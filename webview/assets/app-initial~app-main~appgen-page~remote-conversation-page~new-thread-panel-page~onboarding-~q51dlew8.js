...
var l,
  u = e(() => {
    (c(), (l = i(`remote-host-globe-color-by-host-id`, void 0)));
  });
...
function _(e, t) {
  ...
  return Object.fromEntries(
    r.map((e, i) => [
      e,
      t?.[e] ?? h({ chroma: g({ hostCount: r.length, hostIndex: i }), hue: n[e] }),
    ]),
  );
}
function v(e) {
...
function w(e) {
  let n = (0, T.c)(11),
    { className: r, hostId: i, hostIdsForColorAssignment: o } = e,
    s = a(l),
    c;
  n[0] !== i || n[1] !== o
    ? ((c = o.includes(i) ? o : [i, ...o]), (n[0] = i), (n[1] = o), (n[2] = c))
    : (c = n[2]);
  let u = c,
    d;
  n[3] !== s || n[4] !== u ? ((d = _(u, s)), (n[3] = s), (n[4] = u), (n[5] = d)) : (d = n[5]);
  let f = d[i],
    p;
  ...
  return (
    n[8] !== r || n[9] !== p
      ? ((m = (0, E.jsx)(t, { className: r, style: p })), (n[8] = r), (n[9] = p), (n[10] = m))
      : (m = n[10]),
    m
  );
}
...
//# sourceMappingURL=app-initial~app-main~appgen-page~remote-conversation-page~new-thread-panel-page~onboarding-~q51dlew8.js.map
