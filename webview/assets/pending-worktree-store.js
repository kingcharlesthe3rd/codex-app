...
import { fo as t, po as n } from "./app-server-manager-signals.js";
...
function S(e) {
  ...
  return (
    n[0] !== e || n[1] !== r
      ? ((i = r.find((t) => t.id === e) ?? null), (n[0] = e), (n[1] = r), (n[2] = i))
      : (i = n[2]),
    i
  );
}
    ...
    : ((c = (e, t) => {
        if (t.length !== 0) {
          if (window.electronBridge == null) {
            n((n) => (n === void 0 ? [] : n).map((n) => (n.id === e ? O(n, t) : n)));
            return;
          }
          t.forEach((t) => {
...
function E(e, t) {
  ...
  return (
    ...
    o.dispatchMessage(`pending-worktree-create`, { hostId: t.hostId, request: D(e, t) }),
    e
  );
}
function D(e, t) {
