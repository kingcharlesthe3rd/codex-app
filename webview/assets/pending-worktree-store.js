...
import { ps as i, us as a } from "./app-server-manager-signals.js";
...
function C() {
  let e = (0, _.c)(33),
    [, t] = i(`pending_worktrees`),
    { removePendingWorktreeConversationStart: n, retryPendingWorktreeConversationStart: a } = f(),
    o;
  e[0] === t
    ? (o = e[1])
    : ((o = (e) => {
  ...
  e[2] === t
    ...
    : ((c = (e, n) => {
        if (n.length !== 0) {
          ...
          n.forEach((t) => {
            r.dispatchMessage(`pending-worktree-update-metadata`, {
              hostId: b(e),
              id: e,
              update: t,
            });
  ...
  e[12] !== a || e[13] !== t
    ? ((C = (e) => {
        ...
        r.dispatchMessage(`pending-worktree-retry`, { hostId: b(e), id: e });
      }),
      (e[12] = a),
      (e[13] = t),
      (e[14] = C))
  ...
  e[15] === t
    ...
    : ((D = (e) => {
        ...
        r.dispatchMessage(`pending-worktree-continue`, { hostId: b(e), id: e });
      }),
      (e[15] = t),
      (e[16] = D));
  let k = D,
  ...
  e[17] !== n || e[18] !== t
    ? ((A = (e) => {
        if ((n(e), window.electronBridge == null)) {
          t((t) => (t === void 0 ? [] : t).filter((t) => t.id !== e));
          return;
        }
        r.dispatchMessage(`pending-worktree-cancel`, { hostId: b(e), id: e });
      }),
      (e[17] = n),
      (e[18] = t),
      (e[19] = A))
  ...
  e[20] !== n || e[21] !== t
    ? ((M = (e) => {
        ...
        r.dispatchMessage(`pending-worktree-dismiss`, { hostId: b(e), id: e });
      }),
      (e[20] = n),
      (e[21] = t),
      (e[22] = M))
...
function E(e, t) {
  ...
  return (
    ...
    r.dispatchMessage(`pending-worktree-create`, { hostId: t.hostId, request: D(e, t) }),
    e
  );
}
function D(e, t) {
