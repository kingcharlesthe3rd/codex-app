...
import { fs as r, zs as i } from "./app-server-manager-signals.js";
...
function b(e) {
  let t = e.lastIndexOf(`:`);
  return t <= 0 || t === e.length - 1 ? i : e.slice(0, t);
}
function x(e) {
  switch (e) {
    case `queued`:
...
function S() {
  let [e] = r(`pending_worktrees`);
  return e ?? v;
}
function C(e) {
  let t = (0, _.c)(3),
    [n] = r(`pending_worktrees`);
  if (!e) return null;
  if (n === void 0) return;
  let i;
  return (
    t[0] !== e || t[1] !== n
      ? ((i = n.find((t) => t.id === e) ?? null), (t[0] = e), (t[1] = n), (t[2] = i))
      : (i = t[2]),
    i
  );
}
function w() {
  let e = (0, _.c)(33),
    [, t] = r(`pending_worktrees`),
    { removePendingWorktreeConversationStart: n, retryPendingWorktreeConversationStart: i } = f(),
    o;
  e[0] === t
    ? (o = e[1])
    : ((o = (e) => {
    ...
    : ((c = (e, n) => {
        if (n.length !== 0) {
          if (window.electronBridge == null) {
            t((t) => (t === void 0 ? [] : t).map((t) => (t.id === e ? k(t, n) : t)));
            return;
          }
          n.forEach((t) => {
...
function D(e, t) {
  ...
  return (
    E(e, t).launchMode !== `create-stable-worktree` && p(e),
    a.dispatchMessage(`pending-worktree-create`, { hostId: t.hostId, request: O(e, t) }),
    e
  );
}
function O(e, t) {
...
export { S as a, w as i, x as n, f as o, C as r, d as s, T as t };
