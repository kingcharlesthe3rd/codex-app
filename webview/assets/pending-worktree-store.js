...
import { ds as r, ms as i } from "./app-server-manager-signals.js";
...
function b(e) {
  let t = e.lastIndexOf(`:`);
  return t <= 0 || t === e.length - 1 ? r : e.slice(0, t);
}
function x() {
...
function C() {
  let e = (0, _.c)(33),
    ...
    { removePendingWorktreeConversationStart: n, retryPendingWorktreeConversationStart: r } = f(),
    o;
  e[0] === t
    ? (o = e[1])
    : ((o = (e) => {
