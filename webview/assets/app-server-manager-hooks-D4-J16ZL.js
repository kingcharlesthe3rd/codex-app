...
import { A as b, h as x, u as S, v as C } from "./vscode-api.js";
import { f as w } from "./statsig.js";
import { t as T } from "./remote-connection-visibility.js";
import { E, O as D } from "./sidebar-signals.js";
var O = class {
    constructor(e) {
      this.scope = e;
    }
    addManager(e) {
      let t = e.getHostId();
      (this.scope.set(m, (e) => (e.includes(t) ? e : [...e, t])),
        this.scope.set(h, t, e),
        this.scope.set(_, t, d(e)),
        this.scope.set(p, (e) => e + 1));
    }
    ...
    deleteManager(e) {
      (this.scope.set(m, (t) => t.filter((t) => t !== e)),
        this.scope.set(_, e, null),
        this.scope.set(h, e, null),
        v(this.scope, {
          error: null,
          hostId: e,
    ...
    getAll() {
      return this.scope.get(y);
    }
    getDefault() {
      return this.scope.get(g);
    }
    ...
    getForHostId(e) {
      return this.scope.get(m).includes(e) ? this.scope.get(_, e) : null;
    }
    getImplForHostId(e) {
      return this.scope.get(m).includes(e) ? this.scope.get(h, e) : null;
    }
...
function M(e, t) {
  ...
  return t.getAll().filter((t) => {
    let r = t.getHostId();
    if (r === n) return !0;
    let { error: i, state: a } = l(e, r);
    return a === `connected` || i?.code === `login-required`;
  });
}
function N(e, t) {
  return s(`refresh-recent-conversations-for-host`, { hostId: e, sortKey: t })
    .then(() => !0)
    .catch(
      (n) => (
        x.warning(`recent_conversations_refresh_failed`, {
          safe: { sortKey: t },
...
function F({ appServerRegistry: e, onStoreChange: t, subscribeToManager: n }) {
  let r = new Map(),
    i = () => {
      let i = e.getAll(),
...
function I(e, t) {
  return F({
    ...
    subscribeToManager: (e, t) =>
      P([e.addAnyConversationCallback(t), e.addAnyConversationMetaCallback(t)]),
  });
}
function L({ appServerRegistry: e, enabledRemoteHostIds: t, sortKey: n }) {
...
async function R({ scope: e, appServerRegistry: t, enabledRemoteHostIds: n, sortKey: r }) {
  if (!(await Promise.all(M(e, t).map((e) => N(e.getHostId(), r)))).includes(!0))
    throw Error(`Failed to refresh recent conversations`);
  return L({ appServerRegistry: t, enabledRemoteHostIds: n, sortKey: r });
}
function z({ scope: e, appServerRegistry: t, sortKey: n, refreshesInFlightHostIds: r }) {
  for (let i of M(e, t)) {
    let e = i.getHostId();
...
function G(e) {
  let t = (0, k.c)(6),
    ...
    a;
  t[0] !== i || t[1] !== e
    ? ((a = (t) => (e == null ? i.addRegistryCallback(t) : I(i, t))),
      (t[0] = i),
      (t[1] = e),
      (t[2] = a))
    : (a = t[2]);
...
function K(e) {
  let t = (0, k.c)(6),
    ...
    a;
  t[0] !== i || t[1] !== e
    ? ((a = (t) => (e == null ? q : I(i, t))), (t[0] = i), (t[1] = e), (t[2] = a))
    : (a = t[2]);
  let o = a,
    s;
  t[3] !== i || t[4] !== e
...
function Y() {
  return Z(`recent-conversations`);
}
function X() {
  return Z(`recent-conversations-meta`);
}
function Z(e) {
  let t = (0, k.c)(23),
    n = i(o),
    s = H(),
    { enabledRemoteHostIdSet: c } = T(),
    l;
  ...
  let u = l,
    ...
    m = b(),
    h;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((h = new Set()), (t[2] = h)) : (h = t[2]);
  let g = (0, A.useRef)(h),
    _,
    v;
  (t[3] !== s || t[4] !== u || t[5] !== m || t[6] !== e || t[7] !== n || t[8] !== p
    ? ((_ = () => {
        let t = () => {
          ...
          (m.setQueryData(
            [e, p, u],
            L({ appServerRegistry: s, enabledRemoteHostIds: t, sortKey: p }),
          ),
            z({ scope: n, appServerRegistry: s, sortKey: p, refreshesInFlightHostIds: g.current }));
        };
        return (
          t(),
          F({
    ...
    (0, A.useEffect)(_, v));
  let y;
  t[11] !== u || t[12] !== e || t[13] !== p
    ? ((y = [e, p, u]), (t[11] = u), (t[12] = e), (t[13] = p), (t[14] = y))
    : (y = t[14]);
  let x;
  t[15] !== s || t[16] !== u || t[17] !== n || t[18] !== p
    ? ((x = async () =>
        R({ scope: n, appServerRegistry: s, enabledRemoteHostIds: B(u), sortKey: p })),
      (t[15] = s),
      (t[16] = u),
      (t[17] = n),
      (t[18] = p),
...
export { W as a, X as c, U as i, O as l, G as n, H as o, J as r, Y as s, $ as t };
//# sourceMappingURL=app-server-manager-hooks-D4-J16ZL.js.map
