...
function v({ cwd: e, hostId: t, path: n }) {
  return {
    ...
    queryFn: () => a(`open-in-targets`, { params: { cwd: e, hostId: t, path: n } }),
...
function S(
  r,
  { column: i, cwd: a, endLine: o, hostId: m, line: h, openInSidePanel: b = !1, path: x },
) {
  ...
  return (
    ...
    E != null &&
      ...
      O.push({ id: `workspace-file-open-target-separator`, type: `separator` })),
    O.push({
...
function C(e) {
  return e === `darwin` ? _.openInFinder : e === `win32` ? _.openInExplorer : _.openInFileManager;
}
