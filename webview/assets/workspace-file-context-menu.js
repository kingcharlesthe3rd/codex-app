...
import { Gn as r, cn as i } from "./src-1.js";
import { n as a, r as o } from "./lib.js";
import { r as s } from "./platform-BrML-86Y.js";
...
function x(
  e,
  { column: t, cwd: n, endLine: o, hostId: f, line: p, openInSidePanel: y = !1, path: b },
) {
  let x = e.get(c, f ?? `local`),
    C = e.get(u),
    { primaryTarget: w, visibleTargets: T } = v(
      e.queryClient.getQueryData(_({ cwd: n, hostId: f, path: b }).queryKey),
    ),
    E = [],
    D = y,
    O = C && !i(x) && r(b),
  ...
  return (
    ...
    E.push({
      ...
      onSelect: () => {
        h(e.queryClient, { hostId: f, path: b });
      },
    }),
    i(x) ||
      E.push({
