...
import { to as i } from "./app-server-manager-signals.js";
import { Lr as a, kt as o } from "./src-2.js";
...
var u = r(),
  d = e(t(), 1),
  f = n(),
  p = (0, d.createContext)({ expandedTopTray: !1 });
function m(e) {
  let t = (0, u.c)(13),
    { className: n, expandedTopTray: r, children: i } = e,
    a = r === void 0 ? !1 : r,
    o;
  t[0] === n ? (o = t[1]) : ((o = c(`order-2 flex min-w-0 flex-col`, n)), (t[0] = n), (t[1] = o));
  let s;
  t[2] !== i || t[3] !== o
    ? ((s = (0, f.jsx)(`div`, { className: o, children: i })), (t[2] = i), (t[3] = o), (t[4] = s))
    : (s = t[4]);
  let d = s,
    m;
  ...
  let h;
  t[7] !== a || t[8] !== d
    ? ((h = a ? (0, f.jsx)(l, { expandedTopTray: !0, inFlow: !0, children: d }) : d),
      (t[7] = a),
      (t[8] = d),
      (t[9] = h))
    : (h = t[9]);
  ...
  return (
    t[10] !== m || t[11] !== h
      ? ((g = (0, f.jsx)(p.Provider, { value: m, children: h })),
        (t[10] = m),
        (t[11] = h),
        (t[12] = g))
      : (g = t[12]),
...
function h(e) {
  let t = (0, u.c)(7),
    ...
    { expandedTopTray: i } = (0, d.useContext)(p),
    a =
      !i &&
    ...
    s;
  t[0] !== n || t[1] !== a || t[2] !== o
    ? ((s = c(`relative min-w-0 overflow-clip text-token-foreground`, a, o, n)),
      (t[0] = n),
      (t[1] = a),
      (t[2] = o),
      (t[3] = s))
  ...
  return (
    t[4] !== r || t[5] !== s
      ? ((l = (0, f.jsx)(`div`, { className: s, children: r })), (t[4] = r), (t[5] = s), (t[6] = l))
      : (l = t[6]),
    l
  );
}
...
function w(e) {
  ...
  t[9] === r
    ? (p = t[10])
    : ((p = c(`group flex min-w-0 items-center justify-between gap-2 py-0.5 text-sm`, r)),
      (t[9] = r),
      (t[10] = p));
  let m;
  t[11] === i
    ...
    : ((m =
      ...
      (t[12] = m));
  let h;
  t[13] === l ? (h = t[14]) : ((h = c(`min-w-0 flex-1 leading-4`, l)), (t[13] = l), (t[14] = h));
  let g;
  t[15] === a
    ? (g = t[16])
    : ((g =
      ...
      (t[16] = g));
  let _;
  t[17] !== h || t[18] !== g || t[19] !== s
    ? ((_ = (0, f.jsxs)(`div`, { className: h, children: [s, g] })),
      (t[17] = h),
      (t[18] = g),
      (t[19] = s),
      (t[20] = _))
  ...
  return (
    t[27] !== o || t[28] !== p || t[29] !== v || t[30] !== y
      ? ((b = (0, f.jsxs)(`div`, { ...o, className: p, children: [v, y] })),
        (t[27] = o),
        (t[28] = p),
        (t[29] = v),
        (t[30] = y),
