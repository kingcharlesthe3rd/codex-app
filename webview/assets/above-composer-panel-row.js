...
import { Et as i, jr as a } from "./src-4.js";
import { Pa as o } from "./app-server-manager-signals.js";
import { r as s } from "./lib-1.js";
...
function m(e) {
  let t = (0, u.c)(14),
    ...
    s = i === void 0 ? !1 : i,
    d;
  t[0] === n ? (d = t[1]) : ((d = c(`order-2 flex min-w-0 flex-col`, n)), (t[0] = n), (t[1] = d));
  let m;
  t[2] !== a || t[3] !== d
  ...
  let h = m,
    g;
  t[5] !== o || t[6] !== s
    ? ((g = { expandedTopTray: o, hasAboveComposerPortalContent: s }),
      (t[5] = o),
      (t[6] = s),
      (t[7] = g))
    : (g = t[7]);
  let _;
  t[8] !== o || t[9] !== h
    ? ((_ = o ? (0, f.jsx)(l, { expandedTopTray: !0, inFlow: !0, children: h }) : h),
      (t[8] = o),
      (t[9] = h),
      (t[10] = _))
    : (_ = t[10]);
...
function h(e) {
  let t = (0, u.c)(7),
    ...
    s = !i && !a && `first:rounded-t-2xl`,
    l;
  t[0] !== n || t[1] !== o || t[2] !== s
    ? ((l = c(`relative min-w-0 overflow-clip text-token-foreground`, o, s, n)),
      (t[0] = n),
      (t[1] = o),
      (t[2] = s),
      (t[3] = l))
