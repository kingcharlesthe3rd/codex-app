      ...
      return (function () {
        var e = {
            ...
            2370: function (e, t, n) {
              ...
              function a(e, t) {
                ...
                switch (d) {
                  case `!`:
                    return !a(e[1], t);
                  case `or`:
                    for (var f = 1; f < e.length; f++) if (a(e[f], t)) return !0;
                    return !1;
                  case `and`:
                    ...
                    return (function (e, t, n, r) {
                      ...
                      switch (n) {
                        ...
                        case `>`:
                          return e > t;
                        default:
                          throw Error(`Invalid operator in compareNumbers: ${n}`);
                      }
                    })(o(e[1], t), o(e[2], t), d, t);
                  case `in`:
                  ...
                  case `contains`:
                    return (
                      (i = o(e[1], t)),
                      (u = o(e[2], t)),
                      typeof i == `string` && typeof u == `string` && i.indexOf(u) !== -1
                    );
                  case `match`:
                    return (
                      (n = o(e[1], t)),
                      ...
                      typeof n == `string` &&
                        ...
                        (function (e, t) {
                          ...
                          t: for (; e.length > 0; ) {
                            var i, a;
                            if (
                              ((i = (n = c(e)).star), (a = n.chunk), (e = n.pattern), i && a === ``)
                            )
                              return !0;
                            var o = l(a, t),
                              s = o.t,
                            ...
                            if (!u || !(s.length === 0 || e.length > 0)) {
                              if (i)
                                for (var f = 0; f < t.length; f++) {
                                  if (
                                    ((s = (r = l(a, t.slice(f + 1))).t), (u = r.ok), (d = r.err), u)
                                  ) {
              ...
              function o(e, t) {
                return Array.isArray(e) ? e : typeof e == `object` ? e.value : (0, i.default)(t, e);
              }
              function s(e) {
                return (
                  !!Array.isArray(e) &&
                  (((e[0] === `lowercase` || e[0] === `length` || e[0] === `typeof`) &&
                    e.length === 2) ||
                    ((e[0] === `contains` || e[0] === `match`) && e.length === 3))
                );
              }
              function c(e) {
                for (var t = { star: !1, chunk: ``, pattern: `` }; e.length > 0 && e[0] === `*`; )
                ...
                for (var n, r, i = { t: ``, ok: !1, err: !1 }; e.length > 0; ) {
                  ...
                  switch (e[0]) {
                    case `[`:
                      ...
                      t = t.slice(1);
                      var o = !0;
                      (e = e.slice(1)).length > 0 && e[0] === `^` && ((o = !1), (e = e.slice(1)));
                      for (var s = !1, c = 0; ; ) {
                        ...
                        if (
                          ...
                          n.err ||
                            ((d = l),
                            e[0] === `-` &&
                              ((d = (r = u(e.slice(1))).char), (e = r.newChunk), r.err)))
                        )
                          return i;
                        (l <= a && a <= d && (s = !0), c++);
                      }
                    ...
                    case `?`:
                      ...
                      break;
                    case `\\`:
                      if ((e = e.slice(1)).length === 0) return ((i.err = !0), i);
                    default:
                      if (e[0] !== t[0]) return i;
                      ((t = t.slice(1)), (e = e.slice(1)));
                  }
                ...
                (t.default = (function () {
                  ...
                  return (
                    (e.prototype.getRulesByDestinationName = function (e) {
                      for (var t = [], n = 0, r = this.rules; n < r.length; n++) {
                        var i = r[n];
                        (i.destinationName !== e && i.destinationName !== void 0) || t.push(i);
                      }
                      return t;
                    }),
                    e
                ...
                for (var r in t.map)
                  if (t.map.hasOwnProperty(r)) {
                    var i = t.map[r],
                      ...
                      l = void 0;
                    if (
                      (o.length > 1 ? (o.pop(), (l = (0, a.default)(n, o.join(`.`)))) : (l = e),
                      typeof l == `object`)
                    ) {
                      if (i.copy) {
                        ...
                        (d !== void 0 && (0, s.dset)(e, r, d), (0, c.unset)(e, i.move));
                      } else i.hasOwnProperty(`set`) && (0, s.dset)(e, r, i.set);
                      if (i.to_string) {
                        var f = (0, a.default)(e, r);
                        if (typeof f == `string` || (typeof f == `object` && f)) continue;
                        f === void 0
                  ...
                  (t.sample.percent >= 1 ||
                    (t.sample.path
                      ? (function (e, t) {
                          ...
                          return (
                            (c[63] = c[63] === 0 ? 1 : 0),
                            (0, o.default)(parseInt(c.join(``), 2), s) < t.sample.percent
                          );
                        })(e, t)
                ...
                for (var n = e, r = 0, i = t; r < i.length; r++) {
                  ...
                  switch (a.type) {
                    ...
                    case `hash_properties`:
                      break;
                    default:
                      throw Error(`Transformer of type "${a.type}" is unsupported.`);
                  }
                }
                return n;
              };
            ...
            9014: function (e, t) {
              t.dset = function (e, t, n) {
                ...
                for (
                  ...
                  a < o && (i = t[a++]) !== `__proto__` && i !== `constructor` && i !== `prototype`;
                )
                  s = s[i] =
                    a === o
                      ? n
            ...
            3304: function (e) {
              e.exports = typeof Float64Array == `function` ? Float64Array : void 0;
            },
            7382: function (e, t, n) {
              var r,
                i = n(5569),
            ...
            5679: function (e) {
              e.exports = typeof Uint16Array == `function` ? Uint16Array : void 0;
            },
            4773: function (e, t, n) {
              var r,
                i = n(9773),
            ...
            3004: function (e) {
              e.exports = typeof Uint32Array == `function` ? Uint32Array : void 0;
            },
            7980: function (e, t, n) {
              var r,
                i = n(8114),
            ...
            2684: function (e) {
              e.exports = typeof Float64Array == `function` ? Float64Array : null;
            },
            5569: function (e, t, n) {
              e.exports = n(3876);
            },
              ...
              e.exports = function () {
                ...
                try {
                  ((t = new i([1, 3.14, -3.14, NaN])),
                    (e = r(t) && t[0] === 1 && t[1] === 3.14 && t[2] === -3.14 && t[3] != t[3]));
                } catch {
                  e = !1;
                }
                return e;
            ...
            1453: function (e, t, n) {
              ...
              e.exports = function (e) {
                return (i && e instanceof Float64Array) || r(e) === `[object Float64Array]`;
              };
            },
            9331: function (e, t, n) {
              var r = n(7980);
            ...
            3823: function (e, t, n) {
              ...
              e.exports = function (e) {
                return (i && e instanceof Uint16Array) || r(e) === `[object Uint16Array]`;
              };
            },
            2744: function (e, t, n) {
              e.exports = n(2326);
            ...
            2326: function (e, t, n) {
              ...
              e.exports = function (e) {
                return (i && e instanceof Uint32Array) || r(e) === `[object Uint32Array]`;
              };
            },
            8279: function (e, t, n) {
              e.exports = n(208);
            ...
            208: function (e, t, n) {
              ...
              e.exports = function (e) {
                return (i && e instanceof Uint8Array) || r(e) === `[object Uint8Array]`;
              };
            },
            6315: function (e) {
              e.exports = 1023;
            ...
            677: function (e, t, n) {
              ...
              e.exports = function (e, t) {
                var n, l;
                return (
                  a.assign(e, c, 1, 0), (n = c[0]), (n &= i), (l = o(t)), s((n |= l &= r), c[1])
                );
              };
            },
            5500: function (e, t, n) {
                    ...
                    (t += p((e = g[0]))) < c
                      ...
                      : t > o
                        ? e < 0
                          ? i
                          : r
                        : (t <= s ? ((t += 52), (v = 2220446049250313e-31)) : (v = 1),
                          m(_, e),
                          (n = _[0]),
                          (n &= 2148532223),
                          v * h((n |= (t + a) << 20), _[1])));
            ...
            7063: function (e, t, n) {
              ...
              e.exports = function (e, t, n) {
                r(e, t, { configurable: !1, enumerable: !1, writable: !1, value: n });
              };
            },
            2073: function (e) {
            ...
            1680: function (e) {
              e.exports = typeof Object.defineProperty == `function` ? Object.defineProperty : null;
            },
            1471: function (e, t, n) {
              var r = n(1680);
              e.exports = function () {
            ...
            1309: function (e) {
              ...
              e.exports = function (e, s, c) {
                var l, u, d, f;
                if (typeof e != `object` || !e || n.call(e) === `[object Array]`)
                  throw TypeError(
                    "invalid argument. First argument must be an object. Value: `" + e + "`.",
                  );
                if (typeof c != `object` || !c || n.call(c) === `[object Array]`)
                  throw TypeError(
                    "invalid argument. Property descriptor must be an object. Value: `" + c + "`.",
                  );
                if (
                  ((u = `value` in c) &&
                ...
                return (d && r && r.call(e, s, c.get), f && i && i.call(e, s, c.set), e);
              };
            },
            6208: function (e, t, n) {
              var r,
            ...
            374: function (e, t, n) {
              ...
              for (var r = [], i = 0; i < 64; ) r[i] = 0 | (4294967296 * Math.sin(++i % Math.PI));
              function a(e) {
                var t,
                  n,
                  a,
                    ...
                    l = [
                      ...
                      t +
                        (((a =
                          ...
                          r[c] +
                          ~~s[i | (15 & [c, 5 * c + 1, 3 * c + 5, 7 * c][l])]) <<
                          (l = [7, 12, 17, 22, 5, 9, 14, 20, 4, 11, 16, 23, 6, 10, 15, 21][
                            4 * l + (c++ % 4)
                          ])) |
                          (a >>> -l)),
                      t,
                ...
                for (e = ``; c < 32; ) e += ((o[c >> 3] >> (4 * (1 ^ c++))) & 15).toString(16);
                return e;
              }
            },
          },
      ...
      return function (t) {
        ...
        (new i.Store(e).getRulesByDestinationName(r).forEach(function (e) {
          for (var t = e.matchers, r = e.transformers, o = 0; o < t.length; o++)
            if (i.matches(n.obj, t[o]) && ((n.obj = i.transform(n.obj, r[o])), n.obj === null))
              return a(null);
        }),
          a(n));
      };
