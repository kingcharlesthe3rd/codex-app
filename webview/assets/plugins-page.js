...
import { f as u, k as d, m as f, o as p, s as m } from "./vscode-api.js";
import { i as h, r as g } from "./react.js";
import { Xt as _, yr as v } from "./src-4.js";
import { As as y, do as b, us as x } from "./app-server-manager-signals.js";
import { c as S, o as C, r as w } from "./lib-1.js";
import { o as T, vr as E } from "./persisted-signal.js";
...
import { o as P } from "./statsig-DoZ-0xit.js";
import { a as F, t as I } from "./format-skill-title.js";
import { S as ee, b as te, w as ne } from "./config-queries-BHYT-TjG.js";
import { n as re } from "./selectable-remote-connections-signal-DJZ-ZbLr.js";
...
import { f as ce, m as le } from "./chunk-8.js";
import { c as ue, s as de } from "./apps-queries.js";
import { t as L } from "./startCase.js";
import { t as fe } from "./connector-logo.js";
import { r as pe } from "./mention-item.js";
...
import { t as Ne } from "./settings.cog.js";
import { t as Pe } from "./skills.js";
...
import { a as ze, d as Be, i as Ve, l as He, n as Ue, r as We } from "./dialog-layout.js";
import { n as Ge } from "./use-start-new-conversation.js";
import { n as Ke, t as qe } from "./plugin-prefill-prompt.js";
import { l as V, n as Je } from "./bundled-plugin-auto-install-preference.js";
import { t as Ye } from "./use-resize-observer.js";
import { t as Xe } from "./x-circle.js";
import { n as Ze, t as Qe } from "./imported-connector-apps.js";
import { t as $e } from "./search.js";
import { t as et } from "./edit.js";
import { r as H, t as tt } from "./dropdown.js";
import { t as nt } from "./trash.js";
import { t as rt } from "./chevron.js";
import { t as it } from "./remote-host-globe-icon.js";
import { t as at } from "./empty-state-puzzle-piece.js";
import { t as ot } from "./plus.js";
import { t as st } from "./use-connected-remote-connections.js";
import { n as ct, o as lt, t as ut } from "./check-plugin-availability.js";
import {
  c as dt,
  d as ft,
  i as pt,
...
import { t as xt } from "./laptop.js";
import { t as St } from "./banner.js";
import { t as Ct } from "./toggle.js";
import { t as wt } from "./regenerate.js";
import { i as Tt } from "./app-connect-oauth.js";
import { r as Et } from "./format-skill-scope.js";
import { t as Dt } from "./link.js";
import { t as Ot } from "./more-menu-trigger.js";
...
import { t as W } from "./share.js";
import { t as Ft } from "./toolbar-breadcrumb.js";
import { n as It } from "./use-home-directory.js";
import { t as Lt } from "./segmented-toggle.js";
import { t as Rt } from "./apps-availability.js";
import { t as zt } from "./use-media-query.js";
import {
  A as Bt,
  C as Vt,
  D as Ht,
...
import { t as wn } from "./plugin-uninstall-dialog.js";
import { t as Tn } from "./useForm.js";
import { t as En } from "./filter.js";
import { t as Dn } from "./control-group.js";
function On(e) {
  let t = e.source.trim();
...
async function kn({ forceReloadPlugins: e, onReloadError: t, params: n, sendAddMarketplace: r }) {
  let i = await r(n);
  try {
    await e();
  } catch (e) {
...
var G = r(),
  K = e(t(), 1),
  q = n(),
  An = `flex flex-col gap-1.5 text-sm text-token-description-foreground`,
  jn = `w-full rounded-md border border-token-input-border bg-token-input-background px-2.5 py-1.5 text-base text-token-input-foreground outline-none placeholder:text-token-input-placeholder-foreground focus:border-token-focus-border`;
function Mn(e) {
  let t = (0, G.c)(12),
                    ...
                    children: (e) => {
                      let t =
                        c > 0 || e.state.meta.isBlurred
                          ? (e.state.meta.errors.find(Nn) ?? null)
                          : null;
                      ...
                      (0, q.jsxs)(`label`, {
                        ...
                        children: [
                          ...
                          (0, q.jsx)(`textarea`, {
                            ...
                            className: D(jn, `min-h-20 resize-y`),
                            disabled: n,
                            onBlur: e.handleBlur,
                            onChange: (t) => {
                              e.handleChange(t.target.value);
  ...
  return (
    t[9] !== u.Subscribe || t[10] !== d
      ? ((f = (0, q.jsx)(u.Subscribe, { selector: Fn, children: d })),
        (t[9] = u.Subscribe),
        (t[10] = d),
        (t[11] = f))
      : (f = t[11]),
...
var In = { container: `_container_1ujd8_1`, grid: `_grid_1ujd8_5` };
function Ln(e) {
  let t = (0, G.c)(5),
    { children: n, className: r } = e,
    i;
  t[0] === r ? (i = t[1]) : ((i = D(r, In.container)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
...
function zn({
  ...
  if (n)
    return (0, q.jsx)(`div`, {
      ...
      children: (0, q.jsx)(U, {
        title: (0, q.jsx)(C, { ...Y.loadErrorTitle }),
        description: n,
        illustration: (0, q.jsx)(at, {
          "aria-hidden": !0,
  ...
  if (p.length === 0)
    return (0, q.jsx)(`div`, {
      ...
      children: f
        ...
        : (0, q.jsx)(U, { title: m, description: t }),
    });
  let k = p.map((t, n) =>
    (0, q.jsxs)(
      K.Fragment,
  ...
  return (0, q.jsxs)(q.Fragment, {
    children: [
      l
        ...
        : (0, q.jsx)(Rn, { gap: `compact`, isSingleColumn: c, children: k }),
      E != null && b != null
        ? (0, q.jsx)(wn, {
...
function Bn(e) {
  let t = (0, G.c)(121),
    ...
    k;
  t[0] !== o || t[1] !== h || t[2] !== g
    ? ((k = qn({ installedStateAction: o, plugin: g, onToggleInstalledPluginEnabled: h })),
      (t[0] = o),
      (t[1] = h),
      (t[2] = g),
      (t[3] = k))
    : (k = t[3]);
  let j = k,
    M = g.plugin.source.type === `remote`,
    P;
  t[4] !== i || t[5] !== g.marketplacePath || t[6] !== g.plugin.source
    ? ((P = lt(i, g.marketplacePath, g.plugin.source)),
      (t[4] = i),
  ...
  let F = P,
    ...
    te = g.plugin.installed && !g.plugin.enabled,
    ne = s == null && !g.plugin.installed,
    re;
  t[8] === g.plugin.name
    ? (re = t[9])
    : ((re = Oe(g.plugin.name)), (t[8] = g.plugin.name), (t[9] = re));
  let ie = re != null,
    ae = !g.plugin.installed && (s != null || (ie && !M)),
    se;
  t[10] !== a || t[11] !== g || t[12] !== ae
    ? ((se = ae ? { hostId: a, ...be(g) } : { hostId: a }),
      (t[10] = a),
      (t[11] = g),
      (t[12] = ae),
      (t[13] = se))
    : (se = t[13]);
  let { blockedReason: ce, isLoading: le } = ct(se),
    ue;
  t[14] !== ce || t[15] !== g.plugin
    ? ((ue = ut(g.plugin) ? `disabled-by-admin` : ce),
      (t[14] = ce),
      (t[15] = g.plugin),
      (t[16] = ue))
    : (ue = t[16]);
  let de = ue,
    L = de === `disabled-by-admin`,
    pe,
    R,
    ge,
    _e,
  ...
  if (
    ...
    ((ge = Ee(g.plugin.name, ie ? de : null)), (_e = ne && L));
    let e;
    t[47] === g.plugin.shareContext?.creatorName
      ? (e = t[48])
    ...
    t[49] !== i ||
    t[50] !== f ||
    t[51] !== g.plugin.interface?.developerName ||
    t[52] !== F ||
    t[53] !== r
      ? ((a =
          f == null
    ...
    (t[55] === o
      ...
      (R = s));
    let c = f == null ? r : null;
    ((ve = (x != null && !L) || I || ee || p != null), (pe = Me));
    let l = n ?? `border-none`;
    t[57] === l
      ? (z = t[58])
      : ((z = D(`group !cursor-interaction justify-center`, l)), (t[57] = l), (t[58] = z));
    let u = (te || w || L) && `opacity-60`;
    ...
    (t[66] !== g.logoPath || t[67] !== v
      ...
      : (b = t[68]),
      t[69] !== h || t[70] !== b
        ? ((xe = (0, q.jsx)(`span`, { className: h, children: b })),
          (t[69] = h),
          (t[70] = b),
          (t[71] = xe))
        : (xe = t[71]),
      t[72] === g ? (Se = t[73]) : ((Se = V(g)), (t[72] = g), (t[73] = Se)),
      t[74] !== c || t[75] !== g.description
        ? ((Ce =
            g.description == null && c == null
              ...
              : (0, q.jsxs)(q.Fragment, {
                  children: [
                    g.description == null
                      ? null
                      : (0, q.jsx)(`div`, { className: `line-clamp-1`, children: g.description }),
                    c == null
                      ? null
                      : (0, q.jsx)(`div`, {
                          className: `text-xs text-token-description-foreground`,
                          children: (0, q.jsx)(C, { ...Y.sharedBy, values: { name: c } }),
                        }),
                  ],
                })),
          (t[74] = c),
          ...
          (t[76] = Ce))
        : (Ce = t[76]),
      (we = `flex flex-col gap-0.5 !text-token-description-foreground`),
      (Te = Jn(g, w, _, ge)),
      (t[17] = ee),
      (t[18] = ie),
      (t[19] = ne),
        ...
        j === `toggle`
          ? (0, q.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, q.jsx)(N, {
                  tooltipContent: L
                    ? (0, q.jsx)(C, { ...Y.disabledByAdmin })
                    : g.plugin.enabled
                      ? (0, q.jsx)(C, { ...Y.disableToggleTooltip })
                      : (0, q.jsx)(C, { ...Y.enableToggleTooltip }),
                  children: (0, q.jsx)(Ct, {
                    checked: g.plugin.enabled,
                    disabled: L || c || l,
                    ariaLabel: T.formatMessage(Y.toggleAria),
                    onClick: Vn,
                    onChange: (e) => {
                      h?.({ pluginId: g.plugin.id, pluginDisplayName: V(g), enabled: e });
                    },
                  }),
                }),
              ],
          ...
          : j === `menu`
            ? (0, q.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, q.jsx)(_n, {
                    ...
                    enableButtonLabel: (0, q.jsx)(C, { ...Y.enableButton }),
                    enabledStatusAriaLabel: T.formatMessage(Y.enabledStatus),
                    isEnabled: g.plugin.enabled && !L,
                    isUninstalling: l,
                    isUpdating: c,
                    ...
                    onDisable:
                      !M && !L && h
                        ? () => {
                            ((O.current = !0),
                              h({ pluginId: g.plugin.id, pluginDisplayName: V(g), enabled: !1 }));
                          }
                        : void 0,
                    onEnable:
                      !M && te && !L && h
                        ? () => {
                            ((O.current = !0),
                              h({ pluginId: g.plugin.id, pluginDisplayName: V(g), enabled: !0 }));
                          }
                        : void 0,
                    onUninstall: p
                      ? () => {
            ...
            : j === `status`
              ? (0, q.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, q.jsx)(Wn, {
                      ...
                      tryInChatLabel: T.formatMessage(Y.tryInChat),
                      enabledStatusAriaLabel: T.formatMessage(Y.enabledStatus),
                    }),
                  ],
                })
              : _e
                ? (0, q.jsx)(N, {
                    tooltipContent: (0, q.jsx)(C, { ...Y.disabledInstallTooltip }),
                    children: (0, q.jsx)(`span`, {
                      role: `img`,
                      "aria-label": T.formatMessage(Y.disabledInstallTooltip),
                ...
                : (0, q.jsx)(N, {
                    tooltipContent: L
                      ? (0, q.jsx)(C, { ...Y.disabledByAdmin })
                      : (s ?? (0, q.jsx)(C, { ...Y.installTooltip })),
                    children: (0, q.jsx)(`div`, {
                      className: L ? `cursor-not-allowed` : `cursor-interaction`,
                      children: (0, q.jsx)(A, {
                        color: `secondary`,
                        size: `composer`,
                        className: L ? void 0 : `!cursor-interaction`,
                        disabled: L || le,
                        onClick: (e) => {
                          (e.stopPropagation(), !(L || le) && b(g));
                        },
                        children: s ?? (0, q.jsx)(C, { ...Y.connect }),
                      }),
                    }),
                  })),
      (t[82] = j),
      ...
      i.push(
        (0, q.jsx)(
          `span`,
          {
            ...
            children: (0, q.jsx)(C, { ...Y.unavailableInCurrentContext }),
          },
          `${e.plugin.id}-unavailable`,
        ),
      ),
    r && i.push((0, q.jsx)(Ae, {}, `${e.plugin.id}-plugin-upsell`)),
    !n &&
      e.marketplaceName.length > 0 &&
      yt(e.marketplaceName) !== `Built by OpenAI` &&
      i.push(
        (0, q.jsx)(
          `span`,
          { className: `text-token-description-foreground`, children: yt(e.marketplaceName) },
    ...
    t[0] !== n || t[1] !== r || t[2] !== a || t[3] !== i
      ? ((o = async (e) => {
          let t = await kn({
            ...
            onReloadError: Xn,
            params: e,
            sendAddMarketplace: (e) => y(`add-marketplace`, { hostId: r, ...e }),
          });
...
function Qn(e) {
  ...
  return (
    t[8] !== n || t[9] !== l
      ? ((u = (0, q.jsx)(`div`, {
          className: `flex min-h-0 flex-1 items-center justify-center py-8`,
          children: (0, q.jsx)(U, { title: o, description: n, actions: l }),
        })),
        (t[8] = n),
        (t[9] = l),
        (t[10] = u))
...
function $n(e) {
  ...
  return (
    t[22] !== h || t[23] !== _
      ? ((v = (0, q.jsx)(Rn, { isSingleColumn: h, children: _ })),
        (t[22] = h),
        (t[23] = _),
        (t[24] = v))
      : (v = t[24]),
...
var er = {
  ...
  tr = k(`has-opened-plugin-creator-prefill-v1`, !1),
  nr = k(`has-opened-skill-creator-prefill-v1`, !1);
...
function ar(e) {
  ...
  if (n) {
    ...
    return (
      t[8] !== n || t[9] !== o
        ? ((s = (0, q.jsx)(`div`, {
            className: `flex min-h-0 flex-1 items-center justify-center py-8`,
            children: (0, q.jsx)(U, { title: e, description: n, actions: o }),
          })),
          (t[8] = n),
          (t[9] = o),
          (t[10] = s))
  ...
  t[11] !== i || t[12] !== o || t[13] !== f
    ? ((g = (0, q.jsx)(lr, { errors: o, isRetrying: i, onRetry: f })),
      (t[11] = i),
      (t[12] = o),
      (t[13] = f),
      (t[14] = g))
              ...
              children: s.map((e) => {
                ...
                return (0, q.jsx)(
                  Me,
                  {
                    ...
                    icon: (0, q.jsx)(ir, { className: `icon-sm text-token-text-secondary` }),
                    title: on(e),
                    actions: (0, q.jsxs)(Dn, {
                      children: [
                        (0, q.jsx)(N, {
...
function cr(e) {
  let t = (0, G.c)(30),
    ...
    o;
  t[0] === r ? (o = t[1]) : ((o = r == null ? `` : on(r)), (t[0] = r), (t[1] = o));
  let s = o,
    c = r != null,
    l;
  t[2] !== r || t[3] !== a
  ...
  t[8] === u
    ? (f = t[9])
    : ((f = (0, q.jsx)(ze, {
        children: (0, q.jsx)(Ve, { title: u, subtitle: d, subtitleSize: `sm` }),
      })),
      (t[8] = u),
      (t[9] = f));
  let p;
  ...
  let v;
  t[19] !== _ || t[20] !== h
    ? ((v = (0, q.jsx)(ze, { children: (0, q.jsxs)(We, { children: [h, _] }) })),
      (t[19] = _),
      (t[20] = h),
      (t[21] = v))
    : (v = t[21]);
  ...
  t[22] !== v || t[23] !== l || t[24] !== f
    ? ((y = (0, q.jsxs)(Ue, { as: `form`, onSubmit: l, children: [f, v] })),
      (t[22] = v),
      (t[23] = l),
      (t[24] = f),
      (t[25] = y))
  ...
  return (
    t[26] !== i || t[27] !== y || t[28] !== c
      ? ((b = (0, q.jsx)(He, { open: c, onOpenChange: i, size: `compact`, children: y })),
        (t[26] = i),
        (t[27] = y),
        (t[28] = c),
        (t[29] = b))
...
function dr(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)($e, { className: `icon-sm text-token-text-secondary` })), (t[3] = g))
    : (g = t[3]);
  let _;
  t[4] !== r || t[5] !== o
...
function pr(e) {
  ...
  if (e.mode === `manage`) {
    ...
    t[10] !== e.onCreateSkill || t[11] !== c || t[12] !== l
      ? ((d = { ariaLabel: c, disabled: l, Icon: Pe, label: u, onSelect: e.onCreateSkill }),
    ...
    t[30] === m
      ? (g = t[31])
      : ((g = (0, q.jsx)(Ft, { ancestors: m, current: h })), (t[30] = m), (t[31] = g));
    let _ = e.hostSelector,
      v = e.searchInput,
      y;
    t[32] === f ? (y = t[33]) : ((y = (0, q.jsx)(mr, { actions: f })), (t[32] = f), (t[33] = y));
    let b;
    t[34] === n
      ? (b = t[35])
      : ((b = n.formatMessage({
  ...
  if (
    ...
    if (
      ...
      (t[72] !== e.onAddMarketplace || t[73] !== i
        ? ((o = { ariaLabel: i, disabled: !1, Icon: ot, label: a, onSelect: e.onAddMarketplace }),
  ...
  let c = e.hostSelector,
    l;
  t[94] === r ? (l = t[95]) : ((l = (0, q.jsx)(mr, { actions: r })), (t[94] = r), (t[95] = l));
  let u;
...
function mr(e) {
  ...
  if (n.length === 1) {
    let e;
    t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, q.jsx)(ot, { className: `icon-xs` })), (t[1] = e))
      : (e = t[1]);
    let n;
  ...
  let c = i.label,
    l;
  t[11] === n ? (l = t[12]) : ((l = n.map(hr)), (t[11] = n), (t[12] = l));
  let u;
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, q.jsx)(ot, { className: `icon-xs` })), (t[13] = u))
    : (u = t[13]);
  let d;
  return (
    t[14] !== i.ariaLabel ||
...
function gr(e) {
  ...
  t[0] === r
    ? (s = t[1])
    : ((s = (0, q.jsx)(`div`, {
        className: `text-base leading-6 font-medium text-token-foreground`,
        children: r,
      })),
      (t[0] = r),
      (t[1] = s));
  ...
  t[2] === i
    ? (c = t[3])
    : ((c = i ? (0, q.jsx)(`div`, { className: `shrink-0`, children: i }) : null),
      (t[2] = i),
      (t[3] = c));
  let l;
  t[4] !== s || t[5] !== c
    ? ((l = (0, q.jsxs)(`div`, {
        className: `flex items-center justify-between gap-3 border-b border-token-border-light pr-0.5 pb-2 pl-2.5`,
        children: [s, c],
      })),
      (t[4] = s),
      (t[5] = c),
...
function vr(e) {
  ...
  t[0] === r
    ? (o = t[1])
    : ((o = D(
        `flex min-h-15 w-full cursor-interaction items-center gap-3 px-2.5 text-left text-sm leading-[18px] font-normal text-token-description-foreground outline-hidden hover:text-token-foreground focus-visible:text-token-foreground`,
        r,
      )),
      (t[0] = r),
      (t[1] = o));
  let s;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, q.jsx)(`span`, { "aria-hidden": !0, className: `h-10 w-10 shrink-0` })), (t[2] = s))
    : (s = t[2]);
  let c;
  t[3] !== n || t[4] !== i
    ? ((c = i
    ...
    : (c = t[5]);
  let l;
  t[6] === c ? (l = t[7]) : ((l = (0, q.jsx)(`span`, { children: c })), (t[6] = c), (t[7] = l));
  let u;
  return (
    t[8] !== a || t[9] !== o || t[10] !== l
      ? ((u = (0, q.jsxs)(`button`, {
...
function Cr(e) {
  ...
  if (!b) {
    let e;
    t[18] === v ? (e = t[19]) : ((e = v.flatMap(wr)), (t[18] = v), (t[19] = e));
    let o = e,
      s;
    t[20] !== n ||
    t[21] !== r ||
      ...
      ? ((b =
          d == null
            ...
            : (0, q.jsx)(gr, {
                ...
                title: (0, q.jsx)(_r, { count: o.length, children: d }),
                children: m,
              })),
        (t[35] = m),
        (t[36] = o),
      ...
      ? ((e = (e) => {
          ...
          return (0, q.jsx)(
            gr,
            {
              ...
              title:
                t.id === `plugins-connected`
                  ? (0, q.jsx)(C, {
                      ...
                      description: `Title for the section containing connected plugins`,
                    })
                  : t.title,
              action:
                t.id === `plugins-connected`
              ...
              children:
                t.id === `plugins-connected`
                  ? (0, q.jsx)(Dr, { plugins: o, onOpenPluginDetails: h })
                  : (0, q.jsx)(Tr, {
                      errorMessage: r,
                      hostId: i,
                      isLoading: a,
  ...
  return (
    t[73] !== T || t[74] !== E
      ? ((D = (0, q.jsxs)(`div`, { className: `flex flex-1 flex-col gap-9`, children: [E, T] })),
        (t[73] = T),
        (t[74] = E),
        (t[75] = D))
      : (D = t[75]),
...
function Er(e) {
  ...
  return (0, q.jsx)(vr, {
    ...
    children: (0, q.jsx)(C, {
      ...
      values: {
        pluginNames: t.slice(0, 2).map(V).join(`, `),
...
function Dr(e) {
  ...
  if (t[0] !== a || t[1] !== s || t[2] !== r || t[3] !== n) {
    let e = kr({ containerWidth: s, pluginCount: n.length }),
      i = n.slice(0, e);
  ...
  t[11] !== i || t[12] !== c || t[13] !== l
    ? ((p =
        c > 0
          ? (0, q.jsx)(N, {
              tooltipContent: (0, q.jsx)(Or, { plugins: l }),
              children: (0, q.jsx)(`span`, {
...
function kr({ containerWidth: e, pluginCount: t }) {
  if (e == null) return t;
  let n = Math.max(1, Math.floor((e + Sr) / (xr + Sr)));
  return n >= t ? t : n - 1;
}
var Ar = e(v(), 1),
  jr = w({
...
function Mr(e) {
  ...
  t[0] !== c || t[1] !== n.repoPath
    ? ((p = Pr({ repoRoot: c, repoPath: n.repoPath })), (t[0] = c), (t[1] = n.repoPath), (t[2] = p))
    : (p = t[2]);
  let m = p,
    h;
  ...
  let g = h,
    ...
    v;
  t[5] !== n || t[6] !== m || t[7] !== _
    ? ((v = (0, q.jsx)(Fr, { skill: n, size: _, basePath: m })),
      (t[5] = n),
      (t[6] = m),
      (t[7] = _),
      (t[8] = v))
  ...
  let y = v,
    ...
    x;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, q.jsx)(C, { ...jr.connectSkill })), (t[9] = x))
    : (x = t[9]);
  let w;
  t[10] === d ? (w = t[11]) : ((w = d.formatMessage(jr.connectSkill)), (t[10] = d), (t[11] = w));
  let T;
  ...
  let E;
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, q.jsx)(C, { ...jr.connectSkill })), (t[16] = E))
    : (E = t[16]);
  let D;
  ...
  t[22] === g
    ? (k = t[23])
    : ((k = (0, q.jsx)(qt, { kind: `Skill`, title: g })), (t[22] = g), (t[23] = k));
  let j;
  t[24] !== g || t[25] !== i || t[26] !== m
    ? ((j = (e) => {
        let { isOpen: t } = e;
        return (0, q.jsx)(ln, { hostId: i, isOpen: t, skillPath: m, titleText: g });
      }),
      (t[24] = g),
      (t[25] = i),
      (t[26] = m),
...
function Nr(e) {
  ...
  let f;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, q.jsx)(ot, { className: `icon-xs` })), (t[9] = f))
    : (f = t[9]);
  let p;
  return (
    t[10] === d
...
function Pr({ repoRoot: e, repoPath: t }) {
  if (!e) return null;
  let n = t.split(`/`).join(Ar.default.sep),
    r = Ar.default.join(e, n);
  return r.toLowerCase().endsWith(`.md`) ? r : Ar.default.join(r, `SKILL.md`);
}
function Fr(e) {
  let t = (0, G.c)(13),
  ...
  let c = s,
    l;
  t[7] !== o || t[8] !== a
    ? ((l = en({ size: a, hasLargeIcon: o, largeFallbackClassName: `h-5 w-5` })),
      (t[7] = o),
      (t[8] = a),
      (t[9] = l))
    : (l = t[9]);
...
function Ir(e) {
  ...
  if (t[0] !== s || t[1] !== _) {
    ...
    (t[3] === s
      ? (e = t[4])
      : ((e = (e) => !Cn({ installedSkillMatchKeys: s, skill: e })), (t[3] = s), (t[4] = e)),
      (w = _.filter(e)),
      (t[0] = s),
      (t[1] = _),
      (t[2] = w));
  ...
  if (y != null) {
    let e = o.length + T.length,
      i;
    t[6] !== y || t[7] !== e
      ? ((i = (0, q.jsx)(_r, { count: e, children: y })), (t[6] = y), (t[7] = e), (t[8] = i))
      : (i = t[8]);
    let a;
    t[9] !== c ||
    t[10] !== u ||
    ...
    return (
      t[30] !== i || t[31] !== _
        ? ((b = (0, q.jsx)(gr, { id: `skills-search-results`, title: i, children: _ })),
          (t[30] = i),
          (t[31] = _),
          (t[32] = b))
        : (b = t[32]),
  ...
  return (
    t[54] !== O || t[55] !== k
      ? ((A = (0, q.jsxs)(`div`, { className: `flex flex-col gap-9 pb-panel`, children: [O, k] })),
        (t[54] = O),
        (t[55] = k),
        (t[56] = A))
      : (A = t[56]),
...
function Lr(e) {
  ...
  if (i.length > 0) {
    ...
    return (
      t[15] === e
        ? (r = t[16])
        : ((r = (0, q.jsx)(`div`, { className: `flex flex-col gap-8`, children: e })),
          (t[15] = e),
          (t[16] = r)),
      r
    );
  ...
  return (
    t[25] !== r.id || t[26] !== r.title || t[27] !== d
      ? ((f = (0, q.jsx)(gr, { id: r.id, title: r.title, children: d })),
        (t[25] = r.id),
        (t[26] = r.title),
        (t[27] = d),
        (t[28] = f))
...
function zr(e) {
  let { hiddenItems: t, isExpanded: n, onToggle: r } = e;
  return (0, q.jsx)(Jr, { isExpanded: n, skillNames: t.map(Br), onClick: r });
}
function Br(e) {
  let { skill: t } = e;
  return R(t);
...
function Vr(e) {
  ...
  return (
    t[13] !== u || t[14] !== o || t[15] !== d
      ? ((f = (0, q.jsx)(Rn, { gap: u, isSingleColumn: o, children: d })),
        (t[13] = u),
        (t[14] = o),
        (t[15] = d),
        (t[16] = f))
...
function Hr(e) {
  ...
  t[0] !== o || t[1] !== s.path || t[2] !== s.scope
    ? ((l = s.scope === `repo` ? un({ skillPath: s.path, roots: o }) : null),
      (t[0] = o),
      (t[1] = s.path),
      (t[2] = s.scope),
      (t[3] = l))
  ...
  t[9] === r
    ? (p = t[10])
    : ((p = r === `toggle` ? (0, q.jsx)(Ur, {}) : void 0), (t[9] = r), (t[10] = p));
  let m = r !== `toggle`,
    h;
  t[11] === s ? (h = t[12]) : ((h = R(s)), (t[11] = s), (t[12] = h));
  let g;
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, q.jsx)(`span`, {
          ...
          children: (0, q.jsx)(Pe, { className: `icon-sm` }),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
  ...
  if (r) {
    ...
    return (
      t[2] === r
        ...
        : ((n = (0, q.jsx)(`div`, {
            className: `flex min-h-0 flex-1 items-center justify-center py-8`,
            children: (0, q.jsx)(U, { title: e, description: r }),
          })),
          (t[2] = r),
          (t[3] = n)),
      n
...
function Gr(e) {
  let { hiddenItems: t, isExpanded: n, onToggle: r } = e;
  return (0, q.jsx)(Jr, { isExpanded: n, skillNames: t.map(Kr), onClick: r });
}
function Kr(e) {
  return e.name;
}
function qr(e) {
  ...
  return (
    t[15] === l
      ? (u = t[16])
      : ((u = (0, q.jsx)(Rn, { gap: `compact`, isSingleColumn: !0, children: l })),
        (t[15] = l),
        (t[16] = u)),
    u
  );
...
function Jr(e) {
  ...
  return (
    t[5] !== n || t[6] !== i || t[7] !== s
      ? ((c = (0, q.jsx)(vr, { isExpanded: n, onClick: i, children: s })),
        (t[5] = n),
        (t[6] = i),
        (t[7] = s),
        (t[8] = c))
...
var Yr = e(L(), 1),
  ...
  $r = `(max-width: 1023px)`,
  ei = `shared-by-me`,
  ti = `workspace-shared-with-me-private`,
  ni = `remote:${ti}`,
  ri = `remote:workspace-directory`,
  X = [`plugins`, `apps`, `mcps`, `skills`, `marketplace`],
  ii = `sticky top-0 z-30 bg-token-main-surface-primary after:pointer-events-none after:absolute after:top-full after:right-0 after:left-0 after:h-8 after:bg-linear-to-b after:from-token-main-surface-primary after:to-transparent after:content-['']`,
  ai = a(l, (e) => null);
function oi() {
  let e = s(l),
    t = S(),
    ...
    b = (0, K.useRef)(null),
    w = (0, K.useRef)(null),
    k = (0, K.useRef)(m?.browseScrollTop ?? null),
    A = c(re) ?? [],
    j = st(A),
    [M, N] = (0, K.useState)(m?.selectedHostIdState ?? u.initialHostId ?? `local`),
    I = M === `local` || j.some((e) => e.hostId === M) ? M : x,
    oe = ge({ hostId: I }),
    L = A.map((e) => e.hostId),
    [fe, R] = (0, K.useState)(() =>
      m == null
    ...
    [me, he] = (0, K.useState)(() => u.connectAppId ?? null),
    [_e, xe] = (0, K.useState)(m?.searchQuery ?? ``),
    [Ce, Ee] = (0, K.useState)(0),
    [z, De] = (0, K.useState)(``),
    [Oe, B] = (0, K.useState)(!1),
    [Ae, Me] = (0, K.useState)(!1),
    [Ne, Pe] = (0, K.useState)(`idle`),
    [Fe, Ie] = (0, K.useState)(0),
    [ze, Be] = (0, K.useState)(null),
    [Ve, He] = (0, K.useState)(null),
    [Ue, We] = (0, K.useState)(m?.selectedMarketplaceFilterValueState ?? null),
    [Ye, Xe] = (0, K.useState)(null),
    [$e, et] = (0, K.useState)(null),
    [H, tt] = (0, K.useState)(null),
    [nt, rt] = (0, K.useState)(!1),
    it = ae(I),
    { data: at, isLoading: ot } = It(I),
    ct = at?.homeDirectory,
    yt = g(tr),
    xt = h(tr),
    St = g(nr),
    ...
    {
      canInstallRecommendedSkills: Ft,
      defaultRecommendedRepoRoot: Lt,
      skillCreatorPath: qt,
    } = hn(I),
    $t = it == null ? null : `${it}/skills/.system/plugin-creator/SKILL.md`,
    { errorMessage: en, isLoading: cn, refresh: ln, repoRoot: un, skills: mn } = an(Lt, I),
    { installRecommendedSkill: _n, installingSkillId: vn } = yn({
      forceReloadSkills: wt,
      hostId: I,
      onInstalled: () => {
        Me(!0);
    ...
    {
      errorMessage: wn,
      featuredPluginIds: Tn,
      isLoading: En,
      isFetching: Dn,
      marketplaceLoadErrors: On,
      marketplaces: kn,
      availablePlugins: G,
      installedPlugins: An,
      forceReload: jn,
    ...
    J = P(`1269116100`),
    { config: Pn } = dn(),
    { mutateAsync: Fn } = Gt({ hostId: I }),
    { mutateAsync: In } = Kt({ hostId: I }),
    { data: Rn, isLoading: Y } = ve({ enabled: J, hostId: I, marketplaceKind: `shared-with-me` }),
    { data: Bn, isLoading: Vn } = ve({
      enabled: J,
      hostId: I,
      marketplaceKind: `workspace-directory`,
    }),
    Hn = Yn({ forceReloadPlugins: jn, hostId: I }),
    { data: Un } = te(W[0] ?? null, { hostId: I, useActiveWorkspaceRoot: !1 }),
    {
      data: Wn,
      hardRefetchAppsList: Gn,
      isHardRefetchingAppsList: Kn,
      isLoading: qn,
      loadError: Jn,
    } = ue({ hostId: I }),
    Xn = Jn?.message ?? null,
    {
      closePluginInstall: er,
      connectRequiredApp: ir,
      handleRequiredAppConnected: or,
      handleRequiredAppOAuthStarted: sr,
      installPlugin: lr,
      isInstalling: ur,
      openPluginInstall: fr,
      session: mr,
    } = je({ forceReloadPlugins: jn, hostId: I }),
    { pendingPluginId: hr, setPluginEnabled: gr } = Nt({ hostId: I }),
    { pendingUninstallPluginId: _r, uninstallPlugin: vr } = Mt({ hostId: I }),
    { pendingRemoveMarketplaceName: yr, removeMarketplace: br } = Pt({ hostId: I }),
    {
      isUpgradingMarketplaces: xr,
      pendingUpgradeMarketplaceName: Sr,
      upgradeMarketplaces: wr,
    } = jt({ hostId: I }),
    { data: Tr } = i(ne, I),
    {
      clearConnectingApp: Er,
      connectingApp: Dr,
      handleAppConnectOAuthStarted: Or,
      handleConnectApp: kr,
      handleOpenAppUrl: Ar,
      isAppConnectPending: jr,
    } = kt({ hostId: I }),
    { setAppEnabled: Mr, updatingAppId: Nr } = Rt({ hostId: I }),
    Pr = Ve == null ? null : (Wn?.find((e) => e.id === Ve) ?? null),
    Fr = de(Ve),
    Lr = ee({ hostId: I }),
    zr = fn(Tr?.config),
    Br = sn(Tr?.config),
    Vr = xr || Sr != null,
    Hr = !kn.some((e) => bn(e, zr)) || Vr || yr != null,
    Ur = me == null ? null : (Wn?.find((e) => e.id === me) ?? null),
    Wr = me != null && jr(me),
    Gr = Dr ?? Ur,
    Kr = P(`588076040`),
    qr = P(`4218407052`),
    ...
    X = fe.kind === `manage`,
    oi = fe.tab,
    Z = fe.kind === `browse` ? fe.tab : null,
    _i = I === `local` ? [`claude-cowork`] : [],
    bi = oe && Z === `plugins` && _i.length > 0,
    Ci = p(`external-agent-imported-connectors`, {
      params: { hostId: x, providers: _i },
      queryConfig: { enabled: bi },
    }),
    Ti = Yr || ht(G),
    Q = _t(G),
    Ei = ft(G),
    Di = Rn == null ? null : ft(Rn).filter((e) => e.remoteMarketplaceName === ti),
    Oi = vt({ installedPlugins: An, sharedWithYouPlugins: Rn ?? [] }),
    ki = Bn == null ? null : ft(Bn),
    Ai = !!Di?.length,
    ji = !!ki?.length,
    Mi = Yt(t, `skills`),
    Ni = t.formatMessage({
    ...
    Pi = _e.trim().toLowerCase(),
    Fi = z.trim().toLowerCase(),
    $ = Pi.length > 0,
    Ii = Zt({ skills: At, query: Pi }),
    Li = xn({ skills: mn, query: Pi }),
    Ri = Qt(Li),
    zi = $ ? Li : Ri,
    Bi = zi.filter((e) => !Cn({ installedSkillMatchKeys: Et, skill: e })),
    Vi = Ii.length + Bi.length,
    Hi = [
      ...mt(Ei, { mergeOpenAIBundledMarketplace: Kr }),
      ...(J && Ai
        ? [
            {
              label: t.formatMessage({
    ...
    Ui = dt(Ei.map((e) => ({ name: e.marketplaceName, path: e.marketplacePath }))),
    Wi = t.formatMessage({
    ...
    { data: Gi } = Wt({ enabled: J, hostId: I }),
    {
      ...
      availablePlugins: G,
      homeDirectory: ct,
      pluginShares: J ? (Gi ?? null) : null,
      storefrontPlugins: Ei,
    }),
    Yi = J && Ki != null ? Hi.filter((e) => e.value !== Ki) : Hi,
    Xi = Hi.find((e) => e.value === Ki),
    Zi = [...Ei, ...Ji, ...(Di ?? []), ...(ki ?? [])],
    Qi = [];
  (gt({
    marketplaceOptions: { mergeOpenAIBundledMarketplace: Kr },
    plugins: Ei,
    marketplaceFilterValue: Ui,
    query: ``,
  }).length > 0 &&
    Qi.push({
      label: t.formatMessage({
    ...
    J && qi.length > 0 && Qi.push({ label: Wi, subLabel: null, value: ei }),
    J &&
      ji &&
      Qi.push({
        label: t.formatMessage({
    ...
    !J && !ji && Xi != null && Qi.push({ ...Xi, label: Wi, selectedCount: qi.length || void 0 }));
  let $i = (0, Xr.default)([...Qi, ...Yi], (e) => e.value),
    ea = $i.find((e) => e.value === Ue)?.value ?? Qi[0]?.value ?? Yi[0]?.value ?? Ui,
    ta = Z === `plugins` ? ea : null,
    na = ta === ni,
    ra = ta === ei,
    ia = ra ? qi : Zi,
    aa = ra ? null : ta,
    oa = gt({
      marketplaceOptions: { mergeOpenAIBundledMarketplace: Kr },
      plugins: ia,
      marketplaceFilterValue: aa,
      query: ``,
    }),
    sa = gi({ intl: t, roots: W, skillEntries: Ii }),
    {
      marketplaceFilterValue: ca,
      selectedPluginCategoryId: la,
      showPluginSearchResults: ua,
      showPluginSections: da,
    } = Ut({
      currentBrowseTab: Z,
      hasSearchQuery: $,
      isPluginSharingEnabled: J,
      selectedCategoryId: Ye,
      selectedPluginMarketplaceFilterValue: ta,
    }),
    fa =
      Yr && Z === `plugins` && !$ && la == null && ta === Ui
        ? (0, q.jsx)(C, {
        ...
        : null,
    pa = gt({
      dedupeSearchResults: ua,
      marketplaceOptions: { mergeOpenAIBundledMarketplace: Kr },
      plugins: ua ? Zi : ia,
      marketplaceFilterValue: ua ? ca : aa,
      query: Pi,
    }),
    ma = bt(pa, Tn, $ ? pa : Oi),
    ha = ma
    ...
    ga = la != null && ha.some((e) => e.id === la) ? la : null,
    _a = Ze({
      apps: Qe({ apps: Wn ?? [], connectors: bi ? (Ci.data?.connectors ?? []) : [] }),
      plugins: oa,
    }).map(({ app: e, plugin: t }) => ({ ...t, importedConnectorApp: e })),
    va =
      ga == null ? ma : ma.filter(({ section: e }) => e.id === `plugins-connected` || e.id === ga),
    ya = $ ? va.flatMap(({ plugins: e }) => e) : [],
    ba = $
      ? [
          ...ya.map((e) => `plugin:${e.plugin.id}`),
          ...Ii.map(({ skill: e }) => `installed-skill:${e.path}`),
          ...Bi.map((e) => `recommended-skill:${e.id}`),
        ]
      : [],
    xa = ba.length === 0 ? null : Math.min(Ce, ba.length - 1),
    Sa = xa == null ? null : (ba[xa] ?? null),
    Ca = gt({
      marketplaceOptions: { mergeOpenAIBundledMarketplace: Kr },
      plugins: Oi,
    ...
    wa = new Set([...G, ...(Rn ?? [])].map((e) => e.plugin.id)),
    Ta = new Set(Oi.filter((e) => !wa.has(e.plugin.id)).map((e) => e.plugin.id)),
    Ea = Zt({ skills: At, query: Fi }),
    { installedApps: Da } = tn(Wn ?? []),
    Oa = Sn({ apps: Da, query: Fi }),
    ka = wi({ mcpServers: Un?.servers ?? {}, query: Fi }),
    Aa = Vt({ configuredMarketplaceNames: Br, marketplaces: kn, query: `` }),
    ja = {
      apps: Da.length,
      marketplace: Aa.length,
      mcps: Object.keys(Un?.servers ?? {}).length,
      plugins: Oi.length,
      skills: At.length,
    },
    Ma = X && ja[oi] === 0 ? (xi(ja) ?? oi) : oi,
    Na = X ? Ma === `plugins` : Z === `plugins`,
    Pa = Yt(t, Ma),
    Fa = Vt({ configuredMarketplaceNames: Br, marketplaces: Aa, query: Fi }),
    Ia = Lr.isPending ? (Lr.variables?.key ?? null) : null,
    La = !X && Z === `skills` && Oe,
    Ra = La || Ot || sa.length > 0 || Ii.length > 0,
    za = La || cn || en != null || zi.length > 0,
    Ba = Mi.sections.at(-1) ?? null,
    Va = [...sa.map((e) => ({ id: e.id, title: e.title })), ...(za && Ba != null ? [Ba] : [])],
    Ha = Va.some((e) => e.id === $e) ? $e : null,
    Ua = Ha == null || Ha === `skills-recommended` ? sa : sa.filter((e) => e.id === Ha),
    Wa = (0, K.useEffectEvent)(async () => {
      let { availablePlugins: e } = await Nn();
      return Yr || ht(e);
    }),
    Ga = (Z === `skills` || $) && Ra ? (Mi.sections[0] ?? null) : null,
    Ka =
      (Z === `skills` || $) && za && (Ha == null || Ha === `skills-recommended`)
        ? (Mi.sections.at(-1) ?? null)
        : null,
    qa = async () => {
      try {
        await Gn();
    ...
    Ja = (n) => {
      e.get(se).danger(
        ...
        n == null ? void 0 : { description: _(n) },
      );
    },
    Ya = async (e) => {
      let t = lt(ct, e.marketplacePath, e.plugin.source);
      if (t != null) {
        try {
    ...
    Xa = async (n) => {
      ...
      let o = pn({
        initialShare:
          a == null
            ? null
            : { remotePluginId: a.remotePluginId, sharePrincipals: Xt(a), shareUrl: a.shareUrl },
        saveShare: (e) => Fn({ pluginPath: r, remotePluginId: e, discoverability: `PRIVATE` }),
      });
      Re(e, gn, {
        initialSharePrincipals: o.getCurrentShare()?.sharePrincipals ?? [],
        pluginDisplayName: V(n),
        ...
        onCopyLink: async () => {
          try {
            ...
            if ((e || jn(), t.shareUrl.length > 0 && (await Le(t.shareUrl)))) return !0;
          } catch (e) {
            return (Ja(e), !1);
          }
          return (Ja(), !1);
        ...
        onSaveShareTargets: async (n) => {
          try {
            let e = await o.saveShareTargets(n, (e, t) => In({ remotePluginId: e, targets: t }));
            return (jn(), e);
          } catch (n) {
            throw (
              e
    ...
    to = () => {
      if ($t == null) return;
      T(e, E, {});
      let t = rr({ creatorPath: $t, isFirstOpen: !yt, kind: `plugin` });
      (yt || xt(!0), v({ prefillPrompt: t, startInSidebar: !0 }));
    };
  (0, K.useEffect)(() => {
    if (!Za) {
      Pe(`idle`);
  ...
  let no = () => {
      if (qt == null) return;
      T(e, E, {});
      let t = rr({ creatorPath: qt, isFirstOpen: !St, kind: `skill` });
      (St || Ct(!0), v({ prefillPrompt: t, startInSidebar: !0 }));
    },
    ro = async () => {
      if (Q == null || ut(Q.plugin)) return;
      let e = qe({
        defaultPrompt: Ke(Q.plugin.interface?.defaultPrompt),
        pluginDisplayName: V(Q),
      ...
      if (!Q.plugin.enabled)
        try {
          await gr({ enabled: !0, pluginDisplayName: V(Q), pluginId: Q.plugin.id });
        } catch {
          return;
        }
      v({ prefillPrompt: e, startInSidebar: !0 });
    },
    io = (e, t = Ke(e.plugin.interface?.defaultPrompt)) => {
      let n = W[0] != null && W[0] !== `/` ? W[0] : void 0;
      v({
        prefillPrompt: qe({ defaultPrompt: t, pluginDisplayName: V(e), pluginId: e.plugin.id }),
        prefillCwd: n,
        startInSidebar: !0,
      });
    },
    ao = async () => {
      B(!0);
      try {
        (U(), await Promise.all([jn(), ln(), Gn()]), Me(!1));
      } catch {
        e.get(se).danger(
          t.formatMessage({
    ...
    uo = (e) => {
      if (!(!$ || ba.length === 0)) {
        if (e.key === `ArrowDown`) {
          (e.preventDefault(), Ee(Math.min((xa ?? 0) + 1, ba.length - 1)), lo());
          return;
        }
        if (e.key === `ArrowUp`) {
          (e.preventDefault(), Ee(Math.max((xa ?? 0) - 1, 0)), lo());
          return;
        }
        if (e.key === `Enter`) {
    ...
    go = (t) => {
      (X ||
        e.set(f, {
          ...
          selectedMarketplaceFilterValueState: Ue,
        }),
        a(Te(t, { hostId: I, source: X ? `manage` : void 0 }), { state: X ? void 0 : we() }));
    },
    _o = (0, K.useEffectEvent)(() => {
      b.current?.focus();
    }),
    vo = async (e, t) => {
      await Lr.mutateAsync({ key: e, enabled: t });
    },
    yo = async (e) => {
      try {
        (await br({ marketplaceDisplayName: on(e), marketplaceName: e.name }), tt(null));
      } catch {}
    },
    bo = async () => {
      try {
    ...
    xo = async (e) => {
      try {
        await wr({ marketplaceDisplayName: on(e), marketplaceName: e.name });
      } catch {}
    };
  return (
    (0, K.useEffect)(() => {
      let e = (e) => {
        (e.metaKey || e.ctrlKey) &&
          e.key.toLowerCase() === `f` &&
          (vi(e.target) || (e.preventDefault(), _o()));
      };
      return (
            ...
            ? (0, q.jsx)(pr, {
                ...
                recordSkillAction:
                  Q == null
                    ? void 0
                    : {
                        disabled: ur || hr === Q.plugin.id || ut(Q.plugin),
                        onSelect: () => {
                          ro();
                        },
                      },
          ...
          children: oe
            ? (0, q.jsx)(q.Fragment, {
                children: (0, q.jsxs)(`div`, {
                  ...
                  children: [
                    (0, q.jsx)(Ln, {
                      className: D(`flex h-full w-full flex-1 flex-col`, X ? `gap-0` : `gap-8`),
                      children: X
                        ? (0, q.jsx)(`div`, {
                                    ...
                                    children: (0, q.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, q.jsx)(yi, {
                                          appsCount: Da.length,
                                          currentTab: Ma,
                                          marketplacesCount: Aa.length,
                                          mcpsCount: Object.keys(Un?.servers ?? {}).length,
                                          pluginsCount: Oi.length,
                                          onSelectTab: fo,
                                    ...
                                    Ma === `plugins`
                                      ? (0, q.jsx)(zn, {
                                          ...
                                          onCopyShareLink: J
                                            ...
                                            : void 0,
                                          onOpenPluginDetails: go,
                                          onShareInstalledPlugin: J
                                            ? (e) => {
                                                Xa(e);
                                              }
                                            : void 0,
                                          onTryInChat: J ? io : void 0,
                                          plugins: Ca,
                                          unavailablePluginIds: Ta,
                                          onInstallPlugin: async (e) => {
                                            fr(e);
                                          },
                                          onUninstallInstalledPlugin: vr,
                                          onToggleInstalledPluginEnabled: gr,
                                          pendingPluginId: hr,
                                          pendingUninstallPluginId: _r,
                                        ...
                                        : Ma === `mcps`
                                          ...
                                          : Ma === `marketplace`
                                            ? (0, q.jsx)(ar, {
                                                ...
                                                isRetrying: Oe || Dn,
                                                marketplaceLoadErrors: On,
                                                configuredMarketplaceNames: Br,
                                                configuredGitMarketplaceNames: zr,
                                                isUpgradingMarketplaces: xr,
                                                marketplaces: Fa,
                                                onUpgradeMarketplace: (e) => {
                                                  xo(e);
                                                },
                                                onRemoveMarketplace: tt,
                                                onRetry: ao,
                                                pendingUpgradeMarketplaceName: Sr,
                                                pendingRemoveMarketplaceName: yr,
                                              })
                                            : Wn == null
                                              ? (0, q.jsx)(Qn, {
                                                  errorMessage: Xn,
                        ...
                        : (0, q.jsx)(si, {
                            ...
                            searchInput: (0, q.jsx)(dr, {
                              id: `plugins-page-search`,
                              inputRef: b,
                              autoFocus: Z === `plugins`,
                              label: Ni,
                              onKeyDown: uo,
                              onSearchQueryChange: co,
                              placeholder: Ni,
                              searchQuery: _e,
                              variant: `composer`,
                            }),
                            searchTrailingControl:
                              Z === `plugins` && !$
                                ? (0, q.jsx)(fi, {
                                    sections: ha,
                                    selectedSectionId: ga,
                                    onSelectSection: Xe,
                                  })
                                : Z === `skills` && !$
                                  ? (0, q.jsx)(fi, {
                                      sections: Va,
                                      selectedSectionId: Ha,
                                      onSelectSection: et,
                                    })
                                  : null,
                            searchBottomControl:
                              Z === `plugins` && !$
                                ? (0, q.jsx)(di, {
                                    marketplaceFilterOptions: $i,
                                    selectedMarketplaceFilterValue: ea,
                                    onSelectMarketplace: so,
                                  })
                                : null,
                            children: (0, q.jsxs)(`div`, {
                              className: `flex min-h-0 flex-1 flex-col gap-8`,
                              children: [
                                (Z !== `skills` && !$) || ($ && pa.length > 0)
                                  ? (0, q.jsxs)(`div`, {
                                      className: `flex min-h-0 flex-1 flex-col gap-8`,
                                      children: [
                                        Z === `plugins` && !$ && ga == null && _a.length > 0
                                          ? (0, q.jsxs)(`section`, {
                                              ...
                                              children: [
                                                ...
                                                (0, q.jsx)(zn, {
                                                  ...
                                                  onInstallPlugin: async (e) => {
                                                    (he(null), await kr(e.importedConnectorApp));
                                                  },
                                                  onOpenPluginDetails: go,
                                                }),
                                              ],
                                        ...
                                        (0, q.jsx)(`div`, {
                                          ...
                                          children: (0, q.jsx)(Cr, {
                                            catalogStatusMessage: fa,
                                            errorMessage: wn,
                                            highlightedPluginId: Sa?.startsWith(`plugin:`)
                                              ? Sa.slice(7)
                                              : null,
                                            hostId: I,
                                            isLoading: Qa,
                                ...
                                Z === `skills` || ($ && Vi > 0)
                                  ? (0, q.jsx)(`div`, {
                                      ...
                                      children: (0, q.jsx)(Ir, {
                                        ...
                                        errorMessage: en,
                                        hostId: I,
                                        highlightedInstalledSkillPath: Sa?.startsWith(
                                          `installed-skill:`,
                                        )
                                          ? Sa.slice(16)
                                          : null,
                                        highlightedRecommendedSkillId: Sa?.startsWith(
                                          `recommended-skill:`,
                                        )
                                          ? Sa.slice(18)
                                          : null,
                                        installedSkillGroups: Ua,
                                        installedStateAction: `check`,
                                        installedSection: Ga,
                                        installedSkillMatchKeys: Et,
                                        installedSkills: Ii,
                                        installingSkillId: vn,
                                        isLoadingInstalledSkills: Ot || La,
                                        isLoadingRecommendedSkills: cn || La,
                                        onInstallRecommendedSkill: _n,
                                        onSkillsUpdated: U,
                                        recommendedRepoRoot: un,
                                        recommendedSection: Ka,
                                        recommendedSkills: zi,
                                        roots: W,
                                        searchResultsTitle: $
                                          ? (0, q.jsx)(C, {
                                              id: `skills.appsPage.skillsFilter.all`,
                                ...
                                $ && pa.length + Vi === 0
                                  ? (0, q.jsx)(`div`, {
                                      className: `px-2.5 text-base text-token-text-secondary`,
                                      children: (0, q.jsx)(C, {
                    ...
                    (0, q.jsx)(ke, {
                      hostId: I,
                      isInstalling: ur,
                      onConnectRequiredApp: ir,
                      onInstall: lr,
                      onRequiredAppConnected: or,
                      onRequiredAppOAuthStarted: sr,
                      onTryInChat: io,
                      onViewDetails: go,
                      onOpenChange: (e) => {
                        e || er();
                    ...
                    (0, q.jsx)(Mn, { open: nt, onAddMarketplace: Hn, onOpenChange: rt }),
                    (0, q.jsx)(ci, {
                      hostId: I,
                      pluginDetail: ze,
                      onOpenChange: (e) => {
                    ...
                    (0, q.jsx)(Je, {
                      ...
                      onConnected: async () => {
                        he(null);
                        try {
                          await Tt({ hostId: I, queryClient: y, refreshAppsList: Gn });
                        } catch {}
                      },
                    }),
                    (0, q.jsx)(Bt, {
                      app: Pr,
                      errorMessage: Fr.error?.message ?? null,
                      ...
                      onTryInChat: (e) => {
                        v({
                          ...
                          prefillCwd: W[0] != null && W[0] !== `/` ? W[0] : void 0,
                          startInSidebar: !0,
                        });
                      },
                      tools: Fr.data ?? [],
...
function si(e) {
        ...
        : (0, q.jsx)(`div`, {
            ...
            children: (0, q.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, q.jsx)(`div`, {
                  className: `heading-lg font-normal text-token-text-secondary`,
                  children: c,
                }),
              ],
            }),
  ...
  t[4] === a
    ? (d = t[5])
    : ((d = (0, q.jsx)(`div`, { className: `min-w-0 flex-1`, children: a })),
      (t[4] = a),
      (t[5] = d));
  let f;
  t[6] !== o || t[7] !== d
    ? ((f = (0, q.jsxs)(`div`, { className: `flex items-center gap-2`, children: [d, o] })),
      (t[6] = o),
      (t[7] = d),
      (t[8] = f))
    : (f = t[8]);
...
function ui(e) {
  ...
  t[5] !== i || t[6] !== u
    ? ((f =
        u == null
          ? (0, q.jsx)(xt, { className: `icon-xs shrink-0 text-token-text-secondary` })
          : (0, q.jsx)(it, {
  ...
  t[8] === d
    ? (p = t[9])
    : ((p = (0, q.jsx)(`span`, { className: `truncate text-left`, children: d })),
      (t[8] = d),
      (t[9] = p));
  let m;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, q.jsx)(xt, { className: `icon-xs shrink-0 text-token-text-secondary` })),
      (t[17] = y))
    : (y = t[17]);
  let b;
  t[18] === c
    ...
    : ((b = (0, q.jsxs)(`span`, {
        className: `flex min-w-0 items-center gap-2`,
        children: [y, (0, q.jsx)(`span`, { className: `truncate`, children: c })],
      })),
      (t[18] = c),
      (t[19] = b));
  let w;
  t[20] !== b || t[21] !== _ || t[22] !== v
    ? ((w = (0, q.jsx)(H.Item, { RightIcon: _, onSelect: v, children: b })),
      (t[20] = b),
      (t[21] = _),
      (t[22] = v),
      (t[23] = w))
  ...
  t[33] === T
    ? (E = t[34])
    : ((E = (0, q.jsx)(H.Section, { className: `max-h-40 overflow-y-auto`, children: T })),
      (t[33] = T),
      (t[34] = E));
  let D;
  return (
    t[35] !== w || t[36] !== E || t[37] !== h
      ? ((D = (0, q.jsxs)(tt, {
          align: `end`,
...
function fi(e) {
  ...
  let c;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, q.jsx)(En, { className: `icon-sm text-token-text-secondary` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === s
    ? (l = t[4])
  ...
  let p;
  t[8] !== u || t[9] !== d
    ? ((p = (0, q.jsx)(H.Item, { RightIcon: u, onSelect: d, children: f })),
      (t[8] = u),
      (t[9] = d),
      (t[10] = p))
    : (p = t[10]);
...
function gi({ intl: e, roots: t, skillEntries: n }) {
  let r = new Map();
  for (let i of n) {
    let n = Et({ skill: i.skill, roots: t, intl: e }),
      a = r.get(n);
    if (a == null) {
      r.set(n, { id: `skills-installed-${_i(n)}`, title: n, skillEntries: [i] });
      continue;
    }
...
function yi(e) {
  ...
  let x = b,
    C;
  t[31] === x ? (C = t[32]) : ((C = x.filter(bi)), (t[31] = x), (t[32] = C));
  let w;
  return (
      ...
      ? ((e = (e) =>
          (0, q.jsx)(
            Me,
            {
              className: `group justify-center border-none`,
              actionsPlacement: `center`,
              icon: (0, q.jsx)(Fe, { className: `icon-sm text-token-text-secondary` }),
              title: e.name,
              actions: (0, q.jsxs)(Dn, {
                children: [
                  (0, q.jsx)(N, {
                    ...
                    children: (0, q.jsx)(A, {
                      ...
                      children: (0, q.jsx)(Ne, { className: `icon-sm` }),
                    }),
                  }),
                  (0, q.jsx)(N, {
...
function wi({ mcpServers: e, query: t }) {
  return Object.entries(e)
    .map(([e, t]) => ({ key: e, name: Ti(t.name?.trim() || e), enabled: t.enabled !== !1 }))
...
export { rr as a, nr as i, Mr as n, Ln as o, dr as r, Rn as s, oi as t };
