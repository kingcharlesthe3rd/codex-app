...
import { n as Gr, t as Kr } from "./use-media-query-CuqG-XpQ.js";
import {
  $ as qr,
  A as U,
  B as Jr,
...
import { n as pa, t as ma } from "./esm-2.js";
                      ...
                      (0, W.jsxs)(`label`, {
                        ...
                        children: [
                          ...
                          (0, W.jsx)(`textarea`, {
                            ...
                            className: It(Oa, `min-h-20 resize-y`),
                            disabled: n,
                            onBlur: e.handleBlur,
                            onChange: (t) => {
                              e.handleChange(t.target.value);
...
function Pa(e) {
  let t = (0, Ia.c)(5),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = It(r, Ma.container)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
...
function Fa(e) {
  let t = (0, Ia.c)(7),
    ...
    u;
  t[0] !== r || t[1] !== c || t[2] !== l
    ? ((u = It(`grid`, c, l, r)), (t[0] = r), (t[1] = c), (t[2] = l), (t[3] = u))
    : (u = t[3]);
  let d;
  return (
    t[4] !== n || t[5] !== u
...
function Ba({
  ...
  if (a)
    return (0, G.jsx)(`div`, {
      ...
      children: (0, G.jsx)(`span`, {
        ...
        children: (0, G.jsx)(x, { ...K.pageLoading }),
      }),
    });
  if (r)
    return (0, G.jsx)(`div`, {
      ...
      children: (0, G.jsx)(wn, {
        title: (0, G.jsx)(x, { ...K.loadErrorTitle }),
        description: r,
  ...
  if (v.length === 0)
    return (0, G.jsx)(`div`, {
      ...
      children: _
        ? (0, G.jsx)(`div`, { className: `text-sm text-token-text-secondary`, children: y })
        : (0, G.jsx)(wn, { title: y, description: n }),
    });
  let P = v.map((n, r) =>
    (0, G.jsxs)(
      Za.Fragment,
      {
        children: [
          (0, G.jsx)(Va, {
            ...
            installProgressPercent: Xn(l, m, n.plugin.id),
            installPhase: Zn(l, m, n.plugin.id),
            isInstallLocked: l != null,
            isUpdatingEnabled: O === n.plugin.id,
            isUninstalling: k === n.plugin.id,
            reducedMotion: g,
            cardClassName: f ? `!rounded-none !border-0` : e,
            copyLinkUrl: p?.(n) ?? null,
            ...
            isUnavailableInCurrentContext: A?.has(n.plugin.id),
  ...
  return (0, G.jsxs)(G.Fragment, {
    children: [
      f
        ...
        : (0, G.jsx)(Fa, { gap: h, isSingleColumn: u, children: P }),
      j != null && E != null
        ? (0, G.jsx)(ua, {
            isUninstalling: k === j.plugin.id,
            open: !0,
            pluginDisplayName: d(j),
            onOpenChange: (e) => {
              e || M(null);
            },
            onConfirm: async () => {
              try {
                await E({
                  ...
                  pluginDisplayName: d(j),
                  pluginId: j.plugin.id,
                  pluginName: j.plugin.name,
                  requestPluginId: at(j),
                });
              } finally {
                M(null);
              }
...
function Va(e) {
  let t = (0, Xa.c)(162),
    ...
    M = (0, Za.useRef)(!1),
    N;
  t[0] === C ? (N = t[1]) : ((N = d(C)), (t[0] = C), (t[1] = N));
  let P = N,
    ee = u != null,
    te;
  t[2] !== s || t[3] !== ee || t[4] !== S || t[5] !== C
    ? ((te = ee
        ? `install`
        : Ja({ installedStateAction: s, plugin: C, onToggleInstalledPluginEnabled: S })),
      (t[2] = s),
      (t[3] = ee),
      (t[4] = S),
      (t[5] = C),
    ...
    : (te = t[6]);
  let F = te,
    I = C.plugin.source.type === `remote`,
    ne;
  t[7] !== a || t[8] !== C.marketplacePath || t[9] !== C.plugin.source
    ? ((ne = jr(a, C.marketplacePath, C.plugin.source)),
      (t[7] = a),
  ...
  let L = ne,
    re = v != null && L != null,
    ie = i != null || (g != null && L != null),
    ae = C.plugin.installed && !C.plugin.enabled,
    oe = c == null && !C.plugin.installed,
    se;
  t[11] === C.plugin.name
    ? (se = t[12])
    : ((se = Hn(C.plugin.name)), (t[11] = C.plugin.name), (t[12] = se));
  let le = se != null,
    de = !C.plugin.installed && (c != null || (le && !I)),
    fe;
  t[13] !== o || t[14] !== C || t[15] !== de
    ? ((fe = de
        ? { hostId: o, ...Mt(C), pluginSummary: C.plugin }
      ...
      (t[16] = fe))
    : (fe = t[16]);
  let { blockedReason: pe, isLoading: me } = Fn(fe),
    he;
  t[17] !== pe || t[18] !== C.plugin
    ? ((he = ar(C.plugin) ? `disabled-by-admin` : pe),
      (t[17] = pe),
      (t[18] = C.plugin),
      (t[19] = he))
    : (he = t[19]);
  let ge = he,
    z = ge === `disabled-by-admin`,
    ye,
    be,
    xe,
    Se,
  ...
  if (
    ...
    ((we = Gn(C.plugin.name, le ? ge : null)), (Te = oe && z), (Ce = f || z || me));
    let e;
    if (
      (t[63] === c
        ? (e = t[64])
        : ((e = c ?? (0, G.jsx)(x, { ...K.installTooltip })), (t[63] = c), (t[64] = e)),
      (xe = e),
      ee)
    ) {
      let e;
      (t[65] === l
        ...
        : ((e =
            l === `installing`
              ? (0, G.jsx)(x, { ...K.installing })
              : (0, G.jsx)(x, { ...K.installLoading })),
          (t[65] = l),
          (t[66] = e)),
        (xe = e));
    } else if (z) {
      ...
      (t[67] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, G.jsx)(x, { ...K.disabledByAdmin })), (t[67] = e))
        : (e = t[67]),
        (xe = e));
    } else if (f) {
      let e;
      (t[68] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, G.jsx)(x, { ...K.installLoading })), (t[68] = e))
        : (e = t[68]),
        (xe = e));
    }
    let i;
    ...
    (t[77] === d
      ...
      (be = p));
    let m = v == null ? a : null;
    B = (O != null && !z) || re || ie || y != null;
    let g = ee ? `disabled:opacity-100` : void 0,
      b = ee ? `ghost` : `outline`,
      S;
    t[79] !== D || t[80] !== C
      ? ((S = (e) => {
      ...
      : (S = t[81]);
    let T;
    t[82] !== c || t[83] !== l || t[84] !== u || t[85] !== ee || t[86] !== h
      ? ((T = ee
          ? (0, G.jsxs)(G.Fragment, {
              children: [
                (0, G.jsx)(Sn, {
      ...
      : (T = t[87]);
    let E;
    (t[88] !== Ce || t[89] !== g || t[90] !== b || t[91] !== S || t[92] !== T
      ? ((E = (0, G.jsx)(V, {
          className: g,
          color: b,
          disabled: Ce,
    ...
    t[94] === A
      ? (Ne = t[95])
      : ((Ne = It(`group !cursor-interaction justify-center`, A)), (t[94] = A), (t[95] = Ne));
    let j = (ae || k || z) && `opacity-60`;
    (t[96] !== r || t[97] !== j
      ? ((Pe = It(r, j)), (t[96] = r), (t[97] = j), (t[98] = Pe))
      : (Pe = t[98]),
      (Ee = `center`),
      (De = !1));
    let M = _ ? `!cursor-interaction` : null,
      N;
    t[99] === M
      ? (N = t[100])
      : ((N = It(
    ...
    t[101] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((te = (0, G.jsx)(Yt, { className: `icon-md text-token-text-secondary` })), (t[101] = te))
      : (te = t[101]);
    let F;
    t[102] !== C.plugin.name || t[103] !== P
      ? ((F = (0, G.jsx)(rn, { alt: P, knownAppId: C.plugin.name, fallback: te })),
        (t[102] = C.plugin.name),
        (t[103] = P),
        (t[104] = F))
      : (F = t[104]);
    let I;
    (t[105] !== C.logoDarkPath || t[106] !== C.logoPath || t[107] !== P || t[108] !== F
      ? ((I = (0, G.jsx)(rn, {
          alt: P,
      ...
      : (I = t[109]),
      t[110] !== N || t[111] !== I
        ? ((Oe = (0, G.jsx)(`span`, { className: N, children: I })),
          (t[110] = N),
          (t[111] = I),
          (t[112] = Oe))
        : (Oe = t[112]),
      (ke = P),
      t[113] !== m || t[114] !== C.description
        ? ((Ae =
            C.description == null && m == null
              ? void 0
              : (0, G.jsxs)(G.Fragment, {
                  children: [
                    C.description == null
                      ? null
                      : (0, G.jsx)(`div`, { className: `line-clamp-1`, children: C.description }),
                    m == null
                      ? null
                      : (0, G.jsx)(`div`, {
                          className: `text-xs text-token-description-foreground`,
                          children: (0, G.jsx)(x, { ...K.sharedBy, values: { name: m } }),
                        }),
                  ],
                })),
          (t[113] = m),
          ...
          (t[115] = Ae))
        : (Ae = t[115]),
      (je = `flex flex-col gap-0.5 !text-token-description-foreground`),
      (Me = Ya(C, k, w, we)),
      (t[20] = ie),
      (t[21] = le),
      (t[22] = oe),
    ...
    ((ye = t[46]),
      ...
      (Pe = t[62]));
  let Fe;
  t[116] !== D || t[117] !== _ || t[118] !== C || t[119] !== we
    ? ((Fe = _
        ? () => {
            if (M.current) {
              M.current = !1;
        ...
        F === `toggle`
          ? (0, G.jsxs)(`div`, {
              ...
              children: [
                        ...
                        children: [
                          O != null && !z
                            ? (0, G.jsx)(nn.Item, {
                                ...
                                children: (0, G.jsx)(x, { ...K.tryItNowMenuItem }),
                              })
                            : null,
                          re && v != null
                            ? (0, G.jsx)(nn.Item, {
                          ...
                          re
                            ? (0, G.jsx)(nn.Item, {
                                ...
                                leftIconClassName: `icon-xs`,
                                onSelect: () => {
                                  Dt({ path: L, cwd: null, openFile: j.mutate });
                                },
                                children: (0, G.jsx)(x, {
                ...
                (0, G.jsx)(Vt, {
                  tooltipContent: z
                    ? (0, G.jsx)(x, { ...K.disabledByAdmin })
                    : C.plugin.enabled
                      ? (0, G.jsx)(x, { ...K.disableToggleTooltip })
                      : (0, G.jsx)(x, { ...K.enableToggleTooltip }),
                  children: (0, G.jsx)(Ke, {
                    checked: C.plugin.enabled,
                    disabled: z || p || m,
                    ariaLabel: A.formatMessage(K.toggleAria),
                    onClick: Ha,
                    onChange: (e) => {
          ...
          : F === `menu`
            ? (0, G.jsxs)(`div`, {
                ...
                children: [
                  be,
                  (0, G.jsx)(ia, {
                    disableMenuLabel: (0, G.jsx)(x, {
                      id: `plugins.card.disableMenuItem`,
                      defaultMessage: `Disable`,
                      description: `Menu item label for disabling a plugin from a plugin card`,
                    }),
                    enableButtonLabel: (0, G.jsx)(x, { ...K.enableButton }),
                    enabledStatusAriaLabel: A.formatMessage(K.enabledStatus),
                    isEnabled: C.plugin.enabled && !z,
                    isUninstalling: m,
                    isUpdating: p,
            ...
            : F === `status`
              ...
              : Te
                ? (0, G.jsx)(Vt, {
                    tooltipContent: (0, G.jsx)(x, { ...K.disabledInstallTooltip }),
                    children: (0, G.jsx)(`span`, {
                      role: `img`,
                      "aria-label": A.formatMessage(K.disabledInstallTooltip),
                      className: `flex h-7 w-7 shrink-0 items-center justify-center text-token-text-tertiary`,
                      children: (0, G.jsx)(ir, { className: `icon-sm` }),
                    }),
                  })
                : (0, G.jsx)(Ii, {
                    measurement: Se,
                    ...
                    children: (0, G.jsx)(Vt, {
                      ...
                      children: (0, G.jsx)(`div`, {
                        className: Ce ? `cursor-not-allowed` : `cursor-interaction`,
                        children: Se,
                      }),
                    }),
                  })),
      ...
      i.push(
        (0, G.jsx)(
          `span`,
          {
            ...
            children: (0, G.jsx)(x, { ...K.unavailableInCurrentContext }),
          },
          `${e.plugin.id}-unavailable`,
        ),
      ),
    r && i.push((0, G.jsx)(Pn, {}, `${e.plugin.id}-plugin-upsell`)),
    !n &&
    ...
    t[0] !== n || t[1] !== r || t[2] !== a || t[3] !== i
      ? ((o = async (e) => {
          let t = await va({
            ...
            onReloadError: eo,
            params: e,
            sendAddMarketplace: (e) => Me(`add-marketplace`, { hostId: r, ...e }),
          });
...
function eo(e) {
  T.error(`Failed to refresh plugins after adding marketplace`, {
    safe: {},
    sensitive: { error: e },
  });
}
...
function io(e) {
  ...
  let l;
  t[5] !== i || t[6] !== s
    ? ((l = (0, q.jsx)(V, { color: `outline`, disabled: i, onClick: s, children: c })),
      (t[5] = i),
      (t[6] = s),
      (t[7] = l))
    : (l = t[7]);
  ...
  return (
    t[8] !== n || t[9] !== l
      ? ((u = (0, q.jsx)(`div`, {
          className: `flex min-h-0 flex-1 items-center justify-center py-8`,
          children: (0, q.jsx)(wn, { title: o, description: n, actions: l }),
        })),
        (t[8] = n),
        (t[9] = l),
        (t[10] = u))
...
var lo,
  ...
  po = e(() => {
    (ct(),
      ...
      (uo = Ne(`has-opened-plugin-creator-prefill-v1`, !1)),
      (fo = Ne(`has-opened-skill-creator-prefill-v1`, !1)));
  }),
  mo,
  ho,
  go = e(() => {
...
function _o(e) {
  ...
  if (n) {
    ...
    let o;
    t[5] !== i || t[6] !== r
      ? ((o = (0, J.jsx)(V, { color: `outline`, disabled: i, onClick: r, children: a })),
        (t[5] = i),
        (t[6] = r),
        (t[7] = o))
      : (o = t[7]);
    ...
    return (
      t[8] !== n || t[9] !== o
        ? ((s = (0, J.jsx)(`div`, {
            className: `flex min-h-0 flex-1 items-center justify-center py-8`,
            children: (0, J.jsx)(wn, { title: e, description: n, actions: o }),
          })),
          (t[8] = n),
          (t[9] = o),
          (t[10] = s))
                      ...
                      children: [
                        ...
                        (0, J.jsx)(Vt, {
                          ...
                          children: (0, J.jsx)(V, {
                            ...
                            children: n ? null : (0, J.jsx)(ue, { className: `icon-sm` }),
                          }),
                        }),
                      ],
                    }),
...
function bo(e) {
  ...
  t[8] === u
    ? (f = t[9])
    : ((f = (0, J.jsx)(un, {
        children: (0, J.jsx)(p, { title: u, subtitle: d, subtitleSize: `sm` }),
      })),
      (t[8] = u),
      (t[9] = f));
  let m;
  ...
  let g;
  t[13] !== n || t[14] !== m
    ? ((g = (0, J.jsx)(V, { color: `secondary`, disabled: n, onClick: m, children: h })),
      (t[13] = n),
      (t[14] = m),
      (t[15] = g))
    : (g = t[15]);
  ...
  t[17] === n
    ? (v = t[18])
    : ((v = (0, J.jsx)(V, { color: `danger`, loading: n, type: `submit`, children: _ })),
      (t[17] = n),
      (t[18] = v));
  let y;
  t[19] !== v || t[20] !== g
    ? ((y = (0, J.jsx)(un, { children: (0, J.jsxs)(be, { children: [g, v] }) })),
      (t[19] = v),
      (t[20] = g),
      (t[21] = y))
    : (y = t[21]);
  ...
  t[22] !== y || t[23] !== l || t[24] !== f
    ? ((b = (0, J.jsxs)(fn, { as: `form`, onSubmit: l, children: [f, y] })),
      (t[22] = y),
      (t[23] = l),
      (t[24] = f),
      (t[25] = b))
  ...
  return (
    t[26] !== i || t[27] !== b || t[28] !== c
      ? ((S = (0, J.jsx)(Se, { open: c, onOpenChange: i, size: `compact`, children: b })),
        (t[26] = i),
        (t[27] = b),
        (t[28] = c),
        (t[29] = S))
...
function xo(e) {
  ...
  let _;
  t[22] !== r || t[23] !== h
    ? ((_ = (0, J.jsx)(V, { color: `outline`, disabled: r, onClick: h, children: g })),
      (t[22] = r),
      (t[23] = h),
      (t[24] = _))
    : (_ = t[24]);
...
var Co,
  J,
  wo = e(() => {
    ((Co = $e()), le(), Ge(), Kn(), I(), _(), yn(), Qe(), de(), go(), ha(), za(), $r(), (J = $t()));
  }),
  To,
  Eo,
  Do = e(() => {
...
function Oo(e) {
  ...
  if (e.mode === `manage`) {
    ...
    t[3] !== e.onCreatePlugin || t[4] !== i || t[5] !== a
      ? ((s = { ariaLabel: i, disabled: a, Icon: Yt, label: o, onSelect: e.onCreatePlugin }),
    ...
    t[10] !== e.onCreateSkill || t[11] !== c || t[12] !== l
      ? ((d = { ariaLabel: c, disabled: l, Icon: ne, label: u, onSelect: e.onCreateSkill }),
    ...
    t[36] === b
      ...
      : ((S = (0, Y.jsx)(xn, {
        ...
        (t[36] = b),
        (t[37] = S));
    let C = e.isRefreshingPage ? Ht : jn,
      w;
    t[38] === e
      ? (w = t[39])
      : ((w = (t) => {
    ...
    t[40] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (T = t[40]);
    let E;
    t[41] !== e.isRefreshDisabled || t[42] !== C || t[43] !== w
      ? ((E = (0, Y.jsx)(nn.Item, {
          LeftIcon: C,
  ...
  if (
    ...
    if (
      ...
      (t[72] !== e.onAddMarketplace || t[73] !== i
        ? ((o = { ariaLabel: i, disabled: !1, Icon: c, label: a, onSelect: e.onAddMarketplace }),
  ...
  t[94] !== e.onRefreshPage
    ? ((u = e.needsSkillsRefresh
        ? (0, Y.jsxs)(V, {
            ...
            children: [
              e.isRefreshingPage
                ? (0, Y.jsx)(Ht, { className: `icon-xs text-token-text-link-foreground` })
                : (0, Y.jsx)(`span`, {
  ...
  t[99] === e.isRefreshingPage
    ...
    : ((m = e.isRefreshingPage
        ? (0, Y.jsx)(Ht, { className: `icon-sm` })
        : (0, Y.jsx)(jn, { className: `icon-sm` })),
      (t[99] = e.isRefreshingPage),
      (t[100] = m));
  let h;
  ...
  t[106] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, Y.jsx)(te, { className: `icon-sm` })), (t[106] = g))
    : (g = t[106]);
  let _;
  ...
  let v;
  t[110] !== a || t[111] !== _
    ? ((v = (0, Y.jsx)(Vt, { tooltipContent: a, children: _ })),
      (t[110] = a),
      (t[111] = _),
      (t[112] = v))
    : (v = t[112]);
  let y;
  t[113] === r ? (y = t[114]) : ((y = (0, Y.jsx)(ko, { actions: r })), (t[113] = r), (t[114] = y));
  let b;
  t[115] !== e.hostSelector || t[116] !== v || t[117] !== y || t[118] !== u || t[119] !== h
    ? ((b = (0, Y.jsxs)(`div`, {
  ...
  let S;
  return (
    t[121] !== b || t[122] !== s || t[123] !== l
      ? ((S = (0, Y.jsxs)(`div`, { className: s, children: [l, b] })),
        (t[121] = b),
        (t[122] = s),
        (t[123] = l),
        (t[124] = S))
...
function ko(e) {
  ...
  if (n.length === 1) {
    let e;
    t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Y.jsx)(c, { className: `icon-xs` })), (t[1] = e))
      : (e = t[1]);
    let n;
    ...
    return (
      t[6] !== i.label || t[7] !== n
        ? ((r = (0, Y.jsx)(Vt, { tooltipContent: i.label, children: n })),
          (t[6] = i.label),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  let l = i.label,
    u;
  t[11] === n ? (u = t[12]) : ((u = n.map(Ao)), (t[11] = n), (t[12] = u));
  let d;
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Y.jsx)(c, { className: `icon-xs` })), (t[13] = d))
    : (d = t[13]);
  let f;
  return (
    t[14] !== i.ariaLabel ||
    ...
    bb0: {
      ...
      if (!w) {
        let r = e.flatMap(Fo),
          ...
          x;
        (t[49] !== T || t[50] !== _
          ? ((x = (0, X.jsxs)(`div`, { className: `flex min-h-0 flex-col`, children: [_, T] })),
            (t[49] = T),
            (t[50] = _),
            (t[51] = x))
          : (x = t[51]),
      ...
      t[67] !== l
        ...
        : (N = t[68]);
      let P = e.map(N);
      ((E = `flex flex-1 flex-col gap-8`),
        (D = M === -1 ? null : P.slice(0, M + 1)),
        (O = r),
        (k = M === -1 ? P : P.slice(M + 1)));
    }
    ((t[0] = n),
      ...
      (t[24] = k),
      (t[25] = A));
  } else ((T = t[20]), (E = t[21]), (D = t[22]), (O = t[23]), (k = t[24]), (A = t[25]));
  if (A !== Symbol.for(`react.early_return_sentinel`)) return A;
  let j;
  return (
    t[69] !== T || t[70] !== E || t[71] !== D || t[72] !== O || t[73] !== k
      ? ((j = (0, X.jsxs)(`div`, { className: E, children: [D, O, k, T] })),
        (t[69] = T),
        (t[70] = E),
        (t[71] = D),
        (t[72] = O),
...
function Lo(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, X.jsx)(te, { className: `icon-sm` })), (t[3] = u))
    : (u = t[3]);
  let d;
  t[4] !== c || t[5] !== i
    ? ((d = (0, X.jsx)(V, {
  ...
  t[7] !== c || t[8] !== d
    ? ((f = (0, X.jsxs)(`div`, {
        ...
        children: [l, (0, X.jsx)(Vt, { tooltipContent: c, children: d })],
      })),
      (t[7] = c),
      (t[8] = d),
      (t[9] = f))
    ...
    children: [
      ...
      (0, X.jsx)(`span`, {
        children: (0, X.jsx)(x, {
          ...
          values: {
            pluginNames: t.slice(0, 2).map(d).join(`, `),
...
function Bo(e) {
  return (0, X.jsx)(
    rn,
    {
      ...
      logoUrl: e.logoPath,
      fallback: (0, X.jsx)(Yt, { className: `text-token-text-secondary` }),
    },
    e.plugin.id,
  );
}
function Vo(e) {
  return e.logoPath != null || e.logoDarkPath != null || Rt(e.plugin.name) != null;
}
function Ho(e) {
  let t = (0, Ko.c)(22),
  ...
  if (t[0] !== o || t[1] !== c || t[2] !== a || t[3] !== r || t[4] !== i || t[5] !== n) {
    ...
    (t[11] !== _ || t[12] !== i
      ...
      (t[9] = p),
      (t[10] = m));
  } else ((l = t[6]), (u = t[7]), (f = t[8]), (p = t[9]), (m = t[10]));
  let h;
  t[14] !== l || t[15] !== u || t[16] !== f || t[17] !== p
    ? ((h = (0, X.jsxs)(`div`, { ref: l, className: u, children: [f, p] })),
      (t[14] = l),
      (t[15] = u),
      (t[16] = f),
      (t[17] = p),
...
function Wo(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, X.jsx)(`span`, {
        ...
        children: (0, X.jsx)(Yt, { className: `size-1/2 text-token-text-secondary` }),
      })),
      (t[0] = r))
    : (r = t[0]);
  let i;
...
function Xo(e) {
  ...
  let m = p,
    h;
  t[3] === n.name ? (h = t[4]) : ((h = ke(n.name)), (t[3] = n.name), (t[4] = h));
  let g = h,
  ...
  t[9] !== d || t[10] !== b || t[11] !== o || t[12] !== s || t[13] !== l || t[14] !== n
    ? ((S = o
        ...
        : (0, ns.jsx)(Vt, {
            tooltipContent: (0, ns.jsx)(x, { ...rs.installSkill }),
            children: (0, ns.jsx)(V, {
              ...
              children: (0, ns.jsx)(x, { ...rs.installSkill }),
            }),
          })),
      (t[9] = d),
      (t[10] = b),
  ...
  t[16] === g
    ? (w = t[17])
    : ((w = (0, ns.jsx)(ki, { kind: `Skill`, title: g })), (t[16] = g), (t[17] = w));
  let T;
...
function Zo(e) {
  ...
  t[3] === s
    ? (u = t[4])
    : ((u = s ? null : (0, ns.jsx)(c, { className: `icon-xs` })), (t[3] = s), (t[4] = u));
  let d;
  t[5] === i
    ? (d = t[6])
    : ((d = i
        ? (0, ns.jsx)(x, { ...rs.installed })
        : (0, ns.jsx)(x, {
  ...
  let f;
  return (
    t[7] !== r || t[8] !== s || t[9] !== l || t[10] !== u || t[11] !== d
      ? ((f = (0, ns.jsx)(`div`, {
          className: `flex w-full justify-end`,
          children: (0, ns.jsxs)(V, {
            color: `primary`,
            size: `toolbar`,
            disabled: s,
            loading: r,
...
function as(e) {
  let t = (0, ys.c)(83),
    {
      ...
      roots: S,
      selectedSectionId: C,
      searchResultsTitle: w,
      installedSection: T,
      recommendedSection: E,
    } = e,
    D = i === void 0 ? `check` : i,
    O = R(),
    k;
  ...
  let A = k,
    j = T != null && (a.length > 0 || o.length > 0),
    M = E != null && A.length > 0;
  if (!p && !m && r == null && !j && !M) {
    let e;
    return (
  ...
  if (w != null) {
    ...
    let c;
    return (
      t[31] !== w || t[32] !== e || t[33] !== s
        ? ((c = (0, Z.jsx)(wr, { count: e, id: `skills-search-results`, title: w, children: s })),
          (t[31] = w),
          (t[32] = e),
          (t[33] = s),
          (t[34] = c))
  ...
  let N;
  t[35] !== a || t[36] !== E
    ? ((N = vs(a, E)), (t[35] = a), (t[36] = E), (t[37] = N))
    : (N = t[37]);
  let P = N,
    ee;
  if (t[38] !== a || t[39] !== C) {
    let e;
    (t[41] === C ? (e = t[42]) : ((e = (e) => e.id === C), (t[41] = C), (t[42] = e)),
      (ee = a.find(e)),
      (t[38] = a),
      (t[39] = C),
      (t[40] = ee));
...
function us(e) {
  ...
  t[4] !== r || t[5] !== c || t[6] !== o || t[7] !== s
    ? ((d = r === `toggle` ? Jt({ skill: s, roots: o, intl: c }) : void 0),
      (t[4] = r),
      (t[5] = c),
      (t[6] = o),
      (t[7] = s),
  ...
  let m = r !== `toggle`,
    h;
  t[11] === s ? (h = t[12]) : ((h = pt(s)), (t[11] = s), (t[12] = h));
  let g;
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(`span`, {
          ...
          children: (0, Z.jsx)(ne, { className: `icon-sm` }),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
  ...
  if (i) {
    ...
    return (
      t[2] === i
        ...
        : ((n = (0, Z.jsx)(`div`, {
            className: `flex min-h-0 flex-1 items-center justify-center py-8`,
            children: (0, Z.jsx)(wn, { title: e, description: i }),
          })),
          (t[2] = i),
          (t[3] = n)),
      n
...
function xs({ directoryEntrypoint: e } = {}) {
  let t = Ae(y),
    ...
    r = Gr(Ws),
    o = L(),
    s = Oi({ explicitEntrypoint: e, locationKey: o.key, locationState: o.state }),
    c = hn(),
    l = xi(o.state),
    f = P(Ys, o.key),
    p = t.get(f),
    ...
    _ = (0, Q.useRef)(null),
    v = (0, Q.useRef)(null),
    b = (0, Q.useRef)(p?.browseScrollTop ?? null),
    S = Re(on) ?? [],
    C = Mn(S),
    [w, T] = (0, Q.useState)(p?.selectedHostIdState ?? l.initialHostId ?? `local`),
    E = w === `local` || C.some((e) => e.hostId === w) ? w : F,
    D = kt({ hostId: E }),
    O = S.map((e) => e.hostId),
    [k, A] = (0, Q.useState)(() =>
      p == null
    ...
    [j, M] = (0, Q.useState)(() => l.connectAppId ?? null),
    [N, te] = (0, Q.useState)(p?.searchQuery ?? ``),
    [I, ne] = (0, Q.useState)(0),
    [ie, oe] = (0, Q.useState)(l.initialSearchQuery ?? ``),
    [ce, le] = (0, Q.useState)(!1),
    [ue, de] = (0, Q.useState)(!1),
    [fe, pe] = (0, Q.useState)(`idle`),
    [z, ve] = (0, Q.useState)(0),
    [ye, be] = (0, Q.useState)(null),
    [Se, Te] = (0, Q.useState)(null),
    [B, Ee] = (0, Q.useState)(p?.selectedPluginDirectoryTab ?? `openai`),
    [De, ke] = (0, Q.useState)(null),
    [je, Me] = (0, Q.useState)(null),
    [Ne, Fe] = (0, Q.useState)(null),
    [Ie, Le] = (0, Q.useState)(!1),
    ze = Pt(E),
    { data: Be, isLoading: Ve } = Or(E),
    He = Be?.homeDirectory,
    Ge = u(uo),
    Ke = we(uo),
    qe = u(fo),
    ...
    {
      canInstallRecommendedSkills: ct,
      defaultRecommendedRepoRoot: ut,
      skillCreatorPath: dt,
    } = Jr(E),
    ft = ze == null ? null : `${ze}/skills/.system/plugin-creator/SKILL.md`,
    { errorMessage: pt, isLoading: ht, refresh: gt, repoRoot: _t, skills: vt } = ca(ut, E),
    yt = Xi({ recommendedSkills: ht || pt != null ? null : vt, skills: et }),
    {
      clearInstalledRecommendedSkills: V,
      installRecommendedSkill: bt,
      installedRecommendedSkillIds: xt,
      installingSkillId: St,
    } = ri({
      forceReloadSkills: Qe,
      hostId: E,
      onInstalled: () => {
    ...
    {
      errorMessage: Ct,
      featuredPluginIds: Tt,
      isLoading: Et,
      isFetching: Dt,
      marketplaceLoadErrors: At,
      marketplaces: jt,
      availablePlugins: Nt,
      installedPlugins: Lt,
      forceReload: Rt,
    ...
    { value: Vt } = re(`2817990312`),
    Ht = B === `openai` ? Js.parse(Vt).category_ids : [],
    Ut = ge(`1269116100`),
    Wt = ge(`4218407052`),
    { config: Gt } = Qr(),
    { mutateAsync: Kt } = ra({ hostId: E }),
    { mutateAsync: qt } = sa({ hostId: E }),
    { data: Jt, isLoading: Yt } = Ye({ enabled: Ut, hostId: E, marketplaceKind: `shared-with-me` }),
    { data: Xt, isLoading: Zt } = Ye({
      enabled: Ut,
      hostId: E,
      marketplaceKind: `workspace-directory`,
    }),
    { data: $t, isLoading: tn } = Ye({
      enabled: Wt,
      hostId: E,
      marketplaceKind: `created-by-me-remote`,
    }),
    nn = $a({ forceReloadPlugins: Rt, hostId: E }),
    { data: rn } = Bt(st[0] ?? null, { hostId: E, useActiveWorkspaceRoot: !1 }),
    {
      data: an,
      hardRefetchAppsList: ln,
      isHardRefetchingAppsList: un,
      isLoading: dn,
      loadError: fn,
    } = Oe({ hostId: E }),
    gn = fn?.message ?? null,
    {
      closePluginInstall: _n,
      connectRequiredApp: vn,
      handleRequiredAppConnected: yn,
      handleRequiredAppOAuthStarted: bn,
      installPlugin: xn,
      isInstalling: Sn,
      openPluginInstall: Cn,
      openPluginInstallDetails: wn,
      session: Tn,
    } = er({ forceReloadPlugins: Rt, hostId: E }),
    En = Tn.kind === `installing` ? Tn : null,
    { pendingPluginId: Dn, setPluginEnabled: On } = mn({ hostId: E }),
    { pendingUninstallPluginId: kn, uninstallPlugin: An } = sn({ hostId: E }),
    { pendingRemoveMarketplaceName: jn, removeMarketplace: Nn } = Ue({ hostId: E }),
    {
      isUpgradingMarketplaces: Pn,
      pendingUpgradeMarketplaceName: Fn,
      upgradeMarketplaces: Ln,
    } = Xe({ hostId: E }),
    { data: Bn } = Pe(en, E),
    {
      clearConnectingApp: Vn,
      connectingApp: Hn,
      handleAppConnectOAuthStarted: Un,
      handleConnectApp: Gn,
      handleOpenAppUrl: Kn,
      isAppConnectPending: qn,
    } = ae({ hostId: E }),
    { setAppEnabled: Jn, updatingAppId: Yn } = Mr({ hostId: E }),
    Xn = Se == null ? null : (an?.find((e) => e.id === Se) ?? null),
    Zn = Ce(Se),
    Qn = Ze({ hostId: E }),
    $n = pi(Bn?.config),
    tr = ei(Bn?.config),
    nr = Pn || Fn != null,
    rr = !jt.some((e) => Ji(e, $n)) || nr || jn != null,
    ir = j == null ? null : (an?.find((e) => e.id === j) ?? null),
    or = j != null && qn(j),
    ur = Hn ?? ir,
    { authMethod: fr } = mt(),
    { data: pr } = cn(),
    ...
    hr = k.kind === `manage`,
    gr = k.tab,
    H = k.kind === `browse` ? k.tab : null,
    yr = E === `local` ? [`claude-cowork`] : [],
    br = D && H === `plugins` && yr.length > 0,
    xr = wt(`external-agent-imported-connectors`, {
      params: { hostId: F, providers: yr },
      queryConfig: { enabled: br },
    }),
    Sr = mr || zr(Nt),
    Cr = Pr(Nt),
    Tr = Ir(Nt),
    Er = Jt == null ? null : Ir(Jt).filter((e) => e.remoteMarketplaceName === Gs),
    Dr = Fr({ installedPlugins: Lt, sharedWithYouPlugins: Jt ?? [], workspacePlugins: Xt ?? [] }),
    kr = Xt == null ? null : Ir(Xt),
    Ar =
      (E === `local` && pr?.structure?.toLowerCase() === `workspace` ? pr.name?.trim() : null) ||
      Xt?.find((e) => !!e.marketplaceDisplayName?.trim())?.marketplaceDisplayName?.trim() ||
      null,
    Nr = Gi(n, `skills`),
    Vr = Gi(n, H ?? `plugins`),
    Ur = N.trim().toLowerCase(),
    Kr = ie.trim().toLowerCase(),
    U = Ur.length > 0,
    Yr = ci({ skills: ot, query: Ur }),
    Xr = Di({ skills: vt, query: Ur }),
    Zr = Ui(Xr),
    $r = Fi({ installedRecommendedSkillIds: xt, installedSkillMatchKeys: $e, skills: U ? Xr : Zr }),
    ti = $i({ installedSkills: Yr, recommendedSkills: $r }),
    { data: ni } = yi({ enabled: Ut, hostId: E }),
    {
      ...
      availablePlugins: Nt,
      createdByMeRemotePlugins: $t ?? null,
      homeDirectory: He,
      pluginShares: Ut ? (ni ?? null) : null,
    ...
    Si = As({ intl: n, roots: st, skillEntries: ti }),
    wi = Ut && U && H === `plugins`,
    Ei = H === `skills` || wi ? null : De,
    ki = U ? [] : Dr,
    ji;
  if (wi)
    ji = Wr({
    ...
    switch (B) {
      ...
      case `workspace`:
        ...
        break;
      case `personal`: {
        let e = Tr.filter((e) => !Lr(e) && (ii == null || tt(e) !== ii));
        ji = [
  ...
  let Mi =
      mr && H === `plugins` && !U && Ei == null && B === `openai`
        ? (0, $.jsx)(x, {
    ...
    Li = Ii?.id ?? null,
    Hi = cr({
      apps: lr({ apps: an ?? [], connectors: br ? (xr.data?.connectors ?? []) : [] }),
      plugins: fi,
    ...
    Qi = U
      ...
      : [],
    ea = Qi.length,
    ta = Qi.length === 0 ? null : Math.min(I, Qi.length - 1),
    na = ta == null ? null : (Qi[ta] ?? null),
    ia = Hr({ plugins: Dr, query: Kr }),
    aa = new Set([...Nt, ...(Jt ?? []), ...(Xt ?? [])].map((e) => e.plugin.id)),
    oa = new Set(Dr.filter((e) => !aa.has(e.plugin.id)).map((e) => e.plugin.id)),
    la = ci({ skills: yt, query: Kr }),
    { installedApps: ua } = gi(an ?? []),
    da = _i({ apps: ua, query: Kr }),
    fa = Rs({ mcpServers: rn?.servers ?? {}, query: Kr }),
    pa = qr({ configuredMarketplaceNames: tr, marketplaces: jt, query: `` }),
    ma = {
      apps: ua.length,
      marketplace: pa.length,
      mcps: Object.keys(rn?.servers ?? {}).length,
      plugins: Dr.length,
      skills: yt.length,
    },
    ha = hr && ma[gr] === 0 ? (Fs(ma) ?? gr) : gr,
    ga = hr ? ha === `plugins` : H === `plugins`,
    _a = Ki({ categoryKey: Li, directoryTab: B, isGlobalSearch: wi, searchQuery: Ur }),
    va = Ti({ canonicalCategoryIds: Ht, directoryTab: B, selectedCategoryTitle: Ii?.title }),
  ...
  let xa = Gi(n, ha),
    Sa = qr({ configuredMarketplaceNames: tr, marketplaces: pa, query: Kr }),
    Ca = Qn.isPending ? (Qn.variables?.key ?? null) : null,
    wa = !hr && H === `skills` && ce,
    Ta = wa || rt || Si.length > 0 || ti.length > 0,
    Ea = wa || ht || pt != null || $r.length > 0,
    W = Nr.sections.at(-1) ?? null,
    Da = [...Si.map((e) => ({ id: e.id, title: e.title })), ...(Ea && W != null ? [W] : [])],
    Oa = Da.some((e) => e.id === je) ? je : (Da[0]?.id ?? null),
    ka = (0, Q.useEffectEvent)(async () => {
      let { availablePlugins: e } = await zt();
      return mr || zr(e);
    }),
    ...
    Na = (e) =>
      ai({
        ...
        isOpenAICuratedRemoteMarketplaceEnabled: Wt,
      }),
    Fa = (e) => {
      t.get(Qt).danger(
        n.formatMessage({
        ...
        e == null ? void 0 : { description: We(e) },
      );
    },
    Ia = async (e) => {
      let t = jr(He, e.marketplacePath, e.plugin.source);
      try {
        let n = await Vi({ hostId: E, ...Mt(e) }).catch(() => null),
    ...
    La = async (e) => {
      let r = jr(He, e.marketplacePath, e.plugin.source);
      if (r == null) return;
      let i = await Vi({ hostId: E, ...Mt(e) }).catch(() => null),
      ...
      let s = bi({
        ...
        saveShare: (e) => Ci({ pluginPath: r, remotePluginId: e, savePluginShare: Kt }),
      });
      Ot(t, Ri, {
        initialSharePrincipals: s.getCurrentShare()?.sharePrincipals ?? [],
        pluginDisplayName: d(e),
        ...
        onCopyLink: async () => {
          try {
            ...
            if ((e || Rt(), t.shareUrl.length > 0 && (await _e(t.shareUrl)))) return !0;
          } catch (e) {
            return (Fa(e), !1);
          }
          return (Fa(), !1);
        ...
        onSaveShareTargets: async (e) => {
          try {
            let t = await s.saveShareTargets(e, (e, t) => qt({ remotePluginId: e, targets: t }));
            return (Rt(), t);
          } catch (e) {
            throw (
              t
        ...
        onUpdateSharedVersion: async () => {
          if (o?.remotePluginId != null)
            try {
              (await Kt({ pluginPath: r, remotePluginId: o.remotePluginId }),
                Rt(),
                t
                  .get(Qt)
                  .success(
    ...
    za =
      Et ||
      (Ut && Ve) ||
      (Ut && hr && ha === `plugins` && (Yt || Zt)) ||
      fe === `loading` ||
      (U
        ? tn || Yt || Zt
        : H === `plugins` && ((B === `workspace` && Zt) || (B === `personal` && (tn || Yt)))),
    Va = H === `plugins` && (!U || ea > 0),
    Ha = !wi,
    Ua = ce || nr || un || rt || nt || Et || Dt,
    Wa =
      C.length > 0
        ? (0, $.jsx)(Cs, {
    ...
    Ga = () => {
      if (ft == null) return;
      se(t, Ft, {});
      let e = co({ creatorPath: ft, isFirstOpen: !Ge, kind: `plugin` });
      (Ge || Ke(!0), h({ prefillPrompt: e, startInSidebar: !0 }));
    };
  (0, Q.useEffect)(() => {
    if (!Ra) {
      pe(`idle`);
  ...
  let Ka = () => {
      if (dt == null) return;
      se(t, Ft, {});
      let e = co({ creatorPath: dt, isFirstOpen: !qe, kind: `skill` });
      (qe || Je(!0), h({ prefillPrompt: e, startInSidebar: !0 }));
    },
    qa = async () => {
      if (Cr == null || ar(Cr.plugin)) return;
      let e = Rn({
        defaultPrompt: zn(Cr.plugin.interface?.defaultPrompt),
        pluginDisplayName: d(Cr),
      ...
      if (!Cr.plugin.enabled)
        try {
          await On({ enabled: !0, pluginDisplayName: d(Cr), pluginId: Cr.plugin.id });
        } catch {
          return;
        }
      h({ prefillPrompt: e, startInSidebar: !0 });
    },
    Ja = st[0] != null && st[0] !== `/` ? st[0] : void 0,
    Ya = (e, t = zn(e.plugin.interface?.defaultPrompt)) => {
      h({
        prefillPrompt: Rn({ defaultPrompt: t, pluginDisplayName: d(e), pluginId: e.plugin.id }),
        prefillCwd: Ja,
        startInSidebar: !0,
      });
    },
    Xa = async () => {
      le(!0);
      try {
        (at(), await Promise.all([Rt(), gt(), ln()]), V(), de(!1));
      } catch {
        t.get(Qt).danger(
          n.formatMessage({
    ...
    q = (0, Q.useCallback)((e) => {
      v.current = e;
      let t = b.current;
      e == null || t == null || ((e.scrollTop = t), (b.current = null));
    }, []),
    so = (e, n) => {
      (hr ||
        t.set(f, {
          ...
          selectedPluginDirectoryTab: B,
        }),
        c(he(e, { hostId: E, source: hr ? `manage` : void 0 }), { state: hr ? void 0 : ee(n) }));
    },
    lo = (e) => {
    ...
    mo = async (e, t) => {
      await Qn.mutateAsync({ key: e, enabled: t });
    },
    ho = async (e) => {
      try {
        (await Nn({ marketplaceDisplayName: mi(e), marketplaceName: e.name }), Fe(null));
      } catch {}
    },
    go = async () => {
      try {
    ...
    vo = async (e) => {
      try {
        await Ln({ marketplaceDisplayName: mi(e), marketplaceName: e.name });
      } catch {}
    };
  (0, Q.useEffect)(() => {
    let e = (e) => {
              ...
              ? (0, $.jsx)(wr, {
                  ...
                  children: (0, $.jsx)(Ba, {
                    ...
                    onInstallPlugin: async (e) => {
                      (M(null), await Gn(e.importedConnectorApp));
                    },
          ...
          ? (0, $.jsx)(Oo, {
              ...
              recordSkillAction:
                Cr == null
                  ? void 0
                  : {
                      disabled: Sn || Dn === Cr.plugin.id || ar(Cr.plugin),
                      onSelect: () => {
                        qa();
                      },
                    },
        ...
        children: [
          D
            ? (0, $.jsx)($.Fragment, {
                children: (0, $.jsxs)(`div`, {
                  ...
                  children: [
                    (0, $.jsx)(Pa, {
                      className: It(`flex h-full w-full flex-1 flex-col`, hr ? `gap-0` : `gap-8`),
                      children: hr
                        ? (0, $.jsx)(`div`, {
                                    ...
                                    children: (0, $.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, $.jsx)(Ns, {
                                          ...
                                          mcpsCount: Object.keys(rn?.servers ?? {}).length,
                                  ...
                                  children:
                                    ha === `plugins`
                                      ? (0, $.jsx)(Ba, {
                                          ...
                                          onShareInstalledPlugin: Ut
                                            ? (e) => {
                                                La(e);
                                              }
                                            : void 0,
                                          onTryInChat: Ut ? Ya : void 0,
                                          plugins: ia,
                                          unavailablePluginIds: oa,
                                          onInstallPlugin: async (e) => {
                                            Cn(e, { tryInChatCwd: Ja });
                                          },
                                          onUninstallInstalledPlugin: An,
                                          onToggleInstalledPluginEnabled: On,
                                          pendingPluginId: Dn,
                                          pendingUninstallPluginId: kn,
                                          reducedMotion: m,
                                          emptyStateTitle: (0, $.jsx)(x, {
                                            id: `skills.appsPage.empty.plugins`,
                                            defaultMessage: `No plugins found`,
                                        ...
                                        : ha === `mcps`
                                          ...
                                          : ha === `marketplace`
                                            ? (0, $.jsx)(_o, {
                                                ...
                                                isRetrying: ce || Dt,
                                                marketplaceLoadErrors: At,
                                                configuredMarketplaceNames: tr,
                                                configuredGitMarketplaceNames: $n,
                                                isUpgradingMarketplaces: Pn,
                                                marketplaces: Sa,
                                                onUpgradeMarketplace: (e) => {
                                                  vo(e);
                                                },
                                                onRemoveMarketplace: Fe,
                                                onRetry: Xa,
                                                pendingUpgradeMarketplaceName: Fn,
                                                pendingRemoveMarketplaceName: jn,
                                              })
                                            : an == null
                                              ? (0, $.jsx)(io, {
                                                  errorMessage: gn,
                        ...
                        : (0, $.jsx)(vr, {
                            ...
                            children: (0, $.jsxs)(`div`, {
                              className: It(`flex min-h-0 flex-col gap-8`, !U && `flex-1`),
                              children: [
                                Va
                                  ? (0, $.jsx)(No, {
                                ...
                                H === `skills` && (!U || ea > 0)
                                  ? (0, $.jsx)(as, {
                                      ...
                                      installingSkillId: St,
                                      isLoadingInstalledSkills: rt || wa,
                                      isLoadingRecommendedSkills: ht || wa,
                                      onInstallRecommendedSkill: bt,
                    ...
                    (0, $.jsx)(ba, { open: Ie, onAddMarketplace: nn, onOpenChange: Le }),
                    (0, $.jsx)(bo, {
                      marketplace: Ne,
                      isRemoving: Ne != null && jn === Ne.name,
                      onOpenChange: (e) => {
                        e || Fe(null);
                      },
                      onRemove: (e) => {
                    ...
                    (0, $.jsx)(a, {
                      ...
                      onConnected: async () => {
                        M(null);
                        try {
                          await In({ hostId: E, queryClient: g, refreshAppsList: ln });
                        } catch {}
                      },
                    }),
                    (0, $.jsx)(zi, {
                      app: Xn,
                      errorMessage: Zn.error?.message ?? null,
                      isLoading: Zn.isLoading,
                      onOpenChange: (e) => {
                        e || Te(null);
                      },
                      onOpenAppUrl: Kn,
                      ...
                      onTryInChat: (e) => {
                        h({
                          prefillPrompt: `[@${e.name}](${me(i(e.id))})`,
                          prefillCwd: st[0] != null && st[0] !== `/` ? st[0] : void 0,
                          startInSidebar: !0,
                        });
                      },
                      tools: Zn.data ?? [],
          ...
          ye == null && En == null
            ? (0, $.jsx)(Wn, {
                ...
                onInstall: xn,
                onRequiredAppConnected: yn,
                onRequiredAppOAuthStarted: bn,
                onTryInChat: Ya,
                onViewDetails: so,
                onOpenChange: (e) => {
                  e || _n();
...
function Cs(e) {
  ...
  t[5] !== i || t[6] !== u
    ? ((f =
        u == null
          ? (0, $.jsx)(Nn, { className: `icon-xs shrink-0 text-token-text-secondary` })
          : (0, $.jsx)(mr, {
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, $.jsx)(Nn, { className: `icon-xs shrink-0 text-token-text-secondary` })),
      (t[17] = y))
    : (y = t[17]);
  let b;
  t[18] === c
  ...
  t[20] !== b || t[21] !== _ || t[22] !== v
    ? ((S = (0, $.jsx)(nn.Item, { RightIcon: _, onSelect: v, children: b })),
      (t[20] = b),
      (t[21] = _),
      (t[22] = v),
      (t[23] = S))
    ...
    (t[29] !== r || t[30] !== i || t[31] !== a
      ? ((e = (e) =>
          (0, $.jsx)(
            nn.Item,
            {
              RightIcon: e.hostId === a ? Be : void 0,
              onSelect: () => {
                r(e.hostId);
              },
  ...
  t[33] === C
    ? (w = t[34])
    : ((w = (0, $.jsx)(nn.Section, { className: `max-h-40 overflow-y-auto`, children: C })),
      (t[33] = C),
      (t[34] = w));
  let T;
  return (
...
function Es(e) {
  ...
  let p;
  t[8] !== u || t[9] !== d
    ? ((p = (0, $.jsx)(nn.Item, { RightIcon: u, onSelect: d, children: f })),
      (t[8] = u),
      (t[9] = d),
      (t[10] = p))
    : (p = t[10]);
...
function As({ intl: e, roots: t, skillEntries: n }) {
  let r = new Map();
  for (let i of n) {
    let n = Jt({ skill: i.skill, roots: t, intl: e }),
      a = r.get(n);
    if (a == null) {
      ...
      ? ((e = (e) =>
          (0, $.jsx)(
            Jn,
            {
              ...
              actionsPlacement: `center`,
              icon: (0, $.jsx)(Ut, { className: `icon-sm text-token-text-secondary` }),
              title: e.name,
              actions: (0, $.jsxs)(ga, {
                children: [
                  (0, $.jsx)(Vt, {
...
var Bs,
  ...
  Xs = e(() => {
    ((Bs = $e()),
      ...
      (Js = C({ category_ids: h(gn()).default([]) }).catch({ category_ids: [] })),
      (Ys = S(y, (e) => null)));
  });
