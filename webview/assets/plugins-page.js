...
import { n as la, t as ua } from "./plugin-uninstall-dialog-m.js";
                      ...
                      (0, W.jsxs)(`label`, {
                        ...
                        children: [
                          ...
                          (0, W.jsx)(`textarea`, {
                            ...
                            className: Ze(Oa, `min-h-20 resize-y`),
                            disabled: n,
                            onBlur: e.handleBlur,
                            onChange: (t) => {
                              e.handleChange(t.target.value);
...
function Pa(e) {
  let t = (0, Ia.c)(5),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = Ze(r, Ma.container)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
...
function Fa(e) {
  let t = (0, Ia.c)(7),
    ...
    u;
  t[0] !== r || t[1] !== c || t[2] !== l
    ? ((u = Ze(`grid`, c, l, r)), (t[0] = r), (t[1] = c), (t[2] = l), (t[3] = u))
    : (u = t[3]);
  let d;
  return (
    t[4] !== n || t[5] !== u
  ...
  if (_.length === 0)
    return (0, G.jsx)(`div`, {
      ...
      children: g
        ...
        : (0, G.jsx)(j, { title: v, description: n }),
    });
  let M = _.map((n, r) =>
    (0, G.jsxs)(
      Za.Fragment,
      {
        children: [
          (0, G.jsx)(Va, {
            ...
            installProgressPercent: Fn(l, p, n.plugin.id),
            installPhase: Dn(l, p, n.plugin.id),
  ...
  return (0, G.jsxs)(G.Fragment, {
    children: [
      d
        ...
        : (0, G.jsx)(Fa, { gap: m, isSingleColumn: u, children: M }),
      k != null && w != null
        ? (0, G.jsx)(ua, {
            isUninstalling: D === k.plugin.id,
            open: !0,
            pluginDisplayName: nn(k),
            onOpenChange: (e) => {
              e || A(null);
            },
            onConfirm: async () => {
...
function Va(e) {
  let t = (0, Xa.c)(162),
    ...
    ee = (0, Za.useRef)(!1),
    j;
  t[0] === b ? (j = t[1]) : ((j = nn(b)), (t[0] = b), (t[1] = j));
  let N = j,
    P = u != null,
    F;
  t[2] !== s || t[3] !== P || t[4] !== y || t[5] !== b
    ? ((F = P
        ? `install`
    ...
    : (F = t[6]);
  let I = F,
    te = b.plugin.source.type === `remote`,
    ne;
  t[7] !== a || t[8] !== b.marketplacePath || t[9] !== b.plugin.source
    ? ((ne = jr(a, b.marketplacePath, b.plugin.source)),
      (t[7] = a),
  ...
  let ae = ne,
    oe = _ != null && ae != null,
    se = i != null || (h != null && ae != null),
    ce = b.plugin.installed && !b.plugin.enabled,
    le = c == null && !b.plugin.installed,
    ue;
  t[11] === b.plugin.name
    ? (ue = t[12])
    : ((ue = Gn(b.plugin.name)), (t[11] = b.plugin.name), (t[12] = ue));
  let de = ue != null,
    fe = !b.plugin.installed && (c != null || (de && !te)),
    pe;
  t[13] !== o || t[14] !== b || t[15] !== fe
    ? ((pe = fe
        ? { hostId: o, ...Bt(b), pluginSummary: b.plugin }
      ...
      (t[16] = pe))
    : (pe = t[16]);
  let { blockedReason: me, isLoading: he } = zn(pe),
    ge;
  t[17] !== me || t[18] !== b.plugin
    ? ((ge = Jn(b.plugin) ? `disabled-by-admin` : me),
      (t[17] = me),
      (t[18] = b.plugin),
      (t[19] = ge))
    : (ge = t[19]);
  let _e = ge,
    L = _e === `disabled-by-admin`,
    ve,
    ye,
    be,
    R,
  ...
  if (
    ...
    ((Se = Ln(b.plugin.name, de ? _e : null)), (Ce = le && L), (xe = d || L || he));
    let e;
    if (
      (t[63] === c
        ? (e = t[64])
    ...
    (t[77] === f
      ...
      (ye = p));
    let h = _ == null ? a : null;
    we = (E != null && !L) || oe || se || v != null;
    let y = P ? `disabled:opacity-100` : void 0,
      S = P ? `ghost` : `outline`,
      C;
    t[79] !== T || t[80] !== b
      ? ((C = (e) => {
          (e.stopPropagation(), T(b));
        }),
        (t[79] = T),
        (t[80] = b),
        (t[81] = C))
      : (C = t[81]);
    let w;
    t[82] !== c || t[83] !== l || t[84] !== u || t[85] !== P || t[86] !== m
      ? ((w = P
          ? (0, G.jsxs)(G.Fragment, {
              children: [
                (0, G.jsx)(ie, {
      ...
      : (w = t[87]);
    let O;
    (t[88] !== xe || t[89] !== y || t[90] !== S || t[91] !== C || t[92] !== w
      ? ((O = (0, G.jsx)(z, {
          className: y,
          color: S,
          disabled: xe,
    ...
    t[94] === k
      ? (Pe = t[95])
      : ((Pe = Ze(`group !cursor-interaction justify-center`, k)), (t[94] = k), (t[95] = Pe));
    let A = (ce || D || L) && `opacity-60`;
    (t[96] !== r || t[97] !== A
      ? ((Fe = Ze(r, A)), (t[96] = r), (t[97] = A), (t[98] = Fe))
      : (Fe = t[98]),
      (Te = `center`),
      (De = !1));
    ...
    t[101] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((M = (0, G.jsx)(dn, { className: `icon-md text-token-text-secondary` })), (t[101] = M))
      : (M = t[101]);
    let F;
    t[102] !== b.plugin.name || t[103] !== N
      ? ((F = (0, G.jsx)(Ct, { alt: N, knownAppId: b.plugin.name, fallback: M })),
        (t[102] = b.plugin.name),
        (t[103] = N),
        (t[104] = F))
      : (F = t[104]);
    let I;
    (t[105] !== b.logoDarkPath || t[106] !== b.logoPath || t[107] !== N || t[108] !== F
      ? ((I = (0, G.jsx)(Ct, {
          alt: N,
      ...
      : (I = t[109]),
      t[110] !== j || t[111] !== I
        ? ((Oe = (0, G.jsx)(`span`, { className: j, children: I })),
          (t[110] = j),
          (t[111] = I),
          (t[112] = Oe))
        : (Oe = t[112]),
      ...
      t[113] !== h || t[114] !== b.description
        ? ((Ae =
          ...
          (t[115] = Ae))
        : (Ae = t[115]),
      (Me = `flex flex-col gap-0.5 !text-token-description-foreground`),
      (Ne = Ya(b, D, x, Se)),
      (t[20] = se),
      (t[21] = de),
      (t[22] = le),
    ...
    ((ve = t[46]),
      ...
      (Fe = t[62]));
  let Ie;
  t[116] !== T || t[117] !== g || t[118] !== b || t[119] !== Se
    ? ((Ie = g
        ? () => {
            if (ee.current) {
              ee.current = !1;
              ...
              children: [
                ...
                we
                  ? (0, G.jsx)(`div`, {
                      ...
                      onClick: Wa,
                      onKeyDown: Ua,
                      children: (0, G.jsxs)(Pt, {
                        align: `end`,
                        contentWidth: `sm`,
                        triggerButton: (0, G.jsx)(M, {
                        ...
                        children: [
                          ...
                          oe
                            ? (0, G.jsx)(St.Item, {
                                ...
                                leftIconClassName: `icon-xs`,
                                onSelect: () => {
                                  fn({ path: ae, cwd: null, openFile: A.mutate });
                                },
                                children: (0, G.jsx)(V, {
                ...
                (0, G.jsx)(Ee, {
                  ...
                  children: (0, G.jsx)(yt, {
                    ...
                    disabled: L || f || p,
                    ariaLabel: k.formatMessage(K.toggleAria),
                    onClick: Ha,
                    onChange: (e) => {
                      y?.({ pluginId: b.plugin.id, pluginDisplayName: N, enabled: e });
                    },
                  }),
                }),
              ],
            ...
            ? (0, G.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, G.jsx)(ia, {
                    ...
                    enabledStatusAriaLabel: k.formatMessage(K.enabledStatus),
                    isEnabled: b.plugin.enabled && !L,
                    isUninstalling: p,
                    isUpdating: f,
                    ...
                    onDisable:
                      !te && !L && y
                        ? () => {
                            ((ee.current = !0),
                              y({ pluginId: b.plugin.id, pluginDisplayName: N, enabled: !1 }));
                          }
                        : void 0,
                    onEnable:
                      !te && ce && !L && y
                        ? () => {
                            ((ee.current = !0),
                              y({ pluginId: b.plugin.id, pluginDisplayName: N, enabled: !0 }));
                          }
                        : void 0,
                    onUninstall: v
                      ? () => {
            ...
            : I === `status`
              ...
              : Ce
                ? (0, G.jsx)(Ee, {
                    ...
                    children: (0, G.jsx)(`span`, {
                      role: `img`,
                      "aria-label": k.formatMessage(K.disabledInstallTooltip),
                      className: `flex h-7 w-7 shrink-0 items-center justify-center text-token-text-tertiary`,
                      children: (0, G.jsx)(An, { className: `icon-sm` }),
                    }),
                  })
                : (0, G.jsx)(Ii, {
                    measurement: R,
...
function Ya(e, t, n, r) {
  ...
  return (
    ...
    r && i.push((0, G.jsx)(qn, {}, `${e.plugin.id}-plugin-upsell`)),
    !n &&
    ...
    t[0] !== n || t[1] !== r || t[2] !== a || t[3] !== i
      ? ((o = async (e) => {
          let t = await va({
            ...
            onReloadError: eo,
            params: e,
            sendAddMarketplace: (e) => ye(`add-marketplace`, { hostId: r, ...e }),
          });
...
function eo(e) {
  a.error(`Failed to refresh plugins after adding marketplace`, {
    safe: {},
    sensitive: { error: e },
  });
}
...
function io(e) {
  ...
  let l;
  t[5] !== i || t[6] !== s
    ? ((l = (0, q.jsx)(z, { color: `outline`, disabled: i, onClick: s, children: c })),
      (t[5] = i),
      (t[6] = s),
      (t[7] = l))
    : (l = t[7]);
  ...
  return (
    t[8] !== n || t[9] !== l
      ? ((u = (0, q.jsx)(`div`, {
          className: `flex min-h-0 flex-1 items-center justify-center py-8`,
          children: (0, q.jsx)(j, { title: o, description: n, actions: l }),
        })),
        (t[8] = n),
        (t[9] = l),
        (t[10] = u))
...
var lo,
  ...
  po = e(() => {
    (be(),
      ...
      (uo = It(`has-opened-plugin-creator-prefill-v1`, !1)),
      (fo = It(`has-opened-skill-creator-prefill-v1`, !1)));
  }),
  mo,
  ho,
  go = e(() => {
...
function _o(e) {
  ...
  if (n) {
    ...
    let o;
    t[5] !== i || t[6] !== r
      ? ((o = (0, J.jsx)(z, { color: `outline`, disabled: i, onClick: r, children: a })),
        (t[5] = i),
        (t[6] = r),
        (t[7] = o))
      : (o = t[7]);
    ...
    return (
      t[8] !== n || t[9] !== o
        ? ((s = (0, J.jsx)(`div`, {
            className: `flex min-h-0 flex-1 items-center justify-center py-8`,
            children: (0, J.jsx)(j, { title: e, description: n, actions: o }),
          })),
          (t[8] = n),
          (t[9] = o),
          (t[10] = s))
                      ...
                      children: [
                        ...
                        (0, J.jsx)(Ee, {
                          ...
                          children: (0, J.jsx)(z, {
                            ...
                            children: n ? null : (0, J.jsx)(O, { className: `icon-sm` }),
                          }),
                        }),
                      ],
                    }),
...
function bo(e) {
  ...
  t[8] === u
    ? (f = t[9])
    : ((f = (0, J.jsx)(er, {
        children: (0, J.jsx)(ir, { title: u, subtitle: d, subtitleSize: `sm` }),
      })),
      (t[8] = u),
      (t[9] = f));
  let p;
  ...
  let h;
  t[13] !== n || t[14] !== p
    ? ((h = (0, J.jsx)(z, { color: `secondary`, disabled: n, onClick: p, children: m })),
      (t[13] = n),
      (t[14] = p),
      (t[15] = h))
    : (h = t[15]);
  ...
  t[17] === n
    ? (_ = t[18])
    : ((_ = (0, J.jsx)(z, { color: `danger`, loading: n, type: `submit`, children: g })),
      (t[17] = n),
      (t[18] = _));
  let v;
  t[19] !== _ || t[20] !== h
    ? ((v = (0, J.jsx)(er, { children: (0, J.jsxs)(nr, { children: [h, _] }) })),
      (t[19] = _),
      (t[20] = h),
      (t[21] = v))
    : (v = t[21]);
  ...
  t[22] !== v || t[23] !== l || t[24] !== f
    ? ((y = (0, J.jsxs)(ar, { as: `form`, onSubmit: l, children: [f, v] })),
      (t[22] = v),
      (t[23] = l),
      (t[24] = f),
      (t[25] = y))
  ...
  return (
    t[26] !== i || t[27] !== y || t[28] !== c
      ? ((b = (0, J.jsx)($n, { open: c, onOpenChange: i, size: `compact`, children: y })),
        (t[26] = i),
        (t[27] = y),
        (t[28] = c),
        (t[29] = b))
...
function xo(e) {
  ...
  let _;
  t[22] !== r || t[23] !== h
    ? ((_ = (0, J.jsx)(z, { color: `outline`, disabled: r, onClick: h, children: g })),
      (t[22] = r),
      (t[23] = h),
      (t[24] = _))
    : (_ = t[24]);
...
var Co,
  J,
  wo = e(() => {
    ((Co = r()), We(), Ue(), On(), Qn(), tr(), ue(), ke(), ne(), go(), ha(), za(), $r(), (J = n()));
  }),
  To,
  Eo,
  Do = e(() => {
...
function Oo(e) {
  ...
  if (e.mode === `manage`) {
    ...
    t[3] !== e.onCreatePlugin || t[4] !== i || t[5] !== a
      ? ((s = { ariaLabel: i, disabled: a, Icon: dn, label: o, onSelect: e.onCreatePlugin }),
    ...
    t[10] !== e.onCreateSkill || t[11] !== c || t[12] !== l
      ? ((d = { ariaLabel: c, disabled: l, Icon: wn, label: u, onSelect: e.onCreateSkill }),
  ...
  if (
    ...
    if (
      ...
      (t[72] !== e.onAddMarketplace || t[73] !== i
        ? ((o = { ariaLabel: i, disabled: !1, Icon: Nt, label: a, onSelect: e.onAddMarketplace }),
  ...
  t[94] !== e.onRefreshPage
    ? ((l = e.needsSkillsRefresh
        ? (0, Y.jsxs)(z, {
            ...
            children: [
              e.isRefreshingPage
                ? (0, Y.jsx)(fe, { className: `icon-xs text-token-text-link-foreground` })
                : (0, Y.jsx)(`span`, {
  ...
  t[99] === e.isRefreshingPage
    ...
    : ((p = e.isRefreshingPage
        ? (0, Y.jsx)(fe, { className: `icon-sm` })
        : (0, Y.jsx)(I, { className: `icon-sm` })),
      (t[99] = e.isRefreshingPage),
      (t[100] = p));
  let m;
  ...
  t[106] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Y.jsx)(Cn, { className: `icon-sm` })), (t[106] = h))
    : (h = t[106]);
  let g;
  ...
  let _;
  t[110] !== a || t[111] !== g
    ? ((_ = (0, Y.jsx)(Ee, { tooltipContent: a, children: g })),
      (t[110] = a),
      (t[111] = g),
      (t[112] = _))
    : (_ = t[112]);
...
function ko(e) {
  ...
  if (n.length === 1) {
    let e;
    t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Y.jsx)(Nt, { className: `icon-xs` })), (t[1] = e))
      : (e = t[1]);
    let n;
    ...
    return (
      t[6] !== i.label || t[7] !== n
        ? ((r = (0, Y.jsx)(Ee, { tooltipContent: i.label, children: n })),
          (t[6] = i.label),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Y.jsx)(Nt, { className: `icon-xs` })), (t[13] = u))
    : (u = t[13]);
  let d;
  return (
    t[14] !== i.ariaLabel ||
...
function Lo(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, X.jsx)(Cn, { className: `icon-sm` })), (t[3] = u))
    : (u = t[3]);
  let d;
  t[4] !== c || t[5] !== i
    ? ((d = (0, X.jsx)(z, {
  ...
  t[7] !== c || t[8] !== d
    ? ((f = (0, X.jsxs)(`div`, {
        ...
        children: [l, (0, X.jsx)(Ee, { tooltipContent: c, children: d })],
      })),
      (t[7] = c),
      (t[8] = d),
      (t[9] = f))
    ...
    children: [
      ...
      (0, X.jsx)(`span`, {
        children: (0, X.jsx)(V, {
          ...
          values: {
            pluginNames: t.slice(0, 2).map(nn).join(`, `),
...
function Bo(e) {
  return (0, X.jsx)(
    Ct,
    {
      ...
      logoUrl: e.logoPath,
      fallback: (0, X.jsx)(dn, { className: `text-token-text-secondary` }),
    },
    e.plugin.id,
  );
}
function Vo(e) {
  return e.logoPath != null || e.logoDarkPath != null || Ut(e.plugin.name) != null;
}
function Ho(e) {
  let t = (0, Ko.c)(22),
...
function Wo(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, X.jsx)(`span`, {
        ...
        children: (0, X.jsx)(dn, { className: `size-1/2 text-token-text-secondary` }),
      })),
      (t[0] = r))
    : (r = t[0]);
  let i;
...
function Xo(e) {
  ...
  let m = p,
    h;
  t[3] === n.name ? (h = t[4]) : ((h = ge(n.name)), (t[3] = n.name), (t[4] = h));
  let g = h,
...
function Zo(e) {
  ...
  t[3] === s
    ? (l = t[4])
    : ((l = s ? null : (0, ns.jsx)(Nt, { className: `icon-xs` })), (t[3] = s), (t[4] = l));
  let u;
  t[5] === i
    ? (u = t[6])
    : ((u = i
...
function as(e) {
  ...
  let ie;
  return (
    t[78] !== I || t[79] !== te || t[80] !== ne || t[81] !== re
      ? ((ie = (0, Z.jsxs)(`div`, {
...
function us(e) {
  ...
  t[4] !== r || t[5] !== c || t[6] !== o || t[7] !== s
    ? ((d = r === `toggle` ? Tn({ skill: s, roots: o, intl: c }) : void 0),
      (t[4] = r),
      (t[5] = c),
      (t[6] = o),
      (t[7] = s),
  ...
  let m = r !== `toggle`,
    h;
  t[11] === s ? (h = t[12]) : ((h = Ot(s)), (t[11] = s), (t[12] = h));
  let g;
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(`span`, {
          ...
          children: (0, Z.jsx)(wn, { className: `icon-sm` }),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
  ...
  if (i) {
    ...
    return (
      t[2] === i
        ...
        : ((n = (0, Z.jsx)(`div`, {
            className: `flex min-h-0 flex-1 items-center justify-center py-8`,
            children: (0, Z.jsx)(j, { title: e, description: i }),
          })),
          (t[2] = i),
          (t[3] = n)),
      n
...
function xs({ directoryEntrypoint: e } = {}) {
  let t = c(qe),
    ...
    r = Gr(Ws),
    i = me(),
    a = Oi({ explicitEntrypoint: e, locationKey: i.key, locationState: i.state }),
    o = Pe(),
    s = xi(i.state),
    l = f(Ys, i.key),
    p = t.get(l),
    ...
    b = (0, Q.useRef)(null),
    x = (0, Q.useRef)(null),
    S = (0, Q.useRef)(p?.browseScrollTop ?? null),
    C = u(ve) ?? [],
    w = se(C),
    [E, O] = (0, Q.useState)(p?.selectedHostIdState ?? s.initialHostId ?? `local`),
    k = E === `local` || w.some((e) => e.hostId === E) ? E : Ye,
    A = At({ hostId: k }),
    ee = C.map((e) => e.hostId),
    [j, M] = (0, Q.useState)(() =>
      p == null
    ...
    [F, I] = (0, Q.useState)(p?.searchQuery ?? ``),
    [te, ne] = (0, Q.useState)(0),
    [re, ie] = (0, Q.useState)(s.initialSearchQuery ?? ``),
    [oe, ce] = (0, Q.useState)(!1),
    [le, ue] = (0, Q.useState)(!1),
    [de, fe] = (0, Q.useState)(`idle`),
    [pe, he] = (0, Q.useState)(0),
    [ge, L] = (0, Q.useState)(null),
    [ye, be] = (0, Q.useState)(null),
    [R, we] = (0, Q.useState)(p?.selectedPluginDirectoryTab ?? `openai`),
    [Te, Ee] = (0, Q.useState)(null),
    [z, De] = (0, Q.useState)(null),
    [Oe, ke] = (0, Q.useState)(null),
    [Ae, Le] = (0, Q.useState)(!1),
    ze = _t(k),
    { data: Ve, isLoading: He } = Or(k),
    Ue = Ve?.homeDirectory,
    We = d(uo),
    Ge = g(uo),
    Ke = d(fo),
    Je = g(fo),
    {
      forceReloadSkills: Xe,
      installedSkillMatchKeys: Qe,
      installedSkillMetadata: $e,
      isFetching: tt,
      isLoading: nt,
      markSkillsUpdated: rt,
      standaloneInstalledSkills: it,
      workspaceRoots: at,
    } = li(k),
    {
      canInstallRecommendedSkills: ot,
      defaultRecommendedRepoRoot: st,
      skillCreatorPath: pt,
    } = Jr(k),
    ht = ze == null ? null : `${ze}/skills/.system/plugin-creator/SKILL.md`,
    { errorMessage: gt, isLoading: yt, refresh: bt, repoRoot: xt, skills: St } = ca(st, k),
    Ct = Xi({ recommendedSkills: yt || gt != null ? null : St, skills: $e }),
    {
      clearInstalledRecommendedSkills: Tt,
      installRecommendedSkill: Et,
      installedRecommendedSkillIds: Dt,
      installingSkillId: Ot,
    } = ri({
      forceReloadSkills: Xe,
      hostId: k,
      onInstalled: () => {
    ...
    { value: qt } = Ne(`2817990312`),
    Jt = R === `openai` ? Js.parse(qt).category_ids : [],
    Zt = Se(`1269116100`),
    Qt = Se(`4218407052`),
    { config: $t } = Qr(),
    { mutateAsync: en } = ra({ hostId: k }),
    { mutateAsync: tn } = sa({ hostId: k }),
    { data: rn, isLoading: an } = ct({ enabled: Zt, hostId: k, marketplaceKind: `shared-with-me` }),
    { data: on, isLoading: sn } = ct({
      enabled: Zt,
      hostId: k,
      marketplaceKind: `workspace-directory`,
    }),
    { data: cn, isLoading: ln } = ct({
      enabled: Qt,
      hostId: k,
      marketplaceKind: `created-by-me-remote`,
    }),
    un = $a({ forceReloadPlugins: Ut, hostId: k }),
    { data: dn } = Ie(at[0] ?? null, { hostId: k, useActiveWorkspaceRoot: !1 }),
    {
      data: fn,
      hardRefetchAppsList: pn,
      isHardRefetchingAppsList: mn,
      isLoading: hn,
      loadError: gn,
    } = Wt({ hostId: k }),
    _n = gn?.message ?? null,
    {
      closePluginInstall: vn,
      connectRequiredApp: yn,
      handleRequiredAppConnected: bn,
      handleRequiredAppOAuthStarted: xn,
      installPlugin: Sn,
      isInstalling: Cn,
      openPluginInstall: wn,
      openPluginInstallDetails: Tn,
      session: Dn,
    } = Zn({ forceReloadPlugins: Ut, hostId: k }),
    On = Dn.kind === `installing` ? Dn : null,
    { pendingPluginId: kn, setPluginEnabled: An } = dt({ hostId: k }),
    { pendingUninstallPluginId: jn, uninstallPlugin: Nn } = Yt({ hostId: k }),
    { pendingRemoveMarketplaceName: Pn, removeMarketplace: Fn } = ft({ hostId: k }),
    {
      isUpgradingMarketplaces: In,
      pendingUpgradeMarketplaceName: Ln,
      upgradeMarketplaces: Rn,
    } = kt({ hostId: k }),
    { data: zn } = m(Ce, k),
    {
      clearConnectingApp: Bn,
      connectingApp: Vn,
      handleAppConnectOAuthStarted: Hn,
      handleConnectApp: Un,
      handleOpenAppUrl: Gn,
      isAppConnectPending: qn,
    } = zt({ hostId: k }),
    { setAppEnabled: Yn, updatingAppId: Xn } = Mr({ hostId: k }),
    Qn = ye == null ? null : (fn?.find((e) => e.id === ye) ?? null),
    $n = Ft(ye),
    er = Me({ hostId: k }),
    tr = pi(zn?.config),
    nr = ei(zn?.config),
    rr = In || Ln != null,
    ir = !Rt.some((e) => Ji(e, tr)) || rr || Pn != null,
    ar = N == null ? null : (fn?.find((e) => e.id === N) ?? null),
    cr = N != null && qn(N),
    ur = Vn ?? ar,
    { authMethod: fr } = ut(),
    { data: pr } = Kt(),
    ...
    hr = j.kind === `manage`,
    gr = j.tab,
    H = j.kind === `browse` ? j.tab : null,
    yr = k === `local` ? [`claude-cowork`] : [],
    br = A && H === `plugins` && yr.length > 0,
    xr = D(`external-agent-imported-connectors`, {
      params: { hostId: Ye, providers: yr },
      queryConfig: { enabled: br },
    }),
    Sr = mr || zr(Vt),
    Cr = Pr(Vt),
    Tr = Ir(Vt),
    Er = rn == null ? null : Ir(rn).filter((e) => e.remoteMarketplaceName === Gs),
    Dr = Fr({ installedPlugins: Ht, sharedWithYouPlugins: rn ?? [], workspacePlugins: on ?? [] }),
    kr = on == null ? null : Ir(on),
    Ar =
      (k === `local` && pr?.structure?.toLowerCase() === `workspace` ? pr.name?.trim() : null) ||
      on?.find((e) => !!e.marketplaceDisplayName?.trim())?.marketplaceDisplayName?.trim() ||
      null,
    Nr = Gi(n, `skills`),
    Vr = Gi(n, H ?? `plugins`),
    Ur = F.trim().toLowerCase(),
    Kr = re.trim().toLowerCase(),
    U = Ur.length > 0,
    Yr = ci({ skills: it, query: Ur }),
    Xr = Di({ skills: St, query: Ur }),
    Zr = Ui(Xr),
    $r = Fi({ installedRecommendedSkillIds: Dt, installedSkillMatchKeys: Qe, skills: U ? Xr : Zr }),
    ti = $i({ installedSkills: Yr, recommendedSkills: $r }),
    { data: ni } = yi({ enabled: Zt, hostId: k }),
    {
    ...
    Si = As({ intl: n, roots: at, skillEntries: ti }),
    wi = Zt && U && H === `plugins`,
    Ei = H === `skills` || wi ? null : Te,
    ki = U ? [] : Dr,
    ji;
  if (wi)
    ji = Wr({
    ...
    switch (R) {
      ...
      case `workspace`:
        ...
        break;
      case `personal`: {
        let e = Tr.filter((e) => !Lr(e) && (ii == null || et(e) !== ii));
        ji = [
  ...
  let Mi =
      mr && H === `plugins` && !U && Ei == null && R === `openai`
        ? (0, $.jsx)(V, {
    ...
    Li = Ii?.id ?? null,
    Hi = or({
      apps: sr({ apps: fn ?? [], connectors: br ? (xr.data?.connectors ?? []) : [] }),
      plugins: fi,
    ...
    Qi = U
      ...
      : [],
    ea = Qi.length,
    ta = Qi.length === 0 ? null : Math.min(te, Qi.length - 1),
    na = ta == null ? null : (Qi[ta] ?? null),
    ia = Hr({ plugins: Dr, query: Kr }),
    aa = new Set([...Vt, ...(rn ?? []), ...(on ?? [])].map((e) => e.plugin.id)),
    oa = new Set(Dr.filter((e) => !aa.has(e.plugin.id)).map((e) => e.plugin.id)),
    la = ci({ skills: Ct, query: Kr }),
    { installedApps: ua } = gi(fn ?? []),
    da = _i({ apps: ua, query: Kr }),
    fa = Rs({ mcpServers: dn?.servers ?? {}, query: Kr }),
    pa = qr({ configuredMarketplaceNames: nr, marketplaces: Rt, query: `` }),
    ma = {
      apps: ua.length,
      marketplace: pa.length,
      mcps: Object.keys(dn?.servers ?? {}).length,
      plugins: Dr.length,
      skills: Ct.length,
    },
    ha = hr && ma[gr] === 0 ? (Fs(ma) ?? gr) : gr,
    ga = hr ? ha === `plugins` : H === `plugins`,
    _a = Ki({ categoryKey: Li, directoryTab: R, isGlobalSearch: wi, searchQuery: Ur }),
    va = Ti({ canonicalCategoryIds: Jt, directoryTab: R, selectedCategoryTitle: Ii?.title }),
  ...
  let xa = Gi(n, ha),
    Sa = qr({ configuredMarketplaceNames: nr, marketplaces: pa, query: Kr }),
    Ca = er.isPending ? (er.variables?.key ?? null) : null,
    wa = !hr && H === `skills` && oe,
    Ta = wa || nt || Si.length > 0 || ti.length > 0,
    Ea = wa || yt || gt != null || $r.length > 0,
    W = Nr.sections.at(-1) ?? null,
    Da = [...Si.map((e) => ({ id: e.id, title: e.title })), ...(Ea && W != null ? [W] : [])],
    Oa = Da.some((e) => e.id === z) ? z : (Da[0]?.id ?? null),
    ka = (0, Q.useEffectEvent)(async () => {
      let { availablePlugins: e } = await Gt();
      return mr || zr(e);
    }),
    ...
    Ia = async (e) => {
      let t = jr(Ue, e.marketplacePath, e.plugin.source);
      try {
        let n = await Vi({ hostId: k, ...Bt(e) }).catch(() => null),
    ...
    La = async (e) => {
      let r = jr(Ue, e.marketplacePath, e.plugin.source);
      if (r == null) return;
      let i = await Vi({ hostId: k, ...Bt(e) }).catch(() => null),
      ...
      let s = bi({
        ...
        saveShare: (e) => Ci({ pluginPath: r, remotePluginId: e, savePluginShare: en }),
      });
      lr(t, Ri, {
        initialSharePrincipals: s.getCurrentShare()?.sharePrincipals ?? [],
        pluginDisplayName: nn(e),
        ...
        onCopyLink: async () => {
          try {
            ...
            if ((e || Ut(), t.shareUrl.length > 0 && (await je(t.shareUrl)))) return !0;
          } catch (e) {
            return (Fa(e), !1);
          }
          return (Fa(), !1);
        ...
        onSaveShareTargets: async (e) => {
          try {
            let t = await s.saveShareTargets(e, (e, t) => tn({ remotePluginId: e, targets: t }));
            return (Ut(), t);
          } catch (e) {
            throw (
              t
        ...
        onUpdateSharedVersion: async () => {
          if (o?.remotePluginId != null)
            try {
              (await en({ pluginPath: r, remotePluginId: o.remotePluginId }),
                Ut(),
                t
                  .get(Be)
                  .success(
    ...
    za =
      Pt ||
      (Zt && He) ||
      (Zt && hr && ha === `plugins` && (an || sn)) ||
      de === `loading` ||
      (U
        ? ln || an || sn
        : H === `plugins` && ((R === `workspace` && sn) || (R === `personal` && (ln || an)))),
    Va = H === `plugins` && (!U || ea > 0),
    Ha = !wi,
    Ua = oe || rr || mn || nt || tt || Pt || It,
    Wa =
      w.length > 0
        ? (0, $.jsx)(Cs, {
            connectedRemoteConnections: w,
            remoteConnectionHostIds: ee,
            selectedHostId: k,
            onSelectHost: (e) => {
              (Tt(), O(e));
            },
    ...
    Ga = () => {
      if (ht == null) return;
      Fe(t, Re, {});
      let e = co({ creatorPath: ht, isFirstOpen: !We, kind: `plugin` });
      (We || Ge(!0), _({ prefillPrompt: e, startInSidebar: !0 }));
    };
  (0, Q.useEffect)(() => {
    if (!Ra) {
      fe(`idle`);
  ...
  let Ka = () => {
      if (pt == null) return;
      Fe(t, Re, {});
      let e = co({ creatorPath: pt, isFirstOpen: !Ke, kind: `skill` });
      (Ke || Je(!0), _({ prefillPrompt: e, startInSidebar: !0 }));
    },
    qa = async () => {
      if (Cr == null || Jn(Cr.plugin)) return;
      let e = Wn({
        defaultPrompt: Kn(Cr.plugin.interface?.defaultPrompt),
        pluginDisplayName: nn(Cr),
      ...
      if (!Cr.plugin.enabled)
        try {
          await An({ enabled: !0, pluginDisplayName: nn(Cr), pluginId: Cr.plugin.id });
        } catch {
          return;
        }
      _({ prefillPrompt: e, startInSidebar: !0 });
    },
    Ja = at[0] != null && at[0] !== `/` ? at[0] : void 0,
    Ya = (e, t = Kn(e.plugin.interface?.defaultPrompt)) => {
      _({
        prefillPrompt: Wn({ defaultPrompt: t, pluginDisplayName: nn(e), pluginId: e.plugin.id }),
        prefillCwd: Ja,
        startInSidebar: !0,
      });
    },
    Xa = async () => {
      ce(!0);
      try {
        (rt(), await Promise.all([Ut(), bt(), pn()]), Tt(), ue(!1));
      } catch {
        t.get(Be).danger(
          n.formatMessage({
    ...
    eo = (e) => {
      if (!(!U || Qi.length === 0)) {
        if (e.key === `ArrowDown`) {
          (e.preventDefault(), ne(Math.min((ta ?? 0) + 1, Qi.length - 1)), Qa());
          return;
        }
        if (e.key === `ArrowUp`) {
          (e.preventDefault(), ne(Math.max((ta ?? 0) - 1, 0)), Qa());
          return;
        }
        if (e.key === `Enter`) {
          let t = x.current?.querySelector(`[data-search-result-active='true']`);
    ...
    q = (0, Q.useCallback)((e) => {
      x.current = e;
      let t = S.current;
      e == null || t == null || ((e.scrollTop = t), (S.current = null));
    }, []),
    so = (e, n) => {
      (hr ||
        t.set(l, {
          browseScrollTop: x.current?.scrollTop ?? null,
          searchQuery: F,
          selectedHostIdState: E,
          selectedPluginDirectoryTab: R,
        }),
        o(mt(e, { hostId: k, source: hr ? `manage` : void 0 }), { state: hr ? void 0 : lt(n) }));
    },
    lo = (e) => {
    ...
    mo = async (e, t) => {
      await er.mutateAsync({ key: e, enabled: t });
    },
    ho = async (e) => {
      try {
        (await Fn({ marketplaceDisplayName: mi(e), marketplaceName: e.name }), ke(null));
      } catch {}
    },
    go = async () => {
      try {
    ...
    vo = async (e) => {
      try {
        await Rn({ marketplaceDisplayName: mi(e), marketplaceName: e.name });
      } catch {}
    };
  (0, Q.useEffect)(() => {
    let e = (e) => {
              ...
              ? (0, $.jsx)(wr, {
                  ...
                  children: (0, $.jsx)(Ba, {
                    ...
                    onInstallPlugin: async (e) => {
                      (P(null), await Un(e.importedConnectorApp));
                    },
          ...
          ? (0, $.jsx)(Oo, {
              ...
              recordSkillAction:
                Cr == null
                  ? void 0
                  : {
                      disabled: Cn || kn === Cr.plugin.id || Jn(Cr.plugin),
                      onSelect: () => {
                        qa();
                      },
                    },
        ...
        children: [
          A
            ? (0, $.jsx)($.Fragment, {
                children: (0, $.jsxs)(`div`, {
                  ...
                  children: [
                    (0, $.jsx)(Pa, {
                      className: Ze(`flex h-full w-full flex-1 flex-col`, hr ? `gap-0` : `gap-8`),
                      children: hr
                        ? (0, $.jsx)(`div`, {
                                    ...
                                    children: (0, $.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, $.jsx)(Ns, {
                                          ...
                                          mcpsCount: Object.keys(dn?.servers ?? {}).length,
                                  ...
                                  children:
                                    ha === `plugins`
                                      ? (0, $.jsx)(Ba, {
                                          ...
                                          onShareInstalledPlugin: Zt
                                            ? (e) => {
                                                La(e);
                                              }
                                            : void 0,
                                          onTryInChat: Zt ? Ya : void 0,
                                          plugins: ia,
                                          unavailablePluginIds: oa,
                                          onInstallPlugin: async (e) => {
                                            wn(e, { tryInChatCwd: Ja });
                                          },
                                          onUninstallInstalledPlugin: Nn,
                                          onToggleInstalledPluginEnabled: An,
                                          pendingPluginId: kn,
                                          pendingUninstallPluginId: jn,
                                          reducedMotion: h,
                                          emptyStateTitle: (0, $.jsx)(V, {
                                            id: `skills.appsPage.empty.plugins`,
                                            defaultMessage: `No plugins found`,
                                        ...
                                        : ha === `mcps`
                                          ...
                                          : ha === `marketplace`
                                            ? (0, $.jsx)(_o, {
                                                ...
                                                isRetrying: oe || It,
                                                marketplaceLoadErrors: Lt,
                                                configuredMarketplaceNames: nr,
                                                configuredGitMarketplaceNames: tr,
                                                isUpgradingMarketplaces: In,
                                                marketplaces: Sa,
                                                onUpgradeMarketplace: (e) => {
                                                  vo(e);
                                                },
                                                onRemoveMarketplace: ke,
                                                onRetry: Xa,
                                                pendingUpgradeMarketplaceName: Ln,
                        ...
                        : (0, $.jsx)(vr, {
                            ...
                            children: (0, $.jsxs)(`div`, {
                              className: Ze(`flex min-h-0 flex-col gap-8`, !U && `flex-1`),
                              children: [
                                Va
                                  ? (0, $.jsx)(No, {
                                ...
                                H === `skills` && (!U || ea > 0)
                                  ? (0, $.jsx)(as, {
                                      ...
                                      installedRecommendedSkillIds: Dt,
                                      installedSkills: ti,
                                      installedSkillsForRecommendedActions: it,
                                      installingSkillId: Ot,
                                      isLoadingInstalledSkills: nt || wa,
                                      isLoadingRecommendedSkills: yt || wa,
                                      onInstallRecommendedSkill: Et,
                                      onInstalledRecommendedSkillUpdated: () => {
                                        (Tt(), rt());
                                      },
                                      onSelectSection: De,
                                      onSkillsUpdated: rt,
                                      recommendedRepoRoot: xt,
                    ...
                    (0, $.jsx)(ba, { open: Ae, onAddMarketplace: un, onOpenChange: Le }),
                    (0, $.jsx)(bo, {
                      marketplace: Oe,
                      isRemoving: Oe != null && Pn === Oe.name,
                      onOpenChange: (e) => {
                        e || ke(null);
                      },
                      onRemove: (e) => {
                    ...
                    (0, $.jsx)(vt, {
                      ...
                      onConnected: async () => {
                        P(null);
                        try {
                          await Mn({ hostId: k, queryClient: v, refreshAppsList: pn });
                        } catch {}
                      },
                    }),
                    (0, $.jsx)(zi, {
                      app: Qn,
                      errorMessage: $n.error?.message ?? null,
                      ...
                      onTryInChat: (e) => {
                        _({
                          prefillPrompt: `[@${e.name}](${xe(Mt(e.id))})`,
                          prefillCwd: at[0] != null && at[0] !== `/` ? at[0] : void 0,
                          startInSidebar: !0,
                        });
                      },
                      tools: $n.data ?? [],
          ...
          ge == null && On == null
            ? (0, $.jsx)(En, {
                hostId: k,
                isInstalling: Cn,
                onConnectRequiredApp: yn,
                onInstall: Sn,
                onRequiredAppConnected: bn,
                onRequiredAppOAuthStarted: xn,
                onTryInChat: Ya,
                onViewDetails: so,
                onOpenChange: (e) => {
                  e || vn();
...
function Cs(e) {
  ...
  t[5] !== i || t[6] !== u
    ? ((f =
        u == null
          ? (0, $.jsx)(N, { className: `icon-xs shrink-0 text-token-text-secondary` })
          : (0, $.jsx)(mr, {
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, $.jsx)(N, { className: `icon-xs shrink-0 text-token-text-secondary` })),
      (t[17] = y))
    : (y = t[17]);
  let b;
  t[18] === c
  ...
  t[20] !== b || t[21] !== _ || t[22] !== v
    ? ((x = (0, $.jsx)(St.Item, { RightIcon: _, onSelect: v, children: b })),
      (t[20] = b),
      (t[21] = _),
      (t[22] = v),
      (t[23] = x))
    ...
    (t[29] !== r || t[30] !== i || t[31] !== a
      ? ((e = (e) =>
          (0, $.jsx)(
            St.Item,
            {
              RightIcon: e.hostId === a ? Le : void 0,
              onSelect: () => {
                r(e.hostId);
              },
  ...
  t[33] === S
    ? (C = t[34])
    : ((C = (0, $.jsx)(St.Section, { className: `max-h-40 overflow-y-auto`, children: S })),
      (t[33] = S),
      (t[34] = C));
  let w;
  return (
...
function Es(e) {
  ...
  let p;
  t[8] !== u || t[9] !== d
    ? ((p = (0, $.jsx)(St.Item, { RightIcon: u, onSelect: d, children: f })),
      (t[8] = u),
      (t[9] = d),
      (t[10] = p))
    : (p = t[10]);
...
function As({ intl: e, roots: t, skillEntries: n }) {
  let r = new Map();
  for (let i of n) {
    let n = Tn({ skill: i.skill, roots: t, intl: e }),
      a = r.get(n);
    if (a == null) {
      ...
      ? ((e = (e) =>
          (0, $.jsx)(
            Pn,
            {
              ...
              actionsPlacement: `center`,
              icon: (0, $.jsx)(vn, { className: `icon-sm text-token-text-secondary` }),
              title: e.name,
              actions: (0, $.jsxs)(ga, {
                children: [
                  (0, $.jsx)(Ee, {
                    ...
                    children: (0, $.jsx)(z, {
                      ...
                      children: (0, $.jsx)(Cn, { className: `icon-sm` }),
                    }),
                  }),
                  (0, $.jsx)(Ee, {
...
var Bs,
  ...
  Xs = e(() => {
    ((Bs = r()),
      ...
      (Js = C({ category_ids: E(x()).default([]) }).catch({ category_ids: [] })),
      (Ys = p(qe, (e) => null)));
  });
