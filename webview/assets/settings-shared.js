...
function f(e) {
  let t = (0, u.c)(24),
    ...
    f;
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (s = t[3]), (c = t[4]), (l = t[5]), (f = t[6]))
    : (({
        children: r,
        className: s,
        contentClassName: c,
  ...
  let p = f === void 0 ? `secondary` : f,
    m;
  t[7] === s ? (m = t[8]) : ((m = i(`w-[240px] justify-between`, s)), (t[7] = s), (t[8] = m));
  let h;
  t[9] === c
    ? (h = t[10])
    : ((h = i(`flex min-w-0 flex-1 items-center gap-1.5`, c)), (t[9] = c), (t[10] = h));
  let g;
  t[11] !== r || t[12] !== h
    ? ((g = (0, d.jsx)(`span`, { className: h, children: r })),
      (t[11] = r),
      (t[12] = h),
      (t[13] = g))
    : (g = t[13]);
  ...
  t[14] === n
    ? (_ = t[15])
    : ((_ = i(`icon-2xs shrink-0 text-token-input-placeholder-foreground`, n)),
      (t[14] = n),
      (t[15] = _));
  let v;
  t[16] === _ ? (v = t[17]) : ((v = (0, d.jsx)(o, { className: _ })), (t[16] = _), (t[17] = v));
  let y;
  return (
    t[18] !== p || t[19] !== l || t[20] !== m || t[21] !== g || t[22] !== v
...
function p(e) {
  ...
  let a;
  return (t[2] === i ? (a = t[3]) : ((a = (0, d.jsx)(n, { ...i })), (t[2] = i), (t[3] = a)), a);
}
function m(e) {
  let t = (0, u.c)(21),
    { slug: r } = e;
