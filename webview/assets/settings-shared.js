...
function f(e) {
  let t = (0, u.c)(24),
    ...
    f;
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (o = t[3]), (c = t[4]), (l = t[5]), (f = t[6]))
    : (({
        children: r,
        className: o,
        contentClassName: c,
  ...
  let p = f === void 0 ? `secondary` : f,
    m;
  t[7] === o ? (m = t[8]) : ((m = i(`w-[240px] justify-between`, o)), (t[7] = o), (t[8] = m));
  let h;
  t[9] === c
    ? (h = t[10])
  ...
  t[14] === n
    ...
    : ((_ = i(`icon-2xs shrink-0 text-token-input-placeholder-foreground`, n)),
      ...
      (t[15] = _));
  let v;
  t[16] === _ ? (v = t[17]) : ((v = (0, d.jsx)(s, { className: _ })), (t[16] = _), (t[17] = v));
  let y;
  return (
