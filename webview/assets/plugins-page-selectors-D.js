import { $n as e, Xn as t, _t as n, at as r, it as i, tr as a } from "./src-1.js";
import { F as o } from "./rpc-1.js";
...
function S(t) {
  let n =
    ...
    t.find((t) => e(t.name)) ??
    t.find((e) => e.name === p);
  return n == null ? `remote:${i}` : (n.path ?? `remote:${n.name}`);
}
function C(e, t) {
...
function N(t) {
  return t.filter((t) => {
    let r = n(t.plugin.id);
    return t.plugin.name !== `browser` || r == null || !e(r);
  });
}
function P(t) {
  return t.find((t) => t.plugin.name === `record-and-replay` && e(t.marketplaceName)) ?? null;
}
...
function L(t, { mergeOpenAIBundledMarketplace: n }) {
  if (!n) return new Map();
  let a = new Map(),
    o = new Set();
  for (let n of t) {
    let t = _(n.marketplaceName);
    if (t.length === 0) continue;
    let r = s(n);
    e(n.marketplaceName) && o.add(r);
    let i = a.get(t);
    if (i == null) {
      a.set(t, new Set([r]));
      continue;
...
//# sourceMappingURL=plugins-page-selectors-D.js.map
