      ...
      switch (i.label) {
        case 0:
          ((a = R(t)),
            (o = z(a, r)),
            (s = p()),
            (c = `${s}/integrations/${o ?? a}/${n}/${o ?? a}.dynamic.js.gz`),
            (i.label = 1));
        case 1:
        ...
        case 5:
          return (i.sent(), window[`${a}Loader`](), [2, window[`${a}Integration`]]);
      }
    });
  });
}
                    ...
                    function () {
                      return a(r, void 0, void 0, function () {
                        ...
                        return i(this, function (i) {
                          switch (i.label) {
                            case 0:
                              return ((r = t.pop()), r ? [4, c(r, e)] : [2]);
                            case 1:
                              return ((a = i.sent()), (o = a instanceof P), o || n.push(r), [2]);
                          }
                        });
                      });
                    },
            ...
            return i(this, function (i) {
              switch (i.label) {
                ...
                case 3:
                  ((a = i.sent()), (i.label = 4));
                case 4:
                  return ((r = a), (this.integration = H(r, this.settings, t)), [3, 6]);
                case 5:
                  throw (
                    (o = i.sent()),
                    T(e, {
              ...
              switch (i.label) {
                    ...
                    : ((a = this.options?.plan?.track),
                      ...
                      a &&
                        ...
                        I(a, c)
                          ? e.updateEvent(
                              `integrations`,
                              t(t({}, e.event.integrations), c?.integrations),
                            )
                          : (e.updateEvent(
                              `integrations`,
                              t(t({}, e.event.integrations), { All: !1, "Segment.io": !0 }),
                            ),
                            e.cancel(
                              new o({
                                retry: !1,
                ...
                case 1:
                  ...
                  ((u = new n(l, { traverse: !this.disableAutoISOConversion })),
                    T(e, { integrationName: this.name, methodName: r, type: `classic` }),
                    (i.label = 2));
                case 2:
                  return (
                    i.trys.push([2, 5, , 6]),
                    this.integration
                      ? [4, this.integration.invoke.call(this.integration, r, u)]
                      : [3, 4]
                  );
                case 3:
                  (i.sent(), (i.label = 4));
