...
import { a as i, f as a, i as o, t as s } from "./middleware.js";
import { i as c } from "./helpers-D.js";
import {
  a as l,
  f as u,
  i as d,
...
import { i as v, n as y, t as b, u as x } from "./load-script-CGHs-PpL.js";
    ...
    return e(this, function (e) {
      switch (e.label) {
        ...
        case 3:
          throw (
            (l = e.sent()),
            n.stats.gauge(`legacy_destination_time`, -1, [`plugin:${r}`, `failed`]),
            l
          );
        case 4:
          return (
        ...
        case 5:
          return (e.sent(), window[`${t}Loader`](), [2, window[`${t}Integration`]]);
      }
    });
  });
}
                      ...
                      return t(o, void 0, void 0, function () {
                        ...
                        return e(this, function (e) {
                          switch (e.label) {
                            ...
                            case 1:
                              return ((o = e.sent()), (s = o instanceof i), s || a.push(t), [2]);
                          }
                        });
                      });
                    },
...
var F = (function () {
  function n(e, t, n, i, a, o) {
    ...
    ((this.options = {}),
      ...
      (this.options = a),
      (this.buffer = a.disableClientPersistence ? new _(4, []) : new d(4, `${n}:dest-${e}`)),
      this.scheduleFlush());
  }
  return (
        ...
        return e(this, function (e) {
          switch (e.label) {
            ...
            case 1:
              return (
                e.trys.push([1, 5, , 6]),
                (i = this.integrationSource) == null ? [3, 2] : ((a = i), [3, 4])
              );
            case 2:
            ...
            case 3:
              ((a = e.sent()), (e.label = 4));
            case 4:
              return ((t = a), (this.integration = O(t, this.settings, r)), [3, 6]);
            case 5:
              throw (
                (o = e.sent()),
                g(n, {
            ...
            case 6:
              ...
              try {
                (g(n, { integrationName: this.name, methodName: `initialize`, type: `classic` }),
    ...
    (n.prototype.shouldBuffer = function (e) {
      return e.event.type !== `page` && (l() || this._ready !== !0 || this._initialized !== !0);
    }),
          ...
          switch (e.label) {
                ...
                : ((t = this.options?.plan?.track),
                  ...
                  t &&
                    ...
                    S(t, l)
                      ...
                      : (n.updateEvent(
                          `integrations`,
                          r(r({}, n.event.integrations), { All: !1, "Segment.io": !0 }),
                        ),
                        n.cancel(
                          new a({
                            retry: !1,
            ...
            case 1:
              ...
              ((d = new i(u, { traverse: !this.disableAutoISOConversion })),
                g(n, { integrationName: this.name, methodName: o, type: `classic` }),
                (e.label = 2));
            case 2:
              return (
                e.trys.push([2, 5, , 6]),
            ...
            case 5:
              throw (
                (f = e.sent()),
                g(n, { integrationName: this.name, methodName: o, type: `classic`, didError: !0 }),
                f
              );
            case 6:
              return [2, n];
              ...
              switch (e.label) {
                case 0:
                  return l() || this._ready !== !0 || this._initialized !== !0
                    ...
                    : ((this.flushing = !0), (t = this), [4, P(this, this.buffer)]);
                case 1:
                  return (
                    (t.buffer = e.sent()),
                    (this.flushing = !1),
