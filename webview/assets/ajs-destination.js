...
import { a as o, d as s, i as c, p as l, t as u, u as d, v as f } from "./esm-3.js";
    ...
    return t(this, function (t) {
      switch (t.label) {
        ...
        case 3:
          throw (
            (l = t.sent()),
            e.stats.gauge(`legacy_destination_time`, -1, [`plugin:${n}`, `failed`]),
            l
          );
        case 4:
          return (
        ...
        case 5:
          return (t.sent(), window[`${r}Loader`](), [2, window[`${r}Integration`]]);
      }
    });
  });
}
                      ...
                      return r(a, void 0, void 0, function () {
                        ...
                        return t(this, function (t) {
                          switch (t.label) {
                            ...
                            case 1:
                              return ((a = t.sent()), (o = a instanceof P), o || i.push(r), [2]);
                          }
                        });
                      });
                    },
    ...
    ($ = (function () {
      function e(e, t, n, r, i, o) {
        ...
        ((this.options = {}),
          ...
          (this.options = i),
          (this.buffer = i.disableClientPersistence ? new d(4, []) : new O(4, `${n}:dest-${e}`)),
          this.scheduleFlush());
      }
      return (
            ...
            return t(this, function (t) {
              switch (t.label) {
                ...
                case 3:
                  ((a = t.sent()), (t.label = 4));
                case 4:
                  return ((r = a), (this.integration = H(r, this.settings, n)), [3, 6]);
                case 5:
                  throw (
                    (o = t.sent()),
                    T(e, {
              ...
              switch (t.label) {
                    ...
                    : ((r = this.options?.plan?.track),
                      ...
                      r &&
                        ...
                        I(r, c)
                          ...
                          : (e.updateEvent(
                              `integrations`,
                              a(a({}, e.event.integrations), { All: !1, "Segment.io": !0 }),
                            ),
                            e.cancel(
                              new o({
                                retry: !1,
                ...
                case 1:
                  ...
                  ((u = new n(l, { traverse: !this.disableAutoISOConversion })),
                    T(e, { integrationName: this.name, methodName: i, type: `classic` }),
                    (t.label = 2));
                case 2:
                  return (
                    t.trys.push([2, 5, , 6]),
                    this.integration
                      ? [4, this.integration.invoke.call(this.integration, i, u)]
                      : [3, 4]
                  );
                case 3:
                  (t.sent(), (t.label = 4));
