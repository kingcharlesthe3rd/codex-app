      ...
      switch (t.label) {
        case 0:
          ((a = R(n)),
            (o = z(a, i)),
            (s = p()),
            (c = `${s}/integrations/${o ?? a}/${r}/${o ?? a}.dynamic.js.gz`),
            (t.label = 1));
        case 1:
        ...
        case 5:
          return (t.sent(), window[`${a}Loader`](), [2, window[`${a}Integration`]]);
      }
    });
  });
}
  ...
  return a(this, void 0, void 0, function () {
    ...
    return t(this, function (t) {
      return (
        ...
        (a = R(e)),
        (o = z(e, r)),
        (s = `${i}/integrations/${o ?? a}/${n}/${o ?? a}.dynamic.js.gz`),
        [2, v(s)]
      );
    });
  });
                    ...
                    function () {
                      return a(i, void 0, void 0, function () {
                        ...
                        return t(this, function (t) {
                          switch (t.label) {
                            case 0:
                              return ((i = n.pop()), i ? [4, c(i, e)] : [2]);
                            case 1:
                              return ((a = t.sent()), (o = a instanceof P), o || r.push(i), [2]);
                          }
                        });
                      });
                    },
            ...
            return t(this, function (t) {
              switch (t.label) {
                ...
                case 1:
                  return (
                    t.trys.push([1, 5, , 6]),
                    (r = this.integrationSource) == null ? [3, 2] : ((a = r), [3, 4])
                  );
                case 2:
                ...
                case 3:
                  ((a = t.sent()), (t.label = 4));
                case 4:
                  return ((i = a), (this.integration = H(i, this.settings, n)), [3, 6]);
                case 5:
                  throw (
                    (o = t.sent()),
                    T(e, {
