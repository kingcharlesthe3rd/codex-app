...
var t,
  ...
  h = e(() => {
    (c(),
      ...
      (m = class {
        constructor(e, t) {
          ((this.color = t), (this.changed = !1), (this.data = e), (this.type = new f()));
        }
        set(e, t) {
          return (
            (this.color = t), (this.changed = !1), (this.data = e), (this.type.type = u.ALL), this
          );
        }
        _ensureHSL() {
          let e = this.data,
          ...
          return g.set(
            {
              ...
              a: o ? s.channel.clamp.a(c ? parseFloat(o) / 100 : parseFloat(o)) : 1,
            },
            e,
          );
        },
          ...
          return g.set(
            {
              ...
              a: u ? s.channel.clamp.a(d ? parseFloat(u) / 100 : parseFloat(u)) : 1,
            },
            e,
          );
        },
    ...
    (D(),
      ...
      (X = (e, t, n = 50) => {
        let { r, g: i, b: a, a: o } = E.parse(e),
          ...
          h = 1 - m;
        return A(r * m + s * h, i * m + c * h, a * m + l * h, o * d + u * (1 - d));
      }));
  }),
  Q,
  $ = e(() => {
    (D(),
      ...
      (Q = (e, t = 100) => {
        let n = E.parse(e);
        return ((n.r = 255 - n.r), (n.g = 255 - n.g), (n.b = 255 - n.b), X(n, e, t));
      }));
  }),
  ee = e(() => {
    (j(), N(), z(), U(), G(), q(), Y(), $());
...
export { W as a, M as c, K as i, A as l, Q as n, H as o, J as r, R as s, te as t };
