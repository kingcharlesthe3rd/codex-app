...
function r(e) {
  ...
  let r = 1e6,
    ...
    a = 0;
  function ee(t, ee) {
    let o = Number(e.slice(t, ee));
    ((a *= r), (i = i * r + o), i >= n && ((a += (i / n) | 0), (i %= n)));
  }
  return (ee(-24, -18), ee(-18, -12), ee(-12, -6), ee(-6), t ? s(i, a) : o(i, a));
}
function i(e, t) {
  let n = o(e, t),
    r = n.hi & 2147483648;
...
function a(e, t) {
  if ((({ lo: e, hi: t } = ee(e, t)), t <= 2097151)) return String(n * t + e);
  let r = e & 16777215,
    i = ((e >>> 24) | (t << 8)) & 16777215,
    a = (t >> 16) & 65535,
    o = r + i * 6777216 + a * 6710656,
    s = i + a * 8147497,
    ne = a * 2,
    c = 1e7;
  return (
    o >= c && ((s += Math.floor(o / c)), (o %= c)),
    s >= c && ((ne += Math.floor(s / c)), (s %= c)),
    ne.toString() + te(s) + te(o)
  );
}
function ee(e, t) {
...
function re() {
  ...
  if (
    ...
    return {
      ...
      enc(t) {
        return (
          e.setBigInt64(0, this.parse(t), !0), { lo: e.getInt32(0, !0), hi: e.getInt32(4, !0) }
        );
      },
      uEnc(t) {
        return (
          e.setBigInt64(0, this.uParse(t), !0), { lo: e.getInt32(0, !0), hi: e.getInt32(4, !0) }
        );
      },
      dec(t, n) {
...
var d = class {
    ...
    int32(e) {
      return (ce(e), ne(e, this.buf), this);
    }
    bool(e) {
    ...
    sint32(e) {
      return (ce(e), (e = ((e << 1) ^ (e >> 31)) >>> 0), ne(e, this.buf), this);
    }
    sfixed64(e) {
      let t = new Uint8Array(8),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 24) break;
          i.widthEmu = T(n.int64());
          continue;
        case 4:
          if (e !== 32) break;
          i.heightEmu = T(n.int64());
          continue;
        case 5:
          if (e !== 40) break;
          i.rotation = n.int32();
...
var h = {
  encode(e, t = new d()) {
    return (
      ...
      e.transform !== void 0 && m.encode(e.transform, t.uint32(26).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.transform = m.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.value = e.value ?? ``),
      (t.transform =
        e.transform !== void 0 && e.transform !== null ? m.fromPartial(e.transform) : void 0),
...
var Ie = {
  encode(e, t = new d()) {
    ...
    for (let n of e.supplementalFonts) Pe.encode(n, t.uint32(34).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 4:
          if (e !== 34) break;
          i.supplementalFonts.push(Pe.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.supplementalFonts = e.supplementalFonts?.map((e) => Pe.fromPartial(e)) || []),
      t
    );
  },
};
...
var Re = {
  encode(e, t = new d()) {
    return (
      ...
      e.majorFont !== void 0 && Ie.encode(e.majorFont, t.uint32(18).fork()).join(),
      e.minorFont !== void 0 && Ie.encode(e.minorFont, t.uint32(26).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.majorFont = Ie.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.minorFont = Ie.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.majorFont =
        e.majorFont !== void 0 && e.majorFont !== null ? Ie.fromPartial(e.majorFont) : void 0),
      (t.minorFont =
        e.minorFont !== void 0 && e.minorFont !== null ? Ie.fromPartial(e.minorFont) : void 0),
      t
    );
  },
};
...
var Be = {
  encode(e, t = new d()) {
    return (
      e.ref !== void 0 && He.encode(e.ref, t.uint32(18).fork()).join(),
      e.fill !== void 0 && g.encode(e.fill, t.uint32(26).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 2:
          if (e !== 18) break;
          i.ref = He.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.fill = g.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = ze();
    return (
      (t.ref = e.ref !== void 0 && e.ref !== null ? He.fromPartial(e.ref) : void 0),
      (t.fill = e.fill !== void 0 && e.fill !== null ? g.fromPartial(e.fill) : void 0),
      t
    );
  },
};
...
var g = {
  encode(e, t = new d()) {
    ...
    for (let n of e.gradientStops) rt.encode(n, t.uint32(26).fork()).join();
    (e.relId !== void 0 && t.uint32(34).string(e.relId),
      ...
      e.tileRect !== void 0 && w.encode(e.tileRect, t.uint32(186).fork()).join(),
      e.imageReference !== void 0 && _.encode(e.imageReference, t.uint32(90).fork()).join(),
      ...
      e.stretchFillRect !== void 0 && w.encode(e.stretchFillRect, t.uint32(122).fork()).join(),
      e.tile !== void 0 && Ge.encode(e.tile, t.uint32(146).fork()).join(),
      e.duotone !== void 0 && v.encode(e.duotone, t.uint32(130).fork()).join(),
      e.pattern !== void 0 && qe.encode(e.pattern, t.uint32(138).fork()).join(),
      e.grayscale !== void 0 && t.uint32(152).bool(e.grayscale),
      e.rotateWithShape !== void 0 && t.uint32(160).bool(e.rotateWithShape));
    for (let n of e.pictureEffects) tt.encode(n, t.uint32(170).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.gradientStops.push(rt.decode(n, n.uint32()));
          continue;
        case 4:
          if (e !== 34) break;
          i.relId = n.string();
        ...
        case 23:
          if (e !== 186) break;
          i.tileRect = w.decode(n, n.uint32());
          continue;
        case 11:
          if (e !== 90) break;
          i.imageReference = _.decode(n, n.uint32());
          continue;
        case 12:
          if (e !== 96) break;
        ...
        case 18:
          if (e !== 146) break;
          i.tile = Ge.decode(n, n.uint32());
          continue;
        case 16:
          if (e !== 130) break;
          i.duotone = v.decode(n, n.uint32());
          continue;
        case 17:
          if (e !== 138) break;
          i.pattern = qe.decode(n, n.uint32());
          continue;
        case 19:
          if (e !== 152) break;
          i.grayscale = n.bool();
        ...
        case 21:
          if (e !== 170) break;
          i.pictureEffects.push(tt.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      (t.id = e.id ?? void 0),
      (t.type = e.type ?? 0),
      (t.color = e.color !== void 0 && e.color !== null ? h.fromPartial(e.color) : void 0),
      (t.gradientStops = e.gradientStops?.map((e) => rt.fromPartial(e)) || []),
      ...
      (t.fillRect =
        e.fillRect !== void 0 && e.fillRect !== null ? w.fromPartial(e.fillRect) : void 0),
      (t.gradientFlip = e.gradientFlip ?? void 0),
      (t.tileRect =
        e.tileRect !== void 0 && e.tileRect !== null ? w.fromPartial(e.tileRect) : void 0),
      (t.imageReference =
        e.imageReference !== void 0 && e.imageReference !== null
          ? _.fromPartial(e.imageReference)
          : void 0),
      (t.alphaModFix = e.alphaModFix ?? void 0),
      (t.lum = e.lum ?? void 0),
      (t.srcRect = e.srcRect !== void 0 && e.srcRect !== null ? w.fromPartial(e.srcRect) : void 0),
      (t.stretchFillRect =
        e.stretchFillRect !== void 0 && e.stretchFillRect !== null
          ? w.fromPartial(e.stretchFillRect)
          : void 0),
      (t.tile = e.tile !== void 0 && e.tile !== null ? Ge.fromPartial(e.tile) : void 0),
      (t.duotone = e.duotone !== void 0 && e.duotone !== null ? v.fromPartial(e.duotone) : void 0),
      (t.pattern = e.pattern !== void 0 && e.pattern !== null ? qe.fromPartial(e.pattern) : void 0),
      (t.grayscale = e.grayscale ?? void 0),
      (t.rotateWithShape = e.rotateWithShape ?? void 0),
      (t.pictureEffects = e.pictureEffects?.map((e) => tt.fromPartial(e)) || []),
      t
    );
  },
};
...
var v = {
  encode(e, t = new d()) {
    return (
      e.darkColor !== void 0 && h.encode(e.darkColor, t.uint32(10).fork()).join(),
      e.lightColor !== void 0 && h.encode(e.lightColor, t.uint32(18).fork()).join(),
      t
    );
  },
  decode(e, t) {
  ...
  fromPartial(e) {
    ...
    return (
      (t.darkColor =
        e.darkColor !== void 0 && e.darkColor !== null ? h.fromPartial(e.darkColor) : void 0),
      (t.lightColor =
        e.lightColor !== void 0 && e.lightColor !== null ? h.fromPartial(e.lightColor) : void 0),
      t
    );
  },
};
...
var $e = {
  encode(e, t = new d()) {
    return (
      e.fromColor !== void 0 && h.encode(e.fromColor, t.uint32(10).fork()).join(),
      e.toColor !== void 0 && h.encode(e.toColor, t.uint32(18).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.fromColor = h.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.toColor = h.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 24) break;
          i.useAlpha = n.bool();
  ...
  fromPartial(e) {
    ...
    return (
      (t.fromColor =
        e.fromColor !== void 0 && e.fromColor !== null ? h.fromPartial(e.fromColor) : void 0),
      (t.toColor = e.toColor !== void 0 && e.toColor !== null ? h.fromPartial(e.toColor) : void 0),
...
var tt = {
  encode(e, t = new d()) {
    return (
      ...
      e.luminance !== void 0 && Ze.encode(e.luminance, t.uint32(26).fork()).join(),
      e.duotone !== void 0 && v.encode(e.duotone, t.uint32(34).fork()).join(),
      e.biLevelThreshold !== void 0 && t.uint32(40).int32(e.biLevelThreshold),
      e.colorChange !== void 0 && $e.encode(e.colorChange, t.uint32(50).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.luminance = Ze.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
          i.duotone = v.decode(n, n.uint32());
        ...
        case 6:
          if (e !== 50) break;
          i.colorChange = $e.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.alphaModFix = e.alphaModFix ?? void 0),
      (t.luminance =
        e.luminance !== void 0 && e.luminance !== null ? Ze.fromPartial(e.luminance) : void 0),
      (t.duotone = e.duotone !== void 0 && e.duotone !== null ? v.fromPartial(e.duotone) : void 0),
      (t.biLevelThreshold = e.biLevelThreshold ?? void 0),
      (t.colorChange =
        e.colorChange !== void 0 && e.colorChange !== null
          ? $e.fromPartial(e.colorChange)
          : void 0),
      t
    );
  },
...
var y = {
  encode(e, t = new d()) {
    return (
      e.noAutofit !== void 0 && ot.encode(e.noAutofit, t.uint32(10).fork()).join(),
      e.normalAutoFit !== void 0 && ut.encode(e.normalAutoFit, t.uint32(18).fork()).join(),
      e.shapeAutoFit !== void 0 && ct.encode(e.shapeAutoFit, t.uint32(26).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.noAutofit = ot.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.normalAutoFit = ut.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.shapeAutoFit = ct.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      (t.noAutofit =
        e.noAutofit !== void 0 && e.noAutofit !== null ? ot.fromPartial(e.noAutofit) : void 0),
      (t.normalAutoFit =
        e.normalAutoFit !== void 0 && e.normalAutoFit !== null
          ? ut.fromPartial(e.normalAutoFit)
          : void 0),
      (t.shapeAutoFit =
        e.shapeAutoFit !== void 0 && e.shapeAutoFit !== null
          ? ct.fromPartial(e.shapeAutoFit)
          : void 0),
      t
    );
  },
...
var b = {
  encode(e, t = new d()) {
    return (
      ...
      e.fill !== void 0 && g.encode(e.fill, t.uint32(58).fork()).join(),
      ...
      e.autoFit !== void 0 && y.encode(e.autoFit, t.uint32(170).fork()).join(),
      e.outline !== void 0 && C.encode(e.outline, t.uint32(178).fork()).join(),
      e.shadow !== void 0 && pt.encode(e.shadow, t.uint32(186).fork()).join(),
      e.capitalization !== void 0 && t.uint32(192).int32(e.capitalization),
      e.highlight !== void 0 && h.encode(e.highlight, t.uint32(202).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 25:
          if (e !== 202) break;
          i.highlight = h.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.autoFit = e.autoFit !== void 0 && e.autoFit !== null ? y.fromPartial(e.autoFit) : void 0),
      (t.outline = e.outline !== void 0 && e.outline !== null ? C.fromPartial(e.outline) : void 0),
      (t.shadow = e.shadow !== void 0 && e.shadow !== null ? pt.fromPartial(e.shadow) : void 0),
      (t.capitalization = e.capitalization ?? void 0),
      (t.highlight =
        e.highlight !== void 0 && e.highlight !== null ? h.fromPartial(e.highlight) : void 0),
      t
    );
  },
};
...
var _t = {
  ...
  fromPartial(e) {
    let t = gt();
    return (
      (t.top = e.top !== void 0 && e.top !== null ? C.fromPartial(e.top) : void 0),
      (t.right = e.right !== void 0 && e.right !== null ? C.fromPartial(e.right) : void 0),
      (t.bottom = e.bottom !== void 0 && e.bottom !== null ? C.fromPartial(e.bottom) : void 0),
      (t.left = e.left !== void 0 && e.left !== null ? C.fromPartial(e.left) : void 0),
      t
    );
  },
};
...
var x = {
  encode(e, t = new d()) {
    ...
    for (let n of e.tabStops) ht.encode(n, t.uint32(74).fork()).join();
    return (
      e.borders !== void 0 && _t.encode(e.borders, t.uint32(82).fork()).join(),
      e.fill !== void 0 && g.encode(e.fill, t.uint32(90).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 9:
          if (e !== 74) break;
          i.tabStops.push(ht.decode(n, n.uint32()));
          continue;
        case 10:
          if (e !== 82) break;
          i.borders = _t.decode(n, n.uint32());
          continue;
        case 11:
          if (e !== 90) break;
          i.fill = g.decode(n, n.uint32());
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.tabStops = e.tabStops?.map((e) => ht.fromPartial(e)) || []),
      (t.borders = e.borders !== void 0 && e.borders !== null ? _t.fromPartial(e.borders) : void 0),
      (t.fill = e.fill !== void 0 && e.fill !== null ? g.fromPartial(e.fill) : void 0),
...
var bt = {
  encode(e, t = new d()) {
    (e.id !== `` && t.uint32(10).string(e.id),
      ...
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(34).fork()).join(),
      e.paragraphStyle !== void 0 && x.encode(e.paragraphStyle, t.uint32(42).fork()).join(),
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.textStyle =
        e.textStyle !== void 0 && e.textStyle !== null ? b.fromPartial(e.textStyle) : void 0),
      (t.paragraphStyle =
...
var S = {
  encode(e, t = new d()) {
    return (
      ...
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(26).fork()).join(),
      e.paragraphStyle !== void 0 && x.encode(e.paragraphStyle, t.uint32(34).fork()).join(),
...
var C = {
  encode(e, t = new d()) {
    return (
      ...
      e.sketch !== void 0 && Et.encode(e.sketch, t.uint32(42).fork()).join(),
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.sketch = e.sketch !== void 0 && e.sketch !== null ? Et.fromPartial(e.sketch) : void 0),
      (t.cap = e.cap ?? void 0),
...
var w = {
  ...
  fromPartial(e) {
    let t = Dt();
    return (
      (t.l = e.l ?? void 0), (t.t = e.t ?? void 0), (t.r = e.r ?? void 0), (t.b = e.b ?? void 0), t
    );
  },
};
function Ot() {
...
var jt = {
  encode(e, t = new d()) {
    return (
      ...
      e.contentLineRange !== void 0 && Nt.encode(e.contentLineRange, t.uint32(66).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 8:
          if (e !== 66) break;
          i.contentLineRange = Nt.decode(n, n.uint32());
          continue;
        case 9:
          if (e !== 74) break;
    ...
    return (
      ...
      (t.contentLineRange =
        e.contentLineRange !== void 0 && e.contentLineRange !== null
          ? Nt.fromPartial(e.contentLineRange)
          : void 0),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 8) break;
          i.startLineNum = T(n.uint64());
          continue;
        case 2:
          if (e !== 16) break;
          i.endLineNum = T(n.uint64());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
...
var qt = {
  ...
  fromPartial(e) {
    let t = Kt();
    return (
      (t.contextLength = e.contextLength ?? void 0), (t.contextHash = e.contextHash ?? void 0), t
    );
  },
};
function Jt() {
...
var Yt = {
  encode(e, t = new d()) {
    return (
      ...
      e.context !== void 0 && qt.encode(e.context, t.uint32(42).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 5:
          if (e !== 42) break;
          i.context = qt.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.length = e.length ?? 0),
      (t.context = e.context !== void 0 && e.context !== null ? qt.fromPartial(e.context) : void 0),
      t
    );
  },
};
...
var Zt = {
  encode(e, t = new d()) {
    return (
      e.spreadsheetCell !== void 0 && zt.encode(e.spreadsheetCell, t.uint32(10).fork()).join(),
      e.spreadsheetRange !== void 0 && Vt.encode(e.spreadsheetRange, t.uint32(18).fork()).join(),
      e.slide !== void 0 && Ut.encode(e.slide, t.uint32(26).fork()).join(),
      e.element !== void 0 && Gt.encode(e.element, t.uint32(34).fork()).join(),
      e.textRange !== void 0 && Yt.encode(e.textRange, t.uint32(42).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.spreadsheetCell = zt.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.spreadsheetRange = Vt.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.slide = Ut.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
          i.element = Gt.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.textRange = Yt.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      (t.spreadsheetCell =
        e.spreadsheetCell !== void 0 && e.spreadsheetCell !== null
          ? zt.fromPartial(e.spreadsheetCell)
          : void 0),
      (t.spreadsheetRange =
        e.spreadsheetRange !== void 0 && e.spreadsheetRange !== null
          ? Vt.fromPartial(e.spreadsheetRange)
          : void 0),
      (t.slide = e.slide !== void 0 && e.slide !== null ? Ut.fromPartial(e.slide) : void 0),
      (t.element = e.element !== void 0 && e.element !== null ? Gt.fromPartial(e.element) : void 0),
      (t.textRange =
        e.textRange !== void 0 && e.textRange !== null ? Yt.fromPartial(e.textRange) : void 0),
      t
    );
  },
};
...
var tn = {
  encode(e, t = new d()) {
    ...
    for (let n of e.instances) $t.encode(n, t.uint32(18).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.instances.push($t.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = en();
    return (
      (t.type = e.type ?? ``), (t.instances = e.instances?.map((e) => $t.fromPartial(e)) || []), t
    );
  },
};
function nn() {
...
var rn = {
  encode(e, t = new d()) {
    return (
      e.xEmu !== 0 && t.uint32(8).int64(e.xEmu), e.yEmu !== 0 && t.uint32(16).int64(e.yEmu), t
    );
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
...
var on = {
  encode(e, t = new d()) {
    (e.id !== `` && t.uint32(10).string(e.id),
      ...
      e.body !== void 0 && Lt.encode(e.body, t.uint32(50).fork()).join(),
      e.isDeleted !== !1 && t.uint32(56).bool(e.isDeleted));
    for (let n of e.reactions) tn.encode(n, t.uint32(66).fork()).join();
    for (let n of e.citations) t.uint32(74).string(n);
    return (e.position !== void 0 && rn.encode(e.position, t.uint32(82).fork()).join(), t);
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
      r = t === void 0 ? n.len : n.pos + t,
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 8:
          if (e !== 66) break;
          i.reactions.push(tn.decode(n, n.uint32()));
          continue;
        case 9:
          if (e !== 74) break;
        ...
        case 10:
          if (e !== 82) break;
          i.position = rn.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.body = e.body !== void 0 && e.body !== null ? Lt.fromPartial(e.body) : void 0),
      (t.isDeleted = e.isDeleted ?? !1),
      (t.reactions = e.reactions?.map((e) => tn.fromPartial(e)) || []),
      (t.citations = e.citations?.map((e) => e) || []),
      (t.position =
        e.position !== void 0 && e.position !== null ? rn.fromPartial(e.position) : void 0),
      t
    );
  },
};
...
var cn = {
    encode(e, t = new d()) {
      (e.id !== `` && t.uint32(10).string(e.id),
        e.target !== void 0 && Zt.encode(e.target, t.uint32(18).fork()).join());
      for (let n of e.comments) on.encode(n, t.uint32(26).fork()).join();
      return (
    ...
    decode(e, t) {
      ...
      for (; n.pos < r; ) {
        ...
        switch (e >>> 3) {
          ...
          case 2:
            if (e !== 18) break;
            i.target = Zt.decode(n, n.uint32());
            continue;
          case 3:
            if (e !== 26) break;
            i.comments.push(on.decode(n, n.uint32()));
            continue;
          case 4:
            if (e !== 32) break;
            i.status = n.int32();
    ...
    fromPartial(e) {
      ...
      return (
        (t.id = e.id ?? ``),
        (t.target = e.target !== void 0 && e.target !== null ? Zt.fromPartial(e.target) : void 0),
        (t.comments = e.comments?.map((e) => on.fromPartial(e)) || []),
        (t.status = e.status ?? 0),
...
function T(e) {
  let t = ln.Number(e.toString());
  if (t > ln.Number.MAX_SAFE_INTEGER)
    throw new ln.Error(`Value is larger than Number.MAX_SAFE_INTEGER`);
  if (t < ln.Number.MIN_SAFE_INTEGER)
    throw new ln.Error(`Value is smaller than Number.MIN_SAFE_INTEGER`);
  return t;
}
var un = (function (e) {
    return (
...
var zn = {
  encode(e, t = new d()) {
    ...
    for (let n of e.series) Zn.encode(n, t.uint32(26).fork()).join();
    (e.bbox !== void 0 && p.encode(e.bbox, t.uint32(34).fork()).join(),
      e.type !== 0 && t.uint32(40).int32(e.type),
      ...
      e.legend !== void 0 && qn.encode(e.legend, t.uint32(98).fork()).join(),
      e.titleTextStyle !== void 0 && b.encode(e.titleTextStyle, t.uint32(106).fork()).join(),
      e.dataLabels !== void 0 && k.encode(e.dataLabels, t.uint32(114).fork()).join(),
      e.chartFill !== void 0 && g.encode(e.chartFill, t.uint32(122).fork()).join(),
      e.chartLine !== void 0 && C.encode(e.chartLine, t.uint32(130).fork()).join(),
      e.chartSpaceFill !== void 0 && g.encode(e.chartSpaceFill, t.uint32(194).fork()).join(),
      e.chartSpaceLine !== void 0 && C.encode(e.chartSpaceLine, t.uint32(202).fork()).join(),
      e.roundedCorners !== void 0 && t.uint32(208).bool(e.roundedCorners),
      e.plotAreaFill !== void 0 && g.encode(e.plotAreaFill, t.uint32(138).fork()).join(),
      e.plotAreaLine !== void 0 && C.encode(e.plotAreaLine, t.uint32(146).fork()).join(),
    ...
    (e.mapOptions !== void 0 && Nr.encode(e.mapOptions, t.uint32(178).fork()).join(),
      ...
      e.barOptions !== void 0 && Yn.encode(e.barOptions, t.uint32(402).fork()).join(),
      e.lineOptions !== void 0 && dr.encode(e.lineOptions, t.uint32(410).fork()).join(),
      e.areaOptions !== void 0 && pr.encode(e.areaOptions, t.uint32(418).fork()).join(),
      e.pieOptions !== void 0 && hr.encode(e.pieOptions, t.uint32(426).fork()).join(),
      e.ofPieOptions !== void 0 && _r.encode(e.ofPieOptions, t.uint32(474).fork()).join(),
      e.doughnutOptions !== void 0 && yr.encode(e.doughnutOptions, t.uint32(434).fork()).join(),
      e.scatterOptions !== void 0 && xr.encode(e.scatterOptions, t.uint32(442).fork()).join(),
    ...
    for (let n of e.chartGroups) Gn.encode(n, t.uint32(482).fork()).join();
    ...
    for (let n of e.titleParagraphs) Vn.encode(n, t.uint32(514).fork()).join();
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.series.push(Zn.decode(n, n.uint32()));
          continue;
        case 4:
          if (e !== 34) break;
          i.bbox = p.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 40) break;
          i.type = n.int32();
        ...
        case 15:
          if (e !== 122) break;
          i.chartFill = g.decode(n, n.uint32());
          continue;
        case 16:
          if (e !== 130) break;
        ...
        case 24:
          if (e !== 194) break;
          i.chartSpaceFill = g.decode(n, n.uint32());
          continue;
        case 25:
          if (e !== 202) break;
        ...
        case 17:
          if (e !== 138) break;
          i.plotAreaFill = g.decode(n, n.uint32());
          continue;
        case 18:
          if (e !== 146) break;
        ...
        case 50:
          if (e !== 402) break;
          i.barOptions = Yn.decode(n, n.uint32());
          continue;
        case 51:
          if (e !== 410) break;
          i.lineOptions = dr.decode(n, n.uint32());
          continue;
        case 52:
          if (e !== 418) break;
          i.areaOptions = pr.decode(n, n.uint32());
          continue;
        case 53:
          if (e !== 426) break;
          i.pieOptions = hr.decode(n, n.uint32());
          continue;
        case 59:
          if (e !== 474) break;
          i.ofPieOptions = _r.decode(n, n.uint32());
          continue;
        case 54:
          if (e !== 434) break;
          i.doughnutOptions = yr.decode(n, n.uint32());
          continue;
        case 55:
          if (e !== 442) break;
          i.scatterOptions = xr.decode(n, n.uint32());
          continue;
        case 56:
          if (e !== 450) break;
        ...
        case 60:
          if (e !== 482) break;
          i.chartGroups.push(Gn.decode(n, n.uint32()));
          continue;
        case 63:
          if (e !== 506) break;
        ...
        case 64:
          if (e !== 514) break;
          i.titleParagraphs.push(Vn.decode(n, n.uint32()));
          continue;
        case 61:
          if (e !== 490) break;
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.series = e.series?.map((e) => Zn.fromPartial(e)) || []),
      (t.bbox = e.bbox !== void 0 && e.bbox !== null ? p.fromPartial(e.bbox) : void 0),
      (t.type = e.type ?? 0),
      ...
      (t.legend = e.legend !== void 0 && e.legend !== null ? qn.fromPartial(e.legend) : void 0),
      (t.titleTextStyle =
      ...
      (t.chartFill =
        e.chartFill !== void 0 && e.chartFill !== null ? g.fromPartial(e.chartFill) : void 0),
      (t.chartLine =
        e.chartLine !== void 0 && e.chartLine !== null ? C.fromPartial(e.chartLine) : void 0),
      (t.chartSpaceFill =
        e.chartSpaceFill !== void 0 && e.chartSpaceFill !== null
          ? g.fromPartial(e.chartSpaceFill)
          : void 0),
      (t.chartSpaceLine =
      ...
      (t.barOptions =
        e.barOptions !== void 0 && e.barOptions !== null ? Yn.fromPartial(e.barOptions) : void 0),
      (t.lineOptions =
        e.lineOptions !== void 0 && e.lineOptions !== null
          ? dr.fromPartial(e.lineOptions)
          : void 0),
      (t.areaOptions =
        e.areaOptions !== void 0 && e.areaOptions !== null
          ? pr.fromPartial(e.areaOptions)
          : void 0),
      (t.pieOptions =
        e.pieOptions !== void 0 && e.pieOptions !== null ? hr.fromPartial(e.pieOptions) : void 0),
      (t.ofPieOptions =
        e.ofPieOptions !== void 0 && e.ofPieOptions !== null
          ? _r.fromPartial(e.ofPieOptions)
          : void 0),
      (t.doughnutOptions =
        e.doughnutOptions !== void 0 && e.doughnutOptions !== null
          ? yr.fromPartial(e.doughnutOptions)
          : void 0),
      (t.scatterOptions =
        e.scatterOptions !== void 0 && e.scatterOptions !== null
          ? xr.fromPartial(e.scatterOptions)
          : void 0),
      (t.bubbleOptions =
      ...
      (t.surfaceOptions =
        e.surfaceOptions !== void 0 && e.surfaceOptions !== null
          ...
          : void 0),
      (t.chartGroups = e.chartGroups?.map((e) => Gn.fromPartial(e)) || []),
      ...
      (t.titleParagraphs = e.titleParagraphs?.map((e) => Vn.fromPartial(e)) || []),
      (t.externalData =
...
var Vn = {
  encode(e, t = new d()) {
    for (let n of e.runs) Un.encode(n, t.uint32(10).fork()).join();
    return (
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(18).fork()).join(),
      e.paragraphStyle !== void 0 && x.encode(e.paragraphStyle, t.uint32(26).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.runs.push(Un.decode(n, n.uint32()));
          continue;
        case 2:
          if (e !== 18) break;
          i.textStyle = b.decode(n, n.uint32());
  ...
  fromPartial(e) {
    let t = Bn();
    return (
      (t.runs = e.runs?.map((e) => Un.fromPartial(e)) || []),
      (t.textStyle =
        e.textStyle !== void 0 && e.textStyle !== null ? b.fromPartial(e.textStyle) : void 0),
      (t.paragraphStyle =
        e.paragraphStyle !== void 0 && e.paragraphStyle !== null
...
var Gn = {
  encode(e, t = new d()) {
    e.type !== 0 && t.uint32(8).int32(e.type);
    for (let n of e.series) Zn.encode(n, t.uint32(18).fork()).join();
    (e.dataLabels !== void 0 && k.encode(e.dataLabels, t.uint32(26).fork()).join(),
      e.barOptions !== void 0 && Yn.encode(e.barOptions, t.uint32(34).fork()).join(),
      e.lineOptions !== void 0 && dr.encode(e.lineOptions, t.uint32(42).fork()).join(),
      e.areaOptions !== void 0 && pr.encode(e.areaOptions, t.uint32(50).fork()).join(),
      e.scatterOptions !== void 0 && xr.encode(e.scatterOptions, t.uint32(66).fork()).join(),
...
var qn = {
  encode(e, t = new d()) {
    return (
      ...
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(26).fork()).join(),
      e.fill !== void 0 && g.encode(e.fill, t.uint32(34).fork()).join(),
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.textStyle =
        e.textStyle !== void 0 && e.textStyle !== null ? b.fromPartial(e.textStyle) : void 0),
      (t.fill = e.fill !== void 0 && e.fill !== null ? g.fromPartial(e.fill) : void 0),
      (t.stroke = e.stroke !== void 0 && e.stroke !== null ? C.fromPartial(e.stroke) : void 0),
      t
    );
  },
};
...
var Zn = {
  encode(e, t = new d()) {
    ...
    for (let n of e.trendlines) lr.encode(n, t.uint32(202).fork()).join();
    for (let n of e.errorBars) $n.encode(n, t.uint32(210).fork()).join();
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 25:
          if (e !== 202) break;
          i.trendlines.push(lr.decode(n, n.uint32()));
          continue;
        case 26:
          if (e !== 210) break;
          i.errorBars.push($n.decode(n, n.uint32()));
          continue;
        case 27:
          if (e !== 216) break;
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.trendlines = e.trendlines?.map((e) => lr.fromPartial(e)) || []),
      (t.errorBars = e.errorBars?.map((e) => $n.fromPartial(e)) || []),
...
var $n = {
  encode(e, t = new d()) {
    return (
      ...
      e.fill !== void 0 && g.encode(e.fill, t.uint32(50).fork()).join(),
      e.stroke !== void 0 && C.encode(e.stroke, t.uint32(58).fork()).join(),
      e.plus !== void 0 && tr.encode(e.plus, t.uint32(66).fork()).join(),
      e.minus !== void 0 && tr.encode(e.minus, t.uint32(74).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 8:
          if (e !== 66) break;
          i.plus = tr.decode(n, n.uint32());
          continue;
        case 9:
          if (e !== 74) break;
          i.minus = tr.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.fill = e.fill !== void 0 && e.fill !== null ? g.fromPartial(e.fill) : void 0),
      (t.stroke = e.stroke !== void 0 && e.stroke !== null ? C.fromPartial(e.stroke) : void 0),
      (t.plus = e.plus !== void 0 && e.plus !== null ? tr.fromPartial(e.plus) : void 0),
      (t.minus = e.minus !== void 0 && e.minus !== null ? tr.fromPartial(e.minus) : void 0),
      t
    );
  },
};
...
var rr = {
  ...
  fromPartial(e) {
    let t = nr();
    return (
      (t.x = e.x ?? void 0), (t.y = e.y ?? void 0), (t.w = e.w ?? void 0), (t.h = e.h ?? void 0), t
    );
  },
};
function ir() {
...
var ar = {
  encode(e, t = new d()) {
    (e.text !== void 0 && t.uint32(10).string(e.text),
      ...
      e.manualLayout !== void 0 && rr.encode(e.manualLayout, t.uint32(34).fork()).join(),
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(42).fork()).join(),
      e.fill !== void 0 && g.encode(e.fill, t.uint32(50).fork()).join(),
      e.stroke !== void 0 && C.encode(e.stroke, t.uint32(58).fork()).join());
    for (let n of e.textRuns) sr.encode(n, t.uint32(66).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 4:
          if (e !== 34) break;
          i.manualLayout = rr.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.textStyle = b.decode(n, n.uint32());
        ...
        case 8:
          if (e !== 66) break;
          i.textRuns.push(sr.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.manualLayout =
        e.manualLayout !== void 0 && e.manualLayout !== null
          ? rr.fromPartial(e.manualLayout)
          : void 0),
      (t.textStyle =
        e.textStyle !== void 0 && e.textStyle !== null ? b.fromPartial(e.textStyle) : void 0),
      (t.fill = e.fill !== void 0 && e.fill !== null ? g.fromPartial(e.fill) : void 0),
      (t.stroke = e.stroke !== void 0 && e.stroke !== null ? C.fromPartial(e.stroke) : void 0),
      (t.textRuns = e.textRuns?.map((e) => sr.fromPartial(e)) || []),
      t
    );
  },
};
...
var lr = {
  encode(e, t = new d()) {
    return (
      ...
      e.label !== void 0 && ar.encode(e.label, t.uint32(90).fork()).join(),
      t
    );
  },
  decode(e, t) {
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.stroke = e.stroke !== void 0 && e.stroke !== null ? C.fromPartial(e.stroke) : void 0),
      (t.label = e.label !== void 0 && e.label !== null ? ar.fromPartial(e.label) : void 0),
      t
    );
  },
};
...
var hr = {
  ...
  fromPartial(e) {
    let t = mr();
    return (
      (t.firstSliceAngle = e.firstSliceAngle ?? void 0), (t.varyColors = e.varyColors ?? void 0), t
    );
  },
};
function gr() {
...
var Dr = {
  encode(e, t = new d()) {
    return (
      ...
      e.fill !== void 0 && g.encode(e.fill, t.uint32(18).fork()).join(),
...
var O = {
  encode(e, t = new d()) {
    return (
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(10).fork()).join(),
      ...
      e.majorGridlines !== void 0 && C.encode(e.majorGridlines, t.uint32(42).fork()).join(),
      e.minorGridlines !== void 0 && C.encode(e.minorGridlines, t.uint32(50).fork()).join(),
      ...
      e.titleTextStyle !== void 0 && b.encode(e.titleTextStyle, t.uint32(162).fork()).join(),
  ...
  fromPartial(e) {
    ...
    return (
      (t.textStyle =
        e.textStyle !== void 0 && e.textStyle !== null ? b.fromPartial(e.textStyle) : void 0),
      (t.line = e.line !== void 0 && e.line !== null ? C.fromPartial(e.line) : void 0),
      (t.min = e.min ?? void 0),
      (t.max = e.max ?? void 0),
      (t.majorGridlines =
...
var k = {
  encode(e, t = new d()) {
    return (
      ...
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(26).fork()).join(),
      e.leaderLine !== void 0 && C.encode(e.leaderLine, t.uint32(34).fork()).join(),
      e.fill !== void 0 && g.encode(e.fill, t.uint32(42).fork()).join(),
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.textStyle =
        e.textStyle !== void 0 && e.textStyle !== null ? b.fromPartial(e.textStyle) : void 0),
      (t.leaderLine =
        e.leaderLine !== void 0 && e.leaderLine !== null ? C.fromPartial(e.leaderLine) : void 0),
      (t.fill = e.fill !== void 0 && e.fill !== null ? g.fromPartial(e.fill) : void 0),
      (t.stroke = e.stroke !== void 0 && e.stroke !== null ? C.fromPartial(e.stroke) : void 0),
...
var Yr = {
  encode(e, t = new d()) {
    ...
    for (let n of e.colorStyleVariations) m.encode(n, t.uint32(66).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 8:
          if (e !== 66) break;
          i.colorStyleVariations.push(m.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.chartStyleMarkerLayout =
        e.chartStyleMarkerLayout !== void 0 && e.chartStyleMarkerLayout !== null
          ...
          : void 0),
      (t.colorStyleVariations = e.colorStyleVariations?.map((e) => m.fromPartial(e)) || []),
      t
    );
  },
};
...
var ei = {
  encode(e, t = new d()) {
    return (
      ...
      e.autoFit !== void 0 && y.encode(e.autoFit, t.uint32(90).fork()).join(),
      t
    );
  },
  decode(e, t) {
...
var ni = {
  encode(e, t = new d()) {
    return (
      ...
      e.fill !== void 0 && g.encode(e.fill, t.uint32(58).fork()).join(),
      e.line !== void 0 && C.encode(e.line, t.uint32(66).fork()).join(),
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(82).fork()).join(),
...
var ii = {
  ...
  fromPartial(e) {
    let t = ri();
    return (
      (t.type = e.type ?? void 0), (t.colors = e.colors?.map((e) => h.fromPartial(e)) || []), t
    );
  },
};
function ai() {
...
var ui = {
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.fill = e.fill !== void 0 && e.fill !== null ? g.fromPartial(e.fill) : void 0),
      (t.stroke = e.stroke !== void 0 && e.stroke !== null ? C.fromPartial(e.stroke) : void 0),
      (t.text = e.text !== void 0 && e.text !== null ? b.fromPartial(e.text) : void 0),
      t
    );
  },
};
...
var j = {
  encode(e, t = new d()) {
    return (
      ...
      e.fill !== void 0 && g.encode(e.fill, t.uint32(26).fork()).join(),
      e.stroke !== void 0 && C.encode(e.stroke, t.uint32(34).fork()).join(),
      t
    );
  },
  decode(e, t) {
...
var Vi = {
  ...
  fromPartial(e) {
    let t = Bi();
    return (
      (t.text = e.text ?? ``), (t.kind = e.kind ?? void 0), (t.language = e.language ?? void 0), t
    );
  },
};
function Hi() {
...
var ya = {
  ...
  Ea = (function (e) {
    return (
      (e[(e.GUIDE_ORIENTATION_UNSPECIFIED = 0)] = `GUIDE_ORIENTATION_UNSPECIFIED`),
      (e[(e.GUIDE_ORIENTATION_HORIZONTAL = 1)] = `GUIDE_ORIENTATION_HORIZONTAL`),
      (e[(e.GUIDE_ORIENTATION_VERTICAL = 2)] = `GUIDE_ORIENTATION_VERTICAL`),
      (e[(e.UNRECOGNIZED = -1)] = `UNRECOGNIZED`),
      e
    );
  })({}),
...
var Fa = {
  encode(e, t = new d()) {
    ...
    for (let n of e.layouts) Xa.encode(n, t.uint32(26).fork()).join();
    for (let n of e.charts) zn.encode(n, t.uint32(74).fork()).join();
    for (let n of e.images) kt.encode(n, t.uint32(34).fork()).join();
    for (let n of e.contentReferences) jt.encode(n, t.uint32(42).fork()).join();
    for (let n of e.people) Ft.encode(n, t.uint32(90).fork()).join();
    for (let n of e.threads) cn.encode(n, t.uint32(98).fork()).join();
    for (let n of e.textStyles) bt.encode(n, t.uint32(50).fork()).join();
    return (
      e.tableStyles !== void 0 && Ha.encode(e.tableStyles, t.uint32(58).fork()).join(),
      e.viewProperties !== void 0 && Wa.encode(e.viewProperties, t.uint32(66).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.layouts.push(Xa.decode(n, n.uint32()));
          continue;
        case 9:
          if (e !== 74) break;
          i.charts.push(zn.decode(n, n.uint32()));
          continue;
        case 4:
          if (e !== 34) break;
          i.images.push(kt.decode(n, n.uint32()));
          continue;
        case 5:
          if (e !== 42) break;
          i.contentReferences.push(jt.decode(n, n.uint32()));
          continue;
        case 11:
          if (e !== 90) break;
          i.people.push(Ft.decode(n, n.uint32()));
          continue;
        case 12:
          if (e !== 98) break;
          i.threads.push(cn.decode(n, n.uint32()));
          continue;
        case 6:
          if (e !== 50) break;
          i.textStyles.push(bt.decode(n, n.uint32()));
          continue;
        case 7:
          if (e !== 58) break;
          i.tableStyles = Ha.decode(n, n.uint32());
          continue;
        case 8:
          if (e !== 66) break;
          i.viewProperties = Wa.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.layouts = e.layouts?.map((e) => Xa.fromPartial(e)) || []),
      (t.charts = e.charts?.map((e) => zn.fromPartial(e)) || []),
      (t.images = e.images?.map((e) => kt.fromPartial(e)) || []),
      (t.contentReferences = e.contentReferences?.map((e) => jt.fromPartial(e)) || []),
      (t.people = e.people?.map((e) => Ft.fromPartial(e)) || []),
      (t.threads = e.threads?.map((e) => cn.fromPartial(e)) || []),
      (t.textStyles = e.textStyles?.map((e) => bt.fromPartial(e)) || []),
      (t.tableStyles =
        e.tableStyles !== void 0 && e.tableStyles !== null
          ? Ha.fromPartial(e.tableStyles)
          : void 0),
      (t.viewProperties =
        e.viewProperties !== void 0 && e.viewProperties !== null
          ? Wa.fromPartial(e.viewProperties)
          : void 0),
      t
    );
  },
...
var N = {
  encode(e, t = new d()) {
    e.colorScheme !== void 0 && Ra.encode(e.colorScheme, t.uint32(10).fork()).join();
    for (let n of e.backgroundFillStyleList) g.encode(n, t.uint32(18).fork()).join();
    for (let n of e.fillStyleList) g.encode(n, t.uint32(58).fork()).join();
    for (let n of e.lineStyleList) C.encode(n, t.uint32(26).fork()).join();
    for (let n of e.effectStyleList) Os.encode(n, t.uint32(34).fork()).join();
    return (
      e.fontScheme !== void 0 && Re.encode(e.fontScheme, t.uint32(42).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.colorScheme = Ra.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.backgroundFillStyleList.push(g.decode(n, n.uint32()));
          continue;
        case 7:
          if (e !== 58) break;
          i.fillStyleList.push(g.decode(n, n.uint32()));
          continue;
        case 3:
          if (e !== 26) break;
        ...
        case 4:
          if (e !== 34) break;
          i.effectStyleList.push(Os.decode(n, n.uint32()));
          continue;
        case 5:
          if (e !== 42) break;
          i.fontScheme = Re.decode(n, n.uint32());
          continue;
        case 6:
          if (e !== 50) break;
          i.name = n.string();
    ...
    return (
      (t.colorScheme =
        e.colorScheme !== void 0 && e.colorScheme !== null
          ? Ra.fromPartial(e.colorScheme)
          : void 0),
      (t.backgroundFillStyleList = e.backgroundFillStyleList?.map((e) => g.fromPartial(e)) || []),
      (t.fillStyleList = e.fillStyleList?.map((e) => g.fromPartial(e)) || []),
      (t.lineStyleList = e.lineStyleList?.map((e) => C.fromPartial(e)) || []),
      (t.effectStyleList = e.effectStyleList?.map((e) => Os.fromPartial(e)) || []),
      (t.fontScheme =
        e.fontScheme !== void 0 && e.fontScheme !== null ? Re.fromPartial(e.fontScheme) : void 0),
      (t.name = e.name ?? void 0),
      t
    );
  },
...
var Ra = {
  encode(e, t = new d()) {
    e.name !== `` && t.uint32(10).string(e.name);
    for (let n of e.colors) Ba.encode(n, t.uint32(18).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.colors.push(Ba.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = La();
    return ((t.name = e.name ?? ``), (t.colors = e.colors?.map((e) => Ba.fromPartial(e)) || []), t);
  },
};
function za() {
...
var Ha = {
  ...
  fromPartial(e) {
    let t = Va();
    return (
      (t.defaultStyleId = e.defaultStyleId ?? void 0), (t.outerXml = e.outerXml ?? void 0), t
    );
  },
};
function Ua() {
...
var Wa = {
  encode(e, t = new d()) {
    return (
      e.gridSpacingCxEmu !== void 0 && t.uint32(8).int64(e.gridSpacingCxEmu),
      e.gridSpacingCyEmu !== void 0 && t.uint32(16).int64(e.gridSpacingCyEmu),
      e.slideViewSnapToGrid !== void 0 && t.uint32(24).bool(e.slideViewSnapToGrid),
      e.slideViewSnapToObjects !== void 0 && t.uint32(32).bool(e.slideViewSnapToObjects),
      e.slideViewShowGuides !== void 0 && t.uint32(40).bool(e.slideViewShowGuides),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 8) break;
          i.gridSpacingCxEmu = $(n.int64());
          continue;
        case 2:
          if (e !== 16) break;
          i.gridSpacingCyEmu = $(n.int64());
          continue;
        case 3:
          if (e !== 24) break;
...
var Ka = {
  encode(e, t = new d()) {
    return (
      ...
      e.color !== void 0 && h.encode(e.color, t.uint32(50).fork()).join(),
      t
    );
  },
  decode(e, t) {
...
var Xa = {
  encode(e, t = new d()) {
    (e.id !== `` && t.uint32(10).string(e.id),
      ...
      e.background !== void 0 && Be.encode(e.background, t.uint32(82).fork()).join());
    ...
    (e.parentLayoutId !== `` && t.uint32(122).string(e.parentLayoutId),
      e.colorMap !== void 0 && Ys.encode(e.colorMap, t.uint32(130).fork()).join(),
      ...
      e.furnitureVisibility !== void 0 &&
        Ja.encode(e.furnitureVisibility, t.uint32(186).fork()).join());
    for (let n of e.slideGuides) Ka.encode(n, t.uint32(194).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 10:
          if (e !== 82) break;
          i.background = Be.decode(n, n.uint32());
          continue;
        case 11:
          if (e !== 90) break;
        ...
        case 16:
          if (e !== 130) break;
          i.colorMap = Ys.decode(n, n.uint32());
          continue;
        case 17:
          if (e !== 138) break;
          i.theme = N.decode(n, n.uint32());
        ...
        case 23:
          if (e !== 186) break;
          i.furnitureVisibility = Ja.decode(n, n.uint32());
          continue;
        case 24:
          if (e !== 194) break;
          i.slideGuides.push(Ka.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.type = e.type ?? ``),
      (t.background =
        e.background !== void 0 && e.background !== null ? Be.fromPartial(e.background) : void 0),
      (t.elements = e.elements?.map((e) => F.fromPartial(e)) || []),
      (t.bodyLevelStyles = e.bodyLevelStyles?.map((e) => S.fromPartial(e)) || []),
      (t.titleLevelStyles = e.titleLevelStyles?.map((e) => S.fromPartial(e)) || []),
      (t.otherLevelStyles = e.otherLevelStyles?.map((e) => S.fromPartial(e)) || []),
      (t.parentLayoutId = e.parentLayoutId ?? ``),
      (t.colorMap =
        e.colorMap !== void 0 && e.colorMap !== null ? Ys.fromPartial(e.colorMap) : void 0),
      (t.theme = e.theme !== void 0 && e.theme !== null ? N.fromPartial(e.theme) : void 0),
      ...
      (t.furnitureVisibility =
        e.furnitureVisibility !== void 0 && e.furnitureVisibility !== null
          ? Ja.fromPartial(e.furnitureVisibility)
          : void 0),
      (t.slideGuides = e.slideGuides?.map((e) => Ka.fromPartial(e)) || []),
      t
    );
  },
};
...
var F = {
  encode(e, t = new d()) {
    (e.bbox !== void 0 && p.encode(e.bbox, t.uint32(10).fork()).join(),
      e.zIndex !== void 0 && t.uint32(16).int32(e.zIndex),
      e.innerXml !== void 0 && t.uint32(58).string(e.innerXml),
      e.outerXml !== void 0 && t.uint32(66).string(e.outerXml),
      e.shape !== void 0 && Vs.encode(e.shape, t.uint32(34).fork()).join(),
      e.image !== void 0 && Gs.encode(e.image, t.uint32(42).fork()).join(),
      e.chartReference !== void 0 && fo.encode(e.chartReference, t.uint32(146).fork()).join(),
      e.video !== void 0 && qs.encode(e.video, t.uint32(162).fork()).join(),
      e.table !== void 0 && ts.encode(e.table, t.uint32(170).fork()).join(),
      e.imageReference !== void 0 && _.encode(e.imageReference, t.uint32(26).fork()).join(),
      e.codeBlock !== void 0 && xc.encode(e.codeBlock, t.uint32(74).fork()).join(),
      e.embeddedArtifact !== void 0 && mo.encode(e.embeddedArtifact, t.uint32(290).fork()).join(),
      e.smartArt !== void 0 && go.encode(e.smartArt, t.uint32(306).fork()).join());
    ...
    (e.name !== void 0 && t.uint32(82).string(e.name),
      ...
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(114).fork()).join());
    for (let n of e.effects) Y.encode(n, t.uint32(122).fork()).join();
    for (let n of e.children) F.encode(n, t.uint32(138).fork()).join();
    e.groupChildBbox !== void 0 && p.encode(e.groupChildBbox, t.uint32(330).fork()).join();
    for (let n of e.levelsStyles) S.encode(n, t.uint32(130).fork()).join();
    (e.fill !== void 0 && g.encode(e.fill, t.uint32(154).fork()).join(),
      e.line !== void 0 && C.encode(e.line, t.uint32(242).fork()).join(),
      e.scene3d !== void 0 && to.encode(e.scene3d, t.uint32(250).fork()).join(),
      e.shape3d !== void 0 && ro.encode(e.shape3d, t.uint32(258).fork()).join(),
      ...
      e.placement !== void 0 && Zo.encode(e.placement, t.uint32(282).fork()).join(),
      e.connector !== void 0 && $o.encode(e.connector, t.uint32(226).fork()).join());
    ...
    return (
      ...
      e.pictureHasPresetGeometry !== void 0 && t.uint32(320).bool(e.pictureHasPresetGeometry),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 4:
          if (e !== 34) break;
          i.shape = Vs.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.image = Gs.decode(n, n.uint32());
          continue;
        case 18:
          if (e !== 146) break;
          i.chartReference = fo.decode(n, n.uint32());
          continue;
        case 20:
          if (e !== 162) break;
          i.video = qs.decode(n, n.uint32());
          continue;
        case 21:
          if (e !== 170) break;
          i.table = ts.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.imageReference = _.decode(n, n.uint32());
        ...
        case 9:
          if (e !== 74) break;
          i.codeBlock = xc.decode(n, n.uint32());
          continue;
        case 36:
          if (e !== 290) break;
          i.embeddedArtifact = mo.decode(n, n.uint32());
          continue;
        case 38:
          if (e !== 306) break;
          i.smartArt = go.decode(n, n.uint32());
          continue;
        case 6:
          if (e !== 50) break;
        ...
        case 41:
          if (e !== 330) break;
          i.groupChildBbox = p.decode(n, n.uint32());
          continue;
        case 16:
          if (e !== 130) break;
        ...
        case 31:
          if (e !== 250) break;
          i.scene3d = to.decode(n, n.uint32());
          continue;
        case 32:
          if (e !== 258) break;
          i.shape3d = ro.decode(n, n.uint32());
          continue;
        case 33:
          if (e !== 266) break;
        ...
        case 35:
          if (e !== 282) break;
          i.placement = Zo.decode(n, n.uint32());
          continue;
        case 28:
          if (e !== 226) break;
          i.connector = $o.decode(n, n.uint32());
          continue;
        case 29:
          if (e !== 234) break;
          i.citations.push(n.string());
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.innerXml = e.innerXml ?? void 0),
      (t.outerXml = e.outerXml ?? void 0),
      (t.shape = e.shape !== void 0 && e.shape !== null ? Vs.fromPartial(e.shape) : void 0),
      (t.image = e.image !== void 0 && e.image !== null ? Gs.fromPartial(e.image) : void 0),
      (t.chartReference =
        e.chartReference !== void 0 && e.chartReference !== null
          ? fo.fromPartial(e.chartReference)
          : void 0),
      (t.video = e.video !== void 0 && e.video !== null ? qs.fromPartial(e.video) : void 0),
      (t.table = e.table !== void 0 && e.table !== null ? ts.fromPartial(e.table) : void 0),
      (t.imageReference =
        e.imageReference !== void 0 && e.imageReference !== null
          ? _.fromPartial(e.imageReference)
          : void 0),
      (t.codeBlock =
        e.codeBlock !== void 0 && e.codeBlock !== null ? xc.fromPartial(e.codeBlock) : void 0),
      (t.embeddedArtifact =
        e.embeddedArtifact !== void 0 && e.embeddedArtifact !== null
          ? mo.fromPartial(e.embeddedArtifact)
          : void 0),
      (t.smartArt =
        e.smartArt !== void 0 && e.smartArt !== null ? go.fromPartial(e.smartArt) : void 0),
      ...
      (t.groupChildBbox =
        e.groupChildBbox !== void 0 && e.groupChildBbox !== null
          ? p.fromPartial(e.groupChildBbox)
          : void 0),
      (t.levelsStyles = e.levelsStyles?.map((e) => S.fromPartial(e)) || []),
      (t.fill = e.fill !== void 0 && e.fill !== null ? g.fromPartial(e.fill) : void 0),
      (t.line = e.line !== void 0 && e.line !== null ? C.fromPartial(e.line) : void 0),
      (t.scene3d = e.scene3d !== void 0 && e.scene3d !== null ? to.fromPartial(e.scene3d) : void 0),
      (t.shape3d = e.shape3d !== void 0 && e.shape3d !== null ? ro.fromPartial(e.shape3d) : void 0),
      (t.imageMask =
      ...
      (t.creationId = e.creationId ?? void 0),
      (t.placement =
        e.placement !== void 0 && e.placement !== null ? Zo.fromPartial(e.placement) : void 0),
      (t.connector =
        e.connector !== void 0 && e.connector !== null ? $o.fromPartial(e.connector) : void 0),
      (t.citations = e.citations?.map((e) => e) || []),
...
var to = {
  encode(e, t = new d()) {
    return (
      e.camera !== void 0 && oo.encode(e.camera, t.uint32(10).fork()).join(),
      e.lightRig !== void 0 && co.encode(e.lightRig, t.uint32(18).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.camera = oo.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.lightRig = co.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = eo();
    return (
      (t.camera = e.camera !== void 0 && e.camera !== null ? oo.fromPartial(e.camera) : void 0),
      (t.lightRig =
        e.lightRig !== void 0 && e.lightRig !== null ? co.fromPartial(e.lightRig) : void 0),
      t
    );
  },
};
...
var ro = {
  encode(e, t = new d()) {
    return (
      ...
      e.extrusionColor !== void 0 && h.encode(e.extrusionColor, t.uint32(58).fork()).join(),
      e.contourColor !== void 0 && h.encode(e.contourColor, t.uint32(66).fork()).join(),
      t
    );
  },
  decode(e, t) {
  ...
  encode(e, t = new d()) {
    return (
      ...
      e.previewImageReference !== void 0 &&
        _.encode(e.previewImageReference, t.uint32(18).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.previewImageReference = _.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.previewImageReference =
        e.previewImageReference !== void 0 && e.previewImageReference !== null
          ? _.fromPartial(e.previewImageReference)
          : void 0),
      t
    );
  },
...
var go = {
  encode(e, t = new d()) {
    return (
      e.dataModel !== void 0 && Uo.encode(e.dataModel, t.uint32(50).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 6:
          if (e !== 50) break;
          i.dataModel = Uo.decode(n, n.uint32());
          continue;
        case 11:
          if (e !== 90) break;
  ...
  fromPartial(e) {
    ...
    return (
      (t.dataModel =
        e.dataModel !== void 0 && e.dataModel !== null ? Uo.fromPartial(e.dataModel) : void 0),
      (t.layoutNode =
...
var B = {
  encode(e, t = new d()) {
    return (
      ...
      e.algorithm !== void 0 && bo.encode(e.algorithm, t.uint32(18).fork()).join(),
      e.shape !== void 0 && wo.encode(e.shape, t.uint32(26).fork()).join(),
      e.presentationOf !== void 0 && Do.encode(e.presentationOf, t.uint32(34).fork()).join(),
      e.forEach !== void 0 && ko.encode(e.forEach, t.uint32(42).fork()).join(),
      e.choose !== void 0 && jo.encode(e.choose, t.uint32(50).fork()).join(),
      e.constraints !== void 0 && Fo.encode(e.constraints, t.uint32(58).fork()).join(),
      e.rules !== void 0 && zo.encode(e.rules, t.uint32(66).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.algorithm = bo.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.shape = wo.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
          i.presentationOf = Do.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.forEach = ko.decode(n, n.uint32());
          continue;
        case 6:
          if (e !== 50) break;
          i.choose = jo.decode(n, n.uint32());
          continue;
        case 7:
          if (e !== 58) break;
          i.constraints = Fo.decode(n, n.uint32());
          continue;
        case 8:
          if (e !== 66) break;
          i.rules = zo.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      (t.layoutNode =
        e.layoutNode !== void 0 && e.layoutNode !== null ? z.fromPartial(e.layoutNode) : void 0),
      (t.algorithm =
        e.algorithm !== void 0 && e.algorithm !== null ? bo.fromPartial(e.algorithm) : void 0),
      (t.shape = e.shape !== void 0 && e.shape !== null ? wo.fromPartial(e.shape) : void 0),
      (t.presentationOf =
        e.presentationOf !== void 0 && e.presentationOf !== null
          ? Do.fromPartial(e.presentationOf)
          : void 0),
      (t.forEach = e.forEach !== void 0 && e.forEach !== null ? ko.fromPartial(e.forEach) : void 0),
      (t.choose = e.choose !== void 0 && e.choose !== null ? jo.fromPartial(e.choose) : void 0),
      (t.constraints =
        e.constraints !== void 0 && e.constraints !== null
          ? Fo.fromPartial(e.constraints)
          : void 0),
      (t.rules = e.rules !== void 0 && e.rules !== null ? zo.fromPartial(e.rules) : void 0),
      t
    );
  },
};
...
var bo = {
  encode(e, t = new d()) {
    e.type !== `` && t.uint32(10).string(e.type);
    for (let n of e.parameters) So.encode(n, t.uint32(26).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.parameters.push(So.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = yo();
    return (
      (t.type = e.type ?? ``), (t.parameters = e.parameters?.map((e) => So.fromPartial(e)) || []), t
    );
  },
};
function xo() {
...
var jo = {
  encode(e, t = new d()) {
    for (let n of e.branches) No.encode(n, t.uint32(18).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 2:
          if (e !== 18) break;
          i.branches.push(No.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = Ao();
    return ((t.branches = e.branches?.map((e) => No.fromPartial(e)) || []), t);
  },
};
function Mo() {
  return {
...
var Fo = {
  encode(e, t = new d()) {
    for (let n of e.constraints) Lo.encode(n, t.uint32(10).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.constraints.push(Lo.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = Po();
    return ((t.constraints = e.constraints?.map((e) => Lo.fromPartial(e)) || []), t);
  },
};
function Io() {
  return {
...
var zo = {
  encode(e, t = new d()) {
    for (let n of e.rules) Vo.encode(n, t.uint32(10).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.rules.push(Vo.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = Ro();
    return ((t.rules = e.rules?.map((e) => Vo.fromPartial(e)) || []), t);
  },
};
function Bo() {
  return {
...
var Uo = {
  encode(e, t = new d()) {
    for (let n of e.points) Go.encode(n, t.uint32(10).fork()).join();
    for (let n of e.connections) qo.encode(n, t.uint32(18).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.points.push(Go.decode(n, n.uint32()));
          continue;
        case 2:
          if (e !== 18) break;
          i.connections.push(qo.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = Ho();
    return (
      (t.points = e.points?.map((e) => Go.fromPartial(e)) || []),
      (t.connections = e.connections?.map((e) => qo.fromPartial(e)) || []),
      t
    );
  },
};
...
var Yo = {
  encode(e, t = new d()) {
    return (
      e.type !== 0 && t.uint32(8).int32(e.type), e.side !== void 0 && t.uint32(18).string(e.side), t
    );
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
...
var Zo = {
  encode(e, t = new d()) {
    return (
      ...
      e.wrap !== void 0 && Yo.encode(e.wrap, t.uint32(74).fork()).join(),
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.wrap = e.wrap !== void 0 && e.wrap !== null ? Yo.fromPartial(e.wrap) : void 0),
...
var $o = {
  encode(e, t = new d()) {
    return (
      ...
      e.lineStyle !== void 0 && kc.encode(e.lineStyle, t.uint32(42).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 5:
          if (e !== 42) break;
          i.lineStyle = kc.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.toIdx = e.toIdx ?? 0),
      (t.lineStyle =
        e.lineStyle !== void 0 && e.lineStyle !== null ? kc.fromPartial(e.lineStyle) : void 0),
      t
    );
  },
};
...
var ts = {
  encode(e, t = new d()) {
    for (let n of e.rows) ms.encode(n, t.uint32(10).fork()).join();
    t.uint32(18).fork();
    for (let n of e.columnWidths) t.int32(n);
    return (
      t.join(), e.properties !== void 0 && H.encode(e.properties, t.uint32(26).fork()).join(), t
    );
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.rows.push(ms.decode(n, n.uint32()));
          continue;
        case 2:
          if (e === 16) {
  ...
  fromPartial(e) {
    let t = es();
    return (
      (t.rows = e.rows?.map((e) => ms.fromPartial(e)) || []),
...
var H = {
  encode(e, t = new d()) {
    (e.fill !== void 0 && g.encode(e.fill, t.uint32(10).fork()).join(),
    ...
    return (
      ...
      e.borders !== void 0 && as.encode(e.borders, t.uint32(106).fork()).join(),
      e.cellMargins !== void 0 && ls.encode(e.cellMargins, t.uint32(114).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 13:
          if (e !== 106) break;
          i.borders = as.decode(n, n.uint32());
          continue;
        case 14:
          if (e !== 114) break;
          i.cellMargins = ls.decode(n, n.uint32());
          continue;
        case 15:
          if (e !== 120) break;
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.alignment = e.alignment ?? void 0),
      (t.borders = e.borders !== void 0 && e.borders !== null ? as.fromPartial(e.borders) : void 0),
      (t.cellMargins =
        e.cellMargins !== void 0 && e.cellMargins !== null
          ? ls.fromPartial(e.cellMargins)
          : void 0),
...
var W = {
  encode(e, t = new d()) {
    return (
      ...
      e.bottom !== void 0 && C.encode(e.bottom, t.uint32(26).fork()).join(),
      e.left !== void 0 && C.encode(e.left, t.uint32(34).fork()).join(),
      e.diagonalDown !== void 0 && C.encode(e.diagonalDown, t.uint32(42).fork()).join(),
      e.diagonalUp !== void 0 && C.encode(e.diagonalUp, t.uint32(50).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    return (
      ...
      (t.diagonalDown =
        e.diagonalDown !== void 0 && e.diagonalDown !== null
          ...
          : void 0),
      (t.diagonalUp =
        e.diagonalUp !== void 0 && e.diagonalUp !== null ? C.fromPartial(e.diagonalUp) : void 0),
      t
    );
  },
};
...
var ms = {
  encode(e, t = new d()) {
    ...
    for (let n of e.cells) ds.encode(n, t.uint32(10).fork()).join();
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 1:
          if (e !== 10) break;
          i.cells.push(ds.decode(n, n.uint32()));
          continue;
        case 2:
          if (e !== 16) break;
          i.heightEmu = n.int32();
  ...
  fromPartial(e) {
    ...
    return (
      (t.id = e.id ?? void 0),
      (t.cells = e.cells?.map((e) => ds.fromPartial(e)) || []),
      (t.heightEmu = e.heightEmu ?? void 0),
      t
    );
  },
...
var gs = {
  encode(e, t = new d()) {
    return (
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(10).fork()).join(),
      e.paragraphStyle !== void 0 && x.encode(e.paragraphStyle, t.uint32(18).fork()).join(),
      e.fill !== void 0 && g.encode(e.fill, t.uint32(26).fork()).join(),
      ...
      e.borders !== void 0 && ss.encode(e.borders, t.uint32(90).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 11:
          if (e !== 90) break;
          i.borders = ss.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.anchor = e.anchor ?? void 0),
      (t.textDirection = e.textDirection ?? void 0),
      (t.borders = e.borders !== void 0 && e.borders !== null ? ss.fromPartial(e.borders) : void 0),
      t
    );
  },
};
...
var G = {
  encode(e, t = new d()) {
    return (
      ...
      e.cellStyle !== void 0 && gs.encode(e.cellStyle, t.uint32(18).fork()).join(),
      e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(26).fork()).join(),
      e.paragraphStyle !== void 0 && x.encode(e.paragraphStyle, t.uint32(34).fork()).join(),
      e.spaceBefore !== void 0 && t.uint32(40).int32(e.spaceBefore),
      e.spaceAfter !== void 0 && t.uint32(48).int32(e.spaceAfter),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.cellStyle = gs.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.textStyle = b.decode(n, n.uint32());
    ...
    return (
      (t.tableProperties =
        e.tableProperties !== void 0 && e.tableProperties !== null
          ...
          : void 0),
      (t.cellStyle =
        e.cellStyle !== void 0 && e.cellStyle !== null ? gs.fromPartial(e.cellStyle) : void 0),
      (t.textStyle =
        e.textStyle !== void 0 && e.textStyle !== null ? b.fromPartial(e.textStyle) : void 0),
      (t.paragraphStyle =
        e.paragraphStyle !== void 0 && e.paragraphStyle !== null
...
var xs = {
  encode(e, t = new d()) {
    ...
    for (let n of e.conditionalStyles) ys.encode(n, t.uint32(42).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 5:
          if (e !== 42) break;
          i.conditionalStyles.push(ys.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.conditionalStyles = e.conditionalStyles?.map((e) => ys.fromPartial(e)) || []),
      t
    );
  },
};
...
var K = {
  encode(e, t = new d()) {
    ...
    (e.textStyle !== void 0 && b.encode(e.textStyle, t.uint32(18).fork()).join(),
      ...
      e.paragraphStyle !== void 0 && x.encode(e.paragraphStyle, t.uint32(82).fork()).join(),
      e.docxSectionBreakCarrier !== void 0 && t.uint32(88).bool(e.docxSectionBreakCarrier));
    for (let n of e.inlineNodes) ws.encode(n, t.uint32(98).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 12:
          if (e !== 98) break;
          i.inlineNodes.push(ws.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.inlineNodes = e.inlineNodes?.map((e) => ws.fromPartial(e)) || []),
      t
    );
  },
};
...
var J = {
  ...
  fromPartial(e) {
    let t = Es();
    return (
      (t.uri = e.uri ?? ``), (t.isExternal = e.isExternal ?? !1), (t.action = e.action ?? ``), t
    );
  },
};
function Ds() {
...
var Y = {
  encode(e, t = new d()) {
    return (
      e.type !== 0 && t.uint32(8).int32(e.type),
      e.shadow !== void 0 && Ls.encode(e.shadow, t.uint32(18).fork()).join(),
      e.glow !== void 0 && js.encode(e.glow, t.uint32(26).fork()).join(),
      e.reflection !== void 0 && Fs.encode(e.reflection, t.uint32(34).fork()).join(),
      e.softEdges !== void 0 && Ns.encode(e.softEdges, t.uint32(42).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.shadow = Ls.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.glow = js.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
          i.reflection = Fs.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.softEdges = Ns.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      (t.type = e.type ?? 0),
      (t.shadow = e.shadow !== void 0 && e.shadow !== null ? Ls.fromPartial(e.shadow) : void 0),
      (t.glow = e.glow !== void 0 && e.glow !== null ? js.fromPartial(e.glow) : void 0),
      (t.reflection =
        e.reflection !== void 0 && e.reflection !== null ? Fs.fromPartial(e.reflection) : void 0),
      (t.softEdges =
        e.softEdges !== void 0 && e.softEdges !== null ? Ns.fromPartial(e.softEdges) : void 0),
      t
    );
  },
};
...
var Vs = {
  encode(e, t = new d()) {
    ...
    e.rectFormula !== void 0 && Zs.encode(e.rectFormula, t.uint32(66).fork()).join();
    for (let n of e.customPaths) pc.encode(n, t.uint32(74).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 8:
          if (e !== 66) break;
          i.rectFormula = Zs.decode(n, n.uint32());
          continue;
        case 9:
          if (e !== 74) break;
          i.customPaths.push(pc.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.rectFormula =
        e.rectFormula !== void 0 && e.rectFormula !== null
          ? Zs.fromPartial(e.rectFormula)
          : void 0),
      (t.customPaths = e.customPaths?.map((e) => pc.fromPartial(e)) || []),
      t
    );
  },
};
...
var dc = {
  encode(e, t = new d()) {
    return (
      e.moveTo !== void 0 && $s.encode(e.moveTo, t.uint32(10).fork()).join(),
      e.lineTo !== void 0 && tc.encode(e.lineTo, t.uint32(18).fork()).join(),
      e.close !== void 0 && rc.encode(e.close, t.uint32(26).fork()).join(),
      e.quadBezTo !== void 0 && ac.encode(e.quadBezTo, t.uint32(34).fork()).join(),
      e.cubicBezTo !== void 0 && sc.encode(e.cubicBezTo, t.uint32(42).fork()).join(),
      e.arcTo !== void 0 && lc.encode(e.arcTo, t.uint32(50).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.moveTo = $s.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.lineTo = tc.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.close = rc.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
          i.quadBezTo = ac.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.cubicBezTo = sc.decode(n, n.uint32());
          continue;
        case 6:
          if (e !== 50) break;
          i.arcTo = lc.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    let t = uc();
    return (
      (t.moveTo = e.moveTo !== void 0 && e.moveTo !== null ? $s.fromPartial(e.moveTo) : void 0),
      (t.lineTo = e.lineTo !== void 0 && e.lineTo !== null ? tc.fromPartial(e.lineTo) : void 0),
      (t.close = e.close !== void 0 && e.close !== null ? rc.fromPartial(e.close) : void 0),
      (t.quadBezTo =
        e.quadBezTo !== void 0 && e.quadBezTo !== null ? ac.fromPartial(e.quadBezTo) : void 0),
      (t.cubicBezTo =
        e.cubicBezTo !== void 0 && e.cubicBezTo !== null ? sc.fromPartial(e.cubicBezTo) : void 0),
      (t.arcTo = e.arcTo !== void 0 && e.arcTo !== null ? lc.fromPartial(e.arcTo) : void 0),
      t
    );
  },
};
...
var pc = {
  encode(e, t = new d()) {
    ...
    for (let n of e.commands) dc.encode(n, t.uint32(26).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.commands.push(dc.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.widthEmu = e.widthEmu ?? 0),
      (t.heightEmu = e.heightEmu ?? 0),
      (t.commands = e.commands?.map((e) => dc.fromPartial(e)) || []),
      t
    );
  },
};
...
var _c = {
  encode(e, t = new d()) {
    return (
      e.start !== 0 && t.uint32(8).int32(e.start), e.end !== 0 && t.uint32(16).int32(e.end), t
    );
  },
  decode(e, t) {
    let n = e instanceof f ? e : new f(e),
...
var xc = {
  encode(e, t = new d()) {
    return (
      e.id !== `` && t.uint32(10).string(e.id),
      e.kind !== 0 && t.uint32(16).int32(e.kind),
      e.theme !== void 0 && hc.encode(e.theme, t.uint32(26).fork()).join(),
      e.script !== void 0 && Tc.encode(e.script, t.uint32(58).fork()).join(),
      t
    );
  },
  decode(e, t) {
  ...
  fromPartial(e) {
    ...
    return (
      (t.id = e.id ?? ``),
      (t.kind = e.kind ?? 0),
      (t.theme = e.theme !== void 0 && e.theme !== null ? hc.fromPartial(e.theme) : void 0),
      (t.script = e.script !== void 0 && e.script !== null ? Tc.fromPartial(e.script) : void 0),
      t
    );
  },
};
...
var Cc = {
  ...
  fromPartial(e) {
    let t = Sc();
    return (
      (t.id = e.id ?? ``), (t.language = e.language ?? ``), (t.initSource = e.initSource ?? ``), t
    );
  },
};
function wc() {
...
var Tc = {
  encode(e, t = new d()) {
    return (
      ...
      e.result !== void 0 && Dc.encode(e.result, t.uint32(50).fork()).join(),
      e.execution !== void 0 && yc.encode(e.execution, t.uint32(58).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 6:
          if (e !== 50) break;
          i.result = Dc.decode(n, n.uint32());
          continue;
        case 7:
          if (e !== 58) break;
          i.execution = yc.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.result = e.result !== void 0 && e.result !== null ? Dc.fromPartial(e.result) : void 0),
      (t.execution =
        e.execution !== void 0 && e.execution !== null ? yc.fromPartial(e.execution) : void 0),
      t
    );
  },
};
...
function $(e) {
  let t = jc.Number(e.toString());
  if (t > jc.Number.MAX_SAFE_INTEGER)
    throw new jc.Error(`Value is larger than Number.MAX_SAFE_INTEGER`);
  if (t < jc.Number.MIN_SAFE_INTEGER)
    throw new jc.Error(`Value is smaller than Number.MIN_SAFE_INTEGER`);
  return t;
}
export {
  Wa as $,
...
//# sourceMappingURL=presentation-2.js.map
