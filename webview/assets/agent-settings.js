...
import { $i as t, Gn as n, Yn as r, ia as i } from "./src-2.js";
import { Bo as a, bc as o } from "./app-server-manager-signals.js";
...
import { c as C, l as te, o as w } from "./statsig.js";
import "./request.js";
import { t as T } from "./app-server-manager-hooks.js";
import "./use-global-state.js";
import "./invalidate-queries-and-broadcast.js";
import { t as E } from "./thread-context-inputs.js";
import {
  c as D,
  d as O,
  f as k,
...
import "./startCase.js";
import { n as ae, r as oe } from "./experimental-features-queries.js";
...
import { t as M } from "./link-external.js";
import { r as ue, t as N } from "./open-config-toml-button.js";
...
import "./globe.js";
import "./chevron.js";
import { t as he } from "./warning.js";
import { n as z } from "./markdown.js";
import "./code-snippet.js";
import "./copy.js";
import "./copy-button.js";
import "./plus.js";
import "./image-preview-dialog.js";
import { t as ge } from "./alert-1.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as _e } from "./toggle.js";
import { t as ve } from "./lock.js";
import { t as ye } from "./arrow-top-right.js";
import { i as B, t as be } from "./settings-shared.js";
import { t as xe } from "./settings-host-context.js";
import { t as V } from "./alert.js";
import { t as Se } from "./settings-content-layout.js";
import { i as H, t as Ce } from "./primary-runtime-install-action.js";
import { a as we, n as Te } from "./primary-runtime-query-keys-C.js";
import { a as Ee, i as De, n as Oe, r as ke } from "./primary-runtime-install-state.js";
import { n as U } from "./settings-row.js";
import { n as Ae, t as W } from "./settings-group.js";
import { n as je, t as Me } from "./primary-runtime-install-status-message-BdB-ENKl.js";
import { t as Ne } from "./open-in-targets-query.js";
import { n as G, r as K } from "./agent-settings.search.js";
var Pe = m(),
  Fe = e(s(), 1);
async function Ie({ filePath: e, keyPath: t, value: n }) {
  let r = J(t, n);
  if (r == null) throw Error(`Unsupported config key for project config write.`);
  await q({ filePath: e, field: r });
}
async function q({ filePath: e, field: t }) {
  let n = ``;
  try {
    n = (await h(`read-file`, { params: { path: e } })).contents;
  } catch (e) {
    if (!Z(e)) throw Error(`Failed to read project config.`);
  }
  let r = Y(n, t.name, t.value);
  if (r !== n)
    try {
      await h(`local-environment-config-save`, { params: { configPath: e, raw: r } });
    } catch {
...
function Y(e, t, n) {
  return t === `network_access` ? Re(e, n === !0) : Le(e, t, String(n));
}
function Le(e, t, n) {
  let r =
      e.length > 0
...
function $(e) {
  ...
  t[7] === x
    ? (S = t[8])
    : ((S = (0, Q.jsx)(W.Header, { title: v, subtitle: x })), (t[7] = x), (t[8] = S));
  let C = W,
    te = Ae,
    w;
  t[9] === s
  ...
  let E = h.map((e) =>
    ...
    D;
  t[14] !== te || t[15] !== E || t[16] !== w || t[17] !== T
    ? ((D = (0, Q.jsxs)(te, { children: [w, T, E] })),
      (t[14] = te),
      (t[15] = E),
      (t[16] = w),
      (t[17] = T),
    ...
    : (D = t[18]);
  let O;
  t[19] !== D || t[20] !== C.Content
    ? ((O = (0, Q.jsx)(C.Content, { children: D })), (t[19] = D), (t[20] = C.Content), (t[21] = O))
    : (O = t[21]);
  let k;
  return (
    t[22] !== _ || t[23] !== O || t[24] !== S
      ? ((k = (0, Q.jsxs)(_, { children: [S, O] })),
        (t[22] = _),
        (t[23] = O),
        (t[24] = S),
        (t[25] = k))
...
var We = t({ workspaceRoot: i().min(1).nullable().optional() }).passthrough();
function Ge(e) {
...
var Ke = [
    { value: `untrusted`, label: K.untrusted, description: `Always ask before taking action` },
    { value: `on-failure`, label: K.onFailure, description: `Ask only when a command fails` },
    { value: `on-request`, label: K.onRequest, description: `Ask when escalation is requested` },
    { value: `never`, label: K.never, description: `Run without asking for approval` },
  ],
  qe = [
    { value: `read-only`, label: K.readOnly, description: `Can read files, but cannot edit them` },
    {
      value: `workspace-write`,
      label: K.workspaceWrite,
...
function Je() {
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(W.Header, { title: (0, Q.jsx)(b, { ...K.customConfig }) })), (e[2] = l))
    : (l = e[2]);
  let u;
  if (e[3] !== r || e[4] !== t) {
    let n;
                        ...
                        e.path == null
                          ...
                          : (0, Q.jsx)(`div`, {
                              ...
                              children: (0, Q.jsx)(b, {
                                ...
                                values: {
                                  path: (0, Q.jsx)(`code`, { children: e.path }),
                                  location:
                                    e.range == null
                                      ? ``
                                      : (0, Q.jsx)(b, {
  ...
  e[9] === t
    ? (d = e[10])
    : ((d = (0, Q.jsx)(F, { electron: !0, children: (0, Q.jsx)($e, { hostId: t }) })),
      (e[9] = t),
      (e[10] = d));
  let ee, f;
  ...
  e[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, Q.jsx)(`span`, { className: `block` })),
      (m = (0, Q.jsx)(b, {
  ...
  e[16] === t
    ...
    : ((g = (0, Q.jsx)(F, {
      ...
      (e[17] = g));
  let _;
  e[18] !== g || e[19] !== u || e[20] !== d
    ? ((_ = (0, Q.jsxs)(W, {
        id: G.customConfig,
        className: `gap-2`,
        children: [l, (0, Q.jsxs)(W.Content, { children: [u, d, g] })],
      })),
      (e[18] = g),
      (e[19] = u),
      (e[20] = d),
  ...
  let v;
  e[22] !== o || e[23] !== t
    ? ((v = o ? (0, Q.jsx)($, { hostId: t }) : null), (e[22] = o), (e[23] = t), (e[24] = v))
    : (v = e[24]);
  let y;
  e[25] === v
    ? (y = e[26])
    : ((y = (0, Q.jsx)(F, { electron: !0, children: v })), (e[25] = v), (e[26] = y));
  let x;
  e[27] !== i || e[28] !== n || e[29] !== t
    ? ((x = i && n.kind === `local` ? (0, Q.jsx)(Xe, { hostId: t }) : null),
      (e[27] = i),
      (e[28] = n),
      (e[29] = t),
      (e[30] = x))
  ...
  e[31] === x
    ? (S = e[32])
    : ((S = (0, Q.jsx)(F, { electron: !0, children: x })), (e[31] = x), (e[32] = S));
  let C;
  return (
    e[33] !== _ || e[34] !== y || e[35] !== S
      ? ((C = (0, Q.jsx)(Q.Fragment, {
          children: (0, Q.jsxs)(Se, { title: s, subtitle: c, children: [_, y, S] }),
        })),
        (e[33] = _),
        (e[34] = y),
        (e[35] = S),
...
function Xe(e) {
  ...
  return (
    t[0] === n
      ? (i = t[1])
      : ((i = (0, Q.jsx)(Ze, { hostId: n, primaryRuntime: r })), (t[0] = n), (t[1] = i)),
    i
  );
}
function Ze(e) {
  let t = (0, Pe.c)(97),
    { hostId: n, primaryRuntime: i } = e,
    a = u(p),
    o = y(),
    s = C(),
    { logEventWithStatsig: c } = te(),
    { data: l, isLoading: m } = ee(ae, n),
    h;
  t[0] === n ? (h = t[1]) : ((h = { hostId: n }), (t[0] = n), (t[1] = h));
  let g = oe(h),
    x;
  t[2] === l ? (x = t[3]) : ((x = l?.find(Qe)), (t[2] = l), (t[3] = x));
  let S = x,
    w = S?.enabled === !0,
    T;
  t[4] !== n || t[5] !== i
    ? ((T = () => i.diagnoseDependencies({ hostId: n })), (t[4] = n), (t[5] = i), (t[6] = T))
    : (T = t[6]);
  let E;
  t[7] === n ? (E = t[8]) : ((E = Te(n)), (t[7] = n), (t[8] = E));
  let D;
  t[9] !== T || t[10] !== E
    ? ((D = { queryFn: T, queryKey: E, staleTime: _.FIVE_SECONDS }),
      (t[9] = T),
      (t[10] = E),
      (t[11] = D))
    : (D = t[11]);
  let O = v(D),
    k;
  t[12] !== n || t[13] !== i
    ? ((k = { mutationFn: () => i.diagnoseDependencies({ hostId: n }) }),
      (t[12] = n),
      (t[13] = i),
      (t[14] = k))
    : (k = t[14]);
  ...
  t[15] !== i || t[16] !== s
    ? ((ne = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await we(s), i.runUpdateNow({ release: t }));
        },
      }),
      (t[15] = i),
      (t[16] = s),
  ...
  let re = f(ne),
    ie;
  t[18] !== n || t[19] !== i || t[20] !== s
    ? ((ie = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await we(s), i.resetDependencies({ hostId: n, release: t }));
        },
      }),
      (t[18] = n),
      (t[19] = i),
  ...
  t[22] === n
    ? (le = t[23])
    : ((le = { mutationFn: () => Ee({ hostId: n }) }), (t[22] = n), (t[23] = le));
  let M = f(le),
    ue = d(De),
    N = d(ke),
    P = ue?.hostId === n ? ue : null,
    F;
  t[24] === a ? (F = t[25]) : ((F = a.get(se)), (t[24] = a), (t[25] = F));
  let I = F,
    pe = m || g.isPending || A.isPending || re.isPending || j.isPending || M.isPending,
    L;
  t[26] === P ? (L = t[27]) : ((L = Oe(P)), (t[26] = P), (t[27] = L));
  let R = L,
    he =
    ...
    z;
  t[28] !== A || t[29] !== O || t[30] !== o || t[31] !== c || t[32] !== I
    ? ((z = () => {
        let e = Date.now();
        A.mutateAsync()
          .then((t) => {
            if (
              (c(`codex_primary_runtime_dependencies_diagnose`, {
  ...
  t[40] !== I
    ? ((ve = () => {
        let e = Date.now();
        j.mutateAsync({ release: N })
          .then((t) => {
            (c(`codex_primary_runtime_dependencies_reset`, {
              bundle_version: t.bundleVersion ?? ``,
              duration_ms: Date.now() - e,
              status: t.status,
            }),
  ...
  let ye = ve,
    B;
  t[42] !== M || t[43] !== O || t[44] !== o || t[45] !== a || t[46] !== I
    ? ((B = () => {
        M.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
            if ((a.set(De, null), O.refetch(), !t)) {
              I.info(
                o.formatMessage({
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (V = t[49]);
  let Se;
  t[50] === O.data?.problems.length
    ? (Se = t[51])
    : ((Se = O.data?.problems.length
        ? (0, Q.jsx)(b, {
      ...
      (t[51] = Se));
  let H;
  t[52] !== he || t[53] !== O.isLoading || t[54] !== R || t[55] !== P
    ? ((H = R
        ? je(P, Me(P))
        : O.isLoading
          ? (0, Q.jsx)(b, {
  ...
  t[57] === H
    ? (Ne = t[58])
    : ((Ne = (0, Q.jsx)(`span`, { className: `text-sm text-token-text-secondary`, children: H })),
      (t[57] = H),
      (t[58] = Ne));
  let G;
  t[59] !== Se || t[60] !== Ne
    ? ((G = (0, Q.jsx)(U, { label: V, description: Se, control: Ne })),
      (t[59] = Se),
      (t[60] = Ne),
      (t[61] = G))
    : (G = t[61]);
  ...
  t[62] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, Q.jsx)(b, {
      ...
      (t[63] = Fe))
    : ((K = t[62]), (Fe = t[63]));
  let Ie = m || g.isPending || S == null,
    q;
  t[64] !== N || t[65] !== re || t[66] !== g
    ? ((q = (e) => {
        g.mutate(
          { enabled: e, featureName: r },
          {
            onSuccess: () => {
              e && re.mutate({ release: N });
            },
          },
        );
      }),
  ...
  t[68] === o
    ...
    : ((J = o.formatMessage({
      ...
      (t[69] = J));
  let Y;
  t[70] !== w || t[71] !== Ie || t[72] !== q || t[73] !== J
    ? ((Y = (0, Q.jsx)(U, {
        label: K,
        description: Fe,
        control: (0, Q.jsx)(_e, { checked: w, disabled: Ie, onChange: q, ariaLabel: J }),
      })),
      (t[70] = w),
      (t[71] = Ie),
      (t[72] = q),
  ...
  t[77] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ze = (0, Q.jsx)(me, { className: `icon-2xs` })),
      (X = (0, Q.jsx)(b, {
    ...
    : ((ze = t[77]), (X = t[78]));
  let Z;
  t[79] !== A.isPending || t[80] !== ge || t[81] !== j.isPending
    ? ((Z = (0, Q.jsx)(U, {
        label: Le,
        description: Re,
        control: (0, Q.jsxs)(ce, {
  ...
  t[83] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Be = (0, Q.jsx)(b, {
      ...
      (t[84] = $))
    : ((Be = t[83]), ($ = t[84]));
  let Ve = R ? M.isPending : j.isPending,
    He = !w || (R ? M.isPending : pe),
    Ue = R ? be : ye,
    We;
  t[85] === R
    ? (We = t[86])
    : ((We = R
      ...
      (t[86] = We));
  let Ge;
  t[87] !== Ve || t[88] !== He || t[89] !== Ue || t[90] !== We
    ? ((Ge = (0, Q.jsx)(U, {
        label: Be,
        description: $,
        control: (0, Q.jsx)(ce, {
  ...
  let Ke;
  return (
    t[92] !== G || t[93] !== Y || t[94] !== Z || t[95] !== Ge
      ? ((Ke = (0, Q.jsxs)(W, {
          className: `gap-2`,
          children: [
            xe,
            (0, Q.jsx)(W.Content, { children: (0, Q.jsxs)(Ae, { children: [G, Y, Z, Ge] }) }),
          ],
        })),
        (t[92] = G),
        (t[93] = Y),
...
function $e({ hostId: e }) {
  let t = y(),
    ...
    _ = h.hasValue
      ...
      : e === `local`
        ...
        : null,
    v = le(e),
    { data: S, isPending: C } = j(_, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: te, isPending: w } = ee(D, { hostId: e }),
    T = g(`open-file`),
    ae = S?.config ?? null,
    oe = S?.layers ?? null,
    se = S?.origins ?? null,
    M = te?.requirements ?? null,
    ue = nt(oe, t),
    N = oe?.find((e) => e.name.type === `user`) ?? null,
    de = oe?.find((e) => k(e.name)) ?? null,
    fe = v == null ? null : `${v}/config.toml`,
    F = N == null ? fe : O(N.name),
    pe = {
      key: `user`,
      kind: `user`,
      label: t.formatMessage(K.userConfig),
    ...
    me =
      de == null
        ...
        : {
            key: `managed`,
            kind: `managed`,
            label: t.formatMessage(K.adminConfig),
    ...
    z = [...ue, pe, ...(me == null ? [] : [me])],
    ge = ue.length > 0,
    ve = _ == null ? (z[0]?.key ?? null) : `project:${_}`,
    B = z.find((e) => e.key === a) ?? z.find((e) => e.key === ve) ?? z[0] ?? null,
    { data: xe } = ee(Ne, {
      cwd: B?.workspaceRoot == null ? (_ == null ? null : n(_)) : n(B.workspaceRoot),
      hostId: e,
    }),
    V = at(B?.layer?.config ?? null),
    Se = ut(ae?.approval_policy ?? null) ?? `on-request`,
    H = ae?.sandbox_mode == null ? `read-only` : ae.sandbox_mode,
    Ce = V.sandboxMode == null && H === `workspace-write`,
    we = V.sandboxMode === `workspace-write` || Ce,
    Te = V.approvalPolicy ?? Se,
    Ee = V.sandboxMode ?? H,
    De = ct(Te),
    Oe = lt(Ee),
    ke = V.networkAccess ?? ae?.sandbox_workspace_write?.network_access ?? !1,
    je = se == null ? null : A(se, `approval_policy`, [`approvalPolicy`]),
    Me = se == null ? null : A(se, `sandbox_mode`),
    Pe = se == null ? null : A(se, `sandbox_workspace_write`, [`network_access`]),
    q = B?.kind === `project` ? (B.layer?.disabledReason ?? null) : null,
    J = ot(B, t),
    Y = Ke.filter((e) =>
      M?.allowedApprovalPolicies == null || M.allowedApprovalPolicies.length === 0
        ? !0
        : M.allowedApprovalPolicies.includes(e.value),
    ),
    Le = qe.filter((e) =>
      M?.allowedSandboxModes == null || M.allowedSandboxModes.length === 0
        ? !0
        : M.allowedSandboxModes.includes(e.value),
    );
  async function Re(t, n, r) {
    if (!(B == null || B.filePath == null) && c == null) {
      ...
      try {
        (B.kind === `project`
          ? await Ie({ filePath: B.filePath, keyPath: n, value: r })
          ...
          await Promise.all([
            i.invalidateQueries({ queryKey: [...ne, e] }),
      ...
      (0, Q.jsx)(W.Header, {
        title: (0, Q.jsxs)(R, {
          ...
          children: [
                    ...
                    (0, Q.jsxs)(L.Section, {
                      children: [
                        (0, Q.jsx)(L.SectionLabel, {
                          children: (0, Q.jsx)(b, { ...K.projectConfig }),
                        }),
                        ue.map((e) =>
                          (0, Q.jsx)(
                            et,
            ...
            (0, Q.jsxs)(L.Section, {
              children: [
                (0, Q.jsx)(L.SectionLabel, { children: (0, Q.jsx)(b, { ...K.globalConfig }) }),
                (0, Q.jsx)(et, {
                  scopeOption: pe,
                  selected: B?.key === pe.key,
                  onSelect: () => {
                    Ve(pe.key);
                  },
                }),
        ...
        actions: (0, Q.jsxs)(ce, {
          ...
          onClick: () => {
            B?.filePath != null &&
              P({
                path: B.filePath,
                cwd: B.workspaceRoot == null ? null : n(B.workspaceRoot),
                hostId: e,
                target: xe?.preferredTarget,
                openFile: T.mutate,
              });
          },
          children: [
      ...
      (0, Q.jsx)(W.Content, {
        children: (0, Q.jsxs)(Ae, {
          children: [
            ...
            (0, Q.jsx)(U, {
              id: G.approvalPolicy,
              label: (0, Q.jsx)(b, { ...K.approvalPolicy }),
              description: (0, Q.jsx)(tt, {
                error: f.approval,
                lockReason: X,
                children: (0, Q.jsx)(b, {
              ...
              control: (0, Q.jsx)(R, {
                ...
                children: Y.map((e) =>
                  (0, Q.jsx)(
                    L.Item,
                    {
                      RightIcon: e.value === Te ? I : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        Re(`approval`, `approval_policy`, e.value);
                      },
                      SubText: (0, Q.jsx)(`div`, {
            ...
            (0, Q.jsx)(U, {
              id: G.sandboxSettings,
              label: (0, Q.jsx)(b, { ...K.sandboxSettings }),
              description: (0, Q.jsx)(tt, {
                error: f.sandbox,
                lockReason: Z,
                children: (0, Q.jsx)(b, {
              ...
              control: (0, Q.jsx)(R, {
                ...
                triggerButton: (0, Q.jsx)(be, {
                  disabled: $ || Z != null,
                  contentClassName: `truncate`,
                  children: Oe == null ? Ee : t.formatMessage(Oe.label),
                }),
                children: Le.map((e) =>
                  (0, Q.jsx)(
                    L.Item,
                    {
                      RightIcon: e.value === Ee ? I : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        Re(`sandbox`, `sandbox_mode`, e.value);
                      },
                      SubText: (0, Q.jsx)(`div`, {
                        className: `pt-1 text-sm text-token-text-secondary`,
                        children: e.description,
            ...
            we
              ? (0, Q.jsx)(U, {
                  ...
                  control: (0, Q.jsx)(_e, {
                    ...
                    disabled: $ || Be != null,
                    onChange: (e) => {
                      Re(`network`, `sandbox_workspace_write.network_access`, e);
                    },
...
function et(e) {
  ...
  t[0] === r.label
    ? (o = t[1])
    : ((o = (0, Q.jsx)(`span`, { className: `truncate text-sm`, children: r.label })),
      (t[0] = r.label),
      (t[1] = o));
  let s;
  return (
...
function tt(e) {
  let t = (0, Pe.c)(10),
    ...
    a;
  t[0] === n ? (a = t[1]) : ((a = (0, Q.jsx)(`div`, { children: n })), (t[0] = n), (t[1] = a));
  let o;
  t[2] === i
    ? (o = t[3])
    : ((o =
  ...
  t[4] === r
    ...
    : ((s =
        r == null
          ? null
          : (0, Q.jsx)(`div`, { className: `text-sm text-token-error-foreground`, children: r })),
      (t[4] = r),
      (t[5] = s));
  let c;
  return (
    t[6] !== a || t[7] !== o || t[8] !== s
      ? ((c = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [a, o, s] })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s),
        (t[9] = c))
...
function nt(e, t) {
  ...
  for (let r of e) {
    ...
    let e = rt(r.name.dotCodexFolder);
    n.push({
      ...
      label: t.formatMessage(
        ...
        { repoName: it(e ?? r.name.dotCodexFolder) },
      ),
      tooltipText: O(r.name) ?? r.name.dotCodexFolder,
      filePath: O(r.name),
...
function st({
  ...
  return (
    t ??
    (i
      ? r?.kind !== `managed` && n != null && k(n.name)
        ? e.formatMessage({
...
function ct(e) {
  return Ke.find((t) => t.value === e) ?? null;
}
function lt(e) {
