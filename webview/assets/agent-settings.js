...
import { js as c, us as l } from "./app-server-manager-signals.js";
import { _ as u, g as d, k as f, n as p, s as m, u as h } from "./vscode-api.js";
import "./isEqual.js";
import { Zi as g, mn as _, na as v, yn as y } from "./src-1.js";
import "./react-dom.js";
import { c as b, o as x, r as S } from "./lib.js";
import { dn as C, o as w, pn as ee } from "./persisted-signal.js";
import "./proxy.js";
import { t as T } from "./button-DO-oxX3-.js";
...
import { n as D } from "./rpc-1.js";
import { c as O, o as k } from "./statsig.js";
import "./request.js";
import "./platform-BrML-86Y.js";
import "./marked.esm.js";
import { t as A } from "./app-server-manager-hooks.js";
import "./invalidate-queries-and-broadcast.js";
import { t as j } from "./thread-context-inputs.js";
import {
  c as te,
  d as M,
  f as ne,
...
import "./chevron.js";
import { t as de } from "./warning.js";
import "./katex-1.js";
...
import "./checkbox.js";
import "./minus.js";
import { l as ge } from "./links.js";
import "./badge.js";
import "./chat.js";
import { t as _e } from "./search.js";
import { r as z, t as ve } from "./dropdown.js";
import "./globe.js";
import { n as B } from "./markdown.js";
...
import { t as ye } from "./settings-host-context.js";
import { t as be } from "./alert-2.js";
...
import { a as je, i as Me, n as Ne, r as Pe } from "./primary-runtime-install-state-e.js";
...
function Ke(e) {
  ...
  let D = g.map((e) =>
    ...
    O;
  t[14] !== ee || t[15] !== D || t[16] !== T || t[17] !== E
    ? ((O = (0, $.jsxs)(ee, { children: [T, E, D] })),
      (t[14] = ee),
      (t[15] = D),
      (t[16] = T),
      (t[17] = E),
  ...
  let A;
  return (
    t[22] !== v || t[23] !== k || t[24] !== C
      ? ((A = (0, $.jsxs)(v, { children: [C, k] })),
        (t[22] = v),
        (t[23] = k),
        (t[24] = C),
        (t[25] = A))
...
var Xe = g({ workspaceRoot: v().min(1).nullable().optional() }).passthrough();
function Ze(e) {
...
function et() {
  ...
  e[18] !== _ || e[19] !== u || e[20] !== d
    ? ((v = (0, $.jsxs)(K, {
        className: `gap-2`,
        children: [c, (0, $.jsxs)(K.Content, { children: [u, d, _] })],
      })),
      (e[18] = _),
      (e[19] = u),
      (e[20] = d),
  ...
  let y;
  e[22] !== a || e[23] !== t
    ? ((y = a ? (0, $.jsx)(`div`, { children: (0, $.jsx)(Ke, { hostId: t }) }) : null),
      (e[22] = a),
      (e[23] = t),
      (e[24] = y))
    : (y = e[24]);
  ...
  e[31] === S
    ? (C = e[32])
    : ((C = (0, $.jsx)(R, { electron: !0, children: S })), (e[31] = S), (e[32] = C));
  let w;
  return (
    e[33] !== v || e[34] !== b || e[35] !== C
      ? ((w = (0, $.jsx)($.Fragment, {
          children: (0, $.jsxs)(U, { title: o, subtitle: s, children: [v, b, C] }),
        })),
        (e[33] = v),
        (e[34] = b),
        (e[35] = C),
...
function rt(e) {
  let t = (0, q.c)(96),
    ...
    l = b(),
    f = O(),
    { data: p, isLoading: m } = i(fe, n),
    g;
  t[0] === n ? (g = t[1]) : ((g = { hostId: n }), (t[0] = n), (t[1] = g));
  let _ = pe(g),
    v;
  t[2] === p ? (v = t[3]) : ((v = p?.find(it)), (t[2] = p), (t[3] = v));
  let S = v,
    E = S?.enabled === !0,
    D;
  t[4] !== n || t[5] !== r
    ? ((D = () => r.diagnoseDependencies({ hostId: n })), (t[4] = n), (t[5] = r), (t[6] = D))
    : (D = t[6]);
  let k;
  t[7] === n ? (k = t[8]) : ((k = Ae(n)), (t[7] = n), (t[8] = k));
  let A;
  t[9] !== D || t[10] !== k
    ? ((A = { queryFn: D, queryKey: k, staleTime: h.FIVE_SECONDS }),
      (t[9] = D),
      (t[10] = k),
      (t[11] = A))
    : (A = t[11]);
  let j = u(A),
    te;
  t[12] !== n || t[13] !== r
    ? ((te = { mutationFn: () => r.diagnoseDependencies({ hostId: n }) }),
      (t[12] = n),
      (t[13] = r),
      (t[14] = te))
    : (te = t[14]);
  ...
  t[22] === n
    ? (ae = t[23])
    : ((ae = { mutationFn: () => je({ hostId: n }) }), (t[22] = n), (t[23] = ae));
  let oe = d(ae),
    se = o(Me),
    ce = o(Pe),
    P = se?.hostId === n ? se : null,
    F;
  t[24] === c ? (F = t[25]) : ((F = c.get(ue)), (t[24] = c), (t[25] = F));
  let I = F,
    le = m || _.isPending || M.isPending || re.isPending || N.isPending || oe.isPending,
    de;
  t[26] === P ? (de = t[27]) : ((de = Ne(P)), (t[26] = P), (t[27] = de));
  let L = de,
    R =
    ...
    ge;
  t[28] !== M || t[29] !== j || t[30] !== l || t[31] !== c || t[32] !== I
    ? ((ge = () => {
        let e = Date.now();
        M.mutateAsync()
          .then((t) => {
            if (
              (w(c, C, Ee({ diagnostics: t, durationMs: Date.now() - e })),
              j.refetch(),
              t.installed)
            ) {
              I.success(
          ...
          .catch(() => {
            (w(c, C, Te({ durationMs: Date.now() - e })),
              I.danger(
                l.formatMessage({
  ...
  let z = ge,
    ve;
  t[34] !== j || t[35] !== l || t[36] !== ce || t[37] !== N || t[38] !== c || t[39] !== I
    ? ((ve = () => {
        let e = Date.now();
        N.mutateAsync({ release: ce })
          .then((t) => {
            (w(
              c,
              ee,
          ...
          .catch((t) => {
            ...
            (w(c, ee, we({ bundleVersion: null, durationMs: Date.now() - e, status: `failed` })),
              I.danger(
                l.formatMessage({
  ...
  let B = ve,
    ye;
  t[41] !== oe || t[42] !== j || t[43] !== l || t[44] !== c || t[45] !== I
    ? ((ye = () => {
        oe.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
  ...
  t[49] === j.data?.problems.length
    ...
    : ((V = j.data?.problems.length
      ...
      (t[50] = V));
  let H;
  t[51] !== R || t[52] !== j.isLoading || t[53] !== L || t[54] !== P
    ? ((H = L
        ? Ie(P, Le(P))
        : j.isLoading
          ? (0, $.jsx)(x, {
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((De = (0, $.jsx)(x, { ...Y.codexDependencies })),
      ...
      (t[62] = Re))
    : ((De = t[61]), (Re = t[62]));
  let ze = m || _.isPending || S == null,
    J;
  t[63] !== ce || t[64] !== re || t[65] !== _
    ? ((J = (e) => {
        _.mutate(
          { enabled: e, featureName: y },
          {
            onSuccess: () => {
              e && re.mutate({ release: ce });
            },
          },
        );
      }),
  ...
  t[67] === l
    ...
    : ((Be = l.formatMessage({
      ...
      (t[68] = Be));
  let X;
  t[69] !== E || t[70] !== ze || t[71] !== J || t[72] !== Be
    ? ((X = (0, $.jsx)(G, {
        label: De,
        description: Re,
        control: (0, $.jsx)(xe, { checked: E, disabled: ze, onChange: J, ariaLabel: Be }),
      })),
      (t[69] = E),
      (t[70] = ze),
      (t[71] = J),
  ...
  t[76] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((He = (0, $.jsx)(_e, { className: `icon-2xs` })),
      (Ue = (0, $.jsx)(x, {
    ...
    : ((He = t[76]), (Ue = t[77]));
  let Q;
  t[78] !== M.isPending || t[79] !== z || t[80] !== N.isPending
    ? ((Q = (0, $.jsx)(G, {
        label: Ve,
        description: Z,
        control: (0, $.jsxs)(T, {
  ...
  t[82] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((We = (0, $.jsx)(x, { ...Y.resetWorkspaceDependencies })),
      ...
      (t[83] = Ge))
    : ((We = t[82]), (Ge = t[83]));
  let Ke = L ? oe.isPending : N.isPending,
    qe = !E || (L ? oe.isPending : le),
    Je = L ? be : B,
    Ye;
  t[84] === L
    ? (Ye = t[85])
...
function at({ hostId: e }) {
  let t = b(),
    ...
    v = g.hasValue
      ...
      : e === `local`
        ...
        : null,
    y = ce(e),
    { data: S, isPending: C } = se(v, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: w, isPending: ee } = i(te, { hostId: e }),
    D = m(`open-file`),
    O = S?.config ?? null,
    k = S?.layers ?? null,
    A = S?.origins ?? null,
    ...
    F = ct(k, t),
    I = k?.find((e) => e.name.type === `user`) ?? null,
    ue = k?.find((e) => N(e.name)) ?? null,
    fe = y == null ? null : `${y}/config.toml`,
    pe = I == null ? fe : ne(I.name),
    me = {
      key: `user`,
      kind: `user`,
    ...
    he =
      ue == null
        ...
        : {
            ...
            filePath: ne(ue.name),
            expectedVersion: ue.version,
            workspaceRoot: null,
            layer: ue,
          },
    R = [...F, me, ...(he == null ? [] : [he])],
    ge = F.length > 0,
    _e = v == null ? (R[0]?.key ?? null) : `project:${v}`,
    B = R.find((e) => e.key === a) ?? R.find((e) => e.key === _e) ?? R[0] ?? null,
    { data: ye } = i(Re, {
      cwd: B?.workspaceRoot == null ? (v == null ? null : _(v)) : _(B.workspaceRoot),
      hostId: e,
    }),
    be = dt(B?.layer?.config ?? null),
    Se = gt(O?.approval_policy ?? null) ?? `on-request`,
    V = O?.sandbox_mode == null ? `read-only` : O.sandbox_mode,
    U = be.sandboxMode == null && V === `workspace-write`,
    W = be.sandboxMode === `workspace-write` || U,
    we = be.approvalPolicy ?? Se,
    Te = be.sandboxMode ?? V,
    Ee = mt(we),
    De = ht(Te),
    Oe = be.networkAccess ?? O?.sandbox_workspace_write?.network_access ?? !1,
    ke = A == null ? null : re(A, `approval_policy`, [`approvalPolicy`]),
    Ae = A == null ? null : re(A, `sandbox_mode`),
    je = A == null ? null : re(A, `sandbox_workspace_write`, [`network_access`]),
  ...
  async function Le(t, n, i) {
    if (!(B == null || B.filePath == null) && l == null) {
      (u(t), p((e) => ({ ...e, [t]: void 0 })));
      try {
        if (B.kind === `project`) await Be({ filePath: B.filePath, keyPath: n, value: i });
        else {
          let t = B.kind === `user` ? await M(r, e) : null;
        ...
        (await r.invalidateQueries({ queryKey: [...ae, e] }),
          await Promise.all([
      ...
      (0, $.jsx)(K.Header, {
        title: (0, $.jsxs)(ve, {
          ...
          children: [
            ...
            (0, $.jsxs)(z.Section, {
              children: [
                (0, $.jsx)(z.SectionLabel, { children: (0, $.jsx)(x, { ...Y.globalConfig }) }),
                (0, $.jsx)(ot, {
                  scopeOption: me,
        ...
        actions: (0, $.jsxs)(T, {
          ...
          onClick: () => {
            B?.filePath != null &&
              le({
                path: B.filePath,
                cwd: B.workspaceRoot == null ? null : _(B.workspaceRoot),
                hostId: e,
...
function ct(e, t) {
  ...
  for (let r of e) {
    ...
    n.push({
      ...
      tooltipText: ne(r.name) ?? r.name.dotCodexFolder,
      filePath: ne(r.name),
...
function pt({
  ...
  return (
    t ??
    (i
      ? r?.kind !== `managed` && n != null && N(n.name)
        ? e.formatMessage({
