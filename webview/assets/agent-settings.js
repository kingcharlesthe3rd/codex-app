...
import { Ts as c, us as l } from "./app-server-manager-signals.js";
import { A as u, _ as d, n as f, s as ee, u as p, v as m } from "./vscode-api.js";
import "./isEqual.js";
import { ha as h, pn as g, ua as _, vn as v } from "./src-2.js";
import "./react-dom.js";
...
import { gn as E, mn as te, t as D } from "./product-logger.js";
import "./format-skill-title.js";
import { n as O } from "./rpc-2.js";
import { c as k, o as A } from "./statsig.js";
import "./request.js";
import "./platform.js";
...
import { r as P, t as F } from "./dropdown.js";
import { t as le } from "./search.js";
...
import { n as de, r as fe } from "./experimental-features-queries.js";
import "./use-in-app-browser-use-availability.js";
import "./image-square.js";
import "./plus.js";
import { t as pe } from "./app-server-manager-hooks.js";
...
import "./use-auth.js";
import { t as L } from "./use-codex-home.js";
...
import { r as R, t as z } from "./open-config-toml-button.js";
import { t as he } from "./open-workspace-file.js";
...
import "./katex-3.js";
import { f as _e } from "./chunk-9.js";
...
import { t as ve } from "./download.js";
...
import "./chat.js";
import "./globe.js";
import { n as B } from "./markdown-1.js";
...
import { t as U } from "./settings-content-layout.js";
import { t as W } from "./alert.js";
...
import { t as K } from "./settings-group.js";
...
async function X({ filePath: e, field: t }) {
  let n = ``;
  try {
    n = (await f(`read-file`, { params: { path: e } })).contents;
  } catch (e) {
  ...
  if (r !== n)
    try {
      await f(`local-environment-config-save`, { params: { configPath: e, raw: r } });
    } catch {
...
function Ke(e) {
  ...
  t[7] === y
    ? (S = t[8])
    : ((S = (0, $.jsx)(K.Header, { title: v, subtitle: y })), (t[7] = y), (t[8] = S));
  let C = K,
    w = Fe,
    T;
  t[9] === c
  ...
  let te = h.map((e) =>
    ...
    D;
  t[14] !== w || t[15] !== te || t[16] !== T || t[17] !== E
    ? ((D = (0, $.jsxs)(w, { children: [T, E, te] })),
      (t[14] = w),
      (t[15] = te),
      (t[16] = T),
      (t[17] = E),
...
var Xe = _({ workspaceRoot: h().min(1).nullable().optional() }).passthrough();
function Ze(e) {
...
function et() {
  ...
  e[9] === t
    ? (d = e[10])
    : ((d = (0, $.jsx)(I, { electron: !0, children: (0, $.jsx)(at, { hostId: t }) })),
      (e[9] = t),
      (e[10] = d));
  let f, ee;
  ...
  e[18] !== g || e[19] !== u || e[20] !== d
    ? ((_ = (0, $.jsxs)(K, {
        className: `gap-2`,
        children: [c, (0, $.jsxs)(K.Content, { children: [u, d, g] })],
      })),
      (e[18] = g),
      (e[19] = u),
      (e[20] = d),
  ...
  e[25] === v
    ? (y = e[26])
    : ((y = (0, $.jsx)(I, { electron: !0, children: v })), (e[25] = v), (e[26] = y));
  let b;
  e[27] !== i || e[28] !== n || e[29] !== t
    ? ((b = i && n.kind === `local` ? (0, $.jsx)(nt, { hostId: t }) : null),
      (e[27] = i),
      (e[28] = n),
      (e[29] = t),
      (e[30] = b))
  ...
  e[31] === b
    ? (C = e[32])
    : ((C = (0, $.jsx)(I, { electron: !0, children: b })), (e[31] = b), (e[32] = C));
  let w;
  return (
    e[33] !== _ || e[34] !== y || e[35] !== C
      ? ((w = (0, $.jsx)($.Fragment, {
          children: (0, $.jsxs)(U, { title: o, subtitle: s, children: [_, y, C] }),
        })),
        (e[33] = _),
        (e[34] = y),
        (e[35] = C),
...
function rt(e) {
  let t = (0, q.c)(96),
    { hostId: n, primaryRuntime: s } = e,
    c = i(o),
    l = b(),
    u = k(),
    { data: f, isLoading: ee } = r(de, n),
    h;
  t[0] === n ? (h = t[1]) : ((h = { hostId: n }), (t[0] = n), (t[1] = h));
  let g = fe(h),
    _;
  t[2] === f ? (_ = t[3]) : ((_ = f?.find(it)), (t[2] = f), (t[3] = _));
  let y = _,
    C = y?.enabled === !0,
    O;
  t[4] !== n || t[5] !== s
    ? ((O = () => s.diagnoseDependencies({ hostId: n })), (t[4] = n), (t[5] = s), (t[6] = O))
    : (O = t[6]);
  let A;
  t[7] === n ? (A = t[8]) : ((A = Ae(n)), (t[7] = n), (t[8] = A));
  let ne;
  t[9] !== O || t[10] !== A
    ? ((ne = { queryFn: O, queryKey: A, staleTime: p.FIVE_SECONDS }),
      (t[9] = O),
      (t[10] = A),
      (t[11] = ne))
    : (ne = t[11]);
  let j = m(ne),
    re;
  t[12] !== n || t[13] !== s
    ? ((re = { mutationFn: () => s.diagnoseDependencies({ hostId: n }) }),
      (t[12] = n),
      (t[13] = s),
      (t[14] = re))
    : (re = t[14]);
  ...
  t[15] !== s || t[16] !== u
    ? ((ie = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await ke(u), s.runUpdateNow({ release: t }));
        },
      }),
      (t[15] = s),
      (t[16] = u),
  ...
  let ae = d(ie),
    oe;
  t[18] !== n || t[19] !== s || t[20] !== u
    ? ((oe = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await ke(u), s.resetDependencies({ hostId: n, release: t }));
        },
      }),
      (t[18] = n),
      (t[19] = s),
  ...
  t[22] === n
    ? (se = t[23])
    : ((se = { mutationFn: () => je({ hostId: n }) }), (t[22] = n), (t[23] = se));
  let ce = d(se),
    P = a(Me),
    F = a(Pe),
    I = P?.hostId === n ? P : null,
    pe;
  t[24] === c ? (pe = t[25]) : ((pe = c.get(w)), (t[24] = c), (t[25] = pe));
  let L = pe,
    me = ee || g.isPending || M.isPending || ae.isPending || N.isPending || ce.isPending,
    R;
  t[26] === I ? (R = t[27]) : ((R = Ne(I)), (t[26] = I), (t[27] = R));
  let z = R,
    he =
    ...
    ge;
  t[28] !== M || t[29] !== j || t[30] !== l || t[31] !== c || t[32] !== L
    ? ((ge = () => {
        let e = Date.now();
        M.mutateAsync()
          .then((t) => {
            if (
              (D(c, te, Ee({ diagnostics: t, durationMs: Date.now() - e })),
              j.refetch(),
              t.installed)
            ) {
              L.success(
          ...
          .catch(() => {
            (D(c, te, Te({ durationMs: Date.now() - e })),
              L.danger(
                l.formatMessage({
  ...
  let _e = ge,
    ye;
  t[34] !== j || t[35] !== l || t[36] !== F || t[37] !== N || t[38] !== c || t[39] !== L
    ? ((ye = () => {
        let e = Date.now();
        N.mutateAsync({ release: F })
          ...
          .catch((t) => {
            ...
            (D(c, E, we({ bundleVersion: null, durationMs: Date.now() - e, status: `failed` })),
              L.danger(
                l.formatMessage({
  ...
  let B = ye,
    be;
  t[41] !== ce || t[42] !== j || t[43] !== l || t[44] !== c || t[45] !== L
    ? ((be = () => {
        ce.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
            if ((c.set(Me, null), j.refetch(), !t)) {
              L.info(
                l.formatMessage({
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, $.jsx)(K.Header, { title: (0, $.jsx)(x, { ...Y.workspaceDependencies }) })),
      (t[47] = Se))
    : (Se = t[47]);
  let Ce;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ce = (0, $.jsx)(x, { ...Y.currentDependencyVersion })), (t[48] = Ce))
    : (Ce = t[48]);
  let V;
  ...
  let W;
  t[58] !== V || t[59] !== U
    ? ((W = (0, $.jsx)(G, { label: Ce, description: V, control: U })),
      (t[58] = V),
      (t[59] = U),
      (t[60] = W))
    : (W = t[60]);
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((De = (0, $.jsx)(x, { ...Y.codexDependencies })),
      ...
      (t[62] = Re))
    : ((De = t[61]), (Re = t[62]));
  let ze = ee || g.isPending || y == null,
    J;
  t[63] !== F || t[64] !== ae || t[65] !== g
    ? ((J = (e) => {
        g.mutate(
          { enabled: e, featureName: v },
          {
            onSuccess: () => {
              e && ae.mutate({ release: F });
            },
          },
        );
      }),
  ...
  t[67] === l
    ...
    : ((Be = l.formatMessage({
      ...
      (t[68] = Be));
  let X;
  t[69] !== C || t[70] !== ze || t[71] !== J || t[72] !== Be
    ? ((X = (0, $.jsx)(G, {
        label: De,
        description: Re,
        control: (0, $.jsx)(ue, { checked: C, disabled: ze, onChange: J, ariaLabel: Be }),
      })),
      (t[69] = C),
      (t[70] = ze),
      (t[71] = J),
  ...
  t[76] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((He = (0, $.jsx)(le, { className: `icon-2xs` })),
      (Ue = (0, $.jsx)(x, {
  ...
  t[82] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((We = (0, $.jsx)(x, { ...Y.resetWorkspaceDependencies })),
      ...
      (t[83] = Ge))
    : ((We = t[82]), (Ge = t[83]));
  let Ke = z ? ce.isPending : N.isPending,
    qe = !C || (z ? ce.isPending : me),
    Je = z ? xe : B,
    Ye;
  t[84] === z
    ? (Ye = t[85])
  ...
  let Ze;
  return (
    t[91] !== W || t[92] !== X || t[93] !== Q || t[94] !== Xe
      ? ((Ze = (0, $.jsxs)(K, {
          className: `gap-2`,
          children: [
            Se,
            (0, $.jsx)(K.Content, { children: (0, $.jsxs)(Fe, { children: [W, X, Q, Xe] }) }),
          ],
        })),
        (t[91] = W),
        (t[92] = X),
...
function at({ hostId: e }) {
  let t = b(),
    ...
    _ = h.hasValue
      ...
      : e === `local`
        ...
        : null,
    v = L(e),
    { data: y, isPending: w } = ce(_, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: T, isPending: E } = r(j, { hostId: e }),
    te = ee(`open-file`),
    D = y?.config ?? null,
    O = y?.layers ?? null,
    k = y?.origins ?? null,
    A = T?.requirements ?? null,
    le = ct(O, t),
    I = O?.find((e) => e.name.type === `user`) ?? null,
    de = O?.find((e) => oe(e.name)) ?? null,
    fe = v == null ? null : `${v}/config.toml`,
    pe = I == null ? fe : M(I.name),
    me = {
      key: `user`,
      kind: `user`,
    ...
    z = [...le, me, ...(R == null ? [] : [R])],
    ve = le.length > 0,
    ye = _ == null ? (z[0]?.key ?? null) : `project:${_}`,
    B = z.find((e) => e.key === o) ?? z.find((e) => e.key === ye) ?? z[0] ?? null,
    { data: be } = r(Re, {
      cwd: B?.workspaceRoot == null ? (_ == null ? null : g(_)) : g(B.workspaceRoot),
      hostId: e,
    }),
    xe = dt(B?.layer?.config ?? null),
    Se = gt(D?.approval_policy ?? null) ?? `on-request`,
    V = D?.sandbox_mode == null ? `read-only` : D.sandbox_mode,
    U = xe.sandboxMode == null && V === `workspace-write`,
    W = xe.sandboxMode === `workspace-write` || U,
    we = xe.approvalPolicy ?? Se,
    Te = xe.sandboxMode ?? V,
    Ee = mt(we),
    De = ht(Te),
    Oe = xe.networkAccess ?? D?.sandbox_workspace_write?.network_access ?? !1,
    ke = k == null ? null : ie(k, `approval_policy`, [`approvalPolicy`]),
    Ae = k == null ? null : ie(k, `sandbox_mode`),
    je = k == null ? null : ie(k, `sandbox_workspace_write`, [`network_access`]),
  ...
  async function Le(t, n, r) {
    if (!(B == null || B.filePath == null) && l == null) {
      (d(t), p((e) => ({ ...e, [t]: void 0 })));
      try {
        if (B.kind === `project`) await Be({ filePath: B.filePath, keyPath: n, value: r });
        else {
          let t = B.kind === `user` ? await re(i, e) : null;
          await c(`write-config-value`, {
            hostId: e,
            keyPath: n,
            value: r,
            mergeStrategy: `upsert`,
            filePath: t ? t.filePath : B.filePath,
            expectedVersion: t == null ? B.expectedVersion : t.expectedVersion,
          });
        }
        (await i.invalidateQueries({ queryKey: [...N, e] }),
          await Promise.all([
            i.invalidateQueries({ queryKey: [...ae, e] }),
            i.invalidateQueries({ queryKey: [...se, e] }),
          ]));
      } catch (e) {
      ...
      (0, $.jsx)(K.Header, {
        title: (0, $.jsxs)(F, {
          ...
          children: [
            ...
            (0, $.jsxs)(P.Section, {
              children: [
                (0, $.jsx)(P.SectionLabel, { children: (0, $.jsx)(x, { ...Y.globalConfig }) }),
                (0, $.jsx)(ot, {
                  scopeOption: me,
        ...
        actions: (0, $.jsxs)(S, {
          ...
          onClick: () => {
            B?.filePath != null &&
              he({
                path: B.filePath,
                cwd: B.workspaceRoot == null ? null : g(B.workspaceRoot),
                hostId: e,
                target: be?.preferredTarget,
                openFile: te.mutate,
              });
          },
          children: [
...
function ct(e, t) {
  ...
  for (let r of e) {
    ...
    n.push({
      ...
      tooltipText: M(r.name) ?? r.name.dotCodexFolder,
      filePath: M(r.name),
