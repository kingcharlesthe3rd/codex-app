...
import { n as Xt, t as Zt } from "./experimental-feature-visibility-8.js";
var X,
  Qt = e(() => {
    (U(),
      (X = xe({
...
async function en({ filePath: e, field: t }) {
  let n = ``;
  try {
    n = (await g(`read-file`, { params: { path: e } })).contents;
  } catch (e) {
  ...
  if (r !== n)
    try {
      await g(`local-environment-config-save`, { params: { configPath: e, raw: r } });
    } catch {
...
function un(e) {
  ...
  t[19] !== D || t[20] !== S.Content
    ? ((O = (0, Z.jsx)(S.Content, { children: D })), (t[19] = D), (t[20] = S.Content), (t[21] = O))
    : (O = t[21]);
  let k;
  return (
    t[22] !== v || t[23] !== O || t[24] !== x
      ? ((k = (0, Z.jsxs)(v, { children: [x, O] })),
        (t[22] = v),
        (t[23] = O),
        (t[24] = x),
        (t[25] = k))
...
var mn,
  ...
  Z,
  gn = e(() => {
    ((mn = m()), l(), (hn = t(u(), 1)), U(), Dt(), ee(), I(), Zt(), At(), et(), kt(), (Z = v()));
  });
function _n(e) {
  let t = (0, yn.c)(53),
    { hostId: n } = e,
  ...
  let { data: c } = st(o),
    ...
    S,
    C;
  if (t[2] !== a || t[3] !== n || t[4] !== c || t[5] !== r) {
    m = Symbol.for(`react.early_return_sentinel`);
    bb0: {
      let e;
      t[20] !== c?.hasModelSupportingMaxReasoningEffort ||
      t[21] !== c?.hasModelSupportingUltraReasoningEffort
        ? ((e = (e) =>
            e === `max`
              ? c?.hasModelSupportingMaxReasoningEffort === !0
              : c?.hasModelSupportingUltraReasoningEffort === !0),
          (t[20] = c?.hasModelSupportingMaxReasoningEffort),
          (t[21] = c?.hasModelSupportingUltraReasoningEffort),
          (t[22] = e))
        : (e = t[22]);
      ...
      let o;
      t[23] === a ? (o = t[24]) : ((o = (e) => a.has(e)), (t[23] = a), (t[24] = o));
      let s = lt.length + i.filter(o).length;
      ((p = Y),
        ...
        (y = i.map((e) =>
          (0, Q.jsx)(
            B.CheckboxItem,
            {
              checked: a.has(e),
              onCheckedChange: (t) => {
                ft(r, { enabled: t, hostId: n, listModelsData: c, reasoningEffort: e });
              },
  ...
  let w;
  t[31] !== l || t[32] !== h || t[33] !== g || t[34] !== _ || t[35] !== v || t[36] !== y
    ? ((w = (0, Q.jsxs)(l, { align: h, contentWidth: g, triggerButton: _, children: [v, y] })),
      (t[31] = l),
      (t[32] = h),
      (t[33] = g),
      (t[34] = _),
    ...
    : (w = t[37]);
  let T;
  t[38] !== u || t[39] !== w || t[40] !== x || t[41] !== S
    ? ((T = (0, Q.jsx)(u, { label: x, description: S, control: w })),
      (t[38] = u),
      (t[39] = w),
      (t[40] = x),
      (t[41] = S),
  ...
  let E;
  t[43] !== d || t[44] !== T
    ? ((E = (0, Q.jsx)(d, { children: T })), (t[43] = d), (t[44] = T), (t[45] = E))
    : (E = t[45]);
  let D;
  t[46] !== f || t[47] !== E
    ? ((D = (0, Q.jsx)(f, { children: E })), (t[46] = f), (t[47] = E), (t[48] = D))
    : (D = t[48]);
  let O;
  return (
    t[49] !== p || t[50] !== D || t[51] !== C
      ? ((O = (0, Q.jsxs)(p, { children: [C, D] })),
        (t[49] = p),
        (t[50] = D),
        (t[51] = C),
        (t[52] = O))
...
var Cn,
  wn = e(() => {
    (x(), (Cn = a({ workspaceRoot: _().min(1).nullable().optional() }).passthrough()));
  });
function Tn() {
  let e = (0, Un.c)(41),
    { selectedHostId: t } = it(),
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(K, { ...X.customConfig }) })), (e[2] = l))
    : (l = e[2]);
  let u;
  if (e[3] !== r || e[4] !== t) {
    let n;
                  ...
                  children: [
                    ...
                    e.path == null
                      ...
                      : (0, $.jsx)(ae, {
                          ...
                          onClick: () => {
                            e.path != null && tt({ hostId: t, path: e.path, range: e.range });
                          },
                          children: (0, $.jsx)(K, {
  ...
  e[9] === t
    ? (d = e[10])
    : ((d = (0, $.jsx)(R, { electron: !0, children: (0, $.jsx)(jn, { hostId: t }) })),
      (e[9] = t),
      (e[10] = d));
  let f, p;
        ...
        children: [
          ...
          (0, $.jsxs)(`a`, {
            ...
            children: [
              ...
              (0, $.jsx)(N, { href: mt, className: `icon-xxs` }),
            ],
          }),
        ],
      })),
  ...
  e[18] !== _ || e[19] !== u || e[20] !== d
    ? ((v = (0, $.jsxs)(Y, {
        className: `gap-2`,
        children: [l, (0, $.jsxs)(Y.Content, { children: [u, d, _] })],
      })),
      (e[18] = _),
      (e[19] = u),
      (e[20] = d),
  ...
  let y;
  e[22] !== o || e[23] !== t
    ? ((y = o ? (0, $.jsx)(_n, { hostId: t }) : null), (e[22] = o), (e[23] = t), (e[24] = y))
    : (y = e[24]);
  let b;
  e[25] !== a || e[26] !== t
    ? ((b = a ? (0, $.jsx)(`div`, { children: (0, $.jsx)(un, { hostId: t }) }) : null),
      (e[25] = a),
      (e[26] = t),
      (e[27] = b))
    : (b = e[27]);
  ...
  e[28] === b
    ? (x = e[29])
    : ((x = (0, $.jsx)(R, { electron: !0, children: b })), (e[28] = b), (e[29] = x));
  let S;
  e[30] !== i || e[31] !== n || e[32] !== t
    ? ((S = i && n.kind === `local` ? (0, $.jsx)(On, { hostId: t }) : null),
      (e[30] = i),
      (e[31] = n),
      (e[32] = t),
      (e[33] = S))
  ...
  e[34] === S
    ? (C = e[35])
    : ((C = (0, $.jsx)(R, { electron: !0, children: S })), (e[34] = S), (e[35] = C));
  let w;
  return (
    e[36] !== v || e[37] !== y || e[38] !== x || e[39] !== C
      ? ((w = (0, $.jsx)($.Fragment, {
          children: (0, $.jsxs)(Ut, { title: s, subtitle: c, children: [v, y, x, C] }),
        })),
        (e[36] = v),
        (e[37] = y),
        (e[38] = x),
...
function En(e) {
  le({ event: e, href: mt, initiator: `open_in_browser_bridge` });
}
function Dn(e) {
  return (0, $.jsx)(`a`, {
...
function kn(e) {
  let t = (0, Un.c)(96),
    ...
    c = we(),
    l = Te(),
    { data: u, isLoading: f } = o(_e, n),
    p;
  t[0] === n ? (p = t[1]) : ((p = { hostId: n }), (t[0] = n), (t[1] = p));
  let m = fe(p),
    h;
  t[2] === u ? (h = t[3]) : ((h = u?.find(An)), (t[2] = u), (t[3] = h));
  let g = h,
    _ = g?.enabled === !0,
    v;
  t[4] !== n || t[5] !== r
    ? ((v = () => r.diagnoseDependencies({ hostId: n })), (t[4] = n), (t[5] = r), (t[6] = v))
    : (v = t[6]);
  let x;
  t[7] === n ? (x = t[8]) : ((x = Gt(n)), (t[7] = n), (t[8] = x));
  let C;
  t[9] !== v || t[10] !== x
    ? ((C = { queryFn: v, queryKey: x, staleTime: y.FIVE_SECONDS }),
      (t[9] = v),
      (t[10] = x),
      (t[11] = C))
    : (C = t[11]);
  let w = d(C),
    E;
  t[12] !== n || t[13] !== r
    ? ((E = { mutationFn: () => r.diagnoseDependencies({ hostId: n }) }),
      (t[12] = n),
      (t[13] = r),
      (t[14] = E))
    : (E = t[14]);
  ...
  t[15] !== r || t[16] !== l
    ? ((O = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await qt(l), r.runUpdateNow({ release: t }));
        },
      }),
      (t[15] = r),
      (t[16] = l),
  ...
  let k = S(O),
    A;
  t[18] !== n || t[19] !== r || t[20] !== l
    ? ((A = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await qt(l), r.resetDependencies({ hostId: n, release: t }));
        },
      }),
      (t[18] = n),
      (t[19] = r),
  ...
  t[22] === n
    ? (ee = t[23])
    : ((ee = { mutationFn: () => Nt({ hostId: n }) }), (t[22] = n), (t[23] = ee));
  let te = S(ee),
    ne = b(_t),
    M = b(Je),
    N = ne?.hostId === n ? ne : null,
    P;
  t[24] === a ? (P = t[25]) : ((P = a.get(ce)), (t[24] = a), (t[25] = P));
  let F = P,
    re = f || m.isPending || D.isPending || k.isPending || j.isPending || te.isPending,
    ie;
  t[26] === N ? (ie = t[27]) : ((ie = vt(N)), (t[26] = N), (t[27] = ie));
  let I = ie,
    oe =
    ...
    se;
  t[28] !== D || t[29] !== w || t[30] !== c || t[31] !== a || t[32] !== F
    ? ((se = () => {
        let e = Date.now();
        D.mutateAsync()
          .then((t) => {
            if (
              (be(a, je, Pt({ diagnostics: t, durationMs: Date.now() - e })),
              w.refetch(),
              t.installed)
            ) {
              F.success(
          ...
          .catch(() => {
            (be(a, je, Mt({ durationMs: Date.now() - e })),
              F.danger(
                c.formatMessage({
  ...
  let le = se,
    de;
  t[34] !== w || t[35] !== c || t[36] !== M || t[37] !== j || t[38] !== a || t[39] !== F
    ? ((de = () => {
        let e = Date.now();
        j.mutateAsync({ release: M })
          .then((t) => {
            (be(
              a,
              Ee,
              Lt({ bundleVersion: t.bundleVersion, durationMs: Date.now() - e, status: t.status }),
            ),
              w.refetch(),
              F.success(
                c.formatMessage({
          ...
          .catch((t) => {
            if (It(t)) {
              (a.set(_t, null),
                ...
                be(
                  a,
                  Ee,
                  Lt({ bundleVersion: null, durationMs: Date.now() - e, status: `canceled` }),
                ),
                F.info(
                  c.formatMessage({
            ...
            (be(a, Ee, Lt({ bundleVersion: null, durationMs: Date.now() - e, status: `failed` })),
              F.danger(
                c.formatMessage({
  ...
  let R = de,
    z;
  t[41] !== te || t[42] !== w || t[43] !== c || t[44] !== a || t[45] !== F
    ? ((z = () => {
        te.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
            if ((a.set(_t, null), w.refetch(), !t)) {
              F.info(
                c.formatMessage({
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(K, { ...X.workspaceDependencies }) })),
      (t[47] = me))
    : (me = t[47]);
  let he;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((he = (0, $.jsx)(K, { ...X.currentDependencyVersion })), (t[48] = he))
    : (he = t[48]);
  let ve;
  t[49] === w.data?.problems.length
    ? (ve = t[50])
    : ((ve = w.data?.problems.length
        ? (0, $.jsx)(K, {
      ...
      (t[50] = ve));
  let ye;
  t[51] !== oe || t[52] !== w.isLoading || t[53] !== I || t[54] !== N
    ? ((ye = I
        ? dt(N, St(N))
        : w.isLoading
          ? (0, $.jsx)(K, {
  ...
  t[56] === ye
    ? (V = t[57])
    : ((V = (0, $.jsx)(`span`, { className: `text-sm text-token-text-secondary`, children: ye })),
      (t[56] = ye),
      (t[57] = V));
  let H;
  t[58] !== ve || t[59] !== V
    ? ((H = (0, $.jsx)(J, { label: he, description: ve, control: V })),
      (t[58] = ve),
      (t[59] = V),
      (t[60] = H))
    : (H = t[60]);
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xe = (0, $.jsx)(K, { ...X.codexDependencies })),
      (U = (0, $.jsx)(K, {
      ...
      (t[62] = U))
    : ((xe = t[61]), (U = t[62]));
  let Se = f || m.isPending || g == null,
    Ce;
  t[63] !== M || t[64] !== k || t[65] !== m
    ? ((Ce = (e) => {
        m.mutate(
          { enabled: e, featureName: T },
          {
            onSuccess: () => {
              e && k.mutate({ release: M });
            },
          },
        );
      }),
  ...
  t[67] === c
    ...
    : ((W = c.formatMessage({
      ...
      (t[68] = W));
  let G;
  t[69] !== _ || t[70] !== Se || t[71] !== Ce || t[72] !== W
    ? ((G = (0, $.jsx)(J, {
        label: xe,
        description: U,
        control: (0, $.jsx)(ue, { checked: _, disabled: Se, onChange: Ce, ariaLabel: W }),
      })),
      (t[69] = _),
      (t[70] = Se),
      (t[71] = Ce),
  ...
  t[74] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((De = (0, $.jsx)(K, { ...X.diagnoseWorkspaceDependencies })),
      (Oe = (0, $.jsx)(K, {
  ...
  t[76] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = (0, $.jsx)(pe, { className: `icon-2xs` })),
      (Ae = (0, $.jsx)(K, {
    ...
    : ((ke = t[76]), (Ae = t[77]));
  let Me;
  t[78] !== D.isPending || t[79] !== le || t[80] !== j.isPending
    ? ((Me = (0, $.jsx)(J, {
        label: De,
        description: Oe,
        control: (0, $.jsxs)(ae, {
  ...
  t[82] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ne = (0, $.jsx)(K, { ...X.resetWorkspaceDependencies })),
      (Pe = (0, $.jsx)(K, {
      ...
      (t[83] = Pe))
    : ((Ne = t[82]), (Pe = t[83]));
  let Fe = I ? te.isPending : j.isPending,
    Ie = !_ || (I ? te.isPending : re),
    Le = I ? B : R,
    Re;
  t[84] === I
    ? (Re = t[85])
    : ((Re = I
      ...
      (t[85] = Re));
  let q;
  t[86] !== Fe || t[87] !== Ie || t[88] !== Le || t[89] !== Re
    ? ((q = (0, $.jsx)(J, {
        label: Ne,
        description: Pe,
        control: (0, $.jsx)(ae, {
  ...
  let ze;
  return (
    t[91] !== H || t[92] !== G || t[93] !== Me || t[94] !== q
      ? ((ze = (0, $.jsxs)(Y, {
          className: `gap-2`,
          children: [
            me,
            (0, $.jsx)(Y.Content, { children: (0, $.jsxs)(jt, { children: [H, G, Me, q] }) }),
          ],
        })),
        (t[91] = H),
        (t[92] = G),
...
function jn({ hostId: e }) {
  let t = we(),
    ...
    [s, c] = (0, Wn.useState)(null),
    [l, u] = (0, Wn.useState)({}),
    d = b(Ge),
    f = Sn(n.state),
    m = f.hasValue ? (e === `local` ? f.workspaceRoot : null) : e === `local` ? d : null,
    h = re(e),
    { data: g, isPending: _ } = He(m, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: v, isPending: y } = o(Fe, { hostId: e }),
    x = w(`open-file`),
    S = g?.config ?? null,
    T = g?.layers ?? null,
    E = g?.origins ?? null,
    D = v?.requirements ?? null,
    O = Pn(T, t),
    k = T?.find((e) => e.name.type === `user`) ?? null,
    A = T?.find((e) => Le(e.name)) ?? null,
    ee = h == null ? null : `${h}/config.toml`,
    ne = k == null ? ee : Be(k.name),
    M = {
      key: `user`,
      kind: `user`,
      label: t.formatMessage(X.userConfig),
      tooltipText: ne ?? `~/.codex/config.toml`,
      filePath: ne,
    ...
    P = [...O, M, ...(N == null ? [] : [N])],
    ie = O.length > 0,
    I = m == null ? (P[0]?.key ?? null) : `project:${m}`,
    L = P.find((e) => e.key === i) ?? P.find((e) => e.key === I) ?? P[0] ?? null,
    { data: se } = o(Jt, {
      cwd: L?.workspaceRoot == null ? (m == null ? null : C(m)) : C(L.workspaceRoot),
      hostId: e,
    }),
    ce = Ln(L?.layer?.config ?? null),
    le = Hn(S?.approval_policy ?? null) ?? `on-request`,
    de = S?.sandbox_mode == null ? `read-only` : S.sandbox_mode,
    fe = ce.sandboxMode == null && de === `workspace-write`,
    pe = ce.sandboxMode === `workspace-write` || fe,
    R = ce.approvalPolicy ?? le,
    z = ce.sandboxMode ?? de,
    me = Bn(R),
    he = Vn(z),
    ge = ce.networkAccess ?? S?.sandbox_workspace_write?.network_access ?? !1,
    _e = E == null ? null : q(E, `approval_policy`, [`approvalPolicy`]),
    ve = E == null ? null : q(E, `sandbox_mode`),
    ye = E == null ? null : q(E, `sandbox_workspace_write`, [`network_access`]),
    V = L?.kind === `project` ? (L.layer?.disabledReason ?? null) : null,
    H = Rn(L, t),
    be = Gn.filter((e) =>
      D?.allowedApprovalPolicies == null || D.allowedApprovalPolicies.length === 0
        ? !0
        : D.allowedApprovalPolicies.includes(e.value),
    ),
    xe = Kn.filter((e) =>
      D?.allowedSandboxModes == null || D.allowedSandboxModes.length === 0
        ? !0
        : D.allowedSandboxModes.includes(e.value),
    );
  async function U(t, n, i) {
    if (!(L == null || L.filePath == null) && s == null) {
      (c(t), u((e) => ({ ...e, [t]: void 0 })));
      try {
        if (L.kind === `project`) await $t({ filePath: L.filePath, keyPath: n, value: i });
        else {
          let t = L.kind === `user` ? await Re(r, e) : null;
          await Pe(`write-config-value`, {
            hostId: e,
            keyPath: n,
            value: i,
        ...
        (await r.invalidateQueries({ queryKey: [...Ie, e] }),
          await Promise.all([
            r.invalidateQueries({ queryKey: [...ze, e] }),
            r.invalidateQueries({ queryKey: [...qe, e] }),
          ]));
      } catch (e) {
      ...
      (0, $.jsx)(Y.Header, {
        title: (0, $.jsxs)(oe, {
          ...
          children: [
                    ...
                    (0, $.jsxs)(B.Section, {
                      children: [
                        (0, $.jsx)(B.SectionLabel, {
                          children: (0, $.jsx)(K, { ...X.projectConfig }),
                        }),
                        O.map((e) =>
                          (0, $.jsx)(
                            Mn,
            ...
            (0, $.jsxs)(B.Section, {
              children: [
                (0, $.jsx)(B.SectionLabel, { children: (0, $.jsx)(K, { ...X.globalConfig }) }),
                (0, $.jsx)(Mn, {
                  scopeOption: M,
                  selected: L?.key === M.key,
                  onSelect: () => {
                    De(M.key);
                  },
                }),
        ...
        actions: (0, $.jsxs)(ae, {
          ...
          onClick: () => {
            L?.filePath != null &&
              j({
                path: L.filePath,
                cwd: L.workspaceRoot == null ? null : C(L.workspaceRoot),
                hostId: e,
      ...
      (0, $.jsx)(Y.Content, {
        children: (0, $.jsxs)(jt, {
          children: [
            ...
            (0, $.jsx)(J, {
              label: (0, $.jsx)(K, { ...X.approvalPolicy }),
              ...
              control: (0, $.jsx)(oe, {
                ...
                triggerButton: (0, $.jsx)(Tt, {
                  disabled: Ee || W != null,
                  contentClassName: `truncate`,
                  children: me == null ? R : t.formatMessage(me.label),
                }),
                children: be.map((e) =>
                  (0, $.jsx)(
                    B.Item,
                    {
                      RightIcon: e.value === R ? F : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
            ...
            (0, $.jsx)(J, {
              label: (0, $.jsx)(K, { ...X.sandboxSettings }),
              description: (0, $.jsx)(Nn, {
                error: l.sandbox,
                lockReason: G,
                children: (0, $.jsx)(K, {
              ...
              control: (0, $.jsx)(oe, {
                ...
                triggerButton: (0, $.jsx)(Tt, {
                  disabled: Ee || G != null,
                  contentClassName: `truncate`,
                  children: he == null ? z : t.formatMessage(he.label),
                }),
                children: xe.map((e) =>
                  (0, $.jsx)(
                    B.Item,
                    {
                      RightIcon: e.value === z ? F : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
            ...
            pe
              ? (0, $.jsx)(J, {
                  ...
                  control: (0, $.jsx)(ue, {
                    ...
                    disabled: Ee || Te != null,
                    onChange: (e) => {
                      U(`network`, `sandbox_workspace_write.network_access`, e);
                    },
...
function Pn(e, t) {
  ...
  for (let r of e) {
    ...
    n.push({
      ...
      tooltipText: Be(r.name) ?? r.name.dotCodexFolder,
      filePath: Be(r.name),
