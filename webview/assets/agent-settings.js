...
import {
  ...
  t as Ut,
  u as Wt,
} from "./app-initial~app-main~agent-settings-D.js";
import {
  n as Gt,
  t as Kt,
...
var mn,
  ...
  Z,
  gn = e(() => {
    ((mn = B()), b(), (hn = t(K(), 1)), A(), It(), Re(), x(), Zt(), qt(), xt(), Gt(), (Z = Ue()));
  });
function _n(e) {
  let t = (0, yn.c)(53),
    { hostId: n } = e,
  ...
  if (t[2] !== i || t[3] !== n || t[4] !== o || t[5] !== r) {
    ...
    bb0: {
      ...
      let m;
      t[23] === i ? (m = t[24]) : ((m = (e) => i.has(e)), (t[23] = i), (t[24] = m));
      let C = W.length + a.filter(m).length;
      ((d = Y),
        ...
        (y = a.map((e) =>
          (0, Q.jsx)(
            q.CheckboxItem,
            {
              checked: i.has(e),
              onCheckedChange: (t) => {
                Ye(r, { enabled: t, hostId: n, listModelsData: o, reasoningEffort: e });
              },
              children: (0, Q.jsx)(ft, { effort: e }),
            },
            e,
          ),
        )));
  ...
  let C;
  t[31] !== s || t[32] !== p || t[33] !== h || t[34] !== _ || t[35] !== v || t[36] !== y
    ? ((C = (0, Q.jsxs)(s, { align: p, contentWidth: h, triggerButton: _, children: [v, y] })),
      (t[31] = s),
      (t[32] = p),
      (t[33] = h),
      (t[34] = _),
    ...
    : (C = t[37]);
  let w;
  t[38] !== c || t[39] !== C || t[40] !== b || t[41] !== x
    ? ((w = (0, Q.jsx)(c, { label: b, description: x, control: C })),
      (t[38] = c),
      (t[39] = C),
      (t[40] = b),
      (t[41] = x),
  ...
  let T;
  t[43] !== l || t[44] !== w
    ? ((T = (0, Q.jsx)(l, { children: w })), (t[43] = l), (t[44] = w), (t[45] = T))
    : (T = t[45]);
  let E;
  t[46] !== u || t[47] !== T
    ? ((E = (0, Q.jsx)(u, { children: T })), (t[46] = u), (t[47] = T), (t[48] = E))
    : (E = t[48]);
  let D;
  return (
    t[49] !== d || t[50] !== E || t[51] !== S
      ? ((D = (0, Q.jsxs)(d, { children: [S, E] })),
        (t[49] = d),
        (t[50] = E),
        (t[51] = S),
        (t[52] = D))
...
function vn(e) {
  return (0, Q.jsx)(
    q.CheckboxItem,
    { checked: !0, disabled: !0, children: (0, Q.jsx)(ft, { effort: e }) },
    e,
  );
}
var yn,
...
var Cn,
  wn = e(() => {
    (I(), (Cn = _({ workspaceRoot: tt().min(1).nullable().optional() }).passthrough()));
  });
function Tn() {
  let e = (0, Un.c)(41),
    { selectedHostId: t } = yt(),
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(g, { ...X.customConfig }) })), (e[2] = l))
    : (l = e[2]);
  let u;
  if (e[3] !== r || e[4] !== t) {
    let n;
                  ...
                  children: [
                    ...
                    e.path == null
                      ...
                      : (0, $.jsx)(je, {
                          ...
                          onClick: () => {
                            e.path != null && G({ hostId: t, path: e.path, range: e.range });
                          },
                          children: (0, $.jsx)(g, {
  ...
  e[9] === t
    ? (d = e[10])
    : ((d = (0, $.jsx)(et, { electron: !0, children: (0, $.jsx)(jn, { hostId: t }) })),
      (e[9] = t),
      (e[10] = d));
  let f, p;
        ...
        children: [
          ...
          (0, $.jsxs)(`a`, {
            ...
            children: [
              ...
              (0, $.jsx)(Fe, { href: St, className: `icon-xxs` }),
            ],
          }),
        ],
      })),
  ...
  e[16] === t
    ...
    : ((b = (0, $.jsx)(et, {
      ...
      (e[17] = b));
  let x;
  e[18] !== b || e[19] !== u || e[20] !== d
    ? ((x = (0, $.jsxs)(Y, {
        className: `gap-2`,
        children: [l, (0, $.jsxs)(Y.Content, { children: [u, d, b] })],
      })),
      (e[18] = b),
      (e[19] = u),
      (e[20] = d),
  ...
  let S;
  e[22] !== o || e[23] !== t
    ? ((S = o ? (0, $.jsx)(_n, { hostId: t }) : null), (e[22] = o), (e[23] = t), (e[24] = S))
    : (S = e[24]);
  let C;
  e[25] !== a || e[26] !== t
    ? ((C = a ? (0, $.jsx)(`div`, { children: (0, $.jsx)(un, { hostId: t }) }) : null),
      (e[25] = a),
      (e[26] = t),
      (e[27] = C))
    : (C = e[27]);
  ...
  e[28] === C
    ? (w = e[29])
    : ((w = (0, $.jsx)(et, { electron: !0, children: C })), (e[28] = C), (e[29] = w));
  let T;
  e[30] !== i || e[31] !== n || e[32] !== t
    ? ((T = i && n.kind === `local` ? (0, $.jsx)(On, { hostId: t }) : null),
      (e[30] = i),
      (e[31] = n),
      (e[32] = t),
      (e[33] = T))
  ...
  e[34] === T
    ? (E = e[35])
    : ((E = (0, $.jsx)(et, { electron: !0, children: T })), (e[34] = T), (e[35] = E));
  let D;
  return (
    e[36] !== x || e[37] !== S || e[38] !== w || e[39] !== E
      ? ((D = (0, $.jsx)($.Fragment, {
          children: (0, $.jsxs)(kt, { title: s, subtitle: c, children: [x, S, w, E] }),
        })),
        (e[36] = x),
        (e[37] = S),
        (e[38] = w),
...
function En(e) {
  R({ event: e, href: St, initiator: `open_in_browser_bridge` });
}
function Dn(e) {
  return (0, $.jsx)(`a`, {
...
function kn(e) {
  let t = (0, Un.c)(96),
    ...
    a = ee(),
    o = s(),
    { data: l, isLoading: u } = he(le, n),
    d;
  t[0] === n ? (d = t[1]) : ((d = { hostId: n }), (t[0] = n), (t[1] = d));
  let f = ce(d),
    p;
  t[2] === l ? (p = t[3]) : ((p = l?.find(An)), (t[2] = l), (t[3] = p));
  let h = p,
    _ = h?.enabled === !0,
    v;
  t[4] !== n || t[5] !== r
    ...
    : (v = t[6]);
  let y;
  t[7] === n ? (y = t[8]) : ((y = Et(n)), (t[7] = n), (t[8] = y));
  let b;
  t[9] !== v || t[10] !== y
    ? ((b = { queryFn: v, queryKey: y, staleTime: S.FIVE_SECONDS }),
      (t[9] = v),
      (t[10] = y),
      (t[11] = b))
    : (b = t[11]);
  ...
  t[15] !== r || t[16] !== o
    ? ((T = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Tt(o), r.runUpdateNow({ release: t }));
        },
      }),
      (t[15] = r),
      (t[16] = o),
  ...
  t[18] !== n || t[19] !== r || t[20] !== o
    ? ((D = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Tt(o), r.resetDependencies({ hostId: n, release: t }));
        },
      }),
      (t[18] = n),
      (t[19] = r),
  ...
  t[22] === n
    ? (k = t[23])
    : ((k = { mutationFn: () => gt({ hostId: n }) }), (t[22] = n), (t[23] = k));
  let te = ze(k),
    re = ve(mt),
    A = ve(st),
    j = re?.hostId === n ? re : null,
    M;
  t[24] === i ? (M = t[25]) : ((M = i.get(He)), (t[24] = i), (t[25] = M));
  let N = M,
    ie = u || f.isPending || w.isPending || E.isPending || O.isPending || te.isPending,
    ae;
  t[26] === j ? (ae = t[27]) : ((ae = ht(j)), (t[26] = j), (t[27] = ae));
  let F = ae,
    I =
      x.data?.bundleVersion == null || x.data.bundleVersion.length === 0
        ? null
        : x.data.bundleVersion,
    oe;
  t[28] !== w || t[29] !== x || t[30] !== a || t[31] !== i || t[32] !== N
    ? ((oe = () => {
        let e = Date.now();
        w.mutateAsync()
          .then((t) => {
            if (
              (ne(i, Te, Rt({ diagnostics: t, durationMs: Date.now() - e })),
              x.refetch(),
              t.installed)
            ) {
              N.success(
          ...
          .catch(() => {
            (ne(i, Te, Lt({ durationMs: Date.now() - e })),
              N.danger(
                a.formatMessage({
  ...
  let se = oe,
    ue;
  t[34] !== x || t[35] !== a || t[36] !== A || t[37] !== O || t[38] !== i || t[39] !== N
    ? ((ue = () => {
        let e = Date.now();
        O.mutateAsync({ release: A })
          .then((t) => {
            (ne(
              i,
              We,
              Vt({ bundleVersion: t.bundleVersion, durationMs: Date.now() - e, status: t.status }),
            ),
              x.refetch(),
              N.success(
                a.formatMessage({
          ...
          .catch((t) => {
            if (Bt(t)) {
              (i.set(mt, null),
                ...
                ne(
                  i,
                  We,
                  Vt({ bundleVersion: null, durationMs: Date.now() - e, status: `canceled` }),
                ),
                N.info(
                  a.formatMessage({
            ...
            (ne(i, We, Vt({ bundleVersion: null, durationMs: Date.now() - e, status: `failed` })),
              N.danger(
                a.formatMessage({
  ...
  let de = ue,
    pe;
  t[41] !== te || t[42] !== x || t[43] !== a || t[44] !== i || t[45] !== N
    ? ((pe = () => {
        te.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
            if ((i.set(mt, null), x.refetch(), !t)) {
              N.info(
                a.formatMessage({
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ge = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(g, { ...X.workspaceDependencies }) })),
      (t[47] = ge))
    : (ge = t[47]);
  let ye;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, $.jsx)(g, { ...X.currentDependencyVersion })), (t[48] = ye))
    : (ye = t[48]);
  let L;
  t[49] === x.data?.problems.length
    ? (L = t[50])
    : ((L = x.data?.problems.length
        ? (0, $.jsx)(g, {
      ...
      (t[50] = L));
  let R;
  t[51] !== I || t[52] !== x.isLoading || t[53] !== F || t[54] !== j
    ? ((R = F
        ? ut(j, ct(j))
        : x.isLoading
          ? (0, $.jsx)(g, {
  ...
  t[56] === R
    ? (xe = t[57])
    : ((xe = (0, $.jsx)(`span`, { className: `text-sm text-token-text-secondary`, children: R })),
      (t[56] = R),
      (t[57] = xe));
  let z;
  t[58] !== L || t[59] !== xe
    ? ((z = (0, $.jsx)(J, { label: ye, description: L, control: xe })),
      (t[58] = L),
      (t[59] = xe),
      (t[60] = z))
    : (z = t[60]);
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ce = (0, $.jsx)(g, { ...X.codexDependencies })),
      (we = (0, $.jsx)(g, {
      ...
      (t[62] = we))
    : ((Ce = t[61]), (we = t[62]));
  let B = u || f.isPending || h == null,
    V;
  t[63] !== A || t[64] !== E || t[65] !== f
    ? ((V = (e) => {
        f.mutate(
          { enabled: e, featureName: P },
          {
            onSuccess: () => {
              e && E.mutate({ release: A });
            },
          },
        );
      }),
  ...
  t[67] === a
    ...
    : ((H = a.formatMessage({
      ...
      (t[68] = H));
  let Ee;
  t[69] !== _ || t[70] !== B || t[71] !== V || t[72] !== H
    ? ((Ee = (0, $.jsx)(J, {
        label: Ce,
        description: we,
        control: (0, $.jsx)(Se, { checked: _, disabled: B, onChange: V, ariaLabel: H }),
      })),
      (t[69] = _),
      (t[70] = B),
      (t[71] = V),
  ...
  t[74] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((De = (0, $.jsx)(g, { ...X.diagnoseWorkspaceDependencies })),
      (Oe = (0, $.jsx)(g, {
  ...
  t[76] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = (0, $.jsx)(be, { className: `icon-2xs` })),
      (U = (0, $.jsx)(g, {
    ...
    : ((ke = t[76]), (U = t[77]));
  let W;
  t[78] !== w.isPending || t[79] !== se || t[80] !== O.isPending
    ? ((W = (0, $.jsx)(J, {
        label: De,
        description: Oe,
        control: (0, $.jsxs)(je, {
  ...
  t[82] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ae = (0, $.jsx)(g, { ...X.resetWorkspaceDependencies })),
      (Me = (0, $.jsx)(g, {
      ...
      (t[83] = Me))
    : ((Ae = t[82]), (Me = t[83]));
  let Ne = F ? te.isPending : O.isPending,
    Pe = !_ || (F ? te.isPending : ie),
    G = F ? me : de,
    K;
  t[84] === F
    ? (K = t[85])
  ...
  let Ie;
  return (
    t[91] !== z || t[92] !== Ee || t[93] !== W || t[94] !== Fe
      ? ((Ie = (0, $.jsxs)(Y, {
          className: `gap-2`,
          children: [
            ge,
            (0, $.jsx)(Y.Content, { children: (0, $.jsxs)(Kt, { children: [z, Ee, W, Fe] }) }),
          ],
        })),
        (t[91] = z),
        (t[92] = Ee),
...
function jn({ hostId: e }) {
  let t = ee(),
    ...
    u = ve(Ee),
    d = Sn(n.state),
    f = d.hasValue ? (e === `local` ? d.workspaceRoot : null) : e === `local` ? u : null,
    p = Ie(e),
    { data: m, isPending: h } = xe(f, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: _, isPending: v } = he(me, { hostId: e }),
    y = re(`open-file`),
    b = m?.config ?? null,
    x = m?.layers ?? null,
    S = m?.origins ?? null,
    C = _?.requirements ?? null,
    w = Pn(x, t),
    E = x?.find((e) => e.name.type === `user`) ?? null,
    k = x?.find((e) => Oe(e.name)) ?? null,
    te = p == null ? null : `${p}/config.toml`,
    ne = E == null ? te : ae(E.name),
    A = {
      key: `user`,
      kind: `user`,
    ...
    M = [...w, A, ...(j == null ? [] : [j])],
    N = w.length > 0,
    ie = f == null ? (M[0]?.key ?? null) : `project:${f}`,
    P = M.find((e) => e.key === i) ?? M.find((e) => e.key === ie) ?? M[0] ?? null,
    { data: F } = he(Jt, {
      cwd: P?.workspaceRoot == null ? (f == null ? null : D(f)) : D(P.workspaceRoot),
      hostId: e,
    }),
    I = Ln(P?.layer?.config ?? null),
    oe = Hn(b?.approval_policy ?? null) ?? `on-request`,
    ce = b?.sandbox_mode == null ? `read-only` : b.sandbox_mode,
    le = I.sandboxMode == null && ce === `workspace-write`,
    ue = I.sandboxMode === `workspace-write` || le,
    fe = I.approvalPolicy ?? oe,
    _e = I.sandboxMode ?? ce,
    L = Bn(fe),
    be = Vn(_e),
    R = I.networkAccess ?? b?.sandbox_workspace_write?.network_access ?? !1,
    z = S == null ? null : Be(S, `approval_policy`, [`approvalPolicy`]),
    Ce = S == null ? null : Be(S, `sandbox_mode`),
    we = S == null ? null : Be(S, `sandbox_workspace_write`, [`network_access`]),
    Te = P?.kind === `project` ? (P.layer?.disabledReason ?? null) : null,
    B = Rn(P, t),
    H = Gn.filter((e) =>
      C?.allowedApprovalPolicies == null || C.allowedApprovalPolicies.length === 0
        ? !0
        : C.allowedApprovalPolicies.includes(e.value),
    ),
    De = Kn.filter((e) =>
      C?.allowedSandboxModes == null || C.allowedSandboxModes.length === 0
        ? !0
        : C.allowedSandboxModes.includes(e.value),
    );
  async function U(t, n, i) {
    if (!(P == null || P.filePath == null) && o == null) {
      (s(t), l((e) => ({ ...e, [t]: void 0 })));
      try {
        if (P.kind === `project`) await $t({ filePath: P.filePath, keyPath: n, value: i });
        else {
          let t = P.kind === `user` ? await ge(r, e) : null;
          await pe(`write-config-value`, {
            hostId: e,
            keyPath: n,
            value: i,
            mergeStrategy: `upsert`,
            filePath: t ? t.filePath : P.filePath,
            expectedVersion: t == null ? P.expectedVersion : t.expectedVersion,
          });
        }
        (await r.invalidateQueries({ queryKey: [...de, e] }),
          await Promise.all([
            r.invalidateQueries({ queryKey: [...se, e] }),
            r.invalidateQueries({ queryKey: [...T, e] }),
          ]));
      } catch (e) {
        l((n) => ({ ...n, [t]: e instanceof Error ? e.message : `Unable to save` }));
      } finally {
        s(null);
      }
    }
      ...
      (0, $.jsx)(Y.Header, {
        title: (0, $.jsxs)(V, {
          ...
          children: [
            ...
            (0, $.jsxs)(q.Section, {
              children: [
                (0, $.jsx)(q.SectionLabel, { children: (0, $.jsx)(g, { ...X.globalConfig }) }),
                (0, $.jsx)(Mn, {
                  scopeOption: A,
                  selected: P?.key === A.key,
                  onSelect: () => {
                    K(A.key);
                  },
                }),
        ...
        actions: (0, $.jsxs)(je, {
          color: `ghost`,
          size: `toolbar`,
          disabled: P?.filePath == null,
          onClick: () => {
            P?.filePath != null &&
              Pe({
                path: P.filePath,
                cwd: P.workspaceRoot == null ? null : D(P.workspaceRoot),
                hostId: e,
                target: F?.preferredTarget,
                openFile: y.mutate,
              });
          },
          children: [
            ...
            (0, $.jsx)(J, {
              ...
              control: (0, $.jsx)(V, {
                ...
                triggerButton: (0, $.jsx)(Nt, {
                  disabled: G || Ae != null,
                  contentClassName: `truncate`,
                  children: L == null ? fe : t.formatMessage(L.label),
                }),
                children: H.map((e) =>
                  (0, $.jsx)(
                    q.Item,
                    {
                      RightIcon: e.value === fe ? ye : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
              ...
              control: (0, $.jsx)(V, {
                ...
                children: De.map((e) =>
                  (0, $.jsx)(
                    q.Item,
                    {
                      RightIcon: e.value === _e ? ye : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
...
function Pn(e, t) {
  ...
  for (let r of e) {
    ...
    n.push({
      ...
      tooltipText: ae(r.name) ?? r.name.dotCodexFolder,
      filePath: ae(r.name),
...
function zn({
  ...
  return (
    t ??
    (i
      ? r?.kind !== `managed` && n != null && Oe(n.name)
        ? e.formatMessage({
