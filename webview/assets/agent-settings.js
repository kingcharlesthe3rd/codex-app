...
var mn,
  ...
  Z,
  gn = e(() => {
    ((mn = r()), o(), (hn = t(i(), 1)), Xe(), Pt(), mt(), Dt(), Zt(), qt(), V(), Rt(), (Z = n()));
  });
function _n(e) {
  let t = (0, yn.c)(53),
    { hostId: n } = e,
  ...
  if (t[2] !== i || t[3] !== n || t[4] !== o || t[5] !== r) {
    ...
    bb0: {
      ...
      let s;
      t[23] === i ? (s = t[24]) : ((s = (e) => i.has(e)), (t[23] = i), (t[24] = s));
      let l = O.length + a.filter(s).length;
      ((p = Y),
        ...
        (y = a.map((e) =>
          (0, Q.jsx)(
            J.CheckboxItem,
            {
              checked: i.has(e),
              onCheckedChange: (t) => {
                pe(r, { enabled: t, hostId: n, listModelsData: o, reasoningEffort: e });
              },
              children: (0, Q.jsx)(ee, { effort: e }),
            },
            e,
          ),
        )));
  ...
  let C;
  t[31] !== c || t[32] !== h || t[33] !== g || t[34] !== _ || t[35] !== v || t[36] !== y
    ? ((C = (0, Q.jsxs)(c, { align: h, contentWidth: g, triggerButton: _, children: [v, y] })),
      (t[31] = c),
      (t[32] = h),
      (t[33] = g),
      (t[34] = _),
    ...
    : (C = t[37]);
  let E;
  t[38] !== u || t[39] !== C || t[40] !== b || t[41] !== x
    ? ((E = (0, Q.jsx)(u, { label: b, description: x, control: C })),
      (t[38] = u),
      (t[39] = C),
      (t[40] = b),
      (t[41] = x),
  ...
  let D;
  t[43] !== d || t[44] !== E
    ? ((D = (0, Q.jsx)(d, { children: E })), (t[43] = d), (t[44] = E), (t[45] = D))
    : (D = t[45]);
  let k;
  t[46] !== f || t[47] !== D
    ? ((k = (0, Q.jsx)(f, { children: D })), (t[46] = f), (t[47] = D), (t[48] = k))
    : (k = t[48]);
  let A;
  return (
    t[49] !== p || t[50] !== k || t[51] !== S
      ? ((A = (0, Q.jsxs)(p, { children: [S, k] })),
        (t[49] = p),
        (t[50] = k),
        (t[51] = S),
        (t[52] = A))
...
function vn(e) {
  return (0, Q.jsx)(
    J.CheckboxItem,
    { checked: !0, disabled: !0, children: (0, Q.jsx)(ee, { effort: e }) },
    e,
  );
}
var yn,
...
var Cn,
  wn = e(() => {
    (m(), (Cn = S({ workspaceRoot: v().min(1).nullable().optional() }).passthrough()));
  });
function Tn() {
  let e = (0, Un.c)(41),
    { selectedHostId: t } = B(),
                  ...
                  children: [
                    ...
                    e.path == null
                      ...
                      : (0, $.jsx)(De, {
                          ...
                          onClick: () => {
                            e.path != null && re({ hostId: t, path: e.path, range: e.range });
                          },
                          children: (0, $.jsx)(q, {
  ...
  e[9] === t
    ? (d = e[10])
    : ((d = (0, $.jsx)(It, { electron: !0, children: (0, $.jsx)(jn, { hostId: t }) })),
      (e[9] = t),
      (e[10] = d));
  let f, p;
        ...
        children: [
          ...
          (0, $.jsxs)(`a`, {
            ...
            children: [
              ...
              (0, $.jsx)(bt, { href: k, className: `icon-xxs` }),
            ],
          }),
        ],
      })),
  ...
  e[28] === b
    ? (x = e[29])
    : ((x = (0, $.jsx)(It, { electron: !0, children: b })), (e[28] = b), (e[29] = x));
  let S;
  ...
  e[34] === S
    ? (C = e[35])
    : ((C = (0, $.jsx)(It, { electron: !0, children: S })), (e[34] = S), (e[35] = C));
  let w;
  return (
    e[36] !== v || e[37] !== y || e[38] !== x || e[39] !== C
      ? ((w = (0, $.jsx)($.Fragment, {
          children: (0, $.jsxs)(dt, { title: s, subtitle: c, children: [v, y, x, C] }),
        })),
        (e[36] = v),
        (e[37] = y),
        (e[38] = x),
...
function En(e) {
  wt({ event: e, href: k, initiator: `open_in_browser_bridge` });
}
function Dn(e) {
  return (0, $.jsx)(`a`, {
...
function kn(e) {
  let t = (0, Un.c)(96),
    ...
    o = Ze(),
    c = Ee(),
    { data: f, isLoading: m } = d(Tt, n),
    h;
  t[0] === n ? (h = t[1]) : ((h = { hostId: n }), (t[0] = n), (t[1] = h));
  let g = Ct(h),
    _;
  t[2] === f ? (_ = t[3]) : ((_ = f?.find(An)), (t[2] = f), (t[3] = _));
  let v = _,
    y = v?.enabled === !0,
    b;
  t[4] !== n || t[5] !== r
    ? ((b = () => r.diagnoseDependencies({ hostId: n })), (t[4] = n), (t[5] = r), (t[6] = b))
    : (b = t[6]);
  let S;
  t[7] === n ? (S = t[8]) : ((S = Wt(n)), (t[7] = n), (t[8] = S));
  let C;
  t[9] !== b || t[10] !== S
    ? ((C = { queryFn: b, queryKey: S, staleTime: x.FIVE_SECONDS }),
      (t[9] = b),
      (t[10] = S),
      (t[11] = C))
    : (C = t[11]);
  let w = u(C),
    T;
  t[12] !== n || t[13] !== r
    ? ((T = { mutationFn: () => r.diagnoseDependencies({ hostId: n }) }),
      (t[12] = n),
      (t[13] = r),
      (t[14] = T))
    : (T = t[14]);
  ...
  t[15] !== r || t[16] !== c
    ? ((D = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Kt(c), r.runUpdateNow({ release: t }));
        },
      }),
      (t[15] = r),
      (t[16] = c),
  ...
  let O = p(D),
    k;
  t[18] !== n || t[19] !== r || t[20] !== c
    ? ((k = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Kt(c), r.resetDependencies({ hostId: n, release: t }));
        },
      }),
      (t[18] = n),
      (t[19] = r),
  ...
  t[22] === n
    ? (ee = t[23])
    : ((ee = { mutationFn: () => F({ hostId: n }) }), (t[22] = n), (t[23] = ee));
  let j = p(ee),
    te = l(he),
    N = l(oe),
    P = te?.hostId === n ? te : null,
    re;
  t[24] === i ? (re = t[25]) : ((re = i.get(We)), (t[24] = i), (t[25] = re));
  let I = re,
    ie = m || g.isPending || E.isPending || O.isPending || A.isPending || j.isPending,
    L;
  t[26] === P ? (L = t[27]) : ((L = ne(P)), (t[26] = P), (t[27] = L));
  let R = L,
    se =
    ...
    z;
  t[28] !== E || t[29] !== w || t[30] !== o || t[31] !== i || t[32] !== I
    ? ((z = () => {
        let e = Date.now();
        E.mutateAsync()
          .then((t) => {
            if (
              (Be(i, He, rt({ diagnostics: t, durationMs: Date.now() - e })),
              w.refetch(),
              t.installed)
            ) {
              I.success(
          ...
          .catch(() => {
            (Be(i, He, at({ durationMs: Date.now() - e })),
              I.danger(
                o.formatMessage({
  ...
  let ce = z,
    ue;
  t[34] !== w || t[35] !== o || t[36] !== N || t[37] !== A || t[38] !== i || t[39] !== I
    ? ((ue = () => {
        let e = Date.now();
        A.mutateAsync({ release: N })
          .then((t) => {
            (Be(
              i,
              Pe,
              ft({ bundleVersion: t.bundleVersion, durationMs: Date.now() - e, status: t.status }),
            ),
              w.refetch(),
              I.success(
                o.formatMessage({
          ...
          .catch((t) => {
            if (st(t)) {
              (i.set(he, null),
                ...
                Be(
                  i,
                  Pe,
                  ft({ bundleVersion: null, durationMs: Date.now() - e, status: `canceled` }),
                ),
                I.info(
                  o.formatMessage({
            ...
            (Be(i, Pe, ft({ bundleVersion: null, durationMs: Date.now() - e, status: `failed` })),
              I.danger(
                o.formatMessage({
  ...
  let de = ue,
    fe;
  t[41] !== j || t[42] !== w || t[43] !== o || t[44] !== i || t[45] !== I
    ? ((fe = () => {
        j.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
            if ((i.set(he, null), w.refetch(), !t)) {
              I.info(
                o.formatMessage({
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(q, { ...X.workspaceDependencies }) })),
      (t[47] = me))
    : (me = t[47]);
  let B;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, $.jsx)(q, { ...X.currentDependencyVersion })), (t[48] = B))
    : (B = t[48]);
  let V;
  t[49] === w.data?.problems.length
    ? (V = t[50])
    : ((V = w.data?.problems.length
        ? (0, $.jsx)(q, {
      ...
      (t[50] = V));
  let H;
  t[51] !== se || t[52] !== w.isLoading || t[53] !== R || t[54] !== P
    ? ((H = R
        ? ae(P, le(P))
        : w.isLoading
          ? (0, $.jsx)(q, {
  ...
  let ge;
  t[58] !== V || t[59] !== U
    ? ((ge = (0, $.jsx)(M, { label: B, description: V, control: U })),
      (t[58] = V),
      (t[59] = U),
      (t[60] = ge))
    : (ge = t[60]);
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_e = (0, $.jsx)(q, { ...X.codexDependencies })),
      (ve = (0, $.jsx)(q, {
      ...
      (t[62] = ve))
    : ((_e = t[61]), (ve = t[62]));
  let ye = m || g.isPending || v == null,
    W;
  t[63] !== N || t[64] !== O || t[65] !== g
    ? ((W = (e) => {
        g.mutate(
          { enabled: e, featureName: a },
          {
            onSuccess: () => {
              e && O.mutate({ release: N });
            },
          },
        );
      }),
  ...
  t[67] === o
    ...
    : ((be = o.formatMessage({
      ...
      (t[68] = be));
  let G;
  t[69] !== y || t[70] !== ye || t[71] !== W || t[72] !== be
    ? ((G = (0, $.jsx)(M, {
        label: _e,
        description: ve,
        control: (0, $.jsx)(yt, { checked: y, disabled: ye, onChange: W, ariaLabel: be }),
      })),
      (t[69] = y),
      (t[70] = ye),
      (t[71] = W),
  ...
  t[74] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, $.jsx)(q, { ...X.diagnoseWorkspaceDependencies })),
      (Ce = (0, $.jsx)(q, {
  ...
  t[76] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((we = (0, $.jsx)(xe, { className: `icon-2xs` })),
      (Te = (0, $.jsx)(q, {
    ...
    : ((we = t[76]), (Te = t[77]));
  let Oe;
  t[78] !== E.isPending || t[79] !== ce || t[80] !== A.isPending
    ? ((Oe = (0, $.jsx)(M, {
        label: Se,
        description: Ce,
        control: (0, $.jsxs)(De, {
  ...
  t[82] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = (0, $.jsx)(q, { ...X.resetWorkspaceDependencies })),
      (Ae = (0, $.jsx)(q, {
      ...
      (t[83] = Ae))
    : ((ke = t[82]), (Ae = t[83]));
  let je = R ? j.isPending : A.isPending,
    Me = !y || (R ? j.isPending : ie),
    Ne = R ? pe : de,
    K;
  t[84] === R
    ? (K = t[85])
    : ((K = R
      ...
      (t[85] = K));
  let Fe;
  t[86] !== je || t[87] !== Me || t[88] !== Ne || t[89] !== K
    ? ((Fe = (0, $.jsx)(M, {
        label: ke,
        description: Ae,
        control: (0, $.jsx)(De, {
  ...
  let Ie;
  return (
    t[91] !== ge || t[92] !== G || t[93] !== Oe || t[94] !== Fe
      ? ((Ie = (0, $.jsxs)(Y, {
          className: `gap-2`,
          children: [
            me,
            (0, $.jsx)(Y.Content, { children: (0, $.jsxs)(zt, { children: [ge, G, Oe, Fe] }) }),
          ],
        })),
        (t[91] = ge),
        (t[92] = G),
...
function jn({ hostId: e }) {
  let t = Ze(),
    ...
    p = l(Te),
    m = Sn(n.state),
    g = m.hasValue ? (e === `local` ? m.workspaceRoot : null) : e === `local` ? p : null,
    _ = vt(e),
    { data: v, isPending: b } = Se(g, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: x, isPending: S } = d(Me, { hostId: e }),
    C = y(`open-file`),
    w = v?.config ?? null,
    T = v?.layers ?? null,
    E = v?.origins ?? null,
    ...
    A = T?.find((e) => Oe(e.name)) ?? null,
    ee = _ == null ? null : `${_}/config.toml`,
    j = k == null ? ee : K(k.name),
    te = {
      key: `user`,
      kind: `user`,
      label: t.formatMessage(X.userConfig),
      tooltipText: j ?? `~/.codex/config.toml`,
      filePath: j,
    ...
    F = P.find((e) => e.key === i) ?? P.find((e) => e.key === re) ?? P[0] ?? null,
    { data: ie } = d(Jt, {
      cwd: F?.workspaceRoot == null ? (g == null ? null : f(g)) : f(F.workspaceRoot),
      hostId: e,
    }),
    L = Ln(F?.layer?.config ?? null),
    ae = Hn(w?.approval_policy ?? null) ?? `on-request`,
    R = w?.sandbox_mode == null ? `read-only` : w.sandbox_mode,
    oe = L.sandboxMode == null && R === `workspace-write`,
    se = L.sandboxMode === `workspace-write` || oe,
    z = L.approvalPolicy ?? ae,
    ce = L.sandboxMode ?? R,
    le = Bn(z),
    ue = Vn(ce),
    de = L.networkAccess ?? w?.sandbox_workspace_write?.network_access ?? !1,
    fe = E == null ? null : ke(E, `approval_policy`, [`approvalPolicy`]),
    pe = E == null ? null : ke(E, `sandbox_mode`),
    me = E == null ? null : ke(E, `sandbox_workspace_write`, [`network_access`]),
    B = F?.kind === `project` ? (F.layer?.disabledReason ?? null) : null,
    he = Rn(F, t),
    V = Gn.filter((e) =>
    ...
    if (!(F == null || F.filePath == null) && o == null) {
      ...
      try {
        if (F.kind === `project`) await $t({ filePath: F.filePath, keyPath: n, value: i });
          ...
          let t = F.kind === `user` ? await Je(r, e) : null;
          await be(`write-config-value`, {
            hostId: e,
            keyPath: n,
            value: i,
        ...
        (await r.invalidateQueries({ queryKey: [...Ie, e] }),
          await Promise.all([
            r.invalidateQueries({ queryKey: [...Fe, e] }),
      ...
      (0, $.jsx)(Y.Header, {
        title: (0, $.jsxs)(St, {
          ...
          children: [
            ...
            (0, $.jsxs)(J.Section, {
              children: [
                (0, $.jsx)(J.SectionLabel, { children: (0, $.jsx)(q, { ...X.globalConfig }) }),
                (0, $.jsx)(Mn, {
                  scopeOption: te,
                  selected: F?.key === te.key,
                  onSelect: () => {
                    xe(te.key);
                  },
                }),
        ...
        actions: (0, $.jsxs)(De, {
          ...
          onClick: () => {
            F?.filePath != null &&
              jt({
                path: F.filePath,
                cwd: F.workspaceRoot == null ? null : f(F.workspaceRoot),
                hostId: e,
            ...
            (0, $.jsx)(M, {
              ...
              control: (0, $.jsx)(St, {
                ...
                triggerButton: (0, $.jsx)(Ht, {
                  disabled: G || ve != null,
                  contentClassName: `truncate`,
                  children: le == null ? z : t.formatMessage(le.label),
                }),
                children: V.map((e) =>
                  (0, $.jsx)(
                    J.Item,
                    {
                      RightIcon: e.value === z ? Ve : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
            ...
            (0, $.jsx)(M, {
              ...
              control: (0, $.jsx)(St, {
                ...
                triggerButton: (0, $.jsx)(Ht, {
                  disabled: G || ye != null,
                  contentClassName: `truncate`,
                  children: ue == null ? ce : t.formatMessage(ue.label),
                }),
                children: H.map((e) =>
                  (0, $.jsx)(
                    J.Item,
                    {
                      RightIcon: e.value === ce ? Ve : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
...
function Pn(e, t) {
  ...
  for (let r of e) {
    ...
    n.push({
      ...
      tooltipText: K(r.name) ?? r.name.dotCodexFolder,
      filePath: K(r.name),
