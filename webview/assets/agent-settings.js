...
import { Bt as c, n as l } from "./use-host-config-C.js";
import { n as u } from "./thread-context-inputs.js";
import { A as d, _ as f, n as p, s as m, u as h, v as ee } from "./vscode-api.js";
import "./isEqual.js";
import { Aa as g, Ta as _, _n as v, wn as y } from "./src-1.js";
import "./react-dom.js";
...
import { c as D, o as O } from "./statsig.js";
import "./request.js";
...
import { Sn as ne, t as A, wn as j } from "./product-logger.js";
import { f as re } from "./chunk-13.js";
import "./parse-directives.js";
import "./platform.js";
import "./persisted-signal.js";
import { t as M } from "./app-server-manager-hooks.js";
...
import { t as ue } from "./use-codex-home.js";
import "./use-os-info.js";
import { t as I } from "./link-external.js";
import { r as de, t as fe } from "./open-config-toml-button.js";
...
import { n as pe, r as me } from "./experimental-features-queries-D.js";
...
import { n as R } from "./app-identity.js";
...
import "./checkbox.js";
import "./minus.js";
import { u as ge } from "./links.js";
import "./chat.js";
import { r as B, s as V, t as _e } from "./dropdown.js";
import "./globe.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as ve } from "./settings-host-context.js";
import { t as ye } from "./alert.js";
import "./copy-button.js";
import { n as be } from "./markdown-1.js";
import { t as xe } from "./toggle.js";
import { t as Se } from "./lock.js";
...
import { a as we, i as Te, r as Ee, s as De, t as Oe } from "./primary-runtime-install-action.js";
...
import { n as Ie, t as Le } from "./primary-runtime-install-status-message-9X-UzhFS.js";
import { t as Re } from "./open-in-targets-query-sPhl-0xC.js";
import { t as J } from "./experimental-feature-visibility.js";
var Y = r(),
  X = e(t(), 1),
  Z = b({
    customConfig: {
...
async function ze({ filePath: e, keyPath: t, value: n }) {
  let r = Q(t, n);
  if (r == null) throw Error(`Unsupported config key for project config write.`);
  await Be({ filePath: e, field: r });
}
async function Be({ filePath: e, field: t }) {
  let n = ``;
  try {
    n = (await p(`read-file`, { params: { path: e } })).contents;
  } catch (e) {
    if (!Ke(e)) throw Error(`Failed to read project config.`);
  }
  let r = Ve(n, t.name, t.value);
  if (r !== n)
    try {
      await p(`local-environment-config-save`, { params: { configPath: e, raw: r } });
    } catch {
...
function qe(e) {
  ...
  t[7] === y
    ? (b = t[8])
    : ((b = (0, $.jsx)(q.Header, { title: v, subtitle: y })), (t[7] = y), (t[8] = b));
  let te = q,
    C = Fe,
    w;
  t[9] === c
  ...
  t[14] !== C || t[15] !== E || t[16] !== w || t[17] !== T
    ...
    : (D = t[18]);
  let O;
  t[19] !== D || t[20] !== te.Content
    ? ((O = (0, $.jsx)(te.Content, { children: D })),
      (t[19] = D),
      (t[20] = te.Content),
      (t[21] = O))
    : (O = t[21]);
...
var Ze = _({ workspaceRoot: g().min(1).nullable().optional() }).passthrough();
function Qe(e) {
...
var $e = [
    { value: `untrusted`, label: Z.untrusted, description: `Always ask before taking action` },
    { value: `on-failure`, label: Z.onFailure, description: `Ask only when a command fails` },
    { value: `on-request`, label: Z.onRequest, description: `Ask when escalation is requested` },
    { value: `never`, label: Z.never, description: `Run without asking for approval` },
  ],
  et = [
    { value: `read-only`, label: Z.readOnly, description: `Can read files, but cannot edit them` },
    {
      value: `workspace-write`,
      label: Z.workspaceWrite,
...
function tt() {
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(q.Header, { title: (0, $.jsx)(S, { ...Z.customConfig }) })), (e[2] = c))
    : (c = e[2]);
  let u;
  if (e[3] !== r || e[4] !== t) {
    let n;
  ...
  e[9] === t
    ? (d = e[10])
    : ((d = (0, $.jsx)(z, { electron: !0, children: (0, $.jsx)(ot, { hostId: t }) })),
      (e[9] = t),
      (e[10] = d));
  let f, p;
  ...
  e[18] !== g || e[19] !== u || e[20] !== d
    ? ((_ = (0, $.jsxs)(q, {
        className: `gap-2`,
        children: [c, (0, $.jsxs)(q.Content, { children: [u, d, g] })],
      })),
      (e[18] = g),
      (e[19] = u),
      (e[20] = d),
  ...
  let v;
  e[22] !== a || e[23] !== t
    ? ((v = a ? (0, $.jsx)(`div`, { children: (0, $.jsx)(qe, { hostId: t }) }) : null),
      (e[22] = a),
      (e[23] = t),
      (e[24] = v))
    : (v = e[24]);
  ...
  e[25] === v
    ? (y = e[26])
    : ((y = (0, $.jsx)(z, { electron: !0, children: v })), (e[25] = v), (e[26] = y));
  let b;
  e[27] !== i || e[28] !== n || e[29] !== t
    ? ((b = i && n.kind === `local` ? (0, $.jsx)(rt, { hostId: t }) : null),
      (e[27] = i),
      (e[28] = n),
      (e[29] = t),
      (e[30] = b))
  ...
  e[31] === b
    ? (x = e[32])
    : ((x = (0, $.jsx)(z, { electron: !0, children: b })), (e[31] = b), (e[32] = x));
  let C;
  return (
    e[33] !== _ || e[34] !== y || e[35] !== x
      ? ((C = (0, $.jsx)($.Fragment, {
          children: (0, $.jsxs)(G, { title: o, subtitle: s, children: [_, y, x] }),
        })),
        (e[33] = _),
        (e[34] = y),
        (e[35] = x),
...
function rt(e) {
  ...
  return (
    t[0] === n
      ? (i = t[1])
      : ((i = (0, $.jsx)(it, { hostId: n, primaryRuntime: r })), (t[0] = n), (t[1] = i)),
    i
  );
}
function it(e) {
  let t = (0, Y.c)(96),
    ...
    l = x(),
    u = D(),
    { data: d, isLoading: p } = i(pe, n),
    m;
  t[0] === n ? (m = t[1]) : ((m = { hostId: n }), (t[0] = n), (t[1] = m));
  let g = me(m),
    _;
  t[2] === d ? (_ = t[3]) : ((_ = d?.find(at)), (t[2] = d), (t[3] = _));
  let v = _,
    b = v?.enabled === !0,
    C;
  t[4] !== n || t[5] !== r
    ? ((C = () => r.diagnoseDependencies({ hostId: n })), (t[4] = n), (t[5] = r), (t[6] = C))
    : (C = t[6]);
  let E;
  t[7] === n ? (E = t[8]) : ((E = Ae(n)), (t[7] = n), (t[8] = E));
  let O;
  t[9] !== C || t[10] !== E
    ? ((O = { queryFn: C, queryKey: E, staleTime: h.FIVE_SECONDS }),
      (t[9] = C),
      (t[10] = E),
      (t[11] = O))
    : (O = t[11]);
  let k = ee(O),
    re;
  t[12] !== n || t[13] !== r
    ? ((re = { mutationFn: () => r.diagnoseDependencies({ hostId: n }) }),
      (t[12] = n),
      (t[13] = r),
      (t[14] = re))
    : (re = t[14]);
  ...
  t[15] !== r || t[16] !== u
    ? ((ie = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await ke(u), r.runUpdateNow({ release: t }));
        },
      }),
      (t[15] = r),
      (t[16] = u),
  ...
  let N = f(ie),
    ae;
  t[18] !== n || t[19] !== r || t[20] !== u
    ? ((ae = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await ke(u), r.resetDependencies({ hostId: n, release: t }));
        },
      }),
      (t[18] = n),
      (t[19] = r),
  ...
  t[22] === n
    ? (oe = t[23])
    : ((oe = { mutationFn: () => je({ hostId: n }) }), (t[22] = n), (t[23] = oe));
  let se = f(oe),
    ce = o(Me),
    le = o(Pe),
    F = ce?.hostId === n ? ce : null,
    ue;
  t[24] === c ? (ue = t[25]) : ((ue = c.get(w)), (t[24] = c), (t[25] = ue));
  let I = ue,
    de = p || g.isPending || M.isPending || N.isPending || P.isPending || se.isPending,
    fe;
  t[26] === F ? (fe = t[27]) : ((fe = Ne(F)), (t[26] = F), (t[27] = fe));
  let L = fe,
    R =
      k.data?.bundleVersion == null || k.data.bundleVersion.length === 0
        ? null
        : k.data.bundleVersion,
    z;
  t[28] !== M || t[29] !== k || t[30] !== l || t[31] !== c || t[32] !== I
    ? ((z = () => {
        let e = Date.now();
        M.mutateAsync()
          .then((t) => {
            if (
              (A(c, ne, Ee({ diagnostics: t, durationMs: Date.now() - e })),
              k.refetch(),
              t.installed)
            ) {
              I.success(
          ...
          .catch(() => {
            (A(c, ne, Te({ durationMs: Date.now() - e })),
              I.danger(
                l.formatMessage({
  ...
  let ge = z,
    B;
  t[34] !== k || t[35] !== l || t[36] !== le || t[37] !== P || t[38] !== c || t[39] !== I
    ? ((B = () => {
        let e = Date.now();
        P.mutateAsync({ release: le })
          .then((t) => {
            (A(
              c,
              j,
          ...
          .catch((t) => {
            ...
            (A(c, j, we({ bundleVersion: null, durationMs: Date.now() - e, status: `failed` })),
              I.danger(
                l.formatMessage({
  ...
  let _e = B,
    ve;
  t[41] !== se || t[42] !== k || t[43] !== l || t[44] !== c || t[45] !== I
    ? ((ve = () => {
        se.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
            if ((c.set(Me, null), k.refetch(), !t)) {
              I.info(
                l.formatMessage({
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((be = (0, $.jsx)(q.Header, { title: (0, $.jsx)(S, { ...Z.workspaceDependencies }) })),
      (t[47] = be))
    : (be = t[47]);
  let Se;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, $.jsx)(S, { ...Z.currentDependencyVersion })), (t[48] = Se))
    : (Se = t[48]);
  let Ce;
  t[49] === k.data?.problems.length
    ? (Ce = t[50])
    : ((Ce = k.data?.problems.length
        ? (0, $.jsx)(S, {
      ...
      (t[50] = Ce));
  let H;
  t[51] !== R || t[52] !== k.isLoading || t[53] !== L || t[54] !== F
    ? ((H = L
        ? Ie(F, Le(F))
        : k.isLoading
          ? (0, $.jsx)(S, {
  ...
  t[56] === H
    ? (U = t[57])
    : ((U = (0, $.jsx)(`span`, { className: `text-sm text-token-text-secondary`, children: H })),
      (t[56] = H),
      (t[57] = U));
  let W;
  t[58] !== Ce || t[59] !== U
    ? ((W = (0, $.jsx)(K, { label: Se, description: Ce, control: U })),
      (t[58] = Ce),
      (t[59] = U),
      (t[60] = W))
    : (W = t[60]);
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, $.jsx)(S, { ...Z.codexDependencies })),
      ...
      (t[62] = De))
    : ((G = t[61]), (De = t[62]));
  let Re = p || g.isPending || v == null,
    J;
  t[63] !== le || t[64] !== N || t[65] !== g
    ? ((J = (e) => {
        g.mutate(
          { enabled: e, featureName: y },
          {
            onSuccess: () => {
              e && N.mutate({ release: le });
            },
          },
        );
      }),
  ...
  t[67] === l
    ...
    : ((X = l.formatMessage({
      ...
      (t[68] = X));
  let ze;
  t[69] !== b || t[70] !== Re || t[71] !== J || t[72] !== X
    ? ((ze = (0, $.jsx)(K, {
        label: G,
        description: De,
        control: (0, $.jsx)(xe, { checked: b, disabled: Re, onChange: J, ariaLabel: X }),
      })),
      (t[69] = b),
      (t[70] = Re),
      (t[71] = J),
  ...
  t[74] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Be = (0, $.jsx)(S, { ...Z.diagnoseWorkspaceDependencies })),
      (Q = (0, $.jsx)(S, {
  ...
  t[76] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((Ve = t[76]), (He = t[77]));
  let Ue;
  t[78] !== M.isPending || t[79] !== ge || t[80] !== P.isPending
    ? ((Ue = (0, $.jsx)(K, {
        label: Be,
        description: Q,
        control: (0, $.jsxs)(te, {
  ...
  t[82] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((We = (0, $.jsx)(S, { ...Z.resetWorkspaceDependencies })),
      (Ge = (0, $.jsx)(S, {
      ...
      (t[83] = Ge))
    : ((We = t[82]), (Ge = t[83]));
  let Ke = L ? se.isPending : P.isPending,
    qe = !b || (L ? se.isPending : de),
    Je = L ? ye : _e,
    Ye;
  t[84] === L
    ? (Ye = t[85])
  ...
  let Ze;
  return (
    t[91] !== W || t[92] !== ze || t[93] !== Ue || t[94] !== Xe
      ? ((Ze = (0, $.jsxs)(q, {
          className: `gap-2`,
          children: [
            be,
            (0, $.jsx)(q.Content, { children: (0, $.jsxs)(Fe, { children: [W, ze, Ue, Xe] }) }),
          ],
        })),
        (t[91] = W),
        (t[92] = ze),
...
function ot({ hostId: e }) {
  let t = x(),
    n = re(),
    r = d(),
    [a, s] = (0, X.useState)(null),
    [l, f] = (0, X.useState)(null),
    [p, h] = (0, X.useState)({}),
    { data: ee } = o(u),
    g = Qe(n.state),
    _ = g.hasValue
      ...
      : e === `local`
        ...
        : null,
    y = ue(e),
    { data: b, isPending: w } = F(_, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: T, isPending: E } = i(ie, { hostId: e }),
    D = m(`open-file`),
    O = b?.config ?? null,
    ne = b?.layers ?? null,
    A = b?.origins ?? null,
    j = T?.requirements ?? null,
    M = lt(ne, t),
    I = ne?.find((e) => e.name.type === `user`) ?? null,
    de = ne?.find((e) => ae(e.name)) ?? null,
    fe = y == null ? null : `${y}/config.toml`,
    pe = I == null ? fe : N(I.name),
    me = {
      key: `user`,
      kind: `user`,
      label: t.formatMessage(Z.userConfig),
      tooltipText: pe ?? `~/.codex/config.toml`,
      filePath: pe,
      expectedVersion: I?.version ?? null,
      workspaceRoot: null,
      layer: I,
    },
    R =
      de == null
        ...
        : {
            key: `managed`,
            kind: `managed`,
            label: t.formatMessage(Z.adminConfig),
    ...
    he = [...M, me, ...(R == null ? [] : [R])],
    z = M.length > 0,
    ge = _ == null ? (he[0]?.key ?? null) : `project:${_}`,
    V = he.find((e) => e.key === a) ?? he.find((e) => e.key === ge) ?? he[0] ?? null,
    { data: ve } = i(Re, {
      cwd: V?.workspaceRoot == null ? (_ == null ? null : v(_)) : v(V.workspaceRoot),
      hostId: e,
    }),
    ye = ft(V?.layer?.config ?? null),
    be = _t(O?.approval_policy ?? null) ?? `on-request`,
    Se = O?.sandbox_mode == null ? `read-only` : O.sandbox_mode,
    H = ye.sandboxMode == null && Se === `workspace-write`,
    U = ye.sandboxMode === `workspace-write` || H,
    G = ye.approvalPolicy ?? be,
    we = ye.sandboxMode ?? Se,
    Te = ht(G),
    Ee = gt(we),
    De = ye.networkAccess ?? O?.sandbox_workspace_write?.network_access ?? !1,
    Oe = A == null ? null : P(A, `approval_policy`, [`approvalPolicy`]),
    ke = A == null ? null : P(A, `sandbox_mode`),
    Ae = A == null ? null : P(A, `sandbox_workspace_write`, [`network_access`]),
    je = V?.kind === `project` ? (V.layer?.disabledReason ?? null) : null,
    Me = pt(V, t),
    Ne = $e.filter((e) =>
      j?.allowedApprovalPolicies == null || j.allowedApprovalPolicies.length === 0
        ? !0
  ...
  async function Ie(t, n, i) {
    if (!(V == null || V.filePath == null) && l == null) {
      (f(t), h((e) => ({ ...e, [t]: void 0 })));
      try {
        if (V.kind === `project`) await ze({ filePath: V.filePath, keyPath: n, value: i });
        else {
          let t = V.kind === `user` ? await le(r, e) : null;
        ...
        (await r.invalidateQueries({ queryKey: [...se, e] }),
          await Promise.all([
            r.invalidateQueries({ queryKey: [...oe, e] }),
            r.invalidateQueries({ queryKey: [...ce, e] }),
          ]));
      } catch (e) {
        h((n) => ({ ...n, [t]: e instanceof Error ? e.message : `Unable to save` }));
      } finally {
        f(null);
      }
    }
      ...
      (0, $.jsx)(q.Header, {
        title: (0, $.jsxs)(_e, {
          ...
          children: [
                    ...
                    (0, $.jsxs)(B.Section, {
                      children: [
                        (0, $.jsx)(B.SectionLabel, {
                          children: (0, $.jsx)(S, { ...Z.projectConfig }),
                        }),
                        M.map((e) =>
                          (0, $.jsx)(
                            st,
            ...
            (0, $.jsxs)(B.Section, {
              children: [
                (0, $.jsx)(B.SectionLabel, { children: (0, $.jsx)(S, { ...Z.globalConfig }) }),
                (0, $.jsx)(st, {
                  scopeOption: me,
                  selected: V?.key === me.key,
                  onSelect: () => {
                    Ve(me.key);
                  },
                }),
        ...
        actions: (0, $.jsxs)(te, {
          ...
          onClick: () => {
            V?.filePath != null &&
              L({
                path: V.filePath,
                cwd: V.workspaceRoot == null ? null : v(V.workspaceRoot),
                hostId: e,
                target: ve?.preferredTarget,
                openFile: D.mutate,
              });
          },
          children: [
      ...
      (0, $.jsx)(q.Content, {
        children: (0, $.jsxs)(Fe, {
          children: [
            ...
            (0, $.jsx)(K, {
              label: (0, $.jsx)(S, { ...Z.approvalPolicy }),
              description: (0, $.jsx)(ct, {
                error: p.approval,
                lockReason: J,
                children: (0, $.jsx)(S, {
              ...
              control: (0, $.jsx)(_e, {
                ...
                triggerButton: (0, $.jsx)(W, {
                  disabled: Q || J != null,
                  contentClassName: `truncate`,
                  children: Te == null ? G : t.formatMessage(Te.label),
                }),
                children: Ne.map((e) =>
                  (0, $.jsx)(
                    B.Item,
                    {
                      RightIcon: e.value === G ? C : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        Ie(`approval`, `approval_policy`, e.value);
                      },
                      SubText: (0, $.jsx)(`div`, {
            ...
            (0, $.jsx)(K, {
              label: (0, $.jsx)(S, { ...Z.sandboxSettings }),
              description: (0, $.jsx)(ct, {
                error: p.sandbox,
                lockReason: Y,
                children: (0, $.jsx)(S, {
              ...
              control: (0, $.jsx)(_e, {
                ...
                children: Pe.map((e) =>
                  (0, $.jsx)(
                    B.Item,
                    {
                      RightIcon: e.value === we ? C : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        Ie(`sandbox`, `sandbox_mode`, e.value);
                      },
                      SubText: (0, $.jsx)(`div`, {
                        className: `pt-1 text-sm text-token-text-secondary`,
                        children: e.description,
            ...
            U
              ? (0, $.jsx)(K, {
                  ...
                  control: (0, $.jsx)(xe, {
                    ...
                    disabled: Q || Be != null,
                    onChange: (e) => {
                      Ie(`network`, `sandbox_workspace_write.network_access`, e);
                    },
...
function lt(e, t) {
  ...
  for (let r of e) {
    ...
    let e = ut(r.name.dotCodexFolder);
    n.push({
      ...
      label: t.formatMessage(
        ...
        { repoName: dt(e ?? r.name.dotCodexFolder) },
      ),
      tooltipText: N(r.name) ?? r.name.dotCodexFolder,
      filePath: N(r.name),
...
function mt({
  ...
  return (
    t ??
    (i
      ? r?.kind !== `managed` && n != null && ae(n.name)
        ? e.formatMessage({
