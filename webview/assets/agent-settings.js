...
import "./request.js";
import { t as k } from "./app-server-manager-hooks.js";
import "./invalidate-queries-and-broadcast.js";
import { t as A } from "./thread-context-inputs.js";
import {
  c as j,
  d as ee,
  f as M,
...
import { n as ae, r as P } from "./experimental-features-queries.js";
...
import { r as F, t as I } from "./open-config-toml-button.js";
...
import { t as L } from "./with-window.js";
...
import "./checkbox.js";
import "./minus.js";
import { l as R } from "./links.js";
import "./badge-Bpp-zYoJ.js";
import "./chat.js";
import { t as me } from "./search-C0nm-Ej1.js";
import { r as z, t as he } from "./dropdown.js";
import "./globe.js";
import "./chevron.js";
...
import { i as xe, t as Se } from "./settings-shared.js";
import { t as Ce } from "./settings-host-context.js";
import { t as V } from "./settings-content-layout.js";
import { t as H } from "./alert-2.js";
import { a as we, i as Te, r as Ee, s as U, t as De } from "./primary-runtime-install-action.js";
import { a as Oe, n as ke } from "./primary-runtime-query-keys.js";
import { a as Ae, i as je, n as Me, r as Ne } from "./primary-runtime-install-state.js";
import { n as W } from "./settings-row.js";
import { n as Pe, t as G } from "./settings-group.js";
import { n as Fe, t as Ie } from "./primary-runtime-install-status-message.js";
import { t as Le } from "./open-in-targets-query.js";
import { n as Re, r as K } from "./agent-settings.search.js";
var q = _(),
  ze = e(l(), 1);
async function Be({ filePath: e, keyPath: t, value: n }) {
  let r = Y(t, n);
  if (r == null) throw Error(`Unsupported config key for project config write.`);
  await J({ filePath: e, field: r });
}
async function J({ filePath: e, field: t }) {
  let n = ``;
  try {
    n = (await v(`read-file`, { params: { path: e } })).contents;
  } catch (e) {
    if (!Ue(e)) throw Error(`Failed to read project config.`);
  }
...
function Ve(e, t, n) {
  return t === `network_access` ? X(e, n === !0) : He(e, t, String(n));
}
function He(e, t, n) {
  let r =
      e.length > 0
...
function Ge(e) {
  ...
  t[7] === b
    ? (x = t[8])
    : ((x = (0, $.jsx)(G.Header, { title: y, subtitle: b })), (t[7] = b), (t[8] = x));
  let w = G,
    T = Pe,
    E;
  t[9] === s
...
var Ye = r({ workspaceRoot: i().min(1).nullable().optional() }).passthrough();
function Xe(e) {
...
function $e() {
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(G.Header, { title: (0, $.jsx)(C, { ...K.customConfig }) })), (e[2] = l))
    : (l = e[2]);
  let u;
  if (e[3] !== r || e[4] !== t) {
    let n;
  ...
  e[9] === t
    ? (d = e[10])
    : ((d = (0, $.jsx)(L, { electron: !0, children: (0, $.jsx)(it, { hostId: t }) })),
      (e[9] = t),
      (e[10] = d));
  let f, p;
  ...
  e[18] !== _ || e[19] !== u || e[20] !== d
    ? ((v = (0, $.jsxs)(G, {
        id: Re.customConfig,
        className: `gap-2`,
        children: [l, (0, $.jsxs)(G.Content, { children: [u, d, _] })],
      })),
      (e[18] = _),
      (e[19] = u),
      (e[20] = d),
  ...
  let y;
  e[22] !== a || e[23] !== t
    ? ((y = a ? (0, $.jsx)(Ge, { hostId: t }) : null), (e[22] = a), (e[23] = t), (e[24] = y))
    : (y = e[24]);
  let b;
  e[25] === y
    ? (b = e[26])
    : ((b = (0, $.jsx)(L, { electron: !0, children: y })), (e[25] = y), (e[26] = b));
  let x;
  e[27] !== i || e[28] !== n || e[29] !== t
    ? ((x = i && n.kind === `local` ? (0, $.jsx)(tt, { hostId: t }) : null),
      (e[27] = i),
      (e[28] = n),
      (e[29] = t),
      (e[30] = x))
  ...
  e[31] === x
    ? (S = e[32])
    : ((S = (0, $.jsx)(L, { electron: !0, children: x })), (e[31] = x), (e[32] = S));
  let w;
  return (
...
function tt(e) {
  ...
  return (
    t[0] === n
      ? (i = t[1])
      : ((i = (0, $.jsx)(nt, { hostId: n, primaryRuntime: r })), (t[0] = n), (t[1] = i)),
    i
  );
}
function nt(e) {
  let t = (0, q.c)(96),
    ...
    c = S(),
    l = D(),
    { data: u, isLoading: d } = m(ae, r),
    _;
  t[0] === r ? (_ = t[1]) : ((_ = { hostId: r }), (t[0] = r), (t[1] = _));
  let v = P(_),
    y;
  t[2] === u ? (y = t[3]) : ((y = u?.find(rt)), (t[2] = u), (t[3] = y));
  let w = y,
    E = w?.enabled === !0,
    O;
  t[4] !== r || t[5] !== i
    ? ((O = () => i.diagnoseDependencies({ hostId: r })), (t[4] = r), (t[5] = i), (t[6] = O))
    : (O = t[6]);
  let k;
  t[7] === r ? (k = t[8]) : ((k = ke(r)), (t[7] = r), (t[8] = k));
  let A;
  t[9] !== O || t[10] !== k
    ? ((A = { queryFn: O, queryKey: k, staleTime: b.FIVE_SECONDS }),
      (t[9] = O),
      (t[10] = k),
      (t[11] = A))
    : (A = t[11]);
  let j = x(A),
    ee;
  t[12] !== r || t[13] !== i
    ? ((ee = { mutationFn: () => i.diagnoseDependencies({ hostId: r }) }),
      (t[12] = r),
      (t[13] = i),
      (t[14] = ee))
    : (ee = t[14]);
  ...
  t[15] !== i || t[16] !== l
    ? ((te = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Oe(l), i.runUpdateNow({ release: t }));
        },
      }),
      (t[15] = i),
      (t[16] = l),
  ...
  t[18] !== r || t[19] !== i || t[20] !== l
    ? ((re = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Oe(l), i.resetDependencies({ hostId: r, release: t }));
        },
      }),
      (t[18] = r),
      (t[19] = i),
  ...
  t[22] === r
    ? (ie = t[23])
    : ((ie = { mutationFn: () => Ae({ hostId: r }) }), (t[22] = r), (t[23] = ie));
  let ce = h(ie),
    le = p(je),
    F = p(Ne),
    I = le?.hostId === r ? le : null,
    ue;
  t[24] === o ? (ue = t[25]) : ((ue = o.get(oe)), (t[24] = o), (t[25] = ue));
  let L = ue,
    pe = d || v.isPending || M.isPending || ne.isPending || N.isPending || ce.isPending,
    R;
  t[26] === I ? (R = t[27]) : ((R = Me(I)), (t[26] = I), (t[27] = R));
  let z = R,
    he =
      j.data?.bundleVersion == null || j.data.bundleVersion.length === 0
        ? null
        : j.data.bundleVersion,
    ge;
  t[28] !== M || t[29] !== j || t[30] !== c || t[31] !== o || t[32] !== L
    ? ((ge = () => {
        let e = Date.now();
        M.mutateAsync()
          .then((t) => {
            if (
              (T(o, a, Ee({ diagnostics: t, durationMs: Date.now() - e })),
              j.refetch(),
              t.installed)
            ) {
              L.success(
          ...
          .catch(() => {
            (T(o, a, Te({ durationMs: Date.now() - e })),
              L.danger(
                c.formatMessage({
  ...
  let _e = ge,
    B;
  t[34] !== j || t[35] !== c || t[36] !== F || t[37] !== N || t[38] !== o || t[39] !== L
    ? ((B = () => {
        let e = Date.now();
        N.mutateAsync({ release: F })
          .then((t) => {
            (T(
              o,
              s,
          ...
          .catch((t) => {
            ...
            (T(o, s, we({ bundleVersion: null, durationMs: Date.now() - e, status: `failed` })),
              L.danger(
                c.formatMessage({
  ...
  let ye = B,
    be;
  t[41] !== ce || t[42] !== j || t[43] !== c || t[44] !== o || t[45] !== L
    ? ((be = () => {
        ce.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
            if ((o.set(je, null), j.refetch(), !t)) {
              L.info(
                c.formatMessage({
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Ce = t[48]);
  let V;
  t[49] === j.data?.problems.length
    ? (V = t[50])
    : ((V = j.data?.problems.length
        ? (0, $.jsx)(C, {
      ...
      (t[50] = V));
  let H;
  t[51] !== he || t[52] !== j.isLoading || t[53] !== z || t[54] !== I
    ? ((H = z
        ? Fe(I, Ie(I))
        : j.isLoading
          ? (0, $.jsx)(C, {
  ...
  let Le;
  t[58] !== V || t[59] !== U
    ? ((Le = (0, $.jsx)(W, { label: Ce, description: V, control: U })),
      (t[58] = V),
      (t[59] = U),
      (t[60] = Le))
    : (Le = t[60]);
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Re = (0, $.jsx)(C, {
      ...
      (t[62] = K))
    : ((Re = t[61]), (K = t[62]));
  let ze = d || v.isPending || w == null,
    Be;
  t[63] !== F || t[64] !== ne || t[65] !== v
    ? ((Be = (e) => {
        v.mutate(
          { enabled: e, featureName: n },
          {
            onSuccess: () => {
              e && ne.mutate({ release: F });
            },
          },
        );
      }),
  ...
  t[67] === c
    ...
    : ((J = c.formatMessage({
      ...
      (t[68] = J));
  let Y;
  t[69] !== E || t[70] !== ze || t[71] !== Be || t[72] !== J
    ? ((Y = (0, $.jsx)(W, {
        label: Re,
        description: K,
        control: (0, $.jsx)(ve, { checked: E, disabled: ze, onChange: Be, ariaLabel: J }),
      })),
      (t[69] = E),
      (t[70] = ze),
      (t[71] = Be),
  ...
  t[76] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((X = t[76]), (Z = t[77]));
  let Q;
  t[78] !== M.isPending || t[79] !== _e || t[80] !== N.isPending
    ? ((Q = (0, $.jsx)(W, {
        label: Ve,
        description: He,
        control: (0, $.jsxs)(se, {
  ...
  t[82] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = (0, $.jsx)(C, {
      ...
      (t[83] = We))
    : ((Ue = t[82]), (We = t[83]));
  let Ge = z ? ce.isPending : N.isPending,
    Ke = !E || (z ? ce.isPending : pe),
    qe = z ? xe : ye,
    Je;
  t[84] === z
    ? (Je = t[85])
  ...
  let Xe;
  return (
    t[91] !== Le || t[92] !== Y || t[93] !== Q || t[94] !== Ye
      ? ((Xe = (0, $.jsxs)(G, {
          className: `gap-2`,
          children: [
            Se,
            (0, $.jsx)(G.Content, { children: (0, $.jsxs)(Pe, { children: [Le, Y, Q, Ye] }) }),
          ],
        })),
        (t[91] = Le),
        (t[92] = Y),
...
function it({ hostId: e }) {
  let n = S(),
    r = w(),
    i = d(),
    [a, o] = (0, ze.useState)(null),
    [s, l] = (0, ze.useState)(null),
    [u, f] = (0, ze.useState)({}),
    { data: h } = p(A),
    g = Xe(r.state),
    _ = g.hasValue
      ...
      : e === `local`
        ...
        : null,
    v = ce(e),
    { data: b, isPending: x } = ie(_, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: T, isPending: E } = m(j, { hostId: e }),
    D = y(`open-file`),
    O = b?.config ?? null,
    k = b?.layers ?? null,
    ae = b?.origins ?? null,
    ...
    oe = st(k, n),
    le = k?.find((e) => e.name.type === `user`) ?? null,
    F = k?.find((e) => M(e.name)) ?? null,
    I = v == null ? null : `${v}/config.toml`,
    de = le == null ? I : ee(le.name),
    fe = {
      key: `user`,
      kind: `user`,
      label: n.formatMessage(K.userConfig),
      tooltipText: de ?? `~/.codex/config.toml`,
      filePath: de,
      expectedVersion: le?.version ?? null,
      workspaceRoot: null,
      layer: le,
    },
    L =
      F == null
        ...
        : {
            key: `managed`,
            kind: `managed`,
            label: n.formatMessage(K.adminConfig),
    ...
    R = [...oe, fe, ...(L == null ? [] : [L])],
    me = oe.length > 0,
    _e = _ == null ? (R[0]?.key ?? null) : `project:${_}`,
    B = R.find((e) => e.key === a) ?? R.find((e) => e.key === _e) ?? R[0] ?? null,
    { data: ye } = m(Le, {
      cwd: B?.workspaceRoot == null ? (_ == null ? null : t(_)) : t(B.workspaceRoot),
      hostId: e,
    }),
    xe = ut(B?.layer?.config ?? null),
    Ce = ht(O?.approval_policy ?? null) ?? `on-request`,
    V = O?.sandbox_mode == null ? `read-only` : O.sandbox_mode,
    H = xe.sandboxMode == null && V === `workspace-write`,
    we = xe.sandboxMode === `workspace-write` || H,
    Te = xe.approvalPolicy ?? Ce,
    Ee = xe.sandboxMode ?? V,
    U = pt(Te),
    De = mt(Ee),
    Oe = xe.networkAccess ?? O?.sandbox_workspace_write?.network_access ?? !1,
    ke = ae == null ? null : te(ae, `approval_policy`, [`approvalPolicy`]),
    Ae = ae == null ? null : te(ae, `sandbox_mode`),
    je = ae == null ? null : te(ae, `sandbox_workspace_write`, [`network_access`]),
    Me = B?.kind === `project` ? (B.layer?.disabledReason ?? null) : null,
    Ne = dt(B, n),
    Fe = Ze.filter((e) =>
  ...
  async function q(t, n, r) {
    if (!(B == null || B.filePath == null) && s == null) {
      (l(t), f((e) => ({ ...e, [t]: void 0 })));
      try {
        (B.kind === `project`
          ? await Be({ filePath: B.filePath, keyPath: n, value: r })
      ...
      (0, $.jsx)(G.Header, {
        title: (0, $.jsxs)(he, {
          ...
          children: [
            me
              ? (0, $.jsxs)($.Fragment, {
                  children: [
                    (0, $.jsxs)(z.Section, {
                      children: [
                        (0, $.jsx)(z.SectionLabel, {
                          children: (0, $.jsx)(C, { ...K.projectConfig }),
                        }),
                        oe.map((e) =>
                          (0, $.jsx)(
                            at,
            ...
            (0, $.jsxs)(z.Section, {
              children: [
                (0, $.jsx)(z.SectionLabel, { children: (0, $.jsx)(C, { ...K.globalConfig }) }),
                (0, $.jsx)(at, {
                  scopeOption: fe,
                  selected: B?.key === fe.key,
                  onSelect: () => {
                    Z(fe.key);
                  },
                }),
      ...
      (0, $.jsx)(G.Content, {
        children: (0, $.jsxs)(Pe, {
          children: [
            ...
            (0, $.jsx)(W, {
              id: Re.approvalPolicy,
              label: (0, $.jsx)(C, { ...K.approvalPolicy }),
              description: (0, $.jsx)(ot, {
                error: u.approval,
                lockReason: Y,
                children: (0, $.jsx)(C, {
              ...
              control: (0, $.jsx)(he, {
                ...
                triggerButton: (0, $.jsx)(Se, {
                  disabled: X || Y != null,
                  contentClassName: `truncate`,
                  children: U == null ? Te : n.formatMessage(U.label),
                }),
                children: Fe.map((e) =>
                  (0, $.jsx)(
                    z.Item,
                    {
                      ...
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        q(`approval`, `approval_policy`, e.value);
                      },
                      SubText: (0, $.jsx)(`div`, {
            ...
            (0, $.jsx)(W, {
              id: Re.sandboxSettings,
              label: (0, $.jsx)(C, { ...K.sandboxSettings }),
              description: (0, $.jsx)(ot, {
                error: u.sandbox,
                lockReason: Ve,
                children: (0, $.jsx)(C, {
              ...
              control: (0, $.jsx)(he, {
                ...
                triggerButton: (0, $.jsx)(Se, {
                  disabled: X || Ve != null,
                  contentClassName: `truncate`,
                  children: De == null ? Ee : n.formatMessage(De.label),
                }),
                children: Ie.map((e) =>
                  (0, $.jsx)(
                    z.Item,
                    {
                      RightIcon: e.value === Ee ? pe : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        q(`sandbox`, `sandbox_mode`, e.value);
                      },
                      SubText: (0, $.jsx)(`div`, {
                        className: `pt-1 text-sm text-token-text-secondary`,
                        children: e.description,
            ...
            we
              ? (0, $.jsx)(W, {
                  ...
                  control: (0, $.jsx)(ve, {
                    ...
                    disabled: X || He != null,
                    onChange: (e) => {
                      q(`network`, `sandbox_workspace_write.network_access`, e);
                    },
...
function st(e, t) {
  ...
  for (let r of e) {
    ...
    let e = ct(r.name.dotCodexFolder);
    n.push({
      ...
      label: t.formatMessage(
        ...
        { repoName: lt(e ?? r.name.dotCodexFolder) },
      ),
      tooltipText: ee(r.name) ?? r.name.dotCodexFolder,
      filePath: ee(r.name),
...
function ft({
  ...
  return (
    t ??
    (i
      ? r?.kind !== `managed` && n != null && M(n.name)
        ? e.formatMessage({
...
function pt(e) {
  return Ze.find((t) => t.value === e) ?? null;
}
function mt(e) {
