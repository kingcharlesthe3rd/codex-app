...
import { m as a, u as o } from "./apps-queries.js";
...
function p(e) {
  ...
  if (
    ...
    bb0: {
      ...
      let e;
      t[12] !== r || t[13] !== s
        ? ((e = m({ appInfo: r, knownAppId: s })), (t[12] = r), (t[13] = s), (t[14] = e))
        : (e = t[14]);
      let n = e;
      if (n != null) {
        let e;
        (t[15] !== n || t[16] !== o
          ? ((e = (0, f.jsx)(n, { "aria-hidden": !0, className: o })),
            (t[15] = n),
            (t[16] = o),
            (t[17] = e))
          : (e = t[17]),
      ...
      if (
        ((S = h({ logoUrl: c ?? r?.logoUrl, logoDarkUrl: p ?? r?.logoUrlDark, isDarkTheme: y })),
        (b = (0, d.cloneElement)(g, { className: i(x, g.props.className) })),
        S == null)
      ) {
        w = b;
        break bb0;
...
function _(e) {
  ...
  return (
    t[0] !== r || t[1] !== n || t[2] !== s || t[3] !== a
      ? ((c = (0, f.jsx)(v, { className: n, alt: r, fallback: a, src: s }, s)),
        (t[0] = r),
        (t[1] = n),
        (t[2] = s),
        (t[3] = a),
...
function v(e) {
  let t = (0, u.c)(7),
    { alt: n, className: r, src: a, fallback: o } = e,
    [s, c] = (0, d.useState)(!1);
  if (s) return o;
  let l;
  t[0] === r ? (l = t[1]) : ((l = i(`object-contain`, r)), (t[0] = r), (t[1] = l));
  let p;
...
export { p as t };
//# sourceMappingURL=connector-logo-BJg-OSjk.js.map
