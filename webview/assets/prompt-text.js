import { Jr as e, Wr as t, Yr as n, ur as r } from "./app-server-manager-signals.js";
import { it as i } from "./setting-storage.js";
import { r as a, t as o } from "./route-scope.js";
import { a as s, b as c, h as l, o as u, t as d, y as f } from "./mention-item.js";
import { t as p } from "./external-link-source.js";
...
function L(i, a) {
  ...
  for (; S < a.length; ) {
    ...
    let I = f({ href: P, label: j }),
      ...
      R = l(j);
    if (m && I === `plugin`)
      x.push(m.create({ name: R, displayName: R, path: P, description: ``, iconSmall: `` }));
    else if (I === `app` || I === `skill`) {
      let e = j.startsWith(`$`) ? R : j;
      I === `app` && p
        ? x.push(p.create({ name: d(e), displayName: e, path: P, description: ``, iconSmall: `` }))
        : I === `skill` && o
          ? x.push(
              o.create({ name: e, displayName: r(e), path: P, description: ``, iconSmall: `` }),
            )
          : x.push(i.text(`[${A}](${O})`));
    } else if (I === `agent` && g) {
      let e = j.startsWith(`@`) ? j.slice(1) : j,
        ...
        n = c(P);
      t != null || n != null
        ? x.push(g.create({ name: e, displayName: e, conversationId: t, path: P }))
        : x.push(i.text(`[${A}](${O})`));
    } else if (I === `mcp-resource` && _) {
      let e = u(P);
      e == null ? x.push(i.text(`[${A}](${O})`)) : x.push(_.create({ ...e, title: j }));
    } else
...
function R(e) {
  for (let t of e.matchAll(j)) {
    let e = t[1],
      r = t[2];
    if (!(e == null || r == null) && b({ displayText: e, href: n(r) }) != null) return !0;
  }
  return !1;
}
function z(t) {
  for (let r of t.matchAll(k)) {
    let t = r[1],
      i = r[2];
    if (!(t == null || i == null) && f({ href: n(i), label: e(t) }) !== `text`) return !0;
  }
  return !1;
}
...
export { v as a, _ as c, B as i, g as l, F as n, y as o, I as r, m as s, P as t, h as u };
