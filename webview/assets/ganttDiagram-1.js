...
import { i as S, n as C, o as w, r as T } from "./chunk-63.js";
import {
  B as E,
  C as D,
  V as O,
...
` +
    ...
    (vt = { monday: u, tuesday: p, wednesday: f, thursday: h, friday: v, saturday: d, sunday: g }),
    (yt = C((e, t) => {
      let n = [...e].map(() => -1 / 0),
      ...
      renderer: {
        ...
        draw: C(function (e, t, n, u) {
          let d = M().gantt,
            ...
            p;
          f === `sandbox` && (p = ae(`#i` + t));
          let h = ae(f === `sandbox` ? p.nodes()[0].contentDocument.body : `body`),
          ...
          function j(e, t, n) {
            let a = d.barHeight,
              ...
              s = d.topPadding,
              c = d.leftPadding,
              l = r().domain([0, T.length]).range([`#00B9FA`, `#F95002`]).interpolate(i);
            ...
            if (
              (l
                ...
                .attr(`height`, function (e) {
                  return e.vert ? w.length * (d.barHeight + d.barGap) + d.barHeight * 2 : a;
                })
                ...
                .attr(`class`, function (e) {
                  ...
                  let n = 0;
                  for (let [t, r] of T.entries()) e.type === r && (n = t % d.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              l
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? d.gridLineStartPadding + w.length * (d.barHeight + d.barGap) + 60
                ...
                .attr(`class`, function (e) {
                  ...
                  let o = 0;
                  for (let [t, n] of T.entries()) e.type === n && (o = t % d.numberSectionStyles);
                  let c = ``;
                  return (
          ...
          function re(e, t, n, r, i, a, o, s) {
            ...
            for (let { startTime: e, endTime: t } of a)
              ((c === void 0 || e < c) && (c = e), (l === void 0 || t > l) && (l = t));
            if (!c || !l) return;
