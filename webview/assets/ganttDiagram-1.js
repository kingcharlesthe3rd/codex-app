...
import { i as S, n as C, o as w, r as T } from "./chunk-57.js";
import {
  B as E,
  C as D,
  V as O,
...
import { g as le, u as ue } from "./chunk-126.js";
var de = n((e, t) => {
    (function (n, r) {
...
` +
    ...
    (vt = { monday: v, tuesday: x, wednesday: l, thursday: h, friday: s, saturday: b, sunday: c }),
    (yt = C((e, t) => {
      let n = [...e].map(() => -1 / 0),
      ...
      renderer: {
        ...
        draw: C(function (e, t, n, s) {
          let c = M().gantt,
            ...
            h;
          l === `sandbox` && (h = ae(`#i` + t));
          let v = ae(l === `sandbox` ? h.nodes()[0].contentDocument.body : `body`),
          ...
          function j(e, t, n) {
            let a = c.barHeight,
              ...
              l = c.topPadding,
              u = c.leftPadding,
              d = r().domain([0, T.length]).range([`#00B9FA`, `#F95002`]).interpolate(i);
          ...
          function te(e, n, r, i, a, o, l) {
            ...
            if (
              (d
                ...
                .attr(`x`, function (e) {
                  return e.milestone
                    ? k(e.startTime) + i + 0.5 * (k(e.endTime) - k(e.startTime)) - 0.5 * a
                    : k(e.startTime) + i;
                })
                .attr(`y`, function (e, t) {
                ...
                .attr(`height`, function (e) {
                  return e.vert ? w.length * (c.barHeight + c.barGap) + c.barHeight * 2 : a;
                })
                .attr(`transform-origin`, function (e, t) {
                  return (
                    (t = e.order),
                    (k(e.startTime) + i + 0.5 * (k(e.endTime) - k(e.startTime))).toString() +
                      `px ` +
                ...
                .attr(`class`, function (e) {
                  ...
                  let n = 0;
                  for (let [t, r] of T.entries()) e.type === r && (n = t % c.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              d
                ...
                .attr(`x`, function (e) {
                  ...
                  if (
                    (e.milestone &&
                      ((t += 0.5 * (k(e.endTime) - k(e.startTime)) - 0.5 * a), (n = t + a)),
                    e.vert)
                  )
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? c.gridLineStartPadding + w.length * (c.barHeight + c.barGap) + 60
                ...
                .attr(`class`, function (e) {
                  ...
                  let o = 0;
                  for (let [t, n] of T.entries()) e.type === n && (o = t % c.numberSectionStyles);
                  let s = ``;
                  return (
