...
import { i as S, n as C, o as w, r as T } from "./chunk-3.js";
import {
  B as E,
  C as D,
  V as O,
...
` +
    ...
    (vt = { monday: x, tuesday: f, wednesday: y, thursday: a, friday: i, saturday: h, sunday: o }),
    (yt = C((e, t) => {
      let n = [...e].map(() => -1 / 0),
      ...
      renderer: {
        ...
        draw: C(function (e, t, n, i) {
          let a = M().gantt,
            ...
            f;
          o === `sandbox` && (f = ae(`#i` + t));
          let h = ae(o === `sandbox` ? f.nodes()[0].contentDocument.body : `body`),
          ...
          function j(e, t, n) {
            let r = a.barHeight,
              ...
              s = a.topPadding,
              l = a.leftPadding,
              u = c().domain([0, T.length]).range([`#00B9FA`, `#F95002`]).interpolate(g);
          ...
          function te(e, n, r, o, s, c, l) {
            ...
            if (
              (d
                ...
                .attr(`x`, function (e) {
                  return e.milestone
                    ? k(e.startTime) + o + 0.5 * (k(e.endTime) - k(e.startTime)) - 0.5 * s
                    : k(e.startTime) + o;
                })
                .attr(`y`, function (e, t) {
                ...
                .attr(`height`, function (e) {
                  return e.vert ? w.length * (a.barHeight + a.barGap) + a.barHeight * 2 : s;
                })
                .attr(`transform-origin`, function (e, t) {
                  return (
                    (t = e.order),
                    (k(e.startTime) + o + 0.5 * (k(e.endTime) - k(e.startTime))).toString() +
                      `px ` +
                ...
                .attr(`class`, function (e) {
                  ...
                  let n = 0;
                  for (let [t, r] of T.entries()) e.type === r && (n = t % a.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              d
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? a.gridLineStartPadding + w.length * (a.barHeight + a.barGap) + 60
                ...
                .attr(`class`, function (e) {
                  ...
                  let o = 0;
                  for (let [t, n] of T.entries()) e.type === n && (o = t % a.numberSectionStyles);
                  let c = ``;
                  return (
