...
function D(e) {
  let t = e.regex,
    ...
    r = n + E(`(?:<` + n + `~~~(?:\\s*,\\s*[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*~~~)*>)?`, /~~~/g, 2),
    i = {
      keyword:
        ...
        contains: [
          {
            ...
            keywords: i,
            relevance: 0,
            contains: [a, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, T, e.C_BLOCK_COMMENT_MODE],
          },
          e.C_LINE_COMMENT_MODE,
          e.C_BLOCK_COMMENT_MODE,
        ],
...
function I(e) {
  let t = e.regex,
    ...
    s = { $pattern: O, keyword: k, literal: A, built_in: F, "variable.language": P },
    c = `[0-9](_?[0-9])*`,
    l = `\\.(${c})`,
  ...
  let I = {
    ...
    z =
      ...
      `)\\s*=>`,
    B = {
      match: [/const|var|let/, /\s+/, r, /\s*/, /=\s*/, /(async\s*)?/, t.lookahead(z)],
      keywords: `async`,
      className: { 1: `keyword`, 3: `title.function` },
      contains: [x],
    };
...
function de(e) {
  let t = re(e),
    ...
    l = { $pattern: /[a-z-]+/, keyword: `and or not only`, attribute: se.join(` `) },
  ...
  return {
    ...
    contains: [
      ...
      { begin: `@(page|font-face)`, keywords: { $pattern: i, keyword: `@page @font-face` } },
      {
        ...
        returnBegin: !0,
        keywords: { $pattern: /[a-z-]+/, keyword: `and or not only`, attribute: Pe.join(` `) },
        contains: [
...
var K = (e) => W(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/),
  ...
  Ge = [`false`, `nil`, `true`],
  Ke = [`assignment`, `associativity`, `higherThan`, `left`, `lowerThan`, `none`, `right`],
  qe = [
    `#colorLiteral`,
    `#column`,
    `#dsohandle`,
...
function et(e) {
    ...
    O = [
      {
        match: /(@|#(un)?)available/,
        scope: `keyword`,
        starts: { contains: [{ begin: /\(/, end: /\)/, keywords: $e, contains: [...f, h, x] }] },
      },
  ...
  let j = {
    ...
    I = { match: [/operator/, /\s+/, J], className: { 1: `keyword`, 3: `title` } },
    L = {
    ...
    z = { match: [/class\b/, /\s+/, /var\b/], scope: { 1: `keyword`, 3: `keyword` } },
    B = {
...
function st(e) {
  let t = e.regex,
    ...
    s = { $pattern: Q, keyword: tt, literal: $, built_in: ot, "variable.language": at },
    c = `[0-9](_?[0-9])*`,
    l = `\\.(${c})`,
    u = `0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*`,
    d = {
