...
import { t as n } from "./core-BhC--hfn.js";
var r,
  i,
  a = e(() => {
    ((r = t(n())), (i = r.default));
  ...
  return {
    ...
    contains: [
      ...
      n.ATTRIBUTE_SELECTOR_MODE,
      {
        ...
        variants: [{ begin: `:(` + C.join(`|`) + `)` }, { begin: `:(:)?(` + w.join(`|`) + `)` }],
      },
      n.CSS_VARIABLE,
      ...
      },
      {
        ...
        contains: [
          { className: `keyword`, begin: i },
          {
            ...
            excludeEnd: !0,
            relevance: 0,
            keywords: { $pattern: /[a-z-]+/, keyword: `and or not only`, attribute: S.join(` `) },
...
function ae(e) {
  let t = e.regex,
    ...
    r = n + P(`(?:<` + n + `~~~(?:\\s*,\\s*[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*~~~)*>)?`, /~~~/g, 2),
    i = {
      keyword:
...
function se(e) {
  let t = e.regex,
    ...
    s = { $pattern: z, keyword: ce, literal: le, built_in: me, "variable.language": pe },
    c = `[0-9](_?[0-9])*`,
    l = `\\.(${c})`,
...
function Ce(e) {
  let t = we(e),
    ...
    l = { $pattern: /[a-z-]+/, keyword: `and or not only`, attribute: Oe.join(` `) },
...
function _t(e) {
  ...
  return {
    ...
    contains: [
      ...
      t.ATTRIBUTE_SELECTOR_MODE,
      { className: `selector-tag`, begin: `\\b(` + xt.join(`|`) + `)\\b`, relevance: 0 },
      ...
      { begin: `@(page|font-face)`, keywords: { $pattern: i, keyword: `@page @font-face` } },
      {
        ...
        returnBegin: !0,
        keywords: { $pattern: /[a-z-]+/, keyword: `and or not only`, attribute: St.join(` `) },
        contains: [
...
function G(...e) {
  return `(` + (Mt(e).capture ? `` : `?:`) + e.map((e) => jt(e)).join(`|`) + `)`;
}
function Nt(e) {
  let t = { match: /\s+/, relevance: 0 },
    ...
    _ = (e = ``) => ({ className: `subst`, match: W(/\\/, e, /[\t ]*(?:[\r\n]|\r\n)/) }),
    v = (e = ``) => ({ className: `subst`, label: `interpol`, begin: W(/\\/, e, /\(/), end: /\)/ }),
    y = (e = ``) => ({ begin: W(e, /"""/), end: W(/"""/, e), contains: [g(e), _(e), v(e)] }),
    b = (e = ``) => ({ begin: W(e, /"/), end: W(/"/, e), contains: [g(e), v(e)] }),
    x = {
      className: `string`,
    ...
    O = [
      {
        match: /(@|#(un)?)available/,
        scope: `keyword`,
        starts: { contains: [{ begin: /\(/, end: /\)/, keywords: Gt, contains: [...f, h, x] }] },
      },
    ...
    k = {
      ...
      contains: [
        {
          className: `type`,
          match: W(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, Y, `+`),
        },
  ...
  let j = {
    ...
    ne = { match: [/operator/, /\s+/, J], className: { 1: `keyword`, 3: `title` } },
    re = {
    ...
    P = { match: [/class\b/, /\s+/, /var\b/], scope: { 1: `keyword`, 3: `keyword` } },
    ae = {
...
var K,
  ...
  Kt = e(() => {
    ((K = (e) => W(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/)),
      ...
      (Lt = [`false`, `nil`, `true`]),
      (Rt = [`assignment`, `associativity`, `higherThan`, `left`, `lowerThan`, `none`, `right`]),
      (zt = [
        `#colorLiteral`,
        `#column`,
        `#dsohandle`,
...
function qt(e) {
  let t = e.regex,
    ...
    s = { $pattern: Q, keyword: Yt, literal: Xt, built_in: $, "variable.language": en },
    c = `[0-9](_?[0-9])*`,
    l = `\\.(${c})`,
    u = `0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*`,
    d = {
