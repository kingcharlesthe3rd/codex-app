...
function r(e) {
  let t = e.regex,
    ...
    y = {
      ...
      keywords: g,
      contains: v.concat([
        { begin: /\(/, end: /\)/, keywords: g, contains: v.concat([`self`]), relevance: 0 },
      ]),
      relevance: 0,
    },
    b = {
...
function o(e) {
  let t = e.regex,
    ...
    m = {
      ...
      keywords: f,
      contains: p.concat([
        { begin: /\(/, end: /\)/, keywords: f, contains: p.concat([`self`]), relevance: 0 },
      ]),
      relevance: 0,
    },
    h = {
...
function c(e) {
  ...
  ((l.contains = [f, d, s, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a, e.C_BLOCK_COMMENT_MODE]),
    (u.contains = [
      p,
      d,
      c,
  ...
  return {
    ...
    contains: [
      ...
      n.ATTRIBUTE_SELECTOR_MODE,
      {
        ...
        variants: [{ begin: `:(` + m.join(`|`) + `)` }, { begin: `:(:)?(` + h.join(`|`) + `)` }],
      },
      n.CSS_VARIABLE,
      ...
      },
      {
        ...
        contains: [
          { className: `keyword`, begin: i },
          {
            ...
            excludeEnd: !0,
            relevance: 0,
            keywords: { $pattern: /[a-z-]+/, keyword: `and or not only`, attribute: p.join(` `) },
...
function C(e) {
  ...
  let i = {
    ...
    s = { begin: /\[/, end: /\]/, contains: [r, a, i, o, n, `self`], relevance: 0 },
...
var w = `[0-9](_*[0-9])*`,
  ...
  D = {
    className: `number`,
    variants: [
      { begin: `(\\b(${w})((${T})|\\.)?|(${T}))[eE][+-]?(${w})[fFdD]?\\b` },
      { begin: `\\b(${w})((${T})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
      { begin: `(${T})[fFdD]?\\b` },
      { begin: `\\b(${w})[fFdD]\\b` },
...
function k(e) {
  let t = e.regex,
    ...
    r = n + O(`(?:<` + n + `~~~(?:\\s*,\\s*[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*~~~)*>)?`, /~~~/g, 2),
    i = {
      keyword:
        ...
        contains: [
          {
            ...
            keywords: i,
            relevance: 0,
            contains: [a, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, D, e.C_BLOCK_COMMENT_MODE],
          },
          e.C_LINE_COMMENT_MODE,
          e.C_BLOCK_COMMENT_MODE,
        ],
...
function I(e) {
  let t = e.regex,
    ...
    s = { $pattern: A, keyword: j, literal: M, built_in: te, "variable.language": ee },
    c = `[0-9](_?[0-9])*`,
    l = `\\.(${c})`,
  ...
  let O = {
    ...
    L =
      ...
      `)\\s*=>`,
    R = {
      match: [/const|var|let/, /\s+/, r, /\s*/, /=\s*/, /(async\s*)?/, t.lookahead(L)],
      keywords: `async`,
      className: { 1: `keyword`, 3: `title.function` },
      contains: [x],
    };
...
function re(e) {
  ...
  let s = {
    ...
    c = {
      ...
      contains: [
        { begin: /\(/, end: /\)/, contains: [e.inherit(o, { className: `string` }), `self`] },
      ],
    },
    l = ne,
...
function ie(e) {
  let t = e.regex.either(
    ...
    c = { begin: /\[/, end: /\]/, endsParent: !0, relevance: 0, contains: [o, ...a] },
    l = { begin: /\s+/, relevance: 0 },
    u = [s],
    d = [c],
    f = function (e, t) {
      return { contains: [l], starts: { relevance: 0, contains: e, starts: t } };
    },
    p = function (e, t) {
      return {
        begin: `\\\\` + e + `(?![a-zA-Z@:_])`,
      ...
      ...[
        ...
        ...[].concat(
          ...[``, `\\*`].map((e) => [
            ...
            ...[``, `B`, `L`].map((t) => m(t + `Verbatim` + e, f(d, g(t + `Verbatim` + e)))),
          ]),
        ),
...
function me(e) {
  let t = ae(e),
    ...
    l = { $pattern: /[a-z-]+/, keyword: `and or not only`, attribute: le.join(` `) },
  ...
  let d = o.concat({ begin: /\{/, end: /\}/, contains: a }),
    ...
    g = {
      ...
      contains: [
        ...
        c(`keyword`, `all\\b`),
        c(`variable`, `@\\{` + r + `\\}`),
        { begin: `\\b(` + ce.join(`|`) + `)\\b`, className: `selector-tag` },
        t.CSS_NUMBER_MODE,
        c(`selector-tag`, i, 0),
        c(`selector-id`, `#` + i),
    ...
    _ = { begin: `[\\w-]+:(:)?(${n.join(`|`)})`, returnBegin: !0, contains: [g] };
  return (
    a.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, m, h, _, p, g, f, t.FUNCTION_DISPATCH),
...
function ye(e) {
  let t = e.regex,
    ...
    r = t.either(/``[+-]?(\d*\.\d+|\d+\.\d*|\d+)/, /`([+-]?(\d*\.\d+|\d+\.\d*|\d+))?/),
    i = {
      className: `number`,
      relevance: 0,
    ...
    l = { className: `operator`, relevance: 0, begin: /[+\-*/,;.:@~=><&|_`'^?!%]+/ },
    u = {
      className: `pattern`,
      relevance: 0,
      begin: /([a-zA-Z$][a-zA-Z0-9$]*)?_+([a-zA-Z$][a-zA-Z0-9$]*)?/,
    },
    d = { className: `slot`, relevance: 0, begin: /#[a-zA-Z$][a-zA-Z0-9$]*|#+[0-9]?/ },
...
function Se(e) {
  let t = {
    ...
    o = [`dispatch_once_t`, `dispatch_queue_t`, `dispatch_sync`, `dispatch_async`, `dispatch_once`],
    s = {
...
function Ce(e) {
  let t = e.regex,
    ...
    p = (e, n, i) => t.concat(t.concat(`(?:`, e, `)`), n, /(?:\\.|[^\\\/])*?/, i, r),
    m = [
      c,
      e.HASH_COMMENT_MODE,
...
function Te(e) {
  let t = e.regex,
    ...
    x = {
      variants: [
        {
          match: [/new/, t.concat(p, `+`), t.concat(`(?!`, b(v).join(`\\b|`), `\\b)`), i],
...
function Oe(e) {
  let t = [
    ...
    s = {
      ...
      contains: [i, a, { className: `variable`, begin: /\$[A-z]/, end: /[^A-z]/ }],
    },
    c = {
      className: `string`,
      variants: [
...
function Me(e) {
  let t = e.regex,
    ...
    i = t.concat(r, /(::\w+)*/),
    a = [`include`, `extend`, `prepend`, `public`, `private`, `protected`, `raise`, `throw`],
    o = {
    ...
    h = { match: [/(include|extend)\s+/, i], scope: { 2: `title.class` }, keywords: o },
    g = {
      variants: [{ match: [/class\s+/, i, /\s+<\s+/, i] }, { match: [/\b(class|module)\s+/, i] }],
      scope: { 2: `title.class`, 4: `title.class.inherited` },
      keywords: o,
    },
    _ = { relevance: 0, match: /\b[A-Z][A-Z_0-9]+\b/, className: `variable.constant` },
    v = { match: [/def/, /\s+/, n], scope: { 1: `keyword`, 3: `title.function` }, contains: [m] },
    y = [
      d,
      g,
      h,
...
function He(e) {
  ...
  return {
    ...
    contains: [
      ...
      t.ATTRIBUTE_SELECTOR_MODE,
      { className: `selector-tag`, begin: `\\b(` + Le.join(`|`) + `)\\b`, relevance: 0 },
      { className: `selector-pseudo`, begin: `:(` + r.join(`|`) + `)` },
      { className: `selector-pseudo`, begin: `:(:)?(` + n.join(`|`) + `)` },
      a,
      { begin: /\(/, end: /\)/, contains: [t.CSS_NUMBER_MODE] },
      t.CSS_VARIABLE,
      { className: `attribute`, begin: `\\b(` + Ve.join(`|`) + `)\\b` },
      {
...
function We(e) {
  let t = e.regex,
    ...
    _ = { match: t.concat(/\b/, t.either(...p), /\s*\(/), relevance: 0, keywords: { built_in: p } };
  function v(e) {
  ...
  function b(e, { exceptions: t, when: n } = {}) {
    let r = n;
    return (
      (t ||= []), e.map((e) => (e.match(/\|\d+$/) || t.includes(e) ? e : r(e) ? `${e}|0` : e))
    );
  }
  return {
    name: `SQL`,
...
function W(...e) {
  return `(` + (Ge(e).capture ? `` : `?:`) + e.map((e) => V(e)).join(`|`) + `)`;
}
var G = (e) => U(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/),
  Ke = [`Protocol`, `Type`].map(G),
  qe = [`init`, `self`].map(G),
  Je = [`Any`, `Self`],
  K = [
    `actor`,
  ...
  J = W(tt, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),
  Y = U(tt, J, `*`),
  X = U(/[A-Z]/, J, `*`),
  nt = [
    `attached`,
    `autoclosure`,
    U(/convention\(/, W(`swift`, `block`, `c`), /\)/),
    `discardableResult`,
    `dynamicCallable`,
    `dynamicMemberLookup`,
    `escaping`,
...
function it(e) {
  let t = { match: /\s+/, relevance: 0 },
    ...
    i = { match: [/\./, W(...Ke, ...qe)], className: { 2: `keyword` } },
    a = { match: U(/\./, W(...K)), relevance: 0 },
    o = K.filter((e) => typeof e == `string`).concat([`_|0`]),
    s = {
      variants: [
        {
          className: `keyword`,
          match: W(
            ...K.filter((e) => typeof e != `string`)
              .concat(Je)
              .map(G),
            ...qe,
          ),
    ...
    c = { $pattern: W(/\b\w+/, /#\w+/), keyword: o.concat(Ze), literal: Ye },
    l = [i, a, s],
    u = [
      { match: U(/\./, W(...Qe)), relevance: 0 },
      { className: `built_in`, match: U(/\b/, W(...Qe), /(?=\()/) },
    ],
    d = { match: /->/, relevance: 0 },
    f = [
      d,
    ...
    _ = (e = ``) => ({ className: `subst`, match: U(/\\/, e, /[\t ]*(?:[\r\n]|\r\n)/) }),
    v = (e = ``) => ({ className: `subst`, label: `interpol`, begin: U(/\\/, e, /\(/), end: /\)/ }),
    y = (e = ``) => ({ begin: U(e, /"""/), end: U(/"""/, e), contains: [g(e), _(e), v(e)] }),
    b = (e = ``) => ({ begin: U(e, /"/), end: U(/"/, e), contains: [g(e), v(e)] }),
    x = {
      className: `string`,
      variants: [y(), y(`#`), y(`##`), y(`###`), b(), b(`#`), b(`##`), b(`###`)],
    },
    S = [
      e.BACKSLASH_ESCAPE,
    ...
    D = [
      ...
      { className: `variable`, match: `\\$${J}+` },
    ],
    O = [
      {
        match: /(@|#(un)?)available/,
        scope: `keyword`,
        starts: { contains: [{ begin: /\(/, end: /\)/, keywords: rt, contains: [...f, h, x] }] },
      },
      { scope: `keyword`, match: U(/@/, W(...nt), H(W(/\(/, /\s+/))) },
      { scope: `meta`, match: U(/@/, Y) },
    ],
    k = {
      match: H(/\b[A-Z]/),
      relevance: 0,
      contains: [
        {
          className: `type`,
          match: U(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, J, `+`),
        },
        { className: `type`, match: X, relevance: 0 },
        { match: /[?!]+/, relevance: 0 },
        { match: /\.\.\./, relevance: 0 },
        { match: U(/\s+&\s+/, H(X)), relevance: 0 },
      ],
    },
    A = { begin: /</, end: />/, keywords: c, contains: [...r, ...l, ...O, d, k] };
  k.contains.push(A);
  let j = {
      begin: /\(/,
      end: /\)/,
      ...
      contains: [
        `self`,
        { match: U(Y, /\s*:/), keywords: `_|0`, relevance: 0 },
        ...r,
        T,
        ...l,
        ...u,
    ...
    P = {
      match: [/(func|macro)/, /\s+/, W(E.match, Y, q)],
      className: { 1: `keyword`, 3: `title.function` },
      contains: [M, N, t],
      illegal: [/\[/, /%/],
    },
    ...
    ee = { match: [/operator/, /\s+/, q], className: { 1: `keyword`, 3: `title` } },
    te = {
    ...
    L = { match: [/class\b/, /\s+/, /var\b/], scope: { 1: `keyword`, 3: `keyword` } },
    R = {
      ...
      contains: [
        ...
        ...l,
        {
          ...
          keywords: c,
          contains: [{ scope: `title.class.inherited`, match: X }, ...l],
          relevance: 0,
        },
      ],
    };
...
var Z = `[A-Za-z$_][0-9A-Za-z$_]*`,
  at =
    `as.in.of.if.for.while.finally.var.new.function.do.return.void.else.break.catch.instanceof.with.throw.case.default.try.switch.continue.typeof.delete.let.yield.const.class.debugger.async.await.static.import.from.export.extends.using`.split(
      `.`,
    ),
  Q = [`true`, `false`, `null`, `undefined`, `NaN`, `Infinity`],
  ot =
    `Object.Function.Boolean.Symbol.Math.Date.Number.BigInt.String.RegExp.Array.Float32Array.Float64Array.Int8Array.Uint8Array.Uint8ClampedArray.Int16Array.Int32Array.Uint16Array.Uint32Array.BigInt64Array.BigUint64Array.Set.Map.WeakSet.WeakMap.ArrayBuffer.SharedArrayBuffer.Atomics.DataView.JSON.Promise.Generator.GeneratorFunction.AsyncFunction.Reflect.Proxy.Intl.WebAssembly`.split(
      `.`,
    ),
...
function ut(e) {
  let t = e.regex,
    ...
    s = { $pattern: Z, keyword: at, literal: Q, built_in: $, "variable.language": lt },
    c = `[0-9](_?[0-9])*`,
    l = `\\.(${c})`,
    u = `0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*`,
    d = {
  ...
  let O = {
    ...
    j =
      ...
      `)\\s*=>`,
    M = {
      match: [/const|var|let/, /\s+/, r, /\s*/, /=\s*/, /(async\s*)?/, t.lookahead(j)],
      keywords: `async`,
      className: { 1: `keyword`, 3: `title.function` },
      contains: [x],
    };
...
for (let [e, t] of Object.entries(gt)) n.registerLanguage(e, t);
