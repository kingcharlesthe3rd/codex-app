...
function m(e) {
  ...
  t[3] === x
    ? (w = t[4])
    : ((w = x
        ? (0, f.jsx)(r, { ...p.removeDescription })
        : (0, f.jsx)(r, { ...p.confirmDescription })),
      (t[3] = x),
      (t[4] = w));
  let T = w,
    E;
  ...
  let P = x ? p.removeConfirm : p.confirm,
    F;
  t[21] === P ? (F = t[22]) : ((F = (0, f.jsx)(r, { ...P })), (t[21] = P), (t[22] = F));
  let I;
...
export { m as t };
//# sourceMappingURL=plugin-uninstall-dialog-B-C7-Phm.js.map
