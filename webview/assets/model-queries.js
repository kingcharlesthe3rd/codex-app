...
import { Q as r, Xs as i } from "./app-server-manager-signals.js";
import { S as a, Y as o, _ as s, nt as c, wt as l } from "./setting-storage.js";
import { a as u } from "./statsig.js";
import { n as d } from "./use-auth.js";
import { r as f } from "./models-and-reasoning-efforts.js";
var p = l(),
  m = [],
...
var x = c(
  ...
  (
    ...
    queryFn: () =>
      i(`list-models-for-host`, { hostId: a, includeHidden: !0, cursor: null, limit: c }),
    select: ({ data: r }) => {
      let i = [],
        a = new Set(e),
        o = null;
        ...
        r.forEach((e) => {
          if (l ? a.has(e.model) : !e.hidden) {
            let n =
              t === `copilot`
                ? [
                    e.supportedReasoningEfforts.find((e) => e.reasoningEffort === `medium`) ?? {
                      reasoningEffort: `medium`,
                      description: `medium effort`,
                    },
                  ]
                : [...e.supportedReasoningEfforts];
            (i.push({ ...e, supportedReasoningEfforts: n }), e.isDefault && (o = e));
          }
        }),
