...
import { _ as h, k as g, m as _, u as v } from "./vscode-api.js";
import { t as y } from "./queryOptions.js";
import { Zi as b, na as x, qi as S } from "./src-1.js";
import { c as C } from "./lib.js";
import { t as w } from "./invalidate-queries-and-broadcast.js";
import { u as T } from "./config-queries.js";
...
import { n as M, r as N } from "./model-queries-ChI-PsJH.js";
...
function I({ queryClient: e, hostId: t, cwd: n, enabled: r }) {
  return y({
    ...
    queryFn: async () => {
      try {
        return d((await T(e, t, n, !1)).config);
      } catch {
        return null;
      }
    },
...
var L = i(s, ({ cwd: e = null, hostId: t }, { get: n, queryClient: r }) =>
    I({ queryClient: r, hostId: t, cwd: e, enabled: n(p).includes(t) }),
  ),
  R = b({ code: S(-32600), message: x().min(1) });
function z(e) {
...
var J = a(s, (e, { get: t }) => t(p).includes(e));
function Y(e) {
  let t = (0, U.c)(44),
  ...
  let { data: u, isLoading: d } = M(l),
    f;
  t[2] !== i || t[3] !== n
    ? ((f = { hostId: n, cwd: i }), (t[2] = i), (t[3] = n), (t[4] = f))
    : (f = t[4]);
  let p = r(m, f),
    g;
  t[5] !== i || t[6] !== n || t[7] !== a || t[8] !== c
    ? ((g = I({ queryClient: c, hostId: n, cwd: i, enabled: a })),
      (t[5] = i),
      (t[6] = n),
      (t[7] = a),
      (t[8] = c),
      (t[9] = g))
    : (g = t[9]);
  let { data: v, dataUpdatedAt: y, isLoading: b } = h(g),
    x;
  t[10] !== i || t[11] !== n
    ? ((x = { hostId: n, cwd: i }), (t[10] = i), (t[11] = n), (t[12] = x))
    : (x = t[12]);
  let { data: S, dataUpdatedAt: C, isLoading: w } = r(L, x),
    T;
  t[13] !== i ||
  t[14] !== n ||
  t[15] !== a ||
  ...
  t[21] !== c ||
  t[22] !== v?.model ||
  t[23] !== v?.model_reasoning_effort ||
  t[24] !== y
    ? ((T = () => {
        let e = c.getQueryCache().find({ exact: !0, queryKey: G(n, i) }),
          t = e?.state.dataUpdatedAt ?? 0,
          r = v?.model ?? null,
          o = v?.model_reasoning_effort ?? null,
          s = S?.model ?? null,
          l = S?.model_reasoning_effort ?? null;
        if (t === 0 || y !== t || C === t || (r === s && o === l)) return;
        let u = setTimeout(() => {
          _.warning(`model_settings.config_query_diverged`, {
            safe: {
              cacheDataUpdatedAt: t,
              directDataUpdatedAt: y,
              directIsLoading: b,
              isHostRegistered: a,
  ...
  t[35] !== y
    ...
    (0, W.useEffect)(T, E));
  let D, O;
  if (t[37] !== d || t[38] !== b || t[39] !== u || t[40] !== v || t[41] !== p) {
    O = Symbol.for(`react.early_return_sentinel`);
    bb0: {
      let e = H({
        userSavedModelString: v?.model ?? null,
        userSavedReasoningEffort: v?.model_reasoning_effort ?? null,
        listModelsData: u,
      });
      if (v == null) {
        O = K({ ...e, isLoading: b || d }, p);
        break bb0;
      }
      let t = v.model == null || v.model_reasoning_effort == null;
      D = K(
        { ...e, profile: typeof v.profile == `string` ? v.profile : null, isLoading: t && d },
        p,
      );
    }
    ((t[37] = d), (t[38] = b), (t[39] = u), (t[40] = v), (t[41] = p), (t[42] = D), (t[43] = O));
  } else ((D = t[42]), (O = t[43]));
...
function Q(e = null) {
  let t = o(s),
    ...
    h = C(),
    g = i.cwd,
    v = Y({ hostId: a, cwd: g, isHostRegistered: d }),
    y = q(),
    b = r(l, e),
    x = r(u, e),
    S = x?.settings.model ?? null,
    w = S != null && S.trim().length > 0 ? S : null,
    T = p?.authMethod === `copilot`,
    E = (0, W.useCallback)(
      async (t, n) =>
        e == null || !b
          ? !1
          : (await f(`update-thread-settings-for-next-turn`, {
              conversationId: e,
    ...
    M = (0, W.useCallback)(
      (e) => {
        _.error(`Failed to update model and reasoning effort`, {
          safe: {},
          sensitive: { error: e },
        });
        let n = t.get(k),
    ...
    setModelAndReasoningEffort: (0, W.useCallback)(
      async (e, r) => {
        ...
        try {
          ...
          if (T) {
            await c(t, `copilot-default-model`, e, { throwOnFailure: !0 });
            return;
          }
          if (
            (_.info(`Setting default model and reasoning effort`, {
          ...
          let l = await f(`set-default-model-config-for-host`, {
            hostId: a,
            model: e,
            reasoningEffort: r,
            profile: v.profile,
          ...
          if (
            (await f(`clear-prewarmed-threads-for-host`, { hostId: a }),
            l?.status === `okOverridden`)
          ) {
            (n.setQueryData(i, o),
              t.set(m, s, { model: e, reasoningEffort: r, profile: v.profile }));
            return;
          }
          (t.set(m, s, null), await j(), await t.query.fetch(L, { hostId: a, cwd: g }));
        } catch (e) {
          (i != null && n.setQueryData(i, o), M(e));
        }
      },
      [T, E, v.profile, j, d, a, n, t, M, g],
    ),
    modelSettings: A,
  };
}
