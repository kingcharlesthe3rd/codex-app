...
import { $ as i, R as a, fs as o, sa as s, us as c, w as l } from "./app-server-manager-signals.js";
...
import { c as x } from "./lib-2.js";
import { t as S } from "./queryOptions.js";
import { t as C } from "./invalidate-queries-and-broadcast.js";
import { u as w } from "./config-queries.js";
import { t as T } from "./use-global-state.js";
import { n as E } from "./use-auth-CI-WraL2.js";
import { r as D } from "./toast-signal.js";
import { n as O } from "./open-config-toml-button.js";
import { n as k } from "./models-and-reasoning-efforts.js";
import { n as A, r as j } from "./model-queries.js";
...
function P({ queryClient: e, hostId: t, cwd: n, enabled: r }) {
  return S({
    ...
    queryFn: async () => {
      try {
        return c((await w(e, t, n, !1)).config);
      } catch {
        return null;
      }
    },
...
var F = h(_, ({ cwd: e = null, hostId: t }, { get: n, queryClient: r }) =>
  ...
  I = n({ code: t(-32600), message: r().min(1) });
function L(e) {
...
function W() {
  let e = (0, V.c)(3),
    t = j(),
    { data: n, isLoading: r } = T(`copilot-default-model`),
    i = n ?? t.defaultModel,
    a;
  return (
    e[0] !== r || e[1] !== i
