...
import { a as n, l as r, o as i, p as a, t as o, z as s } from "./app-scope.js";
import {
  E as c,
  Ea as l,
  H as u,
...
import { A as h, h as g, u as _, v } from "./vscode-api.js";
import { t as y } from "./queryOptions.js";
import { ha as b, oa as x, ua as S } from "./src-2.js";
import { l as C } from "./lib.js";
...
function I({ queryClient: e, hostId: t, cwd: n, enabled: r }) {
  return y({
    ...
    queryFn: async () => {
      try {
        return l((await E(e, t, n, !1)).config);
      } catch {
        return null;
      }
    },
...
var L = a(o, ({ cwd: e = null, hostId: t }, { get: n, queryClient: r }) =>
    I({ queryClient: r, hostId: t, cwd: e, enabled: n(m).includes(t) }),
  ),
  R = S({ code: x(-32600), message: b().min(1) });
function z(e) {
...
var J = r(o, (e, { get: t }) => t(m).includes(e));
function Y(e) {
  let t = (0, U.c)(44),
    { hostId: r, cwd: a, isHostRegistered: s } = e,
    c = i(o).queryClient,
    l;
  ...
  let { data: u, isLoading: d } = M(l),
    f;
  t[2] !== a || t[3] !== r
    ? ((f = { hostId: r, cwd: a }), (t[2] = a), (t[3] = r), (t[4] = f))
    : (f = t[4]);
  let m = n(p, f),
    h;
  t[5] !== a || t[6] !== r || t[7] !== s || t[8] !== c
    ? ((h = I({ queryClient: c, hostId: r, cwd: a, enabled: s })),
      (t[5] = a),
      (t[6] = r),
      (t[7] = s),
      (t[8] = c),
      (t[9] = h))
    : (h = t[9]);
  let { data: _, dataUpdatedAt: y, isLoading: b } = v(h),
    x;
  t[10] !== a || t[11] !== r
    ? ((x = { hostId: r, cwd: a }), (t[10] = a), (t[11] = r), (t[12] = x))
    : (x = t[12]);
  let { data: S, dataUpdatedAt: C, isLoading: w } = n(L, x),
    T;
  t[13] !== a ||
  t[14] !== r ||
  t[15] !== s ||
  ...
  t[24] !== y
    ? ((T = () => {
        let e = c.getQueryCache().find({ exact: !0, queryKey: G(r, a) }),
          t = e?.state.dataUpdatedAt ?? 0,
          n = _?.model ?? null,
          i = _?.model_reasoning_effort ?? null,
          o = S?.model ?? null,
          l = S?.model_reasoning_effort ?? null;
        if (t === 0 || y !== t || C === t || (n === o && i === l)) return;
        let u = setTimeout(() => {
  ...
  t[35] !== y
    ...
    (0, W.useEffect)(T, E));
  let D, O;
  if (t[37] !== d || t[38] !== b || t[39] !== u || t[40] !== _ || t[41] !== m) {
    ...
    bb0: {
      ...
      if (_ == null) {
        O = K({ ...e, isLoading: b || d }, m);
        break bb0;
      }
      let t = _.model == null || _.model_reasoning_effort == null;
      D = K(
        { ...e, profile: typeof _.profile == `string` ? _.profile : null, isLoading: t && d },
        m,
      );
    }
    ((t[37] = d), (t[38] = b), (t[39] = u), (t[40] = _), (t[41] = m), (t[42] = D), (t[43] = O));
  } else ((D = t[42]), (O = t[43]));
...
function Q(e = null) {
  let t = i(o),
    ...
    h = C(),
    _ = a.cwd,
    v = Y({ hostId: s, cwd: _, isHostRegistered: l }),
    y = q(),
    b = n(c, e),
    x = n(u, e),
    S = x?.settings.model ?? null,
    T = S != null && S.trim().length > 0 ? S : null,
    E = m?.authMethod === `copilot`,
    D = (0, W.useCallback)(
      async (t, n) =>
        e == null || !b
          ? !1
    ...
    setModelAndReasoningEffort: (0, W.useCallback)(
      async (e, n) => {
        let i = null,
          a;
        try {
          if (await D(e, n)) return;
          if (E) {
            await d(t, `copilot-default-model`, e, { throwOnFailure: !0 });
            return;
          }
          if (
            (g.info(`Setting default model and reasoning effort`, {
              safe: { newModel: e, newEffort: n, profile: v.profile },
            }),
            !l)
          )
          ...
          (await r.cancelQueries({ exact: !0, queryKey: i }),
            ...
            r.setQueryData(i, (t) =>
              t == null
                ? t
                : Object.assign(structuredClone(t), { model: e, model_reasoning_effort: n }),
            ));
          let c = await f(`set-default-model-config-for-host`, {
            hostId: s,
            model: e,
            reasoningEffort: n,
            profile: v.profile,
          ...
          if (
            (await f(`clear-prewarmed-threads-for-host`, { hostId: s }),
            c?.status === `okOverridden`)
          ) {
            (r.setQueryData(i, a),
              t.set(p, o, { model: e, reasoningEffort: n, profile: v.profile }));
            return;
          }
          (t.set(p, o, null), await j(), await t.query.fetch(L, { hostId: s, cwd: _ }));
        } catch (e) {
          (i != null && r.setQueryData(i, a), M(e));
        }
      },
      [E, D, v.profile, j, l, s, r, t, M, _],
    ),
    modelSettings: A,
  };
}
