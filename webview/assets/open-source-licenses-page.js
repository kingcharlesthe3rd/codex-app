...
function E() {
  ...
  let i = r,
    o = n.state != null && typeof n.state == `object` && !Array.isArray(n.state) ? n.state : null,
    { data: s, isLoading: l } = d(A),
    u;
  e[2] !== i || e[3] !== o || e[4] !== t
    ? ((u = () => {
        t(i, { replace: !0, state: o });
      }),
      (e[2] = i),
      (e[3] = o),
      (e[4] = t),
  ...
  e[8] === u
    ? (m = e[9])
    : ((m = (0, k.jsxs)(h, { color: `ghost`, size: `toolbar`, onClick: u, children: [f, p] })),
      (e[8] = u),
      (e[9] = m));
  let _, v;
  ...
  return (
    e[15] !== m || e[16] !== b
      ? ((S = (0, k.jsx)(x, { backSlot: m, title: _, subtitle: v, children: b })),
        (e[15] = m),
        (e[16] = b),
        (e[17] = S))
      : (S = e[17]),
...
e(() => {
  ((O = m()),
    ...
    t(),
    (k = v()),
    (A = _(i, `third-party-notices`, { enabled: !0, staleTime: s.ONE_MINUTE })));
})();
