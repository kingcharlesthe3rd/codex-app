...
import { Z as t, s as n, t as r } from "./app-scope-CWE-zIhQ.js";
import { a as i, u as a } from "./vscode-api.js";
import "./isEqual.js";
import "./src.js";
import { s as o } from "./lib-1.js";
...
import "./spinner.js";
import { f as c, m as l } from "./chunk-13.js";
...
var m = t(),
  h = e(),
  g = i(r, `third-party-notices`, { enabled: !0, staleTime: a.ONE_MINUTE });
function _() {
  let e = (0, m.c)(18),
    t = l(),
    r = c(),
    i;
  e[0] === r.state ? (i = e[1]) : ((i = v(r.state)), (e[0] = r.state), (e[1] = i));
  let a = i,
    _ = r.state != null && typeof r.state == `object` && !Array.isArray(r.state) ? r.state : null,
    { data: y, isLoading: b } = n(g),
    x;
  e[2] !== a || e[3] !== _ || e[4] !== t
    ? ((x = () => {
        t(a, { replace: !0, state: _ });
      }),
      (e[2] = a),
      (e[3] = _),
      (e[4] = t),
  ...
  e[8] === x
    ? (w = e[9])
    : ((w = (0, h.jsxs)(s, { color: `ghost`, size: `toolbar`, onClick: x, children: [S, C] })),
      (e[8] = x),
      (e[9] = w));
  let T, E;
  ...
  return (
    e[15] !== w || e[16] !== D
      ? ((O = (0, h.jsx)(d, { backSlot: w, title: T, subtitle: E, children: D })),
        (e[15] = w),
        (e[16] = D),
        (e[17] = O))
      : (O = e[17]),
