...
function E() {
  ...
  e[8] === c
    ? (p = e[9])
    : ((p = (0, k.jsxs)(f, { color: `ghost`, size: `toolbar`, onClick: c, children: [u, d] })),
      (e[8] = c),
      (e[9] = p));
  let g, v;
  ...
  return (
    e[15] !== p || e[16] !== b
      ? ((S = (0, k.jsx)(T, { backSlot: p, title: g, subtitle: v, children: b })),
        (e[15] = p),
        (e[16] = b),
        (e[17] = S))
      : (S = e[17]),
...
e(() => {
  ((O = a()),
    ...
    i(),
    (k = s()),
    (A = u(n, `third-party-notices`, { enabled: !0, staleTime: c.ONE_MINUTE })));
})();
