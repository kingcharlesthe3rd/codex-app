...
import { I as t, a as n, h as r, lt as i, u as a } from "./vscode-api.js";
import { o } from "./lib-2.js";
import { f as s, m as c } from "./chunk-12.js";
...
var m = i(),
  h = e(),
  g = n(r, `third-party-notices`, { enabled: !0, staleTime: a.ONE_MINUTE });
function _() {
  let e = (0, m.c)(18),
    n = c(),
    r = s(),
  ...
  let a = i,
    ...
    { data: y, isLoading: b } = t(g),
    x;
  e[2] !== a || e[3] !== _ || e[4] !== n
    ? ((x = () => {
        n(a, { replace: !0, state: _ });
      }),
      (e[2] = a),
      (e[3] = _),
      (e[4] = n),
  ...
  e[8] === x
    ? (w = e[9])
    : ((w = (0, h.jsxs)(l, { color: `ghost`, size: `toolbar`, onClick: x, children: [S, C] })),
      (e[8] = x),
      (e[9] = w));
  let T, E;
