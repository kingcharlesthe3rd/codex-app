...
function E() {
  ...
  e[8] === d
    ? (g = e[9])
    : ((g = (0, k.jsxs)(u, { color: `ghost`, size: `toolbar`, onClick: d, children: [p, m] })),
      (e[8] = d),
      (e[9] = g));
  let _, v;
  ...
  return (
    e[15] !== g || e[16] !== b
      ? ((S = (0, k.jsx)(y, { backSlot: g, title: _, subtitle: v, children: b })),
        (e[15] = g),
        (e[16] = b),
        (e[17] = S))
      : (S = e[17]),
...
e(() => {
  ((O = n()),
    ...
    c(),
    (k = t()),
    (A = a(_, `third-party-notices`, { enabled: !0, staleTime: s.ONE_MINUTE })));
})();
