...
import { gt as v, vt as y } from "./app-initial~app-main~automations-page.js";
import {
  S as b,
  x,
...
function E() {
  ...
  e[8] === l
    ? (p = e[9])
    : ((p = (0, k.jsxs)(d, { color: `ghost`, size: `toolbar`, onClick: l, children: [u, f] })),
      (e[8] = l),
      (e[9] = p));
  let m, y;
  ...
  return (
    e[15] !== p || e[16] !== b
      ? ((S = (0, k.jsx)(v, { backSlot: p, title: m, subtitle: y, children: b })),
        (e[15] = p),
        (e[16] = b),
        (e[17] = S))
      : (S = e[17]),
...
e(() => {
  ((O = n()),
    ...
    l(),
    (k = u()),
    (A = o(t, `third-party-notices`, { enabled: !0, staleTime: a.ONE_MINUTE })));
})();
