...
import { S as t, U as n, Z as r, _ as i, f as a, wt as o } from "./setting-storage.js";
import { f as s, m as c } from "./chunk-8.js";
...
function _() {
  let e = (0, m.c)(18),
    ...
    i = s(),
    a;
  e[0] === i.state ? (a = e[1]) : ((a = v(i.state)), (e[0] = i.state), (e[1] = a));
  let o = a,
    _ = i.state != null && typeof i.state == `object` && !Array.isArray(i.state) ? i.state : null,
