...
import { N as n, z as r } from "./app-scope.js";
import { Mo as i, Vs as a } from "./app-server-manager-signals.js";
import { A as o, _ as s, n as c, u as l, v as u } from "./vscode-api.js";
import { _ as d } from "./isEqual.js";
import { Xr as f } from "./src-2.js";
import { t as p } from "./request.js";
import { t as m } from "./invalidate-queries-and-broadcast.js";
import { t as h } from "./use-debounced-value-Dw-7BPJJ.js";
import { t as g } from "./use-auth.js";
import { t as _ } from "./fuse.js";
import { t as ee } from "./_baseOrderBy.js";
import { t as v } from "./parse-owner-repo.js";
var y = t((e, t) => {
    var n = ee(),
      r = d();
    function i(e, t, i, a) {
  ...
  n[5] === a
    ...
    : ((c = async () => {
        let e = await p.safeGet(`/wham/environments`),
          ...
          n = new _(e, { threshold: 0.4, keys: [`label`, `repos`] }),
          r = n?.search(a).map(F) ?? [],
          i = (e) => {
            let n = e.toLowerCase();
...
function $() {
  ...
  return (
    e[1] === r
      ? (i = e[2])
      : ((i = { queryKey: n, queryFn: be, staleTime: l.ONE_MINUTE, enabled: r }),
        (e[1] = r),
        (e[2] = i)),
    u(i)
  );
