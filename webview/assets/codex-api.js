...
import { M as n, R as r } from "./app-scope.js";
import { Co as i, Ps as a } from "./app-server-manager-signals.js";
import { _ as o, g as s, k as c, n as l, u } from "./vscode-api.js";
import { d } from "./isEqual.js";
import { Lr as f } from "./src-1.js";
import { t as p } from "./request.js";
import { t as m } from "./invalidate-queries-and-broadcast.js";
import { t as h } from "./use-auth.js";
import { t as g } from "./fuse.js";
import { t as _ } from "./_baseOrderBy-Cz-sT1AW.js";
import { t as ee } from "./parse-owner-repo.js";
...
function C(e) {
  return {
    enabled: e != null,
    queryFn: async () =>
      p.safeGet(`/wham/tasks/{task_id}`, { parameters: { path: { task_id: e ?? `` } } }),
    queryKey: [`task`, e],
...
function w(e) {
  return {
    enabled: e != null,
    queryFn: async () =>
      p.safeGet(`/wham/tasks/{task_id}/turns`, { parameters: { path: { task_id: e ?? `` } } }),
...
function O(e) {
  let t = (0, b.c)(2),
    n;
  return (t[0] === e ? (n = t[1]) : ((n = C(e)), (t[0] = e), (t[1] = n)), o(n));
}
function k(e, t, n) {
  let r = (0, b.c)(11),
    i;
...
function A(e, t, n) {
  ...
  return (
    r[6] !== i || r[7] !== a || r[8] !== s
      ? ((c = { queryKey: i, enabled: a, staleTime: u.FIVE_SECONDS, queryFn: s }),
        (r[6] = i),
        (r[7] = a),
        (r[8] = s),
        (r[9] = c))
...
function j(e) {
  ...
  return (
    t[3] === l
      ? (d = t[4])
      : ((d = { queryKey: c, queryFn: M, enabled: l, placeholderData: n, staleTime: u.ONE_MINUTE }),
        (t[3] = l),
        (t[4] = d)),
    o(d)
  );
...
function N(e, t) {
  let n = (0, b.c)(14),
    ...
    a = v(e, 200),
    s;
  n[0] === a ? (s = n[1]) : ((s = [`workspace`, `environments-search`, a]), (n[0] = a), (n[1] = s));
  let c;
  n[2] !== a || n[3] !== i
    ? ((c = i && a.trim().length > 0), (n[2] = a), (n[3] = i), (n[4] = c))
    : (c = n[4]);
  let l;
  n[5] === a
    ? (l = n[6])
    : ((l = async () => {
        let e = await p.safeGet(`/wham/environments`),
          ...
          n = new g(e, { threshold: 0.4, keys: [`label`, `repos`] }),
          r = n?.search(a).map(F) ?? [],
          i = (e) => {
            let n = e.toLowerCase();
  ...
  let f;
  return (
    n[9] !== s || n[10] !== c || n[11] !== l || n[12] !== d
      ? ((f = { queryKey: s, enabled: c, queryFn: l, staleTime: u.FIVE_MINUTES, select: d }),
        (n[9] = s),
        (n[10] = c),
        (n[11] = l),
        (n[12] = d),
...
function I(e) {
  ...
  t[1] === a
    ? (s = t[2])
    : ((s = { queryKey: i, queryFn: z, staleTime: u.ONE_MINUTE, enabled: a }),
      (t[1] = a),
      (t[2] = s));
  let { data: c } = o(s),
    l,
    d;
  if (t[3] !== c) {
    let e = (0, x.default)(c, [`owner`, `repoName`]).flatMap(R);
    ((d = o),
      (l = [`workspace`, `environments-by-repo`, ...e]),
      (t[3] = c),
      (t[4] = l),
      (t[5] = d));
  } else ((l = t[4]), (d = t[5]));
  ...
  t[6] === c
    ? (p = t[7])
    : ((p = async () => {
        let e = (await Promise.all((c ?? []).map(L))).flat();
  ...
  return (
    t[8] !== l || t[9] !== f || t[10] !== p
      ? ((m = { queryKey: l, enabled: f, staleTime: u.ONE_MINUTE, queryFn: p }),
        (t[8] = l),
        (t[9] = f),
        (t[10] = p),
        (t[11] = m))
...
function L(e) {
  ...
  return p.safeGet(`/wham/environments/by-repo/{provider}/{repo_owner}/{repo_name}`, {
...
async function V(e) {
  ...
  if (
    ...
    for (let n of e.commentAttachments) t.push(f(n));
  let n = {
    branch: e.ref,
...
async function ne(e) {
  ...
  if (
    ...
    for (let n of e.images) t.push(n);
  if (e.commentAttachments?.length) for (let n of e.commentAttachments) t.push(f(n));
  ...
  return (
    t[0] === n
      ...
      : ((r = {
          ...
          queryFn: () =>
            p.safeGet(`/wham/referrals/eligibility_rules`, {
...
function re(e) {
  ...
  return (
    t[3] === i
      ? (s = t[4])
      : ((s = { enabled: i, queryKey: a, queryFn: ie, staleTime: u.FIVE_SECONDS }),
        (t[3] = i),
        (t[4] = s)),
    o(s)
  );
...
function ie() {
  return p.safeGet(`/referrals/invite/eligibility`, { parameters: { query: { referral_key: S } } });
}
function ae() {
  let e = (0, b.c)(1),
    t;
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = { queryKey: [`rate-limit-reset-credits`], queryFn: oe, staleTime: u.FIVE_SECONDS }),
        (e[0] = t))
      : (t = e[0]),
    o(t)
  );
...
async function de(e) {
  await p.safePost(`/wham/tasks/{task_id}/cancel`, { parameters: { path: { task_id: e } } });
}
function fe() {
  let e = (0, b.c)(2),
    t = c(),
...
async function me(e, t, n = 20, r = null) {
...
function ge(e) {
  return e.pages.flatMap(_e);
}
function _e(e) {
  return e.items?.map(ve) ?? [];
}
function ve(e) {
  return e.branch;
}
function ye(e) {
  ...
  t[0] === e
    ? (r = t[1])
    : ((r = () =>
        p.safePost(`/wham/tasks/{task_id}/mark_read`, { parameters: { path: { task_id: e } } })),
      (t[0] = e),
      (t[1] = r));
  let i;
  t[2] !== n || t[3] !== e
...
function $() {
  ...
  return (
    e[1] === r
      ? (i = e[2])
      : ((i = { queryKey: n, queryFn: be, staleTime: u.ONE_MINUTE, enabled: r }),
        (e[1] = r),
        (e[2] = i)),
    o(i)
  );
...
function xe(e) {
  ...
  let { enabled: r } = n,
    i = r === void 0 ? !0 : r,
    { accountId: a, authMethod: s } = h(),
    c;
  t[2] !== a || t[3] !== s
    ? ((c = [`onboarding`, `context`, s, a]), (t[2] = a), (t[3] = s), (t[4] = c))
    : (c = t[4]);
  let l = i && s === `chatgpt`,
    d;
  return (
    t[5] !== c || t[6] !== l
      ? ((d = { queryKey: c, queryFn: Se, staleTime: u.TEN_MINUTES, enabled: l }),
        (t[5] = c),
        (t[6] = l),
        (t[7] = d))
      : (d = t[7]),
