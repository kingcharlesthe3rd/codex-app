...
import { n as i, t as a } from "./fuse.js";
import { _ as o, g as s, k as c, n as l, u } from "./vscode-api.js";
import { d } from "./isEqual.js";
import { Wr as f } from "./src-4.js";
import { do as p } from "./app-server-manager-signals.js";
...
function N(e, t) {
  let n = (0, b.c)(14),
    ...
    s = v(e, 200),
    c;
  n[0] === s ? (c = n[1]) : ((c = [`workspace`, `environments-search`, s]), (n[0] = s), (n[1] = c));
  let l;
  n[2] !== s || n[3] !== i
    ? ((l = i && s.trim().length > 0), (n[2] = s), (n[3] = i), (n[4] = l))
    : (l = n[4]);
  let d;
  n[5] === s
    ? (d = n[6])
    : ((d = async () => {
        let e = await m.safeGet(`/wham/environments`),
          ...
          n = new a(e, { threshold: 0.4, keys: [`label`, `repos`] }),
          r = n?.search(s).map(F) ?? [],
          i = (e) => {
            let n = e.toLowerCase();
  ...
  n[7] === s
    ...
    : ((f = (e) => {
        let [t, n] = e;
        if (!s?.trim()) return n;
        let r = s.trim().toLocaleLowerCase();
  ...
  let p;
  return (
    n[9] !== c || n[10] !== l || n[11] !== d || n[12] !== f
      ? ((p = { queryKey: c, enabled: l, queryFn: d, staleTime: u.FIVE_MINUTES, select: f }),
        (n[9] = c),
        (n[10] = l),
        (n[11] = d),
        (n[12] = f),
  ...
  return (
    t[0] === n
      ...
      : ((r = {
          ...
          queryFn: () =>
            m.safeGet(`/wham/referrals/eligibility_rules`, {
...
function Q(e, t, n) {
  let r = (0, b.c)(12),
    a;
  r[0] === n ? (a = r[1]) : ((a = n === void 0 ? {} : n), (r[0] = n), (r[1] = a));
  let { enabled: o } = a,
    s = o === void 0 ? !0 : o,
    c;
  r[2] !== t || r[3] !== e
