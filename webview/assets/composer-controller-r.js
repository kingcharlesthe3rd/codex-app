...
import { Qr as n, p as r } from "./src-2.js";
import {
  $r as i,
  Ya as a,
  ei as o,
...
import { F as h, lt as g } from "./vscode-api.js";
import { c as _, o as v } from "./lib-2.js";
import { f as y } from "./chunk-12.js";
import { n as b, t as x } from "./known-app-icon.js";
import { p as S } from "./codex-api.js";
import { c as C, x as ee } from "./apps-queries.js";
import { t as w } from "./connector-logo.js";
import { a as T, c as E, i as D, n as O, o as k, s as A, t as j } from "./prompt-text.js";
import {
  c as M,
  d as N,
  i as P,
...
import { t as R } from "./send-open-file-request-Dau-We3b.js";
import { t as z } from "./apps.js";
import { y as ae } from "./use-plugins.js";
import { d as oe, l as se, m as ce, o as le, s as B } from "./use-native-apps.electron.js";
import { t as ue } from "./mcp.js";
import { t as V } from "./get-skill-icon.js";
import { n as de } from "./use-skills.js";
import { a as fe, i as pe, n as me, r as he, s as ge, t as _e } from "./inline-mention-style.js";
import { t as ve } from "./globe.js";
import { t as ye } from "./sortBy.js";
import { r as be } from "./composer-top-menu-chrome.js";
import { t as xe } from "./connected-apps.js";
import { a as H, i as Se, n as Ce } from "./use-composer-controller.js";
import {
  a as we,
  c as Te,
  d as Ee,
...
import { t as He } from "./score-query-match.js";
import { r as Ue } from "./format-skill-scope.js";
...
function Qe(e) {
  ...
  let { types: t } = e;
  for (let e = 0; e < t.length; e += 1) if (t[e] === Ze) return !0;
  return !1;
}
function $e(e) {
  return nt(e)
...
function et(e) {
  let t = [],
    n = [];
  for (let { file: i, isDirectory: a } of nt(e)) {
    if (a) {
      n.push(i);
      continue;
    }
...
function at() {
  let e = h(E);
  return ot(e.value.kind === `local` ? e.value.conversationId : null);
}
function ot(e) {
  return ct(e, Je);
}
...
function ct(e, t) {
  let n = (0, rt.c)(6),
    r;
  n[0] !== e || n[1] !== t
    ? ((r = (n) => lt(e, t, n)), (n[0] = e), (n[1] = t), (n[2] = r))
    : (r = n[2]);
  let i = r,
    a;
  return (
    n[3] !== e || n[4] !== t ? ((a = () => t(e)), (n[3] = e), (n[4] = t), (n[5] = a)) : (a = n[5]),
    (0, it.useSyncExternalStore)(i, a)
  );
}
function lt(e, t, n) {
...
function ut(e) {
  let t = (0, rt.c)(10),
    ...
    l = ot(null),
    u;
  t[0] === c.pathname ? (u = t[1]) : ((u = Le(c.pathname)), (t[0] = c.pathname), (t[1] = u));
  let d = u,
...
for (
  var dt = {
    ...
    pt = typeof navigator < `u` && /Mac/.test(navigator.platform),
    mt =
      typeof navigator < `u` &&
  ...
  dt[48 + ht] = dt[96 + ht] = String(ht);
for (var ht = 1; ht <= 24; ht++) dt[ht + 111] = `F` + ht;
for (var ht = 65; ht <= 90; ht++)
  ((dt[ht] = String.fromCharCode(ht + 32)), (ft[ht] = String.fromCharCode(ht)));
for (var gt in dt) ft.hasOwnProperty(gt) || (ft[gt] = dt[gt]);
function _t(e) {
  var t =
    (!(
      (pt && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey) ||
      (mt && e.shiftKey && e.key && e.key.length == 1) ||
      e.key == `Unidentified`
    ) &&
      e.key) ||
    (e.shiftKey ? ft : dt)[e.keyCode] ||
    e.key ||
    `Unidentified`;
  return (
    t == `Esc` && (t = `Escape`),
...
var vt = typeof navigator < `u` && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
  yt = typeof navigator < `u` && /Win/.test(navigator.platform);
function bt(e) {
  let t = e.split(/-(?!$)/),
    n = t[t.length - 1];
  n == `Space` && (n = ` `);
  ...
  for (let e = 0; e < t.length - 1; e++) {
    ...
    else if (/^mod$/i.test(n)) vt ? (o = !0) : (i = !0);
...
function Ct(e) {
  return new Oe({ props: { handleKeyDown: wt(e) } });
}
function wt(e) {
  let t = xt(e);
  return function (e, n) {
...
function Et(e) {
  return { ...Tt, suppressedAnchorPos: e.anchorPos, suppressedQuery: e.query };
}
function Dt(e, t) {
...
function Ot(e, t, n) {
  let { state: r } = e,
    i = t.getState(r);
  return i?.active !== !0 || !Dt(i, n) ? !1 : (e.dispatch(r.tr.setMeta(t, Et(i))), !0);
}
var kt = 50;
function At(e, t) {
  let { $from: n } = e.selection,
    r = n.parent,
    i = n.parentOffset,
    a = r.textBetween(Math.max(0, i - kt), i, void 0, `￼`),
    o = t.exec(a);
  if (!o) return null;
  let s = i - o[2].length,
    c = n.start() + s;
...
function jt(e) {
  ...
  return [
    ...
    Ct({
      Escape: (e, n) =>
        t.getState(e)?.active && n !== void 0 ? (n(e.tr.setMeta(t, Tt)), a(), !0) : !1,
    }),
    Ct({
      Tab: (e, n) =>
        t.getState(e)?.active && n !== void 0
          ? (n(e.tr.setMeta(t, Tt)), i(`complete-query`), !0)
          : !1,
      Enter: (e, n) =>
        t.getState(e)?.active && n !== void 0
          ? (n(e.tr.setMeta(t, Tt)), i(`insert-mention`), !0)
          : !1,
    }),
  ];
}
...
var Nt = new we(`mention-ui`);
function Pt(e = {}) {
  return jt({ key: Nt, trigger: `@`, wordPattern: /(^|\s)(@[^@]*)$/, ...e });
}
var Ft = t((e) => {
    var t = d(),
      n = m();
...
`),
        ...
        case `title`:
          var Y = c.tagScope & 1,
            tt = c.tagScope & 4;
          if (c.insertionMode === 4 || Y || n.itemProp != null) var nt = De(e, n);
          else tt ? (nt = null) : (De(a.hoistableChunks, n), (nt = void 0));
          return nt;
        case `link`:
          var rt = c.tagScope & 1,
            it = c.tagScope & 4,
          ...
          if (
            ...
            if (typeof st != `string` || n.disabled != null || n.onLoad || n.onError) ct = Te(e, n);
              ...
              var dt = a.styles.get(st),
                ft = i.styleResources.hasOwnProperty(ot) ? i.styleResources[ot] : void 0;
              if (ft !== null) {
        ...
        case `style`:
          ...
          if (
            ...
            (typeof Pt != `function` &&
              typeof Pt != `symbol` &&
              Pt != null &&
              e.push((`` + Pt).replace(Ee, U)),
              Se(e, jt, At),
              e.push(Ne(`style`)));
            var Ft = null;
          } else {
            var It = a.styles.get(Dt);
            if ((i.styleResources.hasOwnProperty(Ot) ? i.styleResources[Ot] : void 0) !== null) {
              ((i.styleResources[Ot] = null),
                It ||
...
` +
      ...
      if (typeof i == `function`)
        if (i.prototype && i.prototype.isReactComponent) {
          ...
          if (
            ...
            (m._reactInternals = C),
            (d = i.contextType),
            (m.context = typeof d == `object` && d ? d._currentValue2 : wt),
            ...
            if (
              ...
              i !== m.state && Mt.enqueueReplaceState(m, m.state, null),
    ...
    function $n(e, t) {
      ...
      if (n !== null) {
                  ...
                  for (o = h.nodes, n = 0; n < o.length; n++) {
                    ...
                    if (m === g[1]) {
                      if (g.length === 4) {
                        ...
                        if (s !== p) throw Error(r(490, `Suspense`, Ct(s) || `Unknown`));
                        b: {
                          ((h = void 0),
                            (s = g[5]),
                            (d = g[2]),
        ...
        typeof n == `string`
          ? ((o = t.blockedSegment),
            o !== null && (o.lastPushedText = yt(o.chunks, n, e.renderState, o.lastPushedText)))
          : (typeof n == `number` || typeof n == `bigint`) &&
            ((o = t.blockedSegment),
            o !== null &&
              (o.lastPushedText = yt(o.chunks, `` + n, e.renderState, o.lastPushedText)));
      }
    }
    function er(e, t, n, i) {
      var a = t.keyPath;
      ...
      for (c = 0; c < s; c++) ((i = n[c]), (t.treeContext = Pt(o, s, c)), or(e, t, i, c));
      ((t.treeContext = o), (t.keyPath = a));
    }
    function tr(e, t, n) {
      if (
    ...
    function hr(e) {
      if (e.status !== 14 && e.status !== 13) {
        ...
        try {
          ...
          ((xn = o), (re.H = n), (re.A = i), n === bn && jt(t), (Nn = a));
        }
      }
    }
    function gr(e, t, n) {
    ...
    function xr(e, t, n, i) {
      ...
      if (
        ...
        throw Error(r(391));
      return (
        xr(e, t, n[0], i), (e = e.renderState.generateStaticMarkup ? !0 : t.push(`<!--/$-->`)), e
      );
    }
    function Sr(e, t, n, r) {
      return (
...
$RC=function(a,b){if(b=document.getElementById(b))(a=document.getElementById(a))?(a.previousSibling.data="$~",$RB.push(a,b),2===$RB.length&&("number"!==typeof $RT?requestAnimationFrame($RV.bind(null,$RB)):(a=performance.now(),setTimeout($RV.bind(null,$RB),2300>a&&2E3<a?2300-a:$RT+300-a)))):b.parentNode.removeChild(b)};`)),
  ...
  It = t((e) => {
    ...
    function je(e, t, n, r, i, a) {
      ...
      if (
        (d !== void 0 && (u.push(o), tr(u, e), u.push(tt, I((`` + d).replace(De, Oe)), H)),
        (d = []),
        r !== void 0 &&
...
` &&
        ...
        case `button`:
          ...
          var be = et(e, i, a, fe, pe, he, ge, de);
        ...
        case `form`:
          ...
          if (typeof Ce == `function`) {
            var ke = $e(i, Ce);
            ke === null
              ? (e.push(We, I(`action`), Ge, Ye, J), (Ee = Te = we = Ce = null), st(i, a))
              : ((Ce = ke.action || ``),
                (we = ke.encType),
                (Te = ke.method),
                (Ee = ke.target),
          ...
          if (
            ...
            e.push(tt),
            Oe !== null && (e.push(Xe), Je(e, `name`, Oe), e.push(nt), De?.forEach(Ze, e)),
            rt(e, Se, H),
            typeof H == `string`)
          ) {
            e.push(I(V(H)));
        ...
        case `object`:
          ...
          if ((e.push(tt), rt(e, K, G), typeof G == `string`)) {
            e.push(I(V(G)));
            var Fe = null;
          } else Fe = G;
          return Fe;
        case `title`:
          var Ie = c.tagScope & 1,
            Re = c.tagScope & 4;
          if (c.insertionMode === 4 || Ie || n.itemProp != null) var ze = mt(e, n);
          ...
          if (
            ...
            if (typeof Qe != `string` || n.disabled != null || n.onLoad || n.onError) ot = ut(e, n);
              ...
              var ct = a.styles.get(Qe),
                lt = i.styleResources.hasOwnProperty(Ke) ? i.styleResources[Ke] : void 0;
              if (lt !== null) {
        ...
        case `meta`:
          var $t = c.tagScope & 1,
            en = c.tagScope & 4;
          if (c.insertionMode === 4 || $t || n.itemProp != null) var tn = pt(e, n, `meta`);
          else
            (l && e.push(Le),
              (tn = en
                ? null
...
` +
    ...
    function ka(e, t, n) {
      ...
      switch (i.status) {
        case 1:
          if ((kt(e.renderState, a), (e.byteSize += i.byteSize), (t = i.completedSegments[0]), !t))
            throw Error(r(391));
          return Oa(e, t, n);
        case 5:
          if (e.trackedPostpones !== null) return !0;
...
function Rt({
  ...
  let l =
      r == null
        ? null
        : (0, it.isValidElement)(r)
          ? (0, it.cloneElement)(r, { className: p(pe, r.props.className) })
          : (0, it.createElement)(r, { className: pe }),
    u = (0, Lt.renderToStaticMarkup)(
      (0, it.createElement)(
        `span`,
        {
        ...
        l == null ? null : (0, it.createElement)(`span`, { className: fe }, l),
        (0, it.createElement)(`span`, { className: p(`min-w-0 break-words`, s) }, o),
      ),
    ),
...
var Bt = zt(`skill-mention`),
  Vt = zt(`app-mention`),
  Ht = zt(`plugin-mention`);
function Ut(e = {}) {
  return jt({ key: X, trigger: `$`, wordPattern: /(^|\s)(\$[^$]*)$/, ...e });
}
var Wt = new we(`slash-command-ui`),
  Gt = /(^|\s)(\/(?:(?<=^\/)[^/]*|[^\s/]*))$/;
function Kt(e = {}) {
  return jt({ key: Wt, trigger: `/`, wordPattern: Gt, ...e });
}
var qt = new we(`customKeymapPlugin`),
  Jt = 0;
function Yt(e) {
  let t = {};
...
function Z(e, t) {
  let n = `custom-keymap-subscription-${Jt}`;
  ((Jt += 1),
    e.dispatch(e.state.tr.setMeta(qt, { handlers: t, subscriptionId: n, type: `addHandlers` })));
  let r = !0;
  return () => {
    r &&
      ((r = !1),
      qt.getState(e.state)?.handlerSubscriptions[n] &&
        e.dispatch(e.state.tr.setMeta(qt, { subscriptionId: n, type: `removeHandlers` })));
  };
}
function Xt(e = {}) {
  return new Oe({
    ...
    state: {
      ...
      apply(e, t) {
        ...
        if (n?.type === `addHandlers`) {
          ...
          return { handlerSubscriptions: e, handlers: Yt(e) };
        }
        if (n?.type === `removeHandlers`) {
          ...
          return { handlerSubscriptions: r, handlers: Yt(r) };
        }
        return t;
      },
    },
    props: {
      handleKeyDown(e, t) {
        let n = qt.getState(e.state).handlers[t.key];
        return n ? n(t) : !1;
      },
    },
  });
...
function en(e) {
  ...
  let y = C(g),
    ...
    { skills: ee, isLoading: T } = de(c ?? s, l),
    E = ae(),
    D;
  t[2] !== s || t[3] !== c
  ...
  let j = an(
      [
        ...(0, $t.default)(ee.filter((e) => e.enabled && ze(e, E)).map(A), nn),
        ...(x == null
          ? []
          : x.map((e) => {
              let t = N(e);
  ...
  Ie({ isLoading: P, onRequestClose: o, query: r, resultCount: j.length });
  let {
      highlightedIndex: te,
      listRef: I,
      getItemProps: L,
  ...
  t[11] !== R || t[12] !== F || t[13] !== I || t[14] !== z
    ? ((oe = (0, Q.jsx)(R, { fadeMaskVariant: F, listRef: I, children: z })),
      (t[11] = R),
      (t[12] = F),
      (t[13] = I),
      (t[14] = z),
  ...
  let se;
  return (
    t[16] !== re || t[17] !== f || t[18] !== ie || t[19] !== oe
      ? ((se = (0, Q.jsx)(re, { chromeVariant: f, className: ie, children: oe })),
        (t[16] = re),
        (t[17] = f),
        (t[18] = ie),
        (t[19] = oe),
...
function dn(e) {
  ...
  t[0] !== _ || t[1] !== m || t[2] !== g
    ? ((y = { placement: m, zIndexClassName: g, variant: _ }),
      ...
      (t[3] = y))
    : (y = t[3]);
  let { overlayPortalContainer: b, shellClassName: x, usesExpandedTopTray: S } = ut(y),
    C;
  ...
  t[9] !== s || t[10] !== n.ui || t[11] !== o || t[12] !== m || t[13] !== h
    ? ((w = () => {
      ...
      (t[14] = w))
    : (w = t[14]);
  let T = (0, it.useSyncExternalStore)(ee, w),
    E;
  bb0: {
    if (T == null) {
      E = null;
...
function vn(e) {
  return Nt.getState(e.view.state);
}
function yn(e) {
  let t = (0, rt.c)(14),
    n = Ce(e, bn),
...
function bn(e) {
  return X.getState(e.view.state);
}
var xn = 65535,
  Sn = 2 ** 16;
function Cn(e, t) {
...
`,
  ...
  syncMentionMetadata({
    ...
    let a = new Map(),
      ...
      d = new Map();
    (e.forEach((e) => {
      (a.set(c(e.path), e), o.set(e.name.toLowerCase(), e));
    }),
      t.forEach((e) => {
        let t = I(e.id);
        (s.set(t, e), l.set(e.id.toLowerCase(), e), l.set(e.name.toLowerCase(), e));
      }),
      n.forEach((e) => {
    ...
    (p.doc.descendants((e, t) => {
      ...
      if (m === `app`) {
        ...
        let t = n.length > 0 ? a.get(c(n)) : void 0;
  ...
  insertAtMention(e, t) {
    let n = t ?? Nt.getState(this.view.state);
    ...
    ((l = l.setSelection(q.create(l.doc, u))),
      (l = l.setMeta(Nt, { active: !1, anchorPos: null, query: `` })),
      i(l),
      this.view.focus());
  }
  insertAgentMention(e, t) {
    ...
    ((c = c.setSelection(q.create(c.doc, u))),
      (c = c.setMeta(Nt, { active: !1, anchorPos: null, query: `` })),
      i(c),
      this.view.focus());
  }
  ...
  insertMention(e, t) {
    ...
    !n || n.anchorPos == null || this.replaceQueryWithMention(e, n, X);
  }
  ...
  insertMentionFromAtMention(e, t) {
    let n = t ?? Nt.getState(this.view.state);
    !n || n.anchorPos == null || this.replaceQueryWithMention(e, n, Nt);
  }
  setAtMentionSource(e, t) {
    if (t.anchorPos == null) return;
    let { state: n, dispatch: r } = this.view,
      i = n.tr.insertText(``, t.anchorPos, t.anchorPos + t.query.length);
    ((i = i.setMeta(Nt, { active: !0, anchorPos: t.anchorPos, query: ``, source: e })),
      r(i),
      this.view.focus());
  }
  ...
  clearSlashCommand(e) {
    let t = e ?? Wt.getState(this.view.state);
    ...
    ((o = o.setSelection(q.create(o.doc, i))),
      (o = o.setMeta(Wt, { active: !1, anchorPos: null, query: `` })),
      r(o),
      this.view.focus());
  }
...
//# sourceMappingURL=composer-controller-r.js.map
