import { n as e, r as t, t as n } from "./runtime.worker-CnG-97Cx.js";
const r = `CSV import`,
  i = /\\|\/|\?|\*|\[|\]|:/g;
function a(e) {
...
function o(r, i) {
  ...
  let f = a(u ?? d),
    p = e(l.ref);
  if (!p)
    throw Error(`CSV import anchor must be an A1 cell reference; received "${i?.anchor ?? `A1`}".`);
  let { bounds: m } = p;
...
function s(e) {
  let t = e ?? `,`;
  if (t.length !== 1)
    throw Error(`CSV import separator must be a single character; received "${t}".`);
  return t;
}
function c(e, t) {
  if (!e.trim()) return [];
...
//# sourceMappingURL=workbook-from-csv-2.js.map
