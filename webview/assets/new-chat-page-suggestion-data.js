...
import { Z as n, a as r, g as i, o as a, p as o, s, t as c } from "./app-scope-CWE-zIhQ.js";
import { Ut as l, en as u } from "./thread-context-inputs.js";
import { n as d, r as f } from "./react.js";
import { r as p } from "./lib-1.js";
import { t as m } from "./persisted-atom.js";
import { o as h } from "./statsig.js";
import { t as g } from "./request.js";
import { f as _, u as v } from "./chunk-13.js";
import { m as y } from "./parse-directives.js";
import { t as b } from "./use-auth.js";
import { n as x } from "./model-queries.js";
import { n as S, r as C } from "./use-model-settings.js";
import { n as w } from "./use-service-tier-settings.js";
import { c as T, o as ee, s as te } from "./announcement-atoms.js";
import { b as ne } from "./mention-item.js";
var E = n(),
  D = e(t(), 1),
  O = [`/`, `/local/:conversationId`],
  k = new Set([`gpt-5.4`, `gpt-5.5`]),
  A = () => {},
  j = m(`seen-model-upgrade-list`, []),
  re = m(`latest-model-seen`, null),
  M = (e, t, n, r) => ({
...
function N() {
  ...
  return (
    e[0] === t
      ? (n = e[1])
      : ((n = O.some((e) => v({ path: e, end: !0 }, t.pathname) != null)), (e[0] = t), (e[1] = n)),
    n
  );
}
var ie = () => {
    let e = (0, E.c)(9),
      t = N(),
      { data: n, isLoading: r } = x(),
      [i, a] = d(j),
      o;
    e[0] !== i || e[1] !== n?.models
      ? ((o =
          n?.models.find(
            (e) => e.availabilityNux != null && !k.has(e.model) && !i.includes(e.model),
          ) ?? null),
        (e[0] = i),
        (e[1] = n?.models),
        (e[2] = o))
  ...
  ae = () => {
    ...
    if (e[0] !== i || e[1] !== o || e[2] !== r?.models || e[3] !== n.model) {
      ((p = o == null ? i : P(i, o)), (g = p !== i), (h = o != null));
      ...
      ((l = t?.upgrade),
        ...
        (f = _ != null && k.has(_.model)),
        (u = !1),
        (m = null),
        l && ((m = l), (u = p.includes(m))),
        (e[0] = i),
        (e[1] = o),
        (e[2] = r?.models),
        (e[3] = n.model),
    ...
    e[20] !== p || e[21] !== m || e[22] !== a || e[23] !== s
      ...
      : (b = e[24]);
    let w = b;
    return M(!!l && !n.isLoading && _ != null && !f && t, u, c, w);
  },
  oe = () => {
    let e = (0, E.c)(9),
      t = N(),
      { isServiceTierAllowed: n } = w(),
      { modelSettings: r } = S(),
      { data: i } = x(),
      a = f(j),
      o,
    ...
    let c = s,
      d;
    e[4] !== a || e[5] !== i?.models
      ? ((d = i?.models.find((e) => u(e, `priority`) && a.includes(e.model)) ?? null),
        (e[4] = a),
        (e[5] = i?.models),
        (e[6] = d))
      : (d = e[6]);
    ...
    return (
      e[7] === m
        ? (h = e[8])
        : ((h = m == null ? null : { model: m.model }), (e[7] = m), (e[8] = h)),
      M(n && !r.isLoading && t && m != null, !1, h, A)
    );
  };
function P(e, t) {
...
var F = 10 * 1e3,
  I = new Set(),
  L = i(c, () => new Map()),
  R = o(c, ({ accountId: e, shouldFetch: t }) => ({
...
function z(e, t, n) {
  ...
  let r =
    e.messages.find((e) => e.message_type === `announcement` && !t.has(e.message_id) && V(e, n)) ??
    null;
...
function W() {
  let e = (0, E.c)(10),
    t = a(c),
    { accountId: n, data: r, isLoading: i, shouldFetch: o } = K(),
    l = H(s(L), n),
    [u, f] = d(ee),
    p = T(u, n),
    m = o ? z(r, l, p) : null,
    h;
  e[0] !== n || e[1] !== m || e[2] !== t || e[3] !== f || e[4] !== u
    ? ((h = () => {
        m == null || n == null || (ce(t, n, m), f(te(u, n, m.message.created_at)));
      }),
      (e[0] = n),
      (e[1] = m),
      (e[2] = t),
  ...
  return (
    e[6] !== m || e[7] !== i || e[8] !== h
      ? ((g = { announcement: m, dismissAnnouncement: h, isLoading: i }),
        (e[6] = m),
        (e[7] = i),
        (e[8] = h),
        (e[9] = g))
...
function G() {
  let e = (0, E.c)(5),
    { data: t, shouldFetch: n } = K(),
    r;
  e[0] !== t || e[1] !== n
    ? ((r = n ? B(t) : null), (e[0] = t), (e[1] = n), (e[2] = r))
    : (r = e[2]);
  let i;
...
function K() {
  let e = (0, E.c)(8),
    { accountId: t, authMethod: n, isLoading: i } = b(),
    a = N(),
    o = h(`4285716042`) && a && !i && n === `chatgpt` && t != null,
    s;
  e[0] !== t || e[1] !== o
    ? ((s = { accountId: t, shouldFetch: o }), (e[0] = t), (e[1] = o), (e[2] = s))
    : (s = e[2]);
  let c = r(R, s),
    l = o && c.isLoading,
    u;
...
async function se() {
  return g.safeGet(`/wham/workspace-messages`, {
    additionalHeaders: { "Cache-Control": `no-store` },
  });
}
function ce(e, t, n) {
  e.set(L, (e) => U(e, t, [n.message.message_id]));
}
var q = `presentations@openai-primary-runtime`,
  J = `documents@openai-primary-runtime`,
  Y = `spreadsheets@openai-primary-runtime`,
  X = `sites@openai-bundled`,
  le = {
    google: {
  ...
  de = [
      ...
      suggestions: [
        {
          ...
          artifact: { label: `Document`, pluginId: J },
        ...
        },
        {
          ...
          artifact: { label: `Spreadsheet`, pluginId: Y },
        ...
        },
        {
          ...
          artifact: { label: `Presentation`, pluginId: q },
        ...
        {
          appIds: [`sites`],
          artifact: { label: `Site`, pluginId: X },
    ...
    },
    {
      ...
      title: p({
        ...
        defaultMessage: `Automate ongoing work`,
        description: `Top-level new chat suggestion for automation tasks`,
      }),
      suggestions: [
        {
          ...
          prompt: p({
            ...
            defaultMessage: `Automate a recurring report I choose from files in {fileApp}, messages in {chatApp}, emails in {mailApp}, or Salesforce data. If I have not named one, ask which report and schedule.`,
          ...
          title: p({
            ...
            description: `New chat follow-up suggestion for automating a recurring report`,
          }),
        },
        {
          appIds: [`google-calendar`, `gmail`, `slack`, `google-drive`],
          ...
          prompt: p({
            ...
            defaultMessage: `Automate my morning prep with {calendarApp}, emails in {mailApp}, messages in {chatApp}, or files in {fileApp}.`,
        ...
        },
        {
          ...
          prompt: p({
            ...
            defaultMessage: `Automate triage of incoming emails in {mailApp}, incoming messages in {chatApp}, new requests in Notion, or new Salesforce records. Ask which queue and rules to use.`,
          ...
          title: p({
            ...
            description: `New chat follow-up suggestion for automating triage`,
          }),
        },
        {
...
function Q(e) {
  return e.formatMessage(Z);
}
function fe({ intl: e, mailProvider: t = `other`, plugins: n }) {
  return de.map((r) => ({
    id: r.id,
    starterPrompt: e.formatMessage(r.starterPrompt),
    suggestions: r.suggestions.map((r) =>
      pe({ intl: e, mailProvider: t, plugins: n, suggestion: r }),
    ),
    title: e.formatMessage(r.title),
  }));
}
function pe({ intl: e, mailProvider: t, plugins: n, suggestion: r }) {
  ...
  return {
    ...
    title: i,
    description: i,
    prompt: e.formatMessage(r.prompt, r.artifact == null ? a : { ...a, artifact: he(r.artifact) }),
    appIds: r.appIds.map((e) => $(e, t)),
    status: `pending`,
    createdAtMs: 0,
    updatedAtMs: 0,
    analyticsType: `new_chat_page_suggestion`,
    homeAction: me({ artifact: r.artifact, pluginKey: $(r.pluginKey, t), plugins: n }),
    showTooltip: !1,
    source: `default`,
  };
}
...
function me({ artifact: e, pluginKey: t, plugins: n }) {
...
function he({ label: e, pluginId: t }) {
  return y(`@${e}`, ne(t));
}
export { oe as a, ie as c, G as i, fe as n, N as o, W as r, ae as s, Q as t };
//# sourceMappingURL=new-chat-page-suggestion-data.js.map
