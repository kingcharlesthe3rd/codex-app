      ...
      (E = (function () {
        ...
        return (
          ...
          (e.prototype.alias = function (e, t, n, r) {
            ...
            var a = { userId: e, type: `alias`, options: i({}, n), integrations: i({}, r) };
            return (
          ...
          (e.prototype.normalize = function (e) {
            ...
            var r = i(i({}, t), e.options?.integrations),
              ...
              c = e.options,
              l = n(e, [`options`]),
              u = i(i(i(i({ timestamp: new Date() }, l), { context: o, integrations: r }), s), {
          ...
          (e.prototype.flush = function () {
            if (this.logs.length > 1) {
              var e = this._logs.reduce(function (e, t) {
                var n,
                  r = i(i({}, t), { json: JSON.stringify(t.extras, null, ` `), extras: t.extras });
                delete r.time;
                var a = t.time?.toISOString() ?? ``;
                return (
                  e[a] && (a = `${a}-${Math.random()}`), i(i({}, e), ((n = {}), (n[a] = r), n))
                );
              }, {});
              ...
              return s(this, function (i) {
                switch (i.label) {
                  ...
                  case 3:
                    return (
                      (t = i.sent()),
                      e.log(`warn`, `Failed to unload destination`, { plugin: n.name, error: t }),
                      [3, 4]
                    );
                  case 4:
                    return [2];
