...
import { a as C, c as ge, i as _e, o as ve, r as ye, s as be } from "./isEmpty-2.js";
function w(e, t) {
...
var Ee = e(() => {
  (m(), Ce(), Te(), (E.prototype.add = E.prototype.push = xe), (E.prototype.has = we));
});
function De(e, t) {
...
function ht(e, t, n, r, o, s) {
  ...
  if (h && !p)
    return ((s ||= new a()), c || ne(e) ? je(e, t, n, r, o, s) : Re(e, t, d, n, r, o, s));
  if (!(n & gt)) {
...
function $t(e, t, n) {
  ...
  return a || ++r != i
    ? a
    : ((i = e == null ? 0 : e.length), !!i && h(i) && me(o, i) && (l(e) || d(e)));
}
var en = e(() => {
  (K(), r(), b(), n(), he(), J());
});
...
function $(e, t, n, r, i) {
  ...
  for (n ||= Mn, i ||= []; ++a < o;) {
    var s = e[a];
    t > 0 && n(s) ? (t > 1 ? $(s, t - 1, n, r, i) : k(i, s)) : r || (i[i.length] = s);
  }
  return i;
}
var Fn = e(() => {
