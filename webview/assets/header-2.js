...
import { Bn as nt, Vn as rt } from "./app-initial~app-main~automations-page.js";
import {
  g as it,
  p as at,
...
function bt(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, J.jsx)(f, { ...jt.moreActionsTrigger })), (t[5] = m))
    : (m = t[5]);
  let h;
  t[6] === r ? (h = t[7]) : ((h = r.formatMessage(jt.moreActionsTrigger)), (t[6] = r), (t[7] = h));
  let g;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, J.jsx)(Ke, { className: `icon-xs` })), (t[8] = g))
    : (g = t[8]);
  let _;
  t[9] === h
    ? (_ = t[10])
    : ((_ = (0, J.jsx)(xe, {
        tooltipContent: m,
        children: (0, J.jsx)(K, { color: `ghost`, size: `icon`, "aria-label": h, children: g }),
      })),
      (t[9] = h),
      (t[10] = _));
  let v;
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, J.jsx)(q.Item, {
        RightIcon: tt,
        onSelect: d,
        children: (0, J.jsx)(f, { ...jt.appSettings }),
      })),
      (t[13] = y))
    : (y = t[13]);
  let x;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, J.jsx)(q.Item, {
        RightIcon: tt,
        onSelect: p,
        children: (0, J.jsx)(f, { ...jt.chromeComputerUseSettings }),
      })),
      (t[14] = x))
    : (x = t[14]);
  let S;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, J.jsx)(f, { ...jt.codexForChrome })), (t[15] = S))
    : (S = t[15]);
  let C;
  t[16] === i
    ? (C = t[17])
    : ((C =
        i == null
          ...
          : (0, J.jsx)(`span`, {
              className: `shrink-0`,
              children: (0, J.jsx)(f, { ...jt.extensionVersion, values: { version: i } }),
            })),
      (t[16] = i),
      (t[17] = C));
  let w;
...
function Nt() {
  ...
  return (
    e[9] !== r || e[10] !== l
      ? ((u = (0, Ft.jsx)(xe, { tooltipContent: o, shortcut: r, children: l })),
        (e[9] = r),
        (e[10] = l),
        (e[11] = u))
      : (u = e[11]),
...
function Bt(e) {
  let t = (0, Ut.c)(23),
    ...
    i = Be(),
    a = y(),
    { cancelPendingWorktree: o } = Je();
  if (r.isLoading && n.length === 0) return null;
  let s = r.error instanceof T && r.error.status === 404;
    ...
    return (
      t[4] === n
        ...
        : ((a = (0, Wt.jsxs)(`div`, {
            ...
            children: [
              e,
              (0, Wt.jsx)(K, { size: `default`, color: `outline`, onClick: n, children: i }),
            ],
          })),
          (t[4] = n),
          (t[5] = a)),
...
var qt = e(() => {}),
  Jt,
  Yt = e(() => {
    (_(), (Jt = M(`cloudTasksEnvironmentFilterId`, null)));
  });
function Xt(e) {
  let t = (0, Zt.c)(15),
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (s = t[0]);
  let l;
  t[1] === r ? (l = t[2]) : ((l = (e) => r(e.target.value)), (t[1] = r), (t[2] = l));
  let u;
  t[3] === o
    ? (u = t[4])
    : ((u = o.formatMessage({
  ...
  let p;
  return (
    t[9] !== a || t[10] !== n || t[11] !== l || t[12] !== u || t[13] !== d
      ? ((p = (0, Qt.jsxs)(`div`, {
          children: [
            s,
            (0, Qt.jsx)(re, {
...
function sn(e) {
  let t = (0, ln.c)(64),
    ...
    [l, u] = He(Jt),
    d = o(),
    { data: p, isLoading: m, isError: h, refetch: g } = E(),
    _;
  t[0] === s ? (_ = t[1]) : ((_ = s.trim()), (t[0] = s), (t[1] = _));
  let v = _.length > 0,
    y;
  t[2] === v ? (y = t[3]) : ((y = { enabled: v }), (t[2] = v), (t[3] = y));
  let { data: x, isLoading: S, isError: C, refetch: w } = ze(s, y),
    T;
  if (t[4] !== s || t[5] !== p || t[6] !== x || t[7] !== d) {
    bb0: {
      let e = s.trim(),
        n = e.length > 0 ? (x ?? []) : (p ?? []);
      if (e.length === 0 && d) {
    ...
    ((t[4] = s), (t[5] = p), (t[6] = x), (t[7] = d), (t[8] = T));
  } else T = t[8];
  let D = T,
    O;
  t[13] !== l || t[14] !== p
    ? ((O = p?.find((e) => e.id === l) ?? null), (t[13] = l), (t[14] = p), (t[15] = O))
    : (O = t[15]);
  let k = O,
    A;
  ...
  let j = l ? `default` : `icon`,
    M;
  t[17] === n ? (M = t[18]) : ((M = ve(`mr-1`, n)), (t[17] = n), (t[18] = M));
  let N;
  ...
  let P;
  t[20] !== l || t[21] !== k
    ? ((P = !!l && k?.label && (0, Y.jsx)(`span`, { className: `text-sm`, children: k.label })),
      (t[20] = l),
      (t[21] = k),
      (t[22] = P))
    : (P = t[22]);
  ...
  t[23] === P
    ? (ee = t[24])
    : ((ee = (0, Y.jsxs)(`span`, { className: `flex items-center gap-1.5`, children: [N, P] })),
      (t[23] = P),
      (t[24] = ee));
  let F;
  t[25] !== ee || t[26] !== j || t[27] !== M
    ? ((F = (0, Y.jsx)(ie, {
        asChild: !0,
        children: (0, Y.jsx)(xe, {
          tooltipContent: A,
          children: (0, Y.jsx)(K, { color: `ghost`, size: j, className: M, children: ee }),
        }),
      })),
      (t[25] = ee),
      (t[26] = j),
  ...
  let z;
  t[33] !== L || t[34] !== R
    ? ((z = (0, Y.jsx)(cn, { isSelected: L, onClick: R, children: te })),
      (t[33] = L),
      (t[34] = R),
      (t[35] = z))
    : (z = t[35]);
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (e) => c(e.currentTarget.value)), (t[39] = H))
    : (H = t[39]);
  let U;
  t[40] !== s || t[41] !== V
    ? ((U = (0, Y.jsx)(q.Section, {
        className: `my-1`,
        children: (0, Y.jsx)(q.SearchInput, { placeholder: V, value: s, onChange: H }),
      })),
      (t[40] = s),
      (t[41] = V),
      (t[42] = U))
  ...
  let re;
  return (
    t[60] !== i || t[61] !== F || t[62] !== ne
      ? ((re = (0, Y.jsxs)(he, { open: i, onOpenChange: a, children: [F, ne] })),
        (t[60] = i),
        (t[61] = F),
        (t[62] = ne),
        (t[63] = re))
...
function cn(e) {
  let t = (0, ln.c)(11),
    ...
    a = r && `font-medium`,
    o;
  t[0] === a ? (o = t[1]) : ((o = ve(an, a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = r ? (0, Y.jsx)(F, { className: `icon-2xs shrink-0 opacity-75` }) : null),
      (t[4] = r),
      (t[5] = c));
  let l;
  return (
...
function fn(e) {
  ...
  t[0] === i
    ? (s = t[1])
    : ((s = (0, X.jsx)(`span`, { children: (0, X.jsx)(f, { ...i }) })), (t[0] = i), (t[1] = s));
  let c;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, X.jsx)(ne, { className: `icon-2xs` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === s
    ? (l = t[4])
  ...
  let m;
  t[8] !== u || t[9] !== d
    ? ((m = (0, X.jsx)(mn, { isSelected: u, onClick: d, children: p })),
      (t[8] = u),
      (t[9] = d),
      (t[10] = m))
    : (m = t[10]);
  ...
  t[23] !== v || t[24] !== S || t[25] !== m
    ? ((C = (0, X.jsx)(Pe, {
        className: `w-[220px]`,
        onOpenAutoFocus: pn,
        children: (0, X.jsxs)(`div`, { className: `flex flex-col`, children: [m, v, S] }),
      })),
      (t[23] = v),
      (t[24] = S),
      (t[25] = m),
  ...
  return (
    t[27] !== a || t[28] !== C || t[29] !== l
      ? ((w = (0, X.jsxs)(he, { open: a, onOpenChange: o, children: [l, C] })),
        (t[27] = a),
        (t[28] = C),
        (t[29] = l),
        (t[30] = w))
...
function mn(e) {
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = r ? (0, X.jsx)(F, { className: `icon-2xs shrink-0 opacity-75` }) : null),
      (t[4] = r),
      (t[5] = c));
  let l;
  return (
...
function En({
  ...
  let o = e ?? [],
    ...
    c = (0, On.default)(
      ...
      return { kind: `remote`, key: H(e.id), at: t * 1e3, task: e };
    }),
    l = s.map((e) => {
      let t = i === `updated_at` ? (e.recencyAt ?? e.updatedAt) : e.createdAt;
      Number.isFinite(t) || m.error(`local conversation has invalid createdAt or updatedAt`);
      let n = Number.isFinite(t) ? t : Number.isFinite(e.createdAt) ? e.createdAt : 0;
      return { kind: `local`, key: Ce(e.id), at: n, conversation: e };
    }),
    u = n.map((e) => ({
...
var On,
  kn,
  An = e(() => {
    ((On = t(ge(), 1)), h(), (kn = t(me(), 1)), fe(), s(), Ee(), g(), I(), A(), Qe(), wn());
  });
function jn(e) {
  let t = (0, In.c)(33),
    {
    ...
    [h] = He(Jt),
    g = c ? d : `recent`,
    _ = O(`/local/:conversationId`)?.params?.conversationId ?? null,
    { data: v } = E(),
    y = C(),
    x;
  t[0] !== h || t[1] !== c || t[2] !== v
    ? ((x = c ? (v?.find((e) => e.id === h) ?? null) : null),
      (t[0] = h),
      (t[1] = c),
      (t[2] = v),
      (t[3] = x))
  ...
  t[4] === y
    ? (w = t[5])
    : ((w = (e) => Cn({ conversation: e, isBackgroundSubagentsEnabled: y })),
      (t[4] = y),
      (t[5] = w));
  let T = r.filter(w),
    D = Tn(n.data, r, S),
    [k, A] = (0, Ln.useState)(``),
    j = (0, Ln.useDeferredValue)(k).trim().toLowerCase(),
    M = j.length > 0,
    N = D.filter(Mn),
    P = M
      ? N.filter((e) => {
      ...
      : N,
    ee = M ? T.filter((e) => Kt(p(e), j)) : T,
    F = M
      ? D.filter((e) =>
          e.kind === `remote`
            ? Kt(e.task.title, j)
            : e.kind === `local`
              ? Kt(p(e.conversation), j)
              : Kt(Nn(e.pendingWorktree, l), j),
        )
      : D,
    I;
  t[6] !== s || t[7] !== k
    ? ((I = (0, Z.jsx)(q.Section, {
        children: (0, Z.jsx)(Xt, { searchQuery: k, onQueryChange: A, autoFocus: s }),
      })),
      (t[6] = s),
      (t[7] = k),
      (t[8] = I))
  ...
  t[10] !== u || t[11] !== d || t[12] !== m || t[13] !== c
    ? ((R =
        ...
        (0, Z.jsxs)(q.Section, {
          ...
          children: [
            (0, Z.jsx)(fn, { filter: d, onSelect: m }),
            d !== `local` && (0, Z.jsx)(sn, {}),
          ],
        })),
      (t[10] = u),
        ...
        : n.isLoading
          ...
          : P.length === 0
            ? M
              ? (0, Z.jsx)(yn, {})
              : (0, Z.jsx)(en, {})
            : P.map((e) => (0, Z.jsx)(mt, { task: e.task, onClose: i }, e.key))),
    B =
      g === `local` &&
      (ee.length
        ? ee.map((e) =>
  ...
  t[21] !== g
                  ...
                  children: [
                    ...
                    F.map((e) =>
                      (0, Z.jsx)(
                        ...
                        {
                          item: e,
                          isActive: e.kind === `local` && _ === e.conversation.id,
                          onClose: i,
                        },
                        e.key,
                      ),
    ...
    : (V = t[22]);
  let H;
  t[23] !== te.Section || t[24] !== z || t[25] !== B || t[26] !== V
    ? ((H = (0, Z.jsxs)(te.Section, {
  ...
  return (
    t[2] === n
      ...
      : ((a = (0, Z.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, Z.jsx)(K, { size: `default`, color: `outline`, onClick: n, children: i }),
          ],
        })),
        (t[2] = n),
        (t[3] = a)),
...
var In,
  ...
  Vn = e(() => {
    ((In = B()),
      ...
      pt(),
      (Z = Me()),
      (Rn = M(`recent-tasks-filter`, `recent`)),
      (zn = (0, Ln.memo)(function (e) {
        ...
        t[0] === r
          ? (o = t[1])
          : ((o = r == null ? void 0 : (0, Z.jsx)(at, { dateString: new Date(r).toISOString() })),
            (t[0] = r),
            (t[1] = o));
        let s;
        return (
          t[2] !== n || t[3] !== i || t[4] !== a || t[5] !== o
            ? ((s = (0, Z.jsx)(lt, { conversationId: n, isActive: i, metaContent: o, onClick: a })),
              (t[2] = n),
              (t[3] = i),
              (t[4] = a),
              (t[5] = o),
      ...
      (Bn = (0, Ln.memo)(function (e) {
        ...
        switch (n.kind) {
          case `remote`: {
            ...
            return (
              t[0] !== n.task || t[1] !== a
                ? ((e = (0, Z.jsx)(mt, { task: n.task, onClose: a })),
                  (t[0] = n.task),
                  (t[1] = a),
                  (t[2] = e))
                : (e = t[2]),
          ...
          case `local`: {
            ...
            let i;
            return (
              t[6] !== r || t[7] !== n.conversation.id || t[8] !== a || t[9] !== e
                ? ((i = (0, Z.jsx)(lt, {
          ...
          case `pending-worktree`: {
            let e;
            t[11] !== n.pendingWorktree.id || t[12] !== a
              ? ((e = () => {
              ...
              : (e = t[13]);
            let r;
            t[14] !== o || t[15] !== n.pendingWorktree.id
              ? ((r = () => {
                  o(n.pendingWorktree.id);
                }),
                (t[14] = o),
...
function Hn(e) {
  ...
  t[3] === g
    ? (_ = t[4])
    : ((_ = { taskFilter: `current`, limit: 20, enabled: g }), (t[3] = g), (t[4] = _));
  let v = w(_),
    x;
  t[5] === v.data ? (x = t[6]) : ((x = v.data ?? []), (t[5] = v.data), (t[6] = x));
  let S;
  t[7] === x ? (S = t[8]) : ((S = x.filter(Wn)), (t[7] = x), (t[8] = S));
  let T = S,
    E,
    O,
    k,
    A;
  if (t[9] !== l || t[10] !== u || t[11] !== r || t[12] !== c.pathname || t[13] !== T.length) {
    let e;
    t[18] === u
      ? (e = t[19])
    ...
    ((E = T.length + n.length),
      ...
      (t[16] = k),
      (t[17] = A));
  } else ((E = t[14]), (O = t[15]), (k = t[16]), (A = t[17]));
  let j = A,
    M;
  t[20] !== j || t[21] !== E || t[22] !== o
    ? ((M = j
        ? o.formatMessage(
            {
  ...
  let N = M,
    P;
  t[24] !== s || t[25] !== d || t[26] !== v
    ? ((P = () => {
        d && s === `chatgpt` && v.refetch();
      }),
      (t[24] = s),
      (t[25] = d),
      (t[26] = v),
    ...
    : (P = t[27]);
  let ee;
  (t[28] === d ? (ee = t[29]) : ((ee = [d]), (t[28] = d), (t[29] = ee)), (0, Kn.useEffect)(P, ee));
  let F, I;
  ...
  t[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = (0, Q.jsx)(f, {
      ...
      (t[32] = L))
    : (L = t[32]);
  let R = O ? `ghostActive` : `ghost`,
    te = O ? `default` : `icon`,
    z = O && `max-w-full min-w-0 !px-0 !py-0 hover:!bg-transparent hover:opacity-80`,
    B;
  t[33] === z ? (B = t[34]) : ((B = ve(`relative`, z)), (t[33] = z), (t[34] = B));
  let H = O ? void 0 : N,
    U;
  t[35] === j
    ? (U = t[36])
    : ((U = j
      ...
      (t[36] = U));
  let W;
  t[37] !== r || t[38] !== O || t[39] !== k
    ? ((W = O
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              (0, Q.jsx)(`span`, { className: ve(`min-w-0 truncate`, !1), children: r }),
        ...
        : k
          ...
          : (0, Q.jsx)(et, { className: `icon-xs hover:opacity-80` })),
      (t[37] = r),
      (t[38] = O),
      (t[39] = k),
      (t[40] = W))
  ...
  t[53] !== re
    ...
    : (ie = t[54]);
  let oe;
  t[55] === l ? (oe = t[56]) : ((oe = l ?? []), (t[55] = l), (t[56] = oe));
  let se;
  t[57] !== h || t[58] !== d || t[59] !== v || t[60] !== a || t[61] !== oe
    ? ((se = (0, Q.jsx)(jn, {
        cloudtasksQuery: v,
...
function Jn(e) {
  ...
  t[28] === n
    ? (_ = t[29])
    : ((_ = ve(`draggable extension:px-panel`, n)), (t[28] = n), (t[29] = _));
  let v = `justify-between`,
    b;
  t[30] === v
    ? (b = t[31])
    : ((b = ve(`flex items-center electron:h-toolbar extension:py-row-y`, v)),
      (t[30] = v),
      (t[31] = b));
  let x;
  t[32] !== a || t[33] !== !1 ? ((x = null), (t[32] = a), (t[33] = !1), (t[34] = x)) : (x = t[34]);
  let S;
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, $.jsx)(Re, { extension: !0, children: (0, $.jsx)(nt, {}) })), (t[42] = E))
    : (E = t[42]);
  let O;
  ...
  t[48] !== k || t[49] !== o
    ...
    : (A = t[50]);
  let j;
  t[51] !== A || t[52] !== b || t[53] !== x || t[54] !== S
    ? ((j = (0, $.jsxs)(`div`, { className: b, children: [x, S, A] })),
      (t[51] = A),
      (t[52] = b),
      (t[53] = x),
      (t[54] = S),
  ...
  t[60] === M
    ? (N = t[61])
    : ((N = (0, $.jsx)(Re, { extension: !0, children: M })), (t[60] = M), (t[61] = N));
  let P;
  return (
    t[62] !== j || t[63] !== N || t[64] !== _
      ? ((P = (0, $.jsxs)(`div`, { className: _, children: [j, N] })),
        (t[62] = j),
        (t[63] = N),
        (t[64] = _),
        (t[65] = P))
...
function Xn() {
  a(`newThread`, `header_new_thread`);
}
function Zn(e) {
  let t = (0, $n.c)(21),
    { mergedTasks: i, onBack: a, showBackButton: o } = e,
    s = y().pathname === `/`,
    c = O(`/local/:conversationId`)?.params?.conversationId ?? null,
    l;
  t[0] === c ? (l = t[1]) : ((l = c == null ? null : r(c)), (t[0] = c), (t[1] = l));
  let u = l,
    d = O(`/remote/:taskId`)?.params?.taskId ?? null,
    { data: p } = pe(d),
    m = N(n, u),
    h = N(Ye, u);
  if (d && p?.task?.title) {
    let e;
    t[2] !== a || t[3] !== o
      ? ((e = o ? (0, $.jsx)(Qn, { onClick: a }) : null), (t[2] = a), (t[3] = o), (t[4] = e))
      : (e = t[4]);
    let n;
    t[5] === p.task.title
      ? (n = t[6])
  ...
  if (u && m) {
    let e;
    t[10] !== a || t[11] !== o
      ? ((e = o ? (0, $.jsx)(Qn, { onClick: a }) : null), (t[10] = a), (t[11] = o), (t[12] = e))
      : (e = t[12]);
    let n;
    t[13] === h
      ? (n = t[14])
...
function Qn(e) {
  let t = (0, $n.c)(7),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(f, { ...er.backButton })), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === r ? (a = t[2]) : ((a = r.formatMessage(er.backButton)), (t[1] = r), (t[2] = a));
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(ue, { className: `size-3` })), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] !== n || t[5] !== a
