...
import { f as C, m as w, p as T } from "./chunk-8.js";
import { o as E } from "./statsig.js";
import { s as D } from "./app-server-manager-hooks-DfDI-9lO.js";
import { D as O, k } from "./sidebar-signals.js";
import { t as A } from "./use-auth.js";
import { C as j, D as M, E as N, m as P } from "./codex-api-B.js";
...
import { n as z } from "./local-conversation-title-signals.js";
import { t as B } from "./with-window.js";
import { i as V, r as H } from "./pending-worktree-store.js";
...
import { a as ae, r as K, t as q } from "./dropdown.js";
...
import { a as X, i as le, t as ue } from "./local-task-row.js";
import { t as de } from "./use-is-background-subagents-enabled-B.js";
import { t as fe } from "./profile-dropdown.js";
import { n as pe } from "./is-subagent-conversation-Tg4-cSB_.js";
import { t as me } from "./history.js";
import { t as he } from "./dock.js";
var Z = x(),
  Q = f();
function ge() {
  let e = (0, Z.c)(12),
...
function Oe(e) {
  ...
  let D = E,
    O;
  t[13] !== l || t[14] !== f
    ? ((O = f?.find((e) => e.id === l) ?? null), (t[13] = l), (t[14] = f), (t[15] = O))
    : (O = t[15]);
  let k = O,
    A;
  ...
  let z;
  t[20] !== l || t[21] !== k
    ? ((z = !!l && k?.label && (0, Q.jsx)(`span`, { className: `text-sm`, children: k.label })),
      (t[20] = l),
      (t[21] = k),
      (t[22] = z))
    : (z = t[22]);
  ...
  t[25] !== B || t[26] !== j || t[27] !== N
    ? ((V = (0, Q.jsx)(oe, {
        ...
        children: (0, Q.jsx)(F, {
          tooltipContent: A,
          children: (0, Q.jsx)(L, { color: `ghost`, size: j, className: N, children: B }),
        }),
      })),
      (t[25] = B),
      (t[26] = j),
  ...
  t[40] !== s || t[41] !== re
    ? ((ae = (0, Q.jsx)(K.Section, {
        className: `my-1`,
        children: (0, Q.jsx)(K.SearchInput, { placeholder: re, value: s, onChange: ie }),
      })),
      (t[40] = s),
      (t[41] = re),
      (t[42] = ae))
...
function ke(e) {
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = r ? (0, Q.jsx)(te, { className: `icon-2xs shrink-0 opacity-75` }) : null),
      (t[4] = r),
      (t[5] = c));
  let l;
  return (
...
function je(e) {
  ...
  t[0] === i
    ? (s = t[1])
    : ((s = (0, Q.jsx)(`span`, { children: (0, Q.jsx)(g, { ...i }) })), (t[0] = i), (t[1] = s));
  let c;
  ...
  t[23] !== v || t[24] !== S || t[25] !== p
    ? ((C = (0, Q.jsx)(se, {
        className: `w-[220px]`,
        onOpenAutoFocus: Me,
        children: (0, Q.jsxs)(`div`, { className: `flex flex-col`, children: [p, v, S] }),
      })),
      (t[23] = v),
      (t[24] = S),
      (t[25] = p),
...
function Le({
  ...
  let l = e ?? [],
    u = t.filter((e) => Fe({ conversation: e, isBackgroundSubagentsEnabled: s })),
    d = (0, ye.default)(
...
function Be(e) {
  let t = (0, Z.c)(31),
    ...
    y;
  t[0] !== p || t[1] !== _
    ? ((y = _?.find((e) => e.id === p) ?? null), (t[0] = p), (t[1] = _), (t[2] = y))
    : (y = t[2]);
  let b = y,
    x;
  t[3] === v
  ...
  t[5] !== c || t[6] !== w
    ? ((F = (0, Q.jsx)(K.Section, {
        children: (0, Q.jsx)(Te, { searchQuery: w, onQueryChange: E, autoFocus: c }),
      })),
      (t[5] = c),
      (t[6] = w),
      (t[7] = F))
    ...
    V =
      ...
      (N.length
        ? N.map((e) =>
            (0, Q.jsx)(
              He,
              { conversationId: e.id, updatedAt: e.updatedAt, isActive: m === e.id, onClose: a },
              e.id,
            ),
          )
        : O
...
function qe() {
  ...
  e[12] !== n || e[13] !== o || e[14] !== f
    ...
    : (S = e[15]);
  let w;
  (e[16] === o ? (w = e[17]) : ((w = [o]), (e[16] = o), (e[17] = w)), (0, $.useEffect)(S, w));
  let T, E;
...
function Xe(e) {
  ...
  t[0] === d
    ? (f = t[1])
    : ((f = { taskFilter: `current`, limit: 20, enabled: d }), (t[0] = d), (t[1] = f));
  let m = N(f),
    h;
  t[2] === u ? (h = t[3]) : ((h = u ?? []), (t[2] = u), (t[3] = h));
  let g = Ie(m.data, h, null),
    _;
  t[4] === n ? (_ = t[5]) : ((_ = p(`draggable extension:px-panel`, n)), (t[4] = n), (t[5] = _));
  ...
  t[6] === v
    ...
    : ((y = p(`flex items-center electron:h-toolbar extension:py-row-y`, v)),
      ...
      (t[7] = y));
  let b;
  t[8] !== i || t[9] !== !1 ? ((b = null), (t[8] = i), (t[9] = !1), (t[10] = b)) : (b = t[10]);
  let x;
    ...
    ? ((x = (0, Q.jsx)(`div`, {
        ...
        children: r
          ...
          : (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)($e, { mergedTasks: g, onBack: s, showBackButton: !0 }),
            }),
      })),
      (t[11] = s),
      (t[12] = g),
  ...
  let w;
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, Q.jsx)(B, { extension: !0, children: (0, Q.jsx)(fe, {}) })), (t[16] = w))
    : (w = t[16]);
  let T;
  t[17] === !0 ? (T = t[18]) : ((T = (0, Q.jsx)(ge, {})), (t[17] = !0), (t[18] = T));
  let E;
  t[19] === T
    ? (E = t[20])
    : ((E = (0, Q.jsx)(B, {
  ...
  t[29] !== c || t[30] !== g || t[31] !== m
    ? ((A =
        c && (0, Q.jsx)(`div`, { children: (0, Q.jsx)(be, { tasksQuery: m, mergedTasks: g }) })),
      (t[29] = c),
      (t[30] = g),
      (t[31] = m),
      (t[32] = A))
  ...
  t[33] === A
    ? (j = t[34])
    : ((j = (0, Q.jsx)(B, { extension: !0, children: A })), (t[33] = A), (t[34] = j));
  let M;
  return (
...
function $e(e) {
  let n = (0, Z.c)(21),
    ...
    c;
  n[0] === s ? (c = n[1]) : ((c = s == null ? null : t(s)), (n[0] = s), (n[1] = c));
  let u = c,
  ...
  if (d && f?.task?.title) {
    let e;
    n[2] !== i || n[3] !== a
      ? ((e = a ? (0, Q.jsx)(et, { onClick: i }) : null), (n[2] = i), (n[3] = a), (n[4] = e))
      : (e = n[4]);
    let t;
    n[5] === f.task.title
      ? (t = n[6])
  ...
  if (u && p) {
    let e;
    n[10] !== i || n[11] !== a
      ? ((e = a ? (0, Q.jsx)(et, { onClick: i }) : null), (n[10] = i), (n[11] = a), (n[12] = e))
      : (e = n[12]);
    let t;
    n[13] === m
      ? (t = n[14])
...
function et(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (i = t[0]);
  let a;
  t[1] === r ? (a = t[2]) : ((a = r.formatMessage(tt.backButton)), (t[1] = r), (t[2] = a));
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
