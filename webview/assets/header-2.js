...
import { I as f, P as p, c as m, f as h, g, lt as _ } from "./vscode-api.js";
import { n as v } from "./react.js";
import { c as y, o as b, r as x } from "./lib-2.js";
import { f as S, m as C, p as w } from "./chunk-12.js";
import { o as T } from "./statsig.js";
import { s as E } from "./app-server-manager-hooks.js";
import { A as D, O } from "./sidebar-signals.js";
import { t as k } from "./use-auth-6.js";
import { C as A, D as j, E as M, m as N } from "./codex-api.js";
...
import { r as H } from "./run-command.js";
import { t as U } from "./check-md.js";
import { n as W } from "./use-start-new-conversation.js";
import { i as te, r as G } from "./pending-worktree-store.js";
...
import { n as pe } from "./is-subagent-conversation.js";
...
function ke(e) {
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = r ? (0, Q.jsx)(U, { className: `icon-2xs shrink-0 opacity-75` }) : null),
      (t[4] = r),
      (t[5] = c));
  let l;
  return (
...
function qe() {
  ...
  e[20] !== n || e[21] !== o || e[22] !== f
    ...
    : (T = e[23]);
  let D;
  (e[24] === o ? (D = e[25]) : ((D = [o]), (e[24] = o), (e[25] = D)), (0, $.useEffect)(T, D));
  let O, A;
  ...
  e[38] !== N || e[39] !== F || e[40] !== R || e[41] !== w
    ...
    : (z = e[42]);
  let B;
  e[43] === i ? (B = e[44]) : ((B = i ?? []), (e[43] = i), (e[44] = B));
  let H;
  e[45] !== l || e[46] !== o || e[47] !== f || e[48] !== B
    ? ((H = (0, Q.jsx)(Be, {
        cloudtasksQuery: f,
        localConversations: B,
        onClose: l,
        autoFocusSearch: o,
      })),
      (e[45] = l),
