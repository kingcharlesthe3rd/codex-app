...
import { H as o, Zt as s, sn as c } from "./use-host-config.js";
import { Ea as l, z as u } from "./thread-context-inputs.js";
import { c as d, f, h as p } from "./vscode-api.js";
import { n as m } from "./react.js";
import { ai as h } from "./src.js";
import { i as g, l as _, s as v } from "./lib-1.js";
import { t as y } from "./clsx.js";
import { t as b } from "./persisted-atom.js";
import { t as x } from "./button-oF-qgtAS.js";
import { t as S } from "./spinner.js";
import { t as C } from "./check-md.js";
import { t as w } from "./use-stable-callback.js";
import { t as ee } from "./tooltip-B.js";
import { t as T } from "./x.js";
import { o as E } from "./statsig.js";
import { t as D } from "./chevron.js";
import { f as O, m as k, p as A } from "./chunk-13.js";
import { s as j } from "./app-server-manager-hooks-D4-J16ZL.js";
import { E as M, O as N } from "./sidebar-signals.js";
import { t as P } from "./use-auth.js";
import { D as te, O as F, m as ne, w as I } from "./codex-api.js";
import { i as re } from "./use-environment.js";
import { t as L } from "./arrow-left.js";
import { n as R } from "./local-conversation-title-signals.js";
import { t as z } from "./with-window.js";
import { n as B, r as V, t as H } from "./sidebar-thread-keys.js";
import { t as U } from "./settings.cog.js";
import { r as W } from "./run-command.js";
import { n as ie } from "./use-start-new-conversation.js";
import { a as G, i as K } from "./pending-worktree-store.js";
import { a as q } from "./command-keybindings.js";
import { t as J } from "./compose.js";
import { a as Y, r as X, t as ae } from "./dropdown.js";
import { t as oe } from "./format-relative-date-time.js";
import { c as se, s as ce, t as le } from "./local-task-row.js";
import { i as ue, n as de, t as fe } from "./popover.js";
import { t as pe } from "./use-is-background-subagents-enabled.js";
import { t as me } from "./arrow-up-right-lg.js";
import { t as he } from "./profile-dropdown.js";
import { t as ge } from "./history.js";
import { t as _e } from "./dock.js";
var Z = r(),
  Q = n(),
  ve = `codex://settings`,
  ye = `codex://settings/computer-use/google-chrome`,
  be = `popup.html`;
function xe() {
  let e = (0, Z.c)(24),
    t = _(),
  ...
  e[0] === t
    ? ((n = e[1]), (r = e[2]))
    : ((n = De()),
      (r = n == null ? null : t.formatMessage(Oe.extensionVersion, { version: n })),
      (e[0] = t),
      (e[1] = n),
      (e[2] = r));
  let i = r,
    a;
  e[3] === t ? (a = e[4]) : ((a = t.formatMessage(Oe.codexForChrome)), (e[3] = t), (e[4] = a));
  let o = a,
    s = i == null ? o : `${o} ${i}`,
    c = we,
    l = Ce,
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(v, { ...Oe.settingsTrigger })), (e[5] = d))
    : (d = e[5]);
  let f;
  e[6] === t ? (f = e[7]) : ((f = t.formatMessage(Oe.settingsTrigger)), (e[6] = t), (e[7] = f));
  let p;
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, Q.jsx)(U, { className: `icon-xs` })), (e[8] = p))
    : (p = e[8]);
  let m;
  e[9] === f
    ? (m = e[10])
    : ((m = (0, Q.jsx)(ee, {
        tooltipContent: d,
        children: (0, Q.jsx)(x, { color: `ghost`, size: `icon`, "aria-label": f, children: p }),
      })),
      (e[9] = f),
      (e[10] = m));
  let h;
  e[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Q.jsx)(X.Item, {
        RightIcon: me,
        onSelect: l,
        children: (0, Q.jsx)(v, { ...Oe.appSettings }),
      })),
      (e[11] = h))
    : (h = e[11]);
  let g;
  e[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, Q.jsx)(X.Item, {
        RightIcon: me,
        onSelect: u,
        children: (0, Q.jsx)(v, { ...Oe.chromeComputerUseSettings }),
      })),
      (e[12] = g))
    : (g = e[12]);
  let y;
  e[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, Q.jsx)(v, { ...Oe.codexForChrome })), (e[13] = y))
    : (y = e[13]);
  let b;
  e[14] === n
    ? (b = e[15])
    : ((b =
        n == null
          ...
          : (0, Q.jsx)(`span`, {
              className: `shrink-0`,
              children: (0, Q.jsx)(v, { ...Oe.extensionVersion, values: { version: n } }),
            })),
      (e[14] = n),
      (e[15] = b));
  let S;
...
function Te(e) {
  f.dispatchMessage(`open-in-browser`, { url: e });
}
function Ee() {
  return globalThis.chrome?.runtime?.getURL(be) ?? be;
}
function De() {
...
var Oe = g({
  settingsTrigger: {
    id: `header.settingsTrigger`,
    defaultMessage: `Settings`,
    description: `Button label for opening settings from the header`,
  },
  appSettings: {
  ...
  codexForChrome: {
    ...
    description: `Footer label for the Chrome extension in the settings menu`,
  },
  extensionVersion: {
...
function ke() {
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(v, { ...Ae.newChat })), (e[2] = s))
    : (s = e[2]);
  let c;
  e[3] === n ? (c = e[4]) : ((c = n.formatMessage(Ae.newChat)), (e[3] = n), (e[4] = c));
  let l;
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(J, { className: `icon-xs` })), (e[5] = l))
    : (l = e[5]);
  let u;
  e[6] !== o || e[7] !== c
    ? ((u = (0, Q.jsx)(x, {
  ...
  return (
    e[9] !== r || e[10] !== u
      ? ((d = (0, Q.jsx)(ee, { tooltipContent: s, shortcut: r, children: u })),
        (e[9] = r),
        (e[10] = u),
        (e[11] = d))
      : (d = e[11]),
...
function Ne(e) {
  let t = (0, Z.c)(23),
    ...
    i = k(),
    a = O(),
    { cancelPendingWorktree: o } = K();
  if (r.isLoading && n.length === 0) return null;
  let s = r.error instanceof d && r.error.status === 404;
    ...
    return (
      t[4] === n
        ...
        : ((a = (0, Q.jsxs)(`div`, {
            ...
            children: [
              e,
              (0, Q.jsx)(x, { size: `default`, color: `outline`, onClick: n, children: i }),
            ],
          })),
          (t[4] = n),
          (t[5] = a)),
  ...
  let c;
  t[6] === n ? (c = t[7]) : (n.filter(Fe), (c = n), (t[6] = n), (t[7] = c));
  let l = c,
    u;
...
var Le = b(`cloudTasksEnvironmentFilterId`, null);
function Re(e) {
  let t = (0, Z.c)(15),
    ...
    ? ((u =
        n.length > 0
          ? (0, Q.jsx)(`button`, {
              ...
              children: (0, Q.jsx)(T, { className: `icon-2xs` }),
            })
          : null),
      (t[5] = o),
      (t[6] = r),
...
var Be = `w-full justify-between !px-[var(--padding-row-x)] !py-[var(--padding-row-y)] text-left`,
  $ = e(t(), 1);
function Ve(e) {
  let t = (0, Z.c)(64),
    { className: n } = e,
    ...
    [c, l] = m(Le),
    u = re(),
    { data: d, isLoading: f, isError: p, refetch: h } = F(),
    g;
  t[0] === o ? (g = t[1]) : ((g = o.trim()), (t[0] = o), (t[1] = g));
  let b = g.length > 0,
    C;
  t[2] === b ? (C = t[3]) : ((C = { enabled: b }), (t[2] = b), (t[3] = C));
  let { data: w, isLoading: T, isError: E, refetch: D } = ne(o, C),
    O;
  if (t[4] !== o || t[5] !== d || t[6] !== w || t[7] !== u) {
    bb0: {
      let e = o.trim(),
        n = e.length > 0 ? (w ?? []) : (d ?? []);
      if (e.length === 0 && u) {
    ...
    ((t[4] = o), (t[5] = d), (t[6] = w), (t[7] = u), (t[8] = O));
  } else O = t[8];
  let k = O,
    A;
  t[13] !== c || t[14] !== d
    ? ((A = d?.find((e) => e.id === c) ?? null), (t[13] = c), (t[14] = d), (t[15] = A))
    : (A = t[15]);
  let j = A,
    M;
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, Q.jsx)(v, {
      ...
      (t[16] = M))
    : (M = t[16]);
  let N = c ? `default` : `icon`,
    P;
  t[17] === n ? (P = t[18]) : ((P = y(`mr-1`, n)), (t[17] = n), (t[18] = P));
  let te;
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((te = (0, Q.jsx)(_e, { className: `icon-2xs` })), (t[19] = te))
    : (te = t[19]);
  let I;
  t[20] !== c || t[21] !== j
    ? ((I = !!c && j?.label && (0, Q.jsx)(`span`, { className: `text-sm`, children: j.label })),
      (t[20] = c),
      (t[21] = j),
      (t[22] = I))
    : (I = t[22]);
  ...
  t[23] === I
    ? (L = t[24])
    : ((L = (0, Q.jsxs)(`span`, { className: `flex items-center gap-1.5`, children: [te, I] })),
      (t[23] = I),
      (t[24] = L));
  let R;
  t[25] !== L || t[26] !== N || t[27] !== P
    ? ((R = (0, Q.jsx)(ue, {
        asChild: !0,
        children: (0, Q.jsx)(ee, {
          tooltipContent: M,
          children: (0, Q.jsx)(x, { color: `ghost`, size: N, className: P, children: L }),
        }),
      })),
      (t[25] = L),
      (t[26] = N),
  ...
  let U;
  t[33] !== B || t[34] !== V
    ? ((U = (0, Q.jsx)(He, { isSelected: B, onClick: V, children: H })),
      (t[33] = B),
      (t[34] = V),
      (t[35] = U))
    : (U = t[35]);
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (e) => s(e.currentTarget.value)), (t[39] = G))
    : (G = t[39]);
  let K;
  t[40] !== o || t[41] !== ie
    ? ((K = (0, Q.jsx)(X.Section, {
        className: `my-1`,
        children: (0, Q.jsx)(X.SearchInput, { placeholder: ie, value: o, onChange: G }),
      })),
      (t[40] = o),
      (t[41] = ie),
      (t[42] = K))
  ...
  let ae;
  return (
    t[60] !== i || t[61] !== R || t[62] !== Y
      ? ((ae = (0, Q.jsxs)(fe, { open: i, onOpenChange: a, children: [R, Y] })),
        (t[60] = i),
        (t[61] = R),
        (t[62] = Y),
        (t[63] = ae))
...
function He(e) {
  let t = (0, Z.c)(11),
    ...
    a = r && `font-medium`,
    o;
  t[0] === a ? (o = t[1]) : ((o = y(Be, a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = r ? (0, Q.jsx)(C, { className: `icon-2xs shrink-0 opacity-75` }) : null),
      (t[4] = r),
      (t[5] = c));
  let l;
  return (
...
function We(e) {
  ...
  t[0] === i
    ? (s = t[1])
    : ((s = (0, Q.jsx)(`span`, { children: (0, Q.jsx)(v, { ...i }) })), (t[0] = i), (t[1] = s));
  let c;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(D, { className: `icon-2xs` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === s
    ? (l = t[4])
  ...
  let p;
  t[8] !== u || t[9] !== d
    ? ((p = (0, Q.jsx)(Ke, { isSelected: u, onClick: d, children: f })),
      (t[8] = u),
      (t[9] = d),
      (t[10] = p))
    : (p = t[10]);
  ...
  let _;
  t[14] !== m || t[15] !== h
    ? ((_ = (0, Q.jsx)(Ke, { isSelected: m, onClick: h, children: g })),
      (t[14] = m),
      (t[15] = h),
      (t[16] = _))
    : (_ = t[16]);
  ...
  let S;
  t[20] !== y || t[21] !== b
    ? ((S = (0, Q.jsx)(Ke, { isSelected: y, onClick: b, children: x })),
      (t[20] = y),
      (t[21] = b),
      (t[22] = S))
    : (S = t[22]);
  ...
  return (
    t[27] !== a || t[28] !== C || t[29] !== l
      ? ((w = (0, Q.jsxs)(fe, { open: a, onOpenChange: o, children: [l, C] })),
        (t[27] = a),
        (t[28] = C),
        (t[29] = l),
        (t[30] = w))
...
function Je({ conversation: e, isBackgroundSubagentsEnabled: t }) {
  return !c(e, t);
}
function Ye(e, t, n) {
  let r = G(),
...
function Xe({
  ...
  let o = e ?? [],
    s = t.filter((e) => Je({ conversation: e, isBackgroundSubagentsEnabled: a })),
    c = (0, Me.default)(
      ...
      return { kind: `remote`, key: V(e.id), at: t * 1e3, task: e };
    }),
    l = s.map((e) => {
      let t = i === `updated_at` ? e.updatedAt : e.createdAt;
      Number.isFinite(t) || p.error(`local conversation has invalid createdAt or updatedAt`);
      let n = Number.isFinite(t) ? t : Number.isFinite(e.createdAt) ? e.createdAt : 0;
      return { kind: `local`, key: H(e.id), at: n, conversation: e };
    }),
    u = n.map((e) => ({
  ...
  return [...c, ...l, ...u].sort((e, t) => t.at - e.at);
}
function Ze(e, t) {
  return e.map((e) => {
    let n = t.get(e.key);
...
var Qe = b(`recent-tasks-filter`, `recent`);
function $e(e) {
  let t = (0, Z.c)(33),
    {
      cloudtasksQuery: n,
    ...
    [h] = m(Le),
    g = l ? f : `recent`,
    y = A(`/local/:conversationId`)?.params?.conversationId ?? null,
    { data: b } = F(),
    C = pe(),
    w;
  t[0] !== h || t[1] !== l || t[2] !== b
    ? ((w = l ? (b?.find((e) => e.id === h) ?? null) : null),
      (t[0] = h),
      (t[1] = l),
      (t[2] = b),
      (t[3] = w))
  ...
  t[4] === C
    ? (T = t[5])
    : ((T = (e) => Je({ conversation: e, isBackgroundSubagentsEnabled: C })),
      (t[4] = C),
      (t[5] = T));
  let E = r.filter(T),
    D = Ye(n.data, r, ee),
    [O, k] = (0, $.useState)(``),
    j = (0, $.useDeferredValue)(O).trim().toLowerCase(),
    M = j.length > 0,
    N = D.filter(et),
    te = M
      ? N.filter((e) => {
      ...
      : N,
    ne = M ? E.filter((e) => Ie(o(e), j)) : E,
    I = M
      ? D.filter((e) =>
          e.kind === `remote`
            ? Ie(e.task.title, j)
            : e.kind === `local`
              ? Ie(o(e.conversation), j)
              : Ie(rt(e.pendingWorktree, u), j),
        )
      : D,
    re;
  t[6] !== c || t[7] !== O
    ? ((re = (0, Q.jsx)(X.Section, {
        children: (0, Q.jsx)(Re, { searchQuery: O, onQueryChange: k, autoFocus: c }),
      })),
      (t[6] = c),
      (t[7] = O),
      (t[8] = re))
  ...
  t[10] !== d || t[11] !== f || t[12] !== p || t[13] !== l
    ? ((R =
        ...
        (0, Q.jsxs)(X.Section, {
          ...
          children: [
            (0, Q.jsx)(We, { filter: f, onSelect: p }),
            f !== `local` && (0, Q.jsx)(Ve, {}),
          ],
        })),
      (t[10] = d),
        ...
        : n.isLoading
          ...
          : te.length === 0
            ? M
              ? (0, Q.jsx)(qe, {})
              : (0, Q.jsx)(ze, {})
            : te.map((e) => (0, Q.jsx)(se, { task: e.task, onClose: i }, e.key))),
    V =
      g === `local` &&
      (ne.length
        ? ne.map((e) =>
            (0, Q.jsx)(
              tt,
              { conversationId: e.id, updatedAt: e.updatedAt, isActive: y === e.id, onClose: i },
              e.id,
            ),
          )
        : M
  ...
  t[21] !== g
                  ...
                  children: [
                    ...
                    n.isPending &&
                      ...
                      (0, Q.jsx)(`div`, {
                        ...
                        children: (0, Q.jsx)(S, { className: `icon-xs` }),
                      }),
                    I.map((e) =>
                      (0, Q.jsx)(
                        nt,
                        {
                          item: e,
                          isActive: e.kind === `local` && y === e.conversation.id,
                          onClose: i,
                        },
                        e.key,
                      ),
    ...
    : (H = t[22]);
  let U;
  t[23] !== z.Section || t[24] !== B || t[25] !== V || t[26] !== H
...
var tt = (0, $.memo)(function (e) {
    let t = (0, Z.c)(7),
      { conversationId: n, updatedAt: r, isActive: i, onClose: a } = e,
      o;
    t[0] === r
      ? (o = t[1])
      : ((o = r == null ? void 0 : (0, Q.jsx)(oe, { dateString: new Date(r).toISOString() })),
        (t[0] = r),
        (t[1] = o));
    let s;
    return (
      t[2] !== n || t[3] !== i || t[4] !== a || t[5] !== o
        ? ((s = (0, Q.jsx)(le, { conversationId: n, isActive: i, metaContent: o, onClick: a })),
          (t[2] = n),
          (t[3] = i),
          (t[4] = a),
          (t[5] = o),
  ...
  nt = (0, $.memo)(function (e) {
    let t = (0, Z.c)(20),
      { item: n, isActive: r, onClose: i } = e,
      { cancelPendingWorktree: a } = K();
    switch (n.kind) {
      case `remote`: {
        let e;
        return (
          t[0] !== n.task || t[1] !== i
            ? ((e = (0, Q.jsx)(se, { task: n.task, onClose: i })),
              (t[0] = n.task),
              (t[1] = i),
              (t[2] = e))
            : (e = t[2]),
        ...
        t[3] === n.conversation.updatedAt
          ...
          : ((e =
              n.conversation.updatedAt == null
                ? void 0
                : (0, Q.jsx)(oe, { dateString: new Date(n.conversation.updatedAt).toISOString() })),
            (t[3] = n.conversation.updatedAt),
            (t[4] = e));
        let a;
        return (
...
function ot(e) {
  ...
  let b = te(g),
    C;
  t[5] === b.data ? (C = t[6]) : ((C = b.data ?? []), (t[5] = b.data), (t[6] = C));
  let T;
  t[7] === C ? (T = t[8]) : ((T = C.filter(ct)), (t[7] = C), (t[8] = T));
  let E = T,
    k,
    A,
    M,
    N;
  if (t[9] !== l || t[10] !== u || t[11] !== r || t[12] !== c.pathname || t[13] !== E.length) {
    let e;
    t[18] === u
      ? (e = t[19])
      : ((e = (e) => Je({ conversation: e, isBackgroundSubagentsEnabled: u })),
        (t[18] = u),
        (t[19] = e));
    let n = (l ?? []).filter(e).filter(st);
    ((k = E.length + n.length),
      (M = c.pathname !== `/` && k > 0),
      (A = r != null),
      (N = !1),
      ...
      (t[16] = M),
      (t[17] = N));
  } else ((k = t[14]), (A = t[15]), (M = t[16]), (N = t[17]));
  let F = N,
    ne;
  t[20] !== F || t[21] !== k || t[22] !== o
    ? ((ne = F
        ? o.formatMessage(
            {
  ...
  let I = ne,
    re;
  t[24] !== s || t[25] !== d || t[26] !== b
    ? ((re = () => {
        d && s === `chatgpt` && b.refetch();
      }),
      (t[24] = s),
      (t[25] = d),
      (t[26] = b),
    ...
    : (re = t[27]);
  let L;
  (t[28] === d ? (L = t[29]) : ((L = [d]), (t[28] = d), (t[29] = L)), (0, $.useEffect)(re, L));
  let R, z;
  ...
  let V = A ? `ghostActive` : `ghost`,
    H = A ? `default` : `icon`,
    U = A && `max-w-full min-w-0 !px-0 !py-0 hover:!bg-transparent hover:opacity-80`,
    W;
  t[33] === U ? (W = t[34]) : ((W = y(`relative`, U)), (t[33] = U), (t[34] = W));
  let ie = A ? void 0 : I,
    G;
  t[35] === F
    ? (G = t[36])
    : ((G = F
      ...
      (t[36] = G));
  let K;
  t[37] !== r || t[38] !== A || t[39] !== M
    ? ((K = A
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              (0, Q.jsx)(`span`, { className: `min-w-0 truncate`, children: r }),
              (0, Q.jsx)(D, { className: `icon-2xs shrink-0 text-token-text-tertiary` }),
            ],
          })
        : M
          ? (0, Q.jsx)(`span`, {
          ...
          : (0, Q.jsx)(ge, { className: `icon-xs hover:opacity-80` })),
      (t[37] = r),
      (t[38] = A),
      (t[39] = M),
      (t[40] = K))
  ...
  t[53] !== J
    ...
    : (Y = t[54]);
  let X;
  t[55] === l ? (X = t[56]) : ((X = l ?? []), (t[55] = l), (t[56] = X));
  let oe;
  t[57] !== m || t[58] !== d || t[59] !== b || t[60] !== a || t[61] !== X
    ? ((oe = (0, Q.jsx)($e, {
        cloudtasksQuery: b,
        localConversations: X,
        onClose: m,
        autoFocusSearch: d,
        showFilters: a,
      })),
...
function lt(e) {
  ...
  let g = Ye(m.data, h, null),
    _;
  t[29] === n
    ? (_ = t[30])
    : ((_ = y(`draggable extension:px-panel`, n)), (t[29] = n), (t[30] = _));
  let v = `justify-between`,
    b;
  t[31] === v
    ? (b = t[32])
    : ((b = y(`flex items-center electron:h-toolbar extension:py-row-y`, v)),
      (t[31] = v),
      (t[32] = b));
  let S;
  t[33] !== a || t[34] !== !1 ? ((S = null), (t[33] = a), (t[34] = !1), (t[35] = S)) : (S = t[35]);
  let C;
  t[36] !== c || t[37] !== g || t[38] !== i
    ? ((C = (0, Q.jsx)(`div`, {
        ...
        children: i
          ...
          : (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(pt, { mergedTasks: g, onBack: c, showBackButton: !0 }),
            }),
      })),
      (t[36] = c),
      (t[37] = g),
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, Q.jsx)(z, { chromeExtension: !0, children: (0, Q.jsx)(xe, {}) })), (t[41] = ee))
    : (ee = t[41]);
  let T;
  t[42] === r
    ? (T = t[43])
    : ((T = (0, Q.jsx)(ft, { conversationId: r })), (t[42] = r), (t[43] = T));
  let E;
  t[44] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(z, { extension: !0, children: (0, Q.jsx)(he, {}) })), (t[44] = E))
    : (E = t[44]);
  let D;
  t[45] === !0 ? (D = t[46]) : ((D = (0, Q.jsx)(ke, {})), (t[45] = !0), (t[46] = D));
  let k;
  t[47] !== T || t[48] !== D
    ? ((k = (0, Q.jsx)(z, {
        chromeExtension: !0,
  ...
  t[50] !== k || t[51] !== o
    ...
    : (A = t[52]);
  let M;
  t[53] !== A || t[54] !== b || t[55] !== S || t[56] !== C
    ? ((M = (0, Q.jsxs)(`div`, { className: b, children: [S, C, A] })),
      (t[53] = A),
      (t[54] = b),
      (t[55] = S),
      (t[56] = C),
    ...
    : (M = t[57]);
  let N;
  t[58] !== l || t[59] !== g || t[60] !== m
    ? ((N =
        l && (0, Q.jsx)(`div`, { children: (0, Q.jsx)(Ne, { tasksQuery: m, mergedTasks: g }) })),
      (t[58] = l),
      (t[59] = g),
      (t[60] = m),
      (t[61] = N))
  ...
  t[62] === N
    ? (P = t[63])
    : ((P = (0, Q.jsx)(z, { extension: !0, children: N })), (t[62] = N), (t[63] = P));
  let F;
  return (
    t[64] !== M || t[65] !== P || t[66] !== _
      ? ((F = (0, Q.jsxs)(`div`, { className: _, children: [M, P] })),
        (t[64] = M),
        (t[65] = P),
        (t[66] = _),
        (t[67] = F))
...
function pt(e) {
  let t = (0, Z.c)(21),
    { mergedTasks: n, onBack: r, showBackButton: a } = e,
    o = O().pathname === `/`,
    s = A(`/local/:conversationId`)?.params?.conversationId ?? null,
    c;
  t[0] === s ? (c = t[1]) : ((c = s == null ? null : h(s)), (t[0] = s), (t[1] = c));
  let l = c,
    d = A(`/remote/:taskId`)?.params?.taskId ?? null,
    { data: f } = I(d),
    p = i(u, l),
    m = i(R, l);
  if (d && f?.task?.title) {
    let e;
    t[2] !== r || t[3] !== a
      ? ((e = a ? (0, Q.jsx)(mt, { onClick: r }) : null), (t[2] = r), (t[3] = a), (t[4] = e))
      : (e = t[4]);
    let n;
    t[5] === f.task.title
      ? (n = t[6])
  ...
  if (l && p) {
    let e;
    t[10] !== r || t[11] !== a
      ? ((e = a ? (0, Q.jsx)(mt, { onClick: r }) : null), (t[10] = r), (t[11] = a), (t[12] = e))
      : (e = t[12]);
    let n;
    t[13] === m
      ? (n = t[14])
...
function mt(e) {
  let t = (0, Z.c)(7),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Q.jsx)(v, { ...ht.backButton })), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === r ? (a = t[2]) : ((a = r.formatMessage(ht.backButton)), (t[1] = r), (t[2] = a));
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(L, { className: `size-3` })), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] !== n || t[5] !== a
...
export { lt as t };
//# sourceMappingURL=header-2.js.map
