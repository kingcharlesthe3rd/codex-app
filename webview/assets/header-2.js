...
import { Xd as it, Zd as at } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
import {
  ir as ot,
  nr as st,
...
function bt(e) {
  ...
  t[9] === m
    ...
    : ((g = (0, J.jsx)(Ae, {
        tooltipContent: p,
        children: (0, J.jsx)(G, { color: `ghost`, size: `icon`, "aria-label": m, children: h }),
      })),
      (t[9] = m),
      (t[10] = g));
  let _;
    ...
    return (
      t[4] === n
        ...
        : ((a = (0, Wt.jsxs)(`div`, {
            ...
            children: [
              e,
              (0, Wt.jsx)(G, { size: `default`, color: `outline`, onClick: n, children: i }),
            ],
          })),
          (t[4] = n),
          (t[5] = a)),
...
function sn(e) {
  ...
  t[25] !== M || t[26] !== O || t[27] !== k
    ? ((N = (0, Y.jsx)(ae, {
        ...
        children: (0, Y.jsx)(Ae, {
          tooltipContent: D,
          children: (0, Y.jsx)(G, { color: `ghost`, size: O, className: k, children: M }),
        }),
      })),
      (t[25] = M),
      (t[26] = O),
  ...
  t[40] !== o || t[41] !== B
    ? ((te = (0, Y.jsx)(K.Section, {
        className: `my-1`,
        children: (0, Y.jsx)(K.SearchInput, { placeholder: B, value: o, onChange: V }),
      })),
      (t[40] = o),
      (t[41] = B),
      (t[42] = te))
...
function cn(e) {
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = r ? (0, Y.jsx)(U, { className: `icon-2xs shrink-0 opacity-75` }) : null),
      (t[4] = r),
      (t[5] = c));
  let l;
  return (
...
function mn(e) {
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = r ? (0, X.jsx)(U, { className: `icon-2xs shrink-0 opacity-75` }) : null),
      (t[4] = r),
      (t[5] = c));
  let l;
  return (
...
var On,
  kn,
  An = e(() => {
    ((On = t(ze(), 1)), s(), (kn = t(l(), 1)), O(), $e(), P(), Je(), Ve(), o(), C(), wn());
  });
function jn(e) {
  let t = (0, In.c)(33),
    {
        ...
        : n.isLoading
          ...
          : A.length === 0
            ? O
              ? (0, Z.jsx)(yn, {})
              : (0, Z.jsx)(en, {})
            : A.map((e) => (0, Z.jsx)(ft, { task: e.task, onClose: i }, e.key))),
    R =
      m === `local` &&
      (j.length
        ? j.map((e) =>
  ...
  return (
    t[2] === n
      ...
      : ((a = (0, Z.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, Z.jsx)(G, { size: `default`, color: `outline`, onClick: n, children: i }),
          ],
        })),
        (t[2] = n),
        (t[3] = a)),
  ...
  Vn = e(() => {
    ((In = d()),
      ...
      (zn = (0, Ln.memo)(function (e) {
        ...
        t[0] === r
          ? (o = t[1])
          : ((o = r == null ? void 0 : (0, Z.jsx)(E, { dateString: new Date(r).toISOString() })),
            (t[0] = r),
            (t[1] = o));
        let s;
        return (
          t[2] !== n || t[3] !== i || t[4] !== a || t[5] !== o
            ? ((s = (0, Z.jsx)(pt, { conversationId: n, isActive: i, metaContent: o, onClick: a })),
              (t[2] = n),
              (t[3] = i),
              (t[4] = a),
              (t[5] = o),
...
function Hn(e) {
  ...
  let F = C ? `ghostActive` : `ghost`,
    I = C ? `default` : `icon`,
    L = C && `max-w-full min-w-0 !px-0 !py-0 hover:!bg-transparent hover:opacity-80`,
    R;
  t[33] === L ? (R = t[34]) : ((R = _e(`relative`, L)), (t[33] = L), (t[34] = R));
  let z = C ? void 0 : O,
    B;
  t[35] === E
    ? (B = t[36])
  ...
  t[37] !== r || t[38] !== C || t[39] !== w
    ? ((V = C
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              (0, Q.jsx)(`span`, { className: _e(`min-w-0 truncate`, !1), children: r }),
              (0, Q.jsx)(ce, { className: `icon-2xs shrink-0 text-token-text-tertiary` }),
            ],
          })
        : w
          ? (0, Q.jsx)(`span`, {
...
function Jn(e) {
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(he, { extension: !0, children: (0, $.jsx)(ht, {}) })), (t[42] = w))
    : (w = t[42]);
  let T;
  ...
  t[60] === k
    ? (A = t[61])
    : ((A = (0, $.jsx)(he, { extension: !0, children: k })), (t[60] = k), (t[61] = A));
  let j;
  return (
...
function Zn(e) {
  let t = (0, $n.c)(21),
    ...
    c;
  t[0] === s ? (c = t[1]) : ((c = s == null ? null : g(s)), (t[0] = s), (t[1] = c));
  let l = c,
  ...
  if (u && d?.task?.title) {
    let e;
    t[2] !== i || t[3] !== a
      ? ((e = a ? (0, $.jsx)(Qn, { onClick: i }) : null), (t[2] = i), (t[3] = a), (t[4] = e))
      : (e = t[4]);
    let n;
    t[5] === d.task.title
      ? (n = t[6])
  ...
  if (l && f) {
    let e;
    t[10] !== i || t[11] !== a
      ? ((e = a ? (0, $.jsx)(Qn, { onClick: i }) : null), (t[10] = i), (t[11] = a), (t[12] = e))
      : (e = t[12]);
    let n;
    t[13] === p
      ? (n = t[14])
