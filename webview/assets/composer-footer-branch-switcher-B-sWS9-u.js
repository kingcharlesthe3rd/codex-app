...
import { C as m } from "./codex-api.js";
import { t as ee } from "./use-debounced-value.js";
import { i as te, n as ne } from "./use-environment.js";
...
import { t as x } from "./use-git-default-branch.js";
...
function ce(e) {
  ...
  t[10] === it
    ? (at = t[11])
    : ((at = (0, E.jsx)(_, { electron: !0, children: it })), (t[10] = it), (t[11] = at));
  let ot;
  t[12] === et
    ? (ot = t[13])
    : ((ot = (0, E.jsx)(_, { browser: !0, children: et })), (t[12] = et), (t[13] = ot));
  ...
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ft = (0, E.jsx)(p, { className: `icon-xs` })), (t[23] = ft))
    : (ft = t[23]);
  let K;
  t[24] === dt
    ? (K = t[25])
  ...
  let pt = he
      ? null
      : (0, E.jsx)(h, { collapse: `secondary`, className: `max-w-40 truncate`, children: st }),
    mt;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((mt = (0, E.jsx)(g, {
        children: (0, E.jsx)(f, { className: `icon-2xs text-token-input-placeholder-foreground` }),
      })),
      (t[26] = mt))
    : (mt = t[26]);
  let q;
...
function le(e) {
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, E.jsx)(oe, {
          borderColor: `border-token-side-bar-background`,
          children: (0, E.jsx)(p, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
  ...
  return t == null
    ...
    : (0, E.jsx)(d, {
        ...
        children: (0, E.jsxs)(c, {
          ...
          disabled: n,
          children: [
            (0, E.jsx)(p, { className: `icon-xs` }),
            (0, E.jsx)(h, { collapse: `sm`, className: `max-w-40 truncate text-sm`, children: t }),
            r
...
//# sourceMappingURL=composer-footer-branch-switcher-B-sWS9-u.js.map
