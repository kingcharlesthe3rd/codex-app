...
var nn = {
  ...
  fromPartial(e) {
    let t = tn();
    return (
      (t.type = e.type ?? ``), (t.instances = e.instances?.map((e) => en.fromPartial(e)) || []), t
    );
  },
};
function rn() {
...
var ii = {
  ...
  fromPartial(e) {
    let t = ri();
    return (
      (t.type = e.type ?? void 0), (t.colors = e.colors?.map((e) => p.fromPartial(e)) || []), t
    );
  },
};
function ai() {
...
var ho = {
  ...
  fromPartial(e) {
    let t = mo();
    return (
      (t.type = e.type ?? ``), (t.parameters = e.parameters?.map((e) => _o.fromPartial(e)) || []), t
    );
  },
};
function go() {
