...
async function u(e, t) {
  return t === `local` &&
    o(e.get, `use-copilot-auth-if-available`) &&
...
async function f(a, o, c) {
  try {
    let s = await p(a, o),
      l = a.get(r, o);
    if (l.type !== `fromConfig`) return t(null, e(l, null), s);
    let { config: u } = await i(`read-config-for-host`, {
        hostId: o,
        includeLayers: !1,
        cwd: null,
      }),
    ...
    return d.service_tier == null
      ? t(await m(o, c ?? d.model), d.service_tier, s)
...
async function m(e, t) {
  try {
    let { data: n } = await i(`list-models-for-host`, {
      hostId: e,
      includeHidden: !0,
      cursor: null,
      limit: 100,
