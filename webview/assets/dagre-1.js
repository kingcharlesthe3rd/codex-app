import { g as e, t } from "./merge-1.js";
import { w as n } from "./_baseFor-1.js";
import { i as r, n as i, r as a } from "./_baseUniq-1.js";
import {
  S as o,
  _ as s,
  a as c,
...
import { t as E } from "./graphlib-IXJD-vXw.js";
var ne = class {
  constructor() {
    var e = {};
...
function N(e, t, n, r) {
  ...
  return (arguments.length >= 4 && ((i.rank = n), (i.order = r)), k(e, `border`, i, t));
}
function P(e) {
  return S(
    s(e.nodes(), function (t) {
...
function ve(e) {
  function t(n) {
    var i = e.children(n),
      a = e.node(n);
    if ((i.length && r(i, t), Object.prototype.hasOwnProperty.call(a, `minRank`))) {
      ((a.borderLeft = []), (a.borderRight = []));
      for (var o = a.minRank, s = a.maxRank + 1; o < s; ++o)
        (F(e, `borderLeft`, `_bl`, n, a, o), F(e, `borderRight`, `_br`, n, a, o));
    }
  }
  r(e.children(), t);
}
...
function be(e) {
  var t = e.graph().rankdir.toLowerCase();
  ((t === `bt` || t === `rl`) && Ce(e), (t === `lr` || t === `rl`) && (we(e), xe(e)));
}
function xe(e) {
...
function Oe(e, t) {
  function n(i) {
    r(t.nodeEdges(i), function (r) {
      var a = r.v,
        o = i === a ? r.w : a;
      !e.hasNode(o) && !z(t, r) && (e.setNode(o, {}), e.setEdge(i, o, {}), n(o));
    });
  }
...
function je(e) {
  ...
  function a(o) {
    ...
    Object.prototype.hasOwnProperty.call(t, o) ||
      ((n[o] = !0), (t[o] = !0), r(e.predecessors(o), a), delete n[o], i.push(o));
  }
    ...
    r(e.nodes(), function (o) {
      ...
      (s.rank === t || (s.minRank <= t && t <= s.maxRank)) &&
        ...
        Object.prototype.hasOwnProperty.call(s, `minRank`) &&
          a.setNode(o, { borderLeft: s.borderLeft[t], borderRight: s.borderRight[t] }));
    }),
    a
  );
}
...
function nt(e) {
  ...
  function n(e) {
    return function (t) {
      t.merged ||
        ((f(t.barycenter) || f(e.barycenter) || t.barycenter >= e.barycenter) && rt(e, t));
    };
  }
  function i(t) {
    return function (n) {
...
function st(e, t, n, i) {
  ...
  r(d, function (t) {
    if (e.children(t.v).length) {
      var r = st(e, t.v, n, i);
      ((u[t.v] = r), Object.prototype.hasOwnProperty.call(r, `barycenter`) && lt(t, r));
    }
  });
  var f = tt(d, n);
  ct(f, u);
  ...
  if (c && ((p.vs = w([c, p.vs, l])), e.predecessors(c).length)) {
    ...
    (Object.prototype.hasOwnProperty.call(p, `barycenter`) || ((p.barycenter = 0), (p.weight = 0)),
      (p.barycenter = (p.barycenter * p.weight + m.order + h.order) / (p.weight + 2)),
      (p.weight += 2));
  }
  return p;
}
    ...
    return (
      r(n, function (r, c) {
        if (e.node(r).dummy === `border`) {
          ...
          l.length && ((o = e.node(l[0]).order), a(n, s, c, i, o), (s = c), (i = o));
        }
    ...
    r(t, function (e) {
      ...
      r(e, function (e) {
        ...
        if (r.length) {
          ...
          for (var c = (r.length - 1) / 2, l = Math.floor(c), u = Math.ceil(c); l <= u; ++l) {
            var d = r[l];
            o[e] === e &&
              t < s[d] &&
              !bt(n, e, d) &&
...
function Gt(e) {
  r(e.edges(), function (t) {
    ...
    if (n.width && n.height) {
      var r = e.node(t.v);
      k(e, `edge-proxy`, { rank: (e.node(t.w).rank - r.rank) / 2 + r.rank, e: t }, `_ep`);
    }
  });
}
function Kt(e) {
