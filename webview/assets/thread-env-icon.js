...
import { a as n, n as r } from "./use-host-config-C.js";
import { s as i } from "./lib-1.js";
import { t as a } from "./clsx.js";
import { t as o } from "./tooltip-B.js";
import { t as s } from "./remote-host-globe-icon-B5-baJXK.js";
...
function p(e) {
  let t = (0, d.c)(12),
    { className: i, disableTooltip: o, hostId: c } = e,
    l = o === void 0 ? !1 : o,
    u = r(c),
    p = n(),
    h;
  t[0] === i ? (h = t[1]) : ((h = a(`icon-2xs no-drag shrink-0`, i)), (t[0] = i), (t[1] = h));
  let g;
  t[2] === p ? (g = t[3]) : ((g = p.map(m)), (t[2] = p), (t[3] = g));
  let _;
  t[4] !== c || t[5] !== h || t[6] !== g
    ? ((_ = (0, f.jsx)(`span`, {
  ...
  let v;
  return (
    t[8] !== l || t[9] !== u.display_name || t[10] !== _
...
function h(e) {
  ...
  t[0] === i ? (h = t[1]) : ((h = a(`icon-2xs no-drag shrink-0`, i)), (t[0] = i), (t[1] = h));
  let _;
  t[2] === m ? (_ = t[3]) : ((_ = m.map(g)), (t[2] = m), (t[3] = _));
  let v;
  t[4] !== c || t[5] !== h || t[6] !== _
    ? ((v = (0, f.jsx)(s, { className: h, hostId: c, hostIdsForColorAssignment: _ })),
      (t[4] = c),
      (t[5] = h),
      (t[6] = _),
      (t[7] = v))
  ...
  t[8] === i
    ? (y = t[9])
    : ((y = a(`icon-2xs text-token-description-foreground no-drag shrink-0`, i)),
      (t[8] = i),
      (t[9] = y));
  let x;
  t[10] === y ? (x = t[11]) : ((x = (0, f.jsx)(u, { className: y })), (t[10] = y), (t[11] = x));
  let S;
  t[12] !== v || t[13] !== x
    ? ((S = (0, f.jsxs)(`span`, {
  ...
  let C;
  return (
    t[15] !== l || t[16] !== p.display_name || t[17] !== S
...
function _(e) {
  ...
  t[0] === n
    ? (s = t[1])
    : ((s = a(`icon-2xs text-token-description-foreground no-drag shrink-0`, n)),
      (t[0] = n),
      (t[1] = s));
  let c;
  t[2] === s
...
function v(e) {
  ...
  t[0] === n
    ? (s = t[1])
    : ((s = a(`icon-2xs translate-x-px text-token-description-foreground no-drag shrink-0`, n)),
      (t[0] = n),
      (t[1] = s));
  let l;
  t[2] === s
