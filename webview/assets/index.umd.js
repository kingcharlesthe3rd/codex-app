              ...
              : function (e, t) {
                  return (
                    ...
                    new Promise(function (n, r) {
                      ...
                      for (var a in (i.open(t.method || `get`, e, !0), t.headers))
        ...
        t.default = (function (e) {
          function t(e, n) {
            ...
            return (
              (r.authToken = n),
              (r.player = e),
              (r.metadata = { content: {}, playback: { videoPlayer: `Vimeo` } }),
                ...
                value: function (e) {
                  ...
                  return new Promise(function (n, r) {
                    ...
                    (0, i.default)(`https://api.vimeo.com/videos/` + a, {
                      ...
                      .catch(function (e) {
                        return (console.error(`Request to Vimeo API Failed with: `, e), r(e));
                      });
                  });
                },
              },
        ...
        var s = (function (e) {
          function t(e, n) {
            ...
            return (
              ...
              (r.isBuffering = !1),
              (r.isSeeking = !1),
              (r.lastRecordedTime = { timeReported: Date.now(), timeElapsed: 0 }),
              (r.metadata = [{ playback: { video_player: `youtube` }, content: {} }]),
              (r.playlistIndex = 0),
              r
            );
          }
                    ...
                    (0, i.default)(
                      ...
                      .then(function (n) {
                        ...
                        for (i = 0; i < a.length; i++)
                          e.metadata[i].playback = { total_length: r, video_player: `youtube` };
                        t();
                      })
                      .catch(function (t) {
