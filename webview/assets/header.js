...
import { c as o, f as s, m as c } from "./vscode-api.js";
import { n as l } from "./react.js";
import { Lr as u } from "./src-4.js";
import {
  Ai as d,
  Ds as f,
  T as p,
...
import { c as y, o as b, r as x } from "./lib-1.js";
...
import { o as k } from "./statsig-DoZ-0xit.js";
import { s as A } from "./app-server-manager-hooks.js";
import { A as j, M } from "./sidebar-signals.js";
import { t as N } from "./use-auth.js";
import { f as P, m as F, p as I } from "./chunk-8.js";
import { D as L, O as R, m as z, w as B } from "./codex-api.js";
import { i as V } from "./use-environment.js";
import { t as H } from "./x.js";
import { n as U } from "./local-conversation-title-signals.js";
import { t as W } from "./with-window.js";
import { t as G } from "./settings.cog.js";
import { r as ee } from "./run-command.js";
import { n as K } from "./use-start-new-conversation.js";
import { i as te, r as q } from "./pending-worktree-store.js";
import { a as ne } from "./command-keybindings.js";
import { t as J } from "./arrow-left.js";
import { t as Y } from "./compose.js";
import { a as re, r as X, t as ie } from "./dropdown.js";
import { i as ae, n as oe, t as se } from "./popover.js";
import { t as ce } from "./chevron.js";
import { t as le } from "./format-relative-date-time.js";
import { d as ue, i as de, t as fe, u as pe } from "./profile-dropdown.js";
...
function _e() {
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(b, { ...ve.newChat })), (e[2] = s))
    : (s = e[2]);
  let c;
  e[3] === n ? (c = e[4]) : ((c = n.formatMessage(ve.newChat)), (e[3] = n), (e[4] = c));
  let l;
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(Y, { className: `icon-xs` })), (e[5] = l))
    : (l = e[5]);
  let u;
  e[6] !== o || e[7] !== c
    ? ((u = (0, Q.jsx)(w, {
  ...
  return (
    e[9] !== r || e[10] !== u
      ? ((d = (0, Q.jsx)(O, { tooltipContent: s, shortcut: r, children: u })),
        (e[9] = r),
        (e[10] = u),
        (e[11] = d))
      : (d = e[11]),
...
function xe(e) {
  let t = (0, Z.c)(23),
    ...
    i = F(),
    a = P(),
    { cancelPendingWorktree: s } = q();
  if (r.isLoading && n.length === 0) return null;
  let c = r.error instanceof o && r.error.status === 404;
  ...
  let l;
  t[6] === n ? (l = t[7]) : (n.filter(Ce), (l = n), (t[6] = n), (t[7] = l));
  let u = l,
    d;
  if (t[8] !== s || t[9] !== a || t[10] !== i || t[11] !== u) {
    let e;
    ...
    ? ((u =
        n.length > 0
          ? (0, Q.jsx)(`button`, {
              ...
              children: (0, Q.jsx)(H, { className: `icon-2xs` }),
            })
          : null),
      (t[5] = o),
      (t[6] = r),
...
function ke(e) {
  let t = (0, Z.c)(64),
    ...
    [c, u] = l(Te),
    d = V(),
    { data: f, isLoading: p, isError: m, refetch: h } = R(),
    g;
  t[0] === o ? (g = t[1]) : ((g = o.trim()), (t[0] = o), (t[1] = g));
  let _ = g.length > 0,
    v;
  t[2] === _ ? (v = t[3]) : ((v = { enabled: _ }), (t[2] = _), (t[3] = v));
  let { data: x, isLoading: C, isError: E, refetch: D } = z(o, v),
    k;
  if (t[4] !== o || t[5] !== f || t[6] !== x || t[7] !== d) {
    bb0: {
      let e = o.trim(),
        n = e.length > 0 ? (x ?? []) : (f ?? []);
      if (e.length === 0 && d) {
    ...
    ((t[4] = o), (t[5] = f), (t[6] = x), (t[7] = d), (t[8] = k));
  } else k = t[8];
  let A = k,
    j;
  t[13] !== c || t[14] !== f
    ? ((j = f?.find((e) => e.id === c) ?? null), (t[13] = c), (t[14] = f), (t[15] = j))
    : (j = t[15]);
  let M = j,
    N;
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, Q.jsx)(b, {
      ...
      (t[16] = N))
    : (N = t[16]);
  let P = c ? `default` : `icon`,
    F;
  t[17] === n ? (F = t[18]) : ((F = S(`mr-1`, n)), (t[17] = n), (t[18] = F));
  let I;
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (0, Q.jsx)(ge, { className: `icon-2xs` })), (t[19] = I))
    : (I = t[19]);
  let L;
  t[20] !== c || t[21] !== M
    ? ((L = !!c && M?.label && (0, Q.jsx)(`span`, { className: `text-sm`, children: M.label })),
      (t[20] = c),
      (t[21] = M),
      (t[22] = L))
    : (L = t[22]);
  ...
  t[23] === L
    ? (B = t[24])
    : ((B = (0, Q.jsxs)(`span`, { className: `flex items-center gap-1.5`, children: [I, L] })),
      (t[23] = L),
      (t[24] = B));
  let H;
  t[25] !== B || t[26] !== P || t[27] !== F
    ? ((H = (0, Q.jsx)(ae, {
        asChild: !0,
        children: (0, Q.jsx)(O, {
          tooltipContent: N,
          children: (0, Q.jsx)(w, { color: `ghost`, size: P, className: F, children: B }),
        }),
      })),
      (t[25] = B),
      (t[26] = P),
  ...
  let K;
  t[33] !== W || t[34] !== G
    ? ((K = (0, Q.jsx)(Ae, { isSelected: W, onClick: G, children: ee })),
      (t[33] = W),
      (t[34] = G),
      (t[35] = K))
    : (K = t[35]);
  ...
  t[36] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((te = (0, Q.jsx)(X.Separator, {})), (t[36] = te))
    : (te = t[36]);
  let q;
  t[37] === r
    ? (q = t[38])
  ...
  t[40] !== o || t[41] !== q
    ? ((J = (0, Q.jsx)(X.Section, {
        className: `my-1`,
        children: (0, Q.jsx)(X.SearchInput, { placeholder: q, value: o, onChange: ne }),
      })),
      (t[40] = o),
      (t[41] = q),
      (t[42] = J))
  ...
  let ce;
  return (
    t[60] !== i || t[61] !== H || t[62] !== ie
      ? ((ce = (0, Q.jsxs)(se, { open: i, onOpenChange: a, children: [H, ie] })),
        (t[60] = i),
        (t[61] = H),
        (t[62] = ie),
        (t[63] = ce))
...
function Me(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(ce, { className: `icon-2xs` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === s
    ? (l = t[4])
  ...
  let S;
  t[20] !== v || t[21] !== y
    ? ((S = (0, Q.jsx)(Pe, { isSelected: v, onClick: y, children: x })),
      (t[20] = v),
      (t[21] = y),
      (t[22] = S))
    : (S = t[22]);
  ...
  return (
    t[27] !== a || t[28] !== C || t[29] !== l
      ? ((w = (0, Q.jsxs)(se, { open: a, onOpenChange: o, children: [l, C] })),
        (t[27] = a),
        (t[28] = C),
        (t[29] = l),
        (t[30] = w))
...
function Re({
  ...
  let o = e ?? [],
    s = t.filter((e) => Ie({ conversation: e, isBackgroundSubagentsEnabled: a })),
    l = (0, be.default)(
      ...
      return { kind: `remote`, key: _(e.id), at: t * 1e3, task: e };
    }),
    u = s.map((e) => {
      let t = i === `updated_at` ? e.updatedAt : e.createdAt;
      Number.isFinite(t) || c.error(`local conversation has invalid createdAt or updatedAt`);
      let n = Number.isFinite(t) ? t : Number.isFinite(e.createdAt) ? e.createdAt : 0;
      return { kind: `local`, key: v(e.id), at: n, conversation: e };
    }),
    d = n.map((e) => ({
...
function Ve(e) {
  let t = (0, Z.c)(31),
    ...
    [u, f] = l(Be),
    [p] = l(Te),
    m = I(`/local/:conversationId`)?.params?.conversationId ?? null,
    { data: h } = R(),
    g = me(),
    _;
  t[0] !== p || t[1] !== h
    ? ((_ = h?.find((e) => e.id === p) ?? null), (t[0] = p), (t[1] = h), (t[2] = _))
    : (_ = t[2]);
  let v = _,
    x;
  t[3] === g
    ? (x = t[4])
    : ((x = (e) => Ie({ conversation: e, isBackgroundSubagentsEnabled: g })),
      (t[3] = g),
      (t[4] = x));
  let S = r.filter(x),
    C = Le(n.data, r, v),
    ...
    j = k
      ...
      : A,
    M = k ? S.filter((e) => we(d(e), O)) : S,
    P = k
      ? C.filter((e) =>
          e.kind === `remote`
            ? we(e.task.title, O)
            : e.kind === `local`
              ? we(d(e.conversation), O)
  ...
  t[9] !== c || t[10] !== u || t[11] !== f
    ? ((z =
        ...
        (0, Q.jsxs)(X.Section, {
          ...
          children: [
            (0, Q.jsx)(Me, { filter: u, onSelect: f }),
            u !== `local` && (0, Q.jsx)(ke, {}),
          ],
        })),
      (t[9] = c),
        ...
        : n.isLoading
          ...
          : j.length === 0
            ? k
              ? (0, Q.jsx)(Fe, {})
              : (0, Q.jsx)(De, {})
            : j.map((e) => (0, Q.jsx)(ue, { task: e.task, onClose: i }, e.key))),
    H =
      u === `local` &&
      (M.length
        ? M.map((e) =>
            (0, Q.jsx)(
              Ue,
              { conversationId: e.id, updatedAt: e.updatedAt, isActive: m === e.id, onClose: i },
              e.id,
            ),
          )
        : k
  ...
  t[19] !== i
                  ...
                  children: [
                    ...
                    P.map((e) =>
                      (0, Q.jsx)(
                        ...
                        {
                          item: e,
                          isActive: e.kind === `local` && m === e.conversation.id,
                          onClose: i,
                        },
                        e.key,
                      ),
    ...
    : (U = t[20]);
  let W;
  t[21] !== V || t[22] !== H || t[23] !== U || t[24] !== B.Section
    ? ((W = (0, Q.jsxs)(B.Section, {
...
var Ue = (0, $.memo)(function (e) {
    ...
    t[0] === r
      ? (o = t[1])
      : ((o = r == null ? void 0 : (0, Q.jsx)(le, { dateString: new Date(r).toISOString() })),
        (t[0] = r),
        (t[1] = o));
    let s;
    return (
      t[2] !== n || t[3] !== i || t[4] !== a || t[5] !== o
        ? ((s = (0, Q.jsx)(de, { conversationId: n, isActive: i, metaContent: o, onClick: a })),
          (t[2] = n),
          (t[3] = i),
          (t[4] = a),
          (t[5] = o),
  ...
  We = (0, $.memo)(function (e) {
    let t = (0, Z.c)(20),
      ...
      { cancelPendingWorktree: a } = q();
    switch (n.kind) {
      case `remote`: {
        let e;
        return (
          t[0] !== n.task || t[1] !== i
            ? ((e = (0, Q.jsx)(ue, { task: n.task, onClose: i })),
              (t[0] = n.task),
              (t[1] = i),
              (t[2] = e))
            : (e = t[2]),
        ...
        t[3] === n.conversation.updatedAt
          ...
          : ((e =
              n.conversation.updatedAt == null
                ? void 0
                : (0, Q.jsx)(le, { dateString: new Date(n.conversation.updatedAt).toISOString() })),
            (t[3] = n.conversation.updatedAt),
            (t[4] = e));
        let a;
        return (
...
function Ze(e) {
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(W, { chromeExtension: !0, children: (0, Q.jsx)(et, {}) })), (t[17] = E))
    : (E = t[17]);
  let D;
  t[18] === r
    ? (D = t[19])
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, Q.jsx)(W, { extension: !0, children: (0, Q.jsx)(fe, {}) })), (t[20] = O))
    : (O = t[20]);
  let k;
  ...
  t[26] !== j || t[27] !== o
    ...
    : (M = t[28]);
  let N;
  t[29] !== M || t[30] !== y || t[31] !== b || t[32] !== x
    ? ((N = (0, Q.jsxs)(`div`, { className: y, children: [b, x, M] })),
      (t[29] = M),
      (t[30] = y),
      (t[31] = b),
      (t[32] = x),
  ...
  t[38] === F
    ? (I = t[39])
    : ((I = (0, Q.jsx)(W, { extension: !0, children: F })), (t[38] = F), (t[39] = I));
  let R;
  return (
    t[40] !== N || t[41] !== I || t[42] !== _
      ? ((R = (0, Q.jsxs)(`div`, { className: _, children: [N, I] })),
        (t[40] = N),
        (t[41] = I),
        (t[42] = _),
        (t[43] = R))
...
function $e() {
  ee(`newThread`, `header_new_thread`);
}
function et() {
  let e = (0, Z.c)(6),
    t = y(),
    ...
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(b, { ...at.openCodexAppSettings })), (e[0] = r))
    : (r = e[0]);
  let i;
  e[1] === t
    ? (i = e[2])
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Q.jsx)(G, { className: `icon-xs` })), (e[3] = a))
    : (a = e[3]);
  let o;
  return (
    e[4] === i
...
function tt() {
  s.dispatchMessage(`open-in-browser`, { url: `codex://settings` });
}
function nt(e) {
  (0, Z.c)(9);
...
function rt(e) {
  let t = (0, Z.c)(21),
    ...
    o = P().pathname === `/`,
    s = I(`/local/:conversationId`)?.params?.conversationId ?? null,
    c;
  t[0] === s ? (c = t[1]) : ((c = s == null ? null : u(s)), (t[0] = s), (t[1] = c));
  let l = c,
    d = I(`/remote/:taskId`)?.params?.taskId ?? null,
    { data: f } = B(d),
    m = i(p, l),
    h = i(U, l);
  if (d && f?.task?.title) {
    let e;
    t[2] !== r || t[3] !== a
      ? ((e = a ? (0, Q.jsx)(it, { onClick: r }) : null), (t[2] = r), (t[3] = a), (t[4] = e))
      : (e = t[4]);
    let n;
    t[5] === f.task.title
      ? (n = t[6])
  ...
  if (l && m) {
    let e;
    t[10] !== r || t[11] !== a
      ? ((e = a ? (0, Q.jsx)(it, { onClick: r }) : null), (t[10] = r), (t[11] = a), (t[12] = e))
      : (e = t[12]);
    let n;
    t[13] === h
      ? (n = t[14])
...
function it(e) {
  let t = (0, Z.c)(7),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Q.jsx)(b, { ...at.backButton })), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === r ? (a = t[2]) : ((a = r.formatMessage(at.backButton)), (t[1] = r), (t[2] = a));
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(J, { className: `size-3` })), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] !== n || t[5] !== a
