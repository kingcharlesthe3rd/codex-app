...
function ke(e) {
  return At[e === `none` ? `minimal` : e];
}
function Ae(e) {
  return `file-tree-builtin-${e}`;
}
function je(e) {
  return e !== `none` && Ft.has(e);
}
function Me(e, t, n) {
  if (e === `minimal` || e === `none`) return;
  let r = e === `complete`,
    i = jt[t.toLowerCase()];
  if (i != null && (r || Pt.has(i))) return i;
  for (let e of n) {
    if (r) {
      let t = Nt[e];
      if (t != null) return t;
...
var Ne,
  ...
  Ft,
  It = e(() => {
    ((Ne = `<svg data-icon-sprite aria-hidden="true" width="0" height="0">
  ...
  <symbol id="file-tree-icon-ellipsis" viewBox="0 0 16 16">
    <path d="M5 8.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0M9.5 8.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0M14 8.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0" />
      ...
      (Pe = `<symbol id="file-tree-builtin-astro" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M2.5 11.1s1.86-.9 3.72-.9l1.4-4.39c.05-.21.2-.36.38-.36s.33.15.38.36l1.4 4.38c2.2 0 3.72.92 3.72.92l-3.16-8.69q-.13-.4-.45-.42H6.11q-.3.02-.45.42z" class="fg"/>
      ...
      (Fe = `<symbol id="file-tree-builtin-babel" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M9.49.5q1.92.05 2.66.54 1.27.6 1.35 1.52v.23a4 4 0 0 1-.53 1.9l-1.38 1.24q-.74.38-.72.63c.77.82 1.33 1.29.85 2.42q-.47 1.1-2.04 2.28c-.5.32-1.88 1.35-2.96 1.86-1.64.77-3.1 1.4-4.65 1.89-.51.16-1.5.16-1.5.16L.5 15A76 76 0 0 0 5.76 3.49q-.1-.08-.1-.2.1 0 .32-.35l-.03-.09q-1.17.39-2.38 1.3l-.13.03q0-.1-.21-.16-.46.31-.82.7l-.13-.19.16-.06-.03-.16-.34.29L2 4.5q.36-.48.72-.54l.04-.1V3.8q.16 0 .15-.06l.13-.06a6 6 0 0 0 1.13-.9v-.03H4.1l-.12.07q0-.1-.1-.1l-.15.07-.04-.1q.93-.52 1.63-1.05Q7.89.65 9.5.5M8.46 7.83l-.32.04c-1.31.54-2.31.82-2.91.88a71 71 0 0 0-2.2 4.54h.07q.58-.04 3.04-1.42.13 0 1.66-1.05L9.18 9.7v.03q.45-.2.81-1.3v-.2q-.5-.46-1.53-.4m.28-5.75c-.5.1-.75.19-.72.38l-1.16 2.6q-.17.1-.34.95-.3.48-.25.77v.1l.22.05A15 15 0 0 1 8.86 6c1.1-.71 2.12-1.38 2.8-2.54q.24-.33.21-.54-.02-.33-.4-.54c-.54 0-1.07-.34-1.63-.28l-.94-.03z" clip-rule="evenodd"/>
      ...
      (Ie = `<symbol id="file-tree-builtin-bash" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M11.5 11a.5.5 0 0 1 0 1h-3a.5.5 0 0 1 0-1zM7 6.75C7 6.42 6.64 6 6 6s-1 .42-1 .75q-.01.25.22.41.26.21.89.35.74.14 1.28.53c.37.29.61.7.61 1.21 0 .87-.68 1.5-1.5 1.7v.55a.5.5 0 0 1-1 0v-.56c-.82-.18-1.5-.82-1.5-1.69a.5.5 0 0 1 1 0c0 .33.36.75 1 .75s1-.42 1-.75q.01-.25-.22-.41a2 2 0 0 0-.89-.35q-.74-.14-1.28-.53A1.5 1.5 0 0 1 4 6.75c0-.87.68-1.5 1.5-1.7V4.5a.5.5 0 0 1 1 0v.56c.82.18 1.5.82 1.5 1.69a.5.5 0 0 1-1 0" class="fg-stroke"/>
      ...
      (Le = `<symbol id="file-tree-builtin-biome" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8 2 4.88 7.35a7 7 0 0 1 3.7-.13l1.04.25-.99 4.16-1.05-.25a2.7 2.7 0 0 0-3.07 1.45l-.98-.47a4 4 0 0 1 1.07-1.31 3.8 3.8 0 0 1 3.23-.71l.5-2.08a6 6 0 0 0-5.07 1.12A5.9 5.9 0 0 0 1 14h14z"/>
      ...
      (Re = `<symbol id="file-tree-builtin-bootstrap" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" fill-rule="evenodd" d="M8.47 4.54c1.23 0 2.04.68 2.04 1.73 0 .73-.55 1.39-1.24 1.5v.04c.94.1 1.58.77 1.58 1.7 0 1.2-.9 1.95-2.37 1.95H5.97a.3.3 0 0 1-.2-.08.3.3 0 0 1-.08-.2V4.82a.3.3 0 0 1 .08-.2.3.3 0 0 1 .2-.08zm-1.7 6.04h1.49q1.47-.01 1.49-1.15Q9.74 8.31 8.2 8.3H6.77zm0-5.16v2.06h1.21c.93 0 1.45-.38 1.45-1.06 0-.65-.44-1-1.22-1z" class="fg" clip-rule="evenodd"/>
      ...
      (ze = `<symbol id="file-tree-builtin-browserslist" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M10.36 5.18a.4.4 0 0 0-.03.38c.09.2.3.3.46.23s.24-.3.15-.5l-.01-.02q.23.13.34.39a.83.83 0 0 1-.43 1.08.8.8 0 0 1-1.08-.43.83.83 0 0 1 .6-1.13"/>
      ...
      (Be = `<symbol id="file-tree-builtin-bun" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8 14c3.87 0 7-2.46 7-5.49 0-1.88-1.2-3.53-3.04-4.52q-1.1-.61-1.84-1.07C9.2 2.35 8.64 2 8 2s-1.36.45-2.31 1.03A29 29 0 0 1 4.04 4C2.2 4.98 1 6.63 1 8.51 1 11.54 4.13 14 8 14M7.18 3.88q.3-.66.3-1.37c0-.08.11-.1.13-.01.38 1.57-.53 2.35-1.2 2.61-.08.03-.12-.07-.06-.12a3 3 0 0 0 .83-1.12m1.2-.05a3 3 0 0 0-.45-1.3V2.5c-.04-.07.05-.15.1-.1 1.15 1.2.77 2.3.33 2.87-.05.05-.13 0-.11-.08q.21-.67.13-1.37m1.04-.32a3 3 0 0 0-.94-1.02v-.01c-.06-.05-.01-.16.07-.12 1.51.61 1.61 1.8 1.43 2.5l-.03.03a.07.07 0 0 1-.1-.06 3 3 0 0 0-.43-1.32m-2.97.32c-.36.3-.74.43-1.2.56q-.11 0-.1-.1a3.5 3.5 0 0 0 1.76-1.57s.09-.07.1.04c0 .18-.2.76-.56 1.07m2.89 6.36q-.13.52-.55.88a1.3 1.3 0 0 1-.75.35 1.3 1.3 0 0 1-.77-.35 1.7 1.7 0 0 1-.54-.88.13.13 0 0 1 .15-.15h2.31a.14.14 0 0 1 .15.15M6.15 8.95a1.1 1.1 0 0 1-1.39-.14A1.1 1.1 0 0 1 5.12 7a1.1 1.1 0 0 1 1.2.25 1.1 1.1 0 0 1-.17 1.69m4.96 0a1.1 1.1 0 0 1-1.4-.14 1.1 1.1 0 0 1 .37-1.8 1.1 1.1 0 0 1 1.2.25 1.1 1.1 0 0 1 .24 1.2 1 1 0 0 1-.41.5"/>
      ...
      (Ve = `<symbol id="file-tree-builtin-c" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M8 1q.084 0 .166.021.098.023.186.075c1.055.624 4.22 2.486 5.277 3.11.085.05.15.112.209.192h-.002l.028.037a.5.5 0 0 1 .103.21q.031.102.033.21v6.29a.71.71 0 0 1-.347.616l-5.307 3.144a.68.68 0 0 1-.693 0l-5.307-3.144A.72.72 0 0 1 2 11.145V4.832a.71.71 0 0 1 .346-.612l5.288-3.126A.7.7 0 0 1 7.992 1zm2.901 4.349a3.75 3.75 0 1 0 0 5.302l-1.06-1.06a2.25 2.25 0 1 1 0-3.182z" clip-rule="evenodd"/>
      ...
      (He = `<symbol id="file-tree-builtin-claude" viewBox="0 0 16 16">
  <path fill="currentColor" d="M3.75 10.31 6.5 8.77l.04-.14-.04-.07h-.14l-.46-.03-1.57-.04-1.38-.07-1.33-.07-.34-.07L1 7.86l.03-.21.28-.18.4.03.89.07 1.33.08.97.06 1.43.16h.22l.03-.1-.07-.05-.06-.06-1.39-.92-1.48-.98-.79-.57-.42-.28-.2-.28-.1-.6.39-.41.52.04.12.03.52.4 1.12.86L6.2 6.04l.2.17.09-.06.01-.04-.1-.15-.76-1.46-.85-1.46-.37-.6-.1-.36a1 1 0 0 1-.06-.42l.42-.59.25-.07.6.08.22.2.36.84.58 1.3.9 1.77.29.53.14.47.04.14h.1v-.07l.07-1 .14-1.22.14-1.57.04-.45.23-.53.42-.28.36.15.28.41-.04.25-.16 1.08-.36 1.7-.21 1.14h.12l.14-.15.58-.76.97-1.2.42-.5.5-.51.32-.25h.6l.44.66-.2.68-.61.79-.52.65-.74 1-.45.8.04.05h.1l1.68-.36.9-.16 1.06-.18.5.23.05.22-.2.48-1.15.28-1.34.28-2 .46-.04.01.03.04.9.09.4.03h.94l1.77.14.46.28.27.37-.04.28-.72.37-.95-.23-2.24-.53-.76-.18h-.11v.06l.64.63L12 10.86l1.48 1.35.07.34-.18.28-.2-.03-1.29-.98-.5-.42-1.12-.95h-.07v.1l.25.38 1.37 2.05.07.63-.1.2-.36.14-.38-.08-.8-1.12-.85-1.26-.66-1.15-.07.05-.4 4.23-.19.21-.42.17-.35-.28-.2-.42.2-.87.23-1.12.18-.9.17-1.1.1-.36v-.03h-.1l-.84 1.16-1.27 1.72-1 1.07-.24.1-.42-.22.04-.39.22-.32 1.4-1.8.84-1.1.57-.64-.02-.07h-.04l-3.7 2.4-.66.09-.28-.28.03-.42.14-.14 1.12-.77z"/>
      ...
      (Ue = `<symbol id="file-tree-builtin-cpp" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M8 1q.084 0 .166.021.098.023.186.075c1.055.624 4.22 2.486 5.277 3.11.085.05.15.112.209.192h-.002l.028.037a.5.5 0 0 1 .103.21q.031.102.033.21v6.29a.71.71 0 0 1-.347.616l-5.307 3.144a.68.68 0 0 1-.693 0l-5.307-3.144A.72.72 0 0 1 2 11.145V4.832a.71.71 0 0 1 .346-.612l5.288-3.126A.7.7 0 0 1 7.992 1zm2.901 4.349a3.75 3.75 0 1 0 0 5.302l-1.06-1.06a2.25 2.25 0 1 1 0-3.182z" clip-rule="evenodd"/>
</symbol>`),
      (We = `<symbol id="file-tree-builtin-css" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M10.1 9.19h.73c.03.49.22.6 1 .6.76 0 .93-.12.93-.68 0-.52-.17-.67-.94-.85-1.38-.3-1.68-.56-1.68-1.47 0-1.05.3-1.29 1.67-1.29 1.29 0 1.57.2 1.6 1.13h-.74c-.01-.34-.17-.42-.85-.42-.77 0-.94.1-.94.58 0 .42.17.55.96.73 1.36.3 1.66.58 1.66 1.59 0 1.14-.31 1.39-1.73 1.39-1.39 0-1.69-.24-1.67-1.31m-3.9 0h.74c.03.49.21.6.99.6.76 0 .93-.12.93-.68 0-.52-.17-.67-.93-.85-1.39-.3-1.69-.56-1.69-1.47 0-1.05.3-1.29 1.67-1.29 1.3 0 1.58.2 1.6 1.13h-.73c-.02-.34-.18-.42-.85-.42-.78 0-.95.1-.95.58 0 .42.17.55.96.73 1.37.3 1.67.58 1.67 1.59 0 1.14-.32 1.39-1.74 1.39-1.38 0-1.68-.24-1.66-1.31m-1.22 0h.75c-.09 1.07-.37 1.31-1.56 1.31-1.37 0-1.68-.45-1.68-2.5 0-1.96.36-2.5 1.68-2.5 1.16 0 1.44.25 1.52 1.35h-.76c-.08-.52-.22-.64-.76-.64-.74 0-.9.33-.9 1.78 0 1.47.16 1.8.9 1.8.58 0 .74-.11.8-.6"/>
      ...
      (L = `<symbol id="file-tree-builtin-database" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M8 1c1.533 0 2.73.082 3.669.291.933.207 1.58.533 2.044.996.403.404.904.944.91 1.695.004.764-.509 1.318-.918 1.727-.463.463-1.11.789-2.042.996-.938.209-2.135.291-3.667.291-1.531 0-2.729-.082-3.667-.29-.932-.208-1.579-.534-2.042-.997-.406-.406-.915-.953-.915-1.71 0-.758.509-1.305.915-1.712.464-.463 1.11-.789 2.044-.996C5.27 1.082 6.467 1 8 1"/>
      ...
      (Ge = `<symbol id="file-tree-builtin-default" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M9.5 1a.5.5 0 0 1 .354.146l4 4A.5.5 0 0 1 14 5.5V6h-3a2 2 0 0 1-2-2V1z" class="fg"/>
      ...
      (Ke = `<symbol id="file-tree-builtin-docker" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M1.48 7.36h1.4a.14.14 0 0 0 .14-.13V5.91q-.01-.12-.13-.14H1.48a.13.13 0 0 0-.13.14v1.32q.02.13.13.13m1.94 0h1.41a.14.14 0 0 0 .13-.13V5.91q-.01-.12-.13-.14h-1.4a.13.13 0 0 0-.13.14v1.32q0 .13.12.13m1.98 0h1.4q.13 0 .14-.13V5.91a.13.13 0 0 0-.14-.14H5.4q-.1.01-.12.14v1.32q0 .13.12.13m1.95 0h1.42q.1 0 .12-.13V5.91q0-.12-.12-.14H7.35q-.1.01-.12.14v1.32q.01.13.12.13M3.42 5.5h1.41c.07 0 .13-.08.13-.15V4.03a.13.13 0 0 0-.13-.14h-1.4q-.12 0-.13.14v1.31q0 .13.12.15m1.98 0h1.4c.08 0 .14-.08.14-.15V4.03q0-.13-.14-.14H5.4q-.1 0-.12.14v1.31q0 .13.12.15m1.95 0h1.42c.06 0 .12-.08.12-.15V4.03q-.01-.13-.12-.14H7.35q-.1 0-.12.14v1.31q.01.13.12.15m0-1.9h1.42q.1-.02.12-.14v-1.3Q8.88 2 8.77 2H7.35q-.1 0-.12.14v1.3q.01.13.12.14m1.97 3.78h1.4a.13.13 0 0 0 .14-.13V5.91q-.01-.12-.13-.14H9.32q-.1.01-.12.14v1.32q.01.13.12.13" opacity=".5"/>
      ...
      (qe = `<symbol id="file-tree-builtin-eslint" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="m.1 7.69 3.63-6.3A.8.8 0 0 1 4.37 1h7.26c.26 0 .5.17.64.4l3.63 6.27a.8.8 0 0 1 0 .75l-3.63 6.24a.7.7 0 0 1-.64.34H4.37a.7.7 0 0 1-.64-.34L.1 8.41a.7.7 0 0 1 0-.72m3 3.02q.01.15.14.23l4.63 2.66q.13.06.26 0l4.63-2.66a.3.3 0 0 0 .14-.23V5.4a.3.3 0 0 0-.14-.23L8.13 2.52a.3.3 0 0 0-.26 0L3.24 5.17a.3.3 0 0 0-.14.23z"/>
      ...
      (Je = `<symbol id="file-tree-builtin-font" viewBox="0 0 16 16">
  <path fill="currentColor" d="M12.3 13c-1.59 0-2.68-.99-2.68-2.5 0-1.43 1-2.34 2.88-2.35h2.16v-.83c0-1.08-.62-1.68-1.73-1.68-1.05 0-1.66.54-1.73 1.36H9.93c.09-1.43 1.06-2.48 3.05-2.48 1.75 0 3.02.95 3.02 2.68v5.66h-1.29v-1.02h-.04c-.41.66-1.16 1.16-2.37 1.16m.36-1.12c1.14 0 2-.72 2-1.74v-.96H12.6c-1.12 0-1.6.54-1.6 1.28 0 .97.8 1.42 1.66 1.42m-11.24.98H0L3.8 2h1.39l3.8 10.86H7.54l-1.08-3.2H2.5zm3.09-9.25h-.04l-1.6 4.95H6.1z"/>
      ...
      (Ye = `<symbol id="file-tree-builtin-git" viewBox="0 0 16 16">
  <path fill="currentColor" d="M14.74 7.38 8.62 1.26a.9.9 0 0 0-1.27 0L6.08 2.53l1.61 1.61a1.07 1.07 0 0 1 1.36 1.37l1.55 1.55a1.07 1.07 0 0 1 1.1 1.77 1.07 1.07 0 0 1-1.74-1.16L8.5 6.22v3.8a1.07 1.07 0 1 1-.89-.02V6.15a1.07 1.07 0 0 1-.58-1.4l-1.58-1.6-4.2 4.2a.9.9 0 0 0 0 1.27l6.12 6.12a.9.9 0 0 0 1.27 0l6.09-6.09a.9.9 0 0 0 0-1.27"/>
      ...
      (Xe = `<symbol id="file-tree-builtin-go" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M4.41 4.57A3.2 3.2 0 0 1 6.87 5q.74.49 1.08 1.29.08.12-.1.16l-1.55.4c-.14.03-.15.04-.27-.1a1 1 0 0 0-.44-.34 1.6 1.6 0 0 0-1.68.14q-.95.61-.94 1.73c0 .73.52 1.33 1.25 1.43q.95.1 1.58-.6l.25-.34h-1.8c-.19 0-.24-.12-.17-.27.12-.28.34-.76.47-1a.3.3 0 0 1 .24-.14h2.98a4 4 0 0 1 .64-1.19 4 4 0 0 1 2.6-1.52 3.5 3.5 0 0 1 2.64.46q1.13.73 1.31 2.04a3.5 3.5 0 0 1-1.06 3.09q-.93.92-2.23 1.17l-.74.08a3.5 3.5 0 0 1-2.27-.8 3 3 0 0 1-.93-1.42 4 4 0 0 1-.39.61 4 4 0 0 1-2.64 1.56 3.3 3.3 0 0 1-2.5-.6 3 3 0 0 1-1.18-2.03 3.5 3.5 0 0 1 .8-2.67 4 4 0 0 1 2.6-1.58M13.1 7.5a1.53 1.53 0 0 0-1.9-1.21q-1.3.3-1.62 1.59a1.5 1.5 0 0 0 .85 1.72q.77.33 1.52-.05a2 2 0 0 0 1.18-1.74q0-.17-.03-.3" clip-rule="evenodd"/>
      ...
      (Ze = `<symbol id="file-tree-builtin-graphql" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M8 1a1.25 1.25 0 0 1 1.18 1.65l2.8 1.61q.33-.25.77-.26a1.25 1.25 0 0 1 .48 2.4v3.2a1.25 1.25 0 1 1-1.25 2.13l-2.8 1.62A1.25 1.25 0 0 1 8 15a1.25 1.25 0 0 1-1.18-1.65l-2.8-1.62q-.33.26-.77.27a1.25 1.25 0 0 1-.48-2.4V6.4a1.25 1.25 0 1 1 1.25-2.14l2.8-1.61A1.25 1.25 0 0 1 8 1M4.44 11.14l-.06.13 2.75 1.58a1.25 1.25 0 0 1 1.74 0l2.74-1.58-.05-.13zm3.89-7.68a1.3 1.3 0 0 1-.66 0L4.03 9.77q.37.3.45.78h7.04q.08-.48.45-.78zM4.38 4.73a1.24 1.24 0 0 1-1.02 1.76v3.02l.13.01 3.67-6.35-.03-.02zm4.46-1.56 3.67 6.35.13-.01V6.49a1.25 1.25 0 0 1-1.03-1.76L8.87 3.15z" clip-rule="evenodd"/>
      ...
      (Qe = `<symbol id="file-tree-builtin-html" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" class="bg" opacity=".2"/>
  <path fill="currentColor" d="M10.48 3.76a.5.5 0 0 1 .4.58L10.6 5.8h1.14a.5.5 0 0 1 0 1h-1.32L10 9.2h1.08a.5.5 0 0 1 0 1H9.8l-.3 1.64a.5.5 0 1 1-.98-.18l.27-1.46H6.4l-.3 1.64a.5.5 0 1 1-.98-.18l.27-1.46H4.25a.5.5 0 0 1 0-1h1.32L6 6.8H4.93a.5.5 0 0 1 0-1H6.2l.3-1.64a.5.5 0 1 1 .98.18L7.2 5.8h2.4l.3-1.64a.5.5 0 0 1 .58-.4M6.58 9.2h2.4l.44-2.4h-2.4z" class="fg"/>
      ...
      ($e = `<symbol id="file-tree-builtin-image" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M15 10.5v1a2.5 2.5 0 0 1-2.5 2.5h-9a2.5 2.5 0 0 1-2.46-2.04L4 9l3 2 4-4zm-7-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"/>
      ...
      (et = `<symbol id="file-tree-builtin-javascript" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" class="bg" opacity=".2"/>
  <path fill="currentColor" d="M8.1 9.64h.95c.04.62.28.76 1.28.76s1.2-.14 1.2-.85c0-.66-.2-.85-1.2-1.07-1.79-.38-2.18-.7-2.18-1.86C8.15 5.3 8.54 5 10.31 5c1.67 0 2.04.26 2.07 1.42h-.95c-.02-.43-.23-.53-1.1-.53-1 0-1.22.14-1.22.74 0 .52.22.7 1.24.92 1.76.38 2.15.73 2.15 2 0 1.44-.4 1.75-2.24 1.75-1.8 0-2.18-.3-2.15-1.66M3.5 9.5h.98c0 .76.15.92.85.92.77 0 .94-.18.94-1.02V5.1h1v4.34c0 1.54-.35 1.87-1.92 1.87-1.55 0-1.89-.32-1.86-1.8"/>
      ...
      (tt = `<symbol id="file-tree-builtin-json" viewBox="0 0 16 16">
  <path fill="currentColor" d="M13.25 11.5V9.75a.5.5 0 0 1 .36-.48l.55-.15a1.16 1.16 0 0 0 0-2.24l-.55-.15a.5.5 0 0 1-.36-.48V4.5a2.5 2.5 0 0 0-2.5-2.5h-.25a.5.5 0 0 0 0 1h.25a1.5 1.5 0 0 1 1.5 1.5v1.75a1.5 1.5 0 0 0 1.09 1.44l.54.15a.16.16 0 0 1 0 .32l-.54.15a1.5 1.5 0 0 0-1.09 1.44v1.75a1.5 1.5 0 0 1-1.5 1.5h-.25a.5.5 0 0 0 0 1h.25a2.5 2.5 0 0 0 2.5-2.5m-10.5 0V9.75a.5.5 0 0 0-.36-.48l-.55-.15a1.16 1.16 0 0 1 0-2.24l.55-.15a.5.5 0 0 0 .36-.48V4.5A2.5 2.5 0 0 1 5.25 2h.25a.5.5 0 0 1 0 1h-.25a1.5 1.5 0 0 0-1.5 1.5v1.75a1.5 1.5 0 0 1-1.09 1.44l-.54.15a.16.16 0 0 0 0 .32l.54.15a1.5 1.5 0 0 1 1.09 1.45v1.74a1.5 1.5 0 0 0 1.5 1.5h.25a.5.5 0 0 1 0 1h-.25a2.5 2.5 0 0 1-2.5-2.5"/>
      ...
      (nt = `<symbol id="file-tree-builtin-markdown" viewBox="0 0 16 16">
  <path fill="currentColor" d="M1 12V4h2l2 2.5L7 4h2v8H7V7.5l-2 2-2-2V12zm9-3 3 3.5L16 9h-2V4h-2v5z"/>
</symbol>`),
      (rt = `<symbol id="file-tree-builtin-mcp" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M9.26 2.19a.6.6 0 0 1 .52.34.6.6 0 0 1 0 .43l-.12.18L4.9 7.79a1.65 1.65 0 0 0 0 2.36 1.73 1.73 0 0 0 2.4 0l4.75-4.66a.58.58 0 0 1 .93.18.6.6 0 0 1-.12.61l-4.75 4.66a2.9 2.9 0 0 1-4.01 0 2.75 2.75 0 0 1-.62-3.04A3 3 0 0 1 4.1 7l4.74-4.65a.6.6 0 0 1 .4-.16"/>
      ...
      (it = `<symbol id="file-tree-builtin-nextjs" viewBox="0 0 16 16">
  <defs>
  ...
  <path fill="currentColor" d="M12.172 2h-1.508v9.094h1.508z"/>
      ...
      (at = `<symbol id="file-tree-builtin-npm" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M10.5 13H13V3H3v10h5V5.5h2.5z"/>
      ...
      (R = `<symbol id="file-tree-builtin-oxc" viewBox="0 0 16 16">
  <path fill="currentColor" d="M9.5 1a.5.5 0 0 1 .5.5V3h3.5a.5.5 0 0 1 .38.83L10.5 7.69v1.44q.41.04.95-.16a4 4 0 0 0 .72-.35l.04-.03h.01a.5.5 0 0 1 .67.1l2 2.5a.5.5 0 0 1 0 .62c-.76.96-3.14 2.69-6.89 2.69s-6.13-1.73-6.89-2.69a.5.5 0 0 1 0-.62l2-2.5a.5.5 0 0 1 .67-.1l.05.03.16.09q.22.13.56.26.54.2.95.16V7.69L2.12 3.83A.5.5 0 0 1 2.5 3H6V1.5a.5.5 0 0 1 .5-.5zM7 3.5a.5.5 0 0 1-.5.5H3.6l2.78 3.17a.5.5 0 0 1 .12.33v2a.5.5 0 0 1-.28.45c-.7.35-1.5.15-2.02-.05a5 5 0 0 1-.58-.26l-1.46 1.84c.82.78 2.8 2.02 5.84 2.02s5.02-1.24 5.84-2.02l-1.46-1.83a5 5 0 0 1-.58.26c-.52.2-1.33.39-2.02.04a.5.5 0 0 1-.28-.45v-2a.5.5 0 0 1 .12-.33L12.4 4H9.5a.5.5 0 0 1-.5-.5V2H7z"/>
      ...
      (z = `<symbol id="file-tree-builtin-postcss" viewBox="0 0 16 16">
  <path fill="currentColor" d="M14.5 8a6.5 6.5 0 0 0-5.9-6.47l5.42 8.93A7 7 0 0 0 14.5 8M2.88 12A6.5 6.5 0 0 0 8 14.5c2.08 0 3.93-.98 5.12-2.5zm8.62-1h1.68L11.5 8.24zm-1-.55a4 4 0 0 1-.7.55h.7zM8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5M5.5 11h.7a4 4 0 0 1-.7-.55zm-2.68 0H4.5V8.24zm3.76-6.2A4 4 0 0 1 8 4.5q.76 0 1.42.3L8 2.46zM1.5 8q0 1.31.48 2.46L7.4 1.53A6.5 6.5 0 0 0 1.5 8m14 0a7.5 7.5 0 0 1-.99 3.72l-.01.03-.02.03A7.5 7.5 0 0 1 8 15.5a7.5 7.5 0 0 1-6.5-3.75l-.01-.03A7.5 7.5 0 1 1 15.5 8"/>
      ...
      (ot = `<symbol id="file-tree-builtin-prettier" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M4.93 12v1H2v-1zM13 8v1H9V8zM5.5 4v1H2V4zM9 2v1H4.93V2z" opacity=".4"/>
      ...
      (st = `<symbol id="file-tree-builtin-python" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M7.67 7.6H6c-1.16 0-1.9.73-1.9 1.86v1.46q0 .24-.25.24h-.74c-.75 0-1.33-.32-1.66-.97a3 3 0 0 1-.41-1.46 6 6 0 0 1 .24-2.67c.25-.73.75-1.3 1.58-1.46h4.8c.08 0 .25 0 .25-.08v-.4s-.17-.09-.25-.09H4.85c-.24 0-.33-.08-.33-.32V2.65c0-.56.25-.97.75-1.13.41-.16.83-.33 1.24-.4a7 7 0 0 1 2.98.07c.41.09.83.25 1.16.49.33.32.58.65.5 1.13v2.92c0 1.14-.67 1.78-1.82 1.78-.58.08-1.16.08-1.66.08M5.35 2.73c0 .33.25.65.66.65.33 0 .66-.32.66-.65 0-.32-.33-.56-.66-.64a.65.65 0 0 0-.66.64" class="fg"/>
      ...
      (ct = `<symbol id="file-tree-builtin-react" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" fill-rule="evenodd" d="M8 2.55c1.3-.99 2.59-1.34 3.5-.8.92.55 1.27 1.87 1.08 3.53C14.06 5.94 15 6.9 15 8s-.94 2.06-2.42 2.72c.19 1.65-.16 2.98-1.08 3.52-.91.55-2.2.2-3.5-.8-1.3 1-2.58 1.35-3.5.8-.91-.54-1.27-1.87-1.08-3.52C1.94 10.06 1 9.1 1 8s.94-2.06 2.42-2.72c-.19-1.66.17-2.98 1.08-3.52s2.2-.2 3.5.8M4.26 11.2c-.08 1.34.28 2.03.68 2.26s1.15.22 2.25-.52l.11-.09a12 12 0 0 1-1.24-1.39 11 11 0 0 1-1.8-.41zm7.47-.15q-.83.27-1.79.41-.6.8-1.24 1.4l.11.08c1.1.74 1.86.76 2.25.52.4-.23.76-.92.68-2.26zm-3.04.54a14 14 0 0 1-1.38 0q.34.38.69.7.35-.32.7-.7M8 5.29q-.76 0-1.47.1A13 13 0 0 0 5.07 8a14 14 0 0 0 1.46 2.62 13 13 0 0 0 2.94 0A13 13 0 0 0 10.93 8a14 14 0 0 0-1.46-2.62A13 13 0 0 0 8 5.3M4.64 9.18q-.15.5-.25.96.44.16.94.27a15 15 0 0 1-.7-1.23m6.73 0a15 15 0 0 1-.7 1.23q.5-.11.95-.27a10 10 0 0 0-.25-.96M3.44 6.26C2.27 6.86 1.87 7.53 1.87 8s.4 1.14 1.57 1.74l.13.07q.18-.88.55-1.81a12 12 0 0 1-.55-1.8q-.07.02-.13.06m8.99-.07A12 12 0 0 1 11.88 8q.36.94.55 1.8l.13-.06c1.17-.6 1.56-1.27 1.56-1.74s-.39-1.14-1.56-1.74zm-7.1-.6q-.5.11-.94.27.1.46.25.96a15 15 0 0 1 .69-1.23m5.34 0a15 15 0 0 1 .7 1.23q.14-.5.24-.96-.44-.15-.94-.27M7.18 3.06c-1.09-.74-1.85-.76-2.24-.52s-.76.92-.69 2.26l.01.15a11 11 0 0 1 1.8-.41q.6-.8 1.24-1.4zm3.88-.52c-.4-.24-1.15-.22-2.25.52l-.12.08q.65.6 1.25 1.4.96.15 1.8.41v-.14c.08-1.35-.28-2.04-.68-2.27M8 3.7a10 10 0 0 0-.7.7 14 14 0 0 1 1.4 0 10 10 0 0 0-.7-.7" clip-rule="evenodd"/>
      ...
      (lt = `<symbol id="file-tree-builtin-ruby" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M11.04 2c.48 0 .92.23 1.18.6l2.54 3.65c.37.52.3 1.23-.15 1.69l-5.58 5.64a1.47 1.47 0 0 1-2.06 0L1.39 7.94a1.3 1.3 0 0 1-.15-1.7l2.54-3.63q.2-.3.5-.45.33-.16.68-.16zm.84 2.17a.5.5 0 0 0-.7-.05L8 6.84 4.83 4.12a.5.5 0 0 0-.65.76L6.65 7H3.5a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1H9.35l2.48-2.12a.5.5 0 0 0 .05-.7" clip-rule="evenodd"/>
      ...
      (ut = `<symbol id="file-tree-builtin-rust" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M8 .8a.2.2 0 0 1 .18.1l.38.6.16.02.5-.53.01-.01a.2.2 0 0 1 .33.08l.25.68.16.05.59-.43h.02a.2.2 0 0 1 .3.14l.12.71.15.08.65-.3a.2.2 0 0 1 .2.02.2.2 0 0 1 .1.18l-.03.72.12.1.71-.16a.2.2 0 0 1 .25.25l-.17.7q.06.06.1.13l.73-.03A.2.2 0 0 1 14 4a.2.2 0 0 1 .02.2l-.3.66.08.14.71.12a.2.2 0 0 1 .14.32l-.43.59.05.16.68.25a.2.2 0 0 1 .07.35l-.53.49.01.16.62.38a.2.2 0 0 1 0 .36l-.62.38-.01.16.53.5a.2.2 0 0 1-.07.34l-.68.25-.05.16.43.59a.2.2 0 0 1-.14.32l-.72.12-.07.15.3.65a.2.2 0 0 1-.02.2.2.2 0 0 1-.18.1l-.72-.03-.1.13.16.7a.2.2 0 0 1-.25.25l-.7-.17-.13.1.03.73a.2.2 0 0 1-.1.18.2.2 0 0 1-.2.02l-.66-.3-.14.08-.12.71a.2.2 0 0 1-.32.14l-.59-.43-.16.05-.25.68a.2.2 0 0 1-.34.07l-.5-.53-.16.01-.38.62a.2.2 0 0 1-.36 0l-.38-.62-.16-.01-.5.53a.2.2 0 0 1-.34-.07l-.25-.68-.16-.05-.59.43a.2.2 0 0 1-.32-.14L5 13.78l-.15-.07-.65.3a.2.2 0 0 1-.2-.02.2.2 0 0 1-.1-.18l.03-.72-.13-.1-.7.16a.2.2 0 0 1-.25-.25l.17-.7-.1-.13-.73.03a.2.2 0 0 1-.2-.3l.3-.66-.08-.14-.71-.12a.2.2 0 0 1-.14-.32l.43-.59-.05-.16-.68-.25A.2.2 0 0 1 1 9.22l.53-.5-.02-.16-.6-.38A.2.2 0 0 1 .8 8a.2.2 0 0 1 .1-.18l.6-.38.02-.16-.53-.5a.2.2 0 0 1 .07-.34l.68-.25.05-.16-.43-.59a.2.2 0 0 1 .14-.32L2.2 5l.08-.15L2 4.2a.2.2 0 0 1 .2-.3l.72.03.1-.13-.16-.7a.2.2 0 0 1 .25-.25l.7.16.13-.1-.03-.72A.2.2 0 0 1 4 2a.2.2 0 0 1 .2-.02l.65.3L5 2.2l.12-.71v-.03a.2.2 0 0 1 .32-.1l.59.41.16-.04.25-.68.01-.02A.2.2 0 0 1 6.8.99l.49.53.16-.02.38-.61.02-.02A.2.2 0 0 1 8 .79M6.8 9.45h1.26l.06.01q.03.01.03.05v1.52q0 .07-.09.06h-4.5A5.4 5.4 0 0 0 8 13.42a5.4 5.4 0 0 0 4.45-2.33h-2.42c-.36 0-.68-.5-.77-.75-.08-.22-.2-.91-.25-1.12-.15-.61-.59-.71-.78-.73H6.8zM8 2.58a5.4 5.4 0 0 0-4.07 1.85h5.74l.17.02c.23.03.6.12.96.35.34.23.83.68.83 1.4 0 .66-.55 1.16-1.08 1.5.42.33.7.53.86 1.44.04.17.34.32.62.29.29-.03.62-.16.62-.75v-.24q0-.1.07-.1h.68A5.43 5.43 0 0 0 8 2.59M2.96 6.03a5.4 5.4 0 0 0-.19 3.37h1.66V6.03zM6.8 7.06h1.66c.35 0 .77-.12.77-.47 0-.42-.55-.53-.65-.53H6.8z" clip-rule="evenodd"/>
      ...
      (dt = `<symbol id="file-tree-builtin-sass" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M8.08 1.44c2.41-.91 4.96-.37 5.35 1.27.39 1.62-.92 3.56-2.6 4.25a5 5 0 0 1-3.26.35c-.58-.2-.92-.62-1-.85-.03-.09-.09-.24 0-.3.05-.03.08-.02.22.15s.7.6 1.75.48c2.78-.34 4.45-2.64 3.92-3.88-.37-.87-2.5-1.26-5.18.16C4.03 4.81 3.85 6.24 3.82 6.8c-.08 1.5 1.73 2.28 2.7 3.4q.04.03.07.08c.3-.12.7-.19 1.35-.2 1.58-.03 2.47 1.08 2.43 2.08-.03.78-.7 1.1-.82 1.13-.1.01-.14.02-.15-.06q-.03-.06.13-.15c.16-.09.42-.3.48-.72.05-.43-.24-1.44-1.76-1.63a3 3 0 0 0-1.33.08c.27.62.32 1.87-.29 2.83-.63 1-1.8 1.61-2.93 1.27-.37-.1-.93-.92-.45-2.05.46-1.07 2.4-2.12 2.66-2.26-.9-.83-3.08-1.95-3.4-3.65-.08-.49.13-1.65 1.46-2.98a12 12 0 0 1 4.11-2.52m-1.88 9.7c-.01.01-.9.47-1.52 1.17-.59.66-.75 1.48-.43 1.69.3.18 1-.04 1.51-.62a3 3 0 0 0 .5-.9q.2-.64.02-1.39z" clip-rule="evenodd"/>
      ...
      (ft = `<symbol id="file-tree-builtin-stylelint" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M6.5 2.5V4l-2 1.5v-4zm5 3L9.5 4V2.5l2-1zM9 4H7V2.5h2z"/>
      ...
      (pt = `<symbol id="file-tree-builtin-svelte" viewBox="0 0 16 16">
  <path fill="currentColor" d="m3.98 3.7 3.36-2.08a4.5 4.5 0 0 1 5.9 1.23 4 4 0 0 1 .7 3.02q-.16.75-.58 1.4c.42.77.56 1.66.4 2.52a3.7 3.7 0 0 1-1.57 2.4l-.17.1-3.36 2.09a4.5 4.5 0 0 1-5.9-1.23 4 4 0 0 1-.66-1.44 4 4 0 0 1-.04-1.58 4 4 0 0 1 .58-1.4 4 4 0 0 1-.4-2.52 3.7 3.7 0 0 1 1.57-2.4zl3.36-2.08zm7.87 0a2.7 2.7 0 0 0-1.26-.95 2.7 2.7 0 0 0-1.6-.07 3 3 0 0 0-.52.2l-.16.09-3.36 2.08a2 2 0 0 0-.69.64 2 2 0 0 0-.36.86 2.3 2.3 0 0 0 .42 1.81A2.7 2.7 0 0 0 7.18 9.4q.28-.06.53-.2l.16-.09 1.28-.79.2-.09a.8.8 0 0 1 .87.31.7.7 0 0 1 .13.55.7.7 0 0 1-.24.4l-.08.05-3.36 2.08-.2.09a1 1 0 0 1-.49-.02 1 1 0 0 1-.38-.3 1 1 0 0 1-.13-.37v-.1l.01-.13-.13-.03a4 4 0 0 1-1.1-.5l-.2-.14-.18-.12-.07.18-.08.3a2.3 2.3 0 0 0 .43 1.82q.45.64 1.19.93.73.28 1.51.14l.16-.04q.27-.07.52-.2l.16-.09 3.36-2.08q.4-.25.69-.64.27-.4.36-.86a2.3 2.3 0 0 0-.42-1.82 2.7 2.7 0 0 0-1.27-.95 2.7 2.7 0 0 0-1.6-.08q-.27.07-.52.2l-.16.1-1.28.79-.2.09a1 1 0 0 1-.49-.03 1 1 0 0 1-.38-.29.7.7 0 0 1-.13-.54.7.7 0 0 1 .24-.4l.08-.06L9.33 4.4l.2-.1a.8.8 0 0 1 .87.32 1 1 0 0 1 .13.38v.22l.11.04q.6.18 1.12.5l.2.14.17.12.06-.19.08-.3a2.3 2.3 0 0 0-.42-1.81z"/>
      ...
      (mt = `<symbol id="file-tree-builtin-svg" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M6 1a5 5 0 0 1 4.58 3H7a3 3 0 0 0-3 3v3.58A5 5 0 0 1 6 1" opacity=".5"/>
      ...
      (B = `<symbol id="file-tree-builtin-svgo" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" fill-rule="evenodd" d="M9.17 1q.16.63.27 1.26a6 6 0 0 1 1.61.67q.52-.38 1.08-.71l1.65 1.64q-.32.56-.68 1.05.48.78.72 1.67.6.09 1.18.25v2.32q-.55.15-1.11.24a6 6 0 0 1-.7 1.82q.31.44.59.91l-1.65 1.65-.85-.55a6 6 0 0 1-1.9.83q-.08.47-.2.95H6.84q-.12-.46-.2-.93a6 6 0 0 1-1.96-.81q-.39.27-.8.51l-1.65-1.65q.25-.43.53-.84a6 6 0 0 1-.75-1.9L1 9.16V6.83q.54-.14 1.09-.24a6 6 0 0 1 .77-1.74q-.33-.47-.63-.98l1.65-1.65q.54.32 1.03.68a6 6 0 0 1 1.66-.66q.1-.61.26-1.24zM7.96 3.73a4 4 0 0 0-1.74.36 4.5 4.5 0 0 0-2.3 2.3 4.4 4.4 0 0 0-.1 3.29l.03.06a4.4 4.4 0 0 0 2.4 2.47 4.4 4.4 0 0 0 3.48-.02l.03-.02a4.4 4.4 0 0 0 2.3-2.42l.06-.14a4.4 4.4 0 0 0-.2-3.4 4.4 4.4 0 0 0-2.13-2.07L9.47 4a4 4 0 0 0-1.51-.27" clip-rule="evenodd"/>
      ...
      (ht = `<symbol id="file-tree-builtin-swift" viewBox="0 0 16 16">
  <path fill="currentColor" d="M9.63 1c6.15 4.35 4.16 9.15 4.16 9.15s1.75 2.05 1.04 3.85c0 0-.72-1.26-1.93-1.26-1.17 0-1.85 1.26-4.2 1.26C3.47 14 1 9.46 1 9.46c4.71 3.22 7.93.94 7.93.94C6.8 9.12 2.29 3 2.29 3c3.93 3.47 5.63 4.39 5.63 4.39-1.01-.87-3.86-5.13-3.86-5.13C6.34 4.66 10.86 8 10.86 8c1.28-3.7-1.23-7-1.23-7"/>
      ...
      (V = `<symbol id="file-tree-builtin-table" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M11.5 8a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-4a.5.5 0 0 1 .5-.5zM5 12h2.5v-1H5zm3.5 0H11v-1H8.5zM5 10h2.5V9H5zm3.5 0H11V9H8.5zm1-9a.5.5 0 0 1 .354.146l4 4A.5.5 0 0 1 14 5.5V6h-3a2 2 0 0 1-2-2V1z" class="fg"/>
      ...
      (gt = `<symbol id="file-tree-builtin-tailwind" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M8 4Q5.2 4 4.5 6.67q1.05-1.34 2.45-1c.53.12.91.5 1.33.9C8.98 7.23 9.77 8 11.5 8q2.8 0 3.5-2.67-1.05 1.34-2.45 1c-.53-.12-.91-.5-1.33-.9C10.52 4.77 9.73 4 8 4M4.5 8Q1.7 8 1 10.67q1.05-1.34 2.45-1c.53.12.91.5 1.33.9C5.48 11.23 6.26 12 8 12q2.8 0 3.5-2.67-1.05 1.34-2.45 1c-.53-.12-.91-.5-1.33-.9C7.02 8.77 6.24 8 4.5 8" clip-rule="evenodd"/>
      ...
      (_t = `<symbol id="file-tree-builtin-terraform" viewBox="0 0 16 16">
  <path fill="currentColor" d="M1 0v5.05l4.35 2.53V2.53zm9.18 5.34L5.83 2.82v5.05l4.35 2.53zm.47 5.06V5.34L15 2.82v5.05zm-.48 5.6-4.35-2.53V8.42l4.35 2.53z"/>
      ...
      (vt = `<symbol id="file-tree-builtin-text" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M8.5 11a.5.5 0 0 1 0 1h-3a.5.5 0 0 1 0-1zm2-2a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1zm-1-8a.5.5 0 0 1 .354.146l4 4A.5.5 0 0 1 14 5.5V6h-3a2 2 0 0 1-2-2V1z"/>
      ...
      (yt = `<symbol id="file-tree-builtin-typescript" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" class="bg" opacity=".2"/>
  <path fill="currentColor" d="M8.1 9.64h.95c.04.62.28.76 1.28.76s1.2-.14 1.2-.85c0-.66-.2-.85-1.2-1.07-1.79-.38-2.18-.7-2.18-1.86C8.15 5.3 8.54 5 10.31 5c1.67 0 2.04.26 2.07 1.42h-.95c-.02-.43-.23-.53-1.1-.53-1 0-1.22.14-1.22.74 0 .52.22.7 1.24.92 1.76.38 2.15.73 2.15 2 0 1.44-.4 1.75-2.24 1.75-1.8 0-2.18-.3-2.15-1.66m-3 1.57V5.99H3.5v-.9h4.21v.9H6.1v5.22z"/>
</symbol>`),
      (bt = `<symbol id="file-tree-builtin-vite" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8.57 14.87c-.18.26-.55.11-.55-.22v-3.18l-.05-.27-.13-.22-.2-.15-.24-.06H4.29c-.26 0-.4-.32-.26-.55L6.08 7c.3-.46 0-1.1-.5-1.1H1.8c-.25 0-.4-.32-.25-.56l2.65-4.2A.3.3 0 0 1 4.46 1h7.9c.26 0 .4.32.26.55l-2.05 3.23c-.29.46 0 1.1.5 1.1h3.12c.26 0 .4.34.24.57z"/>
      ...
      (xt = `<symbol id="file-tree-builtin-vscode" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M11.62 14.91a.9.9 0 0 1-1-.17.51.51 0 0 0 .88-.36V1.62a.51.51 0 0 0-.87-.36.9.9 0 0 1 1-.17l2.87 1.39a.9.9 0 0 1 .5.8v9.44a.9.9 0 0 1-.5.8z"/>
      ...
      (St = `<symbol id="file-tree-builtin-vue" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="M9.54 2.25 8 4.95l-1.54-2.7H4l4 7 4-7z"/>
      ...
      (Ct = `<symbol id="file-tree-builtin-wasm" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" fill-rule="evenodd" d="M13 13h-1.02l-.33-1.11H9.9L9.64 13h-.97l1.26-5h1.54zm-2.49-3.77-.42 1.84h1.32l-.49-1.84z" clip-rule="evenodd"/>
      ...
      (wt = `<symbol id="file-tree-builtin-webpack" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" d="m7.74 11.93-3.59-1.92v-3.8l3.6 2.02zm.52 0 3.59-1.92v-3.8l-3.6 2.02zM4.4 5.77 8 3.85l3.6 1.93L8 7.8z" class="fg"/>
      ...
      (Tt = `<symbol id="file-tree-builtin-yml" viewBox="0 0 16 16">
  <path fill="currentColor" d="M7.5 2A1.5 1.5 0 0 1 9 3.5v3A1.5 1.5 0 0 1 7.5 8h-2v2A1.5 1.5 0 0 0 7 11.5v-1A1.5 1.5 0 0 1 8.5 9h5a1.5 1.5 0 0 1 1.5 1.5v3a1.5 1.5 0 0 1-1.5 1.5h-5A1.5 1.5 0 0 1 7 13.5v-1A2.5 2.5 0 0 1 4.5 10V8h-2A1.5 1.5 0 0 1 1 6.5v-3A1.5 1.5 0 0 1 2.5 2zm1 8a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h5a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5zm-6-7a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h5a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5z"/>
      ...
      (Et = `<symbol id="file-tree-builtin-zig" viewBox="0 0 16 16">
  ...
  <path fill="currentColor" fill-rule="evenodd" d="M14 12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-1.25h1v-1H0V6h14zM9.9 8.25c-.883 0-1.9.5-1.9.5H7v1h1v1s1.017.5 1.9.5c.884 0 1.6-.672 1.6-1.5s-.716-1.5-1.6-1.5M2 9.75v1h1v-1zm2 0v1h1v-1zm2 0v1h1v-1zm-5-1v1h1v-1zm2 0v1h1v-1zm2 0v1h1v-1z" class="fg" clip-rule="evenodd"/>
      ...
      (kt = Oe(Ne, Dt)),
      (At = { minimal: Ne, standard: kt, complete: Oe(kt, Ot) }),
      (jt = {
        ".babelrc": `babel`,
        ".babelrc.json": `babel`,
        ".bash_profile": `bash`,
      ...
      (Nt = { jsx: `react`, sass: `sass`, scss: `sass`, tsx: `react` }),
      (Pt = new Set([
        `bash`,
        `c`,
        `cpp`,
  ...
  Gt,
  Kt = e(() => {
    ((Lt = `file-tree-container`),
      (Rt = `data-file-tree-style`),
      (zt = `data-file-tree-unsafe-css`),
      (Bt = `data-file-tree-scrollbar-measure`),
      (Vt = `data-file-tree-scrollbar-gutter-measured`),
      (Ht = `--trees-scrollbar-gutter-measured`),
      (Ut = `header`),
      (Wt = `context-menu`),
      (Gt = `context-menu-trigger`));
  });
function qt(e) {
  return (
    e.spriteSheet != null ||
...
function Jt(e) {
  return e == null
    ...
    : typeof e == `string`
      ? { set: e, colored: !0 }
      : { ...e, set: e.set ?? (qt(e) ? `none` : `complete`), colored: e.colored ?? !0 };
}
var Yt = e(() => {});
function Xt(e, t) {
...
function Zt(e) {
  ...
  let i = new Map();
  for (let [e, n] of Object.entries(t.byFileExtension ?? {})) i.set(Qt(e), n);
    ...
    resolveIcon: (e, o) => {
      if (e === `file-tree-icon-file` && o != null) {
        let n = $t(o),
          s = n.toLowerCase(),
          c = r.get(s);
        if (c != null) return Xt(c, e);
        for (let [t, n] of a) if (s.includes(t)) return Xt(n, e);
        let l = en(n);
        for (let t of l) {
          let n = i.get(t);
          if (n != null) return Xt(n, e);
        }
        let u = Me(t.set, n, l);
        if (u != null && t.set !== `none`) return { name: Ae(u), remappedFrom: e, token: u };
      }
      let s = n?.[e];
      return s == null ? { name: e } : Xt(s, e);
    },
  };
}
var Qt,
...
function ln(e, t) {
  ...
  ((t.totalChildSubtreeNodeCount = n), (t.totalChildVisibleSubtreeCount = r), pn(e, t));
}
function un(e, t, n, r) {
  if (
...
function pn(e, t) {
  if (t.childIds.length < _n) {
    t.childVisibleChunkSums = null;
    return;
  }
  let n = Math.ceil(t.childIds.length / gn),
    r = new Int32Array(n);
  for (let n = 0; n < t.childIds.length; n++) {
    let i = t.childIds[n];
    if (i == null) continue;
    let a = e[i];
    a != null && (r[n >> hn] += a.visibleSubtreeCount);
  }
  t.childVisibleChunkSums = r;
}
function mn(e, t, n, r) {
  let i = Math.min(t.childIds.length, n + gn),
    a = r;
  for (let r = n; r < i; r++) {
    let n = t.childIds[r];
    if (n == null) continue;
...
var hn,
  ...
  _n,
  vn = e(() => {
    ((hn = 5), (gn = 1 << hn), (_n = gn * 4));
  });
function yn(e, t, n = 0) {
  return (e << On) | (n << En) | t;
}
function bn(e) {
  return e.depthAndFlags >>> On;
}
function xn(e) {
  return (e.depthAndFlags & Dn) >> En;
}
function H(e) {
  return (e.depthAndFlags & Dn) !== 0;
}
function Sn(e) {
  return e.depthAndFlags & Tn;
}
function U(e, t) {
  return (Sn(e) & t) !== 0;
}
...
function wn(e, t) {
  e.depthAndFlags = yn(t, Sn(e), xn(e));
}
var Tn,
  En,
  Dn,
  On,
  kn = e(() => {
    ((Tn = 7), (En = 3), (Dn = 1 << En), (On = 4));
  });
function An(e, t) {
  return (
    t == null ||
      Object.defineProperty(e, Nn, { configurable: !0, enumerable: !1, value: t, writable: !1 }),
    e
  );
}
function jn(e) {
  return e == null ? null : (e[Nn] ?? null);
}
function W(e, t, n) {
...
var Nn,
  Pn = e(() => {
    Nn = Symbol(`benchmarkInstrumentation`);
  });
function Fn(e) {
  return e >= 48 && e <= 57;
}
function In(e) {
  let t = [],
    ...
    r = 0;
  for (; r < e.length; ) {
    for (; r < e.length && !Fn(e.charCodeAt(r)); ) r += 1;
    if (r >= e.length) break;
    r > n && t.push(e.slice(n, r));
    let i = 0;
    for (; r < e.length && Fn(e.charCodeAt(r)); ) ((i = i * 10 + (e.charCodeAt(r) - 48)), (r += 1));
    (t.push(i), (n = r));
  }
...
function Ln(e) {
  let t = e.toLowerCase();
  return { lowerValue: t, tokens: In(t) };
}
function Rn(e, t) {
...
function Un(e, t) {
  ...
  for (let r = 0; r < n; r++) {
    ...
    if (n === i) continue;
    let a = Hn(e, r);
    return a === Hn(t, r) ? Vn(n, i) : a === 1 ? -1 : 1;
  }
...
function Gn(e, t, n) {
  ...
  for (let n = 0; n < i; n++) {
    ...
    if (i === a) continue;
    let o = Hn(e, n);
    return o === Hn(t, n) ? Bn(i, a, r) : o === 1 ? -1 : 1;
  }
  return e.segments.length === t.segments.length
    ? e.isDirectory === t.isDirectory
      ? 0
...
function Zn(e) {
  let { hasTrailingSlash: t, segments: n } = Xn(e);
...
function er() {
  let e = new Map();
  return (e.set(rr, 0), { idByValue: e, valueById: [rr], sortKeyById: [Ln(rr)] });
}
function tr(e, t) {
...
function sr(e, t, n) {
  return n === `default` ? Wn(e, t) : n(or(e), or(t));
}
function cr() {
  return {
    depthAndFlags: yn(0, 3, 1),
    nameId: 0,
    parentId: 0,
    subtreeNodeCount: 1,
...
function pr(e, t = {}) {
  return yr(e, t).map((e) => e.path);
}
function mr(e, t = {}) {
  let n = yr(e, t);
  return ar({ paths: n.map((e) => e.path), preparedPaths: n }, `prepared`);
}
function hr(e) {
  let t = e.length,
    n = !1;
  ...
  return ar({ paths: e, presortedPaths: e, presortedPathsContainDirectories: n }, `presorted`);
}
function gr(e) {
  let t = e,
    n = t.preparedPaths;
  if (t[br] === `prepared` && n != null) return n;
  if (!dr(n)) throw Error(`preparedInput must come from PathStore.prepareInput()`);
  return n;
}
function _r(e) {
  let t = e;
  return (t[br] === `presorted` && t.presortedPaths != null) || fr(t.presortedPaths)
    ? t.presortedPaths
    : null;
}
function vr(e) {
...
function yr(e, t = {}) {
  let n = Jn(t),
    r = jn(t);
  Mn(r, `workload.inputFiles`, e.length);
  let i = W(r, `store.preparePathEntries.parse`, () => e.map((e) => Zn(e)));
  return (W(r, `store.preparePathEntries.sort`, () => i.sort((e, t) => sr(e, t, n.sort))), i);
}
var br,
  xr,
  Sr = e(() => {
    (vn(),
      ...
      qn(),
      ir(),
      (br = Symbol(`pathStorePreparedInputKind`)),
      (xr = class {
        directories = new Map();
        directoryStack = [0];
        ...
        constructor(e = {}) {
          ((this.instrumentation = jn(e)), (this.options = Jn(e)));
          ...
          this.directories.set(0, nn());
        }
        appendPaths(e) {
          return W(this.instrumentation, `store.builder.appendPaths.parse`, () =>
            this.appendPreparedPaths(e.map((e) => Zn(e))),
          );
        }
        appendPreparedPaths(e, t = !0) {
          return (
            (this.createdDirectoriesAllExpanded = !1),
            W(this.instrumentation, `store.builder.appendPreparedPaths`, () => {
        ...
        appendPresortedPaths(e, t = null) {
          return (
            W(this.instrumentation, `store.builder.appendPresortedPaths`, () => {
              if (t === !1) {
              ...
              ((c.length = l + 1),
                n != null && (this.lastPreparedPath = Zn(n)),
        ...
        appendPresortedFilePaths(e) {
          ...
          ((s.length = c + 1),
            t != null && (this.lastPreparedPath = Zn(t)),
            (this.hasDeferredDirectoryIndexes = !0));
        }
        finish(e = {}) {
          ...
          return (
            this.hasDeferredDirectoryIndexes
              ? (W(this.instrumentation, `store.builder.buildDirectoryIndexes`, () =>
                  this.buildPresortedFinish(t),
                ),
                (this.hasDeferredDirectoryIndexes = !1))
              : t ||
                W(this.instrumentation, `store.builder.computeSubtreeCounts`, () =>
        ...
        appendPreparedPath(e, t) {
          if (
            ...
            if (
              ...
              (this.options.sort === `default`
                ...
                : sr(this.lastPreparedPath, e, this.options.sort)) > 0
            )
          ...
          let n = this.lastPreparedPath,
            r = ur(e),
            i = n == null ? 0 : ur(n),
            a = n == null ? 0 : lr(n.segments, e.segments),
            o = Math.min(a, r, i);
        ...
        promoteDirectoryToExplicit(e, t) {
          ...
          if (!H(n)) throw Error(`Path is not a directory: "${t}"`);
          if (U(n, 1)) throw Error(`Duplicate path: "${t}"`);
          Cn(n, 1);
        }
        getDirectoryIndex(e) {
        ...
        buildDirectoryIndexes() {
          ...
          for (let t = 1; t < e.length; t++) {
            let n = e[t];
            if (n == null) continue;
            H(n) && this.directories.set(t, nn());
            let r = this.directories.get(n.parentId);
            r != null &&
              (r.childIdByNameId != null && r.childIdByNameId.set(n.nameId, t), sn(r, t));
          }
        }
        computeSubtreeCounts(e) {
          let t = this.nodes[e];
          if (t === void 0) throw Error(`Unknown node ID: ${String(e)}`);
          if (!H(t)) return ((t.subtreeNodeCount = 1), (t.visibleSubtreeCount = 1), 1);
          let n = this.getDirectoryIndex(e),
            r = 1;
          for (let e of n.childIds) r += this.computeSubtreeCounts(e);
          return (ln(this.nodes, n), (t.subtreeNodeCount = r), (t.visibleSubtreeCount = r), r);
        }
      }));
  });
function Cr(e, t = `closed`, n = null) {
  let r = Tr(t);
  return {
...
function Er(e, t) {
  return U(t, 2) || e.defaultExpansion === `open`
    ? !0
    : e.defaultExpansion === `closed`
      ? !1
      : bn(t) <= e.defaultExpansion;
}
function Dr(e, t, n = e.snapshot.nodes[t]) {
  return n == null || !H(n)
    ? !1
...
function Or(e, t, n, r = e.snapshot.nodes[t]) {
...
function Xr(e, t, n) {
  return { ...n, visibleCountDelta: si(e) - t };
}
function Zr(e, t) {
  let n = si(e),
    r = wr();
...
function ei(e, t, n, r = null) {
  ...
  if (i != null) {
    let n = e.instrumentation;
    n == null ? ri(i, t) : W(n, `store.events.batch.merge`, () => ri(i, t));
    return;
  }
  let a = ti(t, r),
    o = e.instrumentation;
  ...
  W(o, `store.events.batch.commit`, () => ai(e, a));
}
function ti(e, t) {
  return {
    affectedAncestorIds: [...e.affectedAncestorIds],
...
function pi(e, t) {
  let n = t == null ? e.snapshot.rootId : Si(e, t);
  return n == null ? [] : wi(e, n);
}
function mi(e, t) {
  let n = Zn(t),
    r = n.isDirectory ? n.segments : n.segments.slice(0, -1),
    i = zi(e, Ri(e, r)),
    { createdNodeIds: a, directoryId: o } = Ti(e, r),
    s = new Set(a),
    c = o;
  if (n.isDirectory) {
    let n = q(e, o);
    if (U(n, 1)) throw Error(`Path already exists: "${t}"`);
    (Cn(n, 1), e.pathCacheByNodeId.set(o, { path: t, version: e.pathCacheVersion }), s.add(o));
  } else ((c = Di(e, o, n.basename)), s.add(c));
  yi(e, o);
  let l = zi(e, o);
  return zr({
    affectedAncestorIds: xi(e, c),
    affectedNodeIds: [...s],
    path: t,
    projectionChanged: Bi(i, l),
  });
}
function hi(e, t, n) {
  let r = Si(e, t);
  ...
  let i = q(e, r);
  if (U(i, 2)) throw Error(`The root node cannot be removed`);
  if (H(i) && K(e, r).childIds.length > 0 && n.recursive !== !0)
    throw Error(`Cannot remove a non-empty directory without recursive: "${t}"`);
  let a = i.parentId,
    o = zi(e, a),
    s = Ii(e, r);
  (Ai(e, a, r, i.nameId), Li(e, a), yi(e, a));
  let c = zi(e, a);
  return Br({
    affectedAncestorIds: xi(e, a),
    affectedNodeIds: s,
    path: t,
    projectionChanged: Bi(o, c),
...
function gi(e, t, n, r) {
  ...
  let a = q(e, i);
  if (U(a, 2)) throw Error(`The root node cannot be moved`);
  let o = r.collision ?? `error`,
    s = Pi(e, i, n),
    c = zi(e, a.parentId),
    l = zi(e, s.parentId),
    u = nr(e.snapshot.segmentTable, a.nameId),
    d = tr(e.snapshot.segmentTable, s.basename);
  if (s.parentId === a.parentId && u === s.basename) return null;
  if (H(a) && Wi(e, i, s.parentId))
    throw Error(`Cannot move a directory into one of its descendants`);
  let f = an(e.snapshot.nodes, K(e, s.parentId)).get(d),
    p = s.existingNodeId ?? f ?? null;
  if (p != null && p !== i && Fi(e, p, o, xn(a)) === `skip`) return null;
  let m = a.parentId;
  (Ai(e, m, i, a.nameId),
    ...
    e.pathCacheVersion++,
    yi(e, m),
    s.parentId !== m && yi(e, s.parentId));
  let h = zi(e, m),
    g = zi(e, s.parentId);
  return Vr({
    affectedAncestorIds: [...new Set([...xi(e, m), ...xi(e, s.parentId)])],
    affectedNodeIds: [i],
    from: t,
    projectionChanged: Vi([c, l], [h, g]),
    to: G(e, i),
  });
}
function _i(e, t) {
...
function G(e, t) {
  let n = q(e, t),
    r = _i(e, t);
  if (r != null) return r;
  if (U(n, 2)) return vi(e, t, ``);
  let i = G(e, n.parentId),
    a = nr(e.snapshot.segmentTable, n.nameId),
    o = i.length === 0 ? a : `${i}${a}`;
  return vi(e, t, H(n) ? `${o}/` : o);
}
function yi(e, t) {
  let n = e.instrumentation;
  if (n == null) {
  ...
  W(n, `store.recomputeCountsUpwardFrom`, () => Ki(e, t));
}
function bi(e, t) {
  let n = [[t, 0]],
...
function Si(e, t) {
  ...
  let n = Qn(t);
  return Ci(e, n.segments, n.requiresDirectory);
}
function Ci(e, t, n) {
...
function q(e, t) {
  let n = e.snapshot.nodes[t];
  if (n === void 0 || U(n, 4)) throw Error(`Unknown node ID: ${String(t)}`);
  return n;
}
function wi(e, t) {
  let n = e.snapshot.nodes[t];
  if (n === void 0 || U(n, 4)) return [];
  if (!H(n)) return [G(e, t)];
  if (K(e, t).childIds.length === 0) return U(n, 1) && !U(n, 2) ? [G(e, t)] : [];
  let r = [],
  ...
  for (; i.length > 0; ) {
    ...
    if (a.childIds.length === 0) {
      (U(n, 1) && !U(n, 2) && r.push(G(e, t.nodeId)), i.pop());
      continue;
    }
...
function Ti(e, t) {
  let n = [],
    r = e.snapshot.rootId;
  for (let i of t) {
    let t = tr(e.snapshot.segmentTable, i),
      a = K(e, r),
      o = an(e.snapshot.nodes, a).get(t);
    if (o !== void 0) {
      if (!H(q(e, o)))
...
function Ei(e, t, n) {
  ...
  return (
    e.snapshot.nodes.push({
      depthAndFlags: yn(bn(r) + 1, 0, 1),
      nameId: n,
      parentId: t,
      subtreeNodeCount: 1,
      visibleSubtreeCount: 1,
    }),
    e.snapshot.directories.set(i, nn()),
    ki(e, t, i),
...
function Di(e, t, n) {
  let r = tr(e.snapshot.segmentTable, n),
    i = K(e, t);
  if (an(e.snapshot.nodes, i).has(r)) throw Error(`Path already exists: "${Ji(e, t, n)}"`);
  let a = q(e, t),
    o = e.snapshot.nodes.length;
  return (
    e.snapshot.nodes.push({
      depthAndFlags: yn(bn(a) + 1, 0),
      nameId: r,
      parentId: t,
      subtreeNodeCount: 1,
      visibleSubtreeCount: 1,
...
function ki(e, t, n) {
  let r = K(e, t),
    i = q(e, n);
  (an(e.snapshot.nodes, r).set(i.nameId, n), un(r, n, i.subtreeNodeCount, i.visibleSubtreeCount));
  let a = Oi(e, r, n);
  (r.childIds.splice(a, 0, n), cn(r, a), pn(e.snapshot.nodes, r));
}
function Ai(e, t, n, r) {
  let i = K(e, t),
    a = on(i),
    o = a.get(n) ?? -1;
  (an(e.snapshot.nodes, i).delete(r), a.delete(n));
  let s = e.snapshot.nodes[n];
  (s != null && un(i, n, -s.subtreeNodeCount, -s.visibleSubtreeCount),
    o >= 0 && (i.childIds.splice(o, 1), cn(i, o), pn(e.snapshot.nodes, i)));
}
function ji(e, t, n) {
  let r = e.snapshot.options.sort;
  return r === `default` ? Mi(e, t, n) : r(Ni(e, t), Ni(e, n));
}
function Mi(e, t, n) {
  let r = q(e, t),
    i = q(e, n),
    a = H(r);
  if (a !== H(i)) return a ? -1 : 1;
  let o = zn(Kn(e.snapshot.segmentTable, r.nameId), Kn(e.snapshot.segmentTable, i.nameId));
  if (o !== 0) return o;
  let s = nr(e.snapshot.segmentTable, r.nameId),
    c = nr(e.snapshot.segmentTable, i.nameId);
...
function Ni(e, t) {
  let n = q(e, t),
    ...
    a = i ? r.slice(0, -1) : r;
  return {
    basename: nr(e.snapshot.segmentTable, n.nameId),
    depth: bn(n),
    isDirectory: i,
    path: r,
...
function Pi(e, t, n) {
  ...
  if (i != null) {
    let t = q(e, i);
    if (H(t))
      return { basename: nr(e.snapshot.segmentTable, r.nameId), existingNodeId: null, parentId: i };
    let a = Qn(n).segments;
  ...
  let a = Qn(n),
    ...
    c = s.length === 0 ? e.snapshot.rootId : Ci(e, s, !0);
...
function Fi(e, t, n, r) {
  ...
  let i = q(e, t);
  if (xn(i) !== r) throw Error(`replace collision requires the same source and destination kinds`);
  if (H(i) && K(e, t).childIds.length > 0)
    throw Error(`replace collision does not support non-empty directories`);
  let a = i.parentId,
    o = i.nameId;
  return (Ii(e, t), Ai(e, a, t, o), Li(e, a), yi(e, a), `handled`);
}
function Ii(e, t) {
  let n = [],
  ...
  for (; r.length > 0; ) {
    ...
    if (t == null) break;
    let i = q(e, t.nodeId);
    if (t.visitedChildren || !H(i)) {
      (H(i) && e.snapshot.directories.delete(t.nodeId),
        Cn(i, 4),
...
function Li(e, t) {
  ...
  for (; n != null; ) {
    let t = q(e, n);
    if (!H(t) || U(t, 2) || K(e, n).childIds.length > 0) return;
    (Cn(t, 1), (n = t.parentId === n ? null : t.parentId));
  }
}
function Ri(e, t) {
  ...
  for (let r of t) {
    ...
    if (t == null) break;
    let i = an(e.snapshot.nodes, K(e, n)).get(t);
    if (i == null || !H(q(e, i))) break;
    n = i;
  }
  return n;
}
...
function Ui(e, t) {
  let n = q(e, t);
  if ((wn(n, (t === e.snapshot.rootId ? -1 : bn(q(e, n.parentId))) + 1), !H(n))) return;
  let r = K(e, t);
  for (let t of r.childIds) Ui(e, t);
}
function Wi(e, t, n) {
  let r = n;
  for (; r != null; ) {
...
function Gi(e, t, n = q(e, t), r = !1) {
  let i = e.instrumentation;
  if (i == null) {
    qi(e, t, n, r);
    return;
  }
  W(i, `store.recomputeNodeCounts`, () => qi(e, t, n, r));
}
function Ki(e, t) {
  let n = t;
  for (; n != null; ) {
    ...
    if ((Gi(e, n, t), n === e.snapshot.rootId)) return;
    let a = t.subtreeNodeCount - r,
      o = t.visibleSubtreeCount - i,
      s = t.parentId;
    ((a !== 0 || o !== 0) && un(K(e, s), n, a, o), (n = s));
  }
}
function qi(e, t, n, r) {
  if (!H(n)) {
  ...
  if (r) {
    ...
    t == null
      ? ln(e.snapshot.nodes, i)
      : W(t, `store.recomputeNodeCounts.rebuildChildAggregates`, () => ln(e.snapshot.nodes, i));
  }
  let a = 1 + i.totalChildSubtreeNodeCount,
    o = i.totalChildVisibleSubtreeCount;
  if (((n.subtreeNodeCount = a), U(n, 2))) {
    n.visibleSubtreeCount = o;
    return;
  }
  n.visibleSubtreeCount = li(e, t) == null ? (Dr(e, t, n) ? 1 + o : 1) : o;
}
function Ji(e, t, n) {
  let r = G(e, t);
...
function Zi(e, t) {
  let n = e.snapshot.nodes[t];
  return !Xi(n) || !H(n) || U(n, 2) ? null : n;
}
function Qi(e) {
  let t = 0;
  for (let [n, r] of e.pathCacheByNodeId)
    r.version === e.pathCacheVersion && Xi(e.snapshot.nodes[n]) && (t += 1);
  return t;
}
function $i(e) {
...
function ea(e) {
  return {
    ...
    cachedPathEntryCount: Qi(e),
    loadInfoEntryCount: e.directoryLoadInfoById.size,
    segmentCount: $i(e.snapshot.segmentTable),
...
function na(e) {
  let t = [],
    n = [];
  for (let n of e.collapsedDirectoryIds) Zi(e, n) != null && t.push(G(e, n));
  for (let t of e.expandedDirectoryIds) Zi(e, t) != null && n.push(G(e, t));
...
function ia(e, t) {
  ...
  for (let n of t.expandedPaths) {
    let t = Si(e, n);
    t != null && Or(e, t, !0, q(e, t));
  }
  for (let n of t.collapsedPaths) {
    let t = Si(e, n);
    t != null && Or(e, t, !1, q(e, t));
  }
}
function aa(e, t) {
...
function ua(e) {
  let t = na(e),
    n = ra(e);
  (W(e.instrumentation, `store.cleanup.stable.clearPathCaches`, () => oa(e)),
    W(e.instrumentation, `store.cleanup.stable.rebuildSegmentTable`, () => sa(e)),
    W(e.instrumentation, `store.cleanup.stable.rebuildDirectoryIndexes`, () => ca(e)),
    W(e.instrumentation, `store.cleanup.stable.trimTrailingRemovedNodeSlots`, () => la(e)),
    W(e.instrumentation, `store.cleanup.stable.restoreExpansionOverrides`, () => ia(e, t)),
    W(e.instrumentation, `store.cleanup.stable.restoreDirectoryLoadInfos`, () => aa(e, n)),
    W(e.instrumentation, `store.cleanup.stable.recomputeCounts`, () => bi(e, e.snapshot.rootId)));
}
function da(e) {
  let t = na(e),
    n = ra(e),
    r = W(e.instrumentation, `store.cleanup.aggressive.listPaths`, () => pi(e)),
    i = An({ ...e.snapshot.options }, e.instrumentation),
    a = W(e.instrumentation, `store.cleanup.aggressive.rebuildSnapshot`, () => {
      let e = new xr(i);
  ...
  ((e.snapshot = a),
    ...
    W(e.instrumentation, `store.cleanup.aggressive.restoreExpansionOverrides`, () => ia(e, t)),
    W(e.instrumentation, `store.cleanup.aggressive.restoreDirectoryLoadInfos`, () => aa(e, n)),
    W(e.instrumentation, `store.cleanup.aggressive.recomputeCounts`, () =>
      bi(e, e.snapshot.rootId),
    ));
}
function fa(e) {
...
function pa(e, t) {
  let n = ea(e);
  t === `stable`
    ? W(e.instrumentation, `store.cleanup.stable`, () => ua(e))
    : W(e.instrumentation, `store.cleanup.aggressive`, () => da(e));
  let r = ea(e);
  return ta(t, t === `stable`, n, r);
}
var ma = e(() => {
  (vn(), kn(), Pn(), ir(), Sr(), Lr(), Yi());
});
function ha(e, t) {
  let n = t + 2;
...
function va(e, t, n, r) {
  return {
    ...
    row: La(e, t.cursor),
    setSize: t.setSize,
    subtreeEndIndex: _a(e, t.cursor, t.index, n),
  };
}
function ya(e, t, n, r, i, a) {
  let o = K(e, t),
    { childIndex: s, childVisibleIndex: c, localVisibleIndex: l } = dn(e.snapshot.nodes, o, n),
    u = o.childIds[s];
  if (u == null) throw Error(`Visible index ${String(n)} is out of range`);
  return ba(e, u, l, r + c, i + 1, s, o.childIds.length, a);
}
function ba(e, t, n, r, i, a, o, s) {
  ...
  if (!H(l) || !Dr(e, c.terminalNodeId, l))
    throw Error(`Visible index ${String(n)} is out of range for collapsed directory`);
  return ya(e, c.terminalNodeId, n - 1, r + 1, c.visibleDepth, [
    ...s,
...
function xa(e, t) {
  ...
  let r = ya(e, e.snapshot.rootId, t, 0, -1, []),
  ...
  return {
    ...
    row: La(e, r.cursor),
    setSize: r.setSize,
    subtreeEndIndex: _a(e, r.cursor, r.index, n),
  };
}
function Sa(e, t, n) {
  ...
  let s = [],
    c = 0,
    l = 0,
    u = W(r, `store.getVisibleSlice.selectFirstRow`, () => Oa(e, a));
  for (let t = a; t <= o && u != null; t++) {
    let t = W(r, `store.getVisibleSlice.materializeRow`, () => La(e, u));
    (s.push(t),
      t.isFlattened && (c++, (l += t.flattenedSegments?.length ?? 0)),
      (u = W(r, `store.getVisibleSlice.advanceCursor`, () => Na(e, u))));
  }
  return (
    Mn(r, `workload.visibleRowsRead`, s.length),
    Mn(r, `workload.flattenedRowsRead`, c),
    Mn(r, `workload.flattenedSegmentsRead`, l),
    s
  );
}
function Ca(e, t = ga(e)) {
  let n = e.instrumentation;
  return n == null ? Fa(e, t) : W(n, `store.getVisibleTreeProjection`, () => Fa(e, t));
}
function wa(e) {
  return Pa(Ca(e));
}
function Ta(e, t) {
  let n = Si(e, t);
  if (n == null || n === e.snapshot.rootId || (H(q(e, n)) && ui(e, n) !== n)) return null;
  let r = 0,
    i = n,
...
function Ea(e, t) {
  ...
  let r = q(e, n);
  if (!H(r)) throw Error(`Path is not a directory: "${t}"`);
  return Dr(e, n, r)
    ? null
    : (Or(e, n, !0, r),
      yi(e, n),
      Hr({ affectedAncestorIds: xi(e, n), affectedNodeIds: [n], path: t, projectionChanged: !0 }));
}
function Da(e, t) {
  let n = Si(e, t);
  if (n == null) throw Error(`Path does not exist: "${t}"`);
  ...
  return Dr(e, n, r)
    ? (Or(e, n, !1, r),
      yi(e, n),
      Ur({ affectedAncestorIds: xi(e, n), affectedNodeIds: [n], path: t, projectionChanged: !0 }))
    : null;
}
function Oa(e, t) {
  return t < 0 || t >= ga(e) ? null : ka(e, e.snapshot.rootId, t, -1);
}
function ka(e, t, n, r) {
  let i = K(e, t),
    a = e.instrumentation,
    { childIndex: o, localVisibleIndex: s } =
      a == null
        ? dn(e.snapshot.nodes, i, n)
        : W(a, `store.getVisibleSlice.selectChildIndex`, () => dn(e.snapshot.nodes, i, n)),
    c = i.childIds[o];
  if (c != null) return Aa(e, c, s, r + 1);
...
function Aa(e, t, n, r) {
  ...
  if (!H(a) || !Dr(e, i.terminalNodeId, a))
    throw Error(`Visible index ${String(n)} is out of range for collapsed directory`);
  return ka(e, i.terminalNodeId, n - 1, i.visibleDepth);
}
function ja(e, t, n) {
  return H(q(e, t))
    ? e.instrumentation == null
      ? { headNodeId: t, terminalNodeId: ui(e, t), visibleDepth: n }
      : {
          headNodeId: t,
          terminalNodeId: W(
            e.instrumentation,
...
function Ma(e, t) {
  ...
  if (!H(n)) return !0;
  let r = n.parentId;
  return r === e.snapshot.rootId ? !0 : li(e, r) !== t;
}
function Na(e, t) {
  let n = q(e, t.terminalNodeId);
  if (H(n)) {
    let r = K(e, t.terminalNodeId);
    if (Dr(e, t.terminalNodeId, n) && r.childIds.length > 0) {
      let n = r.childIds[0];
      return n == null ? null : Aa(e, n, 0, t.visibleDepth + 1);
    }
  }
...
function Fa(e, t) {
  ...
  for (; d.length > 0 && s < t; ) {
    ...
    let x,
      S = _;
    if (H(v)) ((S = f ? ui(e, _) : _), (x = S === _ ? `${b}${h[v.nameId]}/` : G(e, S)));
    else {
      let e = p.get(_);
    ...
    let C = c[S];
    C != null && H(C) && Dr(e, S, C) && d.push([l.get(S), 0, y, x]);
  }
  s < t && (n.length = s);
...
function Ia(e, t) {
  ...
  for (; s.length > 0 && r < t; ) {
    ...
    n[r++] = La(e, g);
    let _ = i[h];
    _ != null && H(_) && Dr(e, h, _) && s.push([a.get(h), 0, m]);
  }
...
function La(e, t) {
  let n = q(e, t.terminalNodeId),
    ...
    a = nr(e.snapshot.segmentTable, n.nameId),
    o = H(n) && K(e, t.terminalNodeId).childIds.length > 0,
    s = t.headNodeId !== t.terminalNodeId,
    c = e.instrumentation,
    l = s
      ? c == null
        ? di(e, t.headNodeId).map((n) => {
            let r = q(e, n);
            return {
              isTerminal: n === t.terminalNodeId,
              name: nr(e.snapshot.segmentTable, r.nameId),
              nodeId: n,
              path: G(e, n),
            };
          })
        : W(c, `store.getVisibleSlice.flatten.collectSegments`, () =>
            di(e, t.headNodeId).map((n) => {
              let r = q(e, n);
              return {
                isTerminal: n === t.terminalNodeId,
  ...
  return {
    ...
    hasChildren: o,
    id: t.terminalNodeId,
    isExpanded: H(n) && Dr(e, t.terminalNodeId, n),
    isFlattened: s,
    isLoading: r === `loading`,
    kind: H(n) ? `directory` : `file`,
...
function Ra(e, t) {
  if (t.headNodeId === t.terminalNodeId) return Ar(e, t.terminalNodeId);
  let n = di(e, t.headNodeId),
    r = !1,
    i = !1;
  for (let t of n) {
    let n = Ar(e, t);
  ...
  Ga = e(() => {
    (vn(),
      ...
      (Wa = class e {
        ...
        constructor(e = {}) {
          let t = jn(e),
            n = W(t, `store.builder.create`, () => new xr(e));
          if (e.preparedInput != null) {
            let t = _r(e.preparedInput);
            t == null
              ? n.appendPreparedPaths(gr(e.preparedInput), !1)
              : n.appendPresortedPaths(t, vr(e.preparedInput));
          } else {
            let r = e.paths ?? [];
            e.presorted === !0
              ? n.appendPaths(r)
              : n.appendPreparedPaths(W(t, `store.preparePathEntries`, () => yr(r, e)));
          }
          let r = W(t, `store.builder.finish`, () => n.finish({ skipSubtreeCountPass: !0 })),
            i = W(
              t,
          ...
          ((this.#e = W(t, `store.state.create`, () =>
            Cr(r, i ? `open` : (e.initialExpansion ?? `closed`), t),
          )),
            i && (this.#e.collapseNewDirectoriesByDefault = !0));
          let a = i
            ? this.#e.snapshot.directories.size - 1
            : W(t, `store.state.initializeExpandedPaths`, () =>
          ...
          ((e.initialExpandedPaths?.length ?? 0) > 0 &&
            W(t, `store.state.checkAllDirectoriesExpanded`, () => this.hasAllDirectoriesExpanded()))
            ? W(t, `store.state.initializeOpenVisibleCounts`, () => Va(this.#e))
            : W(t, `store.state.recomputeCounts`, () => bi(this.#e, this.#e.snapshot.rootId));
        }
        ...
        list(e) {
          return W(this.#e.instrumentation, `store.list`, () => pi(this.#e, e));
        }
        add(e) {
          W(this.#e.instrumentation, `store.add`, () => {
            let t = ga(this.#e);
            Qr(this.#e, Xr(this.#e, t, mi(this.#e, e)));
          });
        }
        remove(e, t = {}) {
          W(this.#e.instrumentation, `store.remove`, () => {
            let n = ga(this.#e);
            Qr(this.#e, Xr(this.#e, n, hi(this.#e, e, t)));
          });
        }
        move(e, t, n = {}) {
          W(this.#e.instrumentation, `store.move`, () => {
            let r = ga(this.#e),
              i = gi(this.#e, e, t, n);
            i != null && Qr(this.#e, Xr(this.#e, r, i));
          });
        }
        batch(e) {
          Zr(this.#e, () => {
        ...
        getVisibleCount() {
          return W(this.#e.instrumentation, `store.getVisibleCount`, () => ga(this.#e));
        }
        getVisibleSlice(e, t) {
          return W(this.#e.instrumentation, `store.getVisibleSlice`, () => Sa(this.#e, e, t));
        }
        getVisibleRowContext(e) {
          return W(this.#e.instrumentation, `store.getVisibleRowContext`, () => xa(this.#e, e));
        }
        ...
        getVisibleIndex(e) {
          return W(this.#e.instrumentation, `store.getVisibleIndex`, () => Ta(this.#e, e));
        }
        getPathInfo(e) {
          return W(this.#e.instrumentation, `store.getPathInfo`, () => {
            let t = Si(this.#e, e);
            if (t == null) return null;
            let n = q(this.#e, t);
            return { depth: bn(n), kind: H(n) ? `directory` : `file`, path: G(this.#e, t) };
          });
        }
        isExpanded(e) {
          return W(this.#e.instrumentation, `store.isExpanded`, () => {
        ...
        expand(e) {
          W(this.#e.instrumentation, `store.expand`, () => {
            let t = ga(this.#e),
              n = Ea(this.#e, e);
            n != null && Qr(this.#e, Xr(this.#e, t, n));
          });
        }
        collapse(e) {
          W(this.#e.instrumentation, `store.collapse`, () => {
            let t = ga(this.#e),
              n = Da(this.#e, e);
            n != null && Qr(this.#e, Xr(this.#e, t, n));
          });
        ...
        markDirectoryUnloaded(e) {
          W(this.#e.instrumentation, `store.markDirectoryUnloaded`, () => {
            let t = this.requireDirectoryNodeId(e);
            ...
            (Mr(this.#e, t),
              Qr(
                ...
                Xr(
                  ...
                  n,
                  Wr({
                    affectedAncestorIds: xi(this.#e, t),
                    affectedNodeIds: [t],
                    path: e,
        ...
        beginChildLoad(e) {
          return W(this.#e.instrumentation, `store.beginChildLoad`, () => {
            let t = this.requireDirectoryNodeId(e),
              n = ga(this.#e),
              r = jr(this.#e, t);
            return (
        ...
        applyChildPatch(e, t) {
          return W(this.#e.instrumentation, `store.applyChildPatch`, () => {
            let n = this.resolveActiveDirectoryNodeId(e.nodeId);
            if (n == null || Ar(this.#e, n) !== `loading` || !Pr(this.#e, n, e.attemptId))
              return !1;
            let r = G(this.#e, n);
            ...
            for (let e of t.operations) {
              ...
              switch (e.type) {
                case `add`:
                  a.push(Xr(this.#e, t, mi(this.#e, e.path)));
                  break;
                case `remove`:
                  a.push(Xr(this.#e, t, hi(this.#e, e.path, { recursive: e.recursive })));
                  break;
                case `move`: {
                  let n = gi(this.#e, e.from, e.to, { collision: e.collision });
                  n != null && a.push(Xr(this.#e, t, n));
                  break;
                }
              }
            }
            ...
            return (
              Qr(
                ...
                Xr(
                  ...
                  i,
                  Kr({
                    affectedAncestorIds: xi(this.#e, n),
                    affectedNodeIds: [n],
                    attemptId: e.attemptId,
                    childEvents: a,
                    path: G(this.#e, n),
        ...
        completeChildLoad(e) {
          return W(this.#e.instrumentation, `store.completeChildLoad`, () => {
            let t = this.resolveActiveDirectoryNodeId(e.nodeId);
            if (t == null) return !1;
            let n = ga(this.#e),
              r = Nr(this.#e, t, e.attemptId);
            return (
              Qr(
                this.#e,
                Xr(
        ...
        failChildLoad(e, t) {
          return W(this.#e.instrumentation, `store.failChildLoad`, () => {
            let n = this.resolveActiveDirectoryNodeId(e.nodeId);
            if (n == null) return !1;
            let r = ga(this.#e),
              i = Fr(this.#e, n, e.attemptId, t);
            return (
              Qr(
                this.#e,
                Xr(
        ...
        cleanup(e = {}) {
          return W(this.#e.instrumentation, `store.cleanup`, () => {
            if (this.#e.transactionStack.length > 0)
              throw Error(`Cleanup cannot run during an open batch or transaction.`);
            if (fa(this.#e)) throw Error(`Cleanup cannot run while directory loads are active.`);
            let t = ga(this.#e),
              n = pa(this.#e, e.mode ?? `stable`);
            return (
              Qr(
                this.#e,
                Xr(
        ...
        initializeExpandedPaths(e) {
          ...
          for (let u of e) {
            ...
            for (let e = d; e < m; e += 1) {
              ...
              if (n == null) continue;
              let i = q(this.#e, n);
              Dr(this.#e, n, i) || (Or(this.#e, n, !0, i), (t += 1));
            }
          }
          return t;
        }
        ...
        requireDirectoryNodeId(e) {
          ...
          if (!H(q(this.#e, t))) throw Error(`Path is not a directory: "${e}"`);
          return t;
        }
        resolveActiveDirectoryNodeId(e) {
          try {
            if (!H(q(this.#e, e))) throw Error(`Node is not a directory: ${String(e)}`);
            return e;
          } catch {
            return null;
          }
...
function Ka(e, t) {
  if (typeof e == `number`) return { itemHeight: t ?? qa.default.itemHeight, factor: e };
  let n = qa[e ?? `default`];
...
var qa,
  ...
  Ya,
  Xa = e(() => {
    (Ja(), (Ya = qa.default.itemHeight));
  }),
  Za,
  Qa = e(() => {
    Za = `@layer base, theme, unsafe;
...
var to,
  no = e(() => {
    to = `@layer base, unsafe;`;
  });
function ro(e) {
  let t = ao.get(e);
  if (t != null) return t;
  let n = document.createElement(`div`);
  n.setAttribute(Bt, `true`);
  ...
  return (n.remove(), ao.set(e, i), i);
}
function io(e, t) {
  if (!e.isConnected) return;
  let n = ro(t);
  if (n == null) return;
  let r = t.querySelector(`style[${Vt}]`),
    i = r instanceof HTMLStyleElement ? r : document.createElement(`style`);
  (r instanceof HTMLStyleElement || (i.setAttribute(Vt, ``), t.appendChild(i)),
    (i.textContent = `:host { ${Ht}: ${n}px; }`));
}
var ao,
  oo = e(() => {
    (Kt(), (ao = new WeakMap()));
...
function so(e) {
  if (
    ...
    uo ?? ((uo = new CSSStyleSheet()), uo.replaceSync($a(Za)));
    let t = !1;
    try {
      ((e.adoptedStyleSheets = [uo]), (t = !0));
    } catch {}
    if (t) {
      e.querySelector(`style[${Rt}]`)?.remove();
      return;
    }
  }
  if (e.querySelector(`style[data-file-tree-style]`) == null) {
    let t = document.createElement(`style`);
    (t.setAttribute(Rt, ``), (t.textContent = $a(Za)), e.prepend(t));
  }
}
function co(e, t) {
  (lo(e, t), so(t), io(e, t));
...
var uo,
  fo = e(() => {
    if (
      ...
      if ((customElements.define(Lt, e), typeof document < `u`))
        for (let e of Array.from(document.querySelectorAll(Lt)))
          e instanceof HTMLElement && co(e, e.shadowRoot ?? e.attachShadow({ mode: `open` }));
    }
  }),
  po,
  mo = e(() => {
    (Kt(), (po = (e) => (e.startsWith(`f::`) ? e.slice(3) : e)));
  });
function ho(e) {
  let t = e.lastIndexOf(`/`);
  return t < 0
...
function To(e, t) {
  ...
  for (let n of e) if (yo(n) && (t.directoryPath === n || t.directoryPath.startsWith(n))) return !0;
  return !1;
}
function Eo(e, t) {
  return t.kind === `root` || t.directoryPath == null ? bo(e) : t.directoryPath;
}
function Do(e, t) {
  let n = e
    .map((e) => {
...
function Ao(e, t, n) {
  ...
  if (!ko(Wa.preparePaths(r, n == null ? {} : { sort: n }), a))
...
function Fo(e, t, n = !1) {
  ...
  switch (t.operation) {
    ...
    case `cleanup`:
      return e;
    case `remove`:
      return Po(e, t.path) ? (n ? e : null) : e;
    case `move`:
      return No(e, t.from, t.to);
    case `batch`: {
      let r = e;
      for (let e of t.events) if (((r = Fo(r, e, n)), r == null)) return null;
      return r;
    }
  }
}
...
function Lo(e) {
  switch (e.operation) {
    case `add`:
      return { ...Io(e), operation: `add`, path: e.path };
    case `remove`:
      return { ...Io(e), operation: `remove`, path: e.path, recursive: e.recursive };
    case `move`:
      return { ...Io(e), from: e.from, operation: `move`, to: e.to };
  }
}
function Ro(e) {
  return {
...
function ns(e, t, n) {
  ...
  return {
    focusedIndex: ts(e.paths.length, r, t),
    getParentIndex: e.getParentIndex,
    paths: e.paths,
    posInSetByIndex: e.posInSetByIndex,
    setSizeByIndex: e.setSizeByIndex,
...
var rs,
  ...
  ss = e(() => {
    (Ga(),
      ...
      Zo(),
      $o(),
      (rs = Symbol(`FILE_TREE_RENAME_VIEW`)),
      (is = 512),
      (as = 512),
      (os = class {
        #e;
        ...
        constructor(e) {
          let {
            ...
            u = Ao({ paths: s, preparedInput: c }, `constructor`, l.sort);
          ((this.#e = l),
        ...
        scrollToPath(e, t) {
          ...
          r < 0 ||
            (this.#Me(r) != null &&
              ...
              (this.#L = { id: (this.#R += 1), offset: es(t?.offset), visibleIndex: r }),
              this.#De()));
        }
        ...
        getVisibleRows(e, t) {
          ...
          if (r < n) return [];
          let i = r - n + 1;
          if (this.#F == null && !this.#l && r >= this.#b.length && i <= as) {
            let e = [];
            for (let t = n; t <= r; t += 1) {
        ...
        setDragTarget(e) {
          ...
          let n = e;
          if (n != null) {
            let e = wo(t.draggedPaths, n);
            (To(t.draggedPaths, n) || this.#r?.canDrop?.(e) === !1) && (n = null);
          }
          Co(t.target, n) || ((this.#i = { ...t, target: n }), this.#De());
        }
        cancelDrag() {
        ...
        completeDrag() {
          ...
          let n = wo(e.draggedPaths, t);
          if (To(e.draggedPaths, t) || this.#r?.canDrop?.(n) === !1) return (this.#De(), !1);
          let r = Do(e.draggedPaths, t);
        ...
        startRenaming(e = this.#c ?? ``, t = {}) {
          ...
          for (let e of Ho(r)) this.#H.isExpanded(e) || this.#H.expand(e);
          return (
            this.#ae([r], r, !1),
        ...
        #q() {
          ...
          if (((this.#T = null), (this.#E = ``), (this.#D = !1), t)) {
            this.remove(e, Go(e) ? { recursive: !0 } : void 0);
            return;
          }
          (this.#Pe(e), this.#De());
        }
        #J() {
          ...
          let t = Go(e),
            n = _o({ files: this.#H.list(), isFolder: t, nextBasename: this.#E, path: Yo(e) });
          ...
          (this.#_?.({
            ...
            this.move(Xo(n.sourcePath, t), Xo(n.destinationPath, t)));
        }
        #Y(e) {
        ...
        resetPaths(e, t = {}) {
          let n = this.#H.list().length,
            r = this.#G,
            i = Ao({ paths: e, preparedInput: t.preparedInput }, `resetPaths`, this.#e.sort),
        ...
        #de() {
          ...
          for (let t of this.#ue()) {
            e.add(t);
            for (let n of Ho(t)) e.add(n);
          }
          return ((this.#m = [...e].sort()), this.#m);
        }
        #fe() {
          return ((this.#g ??= this.#ue().map(Ko)), this.#g);
        }
        #pe() {
          return ((this.#f ??= this.#de().filter((e) => e.endsWith(`/`))), this.#f);
        }
        #me() {
          return ((this.#p ??= this.#pe().map(Ko)), this.#p);
        }
        #he() {
          ((this.#f = null),
            (this.#p = null),
        ...
        #_e(e) {
          ...
          if (e) for (let e of this.#B) for (let n of Ho(e)) t.add(n);
          this.#ve(t);
        }
        #ve(e) {
          this.#W = !0;
        ...
        #Ee() {
          ...
          for (let e of r) {
            ...
            for (let t of Ho(e)) (l.add(t), c?.add(t));
          }
        ...
        #ke(e) {
          for (let t of Ho(e)) this.#H.isExpanded(t) || this.#H.expand(t);
        ...
        #je(e, t = !0) {
          ...
          this.#U = n;
          let r = ns(
            this.#H.getVisibleTreeProjectionData(t ? void 0 : Math.min(n, is)),
            e,
        ...
        #Le(e) {
          ...
          let n = Fo(this.#c, e, !0),
            ...
            o = [...new Set(r)];
          return (Vo(this.#B, o) || ((this.#B = new Set(o)), (this.#V += 1)), (this.#z = a), n);
        }
        #Re() {
          return this.#H.on(`*`, (e) => {
            if (this.#W) return;
            (e.canonicalChanged && (this.#d.clear(), this.#he()),
              this.#i != null && Mo(e) && (this.#i = null));
            let t = Mo(e) ? this.#Le(e) : this.#c,
...
function _s(e, t, n) {
  ...
  return (
    arguments.length > 2 && (o.children = arguments.length > 3 ? ec.call(arguments, 2) : n),
    vs(e, o, r, i, null)
  );
}
...
function xs(e, t) {
  if (t == null) return e.__ ? xs(e.__, e.__i + 1) : null;
  for (var n; t < e.__k.length; t++) if ((n = e.__k[t]) != null && n.__e != null) return n.__e;
  return typeof e.type == `function` ? xs(e) : null;
}
function Ss(e) {
  var t, n;
...
function Cs(e) {
  ((8 & e.__g || !(e.__g |= 8) || !Us.push(e) || Gs++) && Ws == J.debounceRendering) ||
    ((Ws = J.debounceRendering) || queueMicrotask)(ws);
}
function ws() {
  for (var e, t, n, r, i, a, o, s, c = 1; Us.length; )
    (Us.length > c && Us.sort(Ks),
      (e = Us.shift()),
      (c = Us.length),
      8 & e.__g &&
        ((n = void 0),
...
function Ts(e, t, n, r, i, a, o, s, c, l, u, d) {
  var f,
    p,
    m,
    h,
    ...
    y = (r && r.__k) || Qs,
    b = t.length;
  for (c = Es(n, t, y, c, b), f = 0; f < b; f++)
    (m = n.__k[f]) != null &&
      ((p = m.__i == -1 ? Zs : y[m.__i] || Zs),
      (m.__i = f),
      (_ = Ms(e, m, p, i, a, o, s, c, l, u, d)),
      (h = m.__e),
      m.ref && p.ref != m.ref && (p.ref && Ls(p.ref, null, m), u.push(m.ref, m.__c || h, m)),
      g == null && h != null && (g = h),
...
function Es(e, t, n, r, i) {
      ...
      ? ((c = a + f),
        ((o = e.__k[a] =
          ...
          o.constructor == String
            ? vs(null, o, null, null, null)
            : $s(o)
              ? vs(ys, { children: o }, null, null, null)
              : o.constructor == null && o.__b > 0
                ? vs(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v)
                : o).__ = e),
        (o.__b = e.__b + 1),
        (s = null),
  ...
  if (d)
    for (a = 0; a < u; a++)
      (s = n[a]) != null && !(2 & s.__u) && (s.__e == r && (r = xs(s)), Rs(s, s));
  return r;
}
function Ds(e, t, n, r) {
  var i, a;
  if (typeof e.type == `function`) {
    for (i = e.__k, a = 0; i && a < i.length; a++) i[a] && ((i[a].__ = e), (t = Ds(i[a], t, n, r)));
    return t;
  }
  e.__e != t &&
    (r && (t && e.type && !t.parentNode && (t = xs(e)), n.insertBefore(e.__e, t || null)),
    (t = e.__e));
  do t &&= t.nextSibling;
  ...
  n: if (t == `style`)
    if (typeof n == `string`) e.style.cssText = n;
      ...
      if ((typeof r == `string` && (e.style.cssText = r = ``), r))
        for (t in r) (n && t in n) || ks(e.style, t, ``);
      if (n) for (t in n) (r && n[t] == r[t]) || ks(e.style, t, n[t]);
    }
  else if (t[0] == `o` && t[1] == `n`)
    ((a = t != (t = t.replace(qs, `$1`))),
      ...
      n
        ? r
          ? (n.l = r.l)
          : ((n.l = Js), e.addEventListener(t, a ? Xs : Ys, a))
        : e.removeEventListener(t, a ? Xs : Ys, a));
  else {
...
function Ms(e, t, n, r, i, a, o, s, c, l, u) {
  var d,
    f,
    p,
    m,
    ...
    try {
      if (
        ...
        n.__c
          ...
          : (y
              ? (t.__c = f = new O(v, x))
              : ((t.__c = f = new bs(v, x)), (f.constructor = O), (f.render = zs)),
            b && b.sub(f),
            (f.props = v),
            (f.state ||= {}),
            (f.context = x),
        ...
        y &&
          ...
          (f.__s == f.state && (f.__s = tc({}, f.__s)),
          tc(f.__s, O.getDerivedStateFromProps(v, f.__s))),
        (m = f.props),
        (h = f.state),
        (f.__v = t),
        p)
      ...
      if (((f.context = x), (f.props = v), (f.__P = e), (f.__g &= -5), (C = J.__r), (w = 0), y)) {
        for (
          f.state = f.__s,
            f.__g &= -9,
            C && C(t),
        ...
        while (8 & f.__g && ++w < 25);
      ((f.state = f.__s),
        f.getChildContext != null && (r = tc({}, r, f.getChildContext())),
        y && !p && f.getSnapshotBeforeUpdate != null && (g = f.getSnapshotBeforeUpdate(m, h)),
        (te = d),
        d != null && d.type === ys && d.key == null && (te = Fs(d.props.children)),
        (s = Ts(e, $s(te) ? te : [te], t, n, r, i, a, o, s, c, l, u)),
        (t.__u &= -161),
      ...
      if (((t.__v = null), c || a != null))
        if (e.then) {
          for (T = 0, E = !1, t.__u |= c ? 160 : 128, t.__c.__z = [], ne = 0; ne < a.length; ne++)
            (D = a[ne]) == null ||
              E ||
              (D.nodeType == 8 && D.data == `$s`
                ? (T > 0 && t.__c.__z.push(D), T++, (a[ne] = null))
                : D.nodeType == 8 && D.data == `/$s`
                  ? (--T > 0 && t.__c.__z.push(D), (E = T === 0), (s = a[ne]), (a[ne] = null))
          ...
          for (re = a.length; re--; ) gs(a[re]);
          Ns(t);
        }
      else ((t.__e = n.__e), (t.__k = n.__k), e.then || Ns(t));
      J.__e(e, t, n);
    }
  else s = t.__e = Is(n.__e, t, n, r, i, a, o, c, l, u);
  return ((d = J.diffed) && d(t), 128 & t.__u ? void 0 : s);
}
function Ns(e) {
  (e && e.__c && (e.__c.__g |= 4), e && e.__k && e.__k.forEach(Ns));
}
function Ps(e, t, n) {
  for (var r = 0; r < n.length; r++) Ls(n[r], n[++r], n[++r]);
  (J.__c && J.__c(t, e),
    e.some(function (t) {
      try {
        ((e = t.__h),
...
function Fs(e) {
  return typeof e != `object` || !e || (e.__b && e.__b > 0) ? e : $s(e) ? e.map(Fs) : tc({}, e);
}
function Is(e, t, n, r, i, a, o, s, c, l) {
  ...
  if (e == null) {
    ...
    ((e = l.createElementNS(i, b, y.is && y)), (s &&= (J.__m && J.__m(t, a), !1)), (a = null));
  }
  if (b == null) v === y || (s && e.data == y) || (e.data = y);
  else {
    if (((a &&= ec.call(e.childNodes)), (v = n.props || Zs), !s && a != null))
        ...
        u == `children`
          ...
          : u == `dangerouslySetInnerHTML`
            ...
            : u == `value`
              ...
              : u == `checked`
                ? (g = m)
                : (s && typeof m != `function`) || (v[u] === m && !_) || As(e, u, m, v[u], i));
    if (d)
      ...
      for (u = a.length; u--; ) gs(a[u]);
    s ||
      ((u = `value`),
      b == `progress` && h == null
        ? e.removeAttribute(`value`)
        : h == null || (h === e[u] && (b !== `progress` || h)) || As(e, u, h, v[u], i),
      (u = `checked`),
      g != null && g != e[u] && As(e, u, g, v[u], i));
  }
  return e;
}
function Ls(e, t, n) {
...
function Rs(e, t, n) {
  ...
  if (
    ...
    (r = e.ref) && ((r.current && r.current != e.__e) || Ls(r, null, t)),
    (r = e.__c) != null)
  ) {
  ...
  if ((r = e.__k))
    for (i = 0; i < r.length; i++) r[i] && Rs(r[i], t, n || typeof e.type != `function`);
  (n || gs(e.__e), e.__e && e.__e.__l && (e.__e.__l = null), (e.__e = e.__c = e.__ = null));
}
function zs(e, t, n) {
...
function Bs(e, t) {
  ...
  (t == document && (t = document.documentElement),
    ...
    Ms(
      ...
      Zs,
      t.namespaceURI,
      r ? null : t.firstChild ? ec.call(t.childNodes) : null,
      i,
  ...
  nc = e(() => {
    ((Zs = {}),
      ...
      (bs.prototype.setState = function (e, t) {
        var n =
          this.__s != null && this.__s != this.state ? this.__s : (this.__s = tc({}, this.state));
        (typeof e == `function` && (e = e(tc({}, n), this.props)),
          e && tc(n, e),
          e != null && this.__v && (t && this._sb.push(t), Cs(this)));
      }),
      (bs.prototype.forceUpdate = function (e) {
        this.__v && ((this.__g |= 4), e && this.__h.push(e), Cs(this));
      }),
      (bs.prototype.render = ys),
      (Us = []),
      (Gs = 0),
      (Ks = function (e, t) {
        return e.__v.__b - t.__v.__b;
      }),
      (qs = /(PointerCapture)$|Capture$/i),
      (Js = 0),
      (Ys = js(!1)),
      (Xs = js(!0)));
  });
...
function ac({
  ...
  "use no memo";
  let c = `#${e.replace(/^#/, ``)}`,
    { width: l, height: u, viewBox: d } = cc[e] ?? { width: oc, height: sc },
    f = r ?? l,
    p = i ?? u,
    m = a ?? d ?? `0 0 ${l} ${u}`,
...
function uc({ children: e, marker: t, variant: n = `default` }) {
  "use no memo";
  let r = n === `fade`;
  return Y(`div`, {
    "aria-hidden": !0,
...
function dc(e) {
  ...
  return Y(`div`, {
    children: [
      Y(`div`, {
        "data-truncate-content": `visible`,
        children: t === `fruncate` ? Y(`span`, { children: n }) : n,
      }),
      Y(`div`, {
        "data-truncate-content": `overflow`,
        "aria-hidden": !0,
...
function fc({ children: e, mode: t = `truncate`, marker: n = `…`, variant: r = `default`, ...i }) {
  "use no memo";
  let a = Y(dc, { mode: t, children: e }, `content`),
    o = Y(uc, { marker: n, mode: t, variant: r }, `marker`),
    s = Y(`div`, { "data-truncate-fill": !0 }, `fill`);
  return Y(`div`, {
...
function pc({ children: e, ...t }) {
  "use no memo";
  return Y(fc, { mode: `truncate`, ...t, children: e });
}
function mc({ children: e, ...t }) {
  "use no memo";
  return Y(fc, { mode: `fruncate`, ...t, children: e });
}
function hc({
  children: e,
  contents: t,
  ...
  if (Array.isArray(t)) {
    ...
    ((c = Y(pc, { ...s, children: t[0] })), (l = Y(mc, { ...s, children: t[1] })));
  } else {
    if (typeof e != `string`)
      return (console.error(`MiddleTruncate: children must be a string`), null);
    if (e.length === 0) return Y(`div`, { className: a, style: o });
    if (e.length < i)
      return Y(n === `end` ? mc : pc, { ...s, className: a, style: o, children: e });
    let t = null,
      u = null,
      d = null;
    if (typeof r == `string`)
      r === `center` ? (t = gc) : r === `extension` ? (t = _c) : r === `leaf-path` && (t = vc);
    else if (typeof r == `number`) ((t = yc), (u = r));
    else if (Array.isArray(r)) {
      let [e, n] = r;
      ((d = n), e === `last` ? (t = bc) : e === `first` && (t = xc));
    ...
    (h && (_.marker = ``),
      g && (v.marker = ``),
      (c = Y(pc, { ...s, ..._, children: f })),
      (l = Y(mc, { ...s, ...v, children: p })));
  }
  return Y(`div`, {
    "data-truncate-group-container": `middle`,
    className: a,
...
function wc(e, t) {
  return e < 0 || t < e ? Pc : { endIndex: t, startIndex: e };
}
function Tc(e) {
  return e.startIndex < 0 || e.endIndex < e.startIndex;
}
function Ec(e, t) {
  return Tc(e) ? 0 : (e.endIndex - e.startIndex + 1) * t;
}
function Dc(e, t, n) {
  if (t <= 0) return -1;
  let r = t * n;
...
function Mc(e, t, n) {
  ...
  for (let r = 0; r < e.length; r += 1) {
    ...
    let s = t + r * n,
      c = Ac(o, Math.min(e.length - 1, Math.floor(s / n))),
      l = null;
    for (; c >= 0; ) {
      let t = o[c],
...
function Nc(e, t) {
  let n = t.totalRowCount ?? e.length,
    ...
    o = Math.max(0, r - i),
    s = Cc(t.scrollTop, 0, o),
    c = t.stickyRows ?? Mc(e, s, t.itemHeight),
    l = c.reduce((e, n) => Math.max(e, n.top + t.itemHeight), 0),
    u = Math.min(r, s + l),
    d = Math.max(0, i - l),
    f = Math.max(0, r - u),
    p = Dc(s, n, t.itemHeight),
    m = Dc(u, n, t.itemHeight),
    h = l <= 0 || p < 0 || p >= n ? -1 : p,
    g = h === -1 ? -1 : Math.min(n - 1, m - 1),
    _ = h === -1 || g < h ? 0 : g - h + 1,
    v = d <= 0 || m >= n ? Pc : wc(m, Oc(u + d, n, t.itemHeight)),
    y = g + 1,
    b = Tc(v) ? Pc : wc(Math.max(y, v.startIndex - a), Math.min(n - 1, v.endIndex + a)),
    x = Ec(b, t.itemHeight);
  return {
    ...
    window: {
      endIndex: b.endIndex,
      height: x,
      offsetTop: Tc(b) ? 0 : b.startIndex * t.itemHeight,
...
var tl = e(() => {});
function nl({ ariaLabel: e, isFlattened: t = !1, ref: n, value: r, onBlur: i, onInput: a }) {
  return Y(`input`, {
    ref: n,
      ...
      ((r.__ = [
        ...
        function (e) {
          var t = r.__N ? r.__N[0] : r.__[0],
            n = r.t(t, e);
          wl(t, n) || ((r.__N = [n, r.__[1]]), r.__c.setState({}));
        },
      ]),
      (r.__c = Z),
      !Z.__f))
    ...
    var i = function (e, t, n) {
      ...
      return (
        i.forEach(function (e) {
          if (e.__N) {
            var t = e.__[0];
            ((e.__ = e.__N), (e.__N = void 0), wl(t, e.__[0]) || (o = !0));
          }
        }),
...
function dl(e, t) {
  var n = cl(xl++, 3);
  !Q.__s && yl(n.__H, t) && ((n.__ = e), (n.u = t), Z.__H.__h.push(n));
}
function fl(e, t) {
  var n = cl(xl++, 4);
  !Q.__s && yl(n.__H, t) && ((n.__ = e), (n.u = t), Z.__h.push(n));
}
function X(e) {
  return (
    (Tl = 5),
...
function pl(e, t) {
  var n = cl(xl++, 7);
  return (yl(n.__H, t) && ((n.__ = e()), (n.__H = t), (n.__h = e)), n.__);
}
function ml(e, t) {
  return (
    (Tl = 8),
...
function hl() {
  for (var e; (e = El.shift()); )
    if (e.__P && e.__H)
      try {
        (e.__H.__h.forEach(_l), e.__H.__h.forEach(vl), (e.__H.__h = []));
      } catch (t) {
...
function gl(e) {
  var t,
    n = function () {
      (clearTimeout(r), Nl && cancelAnimationFrame(t), setTimeout(e));
    },
    r = setTimeout(n, 35);
...
var xl,
  ...
  Pl = e(() => {
    (nc(),
      ...
      (Q.__ = function (e, t) {
        (e && t.__k && t.__k.__m && (e.__m = t.__k.__m), Ml && Ml(e, t));
      }),
      (Q.__r = function (e) {
        (Ol && Ol(e), (xl = 0));
        var t = (Z = e.__c).__H;
        (t &&
          (Sl === Z
            ...
            : (t.__h.forEach(_l), t.__h.forEach(vl), (t.__h = []), (xl = 0))),
          (Sl = Z));
      }),
      (Q.diffed = function (e) {
        kl && kl(e);
        ...
        (t &&
          t.__H &&
          (t.__H.__h.length &&
            ((El.push(t) !== 1 && Cl === Q.requestAnimationFrame) ||
              ((Cl = Q.requestAnimationFrame) || gl)(hl)),
      ...
      (Nl = typeof requestAnimationFrame == `function`));
  });
            ...
            ys,
            {
              children: [
                Y(`span`, {
                  ...
                  children: a && t != null ? t : Y(pc, { children: e.name }),
                }),
                i < r.length - 1 ? ` / ` : ``,
              ],
            },
...
function zl({
  ...
  let o = e.getVisibleCount(),
    ...
    l = Nc(c, {
      ...
      overscan: n,
      scrollTop: r,
      stickyRows: s == null ? void 0 : Rl(s, r, t, o),
      totalRowCount: o,
      viewportHeight: a,
    }),
...
function Kl(e, t) {
  if (e != null) {
    let t = Ic[e];
    return t == null ? null : { text: t, title: Lc[e] };
  }
  return t ? { icon: { name: `file-tree-icon-dot`, width: 6, height: 6 }, title: Rc } : null;
}
function ql(e, t, n) {
...
function $l(e, t) {
  return (t && Ql(e)) || ((e.ctrlKey || e.metaKey) && Yl(e))
    ? !0
    : e.key === `ArrowDown` ||
        e.key === `ArrowLeft` ||
        e.key === `ArrowRight` ||
...
function lu(e, t) {
  return { kind: e.kind, name: Ll(e), path: t };
}
function uu(e) {
...
function pu(e, t) {
  if (e == null) return null;
  if (`text` in e) return Y(`span`, { title: e.title, children: e.text });
  let n =
    typeof e.icon == `string`
      ...
      : fu(e.icon.name)
        ...
        : e.icon;
  return Y(`span`, { title: e.title, children: Y(ac, { ...n }) });
}
function mu(e) {
  e != null &&
    Wc(
  ...
  return Y(ys, {
    children: [
      ...
      Y(`div`, {
        ...
        children:
          e.kind === `directory`
            ? Y(ac, { ...t(`file-tree-icon-chevron`) })
            : Y(ac, { ...t(`file-tree-icon-file`, u) }),
      }),
      Y(`div`, {
        "data-item-section": `content`,
        children: e.isFlattened
          ? Fl(e, c, a)
          : (c ?? Y(hc, { minimumLength: 5, split: `extension`, children: e.name })),
      }),
      i
        ? Y(`div`, { "data-item-section": `decoration`, children: r == null ? null : pu(r, t) })
        : null,
      s ? Y(`div`, { "data-item-section": `git`, children: pu(o, t) }) : null,
      n
        ? Y(`div`, {
            "data-item-section": `action`,
            children: l
              ? Y(`span`, {
                  "aria-hidden": `true`,
                  "data-item-action-affordance": `decorative`,
                  children: Y(ac, { ...t(`file-tree-icon-ellipsis`) }),
                })
              : null,
          })
        : null,
...
function gu(e, t, n, r = {}) {
  let {
      ...
      contextMenuRightClickEnabled: te,
    ...
    oe = ie === `sticky`,
    se = _?.get(A) ?? null ?? ql(t.ancestorPaths, v, y),
    ...
    ve = {
      ...il({
        ariaLabel: Ll(t),
        domId: t.isFocused ? du(h, A, j) : void 0,
        extraStyle: ae,
        features: {
          actionLaneEnabled: de,
          contextMenuButtonVisibility: de ? ee : null,
          contextMenuEnabled: S,
          ...
          ? (e) => {
              ...
              S &&
                ...
                te &&
                  ...
                  re(t, A, { anchorRect: nu(e.clientX, e.clientY), source: `right-click` })));
            }
          : void 0,
      onFocus: oe
        ? void 0
...
function vu({
  ...
  let De = X(null),
    ...
    Me = X(!1),
    Ne = () => {
      ((Oe.current = null), (ke.current = null), (Ae.current = null));
    },
    Pe = (e, t) => {
      ((Oe.current = e),
        (ke.current = null),
        (Ae.current = t == null ? null : { path: e, scrollTop: t }));
    },
    Fe = (e, t) => {
      ((Oe.current = null), (ke.current = { path: e, viewportOffset: t }), (Ae.current = null));
    },
    Ie = X(d === `retain` && t.isSearchOpen()),
    [Le, Re] = ll(p);
  dl(() => {
    p || Re(!1);
  }, [p]);
  ...
  let L =
    ...
    Ge = e?.contextMenu?.triggerMode ?? (L ? `right-click` : `both`),
    Ke = Ge === `both` || Ge === `button`,
    qe = e?.contextMenu?.buttonVisibility ?? `when-needed`,
    Je = Ge === `both` || Ge === `right-click`;
  fl(() => {
    let e = S.current;
    if (e == null) return;
    let t = (e) => {
        ...
        ((je.current = t), be(t), Ce(t == null ? null : `pointer`));
      },
      n = (e) => {
        e instanceof CustomEvent && (Me.current = e.detail?.disabled === !0);
      };
    return (
  ...
  let Ye = ml((e, t) => {
    ...
    Qe = ml((e) => au(e, te.current, ee.current), []),
    $e = n != null || r != null || i != null,
    { resolveIcon: et } = pl(() => Zt(a), [a]),
    tt = t[rs](),
    nt = tt.getPath(),
    rt = nt != null,
    it = t.isSearchOpen(),
    ...
    R = t.getFocusedPath(),
    z = t.getFocusedIndex(),
    ot = t.getScrollRequest(),
    st = t.isDragAndDropEnabled(),
    ct = t.getDragSession(),
    lt = pl(() => (ct == null ? null : new Set(ct.draggedPaths)), [ct]),
    ut = ct?.target ?? null,
    dt = ct?.primaryPath ?? null,
    ft = uu(o),
    { overlayHeight: pt, overlayRows: mt, snapshot: B, visibleRows: ht } = Ve,
    ...
    _t = mt,
    vt = B.sticky.rows,
    yt = B.physical.totalHeight,
    bt = B.sticky.height,
    xt = pl(() => new Set(vt.map((e) => Il(e.row))), [vt]),
    St = z >= 0 && z >= gt.start && z <= gt.end,
    Ct = ml((e, t) => u?.({ item: lu(e, t), row: e }) ?? null, [u]),
    wt = ml((e) => (Wc(e == null ? null : (ee.current.get(e) ?? null)) ? !0 : Wc(S.current)), []),
    Tt = ml(
      (e) => {
  ...
  Ot.current = kt;
  let At = ml((e) => {
      let t = e == null ? null : ru(S.current, e);
      Se((e) => (e === t ? e : t));
    }, []),
    jt = ml(
      (e, n, r) => {
        ...
        if (a?.dataset.fileTreeStickyRow === `true`) {
          let e = C.current;
          (Pe(n, e?.scrollTop ?? null), (O.current = !0), N((e) => (e === n ? e : n)));
        }
        (i.focus(),
          At(a),
          (Dt.current = !0),
        ...
        if (l) {
          if (t.isSearchOpen()) {
            ...
            ((ie.current =
              z < 0 || e == null
                ? null
                : Math.max(0, Math.min(z * s - e.scrollTop, Math.max(0, t - s)))),
              (j.current = !0));
          }
          t.startRenaming(e) !== !1 && (Ce(`focus`), ve((e) => e + 1));
        }
      },
      [t, z, s, l, V],
    ),
    Nt = ml(
      (e, { restoreTreeFocus: n = !0, targetOffset: r = `live-overlay` } = {}) => {
        ...
        return (
          (O.current = !0), Zc(i, a, s, l, u, d), T.current(), (De.current = n ? e : null), !0
        );
      },
      [t, s, c, V, h],
    ),
    Pt = () => y.current === !0 || ge.current != null || fe.current === !0,
    Ft = (e) =>
    ...
    Lt = () => {
      (se.current != null && (clearTimeout(se.current), (se.current = null)), (oe.current = null));
    },
    Rt = () => {
      (le.current?.remove(), (le.current = null));
    },
    zt = () => {
      (It(ae.current), (ae.current = null), (ce.current = null));
    },
    Bt = (e) => {
    ...
    Ht = (e, n) => {
      let r = S.current?.getRootNode(),
        i = Hl(Bl(r instanceof ShadowRoot ? r : document, e, n));
    ...
    qt = () => {
      ...
      (o !== n.scrollTop && ((n.scrollTop = o), T.current()),
        Kt(Ht(e.clientX, e.clientY)),
        (ae.current = Ft(qt)));
    },
    Jt = (e, t) => {
      ((ce.current = { clientX: e, clientY: t }), (ae.current ??= Ft(qt)));
    },
    Yt = (e, n, r) => {
    ...
    $t = (e) => {
      if (I != null) {
        ...
        Cu.has(e.key) && (e.preventDefault(), e.stopPropagation());
        return;
      }
      if (tt.isActive()) {
        if (e.key === `Escape`) tt.cancel();
        else if (e.key === `Enter`) tt.commit();
        else return;
        (Ce(`focus`), ve((e) => e + 1), e.preventDefault(), e.stopPropagation());
        return;
      }
      if (l && e.key === `F2`) {
        (Mt(R ?? void 0), e.preventDefault(), e.stopPropagation());
        return;
      }
      if (it) {
        if (e.key === `Escape`) ((j.current = !1), (ie.current = null), t.closeSearch());
        else if (e.key === `Enter`) {
          ...
          ((ie.current =
            z < 0 || n == null
              ? null
              : Math.max(0, Math.min(z * s - n.scrollTop, Math.max(0, r - s)))),
            (j.current = !0),
            t.closeSearch());
      ...
      if (f && Xl(e)) {
        (t.openSearch(e.key), ve((e) => e + 1), e.preventDefault(), e.stopPropagation());
        return;
      }
      let n = L && Ql(e),
        r = $l(e, L),
        i = r && S.current != null ? Gc(S.current) : null,
        a = r ? new Set(ou(S.current)) : new Set(),
        o = i?.dataset.fileTreeStickyPath ?? null,
        c = i?.dataset.fileTreeStickyRow === `true` && o != null;
      if (c && o !== R && a.has(o)) {
        let e = C.current;
        (Pe(o, e?.scrollTop ?? null), t.focusPath(o));
      }
      ...
      if (e.shiftKey && e.key === `ArrowDown`) t.extendSelectionFromFocused(1);
        ...
        let e = t.getVisibleRows(d, d)[0] ?? null,
          n = au(u, te.current, ee.current);
        e == null || n == null ? (y = !1) : jt(e, u);
      } else if ((e.ctrlKey || e.metaKey) && Yl(e)) t.toggleFocusedSelection();
      ...
      let b = t.getFocusedPath(),
        ...
        T = n && c && o === u && b === u;
      if ((h || T) && b != null && ((w && x) || T))
        (Pe(b, v?.scrollTop ?? null), (O.current = !0), N((e) => (e === b ? e : b)));
      else {
        let t = e.key === `ArrowUp` && h && b !== u;
        b != null && (t || (_ && b === u))
          ? (Fe(b, cu(S.current, v, i, u, s, bt, V)), (O.current = !0), N((e) => (e === b ? e : b)))
          : Ne();
      }
  ...
  (fl(() => {
    ...
    fl(() => {
      let e = x.current;
      switch (
        el({ hasRenderedInput: e != null, previousRenamingPath: A.current, renamingPath: nt })
      ) {
        case `reset`:
          A.current = null;
          return;
        case `reveal-canonical`:
          nt != null && Nt(nt, { restoreTreeFocus: !1, targetOffset: `live-overlay` });
          return;
        case `ignore`:
          return;
        case `focus-input`:
          e != null && ((De.current = null), (A.current = nt), Wc(e), e.select());
          return;
      }
    }, [gt.end, gt.start, nt, Nt, xt]),
    fl(() => {
      let e = S.current;
      if (e == null) return;
      let t = null,
        ...
        r = () => {
          let t = Gc(e)?.dataset.itemPath ?? null;
          N((e) => (e === t ? e : t));
        },
        i = () => {
          (n(), (O.current = !0), r());
      ...
      let o = !1,
        ...
        m = () => {
          if (
            (a(),
            n.scrollTop > 0 && f(),
            Ee.current != null && y.current && Ot.current(),
            Me.current === !0)
          ) {
            y.current = !1;
            return;
      ...
      let w =
        typeof ResizeObserver < `u`
          ? new ResizeObserver((e) => {
              ((E.current = (e[0] == null ? null : Jc(e[0])) ?? Kc(n, g)), a());
            })
          : null;
      return (
        w?.observe(n),
  ...
  let en = pl(() => (I == null ? null : `${I.path}::${I.source}`), [I]);
  (fl(() => {
    if (en == null) {
      m?.clearSlotContent(Wt);
      return;
    }
    let t = Ee.current;
    if (t == null) return;
    ...
    let r = {
        anchorElement: n,
        anchorRect: t.anchorRect ?? tu(n.getBoundingClientRect()),
        close: (e) => {
          Ot.current(e?.restoreFocus ?? !0);
        },
        restoreFocus: () => {
          Dt.current && Et.current(Ee.current?.path ?? null);
        },
      },
      i = e?.contextMenu?.render?.(t.item, r) ?? null;
    return (
      m?.setSlotContent(Wt, i),
      e?.contextMenu?.onOpen?.(t.item, r),
      mu(i),
      queueMicrotask(() => {
        i == null || !i.isConnected || (document.activeElement === i && mu(i));
      }),
      () => {
        m?.clearSlotContent(Wt);
      }
    ...
    fl(() => {
      I != null && t.getItem(I.path) == null && kt();
    }, [kt, I, t]),
    fl(() => {
      if (I == null) return;
      let e = S.current?.getRootNode(),
        ...
        n = (e) => {
          let n = e.target;
          n instanceof Node &&
            (eu(e) || (_.current?.contains(n) !== !0 && t?.contains(n) !== !0 && kt()));
        },
        r = (e) => {
    ...
    fl(() => {
      ...
      let r = R == null ? null : (ee.current.get(R) ?? null),
        i = Gc(n),
        ...
        te = !1,
        E = !1;
      if (ot != null && ot.id !== ne.current) {
        ne.current = ot.id;
        let n = ot.visibleIndex,
          r = t.getVisibleRows(n, n)[0] ?? null;
        if (r != null) {
          let t = h ? Math.max(0, Math.min(r.ancestorPaths.length * s, Math.max(0, V - s))) : bt;
          ((te = !0), (E = Xc(e, n, s, V, yt, ot.offset, t)));
        }
        t.clearScrollRequest(ot.id);
      }
      let D = !te && l && Zc(e, z, s, V, yt, u),
        re = !te && d != null && d === R && Zc(e, z, s, V, yt, bt),
        A = !te && m != null && m.path === R && Zc(e, z, s, V, yt, m.viewportOffset),
        ae = !te && g != null && g.path === R && e.scrollTop !== g.scrollTop;
      if (
        (ae && (e.scrollTop = g.scrollTop),
        (ae || E || re || A || D || (v && y && d !== R && !b && Yc(e, z, s, V, bt))) && T.current(),
        te)
      ) {
        k.current = R;
        return;
      ...
      if (r == null) {
        (l && z >= 0 && (Zc(e, z, s, V, yt, u), T.current()), (k.current = R));
        return;
      }
      ((y || l || d === R || p === R || m?.path === R || g?.path === R || a == null || a !== R) &&
        (Wc(r),
        d === R && (De.current = null),
        p === R && (Oe.current = null),
        m?.path === R && (ke.current = null),
        g?.path === R && (Ae.current = null),
        (j.current = !1),
        (ie.current = null)),
        (k.current = R));
    }, [t, z, R, St, s, rt, it, gt, V, f, ot, h, bt, yt, ht]));
  let tn = z >= 0 && z >= B.visible.startIndex && z <= B.visible.endIndex,
    nn = R != null && _t.some((e) => Il(e.row) === R),
    rn = tn || nn,
    an = Ke && O.current === !0 && rn ? R : null,
    on = P === `pointer` ? ye : null,
    sn = I?.path ?? je.current ?? on ?? an ?? ye,
    cn = I?.source === `right-click`;
  fl(() => {
    (y.current && I == null) || At(Qe(sn));
  }, [I, Qe, gt, V, we, _t, sn, At, ht]);
  let ln = ml((e) => {
      if (y.current || eu(e)) return;
      let t = e.target;
  ...
  let dn = (e) => {
      if (!st || t.getDragSession() == null || fe.current) return;
      let n = Hl(e.target instanceof HTMLElement ? e.target : null);
      (t.setDragTarget(n),
    ...
    fn = (e) => {
      ...
      (n instanceof Node && S.current?.contains(n) === !0) || (Lt(), zt(), t.setDragTarget(null));
    },
    pn = (e) => {
      !st ||
    ...
    mn = B.window.height,
    hn = B.window.offsetTop,
    gn = Math.min(0, V - mn),
    _n = Math.min(0, V - mn - bt),
    vn = M === R || j.current,
    yn = R != null && vn && !St && z >= 0 ? (ht[z] ?? t.getVisibleRows(z, z)[0] ?? null) : null,
    bn = yn == null ? null : Qc(z, s, gt, mn),
    xn = ue.current,
    H = dt != null && xn != null && xn.path === dt && xn.index >= gt.start && xn.index <= gt.end,
    Sn = dt != null && xn != null && xn.path === dt && !H && xn.path !== yn?.path ? xn : null,
    U = Sn == null ? null : Qc(Sn.index, s, gt, mn),
    Cn = Zl(
      (z >= 0 ? (ht[z] ?? t.getVisibleRows(z, z)[0] ?? null) : null)?.ancestorPaths.at(-1) ?? null,
    ),
    wn = it && R != null ? du(o, R, !St) : void 0,
    Tn = I?.path ?? (it ? R : M),
    En = I?.path ?? ye,
    Dn = Qe(sn),
    On = L && Ke && !cn && !rt && Dn != null && xe != null && sn != null,
    kn = L && (On || I != null),
    An = I?.anchorRect,
    jn = An == null && Dn != null && xe != null && (I != null || On) ? xe : null,
    W =
      An == null
        ? jn == null
          ? void 0
          : { top: `${jn}px` }
        : { left: `${An.left}px`, position: `fixed`, right: `auto`, top: `${An.top}px` },
    Mn = cn ? { opacity: `0` } : void 0,
    Nn = ml(
      (e, n, r, i) => {
        let a = ol({
        ...
        (t.focusMountedPathFromInput(c),
          d && ((O.current = !0), N((e) => (e === c ? e : c)), Ce(`focus`)),
          o && t.toggleMountedDirectoryFromInput(c),
          a.closeSearch && t.closeSearch(),
          a.revealCanonical && Nt(c, { targetOffset: `sticky-parents` }));
      },
      [t, it, B.visible.endIndex, B.visible.startIndex, Nt],
    ),
    Pn = () => {
      if (y.current || !Ke || sn == null || Dn == null) return;
      let e = t.getItem(sn);
      e != null &&
        (At(Dn),
        (Dt.current = !0),
        Te({
          ...
          item: {
            ...
            name: Dn.getAttribute(`aria-label`) ?? sn,
            path: e.getPath(),
          },
          path: e.getPath(),
          source: `button`,
    ...
    Fn = {
      contextHoverPath: En,
      contextMenuButtonTriggerEnabled: Ke,
      contextMenuButtonVisibility: qe,
      contextMenuEnabled: L,
      contextMenuRightClickEnabled: Je,
      contextMenuTriggerMode: Ge,
      controller: t,
      directoriesWithGitChanges: i,
      dragAndDropEnabled: st,
      draggedPathSet: lt,
      dragTarget: ut,
      gitLaneActive: $e,
      gitStatusByPath: n,
    ...
    In = { ...Fn, registerButton: Xe };
  return Y(`div`, {
    ref: S,
    id: ft,
    "data-file-tree-context-menu-button-visibility": L && Ke ? qe : void 0,
    "data-file-tree-context-menu-trigger-mode": L ? Ge : void 0,
    "data-file-tree-has-context-menu-action-lane": L && Ke ? `true` : void 0,
    "data-file-tree-has-git-lane": $e ? `true` : void 0,
    "data-file-tree-virtualized-root": `true`,
    onDragLeave: st ? fn : void 0,
    onDragOver: st ? dn : void 0,
    onDrop: st ? pn : void 0,
    onKeyDown: $t,
    onPointerLeave: L ? un : void 0,
    onPointerOver: L ? ln : void 0,
    role: `tree`,
    tabIndex: -1,
    style: { outline: `none`, position: `relative` },
    children: [
      Y(`style`, { "data-file-tree-guide-style": `true`, dangerouslySetInnerHTML: { __html: Cn } }),
      Y(`slot`, { name: Ut, "data-type": `header-slot` }),
      f
        ? Y(`div`, {
            "data-file-tree-search-container": !0,
            "data-open": it ? `true` : `false`,
            children: Y(`input`, {
              ref: w,
              "aria-activedescendant": wn,
              "aria-controls": ft,
              placeholder: `Search…`,
              "data-file-tree-search-input": !0,
              "data-file-tree-search-input-fake-focus": Le ? `true` : void 0,
              value: at,
              onBlur: () => {
                (d === `retain` && !ze.current) || t.closeSearch();
              },
              onFocus: Be,
              onPointerDown: Be,
              onInput: (e) => {
        ...
        children: [
          ...
          Y(`div`, {
            ...
            children: [
              ...
              Y(`div`, {
                "data-file-tree-virtualized-sticky": `true`,
                style: { height: `${mn}px`, top: `${gn}px`, bottom: `${_n}px` },
                children: [
                  _u(Fn, gt, xt),
                  yn != null && bn != null
                    ? gu(Fn, yn, `parked:${yn.path}`, {
                        isParked: !0,
                        style: {
                          left: `0`,
                          opacity: `0`,
                          pointerEvents: dt === yn.path ? `none` : void 0,
                          position: `absolute`,
                          right: `0`,
                          top: `${bn}px`,
                        },
        ...
        ? Y(`div`, {
            ...
            children: [
              Y(`button`, {
                ...
                "aria-label": `Options`,
                "aria-haspopup": `menu`,
                "aria-expanded": I == null ? `false` : `true`,
                "data-visible": On ? `true` : `false`,
                onMouseDown: (e) => {
                  e.preventDefault();
                },
                onClick: (e) => {
                  if ((e.preventDefault(), e.stopPropagation(), I != null)) {
                    kt();
                    return;
                  }
                  Pn();
                ...
                tabIndex: -1,
                style: Mn,
                children: Y(ac, { ...et(`file-tree-icon-ellipsis`) }),
              }),
              I == null ? null : Y(`slot`, { name: Wt }),
            ],
          })
        : null,
      I == null
...
function Mu(e) {
  e.__g === void 0 ? (e[Gu] = !0) : (e.__g |= 8);
}
function Nu(e) {
  e.__g === void 0 ? (e[Gu] = !1) : (e.__g &= -9);
}
function Pu(e) {
  return e.__g === void 0 ? !0 === e[Gu] : !!(8 & e.__g);
}
function Fu(e) {
  if (e.length === 0 || !1 === Qu.test(e)) return e;
...
function Iu(e) {
  ...
  for (var n in e) {
    var r = e[n];
    if (r != null && r !== ``) {
      var i = n[0] == `-` ? n : $u[n] || ($u[n] = n.replace(td, `-$&`).toLowerCase()),
        a = `;`;
      (typeof r != `number` || i.startsWith(`--`) || ed.has(i) || (a = `px;`),
        (t = t + i + `:` + r + a));
    }
  }
  return t || void 0;
...
function Ru(e, t) {
  return { __v: e, context: t, props: e.props, setState: Lu, forceUpdate: Lu, __d: !0, __h: [] };
}
function zu(e, t, n) {
  if (!e.s) {
    if (n instanceof nd) {
      if (!n.s) return void (n.o = zu.bind(null, e, t));
      (1 & t && (t = n.s), (n = n.v));
    }
    if (n && n.then) return void n.then(zu.bind(null, e, t), zu.bind(null, e, 2));
    ((e.s = t), (e.v = n));
    let r = e.o;
    r && r(e);
  }
...
function Bu(e, t) {
  var n,
    ...
    i = !0;
  return (
    e[Uu] ? ((i = !1), ((n = e[Uu]).state = n[Ku])) : (n = new r(e.props, t)),
    (e[Uu] = n),
    (n.__v = e),
    (n.props = e.props),
    (n.context = t),
    ...
    r.getDerivedStateFromProps
      ? (n.state = ld({}, n.state, r.getDerivedStateFromProps(n.props, n.state)))
      : i && n.componentWillMount
        ? (n.componentWillMount(), (n.state = n[Ku] === n.state ? n.state : n[Ku]))
...
function Vu(e, t, n, r, i, a, o) {
  if (e == null || !0 === e || !1 === e || e === ud) return ud;
  var s = typeof e;
  if (s != `object`) return s == `function` ? ud : s == `string` ? Fu(e) : e + ud;
  if (cd(e)) {
    var c,
      l = ud;
    i[Wu] = e;
      ...
      if (f != null && typeof f != `boolean`) {
        ...
        typeof m == `string`
          ...
          : ((c ||= Array(u)),
            l && c.push(l),
            (l = ud),
            cd(m) ? (p = c).push.apply(p, m) : c.push(m));
      }
    }
    return c ? (l && c.push(l), c) : l;
  }
  if (e.constructor !== void 0) return ud;
  ((e.__ = i), rd && rd(e));
  var h = e.type,
    g = e.props;
  if (typeof h == `function`) {
    ...
    if (h === ys) {
      if (`tpl` in g) {
        for (var x = ud, S = 0; S < g.tpl.length; S++)
          if (((x += g.tpl[S]), g.exprs && S < g.exprs.length)) {
            var C = g.exprs[S];
            if (C == null) continue;
            typeof C != `object` || (C.constructor !== void 0 && !cd(C))
              ? (x += C)
              : (x += Vu(C, t, n, r, e, a, o));
          }
        return x;
      }
      if (`UNSTABLE_comment` in g) return `<!--` + Fu(g.UNSTABLE_comment) + `-->`;
      v = g.children;
    } else {
      ...
      if (ee) ((v = Bu(e, b)), (y = e[Uu]));
      else {
        e[Uu] = y = Ru(e, b);
        for (var te = 0; Pu(y) && te++ < 25; ) {
          (Nu(y), ad && ad(e));
          try {
            v = h.call(y, g, b);
          } catch (t) {
      ...
      if (
        (y.getChildContext != null && (t = ld({}, t, y.getChildContext())),
        ee && J.errorBoundaries && (h.getDerivedStateFromError || y.componentDidCatch))
      ) {
        v =
          v != null && v.type === ys && v.key == null && v.props.tpl == null ? v.props.children : v;
        try {
          return Vu(v, t, n, r, e, a, !1);
        } catch (i) {
          return (
            h.getDerivedStateFromError && (y[Ku] = h.getDerivedStateFromError(i)),
            y.componentDidCatch && y.componentDidCatch(i, sd),
            Pu(y)
              ? ((v = Bu(e, t)),
                (y = e[Uu]).getChildContext != null && (t = ld({}, t, y.getChildContext())),
                Vu(
                  (v =
                    v != null && v.type === ys && v.key == null && v.props.tpl == null
                      ? v.props.children
                      : v),
                  t,
                  n,
    ...
    v = v != null && v.type === ys && v.key == null && v.props.tpl == null ? v.props.children : v;
    try {
      var T = Vu(v, t, n, r, e, a, o);
      return (
        id && id(e),
        J.unmount && J.unmount(e),
        e._suspended
      ...
      return i.then(function i() {
        try {
          var s = Vu(v, t, n, r, e, a, o);
          return e._suspended ? dd + s + fd : s;
        } catch (e) {
  ...
  for (var k in g) {
    var A = g[k];
    if (typeof (A = Hu(A) ? A.value : A) != `function` || k === `class` || k === `className`) {
      switch (k) {
        case `children`:
          D = A;
          continue;
        ...
        case `httpEquiv`:
          ...
          break;
        default:
          if (Ju.test(k)) k = k.replace(Ju, `$1:$2`).toLowerCase();
          else {
            if (qu.test(k)) continue;
            (k[4] !== `-` && !Zu.has(k)) || A == null
              ? n
                ? Xu.test(k) &&
                  (k = k === `panose1` ? `panose-1` : k.replace(/([A-Z])/g, `-$1`).toLowerCase())
                : Yu.test(k) && (k = k.toLowerCase())
              : (A += ud);
          }
      }
      A != null &&
        ...
        (re =
          !0 === A || A === ud
            ? re + ` ` + k
            : re + ` ` + k + `="` + (typeof A == `string` ? Fu(A) : A + ud) + `"`);
    }
  }
  if (qu.test(h)) throw Error(h + ` is not a valid HTML tag name in ` + re + `>`);
  if (
    (O ||
      (typeof D == `string`
        ? (O = Fu(D))
        : D != null &&
          !1 !== D &&
          !0 !== D &&
          (O = Vu(D, t, h === `svg` || (h !== `foreignObject` && n), r, e, a, o))),
    id && id(e),
    od && od(e),
    !O && pd.has(h))
  )
  ...
  var j = `</` + h + `>`,
    ie = re + `>`;
  return cd(O) ? [ie].concat(O, [j]) : typeof O == `string` ? ie + O + j : [ie, O, j];
}
function Hu(e) {
...
var Uu,
  ...
  md = e(() => {
    (nc(),
      ...
      (Zu = new Set([`draggable`, `spellcheck`])),
      (Qu = /["&<]/),
      ($u = {}),
      (ed = new Set(
          ...
          (e.prototype.then = function (t, n) {
            ...
            return (
              (this.o = function (e) {
                try {
                  var i = e.v;
                  1 & e.s ? zu(r, 1, t ? t(i) : i) : n ? zu(r, 1, n(i)) : zu(r, 2, i);
                } catch (e) {
                  zu(r, 2, e);
                }
              }),
...
function hd(e) {
  return e != null && e.length > 0 ? e : ((bd += 1), `pst_ft_${bd}`);
}
function gd({ initialVisibleRowCount: e, itemHeight: t }) {
  return e == null ? 420 : Math.max(0, e) * (t ?? Ya);
}
function _d(e) {
  ...
  Sd = e(() => {
    (It(),
      ...
      (xd = class {
        ...
        unmount() {
          (this.#b != null &&
            (Du(this.#b), delete this.#b.dataset.fileTreeVirtualizedWrapper, (this.#b = void 0)),
            this.#l.clearAll(),
            this.#l.setHost(null),
            this.#f != null &&
        ...
        setComposition(e) {
          this.#e = e;
          let t = this.#T();
          t != null && (this.#O(), Tu(t.wrapper, this.#w()));
        }
        setGitStatus(e) {
          this.#p = ms(e, this.#p);
          let t = this.#T();
          t != null && Tu(t.wrapper, this.#w());
        }
        setIcons(e) {
          this.#m = e;
          let t = this.#T();
          t != null && (this.#E(t.host, t.wrapper), Tu(t.wrapper, this.#w()));
        }
        ...
        #O() {
          ...
          if (e != null) {
            this.#l.setSlotContent(Ut, e());
            return;
          }
          this.#l.setSlotHtml(Ut, this.#e?.header?.html ?? null);
        }
        #k(e) {
          let t = yd(e).find((e) => vd(e)),
            n = _d(ke(Jt(this.#m).set));
          n != null &&
        ...
        #M(e) {
          let t = e.querySelector(`style[${zt}]`);
          if (
          ...
          (this.#g?.parentNode === e && this.#_ === this.#h) ||
            ...
            this.#g.setAttribute(zt, ``),
            this.#g.parentNode !== e && e.appendChild(this.#g),
            (this.#g.textContent = eo(this.#h)),
            (this.#_ = this.#h));
        }
        #N(e) {
...
function Cd() {
  return O(P.theme) ?? `system`;
}
function wd(e) {
  let t = (0, kd.c)(4),
    n;
  t[0] === e ? (n = t[1]) : ((n = e === `system` ? Od : () => e), (t[0] = e), (t[1] = n));
  let r;
  return (
    t[2] === e ? (r = t[3]) : ((r = e === `system` ? Od : () => e), (t[2] = e), (t[3] = r)),
    (0, Ad.useSyncExternalStore)(e === `system` ? Dd : Ed, n, r)
  );
}
function Td(e) {
...
function Md(e, t, n) {
  let r = e == null ? null : (0, Rd.jsx)(`div`, { slot: Ut, children: e }),
    i =
      t != null && n != null
        ? (0, Rd.jsx)(`div`, { slot: Wt, children: t(n.item, n.context) })
        : null;
  return r == null && i == null ? null : (0, Rd.jsxs)(Rd.Fragment, { children: [r, i] });
}
function Nd(e, t) {
  return typeof window > `u` && t != null
    ? (0, Rd.jsxs)(Rd.Fragment, {
        children: [
          (0, Rd.jsx)(`template`, {
            shadowrootmode: `open`,
    ...
    : (0, Rd.jsx)(Rd.Fragment, { children: e });
}
function Pd(e) {
  let t = e.shadowRoot;
...
function Id({ header: e, id: t, model: n, preloadedData: r, renderContextMenu: i, ...a }) {
  let [o, s] = (0, Ld.useState)(null),
    [c, l] = (0, Ld.useState)(null),
    u = (0, Ld.useRef)(n.getComposition()),
    d = (0, Ld.useRef)(n);
  ...
  let f = i != null,
    ...
    m = (0, Ld.useCallback)((e, t) => {
      s({ context: t, item: e });
    }, []),
    h = u.current,
    g = (0, Ld.useMemo)(() => Fd(h, e, f, p, m), [h, p, m, f, e]),
    _ = (0, Ld.useCallback)((e) => {
      l(e);
    }, []);
  ((0, Ld.useEffect)(() => {
    f || s(null);
...
var Ld,
  ...
  Bd = e(() => {
    (Kt(),
      (Ld = t(M(), 1)),
      (Rd = Se()),
      (zd = typeof window > `u` ? Ld.useEffect : Ld.useLayoutEffect));
  });
function Vd(e) {
  let [t] = (0, Hd.useState)(() => new xd(e)),
    n = (0, Hd.useRef)({ timeout: null, model: t });
  return (
    (0, Hd.useEffect)(() => {
      let { current: e } = n;
      return (
...
function Qd(e) {
  let t = (0, mf.c)(97),
    {
      ...
      onStateChange: m,
      paths: h,
      revealSelectedPath: g,
      renderRowDecoration: _,
      resetKey: v,
      selectedPath: y,
      unsafeCSS: b,
    } = e,
  ...
  let O = i(ne),
    k;
  t[3] === h ? (k = t[4]) : ((k = h.map($d)), (t[3] = h), (t[4] = k));
  let A = k,
    j;
  if (t[5] !== n || t[6] !== h || t[7] !== ee) {
    j = new Map();
    for (let e of h)
      typeof e != `string` && j.set(e.displayPath, me(n ?? ``, e.path, ee === `windows`));
    ((t[5] = n), (t[6] = h), (t[7] = ee), (t[8] = j));
  } else j = t[8];
  let ae = j,
    oe;
  t[9] !== r || t[10] !== s
    ? ((oe = tf(s, r)), (t[9] = r), (t[10] = s), (t[11] = oe))
    : (oe = t[11]);
  let se = oe,
    ce = (0, hf.useRef)(null),
    le;
  t[12] === c ? (le = t[13]) : ((le = Array.from(c ?? [])), (t[12] = c), (t[13] = le));
  let ue = (0, hf.useRef)(le),
    de = (0, hf.useRef)(null),
    fe = (0, hf.useRef)(null),
    pe = (0, hf.useRef)(S),
    ge = (0, hf.useRef)(y ?? null),
    ve;
  t[14] === m
    ? (ve = t[15])
    : ((ve = () => {
        m?.({ expandedPaths: ue.current, scrollTop: pe.current, selectedPath: ge.current });
      }),
      (t[14] = m),
      (t[15] = ve));
  let M = N(ve),
  ...
  let Se = N(xe),
    P;
  t[22] === y ? (P = t[23]) : ((P = y == null ? void 0 : [y]), (t[22] = y), (t[23] = P));
  let Ce = `
      :host {
  ...
  (t[33] !== c || t[34] !== F || t[35] !== v || t[36] !== A
    ? ((I = () => {
        ...
        (t != null &&
          ...
          t.resetKey === v &&
          ef(t.treePaths, A) &&
          ef(t.initialExpandedPaths, e)) ||
          ((de.current = {
            initialExpandedPaths: e,
            model: F,
            resetKey: v,
            treePaths: Array.from(A),
          }),
          (ue.current = e),
          (fe.current = null),
          F.resetPaths(A, { initialExpandedPaths: c }));
      }),
      (Te = [c, F, v, A]),
      (t[33] = c),
      (t[34] = F),
    ...
    (0, hf.useEffect)(I, Te));
  let Ee, De;
  (t[39] !== S || t[40] !== F || t[41] !== C || t[42] !== y
    ? ((Ee = () => {
        let e = null,
          t = 0,
          n = () => {
            ((e = null),
              !ff(F, S) && (t >= vf || ((t += 1), (e = window.requestAnimationFrame(n)))));
          };
        return (
          S > 0 && !(C && y != null) ? ((pe.current = S), n()) : (pe.current = 0),
          () => {
      ...
      (t[44] = De))
    : ((Ee = t[43]), (De = t[44])),
    (0, hf.useEffect)(Ee, De));
  let Oe;
  t[45] !== F || t[46] !== C || t[47] !== y
    ? ((Oe = () => {
        if (((ge.current = y ?? null), cf(F, y), !C || y == null)) {
          fe.current = null;
          return;
        }
        fe.current !== y && lf(F, y) && (fe.current = y);
      }),
      (t[45] = F),
      (t[46] = C),
      (t[47] = y),
    ...
    : (Oe = t[48]);
  let ke;
  (t[49] !== F || t[50] !== C || t[51] !== y || t[52] !== A
    ? ((ke = [F, C, y, A]), (t[49] = F), (t[50] = C), (t[51] = y), (t[52] = A), (t[53] = ke))
    : (ke = t[53]),
    (0, hf.useEffect)(Oe, ke));
  let Ae, je;
  (t[54] !== se || t[55] !== F
    ? ((Ae = () => {
        F.setIcons(se);
      ...
      (t[57] = je))
    : ((Ae = t[56]), (je = t[57])),
    (0, hf.useEffect)(Ae, je));
  let Me, Ne;
  (t[58] !== be || t[59] !== F || t[60] !== A
    ? ((Me = () =>
        F.subscribe(() => {
          ((pe.current = df(F)), be(sf(F, A)));
        })),
      (Ne = [be, F, A]),
      (t[58] = be),
      (t[59] = F),
    ...
    ? ((Pe = () => {
        let e = null,
          ...
          r = () => {
            ...
            t >= vf || ((t += 1), (e = window.requestAnimationFrame(r)));
          };
        return (
          r(),
          () => {
      ...
      (t[66] = Fe))
    : ((Pe = t[65]), (Fe = t[66])),
    (0, hf.useEffect)(Pe, Fe));
  let Ie;
  t[67] !== n || t[68] !== o
    ? ((Ie = (0, gf.jsx)(D, { cwd: n, hostId: o })), (t[67] = n), (t[68] = o), (t[69] = Ie))
    : (Ie = t[69]);
  let Le;
  t[70] !== T || t[71] !== n || t[72] !== O || t[73] !== o || t[74] !== E || t[75] !== ae
    ? ((Le = () => {
        let e = of(ae, ce.current);
        return Gd({
          ...rf({ cwd: n, fallbackOpenTargets: O, hostId: o, queryClient: E, targetPath: e }),
          onAddToChat:
            o == null
              ? void 0
              : (e) => {
                  T.mutateAsync({ hostId: o, path: e });
                },
          onCopyPath: re,
          onOpenInTarget: (e, t, n) => {
            O.open(e, { appPath: t, persistPreferred: !1, path: n });
          },
          targetPath: e,
        });
      }),
    ...
    : (Le = t[76]);
  let Re;
  t[77] !== n || t[78] !== o || t[79] !== E || t[80] !== ae
    ? ((Re = () => af({ cwd: n, hostId: o, queryClient: E, targetPath: of(ae, ce.current) })),
      (t[77] = n),
      (t[78] = o),
      (t[79] = E),
      (t[80] = ae),
  ...
  return (
    t[94] !== Ie || t[95] !== He
      ? ((Ue = (0, gf.jsxs)(gf.Fragment, { children: [Ie, He] })),
        (t[94] = Ie),
        (t[95] = He),
        (t[96] = Ue))
      : (Ue = t[96]),
...
function tf(e, t) {
  ...
  let n = t
      ...
      .join(``),
    r = nf(typeof e == `string` ? void 0 : e?.spriteSheet, n);
  return e == null
...
function rf({ cwd: e, fallbackOpenTargets: t, hostId: n, queryClient: r, targetPath: i }) {
  ...
  return {
    ...
    primaryTarget: g({ preferredTarget: u, targets: c, availableTargets: l, mode: d }),
    visibleTargets: A({ targets: c, availableTargets: l, includeHiddenTargets: !0, mode: d }),
  };
}
function af({ cwd: e, hostId: t, queryClient: n, targetPath: r }) {
  if (r != null)
    return n.prefetchQuery({
      gcTime: _.INFINITE,
      queryKey: o(`open-in-targets`, { cwd: e, hostId: t, path: r }),
      queryFn: () => u(`open-in-targets`, { params: { cwd: e, hostId: t, path: r } }),
...
function sf(e, t) {
  ...
  for (let r of t) {
    ...
    let t = r.slice(0, -1),
      i = e.getItem(t);
    i == null || !pf(i) || !i.isExpanded() || n.push(t);
  }
  return n;
}
function cf(e, t) {
...
function bf(e) {
  let t = (0, xf.c)(23),
    { autoFocus: n, inputId: r, inputRef: i, onQueryChange: o, searchQuery: s } = e,
    c = r === void 0 ? `file-tree-search` : r,
    l = ee(),
    u;
  ...
  t[1] === c
    ? (d = t[2])
    : ((d = (0, Sf.jsx)(`label`, { className: `sr-only`, htmlFor: c, children: u })),
      (t[1] = c),
      (t[2] = d));
  let p;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (p = t[3]);
  let m;
  t[4] === o ? (m = t[5]) : ((m = (e) => o(e.target.value)), (t[4] = o), (t[5] = m));
  let h;
  t[6] === l
    ? (h = t[7])
    : ((h = l.formatMessage({
      ...
      (t[7] = h));
  let g;
  t[8] !== n || t[9] !== c || t[10] !== i || t[11] !== s || t[12] !== m || t[13] !== h
    ? ((g = (0, Sf.jsx)(`input`, {
        autoFocus: n,
        id: c,
        ref: i,
    ...
    ? ((_ =
        s.length > 0
          ? (0, Sf.jsx)(ve, {
              ...
              size: `icon`,
              onClick: () => o(``),
              children: (0, Sf.jsx)(a, { className: `icon-2xs` }),
            })
          : null),
      (t[15] = l),
      (t[16] = o),
...
function Mf(e, t) {
  let n = e;
  for (let r of Pf(t)) n.includes(r) || (n === e && (n = [...e]), n.push(r));
  return n;
}
function Nf(e, t, n) {
...
function Ff(e, t) {
  return (
    ...
    If(e.expandedPaths, t.expandedPaths)
  );
}
function If(e, t) {
  return e.length === t.length ? e.every((e, n) => e === t[n]) : !1;
...
function Rf(e) {
  let t = (0, Yf.c)(108),
    ...
    u;
  t[0] !== o || t[1] !== a || t[2] !== i
    ? ((u = { hostId: o, includeHidden: a, root: i }),
      (t[0] = o),
      (t[1] = a),
      (t[2] = i),
      (t[3] = u))
  ...
  let d = b(tp, u),
    ...
    p;
  t[4] !== o || t[5] !== a || t[6] !== i
    ? ((p = { hostId: o, includeHidden: a, root: i }),
      (t[4] = o),
      (t[5] = a),
      (t[6] = i),
      (t[7] = p))
  ...
  let m = b(np, p),
    ...
    g = te(`open-file`),
    _;
  t[8] === i ? (_ = t[9]) : ((_ = S(i)), (t[8] = i), (t[9] = _));
  let v = _,
    y,
    x;
  t[10] !== n || t[11] !== f || t[12] !== i
    ? ((y = n == null ? null : jf({ filePath: n, root: i })),
      (x = Af(f, y)),
      (t[10] = n),
      (t[11] = f),
      (t[12] = i),
    ...
    : ((y = t[13]), (x = t[14]));
  let C = x,
    [w, ee] = (0, Xf.useState)(C.expandedPaths),
    [T, E] = (0, Xf.useState)(C.selectedPath),
    D = (0, Xf.useRef)(w),
    re = (0, Xf.useRef)(null),
    O = (0, Xf.useRef)(null),
    A = (0, Xf.useRef)(T),
    ie;
  t[15] !== w || t[16] !== o || t[17] !== a || t[18] !== c || t[19] !== i
    ? ((ie = { expandedItems: w, hostId: o, includeHidden: a, refreshKey: c, root: i }),
      (t[15] = w),
      (t[16] = o),
      (t[17] = a),
      (t[18] = c),
      ...
      (t[20] = ie))
    : (ie = t[20]);
  let { error: oe, files: ce, isEmpty: le, isLoading: ue } = ae(ip, ie),
    de;
  t[21] === i ? (de = t[22]) : ((de = [i]), (t[21] = i), (t[22] = de));
  let pe = de,
    me;
  t[23] !== m || t[24] !== l
    ? ((me = (e) => {
        let { files: t, query: n } = e;
        n.trim().length !== 0 && l.set(m, { files: t, query: n });
      }),
      (t[23] = m),
      (t[24] = l),
      (t[25] = me))
  ...
  let he = N(me),
    ge;
  t[26] !== he || t[27] !== o || t[28] !== f.searchQuery || t[29] !== pe
    ? ((ge = { hostId: o, onFiles: he, query: f.searchQuery, roots: pe }),
      (t[26] = he),
      (t[27] = o),
      (t[28] = f.searchQuery),
      (t[29] = pe),
      (t[30] = ge))
    : (ge = t[30]);
  let { files: _e, isLoading: ve } = ne(ge),
    M;
  t[31] === f.searchQuery
    ? (M = t[32])
    : ((M = f.searchQuery.trim()), (t[31] = f.searchQuery), (t[32] = M));
  let ye = M,
    be;
  t[33] !== h || t[34] !== f.searchQuery || t[35] !== _e
    ? ((be = Nf(_e, h, f.searchQuery)),
      (t[33] = h),
      (t[34] = f.searchQuery),
      (t[35] = _e),
      (t[36] = be))
  ...
  let xe = be,
    Se;
  t[37] !== v || t[38] !== s || t[39] !== g || t[40] !== i
    ? ((Se = (e, t) => {
        if (s != null) {
          s(fe(i, e), t);
          return;
        }
        g.mutate({ cwd: v, path: e });
      }),
      (t[37] = v),
      (t[38] = s),
      (t[39] = g),
  ...
  let I = N(F),
    Te;
  t[46] !== m || t[47] !== f.searchQuery || t[48] !== l || t[49] !== P || t[50] !== xe
    ? ((Te = (e) => {
        (xe != null && l.set(m, { files: xe, query: f.searchQuery }), P(e, { isPreview: !0 }));
      }),
      (t[46] = m),
      (t[47] = f.searchQuery),
      (t[48] = l),
  ...
  t[54] !== d || t[55] !== l
    ? ((ke = () => {
        let e = re.current;
        e != null && ((re.current = null), l.set(d, (t) => Of(t, e)));
      }),
      (t[54] = d),
      (t[55] = l),
      (t[56] = ke))
  ...
  t[62] === Pe
    ? (Fe = t[63])
    : ((Fe = (e) => {
        (Jf(D.current, e.expandedPaths) || ((D.current = e.expandedPaths), ee(e.expandedPaths)),
          A.current !== e.selectedPath && ((A.current = e.selectedPath), E(e.selectedPath)),
          Pe(e));
      }),
      (t[62] = Pe),
      (t[63] = Fe));
  let Ie = N(Fe),
    Le,
    Re;
  (t[64] !== y || t[65] !== d || t[66] !== l
    ? ((Le = () => {
        if (y == null) return;
        let e = Mf(D.current, y);
        (Jf(D.current, e) || ((D.current = e), ee(e)),
          A.current !== y && ((A.current = y), E(y)),
          (re.current = null),
      ...
      (t[68] = Re))
    : ((Le = t[67]), (Re = t[68])),
    (0, Xf.useEffect)(Le, Re));
  let ze, Be;
  (t[69] !== w || t[70] !== o || t[71] !== a || t[72] !== c || t[73] !== i || t[74] !== l
    ? ((ze = () => {
        Gf(l, { expandedItems: w, hostId: o, includeHidden: a, refreshKey: c, root: i });
      }),
      (Be = [w, o, a, c, i, l]),
      (t[69] = w),
      (t[70] = o),
      ...
      (t[76] = Be))
    : ((ze = t[75]), (Be = t[76])),
    (0, Xf.useEffect)(ze, Be));
  let Ve, He;
  (t[77] === Ae
    ? ((Ve = t[78]), (He = t[79]))
    : ((Ve = () => () => {
        (O.current != null && (window.clearTimeout(O.current), (O.current = null)), Ae());
      }),
      (He = [Ae]),
      (t[77] = Ae),
      (t[78] = Ve),
      (t[79] = He)),
    (0, Xf.useEffect)(Ve, He));
  let Ue;
  t[80] !== r || t[81] !== Me || t[82] !== f.searchQuery
    ? ((Ue = (0, $.jsx)(`div`, {
...
function Bf(e) {
  let t = (0, Yf.c)(22),
    ...
    l;
  t[0] === n ? (l = t[1]) : ((l = n == null ? null : Ef(n)), (t[0] = n), (t[1] = l));
  let u = l,
    d;
  t[2] === u ? (d = t[3]) : ((d = u == null ? Qf : qf(u.map(Vf))), (t[2] = u), (t[3] = d));
  let p = d;
...
function Hf(e, t) {
  let n = e.find((e) => !e.endsWith(Zf));
  n != null && t(n);
}
function Uf(e) {
  let t = Xd(e);
  return t == null || t.endsWith(Zf) ? null : t;
}
function Wf(e, t) {
  if (t != null)
    for (let n of t) {
...
async function Gf(e, { expandedItems: t, hostId: n, includeHidden: r, refreshKey: i, root: a }) {
  await Promise.all(
    wf(t).map(async (t) => {
      await e.query
        .fetch(rp, { directoryPath: t, hostId: n, includeHidden: r, refreshKey: i, root: a })
        .catch(() => void 0);
    }),
  );
}
...
var Yf,
  ...
  ap = e(() => {
    ((Yf = pe()),
      ...
      (Qf = []),
      ($f = 100),
      (ep = { expandedPaths: Qf, scrollTop: 0, searchQuery: ``, selectedPath: null }),
      (tp = p(k, (e) => ep)),
      (np = p(k, (e) => null)),
      (rp = E(
        d,
