import { r as e } from "./_baseFor-1.js";
...
import { t as v } from "./merge.js";
import { t as y } from "./dist-5.js";
import { n as b, r as x } from "./chunk-62.js";
import { I as S, f as C, m as w, r as T, s as E } from "./chunk-96.js";
var ie = y(),
  ae = {
    curveBasis: d,
    curveBasisClosed: m,
...
var N = b((e, t = 2) => {
    ...
    for (let t of e) {
      if (n) {
        ...
        if (e < r) r -= e;
          ...
          if (i > 0 && i < 1)
            return { x: N((1 - i) * n.x + i * t.x, 5), y: N((1 - i) * n.y + i * t.y, 5) };
        }
      }
      n = t;
    }
  ...
  F = b((e, t, n) => {
    (x.info(`our points ${JSON.stringify(t)}`), t[0] !== n && (t = t.reverse()));
    let r = P(t, 25),
      i = e ? 10 : 5,
      a = Math.atan2(t[0].y - r.y, t[0].x - r.x),
      o = { x: 0, y: 0 };
    return (
      (o.x = Math.sin(a) * i + (t[0].x + r.x) / 2), (o.y = -Math.cos(a) * i + (t[0].y + r.y) / 2), o
    );
  }, `calcCardinalityPosition`);
function I(e, t, n) {
  let r = structuredClone(n);
  (x.info(`our points`, r), t !== `start_left` && t !== `start_right` && r.reverse());
  let i = P(r, 25 + e),
    a = 10 + e * 0.5,
...
var R = 0,
  z = b(() => (R++, `id-` + Math.random().toString(36).substr(2, 12) + `-` + R), `generateId`);
function B(e) {
  let t = ``;
    ...
    (e, n) => {
      ...
      for (let e of s) {
        ...
        for (let r of c) {
          let i = H();
          i.text = r || `​`;
          let s = de(d, i).style(`font-size`, o).style(`font-weight`, a).style(`font-family`, e),
