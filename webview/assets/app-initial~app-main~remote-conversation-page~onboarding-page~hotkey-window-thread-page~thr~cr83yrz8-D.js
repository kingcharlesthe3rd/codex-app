...
function d(e) {
  ...
  t[13] !== n || t[14] !== A
    ? ((N = n
        ? {
            "--annotation-mode-button-annotation-background": f(`charts-blue`, _),
            "--annotation-mode-button-annotation-hover-background": f(`charts-blue`, A),
          }
        : {}),
      (t[13] = n),
      (t[14] = A),
  ...
  let V = n ? `justify-start` : `w-full justify-center`,
    H;
  t[30] === V ? (H = t[31]) : ((H = l(`flex min-w-0 items-center`, V)), (t[30] = V), (t[31] = H));
  let U;
  t[32] === j
    ? (U = t[33])
    : ((U = l(
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = (0, g.jsx)(r, {
        className: l(`absolute inset-0 size-full rotate-0 scale-100 opacity-100`),
      })),
      (t[34] = W))
    : (W = t[34]);
  let G;
  t[35] === U
    ? (G = t[36])
    : ((G = (0, g.jsx)(`span`, { className: U, children: W })), (t[35] = U), (t[36] = G));
  ...
  let J;
  t[39] !== a || t[40] !== q
    ? ((J = (0, g.jsx)(`span`, { className: q, children: a })),
      (t[39] = a),
      (t[40] = q),
      (t[41] = J))
    : (J = t[41]);
  ...
  t[42] !== H || t[43] !== G || t[44] !== J
    ? ((Y = (0, g.jsxs)(`span`, { className: H, children: [G, J] })),
      (t[42] = H),
      (t[43] = G),
      (t[44] = J),
      (t[45] = Y))
...
var m,
  ...
  b = e(() => {
    ((m = a()),
      ...
      (_ = 10),
      (v = 15),
      (y = `border-token-charts-blue/40 bg-[var(--annotation-mode-button-annotation-background)] !text-token-text-link-foreground enabled:hover:bg-[var(--annotation-mode-button-annotation-hover-background)]`));
  });
export { b as n, d as t };
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~onboarding-page~hotkey-window-thread-page~thr~cr83yrz8-D.js.map
