...
function h(e) {
  let t = (0, d.c)(28),
    { buttonText: n, iconClassName: r, onCopy: h, ariaLabel: g, className: _, iconOnly: v } = e,
    y = r === void 0 ? `icon-sm` : r,
    b = v === void 0 ? !1 : v,
    x = i(),
    [S, C] = (0, f.useState)(!1),
    w = p(),
  ...
  t[5] !== n || t[6] !== S
    ...
    : (A = t[7]);
  let j = !b,
    M = S && `text-token-foreground`,
    N;
  t[8] !== _ || t[9] !== M ? ((N = o(M, _)), (t[8] = _), (t[9] = M), (t[10] = N)) : (N = t[10]);
  let P;
  t[11] !== g || t[12] !== S || t[13] !== x
    ? ((P = S
        ? x.formatMessage({
  ...
  let F = S ? void 0 : E,
    I;
  t[15] !== S || t[16] !== y
    ? ((I = S ? (0, m.jsx)(c, { className: y }) : (0, m.jsx)(u, { className: y })),
      (t[15] = S),
      (t[16] = y),
      (t[17] = I))
    : (I = t[17]);
  let L = !b && k,
    R;
  t[18] !== F || t[19] !== I || t[20] !== L || t[21] !== N || t[22] !== P
    ? ((R = (0, m.jsxs)(s, {
        className: N,
        "aria-label": P,
        color: `ghost`,
  ...
  let z;
  return (
    t[24] !== R || t[25] !== A || t[26] !== j
      ? ((z = (0, m.jsx)(l, { tooltipContent: A, disabled: j, children: R })),
        (t[24] = R),
        (t[25] = A),
        (t[26] = j),
        (t[27] = z))
