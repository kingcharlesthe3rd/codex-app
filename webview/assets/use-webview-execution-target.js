...
import { o as a, r as o, t as s } from "./use-host-config.js";
import {
  B as c,
  Qi as l,
  Yi as u,
...
var S = `[remote-connections/selection]`,
  C = n(i, ({ get: e }) => {
    let t = e(v),
      n = e(_) ?? [],
      r = x(n, Object.fromEntries(n.map((t) => [t.hostId, e(f, t.hostId)]))),
      i = u(e, g.SELECTED_REMOTE_HOST_ID) ?? null,
...
function w(e) {
  ...
  return e.watch(({ get: n }) => {
    ...
    ((t = i),
      l(e, g.SELECTED_REMOTE_HOST_ID, i ?? void 0).catch((e) => {
...
function D(e) {
  ...
  let w = S,
    D;
  return (
    n[8] !== b || n[9] !== w || n[10] !== f || n[11] !== x
      ? ((D = { activeWorkspaceRoot: b, isActiveWorkspaceRootLoading: f, hostConfig: w, ...x }),
        (n[8] = b),
        (n[9] = w),
        (n[10] = f),
        (n[11] = x),
