import { Z as e, a as t, c as n, s as r, t as i } from "./app-scope-CWE-zIhQ.js";
import { o as a, r as o, t as s } from "./use-host-config-C.js";
import {
  A as c,
  Qi as l,
  V as u,
...
import { h } from "./vscode-api.js";
import { Br as g } from "./src-1.js";
import { n as _, t as v } from "./selectable-remote-connections-signal.js";
import { a as y } from "./remote-projects.js";
var b = { connected: 0, restarting: 1, error: 2, connecting: 3, disconnected: 4 };
function x(e, t) {
  return [...e]
    .map((e, t) => ({ connection: e, index: t }))
    .sort((e, n) => {
      let r = b[t[e.connection.hostId] ?? `disconnected`],
        i = b[t[n.connection.hostId] ?? `disconnected`];
      return r === i ? e.index - n.index : r - i;
    })
    .map(({ connection: e }) => e);
}
var S = `[remote-connections/selection]`,
  C = n(i, ({ get: e }) => {
    let t = e(v),
      n = e(_) ?? [],
      r = x(n, Object.fromEntries(n.map((t) => [t.hostId, e(d, t.hostId)]))),
      i = l(e, g.SELECTED_REMOTE_HOST_ID) ?? null,
...
function w(e) {
  ...
  return e.watch(({ get: n }) => {
    ...
    if (
      ...
      return;
    h.info(`${S} persisted_selection_reconciled`, {
      safe: {
    ...
    ((t = i),
      m(e, g.SELECTED_REMOTE_HOST_ID, i ?? void 0).catch((e) => {
...
function D(e) {
  let n = (0, T.c)(13),
    ...
    o = t(c, i),
    l = t(u, i),
    { data: d, isLoading: m } = r(f),
    h = r(p),
    { remoteConnections: g } = r(C),
    { selectedRemoteProject: _ } = y(),
    [v] = a(`host_config`),
    b = d?.roots?.[0] ?? null,
    x,
    S;
  n[0] !== h || n[1] !== o || n[2] !== l || n[3] !== v || n[4] !== g || n[5] !== _
    ? ((x = E({
        activeLocalProjectCwd: h,
        conversationCwd: o,
        conversationHostId: l,
        selectedRemoteProject: _,
      })),
      (S = v && x.hostId === v.id ? v : s(x.hostId, g)),
      (n[0] = h),
      (n[1] = o),
      (n[2] = l),
      (n[3] = v),
  ...
  let w = S,
    D;
  return (
    n[8] !== b || n[9] !== w || n[10] !== m || n[11] !== x
      ? ((D = { activeWorkspaceRoot: b, isActiveWorkspaceRootLoading: m, hostConfig: w, ...x }),
        (n[8] = b),
        (n[9] = w),
        (n[10] = m),
        (n[11] = x),
...
export { w as i, D as n, C as r, E as t };
