...
import { m as p } from "./vscode-api.js";
import { mr as m } from "./src-1.js";
...
var x = `[remote-connections/selection]`,
  S = n(i, ({ get: e }) => {
    let t = e(_),
      ...
      i = f(e, m.SELECTED_REMOTE_HOST_ID) ?? null,
...
function C(e) {
  ...
  return e.watch(({ get: n }) => {
    ...
    ((t = i),
      o(e, m.SELECTED_REMOTE_HOST_ID, i ?? void 0).catch((e) => {
...
function E(e) {
  let n = (0, w.c)(14),
    ...
    o = t(c, i),
    s = t(a, i),
    { data: d, isLoading: f } = r(h),
    { remoteConnections: p } = r(S),
  ...
  let b = y,
    x;
  n[5] !== g || n[6] !== p || n[7] !== b
    ? ((x = g && b.hostId === g.id ? g : l(b.hostId, p)),
      (n[5] = g),
      (n[6] = p),
      (n[7] = b),
      (n[8] = x))
