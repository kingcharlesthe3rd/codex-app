import { R as e, a as t, c as n, s as r, t as i } from "./app-scope.js";
...
import { n as g, t as _ } from "./selectable-remote-connections-signal-DJZ-ZbLr.js";
...
var x = `[remote-connections/selection]`,
  S = n(i, ({ get: e }) => {
    let t = e(_),
      n = e(g) ?? [],
      r = b(n, Object.fromEntries(n.map((t) => [t.hostId, e(f, t.hostId)]))),
      i = l(e, o.SELECTED_REMOTE_HOST_ID) ?? null,
...
function C(e) {
  ...
  return e.watch(({ get: n }) => {
    ...
    if (
      ...
      return;
    a.info(`${x} persisted_selection_reconciled`, {
      safe: {
    ...
    ((t = i),
      d(e, o.SELECTED_REMOTE_HOST_ID, i ?? void 0).catch((e) => {
...
function E(e) {
  let n = (0, w.c)(14),
    ...
    a = t(u, i),
    o = t(s, i),
    { data: l, isLoading: d } = r(h),
    { remoteConnections: f } = r(S),
    { selectedRemoteProject: m } = v(),
    [g] = p(`host_config`),
    _ = l?.roots?.[0] ?? null,
    y;
  n[0] !== _ || n[1] !== a || n[2] !== o || n[3] !== m
    ? ((y = T({
  ...
  let b = y,
    x;
  n[5] !== g || n[6] !== f || n[7] !== b
    ? ((x = g && b.hostId === g.id ? g : c(b.hostId, f)),
      (n[5] = g),
      (n[6] = f),
      (n[7] = b),
      (n[8] = x))
