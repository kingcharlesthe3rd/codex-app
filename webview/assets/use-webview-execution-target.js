...
import { C as u, Q as d, S as f, Y as p, Z as m, wt as h } from "./setting-storage.js";
...
var x = `[remote-connections/selection]`,
  S = d(f, ({ get: t }) => {
    let n = l(t, `remote_connections`),
      ...
      d = a ? u : (c.find((e) => e.hostId === u)?.hostId ?? c[0]?.hostId ?? null);
    return {
  ...
  return t.watch(({ get: i }) => {
    ...
    u.info(`${x} persisted_selection_reconciled`, {
      safe: {
        ...
        selectedConnectionState: a.selectedRemoteConnection == null ? `cleared` : `selected`,
      },
      sensitive: {
...
function E(e) {
  ...
  return (
    n[9] !== _ || n[10] !== C || n[11] !== u || n[12] !== b
      ? ((E = { activeWorkspaceRoot: _, isActiveWorkspaceRootLoading: u, hostConfig: C, ...b }),
        (n[9] = _),
        (n[10] = C),
        (n[11] = u),
        (n[12] = b),
