...
import { Gh as le, Hh as ue, ig as de, ng as fe } from "./app-initial~app-main~onboarding-page.js";
import {
  A as pe,
  k as P,
...
function _e(e) {
  let t = (0, Y.c)(31),
    { clearSearch: n, close: r, hostId: i, onSelectFile: a, workspaceRoot: o } = e,
    l = T(s),
    u = h(),
    f = ee(me, `searchFiles`),
    p = ae(ye),
    ...
    _ = g === `files` ? p : ``,
    v;
  t[0] === o ? (v = t[1]) : ((v = [o]), (t[0] = o), (t[1] = v));
  let y;
  t[2] !== i || t[3] !== _ || t[4] !== v
    ? ((y = { hostId: i, query: _, roots: v }), (t[2] = i), (t[3] = _), (t[4] = v), (t[5] = y))
    : (y = t[5]);
  let { sections: b } = se(y),
    x = b[0],
    S,
  ...
  if (
    ...
    let r = f ?? ``,
      i;
    t[12] === r ? (i = t[13]) : ((i = (0, Z.jsx)(ne, { keysLabel: r })), (t[12] = r), (t[13] = i));
    let a;
    t[14] !== n || t[15] !== l
      ? ((a = () => {
          (n(), l.set(q, `files`));
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (D = t[22]);
  let O;
  t[23] !== r || t[24] !== x.emptyState || t[25] !== x.items || t[26] !== u || t[27] !== a
    ? ((O =
        x.items.length > 0
          ? x.items.map((e, t) =>
              (0, Z.jsx)(
            ...
            : (0, Z.jsx)(j.Item, {
                ...
                children: (0, Z.jsx)(`div`, {
                  ...
                  children: (0, Z.jsx)(`div`, {
                    ...
                    children: u.formatMessage(x.emptyState),
                  }),
                }),
              })),
      (t[23] = r),
  ...
  return (
    t[29] === O
      ...
      : ((k = (0, Z.jsx)(
          j.Group,
          { forceMount: !0, heading: w, className: `flex flex-col`, style: D, children: O },
          `group-files`,
        )),
        (t[29] = O),
        (t[30] = k)),
...
function xe() {
  ...
  (e[6] !== s || e[7] !== t
    ? ((u = () => {
        s &&
          (i.dispatchHostMessage({ type: `command-menu`, query: `` }),
          t.set(q, `files`),
          t.set(d, !0));
      }),
      (e[6] = s),
      ...
      (e[8] = u))
    : (u = e[8]),
    S(`file-search-command-menu`, re(u)));
  let f;
  e[9] !== s || e[10] !== n || e[11] !== a.id || e[12] !== o
    ? ((f = [s, n, a.id, o]), (e[9] = s), (e[10] = n), (e[11] = a.id), (e[12] = o), (e[13] = f))
    : (f = e[13]);
  let p = n === `files`,
    h;
  e[14] !== a.id || e[15] !== l || e[16] !== o
    ? ((h = (e, t) =>
        o == null
          ? null
          : (0, $.jsx)(_e, {
...
var Q,
  $,
  Se = e(() => {
    ((Q = D()), u(), p(), W(), J(), l(), r(), ce(), ue(), f(), fe(), M(), n(), be(), ($ = N()));
  });
export { q as a, W as c, G as i, I as l, Se as n, J as o, K as r, U as s, xe as t };
