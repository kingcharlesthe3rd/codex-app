...
import { Hr as t, Kn as n, U as r } from "./src-2.js";
import {
  E as i,
  J as a,
  Sn as o,
...
import { r as R } from "./react.js";
import { c as te, n as z, o as B, r as V } from "./lib-2.js";
import { m as H } from "./chunk-12.js";
import { o as U } from "./statsig.js";
import { t as W } from "./thread-context-inputs.js";
import { E as G, c as ne, t as re } from "./sidebar-signals.js";
import { r as ie } from "./toast-signal.js";
import { r as ae, t as K } from "./tooltip.js";
import { t as q } from "./button.js";
import { t as J } from "./spinner.js";
import { t as oe } from "./use-codex-home.js";
import { t as se } from "./open-workspace-file-CJcJ-CWR.js";
import { t as ce } from "./use-platform.js";
import { t as le } from "./local-conversation-title-signals.js";
import { h as ue } from "./window-app-action-helpers.js";
import { t as de } from "./use-stable-callback.js";
import { r as fe } from "./modal-controller-state.js";
import { a as pe, i as me, l as he, n as ge, r as _e } from "./dialog-layout.js";
import { a as ve } from "./open-project-setup-dialog.js";
import { t as ye } from "./context-menu.js";
import { n as be } from "./use-start-new-conversation.js";
import { r as xe } from "./pending-worktree-store-B7c-n7Re.js";
import {
  _ as Se,
  d as Ce,
  f as we,
...
import { i as je } from "./local-task-row-signals-n.js";
import { g as Y, h as Me, l as Ne } from "./sidebar-project-group-signals.js";
import {
  a as Pe,
  c as X,
  d as Fe,
...
import {
  ...
  r as Ge,
  t as Ke,
} from "./sidebar-task-pr-chip-signals-Bs-djlnq.js";
import { t as qe } from "./globe.js";
import { a as Je, r as Ye, s as Xe } from "./thread-actions.js";
import { t as Ze } from "./archive.js";
import { t as Qe } from "./use-app-server-connection-state.js";
import { t as $e } from "./format-relative-date-time.js";
import { a as et, i as tt, o as nt, s as rt, t as it } from "./local-task-row.js";
import { n as Q, r as at } from "./remote-host-globe-icon.js";
import { n as ot, t as st } from "./format-automation-next-run-label.js";
import { t as ct } from "./automation-queries.js";
import { t as lt } from "./get-attached-heartbeat-automation-for-thread.js";
import { t as ut } from "./stop.js";
import { b as dt, n as ft, o as pt, x as mt, y as ht } from "./realtime-controller.js";
import { t as gt } from "./local-environment-selection.js";
import { t as _t } from "./dist-BGrc-53E.js";
function vt(e, t, n) {
  let r = w(e);
  if (r != null) {
    t(r);
...
function yt(e, t) {
  let n = w(t);
  n != null && Se.start(`thread_switch_completed`, { conversationId: n, needsResume: e.get(_, n) });
}
function bt(e, t) {
  e.get(re) !== t && (yt(e, t), ne(e, t));
}
var xt = F(),
  $ = E();
function St() {
...
function wt(e) {
      ...
      ? ((e = (e, t) => {
          ...
          return d == null
            ? (0, $.jsxs)(
                Ct.Fragment,
                {
                  children: [o, (0, $.jsx)(`div`, { className: c, role: `listitem`, children: a })],
                },
                n,
              )
            : (0, $.jsxs)(
                Ct.Fragment,
                {
                  children: [
                    o,
                    (0, $.jsx)(d, { className: c, isLastVisibleItem: s, item: e, children: a }),
                  ],
                },
                n,
              );
  ...
  t[28] !== c || t[29] !== l || t[30] !== n.length
    ? ((k = n.length === 0 && c ? (0, $.jsx)(`div`, { className: l, children: c }) : null),
      (t[28] = c),
      (t[29] = l),
      (t[30] = n.length),
      (t[31] = k))
...
function Dt(e) {
  ...
  return (
    t[8] !== n.tooltipContent || t[9] !== c
      ? ((l = (0, $.jsx)(K, { tooltipContent: n.tooltipContent, children: c })),
...
var Ot = `flex items-center gap-2.5 opacity-0 group-hover:opacity-100 [&:has(:focus-visible)]:opacity-100`;
function kt(e) {
  let t = (0, xt.c)(10),
  ...
  let s = r?.active && `opacity-100`,
    c;
  t[0] !== i || t[1] !== s ? ((c = D(Ot, s, i)), (t[0] = i), (t[1] = s), (t[2] = c)) : (c = t[2]);
  let l;
  t[3] !== n || t[4] !== r || t[5] !== o
    ? ((l = r?.active
        ? (0, $.jsx)(q, {
        ...
        : n.map((e) => {
            ...
            return t
              ? (0, $.jsx)(K, { side: o, tooltipContent: e.ariaLabel, children: n }, e.id)
  ...
  return (
    t[7] !== c || t[8] !== l
      ? ((u = (0, $.jsx)(`div`, { className: c, children: l })), (t[7] = c), (t[8] = l), (t[9] = u))
      : (u = t[9]),
    u
  );
}
...
var Mt = /^#?(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/;
function Nt(e) {
  let t = (0, xt.c)(65),
    ...
    [s] = b(`remote_control_connections`),
    c = k(at),
    l = c?.[n] ?? null,
    [u, d] = (0, Ct.useState)(null),
    [f, p] = (0, Ct.useState)(null),
    m,
    h;
  t[0] !== n || t[1] !== s || t[2] !== o
    ? ((m = [...(o ?? []), ...(s ?? [])]),
  ...
  let g = h[n],
    ...
    v = u ?? _,
    y;
  t[5] === v ? (y = t[6]) : ((y = Ft(v)), (t[5] = v), (t[6] = y));
  let x = y,
    S = m.find((e) => e.hostId === n)?.displayName ?? n,
    C;
  t[7] !== x || t[8] !== c || t[9] !== u || t[10] !== n || t[11] !== r || t[12] !== i
    ? ((C = (e) => {
        (e.preventDefault(), x != null && (u != null && i.set(at, { ...c, [n]: x }), r()));
      }),
      (t[7] = x),
      (t[8] = c),
      (t[9] = u),
  ...
  t[16] !== c || t[17] !== n || t[18] !== r || t[19] !== i
    ? ((A = () => {
        let e = { ...c };
        (delete e[n], i.set(at, Object.keys(e).length > 0 ? e : void 0), r());
      }),
      (t[16] = c),
      (t[17] = n),
      (t[18] = r),
  ...
  t[26] === _
    ...
    : ((I = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(qe, { className: `icon-sm`, style: { color: _ } }),
      })),
      (t[26] = _),
      (t[27] = I));
  let L;
  ...
  let H;
  t[35] !== I || t[36] !== V
    ? ((H = (0, $.jsxs)(`div`, { className: `flex items-center gap-3`, children: [I, V] })),
      (t[35] = I),
      (t[36] = V),
      (t[37] = H))
    : (H = t[37]);
  ...
  t[40] === _
    ? (W = t[41])
    : ((W = (0, $.jsx)(_t, { className: `h-48 w-full`, color: _, onChange: D })),
      (t[40] = _),
      (t[41] = W));
  let G;
  t[42] !== U || t[43] !== W
    ? ((G = (0, $.jsx)(`div`, { "aria-label": U, children: W })),
      (t[42] = U),
      (t[43] = W),
      (t[44] = G))
    : (G = t[44]);
  let ne;
  t[45] !== H || t[46] !== G
    ? ((ne = (0, $.jsxs)(pe, { className: `gap-3 pt-4`, children: [H, G] })),
      (t[45] = H),
      (t[46] = G),
      (t[47] = ne))
    : (ne = t[47]);
  ...
  t[49] === j
    ? (ie = t[50])
    : ((ie = (0, $.jsx)(q, { color: `secondary`, type: `button`, onClick: j, children: re })),
      (t[49] = j),
      (t[50] = ie));
  let ae = x == null,
    K;
  ...
  t[52] === ae
    ? (J = t[53])
    : ((J = (0, $.jsx)(q, { color: `primary`, disabled: ae, type: `submit`, children: K })),
      (t[52] = ae),
      (t[53] = J));
  let oe;
  t[54] !== ie || t[55] !== J
    ? ((oe = (0, $.jsx)(pe, {
        className: `pt-4`,
        children: (0, $.jsxs)(_e, { children: [ie, J] }),
      })),
      (t[54] = ie),
      (t[55] = J),
      (t[56] = oe))
    : (oe = t[56]);
  let se;
  t[57] !== ee || t[58] !== ne || t[59] !== oe || t[60] !== F
    ? ((se = (0, $.jsxs)(ge, { as: `form`, onSubmit: ee, children: [F, ne, oe] })),
      (t[57] = ee),
      (t[58] = ne),
      (t[59] = oe),
      (t[60] = F),
  ...
  return (
    t[62] !== se || t[63] !== M
      ? ((ce = (0, $.jsx)(he, { open: !0, onOpenChange: M, size: `compact`, children: se })),
        (t[62] = se),
        (t[63] = M),
        (t[64] = ce))
      : (ce = t[64]),
...
function Ft(e) {
  return Mt.test(e) ? (e.startsWith(`#`) ? e : `#${e}`) : null;
}
function It(e) {
  switch (e) {
    case `macOS`:
...
var Lt = V({
  ...
  Rt = N(P, !1);
function zt({ scope: e, canToggleActiveStatus: t, showActiveStatus: n }) {
  if (!t) return [];
  let r = () => {
    e.set(Rt, !n);
  };
...
function Ht(e) {
  let t = (0, xt.c)(13),
    ...
    a = j(S, r),
    o = j(v, r),
    s = Ut({ latestTurnStatus: j(y, r), resumeState: i, streamRole: a, threadRuntimeStatus: o }),
    c = Vt[s],
    l;
  t[0] === n
    ? (l = t[1])
  ...
  let f;
  t[4] === d ? (f = t[5]) : ((f = (0, $.jsx)(`span`, { className: d })), (t[4] = d), (t[5] = f));
  let p;
  t[6] !== l || t[7] !== f || t[8] !== c
    ? ((p = (0, $.jsx)(`span`, { className: l, "aria-label": c, children: f })),
      (t[6] = l),
      (t[7] = f),
      (t[8] = c),
      (t[9] = p))
  ...
  return (
    t[10] !== p || t[11] !== c
      ? ((m = (0, $.jsx)(K, { tooltipContent: c, children: p })),
        (t[10] = p),
        (t[11] = c),
        (t[12] = m))
      : (m = t[12]),
...
function Ut({ latestTurnStatus: e, resumeState: t, streamRole: n, threadRuntimeStatus: r }) {
  return n == null
    ? t === `needs_resume`
      ? `needs-resume`
      : `read-only`
...
function Gt(e) {
          ...
          : [
              {
                ...
                icon: (0, $.jsx)(ut, { className: o == null ? void 0 : `translate-x-0.5` }),
                onClick: s.onClick,
              },
            ]),
      (t[0] = o),
          ...
          : [
              {
                ...
                icon: o.isPinned
                  ? (0, $.jsx)(we, { className: `translate-x-px` })
                  : (0, $.jsx)(ot, { className: `translate-x-px` }),
                onClick: o.onClick,
              },
            ]),
      (t[3] = o),
        ...
        ? [
            {
              ...
              ariaLabel: c.formatMessage(Ye.archiveThread),
              icon: (0, $.jsx)(Ze, {}),
              onClick: n,
            },
          ]
  ...
  let m = i && `pl-1 opacity-100`,
    h;
  t[18] === m ? (h = t[19]) : ((h = D(rt, m)), (t[18] = m), (t[19] = h));
  let g;
  return (
    t[20] !== f || t[21] !== p || t[22] !== h
      ? ((g = (0, $.jsx)(kt, { actions: f, confirmAction: p, className: h, tooltipSide: `right` })),
        (t[20] = f),
        (t[21] = p),
        (t[22] = h),
        (t[23] = g))
...
function Kt(e) {
  let t = (0, xt.c)(130),
    ...
    {
      archiveThread: _e,
      markThreadAsUnread: be,
      renameThread: Se,
      copyWorkingDirectory: we,
      copySessionId: Oe,
      copyAppLink: ke,
    } = Je(),
    { platform: je } = ce(),
    ...
    Me;
  t[0] !== y || t[1] !== _ || t[2] !== v
    ? ((Me = { onArchiveStart: _, onArchiveSuccess: v, onArchiveError: y }),
      (t[0] = y),
      (t[1] = _),
      (t[2] = v),
      (t[3] = Me))
  ...
  let {
      ...
      beginArchive: X,
      handleArchiveSuccess: Fe,
      handleArchiveError: Ie,
    } = nt(Me),
    { isActive: Z, onDoubleClick: Le, extraIconBadges: Re, priorityIndicatorNode: ze, ...We } = x,
    { createPendingWorktree: Ge } = xe(),
    Ke = R(gt),
    qe;
  t[4] === a ? (qe = t[5]) : ((qe = { conversationId: a }), (t[4] = a), (t[5] = qe));
  let { canOpenThreadInNewWindow: Ze, openThreadInNewWindow: Qe } = Ae(qe),
    $e = pe !== `projectless`,
    et;
  t[6] !== G || t[7] !== F ? ((et = r(F, G)), (t[6] = G), (t[7] = F), (t[8] = et)) : (et = t[8]);
  let tt = et,
    rt = F != null,
    Q = pe === `projectless` && (F == null || F === `~`) ? (ue ?? b ?? null) : F,
    at = ae && q ? { id: `active-status`, icon: (0, $.jsx)(Ht, { conversationId: a }) } : null,
    ot = null,
    st;
  t[9] !== a || t[10] !== F || t[11] !== D || t[12] !== E
    ? ((st = async () => {
        let e = await ht(E, { sourceConversationId: a, sourceWorkspaceRoot: F });
        e != null && D(`/local/${e}`);
      }),
      (t[9] = a),
      (t[10] = F),
  ...
  let ut = st,
    _t;
  t[14] !== a || t[15] !== Ge || t[16] !== F || t[17] !== Ke || t[18] !== D || t[19] !== E
    ? ((_t = async () => {
        let e = await dt(E, {
          createPendingWorktree: Ge,
          localEnvironmentSelectionsByWorkspace: Ke,
          sourceConversationId: a,
          sourceWorkspaceRoot: F,
        });
        e != null && D(`/worktree-init-v2/${e}`);
      }),
      (t[14] = a),
      (t[15] = Ge),
      (t[16] = F),
  ...
  if (ne === a && re !== `inactive`) {
    ...
    let n = e,
      r;
    t[23] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, $.jsx)(mt, { className: `icon-2xs shrink-0` })), (t[23] = r))
      : (r = t[23]);
    let i;
    t[24] === n
      ? (i = t[25])
    ...
    let a;
    (t[26] !== n || t[27] !== i
      ? ((a = (0, $.jsx)(K, { tooltipContent: n, children: i })),
        (t[26] = n),
        (t[27] = i),
        (t[28] = a))
      : (a = t[28]),
  ...
  let yt = Re;
  at != null && (yt = Re == null ? [at] : [...Re, at]);
  let { data: bt } = k(ct),
    St;
  t[29] !== bt?.items || t[30] !== a
    ? ((St = lt({ automations: bt?.items ?? [], conversationId: a })),
      (t[29] = bt?.items),
      (t[30] = a),
      (t[31] = St))
    : (St = t[31]);
  ...
  t[32] === wt
    ? (Dt = t[33])
    : ((Dt = wt == null ? null : (0, $.jsx)(qt, { automation: wt })), (t[32] = wt), (t[33] = Dt));
  let Ot = Dt,
    kt;
  t[34] !== _e ||
  t[35] !== X ||
  ...
  t[49] !== a || t[50] !== E
    ? ((Lt = () => {
        f(`clean-background-terminals`, { conversationId: a }).catch(() => {
          E.get(ie).danger(
            (0, $.jsx)(B, {
  ...
  let Bt = de(Lt),
    Vt;
  t[52] !== a || t[53] !== T || t[54] !== Se || t[55] !== E || t[56] !== J
    ? ((Vt = () => {
  ...
  t[58] !== Q || t[59] !== Y
    ? ((Kt = () => {
        Q && se({ path: Q, cwd: n(Q), target: `fileManager`, openFile: Y.mutate });
      }),
      (t[58] = Q),
      (t[59] = Y),
      (t[60] = Kt))
  ...
  let Jt = Kt,
    Yt;
  t[61] !== Ut || t[62] !== Z || t[63] !== Le
    ? ((Yt = (e) => {
        (Le?.(e), !e.defaultPrevented && Z && e.target?.closest(`[data-thread-title]`) && Ut());
      }),
      (t[61] = Ut),
      (t[62] = Z),
      (t[63] = Le),
  ...
  t[91] !== me
    ? ((Zt = () => [
        ...(C
          ? me && he
            ? He(E, { threadId: a, isPinned: S, sections: ge })
            : [
                De({
                  isPinned: S,
                  onPinnedChange: (e) => {
          ...
          : []),
        { id: `rename-thread`, message: Ye.renameThread, onSelect: Ut },
        ...(W == null || W === `local`
          ? []
          : [
              {
        ...
        { id: `archive-thread`, message: Ye.archiveThread, onSelect: Mt },
        {
          id: `mark-thread-unread`,
          message: Ye.markThreadUnread,
          enabled: L !== !0,
          onSelect: () => {
            be({ conversationId: a });
          },
        },
        ...zt({ scope: E, canToggleActiveStatus: ae, showActiveStatus: q }),
        { id: `thread-actions-separator`, type: `separator` },
        ...(W == null || W === `local`
          ? [{ id: `open-thread-folder`, message: It(je), enabled: !!Q, onSelect: Jt }]
          : []),
        {
          id: `copy-cwd`,
          message: Ye.copyWorkingDirectory,
          enabled: !!Q,
          onSelect: () => {
            we(Q);
          },
        ...
        ...($e
          ? [
              ...
              {
                id: `fork-into-local`,
                message: tt ? Ye.forkIntoSameWorktree : Ye.forkIntoLocal,
                onSelect: () => {
                  ut();
                },
              },
        ...
        ...(Ze
          ? [
              ...
              { id: `open-thread-new-window`, message: Ye.openInNewWindow, onSelect: Qe },
            ]
          : []),
      ]),
      (t[65] = rt),
  ...
  t[101] !== $t
    ? ((en = (e) => {
        ...
        return !i && !$t && !V
          ? null
          : (0, $.jsx)(Gt, {
              requestArchive: Et ? Mt : t,
              confirmArchive: n,
              confirmingArchive: Et ? !1 : r,
              canArchive: i,
              pinAction: $t
                ? {
                    ariaLabel: N.formatMessage(S ? Te : Ee),
                    isPinned: S,
                    onClick: () => {
                      Xe(E, a, !S);
                    },
  ...
  t[117] !== rn
    ? ((an = (0, $.jsx)(it, {
        ...
        heartbeatAutomationTooltipContent: Ot,
  ...
  let on;
  t[119] !== Qt || t[120] !== an
    ? ((on = (0, $.jsx)(ye, { getItems: Qt, children: an })),
      (t[119] = Qt),
      (t[120] = an),
      (t[121] = on))
    : (on = t[121]);
  let sn;
  t[122] !== Ft || t[123] !== Tt || t[124] !== A || t[125] !== M
    ? ((sn = A
        ? (0, $.jsx)(Ce, { heartbeatAutomationName: Tt, open: !0, onOpenChange: M, onConfirm: Ft })
        : null),
      (t[122] = Ft),
      (t[123] = Tt),
      (t[124] = A),
  ...
  return (
    t[127] !== on || t[128] !== sn
      ? ((cn = (0, $.jsxs)($.Fragment, { children: [on, sn] })),
        (t[127] = on),
        (t[128] = sn),
        (t[129] = cn))
      : (cn = t[129]),
...
function qt(e) {
  ...
  t[0] !== n.nextRunAt || t[1] !== n.status || t[2] !== r
    ? ((i = st({ intl: r, nextRunAt: n.nextRunAt, status: n.status })),
      (t[0] = n.nextRunAt),
      (t[1] = n.status),
      (t[2] = r),
      (t[3] = i))
...
var Jt = (0, Ct.memo)(function (e) {
  ...
  return (
    t[28] !== L || t[29] !== C || t[30] !== n
      ? ((R = (0, $.jsx)(Yt, { threadKey: n, isActive: C, ...L })),
        (t[28] = L),
        (t[29] = C),
        (t[30] = n),
        (t[31] = R))
...
function Yt(e) {
  ...
  return (
    t[4] !== n || t[5] !== a || t[6] !== r
      ? ((o = (0, $.jsx)(Xt, { entry: a, isActive: r, ...n })),
        (t[4] = n),
        (t[5] = a),
        (t[6] = r),
        (t[7] = o))
...
function Xt(e) {
  let t = (0, xt.c)(92),
    ...
    G = te(),
    ne = H(),
    { cancelPendingWorktree: re, renamePendingWorktree: ie, setPendingWorktreePinned: K } = xe(),
    q = n.kind === `local` ? n.conversationId : null,
    J = j(je, q),
    oe = j(d, q),
    se = j(i, q);
  j(a, q);
  let ce = j(s, q),
    le = j(h, q),
    de = j(Fe, q),
    pe = n.kind === `remote` ? n : null,
    me;
  t[0] === pe ? (me = t[1]) : ((me = Ke(pe)), (t[0] = pe), (t[1] = me));
  let he = j(Ge, me),
    ge = j(We, q),
    _e = j(ze, q),
    Se = n.kind === `remote` ? he : ge,
    Ce = Se?.iconBadge ?? null,
    we = N ? void 0 : w,
    ke = be(),
    Ae;
  t[2] === B
  ...
  t[4] === Ce
    ? (Me = t[5])
    : ((Me = Ce == null ? null : (0, $.jsx)(Dt, { badge: Ce })), (t[4] = Ce), (t[5] = Me));
  let Ne = Me,
    Pe;
  t[6] === ee
    ? (Pe = t[7])
    : ((Pe =
        ee == null
          ? void 0
          : (0, $.jsx)(`div`, {
              className: D(rt, `text-token-description-foreground`),
              children: (0, $.jsx)(ae, { keysLabel: ee }),
            })),
      (t[6] = ee),
      (t[7] = Pe));
  let X = Pe,
    Ie;
  t[8] !== N || t[9] !== Se
    ? ((Ie = !N && Se != null ? [Se.hoverCardSection] : void 0),
      (t[8] = N),
      (t[9] = Se),
      (t[10] = Ie))
    : (Ie = t[10]);
  let Z = Ie,
    Le = n.kind === `local` ? se : null,
    { state: Re } = Qe(Le ?? `local`),
    qe =
      n.kind === `local` && ce === `project` && Le != null && Le !== `local` && Re !== `connected`,
    Je;
  t[11] !== f ||
  t[12] !== re ||
  t[13] !== we ||
  ...
  t[27] !== z
    ? ((Je = function (e) {
        let t = e.pendingWorktree,
            ...
            (document.dispatchEvent(new PointerEvent(`pointercancel`)),
              fe(B, ve, {
                ...
                onSave: (e) => {
                  let n = e.trim(),
                    r = t.label.trim();
                  n.length === 0 || n === r || ie(t.id, n);
                },
              }));
          },
          o = G.formatMessage(r ? Te : Ee),
          s =
            f && !z
              ? Oe({
                  isPinned: r,
          ...
          c = y
            ? () => {
                (bt(B, n), y(), ne(`/worktree-init-v2/${t.id}`));
              }
            : void 0,
          d = (e) => {
          ...
          p = () => [
            ...(f
              ...
              : []),
            { id: `rename-thread`, message: Ye.renameThread, onSelect: a },
            ...(t.phase === `failed`
              ? [{ id: `archive-thread`, message: Ye.archiveThread, onSelect: i }]
              : []),
          ],
          m = f && z,
          h = L ? !1 : void 0;
        return (0, $.jsx)(ye, {
          ...
          children: (0, $.jsx)(tt, {
            ...
            hoverCardProjectLabel: we,
            onClick: c,
            onDoubleClick: d,
            onArchive: i,
            dataAttributes: ue.sidebarThreadRow({
              active: u,
              hostId: t.hostId,
              id: n,
  ...
  t[48] !== V
    ? ((nt = function (e) {
        let t = C(e.task.id),
          ...
          o = f
            ? V && U
              ? He(B, { threadId: e.task.id, isPinned: r, sections: W })
              : [
                  De({
                    isPinned: r,
                    onPinnedChange: (t) => {
          ...
          d =
            f && !t
              ? Oe({
                  isPinned: r,
                  hasUnreadTurn: !n && J === !0,
                  ariaLabel: G.formatMessage(r ? Te : Ee),
                  onPin: () => {
                    Y(s, !0);
                  },
                  onUnpin: () => {
              ...
              : { rest: null, hover: null },
          p = c,
          h = le ?? (typeof p == `string` ? p : ``),
          g = L || oe == null ? void 0 : (0, $.jsx)($e, { dateString: new Date(oe).toISOString() });
        return (0, $.jsx)(Kt, {
          conversationId: s,
          isAutomationRun: o,
          ...
          idleIndicatorNode: Ne,
          indicatorRestNode: d.rest,
          indicatorHoverNode: d.hover ?? d.rest,
          reserveLeadingSlot: F,
          metaContent: g,
          overlayMetaContent: X,
          titleOverride: p,
          threadWorkspaceRootHint: de,
          hoverCardSections: Z,
          disableHoverCard: N,
          displayCwd: T,
          isPinned: r,
...
var Qt = M(P, (e) => {
    let t =
      !e.isExpanded &&
      e.maxItems != null &&
      en({ threadKeys: e.threadKeys, currentThreadKey: e.currentThreadKey, maxItems: e.maxItems });
    return {
      isForceExpanded: t,
...
function en({ threadKeys: e, currentThreadKey: t, maxItems: n }) {
  return t == null ? !1 : e.indexOf(t) >= n;
}
var tn = (0, Ct.createContext)(null);
function nn() {
  return (0, Ct.useContext)(tn);
}
function rn({ shortcutLabels: e, shortcutThreadKeys: t }) {
  let n = new Map();
...
function an(e) {
  ...
  t[8] === a
    ...
    : ((M = (e) => {
        ...
        return a == null
          ? (0, $.jsx)(`div`, { className: n, children: r })
          : (0, $.jsx)(a, {
  ...
  if (n.length === 0 && s) {
    ...
    return (
      t[32] !== s || t[33] !== c
        ? ((e = (0, $.jsx)(`div`, { className: c, children: s })),
          (t[32] = s),
          (t[33] = c),
          (t[34] = e))
        : (e = t[34]),
  ...
  t[37] === f
    ...
    : ((B = (e) =>
        f?.beforeThreadKey != null && e.threadKey === f.beforeThreadKey
          ? (0, $.jsx)(St, {})
          : null),
      (z = f != null && f.beforeThreadKey == null ? (0, $.jsx)(St, {}) : null),
      (t[37] = f),
      (t[38] = z),
      (t[39] = B));
  let V;
  ...
  return (
    t[60] !== H || t[61] !== R
      ? ((U = (0, $.jsx)(`div`, { className: R, children: H })),
        (t[60] = H),
        (t[61] = R),
        (t[62] = U))
      : (U = t[62]),
...
var sn = [],
  cn = [],
  ln = { projectIds: [], unreadOnly: !1 },
  un = {
    isWorkspaceRootOptionsLoading: !1,
    projectGroups: sn,
    shortcutThreadKeys: cn,
    threadKeys: cn,
  },
  dn = N(P, ln),
  fn = A(P, ({ get: e }) => g(e, t.ACTIVE_REMOTE_PROJECT_ID) ?? e(W).data?.roots?.[0] ?? null),
  pn = L(P, (e) => {
    let n = un;
    return A(P, ({ get: e }) => {
      let r = e(Y),
        i = yn(e, r),
        { groups: a, isWorkspaceRootOptionsLoading: o } = e(Ne, {
          threadKeys: r,
          enabled: !0,
          threadProjectAssignments: g(e, t.THREAD_PROJECT_ASSIGNMENTS),
          projectlessThreadIds: g(e, t.PROJECTLESS_THREAD_IDS),
        }),
        s = a.filter(Sn),
        c = _n(i),
        l = gn({
          filters: e(dn),
          items: i.map((t) => ({ ...t, hasUnread: bn(e, t) })),
          projectGroups: s,
        }),
        u = {
...
function mn(e, t) {
  e.set(dn, (e) => (e.unreadOnly === t ? e : { ...e, unreadOnly: t }));
}
function hn(e, t, n) {
  e.set(dn, (e) =>
...
function gn({ filters: e, items: t, projectGroups: n }) {
...
function yn(e, t) {
  return e(e(Re, t)).map((t) => ({ ...t, recencyAt: xn(e, t) }));
}
function bn(e, t) {
  switch (t.task.kind) {
    case `local`:
      return e(je, t.task.conversation.id) ?? t.task.conversation.hasUnreadTurn;
    case `remote`:
...
function xn(e, t) {
  switch (t.task.kind) {
    case `local`:
      return e(d, t.task.conversation.id) ?? t.task.conversation.updatedAt;
    case `remote`:
...
function Cn(e, t) {
  let n = wn(e.projectGroups, t.projectGroups),
    r = wn(e.shortcutThreadKeys, t.shortcutThreadKeys),
    i = wn(e.threadKeys, t.threadKeys);
...
var Tn = L(P, (e) => {
  ...
  return A(P, ({ get: r }) => {
    let { groups: i } = r(Ne, {
        threadKeys: r(Y),
        enabled: !0,
        threadProjectAssignments: g(r, t.THREAD_PROJECT_ASSIGNMENTS),
        projectlessThreadIds: g(r, t.PROJECTLESS_THREAD_IDS),
      }),
      a = i.find((t) => t.projectId === e) ?? null;
    if (a == null) return (n.group != null && (n = { group: null }), n);
    let o = vn(yn(r, a.threadKeys)),
      s = n.group == null ? o : En(n.threadKeys, o);
    return ((n.group === a && n.threadKeys === s) || (n = { group: a, threadKeys: s }), n);
  });
});
function En(e, t) {
  if (e.length !== t.length) return t;
...
//# sourceMappingURL=home-project-recent-chats-signals.js.map
