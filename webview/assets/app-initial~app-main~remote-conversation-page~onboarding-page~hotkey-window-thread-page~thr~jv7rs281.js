...
function O(e, { maxFiles: t } = {}) {
  ...
  try {
    ...
    (i.error(`Failed to parse diff`, { safe: {}, sensitive: { error: e } }), (l = []));
  }
  let d = [],
    f = 0;
  for (let e of l)
    for (let n of e.files) {
      ...
      try {
        ...
        i.error(`Failed to parse diff`, { safe: {}, sensitive: { name: n.name, error: e } });
      }
      f += 1;
    }
  if (n) {
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~onboarding-page~hotkey-window-thread-page~thr~jv7rs281.js.map
