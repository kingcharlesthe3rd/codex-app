...
async function k(e, t, n) {
  let r = w(e),
    i = (n ?? []).find((e) => (e.originUrl ? (0, M.default)(w(e.originUrl), r) : !1));
  return i
    ? i.root
...
function A(e, t) {
  ...
  let { data: s, isLoading: l } = u(y, o),
    d;
  n[7] !== e || n[8] !== s?.origins
    ? ((d = s?.origins.find((t) => t.dir === e)?.root ?? s?.origins[0]?.root ?? null),
      (n[7] = e),
      (n[8] = s?.origins),
      (n[9] = d))
    : (d = n[9]);
  ...
  return (
    n[12] !== l || n[13] !== p
      ? ((m = { gitRoot: p, isLoading: l }), (n[12] = l), (n[13] = p), (n[14] = m))
      : (m = n[14]),
    m
  );
}
var j,
  ...
  N,
  P = e(() => {
    ((j = r()), (M = t(l(), 1)), s(), d(), (N = t(o(), 1)), x(), p(), i(), T(), v());
  });
...
function L(e) {
  ...
  let v = _,
    y;
  t[16] === i ? (y = t[17]) : ((y = i == null ? void 0 : z(i)), (t[16] = i), (t[17] = y));
  let b = y,
    x;
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (A = t[26]);
  let j;
  (t[27] === E ? (j = t[28]) : ((j = [E]), (t[27] = E), (t[28] = j)), (0, H.useEffect)(A, j));
  let M = ee,
    N = d == null ? `items-center` : `items-start`,
    P;
  t[29] === N ? (P = t[30]) : ((P = g(`flex w-full min-w-0 gap-2`, N)), (t[29] = N), (t[30] = P));
  let I;
  t[31] !== n || t[32] !== c
  ...
  let L = R,
    ...
    G;
  t[34] === W ? (G = t[35]) : ((G = g(`truncate`, W)), (t[34] = W), (t[35] = G));
  let K = O.map((e, t) =>
      (0, U.jsx)(
        `span`,
        { className: g(!e.isMatch && k && `text-token-description-foreground`), children: e.text },
        t,
      ),
    ),
    q;
  t[36] !== L || t[37] !== G || t[38] !== K || t[39] !== m || t[40] !== S
    ? ((q = (0, U.jsx)(L, { tooltipContent: S, delayDuration: m, className: G, children: K })),
      (t[36] = L),
      (t[37] = G),
      (t[38] = K),
      (t[39] = m),
          ...
          ? (0, U.jsxs)(`div`, {
              ...
              children: [
                i
                  ...
                  : null,
                u ? (0, U.jsx)(`span`, { className: `shrink-0 opacity-80`, children: u }) : null,
  ...
  let Z;
  t[55] !== Y || t[56] !== X
    ? ((Z = (0, U.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [Y, X] })),
      (t[55] = Y),
      (t[56] = X),
      (t[57] = Z))
    : (Z = t[57]);
...
function R(e) {
  let t = (0, V.c)(8),
    ...
    s;
  t[0] !== n || t[1] !== r
    ? ((s = (0, U.jsx)(`div`, { className: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = s))
    : (s = t[2]);
  let c;
  return (
...
export { O as a, A as c, I as i, E as l, G as n, P as o, F as r, D as s, L as t };
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~new-thread-panel-page~appgen-library-page~hot~gm3qqodb.js.map
