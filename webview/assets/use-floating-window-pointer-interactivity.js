...
function a(e) {
  let t = (0, r.c)(26),
    ...
    h;
  t[0] === a ? (h = t[1]) : ((h = a === void 0 ? [] : a), (t[0] = a), (t[1] = h));
  let g = h,
    _ = l === void 0 ? !1 : l,
    v = p === void 0 ? !0 : p,
    y;
  t[2] === m ? (y = t[3]) : ((y = m === void 0 ? [] : m), (t[2] = m), (t[3] = y));
  let b = y,
    [x, S] = (0, i.useState)(!1),
    C;
  ...
  let A;
  return (
    t[19] !== n || t[20] !== g || t[21] !== _ || t[22] !== u || t[23] !== v || t[24] !== b
      ? ((A = [n, g, _, u, v, b]),
        (t[19] = n),
        (t[20] = g),
        (t[21] = _),
