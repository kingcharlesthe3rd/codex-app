...
function h({ getOptions: e, getParams: t, method: i }) {
  let f = r(
      n,
      (n) =>
        s(i, { commonDir: n.commonDir, root: n.root }, t(n), u(n.hostConfig), n.hostConfig, {
          enabled: n.enabled,
          ...e?.(n),
        }),
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~pull-requests-page~new-thread-panel-page~proj~jolrh1c9.js.map
