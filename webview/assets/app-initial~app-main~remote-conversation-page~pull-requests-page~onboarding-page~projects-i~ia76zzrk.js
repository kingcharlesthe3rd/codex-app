...
function A(e) {
  ...
  if (t[0] !== r || t[1] !== n || t[2] !== a) {
    let { Icon: e, iconClassName: i } = N({ status: n, tone: a });
    ((s = e), (c = o(r, i)), (t[0] = r), (t[1] = n), (t[2] = a), (t[3] = s), (t[4] = c));
  } else ((s = t[3]), (c = t[4]));
  let l;
  return (
    t[5] !== s || t[6] !== c
      ? ((l = (0, I.jsx)(s, { className: c })), (t[5] = s), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
function j(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== a) {
    let { Icon: e, iconClassName: i } = P({ state: r, tone: a });
    ((s = e), (c = o(n, i)), (t[0] = n), (t[1] = r), (t[2] = a), (t[3] = s), (t[4] = c));
  } else ((s = t[3]), (c = t[4]));
  let l;
  return (
    t[5] !== s || t[6] !== c
...
function N({ status: e, tone: t }) {
  return {
    Icon: L[e],
    iconClassName: t === `currentColor` ? `text-current` : t === `neutral` ? H : R[e],
  };
}
function P({ state: e, tone: t }) {
  return {
    Icon: z[e],
    iconClassName:
      t === `currentColor` ? o(`text-current`, V[e]) : t === `neutral` ? o(H, V[e]) : B[e],
  };
}
var F,
  I,
  ...
  U = e(() => {
    ((F = n()),
      ...
      k(),
      (I = i()),
      (L = { draft: u, open: S, merged: y, closed: p }),
      (R = {
      ...
      (z = { draft: u, failing: g, in_progress: T, merged: y, ready: O, successful: O }),
      (B = {
        draft: `text-token-description-foreground`,
      ...
      (H = `text-token-description-foreground`));
  });
export { S as a, b as c, U as i, u as l, A as n, C as o, j as r, y as s, M as t, d as u };
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~pull-requests-page~onboarding-page~projects-i~ia76zzrk.js.map
