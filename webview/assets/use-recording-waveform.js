...
import { C as t, Wi as n, ca as r, na as i, sa as a } from "./src-2.js";
import { n as o } from "./jsx-runtime.js";
import { l as s, lt as c } from "./vscode-api.js";
import { a as l, n as u } from "./request.js";
import { n as d } from "./setting-storage.js";
var f = 0.0025,
  ee = 48e3;
function p(e) {
...
var m = `gpt-5.4-mini`,
  h = i({
    output: n(i({ type: a(), content: n(i({ type: a(), text: a().optional() })).optional() })),
  }),
  g = i({
    type: a().optional(),
    delta: a().optional(),
    text: a().optional(),
    response: h.optional(),
    error: r([a(), i({ message: a().optional() })]).optional(),
  }).passthrough();
...
async function k() {
  let e = T.safeParse(await d(t.dictationDictionary));
  return e.success
    ? e.data
        .map((e) => e.trim())
        .filter((e) => e.length > 0)
