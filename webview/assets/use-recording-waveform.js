...
import { a as u, n as d } from "./request.js";
var f = 0.0025,
  ee = 48e3;
function p(e) {
...
var m = `gpt-5.4-mini`,
  h = n({
    output: i(n({ type: a(), content: i(n({ type: a(), text: a().optional() })).optional() })),
  }),
  g = n({
    type: a().optional(),
    delta: a().optional(),
...
async function A(e, t = {}) {
  let n = t.contentType ?? (e.type && e.type.trim().length > 0 ? e.type : `audio/webm`),
    ...
    a = N(),
    o = u(await j({ blob: e, boundary: a, filename: i, contentType: n, language: t.language })),
    c = { "Content-Type": `multipart/form-data; boundary=${a}`, "X-Codex-Base64": `1`, ...d() };
