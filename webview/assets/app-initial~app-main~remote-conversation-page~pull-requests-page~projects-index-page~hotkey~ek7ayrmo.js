...
function v({ className: e = `icon-sm shrink-0`, checks: t }) {
  let r = y(t),
    i = n(`text-token-description-foreground`, e);
  if (r.length === 0) return (0, b.jsx)(g, { className: i });
  let a = r.length > 1 ? C : 0,
    o = 0;
  return (0, b.jsx)(`svg`, {
    "aria-hidden": !0,
    className: i,
...
var b,
  ...
  C,
  w = e(() => {
    (s(), _(), (b = r()), (x = 5.75), (S = 2 * Math.PI * x), (C = 1.5));
  }),
  T,
  E,
  D = e(() => {
...
function O({ checks: e, ciStatus: t }) {
  if (e.length === 0)
    switch (t) {
      case `failing`:
        return (0, A.jsx)(m, { className: `icon-sm shrink-0 text-token-charts-red` });
      case `none`:
        return (0, A.jsx)(p, { className: `icon-sm shrink-0` });
      case `passing`:
        return (0, A.jsx)(o, { className: `icon-sm shrink-0 text-token-charts-green` });
      case `pending`:
        return (0, A.jsx)(E, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    }
  return t === `none`
    ? (0, A.jsx)(p, { className: `icon-sm shrink-0` })
    : (0, A.jsx)(v, { checks: e });
}
function k(e) {
  switch (e) {
...
function M({ automations: e, conversationId: t, includePausedAutomations: n = !1 }) {
  return t == null
    ? null
    : (e.find(
        (e) =>
          i(e) && (e.status === `ACTIVE` || (n && e.status === `PAUSED`)) && e.targetThreadId === t,
      ) ?? null);
}
var N = e(() => {
  l();
});
export { j as a, v as c, k as i, w as l, N as n, E as o, O as r, D as s, M as t };
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~pull-requests-page~projects-index-page~hotkey~ek7ayrmo.js.map
