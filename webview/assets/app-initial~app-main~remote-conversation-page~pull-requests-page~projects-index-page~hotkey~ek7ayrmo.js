...
function v({ className: e = `icon-sm shrink-0`, checks: t }) {
  let n = y(t),
    r = p(`text-token-description-foreground`, e);
  if (n.length === 0) return (0, b.jsx)(l, { className: r });
...
var b,
  ...
  C,
  w = e(() => {
    (m(), u(), (b = a()), (x = 5.75), (S = 2 * Math.PI * x), (C = 1.5));
  }),
  T,
  E,
  D = e(() => {
...
function O({ checks: e, ciStatus: t }) {
  if (e.length === 0)
    switch (t) {
      case `failing`:
        return (0, A.jsx)(d, { className: `icon-sm shrink-0 text-token-charts-red` });
      case `none`:
        return (0, A.jsx)(c, { className: `icon-sm shrink-0` });
      case `passing`:
        return (0, A.jsx)(g, { className: `icon-sm shrink-0 text-token-charts-green` });
      case `pending`:
