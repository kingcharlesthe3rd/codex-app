...
function P(e, t = B()) {
  ...
  return (
      ...
      : n === `computer-use` && ((r = t.computerUse), (i = r)),
    {
      ...
      description: e.description ?? ``,
      iconSmall: F(e),
      brandColor: V(e.plugin.interface),
    }
  );
}
function F(e) {
...
function I(e) {
  return { kind: `skill`, ...M(e) };
}
function L(e) {
  return { kind: `app`, ...N(e) };
}
function R(e, t) {
  return { kind: `plugin`, ...P(e, t) };
}
function z(e) {
...
function H({ conversationId: e, displayName: t }) {
  let n = W(t);
...
//# sourceMappingURL=mention-item-B.js.map
