...
import "./isEqual.js";
import { _t as r, dt as i, gt as a } from "./src-1.js";
import "./react-dom.js";
...
import { a as c, g as l } from "./chunk-13.js";
...
import { t as f } from "./worktree-init-v2-page-2.js";
var p = t(),
  m = e();
function h() {
  let e = (0, p.c)(8),
  ...
  return (
    e[6] === v
      ? (b = e[7])
      : ((b = (0, m.jsx)(f, { homePath: v, conversationPathBuilder: i, onConversationReady: g })),
        (e[6] = v),
        (e[7] = b)),
    b
  );
...
function g(e) {
  s.hotkeyWindowHotkeys?.open({ path: i(e) });
}
