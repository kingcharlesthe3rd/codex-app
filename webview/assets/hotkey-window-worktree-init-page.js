...
function S() {
  ...
  if (
    ...
    return (
      e[4] === l
        ? (t = e[5])
        : ((t = (0, T.jsx)(d, { to: l, replace: !0 })), (e[4] = l), (e[5] = t)),
      t
    );
  }
  let p;
  return (
    e[6] === l
      ? (p = e[7])
      : ((p = (0, T.jsx)(x, { homePath: l, conversationPathBuilder: i, onConversationReady: C })),
        (e[6] = l),
        (e[7] = p)),
    p
  );
...
function C(e) {
  p.hotkeyWindowHotkeys?.open({ path: i(e) });
}
var w, T;
e(() => {
  ((w = n()), r(), t(), h(), l(), f(), b(), _(), v(), (T = c()));
})();
