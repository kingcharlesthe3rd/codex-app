...
import { d as g, u as _ } from "./app-initial~app-main~automations-page.js";
import { n as v, r as y } from "./use-hotkey-window-detail-layout.js";
import { n as b, t as x } from "./worktree-init-v2-page-2.js";
function S() {
  let e = (0, w.c)(8),
  ...
  if (
    ...
    return (
      e[4] === s
        ? (n = e[5])
        : ((n = (0, T.jsx)(t, { to: s, replace: !0 })), (e[4] = s), (e[5] = n)),
      n
    );
  }
  let f;
  return (
    e[6] === s
      ? (f = e[7])
      : ((f = (0, T.jsx)(x, { homePath: s, conversationPathBuilder: u, onConversationReady: C })),
        (e[6] = s),
        (e[7] = f)),
    f
  );
...
function C(e) {
  s.hotkeyWindowHotkeys?.open({ path: u(e) });
}
var w, T;
e(() => {
  ((w = f()), i(), a(), o(), n(), c(), b(), g(), v(), (T = h()));
})();
