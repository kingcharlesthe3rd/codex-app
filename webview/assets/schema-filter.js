...
import { Dx as t, Nx as n } from "./app-initial~app-main~new-thread-panel-page.js";
import { n as r, t as i } from "./is-plan-event-enabled.js";
function a(e, t) {
...
function o(e, n) {
  function i(i) {
    ...
    if (o && s) {
      ...
      if (r(o, c)) {
        var l = a(c, n);
        i.updateEvent(`integrations`, t(t(t({}, i.event.integrations), c?.integrations), l));
      } else
        return (
          i.updateEvent(
            `integrations`,
