...
import { Br as t, Kn as n, qt as r } from "./src-2.js";
import {
  Fa as i,
  Hn as a,
  Ia as o,
...
import { t as ae } from "./persisted-signal-CweW-bgN.js";
import { i as oe, t as w } from "./route-scope.js";
import { a as se, j as ce } from "./app-shell-state.js";
import { r as le } from "./diff-view-mode.js";
import { n as ue } from "./app-shell-tab-controller.js";
import { i as de, t as fe } from "./parse-diff.js";
import { t as pe } from "./sumBy-BWhD-7U6.js";
import { a as T, n as E, r as D } from "./thread-context.js";
import { t as me } from "./hash-code.js";
import { n as he, r as ge, t as _e } from "./project-context-signal.js";
import { g as ve } from "./window-app-action-helpers.js";
function O(e) {
...
function Ce({
  ...
  return c?.aborted
    ...
    : new Promise((u, f) => {
        ...
        h.disposeAbortListener = Te({
          abortPathRequest: () => {
            Ee({ path: o, pendingRequest: m, pathRequest: h });
          },
          signal: c,
        });
        let g = m.paths.get(o);
        (g != null && (g.disposeAbortListener(), g.reject(d())),
          m.paths.set(o, h),
          !A.has(p) &&
            (A.set(p, m),
            (m.flushTimeoutId = setTimeout(() => {
              ((m.flushTimeoutId = null), De(p));
            }, ye))));
      });
}
function we(e) {
...
function Te({ abortPathRequest: e, signal: t }) {
  return t == null
    ? () => {}
...
function Ee({ path: e, pathRequest: t, pendingRequest: n }) {
  if (
    n.paths.get(e) === t &&
    (t.disposeAbortListener(), n.paths.delete(e), t.reject(d()), !(n.paths.size > 0))
  ) {
    ...
    await Promise.allSettled(
      e.map(async (e) => {
        ...
        try {
          ...
          ke({ error: n instanceof Error ? n : Error(String(n)), files: e, pendingRequest: t });
        } finally {
...
function Oe({ diffs: e, files: t, hideWhitespace: n, pendingRequest: r }) {
  for (let i of t) {
...
function ke({ error: e, files: t, pendingRequest: n }) {
  for (let r of t) n.paths.get(r.path)?.reject(e);
}
function Ae({ baseBranch: e, commitSha: t, cwd: r, hideWhitespace: i, source: a }) {
  return {
    cwd: n(r),
    ...(i ? { hideWhitespace: i } : {}),
    source: a,
...
var je = e(t(), 1);
function Me({ cwd: e, path: t }) {
  if (e == null || !p(t)) return t;
  let n = h(je.default.relative(m(``, e), t));
  return n === `` ? te(t) : n;
}
function Ne({ gitRoot: e, gitPath: t }) {
  let n = h(t);
  return e == null ? n : h(m(e, n));
}
var Pe = x(w, null);
function Fe(e, t) {
  (e.set(Pe, null), e.set(k, t));
}
var Ie = e(r(), 1),
  Le = new WeakMap(),
  Re = x(w, null),
  ...
  Be = y(w, ({ get: e }) => e(ze)),
  Ve = ne(S, (e) => null),
  He = y(w, ({ get: e, scope: t }) => e(Ve, oe(t.value))),
  Ue = 3,
  We = 300,
  Ge = 1e3,
  Ke = 30,
  qe = x(w, !1),
  M = ge,
  Je = re(w, ({ get: e }) => u(e(ze), e(T), e(D), `review_model`, { watchForGitInit: !0 })),
  Ye = y(w, ({ get: e }) => e(Je).data?.root ?? e(ze)),
  Xe = b(S, (e) =>
    a(
      `base-branch`,
  ...
  N = y(w, ({ get: e }) => {
    let t = e(M),
      n = t.data ?? null;
    return n == null ? v(t) : e(Xe, { commonDir: n.commonDir, hostConfig: e(D), root: n.root });
  }),
  Ze = he,
  Qe = re(w, ({ get: e }) => {
    let t = e(D),
    ...
    return a(
      `recent-branches`,
      r,
      r == null ? null : { limit: Ke, operationSource: `review_model`, root: r.root },
      n,
      t,
    );
  }),
  P = y(w, ({ get: e }) => St(e(N).data ?? null, e(He))),
  $e = re(w, ({ get: e }) => {
    let t = e(D),
      n = e(T),
      r = e(M).data ?? null,
  ...
  et = b(S, (e) =>
    a(
      `index-info`,
      { commonDir: e.commonDir, root: e.root },
      { cwd: n(e.cwd), operationSource: `review_model` },
      _(e.hostConfig),
      e.hostConfig,
  ...
  tt = y(w, ({ get: e }) => {
    ...
    return i == null
      ? v(r)
      : e(et, { commonDir: i.commonDir, cwd: n, hostConfig: e(D), root: i.root });
  }),
  nt = b(S, (e) =>
    a(
      `review-summary`,
      ...
      {
        enabled: e.enabled,
        refetchInterval: (e) => (e.state.data?.type === `error` ? Ge : !1),
  ...
  F = y(w, ({ get: e }) => {
    ...
    return o == null ? (n == null ? v(t) : f()) : e(nt, o);
  }),
  at = y(w, ({ get: e }) => {
    let t = e(F).data;
    ...
    for (let e of t.files) {
      let t = Ne({ gitRoot: n, gitPath: e.path });
      r.has(t) || r.set(t, e);
    }
    return r;
  });
function ot(e, t = e.get(ut)) {
  let n = e.get(N),
  ...
  return i == null ? null : e.query.snapshot(nt, i);
}
function st({
  baseBranch: e,
  commitSha: t,
...
var I = y(w, ({ get: e, scope: t }) =>
    t.value.routeKind === `remote-thread` ? `cloud` : e(_e).isCodexWorktree ? `worktree` : `local`,
  ),
  ct = y(w, ({ get: e }) => e(L) && e(k) === `branch`),
  lt = y(w, ({ get: e }) => e(L) && O(e(k))),
  L = y(w, ({ get: e }) => {
    let t = e(k);
    return (
...
function dt({ cwd: e, hideWhitespace: t, source: r, baseBranch: i, commitSha: a }) {
  return {
    cwd: n(e),
    ...(t ? { hideWhitespace: t } : {}),
    operationSource: `review_model`,
...
async function ht(e, t) {
  await e.get(ft, t).refetch();
}
async function gt(e, { queueIfRefreshing: t = !1 } = {}) {
  let n = e.get(M).data,
    r = Le.get(e);
  if (n == null) return;
  if (r != null) {
...
async function _t(e, t) {
  ...
  try {
    ...
    await Promise.all([l(e.queryClient, t.commonDir, { hostKey: e.get(T) }), Ot(e)]);
  } finally {
    e.set(qe, !1);
  }
}
async function vt(e, t) {
  let n = e.get(M).data,
    r = e.get(E),
    i = yt({ cwd: r, gitRoot: n?.root ?? null, paths: t });
...
function yt({ cwd: e, gitRoot: t, paths: n }) {
  ...
  return [
    ...new Set(
      n.flatMap((t) => {
        if (t === ``) return [];
        let n = je.default.relative(r, m(e, t));
...
async function xt(e, t) {
  await Promise.all([ee(e.queryClient, t, { hostKey: e.get(T) }), Ot(e)]);
}
function St(e, t = null) {
  return t ?? bt(e);
}
async function Ct(e) {
  e.get(lt) && (await e.get(tt).refetch());
}
function wt(e, t, n) {
  (e.set(Re, t), e.set(ze, n));
}
function Tt(e, t, n) {
  e.set(Ve, t, n);
}
function Et(e, t) {
  (e.set(j, t), Fe(e, `commit`));
}
function Dt(e) {
  return e.watch((t) => {
    if (t.get(k) === `commit`) {
      ...
      if (!(n == null || n.some((t) => t.sha === e))) {
        (t.set(j, null), Fe(t, `branch`));
        return;
      }
    }
    let n = t.get(ut);
    (n === `branch` && t.get(P),
      t.get(M).data != null && (t.get(Re) != null || (t.get(L) && n != null)) && mt(e));
  });
}
async function Ot(e) {
  let t = ot(e);
...
function At(e, t) {
  return t.name !== `AbortError` && e < Ue;
}
function jt(e) {
  return Math.min(We * 2 ** e, 2e3);
}
function Mt(e, t) {
  return e.length > 0 && e.length === t.length && (0, Ie.default)(e.slice(0, -1), t.slice(0, -1));
}
var Nt = e(pe(), 1);
function Pt() {
...
function Vt({ reviewSummary: e, selectedDiff: t, shouldFetchReviewSummary: n }) {
  ...
  let r = t.diff ?? [];
  return Wt(
    (0, Nt.default)(r, (e) => e.additions),
    (0, Nt.default)(r, (e) => e.deletions),
    r.length,
    t.diffText?.length ?? 0,
  );
}
function Ht(e) {
  return Wt(
    (0, Nt.default)(e.files, (e) => e.additions ?? 0),
    (0, Nt.default)(e.files, (e) => e.deletions ?? 0),
    e.files.length,
  );
}
function Ut(e) {
...
var Kt = y(w, ({ get: e }) =>
  ...
  qt = y(w, ({ get: e }) => (e(I) === `cloud` || e(k) === `last-turn` ? (e(Be) ?? e(E)) : e(E))),
  Jt = y(w, ({ get: e }) => {
  ...
  Zt = y(w, ({ get: e }) => {
    ...
    return Vt({
      ...
      selectedDiff: t ? { diff: null, diffText: null } : e(R),
  ...
  $t = y(w, ({ get: e }) =>
    Gt({ reviewSummary: e(F).data, selectedDiff: e(R), shouldFetchReviewSummary: e(L) }),
  ),
  en = y(w, ({ get: e }) => {
    let t = e(M);
  ...
  rn = y(w, ({ get: e }) => e(M).data?.commonDir != null && !e(qe)),
  an = y(w, ({ get: e, scope: t }) => {
    let n = e(R);
    return t.value.routeKind !== `remote-thread` && n.isPendingGitChanges && !e($t);
  }),
  on = y(w, ({ get: e }) => e(R).diffError?.type === `diff-too-large`);
...
var cn = y(w, ({ get: e }) => {
  ...
  z = y(w, ({ get: e }) => {
    if (e(L)) return mn({ cwd: e(E), gitRoot: e(M).data?.root ?? null, reviewSummary: e(F).data });
    let t = e(I) === `cloud` || e(k) === `last-turn` ? e(Ye) : (e(M).data?.root ?? null);
    return gn(e(R).diff, t);
  }),
  ln = ie(w, (e, { get: t }) => {
    if (t(L)) {
    ...
    let n = h(i(e, t(E) ?? void 0));
    return t(z).find((t) => t.path === e || t.gitPath === n) ?? null;
  }),
  un = y(w, ({ get: e }) => _n(e(z))),
  dn = y(w, ({ get: e }) => vn({ diffBytes: e(R).diffBytes, fileEntries: e(z) })),
  fn = y(w, ({ get: e }) =>
    de({ fileCount: e(z).length, totalChangedBytes: e(dn), totalChangedLines: e(un) }),
  ),
  pn = y(w, ({ get: e }) => {
    let t = e(z);
    return !e(L) || e(fn) ? t : t.map((t) => e(ln, t.path) ?? t);
  });
function mn({ cwd: e, gitRoot: t, reviewSummary: n }) {
  return n?.type === `success`
    ? n.files.map((n) => hn({ cwd: e, gitRoot: t, reviewDiffIsFetching: !0, reviewFile: n }))
    : [];
}
function hn({
  cwd: e,
  ...
  return (
      ...
      : (d = `loaded`),
    {
      ...
      displayPath: Me({ cwd: e, path: s }),
      diff: u,
      diffRenderKey: n?.type === `success` ? `${c.length}:${me(c)}` : a.revision,
      diffLoadStatus: d,
      gitPath: o,
      path: s,
      summary: a,
...
function gn(e, t) {
  return (
    e?.map((e) => {
      let n = h(e.metadata.name),
        r = Ne({ gitRoot: t, gitPath: n });
      return {
        canApplyPatchActions: !0,
        displayPath: n,
        diff: e,
        diffRenderKey: me(e.metadata.cacheKey ?? r),
...
function vn({ diffBytes: e, fileEntries: t }) {
  return e ?? t.reduce((e, t) => e + (t.diff?.changedBytes ?? 0), 0);
}
var yn = `codex-thread-find-match`,
  bn = `codex-thread-find-active`,
  xn = `data-content-search-match-id`,
  Sn = `codex-thread-find-shadow-style`,
  Cn = `
...
function Dn({ element: e, matchId: t }) {
  e.setAttribute(xn, t);
}
function On({ container: e, matchId: t, includeShadowRoots: n }) {
  let r = Hn(t);
  for (let t of Fn(e, { includeShadowRoots: n })) {
    let e = t.querySelector(`[${xn}="${r}"]`);
    if (e != null) return e;
  }
  return null;
}
function kn({ container: e, lineNumber: t, side: n, includeShadowRoots: r }) {
  let i = Hn(`${t}`),
    a = n === `additions` ? `[data-additions]` : n === `deletions` ? `[data-deletions]` : null;
  for (let t of Fn(e, { includeShadowRoots: r })) {
    if (a != null) {
      let e =
        jn({ root: t, selector: `${a}[data-line="${i}"]` }) ??
        jn({ root: t, selector: `${a} [data-line="${i}"]` }) ??
        jn({ root: t, selector: `[data-line="${i}"] ${a}` });
      if (e != null) return e;
      if (An(t)) continue;
    }
    let e = jn({ root: t, selector: `[data-line="${i}"]` });
    if (e != null) return e;
  }
  return null;
}
...
function Nn({ target: e, query: t, maxMatches: n, includeShadowRoots: r }) {
  if (n <= 0) return { matches: [], isCapped: !1 };
  let i = t.trim();
  if (i.length === 0) return { matches: [], isCapped: !1 };
  let a = [],
    o = Fn(e, { includeShadowRoots: r }),
    s = !1;
  for (let e of o) {
    let t = n - a.length;
    if (t <= 0) {
    ...
    let r = Rn({ root: e, query: i, maxMatches: t });
...
function Pn(e) {
  for (let t of e) if (!Bn(t)) return !0;
  return !1;
}
function Fn(e, t) {
  let n = [e];
  ...
  for (; r.length > 0; ) {
    ...
    for (; i != null; )
      (i instanceof HTMLElement &&
        i.shadowRoot != null &&
        (In(i.shadowRoot), n.push(i.shadowRoot), r.push(i.shadowRoot)),
        (i = t.nextNode()));
  }
  return n;
}
function In(e) {
  if (e.getElementById(Sn) != null) return;
  let t = document.createElement(`style`);
  ((t.id = Sn), (t.textContent = Cn), e.append(t));
}
function Ln(e) {
...
function Rn({ root: e, query: t, maxMatches: n }) {
  if (n <= 0) return { matches: [], isCapped: !1 };
  let r = Ln(e);
...
function Bn(e) {
  if (e.type === `characterData`) {
    ...
    return t == null ? !1 : Vn(t);
  }
  if (e.type !== `childList`) return !1;
  if (Vn(e.target)) return !0;
...
var Un = 24;
function Wn(e, t, n) {
  let r = Math.max(0, t - Un),
    i = Math.min(e.length, n + Un);
...
var Jn = 150,
  ...
  Xn = x(w, `conversation`),
  Zn = y(w, ({ get: e }) =>
    e(ce) === `right-panel` && e(se) && e(ue.activeTab$)?.tabId === `diff` ? `diff` : e(Xn),
  ),
  H = x(w, !1),
  U = x(w, `conversation`),
  W = x(w, ``),
  ...
  q = x(w, null),
  Qn = x(w, null),
  $n = y(w, ({ get: e }) => e(W).trim().length > 0),
  er = y(w, ({ get: e }) =>
    qn(
      {
        query: e(W).trim(),
        routeContextId: e(G)?.contextId ?? `unavailable`,
        stateDomain: e(U),
        result: e(G),
      },
      `conversation`,
  ...
  tr = y(w, ({ get: e }) => Kn(e(G), e(q)));
function nr(e) {
  e.set(H, !0);
}
function rr(e, t, n) {
  (e.set(Xn, t), n != null && n !== mr(e) && (Y(e), e.set(B, n), fr(e)));
}
function ir(e) {
  (Y(e), e.set(H, !1), e.set(W, ``), e.set(G, null), e.set(K, !1), e.set(q, null));
}
function ar(e, t) {
  (Y(e), e.set(U, t), e.set(G, null), e.set(K, !1), e.set(q, null));
}
function or(e, t) {
  if (t.trim().length === 0) {
    (Y(e), e.set(W, t), e.set(G, null), e.set(K, !1), e.set(q, null));
    return;
  }
  (e.set(W, t), e.set(K, !0));
}
...
function cr(e) {
  let t = e.get(G);
  t == null || t.matches.length === 0 || sr(e, (e.get(q) ?? -1) + 1);
}
function lr(e) {
  let t = e.get(G);
  t == null || t.matches.length === 0 || sr(e, (e.get(q) ?? 0) - 1);
}
function ur(e, t) {
  let n = e.get(W).trim();
  if (n.length === 0) return;
  let r = e.get(G);
  if (!(r != null && r.query === n && r.domain === e.get(U))) {
    X(e)?.runSearch({ selectFirstMatch: !0 });
    return;
  }
  if (t?.shift) {
    lr(e);
...
function dr(
  ...
  let i = 1,
    ...
    m = async ({ selectFirstMatch: n }) => {
      ...
      let c = a,
        u = e.get(U),
        f = _r({ domain: u, conversationSource: t.conversationSource, diffSource: t.diffSource }),
        p = f?.contextId ?? `unavailable`;
      e.set(K, !0);
      try {
        let t = { domain: u, contextId: p, query: r },
          o;
        if (f == null) ((o = gr(t, i)), (i += 1));
        else {
          let e = i;
        ...
        (e.set(G, o), e.set(q, h), e.set(K, !1));
      } catch {
        if (s.signal.aborted || c !== a || l) return;
        (e.set(G, null), e.set(q, null), e.set(K, !1));
      }
    },
    h = async () => {
      if (X(e) !== g) return;
  ...
  (e.set(Yn, n, g), r && e.set(V, n));
  let ee = () => {
      if ((d(), p(), mr(e) !== n)) return;
      let t = e.get(H),
        r = e.get(W).trim();
      if (!t || r.length === 0) {
        e.set(K, !1);
    ...
    _ = e.watch((e) => {
      (e.get(H), e.get(W), e.get(U), e.get(B), e.get(V), ee());
    }),
    v = e.watch((e) => {
      let t = e.get(G),
        n = e.get(q);
  ...
  return () => {
    ...
    let t = e.get(B) === n;
    (t && Y(e),
      e.get(Yn, n) === g && e.set(Yn, n, null),
      e.get(V) === n && e.set(V, null),
...
function fr(e) {
  (e.set(G, null),
    e.set(q, null),
    e.set(K, X(e) != null && e.get(H) && e.get(W).trim().length > 0));
}
function pr(e, t) {
  if (t <= 0) return 0;
  let n = e % t;
...
function Y(e) {
  e.get(G) != null && X(e)?.preserveScrollBeforeResultClear();
}
function X(e) {
  let t = mr(e);
  return t == null ? null : e.get(Yn, t);
}
function mr(e) {
  return e.get(B) ?? e.get(V);
}
...
function _r({ domain: e, conversationSource: t, diffSource: n }) {
  switch (e) {
    case `conversation`:
      return t;
    case `diff`:
...
var Z = y(w, ({ get: e }) => vr(e(J))),
  yr = y(w, ({ get: e }) => Kn(e(J), e(q))),
  Q = 20,
  br = 200,
  xr = 50,
  Sr = 600,
  ...
  Or = y(w, ({ get: e }) => e(fn) && e(Z).active && e(Dr).length > 0),
  kr = y(w, ({ get: e }) => {
    if (!e(Or)) return Q;
    let t = e(Tr),
      n = e(J),
      r = e(wr).trim().toLowerCase(),
  ...
  Mr = y(w, ({ get: e }) => {
    let t = e(Cr),
      ...
      r = e(fn),
      i = e(r ? jr : Er),
      a = n == null ? t : (Ur(i, n.position.path)?.path ?? t);
    if (!r) return a;
    if (i.length !== 0) return a != null && i.some((e) => e.path === a) ? a : i[0]?.path;
  }),
  Nr = y(w, ({ get: e }) => e(Dr).length);
function Pr(e, t) {
  (e.set($, void 0), e.set(Cr, t));
}
function Fr(e, t) {
  (Pr(e, t),
    or(e, ``),
    ...
    requestAnimationFrame(() => {
      Br(t)?.scrollIntoView({ behavior: `auto`, block: `start` });
    }));
}
function Ir(e, t) {
  (Pr(e, t.position.path), or(e, ``), Lr(e, ``));
  let n = { comment: t };
  (e.set($, n),
    requestAnimationFrame(() => {
      Vr(e, n, br);
...
function Rr(e) {
  let t = e.get(Nr),
    n = e.get(J),
    r = e.get(wr).trim().toLowerCase(),
    i = `${n?.query ?? ``}|${r}|${e.get(Z).active}`,
    a = Math.min(t, Math.max(Q, e.get(Ar).length + Q));
  e.set(Tr, (e) => (e.key === i && e.count === a ? e : { count: a, key: i }));
}
function zr(e, t) {
...
function Hr(e, t) {
  let n = Ur(e.get(z), t.position.path),
    r = n == null ? null : Br(n.path);
  if (r == null) return null;
  let i = kn({
      container: r,
