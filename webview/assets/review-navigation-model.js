...
import { _ as t, c as n, g as r, l as i, m as a, p as o, t as s } from "./app-scope.js";
import {
  $n as c,
  ar as l,
  br as u,
...
import { Sr as re, pn as ie } from "./src-2.js";
import { t as ae } from "./persisted-signal.js";
import { M as oe, a as se } from "./app-shell-state.js";
import { A as ce, F as b, I as le, M as ue, S as de } from "./rpc-2.js";
import { i as fe, t as x } from "./route-scope.js";
import { r as pe } from "./diff-view-mode.js";
import { n as me } from "./app-shell-tab-controller.js";
import { t as he } from "./store-tmKc-0Lx.js";
import { i as ge, t as _e } from "./parse-diff-BMY7-MEq.js";
import { t as ve } from "./sumBy-DDE-KTtd.js";
import { a as S, n as C, r as w } from "./thread-context-BQm-6r7t.js";
import { t as ye } from "./hash-code.js";
import { n as be, r as xe, t as Se } from "./project-context-signal.js";
function T(e) {
  return e === `staged` || e === `unstaged`;
}
var E = ae(`diff-filter`, `unstaged`);
function Ce(e, t = {}) {
...
function Ae({
  ...
  return c?.aborted
    ...
    : new Promise((u, d) => {
        ...
        m.disposeAbortListener = Me({
          abortPathRequest: () => {
            Ne({ path: o, pendingRequest: p, pathRequest: m });
          },
          signal: c,
        });
        let g = p.paths.get(o);
        (g != null && (g.disposeAbortListener(), g.reject(h())),
          p.paths.set(o, m),
          !D.has(f) &&
            (D.set(f, p),
            (p.flushTimeoutId = setTimeout(() => {
              ((p.flushTimeoutId = null), Pe(f));
            }, Ee))));
      });
}
function je(e) {
...
function Ne({ path: e, pathRequest: t, pendingRequest: n }) {
  if (
    n.paths.get(e) === t &&
    (t.disposeAbortListener(), n.paths.delete(e), t.reject(h()), !(n.paths.size > 0))
  ) {
...
function ze({ cwd: e, path: t }) {
  if (e == null || !ue(t)) return t;
  let n = b(Re.default.relative(le(``, e), t));
  return n === `` ? ce(t) : n;
}
function Be({ gitRoot: e, gitPath: t }) {
  let n = b(t);
  return e == null ? n : b(le(e, n));
}
var Ve = r(x, null);
function O(e, t) {
...
var He = e(ne(), 1),
  ...
  Ke = n(x, ({ get: e }) => e(Ge)),
  qe = t(s, (e) => null),
  Je = n(x, ({ get: e, scope: t }) => e(qe, fe(t.value))),
  Ye = 3,
  Xe = 300,
  Ze = 1e3,
  Qe = 30,
  ...
  et = r(x, !1),
  A = xe,
  tt = a(x, ({ get: e }) => u(e(Ge), e(S), e(w), `review_model`, { watchForGitInit: !0 })),
  nt = n(x, ({ get: e }) => e(tt).data?.root ?? e(Ge)),
  rt = o(s, (e) =>
    f(
      `base-branch`,
  ...
  j = n(x, ({ get: e }) => {
    let t = e(A),
      n = t.data ?? null;
    return n == null ? _(t) : e(rt, { commonDir: n.commonDir, hostConfig: e(w), root: n.root });
  }),
  it = be,
  at = a(x, ({ get: e }) => {
    let t = e(w),
  ...
  M = n(x, ({ get: e }) => At(e(j).data ?? null, e(Je))),
  ot = a(x, ({ get: e }) => {
    let t = e(w),
      n = e(S),
      r = e(A).data ?? null,
  ...
  ct = n(x, ({ get: e }) => {
    ...
    return i == null
      ? _(r)
      : e(st, { commonDir: i.commonDir, cwd: n, hostConfig: e(w), root: i.root });
  }),
  lt = o(s, (e) =>
    f(
      `review-summary`,
  ...
  N = n(x, ({ get: e }) => {
    ...
    return ft(
      s,
      c,
      !((c.isFetching && !s.isFetching) || c.isError) && c.data?.type === `success` ? c.data : l,
...
var P = n(x, ({ get: e, scope: t }) =>
    t.value.routeKind === `remote-thread` ? `cloud` : e(Se).isCodexWorktree ? `worktree` : `local`,
  ),
  gt = n(x, ({ get: e }) => e(F) && e(E) === `branch`),
  _t = n(x, ({ get: e }) => e(F) && T(e(E))),
  F = n(x, ({ get: e }) => {
    let t = e(E);
    return (
      e(C) != null && e(P) !== `cloud` && t !== `last-turn` && (t !== `commit` || e(k) != null)
    );
  }),
  vt = n(x, ({ get: e }) => {
    let t = e(E);
...
async function Tt(e, t) {
  ...
  try {
    ...
    await Promise.all([g(e.queryClient, t.commonDir, { hostKey: e.get(S) }), It(e)]);
  } finally {
    e.set(et, !1);
  }
}
...
function Dt({ cwd: e, gitRoot: t, paths: n }) {
  ...
  return [
    ...new Set(
      n.flatMap((t) => {
        if (t === ``) return [];
        let n = Re.default.relative(r, le(e, t));
...
async function kt(e, t) {
  await Promise.all([l(e.queryClient, t, { hostKey: e.get(S) }), It(e)]);
}
...
var en = n(x, ({ get: e }) =>
    e(P) === `cloud` || e(E) === `last-turn`
      ? e(xt)
      : { diff: null, diffText: null, diffBytes: null, diffError: null },
  ),
  tn = n(x, ({ get: e }) => (e(P) === `cloud` || e(E) === `last-turn` ? (e(Ke) ?? e(C)) : e(C))),
  nn = n(x, ({ get: e }) => {
    if (e(P) === `cloud` || e(E) === `last-turn`)
  ...
  an = n(x, ({ get: e }) => e(E) !== `branch` && (e(rn).metrics?.fileCount ?? 0) > 0),
  on = n(x, ({ get: e }) => {
    if (e(P) !== `cloud` && e(E) === `branch`) {
      let t = e(rn);
  ...
  sn = n(x, ({ get: e }) => {
    if (e(P) === `cloud` || !T(e(E))) return { stagedFileCount: void 0, unstagedFileCount: void 0 };
    let t = e(N).data;
  ...
  fn = n(x, ({ get: e }) => e(A).data?.commonDir != null && !e(et)),
  pn = n(x, ({ get: e, scope: t }) => {
    let n = e(I);
    return t.value.routeKind !== `remote-thread` && n.isPendingGitChanges && !e(cn);
  }),
  mn = n(x, ({ get: e }) => e(I).diffError?.type === `diff-too-large`);
...
var gn = n(x, ({ get: e }) => {
  ...
  L = n(x, ({ get: e }) => {
    if (e(F)) return Sn({ cwd: e(C), gitRoot: e(A).data?.root ?? null, reviewSummary: e(N).data });
    let t = e(P) === `cloud` || e(E) === `last-turn` ? e(nt) : (e(A).data?.root ?? null);
  ...
  _n = i(x, (e, { get: t }) => {
    ...
    let n = b(ee(e, t(C) ?? void 0));
    return t(L).find((t) => t.path === e || t.gitPath === n) ?? null;
  }),
  vn = n(x, ({ get: e }) => En(e(L))),
  yn = n(x, ({ get: e }) => Dn({ diffBytes: e(I).diffBytes, fileEntries: e(L) })),
  bn = n(x, ({ get: e }) =>
...
function wn({
  ...
  return (
      ...
      : (f = `loaded`),
    {
      ...
      diff: d,
      diffRenderKey: n?.type === `success` ? `${l.length}:${ye(l)}` : o.revision,
...
function Tn(e, t) {
  return Cn(
    e?.map((e) => {
      let n = b(e.metadata.name),
        r = Be({ gitRoot: t, gitPath: n });
      return {
        canApplyPatchActions: !0,
        displayPath: n,
        diff: e,
        diffRenderKey: ye(e.metadata.cacheKey ?? r),
        diffRevision: null,
...
function Hn({ target: e, query: t, maxMatches: n, includeShadowRoots: r }) {
  ...
  for (let e of o) {
    ...
    let r = Kn({ root: e, query: i, maxMatches: t });
...
function Un(e) {
  for (let t of e) if (!Jn(t)) return !0;
  return !1;
}
function R(e, t) {
  let n = [e];
  ...
  for (; r.length > 0; ) {
    ...
    for (; i != null; )
      (i instanceof HTMLElement &&
        i.shadowRoot != null &&
        (Wn(i.shadowRoot), n.push(i.shadowRoot), r.push(i.shadowRoot)),
        (i = t.nextNode()));
  }
  return n;
}
...
function Kn({ root: e, query: t, maxMatches: n }) {
  if (n <= 0) return { matches: [], isCapped: !1 };
  let r = Gn(e);
...
function Jn(e) {
  if (e.type === `characterData`) {
    ...
    return t == null ? !1 : Yn(t);
  }
  if (e.type !== `childList`) return !1;
  if (Yn(e.target)) return !0;
...
var Zn = 24;
function Qn(e, t, n) {
  let r = Math.max(0, t - Zn),
    i = Math.min(e.length, n + Zn);
...
var nr = 150,
  rr = { activeMatchOrdinal: 0, matches: 0, query: `` },
  ir = [`conversation`, `diff`],
  ar = t(x, (e) => null),
  z = r(x, null),
  B = r(x, null),
  or = r(x, `conversation`),
  sr = n(x, ({ get: e }) =>
    e(oe) === `right-panel` && e(se) && e(me.activeTab$)?.tabId === `diff` ? `diff` : e(or),
  ),
  V = r(x, !1),
  H = r(x, `conversation`),
  U = r(x, ``),
  ...
  ur = r(x, rr),
  dr = r(x, null),
  fr = n(x, ({ get: e }) => e(U).trim().length > 0),
  pr = n(x, ({ get: e }) =>
    tr(
      {
        query: e(U).trim(),
  ...
  mr = n(x, ({ get: e }) => er(e(W), e(K)));
function hr(e) {
  e.set(V, !0);
}
function gr(e, t, n) {
  (e.set(or, t), n != null && n !== Pr(e) && (J(e), e.set(z, n), Mr(e)));
}
function _r(e) {
...
function yr(e, t) {
  ...
  (n?.conversationId === t?.conversationId && n?.browserTabId === t?.browserTabId) ||
    (e.set(lr, t), e.set(ur, rr), t == null && e.get(H) === `browser` && vr(e, `conversation`));
}
function br(e, t) {
  (J(e),
    e.set(U, t),
    ...
    e.set(G, !1),
    e.set(K, null),
    e.set(ur, { activeMatchOrdinal: 0, matches: 0, query: t }));
}
function xr(e, t) {
  e.set(dr, t);
}
...
function Cr(e, t) {
  (e.set(ur, t), e.get(H) === `browser` && (e.set(U, t.query), e.set(G, !1)));
}
function wr({ hasBrowserTarget: e }) {
  return e ? [...ir, `browser`] : [...ir];
}
function Tr({ currentDomain: e, hasBrowserTarget: t }) {
  let n = wr({ hasBrowserTarget: t });
...
function Or(e) {
  let t = e.get(W);
  t == null || t.matches.length === 0 || Dr(e, (e.get(K) ?? -1) + 1);
}
function kr(e) {
  let t = e.get(W);
  t == null || t.matches.length === 0 || Dr(e, (e.get(K) ?? 0) - 1);
}
function Ar(e, t) {
  let n = e.get(U).trim();
...
function jr(
  ...
  let i = 1,
    ...
    m = async ({ selectFirstMatch: n }) => {
      ...
      let c = a,
        u = e.get(H),
        f = Lr({ domain: u, conversationSource: t.conversationSource, diffSource: t.diffSource }),
        p = f?.contextId ?? `unavailable`;
      e.set(G, !0);
      try {
        let t = { domain: u, contextId: p, query: r },
          o;
        if (f == null) ((o = Ir(t, i)), (i += 1));
        else {
          let e = i;
  ...
  (e.set(ar, n, g), r && e.set(B, n));
  let _ = () => {
      if ((d(), p(), Pr(e) !== n)) return;
      let t = e.get(V),
        r = e.get(U).trim();
      if (!t || r.length === 0 || e.get(H) === `browser`) {
        e.set(G, !1);
        return;
      }
      c = window.setTimeout(() => {
...
function Lr({ domain: e, conversationSource: t, diffSource: n }) {
  switch (e) {
    case `conversation`:
      return t;
    case `diff`:
...
var X = n(x, ({ get: e }) => Rr(e(q))),
  zr = n(x, ({ get: e }) => er(e(q), e(K))),
  Z = 20,
  Br = 200,
  Vr = 50,
  Hr = 600,
  ...
  qr = n(x, ({ get: e }) => e(bn) && e(X).active && e(Kr).length > 0),
  Jr = n(x, ({ get: e }) => {
    if (!e(qr)) return Z;
    let t = e(Wr),
      n = e(q),
  ...
  Zr = n(x, ({ get: e }) => {
    let t = e(Ur),
      ...
      r = e(bn),
      i = e(r ? Xr : Gr),
      a = n == null ? t : (ci(i, n.position.path)?.path ?? t);
    if (!r) return a;
    if (i.length !== 0) return a != null && i.some((e) => e.path === a) ? a : i[0]?.path;
  }),
  Qr = n(x, ({ get: e }) => e(Kr).length);
function $r(e, t) {
  (e.set(Q, void 0), e.set(Ur, t));
}
function ei(e, t) {
  ($r(e, t),
    Er(e, ``),
    ...
    requestAnimationFrame(() => {
      ai(t)?.scrollIntoView({ behavior: `auto`, block: `start` });
    }));
}
function ti(e, t) {
  ($r(e, t.position.path), Er(e, ``), ni(e, ``));
  let n = { comment: t };
  (e.set(Q, n),
    requestAnimationFrame(() => {
      oi(e, n, Br);
...
function ri(e) {
  let t = e.get(Qr),
    ...
    a = Math.min(t, Math.max(Z, e.get(Yr).length + Z));
...
function ai(e) {
  for (let t of document.querySelectorAll(de.reviewFile))
    if (t.getAttribute(`data-review-path`) === e) return t;
  return null;
}
function oi(e, t, n) {
  if (e.get(Q) !== t) return;
  let r = si(e, t.comment);
  if (r == null) {
    if (n > 1) {
      window.setTimeout(() => {
        oi(e, t, n - 1);
...
function si(e, t) {
  let n = ci(e.get(L), t.position.path),
