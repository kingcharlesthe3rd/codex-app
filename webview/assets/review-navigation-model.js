...
import { t as he } from "./sumBy.js";
import { a as w, i as ge, n as T, r as E, t as _e } from "./thread-context.js";
...
function Me({ path: e, pathRequest: t, pendingRequest: n }) {
  if (
    n.paths.get(e) === t &&
    (t.disposeAbortListener(), n.paths.delete(e), t.reject(re()), !(n.paths.size > 0))
  ) {
...
function Ie({ baseBranch: e, commitSha: t, cwd: n, hideWhitespace: r, source: a }) {
  return {
    cwd: i(n),
    ...(r ? { hideWhitespace: r } : {}),
    source: a,
...
var ze = e(r(), 1),
  ...
  Qe = x(S, !1),
  N = Se,
  $e = ce(S, ({ get: e }) => a(e(Ue), e(w), e(E), `review_model`, { watchForGitInit: !0 })),
  ...
  P = v(S, ({ get: e }) => {
    let t = e(N),
      n = t.data ?? null;
    return n == null ? u(t) : e(tt, { commonDir: n.commonDir, hostConfig: e(E), root: n.root });
  }),
  nt = Ce,
  rt = ce(S, ({ get: e }) => {
    let t = e(E),
    ...
    return p(
      `recent-branches`,
      r,
      r == null ? null : { limit: Xe, operationSource: `review_model`, root: r.root },
      n,
      t,
    );
  }),
  ...
  st = oe(y, (e) =>
    p(
      ...
      h(e.hostConfig),
      e.hostConfig,
      { enabled: e.enabled, refetchOnWindowFocus: `always`, staleTime: b.FIVE_SECONDS },
    ),
  ),
  ct = oe(y, (e) =>
    p(
...
var L = v(S, ({ get: e, scope: t }) =>
  ...
  R = v(S, ({ get: e }) => {
    let t = e(O);
    return (
      e(T) != null && e(L) !== `cloud` && t !== `last-turn` && (t !== `commit` || e(M) != null)
    );
  }),
  z = v(S, ({ get: e }) => {
    let t = e(O);
...
function ht({ cwd: e, hideWhitespace: t, source: n, baseBranch: r, commitSha: a }) {
  return {
    cwd: i(e),
    ...(t ? { hideWhitespace: t } : {}),
    operationSource: `review_model`,
...
var gt = oe(S, (e, { get: t }) => {
    ...
    return {
      ...
      enabled: t(R) && n != null && r?.type === `success` && i != null && a != null,
...
async function St(e, t) {
  ...
  try {
    try {
      await ie({ cwd: e.get(T), hostConfig: e.get(E), operationSource: `review_model` });
    } catch {}
...
async function Ct(e, t, { source: n = e.get(z) } = {}) {
      ...
      return [
        [
          ...f({
            ...
            method: `review-diff`,
            params: {
              ...ht({ cwd: a, hideWhitespace: u, source: n, baseBranch: o, commitSha: s }),
              files: [
                {
                  path: t,
                  changeKind: e.changeKind,
                  ...(e.previousPath == null ? {} : { previousPath: e.previousPath }),
                },
              ],
            },
            hostKey: l,
  ...
  if (g !== Tt(e)) return;
  let ae = Promise.all(re.map((t) => e.queryClient.invalidateQueries({ exact: !0, queryKey: t }))),
...
function Dt(e, t, n) {
  if (e?.type !== `success` || t.type !== `success` || e.source !== t.source) return e;
  let r = new Set(n),
    i = new Map(t.files.map((e) => [e.path, e])),
    a = new Map(t.files.flatMap((e) => (e.previousPath == null ? [] : [[e.previousPath, e]]))),
    o = e.files.flatMap((e) => {
      ...
      return !r.has(e.path) && t == null
        ...
        : t == null
          ? []
          : (i.delete(t.path), t.previousPath != null && a.delete(t.previousPath), [t]);
    });
  o.push(...i.values());
  let s =
    `stageCounts` in t
      ...
      : e.source === `unstaged`
        ? {
            ...
            unstagedFileCount: o.filter((e) => e.changeKind !== `untracked`).length,
            untrackedFileCount: o.filter((e) => e.changeKind === `untracked`).length,
          }
        : e.stageCounts;
...
function zt(e) {
  return e == null || e.trim() === ``
    ...
    : { diff: pe(e), diffText: e, diffBytes: new TextEncoder().encode(e).length, diffError: null };
}
function Bt(e, t) {
...
function Ht(e, t) {
  return e.length > 0 && e.length === t.length && (0, ze.default)(e.slice(0, -1), t.slice(0, -1));
}
var Ut = e(he(), 1);
function Wt() {
...
function Zt({ reviewSummary: e, selectedDiff: t, shouldFetchReviewSummary: n }) {
...
function tn({ reviewSummary: e, selectedDiff: t, shouldFetchReviewSummary: n }) {
...
var nn = v(S, ({ get: e }) =>
  ...
  rn = v(S, ({ get: e }) => (e(L) === `cloud` || e(O) === `last-turn` ? (e(We) ?? e(T)) : e(T))),
  an = v(S, ({ get: e }) => {
    if (e(L) === `cloud` || e(O) === `last-turn`)
      return { isFetchingGitChanges: !1, isPendingGitChanges: !1 };
    let t = e(I);
    return { isFetchingGitChanges: t.isFetching, isPendingGitChanges: e(R) && t.isPending };
  }),
  V = v(S, ({ get: e }) => {
    let t = e(O),
      n = e(an),
  ...
  sn = v(S, ({ get: e }) => e(O) !== `branch` && (e(on).metrics?.fileCount ?? 0) > 0),
  cn = v(S, ({ get: e }) => {
  ...
  ln = v(S, ({ get: e }) => {
    if (e(L) === `cloud` || !D(e(O))) return { stagedFileCount: void 0, unstagedFileCount: void 0 };
    let t = e(I).data;
  ...
  un = v(S, ({ get: e }) =>
    tn({ reviewSummary: e(I).data, selectedDiff: e(V), shouldFetchReviewSummary: e(R) }),
  ),
  dn = v(S, ({ get: e }) => {
    let t = e(N);
  ...
  pn = v(S, ({ get: e }) => {
    ...
    if (e(R)) {
      let n = e(I).data;
      return n?.type === `success` && n.files.length > 0 && !(e(fn) && t.hasOptimisticDiffs);
    }
    return t.diffText != null && t.diffText.trim().length > 0 && !(e(fn) && t.hasOptimisticDiffs);
  }),
  mn = v(S, ({ get: e }) => e(N).data?.commonDir != null && !e(Qe)),
  hn = v(S, ({ get: e, scope: t }) => {
    let n = e(V);
    return t.value.routeKind !== `remote-thread` && n.isPendingGitChanges && !e(un);
  }),
  gn = v(S, ({ get: e }) => e(V).diffError?.type === `diff-too-large`);
function _n({ reviewSummaryFetching: e, reviewSummaryUpdatedAt: t, shouldFetchReviewSummary: n }) {
  return !n || e ? !1 : t !== 0;
}
var vn = v(S, ({ get: e }) => {
    let t = e(R),
  ...
  H = v(S, ({ get: e }) => {
    if (e(R)) return Cn({ cwd: e(T), gitRoot: e(N).data?.root ?? null, reviewSummary: e(I).data });
    let t = e(L) === `cloud` || e(O) === `last-turn` ? e(et) : (e(N).data?.root ?? null);
  ...
  bn = v(S, ({ get: e }) => En(e(H))),
  xn = v(S, ({ get: e }) => Dn({ diffBytes: e(V).diffBytes, fileEntries: e(H) })),
  U = v(S, ({ get: e }) =>
    me({ fileCount: e(H).length, totalChangedBytes: e(xn), totalChangedLines: e(bn) }),
  ),
  Sn = v(S, ({ get: e }) => {
    let t = e(H);
...
function Cn({ cwd: e, gitRoot: t, reviewSummary: n }) {
  return n?.type === `success`
    ? n.files.map((n) => wn({ cwd: e, gitRoot: t, reviewDiffIsFetching: !0, reviewFile: n }))
    : [];
}
function wn({
  cwd: e,
  ...
  return (
      ...
      : (d = `loaded`),
    {
      ...
      diff: u,
      diffRenderKey: n?.type === `success` ? `${c.length}:${ve(c)}` : a.revision,
      diffLoadStatus: d,
      gitPath: o,
      path: s,
      summary: a,
...
var Nn = 150,
  ...
  Pn = x(S, `conversation`),
  Fn = v(S, ({ get: e }) =>
    e(ue) === `right-panel` && e(de) && e(fe.activeTab$)?.tabId === `diff` ? `diff` : e(Pn),
  ),
  G = x(S, !1),
  K = x(S, `conversation`),
  q = x(S, ``),
...
function Hn(e) {
  (Zn(e), e.set(G, !1), e.set(q, ``), e.set(J, null), e.set(Y, !1), e.set(X, null));
}
function Un(e, t) {
...
function Yn(e, t = { conversationSource: null, diffSource: null }) {
  let n = 1,
    ...
    f = async ({ selectFirstMatch: a }) => {
      ...
      let u = r,
        d = e.get(K),
        f = er({ domain: d, conversationSource: t.conversationSource, diffSource: t.diffSource }),
  ...
  return () => {
    ((s = !0), e.get(W) === m && e.set(W, null), g(), _(), l(), i?.abort(), u());
  };
}
function Xn(e, t) {
  if (t <= 0) return 0;
