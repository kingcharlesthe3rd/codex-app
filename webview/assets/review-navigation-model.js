...
import { Mt as l, jt as u } from "./use-host-config-C.js";
import {
  Gi as d,
  Gn as f,
  In as p,
...
import { u as v } from "./vscode-api.js";
import { t as ie } from "./isEqual.js";
import { Rr as ae, _n as oe } from "./src-1.js";
import { M as se, a as ce } from "./app-shell-state.js";
import { A as le, I as y, L as ue, M as de, T as fe } from "./rpc-1.js";
import { f as b, h as pe, t as me } from "./persisted-signal.js";
import { r as x } from "./diff-view-mode.js";
import { r as he } from "./app-shell-tab-controller.js";
import { t as ge } from "./store.js";
import { i as _e, t as ve } from "./parse-diff.js";
import { t as ye } from "./sumBy.js";
import { a as S, n as C, r as w } from "./thread-context.js";
import { n as be, r as xe, t as Se } from "./project-context-signal.js";
function T(e) {
  return e === `staged` || e === `unstaged`;
}
var E = me(`diff-filter`, `unstaged`);
function Ce(e, t = {}) {
  return ge.prepareInput(e, t);
}
var we = `⁣`;
function Te(e) {
  let t = new Set();
  ...
  return e.map((e) => {
    ...
    let r = `${e.displayPath}${we}`;
    for (; n.has(r) || t.has(r); ) r = `${r}${we}`;
...
function Ae({
  ...
  return c?.aborted
    ...
    : new Promise((u, f) => {
        ...
        h.disposeAbortListener = Me({
          abortPathRequest: () => {
            Ne({ path: o, pendingRequest: m, pathRequest: h });
          },
          signal: c,
        });
        let g = m.paths.get(o);
...
function Me({ abortPathRequest: e, signal: t }) {
  return t == null
    ? () => {}
...
function Ne({ path: e, pathRequest: t, pendingRequest: n }) {
  if (
    n.paths.get(e) === t &&
    ...
    (n.flushTimeoutId != null && (clearTimeout(n.flushTimeoutId), (n.flushTimeoutId = null)),
      D.delete(n.requestKey));
  }
}
async function Pe(e) {
  let t = D.get(e);
  if (t == null || (D.delete(e), t.paths.size === 0)) return;
  let n = new Set();
    ...
    await Promise.allSettled(
      e.map(async (e) => {
        ...
        try {
          ...
          Ie({ error: n instanceof Error ? n : Error(String(n)), files: e, pendingRequest: t });
        } finally {
...
function Fe({ diffs: e, files: t, hideWhitespace: n, pendingRequest: r }) {
  for (let i of t) {
...
function Ie({ error: e, files: t, pendingRequest: n }) {
  for (let r of t) n.paths.get(r.path)?.reject(e);
}
function Le({ baseBranch: e, commitSha: t, cwd: n, hideWhitespace: r, source: i }) {
  return {
    cwd: oe(n),
    ...(r ? { hideWhitespace: r } : {}),
    source: i,
...
var Re = e(ae(), 1);
function ze({ cwd: e, path: t }) {
  if (e == null || !de(t)) return t;
  let n = y(Re.default.relative(ue(``, e), t));
  return n === `` ? le(t) : n;
}
function Be({ gitRoot: e, gitPath: t }) {
  let n = y(t);
  return e == null ? n : y(ue(e, n));
}
var Ve = i(b, null);
function He(e, t) {
  (e.set(Ve, null), e.set(E, t));
}
var Ue = e(ie(), 1),
  We = new WeakMap(),
  Ge = i(b, null),
  ...
  qe = r(b, ({ get: e }) => e(Ke)),
  Je = n(c, (e) => null),
  Ye = r(b, ({ get: e, scope: t }) => e(Je, pe(t.value))),
  Xe = 3,
  Ze = 300,
  Qe = 1e3,
  $e = 30,
  et = Error(`Review summary failed`),
  tt = i(b, !1),
  k = xe,
  nt = o(b, ({ get: e }) => ee(e(Ke), e(S), e(w), `review_model`, { watchForGitInit: !0 })),
  rt = r(b, ({ get: e }) => e(nt).data?.root ?? e(Ke)),
  it = s(c, (e) =>
    h(
      `base-branch`,
  ...
  A = r(b, ({ get: e }) => {
    let t = e(k),
      n = t.data ?? null;
    return n == null ? f(t) : e(it, { commonDir: n.commonDir, hostConfig: e(w), root: n.root });
  }),
  at = be,
  ot = o(b, ({ get: e }) => {
    let t = e(w),
    ...
    return h(
      `recent-branches`,
      r,
      r == null ? null : { limit: $e, operationSource: `review_model`, root: r.root },
      n,
      t,
    );
  }),
  j = r(b, ({ get: e }) => jt(e(A).data ?? null, e(Ye))),
  st = o(b, ({ get: e }) => {
    let t = e(w),
      n = e(S),
      r = e(k).data ?? null,
  ...
  ct = s(c, (e) =>
    h(
      `index-info`,
      { commonDir: e.commonDir, root: e.root },
      { cwd: oe(e.cwd), operationSource: `review_model` },
      _(e.hostConfig),
      e.hostConfig,
      { refetchOnWindowFocus: `always`, staleTime: v.FIVE_SECONDS },
    ),
  ),
  lt = r(b, ({ get: e }) => {
    let t = e(vt),
      n = e(C);
    if (!t || n == null) return te();
    let r = e(k),
      i = r.data ?? null;
    return i == null
      ? f(r)
      : e(ct, { commonDir: i.commonDir, cwd: n, hostConfig: e(w), root: i.root });
  }),
  ut = s(c, (e) =>
    h(
      `review-summary`,
  ...
  dt = s(c, (e) =>
    h(
      ...
      _(e.hostConfig),
      e.hostConfig,
      { enabled: e.enabled, staleTime: v.FIVE_SECONDS },
    ),
  ),
  ft = r(b, ({ get: e }) => {
    let t = e(k),
    ...
    if (n == null) return f(t);
    if (r == null || e(N) === `cloud`) return te();
    let o = {
        baseBranch: e(j),
      ...
      s = e(dt, { ...o, includeUntrackedFiles: !1 }),
      c = e(dt, o),
  ...
  M = r(b, ({ get: e }) => {
    ...
    if (o == null) return n == null ? f(t) : te();
    if (r !== `branch` && r !== `unstaged`) return e(ut, o);
    let s = e(ut, { ...o, includeUntrackedFiles: !1 }),
      c = e(ut, o),
      l =
...
var mt = r(b, ({ get: e }) => {
  ...
  let n = e(k).data?.root ?? null,
    r = new Map();
  for (let e of t.files) {
    let t = Be({ gitRoot: n, gitPath: e.path });
    r.has(t) || r.set(t, e);
  }
  return r;
});
function ht(e, t = e.get(yt)) {
  let n = e.get(A),
    ...
    i = gt({
      ...
      cwd: e.get(C),
      enabled: e.get(P) && !r,
      hideWhitespace: e.get(x),
      hostConfig: e.get(w),
      metadata: e.get(k).data ?? null,
      source: t,
    });
...
var N = r(b, ({ get: e, scope: t }) =>
    t.value.routeKind === `remote-thread` ? `cloud` : e(Se).isCodexWorktree ? `worktree` : `local`,
  ),
  _t = r(b, ({ get: e }) => e(P) && e(E) === `branch`),
  vt = r(b, ({ get: e }) => e(P) && T(e(E))),
  P = r(b, ({ get: e }) => {
    let t = e(E);
    return (
      e(C) != null && e(N) !== `cloud` && t !== `last-turn` && (t !== `commit` || e(O) != null)
    );
  }),
  yt = r(b, ({ get: e }) => {
    let t = e(E);
    return t === `last-turn` || (t === `commit` && e(O) == null) ? null : t;
  });
function bt({ cwd: e, hideWhitespace: t, source: n, baseBranch: r, commitSha: i }) {
  return {
    cwd: oe(e),
    ...(t ? { hideWhitespace: t } : {}),
    operationSource: `review_model`,
...
var xt = s(b, (e, { get: t }) => {
    ...
    return {
      ...
      enabled: t(P) && n != null && r?.type === `success` && i != null && a != null,
      refetchOnWindowFocus: `always`,
      retry: zt,
      retryDelay: Bt,
      staleTime: v.FIVE_SECONDS,
      placeholderData: (e, t) => {
        if (!(t == null || !Vt(d, t.queryKey))) return e;
      },
    };
  }),
  St = r(b, ({ get: e }) => Rt(e(Ge)));
async function Ct(e) {
  let t = e.get(k).data;
  if (e.get(P) && t != null) {
    try {
...
async function wt(e, t) {
  await e.get(xt, t).refetch();
}
async function Tt(e, { queueIfRefreshing: n = !1 } = {}) {
  let r = e.get(k).data,
    i = We.get(e);
  if (r == null) return;
  if (i != null) {
...
async function Et(e, t) {
  ...
  try {
    ...
    await Promise.all([g(e.queryClient, t.commonDir, { hostKey: e.get(S) }), Lt(e)]);
  } finally {
    e.set(tt, !1);
  }
}
async function Dt(e, t) {
  let n = e.get(k).data,
    r = e.get(C),
    i = Ot({ cwd: r, gitRoot: n?.root ?? null, paths: t });
  if (!(!e.get(P) || n == null || r == null || i.length === 0)) {
    try {
      await p({
...
function Ot({ cwd: e, gitRoot: t, paths: n }) {
  ...
  return [
    ...new Set(
      n.flatMap((t) => {
        if (t === ``) return [];
        let n = Re.default.relative(r, ue(e, t));
...
async function At(e, t) {
  await Promise.all([m(e.queryClient, t, { hostKey: e.get(S) }), Lt(e)]);
}
function jt(e, t = null) {
  return t ?? kt(e);
}
async function Mt(e) {
  e.get(vt) && (await e.get(lt).refetch());
}
function Nt(e, t, n) {
  (e.set(Ge, t), e.set(Ke, n));
}
function Pt(e, t, n) {
  e.set(Je, t, n);
}
function Ft(e, t) {
  (e.set(O, t), He(e, `commit`));
}
function It(e) {
  return e.watch((t) => {
    if (t.get(E) === `commit`) {
      ...
      if (!(n == null || n.some((t) => t.sha === e))) {
        (t.set(O, null), He(t, `branch`));
        return;
      }
    }
    let n = t.get(yt);
    (n === `branch` && t.get(j),
      t.get(k).data != null && (t.get(Ge) != null || (t.get(P) && n != null)) && Ct(e));
  });
}
async function Lt(e) {
  let t = ht(e);
...
function Rt(e) {
  return e == null || e.trim() === ``
    ...
    : { diff: ve(e), diffText: e, diffBytes: new TextEncoder().encode(e).length, diffError: null };
}
function zt(e, t) {
  return t.name !== `AbortError` && e < Xe;
}
function Bt(e) {
  return Math.min(Ze * 2 ** e, 2e3);
}
function Vt(e, t) {
  return e.length > 0 && e.length === t.length && (0, Ue.default)(e.slice(0, -1), t.slice(0, -1));
}
var Ht = e(ye(), 1);
function Ut() {
...
function Wt() {
  return { staged: Ut(), unstaged: Ut(), version: 0 };
}
function Gt(e) {
  return new Set([
...
var Kt = i(b, Wt()),
  qt = r(b, ({ get: e }) => Gt(e(Kt)));
function Jt(e) {
  e.set(Kt, Wt());
}
async function Yt(e, t) {
  let n = e.get(C);
  if (e.get(N) === `cloud` || n == null) return;
...
function Xt({ reviewSummary: e, selectedDiff: t, shouldFetchReviewSummary: n }) {
  if (n && e?.type === `success`) return Zt(e);
  let r = t.diff ?? [];
  return $t(
    (0, Ht.default)(r, (e) => e.additions),
    (0, Ht.default)(r, (e) => e.deletions),
    r.length,
    t.diffText?.length ?? 0,
  );
}
function Zt(e) {
  return $t(
    (0, Ht.default)(e.files, (e) => e.additions ?? 0),
    (0, Ht.default)(e.files, (e) => e.deletions ?? 0),
    e.files.length,
  );
}
function Qt(e) {
  return e == null ? null : $t(e.additions, e.deletions, e.fileCount);
}
function $t(e, t, n, r = 0) {
  return { additions: e, bytesEstimate: r, deletions: t, fileCount: n, lineCount: e + t };
}
function en({ reviewSummary: e, selectedDiff: t, shouldFetchReviewSummary: n }) {
  return n ? e?.type === `success` && e.files.length > 0 : (t.diff?.length ?? 0) > 0;
}
var tn = r(b, ({ get: e }) =>
    e(N) === `cloud` || e(E) === `last-turn`
      ? e(St)
      : { diff: null, diffText: null, diffBytes: null, diffError: null },
  ),
  nn = r(b, ({ get: e }) => (e(N) === `cloud` || e(E) === `last-turn` ? (e(qe) ?? e(C)) : e(C))),
  rn = r(b, ({ get: e }) => {
    if (e(N) === `cloud` || e(E) === `last-turn`)
      return { isFetchingGitChanges: !1, isPendingGitChanges: !1 };
    let t = e(M);
    return { isFetchingGitChanges: t.isFetching, isPendingGitChanges: e(P) && t.isPending };
  }),
  F = r(b, ({ get: e }) => {
    let t = e(E),
      n = e(rn),
  ...
  an = r(b, ({ get: e }) => {
    if (e(N) === `cloud`) return { isLoading: !1, metrics: null };
    if (e(E) === `branch`) {
      let t = e(M),
        n = t.data;
      if (n?.type === `success`) return { isLoading: !1, metrics: Zt(n) };
      if (e(P) && !t.isError && (t.isFetching || t.isPending))
  ...
  on = r(b, ({ get: e }) => e(E) !== `branch` && (e(an).metrics?.fileCount ?? 0) > 0),
  sn = r(b, ({ get: e }) => {
    if (e(N) !== `cloud` && e(E) === `branch`) {
      let t = e(an);
      if (t.metrics != null) return t.metrics;
    }
    let t = e(P);
    return Xt({
      reviewSummary: e(M).data,
      selectedDiff: t ? { diff: null, diffText: null } : e(F),
      shouldFetchReviewSummary: t,
    });
  }),
  cn = r(b, ({ get: e }) => {
    if (e(N) === `cloud` || !T(e(E))) return { stagedFileCount: void 0, unstagedFileCount: void 0 };
    let t = e(M).data;
  ...
  ln = r(b, ({ get: e }) =>
    en({ reviewSummary: e(M).data, selectedDiff: e(F), shouldFetchReviewSummary: e(P) }),
  ),
  un = r(b, ({ get: e }) => {
    let t = e(k);
    return e(N) !== `cloud` && !t.isLoading && t.data?.root == null;
  }),
  dn = r(b, ({ get: e, scope: t }) => {
    let n = e(E),
      r = e(k);
    return (
  ...
  fn = r(b, ({ get: e }) => {
    ...
    if (e(P)) {
      let n = e(M).data;
      return n?.type === `success` && n.files.length > 0 && !(e(dn) && t.hasOptimisticDiffs);
    }
    return t.diffText != null && t.diffText.trim().length > 0 && !(e(dn) && t.hasOptimisticDiffs);
  }),
  pn = r(b, ({ get: e }) => e(k).data?.commonDir != null && !e(tt)),
  mn = r(b, ({ get: e, scope: t }) => {
    let n = e(F);
    return t.value.routeKind !== `remote-thread` && n.isPendingGitChanges && !e(ln);
  }),
  hn = r(b, ({ get: e }) => e(F).diffError?.type === `diff-too-large`);
function gn({ reviewSummaryFetching: e, reviewSummaryUpdatedAt: t, shouldFetchReviewSummary: n }) {
  return !n || e ? !1 : t !== 0;
}
var _n = r(b, ({ get: e }) => {
    let t = e(P),
  ...
  I = r(b, ({ get: e }) => {
    if (e(P)) return Sn({ cwd: e(C), gitRoot: e(k).data?.root ?? null, reviewSummary: e(M).data });
    let t = e(N) === `cloud` || e(E) === `last-turn` ? e(rt) : (e(k).data?.root ?? null);
    return Tn(e(F).diff, t);
  }),
  vn = a(b, (e, { get: t }) => {
    if (t(P)) {
      let n = t(k).data?.root ?? null,
        r = t(mt)?.get(e) ?? null;
    ...
    let n = y(u(e, t(C) ?? void 0));
    return t(I).find((t) => t.path === e || t.gitPath === n) ?? null;
  }),
  yn = r(b, ({ get: e }) => En(e(I))),
  bn = r(b, ({ get: e }) => Dn({ diffBytes: e(F).diffBytes, fileEntries: e(I) })),
  L = r(b, ({ get: e }) =>
    _e({ fileCount: e(I).length, totalChangedBytes: e(bn), totalChangedLines: e(yn) }),
  ),
  xn = r(b, ({ get: e }) => {
    let t = e(I);
    return !e(P) || e(L) ? t : t.map((t) => e(vn, t.path) ?? t);
  });
...
function wn({
  ...
  let s = y(o.path),
    c = Be({ gitRoot: t, gitPath: s }),
    l = n?.type === `success` ? n.diff : ``,
    u = l.trim().length > 0,
    d = u ? (ve(l)[0] ?? null) : null,
    f = `loading`;
  return (
    d == null
      ? n?.type === `success`
...
var rr = 150,
  ...
  sr = i(b, `conversation`),
  cr = r(b, ({ get: e }) =>
    e(se) === `right-panel` && e(ce) && e(he.activeTab$)?.tabId === `diff` ? `diff` : e(sr),
  ),
  B = i(b, !1),
  V = i(b, `conversation`),
  H = i(b, ``),
  ...
  dr = i(b, ir),
  fr = i(b, null),
  pr = r(b, ({ get: e }) => e(H).trim().length > 0),
  mr = r(b, ({ get: e }) =>
    nr(
      {
        query: e(H).trim(),
...
var Y = r(b, ({ get: e }) => zr(e(K))),
  Br = r(b, ({ get: e }) => tr(e(K), e(G))),
  X = 20,
  Vr = 200,
  Hr = 50,
  Ur = 600,
  ...
  qr = r(b, ({ get: e }) => e(L) && e(Y).active && e(Kr).length > 0),
  Jr = r(b, ({ get: e }) => {
    if (!e(qr)) return X;
    let t = e(Wr),
      n = e(K),
...
function ai(e) {
  for (let t of document.querySelectorAll(fe.reviewFile))
...
function ci(e, t) {
  let n = li(e.get(I), t.position.path),
