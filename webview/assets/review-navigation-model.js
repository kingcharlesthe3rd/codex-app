...
import { u as y } from "./vscode-api.js";
import { t as ne } from "./isEqual.js";
import { fr as re, mn as b } from "./src-1.js";
import { t as ie } from "./persisted-signal.js";
import { M as ae, a as oe } from "./app-shell-state.js";
import { A as se, F as x, I as S, M as ce, S as le } from "./rpc-1.js";
import { i as ue, t as C } from "./route-scope.js";
import { r as de } from "./diff-view-mode.js";
import { n as fe } from "./app-shell-tab-controller.js";
import { t as pe } from "./store.js";
import { i as me, t as he } from "./parse-diff.js";
import { t as ge } from "./sumBy.js";
import { a as w, n as T, r as E } from "./thread-context.js";
import { t as _e } from "./hash-code.js";
import { n as ve, r as ye, t as be } from "./project-context-signal-N.js";
function D(e) {
  return e === `staged` || e === `unstaged`;
}
var O = ie(`diff-filter`, `unstaged`);
function xe(e, t = {}) {
  return pe.prepareInput(e, t);
}
var Se = `⁣`;
function Ce(e) {
  let t = new Set();
  ...
  return e.map((e) => {
    ...
    let r = `${e.displayPath}${Se}`;
    for (; n.has(r) || t.has(r); ) r = `${r}${Se}`;
...
function Oe({
  ...
  return c?.aborted
    ...
    : new Promise((u, d) => {
        ...
        g.disposeAbortListener = Ae({
          abortPathRequest: () => {
            je({ path: o, pendingRequest: h, pathRequest: g });
          },
          signal: c,
        });
        let _ = h.paths.get(o);
        (_ != null && (_.disposeAbortListener(), _.reject(f())),
          h.paths.set(o, g),
          !k.has(m) &&
            (k.set(m, h),
            (h.flushTimeoutId = setTimeout(() => {
              ((h.flushTimeoutId = null), Me(m));
            }, we))));
      });
}
function ke(e) {
...
function Ae({ abortPathRequest: e, signal: t }) {
  return t == null
    ? () => {}
...
function je({ path: e, pathRequest: t, pendingRequest: n }) {
  if (
    n.paths.get(e) === t &&
    (t.disposeAbortListener(), n.paths.delete(e), t.reject(f()), !(n.paths.size > 0))
  ) {
    ...
    await Promise.allSettled(
      e.map(async (e) => {
        ...
        try {
          ...
          Pe({ error: n instanceof Error ? n : Error(String(n)), files: e, pendingRequest: t });
        } finally {
...
function Ne({ diffs: e, files: t, hideWhitespace: n, pendingRequest: r }) {
  for (let i of t) {
...
function Pe({ error: e, files: t, pendingRequest: n }) {
  for (let r of t) n.paths.get(r.path)?.reject(e);
}
function Fe({ baseBranch: e, commitSha: t, cwd: n, hideWhitespace: r, source: i }) {
  return {
    cwd: b(n),
    ...(r ? { hideWhitespace: r } : {}),
    source: i,
...
var Ie = e(re(), 1);
function Le({ cwd: e, path: t }) {
  if (e == null || !ce(t)) return t;
  let n = x(Ie.default.relative(S(``, e), t));
  return n === `` ? se(t) : n;
}
function Re({ gitRoot: e, gitPath: t }) {
  let n = x(t);
  return e == null ? n : x(S(e, n));
}
var ze = i(C, null);
function Be(e, t) {
  (e.set(ze, null), e.set(O, t));
}
var Ve = e(ne(), 1),
  He = new WeakMap(),
  Ue = i(C, null),
  ...
  Ge = t(C, ({ get: e }) => e(We)),
  Ke = r(s, (e) => null),
  qe = t(C, ({ get: e, scope: t }) => e(Ke, ue(t.value))),
  Je = 3,
  Ye = 300,
  Xe = 1e3,
  Ze = 30,
  Qe = i(C, !1),
  j = ye,
  $e = o(C, ({ get: e }) => d(e(We), e(w), e(E), `review_model`, { watchForGitInit: !0 })),
  et = t(C, ({ get: e }) => e($e).data?.root ?? e(We)),
  tt = n(s, (e) =>
    u(
      `base-branch`,
  ...
  M = t(C, ({ get: e }) => {
    let t = e(j),
      n = t.data ?? null;
    return n == null ? v(t) : e(tt, { commonDir: n.commonDir, hostConfig: e(E), root: n.root });
  }),
  nt = ve,
  rt = o(C, ({ get: e }) => {
    let t = e(E),
    ...
    return u(
      `recent-branches`,
      r,
      r == null ? null : { limit: Ze, operationSource: `review_model`, root: r.root },
      n,
      t,
    );
  }),
  N = t(C, ({ get: e }) => Dt(e(M).data ?? null, e(qe))),
  it = o(C, ({ get: e }) => {
    let t = e(E),
      n = e(w),
      r = e(j).data ?? null,
  ...
  at = n(s, (e) =>
    u(
      `index-info`,
      { commonDir: e.commonDir, root: e.root },
      { cwd: b(e.cwd), operationSource: `review_model` },
      p(e.hostConfig),
      e.hostConfig,
      { refetchOnWindowFocus: `always`, staleTime: y.FIVE_SECONDS },
    ),
  ),
  ot = t(C, ({ get: e }) => {
    let t = e(mt),
      n = e(T);
    if (!t || n == null) return m();
    let r = e(j),
      i = r.data ?? null;
    return i == null
      ? v(r)
      : e(at, { commonDir: i.commonDir, cwd: n, hostConfig: e(E), root: i.root });
  }),
  st = n(s, (e) =>
    u(
      `review-summary`,
      ...
      {
        enabled: e.enabled,
        refetchInterval: (e) => (e.state.data?.type === `error` ? Xe : !1),
  ...
  ct = n(s, (e) =>
    u(
      ...
      p(e.hostConfig),
      e.hostConfig,
      { enabled: e.enabled, staleTime: y.FIVE_SECONDS },
    ),
  ),
  lt = t(C, ({ get: e }) => {
    let t = e(j),
  ...
  P = t(C, ({ get: e }) => {
    ...
    return o == null ? (n == null ? v(t) : m()) : e(st, o);
  }),
  ut = t(C, ({ get: e }) => {
    let t = e(P).data;
    if (t?.type !== `success`) return null;
    let n = e(j).data?.root ?? null,
      r = new Map();
    for (let e of t.files) {
      let t = Re({ gitRoot: n, gitPath: e.path });
      r.has(t) || r.set(t, e);
    }
    return r;
  });
function dt(e, t = e.get(ht)) {
  let n = e.get(M),
    ...
    i = ft({
      ...
      cwd: e.get(T),
      enabled: e.get(I) && !r,
      hideWhitespace: e.get(de),
      hostConfig: e.get(E),
      metadata: e.get(j).data ?? null,
      source: t,
    });
...
var F = t(C, ({ get: e, scope: t }) =>
    t.value.routeKind === `remote-thread` ? `cloud` : e(be).isCodexWorktree ? `worktree` : `local`,
  ),
  pt = t(C, ({ get: e }) => e(I) && e(O) === `branch`),
  mt = t(C, ({ get: e }) => e(I) && D(e(O))),
  I = t(C, ({ get: e }) => {
    let t = e(O);
    return (
      e(T) != null && e(F) !== `cloud` && t !== `last-turn` && (t !== `commit` || e(A) != null)
    );
  }),
  ht = t(C, ({ get: e }) => {
    let t = e(O);
    return t === `last-turn` || (t === `commit` && e(A) == null) ? null : t;
  });
function gt({ cwd: e, hideWhitespace: t, source: n, baseBranch: r, commitSha: i }) {
  return {
    cwd: b(e),
    ...(t ? { hideWhitespace: t } : {}),
    operationSource: `review_model`,
...
var _t = n(C, (e, { get: t }) => {
    ...
    return {
      ...
      enabled: t(I) && n != null && r?.type === `success` && i != null && a != null,
      refetchOnWindowFocus: `always`,
      retry: Ft,
      retryDelay: It,
      staleTime: y.FIVE_SECONDS,
      placeholderData: (e, t) => {
        if (!(t == null || !Lt(f, t.queryKey))) return e;
      },
    };
  }),
  vt = t(C, ({ get: e }) => Pt(e(Ue)));
async function yt(e) {
  let t = e.get(j).data;
  if (e.get(I) && t != null) {
    try {
...
async function St(e, t) {
  ...
  try {
    ...
    await Promise.all([c(e.queryClient, t.commonDir, { hostKey: e.get(w) }), Nt(e)]);
  } finally {
    e.set(Qe, !1);
  }
}
async function Ct(e, t) {
  let n = e.get(j).data,
    r = e.get(T),
    i = wt({ cwd: r, gitRoot: n?.root ?? null, paths: t });
  if (!(!e.get(I) || n == null || r == null || i.length === 0)) {
    try {
      await ee({
...
function wt({ cwd: e, gitRoot: t, paths: n }) {
  ...
  return [
    ...new Set(
      n.flatMap((t) => {
        if (t === ``) return [];
        let n = Ie.default.relative(r, S(e, t));
...
async function Et(e, t) {
  await Promise.all([g(e.queryClient, t, { hostKey: e.get(w) }), Nt(e)]);
}
...
function kt(e, t, n) {
  (e.set(Ue, t), e.set(We, n));
}
function At(e, t, n) {
  e.set(Ke, t, n);
}
function jt(e, t) {
  (e.set(A, t), Be(e, `commit`));
}
function Mt(e) {
  return e.watch((t) => {
    if (t.get(O) === `commit`) {
      ...
      if (!(n == null || n.some((t) => t.sha === e))) {
        (t.set(A, null), Be(t, `branch`));
        return;
      }
    }
    let n = t.get(ht);
    (n === `branch` && t.get(N),
      t.get(j).data != null && (t.get(Ue) != null || (t.get(I) && n != null)) && yt(e));
  });
}
async function Nt(e) {
  let t = dt(e);
...
function Pt(e) {
  return e == null || e.trim() === ``
    ...
    : { diff: he(e), diffText: e, diffBytes: new TextEncoder().encode(e).length, diffError: null };
}
function Ft(e, t) {
  return t.name !== `AbortError` && e < Je;
}
function It(e) {
  return Math.min(Ye * 2 ** e, 2e3);
}
function Lt(e, t) {
  return e.length > 0 && e.length === t.length && (0, Ve.default)(e.slice(0, -1), t.slice(0, -1));
}
var Rt = e(ge(), 1);
function zt() {
...
function Bt() {
  return { staged: zt(), unstaged: zt(), version: 0 };
}
function Vt(e) {
  return new Set([
...
var Ht = i(C, Bt()),
  Ut = t(C, ({ get: e }) => Vt(e(Ht)));
function Wt(e) {
  e.set(Ht, Bt());
}
async function Gt(e, t) {
  let n = e.get(T);
  if (e.get(F) === `cloud` || n == null) return;
...
function Kt({ reviewSummary: e, selectedDiff: t, shouldFetchReviewSummary: n }) {
  if (n && e?.type === `success`) return qt(e);
  let r = t.diff ?? [];
  return Yt(
    (0, Rt.default)(r, (e) => e.additions),
    (0, Rt.default)(r, (e) => e.deletions),
    r.length,
    t.diffText?.length ?? 0,
  );
}
function qt(e) {
  return Yt(
    (0, Rt.default)(e.files, (e) => e.additions ?? 0),
    (0, Rt.default)(e.files, (e) => e.deletions ?? 0),
    e.files.length,
  );
}
function Jt(e) {
  return e == null ? null : Yt(e.additions, e.deletions, e.fileCount);
}
function Yt(e, t, n, r = 0) {
  return { additions: e, bytesEstimate: r, deletions: t, fileCount: n, lineCount: e + t };
}
function Xt({ reviewSummary: e, selectedDiff: t, shouldFetchReviewSummary: n }) {
  return n ? e?.type === `success` && e.files.length > 0 : (t.diff?.length ?? 0) > 0;
}
var Zt = t(C, ({ get: e }) =>
    e(F) === `cloud` || e(O) === `last-turn`
      ? e(vt)
      : { diff: null, diffText: null, diffBytes: null, diffError: null },
  ),
  Qt = t(C, ({ get: e }) => (e(F) === `cloud` || e(O) === `last-turn` ? (e(Ge) ?? e(T)) : e(T))),
  $t = t(C, ({ get: e }) => {
    if (e(F) === `cloud` || e(O) === `last-turn`)
      return { isFetchingGitChanges: !1, isPendingGitChanges: !1 };
    let t = e(P);
    return { isFetchingGitChanges: t.isFetching, isPendingGitChanges: e(I) && t.isPending };
  }),
  L = t(C, ({ get: e }) => {
    let t = e(O),
      n = e($t),
  ...
  en = t(C, ({ get: e }) => {
    if (e(F) === `cloud`) return { isLoading: !1, metrics: null };
    let t = e(lt),
      n = Jt(t.data);
    ...
    if (e(O) === `branch`) {
      ...
      return n?.type === `success`
        ...
        : { isLoading: e(I) && t.isPending, metrics: null };
    }
    return { isLoading: t.isFetching, metrics: null };
  }),
  tn = t(C, ({ get: e }) => e(O) !== `branch` && (e(en).metrics?.fileCount ?? 0) > 0),
  nn = t(C, ({ get: e }) => {
    if (e(F) !== `cloud` && e(O) === `branch`) {
      let t = e(en);
      if (t.metrics != null) return t.metrics;
    }
    let t = e(I);
    return Kt({
      reviewSummary: e(P).data,
      selectedDiff: t ? { diff: null, diffText: null } : e(L),
      shouldFetchReviewSummary: t,
    });
  }),
  rn = t(C, ({ get: e }) => {
    if (e(F) === `cloud` || !D(e(O))) return { stagedFileCount: void 0, unstagedFileCount: void 0 };
    let t = e(P).data;
  ...
  an = t(C, ({ get: e }) =>
    Xt({ reviewSummary: e(P).data, selectedDiff: e(L), shouldFetchReviewSummary: e(I) }),
  ),
  on = t(C, ({ get: e }) => {
    let t = e(j);
    return e(F) !== `cloud` && !t.isLoading && t.data?.root == null;
  }),
  sn = t(C, ({ get: e, scope: t }) => {
    let n = e(O),
      r = e(j);
    return (
  ...
  cn = t(C, ({ get: e }) => {
    ...
    if (e(I)) {
      let n = e(P).data;
      return n?.type === `success` && n.files.length > 0 && !(e(sn) && t.hasOptimisticDiffs);
    }
    return t.diffText != null && t.diffText.trim().length > 0 && !(e(sn) && t.hasOptimisticDiffs);
  }),
  ln = t(C, ({ get: e }) => e(j).data?.commonDir != null && !e(Qe)),
  un = t(C, ({ get: e, scope: t }) => {
    let n = e(L);
    return t.value.routeKind !== `remote-thread` && n.isPendingGitChanges && !e(an);
  }),
  dn = t(C, ({ get: e }) => e(L).diffError?.type === `diff-too-large`);
function fn({ reviewSummaryFetching: e, reviewSummaryUpdatedAt: t, shouldFetchReviewSummary: n }) {
  return !n || e ? !1 : t !== 0;
}
var pn = t(C, ({ get: e }) => {
    let t = e(I),
  ...
  R = t(C, ({ get: e }) => {
    if (e(I)) return yn({ cwd: e(T), gitRoot: e(j).data?.root ?? null, reviewSummary: e(P).data });
    let t = e(F) === `cloud` || e(O) === `last-turn` ? e(et) : (e(j).data?.root ?? null);
    return Sn(e(L).diff, t);
  }),
  mn = a(C, (e, { get: t }) => {
    if (t(I)) {
      let n = t(j).data?.root ?? null,
        r = t(ut)?.get(e) ?? null;
    ...
    let n = x(_(e, t(T) ?? void 0));
    return t(R).find((t) => t.path === e || t.gitPath === n) ?? null;
  }),
  hn = t(C, ({ get: e }) => Cn(e(R))),
  gn = t(C, ({ get: e }) => wn({ diffBytes: e(L).diffBytes, fileEntries: e(R) })),
  _n = t(C, ({ get: e }) =>
    me({ fileCount: e(R).length, totalChangedBytes: e(gn), totalChangedLines: e(hn) }),
  ),
  vn = t(C, ({ get: e }) => {
    let t = e(R);
    return !e(I) || e(_n) ? t : t.map((t) => e(mn, t.path) ?? t);
  });
function yn({ cwd: e, gitRoot: t, reviewSummary: n }) {
  return n?.type === `success`
    ? bn(n.files.map((n) => xn({ cwd: e, gitRoot: t, reviewDiffIsFetching: !0, reviewFile: n })))
    : [];
}
function bn(e) {
  let t = Ce(e),
...
function xn({
  ...
  let o = x(a.path),
    s = Re({ gitRoot: t, gitPath: o }),
    c = n?.type === `success` ? n.diff : ``,
    l = c.trim().length > 0,
    u = l ? (he(c)[0] ?? null) : null,
    d = `loading`;
  return (
    u == null
      ? n?.type === `success`
      ...
      : (d = `loaded`),
    {
      ...
      displayPath: Le({ cwd: e, path: s }),
      diff: u,
      diffRenderKey: n?.type === `success` ? `${c.length}:${_e(c)}` : a.revision,
      diffLoadStatus: d,
      gitPath: o,
      path: s,
      summary: a,
  ...
  return bn(
    e?.map((e) => {
      let n = x(e.metadata.name),
        r = Re({ gitRoot: t, gitPath: n });
      return {
        canApplyPatchActions: !0,
        displayPath: n,
        diff: e,
        diffRenderKey: _e(e.metadata.cacheKey ?? r),
...
function wn({ diffBytes: e, fileEntries: t }) {
  return e ?? t.reduce((e, t) => e + (t.diff?.changedBytes ?? 0), 0);
}
var Tn = `codex-thread-find-match`,
  En = `codex-thread-find-active`,
  Dn = `data-content-search-match-id`,
  On = `codex-thread-find-shadow-style`,
  kn = `
...
function Nn({ element: e, matchId: t }) {
  e.setAttribute(Dn, t);
}
function Pn({ container: e, matchId: t, includeShadowRoots: n }) {
  let r = Jn(t);
  for (let t of Vn(e, { includeShadowRoots: n })) {
    let e = t.querySelector(`[${Dn}="${r}"]`);
    if (e != null) return e;
  }
  return null;
}
function Fn({ container: e, lineNumber: t, side: n, includeShadowRoots: r }) {
  let i = Jn(`${t}`),
    a = n === `additions` ? `[data-additions]` : n === `deletions` ? `[data-deletions]` : null;
  for (let t of Vn(e, { includeShadowRoots: r })) {
    if (a != null) {
      let e =
        Ln({ root: t, selector: `${a}[data-line="${i}"]` }) ??
        Ln({ root: t, selector: `${a} [data-line="${i}"]` }) ??
        Ln({ root: t, selector: `[data-line="${i}"] ${a}` });
      if (e != null) return e;
      if (In(t)) continue;
    }
    let e = Ln({ root: t, selector: `[data-line="${i}"]` });
    if (e != null) return e;
  }
  return null;
}
...
function zn({ target: e, query: t, maxMatches: n, includeShadowRoots: r }) {
  if (n <= 0) return { matches: [], isCapped: !1 };
  let i = t.trim();
  if (i.length === 0) return { matches: [], isCapped: !1 };
  let a = [],
    o = Vn(e, { includeShadowRoots: r }),
    s = !1;
  for (let e of o) {
    let t = n - a.length;
    if (t <= 0) {
...
function Hn(e) {
  if (e.getElementById(On) != null) return;
  let t = document.createElement(`style`);
  ((t.id = On), (t.textContent = kn), e.append(t));
}
function Un(e) {
...
var er = 150,
  ...
  nr = i(C, `conversation`),
  rr = t(C, ({ get: e }) =>
    e(ae) === `right-panel` && e(oe) && e(fe.activeTab$)?.tabId === `diff` ? `diff` : e(nr),
  ),
  V = i(C, !1),
  H = i(C, `conversation`),
  U = i(C, ``),
  ...
  K = i(C, null),
  ir = i(C, null),
  ar = t(C, ({ get: e }) => e(U).trim().length > 0),
  or = t(C, ({ get: e }) =>
    $n(
      {
        query: e(U).trim(),
...
function _r(
  ...
  let _ = () => {
    ...
    ee = e.watch((e) => {
      (e.get(V), e.get(U), e.get(H), e.get(z), e.get(B), _());
    }),
    v = e.watch((e) => {
      let t = e.get(W),
        n = e.get(K);
...
var X = t(C, ({ get: e }) => wr(e(q))),
  Tr = t(C, ({ get: e }) => Qn(e(q), e(K))),
  Z = 20,
  Er = 200,
  Dr = 50,
  Or = 600,
  ...
  Nr = t(C, ({ get: e }) => e(_n) && e(X).active && e(Mr).length > 0),
  Pr = t(C, ({ get: e }) => {
    if (!e(Nr)) return Z;
    let t = e(Ar),
      n = e(q),
...
function Gr(e) {
  for (let t of document.querySelectorAll(le.reviewFile))
...
function qr(e, t) {
  let n = Jr(e.get(R), t.position.path),
