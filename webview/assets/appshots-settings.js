...
import { m as r, o as i, s as a, t as o, z as s } from "./app-scope.js";
import "./app-server-manager-signals.js";
import { _ as c, u as l } from "./vscode-api.js";
import "./isEqual.js";
import { k as u } from "./src-2.js";
import "./react-dom.js";
...
import "./tooltip.js";
import { t as _, x as v } from "./product-logger.js";
import "./format-skill-title.js";
import { n as y } from "./rpc-Hf-fxjh7.js";
import { u as b } from "./statsig.js";
import "./request.js";
import "./platform.js";
...
import { t as S } from "./appshot-availability.js";
import { r as C, t as w } from "./dropdown.js";
import "./search.js";
import { t as T } from "./appshot-logo.js";
import { t as E } from "./toggle.js";
import "./use-os-info.js";
import { t as D } from "./use-platform.js";
import "./chevron.js";
import { n as ee } from "./electron-menu-shortcuts.js";
import "./links-p.js";
...
function V() {
  ...
  e[3] !== t || e[4] !== f
    ? ((m = async function (e, n) {
        ...
        try {
          ...
          _(t, v, { hotkey: e ?? void 0, enabled: e != null, source: n });
        } catch (e) {
          let t = e;
    ...
    : (m = e[5]);
  let h = m,
    y = u?.configuredHotkey ?? null,
    b;
  e[6] === y ? (b = e[7]) : ((b = B.find((e) => e.hotkey === y) ?? null), (e[6] = y), (e[7] = b));
  let T = b,
    E;
  e[8] !== y || e[9] !== T?.label
    ? ((E = T?.label ?? (y == null ? null : ee(y))), (e[8] = y), (e[9] = T?.label), (e[10] = E))
    : (E = e[10]);
  let D = E,
    O = T?.hotkey ?? null,
    A;
        ...
        O == null && s == null
          ...
          : (0, L.jsxs)(`div`, {
              ...
              children: [
                ...
                s
                  ? (0, L.jsx)(`span`, { className: `text-token-error-foreground`, children: s })
                  : null,
              ],
            })),
      (e[11] = s),
  ...
  e[18] !== f.isPending || e[19] !== W
    ...
    : (G = e[20]);
  let K;
  e[21] !== h || e[22] !== y || e[23] !== T?.hotkey
    ? ((K = B.map((e) =>
        (0, L.jsx)(
          C.Item,
          {
            RightIcon: e.hotkey === T?.hotkey ? g : void 0,
            onSelect: () => {
              (l(null), e.hotkey !== y && h(e.hotkey, `capture`));
            },
            children: e.label,
          },
          e.hotkey,
      ...
      (e[24] = K))
    : (K = e[24]);
  let q = y == null ? g : void 0,
    J;
  e[25] !== h || e[26] !== y
    ? ((J = () => {
        (l(null), y != null && h(null, `disable`));
      }),
      (e[25] = h),
      (e[26] = y),
      (e[27] = J))
  ...
  let X;
  e[29] !== q || e[30] !== J
    ? ((X = (0, L.jsx)(C.Item, { RightIcon: q, onSelect: J, children: Y })),
      (e[29] = q),
      (e[30] = J),
      (e[31] = X))
    : (X = e[31]);
  let Z;
  e[32] !== K || e[33] !== X
    ? ((Z = (0, L.jsxs)(C.Section, { children: [K, X] })), (e[32] = K), (e[33] = X), (e[34] = Z))
    : (Z = e[34]);
  let Q;
...
function G() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, L.jsx)(O, { slug: `appshots` })), (e[0] = o))
    : (o = e[0]);
  let s;
...
function K() {
  let e = (0, P.c)(9),
    ...
    a;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, L.jsx)(p, { ...W.soundEffect })), (e[0] = a))
    : (a = e[0]);
  let s;
  e[1] === n
    ? (s = e[2])
  ...
  return (
    e[5] !== r || e[6] !== s || e[7] !== c
      ? ((l = (0, L.jsx)(j, {
          label: a,
          control: (0, L.jsx)(E, { ariaLabel: s, checked: r, onChange: c }),
        })),
        (e[5] = r),
        (e[6] = s),
        (e[7] = c),
