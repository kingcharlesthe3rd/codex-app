...
import { lt as z, ut as ce } from "./app-initial~app-main~automations-page.js";
import {
  O as le,
  T as ue,
  k as B,
...
function _e() {
  ...
  e[3] !== t || e[4] !== m
    ? ((h = async function (e, n) {
        u(null);
        try {
          let i = await m.mutateAsync({ hotkey: e });
          if (!i.success) {
            u(i.error);
            return;
          }
          ne(t, r, { hotkey: e ?? void 0, enabled: e != null, source: n });
        } catch (e) {
          let t = e;
    ...
    : (h = e[5]);
  let g = h,
    _ = d?.configuredHotkey ?? null,
    v;
  e[6] === _ ? (v = e[7]) : ((v = X.find((e) => e.hotkey === _) ?? null), (e[6] = _), (e[7] = v));
  let b = v,
    x;
  e[8] !== _ || e[9] !== b?.label
    ? ((x = b?.label ?? (_ == null ? null : oe(_))), (e[8] = _), (e[9] = b?.label), (e[10] = x))
    : (x = e[10]);
  let S = x,
    C = b?.hotkey ?? null,
    w;
    ...
    ? ((w =
        C == null && s == null
          ...
          : (0, q.jsxs)(`div`, {
              ...
              children: [
                C == null ? null : (0, q.jsx)(ye, { hotkey: C }),
                s
                  ? (0, q.jsx)(`span`, { className: `text-token-error-foreground`, children: s })
                  : null,
              ],
            })),
      (e[11] = s),
  ...
  e[16] === S
    ...
    : ((k =
      ...
      (e[17] = k));
  let A;
  e[18] !== m.isPending || e[19] !== k
    ? ((A = (0, q.jsx)(ue, { disabled: m.isPending, style: O, children: k })),
      (e[18] = m.isPending),
      (e[19] = k),
      (e[20] = A))
    : (A = e[20]);
  let j;
  e[21] !== g || e[22] !== _ || e[23] !== b?.hotkey
    ? ((j = X.map((e) =>
        (0, q.jsx)(
          l.Item,
          {
            RightIcon: e.hotkey === b?.hotkey ? re : void 0,
            onSelect: () => {
              (u(null), e.hotkey !== _ && g(e.hotkey, `capture`));
            },
            children: e.label,
          },
          e.hotkey,
      ...
      (e[24] = j))
    : (j = e[24]);
  let M = _ == null ? re : void 0,
    N;
  e[25] !== g || e[26] !== _
    ? ((N = () => {
        (u(null), _ != null && g(null, `disable`));
      }),
      (e[25] = g),
      (e[26] = _),
      (e[27] = N))
  ...
  let F;
  e[29] !== M || e[30] !== N
    ? ((F = (0, q.jsx)(l.Item, { RightIcon: M, onSelect: N, children: P })),
      (e[29] = M),
      (e[30] = N),
      (e[31] = F))
    : (F = e[31]);
  let I;
  e[32] !== j || e[33] !== F
    ? ((I = (0, q.jsxs)(l.Section, { children: [j, F] })), (e[32] = j), (e[33] = F), (e[34] = I))
    : (I = e[34]);
  let L;
  e[35] !== m.isPending || e[36] !== I || e[37] !== A
    ? ((L = (0, q.jsx)(te, {
        align: `end`,
  ...
  return (
    e[39] !== T || e[40] !== L
      ? ((R = (0, q.jsx)(se, { label: E, description: T, control: L })),
        (e[39] = T),
        (e[40] = L),
        (e[41] = R))
      : (R = e[41]),
...
function Se() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(le, { slug: `appshots` })), (e[0] = o))
    : (o = e[0]);
  let s;
...
function Ce() {
  ...
  return (
    e[5] !== i || e[6] !== o || e[7] !== s
      ? ((l = (0, $.jsx)(se, {
          label: a,
          control: (0, $.jsx)(b, { ariaLabel: o, checked: i, onChange: s }),
        })),
        (e[5] = i),
        (e[6] = o),
        (e[7] = s),
