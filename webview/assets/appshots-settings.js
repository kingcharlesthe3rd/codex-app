...
import { Fn as R, In as z } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
import {
  H as se,
  R as ce,
  V as le,
...
function _e() {
  ...
  let f = d,
    ...
    m;
  e[6] === p ? (m = e[7]) : ((m = X.find((e) => e.hotkey === p) ?? null), (e[6] = p), (e[7] = m));
  let g = m,
    _;
  e[8] !== p || e[9] !== g?.label
    ? ((_ = g?.label ?? (p == null ? null : te(p))), (e[8] = p), (e[9] = g?.label), (e[10] = _))
    : (_ = e[10]);
  let v = _,
    b = g?.hotkey ?? null,
    x;
  ...
  let P;
  e[32] !== k || e[33] !== N
    ? ((P = (0, q.jsxs)(C.Section, { children: [k, N] })), (e[32] = k), (e[33] = N), (e[34] = P))
    : (P = e[34]);
  let I;
