...
import { br as h, xr as g } from "./app-initial~app-main~onboarding-page.js";
import {
  Ab as _,
  Ax as v,
  Df as y,
...
import { dt as I, lt as L } from "./app-initial~app-main~automations-page.js";
import {
  Er as ie,
  F as ae,
  P as oe,
...
function _e() {
  ...
  let p = f,
    ...
    g;
  e[6] === m ? (g = e[7]) : ((g = X.find((e) => e.hotkey === m) ?? null), (e[6] = m), (e[7] = g));
  let _ = g,
    v;
  e[8] !== m || e[9] !== _?.label
    ? ((v = _?.label ?? (m == null ? null : de(m))), (e[8] = m), (e[9] = _?.label), (e[10] = v))
    : (v = e[10]);
  let y = v,
    b = _?.hotkey ?? null,
    x;
  ...
  let P;
  e[32] !== O || e[33] !== N
    ? ((P = (0, q.jsxs)(R.Section, { children: [O, N] })), (e[32] = O), (e[33] = N), (e[34] = P))
    : (P = e[34]);
  let I;
