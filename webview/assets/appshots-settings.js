...
import { fr as g, pr as _ } from "./app-initial~app-main~onboarding-page.js";
import {
  O as v,
  S as te,
  dt as y,
...
import { Dt as N, Tt as P } from "./app-initial~app-main~automations-page.js";
import {
  en as ae,
  nn as F,
  nt as I,
...
function _e() {
  ...
  e[3] !== t || e[4] !== l
    ? ((u = async function (e, n) {
        ...
        try {
          ...
          re(t, ne, { hotkey: e ?? void 0, enabled: e != null, source: n });
        } catch (e) {
          let t = e;
  ...
  let _ = h,
    v;
  e[8] !== m || e[9] !== _?.label
    ? ((v = _?.label ?? (m == null ? null : ae(m))), (e[8] = m), (e[9] = _?.label), (e[10] = v))
    : (v = e[10]);
  let y = v,
    S = _?.hotkey ?? null,
    C;
    ...
    ? ((C =
        S == null && i == null
          ...
          : (0, q.jsxs)(`div`, {
              ...
              children: [
                S == null ? null : (0, q.jsx)(ye, { hotkey: S }),
                i
  ...
  e[16] === y
    ...
    : ((k =
      ...
      (e[17] = k));
  let A;
  e[18] !== l.isPending || e[19] !== k
    ? ((A = (0, q.jsx)(ue, { disabled: l.isPending, style: O, children: k })),
      (e[18] = l.isPending),
      (e[19] = k),
      (e[20] = A))
    : (A = e[20]);
  ...
  e[21] !== p || e[22] !== m || e[23] !== _?.hotkey
    ? ((j = X.map((e) =>
        (0, q.jsx)(
          x.Item,
          {
            RightIcon: e.hotkey === _?.hotkey ? b : void 0,
            onSelect: () => {
  ...
  let F;
  e[29] !== M || e[30] !== N
    ? ((F = (0, q.jsx)(x.Item, { RightIcon: M, onSelect: N, children: P })),
      (e[29] = M),
      (e[30] = N),
      (e[31] = F))
    : (F = e[31]);
  let I;
  e[32] !== j || e[33] !== F
    ? ((I = (0, q.jsxs)(x.Section, { children: [j, F] })), (e[32] = j), (e[33] = F), (e[34] = I))
    : (I = e[34]);
  let L;
  e[35] !== l.isPending || e[36] !== I || e[37] !== A
    ? ((L = (0, q.jsx)(te, {
        align: `end`,
  ...
  return (
    e[39] !== w || e[40] !== L
      ? ((R = (0, q.jsx)(g, { label: T, description: w, control: L })),
        (e[39] = w),
        (e[40] = L),
        (e[41] = R))
      : (R = e[41]),
...
function Ce() {
  ...
  return (
    e[5] !== r || e[6] !== a || e[7] !== o
      ? ((c = (0, $.jsx)(g, {
          label: i,
          control: (0, $.jsx)(L, { ariaLabel: a, checked: r, onChange: o }),
        })),
        (e[5] = r),
        (e[6] = a),
        (e[7] = o),
