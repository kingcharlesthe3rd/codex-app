...
import { R as r, o as i, p as a, s as o, t as s } from "./app-scope.js";
import "./app-server-manager-signals.js";
import { g as c, u as l } from "./vscode-api.js";
import "./isEqual.js";
import { k as u } from "./src-1.js";
import "./react-dom.js";
import { c as d, o as f, r as p } from "./lib.js";
import { E as m, o as h } from "./persisted-signal.js";
import "./proxy.js";
import "./button-DO-oxX3-.js";
import { a as g, i as _ } from "./setting-storage.js";
...
import { t as T } from "./appshot-availability-BoK-Z77O.js";
...
import { n as M, t as N } from "./settings-group.js";
var P = r(),
...
function V() {
  ...
  e[3] !== t || e[4] !== p
    ? ((g = async function (e, n) {
        l(null);
        try {
          let r = await p.mutateAsync({ hotkey: e });
          if (!r.success) {
            l(r.error);
            return;
          }
          h(t, m, { hotkey: e ?? void 0, enabled: e != null, source: n });
        } catch (e) {
          let t = e;
  ...
  let S = b,
    E;
  e[8] !== y || e[9] !== S?.label
    ? ((E = S?.label ?? (y == null ? null : C(y))), (e[8] = y), (e[9] = S?.label), (e[10] = E))
    : (E = e[10]);
  let D = E,
    O = S?.hotkey ?? null,
    A;
        ...
        O == null && a == null
          ...
          : (0, L.jsxs)(`div`, {
              ...
              children: [
                ...
                a
                  ? (0, L.jsx)(`span`, { className: `text-token-error-foreground`, children: a })
                  : null,
              ],
            })),
      (e[11] = a),
  ...
  e[16] === D
    ...
    : ((W =
      ...
      (e[17] = W));
  let G;
  e[18] !== p.isPending || e[19] !== W
    ? ((G = (0, L.jsx)(k, { disabled: p.isPending, style: V, children: W })),
      (e[18] = p.isPending),
      (e[19] = W),
      (e[20] = G))
    : (G = e[20]);
  let K;
  e[21] !== _ || e[22] !== y || e[23] !== S?.hotkey
    ? ((K = B.map((e) =>
        (0, L.jsx)(
          w.Item,
          {
            RightIcon: e.hotkey === S?.hotkey ? v : void 0,
            onSelect: () => {
              (l(null), e.hotkey !== y && _(e.hotkey, `capture`));
            },
            children: e.label,
          },
          e.hotkey,
      ...
      (e[24] = K))
    : (K = e[24]);
  let q = y == null ? v : void 0,
    J;
  e[25] !== _ || e[26] !== y
    ? ((J = () => {
        (l(null), y != null && _(null, `disable`));
      }),
      (e[25] = _),
      (e[26] = y),
      (e[27] = J))
  ...
  e[32] !== K || e[33] !== X
    ...
    : (Z = e[34]);
  let Q;
  e[35] !== p.isPending || e[36] !== Z || e[37] !== G
    ? ((Q = (0, L.jsx)(ee, {
        align: `end`,
...
function K() {
  let e = (0, P.c)(9),
    ...
    a;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, L.jsx)(f, { ...W.soundEffect })), (e[0] = a))
    : (a = e[0]);
  let o;
  e[1] === n
    ? (o = e[2])
