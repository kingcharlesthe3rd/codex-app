...
function b(t) {
  let i = (0, _.c)(61),
    { diffContent: m, conversationId: g } = t,
    y = n(l),
    b;
  i[0] === g
    ? (b = i[1])
    : ((b = { conversationId: g, enablePullRequestComments: !1 }), (i[0] = g), (i[1] = b));
  let { commentProps: x } = ie(b),
    C;
  i[2] === m ? (C = i[3]) : ((C = f(m)), (i[2] = m), (i[3] = C));
  let w = C,
    T;
  ...
  i[16] === y
    ? (V = i[17])
    : ((V = (e) => y.set(d, e === `left` ? `unified` : `split`)), (i[16] = y), (i[17] = V));
  let H;
  i[18] !== V || i[19] !== B
    ? ((H = (0, v.jsx)(re, { options: z, selectedId: B, onSelect: V, size: `toolbar` })),
      (i[18] = V),
      (i[19] = B),
      (i[20] = H))
    : (H = i[20]);
  ...
  let G = D ? `ghostActive` : `ghost`,
    K;
  i[24] !== D || i[25] !== y
    ? ((K = () => y.set(u, !D)), (i[24] = D), (i[25] = y), (i[26] = K))
    : (K = i[26]);
  let q;
  i[27] === D
    ? (q = i[28])
  ...
  if (
    ...
    let t;
    (i[49] !== x || i[50] !== g || i[51] !== A || i[52] !== E || i[53] !== D || i[54] !== P
      ? ((t = (t, n) =>
          (0, v.jsx)(
            h,
            {
