...
function F(e) {
  let t = (0, L.c)(61),
    { diffContent: n, conversationId: i } = e,
    a = p(f),
    o;
  t[0] === i
    ? (o = t[1])
    : ((o = { conversationId: i, enablePullRequestComments: !1 }), (t[0] = i), (t[1] = o));
  let { commentProps: u } = ie(o),
    h;
  t[2] === n ? (h = t[3]) : ((h = ae(n)), (t[2] = n), (t[3] = h));
  let g = h,
    _;
  t[4] === g ? (_ = t[5]) : ((_ = oe(g)), (t[4] = g), (t[5] = _));
  let y = _,
    b = m(w),
    x = m(S),
    C = l(),
    { data: T } = m(ne),
    E = c().state?.cwd || T?.roots?.[0],
    { fileCount: D, linesAdded: O, linesDeleted: k } = y,
    A = D <= z && O + k <= B,
    j;
  t[6] === D
    ? (j = t[7])
  ...
  t[16] === a
    ? (V = t[17])
    : ((V = (e) => a.set(w, e === `left` ? `unified` : `split`)), (t[16] = a), (t[17] = V));
  let H;
  t[18] !== V || t[19] !== I
  ...
  t[22] === C
    ...
    : ((W = C.formatMessage({
      ...
      (t[22] = C),
      (t[23] = W));
  let G = x ? `ghostActive` : `ghost`,
    K;
  t[24] !== x || t[25] !== a
    ? ((K = () => a.set(S, !x)), (t[24] = x), (t[25] = a), (t[26] = K))
    : (K = t[26]);
  let q;
  t[27] === x
    ? (q = t[28])
    : ((q = x
        ? (0, R.jsx)(ee, { className: `icon-xs text-token-description-foreground` })
        : (0, R.jsx)(d, { className: `icon-xs text-token-description-foreground` })),
      (t[27] = x),
      (t[28] = q));
  let J;
  t[29] !== x || t[30] !== W || t[31] !== G || t[32] !== K || t[33] !== q
    ? ((J = (0, R.jsx)(v, {
        tooltipContent: U,
        children: (0, R.jsx)(te, {
          "aria-label": W,
  ...
  if (
    ...
    let e;
    (t[49] !== u || t[50] !== i || t[51] !== E || t[52] !== b || t[53] !== x || t[54] !== A
      ? ((e = (e, t) =>
          (0, R.jsx)(
            re,
            {
...
function ce(e) {
  ...
  return (
    t[1] === n
      ? (a = t[2])
      : ((a = (0, R.jsx)(v, { tooltipContent: i, children: (0, R.jsx)(O, { className: n }) })),
        (t[1] = n),
        (t[2] = a)),
    a
  );
...
function le(e) {
  ...
  return (
    t[1] === n
      ? (a = t[2])
      : ((a = (0, R.jsx)(v, { tooltipContent: i, children: (0, R.jsx)(T, { className: n }) })),
        (t[1] = n),
        (t[2] = a)),
    a
  );
