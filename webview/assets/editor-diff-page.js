...
function F(e) {
  ...
  t[0] === r
    ? (c = t[1])
    : ((c = { conversationId: r, enablePullRequestComments: !1 }), (t[0] = r), (t[1] = c));
  ...
  t[16] === s
    ? (V = t[17])
    : ((V = (e) => s.set(S, e === `left` ? `unified` : `split`)), (t[16] = s), (t[17] = V));
  let H;
  t[18] !== V || t[19] !== I
  ...
  if (
    ...
    let e;
    (t[49] !== l || t[50] !== r || t[51] !== T || t[52] !== _ || t[53] !== v || t[54] !== k
      ? ((e = (e, t) =>
          (0, R.jsx)(
            ae,
            {
...
function ce(e) {
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, R.jsx)(p, { tooltipContent: r, children: (0, R.jsx)(k, { className: n }) })),
        (t[1] = n),
        (t[2] = i)),
    i
  );
...
function le(e) {
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, R.jsx)(p, { tooltipContent: r, children: (0, R.jsx)(D, { className: n }) })),
        (t[1] = n),
        (t[2] = i)),
    i
  );
