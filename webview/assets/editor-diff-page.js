...
import { ct as A, lt as j } from "./app-initial~app-main~onboarding-page.js";
import {
  i as oe,
  r as M,
...
function F(e) {
  let t = (0, L.c)(61),
    { diffContent: n, conversationId: o } = e,
    s = i(ie),
    c;
  t[0] === o
    ? (c = t[1])
    : ((c = { conversationId: o, enablePullRequestComments: !1 }), (t[0] = o), (t[1] = c));
  let { commentProps: l } = ee(c),
    u;
  t[2] === n ? (u = t[3]) : ((u = oe(n)), (t[2] = n), (t[3] = u));
  let f = u,
    p;
  t[4] === f ? (p = t[5]) : ((p = A(f)), (t[4] = f), (t[5] = p));
  let h = p,
    g = a(T),
    _ = a(S),
    b = x(),
    { data: C } = a(m),
    w = y().state?.cwd || C?.roots?.[0],
    { fileCount: E, linesAdded: D, linesDeleted: O } = h,
    k = E <= z && D + O <= B,
    j;
  t[6] === E
    ? (j = t[7])
  ...
  t[16] === s
    ? (V = t[17])
    : ((V = (e) => s.set(T, e === `left` ? `unified` : `split`)), (t[16] = s), (t[17] = V));
  let H;
  t[18] !== V || t[19] !== I
  ...
  let G = _ ? `ghostActive` : `ghost`,
    K;
  t[24] !== _ || t[25] !== s
    ? ((K = () => s.set(S, !_)), (t[24] = _), (t[25] = s), (t[26] = K))
    : (K = t[26]);
  let q;
  t[27] === _
    ? (q = t[28])
    : ((q = _
        ? (0, R.jsx)(ne, { className: `icon-xs text-token-description-foreground` })
        : (0, R.jsx)(re, { className: `icon-xs text-token-description-foreground` })),
      (t[27] = _),
      (t[28] = q));
  let J;
  t[29] !== _ || t[30] !== W || t[31] !== G || t[32] !== K || t[33] !== q
    ? ((J = (0, R.jsx)(d, {
        tooltipContent: U,
        children: (0, R.jsx)(te, {
          "aria-label": W,
  ...
  if (
    ...
    let e;
    (t[49] !== l || t[50] !== o || t[51] !== w || t[52] !== g || t[53] !== _ || t[54] !== k
      ? ((e = (e, t) =>
          (0, R.jsx)(
            ae,
            {
...
function ce(e) {
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, R.jsx)(d, { tooltipContent: r, children: (0, R.jsx)(k, { className: n }) })),
        (t[1] = n),
        (t[2] = i)),
    i
  );
...
function le(e) {
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, R.jsx)(d, { tooltipContent: r, children: (0, R.jsx)(O, { className: n }) })),
        (t[1] = n),
        (t[2] = i)),
    i
  );
