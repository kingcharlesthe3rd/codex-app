...
import "./pdf-2.js";
import { G as n, U as r, X as i, Z as a, wt as o } from "./setting-storage.js";
...
import { i as d } from "./focus-composer.js";
import "./file-diff.js";
import "./sumBy.js";
import "./terminal.js";
import "./info.js";
...
function b(t) {
  ...
  o[0] === h
    ? (b = o[1])
    : ((b = { conversationId: h, enablePullRequestComments: !1 }), (o[0] = h), (o[1] = b));
  let { commentProps: x } = ie(b),
    C;
  o[2] === p ? (C = o[3]) : ((C = d(p)), (o[2] = p), (o[3] = C));
  let w = C,
    T;
  o[4] === w ? (T = o[5]) : ((T = ae(w)), (o[4] = w), (o[5] = T));
  let le = T,
    E = a(u),
    D = a(l),
    O = n(),
  ...
  o[11] !== F || o[12] !== I
    ...
    : (L = o[13]);
  let R;
  o[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = { id: `left`, label: (0, v.jsx)(S, { className: `icon-xs` }) }), (o[14] = R))
    : (R = o[14]);
  let z;
  o[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = [R, { id: `right`, label: (0, v.jsx)(ce, { className: `icon-xs` }) }]), (o[15] = z))
    : (z = o[15]);
  let B = E === `unified` ? `left` : `right`,
    V;
  o[16] === y
    ? (V = o[17])
    : ((V = (e) => y.set(u, e === `left` ? `unified` : `split`)), (o[16] = y), (o[17] = V));
  let H;
  o[18] !== V || o[19] !== B
    ...
    : (H = o[20]);
  let U;
  o[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = (0, v.jsx)(r, {
  ...
  let G = D ? `ghostActive` : `ghost`,
    K;
  o[24] !== D || o[25] !== y
    ? ((K = () => y.set(l, !D)), (o[24] = D), (o[25] = y), (o[26] = K))
    : (K = o[26]);
  let q;
  o[27] === D
    ? (q = o[28])
    : ((q = D
      ...
      (o[28] = q));
  let J;
  o[29] !== D || o[30] !== W || o[31] !== G || o[32] !== K || o[33] !== q
    ? ((J = (0, v.jsx)(c, {
        tooltipContent: U,
        children: (0, v.jsx)(ne, {
          "aria-label": W,
  ...
  if (
    ...
    let t;
    (o[49] !== x || o[50] !== h || o[51] !== A || o[52] !== E || o[53] !== D || o[54] !== P
      ? ((t = (t, n) =>
          (0, v.jsx)(
            m,
            {
...
function x() {
  ...
  bb0: {
    ...
    if (n?.unifiedDiff && n.conversationId)
      try {
        let t = n.conversationId ?? null,
          r;
        (e[0] !== n.unifiedDiff || e[1] !== t
          ? ((r = { diffContent: n.unifiedDiff, conversationId: t }),
            (e[0] = n.unifiedDiff),
            (e[1] = t),
            (e[2] = r))
          : (r = e[2]),
        ...
        e[3] === t
          ...
          : ((n = t.formatMessage({
            ...
            (e[4] = n));
        let r;
        (e[5] === n ? (r = e[6]) : ((r = { error: n }), (e[5] = n), (e[6] = r)), (i = r));
        break bb0;
      }
    let a;
    e[7] === t
      ...
      : ((a = t.formatMessage({
        ...
        (e[8] = a));
    let o;
    (e[9] === a ? (o = e[10]) : ((o = { error: a }), (e[9] = a), (e[10] = o)), (i = o));
  }
  return i;
}
function S(e) {
  ...
  return (
    t[1] === n
      ? (a = t[2])
      : ((a = (0, v.jsx)(c, { tooltipContent: i, children: (0, v.jsx)(h, { className: n }) })),
        (t[1] = n),
        (t[2] = a)),
    a
  );
...
function ce(e) {
  ...
  return (
    t[1] === n
      ? (a = t[2])
      : ((a = (0, v.jsx)(c, { tooltipContent: i, children: (0, v.jsx)(p, { className: n }) })),
        (t[1] = n),
        (t[2] = a)),
    a
  );
