...
import { a as r, n as i } from "./src-6.js";
...
import { n as y, t as b } from "./src-1.js";
import { n as x, t as S } from "./chunk-71.js";
import { r as C, u as w } from "./chunk-123.js";
import { n as T, t as E } from "./chunk-17.js";
import { n as D, t as O } from "./mermaid-parser.core-1.js";
import { n as k, t as A } from "./chunk-116.js";
import { a as j, n as M, r as N } from "./chunk-51.js";
function P(e) {
  if (!e.length) return [];
  let t = [],
    n = [];
  ...
  (S(),
    ...
    (F = class {
      ...
      addClass(e, t) {
        ...
        (r &&
          r.forEach((e) => {
            (N(e) && (n?.textStyles ? n.textStyles.push(e) : (n.textStyles = [e])),
    ...
    (I = o((e, t) => {
      ...
      for (let n of e.TreemapRows ?? [])
        n.$type === `ClassDefStatement` && t.addClass(n.className ?? ``, n.styleText ?? ``);
      ...
      let r = P(n),
        i = o((e, n) => {
          for (let r of e)
            (t.addNode(r, n), r.children && r.children.length > 0 && i(r.children, n + 1));
        }, `addNodesRecursively`);
      i(r, 0);
    }, `populate`)),
    ...
    (H = {
      draw: o((e, s, c, l) => {
        ...
        let M = b
          ...
          P = i()
            .size([S, C])
            .paddingTop((e) => (e.children && e.children.length > 0 ? V + B : 0))
            .paddingInner(f)
            ...
            .round(!0)(N),
          F = P.descendants().filter((e) => e.children && e.children.length > 0),
        ...
        (I.append(`rect`)
          ...
          I.append(`text`)
            ...
            .attr(`style`, (e) =>
              e.depth === 0
                ...
                : `dominant-baseline: middle; font-size: 12px; fill:` +
                  ...
                  j({ cssCompiledStyles: e.data.cssCompiledStyles }).labelStyles.replace(
                    `color:`,
                    `fill:`,
                  ),
            )
            .each(function (e) {
              ...
              let r = e.x1 - e.x0,
                i;
              i = d.showValues !== !1 && e.value ? r - 10 - 30 - 10 - 6 : r - 6 - 6;
              let a = Math.max(15, i),
                o = t.node();
        ...
        (R.append(`rect`)
          ...
          .attr(`style`, (e) => j({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles)
          .attr(`fill-opacity`, 0.3)
          .attr(`stroke`, (e) => (e.parent ? D(e.parent.data.name) : D(e.data.name)))
          .attr(`stroke-width`, 3),
          R.append(`clipPath`)
          ...
          R.append(`text`)
            ...
            .each(function (e) {
              ...
              for (
                ...
                u > o &&
                s > 8 &&
                (s--, (l = Math.max(6, Math.min(28, Math.round(s * c)))), !(l < 6 && s === 8));
              )
                (t.style(`font-size`, `${s}px`), (u = s + 2 + l));
              (t.style(`font-size`, `${s}px`),
                (i.getComputedTextLength() > a || s < 8 || o < s) && t.style(`display`, `none`));
            }),
          d.showValues !== !1 &&
            R.append(`text`)
...
export { W as diagram };
//# sourceMappingURL=diagram-13.js.map
