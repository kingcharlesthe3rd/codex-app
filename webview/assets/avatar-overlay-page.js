...
import { An as ge, at as _e, jn as ve, ot as ye } from "./app-initial~app-main~automations-page.js";
import {
  d as W,
  f as G,
  p as be,
...
import { n as ke, t as Y } from "./avatar-mascot-button.js";
import {
  c as Ae,
  s as je,
...
function mt(e) {
  ...
  let [D, O] = (0, X.useState)(E),
    ...
    A;
  t[8] !== a || t[9] !== ee
    ? ((A = a.some((e) => e.id === ee) ? ee : null), (t[8] = a), (t[9] = ee), (t[10] = A))
    : (A = t[10]);
  let j = A,
    M = j != null && n,
    ne,
  ...
  t[29] === p
    ...
    : ((me = () => {
        let e = _.current;
        e != null && (e.scrollTo({ behavior: p ? `auto` : `smooth`, top: 0 }), O(kt(e, 0)));
      }),
      (t[29] = p),
      (t[30] = me));
  let he = me,
  ...
  let W;
  t[36] !== z || t[37] !== h
    ? ((W = z ? { height: h, maxHeight: h } : void 0), (t[36] = z), (t[37] = h), (t[38] = W))
    : (W = t[38]);
  let be = r ? null : V,
    K;
  t[39] !== j ||
    ...
    ? ((K = R
        ? (0, Z.jsxs)(J.div, {
            ...
            children: [
              (0, Z.jsx)(Oe, {
                children: ie
                  ? (0, Z.jsx)(gt, { prefersReducedMotion: p, onClick: he }, `latest`)
                  : null,
              }),
              (0, Z.jsx)(J.div, {
                ref: de,
              ...
              (0, Z.jsx)(Oe, {
                children: ae
                  ? (0, Z.jsx)(_t, { count: I, prefersReducedMotion: p, onClick: _e }, `older`)
                  : null,
              }),
            ],
          })
...
function ht(e) {
  ...
  t[4] === l
    ? (u = t[5])
    : ((u = G(`no-drag w-full min-w-0 shrink-0 overflow-hidden px-1.5 text-left`, l)),
      (t[4] = l),
      (t[5] = u));
  let d;
...
function yt({
  ...
  let se = I > R + Kt || ie,
    ...
    H = A.trim(),
    le = l ? { duration: 0 } : { duration: P ? 0.2 : 0.28, ease: [0.16, 1, 0.3, 1] },
    U = async (e) => {
      if ((e.preventDefault(), e.stopPropagation(), !(!ce || H.length === 0 || O))) {
        (ee(!0), N(null));
        try {
          (await c(t, H), j(``), i());
        } catch {
        ...
        children: [
          ...
          (0, Z.jsx)(`span`, {
            ...
            className: G(
              ...
              se && P && `opacity-0 transition-opacity duration-150 motion-reduce:transition-none`,
            ),
            children:
                  ...
                  (0, Z.jsxs)(`div`, {
                    ...
                    children: [
                      (0, Z.jsx)(`input`, {
                        ...
                        onKeyDown: (e) => {
                          e.key !== `Escape` || O || (e.stopPropagation(), i(), N(null));
                        },
                      }),
                      (0, Z.jsx)(te, {
...
function wt(e) {
  ...
  if (!o) {
    ...
    let i;
    t[15] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, Z.jsx)(ge, { className: `mx-1.5 text-token-text-tertiary` })), (t[15] = i))
      : (i = t[15]);
    let a;
    t[16] === s
      ? (a = t[17])
...
function Zt({ selectedAvatar: e, selectedAvatarId: t }) {
  ...
  let { data: h } = we({ enabled: m, hostId: void 0 }),
    ...
    ge = V == null ? null : lt({ intl: r, petName: V.petName, startedAtMs: V.startedAtMs }),
    ve = [],
  ...
  ((0, $.useEffect)(() => {
    ...
    (0, $.useEffect)(() => {
      ke.current ||
        (o !== x &&
          ((ke.current = !0),
          Y(R.CODEX_AVATAR_OVERLAY_ACTION_OPENED, H.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
    }, [o, Y]),
    Qe({
  ...
  let Ae = (0, $.useCallback)(() => {
    ...
    Le = (0, $.useCallback)((e, t) => {
      ...
      n == null ||
        n.pointerId !== e ||
        ((q.current = null), te(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
    }, []),
    Re = (0, $.useCallback)(
      (e, t) => {
        let n = q.current;
    ...
    ze = (0, $.useCallback)(
      (e, { releaseSample: t, shouldPreserveOrbMomentum: n = !1, shouldOpenMainWindow: r }) => {
        ...
        let { hasMoved: o, releaseSample: s, velocity: c } = rt(i, t, n && i.usesOrbPhysics);
        if (
          ...
          r &&
            i.startedOnMascot &&
            !o &&
            (Y(R.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, H.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          ...
          o &&
            Y(R.CODEX_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED, H.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          c != null)
        ) {
          ...
          case `plan-start`:
            if (r?.kind === `plan` && t.planStartCollaborationMode != null) {
              D(`update-thread-settings-for-next-turn`, {
                ...
                .then(() =>
                  D(`remove-plan-implementation-request`, { conversationId: i, turnId: r.turnId }),
                )
                .then(async () =>
    ...
    st = async (e, t) => {
      ...
      r.length !== 0 &&
        ...
        await D(`send-follow-up-message`, {
          ...
          prompt: r,
          serviceTier: await f(n, n.get(E, e.controlTarget.conversationId) ?? `local`, null),
        }));
    },
    ut = (0, $.useCallback)((e) => {
  ...
  return (
      ...
      ({ layout: e }) => {
        (v(e),
          Ee.current === e.mascot.width &&
            ((Ee.current = null), je(), N(null), window.requestAnimationFrame(Ae)));
      },
      [je, Ae],
    ),
    (0, $.useLayoutEffect)(() => {
    ...
    (0, fn.jsx)(pt, {
      ...
      mascotDragState: y,
      mascotLayout:
        k && M != null ? { ..._.mascot, height: Math.ceil(M / We), width: M } : _.mascot,
