...
import { gt as K, ht as be } from "./app-initial~app-main~automations-page.js";
import { n as xe, t as q } from "./avatar-mascot-button.js";
import {
  i as J,
  r as Se,
      ...
      children: [
        ...
        (0, Z.jsx)(g, {
          ...
          children: (0, Z.jsx)(`div`, {
            ...
            style: { height: N.height, left: N.left, top: N.top, width: N.width },
            children: B,
          }),
        }),
      ],
...
function mt(e) {
  ...
  let [T, E] = (0, X.useState)(w),
    ...
    j;
  t[8] !== a || t[9] !== D
    ? ((j = a.some((e) => e.id === D) ? D : null), (t[8] = a), (t[9] = D), (t[10] = j))
    : (j = t[10]);
  let ie = j,
    M = ie != null && n,
    N,
  ...
  t[29] === f
    ...
    : ((_e = () => {
        let e = _.current;
        e != null && (e.scrollTo({ behavior: f ? `auto` : `smooth`, top: 0 }), E(kt(e, 0)));
      }),
      (t[29] = f),
      (t[30] = _e));
  let W = _e,
  ...
  let be;
  t[36] !== B || t[37] !== h
    ? ((be = B ? { height: h, maxHeight: h } : void 0), (t[36] = B), (t[37] = h), (t[38] = be))
    : (be = t[38]);
  let xe = r ? null : de,
    q;
  t[39] !== ie ||
    ...
    ? ((q = ce
        ? (0, Z.jsxs)(k.div, {
            ...
            children: [
              (0, Z.jsx)(re, {
                children: ae
                  ? (0, Z.jsx)(gt, { prefersReducedMotion: f, onClick: W }, `latest`)
                  : null,
              }),
              (0, Z.jsx)(k.div, {
                ref: me,
              ...
              (0, Z.jsx)(re, {
                children: oe
                  ? (0, Z.jsx)(_t, { count: L, prefersReducedMotion: f, onClick: ye }, `older`)
                  : null,
              }),
            ],
          })
...
function ht(e) {
  ...
  t[4] === l
    ? (u = t[5])
    : ((u = A(`no-drag w-full min-w-0 shrink-0 overflow-hidden px-1.5 text-left`, l)),
      (t[4] = l),
      (t[5] = u));
  let d;
...
function yt({
  ...
  let B = I > se + Kt || R,
    ...
    ue = re.trim(),
    de = u ? { duration: 0 } : { duration: N ? 0.2 : 0.28, ease: [0.16, 1, 0.3, 1] },
    fe = async (e) => {
      if ((e.preventDefault(), e.stopPropagation(), !(!le || ue.length === 0 || O))) {
        (ne(!0), M(null));
        try {
          (await l(t, ue), j(``), a());
        } catch {
        ...
        children: [
          ...
          (0, Z.jsx)(`span`, {
            ...
            className: A(
              ...
              B && N && `opacity-0 transition-opacity duration-150 motion-reduce:transition-none`,
            ),
            children:
              y?.kind === `question` ? (0, Z.jsx)(je, { className: g.iconClassName }) : Rt(g),
          }),
          B
            ? (0, Z.jsx)(k.div, {
                  ...
                  (0, Z.jsxs)(`div`, {
                    ...
                    children: [
                      (0, Z.jsx)(`input`, {
                        ...
                        onKeyDown: (e) => {
                          e.key !== `Escape` || O || (e.stopPropagation(), a(), M(null));
                        },
                      }),
                      (0, Z.jsx)(w, {
...
function wt(e) {
  ...
  if (!o) {
    ...
    let i;
    t[15] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, Z.jsx)(Se, { className: `mx-1.5 text-token-text-tertiary` })), (t[15] = i))
      : (i = t[15]);
    let a;
    t[16] === s
      ? (a = t[17])
...
function Xt() {
  ...
  if (
    (e[0] === r
      ...
      : ((i = () => {
          r &&
            f.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: !1 });
        }),
        (a = [r]),
        (e[0] = r),
        (e[1] = i),
...
function Zt({ selectedAvatar: e, selectedAvatarId: t }) {
  ...
  let { data: g } = ie({ enabled: m, hostId: void 0 }),
    ...
    ue = R == null ? null : lt({ intl: o, petName: R.petName, startedAtMs: R.startedAtMs }),
    de = [],
  ...
  ((0, $.useEffect)(() => {
    ...
    (0, $.useEffect)(() => {
      ke.current ||
        (c !== me &&
          ((ke.current = !0),
          Y(H.CODEX_AVATAR_OVERLAY_ACTION_OPENED, U.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
    }, [c, Y]),
    Qe({
      interactiveRegionRef: De,
      isPaused: () => q.current != null || J.current != null,
      onInteractiveChange: (e) => {
        f.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: e });
      },
  ...
  let Ae = (0, $.useCallback)(() => {
        ...
        (Se.current ??= window.requestAnimationFrame(() => {
          ...
          ((we.current = null),
            !(e == null || J.current == null) &&
              f.dispatchMessage(`avatar-overlay-mascot-resize-move`, { width: e }));
        })));
    }, []),
    Fe = (0, $.useCallback)(
      (e) => {
    ...
    Le = (0, $.useCallback)((e, t) => {
      ...
      n == null ||
        n.pointerId !== e ||
        ((J.current = null), T(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
    }, []),
    Re = (0, $.useCallback)(
      (e, t) => {
        let n = J.current;
      ...
      (e, { releaseSample: t, shouldPreserveOrbMomentum: n = !1, shouldOpenMainWindow: r }) => {
        ...
        if (
          ...
          r &&
            i.startedOnMascot &&
            !a &&
            (Y(H.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, U.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          ...
          a &&
            Y(H.CODEX_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED, U.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          s != null)
        ) {
          ...
          case `plan-start`:
            if (r?.kind === `plan` && t.planStartCollaborationMode != null) {
              G(`update-thread-settings-for-next-turn`, {
                ...
                .then(() =>
                  G(`remove-plan-implementation-request`, { conversationId: i, turnId: r.turnId }),
                )
                .then(async () =>
    ...
    st = async (e, t) => {
      ...
      r.length !== 0 &&
        ...
        await G(`send-follow-up-message`, {
          ...
          prompt: r,
          serviceTier: await h(n, n.get(ce, e.controlTarget.conversationId) ?? `local`, null),
        }));
    },
    ut = (0, $.useCallback)((e) => {
      f.dispatchMessage(`avatar-overlay-keyboard-interaction-changed`, { isInteractive: e });
    }, []);
  return (
    p(
      ...
      ({ layout: e }) => {
        (y(e),
          Te.current === e.mascot.width &&
            ((Te.current = null), je(), k(null), window.requestAnimationFrame(Ae)));
      },
      [je, Ae],
    ),
    (0, $.useLayoutEffect)(() => {
    ...
    (0, fn.jsx)(pt, {
      ...
      mascotDragState: b,
      mascotLayout:
        w && O != null ? { ...v.mascot, height: Math.ceil(O / We), width: O } : v.mascot,
