...
import { a as E } from "./setting-storage.js";
...
import "./check-md.js";
import { t as O } from "./chevron-right.js";
...
import { t as k } from "./clock-Cid-cc8u.js";
import { t as se } from "./question-mark-circle.js";
import { t as A } from "./warning.js";
import "./waveform.js";
import {
  c as ce,
  i as j,
...
import { D as R } from "./codex-api.js";
...
function Ye({
  ...
  onPointerMove: D,
  onPointerUp: O,
  onDismissNotification: re,
  onRunNotificationAction: ae,
  onSubmitQuestionOption: k,
  onNotificationReplyEditorActiveChange: se,
  onOpenNotificationReply: A,
  onSubmitNotificationReply: ce,
  onOpenNotificationTray: j,
  onStartRealtimeVoice: le,
  ...
  return (
    z
      ? (be = {
          ...
          content: (0, q.jsx)(oe, { className: `icon-xs opacity-80` }),
...
function Xe(e) {
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = {
      ...
      (t[7] = D))
    : (D = t[7]);
  let [O, re] = (0, G.useState)(D),
    [ie, ae] = (0, G.useState)(null),
    oe = (0, G.useRef)(null),
    k;
  t[8] !== a || t[9] !== ie
    ? ((k = a.some((e) => e.id === ie) ? ie : null), (t[8] = a), (t[9] = ie), (t[10] = k))
    : (k = t[10]);
  let se = k,
    A = se != null && n,
    ce,
  ...
  (t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = () => {
      ...
      (t[16] = M))
    : ((le = t[15]), (M = t[16])),
    h(`avatar-overlay-keyboard-interaction-ready`, M, le));
  let N = Math.min(O.hiddenOlderNotificationCount, E),
    ue = O.hasScrollableContent,
    de = n && ue && T && O.hasLatestNotificationsAbove,
    P = n && ue && T && N > 0,
    F = n && ue && T,
    I = n && ue,
    fe = a.length > 0,
  ...
  t[29] === f
    ...
    : ((ye = () => {
        let e = _.current;
        e != null && (e.scrollTo({ behavior: f ? `auto` : `smooth`, top: 0 }), re(lt(e, 0)));
      }),
      (t[29] = f),
      (t[30] = ye));
  let be = ye,
  ...
  t[31] !== N || t[32] !== f
    ? ((xe = () => {
        ...
        if (e == null) return;
        let t = $e(e, N);
        (e.scrollTo({ behavior: f ? `auto` : `smooth`, top: t }), re(lt(e, t)));
      }),
      (t[31] = N),
      (t[32] = f),
      (t[33] = xe))
...
function et({
  ...
  let f = v(),
    ...
    ne =
      t.action == null
        ? `${t.title}. ${w}`
        : `${t.title}. ${w}. ${f.formatMessage(J.openNotification)}`,
    E = t.action != null,
    [D, ie] = (0, G.useState)(!1),
    [ae, oe] = (0, G.useState)(!1),
    [k, A] = (0, G.useState)(``),
    ...
    B = (0, G.useCallback)((e) => {
      ...
      (t(), (z.current = ce({ axis: `both`, target: e, onChange: t })));
    }, []);
  (0, G.useLayoutEffect)(() => {
    R.current = D;
  }, [D]);
  let he = I > me + Ke || L,
    ...
    ye = async (e) => {
      if ((e.preventDefault(), e.stopPropagation(), !(!ge || _e.length === 0 || ae))) {
        (oe(!0), de(null));
        try {
          (await l(t, _e), A(``), a());
        } catch {
          de(f.formatMessage(J.notificationReplyError));
        } finally {
          oe(!1);
        }
      }
    ...
    children: [
      (0, q.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, q.jsx)(`span`, {
            role: `img`,
            "aria-label": x?.kind === `question` ? f.formatMessage(J.questionStatusIcon) : y,
            className: S(
            ...
            children:
              x?.kind === `question` ? (0, q.jsx)(se, { className: _.iconClassName }) : _t(_),
          }),
          he
            ? (0, q.jsx)(C.div, {
            ...
            ? (0, q.jsx)(C.div, {
                ...
                children: (0, q.jsx)(`div`, {
                  ...
                  children: (0, q.jsx)(T, {
                    ...
                    color: `outline`,
                    size: `default`,
                    "aria-label": f.formatMessage(J.replyNotification, { title: t.title }),
                    onClick: (e) => {
                      (e.stopPropagation(), de(null), A(``), o(), F(!0));
                    },
                    onPointerDown: (e) => {
                      e.stopPropagation();
                    },
                    children: f.formatMessage(J.replyNotificationButton),
                  }),
                }),
              })
            : null,
                  ...
                  (0, q.jsxs)(`div`, {
                    ...
                    children: [
                      (0, q.jsx)(`input`, {
                        ...
                        "aria-label": f.formatMessage(J.replyNotification, { title: t.title }),
                        autoFocus: !0,
                        placeholder: f.formatMessage(J.notificationReplyPlaceholder),
                        value: k,
                        onChange: (e) => {
                          (A(e.currentTarget.value), de(null));
                        },
                        onKeyDown: (e) => {
                          e.key !== `Escape` || ae || (e.stopPropagation(), a(), de(null));
                        },
                      }),
                      (0, q.jsx)(T, {
                        ...
                        size: `default`,
                        type: `submit`,
                        "aria-label": f.formatMessage(J.sendNotificationReply, { title: t.title }),
                        disabled: _e.length === 0 || ae,
                        loading: ae,
                        children: f.formatMessage(J.replyNotificationButton),
                      }),
                    ],
      ...
      r && !e
        ? (0, q.jsx)(`div`, {
            ...
            children: (0, q.jsx)(re, {
              align: `start`,
              side: `top`,
              tooltipContent: f.formatMessage(J.dismissNotificationTooltip),
              children: (0, q.jsx)(le, {
                ariaLabel: f.formatMessage(J.dismissNotification, { title: t.title }),
                onClick: () => {
                  r(t);
                },
              }),
...
function _t(e) {
  switch (e.iconType) {
    ...
    case `spinner`:
      return (0, q.jsx)(D, { className: e.iconClassName });
    case `warning`:
      return (0, q.jsx)(A, { className: e.iconClassName });
  }
}
var vt = 15e3,
...
function Mt(e) {
  let t = (0, W.c)(158),
    ...
    C = xe(),
    ee = o(f),
    te = E(g.realtimeVoiceAvatarMode) === `pet`,
    [w, ne] = (0, G.useState)(At),
    [T, D] = (0, G.useState)(null),
    [O, re] = (0, G.useState)(!0),
    [ie, oe] = (0, G.useState)(!1),
    [k, se] = (0, G.useState)(!1),
    [A, ce] = (0, G.useState)(!1),
    [j, le] = (0, G.useState)(null),
  ...
  let { data: je, refetch: Me } = R(Ae),
    ...
    Fe = U == null ? null : Ce({ intl: p, petName: U.petName, startedAtMs: U.startedAtMs }),
    Ie = C.phase !== `inactive`,
    Le = _e({ events: ee, intl: p, nowMs: me, realtimeThreadId: C.conversationId }),
    ...
    Xe = (0, G.useRef)(!1),
    Ze;
  t[4] !== J || t[5] !== Y || t[6] !== O || t[7] !== ze.length || t[8] !== S || t[9] !== n
    ? ((Ze = (e, t, r, i) => {
        let a = i === void 0 ? O : i;
        S.logProductEvent(
          F,
  ...
  (t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    ge(nt));
  let rt;
  t[19] !== O || t[20] !== ze.length || t[21] !== C.caption
    ? ((rt = () => {
        if (He.current != null || Ge.current != null) return;
        let e = qt(qe.current);
        if (e == null) return;
        let t = { ...e, isTrayVisible: (O && ze.length > 0) || C.caption != null };
        Qt(Je.current, t) ||
          ((Je.current = t),
    ...
    : ((ut = (e) => {
        ((Ge.current = e),
          ...
          (Ke.current = window.setTimeout(() => {
            ((Ke.current = null), (Ge.current = null), le(null), Z());
          }, 100)));
      }),
      (t[26] = Z),
      (t[27] = ut));
  ...
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((mt = (e, t) => {
        ...
        n == null ||
          n.pointerId !== e ||
          ((He.current = null), se(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
      }),
      (t[30] = mt))
    : (mt = t[30]);
  let ht = mt,
  ...
  t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Tt = (e) => {
        ...
        (Math.abs(r) < bt && Math.abs(i) < bt) ||
          ...
          (t.screenX = n.screenX),
          (t.screenY = n.screenY),
          D((e) => Kt({ currentDragState: e, deltaX: r })),
    ...
    : ((vn = (e) => {
        ...
        (ne(t),
          Ge.current === t.mascot.width &&
            ((Ge.current = null), at(), le(null), window.requestAnimationFrame(Z)));
      }),
      (yn = [at, Z]),
      (t[64] = Z),
      (t[65] = vn),
  ...
  let In = C.canStart,
    ...
    Un = C.phase,
    Wn;
  t[105] !== k || t[106] !== w.mascot || t[107] !== j
    ? ((Wn = k && j != null ? { ...w.mascot, height: Math.ceil(j / Se), width: j } : w.mascot),
      (t[105] = k),
      (t[106] = w.mascot),
      (t[107] = j),
      (t[108] = Wn))
