...
import { bt as he, yt as ge } from "./app-initial~app-main~automations-page.js";
import {
  Al as _e,
  Du as ve,
  Eu as G,
...
function mt({
  ...
  let T = fe(),
    ...
    O = d.length > 0,
    k = a?.phase ?? `inactive`,
    A = Fe(a?.isSessionActive ?? !1, k !== `inactive`),
    ne = A === `voice-orb`,
    j = A === `hidden`,
    M = A === `pet` ? s : { ...s, height: 121, width: 112 },
    N = O && i;
  a?.controlsHovered;
  let P = a?.caption ?? null,
    F = N || P != null,
    re = O || F,
    I = o.placement.startsWith(`top`),
    L = o.placement.endsWith(`end`),
    ie = d.length > Bt,
    ae = o.tray == null ? void 0 : Math.max(0, o.tray.height),
    R = `${I ? `bottom` : `top`} ${L ? `right` : `left`}`,
    oe;
  N
    ? (oe = {
        ariaLabel: T.formatMessage(Q.collapseNotificationTray),
        backgroundColor: `var(--color-token-bg-primary)`,
        content: (0, Z.jsx)(G, { className: `icon-xs opacity-80` }),
  ...
  let se = (0, Z.jsx)(q, {
    ...
    resizeHandle: u == null ? void 0 : { ariaLabel: T.formatMessage(Q.resizeMascot), ...u },
    state: D.mascotState,
    style: c,
    transientState: l,
  });
        ...
        re
          ? (0, Z.jsx)(`div`, {
              ...
              children: (0, Z.jsxs)(C.div, {
                ...
                initial: !1,
                style: ie ? { maxHeight: ae, transformOrigin: R } : { transformOrigin: R },
                transition: E
                  ? { duration: 0 }
        ...
        (0, Z.jsx)(De, {
          ...
          children: (0, Z.jsx)(`div`, {
            ...
            className: V(
              ...
              r && !ne ? `scale-95 transition-transform` : `transition-none`,
            ),
...
function ht(e) {
  ...
  let [D, O] = (0, X.useState)(E),
    ...
    j;
  t[8] !== a || t[9] !== k
    ? ((j = a.some((e) => e.id === k) ? k : null), (t[8] = a), (t[9] = k), (t[10] = j))
    : (j = t[10]);
  let M = j,
    N = M != null && n,
    P,
  ...
  (t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = () => {
      ...
      (t[16] = I))
    : ((re = t[15]), (I = t[16])),
    l(`avatar-overlay-keyboard-interaction-ready`, I, re));
  let L = Math.min(D.hiddenOlderNotificationCount, w),
    ie = D.hasScrollableContent,
    ae = n && ie && te && D.hasLatestNotificationsAbove,
    R = n && ie && te && L > 0,
    oe = n && ie && te,
    se = n && ie,
    ce = a.length > 0,
  ...
  t[17] === p
    ? (B = t[18])
    : ((B = p ? { duration: 0 } : { duration: 0.18, ease: [0.16, 1, 0.3, 1] }),
      (t[17] = p),
      (t[18] = B));
  let H = B,
    le;
  t[19] !== p || t[20] !== m || t[21] !== se
    ? ((le =
        m == null
          ? null
          : (0, Z.jsx)(
              gt,
              { prefersReducedMotion: p, shouldInsetForScrollbar: se, text: m },
              `restricted-caption`,
            )),
      (t[19] = p),
      (t[20] = m),
  ...
  let he;
  (t[26] !== ee || t[27] !== h
    ? ((he = [ee, h, de]), (t[26] = ee), (t[27] = h), (t[28] = he))
    : (he = t[28]),
  ...
  t[29] === p
    ...
    : ((ge = () => {
        let e = _.current;
        e != null && (e.scrollTo({ behavior: p ? `auto` : `smooth`, top: 0 }), O(At(e, 0)));
      }),
      (t[29] = p),
      (t[30] = ge));
  let _e = ge,
  ...
  t[31] !== L || t[32] !== p
    ? ((ve = () => {
        ...
        if (e == null) return;
        let t = yt(e, L);
        (e.scrollTo({ behavior: p ? `auto` : `smooth`, top: t }), O(At(e, t)));
      }),
      (t[31] = L),
      (t[32] = p),
      (t[33] = ve))
  ...
  t[34] === ye
    ? (be = t[35])
    : ((be = V(`relative flex w-full min-w-0 flex-col overflow-hidden`, ye)),
      (t[34] = ye),
      (t[35] = be));
  let xe;
  t[36] !== z || t[37] !== h
    ? ((xe = z ? { height: h, maxHeight: h } : void 0), (t[36] = z), (t[37] = h), (t[38] = xe))
    : (xe = t[38]);
  let Se = r ? null : U,
    K;
  t[39] !== M ||
    ...
    ? ((K = ce
        ? (0, Z.jsxs)(C.div, {
            ...
            children: [
              (0, Z.jsx)(T, {
                children: ae
                  ? (0, Z.jsx)(_t, { prefersReducedMotion: p, onClick: _e }, `latest`)
                  : null,
              }),
              (0, Z.jsx)(C.div, {
                ref: me,
                ...
                role: `list`,
                initial: !1,
                transition: p ? { duration: 0 } : { duration: 0.16, ease: `easeOut` },
                onScroll: (e) => {
              ...
              (0, Z.jsx)(T, {
                children: R
                  ? (0, Z.jsx)(vt, { count: L, prefersReducedMotion: p, onClick: G }, `older`)
                  : null,
              }),
            ],
          })
...
function gt(e) {
  ...
  t[4] === l
    ? (u = t[5])
    : ((u = V(`no-drag w-full min-w-0 shrink-0 overflow-hidden px-1.5 text-left`, l)),
      (t[4] = l),
      (t[5] = u));
  let d;
...
function vt(e) {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = V(qt, `bottom-1 min-w-9`)), (t[10] = p))
    : (p = t[10]);
  let m;
...
function bt({
  ...
  let f = fe(),
    ...
    ce = (0, X.useCallback)((e) => {
      ...
      let t = () => {
        ...
        let n = Pt(e);
        ie((e) => {
          let t = (ae.current && e) || n;
          return e === t ? e : t;
        });
      };
      (t(), (R.current = Ye({ axis: `both`, target: e, onChange: t })));
    }, []);
  (0, X.useLayoutEffect)(() => {
    ae.current = D;
  }, [D]);
  let z = re > se + Kt || L,
    B = z && D && !e,
    H = t.controlTarget?.type === `app-server-conversation` && l != null,
    le = ne.trim(),
    U = u ? { duration: 0 } : { duration: P ? 0.2 : 0.28, ease: [0.16, 1, 0.3, 1] },
    ue = async (e) => {
      if ((e.preventDefault(), e.stopPropagation(), !(!H || le.length === 0 || k))) {
        (A(!0), N(null));
        try {
          (await l(t, le), j(``), i());
        } catch {
      ...
      (0, Z.jsxs)(`div`, {
        ...
        children: [
          (0, Z.jsxs)(C.div, {
            ...
            "aria-label": w ? te : void 0,
            onClick: () => {
              w && o?.(t);
            },
            onKeyDown: (e) => {
              !w || (e.key !== `Enter` && e.key !== ` `) || (e.preventDefault(), o?.(t));
            },
            children: [
              (0, Z.jsx)(`span`, {
          ...
          (0, Z.jsx)(`span`, {
            ...
            className: V(
              ...
              z && P && `opacity-0 transition-opacity duration-150 motion-reduce:transition-none`,
            ),
            children:
                  ...
                  (0, Z.jsxs)(`div`, {
                    ...
                    children: [
                      (0, Z.jsx)(`input`, {
                        ...
                        onKeyDown: (e) => {
                          e.key !== `Escape` || k || (e.stopPropagation(), i(), N(null));
                        },
                      }),
                      (0, Z.jsx)(Ae, {
...
function Tt(e) {
  ...
  if (!o) {
    ...
    let i;
    t[15] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, Z.jsx)(Te, { className: `mx-1.5 text-token-text-tertiary` })), (t[15] = i))
      : (i = t[15]);
    let a;
    t[16] === s
      ? (a = t[17])
...
function zt(e) {
  switch (e.iconType) {
    ...
    case `warning`:
      return (0, Z.jsx)(x, { className: e.iconClassName });
  }
}
var Y,
  X,
...
function Xt() {
  let e = (0, dn.c)(10),
    { selectedAvatar: t, selectedAvatarId: r } = ct(),
    i = t == null,
    a,
    o;
  if (
    (e[0] === i
      ...
      : ((a = () => {
          i &&
            n.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: !1 });
        }),
        (o = [i]),
        (e[0] = i),
        (e[1] = a),
    ...
    return null;
  let s;
  e[3] !== t || e[4] !== r ? ((s = en(t, r)), (e[3] = t), (e[4] = r), (e[5] = s)) : (s = e[5]);
  let c;
  return (
    e[6] !== t || e[7] !== r || e[8] !== s
      ? ((c = (0, fn.jsx)(Zt, { selectedAvatar: t, selectedAvatarId: r }, s)),
        (e[6] = t),
        (e[7] = r),
        (e[8] = s),
        (e[9] = c))
...
function Zt({ selectedAvatar: e, selectedAvatarId: t }) {
  ...
  c(oe, void 0);
  let { data: h } = be({ enabled: m, hostId: void 0 }),
    g = m,
    [_, v] = (0, $.useState)(En),
    [y, b] = (0, $.useState)(null),
    [x, ee] = (0, $.useState)(!0),
    ...
    [E, D] = (0, $.useState)(!1),
    [O, k] = (0, $.useState)(null),
    { mascotWidthPx: A, setMascotWidthPx: j } = Ke(),
    [I, ie] = (0, $.useState)(() => new Map()),
    [R, z] = (0, $.useState)(() => Date.now()),
    [B] = (0, $.useState)(() => $t(e, t)),
    { data: V = [], refetch: U } = ne(),
    { data: de = [], refetch: me } = ye({ taskFilter: `current`, limit: 20 }),
    W = Je({
      includeCompactWaitingRequests: o,
      intl: a,
      localConversations: V,
      excludedConversationId: null,
      remoteTasks: de,
    }),
    he = B == null ? null : ut({ intl: a, petName: B.petName, startedAtMs: B.startedAtMs }),
    _e = [],
    { nextNotificationExpiresAtMs: ve, notifications: G } = ot({
      dismissedNotificationTurnKeys: I,
      extraNotifications: m ? [...[], ..._e] : he == null ? [] : [he],
      nowMs: R,
      sessions: m ? [] : W,
    }),
    xe = lt(G, a),
    Se = W.some((e) => e.source !== `cloud` && e.status === `running`),
  ...
  ((0, $.useEffect)(() => {
    if (B == null) return;
    let e = ce(mn, []);
    e.includes(B.avatarId) || le(mn, [...e, B.avatarId]);
  }, [B]),
    (0, $.useEffect)(() => {
      Ae.current ||
        (s !== N &&
          ((Ae.current = !0),
          J(F.CODEX_AVATAR_OVERLAY_ACTION_OPENED, M.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
    }, [s, J]),
    $e({
      interactiveRegionRef: Oe,
      isPaused: () => Ce.current != null || q.current != null,
      onInteractiveChange: (e) => {
        n.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: e });
      },
  ...
  let je = (0, $.useCallback)(() => {
      ...
      let e = nn(Oe.current);
      if (e == null) return;
      let t = { ...e, isTrayVisible: (x && G.length > 0) || p.caption != null };
      cn(ke.current, t) ||
        ((ke.current = t),
        n.dispatchMessage(`avatar-overlay-element-size-changed`, {
          isTrayVisible: t.isTrayVisible,
          mascot: t.mascot,
          tray: t.tray,
        }));
    }, [x, G.length, p.caption]),
    Me = (0, $.useCallback)(() => {
        ...
        (we.current ??= window.requestAnimationFrame(() => {
          ...
          ((Te.current = null),
            !(e == null || q.current == null) &&
              n.dispatchMessage(`avatar-overlay-mascot-resize-move`, { width: e }));
        })));
    }, []),
    Ie = (0, $.useCallback)(
      (e) => {
        ((Ee.current = e),
          ...
          (De.current = window.setTimeout(() => {
            ((De.current = null), (Ee.current = null), k(null), je());
          }, 100)));
      },
      [Me, je],
    ),
    Le = (0, $.useCallback)(
      () => an(Oe.current?.querySelector(_n) ?? null)?.width ?? A ?? 112,
      [A],
    ),
    Re = (0, $.useCallback)((e, t) => {
      ...
      n == null ||
        n.pointerId !== e ||
        ((q.current = null), T(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
    }, []),
    ze = (0, $.useCallback)(
      (e, t) => {
        let r = q.current;
        if (r == null || r.pointerId !== e) return;
        let i = t == null ? r.currentWidthPx : Qt(r, t);
        ((r.currentWidthPx = i),
          Ne(),
          k(i),
          j(i),
          Ie(i),
          n.dispatchMessage(`avatar-overlay-mascot-resize-end`, { width: i }));
      },
      [Ne, j, Ie],
    ),
    Be = (0, $.useCallback)(
      (e, { releaseSample: t, shouldPreserveOrbMomentum: r = !1, shouldOpenMainWindow: i }) => {
        let a = Ce.current;
        if (a == null || a.pointerId !== e) return;
        ((Ce.current = null), C(!1), b(null));
        let { hasMoved: o, releaseSample: s, velocity: c } = it(a, t, r && a.usesOrbPhysics);
        if (
          (Oe.current?.hasPointerCapture?.(e) && Oe.current.releasePointerCapture?.(e),
          o &&
            !a.hasMoved &&
            s != null &&
            n.dispatchMessage(`avatar-overlay-drag-move`, {
          ...
          i &&
            a.startedOnMascot &&
            !o &&
            (J(F.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, M.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
            n.dispatchMessage(`open-current-main-window`, {})),
          n.dispatchMessage(`avatar-overlay-drag-end`, {
            pointerScreenX: s?.screenX ?? a.screenX,
            pointerScreenY: s?.screenY ?? a.screenY,
          }),
          o &&
            J(F.CODEX_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED, M.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          c != null)
        ) {
          let e = a.usesOrbPhysics ? 3 : 1;
          n.dispatchMessage(`avatar-overlay-drag-release`, {
    ...
    Ve = (e) => {
      e.button !== 0 ||
        ...
        n.dispatchMessage(`avatar-overlay-drag-start`, {
    ...
    He = (e) => {
      ...
      let r = st(e);
      t.samples = pt([...t.samples, r]);
      let i = r.screenX - t.screenX,
        a = r.screenY - t.screenY;
      (Math.abs(i) < 4 && Math.abs(a) < 4) ||
        ((t.hasMoved = !0),
        (t.screenX = r.screenX),
        (t.screenY = r.screenY),
        b((e) => tn({ currentDragState: e, deltaX: i })),
        n.dispatchMessage(`avatar-overlay-drag-move`, {
          pointerScreenX: r.screenX,
          pointerScreenY: r.screenY,
        }));
    },
    Ue = (e) => {
    ...
    Ye = (e) => {
      ...
      (Me(),
        ...
        k(t),
        T(!0),
        n.dispatchMessage(`avatar-overlay-mascot-resize-start`, { width: t }));
    },
    Xe = (e) => {
      let t = q.current;
      if (t == null || t.pointerId !== e.pointerId) return;
    ...
    tt = (e, t) => {
      ...
      if (e.localConversationId != null && t != null) {
        let n = e.localConversationId;
        switch (t.intent) {
          case `command-approval`:
            if (t.commandDecision != null && (i?.kind === `exec` || i?.kind === `network`)) {
              H(`reply-with-command-execution-approval-decision`, {
                conversationId: n,
          ...
          case `file-approval`:
            if (t.fileDecision != null && i?.kind === `patch`) {
              H(`reply-with-file-change-approval-decision`, {
                conversationId: n,
                requestId: i.requestId,
          ...
          case `permission-response`:
            if (t.permissionResponse != null && i?.kind === `permission`) {
              H(`reply-with-permissions-request-approval-response`, {
                conversationId: n,
                requestId: i.requestId,
          ...
          case `mcp-elicitation`:
            if (t.mcpElicitationAction != null && i?.kind === `tool`) {
              H(`reply-with-mcp-server-elicitation-response`, {
                conversationId: n,
                requestId: i.requestId,
          ...
          case `plan-start`:
            if (i?.kind === `plan` && t.planStartCollaborationMode != null) {
              H(`update-thread-settings-for-next-turn`, {
                conversationId: n,
                threadSettings: { collaborationMode: t.planStartCollaborationMode },
              })
                .then(() =>
                  H(`remove-plan-implementation-request`, { conversationId: n, turnId: i.turnId }),
                )
                .then(async () =>
                  H(`send-follow-up-message`, {
                    conversationId: n,
                    prompt: `${ue}\n${i.planContent}`,
                    serviceTier: await S(
                      r,
      ...
      (t != null && t.intent !== `open`) ||
        (e.action != null &&
          ...
          n.dispatchMessage(`open-in-main-window`, { path: e.action.path })));
    },
    rt = (e, t) => {
      let n = e.waitingRequest;
      e.localConversationId == null ||
        n?.kind !== `question` ||
        H(`reply-with-user-input-response`, {
    ...
    ct = async (e, t) => {
      ...
      n.length !== 0 &&
        ...
        await H(`send-follow-up-message`, {
          ...
          prompt: n,
          serviceTier: await S(r, r.get(P, e.controlTarget.conversationId) ?? `local`, null),
        }));
    },
    dt = (0, $.useCallback)((e) => {
      n.dispatchMessage(`avatar-overlay-keyboard-interaction-changed`, { isInteractive: e });
    }, []);
  return (
    l(
      ...
      ({ layout: e }) => {
        (v(e),
          Ee.current === e.mascot.width &&
            ((Ee.current = null), Me(), k(null), window.requestAnimationFrame(je)));
      },
      [Me, je],
    ),
    (0, $.useLayoutEffect)(() => {
    ...
    (0, $.useEffect)(() => {
      ...
      let e = window.setTimeout(() => {
        (z((e) => Math.max(Date.now(), e + 1)), Se && U(), K && me());
      }, pn);
      return () => {
    ...
    (0, fn.jsx)(mt, {
      ...
      avatarMenuItems: [
        {
          ...
          onSelect: () => {
            (J(
              ...
              n.dispatchMessage(`avatar-overlay-close`, {}));
          },
        },
      ],
      interactiveRegionRef: Oe,
      ...
      mascotDragState: y,
      mascotLayout:
        w && O != null ? { ..._.mascot, height: Math.ceil(O / Ge), width: O } : _.mascot,
      mascotResizeHandle: u
        ? void 0
        : {
...
function $t(e, t) {
  return Ze(e, t) || ce(mn, []).includes(e.id)
    ? null
