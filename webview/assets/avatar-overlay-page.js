...
import { F as g, I as _, P as v, f as y, h as b, lt as x, p as ee } from "./vscode-api.js";
import { n as te } from "./react.js";
import { c as ne, n as re, r as S } from "./lib-2.js";
import { _ as C, l as w, p as ie, v as T } from "./persisted-signal-CweW-bgN.js";
import "./rpc-1.js";
import { o as ae } from "./statsig.js";
import "./request.js";
import { c as oe } from "./app-server-manager-hooks.js";
...
import { E as se } from "./codex-api.js";
...
import { t as ce } from "./AnimatePresence.js";
import { t as le } from "./use-reduced-motion.js";
import { t as ue } from "./x.js";
import { t as M } from "./check-circle-filled.js";
import "./use-stable-callback.js";
import "./check-md.js";
import { t as de } from "./chevron-right.js";
import { t as N } from "./context-menu.js";
import { t as fe } from "./read-service-tier-for-request.js";
import { t as pe } from "./get-resize-observer-entry-size.js";
...
import { t as _e } from "./avatar-overlay-analytics.js";
import { i as I } from "./codex-avatar.js";
import { t as L } from "./avatar-mascot-button.js";
import { t as R } from "./use-avatar-options.js";
import { t as ve } from "./use-floating-window-pointer-interactivity.js";
import { t as ye } from "./question-mark-circle.js";
import { t as z } from "./permission-request-model.js";
var B = x(),
  V = e(p(), 1),
  be = 1600,
  xe = 100,
...
function Pe(e, t) {
  ...
  return (
    n.riskLevel === `high` &&
      (l = [{ intent: `open`, label: t.formatMessage(W.review), tone: `primary` }]),
    {
      kind: `tool`,
      requestId: e.requestId,
      operation: o,
...
function Ze({ conversation: e, includeCompactWaitingRequests: t, intl: n }) {
  if (F(e)) return null;
  let r = e.hostId ?? `local`,
    o = r === `local` ? `local` : `remote-host`,
    s = rt(e),
    c = t && s === `waiting` ? a(e) : null;
  return {
    ...
    status: s,
    subtitle: $e(e, n),
    title: i(e) ?? n.formatMessage(Y.newThread),
    turnKey: String(e.turns.length),
    updatedAtMs: e.updatedAt,
    waitingRequest: Ee(c, n),
  };
}
function Qe(e, t) {
...
function vn(e) {
  let t = (0, B.c)(148),
    { isLoading: i, refetch: a, selectedAvatar: o, selectedAvatarId: c } = e,
    p = g(b),
    m = ne(),
    h = ae(`451951815`),
    v = _(T),
  ...
  let { data: be, refetch: xe } = se(z),
    ...
    Le = (0, V.useRef)(!1),
    Re;
  t[4] !== De || t[5] !== Oe || t[6] !== D || t[7] !== W.length || t[8] !== v || t[9] !== o
    ? ((Re = (e, t, n, r) => {
        let i = r === void 0 ? D : r;
        v.logProductEvent(
          s,
  ...
  (t[11] === I
    ...
    (0, V.useEffect)(ze, Be));
  let Ve, He;
  (t[14] !== i || t[15] !== a || t[16] !== o.id || t[17] !== c
    ? ((Ve = () => {
        !i && c?.startsWith(`custom:`) && o.id !== c && a();
      }),
      (He = [i, a, o.id, c]),
      (t[14] = i),
      (t[15] = a),
  ...
  (t[20] !== v || t[21] !== G
    ? ((Ue = () => {
        Le.current ||
          (v !== C &&
            ((Le.current = !0),
            G(n.CODEX_AVATAR_OVERLAY_ACTION_OPENED, f.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
      }),
      (We = [v, G]),
      (t[20] = v),
      (t[21] = G),
  ...
  t[39] === G
    ? (at = t[40])
    : ((at = (e, t) => {
        let { releaseSample: r, shouldOpenMainWindow: i } = t,
          a = ke.current;
        if (a == null || a.pointerId !== e) return;
        ((ke.current = null), A(!1), E(null));
        let o = r == null ? null : Se(a, r);
        (Fe.current?.hasPointerCapture?.(e) && Fe.current.releasePointerCapture?.(e),
          i &&
            a.startedOnMascot &&
            !a.hasMoved &&
            (G(n.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, f.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
            y.dispatchMessage(`open-current-main-window`, {})),
          y.dispatchMessage(`avatar-overlay-drag-end`, {}),
          a.hasMoved &&
            G(n.CODEX_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED, f.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          o != null &&
            y.dispatchMessage(`avatar-overlay-drag-release`, { velocityX: o.x, velocityY: o.y }));
      }),
      (t[39] = G),
      (t[40] = at));
  let Q = at,
        ...
        (t != null && t.intent !== `open`) ||
          (e.action != null &&
            (G(
              ...
              f.CODEX_AVATAR_OVERLAY_SOURCE_NOTIFICATION_ROW,
              e,
            ),
  ...
  t[66] !== p || t[67] !== G
    ? ((Mt = async (e, t) => {
        ...
        i.length !== 0 &&
          (G(
            n.CODEX_AVATAR_OVERLAY_ACTION_NOTIFICATION_REPLY_SUBMITTED,
            f.CODEX_AVATAR_OVERLAY_SOURCE_NOTIFICATION_REPLY,
            e,
          ),
          await d(`send-follow-up-message`, {
            conversationId: e.replyTarget.conversationId,
            prompt: i,
            serviceTier: await fe(p, p.get(r, e.replyTarget.conversationId) ?? `local`, null),
          }));
      }),
      (t[66] = p),
      (t[67] = G),
  ...
  t[82] === q
    ...
    : ((Kt = () => {
      ...
      (t[83] = Kt));
  let qt;
  (t[84] !== Ee || t[85] !== q || t[86] !== o.id
    ? ((qt = [q, o.id, Ee]), (t[84] = Ee), (t[85] = q), (t[86] = o.id), (t[87] = qt))
    : (qt = t[87]),
  ...
  t[88] === q
    ...
    : ((Jt = () => {
      ...
      (t[89] = Jt));
  let Yt;
  (t[90] !== D || t[91] !== N || t[92] !== Ee || t[93] !== q || t[94] !== o.id
    ? ((Yt = [D, q, o.id, Ee, N]),
      (t[90] = D),
      (t[91] = N),
      (t[92] = Ee),
    ...
    : ((rn = [
        {
          ...
          onSelect: () => {
            (G(
              ...
              f.CODEX_AVATAR_OVERLAY_SOURCE_CONTEXT_MENU,
            ),
  ...
  t[121] === G
    ...
    : ((vn = () => {
        (G(
          ...
          f.CODEX_AVATAR_OVERLAY_SOURCE_NOTIFICATION_BADGE,
          void 0,
          !1,
        ),
          O(!1));
  ...
  t[123] === G
    ...
    : ((An = (e) => {
        G(
          n.CODEX_AVATAR_OVERLAY_ACTION_NOTIFICATION_REPLY_OPENED,
          f.CODEX_AVATAR_OVERLAY_SOURCE_NOTIFICATION_REPLY,
          e,
        );
      }),
