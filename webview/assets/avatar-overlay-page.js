...
import { n as T, r as E } from "./product-logger.js";
import "./rpc.js";
import { o as ne } from "./statsig.js";
import "./request.js";
import { c as D } from "./app-server-manager-hooks-DfDI-9lO.js";
...
import "./use-auth.js";
import { E as re } from "./codex-api-B.js";
import "./_baseEach.js";
...
import { t as pe } from "./bullet-separator.js";
import { t as P } from "./is-subagent-conversation-Tg4-cSB_.js";
import { t as me } from "./avatar-overlay-analytics.js";
import { i as he } from "./codex-avatar.js";
import { t as F } from "./avatar-mascot-button.js";
...
function H({ axis: e, debounce: t, initialSize: n = !0, onChange: r, target: i }) {
...
function Oe(e, t) {
  ...
  return r == null
    ...
    : {
        ...
        turnId: e.turnId,
        actions: [
          { intent: `plan-start`, label: t.formatMessage(U.implementPlan), tone: `primary` },
        ],
      };
}
function ke(e, t) {
  ...
  switch (n.kind) {
    ...
    case `toolSuggestion`: {
      let e = q(n.suggestion.tool_name) ?? Re(n.suggestion.tool_id) ?? t.formatMessage(U.tool);
      ((o =
    ...
    case `connectorAuth`: {
      let e = q(n.connector.connector_name) ?? Re(n.connector.connector_id) ?? a,
    ...
    case `urlAction`:
      ((s = Re(n.serverName) ?? q(n.serverName) ?? a),
        ...
        (l = [{ intent: `open`, label: t.formatMessage(U.openLink), tone: `primary` }]));
      break;
    case `generic`:
      ((o =
...
function Ke({ includeCompactWaitingRequests: e, intl: t, localConversations: n, remoteTasks: r }) {
  let i = [],
    a = new Set();
  for (let r of n) {
...
function $e(e) {
  let t = e.resumeState === `needs_resume` ? e.threadRuntimeStatus : null,
    ...
    i = e.turns.some((e) => e.items.some((e) => e.type === `planImplementation` && !e.isCompleted)),
    a =
      e.resumeState === `needs_resume`
        ? t?.type === `systemError`
          ...
          ne
            ? (0, Z.jsx)(`div`, {
                ...
                children: (0, Z.jsxs)(j.div, {
                  animate: { opacity: D ? 1 : 0, scale: D || T ? 1 : 0.97, y: D || T ? 0 : 8 },
          ...
          (0, Z.jsx)(le, {
            ...
            children: (0, Z.jsx)(`div`, {
              ...
              children: (0, Z.jsx)(F, {
                ...
                notificationBadge: A,
                resizeHandle:
                  l == null ? void 0 : { ariaLabel: w.formatMessage(Q.resizeMascot), ...l },
                state: E.mascotState,
                style: s,
                transientState: c,
              }),
...
function lt(e) {
  let t = (0, R.c)(69),
    ...
    p = (0, z.useRef)(null),
    m;
  t[0] !== f || t[1] !== r ? ((m = He(r, f)), (t[0] = f), (t[1] = r), (t[2] = m)) : (m = t[2]);
  let h = m,
    g = r.length > $,
  ...
  let [b, x] = (0, z.useState)(y),
    ...
    T;
  t[4] !== r || t[5] !== S
    ? ((T = r.some((e) => e.id === S) ? S : null), (t[4] = r), (t[5] = S), (t[6] = T))
    : (T = t[6]);
  let E = T,
    ne = E != null && n,
    D,
  ...
  t[19] === u
    ...
    : ((pe = () => {
        let e = p.current;
        e != null && (e.scrollTo({ behavior: u ? `auto` : `smooth`, top: 0 }), x(Ct(e, 0)));
      }),
      (t[19] = u),
      (t[20] = pe));
  let P = pe,
  ...
  t[24] !== oe || t[25] !== u || t[26] !== P
    ? ((F = oe ? (0, Z.jsx)(ut, { prefersReducedMotion: u, onClick: P }, `latest`) : null),
      (t[24] = oe),
      (t[25] = u),
      (t[26] = P),
      (t[27] = F))
    : (F = t[27]);
  let I;
  t[28] === F ? (I = t[29]) : ((I = (0, Z.jsx)(ae, { children: F })), (t[28] = F), (t[29] = I));
  let ge = n ? 1 : 0,
    _e = n || u ? 0 : 3,
    L;
  t[30] !== ge || t[31] !== _e
    ...
    : (L = t[32]);
  let B;
  t[33] === f ? (B = t[34]) : ((B = f.formatMessage(Q.notificationList)), (t[33] = f), (t[34] = B));
  ...
  t[35] === ve
    ...
    : ((ye = v(
      ...
      (t[36] = ye));
  let be;
  t[37] === d ? (be = t[38]) : ((be = { maxHeight: d }), (t[37] = d), (t[38] = be));
  let xe;
  t[39] === u
    ? (xe = t[40])
    : ((xe = u ? { duration: 0 } : { duration: 0.16, ease: `easeOut` }), (t[39] = u), (t[40] = xe));
  let Se;
  ...
  t[49] !== u
    ...
    : (V = t[50]);
  let H;
  t[51] !== L || t[52] !== B || t[53] !== ye || t[54] !== be || t[55] !== xe || t[56] !== V
    ? ((H = (0, Z.jsx)(j.div, {
        ref: ue,
        animate: L,
        "aria-label": B,
  ...
  t[58] !== se || t[59] !== k || t[60] !== u || t[61] !== he
    ? ((U = se
        ? (0, Z.jsx)(dt, { count: k, prefersReducedMotion: u, onClick: he }, `older`)
        : null),
      (t[58] = se),
      (t[59] = k),
      (t[60] = u),
    ...
    : (U = t[62]);
  let W;
  t[63] === U ? (W = t[64]) : ((W = (0, Z.jsx)(ae, { children: U })), (t[63] = U), (t[64] = W));
  let G;
  return (
    t[65] !== I || t[66] !== H || t[67] !== W
      ? ((G = (0, Z.jsxs)(`div`, { className: `relative`, children: [I, H, W] })),
        (t[65] = I),
        (t[66] = H),
        (t[67] = W),
        (t[68] = G))
...
function pt({
  ...
  let F = le > me + at || de,
    ...
    L = O.trim(),
    R = u ? { duration: 0 } : { duration: M ? 0.2 : 0.28, ease: [0.16, 1, 0.3, 1] },
    B = async (e) => {
      if ((e.preventDefault(), e.stopPropagation(), !(!ge || L.length === 0 || D))) {
        (re(!0), oe(null));
        try {
          (await l(t, L), A(``), i());
        } catch {
    ...
    children: (0, Z.jsxs)(`div`, {
      ...
      children: [
        (0, Z.jsxs)(j.div, {
          ...
          onKeyDown: (e) => {
            !T || (e.key !== `Enter` && e.key !== ` `) || (e.preventDefault(), o?.(t));
          },
          children: [
            (0, Z.jsx)(`span`, {
        ...
        (0, Z.jsx)(`span`, {
          role: `img`,
          "aria-label": b?.kind === `question` ? f.formatMessage(Q.questionStatusIcon) : _,
          className: v(
            `pointer-events-none absolute top-1 right-1 z-0 flex size-6 items-center justify-center opacity-100`,
            F && M && `opacity-0 transition-opacity duration-150 motion-reduce:transition-none`,
          ),
          children: b?.kind === `question` ? (0, Z.jsx)(_e, { className: g.iconClassName }) : Mt(g),
        }),
        F
          ? (0, Z.jsx)(j.div, {
              ...
              children: (0, Z.jsx)(ie, {
                ...
                children: (0, Z.jsx)(k, {
                  ...
                  size: `icon`,
                  "aria-expanded": E,
                  "aria-label": f.formatMessage(E ? Q.collapseNotification : Q.expandNotification, {
                    title: t.title,
                  }),
                  onClick: () => {
                    ne((e) => !e);
                ...
                (0, Z.jsxs)(`div`, {
                  ...
                  children: [
                    (0, Z.jsx)(`input`, {
                      ...
                      onKeyDown: (e) => {
                        e.key !== `Escape` || D || (e.stopPropagation(), i(), oe(null));
                      },
                    }),
                    (0, Z.jsx)(k, {
          ...
          ? (0, Z.jsx)(j.div, {
              ...
              children: (0, Z.jsx)(ie, {
                ...
                children: (0, Z.jsx)(k, {
                  ...
                  color: `outline`,
                  size: `icon`,
                  "aria-label": f.formatMessage(Q.dismissNotification, { title: t.title }),
                  onClick: () => {
                    r(t);
                  },
  ...
  switch (o.kind) {
    case `question`: {
      ...
      t[4] !== o.prompt || t[5] !== r
        ...
        : (s = t[6]);
      let c;
      t[7] === o.options ? (c = t[8]) : ((c = o.options.map(ht)), (t[7] = o.options), (t[8] = c));
      let l;
      t[9] !== i || t[10] !== a
        ? ((l = (e) => {
    ...
    case `patch`: {
      ...
      t[25] !== o.actions || t[26] !== c
        ? ((r = (0, Z.jsx)(bt, { actions: o.actions, onRunNotificationAction: c })),
          (t[25] = o.actions),
          (t[26] = c),
          (t[27] = r))
        : (r = t[27]);
    ...
    case `tool`: {
      let e = o.summary ?? o.target,
        r;
      t[63] !== n || t[64] !== e
        ? ((r = (0, Z.jsx)(_t, { isExpanded: n, text: e })), (t[63] = n), (t[64] = e), (t[65] = r))
        : (r = t[65]);
      let i;
      t[66] !== o.actions || t[67] !== c
        ? ((i = (0, Z.jsx)(bt, { actions: o.actions, onRunNotificationAction: c })),
          (t[66] = o.actions),
          (t[67] = c),
          (t[68] = i))
        : (i = t[68]);
...
function vt(e) {
  ...
  if (!o) {
    ...
    let i;
    t[15] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, Z.jsx)(pe, { className: `mx-1.5 text-token-text-tertiary` })), (t[15] = i))
      : (i = t[15]);
    let a;
    t[16] === s
      ? (a = t[17])
...
function Rt() {
  let e = (0, R.c)(7),
    [n, r] = t(Lt),
    i;
  e[0] === n ? (i = e[1]) : ((i = n == null ? null : Bt(n)), (e[0] = n), (e[1] = i));
  let a;
  e[2] === r
    ? (a = e[3])
    : ((a = (e) => {
  ...
  return (
    e[4] !== i || e[5] !== a
      ? ((o = { mascotWidthPx: i, setMascotWidthPx: a }), (e[4] = i), (e[5] = a), (e[6] = o))
      : (o = e[6]),
    o
  );
}
...
function pn() {
  let e = (0, R.c)(9),
    ...
    o;
  e[0] !== i || e[1] !== a ? ((o = En(i, a)), (e[0] = i), (e[1] = a), (e[2] = o)) : (o = e[2]);
  let s;
  return (
...
function mn(e) {
  ...
  let { data: L, refetch: B } = re(_e),
    ...
    ye = P == null ? null : qt({ intl: f, petName: P.petName, startedAtMs: P.startedAtMs }),
    ...
    je = (0, z.useRef)(!1),
    Me;
  t[4] !== W || t[5] !== G || t[6] !== C || t[7] !== H.length || t[8] !== g || t[9] !== u
    ? ((Me = (e, t, n, r) => {
        let i = r === void 0 ? C : r;
  ...
  (t[20] !== g || t[21] !== K
    ? ((Le = () => {
        je.current ||
          (g !== T &&
            ((je.current = !0),
            K(r.CODEX_AVATAR_OVERLAY_ACTION_OPENED, m.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
      }),
      (Re = [g, K]),
      (t[20] = g),
      (t[21] = K),
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = () => {
        (Te.current != null && (window.cancelAnimationFrame(Te.current), (Te.current = null)),
          (Ee.current = null));
      }),
      (t[29] = Ue))
    : (Ue = t[29]);
          ...
          (Te.current ??= window.requestAnimationFrame(() => {
            ...
            ((Ee.current = null),
              !(e == null || we.current == null) &&
                w.dispatchMessage(`avatar-overlay-mascot-resize-move`, { width: e }));
          })));
      }),
      (t[30] = Ge))
    : (Ge = t[30]);
  ...
  t[33] === N
    ? (Ye = t[34])
    : ((Ye = () => jn(ke.current?.querySelector(an) ?? null)?.width ?? N ?? 112),
      (t[33] = N),
      (t[34] = Ye));
  let Xe = Ye,
    Ze;
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ze = (e, t) => {
        ...
        n == null ||
          n.pointerId !== e ||
          ((we.current = null), j(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
      }),
      (t[35] = Ze))
    : (Ze = t[35]);
  let Qe = Ze,
  ...
  t[39] === K
    ...
    : ((Q = (e, t) => {
        ...
        (ke.current?.hasPointerCapture?.(e) && ke.current.releasePointerCapture?.(e),
          i &&
            a.startedOnMascot &&
            !a.hasMoved &&
            (K(r.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, m.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
            w.dispatchMessage(`open-current-main-window`, {})),
          w.dispatchMessage(`avatar-overlay-drag-end`, {}),
          a.hasMoved &&
            K(r.CODEX_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED, m.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          o != null &&
            w.dispatchMessage(`avatar-overlay-drag-release`, { velocityX: o.x, velocityY: o.y }));
      }),
      (t[39] = K),
      (t[40] = Q));
  let $ = Q,
  ...
  t[49] === Xe
    ...
    : ((dt = (e) => {
        ...
        (J(),
          ...
          M(t),
          j(!0),
          w.dispatchMessage(`avatar-overlay-mascot-resize-start`, { width: t }));
      }),
      (t[49] = Xe),
      (t[50] = dt));
  let ft = dt,
    ...
    : ((At = (e) => {
        ...
        (v(t),
          De.current === t.mascot.width &&
            ((De.current = null), J(), M(null), window.requestAnimationFrame(q)));
      }),
      (jt = [J, q]),
      (t[67] = q),
      (t[68] = At),
  ...
  (t[76] !== X || t[77] !== $
    ? ((Lt = () => {
        let e = (e) => {
          ...
          t = (e) => {
            ($(e.pointerId, { shouldOpenMainWindow: !1 }), X(e.pointerId), Qe(e.pointerId));
          };
        return (
  ...
  (t[82] !== U || t[83] !== q || t[84] !== u.id
    ? ((Ht = [q, u.id, U]), (t[82] = U), (t[83] = q), (t[84] = u.id), (t[85] = Ht))
    : (Ht = t[85]),
  ...
  t[106] !== A || t[107] !== _.mascot || t[108] !== se
    ? (($t = A && se != null ? { ..._.mascot, height: Math.ceil(se / Nt), width: se } : _.mascot),
      (t[106] = A),
      (t[107] = _.mascot),
      (t[108] = se),
      (t[109] = $t))
...
function _n() {
  (document.documentElement.classList.remove(un), document.body.classList.remove(un));
}
function vn(e) {
  w.dispatchMessage(`avatar-overlay-keyboard-interaction-changed`, { isInteractive: e });
}
function yn(e) {
  w.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: e });
}
function bn(e) {
