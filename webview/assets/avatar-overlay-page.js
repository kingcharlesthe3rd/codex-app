...
import { Kg as Se, bp as Ce, qg as we, yp as Te } from "./app-initial~app-main~onboarding-page.js";
import { nn as Ee, tn as De } from "./app-initial~app-main~automations-page.js";
import { n as Oe, t as ke } from "./avatar-mascot-button.js";
import {
  a as J,
  o as Ae,
...
import { n as tt, t as nt } from "./avatar-overlay-debug-state-Dz-uULi-.js";
import {
  a as rt,
  c as it,
  d as at,
...
function mt({
  ...
  let T = p(),
    ...
    O = f.length > 0,
    ne = o?.phase ?? `inactive`,
    k = Fe(o?.isSessionActive ?? !1, ne !== `inactive`),
    re = k === `voice-orb`,
    j = k === `hidden`,
    M = k === `pet` ? c : { ...c, height: 121, width: 112 },
    N = O && a;
  o?.controlsHovered;
  let P = o?.caption ?? null,
    F = N || P != null,
    I = O || F,
    L = s.placement.startsWith(`top`),
    R = s.placement.endsWith(`end`),
    oe = f.length > Bt,
    se = s.tray == null ? void 0 : Math.max(0, s.tray.height),
    ce = `${L ? `bottom` : `top`} ${R ? `right` : `left`}`,
    z;
  N
    ? (z = {
  ...
  let V = (0, Z.jsx)(ke, {
    ...
    notificationBadge: z,
    resizeHandle: d == null ? void 0 : { ariaLabel: T.formatMessage(Q.resizeMascot), ...d },
    state: D.mascotState,
    style: l,
    transientState: u,
  });
        ...
        (0, Z.jsx)(ae, {
          ...
          children: (0, Z.jsx)(`div`, {
            ...
            className: B(
              ...
              i && !re ? `scale-95 transition-transform` : `transition-none`,
            ),
            style: { height: M.height, left: M.left, top: M.top, width: M.width },
            children: V,
          }),
        }),
      ],
...
function ht(e) {
  let t = (0, Y.c)(67),
    ...
    _ = (0, X.useRef)(null),
    v;
  t[0] !== g || t[1] !== a ? ((v = lt(a, g)), (t[0] = g), (t[1] = a), (t[2] = v)) : (v = t[2]);
  let y = v,
    x = m == null ? `` : `caption`,
    S = r ? `tray-above` : `tray-below`,
    ee;
  t[3] !== y || t[4] !== x || t[5] !== S
    ? ((ee = [y, x, S]), (t[3] = y), (t[4] = x), (t[5] = S), (t[6] = ee))
    : (ee = t[6]);
  let C = ee.join(`\0`),
    w = a.length > Bt,
    te = Math.max(0, a.length - Bt),
    T;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = {
      ...
      (t[7] = T))
    : (T = t[7]);
  let [E, D] = (0, X.useState)(T),
    [O, ne] = (0, X.useState)(null),
    k = (0, X.useRef)(null),
    re;
  t[8] !== a || t[9] !== O
    ? ((re = a.some((e) => e.id === O) ? O : null), (t[8] = a), (t[9] = O), (t[10] = re))
    : (re = t[10]);
  let j = re,
    M = j != null && n,
    N,
  ...
  (t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = () => {
      ...
      (t[16] = F))
    : ((P = t[15]), (F = t[16])),
    b(`avatar-overlay-keyboard-interaction-ready`, F, P));
  let I = Math.min(E.hiddenOlderNotificationCount, te),
    L = E.hasScrollableContent,
    R = n && L && w && E.hasLatestNotificationsAbove,
    ae = n && L && w && I > 0,
    oe = n && L && w,
    se = n && L,
    ce = a.length > 0,
  ...
  let he;
  (t[26] !== C || t[27] !== h
    ? ((he = [C, h, de]), (t[26] = C), (t[27] = h), (t[28] = he))
    : (he = t[28]),
  ...
  t[29] === f
    ...
    : ((ge = () => {
        let e = _.current;
        e != null && (e.scrollTo({ behavior: f ? `auto` : `smooth`, top: 0 }), D(At(e, 0)));
      }),
      (t[29] = f),
      (t[30] = ge));
  let _e = ge,
  ...
  t[31] !== I || t[32] !== f
    ? ((ve = () => {
        ...
        if (e == null) return;
        let t = yt(e, I);
        (e.scrollTo({ behavior: f ? `auto` : `smooth`, top: t }), D(At(e, t)));
      }),
      (t[31] = I),
      (t[32] = f),
      (t[33] = ve))
  ...
  t[34] === be
    ? (G = t[35])
    : ((G = B(`relative flex w-full min-w-0 flex-col overflow-hidden`, be)),
      (t[34] = be),
      (t[35] = G));
  let K;
  t[36] !== z || t[37] !== h
    ? ((K = z ? { height: h, maxHeight: h } : void 0), (t[36] = z), (t[37] = h), (t[38] = K))
    : (K = t[38]);
  let xe = r ? null : le,
    q;
  t[39] !== j ||
    ...
    ? ((q = ce
        ? (0, Z.jsxs)(A.div, {
            ...
            children: [
              (0, Z.jsx)(me, {
                children: R
                  ? (0, Z.jsx)(_t, { prefersReducedMotion: f, onClick: _e }, `latest`)
                  : null,
              }),
              (0, Z.jsx)(A.div, {
                ref: pe,
              ...
              (0, Z.jsx)(me, {
                children: ae
                  ? (0, Z.jsx)(vt, { count: I, prefersReducedMotion: f, onClick: ye }, `older`)
                  : null,
              }),
            ],
          })
...
function gt(e) {
  ...
  t[4] === l
    ? (u = t[5])
    : ((u = B(`no-drag w-full min-w-0 shrink-0 overflow-hidden px-1.5 text-left`, l)),
      (t[4] = l),
      (t[5] = u));
  let d;
...
function _t(e) {
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = B(qt, `top-1 min-w-12`)), (t[9] = f))
    : (f = t[9]);
  let m;
  t[10] === r ? (m = t[11]) : ((m = r ? void 0 : { scale: 1.03 }), (t[10] = r), (t[11] = m));
  let h;
  t[12] === r ? (h = t[13]) : ((h = r ? void 0 : { scale: 0.96 }), (t[12] = r), (t[13] = h));
  let g;
  t[14] === i
    ? (g = t[15])
    : ((g = i.formatMessage(Q.latestNotifications)), (t[14] = i), (t[15] = g));
  let _;
  t[16] === g ? (_ = t[17]) : ((_ = (0, Z.jsx)(`span`, { children: g })), (t[16] = g), (t[17] = _));
  let v;
...
function vt(e) {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = B(qt, `bottom-1 min-w-9`)), (t[10] = m))
    : (m = t[10]);
  let h;
  t[11] === i ? (h = t[12]) : ((h = i ? void 0 : { scale: 1.03 }), (t[11] = i), (t[12] = h));
  let g;
...
function bt({
  ...
  let d = p(),
    ...
    m = te(be, f),
    h = m == null ? null : Ie(m.items, d),
    g = Re(t),
    _ = d.formatMessage(g.labelMessage),
    v = h ?? t.body ?? d.formatMessage(g.fallbackBodyMessage),
    y = t.waitingRequest,
    b = y == null ? v : He(y, d),
    x = b.replace(/[.?!]+$/, ``),
    S = b === _ ? _ : `${_}. ${x}`,
    ee =
      t.action == null
        ? `${t.title}. ${S}`
        : `${t.title}. ${S}. ${d.formatMessage(Q.openNotification)}`,
    C = t.action != null,
    w = t.kind !== `activity` && r != null,
    [T, E] = (0, X.useState)(!1),
    [D, O] = (0, X.useState)(!1),
    [ne, k] = (0, X.useState)(``),
    [re, j] = (0, X.useState)(null),
    [M, N] = (0, X.useState)(!1),
    [ie, P] = (0, X.useState)(0),
    [F, L] = (0, X.useState)(!1),
    R = (0, X.useRef)(T),
    ae = (0, X.useRef)(void 0),
    se = y == null ? Ut : Wt,
    ce = (0, X.useCallback)((e) => {
      if ((ae.current?.(), (ae.current = void 0), e == null)) return;
      let t = () => {
      ...
      (t(), (ae.current = Ye({ axis: `both`, target: e, onChange: t })));
    }, []);
  (0, X.useLayoutEffect)(() => {
    R.current = T;
  }, [T]);
  let z = ie > se + Kt || F,
    ...
    le = ne.trim(),
    ue = l ? { duration: 0 } : { duration: M ? 0.2 : 0.28, ease: [0.16, 1, 0.3, 1] },
    de = async (e) => {
      if ((e.preventDefault(), e.stopPropagation(), !(!H || le.length === 0 || D))) {
        (O(!0), j(null));
        try {
          (await c(t, le), k(``), i());
        } catch {
          j(d.formatMessage(Q.notificationReplyError));
        } finally {
          O(!1);
        }
      }
        ...
        children: [
            ...
            children: [
              ...
              (0, Z.jsx)(A.div, {
                ...
                className: B(
                  ...
                  V ? `whitespace-pre-wrap` : y == null ? `line-clamp-2` : void 0,
                ),
          ...
          (0, Z.jsx)(`span`, {
            ...
            className: B(
              ...
              z && M && `opacity-0 transition-opacity duration-150 motion-reduce:transition-none`,
            ),
            children:
              y?.kind === `question` ? (0, Z.jsx)(Me, { className: g.iconClassName }) : zt(g),
          }),
          z
            ? (0, Z.jsx)(A.div, {
                ...
                children: (0, Z.jsx)(U, {
                  ...
                  tooltipContent: d.formatMessage(
                    T ? Q.collapseNotificationTooltip : Q.expandNotificationTooltip,
                  ),
                  children: (0, Z.jsx)(oe, {
                    className: B(`size-6`, Jt),
                    color: `ghost`,
                    size: `icon`,
                    "aria-expanded": T,
                    ...
                    children: (0, Z.jsx)(A.span, {
                      ...
                      transition: l ? { duration: 0 } : { duration: 0.12, ease: `easeOut` },
                      children: (0, Z.jsx)(I, { className: `icon-xs` }),
                    }),
                  }),
                }),
              })
                  ...
                  (0, Z.jsxs)(`div`, {
                    ...
                    children: [
                      (0, Z.jsx)(`input`, {
                        ...
                        onKeyDown: (e) => {
                          e.key !== `Escape` || D || (e.stopPropagation(), i(), j(null));
                        },
                      }),
                      (0, Z.jsx)(oe, {
  ...
  switch (o.kind) {
    case `question`: {
      let e = n ? `break-words whitespace-pre-wrap` : `truncate`,
        r;
      t[2] === e ? (r = t[3]) : ((r = B(`min-w-0`, e)), (t[2] = e), (t[3] = r));
      let s;
      t[4] !== o.prompt || t[5] !== r
        ...
        : (s = t[6]);
      let c;
      t[7] === o.options ? (c = t[8]) : ((c = o.options.map(St)), (t[7] = o.options), (t[8] = c));
      let l;
      t[9] !== i || t[10] !== a
        ? ((l = (e) => {
      ...
      let u;
      t[12] !== c || t[13] !== l
        ? ((u = (0, Z.jsx)(Dt, { actions: c, onRunNotificationAction: l })),
          (t[12] = c),
          (t[13] = l),
          (t[14] = u))
        : (u = t[14]);
    ...
    case `patch`: {
      ...
      t[25] !== o.actions || t[26] !== c
        ? ((r = (0, Z.jsx)(Dt, { actions: o.actions, onRunNotificationAction: c })),
          (t[25] = o.actions),
          (t[26] = c),
          (t[27] = r))
        : (r = t[27]);
    ...
    case `exec`: {
      ...
      t[36] !== n || t[37] !== o.summary
        ? ((e = (0, Z.jsx)(wt, { isExpanded: n, text: o.summary })),
          (t[36] = n),
          (t[37] = o.summary),
          (t[38] = e))
        : (e = t[38]);
    ...
    case `network`: {
      ...
      t[45] !== n || t[46] !== o.target
        ? ((e = (0, Z.jsx)(wt, { isExpanded: n, text: o.target })),
          (t[45] = n),
          (t[46] = o.target),
          (t[47] = e))
        : (e = t[47]);
    ...
    case `tool`: {
      ...
      t[66] !== o.actions || t[67] !== c
        ? ((i = (0, Z.jsx)(Dt, { actions: o.actions, onRunNotificationAction: c })),
          (t[66] = o.actions),
          (t[67] = c),
          (t[68] = i))
        : (i = t[68]);
...
function wt(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = B(`min-w-0 text-token-text-secondary`, i)), (t[0] = i), (t[1] = a));
  let o;
  return (
    t[2] !== a || t[3] !== r
      ? ((o = (0, Z.jsx)(`div`, {
...
function Tt(e) {
  ...
  let f = d,
    m;
  t[6] !== r || t[7] !== c
    ? ((m = r > 0 ? c.formatMessage(Q.compactPatchDeletions, { count: r }) : null),
      (t[6] = r),
      (t[7] = c),
      (t[8] = m))
    : (m = t[8]);
  ...
  if (!o) {
    ...
    t[13] === h
      ...
      : ((r =
          h == null
            ? null
            : (0, Z.jsx)(`span`, { className: `ml-1.5 text-token-error-foreground`, children: h })),
        (t[13] = h),
        (t[14] = r));
    let i;
    t[15] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  t[29] !== g || t[30] !== _ || t[31] !== v
    ...
    : (y = t[32]);
  let b;
  t[33] === a ? (b = t[34]) : ((b = a.map(Et)), (t[33] = a), (t[34] = b));
  let x;
  t[35] === b
    ? (x = t[36])
    : ((x = (0, Z.jsx)(`div`, {
...
function zt(e) {
  switch (e.iconType) {
    ...
    case `spinner`:
      return (0, Z.jsx)(le, { className: e.iconClassName });
    case `warning`:
...
function Xt() {
  ...
  if (
    (e[0] === r
      ...
      : ((i = () => {
          r &&
            a.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: !1 });
        }),
        (o = [r]),
        (e[0] = r),
        (e[1] = i),
    ...
    return null;
  let s;
  e[3] !== t || e[4] !== n ? ((s = en(t, n)), (e[3] = t), (e[4] = n), (e[5] = s)) : (s = e[5]);
  let c;
  return (
    e[6] !== t || e[7] !== n || e[8] !== s
...
function Zt({ selectedAvatar: e, selectedAvatarId: t }) {
  let n = C(c),
    ...
    u = E(nt),
    d = hn,
    f = d.phase !== `inactive` && !0;
  te(be, void 0);
  let { data: m } = ee({ enabled: f, hostId: void 0 }),
    h = f,
    [x, S] = (0, $.useState)(En),
    [T, ne] = (0, $.useState)(null),
    [k, A] = (0, $.useState)(!0),
    [re, M] = (0, $.useState)(!1),
    [N, ie] = (0, $.useState)(!1),
    [P, F] = (0, $.useState)(!1),
    [I, L] = (0, $.useState)(null),
    { mascotWidthPx: R, setMascotWidthPx: ae } = Ke(),
    [oe, se] = (0, $.useState)(() => new Map()),
    [ce, B] = (0, $.useState)(() => Date.now()),
    [V] = (0, $.useState)(() => $t(e, t)),
    { data: H = [], refetch: U } = l(),
    { data: le = [], refetch: ue } = g({ taskFilter: `current`, limit: 20 }),
    de = Je({
    ...
    fe = V == null ? null : ut({ intl: r, petName: V.petName, startedAtMs: V.startedAtMs }),
    pe = [],
    { nextNotificationExpiresAtMs: me, notifications: W } = ot({
      dismissedNotificationTurnKeys: oe,
      extraNotifications: f ? [...[], ...pe] : fe == null ? [] : [fe],
      nowMs: ce,
      sessions: f ? [] : de,
    }),
    he = lt(W, r),
    _e = de.some((e) => e.source !== `cloud` && e.status === `running`),
    K = de.some((e) => e.source === `cloud` && e.status === `running`),
    xe = (0, $.useRef)(null),
    q = (0, $.useRef)(null),
    Se = (0, $.useRef)(null),
    we = (0, $.useRef)(null),
  ...
  ((0, $.useEffect)(() => {
    if (V == null) return;
    let e = j(mn, []);
    e.includes(V.avatarId) || ye(mn, [...e, V.avatarId]);
  }, [V]),
    (0, $.useEffect)(() => {
      ke.current ||
        (s !== _ &&
          ((ke.current = !0),
          J(O.CODEX_AVATAR_OVERLAY_ACTION_OPENED, G.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
    }, [s, J]),
    $e({
      interactiveRegionRef: De,
      isPaused: () => xe.current != null || q.current != null,
      onInteractiveChange: (e) => {
        a.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: e });
      },
      regionElementSelectors: gn,
    }));
  let Ae = (0, $.useCallback)(() => {
      if (q.current != null || Te.current != null) return;
      let e = nn(De.current);
      if (e == null) return;
      let t = { ...e, isTrayVisible: (k && W.length > 0) || d.caption != null };
      cn(Oe.current, t) ||
        ((Oe.current = t),
        ...
        (Se.current ??= window.requestAnimationFrame(() => {
          ...
          ((we.current = null),
            !(e == null || q.current == null) &&
              a.dispatchMessage(`avatar-overlay-mascot-resize-move`, { width: e }));
        })));
    }, []),
    Fe = (0, $.useCallback)(
      (e) => {
        ((Te.current = e),
          ...
          (Ee.current = window.setTimeout(() => {
            ((Ee.current = null), (Te.current = null), L(null), Ae());
          }, 100)));
      },
      [je, Ae],
    ),
    Ie = (0, $.useCallback)(
      () => an(De.current?.querySelector(_n) ?? null)?.width ?? R ?? 112,
      [R],
    ),
    Le = (0, $.useCallback)((e, t) => {
      ...
      n == null ||
        n.pointerId !== e ||
        ((q.current = null), ie(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
    }, []),
    Re = (0, $.useCallback)(
      (e, t) => {
        let n = q.current;
    ...
    ze = (0, $.useCallback)(
      (e, { releaseSample: t, shouldPreserveOrbMomentum: n = !1, shouldOpenMainWindow: r }) => {
        ...
        ((xe.current = null), M(!1), ne(null));
        let { hasMoved: o, releaseSample: s, velocity: c } = it(i, t, n && i.usesOrbPhysics);
        if (
          (De.current?.hasPointerCapture?.(e) && De.current.releasePointerCapture?.(e),
          o &&
            !i.hasMoved &&
            s != null &&
          ...
          r &&
            i.startedOnMascot &&
            !o &&
            (J(O.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, G.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          ...
          o &&
            J(O.CODEX_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED, G.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          c != null)
        ) {
    ...
    He = (e) => {
      ze(e.pointerId, { releaseSample: st(e), shouldOpenMainWindow: !0 });
    },
    Ue = (e) => {
      ze(e.pointerId, { shouldPreserveOrbMomentum: !0, shouldOpenMainWindow: !1 });
    },
    We = (e) => {
      ze(e.pointerId, { shouldPreserveOrbMomentum: !0, shouldOpenMainWindow: !1 });
    },
          ...
          case `mcp-elicitation`:
            if (t.mcpElicitationAction != null && r?.kind === `tool`) {
              w(`reply-with-mcp-server-elicitation-response`, {
                conversationId: i,
                requestId: r.requestId,
                response: D(t.mcpElicitationAction),
              }).then(() => {
                U();
              });
              return;
          ...
          case `plan-start`:
            if (r?.kind === `plan` && t.planStartCollaborationMode != null) {
              w(`update-thread-settings-for-next-turn`, {
                ...
                .then(() =>
                  w(`remove-plan-implementation-request`, { conversationId: i, turnId: r.turnId }),
                )
                .then(async () =>
                  w(`send-follow-up-message`, {
                    conversationId: i,
                    prompt: `${z}\n${r.planContent}`,
                    serviceTier: await Ce(
                      n,
                      n.get(ge, i) ?? `local`,
    ...
    ct = async (e, t) => {
      ...
      r.length !== 0 &&
        ...
        await w(`send-follow-up-message`, {
          ...
          prompt: r,
          serviceTier: await Ce(n, n.get(ge, e.controlTarget.conversationId) ?? `local`, null),
        }));
    },
    dt = (0, $.useCallback)((e) => {
      a.dispatchMessage(`avatar-overlay-keyboard-interaction-changed`, { isInteractive: e });
    }, []);
  return (
    b(
      ...
      ({ layout: e }) => {
        (S(e),
          Te.current === e.mascot.width &&
            ((Te.current = null), je(), L(null), window.requestAnimationFrame(Ae)));
      },
      [je, Ae],
    ),
    (0, $.useLayoutEffect)(() => {
    ...
    (0, $.useEffect)(() => {
      ...
      let e = window.setTimeout(() => {
        (B((e) => Math.max(Date.now(), e + 1)), _e && U(), K && ue());
      }, pn);
      return () => {
    ...
    (0, fn.jsx)(mt, {
      ...
      mascotDragState: T,
      mascotLayout:
        N && I != null ? { ...x.mascot, height: Math.ceil(I / Ge), width: I } : x.mascot,
...
function $t(e, t) {
  return Ee(e, t) || j(mn, []).includes(e.id)
    ? null
    : { avatarId: e.id, petName: e.displayName, startedAtMs: Date.now() };
}
function en(e, t) {
  return Ee(e, t) ? `pending-custom-avatar` : `ready`;
}
