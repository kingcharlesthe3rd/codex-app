...
import { n as Ce, t as we } from "./avatar-mascot-button.js";
import {
  vn as Te,
  yn as Ee,
...
function pt({
  ...
  let S = xe(),
    ...
    T = d.length > 0,
    E = a?.phase ?? `inactive`,
    re = Pe(a?.isSessionActive ?? !1, E !== `inactive`),
    ie = re === `voice-orb`,
    k = re === `hidden`,
    j = re === `pet` ? s : { ...s, height: 121, width: 112 },
    M = T && i;
  a?.controlsHovered;
  let N = a?.caption ?? null,
    P = M || N != null,
    F = T || P,
    L = o.placement.startsWith(`top`),
    oe = o.placement.endsWith(`end`),
    R = d.length > Bt,
    z = o.tray == null ? void 0 : Math.max(0, o.tray.height),
    B = `${L ? `bottom` : `top`} ${oe ? `right` : `left`}`,
    V;
  M
    ? (V = {
        ariaLabel: S.formatMessage(Q.collapseNotificationTray),
        backgroundColor: `var(--color-token-bg-primary)`,
        content: (0, Z.jsx)(O, { className: `icon-xs opacity-80` }),
  ...
  let H = (0, Z.jsx)(we, {
    ariaLabel: S.formatMessage(Q.mascotLabel, { petName: e.displayName }),
    assetRef: e.assetRef,
    spritesheetUrl: e.spritesheetUrl,
    notificationBadge: V,
    resizeHandle: u == null ? void 0 : { ariaLabel: S.formatMessage(Q.resizeMascot), ...u },
    state: w.mascotState,
    style: c,
    transientState: l,
  });
      ...
      children: [
        F
          ? (0, Z.jsx)(`div`, {
              ...
              children: (0, Z.jsxs)(I.div, {
                animate: { opacity: P ? 1 : 0, scale: P || C ? 1 : 0.97, y: P || C ? 0 : 8 },
                className: `relative w-full overflow-hidden [corner-shape:var(--codex-corner-shape)]`,
                "data-avatar-overlay-size": `notification-tray`,
                initial: !1,
                style: R ? { maxHeight: z, transformOrigin: B } : { transformOrigin: B },
                transition: C
                  ? { duration: 0 }
        ...
        (0, Z.jsx)(A, {
          ...
          children: (0, Z.jsx)(`div`, {
            ...
            style: { height: j.height, left: j.left, top: j.top, width: j.width },
            children: H,
          }),
        }),
      ],
...
function mt(e) {
  let t = (0, zt.c)(67),
    ...
    _ = (0, X.useRef)(null),
    v;
  t[0] !== g || t[1] !== a ? ((v = ct(a, g)), (t[0] = g), (t[1] = a), (t[2] = v)) : (v = t[2]);
  let y = v,
    b = p == null ? `` : `caption`,
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = {
      ...
      (t[7] = C))
    : (C = t[7]);
  let [w, T] = (0, X.useState)(C),
    [E, re] = (0, X.useState)(null),
    ie = (0, X.useRef)(null),
    O;
  t[8] !== a || t[9] !== E
    ? ((O = a.some((e) => e.id === E) ? E : null), (t[8] = a), (t[9] = E), (t[10] = O))
    : (O = t[10]);
  let k = O,
    A = k != null && n,
    j,
  ...
  (t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = () => {
      ...
      (t[16] = P))
    : ((N = t[15]), (P = t[16])),
    h(`avatar-overlay-keyboard-interaction-ready`, P, N));
  let F = Math.min(w.hiddenOlderNotificationCount, S),
    ae = w.hasScrollableContent,
    L = n && ae && ne && w.hasLatestNotificationsAbove,
    oe = n && ae && ne && F > 0,
    R = n && ae && ne,
    z = n && ae,
    B = a.length > 0,
  ...
  t[17] === f
    ? (H = t[18])
    : ((H = f ? { duration: 0 } : { duration: 0.18, ease: [0.16, 1, 0.3, 1] }),
      (t[17] = f),
      (t[18] = H));
  let U = H,
    se;
  t[19] !== f || t[20] !== p || t[21] !== z
    ? ((se =
        p == null
          ? null
          : (0, Z.jsx)(
              ht,
              { prefersReducedMotion: f, shouldInsetForScrollbar: z, text: p },
              `restricted-caption`,
            )),
      (t[19] = f),
      (t[20] = p),
  ...
  let me;
  (t[26] !== te || t[27] !== m
    ? ((me = [te, m, ue]), (t[26] = te), (t[27] = m), (t[28] = me))
    : (me = t[28]),
  ...
  t[29] === f
    ...
    : ((G = () => {
        let e = _.current;
        e != null && (e.scrollTo({ behavior: f ? `auto` : `smooth`, top: 0 }), T(kt(e, 0)));
      }),
      (t[29] = f),
      (t[30] = G));
  let he = G,
  ...
  t[31] !== F || t[32] !== f
    ? ((ge = () => {
        ...
        if (e == null) return;
        let t = vt(e, F);
        (e.scrollTo({ behavior: f ? `auto` : `smooth`, top: t }), T(kt(e, t)));
      }),
      (t[31] = F),
      (t[32] = f),
      (t[33] = ge))
  ...
  t[34] === ve
    ? (ye = t[35])
    : ((ye = D(`relative flex w-full min-w-0 flex-col overflow-hidden`, ve)),
      (t[34] = ve),
      (t[35] = ye));
  let be;
  t[36] !== V || t[37] !== m
    ? ((be = V ? { height: m, maxHeight: m } : void 0), (t[36] = V), (t[37] = m), (t[38] = be))
    : (be = t[38]);
  let Se = r ? null : ce,
    K;
  t[39] !== k ||
    ...
    ? ((K = B
        ? (0, Z.jsxs)(I.div, {
            ...
            children: [
              (0, Z.jsx)(W, {
                children: L
                  ? (0, Z.jsx)(gt, { prefersReducedMotion: f, onClick: he }, `latest`)
                  : null,
              }),
              (0, Z.jsx)(I.div, {
                ref: fe,
              ...
              (0, Z.jsx)(W, {
                children: oe
                  ? (0, Z.jsx)(_t, { count: F, prefersReducedMotion: f, onClick: _e }, `older`)
                  : null,
              }),
            ],
          })
...
function ht(e) {
  ...
  t[4] === l
    ? (u = t[5])
    : ((u = D(`no-drag w-full min-w-0 shrink-0 overflow-hidden px-1.5 text-left`, l)),
      (t[4] = l),
      (t[5] = u));
  let d;
...
function _t(e) {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = D(qt, `bottom-1 min-w-9`)), (t[10] = p))
    : (p = t[10]);
  let m;
...
function yt({
  ...
  let f = xe(),
    p = t.source === `local` && t.usesLiveConversationState !== !1 ? t.localConversationId : null,
    m = c(ve, p),
    ...
    ne =
      t.action == null
        ? `${t.title}. ${te}`
        : `${t.title}. ${te}. ${f.formatMessage(Q.openNotification)}`,
    S = t.action != null,
    C = t.kind !== `activity` && r != null,
    [w, T] = (0, X.useState)(!1),
    [E, ie] = (0, X.useState)(!1),
    [O, k] = (0, X.useState)(``),
    [A, M] = (0, X.useState)(null),
    [N, P] = (0, X.useState)(!1),
    [F, ae] = (0, X.useState)(0),
    [L, oe] = (0, X.useState)(!1),
    R = (0, X.useRef)(w),
  ...
  let H = F > B + Kt || L,
    U = H && w && !e,
    W = t.controlTarget?.type === `app-server-conversation` && l != null,
    se = O.trim(),
    ce = u ? { duration: 0 } : { duration: N ? 0.2 : 0.28, ease: [0.16, 1, 0.3, 1] },
    le = async (e) => {
      if ((e.preventDefault(), e.stopPropagation(), !(!W || se.length === 0 || E))) {
        (ie(!0), M(null));
        try {
          (await l(t, se), k(``), i());
        } catch {
        ...
        children: [
          (0, Z.jsxs)(I.div, {
            ...
            className: D(
              ...
              C ? `pl-5` : `pl-3`,
              S ? `cursor-interaction` : `cursor-default`,
            ),
            tabIndex: S ? 0 : void 0,
            transition: u ? { duration: 0 } : { duration: 0.12, ease: `easeOut` },
            whileTap: S && !u ? { scale: 0.995 } : void 0,
            "aria-label": S ? ne : void 0,
            onClick: () => {
              S && o?.(t);
            },
            onKeyDown: (e) => {
              !S || (e.key !== `Enter` && e.key !== ` `) || (e.preventDefault(), o?.(t));
            },
            children: [
              (0, Z.jsx)(`span`, {
          ...
          (0, Z.jsx)(`span`, {
            role: `img`,
            "aria-label": y?.kind === `question` ? f.formatMessage(Q.questionStatusIcon) : _,
            className: D(
              `pointer-events-none absolute top-1 right-1 z-0 flex size-6 items-center justify-center opacity-100`,
              H && N && `opacity-0 transition-opacity duration-150 motion-reduce:transition-none`,
            ),
            children:
              y?.kind === `question` ? (0, Z.jsx)(Ae, { className: g.iconClassName }) : Rt(g),
          }),
          H
            ? (0, Z.jsx)(I.div, {
                ...
                children: (0, Z.jsx)(re, {
                  ...
                  children: (0, Z.jsx)(b, {
                    ...
                    children: (0, Z.jsx)(I.span, {
                      animate: { rotate: w ? 90 : 0 },
                      transition: u ? { duration: 0 } : { duration: 0.12, ease: `easeOut` },
                      children: (0, Z.jsx)(j, { className: `icon-xs` }),
                    }),
                  }),
                }),
              })
            ...
            ? (0, Z.jsx)(I.div, {
                ...
                children: (0, Z.jsx)(`div`, {
                  ...
                  children: (0, Z.jsx)(b, {
                    ...
                    color: `outline`,
                    size: `default`,
                    "aria-label": f.formatMessage(Q.replyNotification, { title: t.title }),
                    onClick: (e) => {
                      (e.stopPropagation(), M(null), k(``), a(), P(!0));
                    },
                    onPointerDown: (e) => {
                      e.stopPropagation();
                    },
                  ...
                  (0, Z.jsxs)(`div`, {
                    ...
                    children: [
                      (0, Z.jsx)(`input`, {
                        ...
                        "aria-label": f.formatMessage(Q.replyNotification, { title: t.title }),
                        autoFocus: !0,
                        placeholder: f.formatMessage(Q.notificationReplyPlaceholder),
                        value: O,
                        onChange: (e) => {
                          (k(e.currentTarget.value), M(null));
                        },
                        onKeyDown: (e) => {
                          e.key !== `Escape` || E || (e.stopPropagation(), i(), M(null));
                        },
                      }),
                      (0, Z.jsx)(b, {
                        ...
                        size: `default`,
                        type: `submit`,
                        "aria-label": f.formatMessage(Q.sendNotificationReply, { title: t.title }),
                        disabled: se.length === 0 || E,
                        loading: E,
                        children: f.formatMessage(Q.replyNotificationButton),
                      }),
                    ],
      ...
      C && !e
        ? (0, Z.jsx)(`div`, {
            ...
            children: (0, Z.jsx)(re, {
              ...
              children: (0, Z.jsx)(Ke, {
                ariaLabel: f.formatMessage(Q.dismissNotification, { title: t.title }),
                onClick: () => {
                  r?.(t);
                },
              }),
  ...
  switch (o.kind) {
    case `question`: {
      let e = n ? `break-words whitespace-pre-wrap` : `truncate`,
        r;
      t[2] === e ? (r = t[3]) : ((r = D(`min-w-0`, e)), (t[2] = e), (t[3] = r));
      let s;
      t[4] !== o.prompt || t[5] !== r
...
function Ct(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = D(`min-w-0 text-token-text-secondary`, i)), (t[0] = i), (t[1] = a));
  let o;
  return (
    t[2] !== a || t[3] !== r
      ? ((o = (0, Z.jsx)(`div`, {
...
function wt(e) {
  ...
  if (!o) {
    ...
    let i;
    t[15] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, Z.jsx)(J, { className: `mx-1.5 text-token-text-tertiary` })), (t[15] = i))
      : (i = t[15]);
    let a;
    t[16] === s
      ? (a = t[17])
...
function Xt() {
  ...
  if (
    (e[0] === r
      ...
      : ((i = () => {
          r &&
            l.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: !1 });
        }),
        (a = [r]),
        (e[0] = r),
        (e[1] = i),
...
function Zt({ selectedAvatar: e, selectedAvatarId: t }) {
  let a = d(r),
    ...
    p = f(tt),
    m = hn,
    g = m.phase !== `inactive` && !0;
  c(ve, void 0);
  let { data: v } = y({ enabled: g, hostId: void 0 }),
    b = g,
    [x, ee] = (0, $.useState)(En),
    [te, ne] = (0, $.useState)(null),
    [S, C] = (0, $.useState)(!0),
    [w, T] = (0, $.useState)(!1),
    [E, re] = (0, $.useState)(!1),
    [D, ie] = (0, $.useState)(!1),
    [O, k] = (0, $.useState)(null),
    { mascotWidthPx: A, setMascotWidthPx: j } = Ge(),
    [N, P] = (0, $.useState)(() => new Map()),
    [ae, I] = (0, $.useState)(() => Date.now()),
    [R] = (0, $.useState)(() => $t(e, t)),
    { data: U = [], refetch: W } = fe(),
    { data: se = [], refetch: ce } = M({ taskFilter: `current`, limit: 20 }),
    ue = qe({
    ...
    de = R == null ? null : lt({ intl: o, petName: R.petName, startedAtMs: R.startedAtMs }),
    pe = [],
    { nextNotificationExpiresAtMs: me, notifications: G } = at({
      dismissedNotificationTurnKeys: N,
      extraNotifications: g ? [...[], ...pe] : de == null ? [] : [de],
      nowMs: ae,
      sessions: g ? [] : ue,
    }),
    ge = ct(G, o),
    _e = ue.some((e) => e.source !== `cloud` && e.status === `running`),
    Se = ue.some((e) => e.source === `cloud` && e.status === `running`),
    K = (0, $.useRef)(null),
    q = (0, $.useRef)(null),
    J = (0, $.useRef)(null),
    Ce = (0, $.useRef)(null),
    ...
    Y = (0, $.useCallback)(
      (t, n, r, i = S) => {
        u.logProductEvent(
          ...
          Ze({
            action: t,
            hasRunningCloudSession: Se,
            hasRunningLocalSession: _e,
      ...
      [_e, Se, S, G.length, u, e],
    );
  ((0, $.useEffect)(() => {
    if (R == null) return;
    let e = i(mn, []);
    e.includes(R.avatarId) || n(mn, [...e, R.avatarId]);
  }, [R]),
    (0, $.useEffect)(() => {
      Oe.current ||
        (u !== he &&
          ((Oe.current = !0),
          Y(H.CODEX_AVATAR_OVERLAY_ACTION_OPENED, L.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
    }, [u, Y]),
    Qe({
      interactiveRegionRef: Ee,
      isPaused: () => K.current != null || q.current != null,
  ...
  let ke = (0, $.useCallback)(() => {
      if (q.current != null || we.current != null) return;
      let e = nn(Ee.current);
      if (e == null) return;
      let t = { ...e, isTrayVisible: (S && G.length > 0) || m.caption != null };
      cn(De.current, t) ||
        ((De.current = t),
      ...
      (e) => {
        ((we.current = e),
          ...
          (Te.current = window.setTimeout(() => {
            ((Te.current = null), (we.current = null), k(null), ke());
          }, 100)));
      },
      [Ae, ke],
    ),
    Fe = (0, $.useCallback)(
      () => an(Ee.current?.querySelector(_n) ?? null)?.width ?? A ?? 112,
      [A],
    ),
    Ie = (0, $.useCallback)((e, t) => {
      ...
      n == null ||
        n.pointerId !== e ||
        ((q.current = null), re(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
    }, []),
    Le = (0, $.useCallback)(
      (e, t) => {
        let n = q.current;
      ...
      (e, { releaseSample: t, shouldPreserveOrbMomentum: n = !1, shouldOpenMainWindow: r }) => {
        ...
        if (
          ...
          a &&
            !i.hasMoved &&
            o != null &&
            l.dispatchMessage(`avatar-overlay-drag-move`, {
          ...
          r &&
            i.startedOnMascot &&
            !a &&
            (Y(H.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, L.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
            l.dispatchMessage(`open-current-main-window`, {})),
          l.dispatchMessage(`avatar-overlay-drag-end`, {
            pointerScreenX: o?.screenX ?? i.screenX,
            pointerScreenY: o?.screenY ?? i.screenY,
          }),
          a &&
            Y(H.CODEX_AVATAR_OVERLAY_ACTION_DRAG_COMPLETED, L.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          s != null)
        ) {
          let e = i.usesOrbPhysics ? 3 : 1;
          l.dispatchMessage(`avatar-overlay-drag-release`, {
    ...
    ze = (e) => {
      e.button !== 0 ||
        ...
        l.dispatchMessage(`avatar-overlay-drag-start`, {
    ...
    Be = (e) => {
      ...
      (Math.abs(r) < 4 && Math.abs(i) < 4) ||
        ...
        (t.screenX = n.screenX),
        (t.screenY = n.screenY),
        ne((e) => tn({ currentDragState: e, deltaX: r })),
        l.dispatchMessage(`avatar-overlay-drag-move`, {
        ...
        switch (t.intent) {
          case `command-approval`:
            if (t.commandDecision != null && (n?.kind === `exec` || n?.kind === `network`)) {
              B(`reply-with-command-execution-approval-decision`, {
                conversationId: r,
          ...
          case `file-approval`:
            if (t.fileDecision != null && n?.kind === `patch`) {
              B(`reply-with-file-change-approval-decision`, {
                conversationId: r,
                requestId: n.requestId,
          ...
          case `permission-response`:
            if (t.permissionResponse != null && n?.kind === `permission`) {
              B(`reply-with-permissions-request-approval-response`, {
                conversationId: r,
                requestId: n.requestId,
          ...
          case `mcp-elicitation`:
            if (t.mcpElicitationAction != null && n?.kind === `tool`) {
              B(`reply-with-mcp-server-elicitation-response`, {
                conversationId: r,
                requestId: n.requestId,
                response: oe(t.mcpElicitationAction),
              }).then(() => {
                W();
              });
              return;
          ...
          case `plan-start`:
            if (n?.kind === `plan` && t.planStartCollaborationMode != null) {
              B(`update-thread-settings-for-next-turn`, {
                conversationId: r,
                threadSettings: { collaborationMode: t.planStartCollaborationMode },
              })
                .then(() =>
                  B(`remove-plan-implementation-request`, { conversationId: r, turnId: n.turnId }),
                )
                .then(async () =>
                  B(`send-follow-up-message`, {
                    conversationId: r,
                    prompt: `${V}\n${n.planContent}`,
                    serviceTier: await _(
                      a,
      ...
      (t != null && t.intent !== `open`) ||
        (e.action != null &&
          (Y(
            ...
            L.CODEX_AVATAR_OVERLAY_SOURCE_NOTIFICATION_ROW,
            e,
          ),
    ...
    nt = (e, t) => {
      ...
      e.localConversationId == null ||
        n?.kind !== `question` ||
        B(`reply-with-user-input-response`, {
    ...
    st = async (e, t) => {
      ...
      n.length !== 0 &&
        (Y(
          ...
          L.CODEX_AVATAR_OVERLAY_SOURCE_NOTIFICATION_REPLY,
          e,
        ),
        await B(`send-follow-up-message`, {
          conversationId: e.controlTarget.conversationId,
          prompt: n,
          serviceTier: await _(a, a.get(z, e.controlTarget.conversationId) ?? `local`, null),
        }));
    },
    ut = (0, $.useCallback)((e) => {
  ...
  return (
      ...
      ({ layout: e }) => {
        (ee(e),
          we.current === e.mascot.width &&
            ((we.current = null), Ae(), k(null), window.requestAnimationFrame(ke)));
      },
      [Ae, ke],
    ),
    (0, $.useLayoutEffect)(() => {
    ...
    (0, $.useLayoutEffect)(() => {
      ke();
    }, [S, ke, e.id, ge, m.caption, A]),
    (0, $.useEffect)(() => {
      if (me == null) return;
      let e = Math.max(0, me - Date.now()),
        t = window.setTimeout(() => {
          I((e) => Math.max(Date.now(), e + 1));
        }, e);
      return () => {
    ...
    (0, $.useEffect)(() => {
      ...
      let e = window.setTimeout(() => {
        (I((e) => Math.max(Date.now(), e + 1)), _e && W(), Se && ce());
      }, pn);
      return () => {
    ...
    (0, fn.jsx)(pt, {
      ...
      avatarMenuItems: [
        {
          ...
          onSelect: () => {
            (Y(
              ...
              L.CODEX_AVATAR_OVERLAY_SOURCE_CONTEXT_MENU,
            ),
              l.dispatchMessage(`avatar-overlay-close`, {}));
          },
        },
      ],
      interactiveRegionRef: Ee,
      ...
      mascotDragState: te,
      mascotLayout:
        E && O != null ? { ...x.mascot, height: Math.ceil(O / We), width: O } : x.mascot,
      ...
      onCloseNotificationTray: () => {
        (Y(
          ...
          L.CODEX_AVATAR_OVERLAY_SOURCE_NOTIFICATION_BADGE,
          void 0,
          !1,
        ),
          C(!1));
...
function $t(e, t) {
  return q(e, t) || i(mn, []).includes(e.id)
    ? null
