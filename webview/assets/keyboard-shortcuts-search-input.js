...
import { i as n, l as r } from "./lib.js";
import { t as i } from "./clsx-Cir5-jBH.js";
import { m as a, o } from "./electron-menu-shortcuts.js";
var s = n({
...
function u(e, t) {
  return `titleIntlId` in e
    ? t.formatMessage(s[e.titleIntlId])
    : t.formatMessage(c[e.electron.menuTitleIntlId]);
}
function d(e, t, n) {
  return {
    title: n?.title ?? u(e, t),
    description: n?.description ?? (a(e) ? t.formatMessage(l[e.descriptionIntlId]) : ``),
  };
}
function f(
  e,
...
function h(e) {
  return e.kind !== `webview` || e.commandMenuGroupKey == null
    ? o.length
    : o.indexOf(e.commandMenuGroupKey);
}
var g = t(),
  _ = e();
function v(e) {
  ...
  return (
    t[29] !== w || t[30] !== T
      ? ((E = (0, _.jsxs)(`div`, { className: `relative`, children: [w, T] })),
        (t[29] = w),
        (t[30] = T),
        (t[31] = E))
      : (E = t[31]),
...
export { d as a, p as i, m as n, f as r, v as t };
