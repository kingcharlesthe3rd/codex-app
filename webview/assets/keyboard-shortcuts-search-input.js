...
import { i as n, l as r } from "./lib-1.js";
import { t as i } from "./clsx.js";
import { n as a } from "./app-identity-CNx-Ii8s.js";
import { m as o, o as s } from "./electron-menu-shortcuts.js";
var c = n({
...
function d(e, t) {
  return `titleIntlId` in e
    ? t.formatMessage(c[e.titleIntlId])
    : t.formatMessage(l[e.electron.menuTitleIntlId]);
}
function f(e, t, n) {
  return {
    title: n?.title ?? d(e, t),
    description:
      n?.description ?? (o(e) ? t.formatMessage(u[e.descriptionIntlId], { appName: a }) : ``),
  };
}
function p(
  e,
  {
    ...
    isRealtimeConversationEnabled: o,
...
function m(
  e,
  {
    ...
    isRealtimeConversationEnabled: a,
...
function g(e) {
  return e.kind !== `webview` || e.commandMenuGroupKey == null
    ? s.length
    : s.indexOf(e.commandMenuGroupKey);
}
var _ = t(),
  v = e();
function y(e) {
  ...
  return (
    t[29] !== w || t[30] !== T
      ? ((E = (0, v.jsxs)(`div`, { className: `relative`, children: [w, T] })),
        (t[29] = w),
        (t[30] = T),
        (t[31] = E))
      : (E = t[31]),
...
export { f as a, m as i, h as n, p as r, y as t };
