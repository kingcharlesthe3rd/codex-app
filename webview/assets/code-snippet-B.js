...
var b = (e) => {
  ...
  w = g(() => i(() => import(`./highlight-code.js`), __vite__mapDeps([0, 1, 2]), import.meta.url)),
  T = `
`,
  E = 120,
  D = x.memo(function (e) {
...
function O(e) {
  ...
  (t[8] !== o || t[9] !== i
    ? ((B = () => {
        let e = oe.current;
        if (((e.latestContent = o), (e.latestLanguage = i), e.timeoutHandle != null)) return;
  ...
  let G = W,
    K;
  t[17] !== o || t[18] !== R
    ? ((K = R != null && o.startsWith(R.code) ? R : null), (t[17] = o), (t[18] = R), (t[19] = K))
    : (K = t[19]);
  let q = K,
    J;
  if (t[20] !== o || t[21] !== q || t[22] !== G) {
    let e =
        q == null
          ? null
          : q.html.split(`
`),
      n;
    t[24] !== o || t[25] !== q
      ? ((n = q == null ? o : o.slice(q.code.length)), (t[24] = o), (t[25] = q), (t[26] = n))
      : (n = t[26]);
    let r = n;
    ((J = G
        ...
        : (0, v.jsxs)(`span`, {
            children: [
              e.map((t, n) =>
                (0, v.jsxs)(
                  x.Fragment,
                  { children: [(0, v.jsx)(D, { html: t }), n < e.length - 1 ? T : null] },
                  n,
                ),
              ),
...
function te(e) {
  ...
  t[3] !== m || t[4] !== y || t[5] !== a || t[6] !== r
    ...
    : (w = t[7]);
  let T;
  t[8] !== n || t[9] !== d || t[10] !== f || t[11] !== g
    ? ((T = (0, v.jsx)(j, { shouldWrap: g, className: d, onCopy: f, children: n })),
      (t[8] = n),
      (t[9] = d),
      (t[10] = f),
      (t[11] = g),
    ...
    : (T = t[12]);
  let E;
  t[13] !== u || t[14] !== p || t[15] !== T
    ? ((E = (0, v.jsx)(A, { ref: p, className: u, children: T })),
      (t[13] = u),
      (t[14] = p),
      (t[15] = T),
      (t[16] = E))
  ...
  let D;
  return (
    t[17] !== i || t[18] !== S || t[19] !== C || t[20] !== w || t[21] !== E
      ? ((D = (0, v.jsxs)(`div`, {
          "data-markdown-copy": `code-block`,
          "data-markdown-copy-text": i,
          className: S,
          "data-theme": C,
          children: [w, E],
        })),
...
function k(e) {
  ...
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (i = t[3]))
    : (({ className: n, removeTopBorderRadius: i, ...r } = e),
      (t[0] = e),
      (t[1] = n),
      (t[2] = r),
      (t[3] = i));
  let a = !(i !== void 0 && i) && `rounded-t-lg`,
    s;
  t[4] !== n || t[5] !== a
    ? ((s = o(
  ...
  return (
    t[7] !== r || t[8] !== s
      ? ((c = (0, v.jsx)(`div`, { "data-markdown-copy": `exclude`, className: s, ...r })),
        (t[7] = r),
        (t[8] = s),
        (t[9] = c))
      : (c = t[9]),
...
var A = function (e) {
  let t = (0, _.c)(6),
    { children: n, className: r, ref: i } = e,
    a;
  t[0] === r
    ? (a = t[1])
    : ((a = o(`text-size-chat overflow-auto p-2`, r)), (t[0] = r), (t[1] = a));
  let s;
  return (
    t[2] !== n || t[3] !== i || t[4] !== a
      ? ((s = (0, v.jsx)(`div`, { ref: i, className: a, dir: `ltr`, children: n })),
        (t[2] = n),
        (t[3] = i),
        (t[4] = a),
        (t[5] = s))
...
function j(e) {
  ...
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (i = t[3]))
    : (({ className: n, shouldWrap: i, ...r } = e), (t[0] = e), (t[1] = n), (t[2] = r), (t[3] = i));
  let a = i ? `whitespace-pre-wrap!` : `whitespace-pre!`,
    s;
  t[4] !== n || t[5] !== a ? ((s = o(a, n)), (t[4] = n), (t[5] = a), (t[6] = s)) : (s = t[6]);
  let c;
  return (
    t[7] !== r || t[8] !== s
...
//# sourceMappingURL=code-snippet-B.js.map
