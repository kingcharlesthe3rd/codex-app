...
import { ai as i, pt as a } from "./src-1.js";
import { d as o } from "./statsig.js";
import { m as s } from "./parse-directives.js";
import { w as c } from "./mention-item.js";
import { t as l } from "./app-intl-signal.js";
import { t as u } from "./plugin-config-edits.js";
import { t as d } from "./plugin-prefill-prompt.js";
...
function p(e, t, n) {
  ...
  switch (n.type) {
    case `create-asset`:
      ...
      break;
    case `create`:
      (o(e, `3696170016`) && n.setSelectedMode(`plan`),
        (a = i.formatMessage({
    ...
    case `edit`:
      a = i.formatMessage(
        ...
        { siteMention: c({ projectId: n.projectId, title: n.projectTitle }) },
      );
      break;
  }
  let s;
  switch (n.type) {
    case `create`:
      s = d({ defaultPrompt: a, pluginDisplayName: `Sites`, pluginId: u });
      break;
    case `edit`:
      s = `${a} `;
      break;
  ...
  (t({ activeProject: null, prefillPrompt: s, startInSidebar: !0 }),
    n.type === `edit` &&
      n.liveUrl != null &&
      r.dispatchMessage(`open-in-browser`, {
...
var m = `/sites/:projectId/settings`,
  h = `/sites/library`;
function g(e) {
...
export { f as a, g as i, h as n, p as o, m as r, v as t };
//# sourceMappingURL=sites-GBPP-jT9.js.map
