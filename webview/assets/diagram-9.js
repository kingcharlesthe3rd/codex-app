...
import "./chunk-111.js";
import "./chunk-73.js";
import { t as e } from "./defaultLocale-1.js";
import { t } from "./src-4.js";
import { t as n } from "./ordinal-1.js";
import { a as r, t as i } from "./treemap.js";
import "./dist-9.js";
...
import { r as y } from "./chunk-50.js";
import { t as b } from "./chunk-34.js";
import { t as x } from "./mermaid-parser.core-Cpt-mObg.js";
import { t as S } from "./chunk-78.js";
import { i as C, n as w } from "./chunk-133.js";
var T = class {
  constructor() {
    ((this.nodes = []),
      (this.levels = new Map()),
  ...
  N = {
    draw: a((s, c, l, u) => {
          ...
          .attr(`style`, (e) =>
            e.depth === 0
              ...
              : `dominant-baseline: middle; font-size: 12px; fill:` +
                ...
                C({ cssCompiledStyles: e.data.cssCompiledStyles }).labelStyles.replace(
                  `color:`,
                  `fill:`,
                ),
          )
      ...
      (V.append(`rect`)
        ...
        .attr(`fill`, (e) => (e.parent ? k(e.parent.data.name) : k(e.data.name)))
        .attr(`style`, (e) => C({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles)
        .attr(`fill-opacity`, 0.3)
        .attr(`stroke`, (e) => (e.parent ? k(e.parent.data.name) : k(e.data.name)))
        .attr(`stroke-width`, 3),
        V.append(`clipPath`)
        ...
        V.append(`text`)
          ...
          .each(function (e) {
            ...
            let c = parseInt(n.style(`font-size`), 10),
              l = 0.6;
            for (; a.getComputedTextLength() > o && c > 8; ) (c--, n.style(`font-size`, `${c}px`));
            ...
            (n.style(`font-size`, `${c}px`),
              (a.getComputedTextLength() > o || c < 8 || s < c) && n.style(`display`, `none`));
          }),
        f.showValues !== !1 &&
          V.append(`text`)
