...
import { St as l, xt as u } from "./app-initial~app-main~automations-page.js";
import {
  n as d,
  t as f,
...
import { n as _, r as v } from "./use-hotkey-window-detail-layout-D.js";
...
function x() {
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, w.jsx)(`div`, {
        "aria-hidden": `true`,
        children: (0, w.jsx)(p, { className: `h-12 w-12 text-token-foreground/20` }),
      })),
      (e[2] = i))
    : (i = e[2]);
  let a;
