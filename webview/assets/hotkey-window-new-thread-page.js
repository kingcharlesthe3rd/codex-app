...
import { Ct as l, wt as u } from "./app-initial~app-main~automations-page.js";
import {
  n as d,
  t as f,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~appgen-library-page~hot~djo67r4n.js";
import { c as p, s as m } from "./app-initial~app-main~new-thread-panel-page~onboarding-page.js";
import {
  n as h,
  r as g,
...
function x() {
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, w.jsx)(`div`, {
        "aria-hidden": `true`,
        children: (0, w.jsx)(m, { className: `h-12 w-12 text-token-foreground/20` }),
      })),
      (e[2] = i))
    : (i = e[2]);
  let a;
...
function S(e) {
  c.hotkeyWindowHotkeys?.open({ path: r(e) });
}
var C, w;
e(() => {
  ((C = t()), n(), a(), d(), u(), p(), o(), g(), y(), _(), (w = i()));
})();
