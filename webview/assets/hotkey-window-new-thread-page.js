...
import { t as o } from "./local-active-workspace-root-dropdown.js";
...
import { n as c } from "./thread-layout.js";
import "./add-project-menu-items.js";
import { n as l } from "./use-hotkey-window-detail-layout.js";
import "./thread-scroll-controller-context-value.js";
import { t as u } from "./thread-scroll-layout.js";
var d = t(),
  f = e();
function p() {
  let e = (0, d.c)(4),
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, f.jsx)(`div`, {
        "aria-hidden": `true`,
        children: (0, f.jsx)(s, { className: `h-12 w-12 text-token-foreground/20` }),
      })),
      (e[2] = p))
    : (p = e[2]);
  let h;
...
function m(e) {
  i.hotkeyWindowHotkeys?.open({ path: n(e) });
}
