...
import { ad as l, id as u } from "./app-initial~app-main~onboarding-page.js";
import { Tn as d, wn as f } from "./app-initial~app-main~automations-page.js";
import {
  n as p,
  t as m,
...
function x() {
  ...
  e[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, w.jsx)(m, { showWorkspaceDropdownInFooter: !1, onLocalConversationCreated: n })),
      (e[1] = i))
    : (i = e[1]);
  let a;
...
function S(e) {
  i.hotkeyWindowHotkeys?.open({ path: o(e) });
}
var C, w;
e(() => {
  ((C = s()), n(), r(), p(), d(), l(), a(), g(), y(), _(), (w = c()));
})();
