...
import { C as r, h as i } from "./chunk-44.js";
import { k as a } from "./runtime.worker.js";
import { D as o, b as s, c, s as l } from "./chunk-94.js";
import "./dist-Y1G-iXdi.js";
import "./chunk-129.js";
import "./chunk-67.js";
import "./chunk-147.js";
import { t as u } from "./graphlib-4.js";
import "./chunk-39.js";
import "./chunk-75.js";
import "./chunk-135.js";
import "./chunk-1.js";
import "./chunk-78.js";
import "./chunk-21.js";
import { t as d } from "./dagre-2.js";
import { i as f, n as p, t as m } from "./chunk-117.js";
var h = t(
    (e) =>
      e
        .append(`circle`)
  ...
  w = t(function (e, t) {
    ...
    return (
      (r.width = a.width + 2 * s().state.padding), (r.height = a.height + 2 * s().state.padding), r
    );
  }, `drawState`),
  T = 0,
  E = t(function (n, c, u) {
    ...
    if (
      ...
      h.attr(`marker-end`, `url(` + g + `#` + d(m.relationType.DEPENDENCY) + `End)`),
      u.title !== void 0)
    ) {
      ...
      for (let n = 0; n <= o.length; n++) {
        ...
        ((p = Math.max(p, s.width)),
          (m = Math.min(m, s.x)),
          e.info(s.x, r, a + d),
          d === 0 && ((d = i.node().getBBox().height), e.info(`Title height`, d, a)),
          f.push(i));
      }
      let h = d * o.length;
      if (o.length > 1) {
  ...
  j = t(function (t, r, i, a) {
    ...
    let f = u.select(`[id='${r}']`);
    (A(f), N(a.db.getRootDoc(), f.append(`g`).attr(`id`, r + `-root`), void 0, !1, u, d, a));
    let p = D.padding,
      m = f.node().getBBox(),
      h = m.width + p * 2,
      g = m.height + p * 2;
    (c(f, g, h * 1.75, D.useMaxWidth),
      f.attr(`viewBox`, `${m.x - D.padding}  ${m.y - D.padding} ` + h + ` ` + g));
  }, `draw`),
  ...
  N = t((t, n, r, i, a, o, s) => {
    ...
    for (let e of g) {
      ...
      if (t.note) {
        let e = w(n, { descriptions: [], id: t.id + `-note`, note: t.note, type: `note` }, c);
    ...
    c.nodes().forEach(function (t) {
      t !== void 0 && c.node(t) !== void 0
        ? (e.warn(`Node ` + t + `: ` + JSON.stringify(c.node(t))),
          ...
          a.select(`#` + v.id + ` #` + t).attr(`data-x-shift`, c.node(t).x - c.node(t).width / 2),
          o.querySelectorAll(`#` + v.id + ` #` + t + ` .divider`).forEach((e) => {
    ...
    (c.edges().forEach(function (t) {
      t !== void 0 &&
        c.edge(t) !== void 0 &&
        (e.debug(`Edge ` + t.v + ` -> ` + t.w + `: ` + JSON.stringify(c.edge(t))),
...
export { P as diagram };
//# sourceMappingURL=stateDiagram-1.js.map
