...
import { c as i, o as a, t as o, z as s } from "./app-scope.js";
import { Wo as c } from "./app-server-manager-signals.js";
import { f as l } from "./vscode-api.js";
import { A as u, T as d } from "./src-2.js";
import { s as f } from "./lib.js";
import { n as p, o as m, r as h } from "./app-shell-state.js";
import { t as g } from "./button.js";
import { a as _, t as v } from "./setting-storage.js";
import { n as y } from "./window-zoom-context.js";
import { A as b } from "./rpc-2.js";
import { t as x } from "./app-intl-signal.js";
import { t as S } from "./use-platform.js";
import { t as C } from "./route-scope.js";
import { g as w, h as T } from "./diff-view-mode.js";
import { n as E, t as D } from "./app-shell-tab-controller.js";
import { t as O } from "./local-conversation-title-signals.js";
import { i as k, n as A } from "./thread-context-BQm-6r7t.js";
import { n as j, t as M } from "./focus-composer.js";
import { i as N, o as P, r as F } from "./thread-panel-state.js";
import { t as I } from "./terminal.js";
import { t as L } from "./error-boundary.js";
import { n as R } from "./check-git-index-for-changes.js";
                ...
                m = (t.DomRendererRowFactory = class {
                  ...
                  createRow(e, t, n, r, i, s, c, u, f, m, g) {
                    ...
                    for (let N = 0; N < x; N++) {
                      ...
                      let ne = I.getChars() || o.WHITESPACE_CELL_CHAR;
                      if (
                        (ne === ` ` && (I.isUnderline() || I.isOverline()) && (ne = `\xA0`),
                        (A = x * u - f.get(ne, I.isBold(), I.isItalic())),
                        b)
                      ) {
                        if (
                          S &&
                          ...
                          (I.isInvisible() ? (C += o.WHITESPACE_CELL_CHAR) : (C += ne), S++);
                          continue;
                        }
                        (S && (b.textContent = C),
                      ...
                      (I.isOverline() && (j.push(`xterm-overline`), C === ` ` && (C = `\xA0`)),
                        ...
                        ee && (b.style.textDecoration = `underline`));
                      let z = I.getFgColor(),
                        B = I.getFgColorMode(),
                        V = I.getBgColor(),
                        H = I.getBgColorMode(),
                      ...
                      switch (
                        (this._decorationService.forEachDecorationAtCell(N, t, void 0, (e) => {
                          (e.options.layer !== `top` && q) ||
                            (e.backgroundColorRGB &&
                              ((H = 50331648),
                              (V = (e.backgroundColorRGB.rgba >> 8) & 16777215),
                              (W = e.backgroundColorRGB)),
                            e.foregroundColorRGB &&
                              ((B = 50331648),
                              (z = (e.foregroundColorRGB.rgba >> 8) & 16777215),
                              (G = e.foregroundColorRGB)),
                            (q = e.options.layer === `top`));
                        }),
                        !q &&
                          L &&
                          ((W = this._coreBrowserService.isFocused
                          ...
                          y.selectionForeground &&
                            ((B = 50331648),
                            (z = (y.selectionForeground.rgba >> 8) & 16777215),
                            (G = y.selectionForeground))),
                        q && j.push(`xterm-decoration-top`),
                        H)
                      ) {
                        case 16777216:
                        case 33554432:
                          ((K = y.ansi[V]), j.push(`xterm-bg-${V}`));
                          break;
                        case 50331648:
                          ((K = l.channels.toColor(V >> 16, (V >> 8) & 255, 255 & V)),
                            this._addStyle(
                              b,
                              `background-color:#${h((V >>> 0).toString(16), `0`, 6)}`,
                            ));
                          break;
                        default:
                          U
                            ? ((K = y.foreground), j.push(`xterm-bg-${a.INVERTED_DEFAULT_COLOR}`))
                            : (K = y.background);
                      }
                      switch ((W || (I.isDim() && (W = l.color.multiplyOpacity(K, 0.5))), B)) {
                        case 16777216:
                        case 33554432:
                          (I.isBold() &&
                            z < 8 &&
                            this._optionsService.rawOptions.drawBoldTextInBrightColors &&
                            (z += 8),
                            this._applyMinimumContrast(b, K, y.ansi[z], I, W, void 0) ||
                              j.push(`xterm-fg-${z}`));
                          break;
                        case 50331648:
                          let e = l.channels.toColor((z >> 16) & 255, (z >> 8) & 255, 255 & z);
                          this._applyMinimumContrast(b, K, e, I, W, G) ||
                            this._addStyle(b, `color:#${h(z.toString(16), `0`, 6)}`);
                          break;
                        default:
                          this._applyMinimumContrast(b, K, y.foreground, I, W, G) ||
                            (U && j.push(`xterm-fg-${a.INVERTED_DEFAULT_COLOR}`));
                      }
                      ((j.length &&= ((b.className = j.join(` `)), 0)),
                        R || P || te ? (b.textContent = C) : S++,
                  ...
                  decode(e, t) {
                    ...
                    for (; d < n; ) {
                      ...
                      if (((r = e[d++]), r < 128)) t[s++] = r;
                        ...
                        if (d >= n)
                          return (
                            (this.interim[0] = r), (this.interim[1] = i), (this.interim[2] = a), s
                          );
                        if (((o = e[d++]), (192 & o) != 128)) {
                          d--;
                          continue;
      ...
      : ((o = (0, G.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, G.jsx)(`div`, {
              ...
              children: (0, G.jsx)(g, { color: `secondary`, onClick: n, children: a }),
            }),
          ],
        })),
        (t[3] = n),
...
function Y(e, t) {
  return (t && Z(e, `c`)) || X(e, `c`) || Q(e, { ctrlKey: !0, shiftKey: !1 });
}
function se(e, t) {
  return (t && Z(e, `v`)) || X(e, `v`) || Q(e, { ctrlKey: !1, shiftKey: !0 });
}
function ce(e) {
  return le(e, [`ArrowLeft`, `ArrowUp`])
    ? q
    : le(e, [`ArrowRight`, `ArrowDown`])
      ? re
      : le(e, [`Backspace`])
        ? ae
        : le(e, [`Delete`])
...
function he(e, t) {
  ...
  let i = r.getCoords,
    ...
    o = (e, n) => {
      let r = t();
      return r === 1 ? e : ge(e, n.getBoundingClientRect(), r);
    },
...
function ge(e, t, n) {
  return n === 1
    ? e
    : { clientX: t.left + (e.clientX - t.left) / n, clientY: t.top + (e.clientY - t.top) / n };
}
var _e = B(),
  ve = V(),
  ye = H(),
  ...
  $ = e(n(), 1);
function xe(e, t, n) {
  (t.fit(), c.resize(n, e.cols, e.rows));
}
function Se(e) {
  let t = (0, W.c)(5),
    ...
    i = r ?? n,
    a;
  t[0] === e ? (a = t[1]) : ((a = (0, G.jsx)(we, { ...e })), (t[0] = e), (t[1] = a));
  let o;
  return (
    t[2] !== i || t[3] !== a
      ? ((o = (0, G.jsx)(L, { name: `TerminalPanel`, fallback: Ce, children: a }, i)),
        (t[2] = i),
        (t[3] = a),
        (t[4] = o))
      : (o = t[4]),
...
function we(e) {
  let t = (0, W.c)(53),
    ...
    f = ne(te()),
    p = l !== `macOS`,
    m = _(u.lightChromeTheme),
    h = _(u.darkChromeTheme),
    g = _(u.codeFontSize),
    v,
    b,
    x,
  ...
  if (t[0] !== g || t[1] !== h || t[2] !== m || t[3] !== f) {
    v = f === `light` ? w(m, `light`) : w(h, `dark`);
    let e = v.fonts.code?.trim() ?? ``,
      n = e.length > 0 ? e : ee;
    ((x = g ?? 12),
      (b = ue(n)),
      (C = n.split(`,`)[0]?.trim() ?? ``),
  ...
  (t[14] === d
    ...
    : ((B = () => {
      ...
      (t[15] = B),
      (t[16] = V)),
    (0, $.useLayoutEffect)(B, V));
  let H;
  t[17] === r ? (H = t[18]) : ((H = () => r), (t[17] = r), (t[18] = H));
  ...
  (t[19] !== v || t[20] !== f
    ? ((q = () => {
      ...
      (t[22] = q))
    : ((K = t[21]), (q = t[22])),
    (0, $.useLayoutEffect)(q, K));
  let re;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = () => {
        let e = k.current,
          t = D.current;
        !e || !t || ((e.options.theme = me(t)), e.rows > 0 && e.refresh(0, e.rows - 1));
      }),
      (t[23] = re))
    : (re = t[23]);
  let ie;
  (t[24] !== v || t[25] !== f
    ? ((ie = [v, f]), (t[24] = v), (t[25] = f), (t[26] = ie))
    : (ie = t[26]),
    (0, $.useEffect)(re, ie));
  let ae, J;
  (t[27] !== b || t[28] !== x || t[29] !== E
    ? ((ae = () => {
        let e = k.current;
        if (!e) return;
        let t = !1;
  ...
  t[39] !== p
    ? ((Y = () => {
        ...
        k.current = f;
        let g = new _e.ClipboardAddon(),
          _ = new ve.FitAddon();
        A.current = _;
        let v = new ye.WebLinksAddon(Ee);
        (f.loadAddon(g),
          f.loadAddon(_),
          f.loadAddon(v),
          ...
          f.open(e));
        let y = he(f, () => F.current),
          b = () => {
            d ||
              (e.isConnected &&
                requestAnimationFrame(() => {
                  d || (e.isConnected && (M.current ? xe(f, _, u) : _.fit()));
                }));
          };
        b();
        let x = c.register(u, {
  ...
  t[50] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Z = (0, G.jsx)(`div`, {
        ...
        children: (0, G.jsx)(`div`, { className: `h-full w-full overflow-hidden`, ref: O }),
      })),
      (t[50] = Z))
    : (Z = t[50]);
  let Q;
...
function De(e) {
  ...
  return (
    t[0] === n
      ? ((r = t[1]), (i = t[2]))
      : ((r = (e) => (n == null ? ke : c.subscribeToConversation(n, e))),
        (i = () => (n == null ? null : c.getConversationSnapshot(n))),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i)),
    (0, $.useSyncExternalStore)(r, i, Oe)
  );
}
function Oe() {
  return null;
...
function Ae(e) {
  ...
  let f;
  return (
    t[5] !== n || t[6] !== r || t[7] !== i || t[8] !== o || t[9] !== c || t[10] !== d
      ? ((f = (0, G.jsx)(Se, {
          conversationId: n,
          conversationTitle: r,
          cwd: i,
...
var je = `terminal:`,
  ...
  Ne = i(C, ({ get: e }) => {
    let t = e(D.activeTab$);
    return e(h) && t != null && it(t.tabId);
  }),
  Pe = i(C, ({ get: e }) => {
    let t = e(E.activeTab$);
    return e(m) && t != null && it(t.tabId);
  }),
  Fe = i(o, ({ get: e }) => v(e, d.defaultTerminalLocation)),
  Ie = i(C, ({ get: e }) => (e(p) === !1 ? `right` : e(Fe)));
function Le(e) {
  (F(e, `right`), requestAnimationFrame(M));
}
function Re(e) {
  Be(e, `bottom`);
}
function ze(e, t, n = qe(e)) {
  return Be(e, t == null ? n : Je(e, t, n), t);
}
function Be(e, t, n) {
  let r = tt(e);
  if (r == null) return null;
  let i = c.getConversationSnapshot(r.conversationId);
  n != null && !i?.sessionIds.includes(n) && c.addSessionForConversation(r.conversationId, n);
  let a = n ?? $e(e, t, i?.sessionIds ?? []) ?? c.addSessionForConversation(r.conversationId);
  return (
    c.setActiveSessionForConversation(r.conversationId, a), Ze(e, r, t), Ye(e, r, a, !0, t, a), a
  );
}
function Ve(e) {
  return tt(e) != null;
...
function We(e, t) {
  let n = tt(e);
  if (n == null) return;
  let r = c.addSessionForConversation(n.conversationId);
  (Ze(e, n, t), Ye(e, n, r, !0, t, r));
}
function Ge(e) {
  if (e.get(Ne)) {
    F(e, `bottom`);
...
function Je(e, t, n) {
  let r = nt(t);
  return e.get(D.tabs$).some((e) => e.tabId === r)
    ? `bottom`
    : e.get(E.tabs$).some((e) => e.tabId === r)
      ? `right`
      : n;
}
function Ye(e, t, n, r, i, a) {
  let o = c.getConversationSnapshot(t.conversationId),
    s = o?.sessionIds ?? [],
    l = e.get(x),
    u = N(i);
  Qe(e, s, i);
  ...
  for (let [n, r] of d.entries()) {
    let a = nt(r),
      s = z(o?.tabTitlesBySessionId[r], o?.cwdBySessionId[r] || t.cwd, n, d.length, l),
      p = f.get(a);
    if (p != null) {
      p.title !== s && u.updateTab(e, a, { title: s });
      continue;
    }
    u.openTab(e, Ae, {
      activate: !1,
      ...
      onClose: () => {
        c.closeSessionForConversation(t.conversationId, r);
      },
      onMove: (e, n) => {
        ...
        return (
          Ze(e, t, i),
          {
            ...
            props: { ...t, onNewTerminalTab: i === `bottom` ? He : Ue, sessionId: r },
          }
        );
      },
      id: a,
  ...
  r && (u.activateTab(e, nt(n)), P(e, i));
}
function Xe(e, t, n, r) {
  let i = N(r);
  if (!c.getConversationSnapshot(t.conversationId)?.sessionIds.includes(n)) {
    i.closeTab(e, nt(n));
    return;
  }
  (c.setActiveSessionForConversation(t.conversationId, n),
    Ye(e, t, n, !1, r),
    requestAnimationFrame(() => {
      j();
    }));
...
function Ze(e, t, n) {
  ...
  let a = c.subscribeToConversation(t.conversationId, () => {
    let n = c.getConversationSnapshot(t.conversationId);
    if (n == null) {
      let t = Me.get(r);
      if (t != null) {
        for (let n of t.panels) Qe(e, [], n);
        t.unsubscribe();
      }
      Me.delete(r);
      return;
    ...
    let i = Me.get(r);
    if (i != null) for (let t of i.panels) Ye(e, i.target, n.activeSessionId, !1, t);
  });
  Me.set(r, { panels: new Set([n]), target: t, unsubscribe: a });
}
function Qe(e, t, n) {
  let r = N(n),
    i = new Set(t.map(nt));
  for (let t of e.get(r.tabs$)) it(t.tabId) && !i.has(t.tabId) && r.closeTab(e, t.tabId);
  e.get(r.tabs$).length === 0 && F(e, n);
}
function $e(e, t, n) {
  let r = new Set(n),
    i = N(t),
    a = rt(e.get(i.activeTab$)?.tabId ?? null);
  ...
  switch (e.value.routeKind) {
    ...
    case `local-thread`:
      return {
        ...
        conversationTitle: e.get(O, e.value.conversationId),
        cwd: e.get(A),
        hostId: e.get(k),
      };
...
function rt(e) {
  return e?.startsWith(je) ? e.slice(9) : null;
}
function it(e) {
...
//# sourceMappingURL=thread-page-bottom-panel-state-B.js.map
