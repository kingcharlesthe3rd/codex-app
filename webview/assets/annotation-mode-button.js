...
import { t as o } from "./annotate.js";
var s = r(),
  c = e(t(), 1),
  l = n(),
  u = 10,
...
function p(e) {
  ...
  t[13] !== n || t[14] !== A
    ? ((N = n
        ? {
            "--annotation-mode-button-annotation-background": m(`charts-blue`, u),
            "--annotation-mode-button-annotation-hover-background": m(`charts-blue`, A),
          }
        : {}),
      (t[13] = n),
      (t[14] = A),
  ...
  let V = n ? `justify-start` : `w-full justify-center`,
    H;
  t[30] === V ? (H = t[31]) : ((H = i(`flex min-w-0 items-center`, V)), (t[30] = V), (t[31] = H));
  let U;
  t[32] === j
    ? (U = t[33])
    : ((U = i(
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = (0, l.jsx)(o, {
        className: i(`absolute inset-0 size-full rotate-0 scale-100 opacity-100`),
      })),
      (t[34] = W))
    : (W = t[34]);
  let G;
  t[35] === U
    ? (G = t[36])
    : ((G = (0, l.jsx)(`span`, { className: U, children: W })), (t[35] = U), (t[36] = G));
  ...
  let J;
  t[39] !== p || t[40] !== q
    ? ((J = (0, l.jsx)(`span`, { className: q, children: p })),
      (t[39] = p),
      (t[40] = q),
      (t[41] = J))
    : (J = t[41]);
  ...
  t[42] !== H || t[43] !== G || t[44] !== J
    ? ((Y = (0, l.jsxs)(`span`, { className: H, children: [G, J] })),
      (t[42] = H),
      (t[43] = G),
      (t[44] = J),
      (t[45] = Y))
