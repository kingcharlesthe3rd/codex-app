...
import { _ as n, c as r, g as i } from "./app-scope.js";
import { $r as a, Gr as o, Yr as s } from "./src-2.js";
import { S as c, b as l, o as u, r as d, tt as f } from "./app-shell-state.js";
import { Mr as p, t as m } from "./product-logger.js";
...
function v(e, t) {
  ...
  return n === g.BROWSER
    ? t == null
      ? null
      : _(t)
    : (o(n) ?? (e.kind === g.BROWSER ? a(n) : null));
}
function y(e) {
  if (e == null) return !1;
  if (e.kind === g.BROWSER) return !0;
  let t = e.tabId;
  return t === g.BROWSER || s(t);
}
function b(e) {
  if (e == null) return null;
...
function S(e, t) {
  let n = b(t);
  n != null && m(e, p, { routeKind: x(e.value.routeKind), tab: n });
}
function C(e, t, n) {
...
var R = E({ panelId: `right`, panelOpen$: u, setPanelOpen: c }),
  z = E({ panelId: `bottom`, panelOpen$: d, setPanelOpen: l });
