...
import { Ur as a, qr as o, zr as s } from "./src-4.js";
import { Dr as c, o as l } from "./persisted-signal.js";
import { S as u, b as d, et as f, o as p, r as m } from "./app-shell-state.js";
...
function v(e, t) {
  ...
  return n === g.BROWSER
    ? t == null
      ? null
      : _(t)
    : (s(n) ?? (e.kind === g.BROWSER ? o(n) : null));
}
function y(e) {
  if (e == null) return !1;
  if (e.kind === g.BROWSER) return !0;
  let t = e.tabId;
  return t === g.BROWSER || a(t);
}
function b(e) {
  if (e == null) return null;
...
function E({ panelId: e, panelOpen$: t, setPanelOpen: a }) {
  ...
  function R(t, n) {
    ...
    let l = N(e, c);
    c != null && B(t, c);
    let f = r.filter((e) => e !== n);
    (t.set(s, n, null), t.set(o, f), f.length === 0 && a(t, !1));
    let m = k(t, d, f);
    (t.set(d, m),
      t.get(u) === n &&
        (W(t, m[0] ?? D(f, i), !1),
...
var R = E({ panelId: `right`, panelOpen$: p, setPanelOpen: u }),
  z = E({ panelId: `bottom`, panelOpen$: m, setPanelOpen: d });
