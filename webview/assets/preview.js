...
function G(e) {
  ...
  t[5] !== u || t[6] !== d
    ...
    : (f = t[7]);
  let { data: p, isError: m, isLoading: h } = _(`read-file`, f);
  if (!c) return r;
  if (h) {
    let e;
    t[8] === n
      ? (e = t[9])
      : ((e = y(`flex h-full items-center justify-center bg-token-main-surface-primary`, n)),
        (t[8] = n),
        (t[9] = e));
    let r;
    t[10] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, $.jsx)(w, { className: `text-sm` })), (t[10] = r))
      : (r = t[10]);
    let i;
    return (
      t[11] === e
  ...
  return (
    t[13] !== n || t[14] !== p.contents || t[15] !== g
      ? ((v = (0, $.jsx)(K, { className: n, contents: p.contents, filePath: g })),
        (t[13] = n),
        (t[14] = p.contents),
        (t[15] = g),
        (t[16] = v))
...
function K({ className: e, contents: n, filePath: a }) {
  let o = i(),
    c = (0, Q.useMemo)(() => j(n), [n]),
    [d, f] = (0, Q.useState)(0),
    [h, _] = (0, Q.useState)(null),
    [v, y] = (0, Q.useState)(`idle`),
    [b, x] = (0, Q.useState)(0),
    ...
    z = R.find((e) => e.chainId === S) ?? R[0] ?? null,
    B = E?.modelIndex === d ? E : null,
    V = (0, Q.useMemo)(() => ie(z, B), [z, B]),
    H = (0, Q.useMemo)(() => ae(V), [V]),
    U = (0, Q.useMemo)(() => ie(z, A?.modelIndex === d ? A : null), [d, z, A]),
  ...
  function le(e) {
    (C(e), G(null), k(null), M(null));
  }
  function Y(e) {
    z != null && (k(e), G({ chainId: z.chainId, endIndex: e, modelIndex: d, startIndex: e }));
  }
  function X(e) {
    O == null ||
      z == null ||
  ...
  function ue() {
    let e = P.current;
    (k(null), e != null && e.modelIndex === d && M(e));
  }
  function Z(e) {
    if (z == null) return;
    let t = { chainId: z.chainId, endIndex: e, modelIndex: d, startIndex: e };
    (k(null), G(t), M(t));
  }
  function de() {
    (G(null), k(null), M(null), x((e) => e + 1));
  }
  return (
    (0, Q.useEffect)(() => {
      ...
      return (
        ...
        (async () => {
          try {
            ...
            e && (J(h, N.current), (N.current = null), y(`error`));
          }
        })(),
        () => {
    ...
    (0, Q.useEffect)(() => {
      let e = N.current;
      e == null || v !== `idle` || (re(e, H), e.render());
    }, [H, v]),
    (0, Q.useEffect)(() => {
      let e = N.current;
      e == null || v !== `idle` || A == null || W == null || (e.zoomTo(W, 350, !0), e.render());
    }, [W, A, v]),
    F.length === 0 || I == null
      ? (0, $.jsx)(te, {
          className: e,
                  ...
                  ? (0, $.jsx)(p, {
                      ...
                      triggerButton: (0, $.jsxs)(g, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(m, { className: `icon-2xs opacity-65` }),
                        ],
                      }),
                      children: F.map((e, t) =>
                        (0, $.jsx)(
              ...
              children: [
                ...
                v === `loading`
                  ? (0, $.jsx)(`div`, {
                      ...
                      children: (0, $.jsx)(w, { className: `text-sm` }),
                    })
                  : null,
                v === `error`
                  ? (0, $.jsx)(`div`, {
...
function ne(e) {
  ...
  let T = w,
    E;
  t[3] !== n || t[4] !== _ || t[5] !== a || t[6] !== d.chainId
    ? ((E =
        n.length > 1
          ? (0, $.jsx)(p, {
              align: `start`,
              ...
              children: n.map((e) =>
                (0, $.jsx)(
                  ee.Item,
                  {
                    RightIcon: e.chainId === d.chainId ? u : void 0,
                    onSelect: () => a(e.chainId),
                    className: `text-token-text-primary`,
                    children: (0, $.jsx)(r, {
  ...
  t[8] === d.residues.length
    ...
    : ((D = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(r, {
          ...
          values: { count: d.residues.length },
        }),
      })),
      (t[8] = d.residues.length),
      (t[9] = D));
  ...
  t[20] === s
    ...
    : ((M = (e) => {
      ...
      (t[21] = M));
  let N;
  if (t[22] !== _ || t[23] !== c || t[24] !== d.residues || t[25] !== x) {
    let e;
    (t[27] !== _ || t[28] !== c || t[29] !== x
      ? ((e = (e, t) => {
...
function q(e) {
  let t = (0, Z.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = y(`h-2.5 w-2.5 rounded-sm`, r)), (t[0] = r), (t[1] = i));
  let a;
