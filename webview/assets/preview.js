...
function W(e) {
  ...
  if (_) {
    ...
    t[8] === n
      ? (e = t[9])
      : ((e = b(`flex h-full items-center justify-center bg-token-main-surface-primary`, n)),
        (t[8] = n),
        (t[9] = e));
    let r;
    t[10] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Q.jsx)(f, { className: `text-sm` })), (t[10] = r))
      : (r = t[10]);
    let i;
    return (
      t[11] === e
        ? (i = t[12])
        : ((i = (0, Q.jsx)(`div`, { className: e, children: r })), (t[11] = e), (t[12] = i)),
      i
    );
  }
  ...
  return (
    t[13] !== n || t[14] !== h.contents || t[15] !== v
      ? ((y = (0, Q.jsx)(G, { className: n, contents: h.contents, filePath: v })),
        (t[13] = n),
        (t[14] = h.contents),
        (t[15] = v),
        (t[16] = y))
...
function G({ className: e, contents: n, filePath: r }) {
  ...
  function J(e) {
    R != null && (O(e), W({ chainId: R.chainId, endIndex: e, modelIndex: s, startIndex: e }));
  }
  function Y(e) {
    D == null ||
      R == null ||
  ...
  return (
      ...
      return (
        ...
        (async () => {
          try {
            ...
            if (!e) return;
            let r = n(u, { backgroundColor: `white`, disableFog: !0 });
            ((M.current = r),
              r.addModel(I, `pdb`),
              ie(r, null),
              r.zoomTo(),
            ...
            e && (q(u, M.current), (M.current = null), g(`error`));
          }
        })(),
        () => {
          ((e = !1), q(u, M.current), (M.current = null));
        }
      );
    }, [I, b, u]),
    (0, Z.useEffect)(() => {
    ...
    (0, Z.useEffect)(() => {
      let e = M.current;
      e == null || m !== `idle` || k == null || U == null || (e.zoomTo(U, 350, !0), e.render());
    }, [U, k, m]),
    P.length === 0 || F == null
      ? (0, Q.jsx)(ne, {
          className: e,
              ...
              children: [
                ...
                m === `loading`
                  ? (0, Q.jsx)(`div`, {
                      ...
                      children: (0, Q.jsx)(f, { className: `text-sm` }),
                    })
                  : null,
                m === `error`
                  ? (0, Q.jsx)(`div`, {
...
function ne(e) {
  ...
  t[0] === r
    ? (a = t[1])
    : ((a = b(`flex h-full min-h-0 flex-col bg-token-main-surface-primary`, r)),
      (t[0] = r),
      (t[1] = a));
  let o;
  t[2] === i
...
function re(e) {
          ...
          ? (0, Q.jsx)(h, {
              ...
              children: n.map((e) =>
                (0, Q.jsx)(
                  v.Item,
                  {
                    RightIcon: e.chainId === c.chainId ? _ : void 0,
                    ...
                    children: (0, Q.jsx)(y, {
                      ...
                      values: { chainId: Y(e.chainId), count: e.residues.length },
                    }),
                  },
                  e.chainId,
                ),
  ...
  t[20] === a
    ...
    : ((j = (e) => {
        ...
        let t = x(document.elementFromPoint(e.clientX, e.clientY));
        t != null && a(t);
      }),
      (t[20] = a),
      (t[21] = j));
          ...
          return (0, Q.jsx)(
            `button`,
            {
              ...
              "aria-label": d.formatMessage(
                ...
                { chainId: Y(e.chainId), residueName: e.residueName, residueNumber: J(e) },
              ),
              "aria-pressed": n,
              className: b(
...
function K(e) {
  let t = (0, X.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = b(`h-2.5 w-2.5 rounded-sm`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === i ? (a = t[3]) : ((a = (0, Q.jsx)(`span`, { className: i })), (t[2] = i), (t[3] = a));
  let o;
  return (
    t[4] !== n || t[5] !== a
      ? ((o = (0, Q.jsxs)(`span`, {
...
e(() => {
  ((X = r()),
    ...
    (Q = s()),
    a(),
    ($ = { cartoon: { colorscheme: { gradient: `roygb`, max: 100, min: 50, prop: `b` } } }),
