...
function G(e) {
  ...
  t[5] !== u || t[6] !== d
    ...
    : (f = t[7]);
  let { data: p, isError: m, isLoading: h } = b(`read-file`, f);
  if (!c) return r;
  if (h) {
    let e;
    t[8] === n
    ...
    t[10] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, $.jsx)(S, { className: `text-sm` })), (t[10] = r))
      : (r = t[10]);
    let i;
    return (
      t[11] === e
  ...
  return (
    t[13] !== n || t[14] !== p.contents || t[15] !== g
      ? ((_ = (0, $.jsx)(K, { className: n, contents: p.contents, filePath: g })),
        (t[13] = n),
        (t[14] = p.contents),
        (t[15] = g),
        (t[16] = _))
...
function K({ className: e, contents: n, filePath: a }) {
  ...
  function Y(e) {
    z != null && (k(e), G({ chainId: z.chainId, endIndex: e, modelIndex: l, startIndex: e }));
  }
  function X(e) {
    O == null ||
      z == null ||
  ...
  return (
      ...
      return (
        ...
        (async () => {
          try {
            ...
            if (!e) return;
            let r = n(m, { backgroundColor: `white`, disableFog: !0 });
            ((N.current = r),
              r.addModel(L, `pdb`),
              re(r, null),
              r.zoomTo(),
            ...
            e && (J(m, N.current), (N.current = null), v(`error`));
          }
        })(),
        () => {
          ((e = !1), J(m, N.current), (N.current = null));
        }
      );
    }, [L, y, m]),
    (0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      let e = N.current;
      e == null || _ !== `idle` || A == null || W == null || (e.zoomTo(W, 350, !0), e.render());
    }, [W, A, _]),
    F.length === 0 || I == null
      ? (0, $.jsx)(te, {
          className: e,
                  ...
                  ? (0, $.jsx)(u, {
                      ...
                      triggerButton: (0, $.jsxs)(p, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(c, { className: `icon-2xs opacity-65` }),
                        ],
                      }),
                      children: F.map((e, t) =>
                        (0, $.jsx)(
              ...
              children: [
                ...
                _ === `loading`
                  ? (0, $.jsx)(`div`, {
                      ...
                      children: (0, $.jsx)(S, { className: `text-sm` }),
                    })
                  : null,
                _ === `error`
                  ? (0, $.jsx)(`div`, {
...
function ne(e) {
  ...
  let T = w,
    E;
  t[3] !== n || t[4] !== _ || t[5] !== a || t[6] !== f.chainId
    ? ((E =
        n.length > 1
          ? (0, $.jsx)(u, {
              align: `start`,
              ...
              children: n.map((e) =>
                (0, $.jsx)(
                  i.Item,
                  {
                    RightIcon: e.chainId === f.chainId ? h : void 0,
  ...
  t[20] === s
    ...
    : ((M = (e) => {
      ...
      (t[21] = M));
  let N;
  if (t[22] !== _ || t[23] !== l || t[24] !== f.residues || t[25] !== x) {
    let e;
    (t[27] !== _ || t[28] !== l || t[29] !== x
      ? ((e = (e, t) => {
