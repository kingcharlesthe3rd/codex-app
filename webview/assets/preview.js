const __vite__mapDeps = (i, m = __vite__mapDeps, d = m.f || (m.f = ["./3Dmol.js", "./chunk.js"])) =>
  i.map((i) => d[i]);
import { s as e } from "./chunk.js";
import { n as t, t as n } from "./jsx-runtime.js";
import { Z as r } from "./app-scope-CWE-zIhQ.js";
import { o as i } from "./vscode-api.js";
import "./isEqual.js";
import "./src.js";
...
import { n as f } from "./use-resize-observer.js";
...
function k(e, t) {
  let n = new Set(
      e.map((e) => [e.chainId, e.residueName, e.residueNumber, e.insertionCode].join(`:`)),
    ),
...
var F = n(),
  I = { cartoon: { colorscheme: { gradient: `roygb`, max: 100, min: 50, prop: `b` } } },
  L = { stick: { radius: 0.12 } },
  R = {
    cartoon: { colorscheme: { gradient: `roygb`, max: 100, min: 50, prop: `b` }, opacity: 0.34 },
  },
  z = { stick: { hidden: !0 } },
  B = { cartoon: { color: `#f97316` }, stick: { color: `#f97316`, radius: 0.12 } },
  ee = [];
function V(e) {
  let t = (0, _.c)(19),
    { className: n, fallback: r, hostId: a, path: o, showFileName: s } = e,
    l = s === void 0 ? !1 : s,
    u = o != null && o.length > 0,
    d = o ?? ``,
    f;
  t[0] === a ? (f = t[1]) : ((f = a == null ? {} : { hostId: a }), (t[0] = a), (t[1] = f));
  let p;
  t[2] !== d || t[3] !== f
  ...
  t[7] !== p || t[8] !== m
    ...
    : (h = t[9]);
  let { data: v, isError: y, isLoading: b } = i(`read-file`, h);
  if (!u) return r;
  if (b) {
    let e;
    t[10] === n
      ? (e = t[11])
      : ((e = c(`flex h-full items-center justify-center bg-token-main-surface-primary`, n)),
        (t[10] = n),
        (t[11] = e));
    let r;
    ...
    return (
      t[13] === e
        ? (i = t[14])
        : ((i = (0, F.jsx)(`div`, { className: e, children: r })), (t[13] = e), (t[14] = i)),
      i
    );
  }
  ...
  return (
    t[15] !== n || t[16] !== v.contents || t[17] !== x
      ? ((S = (0, F.jsx)(H, { className: n, contents: v.contents, filePath: x })),
        (t[15] = n),
        (t[16] = v.contents),
        (t[17] = x),
        (t[18] = S))
...
function H({ className: t, contents: n, filePath: r }) {
  let i = o(),
    c = (0, v.useMemo)(() => S(n), [n]),
    [_, y] = (0, v.useState)(0),
    ...
    q = k?.modelIndex === _ ? k : null,
    Y = (0, v.useMemo)(() => K(H, q), [H, q]),
    X = (0, v.useMemo)(() => ne(Y), [Y]),
    Z = (0, v.useMemo)(() => K(H, N?.modelIndex === _ ? N : null), [_, H, N]),
    Q = (0, v.useMemo)(() => ne(Z), [Z]);
  function $(e) {
    ((L.current = e), A(e));
  }
  (0, v.useEffect)(() => {
  ...
  function se(e) {
    (O(e), $(null), M(null), P(null));
  }
  function ce(e) {
    H != null && (M(e), $({ chainId: H.chainId, endIndex: e, modelIndex: _, startIndex: e }));
  }
  function le(e) {
    j == null ||
      H == null ||
      ...
      return (
        ...
        (async () => {
          try {
            ...
            if (!t) return;
            let r = n(b, { backgroundColor: `white`, disableFog: !0 });
            ((I.current = r),
              r.addModel(B, `pdb`),
              G(r, null),
              r.zoomTo(),
            ...
            t && (J(b, I.current), (I.current = null), w(`error`));
          }
        })(),
        () => {
          ((t = !1), J(b, I.current), (I.current = null));
        }
      );
    }, [B, T, b]),
    (0, v.useEffect)(() => {
      let e = I.current;
      e == null || C !== `idle` || (G(e, X), e.render());
    }, [X, C]),
    (0, v.useEffect)(() => {
      let e = I.current;
      e == null || C !== `idle` || N == null || Q == null || (e.zoomTo(Q, 350, !0), e.render());
    }, [Q, N, C]),
    R.length === 0 || z == null
      ? (0, F.jsx)(U, {
          className: t,
                  ...
                  ? (0, F.jsx)(m, {
                      ...
                      triggerButton: (0, F.jsxs)(l, {
                        ...
                        children: [
                          ...
                          (0, F.jsx)(d, { className: `icon-2xs opacity-65` }),
                        ],
                      }),
                      children: R.map((e, t) =>
                        (0, F.jsx)(
                  ...
                  children: [
                    ...
                    (0, F.jsx)(`span`, {
                      children: (0, F.jsx)(s, {
                        ...
                        values: { mean: ie(z.stats.meanScore) },
                      }),
                    }),
                  ],
                }),
...
function U(e) {
  ...
  t[0] === r
    ? (a = t[1])
    : ((a = c(`flex h-full min-h-0 flex-col bg-token-main-surface-primary`, r)),
      (t[0] = r),
      (t[1] = a));
  let o;
  t[2] === i
  ...
  return (
    t[4] !== n || t[5] !== a || t[6] !== o
      ? ((s = (0, F.jsxs)(`div`, { className: a, children: [o, n] })),
        (t[4] = n),
        (t[5] = a),
        (t[6] = o),
        (t[7] = s))
...
function te(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = function (e) {
        ...
        if (t == null || !(n instanceof HTMLElement) || !t.contains(n)) return null;
          ...
          ? (0, F.jsx)(m, {
              ...
              children: n.map((e) =>
                (0, F.jsx)(
                  p.Item,
                  {
                    RightIcon: e.chainId === g.chainId ? u : void 0,
                    ...
                    children: (0, F.jsx)(s, {
                      ...
                      values: { chainId: Z(e.chainId), count: e.residues.length },
                    }),
                  },
                  e.chainId,
                ),
  ...
  t[20] === a
    ...
    : ((I = (e) => {
      ...
      (t[21] = I));
  let L;
  if (t[22] !== x || t[23] !== f || t[24] !== g.residues || t[25] !== w) {
    let e;
    (t[27] !== x || t[28] !== f || t[29] !== w
      ? ((e = (e, t) => {
          ...
          return (0, F.jsx)(
            `button`,
            {
              ...
              "aria-label": x.formatMessage(
                ...
                { chainId: Z(e.chainId), residueName: e.residueName, residueNumber: X(e) },
              ),
              "aria-pressed": n,
              className: c(
              ...
              title: x.formatMessage(
                ...
                { residueName: e.residueName, residueNumber: X(e) },
              ),
...
function W(e) {
  let t = (0, _.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = c(`h-2.5 w-2.5 rounded-sm`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === i ? (a = t[3]) : ((a = (0, F.jsx)(`span`, { className: i })), (t[2] = i), (t[3] = a));
  let o;
  return (
    t[4] !== n || t[5] !== a
      ? ((o = (0, F.jsxs)(`span`, {
...
function G(e, t) {
  ...
  let n = { not: t };
  (e.setStyle(n, R), e.addStyle({ and: [n, { hetflag: !1 }] }, z), e.setStyle(t, B));
}
function K(e, t) {
...
function ne(e) {
  ...
  return t.length > 0 ? { serial: t } : { or: e.map(q) };
}
function q(e) {
  return { chain: e.chainId, icode: e.insertionCode, resi: e.residueNumber, resn: e.residueName };
}
function re(e) {
  let t = e,
    n =
...
export { V as PdbPreviewFromFile };
