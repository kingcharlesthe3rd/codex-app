const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./3Dmol.js", "./chunk-Bj-mKKzh.js"]),
) => i.map((i) => d[i]);
...
import { lt as a, o } from "./vscode-api.js";
...
function V(e) {
  let t = (0, _.c)(19),
    { className: n, fallback: r, hostId: a, path: s, showFileName: c } = e,
    l = c === void 0 ? !1 : c,
    u = s != null && s.length > 0,
    d = s ?? ``,
    f;
  ...
  t[7] !== p || t[8] !== m
    ...
    : (h = t[9]);
  let { data: v, isError: y, isLoading: b } = o(`read-file`, h);
  if (!u) return r;
  if (b) {
    let e;
    t[10] === n
      ? (e = t[11])
      : ((e = i(`flex h-full items-center justify-center bg-token-main-surface-primary`, n)),
        (t[10] = n),
        (t[11] = e));
    let r;
    ...
    return (
      t[13] === e
        ? (a = t[14])
        : ((a = (0, F.jsx)(`div`, { className: e, children: r })), (t[13] = e), (t[14] = a)),
      a
    );
  }
  if (y || v == null) return r;
  let x = l ? (s ?? void 0) : void 0,
    S;
  return (
      ...
      return (
        ...
        (async () => {
          try {
            ...
            n && (J(b, I.current), (I.current = null), w(`error`));
          }
        })(),
        () => {
          ((n = !1), J(b, I.current), (I.current = null));
        }
      );
    }, [B, T, b]),
    (0, v.useEffect)(() => {
...
function W(e) {
  let t = (0, _.c)(7),
    ...
    a;
  t[0] === r ? (a = t[1]) : ((a = i(`h-2.5 w-2.5 rounded-sm`, r)), (t[0] = r), (t[1] = a));
  let o;
  t[2] === a ? (o = t[3]) : ((o = (0, F.jsx)(`span`, { className: a })), (t[2] = a), (t[3] = o));
  let s;
  return (
    t[4] !== n || t[5] !== o
      ? ((s = (0, F.jsxs)(`span`, {
