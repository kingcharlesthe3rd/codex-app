...
function G(e) {
  ...
  t[5] !== d || t[6] !== f
    ...
    : (p = t[7]);
  let { data: h, isError: g, isLoading: _ } = m(`read-file`, p);
  if (!l) return r;
  if (_) {
    let e;
    t[8] === n
    ...
    return (
      t[11] === e
        ? (a = t[12])
        : ((a = (0, $.jsx)(`div`, { className: e, children: r })), (t[11] = e), (t[12] = a)),
      a
    );
  }
  ...
  return (
    t[13] !== n || t[14] !== h.contents || t[15] !== v
      ? ((y = (0, $.jsx)(K, { className: n, contents: h.contents, filePath: v })),
        (t[13] = n),
        (t[14] = h.contents),
        (t[15] = v),
        (t[16] = y))
      ...
      return (
        ...
        (async () => {
          try {
            ...
            if (!e) return;
            let i = n(f, { backgroundColor: `white`, disableFog: !0 });
            ((N.current = i),
              i.addModel(L, `pdb`),
              re(i, null),
              i.zoomTo(),
            ...
            e && (J(f, N.current), (N.current = null), h(`error`));
          }
        })(),
        () => {
          ((e = !1), J(f, N.current), (N.current = null));
        }
      );
    }, [L, g, f]),
    (0, Q.useEffect)(() => {
      let e = N.current;
      e == null || m !== `idle` || (re(e, H), e.render());
    }, [H, m]),
    (0, Q.useEffect)(() => {
      let e = N.current;
      e == null || m !== `idle` || A == null || W == null || (e.zoomTo(W, 350, !0), e.render());
    }, [W, A, m]),
    F.length === 0 || I == null
      ? (0, $.jsx)(te, {
          className: e,
                  ...
                  ? (0, $.jsx)(s, {
                      ...
                      triggerButton: (0, $.jsxs)(o, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(u, { className: `icon-2xs opacity-65` }),
                        ],
                      }),
                      children: F.map((e, t) =>
                        (0, $.jsx)(
...
function te(e) {
  ...
  return (
    t[4] !== n || t[5] !== o || t[6] !== s
      ? ((c = (0, $.jsxs)(`div`, { className: o, children: [s, n] })),
        (t[4] = n),
        (t[5] = o),
        (t[6] = s),
        (t[7] = c))
...
function ne(e) {
  ...
  let T = w,
    E;
  t[3] !== n || t[4] !== h || t[5] !== r || t[6] !== f.chainId
    ? ((E =
        n.length > 1
          ? (0, $.jsx)(s, {
              align: `start`,
  ...
  t[20] === c
    ...
    : ((M = (e) => {
      ...
      (t[21] = M));
  let N;
  if (t[22] !== h || t[23] !== l || t[24] !== f.residues || t[25] !== x) {
    let e;
    (t[27] !== h || t[28] !== l || t[29] !== x
      ? ((e = (e, t) => {
