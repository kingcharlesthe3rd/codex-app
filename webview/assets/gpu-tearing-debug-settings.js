...
import { Z as r, g as i, o as a, s as o, t as s } from "./app-scope-CWE-zIhQ.js";
import "./use-host-config-C.js";
import { A as c, o as l, r as u } from "./vscode-api.js";
import { Aa as d, Ta as f, ca as p, ga as m, ha as h, k as g, la as _, ta as v } from "./src-1.js";
import { i as y, l as b, s as x } from "./lib-1.js";
import { t as S } from "./button.js";
import { a as C, r as w, s as T } from "./setting-storage.js";
...
import { A as j, I as M } from "./rpc-1.js";
import { t as N, tn as ee } from "./product-logger.js";
import { a as P, m as F, r as I } from "./sidebar-signals.js";
import { d as L, g as R, l as te, m as ne, u as z } from "./diff-view-mode.js";
import { a as B, i as re, l as ie, n as ae } from "./dialog-layout.js";
import { t as oe } from "./x-circle.js";
import { t as se } from "./format-relative-date-time.js";
import { t as ce } from "./alert-1.js";
import { r as V } from "./settings-row.js";
...
import { t as we } from "./scroll-to-bottom-buton.js";
import { t as W } from "./settings-group.js";
import { n as Te, t as Ee } from "./external-agent-config-paths.js";
var De = `external-agent-config-import-settings`,
  ...
  Me = f({
    ...
    theme: f({
      accent: q,
      contrast: p().int().min(0).max(100),
      fonts: f({ code: je, ui: je }),
      ink: q,
      opaqueWindows: h(),
      semanticColors: f({ diffAdded: q, diffRemoved: q, skill: q }),
      surface: q,
    }),
    variant: _([`light`, `dark`]),
  });
function Ne(e) {
  let t = a(s),
    { chromeThemeSetting: n, codeThemeSetting: r } = Fe(e),
    i = C(n),
    o = C(r),
    c = R(i, e),
    l = L(e),
    u = { codeThemeId: z(o, e).id, theme: c },
    d = (0, G.useRef)(u),
    f = (0, G.useRef)(u),
    p = (0, G.useRef)(0),
    m = (0, G.useRef)(Promise.resolve());
  p.current === 0 && ((d.current = u), (f.current = u));
  let h = (0, G.useCallback)(
      (e) => {
        ((d.current = e), w(t, n, e.theme), w(t, r, e.codeThemeId));
      },
      [n, r, t],
    ),
    g = (0, G.useCallback)(
      async (e, t) => {
        ...
        let n = async () => {
            try {
              ...
              throw (Ie(d.current, e) && h(f.current), t);
            } finally {
              --p.current;
            }
          },
    ...
    _ = (0, G.useCallback)(
      async (e) => {
        await g(e, async () => {
          ...
          await T(n, e.theme);
          try {
            await T(r, e.codeThemeId);
          } catch (e) {
            throw (await T(n, t.theme).catch(() => void 0), e);
          }
          f.current = e;
        });
      },
      ...
      async (e) => {
        ...
        await g(t, async () => {
          ...
          if (i.codeThemeId !== t.codeThemeId) {
            await T(r, t.codeThemeId);
            try {
              await T(n, e);
            } catch (e) {
              throw (await T(r, i.codeThemeId).catch(() => void 0), e);
            }
            f.current = t;
            return;
          }
          (await T(n, e), (f.current = t));
        });
      },
      [n, r, g],
    ),
    y = (0, G.useCallback)(
      (e) => {
        v(J(d.current.theme, e)).catch(() => void 0);
      },
      [v],
    ),
    b = (0, G.useCallback)(
      (e) => {
        v(J(d.current.theme, { fonts: e })).catch(() => void 0);
      },
      [v],
    ),
    x = (0, G.useCallback)(
      async (t) => {
        let n = await te(t, e);
        await _({ codeThemeId: t, theme: J(d.current.theme, n) });
      },
      [_, e],
    ),
    S = (0, G.useCallback)(
      () => Re({ codeThemeId: d.current.codeThemeId, theme: d.current.theme, variant: e }),
      [e],
    ),
    E = (0, G.useCallback)(
      (t) => {
  ...
  return {
    ...
    fonts: O.theme.fonts,
    importThemeString: D,
    selectedCodeTheme: z(O.codeThemeId, e),
    setCodeThemeId: x,
    setFontsPatch: b,
    setThemePatch: y,
    theme: O.theme,
...
function Pe(e, t, n) {
  ...
  return { codeThemeId: i.id, theme: R(r.theme, t) };
}
function Fe(e) {
  return e === `light`
    ? { chromeThemeSetting: g.lightChromeTheme, codeThemeSetting: g.lightCodeThemeId }
    : { chromeThemeSetting: g.darkChromeTheme, codeThemeSetting: g.darkCodeThemeId };
}
function J(e, t) {
  return {
    ...e,
...
function Ie(e, t) {
  return e.codeThemeId === t.codeThemeId && Le(e.theme, t.theme);
}
function Le(e, t) {
  return (
    e.accent === t.accent &&
...
function Re(e) {
  return `${ke}${JSON.stringify(e)}`;
}
function ze(e) {
  let t = e.trim();
  if (!t.startsWith(ke)) throw Error(`Theme share string mismatch`);
  let n = t.slice(15),
    r = n.startsWith(`{`) ? n : decodeURIComponent(n);
  return Me.parse(JSON.parse(r));
}
var Y = r();
function Be(e) {
  let t = (0, Y.c)(7),
...
var X = y({
    ...
    realtimeVoiceHotkey: {
      ...
      defaultMessage: `Realtime voice hotkey`,
      description: `Label for realtime voice hotkey setting`,
    },
    realtimeVoiceWakeWord: {
      id: `settings.general.realtimeVoiceWakeWord.label`,
      defaultMessage: `Wake word`,
      description: `Label for realtime voice wake word setting`,
    },
    realtimeVoiceAvatar: {
    ...
    realtimeVoiceSingletonOrchestratorThread: {
      id: `settings.general.realtimeVoiceSingletonOrchestratorThread.label`,
      defaultMessage: `Singleton voice thread`,
      description: `Label for toggling whether realtime voice uses one backing orchestrator thread`,
    },
  ...
  Z = `external-agent-import`,
  Ve = { importedSessionCount: 0, latestImportedAtMs: null };
function He(e) {
  let t = (0, Y.c)(68),
    {
      codexHome: n,
  ...
  t[4] !== m.importChoices || t[5] !== f
    ? ((g = m.importChoices.length === 0 ? null : he(f, m.importChoices)),
      (t[4] = m.importChoices),
      (t[5] = f),
      (t[6] = g))
    : (g = t[6]);
  ...
  t[9] !== m.providerIds || t[10] !== _ || t[11] !== y
    ? ((C = (e) => {
        _ != null && y({ source: `settings`, action: e, ...ue(_, ve(_), m.providerIds) });
      }),
      (t[9] = m.providerIds),
      (t[10] = _),
      (t[11] = y),
  ...
  let j = A,
    M;
  t[24] !== m || t[25] !== y || t[26] !== j || t[27] !== k || t[28] !== u
    ? ((M =
    ...
    : (M = t[29]);
  let P;
  t[30] !== m.isImportDialogOpen || t[31] !== m.setImportDialogOpen || t[32] !== M
    ? ((P = (0, K.jsx)(ie, {
  ...
  if (u === `general-row`) {
    ...
    t[34] !== n || t[35] !== m.closeCompletedImportDialog || t[36] !== a
      ? ((o = (0, K.jsx)(Q, { progress: a, codexHome: n, onClose: m.closeCompletedImportDialog })),
        (t[34] = n),
    ...
    t[38] === r
      ? (c = t[39])
      : ((c = r
          ? (0, K.jsx)(x, { ...X.importedAgentSetup })
          : (0, K.jsx)(x, { ...X.externalAgentImport })),
        (t[38] = r),
        (t[39] = c));
    let l;
    ...
    t[53] !== c || t[54] !== l || t[55] !== p
      ? ((g = (0, K.jsx)(V, { id: De, label: c, description: l, control: p })),
        (t[53] = c),
        (t[54] = l),
        (t[55] = p),
        (t[56] = g))
    ...
    return (
      t[57] !== s || t[58] !== g || t[59] !== v
        ? ((y = (0, K.jsxs)(K.Fragment, { children: [g, v, s] })),
          (t[57] = s),
          (t[58] = g),
          (t[59] = v),
          (t[60] = y))
  ...
  let L;
  return (
    t[62] !== m.isImporting || t[63] !== F || t[64] !== _ || t[65] !== h || t[66] !== D
      ? ((L = (0, K.jsx)(K.Fragment, {
          children: (0, K.jsxs)(W, {
            className: `gap-2`,
            children: [
              I,
                ...
                children: h
                  ? (0, K.jsx)(H, {
                      children: (0, K.jsx)(V, {
                        ...
                        control: (0, K.jsx)(E, { className: `h-4 w-4` }),
                      }),
                    })
                  : (0, K.jsx)(H, {
                      children:
...
function We({ hostId: e, onImportSuccess: t, workspaceRoots: n }) {
  let r = a(s),
    i = c(),
    d = o(I),
    f = xe({ enabled: !0, workspaceRoots: n }),
    p = ye(f.detectedItems),
    m =
      l(`external-agent-import-status`, {
        params: { hostId: e, providers: me },
    ...
    [D, O] = (0, G.useState)(!1),
    [A, j] = (0, G.useState)(`items`),
    [M, N] = (0, G.useState)([]),
    [ee, L] = (0, G.useState)(`idle`),
    R = Ue([m.latestImportedAtMs, S]),
    te = y ? w : R,
    ne = f.isImporting || y,
    z = (e) => {
      (N(e), j(`items`));
    },
    B = async ({ providerIds: n, selection: a }) => {
      if ((L(`idle`), !f.hasImportableItems)) {
        O(!1);
        return;
      }
      let o =
        n.length === 0
          ...
          : pe({ detectedItems: f.detectedItems, providerIds: n, selection: a });
      if (o.length === 0) {
        O(!1);
        return;
      }
          ...
          content: ({ close: e, level: t }) =>
            (0, K.jsx)(ce, {
              ...
              children: (0, K.jsxs)(`div`, {
                ...
                children: [
                  (0, K.jsx)(E, { className: `icon-sm text-token-text-secondary` }),
                  (0, K.jsx)(x, {
        ...
        ((l = n.length),
          ...
          await le({
            ...
            onImportedProjectRootsReady: (e) => {
              F(r, P({ collapsedGroups: d, importedProjectRoots: e }));
            },
...
function Ge(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, K.jsx)(`div`, { className: `shrink-0 font-medium`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function Q(e) {
  ...
  let v = r?.status,
    y;
  t[10] === v ? (y = t[11]) : ((y = Ze(v)), (t[10] = v), (t[11] = y));
  let x = r?.status,
    S;
  t[12] === x ? (S = t[13]) : ((S = Qe(x)), (t[12] = x), (t[13] = S));
  let C;
  t[14] === r ? (C = t[15]) : ((C = $e(r)), (t[14] = r), (t[15] = C));
  let w;
  t[16] === r ? (w = t[17]) : ((w = et(r)), (t[16] = r), (t[17] = w));
  let T;
    ...
    ? ((E =
        r != null && r.items.length > 0
          ? (0, K.jsx)(B, {
              ...
              children: (0, K.jsx)(Ke, { codexHome: n, items: r.items, status: r.status }),
            })
          : null),
      (t[23] = n),
      (t[24] = r),
  ...
  t[36] !== D || t[37] !== A
    ? ((j = (0, K.jsx)(ae, {
        ...
        children: (0, K.jsxs)(`div`, { className: `relative min-h-0`, children: [D, A] }),
      })),
      (t[36] = D),
      (t[37] = A),
      (t[38] = j))
...
function Ke(e) {
        ...
        e.length > 0
          ? (0, K.jsxs)(K.Fragment, {
              children: [
                ...
                e.map((e) => (0, K.jsx)(Ye, { codexHome: n, item: e, status: i }, it(e))),
              ],
            })
          : null),
      (s =
        c.length > 0
          ? (0, K.jsxs)(K.Fragment, {
              children: [
                ...
                c.map((e) => (0, K.jsx)(Ye, { codexHome: n, item: e, status: i }, it(e))),
              ],
            })
          : null),
      (t[0] = n),
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== s
      ? ((c = (0, K.jsxs)(a, { children: [o, s] })), (t[6] = a), (t[7] = o), (t[8] = s), (t[9] = c))
      : (c = t[9]),
    c
  );
}
...
function Ye(e) {
  ...
  let s;
  t[3] !== n || t[4] !== r || t[5] !== i
    ? ((s = tt(r, n, i)), (t[3] = n), (t[4] = r), (t[5] = i), (t[6] = s))
    : (s = t[6]);
  let c;
  t[7] === i ? (c = t[8]) : ((c = (0, K.jsx)(Xe, { status: i })), (t[7] = i), (t[8] = c));
  let l;
  return (
    t[9] !== o || t[10] !== s || t[11] !== c
      ? ((l = (0, K.jsx)(V, { label: o, description: s, control: c })),
        (t[9] = o),
        (t[10] = s),
        (t[11] = c),
        (t[12] = l))
    ...
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, K.jsx)(`span`, {
            ...
            children: (0, K.jsx)(D, { className: `icon-2xs text-token-success` }),
          })),
          (t[1] = e))
        : (e = t[1]),
      e
  ...
  return (
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, K.jsx)(`span`, {
          ...
          children: (0, K.jsx)(A, { className: `icon-2xs text-token-editor-error-foreground` }),
        })),
        (t[2] = r))
      : (r = t[2]),
    r
...
function Ze(e) {
  return e === `success`
    ? (0, K.jsx)(D, { className: `icon-md text-token-charts-green` })
    : e === `error`
      ? (0, K.jsx)(oe, { className: `icon-md text-token-danger` })
      : (0, K.jsx)(E, { className: `icon-md` });
}
function Qe(e) {
  return e === `success`
...
function tt(e, t, n) {
  let r = n === `success` ? nt(e) : e.description;
  if (e.cwd == null || e.cwd === ``) {
    let e = r
    ...
    if (t != null && t !== ``) {
      ...
      ((e = e.split(t).join(`~/.codex`)),
        (e = e.split(Te(n, `.claude`)).join(`~/.claude`)),
        (e = e.split(Te(n, `.agents`)).join(`~/.agents`)));
    }
    return M(e);
  }
  let i = rt(e.cwd);
...
function rt(e) {
  return e == null || e === `` ? null : j(e) || e;
}
function it(e) {
  return `${e.itemType}:${e.cwd ?? ``}:${e.description}`;
}
var at = `wsl_remote_connections`;
function ot(e) {
  return v(e, at) === !0;
}
var $ = i(s, {
...
export { He as a, Ne as c, Q as i, Oe as l, st as n, X as o, ot as r, Be as s, $ as t, De as u };
