...
import { D as t, Di as n, Ei as r, Hi as i, Ni as a, Pi as o, Qi as s, qi as c } from "./src-C.js";
import { Ia as l, Va as u } from "./app-server-manager-signals.js";
...
import { t as de } from "./alert-1.js";
...
function pt(e) {
  ...
  t[9] !== v.remainingArtifacts
    ? ((b =
        !v.isImporting && v.isRemainingArtifactsDialogOpen
          ? { status: `success`, items: [], remainingArtifacts: v.remainingArtifacts }
          : null),
      (t[7] = v.isImporting),
      (t[8] = v.isRemainingArtifactsDialogOpen),
      (t[9] = v.remainingArtifacts),
  ...
  t[21] !== v.providerIds || t[22] !== D || t[23] !== k
    ? ((A = (e) => {
        D != null && k({ source: `settings`, action: e, ...he(D, we(D), v.providerIds) });
      }),
      (t[21] = v.providerIds),
      (t[22] = D),
      (t[23] = k),
  ...
  let I = F,
    L;
  t[31] !== v.detectedItems || t[32] !== v.selectedImportProviderIds || t[33] !== D || t[34] !== f
    ? ((L =
  ...
  t[36] !== v || t[37] !== k || t[38] !== R || t[39] !== I || t[40] !== u
    ...
    : (z = t[41]);
  let B;
  t[42] !== v.isImportDialogOpen || t[43] !== v.setImportDialogOpen || t[44] !== z
    ? ((B = (0, Y.jsx)(ne, {
  ...
  if (u === `general-row`) {
    ...
    if (!y && !e && !i && !a) return C;
    let s = v.isCompletedImportDialogOpen ? v.lastCompletedImportProgress : null,
      c;
    t[46] !== n ||
    ...
    let f = y || v.isImporting || (!e && (!i || !a)),
      p = !e && a ? v.openCompletedImportDialog : r ? v.openRemainingArtifactsDialog : P,
      m;
    t[56] !== v.isImporting || t[57] !== e || t[58] !== i || t[59] !== y || t[60] !== r
      ? ((m = v.isImporting
          ? (0, Y.jsx)(g, {
                    ...
                    T
                      ? (0, Y.jsx)(K, {
                          label: (0, Y.jsx)(g, {
                            ...
                            values: { count: v.selectedRemainingArtifacts.length },
                          }),
                          description: (0, Y.jsx)(g, {
                          ...
                          control: (0, Y.jsxs)(M, {
                            ...
                            onClick: () => {
                              v.migrateRemainingArtifacts(v.selectedRemainingArtifacts);
                            },
                            children: [
                              (0, Y.jsx)(`span`, {
                                children: (0, Y.jsx)(g, {
...
function ht({
  ...
  let o = _(h),
    ...
    { ensureSkillByName: p, installSkill: y } = fe({ hostId: t, loadOnMount: !1 }),
    ...
    we = async ({ providerIds: n, selection: r }) => {
      ...
      let a =
        n.length === 0
          ...
          : be({ detectedItems: b.detectedItems, providerIds: n, selection: r });
      if (a.length === 0) {
        G(!1);
        return;
      }
      ...
      try {
        ...
        ((d = `invalidate_queries`),
          await Promise.all([
            ...
            n.length === 0
              ? Promise.resolve()
              : s.invalidateQueries({ queryKey: w(`workspace-root-options`, { hostId: t }) }),
          ]));
        let h = {
          status: `success`,
          items: a,
