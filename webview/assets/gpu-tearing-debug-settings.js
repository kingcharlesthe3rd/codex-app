...
import { A as d, Fi as f, Hi as p, Pi as m, Vi as h, Zi as g, na as _ } from "./src-1.js";
import { c as v, o as y, r as b } from "./lib.js";
import { Wt as x, o as S } from "./persisted-signal.js";
import { t as C } from "./button-DO-oxX3-.js";
import { a as w, r as T, s as E } from "./setting-storage.js";
import { t as D } from "./spinner.js";
import { t as O } from "./check-md.js";
import { t as k } from "./use-stable-callback.js";
import { A, F as j } from "./rpc-1.js";
import { a as M, h as N, r as P } from "./sidebar-signals.js";
import { r as F } from "./toast-signal.js";
import { t as I } from "./x.js";
import { d as L, g as R, l as z, m as ee, u as B } from "./diff-view-mode.js";
import { a as V, i as te, l as ne, n as re } from "./dialog-layout.js";
import { t as ie } from "./x-circle.js";
import { t as ae } from "./format-relative-date-time.js";
import { t as oe } from "./alert-1.js";
import { n as H } from "./settings-row.js";
import { n as U, t as W } from "./settings-group.js";
import {
  _ as se,
  a as ce,
  b as le,
...
import { t as Ce } from "./scroll-to-bottom-buton.js";
var we = `external-agent-config-import-settings`,
  G = e(t(), 1);
function K() {
  return (K =
    Object.assign ||
...
var q = function (e, t, n) {
  ...
  Oe = function (e, t, n) {
    var r = e.getBoundingClientRect(),
      i = J(t)
        ...
        : t;
    return {
      left: q((i.pageX - (r.left + De(e).pageXOffset)) / r.width),
      top: q((i.pageY - (r.top + De(e).pageYOffset)) / r.height),
    };
  },
  ke = function (e) {
    !J(e) && e.preventDefault();
  },
  Ae = G.memo(function (e) {
    var t = e.onMove,
      n = e.onKey,
      r = Te(e, [`onMove`, `onKey`]),
      i = (0, G.useRef)(null),
          ...
          return [
            function (e) {
              ...
              if (
                ...
                (r.focus(), a(Oe(r, t, s.current)), n(!0));
              }
            },
            function (e) {
  ...
  Me = function (e) {
    var t = e.color,
      ...
      r = e.top,
      i = r === void 0 ? 0.5 : r,
      a = je([`react-colorful__pointer`, e.className]);
...
var Ne = function (e) {
  ...
  Ve = G.memo(function (e) {
    var t = e.hue,
      n = e.onChange,
      r = je([`react-colorful__hue`, e.className]);
    return G.createElement(
      `div`,
      { className: r },
      G.createElement(
  ...
  He = G.memo(function (e) {
    var t = e.hsva,
      n = e.onChange,
      r = { backgroundColor: Le({ h: t.h, s: 100, v: 100, a: 1 }) };
    return G.createElement(
      `div`,
  ...
  We = function (e, t) {
    return e.toLowerCase() === t.toLowerCase() || Ue(Pe(e), Pe(t));
  };
function Ge(e, t, n) {
  var r = Ee(n),
...
var Ke,
  qe = typeof window < `u` ? G.useLayoutEffect : G.useEffect,
  Je = function () {
  ...
  Ze = function (e) {
    var t = e.className,
      ...
      a = e.onChange,
      o = Te(e, [`className`, `colorModel`, `color`, `onChange`]),
      s = (0, G.useRef)(null);
    Xe(s);
    var c = Ge(n, i, a),
      l = c[0],
      u = c[1],
      d = je([`react-colorful`, t]);
    return G.createElement(
      `div`,
      K({}, o, { ref: s, className: d }),
      G.createElement(He, { hsva: l, onChange: u }),
      G.createElement(Ve, { hue: l.h, onChange: u, className: `react-colorful__last-control` }),
    );
  },
  Qe = {
    defaultColor: `000`,
  ...
  $e = function (e) {
    return G.createElement(Ze, K({}, e, { colorModel: Qe }));
  },
  Z = n(),
  et = (e) =>
    (0, Z.jsx)(`svg`, {
  ...
  tt = `codex-theme-v1:`,
  nt = p((e) => typeof e == `string` && ee(e)),
  Q = _().regex(/^#[0-9a-fA-F]{6}$/),
  rt = _().nullable(),
  it = g({
    codeThemeId: nt,
    theme: g({
      accent: Q,
      contrast: m().int().min(0).max(100),
      fonts: g({ code: rt, ui: rt }),
      ink: Q,
      opaqueWindows: h(),
...
function at(e) {
  ...
  let h = (0, G.useCallback)(
      (e) => {
        ((d.current = e), T(t, n, e.theme), T(t, r, e.codeThemeId));
      },
      [n, r, t],
    ),
    g = (0, G.useCallback)(
    ...
    _ = (0, G.useCallback)(
      async (e) => {
        await g(e, async () => {
          ...
          await E(n, e.theme);
          try {
            await E(r, e.codeThemeId);
          } catch (e) {
            throw (await E(n, t.theme).catch(() => void 0), e);
          }
          f.current = e;
        });
      },
      ...
      async (e) => {
        ...
        await g(t, async () => {
          ...
          if (i.codeThemeId !== t.codeThemeId) {
            await E(r, t.codeThemeId);
            try {
              await E(n, e);
            } catch (e) {
              throw (await E(r, i.codeThemeId).catch(() => void 0), e);
            }
            f.current = t;
            return;
          }
          (await E(n, e), (f.current = t));
        });
      },
      [n, r, g],
    ),
  ...
  return {
    ...
    fonts: O.theme.fonts,
    importThemeString: D,
    selectedCodeTheme: B(O.codeThemeId, e),
    setCodeThemeId: x,
    setFontsPatch: b,
    setThemePatch: y,
    theme: O.theme,
...
function St(e) {
  ...
  t[4] !== m.importChoices || t[5] !== f
    ? ((g = m.importChoices.length === 0 ? null : me(f, m.importChoices)),
      (t[4] = m.importChoices),
      (t[5] = f),
      (t[6] = g))
    : (g = t[6]);
  ...
  let w = b,
    T;
  t[9] !== m.providerIds || t[10] !== _ || t[11] !== w
    ? ((T = (e) => {
        _ != null && w({ source: `settings`, action: e, ...ce(_, _e(_), m.providerIds) });
      }),
      (t[9] = m.providerIds),
      (t[10] = _),
      (t[11] = w),
  ...
  t[16] !== m || t[17] !== E
    ? ((A = () => {
        (E(`skipped`), m.setImportDialogOpen(!1));
      }),
      (t[16] = m),
      (t[17] = E),
      (t[18] = A))
  ...
  let N = M,
    P;
  t[24] !== m || t[25] !== w || t[26] !== N || t[27] !== j || t[28] !== u
    ? ((P =
  ...
  if (u === `general-row`) {
    ...
    t[38] === r
      ? (c = t[39])
      : ((c = r
          ? (0, Z.jsx)(y, { ...mt.importedAgentSetup })
          : (0, Z.jsx)(y, { ...mt.externalAgentImport })),
        (t[38] = r),
        (t[39] = c));
    let l;
    ...
    let u = h || m.isImporting || (!e && (!r || !i)),
      d = !e && i ? m.openCompletedImportDialog : k,
      f;
    ...
    t[53] !== c || t[54] !== l || t[55] !== p
      ? ((g = (0, Z.jsx)(H, { id: we, label: c, description: l, control: p })),
        (t[53] = c),
        (t[54] = l),
        (t[55] = p),
        (t[56] = g))
    ...
    return (
      t[57] !== s || t[58] !== g || t[59] !== v
        ? ((b = (0, Z.jsxs)(Z.Fragment, { children: [g, v, s] })),
          (t[57] = s),
          (t[58] = g),
          (t[59] = v),
          (t[60] = b))
  ...
  let R;
  return (
    t[62] !== m.isImporting || t[63] !== I || t[64] !== _ || t[65] !== h || t[66] !== k
                ...
                children: h
                  ? (0, Z.jsx)(U, {
                      children: (0, Z.jsx)(H, {
                        ...
                        control: (0, Z.jsx)(D, { className: `h-4 w-4` }),
                      }),
                    })
                  : (0, Z.jsx)(U, {
                      children:
...
function wt({ hostId: e, onImportSuccess: t, workspaceRoots: n }) {
  let r = a(s),
    i = c(),
    d = o(P),
    f = be({ enabled: !0, workspaceRoots: n }),
    p = ve(f.detectedItems),
    m =
      l(`external-agent-import-status`, {
        params: { hostId: e, providers: pe },
    ...
    [E, O] = (0, G.useState)(!1),
    [k, A] = (0, G.useState)(`items`),
    [j, I] = (0, G.useState)([]),
    [L, R] = (0, G.useState)(`idle`),
    z = Ct([m.latestImportedAtMs, S]),
    ee = b ? w : z,
    B = f.isImporting || b,
    V = (e) => {
      (I(e), A(`items`));
    },
    te = async ({ providerIds: n, selection: a }) => {
      ...
      let o =
        n.length === 0
          ...
          : fe({ detectedItems: f.detectedItems, providerIds: n, selection: a });
      if (o.length === 0) {
        O(!1);
        return;
      }
          ...
          content: ({ close: e, level: t }) =>
            (0, Z.jsx)(oe, {
              ...
              children: (0, Z.jsxs)(`div`, {
                ...
                children: [
                  (0, Z.jsx)(D, { className: `icon-sm text-token-text-secondary` }),
                  (0, Z.jsx)(y, {
        ...
        ((l = n.length),
          ...
          await se({
            ...
            onImportedProjectRootsReady: (e) => {
              N(r, M({ collapsedGroups: d, importedProjectRoots: e }));
            },
  ...
  return {
    ...
    importSelection: (e) => te({ providerIds: j, selection: e }),
    ...
    openImportDialog: () => {
      (R(`idle`), I(p), A(`providers`), O(!0));
    },
    detectedItems: f.detectedItems,
    providerIds: p,
    selectImportProviders: V,
...
function Et(e) {
  ...
  let y = r?.status,
    b;
  t[10] === y ? (b = t[11]) : ((b = Mt(y)), (t[10] = y), (t[11] = b));
  let x = r?.status,
    S;
  ...
  t[36] !== D || t[37] !== A
    ? ((j = (0, Z.jsx)(re, {
        ...
        children: (0, Z.jsxs)(`div`, { className: `relative min-h-0`, children: [D, A] }),
      })),
      (t[36] = D),
      (t[37] = A),
      (t[38] = j))
    ...
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsx)(`span`, {
            ...
            children: (0, Z.jsx)(O, { className: `icon-2xs text-token-success` }),
          })),
          (t[1] = e))
        : (e = t[1]),
      e
  ...
  return (
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Z.jsx)(`span`, {
          ...
          children: (0, Z.jsx)(I, { className: `icon-2xs text-token-editor-error-foreground` }),
        })),
        (t[2] = r))
      : (r = t[2]),
    r
...
function Mt(e) {
  return e === `success`
    ? (0, Z.jsx)(O, { className: `icon-md text-token-charts-green` })
    : e === `error`
      ? (0, Z.jsx)(ie, { className: `icon-md text-token-danger` })
      : (0, Z.jsx)(D, { className: `icon-md` });
}
function Nt(e) {
  return e === `success`
