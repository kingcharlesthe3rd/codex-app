...
import { R as r, h as i, o as a, s as o, t as s } from "./app-scope.js";
import { k as c, o as l, r as u } from "./vscode-api.js";
import { $i as d, Ki as f, Mi as p, O as m, Ti as h, Vi as g, ji as _, wi as v } from "./src-4.js";
import { Ao as y, Fo as b } from "./app-server-manager-signals.js";
import { c as x, o as S, r as C } from "./lib-1.js";
import { Gt as w, o as T } from "./persisted-signal.js";
import { t as E } from "./button.js";
import { a as D, r as O, s as k } from "./setting-storage.js";
import { t as A } from "./spinner.js";
import { t as j } from "./check-md.js";
import { t as M } from "./use-stable-callback.js";
import { a as N, h as P, r as F } from "./sidebar-signals.js";
import { r as I } from "./toast-signal.js";
import { t as L } from "./x.js";
import { d as R, g as z, l as ee, m as te, u as B } from "./diff-view-mode.js";
import { a as V, i as ne, l as re, n as ie } from "./dialog-layout.js";
import { t as ae } from "./x-circle.js";
import { t as oe } from "./format-relative-date-time.js";
import { t as se } from "./alert-2.js";
import { n as H } from "./settings-row.js";
import { n as ce, t as U } from "./settings-group.js";
import {
  _ as le,
  a as ue,
  b as de,
...
import { t as Te } from "./scroll-to-bottom-buton-CyF2-De6.js";
function Ee(e) {
  return d(v, e);
}
  ...
  Ae = function (e, t, n) {
    var r = e.getBoundingClientRect(),
      i = J(t)
        ...
        : t;
    return {
      left: q((i.pageX - (r.left + ke(e).pageXOffset)) / r.width),
      top: q((i.pageY - (r.top + ke(e).pageYOffset)) / r.height),
    };
  },
  je = function (e) {
    !J(e) && e.preventDefault();
  },
  Me = W.memo(function (e) {
    var t = e.onMove,
      n = e.onKey,
      r = Oe(e, [`onMove`, `onKey`]),
      i = (0, W.useRef)(null),
      ...
      l = (0, W.useMemo)(
        function () {
          var e = function (e) {
              (je(e),
                (J(e) ? e.touches.length > 0 : e.buttons > 0) && i.current
...
var Fe = function (e) {
  ...
  Re = function (e) {
    ...
    return {
      h: Y(e.h),
      s: Y(i > 0 && i < 200 ? ((t * n) / 100 / (i <= 100 ? i : 200 - i)) * 100 : 0),
      l: Y(i / 2),
      a: Y(r, 2),
    };
  },
  ...
  Be = function (e) {
    ...
    var a = Math.floor(t),
      ...
      l = a % 6;
    return {
      r: Y(255 * [r, s, o, o, c, r][l]),
      g: Y(255 * [c, r, r, s, o, o][l]),
      b: Y(255 * [o, o, c, r, r, s][l]),
      a: Y(i, 2),
    };
  },
  X = function (e) {
    ...
    return W.createElement(
      ...
      W.createElement(
        ...
        W.createElement(Pe, {
          ...
          left: t / 360,
          color: ze({ h: t, s: 100, v: 100, a: 1 }),
        }),
      ),
    );
  }),
  We = W.memo(function (e) {
    var t = e.hsva,
      n = e.onChange,
      r = { backgroundColor: ze({ h: t.h, s: 100, v: 100, a: 1 }) };
    return W.createElement(
      `div`,
      ...
      W.createElement(
        Me,
        {
          ...
          onKey: function (e) {
            n({ s: q(t.s + 100 * e.left, 0, 100), v: q(t.v - 100 * e.top, 0, 100) });
          },
          "aria-label": `Color`,
  ...
  Ke = function (e, t) {
    return e.toLowerCase() === t.toLowerCase() || Ge(Ie(e), Ie(t));
  };
function qe(e, t, n) {
  var r = K(n),
...
var Je,
  Ye = typeof window < `u` ? W.useLayoutEffect : W.useEffect,
  Xe = function () {
    return Je || (typeof __webpack_nonce__ < `u` ? __webpack_nonce__ : void 0);
  },
  Ze = new Map(),
  Qe = function (e) {
    Ye(function () {
      var t = e.current ? e.current.ownerDocument : document;
      if (t !== void 0 && !Ze.has(t)) {
  ...
  $e = function (e) {
    ...
    return W.createElement(
      `div`,
      G({}, o, { ref: s, className: d }),
      W.createElement(We, { hsva: l, onChange: u }),
      W.createElement(Ue, { hue: l.h, onChange: u, className: `react-colorful__last-control` }),
    );
  },
  et = {
    defaultColor: `000`,
  ...
  tt = function (e) {
    return W.createElement($e, G({}, e, { colorModel: et }));
  },
  Z = n(),
  nt = (e) =>
    (0, Z.jsx)(`svg`, {
  ...
  rt = `codex-theme-v1:`,
  it = p((e) => typeof e == `string` && te(e)),
  Q = f().regex(/^#[0-9a-fA-F]{6}$/),
  at = f().nullable(),
  ot = g({
    codeThemeId: it,
    theme: g({
      accent: Q,
      contrast: Ee().int().min(0).max(100),
      fonts: g({ code: at, ui: at }),
      ink: Q,
      opaqueWindows: _(),
      semanticColors: g({ diffAdded: Q, diffRemoved: Q, skill: Q }),
      surface: Q,
    }),
    variant: h([`light`, `dark`]),
  });
function st(e) {
  let t = a(s),
    { chromeThemeSetting: n, codeThemeSetting: r } = lt(e),
    i = D(n),
    o = D(r),
    c = z(i, e),
    l = R(e),
    u = { codeThemeId: B(o, e).id, theme: c },
    d = (0, W.useRef)(u),
    f = (0, W.useRef)(u),
    p = (0, W.useRef)(0),
    m = (0, W.useRef)(Promise.resolve());
  p.current === 0 && ((d.current = u), (f.current = u));
  let h = (0, W.useCallback)(
      (e) => {
        ((d.current = e), O(t, n, e.theme), O(t, r, e.codeThemeId));
      },
      [n, r, t],
    ),
    g = (0, W.useCallback)(
      async (e, t) => {
        ...
        let n = async () => {
            try {
              ...
              throw (dt(d.current, e) && h(f.current), t);
            } finally {
              --p.current;
            }
          },
    ...
    _ = (0, W.useCallback)(
      async (e) => {
        await g(e, async () => {
          ...
          await k(n, e.theme);
          try {
            await k(r, e.codeThemeId);
          } catch (e) {
            throw (await k(n, t.theme).catch(() => void 0), e);
          }
          f.current = e;
        });
      },
      ...
      async (e) => {
        ...
        await g(t, async () => {
          ...
          if (i.codeThemeId !== t.codeThemeId) {
            await k(r, t.codeThemeId);
            try {
              await k(n, e);
            } catch (e) {
              throw (await k(r, i.codeThemeId).catch(() => void 0), e);
            }
            f.current = t;
            return;
          }
          (await k(n, e), (f.current = t));
        });
      },
      [n, r, g],
    ),
    y = (0, W.useCallback)(
      (e) => {
        v(ut(d.current.theme, e)).catch(() => void 0);
      },
      [v],
    ),
    b = (0, W.useCallback)(
      (e) => {
        v(ut(d.current.theme, { fonts: e })).catch(() => void 0);
      },
      [v],
    ),
    x = (0, W.useCallback)(
      async (t) => {
        let n = await ee(t, e);
        await _({ codeThemeId: t, theme: ut(d.current.theme, n) });
      },
      [_, e],
    ),
    S = (0, W.useCallback)(
      () => pt({ codeThemeId: d.current.codeThemeId, theme: d.current.theme, variant: e }),
      [e],
    ),
    C = (0, W.useCallback)(
      (t) => {
  ...
  return {
    ...
    fonts: T.theme.fonts,
    importThemeString: w,
    selectedCodeTheme: B(T.codeThemeId, e),
    setCodeThemeId: x,
    setFontsPatch: b,
    setThemePatch: y,
    theme: T.theme,
...
function ct(e, t, n) {
  ...
  return { codeThemeId: i.id, theme: z(r.theme, t) };
}
function lt(e) {
  return e === `light`
    ? { chromeThemeSetting: m.lightChromeTheme, codeThemeSetting: m.lightCodeThemeId }
    : { chromeThemeSetting: m.darkChromeTheme, codeThemeSetting: m.darkCodeThemeId };
}
function ut(e, t) {
  return {
    ...e,
...
function pt(e) {
  return `${rt}${JSON.stringify(e)}`;
}
function mt(e) {
  let t = e.trim();
  if (!t.startsWith(rt)) throw Error(`Theme share string mismatch`);
  let n = t.slice(15),
    r = n.startsWith(`{`) ? n : decodeURIComponent(n);
  return ot.parse(JSON.parse(r));
}
var $ = r();
function ht(e) {
  let t = (0, $.c)(7),
...
var St = `external-agent-import`,
  Ct = { importedSessionCount: 0, latestImportedAtMs: null };
function wt(e) {
  let t = (0, $.c)(68),
    {
      codexHome: n,
  ...
  t[4] !== m.importChoices || t[5] !== f
    ? ((g = m.importChoices.length === 0 ? null : ge(f, m.importChoices)),
      (t[4] = m.importChoices),
      (t[5] = f),
      (t[6] = g))
    : (g = t[6]);
  ...
  t[9] !== m.providerIds || t[10] !== _ || t[11] !== y
    ? ((b = (e) => {
        _ != null && y({ source: `settings`, action: e, ...ue(_, ye(_), m.providerIds) });
      }),
      (t[9] = m.providerIds),
      (t[10] = _),
      (t[11] = y),
  ...
  t[16] !== m || t[17] !== C
    ? ((k = () => {
        (C(`skipped`), m.setImportDialogOpen(!1));
      }),
      (t[16] = m),
      (t[17] = C),
      (t[18] = k))
  ...
  let N = M,
    P;
  t[24] !== m || t[25] !== y || t[26] !== N || t[27] !== j || t[28] !== u
    ? ((P =
  ...
  if (u === `general-row`) {
    ...
    t[34] !== n || t[35] !== m.closeCompletedImportDialog || t[36] !== a
      ? ((o = (0, Z.jsx)(Ot, { progress: a, codexHome: n, onClose: m.closeCompletedImportDialog })),
        (t[34] = n),
    ...
    t[38] === r
      ? (c = t[39])
      : ((c = r
          ? (0, Z.jsx)(S, { ...gt.importedAgentSetup })
          : (0, Z.jsx)(S, { ...gt.externalAgentImport })),
        (t[38] = r),
        (t[39] = c));
    let l;
    ...
    let u = h || m.isImporting || (!e && (!r || !i)),
      d = !e && i ? m.openCompletedImportDialog : O,
      f;
    ...
    t[53] !== c || t[54] !== l || t[55] !== p
      ? ((g = (0, Z.jsx)(H, { id: De, label: c, description: l, control: p })),
        (t[53] = c),
        (t[54] = l),
        (t[55] = p),
        (t[56] = g))
  ...
  let R;
  return (
    t[62] !== m.isImporting || t[63] !== I || t[64] !== _ || t[65] !== h || t[66] !== O
      ? ((R = (0, Z.jsx)(Z.Fragment, {
          children: (0, Z.jsxs)(U, {
            className: `gap-2`,
            children: [
              L,
                ...
                children: h
                  ? (0, Z.jsx)(ce, {
                      children: (0, Z.jsx)(H, {
                        ...
                        control: (0, Z.jsx)(A, { className: `h-4 w-4` }),
                      }),
                    })
                  : (0, Z.jsx)(ce, {
                      children:
...
function Et({ hostId: e, onImportSuccess: t, workspaceRoots: n }) {
  let r = a(s),
    i = c(),
    d = o(F),
    f = Se({ enabled: !0, workspaceRoots: n }),
    p = be(f.detectedItems),
    m =
      l(`external-agent-import-status`, {
        params: { hostId: e, providers: he },
        queryConfig: { refetchOnMount: !0, staleTime: 0 },
      }).data ?? Ct,
    [h, g] = (0, W.useState)(null),
    [_, v] = (0, W.useState)(!1),
    [y, b] = (0, W.useState)(!1),
    [x, C] = (0, W.useState)(null),
    [w, T] = (0, W.useState)(null),
    [E, D] = (0, W.useState)(!1),
    [O, k] = (0, W.useState)(`items`),
    [j, M] = (0, W.useState)([]),
    [L, R] = (0, W.useState)(`idle`),
    z = Tt([m.latestImportedAtMs, x]),
    ee = y ? w : z,
    te = f.isImporting || y,
    B = (e) => {
      (M(e), k(`items`));
    },
    V = async ({ providerIds: n, selection: a }) => {
      if ((R(`idle`), !f.hasImportableItems)) {
        D(!1);
        return;
      }
      let o =
        n.length === 0
          ? f.getSelectedItems(a)
          : me({ detectedItems: f.detectedItems, providerIds: n, selection: a });
      if (o.length === 0) {
        D(!1);
        return;
      }
          ...
          content: ({ close: e, level: t }) =>
            (0, Z.jsx)(se, {
              ...
              children: (0, Z.jsxs)(`div`, {
                ...
                children: [
                  (0, Z.jsx)(A, { className: `icon-sm text-token-text-secondary` }),
                  (0, Z.jsx)(S, {
      ...
      try {
        c = `import`;
        let { projectRoots: n } = await f.importItems(o);
        ((l = n.length),
          (c = `complete_import`),
          await le({
            hostId: e,
            onImportedProjectRootsReady: (e) => {
              P(r, N({ collapsedGroups: d, importedProjectRoots: e }));
            },
            projectRoots: e === `local` ? n : [],
            refreshRecentConversations: o.some((e) => e.itemType === `SESSIONS`)
              ? () => Ce(e)
              : void 0,
          }),
          ...
          await Promise.all([
            ve(i),
            i.invalidateQueries({ queryKey: u(`codex-agents-md`) }),
            n.length === 0
              ? Promise.resolve()
              : i.invalidateQueries({ queryKey: u(`workspace-root-options`, { hostId: e }) }),
          ]),
          g({ status: `success`, items: o }),
          C(Date.now()),
          t?.(),
          p.success(
            (0, Z.jsx)(S, {
  ...
  return {
    ...
    importDialogStep: O,
    importDialogStatus: L,
    importSelection: (e) => V({ providerIds: j, selection: e }),
    isImportDialogOpen: E,
    isCompletedImportDialogOpen: _,
    isDetecting: f.isDetecting,
    isImporting: te,
    lastCompletedImportProgress: h,
    latestImportedAtMs: ee,
    openCompletedImportDialog: () => {
      h != null && v(!0);
    },
    openImportDialog: () => {
      (R(`idle`), M(p), k(`providers`), D(!0));
    },
    detectedItems: f.detectedItems,
    providerIds: p,
    selectImportProviders: B,
    selectedImportProviderIds: j,
    unsupportedProjects: f.unsupportedProjects,
    setImportDialogOpen: D,
  };
}
function Dt(e) {
  let t = (0, $.c)(7),
...
function Ot(e) {
  ...
  let v = r?.status,
    y;
  t[10] === v ? (y = t[11]) : ((y = Pt(v)), (t[10] = v), (t[11] = y));
  let b = r?.status,
    S;
  t[12] === b ? (S = t[13]) : ((S = Ft(b)), (t[12] = b), (t[13] = S));
  let C;
  t[14] === r ? (C = t[15]) : ((C = It(r)), (t[14] = r), (t[15] = C));
  let w;
  t[16] === r ? (w = t[17]) : ((w = Lt(r)), (t[16] = r), (t[17] = w));
  let T;
  t[18] !== S || t[19] !== C || t[20] !== w || t[21] !== y
    ? ((T = (0, Z.jsx)(V, {
        className: `gap-0`,
        children: (0, Z.jsx)(ne, {
          icon: y,
    ...
    ? ((E =
        r != null && r.items.length > 0
          ? (0, Z.jsx)(V, {
              ...
              children: (0, Z.jsx)(kt, { codexHome: n, items: r.items, status: r.status }),
            })
          : null),
      (t[23] = n),
      (t[24] = r),
  ...
  t[36] !== D || t[37] !== k
    ? ((A = (0, Z.jsx)(ie, {
        ...
        children: (0, Z.jsxs)(`div`, { className: `relative min-h-0`, children: [D, k] }),
      })),
      (t[36] = D),
      (t[37] = k),
      (t[38] = A))
        ...
        e.length > 0
          ? (0, Z.jsxs)(Z.Fragment, {
              children: [
                ...
                e.map((e) => (0, Z.jsx)(Mt, { codexHome: n, item: e, status: i }, Vt(e))),
              ],
            })
          : null),
      (s =
        c.length > 0
          ? (0, Z.jsxs)(Z.Fragment, {
              children: [
                ...
                c.map((e) => (0, Z.jsx)(Mt, { codexHome: n, item: e, status: i }, Vt(e))),
              ],
            })
          : null),
      (t[0] = n),
...
function Mt(e) {
  ...
  let s;
  t[3] !== n || t[4] !== r || t[5] !== i
    ? ((s = Rt(r, n, i)), (t[3] = n), (t[4] = r), (t[5] = i), (t[6] = s))
    : (s = t[6]);
  let c;
  t[7] === i ? (c = t[8]) : ((c = (0, Z.jsx)(Nt, { status: i })), (t[7] = i), (t[8] = c));
  let l;
  return (
    t[9] !== o || t[10] !== s || t[11] !== c
      ? ((l = (0, Z.jsx)(H, { label: o, description: s, control: c })),
        (t[9] = o),
        (t[10] = s),
        (t[11] = c),
        (t[12] = l))
    ...
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsx)(`span`, {
            ...
            children: (0, Z.jsx)(j, { className: `icon-2xs text-token-success` }),
          })),
          (t[1] = e))
        : (e = t[1]),
      e
  ...
  return (
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Z.jsx)(`span`, {
          ...
          children: (0, Z.jsx)(L, { className: `icon-2xs text-token-editor-error-foreground` }),
        })),
        (t[2] = r))
      : (r = t[2]),
    r
...
function Pt(e) {
  return e === `success`
    ? (0, Z.jsx)(j, { className: `icon-md text-token-charts-green` })
    : e === `error`
      ? (0, Z.jsx)(ae, { className: `icon-md text-token-danger` })
      : (0, Z.jsx)(A, { className: `icon-md` });
}
function Ft(e) {
  return e === `success`
...
function Rt(e, t, n) {
  let r = n === `success` ? zt(e) : e.description;
  if (e.cwd == null || e.cwd === ``) {
    let e = r
    ...
    if (t != null && t !== ``) {
      ...
      ((e = e.split(t).join(`~/.codex`)),
        (e = e.split(_t(n, `.claude`)).join(`~/.claude`)),
        (e = e.split(_t(n, `.agents`)).join(`~/.agents`)));
    }
    return b(e);
  }
  let i = Bt(e.cwd);
