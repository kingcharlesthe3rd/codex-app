...
import { t as i } from "./line.js";
import { _ as a, c as o, d as s, g as c, h as l, i as u, n as d, r as f, t as p } from "./step.js";
import { t as m } from "./rough.esm-2.js";
import { n as h, r as g } from "./chunk-62.js";
import { b as _, w as v, y } from "./chunk-96.js";
import { h as b, l as x } from "./chunk-2.js";
import { n as S } from "./chunk-128.js";
import { i as C, n as ee, r as w, t as T } from "./chunk-65.js";
import { n as E } from "./chunk-145.js";
import { i as D, n as te } from "./chunk-134.js";
import { r as O } from "./chunk-41.js";
var k = h((e, t, n, r, i, a = !1, o) => {
  ...
  ne = h((e) => (typeof e == `string` ? e : _()?.flowchart?.curve), `resolveEdgeCurveType`),
  N = new Map(),
  P = new Map(),
  F = h(() => {
    (N.clear(), P.clear());
  ...
  I = h(
    (e) => (e ? (typeof e == `string` ? e : e.reduce((e, t) => e + `;` + t, ``)) : ``),
    `getLabelStyles`,
  ),
  L = h(async (t, n) => {
    let r = _(),
    ...
    (s.attr(`transform`, T(d, i)), N.set(n.id, o), (n.width = u.width), (n.height = u.height));
    let f;
    if (n.startLabelLeft) {
...
function R(e, t) {
  v(_()) && e && ((e.style.width = t.length * 9 + `px`), (e.style.height = `12px`));
}
...
var z = h((e, t) => {
    ...
    if (e.startLabelLeft) {
      let t = P.get(e.id).startLeft,
        ...
        i = e.y;
      if (n) {
        let t = b.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, `start_left`, n);
        ((r = t.x), (i = t.y));
      }
    ...
    if (e.startLabelRight) {
      let t = P.get(e.id).startRight,
        ...
        i = e.y;
      if (n) {
        let t = b.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, `start_right`, n);
        ((r = t.x), (i = t.y));
      }
      t.attr(`transform`, `translate(${r}, ${i})`);
    }
    if (e.endLabelLeft) {
      let t = P.get(e.id).endLeft,
        ...
        i = e.y;
      if (n) {
        let t = b.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, `end_left`, n);
        ((r = t.x), (i = t.y));
      }
      t.attr(`transform`, `translate(${r}, ${i})`);
    }
    if (e.endLabelRight) {
      let t = P.get(e.id).endRight,
        ...
        i = e.y;
      if (n) {
        let t = b.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, `end_right`, n);
        ((r = t.x), (i = t.y));
      }
      t.attr(`transform`, `translate(${r}, ${i})`);
    }
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    if (Math.abs(i - t.y) * o > Math.abs(r - t.x) * c) {
      ...
      s = (u * e) / l;
      let r = { x: n.x < t.x ? n.x + s : n.x - u + s, y: n.y < t.y ? n.y + l - e : n.y - l + e };
      return (
        s === 0 && ((r.x = t.x), (r.y = t.y)),
        u === 0 && (r.x = t.x),
        l === 0 && (r.y = t.y),
      ...
      return (
        g.debug(`sides calc abc89, Q ${l}, q ${e}, R ${u}, r ${s}`, { _x: i, _y: a }),
        s === 0 && ((i = t.x), (a = t.y)),
        u === 0 && (i = t.x),
        l === 0 && (a = t.y),
        { x: i, y: a }
    ...
    return (
      e.forEach((e) => {
        if ((g.info(`abc88 checking point`, e, t), !B(t, e) && !i)) {
          let a = V(t, r, e);
          (g.debug(`abc88 inside`, e, r, a), g.debug(`abc88 intersection`, a, t));
          let o = !1;
          (n.forEach((e) => {
            o ||= e.x === a.x && e.y === a.y;
          }),
...
var W = h(function (e, t, n) {
    ...
    for (let r = 0; r < e.length; r++)
      if (t.includes(r)) {
        ...
        (Math.abs(i.x - t.x) > 10 && Math.abs(i.y - t.y) >= 10
          ? (g.debug(`Corner point fixing`, Math.abs(i.x - t.x), Math.abs(i.y - t.y)),
            (d =
              a.x === o.x
                ? { x: c < 0 ? o.x - 5 + u : o.x + 5 - u, y: l < 0 ? o.y - u : o.y + u }
                : { x: c < 0 ? o.x - u : o.x + u, y: l < 0 ? o.y - 5 + u : o.y + 5 - u }))
          : g.debug(`Corner point skipping fixing`, Math.abs(i.x - t.x), Math.abs(i.y - t.y)),
          n.push(d, s));
      } else n.push(e[r]);
    return n;
  }, `fixCorners`),
  ...
  G = h(function (h, v, y, S, w, T, E, D = !1) {
    ...
    (v.toCluster &&
      ...
      (j = !0)),
      v.fromCluster &&
        (g.debug(`from cluster abc88`, y.get(v.fromCluster), JSON.stringify(A, null, 2)),
    ...
    if (v.look === `handDrawn`) {
      ...
      ((U += ` transition`),
        (W = e(n)
          .select(`path`)
          .attr(`id`, `${E}-${v.id}`)
          .attr(`class`, ` ` + U + (v.classes ? ` ` + v.classes : ``) + (X ? ` ` + X : ``))
  ...
  X = {
    ...
    zero_or_one_neo: h((e, t, n) => {
      ...
      (s
        ...
        .attr(`stroke-width`, `${i}`)
        .attr(`r`, 6),
        s.append(`path`).attr(`d`, `M21,0 L21,18`).attr(`stroke-width`, `${i}`));
    }, `zero_or_one_neo`),
    ...
    zero_or_more_neo: h((e, t, n) => {
      ...
      (o
        ...
        .attr(`r`, 6)
        .attr(`stroke-width`, `${i}`),
        o.append(`path`).attr(`d`, `M0,18 Q18,0 36,18 Q18,36 0,18`).attr(`stroke-width`, `${i}`));
      let s = e
        .append(`defs`)
        .append(`marker`)
        .attr(`id`, n + `_` + t + `-zeroOrMoreEnd`)
      ...
      (s
        ...
        .attr(`r`, 6)
        .attr(`stroke-width`, `${i}`),
        s.append(`path`).attr(`d`, `M21,18 Q39,0 57,18 Q39,36 21,18`).attr(`stroke-width`, `${i}`));
    }, `zero_or_more_neo`),
