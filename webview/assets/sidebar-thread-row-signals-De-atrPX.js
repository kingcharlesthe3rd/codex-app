...
import { mr as p, r as m } from "./src-1.js";
import { o as h } from "./lib.js";
import { A as g } from "./rpc-1.js";
import { a as _ } from "./thread-context-inputs.js";
import { t as v } from "./app-intl-signal-D.js";
import { C as y, j as b, k as x, m as S } from "./open-project-setup-dialog.js";
...
var ee = [],
  ...
  V = t(r, ({ get: e }) => {
    let t = c(e, p.THREAD_PROJECT_ASSIGNMENTS),
      n = c(e, p.PROJECTLESS_THREAD_IDS);
    return e(S, {
      threadKeys: e(x),
      enabled: !0,
  ...
  U = n(r, (e, { get: t }) => {
    ...
    switch (n?.kind) {
      case `pending-worktree`:
        return t(y, n.pendingWorktreeId)?.isPinned === !0;
      case `local`:
      case `remote`: {
        let n = l(e);
  ...
  K = n(r, (e, { get: t }) => {
    ...
    let r = c(t, p.PROJECTLESS_THREAD_IDS);
    return N({
  ...
  Y = n(r, (e, { get: t }) => {
    ...
    return n?.kind === `local`
      ? m({
          ...
          assignment: c(t, p.THREAD_PROJECT_ASSIGNMENTS)?.[n.conversation.id],
        })
      : null;
  }),
  X = n(r, (e, { get: t }) =>
    e == null ? null : (c(t, p.THREAD_WORKSPACE_ROOT_HINTS)?.[e] ?? null),
  ),
  Z = n(r, (e, { get: t }) =>
    e == null ? null : (c(t, p.SIDEBAR_THREAD_METADATA)?.[e]?.labelColor ?? null),
  );
function Q(e) {
  let t = new Set(),
    n = new Map();
...
//# sourceMappingURL=sidebar-thread-row-signals-De-atrPX.js.map
