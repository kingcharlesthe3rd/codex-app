...
import { n as N, t as P } from "./jsx-runtime.js";
...
import { m as le } from "./chunk-9.js";
import { n as ue } from "./rpc-2.js";
import { c as de, o as fe, s as pe } from "./statsig.js";
import { t as me } from "./use-global-state.js";
import { t as he } from "./use-auth.js";
import { a as ge } from "./setting-storage.js";
import { t as _e } from "./spinner.js";
import { t as ve } from "./link-external.js";
import { a as ye, n as be, s as xe, t as Se } from "./mcp-capability-signals.js";
import {
  a as Ce,
  d as we,
  f as Te,
...
import { t as je } from "./x.js";
import { y as Me } from "./use-plugins.js";
import { n as Ne, s as Pe } from "./home-onboarding-assistant-tutorial-card.js";
import { t as Fe } from "./info-BV-snsxq.js";
import { t as Ie } from "./with-window.js";
import {
  d as Le,
  f as Re,
  n as ze,
...
import { d as Ue, i as We, l as Ge, n as Ke, u as qe } from "./dialog-layout.js";
import { t as Je } from "./chevron-right.js";
import { t as Ye } from "./use-stable-callback.js";
import { t as Xe } from "./use-navigate-to-local-conversation.js";
import { n as Ze } from "./electron-menu-shortcuts.js";
import { t as Qe } from "./remote-connections-onboarding-signals.js";
import { r as $e, t as et } from "./dropdown.js";
import { t as tt } from "./chevron.js";
import { t as nt } from "./code-snippet.js";
import { t as rt } from "./copy-button.js";
import { t as it } from "./image-preview-dialog.js";
import { t as at } from "./toggle.js";
import { t as ot } from "./score-query-match.js";
import { t as st } from "./use-is-thread-realtime-enabled.js";
import { t as ct } from "./arrow-up-right-lg.js";
import { t as lt } from "./browser-sidebar-comment-mode-coachmark-state.js";
import { t as ut } from "./workspace-directory-tree.js";
import { a as dt, i as ft } from "./workspace-onboarding-experiment.js";
import { a as pt, t as mt } from "./primary-runtime-query-keys-C.js";
import { i as ht, r as gt } from "./primary-runtime-install-state.js";
import { n as _t, t as vt } from "./hotkey-window-state.js";
import { o as yt, t as bt } from "./codex-mobile-setup-dialog.js";
import { a as xt, o as St, s as Ct } from "./use-debug-panel.js";
import { r as wt, t as Tt } from "./thread-virtualizer.js";
function Et({ labels: e, projectlessThreadCwd: t, statuses: n, workspaceRoots: r }) {
  let i = new Map();
...
function Y(e) {
  ...
  let [p, m] = (0, q.useState)(f),
    ...
    g;
  t[2] !== s || t[3] !== h
    ? ((g = F(`flex h-7 w-full items-center justify-between gap-2`, h, s)),
      (t[2] = s),
      (t[3] = h),
      (t[4] = g))
    : (g = t[4]);
  ...
  t[19] === c
    ? (C = t[20])
    : ((C = c
        ? (0, J.jsx)(`span`, { className: `flex items-center gap-1`, onClick: Dt, children: c })
        : null),
      (t[19] = c),
      (t[20] = C));
  let w;
...
function kt({ sourceThreadId: e }) {
  let [t, n] = (0, q.useState)(Ot),
        ...
        try {
          let n = JSON.parse(t),
            ...
            a = await new Promise((t, i) => {
              let a = H.subscribe(`debug-run-app-action-response`, (e) => {
                if (e.requestId === r) {
                  if ((a(), e.ok)) {
                    t(e.result);
                    return;
              ...
              H.dispatchMessage(`debug-run-app-action-request`, {
                requestId: r,
                action: n,
          ...
          (i(`Error: ${e instanceof Error ? e.message : String(e)}\n\nInput JSON:\n${t}`),
            U.error(`Failed to run debug app action`, {
              safe: {},
...
function X(e) {
  ...
  t[6] === r
    ...
    : ((c = (0, J.jsx)(rt, {
        ...
        onCopy: () => {
          navigator?.clipboard?.writeText && navigator.clipboard.writeText(r).catch(At);
        },
      })),
      (t[6] = r),
      (t[7] = c));
...
function At() {}
var jt = new Intl.DateTimeFormat(void 0, {
    fractionalSecondDigits: 3,
    hour: `2-digit`,
    minute: `2-digit`,
    second: `2-digit`,
  }),
  Mt = `debug-app-server-section`,
  Nt = [`resumed`, `resuming`, `needs_resume`],
  Pt = L(W, (e) => null);
function Ft() {
  let e = (0, K.c)(2),
    t = R(m),
...
function It(e) {
  let t = (0, K.c)(15),
    ...
    i = R(A),
    [a] = v(`host_config`),
    [o] = v(`remote_connections`),
    [s] = v(`remote_control_connections`),
    c;
  ...
  return (
    t[13] === c
      ? (l = t[14])
      : ((l = (0, J.jsx)(`div`, { className: `flex flex-col gap-3 py-3`, children: c })),
        (t[13] = c),
        (t[14] = l)),
    l
  );
...
function Lt(e) {
  let t = (0, K.c)(69),
    ...
    u = !!n.lines?.length,
    d;
  t[0] === a ? (d = t[1]) : ((d = a.filter(_n)), (t[0] = a), (t[1] = d));
  let f = d.length,
    p = B(Pt, r) ?? n.stateType === `local`,
    m = n.stateType === `local` ? `local` : s,
    h;
  t[2] === a ? (h = t[3]) : ((h = a.filter(Bt)), (t[2] = a), (t[3] = h));
  let g = h.length,
    _;
  t[4] === i ? (_ = t[5]) : ((_ = i.filter(zt)), (t[4] = i), (t[5] = _));
  let v = _.length,
    y;
  t[6] === i ? (y = t[7]) : ((y = i.filter(Rt)), (t[6] = i), (t[7] = y));
  let b = y.length,
    x;
  t[8] !== r || t[9] !== o
    ? ((x = (e) => {
        o.set(Pt, r, e.currentTarget.open);
      }),
      (t[8] = r),
      (t[9] = o),
      (t[10] = x))
  ...
  t[11] === n.displayName
    ...
    : ((w = (0, J.jsx)(`span`, {
      ...
      (t[12] = w));
  let T;
  t[13] === m ? (T = t[14]) : ((T = (0, J.jsx)(sn, { state: m })), (t[13] = m), (t[14] = T));
  let E;
  t[15] !== w || t[16] !== T
    ? ((E = (0, J.jsxs)(`div`, { className: `flex items-center gap-2`, children: [w, T] })),
      (t[15] = w),
      (t[16] = T),
      (t[17] = E))
    : (E = t[17]);
  ...
  let te;
  t[47] !== u || t[48] !== n
    ? ((te = u ? (0, J.jsx)(Vt, { hostDetails: n }) : null), (t[47] = u), (t[48] = n), (t[49] = te))
    : (te = t[49]);
  let ne;
  t[50] !== r || t[51] !== l
    ? ((ne = (0, J.jsx)(Gt, { hostId: r, threadStatusEntries: l })),
      (t[50] = r),
      (t[51] = l),
      (t[52] = ne))
    : (ne = t[52]);
  let V;
  t[53] !== r || t[54] !== a
    ? ((V = (0, J.jsx)(Ut, { hostId: r, requests: a })), (t[53] = r), (t[54] = a), (t[55] = V))
    : (V = t[55]);
  let H;
  t[56] !== r || t[57] !== i
    ? ((H = (0, J.jsx)(Jt, { hostId: r, notifications: i })), (t[56] = r), (t[57] = i), (t[58] = H))
    : (H = t[58]);
  let U;
  t[59] !== te || t[60] !== ne || t[61] !== V || t[62] !== H
    ? ((U = (0, J.jsx)(`div`, {
...
function Vt(e) {
  let t = (0, K.c)(4),
    { hostDetails: n } = e,
    r;
  t[0] === n.lines ? (r = t[1]) : ((r = n.lines?.map(Ht)), (t[0] = n.lines), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function Ut(e) {
  let t = (0, K.c)(16),
    ...
    [i, a] = (0, q.useState)(!1),
    o;
  t[0] === r ? (o = t[1]) : ((o = r.filter(_n)), (t[0] = r), (t[1] = o));
  let s = o,
    c = i ? s : r,
    l = r.length === 0,
    u;
...
function Wt(e) {
  return (0, J.jsx)(nn, { request: e }, e.id);
}
function Gt({ hostId: e, threadStatusEntries: t }) {
  let [n, r] = (0, q.useState)(null),
    [i, a] = (0, q.useState)(null),
    o = ln(t),
    s = i != null && Nt.includes(i) ? i : null,
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(Y, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children:
          o.length === 0
            ? (0, J.jsx)(tn, { message: `No in-memory threads for this manager yet` })
            : (0, J.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, J.jsx)(`div`, {
                    ...
                    children:
                      c.length === 0
                        ? (0, J.jsx)(tn, { message: `No in-memory threads match this state` })
                        : c.map((t) =>
                            (0, J.jsxs)(
                              `div`,
                              {
...
function Kt(e) {
  let t = (0, K.c)(44),
    ...
    a = B(j, n.conversationId),
    o = n.resumeState === `resumed` && a?.role === `owner` && !r,
    s = Xe(),
    c;
  t[0] === n.title
    ? (c = t[1])
    : ((c = n.title?.trim() || `Untitled thread`), (t[0] = n.title), (t[1] = c));
  let l;
  t[2] === c
    ? (l = t[3])
    : ((l = (0, J.jsx)(`div`, {
  ...
  let x = `resume: ${n.resumeState}`,
    S;
  t[28] === x ? (S = t[29]) : ((S = (0, J.jsx)(qt, { label: x })), (t[28] = x), (t[29] = S));
  let C = `stream: ${a?.role ?? `none`}`,
    w;
  t[30] === C ? (w = t[31]) : ((w = (0, J.jsx)(qt, { label: C })), (t[30] = C), (t[31] = w));
  let T = `runtime: ${n.threadRuntimeStatus?.type ?? `none`}`,
    E;
  t[32] === T ? (E = t[33]) : ((E = (0, J.jsx)(qt, { label: T })), (t[32] = T), (t[33] = E));
  let D = `turn: ${n.lastTurnStatus ?? `none`}`,
    O;
  t[34] === D ? (O = t[35]) : ((O = (0, J.jsx)(qt, { label: D })), (t[34] = D), (t[35] = O));
  let k;
...
function Jt(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== s || t[4] !== a) {
    ...
    let y = o,
      b;
    (t[18] === y ? (b = t[19]) : ((b = y.filter(Qt)), (t[18] = y), (t[19] = b)), (d = b));
    let x;
    (t[20] !== y || t[21] !== a
      ? ((x = a ? y : y.filter(Zt)), (t[20] = y), (t[21] = a), (t[22] = x))
      : (x = t[22]),
      (f = x),
      (l = en),
      (h = r.length === 0),
      ...
      (m =
        e.length > 0
          ? (0, J.jsxs)(`select`, {
              ...
              children: [(0, J.jsx)(`option`, { value: ``, children: `All threads` }), e.map(Xt)],
            })
          : null),
      (t[0] = n),
      (t[1] = r),
        ...
        d.length > 0
          ? (0, J.jsxs)(`label`, {
              ...
              children: [
                ...
                (0, J.jsxs)(`span`, { className: `tabular-nums`, children: [`(`, d.length, `)`] }),
              ],
            })
          : null),
      (t[26] = d.length),
  ...
  t[33] !== u || t[34] !== d.length || t[35] !== f
    ? ((x =
        f.length > 0
          ...
          : (0, J.jsx)(tn, {
              message: d.length > 0 ? `Only hidden delta notifications recorded` : pn(u),
            })),
      (t[33] = u),
      (t[34] = d.length),
      (t[35] = f),
...
function Yt(e) {
  return (0, J.jsx)(rn, { notification: e }, e.id);
}
function Xt(e) {
  return (0, J.jsx)($t, { threadId: e }, e);
}
function Zt(e) {
  return !e.isNoisy;
}
...
function $t(e) {
  ...
  let i = B(T, r),
    a;
  t[2] === i ? (a = t[3]) : ((a = i?.trim() || `Untitled thread`), (t[2] = i), (t[3] = a));
  let o;
  return (
    t[4] !== a || t[5] !== n
      ? ((o = (0, J.jsx)(`option`, { value: n, children: a })), (t[4] = a), (t[5] = n), (t[6] = o))
      : (o = t[6]),
    o
  );
}
...
function nn(e) {
  ...
  t[7] === n.startedAtMs
    ? (o = t[8])
    : ((o = jt.format(n.startedAtMs)), (t[7] = n.startedAtMs), (t[8] = o));
  let s;
  t[9] === o ? (s = t[10]) : ((s = (0, J.jsx)(`div`, { children: o })), (t[9] = o), (t[10] = s));
  let c;
  t[11] === n ? (c = t[12]) : ((c = vn(n)), (t[11] = n), (t[12] = c));
  let l;
  ...
  t[25] === n.endedAtMs
    ...
    : ((h =
        n.endedAtMs == null
          ...
          : (0, J.jsxs)(`div`, { children: [`Ended: `, jt.format(n.endedAtMs)] })),
      (t[25] = n.endedAtMs),
      (t[26] = h));
  let g;
  ...
  t[31] === n.paramsPreview
    ? (_ = t[32])
    : ((_ = (0, J.jsx)(an, { payload: n.paramsPreview, title: `Params` })),
      (t[31] = n.paramsPreview),
      (t[32] = _));
  let v;
  t[33] === n.resultPreview
    ...
    : ((v =
        n.resultPreview == null
          ? null
          : (0, J.jsx)(an, { payload: n.resultPreview, title: `Result` })),
      (t[33] = n.resultPreview),
      (t[34] = v));
  let y;
  t[35] === n.errorPreview
    ...
    : ((y =
        n.errorPreview == null
          ? null
          : (0, J.jsx)(an, { payload: n.errorPreview, title: `Error` })),
      (t[35] = n.errorPreview),
      (t[36] = y));
  let b;
...
function rn(e) {
  ...
  t[0] === n.severity
    ? (r = t[1])
    : ((r = F(`group/notification bg-token-background rounded-lg border`, yn(n.severity))),
      (t[0] = n.severity),
      (t[1] = r));
  let i;
  t[2] === n.method
  ...
  t[9] === n.receivedAtMs
    ? (s = t[10])
    : ((s = jt.format(n.receivedAtMs)), (t[9] = n.receivedAtMs), (t[10] = s));
  let c;
  t[11] === s
    ? (c = t[12])
    : ((c = (0, J.jsx)(`div`, {
  ...
  t[16] === n.paramsPreview
    ...
    : ((u = (0, J.jsx)(`div`, {
        className: `space-y-3 border-t border-token-border p-3`,
        children: (0, J.jsx)(an, { payload: n.paramsPreview, title: `Params` }),
      })),
      (t[16] = n.paramsPreview),
      (t[17] = u));
  let d;
...
function an(e) {
  ...
  t[2] === n
    ...
    : ((a = (0, J.jsx)(`button`, {
        ...
        onClick: () => {
          navigator.clipboard?.writeText(n).catch(on);
        },
        children: `Copy`,
      })),
      (t[2] = n),
...
function sn(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = F(`rounded-full px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide`, bn(n))),
      (t[0] = n),
      (t[1] = r));
  let i;
  return (
...
var xn = [`browser-debug-snapshot`],
  Sn = `debug-browser-tabs`,
  Cn = 1e3,
  wn = new Intl.DateTimeFormat(void 0, {
    fractionalSecondDigits: 3,
    hour: `2-digit`,
    minute: `2-digit`,
    second: `2-digit`,
...
function Tn() {
  ...
  e[1] === o
    ...
    : ((c = {
        ...
        queryKey: xn,
        refetchInterval: Cn,
        staleTime: se.FIVE_SECONDS,
      }),
      (e[1] = o),
      (e[2] = c));
  let { data: l, isFetching: u, isLoading: d, refetch: f } = ce(c),
    p;
  e[3] === f
    ? (p = e[4])
    : ((p = async (e) => {
        if (t != null)
          try {
            ...
            (a(`Failed to open Browser owner`),
              U.error(`Failed to open Browser debug owner`, {
                safe: {
                  browserTabId: e.browserTabId,
                  conversationId: e.conversationId,
                  windowId: e.windowId,
        ...
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              (0, J.jsx)(`button`, {
                ...
                disabled: l == null,
                onClick: () => {
                  l != null && navigator.clipboard?.writeText(JSON.stringify(l, null, 2)).catch(En);
                },
                children: `Copy JSON`,
              }),
              (0, J.jsxs)(`button`, {
                ...
                children: [u ? (0, J.jsx)(_e, { className: `icon-2xs` }) : null, `Refresh`],
              }),
            ],
          })
        : null),
  ...
  e[10] !== l || e[11] !== m || e[12] !== d || e[13] !== n || e[14] !== i
    ? ((_ = n
        ? t == null
          ? (0, J.jsx)(Hn, { message: `Browser debug service unavailable.` })
          : d && l == null
            ? (0, J.jsx)(Hn, { message: `Loading Browser debug snapshot...` })
            : l == null
              ? (0, J.jsx)(Hn, { message: `Browser debug snapshot unavailable.` })
              : (0, J.jsx)(On, { onOpenOwner: m, openOwnerStatus: i, snapshot: l })
        : null),
      (e[10] = l),
      (e[11] = m),
      (e[12] = d),
...
function On(e) {
  ...
  t[0] === i.capturedAtMs
    ? (a = t[1])
    : ((a = wn.format(i.capturedAtMs)), (t[0] = i.capturedAtMs), (t[1] = a));
  let o;
  t[2] === a
    ? (o = t[3])
  ...
  t[21] === r
    ...
    : ((v =
      ...
      (t[22] = v));
  let y;
  t[23] === i.windows ? (y = t[24]) : ((y = i.windows.map(Nn)), (t[23] = i.windows), (t[24] = y));
  let b;
  t[25] === y
    ? (b = t[26])
    : ((b = (0, J.jsx)(Vn, {
  ...
  t[34] === i.sessionRoutes
    ? (C = t[35])
    : ((C = i.sessionRoutes.map(Mn)), (t[34] = i.sessionRoutes), (t[35] = C));
  let w;
  t[36] === C
    ? (w = t[37])
    : ((w = (0, J.jsx)(Vn, {
  ...
  t[38] === i.pendingAttaches
    ? (T = t[39])
    : ((T = i.pendingAttaches.map(jn)), (t[38] = i.pendingAttaches), (t[39] = T));
  let E;
  t[40] === T
    ? (E = t[41])
    : ((E = (0, J.jsx)(Vn, {
  ...
  t[42] === i.openRequests
    ? (D = t[43])
    : ((D = i.openRequests.map(An)), (t[42] = i.openRequests), (t[43] = D));
  let O;
  t[44] === D
    ? (O = t[45])
    : ((O = (0, J.jsx)(Vn, {
  ...
  t[46] === i.events
    ? (k = t[47])
    : ((k = i.events.slice().reverse().map(kn)), (t[46] = i.events), (t[47] = k));
  let A;
  t[48] === k
    ? (A = t[49])
    : ((A = (0, J.jsx)(Vn, {
...
function kn(e) {
  return (0, J.jsx)(Rn, { event: e }, e.sequence);
}
function An(e) {
  return (0, J.jsx)(
    zn,
...
function Mn(e) {
  return (0, J.jsx)(In, { route: e }, `${e.windowId}:${e.conversationId}`);
}
function Nn(e) {
  return (0, J.jsx)(Pn, { window: e }, e.windowId);
}
function Pn(e) {
  let t = (0, K.c)(32),
    { window: n } = e,
  ...
  return (
    t[28] !== x || t[29] !== S || t[30] !== C
      ? ((w = (0, J.jsx)(zn, { details: x, subtitle: S, title: C })),
        (t[28] = x),
        (t[29] = S),
        (t[30] = C),
        (t[31] = w))
...
function Fn(e) {
  ...
  t[16] === d
    ? (f = t[17])
    : ((f = (0, J.jsxs)(`span`, { children: [`g`, d] })), (t[16] = d), (t[17] = f));
  ...
  t[38] === x
    ? (S = t[39])
    : ((S = (0, J.jsx)(X, { label: `Window`, value: x })), (t[38] = x), (t[39] = S));
  let C = String(r.ownerWebContentsId),
    w;
  t[40] === C
    ? (w = t[41])
    : ((w = (0, J.jsx)(X, { label: `Owner webContents`, value: C })), (t[40] = C), (t[41] = w));
  let T = r.ownerRoutePath ?? `missing`,
    E;
  t[42] === T
    ? (E = t[43])
    : ((E = (0, J.jsx)(X, { label: `Owner route`, value: T })), (t[42] = T), (t[43] = E));
  let D = r.guestWebContentsId == null ? `none` : String(r.guestWebContentsId),
    O;
  t[44] === D
    ? (O = t[45])
    : ((O = (0, J.jsx)(X, { label: `Guest webContents`, value: D })), (t[44] = D), (t[45] = O));
  let k = r.pageKey ?? `none`,
    A;
  t[46] === k
    ? (A = t[47])
    : ((A = (0, J.jsx)(X, { label: `Page key`, value: k })), (t[46] = k), (t[47] = A));
  let j = r.url || `about:blank`,
    M;
  t[48] === j
    ? (M = t[49])
    : ((M = (0, J.jsx)(X, { label: `URL`, value: j })), (t[48] = j), (t[49] = M));
  let N = r.pendingUrl || `none`,
    P;
  t[50] === N
    ? (P = t[51])
    : ((P = (0, J.jsx)(X, { label: `Pending URL`, value: N })), (t[50] = N), (t[51] = P));
  let F;
  t[52] === r.bounds ? (F = t[53]) : ((F = Gn(r.bounds)), (t[52] = r.bounds), (t[53] = F));
  let I;
  t[54] === F
    ? (I = t[55])
    : ((I = (0, J.jsx)(X, { label: `Bounds`, value: F })), (t[54] = F), (t[55] = I));
  let ee = `active=${r.active}`,
    L = `presented=${r.presented}`,
    R = `visible=${r.visible}`,
    z = `hasPage=${r.hasPage}`,
    te = `loading=${r.isLoading}`,
    B = `restoring=${r.isRestoring}`,
    ne = `suspended=${r.isSuspended}`,
    V;
  t[56] !== ee ||
  t[57] !== L ||
  t[58] !== R ||
  ...
  t[64] === H
    ? (U = t[65])
    : ((U = (0, J.jsx)(X, { label: `Flags`, value: H })), (t[64] = H), (t[65] = U));
  let W = `page=${r.isBrowserUsePage}`,
    re = `active=${r.isBrowserUseActive}`,
    ie = `agent=${r.isAgentControllingBrowser}`,
    ae = `visibilityRequest=${r.hasPendingBrowserUseVisibilityRequest}`,
    oe = `panelOpen=${r.pendingBrowserUsePanelOpen}`,
    se;
  t[66] !== W || t[67] !== re || t[68] !== ie || t[69] !== ae || t[70] !== oe
    ? ((se = [W, re, ie, ae, oe]),
      (t[66] = W),
      (t[67] = re),
      (t[68] = ie),
  ...
  t[72] === ce
    ? (G = t[73])
    : ((G = (0, J.jsx)(X, { label: `Browser Use`, value: ce })), (t[72] = ce), (t[73] = G));
  ...
  t[79] === me
    ? (he = t[80])
    : ((he = (0, J.jsx)(X, { label: `Lifecycle`, value: me })), (t[79] = me), (t[80] = he));
  let ge =
  ...
  t[81] === ge
    ? (_e = t[82])
    : ((_e = (0, J.jsx)(X, { label: `Pending teardown`, value: ge })), (t[81] = ge), (t[82] = _e));
  let ve;
  t[83] !== y ||
  t[84] !== b ||
  t[85] !== S ||
  ...
  t[96] !== _e
    ? ((ve = (0, J.jsxs)(`div`, {
        ...
        children: [y, b, S, w, E, O, A, M, P, I, U, G, he, _e],
      })),
      (t[83] = y),
      (t[84] = b),
      (t[85] = S),
...
function In(e) {
  ...
  return (
    t[25] !== n.conversationId || t[26] !== v || t[27] !== y
      ? ((b = (0, J.jsx)(zn, { details: v, subtitle: y, title: n.conversationId })),
...
function Ln(e) {
  ...
  return (
    t[19] !== f || t[20] !== p || t[21] !== m
      ? ((h = (0, J.jsx)(zn, { details: f, subtitle: p, title: m })),
        (t[19] = f),
        (t[20] = p),
        (t[21] = m),
        (t[22] = h))
...
function Rn(e) {
  ...
  t[2] === n.timestampMs
    ? (a = t[3])
    : ((a = wn.format(n.timestampMs)), (t[2] = n.timestampMs), (t[3] = a));
  let o;
  ...
  return (
    t[28] !== n.message || t[29] !== y || t[30] !== b
      ? ((x = (0, J.jsx)(zn, { details: y, subtitle: n.message, title: b })),
        (t[28] = n.message),
        (t[29] = y),
        (t[30] = b),
        (t[31] = x))
...
function zn(e) {
  ...
  t[4] !== a || t[5] !== o
    ...
    : (s = t[6]);
  let c;
  t[7] === n ? (c = t[8]) : ((c = n.map(Bn)), (t[7] = n), (t[8] = c));
  let l;
  t[9] === c
    ? (l = t[10])
  ...
  createTable: (e) => {
    ((e.getHeaderGroups = Z(
      ...
      (e.getLeftHeaderGroups = Z(
        ...
        (t, n, r) =>
          tr(t, r?.map((e) => n.find((t) => t.id === e)).filter(Boolean) ?? [], e, `left`),
      ...
      (e.getRightHeaderGroups = Z(
        ...
        (t, n, r) =>
          tr(t, r?.map((e) => n.find((t) => t.id === e)).filter(Boolean) ?? [], e, `right`),
...
function tr(e, t, n, r) {
  ...
  (s(
    t.map((e, t) => $n(n, e, { depth: i, index: t })),
    i - 1,
  ),
    o.reverse());
  let c = (e) =>
...
var hr = {
  ...
  createColumn: (e, t) => {
    ((e.getAutoFilterFn = () => {
      ...
      (e.getFilterFn = () =>
        Jn(e.columnDef.filterFn)
          ? e.columnDef.filterFn
          : e.columnDef.filterFn === `auto`
            ? e.getAutoFilterFn()
            : (t.options.filterFns?.[e.columnDef.filterFn] ?? pr[e.columnDef.filterFn])),
      (e.getCanFilter = () =>
...
var br = {
    ...
    createColumn: (e, t) => {
      ((e.getIndex = Z(
        ...
        (e.getIsFirstColumn = (n) => jr(t, n)[0]?.id === e.id),
        (e.getIsLastColumn = (n) => {
          let r = jr(t, n);
  ...
  xr = () => ({ left: [], right: [] }),
  Sr = {
    getInitialState: (e) => ({ columnPinning: xr(), ...e }),
    ...
    createTable: (e) => {
      ((e.setColumnPinning = (t) =>
        ...
        (e.resetColumnPinning = (t) =>
          e.setColumnPinning(t ? xr() : (e.initialState?.columnPinning ?? xr()))),
...
var wr = { size: 150, minSize: 20, maxSize: 2 ** 53 - 1 },
  Tr = () => ({
    startOffset: null,
    startSize: null,
    deltaOffset: null,
  ...
  Er = {
    ...
    getInitialState: (e) => ({ columnSizing: {}, columnSizingInfo: Tr(), ...e }),
    getDefaultOptions: (e) => ({
    ...
    createColumn: (e, t) => {
      ((e.getSize = () => {
        ...
        return Math.min(
          Math.max(e.columnDef.minSize ?? wr.minSize, n ?? e.columnDef.size ?? wr.size),
          e.columnDef.maxSize ?? wr.maxSize,
        );
      }),
        (e.getStart = Z(
          (e) => [e, jr(t, e), t.getState().columnSizing],
        ...
        (e.getResizeHandler = (n) => {
          ...
          return (a) => {
            if (
              !r ||
              !i ||
              (a.persist == null || a.persist(), kr(a) && a.touches && a.touches.length > 1)
            )
              return;
            let o = e.getSize(),
              s = e
                ...
                : [[r.id, r.getSize()]],
              c = kr(a) ? Math.round(a.touches[0].clientX) : a.clientX,
              l = {},
              u = (e, n) => {
                typeof n == `number` &&
...
var Mr = {
  ...
  Nr = {
    ...
    createTable: (e) => {
      ((e.getGlobalAutoFilterFn = () => pr.includesString),
        (e.getGlobalFilterFn = () => {
  ...
  Fr = 0,
  Ir = 10,
  Lr = () => ({ pageIndex: Fr, pageSize: Ir }),
  Rr = {
    getInitialState: (e) => ({ ...e, pagination: { ...Lr(), ...e?.pagination } }),
      ...
      ((e._autoResetPageIndex = () => {
        ...
        (e.setPagination = (t) =>
          e.options.onPaginationChange == null
            ? void 0
            : e.options.onPaginationChange((e) => Kn(t, e))),
        (e.resetPagination = (t) => {
          e.setPagination(t ? Lr() : (e.initialState.pagination ?? Lr()));
        }),
        (e.setPageIndex = (t) => {
          e.setPagination((n) => {
            let r = Kn(t, n.pageIndex),
              i =
        ...
        (e.setPageSize = (t) => {
          e.setPagination((e) => {
            let n = Math.max(1, Kn(t, e.pageSize)),
        ...
        (e.setPageCount = (t) =>
          e.setPagination((n) => {
            let r = Kn(t, e.options.pageCount ?? -1);
  ...
  zr = () => ({ top: [], bottom: [] }),
  Br = {
    getInitialState: (e) => ({ rowPinning: zr(), ...e }),
    ...
    createTable: (e) => {
      ((e.setRowPinning = (t) =>
        ...
        (e.resetRowPinning = (t) =>
          e.setRowPinning(t ? zr() : (e.initialState?.rowPinning ?? zr()))),
    ...
    createTable: (e) => {
      ((e.setRowSelection = (t) =>
        ...
        (e.getSelectedRowModel = Z(
          ...
          (t, n) => (Object.keys(t).length ? Ur(e, n) : { rows: [], flatRows: [], rowsById: {} }),
  ...
  Hr = (e, t, n, r, i) => {
    ...
    (n
      ...
      r &&
        ...
        o.subRows.forEach((t) => Hr(e, t.id, n, r, i)));
  };
function Ur(e, t) {
...
function Gr(e, t, n) {
  ...
  return (
    e.subRows.forEach((e) => {
      if (
        !(a && !i) &&
        (e.getCanSelect() && (Wr(e, t) ? (a = !0) : (i = !1)), e.subRows && e.subRows.length)
      ) {
        let n = Gr(e, t);
...
var Kr = /([0-9]+)/gm,
  qr = (e, t, n) => ti(ei(e.getValue(n)).toLowerCase(), ei(t.getValue(n)).toLowerCase()),
  Jr = (e, t, n) => ti(ei(e.getValue(n)), ei(t.getValue(n))),
  Yr = (e, t, n) => $r(ei(e.getValue(n)).toLowerCase(), ei(t.getValue(n)).toLowerCase()),
  Xr = (e, t, n) => $r(ei(e.getValue(n)), ei(t.getValue(n))),
  Zr = (e, t, n) => {
    let r = e.getValue(n),
      i = t.getValue(n);
...
function ti(e, t) {
  let n = e.split(Kr).filter(Boolean),
    r = t.split(Kr).filter(Boolean);
    ...
    Nr,
    {
      ...
      createColumn: (e, t) => {
        ((e.getAutoSortingFn = () => {
          ...
          (e.getSortingFn = () => {
            if (!e) throw Error();
            return Jn(e.columnDef.sortingFn)
              ? e.columnDef.sortingFn
              : e.columnDef.sortingFn === `auto`
                ? e.getAutoSortingFn()
                : (t.options.sortingFns?.[e.columnDef.sortingFn] ?? ni[e.columnDef.sortingFn]);
          }),
          (e.toggleSorting = (n, r) => {
...
function oi() {
  return (e) =>
    Z(
      ...
      (e, t, n) => (!t.rows.length || (e !== !0 && !Object.keys(e ?? {}).length) || !n ? t : si(t)),
...
function ci(e, t) {
  return e ? (li(e) ? q.createElement(e, t) : e) : null;
}
function li(e) {
  return ui(e) || typeof e == `function` || di(e);
}
function ui(e) {
  return (
    typeof e == `function` &&
...
function xi(e) {
  return e == null ? `default` : e > hi ? `danger` : e > mi ? `warning` : `default`;
}
function Si(e, t) {
  let n = (t.get(e.pid) ?? []).map((e) => Si(e, t));
  return (
    n.sort(Ci),
    {
      children: n,
      commandLabel: _i(e.command),
      fullCommand: e.command.trim().length > 0 ? e.command.trim() : `(command unavailable)`,
      process: e,
      totalCpuPercent: wi(e.cpuPercent, n),
      totalRssKb: Ti(e.rssKb, n),
    }
  );
}
function Ci(e, t) {
...
function Ei(e) {
  return pi.default.basename(e.replaceAll(`\\`, `/`));
}
var Di = `debug-child-processes`,
  Oi = 12,
  ki = 36;
function Ai() {
  let e = (0, K.c)(25),
    ...
    ? ((_ = t
        ? u && l == null
          ...
          : l?.rootProcess == null
            ...
            : (0, J.jsx)(Mi, { onProcessDetailsClick: o, processes: f, rootProcess: l.rootProcess })
        : null),
      (e[8] = l),
      (e[9] = u),
      (e[10] = t),
  ...
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, J.jsx)(We, {
        title: (0, J.jsx)(Ue, { children: `Process details` }),
        subtitle: (0, J.jsx)(qe, { children: `The process ID and full command are shown below` }),
      })),
      (e[14] = b))
    : (b = e[14]);
  let x;
  ...
  let S;
  e[17] !== x || e[18] !== v
    ? ((S = (0, J.jsx)(Ge, { open: v, onOpenChange: y, size: `wide`, children: x })),
      (e[17] = x),
      (e[18] = v),
      (e[19] = S))
    : (S = e[19]);
...
function Mi({ onProcessDetailsClick: e, processes: t, rootProcess: n }) {
  let r = (0, q.useMemo)(() => gi(n, t), [t, n]),
    i = (0, q.useMemo)(() => (r == null ? [] : [r]), [r]),
    a = fi({
      columns: (0, q.useMemo)(() => Ni(e), [e]),
      data: i,
      getCoreRowModel: ai(),
      getExpandedRowModel: oi(),
                      ...
                      (0, J.jsx)(
                        `th`,
                        {
                          ...
                          children: e.isPlaceholder
                            ? null
                            : ci(e.column.columnDef.header, e.getContext()),
                        },
                        e.id,
                      ),
                    ),
                    ...
                    .map((e) =>
                      (0, J.jsx)(
                        `td`,
                        {
                          ...
                          children: ci(e.column.columnDef.cell, e.getContext()),
                        },
                        e.id,
                      ),
                    ),
        ...
        (0, J.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, J.jsx)(`button`, {
              ...
              onClick: () => e(Fi(t.original)),
              children: (0, J.jsx)(Fe, { className: `icon-xs` }),
            }),
          ],
        }),
    },
        ...
        (0, J.jsx)(Pi, {
          selfValue:
            e.original.process.depth === 0 && e.original.process.cpuPercent == null
              ? ``
              : yi(e.original.process.cpuPercent),
          totalValue: yi(e.original.totalCpuPercent),
        }),
    },
    {
      id: `ram`,
      ...
      cell: ({ row: e }) =>
        (0, J.jsx)(Pi, {
          selfValue: vi(e.original.process.rssKb),
          totalValue: vi(e.original.totalRssKb),
          tone: xi(e.original.totalRssKb),
        }),
    },
    {
      ...
      id: `age`,
      header: `Age`,
      cell: ({ row: e }) => bi(e.original.process.ageSeconds),
    },
  ];
}
function Pi(e) {
...
function Ii() {
  try {
    return window.localStorage.getItem(Di) === `open`;
  } catch {
    return !1;
  }
}
function Li(e) {
  let t = (0, K.c)(4),
    { lines: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = n.map(Ri)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function Bi(e) {
  ...
  if (
    ...
    let v;
    t[17] === a ? (v = t[18]) : ((v = { label: `reasoning`, value: a }), (t[17] = a), (t[18] = v));
    let y;
    t[19] === o
      ? (y = t[20])
    ...
    let x;
    t[23] === c ? (x = t[24]) : ((x = { label: `cwd`, value: c }), (t[23] = c), (t[24] = x));
    ...
    (t[27] === T
      ...
      (t[11] = p),
      (t[12] = m));
  } else ((l = t[7]), (u = t[8]), (d = t[9]), (f = t[10]), (p = t[11]), (m = t[12]));
  let g;
  t[29] !== l || t[30] !== d
  ...
  return (
    t[32] !== u || t[33] !== f || t[34] !== p || t[35] !== m || t[36] !== g
      ? ((_ = (0, J.jsx)(u, { title: f, storageKey: p, variant: m, children: g })),
        (t[32] = u),
        (t[33] = f),
        (t[34] = p),
        (t[35] = m),
...
function Ji(e, t) {
  let n = t.topInset ?? 0,
    r = t.height - n,
    i = Math.max(Gi, Math.min(e.width, t.width));
  return {
    height: Math.max(Ki, Math.min(e.height, r)),
    width: i,
    x: Math.min(t.width - Ui, Math.max(Ui - i, e.x)),
    y: Math.min(t.height - Wi, Math.max(n, e.y)),
  };
}
function Yi(e, t, n) {
  return Ji({ ...e, height: e.height + t.y, width: e.width + t.x }, n);
}
function Xi(e) {
  let t = (0, K.c)(22),
...
function Zi() {
  let e = (0, K.c)(15),
    ...
    { data: i, isLoading: a } = me(p.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED),
    o = i === !0,
  ...
  e[3] === t
    ...
    : ((u = (e) => {
        (r(null),
          E(t, p.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED, e)
            .then(() => {
              H.dispatchMessage(`global-dictation-force-lock-changed`, { enabled: e });
            })
            .catch((e) => {
              r(
...
function Qi() {
  ...
  e[0] === t
    ? (a = e[1])
    : ((a = { mutationFn: $i, onSuccess: (e) => (t.setQueryData(vt, e.state), e) }),
      (e[0] = t),
      (e[1] = a));
  let o = ne(a);
  ...
  e[2] === i.configuredHotkey
    ? (s = e[3])
    : ((s = i.configuredHotkey == null ? `Off` : Ze(i.configuredHotkey)),
      (e[2] = i.configuredHotkey),
      (e[3] = s));
  let c = s,
  ...
  e[4] === c
    ? (p = e[5])
    : ((p = (0, J.jsx)(X, { label: `Configured hotkey`, value: c })), (e[4] = c), (e[5] = p));
  let m;
  e[6] === l
    ? (m = e[7])
    : ((m = (0, J.jsx)(X, { label: `Gate`, value: l })), (e[6] = l), (e[7] = m));
  let h;
  e[8] === u
    ? (h = e[9])
    : ((h = (0, J.jsx)(X, { label: `Runtime`, value: u })), (e[8] = u), (e[9] = h));
  let g;
  e[10] === d
    ? (g = e[11])
    : ((g = (0, J.jsx)(X, { label: `Dev override`, value: d })), (e[10] = d), (e[11] = g));
  let _;
  e[12] !== p || e[13] !== m || e[14] !== h || e[15] !== g
    ? ((_ = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [p, m, h, g] })),
      (e[12] = p),
      (e[13] = m),
      (e[14] = h),
      (e[15] = g),
  ...
  e[17] !== i.isDevOverrideEnabled || e[18] !== o
    ? ((y = () => {
      ...
      (e[19] = y))
    : (y = e[19]);
  let b = i.isDevOverrideEnabled ? `Disable dev override` : `Enable hotkey in dev`,
    x;
  ...
  e[28] !== x || e[29] !== S || e[30] !== C
    ? ((w = (0, J.jsxs)(`div`, { className: `flex flex-col gap-2 py-1.5`, children: [x, S, C] })),
      (e[28] = x),
      (e[29] = S),
      (e[30] = C),
      (e[31] = w))
...
async function $i(e) {
  let { enabled: t } = e,
    n = ue.hotkeyWindowHotkeys;
  if (n == null) throw Error(`Popout Window hotkeys are unavailable`);
  return n.setDevOverrideEnabled(t);
}
var ea = `debug-maitai-section`,
  ta = [`all`, `family`, `signal`, `derived`, `query`, `mutation`],
  na = 50,
  ra = 3,
  ia = 12,
  aa = 4,
...
function ca() {
  ...
  if (
    ...
    ((_ = n.filter((e) => Ta(e).includes(v) && Ea(e).includes(y) && Ca(e, s))),
      (p = _.slice(0, d)));
    let b = ba(p);
    ...
    e[16] === a
      ...
      : ((w = (0, J.jsx)(`input`, {
        ...
        (e[17] = w));
    let T;
    e[18] === s ? (T = e[19]) : ((T = wa(s)), (e[18] = s), (e[19] = T));
    let E;
    e[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((E = (0, J.jsx)(tt, { className: `icon-2xs opacity-70` })), (e[20] = E))
      : (E = e[20]);
    let D;
    e[21] === T
      ? (D = e[22])
    ...
    e[24] === D
      ? (k = e[25])
      : ((k = (0, J.jsx)(et, { align: `end`, triggerButton: D, children: O })),
        (e[24] = D),
        (e[25] = k));
    let A;
...
function ha(e) {
  let t = (0, K.c)(37),
    ...
    m = n.writeValue != null && !p && Pa(c),
    h = !s && `rounded border border-token-border bg-token-foreground/[0.025]`,
    g;
  t[0] === h ? (g = t[1]) : ((g = F(`flex flex-col`, h)), (t[0] = h), (t[1] = g));
  let _;
  t[2] !== l || t[3] !== f || t[4] !== u
    ? ((_ = () => {
        let e = !l;
  ...
  t[12] === b
    ...
    : ((x = (0, J.jsx)(`span`, {
      ...
      (t[13] = x));
  let S;
  t[14] === n ? (S = t[15]) : ((S = Sa(n)), (t[14] = n), (t[15] = S));
  let C;
  t[16] === S
    ? (C = t[17])
    : ((C = (0, J.jsx)(`span`, {
            ...
            children: [
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsxs)(`div`, {
                    className: `truncate text-xs text-token-description-foreground`,
                    children: [n.scopeName, ` /`, ` `, Oa(n.scopeKey)],
                  }),
                  p
                    ? (0, J.jsx)(at, {
...
function _a(e) {
  let t = (0, K.c)(17),
    ...
    [r, i] = (0, q.useState)(!1),
    a;
  t[0] === n ? (a = t[1]) : ((a = Aa(n)), (t[0] = n), (t[1] = a));
  let o = a,
    s;
  t[2] !== r || t[3] !== o.text || t[4] !== n
    ? ((s = r ? ka(n) : o.text), (t[2] = r), (t[3] = o.text), (t[4] = n), (t[5] = s))
    : (s = t[5]);
  let c = s,
...
function ya(e) {
  let t = (0, K.c)(20),
    ...
    o;
  t[0] === r ? (o = t[1]) : ((o = ka(r)), (t[0] = r), (t[1] = o));
...
function Ca(e, t) {
  return t === `all` ? !0 : t === `family` ? xa(e) : !xa(e) && Sa(e) === t;
}
function wa(e) {
  switch (e) {
    case `all`:
...
function Ea(e) {
  return xa(e) ? ka(e.familyKey).toLowerCase() : ``;
}
function Da(e, t, n) {
  try {
    return e.get(t.atom);
...
function Oa(e) {
  return typeof e == `string` ? e : ka(e).replaceAll(/\s+/g, ` `);
}
function ka(e) {
  if (e instanceof Error) return `${e.name}: ${e.message}`;
  if (e === void 0) return `undefined`;
  try {
    return JSON.stringify(e, Ia(), 2) ?? Object.prototype.toString.call(e);
  } catch {
...
function ja(e, t, n) {
  ...
  if (typeof e == `string`) return e.length <= oa ? e : ((t.truncated = !0), `${e.slice(0, oa)}…`);
  ...
  if (e instanceof Map)
    return Ma([...e.entries()], t, ([e, r]) => [ja(e, t, n + 1), ja(r, t, n + 1)]);
  if (e instanceof Set) return Ma([...e], t, (e) => ja(e, t, n + 1));
  if (Array.isArray(e)) return Ma(e, t, (e) => ja(e, t, n + 1));
  let r = Object.entries(e),
    i = r.slice(0, ia).map(([e, r]) => [e, ja(r, t, n + 1)]);
  return (
    r.length > ia && ((t.truncated = !0), i.push([`…`, `${r.length - ia} more`])),
    Object.fromEntries(i)
  );
}
function Ma(e, t, n) {
  let r = e.slice(0, ia).map((e) => n(e));
  return (e.length > ia && ((t.truncated = !0), r.push(`${e.length - ia} more`)), r);
}
function Na(e) {
...
var La = 8,
  ...
  Ha = t({
    ...
    data: l(),
    mimeType: l().optional(),
    mime_type: l().optional(),
  }).catchall(d()),
  Ua = t({ type: o(`text`), text: l() }).catchall(d()),
  Wa = t({ code: l(), timeout_ms: d().optional(), title: d().optional() }).catchall(d());
function Ga(e) {
  let t = Ka(e);
  return t.totalCount === 0
    ...
    : {
        lines: [
          ...
          ...t.recentCalls.flatMap((e, t) => Ja(e, t)),
        ],
      };
}
function Ka(e) {
...
function qa(e) {
  return e.type === `mcpToolCall` && e.server === Va;
}
function Ja({ conversationId: e, item: t, turnId: n }, r) {
  let i = [
    {
      label: `call[${r}]`,
      value:
  ...
  return (
    ...
    t.result != null &&
      (i.push(...Za(t.result, r)),
      i.push({ kind: `json`, label: `call[${r}].result`, value: Ya(t.result, za) })),
    i
  );
}
function Ya(e, t = Ra) {
  return so(JSON.stringify(e, Xa, 2) ?? String(e), t);
}
function Xa(e, t) {
...
function Za(e, t) {
  ...
  return n == null
    ...
    : n.flatMap((e, n) => {
        ...
        if (r != null)
          return [
            { kind: `multiline`, label: `call[${t}].result.content[${n}]`, value: so(r, Ba) },
          ];
        let i = eo(e);
        return i == null
          ? []
...
function eo(e) {
  ...
  let r = t.data.mimeType ?? t.data.mime_type ?? ro(n);
  return r.startsWith(`image/`) ? { data: n, mimeType: r } : null;
}
function to(e) {
  return Ha.safeParse(e).success;
}
function no(e) {
...
function io(e, t) {
  let n = ao(e);
  if (n == null) return [{ label: `call[${t}].arguments`, value: Ya(e) }];
  let r = [];
  return (
    ...
    r.push({ kind: `javascript`, label: `call[${t}].script`, value: oo(n.code) }),
    Object.keys(n.extraArguments).length > 0 &&
      r.push({ label: `call[${t}].arguments`, value: Ya(n.extraArguments) }),
    r
  );
}
function ao(e) {
  ...
  ho = te(W, ({ get: e }) =>
    Ga(
      e(_, g)
        ...
        .reverse()
        .flatMap((t) =>
          (e(b, t) ?? co).map((e) => ({ conversationId: t, items: e.items, turnId: e.turnId })),
        ),
    ),
  );
function go(e) {
  ...
  if (n != null) {
    ...
    return (
      t[0] === n
        ? (e = t[1])
        : ((e = (0, J.jsx)(vo, { conversationId: n })), (t[0] = n), (t[1] = e)),
      e
    );
  }
  let r;
...
function _o() {
  ...
  return (
    e[0] === t.lines
      ? (n = e[1])
      : ((n = (0, J.jsx)(yo, { lines: t.lines })), (e[0] = t.lines), (e[1] = n)),
    n
  );
}
function vo(e) {
  ...
  return (
    t[5] === a.lines
      ? (o = t[6])
      : ((o = (0, J.jsx)(yo, { lines: a.lines })), (t[5] = a.lines), (t[6] = o)),
    o
  );
}
function yo(e) {
...
function bo({ lines: e }) {
  let t = (0, q.useMemo)(
      () => e.map((e, t) => ({ estimatedHeightPx: lo, line: e, turnKey: `${t}:${e.label}` })),
      [e],
    ),
    [n, r] = (0, q.useState)({}),
    [i, a] = (0, q.useState)(null),
    [o, s] = (0, q.useState)(() => wo(t.length)),
    c = (0, q.useRef)(null),
    l = (0, q.useRef)(n),
    u = Tt({ entries: t, gapPx: 0, measuredHeightsByKey: n });
  l.current = n;
  let d = Ye(() => {
      ...
      let n = i.getBoundingClientRect(),
        ...
        o = e.scrollTop - a,
        c = To({ layout: u, viewportBottomPx: o + e.clientHeight, viewportTopPx: o });
      s((e) => (Eo(e, c) ? e : c));
    }),
    f = Ye((e) => {
      if (e.size === 0) return;
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(`div`, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children: h.map((e) => (0, J.jsx)(xo, { entry: e, measureLineRef: m }, e.turnKey)),
      }),
    }),
  });
}
var xo = (0, q.memo)(function (e) {
  let t = (0, K.c)(6),
    { entry: n, measureLineRef: r } = e,
    i;
  t[0] === n.line
    ? (i = t[1])
    : ((i = (0, J.jsx)(So, { line: n.line })), (t[0] = n.line), (t[1] = i));
  let a;
  return (
...
function So(e) {
  ...
  switch (n.kind) {
    ...
    case `image`: {
      let e;
      return (
        t[9] === n ? (e = t[10]) : ((e = (0, J.jsx)(jo, { line: n })), (t[9] = n), (t[10] = e)), e
      );
    }
    case void 0: {
      let e;
...
function wo(e) {
  return { startIndex: 0, endIndex: Math.min(e, fo) };
}
function To({ layout: e, viewportBottomPx: t, viewportTopPx: n }) {
  let r = e.turnKeys.length;
  if (r === 0) return { startIndex: 0, endIndex: 0 };
  if (t <= 0) return { startIndex: 0, endIndex: Math.min(r, uo) };
  if (n >= e.totalHeightPx) return { startIndex: Math.max(0, r - uo), endIndex: r };
  let i = Math.max(0, n),
...
function Do(e) {
  return e.closest(`[data-debug-panel-scroll-container]`) ?? Oo(e);
}
function Oo(e) {
...
function Ao(e) {
  ...
  return (
    t[5] !== n || t[6] !== c
      ? ((l = (0, J.jsx)(Co, { label: n, children: c })), (t[5] = n), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
function jo(e) {
  ...
  return (
    t[15] !== n.label || t[16] !== m
      ? ((h = (0, J.jsx)(Co, { label: n.label, children: m })),
        (t[15] = n.label),
        (t[16] = m),
        (t[17] = h))
      : (h = t[17]),
...
function Ro() {
  let e = (0, K.c)(41),
    ...
    [j, M] = (0, q.useState)(!1),
    N;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((N = { hostId: g }), (e[0] = N)) : (N = e[0]);
  let P = j && !0,
    I;
  e[1] === P
    ? (I = e[2])
    : ((I = { params: N, queryConfig: { enabled: P } }), (e[1] = P), (e[2] = I));
  let L = ie(`workspace-root-options`, I).data?.roots.length ?? 0,
    z;
  ...
  e[7] === d.roles
    ? (oe = e[8])
    : ((oe = d.roles.length === 0 ? `none` : d.roles.join(`, `)), (e[7] = d.roles), (e[8] = oe));
  let se = oe,
    ce;
  e[9] !== ae ||
  e[10] !== n ||
    ...
    ? ((ce = j
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              (0, J.jsx)(`div`, {
                className: `text-xs text-token-description-foreground`,
                children: `Auth: ${n.authMethod ?? `none`} · Projects: ${L}`,
              }),
              (0, J.jsx)(`div`, {
                className: `text-xs text-token-description-foreground`,
                children: `Codex runtime: ${A == null ? `idle` : zo(A)}`,
              }),
              (0, J.jsx)(`div`, {
                ...
                children: te.map((e) =>
                  (0, J.jsx)(
                    `button`,
                    {
                      ...
                      onClick: () => {
                        (e.value === `workspace` && _(!1), o(e.value));
                      },
                      children: e.label,
                    },
                    e.value,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    ...
                    children: `Onboarding welcome pending: ${s ? `pending` : `off`} · Projectless completed: ${l ? `yes` : `no`} · Plugin checklist active: ${f ? `yes` : `no`} · Roles: ${se}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-xs text-token-description-foreground`,
                    children: `Home onboarding tiles debug override: ${m ? `forced on` : `off`}`,
                  }),
                  (0, J.jsxs)(`div`, {
                    className: `flex flex-wrap items-center gap-2`,
                    children: [
                      ...
                      (0, J.jsx)(
                        `button`,
                        {
                          ...
                          onClick: () => {
                            ...
                            y({ arm: e.value, assignedAtMs: Date.now(), experimentName: ft });
                          },
                          children: e.label,
                        },
                        e.value,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Work plugins announcement: ${T ? `seen` : `unseen`}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    ...
                    onClick: () => {
                      (D(!1), O(!1), i.updateUserAsync(i.getContext().user));
                    },
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Remote Connections home announcement: ${k ? `seen` : `unseen`}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    className: `rounded border border-token-border px-3 py-1 text-token-description-foreground hover:bg-token-foreground/5`,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Browser comment mode coachmark: ${C ? `seen` : `unseen`}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    className: `rounded border border-token-border px-3 py-1 text-token-description-foreground hover:bg-token-foreground/5`,
...
function Vo() {
  ...
  let c = s,
    l;
  e[2] === t.length ? (l = e[3]) : ((l = t.length.toString()), (e[2] = t.length), (e[3] = l));
  let u;
  e[4] === l
    ? (u = e[5])
    : ((u = (0, J.jsx)(X, { label: `Catalog entries`, value: l })), (e[4] = l), (e[5] = u));
  let d;
  e[6] === i.length ? (d = e[7]) : ((d = i.length.toString()), (e[6] = i.length), (e[7] = d));
  let f;
  e[8] === d
    ? (f = e[9])
    : ((f = (0, J.jsx)(X, { label: `Views`, value: d })), (e[8] = d), (e[9] = f));
  let p;
  e[10] === n.length ? (p = e[11]) : ((p = n.length.toString()), (e[10] = n.length), (e[11] = p));
  let m;
  e[12] === p
    ? (m = e[13])
    : ((m = (0, J.jsx)(X, { label: `File viewers`, value: p })), (e[12] = p), (e[13] = m));
  let h;
  e[14] === r.length ? (h = e[15]) : ((h = r.length.toString()), (e[14] = r.length), (e[15] = h));
  let g;
  e[16] === h
    ? (g = e[17])
    : ((g = (0, J.jsx)(X, { label: `Mention servers`, value: h })), (e[16] = h), (e[17] = g));
  let _;
  e[18] === a
    ? (_ = e[19])
    : ((_ = a ? (0, J.jsx)(_e, { className: `icon-2xs` }) : null), (e[18] = a), (e[19] = _));
  let v;
...
function Ho(e) {
  U.error(`Failed to reload bundled plugins from debug page`, {
    safe: {},
    sensitive: { error: e },
  });
}
  ...
  return (
    e[0] === t
      ...
      : ((n = (0, J.jsx)(Y, {
          ...
          variant: `global`,
          children: (0, J.jsx)(Wo, { productEvents: t }),
        })),
        (e[0] = t),
        (e[1] = n)),
    n
...
function Wo(e) {
  ...
  if (t[1] !== n || t[2] !== r) {
    ...
    (t[11] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((f = (0, J.jsxs)(`div`, {
          className: `mt-2 grid grid-cols-[88px_90px_80px_minmax(0,1fr)] gap-3 text-xs font-medium text-token-description-foreground uppercase`,
          children: [
            (0, J.jsx)(`span`, { children: `Status` }),
            (0, J.jsx)(`span`, { children: `Time` }),
            (0, J.jsx)(`span`, { children: `Type` }),
...
function Go(e) {
  ...
  return (0, J.jsxs)(
    `div`,
    {
      ...
      children: [
        (0, J.jsxs)(`div`, {
          className: `grid grid-cols-[88px_90px_80px_minmax(0,1fr)] items-start gap-3 text-sm`,
          children: [
            (0, J.jsx)(`span`, {
              className: F(`w-fit rounded-full px-2 py-0.5 text-xs font-medium`, qo(e.status)),
...
function Xo(e, t) {
  return ot(Zo(e), t) > 0 || ot(Qo(e), t) > 0 || ot(e.event.type, t) > 0 || ot(ts(e), t) > 0;
}
function Zo(e) {
  switch (e.event.type) {
    case `legacy`:
...
function rs() {
  let e = (0, K.c)(23),
    ...
    i = fe(`2380644311`),
    a = st(),
    { data: o, isLoading: s } = me(p.REALTIME_VOICE_MODE_DEBUG_DISABLED),
    c = o === !0,
    l = i ? `Enabled` : `Disabled`,
    u;
  e[0] === l
    ? (u = e[1])
    : ((u = (0, J.jsx)(X, { label: `Statsig gate`, value: l })), (e[0] = l), (e[1] = u));
  let d = c ? `Forcing off` : `Off`,
    f;
  e[2] === d
    ? (f = e[3])
    : ((f = (0, J.jsx)(X, { label: `Debug override`, value: d })), (e[2] = d), (e[3] = f));
  let m = a ? `Enabled` : `Disabled`,
    h;
  e[4] === m
    ? (h = e[5])
    : ((h = (0, J.jsx)(X, { label: `Effective voice mode`, value: m })), (e[4] = m), (e[5] = h));
  let g;
  e[6] !== u || e[7] !== f || e[8] !== h
    ? ((g = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [u, f, h] })),
      (e[6] = u),
      (e[7] = f),
      (e[8] = h),
      (e[9] = g))
  ...
  e[11] === t
    ...
    : ((v = (e) => {
        (r(null),
          E(t, p.REALTIME_VOICE_MODE_DEBUG_DISABLED, e).catch((e) => {
...
var is = t({ dynamic_configs: u(l(), d()), feature_gates: u(l(), d()) }),
  as = c([t({ is_user_in_experiment: i() }), t({ ue: o(!0) })]);
function os(e) {
  let t = us(e);
  return t == null
    ? []
...
function ss(e, t) {
  ...
  return n
    ? e.filter(
        (e) =>
          [e.kind, e.name, e.reason, e.ruleId, e.kind === `experiment` ? (e.groupName ?? ``) : ``]
            .join(` `)
            .toLowerCase()
            .includes(n) || e.name === ls(t.trim()),
      )
    : e;
}
function cs(e, t) {
  let n = t.trim();
  return n.length > 0 && e === ls(n) ? n : e;
}
function ls(e) {
...
function us(e) {
  ...
  let r = is.safeParse(Reflect.apply(n, t, []));
  return r.success ? r.data : null;
}
function ds(e) {
  return as.safeParse(e).success;
}
function fs() {
  let e = (0, K.c)(32),
    { client: t } = pe(),
  ...
  if (e[0] !== t || e[1] !== n) {
    let m = os(t),
      h = n.trim().length > 0,
      g = h ? ss(m, n) : [],
      _ = m.filter(hs).length,
      v = m.filter(ms).length,
      y = m.filter(ps).length;
    ((i = Y),
      (u = `debug-statsig`),
      (d = `Statsig`),
      (f = `global`),
    ...
    (e[12] === b
      ? (x = e[13])
      : ((x = (0, J.jsx)(X, { label: `Enabled gates`, value: b })), (e[12] = b), (e[13] = x)),
      (c = (0, J.jsxs)(`div`, {
        className: `flex flex-col gap-1`,
        children: [x, (0, J.jsx)(X, { label: `Assigned experiments`, value: y.toString() })],
      })));
    let S;
    (e[14] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((S = (e) => {
      ...
      (o =
        h && g.length === 0
          ...
          : h
            ? g.map((e) => (0, J.jsx)(gs, { entry: e, query: n }, `${e.kind}:${e.name}`))
            : null),
      (e[0] = t),
      (e[1] = n),
      (e[2] = i),
  ...
  let g;
  return (
    e[25] !== i || e[26] !== h || e[27] !== u || e[28] !== d || e[29] !== f || e[30] !== p
      ? ((g = (0, J.jsx)(i, {
          storageKey: u,
          title: d,
          variant: f,
...
function gs(e) {
  let t = (0, K.c)(9),
    ...
    o;
  t[0] !== n.name || t[1] !== r
    ? ((o = cs(n.name, r)), (t[0] = n.name), (t[1] = r), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== i || t[4] !== a
    ? ((s = (0, J.jsx)(_s, { label: i, tone: a })), (t[3] = i), (t[4] = a), (t[5] = s))
    : (s = t[5]);
  let c;
  return (
    t[6] !== o || t[7] !== s
      ? ((c = (0, J.jsx)(Xi, { title: o, status: s })), (t[6] = o), (t[7] = s), (t[8] = c))
      : (c = t[8]),
    c
  );
}
function _s(e) {
  let t = (0, K.c)(7),
    ...
    s;
  t[0] !== i || t[1] !== a || t[2] !== o
    ? ((s = F(`inline-flex min-h-5 items-center rounded border px-2 text-xs`, i, a, o)),
      (t[0] = i),
      (t[1] = a),
      (t[2] = o),
      (t[3] = s))
...
function vs() {
  let e = (0, K.c)(18),
    ...
    [r, i] = (0, q.useState)(!1),
    a;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: g }), (e[0] = a)) : (a = e[0]);
  let o;
  e[1] === t
    ? (o = e[2])
  ...
  e[10] !== r || e[11] !== t || e[12] !== d || e[13] !== l
    ? ((p = t
        ? l.length === 0
          ...
          : l.map((e) => (0, J.jsx)(bs, { includeHidden: r, label: d[e] ?? e, root: e }, e))
        : null),
      (e[10] = r),
      (e[11] = t),
      (e[12] = d),
...
function bs(e) {
  ...
  t[4] !== c || t[5] !== l
    ...
    : (u = t[6]);
  let d;
  t[7] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = () => o(xs)), (t[7] = d)) : (d = t[7]);
  let f;
  t[8] !== n || t[9] !== u
    ? ((f = (0, J.jsx)(Xi, { title: u, subtitle: n, onClick: d })),
      (t[8] = n),
      (t[9] = u),
      (t[10] = f))
    : (f = t[10]);
  ...
  t[11] !== i || t[12] !== a || t[13] !== n
    ? ((p = a
        ? (0, J.jsx)(`div`, {
            className: `pb-1`,
            children: (0, J.jsx)(ut, { hostId: g, includeHidden: i, root: n }),
          })
        : null),
      (t[11] = i),
      (t[12] = a),
...
var Ss = `debug-workspace-runtime`,
  Cs = 1e3,
...
function Ts() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, J.jsx)(Es, { primaryRuntime: t })), (e[0] = n))
      : (n = e[0]),
    n
  );
}
function Es(e) {
  let t = (0, K.c)(33),
    ...
    u = R(gt),
    d;
  t[0] === n ? (d = t[1]) : ((d = () => n.getUpdateStatus()), (t[0] = n), (t[1] = d));
  let f;
  t[2] !== o || t[3] !== d
    ? ((f = {
        enabled: o,
      ...
      (t[4] = f))
    : (f = t[4]);
  let { data: p, isLoading: m, refetch: h } = ce(f),
    g;
  t[5] !== n || t[6] !== a
    ? ((g = async (e) => {
        let { release: t } = e;
        return (await pt(a), n.runUpdateNow({ release: t }));
      }),
      (t[5] = n),
      (t[6] = a),
      (t[7] = g))
  ...
  t[8] === i
    ? (_ = t[9])
    : ((_ = (e) => {
        (l(ks(e)), i.invalidateQueries({ queryKey: mt }));
      }),
      (t[8] = i),
      (t[9] = _));
  let v;
  t[10] !== g || t[11] !== _
    ? ((v = { mutationFn: g, onSuccess: _ }), (t[10] = g), (t[11] = _), (t[12] = v))
    : (v = t[12]);
  let y = ne(v),
  ...
  t[13] === r
    ...
    : ((S = (e) => {
        ...
        (r.set(gt, t), H.dispatchMessage(`set-primary-runtime-install-release`, { release: t }));
      }),
      (t[13] = r),
      (t[14] = S));
  let C = S,
        ...
        ? (0, J.jsx)(et, {
            ...
            triggerButton: (0, J.jsxs)(`button`, {
              ...
              children: [
                ...
                `Cron`,
                (0, J.jsx)(tt, { className: `icon-2xs opacity-70` }),
              ],
            }),
            children: (0, J.jsxs)(`div`, {
              className: `flex min-w-[220px] flex-col gap-0.5`,
              children: [
                (0, J.jsx)($e.Title, { children: `Workspace runtime cron` }),
                (0, J.jsx)($e.Item, {
                  disabled: b || p?.enabled === !1,
                  onSelect: () => {
                    y.mutateAsync({ release: u }).catch((e) => {
                      (l(`Failed to trigger cron job`),
                        U.error(`Failed to trigger workspace runtime cron from debug page`, {
                          safe: { release: u },
                          sensitive: { error: e },
                        }));
                    });
                ...
                (0, J.jsx)($e.Separator, {}),
                (0, J.jsx)($e.Title, { children: `Install flow` }),
                (0, J.jsxs)(`div`, {
          ...
          : (0, J.jsxs)(`div`, {
              ...
              children: [
                ...
                p?.disabledReason == null
                  ? null
                  : (0, J.jsx)(X, { label: `Disabled`, value: js(p.disabledReason) }),
                (0, J.jsx)(X, { label: `Next cron`, value: Os(p?.nextRunAt ?? null) }),
                (0, J.jsx)(X, {
                  label: `Startup check`,
...
function Os(e) {
  ...
  if (n < 60) return `${t.toLocaleString()} (${ws.format(n, `second`)})`;
  let r = Math.ceil(n / 60);
  return r < 60
    ? `${t.toLocaleString()} (${ws.format(r, `minute`)})`
    : `${t.toLocaleString()} (${ws.format(Math.ceil(r / 60), `hour`)})`;
}
function ks(e) {
  switch (e.status) {
    ...
    case `skipped`:
      return e.reason == null ? `Skipped` : `Skipped: ${As(e.reason)}`;
  }
}
function As(e) {
  switch (e) {
...
function Ns() {
  let e = (0, K.c)(23),
    t = ee(W),
    [n, r] = (0, q.useState)(null),
    i = ge(f.autoCleanupEnabled),
    { data: a, isLoading: o } = me(p.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED),
    s = a === !0,
    c = i && s,
    l = o,
  ...
  let v;
  e[6] !== d || e[7] !== h || e[8] !== _
    ? ((v = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [d, h, _] })),
      (e[6] = d),
      (e[7] = h),
      (e[8] = _),
      (e[9] = v))
  ...
  e[11] === t
    ...
    : ((b = (e) => {
        (r(null),
          E(t, p.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED, e).catch((e) => {
...
var Ps = 1e3,
  Fs = `debug-ambient-suggestion-threads`,
  Is = new Intl.RelativeTimeFormat(void 0, { numeric: `auto` }),
  Ls = V(W, `is-packaged`, { staleTime: se.FIVE_SECONDS });
function Rs(e) {
  let t = (0, K.c)(17),
    { onClose: n } = e,
    [r, i] = (0, q.useState)(Bs),
  ...
  t[7] === r
    ? ((u = t[8]), (d = t[9]))
    : ((u = (e) => {
        o((t) => Ji({ ...t, x: t.x + e.x, y: t.y + e.y }, r));
      }),
      (d = (e) => {
        o((t) => Yi(t, e, r));
      }),
  ...
  t[10] !== n || t[11] !== u || t[12] !== d
    ? ((f = (0, J.jsx)(Vs, { onClose: n, onMove: u, onResize: d })),
      (t[10] = n),
      (t[11] = u),
      (t[12] = d),
      (t[13] = f))
...
function Vs({
  ...
  let c = he(),
    ...
    v = h != null && o && a.allowDebugMenu(Me()),
    y = m?.isPackaged === !1,
    b = e ?? null,
    x =
      typeof window < `u`
    ...
    C = async (e) => {
      if (!f) {
        ...
        try {
          ...
          U.error(`Failed to export logs`, { safe: { scope: e }, sensitive: { error: t } });
        } finally {
          p(!1);
        }
      }
    ...
    w = () => {
      (async () => {
        try {
          ...
          U.error(`Failed to open debug window`, { safe: {}, sensitive: { error: e } });
        }
      })();
    };
  return (0, J.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, J.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, J.jsx)(Ie, {
            electron: !0,
            children: (0, J.jsx)(go, { conversationId: b ?? void 0 }),
          }),
          b == null ? null : (0, J.jsx)(Bi, { conversationId: b }),
          l.map((e) => {
            ...
            return (0, J.jsx)(
              Y,
              {
                ...
                storageKey: t,
                variant: `selection`,
                children: (0, J.jsx)(Li, { lines: e.lines }),
              },
              e.id,
            );
          }),
          ...
          null,
          (0, J.jsx)(Ft, {}),
          (0, J.jsx)(Ie, { electron: !0, children: (0, J.jsx)(Tn, {}) }),
          (0, J.jsx)(sa, {}),
          (0, J.jsx)(Vo, {}),
          (0, J.jsx)(fs, {}),
          (0, J.jsx)(Ws, {}),
          ...
          (0, J.jsx)(rs, {}),
          y ? (0, J.jsx)(Zi, {}) : null,
          (0, J.jsx)(kt, { sourceThreadId: b ?? void 0 }),
          y ? (0, J.jsx)(Ns, {}) : null,
          (0, J.jsx)(Qi, {}),
          (0, J.jsx)(Y, {
                              ...
                              children: [
                                ...
                                f
                                  ? (0, J.jsx)(`div`, {
                                      ...
                                      children: (0, J.jsx)(_e, { className: `icon-xxs` }),
                                    })
                                  : (0, J.jsx)(et, {
                                      align: `end`,
                                      triggerButton: (0, J.jsxs)(`button`, {
...
function Ws() {
  let e = (0, K.c)(25),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((t = Me()), (e[0] = t)) : (t = e[0]);
  let r = t,
    i = I(),
    [a, o] = (0, q.useState)(Ks),
    s = a && (r === `dev` || r === `nightly`),
  ...
  e[1] === s
    ? (c = e[2])
    : ((c = { queryConfig: { enabled: s, intervalMs: Ps } }), (e[1] = s), (e[2] = c));
  let { data: l, isLoading: u } = ie(`ambient-suggestions-generation-statuses`, c),
    d;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = { hostId: g }), (e[3] = d)) : (d = e[3]);
  let f;
  e[4] === a
    ? (f = e[5])
    : ((f = { params: d, queryConfig: { enabled: a } }), (e[4] = a), (e[5] = f));
  let { data: p } = ie(`workspace-root-options`, f),
    m;
  e[6] === a ? (m = e[7]) : ((m = { queryConfig: { enabled: a } }), (e[6] = a), (e[7] = m));
  ...
  e[8] === i
    ...
    : ((_ = {
        onSuccess: () => {
          (i.invalidateQueries({ queryKey: ae(`ambient-suggestions-generation-statuses`) }),
            i.invalidateQueries({ queryKey: ae(`ambient-suggestions`) }));
        },
      }),
      (e[8] = i),
      (e[9] = _));
  let v = oe(`ambient-suggestions-refresh`, _),
    y = l?.statuses,
    b,
    x,
    S;
              ...
              (0, J.jsx)(
                Xi,
                {
                  ...
                  rightActions: (0, J.jsx)(`button`, {
                    ...
                    disabled: s || v.isPending,
                    onClick: () => {
                      v.mutateAsync({ hostId: g, projectRoot: n(r) }).catch((e) => {
                        U.error(`Failed to refresh ambient suggestions from debug page`, {
                          safe: {},
  ...
  let C = a ? `Ambient suggestion chats (${x.length})` : `Ambient suggestion chats`,
    w;
  return (
    e[22] !== b || e[23] !== C
      ? ((w = (0, J.jsx)(Y, {
...
function qs(e, t) {
  ...
  if (r > 0) {
    ...
    return t == null
      ...
      : `${r} safety check active • started ${Js(t)}${n}`;
  }
  if (i > 0) {
    let t = e?.runningStartedAtMs ?? null;
    return t == null ? `${i} active${n}` : `${i} active • started ${Js(t)}${n}`;
  }
  return e?.lastFinishedAtMs == null
    ? `No completed run yet${n}`
    : `Finished ${Js(e.lastFinishedAtMs)}${n}`;
}
function Js(e) {
  let t = Math.max(0, Math.floor((Date.now() - e) / 1e3));
  if (t < 60) return Is.format(-t, `second`);
  let n = Math.floor(t / 60);
  if (n < 60) return Is.format(-n, `minute`);
  let r = Math.floor(n / 60);
  return Is.format(-r, `hour`);
}
function Ys(e) {
  try {
    return window.localStorage.getItem(e) === `open`;
