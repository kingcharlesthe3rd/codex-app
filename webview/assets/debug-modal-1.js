...
import { n as me } from "./rpc-1.js";
import { c as he, o as ge, s as _e } from "./statsig.js";
import { t as ve } from "./use-global-state.js";
import { t as ye } from "./use-auth.js";
import { t as be } from "./link-external.js";
import { a as xe, n as Se, s as Ce, t as we } from "./mcp-capability-signals.js";
import { t as Te } from "./chevron.js";
import { m as Ee } from "./chunk-109.js";
import { a as De, i as Oe } from "./announcement-atoms.js";
import {
  a as ke,
  d as Ae,
  f as je,
...
import { t as Le } from "./info.js";
import { t as Re } from "./x.js";
import { y as ze } from "./use-plugins.js";
import { n as Be, s as Ve } from "./home-onboarding-assistant-tutorial-card.js";
import { t as He } from "./with-window.js";
import { r as Ue } from "./modal-controller-state.js";
import { d as We, i as Ge, l as Ke, n as qe, u as Je } from "./dialog-layout.js";
import { t as Ye } from "./use-navigate-to-local-conversation.js";
import { n as Xe } from "./electron-menu-shortcuts.js";
import { t as Ze } from "./remote-connections-onboarding-signals.js";
import { r as Qe, t as $e } from "./dropdown.js";
import { t as et } from "./code-snippet.js";
import { t as tt } from "./copy-button.js";
import { t as nt } from "./image-preview-dialog.js";
import { i as rt, n as it, r as at, t as ot } from "./use-is-thread-realtime-enabled.js";
import { t as st } from "./arrow-up-right-lg-BG8h--9V.js";
import { t as ct } from "./toggle.js";
import { t as lt } from "./score-query-match-CZO-nWKm.js";
import { a as ut, i as dt } from "./workspace-onboarding-experiment.js";
import { t as ft } from "./browser-sidebar-comment-mode-coachmark-state.js";
import { t as pt } from "./workspace-directory-tree.js";
import { n as mt, o as ht, t as gt } from "./app-server-notification-debug-signals.js";
import { a as _t, t as vt } from "./primary-runtime-query-keys.js";
import { i as yt, r as bt } from "./primary-runtime-install-state-e.js";
import { t as xt } from "./run-app-action-in-primary-window.js";
import { n as St, t as Ct } from "./hotkey-window-state.js";
import { h as wt, t as Tt } from "./codex-mobile-setup-dialog.js";
import { a as Et, o as Dt, s as Ot } from "./use-debug-panel.js";
import { r as kt, t as At } from "./thread-virtualizer.js";
function jt({ labels: e, projectlessThreadCwd: t, statuses: n, workspaceRoots: r }) {
  let i = new Map();
...
function Y(e) {
  ...
  t[19] === c
    ? (C = t[20])
    : ((C = c
        ? (0, J.jsx)(`span`, { className: `flex items-center gap-1`, onClick: Mt, children: c })
        : null),
      (t[19] = c),
      (t[20] = C));
  let w;
...
function Pt({ sourceThreadId: e }) {
  let [t, n] = (0, q.useState)(Nt),
    ...
    s = async () => {
      if (!a) {
        ...
        try {
          let n = JSON.parse(t),
            r = await xt(n, { sourceThreadId: e });
          i(
            `Success\n\nResult:\n${JSON.stringify(r, null, 2)}\n\nSent payload:\n${JSON.stringify(n, null, 2)}`,
          );
        } catch (e) {
          (i(`Error: ${e instanceof Error ? e.message : String(e)}\n\nInput JSON:\n${t}`),
            F.error(`Failed to run debug app action`, {
              safe: {},
...
function X(e) {
  ...
  t[6] === r
    ...
    : ((c = (0, J.jsx)(tt, {
        ...
        onCopy: () => {
          navigator?.clipboard?.writeText && navigator.clipboard.writeText(r).catch(Ft);
        },
      })),
      (t[6] = r),
      (t[7] = c));
...
function Ft() {}
var It = new Intl.DateTimeFormat(void 0, {
    fractionalSecondDigits: 3,
    hour: `2-digit`,
    minute: `2-digit`,
    second: `2-digit`,
  }),
  Lt = `debug-app-server-section`,
  Rt = [`resumed`, `resuming`, `needs_resume`],
  zt = s(u, (e) => null);
function Bt() {
  let e = (0, K.c)(2),
    t = l(w),
...
function Vt(e) {
  let t = (0, K.c)(15),
    ...
    i = l(k),
    [a] = S(`host_config`),
    [o] = S(`remote_ssh_connections`),
    [s] = S(`remote_control_connections`),
    c;
...
function Ht(e) {
  let t = (0, K.c)(69),
    ...
    p = !!n.lines?.length,
    m;
  t[0] === o ? (m = t[1]) : ((m = o.filter(Sn)), (t[0] = o), (t[1] = m));
  let h = m.length,
    _ = a(zt, r) ?? n.stateType === `local`,
    y = n.stateType === `local` ? `local` : l,
    b;
  t[2] === o ? (b = t[3]) : ((b = o.filter(Gt)), (t[2] = o), (t[3] = b));
  let x = b.length,
    S;
  t[4] === i ? (S = t[5]) : ((S = i.filter(Wt)), (t[4] = i), (t[5] = S));
  let w = S.length,
    T;
  t[6] === i ? (T = t[7]) : ((T = i.filter(Ut)), (t[6] = i), (t[7] = T));
  let E = T.length,
    D;
  t[8] !== r || t[9] !== s
    ? ((D = (e) => {
        s.set(zt, r, e.currentTarget.open);
      }),
      (t[8] = r),
      (t[9] = s),
      (t[10] = D))
  ...
  t[11] === n.displayName
    ...
    : ((O = (0, J.jsx)(`span`, {
      ...
      (t[12] = O));
  let k;
  t[13] === y ? (k = t[14]) : ((k = (0, J.jsx)(fn, { state: y })), (t[13] = y), (t[14] = k));
  let A;
  t[15] !== O || t[16] !== k
  ...
  let V;
  t[47] !== p || t[48] !== n
    ? ((V = p ? (0, J.jsx)(Kt, { hostDetails: n }) : null), (t[47] = p), (t[48] = n), (t[49] = V))
    : (V = t[49]);
  let H;
  t[50] !== r || t[51] !== f
    ? ((H = (0, J.jsx)(Xt, { hostId: r, threadStatusEntries: f })),
      (t[50] = r),
      (t[51] = f),
      (t[52] = H))
    : (H = t[52]);
  let ne;
  t[53] !== r || t[54] !== o
    ? ((ne = (0, J.jsx)(Jt, { hostId: r, requests: o })), (t[53] = r), (t[54] = o), (t[55] = ne))
    : (ne = t[55]);
  let re;
  t[56] !== r || t[57] !== i
    ? ((re = (0, J.jsx)($t, { hostId: r, notifications: i })),
      (t[56] = r),
      (t[57] = i),
      (t[58] = re))
    : (re = t[58]);
  let ie;
  t[59] !== V || t[60] !== H || t[61] !== ne || t[62] !== re
    ? ((ie = (0, J.jsx)(`div`, {
...
function Kt(e) {
  let t = (0, K.c)(4),
    { hostDetails: n } = e,
    r;
  t[0] === n.lines ? (r = t[1]) : ((r = n.lines?.map(qt)), (t[0] = n.lines), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function Jt(e) {
  let t = (0, K.c)(16),
    ...
    [i, a] = (0, q.useState)(!1),
    o;
  t[0] === r ? (o = t[1]) : ((o = r.filter(Sn)), (t[0] = r), (t[1] = o));
  let s = o,
    c = i ? s : r,
    l = r.length === 0,
    u;
...
function Yt(e) {
  return (0, J.jsx)(cn, { request: e }, e.id);
}
function Xt({ hostId: e, threadStatusEntries: t }) {
  let [n, r] = (0, q.useState)(null),
    [i, a] = (0, q.useState)(null),
    o = mn(t),
    s = i != null && Rt.includes(i) ? i : null,
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(Y, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children:
          o.length === 0
            ? (0, J.jsx)(sn, { message: `No in-memory threads for this manager yet` })
            : (0, J.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, J.jsx)(`div`, {
                    ...
                    children:
                      c.length === 0
                        ? (0, J.jsx)(sn, { message: `No in-memory threads match this state` })
                        : c.map((t) =>
                            (0, J.jsxs)(
                              `div`,
                              {
                                      ...
                                      (0, J.jsx)(
                                        Zt,
                                        {
                                          ...
                                          onUnsubscribe: async (t) => {
                                            r(t);
                                            try {
                                              await x(`unsubscribe-thread-for-host`, {
                                                hostId: e,
                                                threadId: t,
                                              });
                                            } finally {
...
function Zt(e) {
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, J.jsx)(st, { className: `icon-xs` })), (t[9] = p))
    : (p = t[9]);
  let m;
  t[10] === f
    ? (m = t[11])
  ...
  let S = `resume: ${n.resumeState}`,
    C;
  t[28] === S ? (C = t[29]) : ((C = (0, J.jsx)(Qt, { label: S })), (t[28] = S), (t[29] = C));
  let w = `stream: ${o?.role ?? `none`}`,
    T;
  t[30] === w ? (T = t[31]) : ((T = (0, J.jsx)(Qt, { label: w })), (t[30] = w), (t[31] = T));
  let D = `runtime: ${n.threadRuntimeStatus?.type ?? `none`}`,
    O;
  t[32] === D ? (O = t[33]) : ((O = (0, J.jsx)(Qt, { label: D })), (t[32] = D), (t[33] = O));
  let k = `turn: ${n.lastTurnStatus ?? `none`}`,
    A;
  t[34] === k ? (A = t[35]) : ((A = (0, J.jsx)(Qt, { label: k })), (t[34] = k), (t[35] = A));
  let j;
  t[36] !== C || t[37] !== T || t[38] !== O || t[39] !== A
    ? ((j = (0, J.jsxs)(`div`, {
...
function $t(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== s || t[4] !== a) {
    ...
    let c = o,
      u;
    (t[18] === c ? (u = t[19]) : ((u = c.filter(rn)), (t[18] = c), (t[19] = u)), (p = u));
    let x;
    (t[20] !== c || t[21] !== a
      ? ((x = a ? c : c.filter(nn)), (t[20] = c), (t[21] = a), (t[22] = x))
      : (x = t[22]),
      (m = x),
      (d = on),
      (_ = r.length === 0),
      ...
      (g =
        e.length > 0
          ? (0, J.jsxs)(`select`, {
              ...
              children: [(0, J.jsx)(`option`, { value: ``, children: `All threads` }), e.map(tn)],
            })
          : null),
      (t[0] = n),
      (t[1] = r),
  ...
  t[33] !== f || t[34] !== p.length || t[35] !== m
    ? ((C =
        m.length > 0
          ...
          : (0, J.jsx)(sn, {
              message: p.length > 0 ? `Only hidden delta notifications recorded` : vn(f),
            })),
      (t[33] = f),
      (t[34] = p.length),
      (t[35] = m),
...
function en(e) {
  return (0, J.jsx)(ln, { notification: e }, e.id);
}
function tn(e) {
  return (0, J.jsx)(an, { threadId: e }, e);
}
function nn(e) {
  return !e.isNoisy;
}
...
function an(e) {
  let t = (0, K.c)(7),
    { threadId: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = te(n)), (t[0] = n), (t[1] = r));
  let i = a(h, r),
    o;
...
function cn(e) {
  ...
  t[7] === n.startedAtMs
    ? (o = t[8])
    : ((o = It.format(n.startedAtMs)), (t[7] = n.startedAtMs), (t[8] = o));
  let s;
  t[9] === o ? (s = t[10]) : ((s = (0, J.jsx)(`div`, { children: o })), (t[9] = o), (t[10] = s));
  let c;
  t[11] === n ? (c = t[12]) : ((c = Cn(n)), (t[11] = n), (t[12] = c));
  let l;
  ...
  t[25] === n.endedAtMs
    ...
    : ((h =
        n.endedAtMs == null
          ...
          : (0, J.jsxs)(`div`, { children: [`Ended: `, It.format(n.endedAtMs)] })),
      (t[25] = n.endedAtMs),
      (t[26] = h));
  let g;
  ...
  t[31] === n.paramsPreview
    ? (_ = t[32])
    : ((_ = (0, J.jsx)(un, { payload: n.paramsPreview, title: `Params` })),
      (t[31] = n.paramsPreview),
      (t[32] = _));
  let v;
  t[33] === n.resultPreview
    ...
    : ((v =
        n.resultPreview == null
          ? null
          : (0, J.jsx)(un, { payload: n.resultPreview, title: `Result` })),
      (t[33] = n.resultPreview),
      (t[34] = v));
  let y;
  t[35] === n.errorPreview
    ...
    : ((y =
        n.errorPreview == null
          ? null
          : (0, J.jsx)(un, { payload: n.errorPreview, title: `Error` })),
      (t[35] = n.errorPreview),
      (t[36] = y));
  let b;
...
function ln(e) {
  ...
  t[0] === n.severity
    ? (r = t[1])
    : ((r = G(`group/notification bg-token-background rounded-lg border`, wn(n.severity))),
      (t[0] = n.severity),
      (t[1] = r));
  let i;
  t[2] === n.method
  ...
  t[9] === n.receivedAtMs
    ? (s = t[10])
    : ((s = It.format(n.receivedAtMs)), (t[9] = n.receivedAtMs), (t[10] = s));
  let c;
  t[11] === s
    ? (c = t[12])
    : ((c = (0, J.jsx)(`div`, {
  ...
  t[16] === n.paramsPreview
    ...
    : ((u = (0, J.jsx)(`div`, {
        className: `space-y-3 border-t border-token-border p-3`,
        children: (0, J.jsx)(un, { payload: n.paramsPreview, title: `Params` }),
      })),
      (t[16] = n.paramsPreview),
      (t[17] = u));
  let d;
...
function un(e) {
  ...
  t[2] === n
    ...
    : ((a = (0, J.jsx)(`button`, {
        ...
        onClick: () => {
          navigator.clipboard?.writeText(n).catch(dn);
        },
        children: `Copy`,
      })),
      (t[2] = n),
...
function fn(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = G(`rounded-full px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide`, Tn(n))),
      (t[0] = n),
      (t[1] = r));
  let i;
  return (
...
function gn({ count: e, status: t }) {
  return `${t} (${e})`;
}
function _n(e) {
  return Rt.find((t) => t === e) ?? null;
}
function vn(e) {
  return e == null
...
var En = [`browser-debug-snapshot`],
  Dn = `debug-browser-tabs`,
  On = 1e3,
  kn = new Intl.DateTimeFormat(void 0, {
    fractionalSecondDigits: 3,
    hour: `2-digit`,
    minute: `2-digit`,
    second: `2-digit`,
...
function An() {
  ...
  e[1] === o
    ...
    : ((c = {
      ...
      (e[1] = o),
      (e[2] = c));
  let { data: l, isFetching: u, isLoading: d, refetch: f } = A(c),
    p;
  e[3] === f
    ? (p = e[4])
    : ((p = async (e) => {
        if (t != null)
          try {
            ...
            (a(`Failed to open Browser owner`),
              F.error(`Failed to open Browser debug owner`, {
                safe: {
                  browserTabId: e.browserTabId,
                  conversationId: e.conversationId,
                  windowId: e.windowId,
        ...
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              (0, J.jsx)(`button`, {
                ...
                disabled: l == null,
                onClick: () => {
                  l != null && navigator.clipboard?.writeText(JSON.stringify(l, null, 2)).catch(jn);
                },
                children: `Copy JSON`,
              }),
              (0, J.jsxs)(`button`, {
  ...
  e[10] !== l || e[11] !== m || e[12] !== d || e[13] !== n || e[14] !== i
    ? ((_ = n
        ? t == null
          ? (0, J.jsx)(qn, { message: `Browser debug service unavailable.` })
          : d && l == null
            ? (0, J.jsx)(qn, { message: `Loading Browser debug snapshot...` })
            : l == null
              ? (0, J.jsx)(qn, { message: `Browser debug snapshot unavailable.` })
              : (0, J.jsx)(Nn, { onOpenOwner: m, openOwnerStatus: i, snapshot: l })
        : null),
      (e[10] = l),
      (e[11] = m),
      (e[12] = d),
...
function Nn(e) {
  ...
  t[0] === i.capturedAtMs
    ? (a = t[1])
    : ((a = kn.format(i.capturedAtMs)), (t[0] = i.capturedAtMs), (t[1] = a));
  let o;
  t[2] === a
    ? (o = t[3])
  ...
  t[21] === r
    ...
    : ((v =
      ...
      (t[22] = v));
  let y;
  t[23] === i.windows ? (y = t[24]) : ((y = i.windows.map(Rn)), (t[23] = i.windows), (t[24] = y));
  let b;
  t[25] === y
    ? (b = t[26])
    : ((b = (0, J.jsx)(Kn, {
  ...
  t[34] === i.sessionRoutes
    ? (C = t[35])
    : ((C = i.sessionRoutes.map(Ln)), (t[34] = i.sessionRoutes), (t[35] = C));
  let w;
  t[36] === C
    ? (w = t[37])
    : ((w = (0, J.jsx)(Kn, {
  ...
  t[38] === i.pendingAttaches
    ? (T = t[39])
    : ((T = i.pendingAttaches.map(In)), (t[38] = i.pendingAttaches), (t[39] = T));
  let E;
  t[40] === T
    ? (E = t[41])
    : ((E = (0, J.jsx)(Kn, {
  ...
  t[42] === i.openRequests
    ? (D = t[43])
    : ((D = i.openRequests.map(Fn)), (t[42] = i.openRequests), (t[43] = D));
  let O;
  t[44] === D
    ? (O = t[45])
    : ((O = (0, J.jsx)(Kn, {
  ...
  t[46] === i.events
    ? (k = t[47])
    : ((k = i.events.slice().reverse().map(Pn)), (t[46] = i.events), (t[47] = k));
  let A;
  t[48] === k
    ? (A = t[49])
    : ((A = (0, J.jsx)(Kn, {
...
function Pn(e) {
  return (0, J.jsx)(Un, { event: e }, e.sequence);
}
function Fn(e) {
  return (0, J.jsx)(
    Wn,
...
function Ln(e) {
  return (0, J.jsx)(Vn, { route: e }, `${e.windowId}:${e.conversationId}`);
}
function Rn(e) {
  return (0, J.jsx)(zn, { window: e }, e.windowId);
}
function zn(e) {
  let t = (0, K.c)(32),
    { window: n } = e,
  ...
  return (
    t[28] !== x || t[29] !== S || t[30] !== C
      ? ((w = (0, J.jsx)(Wn, { details: x, subtitle: S, title: C })),
        (t[28] = x),
        (t[29] = S),
        (t[30] = C),
        (t[31] = w))
...
function Bn(e) {
  ...
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, J.jsxs)(`span`, {
        ...
        children: [`Open owner`, (0, J.jsx)(st, { className: `icon-2xs` })],
      })),
      (t[23] = g))
    : (g = t[23]);
  let _;
  ...
  let I;
  t[55] === r.bounds ? (I = t[56]) : ((I = Xn(r.bounds)), (t[55] = r.bounds), (t[56] = I));
  let L;
  t[57] === I
    ? (L = t[58])
  ...
  t[67] === re
    ? (ie = t[68])
    : ((ie = (0, J.jsx)(X, { label: `Flags`, value: re })), (t[67] = re), (t[68] = ie));
  let U = `page=${r.isBrowserUsePage}`,
    ae = `active=${r.isBrowserUseActive}`,
    oe = `agent=${r.isAgentControllingBrowser}`,
    W = `visibilityRequest=${r.hasPendingBrowserUseVisibilityRequest}`,
    se = `panelOpen=${r.pendingBrowserUsePanelOpen}`,
    ce;
  t[69] !== U || t[70] !== ae || t[71] !== oe || t[72] !== W || t[73] !== se
    ? ((ce = [U, ae, oe, W, se]),
      (t[69] = U),
      (t[70] = ae),
      (t[71] = oe),
  ...
  t[99] !== ve
    ? ((ye = (0, J.jsxs)(`div`, {
        ...
        children: [b, x, C, T, D, k, j, N, F, L, ie, G, ge, ve],
      })),
      (t[86] = b),
      (t[87] = x),
      (t[88] = C),
...
function Vn(e) {
  ...
  return (
    t[25] !== n.conversationId || t[26] !== v || t[27] !== y
      ? ((b = (0, J.jsx)(Wn, { details: v, subtitle: y, title: n.conversationId })),
...
function Hn(e) {
  ...
  return (
    t[19] !== f || t[20] !== p || t[21] !== m
      ? ((h = (0, J.jsx)(Wn, { details: f, subtitle: p, title: m })),
        (t[19] = f),
        (t[20] = p),
        (t[21] = m),
        (t[22] = h))
...
function Un(e) {
  ...
  t[2] === n.timestampMs
    ? (a = t[3])
    : ((a = kn.format(n.timestampMs)), (t[2] = n.timestampMs), (t[3] = a));
  let o;
  ...
  return (
    t[28] !== n.message || t[29] !== y || t[30] !== b
      ? ((x = (0, J.jsx)(Wn, { details: y, subtitle: n.message, title: b })),
        (t[28] = n.message),
        (t[29] = y),
        (t[30] = b),
        (t[31] = x))
...
function Wn(e) {
  ...
  t[4] !== a || t[5] !== o
    ...
    : (s = t[6]);
  let c;
  t[7] === n ? (c = t[8]) : ((c = n.map(Gn)), (t[7] = n), (t[8] = c));
  let l;
  t[9] === c
    ? (l = t[10])
  ...
  createTable: (e) => {
    ((e.getHeaderGroups = Z(
      ...
      (e.getLeftHeaderGroups = Z(
        ...
        (t, n, r) =>
          or(t, r?.map((e) => n.find((t) => t.id === e)).filter(Boolean) ?? [], e, `left`),
      ...
      (e.getRightHeaderGroups = Z(
        ...
        (t, n, r) =>
          or(t, r?.map((e) => n.find((t) => t.id === e)).filter(Boolean) ?? [], e, `right`),
...
function or(e, t, n, r) {
  ...
  (s(
    t.map((e, t) => ir(n, e, { depth: i, index: t })),
    i - 1,
  ),
    o.reverse());
  let c = (e) =>
...
var sr = (e, t, n, r, i, a, o) => {
    let s = {
      ...
      subRows: a ?? [],
      getLeafRows: () => tr(s.subRows, (e) => e.subRows),
...
lr.autoRemove = (e) => yr(e);
var ur = (e, t, n) => {
  var r;
  return !!(!((r = e.getValue(t)) == null || (r = r.toString()) == null) && r.includes(n));
};
ur.autoRemove = (e) => yr(e);
var dr = (e, t, n) => {
  var r;
  return (
...
dr.autoRemove = (e) => yr(e);
var fr = (e, t, n) => e.getValue(t)?.includes(n);
fr.autoRemove = (e) => yr(e);
var pr = (e, t, n) =>
  !n.some((n) => {
    var r;
    return !((r = e.getValue(t)) != null && r.includes(n));
  });
pr.autoRemove = (e) => yr(e) || !(e != null && e.length);
var mr = (e, t, n) => n.some((n) => e.getValue(t)?.includes(n));
mr.autoRemove = (e) => yr(e) || !(e != null && e.length);
var hr = (e, t, n) => e.getValue(t) === n;
hr.autoRemove = (e) => yr(e);
var gr = (e, t, n) => e.getValue(t) == n;
gr.autoRemove = (e) => yr(e);
var _r = (e, t, n) => {
  let [r, i] = n,
    a = e.getValue(t);
  return a >= r && a <= i;
};
((_r.resolveFilterValue = (e) => {
  let [t, n] = e,
  ...
  (_r.autoRemove = (e) => yr(e) || (yr(e[0]) && yr(e[1]))));
var vr = {
  includesString: lr,
      ...
      (e.getFilterFn = () =>
        $n(e.columnDef.filterFn)
          ...
          : e.columnDef.filterFn === `auto`
            ? e.getAutoFilterFn()
            : (t.options.filterFns?.[e.columnDef.filterFn] ?? vr[e.columnDef.filterFn])),
      (e.getCanFilter = () =>
      ...
      (e.setFilterValue = (n) => {
        t.setColumnFilters((t) => {
          let r = e.getFilterFn(),
            ...
            a = Zn(n, i ? i.value : void 0);
          if (xr(r, a, e)) return t?.filter((t) => t.id !== e.id) ?? [];
      ...
      e.options.onColumnFiltersChange == null ||
        e.options.onColumnFiltersChange((e) =>
          Zn(t, e)?.filter((e) => {
            ...
            return !(t && xr(t.getFilterFn(), e.value, t));
          }),
        );
    }),
    ...
    createColumn: (e, t) => {
      ((e.toggleGrouping = () => {
        ...
        (e.getAutoAggregationFn = () => {
          let n = t.getCoreRowModel().flatRows[0]?.getValue(e.id);
          if (typeof n == `number`) return Sr.sum;
          if (Object.prototype.toString.call(n) === `[object Date]`) return Sr.extent;
        }),
        (e.getAggregationFn = () => {
          if (!e) throw Error();
...
var Tr = {
    ...
    createColumn: (e, t) => {
      ((e.getIndex = Z(
        ...
        (e.getIsFirstColumn = (n) => Ir(t, n)[0]?.id === e.id),
        (e.getIsLastColumn = (n) => {
          let r = Ir(t, n);
  ...
  Er = () => ({ left: [], right: [] }),
  Dr = {
    getInitialState: (e) => ({ columnPinning: Er(), ...e }),
    ...
    createTable: (e) => {
      ((e.setColumnPinning = (t) =>
        ...
        (e.resetColumnPinning = (t) =>
          e.setColumnPinning(t ? Er() : (e.initialState?.columnPinning ?? Er()))),
...
var kr = { size: 150, minSize: 20, maxSize: 2 ** 53 - 1 },
  Ar = () => ({
    startOffset: null,
    startSize: null,
    deltaOffset: null,
  ...
  jr = {
    getDefaultColumnDef: () => kr,
    getInitialState: (e) => ({ columnSizing: {}, columnSizingInfo: Ar(), ...e }),
    getDefaultOptions: (e) => ({
    ...
    createColumn: (e, t) => {
      ((e.getSize = () => {
        ...
        return Math.min(
          Math.max(e.columnDef.minSize ?? kr.minSize, n ?? e.columnDef.size ?? kr.size),
          e.columnDef.maxSize ?? kr.maxSize,
        );
      }),
        (e.getStart = Z(
          (e) => [e, Ir(t, e), t.getState().columnSizing],
        ...
        (e.getResizeHandler = (n) => {
          ...
          return (a) => {
            if (
              !r ||
              !i ||
              (a.persist == null || a.persist(), Pr(a) && a.touches && a.touches.length > 1)
            )
              return;
            let o = e.getSize(),
              s = e
                ...
                : [[r.id, r.getSize()]],
              c = Pr(a) ? Math.round(a.touches[0].clientX) : a.clientX,
              l = {},
              u = (e, n) => {
                typeof n == `number` &&
    ...
    createTable: (e) => {
      ((e.setColumnSizing = (t) =>
        ...
        (e.resetHeaderSizeInfo = (t) => {
          e.setColumnSizingInfo(t ? Ar() : (e.initialState.columnSizingInfo ?? Ar()));
        }),
        (e.getTotalSize = () =>
...
var Lr = {
  ...
  Rr = {
    ...
    createTable: (e) => {
      ((e.getGlobalAutoFilterFn = () => vr.includesString),
        (e.getGlobalFilterFn = () => {
  ...
  zr = {
    ...
    getDefaultOptions: (e) => ({ onExpandedChange: Qn(`expanded`, e), paginateExpandedRows: !0 }),
    createTable: (e) => {
      let t = !1,
        n = !1;
  ...
  Br = 0,
  Vr = 10,
  Hr = () => ({ pageIndex: Br, pageSize: Vr }),
  Ur = {
    getInitialState: (e) => ({ ...e, pagination: { ...Hr(), ...e?.pagination } }),
      ...
      ((e._autoResetPageIndex = () => {
        ...
        (e.setPagination = (t) =>
          e.options.onPaginationChange == null
            ? void 0
            : e.options.onPaginationChange((e) => Zn(t, e))),
        (e.resetPagination = (t) => {
          e.setPagination(t ? Hr() : (e.initialState.pagination ?? Hr()));
        }),
        (e.setPageIndex = (t) => {
          e.setPagination((n) => {
        ...
        (e.setPageSize = (t) => {
          e.setPagination((e) => {
            let n = Math.max(1, Zn(t, e.pageSize)),
  ...
  Wr = () => ({ top: [], bottom: [] }),
  Gr = {
    getInitialState: (e) => ({ rowPinning: Wr(), ...e }),
    ...
    createTable: (e) => {
      ((e.setRowPinning = (t) =>
        ...
        (e.resetRowPinning = (t) =>
          e.setRowPinning(t ? Wr() : (e.initialState?.rowPinning ?? Wr()))),
    ...
    createTable: (e) => {
      ((e.setRowSelection = (t) =>
        ...
        (e.getSelectedRowModel = Z(
          ...
          (t, n) => (Object.keys(t).length ? Jr(e, n) : { rows: [], flatRows: [], rowsById: {} }),
  ...
  qr = (e, t, n, r, i) => {
    ...
    (n
      ...
      r &&
        ...
        o.subRows.forEach((t) => qr(e, t.id, n, r, i)));
  };
function Jr(e, t) {
...
function Xr(e, t, n) {
  ...
  return (
    e.subRows.forEach((e) => {
      if (
        !(a && !i) &&
        (e.getCanSelect() && (Yr(e, t) ? (a = !0) : (i = !1)), e.subRows && e.subRows.length)
      ) {
        let n = Xr(e, t);
...
var Zr = /([0-9]+)/gm,
  Qr = (e, t, n) => oi(ai(e.getValue(n)).toLowerCase(), ai(t.getValue(n)).toLowerCase()),
  $r = (e, t, n) => oi(ai(e.getValue(n)), ai(t.getValue(n))),
  ei = (e, t, n) => ii(ai(e.getValue(n)).toLowerCase(), ai(t.getValue(n)).toLowerCase()),
  ti = (e, t, n) => ii(ai(e.getValue(n)), ai(t.getValue(n))),
  ni = (e, t, n) => {
    let r = e.getValue(n),
      i = t.getValue(n);
...
function oi(e, t) {
  let n = e.split(Zr).filter(Boolean),
    r = t.split(Zr).filter(Boolean);
      ...
      createColumn: (e, t) => {
        ((e.getAutoSortingFn = () => {
          ...
          for (let t of n) {
            ...
            if (typeof n == `string` && ((r = !0), n.split(Zr).length > 1)) return si.alphanumeric;
          }
          ...
          (e.getSortingFn = () => {
            ...
            return $n(e.columnDef.sortingFn)
              ...
              : e.columnDef.sortingFn === `auto`
                ? e.getAutoSortingFn()
                : (t.options.sortingFns?.[e.columnDef.sortingFn] ?? si[e.columnDef.sortingFn]);
          }),
          (e.toggleSorting = (n, r) => {
        ...
        let n = { rows: [], flatRows: [], rowsById: {} },
          r = function (t, i, a) {
            ...
            for (let c = 0; c < t.length; c++) {
              let l = sr(e, e._getRowId(t[c], c, a), t[c], c, i, void 0, a?.id);
...
function di() {
  return (e) =>
    Z(
      ...
      (e, t, n) => (!t.rows.length || (e !== !0 && !Object.keys(e ?? {}).length) || !n ? t : fi(t)),
...
function pi(e, t) {
  return e ? (mi(e) ? q.createElement(e, t) : e) : null;
}
function mi(e) {
  return hi(e) || typeof e == `function` || gi(e);
}
function hi(e) {
  return (
    typeof e == `function` &&
...
function Ei(e) {
  return e == null ? `default` : e > bi ? `danger` : e > yi ? `warning` : `default`;
}
function Di(e, t) {
  let n = (t.get(e.pid) ?? []).map((e) => Di(e, t));
  return (
    n.sort(Oi),
    {
      children: n,
      commandLabel: Si(e.command),
      fullCommand: e.command.trim().length > 0 ? e.command.trim() : `(command unavailable)`,
      process: e,
      totalCpuPercent: ki(e.cpuPercent, n),
      totalRssKb: Ai(e.rssKb, n),
    }
  );
}
function Oi(e, t) {
...
function ji(e) {
  return vi.default.basename(e.replaceAll(`\\`, `/`));
}
var Mi = `debug-child-processes`,
  Ni = 12,
  Pi = 36;
function Fi() {
  let e = (0, K.c)(25),
  ...
  let { data: l, isLoading: u } = I(`child-processes`, c),
    d;
  e[2] === l?.processes
    ? (d = e[3])
    ...
    ? ((_ = t
        ? u && l == null
          ...
          : l?.rootProcess == null
            ...
            : (0, J.jsx)(Li, { onProcessDetailsClick: o, processes: f, rootProcess: l.rootProcess })
        : null),
      (e[8] = l),
      (e[9] = u),
      (e[10] = t),
  ...
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, J.jsx)(Ge, {
        title: (0, J.jsx)(We, { children: `Process details` }),
        subtitle: (0, J.jsx)(Je, { children: `The process ID and full command are shown below` }),
      })),
      (e[14] = b))
    : (b = e[14]);
  let x;
  ...
  let S;
  e[17] !== x || e[18] !== v
    ? ((S = (0, J.jsx)(Ke, { open: v, onOpenChange: y, size: `wide`, children: x })),
      (e[17] = x),
      (e[18] = v),
      (e[19] = S))
    : (S = e[19]);
...
function Li({ onProcessDetailsClick: e, processes: t, rootProcess: n }) {
  let r = (0, q.useMemo)(() => xi(n, t), [t, n]),
    i = (0, q.useMemo)(() => (r == null ? [] : [r]), [r]),
    a = _i({
      columns: (0, q.useMemo)(() => Ri(e), [e]),
      data: i,
      getCoreRowModel: ui(),
      getExpandedRowModel: di(),
                      ...
                      (0, J.jsx)(
                        `th`,
                        {
                          ...
                          children: e.isPlaceholder
                            ? null
                            : pi(e.column.columnDef.header, e.getContext()),
                        },
                        e.id,
                      ),
                    ),
        ...
        (0, J.jsx)(zi, {
          selfValue:
            e.original.process.depth === 0 && e.original.process.cpuPercent == null
              ? ``
              : wi(e.original.process.cpuPercent),
          totalValue: wi(e.original.totalCpuPercent),
        }),
    },
    {
      id: `ram`,
      ...
      cell: ({ row: e }) =>
        (0, J.jsx)(zi, {
          selfValue: Ci(e.original.process.rssKb),
          totalValue: Ci(e.original.totalRssKb),
          tone: Ei(e.original.totalRssKb),
        }),
    },
    {
      ...
      id: `age`,
      header: `Age`,
      cell: ({ row: e }) => Ti(e.original.process.ageSeconds),
    },
  ];
}
function zi(e) {
...
function Vi() {
  try {
    return window.localStorage.getItem(Mi) === `open`;
  } catch {
    return !1;
  }
}
function Hi(e) {
  let t = (0, K.c)(4),
    { lines: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = n.map(Ui)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function Gi(e) {
  ...
  if (
    ...
    let e = Dt(r),
      a = Ot(r);
    ((d = Y),
      (g = `Local conversation`),
      (_ = `debug-entry-local-conversation-current`),
      (v = `selection`),
      (u = Hi));
    let f;
    t[13] === n ? (f = t[14]) : ((f = { label: `id`, value: n }), (t[13] = n), (t[14] = f));
    let p;
    t[15] === i ? (p = t[16]) : ((p = { label: `model`, value: i }), (t[15] = i), (t[16] = p));
    let m;
    t[17] === o ? (m = t[18]) : ((m = { label: `reasoning`, value: o }), (t[17] = o), (t[18] = m));
    let y;
    t[19] === s
      ? (y = t[20])
    ...
    (t[27] === T
      ...
      (t[11] = _),
      (t[12] = v));
  } else ((u = t[7]), (d = t[8]), (h = t[9]), (g = t[10]), (_ = t[11]), (v = t[12]));
  let b;
  t[29] !== u || t[30] !== h
    ? ((b = (0, J.jsx)(u, { lines: h })), (t[29] = u), (t[30] = h), (t[31] = b))
    : (b = t[31]);
  let x;
  return (
    t[32] !== d || t[33] !== g || t[34] !== _ || t[35] !== v || t[36] !== b
      ? ((x = (0, J.jsx)(d, { title: g, storageKey: _, variant: v, children: b })),
        (t[32] = d),
        (t[33] = g),
        (t[34] = _),
        (t[35] = v),
...
var Ji = 96,
  ...
  Xi = 480,
  Zi = 320;
function Qi({ height: e, topInset: t = 0, width: n }) {
  let r = Math.min(920, n - 32),
    i = e - t,
    a = Math.min(840, i - 32);
  return {
    height: Math.max(Zi, a),
    width: Math.max(Xi, r),
    x: Math.round((n - r) / 2),
...
function $i(e, t) {
  let n = t.topInset ?? 0,
    r = t.height - n,
    i = Math.max(Xi, Math.min(e.width, t.width));
  return {
    height: Math.max(Zi, Math.min(e.height, r)),
    width: i,
    x: Math.min(t.width - Ji, Math.max(Ji - i, e.x)),
    y: Math.min(t.height - Yi, Math.max(n, e.y)),
  };
}
function ea(e, t, n) {
  return $i({ ...e, height: e.height + t.y, width: e.width + t.x }, n);
}
function ta(e) {
  let t = (0, K.c)(22),
...
function na() {
  let e = (0, K.c)(15),
    ...
    { data: i, isLoading: a } = ve(oe.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED),
    o = i === !0,
  ...
  e[3] === t
    ...
    : ((p = (e) => {
        (r(null),
          d(t, oe.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED, e)
            .then(() => {
              M.dispatchMessage(`global-dictation-force-lock-changed`, { enabled: e });
            })
            .catch((e) => {
              r(
...
function ra() {
  ...
  e[0] === t
    ? (a = e[1])
    : ((a = { mutationFn: ia, onSuccess: (e) => (t.setQueryData(Ct, e.state), e) }),
      (e[0] = t),
      (e[1] = a));
  let o = N(a);
  ...
  e[2] === i.configuredHotkey
    ? (s = e[3])
    : ((s = i.configuredHotkey == null ? `Off` : Xe(i.configuredHotkey)),
      (e[2] = i.configuredHotkey),
      (e[3] = s));
  let c = s,
...
async function ia(e) {
  let { enabled: t } = e,
    n = me.hotkeyWindowHotkeys;
  if (n == null) throw Error(`Popout Window hotkeys are unavailable`);
  return n.setDevOverrideEnabled(t);
}
var aa = `debug-maitai-section`,
  oa = [`all`, `family`, `signal`, `derived`, `query`, `mutation`],
  sa = 50,
  ca = 3,
  la = 12,
  ua = 4,
...
function pa() {
  ...
  if (
    ...
    ((b = n.filter((e) => Aa(e).includes(i) && ja(e).includes(c) && Oa(e, l))),
      (g = b.slice(0, m)));
    let u = Ta(g);
    ...
    e[16] === o
      ...
      : ((w = (0, J.jsx)(`input`, {
        ...
        (e[17] = w));
    let T;
    e[18] === l ? (T = e[19]) : ((T = ka(l)), (e[18] = l), (e[19] = T));
    let E;
    e[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((E = (0, J.jsx)(Te, { className: `icon-2xs opacity-70` })), (e[20] = E))
      : (E = e[20]);
    let D;
    e[21] === T
      ? (D = e[22])
    ...
    e[24] === D
      ? (k = e[25])
      : ((k = (0, J.jsx)($e, { align: `end`, triggerButton: D, children: O })),
        (e[24] = D),
        (e[25] = k));
    let A;
...
function ba(e) {
  ...
  t[12] === b
    ...
    : ((x = (0, J.jsx)(`span`, {
      ...
      (t[13] = x));
  let S;
  t[14] === n ? (S = t[15]) : ((S = Da(n)), (t[14] = n), (t[15] = S));
  let C;
  t[16] === S
    ? (C = t[17])
    : ((C = (0, J.jsx)(`span`, {
            ...
            children: [
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsxs)(`div`, {
                    className: `truncate text-xs text-token-description-foreground`,
                    children: [n.scopeName, ` /`, ` `, Na(n.scopeKey)],
                  }),
                  p
                    ? (0, J.jsx)(ct, {
...
function Sa(e) {
  let t = (0, K.c)(17),
    ...
    [r, i] = (0, q.useState)(!1),
    a;
  t[0] === n ? (a = t[1]) : ((a = Fa(n)), (t[0] = n), (t[1] = a));
  let o = a,
    s;
  t[2] !== r || t[3] !== o.text || t[4] !== n
    ? ((s = r ? Pa(n) : o.text), (t[2] = r), (t[3] = o.text), (t[4] = n), (t[5] = s))
    : (s = t[5]);
  let c = s,
...
function wa(e) {
  let t = (0, K.c)(20),
    ...
    o;
  t[0] === r ? (o = t[1]) : ((o = Pa(r)), (t[0] = r), (t[1] = o));
...
function Oa(e, t) {
  return t === `all` ? !0 : t === `family` ? Ea(e) : !Ea(e) && Da(e) === t;
}
function ka(e) {
  switch (e) {
    case `all`:
...
function ja(e) {
  return Ea(e) ? Pa(e.familyKey).toLowerCase() : ``;
}
function Ma(e, t, n) {
  try {
    return e.get(t.atom);
...
function Na(e) {
  return typeof e == `string` ? e : Pa(e).replaceAll(/\s+/g, ` `);
}
function Pa(e) {
  if (e instanceof Error) return `${e.name}: ${e.message}`;
  if (e === void 0) return `undefined`;
  try {
    return JSON.stringify(e, Va(), 2) ?? Object.prototype.toString.call(e);
  } catch {
...
function Ia(e, t, n) {
  ...
  if (typeof e == `string`) return e.length <= da ? e : ((t.truncated = !0), `${e.slice(0, da)}…`);
  ...
  if (e instanceof Map)
    return La([...e.entries()], t, ([e, r]) => [Ia(e, t, n + 1), Ia(r, t, n + 1)]);
  if (e instanceof Set) return La([...e], t, (e) => Ia(e, t, n + 1));
  if (Array.isArray(e)) return La(e, t, (e) => Ia(e, t, n + 1));
  let r = Object.entries(e),
    i = r.slice(0, la).map(([e, r]) => [e, Ia(r, t, n + 1)]);
  return (
...
var Ha = 8,
  ...
  Ja = V({ type: se(`text`), text: W() }).catchall(U()),
  Ya = V({ code: W(), timeout_ms: U().optional(), title: U().optional() }).catchall(U());
function Xa(e) {
  let t = Za(e);
  return t.totalCount === 0
    ...
    : {
        lines: [
          ...
          ...t.recentCalls.flatMap((e, t) => $a(e, t)),
        ],
      };
}
function Za(e) {
...
function Qa(e) {
  return e.type === `mcpToolCall` && e.server === Ka;
}
function $a({ conversationId: e, item: t, turnId: n }, r) {
  let i = [
    {
      label: `call[${r}]`,
      value:
  ...
  return (
    ...
    t.result != null &&
      (i.push(...no(t.result, r)),
      i.push({ kind: `json`, label: `call[${r}].result`, value: eo(t.result, Wa) })),
    i
  );
}
function eo(e, t = Ua) {
  return po(JSON.stringify(e, to, 2) ?? String(e), t);
}
function to(e, t) {
  return e === `data` && typeof t == `string` && oo(this)
...
function no(e, t) {
  ...
  return n == null
    ...
    : n.flatMap((e, n) => {
        ...
        if (r != null)
          return [
            { kind: `multiline`, label: `call[${t}].result.content[${n}]`, value: po(r, Ga) },
          ];
        let i = ao(e);
        return i == null
          ? []
...
function ao(e) {
  ...
  let r = t.data.mimeType ?? t.data.mime_type ?? co(n);
  return r.startsWith(`image/`) ? { data: n, mimeType: r } : null;
}
function oo(e) {
  return qa.safeParse(e).success;
}
function so(e) {
...
function lo(e, t) {
  let n = uo(e);
  if (n == null) return [{ label: `call[${t}].arguments`, value: eo(e) }];
  let r = [];
  return (
    ...
    r.push({ kind: `javascript`, label: `call[${t}].script`, value: fo(n.code) }),
    Object.keys(n.extraArguments).length > 0 &&
      r.push({ label: `call[${t}].arguments`, value: eo(n.extraArguments) }),
    r
  );
}
function uo(e) {
  let t = Ya.safeParse(e);
  if (!t.success) return null;
  ...
  bo = o(u, ({ get: e }) =>
    Xa(
      e(O, _)
        ...
        .reverse()
        .flatMap((t) =>
          (e(p, t) ?? mo).map((e) => ({ conversationId: t, items: e.items, turnId: e.turnId })),
        ),
    ),
  );
function xo(e) {
  ...
  if (n != null) {
    ...
    return (
      t[0] === n
        ? (e = t[1])
        : ((e = (0, J.jsx)(Co, { conversationId: n })), (t[0] = n), (t[1] = e)),
      e
    );
  }
  let r;
...
function So() {
  ...
  return (
    e[0] === t.lines
      ? (n = e[1])
      : ((n = (0, J.jsx)(wo, { lines: t.lines })), (e[0] = t.lines), (e[1] = n)),
    n
  );
}
function Co(e) {
  ...
  return (
    t[5] === o.lines
      ? (s = t[6])
      : ((s = (0, J.jsx)(wo, { lines: o.lines })), (t[5] = o.lines), (t[6] = s)),
    s
  );
}
function wo(e) {
...
function To({ lines: e }) {
  let t = (0, q.useMemo)(
      () => e.map((e, t) => ({ estimatedHeightPx: ho, line: e, turnKey: `${t}:${e.label}` })),
      [e],
    ),
    [n, r] = (0, q.useState)({}),
    [i, a] = (0, q.useState)(null),
    [o, s] = (0, q.useState)(() => ko(t.length)),
    c = (0, q.useRef)(null),
    l = (0, q.useRef)(n),
    u = At({ entries: t, gapPx: 0, measuredHeightsByKey: n });
  l.current = n;
  let d = pe(() => {
      ...
      let n = i.getBoundingClientRect(),
        ...
        o = e.scrollTop - a,
        c = Ao({ layout: u, viewportBottomPx: o + e.clientHeight, viewportTopPx: o });
      s((e) => (jo(e, c) ? e : c));
    }),
    f = pe((e) => {
      if (e.size === 0) return;
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(`div`, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children: h.map((e) => (0, J.jsx)(Eo, { entry: e, measureLineRef: m }, e.turnKey)),
      }),
    }),
  });
}
var Eo = (0, q.memo)(function (e) {
  let t = (0, K.c)(6),
    { entry: n, measureLineRef: r } = e,
    i;
  t[0] === n.line
    ? (i = t[1])
    : ((i = (0, J.jsx)(Do, { line: n.line })), (t[0] = n.line), (t[1] = i));
  let a;
  return (
...
function Do(e) {
  ...
  switch (n.kind) {
    ...
    case `image`: {
      let e;
      return (
        t[9] === n ? (e = t[10]) : ((e = (0, J.jsx)(Io, { line: n })), (t[9] = n), (t[10] = e)), e
      );
    }
    case void 0: {
      let e;
...
function ko(e) {
  return { startIndex: 0, endIndex: Math.min(e, _o) };
}
function Ao({ layout: e, viewportBottomPx: t, viewportTopPx: n }) {
  let r = e.turnKeys.length;
  if (r === 0) return { startIndex: 0, endIndex: 0 };
  if (t <= 0) return { startIndex: 0, endIndex: Math.min(r, go) };
  if (n >= e.totalHeightPx) return { startIndex: Math.max(0, r - go), endIndex: r };
  let i = Math.max(0, n),
...
function Mo(e) {
  return e.closest(`[data-debug-panel-scroll-container]`) ?? No(e);
}
function No(e) {
...
function Fo(e) {
  ...
  return (
    t[5] !== n || t[6] !== c
      ? ((l = (0, J.jsx)(Oo, { label: n, children: c })), (t[5] = n), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
function Io(e) {
  ...
  return (
    t[15] !== n.label || t[16] !== m
      ? ((h = (0, J.jsx)(Oo, { label: n.label, children: m })),
        (t[15] = n.label),
        (t[16] = m),
        (t[17] = h))
      : (h = t[17]),
...
function Ho() {
  let e = (0, K.c)(41),
    ...
    [P, F] = (0, q.useState)(!1),
    L;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((L = { hostId: _ }), (e[0] = L)) : (L = e[0]);
  let ee = P && !0,
    R;
  e[1] === ee
    ? (R = e[2])
    : ((R = { params: L, queryConfig: { enabled: ee } }), (e[1] = ee), (e[2] = R));
  let te = I(`workspace-root-options`, R).data?.roots.length ?? 0,
    B;
  ...
  e[7] === h.roles
    ? (W = e[8])
    : ((W = h.roles.length === 0 ? `none` : h.roles.join(`, `)), (e[7] = h.roles), (e[8] = W));
  let se = W,
    ce;
  e[9] !== oe ||
  e[10] !== n ||
    ...
    ? ((ce = P
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, J.jsx)(`div`, {
                className: `text-xs text-token-description-foreground`,
                children: `Codex runtime: ${N == null ? `idle` : Uo(N)}`,
              }),
              (0, J.jsx)(`div`, {
                ...
                children: V.map((e) =>
                  (0, J.jsx)(
                    `button`,
                    {
                      ...
                      onClick: () => {
                        (e.value === `workspace` && S(!1), o(e.value));
                      },
                      children: e.label,
                    },
                    e.value,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    ...
                    children: `Onboarding welcome pending: ${s ? `pending` : `off`} · Projectless completed: ${p ? `yes` : `no`} · Plugin checklist active: ${g ? `yes` : `no`} · Roles: ${se}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-xs text-token-description-foreground`,
                    children: `Onboarding plugin checklist: ${g ? `active` : `inactive`}`,
                  }),
                  (0, J.jsxs)(`div`, {
                      ...
                      (0, J.jsx)(
                        `button`,
                        {
                          ...
                          onClick: () => {
                            ...
                            w({ arm: e.value, assignedAtMs: Date.now(), experimentName: dt });
                          },
                          children: e.label,
                        },
                        e.value,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Work plugins announcement: ${k ? `seen` : `unseen`}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-xs text-token-description-foreground`,
                    children: `Codex Mobile setup page: ${T}`,
                  }),
                  (0, J.jsx)(`div`, {
                    className: `flex flex-wrap gap-2`,
                    children: ie.map((e) =>
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Browser comment mode coachmark: ${D ? `seen` : `unseen`}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    className: `rounded border border-token-border px-3 py-1 text-token-description-foreground hover:bg-token-foreground/5`,
...
function Uo({ downloadedBytes: e, errorMessage: t, phase: n, totalBytes: r }) {
  return [n, e == null ? null : r == null ? `${Wo(e)} downloaded` : `${Wo(e)} / ${Wo(r)}`, t]
    .filter(Boolean)
    .join(` · `);
}
function Wo(e) {
...
function Ko(e) {
  F.error(`Failed to reload bundled plugins from debug page`, {
    safe: {},
    sensitive: { error: e },
  });
}
  ...
  return (
    e[0] === t
      ...
      : ((n = (0, J.jsx)(Y, {
          ...
          variant: `global`,
          children: (0, J.jsx)(Jo, { productEvents: t }),
        })),
        (e[0] = t),
        (e[1] = n)),
    n
    ...
    `div`,
    {
      ...
      children: [
        (0, J.jsxs)(`div`, {
          ...
          children: [
            (0, J.jsx)(`span`, {
              className: G(`w-fit rounded-full px-2 py-0.5 text-xs font-medium`, Zo(e.status)),
              children: Xo(e.status),
            }),
            (0, J.jsx)(`span`, {
              className: `text-token-description-foreground tabular-nums`,
              children: Qo(e.updatedTimestampMs),
            }),
            (0, J.jsxs)(`span`, {
              className: `min-w-0`,
              children: [
...
function $o(e, t) {
  let n = [...e].reverse(),
    r = t.trim();
  return r.length === 0 ? n : n.filter((e) => es(e, r));
}
function es(e, t) {
  let n = ns(e);
  return lt(ts(e), t) > 0 || lt(e.event.eventType, t) > 0 || lt(n, t) > 0;
}
function ts(e) {
...
function ns(e) {
  return e.event.payload == null ? `` : rs(e.event.payload);
}
function rs(e) {
...
function is() {
  let e = (0, K.c)(31),
    ...
    o = rt(),
    s = o.override,
    { data: l, isLoading: f } = ve(oe.REALTIME_VOICE_MODE_DEBUG_DISABLED),
    p = l === !0,
  ...
  e[11] === t
    ...
    : ((S = (e) => {
        (r(null),
          d(t, oe.REALTIME_VOICE_MODE_DEBUG_DISABLED, e).catch((e) => {
        ...
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, J.jsx)(`textarea`, {
                ...
                value: s.config,
                onChange: (e) => {
                  t.set(at, { ...s, config: e.currentTarget.value });
                },
              }),
              o.error
                ? (0, J.jsx)(`div`, {
...
var as = { assignedExperimentCount: 0, enabledGateCount: 0, gateCount: 0 },
  os = { disableExposureLog: !0 };
le(W());
var ss = V({ dynamic_configs: ne(W(), U()), feature_gates: ne(W(), U()) }),
  cs = ce([V({ is_user_in_experiment: B() }), V({ ue: se(!0) })]),
  ls,
  us = new Map();
function ds(e, t = ``) {
  if (!t.trim()) return [];
  let n = bs(e),
    r = new Map(
      [...gs(t), ...(n == null ? [] : vs(n))].map((e) => [`${e.kind}:${e.name}`, e]),
    ).values();
  return ps(
    Array.from(r, (t) => hs(e, t)),
    t,
  );
}
function fs(e) {
  ...
  return t == null
    ? as
    : {
        assignedExperimentCount: Object.values(t.dynamic_configs).filter(Ss).length,
        enabledGateCount: Object.keys(t.feature_gates).filter((t) => e.getFeatureGate(t, os).value)
          .length,
...
function hs(e, t) {
  switch (t.kind) {
    case `gate`: {
      let n = e.getFeatureGate(t.name, os);
      return {
        kind: `gate`,
        name: t.name,
        enabled: n.value,
    ...
    case `experiment`: {
      let n = e.getExperiment(t.name, os);
      return {
        kind: `experiment`,
        name: t.name,
...
function _s() {
  return ls === null ? us : ((ls = null), (us = new Map()), us);
}
function vs(e) {
  return [
...
function bs(e) {
  ...
  let i = ss.safeParse(Reflect.apply(r, n, []));
  return i.success ? i.data : null;
}
function xs(e) {
  return cs.safeParse(e).success;
}
function Ss(e) {
  let t = cs.safeParse(e);
  return t.success
...
function Cs() {
  ...
  if (e[0] !== n || e[1] !== i || e[2] !== t) {
    let a = ds(t, n),
      { assignedExperimentCount: g, enabledGateCount: _, gateCount: v } = fs(t),
      y = n.trim().length > 0,
      b;
    (e[13] === i
      ? (b = e[14])
    ...
    (e[22] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      (c =
        y && a.length === 0
          ...
          : y
            ? a.map((e) =>
                (0, J.jsx)(ws, { entry: e, onSelectGate: void 0, query: n }, `${e.kind}:${e.name}`),
              )
            : null),
      (e[0] = n),
      (e[1] = i),
...
function ws(e) {
  let t = (0, K.c)(13),
    ...
    s;
  t[0] !== n.name || t[1] !== i
    ? ((s = ms(n.name, i)), (t[0] = n.name), (t[1] = i), (t[2] = s))
    : (s = t[2]);
  let c;
  t[3] === n.kind ? (c = t[4]) : ((c = void 0), (t[3] = n.kind), (t[4] = c));
  let l;
  t[5] !== a || t[6] !== o
    ? ((l = (0, J.jsx)(Ts, { label: a, tone: o })), (t[5] = a), (t[6] = o), (t[7] = l))
    : (l = t[7]);
  let u;
  return (
    t[8] !== r || t[9] !== s || t[10] !== c || t[11] !== l
      ? ((u = (0, J.jsx)(ta, { title: s, subtitle: c, status: l, onClick: r })),
        (t[8] = r),
        (t[9] = s),
        (t[10] = c),
        (t[11] = l),
...
function Es() {
  let e = (0, K.c)(18),
    ...
    [r, i] = (0, q.useState)(!1),
    a;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: _ }), (e[0] = a)) : (a = e[0]);
  let o;
  e[1] === t
    ? (o = e[2])
    : ((o = { params: a, queryConfig: { enabled: t } }), (e[1] = t), (e[2] = o));
  let { data: s } = I(`workspace-root-options`, o),
    c;
  ...
  e[10] !== r || e[11] !== t || e[12] !== d || e[13] !== l
    ? ((p = t
        ? l.length === 0
          ...
          : l.map((e) => (0, J.jsx)(Os, { includeHidden: r, label: d[e] ?? e, root: e }, e))
        : null),
      (e[10] = r),
      (e[11] = t),
      (e[12] = d),
...
function Os(e) {
  ...
  t[4] !== c || t[5] !== l
    ...
    : (u = t[6]);
  let d;
  t[7] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = () => o(ks)), (t[7] = d)) : (d = t[7]);
  let f;
  t[8] !== n || t[9] !== u
    ? ((f = (0, J.jsx)(ta, { title: u, subtitle: n, onClick: d })),
      (t[8] = n),
      (t[9] = u),
      (t[10] = f))
    : (f = t[10]);
  ...
  t[11] !== i || t[12] !== a || t[13] !== n
    ? ((p = a
        ? (0, J.jsx)(`div`, {
            className: `pb-1`,
            children: (0, J.jsx)(pt, { hostId: _, includeHidden: i, root: n }),
          })
        : null),
      (t[11] = i),
      (t[12] = a),
...
var As = `debug-workspace-runtime`,
  js = 1e3,
  Ms = new Intl.RelativeTimeFormat(void 0, { numeric: `auto` });
function Ns() {
  let e = (0, K.c)(1),
    t = me.primaryRuntime;
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, J.jsx)(Ps, { primaryRuntime: t })), (e[0] = n))
      : (n = e[0]),
    n
  );
}
function Ps(e) {
  ...
  t[2] !== o || t[3] !== m
    ? ((h = {
      ...
      (t[4] = h))
    : (h = t[4]);
  let { data: g, isLoading: _, refetch: v } = A(h),
    y;
  t[5] !== n || t[6] !== a
    ? ((y = async (e) => {
        let { release: t } = e;
        return (await _t(a), n.runUpdateNow({ release: t }));
      }),
      (t[5] = n),
      (t[6] = a),
      (t[7] = y))
  ...
  t[8] === i
    ? (b = t[9])
    : ((b = (e) => {
        (f(Ls(e)), i.invalidateQueries({ queryKey: vt }));
      }),
      (t[8] = i),
      (t[9] = b));
  let x;
  ...
  t[13] === r
    ...
    : ((T = (e) => {
        ...
        (r.set(bt, t), M.dispatchMessage(`set-primary-runtime-install-release`, { release: t }));
      }),
      (t[13] = r),
      (t[14] = T));
  let E = T,
        ...
        ? (0, J.jsx)($e, {
            ...
            triggerButton: (0, J.jsxs)(`button`, {
              ...
              children: [
                ...
                `Cron`,
                (0, J.jsx)(Te, { className: `icon-2xs opacity-70` }),
              ],
            }),
            children: (0, J.jsxs)(`div`, {
              className: `flex min-w-[220px] flex-col gap-0.5`,
              children: [
                (0, J.jsx)(Qe.Title, { children: `Workspace runtime cron` }),
                (0, J.jsx)(Qe.Item, {
                  disabled: C || g?.enabled === !1,
                  onSelect: () => {
                    S.mutateAsync({ release: p }).catch((e) => {
                      (f(`Failed to trigger cron job`),
                        F.error(`Failed to trigger workspace runtime cron from debug page`, {
                          safe: { release: p },
                          sensitive: { error: e },
                        }));
                    });
                ...
                (0, J.jsx)(Qe.Separator, {}),
                (0, J.jsx)(Qe.Title, { children: `Install flow` }),
                (0, J.jsxs)(`div`, {
          ...
          : (0, J.jsxs)(`div`, {
              ...
              children: [
                ...
                g?.disabledReason == null
                  ? null
                  : (0, J.jsx)(X, { label: `Disabled`, value: zs(g.disabledReason) }),
                (0, J.jsx)(X, { label: `Next cron`, value: Is(g?.nextRunAt ?? null) }),
                (0, J.jsx)(X, {
                  label: `Startup check`,
...
function Is(e) {
  ...
  if (n < 60) return `${t.toLocaleString()} (${Ms.format(n, `second`)})`;
  let r = Math.ceil(n / 60);
  return r < 60
    ? `${t.toLocaleString()} (${Ms.format(r, `minute`)})`
    : `${t.toLocaleString()} (${Ms.format(Math.ceil(r / 60), `hour`)})`;
}
function Ls(e) {
  switch (e.status) {
    ...
    case `skipped`:
      return e.reason == null ? `Skipped` : `Skipped: ${Rs(e.reason)}`;
  }
}
function Rs(e) {
  switch (e) {
...
function Vs() {
  let e = (0, K.c)(23),
    t = c(u),
    [n, r] = (0, q.useState)(null),
    i = ue(H.autoCleanupEnabled),
    { data: a, isLoading: o } = ve(oe.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED),
    s = a === !0,
    l = i && s,
    f = o,
  ...
  e[11] === t
    ...
    : ((x = (e) => {
        (r(null),
          d(t, oe.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED, e).catch((e) => {
...
var Hs = 1e3,
  Us = `debug-ambient-suggestion-threads`,
  Ws = new Intl.RelativeTimeFormat(void 0, { numeric: `auto` }),
  Gs = j(u, `is-packaged`, { staleTime: R.FIVE_SECONDS });
function Ks(e) {
  let t = (0, K.c)(17),
    { onClose: n } = e,
    [r, i] = (0, q.useState)(Js),
  ...
  t[10] !== n || t[11] !== u || t[12] !== d
    ? ((f = (0, J.jsx)(Ys, { onClose: n, onMove: u, onResize: d })),
      (t[10] = n),
      (t[11] = u),
      (t[12] = d),
      (t[13] = f))
...
function Ys({
  ...
  let s = ye(),
    ...
    v = h != null && a && ie.allowDebugMenu(ze()),
    y = m?.isPackaged === !1,
    b = e ?? null,
    x =
      typeof window < `u`
    ...
    C = async (e) => {
      if (!f) {
        ...
        try {
          ...
          F.error(`Failed to export logs`, { safe: { scope: e }, sensitive: { error: t } });
        } finally {
          p(!1);
        }
      }
    ...
    w = () => {
      (async () => {
        try {
          ...
          F.error(`Failed to open debug window`, { safe: {}, sensitive: { error: e } });
        }
      })();
    };
  return (0, J.jsxs)(`div`, {
    ...
    children: [
                ...
                children: [
                  v
                    ? (0, J.jsx)(`button`, {
                        ...
                        onClick: w,
                        children: (0, J.jsx)(be, { className: `icon-xs` }),
                      })
                    : null,
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    ...
                    onClick: t,
                    children: (0, J.jsx)(Re, { className: `icon-xs` }),
                  }),
                ],
              }),
            ],
      ...
      (0, J.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, J.jsx)(He, {
            electron: !0,
            children: (0, J.jsx)(xo, { conversationId: b ?? void 0 }),
          }),
          b == null ? null : (0, J.jsx)(Gi, { conversationId: b }),
          c.map((e) => {
            ...
            return (0, J.jsx)(
              Y,
              {
                ...
                storageKey: t,
                variant: `selection`,
                children: (0, J.jsx)(Hi, { lines: e.lines }),
              },
              e.id,
            );
          }),
          ...
          null,
          (0, J.jsx)(Bt, {}),
          (0, J.jsxs)(He, { electron: !0, children: [(0, J.jsx)(An, {}), null] }),
          (0, J.jsx)(fa, {}),
          (0, J.jsx)(Go, {}),
          (0, J.jsx)(Cs, {}),
          (0, J.jsx)(Qs, {}),
          ...
          (0, J.jsx)(is, {}),
          y ? (0, J.jsx)(na, {}) : null,
          (0, J.jsx)(Pt, { sourceThreadId: b ?? void 0 }),
          y ? (0, J.jsx)(Vs, {}) : null,
          (0, J.jsx)(ra, {}),
          (0, J.jsx)(Y, {
          ...
          g
            ? (0, J.jsxs)(Y, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `flex flex-col py-1.5`,
                    children: (0, J.jsx)(X, { label: `App session ID`, value: x ?? `Unavailable` }),
                  }),
                  (0, J.jsxs)(`div`, {
...
function Qs() {
  let e = (0, K.c)(25),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((t = ze()), (e[0] = t)) : (t = e[0]);
  let n = t,
    r = P(),
    [i, a] = (0, q.useState)(ec),
    o = i && (n === `dev` || n === `nightly`),
  ...
  e[1] === o
    ? (s = e[2])
    : ((s = { queryConfig: { enabled: o, intervalMs: Hs } }), (e[1] = o), (e[2] = s));
  let { data: c, isLoading: l } = I(`ambient-suggestions-generation-statuses`, s),
    u;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((u = { hostId: _ }), (e[3] = u)) : (u = e[3]);
  let d;
  e[4] === i
    ? (d = e[5])
    : ((d = { params: u, queryConfig: { enabled: i } }), (e[4] = i), (e[5] = d));
  let { data: f } = I(`workspace-root-options`, d),
    p;
  e[6] === i ? (p = e[7]) : ((p = { queryConfig: { enabled: i } }), (e[6] = i), (e[7] = p));
  let { data: m } = I(`projectless-thread-cwd`, p),
    h;
  e[8] === r
    ? (h = e[9])
    : ((h = {
        onSuccess: () => {
          (r.invalidateQueries({ queryKey: L(`ambient-suggestions-generation-statuses`) }),
            r.invalidateQueries({ queryKey: L(`ambient-suggestions`) }));
        },
      }),
      (e[8] = r),
      (e[9] = h));
  let g = ee(`ambient-suggestions-refresh`, h),
    v = c?.statuses,
    y,
    b,
    x;
              ...
              (0, J.jsx)(
                ta,
                {
                  ...
                  rightActions: (0, J.jsx)(`button`, {
                    ...
                    onClick: () => {
                      g.mutateAsync({ hostId: _, projectRoot: ae(n) }).catch((e) => {
                        F.error(`Failed to refresh ambient suggestions from debug page`, {
                          safe: {},
...
function tc(e, t) {
  ...
  if (r > 0) {
    ...
    return t == null
      ...
      : `${r} safety check active • started ${nc(t)}${n}`;
  }
  if (i > 0) {
    let t = e?.runningStartedAtMs ?? null;
    return t == null ? `${i} active${n}` : `${i} active • started ${nc(t)}${n}`;
  }
  return e?.lastFinishedAtMs == null
    ? `No completed run yet${n}`
    : `Finished ${nc(e.lastFinishedAtMs)}${n}`;
}
function nc(e) {
  let t = Math.max(0, Math.floor((Date.now() - e) / 1e3));
  if (t < 60) return Ws.format(-t, `second`);
  let n = Math.floor(t / 60);
  if (n < 60) return Ws.format(-n, `minute`);
  let r = Math.floor(n / 60);
  return Ws.format(-r, `hour`);
}
function rc(e) {
  try {
    return window.localStorage.getItem(e) === `open`;
