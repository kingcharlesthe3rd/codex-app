...
import { d as on, f as sn, u as cn } from "./app-initial~app-main~automations-page.js";
import {
  _ as ln,
  g as un,
  l as dn,
...
import {
  ...
  i as Hn,
  r as Un,
} from "./app-initial~app-main~debug-window-page~debug-modal~home-ambient-suggestions-content-D8-xUpni.js";
import {
  c as Wn,
  l as Gn,
  n as Kn,
...
import {
  c as Jn,
  l as Yn,
} from "./app-initial~app-main~remote-conversation-page~onboarding-page~hotkey-window-thread-page~deb~8g4hfqoz.js";
import {
  a as Xn,
  n as Zn,
  o as Qn,
  ...
  t as tr,
  u as nr,
} from "./app-initial~app-main~codex-mobile-page~debug-window-page~remote-connections-settings~debug-modal-sQGl-xcL.js";
import {
  a as rr,
  r as ir,
  s as ar,
  ...
  let [t, n] = (0, kr.useState)(jr),
    ...
    s = async () => {
      if (!a) {
        ...
        try {
          let n = JSON.parse(t),
            r = await Yn(n, { sourceThreadId: e });
          i(
            `Success\n\nResult:\n${JSON.stringify(r, null, 2)}\n\nSent payload:\n${JSON.stringify(n, null, 2)}`,
          );
        } catch (e) {
          (i(`Error: ${e instanceof Error ? e.message : String(e)}\n\nInput JSON:\n${t}`),
            d.error(`Failed to run debug app action`, {
              safe: {},
...
function Rr(e) {
  let t = (0, Si.c)(15),
    ...
    i = F(Bt),
    [a] = Et(`host_config`),
    [o] = Et(`remote_ssh_connections`),
    [s] = Et(`remote_control_connections`),
    c;
...
function zr(e) {
  let t = (0, Si.c)(69),
    ...
    d = !!n.lines?.length,
    f;
  t[0] === a ? (f = t[1]) : ((f = a.filter(vi)), (t[0] = a), (t[1] = f));
  let p = f.length,
    m = b(Di, r) ?? n.stateType === `local`,
    h = n.stateType === `local` ? `local` : c,
    g;
  ...
  t[33] === y
    ...
    : ((te =
        y > 0
          ? (0, H.jsxs)(`span`, {
              className: `rounded-full bg-token-charts-red/15 px-2 py-0.5 text-token-charts-red`,
              children: [y, ` notification errors`],
            })
          : null),
      (t[33] = y),
      (t[34] = te));
  ...
  let ie;
  t[47] !== d || t[48] !== n
    ? ((ie = d ? (0, H.jsx)(Ur, { hostDetails: n }) : null), (t[47] = d), (t[48] = n), (t[49] = ie))
    : (ie = t[49]);
  let I;
  t[50] !== r || t[51] !== u
    ? ((I = (0, H.jsx)(qr, { hostId: r, threadStatusEntries: u })),
      (t[50] = r),
      (t[51] = u),
      (t[52] = I))
    : (I = t[52]);
                                      ...
                                      (0, H.jsx)(
                                        Jr,
                                        {
                                          ...
                                          onUnsubscribe: async (t) => {
                                            r(t);
                                            try {
                                              await St(`unsubscribe-thread-for-host`, {
                                                hostId: e,
                                                threadId: t,
                                              });
                                            } finally {
...
function Jr(e) {
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, H.jsx)(Dn, { className: `icon-xs` })), (t[9] = f))
    : (f = t[9]);
  let p;
  t[10] === d
    ? (p = t[11])
...
function Xr(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== c || t[4] !== a) {
    ...
    let o;
    t[15] !== d || t[16] !== r
      ? ((o = d == null ? r : r.filter((e) => e.threadId === d)),
        (t[15] = d),
        (t[16] = r),
        (t[17] = o))
      : (o = t[17]);
    let s = o,
      b;
    (t[18] === s ? (b = t[19]) : ((b = s.filter(ei)), (t[18] = s), (t[19] = b)), (f = b));
    let x;
    (t[20] !== s || t[21] !== a
        ...
        f.length > 0
          ? (0, H.jsxs)(`label`, {
              ...
              children: [
                ...
                (0, H.jsxs)(`span`, { className: `tabular-nums`, children: [`(`, f.length, `)`] }),
              ],
            })
          : null),
      (t[26] = f.length),
  ...
  t[33] !== d || t[34] !== f.length || t[35] !== p
    ? ((S =
        p.length > 0
          ...
          : (0, H.jsx)(ri, {
              message: f.length > 0 ? `Only hidden delta notifications recorded` : mi(d),
            })),
      (t[33] = d),
      (t[34] = f.length),
      (t[35] = p),
...
function ki() {
  ...
  e[1] === o
    ...
    : ((c = {
        ...
        queryKey: na,
        refetchInterval: ia,
        staleTime: O.FIVE_SECONDS,
      }),
      (e[1] = o),
      (e[2] = c));
  let { data: l, isFetching: u, isLoading: f, refetch: p } = v(c),
    m;
  e[3] === p
    ? (m = e[4])
    : ((m = async (e) => {
        if (t != null)
          try {
            ...
            (a(`Failed to open Browser owner`),
              d.error(`Failed to open Browser debug owner`, {
                safe: {
                  browserTabId: e.browserTabId,
                  conversationId: e.conversationId,
                  windowId: e.windowId,
      ...
      (e[4] = m));
  let h = m,
    g = n && l != null ? `Browser tabs (${l.tabs.length})` : `Browser tabs`,
    _;
        ...
        ? (0, U.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, U.jsxs)(`button`, {
                ...
                children: [u ? (0, U.jsx)(je, { className: `icon-2xs` }) : null, `Refresh`],
              }),
            ],
          })
        : null),
        ...
        ? t == null
          ...
          : f && l == null
            ...
            : l == null
              ...
              : (0, U.jsx)(Ni, { onOpenOwner: h, openOwnerStatus: i, snapshot: l })
        : null),
      (e[10] = l),
      (e[11] = h),
      (e[12] = f),
...
function Vi(e) {
  ...
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, U.jsxs)(`span`, {
        ...
        children: [`Open owner`, (0, U.jsx)(Dn, { className: `icon-2xs` })],
      })),
      (t[23] = g))
    : (g = t[23]);
  let _;
  ...
  let ne = `snapshot=${r.hasPersistedPageState}`,
    ...
    F = `host=${r.webviewHostRegistered}`,
    ie;
  t[57] !== ne || t[58] !== re || t[59] !== F
    ? ((ie = [ne, re, F]), (t[57] = ne), (t[58] = re), (t[59] = F), (t[60] = ie))
    : (ie = t[60]);
  let I = ie.join(` `),
    ae;
  t[61] === I
    ? (ae = t[62])
    : ((ae = (0, U.jsx)(V, { label: `Persistence`, value: I })), (t[61] = I), (t[62] = ae));
  let L;
  ...
  t[65] === L
    ? (R = t[66])
    : ((R = (0, U.jsx)(V, { label: `Snapshot age`, value: L })), (t[65] = L), (t[66] = R));
  let oe;
  t[67] === r.restorePhase
    ? (oe = t[68])
    : ((oe = (0, U.jsx)(V, { label: `Restore phase`, value: r.restorePhase })),
      (t[67] = r.restorePhase),
      (t[68] = oe));
  let se;
  t[69] === r.restoreInvariant
    ...
    : ((se =
      ...
      (t[70] = se));
  let ce;
  t[71] === r.bounds ? (ce = t[72]) : ((ce = Zi(r.bounds)), (t[71] = r.bounds), (t[72] = ce));
  let le;
  t[73] === ce
    ? (le = t[74])
    : ((le = (0, U.jsx)(V, { label: `Bounds`, value: ce })), (t[73] = ce), (t[74] = le));
  let ue = `active=${r.active}`,
    de = `presented=${r.presented}`,
    fe = `visible=${r.visible}`,
    pe = `hasPage=${r.hasPage}`,
    me = `loading=${r.isLoading}`,
    he = `restoring=${r.isRestoring}`,
    ge = `suspended=${r.isSuspended}`,
    _e;
  t[75] !== ue ||
  t[76] !== de ||
  t[77] !== fe ||
  ...
  t[83] === ve
    ? (ye = t[84])
    : ((ye = (0, U.jsx)(V, { label: `Flags`, value: ve })), (t[83] = ve), (t[84] = ye));
  let be = `page=${r.isBrowserUsePage}`,
    xe = `active=${r.isBrowserUseActive}`,
    Se = `agent=${r.isAgentControllingBrowser}`,
    Ce = `visibilityRequest=${r.hasPendingBrowserUseVisibilityRequest}`,
    we = `panelOpen=${r.pendingBrowserUsePanelOpen}`,
    Te;
  t[85] !== be || t[86] !== xe || t[87] !== Se || t[88] !== Ce || t[89] !== we
    ? ((Te = [be, xe, Se, Ce, we]),
      (t[85] = be),
      (t[86] = xe),
      (t[87] = Se),
  ...
  t[91] === Ee
    ? (De = t[92])
    : ((De = (0, U.jsx)(V, { label: `Browser Use`, value: Ee })), (t[91] = Ee), (t[92] = De));
  let Oe = `mount=${r.mountGeneration}`,
    ke = `last=${r.lastLifecycleSequence}`,
    Ae = `presented=${r.lastPresentedSequence}`,
    je = `pendingAttach=${r.pendingAttachCount}`,
    Me;
  t[93] !== Oe || t[94] !== ke || t[95] !== Ae || t[96] !== je
    ? ((Me = [Oe, ke, Ae, je]),
      (t[93] = Oe),
      (t[94] = ke),
      (t[95] = Ae),
  ...
  t[98] === Ne
    ? (Pe = t[99])
    : ((Pe = (0, U.jsx)(V, { label: `Lifecycle`, value: Ne })), (t[98] = Ne), (t[99] = Pe));
  let Fe =
  ...
  t[100] === Fe
    ? (Ie = t[101])
    : ((Ie = (0, U.jsx)(V, { label: `Pending teardown`, value: Fe })),
      (t[100] = Fe),
      (t[101] = Ie));
  let Le;
  t[102] !== b ||
  ...
  t[120] !== Ie
    ? ((Le = (0, U.jsxs)(`div`, {
        ...
        children: [b, x, S, w, E, O, A, M, P, te, ae, R, oe, se, le, ye, De, Pe, Ie],
      })),
      (t[102] = b),
      (t[103] = x),
      (t[104] = S),
...
var es,
  ...
  ns,
  rs = e(() => {
    ((es = t(te(), 1)), (ts = 1024 * 1024), (ns = 5 * 1024 * 1024));
  });
function is() {
  let e = (0, ds.c)(25),
  ...
  let { data: l, isLoading: u } = E(`child-processes`, c),
    d;
  e[2] === l?.processes
    ? (d = e[3])
  ...
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, K.jsx)(Te, {
        title: (0, K.jsx)(Ae, { children: `Process details` }),
        subtitle: (0, K.jsx)(ke, { children: `The process ID and full command are shown below` }),
      })),
      (e[14] = b))
    : (b = e[14]);
  let x;
  ...
  let S;
  e[17] !== x || e[18] !== v
    ? ((S = (0, K.jsx)(Se, { open: v, onOpenChange: y, size: `wide`, children: x })),
      (e[17] = x),
      (e[18] = v),
      (e[19] = S))
    : (S = e[19]);
...
function zs() {
  ...
  e[1] === o
    ? (c = e[2])
    : ((c = { enabled: o, queryFn: s, queryKey: nc, staleTime: O.FIVE_SECONDS }),
      (e[1] = o),
      (e[2] = c));
  let { data: l, isFetching: u, isLoading: f, refetch: p } = v(c),
    m;
    ...
    : ((m = async (e, n) => {
        if (t != null) {
          ...
          try {
            ...
            let n = t;
            (a(`${e} failed`),
              d.error(`Failed to run downloads debug action`, {
                safe: { label: e },
                sensitive: { error: n },
              }));
          }
  ...
  e[5] === l?.downloads
    ? (g = e[6])
    : ((g = l?.downloads ?? []), (e[5] = l?.downloads), (e[6] = g));
  let _ = n && l != null ? `Downloads (${g.length})` : `Downloads`,
    y;
  e[7] !== l || e[8] !== u || e[9] !== n || e[10] !== p || e[11] !== h
    ? ((y = n
        ? (0, q.jsxs)(`div`, {
            className: `flex items-center gap-1`,
            children: [
              (0, q.jsxs)(`button`, {
                ...
                children: [(0, q.jsx)(yn, { className: `icon-2xs` }), `Open in Finder`],
              }),
              (0, q.jsx)(`button`, {
                type: `button`,
                className: `cursor-interaction rounded px-1.5 py-0.5 text-xs hover:bg-token-foreground/10 disabled:cursor-not-allowed disabled:opacity-50`,
              ...
              (0, q.jsxs)(`button`, {
                ...
                children: [u ? (0, q.jsx)(je, { className: `icon-2xs` }) : null, `Refresh`],
              }),
            ],
          })
        : null),
    ...
    : (y = e[12]);
  let b;
  e[13] !== i || e[14] !== l || e[15] !== f || e[16] !== n || e[17] !== h
    ? ((b = n
        ? t == null
...
function Ws(e) {
  ...
  if (Qs(n.status)) {
    ...
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((o = (0, q.jsx)(mn, { className: `icon-2xs` })), (t[3] = o))
      : (o = t[3]);
    let s;
    t[4] !== e || t[5] !== i
      ? ((s = (0, q.jsxs)(`button`, {
    ...
    t[10] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((u = (0, q.jsx)(We, { className: `icon-2xs` })), (t[10] = u))
      : (u = t[10]);
    let d;
    t[11] !== c || t[12] !== l
      ? ((d = (0, q.jsxs)(`button`, {
  ...
  if (n.status === `paused`) {
    ...
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((a = (0, q.jsx)(hn, { className: `icon-2xs` })), (t[20] = a))
      : (a = t[20]);
    let o;
    t[21] !== e || t[22] !== i
      ? ((o = (0, q.jsxs)(`button`, {
    ...
    t[27] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((u = (0, q.jsx)(We, { className: `icon-2xs` })), (t[27] = u))
      : (u = t[27]);
    let d;
    t[28] !== c || t[29] !== l
      ? ((d = (0, q.jsxs)(`button`, {
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, q.jsx)(le, { className: `icon-2xs` })), (t[43] = m))
    : (m = t[43]);
  let h;
  t[44] === p
    ? (h = t[45])
  ...
  let b;
  t[55] !== y || t[56] !== h
    ? ((b = (0, q.jsx)(Fe, { align: `end`, triggerButton: h, children: y })),
      (t[55] = y),
      (t[56] = h),
      (t[57] = b))
    : (b = t[57]);
...
function sc() {
  let e = (0, cc.c)(15),
    ...
    { data: i, isLoading: a } = it(g.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED),
    s = i === !0,
  ...
  e[3] === t
    ...
    : ((d = (e) => {
        (r(null),
          Vt(t, g.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED, e)
            .then(() => {
              C.dispatchMessage(`global-dictation-force-lock-changed`, { enabled: e });
            })
            .catch((e) => {
              r(
...
var cc,
  ...
  uc,
  dc = e(() => {
    ((cc = l()), I(), h(), (lc = t(j(), 1)), tt(), Xt(), xt(), se(), p(), Ir(), Dr(), (uc = R()));
  });
function fc() {
  let e = (0, mc.c)(35),
    t = S(),
  ...
  e[0] === t
    ? (a = e[1])
    : ((a = { mutationFn: pc, onSuccess: (e) => (t.setQueryData(cn, e.state), e) }),
      (e[0] = t),
      (e[1] = a));
  let o = ee(a);
  ...
  e[2] === i.configuredHotkey
    ? (s = e[3])
    : ((s = i.configuredHotkey == null ? `Off` : Bn(i.configuredHotkey)),
      (e[2] = i.configuredHotkey),
      (e[3] = s));
  let c = s,
  ...
  e[26] === n
    ...
    : ((w = n
      ...
      (e[27] = w));
  let T;
  e[28] !== x || e[29] !== C || e[30] !== w
    ? ((T = (0, gc.jsxs)(`div`, { className: `flex flex-col gap-2 py-1.5`, children: [x, C, w] })),
      (e[28] = x),
      (e[29] = C),
      (e[30] = w),
      (e[31] = T))
...
var mc,
  ...
  gc,
  _c = e(() => {
    ((mc = l()), w(), I(), (hc = t(j(), 1)), sn(), zn(), Pt(), Ir(), Dr(), (gc = R()));
  });
function vc() {
  let e = (0, Jc.c)(1),
    t;
...
function yc() {
  ...
  if (
    ...
    ((v = n.filter((e) => Ic(e).includes(o) && Lc(e).includes(y) && Pc(e, c))),
      (m = v.slice(0, f)));
    let b = jc(m);
    ...
    e[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((E = (0, J.jsx)(Je, { className: `icon-2xs opacity-70` })), (e[20] = E))
      : (E = e[20]);
    let D;
    e[21] === T
      ? (D = e[22])
    ...
    e[24] === D
      ? (k = e[25])
      : ((k = (0, J.jsx)(Fe, { align: `end`, triggerButton: D, children: O })),
        (e[24] = D),
        (e[25] = k));
    let A;
    (e[26] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      (e[10] = _),
      (e[11] = v));
  } else ((m = e[7]), (h = e[8]), (g = e[9]), (_ = e[10]), (v = e[11]));
  let y;
  e[31] !== m.length || e[32] !== v.length
    ? ((y =
        m.length < v.length
          ? (0, J.jsx)(`button`, {
              type: `button`,
  ...
  let b;
  return (
    e[34] !== h || e[35] !== g || e[36] !== _ || e[37] !== y
      ? ((b = (0, J.jsxs)(`div`, { className: h, children: [g, _, y] })),
        (e[34] = h),
        (e[35] = g),
        (e[36] = _),
        (e[37] = y),
...
var xl,
  ...
  kl = e(() => {
    (oe(),
      ...
      (Dl = i({ type: s(`text`), text: a() }).catchall(c())),
      (Ol = i({ code: a(), timeout_ms: c().optional(), title: c().optional() }).catchall(c())));
  });
function Al(e) {
  let t = (0, Jl.c)(3),
    { conversationId: n } = e;
...
function bu() {
  ...
  e[1] === R
    ? (oe = e[2])
    : ((oe = { params: L, queryConfig: { enabled: R } }), (e[1] = R), (e[2] = oe));
  let se = E(`workspace-root-options`, oe).data?.roots.length ?? 0,
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((de = [
        ...
        { value: Wt, label: `T5 Onboarding V2` },
      ]),
      (e[4] = de))
    : (de = e[4]);
  let fe = de,
  ...
  e[8] === m.roles
    ? (xe = e[9])
    : ((xe = m.roles.length === 0 ? `none` : m.roles.join(`, `)), (e[8] = m.roles), (e[9] = xe));
  let Se = xe,
    Ce;
  e[10] !== be ||
  e[11] !== n ||
    ...
    ? ((Ce = I
        ? (0, X.jsxs)(`div`, {
            ...
            children: [
                ...
                children: ue.map((e) =>
                  (0, X.jsx)(
                    `button`,
                    {
                      ...
                      onClick: () => {
                        if (e.value === `welcome`) {
                          (In(an), Nn(t), l(e.value), a(`/`, { replace: !0 }));
                          return;
                        }
                        (e.value === `workspace` && w(!1), l(e.value));
                      },
                      children: e.label,
                    },
                    e.value,
                ...
                children: [
                  (0, X.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, X.jsx)(`div`, {
                        children: `V2 suggestions enabled at onboarding completion: ${_ ? `yes` : `no`}`,
                      }),
                      (0, X.jsx)(`div`, {
                  ...
                  (0, X.jsx)(`button`, {
                    ...
                    onClick: () => {
                      (p(!1),
                        ...
                        w(!1),
                        (async () => {
                          (await Vt(t, `use-copilot-auth-if-available`, !1),
                            await St(`logout`, { hostId: an }),
                            l(`welcome`),
                            d(!0),
                            p(!1),
                            g(!1),
                            ...
                            onClick: () => {
                              (e.value == null &&
                                ...
                                t.queryClient.removeQueries({
                                  queryKey: ie(`email-domain-mail-provider`),
                                }),
                                t.set(ht, e.value));
                            },
                            children: e.label,
              ...
              (0, X.jsx)(Oe, { electron: !0, children: (0, X.jsx)(uu, {}) }),
              null,
              (0, X.jsxs)(`div`, {
                className: `flex flex-col gap-2`,
                children: [
                      ...
                      (0, X.jsx)(
                        `button`,
                        {
                          ...
                          onClick: () => {
                            ...
                            D({ arm: e.value, assignedAtMs: Date.now(), experimentName: Ft });
                          },
                          children: e.label,
                        },
                        e.value,
              ...
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, X.jsx)(`button`, {
                    ...
                    onClick: () => {
                      (N(!1), ee(!1), s.updateUserAsync(s.getContext().user));
                    },
...
function Eu() {
  ...
  e[5] !== n || e[6] !== s
    ? ((c = (0, Ou.jsxs)(`div`, {
        ...
        children: [
          a,
          (0, Ou.jsx)(Qe, { ariaLabel: `Hide pet resize button`, checked: n, onChange: s }),
        ],
      })),
      (e[5] = n),
      (e[6] = s),
...
function Au() {
  ...
  e[18] === a
    ? (_ = e[19])
    : ((_ = a ? (0, Pu.jsx)(je, { className: `icon-2xs` }) : null), (e[18] = a), (e[19] = _));
  let v;
...
function ju(e) {
  d.error(`Failed to reload bundled plugins from debug page`, {
    safe: {},
    sensitive: { error: e },
  });
}
var Mu,
  ...
  Pu,
  Fu = e(() => {
    ((Mu = l()), I(), (Nu = t(j(), 1)), Ne(), be(), Ze(), L(), Ir(), Dr(), (Pu = R()));
  });
function Iu() {
  let e = (0, Ju.c)(2),
    t = nr(),
...
function Wu(e, t) {
  let n = Ku(e);
  return fn(Gu(e), t) > 0 || fn(e.event.eventType, t) > 0 || fn(n, t) > 0;
}
function Gu(e) {
...
var ud,
  ...
  gd = e(() => {
    (oe(),
      ...
      u(a()),
      (fd = i({ dynamic_configs: f(a(), c()), feature_gates: f(a(), c()) })),
      (pd = ne([i({ is_user_in_experiment: r() }), i({ ue: s(!0) })])),
      (hd = new Map()));
  });
function _d() {
  let e = (0, bd.c)(49),
  ...
  if (e[0] !== n || e[1] !== i || e[2] !== o || e[3] !== t) {
    ...
    (e[24] === t.client
      ...
      : ((O = () => {
          (r(!0),
            Qn(t.client, `debug_button`).finally(() => {
              r(!1);
            }));
        }),
        (e[24] = t.client),
...
var bd,
  ...
  Sd,
  Cd = e(() => {
    ((bd = l()), Ie(), (xd = t(j(), 1)), Me(), Rs(), Kt(), Xn(), Ir(), Dr(), gd(), (Sd = R()));
  });
function wd() {
  let e = (0, Od.c)(18),
    [t, n] = (0, kd.useState)(!1),
  ...
  let { data: s } = E(`workspace-root-options`, o),
    c;
...
function Ed(e) {
  ...
  t[11] !== i || t[12] !== a || t[13] !== n
    ? ((p = a
        ? (0, Ad.jsx)(`div`, {
            className: `pb-1`,
            children: (0, Ad.jsx)(ue, { hostId: an, includeHidden: i, root: n }),
          })
        : null),
      (t[11] = i),
      (t[12] = a),
...
var Od,
  ...
  Ad,
  jd = e(() => {
    ((Od = l()), (kd = t(j(), 1)), ce(), Ye(), Mt(), ae(), Rs(), Dr(), (Ad = R()));
  });
function Md() {
  let e = (0, Bd.c)(1),
    t = rn.primaryRuntime;
...
function Nd(e) {
  let t = (0, Bd.c)(33),
    ...
    i = S(),
    a = Qt(),
    [s, c] = (0, Vd.useState)(Pd),
    [l, u] = (0, Vd.useState)(`Not run yet`),
    f = F(jn),
    p;
  ...
  t[2] !== s || t[3] !== p
    ? ((m = {
      ...
      (t[4] = m))
    : (m = t[4]);
  let { data: h, isLoading: g, refetch: _ } = v(m),
    y;
  t[5] !== n || t[6] !== a
    ? ((y = async (e) => {
        let { release: t } = e;
        return (await ar(a), n.runUpdateNow({ release: t }));
      }),
      (t[5] = n),
      (t[6] = a),
      (t[7] = y))
  ...
  t[8] === i
    ? (b = t[9])
    : ((b = (e) => {
        (u(Id(e)), i.invalidateQueries({ queryKey: or }));
      }),
      (t[8] = i),
      (t[9] = b));
  let x;
  ...
  t[13] === r
    ...
    : ((D = (e) => {
        ...
        (r.set(jn, t), C.dispatchMessage(`set-primary-runtime-install-release`, { release: t }));
      }),
      (t[13] = r),
      (t[14] = D));
  let k = D,
  ...
  t[22] !== E
    ? ((A = s
        ? (0, Q.jsx)(Fe, {
            ...
            triggerButton: (0, Q.jsxs)(`button`, {
              ...
              disabled: T,
              children: [
                T ? (0, Q.jsx)(je, { className: `icon-2xs` }) : null,
                `Cron`,
                (0, Q.jsx)(Je, { className: `icon-2xs opacity-70` }),
              ],
            }),
            children: (0, Q.jsxs)(`div`, {
              className: `flex min-w-[220px] flex-col gap-0.5`,
              children: [
                (0, Q.jsx)(nt.Title, { children: `Workspace runtime cron` }),
                (0, Q.jsx)(nt.Item, {
                  disabled: T || h?.enabled === !1,
                  onSelect: () => {
                    w.mutateAsync({ release: f }).catch((e) => {
                      (u(`Failed to trigger cron job`),
                        d.error(`Failed to trigger workspace runtime cron from debug page`, {
                          safe: { release: f },
                          sensitive: { error: e },
                        }));
                    });
                ...
                (0, Q.jsx)(nt.Separator, {}),
                (0, Q.jsx)(nt.Title, { children: `Install flow` }),
                (0, Q.jsxs)(`div`, {
    ...
    : (A = t[23]);
  let j;
  t[24] !== h || t[25] !== g || t[26] !== s || t[27] !== T || t[28] !== l
    ? ((j = s
        ? g && h == null
          ? (0, Q.jsx)(`div`, {
              className: `text-token-description-foreground`,
          ...
          : (0, Q.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, Q.jsx)(V, { label: `Running`, value: T ? `Yes` : `No` }),
                (0, Q.jsx)(V, { label: `Last trigger`, value: l }),
              ],
            })
        : null),
      (t[24] = h),
...
function Kd() {
  let e = (0, qd.c)(23),
    ...
    i = pt(T.autoCleanupEnabled),
    { data: a, isLoading: s } = it(g.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED),
    c = a === !0,
    l = i && c,
    u = s,
  ...
  e[4] === h
    ? (_ = e[5])
    : ((_ = (0, Yd.jsx)(V, { label: `Effective cleanup`, value: h })), (e[4] = h), (e[5] = _));
  let v;
  e[6] !== f || e[7] !== m || e[8] !== _
    ? ((v = (0, Yd.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [f, m, _] })),
      (e[6] = f),
      (e[7] = m),
      (e[8] = _),
      (e[9] = v))
  ...
  e[11] === t
    ...
    : ((b = (e) => {
        (r(null),
          Vt(t, g.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED, e).catch((e) => {
...
var qd,
  ...
  Yd,
  Xd = e(() => {
    ((qd = l()), I(), h(), (Jd = t(j(), 1)), tt(), Xt(), xt(), p(), gt(), Ir(), Dr(), (Yd = R()));
  });
function Zd(e) {
  let t = (0, uf.c)(17),
    { onClose: n } = e,
...
function ef({
  ...
  let s = Dt(),
    ...
    x = v != null && a && _.allowDebugMenu(et()),
    S = g?.isPackaged === !1,
    C = e ?? null,
    w =
      typeof window < `u`
        ...
        : void 0,
    T = l.client.getContext().user?.customIDs?.stableID,
    E = async () => {
    ...
    D = async (e) => {
      if (!m) {
        ...
        try {
          ...
          d.error(`Failed to export logs`, { safe: { scope: e }, sensitive: { error: t } });
        } finally {
          h(!1);
        }
      }
    ...
    O = () => {
      (async () => {
        try {
          ...
          d.error(`Failed to open debug window`, { safe: {}, sensitive: { error: e } });
        }
      })();
    };
  return (0, $.jsxs)(`div`, {
    ...
    children: [
      i
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              (0, $.jsx)(`div`, {
                className: z(`h-full`, n == null ? `draggable` : `cursor-move`),
                onPointerDown: (e) => {
                  n != null && nf(e, n);
                },
              }),
                ...
                children: [
                  x
                    ? (0, $.jsx)(`button`, {
                        ...
                        onClick: O,
                        children: (0, $.jsx)(Rn, { className: `icon-xs` }),
                      })
                    : null,
                  (0, $.jsx)(`button`, {
                    type: `button`,
      ...
      (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsxs)(Oe, {
            electron: !0,
            children: [(0, $.jsx)(ki, {}), c ? (0, $.jsx)(zs, {}) : null, null, (0, $.jsx)(Eu, {})],
          }),
          (0, $.jsx)(vc, {}),
          (0, $.jsx)(Au, {}),
          (0, $.jsx)(_d, {}),
                              ...
                              children: [
                                ...
                                m
                                  ? (0, $.jsx)(`div`, {
                                      ...
                                      children: (0, $.jsx)(je, { className: `icon-xxs` }),
                                    })
                                  : (0, $.jsx)(Fe, {
                                      align: `end`,
                                      triggerButton: (0, $.jsxs)(`button`, {
                                        ...
                                        children: [
                                          `Export`,
                                          (0, $.jsx)(Je, { className: `icon-2xs opacity-70` }),
                                        ],
                                      }),
                                      children: (0, $.jsxs)(`div`, {
                                        className: `flex min-w-[180px] flex-col gap-0.5`,
...
function rf() {
  let e = (0, uf.c)(25),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((t = et()), (e[0] = t)) : (t = e[0]);
  let n = t,
    r = S(),
  ...
  let { data: c, isLoading: l } = E(`ambient-suggestions-generation-statuses`, s),
    u;
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = { hostId: an }), (e[3] = u))
    : (u = e[3]);
  ...
  e[4] === i
    ? (f = e[5])
    : ((f = { params: u, queryConfig: { enabled: i } }), (e[4] = i), (e[5] = f));
  let { data: p } = E(`workspace-root-options`, f),
    m;
  e[6] === i ? (m = e[7]) : ((m = { queryConfig: { enabled: i } }), (e[6] = i), (e[7] = m));
  let { data: h } = E(`projectless-thread-cwd`, m),
    g;
  e[8] === r
    ? (g = e[9])
    : ((g = {
        onSuccess: () => {
          (r.invalidateQueries({ queryKey: ie(`ambient-suggestions-generation-statuses`) }),
            r.invalidateQueries({ queryKey: ie(`ambient-suggestions`) }));
        },
      }),
      (e[8] = r),
      (e[9] = g));
  let _ = D(`ambient-suggestions-refresh`, g),
    v = c?.statuses,
    y,
    b,
    x;
              ...
              (0, $.jsx)(
                Fs,
                {
                  ...
                  rightActions: (0, $.jsx)(`button`, {
                    ...
                    onClick: () => {
                      _.mutateAsync({ domain: null, hostId: an, projectRoot: k(n) }).catch((e) => {
                        d.error(`Failed to refresh ambient suggestions from debug page`, {
                          safe: {},
  ...
  let C = i ? `Ambient suggestion chats (${b.length})` : `Ambient suggestion chats`,
    w;
  return (
    e[22] !== y || e[23] !== C
      ? ((w = (0, $.jsx)(B, {
...
var uf,
  ...
  gf = e(() => {
    ((uf = l()),
      ...
      (hf = M(o, `is-packaged`, { staleTime: O.FIVE_SECONDS })));
  });
