...
import { _ as r, a as i, c as a, o, s, t as c, v as l, z as u } from "./app-scope.js";
import {
  Ia as d,
  St as f,
  Ts as p,
...
import { n as ge } from "./rpc-2.js";
import { c as _e, o as ve, s as ye } from "./statsig.js";
import { r as G, t as be } from "./dropdown.js";
import { r as xe } from "./modal-controller-state.js";
import { d as Se, i as Ce, l as we, n as Te, u as Ee } from "./dialog-layout-B.js";
import { t as De } from "./with-window.js";
import { t as Oe } from "./toggle.js";
import { t as ke } from "./use-global-state.js";
import { t as Ae } from "./use-auth.js";
import { y as je } from "./use-plugins.js";
import { t as Me } from "./link-external.js";
import { a as Ne, n as Pe, s as Fe, t as Ie } from "./mcp-capability-signals.js";
import { t as Le } from "./chevron.js";
import { m as Re } from "./chunk-9.js";
import { a as ze, i as Be } from "./announcement-atoms.js";
import {
  a as Ve,
  d as He,
  f as Ue,
...
import { t as Ye } from "./info-1.js";
import { n as Xe, s as Ze } from "./home-onboarding-assistant-tutorial-card.js";
...
import { t as tt } from "./code-snippet.js";
import { t as nt } from "./copy-button.js";
import { t as rt } from "./image-preview-dialog.js";
import { i as it, n as at, r as ot, t as st } from "./use-is-thread-realtime-enabled.js";
import { t as ct } from "./arrow-up-right-lg-Cev-8THl.js";
import { t as lt } from "./score-query-match.js";
import { a as ut, i as dt } from "./workspace-onboarding-experiment.js";
import { r as ft, t as pt } from "./browser-sidebar-comment-mode-coachmark-state.js";
import { t as mt } from "./workspace-directory-tree.js";
import { n as ht, o as gt, t as _t } from "./app-server-notification-debug-signals.js";
import { a as vt, t as yt } from "./primary-runtime-query-keys.js";
import { i as bt, r as xt } from "./primary-runtime-install-state.js";
import { t as St } from "./run-app-action-in-primary-window.js";
import { n as Ct, t as wt } from "./hotkey-window-state.js";
import { o as Tt, t as Et } from "./codex-mobile-setup-dialog.js";
import { a as Dt, o as Ot, s as kt } from "./use-debug-panel.js";
import { r as At, t as jt } from "./thread-virtualizer.js";
function Mt({ labels: e, projectlessThreadCwd: t, statuses: n, workspaceRoots: r }) {
  let i = new Map();
...
function Y(e) {
  ...
  t[19] === c
    ? (C = t[20])
    : ((C = c
        ? (0, J.jsx)(`span`, { className: `flex items-center gap-1`, onClick: Nt, children: c })
        : null),
      (t[19] = c),
      (t[20] = C));
  let w;
...
function Ft({ sourceThreadId: e }) {
  let [t, n] = (0, q.useState)(Pt),
...
function X(e) {
  ...
  t[6] === r
    ...
    : ((c = (0, J.jsx)(nt, {
        ...
        onCopy: () => {
          navigator?.clipboard?.writeText && navigator.clipboard.writeText(r).catch(It);
        },
      })),
      (t[6] = r),
      (t[7] = c));
...
function It() {}
var Lt = new Intl.DateTimeFormat(void 0, {
    fractionalSecondDigits: 3,
    hour: `2-digit`,
    minute: `2-digit`,
    second: `2-digit`,
  }),
  Rt = `debug-app-server-section`,
  zt = [`resumed`, `resuming`, `needs_resume`],
  Bt = r(c, (e) => null);
function Vt() {
  let e = (0, K.c)(2),
    t = s(T),
...
function Ht(e) {
  let t = (0, K.c)(15),
    ...
    i = s(D),
    [a] = b(`host_config`),
    [o] = b(`remote_ssh_connections`),
    [c] = b(`remote_control_connections`),
    l;
  if (t[0] !== a || t[1] !== n || t[2] !== r || t[3] !== c || t[4] !== o || t[5] !== i) {
    let e;
    (t[7] !== a || t[8] !== r || t[9] !== c || t[10] !== o || t[11] !== i
      ? ((e = (e) =>
          (0, J.jsx)(
            Ut,
            {
  ...
  return (
    t[13] === l
      ? (u = t[14])
      : ((u = (0, J.jsx)(`div`, { className: `flex flex-col gap-3 py-3`, children: l })),
        (t[13] = l),
        (t[14] = u)),
    u
  );
...
function Ut(e) {
  let t = (0, K.c)(69),
    { hostDetails: n, hostId: r, notifications: a, requests: s } = e,
    l = o(c),
    u = i(S, r),
    d = i(v, r),
    f = i(y, r),
    p = !!n.lines?.length,
    m;
  t[0] === s ? (m = t[1]) : ((m = s.filter(Cn)), (t[0] = s), (t[1] = m));
  let h = m.length,
    g = i(Bt, r) ?? n.stateType === `local`,
    _ = n.stateType === `local` ? `local` : u,
    b;
  t[2] === s ? (b = t[3]) : ((b = s.filter(Kt)), (t[2] = s), (t[3] = b));
  let x = b.length,
    C;
  t[4] === a ? (C = t[5]) : ((C = a.filter(Gt)), (t[4] = a), (t[5] = C));
  let w = C.length,
    T;
  t[6] === a ? (T = t[7]) : ((T = a.filter(Wt)), (t[6] = a), (t[7] = T));
  let E = T.length,
    D;
  t[8] !== r || t[9] !== l
    ? ((D = (e) => {
        l.set(Bt, r, e.currentTarget.open);
      }),
      (t[8] = r),
      (t[9] = l),
      (t[10] = D))
  ...
  t[11] === n.displayName
    ...
    : ((O = (0, J.jsx)(`span`, {
      ...
      (t[12] = O));
  let k;
  t[13] === _ ? (k = t[14]) : ((k = (0, J.jsx)(pn, { state: _ })), (t[13] = _), (t[14] = k));
  let A;
  t[15] !== O || t[16] !== k
    ? ((A = (0, J.jsxs)(`div`, { className: `flex items-center gap-2`, children: [O, k] })),
      (t[15] = O),
      (t[16] = k),
      (t[17] = A))
    : (A = t[17]);
  ...
  t[25] === s.length
    ? (F = t[26])
    : ((F = (0, J.jsxs)(`span`, { children: [s.length, ` requests`] })),
      (t[25] = s.length),
      (t[26] = F));
  let I;
  t[27] === a.length
    ? (I = t[28])
    : ((I = (0, J.jsxs)(`span`, { children: [a.length, ` notifications`] })),
      (t[27] = a.length),
      (t[28] = I));
  let L;
  t[29] === x
  ...
  t[33] === w
    ...
    : ((ee =
        w > 0
          ? (0, J.jsxs)(`span`, {
              className: `rounded-full bg-token-charts-red/15 px-2 py-0.5 text-token-charts-red`,
              children: [w, ` notification errors`],
            })
          : null),
      (t[33] = w),
      (t[34] = ee));
  ...
  let re;
  t[47] !== p || t[48] !== n
    ? ((re = p ? (0, J.jsx)(qt, { hostDetails: n }) : null), (t[47] = p), (t[48] = n), (t[49] = re))
    : (re = t[49]);
  let ie;
  t[50] !== r || t[51] !== f
    ? ((ie = (0, J.jsx)(Zt, { hostId: r, threadStatusEntries: f })),
      (t[50] = r),
      (t[51] = f),
      (t[52] = ie))
    : (ie = t[52]);
  let B;
  t[53] !== r || t[54] !== s
    ? ((B = (0, J.jsx)(Yt, { hostId: r, requests: s })), (t[53] = r), (t[54] = s), (t[55] = B))
    : (B = t[55]);
  let ae;
  t[56] !== r || t[57] !== a
    ? ((ae = (0, J.jsx)(en, { hostId: r, notifications: a })),
      (t[56] = r),
      (t[57] = a),
      (t[58] = ae))
    : (ae = t[58]);
  let V;
  t[59] !== re || t[60] !== ie || t[61] !== B || t[62] !== ae
    ? ((V = (0, J.jsx)(`div`, {
...
function qt(e) {
  let t = (0, K.c)(4),
    { hostDetails: n } = e,
    r;
  t[0] === n.lines ? (r = t[1]) : ((r = n.lines?.map(Jt)), (t[0] = n.lines), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function Yt(e) {
  let t = (0, K.c)(16),
    ...
    [i, a] = (0, q.useState)(!1),
    o;
  t[0] === r ? (o = t[1]) : ((o = r.filter(Cn)), (t[0] = r), (t[1] = o));
  let s = o,
    c = i ? s : r,
    l = r.length === 0,
    u;
...
function Xt(e) {
  return (0, J.jsx)(ln, { request: e }, e.id);
}
function Zt({ hostId: e, threadStatusEntries: t }) {
  let [n, r] = (0, q.useState)(null),
    [i, a] = (0, q.useState)(null),
    o = hn(t),
    s = i != null && zt.includes(i) ? i : null,
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(Y, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children:
          o.length === 0
            ? (0, J.jsx)(cn, { message: `No in-memory threads for this manager yet` })
            : (0, J.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, J.jsx)(`div`, {
                    ...
                    children:
                      c.length === 0
                        ? (0, J.jsx)(cn, { message: `No in-memory threads match this state` })
                        : c.map((t) =>
                            (0, J.jsxs)(
                              `div`,
                              {
                                      ...
                                      (0, J.jsx)(
                                        Qt,
                                        {
                                          ...
                                          onUnsubscribe: async (t) => {
                                            r(t);
                                            try {
                                              await p(`unsubscribe-thread-for-host`, {
                                                hostId: e,
                                                threadId: t,
                                              });
                                            } finally {
...
function Qt(e) {
  let t = (0, K.c)(44),
    { entry: n, isPending: r, onUnsubscribe: a } = e,
    o = i(x, n.conversationId),
  ...
  let g;
  t[15] !== u || t[16] !== h
    ? ((g = (0, J.jsxs)(`div`, { className: `min-w-0`, children: [u, h] })),
      (t[15] = u),
      (t[16] = h),
      (t[17] = g))
    : (g = t[17]);
  ...
  let C = `resume: ${n.resumeState}`,
    w;
  t[28] === C ? (w = t[29]) : ((w = (0, J.jsx)($t, { label: C })), (t[28] = C), (t[29] = w));
  let T = `stream: ${o?.role ?? `none`}`,
    E;
  t[30] === T ? (E = t[31]) : ((E = (0, J.jsx)($t, { label: T })), (t[30] = T), (t[31] = E));
  let D = `runtime: ${n.threadRuntimeStatus?.type ?? `none`}`,
    O;
  t[32] === D ? (O = t[33]) : ((O = (0, J.jsx)($t, { label: D })), (t[32] = D), (t[33] = O));
  let k = `turn: ${n.lastTurnStatus ?? `none`}`,
    A;
  t[34] === k ? (A = t[35]) : ((A = (0, J.jsx)($t, { label: k })), (t[34] = k), (t[35] = A));
  let j;
...
function en(e) {
  let t = (0, K.c)(45),
    ...
    y,
    b;
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== l || t[4] !== a) {
    let e = mn(r);
    f = l != null && e.includes(l) ? l : null;
    let o;
    t[15] !== f || t[16] !== r
    ...
    let s = o,
      c;
    (t[18] === s ? (c = t[19]) : ((c = s.filter(an)), (t[18] = s), (t[19] = c)), (p = c));
    let x;
    (t[20] !== s || t[21] !== a
      ? ((x = a ? s : s.filter(rn)), (t[20] = s), (t[21] = a), (t[22] = x))
      : (x = t[22]),
      (m = x),
      (d = sn),
      (_ = r.length === 0),
      ...
      (g =
        e.length > 0
          ? (0, J.jsxs)(`select`, {
              ...
              value: f ?? ``,
              onChange: (e) => {
                u(e.currentTarget.value || null);
              },
              children: [(0, J.jsx)(`option`, { value: ``, children: `All threads` }), e.map(nn)],
            })
          : null),
      (t[0] = n),
      (t[1] = r),
  ...
  t[33] !== f || t[34] !== p.length || t[35] !== m
    ? ((C =
        m.length > 0
          ...
          : (0, J.jsx)(cn, {
              message: p.length > 0 ? `Only hidden delta notifications recorded` : yn(f),
            })),
      (t[33] = f),
      (t[34] = p.length),
      (t[35] = m),
...
function tn(e) {
  return (0, J.jsx)(un, { notification: e }, e.id);
}
function nn(e) {
  return (0, J.jsx)(on, { threadId: e }, e);
}
function rn(e) {
  return !e.isNoisy;
}
...
function on(e) {
  ...
  let a = i(f, r),
    o;
  t[2] === a ? (o = t[3]) : ((o = a?.trim() || `Untitled thread`), (t[2] = a), (t[3] = o));
  let s;
  return (
    t[4] !== o || t[5] !== n
...
function ln(e) {
  ...
  t[7] === n.startedAtMs
    ? (o = t[8])
    : ((o = Lt.format(n.startedAtMs)), (t[7] = n.startedAtMs), (t[8] = o));
  let s;
  t[9] === o ? (s = t[10]) : ((s = (0, J.jsx)(`div`, { children: o })), (t[9] = o), (t[10] = s));
  let c;
  t[11] === n ? (c = t[12]) : ((c = wn(n)), (t[11] = n), (t[12] = c));
  let l;
  ...
  t[25] === n.endedAtMs
    ...
    : ((h =
        n.endedAtMs == null
          ...
          : (0, J.jsxs)(`div`, { children: [`Ended: `, Lt.format(n.endedAtMs)] })),
      (t[25] = n.endedAtMs),
      (t[26] = h));
  let g;
  ...
  t[31] === n.paramsPreview
    ? (_ = t[32])
    : ((_ = (0, J.jsx)(dn, { payload: n.paramsPreview, title: `Params` })),
      (t[31] = n.paramsPreview),
      (t[32] = _));
  let v;
  t[33] === n.resultPreview
    ...
    : ((v =
        n.resultPreview == null
          ? null
          : (0, J.jsx)(dn, { payload: n.resultPreview, title: `Result` })),
      (t[33] = n.resultPreview),
      (t[34] = v));
  let y;
  t[35] === n.errorPreview
    ...
    : ((y =
        n.errorPreview == null
          ? null
          : (0, J.jsx)(dn, { payload: n.errorPreview, title: `Error` })),
      (t[35] = n.errorPreview),
      (t[36] = y));
  let b;
...
function un(e) {
  ...
  t[0] === n.severity
    ? (r = t[1])
    : ((r = W(`group/notification bg-token-background rounded-lg border`, Tn(n.severity))),
      (t[0] = n.severity),
      (t[1] = r));
  let i;
  t[2] === n.method
  ...
  t[9] === n.receivedAtMs
    ? (s = t[10])
    : ((s = Lt.format(n.receivedAtMs)), (t[9] = n.receivedAtMs), (t[10] = s));
  let c;
  t[11] === s
    ? (c = t[12])
    : ((c = (0, J.jsx)(`div`, {
  ...
  t[16] === n.paramsPreview
    ...
    : ((u = (0, J.jsx)(`div`, {
        className: `space-y-3 border-t border-token-border p-3`,
        children: (0, J.jsx)(dn, { payload: n.paramsPreview, title: `Params` }),
      })),
      (t[16] = n.paramsPreview),
      (t[17] = u));
  let d;
...
function dn(e) {
  ...
  t[2] === n
    ...
    : ((a = (0, J.jsx)(`button`, {
        ...
        onClick: () => {
          navigator.clipboard?.writeText(n).catch(fn);
        },
        children: `Copy`,
      })),
      (t[2] = n),
...
function pn(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = W(`rounded-full px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide`, En(n))),
      (t[0] = n),
      (t[1] = r));
  let i;
  return (
...
function _n({ count: e, status: t }) {
  return `${t} (${e})`;
}
function vn(e) {
  return zt.find((t) => t === e) ?? null;
}
function yn(e) {
  return e == null
...
var Dn = [`browser-debug-snapshot`],
  On = `debug-browser-tabs`,
  kn = 1e3,
  An = new Intl.DateTimeFormat(void 0, {
    fractionalSecondDigits: 3,
    hour: `2-digit`,
    minute: `2-digit`,
    second: `2-digit`,
...
function jn() {
  ...
  e[1] === o
    ...
    : ((c = {
      ...
      (e[1] = o),
      (e[2] = c));
  let { data: l, isFetching: u, isLoading: d, refetch: f } = ee(c),
    p;
  e[3] === f
    ? (p = e[4])
    : ((p = async (e) => {
        ...
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              (0, J.jsx)(`button`, {
                ...
                disabled: l == null,
                onClick: () => {
                  l != null && navigator.clipboard?.writeText(JSON.stringify(l, null, 2)).catch(Mn);
                },
                children: `Copy JSON`,
              }),
              (0, J.jsxs)(`button`, {
                ...
                children: [u ? (0, J.jsx)(fe, { className: `icon-2xs` }) : null, `Refresh`],
              }),
            ],
          })
        : null),
  ...
  e[10] !== l || e[11] !== m || e[12] !== d || e[13] !== n || e[14] !== i
    ? ((_ = n
        ? t == null
          ? (0, J.jsx)(Jn, { message: `Browser debug service unavailable.` })
          : d && l == null
            ? (0, J.jsx)(Jn, { message: `Loading Browser debug snapshot...` })
            : l == null
              ? (0, J.jsx)(Jn, { message: `Browser debug snapshot unavailable.` })
              : (0, J.jsx)(Pn, { onOpenOwner: m, openOwnerStatus: i, snapshot: l })
        : null),
      (e[10] = l),
      (e[11] = m),
      (e[12] = d),
...
function Pn(e) {
  ...
  t[0] === i.capturedAtMs
    ? (a = t[1])
    : ((a = An.format(i.capturedAtMs)), (t[0] = i.capturedAtMs), (t[1] = a));
  let o;
  t[2] === a
    ? (o = t[3])
  ...
  t[21] === r
    ...
    : ((v =
      ...
      (t[22] = v));
  let y;
  t[23] === i.windows ? (y = t[24]) : ((y = i.windows.map(zn)), (t[23] = i.windows), (t[24] = y));
  let b;
  t[25] === y
    ? (b = t[26])
    : ((b = (0, J.jsx)(qn, {
  ...
  t[34] === i.sessionRoutes
    ? (C = t[35])
    : ((C = i.sessionRoutes.map(Rn)), (t[34] = i.sessionRoutes), (t[35] = C));
  let w;
  t[36] === C
    ? (w = t[37])
    : ((w = (0, J.jsx)(qn, {
  ...
  t[38] === i.pendingAttaches
    ? (T = t[39])
    : ((T = i.pendingAttaches.map(Ln)), (t[38] = i.pendingAttaches), (t[39] = T));
  let E;
  t[40] === T
    ? (E = t[41])
    : ((E = (0, J.jsx)(qn, {
  ...
  t[42] === i.openRequests
    ? (D = t[43])
    : ((D = i.openRequests.map(In)), (t[42] = i.openRequests), (t[43] = D));
  let O;
  t[44] === D
    ? (O = t[45])
    : ((O = (0, J.jsx)(qn, {
  ...
  t[46] === i.events
    ? (k = t[47])
    : ((k = i.events.slice().reverse().map(Fn)), (t[46] = i.events), (t[47] = k));
  let A;
  t[48] === k
    ? (A = t[49])
    : ((A = (0, J.jsx)(qn, {
...
function Fn(e) {
  return (0, J.jsx)(Wn, { event: e }, e.sequence);
}
function In(e) {
  return (0, J.jsx)(
    Gn,
...
function Rn(e) {
  return (0, J.jsx)(Hn, { route: e }, `${e.windowId}:${e.conversationId}`);
}
function zn(e) {
  return (0, J.jsx)(Bn, { window: e }, e.windowId);
}
function Bn(e) {
  let t = (0, K.c)(32),
    { window: n } = e,
  ...
  return (
    t[28] !== x || t[29] !== S || t[30] !== C
      ? ((w = (0, J.jsx)(Gn, { details: x, subtitle: S, title: C })),
        (t[28] = x),
        (t[29] = S),
        (t[30] = C),
        (t[31] = w))
...
function Vn(e) {
  ...
  let I;
  t[55] === r.bounds ? (I = t[56]) : ((I = Zn(r.bounds)), (t[55] = r.bounds), (t[56] = I));
  let L;
  t[57] === I
    ? (L = t[58])
    : ((L = (0, J.jsx)(X, { label: `Bounds`, value: I })), (t[57] = I), (t[58] = L));
  let R = `active=${r.active}`,
    ee = `presented=${r.presented}`,
    z = `visible=${r.visible}`,
    te = `hasPage=${r.hasPage}`,
    ne = `loading=${r.isLoading}`,
    re = `restoring=${r.isRestoring}`,
    ie = `suspended=${r.isSuspended}`,
    B;
  t[59] !== R ||
  t[60] !== ee ||
  t[61] !== z ||
  ...
  t[67] === ae
    ? (V = t[68])
    : ((V = (0, J.jsx)(X, { label: `Flags`, value: ae })), (t[67] = ae), (t[68] = V));
  let oe = `page=${r.isBrowserUsePage}`,
    H = `active=${r.isBrowserUseActive}`,
    ...
    ue;
  t[69] !== oe || t[70] !== H || t[71] !== se || t[72] !== ce || t[73] !== le
    ? ((ue = [oe, H, se, ce, le]),
      (t[69] = oe),
      (t[70] = H),
      (t[71] = se),
  ...
  t[75] === U
    ? (W = t[76])
    : ((W = (0, J.jsx)(X, { label: `Browser Use`, value: U })), (t[75] = U), (t[76] = W));
  ...
  t[82] === ge
    ? (_e = t[83])
    : ((_e = (0, J.jsx)(X, { label: `Lifecycle`, value: ge })), (t[82] = ge), (t[83] = _e));
  let ve =
  ...
  t[84] === ve
    ? (ye = t[85])
    : ((ye = (0, J.jsx)(X, { label: `Pending teardown`, value: ve })), (t[84] = ve), (t[85] = ye));
  let G;
  t[86] !== b ||
  t[87] !== x ||
  t[88] !== C ||
  ...
  t[99] !== ye
    ? ((G = (0, J.jsxs)(`div`, {
        ...
        children: [b, x, C, T, D, k, j, N, F, L, V, W, _e, ye],
      })),
      (t[86] = b),
      (t[87] = x),
      (t[88] = C),
...
function Hn(e) {
  ...
  return (
    t[25] !== n.conversationId || t[26] !== v || t[27] !== y
      ? ((b = (0, J.jsx)(Gn, { details: v, subtitle: y, title: n.conversationId })),
...
function Un(e) {
  ...
  return (
    t[19] !== f || t[20] !== p || t[21] !== m
      ? ((h = (0, J.jsx)(Gn, { details: f, subtitle: p, title: m })),
        (t[19] = f),
        (t[20] = p),
        (t[21] = m),
        (t[22] = h))
...
function Wn(e) {
  ...
  t[2] === n.timestampMs
    ? (a = t[3])
    : ((a = An.format(n.timestampMs)), (t[2] = n.timestampMs), (t[3] = a));
  let o;
  ...
  return (
    t[28] !== n.message || t[29] !== y || t[30] !== b
      ? ((x = (0, J.jsx)(Gn, { details: y, subtitle: n.message, title: b })),
        (t[28] = n.message),
        (t[29] = y),
        (t[30] = b),
        (t[31] = x))
...
function Gn(e) {
  ...
  t[4] !== a || t[5] !== o
    ...
    : (s = t[6]);
  let c;
  t[7] === n ? (c = t[8]) : ((c = n.map(Kn)), (t[7] = n), (t[8] = c));
  let l;
  t[9] === c
    ? (l = t[10])
  ...
  createTable: (e) => {
    ((e.getHeaderGroups = Z(
      ...
      (e.getLeftHeaderGroups = Z(
        ...
        (t, n, r) =>
          sr(t, r?.map((e) => n.find((t) => t.id === e)).filter(Boolean) ?? [], e, `left`),
      ...
      (e.getRightHeaderGroups = Z(
        ...
        (t, n, r) =>
          sr(t, r?.map((e) => n.find((t) => t.id === e)).filter(Boolean) ?? [], e, `right`),
...
function sr(e, t, n, r) {
  ...
  (s(
    t.map((e, t) => ar(n, e, { depth: i, index: t })),
    i - 1,
  ),
    o.reverse());
  let c = (e) =>
...
var cr = (e, t, n, r, i, a, o) => {
    let s = {
      ...
      subRows: a ?? [],
      getLeafRows: () => nr(s.subRows, (e) => e.subRows),
...
ur.autoRemove = (e) => br(e);
var dr = (e, t, n) => {
  var r;
  return !!(!((r = e.getValue(t)) == null || (r = r.toString()) == null) && r.includes(n));
};
dr.autoRemove = (e) => br(e);
var fr = (e, t, n) => {
  var r;
  return (
...
fr.autoRemove = (e) => br(e);
var pr = (e, t, n) => e.getValue(t)?.includes(n);
pr.autoRemove = (e) => br(e);
var mr = (e, t, n) =>
  !n.some((n) => {
    var r;
    return !((r = e.getValue(t)) != null && r.includes(n));
  });
mr.autoRemove = (e) => br(e) || !(e != null && e.length);
var hr = (e, t, n) => n.some((n) => e.getValue(t)?.includes(n));
hr.autoRemove = (e) => br(e) || !(e != null && e.length);
var gr = (e, t, n) => e.getValue(t) === n;
gr.autoRemove = (e) => br(e);
var _r = (e, t, n) => e.getValue(t) == n;
_r.autoRemove = (e) => br(e);
var vr = (e, t, n) => {
  let [r, i] = n,
    a = e.getValue(t);
  return a >= r && a <= i;
...
((vr.resolveFilterValue = (e) => {
  ...
  (vr.autoRemove = (e) => br(e) || (br(e[0]) && br(e[1]))));
var yr = {
  includesString: ur,
      ...
      (e.getFilterFn = () =>
        er(e.columnDef.filterFn)
          ...
          : e.columnDef.filterFn === `auto`
            ? e.getAutoFilterFn()
            : (t.options.filterFns?.[e.columnDef.filterFn] ?? yr[e.columnDef.filterFn])),
      (e.getCanFilter = () =>
      ...
      (e.setFilterValue = (n) => {
        t.setColumnFilters((t) => {
          let r = e.getFilterFn(),
            ...
            a = Qn(n, i ? i.value : void 0);
          if (Sr(r, a, e)) return t?.filter((t) => t.id !== e.id) ?? [];
      ...
      e.options.onColumnFiltersChange == null ||
        e.options.onColumnFiltersChange((e) =>
          Qn(t, e)?.filter((e) => {
            ...
            return !(t && Sr(t.getFilterFn(), e.value, t));
          }),
        );
    }),
    ...
    createColumn: (e, t) => {
      ((e.toggleGrouping = () => {
        ...
        (e.getAutoAggregationFn = () => {
          let n = t.getCoreRowModel().flatRows[0]?.getValue(e.id);
          if (typeof n == `number`) return Cr.sum;
          if (Object.prototype.toString.call(n) === `[object Date]`) return Cr.extent;
        }),
        (e.getAggregationFn = () => {
          if (!e) throw Error();
          return er(e.columnDef.aggregationFn)
            ? e.columnDef.aggregationFn
            : e.columnDef.aggregationFn === `auto`
              ? e.getAutoAggregationFn()
              : (t.options.aggregationFns?.[e.columnDef.aggregationFn] ??
                Cr[e.columnDef.aggregationFn]);
        }));
    },
    createTable: (e) => {
      ((e.setGrouping = (t) =>
...
var Er = {
    ...
    createColumn: (e, t) => {
      ((e.getIndex = Z(
        ...
        (e.getIsFirstColumn = (n) => Lr(t, n)[0]?.id === e.id),
        (e.getIsLastColumn = (n) => {
          let r = Lr(t, n);
  ...
  Dr = () => ({ left: [], right: [] }),
  Or = {
    getInitialState: (e) => ({ columnPinning: Dr(), ...e }),
    ...
    createTable: (e) => {
      ((e.setColumnPinning = (t) =>
        ...
        (e.resetColumnPinning = (t) =>
          e.setColumnPinning(t ? Dr() : (e.initialState?.columnPinning ?? Dr()))),
...
var Ar = { size: 150, minSize: 20, maxSize: 2 ** 53 - 1 },
  jr = () => ({
    startOffset: null,
    startSize: null,
    deltaOffset: null,
  ...
  Mr = {
    ...
    getInitialState: (e) => ({ columnSizing: {}, columnSizingInfo: jr(), ...e }),
    getDefaultOptions: (e) => ({
    ...
    createColumn: (e, t) => {
      ((e.getSize = () => {
        ...
        return Math.min(
          Math.max(e.columnDef.minSize ?? Ar.minSize, n ?? e.columnDef.size ?? Ar.size),
          e.columnDef.maxSize ?? Ar.maxSize,
        );
      }),
        (e.getStart = Z(
          (e) => [e, Lr(t, e), t.getState().columnSizing],
        ...
        (e.getResizeHandler = (n) => {
          ...
          return (a) => {
            if (
              !r ||
              !i ||
              (a.persist == null || a.persist(), Fr(a) && a.touches && a.touches.length > 1)
            )
              return;
            let o = e.getSize(),
              s = e
                ...
                : [[r.id, r.getSize()]],
              c = Fr(a) ? Math.round(a.touches[0].clientX) : a.clientX,
              l = {},
              u = (e, n) => {
                typeof n == `number` &&
    ...
    createTable: (e) => {
      ((e.setColumnSizing = (t) =>
        ...
        (e.resetHeaderSizeInfo = (t) => {
          e.setColumnSizingInfo(t ? jr() : (e.initialState.columnSizingInfo ?? jr()));
        }),
        (e.getTotalSize = () =>
...
var Rr = {
  ...
  zr = {
    ...
    createTable: (e) => {
      ((e.getGlobalAutoFilterFn = () => yr.includesString),
        (e.getGlobalFilterFn = () => {
  ...
  Br = {
    ...
    getDefaultOptions: (e) => ({ onExpandedChange: $n(`expanded`, e), paginateExpandedRows: !0 }),
    createTable: (e) => {
      let t = !1,
        n = !1;
  ...
  Vr = 0,
  Hr = 10,
  Ur = () => ({ pageIndex: Vr, pageSize: Hr }),
  Wr = {
    getInitialState: (e) => ({ ...e, pagination: { ...Ur(), ...e?.pagination } }),
      ...
      ((e._autoResetPageIndex = () => {
        ...
        (e.setPagination = (t) =>
          e.options.onPaginationChange == null
            ? void 0
            : e.options.onPaginationChange((e) => Qn(t, e))),
        (e.resetPagination = (t) => {
          e.setPagination(t ? Ur() : (e.initialState.pagination ?? Ur()));
        }),
        (e.setPageIndex = (t) => {
          e.setPagination((n) => {
        ...
        (e.setPageSize = (t) => {
          e.setPagination((e) => {
            let n = Math.max(1, Qn(t, e.pageSize)),
  ...
  Gr = () => ({ top: [], bottom: [] }),
  Kr = {
    getInitialState: (e) => ({ rowPinning: Gr(), ...e }),
    ...
    createTable: (e) => {
      ((e.setRowPinning = (t) =>
        ...
        (e.resetRowPinning = (t) =>
          e.setRowPinning(t ? Gr() : (e.initialState?.rowPinning ?? Gr()))),
    ...
    createTable: (e) => {
      ((e.setRowSelection = (t) =>
        ...
        (e.getSelectedRowModel = Z(
          ...
          (t, n) => (Object.keys(t).length ? Yr(e, n) : { rows: [], flatRows: [], rowsById: {} }),
    ...
    createRow: (e, t) => {
      ((e.toggleSelected = (n, r) => {
        ...
        t.setRowSelection((a) => {
          ...
          let o = { ...a };
          return (Jr(o, e.id, n, r?.selectChildren ?? !0, t), o);
        });
      }),
        (e.getIsSelected = () => {
  ...
  Jr = (e, t, n, r, i) => {
    ...
    (n
      ...
      r &&
        ...
        o.subRows.forEach((t) => Jr(e, t.id, n, r, i)));
  };
function Yr(e, t) {
...
function Zr(e, t, n) {
  ...
  return (
    e.subRows.forEach((e) => {
      if (
        !(a && !i) &&
        (e.getCanSelect() && (Xr(e, t) ? (a = !0) : (i = !1)), e.subRows && e.subRows.length)
      ) {
        let n = Zr(e, t);
...
var Qr = /([0-9]+)/gm,
  $r = (e, t, n) => si(oi(e.getValue(n)).toLowerCase(), oi(t.getValue(n)).toLowerCase()),
  ei = (e, t, n) => si(oi(e.getValue(n)), oi(t.getValue(n))),
  ti = (e, t, n) => ai(oi(e.getValue(n)).toLowerCase(), oi(t.getValue(n)).toLowerCase()),
  ni = (e, t, n) => ai(oi(e.getValue(n)), oi(t.getValue(n))),
  ri = (e, t, n) => {
    let r = e.getValue(n),
      i = t.getValue(n);
    return r > i ? 1 : r < i ? -1 : 0;
  },
  ii = (e, t, n) => ai(e.getValue(n), t.getValue(n));
function ai(e, t) {
      ...
      createColumn: (e, t) => {
        ((e.getAutoSortingFn = () => {
          ...
          for (let t of n) {
            ...
            if (Object.prototype.toString.call(n) === `[object Date]`) return ci.datetime;
            if (typeof n == `string` && ((r = !0), n.split(Qr).length > 1)) return ci.alphanumeric;
          }
          return r ? ci.text : ci.basic;
        }),
          (e.getAutoSortDir = () =>
          ...
          (e.getSortingFn = () => {
            if (!e) throw Error();
            return er(e.columnDef.sortingFn)
              ? e.columnDef.sortingFn
              : e.columnDef.sortingFn === `auto`
                ? e.getAutoSortingFn()
                : (t.options.sortingFns?.[e.columnDef.sortingFn] ?? ci[e.columnDef.sortingFn]);
          }),
          (e.toggleSorting = (n, r) => {
        ...
        let n = { rows: [], flatRows: [], rowsById: {} },
          r = function (t, i, a) {
            ...
            for (let c = 0; c < t.length; c++) {
              let l = cr(e, e._getRowId(t[c], c, a), t[c], c, i, void 0, a?.id);
...
function fi() {
  return (e) =>
    Z(
      ...
      (e, t, n) => (!t.rows.length || (e !== !0 && !Object.keys(e ?? {}).length) || !n ? t : pi(t)),
...
function mi(e, t) {
  return e ? (hi(e) ? q.createElement(e, t) : e) : null;
}
function hi(e) {
  return gi(e) || typeof e == `function` || _i(e);
}
function gi(e) {
  return (
    typeof e == `function` &&
...
function Di(e) {
  return e == null ? `default` : e > xi ? `danger` : e > bi ? `warning` : `default`;
}
function Oi(e, t) {
  let n = (t.get(e.pid) ?? []).map((e) => Oi(e, t));
  return (
    n.sort(ki),
    {
      children: n,
      commandLabel: Ci(e.command),
      fullCommand: e.command.trim().length > 0 ? e.command.trim() : `(command unavailable)`,
      process: e,
      totalCpuPercent: Ai(e.cpuPercent, n),
      totalRssKb: ji(e.rssKb, n),
    }
  );
}
function ki(e, t) {
...
function Mi(e) {
  return yi.default.basename(e.replaceAll(`\\`, `/`));
}
var Ni = `debug-child-processes`;
function Pi() {
  let e = (0, K.c)(25),
    [t, n] = (0, q.useState)(Bi),
    [r, i] = (0, q.useState)(!1),
    ...
    ? ((_ = t
        ? u && l == null
          ...
          : l?.rootProcess == null
            ...
            : (0, J.jsx)(Ii, { onProcessDetailsClick: o, processes: f, rootProcess: l.rootProcess })
        : null),
      (e[8] = l),
      (e[9] = u),
      (e[10] = t),
  ...
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, J.jsx)(Ce, {
        title: (0, J.jsx)(Se, { children: `Process details` }),
        subtitle: (0, J.jsx)(Ee, { children: `The process ID and full command are shown below` }),
      })),
      (e[14] = b))
    : (b = e[14]);
  let x;
  ...
  let S;
  e[17] !== x || e[18] !== v
    ? ((S = (0, J.jsx)(we, { open: v, onOpenChange: y, size: `wide`, children: x })),
      (e[17] = x),
      (e[18] = v),
      (e[19] = S))
    : (S = e[19]);
...
function Ii({ onProcessDetailsClick: e, processes: t, rootProcess: n }) {
  let r = (0, q.useMemo)(() => Si(n, t), [t, n]),
    i = (0, q.useMemo)(() => (r == null ? [] : [r]), [r]),
    a = vi({
      columns: (0, q.useMemo)(() => Li(e), [e]),
      data: i,
      getCoreRowModel: di(),
                      ...
                      (0, J.jsx)(
                        `th`,
                        {
                          ...
                          children: e.isPlaceholder
                            ? null
                            : mi(e.column.columnDef.header, e.getContext()),
                        },
                        e.id,
                      ),
                    ),
                    ...
                    .map((e) =>
                      (0, J.jsx)(
                        `td`,
                        {
                          ...
                          children: mi(e.column.columnDef.cell, e.getContext()),
                        },
                        e.id,
                      ),
                    ),
        ...
        (0, J.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, J.jsx)(`button`, {
              ...
              onClick: () => e(zi(t.original)),
              children: (0, J.jsx)(Ye, { className: `icon-xs` }),
            }),
          ],
        }),
    },
        ...
        (0, J.jsx)(Ri, {
          selfValue:
            e.original.process.depth === 0 && e.original.process.cpuPercent == null
              ? ``
              : Ti(e.original.process.cpuPercent),
          totalValue: Ti(e.original.totalCpuPercent),
        }),
    },
    {
      id: `ram`,
      ...
      cell: ({ row: e }) =>
        (0, J.jsx)(Ri, {
          selfValue: wi(e.original.process.rssKb),
          totalValue: wi(e.original.totalRssKb),
          tone: Di(e.original.totalRssKb),
        }),
    },
    {
      ...
      id: `age`,
      header: `Age`,
      cell: ({ row: e }) => Ei(e.original.process.ageSeconds),
    },
  ];
}
function Ri(e) {
...
function Bi() {
  try {
    return window.localStorage.getItem(Ni) === `open`;
  } catch {
    return !1;
  }
}
function Vi(e) {
  let t = (0, K.c)(4),
    { lines: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = n.map(Hi)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function Wi(e) {
  ...
  if (
    ...
    ((d = Y),
      ...
      (v = `debug-entry-local-conversation-current`),
      (y = `selection`),
      (u = Vi));
    let m;
    t[13] === n ? (m = t[14]) : ((m = { label: `id`, value: n }), (t[13] = n), (t[14] = m));
    let h;
    t[15] === a ? (h = t[16]) : ((h = { label: `model`, value: a }), (t[15] = a), (t[16] = h));
    let g;
    t[17] === o ? (g = t[18]) : ((g = { label: `reasoning`, value: o }), (t[17] = o), (t[18] = g));
    let _;
    t[19] === s
      ? (_ = t[20])
      : ((_ = { label: `rolloutPath`, value: s }), (t[19] = s), (t[20] = _));
    let b;
    t[21] === c
      ? (b = t[22])
    ...
    (t[27] === T
      ...
      (t[11] = v),
      (t[12] = y));
  } else ((u = t[7]), (d = t[8]), (f = t[9]), (p = t[10]), (v = t[11]), (y = t[12]));
  let b;
  t[29] !== u || t[30] !== f
    ? ((b = (0, J.jsx)(u, { lines: f })), (t[29] = u), (t[30] = f), (t[31] = b))
    : (b = t[31]);
  let x;
  return (
    t[32] !== d || t[33] !== p || t[34] !== v || t[35] !== y || t[36] !== b
      ? ((x = (0, J.jsx)(d, { title: p, storageKey: v, variant: y, children: b })),
        (t[32] = d),
        (t[33] = p),
        (t[34] = v),
        (t[35] = y),
...
var qi = 96,
  ...
  Yi = 480,
  Xi = 320;
function Zi({ height: e, topInset: t = 0, width: n }) {
  let r = Math.min(920, n - 32),
    i = e - t,
    a = Math.min(840, i - 32);
  return {
    height: Math.max(Xi, a),
    width: Math.max(Yi, r),
    x: Math.round((n - r) / 2),
...
function Qi(e, t) {
  let n = t.topInset ?? 0,
    r = t.height - n,
    i = Math.max(Yi, Math.min(e.width, t.width));
  return {
    height: Math.max(Xi, Math.min(e.height, r)),
    width: i,
    x: Math.min(t.width - qi, Math.max(qi - i, e.x)),
    y: Math.min(t.height - Ji, Math.max(n, e.y)),
  };
}
function $i(e, t, n) {
  return Qi({ ...e, height: e.height + t.y, width: e.width + t.x }, n);
}
function ea(e) {
  let t = (0, K.c)(22),
...
function ta() {
  let e = (0, K.c)(15),
    ...
    { data: i, isLoading: a } = ke(U.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED),
    s = i === !0,
    l = s ? `Force claiming` : `Off`,
    u;
  e[0] === l
    ? (u = e[1])
    : ((u = (0, J.jsx)(`div`, {
        className: `flex flex-col py-1.5`,
        children: (0, J.jsx)(X, { label: `Lock override`, value: l }),
      })),
      (e[0] = l),
      (e[1] = u));
  let f;
  ...
  e[3] === t
    ...
    : ((p = (e) => {
        (r(null),
          d(t, U.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED, e)
            .then(() => {
...
function na() {
  ...
  e[0] === t
    ? (a = e[1])
    : ((a = { mutationFn: ra, onSuccess: (e) => (t.setQueryData(wt, e.state), e) }),
      (e[0] = t),
      (e[1] = a));
  let o = j(a);
  ...
  e[2] === i.configuredHotkey
    ? (c = e[3])
    : ((c = i.configuredHotkey == null ? `Off` : $e(i.configuredHotkey)),
      (e[2] = i.configuredHotkey),
      (e[3] = c));
  let l = c,
  ...
  e[4] === l
    ? (m = e[5])
    : ((m = (0, J.jsx)(X, { label: `Configured hotkey`, value: l })), (e[4] = l), (e[5] = m));
  let h;
  e[6] === u
    ? (h = e[7])
...
async function ra(e) {
  let { enabled: t } = e,
    n = ge.hotkeyWindowHotkeys;
  if (n == null) throw Error(`Popout Window hotkeys are unavailable`);
  return n.setDevOverrideEnabled(t);
}
var ia = `debug-maitai-section`,
  aa = [`all`, `family`, `signal`, `derived`, `query`, `mutation`],
  oa = 50,
  sa = 3,
  ca = 12,
  la = 4,
...
function fa() {
  ...
  if (
    ...
    ((b = n.filter((e) => ka(e).includes(o) && Aa(e).includes(c) && Da(e, u))),
      (g = b.slice(0, m)));
    let l = wa(g);
    ...
    e[16] === a
      ...
      : ((w = (0, J.jsx)(`input`, {
        ...
        (e[17] = w));
    let T;
    e[18] === u ? (T = e[19]) : ((T = Oa(u)), (e[18] = u), (e[19] = T));
    let E;
    e[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((E = (0, J.jsx)(Le, { className: `icon-2xs opacity-70` })), (e[20] = E))
      : (E = e[20]);
    let D;
    e[21] === T
      ? (D = e[22])
    ...
    e[24] === D
      ? (k = e[25])
      : ((k = (0, J.jsx)(be, { align: `end`, triggerButton: D, children: O })),
        (e[24] = D),
        (e[25] = k));
    let A;
...
function ya(e) {
  ...
  t[12] === b
    ...
    : ((x = (0, J.jsx)(`span`, {
      ...
      (t[13] = x));
  let S;
  t[14] === n ? (S = t[15]) : ((S = Ea(n)), (t[14] = n), (t[15] = S));
  let C;
  t[16] === S
    ? (C = t[17])
    : ((C = (0, J.jsx)(`span`, {
            ...
            children: [
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsxs)(`div`, {
                    className: `truncate text-xs text-token-description-foreground`,
                    children: [n.scopeName, ` /`, ` `, Ma(n.scopeKey)],
                  }),
                  p
                    ? (0, J.jsx)(Oe, {
...
function xa(e) {
  let t = (0, K.c)(17),
    ...
    [r, i] = (0, q.useState)(!1),
    a;
  t[0] === n ? (a = t[1]) : ((a = Pa(n)), (t[0] = n), (t[1] = a));
  let o = a,
    s;
  t[2] !== r || t[3] !== o.text || t[4] !== n
    ? ((s = r ? Na(n) : o.text), (t[2] = r), (t[3] = o.text), (t[4] = n), (t[5] = s))
    : (s = t[5]);
  let c = s,
...
function Ca(e) {
  let t = (0, K.c)(20),
    ...
    o;
  t[0] === r ? (o = t[1]) : ((o = Na(r)), (t[0] = r), (t[1] = o));
...
function Da(e, t) {
  return t === `all` ? !0 : t === `family` ? Ta(e) : !Ta(e) && Ea(e) === t;
}
function Oa(e) {
  switch (e) {
    case `all`:
...
function Aa(e) {
  return Ta(e) ? Na(e.familyKey).toLowerCase() : ``;
}
function ja(e, t, n) {
  try {
    return e.get(t.atom);
...
function Ma(e) {
  return typeof e == `string` ? e : Na(e).replaceAll(/\s+/g, ` `);
}
function Na(e) {
  if (e instanceof Error) return `${e.name}: ${e.message}`;
  if (e === void 0) return `undefined`;
  try {
    return JSON.stringify(e, Ba(), 2) ?? Object.prototype.toString.call(e);
  } catch {
...
function Fa(e, t, n) {
  ...
  if (typeof e == `string`) return e.length <= ua ? e : ((t.truncated = !0), `${e.slice(0, ua)}…`);
  ...
  if (e instanceof Map)
    return Ia([...e.entries()], t, ([e, r]) => [Fa(e, t, n + 1), Fa(r, t, n + 1)]);
  if (e instanceof Set) return Ia([...e], t, (e) => Fa(e, t, n + 1));
  if (Array.isArray(e)) return Ia(e, t, (e) => Fa(e, t, n + 1));
  let r = Object.entries(e),
    i = r.slice(0, ca).map(([e, r]) => [e, Fa(r, t, n + 1)]);
  return (
    r.length > ca && ((t.truncated = !0), i.push([`…`, `${r.length - ca} more`])),
    Object.fromEntries(i)
  );
}
function Ia(e, t, n) {
  let r = e.slice(0, ca).map((e) => n(e));
  return (e.length > ca && ((t.truncated = !0), r.push(`${e.length - ca} more`)), r);
}
function La(e) {
...
var Va = 8,
  ...
  Ka = ue({
    ...
    data: H(),
    mimeType: H().optional(),
    mime_type: H().optional(),
  }).catchall(B()),
  qa = ue({ type: se(`text`), text: H() }).catchall(B()),
  Ja = ue({ code: H(), timeout_ms: B().optional(), title: B().optional() }).catchall(B());
function Ya(e) {
  let t = Xa(e);
  return t.totalCount === 0
    ...
    : {
        lines: [
          ...
          ...t.recentCalls.flatMap((e, t) => Qa(e, t)),
        ],
      };
}
function Xa(e) {
...
function Za(e) {
  return e.type === `mcpToolCall` && e.server === Ga;
}
function Qa({ conversationId: e, item: t, turnId: n }, r) {
  let i = [
    {
      label: `call[${r}]`,
      value:
  ...
  return (
    ...
    t.result != null &&
      (i.push(...to(t.result, r)),
      i.push({ kind: `json`, label: `call[${r}].result`, value: $a(t.result, Ua) })),
    i
  );
}
function $a(e, t = Ha) {
  return fo(JSON.stringify(e, eo, 2) ?? String(e), t);
}
function eo(e, t) {
  return e === `data` && typeof t == `string` && ao(this)
...
function to(e, t) {
  ...
  return n == null
    ...
    : n.flatMap((e, n) => {
        ...
        if (r != null)
          return [
            { kind: `multiline`, label: `call[${t}].result.content[${n}]`, value: fo(r, Wa) },
          ];
        let i = io(e);
        return i == null
          ? []
...
function io(e) {
  ...
  let r = t.data.mimeType ?? t.data.mime_type ?? so(n);
  return r.startsWith(`image/`) ? { data: n, mimeType: r } : null;
}
function ao(e) {
  return Ka.safeParse(e).success;
}
function oo(e) {
...
function co(e, t) {
  let n = lo(e);
  if (n == null) return [{ label: `call[${t}].arguments`, value: $a(e) }];
  let r = [];
  return (
    ...
    r.push({ kind: `javascript`, label: `call[${t}].script`, value: uo(n.code) }),
    Object.keys(n.extraArguments).length > 0 &&
      r.push({ label: `call[${t}].arguments`, value: $a(n.extraArguments) }),
    r
  );
}
function lo(e) {
  let t = Ja.safeParse(e);
  if (!t.success) return null;
  ...
  yo = a(c, ({ get: e }) =>
    Ya(
      e(C, k)
        ...
        .reverse()
        .flatMap((t) =>
          (e(O, t) ?? po).map((e) => ({ conversationId: t, items: e.items, turnId: e.turnId })),
        ),
    ),
  );
function bo(e) {
  ...
  if (n != null) {
    ...
    return (
      t[0] === n
        ? (e = t[1])
        : ((e = (0, J.jsx)(So, { conversationId: n })), (t[0] = n), (t[1] = e)),
      e
    );
  }
  let r;
...
function xo() {
  ...
  return (
    e[0] === t.lines
      ? (n = e[1])
      : ((n = (0, J.jsx)(Co, { lines: t.lines })), (e[0] = t.lines), (e[1] = n)),
    n
  );
}
function So(e) {
  ...
  return (
    t[5] === o.lines
      ? (s = t[6])
      : ((s = (0, J.jsx)(Co, { lines: o.lines })), (t[5] = o.lines), (t[6] = s)),
    s
  );
}
function Co(e) {
...
function wo({ lines: e }) {
  let t = (0, q.useMemo)(
      () => e.map((e, t) => ({ estimatedHeightPx: mo, line: e, turnKey: `${t}:${e.label}` })),
      [e],
    ),
    [n, r] = (0, q.useState)({}),
    [i, a] = (0, q.useState)(null),
    [o, s] = (0, q.useState)(() => Oo(t.length)),
    c = (0, q.useRef)(null),
    l = (0, q.useRef)(n),
    u = jt({ entries: t, gapPx: 0, measuredHeightsByKey: n });
  l.current = n;
  let d = me(() => {
      ...
      let n = i.getBoundingClientRect(),
        ...
        o = e.scrollTop - a,
        c = ko({ layout: u, viewportBottomPx: o + e.clientHeight, viewportTopPx: o });
      s((e) => (Ao(e, c) ? e : c));
    }),
    f = me((e) => {
      if (e.size === 0) return;
  ...
  return (0, J.jsx)(`div`, {
    ...
    children: (0, J.jsx)(`div`, {
      ...
      children: (0, J.jsx)(`div`, {
        ...
        children: h.map((e) => (0, J.jsx)(To, { entry: e, measureLineRef: m }, e.turnKey)),
      }),
    }),
  });
}
var To = (0, q.memo)(function (e) {
  let t = (0, K.c)(6),
    { entry: n, measureLineRef: r } = e,
    i;
  t[0] === n.line
    ? (i = t[1])
    : ((i = (0, J.jsx)(Eo, { line: n.line })), (t[0] = n.line), (t[1] = i));
  let a;
  return (
...
function Eo(e) {
  ...
  switch (n.kind) {
    ...
    case `image`: {
      let e;
      return (
        t[9] === n ? (e = t[10]) : ((e = (0, J.jsx)(Fo, { line: n })), (t[9] = n), (t[10] = e)), e
      );
    }
    case void 0: {
      let e;
...
function ko({ layout: e, viewportBottomPx: t, viewportTopPx: n }) {
  let r = e.turnKeys.length;
  if (r === 0) return { startIndex: 0, endIndex: 0 };
  if (t <= 0) return { startIndex: 0, endIndex: Math.min(r, ho) };
  if (n >= e.totalHeightPx) return { startIndex: Math.max(0, r - ho), endIndex: r };
  let i = Math.max(0, n),
...
function jo(e) {
  return e.closest(`[data-debug-panel-scroll-container]`) ?? Mo(e);
}
function Mo(e) {
...
function Po(e) {
  ...
  return (
    t[5] !== n || t[6] !== c
      ? ((l = (0, J.jsx)(Do, { label: n, children: c })), (t[5] = n), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
function Fo(e) {
  ...
  return (
    t[15] !== n.label || t[16] !== m
      ? ((h = (0, J.jsx)(Do, { label: n.label, children: m })),
        (t[15] = n.label),
        (t[16] = m),
        (t[17] = h))
      : (h = t[17]),
...
function Vo() {
  let e = (0, K.c)(42),
    ...
    [I, L] = (0, q.useState)(!1),
    R;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((R = { hostId: k }), (e[0] = R)) : (R = e[0]);
  let ee = I && !0,
    te;
  e[1] === ee
    ? (te = e[2])
    : ((te = { params: R, queryConfig: { enabled: ee } }), (e[1] = ee), (e[2] = te));
  let ne = F(`workspace-root-options`, te).data?.roots.length ?? 0,
    re;
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = [
        ...
        { value: ut, label: `T5 Onboarding V2` },
      ]),
      (e[4] = B))
    : (B = e[4]);
  let ae = B,
  ...
  e[7] === g.roles
    ? (le = e[8])
    : ((le = g.roles.length === 0 ? `none` : g.roles.join(`, `)), (e[7] = g.roles), (e[8] = le));
  let ue = le,
    U;
  e[9] !== ce ||
  e[10] !== n ||
    ...
    ? ((U = I
        ? (0, J.jsxs)(`div`, {
            ...
            children: [
              (0, J.jsx)(`div`, {
                className: `text-xs text-token-description-foreground`,
                children: `Auth: ${n.authMethod ?? `none`} · Projects: ${ne}`,
              }),
              (0, J.jsx)(`div`, {
                className: `text-xs text-token-description-foreground`,
                children: `Codex runtime: ${P == null ? `idle` : Ho(P)}`,
              }),
              (0, J.jsx)(`div`, {
                ...
                children: ie.map((e) =>
                  (0, J.jsx)(
                    `button`,
                    {
                      ...
                      onClick: () => {
                        (e.value === `workspace` && x(!1), l(e.value));
                      },
                      children: e.label,
                    },
                    e.value,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    ...
                    children: `Onboarding welcome pending: ${u ? `pending` : `off`} · Projectless completed: ${m ? `yes` : `no`} · Plugin checklist active: ${_ ? `yes` : `no`} · Roles: ${ue}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    ...
                    onClick: () => {
                      (h(!1),
                        ...
                        x(!1),
                        (async () => {
                          (await d(t, `use-copilot-auth-if-available`, !1),
                            await p(`logout`, { hostId: k }),
                            l(`welcome`),
                            f(!0),
                            h(!1),
                            v(!1),
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-xs text-token-description-foreground`,
                    children: `Onboarding plugin checklist: ${_ ? `active` : `inactive`}`,
                  }),
                  (0, J.jsxs)(`div`, {
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-xs text-token-description-foreground`,
                    children: `Home onboarding tiles debug override: ${y ? `forced on` : `off`}`,
                  }),
                  (0, J.jsxs)(`div`, {
                    className: `flex flex-wrap items-center gap-2`,
                    children: [
                      ...
                      (0, J.jsx)(
                        `button`,
                        {
                          ...
                          onClick: () => {
                            ...
                            C({ arm: e.value, assignedAtMs: Date.now(), experimentName: dt });
                          },
                          children: e.label,
                        },
                        e.value,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, J.jsx)(`button`, {
                    ...
                    onClick: () => {
                      (A(!1), j(!1), i.updateUserAsync(i.getContext().user));
                    },
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Remote Connections home announcement: ${M ? `seen` : `unseen`}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    className: `rounded border border-token-border px-3 py-1 text-token-description-foreground hover:bg-token-foreground/5`,
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  (0, J.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Browser profile import NUX: ${N ? `seen` : `unseen`}`,
                  }),
                  (0, J.jsx)(`button`, {
                    type: `button`,
                    className: `cursor-interaction rounded border border-token-border px-3 py-1 text-token-description-foreground hover:bg-token-foreground/5`,
...
function Ho({ downloadedBytes: e, errorMessage: t, phase: n, totalBytes: r }) {
  return [n, e == null ? null : r == null ? `${Uo(e)} downloaded` : `${Uo(e)} / ${Uo(r)}`, t]
    .filter(Boolean)
    .join(` · `);
}
function Uo(e) {
...
function Wo() {
  ...
  e[18] === a
    ? (v = e[19])
    : ((v = a ? (0, J.jsx)(fe, { className: `icon-2xs` }) : null), (e[18] = a), (e[19] = v));
  let y;
  ...
  return (
    e[0] === t
      ...
      : ((n = (0, J.jsx)(Y, {
          ...
          variant: `global`,
          children: (0, J.jsx)(qo, { productEvents: t }),
        })),
        (e[0] = t),
        (e[1] = n)),
    n
    ...
    `div`,
    {
      ...
      children: [
        (0, J.jsxs)(`div`, {
          ...
          children: [
            (0, J.jsx)(`span`, {
              className: W(`w-fit rounded-full px-2 py-0.5 text-xs font-medium`, Xo(e.status)),
              children: Yo(e.status),
            }),
            (0, J.jsx)(`span`, {
              className: `text-token-description-foreground tabular-nums`,
              children: Zo(e.updatedTimestampMs),
            }),
            (0, J.jsxs)(`span`, {
              className: `min-w-0`,
              children: [
...
function Qo(e, t) {
  let n = [...e].reverse(),
    r = t.trim();
  return r.length === 0 ? n : n.filter((e) => $o(e, r));
}
function $o(e, t) {
  let n = ts(e);
  return lt(es(e), t) > 0 || lt(e.event.eventType, t) > 0 || lt(n, t) > 0;
}
function es(e) {
...
function rs() {
  let e = (0, K.c)(31),
    ...
    s = it(),
    l = s.override,
    { data: u, isLoading: f } = ke(U.REALTIME_VOICE_MODE_DEBUG_DISABLED),
    p = u === !0,
    m = i ? `Enabled` : `Disabled`,
    h;
  e[0] === m
    ? (h = e[1])
    : ((h = (0, J.jsx)(X, { label: `Statsig gate`, value: m })), (e[0] = m), (e[1] = h));
  let g = p ? `Forcing off` : `Off`,
    _;
  e[2] === g
    ? (_ = e[3])
    : ((_ = (0, J.jsx)(X, { label: `Debug override`, value: g })), (e[2] = g), (e[3] = _));
  let v = a ? `Enabled` : `Disabled`,
    y;
  e[4] === v
    ? (y = e[5])
    : ((y = (0, J.jsx)(X, { label: `Effective voice mode`, value: v })), (e[4] = v), (e[5] = y));
  let b;
  e[6] !== h || e[7] !== _ || e[8] !== y
    ? ((b = (0, J.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [h, _, y] })),
      (e[6] = h),
      (e[7] = _),
      (e[8] = y),
      (e[9] = b))
  ...
  e[11] === t
    ...
    : ((S = (e) => {
        (r(null),
          d(t, U.REALTIME_VOICE_MODE_DEBUG_DISABLED, e).catch((e) => {
  ...
  let w;
  e[17] !== l ||
  e[18] !== s.canUseLocalOverride ||
  e[19] !== s.error ||
  e[20] !== s.source ||
  e[21] !== s.statsigValue ||
  e[22] !== t
    ? ((w = s.canUseLocalOverride
        ? (0, J.jsxs)(`div`, {
            className: `flex flex-col gap-2 border-t-[0.5px] border-token-border py-2`,
            children: [
              (0, J.jsx)(X, {
                label: `Config source`,
                value: s.source === `local-override` ? `Local override` : `Statsig`,
              }),
              (0, J.jsxs)(`div`, {
                className: `flex items-center justify-between gap-3`,
                children: [
                  ...
                  (0, J.jsx)(Oe, {
                    ...
                    onChange: (e) => {
                      t.set(ot, {
                        enabled: e,
                        config:
                          e && l.config.trim().length === 0
                            ? JSON.stringify(s.statsigValue, null, 2)
                            : l.config,
                      });
                    },
                  }),
              ...
              (0, J.jsx)(`textarea`, {
                ...
                value: l.config,
                onChange: (e) => {
                  t.set(ot, { ...l, config: e.currentTarget.value });
                },
              }),
              s.error
                ? (0, J.jsx)(`div`, {
...
var is = { assignedExperimentCount: 0, enabledGateCount: 0, gateCount: 0 },
  as = { disableExposureLog: !0 };
ne(H());
var os = ue({ dynamic_configs: ce(H(), B()), feature_gates: ce(H(), B()) }),
  ss = oe([ue({ is_user_in_experiment: V() }), ue({ ue: se(!0) })]),
  cs,
  ls = new Map();
function us(e, t = ``) {
  if (!t.trim()) return [];
  let n = ys(e),
    r = new Map(
      [...hs(t), ...(n == null ? [] : _s(n))].map((e) => [`${e.kind}:${e.name}`, e]),
    ).values();
  return fs(
    Array.from(r, (t) => ms(e, t)),
    t,
  );
}
function ds(e) {
  ...
  return t == null
    ? is
    : {
        assignedExperimentCount: Object.values(t.dynamic_configs).filter(xs).length,
        enabledGateCount: Object.keys(t.feature_gates).filter((t) => e.getFeatureGate(t, as).value)
          .length,
...
function ps(e, t) {
  ...
  if (n != null) return n;
  let r = t.trim();
  return r.length > 0 && e === vs(r) ? r : e;
}
function ms(e, t) {
  switch (t.kind) {
    case `gate`: {
      let n = e.getFeatureGate(t.name, as);
      return {
        kind: `gate`,
        name: t.name,
        enabled: n.value,
    ...
    case `experiment`: {
      let n = e.getExperiment(t.name, as);
      return {
        kind: `experiment`,
        name: t.name,
...
function gs() {
  return cs === null ? ls : ((cs = null), (ls = new Map()), ls);
}
function _s(e) {
  return [
...
function ys(e) {
  ...
  let i = os.safeParse(Reflect.apply(r, n, []));
  return i.success ? i.data : null;
}
function bs(e) {
  return ss.safeParse(e).success;
}
function xs(e) {
  let t = ss.safeParse(e);
  return t.success
...
function Ss() {
  ...
  if (e[0] !== n || e[1] !== i || e[2] !== t) {
    let a = us(t, n),
      { assignedExperimentCount: g, enabledGateCount: _, gateCount: v } = ds(t),
      y = n.trim().length > 0,
      b;
    (e[13] === i
      ? (b = e[14])
    ...
    (e[22] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      (c =
        y && a.length === 0
          ...
          : y
            ? a.map((e) =>
                (0, J.jsx)(Cs, { entry: e, onSelectGate: void 0, query: n }, `${e.kind}:${e.name}`),
              )
            : null),
      (e[0] = n),
      (e[1] = i),
...
function Cs(e) {
  let t = (0, K.c)(13),
    ...
    s;
  t[0] !== n.name || t[1] !== i
    ? ((s = ps(n.name, i)), (t[0] = n.name), (t[1] = i), (t[2] = s))
    : (s = t[2]);
  let c;
  t[3] === n.kind ? (c = t[4]) : ((c = void 0), (t[3] = n.kind), (t[4] = c));
  let l;
  t[5] !== a || t[6] !== o
    ? ((l = (0, J.jsx)(ws, { label: a, tone: o })), (t[5] = a), (t[6] = o), (t[7] = l))
    : (l = t[7]);
  let u;
  return (
    t[8] !== r || t[9] !== s || t[10] !== c || t[11] !== l
      ? ((u = (0, J.jsx)(ea, { title: s, subtitle: c, status: l, onClick: r })),
        (t[8] = r),
        (t[9] = s),
        (t[10] = c),
        (t[11] = l),
...
function Ts() {
  let e = (0, K.c)(18),
    ...
    [r, i] = (0, q.useState)(!1),
    a;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: k }), (e[0] = a)) : (a = e[0]);
  let o;
  e[1] === t
    ? (o = e[2])
  ...
  e[10] !== r || e[11] !== t || e[12] !== d || e[13] !== l
    ? ((p = t
        ? l.length === 0
          ...
          : l.map((e) => (0, J.jsx)(Ds, { includeHidden: r, label: d[e] ?? e, root: e }, e))
        : null),
      (e[10] = r),
      (e[11] = t),
      (e[12] = d),
...
function Ds(e) {
  ...
  t[4] !== c || t[5] !== l
    ...
    : (u = t[6]);
  let d;
  t[7] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = () => o(Os)), (t[7] = d)) : (d = t[7]);
  let f;
  t[8] !== n || t[9] !== u
    ? ((f = (0, J.jsx)(ea, { title: u, subtitle: n, onClick: d })),
      (t[8] = n),
      (t[9] = u),
      (t[10] = f))
    : (f = t[10]);
  ...
  t[11] !== i || t[12] !== a || t[13] !== n
    ? ((p = a
        ? (0, J.jsx)(`div`, {
            className: `pb-1`,
            children: (0, J.jsx)(mt, { hostId: k, includeHidden: i, root: n }),
          })
        : null),
      (t[11] = i),
      (t[12] = a),
...
var ks = `debug-workspace-runtime`,
  As = 1e3,
  js = new Intl.RelativeTimeFormat(void 0, { numeric: `auto` });
function Ms() {
  let e = (0, K.c)(1),
    t = ge.primaryRuntime;
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, J.jsx)(Ns, { primaryRuntime: t })), (e[0] = n))
      : (n = e[0]),
    n
  );
}
function Ns(e) {
  ...
  t[2] !== l || t[3] !== m
    ? ((h = {
      ...
      (t[4] = h))
    : (h = t[4]);
  let { data: g, isLoading: _, refetch: v } = ee(h),
    y;
  t[5] !== n || t[6] !== a
    ? ((y = async (e) => {
        let { release: t } = e;
        return (await vt(a), n.runUpdateNow({ release: t }));
      }),
      (t[5] = n),
      (t[6] = a),
      (t[7] = y))
  ...
  t[8] === i
    ? (b = t[9])
    : ((b = (e) => {
        (f(Is(e)), i.invalidateQueries({ queryKey: yt }));
      }),
      (t[8] = i),
      (t[9] = b));
  let x;
  ...
  t[13] === r
    ...
    : ((T = (e) => {
        ...
        (r.set(xt, t), N.dispatchMessage(`set-primary-runtime-install-release`, { release: t }));
      }),
      (t[13] = r),
      (t[14] = T));
  let E = T,
  ...
  t[22] !== w
    ? ((D = l
        ? (0, J.jsx)(be, {
            ...
            triggerButton: (0, J.jsxs)(`button`, {
              ...
              disabled: C,
              children: [
                C ? (0, J.jsx)(fe, { className: `icon-2xs` }) : null,
                `Cron`,
                (0, J.jsx)(Le, { className: `icon-2xs opacity-70` }),
              ],
            }),
            children: (0, J.jsxs)(`div`, {
              className: `flex min-w-[220px] flex-col gap-0.5`,
              children: [
                (0, J.jsx)(G.Title, { children: `Workspace runtime cron` }),
                (0, J.jsx)(G.Item, {
                ...
                (0, J.jsx)(G.Separator, {}),
                (0, J.jsx)(G.Title, { children: `Install flow` }),
                (0, J.jsxs)(`div`, {
    ...
    : (D = t[23]);
  let O;
  t[24] !== g || t[25] !== _ || t[26] !== l || t[27] !== C || t[28] !== d
    ? ((O = l
        ? _ && g == null
          ? (0, J.jsx)(`div`, {
              className: `text-token-description-foreground`,
          ...
          : (0, J.jsxs)(`div`, {
              ...
              children: [
                ...
                g?.disabledReason == null
                  ? null
                  : (0, J.jsx)(X, { label: `Disabled`, value: Rs(g.disabledReason) }),
                (0, J.jsx)(X, { label: `Next cron`, value: Fs(g?.nextRunAt ?? null) }),
                (0, J.jsx)(X, {
                  label: `Startup check`,
...
function Fs(e) {
  ...
  if (n < 60) return `${t.toLocaleString()} (${js.format(n, `second`)})`;
  let r = Math.ceil(n / 60);
  return r < 60
    ? `${t.toLocaleString()} (${js.format(r, `minute`)})`
    : `${t.toLocaleString()} (${js.format(Math.ceil(r / 60), `hour`)})`;
}
function Is(e) {
  switch (e.status) {
    ...
    case `skipped`:
      return e.reason == null ? `Skipped` : `Skipped: ${Ls(e.reason)}`;
  }
}
function Ls(e) {
  switch (e) {
...
function Bs() {
  let e = (0, K.c)(23),
    t = o(c),
    [n, r] = (0, q.useState)(null),
    i = de(ae.autoCleanupEnabled),
    { data: a, isLoading: s } = ke(U.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED),
    l = a === !0,
    u = i && l,
    f = s,
  ...
  e[0] === p
    ? (m = e[1])
    : ((m = (0, J.jsx)(X, { label: `Worktrees setting`, value: p })), (e[0] = p), (e[1] = m));
  let h = l ? `Enabled` : `Disabled`,
    g;
  e[2] === h
    ? (g = e[3])
    : ((g = (0, J.jsx)(X, { label: `Source-build override`, value: h })), (e[2] = h), (e[3] = g));
  let _ = u ? `Enabled` : `Disabled`,
    v;
  e[4] === _
    ? (v = e[5])
    : ((v = (0, J.jsx)(X, { label: `Effective cleanup`, value: _ })), (e[4] = _), (e[5] = v));
  let y;
  e[6] !== m || e[7] !== g || e[8] !== v
  ...
  e[11] === t
    ...
    : ((x = (e) => {
        (r(null),
          d(t, U.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED, e).catch((e) => {
...
var Vs = 1e3,
  Hs = `debug-ambient-suggestion-threads`,
  Us = new Intl.RelativeTimeFormat(void 0, { numeric: `auto` }),
  Ws = M(c, `is-packaged`, { staleTime: R.FIVE_SECONDS });
function Gs(e) {
  let t = (0, K.c)(17),
    { onClose: n } = e,
    [r, i] = (0, q.useState)(qs),
  ...
  t[7] === r
    ? ((u = t[8]), (d = t[9]))
    : ((u = (e) => {
        o((t) => Qi({ ...t, x: t.x + e.x, y: t.y + e.y }, r));
      }),
      (d = (e) => {
        o((t) => $i(t, e, r));
      }),
  ...
  t[10] !== n || t[11] !== u || t[12] !== d
    ? ((f = (0, J.jsx)(Js, { onClose: n, onMove: u, onResize: d })),
      (t[10] = n),
      (t[11] = u),
      (t[12] = d),
      (t[13] = f))
...
function Js({
  ...
  let c = Ae(),
    ...
    y = g != null && a && te.allowDebugMenu(je()),
    b = h?.isPackaged === !1,
    x = e ?? null,
    S =
      typeof window < `u`
        ...
        : void 0,
    C = l.client.getContext().user?.customIDs?.stableID,
    w = async () => {
    ...
    children: [
              ...
              (0, J.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, J.jsx)(`button`, {
                    ...
                    onClick: t,
                    children: (0, J.jsx)(he, { className: `icon-xs` }),
                  }),
                ],
              }),
            ],
      ...
      (0, J.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, J.jsx)(De, {
            electron: !0,
            children: (0, J.jsx)(bo, { conversationId: x ?? void 0 }),
          }),
          x == null ? null : (0, J.jsx)(Wi, { conversationId: x }),
          u.map((e) => {
            ...
            return (0, J.jsx)(
              Y,
              {
                ...
                storageKey: t,
                variant: `selection`,
                children: (0, J.jsx)(Vi, { lines: e.lines }),
              },
              e.id,
            );
          }),
          ...
          null,
          (0, J.jsx)(Vt, {}),
          (0, J.jsxs)(De, { electron: !0, children: [(0, J.jsx)(jn, {}), null] }),
          (0, J.jsx)(da, {}),
          (0, J.jsx)(Wo, {}),
          (0, J.jsx)(Ss, {}),
          (0, J.jsx)(Zs, {}),
          ...
          (0, J.jsx)(rs, {}),
          b ? (0, J.jsx)(ta, {}) : null,
          (0, J.jsx)(Ft, { sourceThreadId: x ?? void 0 }),
          b ? (0, J.jsx)(Bs, {}) : null,
          (0, J.jsx)(na, {}),
          (0, J.jsx)(Y, {
            ...
            children: (0, J.jsxs)(`div`, {
              className: `flex flex-col py-1.5`,
              children: [
                (0, J.jsx)(X, { label: `Auth Method`, value: c.authMethod ?? `none` }),
                (0, J.jsx)(X, { label: `User ID`, value: c.userId ?? `Unavailable` }),
                (0, J.jsx)(X, { label: `Account ID`, value: c.accountId ?? `Unavailable` }),
                (0, J.jsx)(X, { label: `Email`, value: c.email ?? `Unavailable` }),
              ],
            }),
          }),
          _
            ? (0, J.jsxs)(Y, {
                ...
                children: [
                  (0, J.jsxs)(`div`, {
                    className: `flex flex-col py-1.5`,
                    children: [
                      (0, J.jsx)(X, { label: `App session ID`, value: S ?? `Unavailable` }),
                      (0, J.jsx)(X, { label: `Stable ID`, value: C ?? `Unavailable` }),
                    ],
                  }),
                  (0, J.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                p
                                  ? (0, J.jsx)(`div`, {
                                      ...
                                      children: (0, J.jsx)(fe, { className: `icon-xxs` }),
                                    })
                                  : (0, J.jsx)(be, {
                                      align: `end`,
                                      triggerButton: (0, J.jsxs)(`button`, {
...
function Zs() {
  let e = (0, K.c)(25),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((t = je()), (e[0] = t)) : (t = e[0]);
  let n = t,
    r = A(),
    [i, a] = (0, q.useState)($s),
    o = i && (n === `dev` || n === `nightly`),
  ...
  e[1] === o
    ? (s = e[2])
    : ((s = { queryConfig: { enabled: o, intervalMs: Vs } }), (e[1] = o), (e[2] = s));
  let { data: c, isLoading: l } = F(`ambient-suggestions-generation-statuses`, s),
    u;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((u = { hostId: k }), (e[3] = u)) : (u = e[3]);
  let d;
  e[4] === i
    ? (d = e[5])
  ...
  let { data: m } = F(`projectless-thread-cwd`, p),
    h;
  e[8] === r
    ? (h = e[9])
    : ((h = {
      ...
      (e[8] = r),
      (e[9] = h));
  let g = L(`ambient-suggestions-refresh`, h),
    _ = c?.statuses,
    v,
    y,
    b;
  if (
              ...
              (0, J.jsx)(
                ea,
                {
                  ...
                  rightActions: (0, J.jsx)(`button`, {
                    ...
                    onClick: () => {
                      g.mutateAsync({ hostId: k, projectRoot: le(n) }).catch((e) => {
    ...
    ((e[10] = c),
      ...
      (e[18] = y),
      (e[19] = b));
  } else ((v = e[17]), (y = e[18]), (b = e[19]));
  if (b !== Symbol.for(`react.early_return_sentinel`)) return b;
  let x = i ? `Ambient suggestion chats (${y.length})` : `Ambient suggestion chats`,
    S;
  return (
    e[22] !== v || e[23] !== x
      ? ((S = (0, J.jsx)(Y, {
...
function ec(e, t) {
  ...
  if (r > 0) {
    ...
    return t == null
      ...
      : `${r} safety check active • started ${tc(t)}${n}`;
  }
  if (i > 0) {
    let t = e?.runningStartedAtMs ?? null;
    return t == null ? `${i} active${n}` : `${i} active • started ${tc(t)}${n}`;
  }
  return e?.lastFinishedAtMs == null
    ? `No completed run yet${n}`
    : `Finished ${tc(e.lastFinishedAtMs)}${n}`;
}
function tc(e) {
  let t = Math.max(0, Math.floor((Date.now() - e) / 1e3));
  if (t < 60) return Us.format(-t, `second`);
  let n = Math.floor(t / 60);
  if (n < 60) return Us.format(-n, `minute`);
  let r = Math.floor(n / 60);
  return Us.format(-r, `hour`);
}
function nc(e) {
  try {
    return window.localStorage.getItem(e) === `open`;
