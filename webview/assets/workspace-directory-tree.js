...
import { Ba as n, Ha as r, Ra as i, Va as a } from "./app-server-manager-signals.js";
...
import { t as te } from "./use-workspace-file-search.js";
...
function ce({ filePath: e, root: t }) {
  ...
  let o = a(t).replace(/\/+$/, ``),
    s = n(r).replace(/\/+$/, ``),
    c = n(o).replace(/\/+$/, ``);
  return c.length === 0 || !s.startsWith(`${c}/`) ? null : r.slice(o.length + 1);
}
function le(e, t) {
  let n = e;
...
function ge(e) {
  ...
  n[15] !== j || n[16] !== c || n[17] !== s || n[18] !== d || n[19] !== o
    ? ((L = { expandedItems: j, hostId: c, includeHidden: s, refreshKey: d, root: o }),
      (n[15] = j),
      (n[16] = c),
      (n[17] = s),
      (n[18] = d),
  ...
  let Me = x(q),
    J;
  n[46] !== S || n[47] !== y.searchQuery || n[48] !== h || n[49] !== G || n[50] !== U
    ? ((J = (e) => {
        (U != null && h.set(S, { files: U, query: y.searchQuery }), G(e, { isPreview: !0 }));
      }),
      (n[46] = S),
      (n[47] = y.searchQuery),
      (n[48] = h),
  ...
  n[62] === ze
    ? (Be = n[63])
    : ((Be = (e) => {
        (xe(N.current, e.expandedPaths) || ((N.current = e.expandedPaths), fe(e.expandedPaths)),
          I.current !== e.selectedPath && ((I.current = e.selectedPath), ge(e.selectedPath)),
          ze(e));
      }),
      (n[62] = ze),
      (n[63] = Be));
  ...
  (n[64] !== T || n[65] !== _ || n[66] !== h
    ...
    (0, O.useEffect)(He, Ue));
  let We, Ge;
  (n[69] !== j || n[70] !== c || n[71] !== s || n[72] !== d || n[73] !== o || n[74] !== h
    ? ((We = () => {
        be(h, { expandedItems: j, hostId: c, includeHidden: s, refreshKey: d, root: o });
      }),
      (Ge = [j, c, s, d, o, h]),
      (n[69] = j),
      (n[70] = c),
  ...
  (n[77] === X
    ? ((Ke = n[78]), (qe = n[79]))
    : ((Ke = () => () => {
        (F.current != null && (window.clearTimeout(F.current), (F.current = null)), X());
      }),
      (qe = [X]),
      (n[77] = X),
      (n[78] = Ke),
...
function ve(e) {
  let n = (0, D.c)(22),
    ...
    u;
  n[0] === r ? (u = n[1]) : ((u = r == null ? null : C(r)), (n[0] = r), (n[1] = u));
  let f = u,
    p;
  n[2] === f ? (p = n[3]) : ((p = f == null ? j : L(f.map(N))), (n[2] = f), (n[3] = p));
  let m = p;
...
async function be(e, { expandedItems: t, hostId: n, includeHidden: r, refreshKey: i, root: a }) {
  await Promise.all(
    ie(t).map(async (t) => {
      await e.query
        .fetch(M, { directoryPath: t, hostId: n, includeHidden: r, refreshKey: i, root: a })
        .catch(() => void 0);
    }),
  );
}
