...
import { N as r, _ as i, a, i as o, l as s, o as c, s as l, t as u, z as d } from "./app-scope.js";
import { i as f, s as p, u as m } from "./vscode-api.js";
import { pn as h } from "./src-2.js";
import { s as g } from "./lib.js";
import { t as _ } from "./use-stable-callback.js";
import { F as v, I as ee, M as y, P as b } from "./rpc-Hf-fxjh7.js";
...
function _e(e) {
  let t = (0, E.c)(108),
    ...
    g;
  t[0] !== u || t[1] !== s || t[2] !== i
    ? ((g = { hostId: u, includeHidden: s, root: i }),
      (t[0] = u),
      (t[1] = s),
      (t[2] = i),
      (t[3] = g))
  ...
  let v = o(me, g),
    ...
    b;
  t[4] !== u || t[5] !== s || t[6] !== i
    ? ((b = { hostId: u, includeHidden: s, root: i }),
      (t[4] = u),
      (t[5] = s),
      (t[6] = i),
      (t[7] = b))
  ...
  let k = T,
    ...
    F = (0, D.useRef)(j),
    I;
  t[15] !== A || t[16] !== u || t[17] !== s || t[18] !== f || t[19] !== i
    ? ((I = { expandedItems: A, hostId: u, includeHidden: s, refreshKey: f, root: i }),
      (t[15] = A),
      (t[16] = u),
      (t[17] = s),
      (t[18] = f),
      ...
      (t[20] = I))
    : (I = t[20]);
  let { error: Ce, files: we, isEmpty: Te, isLoading: Ee } = a(ge, I),
    L;
  ...
  let Oe = _(R),
    z;
  t[26] !== Oe || t[27] !== u || t[28] !== y.searchQuery || t[29] !== De
    ? ((z = { hostId: u, onFiles: Oe, query: y.searchQuery, roots: De }),
      (t[26] = Oe),
      (t[27] = u),
      (t[28] = y.searchQuery),
      (t[29] = De),
  ...
  (t[64] !== w || t[65] !== v || t[66] !== m
    ...
    (0, D.useEffect)(He, Ue));
  let We, Ge;
  (t[69] !== A || t[70] !== u || t[71] !== s || t[72] !== f || t[73] !== i || t[74] !== m
    ? ((We = () => {
        xe(m, { expandedItems: A, hostId: u, includeHidden: s, refreshKey: f, root: i });
      }),
      (Ge = [A, u, s, f, i, m]),
      (t[69] = A),
      (t[70] = u),
