...
import { f as p, u as m } from "./vscode-api.js";
import { i as h } from "./react.js";
import { O as g, lt as _ } from "./src-4.js";
import {
  As as v,
  D as y,
  Eo as b,
...
import { o as j, r as ee } from "./lib-1.js";
import { Or as te, kr as M, o as ne } from "./persisted-signal.js";
import { t as N } from "./button.js";
import { a as P } from "./setting-storage.js";
import { f as re, o as F } from "./statsig-DoZ-0xit.js";
import { t as ie } from "./request.js";
import { t as I } from "./route-scope.js";
import { g as ae, h as oe } from "./diff-view-mode.js";
import { n as se } from "./app-shell-tab-controller.js";
import { n as ce } from "./local-conversation-title-signals.js";
import { N as le } from "./review-navigation-model.js";
import { i as ue } from "./thread-context.js";
...
import { a as z, d as be, i as xe, l as Se, n as Ce, r as we } from "./dialog-layout.js";
import { j as Te } from "./app-server-dynamic-tools.js";
import { t as Ee } from "./sortBy.js";
var De = l(d, ({ get: e }) => ({
    enabled: e(re, `637432221`),
    queryKey: [`appgen`, `access`],
    queryFn: () => ie.safeGet(`/wham/sites/access`),
    retry: !1,
    staleTime: m.TEN_MINUTES,
  })),
  Oe = a(d, ({ get: e }) => {
    if (!e(re, `637432221`)) return `unavailable`;
    let { data: t, isError: n } = e(De);
      ...
      case `thread_switch_completed`: {
        ...
        ((this.pendingThreadSwitch = null),
          ne(e, te, {
            ...
            switchKind: je(t.defaults.needsResume ? `cold` : `hot`),
...
function je(e) {
  switch (e) {
    case `hot`:
      return M.CODEX_THREAD_SWITCH_KIND_HOT;
    case `cold`:
      return M.CODEX_THREAD_SWITCH_KIND_COLD;
  }
}
var B = e(t()),
  V = n(),
...
function Pe({ isPinned: e, onPinnedChange: t }) {
  return {
...
function Fe({ isPinned: e, hasUnreadTurn: t, ariaLabel: n, onPin: r, onUnpin: i }) {
  if (t)
    return {
      rest: null,
...
function Le(e) {
  ...
  t[12] === d
    ? (g = t[13])
    : ((g = (0, V.jsx)(be, { className: `sr-only`, children: d })), (t[12] = d), (t[13] = g));
  let _;
  t[14] !== p || t[15] !== d
    ? ((_ = (0, V.jsx)(z, { children: (0, V.jsx)(xe, { title: d, subtitle: p }) })),
      (t[14] = p),
      (t[15] = d),
      (t[16] = _))
    : (_ = t[16]);
  ...
  t[20] === v
    ? (b = t[21])
    : ((b = (0, V.jsx)(N, { color: `ghost`, type: `button`, onClick: v, children: y })),
      (t[20] = v),
      (t[21] = b));
  let x;
  t[22] === s
  ...
  let S;
  t[24] !== b || t[25] !== x
    ? ((S = (0, V.jsx)(z, { children: (0, V.jsxs)(we, { children: [b, x] }) })),
      (t[24] = b),
      (t[25] = x),
      (t[26] = S))
    : (S = t[26]);
  ...
  t[27] !== S || t[28] !== h || t[29] !== g || t[30] !== _
    ? ((C = (0, V.jsxs)(Ce, { as: `form`, onSubmit: h, children: [g, _, S] })),
      (t[27] = S),
      (t[28] = h),
      (t[29] = g),
      (t[30] = _),
...
function ze(e) {
  let t = (0, H.c)(6),
    { conversationId: n } = e,
    r = F(`459748632`) && n != null,
    i;
  t[0] !== r || t[1] !== n
    ? ((i = () => {
        !r || n == null || p.dispatchMessage(`open-in-new-window`, { path: _(n) });
      }),
      (t[0] = r),
      (t[1] = n),
      (t[2] = i))
...
var Ve = a(d, ({ get: e }) => {
  ...
  for (let n of e(k))
    for (let r of e(D, n))
      t.push({ cwd: e(O, r), hostId: n, id: r, title: e(ce, r), turns: e(A, r) ?? [] });
  return t;
});
function He(e) {
  let t = [];
...
function Ge(e, t, n = Date.now()) {
  ...
  if (e.osPid != null) {
    let n = J(e.osPid, t);
    if (n != null && Ze(Y(e.command), n.command)) return n;
  }
  let r = Je(e.processId);
  if (r != null) {
    ...
    let i = Xe(e, Ke(r, t), n);
    if (i != null) return J(i.pid, t);
  }
  let i = Xe(e, t, n);
  return i == null ? null : J(i.pid, t);
}
function Ke(e, t) {
  let n = new Map(t.map((e) => [e.pid, e]));
  return t.filter((t) => Ye(t.pid, e, n));
}
function qe(e, t, n) {
...
function nt(e) {
  return e == null ? [] : He([e]).filter((e) => e.source === `restored-process`);
}
var rt = e(Ee(), 1),
  it = f([]);
function at(e) {
...
function dt(e) {
  ...
  return (
    t[0] !== o || t[1] !== s || t[2] !== a || t[3] !== i || t[4] !== l
      ? ((u = () =>
          le(l, { conversationSource: o, diffSource: s }, { orchestrationId: i, isDefault: a })),
        (d = [o, s, a, i, l]),
        (t[0] = o),
        (t[1] = s),
        (t[2] = a),
...
var pt = a(I, ({ get: e, scope: t }) => (t.value.routeKind === `local-thread` ? e(ue) : null));
function mt(e) {
  let t = (0, H.c)(7),
    n;
    ...
    t[2] !== l || t[3] !== d || t[4] !== a
      ? ((f = () => {
          if (!(l == null || d == null))
            return (
              E(a, l, d),
              v(`set-active-conversation`, { hostId: d, conversationId: l, active: !0 }),
              () => {
                (E(a, l, null),
                  v(`set-active-conversation`, { hostId: d, conversationId: l, active: !1 }));
              }
            );
        }),
        (p = [l, d, a]),
...
var gt = s(d, (e, { get: t }) => t(w, e)?.type ?? null),
  _t = s(d, (e, { get: t }) =>
    ht({
      hasConversation: t(S, e),
      hostId: t(y, e),
      latestTurnId: t(x, e),
...
function xt(e) {
  let t = (0, H.c)(30),
    { output: n } = e,
    r = ye(ve()),
    i = P(g.lightChromeTheme),
    a = P(g.darkChromeTheme),
    o = P(g.codeFontSize),
    s,
    c,
    l,
  ...
  if (t[0] !== o || t[1] !== a || t[2] !== i || t[3] !== r) {
    s = r === `light` ? ae(i, `light`) : ae(a, `dark`);
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (b = t[12]);
  let x;
  (t[13] !== s || t[14] !== r ? ((x = [s, r]), (t[13] = s), (t[14] = r), (t[15] = x)) : (x = t[15]),
    (0, B.useEffect)(b, x));
  let S, C;
    ...
    t[29] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((k = (0, V.jsx)(`div`, {
          ...
          children: (0, V.jsx)(`div`, {
            ...
            children: (0, V.jsx)(`div`, { className: `h-full w-full overflow-hidden`, ref: p }),
          }),
        })),
        (t[29] = k))
      : (k = t[29]),
...
function St(e, t) {
  t && (e.preventDefault?.(), p.dispatchMessage(`open-in-browser`, { url: t }));
}
function Ct(e) {
  let t = (0, H.c)(5),
...
function wt(e) {
  ...
  return (
    t[0] === e
      ? ((n = t[1]), (r = t[2]))
      : ((n = (t) => b.subscribeToSessionSnapshot(e, t)),
        (r = () => b.getSnapshot(e)),
        (t[0] = e),
        (t[1] = n),
        (t[2] = r)),
...
function Dt({ scope: e, backgroundTerminal: t, conversationId: n, fallbackTitle: r }) {
  se.openTab(e, Ct, {
    icon: (0, V.jsx)(de, { className: `icon-xs shrink-0` }),
...
var Z = o(d, () => new Map());
function Ot(e, t, n) {
  e.set(Z, jt(e.get(Z), t, n));
}
function kt(e, t) {
  e.set(Z, Mt(e.get(Z), t));
}
function At(e) {
  e.set(Z, Nt(e.get(Z)));
}
...
function It(e, t, n) {
  ...
  for (let a of e) {
    ...
    (o != null && o < Pt) || i.has(e.pid) || (i.add(e.pid), r.push({ metrics: e, process: a }));
  }
  return r;
}
function Lt(e, t) {
  ...
  for (let i of t.values())
    Wt(e, i.row) || r.push({ row: i.row, rowIndex: i.rowIndex ?? n.length });
...
function Rt(e, t, n) {
  ...
  let r = new Map(e.map((e) => [e.process.id, e])),
    i = new Map();
  for (let [a, o] of t) Vt(o, r.get(a) ?? Ut(e, o.row), n) || i.set(a, o);
  return i;
}
function zt(e, t) {
  return Bt(e, t)?.sortRow ?? e;
}
function Bt(e, t) {
  let n = t.get(e.process.id);
  if (n != null) return n;
  for (let n of t.values()) if (q(e.process, n.row.process)) return n;
}
function Q(e, t) {
...
function Ht(e, t, n) {
  ...
  return r == null || i == null ? !0 : n - i * 1e3 >= r - Ft;
}
function Ut(e, t) {
  return e.find((e) => q(e.process, t.process)) ?? null;
}
function Wt(e, t) {
  return Ut(e, t) != null;
}
var Gt = o(d, () => null),
  $ = 0;
function Kt(e, t) {
  (($ += 1), e.set(Gt, { processId: t, requestId: $ }));
}
export {
  ze as A,
  ke as B,
