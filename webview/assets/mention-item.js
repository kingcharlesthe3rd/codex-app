import { Ur as e } from "./src-2.js";
import { i as t } from "./lib.js";
import { u as n } from "./format-skill-title.js";
...
function x({ projectId: e, title: t }) {
  return n(t, b(e));
}
function S({ resourceUri: e, server: t }) {
...
function P(e) {
  return C(e) ? `app` : D(e) ? `plugin` : `skill`;
}
function F({ href: e, label: t }) {
  return w(e) || T(e)
    ? `agent`
    : D(e)
      ? `plugin`
...
function z(e, t = G()) {
  ...
  return (
      ...
      : n === `computer-use` && ((r = t.computerUse), (i = r)),
    {
      ...
      description: e.description ?? ``,
      iconSmall: B(e),
      brandColor: K(e.plugin.interface),
    }
  );
}
function B(e) {
...
function V(e) {
  return { kind: `skill`, ...L(e) };
}
function H(e) {
  return { kind: `app`, ...R(e) };
}
function U(e, t) {
  return { kind: `plugin`, ...z(e, t) };
}
function W(e) {
  return { browserUse: e.formatMessage(i.label), computerUse: e.formatMessage(m.computerUse) };
}
function G() {
  return { browserUse: i.label.defaultMessage, computerUse: m.computerUse.defaultMessage };
}
function K(e) {
  let t = e?.brandColor;
  if (!(t == null || t.length === 0)) return t;
}
function q({ conversationId: e, displayName: t }) {
  let n = Y(t);
  return { kind: `agent`, name: n.toLowerCase(), displayName: n, conversationId: e, path: _(e) };
}
function J(e) {
  return { kind: `agent`, name: e.roleName, displayName: e.roleName, path: v(e.roleName) };
}
function Y(e) {
  let t = e.trim();
