import { ai as e } from "./src-3.js";
import { i as t } from "./lib-1.js";
import { m as n } from "./parse-directives.js";
import { r } from "./skill-utils.js";
var i = t({
  label: {
...
function S(e) {
  return `${f}${encodeURIComponent(e.trim())}`;
}
function C({ projectId: e, title: t }) {
  return n(t, S(e));
}
function w({ resourceUri: e, server: t }) {
  return `${u}${encodeURIComponent(t)}/${encodeURIComponent(e)}`;
}
function T(e) {
...
function L(e) {
  return T(e) ? `app` : k(e) ? `plugin` : `skill`;
}
function R({ href: e, label: t }) {
  return E(e) || D(e) || F(e) != null
    ? `agent`
    : k(e)
      ? `plugin`
      : A(e) == null
...
function H(e, t = J()) {
  ...
  return (
      ...
      : n === `computer-use` && ((r = t.computerUse), (i = r)),
    {
      ...
      description: e.description ?? ``,
      iconSmall: U(e),
      brandColor: Y(e.plugin.interface),
    }
  );
}
function U(e) {
...
function W(e) {
  return { kind: `skill`, ...B(e) };
}
function G(e) {
  return { kind: `app`, ...V(e) };
}
function K(e, t) {
  return { kind: `plugin`, ...H(e, t) };
}
function q(e) {
  return { browserUse: e.formatMessage(i.label), computerUse: e.formatMessage(h.computerUse) };
}
function J() {
  return { browserUse: i.label.defaultMessage, computerUse: h.computerUse.defaultMessage };
}
function Y(e) {
  let t = e?.brandColor;
  if (!(t == null || t.length === 0)) return t;
}
function X({ conversationId: e, displayName: t }) {
  let n = Q(t);
  return { kind: `agent`, name: n.toLowerCase(), displayName: n, conversationId: e, path: v(e) };
}
function Z(e) {
  return { kind: `agent`, name: e.roleName, displayName: e.roleName, path: y(e.roleName) };
}
function Q(e) {
  let t = e.trim();
