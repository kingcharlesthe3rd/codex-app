...
import { i as Tr, r as Er } from "./ambient-suggestions-connected-apps-consent.js";
import {
  h as Dr,
  m as Or,
  n as kr,
...
import { n as Br, t as Vr } from "./animated-icon.js";
function Hr(e, t) {
...
var Ur,
  ...
  ii = e(() => {
    (F(),
      ...
      (Kr = [`coding`, `non_coding`]),
      (qr = [`claude-code`, `claude-cowork`]),
      (Jr = y({
        state: y({
          roles: p(gt(Gr)),
          personalizedSuggestionsEnabled: ce(),
          workMode: gt(Kr).nullable(),
        }),
        options: y({ focusComposer: ce().optional(), prefillPrompt: Dt().optional() }).optional(),
      })),
      (q = {
        Start: `start`,
      ...
      (Yr = y({ step: ie(q.TeenWelcome) })),
      (Xr = y({ step: ie(q.TeenInterests), interests: p(gt(Ur)) })),
      (Zr = y({ step: ie(q.TeenPrompts), completion: Jr })),
      (Qr = y({ step: ie(q.WindowsSandboxSetup) })),
      ($r = y({
        step: ie(q.ConversationalOnboarding),
        roles: p(gt(Gr)),
        personalizedSuggestionsEnabled: ce(),
        workMode: gt(Kr).nullable(),
      })),
      (ei = y({
        step: ie(q.RoleSelection),
        roles: p(gt(Gr)),
        personalizedSuggestionsEnabled: ce(),
        workMode: gt(Kr).nullable(),
      })),
      (ti = y({
        step: ie(q.AgentMigrationSourceSelection),
        providerIds: p(gt(qr)),
        skipped: ce().optional(),
      })),
      (ni = y({ step: ie(q.AgentMigrationItemSelection), action: gt([`imported`, `skipped`]) })),
      (ri = o(`step`, [Yr, Xr, Zr, Qr, $r, ei, ti, ni])));
  }),
  ai,
  oi,
  si,
  ...
  ui = e(() => {
    (C(),
      f(),
      ii(),
      (ai = oe(`OnboardingScope`, { parent: _ })),
      (oi = le(ai, () => q.Start)),
      (si = le(ai, () => null)),
      (ci = le(ai, () => null)),
      (li = le(ai, () => null)));
      ...
      ? ((_ = () => {
          ...
          if (
            (re(t, T, {
              ...
              personalizedSuggestionsEnabled: e?.state.personalizedSuggestionsEnabled,
            }),
            e == null)
          )
            return;
          let { state: l, options: _ } = e,
            v = l.personalizedSuggestionsEnabled ?? !0,
            y = mi(l.workMode);
          (n(l),
            xt(t, Je.conversationDetailMode, y.threadDetailLevel)
              .catch(pi)
              .finally(() => {
                let e = a === `welcome`;
                (o(`auto`),
                  ...
                  r(`/?${xr}=1`, {
                    replace: !0,
                    state:
                      _?.focusComposer !== !0 && _?.prefillPrompt == null
                        ? void 0
                        : { focusComposerNonce: Date.now(), prefillPrompt: _.prefillPrompt },
                  }));
              }),
            y.fontSizes != null &&
              (xt(t, ft.sansFontSize, y.fontSizes.sans), xt(t, ft.codeFontSize, y.fontSizes.code)),
            t.set(Xn, y.composerPermissionModeVisibility),
            v && t.set(Er, !0),
            (async () => {
              (await xt(t, wt.enabled, v),
                v &&
                  (await g(`ambient-suggestions-refresh`, {
                    params: { domain: null, hostId: O, projectRoot: k(`~`) },
                  }),
                  await Promise.all([
                    i.invalidateQueries({ queryKey: d(`ambient-suggestions`) }),
                    i.invalidateQueries({ queryKey: d(`ambient-suggestions-refresh`) }),
                  ])));
            })().catch(fi));
        }),
        (e[0] = r),
...
function fi(e) {
  x.error(`Failed to refresh ambient suggestions after onboarding`, {
    safe: {},
    sensitive: { error: e },
  });
}
function pi(e) {
  x.error(`Failed to persist welcome v2 onboarding configuration`, {
    safe: {},
    sensitive: { error: e },
  });
}
function mi(e) {
  return e === `non_coding`
    ? {
        threadDetailLevel: it,
        fontSizes: { sans: gi, code: _i },
        composerPermissionModeVisibility: { "guardian-approvals": !0, "full-access": !1 },
      }
    : {
        threadDetailLevel: ee,
        fontSizes: null,
        composerPermissionModeVisibility: { "guardian-approvals": !0, "full-access": !0 },
      };
}
var hi,
  gi,
...
function yi(e) {
  let t = (0, bi.c)(15),
    {
      finalStep: n,
      hasPreviouslyCompletedOnboarding: r,
      isAdvancingOnboarding: i,
      onboardingOverride: a,
      postLoginWelcomePending: o,
    } = e,
    s = ze(),
    c = Le(),
    { client: l, isLoading: u } = Et(),
    d;
  t[0] === l ? (d = t[1]) : ((d = P(l, `2744470156`)), (t[0] = l), (t[1] = d));
  let f = d,
    p = s.authMethod === `chatgpt`,
    m;
  t[2] === p ? (m = t[3]) : ((m = { enabled: p }), (t[2] = p), (t[3] = m));
  let { isLoading: h, shouldUseTeenOnboarding: g } = _r(m),
    _ = h || i || u || n.isLoading || (a !== `welcome` && !o && r == null),
    v = a === `welcome` || o || r === !1,
    y = f,
    b;
  t[4] === n.shouldShow
    ? (b = t[5])
    : ((b = { shouldShow: n.shouldShow }), (t[4] = n.shouldShow), (t[5] = b));
  let x;
  t[6] === c
    ? (x = t[7])
    : ((x = { isSupported: !0, shouldShow: async () => Dn({ queryClient: c }) }),
      (t[6] = c),
      (t[7] = x));
  let S;
  return (
    t[8] !== g || t[9] !== _ || t[10] !== v || t[11] !== y || t[12] !== b || t[13] !== x
      ? ((S = {
          isLoading: _,
          shouldShowStandardOnboarding: v,
          shouldShowConversationalOnboarding: y,
          shouldShowTeenOnboarding: g,
          finalStep: b,
          agentMigration: x,
        }),
        (t[8] = g),
...
async function Si(
  e,
  { completeOnboarding: t, logEntered: n, logStepViewed: r, onboardingContext: i, result: a },
) {
  let o = e.get(oi);
  if (o === q.Complete) return;
  let s = a == null ? void 0 : ri.parse(a);
  s != null && ki(e, s);
  let c = await Ci({ currentStep: o, onboardingContext: i, result: s });
  e.get(oi) === o && (c !== o && (o === q.Start && n(), Oi(e, c, r)), c === q.Complete && t());
}
async function Ci({ currentStep: e, onboardingContext: t, result: n }) {
  if (t.isLoading) return e;
  switch (e) {
    case q.Start:
      return t.shouldShowStandardOnboarding ? wi(t) : Di(t);
    case q.WindowsSandboxSetup:
      return q.Complete;
    case q.TeenWelcome:
      return q.TeenInterests;
    case q.TeenInterests:
      return q.TeenPrompts;
    case q.TeenPrompts:
      return Di(t);
    case q.ConversationalOnboarding:
    case q.RoleSelection:
      return Ti(t, n);
    case q.AgentMigrationSourceSelection:
    case q.AgentMigrationItemSelection:
      return Ei({ currentStep: e, onboardingContext: t, result: n });
    case q.Complete:
      return q.Complete;
  }
}
function wi(e) {
  return e.shouldShowTeenOnboarding
    ...
    : e.shouldShowConversationalOnboarding
      ? q.ConversationalOnboarding
      : q.RoleSelection;
}
async function Ti(e, t) {
  return (t?.step === q.ConversationalOnboarding || t?.step === q.RoleSelection) &&
    t.workMode === `non_coding`
    ? Di(e)
    : (await e.agentMigration.shouldShow())
      ? q.AgentMigrationSourceSelection
      : Di(e);
}
function Ei({ currentStep: e, onboardingContext: t, result: n }) {
  switch (e) {
    case q.AgentMigrationSourceSelection:
      return n?.step === q.AgentMigrationSourceSelection &&
        n.skipped !== !0 &&
        n.providerIds.length > 0
        ? q.AgentMigrationItemSelection
        : Di(t);
    case q.AgentMigrationItemSelection:
      return Di(t);
  }
...
function Di(e) {
  return e.finalStep.shouldShow ? q.WindowsSandboxSetup : q.Complete;
}
function Oi(e, t, n) {
  e.set(oi, t);
  let r = Ai[t];
...
function ki(e, t) {
  switch ((x.debug(`[onboarding-flow] store result`, { safe: { resultStep: t.step } }), t.step)) {
    case q.TeenWelcome:
      return;
    case q.TeenInterests:
      e.set(ci, t);
...
var Ai,
  ji = e(() => {
    (be(),
      ...
      (Ai = {
        [q.Start]: null,
        [q.TeenWelcome]: `teen_welcome`,
        [q.TeenInterests]: `teen_interests`,
        [q.TeenPrompts]: `teen_prompts`,
        [q.WindowsSandboxSetup]: null,
        [q.ConversationalOnboarding]: null,
        [q.RoleSelection]: `role_selection`,
        [q.AgentMigrationSourceSelection]: `agent_migration_source_selection`,
        [q.AgentMigrationItemSelection]: `agent_migration_item_selection`,
        [q.Complete]: null,
      }));
  });
async function Mi({
...
function Pi(e) {
  ...
  return (
    t[7] === c
      ? (l = t[8])
      : ((l = (0, Ii.jsx)(Ii.Fragment, { children: c })), (t[7] = c), (t[8] = l)),
    l
  );
}
var Fi,
...
function Ri(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = { status: `idle` }), (t[0] = s))
    : (s = t[0]);
  let [c, u] = (0, Vi.useState)(s),
    d;
  t[1] === n.isSupported
    ? (d = t[2])
    : ((d = { enabled: n.isSupported }), (t[1] = n.isSupported), (t[2] = d));
  let f = Fn(d),
    p;
  t[3] !== f || t[4] !== r
    ? ((p = f.getSummaryForProviders(r)), (t[3] = f), (t[4] = r), (t[5] = p))
    : (p = t[5]);
  let m = p,
    h;
  t[6] !== a || t[7] !== o?.arm
    ? ((h = (e) => {
        re(a, j, { ...e, experimentArm: o?.arm });
      }),
      (t[6] = a),
      (t[7] = o?.arm),
      (t[8] = h))
  ...
  let v;
  t[9] !== f || t[10] !== c || t[11] !== i || t[12] !== r || t[13] !== a
    ? ((v = (e) => {
        let { result: t, skipped: n } = e;
        if (n === !0 || t == null) {
          i({ step: q.AgentMigrationItemSelection, action: `skipped` });
          return;
        }
        Mi({
          importSelection: () => f.importSelection(t, r),
          importStatus: c,
          onComplete: () => {
            i({ step: q.AgentMigrationItemSelection, action: `imported` });
          },
          onImportStarted: zi,
          scope: a,
          setImportStatus: u,
  ...
  t[20] !== m
    ? ((y = (e) => {
        ...
        return (0, Hi.jsx)(Kn, {
          ...
          isPending: f.isImporting || c.status === `importing`,
          logShownOnMount: !1,
...
function Wi(e) {
  ...
  return (
    t[2] !== a || t[3] !== r
      ? ((o = (0, Ji.jsx)(Gi, { agentMigration: a, onContinue: r, summary: a.summary })),
        (t[2] = a),
        (t[3] = r),
        (t[4] = o))
      : (o = t[4]),
...
function Gi(e) {
  ...
  let u = c,
    d;
  t[3] !== n.providerIds || t[4] !== u || t[5] !== i
    ? ((d = (e) => {
        u({ source: `first_time_onboarding`, action: e, ...Pn(i, Gn(i), n.providerIds) });
      }),
      (t[3] = n.providerIds),
      (t[4] = u),
      (t[5] = i),
  ...
  t[9] === m
    ...
    : ((h = () => {
      ...
      (t[10] = h));
  let g;
  (t[11] === i ? (g = t[12]) : ((g = [i]), (t[11] = i), (t[12] = g)), (0, qi.useEffect)(h, g));
  let v;
  t[13] === r
    ? (v = t[14])
    : ((v = (e) => {
        ...
        return (0, Ji.jsx)(jn, {
          ...
          onContinue: (e) => {
            ...
            (r && f(`skipped`),
              t({
                result: {
                  step: q.AgentMigrationSourceSelection,
                  providerIds: e,
                  ...(r ? { skipped: !0 } : {}),
                },
                skipped: r,
          ...
          onSkip: () => {
            (f(`skipped`),
              t({
                result: { step: q.AgentMigrationSourceSelection, providerIds: [], skipped: !0 },
                skipped: !0,
              }));
          },
        });
...
function Xi(e) {
  ...
  t[1] === l
    ? (u = t[2])
    : ((u = G(`relative flex items-center justify-center gap-2`, l)), (t[1] = l), (t[2] = u));
  let d;
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Qi.jsx)(or, { className: `size-4`, "aria-hidden": `true` })), (t[15] = h))
    : (h = t[15]);
  let g;
  t[16] === m
    ? (g = t[17])
  ...
  return (
    t[21] !== _ || t[22] !== u || t[23] !== d
      ? ((y = (0, Qi.jsxs)(`div`, { className: u, children: [d, _] })),
        (t[21] = _),
        (t[22] = u),
        (t[23] = d),
        (t[24] = y))
...
var Zi,
  Qi,
  $i = e(() => {
    ((Zi = U()), We(), D(), N(), lr(), Jn(), tt(), Ne(), ar(), (Qi = K()));
  });
function ea(e) {
  let t = (0, ta.c)(10),
    {
...
function ia(e) {
  let t = (0, oa.c)(31),
    { otherRoleDescription: n, selectedRole: r, onOtherRoleDescriptionChange: i, onSelect: a } = e,
    o = M(),
    s;
  t[0] === o
    ? (s = t[1])
  ...
  let u;
  t[3] !== a || t[4] !== r
    ? ((u = ca.map((e) => (0, sa.jsx)(aa, { checked: r === e, role: e, onSelect: () => a(e) }, e))),
      (t[3] = a),
      (t[4] = r),
      (t[5] = u))
    : (u = t[5]);
  ...
  t[6] === u
    ? (d = t[7])
    : ((d = (0, sa.jsx)(`div`, {
        className: `grid grid-cols-3 gap-x-1.5 gap-y-1 p-2`,
        children: u,
      })),
      (t[6] = u),
      (t[7] = d));
  let f;
  t[8] === a ? (f = t[9]) : ((f = () => a(`something_else`)), (t[8] = a), (t[9] = f));
  let p = r === `something_else`,
    m;
  t[10] === a ? (m = t[11]) : ((m = () => a(`something_else`)), (t[10] = a), (t[11] = m));
  let h;
  t[12] !== c || t[13] !== p || t[14] !== m
    ? ((h = (0, sa.jsx)(`input`, {
        "aria-label": c,
        checked: p,
        className: `sr-only`,
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, sa.jsx)(Ze, { "aria-hidden": !0, className: `size-[18px] shrink-0` })), (t[16] = g))
    : (g = t[16]);
  let _;
  t[17] !== i || t[18] !== a
    ? ((_ = (e) => {
        (a(`something_else`), i(e.currentTarget.value));
      }),
      (t[17] = i),
      (t[18] = a),
      (t[19] = _))
  ...
  return (
    t[28] !== b || t[29] !== d
      ? ((x = (0, sa.jsxs)(`fieldset`, {
          className: `w-full overflow-hidden rounded-2xl border border-token-border bg-token-main-surface-primary text-lg leading-6 shadow-[0_2px_6px_-1px_rgba(0,0,0,0.03)]`,
          children: [l, d, b],
        })),
        (t[28] = b),
        (t[29] = d),
...
function aa(e) {
  ...
  t[4] === o
    ? (s = t[5])
    : ((s = G(`flex size-[18px] shrink-0 items-center justify-center rounded-full border`, o)),
      (t[4] = o),
      (t[5] = s));
  let c;
  t[6] === n
  ...
  let l;
  t[8] !== s || t[9] !== c
    ? ((l = (0, sa.jsx)(`span`, { className: s, children: c })),
      (t[8] = s),
      (t[9] = c),
      (t[10] = l))
    : (l = t[10]);
  ...
  t[11] === u
    ? (d = t[12])
    : ((d = (0, sa.jsx)(`span`, { className: `truncate`, children: (0, sa.jsx)(v, { ...u }) })),
      (t[11] = u),
      (t[12] = d));
  let f;
  return (
...
var oa,
  ...
  la = e(() => {
    ((oa = U()),
      ...
      Pr(),
      (sa = K()),
      (ca = Nr.filter((e) => e !== `something_else`)));
  });
function ua(e) {
  let t = (0, da.c)(9),
    { taskIds: n, taskPlugins: r, onSelect: i } = e,
    a;
      ...
      ? ((e = (e) =>
          (0, fa.jsxs)(
            `button`,
            {
              ...
              children: [
                (0, fa.jsx)(mn, {
                  appPlugin: r?.get(e) ?? null,
                  className: `size-6 shrink-0 object-contain`,
                  task: e,
                }),
                (0, fa.jsx)(`span`, { children: (0, fa.jsx)(v, { ...pn(e).label }) }),
              ],
            },
            e,
          )),
  ...
  return (
    t[7] === a
      ? (o = t[8])
      : ((o = (0, fa.jsx)(`div`, {
          className: `grid w-full auto-cols-fr grid-flow-col gap-3 text-lg leading-6`,
          children: a,
        })),
        (t[7] = a),
        (t[8] = o)),
...
function ma(e) {
  let t = (0, xa.c)(134),
    {
      ...
      isTaskReady: a,
      otherRoleDescription: o,
      roleSelection: s,
      selectedTaskContent: c,
      showInitialThinking: l,
      showSelectedTaskThinking: d,
      showTaskIntroThinking: f,
      taskIds: p,
      taskPlugins: m,
      userFirstName: h,
      workflow: g,
      onContinueRole: _,
      onGetStarted: y,
      onInitialThinkingComplete: b,
      onOtherRoleDescriptionChange: x,
      onRoleSelectionChange: S,
      onSelectTask: C,
      onSelectedTaskThinkingComplete: T,
      onSkip: E,
      onTaskIntroThinkingComplete: D,
    } = e,
    [O, k] = (0, Sa.useState)(!1),
    [A, ee] = (0, Sa.useState)(!1),
    [j, te] = (0, Sa.useState)(!1),
    [ne, re] = (0, Sa.useState)(!1),
    [N, ie] = (0, Sa.useState)(!0),
    [ae, P] = (0, Sa.useState)(Ta),
    oe;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (e) => {
        let t = va(e);
        P((e) =>
          e.hasContentBelow === t.hasContentBelow &&
          e.hasContentUnderTitleBar === t.hasContentUnderTitleBar
            ? e
            : t,
        );
      }),
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ue = (e, t) => {
        t.parentElement != null && se(t.parentElement);
      }),
      (t[2] = ue))
    : (ue = t[2]);
  let de = z(ue),
  ...
  if (
    ...
    let e = o.trim(),
      n = null;
    g.selectedRole === `something_else`
      ? (n = e.length > 1 ? e : F.formatMessage(Fr[g.selectedRole]))
      : g.selectedRole != null && (n = F.formatMessage(Fr[g.selectedRole]));
    let r =
        g.selectedRole === `something_else` || g.selectedRole === `people_hr`
          ? n
          : n?.toLocaleLowerCase(),
      a,
      u;
    t[45] !== F || t[46] !== g.selectedTask
      ? ((a = g.selectedTask == null ? null : pn(g.selectedTask)),
        (u = a == null ? null : F.formatMessage(a.label)),
        (t[45] = F),
        (t[46] = g.selectedTask),
        (t[47] = a),
        (t[48] = u))
      : ((a = t[47]), (u = t[48]));
    let _ = u,
      y = a?.SelectionAttachment ?? null,
      w;
    t[49] === g.declinedTasks
      ? (w = t[50])
      : ((w = g.declinedTasks ?? []), (t[49] = g.declinedTasks), (t[50] = w));
    let E = w,
      O;
    t[51] !== F || t[52] !== h
      ? ((O =
    ...
    let ce = oe,
      ue = `${k} ${N}\n\n${P}`,
      { hasContentBelow: pe, hasContentUnderTitleBar: he } = ae;
    me = pe;
    let R = l && !A,
      z = he ? Ma : ja;
    ((ge = !R && !l && (g.phase !== `role` || j)),
      (_e = !R && !l && g.phase === `role` && j),
      (ye = `relative flex h-full min-h-0 w-full flex-col bg-token-main-surface-primary tracking-normal text-token-text-primary select-text [--codex-chat-font-size:16px]`));
    let De = he
    ...
    (t[60] === De
      ? (B = t[61])
      : ((B = G(`pointer-events-none absolute inset-x-0 top-0 z-20 h-12 border-b-[0.5px]`, De)),
        (t[60] = De),
        (t[61] = B)),
      t[62] === B
        ? (be = t[63])
        : ((be = (0, J.jsx)(`div`, { className: B })), (t[62] = B), (t[63] = be)));
    let Oe;
    t[64] === R
      ? (Oe = t[65])
      : ((Oe = R ? { height: Da, top: `50%`, width: Da, x: `-50%`, y: `-50%` } : !1),
        (t[64] = R),
        (t[65] = Oe));
    let V;
    t[66] !== he || t[67] !== i || t[68] !== R || t[69] !== z
      ? ((V =
          R && !i
            ? { height: Da, top: `50%`, width: Da, x: `-50%`, y: `-50%` }
            : { height: z, top: he ? `0.875rem` : `1.5rem`, width: z, x: `-50%`, y: 0 }),
        (t[66] = he),
        (t[67] = i),
        (t[68] = R),
        (t[69] = z),
    ...
    t[71] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (Ae = t[71]);
    let je;
    t[72] !== i || t[73] !== fe || t[74] !== R
      ? ((je = fe ? { duration: 0 } : { ...Aa, delay: R && i ? Ea : 0 }),
        (t[72] = i),
        (t[73] = fe),
        (t[74] = R),
        (t[75] = je))
    ...
    let H;
    t[76] !== i || t[77] !== R
      ? ((H = R && i ? () => ee(!0) : void 0), (t[76] = i), (t[77] = R), (t[78] = H))
      : (H = t[78]);
    let Me;
    (t[79] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((Me = (0, J.jsx)(zr, { className: `block size-full` })), (t[79] = Me))
      : (Me = t[79]),
      t[80] !== Oe || t[81] !== V || t[82] !== je || t[83] !== H
        ? ((xe = (0, J.jsx)(ke.div, {
            "aria-hidden": `true`,
          ...
          (t[84] = xe))
        : (xe = t[84]),
      (ve = `relative flex min-h-0 flex-1`),
      (Ee = le),
      (L = `flex min-h-0 flex-1 flex-col-reverse overflow-x-hidden overflow-y-auto [overflow-anchor:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden`),
      t[85] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((I = (e) => se(e.currentTarget)), (t[85] = I))
        : (I = t[85]),
      (we = de),
      (Te = `min-h-full shrink-0 px-8 pt-[72px]`),
      (Se = `mx-auto flex w-full max-w-[736px] flex-col gap-4 pb-6 text-lg leading-6`),
      (Ce = R
        ? null
        : l
          ? (0, J.jsx)(ha, { fadeIn: !0, onComplete: b })
          : (0, J.jsxs)(J.Fragment, {
              children: [
                (0, J.jsx)(Lt, {
                  animate: g.phase === `role`,
                  onComplete: () => te(!0),
                  children: ue,
                }),
                g.phase === `role` && j
                  ...
                  : g.phase === `role`
                    ...
                    : (0, J.jsxs)(J.Fragment, {
                        children: [
                          (0, J.jsx)(_a, { answer: n ?? ``, question: P }),
                          n == null ? null : (0, J.jsx)(ya, { children: n }),
                          f
                            ? (0, J.jsx)(ha, { onComplete: D })
                            : (0, J.jsxs)(J.Fragment, {
                                children: [
                                  (0, J.jsx)(Lt, {
                                    animate: g.phase === `task` && E.length === 0,
                                    onComplete: () => re(!0),
                                    children: [
                                      F.formatMessage(
                                        {
...
`),
                                  ...
                                  g.phase === `task`
                                            ...
                                            (0, J.jsxs)(
                                              `div`,
                                              {
                                                ...
                                                children: [
                                                  ...
                                                  (0, J.jsx)(Lt, {
                                                    animate: t === E.length - 1,
                                                    children: fn[e].getDeclinedRetryPrompt(F),
                                                  }),
                                                ],
                                              },
                                              `${e}-${t}`,
                                    ...
                                    : (0, J.jsxs)(J.Fragment, {
                                        children: [
                                          (0, J.jsx)(_a, { answer: _ ?? ``, question: ce }),
                                          _ == null
                                            ? null
                                            : (0, J.jsxs)(`div`, {
                                                className: `flex flex-col gap-2`,
                                                children: [
                                                  y == null ? null : (0, J.jsx)(y, {}),
                                                  (0, J.jsx)(ya, { children: _ }),
                                                ],
                                              }),
                                          d
                                            ? (0, J.jsx)(ha, { durationSeconds: Oa, onComplete: T })
                                            : c,
                                        ],
                                      }),
                                ],
  ...
  let R;
  t[86] !== Se || t[87] !== Ce
    ? ((R = (0, J.jsx)(`div`, { className: Se, children: Ce })),
      (t[86] = Se),
      (t[87] = Ce),
      (t[88] = R))
    : (R = t[88]);
  let De;
  t[89] !== R || t[90] !== we || t[91] !== Te
    ? ((De = (0, J.jsx)(`div`, { ref: we, className: Te, children: R })),
      (t[89] = R),
      (t[90] = we),
      (t[91] = Te),
      (t[92] = De))
    : (De = t[92]);
  let B;
  t[93] !== I || t[94] !== De || t[95] !== Ee || t[96] !== L
    ? ((B = (0, J.jsx)(`div`, { ref: Ee, className: L, onScroll: I, children: De })),
      (t[93] = I),
      (t[94] = De),
      (t[95] = Ee),
      (t[96] = L),
      (t[97] = B))
    : (B = t[97]);
  let Oe = me ? `opacity-100` : `opacity-0`,
    V;
  t[98] === Oe
    ? (V = t[99])
    : ((V = G(
  ...
  t[100] === V
    ? (Ae = t[101])
    : ((Ae = (0, J.jsx)(`div`, { "aria-hidden": !0, className: V })), (t[100] = V), (t[101] = Ae));
  let je;
  t[102] !== ve || t[103] !== B || t[104] !== Ae
    ? ((je = (0, J.jsxs)(`div`, { className: ve, children: [B, Ae] })),
      (t[102] = ve),
      (t[103] = B),
      (t[104] = Ae),
      (t[105] = je))
    ...
    ? ((H =
        _e || ge
          ? (0, J.jsxs)(ke.div, {
              ...
              transition: ka,
              children: [
                _e ? (0, J.jsx)(Xi, { checked: N, onChange: ie, variant: `checkbox` }) : null,
                ge
                  ? (0, J.jsx)(ea, {
                      canContinueRole: r,
                      isTaskReady: a,
                  ...
                  : null,
                ge ? (0, J.jsx)(ba, { isTaskReady: a, phase: g.phase }) : null,
              ],
            })
          : null),
      (t[106] = r),
  ...
  t[115] === H
    ? (Me = t[116])
    : ((Me = (0, J.jsx)(`div`, {
        className: `relative flex shrink-0 flex-col items-center gap-3 px-10 pt-10 pb-12`,
        children: H,
      })),
      (t[115] = H),
      (t[116] = Me));
  ...
  t[122] === E
    ...
    : ((Le = (0, J.jsxs)(St, {
        ...
        children: [
          ...
          Pe,
          (0, J.jsx)(yt, {
            children: (0, J.jsxs)(pe, {
              children: [
                Fe,
                (0, J.jsx)(W, { color: `outline`, type: `button`, onClick: E, children: Ie }),
              ],
            }),
          }),
        ],
  ...
  let Re;
  t[124] !== O || t[125] !== Le
    ? ((Re = (0, J.jsx)(he, { open: O, size: `compact`, onOpenChange: k, children: Le })),
      (t[124] = O),
      (t[125] = Le),
      (t[126] = Re))
    : (Re = t[126]);
  ...
  return (
    ...
    t[131] !== Me ||
    t[132] !== Re
      ? ((ze = (0, J.jsxs)(`div`, { className: ye, children: [be, xe, je, Me, Re] })),
        (t[127] = ye),
        (t[128] = be),
        (t[129] = xe),
        (t[130] = je),
...
function ha(e) {
  let t = (0, xa.c)(10),
    { durationSeconds: n, fadeIn: r, onComplete: i } = e,
    a = n === void 0 ? 2 : n,
    o = r === void 0 ? !1 : r,
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (c = t[1]);
  let l;
  t[2] === a ? (l = t[3]) : ((l = { delay: a, duration: 0.2 }), (t[2] = a), (t[3] = l));
  let u;
  t[4] === o
    ? (u = t[5])
    : ((u = o
...
function _a(e) {
  let t = (0, xa.c)(37),
    { answer: n, question: r } = e,
    [i, a] = (0, Sa.useState)(!1),
    { elementHeightPx: o, elementRef: s } = me(),
    c;
  t[0] === i ? (c = t[1]) : ((c = () => a(!i)), (t[0] = i), (t[1] = c));
  let l;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, J.jsx)(`span`, {
        className: `truncate text-token-conversation-summary-trailing group-hover:text-token-foreground`,
        children: (0, J.jsx)(v, {
  ...
  t[6] === f
    ? (p = t[7])
    : ((p = (0, J.jsx)(Ue, { className: f, "aria-hidden": !0 })), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== i || t[9] !== c || t[10] !== p
    ? ((m = (0, J.jsxs)(`button`, {
        type: `button`,
  ...
  let h = i ? o : 0,
    ...
    _;
  t[12] !== h || t[13] !== g
    ? ((_ = { height: h, opacity: g }), (t[12] = h), (t[13] = g), (t[14] = _))
    : (_ = t[14]);
  let y = !i,
    b = !i,
    x = i ? `mt-1.5 overflow-visible` : `overflow-hidden`,
    S;
  t[15] === x ? (S = t[16]) : ((S = G(x)), (t[15] = x), (t[16] = S));
  let C = i ? `auto` : `none`,
    w;
  t[17] === C ? (w = t[18]) : ((w = { pointerEvents: C }), (t[17] = C), (t[18] = w));
  let T = i ? s : null,
    E;
  t[19] === r
    ? (E = t[20])
    : ((E = (0, J.jsx)(`p`, { className: `text-token-text-secondary`, children: r })),
      (t[19] = r),
      (t[20] = E));
  let D;
  t[21] === n ? (D = t[22]) : ((D = (0, J.jsx)(`p`, { children: n })), (t[21] = n), (t[22] = D));
  let O;
  t[23] !== T || t[24] !== E || t[25] !== D
    ? ((O = (0, J.jsxs)(`div`, {
        ref: T,
    ...
    : (O = t[26]);
  let k;
  t[27] !== _ || t[28] !== y || t[29] !== b || t[30] !== S || t[31] !== w || t[32] !== O
    ? ((k = (0, J.jsx)(ke.div, {
        initial: !1,
        animate: _,
        "aria-hidden": y,
  ...
  return (
    t[34] !== k || t[35] !== m
      ? ((A = (0, J.jsxs)(`div`, { className: `flex flex-col`, children: [m, k] })),
        (t[34] = k),
        (t[35] = m),
        (t[36] = A))
      : (A = t[36]),
...
function va(e) {
  let t = e.firstElementChild?.firstElementChild;
  if (!(t instanceof HTMLElement)) return Ta;
  let n = e.getBoundingClientRect(),
    r = t.getBoundingClientRect();
  return { hasContentBelow: r.bottom > n.bottom + wa, hasContentUnderTitleBar: r.top < n.top + Ca };
}
function ya(e) {
  let t = (0, xa.c)(2),
    { children: n } = e,
...
function ba(e) {
  let t = (0, xa.c)(6),
    { isTaskReady: n, phase: r } = e,
    i = r === `role` ? 0 : r === `task` || !n ? 1 : 2,
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = [0, 1, 2]), (t[0] = a)) : (a = t[0]);
  let o;
  t[1] === i
    ? (o = t[2])
    : ((o = a.map((e) =>
...
var xa,
  ...
  Na = e(() => {
    ((xa = U()),
      ...
      (Ca = 48),
      (wa = 1),
      (Ta = { hasContentBelow: !1, hasContentUnderTitleBar: !1 }),
      (Ea = 1),
      (Da = 40),
      (Oa = 0.6),
      (ka = { duration: 0.4, ease: [0.23, 1, 0.32, 1] }),
      (Aa = { type: `spring`, stiffness: 110, damping: 20, mass: 1 }),
      (ja = 28),
      (Ma = 20));
  });
function Pa(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Ba.jsx)(rt, { scope: Cn, children: (0, Ba.jsx)(Fa, { onContinue: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function Fa(e) {
  let t = (0, Ra.c)(136),
    ...
    i = ze(),
    { data: a } = ht(),
    o = i.accountId != null && i.userId != null,
    s;
  t[0] !== i.accountId || t[1] !== i.userId || t[2] !== o
    ? ((s = { accountId: i.accountId, enabled: o, userId: i.userId }),
      (t[0] = i.accountId),
      (t[1] = i.userId),
      (t[2] = o),
      (t[3] = s))
    : (s = t[3]);
  let { data: u, isLoading: d } = Mn(s),
    f = l(Cr),
    p = I(Cr),
    m;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = { conversationId: null, cwdOverride: Va, hostId: O }), (t[4] = m))
    : (m = t[4]);
  let { isConfigDataPending: h, requirements: g } = ae(m),
    _;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = { conversationId: null, cwdOverride: Va, hostId: O }), (t[5] = _))
    : (_ = t[5]);
  let { agentMode: v, permissionProfileId: y, shouldSendPermissionOverrides: b } = ue(_),
    { serviceTierSettings: x } = et(null),
    S;
  t[6] === Symbol.for(`react.memo_cache_sentinel`) ? ((S = { hostId: O }), (t[6] = S)) : (S = t[6]);
  let { data: C, isLoading: w } = Pe(S),
    T = R(Ot) ?? rn(r),
    E = R(Hn) === !0,
    D = T.selectedTask,
    k = R(ur),
    A;
  t[7] === i.email ? (A = t[8]) : ((A = An(i.email)), (t[7] = i.email), (t[8] = A));
  let ee = A,
    j = k == null,
    M;
  t[9] === j ? (M = t[10]) : ((M = { enabled: j }), (t[9] = j), (t[10] = M));
  let { data: te, isError: ne } = Te(kn, ee, M),
    N = Nn({ debugOverride: k, detectedProvider: te?.provider, emailDomain: ee, isError: ne }),
    ie = a?.plan_type ?? i.planAtLogin,
    P = N == null ? null : En(N, ie),
    oe = N == null ? null : un(N, ie),
    se = P == null ? null : Yt(P),
    ce;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = { hostId: O }), (t[11] = ce))
    : (ce = t[11]);
  let { data: le, isLoading: fe } = Se(ce),
    F;
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = { hostId: O, marketplaceKind: `local` }), (t[12] = F))
    : (F = t[12]);
  let { data: pe, isLoading: me, refetch: he } = Me(F),
    ge = P == null ? null : Qt(P, pe),
    _e = Le(),
    ve =
      le == null || se == null
        ? []
        : se.flatMap((e) => {
            let t = $t(le, e);
            return t == null ? [] : [en(t.id)];
          }),
    ye;
  (t[13] === ve ? (ye = t[14]) : ((ye = { queries: ve }), (t[13] = ve), (t[14] = ye)), de(ye));
  let be;
  t[15] === C?.models
    ? (be = t[16])
    : ((be = C?.models.some(Ia)), (t[15] = C?.models), (t[16] = be));
  let xe = be === !0,
    we;
  t[17] === he ? (we = t[18]) : ((we = async () => (await he()).data), (t[17] = he), (t[18] = we));
  let Ee;
  t[19] !== v ||
  t[20] !== le ||
  t[21] !== fe ||
  ...
  t[33] !== we
    ? ((Ee = {
        ...
        hostId: O,
        isAppsLoading: fe,
        isConfigDataPending: h,
        isModelsLoading: w,
        isPluginsLoading: me,
        isRequiredModelAvailable: xe,
        localPlugins: pe,
        mailProvider: P,
        permissionProfileId: y,
        permissionsRequirements: g,
        projectRoot: Va,
        queryClient: _e,
        refetchLocalPlugins: we,
        serviceTier: x.serviceTierForRequest,
        shouldSendPermissionOverrides: b,
      }),
      (t[19] = v),
      (t[20] = le),
      (t[21] = fe),
    ...
    : (Ee = t[34]);
  let L = Ee,
    [z, De] = (0, za.useState)(null),
    [B, Oe] = (0, za.useState)(``),
    [V, ke] = (0, za.useState)(!0),
    [Ae, je] = (0, za.useState)(!1),
    [H, Ne] = (0, za.useState)(!1),
    U = R(xn),
    Fe = R(Xt),
    Ie = R(Ut),
    Re = Te(At, U?.conversationId ?? null),
    Be = Te(jt, U?.conversationId ?? null),
    Ve;
  t[35] === B ? (Ve = t[36]) : ((Ve = B.trim()), (t[35] = B), (t[36] = Ve));
  let He = Ve,
    Ue = z != null && (z !== `something_else` || He.length > 1),
    We;
  t[37] !== Fe || t[38] !== D || t[39] !== Re
    ? ((We = D != null && (gn(D) ? Re != null : Fe)),
      (t[37] = Fe),
      (t[38] = D),
      (t[39] = Re),
      (t[40] = We))
  ...
  t[44] !== r || t[45] !== L
    ? ((qe = async (e) => {
      ...
      (t[46] = qe))
    : (qe = t[46]);
  let Je = (0, za.useEffectEvent)(qe),
    Ye;
  t[47] !== pe || t[48] !== P || t[49] !== Je
    ? ((Ye = () => {
        pe == null || P == null || Je(P);
      }),
      (t[47] = pe),
  ...
  let Xe;
  (t[51] !== pe || t[52] !== P
    ? ((Xe = [pe, P]), (t[51] = pe), (t[52] = P), (t[53] = Xe))
    : (Xe = t[53]),
    (0, za.useEffect)(Ye, Xe));
  let Ze;
  t[54] !== i.accountId ||
  t[55] !== Ge ||
  t[56] !== n ||
  ...
  t[60] !== D
    ? ((Ze = async (e) => {
        let { isSkipped: t, personalizedSuggestionsEnabled: a } = e;
        (Ge && i.accountId != null && D != null && kr(r, i.accountId, D),
          t ? Zt(r, D) : tn(r, D),
          await n({
            step: q.ConversationalOnboarding,
            roles: f.roles,
  ...
  let G = Ze,
    Qe;
  t[62] !== Ue || t[63] !== z || t[64] !== r || t[65] !== p || t[66] !== He
    ? ((Qe = (e) => {
        if (!Ue || z == null) return;
        let t = [z],
          n = Mr(t);
        (p({ roles: t, personalizedSuggestionsEnabled: e, workMode: n }),
          re(r, c, {
            step: `role`,
            option: z,
            selected: !0,
            selectedRoles: z,
            selectedWorkMode: n,
            otherRoleDescription: z === `something_else` ? He : void 0,
          }),
          Mt(r, z),
          wn(r, z),
          je(!0));
  ...
  let $e = Qe,
    tt;
  t[68] !== Be || t[69] !== Ie || t[70] !== Ge || t[71] !== r || t[72] !== D
    ? ((tt = () => {
        if (D != null) {
          if (Be) {
            vn(r, D);
  ...
  let nt = tt,
    rt;
  t[74] !== r || t[75] !== D || t[76] !== T.permissionStatus
    ? ((rt = () => {
        D == null || T.permissionStatus === `allowed` || nn(r, D);
      }),
      (t[74] = r),
      (t[75] = D),
      (t[76] = T.permissionStatus),
      (t[77] = rt))
    : (rt = t[77]);
  let it = rt,
    at;
  t[78] !== nt || t[79] !== r || t[80] !== D || t[81] !== L
    ? ((at = (e) => {
        (nt(), an(O), D != null && fn[D].reset(r), yn(r), Pt(r, e), Wt(r, e), Ne(!0));
        let t = fn[e];
        (t.reset(r), t.prepare?.(r, e, L));
      }),
      (t[78] = nt),
      (t[79] = r),
      (t[80] = D),
  ...
  let ot = at,
    st;
  t[83] !== it || t[84] !== nt || t[85] !== r
    ? ((st = (e) => {
        (nt(), it(), an(O), fn[e].reset(r), yn(r), Ne(!1), Vt(r, e));
      }),
      (t[83] = it),
      (t[84] = nt),
      (t[85] = r),
  ...
  let K = st,
    ct;
  t[87] !== nt || t[88] !== r || t[89] !== D || t[90] !== L
    ? ((ct = () => {
        (nt(), D != null && (an(O), yn(r), fn[D].retry(r, D, L)));
      }),
      (t[87] = nt),
      (t[88] = r),
      (t[89] = D),
  ...
  t[92] !== r || t[93] !== L
    ? ((ut = () => {
        Ne(!1);
        let e = rn(r).selectedTask;
        e != null && fn[e].start?.(r, e, L);
      }),
      (t[92] = r),
      (t[93] = L),
      (t[94] = ut))
    : (ut = t[94]);
  let dt = ut,
    ft = T.permissionStatus === `denied` || Ge,
    pt = D == null ? null : fn[D].View,
    mt;
  t[95] !== pt || t[96] !== K || t[97] !== lt || t[98] !== E || t[99] !== D || t[100] !== L
    ? ((mt =
        pt == null || D == null
          ? null
          : (0, Ba.jsx)(
  ...
  t[102] === u?.displayName
    ? (yt = t[103])
    : ((yt = u?.displayName?.trim().split(/\s+/)[0] || void 0),
      (t[102] = u?.displayName),
      (t[103] = yt));
  let bt;
  t[104] !== G || t[105] !== f.personalizedSuggestionsEnabled
    ? ((bt = () => {
        G({ isSkipped: !1, personalizedSuggestionsEnabled: f.personalizedSuggestionsEnabled });
      }),
      (t[104] = G),
      (t[105] = f.personalizedSuggestionsEnabled),
      (t[106] = bt))
    : (bt = t[106]);
  let xt;
  ...
  t[109] !== it ||
  t[110] !== nt ||
  t[111] !== f.personalizedSuggestionsEnabled ||
  t[112] !== r ||
  t[113] !== T.permissionStatus ||
  t[114] !== T.phase
    ? ((St = () => {
        (nt(),
          it(),
          T.permissionStatus !== `allowed` && Ft(r, `denied`),
          G({
            isSkipped: !0,
            personalizedSuggestionsEnabled:
              T.phase === `role` ? !1 : f.personalizedSuggestionsEnabled,
          }));
      }),
      (t[108] = G),
      (t[109] = it),
  ...
  return (
    ...
    t[134] !== T
      ? ((wt = (0, Ba.jsx)(ma, {
          ...
          isAppWindowFocused: E,
          isTaskReady: ft,
          otherRoleDescription: B,
          roleSelection: z,
          selectedTaskContent: gt,
          showInitialThinking: _t,
          showSelectedTaskThinking: H,
          showTaskIntroThinking: vt,
          taskIds: oe,
          taskPlugins: ge,
          userFirstName: yt,
          workflow: T,
          onContinueRole: $e,
          onGetStarted: bt,
          onInitialThinkingComplete: xt,
          onOtherRoleDescriptionChange: Oe,
          onRoleSelectionChange: De,
          onSelectTask: ot,
          onSelectedTaskThinkingComplete: dt,
          onSkip: St,
          onTaskIntroThinkingComplete: Ct,
        })),
        (t[117] = Ue),
        (t[118] = $e),
        (t[119] = ot),
...
function Ia(e) {
  return e.model === `gpt-5.5` && e.supportedReasoningEfforts.some(La);
}
function La(e) {
...
function Ua(e) {
  let t = (0, Ga.c)(30),
    ...
    s = _e(`4147559047`),
    u;
  t[0] === s ? (u = t[1]) : ((u = s.get(`allow_multi_select`, !0)), (t[0] = s), (t[1] = u));
  let d = u,
    f;
  t[2] === s ? (f = t[3]) : ((f = s.get(`allow_skip`, !0)), (t[2] = s), (t[3] = f));
  let p = f,
    [m] = (0, Ka.useState)(jr),
    h;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let C = S,
    w;
  t[11] !== d || t[12] !== g || t[13] !== x
    ? ((w = (e) => {
        let t = !d || !g.roles.includes(e),
          n = [e];
        d && (n = t ? [...g.roles, e] : g.roles.filter((t) => t !== e));
        let r = { ...g, roles: n, workMode: Mr(n) };
        (y(r), x({ role: e, selected: t, state: r }));
      }),
      (t[11] = d),
      (t[12] = g),
      (t[13] = x),
              ...
              children: [
                ...
                (0, Y.jsx)(`div`, {
                  ...
                  children: m.map((e) =>
                    (0, Y.jsx)(
                      Wa,
                      { role: e, selected: g.roles.includes(e), onClick: () => T(e) },
                      e,
                    ),
                  ),
                }),
                (0, Y.jsx)(Xi, { checked: g.personalizedSuggestionsEnabled, onChange: D }),
                (0, Y.jsxs)(`div`, {
                    ...
                    p
                      ? (0, Y.jsx)(`button`, {
                          ...
                          onClick: () => {
                            ...
                            (C(e), t({ result: { step: q.RoleSelection, ...e }, skipped: !0 }));
                          },
                          children: (0, Y.jsx)(v, {
  ...
  return (
    t[27] !== ee || t[28] !== A
      ? ((j = (0, Y.jsx)(Pi, { name: `role_selection`, onComplete: A, children: ee })),
        (t[27] = ee),
        (t[28] = A),
        (t[29] = j))
      : (j = t[29]),
...
function $a(e) {
  ...
  t[4] === i
    ...
    : ((l = (e) => {
        ...
        return (0, no.jsx)(Ja, {
          ...
          onToggleInterest: s,
          onNext: () => {
            t({ result: { step: q.TeenInterests, interests: i } });
          },
        });
      }),
      (t[4] = i),
  ...
  return (
    t[6] !== c || t[7] !== l
      ? ((u = (0, no.jsx)(Pi, { name: `teen_interests`, onComplete: c, children: l })),
        (t[6] = c),
        (t[7] = l),
        (t[8] = u))
      : (u = t[8]),
...
var eo,
  ...
  no,
  ro = e(() => {
    ((eo = U()), (to = t(Ye(), 1)), ii(), Wr(), Li(), Qa(), (no = K()));
  });
function io(e) {
  let t = (0, so.c)(34),
...
function oo(e) {
  ...
  t[7] === n.titleMessage
    ...
    : ((s = (0, Z.jsx)(`h3`, {
        ...
        children: (0, Z.jsx)(v, { ...n.titleMessage }),
      })),
      (t[7] = n.titleMessage),
      (t[8] = s));
  let c;
  t[9] === n.descriptionMessage
    ...
    : ((c = (0, Z.jsx)(`p`, {
        ...
        children: (0, Z.jsx)(v, { ...n.descriptionMessage }),
      })),
      (t[9] = n.descriptionMessage),
      (t[10] = c));
  let l;
...
function uo(e) {
  ...
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, po.jsx)(Pi, { name: `teen_prompts`, onComplete: i, children: a })),
        (t[4] = i),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, Q.jsx)(Xe, { className: `icon-sm`, ExternalIcon: bn, href: bo }),
        ],
      })),
      (t[7] = l))
    : (l = t[7]);
...
function go(e) {
  Oe({ event: e, href: bo, initiator: `open_in_browser_bridge` });
}
function _o() {
  let e = (0, yo.c)(4),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, Q.jsxs)(vo, {
        ...
        children: [
          (0, Q.jsx)(`div`, { className: `absolute inset-x-5 top-5 h-10 rounded bg-[#FFF8FC]` }),
          (0, Q.jsx)(`div`, {
  ...
  e[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((n = (0, Q.jsxs)(vo, {
        ...
        children: [
          (0, Q.jsx)(`div`, { className: `absolute inset-x-4 top-4 h-12 rounded bg-[#FFFFF0]` }),
          (0, Q.jsx)(`div`, {
...
function vo(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = G(`absolute overflow-hidden rounded-2xl border border-token-border/50 shadow-2xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  return (
...
var wo,
  ...
  jo,
  Mo = e(() => {
    ((Ao = `_uacArrow_cwr2x_1`),
      (jo = { uacArrow: Ao, "uac-arrow-bounce": `_uac-arrow-bounce_cwr2x_1` }));
  });
function No(e) {
  let t = (0, Ro.c)(27),
    { onContinue: n } = e,
    r = Ce(_),
    {
      ...
      requiresElevatedSandboxByPolicy: u,
      showUnelevatedSetupAlternative: d,
      allowUnelevatedFallback: f,
      setLimitedAccessMode: p,
      enableElevated: m,
      enableUnelevated: h,
      retryRequirements: g,
    } = rr(),
    { hasError: v, retry: y } = nr(),
    b;
  t[0] === n
    ? (b = t[1])
    : ((b = (e) => {
        e && n({ step: q.WindowsSandboxSetup });
      }),
      (t[0] = n),
      (t[1] = b));
  let x = b,
  ...
  t[5] !== h || t[6] !== n || t[7] !== r
    ? ((T = () => {
        h().then((e) => {
          e && (r.set(Zn, !0), n({ step: q.WindowsSandboxSetup }));
        });
      }),
      (t[5] = h),
      (t[6] = n),
  ...
  t[9] !== n || t[10] !== r || t[11] !== p
    ? ((D = () => {
        (p(), r.set(Zn, !0), n({ step: q.WindowsSandboxSetup }));
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = p),
...
function Po(e) {
  ...
  if (i) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(Ht, { className: `size-10` })), (t[0] = e))
      : (e = t[0]);
    let n;
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  if (a) {
    let e;
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(Ht, { className: `size-10` })), (t[2] = e))
      : (e = t[2]);
    let n;
    ...
    t[6] === p
      ...
      : ((a = (0, $.jsx)(W, {
        ...
        (t[7] = a));
    let o;
    t[8] === m ? (o = t[9]) : ((o = (0, $.jsx)(Io, { onConfirm: m })), (t[8] = m), (t[9] = o));
    let s;
    return (
      t[10] !== a || t[11] !== o
        ? ((s = (0, $.jsxs)(Fo, {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(Ht, { className: `size-10` })), (t[13] = _))
    : (_ = t[13]);
  let y;
  ...
  t[16] === l
    ...
    : ((x = l
      ...
      (t[16] = l),
      (t[17] = x));
  let S = l ? `mt-6` : `mt-[22px]`,
    C = !h,
    w;
  t[18] !== r || t[19] !== d || t[20] !== C
    ? ((w = (0, $.jsx)(Lo, { disabled: r, showArrow: C, onElevatedSetup: d })),
      (t[18] = r),
      (t[19] = d),
      (t[20] = C),
      (t[21] = w))
  ...
  let T;
  t[22] !== S || t[23] !== w
    ? ((T = (0, $.jsx)(`div`, { className: S, children: w })),
      (t[22] = S),
      (t[23] = w),
      (t[24] = T))
    : (T = t[24]);
  ...
  t[40] !== r || t[41] !== m || t[42] !== l
    ? ((A = l ? (0, $.jsx)(Io, { disabled: r, onConfirm: m }) : null),
      (t[40] = r),
      (t[41] = m),
      (t[42] = l),
      (t[43] = A))
  ...
  t[47] !== O || t[48] !== ee
    ...
    : (j = t[49]);
  let M;
  t[50] !== j || t[51] !== x || t[52] !== T || t[53] !== E
    ? ((M = (0, $.jsxs)(`div`, {
        className: `flex w-full flex-col items-center`,
        children: [_, b, x, T, E, j],
      })),
      (t[50] = j),
      (t[51] = x),
      (t[52] = T),
  ...
  return (
    t[55] !== l || t[56] !== M
      ? ((te = (0, $.jsx)(Fo, { shiftForWorkspaceRequirement: l, children: M })),
        (t[55] = l),
        (t[56] = M),
        (t[57] = te))
      : (te = t[57]),
...
function Fo(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = G(`relative my-auto flex w-full shrink-0 flex-col items-center gap-5 py-7`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  return (
...
function Io(e) {
  ...
  let m, h;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(w, { className: `sr-only`, children: s })),
      (h = (0, $.jsx)(xe, { className: `sr-only`, children: l })),
      (t[7] = m),
      (t[8] = h))
    : ((m = t[7]), (h = t[8]));
  let g;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, $.jsx)(yt, {
        className: `!pt-0`,
        children: (0, $.jsx)(u, { title: s, subtitle: l, subtitleSize: `sm` }),
      })),
      (t[9] = g))
    : (g = t[9]);
  let _;
  ...
  t[12] === p
    ? (b = t[13])
    : ((b = (0, $.jsxs)(St, { as: `form`, onSubmit: p, children: [m, h, g, y] })),
      (t[12] = p),
      (t[13] = b));
  let x;
  return (
    t[14] !== i || t[15] !== b || t[16] !== f
      ? ((x = (0, $.jsx)(he, {
          open: i,
          onOpenChange: a,
...
function Lo(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(`div`, {
        ...
        children: (0, $.jsx)(Fe, { className: `size-3.5` }),
      })),
      (t[4] = l))
    : (l = t[4]);
  let u;
  ...
  t[9] === r
    ...
    : ((m = r
        ? (0, $.jsx)(`span`, {
            ...
            "aria-hidden": `true`,
            children: (0, $.jsx)(Oo, { className: G(`h-[30px] w-[25px]`, jo.uacArrow) }),
          })
        : null),
      (t[9] = r),
      (t[10] = m));
...
function Vo(e) {
  ...
  switch (n) {
    case q.Start: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Uo.jsx)(Rn, { debugName: `OnboardingLoadingPage` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
    ...
    case q.TeenPrompts: {
      ...
      let n;
      return (
        t[7] !== e || t[8] !== a.interests
          ? ((n = (0, Uo.jsx)(uo, { selectedInterests: a.interests, onContinue: e })),
            (t[7] = e),
            (t[8] = a.interests),
            (t[9] = n))
          : (n = t[9]),
    ...
    case q.ConversationalOnboarding: {
      ...
      return (
        t[12] === i
          ? (e = t[13])
          : ((e = (0, Uo.jsx)(Pa, { onContinue: i })), (t[12] = i), (t[13] = e)),
        e
      );
    }
    case q.RoleSelection: {
      ...
      let n;
      return (
        t[16] !== r.isLoading || t[17] !== e
          ? ((n = (0, Uo.jsx)(Ua, { isAdvancePending: r.isLoading, onContinue: e })),
            (t[16] = r.isLoading),
            (t[17] = e),
            (t[18] = n))
          : (n = t[18]),
    ...
    case q.AgentMigrationSourceSelection: {
      ...
      let n;
      return (
        t[21] !== r.agentMigration || t[22] !== e
          ? ((n = (0, Uo.jsx)(Wi, { agentMigrationContext: r.agentMigration, onContinue: e })),
            (t[21] = r.agentMigration),
            (t[22] = e),
            (t[23] = n))
          : (n = t[23]),
        n
    ...
    case q.AgentMigrationItemSelection: {
      ...
      let n;
      return (
        t[26] !== o.providerIds || t[27] !== r.agentMigration || t[28] !== e
          ? ((n = (0, Uo.jsx)(Ri, {
...
var Ho,
  Uo,
  Wo = e(() => {
    ((Ho = U()), C(), Wn(), ui(), ii(), Ui(), Yi(), Ha(), qa(), ro(), mo(), Eo(), Bo(), (Uo = K()));
  });
function Go() {
  let e = (0, Ko.c)(25),
    t = Ce(ai),
  ...
  e[10] === m
    ...
    : ((h = () => {
      ...
      (e[10] = m),
      (e[11] = h));
  let g = (0, qo.useEffectEvent)(h),
    _;
  e[12] !== g || e[13] !== r || e[14] !== f.isLoading
    ? ((_ = () => {
        r !== q.Start || f.isLoading || g();
      }),
      (e[12] = g),
      (e[13] = r),
      (e[14] = f.isLoading),
    ...
    : (_ = e[15]);
  let v;
  (e[16] !== r || e[17] !== f.isLoading
    ? ((v = [r, f.isLoading]), (e[16] = r), (e[17] = f.isLoading), (e[18] = v))
    : (v = e[18]),
    (0, qo.useEffect)(_, v));
  let y;
  e[19] === m
  ...
  let b = y,
    x;
  return (
    e[21] !== r || e[22] !== b || e[23] !== f
      ? ((x = (0, Jo.jsx)(Vo, { currentStep: r, onboardingContext: f, onContinue: b })),
        (e[21] = r),
        (e[22] = b),
        (e[23] = f),
        (e[24] = x))
...
function Xo() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $o.jsx)(rt, { scope: ai, children: (0, $o.jsx)(Zo, {}) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Zo() {
  let e = (0, Qo.c)(3),
    t = R(oi),
    n = st.ChatGPT === `codex` && t !== q.ConversationalOnboarding,
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $o.jsx)(Go, {})), (e[0] = r))
    : (r = e[0]);
  ...
  return (
    e[1] === n
      ? (i = e[2])
      : ((i = (0, $o.jsx)(Tn, { fullBleed: !0, showBrandIcon: n, children: r })),
        (e[1] = n),
        (e[2] = i)),
    i
  );
...
var Qo, $o;
e(() => {
  ((Qo = U()), C(), D(), lr(), Bn(), ui(), ii(), Yo(), ($o = K()));
})();
export { Xo as OnboardingPage };
//# sourceMappingURL=onboarding-page-N.js.map
