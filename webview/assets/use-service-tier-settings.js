...
import { n as f, t as p } from "./use-model-settings-DhE-8qP1.js";
...
function _(u) {
  let _ = (0, g.c)(25),
    ...
    { modelSettings: x } = p(v),
    S;
  _[0] === b.hostId ? (S = _[1]) : ((S = { hostId: b.hostId }), (_[0] = b.hostId), (_[1] = S));
  ...
  _[13] !== O
    ? ((N = async (e, t) => {
        ...
        try {
          ...
          let t = e;
          s.error(`Failed to set default service tier`, { safe: {}, sensitive: { error: t } });
          return;
        }
        r &&
          c &&
          d(y, {
            ...
            metadata: { previous_service_tier: o(T.serviceTier), service_tier: o(e), source: t },
          });
      }),
      (_[7] = k),
      (_[8] = T.serviceTier),
  ...
  return (
    _[22] !== P || _[23] !== I
      ? ((L = { serviceTierSettings: I, setServiceTier: P }), (_[22] = P), (_[23] = I), (_[24] = L))
      : (L = _[24]),
    L
  );
}
