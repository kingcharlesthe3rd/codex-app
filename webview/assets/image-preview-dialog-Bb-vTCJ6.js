...
import { n as s } from "./use-host-config.js";
import { A as c, f as l, l as u, n as d, r as f, s as p, u as m, v as h } from "./vscode-api.js";
import { Mn as g, Sn as _, fn as v, or as y, sr as b } from "./src-3.js";
import { t as x } from "./react-dom.js";
import { i as S, l as C, s as w } from "./lib-1.js";
...
import { A as F, L as I, n as L } from "./rpc-1.js";
import { n as R, t as ee } from "./base64.js";
import { t as z } from "./chevron.js";
import { Ct as B, St as te, r as V, wt as H, xt as U } from "./product-logger.js";
import { m as ne } from "./chunk-13.js";
import { o as W } from "./prompt-text.js";
import { k as G } from "./composer-view-state.js";
import { t as K } from "./plugin-install-store.js";
import { m as re } from "./use-plugins.js";
import { a as ie, c as ae } from "./apps-queries.js";
import { d as oe, l as se, u as ce } from "./known-app-icon.js";
import { t as le } from "./arrow-left.js";
import { t as ue } from "./download.js";
import { o as de } from "./plugin-detail-route-utils.js";
import { n as fe, r as pe, t as me } from "./open-target-selection.js";
import { d as he, l as ge } from "./dialog-layout.js";
import { l as q, o as _e, r as ve } from "./plugins-availability.js";
import { i as ye, n as be } from "./image-preview-shortcuts.js";
import { t as xe } from "./minus.js";
import { r as J, t as Se } from "./dropdown.js";
import { t as Ce } from "./use-app-connect-flow.js";
import { t as we } from "./compound-button.js";
import { t as Te } from "./codex-analytics-attribution.js";
var Ee = class extends Error {
  ...
  De = `/wham/apps/google_drive/upload`,
  Oe = `Unsupported file type. Expected one of: .docx, .pptx, .xlsx.`,
  ke = /https?:\/\/(?:docs|drive)\.google\.com\/[^\s"'<>),]+/i;
function Ae(e) {
  switch (Re(e)) {
    case `docx`:
      return `document`;
  ...
  return (
    e.find((e) =>
      e.id === `connector_5f3c8c41a1e54ad7a76272c89e2554fa`
        ? !0
        : [e.id, e.name, ...e.pluginDisplayNames].some((e) => ze(e) === `google-drive`),
    ) ?? null
  );
}
function Y(e) {
  ...
  return (
    e.find((e) =>
      [e.plugin.id.split(`@`)[0], e.plugin.name, e.displayName].some(
        (e) => e != null && ze(e) === `google-drive`,
      ),
    ) ?? null
  );
}
function Me({ apps: e, plugin: t }) {
  if (e != null && Y(e)) return { kind: `upload` };
...
async function Ne({ hostId: e, path: t, title: n }) {
  if (Ae(t) == null) throw Error(Oe);
  let r = await d(`read-file-binary`, { params: { hostId: e, path: t } });
  if (r.contentsBase64 == null) throw Error(`File contents are unavailable.`);
  let i = F(t),
    a = Be(t),
    o = Fe({ fileBytes: ee(r.contentsBase64), filename: i, mimeType: a, title: n ?? i }),
    s = R(o.body),
    c = (
      await u
        .getInstance()
        .post(De, s, { "Content-Type": `multipart/form-data; boundary=${o.boundary}`, [_]: `1` })
    ).body,
    l = c.connector_result;
  if (Ie(l)) throw new Ee();
...
function Pe(e) {
  ...
  if (typeof n == `object` && n && !Array.isArray(n)) {
    let e = Le(n.url) ?? Le(n.webViewLink);
    if (e != null) return e;
  }
...
function Fe({ fileBytes: e, filename: t, mimeType: n, title: r }) {
  ...
  return (
    ((e, t) => {
      o(`--${i}\r\nContent-Disposition: form-data; name="${Ve(e)}"\r\n\r\n${t}\r\n`);
    })(`arguments`, JSON.stringify({ title: r })),
    o(
      `--${i}\r\nContent-Disposition: form-data; name="file"; filename="${Ve(t)}"\r\nContent-Type: ${n}\r\n\r\n`,
    ),
    a.push(e),
    o(`\r\n--${i}--\r\n`),
    { body: He(a), boundary: i }
  );
}
function Ie(e) {
  let t = e._meta;
...
function Le(e) {
  return typeof e == `string`
    ? ((e.match(ke)?.[0] ?? null)?.replace(/[.;:!?]+$/, ``) ?? null)
    : null;
}
function Re(e) {
  let t = F(e),
...
function Ue({ clickAction: e, clickSource: t, context: n, productLogger: r, resourceKind: i }) {
  let a = We(i);
  a != null &&
    r.logProductEvent(B, {
...
function We(e) {
  switch (e) {
    case `document`:
      return H.CODEX_GOOGLE_WORKSPACE_RESOURCE_KIND_DOCUMENT;
    case `spreadsheet`:
      return H.CODEX_GOOGLE_WORKSPACE_RESOURCE_KIND_SPREADSHEET;
    case `presentation`:
      return H.CODEX_GOOGLE_WORKSPACE_RESOURCE_KIND_PRESENTATION;
    default:
      return null;
  }
}
...
function Ke(e) {
  ...
  t[2] !== r || t[3] !== o
    ? ((l = async () => {
        await ie({ hostId: r, queryClient: o });
      }),
      (t[2] = r),
      (t[3] = o),
      (t[4] = l))
  ...
  return (
    t[5] !== n || t[6] !== a || t[7] !== s || t[8] !== l
      ? ((u = (0, Q.jsx)(_e, { app: n, onOpenChange: s, onConnected: l, onOAuthStarted: a })),
        (t[5] = n),
        (t[6] = a),
        (t[7] = s),
        (t[8] = l),
...
function Je({
  ...
  let m = i(W),
    h = C(),
    g = ne(),
    { data: _, hardRefetchAppsList: v } = ae({ hostId: o }),
    { availablePlugins: y, refetch: b } = re(o),
    { openPluginInstall: x, session: S } = K(),
    { pendingPluginId: w, setPluginEnabled: T } = ve({ hostId: o }),
    E = a(V),
    D = X(y),
    O = D != null && w === D.plugin.id,
    k = Xe(f),
    A = (e) => {
      g(de(e, { hostId: o }));
    },
    ...
    N = async () => {
      let r = n == null ? d : I(n, d);
      Ue({
        clickAction: U.CODEX_GOOGLE_WORKSPACE_RESOURCE_CLICK_ACTION_UPLOAD_LOCAL_FILE,
        clickSource: e,
        context: {
      ...
      let i = Pe(await Ne({ hostId: o, path: r, title: p }));
      if (i != null) {
        let e = Ze(f),
          t = p?.trim(),
          n = {
    ...
    P = async (e) => {
      try {
        await T({ pluginDisplayName: q(e), pluginId: e.plugin.id, enabled: !0 });
      } catch {
        return;
      }
    },
    F = async () => {
      if (!s) {
        ...
        try {
          ...
          let [t, n] = await Promise.all([v(), b()]),
            i = X(n.availablePlugins),
            a = je(t);
          if (Y(t)) {
            await N();
            return;
          ...
          if (i?.plugin.installed !== !0) {
            ...
            m.get(M).danger(h.formatMessage(Qe.authFailure));
            return;
          }
          if (!i.plugin.enabled) {
            await P(i);
          ...
          m.get(M).danger(
            e instanceof Ee
              ? h.formatMessage(Qe.authFailure)
              : h.formatMessage(
                  {
...
async function $e({ params: e, queryClient: t, signal: n }) {
  let r = f(`open-in-targets`, e),
    i = await d(`open-in-targets`, { params: e });
    ...
    await Promise.all(
      i.targets.map(async (e) => {
        ...
        try {
          ...
          et(t, r, e.id, n, { available: !1, resolvedIcon: null });
          return;
        }
        if (
          (et(t, r, e.id, n, { available: i, ...(i ? {} : { resolvedIcon: null }) }),
          !(!i || n?.aborted))
        )
          try {
            let { icon: i } = await a.loadTargetIcon({ target: e.target });
            et(t, r, e.id, n, { resolvedIcon: i });
          } catch {
            et(t, r, e.id, n, { resolvedIcon: null });
          }
      }),
    ),
    t.getQueryData(r) ?? i
...
function tt(e) {
  ...
  t[12] !== r || t[13] !== a || t[14] !== o
    ? ((m = rt({ cwd: r, hostId: a, openPath: o })),
      (t[12] = r),
      (t[13] = a),
      (t[14] = o),
      (t[15] = m))
...
function nt(e) {
  let t = (0, Z.c)(25),
    ...
    s;
  t[0] !== n || t[1] !== i || t[2] !== a
    ? ((s = rt({ cwd: n, hostId: i, openPath: a })), (t[0] = n), (t[1] = i), (t[2] = a), (t[3] = s))
    : (s = t[3]);
  let c = s,
    l = o <= 0,
    u;
...
function rt({ cwd: e, hostId: t, openPath: n }) {
  return !!(e ?? n);
}
function it(e) {
  let t = (0, Z.c)(14),
    { turnId: n, cwd: r, deferEnrichment: s, hostId: l, openPath: u, targets: d } = e,
    m = c(),
    h = i(o),
    g = C(),
    _;
  ...
  return (
    ...
    t[12] !== n
      ? ((x = (e, t) => {
          let { appPath: i, openMode: a, persistPreferred: o, line: c, column: p, path: h } = t,
            g = h ?? u ?? r;
          g &&
            (d?.find((t) => t.target === e && (t.appPath ?? null) === (i ?? null))?.kind ===
              `editor` &&
              b != null &&
              n != null &&
              y.submitCodexAnalyticsEvent?.({
                action: `open_in_ide`,
                eventKind: `action`,
                metadata: { target: e },
                threadId: b.threadId,
            ...
            v({
              ...
              ...(p == null ? {} : { column: p }),
              ...(a == null ? {} : { openMode: a }),
              ...(o && r ? { persistPreferredTargetPath: r } : {}),
              ...(l == null ? {} : { hostId: l }),
            }));
        }),
        (t[3] = r),
...
function at(e) {
  ...
  t[0] !== n || t[1] !== s || t[2] !== i || t[3] !== o
    ? ((u = { cwd: n, hostId: i, path: o, ...(s ? { deferEnrichment: !0 } : {}) }),
      (p = h),
      (d = f(`open-in-targets`, u)),
      (t[0] = n),
      (t[1] = s),
      (t[2] = i),
      (t[3] = o),
  ...
  t[7] !== u || t[8] !== l
    ? ((g = (e) => {
        let { signal: t } = e;
        return ot({ params: u, queryClient: l, signal: t });
      }),
      (t[7] = u),
      (t[8] = l),
      (t[9] = g))
  ...
  t[10] !== n || t[11] !== i || t[12] !== a || t[13] !== o
    ? ((_ = rt({ cwd: n, hostId: i, openPath: o }) && a),
      (t[10] = n),
      (t[11] = i),
      (t[12] = a),
      (t[13] = o),
  ...
  let v;
  return (
    t[15] !== d || t[16] !== g || t[17] !== _
      ? ((v = { queryKey: d, queryFn: g, enabled: _, staleTime: m.ONE_MINUTE }),
        (t[15] = d),
        (t[16] = g),
        (t[17] = _),
        (t[18] = v))
...
async function ot({ params: e, queryClient: t, signal: n }) {
  if (e.deferEnrichment) return $e({ params: e, queryClient: t, signal: n });
  if (st(e.path)) {
    let n = await d(`open-in-targets`, { params: { ...e, nativeBrowserDiscovery: `known` } });
    n.targets.some((e) => e.kind === `native` && e.appPath != null) &&
      t.setQueryData(f(`open-in-targets`, e), n);
  }
  return d(`open-in-targets`, { params: e });
}
function st(e) {
  if (e == null) return !1;
  if (y(e) || b(e)) return !0;
...
var ct = [25, 50, 100, 150, 200],
  lt = ct,
  ut = 10,
  dt = 400,
  ft = 0.01;
function pt(e) {
  return Math.min(dt, Math.max(ut, e));
}
function mt(e, t) {
  return pt(Math.round(e * Math.exp(-t * ft)));
}
function ht({ initialDistance: e, initialZoomPercent: t, nextDistance: n }) {
  return pt(Math.round((n / e) * t));
}
function gt(e, t, n, r) {
  let i = e - n,
    a = t - r;
...
function vt(e) {
  ...
  t[5] === r
    ? (u = t[6])
    : ((u = (0, Q.jsx)(`div`, { className: `min-w-0 justify-self-center`, children: r })),
      (t[5] = r),
      (t[6] = u));
  let d;
  t[7] === o
...
function yt(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Q.jsx)(k, { className: `icon-2xs rotate-180` })), (t[4] = f))
    : (f = t[4]);
  let p;
  t[5] !== i || t[6] !== c || t[7] !== d
    ? ((p = (0, Q.jsx)(E, {
  ...
  let m;
  t[9] !== c || t[10] !== p
    ? ((m = (0, Q.jsx)(j, { tooltipContent: c, children: p })),
      (t[9] = c),
      (t[10] = p),
      (t[11] = m))
    : (m = t[11]);
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Q.jsx)(k, { className: `icon-2xs` })), (t[15] = _))
    : (_ = t[15]);
  let v;
  ...
  let y;
  t[20] !== u || t[21] !== v
    ? ((y = (0, Q.jsx)(j, { tooltipContent: u, children: v })),
      (t[20] = u),
      (t[21] = v),
      (t[22] = y))
    : (y = t[22]);
  ...
  return (
    t[23] !== y || t[24] !== m || t[25] !== h
      ? ((b = (0, Q.jsxs)(`div`, { className: `flex items-center gap-0.5`, children: [m, h, y] })),
        (t[23] = y),
        (t[24] = m),
        (t[25] = h),
        (t[26] = b))
...
function bt(e) {
  ...
  t[0] === o
    ...
    : ((c = (0, Q.jsx)(`span`, {
        ...
        children: (0, Q.jsx)(wt, { zoomPercent: o }),
      })),
      (t[0] = o),
      (t[1] = c));
  let l;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(z, { className: `icon-sm` })), (t[2] = l))
    : (l = t[2]);
  let u;
  t[3] !== c || t[4] !== i
    ? ((u = (0, Q.jsxs)(E, {
      ...
      ? ((e = (e) =>
          (0, Q.jsx)(
            J.Item,
            {
              ...
              children: (0, Q.jsx)(wt, { zoomPercent: e }),
            },
            e,
          )),
        (t[11] = n?.selected),
...
function xt(e) {
  let t = (0, Z.c)(69),
    ...
    [y, b] = (0, $.useState)(!1),
    x;
  t[0] === i ? (x = t[1]) : ((x = { hostId: i }), (t[0] = i), (t[1] = x));
  let {
      clearConnectingApp: S,
      connectingApp: T,
    ...
    O;
  t[2] !== l || t[3] !== i || t[4] !== o
    ? ((O = { cwd: l, hostId: i, openPath: o }), (t[2] = l), (t[3] = i), (t[4] = o), (t[5] = O))
    : (O = t[5]);
  let {
      canLoadTargets: k,
      preferredTarget: A,
  ...
  if (
    ...
    let e = fe({ targets: j, availableTargets: M, includeHiddenTargets: !0, mode: N }),
      r = pe({ preferredTarget: A, targets: j, availableTargets: M, mode: N }),
      s = e.filter(St),
      c;
    (t[33] === o ? (c = t[34]) : ((c = Ae(o)), (t[33] = o), (t[34] = c)), (z = c != null));
    let p;
    t[35] === f
      ? (p = t[36])
      : ((p = f.formatMessage({
    ...
    let C = S,
      T;
    t[39] !== i || t[40] !== C || t[41] !== m || t[42] !== o
      ? ((T = () => {
          C(() => {
            m.mutate({ cwd: null, hostId: i, path: o, target: `fileManager` });
          });
        }),
        (t[39] = i),
        (t[40] = C),
    ...
    let E = T,
      O;
    t[44] !== L || t[45] !== C || t[46] !== o
      ? ((O = (e, t) => {
          C(() => {
            L(e.target, { appPath: e.appPath, path: o, persistPreferred: t && me(e) });
          });
        }),
        (t[44] = L),
        (t[45] = C),
    ...
    t[55] !== h
      ? ((U =
          k && (h || !P || I)
            ? (0, Q.jsx)(nt, { cwd: l, delayMs: h ? 0 : _t, hostId: i, openPath: o })
            : null),
        (t[49] = k),
        (t[50] = l),
        (t[51] = P),
    ...
    ((B = ne),
      (V = y
        ...
        : (0, Q.jsx)(we, {
            ...
            primaryAriaLabel: r == null ? x : K,
            secondaryAriaLabel: ie,
            secondaryTooltipContent: ie,
            tooltipContent: K,
                ...
                z
                  ? (0, Q.jsx)(Ge, {
                      analyticsClickSource:
                        te.CODEX_GOOGLE_WORKSPACE_RESOURCE_CLICK_SOURCE_ARTIFACT_PREVIEW_EXPORT_MENU,
                      analyticsContext: n,
                      handleConnectApp: D,
                      hostId: i,
                      isOpening: y,
            ...
            children: (0, Q.jsxs)(`span`, {
              ...
              children: [
                r == null
                  ? null
                  : (0, Q.jsx)(`img`, { alt: ``, src: r.icon, className: `icon-sm` }),
                r == null || d
                  ? (0, Q.jsx)(`span`, {
      ...
      (t[31] = B),
      (t[32] = V));
  } else ((z = t[30]), (B = t[31]), (V = t[32]));
  let H;
  t[59] !== z || t[60] !== S || t[61] !== T || t[62] !== E || t[63] !== i
    ? ((H =
        z && T != null
          ? (0, Q.jsx)(Ke, { app: T, hostId: i, onClose: S, onOAuthStarted: E })
          : null),
      (t[59] = z),
      (t[60] = S),
      (t[61] = T),
  ...
  let U;
  return (
    t[65] !== B || t[66] !== V || t[67] !== H
      ? ((U = (0, Q.jsxs)(Q.Fragment, { children: [B, V, H] })),
        (t[65] = B),
        (t[66] = V),
        (t[67] = H),
        (t[68] = U))
...
function Ct({ hostId: e, path: t, sizeBytes: n }) {
  let r = i(o),
    a = C(),
    c = s(e),
    [l, u] = (0, $.useState)(!1),
  ...
  if (e === `local` || (n != null && n > 47185920 && !v(c))) return null;
  let h = async () => {
    u(!0);
    try {
      let { sizeBytes: n } = await d(`read-file-metadata`, { params: { hostId: e, path: t } });
      if ((n == null || n > 47185920) && v(c)) {
        await d(`save-file`, {
          params: { kind: `remote-file`, hostId: e, sourcePath: t, suggestedFilename: F(t) },
        });
        return;
      }
      ...
      if (r == null) return;
      await d(`save-file`, {
        params: { kind: `contents`, suggestedFilename: F(t), contentsBase64: r },
      });
    } catch {
      r.get(M).danger(m);
    } finally {
  ...
  return (0, Q.jsx)(j, {
    ...
    children: (0, Q.jsx)(E, {
      ...
      children: l ? null : (0, Q.jsx)(ue, { className: `icon-sm` }),
    }),
  });
}
function wt(e) {
...
var Et = e(x(), 1),
  Dt = 200,
  Ot = `no-drag pointer-events-auto flex cursor-interaction items-center justify-center rounded-full bg-token-editor-background/95 text-token-foreground shadow-md ring-1 ring-black/5 backdrop-blur-sm transition-transform hover:bg-token-menu-background hover:ring-token-focus-border focus:outline-none focus-visible:ring-1 focus-visible:ring-token-focus-border active:scale-95 disabled:cursor-not-allowed disabled:opacity-50`,
  kt = T(Ot, `h-10 min-w-10 px-3`);
function At({
  src: e,
  alt: t,
  bottomContent: n,
  ...
  zoomControlsPlacement: M = `bottom`,
}) {
  let F = C(),
    [I, L] = (0, $.useState)(null),
    [R, ee] = (0, $.useState)(null),
    [z, B] = (0, $.useState)(null),
    [te, V] = (0, $.useState)(null),
    H = (0, $.useRef)(null),
    U = (0, $.useRef)(null),
    ne = (0, $.useRef)(null),
    W = (0, $.useRef)(new Map()),
    ...
    fe = te?.src === e ? te : null,
    pe = Mt({ naturalSize: fe, previewViewportSize: R }),
    me = z?.src === e ? z.zoomPercent : null,
    q = me ?? pe,
    _e = Ft(pe),
    ve = _e[0] ?? q,
    J = _e.at(-1) ?? q,
    Se = q == null ? null : F.formatNumber(q / 100, { style: `percent`, maximumFractionDigits: 0 }),
    Ce = Ht(e, t),
    we = (e) => {
    ...
    Te = q != null && ve != null && q > ve,
    Ee = q != null && J != null && q < J,
    De = r?.trim() || null,
    Oe = E != null || w != null,
    ke = () => {
      (W.current.clear(), (G.current = null), (K.current = null), B(null));
    },
    Ae = () => {
      E != null && (ke(), E());
    },
    ...
    X = (0, $.useCallback)((e) => {
      ...
      ee((e) => (e?.width === t && e.height === n ? e : { width: t, height: n }));
    }, []),
    Me = (0, $.useCallback)(
      (t) => {
        let n = jt(t);
        return n == null ? !1 : (I != null && X(I), V({ src: e, ...n }), !0);
      },
      [I, e, X],
    ),
    Ne = (0, $.useCallback)(
  ...
  if (q != null && fe != null) {
    let e = q / 100;
    Fe = { width: `${fe.width * e}px`, height: `${fe.height * e}px` };
  }
  let Ie = ({ clientX: t, clientY: n, zoomPercent: r }) => {
      let i = H.current;
      if (I == null || i == null) {
        B({ src: e, zoomPercent: r });
        return;
      }
      let a = i.getBoundingClientRect(),
        o = a.width > 0 ? Vt((t - a.left) / a.width) : 0.5,
        s = a.height > 0 ? Vt((n - a.top) / a.height) : 0.5;
      if (
        ((0, Et.flushSync)(() => {
          B({ src: e, zoomPercent: r });
        }),
      ...
      ((I.scrollLeft += c.left + c.width * o - t), (I.scrollTop += c.top + c.height * s - n));
    },
    Le = (t) => {
      if (I == null) {
        B({ src: e, zoomPercent: t });
        return;
      }
      let n = I.getBoundingClientRect();
      Ie({ clientX: n.left + n.width / 2, clientY: n.top + n.height / 2, zoomPercent: t });
    },
    Re = (e) => {
      q != null && Le(Pt({ currentZoomPercent: q, direction: e, zoomRamp: _e }));
    },
    ze = () => {
      (B(null), I != null && ((I.scrollLeft = 0), (I.scrollTop = 0)));
    },
    Be = A((e) => {
      switch (e.type) {
        case `step-zoom`:
    ...
    Ve = A((e) => {
      if (!e.ctrlKey || q == null) return;
      (e.preventDefault(), e.stopPropagation());
      let t = It({
        maximumZoomPercent: J,
        minimumZoomPercent: ve,
        zoomPercent: q * Math.exp(-Lt(e) / Dt),
      });
      if (t == null || t === q) return;
      let n = Rt({ event: e, fallbackPoint: ne.current, previewViewportNode: I });
      Ie({ clientX: n.clientX, clientY: n.clientY, zoomPercent: t });
    }),
    He = (0, $.useCallback)(
      (e) => {
        let t = U.current;
        if (t !== e) {
          if ((t?.removeEventListener(`wheel`, Ve), (U.current = e), L(e), e == null)) {
            ee(null);
            return;
          }
          (e.addEventListener(`wheel`, Ve, { passive: !1 }), X(e));
        }
      },
      [Ve, X],
    ),
    Ue = (e) => {
      if (((ne.current = { clientX: e.clientX, clientY: e.clientY }), e.pointerType !== `touch`))
        return;
      if (
        (typeof e.currentTarget.setPointerCapture == `function` &&
          e.currentTarget.setPointerCapture(e.pointerId),
        W.current.set(e.pointerId, { clientX: e.clientX, clientY: e.clientY }),
        W.current.size === 1 && I != null)
      ) {
        G.current = {
      ...
      G.current = null;
      let t = Bt(W.current);
      K.current = t == null || q == null ? null : { distance: t.distance, zoomPercent: q };
    },
    We = (e) => {
      if (
        ((ne.current = { clientX: e.clientX, clientY: e.clientY }),
        e.pointerType === `touch` && W.current.has(e.pointerId))
      ) {
        if (
          (W.current.set(e.pointerId, { clientX: e.clientX, clientY: e.clientY }),
          W.current.size > 1)
        ) {
          (e.preventDefault(), e.stopPropagation(), (G.current = null));
          let t = K.current,
            n = Bt(W.current);
          ...
          if (r == null || r === q) return;
          Ie({ clientX: n.clientX, clientY: n.clientY, zoomPercent: r });
          return;
        }
        I == null ||
          G.current == null ||
          (G.current.pointerId === e.pointerId &&
            (e.preventDefault(),
            e.stopPropagation(),
            (I.scrollLeft = G.current.scrollLeft - (e.clientX - G.current.clientX)),
            (I.scrollTop = G.current.scrollTop - (e.clientY - G.current.clientY))));
      }
    },
    Z = (e) => {
      if (e.pointerType !== `touch`) return;
      if (
        (W.current.delete(e.pointerId),
      ...
      let t = W.current.entries().next().value;
      if (W.current.size === 1 && t != null) {
        let [e, n] = t;
        ((G.current =
          I == null
            ? null
      ...
      let n = Bt(W.current);
      ((G.current = null),
        (K.current = n == null || q == null ? null : { distance: n.distance, zoomPercent: q }));
    };
  ((0, $.useEffect)(() => {
    if (!i) return;
    let e = be(),
    ...
    (0, $.useEffect)(() => {
      if (I == null || (X(I), typeof ResizeObserver > `u`)) return;
  ...
  let Ge = (0, Q.jsxs)(`div`, {
    className: T(
      ...
      M === `bottom` && `pb-8`,
      !y && `pt-12`,
      !y && (Oe ? `px-16 sm:px-20` : `px-4 sm:px-8`),
    ),
    onPointerDown: (e) => {
      y || e.target !== e.currentTarget || Y(!1);
    },
    children: [
      j && M === `header`
        ? (0, Q.jsx)(vt, {
            ...
            hideMetadata: !0,
            title: t,
            rightContent: (0, Q.jsx)(bt, {
              fitOption: { selected: me == null, onSelect: ze },
              triggerTestId: `image-preview-zoom-trigger`,
              zoomPercent: Math.round(q ?? 100),
              onZoomPercentChange: Le,
            }),
          })
        : null,
      y
        ...
        : (0, Q.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, Q.jsx)(`button`, {
                ...
                children: (0, Q.jsx)(N, { className: `icon-sm` }),
              }),
            ],
          }),
      E == null
        ...
        : (0, Q.jsx)(`button`, {
            type: `button`,
            className: T(kt, `absolute top-1/2 left-3 z-10 -translate-y-1/2 p-0`),
            "aria-label": ce,
            onClick: (e) => {
            ...
            children: (0, Q.jsx)(le, { className: `icon-sm` }),
          }),
      w == null
        ? null
        : (0, Q.jsx)(`button`, {
            type: `button`,
            className: T(kt, `absolute top-1/2 right-3 z-10 -translate-y-1/2 p-0`),
            "aria-label": de,
            onClick: (e) => {
            ...
            children: (0, Q.jsx)(le, { className: `icon-sm rotate-180` }),
          }),
      (0, Q.jsxs)(`div`, {
        ref: He,
        ...
        children: [
          y
            ...
            : (0, Q.jsx)(he, {
                asChild: !0,
                children: (0, Q.jsx)(`h2`, { className: `sr-only`, children: re }),
              }),
          o ??
            (0, Q.jsx)(
              `img`,
              {
                ...
                className: T(
                  ...
                  Fe == null ? `max-h-full max-w-full` : `block max-w-none`,
                ),
                style: Fe,
                decoding: m,
                draggable: h,
                ...
                ? (0, Q.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, Q.jsx)(`div`, {
                        ...
                        children: (0, Q.jsx)(`span`, { children: Se }),
                      }),
                      (0, Q.jsx)(`button`, {
                        type: `button`,
                        className: `no-drag flex size-9 cursor-interaction items-center justify-center rounded-full bg-token-foreground/10 focus:outline-none focus-visible:ring-1 focus-visible:ring-token-focus-border disabled:cursor-not-allowed disabled:opacity-50`,
                        ...
                        children: (0, Q.jsx)(P, { className: `icon-xs` }),
                      }),
                    ],
                  })
                : null,
  ...
  return y
    ...
    : (0, Q.jsx)(ge, {
        ...
        overlayClassName: T(`!bg-black/90`, f && `!animate-none`),
        portalContainer: D,
        showDialogClose: !1,
        triggerContent: s,
        viewportSized: !0,
...
function Mt({ naturalSize: e, previewViewportSize: t }) {
...
function Pt({ currentZoomPercent: e, direction: t, zoomRamp: n }) {
  if (t === `in`) {
...
function It({ maximumZoomPercent: e, minimumZoomPercent: t, zoomPercent: n }) {
...
function Rt({ event: e, fallbackPoint: t, previewViewportNode: n }) {
  let r = { clientX: e.clientX, clientY: e.clientY };
  if (n == null) return r;
  let i = n.getBoundingClientRect();
  return (r.clientX !== 0 || r.clientY !== 0) && zt(r, i)
    ? r
    : t != null && zt(t, i)
      ? t
...
//# sourceMappingURL=image-preview-dialog-Bb-vTCJ6.js.map
