...
import { a as w, d as T, r as E, u as D } from "./codex-mobile-setup-dialog-DkK-zmuG.js";
...
function N() {
  let e = (0, F.c)(8),
    ...
    [r] = x(D),
    i;
  e[0] === t ? (i = e[1]) : ((i = u(t)), (e[0] = t), (e[1] = i));
  let { data: o, isError: s, isFetching: l, isPending: d } = m(i);
  if (d || n == null) return null;
  let h;
  return (
    e[2] !== s || e[3] !== l || e[4] !== o || e[5] !== n.status || e[6] !== r
      ? ((h = (0, L.jsx)(P, {
...
//# sourceMappingURL=codex-mobile-page-DD-HzNwZ.js.map
