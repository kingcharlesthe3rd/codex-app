...
import { n as s } from "./marked.esm.js";
import { n as c, r as l } from "./chunk-4.js";
import { L as u, P as d, k as f, s as p, y as m } from "./chunk-100.js";
import { i as h } from "./chunk-56.js";
var g = {
...
`)
          .forEach((e, n) => {
            (n !== 0 && (a++, i.push([])),
              e.split(` `).forEach((e) => {
                ((e = e.replace(/&#39;/g, `'`)), e && i[a].push({ content: e, type: t }));
              }));
          })
...
var U = c(
  async (
    ...
    if ((l.debug(`XYZ createText`, n, r, i, a, o, c, `addSvgBackground: `, d), o)) {
      ...
      return await F(
        t,
        { isNode: c, label: f(n) ? i : e, labelStyle: r.replace(`fill:`, `color:`) },
        u,
        a,
        d,
        p,
      ...
      let a = h(n.replace(/<br\s*\/?>/g, `<br/>`)),
        o = z(u, t, s ? T(a.replace(`<br>`, `<br/>`), p) : w(a), n ? d : !1, !c);
      if (c) {
