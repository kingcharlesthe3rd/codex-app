...
import { cr as i, po as a } from "./app-server-manager-signals.js";
...
import { t as x } from "./useQueries.js";
import { f as S } from "./chunk-8.js";
import { o as C, p as w } from "./statsig.js";
import { _ as T } from "./config-queries.js";
import { t as E } from "./use-debounced-value.js";
import { t as D } from "./startCase-Bo0-xpFk.js";
import { E as O, T as k, _ as A, l as j, p as M, v as N } from "./mention-item.js";
import { t as P } from "./apps.js";
import { t as F } from "./plugin-install-store.js";
import { t as I } from "./use-platform.js";
import { m as L, v as R } from "./use-plugins.js";
import { i as ee, l as te, u as ne } from "./mcp-capability-signals.js";
import {
  a as z,
  c as re,
  f as ie,
...
import { t as xe } from "./use-workspace-file-search.js";
...
function Ae(e) {
  ...
  return { cells: r, color: Pe(n), scanCells: Ne(i) };
}
function je(e) {
  let t = De;
  for (let n = 0; n < e.length; n += 1) t = (t * Oe + e.charCodeAt(n)) % Ee;
  return t;
}
function Me(e, t) {
...
function Pe(e) {
  return Fe(Math.floor((e / Ee) * ke.length));
}
function Fe(e) {
  return ke[e % ke.length] ?? `var(--color-token-charts-yellow)`;
}
var Ie = {
...
function Le(e) {
  ...
  if (t[5] !== o || t[6] !== n || t[7] !== r || t[8] !== i) {
    let e = Ae(i);
    ((s = r),
      t[17] === n ? (l = t[18]) : ((l = c(`shrink-0`, n)), (t[17] = n), (t[18] = l)),
      (u = `-2 -1 24 24`),
      (d = `none`),
      (f = `crispEdges`),
      ...
      (m = e.cells.map((t) =>
        (0, q.jsx)(
          `rect`,
          {
            className: o ? Ie.filledScanCell : void 0,
            x: t.column * J,
            y: t.row * J,
            width: J,
            height: J,
...
function ze(e) {
  let t = (0, K.c)(10),
    ...
    c;
  t[0] !== r || t[1] !== a || t[2] !== o
    ? ((c = Be({ isLoading: r, query: a, resultCount: o })),
      (t[0] = r),
      (t[1] = a),
      (t[2] = o),
      (t[3] = c))
...
function Be({ isLoading: e, query: t, resultCount: n }) {
...
function Ve(e) {
  ...
  if (o === `expandedTopTray` || l || Ce(s.pathname)) {
    let e;
    t[0] === r
      ? (e = t[1])
...
function Ue(e) {
  let t = (0, K.c)(6),
    ...
    o = S(),
    s =
      a === `expandedTopTray` || a === `embeddedExpandedTopTray` || Ce(o.pathname)
    ...
    l;
  t[0] !== r || t[1] !== s ? ((l = c(s, r)), (t[0] = r), (t[1] = s), (t[2] = l)) : (l = t[2]);
  let u;
  return (
    t[3] !== n || t[4] !== l
...
var Ke = 8,
  qe = `--composer-top-menu-max-height`;
function Je(e) {
  let t = (0, K.c)(4),
        ...
        let e = null,
          ...
          i = () => {
            let e = n.getBoundingClientRect(),
              ...
              i = `${Math.max(0, Math.floor(r - 46 - Ke))}px`;
            i !== t && ((t = i), n.style.setProperty(qe, i));
          },
          a = () => {
...
function Xe(e) {
  ...
  let { installedPlugins: c } = L(r, void 0, s),
    l,
    u;
  return (
    t[2] !== o || t[3] !== r || t[4] !== c || t[5] !== i
      ? ((l = () => {
          let e = o ? c.filter(Qe) : [];
          (i.set(ne, r, e), i.set(ee, r, e.flatMap(Ze)));
        }),
        (u = [o, r, c, i]),
        (t[2] = o),
        (t[3] = r),
...
var $e = v(d, ({ hostId: e, path: t, query: n, servers: r }, { scope: i }) => ({
  queryKey: [`mcp-capability-mentions`, e, et(r), t, n],
...
function tt({ installedPlugins: e, pluginSections: t, query: n, servers: r }) {
  if (r.length === 0) return t;
  let i = at({ installedPlugins: e, query: n, servers: r });
  if (i.length === 0) return t;
  let a = new Set(i.map(({ pluginId: e }) => `plugin:${N(e)}`)),
    o = i.map(({ item: e }) => e),
    s = !1,
    c = t.map((e) =>
      e.id === `plugins`
        ? ((s = !0), { ...e, items: [...o, ...e.items.filter(({ key: e }) => !a.has(e))] })
        : e,
    );
  return s
    ? c
...
function nt({ isLoading: e, mentionSource: t, results: n, servers: r }) {
  let i = t.path.at(-1)?.title ?? t.pluginLabel,
    a = r.length > 1;
  return ot({ results: n, servers: r }).flatMap(({ items: n, server: r, serverTitle: o }) => {
    let s = n == null ? void 0 : st({ items: n, mentionSource: t, server: r });
        ...
        ? [
            {
              ...
              items: s ?? [],
              emptyState: e && s == null ? ut.appPluginsLoading : null,
              isLoading: e,
              showTitle: !0,
            },
          ]
...
function at({ installedPlugins: e, query: t, servers: n }) {
...
function ot({ results: e, servers: t }) {
  let n = new Map(e?.map(({ items: e, server: t }) => [t, e]));
  return t.map(({ server: e, serverTitle: t }) => ({ items: n.get(e), server: e, serverTitle: t }));
}
function st({ items: e, mentionSource: t, server: n }) {
  return e.map((e, r) => {
    switch (e.type) {
      case `group`:
        return {
          detail: null,
          insertMention: it({ ...t, path: [...t.path, e], server: n }),
...
var Z = e(ge(), 1);
function ft({ backgroundAgents: e, excludedConversationIds: t = [], query: n }) {
  if (e.length === 0) return null;
  let r = e.filter((e) => !t.includes(e.conversationId)),
    i = n.trim(),
    a = i.length === 0 ? r : pt(r, i).filter((e) => ht(e, i) > 0);
  return {
    sections: [
      {
        id: `agents`,
        ...
        items: a.map((e) => ({
          ...
          label: e.displayName,
          detail: e.agentRole,
          iconElement: (0, Y.createElement)(Le, {
...
function pt(e, t) {
  return (0, Z.default)(
    e.map((e, n) => ({ agent: e, score: ht(e, t), index: n })),
...
var gt = e(D(), 1);
function _t({ agents: e, query: t }) {
  if (e.length === 0) return null;
  let n = t.trim(),
    r = n.length === 0 ? e : vt(e, n).filter((e) => yt(e, n) > 0);
  return {
    sections: [
      {
        id: `custom-agents`,
...
function vt(e, t) {
  return (0, Z.default)(
    e.map((e, n) => ({ agent: e, score: yt(e, t), index: n })),
...
function yt(e, t) {
  return Math.max(
    ...
    H(`@${e.roleName}`, t),
    H(e.description ?? ``, t),
    ...e.nicknameCandidates.map((e) => H(e, t)),
  );
}
var bt = [],
  xt = { sections: [] };
function St(e) {
  ...
  let { files: c, isLoading: u } = xe(s),
    d = i.trim();
  if (a == null || a.length === 0) return xt;
  let f = null;
  if (d.length === 0) {
    let e;
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (p = t[6]);
  let m;
  t[7] === c ? (m = t[8]) : ((m = c == null ? bt : c.map(Ct)), (t[7] = c), (t[8] = m));
  let h = u || o,
    g;
  return (
    t[9] !== f || t[10] !== p || t[11] !== m || t[12] !== h
      ? ((g = { sections: [{ id: `files`, title: p, items: m, emptyState: f, isLoading: h }] }),
        (t[9] = f),
        (t[10] = p),
        (t[11] = m),
        (t[12] = h),
...
function wt(e) {
  ...
  let { nativeApps: p, isLoading: m } = ue(f),
    h;
  t[2] === c ? (h = t[3]) : ((h = kt(c)), (t[2] = c), (t[3] = h));
  let v = h,
    b = s.formatMessage({
    ...
    C = p.find(Dt) ?? null,
    w =
      l.length > 0 && S != null && Ot(S, l)
        ? {
            kind: `chrome-plugin`,
            plugin: S,
            mention: { ...z(S, a), name: V, displayName: V, description: b },
    ...
    T =
      l.length === 0 || r == null
        ...
        : p
            ...
            .filter((e) => At(e.app.displayName, l)),
    E = [...(w == null ? [] : [w]), ...T].slice(0, 2),
    D = E.flatMap(Et),
    O = x({
      queries: D.map((e) => ({
        queryKey: y(`computer-use-native-desktop-app-icon`, { appPath: e.appPath }),
        queryFn: () =>
          _(`computer-use-native-desktop-app-icon`, { params: { appPath: e.appPath } }),
        enabled: r != null,
  ...
  let A = v.title,
    j = E.map((e) => {
      ...
      let t = O[D.indexOf(e.app)]?.data?.iconSmall ?? ``,
        n = se({ app: e.app, description: b, computerPlugin: e.plugin, iconSmall: t });
      return {
    ...
    M;
  t[4] !== m || t[5] !== O
    ? ((M = m || O.some(Tt)), (t[4] = m), (t[5] = O), (t[6] = M))
    : (M = t[6]);
  let N;
  return (
    t[7] !== k || t[8] !== j || t[9] !== M || t[10] !== v.title
      ? ((N = { id: `native-apps`, title: A, items: j, emptyState: k, isLoading: M }),
        (t[7] = k),
        (t[8] = j),
        (t[9] = M),
        (t[10] = v.title),
...
function Ot(e, t) {
  return Math.max(H(e.plugin.name, t), H(e.displayName ?? ``, t), H(V, t), H(`@${V}`, t)) > 0;
}
function kt(e) {
  return e === `macOS`
...
function Pt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = { installSuggestionPluginNames: jt }), (t[0] = c))
    : (c = t[0]);
  let { availablePlugins: d, isLoading: f } = L(n, i, c),
    p = !s,
    m;
  t[1] === p ? (m = t[2]) : ((m = { enabled: p }), (t[1] = p), (t[2] = m));
  let { availablePlugins: h, isLoading: g } = L(n, i, m),
    _ = [...d];
  if (!s) {
    let e = new Set(d.map(It));
    for (let t of h) {
      let n = It(t);
  ...
  let v = f || (!s && g),
    ...
    E = T ? Rt(S) : [],
    D = new Set(E),
    O = T ? S.filter((e) => !D.has(e) && (e.plugin.installed || !Lt(e))) : S,
    k;
  t[3] === y
    ? (k = t[4])
    : ((k = (e) => {
  ...
  let j = k,
    M = wt({
      chromeAppPlugins: E,
      computerUsePlugin: w,
      onPluginMentionInserted: j,
      pluginMentionLabels: b,
      query: r,
    }),
    N = x.length === 0 ? O : Bt(O, x, b).filter((e) => Vt(e, x, b) > 0),
    P = v && N.length === 0;
  if (N.length === 0 && !P && M == null) {
    let e;
    return (
      t[5] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = { sections: [] }), (t[5] = e))
        ...
        items: N.map((e) => {
          ...
          return {
            ...
            insertMention: (n) => {
              ...
              (r.insertMentionFromAtMention(t, i), j(e));
            },
          };
        }),
        emptyState: n,
  ...
  return (M != null && R.push(M), { sections: R });
}
function Ft(e) {
  return e.plugin.availability === Mt
    ? !1
    : e.plugin.enabled
      ? !0
      : !e.plugin.installed && jt.includes(e.plugin.name);
}
function It(e) {
...
function Rt(e) {
  let t = R(),
    ...
    i = zt(t);
  return (0, Z.default)(
    e.filter((e) => Lt(e) && e.marketplaceName === n),
...
function Bt(e, t, n) {
  return (0, Z.default)(
    e.map((e, r) => ({ plugin: e, score: Vt(e, t, n), index: r })),
    [(e) => -e.score, (e) => z(e.plugin, n).displayName, (e) => e.index],
  ).map((e) => e.plugin);
}
function Vt(e, t, n) {
  let r = z(e, n);
  return Math.max(
    ...
    H(r.displayName, t),
    H(`@${r.displayName}`, t),
    H(`@${e.displayName ?? e.plugin.name}`, t),
  );
}
function Ht(e) {
  let t = (0, K.c)(14),
  ...
  let { installedPlugins: f, isLoading: p } = L(n ?? `local`, i, d),
    m = new Set(f.map(Wt)),
    h = R();
  if (!o) {
    let e;
  ...
  return (
    t[9] !== u || t[10] !== v || t[11] !== y || t[12] !== b
      ? ((x = { sections: [{ id: `skills`, title: v, items: y, emptyState: b, isLoading: u }] }),
        (t[9] = u),
        (t[10] = v),
        (t[11] = y),
        (t[12] = b),
...
function Gt(e, t, n, r = null) {
  if (!e.enabled || !Re(e, r)) return !1;
  let a = i(e.path)?.pluginId;
  return a == null || !Q.includes(a) || (!n && !t.has(a));
}
function Kt(e, t) {
  return (0, Z.default)(
    e.map((e, n) => ({ skill: e, score: qt(e, t), index: n })),
    [
      (e) => -e.score,
      (e) =>
...
function qt(e, t) {
  return Math.max(H(e.name, t), H(e.displayName ?? ``, t), H(`@${e.displayName ?? e.name}`, t));
}
function Jt(e, t) {
...
function Yt(e) {
  ...
  let g = St(m),
    ...
    b;
  t[5] !== i || t[6] !== s || t[7] !== y
    ? ((b = { hostId: i, query: s, roots: y }), (t[5] = i), (t[6] = s), (t[7] = y), (t[8] = b))
    : (b = t[8]);
  let x = tt({ installedPlugins: v, pluginSections: Pt(b).sections, query: s, servers: _ }),
    S;
  t[9] !== i || t[10] !== s || t[11] !== o
    ? ((S = { hostId: i, query: s, roots: o }), (t[9] = i), (t[10] = s), (t[11] = o), (t[12] = S))
    : (S = t[12]);
  let C = Ht(S),
    { data: w, isLoading: D } = T(a, d),
    O = new Set(
      c.flatMap((e) => (e.agentRole == null || u.includes(e.conversationId) ? [] : [e.agentRole])),
    ),
    k = w?.roles.filter((e) => !O.has(e.roleName)) ?? [],
    A = ft({ backgroundAgents: c, excludedConversationIds: u, query: s }),
    j = d ? _t({ agents: k, query: s }) : null,
    M = A?.sections[0] ?? null,
    N = j?.sections[0] ?? null,
    P = [...(M?.items ?? []), ...(N?.items ?? [])],
    F =
    ...
    I = Zt(Xt(dt([F == null ? null : { sections: [F] }, { sections: x }, C, g]), s)),
    L;
...
var $t = { loadingBar: `_loadingBar_1g9nv_1`, "loading-bar-slide": `_loading-bar-slide_1g9nv_1` };
function en(e) {
  let t = (0, K.c)(29),
    {
      backgroundAgents: n,
...
function tn(e) {
  ...
  let { sections: u } = Yt(l),
    d;
  t[15] === a ? (d = t[16]) : ((d = (0, q.jsx)(Xe, { hostId: a })), (t[15] = a), (t[16] = d));
  let f;
  t[17] !== n || t[18] !== o || t[19] !== u
    ? ((f = (0, q.jsx)(an, { ...n, query: o, sections: u })),
      (t[17] = n),
      (t[18] = o),
      (t[19] = u),
      (t[20] = f))
  ...
  return (
    t[21] !== d || t[22] !== f
      ? ((p = (0, q.jsxs)(q.Fragment, { children: [d, f] })), (t[21] = d), (t[22] = f), (t[23] = p))
      : (p = t[23]),
    p
  );
}
function nn(e) {
  ...
  t[5] !== a.pluginId || t[6] !== a.server
    ...
    : (s = t[7]);
  let c = o.filter(s),
    l = h($e, { hostId: r, path: a.path.map(rn), query: i, servers: c }),
    u = nt({ isLoading: l.isLoading, mentionSource: a, results: l.data, servers: c }),
    d;
  return (
    t[8] !== n || t[9] !== i || t[10] !== u
      ? ((d = (0, q.jsx)(an, { ...n, query: i, sections: u })),
        (t[8] = n),
        (t[9] = i),
        (t[10] = u),
        (t[11] = d))
...
function an(e) {
  ...
  let w = g.length > 1 || g.some(cn),
    T = !(_.length > 0) && g.every(fn),
    E;
  (t[5] === r ? (E = t[6]) : ((E = r.some(sn)), (t[5] = r), (t[6] = E)),
    ze({ isLoading: E, onRequestClose: o, query: p, resultCount: _.length }));
  let D = m === `default` ? `both` : `bottom`,
    O = Ye(h),
    k = h ? `composer-home-top-menu` : `max-h-[320px]`,
    A;
  t[7] !== n || t[8] !== k ? ((A = c(n, k)), (t[7] = n), (t[8] = k), (t[9] = A)) : (A = t[9]);
  let j;
  return (
    ...
    (0, q.jsxs)(Ve, {
      ...
      children: [
        ...
        g.some(on) ? (0, q.jsx)(`div`, { className: $t.loadingBar, "aria-hidden": `true` }) : null,
      ],
    })
  );
}
  ...
  t[7] !== i || t[8] !== o || t[9] !== s || t[10] !== c.emptyState || t[11] !== c.items
    ? ((u =
        c.items.length > 0
          ...
          : c.emptyState == null
            ? null
            : (0, q.jsx)(We, { children: (0, q.jsx)(f, { ...c.emptyState }) })),
      (t[7] = i),
      (t[8] = o),
      (t[9] = s),
      (t[10] = c.emptyState),
...
function dn(e) {
  ...
  t[3] !== n.labelClassName || t[4] !== l
    ? ((u = c(`truncate`, l, n.labelClassName)), (t[3] = n.labelClassName), (t[4] = l), (t[5] = u))
    : (u = t[5]);
  let d;
  t[6] !== n.label || t[7] !== u
  ...
  return (
    t[15] !== a || t[16] !== i || t[17] !== o || t[18] !== p
      ? ((m = (0, q.jsx)(Ge, { getItemProps: a, highlighted: o, itemIndex: i, children: p })),
        (t[15] = a),
        (t[16] = i),
        (t[17] = o),
        (t[18] = p),
