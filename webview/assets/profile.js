...
import { f as s, l as c, o as l, u } from "./vscode-api.js";
import "./isEqual.js";
import { Ki as d, Vi as f } from "./src-4.js";
import { us as p } from "./app-server-manager-signals.js";
import "./react-dom.js";
import { c as m, o as h, r as g } from "./lib-1.js";
import {
  Cn as _,
  Dn as v,
  En as y,
...
import { i as O, t as ee } from "./proxy.js";
import { G as k, mt as A, tt as j } from "./single-value.js";
import { r as M, t as N } from "./use-transform.js";
import { t as te } from "./AnimatePresence.js";
import { t as P } from "./use-reduced-motion.js";
import { t as F } from "./codex-avatar.js";
...
import "./rpc-2.js";
import { o as z } from "./statsig-DoZ-0xit.js";
import "./request.js";
import "./platform.js";
...
import { t as V } from "./link-external.js";
import { r as H } from "./toast-signal.js";
import { t as U } from "./question-mark-circle.js";
import { n as W } from "./chunk-8.js";
import { t as G } from "./known-app-icon.js";
import "./branch.js";
...
import { p as K } from "./codex-api.js";
...
import { t as oe } from "./pencil.js";
import "./filesystem-media-src.js";
import { t as se } from "./copy-to-clipboard.js";
import { a as Y, d as ce, i as le, l as ue, n as de, r as fe, u as X } from "./dialog-layout.js";
import { t as pe } from "./codex-api-error.js";
import { t as me } from "./copy-D.js";
import {
  C as he,
  S as ge,
  _ as _e,
...
import { t as Le } from "./lock.js";
import { t as Re } from "./model-and-reasoning-effort-translations.js";
import { t as ze } from "./settings-content-layout.js";
import { a as Be, n as Ve, r as He } from "./custom-avatars-query.js";
...
function We(e, t, n) {
  ...
  if (
    (e.attach((e, t) => {
      ((a = e), (o = (e) => t(Ge(e, s))), A.postRender(l));
    }, c),
    k(t))
  ) {
    let n = t.on(`change`, (t) => e.set(Ge(t, s))),
      r = e.on(`destroy`, n);
    return () => {
      (n(), r());
    };
...
var Z = e(t(), 1);
function qe(e, t = {}) {
  let { isStatic: n } = (0, Z.useContext)(O),
    r = () => (k(e) ? e.get() : e);
  if (n) return N(r);
  let i = M(r());
  return ((0, Z.useInsertionEffect)(() => We(i, e, t), [i, JSON.stringify(t)]), i);
}
var Q = r(),
  $ = n(),
  Je = { plugin: `@`, skill: `$` };
function Ye(e) {
  ...
  if (
      ...
      ? ((m =
          r !== void 0 && i !== void 0
            ? (0, $.jsx)(Ze, {
                ...
                value: l
                  ? (0, $.jsxs)($.Fragment, {
                      children: [(0, $.jsx)(et, { effort: r }), ` · `, nt(o, i)],
                    })
                  : (0, $.jsx)(Qe, {}),
              })
            : null),
      ...
      ? ((g =
          n.skillsExplored == null
            ...
            : (0, $.jsx)(Ze, {
                ...
                value:
                  n.skillsExplored === 0 ? (0, $.jsx)($e, {}) : o.formatNumber(n.skillsExplored),
              })),
      ...
      ? ((_ =
          n.totalSkillsUsed == null
            ...
            : (0, $.jsx)(Ze, {
                ...
                value: u ? o.formatNumber(n.totalSkillsUsed) : (0, $.jsx)($e, {}),
              })),
        (t[27] = u),
    ...
    t[31] !== n.totalThreads || t[32] !== o
      ? ((v =
          n.totalThreads == null
            ...
            : (0, $.jsx)(Ze, {
                ...
                value: n.totalThreads === 0 ? (0, $.jsx)($e, {}) : o.formatNumber(n.totalThreads),
              })),
        (t[31] = n.totalThreads),
        (t[32] = o),
        (t[33] = v))
      : (v = t[33]);
    let y;
    (t[34] !== v || t[35] !== p || t[36] !== m || t[37] !== g || t[38] !== _
      ? ((y = (0, $.jsxs)(`div`, {
          className: `flex min-w-0 flex-col gap-2`,
          children: [
            f,
            (0, $.jsxs)(`dl`, { className: `flex flex-col gap-2`, children: [p, m, g, _, v] }),
          ],
        })),
        (t[34] = v),
        (t[35] = p),
                ...
                children: [
                  ...
                  e.length === 0
                    ? (0, $.jsxs)(`div`, {
                        ...
                        children: [
                          (0, $.jsx)(q, { "aria-hidden": !0, className: `icon-xs` }),
                          (0, $.jsxs)(`div`, {
...
function Xe(e) {
  ...
  t[6] !== n.plugin_id || t[7] !== n.type || t[8] !== a || t[9] !== r
    ? ((l = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(tt, { name: a, plugin: r, pluginId: n.plugin_id, type: n.type }),
      })),
      (t[6] = n.plugin_id),
      (t[7] = n.type),
      (t[8] = a),
...
function Ze(e) {
  ...
  let s = n ? `text-token-text-tertiary` : `text-token-text-primary`,
    c;
  t[2] === s ? (c = t[3]) : ((c = D(`shrink-0 tabular-nums`, s)), (t[2] = s), (t[3] = c));
  let l;
  t[4] === a
    ? (l = t[5])
...
function et(e) {
  ...
  switch (n) {
    ...
    case `max`: {
      let e;
      return (
        t[0] === n ? (e = t[1]) : ((e = (0, $.jsx)(Re, { effort: n })), (t[0] = n), (t[1] = e)), e
      );
    }
    default: {
      let e;
...
function tt(e) {
  ...
  t[0] !== n || t[1] !== a
    ? ((o =
        a === `plugin`
          ? (0, Z.createElement)(q, { "aria-hidden": !0, className: `icon-sm` })
          : (0, Z.createElement)(ae(null, { fallbackName: n }), { className: `icon-sm` })),
      (t[0] = n),
      (t[1] = a),
      (t[2] = o))
    : (o = t[2]);
  ...
  if (r == null) {
    ...
    if (t[6] !== n || t[7] !== i || t[8] !== a) {
      ...
      bb0: {
        let t = G(i?.split(`@`)[0] ?? (a === `skill` ? n.split(`:`)[0] : n));
        if (t != null) {
...
function gt(e) {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(ce, { className: `sr-only`, children: (0, $.jsx)(h, { ...Et.title }) })),
      (t[15] = w))
    : (w = t[15]);
  let T;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, $.jsx)(le, { title: (0, $.jsx)(h, { ...Et.title }) })), (t[17] = E))
    : (E = t[17]);
  let D;
  ...
  t[31] === o
    ...
    : ((te =
      ...
      (t[32] = te));
  let P;
  t[33] !== n.dataUrl || t[34] !== A || t[35] !== j || t[36] !== M || t[37] !== N || t[38] !== te
    ? ((P = (0, $.jsx)(`div`, {
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, $.jsx)(at, { className: `icon-sm` })), (t[48] = B))
    : (B = t[48]);
  let V;
  t[49] !== L || t[50] !== R || t[51] !== z
    ? ((V = (0, $.jsx)(I, {
        "aria-label": L,
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = (0, $.jsx)(ot, { className: `icon-sm` })), (t[67] = re))
    : (re = t[67]);
  let J;
  ...
  let oe;
  t[77] !== u || t[78] !== r
    ? ((oe = (0, $.jsx)(I, { color: `ghost`, disabled: u, onClick: r, children: ae })),
      (t[77] = u),
      (t[78] = r),
      (t[79] = oe))
    : (oe = t[79]);
  ...
  let he;
  t[84] !== oe || t[85] !== me
    ? ((he = (0, $.jsxs)(fe, { children: [oe, me] })), (t[84] = oe), (t[85] = me), (t[86] = he))
    : (he = t[86]);
  let ge;
  t[87] !== F || t[88] !== ie || t[89] !== he || t[90] !== C
    ? ((ge = (0, $.jsxs)(de, {
        as: `form`,
        className: `gap-5`,
        onSubmit: C,
        children: [w, T, E, F, ie, he],
      })),
      (t[87] = F),
      (t[88] = ie),
      (t[89] = he),
...
function vt(e, t) {
  return Math.max(st / e, st / t);
}
function yt(e, t) {
  return (st - e * t) / 2;
}
function bt(e, t, n) {
  return Math.min(0, Math.max(st - t * n, e));
}
function xt(e, t) {
  let n = (st / 2 - e.offsetX) / e.zoom,
    r = (st / 2 - e.offsetY) / e.zoom;
  return {
    ...e,
    offsetX: bt(st / 2 - n * t, e.naturalWidth, t),
    offsetY: bt(st / 2 - r * t, e.naturalHeight, t),
    zoom: t,
  };
}
async function St(e, t) {
  ...
  i.drawImage(n, -t.offsetX / t.zoom, -t.offsetY / t.zoom, st / t.zoom, st / t.zoom, 0, 0, lt, lt);
...
`,
  ...
  ln = f({ base64: d().min(1), contentType: d() });
function un() {
...
async function In(e) {
  if (!Rn(e)) return null;
  try {
    let t = await c.getInstance().get(e),
      n = ln.parse(t.body);
...
function Qn(e) {
  ...
  let P;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (0, $.jsx)(re, { "aria-hidden": !0, className: `icon-sm` })), (t[15] = P))
    : (P = t[15]);
  let F;
  t[16] !== j || t[17] !== N
    ? ((F = (0, $.jsx)(I, {
  ...
  let R = o == null ? `mt-[50px]` : `mt-8`,
    z;
  t[20] === R ? (z = t[21]) : ((z = D(`flex flex-col items-center`, R)), (t[20] = R), (t[21] = z));
  let B;
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = D(
  ...
  t[42] === ne
    ? (q = t[43])
    : ((q = D(`flex items-start justify-center gap-2 sm:gap-5`, ne)), (t[42] = ne), (t[43] = q));
  let J;
  t[44] === p
    ? (J = t[45])
    : ((J = p.formatMessage({
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((le = (0, $.jsx)(Hn, { "aria-hidden": !0, className: `icon-sm` })), (t[49] = le))
    : (le = t[49]);
  let de;
  t[50] !== J || t[51] !== ae || t[52] !== oe || t[53] !== Y
    ? ((de = (0, $.jsx)($n, {
        ariaLabel: J,
        active: ae,
        disabled: oe,
  ...
  t[60] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_e = (0, $.jsx)(Bn, { "aria-hidden": !0, className: `icon-sm` })), (t[60] = _e))
    : (_e = t[60]);
  let ve;
  t[61] !== fe || t[62] !== pe || t[63] !== me || t[64] !== ge
    ? ((ve = (0, $.jsx)($n, {
        ariaLabel: fe,
        active: pe,
        disabled: me,
  ...
  t[71] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((we = (0, $.jsx)(Vn, { "aria-hidden": !0, className: `icon-sm` })), (t[71] = we))
    : (we = t[71]);
  let Te;
  ...
  t[79] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Oe = (0, $.jsx)(ie, { "aria-hidden": !0, className: `icon-sm` })), (t[79] = Oe))
    : (Oe = t[79]);
  let ke;
  t[80] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = (0, $.jsx)(`span`, {
  ...
  t[81] !== c || t[82] !== Ee || t[83] !== De
    ...
    : (Ae = t[84]);
  let je;
  t[85] !== q || t[86] !== de || t[87] !== ve || t[88] !== Te || t[89] !== Ae
    ? ((je = (0, $.jsxs)(`div`, { className: q, children: [de, ve, Te, Ae] })),
      (t[85] = q),
      (t[86] = de),
      (t[87] = ve),
      (t[88] = Te),
  ...
  t[98] !== z || t[99] !== K || t[100] !== je || t[101] !== Ne
    ? ((Pe = (0, $.jsxs)(`div`, {
        ...
        children: [L, (0, $.jsxs)(`div`, { className: z, children: [K, je, Ne] })],
      })),
      (t[98] = z),
      (t[99] = K),
      (t[100] = je),
...
function $n(e) {
  ...
  t[0] === o
    ? (l = t[1])
    : ((l = (0, $.jsx)(`span`, { className: Gn, children: o })), (t[0] = o), (t[1] = l));
  let u;
  return (
...
function er(e) {
  ...
  t[4] !== d || t[5] !== n || t[6] !== u || t[7] !== c
    ? ((_ = d
        ? (0, $.jsx)(I, {
            ...
            uniform: !0,
            onClick: c,
            children: (0, $.jsx)(L, { "aria-hidden": !0, className: `icon-xs rotate-180` }),
          })
        : null),
      (t[4] = d),
      (t[5] = n),
  ...
  t[9] === v
    ? (y = t[10])
    : ((y = D(`truncate text-xs leading-4 font-medium`, v)), (t[9] = v), (t[10] = y));
  let b;
  t[11] !== a || t[12] !== y
  ...
  t[21] !== d || t[22] !== n || t[23] !== u || t[24] !== s
    ? ((C = d
        ? (0, $.jsx)(I, {
            ...
            uniform: !0,
            onClick: s,
            children: (0, $.jsx)(L, { "aria-hidden": !0, className: `icon-xs` }),
          })
        : null),
      (t[21] = d),
      (t[22] = n),
  ...
  let O;
  return (
    t[33] !== f || t[34] !== C || t[35] !== E || t[36] !== g || t[37] !== _ || t[38] !== S
      ? ((O = (0, $.jsxs)(`div`, {
          "aria-label": f,
          className: g,
          role: `group`,
...
function tr(e) {
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(re, { "aria-hidden": !0, className: `icon-xs` })), (t[7] = d))
    : (d = t[7]);
  let f;
  t[8] !== i || t[9] !== u
    ? ((f = (0, $.jsx)(I, {
  ...
  let g;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, $.jsx)(nr, { step: 1 })), (t[14] = g))
    : (g = t[14]);
  let _, v;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(me, { "aria-hidden": !0, className: `icon-xs` })),
      (v = (0, $.jsx)(h, {
  ...
  let S;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(V, { "aria-hidden": !0, className: `icon-xs` })), (t[23] = S))
    : (S = t[23]);
  let C;
  t[24] === c
    ? (C = t[25])
...
function ir({
  ...
  let d = i(o),
    ...
    R = (e, t) => {
      ...
      w(d, v, { action: e, socialPlatform: sr(t) });
    },
    z = () => {
      ...
      return {
        ...
        stats: [
          ...
          },
          {
            ...
            value: Ee(f, l.currentStreakDays),
          },
          {
            label: f.formatMessage({
            ...
            value: Ee(f, l.longestStreakDays),
          },
        ],
        theme: un(),
        usernameLabel: r,
        usageCells: De({ dailyUsage: e, todayIso: c }),
      };
    },
    B = async (e, t) => {
      let n = await ar(e);
    ...
    V = async (e, { clearPreview: t, showLoadingState: n, requestId: r }) => {
      (n && g(!0), t && S(null));
      try {
        await B(await dn({ ...z(), petImageUrl: e?.imageUrl ?? null }), r);
      } catch {
        if (j.current !== r) return;
        (b(!1), A(null), d.get(H).danger(N));
      } finally {
        n && j.current === r && g(!1);
      }
    },
    ...
    W = () => {
      ...
      (b(!0), T(null), A(null), D(t === -1 ? null : t), ee(t !== -1));
      let n = r[t];
      if (n == null) {
    ...
    G = (e) => {
      ...
      j.current += 1;
      let n = j.current;
      (D(e), ee(!0), U(t, k, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    K = (e) => {
      ...
      j.current += 1;
      let n = j.current;
      (ee(e), V(e ? t : null, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    ne = () => {
      x != null &&
        (R(y.CODEX_PROFILE_SHARE_ACTION_SAVE_BUTTON_CLICKED), pn(x.blob), d.get(H).success(F));
    },
    q = () => {
      x != null &&
        se({ "image/png": x.blob }).then(
          () => {
            d.get(H).success(te);
          },
          () => {
    ...
    re = (e) => {
      (e || ((j.current += 1), T(null), D(null), ee(!1), g(!1), A(null)), b(e));
    };
  return (0, $.jsxs)($.Fragment, {
    children: [
      (0, $.jsxs)(I, {
        ...
        size: `toolbar`,
        onClick: () => {
          (R(y.CODEX_PROFILE_SHARE_ACTION_SHARE_BUTTON_CLICKED), W());
        },
        children: [
          (0, $.jsx)(Ue, { "aria-hidden": !0, className: `icon-xs` }),
          (0, $.jsx)(h, {
      ...
      (0, $.jsx)(Qn, {
        ...
        onOpenChange: re,
        onOpenSocialDraft: (e) => {
          (R(y.CODEX_PROFILE_SHARE_ACTION_SOCIAL_COMPOSER_BUTTON_CLICKED, e),
            s.dispatchMessage(`open-in-browser`, { url: or(e, L) }));
        },
        onSelectSocialPlatform: (e) => {
          (R(y.CODEX_PROFILE_SHARE_ACTION_SOCIAL_SHARE_BUTTON_CLICKED, e), T(e));
        },
      }),
    ],
  });
...
function sr(e) {
  switch (e) {
    case `linkedin`:
      return b.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_LINKEDIN;
    case `reddit`:
      return b.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_REDDIT;
    case `x`:
      return b.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_X;
  }
}
...
function br({ today: e = new Date() }) {
  let t = i(o),
    ...
    c = z(`3162484136`),
    d = z(`1991660486`),
    { accountId: f, authMethod: p, planAtLogin: g, userId: v } = B(),
    { data: y } = K(),
    { data: b } = l(`account-info`, {
      queryConfig: { enabled: p === `chatgpt` && !0, staleTime: u.ONE_MINUTE },
    }),
    { data: T } = a(Ve),
    O = _e(e),
    k = ye(O),
    A = Jr(O),
    j = f ?? b?.accountId ?? null,
    M = v ?? b?.userId ?? null,
    N = Ae({ accountId: j, enabled: p === `chatgpt`, userId: M }),
    te = N.data?.activityInsights,
    F = Te({ accountId: j, userId: M }),
    L = Oe({ accountId: j, userId: M }),
    V = F.isPending || L.isPending,
    H = ve({ accountId: j, userId: M }),
    U = Be(T?.avatars),
    { selectedAvatar: W } = He(U),
    [G, ne] = (0, Z.useState)(null),
    [q, re] = (0, Z.useState)(null),
    [J, ie] = (0, Z.useState)(`daily`),
    [ae, se] = (0, Z.useState)(null),
    [Y, ce] = (0, Z.useState)(null),
    [le, ue] = (0, Z.useState)(null),
    [de, fe] = (0, Z.useState)(!1),
    X = N.isLoading,
    pe = (N.data == null && N.isError) || N.data?.hasStatsError === !0,
    me = W.id.startsWith(`custom:`),
    xe = X ? null : (q ?? N.data?.imageUrl ?? y?.profile_picture_url ?? null),
    Ce = xe != null && xe !== G,
    we = N.data?.username?.trim() || null,
    De = N.data?.displayName ?? null,
    je = X ? null : (De ?? we ?? y?.name ?? null),
    Me = ke({
      accountStructure: y?.structure,
      plan: y?.plan_type ?? b?.plan ?? g,
      workspaceName: y?.name,
    }),
    Re = N.data?.summary,
    Ue = Re?.longestTaskDurationMs,
    We = N.data?.dailyUsage,
    Ge = U.flatMap((e) =>
    ...
    Ke =
      pe || We == null
        ? null
        : {
            cells: Ie({ dailyUsage: We, todayIso: O, view: J }),
            dailyValues: ge({ dailyUsage: We, todayIso: O }),
            weeklyTotals: he({ dailyUsage: We, todayIso: O }),
            cumulativeTotals: Fe({ dailyUsage: We, todayIso: O }),
          },
    qe = r.formatMessage({
  ...
  return (
    (0, Z.useEffect)(() => {
      n.current || ((n.current = !0), w(t, S, { profileOwner: `self` }));
    }, [t]),
    (0, $.jsxs)(ze, {
      ref: ce,
      className: `relative`,
      ...
      backSlot: (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsxs)(`div`, {
            ...
            children: [
              c && !X && !pe && we != null && De != null && Re != null && We != null
                ? (0, $.jsx)(ir, {
                    dailyUsage: We,
                    displayName: De,
                    imageUrl: Ce ? xe : null,
                    petOptions: Ge,
                    selectedPetId: me ? W.id : null,
                    todayIso: O,
                    usageSummary: Re,
                    username: we,
                  })
              ...
              (0, $.jsxs)(I, {
                ...
                size: `toolbar`,
                onClick: () => {
                  (w(t, C, { action: E.CODEX_PROFILE_EDIT_ACTION_OPENED }), fe(!0));
                },
                children: [
                  (0, $.jsx)(oe, { "aria-hidden": !0, className: `icon-xs` }),
                  (0, $.jsx)(h, {
      ...
      children: [
          ...
          children: [
                          ...
                          (0, $.jsxs)(`label`, {
                            ...
                            children: [
                              ...
                              (0, $.jsx)(`input`, {
                                ...
                                onClick: () => {
                                  w(t, _, {
                                    action: x.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_STARTED,
                                  });
                                },
                                onChange: (e) => {
                                  ...
                                  ((e.currentTarget.value = ``),
                                    n != null &&
                                      (w(t, _, {
                                        action:
                                          x.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_IMAGE_SELECTED,
                                      }),
                                      Ar(n).then(ue, () => {
                                        (w(t, _, {
                                          action: x.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED,
                                        }),
                                          ue(null));
                                      })));
                                },
                  ...
                  : pe
                    ...
                    : (0, $.jsxs)($.Fragment, {
                        children: [
                          ...
                          (0, $.jsx)(Gr, {
                            value: Ee(r, Re?.currentStreakDays),
                            label: (0, $.jsx)(h, {
                          ...
                          (0, $.jsx)(Kr, {}),
                          (0, $.jsx)(Gr, {
                            value: Ee(r, Re?.longestStreakDays),
                            label: (0, $.jsx)(h, {
            ...
            (0, $.jsxs)(`section`, {
              ...
              children: [
                ...
                X
                  ? (0, $.jsx)(Ir, { columnCount: k, monthLabelCount: A.length })
                  : Ke == null
                    ? (0, $.jsx)(zr, {})
                    : (0, $.jsxs)(`div`, {
                          ...
                          (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              (0, $.jsx)(`div`, {
                                ...
                                style: { gridTemplateColumns: `repeat(${k}, minmax(1px, 1fr))` },
                                children: Ke.cells.map((e, t) => {
                                  let n = Pe(t, O);
                                  if (J === `daily` && n > O) return null;
                                  ...
                                  return (0, $.jsx)(
                                    R,
                                    {
                                      ...
                                      portalContainer: Y,
                                      tooltipContent: (0, $.jsx)(Xr, {
                                        dateIso: n,
                                        tokenCount: Ke.dailyValues[t] ?? 0,
                                        todayIso: O,
                                      }),
                                      children: c,
                                    },
            ...
            d ? (0, $.jsx)(Br, { insights: te, isLoading: X, isUnavailable: pe }) : null,
          ],
        }),
        le == null
          ? null
          : (0, $.jsx)(gt, {
              ...
              onSave: (e) => {
                (ue(null),
                  ...
                  H.mutate(e.photo, {
                    onError: () => {
                      (w(t, _, { action: x.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED }),
                        re(null));
                    },
                    onSuccess: () => {
                      (w(t, _, { action: x.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED }),
                        ne(null),
                        re(null));
                    },
                  }));
        ...
        de
          ? (0, $.jsx)(xr, {
              ...
              onProfileImageError: ne,
              onSaveError: (e) => {
                w(t, C, { action: E.CODEX_PROFILE_EDIT_ACTION_SAVE_FAILED, ...e });
              },
              onPhotoChangeImageSelected: () => {
                w(t, C, { action: E.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED });
              },
              onPhotoChangeStarted: () => {
                w(t, C, { action: E.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED });
              },
              onSaveProfile: async (e) => {
                (await F.mutateAsync(e), ne(null));
              },
              onSaveSuccess: () => {
                w(t, C, { action: E.CODEX_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED });
              },
              onSaveUsername: (e) => L.mutateAsync(e),
            })
          : null,
      ],
    })
...
function xr({
  ...
  let g = m(),
    ...
    [ee, k] = (0, Z.useState)(null),
    [A, j] = (0, Z.useState)(null),
    [M, N] = (0, Z.useState)(null),
    [te, P] = (0, Z.useState)(null),
    [F, L] = (0, Z.useState)(null),
    [R, z] = (0, Z.useState)(!1),
    B = R || r || n,
    V = Ce(C),
    ...
    K = async () => {
      ...
      if ((s && ((f.photo = E.photo), (p += 1)), m == null && p === 0)) {
        i();
        return;
      }
      z(!0);
      let h = T.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED,
        _ = T.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED;
      try {
        (m != null &&
          ((h = T.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
          await d(m),
          (h = T.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          p > 0 &&
            ((_ = T.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
            await l(f),
            (_ = T.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          u(),
          i());
      } catch (e) {
        if (
          (c({ profileDetailsUpdateApiStatus: _, usernameUpdateApiStatus: h }),
          h === T.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED)
        ) {
          N(Tr(e, g));
          return;
              ...
              children: (0, $.jsxs)(`label`, {
                ...
                children: [
                  ...
                  (0, $.jsx)(`span`, {
                    ...
                    children: (0, $.jsx)(oe, { "aria-hidden": !0, className: `icon-sm` }),
                  }),
                  (0, $.jsx)(`input`, {
                    type: `file`,
                    accept: `image/*`,
                    ...
                    children: [
                      ...
                      (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(`input`, {
                          ...
                          maxLength: 64,
                          onChange: (e) => {
                            (S(e.target.value), j(null), L(null));
                          },
                          onFocus: (e) => {
                      ...
                      (0, $.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(`input`, {
                            ...
                            maxLength: 20,
                            onChange: (e) => {
                              let t = we(e.target.value),
                                n = Ce(t);
                              (w(t), N(n.ok ? null : kr(n.reason, g)), L(null));
                            },
                            onFocus: (e) => {
                              e.currentTarget.select();
                            },
...
function Sr() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(U, { "aria-hidden": !0, className: `icon-2xs` })), (e[3] = i))
    : (i = e[3]);
  let a;
  return (
    e[4] === r
...
function jr(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(Mr, { className: `absolute top-0 left-[72px] size-20 rounded-full` })),
      (a = (0, $.jsx)(Mr, { className: `absolute top-[100px] left-0 h-8 w-56 rounded-lg` })),
      (o = (0, $.jsx)(Mr, { className: `absolute top-[136px] left-12 h-5 w-32 rounded-lg` })),
      (t[0] = i),
      (t[1] = a),
      (t[2] = o))
    : ((i = t[0]), (a = t[1]), (o = t[2]));
...
function Mr(e) {
  let t = (0, Q.c)(4),
    { className: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = D(dr.profileLoadingBlock, `block`, n)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function Nr() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)($.Fragment, { children: yr.map(Pr) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
    ...
    Z.Fragment,
    {
      children: [
        ...
        (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(Mr, { className: `h-5 w-12 rounded-md` }),
            (0, $.jsx)(Mr, { className: `h-5 w-20 rounded-md` }),
          ],
        }),
      ],
    },
...
function Lr(e, t) {
  return (0, $.jsx)(Mr, { className: `h-4 w-6 rounded-md` }, t);
}
function Rr(e, t) {
  return (0, $.jsx)(Mr, { className: `aspect-square w-full rounded-[4px]` }, t);
}
function zr() {
  let e = (0, Q.c)(1),
    t;
...
function Br(e) {
  ...
  if (!i && n != null) {
    ...
    return (
      t[2] !== n || t[3] !== o
        ? ((e = (0, $.jsx)(Ye, { insights: n, plugins: o })), (t[2] = n), (t[3] = o), (t[4] = e))
        : (e = t[4]),
      e
    );
  }
    ...
    `div`,
    {
      ...
      children: [
        (0, $.jsxs)(`div`, {
          className: `flex items-center gap-1.5`,
          children: [
            (0, $.jsx)(Mr, { className: `size-6 rounded-lg` }),
            (0, $.jsx)(Mr, { className: `h-5 w-24 rounded-md` }),
          ],
        }),
        (0, $.jsx)(Mr, { className: `h-5 w-14 rounded-md` }),
      ],
    },
    t,
  );
...
function Wr(e, t) {
  return (0, $.jsxs)(
    `div`,
    {
      ...
      children: [
        (0, $.jsx)(Mr, { className: `h-5 w-24 rounded-md` }),
        (0, $.jsx)(Mr, { className: `h-5 w-10 rounded-md` }),
      ],
    },
    t,
  );
...
function Xr(e) {
  ...
  t[0] !== n || t[1] !== a || t[2] !== i
    ...
    : (o = t[3]);
  let s;
  t[4] !== a || t[5] !== r ? ((s = be(a, r)), (t[4] = a), (t[5] = r), (t[6] = s)) : (s = t[6]);
  let c;
  return (
    t[7] !== o || t[8] !== s
      ? ((c = (0, $.jsx)(h, {
...
function Zr(e) {
  let t = (0, Q.c)(10),
    ...
    a = m(),
    o;
  t[0] !== a || t[1] !== r ? ((o = be(a, r)), (t[0] = a), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s = o,
    c;
  t[3] !== a || t[4] !== i
