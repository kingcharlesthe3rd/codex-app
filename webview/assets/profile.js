...
import { n as Tt, t as Et } from "./codex-avatar.js";
import {
  h as Dt,
  p as Ot,
...
import {
  n as zt,
  t as Bt,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~project~obbidxvq.js";
import {
  a as Vt,
  i as Ht,
  n as Ut,
                ...
                children: [
                  ...
                  e.length === 0
                    ? (0, J.jsxs)(`div`, {
                        ...
                        children: [
                          (0, J.jsx)(te, { "aria-hidden": !0, className: `icon-xs` }),
                          (0, J.jsxs)(`div`, {
...
function Qt(e) {
  ...
  let s = n ? `text-token-text-tertiary` : `text-token-text-primary`,
    c;
  t[2] === s ? (c = t[3]) : ((c = oe(`shrink-0 tabular-nums`, s)), (t[2] = s), (t[3] = c));
  let l;
  t[4] === a
    ? (l = t[5])
...
function tn(e) {
  ...
  switch (n) {
    ...
    case `max`: {
      let e;
      return (
        t[0] === n ? (e = t[1]) : ((e = (0, J.jsx)(Bt, { effort: n })), (t[0] = n), (t[1] = e)), e
      );
    }
    default: {
      let e;
...
function nn(e) {
  ...
  t[0] !== n || t[1] !== a
    ? ((o =
        a === `plugin`
          ? (0, cn.createElement)(te, { "aria-hidden": !0, className: `icon-sm` })
  ...
  if (r == null) {
    ...
    if (t[7] !== n || t[8] !== i || t[9] !== a) {
      ...
      bb0: {
        let t = M(i?.split(`@`)[0] ?? (a === `skill` ? n.split(`:`)[0] : n));
        if (t != null) {
...
function mn(e) {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Y.jsx)(re, { className: `sr-only`, children: (0, Y.jsx)(q, { ...Fn.title }) })),
      (t[15] = E))
    : (E = t[15]);
  let te;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, Y.jsx)(ee, { title: (0, Y.jsx)(q, { ...Fn.title }) })), (t[17] = k))
    : (k = t[17]);
  let A;
  ...
  t[31] === o
    ...
    : ((ie =
      ...
      (t[32] = ie));
  let R;
  t[33] !== n.dataUrl || t[34] !== P || t[35] !== F || t[36] !== I || t[37] !== L || t[38] !== ie
    ? ((R = (0, Y.jsx)(`div`, {
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((le = (0, Y.jsx)(fn, { className: `icon-sm` })), (t[48] = le))
    : (le = t[48]);
  let ue;
  t[49] !== ae || t[50] !== oe || t[51] !== se
    ? ((ue = (0, Y.jsx)(D, {
        "aria-label": ae,
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ge = (0, Y.jsx)(Yt, { className: `icon-sm` })), (t[67] = ge))
    : (ge = t[67]);
  let H;
  t[68] !== me || t[69] !== he || t[70] !== V
    ? ((H = (0, Y.jsx)(D, {
        "aria-label": me,
        className: `!size-5 !p-0`,
        color: `ghost`,
  ...
  let U;
  t[79] !== f || t[80] !== r
    ? ((U = (0, Y.jsx)(D, { color: `ghost`, disabled: f, onClick: r, children: ye })),
      (t[79] = f),
      (t[80] = r),
      (t[81] = U))
    : (U = t[81]);
  ...
  let xe;
  t[86] !== U || t[87] !== G
    ? ((xe = (0, Y.jsxs)(ce, { children: [U, G] })), (t[86] = U), (t[87] = G), (t[88] = xe))
    : (xe = t[88]);
  let Se;
  t[89] !== z || t[90] !== _e || t[91] !== ve || t[92] !== xe || t[93] !== T
    ? ((Se = (0, Y.jsxs)(x, {
        as: `form`,
        className: `gap-5`,
        onSubmit: T,
        children: [E, te, k, z, _e, ve, xe],
      })),
      (t[89] = z),
      (t[90] = _e),
      (t[91] = ve),
...
async function hr(e) {
  if (!_r(e)) return null;
  try {
    let t = await m.getInstance().get(e),
      n = Zr.parse(t.body);
...
var yr,
  ...
  Qr = e(() => {
    (b(),
      ...
      (Zr = n({ base64: r().min(1), contentType: r() })));
  }),
  $r,
  ei,
  ti = e(() => {
...
function ci(e) {
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = { style: { height: `100dvh`, maxWidth: `none`, width: `100vw`, zIndex: 51 } }),
      (t[8] = ee))
    : (ee = t[8]);
  let O;
  ...
  let j;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, X.jsx)(se, { "aria-hidden": !0, className: `icon-sm` })), (t[15] = j))
    : (j = t[15]);
  let M;
  t[16] !== k || t[17] !== A
    ? ((M = (0, X.jsx)(D, {
  ...
  let P = o == null ? `mt-[50px]` : `mt-8`,
    F;
  t[20] === P ? (F = t[21]) : ((F = oe(`flex flex-col items-center`, P)), (t[20] = P), (t[21] = F));
  let I;
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = oe(
  ...
  let R;
  t[30] !== L || t[31] !== ie
    ? ((R = (0, X.jsx)(Ce.div, { className: I, style: L, children: ie })),
      (t[30] = L),
      (t[31] = ie),
      (t[32] = R))
    : (R = t[32]);
  let z;
  t[33] !== S || t[34] !== b || t[35] !== R
    ? ((z = (0, X.jsx)(`div`, {
  ...
  let ce;
  t[39] !== z || t[40] !== ae
    ? ((ce = (0, X.jsxs)(`div`, { className: `relative w-fit`, children: [z, ae] })),
      (t[39] = z),
      (t[40] = ae),
      (t[41] = ce))
    : (ce = t[41]);
  ...
  t[42] === ue
    ? (de = t[43])
    : ((de = oe(`flex items-start justify-center gap-2 sm:gap-5`, ue)), (t[42] = ue), (t[43] = de));
  let B;
  t[44] === m
    ? (B = t[45])
    : ((B = m.formatMessage({
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, X.jsx)(oi, { "aria-hidden": !0, className: `icon-sm` })), (t[49] = V))
    : (V = t[49]);
  let ge;
  t[50] !== B || t[51] !== fe || t[52] !== pe || t[53] !== he
    ? ((ge = (0, X.jsx)(li, {
        ariaLabel: B,
        active: fe,
        disabled: pe,
  ...
  t[60] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = (0, X.jsx)(ei, { "aria-hidden": !0, className: `icon-sm` })), (t[60] = W))
    : (W = t[60]);
  let be;
  t[61] !== H || t[62] !== _e || t[63] !== ve || t[64] !== U
    ? ((be = (0, X.jsx)(li, {
        ariaLabel: H,
        active: _e,
        disabled: ve,
  ...
  t[71] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((De = (0, X.jsx)(ri, { "aria-hidden": !0, className: `icon-sm` })), (t[71] = De))
    : (De = t[71]);
  let Oe;
  t[72] !== G || t[73] !== xe || t[74] !== Se || t[75] !== Te
    ? ((Oe = (0, X.jsx)(li, {
        ariaLabel: G,
        active: xe,
        disabled: Se,
  ...
  t[79] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Me = (0, X.jsx)(le, { "aria-hidden": !0, className: `icon-sm` })), (t[79] = Me))
    : (Me = t[79]);
  let Pe;
  ...
  t[81] !== l || t[82] !== ke || t[83] !== je
    ...
    : (Fe = t[84]);
  let Ie;
  t[85] !== de || t[86] !== ge || t[87] !== be || t[88] !== Oe || t[89] !== Fe
    ? ((Ie = (0, X.jsxs)(`div`, { className: de, children: [ge, be, Oe, Fe] })),
      (t[85] = de),
      (t[86] = ge),
      (t[87] = be),
      (t[88] = Oe),
  ...
  t[91] !== s || t[92] !== c || t[93] !== u || t[94] !== f || t[95] !== o
    ...
    : (Le = t[96]);
  let K;
  t[97] === Le ? (K = t[98]) : ((K = (0, X.jsx)(Ne, { children: Le })), (t[97] = Le), (t[98] = K));
  let Re;
  t[99] !== F || t[100] !== ce || t[101] !== Ie || t[102] !== K
    ? ((Re = (0, X.jsxs)(`div`, {
        className: `flex min-h-fit flex-col items-center`,
        children: [N, (0, X.jsxs)(`div`, { className: F, children: [ce, Ie, K] })],
      })),
      (t[99] = F),
      (t[100] = ce),
      (t[101] = Ie),
...
function ui(e) {
  ...
  t[4] !== d || t[5] !== n || t[6] !== u || t[7] !== c
    ? ((h = d
        ? (0, X.jsx)(D, {
            ...
            uniform: !0,
            onClick: c,
            children: (0, X.jsx)(ye, { "aria-hidden": !0, className: `icon-xs rotate-180` }),
          })
        : null),
      (t[4] = d),
      (t[5] = n),
  ...
  t[9] === g
    ? (_ = t[10])
    : ((_ = oe(`truncate text-xs leading-4 font-medium`, g)), (t[9] = g), (t[10] = _));
  let v;
  t[11] !== a || t[12] !== _
  ...
  t[21] !== d || t[22] !== n || t[23] !== u || t[24] !== s
    ? ((x = d
        ? (0, X.jsx)(D, {
            ...
            uniform: !0,
            onClick: s,
            children: (0, X.jsx)(ye, { "aria-hidden": !0, className: `icon-xs` }),
          })
        : null),
      (t[21] = d),
      (t[22] = n),
...
function di(e) {
  ...
  let m;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, X.jsx)(se, { "aria-hidden": !0, className: `icon-xs` })), (t[10] = m))
    : (m = t[10]);
  let h;
  t[11] !== a || t[12] !== p
    ? ((h = (0, X.jsx)(D, {
  ...
  let v, y;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, X.jsx)(H, { "aria-hidden": !0, className: `icon-xs` })),
      (v = (0, X.jsx)(q, {
  ...
  t[26] === d
    ? (C = t[27])
    : ((C = (0, X.jsx)(Mt, { href: d, className: `icon-xs` })), (t[26] = d), (t[27] = C));
  let w;
  t[28] === l
    ? (w = t[29])
    : ((w = (0, X.jsx)(q, {
  ...
  return (
    t[38] !== ee || t[39] !== g
      ? ((O = (0, X.jsxs)(X.Fragment, { children: [g, ee] })),
        (t[38] = ee),
        (t[39] = g),
        (t[40] = O))
      : (O = t[40]),
...
function Ti({
  ...
  let l = h(i),
    ...
    re = (e, t) => {
      ...
      K(l, ke, { action: e, socialPlatform: Oi(t) });
    },
    j = () => {
      ...
      return {
        ...
        stats: [
          ...
          },
          {
            ...
            value: vt(u, s.currentStreakDays),
          },
          {
            label: u.formatMessage({
            ...
            value: vt(u, s.longestStreakDays),
          },
        ],
        theme: Un(),
        usernameLabel: r,
        usageCells: Je({ dailyUsage: e, todayIso: o }),
      };
    },
    M = async (e, t) => {
      let n = await Ei(e);
    ...
    N = async (e, { clearPreview: t, showLoadingState: n, requestId: r }) => {
      (n && f(!0), t && _(null));
      try {
        await M(await Wn({ ...j(), petImageUrl: e?.imageUrl ?? null }), r);
      } catch {
        if (E.current !== r) return;
        (m(!1), T(null), l.get(Dt).danger(O));
      } finally {
        n && E.current === r && f(!1);
      }
    },
    P = async (e, t, { clearPreview: n, showLoadingState: r, requestId: i }) => {
      (r && f(!0), n && _(null));
      try {
        let n = t ?? (await Gn(j()));
        if (E.current !== i) return;
        (t ?? T(n), await M(await n.createImageBlob(e.imageUrl), i));
      } catch {
        if (E.current !== i) return;
        (m(!1), T(null), l.get(Dt).danger(O));
      } finally {
    ...
    I = (e) => {
      ...
      E.current += 1;
      let n = E.current;
      (x(e), C(!0), P(t, w, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    L = (e) => {
      ...
      E.current += 1;
      let n = E.current;
      (C(e), N(e ? t : null, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    ie = () => {
      g != null &&
        (re(Fe.CODEX_PROFILE_SHARE_ACTION_SAVE_BUTTON_CLICKED), Kn(g.blob), l.get(Dt).success(A));
    },
    R = () => {
      g != null &&
        pe({ "image/png": g.blob }).then(
          () => {
            l.get(Dt).success(te);
          },
          () => {
  ...
  return (0, Ai.jsxs)(Ai.Fragment, {
    children: [
      (0, Ai.jsxs)(D, {
        ...
        size: `toolbar`,
        onClick: () => {
          (re(Fe.CODEX_PROFILE_SHARE_ACTION_SHARE_BUTTON_CLICKED), F());
        },
        children: [
          (0, Ai.jsx)(Pt, { "aria-hidden": !0, className: `icon-xs` }),
          (0, Ai.jsx)(q, {
      ...
      (0, Ai.jsx)(ci, {
        ...
        onOpenSocialDraft: (e, t) => {
          let n = Di(e, ne);
          (re(Fe.CODEX_PROFILE_SHARE_ACTION_SOCIAL_COMPOSER_BUTTON_CLICKED, e),
            _e({ event: t, href: n, initiator: `open_in_browser_bridge` }));
        },
        onSelectSocialPlatform: (e) => {
          (re(Fe.CODEX_PROFILE_SHARE_ACTION_SOCIAL_SHARE_BUTTON_CLICKED, e), y(e));
        },
      }),
    ],
  });
...
function Oi(e) {
  switch (e) {
    case `linkedin`:
      return W.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_LINKEDIN;
    case `reddit`:
      return W.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_REDDIT;
    case `x`:
      return W.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_X;
  }
}
var ki,
  Ai,
...
function Li({ today: e = new Date() }) {
  let t = h(i),
    ...
    s = ze(Wt),
    l = ze(`1991660486`),
    { accountId: f, authMethod: p, planAtLogin: m, userId: _ } = je(),
    { data: v } = Ie(),
    { data: y } = u(`account-info`, {
      queryConfig: { enabled: p === `chatgpt` && !0, staleTime: d.ONE_MINUTE },
    }),
    { data: b } = g(Kt),
    x = mt(e),
    S = st(x),
    C = da(x),
    w = f ?? y?.accountId ?? null,
    T = _ ?? y?.userId ?? null,
    E = nt({ accountId: w, enabled: p === `chatgpt`, userId: T }),
    ee = E.data?.activityInsights,
    O = Ze({ accountId: w, userId: T }),
    te = rt({ accountId: w, userId: T }),
    k = O.isPending || te.isPending,
    A = tt({ accountId: w, userId: T }),
    ne = _t(b?.avatars),
    { selectedAvatar: re } = ft(ne),
    [j, M] = (0, Q.useState)(null),
    [N, P] = (0, Q.useState)(null),
    [F, I] = (0, Q.useState)(`daily`),
    [L, ie] = (0, Q.useState)(null),
    [z, se] = (0, Q.useState)(null),
    [ce, le] = (0, Q.useState)(null),
    [ue, de] = (0, Q.useState)(!1),
    B = E.isLoading,
    fe = E.data == null && E.isError,
    pe = c.isInternal(ve()) && E.error != null ? va(E.error) : null,
    me = E.data?.hasStatsError === !0,
    he = re.id.startsWith(`custom:`),
    V = B ? null : (N ?? E.data?.imageUrl ?? v?.profile_picture_url ?? null),
    ge = V != null && V !== j,
    H = E.data?.username?.trim() || null,
    _e = E.data?.displayName ?? null,
    ye = B ? null : et({ accountName: v?.name, displayName: _e, username: H }),
    U = ot({
      accountStructure: v?.structure,
      plan: v?.plan_type ?? y?.plan ?? m,
      workspaceName: v?.name,
    }),
    W = E.data?.summary,
    be = W?.longestTaskDurationMs,
    Se = E.data?.dailyUsage,
    Te = ne.flatMap((e) =>
    ...
    Ee =
      me || Se == null
        ? null
        : {
            cells: dt({ dailyUsage: Se, todayIso: x, view: F }),
            dailyValues: bt({ dailyUsage: Se, todayIso: x }),
            weeklyTotals: ct({ dailyUsage: Se, todayIso: x }),
            cumulativeTotals: gt({ dailyUsage: Se, todayIso: x }),
          },
    De = r.formatMessage({
  ...
  return (
    (0, Q.useEffect)(() => {
      n.current || ((n.current = !0), K(t, Pe, { profileOwner: `self` }));
    }, [t]),
    fe
      ? (0, $.jsx)(ut, {
      ...
      : (0, $.jsxs)(ut, {
              ...
              (0, $.jsxs)(`div`, {
                ...
                children: [
                  s
                    ...
                    : null,
                  o && !B && !me && H != null && _e != null && W != null && Se != null
                    ? (0, $.jsx)(Ti, {
                        dailyUsage: Se,
                        displayName: _e,
                        imageUrl: ge ? V : null,
                        petOptions: Te,
                        selectedPetId: he ? re.id : null,
                        todayIso: x,
                        usageSummary: W,
                        username: H,
                      })
                  ...
                  (0, $.jsxs)(D, {
                    ...
                    size: `toolbar`,
                    onClick: () => {
                      (K(t, G, { action: Me.CODEX_PROFILE_EDIT_ACTION_OPENED }), de(!0));
                    },
                    children: [
                      (0, $.jsx)(ae, { "aria-hidden": !0, className: `icon-xs` }),
                      (0, $.jsx)(q, {
          ...
          children: [
            (0, $.jsxs)(`div`, {
              ...
              children: [
                (0, $.jsx)(`section`, {
                  ...
                  children: B
                    ? (0, $.jsx)(Ji, { avatar: re, showsPet: he })
                    : (0, $.jsxs)($.Fragment, {
                        children: [
                          (0, $.jsxs)(`div`, {
                              ...
                              (0, $.jsxs)(`label`, {
                                ...
                                children: [
                                  ...
                                  (0, $.jsx)(`input`, {
                                    ...
                                    onClick: () => {
                                      K(t, we, {
                                        action: We.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_STARTED,
                                      });
                                    },
                                    onChange: (e) => {
                                      ...
                                      ((e.currentTarget.value = ``),
                                        n != null &&
                                          (K(t, we, {
                                            action:
                                              We.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_IMAGE_SELECTED,
                                          }),
                                          qi(n).then(le, () => {
                                            (K(t, we, {
                                              action:
                                                We.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED,
                                            }),
                                              le(null));
                                          })));
                                    },
                      ...
                      : me
                        ...
                        : (0, $.jsxs)($.Fragment, {
                            children: [
                              ...
                              (0, $.jsx)(ca, {
                                value: vt(r, W?.currentStreakDays),
                                label: (0, $.jsx)(q, {
                              ...
                              (0, $.jsx)(la, {}),
                              (0, $.jsx)(ca, {
                                value: vt(r, W?.longestStreakDays),
                                label: (0, $.jsx)(q, {
                              ...
                              (0, $.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, $.jsx)(`div`, {
                                    ...
                                    children: Ee.cells.map((e, t) => {
                                      let n = yt(t, x);
                                      if (F === `daily` && n > x) return null;
                ...
                l ? (0, $.jsx)(ra, { insights: ee, isLoading: B, isUnavailable: me }) : null,
              ],
            }),
            ce == null
              ? null
              : (0, $.jsx)(mn, {
                  ...
                  onSave: (e) => {
                    (le(null),
                      ...
                      A.mutate(e.photo, {
                        onError: () => {
                          (K(t, we, { action: We.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED }),
                            P(null));
                        },
                        onSuccess: () => {
                          (K(t, we, {
                            action: We.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED,
                          }),
                            M(null),
                            P(null));
                        },
            ...
            ue
              ? (0, $.jsx)(Ri, {
                  displayName: ye,
                  failedProfileImageUrl: j,
                  isPhotoSaving: A.isPending,
                  isTextSaving: k,
                  profileImageUrl: V,
                  username: H,
                  onCancel: () => {
                  ...
                  onProfileImageError: M,
                  onSaveError: (e) => {
                    K(t, G, { action: Me.CODEX_PROFILE_EDIT_ACTION_SAVE_FAILED, ...e });
                  },
                  onPhotoChangeImageSelected: () => {
                    K(t, G, {
                      action: Me.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED,
                    });
                  },
                  onPhotoChangeStarted: () => {
                    K(t, G, { action: Me.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED });
                  },
                  onSaveProfile: async (e) => {
                    (await O.mutateAsync(e), M(null));
                  },
                  onSaveSuccess: () => {
                    K(t, G, { action: Me.CODEX_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED });
                  },
                  onSaveUsername: (e) => te.mutateAsync(e),
                })
              : null,
          ],
        })
...
function Ri({
  ...
  let m = Ke(),
    ...
    z = ie || r || n,
    se = St(S),
    le = z || y.trim().length === 0 || !se.ok,
    ue = T?.previewUrl ?? f,
    de = ue != null && ue !== t,
    B = p?.trim() ?? ``,
    fe = async () => {
      if (le) return;
      (j(null), N(null), F(null), L(null));
      let t = y.trim(),
        n = at(S),
        r = e?.trim() ?? ``;
      (b(t), C(n));
      ...
      R(!0);
      let g = De.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED,
        _ = De.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED;
      try {
        (h != null &&
          ((g = De.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
          await d(h),
          (g = De.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          p > 0 &&
            ((_ = De.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
            await l(f),
            (_ = De.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          u(),
          i());
      } catch (e) {
        if (
              ...
              children: (0, $.jsxs)(`label`, {
                ...
                children: [
                  ...
                  (0, $.jsx)(`span`, {
                    ...
                    children: (0, $.jsx)(ae, { "aria-hidden": !0, className: `icon-sm` }),
                  }),
                  (0, $.jsx)(`input`, {
                    type: `file`,
                    accept: `image/*`,
                    ...
                    children: [
                      ...
                      (0, $.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(`input`, {
                            id: v,
                            "aria-describedby": M == null ? void 0 : _,
                            "aria-invalid": M != null,
                            className: `min-w-0 flex-1 bg-transparent text-base leading-6 text-token-input-foreground outline-none`,
                            disabled: z,
                            maxLength: 20,
                            onChange: (e) => {
                              let t = lt(e.target.value),
                                n = St(t);
                              (C(t), N(n.ok ? null : Ki(n.reason, m)), L(null));
                            },
                            onFocus: (e) => {
                              e.currentTarget.select();
                            },
...
function zi() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(kt, { "aria-hidden": !0, className: `icon-2xs` })), (e[3] = i))
    : (i = e[3]);
  let a;
  return (
    e[4] === r
...
function Yi(e) {
  let t = (0, Z.c)(4),
    { className: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = oe(Fi.profileLoadingBlock, `block`, n)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function ra(e) {
  ...
  let { availablePlugins: o } = ie(qe, a);
  if (r) {
    let e;
    return (
...
function pa(e) {
  ...
  t[0] !== n || t[1] !== a || t[2] !== i
    ...
    : (o = t[3]);
  let s;
  t[4] !== a || t[5] !== r ? ((s = $e(a, r)), (t[4] = a), (t[5] = r), (t[6] = s)) : (s = t[6]);
  let c;
  return (
    t[7] !== o || t[8] !== s
      ? ((c = (0, $.jsx)(q, {
...
function ma(e) {
  let t = (0, Z.c)(10),
    ...
    a = Ke(),
    o;
  t[0] !== a || t[1] !== r ? ((o = $e(a, r)), (t[0] = a), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s = o,
    c;
  t[3] !== a || t[4] !== i
