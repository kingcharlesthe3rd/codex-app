...
import { n as Xe, t as Ze } from "./codex-avatar.js";
import {
  Go as Qe,
  St as $e,
  Wo as et,
...
function Qt(e) {
  ...
  let s = n ? `text-token-text-tertiary` : `text-token-text-primary`,
    c;
  t[2] === s ? (c = t[3]) : ((c = Se(`shrink-0 tabular-nums`, s)), (t[2] = s), (t[3] = c));
  let l;
  t[4] === a
    ? (l = t[5])
...
function tn(e) {
  ...
  switch (n) {
    ...
    case `max`: {
      let e;
      return (
        t[0] === n ? (e = t[1]) : ((e = (0, J.jsx)(C, { effort: n })), (t[0] = n), (t[1] = e)), e
      );
    }
    default: {
      let e;
...
function nn(e) {
  ...
  t[0] !== n || t[1] !== a
    ? ((o =
        a === `plugin`
          ...
          : (0, cn.createElement)(it(null, { fallbackName: n }), { className: `icon-sm` })),
      (t[0] = n),
      (t[1] = a),
      (t[2] = o))
    : (o = t[2]);
  ...
  if (r == null) {
    ...
    if (t[7] !== n || t[8] !== i || t[9] !== a) {
      ...
      bb0: {
        let t = Be(i?.split(`@`)[0] ?? (a === `skill` ? n.split(`:`)[0] : n));
        if (t != null) {
...
function mn(e) {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, Y.jsx)(mt, { className: `sr-only`, children: (0, Y.jsx)(K, { ...Fn.title }) })),
      (t[15] = w))
    : (w = t[15]);
  let T;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Y.jsx)(ht, { title: (0, Y.jsx)(K, { ...Fn.title }) })), (t[17] = E))
    : (E = t[17]);
  let D;
  ...
  t[31] === o
    ...
    : ((F =
      ...
      (t[32] = F));
  let I;
  t[33] !== n.dataUrl || t[34] !== ee || t[35] !== j || t[36] !== M || t[37] !== P || t[38] !== F
    ? ((I = (0, Y.jsx)(`div`, {
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, Y.jsx)(Yt, { className: `icon-sm` })), (t[67] = oe))
    : (oe = t[67]);
  let se;
  t[68] !== re || t[69] !== ie || t[70] !== ae
    ? ((se = (0, Y.jsx)(N, {
        "aria-label": re,
        className: `!size-5 !p-0`,
        color: `ghost`,
  ...
  let de;
  t[79] !== f || t[80] !== r
    ? ((de = (0, Y.jsx)(N, { color: `ghost`, disabled: f, onClick: r, children: le })),
      (t[79] = f),
      (t[80] = r),
      (t[81] = de))
    : (de = t[81]);
  ...
  let me;
  t[86] !== de || t[87] !== q
    ? ((me = (0, Y.jsxs)(pt, { children: [de, q] })), (t[86] = de), (t[87] = q), (t[88] = me))
    : (me = t[88]);
  let he;
  t[89] !== L || t[90] !== ce || t[91] !== G || t[92] !== me || t[93] !== C
    ? ((he = (0, Y.jsxs)(gt, {
        as: `form`,
        className: `gap-5`,
        onSubmit: C,
        children: [w, T, E, L, ce, G, me],
      })),
      (t[89] = L),
      (t[90] = ce),
      (t[91] = G),
...
async function hr(e) {
  if (!_r(e)) return null;
  try {
    let t = await _.getInstance().get(e),
      n = Zr.parse(t.body);
...
var yr,
  ...
  Qr = e(() => {
    (l(),
      ...
      (Zr = m({ base64: d().min(1), contentType: d() })));
  }),
  $r,
  ei,
  ti = e(() => {
...
function ci(e) {
  ...
  let ee;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, X.jsx)(se, { "aria-hidden": !0, className: `icon-sm` })), (t[15] = ee))
    : (ee = t[15]);
  let j;
  t[16] !== k || t[17] !== A
    ? ((j = (0, X.jsx)(N, {
  ...
  let P = o == null ? `mt-[50px]` : `mt-8`,
    F;
  t[20] === P ? (F = t[21]) : ((F = Se(`flex flex-col items-center`, P)), (t[20] = P), (t[21] = F));
  let I;
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = Se(
  ...
  let z;
  t[30] !== L || t[31] !== R
    ? ((z = (0, X.jsx)(Je.div, { className: I, style: L, children: R })),
      (t[30] = L),
      (t[31] = R),
      (t[32] = z))
    : (z = t[32]);
  let B;
  t[33] !== S || t[34] !== b || t[35] !== z
    ? ((B = (0, X.jsx)(`div`, {
  ...
  let H;
  t[39] !== B || t[40] !== V
    ? ((H = (0, X.jsxs)(`div`, { className: `relative w-fit`, children: [B, V] })),
      (t[39] = B),
      (t[40] = V),
      (t[41] = H))
    : (H = t[41]);
  ...
  t[42] === U
    ? (te = t[43])
    : ((te = Se(`flex items-start justify-center gap-2 sm:gap-5`, U)), (t[42] = U), (t[43] = te));
  let W;
  t[44] === m
    ? (W = t[45])
    : ((W = m.formatMessage({
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, X.jsx)(oi, { "aria-hidden": !0, className: `icon-sm` })), (t[49] = oe))
    : (oe = t[49]);
  let ce;
  t[50] !== W || t[51] !== ne || t[52] !== re || t[53] !== ae
    ? ((ce = (0, X.jsx)(li, {
        ariaLabel: W,
        active: ne,
        disabled: re,
  ...
  t[60] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = (0, X.jsx)(ei, { "aria-hidden": !0, className: `icon-sm` })), (t[60] = q))
    : (q = t[60]);
  let me;
  t[61] !== G || t[62] !== le || t[63] !== de || t[64] !== pe
    ? ((me = (0, X.jsx)(li, {
        ariaLabel: G,
        active: le,
        disabled: de,
  ...
  t[71] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((be = (0, X.jsx)(ri, { "aria-hidden": !0, className: `icon-sm` })), (t[71] = be))
    : (be = t[71]);
  let xe;
  t[72] !== he || t[73] !== ge || t[74] !== _e || t[75] !== ye
    ? ((xe = (0, X.jsx)(li, {
        ariaLabel: he,
        active: ge,
        disabled: _e,
  ...
  t[79] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Te = (0, X.jsx)(Pe, { "aria-hidden": !0, className: `icon-sm` })), (t[79] = Te))
    : (Te = t[79]);
  let Ee;
  ...
  t[81] !== l || t[82] !== Ce || t[83] !== we
    ...
    : (De = t[84]);
  let Oe;
  t[85] !== te || t[86] !== ce || t[87] !== me || t[88] !== xe || t[89] !== De
    ? ((Oe = (0, X.jsxs)(`div`, { className: te, children: [ce, me, xe, De] })),
      (t[85] = te),
      (t[86] = ce),
      (t[87] = me),
      (t[88] = xe),
  ...
  t[97] === ke
    ? (Ae = t[98])
    : ((Ae = (0, X.jsx)(qe, { children: ke })), (t[97] = ke), (t[98] = Ae));
  let je;
  t[99] !== F || t[100] !== H || t[101] !== Oe || t[102] !== Ae
    ? ((je = (0, X.jsxs)(`div`, {
        className: `flex min-h-fit flex-col items-center`,
        children: [M, (0, X.jsxs)(`div`, { className: F, children: [H, Oe, Ae] })],
      })),
      (t[99] = F),
      (t[100] = H),
      (t[101] = Oe),
  ...
  let Ne;
  return (
    t[107] !== d || t[108] !== i || t[109] !== j || t[110] !== Me
      ? ((Ne = (0, X.jsxs)(lt, {
          open: i,
...
function ui(e) {
  ...
  t[4] !== d || t[5] !== n || t[6] !== u || t[7] !== c
    ? ((h = d
        ? (0, X.jsx)(N, {
            ...
            uniform: !0,
            onClick: c,
            children: (0, X.jsx)(ae, { "aria-hidden": !0, className: `icon-xs rotate-180` }),
          })
        : null),
      (t[4] = d),
      (t[5] = n),
  ...
  t[9] === g
    ? (_ = t[10])
    : ((_ = Se(`truncate text-xs leading-4 font-medium`, g)), (t[9] = g), (t[10] = _));
  let v;
  t[11] !== a || t[12] !== _
  ...
  t[21] !== d || t[22] !== n || t[23] !== u || t[24] !== s
    ? ((x = d
        ? (0, X.jsx)(N, {
            ...
            uniform: !0,
            onClick: s,
            children: (0, X.jsx)(ae, { "aria-hidden": !0, className: `icon-xs` }),
          })
        : null),
      (t[21] = d),
      (t[22] = n),
...
function di(e) {
  ...
  let v, y;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, X.jsx)(at, { "aria-hidden": !0, className: `icon-xs` })),
      (v = (0, X.jsx)(K, {
  ...
  t[26] === d
    ? (C = t[27])
    : ((C = (0, X.jsx)(ke, { href: d, className: `icon-xs` })), (t[26] = d), (t[27] = C));
  let w;
  t[28] === l
    ? (w = t[29])
    : ((w = (0, X.jsx)(K, {
...
function Ti({
  ...
  let l = s(pe),
    ...
    M = (e, t) => {
      ...
      W(l, oe, { action: e, socialPlatform: Oi(t) });
    },
    P = () => {
      ...
      return {
        ...
        stats: [
          ...
          },
          {
            ...
            value: At(u, o.currentStreakDays),
          },
          {
            label: u.formatMessage({
            ...
            value: At(u, o.longestStreakDays),
          },
        ],
        theme: Un(),
        usernameLabel: r,
        usageCells: Dt({ dailyUsage: e, todayIso: a }),
      };
    },
    F = async (e, t) => {
      let n = await Ei(e);
    ...
    I = async (e, { clearPreview: t, showLoadingState: n, requestId: r }) => {
      (n && f(!0), t && g(null));
      try {
        await F(await Wn({ ...P(), petImageUrl: e?.imageUrl ?? null }), r);
      } catch {
        if (E.current !== r) return;
        (m(!1), T(null), l.get(ie).danger(O));
      } finally {
        n && E.current === r && f(!1);
      }
    },
    L = async (e, t, { clearPreview: n, showLoadingState: r, requestId: i }) => {
      ...
      try {
        ...
        (t ?? T(n), await F(await n.createImageBlob(e.imageUrl), i));
      } catch {
        if (E.current !== i) return;
        (m(!1), T(null), l.get(ie).danger(O));
      } finally {
    ...
    z = () => {
      ...
      (m(!0), v(null), T(null), b(t === -1 ? null : t), S(t !== -1));
      let n = r[t];
      if (n == null) {
    ...
    B = (e) => {
      ...
      E.current += 1;
      let n = E.current;
      (b(e), S(!0), L(t, C, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    V = (e) => {
      ...
      E.current += 1;
      let n = E.current;
      (S(e), I(e ? t : null, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    H = () => {
      h != null &&
        (M(R.CODEX_PROFILE_SHARE_ACTION_SAVE_BUTTON_CLICKED), Kn(h.blob), l.get(ie).success(ee));
    },
    U = () => {
      h != null &&
        te({ "image/png": h.blob }).then(
          () => {
            l.get(ie).success(k);
          },
          () => {
    ...
    ne = (e) => {
      (e || ((E.current += 1), v(null), b(null), S(!1), f(!1), T(null)), m(e));
    };
  return (0, Ai.jsxs)(Ai.Fragment, {
    children: [
      (0, Ai.jsxs)(N, {
        ...
        size: `toolbar`,
        onClick: () => {
          (M(R.CODEX_PROFILE_SHARE_ACTION_SHARE_BUTTON_CLICKED), z());
        },
        children: [
          (0, Ai.jsx)(w, { "aria-hidden": !0, className: `icon-xs` }),
          (0, Ai.jsx)(K, {
      ...
      (0, Ai.jsx)(ci, {
        ...
        onOpenSocialDraft: (e, t) => {
          let n = Di(e, j);
          (M(R.CODEX_PROFILE_SHARE_ACTION_SOCIAL_COMPOSER_BUTTON_CLICKED, e),
            Le({ event: t, href: n, initiator: `open_in_browser_bridge` }));
        },
        onSelectSocialPlatform: (e) => {
          (M(R.CODEX_PROFILE_SHARE_ACTION_SOCIAL_SHARE_BUTTON_CLICKED, e), v(e));
        },
      }),
    ],
  });
...
function Oi(e) {
  switch (e) {
    case `linkedin`:
      return P.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_LINKEDIN;
    case `reddit`:
      return P.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_REDDIT;
    case `x`:
      return P.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_X;
  }
}
var ki,
  Ai,
...
function Li({ today: e = new Date() }) {
  let t = s(pe),
    ...
    l = ee(ge),
    u = ee(`1991660486`),
    { accountId: d, authMethod: f, planAtLogin: m, userId: h } = De(),
    { data: g } = He(),
    { data: _ } = v(`account-info`, {
      queryConfig: { enabled: f === `chatgpt` && !0, staleTime: p.ONE_MINUTE },
    }),
    { data: y } = c(Kt),
    x = Vt(e),
    S = yt(x),
    C = da(x),
    w = d ?? _?.accountId ?? null,
    E = h ?? _?.userId ?? null,
    D = Ft({ accountId: w, enabled: f === `chatgpt`, userId: E }),
    O = D.data?.activityInsights,
    k = kt({ accountId: w, userId: E }),
    A = Nt({ accountId: w, userId: E }),
    j = k.isPending || A.isPending,
    P = St({ accountId: w, userId: E }),
    F = Ht(y?.avatars),
    { selectedAvatar: L } = Wt(F),
    [R, z] = (0, Q.useState)(null),
    [B, H] = (0, Q.useState)(null),
    [U, te] = (0, Q.useState)(`daily`),
    [ie, ae] = (0, Q.useState)(null),
    [oe, se] = (0, Q.useState)(null),
    [G, le] = (0, Q.useState)(null),
    [de, fe] = (0, Q.useState)(!1),
    q = D.isLoading,
    me = D.data == null && D.isError,
    _e = o.isInternal(Oe()) && D.error != null ? va(D.error) : null,
    ve = D.data?.hasStatsError === !0,
    ye = L.id.startsWith(`custom:`),
    Ce = q ? null : (B ?? D.data?.imageUrl ?? g?.profile_picture_url ?? null),
    we = Ce != null && Ce !== R,
    Te = D.data?.username?.trim() || null,
    Ee = D.data?.displayName ?? null,
    ke = q ? null : Ot({ accountName: g?.name, displayName: Ee, username: Te }),
    Ae = jt({
      accountStructure: g?.structure,
      plan: g?.plan_type ?? _?.plan ?? m,
      workspaceName: g?.name,
    }),
    je = D.data?.summary,
    Me = je?.longestTaskDurationMs,
    Ne = D.data?.dailyUsage,
    Pe = F.flatMap((e) =>
    ...
    Fe =
      ve || Ne == null
        ? null
        : {
            cells: Bt({ dailyUsage: Ne, todayIso: x, view: U }),
            dailyValues: zt({ dailyUsage: Ne, todayIso: x }),
            weeklyTotals: bt({ dailyUsage: Ne, todayIso: x }),
            cumulativeTotals: _t({ dailyUsage: Ne, todayIso: x }),
          },
    Ie = r.formatMessage({
  ...
  return (
    (0, Q.useEffect)(() => {
      n.current || ((n.current = !0), W(t, ce, { profileOwner: `self` }));
    }, [t]),
    me
      ? (0, $.jsx)(be, {
                ...
                children: [
                  l
                    ? (0, $.jsxs)(N, {
                        ...
                        onClick: xe,
                        children: [
                          (0, $.jsx)(he, { "aria-hidden": !0, className: `icon-xs` }),
                          (0, $.jsx)(K, {
                    ...
                    : null,
                  a && !q && !ve && Te != null && Ee != null && je != null && Ne != null
                    ? (0, $.jsx)(Ti, {
                        dailyUsage: Ne,
                        displayName: Ee,
                        imageUrl: we ? Ce : null,
                        petOptions: Pe,
                        selectedPetId: ye ? L.id : null,
                        todayIso: x,
                        usageSummary: je,
                        username: Te,
                      })
                  ...
                  (0, $.jsxs)(N, {
                    ...
                    size: `toolbar`,
                    onClick: () => {
                      (W(t, ne, { action: re.CODEX_PROFILE_EDIT_ACTION_OPENED }), fe(!0));
                    },
                    children: [
          ...
          children: [
            (0, $.jsxs)(`div`, {
              ...
              children: [
                      ...
                      : ve
                        ...
                        : (0, $.jsxs)($.Fragment, {
                            children: [
                              ...
                              (0, $.jsx)(ca, {
                                value: At(r, je?.currentStreakDays),
                                label: (0, $.jsx)(K, {
                              ...
                              (0, $.jsx)(la, {}),
                              (0, $.jsx)(ca, {
                                value: At(r, je?.longestStreakDays),
                                label: (0, $.jsx)(K, {
                ...
                u ? (0, $.jsx)(ra, { insights: O, isLoading: q, isUnavailable: ve }) : null,
              ],
            }),
            G == null
              ? null
              : (0, $.jsx)(mn, {
                  ...
                  onSave: (e) => {
                    (le(null),
                      ...
                      P.mutate(e.photo, {
                        onError: () => {
                          (W(t, I, { action: V.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED }),
                            H(null));
                        },
                        onSuccess: () => {
                          (W(t, I, {
            ...
            de
              ? (0, $.jsx)(Ri, {
                  ...
                  onProfileImageError: z,
                  onSaveError: (e) => {
                    W(t, ne, { action: re.CODEX_PROFILE_EDIT_ACTION_SAVE_FAILED, ...e });
                  },
                  ...
                  onPhotoChangeStarted: () => {
                    W(t, ne, { action: re.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED });
                  },
                  onSaveProfile: async (e) => {
                    (await k.mutateAsync(e), z(null));
                  },
                  onSaveSuccess: () => {
                    W(t, ne, { action: re.CODEX_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED });
                  },
...
function Ri({
  ...
  let m = ue(),
    ...
    [M, P] = (0, Q.useState)(null),
    [F, I] = (0, Q.useState)(!1),
    L = F || r || n,
    R = Rt(x),
    z = L || y.trim().length === 0 || !R.ok,
    B = C?.previewUrl ?? f,
    V = B != null && B !== t,
    H = p?.trim() ?? ``,
    te = async () => {
      if (z) return;
      (O(null), A(null), j(null), P(null));
      let t = y.trim(),
        n = Et(x),
        r = e?.trim() ?? ``;
      (b(t), S(n));
            ...
            (0, $.jsx)(dt, {
              ...
              children: (0, $.jsxs)(`label`, {
                ...
                className: Se(
                  ...
                  L ? `cursor-default opacity-70` : `cursor-interaction`,
                ),
                children: [
                  V
                    ? (0, $.jsx)(`img`, {
                    ...
                    children: [
                      ...
                      (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(`input`, {
                          ...
                          maxLength: 64,
                          onChange: (e) => {
                            (b(e.target.value), O(null), P(null));
                          },
                          onFocus: (e) => {
                          ...
                          (0, $.jsx)(`input`, {
                            ...
                            onChange: (e) => {
                              let t = xt(e.target.value),
                                n = Rt(t);
                              (S(t), A(n.ok ? null : Ki(n.reason, m)), P(null));
                            },
                            onFocus: (e) => {
                              e.currentTarget.select();
                            },
...
function zi() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(st, { "aria-hidden": !0, className: `icon-2xs` })), (e[3] = i))
    : (i = e[3]);
  let a;
  return (
    e[4] === r
...
function Yi(e) {
  let t = (0, Z.c)(4),
    { className: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = Se(Fi.profileLoadingBlock, `block`, n)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function ra(e) {
  ...
  let { availablePlugins: o } = je(me, a);
  if (r) {
    let e;
    return (
...
function pa(e) {
  ...
  t[0] !== n || t[1] !== a || t[2] !== i
    ...
    : (o = t[3]);
  let s;
  t[4] !== a || t[5] !== r ? ((s = wt(a, r)), (t[4] = a), (t[5] = r), (t[6] = s)) : (s = t[6]);
  let c;
  return (
    t[7] !== o || t[8] !== s
      ? ((c = (0, $.jsx)(K, {
...
function ma(e) {
  let t = (0, Z.c)(10),
    ...
    a = ue(),
    o;
  t[0] !== a || t[1] !== r ? ((o = wt(a, r)), (t[0] = a), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s = o,
    c;
  t[3] !== a || t[4] !== i
