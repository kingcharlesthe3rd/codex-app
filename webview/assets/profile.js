...
import { c as ee, o as w, r as T } from "./lib-2.js";
import { n as E } from "./chunk-12.js";
import { t as D } from "./known-app-icon.js";
import "./branch.js";
import "./github-mark.js";
import "./google-drive-CC-Egn92.js";
import "./notion.js";
import { h as O } from "./persisted-signal-CweW-bgN.js";
import "./rpc-1.js";
import { o as k } from "./statsig.js";
import "./request.js";
...
import { t as A } from "./use-auth-6.js";
import "./_baseEach.js";
...
import { i as L, t as R } from "./proxy.js";
import { G as z, mt as B, tt as V } from "./single-value.js";
...
import { t as W } from "./get-skill-icon.js";
import "./bug.js";
import "./chrome.js";
import "./codex.js";
import "./openai-blossom.js";
import { t as G } from "./pencil.js";
...
import { t as pe } from "./codex-api-error.js";
import { t as J } from "./copy.js";
import {
  C as me,
  S as he,
  _ as ge,
...
import { t as Pe } from "./lock.js";
import { t as Fe } from "./model-and-reasoning-effort-translations.js";
import { t as Ie } from "./settings-content-layout.js";
import { i as Le, o as Re, r as ze, t as Be } from "./codex-avatar.js";
import { t as Ve } from "./share.js";
import { t as He } from "./question-mark-circle.js";
function Ue(e, t, n) {
  let r = e.get(),
    i = null,
    a = r,
  ...
  if (
    (e.attach((e, t) => {
      ((a = e), (o = (e) => t(We(e, s))), B.postRender(l));
    }, c),
    z(t))
  ) {
    let n = t.on(`change`, (t) => e.set(We(t, s))),
      r = e.on(`destroy`, n);
    return () => {
      (n(), r());
    };
...
var Z = e(p(), 1);
function Ke(e, t = {}) {
  let { isStatic: n } = (0, Z.useContext)(L),
    r = () => (z(e) ? e.get() : e);
  if (n) return H(r);
  let i = te(r());
  return ((0, Z.useInsertionEffect)(() => Ue(i, e, t), [i, JSON.stringify(t)]), i);
}
var Q = x(),
  $ = m(),
  qe = { plugin: `@`, skill: `$` };
  ...
  if (
      ...
      ? ((m =
          r !== void 0 && i !== void 0
            ? (0, $.jsx)(Xe, {
                ...
                value: l
                  ? (0, $.jsxs)($.Fragment, {
                      children: [(0, $.jsx)($e, { effort: r }), ` · `, tt(o, i)],
                    })
                  : (0, $.jsx)(Ze, {}),
              })
            : null),
      ...
      ? ((h =
          n.skillsExplored == null
            ...
            : (0, $.jsx)(Xe, {
                ...
                value:
                  n.skillsExplored === 0 ? (0, $.jsx)(Qe, {}) : o.formatNumber(n.skillsExplored),
              })),
      ...
      ? ((g =
          n.totalSkillsUsed == null
            ...
            : (0, $.jsx)(Xe, {
                ...
                value: u ? o.formatNumber(n.totalSkillsUsed) : (0, $.jsx)(Qe, {}),
              })),
        (t[27] = u),
      ...
      ? ((_ =
          n.totalThreads == null
            ...
            : (0, $.jsx)(Xe, {
                ...
                value: n.totalThreads === 0 ? (0, $.jsx)(Qe, {}) : o.formatNumber(n.totalThreads),
              })),
        (t[31] = n.totalThreads),
        (t[32] = o),
        (t[33] = _))
    ...
    (t[34] !== _ || t[35] !== p || t[36] !== m || t[37] !== h || t[38] !== g
      ? ((v = (0, $.jsxs)(`div`, {
          ...
          children: [
            f,
            (0, $.jsxs)(`dl`, { className: `flex flex-col gap-2`, children: [p, m, h, g, _] }),
          ],
        })),
        (t[34] = _),
        (t[35] = p),
...
function Ye(e) {
  ...
  t[6] !== n.plugin_id || t[7] !== n.type || t[8] !== a || t[9] !== r
    ? ((l = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(et, { name: a, plugin: r, pluginId: n.plugin_id, type: n.type }),
      })),
      (t[6] = n.plugin_id),
      (t[7] = n.type),
      (t[8] = a),
...
function $e(e) {
  ...
  switch (n) {
    ...
    case `xhigh`: {
      let e;
      return (
        t[0] === n ? (e = t[1]) : ((e = (0, $.jsx)(Fe, { effort: n })), (t[0] = n), (t[1] = e)), e
      );
    }
    default: {
      let e;
...
function et(e) {
  ...
  t[0] !== n || t[1] !== a
    ? ((o =
        a === `plugin`
          ...
          : (0, Z.createElement)(W(null, { fallbackName: n }), { className: `icon-sm` })),
      (t[0] = n),
      (t[1] = a),
      (t[2] = o))
    : (o = t[2]);
  ...
  if (r?.logoPath != null) {
    ...
    return (
      t[3] !== s || t[4] !== r.logoPath
        ? ((e = (0, $.jsx)(M, { alt: ``, className: `icon-sm`, fallback: s, logoUrl: r.logoPath })),
          (t[3] = s),
          (t[4] = r.logoPath),
          (t[5] = e))
        : (e = t[5]),
  ...
  if (r == null) {
    ...
    if (t[6] !== n || t[7] !== i || t[8] !== a) {
      ...
      bb0: {
        let t = D(i?.split(`@`)[0] ?? (a === `skill` ? n.split(`:`)[0] : n));
        if (t != null) {
...
var it = (e) =>
  ...
  ft = dt - 32,
  pt = 2,
  mt = `radial-gradient(circle at center, transparent 0 ${ut - 0.5}px, black ${ut}px ${ft}px, transparent ${dt}px)`;
function ht(e) {
  let t = (0, Q.c)(96),
  ...
  t[0] === o
    ? (f = t[1])
    : ((f = o == null ? 1 : _t(o.naturalWidth, o.naturalHeight)), (t[0] = o), (t[1] = f));
  let p = f,
    m = o == null ? 1 : o.zoom / p,
    h;
  t[2] !== o || t[3] !== p
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(se, { className: `sr-only`, children: (0, $.jsx)(w, { ...Tt.title }) })),
      (t[15] = S))
    : (S = t[15]);
  let C;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(ce, { title: (0, $.jsx)(w, { ...Tt.title }) })), (t[17] = T))
    : (T = t[17]);
  let E;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = { maxWidth: st }), (t[18] = E))
    : (E = t[18]);
  let D;
    ...
    ? ((D =
        o == null
          ...
          : (0, $.jsx)(`div`, {
              ...
              style: { WebkitMaskImage: mt, maskImage: mt },
              children: (0, $.jsxs)(`div`, {
                className: `absolute top-0 left-0 overflow-hidden`,
                style: {
                  height: o.naturalHeight * o.zoom,
                  transform: `translate(${lt + o.offsetX}px, ${lt + o.offsetY}px)`,
                ...
                children: [
                  (0, $.jsx)(`img`, {
                    ...
                    style: {
                      filter: `blur(${pt}px)`,
                      height: `calc(100% + ${pt * 2}px)`,
                      transform: `translate(${-pt}px, ${-pt}px)`,
                      width: `calc(100% + ${pt * 2}px)`,
                    },
                  }),
                  (0, $.jsx)(`div`, {
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = { height: ot, width: ot }), (t[22] = O))
    : (O = t[22]);
  let k;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (e) => {
        s(gt(e.currentTarget.naturalWidth, e.currentTarget.naturalHeight));
      }),
      (t[23] = k))
    : (k = t[23]);
  let A;
        ...
        c != null &&
          ...
          s((t) =>
            t == null
              ...
              : {
                  ...t,
                  offsetX: yt(c.offsetX + e.clientX - c.pointerX, t.naturalWidth, t.zoom),
                  offsetY: yt(c.offsetY + e.clientY - c.pointerY, t.naturalHeight, t.zoom),
                },
          );
      }),
      (t[26] = c),
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, $.jsx)(it, { className: `icon-sm` })), (t[48] = V))
    : (V = t[48]);
  let te;
  t[49] !== R || t[50] !== z || t[51] !== B
    ? ((te = (0, $.jsx)(F, {
        "aria-label": R,
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = (0, $.jsx)(at, { className: `icon-sm` })), (t[67] = W))
    : (W = t[67]);
  let G;
  t[68] !== ie || t[69] !== ae || t[70] !== oe
    ? ((G = (0, $.jsx)(F, {
        "aria-label": ie,
        className: `!size-5 !p-0`,
        color: `ghost`,
  ...
  let J;
  t[77] !== u || t[78] !== r
    ? ((J = (0, $.jsx)(F, { color: `ghost`, disabled: u, onClick: r, children: pe })),
      (t[77] = u),
      (t[78] = r),
      (t[79] = J))
    : (J = t[79]);
  ...
  let _e;
  t[84] !== J || t[85] !== ge
    ? ((_e = (0, $.jsxs)(de, { children: [J, ge] })), (t[84] = J), (t[85] = ge), (t[86] = _e))
    : (_e = t[86]);
  let ve;
  t[87] !== L || t[88] !== K || t[89] !== _e || t[90] !== x
    ? ((ve = (0, $.jsxs)(ue, {
        as: `form`,
        className: `gap-5`,
        onSubmit: x,
        children: [S, C, T, L, K, _e],
      })),
      (t[87] = L),
      (t[88] = K),
      (t[89] = _e),
...
function gt(e, t) {
  let n = _t(e, t);
  return { naturalHeight: t, naturalWidth: e, offsetX: vt(e, n), offsetY: vt(t, n), zoom: n };
}
function _t(e, t) {
  return Math.max(ot / e, ot / t);
}
function vt(e, t) {
  return (ot - e * t) / 2;
}
function yt(e, t, n) {
  return Math.min(0, Math.max(ot - t * n, e));
}
function bt(e, t) {
  let n = (ot / 2 - e.offsetX) / e.zoom,
    r = (ot / 2 - e.offsetY) / e.zoom;
  return {
    ...e,
    offsetX: yt(ot / 2 - n * t, e.naturalWidth, t),
    offsetY: yt(ot / 2 - r * t, e.naturalHeight, t),
    zoom: t,
  };
}
async function xt(e, t) {
  let n = await St(e.dataUrl),
    r = document.createElement(`canvas`);
  ((r.height = ct), (r.width = ct));
  let i = r.getContext(`2d`);
  if (i == null) throw Error(`Unable to create profile photo crop canvas`);
  i.drawImage(n, -t.offsetX / t.zoom, -t.offsetY / t.zoom, ot / t.zoom, ot / t.zoom, 0, 0, ct, ct);
  let a = wt(e.contentType),
...
var Tt = T({
  ...
  Et = `` + new URL(`OpenAISans-Medium-B7nJY_kG.woff2`, import.meta.url).href,
  Dt = `` + new URL(`OpenAISans-Regular-DFZxHTKM.woff2`, import.meta.url).href,
  Ot = `<svg width="92" height="28" viewBox="0 0 92 28" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
  ...
  Kt = 232,
  qt = (At - 2 * Nt) / 4,
  Jt = { 0: `#e5e5e5`, 1: `#bbb4ff`, 2: `#a79dff`, 3: `#8d7cff`, 4: `#5865f2` },
  Yt = t({ base64: n().min(1), contentType: n() }),
  Xt = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(Ot.replaceAll(`currentColor`, Rt))}`;
async function Zt({ imageUrl: e, initials: t, stats: n, usernameLabel: r, usageCells: i }) {
  let a = document.createElement(`canvas`);
  ((a.width = At * Mt), (a.height = jt * Mt));
  let o = a.getContext(`2d`);
  if (o == null) throw Error(`Unable to create profile share card canvas`);
  let [s, c] = await Promise.all([e == null ? Promise.resolve(null) : dn(e), pn(Xt, null), $t()]);
  if (c == null) throw Error(`Unable to load Codex watermark`);
  return (o.scale(Mt, Mt), tn(o), nn(o, s, t), rn(o, r), an(o, c), on(o, i), sn(o, n), hn(a));
}
function Qt(e) {
  let t = URL.createObjectURL(e),
    n = document.createElement(`a`);
  ((n.href = t), (n.download = kt), n.click(), window.setTimeout(() => URL.revokeObjectURL(t), 0));
}
async function $t() {
  (await Promise.all([en(Dt, `400`), en(Et, `500`)]), await document.fonts.ready);
}
async function en(e, t) {
  let n = new FontFace(zt, `url(${e})`, { weight: t });
  (document.fonts.add(n), await n.load());
}
function tn(e) {
  ((e.fillStyle = `#ffffff`), ln(e, 0, 0, At, jt, Pt), e.fill());
}
function nn(e, t, n) {
  let r = Nt,
    i = Nt;
...
function rn(e, t) {
  let n = Nt + Ft + 12,
    r = Vt - n - 12;
  ((e.fillStyle = `#0d0d0d`),
    (e.font = `500 22px 'OpenAI Sans', system-ui, sans-serif`),
    (e.textAlign = `left`),
    (e.textBaseline = `middle`),
    e.fillText(un(e, t, r), n, Nt + Ft / 2));
}
function an(e, t) {
  e.drawImage(t, Vt, Ht, It, Lt);
}
function on(e, t) {
  for (let n = 0; n < 182; n += 1) {
    let r = Math.floor(n / 7),
      i = n % 7,
      a = Nt + r * Gt,
      o = Ut + i * Gt;
    ((e.fillStyle = Jt[t[n] ?? 0]), ln(e, a, o, Wt, Wt, 4), e.fill());
  }
}
function sn(e, t) {
  t.forEach((t, n) => {
    n > 0 &&
      ((e.fillStyle = `rgba(13, 13, 13, 0.06)`), ln(e, Nt + n * qt, Kt + 2, 1, 40, 0.5), e.fill());
    let r = Nt + n * qt + qt / 2,
      i = qt - 8;
    ((e.fillStyle = `#0d0d0d`),
      ...
      (e.textAlign = `center`),
      (e.textBaseline = `middle`),
      e.fillText(un(e, t.value, i), r, Kt + 13),
      (e.fillStyle = `#5d5d5d`),
      (e.font = `400 14px 'OpenAI Sans', system-ui, sans-serif`),
      e.fillText(un(e, t.label, i), r, Kt + 37));
  });
}
...
async function dn(e) {
  return (await pn(e, mn(e) ? `anonymous` : null)) ?? (await fn(e));
}
async function fn(e) {
  if (!mn(e)) return null;
  try {
    let t = await b.getInstance().get(e),
      n = Yt.parse(t.body);
    return await pn(`data:${n.contentType.trim() || `image/png`};base64,${n.base64}`, null);
  } catch {
    return null;
  }
}
...
var gn = (e) =>
  ...
  yn = `profile-share-card-social-instructions`,
  bn = `relative size-[52px] overflow-visible !rounded-full`,
  xn = `absolute top-[60px] left-1/2 max-w-[68px] -translate-x-1/2 truncate text-center text-xs leading-4 text-token-text-secondary`,
  Sn = `[box-shadow:rgba(0,0,0,0.06)_0px_4px_12px_-8px,rgba(0,0,0,0.10)_0px_9px_64px_-10px,rgba(0,0,0,0.05)_0px_0px_0px_0.5px]`,
  Cn = { stiffness: 200, damping: 25, mass: 1 },
  wn = 1.5,
  Tn = 2;
function En(e) {
  let t = (0, Q.c)(105),
    {
      ...
      isLoading: r,
      open: i,
      selectedSocialPlatform: a,
      onCopy: o,
      onDownload: s,
      onDismissShareInstructions: c,
      onOpenChange: l,
      onOpenSocialDraft: u,
      onSelectSocialPlatform: d,
    } = e,
    f = ee(),
    p = te(0),
    m = te(0),
  ...
  t[6] === x
    ...
    : ((S = (e) => {
        ...
        (e.target instanceof Node && t?.contains(e.target) === !0) || x();
      }),
      (t[6] = x),
      (t[7] = S));
  let C = S,
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = { style: { height: `100dvh`, maxWidth: `none`, width: `100vw`, zIndex: 51 } }),
      (t[8] = T))
    : (T = t[8]);
  let E;
  ...
  let A;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, $.jsx)(ie, { "aria-hidden": !0, className: `icon-sm` })), (t[15] = A))
    : (A = t[15]);
  let j;
  t[16] !== O || t[17] !== k
    ? ((j = (0, $.jsx)(F, {
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, $.jsx)(`h2`, {
      ...
      (t[19] = M))
    : (M = t[19]);
  let N = a == null ? `mt-[50px]` : `mt-8`,
    P;
  t[20] === N ? (P = t[21]) : ((P = h(`flex flex-col items-center`, N)), (t[20] = N), (t[21] = P));
  let I;
  t[22] !== g || t[23] !== _
    ? ((I = { rotateX: g, rotateY: _ }), (t[22] = g), (t[23] = _), (t[24] = I))
    : (I = t[24]);
  let L;
  t[25] !== n || t[26] !== f || t[27] !== a
    ? ((L =
        n == null
          ? (0, $.jsx)(`div`, {
              role: `status`,
              ...
              className: h(
                `flex aspect-[499/306] items-center justify-center rounded-[32px] bg-token-dropdown-background/90 text-sm text-token-text-secondary`,
                Sn,
              ),
              style: { width: `min(499px, calc(100vw - 56px))` },
              children: (0, $.jsx)(w, {
          ...
          : (0, $.jsx)(`img`, {
              ...
              className: h(`block h-auto w-auto rounded-[32px]`, Sn),
              style: {
                maxHeight:
                  a == null ? `max(180px, calc(100vh - 310px))` : `max(180px, calc(100vh - 460px))`,
                maxWidth: `min(499px, calc(100vw - 56px))`,
              },
            })),
      (t[25] = n),
      (t[26] = f),
  ...
  t[32] !== x || t[33] !== y || t[34] !== z
    ? ((B = (0, $.jsx)(`div`, {
      ...
      (t[35] = B))
    : (B = t[35]);
  let V = a == null ? `mt-[50px]` : `mt-8 mb-7`,
    H;
  t[36] === V
    ? (H = t[37])
    : ((H = h(`flex items-start justify-center gap-2 sm:gap-5`, V)), (t[36] = V), (t[37] = H));
  let U;
  t[38] === f
    ? (U = t[39])
    : ((U = f.formatMessage({
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, $.jsx)(vn, { "aria-hidden": !0, className: `icon-sm` })), (t[43] = K))
    : (K = t[43]);
  let q;
  t[44] !== U || t[45] !== re || t[46] !== ae || t[47] !== G
    ? ((q = (0, $.jsx)(Dn, {
        ariaLabel: U,
        active: re,
        disabled: ae,
  ...
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, $.jsx)(gn, { "aria-hidden": !0, className: `icon-sm` })), (t[54] = me))
    : (me = t[54]);
  let he;
  t[55] !== ce || t[56] !== ue || t[57] !== de || t[58] !== J
    ? ((he = (0, $.jsx)(Dn, {
        ariaLabel: ce,
        active: ue,
        disabled: de,
  ...
  t[65] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((be = (0, $.jsx)(_n, { "aria-hidden": !0, className: `icon-sm` })), (t[65] = be))
    : (be = t[65]);
  let xe;
  t[66] !== ge || t[67] !== _e || t[68] !== ve || t[69] !== ye
    ? ((xe = (0, $.jsx)(Dn, {
        ariaLabel: ge,
        active: _e,
        disabled: ve,
  ...
  t[73] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((we = (0, $.jsx)(oe, { "aria-hidden": !0, className: `icon-sm` })), (t[73] = we))
    : (we = t[73]);
  let Te;
  ...
  t[75] !== s || t[76] !== Se || t[77] !== Ce
    ...
    : (Ee = t[78]);
  let De;
  t[79] !== H || t[80] !== q || t[81] !== he || t[82] !== xe || t[83] !== Ee
    ? ((De = (0, $.jsxs)(`div`, { className: H, children: [q, he, xe, Ee] })),
      (t[79] = H),
      (t[80] = q),
      (t[81] = he),
      (t[82] = xe),
  ...
  t[85] !== o || t[86] !== c || t[87] !== u || t[88] !== a
    ...
    : (Oe = t[89]);
  let X;
  t[90] === Oe ? (X = t[91]) : ((X = (0, $.jsx)(ne, { children: Oe })), (t[90] = Oe), (t[91] = X));
  let ke;
  t[92] !== P || t[93] !== B || t[94] !== De || t[95] !== X
    ? ((ke = (0, $.jsxs)(`div`, {
        className: `flex min-h-fit flex-col items-center`,
        children: [M, (0, $.jsxs)(`div`, { className: P, children: [B, De, X] })],
      })),
      (t[92] = P),
      (t[93] = B),
      (t[94] = De),
  ...
  let je;
  return (
    t[100] !== l || t[101] !== i || t[102] !== j || t[103] !== Ae
      ? ((je = (0, $.jsxs)(le, {
          open: i,
...
function Dn(e) {
  ...
  t[0] === o
    ? (l = t[1])
    : ((l = (0, $.jsx)(`span`, { className: xn, children: o })), (t[0] = o), (t[1] = l));
  let u;
  return (
...
function On(e) {
  let t = (0, Q.c)(36),
    ...
    o = ee(),
    s;
  t[0] !== o || t[1] !== n ? ((s = An(o, n)), (t[0] = o), (t[1] = n), (t[2] = s)) : (s = t[2]);
  let c = s,
    l;
  t[3] === c
    ? (l = t[4])
  ...
  let m;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(kn, { step: 1 })), (t[14] = m))
    : (m = t[14]);
  let h, g;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, $.jsx)(J, { "aria-hidden": !0, className: `icon-xs` })),
      (g = (0, $.jsx)(w, {
  ...
  let b;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, $.jsx)(I, { "aria-hidden": !0, className: `icon-xs` })), (t[23] = b))
    : (b = t[23]);
  let x;
  t[24] === c
    ? (x = t[25])
  ...
  return (
    t[33] !== T || t[34] !== p
      ? ((E = (0, $.jsxs)($.Fragment, { children: [p, T] })), (t[33] = T), (t[34] = p), (t[35] = E))
      : (E = t[35]),
    E
  );
}
...
function jn({
  ...
  let o = g(y),
    ...
    k = (e, t) => {
      ...
      O(o, d, { action: e, socialPlatform: Pn(t) });
    },
    A = async () => {
      let s = c.formatMessage(
        {
        ...
        let a = await Zt({
          ...
          stats: [
            ...
            },
            {
              ...
              value: we(c, i.currentStreakDays),
            },
            {
              label: c.formatMessage({
              ...
              value: we(c, i.longestStreakDays),
            },
          ],
          usernameLabel: s,
          usageCells: Te({ dailyUsage: e, todayIso: r }),
        });
        h({ blob: a, imageUrl: await Mn(a) });
      } catch {
        (p(!1), o.get(N).danger(S));
      } finally {
        u(!1);
      }
    },
    j = () => {
      m != null &&
        (k(s.CODEX_PROFILE_SHARE_ACTION_SAVE_BUTTON_CLICKED), Qt(m.blob), o.get(N).success(E));
    },
    M = () => {
      m != null &&
        K({ "image/png": m.blob }).then(
          () => {
            o.get(N).success(C);
          },
          () => {
  ...
  return (0, $.jsxs)($.Fragment, {
    children: [
      (0, $.jsxs)(F, {
        ...
        size: `toolbar`,
        onClick: () => {
          (k(s.CODEX_PROFILE_SHARE_ACTION_SHARE_BUTTON_CLICKED), A());
        },
        children: [
          (0, $.jsx)(Ve, { "aria-hidden": !0, className: `icon-xs` }),
          (0, $.jsx)(w, {
      ...
      (0, $.jsx)(En, {
        ...
        onOpenChange: P,
        onOpenSocialDraft: (e) => {
          (k(s.CODEX_PROFILE_SHARE_ACTION_SOCIAL_COMPOSER_BUTTON_CLICKED, e),
            v.dispatchMessage(`open-in-browser`, { url: Nn(e, D) }));
        },
        onSelectSocialPlatform: (e) => {
          (k(s.CODEX_PROFILE_SHARE_ACTION_SOCIAL_SHARE_BUTTON_CLICKED, e), b(e));
        },
      }),
    ],
  });
...
var Fn = `_profileLoadingBlock_1lb04_1`,
  In = `_profilePhotoEditBadge_1lb04_22`,
  Ln = `_profilePhotoInput_1lb04_28`,
  Rn = {
    profileLoadingBlock: Fn,
    "profile-loading-page-sweep": `_profile-loading-page-sweep_1lb04_1`,
    profilePhotoEditBadge: In,
    profilePhotoInput: Ln,
  },
  zn = 12,
  Bn = {
  ...
  Vn = `bg-[color-mix(in_srgb,var(--color-token-primary)_78%,transparent)]`,
  Hn = `bg-[var(--color-token-primary)] ring-1 ring-[color-mix(in_srgb,var(--color-token-primary)_55%,transparent)]`,
  Un = `bg-[color-mix(in_srgb,var(--color-token-primary)_14%,var(--profile-usage-level-0))]`,
  Wn = t({ type: n(), msg: n() }),
  Gn = `·`,
  Kn = [
    `totalTextTokens`,
...
function qn({ today: e = new Date() }) {
  let t = g(y),
    ...
    l = k(`1991660486`),
    d = k(`3162484136`),
    { accountId: f, authMethod: p, planAtLogin: m, userId: v } = A(),
    { data: b } = j(),
    ...
    D = ve(E),
    M = xr(E),
    N = f ?? x?.accountId ?? null,
    I = v ?? x?.userId ?? null,
    L = Oe({ accountId: N, enabled: p === `chatgpt`, userId: I }),
    z = L.data?.activityInsights,
    B = Ce({ accountId: N, userId: I }),
    V = Ee({ accountId: N, userId: I }),
    te = B.isPending || V.isPending,
    H = _e({ accountId: N, userId: I }),
    { selectedAvatar: ne } = Le(Re(T?.avatars)),
    [re, ie] = (0, Z.useState)(null),
    [ae, oe] = (0, Z.useState)(null),
    [W, K] = (0, Z.useState)(`daily`),
    [q, se] = (0, Z.useState)(null),
    [ce, le] = (0, Z.useState)(null),
    [ue, de] = (0, Z.useState)(null),
    [fe, pe] = (0, Z.useState)(!1),
    J = L.isLoading,
    ye = (L.data == null && L.isError) || L.data?.hasStatsError === !0,
    xe = ne.id.startsWith(`custom:`),
    Se = J ? null : (ae ?? L.data?.imageUrl ?? b?.profile_picture_url ?? null),
    Te = Se != null && Se !== re,
    X = L.data?.username?.trim() || null,
    ke = L.data?.displayName ?? null,
    Fe = J ? null : (ke ?? X ?? b?.name ?? null),
    Be = De({
    ...
    Ve = L.data?.summary,
    He = Ve?.longestTaskDurationMs,
    Ue = L.data?.dailyUsage,
    We =
      ye || Ue == null
        ? null
        : {
            cells: Ne({ dailyUsage: Ue, todayIso: E, view: W }),
            dailyValues: he({ dailyUsage: Ue, todayIso: E }),
            weeklyTotals: me({ dailyUsage: Ue, todayIso: E }),
            cumulativeTotals: Me({ dailyUsage: Ue, todayIso: E }),
          },
    Ge = r.formatMessage({
  ...
  return (
    (0, Z.useEffect)(() => {
      n.current || ((n.current = !0), O(t, o, { profileOwner: `self` }));
    }, [t]),
    (0, $.jsxs)(Ie, {
      ref: le,
      className: `relative`,
      ...
      backSlot: (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsxs)(`div`, {
            ...
            children: [
              d && !J && X != null && ke != null && Ve != null && Ue != null
                ? (0, $.jsx)(jn, {
                    dailyUsage: Ue,
                    displayName: ke,
                    imageUrl: Te ? Se : null,
              ...
              (0, $.jsxs)(F, {
                ...
                size: `toolbar`,
                onClick: () => {
                  (O(t, u, { action: i.CODEX_PROFILE_EDIT_ACTION_OPENED }), pe(!0));
                },
                children: [
                  (0, $.jsx)(G, { "aria-hidden": !0, className: `icon-xs` }),
                  (0, $.jsx)(w, {
      ...
      children: [
        (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(`section`, {
              ...
              children: J
                ? (0, $.jsx)(ir, { avatar: ne, showsPet: xe })
                : (0, $.jsxs)($.Fragment, {
                    children: [
                      (0, $.jsxs)(`div`, {
                  ...
                  : ye
                    ...
                    : (0, $.jsxs)($.Fragment, {
                        children: [
                          ...
                          (0, $.jsx)(vr, {
                            value: we(r, Ve?.currentStreakDays),
                            label: (0, $.jsx)(w, {
                          ...
                          (0, $.jsx)(yr, {}),
                          (0, $.jsx)(vr, {
                            value: we(r, Ve?.longestStreakDays),
                            label: (0, $.jsx)(w, {
            ...
            (0, $.jsxs)(`section`, {
              ...
              children: [
                ...
                J
                  ? (0, $.jsx)(lr, { columnCount: D, monthLabelCount: M.length })
                  : We == null
                    ? (0, $.jsx)(fr, {})
                    : (0, $.jsxs)(`div`, {
                          ...
                          (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              (0, $.jsx)(`div`, {
                                ...
                                style: { gridTemplateColumns: `repeat(${D}, minmax(1px, 1fr))` },
                                children: We.cells.map((e, t) => {
                                  let n = je(t, E);
                                  if (W === `daily` && n > E) return null;
                                  let r = Math.floor(t / 7),
                                    i = W !== `daily`,
                                    a = i && q === `${W}:${r}`,
                                    o = Bn[e];
                                  i && e > 0 ? (o = a ? Hn : Vn) : a && (o = Un);
                                  let c = (0, $.jsx)(
                                    `div`,
                                    {
                                      className: `aspect-square w-full`,
                                      children: (0, $.jsx)(R.div, {
                                  ...
                                  return (0, $.jsx)(
                                    P,
                                    {
                                      ...
                                      portalContainer: ce,
                                      tooltipContent: (0, $.jsx)(Cr, {
                                        dateIso: n,
                                        tokenCount: We.dailyValues[t] ?? 0,
                                        todayIso: E,
                                      }),
                                      children: c,
                                    },
            ...
            l ? (0, $.jsx)(pr, { insights: z, isLoading: J, isUnavailable: ye }) : null,
          ],
        }),
        ue == null
          ? null
          : (0, $.jsx)(ht, {
              ...
              onSave: (e) => {
                (de(null),
                  ...
                  H.mutate(e.photo, {
                    onError: () => {
                      (O(t, c, { action: a.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED }),
                        oe(null));
                    },
                    onSuccess: () => {
                      (O(t, c, { action: a.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED }),
                        ie(null),
                        oe(null));
                    },
                  }));
        ...
        fe
          ? (0, $.jsx)(Jn, {
              ...
              onSaveError: (e) => {
                O(t, u, { action: i.CODEX_PROFILE_EDIT_ACTION_SAVE_FAILED, ...e });
              },
              onPhotoChangeImageSelected: () => {
                O(t, u, { action: i.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED });
              },
              onPhotoChangeStarted: () => {
                O(t, u, { action: i.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED });
              },
              onSaveProfile: async (e) => {
                (await B.mutateAsync(e), ie(null));
              },
              onSaveSuccess: () => {
                O(t, u, { action: i.CODEX_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED });
              },
...
function Jn({
  ...
  let g = ee(),
    ...
    ie = async () => {
      ...
      if ((s && ((p.photo = E.photo), (m += 1)), h == null && m === 0)) {
        i();
        return;
      }
      B(!0);
                ...
                children: [
                  ...
                  (0, $.jsx)(`span`, {
                    className: h(
                      ...
                      Rn.profilePhotoEditBadge,
                    ),
                    children: (0, $.jsx)(G, { "aria-hidden": !0, className: `icon-sm` }),
                  }),
                  (0, $.jsx)(`input`, {
                    type: `file`,
                    accept: `image/*`,
                    ...
                    children: [
                      ...
                      (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(`input`, {
                          ...
                          maxLength: 64,
                          onChange: (e) => {
                            (S(e.target.value), j(null), R(null));
                          },
                          onFocus: (e) => {
                      ...
                      (0, $.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(`input`, {
                            ...
                            maxLength: 20,
                            onChange: (e) => {
                              let t = Se(e.target.value),
                                n = xe(t);
                              (T(t), N(n.ok ? null : nr(n.reason, g)), R(null));
                            },
                            onFocus: (e) => {
                              e.currentTarget.select();
                            },
...
function Yn() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(He, { "aria-hidden": !0, className: `icon-2xs` })), (e[3] = i))
    : (i = e[3]);
  let a;
  return (
    e[4] === r
...
function tr(e) {
  if (e instanceof Error) {
    ...
    if (e.message.length > 0) {
      try {
        let t = Wn.safeParse(JSON.parse(e.message));
...
function ir(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(ar, { className: `absolute top-0 left-[72px] size-20 rounded-full` })),
      (a = (0, $.jsx)(ar, { className: `absolute top-[100px] left-0 h-8 w-56 rounded-lg` })),
      (o = (0, $.jsx)(ar, { className: `absolute top-[136px] left-12 h-5 w-32 rounded-lg` })),
      (t[0] = i),
      (t[1] = a),
      (t[2] = o))
    : ((i = t[0]), (a = t[1]), (o = t[2]));
...
function ar(e) {
  let t = (0, Q.c)(4),
    { className: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = h(Rn.profileLoadingBlock, `block`, n)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function or() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)($.Fragment, { children: Kn.map(sr) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
    ...
    Z.Fragment,
    {
      children: [
        ...
        (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(ar, { className: `h-5 w-12 rounded-md` }),
            (0, $.jsx)(ar, { className: `h-5 w-20 rounded-md` }),
          ],
        }),
      ],
    },
...
function lr(e) {
  ...
  let o;
  t[2] === n ? (o = t[3]) : ((o = Array.from({ length: n * 7 }, dr)), (t[2] = n), (t[3] = o));
  let s;
  t[4] !== a || t[5] !== o
    ? ((s = (0, $.jsx)(`div`, {
        className: `grid grid-flow-col grid-rows-[repeat(7,minmax(1px,1fr))] gap-[3px] overflow-hidden`,
  ...
  t[7] === r
    ...
    : ((c = (0, $.jsx)(`div`, {
        ...
        children: Array.from({ length: r }, ur),
      })),
      (t[7] = r),
      (t[8] = c));
  let l;
...
function ur(e, t) {
  return (0, $.jsx)(ar, { className: `h-4 w-6 rounded-md` }, t);
}
function dr(e, t) {
  return (0, $.jsx)(ar, { className: `aspect-square w-full rounded-[4px]` }, t);
}
function fr() {
  let e = (0, Q.c)(1),
    t;
...
function pr(e) {
  ...
  if (!a && n != null) {
    ...
    return (
      t[2] !== n || t[3] !== s
        ? ((e = (0, $.jsx)(Je, { insights: n, plugins: s })), (t[2] = n), (t[3] = s), (t[4] = e))
        : (e = t[4]),
      e
    );
  }
    ...
    ? ((i = (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsx)(`div`, {
            "aria-hidden": !0,
            className: `flex flex-col gap-2`,
            children: Array.from({ length: 5 }, _r),
          }),
        ],
      })),
      (e[3] = i))
    ...
    ? ((o = (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsx)(`div`, {
            "aria-hidden": !0,
            className: `flex flex-col gap-2`,
            children: Array.from({ length: 5 }, gr),
          }),
        ],
      })),
      (e[5] = o))
    ...
    `div`,
    {
      ...
      children: [
        (0, $.jsxs)(`div`, {
          className: `flex items-center gap-1.5`,
          children: [
            (0, $.jsx)(ar, { className: `size-6 rounded-lg` }),
            (0, $.jsx)(ar, { className: `h-5 w-24 rounded-md` }),
          ],
        }),
        (0, $.jsx)(ar, { className: `h-5 w-14 rounded-md` }),
      ],
    },
    t,
  );
...
function _r(e, t) {
  return (0, $.jsxs)(
    `div`,
    {
      ...
      children: [
        (0, $.jsx)(ar, { className: `h-5 w-24 rounded-md` }),
        (0, $.jsx)(ar, { className: `h-5 w-10 rounded-md` }),
      ],
    },
    t,
  );
...
function Cr(e) {
  let t = (0, Q.c)(10),
    ...
    o;
  t[0] !== n || t[1] !== a || t[2] !== i
    ? ((o = Tr({ dateIso: n, intl: a, todayIso: i })),
      (t[0] = n),
      (t[1] = a),
      (t[2] = i),
      (t[3] = o))
    : (o = t[3]);
  let s;
  t[4] !== a || t[5] !== r ? ((s = Y(a, r)), (t[4] = a), (t[5] = r), (t[6] = s)) : (s = t[6]);
  let c;
  return (
    t[7] !== o || t[8] !== s
      ? ((c = (0, $.jsx)(w, {
...
function wr(e) {
  let t = (0, Q.c)(10),
    ...
    a = ee(),
    o;
  t[0] !== a || t[1] !== r ? ((o = Y(a, r)), (t[0] = a), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s = o,
    c;
  t[3] !== a || t[4] !== i
...
function Tr({ dateIso: e, intl: t, todayIso: n }) {
