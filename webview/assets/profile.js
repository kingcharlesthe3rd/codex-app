...
import { n as Lt, t as Rt } from "./codex-avatar.js";
import {
  Tr as zt,
  wr as Bt,
  ...
  if (
    ...
    (t[34] !== v || t[35] !== p || t[36] !== m || t[37] !== h || t[38] !== _
      ? ((y = (0, J.jsxs)(`div`, {
          ...
          children: [
            f,
            (0, J.jsxs)(`dl`, { className: `flex flex-col gap-2`, children: [p, m, h, _, v] }),
          ],
        })),
        (t[34] = v),
        (t[35] = p),
                ...
                children: [
                  ...
                  e.length === 0
                    ? (0, J.jsxs)(`div`, {
                        ...
                        children: [
                          (0, J.jsx)(Me, { "aria-hidden": !0, className: `icon-xs` }),
                          (0, J.jsxs)(`div`, {
...
function Qt(e) {
  ...
  let s = n ? `text-token-text-tertiary` : `text-token-text-primary`,
    c;
  t[2] === s ? (c = t[3]) : ((c = Ee(`shrink-0 tabular-nums`, s)), (t[2] = s), (t[3] = c));
  let l;
  t[4] === a
    ? (l = t[5])
...
function tn(e) {
  ...
  switch (n) {
    ...
    case `max`: {
      let e;
      return (
        t[0] === n ? (e = t[1]) : ((e = (0, J.jsx)(rt, { effort: n })), (t[0] = n), (t[1] = e)), e
      );
    }
    default: {
      let e;
...
function nn(e) {
  ...
  t[0] !== n || t[1] !== a
    ? ((o =
        a === `plugin`
          ? (0, cn.createElement)(Me, { "aria-hidden": !0, className: `icon-sm` })
          : (0, cn.createElement)(q(null, { fallbackName: n }), { className: `icon-sm` })),
      (t[0] = n),
      (t[1] = a),
      (t[2] = o))
    : (o = t[2]);
  ...
  if (r == null) {
    ...
    if (t[7] !== n || t[8] !== i || t[9] !== a) {
      ...
      bb0: {
        let t = De(i?.split(`@`)[0] ?? (a === `skill` ? n.split(`:`)[0] : n));
        if (t != null) {
...
function mn(e) {
  let t = (0, wn.c)(99),
    ...
    [l, u] = (0, Tn.useState)(null),
    [d, f] = (0, Tn.useState)(!1),
    [p, m] = (0, Tn.useState)(!1),
    h;
  t[0] === o
    ? (h = t[1])
    : ((h = o == null ? 1 : gn(o.naturalWidth, o.naturalHeight)), (t[0] = o), (t[1] = h));
  let _ = h,
    v = o == null ? 1 : o.zoom / _,
    b;
  t[2] !== o || t[3] !== _
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, Y.jsx)(y, { className: `sr-only`, children: (0, Y.jsx)(g, { ...Fn.title }) })),
      (t[15] = D))
    : (D = t[15]);
  let O;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, Y.jsx)(c, { title: (0, Y.jsx)(g, { ...Fn.title }) })), (t[17] = k))
    : (k = t[17]);
  let A;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = { maxWidth: Dn }), (t[18] = A))
    : (A = t[18]);
  let te;
        ...
        l != null &&
          ...
          s((t) =>
            t == null
              ...
              : {
                  ...t,
                  offsetX: vn(l.offsetX + e.clientX - l.pointerX, t.naturalWidth, t.zoom),
                  offsetY: vn(l.offsetY + e.clientY - l.pointerY, t.naturalHeight, t.zoom),
                },
          );
      }),
      (t[26] = l),
  ...
  t[28] === l?.pointerId
    ? ((F = t[29]), (I = t[30]))
    : ((F = (e) => {
        e.pointerId === l?.pointerId && u(null);
      }),
      (I = (e) => {
        e.pointerId === l?.pointerId && u(null);
      }),
  ...
  t[31] === o
    ...
    : ((ae =
      ...
      (t[32] = ae));
  let L;
  t[33] !== n.dataUrl || t[34] !== N || t[35] !== P || t[36] !== F || t[37] !== I || t[38] !== ae
    ? ((L = (0, Y.jsx)(`div`, {
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (0, Y.jsx)(fn, { className: `icon-sm` })), (t[48] = se))
    : (se = t[48]);
  let V;
  t[49] !== z || t[50] !== oe || t[51] !== B
    ? ((V = (0, Y.jsx)(K, {
        "aria-label": z,
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = (0, Y.jsx)(Yt, { className: `icon-sm` })), (t[67] = pe))
    : (pe = t[67]);
  let me;
  t[68] !== ue || t[69] !== de || t[70] !== fe
    ? ((me = (0, Y.jsx)(K, {
        "aria-label": ue,
        className: `!size-5 !p-0`,
        color: `ghost`,
  ...
  let _e;
  t[79] !== p || t[80] !== r
    ? ((_e = (0, Y.jsx)(K, { color: `ghost`, disabled: p, onClick: r, children: ge })),
      (t[79] = p),
      (t[80] = r),
      (t[81] = _e))
    : (_e = t[81]);
  ...
  let be;
  t[86] !== _e || t[87] !== ye
    ? ((be = (0, Y.jsxs)(ne, { children: [_e, ye] })), (t[86] = _e), (t[87] = ye), (t[88] = be))
    : (be = t[88]);
  let q;
  t[89] !== R || t[90] !== he || t[91] !== W || t[92] !== be || t[93] !== E
    ? ((q = (0, Y.jsxs)(qe, {
        as: `form`,
        className: `gap-5`,
        onSubmit: E,
        children: [D, O, k, R, he, W, be],
      })),
      (t[89] = R),
      (t[90] = he),
      (t[91] = W),
...
async function hr(e) {
  if (!_r(e)) return null;
  try {
    let t = await A.getInstance().get(e),
      n = Zr.parse(t.body);
...
var yr,
  ...
  Qr = e(() => {
    (P(),
      ...
      (Zr = _({ base64: Xe().min(1), contentType: Xe() })));
  }),
  $r,
  ei,
  ti = e(() => {
...
function ci(e) {
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = { style: { height: `100dvh`, maxWidth: `none`, width: `100vw`, zIndex: 51 } }),
      (t[8] = k))
    : (k = t[8]);
  let A;
  ...
  let N;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, X.jsx)(o, { "aria-hidden": !0, className: `icon-sm` })), (t[15] = N))
    : (N = t[15]);
  let P;
  t[16] !== j || t[17] !== M
    ? ((P = (0, X.jsx)(K, {
  ...
  t[20] === ne
    ? (I = t[21])
    : ((I = Ee(`flex flex-col items-center`, ne)), (t[20] = ne), (t[21] = I));
  let ae;
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = Ee(
    ...
    : (ae = t[22]);
  let L;
  t[23] !== O || t[24] !== b || t[25] !== x
    ? ((L = { rotateX: b, rotateY: x, width: O }),
      (t[23] = O),
      (t[24] = b),
      (t[25] = x),
      (t[26] = L))
  ...
  let z;
  t[30] !== L || t[31] !== R
    ? ((z = (0, X.jsx)(se.div, { className: ae, style: L, children: R })),
      (t[30] = L),
      (t[31] = R),
      (t[32] = z))
    : (z = t[32]);
  let oe;
  t[33] !== T || t[34] !== C || t[35] !== z
    ? ((oe = (0, X.jsx)(`div`, {
  ...
  let V;
  t[39] !== oe || t[40] !== B
    ? ((V = (0, X.jsxs)(`div`, { className: `relative w-fit`, children: [oe, B] })),
      (t[39] = oe),
      (t[40] = B),
      (t[41] = V))
    : (V = t[41]);
  ...
  t[42] === ce
    ? (le = t[43])
    : ((le = Ee(`flex items-start justify-center gap-2 sm:gap-5`, ce)), (t[42] = ce), (t[43] = le));
  let H;
  t[44] === h
    ? (H = t[45])
    : ((H = h.formatMessage({
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, X.jsx)(oi, { "aria-hidden": !0, className: `icon-sm` })), (t[49] = me))
    : (me = t[49]);
  let he;
  t[50] !== H || t[51] !== U || t[52] !== ue || t[53] !== pe
    ? ((he = (0, X.jsx)(li, {
        ariaLabel: H,
        active: U,
        disabled: ue,
  ...
  t[60] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, X.jsx)(ei, { "aria-hidden": !0, className: `icon-sm` })), (t[60] = ye))
    : (ye = t[60]);
  let be;
  t[61] !== W || t[62] !== ge || t[63] !== _e || t[64] !== G
    ? ((be = (0, X.jsx)(li, {
        ariaLabel: W,
        active: ge,
        disabled: _e,
  ...
  t[71] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Te = (0, X.jsx)(ri, { "aria-hidden": !0, className: `icon-sm` })), (t[71] = Te))
    : (Te = t[71]);
  let De;
  t[72] !== q || t[73] !== xe || t[74] !== Se || t[75] !== we
    ? ((De = (0, X.jsx)(li, {
        ariaLabel: q,
        active: xe,
        disabled: Se,
  ...
  t[79] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ae = (0, X.jsx)(Ke, { "aria-hidden": !0, className: `icon-sm` })), (t[79] = Ae))
    : (Ae = t[79]);
  let Me;
  ...
  t[81] !== u || t[82] !== Oe || t[83] !== ke
    ...
    : (Pe = t[84]);
  let Fe;
  t[85] !== le || t[86] !== he || t[87] !== be || t[88] !== De || t[89] !== Pe
    ? ((Fe = (0, X.jsxs)(`div`, { className: le, children: [he, be, De, Pe] })),
      (t[85] = le),
      (t[86] = he),
      (t[87] = be),
      (t[88] = De),
  ...
  t[97] === Ie
    ? (Le = t[98])
    : ((Le = (0, X.jsx)(Ne, { children: Ie })), (t[97] = Ie), (t[98] = Le));
  let Re;
  t[99] !== I || t[100] !== V || t[101] !== Fe || t[102] !== Le
    ? ((Re = (0, X.jsxs)(`div`, {
        className: `flex min-h-fit flex-col items-center`,
        children: [F, (0, X.jsxs)(`div`, { className: I, children: [V, Fe, Le] })],
      })),
      (t[99] = I),
      (t[100] = V),
      (t[101] = Fe),
  ...
  let Be;
  return (
    t[107] !== f || t[108] !== i || t[109] !== P || t[110] !== ze
      ? ((Be = (0, X.jsxs)(re, {
          open: i,
...
function ui(e) {
  ...
  t[4] !== d || t[5] !== n || t[6] !== u || t[7] !== c
    ? ((h = d
        ? (0, X.jsx)(K, {
            ...
            uniform: !0,
            onClick: c,
            children: (0, X.jsx)(_e, { "aria-hidden": !0, className: `icon-xs rotate-180` }),
          })
        : null),
      (t[4] = d),
      (t[5] = n),
  ...
  t[9] === _
    ? (v = t[10])
    : ((v = Ee(`truncate text-xs leading-4 font-medium`, _)), (t[9] = _), (t[10] = v));
  let y;
  t[11] !== a || t[12] !== v
    ? ((y = (0, X.jsx)(`div`, { className: v, children: a })),
      (t[11] = a),
      (t[12] = v),
      (t[13] = y))
    : (y = t[13]);
  ...
  let x;
  t[18] !== y || t[19] !== b
    ? ((x = (0, X.jsxs)(`div`, { className: `min-w-0 text-center`, children: [y, b] })),
      (t[18] = y),
      (t[19] = b),
      (t[20] = x))
    : (x = t[20]);
  ...
  t[21] !== d || t[22] !== n || t[23] !== u || t[24] !== s
    ? ((S = d
        ? (0, X.jsx)(K, {
            ...
            uniform: !0,
            onClick: s,
            children: (0, X.jsx)(_e, { "aria-hidden": !0, className: `icon-xs` }),
          })
        : null),
      (t[21] = d),
      (t[22] = n),
  ...
  let E;
  return (
    t[33] !== f || t[34] !== S || t[35] !== T || t[36] !== m || t[37] !== h || t[38] !== x
      ? ((E = (0, X.jsxs)(`div`, {
          "aria-label": f,
          className: m,
          role: `group`,
...
function di(e) {
  let t = (0, mi.c)(41),
    { platform: n, getSocialDraftUrl: r, onCopy: i, onDismiss: a, onOpenSocialDraft: s } = e,
    c = ee(),
    l;
  t[0] !== c || t[1] !== n ? ((l = pi(c, n)), (t[0] = c), (t[1] = n), (t[2] = l)) : (l = t[2]);
  let u = l,
    d;
  t[3] !== r || t[4] !== n ? ((d = r(n)), (t[3] = r), (t[4] = n), (t[5] = d)) : (d = t[5]);
  let f = d,
    p;
  t[6] === u
    ? (p = t[7])
  ...
  let h;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, X.jsx)(o, { "aria-hidden": !0, className: `icon-xs` })), (t[10] = h))
    : (h = t[10]);
  let _;
  t[11] !== a || t[12] !== m
    ? ((_ = (0, X.jsx)(K, {
  ...
  let y;
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, X.jsx)(fi, { step: 1 })), (t[17] = y))
    : (y = t[17]);
  let b, x;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, X.jsx)(V, { "aria-hidden": !0, className: `icon-xs` })),
      (b = (0, X.jsx)(g, {
  ...
  t[26] === f
    ? (T = t[27])
    : ((T = (0, X.jsx)(we, { href: f, className: `icon-xs` })), (t[26] = f), (t[27] = T));
  let E;
  t[28] === u
    ? (E = t[29])
    : ((E = (0, X.jsx)(g, {
  ...
  return (
    t[38] !== k || t[39] !== v
      ? ((A = (0, X.jsxs)(X.Fragment, { children: [v, k] })), (t[38] = k), (t[39] = v), (t[40] = A))
      : (A = t[40]),
    A
  );
}
...
function Ti({
  ...
  let l = ae(p),
    ...
    [y, b] = (0, ki.useState)(null),
    [x, S] = (0, ki.useState)(null),
    [C, w] = (0, ki.useState)(!1),
    [T, E] = (0, ki.useState)(null),
    O = (0, ki.useRef)(0),
    k = u.formatMessage({
    ...
    ne = (e, t) => {
      ...
      D(l, s, { action: e, socialPlatform: Oi(t) });
    },
    re = () => {
      ...
      return {
        ...
        stats: [
          ...
          },
          {
            ...
            value: St(u, o.currentStreakDays),
          },
          {
            label: u.formatMessage({
            ...
            value: St(u, o.longestStreakDays),
          },
        ],
        theme: Un(),
        usernameLabel: r,
        usageCells: Pt({ dailyUsage: e, todayIso: a }),
      };
    },
    I = async (e, t) => {
      let n = await Ei(e);
    ...
    ie = async (e, { clearPreview: t, showLoadingState: n, requestId: r }) => {
      (n && f(!0), t && v(null));
      try {
        await I(await Wn({ ...re(), petImageUrl: e?.imageUrl ?? null }), r);
      } catch {
        if (O.current !== r) return;
        (h(!1), E(null), l.get(Pe).danger(A));
      } finally {
        n && O.current === r && f(!1);
      }
    },
    L = async (e, t, { clearPreview: n, showLoadingState: r, requestId: i }) => {
      ...
      try {
        ...
        (t ?? E(n), await I(await n.createImageBlob(e.imageUrl), i));
      } catch {
        if (O.current !== i) return;
        (h(!1), E(null), l.get(Pe).danger(A));
      } finally {
    ...
    R = () => {
      ...
      (h(!0), b(null), E(null), S(t === -1 ? null : t), w(t !== -1));
      let n = r[t];
      if (n == null) {
        ie(null, { clearPreview: !0, requestId: e, showLoadingState: !0 });
        return;
      }
    ...
    z = (e) => {
      ...
      O.current += 1;
      let n = O.current;
      (S(e), w(!0), L(t, T, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    B = (e) => {
      ...
      O.current += 1;
      let n = O.current;
      (w(e), ie(e ? t : null, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    se = () => {
      _ != null &&
        (ne(N.CODEX_PROFILE_SHARE_ACTION_SAVE_BUTTON_CLICKED), Kn(_.blob), l.get(Pe).success(P));
    },
    V = () => {
      _ != null &&
        j({ "image/png": _.blob }).then(
          () => {
            l.get(Pe).success(te);
          },
          () => {
    ...
    ce = (e) => {
      (e || ((O.current += 1), b(null), S(null), w(!1), f(!1), E(null)), h(e));
    };
  return (0, Ai.jsxs)(Ai.Fragment, {
    children: [
      (0, Ai.jsxs)(K, {
        ...
        size: `toolbar`,
        onClick: () => {
          (ne(N.CODEX_PROFILE_SHARE_ACTION_SHARE_BUTTON_CLICKED), R());
        },
        children: [
          (0, Ai.jsx)(nt, { "aria-hidden": !0, className: `icon-xs` }),
          (0, Ai.jsx)(g, {
      ...
      (0, Ai.jsx)(ci, {
        ...
        onOpenSocialDraft: (e, t) => {
          let n = Di(e, F);
          (ne(N.CODEX_PROFILE_SHARE_ACTION_SOCIAL_COMPOSER_BUTTON_CLICKED, e),
            oe({ event: t, href: n, initiator: `open_in_browser_bridge` }));
        },
        onSelectSocialPlatform: (e) => {
          (ne(N.CODEX_PROFILE_SHARE_ACTION_SOCIAL_SHARE_BUTTON_CLICKED, e), b(e));
        },
      }),
    ],
  });
...
function Oi(e) {
  switch (e) {
    case `linkedin`:
      return He.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_LINKEDIN;
    case `reddit`:
      return He.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_REDDIT;
    case `x`:
      return He.CODEX_PROFILE_SHARE_SOCIAL_PLATFORM_X;
  }
}
var ki,
  Ai,
...
function Li({ today: e = new Date() }) {
  let t = ae(p),
    ...
    s = te(Wt),
    c = te(`1991660486`),
    { accountId: l, authMethod: u, planAtLogin: d, userId: f } = fe(),
    { data: h } = Be(),
    { data: _ } = xe(`account-info`, {
      queryConfig: { enabled: u === `chatgpt` && !0, staleTime: b.ONE_MINUTE },
    }),
    { data: v } = R(Kt),
    y = Ot(e),
    x = yt(y),
    S = da(y),
    C = l ?? _?.accountId ?? null,
    w = f ?? _?.userId ?? null,
    T = st({ accountId: C, enabled: u === `chatgpt`, userId: w }),
    E = T.data?.activityInsights,
    O = ot({ accountId: C, userId: w }),
    k = Nt({ accountId: C, userId: w }),
    A = O.isPending || k.isPending,
    j = _t({ accountId: C, userId: w }),
    M = ft(v?.avatars),
    { selectedAvatar: N } = kt(M),
    [P, F] = (0, Q.useState)(null),
    [ne, re] = (0, Q.useState)(null),
    [I, ie] = (0, Q.useState)(`daily`),
    [L, z] = (0, Q.useState)(null),
    [oe, B] = (0, Q.useState)(null),
    [V, ce] = (0, Q.useState)(null),
    [le, H] = (0, Q.useState)(!1),
    U = T.isLoading,
    ue = T.data == null && T.isError,
    de = ve.isInternal(m()) && T.error != null ? va(T.error) : null,
    pe = T.data?.hasStatsError === !0,
    he = N.id.startsWith(`custom:`),
    W = U ? null : (ne ?? T.data?.imageUrl ?? h?.profile_picture_url ?? null),
    _e = W != null && W !== P,
    G = T.data?.username?.trim() || null,
    ye = T.data?.displayName ?? null,
    be = U ? null : Ct({ accountName: h?.name, displayName: ye, username: G }),
    q = ht({
      accountStructure: h?.structure,
      plan: h?.plan_type ?? _?.plan ?? d,
      workspaceName: h?.name,
    }),
    Se = T.data?.summary,
    Ce = Se?.longestTaskDurationMs,
    we = T.data?.dailyUsage,
    De = M.flatMap((e) =>
    ...
    ke =
      pe || we == null
        ? null
        : {
            cells: xt({ dailyUsage: we, todayIso: y, view: I }),
            dailyValues: Ft({ dailyUsage: we, todayIso: y }),
            weeklyTotals: It({ dailyUsage: we, todayIso: y }),
            cumulativeTotals: dt({ dailyUsage: we, todayIso: y }),
          },
    Ae = i.formatMessage({
  ...
  return (
    (0, Q.useEffect)(() => {
      r.current || ((r.current = !0), D(t, Ge, { profileOwner: `self` }));
    }, [t]),
    ue
      ? (0, $.jsx)(bt, {
                ...
                children: [
                  s
                    ? (0, $.jsxs)(K, {
                        ...
                        onClick: Vt,
                        children: [
                          (0, $.jsx)(Gt, { "aria-hidden": !0, className: `icon-xs` }),
                          (0, $.jsx)(g, {
                    ...
                    : null,
                  o && !U && !pe && G != null && ye != null && Se != null && we != null
                    ? (0, $.jsx)(Ti, {
                        dailyUsage: we,
                        displayName: ye,
                        imageUrl: _e ? W : null,
                        petOptions: De,
                        selectedPetId: he ? N.id : null,
                        todayIso: y,
                        usageSummary: Se,
                        username: G,
                      })
                  ...
                  (0, $.jsxs)(K, {
                    ...
                    size: `toolbar`,
                    onClick: () => {
                      (D(t, me, { action: ge.CODEX_PROFILE_EDIT_ACTION_OPENED }), H(!0));
                    },
                    children: [
                      (0, $.jsx)(Te, { "aria-hidden": !0, className: `icon-xs` }),
                      (0, $.jsx)(g, {
          ...
          children: [
              ...
              children: [
                            ...
                            children: [
                              (0, $.jsxs)(`label`, {
                                ...
                                className: Ee(
                                  ...
                                  j.isPending ? `cursor-default opacity-70` : `cursor-interaction`,
                                ),
                                children: [
                                  _e
                                    ? (0, $.jsx)(`img`, {
                                  ...
                                  (0, $.jsx)(`input`, {
                                    ...
                                    onClick: () => {
                                      D(t, Je, {
                                        action: ze.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_STARTED,
                                      });
                                    },
                                    onChange: (e) => {
                                      ...
                                      ((e.currentTarget.value = ``),
                                        n != null &&
                                          (D(t, Je, {
                                            action:
                                              ze.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_IMAGE_SELECTED,
                                          }),
                                          qi(n).then(ce, () => {
                                            (D(t, Je, {
                                              action:
                                                ze.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED,
                                            }),
                                              ce(null));
                                          })));
                                    },
                      ...
                      : pe
                        ...
                        : (0, $.jsxs)($.Fragment, {
                            children: [
                              ...
                              (0, $.jsx)(ca, {
                                value: St(i, Se?.currentStreakDays),
                                label: (0, $.jsx)(g, {
                              ...
                              (0, $.jsx)(la, {}),
                              (0, $.jsx)(ca, {
                                value: St(i, Se?.longestStreakDays),
                                label: (0, $.jsx)(g, {
                ...
                (0, $.jsxs)(`section`, {
                  ...
                  children: [
                    ...
                    U
                      ? (0, $.jsx)($i, { columnCount: x, monthLabelCount: S.length })
                      : ke == null
                        ? (0, $.jsx)(na, {})
                        : (0, $.jsxs)(`div`, {
                ...
                c ? (0, $.jsx)(ra, { insights: E, isLoading: U, isUnavailable: pe }) : null,
              ],
            }),
            V == null
              ? null
              : (0, $.jsx)(mn, {
                  ...
                  onSave: (e) => {
                    (ce(null),
                      ...
                      j.mutate(e.photo, {
                        onError: () => {
                          (D(t, Je, { action: ze.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED }),
                            re(null));
                        },
                        onSuccess: () => {
                          (D(t, Je, {
                            action: ze.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED,
                          }),
                            F(null),
                            re(null));
                        },
            ...
            le
              ? (0, $.jsx)(Ri, {
                  ...
                  onSaveError: (e) => {
                    D(t, me, { action: ge.CODEX_PROFILE_EDIT_ACTION_SAVE_FAILED, ...e });
                  },
                  onPhotoChangeImageSelected: () => {
                    D(t, me, {
                      action: ge.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED,
                    });
                  },
                  onPhotoChangeStarted: () => {
                    D(t, me, { action: ge.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED });
                  },
                  onSaveProfile: async (e) => {
                    (await O.mutateAsync(e), F(null));
                  },
                  onSaveSuccess: () => {
                    D(t, me, { action: ge.CODEX_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED });
                  },
...
function Ri({
  ...
  let h = ee(),
    ...
    le = async () => {
      ...
      if ((s && ((c.photo = E.photo), (p += 1)), m == null && p === 0)) {
        i();
        return;
      }
      L(!0);
      let g = z.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED,
        _ = z.CODEX_PROFILE_EDIT_SAVE_API_STATUS_NOT_ATTEMPTED;
      try {
        (m != null &&
          ((g = z.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
          await f(m),
          (g = z.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          p > 0 &&
            ((_ = z.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED),
            await u(c),
            (_ = z.CODEX_PROFILE_EDIT_SAVE_API_STATUS_SUCCEEDED)),
          d(),
          i());
      } catch (e) {
        if (
          (l({ profileDetailsUpdateApiStatus: _, usernameUpdateApiStatus: g }),
          g === z.CODEX_PROFILE_EDIT_SAVE_API_STATUS_FAILED)
        ) {
          M(Hi(e, h));
          return;
              ...
              children: (0, $.jsxs)(`label`, {
                ...
                children: [
                  ...
                  (0, $.jsx)(`span`, {
                    ...
                    children: (0, $.jsx)(Te, { "aria-hidden": !0, className: `icon-sm` }),
                  }),
                  (0, $.jsx)(`input`, {
                    type: `file`,
                    accept: `image/*`,
                    ...
                    children: [
                      ...
                      (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(`input`, {
                          ...
                          maxLength: 64,
                          onChange: (e) => {
                            (C(e.target.value), te(null), I(null));
                          },
                          onFocus: (e) => {
                    ...
                    children: [
                      ...
                      (0, $.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(`input`, {
                            id: x,
                            "aria-describedby": j == null ? void 0 : b,
                            "aria-invalid": j != null,
                            className: `min-w-0 flex-1 bg-transparent text-base leading-6 text-token-input-foreground outline-none`,
                            disabled: R,
                            maxLength: 20,
                            onChange: (e) => {
                              let t = gt(e.target.value),
                                n = vt(t);
                              (T(t), M(n.ok ? null : Ki(n.reason, h)), I(null));
                            },
                            onFocus: (e) => {
                              e.currentTarget.select();
                            },
...
function zi() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(Bt, { "aria-hidden": !0, className: `icon-2xs` })), (e[3] = i))
    : (i = e[3]);
  let a;
  return (
    e[4] === r
...
function Yi(e) {
  let t = (0, Z.c)(4),
    { className: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = Ee(Fi.profileLoadingBlock, `block`, n)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function pa(e) {
  ...
  t[0] !== n || t[1] !== a || t[2] !== i
    ...
    : (o = t[3]);
  let s;
  t[4] !== a || t[5] !== r ? ((s = At(a, r)), (t[4] = a), (t[5] = r), (t[6] = s)) : (s = t[6]);
  let c;
  return (
    t[7] !== o || t[8] !== s
      ? ((c = (0, $.jsx)(g, {
...
function ma(e) {
  let t = (0, Z.c)(10),
    ...
    a = ee(),
    o;
  t[0] !== a || t[1] !== r ? ((o = At(a, r)), (t[0] = a), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s = o,
    c;
  t[3] !== a || t[4] !== i
