...
import { p as g } from "./codex-api-B.js";
import "./_baseEach.js";
...
import { a as ie, d as ae, i as oe, l as se, n as ce, r as v, u as le } from "./dialog-layout.js";
import { t as y } from "./codex-api-error.js";
...
function Ce(e) {
  ...
  t[0] === s
    ? (p = t[1])
    : ((p = s == null ? 1 : Te(s.naturalWidth, s.naturalHeight)), (t[0] = s), (t[1] = p));
  let m = p,
    h = s == null ? 1 : s.zoom / m,
    g;
  t[2] !== s || t[3] !== m
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((de = (0, H.jsx)(ae, { className: `sr-only`, children: (0, H.jsx)(c, { ...ke.title }) })),
      (t[15] = de))
    : (de = t[15]);
  let x;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, H.jsx)(oe, { title: (0, H.jsx)(c, { ...ke.title }) })), (t[17] = S))
    : (S = t[17]);
  let C;
        ...
        u != null &&
          ...
          l((t) =>
            t == null
              ...
              : {
                  ...t,
                  offsetX: Y(u.offsetX + e.clientX - u.pointerX, t.naturalWidth, t.zoom),
                  offsetY: Y(u.offsetY + e.clientY - u.pointerY, t.naturalHeight, t.zoom),
                },
          );
      }),
      (t[26] = u),
  ...
  t[31] === s
    ...
    : ((O =
      ...
      (t[32] = O));
  let k;
  t[33] !== n.dataUrl || t[34] !== me || t[35] !== T || t[36] !== E || t[37] !== D || t[38] !== O
    ? ((k = (0, H.jsx)(`div`, {
  ...
  let J;
  t[77] !== f || t[78] !== r
    ? ((J = (0, H.jsx)(te, { color: `ghost`, disabled: f, onClick: r, children: Ce })),
      (t[77] = f),
      (t[78] = r),
      (t[79] = J))
    : (J = t[79]);
  ...
  let Q;
  t[84] !== J || t[85] !== Z
    ? ((Q = (0, H.jsxs)(v, { children: [J, Z] })), (t[84] = J), (t[85] = Z), (t[86] = Q))
    : (Q = t[86]);
  let $;
...
function we(e, t) {
  let n = Te(e, t);
  return { naturalHeight: t, naturalWidth: e, offsetX: J(e, n), offsetY: J(t, n), zoom: n };
}
function Te(e, t) {
...
async function De(e, t) {
  ...
  i.drawImage(n, -t.offsetX / t.zoom, -t.offsetY / t.zoom, U / t.zoom, U / t.zoom, 0, 0, W, W);
...
function Be({ today: e = new Date() }) {
  ...
  return (
    (0, V.useEffect)(() => {
      n.current ||
        ((n.current = !0),
        m(t, { eventName: `codex_profile_page_viewed`, metadata: { profile_owner: `self` } }));
    }, [t]),
    (0, H.jsxs)(F, {
      ref: xe,
      className: `relative`,
      ...
      children: [
          ...
          children: [
                          ...
                          (0, H.jsxs)(`label`, {
                            ...
                            children: [
                              ...
                              (0, H.jsx)(`input`, {
                                ...
                                onClick: () => {
                                  m(t, { eventName: `codex_profile_inline_photo_change_started` });
                                },
                                onChange: (e) => {
            ...
            (0, H.jsxs)(`section`, {
              ...
              children: [
                ...
                Y
                  ? (0, H.jsx)(nt, { columnCount: le, monthLabelCount: y.length })
                  : Me == null
                    ? (0, H.jsx)(at, {})
                    : (0, H.jsxs)(`div`, {
                          ...
                          (0, H.jsxs)(`div`, {
                            ...
                            children: [
                              (0, H.jsx)(`div`, {
                                ...
                                style: { gridTemplateColumns: `repeat(${le}, minmax(1px, 1fr))` },
          ...
          : (0, H.jsx)(Ce, {
              ...
              onSave: (e) => {
                (we(null),
                  ...
                  z.mutate(e.photo, {
                    onError: () => {
                      (m(t, { eventName: `codex_profile_inline_photo_change_failed` }), ye(null));
                    },
                    onSuccess: () => {
                      (m(t, { eventName: `codex_profile_inline_photo_change_succeeded` }),
                        ve(null),
                        ye(null));
                    },
                  }));
        ...
        Te
          ? (0, H.jsx)(Ve, {
              ...
              onSaveError: (e) => {
                m(t, { eventName: `codex_profile_edit_save_failed`, metadata: e });
              },
              onPhotoChangeImageSelected: () => {
                m(t, { eventName: `codex_profile_edit_modal_photo_change_image_selected` });
              },
              onPhotoChangeStarted: () => {
                m(t, { eventName: `codex_profile_edit_modal_photo_change_started` });
              },
  ...
  let g = o(),
    ...
    U = async () => {
      ...
      try {
        ...
        if (
          (d({ profile_details_update_api_status: h, username_update_api_status: m }),
          m === `failed`)
        ) {
          M(Ge(e, g));
          return;
              ...
              children: (0, H.jsxs)(`label`, {
                ...
                children: [
                  ...
                  (0, H.jsx)(`span`, {
                    ...
                    children: (0, H.jsx)(ue, { "aria-hidden": !0, className: `icon-sm` }),
                  }),
                  (0, H.jsx)(`input`, {
                    type: `file`,
                    accept: `image/*`,
                          ...
                          (0, H.jsx)(`input`, {
                            ...
                            onChange: (e) => {
                              let t = S(e.target.value),
                                n = C(t);
                              (fe(t), M(n.ok ? null : Ye(n.reason, g)), I(null));
                            },
                            onFocus: (e) => {
                              e.currentTarget.select();
                            },
...
function He() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, H.jsx)(z, { "aria-hidden": !0, className: `icon-2xs` })), (e[3] = i))
    : (i = e[3]);
  let a;
  return (
    e[4] === r
...
function Ze(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, H.jsx)(Qe, { className: `absolute top-0 left-[72px] size-20 rounded-full` })),
      (a = (0, H.jsx)(Qe, { className: `absolute top-[100px] left-0 h-8 w-56 rounded-lg` })),
      (o = (0, H.jsx)(Qe, { className: `absolute top-[140px] left-12 h-7 w-32 rounded-lg` })),
      (t[0] = i),
      (t[1] = a),
      (t[2] = o))
    : ((i = t[0]), (a = t[1]), (o = t[2]));
...
function Qe(e) {
  let t = (0, B.c)(4),
    { className: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = a(je.profileLoadingBlock, `block`, n)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, H.jsx)(`span`, { "aria-hidden": !0, className: r })), (t[2] = r), (t[3] = i)),
    i
  );
}
function $e() {
...
function nt(e) {
  ...
  let o;
  t[2] === n ? (o = t[3]) : ((o = Array.from({ length: n * 7 }, it)), (t[2] = n), (t[3] = o));
  let s;
  t[4] !== a || t[5] !== o
    ? ((s = (0, H.jsx)(`div`, {
        className: `grid grid-flow-col grid-rows-[repeat(7,minmax(1px,1fr))] gap-[3px] overflow-hidden`,
...
function pt(e) {
  ...
  t[0] !== n || t[1] !== a || t[2] !== i
    ...
    : (s = t[3]);
  let l;
  t[4] !== a || t[5] !== r ? ((l = ct(a, r)), (t[4] = a), (t[5] = r), (t[6] = l)) : (l = t[6]);
  let u;
  return (
    t[7] !== s || t[8] !== l
      ? ((u = (0, H.jsx)(c, {
...
function mt(e) {
  let t = (0, B.c)(10),
    ...
    a = o(),
    s;
  t[0] !== a || t[1] !== r ? ((s = ct(a, r)), (t[0] = a), (t[1] = r), (t[2] = s)) : (s = t[2]);
  let l = s,
    u;
  t[3] !== a || t[4] !== i
