...
import { n as Ke, t as qe } from "./codex-avatar.js";
import {
  Lo as Je,
  Ro as Ye,
  X as Xe,
                ...
                children: [
                  ...
                  e.length === 0
                    ? (0, J.jsxs)(`div`, {
                        ...
                        children: [
                          (0, J.jsx)(at, { "aria-hidden": !0, className: `icon-xs` }),
                          (0, J.jsxs)(`div`, {
...
function Qt(e) {
  ...
  let s = n ? `text-token-text-tertiary` : `text-token-text-primary`,
    c;
  t[2] === s ? (c = t[3]) : ((c = U(`shrink-0 tabular-nums`, s)), (t[2] = s), (t[3] = c));
  let l;
  t[4] === a
    ? (l = t[5])
...
function tn(e) {
  ...
  switch (n) {
    ...
    case `max`: {
      let e;
      return (
        t[0] === n ? (e = t[1]) : ((e = (0, J.jsx)(tt, { effort: n })), (t[0] = n), (t[1] = e)), e
      );
    }
    default: {
      let e;
...
function nn(e) {
  ...
  t[0] !== n || t[1] !== a
    ? ((o =
        a === `plugin`
          ? (0, cn.createElement)(at, { "aria-hidden": !0, className: `icon-sm` })
          : (0, cn.createElement)(ft(null, { fallbackName: n }), { className: `icon-sm` })),
      (t[0] = n),
      (t[1] = a),
      (t[2] = o))
    : (o = t[2]);
...
function mn(e) {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, Y.jsx)(te, { className: `sr-only`, children: (0, Y.jsx)(q, { ...Fn.title }) })),
      (t[15] = w))
    : (w = t[15]);
  let T;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Y.jsx)(Se, { title: (0, Y.jsx)(q, { ...Fn.title }) })), (t[17] = E))
    : (E = t[17]);
  let D;
  ...
  t[31] === o
    ...
    : ((ne =
      ...
      (t[32] = ne));
  let P;
  t[33] !== n.dataUrl || t[34] !== A || t[35] !== j || t[36] !== M || t[37] !== N || t[38] !== ne
    ? ((P = (0, Y.jsx)(`div`, {
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((fe = (0, Y.jsx)(Yt, { className: `icon-sm` })), (t[67] = fe))
    : (fe = t[67]);
  let pe;
  t[68] !== ue || t[69] !== de || t[70] !== H
    ? ((pe = (0, Y.jsx)(z, {
        "aria-label": ue,
        className: `!size-5 !p-0`,
        color: `ghost`,
  ...
  let G;
  t[79] !== f || t[80] !== r
    ? ((G = (0, Y.jsx)(z, { color: `ghost`, disabled: f, onClick: r, children: me })),
      (t[79] = f),
      (t[80] = r),
      (t[81] = G))
    : (G = t[81]);
  ...
  let ve;
  t[86] !== G || t[87] !== _e
    ? ((ve = (0, Y.jsxs)(ye, { children: [G, _e] })), (t[86] = G), (t[87] = _e), (t[88] = ve))
    : (ve = t[88]);
  let xe;
  t[89] !== F || t[90] !== U || t[91] !== W || t[92] !== ve || t[93] !== C
    ? ((xe = (0, Y.jsxs)(ie, {
        as: `form`,
        className: `gap-5`,
        onSubmit: C,
        children: [w, T, E, F, U, W, ve],
      })),
      (t[89] = F),
      (t[90] = U),
      (t[91] = W),
...
async function hr(e) {
  if (!_r(e)) return null;
  try {
    let t = await d.getInstance().get(e),
      n = Zr.parse(t.body);
...
var yr,
  ...
  Qr = e(() => {
    (b(),
      ...
      (Zr = i({ base64: m().min(1), contentType: m() })));
  }),
  $r,
  ei,
  ti = e(() => {
...
function ci(e) {
  ...
  let j;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, X.jsx)(ge, { "aria-hidden": !0, className: `icon-sm` })), (t[15] = j))
    : (j = t[15]);
  let M;
  t[16] !== ee || t[17] !== A
    ? ((M = (0, X.jsx)(z, {
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, X.jsx)(`h2`, {
      ...
      (t[19] = N))
    : (N = t[19]);
  let ne = o == null ? `mt-[50px]` : `mt-8`,
    P;
  t[20] === ne
    ? (P = t[21])
    : ((P = U(`flex flex-col items-center`, ne)), (t[20] = ne), (t[21] = P));
  let F;
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = U(
  ...
  let R;
  t[30] !== I || t[31] !== L
    ? ((R = (0, X.jsx)(de.div, { className: F, style: I, children: L })),
      (t[30] = I),
      (t[31] = L),
      (t[32] = R))
    : (R = t[32]);
  ...
  let ae;
  t[39] !== B || t[40] !== ie
    ? ((ae = (0, X.jsxs)(`div`, { className: `relative w-fit`, children: [B, ie] })),
      (t[39] = B),
      (t[40] = ie),
      (t[41] = ae))
    : (ae = t[41]);
  ...
  t[42] === oe
    ? (ce = t[43])
    : ((ce = U(`flex items-start justify-center gap-2 sm:gap-5`, oe)), (t[42] = oe), (t[43] = ce));
  let V;
  t[44] === m
    ? (V = t[45])
    : ((V = m.formatMessage({
  ...
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (pe = t[49]);
  let W;
  t[50] !== V || t[51] !== le || t[52] !== ue || t[53] !== fe
    ? ((W = (0, X.jsx)(li, {
        ariaLabel: V,
        active: le,
        disabled: ue,
  ...
  t[60] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (K = t[60]);
  let Se;
  t[61] !== G || t[62] !== _e || t[63] !== ve || t[64] !== xe
    ? ((Se = (0, X.jsx)(li, {
        ariaLabel: G,
        active: _e,
        disabled: ve,
  ...
  t[71] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Oe = t[71]);
  let ke;
  t[72] !== Ce || t[73] !== we || t[74] !== Te || t[75] !== De
    ? ((ke = (0, X.jsx)(li, {
        ariaLabel: Ce,
        active: we,
        disabled: Te,
  ...
  t[79] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Me = (0, X.jsx)(se, { "aria-hidden": !0, className: `icon-sm` })), (t[79] = Me))
    : (Me = t[79]);
  let Ne;
  ...
  t[81] !== l || t[82] !== Ae || t[83] !== je
    ...
    : (Pe = t[84]);
  let Fe;
  t[85] !== ce || t[86] !== W || t[87] !== Se || t[88] !== ke || t[89] !== Pe
    ? ((Fe = (0, X.jsxs)(`div`, { className: ce, children: [W, Se, ke, Pe] })),
      (t[85] = ce),
      (t[86] = W),
      (t[87] = Se),
      (t[88] = ke),
  ...
  t[97] === Ie
    ? (Le = t[98])
    : ((Le = (0, X.jsx)(he, { children: Ie })), (t[97] = Ie), (t[98] = Le));
  let Re;
  t[99] !== P || t[100] !== ae || t[101] !== Fe || t[102] !== Le
    ? ((Re = (0, X.jsxs)(`div`, {
        className: `flex min-h-fit flex-col items-center`,
        children: [N, (0, X.jsxs)(`div`, { className: P, children: [ae, Fe, Le] })],
      })),
      (t[99] = P),
      (t[100] = ae),
      (t[101] = Fe),
...
function ui(e) {
  ...
  t[4] !== d || t[5] !== n || t[6] !== u || t[7] !== c
    ? ((h = d
        ? (0, X.jsx)(z, {
            ...
            uniform: !0,
            onClick: c,
            children: (0, X.jsx)(j, { "aria-hidden": !0, className: `icon-xs rotate-180` }),
          })
        : null),
      (t[4] = d),
      (t[5] = n),
  ...
  t[9] === g
    ? (_ = t[10])
    : ((_ = U(`truncate text-xs leading-4 font-medium`, g)), (t[9] = g), (t[10] = _));
  let v;
  t[11] !== a || t[12] !== _
  ...
  t[21] !== d || t[22] !== n || t[23] !== u || t[24] !== s
    ? ((x = d
        ? (0, X.jsx)(z, {
            ...
            uniform: !0,
            onClick: s,
            children: (0, X.jsx)(j, { "aria-hidden": !0, className: `icon-xs` }),
          })
        : null),
      (t[21] = d),
      (t[22] = n),
...
function di(e) {
  ...
  let m;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, X.jsx)(ge, { "aria-hidden": !0, className: `icon-xs` })), (t[10] = m))
    : (m = t[10]);
  let h;
  t[11] !== a || t[12] !== p
    ? ((h = (0, X.jsx)(z, {
  ...
  let v, y;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, X.jsx)(x, { "aria-hidden": !0, className: `icon-xs` })),
      (v = (0, X.jsx)(q, {
  ...
  t[26] === d
    ? (w = t[27])
    : ((w = (0, X.jsx)(I, { href: d, className: `icon-xs` })), (t[26] = d), (t[27] = w));
  let T;
  t[28] === l
    ? (T = t[29])
    : ((T = (0, X.jsx)(q, {
  ...
  return (
    t[38] !== O || t[39] !== g
      ? ((k = (0, X.jsxs)(X.Fragment, { children: [g, O] })), (t[38] = O), (t[39] = g), (t[40] = k))
      : (k = t[40]),
    k
  );
}
...
function Ti({
  ...
  let u = a(r),
    ...
    M = (e, t) => {
      ...
      Te(u, Ne, { action: e, socialPlatform: Oi(t) });
    },
    N = () => {
      ...
      return {
        ...
        stats: [
          ...
          },
          {
            ...
            value: Ot(d, c.currentStreakDays),
          },
          {
            label: d.formatMessage({
            ...
            value: Ot(d, c.longestStreakDays),
          },
        ],
        theme: Un(),
        usernameLabel: r,
        usageCells: Tt({ dailyUsage: e, todayIso: s }),
      };
    },
    ne = async (e, t) => {
      let n = await Ei(e);
    ...
    P = async (e, { clearPreview: t, showLoadingState: n, requestId: r }) => {
      (n && p(!0), t && _(null));
      try {
        await ne(await Wn({ ...N(), petImageUrl: e?.imageUrl ?? null }), r);
      } catch {
        if (D.current !== r) return;
        (h(!1), E(null), u.get(le).danger(k));
      } finally {
        n && D.current === r && p(!1);
      }
    },
    F = async (e, t, { clearPreview: n, showLoadingState: r, requestId: i }) => {
      (r && p(!0), n && _(null));
      try {
        let n = t ?? (await Gn(N()));
        if (D.current !== i) return;
        (t ?? E(n), await ne(await n.createImageBlob(e.imageUrl), i));
      } catch {
        if (D.current !== i) return;
        (h(!1), E(null), u.get(le).danger(k));
      } finally {
    ...
    I = () => {
      ...
      (h(!0), y(null), E(null), x(t === -1 ? null : t), w(t !== -1));
      let n = i[t];
      if (n == null) {
        P(null, { clearPreview: !0, requestId: e, showLoadingState: !0 });
        return;
      }
      F(n, null, { clearPreview: !0, requestId: e, showLoadingState: !0 });
    },
    L = (e) => {
      let t = i[e];
      if (t == null) return;
      D.current += 1;
      let n = D.current;
      (x(e), w(!0), F(t, T, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    R = (e) => {
      ...
      D.current += 1;
      let n = D.current;
      (w(e), P(e ? t : null, { clearPreview: !1, requestId: n, showLoadingState: !1 }));
    },
    re = () => {
      g != null &&
        (M(Me.CODEX_PROFILE_SHARE_ACTION_SAVE_BUTTON_CLICKED), Kn(g.blob), u.get(le).success(te));
    },
    B = () => {
      g != null &&
        C({ "image/png": g.blob }).then(
          () => {
            u.get(le).success(ee);
          },
          () => {
    ...
    ie = (e) => {
      (e || ((D.current += 1), y(null), x(null), w(!1), p(!1), E(null)), h(e));
    };
  return (0, Ai.jsxs)(Ai.Fragment, {
    children: [
      (0, Ai.jsxs)(z, {
        ...
        size: `toolbar`,
        onClick: () => {
          (M(Me.CODEX_PROFILE_SHARE_ACTION_SHARE_BUTTON_CLICKED), I());
        },
        children: [
          (0, Ai.jsx)(Xe, { "aria-hidden": !0, className: `icon-xs` }),
          (0, Ai.jsx)(q, {
      ...
      (0, Ai.jsx)(ci, {
        ...
        onOpenSocialDraft: (e, t) => {
          let n = Di(e, j);
          (M(Me.CODEX_PROFILE_SHARE_ACTION_SOCIAL_COMPOSER_BUTTON_CLICKED, e),
            fe({ event: t, href: n, initiator: `open_in_browser_bridge` }));
        },
        onSelectSocialPlatform: (e) => {
          (M(Me.CODEX_PROFILE_SHARE_ACTION_SOCIAL_SHARE_BUTTON_CLICKED, e), y(e));
        },
      }),
    ],
  });
...
function Li({ today: e = new Date() }) {
  let t = a(r),
    ...
    l = Ue(st),
    u = Ue(`1991660486`),
    { accountId: d, authMethod: f, planAtLogin: p, userId: m } = P(),
    { data: g } = ce(),
    { data: v } = h(`account-info`, {
      queryConfig: { enabled: f === `chatgpt` && !0, staleTime: _.ONE_MINUTE },
    }),
    { data: b } = y(Kt),
    x = zt(e),
    S = _t(x),
    C = da(x),
    w = d ?? v?.accountId ?? null,
    T = m ?? v?.userId ?? null,
    E = Nt({ accountId: w, enabled: f === `chatgpt`, userId: T }),
    D = E.data?.activityInsights,
    O = Dt({ accountId: w, userId: T }),
    k = jt({ accountId: w, userId: T }),
    ee = O.isPending || k.isPending,
    A = bt({ accountId: w, userId: T }),
    te = Ht(b?.avatars),
    { selectedAvatar: j } = Wt(te),
    [M, N] = (0, Q.useState)(null),
    [F, I] = (0, Q.useState)(null),
    [L, re] = (0, Q.useState)(`daily`),
    [B, ie] = (0, Q.useState)(null),
    [ae, oe] = (0, Q.useState)(null),
    [se, V] = (0, Q.useState)(null),
    [le, ue] = (0, Q.useState)(!1),
    H = E.isLoading,
    fe = E.data == null && E.isError,
    pe = o.isInternal(ne()) && E.error != null ? va(E.error) : null,
    W = E.data?.hasStatsError === !0,
    me = j.id.startsWith(`custom:`),
    G = H ? null : (F ?? E.data?.imageUrl ?? g?.profile_picture_url ?? null),
    he = G != null && G !== M,
    ge = E.data?.username?.trim() || null,
    _e = E.data?.displayName ?? null,
    ve = H ? null : Et({ accountName: g?.name, displayName: _e, username: ge }),
    ye = kt({
      accountStructure: g?.structure,
      plan: g?.plan_type ?? v?.plan ?? p,
      workspaceName: g?.name,
    }),
    be = E.data?.summary,
    xe = be?.longestTaskDurationMs,
    K = E.data?.dailyUsage,
    Se = te.flatMap((e) =>
    ...
    we =
      W || K == null
        ? null
        : {
            cells: Rt({ dailyUsage: K, todayIso: x, view: L }),
            dailyValues: Lt({ dailyUsage: K, todayIso: x }),
            weeklyTotals: vt({ dailyUsage: K, todayIso: x }),
            cumulativeTotals: ht({ dailyUsage: K, todayIso: x }),
          },
    Ee = i.formatMessage({
  ...
  return (
    (0, Q.useEffect)(() => {
      n.current || ((n.current = !0), Te(t, Ve, { profileOwner: `self` }));
    }, [t]),
    fe
      ? (0, $.jsx)(Vt, {
                ...
                children: [
                  l
                    ? (0, $.jsxs)(z, {
                        ...
                        onClick: ot,
                        children: [
                          (0, $.jsx)(lt, { "aria-hidden": !0, className: `icon-xs` }),
                          (0, $.jsx)(q, {
                    ...
                    : null,
                  c && !H && !W && ge != null && _e != null && be != null && K != null
                    ? (0, $.jsx)(Ti, {
                        dailyUsage: K,
                        displayName: _e,
                        imageUrl: he ? G : null,
                        petOptions: Se,
                        selectedPetId: me ? j.id : null,
                        todayIso: x,
                        usageSummary: be,
                        username: ge,
                      })
                  ...
                  (0, $.jsxs)(z, {
                    ...
                    size: `toolbar`,
                    onClick: () => {
                      (Te(t, Oe, { action: Re.CODEX_PROFILE_EDIT_ACTION_OPENED }), ue(!0));
                    },
                    children: [
                      (0, $.jsx)(pt, { "aria-hidden": !0, className: `icon-xs` }),
                      (0, $.jsx)(q, {
          ...
          children: [
            (0, $.jsxs)(`div`, {
              ...
              children: [
                              ...
                              (0, $.jsxs)(`label`, {
                                ...
                                children: [
                                  ...
                                  (0, $.jsx)(`input`, {
                                    ...
                                    onClick: () => {
                                      Te(t, He, {
                                        action: Pe.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_STARTED,
                                      });
                                    },
                                    onChange: (e) => {
                                      ...
                                      ((e.currentTarget.value = ``),
                                        n != null &&
                                          (Te(t, He, {
                                            action:
                                              Pe.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_IMAGE_SELECTED,
                                          }),
                                          qi(n).then(V, () => {
                                            (Te(t, He, {
                                              action:
                                                Pe.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED,
                                            }),
                                              V(null));
                                          })));
                                    },
                      ...
                      : W
                        ...
                        : (0, $.jsxs)($.Fragment, {
                            children: [
                              ...
                              (0, $.jsx)(ca, {
                                value: Ot(i, be?.currentStreakDays),
                                label: (0, $.jsx)(q, {
                              ...
                              (0, $.jsx)(la, {}),
                              (0, $.jsx)(ca, {
                                value: Ot(i, be?.longestStreakDays),
                                label: (0, $.jsx)(q, {
                                ...
                                children: [
                                  (0, $.jsx)(`div`, {
                                    ...
                                    children: we.cells.map((e, t) => {
                                      let n = xt(t, x);
                                      if (L === `daily` && n > x) return null;
                                      let r = Math.floor(t / 7),
                                        i = L !== `daily`,
                                        a = i && B === `${L}:${r}`,
                                        o = ba[e];
                                      i && e > 0 ? (o = a ? Sa : xa) : a && (o = Ca);
                                      let c = (0, $.jsx)(
                                        `div`,
                                        {
                                          className: `aspect-square w-full`,
                                          children: (0, $.jsx)(de.div, {
                ...
                u ? (0, $.jsx)(ra, { insights: D, isLoading: H, isUnavailable: W }) : null,
              ],
            }),
            se == null
              ? null
                  ...
                  onSave: (e) => {
                    (V(null),
                      ...
                      A.mutate(e.photo, {
                        onError: () => {
                          (Te(t, He, {
                            action: Pe.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_FAILED,
                          }),
                            I(null));
                        },
                        onSuccess: () => {
                          (Te(t, He, {
                            action: Pe.CODEX_PROFILE_INLINE_PHOTO_CHANGE_ACTION_SUCCEEDED,
                          }),
                            N(null),
                            I(null));
                        },
            ...
            le
              ? (0, $.jsx)(Ri, {
                  ...
                  onProfileImageError: N,
                  onSaveError: (e) => {
                    Te(t, Oe, { action: Re.CODEX_PROFILE_EDIT_ACTION_SAVE_FAILED, ...e });
                  },
                  onPhotoChangeImageSelected: () => {
                    Te(t, Oe, {
                      action: Re.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_IMAGE_SELECTED,
                    });
                  },
                  onPhotoChangeStarted: () => {
                    Te(t, Oe, { action: Re.CODEX_PROFILE_EDIT_ACTION_MODAL_PHOTO_CHANGE_STARTED });
                  },
                  onSaveProfile: async (e) => {
                    (await O.mutateAsync(e), N(null));
                  },
                  onSaveSuccess: () => {
                    Te(t, Oe, { action: Re.CODEX_PROFILE_EDIT_ACTION_SAVE_SUCCEEDED });
                  },
...
function Ri({
  ...
  let m = ze(),
    ...
    F = ne || r || n,
    I = It(x),
    L = F || y.trim().length === 0 || !I.ok,
    R = C?.previewUrl ?? f,
    B = R != null && R !== t,
    ae = p?.trim() ?? ``,
    se = async () => {
      if (L) return;
      (O(null), ee(null), j(null), N(null));
      let t = y.trim(),
        n = wt(x),
        r = e?.trim() ?? ``;
      (b(t), S(n));
            ...
            (0, $.jsx)(oe, {
              ...
              children: (0, $.jsxs)(`label`, {
                ...
                className: U(
                  ...
                  F ? `cursor-default opacity-70` : `cursor-interaction`,
                ),
                children: [
                  B
                    ? (0, $.jsx)(`img`, {
                  ...
                  (0, $.jsx)(`span`, {
                    ...
                    children: (0, $.jsx)(pt, { "aria-hidden": !0, className: `icon-sm` }),
                  }),
                  (0, $.jsx)(`input`, {
                    type: `file`,
                    accept: `image/*`,
                    ...
                    children: [
                      ...
                      (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(`input`, {
                          ...
                          maxLength: 64,
                          onChange: (e) => {
                            (b(e.target.value), O(null), N(null));
                          },
                          onFocus: (e) => {
                      ...
                      (0, $.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(`input`, {
                            ...
                            maxLength: 20,
                            onChange: (e) => {
                              let t = yt(e.target.value),
                                n = It(t);
                              (S(t), ee(n.ok ? null : Ki(n.reason, m)), N(null));
                            },
                            onFocus: (e) => {
                              e.currentTarget.select();
                            },
...
function zi() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(rt, { "aria-hidden": !0, className: `icon-2xs` })), (e[3] = i))
    : (i = e[3]);
  let a;
  return (
    e[4] === r
...
function Yi(e) {
  let t = (0, Z.c)(4),
    { className: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = U(Fi.profileLoadingBlock, `block`, n)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function ra(e) {
  ...
  let { availablePlugins: o } = we(Be, a);
  if (r) {
    let e;
    return (
...
function pa(e) {
  ...
  t[0] !== n || t[1] !== a || t[2] !== i
    ...
    : (o = t[3]);
  let s;
  t[4] !== a || t[5] !== r ? ((s = St(a, r)), (t[4] = a), (t[5] = r), (t[6] = s)) : (s = t[6]);
  let c;
  return (
    t[7] !== o || t[8] !== s
      ? ((c = (0, $.jsx)(q, {
...
function ma(e) {
  let t = (0, Z.c)(10),
    ...
    a = ze(),
    o;
  t[0] !== a || t[1] !== r ? ((o = St(a, r)), (t[0] = a), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s = o,
    c;
  t[3] !== a || t[4] !== i
