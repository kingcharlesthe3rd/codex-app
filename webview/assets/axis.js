import { i as e, l as t, r as n, s as r } from "./linear.js";
import { a as i, c as a, d as o, f as s, i as c, s as l, u } from "./string.js";
import { t as d } from "./init-2.js";
var f = Math.PI / 180,
  p = 180 / Math.PI,
  m = 18,
  h = 0.96422,
...
function ae(e) {
  return function (t, n) {
    ...
    return function (e) {
      return ((t.h = r(e)), (t.c = a(e)), (t.l = o(e)), (t.opacity = s(e)), t + ``);
    };
  };
}
var oe = ae(c);
...
function k(e, t, n, r) {
  ...
  return (
    ...
    n &&
      ((i.count = (t, r) => (ce.setTime(+t), O.setTime(+r), e(ce), e(O), Math.floor(n(ce, O)))),
      (i.every = (e) => (
        (e = Math.floor(e)),
        !isFinite(e) || !(e > 0)
          ? null
...
function De(e, n, i, a, o, s) {
  ...
  function u(n, i, a) {
    let o = Math.abs(i - n) / a,
      s = t(([, , e]) => e).right(c, o);
    if (s === c.length) return e.every(r(n / ue, i / ue, a));
    if (s === 0) return A.every(Math.max(r(n, i, a), 1));
  ...
  function S(e, t) {
    return function (n) {
      ...
      for (n instanceof Date || (n = new Date(+n)); ++i < o; )
        e.charCodeAt(i) === 37 &&
          (r.push(e.slice(a, i)),
          (c = Fe[(s = e.charAt(++i))]) == null ? (c = s === `e` ? ` ` : `0`) : (s = e.charAt(++i)),
          (l = t[s]) && (s = l(n, c)),
          r.push(s),
          (a = i + 1));
    ...
    return function (n) {
      ...
      if (
        ...
        (`W` in r || `U` in r) &&
          ...
          (o = `Z` in r ? Ne(J(r.y, 0, 1)).getUTCDay() : Me(J(r.y, 0, 1)).getDay()),
          (r.m = 0),
          (r.d =
            `W` in r ? ((r.w + 6) % 7) + r.W * 7 - ((o + 5) % 7) : r.w + r.U * 7 - ((o + 6) % 7)));
      return `Z` in r ? ((r.H += (r.Z / 100) | 0), (r.M += r.Z % 100), Ne(r)) : Me(r);
    };
  }
  function w(e, t, n, r) {
    for (var i = 0, a = t.length, o = n.length, s, c; i < a; ) {
      ...
      if (((s = t.charCodeAt(i++)), s === 37)) {
        if (((s = t.charAt(i++)), (c = x[s in Fe ? t.charAt(i++) : s]), !c || (r = c(e, n, r)) < 0))
          return -1;
...
function Qt(t, r, i, a, o, s, c, l, u, d) {
  var f = n(),
    p = f.invert,
    m = f.domain,
    h = d(`.%L`),
  ...
  return (
    ...
    (f.nice = function (e) {
      var t = m();
      return (
        (!e || typeof e.range != `function`) && (e = r(t[0], t[t.length - 1], e ?? 10)),
        e ? m(se(t, e)) : f
      );
    }),
    (f.copy = function () {
      return e(f, Qt(t, r, i, a, o, s, c, l, u, d));
    }),
    f
  );
}
function $t() {
  return d.apply(
    Qt(Ae, je, K, Te, V, z, R, L, I, Jt).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
    arguments,
  );
}
function en(e) {
