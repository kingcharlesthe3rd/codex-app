var e = `vscode://schemas/color-theme`,
  ...
  a = [
    { name: `Default foreground`, scope: [`source`, `text`], settings: { foreground: `#E6E6E6` } },
    {
      name: `Comments`,
    ...
    { name: `Strings`, scope: [`string`, `string.quoted`], settings: { foreground: `#E6E6E6` } },
    {
    ...
    { name: `Tags`, scope: [`entity.name.tag`, `meta.tag`], settings: { foreground: `#F9B98C` } },
    {
      name: `Attributes`,
    ...
    { name: `Emphasis`, scope: [`markup.italic`], settings: { fontStyle: `italic` } },
    { name: `Strong emphasis`, scope: [`markup.bold`], settings: { fontStyle: `bold` } },
    {
  ...
  o = { $schema: e, name: t, displayName: n, type: r, colors: i, tokenColors: a };
export {
  e as $schema,
  i as colors,
  o as default,
