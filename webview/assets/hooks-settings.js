...
import { k as c, s as l } from "./vscode-api.js";
import "./isEqual.js";
import { ut as u } from "./src-4.js";
import { ls as d } from "./app-server-manager-signals.js";
import "./react-dom.js";
import { c as f, o as p, r as m, t as h } from "./lib-1.js";
...
import { _ as E, f as D, n as O } from "./chunk-8.js";
import "./_baseEach.js";
...
import { a as M, d as N, i as P, l as F, n as I } from "./dialog-layout.js";
import "./_defineProperty.js";
import { f as L } from "./links.js";
...
import { i as ce } from "./hooks-settings-route.js";
...
function we(e) {
  ...
  t[7] !== _ || t[8] !== d
    ? ((b = (0, $.jsx)(M, {
        children: (0, $.jsx)(P, { title: _, subtitle: d, subtitleClassName: `break-all` }),
      })),
      (t[7] = _),
      (t[8] = d),
      (t[9] = b))
...
function Oe(e) {
  let t = (0, Q.c)(18),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, $.jsx)(T, { className: `icon-xs shrink-0 text-token-editor-warning-foreground` })),
      (t[0] = s))
    : (s = t[0]);
  let c;
  t[1] === i
  ...
  let d;
  t[5] === u ? (d = t[6]) : ((d = (0, $.jsx)(R, { className: u })), (t[5] = u), (t[6] = d));
  let f;
  t[7] !== o || t[8] !== c || t[9] !== d
    ? ((f = (0, $.jsxs)(`button`, {
        type: `button`,
  ...
  t[13] !== r || t[14] !== m
    ? ((M =
        m?.source === `plugin` && m.pluginId != null
          ? u({ hostId: r, pluginId: m.pluginId })
          : void 0),
      (t[13] = r),
      (t[14] = m),
      (t[15] = M))
...
function Le(e) {
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(k, { className: `icon-sm text-token-text-secondary` })), (t[8] = u))
    : (u = t[8]);
  let d;
  t[9] === o
    ? (d = t[10])
...
function He(e) {
  ...
  let c;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(A, { className: `icon-sm text-token-text-secondary` })), (t[5] = c))
    : (c = t[5]);
  let l;
  t[6] !== n.cwd || t[7] !== r
...
function Ge(e) {
  ...
  let i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(T, { className: `icon-2xs shrink-0 text-token-editor-warning-foreground` })),
      (t[0] = i))
    : (i = t[0]);
  let a;
...
function Ye() {
  ...
  let { data: C, isPending: T } = i(x, S),
    O;
  e[2] === l ? (O = e[3]) : ((O = l.get(`hostId`)), (e[2] = l), (e[3] = O));
  let k = O,
    A = k == null || k === m,
    j,
    M;
  if (
    ...
    let t = A ? l.get(`projectRoot`) : null,
      n = A ? l.get(`pluginId`) : null,
      r = null;
    (m === `local` ? (r = _?.roots?.[0] ?? null) : v?.hostId === m && (r = v.remotePath),
      (j = C == null ? void 0 : Xe(C.roots, r, t)),
      (M = A
        ? ie({ pluginId: n, source: l.get(`source`), projectRoot: t, projectRoots: j })
        : null),
      (e[4] = _?.roots?.[0]),
      (e[5] = A),
      (e[6] = l),
  ...
  let H = V,
    te;
  e[33] !== l || e[34] !== m || e[35] !== u
    ? ((te = (e) => {
        let t = new URLSearchParams(l);
        (ce(t, m, e), u(t, { replace: !0 }));
      }),
      (e[33] = l),
      (e[34] = m),
      (e[35] = u),
