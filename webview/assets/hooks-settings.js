...
import { dt as Ce, lt as we } from "./app-initial~app-main~automations-page.js";
import {
  d as Te,
  f as Ee,
  p as De,
                        ...
                        a
                          ? (0, X.jsx)(ce, {
                              ...
                              children: (0, X.jsx)(`button`, {
                                type: `button`,
                                "aria-label": u.formatMessage(_t.openConfigFile),
...
function yt(e) {
  ...
  t[7] !== g || t[8] !== d
    ? ((y = (0, Z.jsx)(Ye, {
        children: (0, Z.jsx)(Qe, { title: g, subtitle: d, subtitleClassName: `break-all` }),
      })),
      (t[7] = g),
      (t[8] = d),
      (t[9] = y))
...
function Ct(e) {
  let t = (0, Et.c)(18),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Z.jsx)(R, { className: `icon-xs shrink-0 text-token-editor-warning-foreground` })),
      (t[0] = s))
    : (s = t[0]);
  let c;
  t[1] === i
  ...
  t[3] === l
    ? (u = t[4])
    : ((u = Ee(`icon-2xs shrink-0 transition-transform`, l)), (t[3] = l), (t[4] = u));
  let d;
  t[5] === u ? (d = t[6]) : ((d = (0, Z.jsx)(Oe, { className: u })), (t[5] = u), (t[6] = d));
  let f;
  t[7] !== o || t[8] !== c || t[9] !== d
    ? ((f = (0, Z.jsxs)(`button`, {
        type: `button`,
...
function kt(e) {
  ...
  if (t[2] !== n || t[3] !== c || t[4] !== u || t[5] !== f) {
    ((D = n == null || c ? [] : g(n)), (x = []), (S = []), (C = null), (T = null));
    for (let e of D)
      bb0: switch (e.id) {
        case `plugin`:
          C = e;
    ...
    ((E = o(D, f)),
      ...
      (t[11] = D),
      (t[12] = O));
  } else ((x = t[6]), (S = t[7]), (C = t[8]), (T = t[9]), (E = t[10]), (D = t[11]), (O = t[12]));
  let k = O,
    A;
  t[13] !== r || t[14] !== f
    ? ((A =
  ...
  let j = A,
    M;
  t[16] === f ? (M = t[17]) : ((M = f == null ? null : Rt(f.source)), (t[16] = f), (t[17] = M));
  let N = M,
    P = null;
  ...
  let H;
  t[26] !== b || t[27] !== V
    ? ((H = (0, $.jsx)(ce, { delayDuration: 0, tooltipContent: b, children: V })),
      (t[26] = b),
      (t[27] = V),
      (t[28] = H))
    : (H = t[28]);
...
function Pt(e) {
  ...
  let o = a,
    s;
  t[3] === n.entry ? (s = t[4]) : ((s = c(n.entry)), (t[3] = n.entry), (t[4] = s));
  let l = s,
    u;
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(He, { className: `icon-sm text-token-text-secondary` })), (t[8] = d))
    : (d = t[8]);
  let f;
  t[9] === o
    ? (f = t[10])
  ...
  t[11] === n.entry.hooks.length
    ...
    : ((p = (0, $.jsx)(Bt, { count: n.entry.hooks.length })),
      ...
      (t[12] = p));
  let m;
  t[13] === l ? (m = t[14]) : ((m = (0, $.jsx)(Vt, { summary: l })), (t[13] = l), (t[14] = m));
  let h;
...
function It(e) {
  ...
  let d;
  t[7] === i ? (d = t[8]) : ((d = (0, $.jsx)(Lt, { source: i })), (t[7] = i), (t[8] = d));
  let f;
  t[9] === a.hooks.length
    ? (f = t[10])
    : ((f = (0, $.jsx)(Bt, { count: a.hooks.length })), (t[9] = a.hooks.length), (t[10] = f));
  let p;
  t[11] === s ? (p = t[12]) : ((p = (0, $.jsx)(Vt, { summary: s })), (t[11] = s), (t[12] = p));
  let m;
...
function zt(e) {
  ...
  let l;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(Le, { className: `icon-sm text-token-text-secondary` })), (t[5] = l))
    : (l = t[5]);
  let u;
  t[6] !== n.cwd || t[7] !== r
  ...
  t[11] === n.hooks.length
    ? (f = t[12])
    : ((f = (0, $.jsx)(Bt, { count: n.hooks.length })), (t[11] = n.hooks.length), (t[12] = f));
  let p;
  t[13] === o ? (p = t[14]) : ((p = (0, $.jsx)(Vt, { summary: o })), (t[13] = o), (t[14] = p));
  let m;
...
function Vt(e) {
  ...
  let i;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(Oe, { className: `icon-2xs shrink-0 -rotate-90` })), (t[2] = i))
    : (i = t[2]);
  let a;
  return (
    t[3] === r
...
function Jt() {
  ...
  (e[22] !== r.key || e[23] !== o || e[24] !== s || e[25] !== y
    ? ((N = [r.key, o, s, y]), (e[22] = r.key), (e[23] = o), (e[24] = s), (e[25] = y), (e[26] = N))
    : (N = e[26]),
    (0, Xt.useEffect)(M, N));
  let P = C(Fe, s),
    ee;
