...
import { d as l, l as u, n as d } from "./thread-context-inputs.js";
import { A as f, s as p } from "./vscode-api.js";
import "./isEqual.js";
import { mt as m } from "./src-1.js";
import "./react-dom.js";
import { i as h, l as g, n as _, s as v } from "./lib-1.js";
...
import { t as x } from "./tooltip-B.js";
...
import { _ as E, f as D, n as O } from "./chunk-13.js";
...
import { t as N } from "./settings.cog.js";
import { a as P, d as F, i as I, l as L, n as R } from "./dialog-layout.js";
import "./_defineProperty.js";
import { p as z } from "./links.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as ee } from "./settings-host-context.js";
import { t as B } from "./get-project-name.js";
import { t as V } from "./building.js";
import { t as H } from "./banner.js";
import { t as U } from "./toggle.js";
import { a as W, i as te, r as G } from "./hooks-settings-queries.js";
import {
  a as K,
  f as q,
  i as ne,
...
import { r as Y } from "./settings-row.js";
import { t as X } from "./settings-surface.js";
...
function ve(e) {
  ...
  if (
    ...
    let e = K(a, n);
    ((h = `border-t border-token-border px-3`), (f = `divide-y-[0.5px] divide-token-border`));
    let p;
    (t[12] !== l ||
    t[13] !== r ||
    t[14] !== c ||
    ...
    t[18] !== d
                    ...
                    (0, $.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        a
                          ? (0, $.jsx)(x, {
                              triggerAsChild: !0,
                              tooltipContent: (0, $.jsx)(v, { ...Ce.openConfigFile }),
      ...
      (t[10] = m),
      (t[11] = h));
  } else ((f = t[9]), (m = t[10]), (h = t[11]));
  let _;
  t[20] !== f || t[21] !== m
    ? ((_ = (0, $.jsx)(`div`, { className: f, children: m })),
      (t[20] = f),
      (t[21] = m),
      (t[22] = _))
    : (_ = t[22]);
  ...
  return (
    t[23] !== h || t[24] !== _
      ? ((S = (0, $.jsx)(`div`, { className: h, children: _ })),
        (t[23] = h),
        (t[24] = _),
        (t[25] = S))
      : (S = t[25]),
...
function we(e) {
  ...
  t[7] !== g || t[8] !== d
    ? ((b = (0, $.jsx)(P, {
        children: (0, $.jsx)(I, { title: g, subtitle: d, subtitleClassName: `break-all` }),
      })),
      (t[7] = g),
      (t[8] = d),
      (t[9] = b))
...
function Te(e) {
  ...
  return (
    t[19] !== d || t[20] !== f || t[21] !== p
      ? ((m = (0, $.jsxs)($.Fragment, { children: [d, f, p] })),
        (t[19] = d),
        (t[20] = f),
        (t[21] = p),
        (t[22] = m))
...
function Oe(e) {
  ...
  t[3] === l
    ? (u = t[4])
    : ((u = y(`icon-2xs shrink-0 transition-transform`, l)), (t[3] = l), (t[4] = u));
  let d;
  t[5] === u ? (d = t[6]) : ((d = (0, $.jsx)(w, { className: u })), (t[5] = u), (t[6] = d));
  let f;
  t[7] !== o || t[8] !== c || t[9] !== d
    ? ((f = (0, $.jsxs)(`button`, {
        type: `button`,
...
function Me(e) {
  ...
  if (t[2] !== n || t[3] !== s || t[4] !== l || t[5] !== d) {
    ((A = n == null || s ? [] : ne(n)), (T = []), (E = []), (D = null), (O = null));
    for (let e of A)
      bb0: switch (e.id) {
        case `plugin`:
          D = e;
    ...
    ((k = oe(A, d)),
      (j = qe({ entry: k, projectRootLabels: l, selection: d })),
      (t[2] = n),
      (t[3] = s),
      (t[4] = l),
      (t[5] = d),
      ...
      (t[11] = A),
      (t[12] = j));
  } else ((T = t[6]), (E = t[7]), (D = t[8]), (O = t[9]), (k = t[10]), (A = t[11]), (j = t[12]));
  let M = j,
    N;
  t[13] !== r || t[14] !== d
    ? ((N =
  ...
  let P = N,
    F;
  t[16] === d ? (F = t[17]) : ((F = d == null ? null : Ve(d.source)), (t[16] = d), (t[17] = F));
  let I = F,
    L = null;
  ...
  let R = `none`;
  if (d?.source === `project`) R = d.projectRoot;
  else if (d?.source === `plugin`) {
    R = `plugin`;
    let e = d.pluginId;
    e !== void 0 && (R = `plugin:${e ?? `unknown`}`);
  } else d != null && (R = d.source);
  let z;
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, $.jsx)(se, { slug: je })), (t[19] = z))
    : (z = t[19]);
  let ee;
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, $.jsx)(v, {
      ...
      (t[20] = ee))
    : (ee = t[20]);
  let B = u == null || u.length === 0 || s || c,
    V;
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, $.jsx)(C, { className: `icon-xs` })), (t[21] = V))
    : (V = t[21]);
  let H;
  t[22] !== p || t[23] !== w || t[24] !== B
    ? ((H = (0, $.jsx)(b, {
        "aria-label": w,
        color: `ghost`,
        disabled: B,
  ...
  let U;
  t[26] !== w || t[27] !== H
    ? ((U = (0, $.jsx)(x, { delayDuration: 0, tooltipContent: w, children: H })),
      (t[26] = w),
      (t[27] = H),
      (t[28] = U))
    : (U = t[28]);
                  ...
                  : (0, $.jsxs)(`div`, {
                      ...
                      children: [
                        T.length > 0
                          ...
                          : null,
                        D == null ? null : (0, $.jsx)(Ie, { section: D, onSelectSourceSection: f }),
                        O == null
                          ? null
                          : (0, $.jsx)(Re, {
                              section: O,
...
function Le(e) {
  ...
  let o = a,
    s;
  t[3] === n.entry ? (s = t[4]) : ((s = ie(n.entry)), (t[3] = n.entry), (t[4] = s));
  let c = s,
    l;
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(j, { className: `icon-sm text-token-text-secondary` })), (t[8] = u))
    : (u = t[8]);
  let d;
  t[9] === o
    ? (d = t[10])
  ...
  t[11] === n.entry.hooks.length
    ...
    : ((f = (0, $.jsx)(Ue, { count: n.entry.hooks.length })),
      ...
      (t[12] = f));
  let p;
  t[13] === c ? (p = t[14]) : ((p = (0, $.jsx)(We, { summary: c })), (t[13] = c), (t[14] = p));
  let m;
  t[15] !== d || t[16] !== f || t[17] !== p
    ? ((m = (0, $.jsx)(Y, { icon: u, label: d, description: f, control: p })),
      (t[15] = d),
      (t[16] = f),
      (t[17] = p),
      (t[18] = m))
...
function Ve(e) {
  ...
  switch (e) {
    ...
    case `user`:
      return (0, $.jsx)(N, { className: t });
    case `admin`:
      return (0, $.jsx)(V, { className: t });
    case `project`:
...
function He(e) {
  ...
  let c;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(M, { className: `icon-sm text-token-text-secondary` })), (t[5] = c))
    : (c = t[5]);
  let l;
  t[6] !== n.cwd || t[7] !== r
...
function We(e) {
  ...
  let i;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(w, { className: `icon-2xs shrink-0 -rotate-90` })), (t[2] = i))
    : (i = t[2]);
  let a;
  return (
    t[3] === r
...
function Ye() {
  let e = (0, Q.c)(55),
    ...
    [p, m] = E(),
    h = f(),
    { selectedHostId: _, setSelectedHostId: v } = ee(),
    y = c(_),
    { data: b } = o(d),
    x = o(u),
    C;
  e[0] === _ ? (C = e[1]) : ((C = { hostId: _ }), (e[0] = _), (e[1] = C));
  let { data: w, isPending: T } = i(l, C),
    O;
  e[2] === p ? (O = e[3]) : ((O = p.get(`hostId`)), (e[2] = p), (e[3] = O));
  let k = O,
    A = k == null || k === _,
    j,
    M;
  if (
    ...
    let t = A ? p.get(`projectRoot`) : null,
      n = A ? p.get(`pluginId`) : null,
      r = null;
    (_ === `local` ? (r = b?.roots?.[0] ?? null) : x?.hostId === _ && (r = x.remotePath),
      (j = w == null ? void 0 : Xe(w.roots, r, t)),
      (M = A
        ? re({ pluginId: n, source: p.get(`source`), projectRoot: t, projectRoots: j })
        : null),
      (e[4] = b?.roots?.[0]),
      (e[5] = A),
      (e[6] = p),
  ...
  let N = M,
    P;
  e[12] !== j || e[13] !== _
    ? ((P = { hostId: _, cwds: j }), (e[12] = j), (e[13] = _), (e[14] = P))
    : (P = e[14]);
  let F = i(G, P),
    I;
  e[15] === v
  ...
  let L = (0, he.useEffectEvent)(I),
    R;
  e[17] !== h || e[18] !== _ || e[19] !== k || e[20] !== L
    ? ((R = () => {
        if (k != null && k !== _) {
          L(k);
          return;
        }
        te(h, _, { refetchType: `active` });
      }),
      (e[17] = h),
      (e[18] = _),
      (e[19] = k),
    ...
    : (R = e[21]);
  let z;
  (e[22] !== r.key || e[23] !== h || e[24] !== _ || e[25] !== k
    ? ((z = [r.key, h, _, k]), (e[22] = r.key), (e[23] = h), (e[24] = _), (e[25] = k), (e[26] = z))
    : (z = e[26]),
    (0, he.useEffect)(R, z));
  let B = i(W, _),
    V;
  e[27] !== F || e[28] !== n || e[29] !== h || e[30] !== t || e[31] !== _
    ? ((V = () => {
        F.refetch().then(async (e) => {
          e.isSuccess &&
            (await te(h, _, { broadcast: !0, refetchType: `none` }),
            t
              .get(S)
              .success(
                n.formatMessage({
  ...
  let H = V,
    U;
  e[33] !== p || e[34] !== _ || e[35] !== m
    ? ((U = (e) => {
        let t = new URLSearchParams(p);
        (ce(t, _, e), m(t, { replace: !0 }));
      }),
      (e[33] = p),
      (e[34] = _),
      (e[35] = m),
