...
import { k as l, s as u } from "./vscode-api.js";
import "./isEqual.js";
import { pt as d } from "./src-1.js";
import "./react-dom.js";
import { c as f, o as p, r as m, t as h } from "./lib.js";
...
import { c as y, t as b, u as x } from "./thread-context-inputs.js";
import "./config-queries.js";
import "./selectable-remote-connections-signal.js";
import { t as S } from "./link-external.js";
import { t as C } from "./open-workspace-file.js";
...
import { t as E } from "./warning.js";
import { _ as D, f as O, n as k } from "./chunk-109.js";
import "./_baseEach-BPh-9Ri0.js";
import "./_baseOrderBy.js";
import { t as A } from "./apps.js";
import "./x.js";
import "./with-window.js";
import { t as j } from "./folder.js";
import { t as M } from "./settings.cog.js";
import { a as N, d as P, i as F, l as I, n as L } from "./dialog-layout.js";
import "./_defineProperty.js";
import { f as R } from "./links.js";
import { t as z } from "./building.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as ee } from "./settings-host-context.js";
import { t as B } from "./get-project-name.js";
import { t as V } from "./banner.js";
import { t as H } from "./toggle.js";
import { t as te } from "./regenerate.js";
import { a as U, i as ne, r as W } from "./hooks-settings-queries.js";
import {
  a as G,
  f as K,
  i as re,
...
import { i as se } from "./settings-shared.js";
import { i as ce } from "./hooks-settings-route-B.js";
...
import { i as de, n as fe, r as pe, t as me } from "./hooks-settings-copy.js";
var Q = r(),
  he = e(t()),
  $ = n();
function ge(e, t) {
...
function ve(e) {
  ...
  if (
    ...
    let e = G(a, n);
    ((b = `border-t border-token-border px-3`), (h = `divide-y-[0.5px] divide-token-border`));
    let u;
    (t[12] !== l ||
    t[13] !== r ||
    t[14] !== c ||
    ...
    t[18] !== m
          ...
          return (0, $.jsxs)(
            `div`,
            {
              ...
              children: [
                    ...
                    (0, $.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        a
                          ? (0, $.jsx)(v, {
                              triggerAsChild: !0,
                              tooltipContent: (0, $.jsx)(p, { ...Ce.openConfigFile }),
                              children: (0, $.jsx)(`button`, {
                                type: `button`,
                                "aria-label": c.formatMessage(Ce.openConfigFile),
                ...
                u
                  ? (0, $.jsx)(`div`, { className: `pl-7`, children: (0, $.jsx)(be, { hook: e }) })
                  : null,
              ],
            },
            e.key,
      ...
      (t[10] = y),
      (t[11] = b));
  } else ((h = t[9]), (y = t[10]), (b = t[11]));
  let x;
  t[20] !== h || t[21] !== y
    ? ((x = (0, $.jsx)(`div`, { className: h, children: y })),
      (t[20] = h),
      (t[21] = y),
      (t[22] = x))
    : (x = t[22]);
  ...
  return (
    t[23] !== b || t[24] !== x
      ? ((w = (0, $.jsx)(`div`, { className: b, children: x })),
        (t[23] = b),
        (t[24] = x),
        (t[25] = w))
      : (w = t[25]),
...
function we(e) {
  ...
  t[7] !== _ || t[8] !== d
    ? ((b = (0, $.jsx)(N, {
        children: (0, $.jsx)(F, { title: _, subtitle: d, subtitleClassName: `break-all` }),
      })),
      (t[7] = _),
      (t[8] = d),
      (t[9] = b))
...
function Te(e) {
  ...
  if (
    ...
    (t[12] === g
      ...
      (t[10] = p),
      (t[11] = m));
  } else ((d = t[9]), (p = t[10]), (m = t[11]));
  let h;
  return (
    t[19] !== d || t[20] !== p || t[21] !== m
      ? ((h = (0, $.jsxs)($.Fragment, { children: [d, p, m] })),
        (t[19] = d),
        (t[20] = p),
        (t[21] = m),
        (t[22] = h))
...
function Oe(e) {
  let t = (0, Q.c)(18),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, $.jsx)(E, { className: `icon-xs shrink-0 text-token-editor-warning-foreground` })),
      (t[0] = s))
    : (s = t[0]);
  let c;
  t[1] === i
  ...
  t[3] === l
    ? (u = t[4])
    : ((u = g(`icon-2xs shrink-0 transition-transform`, l)), (t[3] = l), (t[4] = u));
  let d;
  t[5] === u ? (d = t[6]) : ((d = (0, $.jsx)(T, { className: u })), (t[5] = u), (t[6] = d));
  let f;
  t[7] !== o || t[8] !== c || t[9] !== d
    ? ((f = (0, $.jsxs)(`button`, {
        type: `button`,
...
function Me(e) {
  ...
  let C = S,
    ...
    k,
    A;
  if (t[2] !== n || t[3] !== s || t[4] !== l || t[5] !== m) {
    ((k = n == null || s ? [] : re(n)), (w = []), (T = []), (E = null), (D = null));
    for (let e of k)
      bb0: switch (e.id) {
        case `plugin`:
          E = e;
    ...
    ((O = J(k, m)),
      (A = qe({ entry: O, projectRootLabels: l, selection: m })),
      (t[2] = n),
      (t[3] = s),
      (t[4] = l),
      (t[5] = m),
      ...
      (t[11] = k),
      (t[12] = A));
  } else ((w = t[6]), (T = t[7]), (E = t[8]), (D = t[9]), (O = t[10]), (k = t[11]), (A = t[12]));
  let j = A,
    M;
  t[13] !== r || t[14] !== m
    ? ((M =
        m?.source === `plugin` && m.pluginId != null
          ? d({ hostId: r, pluginId: m.pluginId })
          : void 0),
      (t[13] = r),
      (t[14] = m),
      (t[15] = M))
  ...
  let N = M,
    P;
  t[16] === m ? (P = t[17]) : ((P = m == null ? null : Ve(m.source)), (t[16] = m), (t[17] = P));
  let F = P,
    I = null;
  if (m?.source === `project`) I = m.projectRoot;
  else if (m != null) {
    let e;
  ...
  let L = `none`;
  if (m?.source === `project`) L = m.projectRoot;
  else if (m?.source === `plugin`) {
    L = `plugin`;
    let e = m.pluginId;
    e !== void 0 && (L = `plugin:${e ?? `unknown`}`);
  } else m != null && (L = m.source);
  let R;
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, $.jsx)(se, { slug: je })), (t[19] = R))
    : (R = t[19]);
  let z;
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, $.jsx)(p, {
      ...
      (t[20] = z))
    : (z = t[20]);
  let ee = u == null || u.length === 0 || s || c,
    B;
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, $.jsx)(te, { className: `icon-xs` })), (t[21] = B))
    : (B = t[21]);
  let V;
  t[22] !== g || t[23] !== C || t[24] !== ee
    ? ((V = (0, $.jsx)(_, {
        "aria-label": C,
        color: `ghost`,
        disabled: ee,
  ...
  let H;
  t[26] !== C || t[27] !== V
    ? ((H = (0, $.jsx)(v, { delayDuration: 0, tooltipContent: C, children: V })),
      (t[26] = C),
      (t[27] = V),
      (t[28] = H))
    : (H = t[28]);
                  ...
                  : (0, $.jsxs)(`div`, {
                      ...
                      children: [
                        w.length > 0
                          ...
                          : null,
                        E == null ? null : (0, $.jsx)(Ie, { section: E, onSelectSourceSection: h }),
                        D == null
                          ? null
                          : (0, $.jsx)(Re, {
                              section: D,
...
function Le(e) {
  ...
  let o = a,
    s;
  t[3] === n.entry ? (s = t[4]) : ((s = ae(n.entry)), (t[3] = n.entry), (t[4] = s));
  let c = s,
    l;
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(A, { className: `icon-sm text-token-text-secondary` })), (t[8] = u))
    : (u = t[8]);
  let d;
  t[9] === o
    ? (d = t[10])
  ...
  t[11] === n.entry.hooks.length
    ? (p = t[12])
    : ((p = (0, $.jsx)(Ue, { count: n.entry.hooks.length })),
      (t[11] = n.entry.hooks.length),
      (t[12] = p));
  let m;
  t[13] === c ? (m = t[14]) : ((m = (0, $.jsx)(We, { summary: c })), (t[13] = c), (t[14] = m));
  let h;
  t[15] !== d || t[16] !== p || t[17] !== m
    ? ((h = (0, $.jsx)(Y, { icon: u, label: d, description: p, control: m })),
      (t[15] = d),
      (t[16] = p),
      (t[17] = m),
      (t[18] = h))
...
function ze(e) {
  let t = (0, Q.c)(21),
    ...
    a = n.entry,
    o;
  t[0] === a ? (o = t[1]) : ((o = ae(a)), (t[0] = a), (t[1] = o));
  let s = o,
    c;
  t[2] !== r || t[3] !== i
    ? ((c = () => {
...
function He(e) {
  let t = (0, Q.c)(22),
    ...
    a;
  t[0] === n ? (a = t[1]) : ((a = ae(n)), (t[0] = n), (t[1] = a));
  let o = a,
    s;
  t[2] !== n.cwd || t[3] !== i
    ? ((s = () => {
...
function We(e) {
  ...
  let i;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(T, { className: `icon-2xs shrink-0 -rotate-90` })), (t[2] = i))
    : (i = t[2]);
  let a;
  return (
    t[3] === r
...
function Ge(e) {
  ...
  let i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(E, { className: `icon-2xs shrink-0 text-token-editor-warning-foreground` })),
      (t[0] = i))
    : (i = t[0]);
  let a;
...
function qe({ entry: e, projectRootLabels: t, selection: n }) {
  if (n == null) return null;
  if (n.source === `project`) return Ke(n.projectRoot, t);
  if (n.source === `plugin`) {
    let t = n.pluginId === void 0 ? null : de(n.pluginId);
    if ((t == null && e != null && (t = Je(e.hooks)), t != null)) return t;
  }
  return (0, $.jsx)(Be, { source: n.source });
}
function Je(e) {
  let t = null;
  for (let n of e) {
...
function Ye() {
  let e = (0, Q.c)(55),
    ...
    [u, d] = D(),
    p = l(),
    { selectedHostId: m, setSelectedHostId: h } = ee(),
    g = c(m),
    { data: _ } = o(b),
    v = o(y),
    S;
  e[0] === m ? (S = e[1]) : ((S = { hostId: m }), (e[0] = m), (e[1] = S));
  let { data: C, isPending: T } = i(x, S),
    E;
  e[2] === u ? (E = e[3]) : ((E = u.get(`hostId`)), (e[2] = u), (e[3] = E));
  let k = E,
    A = k == null || k === m,
    j,
    M;
  if (
    ...
    let t = A ? u.get(`projectRoot`) : null,
      n = A ? u.get(`pluginId`) : null,
      r = null;
    (m === `local` ? (r = _?.roots?.[0] ?? null) : v?.hostId === m && (r = v.remotePath),
      (j = C == null ? void 0 : Xe(C.roots, r, t)),
      (M = A
        ? ie({ pluginId: n, source: u.get(`source`), projectRoot: t, projectRoots: j })
        : null),
      (e[4] = _?.roots?.[0]),
      (e[5] = A),
      (e[6] = u),
  ...
  e[17] !== p || e[18] !== m || e[19] !== k || e[20] !== L
    ...
    : (R = e[21]);
  let z;
  (e[22] !== r.key || e[23] !== p || e[24] !== m || e[25] !== k
    ? ((z = [r.key, p, m, k]), (e[22] = r.key), (e[23] = p), (e[24] = m), (e[25] = k), (e[26] = z))
    : (z = e[26]),
    (0, he.useEffect)(R, z));
  let B = i(U, m),
    V;
  e[27] !== F || e[28] !== n || e[29] !== p || e[30] !== t || e[31] !== m
    ? ((V = () => {
        F.refetch().then(async (e) => {
          e.isSuccess &&
            (await ne(p, m, { broadcast: !0, refetchType: `none` }),
            t
              .get(w)
              .success(
                n.formatMessage({
  ...
  let H = V,
    te;
  e[33] !== u || e[34] !== m || e[35] !== d
    ? ((te = (e) => {
        let t = new URLSearchParams(u);
        (ce(t, m, e), d(t, { replace: !0 }));
      }),
      (e[33] = u),
      (e[34] = m),
      (e[35] = d),
  ...
  return (
    ...
    e[53] !== K
      ? ((se = (0, $.jsx)(Me, {
          ...
          hostId: m,
          isRemoteHost: re,
          isLoadingProjectRoots: T,
          loadError: F.error,
          isLoading: F.isPending,
          isRefreshing: ae,
          projectRootLabels: oe,
          projectRoots: j,
          selectedSourceSection: N,
          onSelectSourceSection: G,
          onRefreshHooks: H,
...
function Xe(e, t, n) {
  let r = Array.from(new Set(e)).sort((e, t) => e.localeCompare(t));
  if (t != null) {
    let e = r.indexOf(t);
    (e >= 0 && r.splice(e, 1), r.unshift(t));
  }
  return (n != null && !r.includes(n) && r.push(n), r);
}
