...
import { Dt as ye, Tt as be } from "./app-initial~app-main~automations-page.js";
import {
  Ci as xe,
  Ct as Se,
  Du as Ce,
                    ...
                    (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        a
                          ? (0, X.jsx)(se, {
                              triggerAsChild: !0,
                              tooltipContent: (0, X.jsx)(q, { ..._t.openConfigFile }),
...
function yt(e) {
  ...
  t[7] !== g || t[8] !== d
    ? ((y = (0, Z.jsx)(Me, {
        children: (0, Z.jsx)(ke, { title: g, subtitle: d, subtitleClassName: `break-all` }),
      })),
      (t[7] = g),
      (t[8] = d),
      (t[9] = y))
              ...
              children: e.map((e) =>
                (0, Z.jsxs)(
                  `div`,
                  {
                    children: [
                      (0, Z.jsx)(U, {
                        icon: (0, Z.jsx)(I, { className: `icon-xs` }),
                        label: (0, Z.jsx)(`span`, {
                          className: `font-medium`,
                          children: oe(e.eventName, s),
                        }),
                        description: M(e.eventName, s),
                        control:
                          e.needsReview > 0
                            ? (0, Z.jsx)(K, {
...
function Ct(e) {
  let t = (0, Et.c)(18),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Z.jsx)(K, { className: `icon-xs shrink-0 text-token-editor-warning-foreground` })),
      (t[0] = s))
    : (s = t[0]);
  let c;
  t[1] === i
  ...
  t[3] === l
    ? (u = t[4])
    : ((u = pe(`icon-2xs shrink-0 transition-transform`, l)), (t[3] = l), (t[4] = u));
  let d;
  t[5] === u ? (d = t[6]) : ((d = (0, Z.jsx)(we, { className: u })), (t[5] = u), (t[6] = d));
  let f;
  t[7] !== o || t[8] !== c || t[9] !== d
    ? ((f = (0, Z.jsxs)(`button`, {
        type: `button`,
...
function kt(e) {
  ...
  if (t[2] !== n || t[3] !== s || t[4] !== l || t[5] !== d) {
    ((T = n == null || s ? [] : j(n)), (b = []), (x = []), (S = null), (C = null));
    for (let e of T)
      bb0: switch (e.id) {
        case `plugin`:
          S = e;
    ...
    ((w = D(T, d)),
      (E = Wt({ entry: w, projectRootLabels: l, selection: d })),
      (t[2] = n),
      (t[3] = s),
      (t[4] = l),
      (t[5] = d),
  ...
  t[13] !== r || t[14] !== d
    ? ((k =
        d?.source === `plugin` && d.pluginId != null
          ? y({ hostId: r, pluginId: d.pluginId })
          : void 0),
      (t[13] = r),
      (t[14] = d),
      (t[15] = k))
  ...
  let A = k,
    ee;
  t[16] === d ? (ee = t[17]) : ((ee = d == null ? null : Rt(d.source)), (t[16] = d), (t[17] = ee));
  let M = ee,
    N = null;
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, $.jsx)(ne, { className: `icon-xs` })), (t[21] = R))
    : (R = t[21]);
  let te;
  t[22] !== p || t[23] !== v || t[24] !== L
    ? ((te = (0, $.jsx)(He, {
        "aria-label": v,
        color: `ghost`,
        disabled: L,
  ...
  let z;
  t[26] !== v || t[27] !== te
    ? ((z = (0, $.jsx)(se, { delayDuration: 0, tooltipContent: v, children: te })),
      (t[26] = v),
      (t[27] = te),
      (t[28] = z))
    : (z = t[28]);
                  ...
                  : (0, $.jsxs)(`div`, {
                      ...
                      children: [
                        b.length > 0
                          ...
                          : null,
                        S == null ? null : (0, $.jsx)(Nt, { section: S, onSelectSourceSection: f }),
                        C == null
                          ? null
                          : (0, $.jsx)(Ft, {
                              section: C,
...
function Pt(e) {
  ...
  let o = a,
    s;
  t[3] === n.entry ? (s = t[4]) : ((s = E(n.entry)), (t[3] = n.entry), (t[4] = s));
  let c = s,
    l;
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(Ke, { className: `icon-sm text-token-text-secondary` })), (t[8] = u))
    : (u = t[8]);
  let d;
  t[9] === o
    ? (d = t[10])
  ...
  t[15] !== d || t[16] !== f || t[17] !== p
    ? ((m = (0, $.jsx)(U, { icon: u, label: d, description: f, control: p })),
      (t[15] = d),
      (t[16] = f),
      (t[17] = p),
      (t[18] = m))
...
function It(e) {
  ...
  t[13] !== l || t[14] !== u || t[15] !== d || t[16] !== f
    ? ((p = (0, $.jsx)(U, { icon: l, label: u, description: d, control: f })),
      (t[13] = l),
      (t[14] = u),
      (t[15] = d),
      (t[16] = f),
...
function Rt(e) {
  ...
  switch (e) {
    case `plugin`:
      return (0, $.jsx)(Ke, { className: t });
    case `user`:
      return (0, $.jsx)($e, { className: t });
    case `admin`:
      return (0, $.jsx)(W, { className: t });
    case `project`:
      return (0, $.jsx)(xe, { className: t });
    case `sessionFlags`:
    case `unknown`:
...
function zt(e) {
  ...
  let c;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(xe, { className: `icon-sm text-token-text-secondary` })), (t[5] = c))
    : (c = t[5]);
  let l;
  t[6] !== n.cwd || t[7] !== r
  ...
  t[15] !== u || t[16] !== d || t[17] !== f
    ? ((p = (0, $.jsx)(U, { icon: c, label: u, description: d, control: f })),
      (t[15] = u),
      (t[16] = d),
      (t[17] = f),
      (t[18] = p))
...
function Vt(e) {
  ...
  let i;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(we, { className: `icon-2xs shrink-0 -rotate-90` })), (t[2] = i))
    : (i = t[2]);
  let a;
  return (
    t[3] === r
...
function Ht(e) {
  ...
  let i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(K, { className: `icon-2xs shrink-0 text-token-editor-warning-foreground` })),
      (t[0] = i))
    : (i = t[0]);
  let a;
...
function Wt({ entry: e, projectRootLabels: t, selection: n }) {
  ...
  if (n.source === `plugin`) {
    let t = n.pluginId === void 0 ? null : L(n.pluginId);
...
function Jt() {
  let e = (0, Yt.c)(55),
    ...
    [o, u] = he(),
    d = m(),
    { selectedHostId: f, setSelectedHostId: p } = P(),
    h = i(f),
    g = v(l),
    y = v(a),
    x;
  e[0] === f ? (x = e[1]) : ((x = { hostId: f }), (e[0] = f), (e[1] = x));
  let { data: S, isPending: C } = _(s, x),
    w;
  e[2] === o ? (w = e[3]) : ((w = o.get(`hostId`)), (e[2] = o), (e[3] = w));
  let T = w,
    E = T == null || T === f,
    D,
    O;
  if (e[4] !== g || e[5] !== E || e[6] !== o || e[7] !== f || e[8] !== y || e[9] !== S) {
    let t = E ? o.get(`projectRoot`) : null,
      n = E ? o.get(`pluginId`) : null,
      r = [];
    (f === `local` ? (r = g) : y?.hostId === f && (r = [y.remotePath]),
      (D = S == null ? void 0 : re(S.roots, r, t)),
      (O = E
        ? ee({ pluginId: n, source: o.get(`source`), projectRoot: t, projectRoots: D })
        : null),
      (e[4] = g),
      (e[5] = E),
      (e[6] = o),
  ...
  let k = O,
    A;
  e[12] !== D || e[13] !== f
    ? ((A = { hostId: f, cwds: D }), (e[12] = D), (e[13] = f), (e[14] = A))
    : (A = e[14]);
  let j = _(ze, A),
    M;
  e[15] === p
    ...
    : ((M = (e) => {
      ...
      (e[15] = p),
      (e[16] = M));
  let N = (0, Xt.useEffectEvent)(M),
    F;
  e[17] !== d || e[18] !== f || e[19] !== T || e[20] !== N
    ? ((F = () => {
        if (T != null && T !== f) {
          N(T);
          return;
        }
        Se(d, f, { refetchType: `active` });
      }),
      (e[17] = d),
      (e[18] = f),
      (e[19] = T),
    ...
    : (F = e[21]);
  let I;
  (e[22] !== r.key || e[23] !== d || e[24] !== f || e[25] !== T
    ? ((I = [r.key, d, f, T]), (e[22] = r.key), (e[23] = d), (e[24] = f), (e[25] = T), (e[26] = I))
    : (I = e[26]),
    (0, Xt.useEffect)(F, I));
  let L = _(Re, f),
    R;
  e[27] !== j || e[28] !== n || e[29] !== d || e[30] !== t || e[31] !== f
    ? ((R = () => {
        j.refetch().then(async (e) => {
          e.isSuccess &&
            (await Se(d, f, { broadcast: !0, refetchType: `none` }),
            t
              .get(Ue)
              .success(
                n.formatMessage({
  ...
  let z = R,
    B;
  e[33] !== o || e[34] !== f || e[35] !== u
    ? ((B = (e) => {
        let t = new URLSearchParams(o);
        (te(t, f, e), u(t, { replace: !0 }));
      }),
      (e[33] = o),
      (e[34] = f),
      (e[35] = u),
  ...
  e[37] === L
    ? ((ie = e[38]), (G = e[39]))
    : ((ie = (e, t) => {
        L.mutate([{ key: e.key, enabled: t }]);
      }),
      (G = (e) => {
        L.mutate([{ key: e.key, trustedHash: e.currentHash }]);
      }),
      (e[37] = L),
      (e[38] = ie),
      (e[39] = G));
