...
function M(e) {
  let t = (0, N.c)(5),
    { className: r } = e,
    i;
  t[0] === r ? (i = t[1]) : ((i = h(`last:hidden`, r)), (t[0] = r), (t[1] = i));
  let a;
  ...
  return (
    t[3] === i
      ? (o = t[4])
      : ((o = (0, P.jsx)(`span`, { "aria-hidden": !0, className: i, children: a })),
        (t[3] = i),
        (t[4] = o)),
    o
  );
...
function z(e) {
  let t = (0, B.c)(6),
    ...
    o;
  t[0] !== a || t[1] !== n || t[2] !== i
    ? ((o = E({ intl: a, minutes: n, variant: i })), (t[0] = a), (t[1] = n), (t[2] = i), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] === o
      ? (s = t[5])
      : ((s = (0, V.jsx)(V.Fragment, { children: o })), (t[4] = o), (t[5] = s)),
    s
  );
}
var B,
...
function U(e) {
  let t = (0, Y.c)(45),
    {
      ...
      onRateLimitResetClick: u,
      onPlanUpgradeClick: d,
      planUpgradeOpensNativeSurface: f,
      onRequestLimitIncreaseClick: g,
      isLoading: v,
      showLearnMore: y,
      layout: x,
    } = e,
    ...
    w = v === void 0 ? !1 : v,
    T = y === void 0 ? !0 : y,
    E = x === void 0 ? `default` : x;
  if (!w && r.length === 0 && C === 0) return null;
  let D, O, A, M, N, P, F, I, R, z;
  if (t[0] !== i || t[1] !== E || t[2] !== r || t[3] !== s || t[4] !== o) {
    let e = j(r, { activeLimitName: i, selectedModel: s }),
      a;
    (t[15] !== i || t[16] !== o
      ? ((a = o ?? !k(i)), (t[15] = i), (t[16] = o), (t[17] = a))
      : (a = t[17]),
      (M = a),
      (A = E === `compact`),
      (O = p),
    ...
    ((D = t[5]),
      ...
      (z = t[14]));
  let B;
  t[19] !== P || t[20] !== F || t[21] !== I
    ? ((B = (0, X.jsxs)(`span`, { className: P, children: [F, I] })),
      (t[19] = P),
      (t[20] = F),
      (t[21] = I),
      (t[22] = B))
    : (B = t[22]);
  let V;
  t[23] !== D || t[24] !== N || t[25] !== B || t[26] !== R || t[27] !== z
    ? ((V = (0, X.jsx)(D, { LeftIcon: R, RightIcon: z, tooltipSide: N, children: B })),
      (t[23] = D),
      (t[24] = N),
      (t[25] = B),
      (t[26] = R),
    ...
    ? ((H = (0, X.jsx)(`div`, {
        ...
        children: w
          ? (0, X.jsx)(b.Item, {
              LeftIcon: _,
              className: h(
                A && `pl-[calc(var(--padding-row-x)+1.25rem)] pr-[var(--padding-row-x)]`,
              ),
              disabled: !0,
              children: (0, X.jsx)(n, {
              ...
              children: [
                (0, X.jsx)(`div`, {
                  ...
                  children: r.map((e, t) => {
                    ...
                    return (0, X.jsx)(
                      G,
                      { rateLimit: e.snapshot, limitName: n, compact: A },
                ...
                T &&
                  (0, X.jsx)(b.Item, {
                    rightIcon: (0, X.jsx)(m, {
                      href: Q,
                      className: h(Z, A && `text-token-description-foreground`),
                    }),
                    className: h(
                      A && `pl-[calc(var(--padding-row-x)+1.25rem)] pr-[var(--padding-row-x)]`,
                    ),
                    ...
                    children: (0, X.jsx)(`span`, {
                      className: h(
                        A ? `text-token-foreground` : `text-token-description-foreground`,
                      ),
                      children: (0, X.jsx)(n, {
  ...
  let U;
  return (
    t[41] !== O || t[42] !== V || t[43] !== H
      ? ((U = (0, X.jsx)(O, { trigger: V, children: H })),
        (t[41] = O),
        (t[42] = V),
        (t[43] = H),
        (t[44] = U))
...
function W(e) {
  a({ event: e, href: Q, initiator: `open_in_browser_bridge` });
}
function G(e) {
  let t = (0, Y.c)(19),
    { rateLimit: r, limitName: i, compact: a } = e,
    o = r?.primary,
    s;
  t[0] === o ? (s = t[1]) : ((s = w(o)), (t[0] = o), (t[1] = s));
  let c = s,
    l = r?.secondary,
    u;
  ...
  let p;
  t[7] !== a || t[8] !== r || t[9] !== c
    ? ((p = c && (0, X.jsx)(K, { bucket: r.primary ?? null, compact: a })),
      (t[7] = a),
      (t[8] = r),
      (t[9] = c),
      (t[10] = p))
    : (p = t[10]);
  let m;
  t[11] !== a || t[12] !== r || t[13] !== d
    ? ((m = d && (0, X.jsx)(K, { bucket: r.secondary ?? null, compact: a })),
      (t[11] = a),
      (t[12] = r),
      (t[13] = d),
      (t[14] = m))
  ...
  return (
    t[15] !== f || t[16] !== p || t[17] !== m
      ? ((g = (0, X.jsxs)(X.Fragment, { children: [f, p, m] })),
        (t[15] = f),
        (t[16] = p),
        (t[17] = m),
        (t[18] = g))
...
function K(e) {
  ...
  if (t[0] !== n.resetsAt) {
    ...
    ((i = e == null ? null : C(e)), (t[0] = n.resetsAt), (t[1] = i));
  } else i = t[1];
  let a = i,
    o,
    s,
  ...
  if (t[2] !== n.usedPercent || t[3] !== n.windowDurationMins || t[4] !== r) {
    let e = O(n.usedPercent ?? 0),
      i = r && `flex min-w-0 items-center gap-1`,
      a;
    t[9] === i
      ? (a = t[10])
      : ((a = h(`text-token-foreground font-medium`, i)), (t[9] = i), (t[10] = a));
    let u = r && `shrink-0`,
      d;
    t[11] === u ? (d = t[12]) : ((d = h(u)), (t[11] = u), (t[12] = d));
    let f = n.windowDurationMins ?? null,
      p;
    t[13] === f ? (p = t[14]) : ((p = (0, X.jsx)(z, { minutes: f })), (t[13] = f), (t[14] = p));
    let m;
    (t[15] !== p || t[16] !== d
      ? ((m = (0, X.jsx)(`span`, { className: d, children: p })),
        (t[15] = p),
        (t[16] = d),
        (t[17] = m))
      : (m = t[17]),
      t[18] !== m || t[19] !== a
        ? ((l = (0, X.jsx)(`span`, { className: a, children: m })),
          (t[18] = m),
          (t[19] = a),
          (t[20] = l))
        : (l = t[20]));
    ...
    (t[21] === g
      ? (c = t[22])
      : ((c = h(`text-token-description-foreground flex gap-1 text-end`, g)),
        (t[21] = g),
        (t[22] = c)),
      (o = `shrink-0`),
      (s = S(e)),
  ...
  let u;
  t[23] !== o || t[24] !== s
    ? ((u = (0, X.jsx)(`span`, { className: o, children: s })),
      (t[23] = o),
      (t[24] = s),
      (t[25] = u))
    : (u = t[25]);
  ...
  t[26] === a
    ...
    : ((d =
        ...
        (0, X.jsxs)(X.Fragment, {
          children: [
            (0, X.jsx)(`span`, { className: `shrink-0`, children: (0, X.jsx)(M, {}) }),
            (0, X.jsx)(`span`, {
              title: a,
              className: h(
  ...
  t[28] !== c || t[29] !== u || t[30] !== d
    ? ((f = (0, X.jsxs)(`span`, { className: c, children: [u, d] })),
      (t[28] = c),
      (t[29] = u),
      (t[30] = d),
      (t[31] = f))
  ...
  return (
    t[32] !== l || t[33] !== f
      ? ((p = (0, X.jsxs)(X.Fragment, { children: [l, f] })), (t[32] = l), (t[33] = f), (t[34] = p))
      : (p = t[34]),
    p
  );
}
...
function J(e) {
  ...
  if (u != null) {
    ...
    return (
      t[1] !== i || t[2] !== u
        ? ((r = (0, X.jsx)(b.Item, { className: i, onClick: u, children: e })),
          (t[1] = i),
          (t[2] = u),
          (t[3] = r))
        : (r = t[3]),
  ...
  t[4] === d
    ? (f = t[5])
    : ((f = (0, X.jsx)(m, { className: Z, href: $, PrimaryIcon: d })), (t[4] = d), (t[5] = f));
  let p = f,
    h;
  t[6] === o
    ? (h = t[7])
    : ((h = (e) => {
        (!c(e) && (o?.(e), e.defaultPrevented)) ||
          a({ event: e, href: $, initiator: `open_in_browser_bridge` });
      }),
      (t[6] = o),
      (t[7] = h));
  let g = h;
  switch (r) {
    ...
    case `finserv`: {
      ...
      return (
        t[24] === i
          ? (r = t[25])
          : ((r = (0, X.jsx)(b.Item, { className: i, allowWrap: !0, children: e })),
            (t[24] = i),
            (t[25] = r)),
        r
      );
...
var Y,
  ...
  ee = e(() => {
    ((Y = o()),
      ...
      H(),
      (X = y()),
      (Z = `icon-xs shrink-0 opacity-75 group-focus:opacity-100 group-hover:opacity-100`),
      (Q = `https://help.openai.com/en/articles/11369540-using-codex-with-your-chatgpt-plan#h_8dd84c836b`),
      ($ = `https://openai.com/chatgpt/pricing`));
  });
export { M as a, R as i, ee as n, F as o, L as r, U as t };
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~hotkey-window-thread-page~thread-app-shell-ch~ecjwgenq.js.map
