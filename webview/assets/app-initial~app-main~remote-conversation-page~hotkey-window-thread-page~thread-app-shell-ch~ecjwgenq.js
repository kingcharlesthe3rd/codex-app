...
function M(e) {
  ...
  return (
    t[3] === r
      ? (a = t[4])
      : ((a = (0, P.jsx)(`span`, { "aria-hidden": !0, className: r, children: i })),
        (t[3] = r),
        (t[4] = a)),
    a
  );
...
function I(e) {
  let t = (0, L.c)(6),
    ...
    a;
  t[0] !== i || t[1] !== n || t[2] !== r
    ? ((a = T({ intl: i, minutes: n, variant: r })), (t[0] = i), (t[1] = n), (t[2] = r), (t[3] = a))
    : (a = t[3]);
  let o;
  return (
    t[4] === a
...
function B(e) {
  ...
  t[23] !== O || t[24] !== P || t[25] !== B || t[26] !== R || t[27] !== z
    ? ((U = (0, q.jsx)(O, { LeftIcon: R, RightIcon: z, tooltipSide: P, children: B })),
      (t[23] = O),
      (t[24] = P),
      (t[25] = B),
      (t[26] = R),
    ...
    ? ((W = (0, q.jsx)(`div`, {
        ...
        children: w
          ? (0, q.jsx)(f.Item, {
              LeftIcon: r,
              className: d(
                M && `pl-[calc(var(--padding-row-x)+1.25rem)] pr-[var(--padding-row-x)]`,
              ),
              disabled: !0,
              children: (0, q.jsx)(y, {
                ...
                T &&
                  (0, q.jsx)(f.Item, {
                    ...
                    children: (0, q.jsx)(`span`, {
                      className: d(
                        M ? `text-token-foreground` : `text-token-description-foreground`,
                      ),
                      children: (0, q.jsx)(y, {
...
function U(e) {
  ...
  if (t[2] !== n.usedPercent || t[3] !== n.windowDurationMins || t[4] !== r) {
    ...
    t[9] === i
      ? (a = t[10])
      : ((a = d(`text-token-foreground font-medium`, i)), (t[9] = i), (t[10] = a));
    let u = r && `shrink-0`,
      f;
    t[11] === u ? (f = t[12]) : ((f = d(u)), (t[11] = u), (t[12] = f));
    let p = n.windowDurationMins ?? null,
      m;
    t[13] === p ? (m = t[14]) : ((m = (0, q.jsx)(I, { minutes: p })), (t[13] = p), (t[14] = m));
    let h;
    (t[15] !== m || t[16] !== f
  ...
  t[26] === a
    ...
    : ((f =
        ...
        (0, q.jsxs)(q.Fragment, {
          children: [
            (0, q.jsx)(`span`, { className: `shrink-0`, children: (0, q.jsx)(M, {}) }),
            (0, q.jsx)(`span`, {
              title: a,
              className: d(
  ...
  return (
    t[32] !== l || t[33] !== p
      ? ((m = (0, q.jsxs)(q.Fragment, { children: [l, p] })), (t[32] = l), (t[33] = p), (t[34] = m))
      : (m = t[34]),
    m
  );
}
...
function G(e) {
  ...
  t[4] === l
    ? (d = t[5])
    : ((d = (0, q.jsx)(o, { className: J, href: X, PrimaryIcon: l })), (t[4] = l), (t[5] = d));
  let p = d,
    m;
  t[6] === i
    ? (m = t[7])
  ...
  switch (n) {
    ...
    case `finserv`: {
      ...
      return (
        t[24] === r
          ? (n = t[25])
          : ((n = (0, q.jsx)(f.Item, { className: r, allowWrap: !0, children: e })),
            (t[24] = r),
            (t[25] = n)),
        n
      );
