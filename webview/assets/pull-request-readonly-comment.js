...
import { ca as t, la as n, sa as r } from "./app-server-manager-signals.js";
...
function ie(e) {
  let n = (0, A.c)(57),
    ...
    V,
    H;
  if (n[0] !== a || n[1] !== i || n[2] !== c || n[3] !== v || n[4] !== R || n[5] !== F) {
    let { authorLogin: e, text: t } = v == null ? { authorLogin: null, text: c ?? `` } : r(v);
    ((B = i ?? v?.authorLogin ?? e),
      (V = v == null ? (c ?? ``) : t),
      (z =
        B ??
  ...
  if (ee) {
    ...
    n[10] === v?.position.path
      ? (e = n[11])
      : ((e = v?.position.path.split(`/`).at(-1) ?? null), (n[10] = v?.position.path), (n[11] = e));
    let t = e,
      r;
    ...
    let i = r,
      a;
    n[16] === y ? (a = n[17]) : ((a = o(`flex min-w-0 gap-2 py-1`, y)), (n[16] = y), (n[17] = a));
    let s;
    n[18] === U
      ? (s = n[19])
  ...
  let fe = v == null ? [] : t(v).slice(1),
    ...
    G;
  n[36] !== v || n[37] !== P
    ? ((G = P && v != null ? ce(v) : null), (n[36] = v), (n[37] = P), (n[38] = G))
    : (G = n[38]);
  let K = G,
    me = B != null || b != null,
    q = ue === `card`,
    J;
  n[39] === U ? (J = n[40]) : ((J = (0, j.jsx)(M, { children: U })), (n[39] = U), (n[40] = J));
  let he = J,
    ge = I
      ? null
      : (0, j.jsxs)(`div`, {
  ...
  let X = Y,
    Z;
  n[44] !== q || n[45] !== X || n[46] !== b || n[47] !== I || n[48] !== K || n[49] !== L
    ? ((Z =
        K != null || b != null || q
          ? (0, j.jsxs)(`div`, {
