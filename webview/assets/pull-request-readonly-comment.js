...
import { Ma as t, Na as n, ja as r } from "./app-server-manager-signals.js";
import { n as i, t as a } from "./jsx-runtime.js";
import { t as o } from "./clsx.js";
import { lt as s } from "./vscode-api.js";
...
import { n as g } from "./markdown-2.js";
import { t as _ } from "./github-details.js";
var v = s(),
  y = a();
function b(e) {
  let t = (0, v.c)(29),
  ...
  let C = S,
    ...
    T;
  t[5] !== a || t[6] !== w ? ((T = o(w, a)), (t[5] = a), (t[6] = w), (t[7] = T)) : (T = t[7]);
  let E;
  t[8] !== s || t[9] !== b || t[10] !== _
    ? ((E = o(
        `flex flex-wrap items-center justify-between gap-3`,
        _ ? o(`px-3 py-2.5`, (b || s != null) && `border-b border-token-border/24`) : `mb-3`,
      )),
      (t[8] = s),
      (t[9] = b),
      (t[10] = _),
  ...
  let D;
  t[12] !== f || t[13] !== C
    ? ((D = f == null ? C : (0, y.jsx)(d, { delayDuration: 250, tooltipContent: f, children: C })),
      (t[12] = f),
      (t[13] = C),
      (t[14] = D))
    : (D = t[14]);
  let O;
  t[15] !== u || t[16] !== E || t[17] !== D
    ? ((O = (0, y.jsxs)(`div`, { className: E, children: [D, u] })),
      (t[15] = u),
      (t[16] = E),
      (t[17] = D),
      (t[18] = O))
  ...
  let j;
  return (
    t[23] !== p || t[24] !== O || t[25] !== k || t[26] !== A || t[27] !== T
      ? ((j = (0, y.jsxs)(`div`, { className: T, onPointerDownCapture: p, children: [O, k, A] })),
        (t[23] = p),
        (t[24] = O),
        (t[25] = k),
        (t[26] = A),
...
function C(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, y.jsx)(`span`, {
        ...
        children: (0, y.jsx)(u, { className: `size-2` }),
      })),
      (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, y.jsxs)(`span`, { className: `relative shrink-0`, children: [n, r] })),
        (t[1] = n),
        (t[2] = i)),
    i
  );
...
function T(e) {
  ...
  if (
    ...
    t[9] !== i.authorAvatarUrl || t[10] !== i.authorLogin
      ? ((e = i.authorAvatarUrl ?? S(i.authorLogin, 32)),
  ...
  t[16] !== d || t[17] !== f || t[18] !== m
    ? ((h = (0, y.jsxs)(`div`, { className: d, children: [f, m] })),
      (t[16] = d),
      (t[17] = f),
      (t[18] = m),
      (t[19] = h))
  ...
  return (
    t[22] !== p || t[23] !== h || t[24] !== _
      ? ((b = (0, y.jsxs)(`div`, { className: p, children: [h, _] })),
        (t[22] = p),
        (t[23] = h),
        (t[24] = _),
        (t[25] = b))
...
function E(e) {
  let n = (0, v.c)(67),
    {
      ...
      createdAt: j,
      defaultCollapsed: ee,
      metadataAccessory: te,
      metadataAccessoryFlush: ne,
      metadataTooltipContent: re,
      onOpenInReview: M,
      replies: ie,
      showDiffLocation: ae,
      url: N,
    ...
    ue = ie === void 0 ? [] : ie,
    P = ae === void 0 ? !1 : ae,
    de = oe === void 0 ? `plain` : oe,
    F = c(),
    [I, L] = (0, w.useState)(ce),
    [R, fe] = (0, w.useState)(null),
    z,
    B,
    V,
    H;
  if (n[0] !== a || n[1] !== i || n[2] !== s || n[3] !== T || n[4] !== R || n[5] !== F) {
    let { authorLogin: e, text: t } = T == null ? { authorLogin: null, text: s ?? `` } : r(T);
    ((B = i ?? T?.authorLogin ?? e),
      (V = T == null ? (s ?? ``) : t),
      (z =
        B ??
    ...
    let o = a ?? T?.authorAvatarUrl ?? (B == null ? null : S(B, 48)),
      c = o != null && o !== R,
      l = F.formatMessage(
        {
          id: `pullRequestsPage.detail.commentAuthorAvatarAlt`,
  ...
  if (se) {
    let e;
    n[10] === T?.position.path
      ? (e = n[11])
      : ((e = T?.position.path.split(`/`).at(-1) ?? null), (n[10] = T?.position.path), (n[11] = e));
    let t = e,
      r = M != null || N != null,
      i;
    n[12] !== j || n[13] !== t || n[14] !== r
      ? ((i =
          t != null || j != null
            ? (0, y.jsxs)(y.Fragment, {
                children: [
                  ...
                  j == null
                    ...
                    : (0, y.jsx)(`span`, {
                        ...
                        children: (0, y.jsx)(h, { dateString: j }),
                      }),
                ],
              })
            : null),
    ...
    let c;
    n[30] === E ? (c = n[31]) : ((c = o(`flex min-w-0 gap-2 py-1`, E)), (n[30] = E), (n[31] = c));
    let l;
    n[32] === U
      ? (l = n[33])
      : ((l = (0, y.jsx)(`span`, { className: `shrink-0`, children: U })),
        (n[32] = U),
        (n[33] = l));
    let u;
    n[34] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((u = {
          ...
          p(e) {
            let { children: t } = e;
            return (0, y.jsx)(`span`, { className: `block leading-5`, children: t });
          },
          strong(e) {
            let { children: t } = e;
            return (0, y.jsx)(y.Fragment, { children: t });
          },
        }),
        (n[34] = u))
      : (u = n[34]);
    let d;
    n[35] === V ? (d = n[36]) : ((d = _(V)), (n[35] = V), (n[36] = d));
    let f;
    n[37] === d
      ? (f = n[38])
      : ((f = (0, y.jsx)(g, {
  ...
  let pe = T == null ? [] : t(T).slice(1),
    me = ue.map(k),
    W = [...pe, ...me],
    G;
  n[46] !== T || n[47] !== P
    ? ((G = P && T != null ? A(T) : null), (n[46] = T), (n[47] = P), (n[48] = G))
    : (G = n[48]);
  let K = G,
    he = B != null || j != null,
    q = de === `card`,
    J;
  n[49] === U ? (J = n[50]) : ((J = (0, y.jsx)(C, { children: U })), (n[49] = U), (n[50] = J));
  let ge = J,
    _e = I
      ? null
      : (0, y.jsxs)(`div`, {
  ...
  let X = Y,
    Z;
  n[54] !== q || n[55] !== X || n[56] !== j || n[57] !== I || n[58] !== K || n[59] !== L
    ? ((Z =
        K != null || j != null || q
          ? (0, y.jsxs)(`div`, {
                ...
                q
                  ? (0, y.jsx)(d, {
                      ...
                      children: (0, y.jsx)(f, {
                        ...
                        uniform: !0,
                        onClick: (e) => {
                          (e.preventDefault(), e.stopPropagation(), L(D));
                        },
                        children: (0, y.jsx)(m, {
                          className: I
        ...
        N == null
          ...
          : (0, y.jsx)(d, {
              ...
              children: (0, y.jsx)(`a`, {
                ...
                rel: `noreferrer`,
                target: `_blank`,
                children: (0, y.jsx)(p, { className: `icon-xs` }),
              }),
            })),
      (n[61] = F),
      (n[62] = N),
  ...
  return (
    n[64] !== z || n[65] !== ye
      ? (($ = (0, y.jsxs)(y.Fragment, { children: [z, ye] })),
        (n[64] = z),
        (n[65] = ye),
        (n[66] = $))
      : ($ = n[66]),
...
export { b as i, C as n, x as r, E as t };
