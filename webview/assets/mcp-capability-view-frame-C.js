...
import { Ea as f, Ts as p } from "./app-server-manager-signals.js";
import { f as m, h } from "./vscode-api.js";
...
import { i as z, l as ee, s as B } from "./lib.js";
import { l as V } from "./persisted-signal.js";
...
import { r as ce, t as le } from "./dropdown.js";
import { d as ue, i as de, l as fe, n as pe, r as W, u as me } from "./dialog-layout-B.js";
import { t as G } from "./apps-2.js";
import { d as he, f as ge, g as _e, h as ve, l as ye, p as be } from "./mcp-capability-signals.js";
...
import { k as Ee } from "./composer-view-state.js";
import { n as De } from "./projectless-thread.js";
import { n as Oe, u as ke } from "./app-shell-tab-controller.js";
import { u as Ae } from "./sidebar-project-group-signals.js";
import { t as je } from "./build-worktree-label-from-input.js";
import { t as Me } from "./read-service-tier-for-request.js";
import { i as Ne } from "./pending-worktree-store.js";
import { t as Pe } from "./checkbox.js";
import { t as Fe } from "./macbook.js";
import { t as Ie } from "./worktree.js";
import { n as Le, t as Re } from "./project-dropdown-options.js";
import { n as ze, t as Be } from "./mcp-capability-client.js";
import { n as Ve, t as He } from "./thread-right-panel-state.js";
import { t as Ue } from "./back-forward-navigation-buttons.js";
import { t as We } from "./alert.js";
import {
  a as Ge,
  c as Ke,
  i as qe,
...
function tt(e, t) {
  let n = nt(t);
  e.get(Oe.tabs$).some((e) => e.tabId === n) &&
    (Oe.closeTab(e, n), e.get(Oe.tabs$).length === 0 && He(e));
}
function nt(e) {
  return `${ke.MCP_APP}:${e}`;
}
var rt = e(g(), 1),
  it = { intrinsicHeight: null, isFullScreen: !1, isInlineExpanded: !1, sandboxError: null },
  at = a(Te, () => new Map()),
  ot = a(Te, () => new Map()),
  st = a(Te, () => new Set()),
  ct = i(Te, ({ get: e }) => {
  ...
  lt = o(Te, (e, { get: t }) => t(at).get(e) ?? null),
  ut = o(Te, (e, { get: t }) => t(ot).get(e) ?? it),
  dt = o(Te, (e, { get: t }) => t(st).has(e));
function ft(e) {
  return e;
}
function pt(e, t, n) {
...
function gt(e, t) {
  ...
  (e.set(at, (r) => {
    let i = e.get(ot),
      ...
      c = r;
    (a == null || !(0, rt.default)(a, s)) && ((c = new Map(r)), c.set(t.mcpAppId, s));
    let l = xt({
      activeSidePanelTabId: e.get(Oe.activeTab$)?.tabId ?? null,
      frameStates: i,
      registration: t,
      registrations: c,
    });
...
function _t(e, t, n) {
  ...
  for (let r of n.values())
    if (
      ...
      Ct(r.sidePanelFrameContent ?? r.inlineFrameContent, t)
    )
      return r.mcpAppId;
  return t.mcpAppId;
}
function vt(e, t, n) {
  (n.isFullScreen === !0 && bt(e, t),
    e.set(ot, (e) => {
      let r = e.get(t) ?? it,
        i = { ...r, ...n };
      if (
...
function xt({ activeSidePanelTabId: e, frameStates: t, registration: n, registrations: r }) {
  for (let i of r.values())
    if (
      e === nt(i.mcpAppId) &&
      t.get(i.mcpAppId)?.isFullScreen === !0 &&
      Ct(i.sidePanelFrameContent ?? i.inlineFrameContent, n)
    )
      return i;
  return null;
}
function St({ hostedInThreadScrollLayout: e, inlineFrameContainer: t, mcpAppId: n, ...r }) {
  return r;
}
function Ct(e, t) {
  return (
    ...
    e.server === t.server &&
    (0, rt.default)(e.mcpAppScope, t.mcpAppScope) &&
    wt(e.sandboxOriginScope, t.sandboxOriginScope)
  );
}
function wt(e, t) {
...
function Et({ server: e, tool: t }) {
  return Y(e) ? Xe(t) : null;
}
function Dt({ mcpAppScope: e, server: t, tools: n }) {
  return Y(t) ? Xe(n.find((t) => t.name === e.originTool) ?? null) : null;
}
function Ot({ connectorId: e, server: t, toolName: n, tools: r }) {
  let i = Mt({ server: t, toolName: n, tools: r });
  if ((Nt({ connectorId: e, server: t, tool: i, toolName: n }), Pt(i)))
    throw Error(`MCP app cannot call tools that accept file parameters: ${i?.name ?? n}`);
  return { name: i?.name ?? n, tool: i };
}
function kt({ connectorId: e, server: t, tools: n }) {
  let r = Y(t) ? n.filter((t) => Xe(t) === e) : n;
  if (Y(t) && e == null) throw Error(`MCP app requests require a trusted connector scope`);
  return r.filter((e) => !Pt(e));
}
function At({ mcpAppScope: e, server: t, uri: n }) {
  if (Y(t) && (e.originResourceUri == null || n !== e.originResourceUri))
    throw Error(`MCP app cannot read resource outside its widget scope: ${n}`);
}
function jt({ connectorId: e, instanceFallbackId: t, server: n }) {
  return Y(n)
...
function Nt({ connectorId: e, server: t, tool: n, toolName: r }) {
  if (!Y(t)) return;
  let i = Xe(n);
...
var zt = `CALL`,
  ...
  Wt = 3e4,
  Gt = _,
  Kt = L({ status: N(2), type: N(`environment_status`) }).passthrough();
async function qt({
  hostApiHandlers: e,
  origin: t,
  sandboxId: n,
      ...
      let c,
        ...
        u = (r) => {
          ...
          if (
            ...
            return;
          let a = i.portNames;
          if (!v(a) || r.ports.length !== a.length + 1) return;
          let s = Jt(a, r.ports);
          if (s == null) return;
...
function Xt(e) {
  return Yt(e) ? typeof e.postMessage == `function` && typeof e.start == `function` : !1;
}
function Zt(e, t) {
  return {
    ...
    runWidgetCode: rn(e.runWidgetCode, t),
...
var an = e(R(), 1),
  ...
  sn = O(),
  cn = P(j(), D()),
  ln = L({ text: j(), type: N(`text`) }).strip(),
  un = L({ data: j(), mimeType: j(), type: N(`image`) }).strip(),
  dn = L({ type: y([`audio`, `image`, `resource`, `resource_link`, `text`]) }).passthrough(),
  fn = j(),
  pn = L({ mode: y([`inline`, `fullscreen`]) }),
  mn = L({ canGoBack: k(), canGoForward: k() }).passthrough(),
  hn = L({ prompt: j().trim().min(1) }).strip(),
  gn = L({ method: j(), params: P(j(), D()).optional() }).strip(),
  _n = L({ blob: E(Blob), name: j().trim().min(1) }).strip(),
  vn = I({ [ge]: ve.optional(), progressToken: he.optional() }),
  yn = L({
    name: j().min(1),
    arguments: P(j(), sn).optional(),
    _meta: vn.optional(),
  }).passthrough(),
  bn = L({ uri: j().min(1) }).passthrough(),
  xn = L({ code: M().optional(), message: j().min(1) }).passthrough(),
  Sn = M().finite().positive(),
  Cn = L({ href: j().refine(br) }),
  wn = P(j(), sn),
  Tn = L({ content: x(D()).optional() }).passthrough(),
  En = L({ content: x(dn), structuredContent: cn.optional() }).strict(),
...
function Ln(e) {
  let t = (0, K.c)(39),
    ...
    k = l(Oe.tabs$),
    A;
  t[0] === u ? (A = t[1]) : ((A = u == null ? 0 : new Blob([u]).size), (t[0] = u), (t[1] = A));
  let j = A,
    M,
    N;
  t[2] !== n ||
  ...
  return (
    ...
    t[36] !== w
      ? ((F = () => {
        ...
        (I = [n, r, i, T, o, c, P, u, j, d, f, M, p, m, h, g, _, E, v, y, b, x, S, C, w]),
        (t[12] = n),
        (t[13] = r),
        (t[14] = i),
        (t[15] = T),
...
function Rn(e) {
  let t = (0, K.c)(30),
    { error: n, fullSurface: i, heightHint: a, html: o, isLoading: c, mcpAppId: l } = e,
    u = i === void 0 ? !1 : i,
    d = s(Te),
    f = ee(),
    p = r(lt, l),
  ...
  t[0] !== m.intrinsicHeight || t[1] !== a
    ? ((y = yr(m.intrinsicHeight, a)), (t[0] = m.intrinsicHeight), (t[1] = a), (t[2] = y))
    : (y = t[2]);
  let b = y,
    x = n ?? m.sandboxError,
    S,
...
function Vn(e) {
  ...
  let s =
      a.isFullScreen || (!a.isInlineExpanded && i.inlineFrameContainer?.isConnected !== !0 && o)
        ? (i.sidePanelFrameContent ?? i.inlineFrameContent)
        : i.inlineFrameContent,
    c;
  return (
    t[0] !== s || t[1] !== a || t[2] !== i.inlineFrameContainer || t[3] !== i.mcpAppId
      ? ((c = (0, q.jsx)(Hn, {
          ...s,
...
function Hn({
  ...
  let D = s(Te),
    ...
    [W, me] = (0, J.useState)(null),
    [G, he] = (0, J.useState)(Mn),
    [ge, _e] = (0, J.useState)(null),
    [ve, ye] = (0, J.useState)(!1),
    [be, xe] = (0, J.useState)(null),
    [Ce, we] = (0, J.useState)(null),
    De = (0, J.useMemo)(() => rr(x), [x]),
    ke = (0, J.useMemo)(() => ir(S), [S]),
    Ae = (0, J.useMemo)(() => Ke({ toolResult: S }), [S]),
    ...
    Pe = Ge({ locale: O.locale, originScope: g, widgetDomain: w }),
    Fe = (0, J.useMemo)(() => qe({ originScope: g, sourceUrl: Pe }), [Pe, g]),
    ...
    He = (0, J.useEffectEvent)(() => {
      vt(D, o, { sandboxError: Error(`The MCP app sandbox failed to load.`) });
    }),
    Ue = (0, J.useEffectEvent)((e) => {
      let t = Sn.safeParse(e);
      t.success && vt(D, o, { intrinsicHeight: t.data });
    }),
    ...
    Je = (0, J.useEffectEvent)((e) => {
      ...
      t.success && he({ canGoBack: t.data.canGoBack, canGoForward: t.data.canGoForward });
    }),
    ...
    Xe = (0, J.useEffectEvent)((e) => {
      ...
      if (t.success) {
        let e = t.data.mode === `fullscreen`,
          n = t.data.mode;
        return (
          e && (V != null && (V.style.display = `none`), ht(D, o)),
          vt(D, o, { isFullScreen: e }),
          W != null &&
            ge != null &&
            (Q(W.setWidgetView({ displayMode: n, isTombstone: !1, viewParams: ke, widgetId: ge })),
            V != null &&
              Q(
                W.notifyMcpAppsHostContext({
                  hostContext: pr({
                    containerDimensions: hr(V),
                    displayMode: n,
                    locale: O.locale,
                    safeAreaInsets: mr({
                      displayMode: n,
    ...
    Qe = (0, J.useEffectEvent)(() => be),
    K = (e) => {
      let t = tr(e.content);
      j({ id: o, imageAttachments: nr(e.content), text: t, title: b });
    },
    $e = (0, J.useEffectEvent)((e, t) => {
      let n = wn.safeParse(t);
      xe(n.success ? n.data : null);
      let r = En.safeParse(t);
      r.success && K(r.data);
    }),
    it = (0, J.useEffectEvent)((e) => {
      W != null && Q(W.navigate({ delta: e }));
    }),
    at = (0, J.useEffectEvent)(async (t) => {
      let n = hn.safeParse(t);
      if (!n.success) throw $(`Invalid follow-up message`, -32602);
      if (Ce != null) throw $(`A follow-up message is already awaiting confirmation`, on);
      let { prompt: i } = n.data,
      ...
      switch (a.type) {
        case `current-thread`:
          await p(`send-follow-up-message`, {
            conversationId: e,
            prompt: a.prompt,
            serviceTier: await Me(D, r, null),
          });
          return;
        case `new-thread`:
          if (a.executionMode === `worktree`) {
            await k(
              `/worktree-init-v2/${await Qn({ createPendingWorktree: M, hostId: r, prompt: a.prompt, projectRoot: a.projectRoot, scope: D })}`,
            );
            return;
          }
          await k(
            A(await Zn({ hostId: r, prompt: a.prompt, projectRoot: a.projectRoot, scope: D })),
          );
          return;
      }
    }),
      ...
      switch (i) {
        ...
        case `resources/read`: {
          ...
          return ot({ method: i, params: t.data }, async () => {
            lr(() => {
              At({ mcpAppScope: c, server: _, uri: t.data.uri });
            });
            try {
        ...
        case `tools/list`:
          return ot(n.data, async () => {
            let e = cr(await ar({ hostId: r, mcpServerStatuses: Y(_) ? u : void 0, server: _ })),
              t = Dt({ mcpAppScope: c, server: _, tools: e });
            return { tools: lr(() => kt({ connectorId: t, server: _, tools: e })) };
          });
        case `resources/list`:
          return ot(n.data, async () =>
            Y(_)
              ? { resources: [] }
              : { resources: (await ar({ hostId: r, server: _ })).resources },
          );
        case `resources/templates/list`:
          return ot(n.data, async () =>
            Y(_)
              ? { resourceTemplates: [] }
              : { resourceTemplates: (await ar({ hostId: r, server: _ })).resourceTemplates },
          );
        case `prompts/list`:
  ...
  let ut = (0, J.useEffectEvent)((e) => {
      et(D, {
        activate: !D.get(Oe.tabs$).some((e) => e.tabId === nt(o)),
        icon: v,
        mcpAppId: o,
        onExitFullScreen: e,
    ...
    dt = (0, J.useEffectEvent)(() => {
      R.current || (ht(D, o), vt(D, o, { isFullScreen: !1 }));
    });
  ((0, J.useLayoutEffect)(() => {
    if (L) {
      ut(dt);
    ...
    tt(D, o);
  }, [L, o, D, v?.alt, v?.logoDarkUrl, v?.logoUrl, y]),
    (0, J.useLayoutEffect)(() => {
      if (U == null || V == null || !ce) return;
      (vt(D, o, { sandboxError: null }), ye(!1), he(Mn), (z.current = null));
      let e = Ie();
      if (e == null) {
    ...
    (0, J.useEffect)(() => {
      if (!ve || W == null || ge == null) return;
      let e = {
        toolInput: De,
        toolOutput: ke,
        toolResponseMetadata: Ae,
        toolResult: { content: S.content, structuredContent: S.structuredContent ?? void 0 },
      };
      if ((0, rt.default)(z.current, e)) return;
      z.current = e;
      let t = Qe();
      (Q(
        W.setWidgetData({
        ...
        De != null && Q(W.notifyMcpAppsToolInput({ arguments: De })),
        Q(
          W.notifyMcpAppsToolResult({
            content: S.content,
            ...(S.structuredContent == null ? {} : { structuredContent: S.structuredContent }),
            ...(Ae == null ? {} : { _meta: Ae }),
          }),
        ));
    }, [ve, W, De, ke, Ae, S, ge]),
    (0, J.useEffect)(() => {
      if (V == null || W == null || ge == null || (L && Le == null)) return;
      let e = null,
        ...
        n = () => {
          ...
          (Q(
            ...
            Q(W.setWidgetView({ displayMode: t, isTombstone: !1, viewParams: ke, widgetId: ge })),
            Q(
              W.notifyMcpAppsHostContext({
                hostContext: pr({
    ...
    }, [V, O.locale, I, L, G.canGoBack, G.canGoForward, F, W, Le, ke, ge]));
  let ft = (e) => {
      let t = Ce;
    ...
    pt = () => {
      let e = Ce;
      e != null && (we(null), e.reject($(`Follow-up message was not confirmed`, on)));
    },
    mt = U?.tagName === `WEBVIEW`,
    gt = V != null && W != null && mt && Rt(),
    _t = G.canGoBack || G.canGoForward,
    yt = W != null && _t,
    bt = yt && !L,
    xt = yt && L && N?.tabId === nt(o);
  return (0, q.jsxs)(q.Fragment, {
    children: [
      (0, q.jsx)(Gn, { confirmation: Ce, onCancel: pt, onConfirm: ft }),
      xt
...
function Gn(e) {
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== s
      ? ((c = (0, q.jsx)(fe, { open: a, onOpenChange: o, size: `wide`, children: s })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s),
        (t[9] = c))
...
function Kn(e) {
  ...
  if (t[2] !== p || t[3] !== h || t[4] !== s) {
    let e = F(`~`);
    ((b = Re({ workspaceGroups: s, roots: [], formatRootLabel: Yn })),
      (x = Re({ workspaceGroups: s?.filter(Jn), roots: [], formatRootLabel: qn })));
  ...
  t[44] === r
    ? (z = t[45])
    : ((z = (0, q.jsx)(ie, { color: `secondary`, className: `ml-auto`, onClick: r, children: R })),
      (t[44] = r),
      (t[45] = z));
  let V = !w,
    te;
  ...
  t[47] === V
    ...
    : ((ne = (0, q.jsx)(ie, { type: `submit`, disabled: V, children: te })),
      ...
      (t[48] = ne));
  let H;
  t[49] !== L || t[50] !== z || t[51] !== ne
    ? ((H = (0, q.jsxs)(W, { className: `justify-start gap-2`, children: [L, z, ne] })),
      (t[49] = L),
      (t[50] = z),
      (t[51] = ne),
      (t[52] = H))
...
function Xn(e) {
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)(B, { ...Fn.workLocally })), (t[12] = g))
    : (g = t[12]);
  let _;
  t[13] !== m || t[14] !== h
    ? ((_ = (0, q.jsx)(ce.Item, { LeftIcon: Fe, RightIcon: m, onSelect: h, children: g })),
      (t[13] = m),
      (t[14] = h),
      (t[15] = _))
    : (_ = t[15]);
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, q.jsx)(B, { ...Fn.newWorktree })), (t[18] = S))
    : (S = t[18]);
  let C;
...
async function Zn({ hostId: e, prompt: t, projectRoot: n, scope: r }) {
  ...
  if (a.cwd == null) throw $(`Missing project root`, on);
  if (i && a.projectlessOutputDirectory == null)
    throw $(`Missing projectless thread output directory`, on);
  let { config: o } = await p(`read-config-for-host`, { hostId: e, includeLayers: !1, cwd: a.cwd }),
    s = b(V(`agent-mode-by-host-id`, {})[e] ?? `auto`, a.workspaceRoots, o);
...
async function Qn({ createPendingWorktree: e, hostId: t, prompt: n, projectRoot: r, scope: i }) {
  if (r === `~`) throw $(`Missing project root`, on);
...
function ir(e) {
  let t = cn.safeParse(e.structuredContent);
...
async function ar({ hostId: e, mcpServerStatuses: t, server: n }) {
  ...
  if (i == null) throw $(`MCP server not found: ${n}`, on);
  return i;
}
async function or({
  conversationId: e,
...
async function sr({ hostId: e, mcpAppScope: t, mcpServerStatuses: n, server: r, toolName: i }) {
  let a = n?.data.find(({ name: e }) => e === r) ?? (await ar({ hostId: e, server: r })),
    o = cr(a),
    s = Dt({ mcpAppScope: t, server: r, tools: o });
  return { ...lr(() => Ot({ connectorId: s, server: r, toolName: i, tools: o })), serverStatus: a };
}
function cr(e) {
...
function fr(e, t) {
  ...
  return n.success
    ? $(n.data.message, n.data.code ?? on, e)
...
var xr = O(),
  ...
  Tr = c(
    ...
    ({ threadId: e, view: t }, { scope: n }) => ({
      ...
      queryFn: () => ze(n, t.hostId, t.server, t.resourceUri, e),
      staleTime: 0,
    }),
    { key: Dr },
  ),
  Er = c(
    ...
    ({ toolArguments: e, threadId: t, view: n }, { scope: r }) => ({
      ...
      queryFn: async () => Be(r, n.hostId, n.server, n.tool.name, e, t),
      staleTime: 0,
    }),
    { key: Or },
  );
function Dr({ threadId: e, view: t }) {
  return JSON.stringify([t.hostId, t.resourceUri, t.server, e, t.tool.name]);
}
function Or({ threadId: e, toolArguments: t, view: n }) {
  return JSON.stringify([n.hostId, n.resourceUri, n.server, e, n.tool.name, t]);
}
var kr = {};
function Ar(e) {
  let t = (0, K.c)(81),
    { className: n, instanceId: i, readHostResource: a, toolArguments: o, view: c } = e,
    l = o === void 0 ? kr : o,
    d = s(u),
    f = s(Te),
    ...
    m;
  t[0] !== p || t[1] !== f.value
    ? ((m = p ? we(f.value) : null), (t[0] = p), (t[1] = f.value), (t[2] = m))
    : (m = t[2]);
  let h = m,
    g = h ?? void 0,
    _;
  t[3] !== g || t[4] !== c
    ? ((_ = { threadId: g, view: c }), (t[3] = g), (t[4] = c), (t[5] = _))
    : (_ = t[5]);
  let { data: v, error: y, isLoading: b } = r(Tr, _),
    x = h ?? void 0,
    C;
  t[6] !== x || t[7] !== l || t[8] !== c
    ? ((C = { threadId: x, toolArguments: l, view: c }),
      (t[6] = x),
      (t[7] = l),
      (t[8] = c),
      (t[9] = C))
    : (C = t[9]);
  let { data: w, error: T, isLoading: E } = r(Er, C),
    D = Ye(v);
  se(`2957382457`);
  let O = Je({
      isDilEnabled: !1,
    ...
    A;
  t[10] !== c.server || t[11] !== c.tool
    ? ((A = Et({ server: c.server, tool: c.tool })),
      (t[10] = c.server),
      (t[11] = c.tool),
      (t[12] = A))
    : (A = t[12]);
  ...
  t[20] !== c.serverTools
    ? ((M = async (e) => {
        ...
        switch (t.method) {
          case `tools/call`: {
            let e = Cr.parse(t.params),
              n = Ot({ connectorId: j, server: c.server, toolName: e.name, tools: c.serverTools });
            return Be(d, c.hostId, c.server, n.name, Sr.parse(e.arguments ?? {}), h ?? void 0);
          }
          case `resources/read`: {
            ...
            return n == null
              ? (At({
                  mcpAppScope: { originResourceUri: c.resourceUri },
                  server: c.server,
                  uri: e.uri,
                }),
                ze(d, c.hostId, c.server, e.uri, h ?? void 0))
              : { contents: [{ ...n, uri: e.uri }] };
          }
          case `tools/list`:
            return { tools: kt({ connectorId: j, server: c.server, tools: c.serverTools }) };
          case `resources/list`:
            return { resources: [] };
          case `resources/templates/list`:
  ...
  if (
    ...
    let e;
    t[31] === i ? (e = t[32]) : ((e = i == null ? [] : [i]), (t[31] = i), (t[32] = e));
    let n;
    (t[33] !== e || t[34] !== c.hostId || t[35] !== c.server || t[36] !== c.tool.name
      ? ((n = [`openai-mcp-capability`, c.hostId, c.server, c.tool.name, ...e]),
        (t[33] = e),
        (t[34] = c.hostId),
        (t[35] = c.server),
        (t[36] = c.tool.name),
      ...
      (F = ft(n.join(`:`))),
      (P = S(h ?? F)),
      (I = jt({ connectorId: j, instanceFallbackId: F, server: c.server })),
      (t[22] = i),
      (t[23] = j),
      (t[24] = h),
      (t[25] = c.hostId),
      ...
      (t[29] = F),
      (t[30] = I));
  } else ((P = t[28]), (F = t[29]), (I = t[30]));
  let L = I,
    R;
  t[38] === n ? (R = t[39]) : ((R = te(`h-full min-h-0`, n)), (t[38] = n), (t[39] = R));
  let z;
  t[40] === F
    ? (z = t[41])
    : ((z = (0, q.jsx)(In, { isInlineExpanded: !0, mcpAppId: F })), (t[40] = F), (t[41] = z));
  let ee = k?.csp ?? null,
    B = y ?? T,
    V = k?.html ?? null,
    ne = b || E,
    H;
  t[42] !== c.resourceUri || t[43] !== c.tool.name
    ? ((H = { originResourceUri: c.resourceUri, originTool: c.tool.name }),
      (t[42] = c.resourceUri),
      (t[43] = c.tool.name),
      (t[44] = H))
    : (H = t[44]);
  let re = k?.prefersBorder ?? !1,
    ie = w ?? null,
    ae = k?.widgetDomain ?? null,
    oe;
  t[45] !== P ||
  t[46] !== F ||
  t[47] !== N ||
  ...
  t[60] !== c.title
    ? ((oe = (0, q.jsx)(Ln, {
        ...
        sandboxOriginScope: L,
        server: c.server,
        sidePanelIcon: null,
        sidePanelTitle: c.title,
        title: c.title,
        toolArguments: l,
        toolResult: ie,
        widgetDomain: ae,
  ...
  let le;
  t[72] !== p || t[73] !== F
    ? ((le = p ? null : (0, q.jsx)(zn, { mcpAppId: F })), (t[72] = p), (t[73] = F), (t[74] = le))
    : (le = t[74]);
  let ue;
  return (
    t[75] !== R || t[76] !== z || t[77] !== oe || t[78] !== ce || t[79] !== le
      ? ((ue = (0, q.jsxs)(`div`, {
