...
import { Zi as t, ea as n, ia as r, na as i } from "./src-1.js";
import { a } from "./statsig.js";
var o = e(),
  s = `1852350085`,
  c = i().refine((e) => e.trim().length > 0),
  l = t({ skill_markdown_by_id: n(i(), r()).optional() }).catch({ skill_markdown_by_id: {} });
function u() {
  let e = (0, o.c)(2),
    { value: t } = a(s),
    n;
