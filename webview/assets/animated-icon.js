...
import { c as ie, s as y } from "./app-initial~app-main~new-thread-panel-page~onboarding-page.js";
import {
  a as b,
  o as ae,
...
function se({ animation: e, animationData: t, fallback: n }) {
  ...
  return (e && ((r.animationJson = C[e]()), (r.SvgFallback = ce[e])), r);
}
var C,
  ce,
  w = e(() => {
    (h(),
      ...
      (C = {
        ...
        automation: () =>
          i(
            () => import(`./automation-CpA-NE6g.js`).then((e) => e.default),
            __vite__mapDeps([2, 1]),
            import.meta.url,
          ),
        browsing: () =>
        ...
        "run-command": () =>
          i(
            () => import(`./run_command_animation-B.js`).then((e) => e.default),
...
function le(e) {
  ...
  if (A === void 0) {
    ...
    ((e.width = 1), (e.height = 1), (A = e.getContext(`2d`, { willReadFrequently: !0 })));
  }
  return A
    ? (A.clearRect(0, 0, 1, 1),
      (A.fillStyle = t),
...
function de(e) {
  return (
    ...
    N ||
      ...
      N.observe(document.documentElement, { attributes: !0, attributeFilter: [`class`, `style`] })),
    e(),
    () => {
...
function pe(e) {
  let t = (0, he.c)(71),
    ...
    x;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((x = se({ animation: n, animationData: r, fallback: i })),
      (t[0] = n),
      (t[1] = r),
      (t[2] = i),
      (t[3] = x))
  ...
  let { SvgFallback: oe, animationJson: S } = x,
    ...
    [w, pe] = (0, T.useState)(null),
    D = re(),
    O = typeof h == `number` ? `` : ge[h],
    k;
  t[4] === h
    ? (k = t[5])
    : ((k = typeof h == `number` ? { width: h, height: h } : {}), (t[4] = h), (t[5] = k));
  let A = k,
    j = typeof h == `number` ? `` : _e[h],
    M;
  t[6] !== h || t[7] !== A
    ? ((M = typeof h == `number` ? A : {}), (t[6] = h), (t[7] = A), (t[8] = M))
    : (M = t[8]);
  let N = M,
    P;
  t[9] !== p || t[10] !== j || t[11] !== c
    ? ((P = ne(j, p, c, `flex items-center justify-center`)),
      (t[9] = p),
      (t[10] = j),
      (t[11] = c),
      (t[12] = P))
  ...
  if (!m || ye) {
    ...
    if (
      (t[31] !== F || t[32] !== N || t[33] !== i
        ? ((a = (0, E.jsx)(`div`, { ref: y, className: F, style: N, children: i })),
          (t[31] = F),
          (t[32] = N),
          (t[33] = i),
          (t[34] = a))
  ...
  if (!D && !C && !ie) {
    ...
    return (
      t[35] !== F || t[36] !== N
        ? ((e = (0, E.jsx)(`div`, { ref: y, className: F, style: N })),
          (t[35] = F),
          (t[36] = N),
          (t[37] = e))
        : (e = t[37]),
  ...
  let be = ye ? `visible` : `hidden`,
    U;
  t[38] !== H || t[39] !== be
    ? ((U = (0, E.jsx)(T.Activity, { mode: be, children: H })),
      (t[38] = H),
      (t[39] = be),
      (t[40] = U))
    : (U = t[40]);
  ...
  t[41] === O
    ? (W = t[42])
    : ((W = ne(O, `flex items-center justify-center`)), (t[41] = O), (t[42] = W));
  let G = C?.data ?? void 0,
    K;
  t[43] === C
    ? (K = t[44])
    : ((K = (e) => {
        ...
        let t = ve.current;
        if (!t) {
          ((t = new OffscreenCanvas(C.size.width, C.size.height)), (ve.current = t));
  ...
  let Y;
  t[54] !== H || t[55] !== J
    ? ((Y = (0, E.jsx)(T.Suspense, { fallback: H, children: J })),
      (t[54] = H),
      (t[55] = J),
      (t[56] = Y))
    : (Y = t[56]);
  ...
  t[57] !== A || t[58] !== W || t[59] !== Y
    ? ((X = (0, E.jsx)(`div`, { className: W, style: A, children: Y })),
      (t[57] = A),
      (t[58] = W),
      (t[59] = Y),
      (t[60] = X))
  ...
  t[61] !== F || t[62] !== N || t[63] !== X
    ? ((Z = (0, E.jsx)(`div`, { ref: y, className: F, style: N, children: X })),
      (t[61] = F),
      (t[62] = N),
      (t[63] = X),
      (t[64] = Z))
  ...
  let Q;
  t[65] !== xe || t[66] !== Z
    ? ((Q = (0, E.jsx)(T.Activity, { mode: xe, children: Z })),
      (t[65] = xe),
      (t[66] = Z),
      (t[67] = Q))
    : (Q = t[67]);
  ...
  return (
    t[68] !== U || t[69] !== Q
      ? (($ = (0, E.jsxs)(E.Fragment, { children: [U, Q] })), (t[68] = U), (t[69] = Q), (t[70] = $))
      : ($ = t[70]),
    $
  );
}
...
var he,
  ...
  P = e(() => {
    ((he = n()),
      ...
      (ge = { fill: `h-full w-full`, xs: `w-3 h-3`, sm: `w-4 h-4`, md: `w-5 h-5`, lg: `w-6 h-6` }),
      (_e = { fill: `h-full w-full`, xs: `w-3 h-3`, sm: `w-4 h-4`, md: `w-6 h-6`, lg: `w-8 h-8` }),
      (j = new Map()),
      (M = new Set()),
      (N = null));
  });
export { P as n, pe as t };
