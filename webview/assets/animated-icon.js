  ...
  C = e(() => {
    (y(),
      ...
      (S = {
        ...
        loader: () =>
          s(
            () => import(`./loader-CisA-DQ7.js`).then((e) => e.default),
            __vite__mapDeps([9, 1]),
            import.meta.url,
          ),
        "internal-knowledge": () =>
...
function pe(e) {
  ...
  let N = M,
    P;
  t[9] !== f || t[10] !== j || t[11] !== s
    ? ((P = ie(j, f, s, `flex items-center justify-center`)),
      (t[9] = f),
      (t[10] = j),
      (t[11] = s),
      (t[12] = P))
  ...
  t[41] === O
    ? (W = t[42])
    : ((W = ie(O, `flex items-center justify-center`)), (t[41] = O), (t[42] = W));
  let G = S?.data ?? void 0,
    K;
  t[43] === S
    ? (K = t[44])
