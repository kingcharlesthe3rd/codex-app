...
import { t as s } from "./codex.js";
import { t as c } from "./homepage-logo.js";
import { t as ne } from "./clock.js";
...
var f = e(n()),
  ...
  h = {
    "analyze-image": () =>
      t(() => import(`./analyze_image_animation-B.js`).then((e) => e.default), [], import.meta.url),
    automation: () =>
    ...
    "codex-looking-around": () =>
      t(() => import(`./codex-looking-around.js`).then((e) => e.default), [], import.meta.url),
    "edit-files": () =>
      t(() => import(`./edit_files_animation.js`).then((e) => e.default), [], import.meta.url),
    ...
    "to-do": () =>
      t(() => import(`./to_do_animation.js`).then((e) => e.default), [], import.meta.url),
    "web-search": () =>
