...
import { Dw as s, Ew as c } from "./app-initial~app-main~onboarding-page.js";
import {
  M as ee,
  j as l,
...
function ce({ animation: e, animationData: t, fallback: n }) {
  ...
  return (e && ((r.animationJson = S[e]()), (r.SvgFallback = le[e])), r);
}
var S,
  le,
  C = e(() => {
...
function pe(e) {
  let t = (0, he.c)(71),
    ...
    h = ee === void 0 ? !0 : ee,
    g = l === void 0 ? !0 : l,
    _ = te === void 0 ? `worker` : te,
    ae = re === void 0 ? !0 : re,
    v = (0, T.useRef)(null),
    [y, oe] = (0, T.useState)(null),
    b;
  t[0] !== n || t[1] !== r || t[2] !== i
  ...
  let { SvgFallback: se, animationJson: x } = b,
    ...
    [C, pe] = (0, T.useState)(null),
    D = ie(),
    O = typeof m == `number` ? `` : ge[m],
    k;
  t[4] === m
    ? (k = t[5])
    : ((k = typeof m == `number` ? { width: m, height: m } : {}), (t[4] = m), (t[5] = k));
  let A = k,
    j = typeof m == `number` ? `` : _e[m],
    M;
  t[6] !== m || t[7] !== A
    ? ((M = typeof m == `number` ? A : {}), (t[6] = m), (t[7] = A), (t[8] = M))
    : (M = t[8]);
  let N = M,
    P;
  t[9] !== f || t[10] !== j || t[11] !== c
    ? ((P = ne(j, f, c, `flex items-center justify-center`)),
      (t[9] = f),
      (t[10] = j),
      (t[11] = c),
      (t[12] = P))
  ...
  if (!p || ye) {
    ...
    if (
      (t[31] !== F || t[32] !== N || t[33] !== i
        ? ((a = (0, E.jsx)(`div`, { ref: v, className: F, style: N, children: i })),
          (t[31] = F),
          (t[32] = N),
          (t[33] = i),
          (t[34] = a))
  ...
  if (!D && !S && !ae) {
    ...
    return (
      t[35] !== F || t[36] !== N
        ? ((e = (0, E.jsx)(`div`, { ref: v, className: F, style: N })),
          (t[35] = F),
          (t[36] = N),
          (t[37] = e))
        : (e = t[37]),
  ...
  t[43] === S
    ...
    : ((K = (e) => {
        ...
        let t = ve.current;
        if (!t) {
          ((t = new OffscreenCanvas(S.size.width, S.size.height)), (ve.current = t));
  ...
  t[61] !== F || t[62] !== N || t[63] !== X
    ? ((Z = (0, E.jsx)(`div`, { ref: v, className: F, style: N, children: X })),
      (t[61] = F),
      (t[62] = N),
      (t[63] = X),
      (t[64] = Z))
