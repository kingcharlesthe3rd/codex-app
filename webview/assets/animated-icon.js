const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./browser.js", "./chunk-Bj-mKKzh.js", "./jsx-runtime.js"]),
) => i.map((i) => d[i]);
...
import { t as d } from "./codex.js";
import { t as f } from "./tasks.js";
var p = e(n()),
  m = r(),
  h = (e) =>
    (0, m.jsxs)(`svg`, {
  ...
  g = {
    ...
    automation: () =>
      t(() => import(`./automation.js`).then((e) => e.default), [], import.meta.url),
    browsing: () =>
      t(
    ...
    "code-searching": () =>
      t(() => import(`./code-searching-icon.js`).then((e) => e.default), [], import.meta.url),
    "codex-happy-small": () =>
      t(() => import(`./codex-happy-small.js`).then((e) => e.default), [], import.meta.url),
    ...
    hello: () => t(() => import(`./hello.js`).then((e) => e.default), [], import.meta.url),
    loader: () => t(() => import(`./loader.js`).then((e) => e.default), [], import.meta.url),
    "internal-knowledge": () =>
      t(() => import(`./internal-knowledge-icon.js`).then((e) => e.default), [], import.meta.url),
    "list-files": () =>
      t(() => import(`./list_files_animation.js`).then((e) => e.default), [], import.meta.url),
    "local-context": () =>
      t(() => import(`./local_context_animation.js`).then((e) => e.default), [], import.meta.url),
    "run-command": () =>
      t(
    ...
    searching: () =>
      t(() => import(`./searching_animation.js`).then((e) => e.default), [], import.meta.url),
    "to-do": () =>
      t(() => import(`./to_do_animation-Dp-mkkO5.js`).then((e) => e.default), [], import.meta.url),
    "web-search": () =>
      t(() => import(`./web-search-icon.js`).then((e) => e.default), [], import.meta.url),
  },
  _ = {
    "analyze-image": te,
    automation: c,
...
var re = a(),
  ...
  ie = { fill: `h-full w-full`, xs: `w-3 h-3`, sm: `w-4 h-4`, md: `w-5 h-5`, lg: `w-6 h-6` },
  ae = { fill: `h-full w-full`, xs: `w-3 h-3`, sm: `w-4 h-4`, md: `w-6 h-6`, lg: `w-8 h-8` };
function oe(e) {
...
function ce(e) {
  return (
    ...
    x ||
      ...
      x.observe(document.documentElement, { attributes: !0, attributeFilter: [`class`, `style`] })),
    e(),
    () => {
...
function ue(e) {
  ...
  t[4] === g
    ? (O = t[5])
    : ((O = typeof g == `number` ? { width: g, height: g } : {}), (t[4] = g), (t[5] = O));
  let k = O,
  ...
  if (!h || V) {
    ...
    if (
      (t[31] !== P || t[32] !== M || t[33] !== i
        ? ((a = (0, m.jsx)(`div`, { ref: b, className: P, style: M, children: i })),
          (t[31] = P),
          (t[32] = M),
          (t[33] = i),
          (t[34] = a))
  ...
  t[41] === D
    ? (G = t[42])
    : ((G = i(D, `flex items-center justify-center`)), (t[41] = D), (t[42] = G));
  ...
  t[43] === w
    ...
    : ((K = (e) => {
        ...
        let t = he.current;
        if (!t) {
          ((t = new OffscreenCanvas(w.size.width, w.size.height)), (he.current = t));
  ...
  return (
    t[65] !== W || t[66] !== Q
      ? (($ = (0, m.jsxs)(m.Fragment, { children: [W, Q] })), (t[65] = W), (t[66] = Q), (t[67] = $))
      : ($ = t[67]),
    $
  );
}
