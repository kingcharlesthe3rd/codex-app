...
function pe(e) {
  ...
  t[4] === p
    ? (k = t[5])
    : ((k = typeof p == `number` ? { width: p, height: p } : {}), (t[4] = p), (t[5] = k));
  let A = k,
  ...
  let N = M,
    P;
  t[9] !== d || t[10] !== j || t[11] !== c
    ? ((P = ae(j, d, c, `flex items-center justify-center`)),
      (t[9] = d),
      (t[10] = j),
      (t[11] = c),
      (t[12] = P))
  ...
  if (!f || ye) {
    ...
    if (
      (t[31] !== F || t[32] !== N || t[33] !== i
        ? ((a = (0, E.jsx)(`div`, { ref: _, className: F, style: N, children: i })),
          (t[31] = F),
          (t[32] = N),
          (t[33] = i),
          (t[34] = a))
  ...
  if (!D && !S && !oe) {
    ...
    return (
      t[35] !== F || t[36] !== N
        ? ((e = (0, E.jsx)(`div`, { ref: _, className: F, style: N })),
          (t[35] = F),
          (t[36] = N),
          (t[37] = e))
        : (e = t[37]),
  ...
  t[41] === O
    ? (W = t[42])
    : ((W = ae(O, `flex items-center justify-center`)), (t[41] = O), (t[42] = W));
  let G = S?.data ?? void 0,
    K;
  t[43] === S
    ? (K = t[44])
  ...
  t[61] !== F || t[62] !== N || t[63] !== X
    ? ((Z = (0, E.jsx)(`div`, { ref: _, className: F, style: N, children: X })),
      (t[61] = F),
      (t[62] = N),
      (t[63] = X),
      (t[64] = Z))
