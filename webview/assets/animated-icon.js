...
function pe(e) {
  let t = (0, he.c)(71),
    ...
    h = c === void 0 ? !0 : c,
    g = re === void 0 ? !0 : re,
    _ = ie === void 0 ? `worker` : ie,
    ae = d === void 0 ? !0 : d,
    v = (0, T.useRef)(null),
    [y, oe] = (0, T.useState)(null),
    b;
  t[0] !== n || t[1] !== i || t[2] !== a
    ? ((b = ce({ animation: n, animationData: i, fallback: a })),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a),
      (t[3] = b))
  ...
  let N = M,
    P;
  t[9] !== f || t[10] !== j || t[11] !== s
    ? ((P = r(j, f, s, `flex items-center justify-center`)),
      (t[9] = f),
      (t[10] = j),
      (t[11] = s),
      (t[12] = P))
  ...
  t[41] === O
    ? (W = t[42])
    : ((W = r(O, `flex items-center justify-center`)), (t[41] = O), (t[42] = W));
  let G = S?.data ?? void 0,
    K;
  t[43] === S
    ? (K = t[44])
