...
import { Bt as s, K as c, cn as l, n as u } from "./use-host-config.js";
import {
  B as d,
  L as f,
  Lt as p,
...
import { Br as ee, Dt as te, J as ne, Ot as re, kt as ie, q as E, s as ae } from "./src-3.js";
...
import { a as Te, r as Ee } from "./thread-actions-B.js";
...
function nn(e) {
  let t = (0, K.c)(22),
    ...
    [v, y] = (0, Re.useState)(!1),
    b = (e) => {
      h(d, ee.PROJECT_APPEARANCES, re({ projectAppearances: m, projectId: n, appearance: e }));
    },
    x;
  t[0] === s ? (x = t[1]) : ((x = k(`h-7 w-7 rounded-md !p-1`, s)), (t[0] = s), (t[1] = x));
  let S;
  t[2] !== f || t[3] !== r
    ? ((S = f.formatMessage(
        {
      ...
      (t[4] = S))
    : (S = t[4]);
  let C = g == null ? i : (0, q.jsx)(rn, { appearance: g, className: l ?? `h-5 w-5` }),
    w;
  t[5] !== x || t[6] !== S || t[7] !== C
    ? ((w = (0, q.jsx)(De, {
        asChild: !0,
  ...
  t[12] === f
    ...
    : ((E = f.formatMessage({
      ...
      (t[13] = E));
  let ae = te.map((e) => {
      let t = _.marker.kind === `icon` && _.marker.icon === e;
      return (0, q.jsx)(
        `button`,
        {
          type: `button`,
          ...
          "aria-pressed": t,
          onClick: () => {
            b({ color: _.color, marker: { kind: `icon`, icon: e } });
          },
...
function cn(e) {
  let t = (0, K.c)(48),
    {
      ...
      hoverCardProjectId: h,
      hoverCardProjectLabel: g,
      hoverCardRepositoryLabel: _,
      hasUnreadTurn: y,
      isAutomationRun: x,
      isGrouped: C,
    ...
    N = r ?? M ?? A?.cwd ?? null,
    ce = i(R, n) ?? A?.title,
    le = i(m, n) ?? A?.createdAt,
    ue = i(S, n) ?? A?.updatedAt ?? le,
    de = i(f, n) ?? A?.gitInfo?.branch,
    P = i(d, n) ?? A?.hostId ?? null,
    pe = u(P ?? `local`),
    I = p ?? pe,
    L = p?.id ?? P,
    z = me(L ?? `local`),
    ge = (i(v, n) ?? A?.workspaceKind) === `projectless`,
    { data: B } = F(ee.THREAD_PROJECT_ASSIGNMENTS),
    _e;
  t[0] !== n || t[1] !== B
    ? ((_e = ae(B)[n] ?? null), (t[0] = n), (t[1] = B), (t[2] = _e))
    : (_e = t[2]);
  let ve = ie ? null : (h ?? (ge ? null : (_e?.projectId ?? N))),
    V = on(ve ?? ``),
    { renameThread: H } = Te(),
  ...
  let Se = xe,
    Ce;
  t[5] !== N || t[6] !== ie || t[7] !== Se || t[8] !== g || t[9] !== ge
    ? ((Ce = ie ? Se : (Ne(null, g) ?? (ge ? Se : (Ne(N) ?? N ?? Se)))),
      (t[5] = N),
      (t[6] = ie),
      (t[7] = Se),
      (t[8] = g),
