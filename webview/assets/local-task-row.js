...
import { m as ae } from "./chunk-8.js";
import { t as E } from "./branch.js";
import { t as oe } from "./request.js";
    ...
    ? ((c =
        !o && r != null && r !== ``
          ? (0, U.jsx)(K, {
              row: {
                id: `project`,
                icon: (0, U.jsx)(z, { isCodexWorktree: !1, isGitRepository: !1, isOpen: !0 }),
                label: r,
              },
            })
          : null),
...
function K(e) {
  ...
  t[0] === n.icon
    ? (r = t[1])
    : ((r = (0, W.cloneElement)(n.icon, { className: b(`icon-xs`, n.icon.props.className) })),
      (t[0] = n.icon),
      (t[1] = r));
  let i = r,
  ...
  t[2] === a
    ? (o = t[3])
    : ((o = b(`flex min-w-0 gap-1.5 text-sm leading-5`, a)), (t[2] = a), (t[3] = o));
  let s;
  t[4] === i
    ? (s = t[5])
    : ((s = (0, U.jsx)(`span`, {
  ...
  let c = n.allowWrap ? `whitespace-normal` : `overflow-hidden text-ellipsis whitespace-nowrap`,
    ...
    u;
  t[6] !== c || t[7] !== l
    ? ((u = b(`block min-w-0 flex-1 leading-5`, c, l)), (t[6] = c), (t[7] = l), (t[8] = u))
    : (u = t[8]);
  let d;
  t[9] !== n.label || t[10] !== u
...
function Te(e) {
  ...
  if ((n.unreadCount ?? 0) > 0) {
    let e = n.unreadCount ?? 0,
      r;
    return (
      t[0] === e ? (r = t[1]) : ((r = (0, U.jsx)(Ee, { count: e })), (t[0] = e), (t[1] = r)), r
    );
  }
  if (n.type === `loading`) {
    let e;
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, U.jsx)(`div`, {
          ...
          children: (0, U.jsx)(se, { className: `icon-xs shrink-0`, animationDurationMs: 2e3 }),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
...
function Ae(e) {
  ...
  let pe = fe,
    ...
    ke = !q,
    Ae = R + (G ? 1 : 0),
    J = D == null ? `group-focus-within:opacity-0 group-hover:opacity-0` : `group-hover:opacity-0`,
    Y = M && (B === `loading` || ve),
    Ie = C ?? w,
    X;
  ...
  t[21] !== m || t[22] !== $ || t[23] !== Oe || t[24] !== N
    ? ((Ge = Oe
        ? (0, U.jsx)(Fe, { archiveAriaLabel: m, onArchive: $, useStableTrailingRail: N })
        : null),
      (t[21] = m),
      (t[22] = $),
      (t[23] = Oe),
  ...
  t[31] !== q || t[32] !== g || t[33] !== B || t[34] !== ve
    ? ((Ye = !q && (B === `loading` || ve) ? (0, U.jsx)(Te, { statusState: g }) : null),
      (t[31] = q),
      (t[32] = g),
      (t[33] = B),
      (t[34] = ve),
  ...
  t[42] !== $
    ? ((Ze = K
        ? null
        : D
          ? D({ requestArchive: $, confirmArchive: We, confirmingArchive: V, canArchive: G })
          : Ke),
      (t[36] = Ke),
      (t[37] = G),
      (t[38] = We),
  ...
  let St = F ? -1 : 0,
    Ct = ge ? `page` : void 0,
    wt = De && `[mask-image:linear-gradient(to_left,transparent_0,transparent_72px,black_80px)]`,
    Tt;
  t[82] === wt
    ? (Tt = t[83])
  ...
  t[84] === Et
    ? (Dt = t[85])
    : ((Dt = b(`flex min-w-0 flex-1 items-center gap-2 pl-0.5`, Et)), (t[84] = Et), (t[85] = Dt));
  let Ot = P === `start` && it,
    kt = ge ? `text-[var(--vscode-foreground)]` : `text-token-foreground`,
    At;
  t[86] !== ce || t[87] !== kt
    ? ((At = b(`flex min-w-0 flex-1 self-stretch items-center gap-2 text-base leading-5`, kt, ce)),
      (t[86] = ce),
      (t[87] = kt),
      (t[88] = At))
    : (At = t[88]);
...
function je(e) {
  ...
  t[11] === n
    ? (v = t[12])
    : ((v = b(`flex min-w-[24px] items-center justify-end gap-2`, n)), (t[11] = n), (t[12] = v));
  let y;
  t[13] === _
    ? (y = t[14])
    : ((y =
        _.length > 0
          ? (0, U.jsx)(`div`, { className: `flex items-center gap-1`, children: _ })
          : null),
      (t[13] = _),
      (t[14] = y));
  let ee;
  t[15] !== i || t[16] !== h
    ? ((ee =
        i != null || h.length > 0
          ? (0, U.jsxs)(`div`, { className: `flex items-center gap-1.5`, children: [h, i] })
          : null),
      (t[15] = i),
      (t[16] = h),
      (t[17] = ee))
    ...
    c =
      a == null
        ? (0, U.jsx)(
            `span`,
            {
              className: b(`flex shrink-0 items-center text-token-description-foreground`, i),
              children: s,
            },
            t,
          )
...
function Me(e) {
  ...
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, U.jsx)(A, { className: `icon-xs shrink-0 text-token-error-foreground` })),
      (t[2] = a))
    : (a = t[2]);
  let o;
  return (
    t[3] === i
      ? (o = t[4])
      : ((o = (0, U.jsx)(`div`, { className: i, children: a })), (t[3] = i), (t[4] = o)),
    o
  );
}
function Ne(e) {
  ...
  return (
    t[3] !== r || t[4] !== o
      ? ((s = (0, U.jsx)(`div`, { className: o, children: r })), (t[3] = r), (t[4] = o), (t[5] = s))
      : (s = t[5]),
    s
  );
}
...
function X(e) {
  ...
  t[18] === I
    ? (je = t[19])
    : ((je = () =>
        oe.safePost(`/wham/tasks/{task_id}/archive`, { parameters: { path: { task_id: I } } })),
      (t[18] = I),
      (t[19] = je));
  let J;
              ...
              sections: [
                {
                  ...
                  rows: [
                    {
                      id: `environment`,
                      icon: (0, U.jsx)(Se, { envType: `cloud`, disableTooltip: !0 }),
  ...
  let Be = (j || B) && v == null,
    Ve = K ? Fe : null,
    He;
  t[47] === M ? (He = t[48]) : ((He = M.formatMessage(Le.archiveTask)), (t[47] = M), (t[48] = He));
  let $;
  ...
  t[74] !== K || t[75] !== T || t[76] !== Fe
    ? ((Ge = () => {
        let e = [...T];
        return (K && e.push({ id: `archive-task`, message: Le.archiveTask, onSelect: Fe }), e);
      }),
      (t[74] = K),
      (t[75] = T),
      (t[76] = Fe),
    ...
    s != null &&
      l.push({
        ...
        label:
          r == null
            ? s
            : (0, U.jsx)(O, { tooltipContent: r, children: (0, U.jsx)(`span`, { children: s }) }),
      }),
    e != null &&
      l.push({
        allowWrap: !0,
        id: `branch-mismatch`,
        icon: (0, U.jsx)(B, { className: `text-token-editor-warning-foreground` }),
        label: e,
        tone: `danger`,
      }),
    c != null && l.push({ id: `worktree`, icon: a ?? (0, U.jsx)(P, {}), label: c }),
    l.length > 0 ? l : void 0
  );
}
function Ve(e) {
  ...
  t[0] !== m || t[1] !== n.createdAt
    ? ((se = m ?? (0, U.jsx)(N, { dateString: new Date(n.createdAt).toISOString() })),
      (t[0] = m),
      (t[1] = n.createdAt),
      (t[2] = se))
    : (se = t[2]);
  ...
  let I = F,
    ...
    R;
  t[22] !== E || t[23] !== y
    ? ((R = y ? E.formatMessage(ge.archiveThread) : void 0), (t[22] = E), (t[23] = y), (t[24] = R))
    : (R = t[24]);
  let z;
  t[25] === y
    ? (z = t[26])
...
function He({ codexHome: e, cwd: t, hideRemoteHostEnvIcon: r, hostId: i, isGrouped: a }) {
...
function $(e) {
  let t = (0, H.c)(29),
    ...
    D = ce(E ?? `local`),
    O = C(u, n) === `projectless`,
    k = He({ codexHome: D, cwd: T, hideRemoteHostEnvIcon: te, hostId: E, isGrouped: ne }),
    se =
      !O &&
      T != null &&
      (k == null || k === `worktree` || k === `remote-worktree` || k === `localGrouped`),
    le;
  t[0] === w
    ? (le = t[1])
    : ((le = w.formatMessage({
  ...
  let de = j,
    fe = se && re,
    pe;
  t[7] === fe ? (pe = t[8]) : ((pe = { enabled: fe, staleTime: 0 }), (t[7] = fe), (t[8] = pe));
  let me = ve(T, oe, `local_thread_hover_card`, pe),
    ...
    P = se
      ? Be({
          ...
          codexHome: D,
          workspaceIcon: k === `worktree` || k === `remote-worktree` ? void 0 : (0, U.jsx)(ue, {}),
          workspacePath: T,
        })
      : void 0,
    F;
    ...
    L =
      ...
      (be(k)
        ? [
            {
              id: `environment`,
              icon: (0, U.jsx)(Se, { envType: k, hostId: E ?? void 0, disableTooltip: !0 }),
              label: ge ?? (0, U.jsx)(xe, { envType: k }),
            },
          ]
        : []),
    R;
  t[14] === L ? (R = t[15]) : ((R = { id: `environment`, rows: L }), (t[14] = L), (t[15] = R));
  let z;
  t[16] === m ? (z = t[17]) : ((z = m ?? []), (t[16] = m), (t[17] = z));
  let B;
  t[18] === I ? (B = t[19]) : ((B = { id: `automation`, rows: I }), (t[18] = I), (t[19] = B));
  let _e;
  t[20] !== R || t[21] !== z || t[22] !== B
    ? ((_e = [R, ...z, B].filter(Ue)), (t[20] = R), (t[21] = z), (t[22] = B), (t[23] = _e))
    : (_e = t[23]);
  let ye = _e,
    W;
  return (
...
function Ge(e) {
  return (0, U.jsx)(j, { browser: !0, electron: !0, children: (0, U.jsx)($, { ...e }) });
}
function Ke(e) {
  let t = (0, H.c)(98),
    {
  ...
  let ct = ot && st?.parentThreadId != null,
    ...
    ut;
  t[6] !== $e || t[7] !== N
    ? ((ut = (0, U.jsx)(Je, { title: $e, titleOverride: N })), (t[6] = $e), (t[7] = N), (t[8] = ut))
    : (ut = t[8]);
  let dt = ut,
  ...
  t[9] !== Ue || t[10] !== ct || t[11] !== lt || t[12] !== We
    ? ((mt =
        lt === `loading`
          ? { type: `loading`, unread: ct ? !1 : Ue === !0, unreadCount: ct ? 0 : (We ?? 0) }
          : { type: lt, unread: ct ? !1 : Ue === !0, unreadCount: ct ? 0 : (We ?? 0) }),
      (t[9] = Ue),
      (t[10] = ct),
      (t[11] = lt),
      (t[12] = We),
        ...
        (rt(),
          c(`archive-conversation`, { conversationId: n })
            .then(() => {
              it();
              let e = qe;
              ct || Z.get(D).info((0, U.jsx)(ye, { onOpenSettings: e }), { id: `archive-thread` });
            })
            .catch(() => {
              (at(),
                Z.get(D).danger(
  ...
  let yt = vt,
    bt;
  t[25] === yt ? (bt = t[26]) : ((bt = yt == null ? [] : [yt]), (t[25] = yt), (t[26] = bt));
  let xt = bt,
    St;
  ...
  if (Ct != null) {
    let e;
    (t[32] !== Ct || t[33] !== j
      ? ((e = j == null ? [Ct] : [...j, Ct]), (t[32] = Ct), (t[33] = j), (t[34] = e))
      : (e = t[34]),
      (wt = e));
  }
  let Tt;
  t[35] !== Ye || t[36] !== $ || t[37] !== Pe || t[38] !== Ke || t[39] !== Te
    ? ((Tt = He({ codexHome: Ye, cwd: $, hideRemoteHostEnvIcon: Pe, hostId: Ke, isGrouped: Te })),
      (t[35] = Ye),
      (t[36] = $),
      (t[37] = Pe),
      (t[38] = Ke),
  ...
  let At = Ke ?? void 0,
    jt;
  t[53] !== n || t[54] !== r || t[55] !== Re || t[56] !== d || t[57] !== u || t[58] !== s
    ? ((jt = () => {
        (d?.(),
          Re(n, r),
          (0, W.startTransition)(() => {
...
function qe() {
  T.dispatchHostMessage({ type: `navigate-to-route`, path: `/settings/data-controls` });
}
function Je(e) {
  let t = (0, H.c)(3),
