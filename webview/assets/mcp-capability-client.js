...
import { Zi as r, na as i, qi as a, ra as o, zi as s } from "./src-1.js";
import { l as c, p as l } from "./mcp-capability-signals.js";
var u = r({
    items: s(
      o([
        r({ id: i().min(1), title: i().min(1), type: a(`group`) }),
        r({ resourceUri: i().min(1), title: i().min(1), type: a(`resource`) }),
      ]),
    ),
  }),
  d = e(t, (e) => ({
...
async function f(e, t, r, i) {
  return l.parse(
    await n(`read-mcp-resource`, { hostId: t, server: r, threadId: await h(e, t), uri: i }),
  );
}
