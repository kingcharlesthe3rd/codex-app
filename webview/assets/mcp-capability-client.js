...
import { _ as n, n as r, p as i } from "./mcp-capability-signals.js";
async function a(e, t, i, a, o) {
  return n.parse(await c(e.get(r, t), i, a, { method: `resources/read`, params: { uri: o } }));
}
        ...
        return {
          items: e.mentionSearch.responseSchema.parse(
            await c(
              ...
              t,
              n,
              e.mentionSearch.requestSchema.parse({ method: e.mentionSearch.method, params: a }),
            ),
          ).items,
          server: n,
        };
...
async function s(e, t, n, a, o, s) {
  return i.parse(
    await c(e.get(r, t), n, a, { method: `tools/call`, params: { arguments: s, name: o } }),
  );
}
async function c(e, n, r, i) {
  let a = l(e, n);
  return t(`call-app-plugin-request`, {
    params: { hostId: a.hostId, pluginId: n, pluginPath: a.pluginPath, server: r, ...i },
  });
}
function l(e, t) {
