...
import { Di as A, w as te } from "./src-1.js";
import { c as ne, o as j, r as M } from "./lib.js";
import { c as N, dt as re, ft as ie, o as ae, t as oe, ut as se } from "./persisted-signal.js";
import { a as ce, t as le } from "./setting-storage.js";
import { t as ue } from "./spinner.js";
import { t as de } from "./check-md.js";
import { r as fe, t as pe } from "./tooltip.js";
import { P as me } from "./rpc-1.js";
import { a as he } from "./thread-context-inputs.js";
import { a as ge } from "./use-model-settings.js";
import { r as P } from "./toast-signal.js";
import { t as _e } from "./chevron.js";
import { m as ve } from "./chunk-109.js";
import { t as ye } from "./branch.js";
...
import { i as I, n as we } from "./git-current-branch-query.js";
import { t as L } from "./app-intl-signal-D.js";
...
import { r as R, t as je } from "./dropdown.js";
import { t as Me } from "./copy.js";
import { t as Ne } from "./plus.js";
import { a as z, i as Pe, o as Fe, r as Ie, t as B } from "./gh-pull-request-status-query.js";
import { n as Le } from "./dist-12.js";
...
function Ye(e) {
  let t = me(e.root).replace(/\/+$/, ``),
    n = me(e.commonDir).replace(/\/+$/, ``);
...
var q = new Map(),
  J = c(m, (e) => null),
  Y = c(m, (e) => ``),
  Ct = oe(`git-action-include-unstaged-changes`, !0),
  X = c(m, (e) => ``),
  wt = c(m, (e) => ``),
  Tt = c(m, (e) => !0);
function Et(e, t) {
...
var Z = d(`LocalGitActionsScope`, {
  ...
  It = u(F, (e, { get: t }) => {
    ...
    return jt({
      ...
      storedThreadBranch: t(T, e.conversationId),
    }).currentBranchName;
  }),
  Lt = u(F, (e, { get: t }) => t(Pe, tn(e, t(It, e)))),
  Rt = u(F, (e, { get: t }) => t(B, tn(e, t(It, e)))),
  zt = u(
    F,
    (e, { get: t }) =>
      jt({ currentBranch: t(It, e), storedThreadBranch: t(T, e.conversationId) })
...
async function On(e, t, { headBranch: n, signal: r } = {}) {
  ...
  return fn({
    pullRequestInstructions: le(e.get, te.pullRequestInstructions) ?? null,
...
async function kn(e, t, n, r) {
  ...
  return on({
    commitInstructions: le(e.get, te.commitInstructions) ?? null,
    diffError: s,
    draftMessage: n,
...
var Pn = o(
      ...
      return {
        ...
        onSuccess: async (i, a) => {
          ...
          (Mn(t, o, r, a.operationSource),
            ...
            o != null && (await t.invalidateQueries({ queryKey: h(o.commonDir, o.root, r) })));
        },
      };
    },
    { excludeFieldsFromKey: [`operationSource`] },
  ...
  Ln = o(m, (e, { queryClient: t }) => {
    let n = x(e.hostConfig);
    return {
      mutationKey: [
        `vscode`,
      ...
      onSettled: (r, i, a) => {
        ...
        o != null &&
          (S(t, o, { changeType: a.mode === `synced` ? `synced-branch` : `head`, hostKey: n }),
          r?.status === `success` &&
            a.mode === `synced` &&
            S(t, o, { changeType: `head`, hostKey: n }));
      },
      networkMode: `always`,
    };
  });
    ...
    if (n.nextStep !== `push`) {
      ...
      if (
        ...
        !(await zn({
          ...
          commitAttribution: Hn(e.get(ge, { cwd: t.cwd, hostId: t.hostConfig.id }).data),
          operationSource: t.operationSource,
          signal: i,
        })))
      )
...
function Yn(e) {
  ...
  t[3] !== g || t[4] !== o || t[5] !== s || t[6] !== M
    ? ((N = { codexWorktree: g, conversationId: M, cwd: o, hostConfig: s }),
      (t[3] = g),
      (t[4] = o),
      (t[5] = s),
      (t[6] = M),
  ...
  let fe = i(vt, le),
    pe;
  t[14] !== v || t[15] !== re
    ? ((pe = { ...re, operationSource: v }), (t[14] = v), (t[15] = re), (t[16] = pe))
    : (pe = t[16]);
  let me = i(Kn, pe),
    he;
  t[17] !== o || t[18] !== s || t[19] !== v
    ...
    : (he = t[20]);
  let ge = i(H, he),
    P = ge.type === `success` ? ge.data : void 0,
    ve = i(J, E),
    F = me.isPending || ve != null,
    xe;
  ...
  let L = i(gt, we),
    Te = null;
  P && (Te = P.branch ?? P.upstreamRef ?? null);
  let Ee;
  t[32] !== ie || t[33] !== Te || t[34] !== ae
    ? ((Ee = !ae && ie?.trim() ? ie.trim() : ae ? null : Te),
      (t[32] = ie),
      (t[33] = Te),
      (t[34] = ae),
      (t[35] = Ee))
  ...
  let ke = Ee,
    ...
    Pe;
  t[36] !== D || t[37] !== O
    ? ((Pe = Ve({ branchPrefix: D, conversationTitle: O })), (t[36] = D), (t[37] = O), (t[38] = Pe))
    : (Pe = t[38]);
  let Fe = C ?? Pe,
    Ie;
  t[39] === Fe ? (Ie = t[40]) : ((Ie = Fe.trim()), (t[39] = Fe), (t[40] = Ie));
  let B = Ie,
    V = be(B, 200),
    Re;
  t[41] !== z || t[42] !== V || t[43] !== n
    ? ((Re = n && z && V.length > 0 && !V.endsWith(`/`)),
      (t[41] = z),
      (t[42] = V),
      (t[43] = n),
      (t[44] = Re))
  ...
  let Be = Re,
    Ue;
  t[45] !== o || t[46] !== V || t[47] !== s || t[48] !== v || t[49] !== Be
    ? ((Ue = { branch: V, cwd: o, enabled: Be, hostConfig: s, operationSource: v }),
      (t[45] = o),
      (t[46] = V),
      (t[47] = s),
      (t[48] = v),
  ...
  let { data: We } = i(He, Ue),
    Ge = V === B && We === !0,
    Ke;
  t[51] !== Ge || t[52] !== z || t[53] !== B
    ? ((Ke = z && (B.length === 0 || B.endsWith(`/`) || Ge)),
      (t[51] = Ge),
      (t[52] = z),
      (t[53] = B),
      (t[54] = Ke))
    : (Ke = t[54]);
  let qe = Ke,
    Je = L == null || L === `changes-loading`,
    Ye = I == null && !F && !qe,
    et = !F && !qe && (z ? (P?.commitsAhead ?? 0) > 0 : se == null),
    tt = Ye && (z || fe == null),
    nt;
  t[55] !== _ || t[56] !== x
    ? ((nt = _
  ...
  t[66] !== me
    ? ((it = (e) => {
        if (F || qe || (e !== `push` && I != null)) return;
        (r(!1), d?.(`loading`));
        let t = z ? { kind: `commit`, newBranch: B, nextStep: e } : { kind: `commit`, nextStep: e };
        me.mutate(t, {
          onSuccess: (e) => {
            d?.(e ? `success` : `error`);
          },
  ...
  t[72] === rt
    ? (K = t[73])
    : ((K = (0, U.jsx)(De, { className: `sr-only`, children: rt })), (t[72] = rt), (t[73] = K));
  let st;
  t[74] !== Me || t[75] !== Te || t[76] !== z || t[77] !== ke || t[78] !== F
    ? ((st = (0, U.jsx)(`span`, {
        ...
        children: Me
          ? (0, U.jsxs)(je, {
              ...
              triggerButton: (0, U.jsxs)(`button`, {
                ...
                children: [
                  (0, U.jsx)(ye, { className: `icon-xs shrink-0` }),
                  (0, U.jsx)(`span`, {
                    className: `truncate`,
                    children: z
                      ? (0, U.jsx)(j, {
                  ...
                  (0, U.jsx)(_e, { className: `icon-2xs shrink-0` }),
                ],
              }),
              children: [
                (0, U.jsx)(R.SectionLabel, {
                  children: (0, U.jsx)(j, {
        ...
        ? (0, U.jsxs)(`span`, {
            ...
            children: [
              (0, U.jsx)(`span`, {
                ...
                children:
                  Se.isLoading || Se.isFetching
                    ? (0, U.jsx)(ue, { className: `icon-xs text-token-description-foreground` })
                    : null,
              }),
              (0, U.jsx)(Zn, {
                isLoading: Se.isLoading,
                isUnavailable: Se.isUnavailable,
                selectionSummary: Se.selectionSummary,
              }),
            ],
          })
        : null),
  ...
  t[83] !== st || t[84] !== ct
    ...
    : (lt = t[85]);
  let ut;
  t[86] !== Ge || t[87] !== Fe || t[88] !== D || t[89] !== z || t[90] !== F
    ? ((ut = z
        ? (0, U.jsx)(qn, {
  ...
  t[101] === I
    ? (pt = t[102])
    : ((pt = (0, U.jsx)(Qe, { reason: I })), (t[101] = I), (t[102] = pt));
  let mt;
  ...
  t[105] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (yt = t[105]);
  let bt;
  t[106] !== F || t[107] !== ft || t[108] !== pt || t[109] !== mt
    ? ((bt = (0, U.jsx)(Qn, {
        Icon: Ze,
        disabled: ft,
        loading: F,
    ...
    : (bt = t[110]);
  let xt;
  t[111] !== tt || t[112] !== I || t[113] !== _ || t[114] !== fe || t[115] !== G
    ? ((xt = _
        ? (0, U.jsx)(Qn, {
            Icon: ze,
            disabled: !tt,
            loading: !1,
            tooltipContent:
              I == null ? (0, U.jsx)($e, { reason: fe }) : (0, U.jsx)(Qe, { reason: I }),
    ...
    : (xt = t[116]);
  let St;
  t[117] !== et || t[118] !== _ || t[119] !== se || t[120] !== G
    ? ((St = _
        ? (0, U.jsx)(Qn, {
            Icon: ze,
            disabled: !et,
            loading: !1,
            tooltipContent: (0, U.jsx)($e, { reason: se }),
            value: `push`,
            onSelect: () => G(`push`),
            children: (0, U.jsx)(j, {
...
function Qn(e) {
  ...
  t[0] !== r || t[1] !== a
    ? ((l = a
        ? (0, U.jsx)(ue, { className: `icon-xs shrink-0` })
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, U.jsx)(`span`, {
        ...
        children: (0, U.jsx)(fe, { keysLabel: ke(`CmdOrCtrl+Enter`), variant: `button` }),
      })),
      (t[5] = d))
    : (d = t[5]);
  let f;
  ...
  return (
    t[16] !== h || t[17] !== o
      ? ((g = (0, U.jsx)(pe, { tooltipContent: o, children: h })),
        (t[16] = h),
        (t[17] = o),
        (t[18] = g))
      : (g = t[18]),
...
function er(e) {
  ...
  if (
    ...
    if (E) {
      ...
      (t[21] === n
        ? (r = t[22])
        : ((r = (0, U.jsxs)(R.Section, { className: `flex flex-col gap-1`, children: [e, n] })),
          (t[21] = n),
          (t[22] = r)),
        (C = r));
      ...
      (t[24] !== _ || t[25] !== p || t[26] !== m || t[27] !== r
        ? ((e = (e) =>
          ...
          (t[28] = e))
        : (e = t[28]),
        (C = (0, U.jsx)(R.Section, { className: `flex flex-col`, children: w.map(e) })));
    }
    ((t[0] = n),
      (t[1] = _),
      (t[2] = a),
