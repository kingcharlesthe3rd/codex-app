...
import { C as ee, ta as M } from "./src-3.js";
...
var Z = l(`LocalGitActionsScope`, {
  ...
  Ft = u(F, (e, { get: t }) => {
    ...
    return At({
      ...
      storedThreadBranch: t(_, e.conversationId),
    }).currentBranchName;
  }),
  ...
  Rt = u(
    F,
    (e, { get: t }) =>
      At({ currentBranch: t(Ft, e), storedThreadBranch: t(_, e.conversationId) })
      ...
      onSuccess: async (n, r) => {
        ...
        (await i.cancel(),
          ...
          r.conversationId != null &&
            ...
            T(r.conversationId, r.headBranch));
      },
      onSettled: (n, r, i) => {
        i.signal?.aborted &&
          i.openInBrowser !== !0 &&
  ...
  Fn = s(m, (e, { queryClient: t }) => {
    ...
    return {
      ...
      onSettled: (r, i, a) => {
        ...
        o != null &&
          (b(t, o, { changeType: a.mode === `synced` ? `synced-branch` : `head`, hostKey: n }),
          r?.status === `success` &&
            a.mode === `synced` &&
            b(t, o, { changeType: `head`, hostKey: n }));
      },
      networkMode: `always`,
    };
  });
  ...
  try {
    ...
    if (n.nextStep !== `push`) {
      if (
        ...
        let n = e.get(Ft, t);
        n.length > 0 && T(t.conversationId, n);
      }
      if (
...
function Jn(e) {
  ...
  let D = E,
    ...
    M = i ?? null,
    te;
  t[3] !== g || t[4] !== o || t[5] !== s || t[6] !== M
    ? ((te = { codexWorktree: g, conversationId: M, cwd: o, hostConfig: s }),
      (t[3] = g),
      (t[4] = o),
      (t[5] = s),
      (t[6] = M),
  ...
  let pe = a(gt, de),
    me;
  t[14] !== v || t[15] !== ie
    ? ((me = { ...ie, operationSource: v }), (t[14] = v), (t[15] = ie), (t[16] = me))
    : (me = t[16]);
  let he = a(Wn, me),
    ge;
  t[17] !== o || t[18] !== s || t[19] !== v
    ? ((ge = { cwd: o, hostConfig: s, operationSource: v }),
      (t[17] = o),
      (t[18] = s),
      (t[19] = v),
      (t[20] = ge))
  ...
  let Re = Le,
    Ue;
  t[45] !== o || t[46] !== H || t[47] !== s || t[48] !== v || t[49] !== Re
    ? ((Ue = { branch: H, cwd: o, enabled: Re, hostConfig: s, operationSource: v }),
      (t[45] = o),
      (t[46] = H),
      (t[47] = s),
      (t[48] = v),
  ...
  t[106] !== I || t[107] !== ut || t[108] !== dt || t[109] !== ft
    ...
    : (vt = t[110]);
  let yt;
  t[111] !== $e || t[112] !== L || t[113] !== _ || t[114] !== pe || t[115] !== K
    ? ((yt = _
        ? (0, G.jsx)(Zn, {
            Icon: ze,
            disabled: !$e,
    ...
    : (yt = t[116]);
  let bt;
  t[117] !== Qe || t[118] !== _ || t[119] !== le || t[120] !== K
    ? ((bt = _
        ? (0, G.jsx)(Zn, {
            Icon: ze,
            disabled: !Qe,
