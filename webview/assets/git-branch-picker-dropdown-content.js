...
import { m as de } from "./chunk-8.js";
import { t as fe } from "./branch.js";
import { r as pe, t as me } from "./product-logger.js";
import { a as he } from "./thread-context-inputs.js";
import { t as ge } from "./use-debounced-value.js";
import { r as F } from "./toast-signal.js";
import { r as I, t as _e } from "./tooltip.js";
import { t as L } from "./route-scope.js";
import { s as ve } from "./prompt-text.js";
import { i as R } from "./use-model-settings-DhE-8qP1.js";
...
import { n as Ee } from "./check-git-index-for-changes.js";
...
import { r as H, t as Me } from "./dropdown.js";
import { t as Ne } from "./chevron.js";
import { t as U } from "./copy-to-clipboard.js";
import { t as Pe } from "./copy.js";
import { t as Fe } from "./plus.js";
import { n as Ie, t as Le } from "./gh-cli-status-query.js";
import { n as Re } from "./dist-10.js";
import { n as ze } from "./use-git-default-branch.js";
...
function qe(e) {
  ...
  t[8] !== n || t[9] !== f || t[10] !== u || t[11] !== l || t[12] !== c
    ? ((v = async () => {
        ...
        (n != null && e.push(l.invalidateQueries({ queryKey: [`git`, `metadata`, f, n] })),
          await Promise.all(e));
      }),
      (t[8] = n),
      (t[9] = f),
...
var Z = ie(`LocalGitActionsScope`, {
  ...
  Ht = C(
    L,
    (e, { get: t }) =>
      Pt({ currentBranch: t(zt, e), storedThreadBranch: t(s, e.conversationId) })
  ...
  Gt = T(Z, ({ get: e, scope: t }) => e(Y, { cwd: t.value.cwd, hostId: t.value.hostId })),
  ...
  Zt = T(Z, ({ get: e }) => {
    let t = e(Wt),
      ...
      r = e(Ct, t),
      i = e(wt, t);
    return r == null || (n == null && i == null) || (e(Yt) && n == null) ? null : r;
  }),
  Qt = T(Z, ({ get: e }) => {
    let t = e(Wt);
    return e(Tt, {
...
function Cn(e) {
  ...
  let d = u,
    ...
    h;
  t[4] !== f || t[5] !== p || t[6] !== m
    ? ((h = [f, p, m].filter(wn)), (t[4] = f), (t[5] = p), (t[6] = m), (t[7] = h))
    : (h = t[7]);
  let g = h.join(`
`),
    _;
...
function $({ toaster: e, title: t, message: n, execOutput: r }) {
  e.custom({
    duration: Tn,
    content: ({ close: e }) => (0, q.jsx)(Cn, { title: t, message: n, execOutput: r, onClose: e }),
  });
}
function En(e, t) {
  let n = t?.trim() ?? ``;
...
var On = 1e3,
  ...
  An = P(E, (e, { get: t, scope: n }) => {
    let r = { cwd: e.cwd, hostId: e.hostConfig.id },
      i = xn({ conversationId: e.conversationId, tokenUsageInfo: t(c, e.conversationId) }),
      a = t(B),
      o = t(F);
    return {
      ...
      mutationFn: async () => {
        ...
        try {
          ...
          c && n.get(Y, r)?.phase === `generating-commit-message` && n.set(Y, r, t);
        }
    ...
    return {
      ...
      mutationFn: async () => {
        let t = n.get(X, r),
          ...
          c = n.get(jt, r).trim(),
          l = t.trim();
        if (l.length > 0 && s.length > 0 && c.length > 0) return { body: c, message: l, title: s };
        let u;
        try {
...
`),
        ...
        return d.length === 0 || f.length === 0 || p.length === 0
          ? (o.danger(
            ...
            null)
          : (Fn(n, r, t, d),
            s.length === 0 && n.set(At, r, (e) => (e.trim().length === 0 ? f : e)),
            c.length === 0 && n.set(jt, r, (e) => (e.trim().length === 0 ? p : e)),
            { body: p, message: d, title: f });
      },
    };
  }),
  Mn = P(E, (e, { get: t, scope: n }) => {
    let r = xn({ conversationId: e.conversationId, tokenUsageInfo: t(c, e.conversationId) }),
      i = t(B),
      a = t(F);
    return {
      ...
      mutationFn: async ({ body: t, title: o }) => {
        ...
        if (l.length === 0) return (a.danger(i.formatMessage(Q.pullRequestGenerationError)), null);
        let u;
        try {
          u = await M(`generate-pull-request-message`, {
            params: { hostId: e.hostConfig.id, prompt: l, cwd: e.cwd, conversationId: r },
          });
        } catch {
...
async function Nn(e, t) {
  let [r, i, a] = await Promise.all([
      g(`git`).request({
        method: `review-patch`,
        params: { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: kn, source: `branch` },
      }),
      g(`git`).request({
...
async function Pn(e, t, r) {
  let i = e.get(kt),
    a = await g(`git`).request({
      ...
      params: { cwd: t.cwd, hostConfig: t.hostConfig, includeUnstaged: i, operationSource: kn },
    }),
    o = dn(a),
    ...
    l = c?.linesAdded ?? 0,
    u = c?.linesRemoved ?? 0,
    d = l + u > On ? { filesChanged: c?.filesChanged ?? 0, linesAdded: l, linesRemoved: u } : null;
  return ln({
    ...
    (e, { queryClient: t, scope: n }) => {
      ...
      return {
        ...
        onSuccess: async (a, o) => {
          ...
          let s = t.getQueryData(i(e.cwd, r, e.hostConfig, o.operationSource).queryKey);
          (Ln(t, s, r, o.operationSource),
            Ee(),
            n.set(X, { cwd: e.cwd, hostId: e.hostConfig.id }, ``),
            s != null && (await t.invalidateQueries({ queryKey: f(s.commonDir, s.root, r) })));
        },
      };
    },
    { excludeFieldsFromKey: [`operationSource`] },
  ...
  Vn = P(
    ...
    (e, { queryClient: t, scope: n }) => {
      ...
      return {
        ...
        onSuccess: (a, o) => {
          a.status === `success` &&
            (me(n, { eventName: `codex_git_push_succeeded`, metadata: { forced: o.force ?? !1 } }),
            ...
            Rn(
              t,
              t.getQueryData(i(e.cwd, r, e.hostConfig, o.operationSource).queryKey),
              r,
              o.operationSource,
            ));
        },
  ...
  Hn = P(E, (e, { queryClient: t }) => {
    ...
    return {
      ...
      mutationFn: async (t) => {
        ...
        if (n.status === `error`)
          return { status: `create-error`, error: n.error, execOutput: n.execOutput };
      ...
      onSettled: (r, a, s) => {
        let c = t.getQueryData(i(e.cwd, n, e.hostConfig, e.operationSource).queryKey);
        c != null &&
          (o(t, c, { changeType: s.mode === `synced` ? `synced-branch` : `head`, hostKey: n }),
          r?.status === `success` &&
            s.mode === `synced` &&
...
async function Wn({
  ...
  if (l == null) return !1;
  let u = l.trim();
  if (u.length === 0) return (s.danger(c.formatMessage(Q.commitMessageEmpty)), !1);
  try {
    let r = await e
    ...
    return ($({ toaster: s, title: c.formatMessage(Q.commitErrorTitle), message: null }), !1);
  }
  return !0;
}
async function Gn({
  ...
  let u = { cwd: t, force: o };
  !r.upstreamRef && r.branch && ((u.refspec = `HEAD:refs/heads/${r.branch}`), (u.setUpstream = !0));
  try {
    let r = await e
    ...
    if (r.status === `error`)
      return (
        $({
          toaster: s,
          title: l,
          message: r.execOutput == null ? c.formatMessage(Q.pushErrorTitle) : null,
          execOutput: r.execOutput,
        }),
        !1
      );
...
async function Kn({
  ...
  if (i?.branch == null || i.defaultBranch == null)
    return (
      $({ toaster: u, title: d.formatMessage(Q.createPullRequestErrorTitle), message: null }), null
    );
  try {
    let f = await e
    ...
    return f.status === `success`
      ? (s &&
          f.url != null &&
          ue.dispatchMessage(`open-in-browser`, { url: f.url, useExternalBrowser: !0 }),
        { url: f.url })
      : ($({
          toaster: u,
...
async function Jn(e, t, n) {
  ...
  e.set(Y, r, { workflow: `commit`, phase: n.nextStep === `push` ? `pushing` : `committing` });
  try {
    let i = e.get(K, { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: t.operationSource }),
    ...
    if (n.nextStep !== `push`) {
      ...
      if (
        ...
        !(await Wn({
          ...
          commitAttribution: qn(e.get(R, { cwd: t.cwd, hostId: t.hostConfig.id }).data),
          operationSource: t.operationSource,
        })))
      )
        return !1;
    ...
    return (
      e
        .get(F)
        .success(
          s.formatMessage(n.nextStep === `commit` ? Q.commitSuccess : Q.pushSuccess, {
            branch: En(s, o),
          }),
        ),
      !0
...
async function Yn(e, t, n) {
  ...
  try {
    ...
    let u =
      l ??
      (await e
        .get(Mn, { conversationId: t.conversationId, cwd: t.cwd, hostConfig: t.hostConfig })
        ...
        prLabel:
          n == null
            ...
            : (0, q.jsx)(`a`, {
                ...
                onClick: (e) => {
                  (e.preventDefault(), ue.dispatchMessage(`open-in-browser`, { url: n }));
                },
                children: `PR`,
              }),
      },
...
function rr(e) {
  ...
  let le = k(wt, ce),
    ue;
  t[14] !== h || t[15] !== ae
    ? ((ue = { ...ae, operationSource: h }), (t[14] = h), (t[15] = ae), (t[16] = ue))
    : (ue = t[16]);
  let de = k(Zn, ue),
    pe;
  ...
  let z = Ce,
    ...
    Te;
  t[36] !== T || t[37] !== O
    ? ((Te = tr({ branchPrefix: T, conversationTitle: O })), (t[36] = T), (t[37] = O), (t[38] = Te))
    : (Te = t[38]);
  let Ee = x ?? Te,
    ke;
  ...
  t[45] !== o || t[46] !== U || t[47] !== s || t[48] !== h || t[49] !== Ie
    ? ((Le = { branch: U, cwd: o, enabled: Ie, hostConfig: s, operationSource: h }),
      (t[45] = o),
      (t[46] = U),
      (t[47] = s),
      (t[48] = h),
              ...
              (0, q.jsx)(`span`, {
                ...
                children:
                  L.isLoading || L.isFetching
                    ? (0, q.jsx)(be, { className: `icon-xs text-token-description-foreground` })
                    : null,
              }),
              (0, q.jsx)(ar, {
  ...
  t[111] !== qe || t[112] !== R || t[113] !== m || t[114] !== le || t[115] !== G
    ? ((mt = m
        ? (0, q.jsx)(or, {
            ...
            loading: !1,
            tooltipContent:
              R == null ? (0, q.jsx)(it, { reason: le }) : (0, q.jsx)(rt, { reason: R }),
...
function or(e) {
  ...
  t[9] !== i || t[10] !== c || t[11] !== f || t[12] !== s
    ? ((p = (0, q.jsx)(Re.Item, { disabled: i, value: s, onSelect: c, children: f })),
      (t[9] = i),
      (t[10] = c),
      (t[11] = f),
      (t[12] = s),
...
function cr(e) {
  ...
  t[2] === c
    ? (u = t[3])
    : ((u = S(`flex h-9 w-9 items-center justify-center rounded-xl`, c)), (t[2] = c), (t[3] = u));
  let d;
  t[4] !== n || t[5] !== u
  ...
  t[7] === o
    ? (f = t[8])
    : ((f = o
        ? (0, q.jsx)(be, { className: `icon-xs mt-0.5 text-token-description-foreground` })
        : null),
      (t[7] = o),
      (t[8] = f));
  let p;
...
function dr(e) {
  ...
  if (t[0] !== i || t[1] !== n || t[2] !== r) {
    ...
    (t[8] === i
      ? (c = t[9])
      : ((c = S(`flex flex-1 items-center justify-between gap-2`, i)), (t[8] = i), (t[9] = c)),
...
function pr(e) {
  ...
  t[4] !== r || t[5] !== c
    ...
    : (l = t[6]);
  let u;
  t[7] === a ? (u = t[8]) : ((u = S(`min-w-0 truncate text-right`, a)), (t[7] = a), (t[8] = u));
  let d;
  t[9] !== u || t[10] !== i
...
function mr(e) {
  let t = (0, W.c)(8),
    ...
    s;
  t[0] === o ? (s = t[1]) : ((s = S(`rounded-lg p-2`, o)), (t[0] = o), (t[1] = s));
  let c;
  return (
...
function _r(e) {
  ...
  t[3] === a
    ? (u = t[4])
    : ((u = S(`vertical-scroll-fade-mask max-h-64 overflow-y-auto [--edge-fade-distance:2rem]`, a)),
      (t[3] = a),
      (t[4] = u));
  let d;
  t[5] !== r || t[6] !== u
...
function br(e) {
  ...
  if (
    ...
    if (O) {
      ...
      (t[21] === n
        ? (r = t[22])
        : ((r = (0, q.jsxs)(H.Section, { className: `flex flex-col gap-1`, children: [e, n] })),
          (t[21] = n),
          (t[22] = r)),
        (w = r));
      ...
      (t[24] !== _ || t[25] !== p || t[26] !== m || t[27] !== r
        ? ((e = (e) =>
          ...
          (t[28] = e))
        : (e = t[28]),
        (w = (0, q.jsx)(H.Section, { className: `flex flex-col`, children: T.map(e) })));
    }
    ((t[0] = n),
      (t[1] = _),
      (t[2] = a),
