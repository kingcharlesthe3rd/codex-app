...
import { f as h, n as g, r as _, u as v } from "./vscode-api.js";
import { S as y, Wt as b } from "./src-4.js";
import {
  G as x,
  Jn as ee,
  Po as S,
...
import { c as ne, o as N, r as re } from "./lib-1.js";
import { c as ie, ct as ae, lt as oe, o as se, t as ce, ut as le } from "./persisted-signal.js";
import { a as ue, t as de } from "./setting-storage.js";
import { t as fe } from "./spinner.js";
import { t as pe } from "./check-md.js";
import { r as me, t as he } from "./tooltip.js";
import { a as ge } from "./thread-context-inputs.js";
import { a as _e } from "./use-model-settings.js";
import { r as P } from "./toast-signal.js";
import { m as F } from "./chunk-8.js";
import { t as ve } from "./branch.js";
import { t as ye } from "./use-debounced-value.js";
import { t as I } from "./route-scope.js";
import { o as be } from "./prompt-text.js";
import { t as xe } from "./x.js";
import { t as L } from "./sumBy.js";
import { i as Se, n as Ce } from "./git-current-branch-query.js";
import { t as R } from "./app-intl-signal.js";
import { n as we } from "./check-git-index-for-changes.js";
import { t as Te } from "./copy-to-clipboard.js";
import { d as Ee, l as De } from "./dialog-layout.js";
import { n as Oe } from "./electron-menu-shortcuts.js";
import { t as ke } from "./checkbox.js";
import { r as z, t as Ae } from "./dropdown.js";
import { t as je } from "./chevron.js";
import { t as B } from "./copy-D.js";
import { t as Me } from "./plus.js";
import { a as Ne, i as Pe, o as Fe, r as V, t as H } from "./gh-pull-request-status-query.js";
import { n as Ie } from "./dist-14.js";
import { n as Le } from "./use-git-default-branch.js";
import { r as Re } from "./diff-stats.js";
import { t as ze } from "./send-to-cloud.js";
import { t as Be } from "./cmdk.js";
import { t as Ve } from "./codex-analytics-attribution.js";
import { t as He } from "./get-default-branch-name.js";
var Ue = Se({
    method: `branch-exists`,
    getParams: (e) => ({ branch: e.branch, operationSource: e.operationSource, root: e.root }),
    getOptions: () => ({ select: (e) => e.exists, staleTime: v.FIVE_SECONDS }),
  }).fromCwd$,
  We = { type: `loading` },
  Ge = { type: `error` },
  Ke = Se({
  ...
  U = u(
    ...
    (e, { get: t }) => {
      let n = { ...e, enabled: !0 },
        r = t(w, { ...n, watchForGitInit: !1 }),
        i = t(Ke.fromCwd$, n),
        a = t(qe.fromCwd$, n),
        o = t(Je.fromCwd$, n);
      if (r.isError || i.isError || a.isError || o.isError) return Ge;
      if (!r.isSuccess || !i.isSuccess || !a.isSuccess || !o.isSuccess) return We;
      let s = r.data,
        c = i.data,
        l = a.data;
...
function Ye(e, t) {
  let n = { ...t, enabled: !0 };
  return Promise.all([e.get(Ke.fromCwd$, n).refetch(), e.get(qe.fromCwd$, n).refetch()]);
}
function Xe(e) {
  ...
  switch (n.kind) {
    case `commit`: {
      ...
      return (
        t[0] === n.reason
          ? (e = t[1])
          : ((e = (0, W.jsx)($e, { reason: n.reason })), (t[0] = n.reason), (t[1] = e)),
        e
      );
    }
    case `push`: {
      ...
      return (
        t[2] === n.reason
          ? (e = t[3])
          : ((e = (0, W.jsx)(et, { reason: n.reason })), (t[2] = n.reason), (t[3] = e)),
        e
      );
    }
    case `create-pr`: {
      ...
      return (
        t[4] === n.reason
          ? (e = t[5])
          : ((e = (0, W.jsx)(tt, { reason: n.reason })), (t[4] = n.reason), (t[5] = e)),
        e
      );
    }
  }
...
function rt({
  ...
  return i
    ? {
        canCommitPushAndCreatePullRequest: t == null && it(a) && it(n),
        canCreatePullRequest: !1,
        canPushAndCreatePullRequest: e > 0 && it(o) && it(n),
      }
    : {
...
function at({ hasSomeUncommittedChanges: e, isChangesLoading: t, isChangesUnavailable: n }) {
  switch (!0) {
    case t:
...
function ot({ pushStatus: e, ignoreNothingToPush: t = !1 }) {
  switch (!0) {
    case !e:
...
function lt(e, t) {
  let n = ut(e),
    r = t.flatMap((e) =>
      e?.type === `success`
        ? e.files.filter((e) => [e.path, e.previousPath].some((e) => e != null && ut(e) === n))
        : [],
    );
  return r.length === 0
    ? null
...
var dt = s(I, (e) =>
  ...
  ht = u(I, (e, { get: t }) => {
    ...
    return r == null
      ? k(n)
      : t(ft, { commonDir: r.commonDir, cwd: e.cwd, hostConfig: e.hostConfig, root: r.root });
  }),
  gt = u(I, (e, { get: t }) => {
    let n = t(mt, { cwd: e.cwd, hostConfig: e.hostConfig, source: `staged` }),
      r = e.includeUnstaged
        ? t(mt, { cwd: e.cwd, hostConfig: e.hostConfig, source: `unstaged` })
        : null,
      i = ct(r == null ? [n.data] : [n.data, r.data]);
    return {
  ...
  vt = u(I, (e, { get: t }) => {
    let n = t(U, bt(e));
    return ot({ pushStatus: n.type === `success` ? n.data : void 0 });
  }),
  yt = u(I, (e, { get: t }) => {
    let n = t(U, bt(e));
    return ot({ pushStatus: n.type === `success` ? n.data : void 0, ignoreNothingToPush: !0 });
  }),
  J = u(I, (e, { get: t }) => {
    let n = t(U, bt(e)),
      r = n.type === `success` ? n.data : void 0,
      i = t(_t, { ...e, includeUnstaged: e.includeLocalChanges }),
      a = t(vt, e),
      o = t(yt, e),
      s = xt(e, r?.branch ?? ``),
      c = t(V, s),
      l = t(Ne, e.hostConfig.id),
      u = t(H, s),
      d = st({ ghCliAvailability: l, hasOpenPr: u, isLoadingPRStatus: c.isLoading, pushStatus: r }),
      f = st({
      ...
      m = K({ ...p, createsBranch: e.createsBranch, includeLocalChanges: e.includeLocalChanges });
    return {
      blockedStep: St({
        ...p,
        commitBlockedReason: i,
...
var Ct = new Map(),
  Y = c(m, (e) => null),
  X = c(m, (e) => ``),
  wt = ce(`git-action-include-unstaged-changes`, !0),
  Tt = c(m, (e) => ``),
  Et = c(m, (e) => ``),
  Dt = c(m, (e) => !0);
function Ot(e, t) {
  (e.set(Tt, t, ``), e.set(Et, t, ``), e.set(Dt, t, !0));
}
function kt(e) {
  let t = new AbortController();
  return (Ct.set(Mt(e), t), t.signal);
}
function At(e) {
  Ct.get(Mt(e))?.abort();
}
function jt(e, t) {
  Ct.get(Mt(e))?.signal === t && Ct.delete(Mt(e));
}
function Mt(e) {
  return JSON.stringify([e.hostId, e.cwd]);
}
function Nt({ currentBranch: e, storedThreadBranch: t }) {
  let n = e?.trim() ?? ``,
    r = t?.trim() ?? ``;
  return {
    currentBranchName: n,
...
var Z = d(`LocalGitActionsScope`, {
  ...
  Rt = u(I, (e, { get: t }) => {
    ...
    return Nt({
      ...
      storedThreadBranch: t(j, e.conversationId),
    }).currentBranchName;
  }),
  zt = u(I, (e, { get: t }) => t(Pe, rn(e, t(Rt, e)))),
  Bt = u(I, (e, { get: t }) => t(H, rn(e, t(Rt, e)))),
  Vt = u(
    I,
    (e, { get: t }) =>
      Nt({ currentBranch: t(Rt, e), storedThreadBranch: t(j, e.conversationId) })
  ...
  Ut = a(Z, ({ get: e, scope: t }) => ({
    codexWorktree: t.value.codexWorktree,
    conversationId: t.value.conversationId,
    cwd: t.value.cwd,
    hostConfig: e(ge, t.value.hostId),
  })),
  Wt = a(Z, ({ get: e, scope: t }) => e(Y, { cwd: t.value.cwd, hostId: t.value.hostId })),
  Gt = a(Z, ({ get: e }) => e(_t, { ...e(Ut), includeUnstaged: !0 })),
  Kt = u(I, (e, { get: t }) => {
    let n = t(It, e);
    ...
    if (i) {
      ...
      if (t(_t, { ...e, includeUnstaged: !0 }) != null && (r?.commitsAhead ?? 0) === 0)
        return `hidden`;
    } else {
      let n = t(Lt, e).data;
    ...
    return t(J, {
      ...
      hostConfig: e.hostConfig,
      createsBranch: i,
      includeLocalChanges: t(Dt, { cwd: e.cwd, hostId: e.hostConfig.id }),
    }).blockedStep == null
      ? `enabled`
      : `disabled`;
  }),
  qt = a(Z, ({ get: e }) => e(Kt, e(Ut))),
  Jt = a(Z, ({ get: e }) => {
    let t = e(Ut),
      n = e(U, {
        cwd: t.cwd,
  ...
  Yt = a(Z, ({ get: e }) => e(Jt) && !e(Ht, e(Ut))),
  Xt = a(Z, ({ get: e }) => {
    let t = e(Ut),
      n = e(Gt),
      r = e(vt, t),
      i = e(yt, t);
    return r == null || (n == null && i == null) || (e(Jt) && n == null) ? null : r;
  }),
  Zt = a(Z, ({ get: e }) => {
    let t = e(Ut);
    return e(J, {
      cwd: t.cwd,
      hostConfig: t.hostConfig,
      createsBranch: e(Jt) || e(Ht, t),
      includeLocalChanges: e(Dt, { cwd: t.cwd, hostId: t.hostConfig.id }),
    }).blockedStep;
  }),
  Qt = a(Z, ({ get: e }) => {
    let t = e(Ut);
    return t.codexWorktree && e(It, t).isLoading;
  });
function $t(e) {
  if (e.get(Jt)) {
    (e.set(Ft, `commit`), e.set(Pt, `worktree-branch-setup`));
    return;
  }
  e.set(Pt, `commit`);
}
function en(e) {
  if (e.get(Yt)) {
    (e.set(Ft, `create-pr`), e.set(Pt, `worktree-branch-setup`));
    return;
  }
  e.set(Pt, `create-pr`);
}
function tn(e) {
  (e.set(Ft, null), e.set(Pt, `worktree-branch-setup`));
}
function nn(e) {
  let t = e.get(Ft) ?? `commit`;
  (e.set(Ft, null), e.set(Pt, t));
}
function rn(e, t) {
  return {
    cwd: e.cwd,
...
function an(
  ...
  if ((Ye(e, { cwd: n, hostConfig: r, operationSource: i }), a != null)) {
    a();
    return;
  }
  t != null &&
    (e.queryClient.invalidateQueries({
      queryKey: _(`gh-pr-summary`, { cwd: n, headBranch: t, hostId: r.id }),
    }),
    e.queryClient.invalidateQueries({
      queryKey: _(`gh-pr-status`, { cwd: n, headBranch: t, hostId: r.id }),
    }));
}
var on = `Testing note: If you mention tests, include unit tests or UI testing frameworks only. Skip lint/tsc since CI runs those.`,
  sn = `Untracked changes are not included.`;
function cn({
  ...
  let s = ln({ diffError: t, oversizedDiffSummary: r, uncommittedDiff: i });
  (s != null && a.push(s), a.length > 0 && a.push(on));
  let c = e?.trim() ?? ``;
  return (
    c.length > 0 &&
      a.push(
...
function ln({ diffError: e, oversizedDiffSummary: t, uncommittedDiff: n }) {
  if (t != null)
    return [
      `Changes:`,
...
`);
  if (e?.type === `diff-too-large`)
    return [`Changes:`, `Diff too large to include inline.`, ``, sn].join(`
`);
...
`),
  ...
  return (
    ...
    a.push(hn({ uncommittedDiff: t, filePaths: n })),
    a.join(`

`)
  );
}
function hn({ uncommittedDiff: e, filePaths: t }) {
  let n = e?.trim() ?? ``,
    r = (n.length > 0 ? gn(n) : 0) > fn,
    i = [`Changes:`];
  return n.length === 0 || r
    ? (i.push(_n(t)),
      i.join(`
...
var yn = 80;
function bn({ conversationId: e, tokenUsageInfo: t }) {
  if (e == null) return null;
  let { percent: n } = Be(t);
  return n == null || n < yn ? e : null;
}
function xn(e) {
  let t = (0, G.c)(18),
    ...
    ? ((m = d
        ? (0, W.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, W.jsx)(`pre`, { className: `m-0 whitespace-pre-wrap`, children: n }),
            ],
          })
        : null),
      (t[5] = n),
...
function Sn(e) {
  ...
  let d = u,
    ...
    h;
  t[4] !== f || t[5] !== p || t[6] !== m
    ? ((h = [f, p, m].filter(Cn)), (t[4] = f), (t[5] = p), (t[6] = m), (t[7] = h))
    : (h = t[7]);
  let g = h.join(`
`),
    _;
  ...
  t[11] !== s || t[12] !== o
    ? ((y = o
        ? (0, W.jsx)(`button`, {
            ...
            children: (0, W.jsx)(xe, { className: `icon-xs` }),
          })
        : null),
      (t[11] = s),
      (t[12] = o),
  ...
  t[17] !== r || t[18] !== x || t[19] !== ee
    ? ((S = (0, W.jsx)(xn, { command: x, output: ee, message: r })),
      (t[17] = r),
      (t[18] = x),
      (t[19] = ee),
      (t[20] = S))
    ...
    ? ((C =
        g.length > 0
          ? (0, W.jsx)(`button`, {
              ...
              children: (0, W.jsx)(B, { className: `icon-2xs` }),
            })
          : null),
      (t[21] = g),
      (t[22] = s),
  ...
  let w;
  t[24] !== S || t[25] !== C
    ? ((w = (0, W.jsxs)(`div`, { className: `relative`, children: [S, C] })),
      (t[24] = S),
      (t[25] = C),
      (t[26] = w))
    : (w = t[26]);
  ...
  t[27] === a
    ? (T = t[28])
    : ((T = a
        ? (0, W.jsx)(`div`, { className: `mt-2 flex items-center justify-end gap-2`, children: a })
        : null),
      (t[27] = a),
      (t[28] = T));
  let E;
...
function $({ toaster: e, title: t, message: n, execOutput: r }) {
  e.custom({
    duration: wn,
    content: ({ close: e }) => (0, W.jsx)(Sn, { title: t, message: n, execOutput: r, onClose: e }),
  });
}
function Tn(e, t) {
  let n = t?.trim() ?? ``;
...
var Dn = 1e3,
  On = `local_conversation_git_actions`,
  kn = o(m, (e, { get: t, scope: n }) => {
    let r = { cwd: e.cwd, hostId: e.hostConfig.id },
      i = bn({ conversationId: e.conversationId, tokenUsageInfo: t(x, e.conversationId) }),
      a = t(R),
      o = t(P);
    return {
      ...
      mutationFn: async ({ signal: t } = {}) => {
        ...
        let u;
        try {
          u = await g(`generate-commit-message`, {
            params: {
              hostId: e.hostConfig.id,
              prompt: await Nn(n, e, c, t),
              cwd: e.cwd,
              conversationId: i,
            },
            signal: t,
  ...
  An = o(m, (e, { get: t, scope: n }) => {
    ...
    return {
      ...
      mutationFn: async ({ headBranch: t, signal: s } = {}) => {
        ...
        let f;
        try {
          let [r, a] = await Promise.all([Nn(n, e, c, s), Mn(n, e, { headBranch: t, signal: s })]);
          if (a.trim().length === 0) return null;
          f = await g(`generate-commit-pull-request-message`, {
            params: {
              hostId: e.hostConfig.id,
        ...
        return s?.aborted
          ...
          : p.length === 0 || m.length === 0 || h.length === 0
            ? (o.danger(
              ...
              null)
            : (Pn(n, r, c, p),
              l.length === 0 && n.set(Tt, r, (e) => (e.trim().length === 0 ? m : e)),
              u.length === 0 && n.set(Et, r, (e) => (e.trim().length === 0 ? h : e)),
              { body: h, message: p, title: m });
      },
    };
  }),
  jn = o(m, (e, { get: t, scope: n }) => {
    let r = bn({ conversationId: e.conversationId, tokenUsageInfo: t(x, e.conversationId) }),
      i = t(R),
      a = t(P);
    return {
...
async function Mn(e, t, { headBranch: n, signal: r } = {}) {
  let [i, a, o] = await Promise.all([
      T(`git`).request({
        method: `review-patch`,
        params: { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: On, source: `branch` },
        signal: r,
      }),
      T(`git`).request({
        method: `branch-metadata`,
        params: { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: On },
        signal: r,
      }),
      T(`git`).request({
    ...
    s = e.get(U, { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: On }),
    c = s.type === `success` ? s.data : void 0;
  return mn({
    pullRequestInstructions: de(e.get, y.pullRequestInstructions) ?? null,
...
async function Nn(e, t, n, r) {
  let i = e.get(wt),
    a = await T(`git`).request({
      method: `commit-message-diff`,
      params: { cwd: t.cwd, hostConfig: t.hostConfig, includeUnstaged: i, operationSource: On },
      signal: r,
    }),
    o = un(a),
    ...
    l = c?.linesAdded ?? 0,
    u = c?.linesRemoved ?? 0,
    d = l + u > Dn ? { filesChanged: c?.filesChanged ?? 0, linesAdded: l, linesRemoved: u } : null;
  return cn({
    commitInstructions: de(e.get, y.commitInstructions) ?? null,
    diffError: s,
    draftMessage: n,
...
var Rn = o(
    ...
    (e, { queryClient: t, scope: n }) => {
      ...
      return {
        ...
        onSuccess: async (i, a) => {
          ...
          se(n, ae, {});
          let o = t.getQueryData(E(e.cwd, r, e.hostConfig, a.operationSource).queryKey);
          (In(t, o, r, a.operationSource),
            we(),
    ...
    (e, { scope: t }) => ({
      ...
      onSettled: (n, r, i) => {
        i.signal?.aborted &&
          ...
          t.queryClient.invalidateQueries({
            queryKey: _(`gh-pr-status`, { cwd: i.cwd, headBranch: i.headBranch, hostId: e.hostId }),
          }));
      },
      networkMode: `always`,
    }),
      ...
      return {
        ...
        onSuccess: (i, a) => {
          i.status === `success` &&
            ...
            Ln(
              t,
              t.getQueryData(E(e.cwd, r, e.hostConfig, a.operationSource).queryKey),
              r,
              a.operationSource,
            ));
        },
  ...
  Vn = o(m, (e, { queryClient: t }) => {
    let n = D(e.hostConfig);
    return {
      mutationKey: [
        `vscode`,
      ...
      mutationFn: async ({ signal: t, ...n }) => {
        let r = await g(`git-create-branch`, {
        ...
        let i = await g(`git-checkout-branch`, {
      ...
      onSettled: (r, i, a) => {
        let o = t.getQueryData(E(e.cwd, n, e.hostConfig, e.operationSource).queryKey);
        o != null &&
          (A(t, o, { changeType: a.mode === `synced` ? `synced-branch` : `head`, hostKey: n }),
          r?.status === `success` &&
            a.mode === `synced` &&
            A(t, o, { changeType: `head`, hostKey: n }));
      },
      networkMode: `always`,
    };
  });
async function Hn({
  ...
  try {
    let d = await e
      .get(Vn, { cwd: n, hostConfig: r, operationSource: i })
...
async function Un({
  ...
  try {
    let r = await e
      .get(Rn, { cwd: t, hostConfig: n, operationSource: a })
...
async function Wn({
  ...
  try {
    let r = await e
      .get(Bn, { cwd: t, hostConfig: n, operationSource: a })
...
async function Gn({
  ...
  try {
    let p = await e
      .get(zn, { cwd: n, hostId: r.id, operationSource: o })
      .mutateAsync({
        cwd: n,
        headBranch: i.branch,
    ...
    return u?.aborted
      ...
      : p.status === `success`
        ? (s &&
            p.url != null &&
            h.dispatchMessage(`open-in-browser`, { url: p.url, useExternalBrowser: !0 }),
          { url: p.url })
        : ($({
            toaster: d,
...
function Kn(e) {
  if (b(e, `codex_git_commit`) !== !0) return null;
...
async function qn(e, t, n) {
  ...
  try {
    ...
    if (
      ...
      ((c = await e
        .get(kn, { conversationId: t.conversationId, cwd: t.cwd, hostConfig: t.hostConfig })
    ...
    if (n.newBranch != null) {
      if (
        ...
        return !1;
      await Ye(e, { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: t.operationSource });
    }
    if (n.nextStep !== `push`) {
      if (
        n.newBranch == null &&
      ...
      if (
        ...
        !(await Un({
          ...
          commitAttribution: Kn(e.get(_e, { cwd: t.cwd, hostId: t.hostConfig.id }).data),
          operationSource: t.operationSource,
          signal: i,
        })))
      )
  ...
  try {
    ...
    let o = e.get(U, { cwd: t.cwd, hostConfig: t.hostConfig, operationSource: t.operationSource }),
      ...
      u =
        n.nextStep === `commit-push-and-create-pr`
          ? await e
              .get(An, { conversationId: t.conversationId, cwd: t.cwd, hostConfig: t.hostConfig })
    ...
    let d =
      u ??
      (await e
        .get(jn, { conversationId: t.conversationId, cwd: t.cwd, hostConfig: t.hostConfig })
        .mutateAsync({
          body: e.get(Et, r),
    ...
    if (n.nextStep === `commit-push-and-create-pr`) {
      if (n.newBranch == null && t.conversationId != null && e.get(Vt, t)) {
        let n = e.get(Rt, t);
        n.length > 0 && M(t.conversationId, n);
      }
      if (
    ...
    return f == null || n.openInBrowser ? f != null : (Yn(e, c, f.url), !0);
  } finally {
    (jt(r, i), e.set(Y, r, null));
  }
}
        ...
        prLabel:
          n == null
            ...
            : (0, W.jsx)(`a`, {
                ...
                onClick: (e) => {
                  (e.preventDefault(), h.dispatchMessage(`open-in-browser`, { url: n }));
                },
                children: `PR`,
              }),
      },
...
function Zn(e) {
  ...
  return (
    t[12] !== u || t[13] !== d
      ? ((f = (0, W.jsxs)(`div`, { className: `flex flex-col gap-1 px-3 pt-2`, children: [u, d] })),
        (t[12] = u),
        (t[13] = d),
        (t[14] = f))
      : (f = t[14]),
...
function $n(e) {
  let t = (0, G.c)(137),
    ...
    b = f(m),
    x = ne(),
    [ee, S] = (0, Ze.useState)(null),
    [C, w] = (0, Ze.useState)(null),
    T;
  t[0] !== o || t[1] !== s.id
    ? ((T = { cwd: o, hostId: s.id }), (t[0] = o), (t[1] = s.id), (t[2] = T))
    : (T = t[2]);
  let E = T,
    D = ue(y.branchPrefix),
    O = i(te, a),
    ...
    j = a ?? null,
    M;
  t[3] !== g || t[4] !== o || t[5] !== s || t[6] !== j
    ? ((M = { codexWorktree: g, conversationId: j, cwd: o, hostConfig: s }),
      (t[3] = g),
      (t[4] = o),
      (t[5] = s),
      (t[6] = j),
  ...
  let re = M,
    ...
    oe;
  t[8] !== o || t[9] !== s
    ? ((oe = { cwd: o, hostConfig: s }), (t[8] = o), (t[9] = s), (t[10] = oe))
    : (oe = t[10]);
  let se = i(vt, oe),
    ce;
  t[11] !== o || t[12] !== s
  ...
  let le = i(yt, ce),
    de;
  t[14] !== v || t[15] !== re
    ? ((de = { ...re, operationSource: v }), (t[14] = v), (t[15] = re), (t[16] = de))
    : (de = t[16]);
  let me = i(Xn, de),
    he;
  t[17] !== o || t[18] !== s || t[19] !== v
    ? ((he = { cwd: o, hostConfig: s, operationSource: v }),
      (t[17] = o),
      (t[18] = s),
      (t[19] = v),
      (t[20] = he))
    : (he = t[20]);
  let ge = i(U, he),
    _e = ge.type === `success` ? ge.data : void 0,
    P = i(Y, E),
    F = me.isPending || P != null,
    I;
  t[21] !== o || t[22] !== s || t[23] !== k
    ? ((I = { cwd: o, hostConfig: s, includeUnstaged: k }),
      (t[21] = o),
      (t[22] = s),
      (t[23] = k),
      (t[24] = I))
  ...
  t[25] !== o || t[26] !== s || t[27] !== k
    ? ((xe = { cwd: o, hostConfig: s, includeUnstaged: k }),
      (t[25] = o),
      (t[26] = s),
      (t[27] = k),
      (t[28] = xe))
  ...
  let L = i(_t, xe),
    Se;
  t[29] !== o || t[30] !== s
    ? ((Se = { cwd: o, hostConfig: s, includeUnstaged: !0 }),
      (t[29] = o),
      (t[30] = s),
      (t[31] = Se))
    : (Se = t[31]);
  let Ce = i(_t, Se),
    R = null;
  _e && (R = _e.branch ?? _e.upstreamRef ?? null);
  let we;
  t[32] !== ie || t[33] !== R || t[34] !== ae
    ? ((we = !ae && ie?.trim() ? ie.trim() : ae ? null : R),
      (t[32] = ie),
      (t[33] = R),
      (t[34] = ae),
      (t[35] = we))
  ...
  let Te = we,
    ...
    Ne;
  t[36] !== D || t[37] !== O
    ? ((Ne = He({ branchPrefix: D, conversationTitle: O })), (t[36] = D), (t[37] = O), (t[38] = Ne))
    : (Ne = t[38]);
  let Pe = C ?? Ne,
    Fe;
  ...
  t[45] !== o || t[46] !== H || t[47] !== s || t[48] !== v || t[49] !== Re
    ? ((Be = { branch: H, cwd: o, enabled: Re, hostConfig: s, operationSource: v }),
      (t[45] = o),
      (t[46] = H),
      (t[47] = s),
      (t[48] = v),
  ...
  let { data: Ve } = i(Ue, Be),
    We = H === V && Ve === !0,
    Ge;
  t[51] !== We || t[52] !== B || t[53] !== V
    ? ((Ge = B && (V.length === 0 || V.endsWith(`/`) || We)),
      (t[51] = We),
      (t[52] = B),
      (t[53] = V),
      (t[54] = Ge))
    : (Ge = t[54]);
  let Ke = Ge,
    qe = Ce == null || Ce === `changes-loading`,
    Je = L == null && !F && !Ke,
    Ye = !F && !Ke && (B ? (_e?.commitsAhead ?? 0) > 0 : se == null),
    Xe = Je && (B || le == null),
    tt;
  t[55] !== _ || t[56] !== x
    ? ((tt = _
  ...
  t[72] === nt
    ? (ot = t[73])
    : ((ot = (0, W.jsx)(Ee, { className: `sr-only`, children: nt })), (t[72] = nt), (t[73] = ot));
  let st;
  t[74] !== Oe || t[75] !== R || t[76] !== B || t[77] !== Te || t[78] !== F
    ? ((st = (0, W.jsx)(`span`, {
          ...
          ? (0, W.jsxs)(Ae, {
              ...
              triggerButton: (0, W.jsxs)(`button`, {
                ...
                children: [
                  ...
                  (0, W.jsx)(je, { className: `icon-2xs shrink-0` }),
                ],
              }),
              children: [
                (0, W.jsx)(z.SectionLabel, {
                  children: (0, W.jsx)(N, {
        ...
        ? (0, W.jsxs)(`span`, {
            ...
            children: [
              (0, W.jsx)(`span`, {
                ...
                children:
                  be.isLoading || be.isFetching
                    ? (0, W.jsx)(fe, { className: `icon-xs text-token-description-foreground` })
                    : null,
              }),
              (0, W.jsx)(tr, {
                isLoading: be.isLoading,
                isUnavailable: be.isUnavailable,
                selectionSummary: be.selectionSummary,
              }),
            ],
          })
        : null),
  ...
  t[83] !== st || t[84] !== q
    ...
    : (ct = t[85]);
  let lt;
  t[86] !== We || t[87] !== Pe || t[88] !== D || t[89] !== B || t[90] !== F
    ? ((lt = B
        ? (0, W.jsx)(Zn, {
            branchAlreadyExists: We,
            disabled: F,
            placeholder: D?.trim(),
            value: Pe,
            onChange: w,
  ...
  t[101] === L
    ? (ft = t[102])
    : ((ft = (0, W.jsx)($e, { reason: L })), (t[101] = L), (t[102] = ft));
  let pt;
  t[103] === K ? (pt = t[104]) : ((pt = () => K(`commit`)), (t[103] = K), (t[104] = pt));
  let mt;
  t[105] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (mt = t[105]);
  let ht;
  t[106] !== F || t[107] !== dt || t[108] !== ft || t[109] !== pt
    ? ((ht = (0, W.jsx)(nr, {
        Icon: Qe,
        disabled: dt,
        loading: F,
    ...
    : (ht = t[110]);
  let J;
  t[111] !== Xe || t[112] !== L || t[113] !== _ || t[114] !== le || t[115] !== K
    ? ((J = _
        ? (0, W.jsx)(nr, {
            Icon: ze,
            disabled: !Xe,
            loading: !1,
            tooltipContent:
              L == null ? (0, W.jsx)(et, { reason: le }) : (0, W.jsx)($e, { reason: L }),
    ...
    : (J = t[116]);
  let bt;
  t[117] !== Ye || t[118] !== _ || t[119] !== se || t[120] !== K
    ? ((bt = _
        ? (0, W.jsx)(nr, {
            Icon: ze,
            disabled: !Ye,
            loading: !1,
            tooltipContent: (0, W.jsx)(et, { reason: se }),
            value: `push`,
            onSelect: () => K(`push`),
            children: (0, W.jsx)(N, {
    ...
    : (bt = t[121]);
  let xt;
  t[122] !== ht || t[123] !== J || t[124] !== bt
    ? ((xt = (0, W.jsx)(`div`, {
        className: `border-t border-token-border-default py-1`,
        children: (0, W.jsx)(Ie.List, {
          children: (0, W.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [ht, J, bt] }),
        }),
      })),
      (t[122] = ht),
      (t[123] = J),
  ...
  let Ct;
  return (
    t[132] !== at || t[133] !== n || t[134] !== ot || t[135] !== St
      ? ((Ct = (0, W.jsxs)(De, {
          open: n,
          showDialogClose: !1,
          unstyledContent: !0,
...
function nr(e) {
  ...
  t[0] !== r || t[1] !== a
    ? ((l = a
        ? (0, W.jsx)(fe, { className: `icon-xs shrink-0` })
        : (0, W.jsx)(r, { className: `icon-xs shrink-0` })),
      (t[0] = r),
      (t[1] = a),
      (t[2] = l))
    : (l = t[2]);
  ...
  t[3] === n
    ? (u = t[4])
    : ((u = (0, W.jsx)(`span`, { className: `truncate`, children: n })), (t[3] = n), (t[4] = u));
  let d;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, W.jsx)(`span`, {
        ...
        children: (0, W.jsx)(me, { keysLabel: Oe(`CmdOrCtrl+Enter`), variant: `button` }),
      })),
      (t[5] = d))
    : (d = t[5]);
  let f;
  ...
  let h;
  t[14] === m ? (h = t[15]) : ((h = (0, W.jsx)(`div`, { children: m })), (t[14] = m), (t[15] = h));
  let g;
  return (
    t[16] !== h || t[17] !== o
      ? ((g = (0, W.jsx)(he, { tooltipContent: o, children: h })),
        (t[16] = h),
        (t[17] = o),
        (t[18] = g))
      : (g = t[18]),
...
function ir(e) {
  ...
  if (
    ...
    if (E) {
      ...
      (t[21] === n
        ? (r = t[22])
        : ((r = (0, W.jsxs)(z.Section, { className: `flex flex-col gap-1`, children: [e, n] })),
          (t[21] = n),
          (t[22] = r)),
        (C = r));
      ...
      (t[24] !== _ || t[25] !== p || t[26] !== m || t[27] !== r
        ? ((e = (e) =>
          ...
          (t[28] = e))
        : (e = t[28]),
        (C = (0, W.jsx)(z.Section, { className: `flex flex-col`, children: w.map(e) })));
    }
    ((t[0] = n),
      (t[1] = _),
      (t[2] = a),
