...
function o(e) {
  let t = (0, i.c)(74),
    ...
    I;
  t[0] !== P || t[1] !== F
    ? ((I = n(`flex gap-2 pb-0`, P, F)), (t[0] = P), (t[1] = F), (t[2] = I))
    : (I = t[2]);
  let L = I,
    R;
  t[3] !== L ||
  ...
  if (
    ...
    bb0: {
      let e = {
        ...
        r = n(`icon-sm shrink-0`, k === `infoAccent` && `text-token-text-link-foreground`, v),
        i = () =>
          (0, a.jsxs)(`div`, {
      ...
      if (
        ...
        let r = n(
          ...
          s;
        t[37] !== _ || t[38] !== i || t[39] !== o
          ? ((s = (_ || o) && i()), (t[37] = _), (t[38] = i), (t[39] = o), (t[40] = s))
          : (s = t[40]);
        let c;
        (t[41] === B ? (c = t[42]) : ((c = B(`gap-1.5`)), (t[41] = B), (t[42] = c)),
          (G = (0, a.jsx)(`div`, {
      ...
      if (M) {
        ...
        t[43] === o
          ...
          : ((s = o
            ...
            (t[44] = s));
        let c;
        t[45] === B ? (c = t[46]) : ((c = B()), (t[45] = B), (t[46] = c));
        let l;
        (t[47] !== z || t[48] !== s || t[49] !== c
          ? ((l = (0, a.jsxs)(`div`, {
      ...
      (t[51] === l
        ? (V = t[52])
        : ((V = n(`flex h-full w-full items-center gap-2`, l)), (t[51] = l), (t[52] = V)),
        (H = _ && (0, a.jsx)(_, { className: n(r, N && `max-[400px]:hidden`) })));
    }
    ((t[17] = _),
      (t[18] = C),
      (t[19] = s),
  ...
  t[53] === K
    ? (q = t[54])
    : ((q = n(`flex min-w-0 grow flex-row items-center justify-between gap-2`, K)),
      (t[53] = K),
      (t[54] = q));
  let J;
  t[55] === o
