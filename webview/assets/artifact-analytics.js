...
function f(e, t, { annotationModeEnabled: n, startSource: r }) {
  a(e, s, { ...g(t), annotationModeEnabled: n, startSource: v(r) });
}
function p(e, t) {
  a(e, d, { ...g(t) });
}
...
function h(
  e,
  n,
  { annotationModeEnabled: r, annotationTargetKind: i, submitMode: o, submitSource: s },
) {
  a(e, t, {
    ...g(n),
...
function _(e) {
  switch (e) {
    case `document`:
      return u.CODEX_ARTIFACT_KIND_DOCUMENT;
    case `notebook`:
      return u.CODEX_ARTIFACT_KIND_NOTEBOOK;
    case `pdf`:
      return u.CODEX_ARTIFACT_KIND_PDF;
    case `slides`:
      return u.CODEX_ARTIFACT_KIND_PRESENTATION;
    case `spreadsheet`:
      return u.CODEX_ARTIFACT_KIND_SPREADSHEET;
  }
}
function v(e) {
  switch (e) {
