...
function l(e, t, { annotationModeEnabled: n, startSource: r }) {
  s(e, c, { ...p(t), annotationModeEnabled: n, startSource: h(r) });
}
function u(e, t) {
  s(e, o, { ...p(t) });
}
...
function f(
  ...
  s(e, t, {
    ...
    ...(i == null ? {} : { annotationTargetKind: i }),
    submitMode: g(a),
    submitSource: _(o),
  });
}
function p({ artifactTabId: e, artifactType: t, importKind: n, threadId: r }) {
  return {
    artifactKind: m(t),
    artifactImportKind: n,
    ...(e == null ? {} : { artifactTabId: e }),
    ...(r == null ? {} : { threadId: r }),
  };
}
function m(e) {
...
function h(t) {
  switch (t) {
    case `annotation_mode_pointer`:
      return e.CODEX_ARTIFACT_ANNOTATION_START_SOURCE_ANNOTATION_MODE_POINTER;
    case `ask_codex_button`:
      return e.CODEX_ARTIFACT_ANNOTATION_START_SOURCE_ASK_CODEX_BUTTON;
    case `ask_codex_shortcut`:
      return e.CODEX_ARTIFACT_ANNOTATION_START_SOURCE_ASK_CODEX_SHORTCUT;
  }
}
function g(e) {
  switch (e) {
    case `direct`:
      return a.CODEX_ARTIFACT_ANNOTATION_SUBMIT_MODE_DIRECT;
    case `saved`:
      return a.CODEX_ARTIFACT_ANNOTATION_SUBMIT_MODE_SAVED;
  }
}
function _(e) {
  switch (e) {
...
export { u as i, l as n, f as r, d as t };
