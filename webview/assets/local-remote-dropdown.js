...
import { t as fe } from "./link-external.js";
import { n as pe } from "./use-webview-execution-target.js";
import { n as me } from "./composer-footer.js";
...
import { p as ye } from "./sidebar-project-groups-Bs-6klyU.js";
...
import { t as Me } from "./globe.js";
import { t as Ne } from "./chevron.js";
import { t as Pe } from "./cloud.js";
import { t as Fe } from "./macbook.js";
import { t as Ie } from "./worktree.js";
import { t as Le } from "./notebook.js";
import { t as Re } from "./settings.cog.js";
import { t as ze } from "./codex.js";
import { t as Be } from "./plus.js";
import { t as Ve } from "./use-git-current-branch-CZf-kxlj.js";
import { t as He } from "./rate-limit-summary.js";
import { t as Ue } from "./dist-10.js";
import { c as We, d as Ge, f as Ke } from "./local-remote-selection.js";
import { t as qe } from "./use-git-default-branch.js";
import { t as Je } from "./slash-command-item.js";
import { a as Ye, r as Xe } from "./git-branch-picker-dropdown-content.js";
...
function ht(e, t, n, r) {
  let a = (0, $.c)(9),
    o;
  a[0] === r ? (o = a[1]) : ((o = r === void 0 ? {} : r), (a[0] = r), (a[1] = o));
  let c = o,
    l = String(e),
    u;
  ...
  let f;
  return (
    a[7] === c ? (f = a[8]) : ((f = { staleTime: A.FIVE_SECONDS, ...c }), (a[7] = c), (a[8] = f)),
...
function vt(e) {
  ...
  return (
    t[4] !== o || t[5] !== s
      ? ((c = (0, Q.jsx)(`div`, { className: o, children: s })), (t[4] = o), (t[5] = s), (t[6] = c))
      : (c = t[6]),
    c
  );
}
function yt(e) {
  ...
  if (n.status === `queued` || n.status === `running`) {
    let e;
    return (
      t[0] === n ? (e = t[1]) : ((e = (0, Q.jsx)(bt, { operation: n })), (t[0] = n), (t[1] = e)), e
    );
  }
  if (n.status === `warning`) {
    let e;
    return (
      t[2] !== r || t[3] !== n
        ? ((e = (0, Q.jsx)(St, { operation: n, onClose: r })), (t[2] = r), (t[3] = n), (t[4] = e))
        : (e = t[4]),
      e
    );
  }
  if (n.status === `success`) {
    let e;
    return (
      t[5] === n ? (e = t[6]) : ((e = (0, Q.jsx)(xt, { operation: n })), (t[5] = n), (t[6] = e)), e
    );
  }
  let a;
  return (
...
function xt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(be, { className: `icon-md text-token-charts-green` })), (t[0] = r))
    : (r = t[0]);
  let i;
...
function St(e) {
  let t = (0, $.c)(12),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Q.jsx)(pt, { className: `icon-md text-token-editor-warning-foreground` })),
      (t[0] = i))
    : (i = t[0]);
  let a;
  ...
  return (
    t[9] !== o || t[10] !== c
      ? ((l = (0, Q.jsxs)(J, { className: `gap-0 px-6 py-5`, children: [o, c] })),
        (t[9] = o),
        (t[10] = c),
        (t[11] = l))
      : (l = t[11]),
...
function Ct(e) {
  let t = (0, $.c)(21),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(Ae, { className: `icon-md text-token-danger -ml-2` })), (t[0] = o))
    : (o = t[0]);
  let s;
  ...
  t[6] === a
    ...
    : ((l =
        a != null && a.output.length > 0
          ? (0, Q.jsx)(G, {
              className: `pt-5`,
              children: (0, Q.jsx)(vt, { command: a?.command, output: a.output }),
            })
          : null),
      (t[6] = a),
      (t[7] = l));
  ...
  let m;
  t[14] !== d || t[15] !== p
    ? ((m = (0, Q.jsx)(G, { className: `pt-5`, children: (0, Q.jsxs)(Y, { children: [d, p] }) })),
      (t[14] = d),
      (t[15] = p),
      (t[16] = m))
    : (m = t[16]);
...
function wt(e) {
  ...
  t[0] === n.status
    ? (i = t[1])
    : ((i = (0, Q.jsx)(Tt, { status: n.status })), (t[0] = n.status), (t[1] = i));
  ...
  return (
    t[13] !== i || t[14] !== d
      ? ((f = (0, Q.jsxs)(`div`, { className: `flex items-center gap-3`, children: [i, d] })),
        (t[13] = i),
        (t[14] = d),
        (t[15] = f))
      : (f = t[15]),
    ...
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(`span`, {
            ...
            children: (0, Q.jsx)(be, { className: `icon-2xs text-token-success` }),
          })),
          (t[1] = e))
        : (e = t[1]),
      e
    ...
    return (
      t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(`span`, {
            ...
            children: (0, Q.jsx)(he, { className: `icon-2xs text-token-editor-error-foreground` }),
          })),
          (t[2] = e))
        : (e = t[2]),
      e
...
function Et(e) {
  return (0, Q.jsx)(mt, { className: `icon-md rotate-90 text-token-foreground` });
}
function Dt(e) {
...
function Pt(e) {
  let r = (0, $.c)(63),
    ...
    x = Ye({ branchPrefix: re(t.branchPrefix) ?? void 0, conversationTitle: d }),
    S = y ?? (f || x),
    C = S.trim(),
    w = p(ne(_, l)),
    ...
    D = E ?? m,
    O = o(D),
    { data: te, isLoading: A, isFetching: j } = ht(E ?? m, w, `move_to_local_dialog`),
  ...
  r[0] === M?.worktrees
    ? (ae = r[1])
    : ((ae = new Set((M?.worktrees ?? []).map(Ft))), (r[0] = M?.worktrees), (r[1] = ae));
  let oe = ae,
    F;
  r[2] !== ie || r[3] !== oe
    ? ((F = (e) => oe.has(o(e)) || n(e, ie)), (r[2] = ie), (r[3] = oe), (r[4] = F))
    : (F = r[4]);
  let L = F,
    R,
    se,
    ...
    V,
    H;
  if (r[5] !== m || r[6] !== L || r[7] !== P || r[8] !== g || r[9] !== D || r[10] !== N?.labels) {
    let e;
    (r[17] === L ? (e = r[18]) : ((e = (e) => !L(e.root)), (r[17] = L), (r[18] = e)),
      (se = gt({ cwd: m, sourceWorktreeRoot: D, repoWorktreeEntries: (P ?? []).filter(e) })));
    let t;
    (r[19] === N?.labels ? (t = r[20]) : ((t = N?.labels ?? {}), (r[19] = N?.labels), (r[20] = t)),
      (H = t),
    ...
    ((z = n == null ? null : i(n)),
      ...
      (r[15] = V),
      (r[16] = H));
  } else ((R = r[11]), (se = r[12]), (z = r[13]), (B = r[14]), (V = r[15]), (H = r[16]));
  let ce = V,
    U = a && R != null,
    le;
  r[21] === U
    ? (le = r[22])
    : ((le = { enabled: U, refetchOnMount: `always`, refetchOnWindowFocus: `always` }),
      (r[21] = U),
      (r[22] = le));
  let { data: W, isLoading: ue, isFetching: fe } = Ve(R, w, `move_to_local_dialog`, le),
    pe = a && R != null,
    me;
  r[23] === pe
    ? (me = r[24])
    : ((me = { enabled: pe, refetchOnMount: `always`, refetchOnWindowFocus: `always` }),
      (r[23] = pe),
      (r[24] = me));
  let { data: he, isLoading: ge, isFetching: _e } = rt(R, w, `move_to_local_dialog`, me),
    G = (P ?? []).some((e) => {
      let t = o(e.root);
      return !(
        L(e.root) ||
    ...
    q = he?.type === `success` && he.stagedCount + he.unstagedCount + he.untrackedCount > 0,
    J = null;
  if (A || j) {
    let e;
    (r[25] === h
...
function It(e) {
  let t = (0, $.c)(108),
    ...
    M;
  t[0] !== d || t[1] !== p
    ? ((M = d == null ? null : Rt({ workspaceRoot: d.workspaceRoot, workspaceRootLabels: p })),
      (t[0] = d),
      (t[1] = p),
      (t[2] = M))
    : (M = t[2]);
  ...
  let ae = P,
    oe;
  t[15] !== O || t[16] !== A || t[17] !== r || t[18] !== b || t[19] !== T || t[20] !== te
    ? ((oe = (e) => {
        if (!e && A) {
  ...
  if (A && T != null) {
    ...
    return (
      t[35] !== re || t[36] !== F || t[37] !== r
        ? ((i = (0, Q.jsx)(q, { size: `compact`, open: re, onOpenChange: F, children: r })),
          (t[35] = re),
          (t[36] = F),
          (t[37] = r),
          (t[38] = i))
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = (0, Q.jsx)(Xe.Header, {
        icon: (0, Q.jsx)(mt, { className: `icon-base rotate-90 text-token-foreground` }),
      })),
      (t[41] = L))
    : (L = t[41]);
  let R;
  ...
  let U;
  t[58] !== ce || t[59] !== R
    ? ((U = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [R, ce] })),
      (t[58] = ce),
      (t[59] = R),
      (t[60] = U))
    : (U = t[60]);
        ...
        ie == null
          ...
          : (0, Q.jsxs)(`span`, {
              ...
              children: [
                ...
                (0, Q.jsx)(Ne, { className: `icon-xs shrink-0 text-token-description-foreground` }),
              ],
            })),
      (t[64] = ie),
      (t[65] = de));
  ...
  if (t[69] !== u || t[70] !== f || t[71] !== p) {
    ...
    (t[73] !== f || t[74] !== p
      ? ((e = (e) => {
          let t = Rt({ workspaceRoot: e.workspaceRoot, workspaceRootLabels: p });
          return (0, Q.jsx)(
            Z.Item,
            {
              ...
              children: (0, Q.jsx)(`span`, { className: `block truncate`, children: t }),
            },
            e.gitRoot,
          );
        }),
  ...
  let _e;
  t[85] !== U || t[86] !== ge
    ? ((_e = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [U, ge] })),
      (t[85] = U),
      (t[86] = ge),
      (t[87] = _e))
    : (_e = t[87]);
  ...
  t[97] !== K || t[98] !== J
    ? ((Y = (0, Q.jsx)(Xe.Footer, {
        ...
        right: (0, Q.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [K, J] }),
      })),
      (t[97] = K),
      (t[98] = J),
      (t[99] = Y))
  ...
  return (
    t[104] !== F || t[105] !== n || t[106] !== ve
      ? ((ye = (0, Q.jsx)(q, { size: `compact`, open: n, onOpenChange: F, children: ve })),
        (t[104] = F),
        (t[105] = n),
        (t[106] = ve),
        (t[107] = ye))
...
function zt(e) {
  ...
  let { data: F, isLoading: I, isFetching: L } = Ve(l, f, `move_to_worktree_dialog`, oe),
    R;
  n[2] !== a || n[3] !== l
  ...
  let { data: V, isLoading: H } = E(B),
    ...
    de = r && W,
    fe;
  n[13] === de ? (fe = n[14]) : ((fe = { enabled: de }), (n[13] = de), (n[14] = fe));
  let {
      data: pe,
      isLoading: me,
      isFetching: he,
  ...
  let { data: Y } = at(l, f, `move_to_worktree_dialog`, J),
    ...
    be;
  n[17] === c ? (be = n[18]) : ((be = (e) => !c || e !== c), (n[17] = c), (n[18] = be));
  ...
  if (M && C != null) {
    ...
    return (
      n[52] !== ie || n[53] !== Re || n[54] !== r
        ? ((i = (0, Q.jsx)(q, { size: `compact`, open: ie, onOpenChange: Re, children: r })),
          (n[52] = ie),
          (n[53] = Re),
          (n[54] = r),
          (n[55] = i))
  ...
  n[65] !== Ke || n[66] !== Je || n[67] !== Ze
    ? ((tt = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [Ke, Je, Ze] })),
      (n[65] = Ke),
      (n[66] = Je),
      (n[67] = Ze),
      (n[68] = tt))
  ...
  n[79] !== rt || n[80] !== it
    ? ((ot = (0, Q.jsx)(Xe.Footer, {
        className: `flex-col items-stretch gap-3`,
        right: (0, Q.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [rt, it] }),
      })),
      (n[79] = rt),
      (n[80] = it),
      (n[81] = ot))
  ...
  n[82] !== He.Root || n[83] !== Ue || n[84] !== tt || n[85] !== ot
    ? ((st = (0, Q.jsxs)(He.Root, { className: `gap-5`, children: [Ue, tt, ot] })),
      (n[82] = He.Root),
      (n[83] = Ue),
      (n[84] = tt),
      (n[85] = ot),
  ...
  return (
    n[87] !== Be || n[88] !== Re || n[89] !== r || n[90] !== st
      ? ((ct = (0, Q.jsx)(Be, { size: `compact`, open: r, onOpenChange: Re, children: st })),
        (n[87] = Be),
        (n[88] = Re),
        (n[89] = r),
        (n[90] = st),
...
function Ut(e) {
  ...
  t[7] === l
    ? (u = t[8])
    : ((u = (0, Q.jsx)(`span`, { className: `text-token-description-foreground`, children: l })),
      (t[7] = l),
      (t[8] = u));
  let d;
  return (
  ...
  Jt = ie(T, ({ get: e }) => {
    ...
    return {
      queryKey: [
        ...
        `results`,
        ...(0, Gt.default)(n, [`owner`, `repoName`]).flatMap(({ owner: e, repoName: t }) => [e, t]),
      ],
      enabled: t.isSuccess,
      staleTime: A.FIVE_MINUTES,
  ...
  return (
    await Promise.all(
      e.map(({ owner: e, repoName: t }) =>
        F.safeGet(`/wham/environments/by-repo/{provider}/{repo_owner}/{repo_name}`, {
...
var Xt = w(T, ({ get: e }) =>
    (0, Kt.default)([...(e(Jt).data ?? []), ...(e(qt).data ?? [])], (e) => e.id),
  ),
  ...
  Qt = (0, dt.memo)(function (e) {
    ...
    if (t[0] !== I.cwd || t[1] !== o || t[2] !== R || t[3] !== L) {
      let e = [...(L ?? []), ...(R ?? [])];
      ((se = vn({ executionTargetCwd: I.cwd, footerRemoteState: o, remoteConnections: e })),
        (t[0] = I.cwd),
        (t[1] = o),
        (t[2] = R),
        (t[3] = L),
    ...
    let we = Ce,
      ...
      Ee;
    t[18] !== P || t[19] !== W
      ? ((Ee = W ? P.formatMessage(_n.startInRemote) : P.formatMessage(_n.workLocally)),
        (t[18] = P),
        (t[19] = W),
        (t[20] = Ee))
      : (Ee = t[20]);
    let De = Ee,
      Oe;
    t[21] !== P || t[22] !== W
      ? ((Oe = W ? P.formatMessage(_n.remoteWorktreeTooltip) : P.formatMessage(_n.worktreeTooltip)),
        (t[21] = P),
        (t[22] = W),
        (t[23] = Oe))
      : (Oe = t[23]);
    ...
    (t[40] !== Be || t[41] !== Ve || t[42] !== He || t[43] !== qe
      ...
      We(Je));
    let Ye;
    t[45] === P ? (Ye = t[46]) : ((Ye = P.formatMessage(_n.runInCloud)), (t[45] = P), (t[46] = Ye));
    let Xe;
    t[47] === P
      ? (Xe = t[48])
      : ((Xe = P.formatMessage({
    ...
    let ut = lt,
      ft;
    t[61] !== i || t[62] !== I || t[63] !== G || t[64] !== W || t[65] !== O || t[66] !== s
      ? ((ft = () => {
          i == null ||
            s == null ||
            ve(O, fn, {
    ...
    t[77] !== S || t[78] !== P || t[79] !== gt || t[80] !== vt || t[81] !== E
      ? ((yt =
          E === `summary-panel`
            ? (0, Q.jsx)(Ze, {
                disabled: S,
                icon: (0, Q.jsx)(`span`, { className: `shrink-0`, children: gt }),
                label: (0, Q.jsxs)(`span`, {
                  className: `flex min-w-0 items-center gap-1 text-token-foreground`,
                  children: [
                    (0, Q.jsx)(`span`, { className: `min-w-0 truncate`, children: vt }),
                    S
                      ? null
                      : (0, Q.jsx)(Ne, { className: `icon-2xs shrink-0 text-token-text-tertiary` }),
                  ],
                }),
            ...
            : (0, Q.jsxs)(le, {
                ...
                children: [
                  gt,
                  (0, Q.jsx)(me, { collapse: `xs`, className: `max-w-40 truncate`, children: vt }),
                  (0, Q.jsx)(Ne, { className: `icon-2xs text-token-input-placeholder-foreground` }),
                ],
              })),
        (t[77] = S),
        (t[78] = P),
          ...
          (0, Q.jsx)(je, {
            ...
            triggerButton:
              E === `summary-panel`
                ? bt
                : (0, Q.jsx)(z, {
                    tooltipContent: (0, Q.jsx)(D, { ..._n.localRemoteWhereRun }),
                    children: bt,
                  }),
            children: (0, Q.jsx)($t, {
              composerMode: n,
    ...
    t[119] !== Tt || t[120] !== Dt || t[121] !== Et
      ? ((Ot =
          Tt || Dt
            ? (0, Q.jsxs)(`div`, { className: `flex items-center gap-1`, children: [Tt, Et] })
            : null),
        (t[119] = Tt),
        (t[120] = Dt),
        (t[121] = Et),
    ...
    t[123] === I.cwd
      ? (At = t[124])
      : ((At = I.cwd
          ? (0, Q.jsx)(`span`, { className: `block font-mono text-xs break-all`, children: I.cwd })
          : null),
        (t[123] = I.cwd),
        (t[124] = At));
    let jt = At,
    ...
    t[150] !== K || t[151] !== n || t[152] !== J || t[153] !== Y
      ? ((zt =
          K && n === `cloud` && J == null ? (0, Q.jsx)(un, { setSelectedEnvironment: Y }) : null),
        (t[150] = K),
        (t[151] = n),
        (t[152] = J),
        (t[153] = Y),
    ...
    t[155] !== _ || t[156] !== It
      ? ((Bt = (0, Q.jsx)(_e, {
          extension: !0,
          children: (0, Q.jsxs)(`div`, { className: `flex items-center gap-1`, children: [It, _] }),
        })),
        (t[155] = _),
        (t[156] = It),
        (t[157] = Bt))
    ...
    return (
      ...
      t[170] !== Vt ||
      t[171] !== Ht
        ? ((Ut = (0, Q.jsxs)(Q.Fragment, { children: [Lt, Rt, zt, Bt, Vt, Ht] })),
          (t[166] = Lt),
          (t[167] = Rt),
          (t[168] = zt),
          (t[169] = Bt),
...
function $t(e) {
  let t = (0, $.c)(123),
    ...
    F = oe?.plan_type,
    I;
  t[0] === F ? (I = t[1]) : ((I = Se(F)?.pricePlan ?? null), (t[0] = F), (t[1] = I));
  let L = I,
    R = oe?.rate_limit,
    se = oe?.credits,
    z;
  ...
  if (
    ...
    ((H = Oe(e, { activeLimitName: n, selectedModel: N })),
      ...
      (le = H.some(en) || !!B?.primary?.windowDurationMins || !!B?.secondary?.windowDurationMins),
      (t[6] = B?.primary?.windowDurationMins),
      (t[7] = B?.secondary?.windowDurationMins),
      (t[8] = oe),
      (t[9] = N),
        ...
        q?.status === `queued` || q?.status === `running`
          ...
          : q?.status === `error`
            ...
            : q?.hasUnseenTerminalState && q.status === `warning`
              ? (0, Q.jsx)(pt, { className: `icon-2xs text-token-editor-warning-foreground` })
  ...
  t[37] !== i || t[38] !== s.hostConfig || t[39] !== y
    ? ((Le = (0, Q.jsx)(pn, { composerMode: i, gitRoot: y, hostConfig: s.hostConfig })),
      (t[37] = i),
      (t[38] = s.hostConfig),
      (t[39] = y),
      (t[40] = Le))
  ...
  let Be = u === `enabled` ? `min-w-[175px]` : `w-52`,
    Ve;
  t[46] === Be ? (Ve = t[47]) : ((Ve = S(`flex flex-col`, Be)), (t[46] = Be), (t[47] = Ve));
  let Ue;
  ...
  t[50] !== A || t[51] !== i || t[52] !== j || t[53] !== a
    ? ((Ge = () => {
        (i !== `local` &&
          ae(j, { eventName: `codex_composer_runtime_changed`, metadata: { mode: `local` } }),
          a(`local`),
          A());
      }),
      (t[50] = A),
  ...
  t[55] === p
    ? (Ke = t[56])
    : ((Ke = p ? (0, Q.jsx)(D, { ..._n.startInRemote }) : (0, Q.jsx)(D, { ..._n.workLocally })),
      (t[55] = p),
      (t[56] = Ke));
  let qe;
  ...
  t[79] !== u || t[80] !== E || t[81] !== b
    ? ((Xe = u === `enabled` ? (0, Q.jsx)(nn, { selectedEnvironment: b, onClick: E }) : null),
      (t[79] = u),
      (t[80] = E),
      (t[81] = b),
      (t[82] = Xe))
  ...
  t[83] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ze = (0, Q.jsx)(`div`, { className: `mx-1 my-1.5 h-[0.5px] bg-token-foreground/10` })),
      (t[83] = Ze))
    : (Ze = t[83]);
  let Qe;
  t[84] !== V ||
  ...
  t[105] !== pe
    ...
    : (nt = t[106]);
  let rt;
  t[107] !== Fe || t[108] !== Y || t[109] !== X || t[110] !== je || t[111] !== Ce || t[112] !== ye
    ? ((rt = ye
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              (0, Q.jsx)(Z.Separator, {}),
  ...
  return (
    ...
    t[120] !== nt ||
    t[121] !== rt
      ? ((it = (0, Q.jsxs)(`div`, { className: Ve, children: [Ue, qe, Je, Ye, tt, nt, rt] })),
        (t[114] = Ve),
        (t[115] = Ue),
        (t[116] = qe),
        (t[117] = Je),
...
function nn(e) {
  ...
  return (
    t[0] !== r || t[1] !== n || t[2] !== s
      ? ((c = (0, Q.jsx)(Ut, { selectedEnvironment: n, zeroEnvironments: s, onClick: r })),
        (t[0] = r),
        (t[1] = n),
        (t[2] = s),
        (t[3] = c))
...
function on(e) {
  ...
  if (a === `loading`) {
    ...
    (t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(W, { className: `icon-xxs text-token-description-foreground` }),
        })),
        (t[3] = e))
      : (e = t[3]),
      (h = e));
  ...
  t[22] === f
    ...
    : ((g = f.formatMessage({
      ...
      (t[23] = g));
  let _;
  t[24] === i ? (_ = t[25]) : ((_ = (e) => i(e.target.value)), (t[24] = i), (t[25] = _));
  let v;
  t[26] !== n || t[27] !== g || t[28] !== _
    ? ((v = (0, Q.jsx)(Z.Section, {
        className: `my-1`,
        children: (0, Q.jsx)(Z.SearchInput, { placeholder: g, value: n, onChange: _ }),
      })),
      (t[26] = n),
      (t[27] = g),
      (t[28] = _),
  ...
  return (
    t[30] !== h || t[31] !== v
      ? ((y = (0, Q.jsxs)(`div`, { className: `flex flex-col`, children: [v, h] })),
        (t[30] = h),
        (t[31] = v),
        (t[32] = y))
      : (y = t[32]),
...
function dn(e) {
  ...
  t[3] !== a || t[4] !== g || t[5] !== _ || t[6] !== c
    ? ((y = ut({
        ...
        handoffDirection: lt({ codexWorktree: !1, operation: _, threadHandoff: c }),
        operation: _,
        threadHandoff: c,
      })),
      (t[3] = a),
  ...
  t[19] !== o.cwd || t[20] !== b || t[21] !== f || t[22] !== l
    ? ((k =
        f === `summary-panel`
          ? (0, Q.jsx)(Ze, {
              icon: (0, Q.jsx)(Ie, { className: `icon-sm shrink-0 text-token-foreground` }),
              label: (0, Q.jsxs)(`span`, {
                className: `flex min-w-0 items-center gap-1 text-token-foreground`,
                children: [
                  (0, Q.jsx)(`span`, { className: `min-w-0 truncate`, children: l }),
                  b
                    ? (0, Q.jsx)(Ne, { className: `icon-2xs shrink-0 text-token-text-tertiary` })
                    : null,
                ],
    ...
    ? ((M = b
        ? (0, Q.jsx)(je, {
            ...
            triggerButton:
              f === `summary-panel`
                ? A
                : (0, Q.jsx)(z, { tooltipContent: u, tooltipMaxWidth: d, children: A }),
        ...
        : (0, Q.jsx)(z, {
            ...
            children: (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(`div`, { className: `pointer-events-none`, children: A }),
            }),
          })),
      (t[26] = te),
      (t[27] = x),
...
function fn(e) {
  ...
  let f = ne(ge, d),
    p = et(i),
    m;
  t[3] !== u?.codexHome || t[4] !== o.activeWorkspaceRoot || t[5] !== l || t[6] !== p || t[7] !== c
    ? ((m = lt({
...
function vn({ executionTargetCwd: e, footerRemoteState: t, remoteConnections: n }) {
  ...
  return a == null || a === `local` || o == null
    ? null
    : { hostId: a, connectionDisplayName: i?.connectionDisplayName ?? yn(n, a), projectPath: o };
}
function yn(e, t) {
