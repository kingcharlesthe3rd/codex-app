...
import { n as Jn, r as Yn } from "./git-submodule-paths-query.js";
import { a as Xn, c as Zn, i as Qn, o as $n, r as er, s as tr } from "./git-branch-switcher.js";
import { n as nr, t as rr } from "./dock.js";
import { n as ir, t as ar } from "./use-codex-worktrees.js";
function or(e, t, n) {
  let r = (0, cr.c)(15),
    i = (0, dr.useDeferredValue)(e),
    a = t?.id,
    o;
  r[0] !== i || r[1] !== a
  ...
  (r[6] !== s || r[7] !== p || r[8] !== n
    ...
    : ((h = r[9]), (g = r[10])),
    (0, dr.useEffect)(h, g));
  let _ = c instanceof oe && c.status === 404,
    v;
  v =
    u.length > 0
      ? `list`
  ...
  return (
    await Promise.all(
      e.map(({ owner: e, repoName: t }) =>
        he.safeGet(`/wham/environments/by-repo/{provider}/{repo_owner}/{repo_name}`, {
  ...
  gr = e(() => {
    ((cr = Le()),
      ...
      (fr = z(v, () => ({
        ...
        queryFn: async () => he.safeGet(`/wham/environments`),
        placeholderData: Ne,
        staleTime: D.FIVE_MINUTES,
      }))),
      (pr = z(v, ({ get: e }) => {
        let t = e(Dt, { params: void 0, source: `workspace_repo_owner_names` }),
          n = He(t.data?.origins ?? []);
        return {
          queryKey: [
            `workspace`,
            ...
            `results`,
            ...(0, lr.default)(n, [`owner`, `repoName`]).flatMap(({ owner: e, repoName: t }) => [
              e,
              t,
            ]),
          ],
          enabled: t.isSuccess,
          staleTime: D.FIVE_MINUTES,
          queryFn: sr.bind(null, n),
        };
      })),
      (mr = y(v, ({ get: e }) =>
        (0, ur.default)([...(e(pr).data ?? []), ...(e(fr).data ?? [])], (e) => e.id),
      )),
      (hr = f(v, ({ envQuery: e, selectedEnvironmentId: t }, { get: n }) => {
        let r = n(fr),
          i = n(pr).data ?? [],
...
function _r({ cloudAccess: e, hasGitRepository: t, isBrowser: n }) {
...
function br(e) {
  ...
  t[0] !== p.cwd || t[1] !== p.hostConfig
    ? ((m = {
      ...
      (t[2] = m))
    : (m = t[2]);
  let h = _r({ cloudAccess: f, hasGitRepository: we(Nt, m)?.root != null, isBrowser: !1 });
  if (n !== `cloud` || !h) return null;
  let g;
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, q.jsx)(rr, { className: `icon-xs` })), (t[5] = v))
    : (v = t[5]);
  let y;
  t[6] === u
    ? (y = t[7])
  ...
  let w;
  return (
    t[16] !== i || t[17] !== c || t[18] !== s || t[19] !== b || t[20] !== C
      ? ((w = (0, q.jsx)(Re, {
...
function xr(e) {
  let t = (0, Cr.c)(35),
    ...
    [s, c] = (0, wr.useState)(``),
    { envListState: l, listToShow: u, zeroEnvironments: d } = or(s, n, i),
    f = ie(),
    p;
  if (d) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, q.jsx)(ot, { href: W, className: Tr })), (t[0] = e))
      : (e = t[0]);
    let n;
    ...
    if (l === `loading`) {
      ...
      (t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((n = (0, q.jsx)(`div`, {
            ...
            children: (0, q.jsx)(vt, { className: `icon-xxs text-token-description-foreground` }),
          })),
          (t[2] = n))
        : (n = t[2]),
        (e = n));
      ...
      let s;
      if (t[5] !== a || t[6] !== u || t[7] !== n?.id || t[8] !== r || t[9] !== i) {
        let e;
      ...
      let f;
      (t[20] !== s || t[21] !== d
        ? ((f = (0, q.jsxs)(q.Fragment, { children: [s, c, d] })),
          (t[20] = s),
          (t[21] = d),
          (t[22] = f))
        : (f = t[22]),
    ...
    t[26] !== s || t[27] !== d
      ? ((h = (0, q.jsx)(K.Section, {
          className: `my-1`,
          children: (0, q.jsx)(K.SearchInput, { placeholder: d, value: s, onChange: m }),
        })),
        (t[26] = s),
        (t[27] = d),
        (t[28] = h))
    ...
    let g;
    (t[29] !== e || t[30] !== h
      ? ((g = (0, q.jsxs)(`div`, { className: `flex flex-col`, children: [h, e] })),
        (t[29] = e),
        (t[30] = h),
        (t[31] = g))
      : (g = t[31]),
  ...
  return (
    t[33] === p
      ? (h = t[34])
      : ((h = (0, q.jsxs)(`div`, { className: `flex w-64 flex-col`, children: [m, p] })),
        (t[33] = p),
        (t[34] = h)),
    h
  );
...
function Sr(e) {
  je({ disposition: `current-tab`, event: e, href: W, initiator: `open_in_browser_bridge` });
}
var Cr,
  wr,
  q,
...
function Ur(e, t, n, r, i) {
  ...
  return (
    a[3] === i
      ? (s = a[4])
      : ((s = { select: Wr, staleTime: D.FIVE_SECONDS, ...i }), (a[3] = i), (a[4] = s)),
    kt(e, t, `branch-exists`, o, r, s)
  );
}
function Wr(e) {
  return e.exists;
...
function Qr(e) {
  ...
  if (t[0] !== n) {
    ...
    (t[7] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      (t[5] = s),
      (t[6] = l));
  } else ((r = t[1]), (i = t[2]), (a = t[3]), (o = t[4]), (s = t[5]), (l = t[6]));
  let u;
  t[11] !== r || t[12] !== a || t[13] !== o
    ? ((u = (0, J.jsx)(r, { className: a, children: o })),
      (t[11] = r),
      (t[12] = a),
      (t[13] = o),
      (t[14] = u))
  ...
  let d;
  return (
    t[15] !== i || t[16] !== s || t[17] !== l || t[18] !== u
      ? ((d = (0, J.jsxs)(i, { className: s, children: [l, u] })),
        (t[15] = i),
        (t[16] = s),
        (t[17] = l),
        (t[18] = u),
...
function $r(e) {
  let t = (0, li.c)(8),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, J.jsx)(Ae, { className: `icon-md text-token-charts-green` })), (t[0] = r))
    : (r = t[0]);
  let i;
...
function ei(e) {
  ...
  return (
    t[9] !== o || t[10] !== l
      ? ((u = (0, J.jsxs)(zt, { className: `gap-0 px-6 py-5`, children: [o, l] })),
        (t[9] = o),
        (t[10] = l),
        (t[11] = u))
      : (u = t[11]),
...
function ti(e) {
  let t = (0, li.c)(21),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, J.jsx)(sn, { className: `icon-md text-token-danger -ml-2` })), (t[0] = o))
    : (o = t[0]);
  let s;
  ...
  let h;
  t[14] !== f || t[15] !== m
    ? ((h = (0, J.jsx)(Lt, { className: `pt-5`, children: (0, J.jsxs)(pe, { children: [f, m] }) })),
      (t[14] = f),
      (t[15] = m),
      (t[16] = h))
    : (h = t[16]);
...
var li,
  J,
  ui = e(() => {
    ((li = Le()), R(), Me(), m(), Xr(), Pt(), zr(), Hr(), bn(), ln(), (J = Et()));
  });
function di(e) {
  let t = (0, fi.c)(8),
    n = ie(),
    r = we(yn, e),
    { data: i, isError: a, isLoading: o } = me(lt.QUEUED_FOLLOW_UPS);
  switch (
    $t({
...
function mi(e) {
  let t = (0, _i.c)(109),
    ...
    m = di(a),
    h = we(ze, a) ?? !1,
    [g, _] = (0, vi.useState)(null),
    { data: v } = me(lt.GIT_BRANCH_PREFIX),
    y = dn({ branchPrefix: v ?? void 0, conversationTitle: s }),
    b = ce(),
    S;
  ...
  let w = S.length === 0,
    ...
    O;
  t[2] !== a || t[3] !== b
    ? ((O = b.getMaybeForConversationId(a)?.getConversation(a)?.forkedFromId ?? null),
      (t[2] = a),
      (t[3] = b),
      (t[4] = O))
    : (O = t[4]);
  let k = O,
    A;
  t[5] !== u || t[6] !== d || t[7] !== k
    ? ((A = [`move-thread`, `to-host-worktree`, `resolve-owned-worktree`, u, d, k]),
      (t[5] = u),
      (t[6] = d),
      (t[7] = k),
      (t[8] = A))
  ...
  let M = n && k != null,
    ee;
  t[14] !== A || t[15] !== j || t[16] !== M
    ? ((ee = { queryKey: A, queryFn: j, enabled: M, staleTime: 0 }),
      (t[14] = A),
      (t[15] = j),
      (t[16] = M),
      (t[17] = ee))
    : (ee = t[17]);
  let { data: N } = De(ee),
    P = N?.worktreeGitRoot != null && N?.worktreeWorkspaceRoot != null,
    te = o.pastedTextAttachments.length > 0,
    F = n && !te && w && E.length > 0 && !E.endsWith(`/`),
    ne;
  t[18] === F ? (ne = t[19]) : ((ne = { enabled: F }), (t[18] = F), (t[19] = ne));
  let { data: re, isPending: I } = Ur(d, D, E, `move_to_host_worktree`, ne),
    L = null;
  if (m != null) L = m;
  else if (te) {
    let e;
  ...
  let ae = L != null,
    { activeOperationId: R } = wn(),
    z = xn(a),
    {
      addToHostWorktreeOperation: oe,
    ...
    V = z != null && R === z.id,
    H = n || V,
    de = z?.status === `success` || z?.status === `warning` || z?.status === `error`,
    fe;
  t[30] !== se || t[31] !== V || t[32] !== r || t[33] !== z || t[34] !== B || t[35] !== de
    ? ((fe = (e) => {
        if (!e && V) {
          if (de) {
            (B(z.id), r(!1));
          ...
          (le(
            oe({
              ...
              stepIds: [
                ...
                P ? `reuse-existing-worktree` : `create-new-worktree`,
  ...
  if (V && z != null) {
    let e;
    t[49] !== se || t[50] !== z.id || t[51] !== B || t[52] !== de
      ? ((e = () => {
          if (de) {
            B(z.id);
            return;
    ...
    t[60] !== ue
      ...
      : (n = t[61]);
    let i;
    t[62] !== z || t[63] !== e || t[64] !== n
      ? ((i = (0, Y.jsx)(Zr, { operation: z, onClose: e, onRetry: n })),
        (t[62] = z),
        (t[63] = e),
        (t[64] = n),
        (t[65] = i))
    ...
    let a;
    return (
      t[66] !== H || t[67] !== pe || t[68] !== i
        ? ((a = (0, Y.jsx)(_e, { size: `compact`, open: H, onOpenChange: pe, children: i })),
          (t[66] = H),
          (t[67] = pe),
          (t[68] = i),
          (t[69] = a))
  ...
  let be;
  t[80] !== ye || t[81] !== W
    ? ((be = (0, Y.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [ye, W] })),
      (t[80] = ye),
      (t[81] = W),
      (t[82] = be))
    : (be = t[82]);
  let xe;
  t[83] !== T || t[84] !== p || t[85] !== w
    ? ((xe = w
        ? (0, Y.jsxs)(`div`, {
  ...
  let G;
  t[87] !== be || t[88] !== xe
    ? ((G = (0, Y.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [be, xe] })),
      (t[87] = be),
      (t[88] = xe),
      (t[89] = G))
    : (G = t[89]);
  ...
  t[95] === L
    ...
    : ((Ee =
      ...
      (t[96] = Ee));
  let Oe;
  t[97] !== Se || t[98] !== Te || t[99] !== Ee
    ? ((Oe = (0, Y.jsx)(Gt.Footer, {
  ...
  let Ae;
  return (
    t[105] !== pe || t[106] !== n || t[107] !== ke
      ? ((Ae = (0, Y.jsx)(_e, { size: `compact`, open: n, onOpenChange: pe, children: ke })),
        (t[105] = pe),
        (t[106] = n),
        (t[107] = ke),
        (t[108] = Ae))
...
function Ci(e) {
  let t = (0, Oi.c)(63),
    ...
    l = ie(),
    u = di(i),
    [d, f] = (0, ki.useState)(null),
    [p, m] = (0, ki.useState)(null),
    h = dn({ branchPrefix: fe(Ge.branchPrefix) ?? void 0, conversationTitle: o }),
    g = p ?? (s || h),
    _ = g.trim(),
    v = C(we(j, i)),
    { data: y } = We(c, v, `move_to_local_dialog`),
    b = y?.root ?? null,
    x = b ?? c,
    S = It(x),
    { data: w, isLoading: T, isFetching: E } = bi(b ?? c, v, `move_to_local_dialog`),
    { data: D } = ir(v, `move_to_local_dialog`),
    O = st(v.id),
    { data: k } = Oe(ge),
    A = w?.worktrees,
    M;
  t[0] === D?.worktrees
    ? (M = t[1])
    : ((M = new Set((D?.worktrees ?? []).map(wi))), (t[0] = D?.worktrees), (t[1] = M));
  let ee = M,
    N;
  t[2] !== O || t[3] !== ee
    ? ((N = (e) => ee.has(It(e)) || ne(e, O)), (t[2] = O), (t[3] = ee), (t[4] = N))
    : (N = t[4]);
  let P = N,
    F,
    re,
    ...
    ae,
    R;
  if (t[5] !== c || t[6] !== P || t[7] !== A || t[8] !== d || t[9] !== x || t[10] !== k?.labels) {
    let e;
    (t[17] === P ? (e = t[18]) : ((e = (e) => !P(e.root)), (t[17] = P), (t[18] = e)),
      (re = an({ cwd: c, sourceWorktreeRoot: x, repoWorktreeEntries: (A ?? []).filter(e) })));
    let n;
    (t[19] === k?.labels ? (n = t[20]) : ((n = k?.labels ?? {}), (t[19] = k?.labels), (t[20] = n)),
      (R = n),
      (L = re.find((e) => e.gitRoot === d) ?? re[0] ?? null));
    ...
    ((I = r == null ? null : te(r)),
      ...
      (t[15] = ae),
      (t[16] = R));
  } else ((F = t[11]), (re = t[12]), (I = t[13]), (L = t[14]), (ae = t[15]), (R = t[16]));
  let z = ae,
    oe = n && F != null,
    se;
  t[21] === oe
    ? (se = t[22])
    : ((se = { enabled: oe, refetchOnMount: `always`, refetchOnWindowFocus: `always` }),
      (t[21] = oe),
      (t[22] = se));
  let { data: ce, isLoading: B, isFetching: le } = qt(F, v, `move_to_local_dialog`, se),
    ue = n && F != null,
    V;
  t[23] === ue
    ? (V = t[24])
    : ((V = { enabled: ue, refetchOnMount: `always`, refetchOnWindowFocus: `always` }),
      (t[23] = ue),
      (t[24] = V));
  let { data: H, isLoading: de, isFetching: pe } = Zn(F, v, `move_to_local_dialog`, V),
    me = (A ?? []).some((e) => {
      let t = It(e.root);
      return !(
        P(e.root) ||
    ...
    he = T || E || (F != null && (B || le || de || pe)),
    _e = H?.type === `success` && H.stagedCount + H.unstagedCount + H.untrackedCount > 0,
    U = null;
  if (u != null) U = u;
  else if (T || E) {
    let e;
  ...
  let ve = v.kind === `local` ? `local` : `remote`,
    ye;
...
function Ti(e) {
  let t = (0, Oi.c)(109),
    ...
    j = T != null && w === T.id,
    M = n || j,
    ee = h != null || g == null || _ == null || v == null,
    N;
  t[0] !== d || t[1] !== p
    ? ((N = d == null ? null : Di({ workspaceRoot: d.workspaceRoot, workspaceRootLabels: p })),
      (t[0] = d),
      (t[1] = p),
      (t[2] = N))
    : (N = t[2]);
  let P = N,
    te = d == null || u.length <= 1,
    F;
  t[3] !== E ||
  t[4] !== a ||
  t[5] !== i ||
  ...
  let ne = F,
    re;
  t[15] !== D || t[16] !== j || t[17] !== r || t[18] !== b || t[19] !== T || t[20] !== O
    ? ((re = (e) => {
        if (!e && j) {
  ...
  if (j && T != null) {
    let e;
    t[22] !== D || t[23] !== T.id || t[24] !== T.status || t[25] !== O
      ? ((e = () => {
          if (T.status === `success` || T.status === `error`) {
            O(T.id);
            return;
    ...
    return (
      t[35] !== M || t[36] !== I || t[37] !== r
        ? ((i = (0, X.jsx)(_e, { size: `compact`, open: M, onOpenChange: I, children: r })),
          (t[35] = M),
          (t[36] = I),
          (t[37] = r),
          (t[38] = i))
  ...
  let ue;
  t[58] !== le || t[59] !== R
    ? ((ue = (0, X.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [R, le] })),
      (t[58] = le),
      (t[59] = R),
      (t[60] = ue))
    : (ue = t[60]);
        ...
        P == null
          ...
          : (0, X.jsxs)(`span`, {
              ...
              children: [
                ...
                (0, X.jsx)(Ke, { className: `icon-xs shrink-0 text-token-description-foreground` }),
              ],
            })),
      (t[63] = P),
      (t[64] = H));
  ...
  t[65] !== te || t[66] !== H
    ...
    : (de = t[67]);
  let fe;
  if (t[68] !== u || t[69] !== f || t[70] !== p) {
    let e;
    (t[72] !== f || t[73] !== p
      ? ((e = (e) => {
          let t = Di({ workspaceRoot: e.workspaceRoot, workspaceRootLabels: p });
          return (0, X.jsx)(
            K.Item,
            {
  ...
  let ge;
  t[83] !== ue || t[84] !== he
    ? ((ge = (0, X.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [ue, he] })),
      (t[83] = ue),
      (t[84] = he),
      (t[85] = ge))
    : (ge = t[85]);
  ...
  t[94] !== h || t[95] !== m
    ...
    : (W = t[96]);
  let be;
  t[97] !== U || t[98] !== ye || t[99] !== W
    ? ((be = (0, X.jsx)(Gt.Footer, {
        className: `flex-col items-stretch gap-3`,
        right: (0, X.jsxs)(`div`, {
          className: `flex w-full flex-col gap-3`,
          children: [U, ye, W],
  ...
  let G;
  return (
    t[105] !== I || t[106] !== n || t[107] !== xe
      ? ((G = (0, X.jsx)(_e, { size: `compact`, open: n, onOpenChange: I, children: xe })),
        (t[105] = I),
        (t[106] = n),
        (t[107] = xe),
        (t[108] = G))
...
function ji(e) {
  let t = (0, Fi.c)(95),
    ...
    p = we(ze, a) ?? !1,
    m = C(we(j, a)),
    [h, g] = (0, Ii.useState)(null),
    [_, y] = (0, Ii.useState)(null),
    [b, w] = (0, Ii.useState)(null),
    ...
    ee = E != null && T === E.id,
    N = n || ee,
    { data: P } = Qt(l, m, `move_to_worktree_dialog`),
    te = fe(Ge.branchPrefix),
    F;
  t[0] === n ? (F = t[1]) : ((F = { enabled: n }), (t[0] = n), (t[1] = F));
  let { data: ne, isLoading: re, isFetching: I } = qt(l, m, `move_to_worktree_dialog`, F),
    L;
  t[2] !== a || t[3] !== l
    ? ((L = [`move-thread`, `to-worktree`, `resolve-owned-worktree`, a, l]),
      (t[2] = a),
      (t[3] = l),
      (t[4] = L))
    : (L = t[4]);
  ...
  t[5] !== a || t[6] !== l || t[7] !== m
    ...
    : (ae = t[8]);
  let R;
  t[9] !== n || t[10] !== L || t[11] !== ae
    ? ((R = { queryKey: L, queryFn: ae, enabled: n, staleTime: 0 }),
      (t[9] = n),
      (t[10] = L),
      (t[11] = ae),
      (t[12] = R))
    : (R = t[12]);
  let { data: z, isLoading: oe } = De(R),
    se = ne != null && ne === c,
    ce = P != null && c === P,
    B = se && !ce,
    le = re || I,
    ue = n && B,
    V;
  t[13] === ue ? (V = t[14]) : ((V = { enabled: ue }), (t[13] = ue), (t[14] = V));
  let {
      data: H,
      isLoading: de,
      isFetching: pe,
      isError: me,
      refetch: he,
    } = $n(l, m, `move_to_worktree_dialog`, V),
    ge = H === void 0 ? [] : H,
    U = n && ce,
    ve;
  t[15] === U ? (ve = t[16]) : ((ve = { enabled: U }), (t[15] = U), (t[16] = ve));
  let { data: ye } = $n(l, m, `move_to_worktree_dialog`, ve),
    W = ye === void 0 ? [] : ye,
    be = z?.worktreeGitRoot != null && z?.worktreeWorkspaceRoot != null,
    G;
  t[17] === c ? (G = t[18]) : ((G = (e) => !c || e !== c), (t[17] = c), (t[18] = G));
  let Se = Pi({ branches: ge, defaultBranch: P ?? null }).filter(G),
    Ce = de || pe,
    Te = dn({ branchPrefix: te ?? void 0, conversationTitle: s }),
    Ee = B && h && Se.includes(h) ? h : B ? (Se[0] ?? null) : null,
    Oe = ce ? (b ?? Te) : c,
    ke = Oe.trim(),
    Ae = ke.length === 0,
    je = ke.endsWith(`/`),
    Me = P != null && ke === P,
    Ne = ce && ke.length > 0 && W.includes(ke),
    Pe = le || oe || (B && Ce),
    Fe = null;
  if (f != null) Fe = f;
  else if (Pe) {
  ...
  let Be = Le,
    Ve;
  t[33] !== O || t[34] !== ee || t[35] !== r || t[36] !== E || t[37] !== k
    ? ((Ve = (e) => {
        if (!e && ee) {
  ...
  if (ee && E != null) {
    let e;
    t[39] !== O || t[40] !== E.id || t[41] !== E.status || t[42] !== k
      ? ((e = () => {
          if (E.status === `success` || E.status === `error`) {
            k(E.id);
            return;
    ...
    t[48] !== E || t[49] !== e || t[50] !== n
      ? ((r = (0, Z.jsx)(Zr, { operation: E, onClose: e, onRetry: n })),
        (t[48] = E),
        (t[49] = e),
        (t[50] = n),
        (t[51] = r))
    ...
    let i;
    return (
      t[52] !== N || t[53] !== He || t[54] !== r
        ? ((i = (0, Z.jsx)(_e, { size: `compact`, open: N, onOpenChange: He, children: r })),
          (t[52] = N),
          (t[53] = He),
          (t[54] = r),
          (t[55] = i))
  ...
  let $e = B
      ...
      : null,
    et;
  t[60] !== Ue || t[61] !== d || t[62] !== ce || t[63] !== Oe
    ? ((et = ce
        ? (0, Z.jsxs)(`div`, {
            className: `flex flex-col gap-2`,
            children: [
    ...
    : (et = t[64]);
  let tt;
  t[65] !== Ze || t[66] !== $e || t[67] !== et
    ? ((tt = (0, Z.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [Ze, $e, et] })),
      (t[65] = Ze),
      (t[66] = $e),
      (t[67] = et),
      (t[68] = tt))
  ...
  t[71] === Pe
    ...
    : ((rt = Pe
      ...
      (t[72] = rt));
  let it;
  t[73] !== Ue || t[74] !== Ie || t[75] !== Pe || t[76] !== rt
    ? ((it = (0, Z.jsx)(Qe, {
        className: `h-11 w-full justify-center rounded-full px-4 text-base font-medium`,
        color: `primary`,
        disabled: Ie,
  ...
  t[78] !== Fe || t[79] !== Pe
    ...
    : (at = t[80]);
  let ot;
  t[81] !== nt || t[82] !== it || t[83] !== at
    ? ((ot = (0, Z.jsx)(Gt.Footer, {
        className: `flex-col items-stretch gap-3`,
        right: (0, Z.jsxs)(`div`, {
          className: `flex w-full flex-col gap-3`,
          children: [nt, it, at],
    ...
    : (ot = t[84]);
  let st;
  t[85] !== qe.Root || t[86] !== Je || t[87] !== tt || t[88] !== ot
    ? ((st = (0, Z.jsxs)(qe.Root, { className: `gap-5`, children: [Je, tt, ot] })),
      (t[85] = qe.Root),
      (t[86] = Je),
      (t[87] = tt),
      (t[88] = ot),
  ...
  let ct;
  return (
    t[90] !== We || t[91] !== He || t[92] !== n || t[93] !== st
      ? ((ct = (0, Z.jsx)(We, { size: `compact`, open: n, onOpenChange: He, children: st })),
        (t[90] = We),
        (t[91] = He),
        (t[92] = n),
        (t[93] = st),
...
function Ri(e) {
  ...
  if (r) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Wi.jsx)(ot, { href: W, className: Gi })), (t[0] = e))
      : (e = t[0]);
    let n;
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
...
function Bi(e) {
  ...
  let m;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, Wi.jsx)($e, { className: `icon-xxs` })), (t[4] = m))
    : (m = t[4]);
  let h;
  t[5] !== f || t[6] !== p
    ? ((h = (0, Wi.jsx)(Qe, {
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, Wi.jsx)(ot, { href: `${W}/settings/environments`, className: Gi })), (t[39] = D))
    : (D = t[39]);
  let O;
  ...
  let k;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, Wi.jsx)(ot, { href: Ki, className: Gi })), (t[41] = k))
    : (k = t[41]);
  let A;
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, Wi.jsxs)(K.Section, {
...
function Vi(e) {
  je({ disposition: `current-tab`, event: e, href: Ki, initiator: `open_in_browser_bridge` });
}
function Hi(e) {
  je({
...
function Ji(e) {
  let t = (0, ha.c)(151),
    {
      ...
      isBrowser: d,
      isLocalModeRemote: f,
      currentLocalModeRemoteState: p,
      crossHostHandoffEnabled: m,
      showCrossHostHandoff: h,
    ...
    P = ie(),
    { activeMode: te } = St(i),
    F = te?.settings.model ?? null,
    { data: re } = Oe(u),
    I = re === void 0 ? null : re,
    L = I?.plan_type,
    R;
  t[0] === L ? (R = t[1]) : ((R = zn(L)?.pricePlan ?? null), (t[0] = L), (t[1] = R));
  let z = R,
    oe = I?.rate_limit,
    se = I?.credits,
    ce;
  t[2] !== L || t[3] !== oe || t[4] !== se
    ? ((ce = Gn(oe, se, L)), (t[2] = L), (t[3] = oe), (t[4] = se), (t[5] = ce))
    : (ce = t[5]);
  let B = ce,
    le,
    V,
  ...
  if (
    ...
    let e = Bn(I),
      n = Hn(I);
    ((V = Un(e, { activeLimitName: n, selectedModel: F })),
      (le = V.find(Zi)?.limitName ?? n ?? null),
      (H = Wn(I, { activeLimitName: n, selectedModel: F })),
      (de = V.some(Xi) || !!B?.primary?.windowDurationMins || !!B?.secondary?.windowDurationMins),
      (t[6] = B?.primary?.windowDurationMins),
      (t[7] = B?.secondary?.windowDurationMins),
      (t[8] = I),
      (t[9] = F),
      ...
      (t[12] = H),
      (t[13] = de));
  } else ((le = t[10]), (V = t[11]), (H = t[12]), (de = t[13]));
  let fe = de,
    pe = In(),
    me = Fn(),
    he = z != null && me !== `web`,
  ...
  t[14] !== a.hostConfig || t[15] !== w
    ...
    : (_e = t[16]);
  let ve = we(_n, _e),
    ye = ve ?? P.formatMessage($.fallbackBranch),
    be = xn(i),
    G = h ? kr(be) : be,
    Se = G?.direction === `to-host-worktree` ? null : G,
    Ce = G?.status === `queued` || G?.status === `running`,
    Te = G?.direction === `to-host-worktree` && Ce,
    Ee = we(ue, i),
    { openOperation: De } = Sn(),
    ke = ne(f ? null : a.activeWorkspaceRoot, ge?.codexHome),
    je = ve ?? fa(be, i) ?? (h ? Ee : null),
    Me = Or({ codexWorktree: ke, operation: Se, threadHandoff: c }),
    Ne = jr({
      conversationId: i,
      handoffBranch: je,
      handoffDirection: Me,
  ...
  let Be = ze,
    Ve;
  t[25] !== Te || t[26] !== Ie || t[27] !== P || t[28] !== Se
    ? ((Ve = Te ? P.formatMessage($.finishCurrentHandoffTooltip) : Se == null ? void 0 : Ie),
      (t[25] = Te),
      (t[26] = Ie),
      (t[27] = P),
      (t[28] = Se),
  ...
  let He = Ve,
    Ue = f
      ? P.formatMessage($.workRemotelyTooltipWithoutPath, {
          hostDisplayName: p?.connectionDisplayName ?? b,
        })
      : P.formatMessage($.workLocallyTooltip, { branchName: ye }),
    We;
  t[30] !== j || t[31] !== M || t[32] !== De || t[33] !== Se
    ? ((We = () => {
        if ((j(), Se != null)) {
          (M(), De(Se.id));
          return;
    ...
    : (We = t[34]);
  let Ge = We,
    Ke = h && ((i != null && c != null) || G?.direction === `to-host-worktree`),
    qe;
  t[35] !== n || t[36] !== a.hostConfig || t[37] !== w
    ? ((qe = (0, Q.jsx)(ua, { composerMode: n, gitRoot: w, hostConfig: a.hostConfig })),
      (t[35] = n),
      (t[36] = a.hostConfig),
      (t[37] = w),
      (t[38] = qe))
  ...
  let Ye = l === `enabled` ? `min-w-[175px]` : `w-52`,
    Xe;
  t[44] === Ye ? (Xe = t[45]) : ((Xe = dt(`flex flex-col`, Ye)), (t[44] = Ye), (t[45] = Xe));
  let Ze;
  t[46] === o.isAttachedToStartedTask
    ? (Ze = t[47])
    : ((Ze = (0, Q.jsx)(K.Title, {
      ...
      (t[46] = o.isAttachedToStartedTask),
      (t[47] = Ze));
  let Qe = n === `local` ? Ae : void 0,
    $e;
  t[48] !== j || t[49] !== n || t[50] !== N || t[51] !== r
    ? (($e = () => {
        (n !== `local` && ae(N, g, { mode: `local` }), r(`local`), j());
      }),
      (t[48] = j),
      (t[49] = n),
      (t[50] = N),
    ...
    : ($e = t[52]);
  let et;
  t[53] !== Ce || t[54] !== P || t[55] !== Ue
    ? ((et = Ce ? P.formatMessage($.finishCurrentHandoffTooltip) : Ue),
      (t[53] = Ce),
      (t[54] = P),
      (t[55] = Ue),
      (t[56] = et))
  ...
  t[57] === f
    ? (tt = t[58])
    : ((tt = f ? (0, Q.jsx)(x, { ...$.startInRemote }) : (0, Q.jsx)(x, { ...$.workLocally })),
      (t[57] = f),
      (t[58] = tt));
  let nt;
  t[59] !== y || t[60] !== Ce || t[61] !== Qe || t[62] !== $e || t[63] !== et || t[64] !== tt
    ? ((nt = (0, Q.jsx)(K.Item, {
        LeftIcon: y,
        RightIcon: Qe,
        disabled: Ce,
  ...
  t[75] !== A
    ? ((rt =
        ...
        (0, Q.jsx)(K.Item, {
          LeftIcon: U,
          RightIcon: n === `worktree` ? Ae : void 0,
          disabled: Ce,
          onClick: () => {
            (n !== `worktree` && ae(N, g, { mode: `worktree` }), r(`worktree`), j());
          },
          tooltipText: Ce ? P.formatMessage($.finishCurrentHandoffTooltip) : A,
          children: (0, Q.jsxs)(`span`, {
            className: `inline-flex items-center gap-1`,
            children: [
              f ? (0, Q.jsx)(x, { ...$.remoteWorktreeMode }) : (0, Q.jsx)(x, { ...$.worktreeMode }),
              Je,
            ],
          }),
        })),
  ...
  t[84] !== r
    ? ((it =
        C || d
          ? l === `enabled`
            ? (0, Q.jsx)(K.Item, {
                LeftIcon: rn,
                RightIcon: n === `cloud` ? Ae : void 0,
                disabled: Ce,
                onClick: () => {
                  (n !== `cloud` && ae(N, g, { mode: `cloud` }), r(`cloud`));
                },
                tooltipText: Ce
                ...
                children: (0, Q.jsx)(x, { ...$.runInCloud }),
              })
            : (0, Q.jsxs)(Q.Fragment, {
                children: [
                  (0, Q.jsx)(K.Item, {
                    LeftIcon: s,
                    rightIcon: (0, Q.jsx)(ot, { href: W, className: _a }),
                    href: W,
                    onClick: Yi,
                    children: (0, Q.jsx)(x, {
    ...
    : (it = t[85]);
  let at;
  t[86] !== l || t[87] !== k || t[88] !== T
    ? ((at = l === `enabled` ? (0, Q.jsx)(Qi, { selectedEnvironment: T, onClick: k }) : null),
      (t[86] = l),
      (t[87] = k),
      (t[88] = T),
      (t[89] = at))
  ...
  t[90] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = (0, Q.jsx)(`div`, { className: `mx-1 my-1.5 h-[0.5px] bg-token-foreground/10` })),
      (t[90] = st))
    : (st = t[90]);
  let ct;
  t[91] !== le ||
  ...
  let lt;
  t[102] !== at || t[103] !== ct
    ? ((lt = (0, Q.jsxs)(Ht, { extension: !0, children: [at, st, ct] })),
      (t[102] = at),
      (t[103] = ct),
      (t[104] = lt))
    : (lt = t[104]);
        ...
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              ...
              (0, Q.jsxs)(K.Item, {
                ...
                tooltipText: He,
                children: [
                  (0, Q.jsx)(K.ItemIcon, { children: Be }),
                  (0, Q.jsx)(ea, { useContinueLabel: m, direction: Me, isRemoteHost: f }),
                ],
              }),
            ],
          })
  ...
  return (
    ...
    t[148] !== ft ||
    t[149] !== pt
      ? ((mt = (0, Q.jsxs)(`div`, { className: Xe, children: [Ze, nt, rt, it, lt, ut, ft, pt] })),
        (t[141] = Xe),
        (t[142] = Ze),
        (t[143] = nt),
        (t[144] = rt),
...
function $i(e) {
  let t = (0, ha.c)(51),
    {
      ...
      localWorkspaceRootForHandoff: m,
      closeDropdown: h,
  ...
  t[4] !== n || t[5] !== o || t[6] !== a || t[7] !== i
    ? ((S = o && Ar({ conversationId: n, operation: a, threadHandoff: i })),
      (t[4] = n),
      (t[5] = o),
      (t[6] = a),
      (t[7] = i),
  ...
  let C = S,
    w;
  t[9] !== v || t[10] !== a
    ? ((w = a == null ? void 0 : v.formatMessage($.finishCurrentHandoffTooltip)),
      (t[9] = v),
      (t[10] = a),
      (t[11] = w))
    : (w = t[11]);
  let T = w,
    E =
      m ??
      (a?.direction === `to-host-worktree` && a.request.destinationHostId === `local`
        ? a.request.destinationWorkspaceRoot
        : null),
    D;
  t[12] !== E || t[13] !== a
    ? ((D =
        E != null && Mr({ destinationHostId: `local`, destinationWorkspaceRoot: E, operation: a })),
      (t[12] = E),
      (t[13] = a),
      (t[14] = D))
    : (D = t[14]);
  let O = D,
    k = E != null && !C && !O,
    A;
  t[15] !== C || t[16] !== h || t[17] !== s || t[18] !== a || t[19] !== g || t[20] !== _
    ? ((A = (e) => {
        let { destinationHostId: t, destinationWorkspaceRoot: n, destinationLabel: r } = e;
        if (a != null && Mr({ destinationHostId: t, destinationWorkspaceRoot: n, operation: a })) {
          (h(),
            g({
              currentBranch: s ?? ``,
              destinationHostId: t,
    ...
    : (A = t[21]);
  let j = A;
  if (a?.direction !== `to-host-worktree` && m == null && b.length === 0) return null;
  let M;
  t[22] === l
    ? (M = t[23])
    : ((M = l ? (0, Q.jsx)(K.Separator, {}) : null), (t[22] = l), (t[23] = M));
  let ee;
  t[24] !== T ||
  t[25] !== j ||
  t[26] !== c ||
    ...
    ? ((ee =
        E == null
          ...
          : (0, Q.jsxs)(K.Item, {
              ...
              children: [
                (0, Q.jsx)(K.ItemIcon, {
                  children: O ? c : (0, Q.jsx)(en, { className: `icon-2xs` }),
                }),
                (0, Q.jsx)(x, {
  ...
  if (
    ...
    let e;
    (t[40] !== C || t[41] !== T || t[42] !== j || t[43] !== c || t[44] !== v || t[45] !== a
      ? ((e = (e) => {
          if (e.status !== `ready`) {
            let t = a?.direction === `to-host-worktree` && a.request.destinationHostId === e.hostId;
            return (0, Q.jsx)(
              ta,
              {
                ...
                onSelect: t
                  ? () => {
                      j({
                        ...
                        destinationWorkspaceRoot: a.request.destinationWorkspaceRoot,
          ...
          return (0, Q.jsx)(
            ta,
            {
              hostDisplayName: t,
              disabled: i,
              icon: r ? c : (0, Q.jsx)(p, { className: `icon-2xs` }),
              tooltipText: i ? T : n.remotePath,
              onSelect: () => {
                j({
                  destinationHostId: n.hostId,
                  destinationWorkspaceRoot: n.remotePath,
  ...
  let te;
  return (
    t[47] !== M || t[48] !== ee || t[49] !== N
      ? ((te = (0, Q.jsxs)(Q.Fragment, { children: [M, ee, N] })),
        (t[47] = M),
        (t[48] = ee),
        (t[49] = N),
        (t[50] = te))
...
function na(e) {
  let t = (0, ha.c)(11),
    ...
    [o, s] = (0, ga.useState)(``),
    { envListState: c, listToShow: l } = or(o, n, i),
    u;
...
function sa(e) {
  ...
  let C = we(_n, S),
    ...
    O = T?.direction === `to-host-worktree` && D,
    k = we(ue, c),
    { openOperation: A } = Sn(),
    j = C ?? fa(w, c) ?? (s ? k : null),
    M = jr({
      conversationId: c,
      handoffBranch: j,
      handoffDirection: Or({ codexWorktree: !1, operation: E, threadHandoff: f }),
      operation: T,
      threadHandoff: f,
    }),
    ee = O,
  ...
  let I = re,
    L;
  t[11] !== O || t[12] !== te || t[13] !== b || t[14] !== E
    ? ((L = O ? b.formatMessage($.finishCurrentHandoffTooltip) : E == null ? void 0 : te),
      (t[11] = O),
      (t[12] = te),
      (t[13] = b),
      (t[14] = E),
  ...
  t[16] !== r || t[17] !== _ || t[18] !== A || t[19] !== E
    ...
    : (R = t[20]);
  let z = R,
    oe = s && ((c != null && f != null) || T?.direction === `to-host-worktree`),
    se = M || (oe && (T?.direction === `to-host-worktree` || y != null)),
    ce;
  t[21] !== l.cwd || t[22] !== M || t[23] !== se || t[24] !== s || t[25] !== g || t[26] !== p
    ? ((ce =
        g === `summary-panel`
          ? (0, Q.jsx)(Kt, {
              icon: (0, Q.jsx)(U, { className: `icon-sm shrink-0 text-token-foreground` }),
              label: (0, Q.jsxs)(`span`, {
                className: `flex min-w-0 items-center gap-1 text-token-foreground`,
                children: [
                  (0, Q.jsx)(`span`, { className: `min-w-0 truncate`, children: p }),
                  M
                    ? (0, Q.jsx)(Ke, { className: `icon-2xs shrink-0 text-token-text-tertiary` })
                    : null,
                ],
              }),
              ...
              title: l.cwd ?? void 0,
              trailing:
                s && se ? (0, Q.jsx)(Ye, { className: `icon-xs text-token-text-tertiary` }) : null,
            })
          : (0, Q.jsx)(Kn, {
              categoryLabel: null,
              collapse: `none`,
              icon: null,
              indicator: se ? `chevron` : `none`,
              value: p,
    ...
    : (ce = t[27]);
  let B = ce,
    le = g === `summary-panel` && `w-full`,
    V;
  t[28] === le ? (V = t[29]) : ((V = dt(le)), (t[28] = le), (t[29] = V));
  let H;
  t[30] !== a ||
  t[31] !== c ||
  t[32] !== o ||
    ...
    ? ((H = se
        ? (0, Q.jsx)(Re, {
            ...
            triggerButton:
              g === `summary-panel`
                ? B
                : (0, Q.jsx)(_t, { tooltipContent: m, tooltipMaxWidth: h, children: B }),
            children: (0, Q.jsxs)(`div`, {
              className: dt(`flex flex-col`, s ? `min-w-[220px]` : `min-w-[180px]`),
              children: [
                s
                  ? (0, Q.jsx)(K.Title, {
                      children: (0, Q.jsx)(x, {
                ...
                M
                  ? (0, Q.jsxs)(K.Item, {
                      ...
                      tooltipText: ae,
                      children: [
                        (0, Q.jsx)(K.ItemIcon, { children: I }),
                        (0, Q.jsx)(ea, {
                          useContinueLabel: s,
                          direction: `to-local`,
                          isRemoteHost: l.hostId !== P,
                        }),
                      ],
                    })
                  : null,
                ...
                s && a === `enabled`
                  ? (0, Q.jsxs)(K.Item, {
                      ...
                      children: [
                        (0, Q.jsx)(K.ItemIcon, {
                          children: (0, Q.jsx)(rn, { className: `icon-2xs` }),
                        }),
                        (0, Q.jsx)(x, { ...$.runInCloud }),
                      ],
                    })
                  : null,
              ],
  ...
  return (
    t[61] !== H || t[62] !== V
      ? ((de = (0, Q.jsx)(`div`, { className: V, children: H })),
        (t[61] = H),
        (t[62] = V),
        (t[63] = de))
      : (de = t[63]),
...
function ca(e) {
  ...
  let f = we(_n, d),
    ...
    h = we(ue, r),
    g = Or({
      codexWorktree: ne(c ? null : a.activeWorkspaceRoot, u?.codexHome),
      operation: m,
      threadHandoff: s,
    }),
    _;
  t[3] !== r || t[4] !== f || t[5] !== p || t[6] !== l || t[7] !== h
    ? ((_ = f ?? fa(p, r) ?? (l ? h : null)),
      (t[3] = r),
      (t[4] = f),
      (t[5] = p),
  ...
  if (
    (t[0] !== r || t[1] !== i || t[2] !== a
      ? ((o = {
        ...
        (t[3] = o))
      : (o = t[3]),
    !((we(Jn, o)?.length ?? 0) > 0) || n !== `worktree`)
  )
    return null;
  let s;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(x, { ...$.worktreeSubmoduleWarning })), (t[4] = s))
    : (s = t[4]);
  let c;
  return (
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
...
function da(e) {
  let t = (0, ha.c)(9),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = hn(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === r
    ? (o = t[3])
    ...
    ((ha = Le()),
      ...
      (va = (0, ga.memo)(function (e) {
        let t = (0, ha.c)(177),
          ...
          M = H(`2256010998`),
          ee = xn(i),
          F = M || ee?.direction === `to-host-worktree`,
          { access: ne } = Nn(),
          re = Ee(i),
          I = a ?? re,
          L = be(),
          ae;
        t[0] !== I.cwd || t[1] !== o || t[2] !== L
          ? ((ae = pa({ executionTargetCwd: I.cwd, footerRemoteState: o, remoteConnections: L })),
            (t[0] = I.cwd),
            (t[1] = o),
            (t[2] = L),
            (t[3] = ae))
        ...
        let le = we(Vt, B),
          ...
          V = ce?.root ?? null,
          { data: de } = Oe(ge),
          fe = F && w && I.hostId !== `local` ? de?.roots : void 0,
          pe;
        t[10] === fe ? (pe = t[11]) : ((pe = fe ?? []), (t[10] = fe), (t[11] = pe));
        let me;
        t[12] === pe
          ? (me = t[13])
          : ((me = { params: { hostId: P, dirs: pe }, source: `local_remote_dropdown` }),
            (t[12] = pe),
            (t[13] = me));
        let { data: he } = we(Dt, me),
          _e;
        t[14] === I.cwd
          ? (_e = t[15])
        ...
        let G = W,
          Ce;
        t[25] !== ne || t[26] !== ue
          ? ((Ce = _r({ cloudAccess: ne, hasGitRepository: ue, isBrowser: !1 })),
            (t[25] = ne),
            (t[26] = ue),
            (t[27] = Ce))
          : (Ce = t[27]);
          ...
          : ((Me = Ae
              ? (0, Q.jsxs)(Q.Fragment, {
                  children: [
                    (0, Q.jsx)(x, { ...$.runInCloud }),
                    (0, Q.jsx)(`span`, {
                      className: pn.runLocationEnvironmentSuffix,
                      children: (0, Q.jsx)(x, {
              ...
              : (0, Q.jsxs)(Q.Fragment, {
                  children: [
                    (0, Q.jsx)(`span`, {
                      className: pn.defaultExternalFooterOnly,
                      children: (0, Q.jsx)(x, { ...$.selectEnvironment }),
                    }),
                    (0, Q.jsx)(`span`, {
                      className: dt(pn.homeExternalFooterOnly, `hidden`),
                      children: (0, Q.jsx)(x, { ...$.runInCloud }),
                    }),
                  ],
                })),
        ...
        let Fe = Pe,
          ...
          Le;
        t[32] !== k || t[33] !== z
          ? ((Le = z ? k.formatMessage($.startInRemote) : k.formatMessage($.workLocally)),
            (t[32] = k),
            (t[33] = z),
            (t[34] = Le))
          : (Le = t[34]);
        ...
        t[35] !== k || t[36] !== z
          ? ((Be = z
              ? k.formatMessage($.remoteWorktreeTooltip)
              : k.formatMessage($.worktreeTooltip)),
            (t[35] = k),
            (t[36] = z),
            (t[37] = Be))
          : (Be = t[37]);
        ...
        let Ge = We,
          qe;
        (t[42] !== Ie || t[43] !== ze || t[44] !== He || t[45] !== Ue || t[46] !== Ge
          ? ((qe = {
              id: `local`,
              title: ze,
              description: He,
        ...
        let Je;
        t[48] !== k || t[49] !== z
          ? ((Je = z ? k.formatMessage($.remoteWorktreeMode) : k.formatMessage($.worktreeMode)),
            (t[48] = k),
            (t[49] = z),
            (t[50] = Je))
          : (Je = t[50]);
        ...
        let Qe = Ze,
          $e;
        (t[55] !== Je || t[56] !== Ye || t[57] !== Xe || t[58] !== Qe
          ? (($e = {
              id: `worktree`,
              title: Je,
              description: Ye,
        ...
        t[60] === k
          ? (et = t[61])
          : ((et = k.formatMessage($.runInCloud)), (t[60] = k), (t[61] = et));
        let tt;
        t[62] === k
          ? (tt = t[63])
          : ((tt = k.formatMessage({
        ...
        let at = it,
          ot;
        (t[66] !== et || t[67] !== tt || t[68] !== rt || t[69] !== at
          ? ((ot = {
              id: `cloud`,
              title: et,
              description: tt,
        ...
        t[71] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((st = (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(`span`, {
                className: `truncate`,
                children: (0, Q.jsx)(x, { ...$.worktreeSegment }),
              }),
            })),
            (t[71] = st))
          : (st = t[71]);
        ...
        t[81] !== s
          ? ((mt = () => {
              i == null ||
                ...
                nt(C, ca, {
                  conversationId: i,
                  composerViewState: C.get(se),
                  executionTarget: I,
                  gitRoot: V,
                  isLocalModeRemote: z,
                  threadHandoff: s,
                  showCrossHostHandoff: F,
                });
            }),
            (t[75] = i),
            (t[76] = I),
        ...
        t[83] !== i || t[84] !== C || t[85] !== s
          ...
          : (gt = t[86]);
        let vt = gt,
          yt = S === `summary-panel` ? `icon-sm text-token-foreground` : `icon-xs`,
          bt;
        t[87] !== n || t[88] !== z || t[89] !== yt
          ? ((bt =
              n === `cloud`
                ? (0, Q.jsx)(rn, { className: yt })
                : n === `worktree`
                  ? (0, Q.jsx)(U, { className: yt })
                  : z
                    ? (0, Q.jsx)(p, { className: yt })
                    : (0, Q.jsx)(en, { className: yt })),
            (t[87] = n),
            (t[88] = z),
            (t[89] = yt),
            (t[90] = bt))
              ...
              n === `cloud`
                ...
                : n === `worktree`
                  ? (0, Q.jsx)(`span`, {
                      className: `inline-flex items-center gap-1`,
                      children: z
                        ? (0, Q.jsx)(x, { ...$.remoteWorktreeMode })
                        : (0, Q.jsx)(x, { ...$.worktreeMode }),
                    })
                  : S === `summary-panel` && !z
                    ? (0, Q.jsx)(x, { ...$.localShort })
                    : z
        ...
        let Ct = St,
          wt;
        t[96] !== _ || t[97] !== k || t[98] !== xt || t[99] !== Ct || t[100] !== S
          ? ((wt =
              S === `summary-panel`
                ? (0, Q.jsx)(Kt, {
                    disabled: _,
                    icon: (0, Q.jsx)(`span`, { className: `shrink-0`, children: xt }),
                    label: (0, Q.jsxs)(`span`, {
                      className: `flex min-w-0 items-center gap-1 text-token-foreground`,
                      children: [
                        (0, Q.jsx)(`span`, { className: `min-w-0 truncate`, children: Ct }),
                        _
                          ? null
                          : (0, Q.jsx)(Ke, {
                    ...
                    labelClassName: `flex min-w-0 items-center`,
                    title: k.formatMessage($.localRemoteWhereRun),
                  })
                : (0, Q.jsx)(Kn, {
                    categoryLabel: null,
                    collapse: `xs`,
              ...
              (0, Q.jsx)(Re, {
                ...
                triggerButton:
                  S === `summary-panel`
                    ? Tt
                    : (0, Q.jsx)(_t, {
                        tooltipContent: (0, Q.jsx)(x, { ...$.localRemoteWhereRun }),
                        children: Tt,
                      }),
                children: (0, Q.jsx)(Ji, {
                  composerMode: n,
        ...
        let jt = At,
          Mt = v || (i == null && !z && !le && !ue),
          Pt;
        t[152] !== Ot || t[153] !== Mt || t[154] !== y || t[155] !== jt
          ? ((Pt = Mt ? null : y ? jt : Ot()),
            (t[152] = Ot),
            (t[153] = Mt),
            (t[154] = y),
        ...
        t[157] === O
          ? (It = t[158])
          : ((It = O ? (0, Q.jsx)(Pn, {}) : null), (t[157] = O), (t[158] = It));
        let Lt;
        t[159] !== Te || t[160] !== n || t[161] !== Ae || t[162] !== r || t[163] !== je
          ? ((Lt =
              Te && n === `cloud`
                ? (0, Q.jsx)(ra, {
                    selectedEnvironment: Ae,
          ...
          : (Lt = t[164]);
        let Rt;
        t[165] !== Te || t[166] !== n || t[167] !== Ae || t[168] !== je
          ? ((Rt =
              Te && n === `cloud` && Ae == null
                ? (0, Q.jsx)(oa, { setSelectedEnvironment: je })
                : null),
            (t[165] = Te),
            (t[166] = n),
            (t[167] = Ae),
        ...
        t[170] === Ft
          ? (zt = t[171])
          : ((zt = (0, Q.jsx)(Ht, { extension: !0, electron: !0, browser: !0, children: Ft })),
            (t[170] = Ft),
            (t[171] = zt));
        let Bt;
        return (
          t[172] !== It || t[173] !== Lt || t[174] !== Rt || t[175] !== zt
            ? ((Bt = (0, Q.jsxs)(Q.Fragment, { children: [It, Lt, Rt, zt] })),
              (t[172] = It),
              (t[173] = Lt),
              (t[174] = Rt),
              (t[175] = zt),
...
export { br as a, vr as c, Nr as i, ya as n, Er as o, Dr as r, yr as s, va as t };
