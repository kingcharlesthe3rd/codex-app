...
import { It as ft, Lt as pt } from "./app-initial~app-main~automations-page.js";
import {
  d as mt,
  f as ht,
  p as gt,
...
import {
  ...
  r as Gn,
  t as Kn,
} from "./app-initial~app-main~remote-conversation-page~hotkey-window-thread-page~thread-app-shell-ch~oc6ebzsr.js";
...
function ar(e, t, n) {
  ...
  (r[6] !== s || r[7] !== m || r[8] !== n
    ...
    : ((g = r[9]), (_ = r[10])),
    (0, ur.useEffect)(g, _));
  let y = c instanceof v && c.status === 404,
    b;
  b =
    u.length > 0
      ? `list`
  ...
  let x;
  return (
    r[11] !== b || r[12] !== u || r[13] !== h
      ? ((x = { envListState: b, listToShow: u, zeroEnvironments: h }),
        (r[11] = b),
        (r[12] = u),
        (r[13] = h),
        (r[14] = x))
  ...
  return (
    await Promise.all(
      e.map(({ owner: e, repoName: t }) =>
        et.safeGet(`/wham/environments/by-repo/{provider}/{repo_owner}/{repo_name}`, {
  ...
  hr = e(() => {
    ((sr = r()),
      ...
      (dr = p(st, () => ({
        ...
        queryFn: async () => et.safeGet(`/wham/environments`),
        placeholderData: w,
        staleTime: x.FIVE_MINUTES,
      }))),
      (fr = p(st, ({ get: e }) => {
        let t = e(kt, { params: void 0, source: `workspace_repo_owner_names` }),
          n = It(t.data?.origins ?? []);
        return {
          queryKey: [
            `workspace`,
      ...
      (mr = _(st, ({ envQuery: e, selectedEnvironmentId: t }, { get: n }) => {
        let r = n(dr),
          i = n(fr).data ?? [],
...
function yr(e) {
  ...
  t[0] !== h.cwd || t[1] !== h.hostConfig
    ? ((g = {
      ...
      (t[2] = g))
    : (g = t[2]);
  let _ = gr({ cloudAccess: m, hasGitRepository: d(Pe, g)?.root != null, isBrowser: !1 });
  if (n !== `cloud` || !_) return null;
  let v;
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, wr.jsx)(nr, { className: `icon-xs` })), (t[5] = b))
    : (b = t[5]);
  let x;
  t[6] === f
    ? (x = t[7])
  ...
  let T;
  return (
    t[16] !== i || t[17] !== c || t[18] !== s || t[19] !== S || t[20] !== w
      ? ((T = (0, wr.jsx)(Bt, {
...
function br(e) {
  let t = (0, Sr.c)(35),
    { selectedEnvironment: n, setComposerMode: r, setSelectedEnvironment: i, closeDropdown: a } = e,
    [o, s] = (0, Cr.useState)(``),
    { envListState: c, listToShow: l, zeroEnvironments: u } = ar(o, n, i),
    d = rt(),
    f;
  if (u) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, wr.jsx)(jt, { href: S, className: Tr })), (t[0] = e))
      : (e = t[0]);
    let n;
    ...
    if (c === `loading`) {
      ...
      (t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((n = (0, wr.jsx)(`div`, {
            ...
            children: (0, wr.jsx)(_e, { className: `icon-xxs text-token-description-foreground` }),
          })),
          (t[2] = n))
        : (n = t[2]),
        (e = n));
      ...
      let o;
      if (t[5] !== a || t[6] !== l || t[7] !== n?.id || t[8] !== r || t[9] !== i) {
        let e;
      ...
      let d;
      (t[20] !== o || t[21] !== u
        ? ((d = (0, wr.jsxs)(wr.Fragment, { children: [o, s, u] })),
          (t[20] = o),
          (t[21] = u),
          (t[22] = d))
        : (d = t[22]),
    ...
    let m;
    t[26] !== o || t[27] !== u
      ? ((m = (0, wr.jsx)(q.Section, {
          className: `my-1`,
          children: (0, wr.jsx)(q.SearchInput, { placeholder: u, value: o, onChange: p }),
        })),
        (t[26] = o),
        (t[27] = u),
        (t[28] = m))
    ...
    let h;
    (t[29] !== e || t[30] !== m
      ? ((h = (0, wr.jsxs)(`div`, { className: `flex flex-col`, children: [m, e] })),
        (t[29] = e),
        (t[30] = m),
        (t[31] = h))
      : (h = t[31]),
  ...
  return (
    t[33] === f
      ? (m = t[34])
      : ((m = (0, wr.jsxs)(`div`, { className: `flex w-64 flex-col`, children: [p, f] })),
        (t[33] = f),
        (t[34] = m)),
    m
  );
...
function xr(e) {
  Ht({ disposition: `current-tab`, event: e, href: S, initiator: `open_in_browser_bridge` });
}
var Sr,
  Cr,
  wr,
...
function Ur(e, t, n, r, i) {
  ...
  return (
    a[3] === i
      ? (s = a[4])
      : ((s = { select: Wr, staleTime: x.FIVE_SECONDS, ...i }), (a[3] = i), (a[4] = s)),
    Se(e, t, `branch-exists`, o, r, s)
  );
}
function Wr(e) {
  return e.exists;
...
function $r(e) {
  let t = (0, li.c)(8),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, J.jsx)(Ge, { className: `icon-md text-token-charts-green` })), (t[0] = r))
    : (r = t[0]);
  let i;
...
function ei(e) {
  ...
  return (
    t[9] !== o || t[10] !== c
      ? ((l = (0, J.jsxs)(En, { className: `gap-0 px-6 py-5`, children: [o, c] })),
        (t[9] = o),
        (t[10] = c),
        (t[11] = l))
      : (l = t[11]),
...
function ti(e) {
  let t = (0, li.c)(21),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, J.jsx)(H, { className: `icon-md text-token-danger -ml-2` })), (t[0] = o))
    : (o = t[0]);
  let s;
  ...
  let m;
  t[14] !== d || t[15] !== p
    ? ((m = (0, J.jsx)(Sn, { className: `pt-5`, children: (0, J.jsxs)(wn, { children: [d, p] }) })),
      (t[14] = d),
      (t[15] = p),
      (t[16] = m))
    : (m = t[16]);
...
var li,
  J,
  ui = e(() => {
    ((li = r()), nt(), tt(), Cn(), Xr(), $e(), zr(), Hr(), se(), ae(), (J = n()));
  });
function di(e) {
  let t = (0, fi.c)(8),
    n = rt(),
    r = d(F, e),
    { data: i, isError: a, isLoading: o } = wt(T.QUEUED_FOLLOW_UPS);
  switch (
    z({
...
function mi(e) {
  let t = (0, _i.c)(109),
    ...
    h = di(i),
    g = d(we, i) ?? !1,
    [_, v] = (0, vi.useState)(null),
    { data: y } = wt(T.GIT_BRANCH_PREFIX),
    b = oe({ branchPrefix: y ?? void 0, conversationTitle: o }),
    x = Ke(),
    S;
  t[0] === s ? (S = t[1]) : ((S = s.trim()), (t[0] = s), (t[1] = S));
  let C = S.length === 0,
    w = C ? (_ ?? b) : s,
    E = w.trim(),
    ee = ot(l),
    D;
  t[2] !== i || t[3] !== x
    ? ((D = x.getMaybeForConversationId(i)?.getConversation(i)?.forkedFromId ?? null),
      (t[2] = i),
      (t[3] = x),
      (t[4] = D))
    : (D = t[4]);
  let O = D,
    A;
  t[5] !== l || t[6] !== f || t[7] !== O
    ? ((A = [`move-thread`, `to-host-worktree`, `resolve-owned-worktree`, l, f, O]),
      (t[5] = l),
      (t[6] = f),
      (t[7] = O),
      (t[8] = A))
  ...
  let te = n && O != null,
    M;
  t[14] !== A || t[15] !== j || t[16] !== te
    ? ((M = { queryKey: A, queryFn: j, enabled: te, staleTime: 0 }),
      (t[14] = A),
      (t[15] = j),
      (t[16] = te),
      (t[17] = M))
    : (M = t[17]);
  let { data: N } = u(M),
    ne = N?.worktreeGitRoot != null && N?.worktreeWorkspaceRoot != null,
    re = a.pastedTextAttachments.length > 0,
    ie = n && !re && C && E.length > 0 && !E.endsWith(`/`),
    ae;
  t[18] === ie ? (ae = t[19]) : ((ae = { enabled: ie }), (t[18] = ie), (t[19] = ae));
  let { data: P, isPending: F } = Ur(f, ee, E, `move_to_host_worktree`, ae),
    I = null;
  if (h != null) I = h;
  else if (re) {
    let e;
  ...
  let L = I != null,
    { activeOperationId: se } = Hn(),
    R = Un(i),
    {
      addToHostWorktreeOperation: ce,
      closeActiveOperation: z,
      removeOperation: B,
      openOperation: le,
      updateOperation: V,
    } = Gn(),
    H = R != null && se === R.id,
    ue = n || H,
    de = R?.status === `success` || R?.status === `warning` || R?.status === `error`,
    fe;
  t[30] !== z || t[31] !== H || t[32] !== r || t[33] !== R || t[34] !== B || t[35] !== de
    ? ((fe = (e) => {
        if (!e && H) {
          if (de) {
            (B(R.id), r(!1));
          ...
          (le(
            ce({
              ...
              stepIds: [
                ...
                ne ? `reuse-existing-worktree` : `create-new-worktree`,
  ...
  if (H && R != null) {
    let e;
    t[49] !== z || t[50] !== R.id || t[51] !== B || t[52] !== de
      ? ((e = () => {
          if (de) {
            B(R.id);
            return;
    ...
    t[60] !== V
      ...
      : (n = t[61]);
    let i;
    t[62] !== R || t[63] !== e || t[64] !== n
      ? ((i = (0, Y.jsx)(Zr, { operation: R, onClose: e, onRetry: n })),
        (t[62] = R),
        (t[63] = e),
        (t[64] = n),
        (t[65] = i))
    ...
    let a;
    return (
      t[66] !== ue || t[67] !== pe || t[68] !== i
        ? ((a = (0, Y.jsx)(yn, { size: `compact`, open: ue, onOpenChange: pe, children: i })),
          (t[66] = ue),
          (t[67] = pe),
          (t[68] = i),
          (t[69] = a))
  ...
  let ye;
  t[80] !== ve || t[81] !== U
    ? ((ye = (0, Y.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [ve, U] })),
      (t[80] = ve),
      (t[81] = U),
      (t[82] = ye))
    : (ye = t[82]);
  ...
  let xe;
  t[87] !== ye || t[88] !== be
    ? ((xe = (0, Y.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [ye, be] })),
      (t[87] = ye),
      (t[88] = be),
      (t[89] = xe))
    : (xe = t[89]);
  ...
  let De;
  return (
    t[105] !== pe || t[106] !== n || t[107] !== Ee
      ? ((De = (0, Y.jsx)(yn, { size: `compact`, open: n, onOpenChange: pe, children: Ee })),
        (t[105] = pe),
        (t[106] = n),
        (t[107] = Ee),
        (t[108] = De))
...
function bi(e, t, n, r) {
  ...
  let u;
  return (
    i[7] === o ? (u = i[8]) : ((u = { staleTime: x.FIVE_SECONDS, ...o }), (i[7] = o), (i[8] = u)),
    Se(e, t, `list-worktrees`, l, n, u)
  );
}
var xi,
  Si = e(() => {
...
function Ci(e) {
  let t = (0, Oi.c)(63),
    ...
    u = rt(),
    f = di(i),
    [p, g] = (0, ki.useState)(null),
    [_, v] = (0, ki.useState)(null),
    y = oe({ branchPrefix: Xe(m.branchPrefix) ?? void 0, conversationTitle: o }),
    x = _ ?? (s || y),
    S = x.trim(),
    C = ot(d(Be, i)),
    { data: w } = Me(l, C, `move_to_local_dialog`),
    T = w?.root ?? null,
    E = T ?? l,
    ee = Le(E),
    { data: D, isLoading: k, isFetching: A } = bi(T ?? l, C, `move_to_local_dialog`),
    { data: j } = rr(C, `move_to_local_dialog`),
    te = Ot(C.id),
    { data: M } = c(Fe),
    N = D?.worktrees,
    ne;
  t[0] === j?.worktrees
    ? (ne = t[1])
    : ((ne = new Set((j?.worktrees ?? []).map(wi))), (t[0] = j?.worktrees), (t[1] = ne));
  let re = ne,
    ie;
  t[2] !== te || t[3] !== re
    ? ((ie = (e) => re.has(Le(e)) || b(e, te)), (t[2] = te), (t[3] = re), (t[4] = ie))
    : (ie = t[4]);
  let ae = ie,
    P,
    F,
    ...
    se,
    R;
  if (t[5] !== l || t[6] !== ae || t[7] !== N || t[8] !== p || t[9] !== E || t[10] !== M?.labels) {
    let e;
    (t[17] === ae ? (e = t[18]) : ((e = (e) => !ae(e.root)), (t[17] = ae), (t[18] = e)),
      (F = B({ cwd: l, sourceWorktreeRoot: E, repoWorktreeEntries: (N ?? []).filter(e) })));
    let n;
    (t[19] === M?.labels ? (n = t[20]) : ((n = M?.labels ?? {}), (t[19] = M?.labels), (t[20] = n)),
      (R = n),
      (L = F.find((e) => e.gitRoot === p) ?? F[0] ?? null));
    ...
    ((I = r == null ? null : h(r)),
      ...
      (t[15] = se),
      (t[16] = R));
  } else ((P = t[11]), (F = t[12]), (I = t[13]), (L = t[14]), (se = t[15]), (R = t[16]));
  let ce = se,
    z = n && P != null,
    le;
  t[21] === z
    ? (le = t[22])
    : ((le = { enabled: z, refetchOnMount: `always`, refetchOnWindowFocus: `always` }),
      (t[21] = z),
      (t[22] = le));
  let { data: V, isLoading: H, isFetching: ue } = O(P, C, `move_to_local_dialog`, le),
    de = n && P != null,
    fe;
  t[23] === de
    ? (fe = t[24])
    : ((fe = { enabled: de, refetchOnMount: `always`, refetchOnWindowFocus: `always` }),
      (t[23] = de),
      (t[24] = fe));
  let { data: pe, isLoading: me, isFetching: he } = Xn(P, C, `move_to_local_dialog`, fe),
    ge = (N ?? []).some((e) => {
      let t = Le(e.root);
      return !(
        ae(e.root) ||
    ...
    _e = k || A || (P != null && (H || ue || me || he)),
    ve = pe?.type === `success` && pe.stagedCount + pe.unstagedCount + pe.untrackedCount > 0,
    U = null;
  if (f != null) U = f;
  else if (k || A) {
    let e;
  ...
  return (
    ...
    t[61] !== T
      ? ((xe = (0, X.jsx)(Ti, {
          ...
          onChangeLocalBranch: v,
          cwd: l,
          localTargets: F,
          selectedLocalTarget: L,
          onChangeLocalTarget: g,
...
function Ti(e) {
  let t = (0, Oi.c)(109),
    ...
    N;
  t[0] !== f || t[1] !== m
    ? ((N = f == null ? null : Di({ workspaceRoot: f.workspaceRoot, workspaceRootLabels: m })),
      (t[0] = f),
      (t[1] = m),
      (t[2] = N))
    : (N = t[2]);
  let ne = N,
    re = f == null || u.length <= 1,
    ie;
  t[3] !== E ||
  t[4] !== a ||
  t[5] !== i ||
        ...
        M ||
          (O(
            E({
              ...
              sourceBranch: s,
              localBranch: s,
              request: { cwd: l, localGitRoot: _, localWorkspaceRoot: v, worktreeRoot: y },
              stepIds: [
  ...
  let ae = ie,
    P;
  t[15] !== ee || t[16] !== j || t[17] !== r || t[18] !== x || t[19] !== T || t[20] !== D
    ? ((P = (e) => {
        if (!e && j) {
  ...
  if (j && T != null) {
    ...
    let i;
    return (
      t[35] !== te || t[36] !== F || t[37] !== r
        ? ((i = (0, X.jsx)(yn, { size: `compact`, open: te, onOpenChange: F, children: r })),
          (t[35] = te),
          (t[36] = F),
          (t[37] = r),
          (t[38] = i))
  ...
  let V;
  t[58] !== le || t[59] !== oe
    ? ((V = (0, X.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [oe, le] })),
      (t[58] = le),
      (t[59] = oe),
      (t[60] = V))
    : (V = t[60]);
        ...
        ne == null
          ...
          : (0, X.jsxs)(`span`, {
              ...
              children: [
                ...
                (0, X.jsx)(_t, { className: `icon-xs shrink-0 text-token-description-foreground` }),
              ],
            })),
      (t[63] = ne),
      (t[64] = ue));
  ...
  let ge;
  t[83] !== V || t[84] !== he
    ? ((ge = (0, X.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [V, he] })),
      (t[83] = V),
      (t[84] = he),
      (t[85] = ge))
    : (ge = t[85]);
  ...
  let W;
  return (
    t[105] !== F || t[106] !== n || t[107] !== xe
      ? ((W = (0, X.jsx)(yn, { size: `compact`, open: n, onOpenChange: F, children: xe })),
        (t[105] = F),
        (t[106] = n),
        (t[107] = xe),
        (t[108] = W))
...
function ji(e) {
  let t = (0, Fi.c)(95),
    ...
    te = T != null && w === T.id,
    M = n || te,
    { data: N } = le(l, _, `move_to_worktree_dialog`),
    ne = Xe(m.branchPrefix),
    re;
  t[0] === n ? (re = t[1]) : ((re = { enabled: n }), (t[0] = n), (t[1] = re));
  let { data: ie, isLoading: ae, isFetching: P } = O(l, _, `move_to_worktree_dialog`, re),
    F;
  t[2] !== i || t[3] !== l
    ? ((F = [`move-thread`, `to-worktree`, `resolve-owned-worktree`, i, l]),
      (t[2] = i),
      (t[3] = l),
      (t[4] = F))
    : (F = t[4]);
  ...
  let L;
  t[9] !== n || t[10] !== F || t[11] !== I
    ? ((L = { queryKey: F, queryFn: I, enabled: n, staleTime: 0 }),
      (t[9] = n),
      (t[10] = F),
      (t[11] = I),
      (t[12] = L))
    : (L = t[12]);
  let { data: se, isLoading: R } = u(L),
    ce = ie != null && ie === c,
    z = N != null && c === N,
    B = ce && !z,
    V = ae || P,
    H = n && B,
    ue;
  t[13] === H ? (ue = t[14]) : ((ue = { enabled: H }), (t[13] = H), (t[14] = ue));
  let {
      data: de,
      isLoading: fe,
      isFetching: pe,
      isError: me,
      refetch: he,
    } = Qn(l, _, `move_to_worktree_dialog`, ue),
    ge = de === void 0 ? [] : de,
    _e = n && z,
    ve;
  t[15] === _e ? (ve = t[16]) : ((ve = { enabled: _e }), (t[15] = _e), (t[16] = ve));
  let { data: U } = Qn(l, _, `move_to_worktree_dialog`, ve),
    ye = U === void 0 ? [] : U,
    be = se?.worktreeGitRoot != null && se?.worktreeWorkspaceRoot != null,
    xe;
  t[17] === c ? (xe = t[18]) : ((xe = (e) => !c || e !== c), (t[17] = c), (t[18] = xe));
  let W = Pi({ branches: ge, defaultBranch: N ?? null }).filter(xe),
    Se = fe || pe,
    G = oe({ branchPrefix: ne ?? void 0, conversationTitle: s }),
    Ce = B && v && W.includes(v) ? v : B ? (W[0] ?? null) : null,
    Te = z ? (S ?? G) : c,
    Ee = Te.trim(),
    De = Ee.length === 0,
    Oe = Ee.endsWith(`/`),
    Ae = N != null && Ee === N,
    je = z && Ee.length > 0 && ye.includes(Ee),
    Me = V || R || (B && Se),
    Ne = null;
  if (h != null) Ne = h;
  else if (Me) {
  ...
  let Ie = Fe,
    Le;
  t[33] !== ee || t[34] !== te || t[35] !== r || t[36] !== T || t[37] !== D
    ? ((Le = (e) => {
        if (!e && te) {
          if (T?.status === `success` || T?.status === `error`) {
            (D(T.id), r(!1));
      ...
      Pe ||
        (A(
          E({
            ...
            stepIds: [
              be ? `reuse-existing-worktree` : `create-new-worktree`,
              `stash-source-changes`,
              `checkout-local-branch`,
  ...
  if (te && T != null) {
    let e;
    t[39] !== ee || t[40] !== T.id || t[41] !== T.status || t[42] !== D
      ? ((e = () => {
          if (T.status === `success` || T.status === `error`) {
            D(T.id);
            return;
    ...
    let i;
    return (
      t[52] !== M || t[53] !== Re || t[54] !== r
        ? ((i = (0, Z.jsx)(yn, { size: `compact`, open: M, onOpenChange: Re, children: r })),
          (t[52] = M),
          (t[53] = Re),
          (t[54] = r),
          (t[55] = i))
  ...
  t[65] !== Ke || t[66] !== qe || t[67] !== Je
    ? ((Ze = (0, Z.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [Ke, qe, Je] })),
      (t[65] = Ke),
      (t[66] = qe),
      (t[67] = Je),
      (t[68] = Ze))
  ...
  t[71] === Me
    ...
    : ((et = Me
      ...
      (t[72] = et));
  let tt;
  t[73] !== ze || t[74] !== Pe || t[75] !== Me || t[76] !== et
    ? ((tt = (0, Z.jsx)(ke, {
        className: `h-11 w-full justify-center rounded-full px-4 text-base font-medium`,
        color: `primary`,
        disabled: Pe,
  ...
  t[81] !== $e || t[82] !== tt || t[83] !== nt
    ...
    : (it = t[84]);
  let at;
  t[85] !== He.Root || t[86] !== Ue || t[87] !== Ze || t[88] !== it
    ? ((at = (0, Z.jsxs)(He.Root, { className: `gap-5`, children: [Ue, Ze, it] })),
      (t[85] = He.Root),
      (t[86] = Ue),
      (t[87] = Ze),
      (t[88] = it),
  ...
  let ct;
  return (
    t[90] !== Ve || t[91] !== Re || t[92] !== n || t[93] !== at
      ? ((ct = (0, Z.jsx)(Ve, { size: `compact`, open: n, onOpenChange: Re, children: at })),
        (t[90] = Ve),
        (t[91] = Re),
        (t[92] = n),
        (t[93] = at),
...
function Ri(e) {
  ...
  if (r) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Wi.jsx)(jt, { href: S, className: Gi })), (t[0] = e))
      : (e = t[0]);
    let n;
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  t[8] === c
    ? (l = t[9])
    : ((l = (0, Wi.jsx)(`span`, { className: `text-token-description-foreground`, children: c })),
      (t[8] = c),
      (t[9] = l));
  let u;
  return (
...
function Bi(e) {
  ...
  let m;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, Wi.jsx)(Yt, { className: `icon-xxs` })), (t[4] = m))
    : (m = t[4]);
  let h;
  t[5] !== f || t[6] !== p
    ? ((h = (0, Wi.jsx)(ke, {
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Wi.jsx)(q.Separator, {})), (t[38] = E))
    : (E = t[38]);
  let ee;
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, Wi.jsx)(jt, { href: `${S}/settings/environments`, className: Gi })), (t[39] = ee))
    : (ee = t[39]);
  let D;
  ...
  let O;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, Wi.jsx)(jt, { href: Ki, className: Gi })), (t[41] = O))
    : (O = t[41]);
  let k;
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, Wi.jsxs)(q.Section, {
...
function Vi(e) {
  Ht({ disposition: `current-tab`, event: e, href: Ki, initiator: `open_in_browser_bridge` });
}
function Hi(e) {
  Ht({
...
function Ji(e) {
  let t = (0, ha.c)(151),
    {
      ...
      crossHostHandoffEnabled: h,
      showCrossHostHandoff: g,
      localWorkspaceRootForHandoff: _,
      localModeIcon: v,
      remoteLabel: y,
      showWorktree: x,
      hasGitRepo: C,
      ...
      closeDropdown: A,
      openHandoffDialog: j,
      openHostWorktreeHandoffDialog: te,
    } = e,
    M = o(st),
    N = rt(),
    { activeMode: re } = ne(i),
    ie = re?.settings.model ?? null,
    { data: ae } = c(Re),
    P = ae === void 0 ? null : ae,
    F = P?.plan_type,
    I;
  t[0] === F ? (I = t[1]) : ((I = Rn(F)?.pricePlan ?? null), (t[0] = F), (t[1] = I));
  let L = I,
    oe = P?.rate_limit,
    se = P?.credits,
    ce;
  t[2] !== F || t[3] !== oe || t[4] !== se
    ? ((ce = mn(oe, se, F)), (t[2] = F), (t[3] = oe), (t[4] = se), (t[5] = ce))
    : (ce = t[5]);
  let z = ce,
    B,
    le,
    ...
    H;
  if (
    t[6] !== z?.primary?.windowDurationMins ||
    t[7] !== z?.secondary?.windowDurationMins ||
    t[8] !== P ||
    t[9] !== ie
  ) {
    let e = dn(P),
      n = pn(P);
    ((le = sn(e, { activeLimitName: n, selectedModel: ie })),
      (B = le.find(Zi)?.limitName ?? n ?? null),
      (V = fn(P, { activeLimitName: n, selectedModel: ie })),
      (H = le.some(Xi) || !!z?.primary?.windowDurationMins || !!z?.secondary?.windowDurationMins),
      (t[6] = z?.primary?.windowDurationMins),
      (t[7] = z?.secondary?.windowDurationMins),
      (t[8] = P),
      (t[9] = ie),
      ...
      (t[12] = V),
      (t[13] = H));
  } else ((B = t[10]), (le = t[11]), (V = t[12]), (H = t[13]));
  let ue = H,
    de = An(),
    fe = kn(),
    pe = L != null && fe !== `web`,
  ...
  t[14] !== a.hostConfig || t[15] !== w
    ...
    : (ge = t[16]);
  let ve = d(R, ge),
    be = ve ?? N.formatMessage($.fallbackBranch),
    xe = Un(i),
    W = g ? kr(xe) : xe,
    Se = W?.direction === `to-host-worktree` ? null : W,
    G = W?.status === `queued` || W?.status === `running`,
    Ce = W?.direction === `to-host-worktree` && G,
    we = d(ye, i),
    { openOperation: Te } = Gn(),
    Ee = b(p ? null : a.activeWorkspaceRoot, he?.codexHome),
    De = ve ?? fa(xe, i) ?? (g ? we : null),
    Oe = Or({ codexWorktree: Ee, operation: Se, threadHandoff: l }),
    ke = jr({
      conversationId: i,
      handoffBranch: De,
      handoffDirection: Oe,
  ...
  let Ie = Fe,
    Le;
  t[25] !== Ce || t[26] !== Me || t[27] !== N || t[28] !== Se
    ? ((Le = Ce ? N.formatMessage($.finishCurrentHandoffTooltip) : Se == null ? void 0 : Me),
      (t[25] = Ce),
      (t[26] = Me),
      (t[27] = N),
      (t[28] = Se),
  ...
  let ze = Le,
    Be = p
      ? N.formatMessage($.workRemotelyTooltipWithoutPath, {
          hostDisplayName: m?.connectionDisplayName ?? y,
        })
      : N.formatMessage($.workLocallyTooltip, { branchName: be }),
    Ve;
  t[30] !== A || t[31] !== j || t[32] !== Te || t[33] !== Se
    ? ((Ve = () => {
        if ((A(), Se != null)) {
          (j(), Te(Se.id));
          return;
    ...
    : (Ve = t[34]);
  let He = Ve,
    Ue = g && ((i != null && l != null) || W?.direction === `to-host-worktree`),
    Ke;
  t[35] !== n || t[36] !== a.hostConfig || t[37] !== w
    ? ((Ke = (0, Q.jsx)(ua, { composerMode: n, gitRoot: w, hostConfig: a.hostConfig })),
      (t[35] = n),
      (t[36] = a.hostConfig),
      (t[37] = w),
      (t[38] = Ke))
  ...
  let Je = u === `enabled` ? `min-w-[175px]` : `w-52`,
    Ye;
  t[44] === Je ? (Ye = t[45]) : ((Ye = ht(`flex flex-col`, Je)), (t[44] = Je), (t[45] = Ye));
  let Xe;
  t[46] === s.isAttachedToStartedTask
    ...
    : ((Xe = (0, Q.jsx)(q.Title, {
      ...
      (t[46] = s.isAttachedToStartedTask),
      (t[47] = Xe));
  let Ze = n === `local` ? Ge : void 0,
    Qe;
  t[48] !== A || t[49] !== n || t[50] !== M || t[51] !== r
    ? ((Qe = () => {
        (n !== `local` && We(M, U, { mode: `local` }), r(`local`), A());
      }),
      (t[48] = A),
      (t[49] = n),
      (t[50] = M),
    ...
    : (Qe = t[52]);
  let $e;
  t[53] !== G || t[54] !== N || t[55] !== Be
    ? (($e = G ? N.formatMessage($.finishCurrentHandoffTooltip) : Be),
      (t[53] = G),
      (t[54] = N),
      (t[55] = Be),
      (t[56] = $e))
  ...
  t[57] === p
    ? (et = t[58])
    : ((et = p ? (0, Q.jsx)(K, { ...$.startInRemote }) : (0, Q.jsx)(K, { ...$.workLocally })),
      (t[57] = p),
      (t[58] = et));
  let tt;
  t[59] !== v || t[60] !== G || t[61] !== Ze || t[62] !== Qe || t[63] !== $e || t[64] !== et
    ? ((tt = (0, Q.jsx)(q.Item, {
        LeftIcon: v,
        RightIcon: Ze,
        disabled: G,
  ...
  t[75] !== k
    ? ((nt =
        ...
        (0, Q.jsx)(q.Item, {
          LeftIcon: In,
          RightIcon: n === `worktree` ? Ge : void 0,
          disabled: G,
          onClick: () => {
            (n !== `worktree` && We(M, U, { mode: `worktree` }), r(`worktree`), A());
          },
          tooltipText: G ? N.formatMessage($.finishCurrentHandoffTooltip) : k,
          children: (0, Q.jsxs)(`span`, {
            className: `inline-flex items-center gap-1`,
            children: [
              p ? (0, Q.jsx)(K, { ...$.remoteWorktreeMode }) : (0, Q.jsx)(K, { ...$.worktreeMode }),
              qe,
            ],
          }),
        })),
  ...
  t[84] !== r
    ? ((it =
        C || f
          ? u === `enabled`
            ? (0, Q.jsx)(q.Item, {
                LeftIcon: me,
                RightIcon: n === `cloud` ? Ge : void 0,
                disabled: G,
                onClick: () => {
                  (n !== `cloud` && We(M, U, { mode: `cloud` }), r(`cloud`));
                },
                tooltipText: G
            ...
            : (0, Q.jsxs)(Q.Fragment, {
                children: [
                  (0, Q.jsx)(q.Item, {
                    LeftIcon: rn,
                    rightIcon: (0, Q.jsx)(jt, { href: S, className: _a }),
                    href: S,
                    onClick: Yi,
                    children: (0, Q.jsx)(K, {
    ...
    : (it = t[85]);
  let at;
  t[86] !== u || t[87] !== O || t[88] !== T
    ? ((at = u === `enabled` ? (0, Q.jsx)(Qi, { selectedEnvironment: T, onClick: O }) : null),
      (t[86] = u),
      (t[87] = O),
      (t[88] = T),
      (t[89] = at))
  ...
  t[90] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ot = (0, Q.jsx)(`div`, { className: `mx-1 my-1.5 h-[0.5px] bg-token-foreground/10` })),
      (t[90] = ot))
    : (ot = t[90]);
  let ct;
  t[91] !== B ||
  ...
  t[100] !== de
    ? ((ct =
        ...
        (0, Q.jsx)(ft, {
          ...
          suppressUpsell: V,
          selectedModel: ie,
          planUpgradeOpensNativeSurface: pe,
          onPlanUpgradeClick:
            L == null
              ? void 0
              : (e) => {
  ...
  let lt;
  t[102] !== at || t[103] !== ct
    ? ((lt = (0, Q.jsxs)(bn, { extension: !0, children: [at, ot, ct] })),
      (t[102] = at),
      (t[103] = ct),
      (t[104] = lt))
    : (lt = t[104]);
        ...
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              ...
              (0, Q.jsxs)(q.Item, {
                ...
                tooltipText: ze,
                children: [
                  (0, Q.jsx)(q.ItemIcon, { children: Ie }),
                  (0, Q.jsx)(ea, { useContinueLabel: h, direction: Oe, isRemoteHost: p }),
                ],
              }),
            ],
          })
  ...
  return (
    ...
    t[148] !== dt ||
    t[149] !== pt
      ? ((mt = (0, Q.jsxs)(`div`, { className: Ye, children: [Xe, tt, nt, it, lt, ut, dt, pt] })),
        (t[141] = Ye),
        (t[142] = Xe),
        (t[143] = tt),
        (t[144] = nt),
...
function $i(e) {
  let t = (0, ha.c)(51),
    ...
    v;
  t[0] !== u || t[1] !== l || t[2] !== f
    ? ((v = { sourceHostId: l, sourceGitRoot: u, sourceWorkspaceRoot: f }),
      (t[0] = u),
      (t[1] = l),
      (t[2] = f),
      (t[3] = v))
    ...
    ? ((A =
        w == null
          ...
          : (0, Q.jsxs)(q.Item, {
              ...
              children: [
                (0, Q.jsx)(q.ItemIcon, {
                  children: E ? s : (0, Q.jsx)(Ln, { className: `icon-2xs` }),
                }),
                (0, Q.jsx)(K, {
  ...
  if (
    ...
    let e;
    (t[40] !== x || t[41] !== C || t[42] !== O || t[43] !== s || t[44] !== _ || t[45] !== i
      ? ((e = (e) => {
          if (e.status !== `ready`) {
          ...
          return (0, Q.jsx)(
            ta,
            {
              hostDisplayName: t,
              disabled: a,
              icon: r ? s : (0, Q.jsx)(Wt, { className: `icon-2xs` }),
  ...
  return (
    t[47] !== k || t[48] !== A || t[49] !== j
      ? ((te = (0, Q.jsxs)(Q.Fragment, { children: [k, A, j] })),
        (t[47] = k),
        (t[48] = A),
        (t[49] = j),
        (t[50] = te))
...
function ta(e) {
  let t = (0, ha.c)(10),
    ...
    s;
  t[0] === i ? (s = t[1]) : ((s = (0, Q.jsx)(q.ItemIcon, { children: i })), (t[0] = i), (t[1] = s));
  let c;
  t[2] === n
    ? (c = t[3])
    : ((c = (0, Q.jsx)(K, {
  ...
  return (
    t[4] !== r || t[5] !== o || t[6] !== s || t[7] !== c || t[8] !== a
      ? ((l = (0, Q.jsxs)(q.Item, { disabled: r, onSelect: o, tooltipText: a, children: [s, c] })),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s),
        (t[7] = c),
...
function sa(e) {
  ...
  let C = d(R, S),
    ...
    ee = T?.status === `queued` || T?.status === `running`,
    D = T?.direction === `to-host-worktree` && ee,
    O = d(ye, c),
    { openOperation: k } = Gn(),
    j = C ?? fa(w, c) ?? (s ? O : null),
    te = jr({
  ...
  let P = ae,
    F;
  t[11] !== D || t[12] !== ne || t[13] !== x || t[14] !== E
    ? ((F = D ? x.formatMessage($.finishCurrentHandoffTooltip) : E == null ? void 0 : ne),
      (t[11] = D),
      (t[12] = ne),
      (t[13] = x),
      (t[14] = E),
  ...
  t[16] !== r || t[17] !== v || t[18] !== k || t[19] !== E
    ...
    : (L = t[20]);
  let oe = L,
    se = s && ((c != null && p != null) || T?.direction === `to-host-worktree`),
    ce = te || (se && (T?.direction === `to-host-worktree` || b != null)),
    z;
  t[21] !== l.cwd || t[22] !== te || t[23] !== ce || t[24] !== s || t[25] !== _ || t[26] !== m
    ? ((z =
        _ === `summary-panel`
          ? (0, Q.jsx)(A, {
              icon: (0, Q.jsx)(In, { className: `icon-sm shrink-0 text-token-foreground` }),
              label: (0, Q.jsxs)(`span`, {
                className: `flex min-w-0 items-center gap-1 text-token-foreground`,
                children: [
                  (0, Q.jsx)(`span`, { className: `min-w-0 truncate`, children: m }),
                  te
                    ? (0, Q.jsx)(_t, { className: `icon-2xs shrink-0 text-token-text-tertiary` })
                    : null,
                ],
              }),
              ...
              title: l.cwd ?? void 0,
              trailing:
                s && ce ? (0, Q.jsx)(Ze, { className: `icon-xs text-token-text-tertiary` }) : null,
            })
          : (0, Q.jsx)(On, {
              categoryLabel: null,
              collapse: `none`,
              icon: null,
              indicator: ce ? `chevron` : `none`,
              value: m,
    ...
    : (z = t[27]);
  let B = z,
    le = _ === `summary-panel` && `w-full`,
    V;
  t[28] === le ? (V = t[29]) : ((V = ht(le)), (t[28] = le), (t[29] = V));
  let H;
  t[30] !== a ||
  t[31] !== c ||
  t[32] !== o ||
    ...
    ? ((H = ce
        ? (0, Q.jsx)(Bt, {
            ...
            triggerButton:
              _ === `summary-panel`
                ? B
                : (0, Q.jsx)(Oe, { tooltipContent: h, tooltipMaxWidth: g, children: B }),
            children: (0, Q.jsxs)(`div`, {
              className: ht(`flex flex-col`, s ? `min-w-[220px]` : `min-w-[180px]`),
              children: [
                s
                  ? (0, Q.jsx)(q.Title, {
                      children: (0, Q.jsx)(K, {
                ...
                te
                  ? (0, Q.jsxs)(q.Item, {
                      ...
                      tooltipText: I,
                      children: [
                        (0, Q.jsx)(q.ItemIcon, { children: P }),
                        (0, Q.jsx)(ea, {
                          useContinueLabel: s,
                          direction: `to-local`,
                          isRemoteHost: l.hostId !== ut,
                        }),
                      ],
                    })
                  : null,
  ...
  return (
    t[61] !== H || t[62] !== V
      ? ((ue = (0, Q.jsx)(`div`, { className: V, children: H })),
        (t[61] = H),
        (t[62] = V),
        (t[63] = ue))
      : (ue = t[63]),
...
function ca(e) {
  ...
  let p = d(R, f),
    ...
    g = d(ye, r),
    _ = Or({
      codexWorktree: b(c ? null : a.activeWorkspaceRoot, u?.codexHome),
      operation: h,
      threadHandoff: s,
    }),
    v;
  t[3] !== r || t[4] !== p || t[5] !== m || t[6] !== l || t[7] !== g
    ? ((v = p ?? fa(m, r) ?? (l ? g : null)),
      (t[3] = r),
      (t[4] = p),
      (t[5] = m),
  ...
  if (
    (t[0] !== r || t[1] !== i || t[2] !== a
      ? ((o = {
        ...
        (t[3] = o))
      : (o = t[3]),
    !((d(qn, o)?.length ?? 0) > 0) || n !== `worktree`)
  )
    return null;
  let s;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(K, { ...$.worktreeSubmoduleWarning })), (t[4] = s))
    : (s = t[4]);
  let c;
  return (
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    ((ha = r()),
      ...
      (va = (0, ga.memo)(function (e) {
        let t = (0, ha.c)(177),
          ...
          re = Ce(`2256010998`),
          ie = Un(i),
          ae = re || ie?.direction === `to-host-worktree`,
          { access: P } = _n(),
          F = ee(i),
          I = a ?? F,
          L = dt(),
          oe;
        t[0] !== I.cwd || t[1] !== s || t[2] !== L
          ? ((oe = pa({ executionTargetCwd: I.cwd, footerRemoteState: s, remoteConnections: L })),
            (t[0] = I.cwd),
            (t[1] = s),
            (t[2] = L),
            (t[3] = oe))
        ...
        let le = d(Ie, B),
          ...
          H = z?.root ?? null,
          { data: ue } = c(Fe),
          de = ae && D && I.hostId !== `local` ? ue?.roots : void 0,
          fe;
        t[10] === de ? (fe = t[11]) : ((fe = de ?? []), (t[10] = de), (t[11] = fe));
        let pe;
        t[12] === fe
          ? (pe = t[13])
          : ((pe = { params: { hostId: ut, dirs: fe }, source: `local_remote_dropdown` }),
            (t[12] = fe),
            (t[13] = pe));
        let { data: he } = d(kt, pe),
          ge;
        t[14] === I.cwd
          ? (ge = t[15])
          : ((ge = I.cwd == null ? [] : [I.cwd]), (t[14] = I.cwd), (t[15] = ge));
        let _e;
        t[16] !== I.hostId || t[17] !== ge
          ? ((_e = { params: { hostId: I.hostId, dirs: ge }, source: `local_remote_dropdown` }),
            (t[16] = I.hostId),
            (t[17] = ge),
            (t[18] = _e))
          : (_e = t[18]);
          ...
          ? ((U =
              de == null
                ...
                : bt({
                    ...
                    sourceGitRoot: H,
                    sourceGitOrigins: ve?.origins,
                    destinationWorkspaceRoots: de,
                    destinationGitOrigins: he?.origins,
                  })),
            (t[19] = I.cwd),
            (t[20] = H),
            (t[21] = he?.origins),
        ...
        let ye = U,
          be;
        t[25] !== P || t[26] !== V
          ? ((be = gr({ cloudAccess: P, hasGitRepository: V, isBrowser: !1 })),
            (t[25] = P),
            (t[26] = V),
            (t[27] = be))
          : (be = t[27]);
          ...
          : ((Te = G
              ? (0, Q.jsxs)(Q.Fragment, {
                  children: [
                    (0, Q.jsx)(K, { ...$.runInCloud }),
                    (0, Q.jsx)(`span`, {
                      className: M.runLocationEnvironmentSuffix,
                      children: (0, Q.jsx)(K, {
              ...
              : (0, Q.jsxs)(Q.Fragment, {
                  children: [
                    (0, Q.jsx)(`span`, {
                      className: M.defaultExternalFooterOnly,
                      children: (0, Q.jsx)(K, { ...$.selectEnvironment }),
                    }),
                    (0, Q.jsx)(`span`, {
                      className: ht(M.homeExternalFooterOnly, `hidden`),
                      children: (0, Q.jsx)(K, { ...$.runInCloud }),
                    }),
                  ],
                })),
        ...
        let ke = De,
          ...
          je;
        t[32] !== N || t[33] !== R
          ? ((je = R ? N.formatMessage($.startInRemote) : N.formatMessage($.workLocally)),
            (t[32] = N),
            (t[33] = R),
            (t[34] = je))
          : (je = t[34]);
        ...
        t[35] !== N || t[36] !== R
          ? ((Ne = R
              ? N.formatMessage($.remoteWorktreeTooltip)
              : N.formatMessage($.worktreeTooltip)),
            (t[35] = N),
            (t[36] = R),
            (t[37] = Ne))
          : (Ne = t[37]);
        ...
        let Ve = Be,
          He;
        (t[42] !== Ae || t[43] !== Me || t[44] !== Re || t[45] !== ze || t[46] !== Ve
          ? ((He = {
              id: `local`,
              title: Me,
              description: Re,
        ...
        let Ue;
        t[48] !== N || t[49] !== R
          ? ((Ue = R ? N.formatMessage($.remoteWorktreeMode) : N.formatMessage($.worktreeMode)),
            (t[48] = N),
            (t[49] = R),
            (t[50] = Ue))
          : (Ue = t[50]);
        ...
        let qe = Ke,
          Je;
        (t[55] !== Ue || t[56] !== We || t[57] !== Ge || t[58] !== qe
          ? ((Je = {
              id: `worktree`,
              title: Ue,
              description: We,
        ...
        t[60] === N
          ? (Ye = t[61])
          : ((Ye = N.formatMessage($.runInCloud)), (t[60] = N), (t[61] = Ye));
        let Xe;
        t[62] === N
          ? (Xe = t[63])
          : ((Xe = N.formatMessage({
        ...
        let $e = Qe,
          et;
        (t[66] !== Ye || t[67] !== Xe || t[68] !== Ze || t[69] !== $e
          ? ((et = {
              id: `cloud`,
              title: Ye,
              description: Xe,
        ...
        t[81] !== u
          ? ((ct = () => {
              i == null ||
                ...
                Mn(E, ca, {
                  conversationId: i,
                  composerViewState: E.get(Tt),
                  executionTarget: I,
                  gitRoot: H,
                  isLocalModeRemote: R,
                  threadHandoff: u,
                  showCrossHostHandoff: ae,
                });
            }),
            (t[75] = i),
            (t[76] = I),
        ...
        t[83] !== i || t[84] !== E || t[85] !== u
          ...
          : (ft = t[86]);
        let pt = ft,
          mt = T === `summary-panel` ? `icon-sm text-token-foreground` : `icon-xs`,
          gt;
        t[87] !== n || t[88] !== R || t[89] !== mt
          ? ((gt =
              n === `cloud`
                ? (0, Q.jsx)(me, { className: mt })
                : n === `worktree`
                  ? (0, Q.jsx)(In, { className: mt })
                  : R
                    ? (0, Q.jsx)(Wt, { className: mt })
                    : (0, Q.jsx)(Ln, { className: mt })),
            (t[87] = n),
            (t[88] = R),
            (t[89] = mt),
            (t[90] = gt))
              ...
              n === `cloud`
                ...
                : n === `worktree`
                  ...
                  : T === `summary-panel` && !R
                    ...
                    : R
                      ? (0, Q.jsx)(da, { rateLimit: null, isRemoteHost: R })
                      : (0, Q.jsxs)(Q.Fragment, {
                          children: [
                            (0, Q.jsx)(`span`, {
                              className: M.defaultExternalFooterOnly,
        ...
        let xt = yt,
          St;
        t[96] !== x || t[97] !== N || t[98] !== vt || t[99] !== xt || t[100] !== T
          ? ((St =
              T === `summary-panel`
                ? (0, Q.jsx)(A, {
                    disabled: x,
                    ...
                    label: (0, Q.jsxs)(`span`, {
                      className: `flex min-w-0 items-center gap-1 text-token-foreground`,
                      children: [
                        (0, Q.jsx)(`span`, { className: `min-w-0 truncate`, children: xt }),
                        x
                          ? null
                          : (0, Q.jsx)(_t, {
                    ...
                    labelClassName: `flex min-w-0 items-center`,
                    title: N.formatMessage($.localRemoteWhereRun),
                  })
                : (0, Q.jsx)(On, {
                    categoryLabel: null,
                    collapse: `xs`,
              ...
              (0, Q.jsx)(Bt, {
                ...
                triggerButton:
                  T === `summary-panel`
                    ? Ct
                    : (0, Q.jsx)(Oe, {
                        tooltipContent: (0, Q.jsx)(K, { ...$.localRemoteWhereRun }),
                        children: Ct,
                      }),
                children: (0, Q.jsx)(Ji, {
                  composerMode: n,
                  ...
                  isBrowser: !1,
                  isLocalModeRemote: R,
                  currentLocalModeRemoteState: se,
                  crossHostHandoffEnabled: re,
                  showCrossHostHandoff: ae,
                  localWorkspaceRootForHandoff: ye,
                  localModeIcon: Ae,
                  remoteLabel: ke,
                  showWorktree: Se,
                  hasGitRepo: V,
                  ...
                  setSelectedEnvironment: we,
                  environmentSelectorOpen: k,
                  setEnvironmentSelectorOpen: j,
                  openEnvironmentSelector: st,
                  worktreeTooltipText: Le,
                  closeDropdown: () => O(!1),
                  openHandoffDialog: lt,
                  openHostWorktreeHandoffDialog: pt,
                }),
              })),
            (t[102] = Ae),
            (t[103] = P),
        ...
        let Mt = jt,
          Nt = S || (i == null && !R && !le && !V),
          q;
        t[152] !== Dt || t[153] !== Nt || t[154] !== C || t[155] !== Mt
          ? ((q = Nt ? null : C ? Mt : Dt()),
            (t[152] = Dt),
            (t[153] = Nt),
            (t[154] = C),
        ...
        t[157] === te
          ? (Ft = t[158])
          : ((Ft = te ? (0, Q.jsx)(gn, {}) : null), (t[157] = te), (t[158] = Ft));
        let It;
        t[159] !== xe || t[160] !== n || t[161] !== G || t[162] !== r || t[163] !== we
          ? ((It =
              xe && n === `cloud`
                ? (0, Q.jsx)(ra, {
                    selectedEnvironment: G,
          ...
          : (It = t[164]);
        let Lt;
        t[165] !== xe || t[166] !== n || t[167] !== G || t[168] !== we
          ? ((Lt =
              xe && n === `cloud` && G == null
                ? (0, Q.jsx)(oa, { setSelectedEnvironment: we })
                : null),
            (t[165] = xe),
            (t[166] = n),
            (t[167] = G),
        ...
        t[170] === Pt
          ? (zt = t[171])
          : ((zt = (0, Q.jsx)(bn, { extension: !0, electron: !0, browser: !0, children: Pt })),
            (t[170] = Pt),
            (t[171] = zt));
        let Vt;
        return (
          t[172] !== Ft || t[173] !== It || t[174] !== Lt || t[175] !== zt
            ? ((Vt = (0, Q.jsxs)(Q.Fragment, { children: [Ft, It, Lt, zt] })),
              (t[172] = Ft),
              (t[173] = It),
              (t[174] = Lt),
              (t[175] = zt),
