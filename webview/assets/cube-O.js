...
import { X as i, Y as a, jt as o } from "./use-host-config.js";
...
import { w as p } from "./parse-directives.js";
import { t as m } from "./plugin-install-store.js";
import { m as h } from "./use-plugins.js";
import { o as g } from "./plugin-detail-route-utils.js";
import { n as _ } from "./get-file-icon.js";
import { c as v } from "./inline-mentions.js";
import { n as y, t as b } from "./use-plugin-install-flow.js";
import { i as x, n as S, t as C } from "./popover.js";
import { _ as w, g as T } from "./mention-metadata-syncer.js";
import { n as E } from "./markdown-2.js";
import { t as D } from "./comment.js";
import { a as O } from "./use-dictation-hotkey.js";
import { r as k, t as A } from "./comment-attachment-labels.js";
...
function F(e, { underOneSecond: t = `null`, trimZeroUnits: n = !1 } = {}) {
  let r = Math.max(e, 0),
    i = Math.floor(r / 1e3);
...
function I(e) {
  return F(e, { underOneSecond: `zero`, trimZeroUnits: !0 }) ?? `0s`;
}
var L = r();
function R(e) {
  let t = (0, L.c)(25),
  ...
  let { forceReload: l } = h(n, i, c),
    d;
  t[2] !== l || t[3] !== n || t[4] !== r
    ? ((d = { forceReloadPlugins: l, hostId: n, onRequiredAppConnected: r }),
      (t[2] = l),
      (t[3] = n),
      (t[4] = r),
      (t[5] = d))
  ...
  let {
      ...
      connectRequiredApp: _,
      handleRequiredAppConnected: v,
      handleRequiredAppOAuthStarted: x,
      installPlugin: S,
      isInstalling: C,
      session: w,
    } = b(d),
...
function B(e) {
  ...
  let T = b,
    E;
  t[5] !== n || t[6] !== r
    ? ((E = n == null ? { icon: r } : { Icon: n }), (t[5] = n), (t[6] = r), (t[7] = E))
    : (E = t[7]);
  let D;
  t[8] === i
    ? (D = t[9])
    : ((D = (0, N.jsx)(`span`, {
        ...
        children: (0, N.jsx)(`span`, { className: `truncate`, children: i }),
      })),
      (t[8] = i),
      (t[9] = D));
  let O;
  t[10] !== a || t[11] !== o || t[12] !== E || t[13] !== D
    ? ((O = (0, N.jsx)(`div`, {
        ...
        children: (0, N.jsx)(x, {
          asChild: !0,
          children: (0, N.jsx)(w, { ...E, onRemove: a, onRemoveAriaLabel: o, children: D }),
        }),
      })),
      (t[10] = a),
      (t[11] = o),
  ...
  let j;
  return (
    t[21] !== d || t[22] !== A || t[23] !== O
      ? ((j = (0, N.jsxs)(C, { open: d, onOpenChange: f, children: [O, A] })),
        (t[21] = d),
        (t[22] = A),
        (t[23] = O),
        (t[24] = j))
...
function H(e) {
  ...
  t[3] !== i || t[4] !== r
    ...
    : (o = t[5]);
  let c;
  t[6] === n ? (c = t[7]) : ((c = (0, N.jsx)(U, { selections: n })), (t[6] = n), (t[7] = c));
  let l;
...
function G(e) {
  let t = (0, L.c)(19),
    ...
    l;
  t[0] !== r || t[1] !== n || t[2] !== c
    ? ((l = A(c, r, n)), (t[0] = r), (t[1] = n), (t[2] = c), (t[3] = l))
    : (l = t[3]);
  let u = l,
    d = i === `design-tweak` ? O : D,
    f;
  t[4] !== r || t[5] !== c || t[6] !== a
    ? ((f = a == null ? void 0 : k(c, r)), (t[4] = r), (t[5] = c), (t[6] = a), (t[7] = f))
    : (f = t[7]);
  let p = f;
  if (o == null) {
    let e;
    return (
      t[8] !== d || t[9] !== u || t[10] !== a || t[11] !== p
        ? ((e = (0, N.jsx)(T, { filename: u, Icon: d, onRemove: a, onRemoveAriaLabel: p })),
          (t[8] = d),
          (t[9] = u),
          (t[10] = a),
          (t[11] = p),
  ...
  let m;
  return (
    t[13] !== d || t[14] !== u || t[15] !== a || t[16] !== p || t[17] !== o
      ? ((m = (0, N.jsx)(B, {
          Icon: d,
          label: u,
          onRemove: a,
...
function q(e) {
  ...
  t[0] !== e.commentAttachments || t[1] !== e.comments
    ? ((u = e.commentAttachments == null ? e.comments : e.commentAttachments.map(a)),
  ...
  t[3] !== e.commentAttachments || t[4] !== e.screenshotThumbnailSrcs
    ? ((f = e.commentAttachments == null ? e.screenshotThumbnailSrcs : e.commentAttachments.map(X)),
  ...
  let y = _,
    b;
  if (t[10] !== d || t[11] !== r || t[12] !== o || t[13] !== g || t[14] !== m || t[15] !== y) {
    let e;
    (t[17] !== r || t[18] !== o || t[19] !== g || t[20] !== m || t[21] !== y
      ? ((e = (e, t) => {
          let n = i(e),
            a = null,
            s = null,
            u = e.artifactAnnotationFilePath ?? e.pdfAnnotationFilePath,
            d = e.origin === `artifact_annotation` || e.origin === `pdf`;
          n.type === `details` &&
            ((a = n.pathLabel),
            a != null && e.origin === `diff`
              ? ((a = $(e.path, r)), (s = te(e, r)))
              : a != null && d && u != null && (s = p(u)));
          let f = d ? (u ?? a ?? void 0) : (a ?? void 0),
            h = m?.[t],
            _ =
              e.origin === `pdf` && h != null && e.pdfAnnotationContentPreview == null
                ? { type: `image`, src: h }
                : null,
            b = h == null || e.origin === `pdf` ? null : (0, N.jsx)(ee, { alt: g, src: h }),
            x = e.artifactAnnotationContentPreview ?? e.pdfAnnotationContentPreview ?? _,
            S = x?.type === `image` ? x : null,
            C = S != null;
          return (0, N.jsxs)(
            `div`,
            {
              className: l(
                `min-w-0 px-2.5 py-2`,
                C ? `flex items-start gap-2` : `flex flex-col gap-1.5`,
              ),
              children: [
                (0, N.jsxs)(`div`, {
                  ...
                  children: [
                          ...
                          ? (0, N.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                n.browserElementPreview == null
                                  ? a
                                    ? s == null
                                      ? (0, N.jsx)(`span`, { className: `break-all`, children: a })
                                      : d
                                        ? (0, N.jsx)(J, {
                                            cwd: r,
                                            hostId: o,
                                ...
                                n.lineRange == null
                                  ? null
                                  : (0, N.jsx)(`span`, { children: n.lineRange }),
                    ...
                    x?.type === `text`
                      ...
                      : null,
                    (0, N.jsx)(Z, { comment: e, cwd: r, hostId: o }),
                  ],
                }),
                S == null ? null : (0, N.jsx)(Y, { alt: S.alt?.trim() || y, src: S.src }),
              ],
            },
...
function J(e) {
  ...
  t[0] === a.path
    ? (s = t[1])
    : ((s = (0, M.createElement)(_(a.path), { className: `icon-xs shrink-0` })),
      (t[0] = a.path),
      (t[1] = s));
  let c;
  t[2] === i
    ? (c = t[3])
    : ((c = (0, N.jsx)(`span`, { className: `min-w-0 truncate`, children: i })),
      (t[2] = i),
      (t[3] = c));
  let l;
  t[4] !== s || t[5] !== c
...
function Z(e) {
  ...
  if (n.designTweak && n.designTweakChanges != null) {
    ...
    t[0] !== n.body || t[1] !== n.designTweakChanges
      ? ((e = Q(n.body, n.designTweakChanges)),
        (t[0] = n.body),
  ...
  let a;
  t[5] === n.body ? (a = t[6]) : ((a = j(n.body)), (t[5] = n.body), (t[6] = a));
  let o;
  return (
    t[7] !== r || t[8] !== i || t[9] !== a
      ? ((o = (0, N.jsx)(E, {
...
`)
      .map((e, t) => {
        let r = n.get(e);
        if (r == null) return (0, N.jsx)(`span`, { children: e }, t);
        let i = `${r.property}: `,
          a = ` ${K} `,
          o = `${r.property}: ${r.previousValue} ${K} ${r.nextValue}`;
        return (0, N.jsxs)(
          `span`,
          {
            "aria-label": o,
            ...
            children: [
              (0, N.jsx)(`span`, { className: `text-token-text-secondary`, children: i }),
              (0, N.jsx)(`span`, { children: r.previousValue }),
              (0, N.jsx)(`span`, {
                "aria-hidden": `true`,
                className: `text-token-description-foreground`,
                children: a,
              }),
              (0, N.jsx)(`span`, { children: r.nextValue }),
            ],
          },
          t,
        );
...
function te(e, t) {
  let n = $(e.path, t),
    r = e.lineRange;
  if (r == null) return p(n);
  let i =
    r.match(e.side === `left` ? /L(\d+)/ : /R(\d+)/)?.[1] ?? (/^\d+(?:-\d+)?$/.test(r) ? r : null);
  return p(i == null ? n : `${n}:${i}`);
}
function $(e, t) {
  return t == null ? e : d(o(e, t));
}
function ne(e) {
...
export { U as a, I as c, H as i, F as l, q as n, B as o, G as r, R as s, re as t, P as u };
//# sourceMappingURL=cube-O.js.map
