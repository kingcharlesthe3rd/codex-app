...
import { o as r, s as i, z as a } from "./app-scope.js";
import { ao as o, co as s, io as c } from "./app-server-manager-signals.js";
import { A as l, r as u, s as d } from "./vscode-api.js";
import { l as f, s as p } from "./lib.js";
...
import { t as y } from "./regenerate.js";
import { r as b, t as x } from "./dropdown.js";
import { t as S } from "./file.js";
import { t as C } from "./image-square.js";
import { t as w } from "./clock.js";
import { t as T } from "./warning.js";
import { t as E } from "./route-scope.js";
import { t as D } from "./check-circle-filled.js";
import { it as O, r as k } from "./review-navigation-model.js";
import { t as A } from "./json.js";
import { t as j } from "./three-dots.js";
import { t as M } from "./unselected-circle.js";
import { t as N } from "./x-circle-filled-Do-SvWo6.js";
import { n as P, r as F } from "./code-snippet.js";
import { p as I } from "./use-diff-annotations.js";
import { t as L } from "./pull-request-open.js";
import { t as R } from "./comment-B.js";
...
function J({ className: e = `icon-sm shrink-0`, checks: t }) {
  ...
  if (n.length === 0) return (0, W.jsx)(M, { className: r });
...
function ce(e) {
  ...
  t[0] === i
    ? (o = t[1])
    : ((o = (0, W.jsx)(b.SectionLabel, { children: i })), (t[0] = i), (t[1] = o));
  let s;
  t[2] === r
    ? (s = t[3])
    : ((s = (0, W.jsx)(`div`, {
...
function pe(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i) {
    ...
    ((c = `max-w-[220px]`),
      ...
      t[7] === i
        ? (o = t[8])
        : ((o = (0, W.jsx)(b.SectionLabel, { children: i })), (t[7] = i), (t[8] = o)),
      (s =
        e.length === 0
          ? (0, W.jsx)(b.Message, { compact: !0, children: n })
          : (0, W.jsx)(`div`, {
              className: `flex max-h-[104px] flex-col overflow-y-auto`,
              children: e.map(me),
            })),
...
function _e(e, t) {
  return (0, W.jsxs)(
    `div`,
    {
      ...
      children: [
        (0, W.jsx)(b.SectionLabel, { children: e.title }),
        (0, W.jsx)(`div`, {
...
function be(e) {
  ...
  let { startLine: i, startSide: a, endLine: c, endSide: l } = r,
    u;
  t[2] !== n || t[3] !== c || t[4] !== l || t[5] !== i || t[6] !== a
    ? ((u =
        i === c && a === l
          ? (0, W.jsx)(p, {
...
function Ce({ checks: e, ciStatus: t }) {
  if (e.length === 0)
    switch (t) {
      case `failing`:
        return (0, W.jsx)(N, { className: `icon-sm shrink-0 text-token-charts-red` });
      case `none`:
        return (0, W.jsx)(w, { className: `icon-sm shrink-0` });
      case `passing`:
        return (0, W.jsx)(D, { className: `icon-sm shrink-0 text-token-charts-green` });
      case `pending`:
        return (0, W.jsx)(ne, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    }
  return t === `none`
    ? (0, W.jsx)(w, { className: `icon-sm shrink-0` })
    : (0, W.jsx)(J, { checks: e });
}
function we(e) {
  switch (e) {
...
function Je({
  ...
  let v = r.length,
    ...
    x = Ce({ checks: t, ciStatus: n }),
    S = we(n);
  return (
    h.includes(`checks-none`) && y.push({ icon: x, key: `checks-none`, label: S }),
    ...
    h.includes(`checks-pending`) &&
      y.push({ flyoutContent: b, icon: x, key: `checks-pending`, label: S }),
    h.includes(`checks-successful`) &&
      y.push({ flyoutContent: b, icon: x, key: `checks-successful`, label: S }),
    ...
    h.includes(`merging-blocked`) &&
      y.push({
        disabled: !0,
        icon: (0, W.jsx)(T, { className: `icon-sm shrink-0 text-token-charts-red` }),
        key: `merging-blocked`,
        label: (0, W.jsx)(p, {
...
function Ye({
  ...
  return {
    ...
    icon: (0, W.jsx)(R, { className: `icon-sm shrink-0` }),
    key: `comments`,
    label:
      r > 0
        ? i.formatMessage(
  ...
  switch (n) {
    ...
    case `review_required`:
      return {
        disabled: !r,
        flyoutContent: e,
        icon: (0, W.jsx)(w, { className: `icon-sm shrink-0 text-token-description-foreground` }),
        key: `awaiting-review`,
        label: (0, W.jsx)(p, {
...
function tt(e) {
  switch (e) {
    ...
    case `requested`:
      return (0, W.jsx)(w, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `commented`:
      return (0, W.jsx)(R, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `changes-requested`:
      return (0, W.jsx)(T, { className: `icon-sm shrink-0 text-token-charts-red` });
  }
}
function nt(e, t, n) {
...
function rt(e) {
  let t = (0, X.c)(20),
    ...
    c;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((c = nt(n, r, i)), (t[0] = n), (t[1] = r), (t[2] = i), (t[3] = c))
    : (c = t[3]);
  let f;
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((f = (e, t) => {
        if (e.status === `success`) {
          if (r != null) {
            let e = (e) => {
              s.setQueryData(u(`gh-pr-status`, e), it);
            };
            (e({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
              e({ cwd: t.cwd, headBranch: r, hostId: t.hostId, number: t.number, repo: t.repo }),
              Promise.all([
                s.invalidateQueries({ queryKey: u(`gh-pr-body`) }),
                s.invalidateQueries({ queryKey: u(`gh-pr-checks`) }),
                s.invalidateQueries({ queryKey: u(`gh-pr-comments`) }),
                s.invalidateQueries({
                  queryKey: u(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
                }),
                s.invalidateQueries({
                  queryKey: u(`gh-pr-status`, {
                    cwd: t.cwd,
                    headBranch: r,
                    hostId: t.hostId,
                    number: t.number,
  ...
  let p;
  t[8] !== a || t[9] !== c || t[10] !== f
    ? ((p = { source: a, mutationKey: c, onSuccess: f }),
      (t[8] = a),
      (t[9] = c),
      (t[10] = f),
      (t[11] = p))
    : (p = t[11]);
  let m = d(`gh-pr-merge`, p),
    h,
    g;
  t[12] !== i || t[13] !== m
    ? ((h = (e, t) => {
...
function lt() {
  ...
  return (
    e[2] !== n || e[3] !== a
      ? ((o = (0, W.jsx)(ut, { entries: n, onSelectPath: a })), (e[2] = n), (e[3] = a), (e[4] = o))
      : (o = e[4]),
    o
  );
}
function ut(e) {
  ...
  if (t[0] !== n || t[1] !== i || t[2] !== r || t[3] !== s || t[4] !== a) {
    ...
    let S;
    (t[16] !== d || t[17] !== a
      ? ((S = (0, W.jsx)(b.SearchInput, { autoFocus: !0, placeholder: d, value: a, onChange: y })),
        (t[16] = d),
        (t[17] = a),
        (t[18] = S))
      : (S = t[18]),
...
function gt(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, W.jsx)(j, { className: `icon-xs text-token-description-foreground` })), (t[11] = M))
    : (M = t[11]);
  let N;
  t[12] === O
    ? (N = t[13])
  ...
  let I;
  t[14] !== O || t[15] !== N
    ? ((I = (0, W.jsx)(v, { tooltipContent: O, delayOpen: !0, children: N })),
      (t[14] = O),
      (t[15] = N),
      (t[16] = I))
    : (I = t[16]);
  ...
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (z = t[35]);
  let B;
  t[36] !== a || t[37] !== o || t[38] !== S || t[39] !== u
    ? ((B = u
        ? (0, W.jsx)(yt, { Icon: y, label: S, onClick: () => a?.(), disabled: o || !a })
        : null),
      (t[36] = a),
      (t[37] = o),
      (t[38] = S),
  ...
  let V = r.wrap ? P : F,
    H;
  t[41] !== r.onToggleWrap || t[42] !== V || t[43] !== w
    ? ((H = (0, W.jsx)(yt, { Icon: V, label: w, onClick: r.onToggleWrap })),
      (t[41] = r.onToggleWrap),
      (t[42] = V),
      (t[43] = w),
      (t[44] = H))
  ...
  let U = r.expanded ? mt : pt,
    G;
  t[45] !== r.onToggleExpanded || t[46] !== E || t[47] !== U
    ? ((G = (0, W.jsx)(yt, { Icon: U, label: E, onClick: r.onToggleExpanded })),
  ...
  let q;
  return (
    t[51] !== R || t[52] !== B || t[53] !== H || t[54] !== G || t[55] !== K
      ? ((q = (0, W.jsxs)(`div`, {
          className: `flex items-center gap-1.5`,
          children: [R, z, B, H, G, K],
        })),
        (t[51] = R),
        (t[52] = B),
        (t[53] = H),
...
function _t(e) {
  ...
  let M = A,
    N;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, W.jsx)(j, { className: `icon-xs` })), (t[11] = N))
    : (N = t[11]);
  let I;
  t[12] === k
    ? (I = t[13])
  ...
  let L;
  t[14] !== k || t[15] !== I
    ? ((L = (0, W.jsx)(v, { tooltipContent: k, delayOpen: !0, children: I })),
      (t[14] = k),
      (t[15] = I),
      (t[16] = L))
    : (L = t[16]);
  let R;
  t[17] !== a || t[18] !== o || t[19] !== C || t[20] !== u
    ? ((R = u
        ? (0, W.jsx)(b.Item, {
            onSelect: (e) => {
              (e.preventDefault(), a?.(), M());
            },
            LeftIcon: y,
            disabled: o || !a,
            children: C,
  ...
  t[22] === r
    ? (z = t[23])
    : ((z = (e) => {
        (e.preventDefault(), r.onToggleWrap(), M());
      }),
      (t[22] = r),
      (t[23] = z));
  let B = r.wrap ? P : F,
    V;
  t[24] !== z || t[25] !== B || t[26] !== T
    ? ((V = (0, W.jsx)(b.Item, { onSelect: z, LeftIcon: B, children: T })),
      (t[24] = z),
      (t[25] = B),
      (t[26] = T),
      (t[27] = V))
  ...
  t[28] === r
    ? (H = t[29])
    : ((H = (e) => {
        (e.preventDefault(), r.onToggleExpanded(), M());
      }),
      (t[28] = r),
      (t[29] = H));
  let U = r.expanded ? mt : pt,
    G;
  t[30] !== D || t[31] !== H || t[32] !== U
    ? ((G = (0, W.jsx)(b.Item, { onSelect: H, LeftIcon: U, children: D })),
      (t[30] = D),
      (t[31] = H),
      (t[32] = U),
      (t[33] = G))
  ...
  let J;
  return (
    t[49] !== g || t[50] !== L || t[51] !== R || t[52] !== V || t[53] !== G || t[54] !== q
      ? ((J = (0, W.jsxs)(x, {
          open: g,
          onOpenChange: _,
          align: `end`,
...
function bt(e) {
  ...
  t[22] === l
    ...
    : ((z = l
      ...
      (t[23] = z));
  let B;
  t[24] !== D || t[25] !== T || t[26] !== R || t[27] !== z
    ? ((B = (0, W.jsx)(b.Item, { onSelect: D, "aria-label": T, LeftIcon: R, children: z })),
      (t[24] = D),
      (t[25] = T),
      (t[26] = R),
      (t[27] = z),
  ...
  t[29] === r
    ...
    : ((H = r
      ...
      (t[30] = H));
  let U;
  t[31] !== k || t[32] !== V || t[33] !== H
    ? ((U = (0, W.jsx)(b.Item, { onSelect: k, LeftIcon: V, children: H })),
      (t[31] = k),
      (t[32] = V),
      (t[33] = H),
      (t[34] = U))
