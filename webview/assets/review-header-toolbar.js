...
import { G as i, L as a, U as o, X as s, Z as c, m as l, u, wt as d } from "./setting-storage.js";
import { t as f } from "./tooltip.js";
import { t as p } from "./route-scope.js";
import { t as m } from "./button.js";
import { t as h } from "./spinner.js";
import { L as g, n as _ } from "./review-navigation-model.js";
import { t as v } from "./check-md.js";
import { t as y } from "./clock.js";
import { r as b, t as x } from "./dropdown.js";
import { t as S } from "./three-dots.js";
import { t as C } from "./warning.js";
import { c as w, l as T, o as E, p as D, u as O } from "./pull-request-status-Ceb-oAPn.js";
import { n as k, t as A } from "./json.js";
import { t as j } from "./image-square.js";
import { n as M, r as N } from "./code-snippet.js";
import { t as P } from "./regenerate.js";
import { t as F } from "./score-query-match.js";
import { n as I, t as L } from "./diff-unified.js";
import { t as R } from "./middle-truncated-text.js";
import { t as z } from "./document-search.js";
var B = e(n()),
  V = r(),
  H = (e) =>
    (0, V.jsx)(`svg`, {
...
function G({
  ...
  let _ = r.length,
    y = [],
    b = E({ canFix: e, checks: t, intl: s, onFixCheck: d, onOpenCheck: f }),
    x = w({ ciStatus: n }),
    S = T(n);
  return (
    g.includes(`checks-none`) && y.push({ icon: x, key: `checks-none`, label: S }),
    ...
    y.push(J({ flyoutContent: Y(m, s), intl: s, reviewStatus: p })),
    y.push(
      K({
    ...
    g.includes(`merging-blocked`) &&
      y.push({
        disabled: !0,
        icon: (0, V.jsx)(C, { className: `icon-sm shrink-0 text-token-charts-red` }),
        key: `merging-blocked`,
        label: (0, V.jsx)(o, {
    ...
    g.includes(`ready-to-merge`) &&
      y.push({
        ...
        icon: c.isPending
          ...
          : (0, V.jsx)(v, { className: `icon-sm shrink-0 text-token-description-foreground` }),
        key: `ready-to-merge`,
        label: (0, V.jsx)(o, {
        ...
        tooltipDisabled: c.mergeDisabledReason == null,
        tooltipText: l,
      }),
    y
  );
  ...
  switch (n) {
    case `approved`:
      return {
        disabled: !r,
        flyoutContent: e,
        icon: (0, V.jsx)(v, { className: `icon-sm shrink-0 text-token-description-foreground` }),
    ...
    case `review_required`:
      return {
        disabled: !r,
        flyoutContent: e,
        icon: (0, V.jsx)(y, { className: `icon-sm shrink-0 text-token-description-foreground` }),
        key: `awaiting-review`,
        label: (0, V.jsx)(o, {
...
function ne(e) {
  switch (e) {
    case `approved`:
      return (0, V.jsx)(v, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `requested`:
      return (0, V.jsx)(y, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `commented`:
      return (0, V.jsx)(H, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `changes-requested`:
      return (0, V.jsx)(C, { className: `icon-sm shrink-0 text-token-charts-red` });
  }
}
var Z = d();
function re(e, t, n) {
...
function ie(e) {
  let t = (0, Z.c)(20),
    { cwd: n, headBranch: r, hostId: i, operationSource: o, onSuccess: s } = e,
    c = a(),
    d;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((d = re(n, r, i)), (t[0] = n), (t[1] = r), (t[2] = i), (t[3] = d))
    : (d = t[3]);
  let f;
  t[4] !== r || t[5] !== s || t[6] !== c
    ? ((f = (e, t) => {
        if (e.status === `success`) {
          if (r != null) {
            let e = (e) => {
              c.setQueryData(u(`gh-pr-status`, e), ae);
            };
            (e({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
              e({ cwd: t.cwd, headBranch: r, hostId: t.hostId, number: t.number, repo: t.repo }),
              Promise.all([
                c.invalidateQueries({ queryKey: u(`gh-pr-body`) }),
                c.invalidateQueries({ queryKey: u(`gh-pr-checks`) }),
                c.invalidateQueries({ queryKey: u(`gh-pr-comments`) }),
                c.invalidateQueries({
...
function ue(e) {
  let t = (0, Z.c)(19),
    ...
    [l, u] = (0, B.useState)(!1),
    d;
  if (t[0] !== n || t[1] !== a || t[2] !== r || t[3] !== l || t[4] !== s) {
    let e = se(n, s),
      i;
    t[6] === a
      ? (i = t[7])
    ...
    t[15] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((y = (e) => c(e.currentTarget.value)), (t[15] = y))
      : (y = t[15]);
    let S;
    (t[16] !== p || t[17] !== s
      ? ((S = (0, V.jsx)(b.SearchInput, { autoFocus: !0, placeholder: p, value: s, onChange: y })),
        (t[16] = p),
        (t[17] = s),
        (t[18] = S))
      : (S = t[18]),
...
function ge(e) {
  let t = (0, Z.c)(57),
    {
      ...
      diffControls: r,
      onClickCopyGitApplyCommand: a,
      onRefreshGitQueries: o,
      refreshGitQueriesDisabled: s,
      showCopyGitApplyCommand: c,
      showHideWhitespace: l,
      showLoadFullFiles: u,
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, V.jsx)(S, { className: `icon-xs text-token-description-foreground` })), (t[11] = j))
    : (j = t[11]);
  let F;
  t[12] === O
    ? (F = t[13])
  ...
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (z = t[35]);
  let H;
  t[36] !== o || t[37] !== s || t[38] !== b || t[39] !== d
    ? ((H = d
        ? (0, V.jsx)($, { Icon: P, label: b, onClick: () => o?.(), disabled: s || !o })
        : null),
      (t[36] = o),
      (t[37] = s),
      (t[38] = b),
  ...
  let U = r.wrap ? M : N,
    W;
  t[41] !== r.onToggleWrap || t[42] !== U || t[43] !== w
    ? ((W = (0, V.jsx)($, { Icon: U, label: w, onClick: r.onToggleWrap })),
      (t[41] = r.onToggleWrap),
      (t[42] = U),
      (t[43] = w),
      (t[44] = W))
...
function _e(e) {
  ...
  let j = A,
    F;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, V.jsx)(S, { className: `icon-xs` })), (t[11] = F))
    : (F = t[11]);
  let I;
  t[12] === k
    ? (I = t[13])
  ...
  let H = r.wrap ? M : N,
    U;
  t[24] !== z || t[25] !== H || t[26] !== T
    ? ((U = (0, V.jsx)(b.Item, { onSelect: z, LeftIcon: H, children: T })),
      (t[24] = z),
      (t[25] = H),
      (t[26] = T),
      (t[27] = U))
  ...
  t[30] !== D || t[31] !== W || t[32] !== G
    ? ((K = (0, V.jsx)(b.Item, { onSelect: W, LeftIcon: G, children: D })),
      (t[30] = D),
      (t[31] = W),
      (t[32] = G),
      (t[33] = K))
...
function ve(e) {
  ...
  t[0] !== n.diffMode || t[1] !== r
    ...
    : (a = t[2]);
  let o = a,
    s = n.diffMode === `unified` ? I : L,
    c;
  t[3] === n
    ? (c = t[4])
    : ((c = () => n.onSelectDiffMode(n.diffMode === `unified` ? `right` : `left`)),
      (t[3] = n),
      (t[4] = c));
  let l;
  return (
    t[5] !== o || t[6] !== s || t[7] !== c
      ? ((l = (0, V.jsx)($, { Icon: s, label: o, onClick: c })),
        (t[5] = o),
        (t[6] = s),
        (t[7] = c),
        (t[8] = l))
...
function ye(e) {
  let t = (0, Z.c)(50),
    {
      onClose: n,
      wordDiffsEnabled: r,
      showCopyGitApplyCommand: a,
      showHideWhitespace: s,
      showLoadFullFiles: c,
  ...
  t[22] === d
    ...
    : ((z = d
      ...
      (t[23] = z));
  let B;
  t[24] !== T || t[25] !== C || t[26] !== R || t[27] !== z
    ? ((B = (0, V.jsx)(b.Item, { onSelect: T, "aria-label": C, LeftIcon: R, children: z })),
      (t[24] = T),
      (t[25] = C),
      (t[26] = R),
      (t[27] = z),
  ...
  t[29] === r
    ...
    : ((G = r
      ...
      (t[30] = G));
  let K;
  t[31] !== D || t[32] !== H || t[33] !== G
    ? ((K = (0, V.jsx)(b.Item, { onSelect: D, LeftIcon: H, children: G })),
      (t[31] = D),
      (t[32] = H),
      (t[33] = G),
      (t[34] = K))
