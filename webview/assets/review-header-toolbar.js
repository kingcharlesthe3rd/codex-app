...
import { t as u } from "./regenerate.js";
import { f as d } from "./persisted-signal.js";
import { t as f } from "./document-search.js";
import { t as p } from "./file.js";
import { it as m, r as h } from "./review-navigation-model.js";
import { i as g } from "./get-file-icon.js";
import { t as _ } from "./json-2.js";
import { r as v, t as y } from "./dropdown.js";
import { t as b } from "./three-dots.js";
import { n as x, r as S } from "./code-snippet.js";
import { t as C } from "./score-query-match.js";
import { n as w, t as T } from "./diff-unified.js";
import { t as E } from "./middle-truncated-text.js";
var D = e(t()),
  O = n(),
  k = (e) =>
    (0, O.jsxs)(`svg`, {
...
function A(e, t) {
  ...
  return n.length === 0
    ...
    : e
        .map((e) => {
          let t = C(M(e.displayPath).fileName, n);
          return { entry: e, score: t > 0 ? t : C(e.displayPath, n) };
        })
        .filter(({ score: e }) => e > 0)
...
function P() {
  let e = (0, N.c)(5),
    ...
    n = a(m),
    r;
  e[0] === t ? (r = e[1]) : ((r = (e) => h(t, e)), (e[0] = t), (e[1] = r));
  let o;
  return (
    e[2] !== n || e[3] !== r
      ? ((o = (0, O.jsx)(F, { entries: n, onSelectPath: r })), (e[2] = n), (e[3] = r), (e[4] = o))
      : (o = e[4]),
    o
  );
}
function F(e) {
  let t = (0, N.c)(19),
    ...
    [d, p] = (0, D.useState)(!1),
    m;
  if (t[0] !== n || t[1] !== i || t[2] !== r || t[3] !== d || t[4] !== a) {
    let e = A(n, a),
      o;
    t[6] === i
      ? (o = t[7])
    ...
    t[9] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((_ = (0, O.jsx)(f, { className: `icon-xs text-token-description-foreground` })),
        (t[9] = _))
      : (_ = t[9]);
    let b;
    t[10] === h
    ...
    let x;
    t[12] !== h || t[13] !== b
      ? ((x = (0, O.jsx)(l, { tooltipContent: h, delayOpen: !0, children: b })),
        (t[12] = h),
        (t[13] = b),
        (t[14] = x))
      : (x = t[14]);
    ...
    t[15] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((S = (e) => u(e.currentTarget.value)), (t[15] = S))
      : (S = t[15]);
    let C;
    (t[16] !== h || t[17] !== a
      ? ((C = (0, O.jsx)(v.SearchInput, { autoFocus: !0, placeholder: h, value: a, onChange: S })),
        (t[16] = h),
        (t[17] = a),
        (t[18] = C))
      : (C = t[18]),
            ...
            : e.map((e) =>
                (0, O.jsx)(
                  v.Item,
                  {
                    ...
                    children: (0, O.jsx)(I, { displayPath: e.displayPath }),
                  },
                  e.path,
                ),
              ),
...
function I(e) {
  let t = (0, N.c)(9),
    { displayPath: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = M(n)), (t[0] = n), (t[1] = r));
  let { fileName: i, parentPath: a } = r,
    o;
  t[2] === i
    ? (o = t[3])
    : ((o = (0, O.jsx)(`span`, { className: `shrink-0 text-token-foreground`, children: i })),
      (t[2] = i),
      (t[3] = o));
  let s;
  t[4] === a
...
function V(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, O.jsx)(b, { className: `icon-xs text-token-description-foreground` })), (t[11] = R))
    : (R = t[11]);
  let B;
  t[12] === F
    ? (B = t[13])
  ...
  let V;
  t[14] !== F || t[15] !== B
    ? ((V = (0, O.jsx)(l, { tooltipContent: F, delayOpen: !0, children: B })),
      (t[14] = F),
      (t[15] = B),
      (t[16] = V))
    : (V = t[16]);
  ...
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (q = t[35]);
  let J;
  t[36] !== a || t[37] !== s || t[38] !== T || t[39] !== m
    ? ((J = m
        ? (0, O.jsx)(W, { Icon: u, label: T, onClick: () => a?.(), disabled: s || !a })
        : null),
      (t[36] = a),
      (t[37] = s),
      (t[38] = T),
  ...
  let Y = r.wrap ? x : S,
    X;
  t[41] !== r.onToggleWrap || t[42] !== Y || t[43] !== k
    ? ((X = (0, O.jsx)(W, { Icon: Y, label: k, onClick: r.onToggleWrap })),
      (t[41] = r.onToggleWrap),
      (t[42] = Y),
      (t[43] = k),
      (t[44] = X))
    : (X = t[44]);
  let Z = r.expanded ? z : ee,
    Q;
  t[45] !== r.onToggleExpanded || t[46] !== j || t[47] !== Z
    ? ((Q = (0, O.jsx)(W, { Icon: Z, label: j, onClick: r.onToggleExpanded })),
    ...
    : (Q = t[48]);
  let $;
  t[49] === r ? ($ = t[50]) : (($ = (0, O.jsx)(U, { diffControls: r })), (t[49] = r), (t[50] = $));
  let te;
  return (
    t[51] !== K || t[52] !== J || t[53] !== X || t[54] !== Q || t[55] !== $
      ? ((te = (0, O.jsxs)(`div`, {
...
function H(e) {
  ...
  let L = I,
    R;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, O.jsx)(b, { className: `icon-xs` })), (t[11] = R))
    : (R = t[11]);
  let B;
  t[12] === F
    ? (B = t[13])
  ...
  let W = r.wrap ? x : S,
    K;
  t[24] !== U || t[25] !== W || t[26] !== A
    ? ((K = (0, O.jsx)(v.Item, { onSelect: U, LeftIcon: W, children: A })),
      (t[24] = U),
      (t[25] = W),
      (t[26] = A),
      (t[27] = K))
  ...
  t[28] === r
    ...
    : ((q = (e) => {
      ...
      (t[28] = r),
      (t[29] = q));
  let J = r.expanded ? z : ee,
    Y;
  t[30] !== M || t[31] !== q || t[32] !== J
    ? ((Y = (0, O.jsx)(v.Item, { onSelect: q, LeftIcon: J, children: M })),
      (t[30] = M),
      (t[31] = q),
      (t[32] = J),
      (t[33] = Y))
  ...
  let Q;
  return (
    t[49] !== C || t[50] !== V || t[51] !== H || t[52] !== K || t[53] !== Y || t[54] !== Z
      ? ((Q = (0, O.jsxs)(y, {
          open: C,
          onOpenChange: w,
          align: `end`,
...
function U(e) {
  ...
  return (
    t[5] !== a || t[6] !== s || t[7] !== c
      ? ((l = (0, O.jsx)(W, { Icon: s, label: a, onClick: c })),
        (t[5] = a),
        (t[6] = s),
        (t[7] = c),
        (t[8] = l))
...
function W(e) {
  let t = (0, N.c)(12),
    ...
    s = a === void 0 ? !1 : a,
    u = o === void 0 ? !1 : o,
    d = u ? `ghostActive` : `ghost`,
    f;
  t[0] === n ? (f = t[1]) : ((f = (0, O.jsx)(n, { className: `icon-xs` })), (t[0] = n), (t[1] = f));
  let p;
  t[2] !== s || t[3] !== r || t[4] !== i || t[5] !== u || t[6] !== d || t[7] !== f
    ? ((p = (0, O.jsx)(c, {
        "aria-label": r,
        "aria-pressed": u,
        color: d,
  ...
  return (
    t[9] !== r || t[10] !== p
      ? ((m = (0, O.jsx)(l, { tooltipContent: r, children: p })),
        (t[9] = r),
        (t[10] = p),
        (t[11] = m))
      : (m = t[11]),
...
function G(e) {
  ...
  t[22] === d
    ...
    : ((W = d
      ...
      (t[23] = W));
  let G;
  t[24] !== A || t[25] !== E || t[26] !== U || t[27] !== W
    ? ((G = (0, O.jsx)(v.Item, { onSelect: A, "aria-label": E, LeftIcon: U, children: W })),
      (t[24] = A),
      (t[25] = E),
      (t[26] = U),
      (t[27] = W),
  ...
  t[29] === r
    ...
    : ((q = r
      ...
      (t[30] = q));
  let J;
  t[31] !== M || t[32] !== K || t[33] !== q
    ? ((J = (0, O.jsx)(v.Item, { onSelect: M, LeftIcon: K, children: q })),
      (t[31] = M),
      (t[32] = K),
      (t[33] = q),
      (t[34] = J))
  ...
  let Z;
  return (
    t[44] !== G || t[45] !== J || t[46] !== Y || t[47] !== X || t[48] !== H
      ? ((Z = (0, O.jsxs)(O.Fragment, { children: [H, G, J, Y, X] })),
        (t[44] = G),
        (t[45] = J),
        (t[46] = Y),
        (t[47] = X),
...
export { L as a, R as i, H as n, P as o, V as r, k as s, U as t };
