...
import { s as t } from "./lib-1.js";
import { t as n } from "./clock-Cid-cc8u.js";
import { t as r } from "./check-circle-filled.js";
import { n as i, r as a } from "./get-attached-heartbeat-automation-for-thread.js";
import { t as o } from "./x-circle-filled-Do-SvWo6.js";
var s = e();
function c({ checks: e, ciStatus: t }) {
  if (e.length === 0)
    switch (t) {
      case `failing`:
        return (0, s.jsx)(o, { className: `icon-sm shrink-0 text-token-charts-red` });
      case `none`:
        return (0, s.jsx)(n, { className: `icon-sm shrink-0` });
      case `passing`:
        return (0, s.jsx)(r, { className: `icon-sm shrink-0 text-token-charts-green` });
      case `pending`:
        return (0, s.jsx)(i, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    }
  return t === `none`
    ? (0, s.jsx)(n, { className: `icon-sm shrink-0` })
    : (0, s.jsx)(a, { checks: e });
}
function l(e) {
  switch (e) {
...
//# sourceMappingURL=pull-request-checks-summary.js.map
