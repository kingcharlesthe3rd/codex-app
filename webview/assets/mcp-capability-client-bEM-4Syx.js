...
import { Aa as r, Ta as i, ja as a, pa as o, xa as s } from "./src.js";
import { m as c, u as l } from "./mcp-capability-signals.js";
var u = i({
    items: o(
      a([
        i({ id: r().min(1), title: r().min(1), type: s(`group`) }),
        i({ resourceUri: r().min(1), title: r().min(1), type: s(`resource`) }),
      ]),
    ),
  }),
  d = e(t, (e) => ({
...
//# sourceMappingURL=mcp-capability-client-bEM-4Syx.js.map
