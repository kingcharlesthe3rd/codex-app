...
import { i as S, n as C, r as w, t as T } from "./src-3.js";
import { t as E } from "./dist-2.js";
import { i as D, n as O, o as k, r as A } from "./chunk-64.js";
import {
  A as j,
  C as M,
  G as ee,
...
import { g as ce, u as le } from "./chunk-49.js";
var ue = n((e, t) => {
    (function (n, r) {
        ...
        E = {
          ...
          parse: O(function (e) {
            ...
            for (var g in this.yy)
              Object.prototype.hasOwnProperty.call(this.yy, g) && (h.yy[g] = this.yy[g]);
            (m.setInput(e, h.yy),
              (h.yy.lexer = m),
              (h.yy.parser = this),
            ...
            for (var x, S, C, w, T, E = {}, D, k, A, j; ; ) {
              if (
                ...
                var M = ``;
                for (D in ((j = []), o[C]))
                  this.terminals_[D] && D > d && j.push(`'` + this.terminals_[D] + `'`);
                ((M = m.showPosition
                  ? `Parse error on line ` +
                    (c + 1) +
                    `:
...
Expecting ` +
                  ...
                  : `Parse error on line ` +
                    (c + 1) +
                    `: Unexpected ` +
                    (x == f ? `end of input` : `'` + (this.terminals_[x] || x) + `'`)),
                  this.parseError(M, {
                    text: m.match,
              ...
              if (w[0] instanceof Array && w.length > 1)
                throw Error(
                  `Parse Error: multiple actions possible at state: ` + C + `, token: ` + x,
                );
              switch (w[0]) {
                case 1:
                  (n.push(x),
                ...
                case 2:
                  if (
                    ...
                    v && (E._$.range = [a[a.length - (k || 1)].range[0], a[a.length - 1].range[1]]),
                    (T = this.performAction.apply(E, [s, l, c, h.yy, w[1], i, a].concat(p))),
                    T !== void 0)
                  )
                    return T;
                  (k &&
...
` +
    ...
    ($e = O(function (e, t, n, r) {
      ...
      return r.includes(i) || r.includes(a)
        ? !1
        : (n.includes(`weekends`) && (e.isoWeekday() === Se[J] || e.isoWeekday() === Se[J] + 1)) ||
    ...
    (rt = O(function (e, t, n, r) {
      ...
      ((i =
        ...
        (i = i.add(1, `d`)));
      let a;
      a = e.endTime instanceof Date ? (0, P.default)(e.endTime) : (0, P.default)(e.endTime, t, !0);
    ...
    (at = O(function (e, t, n) {
      ...
      if (i.isValid()) return i.toDate();
      {
        ...
        let e = new Date(n);
        if (e === void 0 || isNaN(e.getTime()) || e.getFullYear() < -1e4 || e.getFullYear() > 1e4)
      ...
      let e = O(function (e) {
          ...
          switch (X[e].raw.startTime.type) {
            case `prevTaskEnd`:
              ...
              break;
            case `getStartDate`:
              ((n = at(void 0, I, X[e].raw.startTime.startData)), n && (X[e].startTime = n));
              break;
          }
          return (
            X[e].startTime &&
    ...
    (Ct = { monday: l, tuesday: y, wednesday: m, thursday: d, friday: s, saturday: o, sunday: r }),
    (wt = O((e, t) => {
      let n = [...e].map(() => -1 / 0),
      ...
      renderer: {
        ...
        draw: O(function (e, t, n, r) {
          ...
          let s = N().securityLevel,
            l;
          s === `sandbox` && (l = C(`#i` + t));
          let d = C(s === `sandbox` ? l.nodes()[0].contentDocument.body : `body`),
            m = s === `sandbox` ? l.nodes()[0].contentDocument : document,
          ...
          if (r.db.getDisplayMode() === `compact` || o.displayMode === `compact`) {
            let e = {};
            for (let t of T) e[t.section] === void 0 ? (e[t.section] = [t]) : e[t.section].push(t);
            let t = 0;
          ...
          function te(e, t, n) {
            let a = o.barHeight,
              ...
              c = o.topPadding,
              l = o.leftPadding,
              u = p().domain([0, E.length]).range([`#00B9FA`, `#F95002`]).interpolate(i);
            (re(s, c, l, t, n, e, r.db.getExcludes(), r.db.getIncludes()),
              se(l, c, t, n),
              ne(e, s, c, l, a, u, t, n),
              ce(s, c, l, a, u),
              le(l, c, t, n));
          ...
          function ne(e, n, i, a, s, c, l) {
            ...
            j.append(`g`)
              ...
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e.type === n) return `section section` + (t % o.numberSectionStyles);
            ...
            if (
              (d
                ...
                .attr(`x`, function (e) {
                  return e.milestone
                    ? M(e.startTime) + a + 0.5 * (M(e.endTime) - M(e.startTime)) - 0.5 * s
                    : M(e.startTime) + a;
                })
                .attr(`y`, function (e, t) {
                ...
                .attr(`height`, function (e) {
                  return e.vert ? T.length * (o.barHeight + o.barGap) + o.barHeight * 2 : s;
                })
                .attr(`transform-origin`, function (e, t) {
                  return (
                    (t = e.order),
                    (M(e.startTime) + a + 0.5 * (M(e.endTime) - M(e.startTime))).toString() +
                      `px ` +
                      (t * n + i + 0.5 * s).toString() +
                      `px`
                  );
                })
                .attr(`class`, function (e) {
                  ...
                  let n = 0;
                  for (let [t, r] of E.entries()) e.type === r && (n = t % o.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              d
                ...
                .attr(`x`, function (e) {
                  ...
                  if (
                    (e.milestone &&
                      ((t += 0.5 * (M(e.endTime) - M(e.startTime)) - 0.5 * s), (n = t + s)),
                    e.vert)
                  )
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? o.gridLineStartPadding + T.length * (o.barHeight + o.barGap) + 60
                    : ((t = e.order), t * n + o.barHeight / 2 + (o.fontSize / 2 - 2) + i);
                })
                .attr(`text-height`, s)
                .attr(`class`, function (e) {
                  let t = M(e.startTime),
                  ...
                  let a = 0;
                  for (let [t, n] of E.entries()) e.type === n && (a = t % o.numberSectionStyles);
                  let c = ``;
                  return (
                    e.active && (c = e.crit ? `activeCritText` + a : `activeText` + a),
                    e.done
                      ? (c = e.crit ? c + ` doneCritText` + a : c + ` doneText` + a)
                      : e.crit && (c = c + ` critText` + a),
                    e.milestone && (c += ` milestoneText`),
                    e.vert && (c += ` vertText`),
                    r > n - t
                      ? n + r + 1.5 * o.leftPadding > l
                        ? i + ` taskTextOutsideLeft taskTextOutside` + a + ` ` + c
                        : i + ` taskTextOutsideRight taskTextOutside` + a + ` ` + c + ` width-` + r
          ...
          function re(e, n, i, a, s, c, l, u) {
            ...
            j.append(`g`)
              ...
              .attr(`width`, (e) => M(e.end.endOf(`day`)) - M(e.start.startOf(`day`)))
          ...
          function se(e, t, n, i) {
            let a = r.db.getDateFormat(),
              s = r.db.getAxisFormat(),
              l;
            l = s || (a === `D` ? `%d` : (o.axisFormat ?? `%Y-%m-%d`));
            let d = w(M)
                .tickSize(-i + t + o.gridLineStartPadding)
                .tickFormat(g(l)),
              p = /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(
                r.db.getTickInterval() || o.tickInterval,
              );
            if (p !== null) {
              let e = parseInt(p[1], 10);
              if (isNaN(e) || e <= 0)
                D.warn(`Invalid tick interval value: "${p[1]}". Skipping custom tick interval.`);
              else {
                let t = p[2],
                  n = r.db.getWeekday() || o.weekday,
                  i = M.domain(),
                  a = i[0],
                  s = i[1],
                  l = ie(a, s, e, t);
            ...
            j.append(`g`)
              ...
              .append(function (e) {
                ...
                for (let [e, n] of t.entries()) {
                  let t = m.createElementNS(`http://www.w3.org/2000/svg`, `tspan`);
              ...
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e[0] === n) return `sectionTitle sectionTitle` + (t % o.numberSectionStyles);
                return `sectionTitle`;
              });
          }
          O(ce, `vertLabels`);
