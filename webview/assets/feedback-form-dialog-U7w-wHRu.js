...
import { a as l, i as u, l as d, n as f, o as p, r as m } from "./dialog-layout.js";
var h = e(t(), 1),
  g = n();
function _({
  ...
  return (0, g.jsx)(d, {
    ...
    children: (0, g.jsxs)(f, {
      ...
      className: `gap-2`,
      onSubmit: async (e) => {
        if ((e.preventDefault(), O == null || E || N)) return;
        if (t === `immediate`) {
          x({ selectedOptionId: O, details: A }) !== !1 && y();
          return;
        }
        D(!0);
        let n = !1;
        try {
          n = (await x({ selectedOptionId: O, details: A })) !== !1;
        } finally {
          D(!1);
        }
        n && y();
                ...
                children: S.map((e) => {
                  ...
                  return (0, g.jsxs)(
                    `button`,
                    {
                      ...
                      "aria-checked": t,
                      onClick: () => {
                        (k(e.id), b?.({ details: A, selectedOptionId: e.id }));
                      },
                      className: a(
...
export { _ as t };
//# sourceMappingURL=feedback-form-dialog-U7w-wHRu.js.map
