...
import { u as i, v as a } from "./vscode-api.js";
...
import { n as f } from "./rpc-2.js";
import { o as p } from "./statsig.js";
import { m } from "./use-plugins.js";
import { d as h } from "./apps-queries.js";
import { y as g } from "./mention-item.js";
import { n as _ } from "./use-composer-controller.js";
import { r as v, t as y } from "./use-native-apps.electron.js";
import { n as b } from "./get-file-icon.js";
import { n as x } from "./use-skills.js";
import { t as S } from "./image-preview-dialog.js";
import { t as C } from "./attachment-remove-button.js";
import { i as w, t as ee } from "./thread-resource-card.js";
function T(e) {
  return (e ?? 140) + 8;
}
var E = r(),
...
function k(e) {
  ...
  if (
    ...
    let e = ne({ appName: r, windowTitle: g }),
      a = d ?? ``,
      o;
    t[31] !== i || t[32] !== f || t[33] !== a
      ? ((o = { alt: a, accessibilityText: i, src: f }),
        (t[31] = i),
        (t[32] = f),
        (t[33] = a),
        (t[34] = o))
    ...
    let s = o,
      c;
    t[35] !== s || t[36] !== u
      ? ((c = u ?? [s]), (t[35] = s), (t[36] = u), (t[37] = c))
      : (c = t[37]);
    let h = c;
    I = h[P] ?? s;
    let S;
    (t[38] === I.accessibilityText
      ? (S = t[39])
      : ((S = I.accessibilityText?.trim() ?? ``), (t[38] = I.accessibilityText), (t[39] = S)),
      (F = S),
      (R = F.length > 0),
      (z = k && R),
      (V = P > 0 ? P - 1 : null),
    ...
    let w = m != null && m.length > 0,
      ...
      D;
    t[40] !== p || t[41] !== b
      ? ((D = b === `composer` ? T(p) : void 0), (t[40] = p), (t[41] = b), (t[42] = D))
      : (D = t[42]);
    let A = D,
      j;
    (t[43] === y
    ...
    t[51] !== b
      ? ((X =
          b === `thread`
            ? (0, O.jsx)(te, { appIconSrc: n, screenshotAlt: d, screenshotSrc: f })
            : (0, O.jsx)(M, {
                hasTransitionSnapshot: w,
                renderedSnapshotHeight: E,
                transitionSnapshotSrc: m,
              })),
        (t[45] = n),
        (t[46] = w),
    ...
    let ie = X,
      ...
      Q = v ? `cursor-interaction` : `cursor-default`;
    (t[53] !== Z || t[54] !== Q
      ? ((W = l(`composer-attachment-surface`, Z, Q)), (t[53] = Z), (t[54] = Q), (t[55] = W))
      : (W = t[55]),
      t[56] === A
        ? (G = t[57])
        : ((G = A == null ? void 0 : { height: A }), (t[56] = A), (t[57] = G)),
      (K = v ? `button` : void 0),
      (q = v ? e : void 0),
      (J = v ? 0 : void 0),
      t[58] !== L || t[59] !== v
        ? ((Y = v
            ? (e) => {
                (e.key === `Enter` || e.key === ` `) && (e.preventDefault(), L(!0));
              }
            : void 0),
          (t[58] = L),
          (t[59] = v),
  ...
  let Z;
  t[70] !== F || t[71] !== z
    ? ((Z = z ? (0, O.jsx)(j, { accessibilityText: F }) : void 0),
      (t[70] = F),
      (t[71] = z),
      (t[72] = Z))
    : (Z = t[72]);
...
function ne({ appName: e, windowTitle: t }) {
  let n = t?.trim();
...
function N(e) {
  ...
  let g = h,
    ...
    v = o && `cursor-interaction`,
    y = !o && `cursor-default`,
    b;
  t[13] !== i || t[14] !== _ || t[15] !== v || t[16] !== y
    ? ((b = l(
  ...
  let x = m
    ...
    S;
  t[18] === x ? (S = t[19]) : ((S = l(`flex-shrink-0`, x)), (t[18] = x), (t[19] = S));
  let C;
  t[20] !== n || t[21] !== a || t[22] !== m
    ? ((C = a ?? (n == null ? null : (0, O.jsx)(n, { className: l(m ? `size-6` : `icon-2xs`) }))),
      (t[20] = n),
      (t[21] = a),
      (t[22] = m),
      (t[23] = C))
  ...
  let w;
  t[24] !== S || t[25] !== C
    ? ((w = (0, O.jsx)(`div`, { className: S, children: C })),
      (t[24] = S),
      (t[25] = C),
      (t[26] = w))
    : (w = t[26]);
  let ee = m
    ...
    T;
  t[27] === ee ? (T = t[28]) : ((T = l(`relative min-w-0 flex-1`, ee)), (t[27] = ee), (t[28] = T));
  let D;
  t[29] !== r || t[30] !== T
    ? ((D = (0, O.jsx)(`div`, { className: T, children: r })),
      (t[29] = r),
      (t[30] = T),
      (t[31] = D))
    : (D = t[31]);
  let k;
  t[32] !== g || t[33] !== m || t[34] !== s || t[35] !== c
    ? ((k =
        s &&
        (0, O.jsx)(`div`, {
          role: `button`,
          ...
          "aria-label": c,
          children: (0, O.jsx)(d, {
            className: l(m ? `icon-xxs` : `icon-2xs text-token-foreground`),
          }),
        })),
      (t[32] = g),
      (t[33] = m),
...
function re(e) {
  let t = (0, E.c)(62),
    ...
    _ = s(),
    v;
  t[0] !== f || t[1] !== h ? ((v = f ?? b(h)), (t[0] = f), (t[1] = h), (t[2] = v)) : (v = t[2]);
  let y = v,
    x;
  t[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((x = /[\\/]$/), (t[3] = x)) : (x = t[3]);
  let S;
  t[4] === h ? (S = t[5]) : ((S = x.test(h)), (t[4] = h), (t[5] = S));
  let T = S,
    D,
    k;
  if (
      ...
      if (
        ...
        t[28] === y
          ...
          : ((s = (0, O.jsx)(`span`, {
              ...
              children: (0, O.jsx)(y, { className: `size-6` }),
            })),
            (t[28] = y),
            (t[29] = s));
        let l = o != null,
        ...
        t[30] === n
          ? (f = t[31])
          : ((f = (0, O.jsx)(`span`, { className: `block max-w-32 truncate`, children: n })),
            (t[30] = n),
            (t[31] = f));
        let p =
            m ??
        ...
        t[37] !== o || t[38] !== D
          ? ((g = o
              ? (0, O.jsx)(C, { className: `top-1 right-1 z-20`, ariaLabel: D, onRemove: o })
              : null),
            (t[37] = o),
            (t[38] = D),
            (t[39] = g))
        ...
        let x;
        (t[44] !== b || t[45] !== a || t[46] !== i
          ? ((x = (0, O.jsx)(F, { folderPath: i, hostId: a, children: b })),
            (t[44] = b),
            (t[45] = a),
            (t[46] = i),
            (t[47] = x))
  ...
  t[48] === n
    ? (A = t[49])
    : ((A = (0, O.jsx)(`span`, { className: `truncate`, children: n })), (t[48] = n), (t[49] = A));
  let j;
  t[50] === d
    ? (j = t[51])
    : ((j = d
  ...
  let te;
  return (
    t[55] !== y || t[56] !== g || t[57] !== u || t[58] !== o || t[59] !== D || t[60] !== M
      ? ((te = (0, O.jsx)(N, {
          Icon: y,
          onClick: u,
          onRemove: o,
...
function F(e) {
  let t = (0, E.c)(14),
    ...
    c;
  t[0] !== r || t[1] !== i || t[2] !== o
    ? ((c = P(r, i, o)), (t[0] = r), (t[1] = i), (t[2] = o), (t[3] = c))
    : (c = t[3]);
  let { data: l } = a(c),
    d,
    f,
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = () => s(!1)),
      ...
      (t[6] = p),
      (t[7] = m))
    : ((d = t[4]), (f = t[5]), (p = t[6]), (m = t[7]));
  let h;
  t[8] === l
    ? (h = t[9])
    : ((h = l == null ? null : (0, O.jsx)(I, { count: l })), (t[8] = l), (t[9] = h));
  let g;
  return (
    t[10] !== n || t[11] !== o || t[12] !== h
      ? ((g = (0, O.jsx)(`span`, {
          className: `contents`,
          onBlur: d,
          onFocus: f,
          onPointerEnter: p,
          onPointerLeave: m,
          children: (0, O.jsx)(u, { defaultOpen: o, tooltipContent: h, children: n }),
        })),
        (t[10] = n),
        (t[11] = o),
        (t[12] = h),
...
function H(e) {
  ...
  t[0] !== a || t[1] !== d
    ? ((f =
        d && a ? { additionalMarketplaceKinds: [`shared-with-me`] } : { includeRemoteCatalog: a }),
      (t[0] = a),
      (t[1] = d),
      (t[2] = f))
    : (f = t[2]);
  let { availablePlugins: h } = m(i, o, f),
    _;
  t[3] === h ? (_ = t[4]) : ((_ = v(h)), (t[3] = h), (t[4] = _));
  let b = _ != null,
    x;
  t[5] === b ? (x = t[6]) : ((x = { enabled: b }), (t[5] = b), (t[6] = x));
  let { nativeApps: S } = y(x),
    C,
    w;
  return (
    t[7] !== n ||
...
export { k as a, N as i, z as n, T as o, re as r, B as t };
//# sourceMappingURL=mention-metadata-syncer-Cux3-DQM.js.map
