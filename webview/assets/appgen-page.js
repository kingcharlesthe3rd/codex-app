...
import { n as ye, t as be } from "./appgen-share-dialog.js";
function xe() {
  let e = (0, Q.c)(67),
    t = i(r),
    n = ie(),
  ...
  e[19] === d
    ? (I = e[20])
    : ((I = d ? null : (0, $.jsx)(oe, { className: `icon-xs` })), (e[19] = d), (e[20] = I));
  let L;
  ...
  e[31] === A
    ? (B = e[32])
    : ((B = (0, $.jsx)(w, { color: `outline`, size: `toolbar`, onClick: A, children: z })),
      (e[31] = A),
      (e[32] = B));
  let V;
  e[33] !== B || e[34] !== R
  ...
  e[39] === U
    ? (W = e[40])
    : ((W = (0, $.jsx)(T, { extension: !0, children: U })), (e[39] = U), (e[40] = W));
  let G;
  e[41] === U
    ? (G = e[42])
    : ((G = (0, $.jsx)(T, {
      ...
      : ((o = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsxs)(`div`, {
            ...
            children: [
              r,
              i,
              (0, $.jsx)(w, { color: `outline`, size: `medium`, onClick: n, children: a }),
            ],
          }),
        })),
        (t[3] = n),
...
function De(e) {
  ...
  t[8] === r.updated_at
    ? (d = t[9])
    : ((d = (0, $.jsx)(f, { dateString: r.updated_at })), (t[8] = r.updated_at), (t[9] = d));
  let p;
        ...
        a == null
          ...
          : (0, $.jsxs)(`span`, {
              ...
              children: [
                ...
                (0, $.jsx)(te, { className: `icon-2xs`, ExternalIcon: ee, href: a }),
              ],
            })),
      (t[19] = a),
      (t[20] = v));
  ...
  let b;
  t[24] !== y || t[25] !== l
    ? ((b = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-px`, children: [l, y] })),
      (t[24] = y),
      (t[25] = l),
      (t[26] = b))
    : (b = t[26]);
...
function ke(e) {
  let t = (0, Q.c)(16),
    ...
    l;
  t[0] !== a || t[1] !== c
    ? ((l = () => _(c, be, { projectId: a })), (t[0] = a), (t[1] = c), (t[2] = l))
    : (l = t[2]);
  let u;
  t[3] === n
    ? (u = t[4])
    : ((u = (0, $.jsx)(P, { className: `icon-xs shrink-0`, accessPolicy: n, "aria-hidden": !0 })),
      (t[3] = n),
      (t[4] = u));
  let d = j,
    f = R(s),
