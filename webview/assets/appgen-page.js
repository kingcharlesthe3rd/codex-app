...
import { vn as A, yn as j } from "./app-initial~app-main~automations-page.js";
import {
  $ as M,
  at as N,
  et as ae,
...
import { n as ye, t as be } from "./appgen-share-dialog--o3-U-xq.js";
function xe() {
  let e = (0, Q.c)(67),
    t = o(r),
    n = ie(),
  ...
  e[19] === d
    ? (I = e[20])
    : ((I = d ? null : (0, $.jsx)(_, { className: `icon-xs` })), (e[19] = d), (e[20] = I));
  let L;
  e[21] !== oe || e[22] !== d || e[23] !== S || e[24] !== O || e[25] !== I
    ? ((L = (0, $.jsx)(se, {
        "aria-label": O,
        color: `ghost`,
        disabled: S,
  ...
  let R;
  e[27] !== O || e[28] !== L
    ? ((R = (0, $.jsx)(te, { tooltipContent: O, children: L })),
      (e[27] = O),
      (e[28] = L),
      (e[29] = R))
    : (R = e[29]);
  ...
  e[31] === M
    ? (B = e[32])
    : ((B = (0, $.jsx)(se, { color: `outline`, size: `toolbar`, onClick: M, children: z })),
      (e[31] = M),
      (e[32] = B));
  let V;
  e[33] !== B || e[34] !== R
  ...
  let H;
  e[36] !== V || e[37] !== F
    ? ((H = (0, $.jsx)(le, { start: F, trailing: V })), (e[36] = V), (e[37] = F), (e[38] = H))
    : (H = e[38]);
  let U = H,
    W;
  e[39] === U
...
function Ce(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(A, { className: `icon-lg text-token-foreground` })), (t[0] = r))
    : (r = t[0]);
  let i;
      ...
      : ((o = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsxs)(`div`, {
            ...
            children: [
              r,
              i,
              (0, $.jsx)(se, { color: `outline`, size: `medium`, onClick: n, children: a }),
            ],
          }),
        })),
        (t[3] = n),
...
function De(e) {
  ...
  t[8] === r.updated_at
    ? (u = t[9])
    : ((u = (0, $.jsx)(ee, { dateString: r.updated_at })), (t[8] = r.updated_at), (t[9] = u));
  let d;
  ...
  let f;
  t[11] !== a || t[12] !== r.slug
    ? ((f = p(a) ?? r.slug), (t[11] = a), (t[12] = r.slug), (t[13] = f))
    : (f = t[13]);
  let m;
  t[14] === f
    ? (m = t[15])
    : ((m = (0, $.jsx)(`span`, { className: `truncate`, children: f })), (t[14] = f), (t[15] = m));
  let h;
  t[16] !== u || t[17] !== m
    ? ((h = (0, $.jsxs)(`span`, {
        ...
        a == null
          ...
          : (0, $.jsxs)(`span`, {
              ...
              children: [
                ...
                (0, $.jsx)(N, { className: `icon-2xs`, ExternalIcon: M, href: a }),
              ],
            })),
      (t[19] = a),
      (t[20] = g));
  ...
  let v;
  t[24] !== _ || t[25] !== l
    ? ((v = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-px`, children: [l, _] })),
      (t[24] = _),
      (t[25] = l),
      (t[26] = v))
    : (v = t[26]);
...
function ke(e) {
  let t = (0, Q.c)(16),
    { accessPolicy: n, projectId: i, projectTitle: a } = e,
    s = C(n),
    c = o(r),
    l;
  t[0] !== i || t[1] !== c
    ? ((l = () => P(c, be, { projectId: i })), (t[0] = i), (t[1] = c), (t[2] = l))
    : (l = t[2]);
  let u;
  t[3] === n
    ? (u = t[4])
    : ((u = (0, $.jsx)(g, { className: `icon-xs shrink-0`, accessPolicy: n, "aria-hidden": !0 })),
      (t[3] = n),
      (t[4] = u));
  let d = E,
    f = x(s),
