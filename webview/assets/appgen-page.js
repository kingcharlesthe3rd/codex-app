...
import { t as h } from "./plugin-config-edits.js";
...
import "./link.js";
import { t as T } from "./more-menu-trigger.js";
import { t as E } from "./arrow-top-right.js";
import { t as D } from "./share.js";
import { m as O, s as k } from "./appgen-url.js";
import "./lock.js";
import "./members.js";
import { t as A } from "./appgen-access-mode.js";
import { n as j, t as M } from "./appgen-share-dialog-BJ-LPm6o.js";
...
function F(e) {
  ...
  t[0] === e
    ? ((r = t[1]), (a = t[2]), (o = t[3]))
    : (({ nowMs: a, value: o, ...r } = e), (t[0] = e), (t[1] = r), (t[2] = a), (t[3] = o));
  let s = S(),
    c;
  t[4] === o ? (c = t[5]) : ((c = o instanceof Date ? o : new Date(o)), (t[4] = o), (t[5] = c));
  let l = c,
  ...
  return (
    t[8] !== l || t[9] !== r
      ? ((d = (0, P.jsx)(n, { ...r, value: l })), (t[8] = l), (t[9] = r), (t[10] = d))
      : (d = t[10]),
    d
  );
}
...
function L() {
  ...
  let c = s,
    l;
  e[3] === c ? (l = e[4]) : ((l = (0, P.jsx)(R, { onCreate: c })), (e[3] = c), (e[4] = l));
  let u = l,
    f;
  e[5] === u ? (f = e[6]) : ((f = (0, P.jsx)(m.Header, { children: u })), (e[5] = u), (e[6] = f));
  let p;
  ...
  return (
    t[2] === n
      ...
      : ((o = (0, P.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, P.jsx)(f, { color: `outline`, size: `toolbar`, onClick: n, children: a }),
          ],
        })),
        (t[2] = n),
        (t[3] = o)),
...
function B(e) {
  let t = (0, N.c)(5),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, P.jsx)(_, { className: `icon-lg text-token-foreground` })), (t[0] = r))
    : (r = t[0]);
  let a;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, P.jsx)(`div`, {
      ...
      : ((s = (0, P.jsx)(`div`, {
          ...
          children: (0, P.jsxs)(`div`, {
            ...
            children: [
              r,
              a,
              (0, P.jsx)(f, { color: `outline`, size: `medium`, onClick: n, children: o }),
            ],
          }),
        })),
        (t[3] = n),
...
function W(e) {
  ...
  let p;
  n[13] !== d || n[14] !== f
    ? ((p = (0, P.jsxs)(`div`, { className: `flex min-w-0 flex-col pr-8`, children: [d, f] })),
      (n[13] = d),
      (n[14] = f),
      (n[15] = p))
    : (p = n[15]);
  ...
  n[21] === r.updated_at
    ...
    : ((v = (0, P.jsx)(`span`, {
        ...
        children: (0, P.jsx)(F, { value: r.updated_at, month: `short`, day: `numeric` }),
      })),
      (n[21] = r.updated_at),
      (n[22] = v));
  let y;
...
function G(e) {
  ...
  let s = o,
    c = j[s],
    l;
  n[2] === c ? (l = n[3]) : ((l = (0, P.jsx)(i, { ...c })), (n[2] = c), (n[3] = l));
  let d;
  n[4] !== s || n[5] !== a
  ...
  n[7] === r
    ? (f = n[8])
    : ((f = (0, P.jsx)(A, { className: `icon-xs shrink-0`, accessPolicy: r, "aria-hidden": !0 })),
      (n[7] = r),
      (n[8] = f));
  let p;
  n[9] !== d || n[10] !== f
...
function K(e) {
  ...
  n[0] === l
    ...
    : ((d = l.formatMessage({
      ...
      (n[1] = d));
  let f;
  n[2] === d ? (f = n[3]) : ((f = (0, P.jsx)(T, { label: d })), (n[2] = d), (n[3] = f));
  let p;
  n[4] !== s || n[5] !== u
    ? ((p = () => {
        v(u, M, { projectId: s });
  ...
  n[8] === p
    ? (h = n[9])
    : ((h = (0, P.jsx)(b.Item, { LeftIcon: D, onSelect: p, children: m })), (n[8] = p), (n[9] = h));
  let g;
  n[10] === o
    ? (g = n[11])
    : ((g =
