...
import { Ht as se, Ut as H } from "./app-initial~app-main~automations-page.js";
import {
  r as ce,
  t as U,
...
import { n as le, r as K } from "./searchable-page-layout.js";
import {
  T as ue,
  a as q,
  c as J,
...
import { n as ye, t as be } from "./appgen-share-dialog-Ca-VUEmz.js";
function xe() {
  let e = (0, Q.c)(67),
    t = _(c),
    n = ee(),
    ...
    { setSelectedMode: g } = re(),
    v = ce(),
    [y, b] = (0, Ae.useState)(``),
    { scrollContainerRef: x, showTitleInToolbar: C, titleRef: w } = ue(),
    T = d || f || u,
    E,
    D;
  e[0] !== i || e[1] !== y
    ? ((E = y.trim().toLowerCase()),
      (D = i?.filter((e) => me(e, E)) ?? null),
      (e[0] = i),
      (e[1] = y),
      (e[2] = E),
      (e[3] = D))
  ...
  e[8] !== t || e[9] !== g || e[10] !== v
    ? ((M = () => {
        pe(t, v, { type: `create`, setSelectedMode: g });
      }),
      (e[8] = t),
      (e[9] = g),
      (e[10] = v),
  ...
  e[12] !== t || e[13] !== v
    ? ((P = (e, n, r) => {
        pe(t, v, { type: `edit`, liveUrl: r, projectId: e, projectTitle: n });
      }),
      (e[12] = t),
      (e[13] = v),
      (e[14] = P))
  ...
  e[19] === f
    ? (L = e[20])
    : ((L = f ? null : (0, $.jsx)(ae, { className: `icon-xs` })), (e[19] = f), (e[20] = L));
  let R;
  e[21] !== ie || e[22] !== f || e[23] !== T || e[24] !== A || e[25] !== L
    ? ((R = (0, $.jsx)(S, {
        "aria-label": A,
        color: `ghost`,
        disabled: T,
  ...
  let z;
  e[27] !== A || e[28] !== R
    ? ((z = (0, $.jsx)(h, { tooltipContent: A, children: R })),
      (e[27] = A),
      (e[28] = R),
      (e[29] = z))
    : (z = e[29]);
  ...
  e[31] === N
    ? (V = e[32])
    : ((V = (0, $.jsx)(S, { color: `outline`, size: `toolbar`, onClick: N, children: B })),
      (e[31] = N),
      (e[32] = V));
  let H;
  e[33] !== V || e[34] !== z
    ? ((H = (0, $.jsxs)(`div`, { className: `flex items-center gap-2`, children: [z, V] })),
      (e[33] = V),
      (e[34] = z),
      (e[35] = H))
    : (H = e[35]);
  let U;
  e[36] !== H || e[37] !== I
    ? ((U = (0, $.jsx)(se, { start: I, trailing: H })), (e[36] = H), (e[37] = I), (e[38] = U))
    : (U = e[38]);
  let W = U,
    G;
  e[39] === W
    ? (G = e[40])
    : ((G = (0, $.jsx)(m, { extension: !0, children: W })), (e[39] = W), (e[40] = G));
  let K;
  e[41] === W
    ? (K = e[42])
    : ((K = (0, $.jsx)(m, {
        ...
        chromeExtension: !0,
        electron: !0,
        children: (0, $.jsx)(oe.Header, { children: W }),
      })),
      (e[41] = W),
      (e[42] = K));
  let q, J;
...
function Ce(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(G, { className: `icon-lg text-token-foreground` })), (t[0] = r))
    : (r = t[0]);
  let i;
      ...
      : ((s = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsxs)(`div`, {
            ...
            children: [
              r,
              i,
              (0, $.jsx)(S, { color: `outline`, size: `medium`, onClick: n, children: o }),
            ],
          }),
        })),
        (t[3] = n),
...
function Ee(e) {
  let t = (0, Q.c)(16),
    { hasNextPage: n, isFetchingNextPage: r, onEdit: i, onLoadNextPage: o, projects: s } = e,
    c;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(`span`, {
        children: (0, $.jsx)(a, {
  ...
  let f;
  t[9] !== n || t[10] !== r || t[11] !== o
    ? ((f = (0, $.jsx)(ve, { hasNextPage: n, isFetchingNextPage: r, onLoadNextPage: o })),
      (t[9] = n),
      (t[10] = r),
      (t[11] = o),
      (t[12] = f))
  ...
  return (
    t[13] !== d || t[14] !== f
      ? ((p = (0, $.jsxs)(`div`, { className: `@container pb-3`, children: [d, f] })),
        (t[13] = d),
        (t[14] = f),
        (t[15] = p))
      : (p = t[15]),
...
function De(e) {
  ...
  t[8] === r.updated_at
    ? (d = t[9])
    : ((d = (0, $.jsx)(ie, { dateString: r.updated_at })), (t[8] = r.updated_at), (t[9] = d));
  let p;
  ...
  let m;
  t[11] !== o || t[12] !== r.slug
    ? ((m = R(o) ?? r.slug), (t[11] = o), (t[12] = r.slug), (t[13] = m))
    : (m = t[13]);
  let h;
  t[14] === m
    ? (h = t[15])
    : ((h = (0, $.jsx)(`span`, { className: `truncate`, children: m })), (t[14] = m), (t[15] = h));
  let g;
  t[16] !== d || t[17] !== h
    ? ((g = (0, $.jsxs)(`span`, {
        ...
        o == null
          ...
          : (0, $.jsxs)(`span`, {
              ...
              children: [
                ...
                (0, $.jsx)(D, { className: `icon-2xs`, ExternalIcon: v, href: o }),
              ],
            })),
      (t[19] = o),
      (t[20] = _));
  ...
  let b;
  t[24] !== y || t[25] !== u
    ? ((b = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-px`, children: [u, y] })),
      (t[24] = y),
      (t[25] = u),
      (t[26] = b))
    : (b = t[26]);
  ...
  t[30] !== r.access_policy || t[31] !== r.id || t[32] !== r.title
    ...
    : (S = t[33]);
  let C;
  t[34] !== o || t[35] !== n || t[36] !== r.id || t[37] !== r.title
    ? ((C = () => n(r.id, r.title, o)),
      (t[34] = o),
      (t[35] = n),
      (t[36] = r.id),
...
function ke(e) {
  let t = (0, Q.c)(16),
    ...
    l;
  t[0] !== r || t[1] !== s
    ? ((l = () => p(s, be, { projectId: r })), (t[0] = r), (t[1] = s), (t[2] = l))
    : (l = t[2]);
  let u;
  t[3] === n
    ? (u = t[4])
    : ((u = (0, $.jsx)(M, { className: `icon-xs shrink-0`, accessPolicy: n, "aria-hidden": !0 })),
      (t[3] = n),
      (t[4] = u));
  let d = a,
    f = A(o),
