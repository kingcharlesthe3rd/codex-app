...
import { $t as A, Qt as j, bt as ae, xt as M } from "./app-initial~app-main~automations-page.js";
import {
  M as N,
  N as oe,
  R as P,
...
function xe() {
  ...
  e[19] === p
    ? (I = e[20])
    : ((I = p ? null : (0, $.jsx)(c, { className: `icon-xs` })), (e[19] = p), (e[20] = I));
  let L;
  ...
  e[31] === M
    ? (B = e[32])
    : ((B = (0, $.jsx)(te, { color: `outline`, size: `toolbar`, onClick: M, children: z })),
      (e[31] = M),
      (e[32] = B));
  let V;
  e[33] !== B || e[34] !== R
  ...
  let H;
  e[36] !== V || e[37] !== F
    ? ((H = (0, $.jsx)(ae, { start: F, trailing: V })), (e[36] = V), (e[37] = F), (e[38] = H))
    : (H = e[38]);
  let U = H,
    W;
  e[39] === U
    ? (W = e[40])
    : ((W = (0, $.jsx)(ce, { extension: !0, children: U })), (e[39] = U), (e[40] = W));
  let G;
  e[41] === U
    ? (G = e[42])
    : ((G = (0, $.jsx)(ce, {
...
function Ce(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(j, { className: `icon-lg text-token-foreground` })), (t[0] = r))
    : (r = t[0]);
  let i;
      ...
      : ((o = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsxs)(`div`, {
            ...
            children: [
              r,
              i,
              (0, $.jsx)(te, { color: `outline`, size: `medium`, onClick: n, children: a }),
            ],
          }),
        })),
        (t[3] = n),
...
function De(e) {
  ...
  t[8] === r.updated_at
    ? (u = t[9])
    : ((u = (0, $.jsx)(F, { dateString: r.updated_at })), (t[8] = r.updated_at), (t[9] = u));
  let d;
        ...
        a == null
          ...
          : (0, $.jsxs)(`span`, {
              ...
              children: [
                ...
                (0, $.jsx)(P, { className: `icon-2xs`, ExternalIcon: N, href: a }),
              ],
            })),
      (t[19] = a),
      (t[20] = h));
...
function ke(e) {
  let t = (0, Q.c)(16),
    ...
    c;
  t[0] !== r || t[1] !== s
    ? ((c = () => H(s, be, { projectId: r })), (t[0] = r), (t[1] = s), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === n
    ? (l = t[4])
    : ((l = (0, $.jsx)(g, { className: `icon-xs shrink-0`, accessPolicy: n, "aria-hidden": !0 })),
      (t[3] = n),
      (t[4] = l));
  let d = O,
    f = m(a),
