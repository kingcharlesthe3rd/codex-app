...
import { Bt as n, r } from "./use-host-config.js";
import { l as i, s as a } from "./lib-1.js";
import { t as o } from "./button-oF-qgtAS.js";
import { _ as s } from "./statsig.js";
import { t as c } from "./statsig-client-key.js";
async function l({ hostId: e = r, signal: t, useStreamlinedLogin: i }) {
  let a = d(t);
  return e === `local`
    ? n(`login-with-chatgpt`, { abortController: a, useStreamlinedLogin: i })
    : n(`login-with-chatgpt-for-host`, { abortController: a, hostId: e, useStreamlinedLogin: i });
}
function u({ signal: e } = {}) {
  return n(`login-with-chatgpt-device-code`, { abortController: d(e) });
}
function d(e) {
...
var f = s(),
  p = `/codex/desktop-auth`,
  m = `https://chatgpt.com${p}`,
  h = `codex_origin_stable_id`,
  g = `codex_streamlined_login`,
  _ = `source_surface_stable_id`;
function v({
  authUrl: e,
  sourceSurfaceStableId: t = f.StableID.get(c),
  ...
  try {
    ...
    if (a.pathname === p) {
      ...
      if (t && e) {
        let r = new URL(e);
        (y(r, t, n), a.searchParams.set(`authorize_url`, r.toString()));
      }
      return (i && a.searchParams.set(g, `true`), a.toString());
    }
    if ((t && y(a, t, n), i && a.searchParams.set(g, `true`), !r)) return a.toString();
    let o = new URL(m);
    return (
      o.searchParams.set(`authorize_url`, a.toString()),
      i && o.searchParams.set(g, `true`),
      o.toString()
    );
  } catch {
    return e;
...
function y(e, t, n) {
  (e.searchParams.set(_, t), n && e.searchParams.set(h, t));
}
var b = t(),
  x = e();
function S(e) {
  ...
  if (r) {
    ...
    t[1] === h
      ...
      : ((r = h.formatMessage({
        ...
        (t[2] = r));
    let i;
    t[3] === d ? (i = t[4]) : ((i = (e) => d(e.target.value)), (t[3] = d), (t[4] = i));
    let c;
    t[5] !== n || t[6] !== r || t[7] !== i
      ? ((c = (0, x.jsxs)(`label`, {
    ...
    let p;
    t[12] !== n || t[13] !== s
      ? ((p = n.trim().length === 0 || s), (t[12] = n), (t[13] = s), (t[14] = p))
      : (p = t[14]);
    let g;
    ...
    let v;
    t[20] !== f || t[21] !== _
      ? ((v = (0, x.jsxs)(`div`, { className: `flex items-center gap-2`, children: [f, _] })),
        (t[20] = f),
        (t[21] = _),
        (t[22] = v))
      : (v = t[22]);
    ...
    return (
      t[23] !== c || t[24] !== v
        ? ((y = (0, x.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [c, v] })),
          (t[23] = c),
          (t[24] = v),
          (t[25] = y))
        : (y = t[25]),
...
export { l as i, v as n, u as r, S as t };
//# sourceMappingURL=onboarding-login-content-BYCq-uLw.js.map
