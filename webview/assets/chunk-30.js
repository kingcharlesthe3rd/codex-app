...
import { u as n } from "./chunk-55.js";
import { s as r, y as i } from "./chunk-102.js";
import { a, i as o, s } from "./chunk-53.js";
import { a as c, i as l, n as u, r as d } from "./chunk-87.js";
var f = {
    common: r,
    getConfig: i,
    insertCluster: o,
...
t(() => {
  m([
    { name: `dagre`, loader: t(async () => await import(`./dagre-7.js`), `loader`) },
    ...[
      {
        name: `cose-bilkent`,
        loader: t(async () => await import(`./cose-bilkent-3.js`), `loader`),
      },
    ],
  ]);
