...
import { ln as v, un as y } from "./app-initial~app-main~onboarding-page.js";
import { _n as b, hn as x } from "./app-initial~app-main~automations-page.js";
import {
  G as S,
  K as C,
...
import { n as O, t as ee } from "./segmented-toggle.js";
import { a as k, i as A, n as j, o as M, r as N, t as P } from "./cloud-preferences.js";
function F() {
  let e = (0, L.c)(1),
    t;
  return (
...
function I() {
            ...
            children: (0, z.jsx)(D.Content, {
              children: (0, z.jsx)(T, {
                children: (0, z.jsx)(v, {
                  ...
                  control: (0, z.jsx)(m, { className: `icon-xs` }),
                }),
              }),
            }),
          })),
  ...
  let p = r.data,
    h = o.data,
    _ = u?.baseline === p.branch_format ? u.value : p.branch_format,
    y,
    b,
    x,
    S,
  ...
  if (
    ...
    C = j(_, h.branch_format_max_length, h.branch_format_special_values);
    let r;
    ...
    e[33] === c.isPending
      ? (u = e[34])
      : ((u = { id: `unified`, label: l, disabled: c.isPending }),
        (e[33] = c.isPending),
        (e[34] = u));
    let d;
    ...
    e[36] === c.isPending
      ? (f = e[37])
      : ((f = { id: `split`, label: d, disabled: c.isPending }),
        (e[36] = c.isPending),
        (e[37] = f));
    let m;
    e[38] !== f || e[39] !== u
      ? ((m = [u, f]), (e[38] = f), (e[39] = u), (e[40] = m))
      : (m = e[40]);
    let k;
    (e[41] !== t || e[42] !== w
      ? ((k = (e) => {
        ...
        (e[43] = k))
      : (k = e[43]),
      e[44] !== p.git_diff_mode || e[45] !== m || e[46] !== k || e[47] !== s
        ? ((N = (0, z.jsx)(v, {
            label: i,
            description: o,
            control: (0, z.jsx)(ee, {
      ...
      (O =
        C == null
          ? (0, z.jsx)(a, {
              ...
              values: { branchName: P(_, h.branch_format_special_values) },
            })
          : ne(C)),
      (e[8] = _),
      (e[9] = h.branch_format_max_length),
  ...
  e[54] === p.branch_format
    ...
    : ((V = (e) => {
      ...
      (e[55] = V));
  let H;
  e[56] !== _ || e[57] !== F || e[58] !== B || e[59] !== V || e[60] !== c.isPending
    ? ((H = (0, z.jsx)(`input`, {
    ...
    : (H = e[61]);
  let U;
  e[62] !== y || e[63] !== E || e[64] !== O || e[65] !== H
    ? ((U = (0, z.jsx)(y, { label: E, description: O, control: H })),
      (e[62] = y),
      (e[63] = E),
      (e[64] = O),
      (e[65] = H),
  ...
  e[68] === h.branch_format_special_values
    ? (G = e[69])
    : ((G = h.branch_format_special_values.map(te).join(`, `)),
      (e[68] = h.branch_format_special_values),
      (e[69] = G));
  let K = _ === p.branch_format || C != null,
    q;
  e[70] !== _ || e[71] !== t || e[72] !== w
    ? ((q = () => {
        w(
          { branch_format: _ },
          t.formatMessage({
  ...
  e[74] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (J = e[74]);
  let Y;
  e[75] !== K || e[76] !== q || e[77] !== c.isPending
    ? ((Y = (0, z.jsx)(f, {
        color: `primary`,
        disabled: K,
        loading: c.isPending,
  ...
  e[79] !== G || e[80] !== Y
    ...
    : (X = e[81]);
  let Z;
  e[82] !== b || e[83] !== X || e[84] !== N || e[85] !== U
    ? ((Z = (0, z.jsxs)(b, { children: [N, U, X] })),
      (e[82] = b),
      (e[83] = X),
      (e[84] = N),
      (e[85] = U),
