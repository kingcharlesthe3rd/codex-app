...
import { _ as v, n as y, t as b, u as ee } from "./chunk-33.js";
import { a as x, l as S, s as C } from "./chunk-141.js";
      ...
      var e = a(function (e, t, n, r) {
        ...
        ce = {
          ...
          table: [
            ...
            { 1: [2, 8] },
            e(te, [2, 15]),
            e(ne, [2, 17], { 21: 22, 19: 130, 22: t, 23: n, 24: r, 26: i, 28: o }),
            e(te, [2, 37], {
              19: 20,
              20: 21,
              21: 22,
          ...
          parse: a(function (e) {
            ...
            for (var S, C, w, T, E, D = {}, O, k, A, j; ; ) {
              if (
                ...
                var M = ``;
                for (O in ((j = []), s[w]))
                  this.terminals_[O] && O > p && j.push(`'` + this.terminals_[O] + `'`);
                ((M = g.showPosition
                  ? `Parse error on line ` +
                    (u + 1) +
                    `:
              ...
              switch (T[0]) {
                ...
                case 2:
                  if (
                    ...
                    b && (D._$.range = [o[o.length - (k || 1)].range[0], o[o.length - 1].range[1]]),
                    (E = this.performAction.apply(D, [l, d, u, _.yy, T[1], i, o].concat(h))),
                    E !== void 0)
                  )
                    return E;
                  (k &&
...
` +
    ...
    (G = a(function (e, t, n, r, i, a, o, s) {
      ...
      ((l.nodeType = e), (l.parentBoundary = j), (l.wrap = ge()), (M = j), (j = t), A.push(M));
    }, `addDeploymentNode`)),
    (K = a(function () {
    ...
    (q = a(function (e, t, n, r, i, a, o, s, l, u, d) {
      ...
      if (!(f === void 0 && ((f = N.find((e) => e.alias === t)), f === void 0))) {
        if (n != null)
          if (typeof n == `object`) {
            let [e, t] = Object.entries(n)[0];
            f[e] = t;
      ...
      for (let e of t) {
        ...
        if (a === 0) {
          ...
          (t.attr(`x1`, e.startPoint.x),
            ...
            t.attr(`stroke`, o),
            t.style(`fill`, `none`),
            e.type !== `rel_b` && t.attr(`marker-end`, `url(#` + r + `-arrowhead)`),
        ...
        (X(n)(
          e.label.text,
          i,
          Math.min(e.startPoint.x, e.endPoint.x) + Math.abs(e.endPoint.x - e.startPoint.x) / 2 + s,
          Math.min(e.startPoint.y, e.endPoint.y) + Math.abs(e.endPoint.y - e.startPoint.y) / 2 + l,
          e.label.width,
          e.label.height,
          { fill: t },
          u,
        ...
        for (let e = 0; e < p.length; e++) {
          let o = e * u - (u * (p.length - 1)) / 2,
            l = t
              ...
              .style(`font-weight`, f)
              .style(`font-family`, d);
          (l.append(`tspan`).attr(`dy`, o).text(p[e]).attr(`alignment-baseline`, `mathematical`),
            r(l, s));
        }
      }
      a(t, `byTspan`);
    ...
    (Fe = class {
      ...
      insert(e) {
        ...
        let t =
          ...
          i = r + e.height;
        ((t >= this.data.widthLimit || n >= this.data.widthLimit || this.nextData.cnt > Ne) &&
    ...
    (Ue = a(function (e, t) {
      ...
      let r = He(e, n);
      return (
        (n.x = e.x + e.width / 2), (n.y = e.y + e.height / 2), { startPoint: r, endPoint: He(t, n) }
      );
    }, `getIntersectPoints`)),
    (We = a(function (e, t, n, r, i) {
      ...
      for (let e of t) {
        ...
        (w(`label`, e, t, i, o),
          e.techn && e.techn.text !== `` && ((o = y(e.techn.text, i)), w(`techn`, e, t, i, o)),
          e.descr && e.descr.text !== `` && ((o = y(e.descr.text, i)), w(`descr`, e, t, i, o)));
    ...
    (Ge = {
      ...
      draw: a(function (e, n, r, a) {
        ...
        (Z.insertComputerIcon(d, n), Z.insertDatabaseIcon(d, n), Z.insertClockIcon(d, n));
        let f = new Fe(a);
        (f.setData(Q.diagramMarginX, Q.diagramMarginX, Q.diagramMarginY, Q.diagramMarginY),
...
//# sourceMappingURL=c4Diagram-4.js.map
