...
import { n as oe, t as se } from "./avatar-mascot-button.js";
import {
  a as ce,
  o as q,
...
import { n as Y, t as me } from "./global-dictation-orb-CBcl-6tx.js";
import {
  _ as he,
  c as ge,
  d as _e,
...
function ze(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = B({ height: 54, left: 0, top: 0, width: 345 }, a)), (t[0] = s))
    : (s = t[0]);
  let c = s,
    l;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = B({ height: 54, left: 0, top: 0, width: 345 }, o)), (t[1] = l))
    : (l = t[1]);
  let u = l,
    d;
  t[2] === r ? (d = t[3]) : ((d = i(r)), (t[2] = r), (t[3] = d));
  let f;
  t[4] === d ? (f = t[5]) : ((f = { height: d }), (t[4] = d), (t[5] = f));
  let p;
  t[6] !== n || t[7] !== r
    ? ((p =
        r > 2
    ...
    : (p = t[8]);
  let m;
  t[9] === n ? (m = t[10]) : ((m = He(n, `absolute rounded-[27px]`)), (t[9] = n), (t[10] = m));
  let h;
  t[11] === m
    ? (h = t[12])
    : ((h = (0, We.jsx)(`div`, {
...
function Ke({
  ...
  onQuickChatDraftChange: R,
  onQuickChatVisibilityChange: z,
  onSubmitQuickChat: B,
  onTrayAnimationFrame: V,
  ...
  let G = f(),
    ...
    ie = W?.type === `native-surface` || (W?.type === `native-root` && h),
    ae = W != null,
    oe = (0, Q.useRef)(!1),
    ce = (0, Q.useRef)(!1),
    q = (0, Q.useRef)(null),
    ...
    Ce = v.length > 1 && c,
    we = g ?? Ce,
    Te = l.tray == null || W?.type === `native-root` ? void 0 : Math.max(0, l.tray.height),
    Ee = () => {
  ...
  (0, Q.useEffect)(
    () => (
      (oe.current = !1),
      () => {
        ((oe.current = !0), q.current != null && window.clearTimeout(q.current));
      }
    ),
    [],
  );
  ...
  let ke =
    r == null
      ...
      : (0, $.jsx)(se, {
          ...
          resizeHandle: m == null ? void 0 : { ariaLabel: G.formatMessage(_t.resizeMascot), ...m },
    ...
    children: (0, $.jsxs)(`section`, {
      ...
      children: [
        ...
        (0, $.jsx)(`div`, {
          ...
          onPointerEnter: K == null ? Ee : void 0,
          onPointerLeave: K == null ? De : void 0,
          children: (0, $.jsxs)(`div`, {
            className: N(`relative w-max`, h && K == null && `overflow-hidden`),
            ...
            children: [
              ...
              (0, $.jsx)(`div`, {
                children: (0, $.jsx)(qe, {
                  ...
                  nativeMaterialAttached: h,
                  nativePresentationOwnsMotion: ie,
                  usesStableBackingCanvases: ae,
                  notifications: v,
                  notificationFollowUp: b,
                  expandedNotificationIds: a,
                  pointerSurfaceId: x,
                  ...
                  trayMaxHeight: Te,
                  onDismissNotification: y === 1 || c ? P : void 0,
                  onNotificationExpansionChange: M,
                  onRunNotificationControl: F,
                  onRunNotificationAction: I,
                  onSubmitQuestionOption: te,
...
function qe(e) {
  let t = (0, pt.c)(61),
    {
      ...
      onDismissNotification: ee,
      onNotificationExpansionChange: C,
      onTrayAnimationFrame: w,
      onQuickChatEditorActiveChange: T,
      onQuickChatDraftChange: E,
      onQuickChatPointerEnter: D,
      onQuickChatPointerLeave: O,
      onRunNotificationControl: k,
  ...
  t[0] !== d || t[1] !== f || t[2] !== y || t[3] !== g
    ...
    : (I = t[4]);
  let L = I,
    R = x && a == null ? `true` : void 0,
    z = x && a == null && `invisible`,
    B;
  t[5] === z
    ? (B = t[6])
    : ((B = N(`absolute top-0 left-1/2 -translate-x-1/2`, z)), (t[5] = z), (t[6] = B));
  let V = x && a == null ? !0 : void 0,
    H;
  t[7] !== a ||
  t[8] !== s ||
  t[9] !== b ||
  ...
  t[19] !== F
    ...
    : (H = t[20]);
  let ne;
  t[21] === H ? (ne = t[22]) : ((ne = (0, $.jsx)(te, { children: H })), (t[21] = H), (t[22] = ne));
  let U;
  t[23] !== R || t[24] !== B || t[25] !== V || t[26] !== ne
    ? ((U = (0, $.jsx)(`div`, {
        className: `relative h-10 w-[344px] shrink-0`,
        children: (0, $.jsx)(`div`, { "aria-hidden": R, className: B, inert: V, children: ne }),
      })),
      (t[23] = R),
      (t[24] = B),
      (t[25] = V),
  ...
  let re = U,
    W;
  t[28] !== L || t[29] !== re
    ? ((W = (0, $.jsxs)($.Fragment, { children: [L, re] })), (t[28] = L), (t[29] = re), (t[30] = W))
    : (W = t[30]);
  let G = W,
    K;
  t[31] === P ? (K = t[32]) : ((K = { maxHeight: P }), (t[31] = P), (t[32] = K));
  let ie = u ? G : null,
    ae;
  t[33] !== n ||
  t[34] !== r ||
  ...
  let oe = u ? null : G,
    se;
  return (
    t[56] !== K || t[57] !== ie || t[58] !== ae || t[59] !== oe
      ? ((se = (0, $.jsxs)(`div`, {
...
function Je(e) {
  ...
  let D;
  t[25] !== n?.[0]?.notificationListAriaLabel || t[26] !== w
    ? ((D = n?.[0]?.notificationListAriaLabel ?? w.formatMessage(_t.notificationList)),
  ...
  t[28] === O
    ? (k = t[29])
    : ((k = N(`relative w-[345px] max-w-full shrink-0`, O)), (t[28] = O), (t[29] = k));
  let A;
  t[30] !== i || t[31] !== o || t[32] !== l || t[33] !== p.length
    ? ((A =
        !o && p.length > 1 && i == null
          ? (0, $.jsx)(ze, { nativeMaterialAttached: l, notificationCount: p.length })
          : null),
      (t[30] = i),
      (t[31] = o),
      (t[32] = l),
    ...
    t[71] !== d
      ? ((e = (e, t) => {
          let r = Ie[t],
            ...
            c = !o && s === `secondary`,
            f = (u && i == null) || (d && i == null && c) || (i != null && i !== r);
          if (c && !d) return null;
          let g = `relative z-10`;
          return (
            s === `primary`
              ? (g = `relative z-20`)
              : c && (g = `pointer-events-none absolute top-0 right-0 left-0 z-10`),
            (0, $.jsx)(
              ee.div,
              {
                layout: !u,
                "aria-hidden": f || c ? `true` : void 0,
                "data-avatar-overlay-backing-canvas": c ? `true` : void 0,
                className: N(g, f && `invisible`),
                inert: f || void 0,
                transition: E,
                onUpdate: v,
                children: (0, $.jsx)(Qe, {
                  canExpandActivityStack: !o && s === `primary` && p.length > 1,
                  copy: n?.[t],
...
function Ye(e) {
  ...
  if (
    ...
    let e = new Map(p.map(Xe)),
      ...
      R;
    t[35] !== r.slots[0]?.presentationRect || t[36] !== f || t[37] !== c || t[38] !== p.length
      ? ((R = c ? f : i(p.length, r.slots[0]?.presentationRect.height)),
    ...
    t[40] !== n?.[0]?.notificationListAriaLabel || t[41] !== E
      ? ((F = n?.[0]?.notificationListAriaLabel ?? E.formatMessage(_t.notificationList)),
        (t[40] = n?.[0]?.notificationListAriaLabel),
        (t[41] = E),
        (t[42] = F))
      : (F = t[42]);
    let B = a == null && `overflow-hidden`;
    (t[43] === B
      ? (I = t[44])
      : ((I = N(`relative w-[345px] max-w-full shrink-0`, B)), (t[43] = B), (t[44] = I)),
      (te = `notification-stack-visible-layout`),
      (L = `list`),
      t[45] === z ? (O = t[46]) : ((O = { height: z }), (t[45] = z), (t[46] = O)),
      t[47] !== s || t[48] !== _
        ? ((k =
            s && _ != null
              ? (e) => {
          ...
          (t[49] = k))
        : (k = t[49]));
    let V = l ? `bottom-0` : `top-0`;
    (t[50] === V ? (D = t[51]) : ((D = N(`absolute inset-x-0`, V)), (t[50] = V), (t[51] = D)),
      (A = `true`),
      (j = `notification-stack-backing-layout`),
      t[52] === f ? (M = t[53]) : ((M = { height: f }), (t[52] = f), (t[53] = M)),
      (P = r.slots.map((t) => {
        let { itemId: i, presentationRect: c, slotId: l, zIndex: f } = t,
          _ = e.get(i);
        if (_ == null) return null;
        let E = n?.[p.indexOf(_)],
          D = !s && l !== `activity-slot-0`;
        if (a != null && a !== l) return null;
        let O = d && a == null;
        return (0, $.jsx)(
          ee.div,
          {
            ...
            className: N(`absolute`, D && `pointer-events-none`, O && `invisible`),
            inert: O || void 0,
            style: {
            ...
            onUpdate: y,
            children: (0, $.jsx)(Qe, {
              canExpandActivityStack: !s && l === `activity-slot-0` && p.length > 1,
              copy: E,
              isNativeMeasurementPlaceholder: d && a == null,
              isPointerSurfaceHovered: h === l,
              nativeMaterialAttached: u,
              nativePresentationOwnsMotion: d,
              nativeSurfaceId: l,
              notification: _,
              notificationFollowUp: m,
              publishesFollowUpVisibility: g,
              isExpanded: x == null ? void 0 : o.includes(_.id),
              onAnimationFrame: y,
    ...
    ((D = t[24]),
      ...
      (L = t[34]));
  let R;
  t[54] !== D || t[55] !== A || t[56] !== j || t[57] !== M || t[58] !== P
    ? ((R = (0, $.jsx)(`div`, {
        className: D,
...
function Ze({
  ...
  let v = _(s),
    ...
    te = async (e) => {
      if (!(e.length === 0 || S || p == null)) {
        (C(!0), O(null));
        try {
          (await p(e), I(``));
        } catch {
          O(y.formatMessage(_t.quickChatError));
        } finally {
          C(!1);
        }
      }
    ...
    R = r.supportState,
    {
      ...
      onStartError: (e) => {
        (v.get(L).danger(de(y, `start`, e).message),
          l.error(`[AvatarOverlay] unable to start dictation`, {
            safe: {},
            sensitive: { error: e },
          }));
      },
      onTranscribeError: (e) => {
        (v.get(L).danger(de(y, `transcription`, e).message),
          l.error(`[AvatarOverlay] dictation failed`, { safe: {}, sensitive: { error: e } }));
      },
      onUnsupported: () => {
        v.get(L).danger(
          y.formatMessage({
  ...
  ((0, Q.useLayoutEffect)(
    ...
    m(
      ...
      () => {
        x.current && b.current?.focus();
      },
      [],
    ));
  let G = async (e) => {
    (e.preventDefault(), e.stopPropagation(), !(B || V) && (await te(A)));
  };
  return (0, $.jsxs)(Be, {
    emptyWidth: j,
    nativeMaterialAttached: t,
    ...
    onBlurCapture: (e) => {
      ...
      (t instanceof Node && e.currentTarget.contains(t)) || ((x.current = !1), i?.(!1));
    },
    onPointerDown: () => {
      ((x.current = !0), i?.(!0));
    },
    ...
    children: [
      (0, $.jsx)(`input`, {
        ref: b,
        "aria-label": y.formatMessage(_t.quickChat),
        className: N(
        ...
        placeholder: e
          ? y.formatMessage(_t.startNewTaskPlaceholder)
          : y.formatMessage(_t.askPlaceholder),
        value: E,
        onChange: (e) => {
      ...
      (0, $.jsx)(ee.div, {
        ...
        children: W
          ? (0, $.jsx)(K, {
              ...
              color: `secondary`,
              idleIcon: (0, $.jsx)(fe, { className: `icon-sm` }),
              isDictating: B,
              isVisible: !0,
              isTranscribing: V,
              canRetryDictation: z,
          ...
          : (0, $.jsx)(k, {
              "aria-label": y.formatMessage(_t.sendQuickChat),
              className: `size-7 shrink-0 !bg-[#636363] !text-white enabled:hover:!bg-[#636363] disabled:opacity-100 electron:!rounded-full`,
              color: `secondary`,
              disabled: A.length === 0 || S,
              loading: S,
              size: `icon`,
              type: `submit`,
              children: S ? null : (0, $.jsx)(g, { className: `icon-sm` }),
            }),
      }),
...
function Qe(e) {
  let t = (0, pt.c)(154),
    ...
    A;
  t[0] !== D || t[1] !== p || t[2] !== i
    ? ((A = i ?? Ne({ intl: D, notification: p })), (t[0] = D), (t[1] = p), (t[2] = i), (t[3] = A))
    : (A = t[3]);
  let j = A,
    M = ye(p),
    P = p.waitingRequest,
    ...
    G = s || re,
    K = (0, Q.useRef)(null),
    ie = (0, Q.useRef)(void 0),
    oe = p.kind === `activity` && r && b != null,
    se = oe || (p.kind !== `activity` && (b != null || p.action != null)),
    ce = p.controlTarget != null && C != null,
    q = p.isLoading && ce,
    le = R || L,
    ue = P != null && `actions` in P && P.actions.length > 0,
    de = ce && V !== void 0 && V === p.turnKey,
    fe = h?.notificationId === p.id && h.turnKey === p.turnKey ? h : null,
    J = h !== void 0,
    Y = ce && (J ? fe != null : de),
  ...
  t[4] !== z || t[5] !== P
    ? ((be = (e) => {
        if ((ie.current?.(), (ie.current = void 0), e == null || P == null)) return;
        let t = () => {
          let t = Array.from(
        ...
        (t(), (ie.current = Ee({ axis: `both`, target: e, onChange: t })));
      }),
      (t[4] = z),
      (t[5] = P),
      (t[6] = be))
  ...
  (t[20] === de
    ...
    : ((X = () => {
      ...
      (t[21] = X),
      (t[22] = je)),
    m(`avatar-overlay-keyboard-interaction-ready`, X, je));
  let Me = Re,
    Z,
    Pe,
    Fe;
  ...
  let Ie = se ? `button` : void 0,
    Le = oe ? j.expandNotificationStackAriaLabel : se ? j.actionAriaLabel : void 0,
    ze = q ? `pr-[88px]` : P == null ? `pr-[58px]` : `pr-[13px]`,
    Be = se ? `cursor-interaction` : `cursor-default`,
    Ve;
  t[26] !== ze || t[27] !== Be
    ? ((Ve = N(
  ...
  t[29] !== se || t[30] !== p || t[31] !== b || t[32] !== w
    ? ((Ue = () => {
      ...
      (t[34] = We))
    : ((Ue = t[33]), (We = t[34]));
  let Ge = p.kind !== `activity` && `font-bold`,
    Ke = P != null && `pr-[38px]`,
    qe = P != null && L ? `break-words whitespace-pre-wrap` : `truncate`,
    Je = p.kind === `activity` && (l ? `text-[#5F6B7A]` : `text-token-text-secondary`),
    Ye = p.kind !== `activity` && (l ? `text-[#1A1A1A]` : `text-token-foreground`),
    Xe;
  t[35] !== Ge || t[36] !== Ke || t[37] !== qe || t[38] !== Je || t[39] !== Ye
    ? ((Xe = N(`text-[13px] leading-[17px]`, Ge, Ke, qe, Je, Ye)),
      (t[35] = Ge),
      (t[36] = Ke),
      (t[37] = qe),
      (t[38] = Je),
  ...
  t[44] !== L || t[45] !== P
    ? ((Qe = P == null ? void 0 : { maxHeight: L ? ht : mt }),
      ...
      (t[46] = Qe))
    : (Qe = t[46]);
  let et = p.kind === `activity` && `hidden`,
    tt = l ? `text-[#5F6B7A]` : `text-token-text-secondary`,
    nt = P == null && `truncate`,
    rt = P != null && (L ? `overflow-y-auto overscroll-contain` : `overflow-hidden`),
    it;
  t[47] !== et || t[48] !== tt || t[49] !== nt || t[50] !== rt
    ? ((it = N(`text-[13px] leading-[17px]`, et, tt, nt, rt)),
      (t[47] = et),
      (t[48] = tt),
      (t[49] = nt),
      (t[50] = rt),
    ...
    ? ((ot =
        P == null
          ...
          : (0, $.jsx)($e, {
              isExpanded: L,
              nativeMaterialAttached: l,
              patchSummaryCopy: j.patchSummary,
              request: P,
  ...
  t[76] !== st
    ? ((ct = (0, $.jsxs)(ee.div, {
      ...
      (t[77] = ct))
    : (ct = t[77]);
  let lt = j.statusIconAriaLabel,
    ft = M.iconType,
    vt = ve && `opacity-0`,
    yt;
  t[78] === vt
    ? (yt = t[79])
    : ((yt = N(`relative flex h-8 w-[31px] items-center justify-center`, vt)),
      (t[78] = vt),
      (t[79] = yt));
  ...
  t[80] !== yt || t[81] !== xt
    ...
    : (St = t[82]);
  let Ct;
  t[83] !== j.statusIconAriaLabel || t[84] !== M || t[85] !== St
    ? ((Ct = (0, $.jsx)(`span`, {
        role: `img`,
        "aria-label": lt,
    ...
    ? ((wt =
        q && !Y
          ? (0, $.jsxs)(`div`, {
              ...
              children: [
                (0, $.jsx)(k, {
                  "aria-label": D.formatMessage(_t.replyNotification, { title: p.title }),
                  className: N(
                    bt,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: D.formatMessage(_t.replyNotification, { title: p.title }),
                  onClick: () => {
                    (U(``),
                      H(p.turnKey),
                      J && C?.(p, { type: `open-follow-up` }),
                      _e &&
                ...
                (0, $.jsx)(k, {
                  "aria-label": D.formatMessage(_t.stopNotification, { title: p.title }),
                  className: N(
                    bt,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: D.formatMessage(_t.stopNotification, { title: p.title }),
                  onClick: () => {
                    (U(``), H(void 0), C?.(p, { type: `stop` }));
                  },
                  children: (0, $.jsx)(ae, {
  ...
  let Tt;
  t[98] !== le ||
  t[99] !== j.collapseNotificationAriaLabel ||
  t[100] !== j.expandNotificationAriaLabel ||
  t[101] !== ue ||
  t[102] !== L ||
  t[103] !== l ||
  t[104] !== p.id ||
    ...
    ? ((Tt =
        P != null && (le || ue)
          ? (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(k, {
                "aria-expanded": L,
                "aria-label": L ? j.collapseNotificationAriaLabel : j.expandNotificationAriaLabel,
                className: N(
                  `size-8 !rounded-full`,
                  l
        ...
        Y || _e
          ? (0, $.jsxs)(ee.form, {
              ...
              className: N(
                ...
                l ? `bg-white` : `bg-token-main-surface-primary`,
              ),
              exit: o ? void 0 : { height: 0, marginBottom: 0, opacity: 0, y: O ? 0 : -2 },
              initial: o || _e ? !1 : { height: 0, marginBottom: 0, opacity: 0, y: O ? 0 : -2 },
              transition:
                o || O
                  ? { duration: 0 }
                  : {
              ...
              onSubmit: (e) => {
                ...
                let t = ne.trim();
                t.length > 0 &&
                  (J || (U(``), H(void 0)), C?.(p, { type: `submit-follow-up`, prompt: t }));
              },
              children: [
                (0, $.jsx)(`input`, {
                  ref: K,
  ...
  let Dt;
  t[128] !== v || t[129] !== Et
    ? ((Dt = (0, $.jsx)(te, { onExitComplete: v, children: Et })),
      (t[128] = v),
      (t[129] = Et),
      (t[130] = Dt))
    : (Dt = t[130]);
  let Ot;
  t[131] !== q ||
  t[132] !== j.dismissNotificationAriaLabel ||
  t[133] !== Y ||
  t[134] !== G ||
  t[135] !== p ||
  t[136] !== x
    ? ((Ot =
        p.kind !== `activity` && x != null && !q && !Y
          ? (0, $.jsx)(`div`, {
              className: N(
              ...
              children: (0, $.jsx)(Te, {
                ariaLabel: j.dismissNotificationAriaLabel,
                onClick: () => {
                  x(p);
                },
              }),
  ...
  switch (s.kind) {
    case `question`: {
      let e = n ? `break-words whitespace-pre-wrap` : `truncate`,
        o;
      t[2] === e ? (o = t[3]) : ((o = N(`min-w-0 pr-[38px]`, e)), (t[2] = e), (t[3] = o));
      let c;
      t[4] !== s.prompt || t[5] !== o
        ? ((c = (0, $.jsx)(`div`, {
            className: o,
...
function nt(e) {
  let t = (0, pt.c)(5),
    ...
    a;
  t[0] === i ? (a = t[1]) : ((a = N(`min-w-0 pr-[38px]`, i)), (t[0] = i), (t[1] = a));
  let o;
  return (
    t[2] !== a || t[3] !== r
      ? ((o = (0, $.jsx)(`div`, {
...
function rt(e) {
  ...
  if (!i) {
    ...
    t[6] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((o = (0, $.jsx)(ce, { className: `mx-1.5 text-token-text-tertiary` })), (t[6] = o))
      : (o = t[6]);
    let s;
...
function dt(e) {
  switch (e.iconType) {
    ...
    case `spinner`:
      return (0, $.jsx)(P, { Icon: je, className: `size-7` });
    case `warning`:
