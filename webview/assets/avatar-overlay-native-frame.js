...
import { Xr as c, Zr as l, qr as u } from "./src-3.js";
import { i as d, l as f, s as p } from "./lib-1.js";
import { t as m } from "./clsx.js";
import { t as h } from "./proxy.js";
import { t as g } from "./AnimatePresence.js";
import { t as _ } from "./use-reduced-motion-2.js";
...
import { t as T } from "./stop.js";
import { n as E, r as D } from "./use-dictation.js";
import { n as O } from "./composer-utils.js";
import { t as k } from "./dictation-error-message.js";
import { t as A } from "./global-dictation-orb-W.js";
import { t as j } from "./chevron.js";
import { t as M } from "./clock-Cid-cc8u.js";
import { t as N } from "./question-mark-circle.js";
import { t as P } from "./warning.js";
import { t as F } from "./waveform.js";
import {
  c as I,
  i as L,
  n as R,
...
function ie({ intl: e, latestTurnItems: t, notification: n, notificationCount: r = 1 }) {
  let i = te(n),
    a = e.formatMessage(i.labelMessage),
    o = (t == null ? null : L(t, e)) ?? n.body ?? e.formatMessage(i.fallbackBodyMessage),
    s = n.waitingRequest == null ? o : z(n.waitingRequest, e),
    c = s.replace(/[.?!]+$/, ``),
    l = n.waitingRequest?.kind === `patch` ? n.waitingRequest : null;
  return {
    actionAriaLabel: `${n.title}. ${s === a ? a : `${a}. ${c}`}. ${e.formatMessage(U.openNotification)}`,
    collapseNotificationAriaLabel: e.formatMessage(U.collapseNotification, { title: n.title }),
    dismissNotificationAriaLabel: e.formatMessage(U.dismissNotification, { title: n.title }),
    expandNotificationAriaLabel: e.formatMessage(U.expandNotification, { title: n.title }),
    expandNotificationStackAriaLabel: e.formatMessage(U.expandNotificationStack, { count: r }),
    notificationListAriaLabel: e.formatMessage(U.notificationList),
    patchSummary:
      l == null
        ? null
        : {
            additions:
              l.additions > 0
                ? e.formatMessage(U.compactPatchAdditions, { count: l.additions })
                : null,
            deletions:
              l.deletions > 0
                ? e.formatMessage(U.compactPatchDeletions, { count: l.deletions })
                : null,
            fileCount: e.formatMessage(U.compactPatchFileCount, { count: l.fileCount }),
          },
    statusIconAriaLabel:
      n.waitingRequest?.kind === `question` ? e.formatMessage(U.questionStatusIcon) : a,
    subtitle: o,
  };
}
var U = d({
  ...
  W = [`activity-primary`, `activity-secondary`, `activity-tertiary`];
function ae(e) {
...
function oe(e) {
  ...
  let g;
  t[6] !== r || t[7] !== i ? ((g = q(i, r)), (t[6] = r), (t[7] = i), (t[8] = g)) : (g = t[8]);
  let _;
  t[9] !== o || t[10] !== d
    ? ((_ = o ?? ae(d)), (t[9] = o), (t[10] = d), (t[11] = _))
    : (_ = t[11]);
  let v;
  t[12] !== n || t[13] !== g || t[14] !== _
    ? ((v = (0, V.jsx)(K, { className: g, cornerRadius: 27, nativeSurfaceId: _, children: n })),
      (t[12] = n),
      (t[13] = g),
      (t[14] = _),
      (t[15] = v))
...
function se(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = l({ height: 54, left: 0, top: 0, width: 345 }, i)), (t[0] = o))
    : (o = t[0]);
  let s = o,
    d;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = l({ height: 54, left: 0, top: 0, width: 345 }, a)), (t[1] = d))
    : (d = t[1]);
  let f = d,
    p;
  t[2] === r ? (p = t[3]) : ((p = c(r)), (t[2] = r), (t[3] = p));
  let m;
  ...
  t[6] !== n || t[7] !== r
    ? ((h =
        r > 2
          ? (0, V.jsx)(`div`, {
              className: q(n, `absolute rounded-[27px]`),
    ...
    : (h = t[8]);
  let g;
  t[9] === n ? (g = t[10]) : ((g = q(n, `absolute rounded-[27px]`)), (t[9] = n), (t[10] = g));
  let _;
  t[11] === g
    ? (_ = t[12])
    : ((_ = (0, V.jsx)(`div`, {
...
var J = 56,
  ...
  de = 300,
  fe = 8,
  pe = `absolute top-1/2 size-7 shrink-0 -translate-y-1/2 !rounded-full !border-0 !bg-transparent !p-0 enabled:hover:!bg-transparent before:pointer-events-none before:absolute before:inset-0 before:rounded-full before:mix-blend-darken before:content-['']`;
function X({
  activityCopies: e,
  ...
  onMascotPointerCancel: O,
  onMascotPointerDown: k,
  ...
  onQuickChatEditorActiveChange: R,
  onQuickChatDraftChange: z,
  onQuickChatVisibilityChange: re,
  onStartRealtimeVoice: H,
  onStopRealtimeVoice: ie,
  onSubmitQuickChat: U,
  onTrayAnimationFrame: W,
  onShowActivityPills: ae,
  quickChatDraft: G,
  quickChatVisible: oe,
  realtimeVoicePhase: se = `inactive`,
  realtimeVoiceWaveformCanvasRef: ce,
  renderMode: K,
}) {
  let q = f(),
    J = K?.type === `native-surface` ? K.id : void 0,
    le = K?.type === `native-surface` || (K?.type === `native-root` && h),
    ue = K != null,
    fe = (0, B.useRef)(!1),
    pe = (0, B.useRef)(!1),
    X = (0, B.useRef)(null),
    ...
    Q = y.length > 1 && c,
    we = g ?? Q,
    Te = l.tray == null || K?.type === `native-root` ? void 0 : Math.max(0, l.tray.height),
    Ee = () => {
  ...
  (0, B.useEffect)(
    () => (
      (fe.current = !1),
      () => {
        ((fe.current = !0), X.current != null && window.clearTimeout(X.current));
      }
    ),
    [],
  );
    ...
    _ && Ce && E != null
      ...
      : _ &&
        ...
        (De = {
          ...
          backgroundColor: xe.badgeBackgroundColor,
          content: y.length,
          foregroundColor: xe.badgeForegroundColor,
          onClick: ae,
        }),
    (0, V.jsx)(`main`, {
      ...
      children: (0, V.jsxs)(`section`, {
        ...
        children: [
          ...
          (0, V.jsx)(`div`, {
            ...
            onPointerEnter: J == null ? Ee : void 0,
            onPointerLeave: J == null ? $ : void 0,
            children: (0, V.jsxs)(`div`, {
              className: m(`relative w-max`, h && J == null && `overflow-hidden`),
              ...
              children: [
                ...
                (0, V.jsx)(`div`, {
                  children: (0, V.jsx)(me, {
                    ...
                    onActivityStackScroll: ee,
                    onActivateNotification: T,
                    onGlobalDictationVisibilityChange: ve,
                    trayMaxHeight: Te,
                    onDismissNotification: b === 1 || c ? P : void 0,
                    onNotificationExpansionChange: N,
                    onRunNotificationControl: F,
                    onRunNotificationAction: I,
                    onSubmitQuestionOption: L,
                    onQuickChatEditorActiveChange: (e) => {
                      ((pe.current = e), R?.(e), e ? Ee() : $());
                    },
                    onQuickChatDraftChange: z,
                    onTrayAnimationFrame: W,
            ...
            ? (0, V.jsx)(`div`, {
                ...
                children: (0, V.jsx)(C, {
                  ...
                  children: (0, V.jsxs)(`div`, {
                    ...
                    children: [
                      (0, V.jsx)(v, {
                        ariaLabel: q.formatMessage(Y.mascotLabel, { petName: r.displayName }),
                        assetRef: r.assetRef,
                        notificationBadge: De,
                        spritesheetUrl: r.spritesheetUrl,
                        resizeHandle:
                          p == null ? void 0 : { ariaLabel: q.formatMessage(Y.resizeMascot), ...p },
                        state: xe.mascotState,
                        style: d,
                      }),
                      (0, V.jsx)(ne, {
                        canStart: a,
...
function me(e) {
  ...
  t[0] === L
    ...
    : ((R = m(`flex h-10 w-[345px] shrink-0 items-center justify-center`, L)),
      ...
      (t[1] = R));
  let z;
  t[2] !== b || t[3] !== _.cleanupEnabled || t[4] !== _.streamingEnabled
    ? ((z = (0, V.jsx)(A, {
        cleanupEnabled: _.cleanupEnabled,
        streamingEnabled: _.streamingEnabled,
        onVisibilityChange: b,
      })),
      (t[2] = b),
      (t[3] = _.cleanupEnabled),
      (t[4] = _.streamingEnabled),
      (t[5] = z))
    : (z = t[5]);
  let te;
  t[6] !== R || t[7] !== z
    ...
    : (te = t[8]);
  let ne = te,
    B = S && a == null ? `true` : void 0,
    re = S && a == null && `invisible`,
    H;
  t[9] === re
    ? (H = t[10])
    : ((H = m(`absolute top-0 left-1/2 -translate-x-1/2`, re)), (t[9] = re), (t[10] = H));
  let ie = S && a == null ? !0 : void 0,
    U;
  t[11] !== a ||
  t[12] !== s ||
  t[13] !== x ||
  ...
  t[23] !== I
    ...
    : (U = t[24]);
  let W;
  t[25] === U ? (W = t[26]) : ((W = (0, V.jsx)(g, { children: U })), (t[25] = U), (t[26] = W));
  let ae;
  t[27] !== W || t[28] !== B || t[29] !== H || t[30] !== ie
    ? ((ae = (0, V.jsx)(`div`, {
        className: `relative h-10 w-[344px] shrink-0`,
        children: (0, V.jsx)(`div`, { "aria-hidden": B, className: H, inert: ie, children: W }),
      })),
      (t[27] = W),
      (t[28] = B),
      (t[29] = H),
  ...
  let oe = ae,
    se;
  t[32] !== ne || t[33] !== oe
    ? ((se = (0, V.jsxs)(V.Fragment, { children: [ne, oe] })),
      (t[32] = ne),
      (t[33] = oe),
      (t[34] = se))
    : (se = t[34]);
  let ce = se,
    K;
  t[35] === F ? (K = t[36]) : ((K = { maxHeight: F }), (t[35] = F), (t[36] = K));
  let q = u ? ce : null,
    J;
  t[37] !== n ||
  t[38] !== r ||
...
function he(e) {
  ...
  t[24] !== n?.[0]?.notificationListAriaLabel || t[25] !== ee
    ? ((D = n?.[0]?.notificationListAriaLabel ?? ee.formatMessage(Y.notificationList)),
  ...
  t[29] !== i || t[30] !== o || t[31] !== c || t[32] !== d.length
    ? ((A =
        !o && d.length > 1 && i == null
          ? (0, V.jsx)(se, { nativeMaterialAttached: c, notificationCount: d.length })
          : null),
      (t[29] = i),
      (t[30] = o),
      (t[31] = c),
...
function ge(e) {
  ...
  if (
    ...
    t[34] !== r.slots[0]?.presentationRect || t[35] !== f || t[36] !== s || t[37] !== d.length
      ? ((R = s ? f : c(d.length, r.slots[0]?.presentationRect.height)),
    ...
    t[39] !== n?.[0]?.notificationListAriaLabel || t[40] !== E
      ? ((P = n?.[0]?.notificationListAriaLabel ?? E.formatMessage(Y.notificationList)),
    ...
    (t[42] === te
      ...
      (N = r.slots.map((t) => {
        let { itemId: s, presentationRect: c, slotId: f, zIndex: v } = t,
          E = e.get(s);
...
function ve({
  ...
  let v = i(a),
    ...
    re = async (e) => {
      if (!(e.length === 0 || C || g == null)) {
        ...
        try {
          ...
          P(y.formatMessage(Y.quickChatError));
        } finally {
          T(!1);
        }
      }
    ...
    H = r.supportState,
    {
      ...
      onStartError: (e) => {
        (v.get(w).danger(k(y, `start`, e).message),
      ...
      onTranscribeError: (e) => {
        (v.get(w).danger(k(y, `transcription`, e).message),
  ...
  let K = async (e) => {
    (e.preventDefault(), e.stopPropagation(), !(U || W) && (await re(I)));
  };
  return (0, V.jsxs)(ce, {
    emptyWidth: L,
    nativeMaterialAttached: t,
    ...
    children: [
      (0, V.jsx)(`input`, {
        ref: x,
        "aria-label": y.formatMessage(Y.quickChat),
        className: m(
        ...
        placeholder: e
          ? y.formatMessage(Y.startNewTaskPlaceholder)
          : y.formatMessage(Y.askPlaceholder),
        value: M,
        onChange: (e) => {
      ...
      (0, V.jsx)(h.div, {
        ...
        children: se
          ? (0, V.jsx)(D, {
              ...
              color: `secondary`,
              idleIcon: (0, V.jsx)(F, { className: `icon-sm` }),
              isDictating: U,
              isVisible: !0,
              isTranscribing: W,
              canRetryDictation: ie,
          ...
          : (0, V.jsx)(b, {
              "aria-label": y.formatMessage(Y.sendQuickChat),
              className: `size-7 shrink-0 !bg-[#636363] !text-white enabled:hover:!bg-[#636363] disabled:opacity-100 electron:!rounded-full`,
              color: `secondary`,
              disabled: I.length === 0 || C,
              loading: C,
              size: `icon`,
              type: `submit`,
...
function ye(e) {
  let t = (0, G.c)(154),
    ...
    M;
  t[0] !== k || t[1] !== u || t[2] !== n
    ? ((M = n ?? ie({ intl: k, notification: u })), (t[0] = k), (t[1] = u), (t[2] = n), (t[3] = M))
    : (M = t[3]);
  let P = M,
    F = te(u),
    L = u.waitingRequest,
    ...
    _e = u.controlTarget != null && E != null,
    ve = u.isLoading && _e,
    ye = U || H,
    xe = L != null && `actions` in L && L.actions.length > 0,
    Se = _e && se !== void 0 && se === u.turnKey,
    ...
    Ee = v && Q,
    $ = c && !i && _e,
    De = L != null || Q || (X && (ve || L != null)),
    Ae;
  t[4] !== W || t[5] !== L
    ? ((Ae = (e) => {
        if ((he.current?.(), (he.current = void 0), e == null || L == null)) return;
        let t = () => {
          let t = Array.from(
            ...
            r = n != null && n.clientHeight > 0 && n.scrollHeight > n.clientHeight + ue;
          W((e) => (ae.current && e ? e : t || r));
        };
        (t(), (he.current = I({ axis: `both`, target: e, onChange: t })));
      }),
      (t[4] = W),
      (t[5] = L),
      (t[6] = Ae))
  ...
  (t[10] === H
    ...
    : ((Pe = () => {
      ...
      (t[11] = Pe),
      (t[12] = Fe)),
    (0, B.useLayoutEffect)(Pe, Fe));
  let Ie;
  t[13] !== Z || t[14] !== Ne || t[15] !== Ee
    ? ((Ie = () => {
        if (Ee)
          return (
            Z || Ne(`open-follow-up`),
  ...
  let Le;
  (t[17] !== Z || t[18] !== Ee
    ? ((Le = [Z, Ee]), (t[17] = Z), (t[18] = Ee), (t[19] = Le))
    : (Le = t[19]),
    (0, B.useEffect)(Ie, Le));
  let Re, ze;
  (t[20] === Se
    ...
    : ((Re = () => {
      ...
      (t[21] = Re),
      (t[22] = ze)),
    s(`avatar-overlay-keyboard-interaction-ready`, Re, ze));
  let Be = oe,
    Ve,
    He,
    Ue;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ve = () => {
      ...
      (t[24] = He),
      (t[25] = Ue))
    : ((Ve = t[23]), (He = t[24]), (Ue = t[25]));
  let We = ge ? `button` : void 0,
    Ge = ge ? P.actionAriaLabel : void 0,
    Ke = ve ? `pr-[88px]` : L == null ? `pr-[58px]` : void 0,
    qe = ge ? `cursor-interaction` : `cursor-default`,
    Je;
  t[26] !== Ke || t[27] !== qe
    ? ((Je = m(
  ...
  t[33] !== ge || t[34] !== u || t[35] !== S || t[36] !== D
    ? ((Ze = (e) => {
      ...
      (t[37] = Ze))
    : (Ze = t[37]);
  let Qe = L != null && `pr-[38px]`,
    $e = L != null && H ? `break-words whitespace-pre-wrap` : `truncate`,
    et = o ? `text-[#1A1A1A]` : `text-token-foreground`,
    tt;
  t[38] !== Qe || t[39] !== $e || t[40] !== et
    ? ((tt = m(`text-[13px] leading-[17px] font-bold`, Qe, $e, et)),
      (t[38] = Qe),
      (t[39] = $e),
      (t[40] = et),
      (t[41] = tt))
  ...
  let rt;
  t[45] !== H || t[46] !== L
    ? ((rt = L == null ? void 0 : { maxHeight: H ? le : J }),
      (t[45] = H),
      (t[46] = L),
      (t[47] = rt))
    : (rt = t[47]);
  let it = o ? `text-[#5F6B7A]` : `text-token-text-secondary`,
    at = L == null && `truncate`,
    ot = L != null && (H ? `overflow-y-auto overscroll-contain` : `overflow-hidden`),
    st;
  t[48] !== it || t[49] !== at || t[50] !== ot
    ? ((st = m(`text-[13px] leading-[17px]`, it, at, ot)),
      (t[48] = it),
      (t[49] = at),
      (t[50] = ot),
      (t[51] = st))
  ...
  t[52] === A
    ? (ct = t[53])
    : ((ct = A ? { duration: 0 } : { duration: 0.18, ease: [0.23, 1, 0.32, 1] }),
      (t[52] = A),
      (t[53] = ct));
  let lt;
  t[54] !== P.patchSummary ||
  ...
  t[61] !== L
    ...
    : (lt = t[62]);
  let ut;
  t[63] !== rt || t[64] !== st || t[65] !== ct || t[66] !== lt
    ? ((ut = (0, V.jsx)(h.div, {
        animate: rt,
        className: st,
        initial: !1,
  ...
  t[76] !== ut
    ? ((dt = (0, V.jsxs)(h.div, {
      ...
      (t[77] = dt))
    : (dt = t[77]);
  let ft = P.statusIconAriaLabel,
    pt = F.iconType,
    mt = De && `opacity-0`,
    ht;
  t[78] === mt
    ? (ht = t[79])
    : ((ht = m(`relative flex h-8 w-[31px] items-center justify-center`, mt)),
      (t[78] = mt),
      (t[79] = ht));
  let gt = L?.kind === `question` ? (0, V.jsx)(N, { className: F.iconClassName }) : ke(F),
    _t;
  t[80] !== ht || t[81] !== gt
    ? ((_t = (0, V.jsx)(`span`, { className: ht, children: gt })),
      (t[80] = ht),
      (t[81] = gt),
      (t[82] = _t))
    : (_t = t[82]);
  let vt;
  t[83] !== P.statusIconAriaLabel || t[84] !== F || t[85] !== _t
    ? ((vt = (0, V.jsx)(`span`, {
        role: `img`,
        "aria-label": ft,
    ...
    ? ((yt =
        ve && !Q
          ? (0, V.jsxs)(`div`, {
              ...
              children: [
                (0, V.jsx)(b, {
                  "aria-label": k.formatMessage(Y.replyNotification, { title: u.title }),
                  className: m(
                    pe,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: k.formatMessage(Y.replyNotification, { title: u.title }),
                  onClick: () => {
                    (q(``),
                      ce(u.turnKey),
                      Z && E?.(u, { type: `open-follow-up` }),
                      $ &&
                ...
                (0, V.jsx)(b, {
                  "aria-label": k.formatMessage(Y.stopNotification, { title: u.title }),
                  className: m(
                    pe,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: k.formatMessage(Y.stopNotification, { title: u.title }),
                  onClick: () => {
                    (q(``), ce(void 0), E?.(u, { type: `stop` }));
                  },
                  children: (0, V.jsx)(T, {
  ...
  let bt;
  t[98] !== ye ||
  t[99] !== P.collapseNotificationAriaLabel ||
  t[100] !== P.expandNotificationAriaLabel ||
  t[101] !== xe ||
  t[102] !== H ||
  t[103] !== o ||
  t[104] !== u.id ||
    ...
    ? ((bt =
        L != null && (ye || xe)
          ? (0, V.jsx)(`div`, {
              ...
              children: (0, V.jsx)(b, {
                "aria-expanded": H,
                "aria-label": H ? P.collapseNotificationAriaLabel : P.expandNotificationAriaLabel,
                className: m(
                  `size-8 !rounded-full`,
                  o
    ...
    ? ((xt =
        Q || $
          ? (0, V.jsxs)(h.form, {
              ...
              initial: i || $ ? !1 : { height: 0, marginBottom: 0, opacity: 0, y: A ? 0 : -2 },
              transition:
                i || A
                  ? { duration: 0 }
                  : {
              ...
              onSubmit: (e) => {
                ...
                let t = K.trim();
                t.length > 0 &&
                  (Z || (q(``), ce(void 0)), E?.(u, { type: `submit-follow-up`, prompt: t }));
              },
              children: [
                (0, V.jsx)(`input`, {
                  ref: me,
  ...
  let St;
  t[128] !== y || t[129] !== xt
    ? ((St = (0, V.jsx)(g, { onExitComplete: y, children: xt })),
      (t[128] = y),
      (t[129] = xt),
      (t[130] = St))
    : (St = t[130]);
  let Ct;
  t[131] !== ve ||
  t[132] !== P.dismissNotificationAriaLabel ||
  t[133] !== Q ||
  t[134] !== X ||
  t[135] !== u ||
  t[136] !== C
  ...
  switch (s.kind) {
    case `question`: {
      ...
      t[4] !== s.prompt || t[5] !== o
        ...
        : (c = t[6]);
      let l;
      t[7] === s.options ? (l = t[8]) : ((l = s.options.map(xe)), (t[7] = s.options), (t[8] = l));
      let u;
      t[9] !== i || t[10] !== a
        ? ((u = (e) => {
    ...
    case `patch`: {
      ...
      t[19] !== n || t[20] !== o || t[21] !== s.files || t[22] !== s.summary
        ? ((e = (0, V.jsx)(Z, { copy: o, files: s.files, isExpanded: n, summary: s.summary })),
          (t[19] = n),
          (t[20] = o),
          (t[21] = s.files),
          (t[22] = s.summary),
    ...
    case `exec`: {
      ...
      t[36] !== n || t[37] !== s.summary
        ? ((e = (0, V.jsx)(Ce, { isExpanded: n, text: s.summary })),
          (t[36] = n),
          (t[37] = s.summary),
          (t[38] = e))
        : (e = t[38]);
    ...
    case `network`: {
      ...
      t[46] !== n || t[47] !== s.target
        ? ((e = (0, V.jsx)(Ce, { isExpanded: n, text: s.target })),
          (t[46] = n),
          (t[47] = s.target),
          (t[48] = e))
        : (e = t[48]);
    ...
    case `tool`: {
      let e = s.summary ?? s.target,
        i;
      t[66] !== n || t[67] !== e
        ? ((i = (0, V.jsx)(Ce, { isExpanded: n, text: e })), (t[66] = n), (t[67] = e), (t[68] = i))
        : (i = t[68]);
      let a;
...
function Se(e) {
  let t = (0, G.c)(11),
    ...
    o;
  t[0] !== n || t[1] !== a.summary
    ? ((o = (0, V.jsx)(Ce, { isExpanded: n, text: a.summary })),
      (t[0] = n),
      (t[1] = a.summary),
      (t[2] = o))
    : (o = t[2]);
...
function Z(e) {
  ...
  t[20] !== o || t[21] !== s || t[22] !== c
    ...
    : (l = t[23]);
  let u;
  t[24] === r ? (u = t[25]) : ((u = r.map(Q)), (t[24] = r), (t[25] = u));
  let d;
  t[26] === u
    ? (d = t[27])
  ...
  return (
    t[0] !== n || t[1] !== r || t[2] !== i
      ? ((a = (0, V.jsx)(`div`, {
          ...
          children: [...n.filter($), ...n.filter(Ee)].map((e) =>
            (0, V.jsx)(
              b,
              {
                className: m(
...
function Oe(e) {
  return e.clientWidth > 0 && e.scrollWidth > e.clientWidth + ue;
}
function ke(e) {
  switch (e.iconType) {
    case `check-circle`:
    ...
    case `clock`:
      return (0, V.jsx)(M, { className: e.iconClassName });
    case `spinner`:
      return (0, V.jsx)(x, { Icon: H, className: `size-7` });
    case `warning`:
      return (0, V.jsx)(P, { className: e.iconClassName });
  }
}
function Ae(e, t) {
  let n = e.tray;
  if (n == null) return {};
  let r = Math.min(n.left, t.left) - fe,
    i = e.placement.startsWith(`top`),
    a = i ? n.top + n.height - fe : t.top + t.height - fe,
    o = i ? t.top + fe : n.top + fe;
  return {
    height: Math.max(0, o - a),
    left: r,
    top: a,
    width: Math.max(n.left + n.width, t.left + t.width) - r + fe,
  };
}
export { ie as n, X as t };
