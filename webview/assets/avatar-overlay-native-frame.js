...
import { An as ne, jn as V } from "./app-initial~app-main~automations-page.js";
import {
  d as re,
  f as H,
  p as U,
...
import { n as K, t as se } from "./avatar-mascot-button.js";
import {
  Jc as ce,
  Yc as q,
...
import { n as J, t as Y } from "./global-dictation-orb.js";
import {
  c as pe,
  s as me,
...
function Re(e) {
  ...
  let h;
  t[6] !== r || t[7] !== i ? ((h = He(i, r)), (t[6] = r), (t[7] = i), (t[8] = h)) : (h = t[8]);
  let g;
  t[9] !== o || t[10] !== d
    ? ((g = o ?? Fe(d)), (t[9] = o), (t[10] = d), (t[11] = g))
    : (g = t[11]);
  let _;
  t[12] !== n || t[13] !== h || t[14] !== g
    ? ((_ = (0, We.jsx)(Ve, { className: h, cornerRadius: 27, nativeSurfaceId: g, children: n })),
      (t[12] = n),
      (t[13] = h),
      (t[14] = g),
      (t[15] = _))
...
function ze(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = u({ height: 54, left: 0, top: 0, width: 345 }, i)), (t[0] = o))
    : (o = t[0]);
  let s = o,
    c;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = u({ height: 54, left: 0, top: 0, width: 345 }, a)), (t[1] = c))
    : (c = t[1]);
  let l = c,
    d;
  t[2] === r ? (d = t[3]) : ((d = f(r)), (t[2] = r), (t[3] = d));
  let p;
  t[4] === d ? (p = t[5]) : ((p = { height: d }), (t[4] = d), (t[5] = p));
  let h;
  t[6] !== n || t[7] !== r
    ? ((h =
        r > 2
    ...
    : (h = t[8]);
  let g;
  t[9] === n ? (g = t[10]) : ((g = He(n, `absolute rounded-[27px]`)), (t[9] = n), (t[10] = g));
  let _;
  t[11] === g
    ? (_ = t[12])
    : ((_ = (0, We.jsx)(`div`, {
...
function Ke({
  ...
  onMascotPointerUp: k,
  onNotificationExpansionChange: A,
  onDismissNotification: M,
  onRunNotificationControl: N,
  onRunNotificationAction: P,
  onSubmitQuestionOption: F,
  onQuickChatEditorActiveChange: I,
  onQuickChatDraftChange: L,
  onQuickChatVisibilityChange: R,
  onSubmitQuickChat: z,
  onTrayAnimationFrame: B,
  onShowActivityPills: te,
  quickChatDraft: ne,
  quickChatVisible: V,
  restrictedSurface: re,
  renderMode: U,
}) {
  let W = ee(),
    ae = U?.type === `native-surface` ? U.id : void 0,
    oe = U?.type === `native-surface` || (U?.type === `native-root` && m),
    G = U != null,
    K = (0, Q.useRef)(!1),
    ce = (0, Q.useRef)(!1),
    q = (0, Q.useRef)(null),
    ...
    J = o && de,
    Y = V ?? le,
    pe = U?.type === `native-root` && m && !J,
    me = ye(_[0]),
    he = _.length > 0,
    _e = re?.phase ?? `inactive`,
    ve = ge(re?.isSessionActive ?? !1, _e !== `inactive`),
    be = ve === `pet` ? d : { ...d, height: 121, width: 112 },
    xe = n && he,
    Se = xe || J || Y,
    Ce = _.length > 1 && c,
    we = h ?? Ce,
    Te = l.tray == null || U?.type === `native-root` ? void 0 : Math.max(0, l.tray.height),
    Ee = () => {
  ...
  let ke =
    r == null
      ? null
      : (0, $.jsx)(se, {
          ariaLabel: W.formatMessage(_t.mascotLabel, { petName: r.displayName }),
          assetRef: r.assetRef,
          notificationBadge: Oe,
          spritesheetUrl: r.spritesheetUrl,
          resizeHandle: p == null ? void 0 : { ariaLabel: W.formatMessage(_t.resizeMascot), ...p },
      ...
      children: [
        ...
        (0, $.jsx)(`div`, {
          ...
          className: H(
            ...
            Se && !pe ? `cursor-interaction` : `pointer-events-none`,
          ),
          inert: pe,
          style: {
          ...
          children: (0, $.jsxs)(`div`, {
            className: H(`relative w-max`, m && ae == null && `overflow-hidden`),
            ...
            children: [
              ...
              (0, $.jsx)(`div`, {
                children: (0, $.jsx)(qe, {
                  ...
                  trayMaxHeight: Te,
                  onDismissNotification: v === 1 || c ? M : void 0,
                  onNotificationExpansionChange: A,
                  onRunNotificationControl: N,
                  onRunNotificationAction: P,
                  onSubmitQuestionOption: F,
                  onQuickChatEditorActiveChange: (e) => {
                    ((ce.current = e), I?.(e), e ? Ee() : De());
                  },
                  onQuickChatDraftChange: L,
                  onTrayAnimationFrame: B,
...
function qe(e) {
  ...
  t[0] !== d || t[1] !== f || t[2] !== y || t[3] !== g
    ...
    : (I = t[4]);
  let L = I,
    ee = x && a == null ? `true` : void 0,
    R = x && a == null && `invisible`,
    z;
  t[5] === R
    ? (z = t[6])
    : ((z = H(`absolute top-0 left-1/2 -translate-x-1/2`, R)), (t[5] = R), (t[6] = z));
  let B = x && a == null ? !0 : void 0,
    te;
  t[7] !== a ||
  t[8] !== s ||
  t[9] !== b ||
  ...
  t[21] === te
    ? (ne = t[22])
    : ((ne = (0, $.jsx)(oe, { children: te })), (t[21] = te), (t[22] = ne));
  let V;
  t[23] !== ee || t[24] !== z || t[25] !== B || t[26] !== ne
    ? ((V = (0, $.jsx)(`div`, {
        className: `relative h-10 w-[344px] shrink-0`,
        children: (0, $.jsx)(`div`, { "aria-hidden": ee, className: z, inert: B, children: ne }),
      })),
      (t[23] = ee),
      (t[24] = z),
      (t[25] = B),
  ...
  let re = V,
    U;
  t[28] !== L || t[29] !== re
    ? ((U = (0, $.jsxs)($.Fragment, { children: [L, re] })), (t[28] = L), (t[29] = re), (t[30] = U))
    : (U = t[30]);
  let ie = U,
    W;
  t[31] === P ? (W = t[32]) : ((W = { maxHeight: P }), (t[31] = P), (t[32] = W));
  let ae = u ? ie : null,
    G;
  t[33] !== n ||
  t[34] !== r ||
...
function Je(e) {
  ...
  t[25] !== n?.[0]?.notificationListAriaLabel || t[26] !== C
    ? ((E = n?.[0]?.notificationListAriaLabel ?? C.formatMessage(_t.notificationList)),
  ...
  t[28] === D
    ? (O = t[29])
    : ((O = H(`relative w-[345px] max-w-full shrink-0`, D)), (t[28] = D), (t[29] = O));
  let k;
  t[30] !== i || t[31] !== o || t[32] !== l || t[33] !== f.length
    ? ((k =
        !o && f.length > 1 && i == null
          ? (0, $.jsx)(ze, { nativeMaterialAttached: l, notificationCount: f.length })
          : null),
      (t[30] = i),
      (t[31] = o),
      (t[32] = l),
...
function Ye(e) {
  ...
  if (
    ...
    let e = new Map(d.map(Xe)),
      L =
        d.length > 1 && (o || u)
          ? r.viewportRect.height
          : (r.slots[0]?.presentationRect.height ?? 0),
      ee;
    t[35] !== r.slots[0]?.presentationRect || t[36] !== L || t[37] !== s || t[38] !== d.length
      ? ((ee = s ? L : f(d.length, r.slots[0]?.presentationRect.height)),
    ...
    t[40] !== n?.[0]?.notificationListAriaLabel || t[41] !== T
      ? ((N = n?.[0]?.notificationListAriaLabel ?? T.formatMessage(_t.notificationList)),
        (t[40] = n?.[0]?.notificationListAriaLabel),
        (t[41] = T),
        (t[42] = N))
      : (N = t[42]);
    let z = i == null && `overflow-hidden`;
    (t[43] === z
      ? (P = t[44])
      : ((P = H(`relative w-[345px] max-w-full shrink-0`, z)), (t[43] = z), (t[44] = P)),
      (F = `notification-stack-visible-layout`),
      (I = `list`),
      t[45] === R ? (D = t[46]) : ((D = { height: R }), (t[45] = R), (t[46] = D)),
      t[47] !== o || t[48] !== g
        ? ((O =
            o && g != null
              ? (e) => {
          ...
          (t[49] = O))
        : (O = t[49]));
    let B = c ? `bottom-0` : `top-0`;
    (t[50] === B ? (E = t[51]) : ((E = H(`absolute inset-x-0`, B)), (t[50] = B), (t[51] = E)),
      (k = `true`),
      (A = `notification-stack-backing-layout`),
      t[52] === L ? (j = t[53]) : ((j = { height: L }), (t[52] = L), (t[53] = j)),
      (M = r.slots.map((t) => {
        let { itemId: s, presentationRect: c, slotId: f, zIndex: g } = t,
          T = e.get(s);
        if (T == null) return null;
        let E = n?.[d.indexOf(T)],
          D = !o && f !== `activity-slot-0`;
        ...
        return (0, $.jsx)(
          G.div,
          {
            ...
            className: H(`absolute`, D && `pointer-events-none`, O && `invisible`),
            inert: O || void 0,
            style: {
            ...
            onUpdate: v,
            children: (0, $.jsx)(Qe, {
              canExpandActivityStack: !o && f === `activity-slot-0` && d.length > 1,
              copy: E,
              isNativeMeasurementPlaceholder: u && i == null,
              isPointerSurfaceHovered: m === f,
              nativeMaterialAttached: l,
              nativePresentationOwnsMotion: u,
              nativeSurfaceId: f,
              notification: T,
              notificationFollowUp: p,
              publishesFollowUpVisibility: h,
              isExpanded: b == null ? void 0 : a.includes(T.id),
              onAnimationFrame: v,
    ...
    ((E = t[24]),
      ...
      (I = t[34]));
  let L;
  t[54] !== E || t[55] !== k || t[56] !== A || t[57] !== j || t[58] !== M
    ? ((L = (0, $.jsx)(`div`, {
        className: E,
...
function Ze({
  ...
  let m = d(te),
    ...
    I = async (e) => {
      if (!(e.length === 0 || y || f == null)) {
        (b(!0), D(null));
        try {
          (await f(e), F(``));
        } catch {
          D(h.formatMessage(_t.quickChatError));
        } finally {
          b(!1);
        }
      }
    ...
    L = r.supportState,
    {
      ...
      onStartError: (e) => {
        (m.get(P).danger(ue(h, `start`, e).message),
      ...
      onTranscribeError: (e) => {
        (m.get(P).danger(ue(h, `transcription`, e).message),
  ...
  let ie = async (e) => {
    (e.preventDefault(), e.stopPropagation(), !(z || B) && (await I(O)));
  };
  return (0, $.jsxs)(Be, {
    emptyWidth: A,
    nativeMaterialAttached: t,
    ...
    onBlurCapture: (e) => {
      ...
      (t instanceof Node && e.currentTarget.contains(t)) || ((v.current = !1), i?.(!1));
    },
    onPointerDown: () => {
      ((v.current = !0), i?.(!0));
    },
    ...
    children: [
      (0, $.jsx)(`input`, {
        ref: g,
        "aria-label": h.formatMessage(_t.quickChat),
        className: H(
        ...
        placeholder: e
          ? h.formatMessage(_t.startNewTaskPlaceholder)
          : h.formatMessage(_t.askPlaceholder),
        value: w,
        onChange: (e) => {
      ...
      (0, $.jsx)(G.div, {
        ...
        children: U
          ? (0, $.jsx)(_, {
              ...
              color: `secondary`,
              idleIcon: (0, $.jsx)(le, { className: `icon-sm` }),
              isDictating: z,
              isVisible: !0,
              isTranscribing: B,
              canRetryDictation: R,
          ...
          : (0, $.jsx)(k, {
              "aria-label": h.formatMessage(_t.sendQuickChat),
              className: `size-7 shrink-0 !bg-[#636363] !text-white enabled:hover:!bg-[#636363] disabled:opacity-100 electron:!rounded-full`,
              color: `secondary`,
              disabled: O.length === 0 || y,
              loading: y,
              size: `icon`,
              type: `submit`,
              children: y ? null : (0, $.jsx)(ce, { className: `icon-sm` }),
            }),
      }),
      T == null ? null : (0, $.jsx)(`span`, { className: `sr-only`, role: `alert`, children: T }),
    ],
  });
}
function Qe(e) {
  let t = (0, pt.c)(154),
    {
      ...
      nativeSurfaceId: u,
      notification: d,
      notificationFollowUp: f,
      publishesFollowUpVisibility: p,
      onAnimationFrame: m,
      role: g,
      onActivateNotification: _,
      onDismissNotification: v,
    ...
    T;
  t[0] !== C || t[1] !== d || t[2] !== r
    ? ((T = r ?? Ne({ intl: C, notification: d })), (t[0] = C), (t[1] = d), (t[2] = r), (t[3] = T))
    : (T = t[3]);
  let E = T,
    D = ye(d),
    O = d.waitingRequest,
    ...
    [N, P] = (0, Q.useState)(!1),
    F = (0, Q.useRef)(M),
    [I, L] = (0, Q.useState)(void 0),
    [z, B] = (0, Q.useState)(``),
    [te, ne] = (0, Q.useState)(!1),
    V = o || te,
    re = (0, Q.useRef)(null),
    U = (0, Q.useRef)(void 0),
    W = d.kind === `activity` && n && _ != null,
    K = W || (d.kind !== `activity` && (_ != null || d.action != null)),
    se = d.controlTarget != null && b != null,
    q = d.isLoading && se,
    le = N || M,
    ue = O != null && `actions` in O && O.actions.length > 0,
    de = se && I !== void 0 && I === d.turnKey,
    fe = f?.notificationId === d.id && f.turnKey === d.turnKey ? f : null,
    J = f !== void 0,
    Y = se && (J ? fe != null : de),
    pe = fe?.submissionStatus === `error`,
    he = fe?.submissionStatus === `submitting`,
    ge = p && Y,
    _e = l && !a && se,
    ve = O != null || Y || (V && (q || O != null)),
    be;
  t[4] !== P || t[5] !== O
    ? ((be = (e) => {
        if ((U.current?.(), (U.current = void 0), e == null || O == null)) return;
        let t = () => {
          let t = Array.from(
          ...
          P((e) => (F.current && e ? e : t || r));
        };
        (t(), (U.current = Ee({ axis: `both`, target: e, onChange: t })));
      }),
      (t[4] = P),
      (t[5] = O),
      (t[6] = be))
  ...
  (t[20] === de
    ...
    : ((X = () => {
      ...
      (t[21] = X),
      (t[22] = je)),
    c(`avatar-overlay-keyboard-interaction-ready`, X, je));
  let Me = Re,
    Z,
    Pe,
    Fe;
  ...
  let Ie = K ? `button` : void 0,
    Le = W ? E.expandNotificationStackAriaLabel : K ? E.actionAriaLabel : void 0,
    ze = q ? `pr-[88px]` : O == null ? `pr-[58px]` : `pr-[13px]`,
  ...
  t[29] !== K || t[30] !== d || t[31] !== _ || t[32] !== x
    ? ((Ue = () => {
      ...
      (t[34] = We))
    : ((Ue = t[33]), (We = t[34]));
  let Ge = d.kind !== `activity` && `font-bold`,
    Ke = O != null && `pr-[38px]`,
    qe = O != null && M ? `break-words whitespace-pre-wrap` : `truncate`,
    Je = d.kind === `activity` && (s ? `text-[#5F6B7A]` : `text-token-text-secondary`),
    Ye = d.kind !== `activity` && (s ? `text-[#1A1A1A]` : `text-token-foreground`),
    Xe;
  t[35] !== Ge || t[36] !== Ke || t[37] !== qe || t[38] !== Je || t[39] !== Ye
    ? ((Xe = H(`text-[13px] leading-[17px]`, Ge, Ke, qe, Je, Ye)),
      (t[35] = Ge),
      (t[36] = Ke),
      (t[37] = qe),
      (t[38] = Je),
  ...
  let Qe;
  t[44] !== M || t[45] !== O
    ? ((Qe = O == null ? void 0 : { maxHeight: M ? ht : mt }),
      (t[44] = M),
      (t[45] = O),
      (t[46] = Qe))
    : (Qe = t[46]);
  let et = d.kind === `activity` && `hidden`,
    tt = s ? `text-[#5F6B7A]` : `text-token-text-secondary`,
    nt = O == null && `truncate`,
    rt = O != null && (M ? `overflow-y-auto overscroll-contain` : `overflow-hidden`),
    it;
  t[47] !== et || t[48] !== tt || t[49] !== nt || t[50] !== rt
    ? ((it = H(`text-[13px] leading-[17px]`, et, tt, nt, rt)),
      (t[47] = et),
      (t[48] = tt),
      (t[49] = nt),
      (t[50] = rt),
  ...
  t[52] === w
    ? (at = t[53])
    : ((at = w ? { duration: 0 } : { duration: 0.18, ease: [0.23, 1, 0.32, 1] }),
      (t[52] = w),
      (t[53] = at));
  let ot;
  t[54] !== E.patchSummary ||
    ...
    ? ((ot =
        O == null
          ...
          : (0, $.jsx)($e, {
              isExpanded: M,
              nativeMaterialAttached: s,
              patchSummaryCopy: E.patchSummary,
              request: O,
  ...
  t[76] !== st
    ? ((ct = (0, $.jsxs)(G.div, {
      ...
      (t[77] = ct))
    : (ct = t[77]);
  let lt = E.statusIconAriaLabel,
    ft = D.iconType,
    vt = ve && `opacity-0`,
    yt;
  t[78] === vt
    ? (yt = t[79])
    : ((yt = H(`relative flex h-8 w-[31px] items-center justify-center`, vt)),
      (t[78] = vt),
      (t[79] = yt));
  let xt = O?.kind === `question` ? (0, $.jsx)(me, { className: D.iconClassName }) : dt(D),
    St;
  t[80] !== yt || t[81] !== xt
    ...
    : (St = t[82]);
  let Ct;
  t[83] !== E.statusIconAriaLabel || t[84] !== D || t[85] !== St
    ? ((Ct = (0, $.jsx)(`span`, {
        role: `img`,
        "aria-label": lt,
    ...
    ? ((wt =
        q && !Y
          ? (0, $.jsxs)(`div`, {
              ...
              children: [
                (0, $.jsx)(k, {
                  "aria-label": C.formatMessage(_t.replyNotification, { title: d.title }),
                  className: H(
                    bt,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: C.formatMessage(_t.replyNotification, { title: d.title }),
                  onClick: () => {
                    (B(``),
                      L(d.turnKey),
                      J && b?.(d, { type: `open-follow-up` }),
                      _e &&
                ...
                (0, $.jsx)(k, {
                  "aria-label": C.formatMessage(_t.stopNotification, { title: d.title }),
                  className: H(
                    bt,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: C.formatMessage(_t.stopNotification, { title: d.title }),
                  onClick: () => {
                    (B(``), L(void 0), b?.(d, { type: `stop` }));
                  },
                  children: (0, $.jsx)(h, {
  ...
  let Tt;
  t[98] !== le ||
  t[99] !== E.collapseNotificationAriaLabel ||
  t[100] !== E.expandNotificationAriaLabel ||
  t[101] !== ue ||
  t[102] !== M ||
  t[103] !== s ||
  t[104] !== d.id ||
    ...
    ? ((Tt =
        O != null && (le || ue)
          ? (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(k, {
                "aria-expanded": M,
                "aria-label": M ? E.collapseNotificationAriaLabel : E.expandNotificationAriaLabel,
                className: H(
                  `size-8 !rounded-full`,
                  s
                ...
                onClick: () => {
                  M && P(!0);
                  let e = !M;
                  ((F.current = e), y == null ? j(e) : y(d.id, e));
                },
                children: (0, $.jsx)(G.span, {
                  animate: { rotate: M ? 0 : -90 },
                  transition: w ? { duration: 0 } : { duration: 0.16, ease: [0.23, 1, 0.32, 1] },
                  children: (0, $.jsx)(ie, { className: `size-5` }),
                }),
              }),
            })
          : null),
    ...
    ? ((Et =
        Y || _e
          ? (0, $.jsxs)(G.form, {
              ...
              animate: { height: pe ? 56 : 40, marginBottom: 10, opacity: 1, y: 0 },
              className: H(
              ...
              initial: a || _e ? !1 : { height: 0, marginBottom: 0, opacity: 0, y: w ? 0 : -2 },
              transition:
                a || w
                  ? { duration: 0 }
                  : {
              ...
              onSubmit: (e) => {
                ...
                let t = z.trim();
                t.length > 0 &&
                  (J || (B(``), L(void 0)), b?.(d, { type: `submit-follow-up`, prompt: t }));
              },
              children: [
                (0, $.jsx)(`input`, {
                  ref: re,
  ...
  let Dt;
  t[128] !== m || t[129] !== Et
    ? ((Dt = (0, $.jsx)(oe, { onExitComplete: m, children: Et })),
      (t[128] = m),
      (t[129] = Et),
      (t[130] = Dt))
    : (Dt = t[130]);
  let Ot;
  t[131] !== q ||
  t[132] !== E.dismissNotificationAriaLabel ||
  t[133] !== Y ||
  t[134] !== V ||
  t[135] !== d ||
  t[136] !== v
    ? ((Ot =
        d.kind !== `activity` && v != null && !q && !Y
          ? (0, $.jsx)(`div`, {
              className: H(
              ...
              children: (0, $.jsx)(Te, {
                ariaLabel: E.dismissNotificationAriaLabel,
                onClick: () => {
                  v(d);
                },
              }),
  ...
  switch (s.kind) {
    case `question`: {
      let e = n ? `break-words whitespace-pre-wrap` : `truncate`,
        o;
      t[2] === e ? (o = t[3]) : ((o = H(`min-w-0 pr-[38px]`, e)), (t[2] = e), (t[3] = o));
      let c;
      t[4] !== s.prompt || t[5] !== o
        ? ((c = (0, $.jsx)(`div`, {
            className: o,
        ...
        : (c = t[6]);
      let l;
      t[7] === s.options ? (l = t[8]) : ((l = s.options.map(et)), (t[7] = s.options), (t[8] = l));
      let u;
      t[9] !== i || t[10] !== a
        ? ((u = (e) => {
    ...
    case `patch`: {
      ...
      t[19] !== n || t[20] !== o || t[21] !== s.files || t[22] !== s.summary
        ? ((e = (0, $.jsx)(rt, { copy: o, files: s.files, isExpanded: n, summary: s.summary })),
          (t[19] = n),
          (t[20] = o),
          (t[21] = s.files),
          (t[22] = s.summary),
    ...
    case `exec`: {
      ...
      t[36] !== n || t[37] !== s.summary
        ? ((e = (0, $.jsx)(nt, { isExpanded: n, text: s.summary })),
          (t[36] = n),
          (t[37] = s.summary),
          (t[38] = e))
        : (e = t[38]);
    ...
    case `network`: {
      ...
      t[46] !== n || t[47] !== s.target
        ? ((e = (0, $.jsx)(nt, { isExpanded: n, text: s.target })),
          (t[46] = n),
          (t[47] = s.target),
          (t[48] = e))
        : (e = t[48]);
...
function nt(e) {
  let t = (0, pt.c)(5),
    ...
    a;
  t[0] === i ? (a = t[1]) : ((a = H(`min-w-0 pr-[38px]`, i)), (t[0] = i), (t[1] = a));
  let o;
  return (
    t[2] !== a || t[3] !== r
      ? ((o = (0, $.jsx)(`div`, {
...
function rt(e) {
  ...
  if (!i) {
    ...
    t[6] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((o = (0, $.jsx)(ne, { className: `mx-1.5 text-token-text-tertiary` })), (t[6] = o))
      : (o = t[6]);
    let s;
...
function dt(e) {
  switch (e.iconType) {
    ...
    case `clock`:
      return (0, $.jsx)(b, { className: e.iconClassName });
    case `spinner`:
      return (0, $.jsx)(D, { Icon: je, className: `size-7` });
    case `warning`:
      return (0, $.jsx)(v, { className: e.iconClassName });
  }
}
function ft(e, t) {
  let n = e.tray;
