...
import { n as z, t as B } from "./avatar-mascot-button.js";
import {
  i as V,
  r as H,
...
import { n as K, t as q } from "./global-dictation-orb.js";
import {
  T as he,
  w as ge,
            ...
            (0, J.jsx)(`defs`, {
              children: (0, J.jsxs)(`filter`, {
                ...
                children: [
                  ...
                  (0, J.jsx)(`feOffset`, { dy: 1, in: `shadow-blur-3`, result: `shadow-offset-3` }),
                  (0, J.jsx)(`feComposite`, {
                    in: `shadow-offset-3`,
                    in2: `SourceAlpha`,
                    operator: `arithmetic`,
                  ...
                  (0, J.jsxs)(`feMerge`, {
                    children: [
                      (0, J.jsx)(`feMergeNode`, { in: `shadow-1` }),
                      (0, J.jsx)(`feMergeNode`, { in: `shadow-2` }),
                      (0, J.jsx)(`feMergeNode`, { in: `shadow-3` }),
                    ],
                  }),
                ],
              }),
...
function Fe({ intl: e, latestTurnItems: t, notification: n, notificationCount: r = 1 }) {
  let i = xe(n),
    a = e.formatMessage(i.labelMessage),
    o = (t == null ? null : ye(t, e)) ?? n.body ?? e.formatMessage(i.fallbackBodyMessage),
    s = n.waitingRequest == null ? o : we(n.waitingRequest, e),
    c = s.replace(/[.?!]+$/, ``),
    l = n.waitingRequest?.kind === `patch` ? n.waitingRequest : null;
  return {
    actionAriaLabel: `${n.title}. ${s === a ? a : `${a}. ${c}`}. ${e.formatMessage(Y.openNotification)}`,
    collapseNotificationAriaLabel: e.formatMessage(Y.collapseNotification, { title: n.title }),
    dismissNotificationAriaLabel: e.formatMessage(Y.dismissNotification, { title: n.title }),
    expandNotificationAriaLabel: e.formatMessage(Y.expandNotification, { title: n.title }),
    expandNotificationStackAriaLabel: e.formatMessage(Y.expandNotificationStack, { count: r }),
    notificationListAriaLabel: e.formatMessage(Y.notificationList),
    patchSummary:
      l == null
        ? null
        : {
            additions:
              l.additions > 0
                ? e.formatMessage(Y.compactPatchAdditions, { count: l.additions })
                : null,
            deletions:
              l.deletions > 0
                ? e.formatMessage(Y.compactPatchDeletions, { count: l.deletions })
                : null,
            fileCount: e.formatMessage(Y.compactPatchFileCount, { count: l.fileCount }),
          },
    statusIconAriaLabel:
      n.waitingRequest?.kind === `question` ? e.formatMessage(Y.questionStatusIcon) : a,
    subtitle: o,
  };
}
var Y,
...
var Re,
  ze = e(() => {
    Re = [`activity-primary`, `activity-secondary`, `activity-tertiary`];
  });
function Be(e) {
  let t = (0, Ge.c)(25),
    {
  ...
  let h;
  t[6] !== r || t[7] !== i ? ((h = We(i, r)), (t[6] = r), (t[7] = i), (t[8] = h)) : (h = t[8]);
  let g;
  t[9] !== o || t[10] !== d
    ? ((g = o ?? Le(d)), (t[9] = o), (t[10] = d), (t[11] = g))
    : (g = t[11]);
  let _;
  t[12] !== n || t[13] !== h || t[14] !== g
    ? ((_ = (0, X.jsx)(Ue, { className: h, cornerRadius: 27, nativeSurfaceId: g, children: n })),
      (t[12] = n),
      (t[13] = h),
      (t[14] = g),
      (t[15] = _))
...
function Ve(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = s({ height: 54, left: 0, top: 0, width: 345 }, i)), (t[0] = l))
    : (l = t[0]);
  let u = l,
    d;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = s({ height: 54, left: 0, top: 0, width: 345 }, c)), (t[1] = d))
    : (d = t[1]);
  let f = d,
    p;
  t[2] === r ? (p = t[3]) : ((p = a(r)), (t[2] = r), (t[3] = p));
  let m;
  ...
  t[6] !== n || t[7] !== r
    ? ((h =
        r > 2
          ? (0, X.jsx)(`div`, {
              className: We(n, `absolute rounded-[27px]`),
    ...
    : (h = t[8]);
  let g;
  t[9] === n ? (g = t[10]) : ((g = We(n, `absolute rounded-[27px]`)), (t[9] = n), (t[10] = g));
  let _;
  t[11] === g
    ? (_ = t[12])
    : ((_ = (0, X.jsx)(`div`, {
...
function He(e) {
  ...
  t[0] !== i || t[1] !== a || t[2] !== p
    ...
    : (m = t[3]);
  let h;
  t[4] === a ? (h = t[5]) : ((h = a ? void 0 : { opacity: 0 }), (t[4] = a), (t[5] = h));
  let g;
  t[6] !== r || t[7] !== i || t[8] !== a
    ? ((g = i || a ? !1 : { opacity: 0, width: r }), (t[6] = r), (t[7] = i), (t[8] = a), (t[9] = g))
    : (g = t[9]);
  let _;
  t[10] === a
    ? (_ = t[11])
  ...
  t[14] === y
    ? (b = t[15])
    : ((b = { maxWidth: `calc(100vw - 12px)`, width: y }), (t[14] = y), (t[15] = b));
  let x;
  return (
    t[16] !== n ||
    t[17] !== o ||
...
function qe({
  ...
  globalDictationOrbEnabled: o = !1,
  interactiveRegionRef: s,
  isNotificationTrayOpen: c = !0,
  layout: l,
  mascotDragState: u,
  mascotLayout: d = l.mascot,
  mascotStyle: f,
  ...
  notifications: _,
  notificationStackItemCount: y = _.length,
  ...
  onDismissNotification: te,
  onRunNotificationControl: N,
  onRunNotificationAction: ne,
  onSubmitQuestionOption: P,
  onQuickChatEditorActiveChange: F,
  onQuickChatDraftChange: I,
  onQuickChatVisibilityChange: L,
  onSubmitQuickChat: R,
  onTrayAnimationFrame: z,
  onShowActivityPills: V,
  quickChatDraft: H,
  quickChatVisible: ie,
  restrictedSurface: ae,
  renderMode: oe,
}) {
  let U = re(),
    se = oe?.type === `native-surface` ? oe.id : void 0,
    ce = oe?.type === `native-surface` || (oe?.type === `native-root` && m),
    le = oe != null,
    W = (0, Z.useRef)(!1),
    ue = (0, Z.useRef)(!1),
    G = (0, Z.useRef)(null),
    ...
    K = o && pe,
    q = ie ?? de,
    he = oe?.type === `native-root` && m && !K,
    ge = xe(_[0]),
    _e = _.length > 0,
    ye = ae?.phase ?? `inactive`,
    be = ve(ae?.isSessionActive ?? !1, ye !== `inactive`),
    Se = be === `pet` ? d : { ...d, height: 121, width: 112 },
    Ce = n && _e,
    we = Ce || K || q,
    Te = _.length > 1 && c,
    Ee = h ?? Te,
    De = l.tray == null || oe?.type === `native-root` ? void 0 : Math.max(0, l.tray.height),
    Oe = () => {
  ...
  (0, Z.useEffect)(
    () => (
      (W.current = !1),
      () => {
        ((W.current = !0), G.current != null && window.clearTimeout(G.current));
      }
    ),
    [],
  );
  ...
  let je =
    r == null
      ? null
      : (0, Q.jsx)(B, {
          ariaLabel: U.formatMessage($.mascotLabel, { petName: r.displayName }),
          assetRef: r.assetRef,
          notificationBadge: Ae,
          spritesheetUrl: r.spritesheetUrl,
          resizeHandle: p == null ? void 0 : { ariaLabel: U.formatMessage($.resizeMascot), ...p },
    ...
    children: (0, Q.jsxs)(`section`, {
      ...
      children: [
        ...
        (0, Q.jsx)(`div`, {
          ...
          "data-avatar-overlay-hit-region": we ? `notification-tray` : void 0,
          className: M(
            `absolute text-sm text-token-foreground`,
            we && !he ? `cursor-interaction` : `pointer-events-none`,
          ),
          inert: he,
          style: {
          ...
          onPointerEnter: se == null ? Oe : void 0,
          onPointerLeave: se == null ? ke : void 0,
          children: (0, Q.jsxs)(`div`, {
            className: M(`relative w-max`, m && se == null && `overflow-hidden`),
            ...
            children: [
              ...
              (0, Q.jsx)(`div`, {
                children: (0, Q.jsx)(Je, {
                  ...
                  isQuickChatVisible: q,
                  isNotificationTrayExpanded: Ee,
                  isNotificationTrayVisiblyExpanded: Te,
                  isTrayAboveMascot: l.placement.startsWith(`top`),
                  isGlobalDictationEnabled: o,
                  isGlobalDictationVisible: K,
                  compositionSurfaceId: se,
                  nativeMaterialAttached: m,
                  nativePresentationOwnsMotion: ce,
                  usesStableBackingCanvases: le,
                  notifications: _,
                  notificationFollowUp: b,
                  expandedNotificationIds: a,
                  pointerSurfaceId: x,
                  ...
                  trayMaxHeight: De,
                  onDismissNotification: y === 1 || c ? te : void 0,
                  onNotificationExpansionChange: ee,
                  onRunNotificationControl: N,
                  onRunNotificationAction: ne,
                  onSubmitQuestionOption: P,
                  onQuickChatEditorActiveChange: (e) => {
                    ((ue.current = e), F?.(e), e ? Oe() : ke());
                  },
                  onQuickChatDraftChange: I,
                  onTrayAnimationFrame: z,
                  onQuickChatPointerEnter: Oe,
          ...
          ? (0, Q.jsx)(`div`, {
              ...
              children: (0, Q.jsx)(v, {
                ...
                children: (0, Q.jsx)(`div`, {
                  "data-avatar-overlay-hit-region": be === `hidden` ? void 0 : `mascot`,
...
function Je(e) {
  let t = (0, mt.c)(61),
    {
      ...
      isGlobalDictationVisible: f,
      notifications: p,
      notificationFollowUp: m,
      pointerSurfaceId: h,
      quickChatDictation: g,
      onActivityStackScroll: _,
      onActivateNotification: v,
      onGlobalDictationVisibilityChange: y,
      nativeMaterialAttached: b,
      nativePresentationOwnsMotion: x,
      usesStableBackingCanvases: S,
      ...
      onSubmitQuickChat: te,
      trayMaxHeight: N,
      quickChatDraft: P,
    } = e,
    F;
  t[0] !== d || t[1] !== f || t[2] !== y || t[3] !== g
    ? ((F = d
        ? (0, Q.jsx)(`div`, {
            className: M(
            ...
            "data-avatar-overlay-measure": `notification-tray-row`,
            children: (0, Q.jsx)(q, {
              cleanupEnabled: g.cleanupEnabled,
              streamingEnabled: g.streamingEnabled,
    ...
    : (F = t[4]);
  let I = F,
    L = x && a == null ? `true` : void 0,
    re = x && a == null && `invisible`,
    R;
  t[5] === re
    ? (R = t[6])
    : ((R = M(`absolute top-0 left-1/2 -translate-x-1/2`, re)), (t[5] = re), (t[6] = R));
  let z = x && a == null ? !0 : void 0,
    B;
  t[7] !== a ||
  t[8] !== s ||
  t[9] !== b ||
  ...
  t[19] !== P
    ...
    : (B = t[20]);
  let V;
  t[21] === B ? (V = t[22]) : ((V = (0, Q.jsx)(ne, { children: B })), (t[21] = B), (t[22] = V));
  let H;
  t[23] !== L || t[24] !== R || t[25] !== z || t[26] !== V
    ? ((H = (0, Q.jsx)(`div`, {
        className: `relative h-10 w-[344px] shrink-0`,
        children: (0, Q.jsx)(`div`, { "aria-hidden": L, className: R, inert: z, children: V }),
      })),
      (t[23] = L),
      (t[24] = R),
      (t[25] = z),
  ...
  let ie = H,
    ae;
  t[28] !== I || t[29] !== ie
    ? ((ae = (0, Q.jsxs)(Q.Fragment, { children: [I, ie] })),
      (t[28] = I),
      (t[29] = ie),
      (t[30] = ae))
    : (ae = t[30]);
  let oe = ae,
    U;
  t[31] === N ? (U = t[32]) : ((U = { maxHeight: N }), (t[31] = N), (t[32] = U));
  let se = u ? oe : null,
    ce;
  t[33] !== n ||
  t[34] !== r ||
  ...
  let le = u ? null : oe,
    W;
  return (
    t[56] !== U || t[57] !== se || t[58] !== ce || t[59] !== le
      ? ((W = (0, Q.jsxs)(`div`, {
...
function Ye(e) {
  let t = (0, mt.c)(78),
    {
      ...
      usesStableBackingCanvases: d,
      notifications: f,
      notificationFollowUp: p,
      pointerSurfaceId: m,
      onActivityStackScroll: h,
      onActivateNotification: g,
      onAnimationFrame: _,
      onDismissNotification: v,
      onNotificationExpansionChange: y,
  ...
  t[0] === u
    ? (w = t[1])
    : ((w = u ? { duration: 0 } : { duration: 0.18, ease: [0.16, 1, 0.3, 1] }),
      (t[0] = u),
      (t[1] = w));
  let T = w;
  if (r != null) {
  ...
  let E;
  t[25] !== n?.[0]?.notificationListAriaLabel || t[26] !== C
    ? ((E = n?.[0]?.notificationListAriaLabel ?? C.formatMessage($.notificationList)),
      (t[25] = n?.[0]?.notificationListAriaLabel),
      (t[26] = C),
      (t[27] = E))
    : (E = t[27]);
  let D = o ? `flex flex-col gap-2` : `pb-2`,
    O;
  t[28] === D
    ? (O = t[29])
    : ((O = M(`relative w-[345px] max-w-full shrink-0`, D)), (t[28] = D), (t[29] = O));
  let k;
  t[30] !== i || t[31] !== o || t[32] !== l || t[33] !== f.length
    ? ((k =
        !o && f.length > 1 && i == null
          ? (0, Q.jsx)(Ve, { nativeMaterialAttached: l, notificationCount: f.length })
          : null),
      (t[30] = i),
      (t[31] = o),
      (t[32] = l),
    ...
    t[71] !== d
      ? ((e = (e, t) => {
          let r = Re[t],
            ...
            c = !o && s === `secondary`,
            h = (u && i == null) || (d && i == null && c) || (i != null && i !== r);
          if (c && !d) return null;
          let C = `relative z-10`;
          return (
            s === `primary`
              ? (C = `relative z-20`)
              : c && (C = `pointer-events-none absolute top-0 right-0 left-0 z-10`),
            (0, Q.jsx)(
              ee.div,
              {
                layout: !u,
                "aria-hidden": h || c ? `true` : void 0,
                "data-avatar-overlay-backing-canvas": c ? `true` : void 0,
                className: M(C, h && `invisible`),
                inert: h || void 0,
                transition: T,
                onUpdate: _,
                children: (0, Q.jsx)($e, {
                  canExpandActivityStack: !o && s === `primary` && f.length > 1,
                  copy: n?.[t],
                  isNativeMeasurementPlaceholder: u && i == null,
                  isPointerSurfaceHovered: m === r,
                  nativeMaterialAttached: l,
                  nativePresentationOwnsMotion: u,
                  nativeSurfaceId: r,
                  notification: e,
                  notificationFollowUp: p,
                  publishesFollowUpVisibility: i != null || !d,
                  isExpanded: y == null ? void 0 : a.includes(e.id),
                  onAnimationFrame: _,
                  role: s,
                  onActivateNotification: g,
                  onDismissNotification: v,
...
function Xe(e) {
  let t = (0, mt.c)(68),
    {
      ...
      onNotificationExpansionChange: b,
  ...
  if (
    ...
    let e = new Map(f.map(Ze)),
      I =
        f.length > 1 && (s || d)
          ? r.viewportRect.height
          : (r.slots[0]?.presentationRect.height ?? 0),
      L;
    t[35] !== r.slots[0]?.presentationRect || t[36] !== I || t[37] !== c || t[38] !== f.length
      ? ((L = c ? I : a(f.length, r.slots[0]?.presentationRect.height)),
      ...
      : (L = t[39]);
    let re = L;
    t[40] !== n?.[0]?.notificationListAriaLabel || t[41] !== T
      ? ((N = n?.[0]?.notificationListAriaLabel ?? T.formatMessage($.notificationList)),
        (t[40] = n?.[0]?.notificationListAriaLabel),
        (t[41] = T),
        (t[42] = N))
      : (N = t[42]);
    let R = i == null && `overflow-hidden`;
    (t[43] === R
      ? (ne = t[44])
      : ((ne = M(`relative w-[345px] max-w-full shrink-0`, R)), (t[43] = R), (t[44] = ne)),
      (P = `notification-stack-visible-layout`),
      (F = `list`),
      t[45] === re ? (D = t[46]) : ((D = { height: re }), (t[45] = re), (t[46] = D)),
      t[47] !== s || t[48] !== g
        ? ((O =
            s && g != null
              ? (e) => {
          ...
          (t[49] = O))
        : (O = t[49]));
    let z = l ? `bottom-0` : `top-0`;
    (t[50] === z ? (E = t[51]) : ((E = M(`absolute inset-x-0`, z)), (t[50] = z), (t[51] = E)),
      (k = `true`),
      (A = `notification-stack-backing-layout`),
      t[52] === I ? (j = t[53]) : ((j = { height: I }), (t[52] = I), (t[53] = j)),
      (te = r.slots.map((t) => {
        let { itemId: a, presentationRect: c, slotId: l, zIndex: g } = t,
          T = e.get(a);
        if (T == null) return null;
        let E = n?.[f.indexOf(T)],
          D = !s && l !== `activity-slot-0`;
        ...
        return (0, Q.jsx)(
          ee.div,
          {
            ...
            className: M(`absolute`, D && `pointer-events-none`, O && `invisible`),
            inert: O || void 0,
            style: {
              left: c.left - r.viewportRect.left,
              top: c.top - r.viewportRect.top,
              width: c.width,
              zIndex: g,
            },
            transition: w,
            onUpdate: v,
            children: (0, Q.jsx)($e, {
              canExpandActivityStack: !s && l === `activity-slot-0` && f.length > 1,
              copy: E,
              isNativeMeasurementPlaceholder: d && i == null,
              isPointerSurfaceHovered: m === l,
              nativeMaterialAttached: u,
              nativePresentationOwnsMotion: d,
              nativeSurfaceId: l,
              notification: T,
              notificationFollowUp: p,
              publishesFollowUpVisibility: h,
              isExpanded: b == null ? void 0 : o.includes(T.id),
              onAnimationFrame: v,
              role: l === `activity-slot-0` ? `primary` : `secondary`,
              onActivateNotification: _,
              onDismissNotification: y,
              onExpansionChange: b,
              onRunNotificationControl: x,
    ...
    ((E = t[24]),
      ...
      (F = t[34]));
  let I;
  t[54] !== E || t[55] !== k || t[56] !== A || t[57] !== j || t[58] !== te
    ? ((I = (0, Q.jsx)(`div`, {
        className: E,
        "data-avatar-overlay-backing-canvas": k,
        "data-avatar-overlay-size": A,
        style: j,
        children: te,
      })),
      (t[54] = E),
...
function Qe({
  ...
  nativePresentationOwnsMotion: r,
  ...
  let m = c(i),
    ...
    F = async (e) => {
      if (!(e.length === 0 || b || f == null)) {
        ...
        try {
          ...
          D(h.formatMessage($.quickChatError));
        } finally {
          x(!1);
        }
      }
    ...
    I = a.supportState,
    {
      ...
      onTranscriptInsert: (e) => {
        let t = O(w, e);
        t !== w && (P(t), _.current?.focus());
      },
      onTranscriptSend: (e) => {
        let t = O(w, e);
        (P(t), F(t.trim()));
      },
      getSurroundingText: () => w,
      onStartError: (e) => {
        (m.get(A).danger(de(h, `start`, e).message),
          n.error(`[AvatarOverlay] unable to start dictation`, {
            safe: {},
            sensitive: { error: e },
          }));
      },
      onTranscribeError: (e) => {
        (m.get(A).danger(de(h, `transcription`, e).message),
          n.error(`[AvatarOverlay] dictation failed`, { safe: {}, sensitive: { error: e } }));
      },
      onUnsupported: () => {
        m.get(A).danger(
          h.formatMessage({
  ...
  let ae = async (e) => {
    (e.preventDefault(), e.stopPropagation(), !(R || z) && (await F(k)));
  };
  return (0, Q.jsxs)(He, {
    emptyWidth: j,
    nativeMaterialAttached: t,
    ...
    onBlurCapture: (e) => {
      ...
      (t instanceof Node && e.currentTarget.contains(t)) || ((v.current = !1), o?.(!1));
    },
    onPointerDown: () => {
      ((v.current = !0), o?.(!0));
    },
    ...
    children: [
      (0, Q.jsx)(`input`, {
        ref: _,
        "aria-label": h.formatMessage($.quickChat),
        className: M(
        ...
        placeholder: e
          ? h.formatMessage($.startNewTaskPlaceholder)
          : h.formatMessage($.askPlaceholder),
        value: w,
        onChange: (e) => {
      ...
      (0, Q.jsx)(ee.div, {
        ...
        children: ie
          ? (0, Q.jsx)(oe, {
              ...
              color: `secondary`,
              idleIcon: (0, Q.jsx)(me, { className: `icon-sm` }),
              isDictating: R,
              isVisible: !0,
              isTranscribing: z,
              canRetryDictation: L,
          ...
          : (0, Q.jsx)(E, {
              "aria-label": h.formatMessage($.sendQuickChat),
              className: `size-7 shrink-0 !bg-[#636363] !text-white enabled:hover:!bg-[#636363] disabled:opacity-100 electron:!rounded-full`,
              color: `secondary`,
              ...
              size: `icon`,
              type: `submit`,
              children: b ? null : (0, Q.jsx)(y, { className: `icon-sm` }),
            }),
      }),
      T == null ? null : (0, Q.jsx)(`span`, { className: `sr-only`, role: `alert`, children: T }),
    ],
  });
}
function $e(e) {
  let t = (0, mt.c)(154),
    {
      ...
      isPointerSurfaceHovered: o,
      nativeMaterialAttached: s,
      nativePresentationOwnsMotion: c,
      nativeSurfaceId: l,
      notification: u,
      notificationFollowUp: d,
      publishesFollowUpVisibility: f,
      onAnimationFrame: p,
      role: m,
      onActivateNotification: h,
    ...
    D;
  t[0] !== C || t[1] !== u || t[2] !== r
    ? ((D = r ?? Fe({ intl: C, notification: u })), (t[0] = C), (t[1] = u), (t[2] = r), (t[3] = D))
    : (D = t[3]);
  let O = D,
    A = xe(u),
    j = u.waitingRequest,
    ...
    [F, I] = (0, Z.useState)(!1),
    L = (0, Z.useRef)(P),
    [z, B] = (0, Z.useState)(void 0),
    [V, H] = (0, Z.useState)(``),
    [ae, oe] = (0, Z.useState)(!1),
    U = o || ae,
    se = (0, Z.useRef)(null),
    ce = (0, Z.useRef)(void 0),
    le = u.kind === `activity` && n && h != null,
    W = le || (u.kind !== `activity` && (h != null || u.action != null)),
    ue = u.controlTarget != null && b != null,
    G = u.isLoading && ue,
    de = F || P,
    fe = j != null && `actions` in j && j.actions.length > 0,
    pe = ue && z !== void 0 && z === u.turnKey,
    me = d?.notificationId === u.id && d.turnKey === u.turnKey ? d : null,
    K = d !== void 0,
    q = ue && (K ? me != null : pe),
    he = me?.submissionStatus === `error`,
    _e = me?.submissionStatus === `submitting`,
    ve = f && q,
    ye = c && !a && ue,
    be = j != null || q || (U && (G || j != null)),
    Se;
  t[4] !== I || t[5] !== j
    ? ((Se = (e) => {
        if ((ce.current?.(), (ce.current = void 0), e == null || j == null)) return;
        let t = () => {
          let t = Array.from(
            ...
            r = n != null && n.clientHeight > 0 && n.scrollHeight > n.clientHeight + _t;
          I((e) => (L.current && e ? e : t || r));
        };
        (t(), (ce.current = Oe({ axis: `both`, target: e, onChange: t })));
      }),
      (t[4] = I),
      (t[5] = j),
      (t[6] = Se))
  ...
  (t[10] === P
    ...
    : ((Ee = () => {
      ...
      (t[11] = Ee),
      (t[12] = ke)),
    (0, Z.useLayoutEffect)(Ee, ke));
  let Ae;
  t[13] !== K || t[14] !== Te || t[15] !== ve
    ? ((Ae = () => {
        if (ve)
          return (
            K || Te(`open-follow-up`),
  ...
  let Me;
  (t[17] !== K || t[18] !== ve
    ? ((Me = [K, ve]), (t[17] = K), (t[18] = ve), (t[19] = Me))
    : (Me = t[19]),
    (0, Z.useEffect)(Ae, Me));
  let J, Ne;
  (t[20] === pe
    ...
    : ((J = () => {
      ...
      (t[21] = J),
      (t[22] = Ne)),
    g(`avatar-overlay-keyboard-interaction-ready`, J, Ne));
  let Pe = Be,
    Y,
    Ie,
    Le;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Y = () => {
      ...
      (t[24] = Ie),
      (t[25] = Le))
    : ((Y = t[23]), (Ie = t[24]), (Le = t[25]));
  let Re = W ? `button` : void 0,
    ze = le ? O.expandNotificationStackAriaLabel : W ? O.actionAriaLabel : void 0,
    Ve = G ? `pr-[88px]` : j == null ? `pr-[58px]` : `pr-[13px]`,
    He = W ? `cursor-interaction` : `cursor-default`,
    Ue;
  t[26] !== Ve || t[27] !== He
    ? ((Ue = M(
  ...
  t[29] !== W || t[30] !== u || t[31] !== h || t[32] !== x
    ? ((Ge = () => {
      ...
      (t[34] = X))
    : ((Ge = t[33]), (X = t[34]));
  let Ke = u.kind !== `activity` && `font-bold`,
    qe = j != null && `pr-[38px]`,
    Je = j != null && P ? `break-words whitespace-pre-wrap` : `truncate`,
    Ye = u.kind === `activity` && (s ? `text-[#5F6B7A]` : `text-token-text-secondary`),
    Xe = u.kind !== `activity` && (s ? `text-[#1A1A1A]` : `text-token-foreground`),
    Ze;
  t[35] !== Ke || t[36] !== qe || t[37] !== Je || t[38] !== Ye || t[39] !== Xe
    ? ((Ze = M(`text-[13px] leading-[17px]`, Ke, qe, Je, Ye, Xe)),
      (t[35] = Ke),
      (t[36] = qe),
      (t[37] = Je),
      (t[38] = Ye),
  ...
  let $e;
  t[44] !== P || t[45] !== j
    ? (($e = j == null ? void 0 : { maxHeight: P ? gt : ht }),
      (t[44] = P),
      (t[45] = j),
      (t[46] = $e))
    : ($e = t[46]);
  let tt = u.kind === `activity` && `hidden`,
    nt = s ? `text-[#5F6B7A]` : `text-token-text-secondary`,
    rt = j == null && `truncate`,
    it = j != null && (P ? `overflow-y-auto overscroll-contain` : `overflow-hidden`),
    at;
  t[47] !== tt || t[48] !== nt || t[49] !== rt || t[50] !== it
    ? ((at = M(`text-[13px] leading-[17px]`, tt, nt, rt, it)),
      (t[47] = tt),
      (t[48] = nt),
      (t[49] = rt),
      (t[50] = it),
  ...
  t[52] === w
    ? (ot = t[53])
    : ((ot = w ? { duration: 0 } : { duration: 0.18, ease: [0.23, 1, 0.32, 1] }),
      (t[52] = w),
      (t[53] = ot));
  let st;
  t[54] !== O.patchSummary ||
  ...
  t[61] !== j
    ? ((st =
        j == null
          ...
          : (0, Q.jsx)(et, {
              isExpanded: P,
              nativeMaterialAttached: s,
              patchSummaryCopy: O.patchSummary,
              request: j,
    ...
    : (st = t[62]);
  let ct;
  t[63] !== $e || t[64] !== at || t[65] !== ot || t[66] !== st
    ? ((ct = (0, Q.jsx)(ee.div, {
        animate: $e,
        className: at,
        initial: !1,
  ...
  t[76] !== ct
    ? ((lt = (0, Q.jsxs)(ee.div, {
      ...
      (t[77] = lt))
    : (lt = t[77]);
  let ut = O.statusIconAriaLabel,
    pt = A.iconType,
    vt = be && `opacity-0`,
    yt;
  t[78] === vt
    ? (yt = t[79])
    : ((yt = M(`relative flex h-8 w-[31px] items-center justify-center`, vt)),
      (t[78] = vt),
      (t[79] = yt));
  let xt = j?.kind === `question` ? (0, Q.jsx)(ge, { className: A.iconClassName }) : ft(A),
    St;
  t[80] !== yt || t[81] !== xt
    ? ((St = (0, Q.jsx)(`span`, { className: yt, children: xt })),
      (t[80] = yt),
      (t[81] = xt),
      (t[82] = St))
    : (St = t[82]);
  let Ct;
  t[83] !== O.statusIconAriaLabel || t[84] !== A || t[85] !== St
    ? ((Ct = (0, Q.jsx)(`span`, {
        role: `img`,
        "aria-label": ut,
        className: `pointer-events-none absolute top-3 right-[13px] flex h-8 w-[31px] items-center justify-center`,
        "data-avatar-overlay-status": pt,
        children: St,
      })),
      (t[83] = O.statusIconAriaLabel),
      (t[84] = A),
      (t[85] = St),
      (t[86] = Ct))
    : (Ct = t[86]);
    ...
    ? ((wt =
        G && !q
          ? (0, Q.jsxs)(`div`, {
              ...
              children: [
                (0, Q.jsx)(E, {
                  "aria-label": C.formatMessage($.replyNotification, { title: u.title }),
                  className: M(
                    bt,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: C.formatMessage($.replyNotification, { title: u.title }),
                  onClick: () => {
                    (H(``),
                      B(u.turnKey),
                      K && b?.(u, { type: `open-follow-up` }),
                      ye &&
                ...
                (0, Q.jsx)(E, {
                  "aria-label": C.formatMessage($.stopNotification, { title: u.title }),
                  className: M(
                    bt,
                  ...
                  color: `ghost`,
                  size: `icon`,
                  title: C.formatMessage($.stopNotification, { title: u.title }),
                  onClick: () => {
                    (H(``), B(void 0), b?.(u, { type: `stop` }));
                  },
                  children: (0, Q.jsx)(ie, {
  ...
  let Tt;
  t[98] !== de ||
  t[99] !== O.collapseNotificationAriaLabel ||
  t[100] !== O.expandNotificationAriaLabel ||
  t[101] !== fe ||
  t[102] !== P ||
  t[103] !== s ||
  t[104] !== u.id ||
    ...
    ? ((Tt =
        j != null && (de || fe)
          ? (0, Q.jsx)(`div`, {
              ...
              children: (0, Q.jsx)(E, {
                "aria-expanded": P,
                "aria-label": P ? O.collapseNotificationAriaLabel : O.expandNotificationAriaLabel,
                className: M(
                  `size-8 !rounded-full`,
                  s
                ...
                onClick: () => {
                  P && I(!0);
                  let e = !P;
                  ((L.current = e), v == null ? N(e) : v(u.id, e));
                },
                children: (0, Q.jsx)(ee.span, {
                  animate: { rotate: P ? 0 : -90 },
                  transition: w ? { duration: 0 } : { duration: 0.16, ease: [0.23, 1, 0.32, 1] },
  ...
  t[126] !== B
    ? ((Et =
        q || ye
          ? (0, Q.jsxs)(ee.form, {
              "aria-hidden": ye && !q ? !0 : void 0,
              animate: { height: he ? 56 : 40, marginBottom: 10, opacity: 1, y: 0 },
              className: M(
                ...
                s ? `bg-white` : `bg-token-main-surface-primary`,
              ),
              exit: a ? void 0 : { height: 0, marginBottom: 0, opacity: 0, y: w ? 0 : -2 },
              initial: a || ye ? !1 : { height: 0, marginBottom: 0, opacity: 0, y: w ? 0 : -2 },
              transition:
                a || w
                  ? { duration: 0 }
                  : {
              ...
              onSubmit: (e) => {
                ...
                let t = V.trim();
                t.length > 0 &&
                  (K || (H(``), B(void 0)), b?.(u, { type: `submit-follow-up`, prompt: t }));
              },
              children: [
                (0, Q.jsx)(`input`, {
                  ref: se,
                  ...
                  "data-avatar-overlay-composition-autofocus": pe ? `true` : void 0,
                ...
                (0, Q.jsx)(E, {
                  ...
                  color: `secondary`,
                  disabled: V.trim().length === 0 || _e,
                  loading: _e,
                  size: `icon`,
                  type: `submit`,
                  children: (0, Q.jsx)(y, { className: `icon-sm` }),
                }),
                he
                  ? (0, Q.jsx)(`div`, {
  ...
  let Dt;
  t[128] !== p || t[129] !== Et
    ? ((Dt = (0, Q.jsx)(ne, { onExitComplete: p, children: Et })),
      (t[128] = p),
      (t[129] = Et),
      (t[130] = Dt))
    : (Dt = t[130]);
  let Ot;
  t[131] !== G ||
  t[132] !== O.dismissNotificationAriaLabel ||
  t[133] !== q ||
  t[134] !== U ||
  t[135] !== u ||
  t[136] !== _
    ? ((Ot =
        u.kind !== `activity` && _ != null && !G && !q
          ? (0, Q.jsx)(`div`, {
              className: M(
              ...
              children: (0, Q.jsx)(De, {
                ariaLabel: O.dismissNotificationAriaLabel,
                onClick: () => {
                  _(u);
                },
              }),
  ...
  switch (s.kind) {
    case `question`: {
      let e = n ? `break-words whitespace-pre-wrap` : `truncate`,
        o;
      t[2] === e ? (o = t[3]) : ((o = M(`min-w-0 pr-[38px]`, e)), (t[2] = e), (t[3] = o));
      let c;
      t[4] !== s.prompt || t[5] !== o
        ? ((c = (0, Q.jsx)(`div`, {
            className: o,
        ...
        : (c = t[6]);
      let l;
      t[7] === s.options ? (l = t[8]) : ((l = s.options.map(tt)), (t[7] = s.options), (t[8] = l));
      let u;
      t[9] !== i || t[10] !== a
        ? ((u = (e) => {
    ...
    case `patch`: {
      ...
      t[19] !== n || t[20] !== o || t[21] !== s.files || t[22] !== s.summary
        ? ((e = (0, Q.jsx)(it, { copy: o, files: s.files, isExpanded: n, summary: s.summary })),
          (t[19] = n),
          (t[20] = o),
          (t[21] = s.files),
          (t[22] = s.summary),
    ...
    case `exec`: {
      ...
      t[36] !== n || t[37] !== s.summary
        ? ((e = (0, Q.jsx)(rt, { isExpanded: n, text: s.summary })),
          (t[36] = n),
          (t[37] = s.summary),
          (t[38] = e))
        : (e = t[38]);
    ...
    case `network`: {
      ...
      t[46] !== n || t[47] !== s.target
        ? ((e = (0, Q.jsx)(rt, { isExpanded: n, text: s.target })),
          (t[46] = n),
          (t[47] = s.target),
          (t[48] = e))
        : (e = t[48]);
    ...
    case `tool`: {
      let e = s.summary ?? s.target,
        i;
      t[66] !== n || t[67] !== e
        ? ((i = (0, Q.jsx)(rt, { isExpanded: n, text: e })), (t[66] = n), (t[67] = e), (t[68] = i))
        : (i = t[68]);
      let a;
...
function nt(e) {
  let t = (0, mt.c)(11),
    ...
    o;
  t[0] !== n || t[1] !== a.summary
    ? ((o = (0, Q.jsx)(rt, { isExpanded: n, text: a.summary })),
      (t[0] = n),
      (t[1] = a.summary),
      (t[2] = o))
    : (o = t[2]);
...
function it(e) {
  ...
  if (!i) {
    ...
    t[0] === n.fileCount
      ? (e = t[1])
      : ((e = (0, Q.jsx)(`span`, { children: n.fileCount })), (t[0] = n.fileCount), (t[1] = e));
    let r;
    t[2] === n.additions
      ? (r = t[3])
      : ((r =
    ...
    t[6] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((o = (0, Q.jsx)(H, { className: `mx-1.5 text-token-text-tertiary` })), (t[6] = o))
      : (o = t[6]);
    let s;
    t[7] === a ? (s = t[8]) : ((s = (0, Q.jsx)(`span`, { children: a })), (t[7] = a), (t[8] = s));
    let c;
    return (
  ...
  t[14] === n.fileCount
    ? (o = t[15])
    : ((o = (0, Q.jsx)(`span`, { className: `text-[11px] leading-4`, children: n.fileCount })),
      (t[14] = n.fileCount),
      (t[15] = o));
  let s;
  t[16] === n.additions
  ...
  t[20] !== o || t[21] !== s || t[22] !== c
    ...
    : (l = t[23]);
  let u;
  t[24] === r ? (u = t[25]) : ((u = r.map(at)), (t[24] = r), (t[25] = u));
  let d;
  t[26] === u
    ? (d = t[27])
    : ((d = (0, Q.jsx)(`div`, { className: `mt-0.5 min-w-0 space-y-0.5`, children: u })),
      (t[26] = u),
      (t[27] = d));
  let f;
  return (
  ...
  return (
    t[0] !== n || t[1] !== r || t[2] !== i
      ? ((a = (0, Q.jsx)(`div`, {
          ...
          children: [...n.filter(lt), ...n.filter(ct)].map((e) =>
            (0, Q.jsx)(
              E,
              {
                className: M(
...
function dt(e) {
  return e.clientWidth > 0 && e.scrollWidth > e.clientWidth + _t;
}
function ft(e) {
  switch (e.iconType) {
    case `check-circle`:
    ...
    case `clock`:
      return (0, Q.jsx)(U, { className: e.iconClassName });
    case `spinner`:
      return (0, Q.jsx)(x, { Icon: Ne, className: `size-7` });
    case `warning`:
      return (0, Q.jsx)(W, { className: e.iconClassName });
  }
}
function pt(e, t) {
  let n = e.tray;
...
export { Ie as i, xt as n, Fe as r, qe as t };
