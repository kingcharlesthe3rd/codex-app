...
import { Xs as r, Ys as i } from "./app-initial~app-main~onboarding-page.js";
import {
  M as a,
  j as o,
...
function d(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, p.jsx)(o, { className: `icon-sm text-token-text-secondary` })), (t[3] = w))
    : (w = t[3]);
  let T;
  t[4] !== r || t[5] !== u
    ? ((T = (0, p.jsx)(`label`, { className: `sr-only`, htmlFor: r, children: u })),
      (t[4] = r),
      (t[5] = u),
      (t[6] = T))
    : (T = t[6]);
...
//# sourceMappingURL=page-search-input-a2-XgvYV.js.map
