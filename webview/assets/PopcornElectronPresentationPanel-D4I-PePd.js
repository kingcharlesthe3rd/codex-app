...
import { t as v } from "./PopcornPageNumberNavigation-C.js";
...
function Tt(e) {
  let t = Q({
    ...
    n = E(e.camera, e.viewportX, e.viewportY);
...
function _n({
  ...
  let Ge = (0, F.useRef)(null),
    ...
    } = de(m?.annotation?.handleRef, { onDismissAnnotation: B, onDismissAllAnnotations: Je }),
    ...
    { drawings: ht, addPendingDrawing: gt } = fe(m?.drawing?.handleRef),
  ...
  let vt = (0, F.useCallback)(() => {
    ...
    wt = (e = `saved`) => {
      ...
      (ct(n),
        e === `direct`
          ? (m?.annotation?.onDirectSubmit ?? m?.annotation?.onSubmit)?.(n)
          : m?.annotation?.onSubmit?.(n),
        Z());
    },
    Tt = () => {
  ...
  let Et = (t) => {
      ((ve.current = t ? { x: Math.round(t.x), y: Math.round(t.y) } : null),
    ...
    Dt = (t) => {
      ...
      if ((Et(n), O && d)) {
        ...
        (Tn(t, y),
          ...
          Ye({ color: pe, strokeWidth: 3, points: [n] }),
          t.preventDefault(),
          t.stopPropagation());
        return;
      }
      ...
      if (!m) {
        if (((S.current = null), (C.current = null), (le.current = !1), r)) return;
        (Tn(t, y),
          (b.current = `marquee`),
          (x.current = null),
    ...
    Ot = (t) => {
      ...
      if (D && l) {
        ...
        Le(!0);
        let i = en(_.selectedSlideElementTargets, n, V.k);
        (e.setHoveredElementId(i), (t.currentTarget.style.cursor = Ne.current ? `` : De));
        return;
      }
      if (b.current === `text`) {
        n && Y.pointerMove(n);
      ...
      if (b.current === `element` && n) {
        (C.current && Math.hypot(n.x - C.current.x, n.y - C.current.y) > mn && (le.current = !0),
    ...
    kt = (t, n) => {
      ...
      if (D && l) {
        ...
        if (!s) return;
        ((M.current = !1), A({ mode: `create`, target: s, body: `` }));
        return;
      }
      if (y.current != null && y.current !== t.pointerId) return;
      let r = b.current;
      ...
      b.current = null;
      let i = S.current,
        a = !!n && !le.current && !!i && _.textLayoutBlocks.some((e) => e.id === i);
      ((S.current = null),
        (C.current = null),
        (le.current = !1),
      ...
      children: [
        ...
        Nt && Ze && q
          ? (0, L.jsx)(he, {
              ...
              onClick: () => {
                ((M.current = !1), A({ mode: `create`, target: q, body: `` }));
              },
            })
          : null,
        J
...
function vn(e, t) {
  ...
  return i.length > 0 && i !== `transparent` && i !== `rgba(0, 0, 0, 0)` ? i : Te(t);
}
function yn(e) {
  let t = e.trim();
...
function Qn({
  ...
  if (!w) return null;
  let T = Pt(w),
    { panels: de, stageOverlays: fe } = (0, F.useMemo)(() => mt(t), [t]),
    pe = ae && _?.annotation?.enabled !== !1,
    [me, he] = (0, F.useState)(!1),
    ge = x && _?.drawing?.enabled !== !1,
    [_e, ye] = (0, F.useState)(!1),
    [be, xe] = (0, F.useState)(0),
    Se = (0, F.useMemo)(() => new On(), []);
  ((0, F.useEffect)(() => {
    pe || he(!1);
  }, [pe]),
    (0, F.useEffect)(() => {
    ...
    (0, F.useEffect)(() => {
      !me || !pe || (w.clearElementSelection(), w.setHoveredElementId(null));
    }, [pe, me, w]),
    (0, F.useEffect)(() => {
      !_e || !ge || (w.clearElementSelection(), w.setHoveredElementId(null));
    }, [w, ge, _e]),
    (0, F.useEffect)(() => {
      if (!me) return;
      let e = (e) => {
  ...
  let [Ce, Te] = (0, F.useState)(() =>
      Object.fromEntries(de.map((e) => [e.id, e.defaultOpen ?? !1])),
    ),
    [Ee, De] = (0, F.useState)(kn),
    [Oe, ke] = (0, F.useState)(() => Object.fromEntries(T.slideIds.map((e) => [e, null]))),
    [E, D] = (0, F.useState)(() => Object.fromEntries(T.slideIds.map((e) => [e, null]))),
    [O, Ae] = (0, F.useState)(() => T.slideIds),
    [k, A] = (0, F.useState)(null),
    [Me, j] = (0, F.useState)(!1),
    ...
    K = !re && N && Ee > 0,
    Xe = (0, F.useMemo)(
      () => ({ left: G ? An : 0, top: 0, right: 0, bottom: K ? Xn(Ee, h) : 0 }),
      [Ee, K, G, h],
    );
  ((0, F.useEffect)(() => {
  ...
  let q = (0, F.useMemo)(
      () => Object.fromEntries(T.slideIds.map((e, t) => [e, T.slideLabels[t] ?? `Slide ${t + 1}`])),
      [T.slideIds, T.slideLabels],
    ),
    Qe = (0, F.useMemo)(() => Object.fromEntries(T.slideIds.map((e, t) => [e, t])), [T.slideIds]),
    $e = T.slideIds[T.selectedSlideIdx] ?? null,
    J = T.fitScale ?? (T.slideRect && T.zoom > 0 ? T.slideRect.scale / T.zoom : null),
    et = J ? X(J) : null,
    tt = T.slideRect?.scale ?? X(J ? J * T.zoom : T.zoom),
    nt = et != null && Math.abs(T.zoom - 1) < Nn,
    rt = H && (!M || Ie),
    it = !rt,
    at = W && !rt,
    ot = (e) => {
    ...
    gt = (0, F.useCallback)(
      async (e, t) => {
        ...
        if (
          ...
          try {
            await We();
            let t = await w.requestSlideThumbnail(e, r ? { cssMaxPx: Fn } : void 0);
            (r ? D : ke)((e) => (e[n] === t ? e : { ...e, [n]: t }));
          } finally {
            R.current.delete(a);
          }
        }
  ...
  ((0, F.useEffect)(() => {
    ...
    (e && (R.current.delete(`rail:${e}`), R.current.delete(`stacked-page:${e}`)),
      gt(T.selectedSlideIdx, { force: !0 }),
      e &&
        Ke.current[e] != null &&
        gt(T.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [gt, T.presentationVersion, T.selectedSlideIdx, T.slideIds]),
    (0, F.useEffect)(() => {
    ...
    }, [gt, T.presentationVersion, T.slideCount]));
  let _t = (0, F.useCallback)(
    ...
    yt = (0, F.useCallback)(
      (e) => {
        ...
        let r = qe.current,
          i = r.indexOf(t),
          a = r.indexOf(n);
        i < 0 || a < 0 || i === a || (Ae((e) => Zn(e, i, a)), w.moveSlide(i, a));
      },
      [w],
    ),
    ...
    $ = (0, F.useCallback)(
      ...
      [k, ht, ut, O, Je, vt, yt, Y, ft, g, dt, d, $e, lt, z, Qe, q, Oe],
    );
  return (0, L.jsx)(`div`, {
    className: r(
                    ...
                    children: [
                      (0, L.jsx)(`div`, {
                        ...
                        children: (0, L.jsx)(_n, {
                          ...
                          viewportInsets: Xe,
                          annotationMode: me,
                          onAnnotationModeChange: he,
                          drawingMode: _e,
                          onDrawingModeChange: ye,
                          drawingCommitToken: be,
                          reviewTools: _,
                          onHyperlinkClick: ie,
                          annotationsEnabled: ae,
                          drawingAnnotationsEnabled: x,
                          commentThreadsEnabled: ue,
...
function or({
  ...
  let se = Pe({ initialCrdtState: o, externalCrdtUpdates: t }),
    ce = (0, F.useRef)(s),
    y = ne(
      void 0,
      () =>
        new ft({
          initialCrdtState: se.initialCrdtState,
          initialSelectedSlideIdx: c,
          initialZoom: l,
    ...
    x = Le({
      ...
      controller: y,
      externalCrdtUpdates: se.externalCrdtUpdates,
      onCrdtUpdate: u,
    }),
    S = (0, F.useMemo)(() => lr(d), [d]),
    C = (0, F.useMemo)(() => ur(S), [S]);
  return (
    (0, F.useEffect)(() => {
      y && ce.current !== s && ((ce.current = s), y.replaceFromProto(s ?? sr().toProto()));
    }, [y, s]),
    (0, F.useEffect)(() => {
      if (y && f)
        return y.subscribeImageHydrationRequests((e) => {
          let t = b.current + 1;
          ((b.current = t),
            f(e)
              .then((e) => {
                if (!(b.current !== t || e.length === 0)) return y.hydrateImageAssets(e);
              })
              .catch(() => {}));
        });
    }, [y, f]),
      ...
      ? (0, L.jsxs)(`section`, {
          ...
          children: [
            (0, L.jsx)(Qn, {
              ...
              headerRightContent:
                S.length > 0
                  ? (0, L.jsxs)(L.Fragment, { children: [(0, L.jsx)(cr, { count: S.length }), n] })
                  : n,
              renderHeaderZoomControl: a,
              zoomToFitLabel: i,
...
//# sourceMappingURL=PopcornElectronPresentationPanel-D4I-PePd.js.map
