...
import { o as S, v as C } from "./vscode-api.js";
import { Aa as w, Da as T, Mr as E, Ta as D, ja as O, la as k, wa as A, xa as j } from "./src-1.js";
import { t as M } from "./preload-helper.js";
import { t as ee } from "./react-dom.js";
import { l as N, s as P } from "./lib-1.js";
import { t as F } from "./clsx.js";
import { t as I } from "./button.js";
import { t as L } from "./spinner.js";
import { n as R } from "./window-zoom-context.js";
import { t as z } from "./chevron-right.js";
import { t as te } from "./badge.js";
import { o as B } from "./statsig.js";
import { t as V } from "./request.js";
import { c as ne } from "./katex-1.js";
import { m as re } from "./chunk-13.js";
import { C as ie, _ as ae, b as H, g as U, r as W, w as G, x as K } from "./parse-directives.js";
import { t as oe } from "./persisted-signal.js";
import { t as se } from "./mime-types.js";
import { A as q, D as J, O as ce, k as le, s as ue } from "./mention-item.js";
import { t as de } from "./use-is-dark.js";
import { t as fe } from "./error-boundary-DOI-M2iu.js";
import { i as pe } from "./get-file-icon.js";
...
import { c as Te } from "./external-link.js";
import { t as Ee } from "./checkbox.js";
import { t as De } from "./chat.js";
import { t as Oe } from "./copy-button.js";
import { t as ke } from "./image-preview-dialog.js";
import { t as Ae } from "./external-markdown-link.js";
import { t as je } from "./code-snippet.js";
import { t as Me } from "./mermaid-diagram-shell-BO-t9BGx.js";
import { t as Ne } from "./hash-code.js";
var Pe = new Set([`auto`, `clip`, `hidden`, `overlay`, `scroll`]),
  Fe = `data-selected-text-overlay-target`,
  Ie = `[${Fe}]`;
function Le({
  ...
  if (a == null || a.rangeCount === 0 || a.isCollapsed || a.toString().trim().length === 0)
    return null;
  let o = ze(a, a.getRangeAt(0), r);
  if (o == null || (n != null && !n.contains(o.target))) return null;
  let s = he(o.range)?.trim() ?? o.range.toString().trim();
  ...
  return {
    ...
    selectedText: s,
    target: o.target,
    targetId: o.target.getAttribute(Fe),
  };
}
function Re(e, t) {
  return (
...
function ze(e, t, n) {
  let r = Be(e.anchorNode, e.anchorOffset, n),
    i = Be(e.focusNode, e.focusOffset, n);
  if (r != null && i != null && r.target !== i.target) return null;
  let a = r ?? i;
  return a == null ? null : { ...a, range: He(t, a.target) };
}
function Be(e, t, n) {
  let r = Ve(e),
    i = r?.closest(n);
...
function Ue(e, t, n, r) {
  ...
  let a = Array.from(e.getClientRects()),
    ...
    s = Ge(a, i);
  if (s != null && (a.length > 1 || Ke(s, o) != null)) return s;
  let c = Ke(e.getBoundingClientRect(), i);
  return c != null && Ke(c, o) != null
    ? c
    : (Ge(Array.from(t.getClientRects()), i) ??
        Ke(o, i) ??
        Ge(Array.from(n.getClientRects()), i) ??
        Ke(n.getBoundingClientRect(), i));
}
function We(e, t) {
  let n = {
  ...
  for (; r != null && r !== document.body && r !== document.documentElement; ) {
    let e = window.getComputedStyle(r),
      t = (e.overflowX || e.overflow).split(/\s+/).some((e) => Pe.has(e)),
      i = (e.overflowY || e.overflow).split(/\s+/).some((e) => Pe.has(e));
    if (t || i) {
...
function Ye(e) {
      ...
      ? ((g = () => {
          let e = a == null ? void 0 : (o?.querySelector(a) ?? void 0),
            ...
            i = () => {
              ...
              Re(p.current, t) || ((p.current = t), h(t));
            },
            s = () => {
              (r(),
  ...
  let v = m.portalTarget == null ? `fixed z-30` : `absolute z-[1]`,
    y;
  t[7] !== i || t[8] !== v
    ? ((y = F(`pointer-events-none -translate-x-1/2 -translate-y-full`, v, i)),
      (t[7] = i),
      (t[8] = v),
      (t[9] = y))
    : (y = t[9]);
  ...
  return (
    t[20] !== w || t[21] !== T
      ? ((E = (0, qe.createPortal)(w, T)), (t[20] = w), (t[21] = T), (t[22] = E))
      : (E = t[22]),
    E
  );
}
var Xe = /&(#(?:\d+|x[\da-fA-F]+)|[a-zA-Z][a-zA-Z0-9]+);/g,
  Ze = { amp: `&`, apos: `'`, gt: `>`, lt: `<`, nbsp: `\xA0`, quot: `"` };
function Qe(e) {
  return e.includes(`&`) ? e.replace(Xe, (e, t) => $e(e, t)) : e;
}
function $e(e, t) {
  return t.startsWith(`#`) ? et(e, t) : (Ze[t] ?? Ze[t.toLowerCase()] ?? e);
}
function et(e, t) {
...
var tt = /^(https?|ircs?|mailto|xmpp|codex)$/i,
  nt = /^data:(?:image|video)\//i;
function rt(e) {
  let t = H(e),
    n = K(G(e));
  return n || t != null || ce(e) || q(e) || J(e) || le(e) || ue(e) != null
    ? n
      ? e
      : (t ?? e)
    : at(e);
...
function it(e) {
  let t = H(e);
  return nt.test(e) || t != null ? (t ?? e) : at(e);
}
function at(e) {
  let t = e.indexOf(`:`),
    n = e.indexOf(`?`),
...
var ot = `data-markdown-raw-link-label`;
function st(e, t) {
...
function mt(e, t, n) {
  let r = n.components?.a ?? `a`,
    i = Qe(e.text),
    a = e.title == null ? void 0 : Qe(e.title);
  return (0, Q.jsx)(
    r,
    { [ot]: i, href: rt(Qe(e.href)), title: a, children: n.renderInlineTokens(e.tokens, t, !1) },
    t,
  );
}
function ht(e, t, n) {
  let r = n.components?.img ?? `img`,
    i = e.title == null ? void 0 : Qe(e.title);
  return (0, Q.jsx)(r, { alt: Qe(e.text), src: it(Qe(e.href)), title: i }, t);
}
function gt(e, t, n) {
  return (0, Q.jsx)(
    n.components?.pre ?? `pre`,
    {
      children: (0, Q.jsx)(n.components?.code ?? `code`, {
        className: F(e.lang && `language-${e.lang}`),
        inline: !1,
  ...
  return (0, Q.jsx)(
    `span`,
    {
      dangerouslySetInnerHTML: {
        __html: ne.renderToString(e.text, {
...
var yt = oe(`markdownCodeBlockWordWrap`, !1),
  bt = (0, Z.lazy)(async () => {
    let { MermaidDiagramRenderer: e } = await M(
      async () => {
        let { MermaidDiagramRenderer: e } = await import(`./mermaid-diagram.js`);
...
function xt(e) {
  ...
  return (
    t[0] === e
      ? (n = t[1])
      : ((n = (0, Q.jsx)(Me, { ...e, Renderer: bt })), (t[0] = e), (t[1] = n)),
    n
  );
}
function St(e) {
...
var wt = /(^|\s)(#[\da-fA-F]{6})(?!\w)/g,
  Tt = /\b(?:issue|pr)\W*$/i;
function Et(e, t = ``) {
  let n = [];
  for (let r of e.matchAll(wt)) {
    let i = r.index + r[1].length,
      a = `${t}${e.slice(0, i)}`;
    (a.length > 0 && !/\s$/.test(a)) || Tt.test(a) || n.push({ content: r[2], index: i });
  }
  return n.length === 0 ? null : n;
}
function Dt({ content: e, key: t }) {
  return (0, Q.jsxs)(Z.Fragment, { children: [e, Ot({ content: e })] }, t);
}
function Ot({ content: e, key: t }) {
  return (0, Q.jsx)(
    `span`,
    {
      "aria-hidden": !0,
...
var At = [
    ...
    { getMatches: Et, render: Dt },
  ],
  jt = [{ matches: kt, render: Ot }];
function Mt(e) {
  let t = At.flatMap(
...
function Nt({ content: e, inlineCode: t, precedingText: n }) {
  let r = jt.filter(({ matches: t }) => t(e, n));
  return r.length === 0
    ? t
    : (0, Q.jsxs)(Q.Fragment, {
        children: [
...
function Ft({
  ...
  let l = (0, Q.jsx)(
    `span`,
    {
      ...
      className: F(`inline-markdown`, Y.inlineMarkdown, e),
      children: t,
    },
    a,
  );
  ...
  if (u != null && ie(u))
    return (0, Q.jsx)(
      ge,
      { className: e, reference: G(u), cwd: n, hostId: i, onOpen: o, openInSidePanel: s },
      a,
    );
  let d = Lt(t);
  if (d != null) {
  ...
  return ve(t)
    ...
    : Nt({ content: t, inlineCode: l, precedingText: c });
}
function It(e) {
...
function Rt(e) {
  let t = (0, X.c)(30),
    ...
    u = It(o),
    d = i && u ? `always` : u ? `user-controlled` : `off`;
  if (l && u) {
    let e;
    t[0] !== r || t[1] !== s
      ? ((e = () =>
          (0, Q.jsx)(St, { className: Y.codeBlock, content: r, onAddSelectedTextToChat: s })),
        (t[0] = r),
        (t[1] = s),
        (t[2] = e))
      : (e = t[2]);
  ...
  if (
    ...
    let e = n && Y.wideBlock,
      i;
    t[8] === e ? (i = t[9]) : ((i = F(Y.codeBlock, e)), (t[8] = e), (t[9] = i));
    let s = n ? `mermaid` : void 0,
      l;
    t[10] !== n || t[11] !== r || t[12] !== a
      ? ((l = () =>
          (0, Q.jsx)(xt, {
            className: F(Y.codeBlock, n && Y.wideBlock),
            code: r,
            isCodeFenceOpen: a,
            fallback: (0, Q.jsx)(je, {
    ...
    let u;
    return (
      t[14] !== r || t[15] !== o || t[16] !== c || t[17] !== i || t[18] !== s || t[19] !== l
        ? ((u = (0, Q.jsx)(Bt, {
            className: i,
            content: r,
            language: o,
  ...
  let p;
  return (
    t[25] !== r || t[26] !== o || t[27] !== c || t[28] !== f
      ? ((p = (0, Q.jsx)(Bt, { content: r, language: o, renderImmediately: c, renderVisible: f })),
        (t[25] = r),
        (t[26] = o),
        (t[27] = c),
        (t[28] = f),
...
function zt(e) {
  ...
  return (
    t[7] !== r || t[8] !== l || t[9] !== u
      ? ((d = (0, Q.jsx)(je, { ...r, shouldWrapCode: l, onToggleWrapCode: u })),
        (t[7] = r),
        (t[8] = l),
        (t[9] = u),
        (t[10] = d))
...
function Bt(e) {
  ...
  if (t[0] !== e) {
    ...
    ((n = r ? i.renderVisible() : (0, Q.jsx)(Vt, { ...i })), (t[0] = e), (t[1] = n));
  } else n = t[1];
  return n;
}
function Vt(e) {
  ...
  let d;
  t[5] === n ? (d = t[6]) : ((d = F(Y.codeBlock, n)), (t[5] = n), (t[6] = d));
...
function Ut(e) {
  ...
  t[2] === i
    ...
    : ((c = (e) => {
        ...
        if (t == null) return;
        let n = ye(t);
        n != null && we({ "text/plain": i, "text/html": n.htmlText }, e);
      }),
      (t[2] = i),
      (t[3] = c));
  let l = c,
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = F(Y.tableWrapper, `group relative`)), (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] === r ? (d = t[6]) : ((d = F(r, Y.table)), (t[5] = r), (t[6] = d));
  let f;
  t[7] !== n || t[8] !== d
    ? ((f = (0, Q.jsx)(`table`, { className: d, children: n })), (t[7] = n), (t[8] = d), (t[9] = f))
    : (f = t[9]);
  let p;
  t[10] !== s || t[11] !== l
    ? ((p = (0, Q.jsx)(`div`, {
...
var Wt = e(se(), 1),
  Gt = /^data:(?:image|video)\//i,
  Kt = `img.shields.io`,
  qt = `/badge/`;
function Jt(e) {
  return !Gt.test(e) && !E(e) ? `image` : (Yt(e)?.startsWith(`video/`) ?? !1) ? `video` : `image`;
}
function Yt(e) {
...
function Xt(e) {
  ...
  return t.protocol !== `https:` || t.hostname !== Kt || !t.pathname.startsWith(qt)
    ? null
...
function Qt({ contentsBase64: e, mimeType: t, path: n }) {
  return `data:${t ?? Yt(n) ?? `application/octet-stream`};base64,${e}`;
}
function $t(e) {
  return e.startsWith(`//`) ? !0 : en(e);
}
function en(e) {
  let t;
  try {
...
var tn = new Set([`openai.com`, `chatgpt.com`, `chat.com`]),
  nn = 500;
function rn(e, t) {
  let n = (0, X.c)(3),
    r = sn(e, nn),
...
function on(e, t) {
  let n = (0, X.c)(15),
    r = e == null,
    i;
  n[0] !== r || n[1] !== e ? ((i = !r && an(e)), (n[0] = r), (n[1] = e), (n[2] = i)) : (i = n[2]);
  let a = i,
    o,
    s;
  n[3] === e
    ...
    : ((o = [`markdown-safe-url`, e]),
      (s = async () => {
        ...
        return V.safePost(`/ecosystem/url_safe`, {
...
var cn = `my-3 block h-auto rounded-md object-contain shadow-md`,
  ln = F(cn, `border border-token-border`),
  un = `max-h-[12.5rem] max-w-[12.5rem]`,
  dn = `max-h-[10rem] w-auto max-w-full`,
  fn = `data-markdown-image-preview-trigger`;
function pn(e) {
  let t = (0, X.c)(80),
    {
      allowWide: n,
    ...
    T = Xt(x),
    E;
  t[0] === x ? (E = t[1]) : ((E = Jt(x)), (t[0] = x), (t[1] = E));
  let D = E,
    O = D === `video`,
    k;
  t[2] === x ? (k = t[3]) : ((k = x.startsWith(`//`)), (t[2] = x), (t[3] = k));
  let A = C != null && !k,
    j = rn(x, T == null && w && D === `image` && !A && en(x)),
    M = T == null && w && !A && $t(x) && j.safeUrl == null && !j.isPending,
    ee = A && O ? me(C) : null,
    P = !O && A,
    { data: I, isLoading: L } = S(`read-file-binary`, {
      params: { path: P ? (C ?? x) : ``, hostId: o },
      queryConfig: {
        cacheKey:
  ...
  let R = I?.contentsBase64 ?? null,
    z =
      j.safeUrl ??
      ee ??
      (P && R != null ? Qt({ contentsBase64: R, mimeType: I?.mimeType ?? null, path: C ?? x }) : x),
    B = r ?? ``,
    V = A && !O,
    ne = A && O && ee == null,
    re = M || (P && R == null && !L) || y === z,
    ...
    ae = ie?.src ?? z,
    U = ie?.alt ?? B,
    W = _ != null && _.index > 0 ? _.index - 1 : null,
    G = _ != null && _.index + 1 < _.items.length ? _.index + 1 : null,
    K;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (e) => {
  ...
  t[17] !== m || t[18] !== B
    ...
    : (pe = t[19]);
  let he = pe;
  if ((P && L && R == null) || j.isPending) {
    if (c !== `scrollable`) return null;
    let e = O ? q : he,
      n;
    return (
      t[20] !== f || t[21] !== c || t[22] !== V || t[23] !== e || t[24] !== d
        ? ((n = (0, Q.jsx)(mn, {
            allowWide: f,
            isLoading: !0,
            label: e,
  ...
  if (ne || re) {
    let e = O ? ce : fe,
      n;
    return (
      t[26] !== f || t[27] !== c || t[28] !== V || t[29] !== e || t[30] !== d
        ? ((n = (0, Q.jsx)(mn, {
            allowWide: f,
            label: e,
            mediaPresentation: c,
  ...
  if (O) {
    let e = f
      ...
      n;
    t[32] !== a || t[33] !== e
      ? ((n = F(cn, e, a)), (t[32] = a), (t[33] = e), (t[34] = n))
      : (n = t[34]);
    let r;
    t[35] === z
      ? (r = t[36])
    ...
    let i;
    return (
      t[37] !== z || t[38] !== n || t[39] !== r || t[40] !== d || t[41] !== q
        ? ((i = (0, Q.jsx)(`video`, {
            className: n,
            src: z,
            title: d,
  ...
  t[47] === ve
    ? (ye = t[48])
    : ((ye = F(`cursor-zoom-in border-0 bg-transparent p-0 align-top`, ve)),
      (t[47] = ve),
      (t[48] = ye));
  let be;
  ...
  t[50] !== B || t[51] !== z || t[52] !== l
    ? ((xe = (e) => {
        v(hn({ fallbackItem: { src: z, alt: B }, root: l.current, trigger: e.currentTarget }));
      }),
      (t[50] = B),
      (t[51] = z),
      (t[52] = l),
    ...
    : (xe = t[53]);
  let Se;
  t[54] !== f || t[55] !== p || t[56] !== a || t[57] !== c || t[58] !== V
    ? ((Se = F(
        ln,
        c === `scrollable` ? `max-h-none !max-w-none w-auto` : f && V ? dn : [un, `h-auto w-auto`],
        p && Y.imageEnter,
        a,
      )),
      (t[54] = f),
  ...
  t[60] === z
    ...
    : ((Ce = () => {
      ...
      (t[61] = Ce));
  let we;
  t[62] !== B || t[63] !== z || t[64] !== Se || t[65] !== Ce || t[66] !== d
    ? ((we = (0, Q.jsx)(`img`, {
        className: Se,
        src: z,
        alt: B,
    ...
    : (we = t[67]);
  let Te;
  t[68] !== ue || t[69] !== ye || t[70] !== xe || t[71] !== we
    ? ((Te = (0, Q.jsx)(`button`, {
        type: `button`,
        className: ye,
        "aria-label": ue,
  ...
  let Ee;
  return (
    t[73] !== h || t[74] !== U || t[75] !== ae || t[76] !== ge || t[77] !== _e || t[78] !== Te
      ? ((Ee = (0, Q.jsx)(ke, {
          src: ae,
          alt: U,
          open: h,
...
function mn(e) {
  ...
  t[2] === c
    ? (d = t[3])
    : ((d = c ? (0, Q.jsx)(L, { className: `icon-md` }) : (0, Q.jsx)(pe, { className: `icon-lg` })),
      (t[2] = c),
      (t[3] = d));
  let f;
  return (
...
function hn({ fallbackItem: e, root: t, trigger: n }) {
  let r = t == null ? [] : Array.from(t.querySelectorAll(`[${fn}="true"]`)),
    i = [],
    a = null;
  for (let e of r) {
...
function vn(e, t) {
  ...
  let n = Z.Children.toArray(e).filter(
    (e) => !((typeof e == `string` && gn.test(e)) || ((0, Z.isValidElement)(e) && e.type === `br`)),
  );
...
function yn({
  ...
  let u = {
    ...
    pre: Z.Fragment,
    p({ children: t }) {
      let n = e ? vn(t, u.img) : null;
      if (n != null && n.length > 1 && n.every((e) => Jt(e.props.src ?? ``) === `image`))
        return (0, Q.jsx)(`p`, {
          className: F(l, Y.paragraph, Y.mediaParagraph, Y.mediaGridParagraph),
      ...
      if (n != null && n.length === 1) {
        let [e] = n,
          ...
          r = t === `image`;
        return (0, Q.jsx)(`p`, {
          className: F(l, Y.paragraph, Y.mediaParagraph, r && Y.mediaWideBlock),
      ...
      return (0, Q.jsx)(`p`, { className: F(l, Y.paragraph), children: t });
    },
    h1({ children: e }) {
      return (0, Q.jsx)(`h1`, { className: F(Y.heading, Y.heading1), children: e });
    },
    h2({ children: e }) {
      return (0, Q.jsx)(`h2`, { className: F(Y.heading, Y.heading2), children: e });
    },
    h3({ children: e }) {
      return (0, Q.jsx)(`h3`, { className: F(Y.heading, Y.heading3), children: e });
    },
    h4({ children: e }) {
      return (0, Q.jsx)(`h4`, { className: F(Y.heading, Y.heading4), children: e });
    },
    h5({ children: e }) {
      return (0, Q.jsx)(`h5`, { className: F(Y.heading, Y.heading5), children: e });
    },
    h6({ children: e }) {
      return (0, Q.jsx)(`h6`, { className: F(Y.heading, Y.heading6), children: e });
    },
    ul({ children: e, className: t }) {
      let n = t?.includes(`contains-task-list`) ?? !1;
      return (0, Q.jsx)(`ul`, {
        className: F(l, Y.list, n ? Y.taskList : Y.unorderedList, t),
        children: e,
      });
    },
    ol({ children: e, className: t, start: n }) {
      return (t?.includes(`contains-task-list`) ?? !1) && Sn(e)
        ? (0, Q.jsx)(`ol`, { className: F(l, Y.list, Y.taskList, t), children: e })
        : (0, Q.jsx)(`ol`, { className: F(l, Y.list, Y.orderedList, t), start: n, children: e });
    },
    li({ children: e, className: t }) {
      let n = t?.includes(`task-list-item`) ?? !1;
      return (0, Q.jsx)(`li`, { className: F(l, Y.listItem, n && Y.taskListItem, t), children: e });
    },
    a: xn({
      conversationId: null,
      cwd: n,
    ...
    blockquote({ children: e }) {
      return (0, Q.jsx)(`blockquote`, { className: F(l, Y.blockquote), children: e });
    },
    hr() {
      return (0, Q.jsx)(`hr`, { className: Y.horizontalRule });
    },
    table({ children: e, markdownSource: t }) {
      return (0, Q.jsx)(Ut, { className: l, markdownSource: t, children: e });
    },
    thead({ children: e }) {
    ...
    th({ children: e }) {
      return (0, Q.jsx)(`th`, {
        className: F(Y.tableHeaderCell, Z.Children.count(e) === 1 && Y.singleChildTableCell),
        children: e,
      });
    },
    td({ children: e }) {
      return (0, Q.jsx)(`td`, {
        className: F(Y.tableCell, Z.Children.count(e) === 1 && Y.singleChildTableCell),
        children: e,
      });
    },
  };
...
function xn({
  ...
  return function ({ href: o, children: s, [ot]: c }) {
    let l = typeof c == `string` ? c.trim() : _n(s).trim();
    if (o != null) {
      let e = _e({
        cwd: t ?? null,
        hostId: n,
...
function On(e, t, n) {
  ...
  return r == null
    ? (0, Q.jsx)(`table`, { children: l }, t)
    : (0, Q.jsx)(r, { markdownSource: e.raw.trim(), children: l }, t);
}
var kn = new Set([
    `blockquote`,
    `br`,
  ...
  return {
    ...
    renderInlineTokens(e, t, n = this.decorateText) {
      ...
      if (r.allowBasicHtml !== !0) {
        for (let [n, o] of e.entries()) i.push(...$n(Pn(o, Fn(o, t, a), r, Qn(e, n))));
        return i;
      }
      return Mn(e, t, r);
    },
...
function Mn(e, t, n) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    let o = e[a],
      s = Fn(o, t, i),
      c = n.allowBasicHtml === !0 ? Un(o) : null,
      l = c == null ? null : Wn(e, a + 1, c);
    if (c != null && l != null) {
      let t = e.slice(a + 1, l);
      (r.push(Hn(c, Mn(t, s, n), s, t)), (a = l));
      continue;
    }
    r.push(...$n(Pn(o, s, n, Qn(e, a))));
  }
  return r;
}
function Nn(e, t) {
  let n = [],
    r = new Map();
  for (let i of e) n.push(...$n(Pn(i, Fn(i, `root`, r), t)));
  return n;
}
function Pn(e, t, n, r = ``) {
  if (Jn(e)) return Cn(e, t, n);
  if (Yn(e)) return vt(e, t);
  if (!Xn(e)) return `raw` in e && typeof e.raw == `string` ? e.raw : ``;
  switch (e.type) {
    case `space`:
      return null;
    case `hr`:
    ...
    case `table`:
      return On(e, t, n);
    case `html`:
      return Vn(e.raw, t, n.allowBasicHtml === !0);
    case `def`:
      return null;
  }
}
...
function In(e) {
  return Jn(e)
    ? `directive-${e.name}-${Ne(Ln(e))}`
    : Yn(e)
      ? `math-${e.display ? `block` : `inline`}-${Ne(Bn(e.text))}`
      : Xn(e)
        ? `${e.type}-${Ne(Rn(e))}`
        : `token-${e.type}-${Ne(zn(e))}`;
}
function Ln(e) {
...
`,
  ...
  return (n.match(/\S+/)?.[0] ?? n).slice(0, An);
}
function Vn(e, t, n) {
...
function Hn(e, t, n, r) {
  switch (e) {
    ...
    case `sub`:
      return Kn(r) ? (0, Q.jsx)(`span`, { children: t }, n) : (0, Q.jsx)(`sub`, { children: t }, n);
    case `sup`:
...
function Gn(e, t) {
  return Zn(e) && e.raw.trim().toLowerCase() === `</${t}>`;
}
function Kn(e) {
  return e.some((e) =>
    e.type === `image` && `href` in e && typeof e.href == `string` && Xt(e.href) != null
      ? !0
...
function Xn(e) {
  return kn.has(e.type);
}
function Zn(e) {
  return Xn(e) && e.type === `html`;
}
function Qn(e, t) {
  let n = e[t - 1];
...
function tr({
  ...
  cwd: a = null,
  directives: o,
  forceCodeBlockWordWrap: c = !1,
  hideCodeBlocks: l,
  hostId: u = s,
  mediaCacheKey: d,
  mediaPresentation: f = `default`,
  openCodeFenceToken: p,
  renderText: m,
  textClassName: h,
  tokens: g,
}) {
  ...
  return (
    ...
    (0, Q.jsx)(`div`, {
      ref: v,
      [Fe]: _,
      className: F(`[&>*:first-child]:mt-0`, Y.markdownContent, n && Y.markdownRoot, r),
      children: jn(g, {
        allowBasicHtml: e,
        components: { ...b, ...i },
        directives: o,
...
function ar({
  ...
  (i.delayMsByKey.set(r, c),
    (i.nextSegmentStartAtMs =
      s + sr({ fadeSegmentDelayMs: t, fadeSegmentMaxDelayMs: n, segmentDelayMs: c })),
    e.style.setProperty(`--fade-delay`, `${c}ms`));
}
function or({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentIndex: n }) {
  let r = n * e;
  return t == null || r <= t
    ? r
    : t +
        (n - Math.floor(t / e)) *
          sr({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentDelayMs: t });
}
function sr({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentDelayMs: n }) {
  return t == null || n < t ? e : Math.max(rr, e * nr);
}
var cr = /^\s*$/;
function lr({
  cwd: e,
  ...
  let g = Qe(h),
    _ = c == null && t ? Mt(g) : null;
  if (!l && c == null && _ == null) return g;
  let v = c ?? dr({ decorations: _, segmentText: (e) => (l ? gr(e, m) : [e]), text: g });
  return !l && v.length === 1 && v[0]?.kind === `text` && v[0].segments[0] === g
    ? g
    : fr({
        cwd: e,
...
function ur({ decorateText: e = !0, segmenter: t, text: n }) {
  let r = Qe(n);
  return dr({ decorations: e ? Mt(r) : null, segmentText: (e) => gr(e, t), text: r });
}
function dr({ decorations: e, segmentText: t, text: n }) {
    ...
    (f.push(
      (0, Q.jsx)(
        `span`,
        {
          ...
          className: Y.fadeIn,
          style: mr({ fadeSegmentDelayMs: t, fadeSegmentMaxDelayMs: n, segmentIndex: m }),
          children: d,
        },
        r?.[p] ?? `fade-${m}`,
      ),
    ...
    ? o.map((n, o) => {
        ...
        return (0, Q.jsx)(
          `span`,
          {
            ...
            className: Y.fadeIn,
            style: mr({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentIndex: s }),
            children: n,
          },
          a?.[o] ?? `fade-${s}`,
        );
...
function mr({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentIndex: n }) {
  if (!(e <= 0))
    return {
      "--fade-delay": `${or({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentIndex: n })}ms`,
    };
}
function hr({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentKey: n, timeline: r }) {
  ...
  return (
    t[2] === n
      ...
      : ((a = (0, Q.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, Q.jsx)(I, { color: `secondary`, size: `default`, onClick: n, children: i }),
          ],
        })),
        (t[2] = n),
        (t[3] = a)),
...
function Cr(e) {
  ...
  if (n != null) return n;
  let r = wr(t);
  return r.length === 0 ? `file` : (Sr.get(r) ?? `file`);
}
function wr(e) {
  let t = e.lastIndexOf(`.`);
...
function Tr(e) {
  ...
  if (
    ...
    ((m = Pr(o)), (f = Pr(s)), (p = Mr(a)));
    let e = Nr(p),
      n = Cr(a),
      i = e.length === 0 ? kr(n, u) : null,
      c = Ar(u, m, f, jr(n));
    h = Er(r?.label, r?.target, u) ?? c;
    let l =
      h == null
        ? null
        : u.formatMessage(
...
var Fr = T((e) => (typeof e == `string` ? e.trim() : void 0), w().min(1)),
  Ir = Fr.optional(),
  Lr = T((e) => {
    if (typeof e != `string`) return;
    let t = Number(e.trim());
  ...
  zr = T(
    ...
    k([`chart`, `table`, `image`, `shape`]),
  ).optional(),
  Br = D({ artifact_kind: j(`presentation`), object_id: Ir }),
  Vr = O([
    Br.extend({ slide_id: Fr, slide_number: Rr }),
    Br.extend({ slide_id: Ir, slide_number: Lr }),
    D({ artifact_kind: j(`workbook`), object_id: Fr, object_kind: zr, sheet: Fr }),
    D({ artifact_kind: j(`workbook`), range: Fr, sheet: Fr }),
    D({ artifact_kind: j(`document`), page_number: Lr }),
  ]),
  Hr = D({ label: Ir, path: Fr });
function Ur(e) {
  let t = Hr.safeParse(e);
  if (!t.success) return;
  let n = Vr.safeParse(e);
  if (n.success)
    return {
...
function Kr({ cwd: e, hostId: t = s, openFileLinksInSidePanel: n = !1, shouldRenderPath: r }) {
  return {
    [v]({ attributes: i }) {
      let a = Ur(i),
        o = a?.path ?? Gr(i, `path`);
      return o != null && r?.(o) === !1
        ...
        : (0, Q.jsx)(Tr, {
            ...
            hostId: t,
            path: o,
            lineRangeStart: Gr(i, `lineRangeStart`) ?? Gr(i, `line_range_start`),
            lineRangeEnd: Gr(i, `lineRangeEnd`) ?? Gr(i, `line_range_end`),
            openInSidePanel: n,
          });
    },
  };
...
function Yr(e) {
  ...
  t[8] === c
    ...
    : ((u = (0, Q.jsx)(`div`, {
        ...
        children: (0, Q.jsx)(I, { color: `outline`, onClick: c, children: l }),
      })),
      (t[8] = c),
      (t[9] = u));
  let d;
...
function Xr() {
  return {
    [c]({ attributes: e, rawText: t }) {
      return (0, Q.jsx)(Yr, { title: Gr(e, `title`) ?? ``, prompt: t ?? `` });
    },
  };
}
function Zr({
  ...
  return { ...Kr({ cwd: t, hostId: r, openFileLinksInSidePanel: a }), ...Xr(), ...qr(), ...Jr() };
}
function Qr({
  allowWideBlocks: e,
  conversationId: t,
...
function ti(e) {
  let t = (0, X.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Q.jsx)(ri, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
...
function ri(e) {
  ...
  t[20] !== n || t[21] !== D || t[22] !== o
    ? ((O = W($r(n, D), o)), (t[20] = n), (t[21] = D), (t[22] = o), (t[23] = O))
    : (O = t[23]);
  let k = O,
    A;
  t[24] === b ? (A = t[25]) : ((A = ei(b)), (t[24] = b), (t[25] = A));
  let j = A,
    M;
  t[26] !== S || t[27] !== i || t[28] !== D || t[29] !== c || t[30] !== l || t[31] !== f
    ? ((M = Zr({
        conversationId: S,
        cwd: i,
        enableInlineDil: D,
  ...
  let F;
  t[49] !== r || t[50] !== P
    ? ((F = { ...P, ...r }), (t[49] = r), (t[50] = P), (t[51] = F))
    : (F = t[51]);
  let I = F,
    L;
  t[52] !== i || t[53] !== c || t[54] !== d || t[55] !== f
    ? ((L = (e, t, n, r) =>
        lr({
          cwd: i,
          decorateText: r,
...
function si(e, t) {
  ...
  return (ci(e, t, n), { textByToken: n.textByToken });
}
function ci(e, t, n, r = !0) {
  for (let i of e) li(i, t, n, r);
}
function li(e, t, n, r) {
  if (mi(e)) {
    let i = ui(e.text, t, r),
  ...
  if (e.type === `table`) {
    for (let i of e.header) ci(i.tokens, t, n, r);
    for (let i of e.rows) for (let e of i) ci(e.tokens, t, n, r);
  }
}
function ui(e, t, n) {
  let r = di(t),
    ...
    a = r.get(i);
  if (a != null) return a;
  let o = ur({ decorateText: n, segmenter: t, text: e });
  if ((r.set(i, o), r.size > ii)) {
...
function fi(e, t) {
  ...
  for (let r of e) {
    if (r.kind === `text`) {
      for (let e of r.segments) n.push(pi(e, t));
      continue;
    }
    n.push(pi(r.content, t));
  }
  return n;
}
function pi(e, t) {
  let n = e.trim(),
    r = n.length === 0 ? `space:${t.segmentCount + 1}` : `text:${Ne(n)}`,
...
function yi(e) {
  let t = e.replace(_i, ``);
  return t.length === 0 || (t.includes("`") && ki(t))
    ? { isCodeFenceOpen: !1, markdown: t }
    : t.includes("```") && Oi(t)
      ? { isCodeFenceOpen: !0, markdown: bi(t) }
      : ((t = t.includes(`![`) ? xi(t) : t),
        (t = t.includes(`](`) ? Si(t) : t),
        (t = Ci(t, `**`)),
        (t = Ci(t, `*`)),
...
function xi(e) {
  return e.replace(gi, (e, t) => t);
}
function Si(e) {
  let t = e.match(hi);
  return t ? (ie(t[2]) || H(t[2]) != null ? e.replace(hi, `$1`) : `${e})`) : e;
}
function Ci(e, t) {
  if (!e.includes(t) || wi(e, t) % 2 == 0) return e;
  let n = Ti(e, t);
  if (n < 0) return e;
...
function wi(e, t) {
  ...
  for (let r = 0; r <= e.length - t.length; ) {
    if (e.startsWith(t, r) && !Ei(e, r) && !Di(e, r, t)) {
      ((n += 1), (r += t.length));
      continue;
    }
    r += 1;
...
function Ti(e, t) {
  for (let n = e.length - t.length; n >= 0; --n)
    if (e.startsWith(t, n) && !Ei(e, n) && !Di(e, n, t)) return n;
  return -1;
}
function Ei(e, t) {
  let n = 0;
...
function Pi(e, t, n) {
  ...
  let s = o == null ? W(e, t) : [...o, ...W(e.slice(a.length), t)];
  if ((r.set(e, s), r.size > ji)) {
    let e = r.keys().next().value;
    typeof e == `string` && r.delete(e);
  }
  return s;
...
`,
      ...
      u = l.trimStart();
    if (
      (n != null && u.length > 0 && Li(l) ? ((t = n), (n = null)) : u.length > 0 && (n = null),
      Ri(u) ? (i = !i) : !i && zi(u) ? (r += 1) : !i && r > 0 && Bi(u) && --r,
...
function Vi(e) {
  let t = (0, X.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Q.jsx)(Ui, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
    t[2] !== e.children || t[3] !== n
      ? ((r = (0, Q.jsx)(fe, {
...
function Ui(e) {
  ...
  let w = g === void 0 ? !1 : g,
    ...
    j = B(`2957382457`),
    M;
  t[23] === Symbol.for(`react.memo_cache_sentinel`) ? ((M = Mi()), (t[23] = M)) : (M = t[23]);
  let ee = M,
    N;
  t[24] === Symbol.for(`react.memo_cache_sentinel`) ? ((N = ir()), (t[24] = N)) : (N = t[24]);
  let P = N,
    F;
  try {
    let e;
  ...
  let I = F,
    ...
    R,
    z;
  if (t[26] !== n || t[27] !== j || t[28] !== o || t[29] !== u) {
    let e = $r(n, j);
    L = u ? yi(Wi(e)) : null;
    let r = L?.markdown ?? e;
    ((z = u ? Ni(r, o, ee) : W(r, o)),
      ...
      (t[31] = R),
      (t[32] = z));
  } else ((L = t[30]), (R = t[31]), (z = t[32]));
  let te = R,
    V = L?.isCodeFenceOpen === !0 && te?.type === `code` ? te : void 0,
    ne;
  t[33] === C ? (ne = t[34]) : ((ne = ei(C)), (t[33] = C), (t[34] = ne));
  let re = ne,
    ie;
  t[35] !== u || t[36] !== z
    ? ((ie = u ? si(z, I) : void 0), (t[35] = u), (t[36] = z), (t[37] = ie))
    : (ie = t[37]);
  let ae = ie,
    H;
  t[38] !== T || t[39] !== i || t[40] !== j || t[41] !== l || t[42] !== d || t[43] !== m
    ? ((H = Zr({
        conversationId: T,
        cwd: i,
        enableInlineDil: j,
...
function Gi(e) {
  ...
  let n = 2;
  for (; Ki(t.charCodeAt(n)); ) n += 1;
  return n === 2 ? !1 : u.has(t.slice(2, n));
}
function Ki(e) {
  return (
...
export { Ye as i, ti as n, Kr as r, Vi as t };
