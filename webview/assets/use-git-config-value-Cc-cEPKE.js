...
function c(e, t, n, i, s, c) {
  let u = (0, l.c)(9),
    d = e ?? null,
    f;
  u[0] === c ? (f = u[1]) : ((f = a(c, null)), (u[0] = c), (u[1] = f));
  let p;
  return (
    u[2] !== t || u[3] !== n || u[4] !== s || u[5] !== i || u[6] !== d || u[7] !== f
      ? ((p = { cwd: d, hostConfig: t, key: n, operationSource: s, scope: i, ...f }),
        (u[2] = t),
        (u[3] = n),
        (u[4] = s),
        (u[5] = i),
...
//# sourceMappingURL=use-git-config-value-Cc-cEPKE.js.map
