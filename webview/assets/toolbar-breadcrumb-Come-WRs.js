    ...
    ? ((s =
        r == null
          ...
          : (0, h.jsxs)(h.Fragment, {
              children: [
                n.length > 0
                  ? (0, h.jsx)(c, { "aria-hidden": !0, className: `icon-xs shrink-0` })
                  : null,
                (0, h.jsx)(`span`, {
                  "aria-current": `page`,
...
function f(e, t) {
  return (0, h.jsxs)(
    ...
    {
      children: [
        t > 0 ? (0, h.jsx)(c, { "aria-hidden": !0, className: `icon-xs shrink-0` }) : null,
        (0, h.jsx)(a, {
          className: `min-w-0`,
          color: `ghost`,
          size: `toolbar`,
...
var p,
  ...
  h,
  g = e(() => {
    ((p = n()), (m = t(r(), 1)), l(), s(), o(), (h = i()));
  });
export { g as n, d as t };
//# sourceMappingURL=toolbar-breadcrumb-Come-WRs.js.map
