...
import { t as _ } from "./dist-3.js";
import { _ as v, n as y, t as b, u as x } from "./chunk-123.js";
import { c as S, i as C, o as w } from "./chunk-126.js";
...
function E(e, t, n, r, i) {
  ...
  for (let [o, s] of r.entries()) {
    ...
    if (o == 0 || o % Fe === 0) {
      ...
      let e = a.data.stopx === a.data.startx ? a.data.startx : a.data.stopx + Q.diagramMarginX,
        t = a.data.starty;
      a.setData(e, e, t, t);
    }
    a.name = s.alias;
      ...
      var e = n(function (e, t, n, r) {
        ...
        ce = {
          ...
          table: [
            ...
            { 1: [2, 8] },
            e(te, [2, 15]),
            e(ne, [2, 17], { 21: 22, 19: 130, 22: t, 23: r, 24: i, 26: a, 28: o }),
            e(te, [2, 37], {
              19: 20,
              20: 21,
              21: 22,
          ...
          parse: n(function (e) {
            ...
            for (var v in this.yy)
              Object.prototype.hasOwnProperty.call(this.yy, v) && (_.yy[v] = this.yy[v]);
            (g.setInput(e, _.yy),
              (_.yy.lexer = g),
              (_.yy.parser = this),
            ...
            for (var C, w, T, E, D, O = {}, k, A, j, M; ; ) {
              if (
                ...
                var N = ``;
                for (k in ((M = []), s[T]))
                  this.terminals_[k] && k > p && M.push(`'` + this.terminals_[k] + `'`);
                ((N = g.showPosition
                  ? `Parse error on line ` +
                    (u + 1) +
                    `:
...
Expecting ` +
                  ...
                  : `Parse error on line ` +
                    (u + 1) +
                    `: Unexpected ` +
                    (C == m ? `end of input` : `'` + (this.terminals_[C] || C) + `'`)),
                  this.parseError(N, {
                    text: g.match,
              ...
              if (E[0] instanceof Array && E.length > 1)
                throw Error(
                  `Parse Error: multiple actions possible at state: ` + T + `, token: ` + C,
                );
              switch (E[0]) {
                case 1:
                  (r.push(C),
                ...
                case 2:
                  if (
                    ...
                    b && (O._$.range = [o[o.length - (A || 1)].range[0], o[o.length - 1].range[1]]),
                    (D = this.performAction.apply(O, [l, d, u, _.yy, E[1], a, o].concat(h))),
                    D !== void 0)
                  )
                    return D;
                  (A &&
...
` +
    ...
    (G = n(function (e, t, n, r, i, a, o, s) {
      ...
      ((l.nodeType = e), (l.parentBoundary = M), (l.wrap = ge()), (N = M), (M = t), j.push(N));
    }, `addDeploymentNode`)),
    (K = n(function () {
    ...
    (q = n(function (e, t, n, r, i, a, o, s, l, u, d) {
      ...
      if (!(f === void 0 && ((f = P.find((e) => e.alias === t)), f === void 0))) {
        if (n != null)
          if (typeof n == `object`) {
            let [e, t] = Object.entries(n)[0];
            f[e] = t;
      ...
      for (let e of t) {
        ...
        if (i === 0) {
          ...
          (t.attr(`x1`, e.startPoint.x),
            ...
            (e.type === `birel` || e.type === `rel_b`) && t.attr(`marker-start`, `url(#arrowend)`),
            (i = -1));
        } else {
          let t = r.append(`path`);
          (t
        ...
        (X(n)(
          e.label.text,
          r,
          Math.min(e.startPoint.x, e.endPoint.x) + Math.abs(e.endPoint.x - e.startPoint.x) / 2 + o,
          Math.min(e.startPoint.y, e.endPoint.y) + Math.abs(e.endPoint.y - e.startPoint.y) / 2 + s,
          e.label.width,
          e.label.height,
          { fill: t },
          l,
    ...
    (xe = n(function (e, t, n) {
      ...
      ((l.fontWeight = `bold`),
        (l.fontSize += 2),
        (l.fontColor = o),
        X(n)(t.label.text, r, t.x, t.y + t.label.Y, t.width, t.height, { fill: `#444444` }, l),
        t.type &&
          t.type.text !== `` &&
          ((l = n.boundaryFont()),
          (l.fontColor = o),
          X(n)(t.type.text, r, t.x, t.y + t.type.Y, t.width, t.height, { fill: `#444444` }, l)),
        t.descr &&
          t.descr.text !== `` &&
          ((l = n.boundaryFont()),
          (l.fontSize -= 2),
          (l.fontColor = o),
          X(n)(t.descr.text, r, t.x, t.y + t.descr.Y, t.width, t.height, { fill: `#444444` }, l)));
    }, `drawBoundary`)),
    (Se = n(function (e, t, n) {
      let r = t.bgColor ? t.bgColor : n[t.typeC4Shape.text + `_bg_color`],
        i = t.borderColor ? t.borderColor : n[t.typeC4Shape.text + `_border_color`],
      ...
      return (
        ...
        (d.fontSize += 2),
        (d.fontColor = a),
        X(n)(t.label.text, s, t.x, t.y + t.label.Y, t.width, t.height, { fill: a }, d),
        ...
        t.descr &&
          ...
          ((d = n.personFont()),
          (d.fontColor = a),
          X(n)(t.descr.text, s, t.x, t.y + t.descr.Y, t.width, t.height, { fill: a }, d)),
        t.height
      );
    }, `drawC4Shape`)),
    (Ce = n(function (e) {
        ...
        for (let e = 0; e < m.length; e++) {
          let o = e * u - (u * (m.length - 1)) / 2,
            l = t
              ...
              .style(`font-weight`, f)
              .style(`font-family`, d);
          (l.append(`tspan`).attr(`dy`, o).text(m[e]).attr(`alignment-baseline`, `mathematical`),
            i(l, s));
        }
      }
      n(t, `byTspan`);
    ...
    (Ie = class {
      ...
      insert(e) {
        ...
        let t =
          ...
          i = r + e.height;
        ((t >= this.data.widthLimit || n >= this.data.widthLimit || this.nextData.cnt > Pe) &&
    ...
    (Le = n(function (e) {
      (f(Q, e),
        e.fontFamily &&
          (Q.personFontFamily = Q.systemFontFamily = Q.messageFontFamily = e.fontFamily),
        e.fontSize && (Q.personFontSize = Q.systemFontSize = Q.messageFontSize = e.fontSize),
        e.fontWeight &&
          (Q.personFontWeight = Q.systemFontWeight = Q.messageFontWeight = e.fontWeight));
    }, `setConf`)),
    (Re = n(
      (e, t) => ({
        fontFamily: e[t + `FontFamily`],
    ...
    (We = n(function (e, t) {
      ...
      let r = Ue(e, n);
      return (
        (n.x = e.x + e.width / 2), (n.y = e.y + e.height / 2), { startPoint: r, endPoint: Ue(t, n) }
      );
    }, `getIntersectPoints`)),
    (Ge = n(function (e, t, n, r) {
      ...
      for (let e of t) {
        ...
        (T(`label`, e, t, a, o),
          e.techn && e.techn.text !== `` && ((o = y(e.techn.text, a)), T(`techn`, e, t, a, o)),
          e.descr && e.descr.text !== `` && ((o = y(e.descr.text, a)), T(`descr`, e, t, a, o)));
    ...
    (Ke = {
      ...
      draw: n(function (e, n, r, i) {
        ...
        (Z.insertComputerIcon(f), Z.insertDatabaseIcon(f), Z.insertClockIcon(f));
        let p = new Ie(i);
        (p.setData(Q.diagramMarginX, Q.diagramMarginX, Q.diagramMarginY, Q.diagramMarginY),
        ...
        (f.attr(
          `viewBox`,
          g.startx - Q.diagramMarginX + ` -` + (Q.diagramMarginY + y) + ` ` + v + ` ` + (_ + y),
        ),
          t.debug(`models:`, g));
      }, `draw`),
    }),
...
//# sourceMappingURL=c4Diagram-5.js.map
