...
import { n as s, r as c, u as l } from "./vscode-api.js";
import { t as u } from "./useQueries.js";
import { Cr as d, ar as f } from "./src-4.js";
import { Cr as p, Kr as m, qr as h } from "./app-server-manager-signals.js";
import { c as g, n as _, o as v, r as y } from "./lib-1.js";
import { t as b } from "./clsx.js";
import { o as x } from "./statsig-DoZ-0xit.js";
import { v as S } from "./config-queries-BHYT-TjG.js";
import { o as C } from "./mcp-capability-signals.js";
import { t as w } from "./use-debounced-value.js";
import { t as T } from "./startCase.js";
import { D as E, E as D, m as O, v as k } from "./mention-item.js";
import { t as A } from "./apps.js";
import { t as j } from "./plugin-install-store-Cl-MdpFm.js";
...
function We(e) {
  ...
  let { nativeApps: y, isLoading: b } = V(v),
    x;
  t[2] === f ? (x = t[3]) : ((x = Ye(f)), (t[2] = f), (t[3] = x));
  let S = x,
    C = d.formatMessage({
    ...
    T = y.find(qe) ?? null,
    E =
      p.length > 0 && w != null && Je(w, p)
        ? {
            kind: `chrome-plugin`,
            plugin: w,
            mention: { ...F(w, a), name: m, displayName: m, description: C },
    ...
    D =
      p.length === 0 || r == null
        ...
        : y
            ...
            .filter((e) => Xe(e.app.displayName, p)),
    O = [...(E == null ? [] : [E]), ...D].slice(0, 2),
    k = O.flatMap(Ke),
    j = u({
      queries: k.map((e) => ({
        queryKey: c(`computer-use-native-desktop-app-icon`, { appPath: e.appPath }),
        queryFn: () =>
          s(`computer-use-native-desktop-app-icon`, { params: { appPath: e.appPath } }),
        enabled: r != null,
        staleTime: l.INFINITE,
        refetchOnWindowFocus: !1,
      })),
    }),
    N = p.length > 0 && b && E == null && D.length === 0 ? S.loading : null;
...
function Je(e, t) {
  return Math.max(W(e.plugin.name, t), W(e.displayName ?? ``, t), W(m, t), W(`@${m}`, t)) > 0;
}
function Ye(e) {
  return e === `macOS`
