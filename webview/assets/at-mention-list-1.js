...
import { R as r, a as i, f as a, t as o } from "./app-scope.js";
import { Er as s, gi as c, hi as l } from "./app-server-manager-signals.js";
import { n as u, r as d, u as f } from "./vscode-api.js";
import { t as p } from "./useQueries.js";
import { Qn as m, gr as h } from "./src-1.js";
import { c as g, n as _, o as v, r as y } from "./lib.js";
import { t as b } from "./clsx-Cir5-jBH.js";
import { o as x } from "./statsig.js";
import { v as S } from "./config-queries.js";
import { o as C } from "./mcp-capability-signals.js";
import { t as w } from "./use-debounced-value.js";
import { t as T } from "./startCase.js";
import { D as E, O as D, m as O, y as k } from "./mention-item-B.js";
import { t as A } from "./apps.js";
import { t as j } from "./plugin-install-store.js";
import { t as M } from "./use-platform.js";
import { m as N, y as P } from "./use-plugins.js";
import {
  a as F,
  c as I,
  i as L,
...
import { r as H, t as ee } from "./get-file-icon.js";
import { n as te, t as ne } from "./mention-icons.js";
import { t as re } from "./mcp.js";
import { t as ie } from "./get-skill-icon.js";
import { n as ae } from "./use-skills-J.js";
import { t as oe } from "./use-is-background-subagents-enabled.js";
import { t as se } from "./sortBy.js";
import { s as ce } from "./dist-13.js";
import {
  a as le,
  c as ue,
  i as U,
...
import { t as W } from "./score-query-match-CZO-nWKm.js";
import { t as _e } from "./list-navigation.js";
import { t as ve } from "./use-workspace-file-search-CG-eRM3a.js";
...
var Ce = a(o, ({ hostId: e, path: t, query: n, servers: r }, { scope: i }) => ({
...
function Me(e) {
  let t = q(e.resourceUri, `file_name`) ?? q(e.resourceUri, `filename`),
    ...
    r = H(t ?? e.title, n);
  if (!(r === `file` && t == null && n == null)) return ee[r];
}
function q(e, t) {
  try {
...
function We(e) {
  let t = (0, G.c)(12),
    ...
    s = g(),
    { platform: m } = M(),
    h = o.trim().toLowerCase(),
    _ = r != null,
    v;
  t[0] === _ ? (v = t[1]) : ((v = { enabled: _ }), (t[0] = _), (t[1] = v));
  let { nativeApps: y, isLoading: b } = V(v),
    x;
  t[2] === m ? (x = t[3]) : ((x = Ye(m)), (t[2] = m), (t[3] = x));
  let S = x,
    C = s.formatMessage({
    ...
    T = y.find(qe) ?? null,
    E =
      h.length > 0 && w != null && Je(w, h)
        ? {
            kind: `chrome-plugin`,
            plugin: w,
            mention: { ...F(w, a), name: l, displayName: l, description: C },
            nativeApp: T == null ? null : { ...T, displayName: I(T) },
          }
        : null,
    D =
      h.length === 0 || r == null
        ...
        : y
            ...
            .filter((e) => Xe(e.app.displayName, h)),
    O = [...(E == null ? [] : [E]), ...D].slice(0, 2),
    k = O.flatMap(Ke),
    j = p({
      queries: k.map((e) => ({
        queryKey: d(`computer-use-native-desktop-app-icon`, { appPath: e.appPath }),
        queryFn: () =>
          u(`computer-use-native-desktop-app-icon`, { params: { appPath: e.appPath } }),
        enabled: r != null,
        staleTime: f.INFINITE,
        refetchOnWindowFocus: !1,
      })),
    }),
    N = h.length > 0 && b && E == null && D.length === 0 ? S.loading : null;
  if ((r == null && E == null) || (O.length === 0 && N == null)) return null;
  let P = S.title,
    z = O.map((e) => {
      if (e.kind === `chrome-plugin`) {
        let t = e.nativeApp == null ? `` : (j[k.indexOf(e.nativeApp)]?.data?.iconSmall ?? ``);
        return {
      ...
      let t = j[k.indexOf(e.app)]?.data?.iconSmall ?? ``,
        n = R({ app: e.app, description: C, computerPlugin: e.plugin, iconSmall: t });
      return {
    ...
    B;
  t[4] !== b || t[5] !== j
    ? ((B = b || j.some(Ge)), (t[4] = b), (t[5] = j), (t[6] = B))
    : (B = t[6]);
  let H;
  return (
    t[7] !== N || t[8] !== z || t[9] !== B || t[10] !== S.title
      ? ((H = { id: `native-apps`, title: P, items: z, emptyState: N, isLoading: B }),
        (t[7] = N),
        (t[8] = z),
        (t[9] = B),
        (t[10] = S.title),
...
function Je(e, t) {
  return Math.max(W(e.plugin.name, t), W(e.displayName ?? ``, t), W(l, t), W(`@${l}`, t)) > 0;
}
function Ye(e) {
  return e === `macOS`
...
function et(e) {
  ...
  let v = u || (!s && m),
    ...
    E = T ? it(C) : [],
    D = new Set(E),
    O = T ? C.filter((e) => !D.has(e) && (e.plugin.installed || !rt(e))) : C,
    A;
  t[3] !== n || t[4] !== y
    ? ((A = (e) => {
        e.plugin.installed || y(n, e);
      }),
      (t[3] = n),
      (t[4] = y),
      (t[5] = A))
  ...
  let P = A,
    ...
    R = S.length === 0 ? O : ot(O, S, b).filter((e) => st(e, S, b) > 0),
    V = v && R.length === 0;
  if (R.length === 0 && !V && I == null) {
    let e;
    return (
      t[6] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = { sections: [] }), (t[6] = e))
...
function it(e) {
  let t = P(),
    ...
    r = at(t);
  return (0, Y.default)(
    e.filter((e) => rt(e) && e.marketplaceName === n),
    [(e) => (e.plugin.name === r ? 0 : 1), (e) => X.indexOf(e.plugin.name)],
  );
}
function at(e) {
  switch (e) {
...
function dt(e, t, n, r = null) {
  if (!e.enabled || !de(e, r)) return !1;
  let i = s(e.path)?.pluginId;
  return i == null || !X.includes(i) || (!n && !t.has(i));
}
function ft(e, t) {
  return (0, Y.default)(
...
function ht(e) {
  ...
  let h = K(m),
    ...
    y;
  t[5] !== a || t[6] !== c || t[7] !== v
    ? ((y = { hostId: a, query: c, roots: v }), (t[5] = a), (t[6] = c), (t[7] = v), (t[8] = y))
    : (y = t[8]);
  let b = Te({ sections: et(y).sections, query: c, servers: g }),
    x;
  t[9] !== a || t[10] !== c || t[11] !== s
    ? ((x = { hostId: a, query: c, roots: s }), (t[9] = a), (t[10] = c), (t[11] = s), (t[12] = x))
    : (x = t[12]);
  let T = ct(x),
    { data: E, isLoading: D } = S(o, d),
    O = new Set(
    ...
    I = _t(gt(Pe([F == null ? null : { sections: [F] }, { sections: b }, null, T, h]), c)),
    L;
...
function St(e) {
  ...
  t[5] !== o.mentionSearchTool || t[6] !== o.server
    ...
    : (c = t[7]);
  let l = s.filter(c),
    u = i(Ce, { hostId: r, path: o.path.map(Ct), query: a, servers: l }),
    d = Ee({ isLoading: u.isLoading, mentionSource: o, results: u.data, servers: l }),
    f;
  return (
    t[8] !== n || t[9] !== a || t[10] !== d
      ? ((f = (0, Q.jsx)($, { ...n, query: a, sections: d })),
        (t[8] = n),
        (t[9] = a),
        (t[10] = d),
        (t[11] = f))
...
function $(e) {
  ...
  let w = m.length > 1 || m.some(Et),
    T = !(h.length > 0) && m.every(At),
    E;
  (t[5] === r ? (E = t[6]) : ((E = r.some(Tt)), (t[5] = r), (t[6] = E)),
    ue({ isLoading: E, onRequestClose: o, query: d, resultCount: h.length }));
  let D = f === `default` ? `both` : `bottom`,
    O = fe(p),
    k = p ? `composer-home-top-menu` : `max-h-[320px]`,
    A;
  t[7] !== n || t[8] !== k ? ((A = b(n, k)), (t[7] = n), (t[8] = k), (t[9] = A)) : (A = t[9]);
  let j;
  return (
    t[10] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((j = b(`flex w-full flex-col`)), (t[10] = j))
      : (j = t[10]),
    (0, Q.jsxs)(me, {
      className: A,
      chromeVariant: f,
      ...
      children: [
        ...
        m.some(wt) ? (0, Q.jsx)(`div`, { className: yt.loadingBar, "aria-hidden": `true` }) : null,
      ],
    })
  );
}
  ...
  t[7] !== i || t[8] !== o || t[9] !== s || t[10] !== c.emptyState || t[11] !== c.items
    ? ((u =
        c.items.length > 0
          ...
          : c.emptyState == null
            ? null
            : (0, Q.jsx)(U, { children: (0, Q.jsx)(v, { ...c.emptyState }) })),
      (t[7] = i),
      (t[8] = o),
      (t[9] = s),
      (t[10] = c.emptyState),
...
function kt(e) {
  ...
  t[3] !== n.labelClassName || t[4] !== c
    ? ((l = b(`truncate`, c, n.labelClassName)), (t[3] = n.labelClassName), (t[4] = c), (t[5] = l))
    : (l = t[5]);
  let u;
  t[6] !== n.label || t[7] !== l
    ? ((u = (0, Q.jsx)(`span`, { className: l, children: n.label })),
      (t[6] = n.label),
      (t[7] = l),
      (t[8] = u))
    : (u = t[8]);
  ...
  return (
    t[15] !== a || t[16] !== i || t[17] !== o || t[18] !== f
      ? ((p = (0, Q.jsx)(le, { getItemProps: a, highlighted: o, itemIndex: i, children: f })),
        (t[15] = a),
        (t[16] = i),
        (t[17] = o),
        (t[18] = f),
