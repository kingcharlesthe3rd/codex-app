...
import { t as oe } from "./automation-host-support-C.js";
var k = new (class {
...
var V = 60,
  H = i(s, ({ get: e }) => {
    ...
    for (let n of e(p))
      for (let r of e(g, n))
        t.push({ cwd: e(m, r), hostId: n, id: r, title: e(ee, r), turns: e(l, r) ?? [] });
    return t;
  });
function U(e) {
  let t = [];
...
var Ce = o(s, (e, { get: t }) => t(f, e)?.type ?? null),
  we = o(s, (e, { get: t }) =>
    Se({
      hasConversation: t(u, e),
      hostId: t(c, e),
      latestTurnId: t(d, e),
      latestTurnStatus: t(h, e),
