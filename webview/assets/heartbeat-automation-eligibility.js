...
import { Z as r, c as i, g as a, l as o, t as s } from "./app-scope-CWE-zIhQ.js";
...
import { f as v } from "./vscode-api.js";
import { pt as y } from "./src.js";
import { i as b, s as x } from "./lib-1.js";
import { t as S } from "./button-oF-qgtAS.js";
import { o as C } from "./statsig.js";
import { Hr as w, Ur as T, t as E } from "./product-logger.js";
import { n as ee } from "./local-conversation-title-signals.js";
import { a as D, d as te, i as ne, l as re, n as ie, r as ae } from "./dialog-layout.js";
import { t as O } from "./command-execution-command.js";
import { t as oe } from "./automation-host-support.js";
var k = new (class {
      ...
      case `thread_switch_completed`: {
        ...
        ((this.pendingThreadSwitch = null),
          E(e, w, {
            ...
            switchKind: se(t.defaults.needsResume ? `cold` : `hot`),
...
function N(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, A.jsx)(o, { className: `icon-2xs block shrink-0` })), (t[4] = o), (t[5] = c));
  let l;
  return (
    t[6] !== r || t[7] !== s || t[8] !== c
      ? ((l = (0, A.jsx)(`button`, {
...
function I({ isPinned: e, onPinnedChange: t }) {
  return {
...
function L({ isPinned: e, hasUnreadTurn: t, ariaLabel: n, onPin: r, onUnpin: i }) {
  if (t)
    return {
      rest: null,
      hover: (0, A.jsx)(`span`, { "aria-hidden": !0, className: `block h-5 w-5` }),
    };
  let a = (0, A.jsx)(N, { isPinned: e, ariaLabel: n, onPin: r, onUnpin: i });
...
function R(e) {
  ...
  t[12] === d
    ? (g = t[13])
    : ((g = (0, A.jsx)(te, { className: `sr-only`, children: d })), (t[12] = d), (t[13] = g));
  let _;
  t[14] !== p || t[15] !== d
    ? ((_ = (0, A.jsx)(D, { children: (0, A.jsx)(ne, { title: d, subtitle: p }) })),
      (t[14] = p),
      (t[15] = d),
      (t[16] = _))
    : (_ = t[16]);
  ...
  t[20] === v
    ? (b = t[21])
    : ((b = (0, A.jsx)(S, { color: `ghost`, type: `button`, onClick: v, children: y })),
      (t[20] = v),
      (t[21] = b));
  let C;
  t[22] === s
  ...
  let w;
  t[24] !== b || t[25] !== C
    ? ((w = (0, A.jsx)(D, { children: (0, A.jsxs)(ae, { children: [b, C] }) })),
      (t[24] = b),
      (t[25] = C),
      (t[26] = w))
    : (w = t[26]);
  ...
  t[27] !== w || t[28] !== h || t[29] !== g || t[30] !== _
    ? ((T = (0, A.jsxs)(ie, { as: `form`, onSubmit: h, children: [g, _, w] })),
      (t[27] = w),
      (t[28] = h),
      (t[29] = g),
      (t[30] = _),
...
function B(e) {
  ...
  t[0] !== r || t[1] !== n
    ? ((i = () => {
        !r || n == null || v.dispatchMessage(`open-in-new-window`, { path: y(n) });
      }),
      (t[0] = r),
      (t[1] = n),
      (t[2] = i))
...
var V = 60,
  H = i(s, ({ get: e }) => {
    ...
    for (let n of e(p))
      for (let r of e(m, n))
        t.push({ cwd: e(c, r), hostId: n, id: r, title: e(ee, r), turns: e(l, r) ?? [] });
    return t;
  });
function U(e) {
  let t = [];
...
function ue(e, t, n = Date.now(), { matchCommandStartTime: r = !1 } = {}) {
  if (t == null) return null;
  let i = r && e.commandExecutionStartedAtMs != null ? V : null;
  if (e.osPid != null) {
    let n = K(e.osPid, t);
    if (n != null && Y(Z(e.command), n.command)) return n;
  }
  let a = pe(e.processId);
  if (a != null) {
    if (e.source !== `restored-process` && i == null) {
      let e = K(a, t);
      if (e != null) return e;
    }
    let r = J(e, de(a, t), n, i);
    if (r != null) return K(r.pid, t);
  }
  let o = J(e, t, n, i);
  return o == null ? null : K(o.pid, t);
}
function de(e, t) {
  ...
  return (
    t
      .filter(
        (e) =>
          Y(i, e.command) &&
          (a == null || r == null || e.ageSeconds == null || X(e.ageSeconds, a) <= r),
      )
      .sort((e, t) => he(e, t, a))[0] ?? null
  );
}
function Y(e, t) {
  let n = Z(t);
...
var Ce = o(s, (e, { get: t }) => t(f, e)?.type ?? null),
  we = o(s, (e, { get: t }) =>
    Se({
      hasConversation: t(_, e),
      hostId: t(u, e),
      latestTurnId: t(h, e),
      latestTurnStatus: t(g, e),
      pendingRequestType: t(Ce, e),
      resumeState: t(d, e),
    }),
  );
export {
