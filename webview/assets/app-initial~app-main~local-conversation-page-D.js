...
function ge(e) {
  ...
  let M = N,
    ...
    F;
  t[29] === P ? (F = t[30]) : ((F = B(`flex w-full min-w-0 gap-2`, P)), (t[29] = P), (t[30] = F));
  let I;
  t[31] !== n || t[32] !== c
  ...
  let L = be,
    ...
    z;
  t[34] === R ? (z = t[35]) : ((z = B(`truncate`, R)), (t[34] = R), (t[35] = z));
  let V = D.map((e, t) =>
      (0, X.jsx)(
        `span`,
        { className: B(!e.isMatch && O && `text-token-description-foreground`), children: e.text },
        t,
      ),
    ),
    H;
  t[36] !== L || t[37] !== z || t[38] !== V || t[39] !== m || t[40] !== x
    ? ((H = (0, X.jsx)(L, { tooltipContent: x, delayDuration: m, className: z, children: V })),
      (t[36] = L),
      (t[37] = z),
      (t[38] = V),
      (t[39] = m),
  ...
  let K;
  t[55] !== W || t[56] !== G
    ? ((K = (0, X.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [W, G] })),
      (t[55] = W),
      (t[56] = G),
      (t[57] = K))
    : (K = t[57]);
...
function ke(e) {
  let t = (0, Me.c)(31),
    { clearSearch: n, close: a, hostId: s, onSelectFile: c, workspaceRoot: l } = e,
    u = o(r),
    d = J(),
    f = i(S, `searchFiles`),
    p = j(je),
  ...
  let y;
  t[2] !== s || t[3] !== g || t[4] !== v
    ? ((y = { hostId: s, query: g, roots: v }), (t[2] = s), (t[3] = g), (t[4] = v), (t[5] = y))
    : (y = t[5]);
  let { sections: b } = w(y),
    x = b[0],
    C,
  ...
  if (
    ...
    let r = f ?? ``,
      i;
    t[12] === r ? (i = t[13]) : ((i = (0, $.jsx)(H, { keysLabel: r })), (t[12] = r), (t[13] = i));
    let a;
    t[14] !== n || t[15] !== u
      ? ((a = () => {
          (n(), u.set(Q, `files`));
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (D = t[22]);
  let O;
  t[23] !== a || t[24] !== x.emptyState || t[25] !== x.items || t[26] !== d || t[27] !== c
    ? ((O =
        x.items.length > 0
          ? x.items.map((e, t) =>
              (0, $.jsx)(
  ...
  return (
    t[29] === O
      ...
      : ((k = (0, $.jsx)(
          N.Group,
          { forceMount: !0, heading: E, className: `flex flex-col`, style: D, children: O },
          `group-files`,
        )),
        (t[29] = O),
        (t[30] = k)),
...
function Fe() {
  ...
  e[9] !== s || e[10] !== n || e[11] !== i.id || e[12] !== a
    ? ((d = [s, n, i.id, a]), (e[9] = s), (e[10] = n), (e[11] = i.id), (e[12] = a), (e[13] = d))
    : (d = e[13]);
  let f = n === `files`,
    p;
...
var Ie,
  Le,
  Re = e(() => {
    ((Ie = h()), l(), s(), pe(), Oe(), R(), C(), f(), E(), G(), P(), re(), m(), Pe(), (Le = g()));
  });
export {
  Q as a,
  Ee as c,
...
//# sourceMappingURL=app-initial~app-main~local-conversation-page-D.js.map
