...
function je(e) {
  ...
  return (
    t[4] !== a || t[5] !== o
      ? ((s = (0, X.jsx)(R, { activities: o, children: a })), (t[4] = a), (t[5] = o), (t[6] = s))
      : (s = t[6]),
    s
  );
}
...
function Le(e) {
  let t = (0, Z.c)(54),
    ...
    { retryPendingWorktreeConversationStart: w } = we(),
    T = _e(v),
    E = Se().find((e) => e.pendingWorktreeId === v),
    D = f({
      mutationFn: async (e) => {
        ...
        if (T)
          if ((y(T.id), t))
            try {
              let e = await De({ entry: T, workspaceRoot: T.sourceWorkspaceRoot });
              (ve(m, {
                ...
                T.clientThreadId == null
                  ? ue(m, { conversationId: e, pendingWorktreeId: T.id }) || Te(T, e)
                  : ae(m, { clientThreadId: T.clientThreadId, conversationId: e }),
                s?.(e),
                s == null && T.clientThreadId == null && g(d(e)));
            } catch (e) {
              let t = e;
              throw (
                y(T.id),
                pe.error(`Error creating local task from worktree`, {
                  safe: {},
                  sensitive: { error: t },
                }),
                m
                  ...
                  .danger(
                    _.formatMessage(
                      ...
                      { br: (0, $.jsx)(`br`, {}), error: se(t) },
                    ),
                  ),
                t
              );
            }
          else (Ce(m, T.id), ce(Re(T)));
      },
    }),
    k;
  t[0] !== x || t[1] !== _ || t[2] !== g || t[3] !== T || t[4] !== m
    ? ((k = async () => {
        if (!T) return;
        let e =
        ...
        g(
          ne(
            await Ne({
              ...
              intl: _,
              pendingWorktree: T,
              serviceTier: await xe(m, T.hostId, e),
            }),
          ),
        );
      }),
  ...
  t[6] !== _ || t[7] !== m
    ? ((A = (e) => {
        (pe.error(`Error starting worktree setup repair thread`, {
          safe: {},
          sensitive: { error: e },
        }),
          m
  ...
  if (!T) {
    ...
    return (
      t[20] === u
        ? (e = t[21])
        : ((e = (0, $.jsx)(ge, { to: u, replace: !0 })), (t[20] = u), (t[21] = e)),
      e
    );
  }
  let R;
  t[22] === T.phase ? (R = t[23]) : ((R = ye(T.phase)), (t[22] = T.phase), (t[23] = R));
  let z = R,
    B = E?.state === `failed`,
    V = E?.state === `starting`,
    H = T.phase === `failed` || B,
                    ...
                    children: [
                      T.phase === `failed` &&
                        (0, $.jsx)(c, {
                          color: `secondary`,
                          onClick: () => {
                            if ((Oe(m, T.hostId), T.localEnvironmentConfigPath != null)) {
                              g(
                                Ee({
                                ...
                                }),
                                {
                                  state: {
                                    hostId: T.hostId,
                                    returnTo: `${h.pathname}${h.search}${h.hash}`,
                                  },
                                },
                              );
                              return;
...
function ze(e) {
  let t = (0, Z.c)(10),
    { hostId: n, prompt: r } = e,
    i;
  t[0] === r ? (i = t[1]) : ((i = g(r)), (t[0] = r), (t[1] = i));
  let a = i,
    o;
  t[2] === a
    ? (o = t[3])
    : ((o = a && (0, $.jsx)(H, { pullRequestNumber: a })), (t[2] = a), (t[3] = o));
  let s;
  t[4] !== n || t[5] !== r
    ? ((s = (0, $.jsx)(B, { message: r, sentAtMs: null, hostId: n, alwaysShowActions: !0 })),
      (t[4] = n),
      (t[5] = r),
      (t[6] = s))
    : (s = t[6]);
