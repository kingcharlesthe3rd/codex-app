...
function je(e) {
  ...
  return (
    t[4] !== a || t[5] !== o
      ? ((s = (0, X.jsx)(P, { activities: o, children: a })), (t[4] = a), (t[5] = o), (t[6] = s))
      : (s = t[6]),
    s
  );
}
...
async function Pe(e, t, n) {
  ...
  let { config: a } = await re(`read-config-for-host`, {
    hostId: e.hostId,
    includeLayers: !1,
    cwd: e.sourceWorkspaceRoot,
  });
...
function Le(e) {
  let t = (0, Z.c)(54),
    ...
    oe = Oe(),
    g = pe(),
    { pendingWorktreeId: se } = ce(),
    v = i ?? se,
    {
      cancelPendingWorktree: y,
      clearPendingWorktreeAttention: b,
      continuePendingWorktree: x,
      createPendingWorktree: S,
      retryPendingWorktree: C,
      setPendingWorktreePinned: w,
    } = ye(),
    { retryPendingWorktreeConversationStart: T } = _e(),
    E = Se(v),
    D = xe().find((e) => e.pendingWorktreeId === v),
    O = a({
      mutationFn: async (e) => {
        ...
        if (E)
          if ((y(E.id), t))
            try {
              let e = await Ee({ entry: E, workspaceRoot: E.sourceWorkspaceRoot });
              (ve(p, {
                ...
                E.clientThreadId == null
                  ? s(p, { conversationId: e, pendingWorktreeId: E.id }) || De(E, e)
                  : ne(p, { clientThreadId: E.clientThreadId, conversationId: e }),
                l?.(e),
                l == null && E.clientThreadId == null && h(f(e)));
            } catch (e) {
              let t = e;
              throw (
                y(E.id),
                n.error(`Error creating local task from worktree`, {
                  safe: {},
                  sensitive: { error: t },
                }),
                p
                  ...
                  .danger(
                    g.formatMessage(
                      ...
                      { br: (0, $.jsx)(`br`, {}), error: he(t) },
                    ),
                  ),
                t
              );
            }
          else (we(p, E.id), oe(Re(E)));
      },
    }),
    k;
  t[0] !== S || t[1] !== g || t[2] !== h || t[3] !== E || t[4] !== p
    ? ((k = async () => {
        if (!E) return;
        let e =
        ...
        h(
          le(
            await Ne({
              ...
              intl: g,
              pendingWorktree: E,
              serviceTier: await Ce(p, E.hostId, e),
            }),
          ),
        );
      }),
  ...
  t[6] !== g || t[7] !== p
    ? ((A = (e) => {
        (n.error(`Error starting worktree setup repair thread`, {
          safe: {},
          sensitive: { error: e },
        }),
          p
  ...
  if (
    ...
    return null;
  if (D?.state === `succeeded` && !re)
    return (0, $.jsx)(de, { to: f(D.conversationId), replace: !0 });
  ...
  if (!E) {
    ...
    return (
      t[20] === d
        ? (e = t[21])
        : ((e = (0, $.jsx)(de, { to: d, replace: !0 })), (t[20] = d), (t[21] = e)),
      e
    );
  }
  let R;
  t[22] === E.phase ? (R = t[23]) : ((R = ge(E.phase)), (t[22] = E.phase), (t[23] = R));
  let z = R,
    B = D?.state === `failed`,
    V = D?.state === `starting`,
    H = E.phase === `failed` || B,
                    ...
                    children: [
                      E.phase === `failed` &&
                        (0, $.jsx)(_, {
                          color: `secondary`,
                          onClick: () => {
                            if ((be(p, E.hostId), E.localEnvironmentConfigPath != null)) {
                              h(
                                Te({
                                  configPath: E.localEnvironmentConfigPath,
...
function ze(e) {
  ...
  t[2] === a
    ? (o = t[3])
    : ((o = a && (0, $.jsx)(N, { pullRequestNumber: a })), (t[2] = a), (t[3] = o));
  let s;
  t[4] !== n || t[5] !== r
    ? ((s = (0, $.jsx)(I, { message: r, sentAtMs: null, hostId: n, alwaysShowActions: !0 })),
      (t[4] = n),
      (t[5] = r),
      (t[6] = s))
    : (s = t[6]);
