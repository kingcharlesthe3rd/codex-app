...
function te(e) {
  ...
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (i = t[3]))
    : (({ className: r, children: n, ...i } = e), (t[0] = e), (t[1] = n), (t[2] = r), (t[3] = i));
  let a = s(),
    c = (0, k.useRef)(null),
    l;
  if (t[4] !== a) {
    let e = o(a, `1585730870`);
    ((l = e.get(`shimmer_variant`, null) === M || e.groupName === M), (t[4] = a), (t[5] = l));
  } else l = t[5];
  let u = l,
    d,
    p;
  ...
  let m = u ? c : void 0,
    ...
    g;
  t[9] !== r || t[10] !== h
    ? ((g = f(`loading-shimmer-pure-text`, h, r)), (t[9] = r), (t[10] = h), (t[11] = g))
    : (g = t[11]);
  let _;
  t[12] !== n || t[13] !== u
    ? ((_ = u
        ? (0, A.jsx)(`span`, {
            ...
            children: (0, A.jsx)(`span`, { className: E.cadencedShimmerHighlight, children: n }),
          })
        : null),
      (t[12] = n),
      (t[13] = u),
  ...
  return (
    t[15] !== n || t[16] !== i || t[17] !== m || t[18] !== g || t[19] !== _
      ? ((v = (0, A.jsxs)(`span`, { ref: m, className: g, ...i, children: [n, _] })),
        (t[15] = n),
        (t[16] = i),
        (t[17] = m),
        (t[18] = g),
...
function ne(e) {
  ...
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (i = t[3]))
    : (({ className: n, message: r, ...i } = e), (t[0] = e), (t[1] = n), (t[2] = r), (t[3] = i));
  let a;
  t[4] === n
    ? (a = t[5])
    : ((a = f(
...
function P(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== a) {
    ...
    bb0: {
      ...
      if (a === `offset`) {
        s = (0, I.jsx)(`div`, { className: f(e, `relative overflow-visible py-0`), children: n });
        break bb0;
      }
      o = f(e, `py-0`);
    }
  ...
  return (
    t[5] !== n || t[6] !== o
      ? ((c = (0, I.jsx)(`div`, { className: o, children: n })), (t[5] = n), (t[6] = o), (t[7] = c))
      : (c = t[7]),
    c
  );
}
...
function H(e) {
  ...
  return (
    t[2] === i
      ? (a = t[3])
      : ((a = (0, W.jsx)(l, { "aria-hidden": !0, className: i })), (t[2] = i), (t[3] = a)),
    a
  );
}
var U,
...
function K(e) {
  ...
  t[2] === a
    ? (c = t[3])
    : ((c = a == null ? null : (0, J.jsx)(H, { expanded: a.expanded })), (t[2] = a), (t[3] = c));
  let l;
  t[4] !== n || t[5] !== s || t[6] !== c
  ...
  if (a == null) {
    ...
    return (
      t[11] !== u || t[12] !== m || t[13] !== o
        ? ((e = (0, J.jsx)(`div`, { className: m, "data-testid": o, children: u })),
          (t[11] = u),
          (t[12] = m),
          (t[13] = o),
          (t[14] = e))
  ...
  let h;
  return (
    t[15] !== u || t[16] !== a.expanded || t[17] !== a.onToggle || t[18] !== m || t[19] !== o
      ? ((h = (0, J.jsx)(`button`, {
          type: `button`,
          className: m,
          "data-testid": o,
...
function X(e) {
  ...
  t[0] === e
    ...
    : (({ className: r, header: i, body: n, ...a } = e),
      ...
      (t[4] = a));
  let o;
  t[5] === r ? (o = t[6]) : ((o = f(`flex min-w-0 flex-col`, r)), (t[5] = r), (t[6] = o));
  let s;
  return (
    t[7] !== n || t[8] !== i || t[9] !== a || t[10] !== o
      ? ((s = (0, Z.jsx)(P, {
          padding: `offset`,
          children: (0, Z.jsxs)(`div`, { ...a, className: o, children: [i, n] }),
        })),
        (t[7] = n),
        (t[8] = i),
        (t[9] = a),
...
function ce(e) {
  let t = (0, le.c)(23),
    { defaultExpanded: n, indentContent: r, icon: i, summary: a, status: o, children: s } = e,
    c = n === void 0 ? !1 : n,
    l = r === void 0 ? !0 : r,
    [u, d] = (0, Q.useState)(!1),
    [p, h] = (0, Q.useState)(c),
  ...
  t[9] !== i || t[10] !== S || t[11] !== C
    ...
    : (w = t[12]);
  let T;
  t[13] !== s || t[14] !== g || t[15] !== v || t[16] !== l || t[17] !== b || t[18] !== x
    ? ((T = b
        ? (0, $.jsx)(_.div, {
            initial: !1,
  ...
  return (
    t[20] !== w || t[21] !== T
      ? ((E = (0, $.jsx)(X, { header: w, body: T })), (t[20] = w), (t[21] = T), (t[22] = E))
      : (E = t[22]),
    E
  );
}
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~remote-conversation-page~onboarding-page~hotkey-~fnaniary.js.map
