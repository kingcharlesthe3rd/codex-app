...
function b(e) {
  ...
  return (
    t[4] === o
      ? (d = t[5])
      : ((d = (0, S.jsxs)(`div`, { "aria-hidden": `true`, className: o, children: [c, u] })),
        (t[4] = o),
        (t[5] = d)),
    d
  );
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~pull-requests-page~plugin-detail-page~new-thr~ny8xzqbh.js.map
