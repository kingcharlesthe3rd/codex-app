...
import { js as t } from "./app-server-manager-signals.js";
import { _ as n, k as r, u as i } from "./vscode-api.js";
...
function f(e) {
  let d = (0, u.c)(31),
    { hostId: f, marketplacePath: h, pluginName: _, remoteMarketplaceName: v, enabled: y } = e,
    b = y === void 0 ? !0 : y,
    x = f ?? `local`,
    S;
  ...
  d[12] !== x || d[13] !== h || d[14] !== _ || d[15] !== w || d[16] !== v
    ? ((N = async () => {
        ...
        let { plugin: e } = await t(`read-plugin`, {
            hostId: x,
            ...c({ marketplacePath: h, remoteMarketplaceName: v }),
            pluginName: _,
          }),
          n = s(e.summary.interface?.logo, x, w),
          r = s(e.summary.interface?.composerIcon, x, w),
          i = Promise.all(
        ...
        return g(e, { composerIconDataUrl: a, logoDataUrl: o, skillImageDataUrls: l });
      }),
      (d[12] = x),
      (d[13] = h),
      (d[14] = _),
  ...
  d[18] !== j || d[19] !== M || d[20] !== N
    ? ((P = { queryKey: M, queryFn: N, enabled: j, staleTime: i.FIVE_MINUTES }),
      (d[18] = j),
      (d[19] = M),
      (d[20] = N),
      (d[21] = P))
