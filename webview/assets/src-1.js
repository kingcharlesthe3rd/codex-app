...
import { o as g, t as _ } from "./src-4.js";
function v(e) {
  return e;
}
var y = e(() => {});
...
function S(e, t) {
  ...
  function f(f) {
    var p = r ?? (t.ticks ? t.ticks.apply(t, n) : t.domain()),
      ...
      k = C.select(`text`);
    ((S = S.merge(
      S.enter().insert(`path`, `.tick`).attr(`class`, `domain`).attr(`stroke`, `currentColor`),
    )),
      (C = C.merge(D)),
      (O = O.merge(
        D.append(`line`)
      ...
      f !== x &&
        ...
        (re = re
          ...
          .attr(`transform`, function (e) {
            return isFinite((e = b(e))) ? d(e + c) : this.getAttribute(`transform`);
          })),
      ...
      (A.prototype = k.prototype =
        {
          ...
          on: function (e, t) {
            ...
            if (arguments.length < 2) {
              for (; ++a < o; ) if ((i = (e = r[a]).type) && (i = se(n[i], e.name))) return i;
              return;
            }
...
function we(e) {
  ...
  for (var t = this._groups, n = t.length, r = Array(n), i = 0; i < n; ++i)
    for (var a = t[i], o = a.length, s = (r[i] = Array(o)), c, l, u = 0; u < o; ++u)
      (c = a[u]) &&
...
function Ue(e) {
  return this.selectAll(e == null ? Ve : He(typeof e == `function` ? e : Fe(e)));
}
var We,
  Ge = e(() => {
...
function tt(e, t, n, r, i, a, o) {
  ...
  for (s = 0; s < u; ++s)
    (c = t[s]) &&
      ((f[s] = p = o.call(c, c.__data__, s, t) + ``), l.has(p) ? (i[s] = c) : l.set(p, c));
  for (s = 0; s < d; ++s)
    ((p = o.call(e, a[s], s, a) + ``),
      (c = l.get(p)) ? ((r[s] = c), (c.__data__ = a[s]), l.delete(p)) : (n[s] = new M(e, a[s])));
...
function ct(e, t, n) {
  var r = this.enter(),
    ...
    a = this.exit();
  return (
    typeof e == `function` ? ((r = e(r)), (r &&= r.selection())) : (r = r.append(e + ``)),
...
function ft() {
  for (var e = this._groups, t = -1, n = e.length; ++t < n; )
    for (var r = e[t], i = r.length - 1, a = r[i], o; --i >= 0; )
      (o = r[i]) &&
        (a && o.compareDocumentPosition(a) ^ 4 && a.parentNode.insertBefore(o, a), (a = o));
  return this;
}
var pt = e(() => {});
function mt(e) {
  ...
  for (var n = this._groups, r = n.length, i = Array(r), a = 0; a < r; ++a) {
    for (var o = n[a], s = o.length, c = (i[a] = Array(s)), l, u = 0; u < s; ++u)
      (l = o[u]) && (c[u] = l);
    c.sort(t);
  }
...
function Ht(e, t, n) {
  return arguments.length > 1
    ? this.each((t == null ? zt : typeof t == `function` ? Vt : Bt)(e, t, n ?? ``))
    : N(this.node(), e);
}
function N(e, t) {
...
function rn(e, t) {
  var n = Yt(e + ``);
  if (arguments.length < 2) {
    for (var r = Xt(this.node()), i = -1, a = n.length; ++i < a; ) if (!r.contains(n[i])) return !1;
    return !0;
  }
...
function* qn() {
  for (var e = this._groups, t = 0, n = e.length; t < n; ++t)
    for (var r = e[t], i = 0, a = r.length, o; i < a; ++i) (o = r[i]) && (yield o);
}
var Jn = e(() => {});
function P(e, t) {
...
function ir() {
  (er(), ++R);
  for (var e = V, t; e; ) ((t = W - e._time) >= 0 && e._call.call(void 0, t), (e = e._next));
  --R;
}
function ar() {
  ((W = (U = K.now()) + G), (R = z = 0));
...
function cr(e) {
  R ||
    ((z &&= clearTimeout(z)),
    e - W > 24
      ? (e < 1 / 0 && (z = setTimeout(ar, e - K.now() - G)), (B &&= clearInterval(B)))
      ...
      (nr.prototype = rr.prototype =
        {
          ...
          restart: function (e, t, n) {
            ...
            ((n = (n == null ? er() : +n) + (t == null ? 0 : +t)),
              !this._next && H !== this && (H ? (H._next = this) : (V = this), (H = this)),
              (this._call = e),
              (this._time = n),
              cr());
          },
...
function _r(e, t, n) {
  ...
  function o(a) {
    ...
    if (
      ...
      for (n.state = 3, i = Array((d = n.tween.length)), l = 0, u = -1; l < d; ++l)
        (f = n.tween[l].value.call(e, e.__data__, n.index, n.group)) && (i[++u] = f);
      i.length = u + 1;
    }
  }
  function s(t) {
...
function kr(e, t) {
  var r;
  return (typeof t == `number` ? i : t instanceof d ? f : (r = d(t)) ? ((t = r), f) : n)(e, t);
}
var Ar = e(() => {
  (r(), c());
});
...
function si(e) {
  ...
  for (
    ...
    for (var c = t[s], l = n[s], u = c.length, d = (o[s] = Array(u)), f, p = 0; p < u; ++p)
      (f = c[p] || l[p]) && (d[p] = f);
  for (; s < r; ++s) o[s] = t[s];
...
function di(e, t) {
  var n = this._id;
  return arguments.length < 2 ? J(this.node(), n).on.on(e) : this.each(ui(n, e, t));
}
var fi = e(() => {
  Y();
});
...
function gi(e) {
  ...
  for (var r = this._groups, i = r.length, a = Array(i), o = 0; o < i; ++o)
    for (var s = r[o], c = s.length, l = (a[o] = Array(c)), u, d, f = 0; f < c; ++f)
      (u = s[f]) &&
        (d = e.call(u, u.__data__, f, s)) &&
        (`__data__` in u && (d.__data__ = u.__data__), (l[f] = d), hr(l[f], t, n, f, l, J(u, n)));
...
function vi(e) {
  ...
  for (var r = this._groups, i = r.length, a = [], o = [], s = 0; s < i; ++s)
    for (var c = r[s], l = c.length, u, d = 0; d < l; ++d)
      if ((u = c[d])) {
        for (var f = e.call(u, u.__data__, d, c), p, m = J(u, n), h = 0, g = f.length; h < g; ++h)
...
function Oi(e, t, n) {
  ...
  return t == null
    ...
    : typeof t == `function`
      ? this.styleTween(e, Ei(e, r, Dr(this, `style.` + e, t))).each(Di(this._id, e))
...
function Ii(e) {
  return this.tween(
    `text`,
    typeof e == `function` ? Fi(Dr(this, `text`, e)) : Pi(e == null ? `` : e + ``),
  );
}
var Li = e(() => {
  Or();
...
function Hi() {
  for (
    var e = this._name, t = this._id, n = qi(), r = this._groups, i = r.length, a = 0;
    a < i;
    ++a
  )
  ...
  return new Promise(function (a, o) {
    ...
    (n.each(function () {
      var n = q(this, r),
        i = n.on;
      (i !== e &&
        ((t = (e = i).copy()), t._.cancel.push(s), t._.interrupt.push(s), t._.end.push(c)),
        (n.on = t));
    }),
      i === 0 && a());
  });
...
var ea,
  ta = e(() => {
    (Q(), Y(), Zi(), mr(), (ea = { time: null, delay: 0, duration: 250, ease: Yi }));
  }),
  na = e(() => {
    (L(), Cr(), ta(), (F.prototype.interrupt = Sr), (F.prototype.transition = $i));
  }),
  ra = e(() => {
    na();
  });
