...
function f(e) {
  return e.targetLinks.length ? e.depth : e.sourceLinks.length ? r(e.sourceLinks, c) - 1 : 0;
}
var p = e(() => {
  s();
});
...
function T() {
  let e = 0,
    ...
    D = 6;
  function O() {
    let e = { nodes: T.apply(null, arguments), links: E.apply(null, arguments) };
  ...
  ((O.update = function (e) {
    ...
    (O.nodeId = function (e) {
      return arguments.length ? ((u = typeof e == `function` ? e : m(e)), O) : u;
    }),
    (O.nodeAlign = function (e) {
      return arguments.length ? ((f = typeof e == `function` ? e : m(e)), O) : f;
    }),
    ...
    (O.nodes = function (e) {
      return arguments.length ? ((T = typeof e == `function` ? e : m(e)), O) : T;
    }),
    (O.links = function (e) {
      return arguments.length ? ((E = typeof e == `function` ? e : m(e)), O) : E;
    }),
    (O.linkSort = function (e) {
      return arguments.length ? ((h = e), O) : h;
    }),
    (O.size = function (t) {
      return arguments.length ? ((e = n = 0), (i = +t[0]), (o = +t[1]), O) : [i - e, o - n];
    }),
    (O.extent = function (t) {
  ...
  function k({ nodes: e, links: t }) {
    ...
    if (h != null) for (let { sourceLinks: t, targetLinks: n } of e) (t.sort(h), n.sort(h));
  }
  function A({ nodes: e }) {
    for (let t of e)
      t.value =
        t.fixedValue === void 0 ? Math.max(a(t.sourceLinks, y), a(t.targetLinks, y)) : t.fixedValue;
  }
  function j({ nodes: e }) {
    let t = e.length,
      n = new Set(e),
  ...
  function N({ nodes: n }) {
    ...
    for (let t of n) {
      ...
      ((t.layer = n), (t.x0 = e + n * a), (t.x1 = t.x0 + s), o[n] ? o[n].push(t) : (o[n] = [t]));
    }
  ...
  function R(e, t) {
    let r = e.length >> 1,
      i = e[r];
    (B(e, i.y0 - l, r - 1, t), z(e, i.y1 + l, r + 1, t), B(e, o, e.length - 1, t), z(e, n, 0, t));
  }
  function z(e, t, n, r) {
    for (; n < e.length; ++n) {
      let i = e[n],
  ...
  function H(e) {
    if (h === void 0) for (let { sourceLinks: t, targetLinks: n } of e) (t.sort(_), n.sort(g));
  }
  function U(e, t) {
            ...
            if (this._x1 === null) this._ += `M` + (this._x1 = e) + `,` + (this._y1 = t);
              ...
              if (!(Math.abs(u * s - c * l) > j) || !i)
                ...
                var f = n - a,
                  ...
                  g = Math.sqrt(m),
                  _ = Math.sqrt(d),
                  v = i * Math.tan((k - Math.acos((m + d - h) / (2 * g * _))) / 2),
                  y = v / _,
                  b = v / g;
                (Math.abs(y - 1) > j && (this._ += `L` + (e + y * l) + `,` + (t + y * u)),
                  (this._ +=
                    `A` +
                    i +
                    `,` +
...
function W(e) {
  ...
  return (
    ...
    (o.x = function (e) {
      return arguments.length ? ((r = typeof e == `function` ? e : F(+e)), o) : r;
    }),
    (o.y = function (e) {
      return arguments.length ? ((i = typeof e == `function` ? e : F(+e)), o) : i;
    }),
