import { $ as e, H as t, J as n, U as r, V as i, it as a } from "./runtime.worker-CnG-97Cx.js";
var o = 180 / Math.PI,
...
var p = f(u, `px, `, `px)`, `deg)`),
  ...
  S = v(function (e = `fatal`) {
    let t = b.fatal;
    (typeof e == `string` ? e.toLowerCase() in b && (t = b[e]) : typeof e == `number` && (t = e),
      (x.trace = () => {}),
      (x.debug = () => {}),
      (x.info = () => {}),
      (x.warn = () => {}),
...
function Ce(e) {
  return this.selectAll(e == null ? xe : Se(typeof e == `function` ? e : he(e)));
}
function we(e) {
...
function ke(e, t, n, r, i, a, o) {
  ...
  for (s = 0; s < d; ++s)
    ((p = o.call(e, a[s], s, a) + ``),
      (c = l.get(p)) ? ((r[s] = c), (c.__data__ = a[s]), l.delete(p)) : (n[s] = new k(e, a[s])));
...
function nt(e, t, n) {
  return arguments.length > 1
    ? this.each((t == null ? $e : typeof t == `function` ? tt : et)(e, t, n ?? ``))
    : A(this.node(), e);
}
function A(e, t) {
  return e.style.getPropertyValue(t) || Qe(e).getComputedStyle(e, null).getPropertyValue(t);
}
function rt(e) {
  return function () {
    delete this[e];
...
W.prototype = Qt.prototype = {
  ...
  restart: function (e, t, n) {
    ...
    ((n = (n == null ? U() : +n) + (t == null ? 0 : +t)),
      !this._next && R !== this && (R ? (R._next = this) : (L = this), (R = this)),
      (this._call = e),
      (this._time = n),
      G());
  },
...
function $t() {
  (U(), ++P);
  for (var e = L, t; e; ) ((t = B - e._time) >= 0 && e._call.call(void 0, t), (e = e._next));
  --P;
}
function en() {
  ((B = (z = H.now()) + V), (P = F = 0));
...
function G(e) {
  P ||
    ((F &&= clearTimeout(F)),
    e - B > 24
      ? (e < 1 / 0 && (F = setTimeout(en, e - H.now() - V)), (I &&= clearInterval(I)))
...
function pn(e, a) {
  var o;
  return (typeof a == `number` ? t : a instanceof n ? r : (o = n(a)) ? ((a = o), r) : i)(e, a);
}
function mn(e) {
  return function () {
    this.removeAttribute(e);
...
function Bn(e, t) {
  var n = this._id;
  return arguments.length < 2 ? Y(this.node(), n).on.on(e) : this.each(zn(n, e, t));
}
function Vn(e) {
  return function () {
  ...
  for (var r = this._groups, i = r.length, a = Array(i), o = 0; o < i; ++o)
    for (var s = r[o], c = s.length, l = (a[o] = Array(c)), u, d, f = 0; f < c; ++f)
      (u = s[f]) &&
        ...
        (`__data__` in u && (d.__data__ = u.__data__), (l[f] = d), K(l[f], t, n, f, l, Y(u, n)));
...
function Wn(e) {
  ...
  for (var r = this._groups, i = r.length, a = [], o = [], s = 0; s < i; ++s)
    for (var c = r[s], l = c.length, u, d = 0; d < l; ++d)
      if ((u = c[d])) {
        for (var f = e.call(u, u.__data__, d, c), p, m = Y(u, n), h = 0, g = f.length; h < g; ++h)
          (p = f[h]) && K(p, t, n, h, f, m);
        (a.push(f), o.push(u));
      }
...
function Qn(e, t, n) {
  ...
  return t == null
    ...
    : typeof t == `function`
      ? this.styleTween(e, Xn(e, r, X(this, `style.` + e, t))).each(Zn(this._id, e))
...
function ir(e) {
  return this.tween(
    `text`,
    typeof e == `function` ? rr(X(this, `text`, e)) : nr(e == null ? `` : e + ``),
  );
}
function ar(e) {
  return function (t) {
...
function cr() {
  for (
    var e = this._name, t = this._id, n = fr(), r = this._groups, i = r.length, a = 0;
    a < i;
    ++a
  )
...
([`w`, `e`].map(br), [`n`, `s`].map(br), [`n`, `w`, `e`, `s`, `nw`, `ne`, `sw`, `se`].map(br));
function br(e) {
  return { type: e };
}
function $(e, t, n) {
