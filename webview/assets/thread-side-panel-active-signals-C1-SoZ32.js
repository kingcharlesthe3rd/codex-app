...
import { _ as r, c as i, l as a, t as o } from "./app-scope-CWE-zIhQ.js";
import { a as s, j as c, o as l, r as u } from "./app-shell-state.js";
import { d, f } from "./persisted-signal.js";
import { r as p, t as m } from "./app-shell-tab-controller.js";
import { s as h } from "./thread-browser-panel-tabs.js";
var g = `codex-browser-sidebar-tweaks-submit-request`;
function _(e) {
  window.dispatchEvent(new CustomEvent(g, { detail: { conversationId: e } }));
}
function v(e, t) {
  let n = (n) => {
...
var y = n(),
  ...
  x = r(o, (e) => null);
function S(e, t, n, { isOpen: r, url: i }) {
  let a = i.trim();
  e.set(x, w(t, n), { currentUrls: a.length > 0 ? [a] : [], isOpen: r });
}
function C(e, t, n) {
  return t == null || n == null ? null : e.get(x, w(t, n));
}
function w(e, t) {
  return `${e}\0${t}`;
}
var T = a(f, (e, { get: t }) =>
  e == null
    ...
    : h(
        e,
        t(c),
        { bottom: t(m.activeTab$), right: t(p.activeTab$) },
        { bottom: t(u), right: t(s) && t(l) },
      ),
);
i(f, ({ get: e }) => e(l) && e(p.activeTab$)?.tabId === d.TIMELINE);
export { v as a, b as i, C as n, _ as o, S as r, T as t };
//# sourceMappingURL=thread-side-panel-active-signals-C1-SoZ32.js.map
