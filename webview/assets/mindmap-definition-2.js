import { t as e } from "./v4.js";
import "./marked.esm.js";
import "./src-2.js";
import { i as t, o as n, r } from "./invert.js";
import "./dist-5.js";
import { n as i, r as a } from "./chunk-64.js";
import { L as o, O as s, b as c, d as l, y as u } from "./chunk-99.js";
import "./chunk-48.js";
import "./chunk-132.js";
import "./chunk-67.js";
import "./chunk-146.js";
import { t as d } from "./chunk-41.js";
import { t as f } from "./chunk-77.js";
import "./chunk-136.js";
import "./chunk-47.js";
import "./chunk-83.js";
import { r as p, t as m } from "./chunk-23.js";
var h = (function () {
  ...
  y = class {
    ...
    getData() {
      let t = this.getMindmap(),
        ...
        r = s().layout !== void 0,
        i = n;
      if ((r || (i.layout = `cose-bilkent`), !t)) return { nodes: [], edges: [], config: i };
      (a.debug(`getData: mindmapRoot`, t, n), this.assignSections(t));
      let o = [],
        l = [];
      (this.flattenNodes(t, o),
        this.generateEdges(t, l),
        a.debug(`getData: processed ${o.length} nodes and ${l.length} edges`));
      let u = new Map();
      for (let e of o)
        u.set(e.id, { shape: e.shape, width: e.width, height: e.height, padding: e.padding });
      return {
        nodes: o,
        edges: l,
        config: i,
      ...
      if (h && g && _) {
        let e = s.attr(`id`),
          t = s
            ...
            .attr(`x2`, `100%`)
            .attr(`y2`, `0%`);
        (t.append(`stop`).attr(`offset`, `0%`).attr(`stop-color`, g).attr(`stop-opacity`, 1),
          t.append(`stop`).attr(`offset`, `100%`).attr(`stop-color`, _).attr(`stop-opacity`, 1));
      }
      f(
        s,
    ...
    for (let i = 0; i < e.THEME_COLOR_LIMIT; i++)
      ((e[`lineColor` + i] = e[`lineColor` + i] || e[`cScaleInv` + i]),
        n(e[`lineColor` + i])
          ...
          : (e[`lineColor` + i] = r(e[`lineColor` + i], 20)));
