...
import { eg as t, tg as n } from "./app-initial~app-main~new-thread-panel-page.js";
import { a as r, o as i, s as a, t as o } from "./dist-3.js";
import { i as s, n as c, r as l } from "./chunk-50.js";
import { A as u, O as d, R as f, b as p, d as m, y as h } from "./chunk-85.js";
import { u as g } from "./chunk-32.js";
import { i as _ } from "./chunk-128.js";
import { r as v } from "./chunk-53.js";
import { r as y } from "./chunk-145.js";
import { n as b, t as x } from "./chunk-24.js";
import { n as S, t as C } from "./chunk-65.js";
import { n as w } from "./chunk-132.js";
import { i as T } from "./chunk-28.js";
import { n as E } from "./chunk-68.js";
import { i as D, n as O, t as k } from "./chunk-6.js";
            ...
            switch (i) {
              ...
              case 25:
                (r.getLogger().trace(`node found ..`, a[s - 2]),
                  (this.$ = { id: a[s - 1], descr: a[s - 1], type: r.getType(a[s - 2], a[s]) }));
                break;
              case 26:
              ...
              case 27:
                (r.getLogger().trace(`node found ..`, a[s - 3]),
                  (this.$ = { id: a[s - 3], descr: a[s - 1], type: r.getType(a[s - 2], a[s]) }));
                break;
            }
          }, `anonymous`),
          table: [
            ...
            { 6: u, 7: d, 10: 23, 11: f },
            e(p, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: o, 22: s }),
            e(p, [2, 18]),
            e(p, [2, 19]),
            e(p, [2, 20]),
            e(p, [2, 21]),
...
` +
    ...
    (P = class {
      ...
      addNode(e, t, n, r) {
        ...
        else throw Error(`There can be only one root. No parent could be found for ("${c.descr}")`);
      }
      getType(e, t) {
      ...
      decorateNode(e) {
        ...
        (e.icon && (n.icon = f(e.icon, t)), e.class && (n.class = f(e.class, t)));
      }
      type2Str(e) {
        switch (e) {
      ...
      flattenNodes(e, t) {
        ...
        if ((t.push(o), e.children)) for (let n of e.children) this.flattenNodes(n, t);
      }
      generateEdges(e, t) {
      ...
      getData() {
        let e = this.getMindmap(),
          ...
          r = d().layout !== void 0,
          i = t;
        if ((r || (i.layout = `cose-bilkent`), !e)) return { nodes: [], edges: [], config: i };
        (s.debug(`getData: mindmapRoot`, e, t), this.assignSections(e));
        let a = [],
          o = [];
        (this.flattenNodes(e, a),
          this.generateEdges(e, o),
          s.debug(`getData: processed ${a.length} nodes and ${o.length} edges`));
        let c = new Map();
        for (let e of a)
          c.set(e.id, { shape: e.shape, width: e.width, height: e.height, padding: e.padding });
        return {
          nodes: a,
          edges: o,
          config: i,
...
` + e,
        ...
        if (
          ((a.type = r.type),
          (a.layoutAlgorithm = k(a.config.layout, { fallback: `cose-bilkent` })),
          (a.diagramId = t),
          !i.getMindmap())
        )
          return;
        ...
        if (l && u && d) {
          let e = o.attr(`id`),
            t = o
              ...
              .attr(`x2`, `100%`)
              .attr(`y2`, `0%`);
          (t.append(`stop`).attr(`offset`, `0%`).attr(`stop-color`, u).attr(`stop-opacity`, 1),
            t.append(`stop`).attr(`offset`, `100%`).attr(`stop-color`, d).attr(`stop-opacity`, 1));
        }
        S(
          o,
...
export { R as diagram };
//# sourceMappingURL=mindmap-definition-2.js.map
