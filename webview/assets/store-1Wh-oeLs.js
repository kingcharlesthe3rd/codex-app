...
function l(e, t) {
  ...
  ((t.totalChildSubtreeNodeCount = n), (t.totalChildVisibleSubtreeCount = r), p(e, t));
}
function u(t, n, r, i) {
  if (
    ((t.totalChildSubtreeNodeCount += r),
    (t.totalChildVisibleSubtreeCount += i),
    t.childVisibleChunkSums == null || i === 0)
  )
    return;
  let a = o(t).get(n);
  if (a === void 0) return;
  let s = a >> e;
  t.childVisibleChunkSums[s] += i;
}
function d(e, n, r) {
  let i = n.childVisibleChunkSums;
  if (i != null) {
    let a = r,
      o = 0;
    for (let s of i) {
      if (a < s) {
        let t = m(e, n, o, a);
        return { ...t, childVisibleIndex: r - t.localVisibleIndex };
      }
      ((a -= s), (o += t));
    }
  ...
  let a = r;
  for (let t = 0; t < n.childIds.length; t++) {
    let i = n.childIds[t];
    if (i == null) continue;
    let o = e[i];
    if (o != null) {
      if (a < o.visibleSubtreeCount)
        return { childIndex: t, childVisibleIndex: r - a, localVisibleIndex: a };
      a -= o.visibleSubtreeCount;
    }
  }
  throw Error(`Visible child index ${String(r)} is out of range`);
}
function f(t, n, r) {
  let i = 0,
    a = n.childVisibleChunkSums,
    o = 0;
  if (a != null) {
    let t = r >> e;
    for (let e = 0; e < t; e += 1) i += a[e] ?? 0;
    o = t << e;
  }
  for (let e = o; e < r; e += 1) {
    let r = n.childIds[e];
    if (r == null) continue;
    let a = t[r];
    a != null && (i += a.visibleSubtreeCount);
  }
  return i;
}
function p(r, i) {
  if (i.childIds.length < n) {
    i.childVisibleChunkSums = null;
    return;
  }
  let a = Math.ceil(i.childIds.length / t),
    o = new Int32Array(a);
  for (let t = 0; t < i.childIds.length; t++) {
    let n = i.childIds[t];
    if (n == null) continue;
    let a = r[n];
    a != null && (o[t >> e] += a.visibleSubtreeCount);
  }
  i.childVisibleChunkSums = o;
}
function m(e, n, r, i) {
  let a = Math.min(n.childIds.length, r + t),
    o = i;
  for (let t = r; t < a; t++) {
    let r = n.childIds[t];
    if (r == null) continue;
    let i = e[r];
    if (i != null) {
      if (o < i.visibleSubtreeCount) return { childIndex: t, localVisibleIndex: o };
      o -= i.visibleSubtreeCount;
    }
  }
  throw Error(`Visible child index ${String(i)} is out of range`);
}
var h = 7,
  g = 3,
  _ = 1 << g,
...
function x(e) {
  return (e.depthAndFlags & _) >> g;
}
function S(e) {
  return (e.depthAndFlags & _) !== 0;
}
function C(e) {
  return e.depthAndFlags & h;
}
function w(e, t) {
  return (C(e) & t) !== 0;
}
...
function ee(e, t) {
  e.depthAndFlags = y(t, C(e), x(e));
}
var te = Symbol(`benchmarkInstrumentation`);
function ne(e, t) {
  return (
    t == null ||
      Object.defineProperty(e, te, { configurable: !0, enumerable: !1, value: t, writable: !1 }),
    e
  );
}
function re(e) {
  return e == null ? null : (e[te] ?? null);
}
function E(e, t, n) {
...
function ae(e) {
  let t = [],
    ...
    r = 0;
  for (; r < e.length; ) {
    for (; r < e.length && !ie(e.charCodeAt(r)); ) r += 1;
    if (r >= e.length) break;
    r > n && t.push(e.slice(n, r));
    let i = 0;
    for (; r < e.length && ie(e.charCodeAt(r)); ) ((i = i * 10 + (e.charCodeAt(r) - 48)), (r += 1));
    (t.push(i), (n = r));
  }
...
function O(e) {
  let t = e.toLowerCase();
  return { lowerValue: t, tokens: ae(t) };
}
function oe(e, t) {
...
function fe(e, t, n) {
  ...
  for (let n = 0; n < i; n++) {
    ...
    if (i === a) continue;
    let o = k(e, n);
    return o === k(t, n) ? ce(i, a, r) : o === 1 ? -1 : 1;
  }
  return e.segments.length === t.segments.length
    ? e.isDirectory === t.isDirectory
      ? 0
...
function A(e) {
  let { hasTrailingSlash: t, segments: n } = he(e);
...
function _e() {
  let e = new Map();
  return (e.set(ge, 0), { idByValue: e, valueById: [ge], sortKeyById: [O(ge)] });
}
function M(e, t) {
...
var ve = Symbol(`pathStorePreparedInputKind`);
function ye(e, t) {
  return ((e[ve] = t), e);
}
function be(e) {
...
function xe(e, t, n) {
  return n === `default` ? de(e, t) : n(be(e), be(t));
}
function Se() {
  return {
    depthAndFlags: y(0, 3, 1),
    nameId: 0,
    parentId: 0,
    subtreeNodeCount: 1,
...
function De(e, t = {}) {
  return Ne(e, t).map((e) => e.path);
}
function Oe(e, t = {}) {
  let n = Ne(e, t);
  return ye({ paths: n.map((e) => e.path), preparedPaths: n }, `prepared`);
}
function ke(e) {
  let t = e.length,
    n = !1;
  ...
  return ye({ paths: e, presortedPaths: e, presortedPathsContainDirectories: n }, `presorted`);
}
function Ae(e) {
  let t = e,
    n = t.preparedPaths;
  if (t[ve] === `prepared` && n != null) return n;
  if (!Te(n)) throw Error(`preparedInput must come from PathStore.prepareInput()`);
  return n;
}
function je(e) {
  let t = e;
  return (t[ve] === `presorted` && t.presortedPaths != null) || Ee(t.presortedPaths)
    ? t.presortedPaths
    : null;
}
function Me(e) {
...
function Ne(e, t = {}) {
  let n = me(t),
    r = re(t);
  D(r, `workload.inputFiles`, e.length);
  let i = E(r, `store.preparePathEntries.parse`, () => e.map((e) => A(e)));
  return (E(r, `store.preparePathEntries.sort`, () => i.sort((e, t) => xe(e, t, n.sort))), i);
}
var Pe = class {
  directories = new Map();
  directoryStack = [0];
  ...
  constructor(e = {}) {
    ((this.instrumentation = re(e)), (this.options = me(e)));
    ...
    this.directories.set(0, r());
  }
  appendPaths(e) {
    return E(this.instrumentation, `store.builder.appendPaths.parse`, () =>
      this.appendPreparedPaths(e.map((e) => A(e))),
    );
  }
  appendPreparedPaths(e, t = !0) {
    return (
      (this.createdDirectoriesAllExpanded = !1),
      E(this.instrumentation, `store.builder.appendPreparedPaths`, () => {
  ...
  appendPresortedPaths(e, t = null) {
    return (
      E(this.instrumentation, `store.builder.appendPresortedPaths`, () => {
        if (t === !1) {
        ...
        ((c.length = l + 1),
          n != null && (this.lastPreparedPath = A(n)),
  ...
  appendPresortedFilePaths(e) {
    ...
    ((s.length = c + 1),
      t != null && (this.lastPreparedPath = A(t)),
      (this.hasDeferredDirectoryIndexes = !0));
  }
  finish(e = {}) {
    ...
    return (
      this.hasDeferredDirectoryIndexes
        ? (E(this.instrumentation, `store.builder.buildDirectoryIndexes`, () =>
            this.buildPresortedFinish(t),
          ),
          (this.hasDeferredDirectoryIndexes = !1))
        : t ||
          E(this.instrumentation, `store.builder.computeSubtreeCounts`, () =>
  ...
  appendPreparedPath(e, t) {
    if (
      ...
      if (
        ...
        (this.options.sort === `default`
          ? fe(this.lastPreparedPath, e, this.segmentSortKeyCache)
          : xe(this.lastPreparedPath, e, this.options.sort)) > 0
      )
    ...
    let n = this.lastPreparedPath,
      r = we(e),
      i = n == null ? 0 : we(n),
      a = n == null ? 0 : Ce(n.segments, e.segments),
      o = Math.min(a, r, i);
  ...
  getOrCreateDirectoryChild(e, t) {
    let n = M(this.segmentTable, t),
      i = this.getDirectoryIndex(e);
    if (i.childIdByNameId != null) {
      let e = i.childIdByNameId.get(n);
      if (e !== void 0) {
        let n = this.nodes[e];
        if (n != null && !S(n))
    ...
    let a = this.nodes[e];
    if (a === void 0) throw Error(`Unknown parent node ID: ${String(e)}`);
    let o = this.nodes.length;
    return (
      this.nodes.push({
        depthAndFlags: y(b(a) + 1, 0, 1),
        nameId: n,
        parentId: e,
        subtreeNodeCount: 1,
        visibleSubtreeCount: 1,
      }),
      i.childIdByNameId != null && i.childIdByNameId.set(n, o),
      s(i, o),
      this.directories.set(o, r()),
      o
    );
  }
  ...
  promoteDirectoryToExplicit(e, t) {
    ...
    if (!S(n)) throw Error(`Path is not a directory: "${t}"`);
  ...
  buildPresortedFinish(e) {
    ...
    for (let e = 1; e < t.length; e++) {
      ...
      let s;
      (o.parentId === r ? (s = a) : ((s = n.get(o.parentId)), (r = o.parentId), (a = s ?? null)),
        s?.childIds.push(e));
    }
    if (!e)
  ...
  buildDirectoryIndexes() {
    ...
    for (let t = 1; t < e.length; t++) {
      let n = e[t];
      if (n == null) continue;
      S(n) && this.directories.set(t, r());
      let i = this.directories.get(n.parentId);
      i != null && (i.childIdByNameId != null && i.childIdByNameId.set(n.nameId, t), s(i, t));
    }
  }
  computeSubtreeCounts(e) {
    let t = this.nodes[e];
    if (t === void 0) throw Error(`Unknown node ID: ${String(e)}`);
    if (!S(t)) return ((t.subtreeNodeCount = 1), (t.visibleSubtreeCount = 1), 1);
    let n = this.getDirectoryIndex(e),
      r = 1;
    for (let e of n.childIds) r += this.computeSubtreeCounts(e);
    return (l(this.nodes, n), (t.subtreeNodeCount = r), (t.visibleSubtreeCount = r), r);
  }
};
function Fe(e, t = `closed`, n = null) {
  let r = Le(t);
  return {
...
function Re(e, t) {
  return w(t, 2) || e.defaultExpansion === `open`
    ...
    : e.defaultExpansion === `closed`
      ? !1
      : b(t) <= e.defaultExpansion;
}
function P(e, t, n = e.snapshot.nodes[t]) {
  return n == null || !S(n)
    ? !1
...
function F(e, t, n, r = e.snapshot.nodes[t]) {
...
function L(e, t, n) {
  return { ...n, visibleCountDelta: pt(e) - t };
}
function it(e, t) {
  let n = pt(e),
    r = Ie();
...
function R(e, t) {
  ...
  E(n, `store.events.record`, () => at(e, t));
}
function at(e, t) {
...
function ot(e, t, n, r = null) {
  ...
  if (i != null) {
    let n = e.instrumentation;
    n == null ? lt(i, t) : E(n, `store.events.batch.merge`, () => lt(i, t));
    return;
  }
  let a = st(t, r),
    o = e.instrumentation;
  ...
  E(o, `store.events.batch.commit`, () => dt(e, a));
}
function st(e, t) {
  return {
    affectedAncestorIds: [...e.affectedAncestorIds],
...
function mt(e, t) {
  let n = t == null ? e.snapshot.rootId : G(e, t);
  return n == null ? [] : St(e, n);
}
function ht(e, t) {
  let n = A(t),
    r = n.isDirectory ? n.segments : n.segments.slice(0, -1),
    i = J(e, It(e, r)),
    { createdNodeIds: a, directoryId: o } = Ct(e, r),
    s = new Set(a),
    c = o;
  if (n.isDirectory) {
    let n = q(e, o);
  ...
  } else ((c = Tt(e, o, n.basename)), s.add(c));
  U(e, o);
  let l = J(e, o);
  return qe({
    affectedAncestorIds: W(e, c),
    affectedNodeIds: [...s],
    path: t,
    projectionChanged: Lt(i, l),
  });
}
function gt(e, t, n) {
  let r = G(e, t);
  ...
  if (S(i) && K(e, r).childIds.length > 0 && n.recursive !== !0)
    throw Error(`Cannot remove a non-empty directory without recursive: "${t}"`);
  let a = i.parentId,
    o = J(e, a),
    s = Pt(e, r);
  (Ot(e, a, r, i.nameId), Ft(e, a), U(e, a));
  let c = J(e, a);
  return Je({
    affectedAncestorIds: W(e, a),
    affectedNodeIds: s,
    path: t,
    projectionChanged: Lt(o, c),
...
function _t(e, t, n, r) {
  ...
  let o = q(e, i);
  if (w(o, 2)) throw Error(`The root node cannot be moved`);
  let s = r.collision ?? `error`,
    c = Mt(e, i, n),
    l = J(e, o.parentId),
    u = J(e, c.parentId),
    d = N(e.snapshot.segmentTable, o.nameId),
    f = M(e.snapshot.segmentTable, c.basename);
  if (c.parentId === o.parentId && d === c.basename) return null;
  if (S(o) && Vt(e, i, c.parentId))
    throw Error(`Cannot move a directory into one of its descendants`);
  let p = a(e.snapshot.nodes, K(e, c.parentId)).get(f),
    m = c.existingNodeId ?? p ?? null;
  if (m != null && m !== i && Nt(e, m, s, x(o)) === `skip`) return null;
  let h = o.parentId;
  (Ot(e, h, i, o.nameId),
    ...
    e.pathCacheVersion++,
    U(e, h),
    c.parentId !== h && U(e, c.parentId));
  let g = J(e, h),
    _ = J(e, c.parentId);
  return Ye({
    affectedAncestorIds: [...new Set([...W(e, h), ...W(e, c.parentId)])],
    affectedNodeIds: [i],
    from: t,
    projectionChanged: Rt([l, u], [g, _]),
    to: H(e, i),
  });
}
function vt(e, t) {
...
function H(e, t) {
  let n = q(e, t),
    r = vt(e, t);
  if (r != null) return r;
  if (w(n, 2)) return yt(e, t, ``);
  let i = H(e, n.parentId),
    a = N(e.snapshot.segmentTable, n.nameId),
    o = i.length === 0 ? a : `${i}${a}`;
  return yt(e, t, S(n) ? `${o}/` : o);
}
function U(e, t) {
  let n = e.instrumentation;
  if (n == null) {
  ...
  E(n, `store.recomputeCountsUpwardFrom`, () => Ut(e, t));
}
function bt(e, t) {
  let n = [[t, 0]],
...
function G(e, t) {
  ...
  let n = j(t);
  return xt(e, n.segments, n.requiresDirectory);
}
function xt(e, t, n) {
...
function St(e, t) {
  ...
  if (!S(n)) return [H(e, t)];
  if (K(e, t).childIds.length === 0) return w(n, 1) && !w(n, 2) ? [H(e, t)] : [];
  let r = [],
  ...
  for (; i.length > 0; ) {
    ...
    if (!S(n)) {
      (r.push(H(e, t.nodeId)), i.pop());
      continue;
    }
    let a = K(e, t.nodeId);
    if (a.childIds.length === 0) {
      (w(n, 1) && !w(n, 2) && r.push(H(e, t.nodeId)), i.pop());
      continue;
    }
...
function Ct(e, t) {
  let n = [],
    r = e.snapshot.rootId;
  for (let i of t) {
    let t = M(e.snapshot.segmentTable, i),
      o = K(e, r),
      s = a(e.snapshot.nodes, o).get(t);
    if (s !== void 0) {
      if (!S(q(e, s)))
...
function wt(e, t, n) {
  let i = q(e, t),
    a = e.snapshot.nodes.length;
  return (
    e.snapshot.nodes.push({
      depthAndFlags: y(b(i) + 1, 0, 1),
      nameId: n,
      parentId: t,
      subtreeNodeCount: 1,
      visibleSubtreeCount: 1,
    }),
    e.snapshot.directories.set(a, r()),
    Dt(e, t, a),
    e.collapseNewDirectoriesByDefault &&
      (e.collapsedDirectoryIds.add(a), (e.hasCollapsedDirectoryOverrides = !0)),
    e.activeNodeCount++,
    a
  );
}
function Tt(e, t, n) {
  let r = M(e.snapshot.segmentTable, n),
    i = K(e, t);
  if (a(e.snapshot.nodes, i).has(r)) throw Error(`Path already exists: "${Gt(e, t, n)}"`);
  let o = q(e, t),
    s = e.snapshot.nodes.length;
  return (
    e.snapshot.nodes.push({
      depthAndFlags: y(b(o) + 1, 0),
      nameId: r,
...
function Dt(e, t, n) {
  let r = K(e, t),
    i = q(e, n);
  (a(e.snapshot.nodes, r).set(i.nameId, n), u(r, n, i.subtreeNodeCount, i.visibleSubtreeCount));
  let o = Et(e, r, n);
  (r.childIds.splice(o, 0, n), c(r, o), p(e.snapshot.nodes, r));
}
function Ot(e, t, n, r) {
  let i = K(e, t),
    s = o(i),
    l = s.get(n) ?? -1;
  (a(e.snapshot.nodes, i).delete(r), s.delete(n));
  let d = e.snapshot.nodes[n];
  (d != null && u(i, n, -d.subtreeNodeCount, -d.visibleSubtreeCount),
    l >= 0 && (i.childIds.splice(l, 1), c(i, l), p(e.snapshot.nodes, i)));
}
function kt(e, t, n) {
  let r = e.snapshot.options.sort;
  return r === `default` ? At(e, t, n) : r(jt(e, t), jt(e, n));
}
function At(e, t, n) {
  let r = q(e, t),
    i = q(e, n),
    a = S(r);
  if (a !== S(i)) return a ? -1 : 1;
  let o = se(pe(e.snapshot.segmentTable, r.nameId), pe(e.snapshot.segmentTable, i.nameId));
  if (o !== 0) return o;
  let s = N(e.snapshot.segmentTable, r.nameId),
    c = N(e.snapshot.segmentTable, i.nameId);
...
function jt(e, t) {
  let n = q(e, t),
    ...
    a = i ? r.slice(0, -1) : r;
  return {
    basename: N(e.snapshot.segmentTable, n.nameId),
    depth: b(n),
    isDirectory: i,
    path: r,
...
function Mt(e, t, n) {
  ...
  if (i != null) {
    let t = q(e, i);
    if (S(t))
      return { basename: N(e.snapshot.segmentTable, r.nameId), existingNodeId: null, parentId: i };
    let a = j(n).segments;
  ...
  let a = j(n),
    ...
    c = s.length === 0 ? e.snapshot.rootId : xt(e, s, !0);
...
function Nt(e, t, n, r) {
  ...
  if (n === `error`) throw Error(`Destination already exists: "${H(e, t)}"`);
  let i = q(e, t);
  if (x(i) !== r) throw Error(`replace collision requires the same source and destination kinds`);
  if (S(i) && K(e, t).childIds.length > 0)
    throw Error(`replace collision does not support non-empty directories`);
  let a = i.parentId,
    o = i.nameId;
  return (Pt(e, t), Ot(e, a, t, o), Ft(e, a), U(e, a), `handled`);
}
function Pt(e, t) {
  let n = [],
  ...
  for (; r.length > 0; ) {
    ...
    if (t == null) break;
    let i = q(e, t.nodeId);
    if (t.visitedChildren || !S(i)) {
      (S(i) && e.snapshot.directories.delete(t.nodeId),
        T(i, 4),
...
function Ft(e, t) {
  ...
  for (; n != null; ) {
    let t = q(e, n);
    if (!S(t) || w(t, 2) || K(e, n).childIds.length > 0) return;
...
function It(e, t) {
  ...
  for (let r of t) {
    ...
    if (t == null) break;
    let i = a(e.snapshot.nodes, K(e, n)).get(t);
    if (i == null || !S(q(e, i))) break;
    n = i;
  }
  return n;
}
...
function Bt(e, t) {
  let n = q(e, t);
  if ((ee(n, (t === e.snapshot.rootId ? -1 : b(q(e, n.parentId))) + 1), !S(n))) return;
  let r = K(e, t);
  for (let t of r.childIds) Bt(e, t);
}
function Vt(e, t, n) {
  let r = n;
  for (; r != null; ) {
...
function Ht(e, t, n = q(e, t), r = !1) {
  let i = e.instrumentation;
  if (i == null) {
    Wt(e, t, n, r);
    return;
  }
  E(i, `store.recomputeNodeCounts`, () => Wt(e, t, n, r));
}
function Ut(e, t) {
  let n = t;
  for (; n != null; ) {
    ...
    if ((Ht(e, n, t), n === e.snapshot.rootId)) return;
    let a = t.subtreeNodeCount - r,
      o = t.visibleSubtreeCount - i,
      s = t.parentId;
    ((a !== 0 || o !== 0) && u(K(e, s), n, a, o), (n = s));
  }
}
function Wt(e, t, n, r) {
  if (!S(n)) {
  ...
  if (r) {
    ...
    t == null
      ? l(e.snapshot.nodes, i)
      : E(t, `store.recomputeNodeCounts.rebuildChildAggregates`, () => l(e.snapshot.nodes, i));
  }
  ...
  n.visibleSubtreeCount = z(e, t) == null ? (P(e, t, n) ? 1 + o : 1) : o;
}
function Gt(e, t, n) {
  let r = H(e, t);
...
function X(e, t) {
  let n = e.snapshot.nodes[t];
  return !Y(n) || !S(n) || w(n, 2) ? null : n;
}
function Kt(e) {
  let t = 0;
  for (let [n, r] of e.pathCacheByNodeId)
    r.version === e.pathCacheVersion && Y(e.snapshot.nodes[n]) && (t += 1);
  return t;
}
function qt(e) {
...
function Jt(e) {
  return {
    ...
    cachedPathEntryCount: Kt(e),
    loadInfoEntryCount: e.directoryLoadInfoById.size,
    segmentCount: qt(e.snapshot.segmentTable),
...
function Xt(e) {
  let t = [],
    n = [];
  for (let n of e.collapsedDirectoryIds) X(e, n) != null && t.push(H(e, n));
  for (let t of e.expandedDirectoryIds) X(e, t) != null && n.push(H(e, t));
...
function Qt(e, t) {
  ...
  for (let n of t.expandedPaths) {
    let t = G(e, n);
    t != null && F(e, t, !0, q(e, t));
  }
  for (let n of t.collapsedPaths) {
    let t = G(e, n);
    t != null && F(e, t, !1, q(e, t));
  }
}
function $t(e, t) {
...
function an(e) {
  let t = Xt(e),
    n = Zt(e);
  (E(e.instrumentation, `store.cleanup.stable.clearPathCaches`, () => en(e)),
    E(e.instrumentation, `store.cleanup.stable.rebuildSegmentTable`, () => tn(e)),
    E(e.instrumentation, `store.cleanup.stable.rebuildDirectoryIndexes`, () => nn(e)),
    E(e.instrumentation, `store.cleanup.stable.trimTrailingRemovedNodeSlots`, () => rn(e)),
    E(e.instrumentation, `store.cleanup.stable.restoreExpansionOverrides`, () => Qt(e, t)),
    E(e.instrumentation, `store.cleanup.stable.restoreDirectoryLoadInfos`, () => $t(e, n)),
    E(e.instrumentation, `store.cleanup.stable.recomputeCounts`, () => bt(e, e.snapshot.rootId)));
}
function on(e) {
  let t = Xt(e),
    n = Zt(e),
    r = E(e.instrumentation, `store.cleanup.aggressive.listPaths`, () => mt(e)),
    i = ne({ ...e.snapshot.options }, e.instrumentation),
    a = E(e.instrumentation, `store.cleanup.aggressive.rebuildSnapshot`, () => {
      let e = new Pe(i);
  ...
  ((e.snapshot = a),
    ...
    E(e.instrumentation, `store.cleanup.aggressive.restoreExpansionOverrides`, () => Qt(e, t)),
    E(e.instrumentation, `store.cleanup.aggressive.restoreDirectoryLoadInfos`, () => $t(e, n)),
    E(e.instrumentation, `store.cleanup.aggressive.recomputeCounts`, () =>
      bt(e, e.snapshot.rootId),
    ));
}
function sn(e) {
...
function cn(e, t) {
  let n = Jt(e);
  t === `stable`
    ? E(e.instrumentation, `store.cleanup.stable`, () => an(e))
    : E(e.instrumentation, `store.cleanup.aggressive`, () => on(e));
  let r = Jt(e);
  return Yt(t, t === `stable`, n, r);
}
var ln = 64;
function un(e, t) {
  let n = t + 2;
...
function fn(e, t, n, r) {
  return {
    ...
    row: $(e, t.cursor),
    setSize: t.setSize,
    subtreeEndIndex: dn(e, t.cursor, t.index, n),
  };
}
function pn(e, t, n, r, i, a) {
  let o = K(e, t),
    { childIndex: s, childVisibleIndex: c, localVisibleIndex: l } = d(e.snapshot.nodes, o, n),
    u = o.childIds[s];
  if (u == null) throw Error(`Visible index ${String(n)} is out of range`);
  return mn(e, u, l, r + c, i + 1, s, o.childIds.length, a);
}
function mn(e, t, n, r, i, a, o, s) {
  ...
  if (!S(l) || !P(e, c.terminalNodeId, l))
    throw Error(`Visible index ${String(n)} is out of range for collapsed directory`);
  return pn(e, c.terminalNodeId, n - 1, r + 1, c.visibleDepth, [
    ...s,
...
function hn(e, t) {
  ...
  let r = pn(e, e.snapshot.rootId, t, 0, -1, []),
    i = r.ancestors.map((t) => H(e, t.cursor.terminalNodeId)),
    a = null;
  return {
    ancestorPaths: i,
    get ancestorRows() {
    ...
    row: $(e, r.cursor),
    setSize: r.setSize,
    subtreeEndIndex: dn(e, r.cursor, r.index, n),
  };
}
function gn(e, t, n) {
  ...
  let s = [],
    c = 0,
    l = 0,
    u = E(r, `store.getVisibleSlice.selectFirstRow`, () => Sn(e, a));
  for (let t = a; t <= o && u != null; t++) {
    let t = E(r, `store.getVisibleSlice.materializeRow`, () => $(e, u));
    (s.push(t),
      t.isFlattened && (c++, (l += t.flattenedSegments?.length ?? 0)),
      (u = E(r, `store.getVisibleSlice.advanceCursor`, () => En(e, u))));
  }
  return (
    D(r, `workload.visibleRowsRead`, s.length),
    D(r, `workload.flattenedRowsRead`, c),
    D(r, `workload.flattenedSegmentsRead`, l),
    s
  );
}
function _n(e, t = Z(e)) {
  let n = e.instrumentation;
  return n == null ? On(e, t) : E(n, `store.getVisibleTreeProjection`, () => On(e, t));
}
function vn(e) {
  return Dn(_n(e));
}
function yn(e, t) {
  let n = G(e, t);
  if (n == null || n === e.snapshot.rootId || (S(q(e, n)) && B(e, n) !== n)) return null;
  let r = 0,
    i = n,
    { nodes: a, rootId: s } = e.snapshot;
  for (; i !== s; ) {
    let t = q(e, i).parentId,
      n = K(e, t),
      c = o(n).get(i);
    if (c == null) throw Error(`Child ${String(i)} was not found in its parent index`);
    if (((r += f(a, n, c)), t !== s)) {
      let n = q(e, t),
        a = z(e, t);
      if (!P(e, t, n) && a !== i) return null;
      B(e, t) === t && (r += 1);
    }
    i = t;
  }
...
function bn(e, t) {
  ...
  let r = q(e, n);
  if (!S(r)) throw Error(`Path is not a directory: "${t}"`);
  return P(e, n, r)
    ? null
    : (F(e, n, !0, r),
      U(e, n),
      Xe({ affectedAncestorIds: W(e, n), affectedNodeIds: [n], path: t, projectionChanged: !0 }));
}
function xn(e, t) {
  let n = G(e, t);
  if (n == null) throw Error(`Path does not exist: "${t}"`);
  ...
  return P(e, n, r)
    ? (F(e, n, !1, r),
      U(e, n),
      Ze({ affectedAncestorIds: W(e, n), affectedNodeIds: [n], path: t, projectionChanged: !0 }))
    : null;
}
function Sn(e, t) {
  return t < 0 || t >= Z(e) ? null : Cn(e, e.snapshot.rootId, t, -1);
}
function Cn(e, t, n, r) {
  let i = K(e, t),
    a = e.instrumentation,
    { childIndex: o, localVisibleIndex: s } =
      a == null
        ? d(e.snapshot.nodes, i, n)
        : E(a, `store.getVisibleSlice.selectChildIndex`, () => d(e.snapshot.nodes, i, n)),
    c = i.childIds[o];
  if (c != null) return Q(e, c, s, r + 1);
...
function Q(e, t, n, r) {
  ...
  if (!S(a) || !P(e, i.terminalNodeId, a))
    throw Error(`Visible index ${String(n)} is out of range for collapsed directory`);
  return Cn(e, i.terminalNodeId, n - 1, i.visibleDepth);
}
function wn(e, t, n) {
  return S(q(e, t))
    ? e.instrumentation == null
      ? { headNodeId: t, terminalNodeId: B(e, t), visibleDepth: n }
      : {
          headNodeId: t,
          terminalNodeId: E(
            e.instrumentation,
...
function Tn(e, t) {
  ...
  if (!S(n)) return !0;
  let r = n.parentId;
  return r === e.snapshot.rootId ? !0 : z(e, r) !== t;
}
function En(e, t) {
  let n = q(e, t.terminalNodeId);
  if (S(n)) {
    let r = K(e, t.terminalNodeId);
    if (P(e, t.terminalNodeId, n) && r.childIds.length > 0) {
      let n = r.childIds[0];
      return n == null ? null : Q(e, n, 0, t.visibleDepth + 1);
    }
  }
  ...
  for (;;) {
    ...
    let n = t.parentId,
      a = K(e, n),
      s = o(a).get(r) ?? -1;
    if (s < 0) throw Error(`Child ${String(r)} was not found in its parent index`);
    let c = a.childIds[s + 1] ?? null;
    if (c != null) return Q(e, c, 0, i);
    (Tn(e, r) && i--, (r = n));
  }
}
function Dn(e) {
...
function On(e, t) {
  ...
  for (; d.length > 0 && s < t; ) {
    ...
    let x,
      C = _;
    if (S(v)) ((C = f ? B(e, _) : _), (x = C === _ ? `${b}${h[v.nameId]}/` : H(e, C)));
    else {
      let e = p.get(_);
    ...
    let w = c[C];
    w != null && S(w) && P(e, C, w) && d.push([l.get(C), 0, y, x]);
  }
  s < t && (n.length = s);
  ...
  for (; s.length > 0 && r < t; ) {
    ...
    if (!S(p)) {
      ...
      n[r++] = {
        ...
        loadState: void 0,
        name: c[p.nameId],
        path: t != null && t.version === d ? t.path : H(e, f),
      };
      continue;
    }
    let h = l ? B(e, f) : f,
    ...
    n[r++] = $(e, g);
    let _ = i[h];
    _ != null && S(_) && P(e, h, _) && s.push([a.get(h), 0, m]);
  }
...
function $(e, t) {
  let n = q(e, t.terminalNodeId),
    r = S(n) ? An(e, t) : null,
    i = H(e, t.terminalNodeId),
    a = N(e.snapshot.segmentTable, n.nameId),
    o = S(n) && K(e, t.terminalNodeId).childIds.length > 0,
    s = t.headNodeId !== t.terminalNodeId,
    c = e.instrumentation,
    l = s
      ? c == null
        ? V(e, t.headNodeId).map((n) => {
            let r = q(e, n);
            return {
              isTerminal: n === t.terminalNodeId,
              name: N(e.snapshot.segmentTable, r.nameId),
              nodeId: n,
              path: H(e, n),
            };
          })
        : E(c, `store.getVisibleSlice.flatten.collectSegments`, () =>
            V(e, t.headNodeId).map((n) => {
              let r = q(e, n);
              return {
                isTerminal: n === t.terminalNodeId,
  ...
  return {
    ...
    hasChildren: o,
    id: t.terminalNodeId,
    isExpanded: S(n) && P(e, t.terminalNodeId, n),
    isFlattened: s,
    isLoading: r === `loading`,
    kind: S(n) ? `directory` : `file`,
...
function An(e, t) {
  if (t.headNodeId === t.terminalNodeId) return I(e, t.terminalNodeId);
  let n = V(e, t.headNodeId),
    r = !1,
    i = !1;
  for (let t of n) {
    let n = I(e, t);
...
var Nn = class e {
  ...
  constructor(e = {}) {
    let t = re(e),
      n = E(t, `store.builder.create`, () => new Pe(e));
    if (e.preparedInput != null) {
      let t = je(e.preparedInput);
      t == null
        ? n.appendPreparedPaths(Ae(e.preparedInput), !1)
        : n.appendPresortedPaths(t, Me(e.preparedInput));
    } else {
      let r = e.paths ?? [];
      e.presorted === !0
        ? n.appendPaths(r)
        : n.appendPreparedPaths(E(t, `store.preparePathEntries`, () => Ne(r, e)));
    }
    let r = E(t, `store.builder.finish`, () => n.finish({ skipSubtreeCountPass: !0 })),
      i = E(
        t,
        `store.state.detectAllDirectoriesExpanded`,
        () => (e.initialExpansion ?? `closed`) === `closed` && n.didMatchAllInitialExpandedPaths(),
      );
    ((this.#e = E(t, `store.state.create`, () =>
      Fe(r, i ? `open` : (e.initialExpansion ?? `closed`), t),
    )),
      i && (this.#e.collapseNewDirectoriesByDefault = !0));
    let a = i
      ? this.#e.snapshot.directories.size - 1
      : E(t, `store.state.initializeExpandedPaths`, () =>
    ...
    ((e.initialExpandedPaths?.length ?? 0) > 0 &&
      E(t, `store.state.checkAllDirectoriesExpanded`, () => this.hasAllDirectoriesExpanded()))
      ? E(t, `store.state.initializeOpenVisibleCounts`, () => jn(this.#e))
      : E(t, `store.state.recomputeCounts`, () => bt(this.#e, this.#e.snapshot.rootId));
  }
  ...
  list(e) {
    return E(this.#e.instrumentation, `store.list`, () => mt(this.#e, e));
  }
  add(e) {
    E(this.#e.instrumentation, `store.add`, () => {
      let t = Z(this.#e);
      R(this.#e, L(this.#e, t, ht(this.#e, e)));
    });
  }
  remove(e, t = {}) {
    E(this.#e.instrumentation, `store.remove`, () => {
      let n = Z(this.#e);
      R(this.#e, L(this.#e, n, gt(this.#e, e, t)));
    });
  }
  move(e, t, n = {}) {
    E(this.#e.instrumentation, `store.move`, () => {
      let r = Z(this.#e),
        i = _t(this.#e, e, t, n);
      i != null && R(this.#e, L(this.#e, r, i));
    });
  }
  batch(e) {
    it(this.#e, () => {
  ...
  getVisibleCount() {
    return E(this.#e.instrumentation, `store.getVisibleCount`, () => Z(this.#e));
  }
  getVisibleSlice(e, t) {
    return E(this.#e.instrumentation, `store.getVisibleSlice`, () => gn(this.#e, e, t));
  }
  getVisibleRowContext(e) {
    return E(this.#e.instrumentation, `store.getVisibleRowContext`, () => hn(this.#e, e));
  }
  ...
  getVisibleIndex(e) {
    return E(this.#e.instrumentation, `store.getVisibleIndex`, () => yn(this.#e, e));
  }
  getPathInfo(e) {
    return E(this.#e.instrumentation, `store.getPathInfo`, () => {
      let t = G(this.#e, e);
      if (t == null) return null;
      let n = q(this.#e, t);
      return { depth: b(n), kind: S(n) ? `directory` : `file`, path: H(this.#e, t) };
    });
  }
  isExpanded(e) {
    return E(this.#e.instrumentation, `store.isExpanded`, () => {
  ...
  expand(e) {
    E(this.#e.instrumentation, `store.expand`, () => {
      let t = Z(this.#e),
        n = bn(this.#e, e);
      n != null && R(this.#e, L(this.#e, t, n));
    });
  }
  collapse(e) {
    E(this.#e.instrumentation, `store.collapse`, () => {
      let t = Z(this.#e),
        n = xn(this.#e, e);
      n != null && R(this.#e, L(this.#e, t, n));
    });
  ...
  markDirectoryUnloaded(e) {
    E(this.#e.instrumentation, `store.markDirectoryUnloaded`, () => {
      let t = this.requireDirectoryNodeId(e);
      ...
      (Ve(this.#e, t),
        R(
          ...
          L(
            ...
            n,
            Qe({
              affectedAncestorIds: W(this.#e, t),
              affectedNodeIds: [t],
              path: e,
  ...
  beginChildLoad(e) {
    return E(this.#e.instrumentation, `store.beginChildLoad`, () => {
      let t = this.requireDirectoryNodeId(e),
        n = Z(this.#e),
        r = Be(this.#e, t);
      return (
  ...
  applyChildPatch(e, t) {
    return E(this.#e.instrumentation, `store.applyChildPatch`, () => {
      let n = this.resolveActiveDirectoryNodeId(e.nodeId);
      if (n == null || I(this.#e, n) !== `loading` || !Ue(this.#e, n, e.attemptId)) return !1;
      let r = H(this.#e, n);
      ...
      for (let e of t.operations) {
        ...
        switch (e.type) {
          case `add`:
            a.push(L(this.#e, t, ht(this.#e, e.path)));
            break;
          case `remove`:
            a.push(L(this.#e, t, gt(this.#e, e.path, { recursive: e.recursive })));
            break;
          case `move`: {
            let n = _t(this.#e, e.from, e.to, { collision: e.collision });
            n != null && a.push(L(this.#e, t, n));
            break;
          }
        }
      }
      ...
      return (
        R(
          ...
          L(
            ...
            i,
            et({
              affectedAncestorIds: W(this.#e, n),
              affectedNodeIds: [n],
              attemptId: e.attemptId,
              childEvents: a,
              path: H(this.#e, n),
  ...
  completeChildLoad(e) {
    return E(this.#e.instrumentation, `store.completeChildLoad`, () => {
      let t = this.resolveActiveDirectoryNodeId(e.nodeId);
      if (t == null) return !1;
      let n = Z(this.#e),
        r = He(this.#e, t, e.attemptId);
      return (
        R(
          this.#e,
          L(
  ...
  failChildLoad(e, t) {
    return E(this.#e.instrumentation, `store.failChildLoad`, () => {
      let n = this.resolveActiveDirectoryNodeId(e.nodeId);
      if (n == null) return !1;
      let r = Z(this.#e),
        i = We(this.#e, n, e.attemptId, t);
      return (
        R(
          this.#e,
          L(
  ...
  cleanup(e = {}) {
    return E(this.#e.instrumentation, `store.cleanup`, () => {
      if (this.#e.transactionStack.length > 0)
        throw Error(`Cleanup cannot run during an open batch or transaction.`);
      if (sn(this.#e)) throw Error(`Cleanup cannot run while directory loads are active.`);
      let t = Z(this.#e),
        n = cn(this.#e, e.mode ?? `stable`);
      return (
        R(
          this.#e,
          L(
  ...
  initializeExpandedPaths(e) {
    ...
    for (let u of e) {
      ...
      for (let e = d; e < m; e += 1) {
        ...
        if (n == null) continue;
        let i = q(this.#e, n);
        P(this.#e, n, i) || (F(this.#e, n, !0, i), (t += 1));
      }
    }
    return t;
  }
  ...
  requireDirectoryNodeId(e) {
    ...
    if (!S(q(this.#e, t))) throw Error(`Path is not a directory: "${e}"`);
    return t;
  }
  resolveActiveDirectoryNodeId(e) {
    try {
      if (!S(q(this.#e, e))) throw Error(`Node is not a directory: ${String(e)}`);
      return e;
    } catch {
      return null;
    }
...
export { Nn as t };
//# sourceMappingURL=store-1Wh-oeLs.js.map
