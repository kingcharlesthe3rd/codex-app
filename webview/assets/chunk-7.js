...
import { u as n } from "./chunk-34.js";
import { s as r, y as i } from "./chunk-87.js";
import { a, i as o, s } from "./chunk-30.js";
import { a as c, i as l, n as u, r as d } from "./chunk-67.js";
var f = {
    common: r,
    getConfig: i,
    insertCluster: o,
...
t(() => {
  m([
    { name: `dagre`, loader: t(async () => await import(`./dagre-10.js`), `loader`) },
    ...[
      {
        name: `cose-bilkent`,
        loader: t(async () => await import(`./cose-bilkent-2.js`), `loader`),
      },
    ],
  ]);
...
var h = t(async (e, t) => {
  ...
  g = t((t = ``, { fallback: n = `dagre` } = {}) => {
    if (t in p) return t;
    if (n in p)
      return (e.warn(`Layout algorithm ${t} is not registered. Using ${n} as fallback.`), n);
