...
e(() => {
  ((t = `#f9f9f7`),
    ...
    (i = `Absolutely Light`),
    (a = [
      { scope: [`comment`, `punctuation.definition.comment`], settings: { foreground: `#939391` } },
...
export { t as bg, n as colors, s as default, r as fg, i as name, a as settings, o as type };
