...
import { us as c } from "./app-server-manager-signals.js";
import { A as l, _ as u, f as d, n as f, r as p } from "./vscode-api.js";
import "./isEqual.js";
import { Er as m } from "./src-2.js";
import "./react-dom.js";
...
import { a as E, i as D, l as O, n as k, r as A } from "./dialog-layout-B.js";
...
import { n as M, r as N } from "./use-in-app-browser-use-availability.js";
import "./plus.js";
...
import { t as P } from "./use-platform.js";
import "./browser-sidebar-availability.js";
import { m as F, y as I } from "./use-plugins.js";
import "./apps-queries.js";
import "./startCase.js";
import "./plugin-detail-queries.js";
import { j as L } from "./mention-item.js";
import "./notion.js";
...
import "./chevron.js";
import { a as R, m as z, p as B } from "./chunk-9.js";
...
import { m as ee } from "./links-p.js";
import "./use-codex-pricing-url.js";
import "./plan-management-state.js";
import { c as te, l as ne, m as re } from "./use-plugin-install-flow.js";
import "./three-dots.js";
import { t as ie } from "./trash.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as H } from "./settings-host-context.js";
import "./lock.js";
...
import { i as ue, t as de } from "./settings-shared.js";
...
import { l as fe, t as pe } from "./browser-use-origin-state-queries.js";
import "./plugins-availability.js";
import { r as G } from "./settings-row.js";
import { t as K } from "./settings-surface.js";
import { t as q } from "./settings-group.js";
import "./settings-empty-state.js";
import { t as me } from "./use-home-directory.js";
...
import { f as J, l as he, m as ge, o as _e, p as ve, s as ye } from "./browser-use-settings-1.js";
var be = e(t(), 1),
  Y = s(),
  X = n();
function xe(e) {
...
function Se(e) {
  ...
  let r = n.isConnected ? `bg-[var(--color-icon-success)]` : `bg-[var(--color-icon-error)]`,
    i;
  t[1] === r ? (i = t[2]) : ((i = v(`h-2 w-2 shrink-0 rounded-full`, r)), (t[1] = r), (t[2] = i));
  let a;
  t[3] === i ? (a = t[4]) : ((a = (0, X.jsx)(`span`, { className: i })), (t[3] = i), (t[4] = a));
  let o;
  t[5] === n.isConnected
    ? (o = t[6])
    : ((o = (0, X.jsx)(`span`, {
        ...
        children: n.isConnected
          ? (0, X.jsx)(_, { ...Z.connected })
          : (0, X.jsx)(_, { ...Z.disconnected }),
      })),
      (t[5] = n.isConnected),
      (t[6] = o));
  let s;
...
var Q = h({
  ...
  Ce = `` + new URL(`chrome-production-large-BLPyHeGg.png`, import.meta.url).href,
  we = `computer-use`,
  Te = `computer-use`,
  Ee = `chrome`,
  De = `chrome-dev`,
  Oe = `chrome-internal`,
  ke = `/settings/computer-use/google-chrome`,
  Ae = `foregroundClicks`,
  $ = [
    { value: `foregroundClicks`, label: Q.foregroundClickSounds },
    { value: `foregroundAndBackgroundClicks`, label: Q.foregroundAndBackgroundClickSounds },
    { value: `off`, label: Q.noClickSounds },
  ];
function je() {
  let e = (0, Y.c)(20),
    { selectedHostId: t } = H(),
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, X.jsx)(q.Header, { title: (0, X.jsx)(_, { ...Q.control }) })), (e[5] = l))
    : (l = e[5]);
  let u;
  e[6] === a
    ? (u = e[7])
    : ((u = (0, X.jsx)(Me, { computerUseAvailability: a })), (e[6] = a), (e[7] = u));
  let d;
  e[8] !== n || e[9] !== a.available || e[10] !== o
    ? ((d = o === `macOS` && a.available && n ? (0, X.jsx)(Be, {}) : null),
      (e[8] = n),
      (e[9] = a.available),
      (e[10] = o),
      (e[11] = d))
  ...
  let f;
  e[12] !== u || e[13] !== d
    ? ((f = (0, X.jsxs)(q, { children: [l, (0, X.jsxs)(q.Content, { children: [u, d] })] })),
      (e[12] = u),
      (e[13] = d),
      (e[14] = f))
    : (f = e[14]);
    ...
    : ((p = a.available
        ? (0, X.jsxs)(X.Fragment, {
            children: [
              (0, X.jsxs)(q, {
                children: [
                  (0, X.jsx)(q.Header, { title: (0, X.jsx)(_, { ...Q.alwaysAllowedApps }) }),
                  (0, X.jsx)(q.Content, {
                    children: (0, X.jsx)(K, { children: (0, X.jsx)(Ue, {}) }),
                  }),
                ],
              }),
              (0, X.jsx)(Re, {}),
  ...
  return (
    e[17] !== f || e[18] !== p
      ? ((m = (0, X.jsxs)(W, { title: s, subtitle: c, children: [f, p] })),
        (e[17] = f),
        (e[18] = p),
        (e[19] = m))
      : (m = e[19]),
...
function Me(e) {
  let t = (0, Y.c)(48),
    { computerUseAvailability: n } = e,
    r = z(),
    { selectedHostId: i } = H(),
    a = c(i).kind === `local`,
    o;
  t[0] === i ? (o = t[1]) : ((o = { hostId: i }), (t[0] = i), (t[1] = o));
  let s = M(o),
    l;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((l = []), (t[2] = l)) : (l = t[2]);
  let u = F(i, l),
    d = me(i),
    f;
  t[3] !== d || t[4] !== u.availablePlugins
    ? ((f = J(u.availablePlugins, Te, d)), (t[3] = d), (t[4] = u.availablePlugins), (t[5] = f))
    : (f = t[5]);
  let p = f,
    m;
  t[6] !== d || t[7] !== u.availablePlugins
    ? ((m = Ke(u.availablePlugins, d)), (t[6] = d), (t[7] = u.availablePlugins), (t[8] = m))
    : (m = t[8]);
  let h = m,
    g = h?.plugin.installed === !0,
    v = g && h.plugin.enabled,
    b;
  t[9] !== h || t[10] !== g || t[11] !== i
    ? ((b = { hostId: i, plugin: h, shouldReadBrowserExtension: g }),
      (t[9] = h),
      (t[10] = g),
      (t[11] = i),
      (t[12] = b))
  ...
  if (
    ...
    let e;
    if (
      (t[23] !== h || t[24] !== s || t[25] !== a
        ? ((e =
            h == null && a && !s.isLoading && !s.allowed
              ? [
                  {
                    description: (0, X.jsx)(_, { ...L.restrictedAvailabilityDescription }),
                    icon: (0, X.jsx)(`img`, {
                      alt: ``,
                    ...
                    title: (0, X.jsx)(_, { ...Q.googleChrome }),
                  },
                ]
              : []),
          (t[23] = h),
      ...
      (t[29] === p
        ? (r = t[30])
        : ((r = { plugin: p, title: e, description: n }), (t[29] = p), (t[30] = r)),
        S.push(r));
    }
    if (h != null) {
      let e;
      t[31] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, X.jsx)(_, { ...Q.googleChrome })), (t[31] = e))
        : (e = t[31]);
      let n;
      t[32] === x ? (n = t[33]) : ((n = (0, X.jsx)(Se, { status: x })), (t[32] = x), (t[33] = n));
      let i;
      t[34] !== v || t[35] !== r
        ? ((i = v
            ? (0, X.jsx)(y, {
        ...
        : (i = t[36]);
      let a;
      (t[37] !== h || t[38] !== n || t[39] !== i
        ? ((a = { plugin: h, title: e, description: n, action: i }),
          (t[37] = h),
          (t[38] = n),
          (t[39] = i),
          (t[40] = a))
...
function Pe() {
  ...
  let s = F(r, a),
    c = me(r),
    l;
  e[1] !== c || e[2] !== s.installedPlugins
    ? ((l = Ke(s.installedPlugins, c)), (e[1] = c), (e[2] = s.installedPlugins), (e[3] = l))
    : (l = e[3]);
  let u = l,
    p = u?.plugin.installed === !0,
    m = p && u.plugin.enabled,
    h;
  e[4] !== u || e[5] !== p || e[6] !== r
    ? ((h = { hostId: r, plugin: u, shouldReadBrowserExtension: p }),
      (e[4] = u),
      (e[5] = p),
      (e[6] = r),
      (e[7] = h))
      ...
      e[10] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((r = (0, X.jsx)(W, {
            ...
            children: (0, X.jsx)(`div`, {
              ...
              children: (0, X.jsx)(b, { className: `icon-xs` }),
            }),
          })),
          (e[10] = r))
        : (r = e[10]),
  ...
  if (!s.isLoading && !m) {
    ...
    return (
      e[11] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, X.jsx)(R, { to: `/settings/computer-use`, replace: !0 })), (e[11] = t))
        : (t = e[11]),
      t
    );
  }
  ...
  e[12] === v
    ...
    : ((E = () => {
        v?.url != null &&
          d.dispatchMessage(`open-in-browser`, { url: v.url, useExternalBrowser: !0 });
      }),
      (e[12] = v),
      (e[13] = E));
  let D;
  ...
  e[15] !== T || e[16] !== E
    ...
    : (O = e[17]);
  let k;
  e[18] !== x || e[19] !== S || e[20] !== w || e[21] !== n || e[22] !== t
    ? ((k =
        n === `macOS` || n === `windows`
          ? (0, X.jsx)(y, {
              color: `danger`,
              ...
              onClick: () => {
                x != null &&
                  f(`chrome-extension-settings-open`, { params: { extensionId: x } }).catch(() => {
                    t.get(C).danger(
                      (0, X.jsx)(_, {
  ...
  let A;
  e[24] !== O || e[25] !== k
    ? ((A = (0, X.jsxs)(`div`, { className: `flex items-center gap-2`, children: [O, k] })),
      (e[24] = O),
      (e[25] = k),
      (e[26] = A))
    : (A = e[26]);
  ...
  let M;
  e[28] !== S || e[29] !== w
    ? ((M = w ? null : (0, X.jsx)(Ie, { installed: S })), (e[28] = S), (e[29] = w), (e[30] = M))
    : (M = e[30]);
  let N;
          ...
          (0, X.jsx)(q.Content, {
            children: (0, X.jsxs)(K, {
              children: [
                (0, X.jsx)(_e, {}),
                (0, X.jsx)(he, {}),
                (0, X.jsx)(Fe, { kind: `download` }),
                (0, X.jsx)(Fe, { kind: `upload` }),
              ],
            }),
          }),
        ],
      })),
      (z = (0, X.jsx)(ye, { surface: `googleChrome` })),
      (B = (0, X.jsx)(ge, {})),
      (e[33] = L),
      (e[34] = z),
      (e[35] = B))
    : ((L = e[33]), (z = e[34]), (B = e[35]));
  let V;
  return (
    e[36] !== M || e[37] !== A
      ? ((V = (0, X.jsxs)(W, {
...
function Fe(e) {
  let t = (0, Y.c)(39),
    { kind: n } = e,
    r = i(o),
    { data: s, isLoading: c } = a(pe),
    l = fe(),
    u = n === `download` ? s?.downloadApprovalMode : s?.uploadApprovalMode,
    d;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, X.jsx)(_, {
  ...
  t[4] === n
    ...
    : ((m = {
      ...
      (t[5] = m));
  let h;
  t[6] !== f || t[7] !== m ? ((h = [f, m]), (t[6] = f), (t[7] = m), (t[8] = h)) : (h = t[8]);
  let g = h,
    v;
  t[9] !== u || t[10] !== g
    ? ((v = g.find((e) => e.id === u) ?? g[0]), (t[9] = u), (t[10] = g), (t[11] = v))
    : (v = t[11]);
  let y = v,
    b = l.isPending,
    S;
  t[12] !== u || t[13] !== b || t[14] !== n || t[15] !== r || t[16] !== l
    ? ((S = async (e) => {
        if (!(e === u || b))
          try {
            await l.mutateAsync({ approvalMode: e, kind: n });
          } catch {
            r.get(C).danger(
              n === `download`
                ? (0, X.jsx)(_, {
  ...
  t[21] === j
    ? (M = t[22])
    : ((M = (0, X.jsx)(`span`, { className: `truncate`, children: j })), (t[21] = j), (t[22] = M));
  let N;
  t[23] !== A || t[24] !== M
    ? ((N = (0, X.jsx)(de, { className: `w-[152px]`, disabled: A, children: M })),
      (t[23] = A),
      (t[24] = M),
      (t[25] = N))
    : (N = t[25]);
  let P;
  t[26] !== u || t[27] !== E || t[28] !== b || t[29] !== g
    ? ((P = (0, X.jsx)(`div`, {
  ...
  let I;
  return (
    t[35] !== F || t[36] !== D || t[37] !== O
      ? ((I = (0, X.jsx)(G, { label: D, description: O, control: F })),
        (t[35] = F),
        (t[36] = D),
        (t[37] = O),
        (t[38] = I))
...
function Ie(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = v(`inline-flex w-max items-center gap-2 rounded-lg px-2 py-1 text-sm font-medium`, r)),
      (t[0] = r),
      (t[1] = i));
  let a = n ? `bg-[var(--color-icon-success)]` : `bg-token-charts-red`,
    o;
  t[2] === a ? (o = t[3]) : ((o = v(`h-2 w-2 rounded-full`, a)), (t[2] = a), (t[3] = o));
  let s;
  ...
  return (
    t[8] !== i || t[9] !== s || t[10] !== c
      ? ((l = (0, X.jsxs)(`span`, { className: i, children: [s, c] })),
        (t[8] = i),
        (t[9] = s),
        (t[10] = c),
        (t[11] = l))
...
function Le() {
  ...
  e[4] === n
    ? (a = e[5])
    : ((a = (0, X.jsxs)(y, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
      (e[4] = n),
      (e[5] = a));
  let o, s;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, X.jsx)(_, {
      ...
      (s = (0, X.jsx)(S, { className: `icon-xs text-token-text-secondary` })),
      (e[6] = o),
      (e[7] = s))
    : ((o = e[6]), (s = e[7]));
  let c;
...
function Re() {
  ...
  e[0] === n
    ...
    : ((r = {
        mutationFn: le,
        onSuccess: (e) => {
          n.setQueryData(p(`computer-use-sound-mode-read`), e);
        },
      }),
      (e[0] = n),
      (e[1] = r));
  ...
  let o;
  e[2] === t.data ? (o = e[3]) : ((o = He(t.data) ? t.data : Ae), (e[2] = t.data), (e[3] = o));
  let s = o,
    c;
  e[4] === s
    ? (c = e[5])
    : ((c = $.find((e) => e.value === s) ?? $.find(ze) ?? $[0]), (e[4] = s), (e[5] = c));
  let d = c,
    f = t.isLoading || i.isPending,
    m;
  e[6] === d.label
    ? (m = e[7])
    : ((m = (0, X.jsx)(_, { ...d.label })), (e[6] = d.label), (e[7] = m));
  let h;
  e[8] !== f || e[9] !== m
    ? ((h = (0, X.jsx)(de, {
    ...
    ? ((v = $.map((e) =>
        (0, X.jsx)(
          w.Item,
          {
            ...
            RightIcon: s === e.value ? x : void 0,
            children: (0, X.jsx)(`span`, {
              className: `text-sm`,
              children: (0, X.jsx)(_, { ...e.label }),
            }),
          },
          e.value,
        ),
  ...
  e[14] === v
    ? (y = e[15])
    : ((y = (0, X.jsx)(`div`, { className: `w-max max-w-[calc(100vw-2rem)]`, children: v })),
      (e[14] = v),
      (e[15] = y));
  let b;
  return (
    e[16] !== h || e[17] !== g || e[18] !== y
      ? ((b = (0, X.jsx)(T, { triggerButton: h, align: `start`, disabled: g, children: y })),
        (e[16] = h),
        (e[17] = g),
        (e[18] = y),
        (e[19] = b))
...
function Be() {
  ...
  e[0] !== r || e[1] !== t
    ? ((c = (e) => {
        if (
          (r.setQueryData(p(`computer-use-background-auth-read`), (t) => ({
  ...
  let f;
  e[5] !== c || e[6] !== d
    ? ((f = { mutationFn: se, onSuccess: c, onError: d }), (e[5] = c), (e[6] = d), (e[7] = f))
    : (f = e[7]);
  let m = u(f);
  if (s.data?.enabled == null) return null;
  let h;
  e[8] !== s.data.computerIconDataURL || e[9] !== s.data.lockIconDataURL
    ? ((h =
        s.data.computerIconDataURL != null && s.data.lockIconDataURL != null
          ? (0, X.jsx)(`span`, {
              className: `flex h-10 w-10 items-center justify-center`,
              children: (0, X.jsx)(`span`, {
                className: `origin-center scale-[0.65]`,
                children: (0, X.jsx)(xe, {
                  computerImageDataUrl: s.data.computerIconDataURL,
                  lockImageDataUrl: s.data.lockIconDataURL,
                }),
              }),
            })
          : null),
      (e[8] = s.data.computerIconDataURL),
      (e[9] = s.data.lockIconDataURL),
      (e[10] = h))
    : (h = e[10]);
  let v;
  e[11] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  e[15] === m
    ...
    : ((S = (e) => {
      ...
      (e[16] = S));
  let w;
  e[17] !== s.data.enabled || e[18] !== b || e[19] !== x || e[20] !== S
    ? ((w = (0, X.jsx)(j, { ariaLabel: b, checked: s.data.enabled, disabled: x, onChange: S })),
      (e[17] = s.data.enabled),
      (e[18] = b),
      (e[19] = x),
      (e[20] = S),
  ...
  return (
    e[22] !== h || e[23] !== w
      ? ((T = (0, X.jsx)(K, {
          children: (0, X.jsx)(G, { icon: h, label: v, description: y, control: w }),
        })),
        (e[22] = h),
        (e[23] = w),
        (e[24] = T))
...
function Ue() {
  ...
  return (
    e[5] === n.data
      ? (c = e[6])
      : ((c = (0, X.jsx)(We, { approvals: n.data })), (e[5] = n.data), (e[6] = c)),
    c
  );
}
function We(e) {
  ...
  t[2] !== s || t[3] !== d
    ? ((f = async () => {
        s != null && (await d.mutateAsync(s.bundleIdentifier), c(null));
      }),
      (t[2] = s),
      (t[3] = d),
      (t[4] = f))
  ...
  t[5] === n?.approvedApps
    ? (m = t[6])
    : ((m = n?.approvedApps ?? []), (t[5] = n?.approvedApps), (t[6] = m));
  let h;
  t[7] !== a || t[8] !== d.isPending || t[9] !== m
    ? ((h = (0, X.jsx)(qe, {
        approvedApps: m,
        intl: a,
  ...
  let j;
  t[16] !== T || t[17] !== S
    ? ((j = (0, X.jsx)(E, { children: (0, X.jsx)(D, { title: S, subtitle: T }) })),
      (t[16] = T),
      (t[17] = S),
      (t[18] = j))
    : (j = t[18]);
  ...
  t[21] === d.isPending
    ? (P = t[22])
    : ((P = (0, X.jsx)(y, { color: `ghost`, disabled: d.isPending, onClick: M, children: N })),
      (t[21] = d.isPending),
      (t[22] = P));
  let F;
  t[23] === p
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (I = t[25]);
  let L;
  t[26] !== d.isPending || t[27] !== F
    ? ((L = (0, X.jsx)(y, { color: `danger`, loading: d.isPending, onClick: F, children: I })),
      (t[26] = d.isPending),
      (t[27] = F),
      (t[28] = L))
    : (L = t[28]);
  let R;
  t[29] !== P || t[30] !== L
    ? ((R = (0, X.jsx)(E, { children: (0, X.jsxs)(A, { children: [P, L] }) })),
      (t[29] = P),
      (t[30] = L),
      (t[31] = R))
    : (R = t[31]);
  let z;
  t[32] !== j || t[33] !== R
    ? ((z = (0, X.jsxs)(k, { children: [j, R] })), (t[32] = j), (t[33] = R), (t[34] = z))
    : (z = t[34]);
  let B;
  t[35] !== z || t[36] !== v
    ? ((B = (0, X.jsx)(O, { open: v, onOpenChange: b, size: `compact`, children: z })),
      (t[35] = z),
      (t[36] = v),
      (t[37] = B))
    : (B = t[37]);
  ...
  return (
    t[38] !== B || t[39] !== h
      ? ((V = (0, X.jsxs)(X.Fragment, { children: [h, B] })), (t[38] = B), (t[39] = h), (t[40] = V))
      : (V = t[40]),
    V
  );
}
...
function Ke(e, t) {
  let n = I();
  return (
    (n === m.Dev ? J(e, De, t) : m.isInternal(n) ? (J(e, Oe, t) ?? J(e, De, t)) : null) ??
    J(e, Ee, t)
  );
}
function qe(e) {
    ...
    (t[6] !== r || t[7] !== i || t[8] !== a
      ? ((e = (e) =>
          (0, X.jsx)(
            G,
            {
              icon: (0, X.jsx)(Je, { approvedApp: e }),
              label: (0, X.jsx)(`span`, { className: `font-medium`, children: e.displayName }),
              description: null,
              control: (0, X.jsx)(y, {
                ...
                size: `icon`,
                children: (0, X.jsx)(ie, { className: `icon-2xs` }),
              }),
            },
            e.bundleIdentifier,
          )),
...
export { je as ComputerUseSettings };
