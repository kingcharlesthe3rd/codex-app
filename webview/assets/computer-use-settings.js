...
import { Uo as n } from "./app-server-manager-signals.js";
...
import { c as g, o as _, r as v } from "./lib-2.js";
import { a as y, m as b, p as x } from "./chunk-12.js";
...
import "./rpc-1.js";
import { a as S, d as C, f as w, o as T, s as E, u as D } from "./browser-use-settings-1.js";
import "./statsig.js";
import "./request.js";
...
import { D as k } from "./mention-item.js";
...
import { i as N, r as P } from "./use-is-plugins-enabled.js";
...
import { c as L, p as R, s as z } from "./use-plugin-install-flow.js";
import "./folder.js";
...
import { a as B, i as V, l as H, n as U, r as W } from "./dialog-layout.js";
...
import { i as le, t as ue } from "./settings-shared.js";
import { t as de } from "./settings-host-context.js";
import { t as fe } from "./settings-content-layout.js";
import "./more-menu-trigger.js";
import { l as pe, t as me } from "./browser-use-origin-state-queries.js";
import "./plugins-availability.js";
import { n as he } from "./settings-row.js";
import { n as ge, t as X } from "./settings-group.js";
import "./settings-empty-state.js";
import { t as _e } from "./use-home-directory-vhC-RDJp.js";
...
import { n as ve, r as ye } from "./computer-use-settings.search-C.js";
var be = e(r(), 1),
  Z = p(),
  Q = i();
function xe(e) {
...
function Ce(e) {
  ...
  let r = n.isConnected ? `bg-[var(--color-icon-success)]` : `bg-[var(--color-icon-error)]`,
    i;
  t[1] === r ? (i = t[2]) : ((i = a(`h-2 w-2 shrink-0 rounded-full`, r)), (t[1] = r), (t[2] = i));
  let o;
  t[3] === i ? (o = t[4]) : ((o = (0, Q.jsx)(`span`, { className: i })), (t[3] = i), (t[4] = o));
  let s;
  t[5] === n.isConnected
    ? (s = t[6])
    : ((s = (0, Q.jsx)(`span`, {
        ...
        children: n.isConnected
          ? (0, Q.jsx)(_, { ...Se.connected })
          : (0, Q.jsx)(_, { ...Se.disconnected }),
      })),
      (t[5] = n.isConnected),
      (t[6] = s));
  let c;
...
var we = `` + new URL(`chrome-production-large-BLPyHeGg.png`, import.meta.url).href,
  Te = `computer-use`,
  Ee = `computer-use`,
  De = `chrome`,
  Oe = `chrome-dev`,
  ke = `chrome-internal`,
  Ae = `/settings/computer-use/google-chrome`,
  je = `foregroundClicks`,
  $ = [
    {
...
function Me() {
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(X.Header, { title: (0, Q.jsx)(_, { ...ye.control }) })), (e[5] = c))
    : (c = e[5]);
  let u;
  e[6] === i
    ? (u = e[7])
    : ((u = (0, Q.jsx)(Ne, { computerUseAvailability: i })), (e[6] = i), (e[7] = u));
  let d;
  e[8] !== n || e[9] !== i.available || e[10] !== a
    ? ((d = a === `macOS` && i.available && n ? (0, Q.jsx)(Ve, {}) : null),
      (e[8] = n),
      (e[9] = i.available),
      (e[10] = a),
      (e[11] = d))
  ...
  e[12] !== u || e[13] !== d
    ? ((f = (0, Q.jsxs)(X, {
        id: ve.computerControl,
        children: [c, (0, Q.jsxs)(X.Content, { children: [u, d] })],
      })),
      (e[12] = u),
      (e[13] = d),
      (e[14] = f))
            ...
            children: [
              (0, Q.jsxs)(X, {
                children: [
                  ...
                  (0, Q.jsx)(X.Content, {
                    children: (0, Q.jsx)(ge, { children: (0, Q.jsx)(We, {}) }),
                  }),
                ],
              }),
              (0, Q.jsx)(ze, {}),
  ...
  return (
    e[17] !== f || e[18] !== p
      ? ((m = (0, Q.jsxs)(fe, { title: o, subtitle: s, children: [f, p] })),
        (e[17] = f),
        (e[18] = p),
        (e[19] = m))
      : (m = e[19]),
...
function Ne(e) {
  let t = (0, Z.c)(48),
    ...
    o = n(a).kind === `local`,
    s;
  t[0] === a ? (s = t[1]) : ((s = { hostId: a }), (t[0] = a), (t[1] = s));
  let c = P(s),
    l;
  ...
  t[3] !== d || t[4] !== u.availablePlugins
    ? ((f = D(u.availablePlugins, Ee, d)), (t[3] = d), (t[4] = u.availablePlugins), (t[5] = f))
    : (f = t[5]);
  let p = f,
    m;
  t[6] !== d || t[7] !== u.availablePlugins
    ? ((m = qe(u.availablePlugins, d)), (t[6] = d), (t[7] = u.availablePlugins), (t[8] = m))
    : (m = t[8]);
  let h = m,
    ...
    y;
  t[9] !== h || t[10] !== g || t[11] !== a
    ? ((y = { hostId: a, plugin: h, shouldReadBrowserExtension: g }),
      (t[9] = h),
      (t[10] = g),
      (t[11] = a),
      (t[12] = y))
  ...
  if (
    ...
    let e;
    if (
      (t[23] !== h || t[24] !== c || t[25] !== o
        ? ((e =
            h == null && o && !c.isLoading && !c.allowed
              ? [
                  {
                    description: (0, Q.jsx)(_, { ...k.restrictedAvailabilityDescription }),
                    icon: (0, Q.jsx)(`img`, {
                      alt: ``,
                    ...
                    title: (0, Q.jsx)(_, { ...ye.googleChrome }),
                  },
                ]
              : []),
          (t[23] = h),
    ...
    if (h != null) {
      ...
      t[31] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(_, { ...ye.googleChrome })), (t[31] = e))
        : (e = t[31]);
      let n;
      t[32] === x ? (n = t[33]) : ((n = (0, Q.jsx)(Ce, { status: x })), (t[32] = x), (t[33] = n));
      let r;
      t[34] !== v || t[35] !== i
        ? ((r = v
            ? (0, Q.jsx)(A, {
        ...
        : (r = t[36]);
      let a;
      (t[37] !== h || t[38] !== n || t[39] !== r
        ? ((a = { plugin: h, title: e, description: n, action: r }),
          (t[37] = h),
          (t[38] = n),
          (t[39] = r),
          (t[40] = a))
  ...
  let O;
  return (
    t[43] !== S || t[44] !== u || t[45] !== a || t[46] !== w
      ? ((O = (0, Q.jsx)(C, {
          emptyStateTitle: T,
          installButtonLabel: E,
          items: S,
          pluginsQuery: u,
          selectedHostId: a,
          unavailableItems: w,
...
function Fe() {
  ...
  e[1] !== o || e[2] !== a.installedPlugins
    ? ((c = qe(a.installedPlugins, o)), (e[1] = o), (e[2] = a.installedPlugins), (e[3] = c))
    : (c = e[3]);
  let l = c,
    u = l?.plugin.installed === !0,
    p = u && l.plugin.enabled,
    h;
  e[4] !== l || e[5] !== u || e[6] !== r
    ? ((h = { hostId: r, plugin: l, shouldReadBrowserExtension: u }),
      (e[4] = l),
      (e[5] = u),
      (e[6] = r),
      (e[7] = h))
      ...
      e[10] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((r = (0, Q.jsx)(fe, {
            ...
            children: (0, Q.jsx)(`div`, {
              ...
              children: (0, Q.jsx)(j, { className: `icon-xs` }),
            }),
          })),
          (e[10] = r))
        : (r = e[10]),
  ...
  if (!a.isLoading && !p) {
    ...
    return (
      e[11] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, Q.jsx)(y, { to: `/settings/computer-use`, replace: !0 })), (e[11] = t))
        : (t = e[11]),
      t
    );
  }
  ...
  e[15] !== D || e[16] !== k
    ...
    : (P = e[17]);
  let I;
  e[18] !== b || e[19] !== x || e[20] !== C || e[21] !== n || e[22] !== t
    ? ((I =
        n === `macOS` || n === `windows`
          ? (0, Q.jsx)(A, {
              color: `danger`,
              ...
              onClick: () => {
                b != null &&
                  m(`chrome-extension-settings-open`, { params: { extensionId: b } }).catch(() => {
                    t.get(O).danger(
                      (0, Q.jsx)(_, {
  ...
  let L;
  e[24] !== P || e[25] !== I
    ? ((L = (0, Q.jsxs)(`div`, { className: `flex items-center gap-2`, children: [P, I] })),
      (e[24] = P),
      (e[25] = I),
      (e[26] = L))
    : (L = e[26]);
  ...
  let z;
  e[28] !== x || e[29] !== C
    ? ((z = C ? null : (0, Q.jsx)(Le, { installed: x })), (e[28] = x), (e[29] = C), (e[30] = z))
    : (z = e[30]);
  let B;
          ...
          (0, Q.jsx)(X.Content, {
            children: (0, Q.jsxs)(ge, {
              children: [
                (0, Q.jsx)(S, {}),
                (0, Q.jsx)(E, {}),
                (0, Q.jsx)(Ie, { kind: `download` }),
                (0, Q.jsx)(Ie, { kind: `upload` }),
              ],
            }),
          }),
        ],
      })),
      (U = (0, Q.jsx)(T, { kind: `denied`, surface: `googleChrome` })),
      (W = (0, Q.jsx)(T, { kind: `allowed`, surface: `googleChrome` })),
      (G = (0, Q.jsx)(T, { kind: `denied`, resource: `downloads`, surface: `googleChrome` })),
      (K = (0, Q.jsx)(T, { kind: `allowed`, resource: `downloads`, surface: `googleChrome` })),
      (ee = (0, Q.jsx)(T, { kind: `denied`, resource: `uploads`, surface: `googleChrome` })),
      (q = (0, Q.jsx)(T, { kind: `allowed`, resource: `uploads`, surface: `googleChrome` })),
      (J = (0, Q.jsx)(w, {})),
      (e[33] = H),
      (e[34] = U),
      (e[35] = W),
...
function Ie(e) {
  let t = (0, Z.c)(39),
    { kind: n } = e,
    r = s(f),
    { data: i, isLoading: a } = c(me),
    o = pe(),
    l = n === `download` ? i?.downloadApprovalMode : i?.uploadApprovalMode,
    u;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Q.jsx)(_, {
  ...
  t[4] === n
    ...
    : ((m = {
      ...
      (t[5] = m));
  let h;
  t[6] !== d || t[7] !== m ? ((h = [d, m]), (t[6] = d), (t[7] = m), (t[8] = h)) : (h = t[8]);
  let g = h,
    v;
  t[9] !== l || t[10] !== g
    ? ((v = g.find((e) => e.id === l) ?? g[0]), (t[9] = l), (t[10] = g), (t[11] = v))
    : (v = t[11]);
  let y = v,
    b = o.isPending,
    x;
  t[12] !== l || t[13] !== b || t[14] !== n || t[15] !== r || t[16] !== o
    ? ((x = async (e) => {
        if (!(e === l || b))
          try {
  ...
  t[21] === D
    ? (k = t[22])
    : ((k = (0, Q.jsx)(`span`, { className: `truncate`, children: D })), (t[21] = D), (t[22] = k));
  let A;
  t[23] !== E || t[24] !== k
    ? ((A = (0, Q.jsx)(ue, { className: `w-[152px]`, disabled: E, children: k })),
      (t[23] = E),
      (t[24] = k),
      (t[25] = A))
    : (A = t[25]);
  let j;
  t[26] !== l || t[27] !== S || t[28] !== b || t[29] !== g
    ? ((j = (0, Q.jsx)(`div`, {
  ...
  let N;
  return (
    t[35] !== M || t[36] !== C || t[37] !== w
      ? ((N = (0, Q.jsx)(he, { label: C, description: w, control: M })),
        (t[35] = M),
        (t[36] = C),
        (t[37] = w),
        (t[38] = N))
...
function Le(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = a(`inline-flex w-max items-center gap-2 rounded-lg px-2 py-1 text-sm font-medium`, r)),
      (t[0] = r),
      (t[1] = i));
  let o = n ? `bg-[var(--color-icon-success)]` : `bg-token-charts-red`,
    s;
  t[2] === o ? (s = t[3]) : ((s = a(`h-2 w-2 rounded-full`, o)), (t[2] = o), (t[3] = s));
  let c;
  t[4] === s ? (c = t[5]) : ((c = (0, Q.jsx)(`span`, { className: s })), (t[4] = s), (t[5] = c));
  let l;
  t[6] === n
    ? (l = t[7])
    : ((l = n
...
function Re() {
  ...
  e[4] === n
    ? (a = e[5])
    : ((a = (0, Q.jsxs)(A, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
      (e[4] = n),
      (e[5] = a));
  let o, s;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(_, {
      ...
      (s = (0, Q.jsx)(K, { className: `icon-xs text-token-text-secondary` })),
      (e[6] = o),
      (e[7] = s))
    : ((o = e[6]), (s = e[7]));
  let c;
...
function ze() {
  ...
  e[0] === n
    ...
    : ((r = {
        mutationFn: se,
        onSuccess: (e) => {
          n.setQueryData(h(`computer-use-sound-mode-read`), e);
        },
      }),
      (e[0] = n),
      (e[1] = r));
  ...
  let a;
  e[2] === t.data ? (a = e[3]) : ((a = Ue(t.data) ? t.data : je), (e[2] = t.data), (e[3] = a));
  let s = a,
    l;
  e[4] === s
    ? (l = e[5])
    : ((l = $.find((e) => e.value === s) ?? $.find(Be) ?? $[0]), (e[4] = s), (e[5] = l));
  let d = l,
    ...
    ? ((g = $.map((e) =>
        (0, Q.jsx)(
          J.Item,
          {
            ...
            RightIcon: s === e.value ? G : void 0,
            children: (0, Q.jsx)(`span`, { className: `text-sm`, children: e.label }),
          },
          e.value,
        ),
      )),
  ...
  e[12] === g
    ? (_ = e[13])
    : ((_ = (0, Q.jsx)(`div`, { className: `w-max max-w-[calc(100vw-2rem)]`, children: g })),
      (e[12] = g),
      (e[13] = _));
  let v;
  return (
    e[14] !== p || e[15] !== m || e[16] !== _
      ? ((v = (0, Q.jsx)(Y, { triggerButton: p, align: `start`, disabled: m, children: _ })),
        (e[14] = p),
        (e[15] = m),
        (e[16] = _),
        (e[17] = v))
...
function Ve() {
  ...
  e[0] !== r || e[1] !== t
    ? ((a = (e) => {
        if (
          (r.setQueryData(h(`computer-use-background-auth-read`), (t) => ({
  ...
  let d;
  e[5] !== a || e[6] !== l
    ? ((d = { mutationFn: ae, onSuccess: a, onError: l }), (e[5] = a), (e[6] = l), (e[7] = d))
    : (d = e[7]);
  let p = u(d);
  ...
  e[15] === p
    ...
    : ((S = (e) => {
      ...
      (e[16] = S));
  let C;
  e[17] !== i.data.enabled || e[18] !== b || e[19] !== x || e[20] !== S
    ? ((C = (0, Q.jsx)(ne, { ariaLabel: b, checked: i.data.enabled, disabled: x, onChange: S })),
      (e[17] = i.data.enabled),
      (e[18] = b),
      (e[19] = x),
      (e[20] = S),
  ...
  return (
    e[22] !== m || e[23] !== C
      ? ((w = (0, Q.jsx)(ge, {
          children: (0, Q.jsx)(he, { icon: m, label: v, description: y, control: C }),
        })),
        (e[22] = m),
        (e[23] = C),
        (e[24] = w))
...
function We() {
  ...
  return (
    e[5] === n.data
      ? (a = e[6])
      : ((a = (0, Q.jsx)(Ge, { approvals: n.data })), (e[5] = n.data), (e[6] = a)),
    a
  );
}
function Ge(e) {
  ...
  t[2] !== a || t[3] !== l
    ? ((d = async () => {
        a != null && (await l.mutateAsync(a.bundleIdentifier), o(null));
      }),
      (t[2] = a),
      (t[3] = l),
      (t[4] = d))
  ...
  t[14] === S
    ...
    : ((C = (0, Q.jsx)(_, {
        ...
        values: { displayName: S },
      })),
      (t[14] = S),
      (t[15] = C));
  let w;
  t[16] !== C || t[17] !== x
    ? ((w = (0, Q.jsx)(B, { children: (0, Q.jsx)(V, { title: x, subtitle: C }) })),
      (t[16] = C),
      (t[17] = x),
      (t[18] = w))
    : (w = t[18]);
  ...
  t[21] === l.isPending
    ? (D = t[22])
    : ((D = (0, Q.jsx)(A, { color: `ghost`, disabled: l.isPending, onClick: T, children: E })),
      (t[21] = l.isPending),
      (t[22] = D));
  let k;
  t[23] === p
  ...
  t[26] !== l.isPending || t[27] !== k
    ? ((M = (0, Q.jsx)(A, { color: `danger`, loading: l.isPending, onClick: k, children: j })),
      (t[26] = l.isPending),
      (t[27] = k),
      (t[28] = M))
    : (M = t[28]);
  let N;
  t[29] !== D || t[30] !== M
    ? ((N = (0, Q.jsx)(B, { children: (0, Q.jsxs)(W, { children: [D, M] }) })),
      (t[29] = D),
      (t[30] = M),
      (t[31] = N))
    : (N = t[31]);
  let P;
  t[32] !== w || t[33] !== N
    ? ((P = (0, Q.jsxs)(U, { children: [w, N] })), (t[32] = w), (t[33] = N), (t[34] = P))
    : (P = t[34]);
  let F;
  t[35] !== P || t[36] !== v
    ? ((F = (0, Q.jsx)(H, { open: v, onOpenChange: y, size: `compact`, children: P })),
      (t[35] = P),
      (t[36] = v),
      (t[37] = F))
    : (F = t[37]);
  ...
  return (
    t[38] !== F || t[39] !== h
      ? ((I = (0, Q.jsxs)(Q.Fragment, { children: [h, F] })), (t[38] = F), (t[39] = h), (t[40] = I))
      : (I = t[40]),
    I
  );
}
...
function qe(e, n) {
  let r = I();
  return (
    (r === t.Dev ? D(e, Oe, n) : t.isInternal(r) ? (D(e, ke, n) ?? D(e, Oe, n)) : null) ??
    D(e, De, n)
  );
}
function Je(e) {
    ...
    (t[6] !== r || t[7] !== i || t[8] !== a
      ? ((e = (e) =>
          (0, Q.jsx)(
            he,
            {
              icon: (0, Q.jsx)(Ye, { approvedApp: e }),
              label: (0, Q.jsx)(`span`, { className: `font-medium`, children: e.displayName }),
              description: null,
              control: (0, Q.jsx)(A, {
...
export { Me as ComputerUseSettings };
