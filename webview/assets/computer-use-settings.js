...
import { _n as Be, hn as Ve } from "./app-initial~app-main~automations-page.js";
import {
  Ct as He,
  G as Ue,
  Gt as We,
...
import { n as ut, t as dt } from "./use-home-directory.js";
import { n as ft, t as pt } from "./apps-availability.js";
import {
  _ as mt,
  c as ht,
  g as gt,
...
var Ct,
  wt = e(() => {
    Ct = `` + new URL(`microsoft-excel-large-CY0bRHcJ.png`, import.meta.url).href;
  }),
  Tt,
  Et = e(() => {
    Tt = `` + new URL(`microsoft-powerpoint-large-DlJg6gsJ.png`, import.meta.url).href;
  });
function Dt(e) {
  let t = (0, Ot.c)(7),
...
function At(e) {
  ...
  let r = n.isConnected ? `bg-[var(--color-icon-success)]` : `bg-[var(--color-icon-error)]`,
    i;
  t[1] === r ? (i = t[2]) : ((i = ve(`h-2 w-2 shrink-0 rounded-full`, r)), (t[1] = r), (t[2] = i));
  let a;
  t[3] === i ? (a = t[4]) : ((a = (0, J.jsx)(`span`, { className: i })), (t[3] = i), (t[4] = a));
  let o;
  t[5] === n.isConnected
    ? (o = t[6])
    : ((o = (0, J.jsx)(`span`, {
        ...
        children: n.isConnected
          ? (0, J.jsx)(m, { ...Y.connected })
          : (0, J.jsx)(m, { ...Y.disconnected }),
      })),
      (t[5] = n.isConnected),
      (t[6] = o));
  let s;
...
function It() {
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(G.Header, { title: (0, Q.jsx)(m, { ...X.control }) })), (e[5] = c))
    : (c = e[5]);
  let l;
  e[6] !== i || e[7] !== a
    ? ((l = (0, Q.jsx)(Lt, { computerUseAvailability: i, platform: a })),
      (e[6] = i),
      (e[7] = a),
      (e[8] = l))
    : (l = e[8]);
  ...
  e[9] !== n || e[10] !== i.available || e[11] !== a
    ? ((u = a === `macOS` && i.available && n ? (0, Q.jsx)(qt, {}) : null),
      (e[9] = n),
      (e[10] = i.available),
      (e[11] = a),
      (e[12] = u))
  ...
  let d;
  e[13] !== l || e[14] !== u
    ? ((d = (0, Q.jsxs)(G, { children: [c, (0, Q.jsxs)(G.Content, { children: [l, u] })] })),
      (e[13] = l),
      (e[14] = u),
      (e[15] = d))
    : (d = e[15]);
    ...
    : ((f = i.available
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              (0, Q.jsxs)(G, {
                children: [
                  (0, Q.jsx)(G.Header, { title: (0, Q.jsx)(m, { ...X.alwaysAllowedApps }) }),
                  (0, Q.jsx)(G.Content, {
                    children: (0, Q.jsx)(ct, { children: (0, Q.jsx)(Xt, {}) }),
                  }),
                ],
              }),
              (0, Q.jsx)(Gt, {}),
  ...
  return (
    e[18] !== d || e[19] !== f
      ? ((p = (0, Q.jsxs)(Ve, { title: o, subtitle: s, children: [d, f] })),
        (e[18] = d),
        (e[19] = f),
        (e[20] = p))
      : (p = e[20]),
...
function Lt(e) {
  ...
  let { isUpdating: f, setAppEnabled: p, updatingAppId: _ } = ft(d),
    v;
  t[4] === Symbol.for(`react.memo_cache_sentinel`) ? ((v = []), (t[4] = v)) : (v = t[4]);
  let y = Me(o, v),
    b = ut(o),
    x = j(Ne),
    S;
  t[5] !== b || t[6] !== y.availablePlugins
    ? ((S = K(y.availablePlugins, an, b)), (t[5] = b), (t[6] = y.availablePlugins), (t[7] = S))
    : (S = t[7]);
  let w = S,
    E;
  t[8] !== b || t[9] !== y.availablePlugins
    ? ((E = $t(y.availablePlugins, b)), (t[8] = b), (t[9] = y.availablePlugins), (t[10] = E))
    : (E = t[10]);
  let D = E,
    O = y.availablePlugins.find(Ae) ?? null,
    k = y.availablePlugins.find(M) ?? null,
    A = [
      {
    ...
    N = D?.plugin.installed === !0,
    P = N && D.plugin.enabled,
    F = c?.find(zt)?.isEnabled ?? !0,
    ee = f && _ === ln,
    I;
  t[11] !== D || t[12] !== N || t[13] !== o
    ? ((I = { hostId: o, plugin: D, shouldReadBrowserExtension: N }),
      (t[11] = D),
      (t[12] = N),
      (t[13] = o),
      (t[14] = I))
  ...
  t[15] !== D || t[16] !== u || t[17] !== s
    ? ((z =
        D == null && s && !u.isLoading && !u.allowed
          ? [
              {
                description: (0, Q.jsx)(m, { ...re.restrictedAvailabilityDescription }),
                icon: (0, Q.jsx)(`img`, {
                  alt: ``,
                ...
                title: (0, Q.jsx)(m, { ...X.googleChrome }),
              },
            ]
          : []),
      (t[15] = D),
    ...
    : (z = t[18]);
  let ne = z;
  if (n.available && w != null) {
    let e, n;
    t[19] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(m, { ...X.anyApp })),
        (n = (0, Q.jsx)(m, {
    ...
    (t[21] === w
      ? (r = t[22])
      : ((r = { plugin: w, title: e, description: n }), (t[21] = w), (t[22] = r)),
      R.push(r));
  }
  if (D != null) {
    let e;
    t[23] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(m, { ...X.googleChrome })), (t[23] = e))
      : (e = t[23]);
    let n;
    t[24] === L ? (n = t[25]) : ((n = (0, Q.jsx)(At, { status: L })), (t[24] = L), (t[25] = n));
    let r;
    t[26] !== P || t[27] !== a
      ? ((r = P
          ? (0, Q.jsx)(H, {
      ...
      : (r = t[28]);
    let i;
    (t[29] !== D || t[30] !== r || t[31] !== n
      ? ((i = { plugin: D, title: e, description: n, action: r }),
        (t[29] = D),
        (t[30] = r),
        (t[31] = n),
        (t[32] = i))
      ...
      R.push({
        ...(t.plugin.installed && t.plugin.enabled
          ? {
              ...
              isPending: ee,
              onToggleEnabled: (t) => {
                p({ appId: ln, appName: i.formatMessage(e.title), enabled: t }).catch(Rt);
              },
              toggleAriaLabel: i.formatMessage(e.toggleAriaLabel),
              toggleTooltip: F
                ? (0, Q.jsx)(m, { ...e.disableTooltip })
                : (0, Q.jsx)(m, { ...e.enableTooltip }),
            }
        ...
        title: (0, Q.jsx)(m, { ...e.title }),
        description: (0, Q.jsx)(m, { ...e.description }),
      });
    }
  let B, V;
  return (
...
function Vt() {
  ...
  let l = c,
    ...
    h;
  e[4] !== l || e[5] !== u || e[6] !== i
    ? ((h = { hostId: i, plugin: l, shouldReadBrowserExtension: u }),
      (e[4] = l),
      (e[5] = u),
      (e[6] = i),
      (e[7] = h))
  ...
  if (!o.isLoading && !p) {
    ...
    return (
      e[11] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, Q.jsx)(r, { to: `/settings/computer-use`, replace: !0 })), (e[11] = t))
        : (t = e[11]),
      t
    );
  }
  ...
  e[15] !== x || e[16] !== S
    ...
    : (w = e[17]);
  let T;
  e[18] !== v || e[19] !== y || e[20] !== b || e[21] !== n || e[22] !== t
    ? ((T =
        n === `macOS` || n === `windows`
          ? (0, Q.jsx)(H, {
              color: `danger`,
              ...
              onClick: () => {
                v != null &&
                  d(`chrome-extension-settings-open`, { params: { extensionId: v } }).catch(() => {
                    t.get(U).danger(
                      (0, Q.jsx)(m, {
  ...
  let E;
  e[24] !== w || e[25] !== T
    ? ((E = (0, Q.jsxs)(`div`, { className: `flex items-center gap-2`, children: [w, T] })),
      (e[24] = w),
      (e[25] = T),
      (e[26] = E))
    : (E = e[26]);
  ...
  let O;
  e[28] !== y || e[29] !== b
    ? ((O = b ? null : (0, Q.jsx)(Ut, { installed: y })), (e[28] = y), (e[29] = b), (e[30] = O))
    : (O = e[30]);
  let k;
  ...
  e[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, Q.jsxs)(G, {
      ...
      (M = (0, Q.jsx)(ht, { surface: `googleChrome` })),
      (N = (0, Q.jsx)(xt, {})),
      (e[33] = j),
      (e[34] = M),
      (e[35] = N))
...
function Ht(e) {
  ...
  t[4] === n
    ...
    : ((d = {
      ...
      (t[5] = d));
  let p;
  t[6] !== l || t[7] !== d ? ((p = [l, d]), (t[6] = l), (t[7] = d), (t[8] = p)) : (p = t[8]);
  let h = p,
    g;
  t[9] !== s || t[10] !== h
    ? ((g = h.find((e) => e.id === s) ?? h[0]), (t[9] = s), (t[10] = h), (t[11] = g))
    : (g = t[11]);
  let _ = g,
    v = o.isPending,
    y;
  ...
  t[21] === T
    ? (E = t[22])
    : ((E = (0, Q.jsx)(`span`, { className: `truncate`, children: T })), (t[21] = T), (t[22] = E));
  let D;
  t[23] !== w || t[24] !== E
    ? ((D = (0, Q.jsx)(Ge, { className: `w-[152px]`, disabled: w, children: E })),
      (t[23] = w),
      (t[24] = E),
      (t[25] = D))
    : (D = t[25]);
  ...
  let A;
  return (
    t[35] !== k || t[36] !== x || t[37] !== S
      ? ((A = (0, Q.jsx)(W, { label: x, description: S, control: k })),
        (t[35] = k),
        (t[36] = x),
        (t[37] = S),
        (t[38] = A))
...
function Ut(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = ve(`inline-flex w-max items-center gap-2 rounded-lg px-2 py-1 text-sm font-medium`, r)),
      (t[0] = r),
      (t[1] = i));
  let a = n ? `bg-[var(--color-icon-success)]` : `bg-token-charts-red`,
    o;
  t[2] === a ? (o = t[3]) : ((o = ve(`h-2 w-2 rounded-full`, a)), (t[2] = a), (t[3] = o));
  let s;
...
function Wt() {
  ...
  let r, i;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(he, { className: `icon-xs` })),
      (i = (0, Q.jsx)(m, {
  ...
  e[4] === n
    ? (a = e[5])
    : ((a = (0, Q.jsxs)(H, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
      (e[4] = n),
      (e[5] = a));
  let o, s;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(m, {
      ...
      (s = (0, Q.jsx)(de, { className: `icon-xs text-token-text-secondary` })),
      (e[6] = o),
      (e[7] = s))
    : ((o = e[6]), (s = e[7]));
  let c;
...
function Gt() {
  ...
  e[0] === n
    ...
    : ((r = {
        mutationFn: Ye,
        onSuccess: (e) => {
          n.setQueryData(o(`computer-use-sound-mode-read`), e);
        },
      }),
      (e[0] = n),
      (e[1] = r));
  ...
  e[4] === s
    ? (c = e[5])
    : ((c = $.find((e) => e.value === s) ?? $.find(Kt) ?? $[0]), (e[4] = s), (e[5] = c));
  let l = c,
    u = t.isLoading || i.isPending,
    d;
  e[6] === l.label
    ? (d = e[7])
    : ((d = (0, Q.jsx)(m, { ...l.label })), (e[6] = l.label), (e[7] = d));
  let f;
  e[8] !== u || e[9] !== d
    ? ((f = (0, Q.jsx)(Ge, {
    ...
    ? ((h = $.map((e) =>
        (0, Q.jsx)(
          Ee.Item,
          {
            ...
            RightIcon: s === e.value ? ne : void 0,
            children: (0, Q.jsx)(`span`, {
              className: `text-sm`,
              children: (0, Q.jsx)(m, { ...e.label }),
            }),
          },
          e.value,
        ),
  ...
  e[14] === h
    ? (g = e[15])
    : ((g = (0, Q.jsx)(`div`, { className: `w-max max-w-[calc(100vw-2rem)]`, children: h })),
      (e[14] = h),
      (e[15] = g));
  let _;
  return (
    e[16] !== f || e[17] !== p || e[18] !== g
      ? ((_ = (0, Q.jsx)(ce, { triggerButton: f, align: `start`, disabled: p, children: g })),
        (e[16] = f),
        (e[17] = p),
        (e[18] = g),
        (e[19] = _))
...
function qt() {
  ...
  e[0] !== r || e[1] !== t
    ? ((a = (e) => {
        if (
          (r.setQueryData(o(`computer-use-background-auth-read`), (t) => ({
  ...
  let c;
  e[5] !== a || e[6] !== s
    ? ((c = { mutationFn: nt, onSuccess: a, onError: s }), (e[5] = a), (e[6] = s), (e[7] = c))
    : (c = e[7]);
  let l = Ce(c);
  ...
  e[15] === l
    ...
    : ((_ = (e) => {
      ...
      (e[16] = _));
  let v;
  e[17] !== i.data.enabled || e[18] !== h || e[19] !== g || e[20] !== _
    ? ((v = (0, Q.jsx)(ie, { ariaLabel: h, checked: i.data.enabled, disabled: g, onChange: _ })),
      (e[17] = i.data.enabled),
      (e[18] = h),
      (e[19] = g),
      (e[20] = _),
  ...
  return (
    e[22] !== u || e[23] !== v
      ? ((y = (0, Q.jsx)(ct, {
          children: (0, Q.jsx)(W, { icon: u, label: d, description: p, control: v }),
        })),
        (e[22] = u),
        (e[23] = v),
        (e[24] = y))
...
function Xt() {
  ...
  return (
    e[5] === n.data
      ? (a = e[6])
      : ((a = (0, Q.jsx)(Zt, { approvals: n.data })), (e[5] = n.data), (e[6] = a)),
    a
  );
}
function Zt(e) {
  ...
  t[5] === n?.approvedApps
    ? (p = t[6])
    : ((p = n?.approvedApps ?? []), (t[5] = n?.approvedApps), (t[6] = p));
  let h;
  t[7] !== i || t[8] !== l.isPending || t[9] !== p
    ? ((h = (0, Q.jsx)(en, {
        approvedApps: p,
        intl: i,
  ...
  let S;
  t[16] !== x || t[17] !== y
    ? ((S = (0, Q.jsx)(ke, { children: (0, Q.jsx)(a, { title: y, subtitle: x }) })),
      (t[16] = x),
      (t[17] = y),
      (t[18] = S))
    : (S = t[18]);
  ...
  t[21] === l.isPending
    ? (E = t[22])
    : ((E = (0, Q.jsx)(H, { color: `ghost`, disabled: l.isPending, onClick: w, children: T })),
      (t[21] = l.isPending),
      (t[22] = E));
  let D;
  t[23] === d
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (O = t[25]);
  let k;
  t[26] !== l.isPending || t[27] !== D
    ? ((k = (0, Q.jsx)(H, { color: `danger`, loading: l.isPending, onClick: D, children: O })),
      (t[26] = l.isPending),
      (t[27] = D),
      (t[28] = k))
    : (k = t[28]);
  let A;
  t[29] !== E || t[30] !== k
    ? ((A = (0, Q.jsx)(ke, { children: (0, Q.jsxs)(N, { children: [E, k] }) })),
      (t[29] = E),
      (t[30] = k),
      (t[31] = A))
    : (A = t[31]);
  let j;
  t[32] !== S || t[33] !== A
    ? ((j = (0, Q.jsxs)(je, { children: [S, A] })), (t[32] = S), (t[33] = A), (t[34] = j))
    : (j = t[34]);
  let M;
  t[35] !== j || t[36] !== g
    ? ((M = (0, Q.jsx)(P, { open: g, onOpenChange: _, size: `compact`, children: j })),
      (t[35] = j),
      (t[36] = g),
      (t[37] = M))
    : (M = t[37]);
  ...
  return (
    t[38] !== M || t[39] !== h
      ? ((F = (0, Q.jsxs)(Q.Fragment, { children: [h, M] })), (t[38] = M), (t[39] = h), (t[40] = F))
      : (F = t[40]),
    F
  );
}
...
function $t(e, t) {
  let n = p();
  return (
    (n === fe.Dev ? K(e, sn, t) : fe.isInternal(n) ? (K(e, cn, t) ?? K(e, sn, t)) : null) ??
    K(e, on, t)
  );
}
function en(e) {
