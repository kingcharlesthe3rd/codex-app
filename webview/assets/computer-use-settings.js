...
import { a as w, m as T, p as E } from "./chunk-13.js";
...
import { N as D } from "./mention-item.js";
...
import { i as k, r as A } from "./use-is-plugins-enabled-Dn_J-WZf.js";
...
import { h as z } from "./links.js";
import "./use-codex-pricing-url.js";
import "./plan-management-state.js";
import { r as B, t as V } from "./dropdown.js";
import { c as ee, h as te, l as ne } from "./use-plugin-install-flow.js";
import "./three-dots.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as H } from "./settings-host-context.js";
import { t as re } from "./trash-DL-ar7Ww.js";
...
import "./browser-use-elevated-risk-learn-more-url-DDETM-uv.js";
      ...
      (t[23] !== h || t[24] !== s || t[25] !== a
        ? ((e =
            h == null && a && !s.isLoading && !s.allowed
              ? [
                  {
                    description: (0, X.jsx)(_, { ...D.restrictedAvailabilityDescription }),
                    icon: (0, X.jsx)(`img`, {
                      alt: ``,
...
function Pe() {
  ...
  let o = j(r, i),
    c = me(r),
    l;
  e[1] !== c || e[2] !== o.installedPlugins
    ? ((l = Ke(o.installedPlugins, c)), (e[1] = c), (e[2] = o.installedPlugins), (e[3] = l))
    : (l = e[3]);
  let u = l,
  ...
  if (!o.isLoading && !m) {
    ...
    return (
      e[11] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, X.jsx)(w, { to: `/settings/computer-use`, replace: !0 })), (e[11] = t))
        : (t = e[11]),
      t
    );
  }
  ...
  e[15] !== E || e[16] !== D
    ...
    : (A = e[17]);
  let M;
  e[18] !== x || e[19] !== S || e[20] !== T || e[21] !== n || e[22] !== t
    ? ((M =
        n === `macOS` || n === `windows`
          ? (0, X.jsx)(y, {
              color: `danger`,
  ...
  let N;
  e[24] !== A || e[25] !== M
    ? ((N = (0, X.jsxs)(`div`, { className: `flex items-center gap-2`, children: [A, M] })),
      (e[24] = A),
      (e[25] = M),
      (e[26] = N))
    : (N = e[26]);
  ...
  let F;
  e[28] !== S || e[29] !== T
    ? ((F = T ? null : (0, X.jsx)(Ie, { installed: S })), (e[28] = S), (e[29] = T), (e[30] = F))
    : (F = e[30]);
  let I;
...
function Fe(e) {
  let t = (0, Y.c)(39),
    { kind: n } = e,
    r = a(s),
    { data: i, isLoading: c } = o(pe),
    l = fe(),
    u = n === `download` ? i?.downloadApprovalMode : i?.uploadApprovalMode,
    d;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, X.jsx)(_, {
  ...
  t[21] === k
    ? (A = t[22])
    : ((A = (0, X.jsx)(`span`, { className: `truncate`, children: k })), (t[21] = k), (t[22] = A));
  let j;
  t[23] !== O || t[24] !== A
    ? ((j = (0, X.jsx)(de, { className: `w-[152px]`, disabled: O, children: A })),
      (t[23] = O),
      (t[24] = A),
      (t[25] = j))
    : (j = t[25]);
  let M;
  t[26] !== u || t[27] !== w || t[28] !== b || t[29] !== g
    ? ((M = (0, X.jsx)(`div`, {
  ...
  let P;
  return (
    t[35] !== N || t[36] !== T || t[37] !== E
      ? ((P = (0, X.jsx)(G, { label: T, description: E, control: N })),
        (t[35] = N),
        (t[36] = T),
        (t[37] = E),
        (t[38] = P))
...
function Re() {
  ...
  let a;
  e[2] === t.data ? (a = e[3]) : ((a = He(t.data) ? t.data : Ae), (e[2] = t.data), (e[3] = a));
  let s = a,
    c;
  e[4] === s
    ? (c = e[5])
  ...
  return (
    e[16] !== h || e[17] !== g || e[18] !== y
      ? ((b = (0, X.jsx)(V, { triggerButton: h, align: `start`, disabled: g, children: y })),
        (e[16] = h),
        (e[17] = g),
        (e[18] = y),
        (e[19] = b))
...
function Be() {
  ...
  e[17] !== i.data.enabled || e[18] !== b || e[19] !== x || e[20] !== S
    ? ((w = (0, X.jsx)(ie, { ariaLabel: b, checked: i.data.enabled, disabled: x, onChange: S })),
      (e[17] = i.data.enabled),
      (e[18] = b),
      (e[19] = x),
      (e[20] = S),
...
function We(e) {
  ...
  t[2] !== o || t[3] !== d
    ? ((f = async () => {
        o != null && (await d.mutateAsync(o.bundleIdentifier), c(null));
      }),
      (t[2] = o),
      (t[3] = d),
      (t[4] = f))
  ...
  let E;
  t[16] !== T || t[17] !== S
    ? ((E = (0, X.jsx)(P, { children: (0, X.jsx)(F, { title: S, subtitle: T }) })),
      (t[16] = T),
      (t[17] = S),
      (t[18] = E))
    : (E = t[18]);
  ...
  t[21] === d.isPending
    ? (k = t[22])
    : ((k = (0, X.jsx)(y, { color: `ghost`, disabled: d.isPending, onClick: D, children: O })),
      (t[21] = d.isPending),
      (t[22] = k));
  let A;
  t[23] === p
  ...
  t[26] !== d.isPending || t[27] !== A
    ? ((M = (0, X.jsx)(y, { color: `danger`, loading: d.isPending, onClick: A, children: j })),
      (t[26] = d.isPending),
      (t[27] = A),
      (t[28] = M))
    : (M = t[28]);
  let N;
  t[29] !== k || t[30] !== M
    ? ((N = (0, X.jsx)(P, { children: (0, X.jsxs)(R, { children: [k, M] }) })),
      (t[29] = k),
      (t[30] = M),
      (t[31] = N))
    : (N = t[31]);
  let z;
  t[32] !== E || t[33] !== N
    ? ((z = (0, X.jsxs)(L, { children: [E, N] })), (t[32] = E), (t[33] = N), (t[34] = z))
    : (z = t[34]);
  let B;
  t[35] !== z || t[36] !== v
    ? ((B = (0, X.jsx)(I, { open: v, onOpenChange: b, size: `compact`, children: z })),
      (t[35] = z),
      (t[36] = v),
      (t[37] = B))
    : (B = t[37]);
