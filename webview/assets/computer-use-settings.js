...
import { Dt as se, Tt as ce } from "./app-initial~app-main~automations-page.js";
import {
  Ao as le,
  Fc as ue,
  Fi as de,
  ...
  t[5] === n.isConnected
    ...
    : ((o = (0, q.jsx)(`span`, {
        ...
        children: n.isConnected
          ? (0, q.jsx)(z, { ...J.connected })
          : (0, q.jsx)(z, { ...J.disconnected }),
      })),
      (t[5] = n.isConnected),
      (t[6] = o));
  let s;
...
function Lt() {
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Z.jsx)(W.Header, { title: (0, Z.jsx)(z, { ...Y.control }) })), (e[5] = c))
    : (c = e[5]);
  let l;
  e[6] !== i || e[7] !== a
    ...
    : ((f = i.available
        ? (0, Z.jsxs)(Z.Fragment, {
            children: [
              (0, Z.jsxs)(W, {
                children: [
                  (0, Z.jsx)(W.Header, { title: (0, Z.jsx)(z, { ...Y.alwaysAllowedApps }) }),
                  (0, Z.jsx)(W.Content, {
  ...
  return (
    e[18] !== d || e[19] !== f
      ? ((p = (0, Z.jsxs)(ce, { title: o, subtitle: s, children: [d, f] })),
        (e[18] = d),
        (e[19] = f),
        (e[20] = p))
      : (p = e[20]),
...
function Rt(e) {
  ...
  let { isUpdating: p, setAppEnabled: h, updatingAppId: g } = pt(f),
    _;
  t[4] === Symbol.for(`react.memo_cache_sentinel`) ? ((_ = []), (t[4] = _)) : (_ = t[4]);
  let v = pe(s, _),
    y = dt(s),
    b = te(ze),
    x;
  t[5] !== y || t[6] !== v.availablePlugins
    ? ((x = G(v.availablePlugins, on, y)), (t[5] = y), (t[6] = v.availablePlugins), (t[7] = x))
    : (x = t[7]);
  let S = x,
    C;
  t[8] !== y || t[9] !== v.availablePlugins
    ? ((C = en(v.availablePlugins, y)), (t[8] = y), (t[9] = v.availablePlugins), (t[10] = C))
    : (C = t[10]);
  let T = C,
    E = v.availablePlugins.find(Be) ?? null,
    D = v.availablePlugins.find(Ve) ?? null,
    O = [
      {
    ...
    k = T?.plugin.installed === !0,
    A = k && T.plugin.enabled,
    j = l?.find(Bt)?.isEnabled ?? !0,
    M = p && g === Q,
    N;
  t[11] !== T || t[12] !== k || t[13] !== s
    ? ((N = { hostId: s, plugin: T, shouldReadBrowserExtension: k }),
      (t[11] = T),
      (t[12] = k),
      (t[13] = s),
      (t[14] = N))
  ...
  t[15] !== T || t[16] !== d || t[17] !== c
    ? ((I =
        T == null && c && !d.isLoading && !d.allowed
          ? [
              {
                description: (0, Z.jsx)(z, { ...ue.restrictedAvailabilityDescription }),
                icon: (0, Z.jsx)(`img`, {
                  alt: ``,
                ...
                title: (0, Z.jsx)(z, { ...Y.googleChrome }),
              },
            ]
          : []),
      (t[15] = T),
  ...
  if (T != null) {
    ...
    t[23] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Z.jsx)(z, { ...Y.googleChrome })), (t[23] = e))
      : (e = t[23]);
    let n;
    t[24] === P ? (n = t[25]) : ((n = (0, Z.jsx)(jt, { status: P })), (t[24] = P), (t[25] = n));
    let r;
    t[26] !== A || t[27] !== o
      ? ((r = A
          ? (0, Z.jsx)(H, {
      ...
      F.push({
        ...(t.plugin.installed && t.plugin.enabled
          ? {
              ...
              isPending: M,
              onToggleEnabled: (t) => {
                h({ appId: Q, appName: a.formatMessage(e.title), enabled: t }).catch(zt);
              },
              toggleAriaLabel: a.formatMessage(e.toggleAriaLabel),
              toggleTooltip: j
                ? (0, Z.jsx)(z, { ...e.disableTooltip })
                : (0, Z.jsx)(z, { ...e.enableTooltip }),
            }
        ...
        title: (0, Z.jsx)(z, { ...e.title }),
        description: (0, Z.jsx)(z, { ...e.description }),
      });
    }
  let R, B;
  return (
...
function Ht() {
  ...
  let a = pe(r, i),
    s = dt(r),
    c;
  e[1] !== s || e[2] !== a.installedPlugins
    ? ((c = en(a.installedPlugins, s)), (e[1] = s), (e[2] = a.installedPlugins), (e[3] = c))
    : (c = e[3]);
  let l = c,
    u = l?.plugin.installed === !0,
    d = u && l.plugin.enabled,
    f;
  e[4] !== l || e[5] !== u || e[6] !== r
    ? ((f = { hostId: r, plugin: l, shouldReadBrowserExtension: u }),
      (e[4] = l),
      (e[5] = u),
      (e[6] = r),
      (e[7] = f))
  ...
  if (!a.isLoading && !d) {
    ...
    return (
      e[11] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, Z.jsx)(B, { to: `/settings/computer-use`, replace: !0 })), (e[11] = t))
        : (t = e[11]),
      t
    );
  }
  ...
  e[15] !== b || e[16] !== x
    ...
    : (C = e[17]);
  let T;
  e[18] !== g || e[19] !== v || e[20] !== y || e[21] !== n || e[22] !== t
    ? ((T =
        n === `macOS` || n === `windows`
          ? (0, Z.jsx)(H, {
              color: `danger`,
              ...
              onClick: () => {
                g != null &&
                  h(`chrome-extension-settings-open`, { params: { extensionId: g } }).catch(() => {
                    t.get(U).danger(
                      (0, Z.jsx)(z, {
  ...
  let E;
  e[24] !== C || e[25] !== T
    ? ((E = (0, Z.jsxs)(`div`, { className: `flex items-center gap-2`, children: [C, T] })),
      (e[24] = C),
      (e[25] = T),
      (e[26] = E))
    : (E = e[26]);
  ...
  let O;
  e[28] !== v || e[29] !== y
    ? ((O = y ? null : (0, Z.jsx)(Wt, { installed: v })), (e[28] = v), (e[29] = y), (e[30] = O))
    : (O = e[30]);
  let k;
...
function Ut(e) {
  let t = (0, X.c)(39),
    { kind: n } = e,
    r = _(o),
    { data: i, isLoading: a } = g(S),
    s = x(),
    c = n === `download` ? i?.downloadApprovalMode : i?.uploadApprovalMode,
    l;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Z.jsx)(z, {
  ...
  t[4] === n
    ...
    : ((f = {
      ...
      (t[5] = f));
  let p;
  t[6] !== u || t[7] !== f ? ((p = [u, f]), (t[6] = u), (t[7] = f), (t[8] = p)) : (p = t[8]);
  let m = p,
    h;
  t[9] !== c || t[10] !== m
    ? ((h = m.find((e) => e.id === c) ?? m[0]), (t[9] = c), (t[10] = m), (t[11] = h))
    : (h = t[11]);
  let v = h,
    y = s.isPending,
    b;
  t[12] !== c || t[13] !== y || t[14] !== n || t[15] !== r || t[16] !== s
    ? ((b = async (e) => {
        if (!(e === c || y))
          try {
            await s.mutateAsync({ approvalMode: e, kind: n });
          } catch {
            r.get(U).danger(
              n === `download`
                ? (0, Z.jsx)(z, {
  ...
  t[21] === k
    ? (A = t[22])
    : ((A = (0, Z.jsx)(`span`, { className: `truncate`, children: k })), (t[21] = k), (t[22] = A));
  let M;
  t[23] !== O || t[24] !== A
    ? ((M = (0, Z.jsx)(Ue, { className: `w-[152px]`, disabled: O, children: A })),
      (t[23] = O),
      (t[24] = A),
      (t[25] = M))
    : (M = t[25]);
  let N;
  t[26] !== c || t[27] !== C || t[28] !== y || t[29] !== m
    ? ((N = (0, Z.jsx)(`div`, {
  ...
  return (
    t[35] !== P || t[36] !== w || t[37] !== T
      ? ((L = (0, Z.jsx)(E, { label: w, description: T, control: P })),
        (t[35] = P),
        (t[36] = w),
        (t[37] = T),
        (t[38] = L))
...
function Gt() {
  ...
  let r, i;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(Te, { className: `icon-xs` })),
      (i = (0, Z.jsx)(z, {
  ...
  e[4] === n
    ? (a = e[5])
    : ((a = (0, Z.jsxs)(H, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
      (e[4] = n),
      (e[5] = a));
  let o, s;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(z, {
      ...
      (s = (0, Z.jsx)(M, { className: `icon-xs text-token-text-secondary` })),
      (e[6] = o),
      (e[7] = s))
    : ((o = e[6]), (s = e[7]));
  let c;
...
function Kt() {
  ...
  e[0] === n
    ...
    : ((r = {
        mutationFn: rt,
        onSuccess: (e) => {
          n.setQueryData(d(`computer-use-sound-mode-read`), e);
        },
      }),
      (e[0] = n),
      (e[1] = r));
  ...
  e[6] === c.label
    ? (f = e[7])
    : ((f = (0, Z.jsx)(z, { ...c.label })), (e[6] = c.label), (e[7] = f));
  let p;
  e[8] !== l || e[9] !== f
    ? ((p = (0, Z.jsx)(Ue, {
    ...
    ? ((h = $.map((e) =>
        (0, Z.jsx)(
          I.Item,
          {
            ...
            RightIcon: o === e.value ? F : void 0,
            children: (0, Z.jsx)(`span`, {
              className: `text-sm`,
              children: (0, Z.jsx)(z, { ...e.label }),
            }),
          },
          e.value,
        ),
  ...
  e[14] === h
    ? (_ = e[15])
    : ((_ = (0, Z.jsx)(`div`, { className: `w-max max-w-[calc(100vw-2rem)]`, children: h })),
      (e[14] = h),
      (e[15] = _));
  let y;
  return (
    e[16] !== p || e[17] !== m || e[18] !== _
      ? ((y = (0, Z.jsx)(j, { triggerButton: p, align: `start`, disabled: m, children: _ })),
        (e[16] = p),
        (e[17] = m),
        (e[18] = _),
        (e[19] = y))
...
function Jt() {
  ...
  e[0] !== r || e[1] !== t
    ? ((a = (e) => {
        if (
          (r.setQueryData(d(`computer-use-background-auth-read`), (t) => ({
  ...
  let c;
  e[5] !== a || e[6] !== s
    ? ((c = { mutationFn: st, onSuccess: a, onError: s }), (e[5] = a), (e[6] = s), (e[7] = c))
    : (c = e[7]);
  let l = v(c);
  ...
  e[15] === l
    ...
    : ((b = (e) => {
      ...
      (e[16] = b));
  let x;
  e[17] !== i.data.enabled || e[18] !== h || e[19] !== y || e[20] !== b
    ? ((x = (0, Z.jsx)(je, { ariaLabel: h, checked: i.data.enabled, disabled: y, onChange: b })),
      (e[17] = i.data.enabled),
      (e[18] = h),
      (e[19] = y),
      (e[20] = b),
  ...
  return (
    e[22] !== f || e[23] !== x
      ? ((S = (0, Z.jsx)(ut, {
          children: (0, Z.jsx)(E, { icon: f, label: p, description: m, control: x }),
        })),
        (e[22] = f),
        (e[23] = x),
        (e[24] = S))
...
function Qt(e) {
  ...
  t[2] !== a || t[3] !== l
    ? ((u = async () => {
        a != null && (await l.mutateAsync(a.bundleIdentifier), s(null));
      }),
      (t[2] = a),
      (t[3] = l),
      (t[4] = u))
  ...
  t[5] === n?.approvedApps
    ? (f = t[6])
    : ((f = n?.approvedApps ?? []), (t[5] = n?.approvedApps), (t[6] = f));
  let p;
  t[7] !== i || t[8] !== l.isPending || t[9] !== f
    ? ((p = (0, Z.jsx)(tn, {
        approvedApps: f,
        intl: i,
  ...
  let S;
  t[16] !== x || t[17] !== y
    ? ((S = (0, Z.jsx)(Ee, { children: (0, Z.jsx)(Ce, { title: y, subtitle: x }) })),
      (t[16] = x),
      (t[17] = y),
      (t[18] = S))
    : (S = t[18]);
  ...
  t[21] === l.isPending
    ? (T = t[22])
    : ((T = (0, Z.jsx)(H, { color: `ghost`, disabled: l.isPending, onClick: C, children: w })),
      (t[21] = l.isPending),
      (t[22] = T));
  let E;
  t[23] === d
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (D = t[25]);
  let O;
  t[26] !== l.isPending || t[27] !== E
    ? ((O = (0, Z.jsx)(H, { color: `danger`, loading: l.isPending, onClick: E, children: D })),
      (t[26] = l.isPending),
      (t[27] = E),
      (t[28] = O))
    : (O = t[28]);
  let k;
  t[29] !== T || t[30] !== O
    ? ((k = (0, Z.jsx)(Ee, { children: (0, Z.jsxs)(ke, { children: [T, O] }) })),
      (t[29] = T),
      (t[30] = O),
      (t[31] = k))
    : (k = t[31]);
  let A;
  t[32] !== S || t[33] !== k
    ? ((A = (0, Z.jsxs)(Oe, { children: [S, k] })), (t[32] = S), (t[33] = k), (t[34] = A))
    : (A = t[34]);
  let j;
  t[35] !== A || t[36] !== m
    ? ((j = (0, Z.jsx)(de, { open: m, onOpenChange: h, size: `compact`, children: A })),
      (t[35] = A),
      (t[36] = m),
      (t[37] = j))
    : (j = t[37]);
  ...
  return (
    t[38] !== j || t[39] !== p
      ? ((M = (0, Z.jsxs)(Z.Fragment, { children: [p, j] })), (t[38] = j), (t[39] = p), (t[40] = M))
      : (M = t[40]),
    M
  );
}
...
function en(e, t) {
  let n = ge();
  return (
    (n === a.Dev ? G(e, cn, t) : a.isInternal(n) ? (G(e, ln, t) ?? G(e, cn, t)) : null) ??
    G(e, sn, t)
  );
}
function tn(e) {
          ...
          (0, Z.jsx)(
            E,
            {
              ...
              control: (0, Z.jsx)(H, {
                ...
                size: `icon`,
                children: (0, Z.jsx)(O, { className: `icon-2xs` }),
              }),
            },
            e.bundleIdentifier,
          )),
