...
import { lt as W, ut as He } from "./app-initial~app-main~automations-page.js";
import {
  $ as Ue,
  Ct as We,
  Ft as Ge,
...
function jt(e) {
  ...
  let r = n.isConnected ? `bg-[var(--color-icon-success)]` : `bg-[var(--color-icon-error)]`,
    i;
  t[1] === r ? (i = t[2]) : ((i = Ce(`h-2 w-2 shrink-0 rounded-full`, r)), (t[1] = r), (t[2] = i));
  let a;
  ...
  t[5] === n.isConnected
    ...
    : ((o = (0, q.jsx)(`span`, {
        ...
        children: n.isConnected
          ? (0, q.jsx)(f, { ...J.connected })
          : (0, q.jsx)(f, { ...J.disconnected }),
      })),
      (t[5] = n.isConnected),
      (t[6] = o));
  let s;
...
function Lt() {
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Z.jsx)(W.Header, { title: (0, Z.jsx)(f, { ...Y.control }) })), (e[5] = c))
    : (c = e[5]);
  let l;
  e[6] !== i || e[7] !== a
    ? ((l = (0, Z.jsx)(Rt, { computerUseAvailability: i, platform: a })),
      (e[6] = i),
      (e[7] = a),
      (e[8] = l))
    : (l = e[8]);
  ...
  e[9] !== n || e[10] !== i.available || e[11] !== a
    ? ((u = a === `macOS` && i.available && n ? (0, Z.jsx)(Jt, {}) : null),
      (e[9] = n),
      (e[10] = i.available),
      (e[11] = a),
      (e[12] = u))
  ...
  let d;
  e[13] !== l || e[14] !== u
    ? ((d = (0, Z.jsxs)(W, { children: [c, (0, Z.jsxs)(W.Content, { children: [l, u] })] })),
      (e[13] = l),
      (e[14] = u),
      (e[15] = d))
    : (d = e[15]);
    ...
    : ((p = i.available
        ? (0, Z.jsxs)(Z.Fragment, {
            children: [
              (0, Z.jsxs)(W, {
                children: [
                  (0, Z.jsx)(W.Header, { title: (0, Z.jsx)(f, { ...Y.alwaysAllowedApps }) }),
                  (0, Z.jsx)(W.Content, {
                    children: (0, Z.jsx)(ut, { children: (0, Z.jsx)(Zt, {}) }),
                  }),
                ],
              }),
              (0, Z.jsx)(Kt, {}),
  ...
  return (
    e[18] !== d || e[19] !== p
      ? ((m = (0, Z.jsxs)(ct, { title: o, subtitle: s, children: [d, p] })),
        (e[18] = d),
        (e[19] = p),
        (e[20] = m))
      : (m = e[20]),
...
function Rt(e) {
  let t = (0, X.c)(35),
    ...
    { data: u } = Se(Oe, c),
    d;
  t[0] === c ? (d = t[1]) : ((d = { hostId: c }), (t[0] = c), (t[1] = d));
  let p = a(d),
    m;
  t[2] === c ? (m = t[3]) : ((m = { hostId: c }), (t[2] = c), (t[3] = m));
  let { isUpdating: h, setAppEnabled: g, updatingAppId: _ } = pt(m),
    v;
  ...
  let b = we(c, v),
    ...
    S = C(Re),
    w;
  t[5] !== x || t[6] !== b.availablePlugins
    ? ((w = G(b.availablePlugins, on, x)), (t[5] = x), (t[6] = b.availablePlugins), (t[7] = w))
    : (w = t[7]);
  let T = w,
    E;
  t[8] !== x || t[9] !== b.availablePlugins
    ? ((E = en(b.availablePlugins, x)), (t[8] = x), (t[9] = b.availablePlugins), (t[10] = E))
    : (E = t[10]);
  let D = E,
    O = b.availablePlugins.find(Ae) ?? null,
    k = b.availablePlugins.find(ze) ?? null,
    A = [
      {
    ...
    j = D?.plugin.installed === !0,
    M = j && D.plugin.enabled,
    N = u?.find(Bt)?.isEnabled ?? !0,
    P = h && _ === Q,
    F;
  t[11] !== D || t[12] !== j || t[13] !== c
    ? ((F = { hostId: c, plugin: D, shouldReadBrowserExtension: j }),
      (t[11] = D),
      (t[12] = j),
      (t[13] = c),
      (t[14] = F))
  ...
  let I = Vt(F),
    L = [],
    R;
  t[15] !== D || t[16] !== p || t[17] !== l
    ? ((R =
        D == null && l && !p.isLoading && !p.allowed
          ? [
              {
                description: (0, Z.jsx)(f, { ...i.restrictedAvailabilityDescription }),
                icon: (0, Z.jsx)(`img`, {
                  alt: ``,
                ...
                title: (0, Z.jsx)(f, { ...Y.googleChrome }),
              },
            ]
          : []),
      (t[15] = D),
    ...
    : (R = t[18]);
  let ee = R;
  if (n.available && T != null) {
    let e, n;
    t[19] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Z.jsx)(f, { ...Y.anyApp })),
        (n = (0, Z.jsx)(f, {
    ...
    (t[21] === T
      ? (r = t[22])
      : ((r = { plugin: T, title: e, description: n }), (t[21] = T), (t[22] = r)),
      L.push(r));
  }
  if (D != null) {
    let e;
    t[23] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Z.jsx)(f, { ...Y.googleChrome })), (t[23] = e))
      : (e = t[23]);
    let n;
    t[24] === I ? (n = t[25]) : ((n = (0, Z.jsx)(jt, { status: I })), (t[24] = I), (t[25] = n));
    let r;
    t[26] !== M || t[27] !== s
      ? ((r = M
          ? (0, Z.jsx)(V, {
      ...
      L.push({
        ...(t.plugin.installed && t.plugin.enabled
          ? {
              ...
              isPending: P,
              onToggleEnabled: (t) => {
                g({ appId: Q, appName: o.formatMessage(e.title), enabled: t }).catch(zt);
              },
              toggleAriaLabel: o.formatMessage(e.toggleAriaLabel),
              toggleTooltip: N
                ? (0, Z.jsx)(f, { ...e.disableTooltip })
                : (0, Z.jsx)(f, { ...e.enableTooltip }),
            }
          : { displayName: o.formatMessage(e.title), plugin: t }),
        icon: (0, Z.jsx)(`img`, {
          alt: ``,
          className: `h-full w-full object-contain`,
          src: e.icon,
        }),
        title: (0, Z.jsx)(f, { ...e.title }),
        description: (0, Z.jsx)(f, { ...e.description }),
      });
    }
  let z, B;
  return (
...
function Ht() {
      ...
      e[10] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((r = (0, Z.jsx)(ct, {
            ...
            children: (0, Z.jsx)(`div`, {
              ...
              children: (0, Z.jsx)(de, { className: `icon-xs` }),
            }),
          })),
          (e[10] = r))
        : (r = e[10]),
  ...
  if (!a.isLoading && !u) {
    ...
    return (
      e[11] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, Z.jsx)(ue, { to: `/settings/computer-use`, replace: !0 })), (e[11] = t))
        : (t = e[11]),
      t
    );
  }
  ...
  e[15] !== y || e[16] !== b
    ...
    : (C = e[17]);
  let w;
  e[18] !== h || e[19] !== g || e[20] !== v || e[21] !== n || e[22] !== t
    ? ((w =
        n === `macOS` || n === `windows`
          ? (0, Z.jsx)(V, {
              color: `danger`,
              ...
              onClick: () => {
                h != null &&
                  S(`chrome-extension-settings-open`, { params: { extensionId: h } }).catch(() => {
                    t.get(I).danger(
                      (0, Z.jsx)(f, {
  ...
  let T;
  e[24] !== C || e[25] !== w
    ? ((T = (0, Z.jsxs)(`div`, { className: `flex items-center gap-2`, children: [C, w] })),
      (e[24] = C),
      (e[25] = w),
      (e[26] = T))
    : (T = e[26]);
  ...
  let O;
  e[28] !== g || e[29] !== v
    ? ((O = v ? null : (0, Z.jsx)(Wt, { installed: g })), (e[28] = g), (e[29] = v), (e[30] = O))
    : (O = e[30]);
  let k;
  ...
  e[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, Z.jsxs)(W, {
      ...
      (M = (0, Z.jsx)(gt, { surface: `googleChrome` })),
      (N = (0, Z.jsx)(St, {})),
      (e[33] = j),
      (e[34] = M),
      (e[35] = N))
...
function Ut(e) {
  ...
  let g = h,
    v;
  t[9] !== s || t[10] !== g
    ? ((v = g.find((e) => e.id === s) ?? g[0]), (t[9] = s), (t[10] = g), (t[11] = v))
    : (v = t[11]);
  let y = v,
    b = o.isPending,
    x;
  ...
  t[21] === O
    ? (k = t[22])
    : ((k = (0, Z.jsx)(`span`, { className: `truncate`, children: O })), (t[21] = O), (t[22] = k));
  let A;
  t[23] !== D || t[24] !== k
    ? ((A = (0, Z.jsx)(Xe, { className: `w-[152px]`, disabled: D, children: k })),
      (t[23] = D),
      (t[24] = k),
      (t[25] = A))
    : (A = t[25]);
  let M;
  t[26] !== s || t[27] !== S || t[28] !== b || t[29] !== g
    ? ((M = (0, Z.jsx)(`div`, {
  ...
  let P;
  return (
    t[35] !== N || t[36] !== C || t[37] !== w
      ? ((P = (0, Z.jsx)(U, { label: C, description: w, control: N })),
        (t[35] = N),
        (t[36] = C),
        (t[37] = w),
        (t[38] = P))
...
function Wt(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = Ce(`inline-flex w-max items-center gap-2 rounded-lg px-2 py-1 text-sm font-medium`, r)),
      (t[0] = r),
      (t[1] = i));
  let a = n ? `bg-[var(--color-icon-success)]` : `bg-token-charts-red`,
    o;
  t[2] === a ? (o = t[3]) : ((o = Ce(`h-2 w-2 rounded-full`, a)), (t[2] = a), (t[3] = o));
  let s;
...
function Gt() {
  ...
  let r, i;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(oe, { className: `icon-xs` })),
      (i = (0, Z.jsx)(f, {
  ...
  e[4] === n
    ? (a = e[5])
    : ((a = (0, Z.jsxs)(V, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
      (e[4] = n),
      (e[5] = a));
  let o, s;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(f, {
      ...
      (s = (0, Z.jsx)(_e, { className: `icon-xs text-token-text-secondary` })),
      (e[6] = o),
      (e[7] = s))
    : ((o = e[6]), (s = e[7]));
  let c;
...
function Kt() {
  ...
  e[0] === r
    ...
    : ((i = {
        mutationFn: nt,
        onSuccess: (e) => {
          r.setQueryData(u(`computer-use-sound-mode-read`), e);
        },
      }),
      (e[0] = r),
      (e[1] = i));
  ...
  let s;
  e[2] === t.data ? (s = e[3]) : ((s = Xt(t.data) ? t.data : dn), (e[2] = t.data), (e[3] = s));
  let l = s,
    d;
  e[4] === l
    ? (d = e[5])
    : ((d = $.find((e) => e.value === l) ?? $.find(qt) ?? $[0]), (e[4] = l), (e[5] = d));
  let p = d,
    h = t.isLoading || a.isPending,
    g;
  e[6] === p.label
    ? (g = e[7])
    : ((g = (0, Z.jsx)(f, { ...p.label })), (e[6] = p.label), (e[7] = g));
  let _;
  e[8] !== h || e[9] !== g
    ? ((_ = (0, Z.jsx)(Xe, {
    ...
    ? ((y = $.map((e) =>
        (0, Z.jsx)(
          m.Item,
          {
            ...
            RightIcon: l === e.value ? le : void 0,
            children: (0, Z.jsx)(`span`, {
              className: `text-sm`,
              children: (0, Z.jsx)(f, { ...e.label }),
            }),
          },
          e.value,
        ),
  ...
  e[14] === y
    ? (b = e[15])
    : ((b = (0, Z.jsx)(`div`, { className: `w-max max-w-[calc(100vw-2rem)]`, children: y })),
      (e[14] = y),
      (e[15] = b));
  let x;
  return (
    e[16] !== _ || e[17] !== v || e[18] !== b
      ? ((x = (0, Z.jsx)(j, { triggerButton: _, align: `start`, disabled: v, children: b })),
        (e[16] = _),
        (e[17] = v),
        (e[18] = b),
        (e[19] = x))
...
function Jt() {
  ...
  e[0] !== i || e[1] !== t
    ? ((s = (e) => {
        if (
          (i.setQueryData(u(`computer-use-background-auth-read`), (t) => ({
  ...
  let d;
  e[5] !== s || e[6] !== l
    ? ((d = { mutationFn: rt, onSuccess: s, onError: l }), (e[5] = s), (e[6] = l), (e[7] = d))
    : (d = e[7]);
  let p = o(d);
  ...
  e[17] !== a.data.enabled || e[18] !== v || e[19] !== y || e[20] !== b
    ? ((x = (0, Z.jsx)(k, { ariaLabel: v, checked: a.data.enabled, disabled: y, onChange: b })),
      (e[17] = a.data.enabled),
      (e[18] = v),
      (e[19] = y),
      (e[20] = b),
  ...
  return (
    e[22] !== m || e[23] !== x
      ? ((S = (0, Z.jsx)(ut, {
          children: (0, Z.jsx)(U, { icon: m, label: h, description: g, control: x }),
        })),
        (e[22] = m),
        (e[23] = x),
        (e[24] = S))
...
function Qt(e) {
  ...
  t[2] !== a || t[3] !== d
    ? ((p = async () => {
        a != null && (await d.mutateAsync(a.bundleIdentifier), c(null));
      }),
      (t[2] = a),
      (t[3] = d),
      (t[4] = p))
  ...
  let w;
  t[16] !== C || t[17] !== x
    ? ((w = (0, Z.jsx)(s, { children: (0, Z.jsx)(l, { title: x, subtitle: C }) })),
      (t[16] = C),
      (t[17] = x),
      (t[18] = w))
    : (w = t[18]);
  ...
  t[21] === d.isPending
    ? (k = t[22])
    : ((k = (0, Z.jsx)(V, { color: `ghost`, disabled: d.isPending, onClick: T, children: D })),
      (t[21] = d.isPending),
      (t[22] = k));
  let A;
  t[23] === m
  ...
  t[26] !== d.isPending || t[27] !== A
    ? ((M = (0, Z.jsx)(V, { color: `danger`, loading: d.isPending, onClick: A, children: j })),
      (t[26] = d.isPending),
      (t[27] = A),
      (t[28] = M))
    : (M = t[28]);
  let N;
  t[29] !== k || t[30] !== M
    ? ((N = (0, Z.jsx)(s, { children: (0, Z.jsxs)(O, { children: [k, M] }) })),
      (t[29] = k),
      (t[30] = M),
      (t[31] = N))
    : (N = t[31]);
  let P;
  t[32] !== w || t[33] !== N
    ? ((P = (0, Z.jsxs)(Te, { children: [w, N] })), (t[32] = w), (t[33] = N), (t[34] = P))
    : (P = t[34]);
  let F;
  t[35] !== P || t[36] !== v
    ? ((F = (0, Z.jsx)(pe, { open: v, onOpenChange: y, size: `compact`, children: P })),
      (t[35] = P),
      (t[36] = v),
      (t[37] = F))
    : (F = t[37]);
  ...
  return (
    t[38] !== F || t[39] !== g
      ? ((L = (0, Z.jsxs)(Z.Fragment, { children: [g, F] })), (t[38] = F), (t[39] = g), (t[40] = L))
      : (L = t[40]),
    L
  );
}
...
function en(e, t) {
  let n = ce();
  return (
    (n === d.Dev ? G(e, cn, t) : d.isInternal(n) ? (G(e, ln, t) ?? G(e, cn, t)) : null) ??
    G(e, sn, t)
  );
}
function tn(e) {
