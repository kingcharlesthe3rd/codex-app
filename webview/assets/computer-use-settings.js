...
import { f as c, g as l, k as u, n as d, r as f } from "./vscode-api.js";
import "./isEqual.js";
import { Cr as p } from "./src-4.js";
import { ls as m } from "./app-server-manager-signals.js";
import "./react-dom.js";
...
import "./tooltip.js";
import "./rpc-2.js";
import { a as C, c as w, d as T, f as E, o as D, p as O } from "./browser-use-settings-2.js";
...
import { a as A, m as j, p as M } from "./chunk-8.js";
...
import { O as N } from "./mention-item.js";
...
import { c as R, p as z, s as B } from "./use-plugin-install-flow.js";
import "./folder.js";
...
import { a as V, i as H, l as U, n as W, r as te } from "./dialog-layout.js";
...
function Me(e) {
  ...
  let s = I(o),
    c;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((c = []), (t[2] = c)) : (c = t[2]);
  let l = ee(i, c),
    u = ve(i),
    d;
  t[3] !== u || t[4] !== l.availablePlugins
    ? ((d = T(l.availablePlugins, Te, u)), (t[3] = u), (t[4] = l.availablePlugins), (t[5] = d))
    : (d = t[5]);
  let f = d,
    p;
  t[6] !== u || t[7] !== l.availablePlugins
    ? ((p = Ke(l.availablePlugins, u)), (t[6] = u), (t[7] = l.availablePlugins), (t[8] = p))
    : (p = t[8]);
  let h = p,
  ...
  if (
    ...
    if (
      ...
      (t[29] === f
        ? (r = t[30])
        : ((r = { plugin: f, title: e, description: n }), (t[29] = f), (t[30] = r)),
        S.push(r));
    }
    if (h != null) {
      let e;
...
function Pe() {
  ...
  let o = ee(r, i),
    l = ve(r),
    u;
  e[1] !== l || e[2] !== o.installedPlugins
    ? ((u = Ke(o.installedPlugins, l)), (e[1] = l), (e[2] = o.installedPlugins), (e[3] = u))
    : (u = e[3]);
  let f = u,
    p = f?.plugin.installed === !0,
    m = p && f.plugin.enabled,
    h;
  e[4] !== f || e[5] !== p || e[6] !== r
    ? ((h = { hostId: r, plugin: f, shouldReadBrowserExtension: p }),
      (e[4] = f),
      (e[5] = p),
      (e[6] = r),
      (e[7] = h))
  ...
  e[12] === v
    ...
    : ((j = () => {
        v?.url != null &&
          c.dispatchMessage(`open-in-browser`, { url: v.url, useExternalBrowser: !0 });
      }),
      (e[12] = v),
      (e[13] = j));
  let M;
    ...
    ? ((F =
        n === `macOS` || n === `windows`
          ? (0, Z.jsx)(y, {
              ...
              onClick: () => {
                x != null &&
                  d(`chrome-extension-settings-open`, { params: { extensionId: x } }).catch(() => {
                    t.get(k).danger(
                      (0, Z.jsx)(g, {
  ...
  let R;
  e[28] !== S || e[29] !== T
    ? ((R = T ? null : (0, Z.jsx)(Ie, { installed: S })), (e[28] = S), (e[29] = T), (e[30] = R))
    : (R = e[30]);
  let z;
  ...
  e[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, Z.jsxs)(Y, {
      ...
      (H = (0, Z.jsx)(D, { surface: `googleChrome` })),
      (U = (0, Z.jsx)(O, {})),
      (e[33] = V),
      (e[34] = H),
      (e[35] = U))
...
function Le() {
  ...
  let r, i;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(ne, { className: `icon-xs` })),
      (i = (0, Z.jsx)(g, {
...
function Re() {
  ...
  e[0] === n
    ...
    : ((r = {
        mutationFn: fe,
        onSuccess: (e) => {
          n.setQueryData(f(`computer-use-sound-mode-read`), e);
        },
      }),
      (e[0] = n),
      (e[1] = r));
  ...
  let d = c,
    p = t.isLoading || i.isPending,
    m;
  e[6] === d.label
    ? (m = e[7])
    : ((m = (0, Z.jsx)(g, { ...d.label })), (e[6] = d.label), (e[7] = m));
  let h;
  e[8] !== p || e[9] !== m
    ? ((h = (0, Z.jsx)(me, {
...
function Be() {
  ...
  e[0] !== r || e[1] !== t
    ? ((c = (e) => {
        if (
          (r.setQueryData(f(`computer-use-background-auth-read`), (t) => ({
  ...
  let p;
  e[5] !== c || e[6] !== d
    ? ((p = { mutationFn: ue, onSuccess: c, onError: d }), (e[5] = c), (e[6] = d), (e[7] = p))
    : (p = e[7]);
  let m = l(p);
...
function We(e) {
  ...
  let T;
  t[16] !== w || t[17] !== S
    ? ((T = (0, Z.jsx)(V, { children: (0, Z.jsx)(H, { title: S, subtitle: w }) })),
      (t[16] = w),
      (t[17] = S),
      (t[18] = T))
    : (T = t[18]);
  ...
  let N;
  t[29] !== O || t[30] !== M
    ? ((N = (0, Z.jsx)(V, { children: (0, Z.jsxs)(te, { children: [O, M] }) })),
      (t[29] = O),
      (t[30] = M),
      (t[31] = N))
    : (N = t[31]);
  let P;
  t[32] !== T || t[33] !== N
    ? ((P = (0, Z.jsxs)(W, { children: [T, N] })), (t[32] = T), (t[33] = N), (t[34] = P))
    : (P = t[34]);
  let F;
  t[35] !== P || t[36] !== v
    ? ((F = (0, Z.jsx)(U, { open: v, onOpenChange: b, size: `compact`, children: P })),
      (t[35] = P),
      (t[36] = v),
      (t[37] = F))
    : (F = t[37]);
...
function Ke(e, t) {
  let n = L();
  return (
    (n === p.Dev ? T(e, De, t) : p.isInternal(n) ? (T(e, Oe, t) ?? T(e, De, t)) : null) ??
    T(e, Ee, t)
  );
}
function qe(e) {
