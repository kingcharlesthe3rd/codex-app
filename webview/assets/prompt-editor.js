...
import { f as y } from "./chunk-8.js";
import { t as b } from "./known-app-icon.js";
import { p as x } from "./codex-api-B.js";
import { b as S, s as C } from "./apps-queries.js";
import { t as ee } from "./connector-logo.js";
import { a as w, i as T, o as E, r as D, s as O, t as k } from "./prompt-text.js";
import {
  c as A,
  d as te,
  i as j,
...
import { v as L } from "./use-plugins.js";
import { t as R } from "./globe.js";
import { a as oe, i as se, n as ce, r as le, s as ue, t as z } from "./inline-mention-style.js";
import { c as de, f as B, h as fe, o as pe, s as me, u as he } from "./use-native-apps.electron.js";
import { n as ge } from "./use-skills.js";
import { t as _e } from "./sortBy.js";
import { r as ve } from "./composer-top-menu-chrome.js";
import { c as ye, d as be, l as xe, m as Se, o as V, s as Ce, u as we } from "./at-mention-list.js";
import {
  a as Te,
  c as Ee,
  d as De,
...
import { t as He } from "./list-navigation.js";
...
function Y(e) {
  let t = (0, J.c)(10),
    ...
    l = Ze(null),
    u;
  t[0] === c.pathname ? (u = t[1]) : ((u = Se(c.pathname)), (t[0] = c.pathname), (t[1] = u));
  let d = u,
...
var st = typeof navigator < `u` && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
...
function _t(e, t, n) {
  let { state: r } = e,
    i = t.getState(r);
  return i?.active !== !0 || !gt(i, n) ? !1 : (e.dispatch(r.tr.setMeta(t, ht(i))), !0);
}
var vt = 50;
function yt(e, t) {
...
function bt(e) {
  ...
  return [
    ...
    ft({
      Escape: (e, n) =>
        t.getState(e)?.active && n !== void 0 ? (n(e.tr.setMeta(t, mt)), a(), !0) : !1,
    }),
    ft({
      Tab: (e, n) =>
...
var wt = t((e) => {
    ...
    function fe(e, t) {
      return (
        ...
        z(t.insertionMode, t.selectedValue, t.tagScope | 12, B(t.viewTransition))
      );
    }
    function pe(e, t) {
      ...
      var n = t.tagScope | 16;
      return (
        e !== null && e.share !== `none` && (n |= 64), z(t.insertionMode, t.selectedValue, n, e)
      );
    }
    var me = new Map();
    function he(e, t) {
        ...
        if (D.call(t, i)) {
          ...
          if (a != null && typeof a != `boolean` && a !== ``) {
            if (i.indexOf(`--`) === 0) {
              ...
              ((o = me.get(i)),
                o === void 0 &&
                  ((o = P(i.replace(ne, `-$1`).toLowerCase().replace(re, `-ms-`))), me.set(i, o)),
                (a =
                  typeof a == `number`
                    ? a === 0 || j.has(i)
                      ? `` + a
    ...
    var ve = P(`javascript:throw new Error('React form unexpectedly submitted.')`);
    function ye(e, t) {
    ...
    function Se(e, t, n, r, i, a, o, s) {
      ...
      if (typeof r == `function`) {
        var l = xe(t, r);
        l === null
          ? (e.push(` `, `formAction`, `="`, ve, `"`), (o = a = i = r = s = null), Te(t, n))
          : ((s = l.name),
            (r = l.action || ``),
            (i = l.encType),
            (a = l.method),
    ...
    function V(e, t, n) {
      switch (t) {
        ...
        case `focusable`:
        case `preserveAlpha`:
          typeof n != `function` && typeof n != `symbol` && e.push(` `, t, `="`, P(n), `"`);
          break;
        case `inert`:
    ...
    function Oe(e, t) {
      ...
      return (
        ...
        typeof t != `function` && typeof t != `symbol` && t != null && e.push(P(`` + t)),
        Ce(e, r, n),
        e.push(Pe(`title`)),
        null
      );
    ...
    function je(e, t, n) {
      ...
      return (e.push(`>`), Ce(e, r, n), typeof n == `string` ? (e.push(P(n)), null) : n);
    }
...
`),
        ...
        case `input`:
          ...
          return (
            ce === null ? le !== null && ge(e, `checked`, le) : ge(e, `checked`, ce),
        ...
        case `button`:
          ...
          if ((e.push(`>`), Fe?.forEach(ye, e), Ce(e, fe, B), typeof B == `string`)) {
            e.push(P(B));
            var Ie = null;
          } else Ie = B;
          return Ie;
        case `form`:
          ...
          if (typeof ze == `function`) {
            var q = xe(i, ze);
            q === null
              ? (e.push(` `, `action`, `="`, ve, `"`), (He = Ve = Be = ze = null), Te(i, a))
              : ((ze = q.action || ``),
                (Be = q.encType),
                (Ve = q.method),
                (He = q.target),
          ...
          if (
            ...
            e.push(`>`),
            Ke !== null &&
              (e.push(`<input type="hidden"`), _e(e, `name`, Ke), e.push(`/>`), Ge?.forEach(ye, e)),
            Ce(e, Re, Le),
            typeof Le == `string`)
          ) {
            e.push(P(Le));
        ...
        case `title`:
          var Y = c.tagScope & 1,
            X = c.tagScope & 4;
          if (c.insertionMode === 4 || Y || n.itemProp != null) var tt = Oe(e, n);
        ...
        case `link`:
          ...
          if (
            ...
            if (typeof ot != `string` || n.disabled != null || n.onLoad || n.onError) st = Ee(e, n);
            else {
              ...
              if (dt !== null) {
                ((i.styleResources[at] = null),
                  ut ||
                    ((ut = { precedence: P(ot), rules: [], hrefs: [], sheets: new Map() }),
                    a.styles.set(ot, ut)));
                var ft = {
                  state: 0,
            ...
            n.onLoad || n.onError
              ? (st = Ee(e, n))
              : (l && e.push(`<!-- -->`), (st = rt ? null : Ee(a.hoistableChunks, n)));
          return st;
        case `script`:
          var ht = c.tagScope & 1,
            gt = n.async;
          ...
          if (
            ...
            if ((i.styleResources.hasOwnProperty(Dt) ? i.styleResources[Dt] : void 0) !== null) {
              ((i.styleResources[Dt] = null),
                Ft ||
                  ((Ft = { precedence: P(Et), rules: [], hrefs: [], sheets: new Map() }),
                  a.styles.set(Et, Ft)));
        ...
        case `meta`:
          var Ut = c.tagScope & 1,
            Wt = c.tagScope & 4;
          if (c.insertionMode === 4 || Ut || n.itemProp != null) var Gt = U(e, n, `meta`);
          else
            (l && e.push(`<!-- -->`),
              (Gt = Wt
                ? null
...
` +
                ...
                if (gn != null) {
                  ...
                  switch (hn) {
                    ...
                    case `className`:
                      _n = `class`;
                    default:
                      if (te(hn) && typeof gn != `function` && typeof gn != `symbol` && !1 !== gn) {
                        if (!0 === gn) gn = ``;
    ...
    function $e(e, t) {
      !(t.instructions & 32) &&
        ((t.instructions |= 32), e.push(` id="`, P(`_` + t.idPrefix + `R_`), `"`));
    }
    function et(e, t) {
      e.push(`[`);
      var n = `[`;
            ...
            ((a = n && 0 < n.remainingCapacity) &&
              ...
              a
                ? ((r.resets.dns[e] = null),
                  ...
                  (n.preconnects += i))
                : ((i = []), Ee(i, { href: e, rel: `dns-prefetch` }), r.preconnects.add(i)));
          }
          Or(t);
        }
      } else R.D(e);
...
` +
            ...
            default:
              ...
              if (
                ...
                switch (((i = []), (e = E({ rel: `preload`, href: e, as: t }, n)), Ee(i, e), t)) {
                  case `font`:
    ...
    function it(e, t) {
      ...
      if (n) {
        ...
        if (e) {
          ...
          (Ee(a, E({ rel: `modulepreload`, href: e }, t)), i.bulkPreloads.add(a), Or(n));
        }
      } else R.m(e, t);
    }
    function at(e, t, n) {
      ...
      if (r) {
        ...
        if (e) {
          ...
          s !== null &&
            ...
            o ||
              ((o = { precedence: P(t), rules: [], hrefs: [], sheets: new Map() }),
              a.styles.set(t, o)),
...
`:
    ...
    function _t(e, t) {
      ...
      (i !== void 0 &&
        (r.push(`<script`), $e(r, e), r.push(`>`, (`` + i).replace(ce, le), `<\/script>`)),
        (i = n + `P:`));
      var s = n + `S:`;
      n += `B:`;
      var c = new Set(),
    ...
    function ln() {
      ((Jt = qt = Kt = Gt = null), (Xt = !1), (Z = null), (rn = 0), (Q = nn = null));
    }
    function un(e, t) {
    ...
    function fn(e, t) {
      if (((Gt = an()), (Q = sn()), (t = t === void 0 ? null : t), Q !== null)) {
...
` +
    ...
    function Yn(e, t, n, r, i, a) {
      ...
      for (
        ...
        ((Xt = !1), (Qt = Zt = 0), ($t = -1), (en = 0), (rn += 1), (Q = null), (e = r(i, a)));
      return (ln(), e);
    }
    ...
    function Zn(e, t, n, i, a, d) {
      if (typeof i == `function`)
        ...
        switch (i) {
          ...
          case c:
          case o:
            ((i = t.keyPath), (t.keyPath = n), $n(e, t, a.children, -1), (t.keyPath = i));
            return;
          case y:
            ((i = t.blockedSegment),
              i === null
                ? a.mode !== `hidden` &&
                  ((i = t.keyPath), (t.keyPath = n), sr(e, t, a.children, -1), (t.keyPath = i))
                : a.mode !== `hidden` &&
        ...
        if (typeof i == `object` && i)
          switch (i.$$typeof) {
            case f:
              if (`ref` in a) for (te in ((m = {}), a)) te !== `ref` && (m[te] = a[te]);
              else m = a;
              ((i = Yn(e, t, n, i.render, m, d)), Xn(e, t, n, i, Zt !== 0, Qt, $t));
              return;
            case g:
              Zn(e, t, n, i.type, a, d);
              return;
    ...
    function er(e, t) {
      ...
      if (n !== null) {
        if (typeof n == `object`) {
          ...
          if (typeof n.then == `function`) return ((t.thenableState = null), $n(e, t, vn(n), o));
      ...
      if (
        ...
        for (i = 0; i < s; i++)
          ((l = n[i]),
            ...
            (u = c[i]),
            typeof u == `number` ? (Qn(e, t, u, l, i), delete c[i]) : sr(e, t, l, i));
        ((t.treeContext = o), (t.keyPath = a));
        return;
      }
      for (c = 0; c < s; c++) ((i = n[c]), (t.treeContext = Nt(o, s, c)), sr(e, t, i, c));
      ((t.treeContext = o), (t.keyPath = a));
    }
    function nr(e, t, n) {
      if (
        ...
        if (
          ...
          a === null
            ...
            : ((n = t.workingMap.get(a)),
              n === void 0 ? ((n = [a[1], a[2], [], i.id]), jr(n, a[0], t)) : (n[3] = i.id));
        else {
          if (a === null) {
      ...
      if (
        ...
        if (t.pendingTasks === 0) {
          if (
            ...
            i !== null && i.parentFlushed && (i.status === 1 || i.status === 3) && mr(t, i),
    ...
    function vr(e, t, n) {
      ...
      switch (i.status) {
        case 1:
          if ((Fe(e.renderState, a), (e.byteSize += i.byteSize), (t = i.completedSegments[0]), !t))
            throw Error(r(391));
          return _r(e, t, n);
        case 5:
    ...
    function Sr(e, t, n, i) {
      ...
      if (
        ...
        throw Error(r(391));
      return (
        Sr(e, t, n[0], i), (e = e.renderState.generateStaticMarkup ? !0 : t.push(`<!--/$-->`)), e
      );
    }
    function Cr(e, t, n, r) {
      return (
...
$RC=function(a,b){if(b=document.getElementById(b))(a=document.getElementById(a))?(a.previousSibling.data="$~",$RB.push(a,b),2===$RB.length&&("number"!==typeof $RT?requestAnimationFrame($RV.bind(null,$RB)):(a=performance.now(),setTimeout($RV.bind(null,$RB),2300>a&&2E3<a?2300-a:$RT+300-a)))):b.parentNode.removeChild(b)};`)),
          ...
          for (n = 0; n < F.length; n++) {
            ...
            a: {
              ...
              (L !== null &&
                L.together &&
                I.pendingTasks === 1 &&
                (L.pendingTasks === 1 ? Gn(D, L, L.hoistables) : L.pendingTasks--),
  ...
  Tt = t((e) => {
    ...
    function N(e, t) {
      if (t.byteLength !== 0)
        if (2048 < t.byteLength)
          (0 < M &&
            (e.enqueue(new Uint8Array(j.buffer, 0, M)), (j = new Uint8Array(2048)), (M = 0)),
            e.enqueue(t));
        else {
          var n = j.length - M;
          (n < t.byteLength &&
    ...
    function ne(e) {
      j && 0 < M && (e.enqueue(new Uint8Array(j.buffer, 0, M)), (j = null), (M = 0));
    }
    ...
    var ge = t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
      ...
      ye = _e.d;
    _e.d = { f: ye.f, r: ye.r, D: ur, C: dr, L: fr, m: pr, X: hr, S: mr, M: gr };
    var be = [],
      xe = null;
    I(`"></template>`);
    var Se = I(`<script`),
    ...
    function Me(e, t, n, r, i, a) {
      ...
      if (
        (d !== void 0 && (u.push(o), nr(u, e), u.push(X, F((`` + d).replace(Oe, ke)), V)),
        (d = []),
        r !== void 0 &&
          (d.push(Ae), d.push(F((`` + JSON.stringify(r)).replace(Oe, ke))), d.push(je)),
        (r = i
          ? {
              preconnects: ``,
              fontPreloads: ``,
    ...
    function Ie(e, t) {
      return (
        t.tagScope & 32 && (e.instructions |= 128),
        G(t.insertionMode, t.selectedValue, t.tagScope | 12, Fe(t.viewTransition))
      );
    }
    function Le(e, t) {
      ...
      var n = t.tagScope | 16;
      return (
        e !== null && e.share !== `none` && (n |= 64), G(t.insertionMode, t.selectedValue, n, e)
      );
    }
    var Re = I(`<!-- -->`);
    function ze(e, t, n, r) {
        ...
        if (R.call(t, i)) {
          ...
          if (a != null && typeof a != `boolean` && a !== ``) {
            if (i.indexOf(`--`) === 0) {
              ...
              ((o = Be.get(i)),
                o === void 0 &&
                  ((o = I(B(i.replace(fe, `-$1`).toLowerCase().replace(pe, `-ms-`)))),
                  Be.set(i, o)),
                (a =
                  typeof a == `number`
                    ? a === 0 || ue.has(i)
    ...
    var Ge = I(` `),
      ...
      qe = I(`=""`);
    function Je(e, t, n) {
      n && typeof n != `function` && typeof n != `symbol` && e.push(Ge, F(t), qe);
    }
    function J(e, t, n) {
      typeof n != `function` &&
        typeof n != `symbol` &&
    ...
    var Ye = I(B(`javascript:throw new Error('React form unexpectedly submitted.')`)),
      Xe = I(`<input type="hidden"`);
    function Ze(e, t) {
      (this.push(Xe), Qe(e), J(this, `name`, t), J(this, `value`, e), this.push(tt));
    }
    function Qe(e) {
      if (typeof e != `string`) throw Error(r(480));
    }
    ...
    function et(e, t, n, r, i, a, o, s) {
      ...
      if (typeof r == `function`) {
        var l = $e(t, r);
        l === null
          ? (e.push(Ge, F(`formAction`), Ke, Ye, q), (o = a = i = r = s = null), ot(t, n))
          : ((s = l.name),
            (r = l.action || ``),
            (i = l.encType),
            (a = l.method),
    ...
    function Y(e, t, n) {
      switch (t) {
        ...
        case `focusable`:
        case `preserveAlpha`:
          typeof n != `function` && typeof n != `symbol` && e.push(Ge, F(t), Ke, F(B(n)), q);
          break;
        case `inert`:
        case `allowFullScreen`:
        case `async`:
    ...
    function pt(e, t) {
      ...
      return (
        e.push(X),
        (t = Array.isArray(n) ? (2 > n.length ? n[0] : null) : n),
        typeof t != `function` && typeof t != `symbol` && t != null && e.push(F(B(`` + t))),
        nt(e, r, n),
        e.push(Dt(`title`)),
        null
      );
    ...
    function yt(e, t, n) {
      ...
      return (e.push(X), nt(e, r, n), typeof n == `string` ? (e.push(F(B(n))), null) : n);
    }
    var bt = I(`
`),
...
` &&
        ...
        case `input`:
          ...
          return (
            ae === null ? oe !== null && Je(e, `checked`, oe) : Je(e, `checked`, ae),
        ...
        case `button`:
          ...
          if ((e.push(X), xe?.forEach(Ze, e), nt(e, de, z), typeof z == `string`)) {
            e.push(F(B(z)));
            var Se = null;
          } else Se = z;
          return Se;
        case `form`:
          ...
          if (typeof we == `function`) {
            var Ae = $e(i, we);
            Ae === null
              ? (e.push(Ge, F(`action`), Ke, Ye, q), (De = Ee = Te = we = null), ot(i, a))
              : ((we = Ae.action || ``),
                (Te = Ae.encType),
                (Ee = Ae.method),
                (De = Ae.target),
          ...
          if (
            ...
            e.push(X),
            ke !== null && (e.push(Xe), J(e, `name`, ke), e.push(tt), Oe?.forEach(Ze, e)),
            nt(e, Ce, V),
            typeof V == `string`)
          ) {
            e.push(F(B(V)));
        ...
        case `title`:
          var Le = c.tagScope & 1,
            ze = c.tagScope & 4;
          if (c.insertionMode === 4 || Le || n.itemProp != null) var Be = pt(e, n);
        ...
        case `link`:
          ...
          if (
            ...
            if (typeof Qe != `string` || n.disabled != null || n.onLoad || n.onError) at = lt(e, n);
            else {
              var st = a.styles.get(Qe),
                ct = i.styleResources.hasOwnProperty(qe) ? i.styleResources[qe] : void 0;
              if (ct !== null) {
                ((i.styleResources[qe] = null),
                  st ||
                    ((st = { precedence: F(B(Qe)), rules: [], hrefs: [], sheets: new Map() }),
                    a.styles.set(Qe, st)));
                var xt = {
                  state: 0,
                  props: L({}, n, { "data-precedence": n.precedence, precedence: null }),
                };
                if (ct) {
          ...
          if (
            ...
            if ((i.styleResources.hasOwnProperty(zt) ? i.styleResources[zt] : void 0) !== null) {
              ((i.styleResources[zt] = null),
                qt ||
                  ((qt = { precedence: F(B(Rt)), rules: [], hrefs: [], sheets: new Map() }),
                  a.styles.set(Rt, qt)));
...
` +
                ...
                if (On != null) {
                  ...
                  switch (Dn) {
                    ...
                    case `className`:
                      kn = `class`;
                    default:
                      if (le(Dn) && typeof On != `function` && typeof On != `symbol` && !1 !== On) {
                        if (!0 === On) On = ``;
    ...
    function dn(e, t, n, i) {
      switch (n.insertionMode) {
        ...
        case 3:
        case 2:
          return (N(e, Gt), N(e, t.segmentPrefix), N(e, F(i.toString(16))), P(e, Kt));
        case 4:
          return (N(e, Jt), N(e, t.segmentPrefix), N(e, F(i.toString(16))), P(e, Z));
        case 5:
          return (N(e, Yt), N(e, t.segmentPrefix), N(e, F(i.toString(16))), P(e, Xt));
        case 6:
          return (N(e, Qt), N(e, t.segmentPrefix), N(e, F(i.toString(16))), P(e, $t));
        case 7:
          return (N(e, tn), N(e, t.segmentPrefix), N(e, F(i.toString(16))), P(e, nn));
        case 8:
          return (N(e, an), N(e, t.segmentPrefix), N(e, F(i.toString(16))), P(e, on));
        case 9:
          return (N(e, cn), N(e, t.segmentPrefix), N(e, F(i.toString(16))), P(e, ln));
        default:
          throw Error(r(397));
      }
    }
...
"$~";Promise.all(b).then($RC.bind(null,n,w),$RX.bind(null,n,"CSS failed to load"))};$RR("`),
    ...
    function Vn(e) {
      ...
      if (n.length) {
        for (
          N(this, xe.startInlineStyle), N(this, Fn), N(this, e.precedence), N(this, In);
          r < n.length - 1;
          r++
        )
          (N(this, n[r]), N(this, Yn));
        for (N(this, n[r]), N(this, Ln), r = 0; r < t.length; r++) N(this, t[r]);
    ...
    function Qn(e) {
      ...
      var n = e.rules,
        r = e.hrefs;
      if (!t || r.length) {
        if ((N(this, xe.startInlineStyle), N(this, qn), N(this, e.precedence), (e = 0), r.length)) {
    ...
    function sr(e, t) {
      ...
      (t.stylesheets.forEach(function (t) {
        if (t.state !== 2)
          if (t.state === 3) (N(e, n), N(e, F(Pn(`` + t.props.href))), N(e, or), (n = ir));
          else {
            N(e, n);
            var i = t.props[`data-precedence`],
              a = t.props;
...
` +
            ...
            default:
              ...
              if (
                ...
                switch (((i = []), (e = L({ rel: `preload`, href: e, as: t }, n)), lt(i, e), t)) {
                  case `font`:
                    a.fontPreloads.add(i);
                    break;
                  default:
    ...
    function pr(e, t) {
      ...
      if (n) {
        ...
        if (e) {
          ...
          (lt(a, L({ rel: `modulepreload`, href: e }, t)), i.bulkPreloads.add(a), Ba(n));
        }
      } else ye.m(e, t);
    }
    function mr(e, t, n) {
      ...
      if (r) {
        ...
        if (e) {
          ...
          s !== null &&
            ((i.styleResources[e] = null),
            o ||
              ((o = { precedence: F(B(t)), rules: [], hrefs: [], sheets: new Map() }),
              a.styles.set(t, o)),
            (t = { state: 0, props: L({ rel: `stylesheet`, href: e, "data-precedence": t }, n) }),
            s &&
...
` +
    ...
    function sa(e, t, n, i, a, d) {
      if (typeof i == `function`)
        if (i.prototype && i.prototype.isReactComponent) {
          ...
          if (`ref` in a) for (var x in ((m = {}), a)) x !== `ref` && (m[x] = a[x]);
          var C = i.defaultProps;
          if (C) for (var T in (m === a && (m = L({}, m, a)), C)) m[T] === void 0 && (m[T] = C[T]);
          ((a = m),
            (m = Ar),
            (C = i.contextType),
    ...
    function ua(e, t) {
      ...
      if (n !== null) {
                  ...
                  for (o = h.nodes, n = 0; n < o.length; n++) {
                    ...
                    if (m === g[1]) {
                      if (g.length === 4) {
                        ...
                        if (s !== p) throw Error(r(490, `Suspense`, kr(s) || `Unknown`));
                        b: {
                          ((h = void 0),
                            (s = g[5]),
                            (d = g[2]),
        ...
        typeof n == `string`
          ? ((o = t.blockedSegment),
            o !== null && (o.lastPushedText = ze(o.chunks, n, e.renderState, o.lastPushedText)))
          : (typeof n == `number` || typeof n == `bigint`) &&
            ((o = t.blockedSegment),
            o !== null &&
              (o.lastPushedText = ze(o.chunks, `` + n, e.renderState, o.lastPushedText)));
      }
    }
    function da(e, t, n, i) {
      var a = t.keyPath;
        ...
        for (var o = t.replay, s = o.nodes, c = 0; c < s.length; c++) {
          ...
          if (l[1] === i) {
            ...
            try {
              ...
              if (typeof r == `object` && r && (r === Kr || typeof r.then == `function`)) throw r;
      ...
      for (c = 0; c < s; c++) ((i = n[c]), (t.treeContext = Br(o, s, c)), _a(e, t, i, c));
      ((t.treeContext = o), (t.keyPath = a));
    }
    function fa(e, t, n) {
      if (
    ...
    function Fa(e, t, n) {
      ...
      return (
        ...
        a
          ...
          : (!(r.instructions & 2) && ((r.instructions |= 2), N(t, _n)), N(t, vn)),
        (r = F(i.toString(16))),
    ...
    function Ra(e, t) {
      ...
      try {
        if (!(0 < e.pendingRootTasks)) {
          ...
          if (r !== null) {
            ...
            if (
              ...
              if (!(b.instructions & 64)) {
                if (((b.instructions |= 64), N(t, y.startInlineScript), !(b.instructions & 32))) {
                  b.instructions |= 32;
          ...
          (te.splice(0, n), ne(t), (j = new Uint8Array(2048)), (M = 0), (La = !0));
          ...
          for (n = 0; n < re.length; n++) {
            ...
            a: {
              ...
              (L !== null &&
                L.together &&
                I.pendingTasks === 1 &&
                (L.pendingTasks === 1 ? ta(w, L, L.hoistables) : L.pendingTasks--),
        ...
        return new Promise(function (r, i) {
          var a,
            ...
            c = Vi(
              e,
              t,
              Me(t.resumableState, n ? n.nonce : void 0, void 0, void 0, void 0, void 0),
              n ? n.onError : void 0,
              o,
              function () {
                var e = new ReadableStream(
  ...
  let l =
    ...
    u = (0, Et.renderToStaticMarkup)(
      (0, Ye.createElement)(
        ...
        (0, Ye.createElement)(`span`, { className: p(`min-w-0 break-words`, s) }, o),
      ),
    ),
  ...
  return {
    ...
    toDOM: (s) => {
      let c = s.attrs.displayName || s.attrs.name,
        ...
        u = e === `app-mention` && S(s.attrs.iconSmall) != null ? `` : s.attrs.iconSmall;
      return Dt({
        text: c,
        icon:
          e === `skill-mention`
...
function Bt(e, t) {
  ...
  ((Rt += 1),
    e.dispatch(e.state.tr.setMeta(Lt, { handlers: t, subscriptionId: n, type: `addHandlers` })));
  let r = !0;
  return () => {
    r &&
      ((r = !1),
      Lt.getState(e.state)?.handlerSubscriptions[n] &&
        e.dispatch(e.state.tr.setMeta(Lt, { subscriptionId: n, type: `removeHandlers` })));
  };
}
function Vt(e = {}) {
  return new ke({
...
function qt(e, t) {
  ...
  for (let a of e) {
    ...
    let s = c(e),
      l = i(s);
    r.has(l) || (r.add(l), n.push({ label: o(s) || a.name || s, path: s, fsPath: s }));
  }
  return n;
}
function Jt(e) {
  ...
  return (
    ...
    (0, Z.jsx)(`div`, {
      ...
      onClick: (e) => {
        ...
        n && (e.preventDefault(), e.stopPropagation(), ie({ path: n, cwd: null }));
      },
      className: p(
        `text-size-chat`,
...
function Zt(e) {
  let t = (0, J.c)(21),
    ...
    { data: _ } = x(),
    v;
  t[0] === l ? (v = t[1]) : ((v = { enabled: !0, hostId: l }), (t[0] = l), (t[1] = v));
  let y = C(v),
  ...
  t[5] !== _?.name || t[6] !== m || t[7] !== D
    ? ((k = (e) => {
        ...
        return {
          ...t,
          key: t.path,
          scopeLabel: Ve({ skill: e, intl: m, roots: D, adminLabel: _?.name ?? void 0 }),
          Icon: de(),
        };
      }),
      (t[5] = _?.name),
  ...
  return (
    t[16] !== I || t[17] !== f || t[18] !== ie || t[19] !== oe
      ? ((se = (0, Z.jsx)(I, { chromeVariant: f, className: ie, children: oe })),
        (t[16] = I),
        (t[17] = f),
        (t[18] = ie),
        (t[19] = oe),
...
function cn(e) {
  ...
  t[0] !== _ || t[1] !== m || t[2] !== g
    ? ((y = { placement: m, zIndexClassName: g, variant: _ }),
      ...
      (t[3] = y))
    : (y = t[3]);
  let { overlayPortalContainer: b, shellClassName: x, usesExpandedTopTray: S } = Y(y),
    C;
  ...
  if (b != null) {
    ...
    return (
      t[35] !== b || t[36] !== e
        ? ((n = (0, rn.createPortal)(e, b)), (t[35] = b), (t[36] = e), (t[37] = n))
        : (n = t[37]),
      n
    );
  }
...
function un({
  ...
  if (typeof document > `u`) return null;
  let a = dn({ composerController: e, mentionUiState: t, placement: r, portalRoot: i });
  if (a != null) return a;
...
function dn({ composerController: e, mentionUiState: t, placement: n, portalRoot: r }) {
  let i = t?.anchorPos;
...
var Fn = class e extends An {
  ...
  apply(e) {
    ...
    return jn.fromReplace(e, this.pos, this.pos + 1, new U(H.from(n), 0, t.isLeaf ? 0 : 1));
  }
  invert(t) {
...
var Rn = class e extends An {
  ...
  apply(e) {
    if (this.structure && (zn(e, this.from, this.gapFrom) || zn(e, this.gapTo, this.to)))
    ...
    return n ? jn.fromReplace(e, this.from, this.to, n) : jn.fail(`Content does not fit in gap`);
  }
  getMap() {
    return new On([
      this.from,
  ...
  static fromJSON(t, n) {
    ...
    return new e(n.from, n.to, n.gapFrom, n.gapTo, U.fromJSON(t, n.slice), n.insert, !!n.structure);
  }
};
...
var Jn = class {
  constructor(e, t, n) {
    ...
    for (let t = e.depth; t > 0; t--) this.placed = H.from(e.node(t).copy(this.placed));
  }
  get depth() {
  ...
  openMore() {
    ...
    return !r.childCount || r.firstChild.isLeaf
      ? !1
      : ((this.unplaced = new U(e, t + 1, Math.max(n, r.size + t >= e.size - n ? t + 1 : 0))), !0);
  }
  dropNode() {
    let { content: e, openStart: t, openEnd: n } = this.unplaced,
      r = Zn(e, t);
    ...
    for (; c < o.childCount; ) {
      ...
      (c++,
        (c > 1 || s == 0 || e.content.size) &&
          ((u = t),
          l.push(Qn(e.mark(d.allowedMarks(e.marks)), c == 1 ? s : 0, c == o.childCount ? f : -1))));
    }
...
function Xn(e, t, n) {
  return t == 0
    ? e.append(n)
    : e.replaceChild(e.childCount - 1, e.lastChild.copy(Xn(e.lastChild.content, t - 1, n)));
}
function Zn(e, t) {
...
function Qn(e, t, n) {
  ...
  let r = e.content;
  return (
    t > 1 && (r = r.replaceChild(0, Qn(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0))),
    t > 0 &&
      ((r = e.type.contentMatch.fillBefore(r).append(r)),
      n <= 0 && (r = r.append(e.type.contentMatch.matchFragment(r).fillBefore(H.empty, !0)))),
    e.copy(r)
  );
}
...
var tr = class e extends An {
  ...
  apply(e) {
    ...
    return jn.fromReplace(e, this.pos, this.pos + 1, new U(H.from(r), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return On.empty;
  }
...
var ir = (e, t) => (e.selection.empty ? !1 : (t && t(e.tr.deleteSelection().scrollIntoView()), !0));
function ar(e, t) {
...
function yr(e) {
  return (t, n) => {
    ...
    let u = t.tr;
    (t.selection instanceof K || t.selection instanceof Pe) && u.deleteSelection();
    let d = u.mapping.map(r.pos),
      f = Hn(u.doc, d, a.length, a);
    if (((f ||= ((a[0] = s ? { type: s } : null), Hn(u.doc, d, a.length, a))), !f)) return !1;
...
function Cr(e, t, n, r) {
  ...
  if (
    ...
    if (n) {
      ...
      s = H.from(i.copy(s));
      let c = e.tr.step(new Rn(t.pos - 1, r, t.pos, r, new U(s, 1, 0), o.length, !0)),
        l = c.doc.resolve(r + 2 * o.length);
      (l.nodeAfter && l.nodeAfter.type == i.type && Un(c.doc, l.pos) && c.join(l.pos),
        n(c.scrollIntoView()));
    }
    return !0;
  }
...
function Br(e, t, n, r, i) {
  for (;;) {
    ...
    if (t == (i < 0 ? 0 : Vr(e))) {
      let n = e.parentNode;
      if (!n || n.nodeType != 1 || Gr(e) || zr.test(e.nodeName) || e.contentEditable == `false`)
        return !1;
      ((t = Nr(e) + (i < 0 ? 0 : 1)), (e = n));
...
function Yr(e, t, n) {
  if (e.caretPositionFromPoint)
    try {
      ...
      if (r) return { node: r.offsetNode, offset: Math.min(Vr(r.offsetNode), r.offset) };
    } catch {}
  if (e.caretRangeFromPoint) {
    let r = e.caretRangeFromPoint(t, n);
    if (r) return { node: r.startContainer, offset: Math.min(Vr(r.startContainer), r.startOffset) };
  }
}
...
var ii = !ni && /Chrome\/(\d+)/.exec(Qr),
  ...
  pi = fi ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function mi(e) {
  ...
  for (let o = n || e.dom; o; ) {
    ...
    if (
      ...
      t.left < s.left + hi(r, `left`)
        ...
        : t.right > s.right - hi(r, `right`) && (c = t.right - s.right + hi(i, `right`)),
      c || l)
    )
...
function Fi(e, t, n) {
  ...
  if (a == null && i < Vr(r)) {
    ...
    let t = e ? (e.nodeType == 3 ? Ir(e, 0, o ? 0 : 1) : e.nodeType == 1 ? e : null) : null;
...
function Gi(e, t, n) {
  return Hi == t && Ui == n
    ? Wi
    : ((Hi = t), (Ui = n), (Wi = n == `up` || n == `down` ? zi(e, t, n) : Vi(e, t, n)));
}
var Ki = 0,
  qi = 1,
  Ji = 2,
    ...
    domFromPos(e, t) {
      ...
      if (t <= 0) {
        ...
        return e && r && !e.border && !e.domAtom
          ? e.domFromPos(0, t)
          : { node: this.contentDOM, offset: e ? Nr(e.dom) : this.contentDOM.childNodes.length };
      }
    }
    parseRange(e, t, n = 0) {
...
`
            ...
            for (let t = e, n; t; t = t.parentNode) {
              if ((n = t.nextSibling)) {
                n.nodeName == `BR` && (o = s = { node: n.parentNode, offset: Nr(n) + 1 });
                break;
              }
              let e = t.pmViewDesc;
      ...
      if (ri && l.focusNode && l.focusNode != s.node && l.focusNode.nodeType == 1) {
  ...
  $i = class e extends Xi {
    ...
    static create(t, n, r, i) {
      let a = i.nodeViews[n.type.name],
        o = a && a(n, i, r);
      return (
        (!o || !o.dom) && (o = De.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)),
  ...
  ea = class e extends Xi {
    ...
    matchesNode(e, t, n) {
      return this.dirty == Ki && e.eq(this.node) && fa(t, this.outerDeco) && n.eq(this.innerDeco);
    }
    get size() {
      ...
      (_a(
        ...
        (t, i, a) => {
          (t.spec.marks
            ...
            : t.type.side >= 0 &&
              !a &&
              s.syncToMarks(i == this.node.childCount ? W.none : this.node.child(i).marks, n, e, i),
            s.placeWidget(t, e, r));
        },
        (t, a, c, l) => {
    ...
    update(e, t, n, r) {
      return this.dirty == Yi || !e.sameMarkup(this.node) ? !1 : (this.updateInner(e, t, n, r), !0);
    }
    updateInner(e, t, n, r) {
...
var na = class e extends ea {
    ...
    update(e, t, n, r) {
      return this.dirty == Yi || (this.dirty != Ki && !this.inParent()) || !e.sameMarkup(this.node)
        ? !1
        : (this.updateOuterDeco(t),
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    if (o) {
      ...
      for (let e in o) {
        let a = o[e];
        a != null &&
          (n && i.length == 1 && i.push((r = new oa(t.isInline ? `span` : `div`))),
          e == `class`
...
var ma = class {
      ...
      if (s instanceof ea) {
        ...
        if (!d && (u = this.recreateWrapper(s, e, t, n, r, a)))
          return (
            ...
            u.contentDOM && ((u.dirty = Ji), u.updateChildren(r, a + 1), (u.dirty = Ki)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  addTextblockHacks() {
    ...
    (!e ||
      ...
      ((si || ai) && e && e.dom.contentEditable == `false` && this.addHackNode(`IMG`, t),
...
function ka(e) {
  ...
  (r ? t.collapse(n.parentNode, Nr(n) + 1) : t.collapse(n, 0),
    !r && !e.state.selection.visible && ni && $ <= 11 && ((n.disabled = !0), (n.disabled = !1)));
}
function Aa(e, t) {
  if (t instanceof G) {
...
function Ra(e, t, n) {
  ...
  } else if (r instanceof G && r.node.isInline) return La(e, new K(t > 0 ? r.$to : r.$from));
  else {
    let n = Ia(e.state, t);
    return n ? La(e, n) : !1;
  }
...
function Ha(e) {
  ...
  let i,
    a,
    o = !1;
  for (ri && n.nodeType == 1 && r < za(n) && Ba(n.childNodes[r], -1) && (o = !0); ; )
    if (r > 0) {
      ...
      for (; t && Ba(t, -1); ) ((i = n.parentNode), (a = Nr(t)), (t = t.previousSibling));
      if (t) ((n = t), (r = za(n)));
      else {
...
function Ua(e) {
  ...
  for (;;)
    if (r < i) {
      ...
      let t = n.nextSibling;
      for (; t && Ba(t, 1); ) ((a = t.parentNode), (o = Nr(t) + 1), (t = t.nextSibling));
      if (t) ((n = t), (r = 0), (i = za(n)));
      else {
        if (((n = n.parentNode), n == e.dom)) break;
        r = i = 0;
...
function eo(e, t) {
  ...
  if ((n == 46 && !t.shiftKey) || (li && n == 68 && r == `c`)) return Xa(e, 1) || Va(e, 1);
  ...
  if (n == 37 || (li && n == 66 && r == `c`)) {
    ...
    return Ra(e, t, r) || Va(e, t);
  } else if (n == 38 || (li && n == 80 && r == `c`)) return Ya(e, -1, r) || Va(e, -1);
  else if (n == 40 || (li && n == 78 && r == `c`)) return Qa(e) || Ya(e, 1, r) || Va(e, 1);
...
function lo(e, t, n) {
  return (
    t < e.openStart && (e = new U(co(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)),
    n < e.openEnd && (e = new U(co(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)),
    e
  );
}
var uo = {
...
function ho(e) {
  ...
  return t
    ? ((mo ||= t.defaultPolicy || t.createPolicy(`ProseMirrorClipboard`, { createHTML: (e) => e })),
      mo.createHTML(e))
    : e;
}
function go(e) {
...
function _o(e) {
  let t = e.querySelectorAll(ai ? `span:not([class]):not([style])` : `span.Apple-converted-space`);
...
((bo.keydown = (e, t) => {
    ...
    if (
      ...
      ((e.input.lastIOSEnter = t),
        (e.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          e.input.lastIOSEnter == t &&
            (e.someProp(`handleKeyDown`, (t) => t(e, qr(13, `Enter`))), (e.input.lastIOSEnter = 0));
        }, 200)));
    } else
      e.someProp(`handleKeyDown`, (t) => t(e, n)) || eo(e, n) ? n.preventDefault() : wo(e, `key`);
}),
  (bo.keyup = (e, t) => {
  ...
  (bo.keypress = (e, t) => {
    let n = t;
    if (Uo(e, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (li && n.metaKey)) return;
...
function Po(e, t) {
  ...
  let n = e.state.doc.resolve(t),
    r = n.nodeAfter;
  return r && r.isAtom && G.isSelectable(r) ? (No(e, new G(n), `pointer`), !0) : !1;
}
function Fo(e, t) {
  if (t == -1) return !1;
  let n = e.state.selection,
...
function Lo(e, t, n, r) {
  return (
    Mo(e, `handleDoubleClickOn`, t, n, r) || e.someProp(`handleDoubleClick`, (n) => n(e, t, r))
  );
}
function Ro(e, t, n, r) {
  return (
...
function zo(e, t, n) {
  ...
  let r = e.state.doc;
  if (t == -1) return r.inlineContent ? (No(e, K.create(r, 0, r.content.size), `pointer`), !0) : !1;
  let i = r.resolve(t);
  for (let t = i.depth + 1; t > 0; t--) {
    let n = t > i.depth ? i.nodeAfter : i.node(t),
      a = i.before(t);
    if (n.inlineContent) No(e, K.create(r, a + 1, a + 1 + n.content.size), `pointer`);
...
yo.mousedown = (e, t) => {
  ...
  o &&
    (a == `singleClick`
      ? (e.input.mouseDown && e.input.mouseDown.done(), (e.input.mouseDown = new Ho(e, o, n, !!r)))
  ...
  constructor(e, t, n, r) {
    ...
    (n.button == 0 &&
      ...
      (this.mightDrag = {
        ...
        setUneditable: !!(this.target && ri && !this.target.hasAttribute(`contentEditable`)),
      }),
      this.target &&
        this.mightDrag &&
      ...
      this.allowDefault || !t
        ...
        : Io(this.view, t.pos, t.inside, e, this.selectNode)
          ...
          : e.button == 0 &&
            ...
            ? (No(this.view, Ne.near(this.view.state.doc.resolve(t.pos)), `pointer`),
              e.preventDefault())
            : wo(this.view, `pointer`));
  }
  move(e) {
    (this.updateAllowDefault(e), wo(this.view, `pointer`), e.buttons == 0 && this.done());
  }
...
bo.compositionstart = bo.compositionupdate = (e) => {
  if (!e.composing) {
    ...
    if (
      ...
      ((e.markCursor = e.state.storedMarks || n.marks()), Xo(e, !0), (e.markCursor = null));
    else if (
      (Xo(e, !t.selection.empty),
      ri && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)
    ) {
      let t = e.domSelectionRange();
...
function qo(e) {
  for (
    e.composing && ((e.input.composing = !1), (e.input.compositionEndedAt = Yo()));
...
((yo.dragstart = (e, t) => {
  ...
  ((!n.dataTransfer.files.length || !ai || oi > 120) && n.dataTransfer.clearData(),
...
function ss(e, t, n) {
  ...
  a
    ...
    : (a = no(e, ns(t.dataTransfer), Qo ? null : t.dataTransfer.getData(`text/html`), !1, i));
  let o = !!(n && as(e, t));
    ...
    if (ai && di && t.inputType == `deleteContentBackward`) {
      ...
      setTimeout(() => {
        if (
          ...
          (e.dom.blur(), e.focus(), e.someProp(`handleKeyDown`, (t) => t(e, qr(8, `Backspace`))))
        )
          return;
...
var ls = class e {
  ...
  hs = class e {
    ...
    map(e, t, n) {
      return this == gs || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, n || ms);
    }
    mapInner(t, n, r, i, a) {
      let o;
    ...
    add(t, n) {
      return n.length ? (this == gs ? e.create(t, n) : this.addInner(t, n, 0)) : this;
    }
    addInner(t, n, r) {
      let i,
        a = 0;
      ...
      return new e(o.length ? this.local.concat(o).sort(ws) : this.local, i || this.children);
    }
    remove(e) {
    ...
    removeInner(t, n) {
      ...
      return r == this.children && i == this.local ? this : i.length || r.length ? new e(i, r) : gs;
    }
    forChild(t, n) {
        ...
        default:
          return new e(
            t.every((e) => e instanceof hs)
              ? t
              : t.reduce((e, t) => e.concat(t instanceof hs ? t : t.members), []),
          );
      }
    }
    forEachSet(e) {
  ...
  for (let t = 0; t < s.length; t += 3)
    if (s[t + 1] < 0) {
      ...
      if (m && p == u && p + m.nodeSize == d) {
        ...
        r == gs ? ((s[t + 1] = -2), (c = !0)) : ((s[t] = u), (s[t + 1] = d), (s[t + 2] = r));
      } else c = !0;
    }
  if (c) {
...
var Os = {
  ...
  js = class {
    ...
    start() {
      (this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, Os)),
        this.onCharData &&
    ...
    flush() {
      ...
      c.eq(Ne.near(e.state.doc.resolve(0), 1))
        ? ((e.input.lastFocus = 0), Ca(e), this.currentSelection.set(n), e.scrollToSelection())
        : (i > -1 || r) &&
          (i > -1 && (e.docView.markDirty(i, a), Ps(e)),
          e.input.badSafariComposition && ((e.input.badSafariComposition = !1), Rs(e, s)),
    ...
    registerMutation(e, t) {
      ...
      if (e.type == `childList`) {
        ...
        let a = r && r.parentNode == e.target ? Nr(r) + 1 : 0,
          ...
          s = i && i.parentNode == e.target ? Nr(i) : e.target.childNodes.length;
...
function Bs(e) {
  ...
  if (e.nodeName == `BR` && e.parentNode) {
    ...
    } else if (e.parentNode.lastChild == e || (si && /^(tr|table)$/i.test(e.parentNode.nodeName)))
      return { ignore: !0 };
...
var Ys = class {
  ...
  updateStateInner(e, t) {
    ...
    let u = c == `preserve` && i && this.dom.style.overflowAnchor == null && vi(this);
    if (i) {
      ...
      if (l) {
        let n = ai ? (this.trackWrites = this.domSelectionRange().focusNode) : null;
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new rs(e.slice, e.move, r < 0 ? void 0 : G.create(this.state.doc, r));
  }
  someProp(e, t) {
  ...
  focus() {
    (this.domObserver.stop(), this.editable && Ci(this.dom), Ca(this), this.domObserver.start());
  }
  get root() {
    let e = this._root;
    if (e == null) {
  ...
  destroy() {
    this.docView &&
      ...
      this.mounted
        ? (this.docView.update(this.state.doc, [], Ds(this), this), (this.dom.textContent = ``))
...
function Zs(e) {
  if (e.markCursor) {
    ...
    ((t.className = `ProseMirror-separator`),
      ...
      (e.cursorWrapper = {
        dom: t,
        deco: fs.widget(e.state.selection.from, t, { raw: !0, marks: e.markCursor }),
      }));
...
((rc.prototype.visible = !1), (rc.findFrom = rc.findGapCursorFrom), Ne.jsonID(`gapcursor`, rc));
var ic = class e {
  constructor(e) {
    this.pos = e;
  }
...
function fc(e, t) {
  if (t.inputType != `insertCompositionText` || !(e.state.selection instanceof rc)) return !1;
  let { $from: n } = e.state.selection,
    r = n.parent.contentMatchAt(n.index()).findWrapping(e.state.schema.nodes.text);
  if (!r) return !1;
  let i = H.empty;
  for (let e = r.length - 1; e >= 0; e--) i = H.from(r[e].createAndFill(null, i));
...
((hc.prototype.append = function (e) {
  ...
  (hc.prototype.slice = function (e, t) {
    return (
      ...
      e >= t ? hc.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, t))
    );
  }),
...
var _c = (function (e) {
  ...
  yc = class e {
    ...
    rebased(t, n) {
      ...
      return (u.emptyItemCount() > vc && (u = u.compress(this.items.length - r.length)), u);
    }
    emptyItemCount() {
      let e = 0;
      return (
  ...
  if (n.getMeta(`addToHistory`) !== !1 && !(o && o.getMeta(`addToHistory`) === !1)) {
    let i = n.getMeta(`composition`),
      a =
        ...
        (!o &&
          e.prevComposition != i &&
          (e.prevTime < (n.time || 0) - r.newGroupDelay || !Tc(n, e.prevRanges))),
...
`),
    ...
    if (e.isText && e.text !== void 0) {
      ...
      r == null ? (n += e.text) : (n += zc(e.text, `${t ? l : ``}${r.attrs.href}`));
    } else if (e.type.name === `atMention`) n += zc(e.attrs.label, e.attrs.path);
    ...
    } else e.type.name === `richLink` && (n += zc(e.attrs.displayText, e.attrs.href));
  }
  return (
    e.descendants((e) => i(e)),
    r &&
...
`);
  if (
    ...
    let t = r.slice(1),
      i = new U(
        H.fromArray(t.map((e) => n.nodes.paragraph.create(null, e === `` ? null : n.text(e)))),
        0,
        0,
      );
    ...
    props: {
      decorations(e) {
        ...
        if (
          ...
          return (
            t.descendants((e, t) => {
              n.push(fs.node(t, t + e.nodeSize, { class: `placeholder`, "data-placeholder": r }));
            }),
            hs.create(t, n)
          );
        }
      ...
      resourceMention: {
        ...
        toDOM: (e) => {
          let t = typeof e.attrs.iconSmall == `string` ? e.attrs.iconSmall : ``,
            ...
            r = typeof e.attrs.resourceUri == `string` ? e.attrs.resourceUri : ``,
        ...
        plugins: [
          ...
          ft({
            ...
            Enter: (e, t) => {
              ...
              return l === `cmdIfMultiline` && a ? Bc(e, t) : (c.emit(`submit`), !0);
            },
      ...
      handlePaste(e, t) {
        ...
        if (r && s != null && !e.state.selection.empty) {
          ...
          if (
            ...
            return (
              e.dispatch(e.state.tr.addMark(t, n, e.state.schema.marks.link.create({ href: s }))),
              !0
            );
          }
        }
        ...
        if (k(o)) {
          ...
          return (e.dispatch(e.state.tr.replaceSelection(new U(t.content, 1, 1))), !0);
        }
        return (Vc(e, o), !0);
      },
      handleDrop(e, t) {
...
var Jc = class {
  ...
  hasPluginBackedMentions() {
    ...
    return (
      this.view.state.doc.descendants((t) =>
        t.type.name !== `pluginMention` && t.type.name !== `resourceMention` ? !0 : ((e = !0), !1),
      ),
      e
    );
  }
...
`,
    ...
    (p.doc.descendants((e, t) => {
      ...
      if (e.type.name === `resourceMention`) {
        ...
        return e.attrs.iconSmall === i.iconSmall && e.attrs.brandColor === o
          ? !0
          : ((g = !0),
            (h = h.setNodeMarkup(t, void 0, { ...e.attrs, brandColor: o, iconSmall: i.iconSmall })),
            !0);
      }
        ...
        let t = u.get(n),
          ...
          s =
            typeof e.attrs.displayName == `string` && e.attrs.displayName.length > 0
              ? e.attrs.displayName
              : p,
          c = fe({ mentionPath: n, mentionDisplayName: s, nativeApps: r, computerPlugin: f }),
          l = o == null ? null : M(o, a),
  ...
  setAtMentionSource(e, t) {
    ...
    ((i = i.setMeta(St, { active: !0, anchorPos: t.anchorPos, query: ``, source: e })),
      r(i),
      this.view.focus());
  }
