...
import { E as o, b as s, c, k as l, s as u } from "./chunk-48.js";
import { n as d, t as f } from "./src-1.js";
import { g as p, u as m } from "./chunk-123.js";
import { i as h } from "./chunk-88.js";
import { n as g } from "./chunk-83.js";
import { n as _ } from "./chunk-61.js";
import { n as v, t as y } from "./graphlib-5.js";
import { n as b } from "./chunk-22.js";
import { t as x } from "./chunk-116.js";
import { n as S } from "./chunk-51.js";
import { i as C } from "./chunk-89.js";
import { n as w } from "./chunk-117.js";
import { n as T } from "./chunk-106.js";
import { n as E, t as D } from "./dagre-4.js";
import { a as O, n as k, r as A, t as j } from "./chunk-62.js";
  ...
  (k(),
    ...
    (F = i((e, t) => {
      let n = i(function (e, t, n) {
        ...
        o = e
          .append(`text`)
          .attr(`x`, s().state.padding)
          .attr(`y`, a + s().state.padding * 0.4 + s().state.dividerMargin + s().state.textHeight)
    ...
    (I = i((e, t, n) => {
      ...
      return (
        e
          ...
          .attr(`width`, d)
          .attr(`height`, p.height + s().state.textHeight + s().state.titleShift + 1)
          .attr(`rx`, `0`),
        l.attr(`x`, f + r),
        ...
        e
          .insert(`rect`, `:first-child`)
          .attr(`x`, f)
          .attr(`y`, s().state.titleShift - s().state.textHeight - s().state.padding)
          .attr(`width`, d)
    ...
    (U = i(function (e, a, c) {
      ...
      if (
        ...
        m.attr(`marker-end`, `url(` + h + `#` + l(j.relationType.DEPENDENCY) + `End)`),
        c.title !== void 0)
      ) {
        ...
        for (let e = 0; e <= o.length; e++) {
          ...
          ((f = Math.max(f, s.width)),
            (m = Math.min(m, s.x)),
            r.info(s.x, n, i + l),
            l === 0 && ((l = a.node().getBBox().height), r.info(`Title height`, l, i)),
            d.push(a));
        }
        let h = l * o.length;
        if (o.length > 1) {
    ...
    (X = i((e, t, n, i, a, o, s) => {
      ...
      for (let e of m) {
        ...
        if (r.note) {
          let e = V(t, { descriptions: [], id: r.id + `-note`, note: r.note, type: `note` }, c);
      ...
      c.nodes().forEach(function (e) {
        e !== void 0 && c.node(e) !== void 0
          ? (r.warn(`Node ` + e + `: ` + JSON.stringify(c.node(e))),
            ...
            a.select(`#` + g.id + ` #` + e).attr(`data-x-shift`, c.node(e).x - c.node(e).width / 2),
      ...
      (c.edges().forEach(function (e) {
        e !== void 0 &&
          c.edge(e) !== void 0 &&
          (r.debug(`Edge ` + e.v + ` -> ` + e.w + `: ` + JSON.stringify(c.edge(e))),
...
export { Z as diagram };
//# sourceMappingURL=stateDiagram-5.js.map
