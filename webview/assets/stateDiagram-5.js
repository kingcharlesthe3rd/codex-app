import { t as e } from "./dagre-4.js";
import { h as t } from "./chunk-20.js";
import { t as n } from "./graphlib-3.js";
import { t as r } from "./src-3.js";
import { t as i } from "./line-DIsP-Yv_.js";
import { h as a } from "./step.js";
import { n as o, r as s } from "./chunk-70.js";
import { E as c, b as l, c as u, s as d } from "./chunk-3.js";
import "./dist-5.js";
...
import "./chunk-19.js";
import "./chunk-16.js";
import { i as f, n as p, t as m } from "./chunk-7.js";
var h = o(
    (e) =>
      e
        .append(`circle`)
  ...
  v = o((e, t) => {
    let n = o(function (e, t, n) {
      ...
      a = e
        .append(`text`)
        .attr(`x`, l().state.padding)
        .attr(`y`, i + l().state.padding * 0.4 + l().state.dividerMargin + l().state.textHeight)
  ...
  y = o((e, t, n) => {
    ...
    return (
      e
        ...
        .attr(`width`, d)
        .attr(`height`, p.height + l().state.textHeight + l().state.titleShift + 1)
        .attr(`rx`, `0`),
      c.attr(`x`, f + r),
      ...
      e
        .insert(`rect`, `:first-child`)
        .attr(`x`, f)
        .attr(`y`, l().state.titleShift - l().state.textHeight - l().state.padding)
        .attr(`width`, d)
  ...
  w = o(function (e, t) {
    ...
    return (
      (r.width = a.width + 2 * l().state.padding), (r.height = a.height + 2 * l().state.padding), r
    );
  }, `drawState`),
  T = 0,
  E = o(function (e, n, r) {
    ...
    if (
      ...
      h.attr(`marker-end`, `url(` + g + `#` + u(m.relationType.DEPENDENCY) + `End)`),
      r.title !== void 0)
    ) {
      ...
      for (let e = 0; e <= c.length; e++) {
        ...
        ((p = Math.max(p, n.width)),
          (m = Math.min(m, n.x)),
          s.info(n.x, a, o + u),
          u === 0 && ((u = t.node().getBBox().height), s.info(`Title height`, u, o)),
          f.push(t));
      }
      let h = u * c.length;
      if (c.length > 1) {
  ...
  N = o((t, r, i, a, o, c, l) => {
    ...
    for (let e of g) {
      ...
      if (t.note) {
        let e = w(r, { descriptions: [], id: t.id + `-note`, note: t.note, type: `note` }, u);
    ...
    u.nodes().forEach(function (e) {
      e !== void 0 && u.node(e) !== void 0
        ? (s.warn(`Node ` + e + `: ` + JSON.stringify(u.node(e))),
          ...
          o.select(`#` + v.id + ` #` + e).attr(`data-x-shift`, u.node(e).x - u.node(e).width / 2),
          c.querySelectorAll(`#` + v.id + ` #` + e + ` .divider`).forEach((e) => {
    ...
    (u.edges().forEach(function (e) {
      e !== void 0 &&
        u.edge(e) !== void 0 &&
        (s.debug(`Edge ` + e.v + ` -> ` + e.w + `: ` + JSON.stringify(u.edge(e))),
