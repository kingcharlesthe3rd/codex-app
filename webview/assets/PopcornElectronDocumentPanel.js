...
import { nx as i, rx as a } from "./app-initial~app-main~new-thread-panel-page.js";
import {
  A as o,
  Jn as s,
  Kn as c,
...
function Yc({
  ...
  return (0, Z.jsxs)(`div`, {
    className: i(`bg-token-bg-primary text-token-text-primary flex h-full min-h-0 flex-col`, n),
    children: [
      r ??
        (0, Z.jsxs)(`header`, {
