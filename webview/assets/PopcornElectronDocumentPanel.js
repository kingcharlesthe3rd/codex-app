...
import { C as Pe, o as Fe, w as Ie } from "./document-2.js";
import {
  A as Le,
  C as Re,
  D as ze,
...
import { a as ft, i as pt, r as mt, t as ht } from "./feature-catalog.js";
import { n as gt, t as _t } from "./PopcornPageNumberNavigation.js";
var vt,
  yt,
  bt = e(() => {
    (_(),
...
function Ct() {
  ...
  return ((e.colorScheme = { name: `Office`, themeColors: { ...Dt } }), e.toProto());
}
function wt() {
  return [
  ...
  zt = e(() => {
    (H(),
      (Rt = class {
        ...
        #r;
        constructor(e) {
          ((this.#e = new Se({ people: e.people ?? [], threads: e.threads ?? [] })),
            (this.#t = e.documentId ?? ``),
    ...
    (Ne(),
      ...
      (Gt = class {
        ...
        add(e, t) {
          let n = this.#a(e),
            r = this.#o(t.range),
            i = new Wt({ id: M(), paragraphs: n, referenceTextRange: r, referenceRunIds: [] });
        ...
        #o(e) {
          let t = this.#r(e);
          if (t)
            return { slideId: this.#t, elementId: this.#n, startCp: t.startCp, length: t.length };
        }
      }));
  }),
  qt,
    ...
    (Ne(),
      ...
      (Xt = class {
        ...
        add(e, t) {
          let n = this.#a(e),
            r = this.#o(t.range),
            i = new Yt({ id: M(), paragraphs: n, referenceTextRange: r, referenceRunIds: [] });
          return (this.#e.push(i), this.#i?.(), i);
        }
        toProto() {
          return this.#e.map((e) => e.toProto());
...
function rn(e) {
  ...
  for (let e of n)
    r.has(e.cell) ||
      (r.add(e.cell), e.rowSpan > 1 && (e.cell.rowSpan = Math.max(Qt(e.cell.rowSpan), e.rowSpan)));
}
function an(e) {
  let t = e.table;
...
function In(e) {
  ...
  let n = 0;
  for (let e of t.rows) e.heightEmu && e.heightEmu > 0 ? (n += e.heightEmu * G) : (n += Un);
  return Math.max(n, t.rows.length * Un);
}
function Ln(e, t) {
  let n = e.bbox?.widthEmu !== void 0 && e.bbox.widthEmu > 0 ? e.bbox.widthEmu * G : void 0;
  ...
  if (!(!a || a.rows.length === 0))
    return S(
      an({
        ...
        bbox: { xEmu: 0, yEmu: 0, widthEmu: Pn(Math.max(1, n)), heightEmu: e.bbox?.heightEmu },
      }),
      t,
      r,
      {
...
function Vn(e) {
  let t = e.table;
  return t ? t.rows.map((e) => (e.heightEmu && e.heightEmu > 0 ? e.heightEmu * G : Un)) : [];
}
...
function Zn(e, t, n, r, i, a = 0, o = !1) {
  ...
  for (;;) {
    let n = e.find(
      (e) =>
        Yn(e, o) && qn(t, s, e.leftPx, e.rightPx) && c >= e.topPx - 0.01 && c < e.bottomPx - 0.01,
    );
    if (!n) {
      let n = e
          .filter((e) => Yn(e, o) && qn(t, s, e.leftPx, e.rightPx) && e.topPx > c + 0.01)
...
function _r(e, t, n, r, i = 0) {
  if (dr(e.kind)) {
    ...
    if (Tn(e.element) && r !== void 0) return r + (e.element.bbox?.yEmu ?? 0) * G;
...
function yr(e) {
  return (
    e.placement?.type === Ta && e.placement.verticalRelativeFrom?.trim().toLowerCase() === `page`
  );
}
function br(e, t) {
...
function Gr(e, t, n, r) {
  let i = [],
    a = new Set();
  for (let o = t; o < n; o += 1) for (let t of Wr(e[o], r)) a.has(t) || (a.add(t), i.push(t));
  return i;
}
function Kr(e, t) {
...
function Jr(e, t, n, r) {
  ...
  let s = Vr(`docx-footnotes-${t.join(`-`)}`, o),
    ...
    u = { element: s, lines: c, textHeightPx: l, reservedHeightPx: l > 0 ? l + Oa : 0 };
  return (e.layoutByKey.set(i, u), u);
}
function Yr(e, t, n, r) {
  return e.ids.length === 0 ? 0 : Jr(t, e.ids, n.contentWidthPx, r).reservedHeightPx;
}
function Xr(e, t, n, r) {
...
function Zr(e, t, n = dn, r) {
  ...
  if (a) return a;
  let o = e.kind === `text` ? Yi(e.element, t, n, e.defaultTabStopTwips, r) : [];
...
function ri(e, t) {
  ...
  let n = e.placement.horizontalRelativeFrom?.trim().toLowerCase(),
    r = e.bbox?.widthEmu !== void 0 && e.bbox.widthEmu > 0 ? e.bbox.widthEmu * G : 0;
...
function ai({ lineIndex: e, trailingSpaceAfterPx: t, firstParagraphSpaceBeforePx: n }) {
  return e === 0 ? R(t, n) : 0;
}
function oi(e) {
...
function hi({
  ...
  if (d) {
    ...
    if (!r && l > n + ba) return { rowCount: 0, widthPx: u.widthPx, heightPx: 0 };
  ...
  for (let i = 0; i < e.length; i += 1) {
    ...
    if (C.kind !== `text`) {
      ...
      for (; !e; ) {
        ...
        (c.push({
          ...
          ni(_, C, { xPx: ei(C, t, l), yPx: k, widthPx: O.widthPx, heightPx: O.heightPx }),
          (u[l] = A),
          (d[l] = 0),
          (f[l] = !1),
          (p[l] = !1),
    ...
    for (; !T; ) {
      ...
      let ee = _i(C.element, E),
        ...
        I = o === n,
        { nextLineIndex: L, fragmentHeightPx: R, endsWithFlowBreak: ne } = si(E, M, F);
      if (L === M) {
        if (!I) {
...
function ji(e, t) {
  return { ...e, xPx: e.xPx + t, flow: Ai(e.flow, t), children: e.children?.map((e) => ji(e, t)) };
}
function Mi(e, t, n, r = {}) {
    ...
    a =
      Math.abs(i) < 0.01
        ...
        : {
            ...
            pageNumberElement: e.pageNumberElement ? ji(e.pageNumberElement, i) : void 0,
          };
...
function Vi(e, t, n, r, i, a) {
  return (e.children ?? []).map((e) => {
    ...
    return (o === `group` && (c.children = Vi(e, c.xPx, c.yPx, c.widthPx, i, a)), c);
  });
}
function Hi(e) {
...
function Ui(e) {
  ...
  for (let n of e.table?.rows ?? [])
    for (let e of n.cells ?? [])
      for (let n of e.elements ?? []) Hi(n) || (n.id && n.id.length > 0 && t.set(n.id, n));
  return t;
}
function Wi(e, t) {
...
function Gi(e, t, n, r, i, a, o, s) {
  ...
  let c = S(
      an({ ...Wi(e, { xPx: t, yPx: n, widthPx: r, heightPx: i }), type: h.ELEMENT_TYPE_TABLE }),
      a,
      o,
      {
        paragraphSpacingUnit: `twips`,
...
function Ji(e, t, n, r, i, a, o, s, c) {
  let l = !1;
  for (let e of Gr(r, i, a, n)) t.idSet.has(e) || (t.idSet.add(e), t.ids.push(e), (l = !0));
  l && qi(e, t, n, o, s, c);
}
...
function ta(e, t) {
  ...
  for (let i of e) {
    ...
    (n.push(s ? { ...i, breakType: Pe.SECTION_BREAK_TYPE_UNSPECIFIED } : i), (r = !1));
  }
  return n;
}
function na(e, t) {
...
function da(e, t) {
  let n = (e) => e.replaceAll(pn, t.currentPageText ?? ``).replaceAll(mn, t.totalPagesText ?? ``);
...
function ha(e, t, n = dn, r = {}) {
  ...
  for (let a = 0; a < D.length; a += 1) {
    ...
    (C.header && (s = j), C.footer && (c = M), C.firstHeader && (l = ee), C.firstFooter && (u = N));
      ...
      if (s.kind !== `text`) {
        ...
        for (; !c; ) {
          ...
          (f.bodyElements.push(
            ...
            ni(oe, s, { xPx: T, yPx: b, widthPx: h.widthPx, heightPx: h.heightPx }),
            (B[z] = C),
            (V[z] = 0),
            (H[z] = !1),
            (U[z] = !1),
        ...
        let A = _i(s.element, h),
          j =
            ...
            ai({
              ...
              firstParagraphSpaceBeforePx: D ? 0 : s.firstParagraphSpaceBeforePx,
            }),
          M = Xr(S, E, O, n),
          ee = Zn(
            oe,
...
function Ma(e) {
  let t = (e.sections ?? []).map((e) => ({ ...e, elements: (e.elements ?? []).map(ja) }));
  return { ...e, sections: t, elements: t.flatMap((e) => e.elements ?? []) };
}
function Na(e) {
  return Pa(e.element, { xPx: e.xPx, yPx: e.yPx, widthPx: e.widthPx, heightPx: e.heightPx });
}
function Pa(e, t) {
  let n = e.bbox?.widthEmu === 0,
    r = e.bbox?.heightEmu === 0;
...
var La,
  ...
  Ba = e(() => {
    (u(),
      ...
      (Ra = { leftEmu: 91440, rightEmu: 91440, topEmu: 45720, bottomEmu: 45720 }),
      (za = ie.load({
        id: ``,
        slides: [],
        theme: void 0,
...
function qa(e) {
  ...
  for (let [n, r] of e.entries()) {
    let e = r.paragraphStyle,
      i = (e?.tabStops ?? []).map((e) => Ka(e.position)).filter((e) => e !== void 0),
      a = {
        index: n + 1,
        id: r.id || void 0,
        styleId: r.styleId,
...
function fo(e) {
  ...
  for (let n of e.cellElementFrames ?? []) {
    let e = lo(n.row, n.col),
      r = t.get(e) ?? [];
    (r.push({ elementId: n.elementId, frame: Ha(n.xPx, n.yPx, n.widthPx, n.heightPx) }),
      t.set(e, r));
  }
  return t;
}
...
function ho(e, t, n, r, i, a, o) {
  ...
  return {
    ...
    children: (e.children ?? []).map((e, r) => ho(e, t, `${n}.children.${r + 1}`, r + 1, i, a, o)),
  };
}
function go(e) {
  return {
  ...
  return {
    ...
    pages: t.map((e, t) => ({
      ...
      pageNumberElement: e.pageNumberElement
        ? ho(e.pageNumberElement, `pageNumber`, `pageNumber.1`, 1, e.layout, n, i)
        : void 0,
    })),
  };
}
...
var xo,
  ...
  ko = e(() => {
    (_(),
      Ne(),
      (Eo = { insertion: g.REVIEW_MARK_TYPE_INSERTION, deletion: g.REVIEW_MARK_TYPE_DELETION }),
      (Do = class {
        #e;
        constructor(e) {
          this.#e = { ...e };
...
function _s(e) {
  if (!e) return;
  let t = { left: vs(e.left), right: vs(e.right), top: vs(e.top), bottom: vs(e.bottom) };
...
function Ss(e) {
  ...
  let t = Cs(e.themeColor),
    ...
    r = e.color ?? e.val;
  return t
    ? { type: `proto`, proto: { type: c.COLOR_TYPE_SCHEME, value: t, transform: n, lastColor: r } }
    : r
      ? `#${r}`
      : void 0;
}
...
var Ms,
  ...
  Is = e(() => {
    (u(),
      ...
      (Ns = { TableStyleLight1: Ms.tableStyleLight1, "Table Style Light 1": Ms.tableStyleLight1 }),
...
function zs(e, t = {}) {
  let n = { left: Ls(e.left), top: Ls(e.top), width: Rs(e.width), height: Rs(e.height) };
  return (t.inline && ((n.left = void 0), (n.top = void 0)), n);
}
function Bs(e, t, n) {
  let r = Hs(t, n);
  if (!(!e && !Us(r)))
    return { type: o.ELEMENT_PLACEMENT_TYPE_INLINE, horizontalAlignment: e, ...r };
}
function Vs(e, t, n) {
      ...
      ($s = class {
        ...
        add(e) {
          ...
          let { position: t, style: n, columnWidths: r, cellMargins: i, keepTogether: a, ...o } = e,
            s = zs({ left: t?.left, top: t?.top, width: t?.width, height: t?.height }),
            ...
            u = this.#e.add(l);
          ((u.cellMargins = i ?? Qs), (u.keepTogether = a), (u.placement = Vs(void 0, s)));
          ...
          if (d) {
            let { preset: e, ...t } = d,
              n = Jo(e),
              r = Yo(e);
            (n ? (u.styleId = n) : r ? (u.styleId = es(r)) : e && (u.styleId = e),
  ...
  xc = e(() => {
    (u(),
      ...
      (bc = class e {
        ...
        get textElements() {
          return this.#n.map((e) => this.#r.get(e)).filter((e) => e instanceof Ao);
        }
        getElementById(e) {
        ...
        resolveTextBlock(e) {
          ...
          if (t) {
            ...
            return e instanceof ae ? (e.getCellById(t.cellId)?.text ?? null) : null;
          }
        ...
        #v(e) {
          let t = e.findIndex(
            (e) => e.type === h.ELEMENT_TYPE_TEXT || e.type === h.ELEMENT_TYPE_TEXT_GROUP,
          );
          return t >= 0
        ...
        #y(e, t, n, r, i) {
          if (e.type === h.ELEMENT_TYPE_TEXT || e.type === h.ELEMENT_TYPE_TEXT_GROUP) {
...
function Ec(e) {
  for (let t of e)
    if (t && (!(t.type === h.ELEMENT_TYPE_TEXT || t.type === h.ELEMENT_TYPE_TEXT_GROUP) || Tc(t)))
      return !0;
  return !1;
}
var Dc,
      ...
      (Dc = class {
        ...
        constructor(e) {
          ...
          ((this.#m = e.context),
            ...
            (this.#a = new bc({ elements: t?.header?.elements ?? [], context: e.context })),
            (this.#o = new bc({ elements: t?.footer?.elements ?? [], context: e.context })),
            (this.#s = new bc({ elements: t?.firstHeader?.elements ?? [], context: e.context })),
            (this.#c = new bc({ elements: t?.firstFooter?.elements ?? [], context: e.context })),
            (this.#l = !!t?.header),
            (this.#u = !!t?.footer),
      ...
      (kc = class {
        ...
        constructor(e) {
          ...
          (t.length > 0
            ? (this.#e = t.map(
                (e, t) =>
                  new Dc({ section: e, context: this.#n, defaultId: `doc-section-${t + 1}` }),
              ))
            : (this.#e = [
                new Dc({
  ...
  Pc = e(() => {
    (Nt(),
      ...
      (Nc = class {
        ...
        get backgroundFill() {
          return ((this.#r ||= new V({ type: `proto`, proto: this.#e.backgroundFill })), this.#r);
        }
        ...
        get footnoteProperties() {
          return ((this.#t ||= new Mc(this.#e.footnoteProperties, this.#i)), this.#t);
        }
        get endnoteProperties() {
          return ((this.#n ||= new Mc(this.#e.endnoteProperties, this.#i)), this.#n);
        }
...
function Ic(e) {
  return {
    ...
    conditionalStyles: (e.conditionalStyles ?? []).map((e) => ({
      ...e,
      style: e.style ? { ...e.style, paragraphStyle: Fc(e.style.paragraphStyle) } : void 0,
    })),
  };
}
var Lc,
    ...
    (Nt(),
      ...
      (Lc = class {
        ...
        set(e) {
          ...
          return (n >= 0 ? (this.#e[n] = t) : this.#e.push(t), this.#t?.(), Ic(K(t)));
        }
    ...
    (Nt(),
      (Vc = class {
        ...
        set(e) {
          let t = Bc(K(e)),
            n = this.#e.findIndex((e) => e.id === t.id || e.name === t.name);
          return (n >= 0 ? (this.#e[n] = t) : this.#e.push(t), this.#t?.(), Bc(K(t)));
        }
        delete(e) {
          let t = this.#e.findIndex((t) => t.id === e || t.name === e);
          return t < 0 ? !1 : (this.#e.splice(t, 1), this.#t?.(), !0);
...
function Kc(e, t) {
  ...
  let n = e;
  if (n.type === c.COLOR_TYPE_SCHEME && typeof n.value == `string` && n.lastColor === void 0) {
      ...
      (qc = class e {
        ...
        constructor(e) {
          ...
          ((this.#e = {
            ...
            (this.tableStyleDefinitions = new Lc(e.tableStyleDefinitions ?? [], {
              onMutated: () => this.invalidateLayoutCache(),
            })),
            (this.fonts = new qt(e.fonts ?? [], { onMutated: () => this.invalidateLayoutCache() })),
            (this.settings = new Nc(e.settings, { onMutated: () => this.invalidateLayoutCache() })),
            (this.theme = new Uc(e.theme, { onMutated: () => this.invalidateLayoutCache() })),
            ...
            (this.numbering = new wo(e.numberingDefinitions ?? [], e.paragraphNumberings ?? [])));
...
function Yc({
  ...
  return (0, Z.jsxs)(`div`, {
    className: a(`bg-token-bg-primary text-token-text-primary flex h-full min-h-0 flex-col`, n),
    children: [
      r ??
        (0, Z.jsxs)(`header`, {
          ...
          children: [
            (0, Z.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, Z.jsx)(`div`, { className: `truncate text-sm font-semibold`, children: t }),
              ],
            }),
            i
              ? (0, Z.jsx)(`div`, {
      ...
      (0, Z.jsxs)(`div`, {
        ...
        children: [
          o
            ...
            : null,
          (0, Z.jsx)(`div`, { className: `min-h-0 min-w-0 flex-1`, children: c }),
        ],
      }),
      s
        ? (0, Z.jsx)(`footer`, {
...
function vl(e) {
  return e.documentProto ? e.documentProto : e.document ? e.document.toProto() : al().toProto();
}
function yl() {
  return dl();
}
    ...
    (He(),
      ...
      (Sl = class {
        ...
        constructor(e = {}) {
          ...
          (this.#n.bootstrap({
            ...
            (this.#r = el()
              .then(() => {
                let e = qe();
                (this.#e.debug(`font-render-deps-ready`, { fontCount: e.length, fontDebug: ut() }),
        ...
        textSelectWordAtPoint(e, t) {
          return (
            this.#n.dispatch({ kind: `text-select-word-at-point`, pageIndex: e, point: t }), !0
          );
        }
  ...
  let o = (0, Q.useRef)(null),
    ...
    O = (0, Q.useMemo)(() => {
      ...
      for (let n of E) {
        ...
        for (let i of r?.textLayoutBlocks ?? []) (e.set(i.id, n.pageIndex), t.push(Zl(i, n)));
      }
    ...
    k = (0, Q.useMemo)(
      () =>
        new ot(
          {
            onPointerDown: (t, n) => {
              let r = Xl(t, n?.blockId ?? null, l.current, u.current, d.current);
              r &&
...
var Q,
  ...
  $l,
  eu = e(() => {
    ((Q = t(n())), rt(), $c(), Dl(), Al(), Nl(), Il(), Wl(), (Ql = r()), ($l = 1600));
  });
function tu({
  controller: e,
...
function fu({
  ...
  let b = (0, pu.useRef)(t),
    x = (0, pu.useRef)(null),
    S = lt(void 0, () => new Sl({ document: du(s), initialPageIndex: c, initialZoom: l }));
  return (
    (0, pu.useEffect)(() => {
    ...
    (0, pu.useEffect)(() => {
      !S ||
        ...
        (_.requestId !== x.current &&
          ((x.current = _.requestId), S.setPageIndex(_.pageNumber - 1, { origin: `navigation` })));
    }, [S, _]),
    S
      ? (0, mu.jsx)(`section`, {
