...
import "./react-dom.js";
import { t as r } from "./clsx-Cir5-jBH.js";
...
import { C as oe, o as U } from "./document-2.js";
import {
  A as W,
  _ as G,
  c as se,
...
import { r as be, t as xe } from "./feature-catalog.js";
import { t as Se } from "./PopcornPageNumberNavigation.js";
var Ce = class {
    #e;
    constructor(e = []) {
      this.#e = e.map((e) => new we(e));
    }
    get items() {
      return [...this.#e];
    }
...
function Oe() {
  let e = new _({ stub: () => {} }, void 0);
  return ((e.colorScheme = { name: `Office`, themeColors: { ...Te } }), e.toProto());
}
function ke() {
  return [
...
function je() {
  return [
    ...
    De({
      ...
      name: `Title`,
      basedOn: `Normal`,
      textStyle: { typeface: `Aptos Display`, fontSize: `28pt`, color: `#1F1F1F` },
    ...
    De({
      ...
      name: `Heading 1`,
      basedOn: `Normal`,
      textStyle: { typeface: `Aptos Display`, fontSize: `20pt`, color: `#156082` },
      paragraphStyle: { lineSpacingPercent: 1e5 },
      spaceBefore: 360,
      spaceAfter: 80,
    }),
    De({
      ...
      name: `Heading 2`,
      basedOn: `Normal`,
      textStyle: { typeface: `Aptos Display`, fontSize: `16pt`, color: `#156082` },
      paragraphStyle: { lineSpacingPercent: 1e5 },
      spaceBefore: 160,
      spaceAfter: 80,
    }),
...
function Pe() {
  ...
  return {
    ...
    sections: [
      {
        id: `doc-section-1`,
        breakType: oe.SECTION_BREAK_TYPE_UNSPECIFIED,
...
var Fe = class {
    ...
    set(e) {
      ...
      return (n >= 0 ? (this.#e[n] = t) : this.#e.push(t), this.#t?.(), K(t));
    }
    delete(e) {
  ...
  Le = class {
    ...
    #r;
    constructor(e) {
      ((this.#e = new M({ people: e.people ?? [], threads: e.threads ?? [] })),
        (this.#t = e.documentId ?? ``),
    ...
    #i(e) {
      let t = this.#r(e),
        n = t?.startCp ?? 0,
        r = t?.length ?? 0;
      return { textRange: { slideId: this.#t, elementId: this.#n, startCp: n, length: r } };
    }
  };
function Re(e, t) {
  ...
  He = class {
    ...
    constructor(e) {
      ((this.#t = e.documentId ?? ``),
        ...
        (this.#r = e.resolveTextRange),
        (this.#i = e.onMutated),
        (this.#e = (e.endnotes ?? []).map((e) => new Ve(e))));
    }
    get items() {
      return [...this.#e];
    }
    add(e, t) {
      let n = this.#a(e),
        r = this.#o(t.range),
        i = new Ve({ id: D(), paragraphs: n, referenceTextRange: r, referenceRunIds: [] });
      return (this.#e.push(i), this.#i?.(), i);
    }
    replace(e) {
      ((this.#e = e.map((e) => new Ve(e))), this.#i?.());
    }
    toProto() {
      return this.#e.map((e) => e.toProto());
    }
    #a(e) {
      return O(e) ? V(e) : V([String(e)]);
    }
    #o(e) {
      let t = this.#r(e);
      if (t) return { slideId: this.#t, elementId: this.#n, startCp: t.startCp, length: t.length };
    }
  },
  Ue = class {
    #e;
    ...
    toProto() {
      return {
        ...
        paragraphs: this.#e.paragraphs
          ? this.#e.paragraphs.map((e) => ({ ...e, runs: e.runs?.map((e) => ({ ...e })) ?? [] }))
          : [],
      };
    }
  },
  Ge = class {
    ...
    constructor(e) {
      ((this.#t = e.documentId ?? ``),
        ...
        (this.#r = e.resolveTextRange),
        (this.#i = e.onMutated),
        (this.#e = (e.footnotes ?? []).map((e) => new We(e))));
    }
    add(e, t) {
      let n = this.#a(e),
        r = this.#o(t.range),
        i = new We({ id: D(), paragraphs: n, referenceTextRange: r, referenceRunIds: [] });
      return (this.#e.push(i), this.#i?.(), i);
    }
    toProto() {
      return this.#e.map((e) => e.toProto());
...
function qe(e) {
  for (let t of e)
    for (let e of t.cells ?? []) if (e.horizontalMerge === !1 || e.verticalMerge === !1) return !0;
  return !1;
}
function Je(e) {
  ...
  for (let t of e)
    for (let e = 0; e < t.cells.length; e += 1) {
      ...
      for (; i < t.cells.length; ) {
        ...
        ((r += Ke(e.gridSpan)), (e.horizontalMerge = !0), (i += 1));
      }
...
function Ze(e) {
  ...
  for (let e of n)
    r.has(e.cell) ||
      (r.add(e.cell), e.rowSpan > 1 && (e.cell.rowSpan = Math.max(Ke(e.cell.rowSpan), e.rowSpan)));
}
function Qe(e) {
  let t = e.table;
  if (!t || t.rows.length === 0 || !qe(t.rows)) return e;
  let n = Je(t.rows);
  return (Ye(n), Ze(n), { ...e, table: { ...t, rows: n } });
}
var $e = {
    accent1: `accent1`,
    accent2: `accent2`,
  ...
  et = I(new _({ stub: () => {} }, void 0), $e);
function tt(e) {
  return I(e, $e);
}
function nt(e) {
  return tt(new _({ stub: () => {} }, e));
}
function rt(e, t, n, r = et) {
...
var it = `__docxField:PAGE__`,
  at = `__docxField:NUMPAGES__`,
  ot = 180,
  st = 120,
  ct = 1,
  lt = 2,
  ut = `__docxAnchorParagraphId:`,
  dt = `__docxInlineParagraphId:`;
function ft(e) {
  if (!(e === void 0 || e <= 0)) return e * h;
}
function pt(e) {
  if (!(e === void 0 || !Number.isFinite(e))) return e * h;
}
function mt(e, t) {
  if (e) {
...
function gt(e, t = { widthPx: ot, heightPx: st }) {
  if (!e.bbox) return t;
  let n = ft(e.bbox.widthEmu),
    r = ft(e.bbox.heightEmu);
...
function _t(e, t) {
  return pt(e.bbox?.xEmu) ?? t;
}
function vt(e, t) {
  return pt(e.bbox?.yEmu) ?? t;
}
function yt(e, t) {
  let n = ht(e, lt, ut),
    r = pt(e.placement?.yOffsetEmu) ?? pt(e.bbox?.yEmu) ?? 0;
  if (e.placement?.verticalRelativeFrom?.trim().toLowerCase() === `page`) return r;
  if (!n) return;
  let i = t.get(n);
...
function bt(e, t) {
  ...
  if (!n) return;
  let r = t.get(n);
  if (r !== void 0) return r + (pt(e.bbox?.yEmu) ?? 0);
}
function xt(e) {
  return ht(e, ct, dt) !== void 0;
}
function St(e) {
  return gt(e);
}
...
function Tt(e) {
  ...
  let n = 0;
  for (let e of t.rows) e.heightEmu && e.heightEmu > 0 ? (n += e.heightEmu * h) : (n += wt);
  return Math.max(n, t.rows.length * wt);
}
function Et(e, t) {
  let n = e.bbox?.widthEmu !== void 0 && e.bbox.widthEmu > 0 ? e.bbox.widthEmu * h : void 0;
  return n && Number.isFinite(n) && n > 0 ? n : t;
}
function Dt(e, t) {
  let n = e.bbox?.xEmu === void 0 ? void 0 : e.bbox.xEmu * h;
  return n !== void 0 && Number.isFinite(n) ? n : t;
}
function Ot(e, t, n, r = et, i) {
  return jt(e, t, n, r, i).heightPx;
}
function kt(e, t, n, r, i) {
  ...
  if (!(!a || a.rows.length === 0))
    return P(
      Qe({
        ...e,
        type: d.ELEMENT_TYPE_TABLE,
        bbox: { xEmu: 0, yEmu: 0, widthEmu: Ct(Math.max(1, n)), heightEmu: e.bbox?.heightEmu },
      }),
      t,
      r,
      {
...
function At(e) {
  let t = e.table;
  return t ? t.rows.map((e) => (e.heightEmu && e.heightEmu > 0 ? e.heightEmu * h : wt)) : [];
}
function jt(e, t, n, r = et, i) {
  let a = e.table;
  if (!a || a.rows.length === 0) return { widthPx: n, heightPx: 0, rowHeightsPx: [] };
  let o = kt(e, t, n, r, i),
    s = At(e),
...
function Ft(e, t) {
  return (
    ...
    Pt(e.leftPx, e.rightPx, t.leftPx, t.rightPx) &&
    Pt(e.topPx, e.bottomPx, t.topPx, t.bottomPx)
  );
}
function It(e, t) {
...
function Lt(e, t) {
  ...
  (e.push(n),
    e.sort((e, t) =>
      Math.abs(e.topPx - t.topPx) > 0.01 ? e.topPx - t.topPx : e.leftPx - t.leftPx,
    ));
}
function Rt(e, t, n, r, i, a = 0, o = !1) {
  let s = t + n,
    c = r,
    l = Math.max(0, a);
  for (;;) {
    let n = e.find(
      (e) =>
        It(e, o) && Pt(t, s, e.leftPx, e.rightPx) && c >= e.topPx - 0.01 && c < e.bottomPx - 0.01,
    );
    if (!n) {
      let n = e
          .filter((e) => It(e, o) && Pt(t, s, e.leftPx, e.rightPx) && e.topPx > c + 0.01)
...
var zt = 12240,
  Bt = 15840,
  Vt = 1e5,
  J = { top: 1440, bottom: 1440, left: 1440, right: 1440, header: 720, footer: 720, gutter: 0 },
  Ht = 8,
  Ut = 0.5,
  Wt = 1,
  Gt = `__docxMirrorMargins:1`,
  Kt = `__docxPageNumberStart:`,
  qt = `__docxPageNumberFormat:`,
  Jt = 2,
  Yt = 1,
  Xt = 5,
  Zt = 6;
function Qt(e) {
  return e.type === d.ELEMENT_TYPE_TABLE || e.table
    ? `table`
    : e.type === d.ELEMENT_TYPE_CHART ||
        e.type === d.ELEMENT_TYPE_CHART_REFERENCE ||
        e.chartReference
      ? `chart`
      : e.type === d.ELEMENT_TYPE_IMAGE ||
          e.type === d.ELEMENT_TYPE_IMAGE_REFERENCE ||
          e.imageReference ||
          e.image
        ? `image`
        : e.type === d.ELEMENT_TYPE_SHAPE || e.shape
          ? `shape`
          : e.type === d.ELEMENT_TYPE_GROUP || (e.children?.length ?? 0) > 0
            ? `group`
            : `text`;
}
function $t(e, t) {
...
function an({
  ...
  return {
    ...
    documentGridLinePitchPx:
      e.documentGridLinePitchTwips === void 0 ? void 0 : q(e.documentGridLinePitchTwips),
  };
}
function on(e, t) {
  let n = (e.get(t) ?? 0) + 1;
...
function pn(e) {
  return e.placement?.type === Jt && e.placement.wrap?.type === Yt;
}
function mn(e) {
  return e.placement?.type === Jt && e.placement.wrap?.type === Xt;
}
function hn(e) {
  if (!gn(e)) return !1;
...
function gn(e) {
  return e.placement?.type === Wt && !xt(e);
}
function _n(e, t, n, r, i = 0) {
  if (dn(e.kind)) {
    let a = bt(e.element, n);
    if (a !== void 0) return a;
    if (gn(e.element)) return t + N(e.element).topPx;
    if (xt(e.element) && r !== void 0) return r + (e.element.bbox?.yEmu ?? 0) * h;
    let o = yt(e.element, n);
    if (o !== void 0) return yn(e.element) ? i + o : o;
    let s = vt(e.element, t);
    return vn(e.element) ? i + s : s;
  }
  return t;
}
function vn(e) {
...
function yn(e) {
  return (
    e.placement?.type === Jt && e.placement.verticalRelativeFrom?.trim().toLowerCase() === `page`
  );
}
function bn(e, t) {
...
function xn(e, t, n, r) {
  return dn(e.kind) && (fn(e.element) || mn(e.element) || pn(e.element))
    ? t
    : Math.max(t, n + r + Sn(e.element));
}
function Sn(e) {
  return gn(e) ? N(e).bottomPx : 0;
}
function Cn(e, t) {
...
function wn(e) {
  return e.sections.length > 0 ? e.sections.flatMap((e) => e.elements ?? []) : (e.elements ?? []);
}
function Tn(e, t) {
  ...
  if (n)
    for (let e of n.rows)
      for (let n of e.cells) {
        ...
        for (let e of n.elements ?? []) Tn(e, t);
      }
}
function En(e, t, n) {
  let r = e,
...
function On(e, t) {
  ...
  switch (e) {
    case `decimal`:
      return r ? `arabicBracketBoth` : !a && !i ? `arabicPlain` : `arabicPeriod`;
    case `lowerLetter`:
...
function kn(e, t, n) {
  ...
  if (r.numberFormat === `bullet`) {
    let e = Dn(r.levelText);
    return e ? { startAt: n, paragraphStyle: { bulletCharacter: e, tabStops: [] } } : void 0;
  }
  let i = On(r.numberFormat, r.levelText);
  if (i)
    return {
      startAt: n,
...
function jn(e) {
  ...
  for (let t of e.numberingDefinitions ?? []) {
    ...
    for (let e of t?.levels ?? [])
      e?.paragraphStyleId &&
        t?.numId &&
        n.set(e.paragraphStyleId, { numId: t.numId, level: Math.max(0, e.level ?? 0) });
  }
  for (let n of e.paragraphNumberings ?? []) n?.paragraphId && n.numId && t.set(n.paragraphId, n);
  for (let c of wn(e))
    Tn(c, (e) => {
      if (!e.id || s.has(e.id)) return;
      s.add(e.id);
      let c = t.get(e.id) ?? En(e.styleId, n, r);
      if (!c?.numId) return;
      let l = Math.max(0, c.level ?? 0),
        u = i.get(c.numId),
        d = a.get(c.numId) ?? [];
      for (let e = l + 1; e < d.length; e += 1) d[e] = void 0;
      d[l] === void 0 && (d[l] = An(e.paragraphStyle, u, l));
      let f = d[l] ?? 1;
      (o.set(e.id, { startAt: f, paragraphStyle: kn(u, l, f)?.paragraphStyle }),
        (d[l] = f + 1),
        a.set(c.numId, d));
    });
  return o;
  ...
  return {
    paragraphs: e.map((e) => {
      ...
      if (!s) {
        ...
        let t = Mn(e.paragraphStyle, void 0, void 0),
          n = x(a?.paragraphStyle, t);
        return (
          n && o !== void 0 && n.autoNumberType && (n.autoNumberStartAt = o),
          n === e.paragraphStyle ? e : ((i = !0), { ...e, paragraphStyle: n })
        );
      }
      let c = Fn(e.textStyle, s.textStyle, r.preserveDirectTextStyle === !0),
        l = s.contextualSpacing ? w(c) : c,
        u = Mn(e.paragraphStyle, s.paragraphStyle, void 0),
        d = x(a?.paragraphStyle, u);
      d && o !== void 0 && d.autoNumberType && (d.autoNumberStartAt = o);
      let f = In(e.runs, r.preserveDirectTextStyle === !0 ? c : s.textStyle),
...
function Fn(e, t, n = !1) {
  if (!n) {
    ...
    return (
      ...
      Object.keys(n).length === 0 ? t : v(n, t)
    );
  }
  return v(e, t);
}
    ...
    a = r.rows.map((e) => {
      let r = !1,
        a = e.cells.map((e) => {
          ...
          let a = Pn(i, t, n, { preserveDirectTextStyle: !0 });
...
function Rn(e, t, n) {
  return Ln(e.paragraphs && e.paragraphs.length > 0 ? Nn(e, t, n) : e, t, n);
}
function zn(e, t, n) {
  return e.map((e) => Rn(e, t, n));
}
function Bn(e, t, n, r) {
  return e.map((e) => {
    let i = Rn(e, t, n),
    ...
    return {
      ...
      firstParagraphUsesContextualSpacing: E(s?.textStyle),
    };
  });
}
function Vn(e, t) {
...
function Hn(e, t, n, r) {
  ...
  for (let o of e.footnotes ?? []) {
    ...
    let e = Bn([Vn(`docx-footnote-${o.id}`, o.paragraphs ?? [])], t, n, r)[0];
    if (e) {
...
function Wn(e, t, n, r) {
  let i = [],
    a = new Set();
  for (let o = t; o < n; o += 1) for (let t of Un(e[o], r)) a.has(t) || (a.add(t), i.push(t));
  return i;
}
function Gn(e, t) {
...
function qn(e, t, n, r) {
  ...
  let s = Vn(`docx-footnotes-${t.join(`-`)}`, o),
    c = Jr(s, n, r),
    l = c.reduce((e, t) => e + Math.max(1, t.heightPx), 0),
    u = { element: s, lines: c, textHeightPx: l, reservedHeightPx: l > 0 ? l + Zt : 0 };
  return (e.layoutByKey.set(i, u), u);
}
function Jn(e, t, n, r) {
  return e.ids.length === 0 ? 0 : qn(t, e.ids, n.contentWidthPx, r).reservedHeightPx;
}
function Yn(e, t, n, r) {
  return n.contentBottomPx - Jn(e, t, n, r);
}
function Xn(e, t, n = et, r) {
  let i = Kn(t, r),
    a = e.linesByWidth.get(i);
  if (a) return a;
  let o = e.kind === `text` ? Jr(e.element, t, n, e.defaultTabStopTwips, r) : [];
  return (e.linesByWidth.set(i, o), o);
}
function Zn(e, t, n, r = et, i) {
  let a = Kn(n, i),
    o = e.measurementsByWidth.get(a);
  if (o) return o;
  let s = Rr(e.element, e.kind, t, n, r, i);
  return (e.measurementsByWidth.set(a, s), s);
}
function Qn(e, t, n, r = et, i) {
  let a = Et(e.element, n),
    o = Kn(a, i),
    s = e.tableMeasurementsByWidth.get(o);
  if (s) return s;
  let c = jt(e.element, t, a, r, i);
...
function $n(e, t, n) {
  ...
  if (e.kind === `table`) {
    let n = nr(e.element, t);
    if (n !== void 0) return n;
    let a = er(e.element, r, i);
  ...
  if (un(e.kind)) {
    ...
    if (n !== void 0) return n;
    let a = er(e.element, r, i);
    return a === void 0 ? _t(e.element, r) : a;
  }
  return r;
}
function er(e, t, n) {
  ...
  if (!i) return;
  let a = gt(e).widthPx;
  return i === `center` ? t + Math.max(0, (n - a) / 2) : i === `right` ? t + Math.max(0, n - a) : t;
}
function tr(e, t, n) {
  let r = pn(t.element) && !fn(t.element);
  if (!r && !mn(t.element)) return;
...
function nr(e, t) {
  if (e.placement?.type !== Jt) return;
  let n = e.placement.horizontalRelativeFrom?.trim().toLowerCase(),
    r = e.bbox?.widthEmu !== void 0 && e.bbox.widthEmu > 0 ? e.bbox.widthEmu * h : 0;
  if (e.placement.xOffsetEmu !== void 0 && Number.isFinite(e.placement.xOffsetEmu)) {
    let r = e.placement.xOffsetEmu * h;
  ...
  return i === `center` ? o + Math.max(0, (s - r) / 2) : i === `right` ? o + Math.max(0, s - r) : o;
}
function rr(e) {
  return e.firstParagraphSpaceBeforePx > 0 || e.lastParagraphSpaceAfterPx > 0;
}
function ir({ lineIndex: e, trailingSpaceAfterPx: t, firstParagraphSpaceBeforePx: n }) {
  return e === 0 ? m(t, n) : 0;
}
function ar(e) {
...
function sr({
  ...
  if (o.idsByReferenceRunId.size === 0) return or(e, t, Math.max(0, r - n));
  let l = t,
    u = 0,
    d = !1,
    f = [...a],
  ...
  for (; l < e.length; ) {
    let t = e[l],
      a = [...f],
      m = new Set(p);
    for (let e of Un(t, o)) m.has(e) || (a.push(e), m.add(e));
    let h = a.length > 0 ? qn(o, a, s, c).reservedHeightPx : 0,
      g = Math.min(r, i - h),
      _ = Math.max(0, g - n),
...
function cr(e) {
  return typeof e == `number` && Number.isFinite(e) && e > 1 ? Math.floor(e) : 1;
}
function lr(e, t, n) {
  let r = 0;
...
function dr(e, t, n) {
  ...
  for (let n = t + i; n <= e.length; n += 1) if (ur(e, t, n)) return n - t;
  return i;
}
function fr(e) {
  let t = e.table;
  ...
  let n = t.rows[0];
  return n ? (n.cells.some((e) => cr(e.rowSpan) > 1) ? 0 : 1) : 0;
}
function pr(e, t, n, r) {
  let i = e.table;
  if (!i) return e;
...
function mr({
  ...
  let l = c.rows,
    ...
    f = fr(e.element),
    p = t > 0 ? lr(u.rowHeightsPx, 0, f) : 0,
    m = t === 0 && f > 0 && c.rows.length > f ? f + 1 : 1,
    h = Math.min(m, c.rows.length - t);
  if (d) {
    let s = c.rows.length - t,
      l = p + lr(u.rowHeightsPx, t, c.rows.length);
    if (!r && l > n + Ut) return { rowCount: 0, widthPx: u.widthPx, heightPx: 0 };
    let d = pr(e.element, t, s, f),
      m = Rr(d, `table`, i, a, o);
    return {
      element: d,
      rowCount: s,
  ...
  for (let e = t; e < c.rows.length; e += 1) {
    ...
    let r = e - t + 1;
    if (g > n + Ut) break;
    r >= h && ur(l, t, e + 1) && ((_ = r), (v = g));
  }
  if (_ === 0) {
    if (!r) return { rowCount: 0, widthPx: u.widthPx, heightPx: 0 };
    ((_ = dr(l, t, h)), (v = p + lr(u.rowHeightsPx, t, t + _)));
  }
  let y = pr(e.element, t, _, f),
    b = Rr(y, `table`, i, a, o);
  return { element: y, rowCount: _, widthPx: b.widthPx, heightPx: b.heightPx > 0 ? b.heightPx : v };
}
function hr(e) {
  if ((e.paragraphs?.length ?? 0) !== 1) return !1;
  let t = e.paragraphs?.[0];
  return t ? (t.runs ?? []).every((e) => (e.text ?? ``).trim().length === 0) : !1;
}
function gr(e, t) {
  return hr(e) ? t.length > 0 && t.every((e) => !ar(e)) : !1;
}
function _r(e) {
  let t = e.paragraphs ?? [];
  return t.length === 1 && t[0]?.docxSectionBreakCarrier === !0 && hr(e);
}
function vr(e) {
  return e
    ? e.segments.length === 0 &&
...
function yr({
  ...
  return e !== 0 || i <= 0 || !vr(t[0]) ? !1 : n && r;
}
function br(e, t) {
  let n = e[t];
  return n
    ? dn(n.kind)
      ? !(fn(n.element) || pn(n.element) || (mn(n.element) && !xt(n.element)))
      : !0
    : !1;
}
function xr(e, t, n, r, i, a = et, o) {
  let s = 0;
  for (let c = n + 1; c < t.length; c += 1) {
    let n = t[c];
    if (!n || !br(t, c)) continue;
    if (n.kind !== `text`) return s + Zn(n, r, i, a, o).heightPx;
    let l = Xn(n, i, a, o),
      u = gr(n.element, l),
      d = cn({
        previousParagraphStyleId: e.lastParagraphStyleId,
        currentParagraphStyleId: n.firstParagraphStyleId,
        currentParagraphUsesContextualSpacing: n.firstParagraphUsesContextualSpacing,
      });
    ...
    let f =
      yr({
        ...
        previousEmptyParagraphHasSpacing: rr(e),
  ...
  for (let i = 0; i < e.length; i += 1) {
    ...
    if (C.kind !== `text`) {
      ...
      for (; !e; ) {
        let w = t.columns.widths[l] ?? t.contentWidthPx,
          ...
          E = T === n,
          D = T + (d[l] ?? 0),
          O = Zn(C, o, w, s, t.documentGridLinePitchTwips),
          k = _n(C, D, h, g[l]),
          A = xn(C, D, k, O.heightPx);
        if (A > r) {
        ...
        (c.push({
          ...
          flow: an({
            ...
            fragmentIndex: on(S, i),
            columnIndex: l,
            balanced: !0,
          }),
        }),
          tr(_, C, { xPx: $n(C, t, l), yPx: k, widthPx: O.widthPx, heightPx: O.heightPx }),
          (u[l] = A),
          (d[l] = 0),
          (f[l] = !1),
          (p[l] = !1),
    ...
    for (; !T; ) {
      let e = t.columns.widths[l] ?? t.contentWidthPx,
        o = u[l] ?? n,
        E = Xn(C, e, s, t.documentGridLinePitchTwips);
      if (E.length === 0 || w >= E.length) {
        (ln(C.element, o, h), (g[l] = o), (T = !0));
        break;
      }
      let D = f[l] ?? !1,
        O = p[l] ?? !1,
        ...
        A = cn({
          ...
          currentParagraphUsesContextualSpacing: C.firstParagraphUsesContextualSpacing,
        }),
        j = k || (A && w === 0 && vr(E[0])),
        M = j && w === 0 ? 1 : w;
      if (M >= E.length) {
      ...
      let ee = gr(C.element, E),
        ...
        F = o === n,
        { nextLineIndex: I, fragmentHeightPx: L, endsWithFlowBreak: re } = or(E, M, P);
      if (I === M) {
        if (!F) {
      ...
      if (w >= E.length) {
        let e = (C.element.paragraphs?.length ?? 0) > 1 ? Ht : 0;
        ((u[l] = (u[l] ?? n) + e),
...
function wr(e) {
  let t = e.pageSetup?.pageMargin ?? J;
  return {
    topPx: q(t.top ?? J.top),
    bottomPx: q(t.bottom ?? J.bottom),
    leftPx: q(t.left ?? J.left),
    rightPx: q(t.right ?? J.right),
    headerPx: q(t.header ?? J.header),
    footerPx: q(t.footer ?? J.footer),
  };
}
function Tr(e) {
  return (e ?? ``).includes(Gt);
}
function Er(e, t, n) {
  return n % 2 != 0 || !Tr(e) ? 0 : t.margins.rightPx - t.margins.leftPx;
}
function Dr(e, t = 0) {
  return {
    key: e.key,
...
function kr(e, t) {
  return e?.columnFrame ? { ...e, columnFrame: Or(e.columnFrame, t) } : e;
}
function Ar(e, t) {
  return { ...e, xPx: e.xPx + t, flow: kr(e.flow, t), children: e.children?.map((e) => Ar(e, t)) };
}
function jr(e, t, n, r = {}) {
  let i = Er(e.sectionId, t, n),
    a =
      Math.abs(i) < 0.01
        ? e
        : {
            ...e,
            layout: Dr(t, i),
            headerElements: e.headerElements.map((e) => Ar(e, i)),
            bodyElements: e.bodyElements.map((e) => Ar(e, i)),
            footerElements: e.footerElements.map((e) => Ar(e, i)),
            pageNumberElement: e.pageNumberElement ? Ar(e.pageNumberElement, i) : void 0,
          };
  return r.layoutMode === `pageless` ? Mr(a, t, r) : a;
}
function Mr(e, t, n) {
  let r = Nr(e.bodyElements),
    i = Math.max(t.contentTopPx, r),
    a = Math.ceil(Math.max(t.basePageHeightPx, n.pagelessMinHeightPx ?? 0, i + t.margins.bottomPx)),
  ...
  return {
    ...
    layout: {
      ...
      columns: e.layout.columns.map((e) => ({ ...e, frame: { ...e.frame, heightPx: o } })),
    },
  };
}
function Nr(e) {
...
function Rr(e, t, n, r, i, a) {
  if (t === `table`) {
    let t = Et(e, r);
    return { widthPx: t, heightPx: Ot(e, n, t, i, a) };
  }
  if (t === `image`) {
    let t = St(e);
  ...
  return t === `shape` || t === `chart` || t === `group`
    ? gt(e, { widthPx: Math.max(1, Math.min(r, 180)), heightPx: 120 })
    : { widthPx: r, heightPx: rt(e, n, r, i) };
}
function zr(e, t) {
  return e.bbox?.widthEmu !== void 0 && e.bbox.widthEmu > 0
    ? Math.max(1, e.bbox.widthEmu * h)
    : Math.max(1, t);
}
function Br(e, t, n, r, i, a) {
  return (e.children ?? []).map((e) => {
    ...
    return (o === `group` && (c.children = Br(e, c.xPx, c.yPx, c.widthPx, i, a)), c);
  });
}
function Vr(e) {
  return e.type === d.ELEMENT_TYPE_TEXT || e.type === d.ELEMENT_TYPE_TEXT_GROUP;
}
function Hr(e) {
  let t = new Map();
  for (let n of e.table?.rows ?? [])
    for (let e of n.cells ?? [])
      for (let n of e.elements ?? []) Vr(n) || (n.id && n.id.length > 0 && t.set(n.id, n));
  return t;
}
function Ur(e, t) {
  ...
  return {
    ...
    bbox: {
      ...
      xEmu: Ct(t.xPx),
      yEmu: Ct(t.yPx),
      widthEmu: n ? 0 : Ct(t.widthPx),
      heightEmu: r ? 0 : Ct(t.heightPx),
    },
  };
}
function Wr(e, t, n, r, i, a, o, s) {
  ...
  let c = P(
      Qe({ ...Ur(e, { xPx: t, yPx: n, widthPx: r, heightPx: i }), type: d.ELEMENT_TYPE_TABLE }),
      a,
      o,
      {
        paragraphSpacingUnit: `twips`,
  ...
  for (let e of c.cellElementFrames ?? []) {
    ...
    if (!t) continue;
    let n = Qt(t);
    u.push(Gr(t, n, e.xPx, e.yPx, e.widthPx, e.heightPx, a, o, void 0, s));
  }
  return u;
}
function Gr(e, t, n, r, i, a, o, s, c, l) {
  let u = { kind: t, element: e, xPx: n, yPx: r, widthPx: i, heightPx: a, flow: l, textLines: c };
  return (
    t === `group` && (u.children = Br(e, n, r, i, o, s)),
    t === `table` && (u.children = Wr(e, n, r, i, a, o, s, l)),
    u
  );
}
function Kr(e, t, n, r, i, a) {
  if (
    ((e.bodyElements = e.bodyElements.filter((e) => e.flow?.noteKind !== `footnote`)),
    t.ids.length === 0)
  )
    return;
  let o = qn(n, t.ids, r.contentWidthPx, a);
  o.textHeightPx <= 0 ||
    e.bodyElements.push(
      Gr(
        o.element,
...
function qr(e, t, n, r, i, a, o, s, c) {
  let l = !1;
  for (let e of Wn(r, i, a, n)) t.idSet.has(e) || (t.idSet.add(e), t.ids.push(e), (l = !0));
  l && Kr(e, t, n, o, s, c);
}
function Jr(e, t, n = et, r, i) {
  return (
    T(e, n, {
...
function Yr(e, t, n, r, i) {
  ...
  for (let [t, l] of e.entries()) {
    let u = Qt(l),
      d = Rr(l, u, r, n.contentWidthPx, i),
      f =
        u === `table`
          ? (nr(l, n) ?? Dt(l, n.contentLeftPx))
          : un(u)
            ? (nr(l, n) ?? _t(l, n.contentLeftPx))
            : n.contentLeftPx,
      p = u === `text` ? o : _n({ element: l, kind: u }, o, s, c);
    if ((a.push(Gr(l, u, f, p, d.widthPx, d.heightPx, r, i)), u === `text`)) {
      (ln(l, p, s), (c = p), (o += d.heightPx), t < e.length - 1 && (o += Ht));
      continue;
    }
    let m = xn({ element: l, kind: u }, o, p, d.heightPx);
    m > o && ((o = m), t < e.length - 1 && (o += Ht));
  }
  return { elements: a, totalHeightPx: Math.max(0, o - t) };
}
function Xr(e, t, n = {}) {
  let r = e.pageSetup?.widthEmu || t.widthEmu || zt,
    i = e.pageSetup?.heightEmu || t.heightEmu || Bt,
    a = Math.max(1, q(r)),
    o = Math.max(1, q(i)),
    s = n.layoutMode === `pageless` ? Math.max(o, Vt) : o,
    c = wr(e),
    l = c.leftPx,
...
function Zr(e) {
  return (
    ...
    e.breakType === oe.SECTION_BREAK_TYPE_NEXT_PAGE ||
    e.breakType === oe.SECTION_BREAK_TYPE_EVEN_PAGE ||
    e.breakType === oe.SECTION_BREAK_TYPE_ODD_PAGE
  );
}
function Qr(e) {
...
function $r(e) {
  return !Zr(e) || Qr(e) ? !1 : (e.elements?.length ?? 0) > 0;
}
function ei(e, t) {
  let n = [],
    r = !1;
  for (let i of e) {
    ...
    (n.push(s ? { ...i, breakType: oe.SECTION_BREAK_TYPE_UNSPECIFIED } : i), (r = !1));
  }
  return n;
}
function ti(e, t) {
...
function ii(e, t) {
  ...
  n &&
    ...
    n.start === void 0 ? e.nextValue === void 0 && (e.nextValue = 1) : (e.nextValue = n.start));
}
function ai(e, t) {
  let n = t ?? `decimal`;
  return n === `upperRoman`
...
function ci(e, t) {
  return e.some((e) => li(e, t));
}
function li(e, t) {
  return (e.paragraphs ?? []).some((e) => (e.runs ?? []).some((e) => (e.text ?? ``).includes(t))) ||
    (e.children ?? []).some((e) => li(e, t))
    ? !0
    : (e.table?.rows ?? []).some((e) =>
        e.cells.some((e) =>
          (e.text ?? ``).includes(t) ||
          (e.paragraphs ?? []).some((e) => (e.runs ?? []).some((e) => (e.text ?? ``).includes(t)))
            ? !0
            : (e.elements ?? []).some((e) => li(e, t)),
        ),
      );
}
function ui(e, t) {
  let n = (e) => e.replaceAll(it, t.currentPageText ?? ``).replaceAll(at, t.totalPagesText ?? ``);
  return e.map((e) => di(e, n));
}
function di(e, t) {
  return {
    ...e,
    ...
    children: (e.children ?? []).map((e) => di(e, t)),
    table: e.table
      ? {
          ...e.table,
          rows: e.table.rows.map((e) => ({
            ...
            cells: e.cells.map((e) => ({
              ...
              elements: (e.elements ?? []).map((e) => di(e, t)),
            })),
          })),
        }
      : e.table,
...
function pi(e, t, n, r, i, a, o, s) {
  let c = ci(n, `__docxField:PAGE__`) || ci(r, `__docxField:PAGE__`),
    l = c ? ai(a.nextValue ?? 1, a.formatType) : void 0;
  c && (a.nextValue = (a.nextValue ?? 1) + 1);
  let u = ui(n, { currentPageText: l }),
    d = ui(r, { currentPageText: l }),
    f = Yr(u, Math.max(0, t.margins.headerPx), t, o, s),
    p = Yr(d, 0, t, o, s),
    m = Yr(
      d,
      Math.max(t.contentTopPx, t.pageHeightPx - t.margins.footerPx - p.totalHeightPx),
      t,
      o,
      s,
    ),
  ...
  return (
    i &&
      !c &&
      a.nextValue !== void 0 &&
      ((h = fi(ai(a.nextValue, a.formatType), t)), (a.nextValue += 1)),
    {
      sectionId: e,
...
function mi(e, t, n = et, r = {}) {
  let i = r.layoutMode === `pageless`,
    ...
    x = new Map(),
    S = X(),
    w = new C(e.textStyles ?? []),
    T = (e) => w.resolve(e),
    E = jn(e),
    D = Hn(e, T, E, e.settings?.defaultTabStop),
    O = a.map((t) => ({ section: t, settings: Xr(t, e, r) }));
  for (let a = 0; a < O.length; a += 1) {
    let { section: C, settings: w } = O[a],
      k = O[a - 1],
      A = O[a + 1];
    ii(d, C);
    let j = zn(C.header?.elements ?? s, T, E),
      M = zn(C.footer?.elements ?? c, T, E),
      ee = zn(C.firstHeader?.elements ?? l, T, E),
      te = zn(C.firstFooter?.elements ?? u, T, E),
      ne = !!C.pageSetup?.pageNumbers;
    (C.header && (s = j),
      C.footer && (c = M),
      C.firstHeader && (l = ee),
      C.firstFooter && (u = te));
    let N = Bn(C.elements ?? [], T, E, e.settings?.defaultTabStop),
      P = C.id || `doc-section`,
      F = (e) =>
        pi(
          P,
      ...
      I = !f || !m || (!i && (p !== w.key || Zr(C)));
    I &&
      (f && o.push(jr(f, m ?? w, o.length + 1, r)),
      (f = F(!0)),
      (x = new Map()),
      (S = X()),
      (p = w.key),
      ...
      (y = void 0),
      (b = Mt()));
    let L = Math.max(h, w.contentTopPx),
      re = !I && (i || !Zr(C)) && L > w.contentTopPx + 0.01,
      ie =
        k !== void 0 &&
        C.breakType === oe.SECTION_BREAK_TYPE_CONTINUOUS &&
        Cn(k.settings.columns, w.columns),
      ae = re && _ && (!ie || !v);
    if (
      f !== void 0 &&
      A !== void 0 &&
      ...
      (i || !Zr(A.section)) &&
      Cn(w.columns, A.settings.columns) &&
      f
    ) {
      let e = Cr({
        preparedElements: N,
    ...
    let R = 0,
      ...
      ce = () => {
        if (R < w.columns.widths.length - 1) {
          R += 1;
          return;
        }
        se();
    ...
    for (let e = 0; e < N.length; e += 1) {
      ...
      if (s.kind === `table` && br(N, e)) {
        let r = s.element.table;
        if (!r || r.rows.length === 0) continue;
        let o = 0;
        for (; o < r.rows.length; ) {
          let c = w.columns.widths[R] ?? w.contentWidthPx,
            l = z[R] ?? L,
            u = l + (B[R] ?? 0),
            d = _n(s, u, x, W[R], i ? bn(w, L) : 0),
            p = l === w.contentTopPx,
      ...
      if (s.kind !== `text`) {
        let c = !1;
        for (; !c; ) {
          let l = w.columns.widths[R] ?? w.contentWidthPx,
            u = z[R] ?? L,
            d = u + (B[R] ?? 0),
            h = Zn(s, t, l, n, w.documentGridLinePitchTwips),
            b = _n(s, d, x, W[R], i ? bn(w, L) : 0),
            C = xn(s, d, b, h.heightPx),
            T = u === w.contentTopPx;
          if (C > w.contentBottomPx && !T) {
            if (R < w.columns.widths.length - 1) {
              R += 1;
              continue;
            }
          ...
          (f.bodyElements.push(
            ...
            tr(G, s, { xPx: E, yPx: b, widthPx: h.widthPx, heightPx: h.heightPx }),
            (z[R] = C),
            (B[R] = 0),
            (V[R] = !1),
            (H[R] = !1),
      ...
      let c = 0,
        l = !1;
      for (; !l; ) {
        let u = w.columns.widths[R] ?? w.contentWidthPx,
          d = z[R] ?? L,
          h = Xn(s, u, n, w.documentGridLinePitchTwips);
        if (h.length === 0 || c >= h.length) {
          (ln(s.element, d, x), (W[R] = d), (l = !0));
          break;
        }
        let b = V[R] ?? !1,
          C = H[R] ?? !1,
          ...
          E = cn({
            ...
            currentParagraphUsesContextualSpacing: s.firstParagraphUsesContextualSpacing,
          }),
          O = T || (E && c === 0 && vr(h[0])),
          k = O && c === 0 ? 1 : c;
        if (k >= h.length) {
        ...
        let A = gr(s.element, h),
          j =
            d -
            ir({
              lineIndex: k,
              trailingSpaceAfterPx: E ? 0 : (B[R] ?? 0),
              firstParagraphSpaceBeforePx: O ? 0 : s.firstParagraphSpaceBeforePx,
            }),
          M = Yn(S, D, w, n),
          ee = Rt(
            G,
            w.columns.xPositions[R] ?? w.contentLeftPx,
            u,
            j,
            M,
        ...
        if (A && P > k && !ne) {
          let r = xr(s, N, e, t, u, n, w.documentGridLinePitchTwips);
          r !== void 0 && I + r > te + Ut && ((P = k), (I = 0), (re = !1));
        }
        if (P === k) {
          if (!ne) {
            if (R < w.columns.widths.length - 1) {
          ...
          ((I = Math.max(1, h[k]?.heightPx ?? 0)), (P = Math.min(h.length, k + 1)), (re = !1));
        }
        if (
          (f || ((f = F(!1)), (x = new Map()), (S = X())),
          f.bodyElements.push({
            kind: `text`,
            element: s.element,
            xPx: w.columns.xPositions[R] ?? w.contentLeftPx,
            yPx: j,
            widthPx: u,
            heightPx: I,
            flow: an({
          ...
          i || qr(f, S, D, h, k, P, w, t, n),
          c === 0 && (ln(s.element, j, x), (W[R] = j)),
          (z[R] = j + I),
          (c = P),
          (B[R] = 0),
          re && c < h.length)
        ...
        if (c >= h.length) {
          let e = (s.element.paragraphs?.length ?? 0) > 1 ? Ht : 0;
          ((z[R] = (z[R] ?? L) + e),
  ...
  return (f && m ? o.push(jr(f, m, o.length + 1, r)) : f && o.push(f), o);
}
var { layoutDocumentFlow: hi } = { layoutDocumentFlow: mi },
  gi = { leftEmu: 91440, rightEmu: 91440, topEmu: 45720, bottomEmu: 45720 };
F.load({
  id: ``,
  slides: [],
  theme: void 0,
...
function _i(e) {
  ...
  let n = !1,
    r = t.rows.map((e) => {
      let t = !1,
        r = e.cells.map((e) =>
          e.marginLeft === gi.leftEmu &&
          e.marginRight === gi.rightEmu &&
          e.marginTop === gi.topEmu &&
          e.marginBottom === gi.bottomEmu
            ? ((t = !0),
              {
                ...e,
                marginLeft: void 0,
...
function vi(e) {
  let t = (e.sections ?? []).map((e) => ({ ...e, elements: (e.elements ?? []).map(_i) }));
  return { ...e, sections: t, elements: t.flatMap((e) => e.elements ?? []) };
}
function yi(e) {
  return bi(e.element, { xPx: e.xPx, yPx: e.yPx, widthPx: e.widthPx, heightPx: e.heightPx });
}
function bi(e, t) {
  let n = e.bbox?.widthEmu === 0,
    r = e.bbox?.heightEmu === 0;
...
function xi(e) {
  return [e.layoutMode ?? `paged`, e.pagelessMinHeightPx ?? `default-min-height`].join(`:`);
}
function Si(e, t, n = {}) {
  return e.resolveLayoutPages((e) => {
    let r = vi(e);
    return hi(r, t, nt(r.theme), n);
  }, xi(n));
}
var Ci = `openai.document.layout/v1`,
  wi = `application/vnd.openai.document-layout+json`;
function Ti(e, t) {
  if (typeof OffscreenCanvas > `u`)
    throw Error(`OffscreenCanvas API is not available for document layout export.`);
...
function ki(e) {
  return e === void 0 ? void 0 : Oi(S(e));
}
function Ai(e) {
  return e === void 0 ? void 0 : Oi(e * h);
}
function ji(e) {
  ...
  for (let [n, r] of e.entries()) {
    let e = r.paragraphStyle,
      i = (e?.tabStops ?? []).map((e) => Ai(e.position)).filter((e) => e !== void 0),
      a = {
        index: n + 1,
        id: r.id || void 0,
        styleId: r.styleId,
        ...
        marginLeftPx: ki(r.marginLeft) ?? Ai(e?.marginLeft),
        indentPx: ki(r.indent) ?? Ai(e?.indent),
        spaceBeforeTwips: r.spaceBefore,
        spaceAfterTwips: r.spaceAfter,
        spaceBeforePx: ki(r.spaceBefore),
        spaceAfterPx: ki(r.spaceAfter),
...
function Ni(e) {
  return Ei(e.xPx, e.yPx, e.widthPx, e.heightPx);
}
function Pi(e, t) {
  return Ei(e.left - t.left, e.top - t.top, e.width, e.height);
}
function Fi(e, t, n) {
  if (!t) return;
  let r = Ni(t.contentFrame),
    i = n?.columnFrame ? Ni(n.columnFrame) : void 0;
  return {
    pageFrame: e,
    contentRelativeFrame: Pi(e, r),
    columnRelativeFrame: i ? Pi(e, i) : void 0,
  };
}
function Ii(e) {
  if (e)
...
function Li(e) {
  switch (e) {
    case c.FILL_TYPE_UNSPECIFIED:
      return `unspecified`;
    case c.FILL_TYPE_SOLID:
      return `solid`;
    case c.FILL_TYPE_GRADIENT:
      return `gradient`;
    case c.FILL_TYPE_PICTURE:
      return `picture`;
    case c.FILL_TYPE_PATTERN:
      return `pattern`;
    default:
      return `unknown`;
  }
...
function Ri(e) {
  switch (e) {
    case p.COLOR_TYPE_UNSPECIFIED:
      return `unspecified`;
    case p.COLOR_TYPE_RGB:
      return `rgb`;
    case p.COLOR_TYPE_SCHEME:
      return `scheme`;
    case p.COLOR_TYPE_SYSTEM:
      return `system`;
    default:
      return `unknown`;
  }
...
function zi(e, t) {
  ...
  return {
    type: Li(e.type),
    color: n && t ? k(n, t) : void 0,
    colorValue: n?.value,
    colorType: n?.type === void 0 ? void 0 : Ri(n.type),
    lastColor: n?.lastColor,
    transform: n?.transform,
    gradientStopCount:
      e.gradientStops && e.gradientStops.length > 0 ? e.gradientStops.length : void 0,
...
function Vi(e, t) {
  if (e)
    return {
      style: e.style === void 0 ? void 0 : Bi(e.style),
      widthPx: e.widthEmu === void 0 ? void 0 : Oi(e.widthEmu * h),
      color: e.fill?.color && t ? k(e.fill.color, t) : void 0,
      fill: zi(e.fill, t),
    };
}
function Hi(e) {
  ...
  if (t)
    return {
      ...
      columnFrame: t.columnFrame ? Ni(t.columnFrame) : void 0,
...
function Ui(e) {
  if (e.textLines && e.textLines.length > 0) {
    let t = e.textLines.map((e) => e.segments.map((e) => e.text).join(``)).join(`
`);
    if (t.length > 0) return t;
  }
  let t = (e.element.paragraphs ?? []).map((e) => (e.runs ?? []).map((e) => e.text ?? ``).join(``))
    .join(`
`);
  return t.length > 0 ? t : void 0;
}
function Wi(e, t, n, r, i, a) {
  ...
  return {
    index: t + 1,
    text: e.text,
    frame: Ei(o, i + a, e.widthPx, n.heightPx),
    font: e.font,
    fontKey: e.fontKey,
    fill: e.fill,
...
function Gi(e, t, n = 0, r = 0, i = e.topY ?? 0) {
  let a = e.segments.map((t, a) => Wi(t, a, e, n, r, i));
  return {
    index: t + 1,
    text: e.segments.map((e) => e.text).join(``),
    frame: Ei(n + (e.x ?? 0), r + i, e.widthPx, e.heightPx),
    align: e.align,
...
function Ji(e) {
  let t = new Map();
  for (let n of e.cellLayouts ?? []) t.set(qi(n.row, n.col), Ki(n.block.lines));
  return t;
}
function Yi(e) {
  let t = new Map();
  for (let n of e.cellElementFrames ?? []) {
    let e = qi(n.row, n.col),
      r = t.get(e) ?? [];
    (r.push({ elementId: n.elementId, frame: Ei(n.xPx, n.yPx, n.widthPx, n.heightPx) }),
      t.set(e, r));
  }
  return t;
}
function Xi(e) {
  if (!e) return;
  let t = {
    left: e.marginLeft === void 0 ? void 0 : Oi(e.marginLeft * h),
    right: e.marginRight === void 0 ? void 0 : Oi(e.marginRight * h),
    top: e.marginTop === void 0 ? void 0 : Oi(e.marginTop * h),
    bottom: e.marginBottom === void 0 ? void 0 : Oi(e.marginBottom * h),
  };
  return t.left !== void 0 || t.right !== void 0 || t.top !== void 0 || t.bottom !== void 0
    ? t
    : void 0;
}
function Zi(e, t, n, r) {
  if (e.kind !== `table` || !e.element.table) return;
  let i = Qe({ ...yi(e), type: d.ELEMENT_TYPE_TABLE }),
    a = P(i, t, n, {
      paragraphSpacingUnit: `twips`,
      explicitRowHeightBehavior: `atLeast`,
      autoRowMinimumHeightPx: 0,
  ...
  let o = Ji(a),
    ...
    l = a.rowHeightsPx.map((t, l) => {
      let u = a.cellRects
          .filter((e) => e.row === l)
          .map((t) => {
            let a = qi(t.row, t.col),
              c = o.get(a),
              l = s.get(a),
              u = i.table?.rows?.[t.row]?.cells?.[t.col],
              d = ji(u?.paragraphs),
              f = Ei(t.xPx, t.yPx, t.widthPx, t.heightPx);
            return {
              row: t.row + 1,
              col: t.col + 1,
              frame: f,
              coordinateHints: Fi(f, r, e.flow),
        ...
        d = { index: l + 1, frame: Ei(e.xPx, c, e.widthPx, t), cells: u };
      return ((c += t), d);
    });
  return {
    frame: Ei(e.xPx, e.yPx, e.widthPx, e.heightPx),
    height: a.heightPx,
...
function Qi(e, t, n, r, i, a, o) {
  let s = Ui(e),
    c = e.textLines ? Ki(e.textLines, e.xPx, e.yPx) : void 0,
    l = ji(e.element.paragraphs),
    u = Ei(e.xPx, e.yPx, e.widthPx, e.heightPx);
  return {
    path: n,
    order: r,
    region: t,
    ...
    frame: u,
    coordinateHints: Fi(u, i, e.flow),
    flow: Hi(e),
    bboxEmu: Mi(e.element.bbox),
    placement: Ii(e.element.placement),
    text: s,
    textLines: c,
    paragraphs: l,
    shapeType: e.element.shape?.geometry?.toString(),
    shapeFill: zi(e.element.shape?.fill, o),
    shapeLine: Vi(e.element.shape?.line, o),
    ...
    tableColumns: Math.max(0, ...(e.element.table?.rows.map((e) => e.cells.length) ?? [0])),
    tableLayout: a && o ? Zi(e, a, o, i) : void 0,
    children: (e.children ?? []).map((e, r) => Qi(e, t, `${n}.children.${r + 1}`, r + 1, i, a, o)),
  };
}
function $i(e) {
  return {
    ...
    contentFrame: Ni(e.contentFrame),
    columns: e.columns.map((e) => ({ index: e.index, frame: Ni(e.frame) })),
    documentGrid: e.documentGrid,
    mirrorMarginXOffsetPx: e.mirrorMarginXOffsetPx,
  };
}
function ea(e, t, n, r, i) {
  return e.map((e, a) => Qi(e, t, `${t}.${a + 1}`, a + 1, n, r, i));
}
function ta(e, t, n) {
  let r = e.toProto(),
    i = n ? nt(r.theme) : void 0;
  return {
    schema: Ci,
    unit: `px`,
    document: {
    ...
    pages: t.map((e, t) => ({
      ...
      frame: Ei(0, 0, e.widthPx, e.heightPx),
      layout: $i(e.layout),
      headerElements: ea(e.headerElements, `header`, e.layout, n, i),
      bodyElements: ea(e.bodyElements, `body`, e.layout, n, i),
      footerElements: ea(e.footerElements, `footer`, e.layout, n, i),
      pageNumberElement: e.pageNumberElement
        ? Qi(e.pageNumberElement, `pageNumber`, `pageNumber.1`, 1, e.layout, n, i)
        : void 0,
    })),
  };
}
function na(e) {
  let t = Ti(1, 1).getContext(`2d`);
  if (!t) throw Error(`Canvas 2D context unavailable for document layout export.`);
  return ta(e, Si(e, t), t);
}
function ra(e, t) {
  let n = t ? ta(e, t) : na(e);
  return new Blob([JSON.stringify(n, null, 2)], { type: wi });
}
var ia = class {
    #e;
    #t;
  ...
  aa = { insertion: f.REVIEW_MARK_TYPE_INSERTION, deletion: f.REVIEW_MARK_TYPE_DELETION },
  oa = class {
    #e;
    constructor(e) {
      this.#e = { ...e };
  ...
  ca = class extends H {
    type = `text`;
    constructor(e, t) {
      (super(e, { ...(t ?? {}), type: d.ELEMENT_TYPE_TEXT }),
        (this.data.type = d.ELEMENT_TYPE_TEXT));
    }
    get id() {
      return this.data.id;
    }
  ...
  la = class {
    ...
    add(e = {}) {
      let { text: t, style: n } = e,
        r;
      if ((this.#t() && this.#e.clear(), t !== void 0 && O(t))) {
        let e = V(t);
  ...
  ua = {
    ...
    "Plain Table 3": {
      ...
      tblStylePr: [
        ...
        { type: `lastRow`, rPr: { bold: !0 }, tcPr: { borders: { top: { val: `nil` } } } },
        {
          type: `firstCol`,
          rPr: { bold: !0 },
          tcPr: {
        ...
        { type: `lastCol`, rPr: { bold: !0 }, tcPr: { borders: { left: { val: `nil` } } } },
        {
          type: `band1Vert`,
          tcPr: {
            shading: {
      ...
      tblStylePr: [
        {
          ...
          tcPr: {
            ...
            shading: { val: `clear`, color: `auto`, fill: `FFFFFF`, themeFill: `background1` },
          },
        },
        {
          type: `lastRow`,
    ...
    "Grid Table 4": {
      ...
      tblStylePr: [
        {
          type: `firstRow`,
          rPr: { bold: !0, color: { val: `FFFFFF`, themeColor: `background1` } },
          tcPr: {
            borders: {
            ...
            shading: { val: `clear`, color: `auto`, fill: `000000`, themeFill: `text1` },
          },
        },
        {
          type: `lastRow`,
          ...
          tcPr: {
            borders: {
              top: { val: `double`, sz: `4`, space: `0`, color: `000000`, themeColor: `text1` },
            },
          },
        },
        { type: `firstCol`, rPr: { bold: !0 } },
    ...
    "Grid Table 5 Dark": {
      ...
      tblPr: {
        ...
        colBandSize: `1`,
        borders: {
          top: { val: `single`, sz: `4`, space: `0`, color: `FFFFFF`, themeColor: `background1` },
          left: { val: `single`, sz: `4`, space: `0`, color: `FFFFFF`, themeColor: `background1` },
          bottom: {
            val: `single`,
            sz: `4`,
            space: `0`,
          ...
          right: { val: `single`, sz: `4`, space: `0`, color: `FFFFFF`, themeColor: `background1` },
          insideH: {
            val: `single`,
            sz: `4`,
            space: `0`,
      ...
      tblStylePr: [
        {
          type: `firstRow`,
          rPr: { bold: !0, color: { val: `FFFFFF`, themeColor: `background1` } },
          tcPr: { shading: { val: `clear`, color: `auto`, fill: `000000`, themeFill: `text1` } },
        },
        {
          type: `lastRow`,
          rPr: { bold: !0 },
        ...
        { type: `neCell`, tcPr: { borders: { left: { val: `nil` }, bottom: { val: `nil` } } } },
        { type: `nwCell`, tcPr: { borders: { bottom: { val: `nil` }, right: { val: `nil` } } } },
        {
          type: `seCell`,
          tcPr: {
            borders: {
    ...
    "List Table 5 Dark": {
      ...
      tblPr: {
        ...
        colBandSize: `1`,
        borders: {
          top: { val: `single`, sz: `24`, space: `0`, color: `000000`, themeColor: `text1` },
          left: { val: `single`, sz: `24`, space: `0`, color: `000000`, themeColor: `text1` },
          bottom: { val: `single`, sz: `24`, space: `0`, color: `000000`, themeColor: `text1` },
          right: { val: `single`, sz: `24`, space: `0`, color: `000000`, themeColor: `text1` },
        },
      },
      tcPr: { shading: { val: `clear`, color: `auto`, fill: `000000`, themeFill: `text1` } },
      tblStylePr: [
        ...
        { type: `neCell`, tcPr: { borders: { left: { val: `nil` } } } },
        { type: `nwCell`, tcPr: { borders: { right: { val: `nil` } } } },
        { type: `seCell`, tcPr: { borders: { top: { val: `nil` }, left: { val: `nil` } } } },
        { type: `swCell`, tcPr: { borders: { top: { val: `nil` }, right: { val: `nil` } } } },
      ],
    },
    ...
    "List Table 7 Colorful Accent 1": {
      ...
      uiPriority: `52`,
      pPr: { spacing: { after: `0`, line: `240`, lineRule: `auto` } },
      rPr: { color: { val: `0F4761`, themeColor: `accent1`, themeShade: `BF` } },
      tblPr: { rowBandSize: `1`, colBandSize: `1` },
      tblStylePr: [
        {
          type: `firstRow`,
        ...
        },
        {
          ...
          tcPr: {
            borders: {
              top: { val: `single`, sz: `4`, space: `0`, color: `156082`, themeColor: `accent1` },
            },
            shading: { val: `clear`, color: `auto`, fill: `FFFFFF`, themeFill: `background1` },
          },
        },
        {
          ...
          tcPr: {
            borders: {
              right: { val: `single`, sz: `4`, space: `0`, color: `156082`, themeColor: `accent1` },
            },
            shading: { val: `clear`, color: `auto`, fill: `FFFFFF`, themeFill: `background1` },
          },
        },
        {
          ...
          tcPr: {
            borders: {
              left: { val: `single`, sz: `4`, space: `0`, color: `156082`, themeColor: `accent1` },
            },
            shading: { val: `clear`, color: `auto`, fill: `FFFFFF`, themeFill: `background1` },
          },
        },
  ...
  da = {
    "List Table 6 Colorful Accent 1": {
      ...
      tblPr: {
        ...
        borders: {
          top: { val: `single`, sz: `4`, space: `0`, color: `156082`, themeColor: `accent1` },
          bottom: { val: `single`, sz: `4`, space: `0`, color: `156082`, themeColor: `accent1` },
        },
      },
      tblStylePr: [
        {
        ...
        },
        {
          ...
          tcPr: {
            borders: {
              top: { val: `double`, sz: `4`, space: `0`, color: `156082`, themeColor: `accent1` },
            },
          },
        },
        { type: `firstCol`, rPr: { bold: !0 } },
    ...
    "List Table 5 Dark Accent 1": {
      ...
      tblPr: {
        ...
        colBandSize: `1`,
        borders: {
          top: { val: `single`, sz: `24`, space: `0`, color: `156082`, themeColor: `accent1` },
          left: { val: `single`, sz: `24`, space: `0`, color: `156082`, themeColor: `accent1` },
          bottom: { val: `single`, sz: `24`, space: `0`, color: `156082`, themeColor: `accent1` },
          right: { val: `single`, sz: `24`, space: `0`, color: `156082`, themeColor: `accent1` },
        },
      },
      tcPr: { shading: { val: `clear`, color: `auto`, fill: `156082`, themeFill: `accent1` } },
      tblStylePr: [
        {
          type: `firstRow`,
          rPr: { bold: !0 },
      ...
      tblStylePr: [
        {
          ...
          tcPr: {
            ...
            shading: { val: `clear`, color: `auto`, fill: `156082`, themeFill: `accent1` },
          },
        },
        {
          type: `lastRow`,
      ...
      tblStylePr: [
        {
          ...
          tcPr: {
            ...
            shading: { val: `clear`, color: `FFFFFF`, fill: `FFFFFF`, themeFill: `background1` },
          },
        },
        {
          type: `lastRow`,
  ...
  fa = {
      ...
      tblStylePr: [
        {
          ...
          tcPr: {
            borders: {
              top: { val: `single`, sz: `4`, space: `0`, color: `E97132`, themeColor: `accent2` },
              left: { val: `single`, sz: `4`, space: `0`, color: `E97132`, themeColor: `accent2` },
              bottom: {
                val: `single`,
                sz: `4`,
                space: `0`,
              ...
              right: { val: `single`, sz: `4`, space: `0`, color: `E97132`, themeColor: `accent2` },
              insideH: { val: `nil` },
              insideV: { val: `nil` },
            },
            shading: { val: `clear`, color: `E97132`, fill: `E97132`, themeFill: `accent2` },
          },
        },
        {
          type: `lastRow`,
          ...
          tcPr: {
            borders: {
              top: { val: `double`, sz: `4`, space: `0`, color: `E97132`, themeColor: `accent2` },
            },
          },
        },
        { type: `firstCol`, rPr: { bold: !0 } },
      ...
      tblStylePr: [
        {
          ...
          tcPr: {
            borders: {
              top: { val: `single`, sz: `4`, space: `0`, color: `196B24`, themeColor: `accent3` },
              left: { val: `single`, sz: `4`, space: `0`, color: `196B24`, themeColor: `accent3` },
              bottom: {
                val: `single`,
                sz: `4`,
                space: `0`,
              ...
              right: { val: `single`, sz: `4`, space: `0`, color: `196B24`, themeColor: `accent3` },
              insideH: { val: `nil` },
              insideV: { val: `nil` },
            },
            shading: { val: `clear`, color: `196B24`, fill: `196B24`, themeFill: `accent3` },
          },
        },
        {
          type: `lastRow`,
          ...
          tcPr: {
            borders: {
              top: { val: `double`, sz: `4`, space: `0`, color: `196B24`, themeColor: `accent3` },
            },
          },
        },
        { type: `firstCol`, rPr: { bold: !0 } },
      ...
      tblStylePr: [
        {
          ...
          tcPr: {
            borders: {
              top: { val: `single`, sz: `4`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
              left: { val: `single`, sz: `4`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
              bottom: {
                val: `single`,
                sz: `4`,
                space: `0`,
              ...
              right: { val: `single`, sz: `4`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
              insideH: { val: `nil` },
              insideV: { val: `nil` },
            },
            shading: { val: `clear`, color: `0F9ED5`, fill: `0F9ED5`, themeFill: `accent4` },
          },
        },
        {
          type: `lastRow`,
          ...
          tcPr: {
            borders: {
              top: { val: `double`, sz: `4`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
            },
          },
        },
        { type: `firstCol`, rPr: { bold: !0 } },
      ...
      tblStylePr: [
        {
          ...
          tcPr: {
            borders: {
              top: { val: `single`, sz: `4`, space: `0`, color: `A02B93`, themeColor: `accent5` },
              left: { val: `single`, sz: `4`, space: `0`, color: `A02B93`, themeColor: `accent5` },
              bottom: {
                val: `single`,
                sz: `4`,
                space: `0`,
              ...
              right: { val: `single`, sz: `4`, space: `0`, color: `A02B93`, themeColor: `accent5` },
              insideH: { val: `nil` },
              insideV: { val: `nil` },
            },
            shading: { val: `clear`, color: `A02B93`, fill: `A02B93`, themeFill: `accent5` },
          },
        },
        {
          type: `lastRow`,
          ...
          tcPr: {
            borders: {
              top: { val: `double`, sz: `4`, space: `0`, color: `A02B93`, themeColor: `accent5` },
            },
          },
        },
        { type: `firstCol`, rPr: { bold: !0 } },
      ...
      tblStylePr: [
        {
          ...
          tcPr: {
            borders: {
              top: { val: `single`, sz: `4`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
              left: { val: `single`, sz: `4`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
              bottom: {
                val: `single`,
                sz: `4`,
                space: `0`,
              ...
              right: { val: `single`, sz: `4`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
              insideH: { val: `nil` },
              insideV: { val: `nil` },
            },
            shading: { val: `clear`, color: `4EA72E`, fill: `4EA72E`, themeFill: `accent6` },
          },
        },
        {
          type: `lastRow`,
          ...
          tcPr: {
            borders: {
              top: { val: `double`, sz: `4`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
            },
          },
        },
        { type: `firstCol`, rPr: { bold: !0 } },
    ...
    "Grid Table 6 Colorful Accent 2": {
      ...
      uiPriority: `51`,
      pPr: { spacing: { after: `0`, line: `240`, lineRule: `auto` } },
      rPr: { color: { val: `0F4761`, themeColor: `accent2`, themeShade: `BF` } },
      tblPr: {
        rowBandSize: `1`,
        colBandSize: `1`,
        borders: {
    ...
    "Grid Table 6 Colorful Accent 3": {
      ...
      uiPriority: `51`,
      pPr: { spacing: { after: `0`, line: `240`, lineRule: `auto` } },
      rPr: { color: { val: `0F4761`, themeColor: `accent3`, themeShade: `BF` } },
      tblPr: {
        rowBandSize: `1`,
        colBandSize: `1`,
        borders: {
    ...
    "Grid Table 6 Colorful Accent 4": {
      ...
      uiPriority: `51`,
      pPr: { spacing: { after: `0`, line: `240`, lineRule: `auto` } },
      rPr: { color: { val: `0F4761`, themeColor: `accent4`, themeShade: `BF` } },
      tblPr: {
        rowBandSize: `1`,
        colBandSize: `1`,
        borders: {
    ...
    "Grid Table 6 Colorful Accent 5": {
      ...
      uiPriority: `51`,
      pPr: { spacing: { after: `0`, line: `240`, lineRule: `auto` } },
      rPr: { color: { val: `0F4761`, themeColor: `accent5`, themeShade: `BF` } },
      tblPr: {
        rowBandSize: `1`,
        colBandSize: `1`,
        borders: {
    ...
    "Grid Table 6 Colorful Accent 6": {
      ...
      uiPriority: `51`,
      pPr: { spacing: { after: `0`, line: `240`, lineRule: `auto` } },
      rPr: { color: { val: `0F4761`, themeColor: `accent6`, themeShade: `BF` } },
      tblPr: {
        rowBandSize: `1`,
        colBandSize: `1`,
        borders: {
    ...
    "List Table 3 Accent 2": {
      ...
      tblPr: {
        ...
        borders: {
          top: { val: `single`, sz: `4`, space: `0`, color: `E97132`, themeColor: `accent2` },
          left: { val: `single`, sz: `4`, space: `0`, color: `E97132`, themeColor: `accent2` },
          bottom: { val: `single`, sz: `4`, space: `0`, color: `E97132`, themeColor: `accent2` },
          right: { val: `single`, sz: `4`, space: `0`, color: `E97132`, themeColor: `accent2` },
        },
      },
      tblStylePr: [
    ...
    "List Table 3 Accent 3": {
      ...
      tblPr: {
        ...
        borders: {
          top: { val: `single`, sz: `4`, space: `0`, color: `196B24`, themeColor: `accent3` },
          left: { val: `single`, sz: `4`, space: `0`, color: `196B24`, themeColor: `accent3` },
          bottom: { val: `single`, sz: `4`, space: `0`, color: `196B24`, themeColor: `accent3` },
          right: { val: `single`, sz: `4`, space: `0`, color: `196B24`, themeColor: `accent3` },
        },
      },
      tblStylePr: [
    ...
    "List Table 3 Accent 4": {
      ...
      tblPr: {
        ...
        borders: {
          top: { val: `single`, sz: `4`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
          left: { val: `single`, sz: `4`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
          bottom: { val: `single`, sz: `4`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
          right: { val: `single`, sz: `4`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
        },
      },
      tblStylePr: [
    ...
    "List Table 3 Accent 5": {
      ...
      tblPr: {
        ...
        borders: {
          top: { val: `single`, sz: `4`, space: `0`, color: `A02B93`, themeColor: `accent5` },
          left: { val: `single`, sz: `4`, space: `0`, color: `A02B93`, themeColor: `accent5` },
          bottom: { val: `single`, sz: `4`, space: `0`, color: `A02B93`, themeColor: `accent5` },
          right: { val: `single`, sz: `4`, space: `0`, color: `A02B93`, themeColor: `accent5` },
        },
      },
      tblStylePr: [
    ...
    "List Table 3 Accent 6": {
      ...
      tblPr: {
        ...
        borders: {
          top: { val: `single`, sz: `4`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
          left: { val: `single`, sz: `4`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
          bottom: { val: `single`, sz: `4`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
          right: { val: `single`, sz: `4`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
        },
      },
      tblStylePr: [
  ...
  ma = {
    "List Table 5 Dark Accent 2": {
      ...
      tblPr: {
        ...
        colBandSize: `1`,
        borders: {
          top: { val: `single`, sz: `24`, space: `0`, color: `E97132`, themeColor: `accent2` },
          left: { val: `single`, sz: `24`, space: `0`, color: `E97132`, themeColor: `accent2` },
          bottom: { val: `single`, sz: `24`, space: `0`, color: `E97132`, themeColor: `accent2` },
          right: { val: `single`, sz: `24`, space: `0`, color: `E97132`, themeColor: `accent2` },
        },
      },
      tcPr: { shading: { val: `clear`, color: `E97132`, fill: `E97132`, themeFill: `accent2` } },
      tblStylePr: [
        {
          type: `firstRow`,
          rPr: { bold: !0 },
    ...
    "List Table 5 Dark Accent 3": {
      ...
      tblPr: {
        ...
        colBandSize: `1`,
        borders: {
          top: { val: `single`, sz: `24`, space: `0`, color: `196B24`, themeColor: `accent3` },
          left: { val: `single`, sz: `24`, space: `0`, color: `196B24`, themeColor: `accent3` },
          bottom: { val: `single`, sz: `24`, space: `0`, color: `196B24`, themeColor: `accent3` },
          right: { val: `single`, sz: `24`, space: `0`, color: `196B24`, themeColor: `accent3` },
        },
      },
      tcPr: { shading: { val: `clear`, color: `196B24`, fill: `196B24`, themeFill: `accent3` } },
      tblStylePr: [
        {
          type: `firstRow`,
          rPr: { bold: !0 },
    ...
    "List Table 5 Dark Accent 4": {
      ...
      tblPr: {
        ...
        colBandSize: `1`,
        borders: {
          top: { val: `single`, sz: `24`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
          left: { val: `single`, sz: `24`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
          bottom: { val: `single`, sz: `24`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
          right: { val: `single`, sz: `24`, space: `0`, color: `0F9ED5`, themeColor: `accent4` },
        },
      },
      tcPr: { shading: { val: `clear`, color: `0F9ED5`, fill: `0F9ED5`, themeFill: `accent4` } },
      tblStylePr: [
        {
          type: `firstRow`,
          rPr: { bold: !0 },
    ...
    "List Table 5 Dark Accent 5": {
      ...
      tblPr: {
        ...
        colBandSize: `1`,
        borders: {
          top: { val: `single`, sz: `24`, space: `0`, color: `A02B93`, themeColor: `accent5` },
          left: { val: `single`, sz: `24`, space: `0`, color: `A02B93`, themeColor: `accent5` },
          bottom: { val: `single`, sz: `24`, space: `0`, color: `A02B93`, themeColor: `accent5` },
          right: { val: `single`, sz: `24`, space: `0`, color: `A02B93`, themeColor: `accent5` },
        },
      },
      tcPr: { shading: { val: `clear`, color: `A02B93`, fill: `A02B93`, themeFill: `accent5` } },
      tblStylePr: [
        {
          type: `firstRow`,
          rPr: { bold: !0 },
    ...
    "List Table 5 Dark Accent 6": {
      ...
      tblPr: {
        ...
        colBandSize: `1`,
        borders: {
          top: { val: `single`, sz: `24`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
          left: { val: `single`, sz: `24`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
          bottom: { val: `single`, sz: `24`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
          right: { val: `single`, sz: `24`, space: `0`, color: `4EA72E`, themeColor: `accent6` },
        },
      },
      tcPr: { shading: { val: `clear`, color: `4EA72E`, fill: `4EA72E`, themeFill: `accent6` } },
      tblStylePr: [
        {
          type: `firstRow`,
          rPr: { bold: !0 },
  ...
  va = { tableStyleLight1: `TableStyleLight1` },
  ya = { TableStyleLight1: va.tableStyleLight1, "Table Style Light 1": va.tableStyleLight1 },
  ba = { color: `#111111`, width: 0.35, style: `solid` },
  xa = { left: 7.2, right: 7.2, top: 2.4, bottom: 2.4 };
function Sa(e) {
  if (e) return ya[e];
}
function Ca(e) {
  if (e) return Ta(e) ? e : Ea(e) ? _a[e] : void 0;
}
function wa() {
  return ha.map((e) => Da(ga[e]));
}
function Ta(e) {
  return Object.prototype.hasOwnProperty.call(ga, e);
}
function Ea(e) {
  return Object.prototype.hasOwnProperty.call(_a, e);
}
function Da(e) {
  return {
    id: e.styleId,
...
function ka(e) {
  switch (e) {
    case `wholeTable`:
      return u.CONDITION_WHOLE_TABLE;
    case `firstRow`:
      return u.CONDITION_FIRST_ROW;
    case `lastRow`:
      return u.CONDITION_LAST_ROW;
    case `firstCol`:
      return u.CONDITION_FIRST_COLUMN;
    case `lastCol`:
      return u.CONDITION_LAST_COLUMN;
    case `band1Horz`:
      return u.CONDITION_BANDED_ROW_ODD;
    case `band2Horz`:
      return u.CONDITION_BANDED_ROW_EVEN;
    case `band1Vert`:
      return u.CONDITION_BANDED_COLUMN_ODD;
    case `band2Vert`:
      return u.CONDITION_BANDED_COLUMN_EVEN;
    case `nwCell`:
      return u.CONDITION_TOP_LEFT_CELL;
    case `neCell`:
      return u.CONDITION_TOP_RIGHT_CELL;
    case `swCell`:
      return u.CONDITION_BOTTOM_LEFT_CELL;
    case `seCell`:
      return u.CONDITION_BOTTOM_RIGHT_CELL;
    default:
      return;
  }
}
...
function Ia(e) {
  let t = Ja(e);
  return t ? new j({ type: `solid`, color: t }).toProto() : void 0;
}
function La(e) {
  let t = Xa(e);
  return t ? new j({ type: `solid`, color: t }).toProto() : void 0;
...
function Ra(e) {
  ...
  let t = {
    ...
    bottom: Ua(e.bottom),
    left: Ua(e.left),
    diagonalDown: Ua(e.tl2br),
    diagonalUp: Ua(e.tr2bl),
  };
  if (
    !(
      t.top === void 0 &&
...
function Ua(e) {
  if (!(!e || e.val === `nil`))
    return ee({ color: Ya(e), width: Wa(e), style: `solid` })?.toProto();
}
function Wa(e) {
  let t = Number(e.sz);
...
function Ga(e) {
  if (!e) return;
  let t = { left: Ka(e.left), right: Ka(e.right), top: Ka(e.top), bottom: Ka(e.bottom) };
  if (!(t.left === void 0 && t.right === void 0 && t.top === void 0 && t.bottom === void 0))
    return t;
}
function Ka(e) {
  if (!(!e || e.type !== `dxa`)) return qa(e.w);
}
function qa(e) {
  if (e === void 0) return;
  let t = Number(e);
...
function Xa(e) {
  ...
  let t = Za(e.themeColor),
    n = Qa(e),
    r = e.color ?? e.val;
  return t
    ? { type: `proto`, proto: { type: p.COLOR_TYPE_SCHEME, value: t, transform: n, lastColor: r } }
    : r
      ? `#${r}`
      : void 0;
}
...
function eo(e) {
  ...
  let t = e.styleOptions,
    n = e.cells.block({ row: 0, column: 0, rowCount: e.rowCount, columnCount: e.columnCount });
  (n.forEachCell((e) => {
    e.margins = xa;
  }),
    (n.borders = { top: ba, bottom: ba, insideHorizontal: ba }),
...
function to(e, t) {
  ...
  let n = e.cells.block({ row: 0, column: 0, rowCount: 1, columnCount: e.columnCount });
  ((n.textStyle.bold = !0), (n.borders = { bottom: ba }));
}
function no(e, t) {
  ...
  ((n.textStyle.bold = !0), (n.borders = { top: ba }));
}
function ro(e, t) {
  (t.firstColumn &&
    (e.cells.block({ row: 0, column: 0, rowCount: e.rowCount, columnCount: 1 }).textStyle.bold =
      !0),
    t.lastColumn &&
      (e.cells.block({
        row: 0,
...
function ao(e, t) {
  ...
  for (let t = n; t <= r; t += 1)
    (t - n) % 2 == 0 &&
      (e.cells.block({ row: 0, column: t, rowCount: e.rowCount, columnCount: 1 }).fill = `#D9D9D9`);
}
function oo(e) {
...
function co(e, t = {}) {
  let n = { left: oo(e.left), top: oo(e.top), width: so(e.width), height: so(e.height) };
  return (t.inline && ((n.left = void 0), (n.top = void 0)), n);
}
function lo(e, t, n) {
  let r = fo(t, n);
  if (!(!e && !po(r)))
    return { type: i.ELEMENT_PLACEMENT_TYPE_INLINE, horizontalAlignment: e, ...r };
}
function uo(e, t, n) {
  if (e?.wrap === `inline`) return lo(e.alignment, e, n);
  let r = t.left !== void 0 || t.top !== void 0,
    a = n?.spaceBefore !== void 0 || n?.spaceAfter !== void 0;
  if (!e?.wrap && !r) return a ? lo(void 0, e, n) : void 0;
  let o = mo(e, n),
    s = ho(e, n);
  return {
    type: i.ELEMENT_PLACEMENT_TYPE_ANCHORED,
    anchorParagraphId: e?.anchorParagraphId,
    horizontalRelativeFrom: e?.horizontalRelativeFrom ?? `page`,
    verticalRelativeFrom: e?.verticalRelativeFrom ?? `page`,
    xOffsetEmu: t.left === void 0 ? void 0 : y(t.left),
    yOffsetEmu: t.top === void 0 ? void 0 : y(t.top),
    horizontalAlignment:
      t.left === void 0 ? (e?.horizontalAlignment ?? e?.alignment) : e?.horizontalAlignment,
    verticalAlignment: e?.verticalAlignment,
    wrap: { type: go(e?.wrap), side: e?.wrapSide },
    distanceTopEmu: o === void 0 ? void 0 : y(o),
    distanceBottomEmu: s === void 0 ? void 0 : y(s),
    distanceLeftEmu: e?.distanceLeft === void 0 ? void 0 : y(e.distanceLeft),
    distanceRightEmu: e?.distanceRight === void 0 ? void 0 : y(e.distanceRight),
    behindDocument: e?.behindDocument,
    layoutInCell: e?.layoutInCell,
    allowOverlap: e?.allowOverlap,
    relativeHeight: e?.relativeHeight,
...
function fo(e, t) {
  let n = mo(e, t),
    r = ho(e, t);
  return {
    distanceTopEmu: n === void 0 ? void 0 : y(n),
    distanceBottomEmu: r === void 0 ? void 0 : y(r),
    distanceLeftEmu: e?.distanceLeft === void 0 ? void 0 : y(e.distanceLeft),
    distanceRightEmu: e?.distanceRight === void 0 ? void 0 : y(e.distanceRight),
  };
}
...
var _o = {
  ...
  vo = 7.68,
  yo = { left: vo, right: vo, top: vo, bottom: vo };
function bo(e) {
...
var So = class {
    ...
    add(e) {
      if (Array.isArray(e)) {
        let t = this.#e.add(e);
        return ((t.cellMargins = yo), t);
      }
      let { position: t, style: n, columnWidths: r, cellMargins: i, keepTogether: a, ...o } = e,
        s = co({ left: t?.left, top: t?.top, width: t?.width, height: t?.height }),
        c = s.left !== void 0 || s.top !== void 0 || s.width !== void 0 || s.height !== void 0,
        l = {
          ...o,
        ...
        u = this.#e.add(l);
      ((u.cellMargins = i ?? yo), (u.keepTogether = a), (u.placement = uo(void 0, s)));
      ...
      if (d) {
        let { preset: e, ...t } = d,
          n = Sa(e),
          r = Ca(e);
        (n ? (u.styleId = n) : r ? (u.styleId = Oa(r)) : e && (u.styleId = e),
          (u.styleOptions = { ..._o, ...bo(u.styleOptions), ...bo(t) }));
      }
      xo(f) &&
        u.rowCount > 0 &&
        u.columnCount > 0 &&
        u.cells
          .block({ row: 0, column: 0, rowCount: u.rowCount, columnCount: u.columnCount })
          .applyBorders({
            outside: { color: `#000000`, width: 1, style: `solid` },
            inside: { color: `#000000`, width: 1, style: `solid` },
          });
      let p = Sa(f);
      return (p && $a(u, p), r !== void 0 && (u.columnWidths = r), u);
    }
  },
  Co = class {
    #e;
    ...
    add(e) {
      let t = wo(e),
        ...
        r = this.#e.add(n);
      return (
        (r.placement = uo(e.style, t, { spaceBefore: e.spaceBefore, spaceAfter: e.spaceAfter })), r
      );
    }
  };
function wo(e) {
  let t = e.size,
    n = e.position ?? {};
  return co(
    { left: n.left, top: n.top, width: n.width ?? t?.width, height: n.height ?? t?.height },
...
function To(e, t) {
  ...
  return `blob` in e
    ? { ...n, blob: Eo(e.blob), contentType: e.contentType }
    : `path` in e
      ? { ...n, path: e.path }
      : `dataUrl` in e
        ? { ...n, dataUrl: e.dataUrl }
...
function Eo(e) {
  ...
  let t = e.buffer;
  if (t instanceof ArrayBuffer && e.byteOffset === 0 && e.byteLength === t.byteLength) return t;
...
var Do = class {
  ...
  add(e) {
    ...
    return (
      ...
      (n.placement = uo(e.style, t, { spaceBefore: e.spaceBefore, spaceAfter: e.spaceAfter })),
      n
    );
  }
};
function Oo(e) {
  let t = e.size,
    n = e.position ?? {},
    r = { left: n.left, top: n.top, width: n.width ?? t?.width, height: n.height ?? t?.height };
  return (e.style?.wrap === `inline` && ((r.left = void 0), (r.top = void 0)), r);
}
var ko = class {
  #e;
  constructor(e) {
  ...
  add(e) {
    let t = Ao(e),
      n = this.#e.add(e.chartType, { ...e.config, series: No(e.config?.series), position: t });
...
var jo = [
    { type: `solid`, color: { type: `theme`, value: `accent1`, transform: { lighten: 0.8 } } },
    { type: `solid`, color: { type: `theme`, value: `accent1`, transform: { lighten: 0.6 } } },
    { type: `solid`, color: { type: `theme`, value: `accent1`, transform: { lighten: 0.4 } } },
    { type: `solid`, color: { type: `theme`, value: `accent1`, transform: { darken: 0.1 } } },
    { type: `solid`, color: { type: `theme`, value: `accent1`, transform: { darken: 0.25 } } },
    { type: `solid`, color: { type: `theme`, value: `accent1`, transform: { darken: 0.5 } } },
  ],
  Mo = [
    {
      style: `solid`,
  ...
  if (e)
    return e.map((e, t) =>
      e.fill || e.line || e.stroke
        ? { ...e }
        : { ...e, fill: jo[t % jo.length], line: Mo[t % Mo.length] },
    );
}
...
function Fo(e, t) {
  ...
  return n === void 0 ? t : v({ alignment: n }, t);
}
var Io = class {
    #e;
    constructor(e = []) {
  ...
  Lo = class e {
    ...
    constructor(e) {
      ...
      ((this.#i = new ca(this.#e, t)), this.#h(this.#i));
      let r = new re(this.#e, []),
        i = new B(this.#e, []),
        a = new ae(this.#e, []),
        o = new te(this.#e, []);
      ((this.#c = new Do(r)),
        ...
        (this.#o = new So(a)),
        (this.#l = new ko(o)),
        (this.#a = new la(this.#i.paragraphs)));
    ...
    get textElements() {
      return this.#n.map((e) => this.#r.get(e)).filter((e) => e instanceof ca);
    }
    getElementById(e) {
    ...
    resolveTextBlock(e) {
      ...
      if (t) {
        ...
        return e instanceof z ? (e.getCellById(t.cellId)?.text ?? null) : null;
      }
      let n = this.getElementById(e);
      return n && (n instanceof ca || `text` in n) ? n.text : null;
    }
    set text(e) {
      this.#i.text.set(e);
    }
    ...
    startParagraphBlock(e = !1) {
      if (!e && this.#n.length === 1 && this.#n[0] === this.#i.id) return this.#a;
      let t = new ca(this.#e);
      return (this.#g(t), new la(t.paragraphs));
    }
    get tables() {
      return this.#o;
    }
    ...
    addGroup(e) {
      let t = co(
        ...
        n = new Po(this.#e, {
          id: e.id,
          name: e.name ?? ``,
          type: d.ELEMENT_TYPE_GROUP,
          children: e.children,
          bbox: {
            xEmu: t.left === void 0 ? void 0 : y(t.left),
            yEmu: t.top === void 0 ? void 0 : y(t.top),
            widthEmu: t.width === void 0 ? void 0 : y(t.width),
            heightEmu: t.height === void 0 ? void 0 : y(t.height),
          },
        });
      return (
        (n.placement = uo(e.style, t, { spaceBefore: e.spaceBefore, spaceAfter: e.spaceAfter })),
    ...
    toProto() {
      return this.#n
        .map((e) => this.#r.get(e))
        .filter((e) => !!e)
        .map((e) => (e instanceof ca, e.toProto()));
    }
    #d() {
      return {
        stub: () => {},
        ...
        getResolvedParagraphTextStyle: (e, t) => {
          let n = this.#m().resolveParagraphTextStyle(e.toProto(), t?.toProto());
          return n ? new A(n) : void 0;
        },
        getResolvedParagraphStyle: (e) => this.#m().resolveParagraphStyle(e.toProto()),
        getResolvedRunTextStyle: (e, t, n) => {
          let r = this.#m().resolveRunTextStyle(e.toProto(), t.toProto(), n?.toProto());
    ...
    #m() {
      return new Io(this.#u.readTextStyleDefinitions());
    }
    #h(e) {
      (this.#u.registerElementId(e.id), this.#r.set(e.id, e), (this.#n = [e.id]));
    }
    #g(e, t) {
      let n = e.id;
      if (!n) return;
    ...
    #v(e) {
      let t = e.findIndex(
        (e) => e.type === d.ELEMENT_TYPE_TEXT || e.type === d.ELEMENT_TYPE_TEXT_GROUP,
      );
      return t >= 0
    ...
    #y(e, t, n, r, i) {
      if (e.type === d.ELEMENT_TYPE_TEXT || e.type === d.ELEMENT_TYPE_TEXT_GROUP) {
        let t = new ca(this.#e, e);
        this.#g(t);
        return;
      }
      if (e.type === d.ELEMENT_TYPE_TABLE || e.table) {
        r.add({ proto: e });
        return;
      }
      if (
      ...
      if (e.type === d.ELEMENT_TYPE_SHAPE || e.shape !== void 0) {
        t.add({ proto: e });
        return;
      }
      (e.type === d.ELEMENT_TYPE_GROUP || (e.children?.length ?? 0) > 0) &&
        this.#g(new Po(this.#e, e));
    }
  };
function Ro(e) {
  if (!e) return;
  let t = e.pageNumbers ? { ...e.pageNumbers } : void 0;
  return { ...e, pageMargin: e.pageMargin ? { ...e.pageMargin } : void 0, pageNumbers: t };
}
function zo(e) {
...
function Ho(e) {
  for (let t of e)
    if (t && (!(t.type === d.ELEMENT_TYPE_TEXT || t.type === d.ELEMENT_TYPE_TEXT_GROUP) || Vo(t)))
      return !0;
  return !1;
}
var Uo = class {
    ...
    constructor(e) {
      ...
      ((this.#m = e.context),
        ...
        (this.#t = t?.breakType ?? oe.SECTION_BREAK_TYPE_UNSPECIFIED),
        (this.#n = Ro(t?.pageSetup)),
        (this.#r = zo(t?.columns)),
        (this.#h = t?.startsWithPageBreak ?? !1),
        (this.#g = t?.pageNumberStart),
        (this.#_ = t?.pageNumberFormat),
        (this.#v = Bo(t?.documentGrid)),
        (this.#p = t?.differentFirstPage ?? !1),
        (this.#i = new Lo({
          elements: t?.elements ?? e.fallbackElements ?? [],
          context: e.context,
        })),
        (this.#a = new Lo({ elements: t?.header?.elements ?? [], context: e.context })),
        (this.#o = new Lo({ elements: t?.footer?.elements ?? [], context: e.context })),
        (this.#s = new Lo({ elements: t?.firstHeader?.elements ?? [], context: e.context })),
        (this.#c = new Lo({ elements: t?.firstFooter?.elements ?? [], context: e.context })),
        (this.#l = !!t?.header),
        (this.#u = !!t?.footer),
    ...
    get pageSetup() {
      return this.#n ? Ro(this.#n) : void 0;
    }
    set pageSetup(e) {
      ((this.#n = Ro(e)), this.#m.invalidateLayout());
    }
    get columns() {
      return this.#r ? zo(this.#r) : void 0;
    }
    set columns(e) {
      ((this.#r = zo(e)), this.#m.invalidateLayout());
    }
    get header() {
    ...
    set documentGrid(e) {
      ((this.#v = Bo(e)), this.#m.invalidateLayout());
    }
    clearHeader() {
    ...
    toProto() {
      let e = {
          ...
          firstHeader: void 0,
          firstFooter: void 0,
          documentGrid: Bo(this.#v),
        },
        t = this.#a.toProto();
      this.#l && Ho(t) && (e.header = this.#y(t));
      let n = this.#o.toProto();
      this.#u && Ho(n) && (e.footer = this.#y(n));
      let r = this.#s.toProto();
      this.#d && Ho(r) && (e.firstHeader = this.#y(r));
      let i = this.#c.toProto();
      return (this.#f && Ho(i) && (e.firstFooter = this.#y(i)), e);
    }
    #y(e) {
      return { elements: e };
    }
  ...
  Wo = class {
    ...
    constructor(e) {
      ...
      (t.length > 0
        ? (this.#e = t.map(
            (e, t) => new Uo({ section: e, context: this.#n, defaultId: `doc-section-${t + 1}` }),
          ))
        : (this.#e = [
            new Uo({
    ...
    add(e = {}) {
      let t = {
          id: e.id || this.#r(),
          breakType: e.breakType ?? oe.SECTION_BREAK_TYPE_UNSPECIFIED,
        ...
        n = new Uo({ section: t, context: this.#n, defaultId: t.id });
...
var Ko = class {
    ...
    toProto() {
      return Go(this.#e) ? void 0 : K(this.#e);
    }
  },
  qo = class {
    #e;
    ...
    get backgroundFill() {
      return ((this.#r ||= new j({ type: `proto`, proto: this.#e.backgroundFill })), this.#r);
    }
    set backgroundFill(e) {
      ((this.#r = e === void 0 ? void 0 : new j(e)),
    ...
    get footnoteProperties() {
      return ((this.#t ||= new Ko(this.#e.footnoteProperties, this.#i)), this.#t);
    }
    get endnoteProperties() {
      return ((this.#n ||= new Ko(this.#e.endnoteProperties, this.#i)), this.#n);
    }
...
function Yo(e) {
  return {
    ...
    conditionalStyles: (e.conditionalStyles ?? []).map((e) => ({
      ...e,
      style: e.style ? { ...e.style, paragraphStyle: Jo(e.style.paragraphStyle) } : void 0,
    })),
  };
}
var Xo = class {
  ...
  #t;
  constructor(e = [], t = {}) {
    ((this.#e = K(e).map(Yo)), (this.#t = t.onMutated));
  }
  get items() {
    return K(this.#e).map(Yo);
  }
  getById(e) {
    if (!e) return;
    let t = this.#e.find((t) => t.id === e);
    return t ? Yo(K(t)) : void 0;
  }
  getByName(e) {
    if (!e) return;
    let t = this.#e.find((t) => t.name === e);
  ...
  set(e) {
    ...
    return (n >= 0 ? (this.#e[n] = t) : this.#e.push(t), this.#t?.(), Yo(K(t)));
  }
  addOfficeWordDefaults() {
    ...
    return ((this.#e = t), this.#t?.(), K(e).map(Yo));
  }
  delete(e) {
...
function Qo(e) {
  return { ...e, paragraphStyle: Zo(e.paragraphStyle) };
}
var $o = class {
    #e;
    #t;
    constructor(e = [], t = {}) {
      ((this.#e = K(e).map(Qo)), (this.#t = t.onMutated));
    }
    get items() {
      return K(this.#e).map(Qo);
    }
    getById(e) {
      if (!e) return;
      let t = this.#e.find((t) => t.id === e);
      return t ? Qo(K(t)) : void 0;
    }
    getByName(e) {
      if (!e) return;
      let t = this.#e.find((t) => t.name === e);
    ...
    set(e) {
      let t = Qo(K(e)),
        n = this.#e.findIndex((e) => e.id === t.id || e.name === t.name);
      return (n >= 0 ? (this.#e[n] = t) : this.#e.push(t), this.#t?.(), Qo(K(t)));
    }
    delete(e) {
      let t = this.#e.findIndex((t) => t.id === e || t.name === e);
      return t < 0 ? !1 : (this.#e.splice(t, 1), this.#t?.(), !0);
...
function ts(e) {
  let t = e.buffer;
  if (t instanceof ArrayBuffer && e.byteOffset === 0 && e.byteLength === t.byteLength)
...
function ns(e, t) {
  if (Array.isArray(e)) {
    for (let n of e) ns(n, t);
    return;
  }
  if (typeof e != `object` || !e) return;
  let n = e;
  if (n.type === p.COLOR_TYPE_SCHEME && typeof n.value == `string` && n.lastColor === void 0) {
    let e = t[n.value] ?? Te[n.value];
    e !== void 0 && (n.lastColor = e.replace(/^#/, ``));
  }
  for (let e of Object.values(n)) ns(e, t);
}
var rs = class e {
    #e;
    #t;
    ...
    constructor(e) {
      ...
      ((this.#e = {
        ...
        (this.#t = new Be()),
        (this.charts = new R({ stub: () => {} }, e.charts ?? [])),
        (this.images = new ne({ stub: () => {} }, e.images ?? [])),
        (this.textStyles = new $o(e.textStyles ?? [], {
          onMutated: () => this.invalidateLayoutCache(),
        })),
        (this.tableStyleDefinitions = new Xo(e.tableStyleDefinitions ?? [], {
          onMutated: () => this.invalidateLayoutCache(),
        })),
        (this.fonts = new Ue(e.fonts ?? [], { onMutated: () => this.invalidateLayoutCache() })),
        (this.settings = new qo(e.settings, { onMutated: () => this.invalidateLayoutCache() })),
        (this.theme = new es(e.theme, { onMutated: () => this.invalidateLayoutCache() })),
        (this.commentContents = new Fe(e.comments ?? [], {
          onMutated: () => this.invalidateLayoutCache(),
        })),
        (this.commentReferences = new Ie(e.commentReferences ?? [], {
          onMutated: () => this.invalidateLayoutCache(),
        })),
        (this.#r = {
          charts: this.charts,
        ...
        (this.sections = new Wo({
          sections: e.sections ?? [],
          fallbackElements: e.elements ?? [],
          context: this.#r,
        })),
        (this.numbering = new ia(e.numberingDefinitions ?? [], e.paragraphNumberings ?? [])));
      ...
      (r?.widthEmu && (this.#e.widthEmu = r.widthEmu),
        ...
        (this.citations = new Ce(t.contentReferences ?? [])),
        (this.footnotes = new Ge({
        ...
        (this.revisions = new sa(e.reviewMarks ?? [])));
    }
    static create() {
      return new e(Pe());
    }
    ...
    toProto() {
      ...
      return (
        ...
        ns(a, this.theme.hexColorMap),
        a
      );
    }
    toDocumentBytes() {
      return ts(U.encode(this.toProto()).finish());
    }
    save() {}
    export(e = { format: `layout` }) {
      let t = e.format ?? `layout`;
      if (t === `layout`) return Promise.resolve(ra(this));
...
function is({
  ...
  return (0, $.jsxs)(`div`, {
    className: r(`bg-token-bg-primary text-token-text-primary flex h-full min-h-0 flex-col`, n),
    children: [
      i ??
        (0, $.jsxs)(`header`, {
          ...
          children: [
            (0, $.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, $.jsx)(`div`, { className: `truncate text-sm font-semibold`, children: t }),
              ],
            }),
            a
              ? (0, $.jsx)(`div`, {
      ...
      (0, $.jsxs)(`div`, {
        ...
        children: [
          o
            ...
            : null,
          (0, $.jsx)(`div`, { className: `min-h-0 min-w-0 flex-1`, children: c }),
        ],
      }),
      s
        ? (0, $.jsx)(`footer`, {
  ...
  return (
    (0, Q.useEffect)(() => {
      ...
      let r = () => {
        ...
        n({ width: Math.max(0, Math.round(e.width)), height: Math.max(0, Math.round(e.height)) });
      };
      r();
...
var cs = {
  ...
  ls = { count: 1, space: 360, widths: [], hasSeparatorLine: !1 },
  us = { count: 2, space: 360, widths: [], hasSeparatorLine: !1 };
function ds() {
  return xe().map((e) => ({
    text: `${fs(e.artifact)} / ${e.area}: ${e.feature}. ${e.summary}`,
    style: { bulletCharacter: `•`, marginLeft: 720, indent: 360, spaceAfter: 120 },
  }));
}
function fs(e) {
...
function ps() {
  ...
  ((t.pageSetup = cs),
    ...
    e.body.shapes.add({
      ...
      line: { style: `solid`, fill: { type: `solid`, color: `#38BDF8` }, width: 1 },
    ...
    (e.body.text.get(`Feature highlights across the engine:`).style = `heading1`));
  for (let t of ds()) e.body.paragraphs.add(t);
  ...
  let n = e.sections.add({ pageSetup: cs, columns: us });
  ...
  for (let e of xe())
    (n.body.paragraphs.add({
      text: `${fs(e.artifact)} / ${e.area}`,
      style: { spaceBefore: 120, spaceAfter: 60 },
    }),
      (n.body.text.get(`${fs(e.artifact)} / ${e.area}`).style = `heading2`),
      n.body.paragraphs.add({
        text: `${e.feature}: ${e.summary}`,
        style: { bulletCharacter: `•`, marginLeft: 720, indent: 360, spaceAfter: 120 },
      }));
  let r = e.sections.add({ pageSetup: cs, columns: ls });
  return (
    ...
    (r.body.text.get(`Embedded content and pagination coverage`).style = `heading1`),
    r.body.tables.add({
      rows: 4,
      columns: 3,
      values: [
        ...
        [`Search`, `Find over long note sequences`, `Keeps human UI and agent inspection aligned.`],
      ],
      style: { preset: `TableGrid`, headerRow: !0 },
...
function ms() {
  return new Worker(
    new URL(`` + new URL(`runtime.worker.js`, import.meta.url).href, `` + import.meta.url),
...
function vs(e) {
  return e.documentProto ? e.documentProto : e.document ? e.document.toProto() : ps().toProto();
}
function ys() {
  return ms();
}
var bs = 1,
  xs = class {
    ...
    constructor(e = {}) {
      ...
      (this.#n.bootstrap({
        ...
        (this.#r = ss()
          .then(() => {
            let e = le();
            (this.#e.debug(`font-render-deps-ready`, { fontCount: e.length, fontDebug: he() }),
              e.length !== 0 && this.#n.dispatch({ kind: `install-font-faces`, fonts: e }));
          })
          .catch(() => {})));
    }
    subscribe(e) {
    ...
    attachPageCanvas(e) {
      ...
      if (
        ((e.canvas.style.width = `${e.width}px`), (e.canvas.style.height = `${e.height}px`), !_s())
      )
        return (
    ...
    detachPageCanvas(e) {
      ...
      let t = window.setTimeout(() => {
        (this.#o.delete(e),
          this.#a.delete(e),
          !this.#l && this.#n.dispatch({ kind: `detach-page-canvas`, surfaceId: e }));
      }, 0);
      this.#o.set(e, t);
    }
    ...
    requestExport(e) {
      return this.#n.request({ kind: `export`, format: e?.format ?? `proto` }).then((e) => {
        if (e.kind !== `export`) throw Error(`Unexpected export response: ${e.kind}`);
        return e.result;
      });
    }
    exportDocumentProto() {
      return this.requestExport({ format: `proto` }).then((e) => e.documentProto);
    }
    replaceFromProto(e) {
      return this.#n.request({ kind: `replace-from-proto`, documentProto: e }).then((e) => {
    ...
    setPageIndex(e, t) {
      this.#n.dispatch({ kind: `set-page-index`, pageIndex: e, origin: t?.origin });
    }
    goToPreviousPage() {
      this.setPageIndex(this.getSnapshot().pageIndex - 1, { origin: `navigation` });
    }
    goToNextPage() {
      this.setPageIndex(this.getSnapshot().pageIndex + 1, { origin: `navigation` });
    }
    setSelectedTextBlockId(e, t) {
      this.#n.dispatch({ kind: `select-text-block`, blockId: e, pageIndex: t?.pageIndex });
    }
    setSelectedObject(e) {
    ...
    textSelectWordAtPoint(e, t) {
      return (this.#n.dispatch({ kind: `text-select-word-at-point`, pageIndex: e, point: t }), !0);
    }
    textSelectParagraphAtPoint(e, t) {
      return (
        this.#n.dispatch({ kind: `text-select-paragraph-at-point`, pageIndex: e, point: t }), !0
      );
    }
    textActivateBlockEnd(e) {
      return (this.#n.dispatch({ kind: `text-activate-block-end`, blockId: e }), !0);
    }
    textClear() {
    ...
    #f(e) {
      switch (e.kind) {
        ...
        case `layout`:
          ((this.#c = e.metadata),
            this.#t.patch({ pageCount: e.pageLayouts.length, pageLayouts: e.pageLayouts }));
          return;
        case `rendered-pages`:
          ((this.#s = e.pages), this.#u());
          return;
        case `debug-log`:
          fe(e.namespace).debug(e.message, e.details);
          return;
        default:
          return e;
      }
...
function Es(e) {
  ...
  return (
    ...
    () => {
      t.__POPCORN_DOCUMENT_DEVTOOLS__ === n && delete t.__POPCORN_DOCUMENT_DEVTOOLS__;
    }
  );
}
function Ds(e, t) {
...
function js(e, t, n = {}) {
  ...
  let r = n.fill ?? `rgba(51, 108, 255, 0.14)`,
    ...
    a = n.lineWidth ?? 1.5;
  (e.save(),
    r && ((e.fillStyle = r), e.fillRect(t.hitBox.x, t.hitBox.y, t.hitBox.width, t.hitBox.height)),
    i &&
      ((e.strokeStyle = i),
      (e.lineWidth = a),
      e.strokeRect(
...
function Ns({
  ...
  let h = (0, Q.useRef)(null),
    ...
    v = (0, Q.useMemo)(() => Os(i, o), [i, o]),
    y = (0, Q.useMemo)(() => As(r, a), [r, a]);
  return (
    (0, Q.useEffect)(() => {
      let r = h.current;
      if (
    ...
    (0, Q.useEffect)(() => {
      let r = h.current;
      if (r) {
        if (((r.style.width = `${n.width}px`), (r.style.height = `${n.height}px`), !l)) {
          ((r.width = Math.max(1, Math.round(n.width * _))),
            (r.height = Math.max(1, Math.round(n.height * _))));
          return;
        }
        e.resizePageCanvas({ surfaceId: t, width: n.width, height: n.height, dpr: _ });
      }
...
function Fs({
  ...
  let o = (0, Q.useRef)(null),
    ...
    S = (0, Q.useMemo)(() => {
      let e = t.pageLayouts.reduce((e, n) => Math.max(e, Math.round(n.width * t.zoom)), 0),
    ...
    T = (0, Q.useMemo)(
      () => Cs(w, { scrollTop: g, viewportHeight: v.height, overscanPx: Ps }),
      [v.height, g, w],
    ),
    E = (0, Q.useMemo)(() => {
    ...
    D = (0, Q.useMemo)(() => ws(w) + 32 + Math.max(0, i), [i, w]),
    O = (0, Q.useMemo)(() => {
      let e = new Map(),
        t = [];
      for (let n of E) {
        let r = b.get(n.pageIndex);
        for (let i of r?.textLayoutBlocks ?? []) (e.set(i.id, n.pageIndex), t.push(Vs(i, n)));
      }
    ...
    k = (0, Q.useMemo)(
      () =>
        new ve(
          {
            onPointerDown: (t, n) => {
              let r = Bs(t, n?.blockId ?? null, l.current, u.current, d.current);
              r &&
                ((l.current = r.pageIndex),
                e.textPointerDown(r.pageIndex, r.pagePoint, { shiftKey: n?.shiftKey }));
            },
            onPointerMove: (t) => {
              let n = Bs(t, null, l.current, u.current, d.current);
            ...
            onSelectWordAtPoint: (t, n) => {
              let r = Bs(t, n?.blockId ?? null, l.current, u.current, d.current);
              r && ((l.current = r.pageIndex), e.textSelectWordAtPoint(r.pageIndex, r.pagePoint));
            },
            onSelectParagraphAtPoint: (t, n) => {
              let r = Bs(t, n?.blockId ?? null, l.current, u.current, d.current);
              r &&
                ((l.current = r.pageIndex), e.textSelectParagraphAtPoint(r.pageIndex, r.pagePoint));
            },
          ...
          },
          {
            ...
            onUnhandledKeyDown: (t) => {
              if (r && (t.metaKey || t.ctrlKey) && t.key.toLowerCase() === `f`) {
  ...
  ((0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      p.current !== t.pageIndex &&
        ((p.current = t.pageIndex),
        Is(S, g, v.height) !== t.pageIndex && (f.current = t.pageIndex));
    }, [v.height, S, g, t.pageIndex]),
    (0, Q.useEffect)(() => {
      let n = Is(S, g, v.height);
      f.current !== t.pageIndex &&
        (n == null || n === t.pageIndex || e.setPageIndex(n, { origin: `scroll` }));
    }, [v.height, e, S, g, t.pageIndex]),
    (0, Q.useEffect)(() => {
      if (!s.current) return;
      if (Is(S, g, v.height) === t.pageIndex) {
        f.current = null;
        return;
      }
      let e = S[t.pageIndex];
      ...
      if (((f.current = t.pageIndex), typeof s.current.scrollTo == `function`)) {
  ...
  let A = (0, Q.useCallback)(() => {
    ...
    j = (0, Q.useCallback)(
      (t, n) => (r) => {
        ...
        let o = Ds(x.get(t.pageIndex) ?? [], a);
        if (!k.isActive()) {
          if (o) {
            e.setSelectedObject({ id: o.id, kind: o.kind, pageIndex: t.pageIndex });
            return;
          }
          let r = ks(n?.textLayoutBlocks ?? [], a);
          e.setSelectedTextBlockId(r?.id ?? null, { pageIndex: t.pageIndex });
          return;
        }
        if (o) {
          (k.clear(), e.setSelectedObject({ id: o.id, kind: o.kind, pageIndex: t.pageIndex }));
          return;
        }
    ...
    M = (0, Q.useCallback)(
      (e, t) => (n) => {
        ...
        if (!c.current) {
          ...
          let a = i ? ks(t?.textLayoutBlocks ?? [], i) : null;
    ...
    te = (0, Q.useCallback)(
      (e) => (t) => {
        ...
        let n = Rs(t, e);
        k.selectParagraphAtPoint(n) && ((l.current = e.pageIndex), t.preventDefault());
      },
      [k],
    ),
    ne = (0, Q.useCallback)(
    ...
    N = (n) => {
      ...
      if ((n.key === `Backspace` || n.key === `Delete`) && !k.isActive() && t.selectedObjectId) {
      ...
      if (n.key === `Escape`) {
        ...
        (t.selectedTextBlockId || t.selectedObjectId) && (e.clearSelection(), n.preventDefault());
        return;
      }
      n.key === `Enter` &&
        !k.isActive() &&
...
function zs(e, t) {
  let n = e.x - t.left,
    r = e.y - t.top;
  return n < 0 || r < 0 || n > t.width || r > t.height ? null : { x: n / t.scale, y: r / t.scale };
}
  ...
  let p = (0, Q.useSyncExternalStore)(
    ...
    v =
      _.width > 0 && p.pageLayouts.length > 0
        ? Ks({ pageLayouts: p.pageLayouts, viewportWidth: _.width })
        : null,
    y = v != null && n != null,
    b = (0, Q.useCallback)(
      (e) => {
    ...
    x = y
      ? {
          label: n,
          selected: m && Math.abs(p.zoom - v) < Ws,
          onSelect: () => {
            let e = Js({
      ...
      : void 0;
  (0, Q.useEffect)(() => {
    !m || !y || Math.abs(p.zoom - v) < Ws || f.setZoom(v);
  }, [y, f, v, m, p.zoom]);
  ...
  return (
    ...
    (0, $.jsx)(is, {
      ...
      header: (0, $.jsx)(ue, {
        ...
        icon: (0, $.jsx)(G, { kind: `document`, children: (0, $.jsx)(W, { className: `size-4` }) }),
      }),
      children: (0, $.jsxs)(`div`, {
...
function Ks({ pageLayouts: e, viewportWidth: t }) {
  let n = e.reduce((e, t) => Math.max(e, t.width), 0);
  return n <= 0 ? 1 : qs((t - 80) / n);
}
function qs(e) {
  return Math.max(Hs, Math.min(Us, e));
}
function Js({ pageIndex: e, pageLayouts: t, viewportHeight: n, zoom: r }) {
  let i = 32;
  for (let a of t) {
...
function Zs({
  ...
  initialDocumentProto: o,
  initialPageIndex: s,
  initialZoom: c,
  title: l = `codex-popcorn-demo.docx`,
  theme: u = `codex`,
  isEditing: d = !1,
  bottomScrollReservePx: f,
  annotationsEnabled: p = !1,
  drawingAnnotationsEnabled: m = !1,
  enablePageNavigation: h,
  navigationTarget: g,
  ...
  let y = (0, Q.useRef)(t),
    b = (0, Q.useRef)(null),
    x = pe(void 0, () => new xs({ document: Xs(o), initialPageIndex: s, initialZoom: c }));
  return (
    (0, Q.useEffect)(() => {
      x && t !== y.current && ((y.current = t), x.replaceDocument(Xs(o)));
    }, [x, t, o]),
    (0, Q.useEffect)(() => {
      !x ||
        g == null ||
        (g.requestId !== b.current &&
          ((b.current = g.requestId), x.setPageIndex(g.pageNumber - 1, { origin: `navigation` })));
    }, [x, g]),
    x
      ? (0, $.jsx)(`section`, {
          className: r(`no-drag h-full min-h-0 bg-token-bg-primary`, e),
          ...
          children: (0, $.jsx)(Gs, {
            ...
            isEditing: d,
            bottomScrollReservePx: f,
            annotationsEnabled: p,
            drawingAnnotationsEnabled: m,
            enablePageNavigation: h,
...
export { Zs as PopcornElectronDocumentPanel };
