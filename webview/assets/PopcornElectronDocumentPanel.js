...
import { C as Pe, o as Fe, w as Ie } from "./document.js";
import {
  A as Le,
  C as Re,
  D as ze,
...
function Yc({
  ...
  return (0, Z.jsxs)(`div`, {
    className: n(`bg-token-bg-primary text-token-text-primary flex h-full min-h-0 flex-col`, r),
    children: [
      i ??
        (0, Z.jsxs)(`header`, {
...
var Q,
  ...
  $l,
  eu = e(() => {
    ((Q = t(i())), rt(), $c(), Dl(), Al(), Nl(), Il(), Wl(), (Ql = r()), ($l = 1600));
  });
function tu({
  controller: e,
