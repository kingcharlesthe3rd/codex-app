...
import { r as be, t as xe } from "./feature-catalog-Q.js";
import { t as Se } from "./PopcornPageNumberNavigation-C.js";
var Ce = class {
    #e;
    constructor(e = []) {
...
var zt = 12240,
  ...
  Zt = 6;
function Qt(e) {
  return e.type === p.ELEMENT_TYPE_TABLE || e.table
    ? `table`
    : e.type === p.ELEMENT_TYPE_CHART ||
        e.type === p.ELEMENT_TYPE_CHART_REFERENCE ||
        e.chartReference
      ? `chart`
      : e.type === p.ELEMENT_TYPE_IMAGE ||
          e.type === p.ELEMENT_TYPE_IMAGE_REFERENCE ||
          e.imageReference ||
          e.image
        ? `image`
        : e.type === p.ELEMENT_TYPE_SHAPE || e.shape
          ? `shape`
          : e.type === p.ELEMENT_TYPE_GROUP || (e.children?.length ?? 0) > 0
            ? `group`
            : `text`;
}
function $t(e, t) {
...
function Vr(e) {
  return e.type === p.ELEMENT_TYPE_TEXT || e.type === p.ELEMENT_TYPE_TEXT_GROUP;
}
function Hr(e) {
  let t = new Map();
...
function Wr(e, t, n, r, i, a, o, s) {
  ...
  let c = P(
      Qe({ ...Ur(e, { xPx: t, yPx: n, widthPx: r, heightPx: i }), type: p.ELEMENT_TYPE_TABLE }),
      a,
      o,
      {
        paragraphSpacingUnit: `twips`,
...
function Li(e) {
  switch (e) {
    case a.FILL_TYPE_UNSPECIFIED:
      return `unspecified`;
    case a.FILL_TYPE_SOLID:
      return `solid`;
    case a.FILL_TYPE_GRADIENT:
      return `gradient`;
    case a.FILL_TYPE_PICTURE:
      return `picture`;
    case a.FILL_TYPE_PATTERN:
      return `pattern`;
    default:
      return `unknown`;
  }
...
function Ri(e) {
  switch (e) {
    case o.COLOR_TYPE_UNSPECIFIED:
      return `unspecified`;
    case o.COLOR_TYPE_RGB:
      return `rgb`;
    case o.COLOR_TYPE_SCHEME:
      return `scheme`;
    case o.COLOR_TYPE_SYSTEM:
      return `system`;
    default:
      return `unknown`;
  }
...
function Bi(e) {
  switch (e) {
    case u.LINE_STYLE_UNSPECIFIED:
      return `unspecified`;
    case u.LINE_STYLE_SOLID:
      return `solid`;
    case u.LINE_STYLE_DASHED:
      return `dashed`;
    case u.LINE_STYLE_DOTTED:
      return `dotted`;
    case u.LINE_STYLE_DASH_DOT:
      return `dash-dot`;
    case u.LINE_STYLE_DASH_DOT_DOT:
      return `dash-dot-dot`;
    default:
      return `unknown`;
  }
...
function Zi(e, t, n, r) {
  ...
  let i = Qe({ ...yi(e), type: p.ELEMENT_TYPE_TABLE }),
    a = P(i, t, n, {
      paragraphSpacingUnit: `twips`,
      explicitRowHeightBehavior: `atLeast`,
      autoRowMinimumHeightPx: 0,
...
var ia = class {
  ...
  aa = { insertion: d.REVIEW_MARK_TYPE_INSERTION, deletion: d.REVIEW_MARK_TYPE_DELETION },
  oa = class {
    #e;
    constructor(e) {
      this.#e = { ...e };
  ...
  ca = class extends H {
    type = `text`;
    constructor(e, t) {
      (super(e, { ...(t ?? {}), type: p.ELEMENT_TYPE_TEXT }),
        (this.data.type = p.ELEMENT_TYPE_TEXT));
    }
    get id() {
      return this.data.id;
    }
...
function Xa(e) {
  ...
  let t = Za(e.themeColor),
    ...
    r = e.color ?? e.val;
  return t
    ? { type: `proto`, proto: { type: o.COLOR_TYPE_SCHEME, value: t, transform: n, lastColor: r } }
    : r
      ? `#${r}`
      : void 0;
}
...
function go(e) {
  return e === `none`
    ? s.ELEMENT_WRAP_TYPE_NONE
    : e === `tight`
      ? s.ELEMENT_WRAP_TYPE_TIGHT
      : e === `through`
        ? s.ELEMENT_WRAP_TYPE_THROUGH
        : e === `topAndBottom`
          ? s.ELEMENT_WRAP_TYPE_TOP_AND_BOTTOM
          : s.ELEMENT_WRAP_TYPE_SQUARE;
}
var _o = {
    headerRow: !1,
    totalRow: !1,
...
var Io = class {
  ...
  Lo = class e {
    ...
    #v(e) {
      let t = e.findIndex(
        (e) => e.type === p.ELEMENT_TYPE_TEXT || e.type === p.ELEMENT_TYPE_TEXT_GROUP,
      );
      return t >= 0
    ...
    #y(e, t, n, r, i) {
      if (e.type === p.ELEMENT_TYPE_TEXT || e.type === p.ELEMENT_TYPE_TEXT_GROUP) {
        let t = new ca(this.#e, e);
        this.#g(t);
        return;
      }
      if (e.type === p.ELEMENT_TYPE_TABLE || e.table) {
        r.add({ proto: e });
        return;
      }
      if (
      ...
      if (e.type === p.ELEMENT_TYPE_SHAPE || e.shape !== void 0) {
        t.add({ proto: e });
        return;
      }
      (e.type === p.ELEMENT_TYPE_GROUP || (e.children?.length ?? 0) > 0) &&
...
function Ho(e) {
  for (let t of e)
    if (t && (!(t.type === p.ELEMENT_TYPE_TEXT || t.type === p.ELEMENT_TYPE_TEXT_GROUP) || Vo(t)))
      return !0;
  return !1;
}
var Uo = class {
...
function ns(e, t) {
  ...
  let n = e;
  if (n.type === o.COLOR_TYPE_SCHEME && typeof n.value == `string` && n.lastColor === void 0) {
...
function ms() {
  return new Worker(
    new URL(`` + new URL(`runtime.worker-3.js`, import.meta.url).href, `` + import.meta.url),
...
function Zs({
  ...
  artifactSearchEnabled: g = !1,
  commentThreadsEnabled: _ = !1,
}) {
  let v = (0, Q.useRef)(t),
    y = pe(void 0, () => new xs({ document: Xs(o), initialPageIndex: s, initialZoom: c }));
  return (
    (0, Q.useEffect)(() => {
      y && t !== v.current && ((v.current = t), y.replaceDocument(Xs(o)));
    }, [y, t, o]),
    y
      ? (0, $.jsx)(`section`, {
