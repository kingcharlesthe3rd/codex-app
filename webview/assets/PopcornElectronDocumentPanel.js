...
import {
  ...
  u as ie,
  w as z,
} from "./workbook-DBfv-lpS.js";
import "./defaultLocale-1.js";
import { C as ae } from "./document-1.js";
...
function Ce() {
  ...
  return ((e.colorScheme = { name: `Office`, themeColors: { ...be } }), e.toProto());
}
function we() {
  return [
...
var Fe = class {
  ...
  Le = class {
    ...
    add(e, t) {
      let n = this.#a(e),
        r = this.#o(t.range),
        i = new Ie({ id: p(), paragraphs: n, referenceTextRange: r, referenceRunIds: [] });
  ...
  Be = class {
    ...
    add(e, t) {
      let n = this.#a(e),
        r = this.#o(t.range),
        i = new ze({ id: p(), paragraphs: n, referenceTextRange: r, referenceRunIds: [] });
      return (this.#e.push(i), this.#i?.(), i);
    }
    toProto() {
      return this.#e.map((e) => e.toProto());
...
function Ke(e) {
  ...
  for (let e of n)
    r.has(e.cell) ||
      (r.add(e.cell), e.rowSpan > 1 && (e.cell.rowSpan = Math.max(Ve(e.cell.rowSpan), e.rowSpan)));
}
function qe(e) {
  let t = e.table;
...
function yt(e) {
  ...
  let n = 0;
  for (let e of t.rows) e.heightEmu && e.heightEmu > 0 ? (n += e.heightEmu * f) : (n += vt);
  return Math.max(n, t.rows.length * vt);
}
function bt(e, t) {
  let n = e.bbox?.widthEmu !== void 0 && e.bbox.widthEmu > 0 ? e.bbox.widthEmu * f : void 0;
...
function Ct(e, t, n, r, i) {
  ...
  if (!(!a || a.rows.length === 0))
    return ee(
      qe({
        ...e,
        type: u.ELEMENT_TYPE_TABLE,
        bbox: { xEmu: 0, yEmu: 0, widthEmu: _t(Math.max(1, n)), heightEmu: e.bbox?.heightEmu },
      }),
      t,
      r,
      {
...
function wt(e) {
  let t = e.table;
  return t ? t.rows.map((e) => (e.heightEmu && e.heightEmu > 0 ? e.heightEmu * f : vt)) : [];
}
...
function Mt(e, t, n, r, i, a = 0, o = !1) {
  ...
  for (;;) {
    let n = e.find(
      (e) =>
        At(e, o) && Ot(t, s, e.leftPx, e.rightPx) && c >= e.topPx - 0.01 && c < e.bottomPx - 0.01,
    );
    if (!n) {
      let n = e
          .filter((e) => At(e, o) && Ot(t, s, e.leftPx, e.rightPx) && e.topPx > c + 0.01)
...
var Nt = 12240,
  Pt = 15840,
  Ft = 1e5,
  Y = { top: 1440, bottom: 1440, left: 1440, right: 1440, header: 720, footer: 720, gutter: 0 },
  It = 8,
  Lt = 0.5,
  Rt = 1,
  ...
  Gt = 6;
function Kt(e) {
  return e.type === u.ELEMENT_TYPE_TABLE || e.table
    ? `table`
    : e.type === u.ELEMENT_TYPE_CHART ||
        e.type === u.ELEMENT_TYPE_CHART_REFERENCE ||
        e.chartReference
      ? `chart`
      : e.type === u.ELEMENT_TYPE_IMAGE ||
          e.type === u.ELEMENT_TYPE_IMAGE_REFERENCE ||
          e.imageReference ||
          e.image
        ? `image`
        : e.type === u.ELEMENT_TYPE_SHAPE || e.shape
          ? `shape`
          : e.type === u.ELEMENT_TYPE_GROUP || (e.children?.length ?? 0) > 0
            ? `group`
            : `text`;
}
function qt(e, t) {
...
function Qt({
  ...
  return {
    ...
    documentGridLinePitchPx:
      e.documentGridLinePitchTwips === void 0 ? void 0 : J(e.documentGridLinePitchTwips),
  };
}
function $t(e, t) {
  let n = (e.get(t) ?? 0) + 1;
...
function dn(e, t, n, r, i = 0) {
  if (an(e.kind)) {
    ...
    if (ht(e.element) && r !== void 0) return r + (e.element.bbox?.yEmu ?? 0) * f;
...
function pn(e) {
  return (
    e.placement?.type === Ht && e.placement.verticalRelativeFrom?.trim().toLowerCase() === `page`
  );
}
function mn(e, t) {
...
function zn(e, t, n, r) {
  let i = [],
    a = new Set();
  for (let o = t; o < n; o += 1) for (let t of Rn(e[o], r)) a.has(t) || (a.add(t), i.push(t));
  return i;
}
function Bn(e, t) {
...
function Hn(e, t, n, r) {
  ...
  let s = Fn(`docx-footnotes-${t.join(`-`)}`, o),
    ...
    u = { element: s, lines: c, textHeightPx: l, reservedHeightPx: l > 0 ? l + Gt : 0 };
  return (e.layoutByKey.set(i, u), u);
}
function Un(e, t, n, r) {
  return e.ids.length === 0 ? 0 : Hn(t, e.ids, n.contentWidthPx, r).reservedHeightPx;
}
function Wn(e, t, n, r) {
...
function Gn(e, t, n = Ye, r) {
  ...
  if (a) return a;
  let o = e.kind === `text` ? Ur(e.element, t, n, e.defaultTabStopTwips, r) : [];
...
function Zn(e, t) {
  ...
  let n = e.placement.horizontalRelativeFrom?.trim().toLowerCase(),
    r = e.bbox?.widthEmu !== void 0 && e.bbox.widthEmu > 0 ? e.bbox.widthEmu * f : 0;
...
function $n({ lineIndex: e, trailingSpaceAfterPx: t, firstParagraphSpaceBeforePx: n }) {
  return e === 0 ? d(t, n) : 0;
}
function er(e) {
...
function lr({
  ...
  if (d) {
    ...
    if (!r && l > n + Lt) return { rowCount: 0, widthPx: u.widthPx, heightPx: 0 };
  ...
  for (let i = 0; i < e.length; i += 1) {
    ...
    if (C.kind !== `text`) {
      ...
      for (; !e; ) {
        ...
        (c.push({
          ...
          Xn(_, C, { xPx: Jn(C, t, l), yPx: k, widthPx: O.widthPx, heightPx: O.heightPx }),
          (u[l] = A),
          (d[l] = 0),
          (f[l] = !1),
          (p[l] = !1),
    ...
    for (; !T; ) {
      ...
      let N = dr(C.element, E),
        ...
        I = o === n,
        { nextLineIndex: L, fragmentHeightPx: R, endsWithFlowBreak: ne } = tr(E, M, F);
      if (L === M) {
        if (!I) {
...
function Tr(e, t) {
  return { ...e, xPx: e.xPx + t, flow: wr(e.flow, t), children: e.children?.map((e) => Tr(e, t)) };
}
function Er(e, t, n, r = {}) {
    ...
    a =
      Math.abs(i) < 0.01
        ...
        : {
            ...
            pageNumberElement: e.pageNumberElement ? Tr(e.pageNumberElement, i) : void 0,
          };
...
function Fr(e, t, n, r, i, a) {
  return (e.children ?? []).map((e) => {
    ...
    return (o === `group` && (c.children = Fr(e, c.xPx, c.yPx, c.widthPx, i, a)), c);
  });
}
function Ir(e) {
  return e.type === u.ELEMENT_TYPE_TEXT || e.type === u.ELEMENT_TYPE_TEXT_GROUP;
}
function Lr(e) {
  let t = new Map();
  for (let n of e.table?.rows ?? [])
    for (let e of n.cells ?? [])
      for (let n of e.elements ?? []) Ir(n) || (n.id && n.id.length > 0 && t.set(n.id, n));
  return t;
}
function Rr(e, t) {
...
function zr(e, t, n, r, i, a, o, s) {
  ...
  let c = ee(
      qe({ ...Rr(e, { xPx: t, yPx: n, widthPx: r, heightPx: i }), type: u.ELEMENT_TYPE_TABLE }),
      a,
      o,
      {
        paragraphSpacingUnit: `twips`,
...
function Hr(e, t, n, r, i, a, o, s, c) {
  let l = !1;
  for (let e of zn(r, i, a, n)) t.idSet.has(e) || (t.idSet.add(e), t.ids.push(e), (l = !0));
  l && Vr(e, t, n, o, s, c);
}
...
function Yr(e, t) {
  ...
  for (let i of e) {
    ...
    (n.push(s ? { ...i, breakType: ae.SECTION_BREAK_TYPE_UNSPECIFIED } : i), (r = !1));
  }
  return n;
}
function Xr(e, t) {
...
function ai(e, t) {
  let n = (e) => e.replaceAll(Qe, t.currentPageText ?? ``).replaceAll($e, t.totalPagesText ?? ``);
      ...
      paragraphs: [
        {
          ...
          textStyle: {
            alignment: o.ALIGNMENT_TYPE_CENTER,
            fontSize: 1e3,
...
function li(e, t, n = Ye, r = {}) {
  ...
  for (let a = 0; a < O.length; a += 1) {
    ...
    (b.header && (s = j), b.footer && (c = M), b.firstHeader && (l = N), b.firstFooter && (u = ee));
    ...
    for (let e = 0; e < P.length; e += 1) {
      ...
      if (s.kind !== `text`) {
        ...
        for (; !c; ) {
          ...
          (f.bodyElements.push(
            ...
            Xn(K, s, { xPx: E, yPx: b, widthPx: h.widthPx, heightPx: h.heightPx }),
            (B[z] = x),
            (V[z] = 0),
            (H[z] = !1),
            (U[z] = !1),
      ...
      for (; !l; ) {
        ...
        if (F === k) {
          ...
          ((L = Math.max(1, h[k]?.heightPx ?? 0)), (F = Math.min(h.length, k + 1)), (ne = !1));
        }
        if (
          (f || ((f = I(!1)), (S = new Map()), (C = Ln())),
          f.bodyElements.push({
...
function pi(e) {
  let t = (e.sections ?? []).map((e) => ({ ...e, elements: (e.elements ?? []).map(fi) }));
  return { ...e, sections: t, elements: t.flatMap((e) => e.elements ?? []) };
}
function mi(e) {
  return hi(e.element, { xPx: e.xPx, yPx: e.yPx, widthPx: e.widthPx, heightPx: e.heightPx });
}
function hi(e, t) {
  let n = e.bbox?.widthEmu === 0,
    r = e.bbox?.heightEmu === 0;
...
function Ni(e) {
  ...
  for (let n of e.cellElementFrames ?? []) {
    let e = ji(n.row, n.col),
      r = t.get(e) ?? [];
    (r.push({ elementId: n.elementId, frame: xi(n.xPx, n.yPx, n.widthPx, n.heightPx) }),
      t.set(e, r));
  }
  return t;
}
function Pi(e, t, n) {
  ...
  let r = ee(qe({ ...mi(e), type: u.ELEMENT_TYPE_TABLE }), t, n, {
    paragraphSpacingUnit: `twips`,
    explicitRowHeightBehavior: `atLeast`,
    autoRowMinimumHeightPx: 0,
    fitColumnWidthsToFrame: !0,
...
function Fi(e, t, n, r, i, a) {
  ...
  return {
    ...
    children: (e.children ?? []).map((e, r) => Fi(e, t, `${n}.children.${r + 1}`, r + 1, i, a)),
  };
}
function Ii(e) {
  return {
...
var Vi = class {
  ...
  Hi = { insertion: c.REVIEW_MARK_TYPE_INSERTION, deletion: c.REVIEW_MARK_TYPE_DELETION },
  Ui = class {
    #e;
    constructor(e) {
      this.#e = { ...e };
  ...
  Gi = class extends w {
    type = `text`;
    constructor(e, t) {
      (super(e, { ...(t ?? {}), type: u.ELEMENT_TYPE_TEXT }),
        (this.data.type = u.ELEMENT_TYPE_TEXT));
    }
    get id() {
      return this.data.id;
    }
  ...
  na = { TableStyleLight1: ta.tableStyleLight1, "Table Style Light 1": ta.tableStyleLight1 },
...
function fa(e) {
  switch (e) {
    case `wholeTable`:
      return l.CONDITION_WHOLE_TABLE;
    case `firstRow`:
      return l.CONDITION_FIRST_ROW;
    case `lastRow`:
      return l.CONDITION_LAST_ROW;
    case `firstCol`:
      return l.CONDITION_FIRST_COLUMN;
    case `lastCol`:
      return l.CONDITION_LAST_COLUMN;
    case `band1Horz`:
      return l.CONDITION_BANDED_ROW_ODD;
    case `band2Horz`:
      return l.CONDITION_BANDED_ROW_EVEN;
    case `band1Vert`:
      return l.CONDITION_BANDED_COLUMN_ODD;
    case `band2Vert`:
      return l.CONDITION_BANDED_COLUMN_EVEN;
    case `nwCell`:
      return l.CONDITION_TOP_LEFT_CELL;
    case `neCell`:
      return l.CONDITION_TOP_RIGHT_CELL;
    case `swCell`:
      return l.CONDITION_BOTTOM_LEFT_CELL;
    case `seCell`:
      return l.CONDITION_BOTTOM_RIGHT_CELL;
    default:
      return;
  }
}
...
function _a(e) {
  switch (e) {
    case `left`:
      return o.ALIGNMENT_TYPE_LEFT;
    case `center`:
      return o.ALIGNMENT_TYPE_CENTER;
    case `right`:
      return o.ALIGNMENT_TYPE_RIGHT;
    default:
      return;
  }
}
...
function Ea(e) {
  if (!(!e || e.val === `nil`)) return A({ color: Ma(e), width: Da(e), style: `solid` })?.toProto();
}
function Da(e) {
  let t = Number(e.sz);
...
function Na(e) {
  ...
  let t = Pa(e.themeColor),
    ...
    r = e.color ?? e.val;
  return t
    ? { type: `proto`, proto: { type: i.COLOR_TYPE_SCHEME, value: t, transform: n, lastColor: r } }
    : r
      ? `#${r}`
      : void 0;
}
...
function Ga(e, t = {}) {
  let n = { left: Ua(e.left), top: Ua(e.top), width: Wa(e.width), height: Wa(e.height) };
  return (t.inline && ((n.left = void 0), (n.top = void 0)), n);
}
function Ka(e, t, n) {
  let i = Ja(t, n);
  if (!(!e && !Ya(i)))
    return { type: r.ELEMENT_PLACEMENT_TYPE_INLINE, horizontalAlignment: e, ...i };
}
function qa(e, t, n) {
...
function Qa(e) {
  return e === `none`
    ? a.ELEMENT_WRAP_TYPE_NONE
    : e === `tight`
      ? a.ELEMENT_WRAP_TYPE_TIGHT
      : e === `through`
        ? a.ELEMENT_WRAP_TYPE_THROUGH
        : e === `topAndBottom`
          ? a.ELEMENT_WRAP_TYPE_TOP_AND_BOTTOM
          : a.ELEMENT_WRAP_TYPE_SQUARE;
}
var $a = {
    headerRow: !1,
    totalRow: !1,
...
var io = class {
    ...
    add(e) {
      ...
      let { position: t, style: n, columnWidths: r, cellMargins: i, keepTogether: a, ...o } = e,
        s = Ga({ left: t?.left, top: t?.top, width: t?.width, height: t?.height }),
        ...
        u = this.#e.add(l);
      ((u.cellMargins = i ?? to), (u.keepTogether = a), (u.placement = qa(void 0, s)));
  ...
  ao = class {
    ...
    add(e) {
      let t = oo(e),
        ...
        r = this.#e.add(n);
      return (
        (r.placement = qa(e.style, t, { spaceBefore: e.spaceBefore, spaceAfter: e.spaceAfter })), r
      );
    }
  };
function oo(e) {
...
var lo = class {
  ...
  add(e) {
    ...
    return (
      ...
      (n.placement = qa(e.style, t, { spaceBefore: e.spaceBefore, spaceAfter: e.spaceAfter })),
      n
    );
  }
};
...
var fo = class {
  ...
  add(e) {
    let t = po(e),
      n = this.#e.add(e.chartType, { ...e.config, series: go(e.config?.series), position: t });
...
var yo = class {
  ...
  bo = class e {
    ...
    #v(e) {
      let t = e.findIndex(
        (e) => e.type === u.ELEMENT_TYPE_TEXT || e.type === u.ELEMENT_TYPE_TEXT_GROUP,
      );
      return t >= 0
    ...
    #y(e, t, n, r, i) {
      if (e.type === u.ELEMENT_TYPE_TEXT || e.type === u.ELEMENT_TYPE_TEXT_GROUP) {
        let t = new Gi(this.#e, e);
        this.#g(t);
        return;
      }
      if (e.type === u.ELEMENT_TYPE_TABLE || e.table) {
        r.add({ proto: e });
        return;
      }
      if (
      ...
      if (e.type === u.ELEMENT_TYPE_SHAPE || e.shape !== void 0) {
        t.add({ proto: e });
        return;
      }
      (e.type === u.ELEMENT_TYPE_GROUP || (e.children?.length ?? 0) > 0) &&
...
function To(e) {
  for (let t of e)
    if (t && (!(t.type === u.ELEMENT_TYPE_TEXT || t.type === u.ELEMENT_TYPE_TEXT_GROUP) || wo(t)))
      return !0;
  return !1;
}
var Eo = class {
    ...
    constructor(e) {
      ...
      ((this.#m = e.context),
        ...
        (this.#a = new bo({ elements: t?.header?.elements ?? [], context: e.context })),
        (this.#o = new bo({ elements: t?.footer?.elements ?? [], context: e.context })),
        (this.#s = new bo({ elements: t?.firstHeader?.elements ?? [], context: e.context })),
        (this.#c = new bo({ elements: t?.firstFooter?.elements ?? [], context: e.context })),
        (this.#l = !!t?.header),
        (this.#u = !!t?.footer),
  ...
  Do = class {
    ...
    constructor(e) {
      ...
      (t.length > 0
        ? (this.#e = t.map(
            (e, t) => new Eo({ section: e, context: this.#n, defaultId: `doc-section-${t + 1}` }),
          ))
        : (this.#e = [
            new Eo({
...
var ko = class {
  ...
  Ao = class {
    ...
    get backgroundFill() {
      return ((this.#r ||= new E({ type: `proto`, proto: this.#e.backgroundFill })), this.#r);
    }
...
var Io = class {
    ...
    set(e) {
      let t = Fo(q(e)),
        n = this.#e.findIndex((e) => e.id === t.id || e.name === t.name);
      return (n >= 0 ? (this.#e[n] = t) : this.#e.push(t), this.#t?.(), Fo(q(t)));
    }
    delete(e) {
      let t = this.#e.findIndex((t) => t.id === e || t.name === e);
      return t < 0 ? !1 : (this.#e.splice(t, 1), this.#t?.(), !0);
...
function Ro(e, t) {
  ...
  let n = e;
  if (n.type === i.COLOR_TYPE_SCHEME && typeof n.value == `string` && n.lastColor === void 0) {
...
var zo = class e {
    ...
    constructor(e) {
      ...
      ((this.#e = {
        ...
        (this.fonts = new Re(e.fonts ?? [], { onMutated: () => this.invalidateLayoutCache() })),
        (this.settings = new Ao(e.settings, { onMutated: () => this.invalidateLayoutCache() })),
        (this.theme = new Lo(e.theme, { onMutated: () => this.invalidateLayoutCache() })),
        ...
        (this.numbering = new Vi(e.numberingDefinitions ?? [], e.paragraphNumberings ?? [])));
...
function Bo({
  ...
  return (0, $.jsxs)(`div`, {
    className: B(`bg-token-bg-primary text-token-text-primary flex h-full min-h-0 flex-col`, n),
    children: [
      r ??
        (0, $.jsxs)(`header`, {
      ...
      (0, $.jsxs)(`div`, {
        ...
        children: [
          a
            ...
            : null,
          (0, $.jsx)(`div`, { className: `min-h-0 min-w-0 flex-1`, children: s }),
        ],
      }),
      o
        ? (0, $.jsx)(`footer`, {
...
function es(e) {
  return e.documentProto ? e.documentProto : e.document ? e.document.toProto() : Yo().toProto();
}
function ts() {
  return Xo();
}
var ns = 1,
  rs = class {
    ...
    constructor(e = {}) {
      ...
      (this.#n.bootstrap({
        ...
        (this.#r = Uo()
          .then(() => {
            let e = G();
            (this.#e.debug(`font-render-deps-ready`, { fontCount: e.length, fontDebug: ue() }),
    ...
    attachPageCanvas(e) {
      ...
      if (
        ((e.canvas.style.width = `${e.width}px`), (e.canvas.style.height = `${e.height}px`), !$o())
      )
        return (
  ...
  let o = (0, Q.useRef)(null),
    ...
    O = (0, Q.useMemo)(() => {
      ...
      for (let n of E) {
        ...
        for (let i of r?.textLayoutBlocks ?? []) (e.set(i.id, n.pageIndex), t.push(Cs(i, n)));
      }
    ...
    k = (0, Q.useMemo)(
      () =>
        new pe(
          {
            onPointerDown: (t, n) => {
              let r = Ss(t, n?.blockId ?? null, l.current, u.current, d.current);
              r &&
  ...
  return (
    ...
    (0, $.jsx)(Bo, {
      ...
      header: (0, $.jsx)(K, {
        ...
        icon: (0, $.jsx)(H, { kind: `document`, children: (0, $.jsx)(V, { className: `size-4` }) }),
      }),
      children: (0, $.jsxs)(`div`, {
...
function Ns({
  ...
  let g = (0, Q.useRef)(t),
    _ = ce(void 0, () => new rs({ document: Ms(a), initialPageIndex: o, initialZoom: s }));
  return (
    (0, Q.useEffect)(() => {
