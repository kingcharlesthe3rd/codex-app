...
function zr(e, t, n, r, i, a, o, s) {
  ...
  let l = ee(
      qe({ ...Rr(e, { xPx: t, yPx: n, widthPx: r, heightPx: i }), type: c.ELEMENT_TYPE_TABLE }),
      a,
      o,
      {
        paragraphSpacingUnit: `twips`,
...
var Vi = class {
  ...
  Hi = { insertion: l.REVIEW_MARK_TYPE_INSERTION, deletion: l.REVIEW_MARK_TYPE_DELETION },
  Ui = class {
    #e;
    constructor(e) {
      this.#e = { ...e };
...
function Na(e) {
  ...
  let t = Pa(e.themeColor),
    ...
    r = e.color ?? e.val;
  return t
    ? { type: `proto`, proto: { type: u.COLOR_TYPE_SCHEME, value: t, transform: n, lastColor: r } }
    : r
      ? `#${r}`
      : void 0;
}
...
var yo = class {
  ...
  bo = class e {
    ...
    #v(e) {
      let t = e.findIndex(
        (e) => e.type === c.ELEMENT_TYPE_TEXT || e.type === c.ELEMENT_TYPE_TEXT_GROUP,
      );
      return t >= 0
    ...
    #y(e, t, n, r, i) {
      if (e.type === c.ELEMENT_TYPE_TEXT || e.type === c.ELEMENT_TYPE_TEXT_GROUP) {
...
function To(e) {
  for (let t of e)
    if (t && (!(t.type === c.ELEMENT_TYPE_TEXT || t.type === c.ELEMENT_TYPE_TEXT_GROUP) || wo(t)))
      return !0;
  return !1;
}
var Eo = class {
...
function Ro(e, t) {
  ...
  let n = e;
  if (n.type === u.COLOR_TYPE_SCHEME && typeof n.value == `string` && n.lastColor === void 0) {
