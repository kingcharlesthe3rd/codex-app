...
var c,
  l = e(() => {
    (n(), i(), o(), (c = [...s(a, `webview`), ...s(r, `vscode-only`), ...s(t, `electron-only`)]));
  });
function u(e) {
  return D.get(e) ?? null;
}
...
var T,
  ...
  A = e(() => {
    (l(),
      (T = [`thread`, `navigation`, `panels`, `workspace`, `skills`, `configure`, `app`]),
      (E = [
    ...
    ((O = c.filter((e) => e.kind === `webview` && /^thread[1-9]$/.test(e.id)).map((e) => e.id)),
      (k = c
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~appgen-settings-page~page~appgen-page~remote-con~hih2jc2y.js.map
