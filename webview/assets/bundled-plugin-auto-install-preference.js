...
import { Ia as o } from "./app-server-manager-signals.js";
import { A as s, _ as ee, f as c, h as te, u as l, v as u } from "./vscode-api.js";
...
import { t as g } from "./format-skill-title.js";
import { n as _ } from "./rpc-Hf-fxjh7.js";
import { t as re } from "./request.js";
import { d as ie, l as ae, n as oe } from "./dialog-layout-B.js";
import { t as se } from "./toggle.js";
import { _ as ce, b as le, g as ue, h as de, v as fe, y as pe } from "./apps-queries.js";
...
function ye(e) {
  return e.displayName ?? g(e.plugin.name);
}
async function be({ hostId: e, marketplacePath: t, pluginName: n }) {
  y(n) && (await _.chromeNativeHost?.install({ hostId: e, marketplacePath: t, pluginName: n }));
}
async function v({ hostId: e, marketplaceName: t, pluginName: n }) {
  y(n) && (await _.chromeNativeHost?.uninstall({ hostId: e, marketplaceName: t, pluginName: n }));
}
function y(e) {
...
function Ce(e) {
  ...
  (t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = () => {
      ...
      (t[1] = te))
    : ((c = t[0]), (te = t[1])),
    (0, Se.useLayoutEffect)(c, te));
  let l;
  t[2] === r ? (l = t[3]) : ((l = ne(`group`, r)), (t[2] = r), (t[3] = l));
  let u;
  t[4] === n
    ? (u = t[5])
    : ((u = (0, b.jsx)(`div`, { ref: ee, children: n })), (t[4] = n), (t[5] = u));
  let d;
  t[6] !== a || t[7] !== u
    ? ((d = (0, b.jsx)(`div`, { ref: s, className: a, children: u })),
      (t[6] = a),
      (t[7] = u),
      (t[8] = d))
    : (d = t[8]);
  ...
  t[9] === i
    ...
    : ((f = ne(
      ...
      (t[10] = f));
  let p;
  t[11] === f ? (p = t[12]) : ((p = (0, b.jsx)(`div`, { className: f })), (t[11] = f), (t[12] = p));
  let m;
  return (
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, b.jsx)(`div`, {
          ...
          children: Array.from({ length: 3 }).map(Ne),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
...
function Ne(e, t) {
  return (0, b.jsxs)(
    `div`,
    {
      ...
      children: [
        (0, b.jsx)(`div`, { className: `h-3 w-36 rounded bg-token-border-default` }),
        (0, b.jsx)(`div`, { className: `h-2.5 w-full rounded bg-token-border-default` }),
        (0, b.jsx)(`div`, { className: `h-2.5 w-4/5 rounded bg-token-border-default` }),
      ],
    },
    t,
  );
...
function Pe(e) {
  ...
  t[0] === r
    ...
    : ((i =
                ...
                (0, b.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, b.jsx)(`div`, {
                      ...
                      children: S(r.blurb.description),
                    }),
                  ],
                }),
                (0, b.jsx)(se, {
      ...
      (t[1] = i));
  let a;
  t[2] === n ? (a = t[3]) : ((a = n.map(Fe)), (t[2] = n), (t[3] = a));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, b.jsxs)(`div`, {
...
function Ie(e) {
  ...
  let T = Re,
    E;
  t[2] === w ? (E = t[3]) : ((E = [`mcp-settings`, `app-connect`, w]), (t[2] = w), (t[3] = E));
  let ze = C && n != null,
    D;
  t[4] === n
    ? (D = t[5])
  ...
  let Be;
  t[6] !== E || t[7] !== ze || t[8] !== D
    ? ((Be = { queryKey: E, enabled: ze, staleTime: l.FIVE_MINUTES, queryFn: D }),
      (t[6] = E),
      (t[7] = ze),
      (t[8] = D),
      (t[9] = Be))
  ...
  t[10] === w
    ? (A = t[11])
    : ((A = [`mcp-settings`, `app-connect`, `tos`, w]), (t[10] = w), (t[11] = A));
  let Ve = C && n != null,
    j;
  t[12] === n
    ? (j = t[13])
    : ((j = async () => {
      ...
      (t[13] = j));
  let He;
  t[14] !== Ve || t[15] !== j || t[16] !== A
    ? ((He = { queryKey: A, enabled: Ve, staleTime: l.FIVE_MINUTES, queryFn: j }),
      (t[14] = Ve),
      (t[15] = j),
      (t[16] = A),
      (t[17] = He))
  ...
  t[18] === k
    ? (Ue = t[19])
    : ((Ue = k == null ? `UNSUPPORTED` : Ae(k)), (t[18] = k), (t[19] = Ue));
  let P = Ue,
    We;
  t[20] === k
    ? (We = t[21])
    : ((We = k == null ? !1 : ke(k.link_params_schema)), (t[20] = k), (t[21] = We));
  let Ge = We,
    F = a == null && !N && (O.isError || k == null || Ge || P === `UNSUPPORTED`),
    Ke;
  t[22] !== n?.installUrl || t[23] !== T || t[24] !== S || t[25] !== x
    ? ((Ke = (e) => {
        ...
        (c.dispatchMessage(`open-in-browser`, { url: o }), i && T(!1));
      }),
      (t[22] = n?.installUrl),
      (t[23] = T),
      (t[24] = S),
  ...
  t[27] !== n || t[28] !== S || t[29] !== g || t[30] !== x
    ? ((qe = () => {
        ...
        (c.dispatchMessage(`open-in-browser`, { url: e }), g(!1));
      }),
      (t[27] = n),
      (t[28] = S),
      (t[29] = g),
  ...
  t[39] !== y
    ? ((Ye = (e) => {
        switch (e.kind) {
          case `connected-directly`:
            ...
            return;
          case `oauth-started`:
            (n != null && se?.({ app: { id: n.id, name: n.name }, redirectUrl: e.redirectUrl }),
              x.get(h).info(ue({ intl: S })),
              T(!1));
            return;
          case `browser-fallback`:
            ...
            return;
          case `failed`:
            (y && x.get(h).danger(n?.installUrl?.trim() ? de(S) : fe(S)), be && T(!1));
            return;
        }
      }),
      (t[32] = n),
    ...
    : (Ye = t[40]);
  let Xe;
  t[41] !== n?.id || t[42] !== S || t[43] !== x
    ? ((Xe = (e) => {
        (te.error(`Failed to connect app {}`, {
  ...
  let L = ee({
      mutationFn: async () => {
        ...
        return a == null
          ...
          : (await a({ app: n, personalizationMode: st }))
  ...
  let z = k?.status === we,
    ...
    V = k?.name ?? n.name,
    Qe;
  t[45] === k ? (Qe = t[46]) : ((Qe = je(k)), (t[45] = k), (t[46] = Qe));
  let $e = Qe,
    H;
  t[47] === S
    ? (H = t[48])
  ...
  let et;
  t[51] !== H || t[52] !== U
    ? ((et = { title: H, description: U }), (t[51] = H), (t[52] = U), (t[53] = et))
    : (et = t[53]);
  let W;
  t[54] === S
    ? (W = t[55])
  ...
  let K;
  t[58] !== W || t[59] !== G
    ? ((K = { title: W, description: G }), (t[58] = W), (t[59] = G), (t[60] = K))
    : (K = t[60]);
  let q;
  t[61] === S
    ? (q = t[62])
  ...
  let Y;
  t[65] !== q || t[66] !== J
    ? ((Y = { title: q, description: J }), (t[65] = q), (t[66] = J), (t[67] = Y))
    : (Y = t[67]);
  let tt;
  t[68] !== et || t[69] !== K || t[70] !== Y
    ? ((tt = [et, K, Y]), (t[68] = et), (t[69] = K), (t[70] = Y), (t[71] = tt))
    : (tt = t[71]);
  let nt = tt,
    rt;
  t[72] === M.data?.blurbs
    ? (rt = t[73])
    : ((rt = M.data?.blurbs ?? []), (t[72] = M.data?.blurbs), (t[73] = rt));
  let it = rt,
    at = M.data?.personalization_toggle_blurb ?? null,
    ot =
      Fe?.connectorId === w ? Fe.enabled : M.data?.personalization_default === `PERSONALIZE_ALWAYS`,
  ...
  t[99] !== P ||
  t[100] !== F
    ? ((pt = a == null && !N && !v && !B && !z && !F && P === `OAUTH` && !!n.installUrl?.trim()),
      (t[93] = n.installUrl),
      (t[94] = a),
      (t[95] = v),
      (t[96] = B),
  ...
  let _t = gt,
    vt;
  t[109] !== V || t[110] !== v || t[111] !== B || t[112] !== z || t[113] !== P || t[114] !== F
    ? ((vt = v
        ? (0, b.jsx)(f, {
  ...
  t[116] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((bt = { "aria-describedby": void 0, style: { maxHeight: Oe, width: De } }), (t[116] = bt))
    : (bt = t[116]);
  let xt;
  t[117] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xt = { maxHeight: Oe }), (t[117] = xt))
    : (xt = t[117]);
  let St;
  t[118] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((St = (0, b.jsx)(`span`, {
        ...
        children: (0, b.jsx)(me, { className: `size-12` }),
      })),
      (t[118] = St))
    : (St = t[118]);
  let Ct;
  t[119] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ct = (0, b.jsxs)(`span`, {
        ...
        children: [
          (0, b.jsx)(`span`, { className: `size-1.5 rounded-full bg-token-border-default` }),
          (0, b.jsx)(`span`, { className: `size-1.5 rounded-full bg-token-border-default` }),
          (0, b.jsx)(`span`, { className: `size-1.5 rounded-full bg-token-border-default` }),
        ],
      })),
  ...
  t[120] !== n.name || t[121] !== S
    ? ((X = S.formatMessage(
      ...
      (t[122] = X))
    : (X = t[122]);
  let wt = n.logoUrl ?? k?.logo_url ?? null,
    Tt = n.logoUrlDark ?? k?.logo_url_dark ?? null,
    Et;
  t[123] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Et = (0, b.jsx)(ve, { className: `icon-sm text-token-text-secondary` })), (t[123] = Et))
    : (Et = t[123]);
  let Z;
  t[124] !== X || t[125] !== wt || t[126] !== Tt
    ? ((Z = (0, b.jsxs)(`div`, {
  ...
  t[135] === Ze
    ...
    : ((kt = Ze
        ? (0, b.jsxs)(`div`, {
            ...
            children: [
              (0, b.jsx)(ge, { className: `icon-sm shrink-0` }),
              (0, b.jsx)(f, {
  ...
  t[137] !== Z || t[138] !== Ot || t[139] !== kt
    ...
    : (At = t[140]);
  let jt;
  t[141] !== M.isPending || t[142] !== N || t[143] !== ut || t[144] !== ct
    ? ((jt =
        N || M.isPending
          ? (0, b.jsx)(Me, {})
          : (0, b.jsx)(Pe, { blurbs: ct, personalizationToggle: ut })),
      (t[141] = M.isPending),
      (t[142] = N),
      (t[143] = ut),
      (t[144] = ct),
  ...
  t[148] !== jt || t[149] !== Mt
    ? ((Nt = (0, b.jsx)(Ce, {
        ...
        children: (0, b.jsxs)(`div`, { className: `flex flex-col gap-4`, children: [jt, Mt] }),
      })),
      (t[148] = jt),
      (t[149] = Mt),
      (t[150] = Nt))
  ...
  t[151] === ht
    ? (Ft = t[152])
    : ((Ft = ht ? (0, b.jsx)(_e, { className: `icon-xs` }) : null), (t[151] = ht), (t[152] = Ft));
  let It;
  t[153] !== yt || t[154] !== Ft
    ? ((It = (0, b.jsxs)(`span`, { className: `flex items-center gap-1`, children: [yt, Ft] })),
      (t[153] = yt),
      (t[154] = Ft),
      (t[155] = It))
    : (It = t[155]);
  let Lt;
  t[156] !== ft || t[157] !== R || t[158] !== Pt || t[159] !== It
    ? ((Lt = (0, b.jsx)(p, {
        color: `primary`,
        size: `large`,
    ...
    : (Lt = t[160]);
  let Rt;
  t[161] !== mt || t[162] !== L.isPending || t[163] !== I
    ? ((Rt = mt
        ? (0, b.jsx)(p, {
            color: `ghost`,
            size: `large`,
  ...
  let zt;
  t[165] !== Lt || t[166] !== Rt
    ? ((zt = (0, b.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [Lt, Rt] })),
      (t[165] = Lt),
      (t[166] = Rt),
      (t[167] = zt))
    : (zt = t[167]);
...
export { v as a, be as i, Ie as n, ye as o, Ce as r, C as t };
