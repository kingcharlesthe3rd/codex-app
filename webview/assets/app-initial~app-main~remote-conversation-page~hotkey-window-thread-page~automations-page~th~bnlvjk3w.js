...
function g() {
  ...
  e[0] === t
    ? (i = e[1])
    : ((i = (e) => {
        (t.setQueryData(f(`inbox-items`, { limit: 200 }), (t) => (t == null ? t : h(t, e, !0))),
  ...
  e[2] === t
    ? (c = e[3])
    : ((c = (e) => {
        (t.setQueryData(f(`inbox-items`, { limit: 200 }), (t) => (t == null ? t : h(t, e, !1))),
  ...
  e[4] === t
    ...
    : ((u = () => {
        ...
        (t.setQueryData(f(`inbox-items`, { limit: 200 }), (t) =>
          ...
          r.dispatchMessage(`inbox-automation-runs-mark-all-read`, { readAt: e }));
      }),
      (e[4] = t),
      (e[5] = u));
  let d = u,
  ...
  let m = n.data?.unreadRunCounts,
    g;
  return (
    e[8] !== n.isLoading || e[9] !== d || e[10] !== a || e[11] !== l || e[12] !== p || e[13] !== m
      ? ((g = {
          items: p,
