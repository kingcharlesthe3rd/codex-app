...
function g() {
  ...
  e[0] === t
    ? (a = e[1])
    : ((a = (e) => {
        (t.setQueryData(r(`inbox-items`, { limit: 200 }), (t) => (t == null ? t : h(t, e, !0))),
          n.dispatchMessage(`inbox-item-set-read-state`, { id: e, isRead: !0 }));
      }),
      (e[0] = t),
      (e[1] = a));
  let o = a,
  ...
  e[2] === t
    ? (s = e[3])
    : ((s = (e) => {
        (t.setQueryData(r(`inbox-items`, { limit: 200 }), (t) => (t == null ? t : h(t, e, !1))),
          n.dispatchMessage(`inbox-item-set-read-state`, { id: e, isRead: !1 }));
      }),
      (e[2] = t),
      (e[3] = s));
  let c = s,
  ...
  e[4] === t
    ...
    : ((l = () => {
        let e = Date.now();
        (t.setQueryData(r(`inbox-items`, { limit: 200 }), (t) =>
          t == null
            ? t
            : {
                ...t,
          ...
          n.dispatchMessage(`inbox-automation-runs-mark-all-read`, { readAt: e }));
      }),
      (e[4] = t),
      (e[5] = l));
  let d = l,
  ...
  e[6] === i.data?.items
    ? (p = e[7])
    : ((p = i.data?.items ?? []), (e[6] = i.data?.items), (e[7] = p));
  let m = i.data?.unreadRunCounts,
    g;
  return (
    e[8] !== i.isLoading || e[9] !== d || e[10] !== o || e[11] !== c || e[12] !== p || e[13] !== m
      ? ((g = {
          items: p,
