...
function g() {
  ...
  e[0] === t
    ? (r = e[1])
    : ((r = (e) => {
        (t.setQueryData(d(`inbox-items`, { limit: 200 }), (t) => (t == null ? t : h(t, e, !0))),
  ...
  e[2] === t
    ? (s = e[3])
    : ((s = (e) => {
        (t.setQueryData(d(`inbox-items`, { limit: 200 }), (t) => (t == null ? t : h(t, e, !1))),
  ...
  let m = n.data?.unreadRunCounts,
    g;
  return (
    e[8] !== n.isLoading || e[9] !== f || e[10] !== i || e[11] !== c || e[12] !== p || e[13] !== m
      ? ((g = {
          items: p,
