...
function g() {
  ...
  e[0] === n
    ? (i = e[1])
    : ((i = (e) => {
        (n.setQueryData(c(`inbox-items`, { limit: 200 }), (t) => (t == null ? t : h(t, e, !0))),
          t.dispatchMessage(`inbox-item-set-read-state`, { id: e, isRead: !0 }));
      }),
      (e[0] = n),
      (e[1] = i));
  let a = i,
  ...
  e[2] === n
    ? (o = e[3])
    : ((o = (e) => {
        (n.setQueryData(c(`inbox-items`, { limit: 200 }), (t) => (t == null ? t : h(t, e, !1))),
          t.dispatchMessage(`inbox-item-set-read-state`, { id: e, isRead: !1 }));
      }),
      (e[2] = n),
      (e[3] = o));
  let l = o,
  ...
  e[4] === n
    ...
    : ((u = () => {
        let e = Date.now();
        (n.setQueryData(c(`inbox-items`, { limit: 200 }), (t) =>
          t == null
            ? t
            : {
                ...t,
          ...
          t.dispatchMessage(`inbox-automation-runs-mark-all-read`, { readAt: e }));
      }),
      (e[4] = n),
      (e[5] = u));
  let d = u,
  ...
  e[6] === r.data?.items
    ? (p = e[7])
    : ((p = r.data?.items ?? []), (e[6] = r.data?.items), (e[7] = p));
  let m = r.data?.unreadRunCounts,
    g;
  return (
    e[8] !== r.isLoading || e[9] !== d || e[10] !== a || e[11] !== l || e[12] !== p || e[13] !== m
      ? ((g = {
          items: p,
