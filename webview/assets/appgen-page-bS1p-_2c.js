...
import { Fi as o, Pi as s } from "./app-server-manager-signals.js";
...
import "./chevron.js";
import "./core.esm.js";
import { m as g } from "./chunk-109.js";
...
import "./folder.js";
import { t as y } from "./settings.cog.js";
import "./use-register-command.js";
import { r as b } from "./modal-controller-state.js";
...
import { n as x } from "./use-start-new-conversation-jDp-QANK.js";
import "./sites-color.js";
import "./plugin-config-edits.js";
import "./plugin-prefill-prompt.js";
import { i as S, r as C, t as w } from "./sites.js";
...
import { a as j, n as M } from "./appgen-url-Dg9-goax.js";
import { i as N, n as P } from "./appgen-access-state-messages.js";
import "./use-workspace-users.js";
import { t as F } from "./appgen-share-dialog-1.js";
var I = r();
e(t());
var L = n(),
  R = (e) =>
...
function B() {
  ...
  e[9] === y
    ? (F = e[10])
    : ((F = y ? null : (0, L.jsx)(D, { className: `icon-xs` })), (e[9] = y), (e[10] = F));
  let R;
  e[11] !== N || e[12] !== y || e[13] !== T || e[14] !== k || e[15] !== F
    ? ((R = (0, L.jsx)(f, {
        "aria-label": k,
        color: `ghost`,
        disabled: T,
  ...
  let z;
  e[17] !== k || e[18] !== R
    ? ((z = (0, L.jsx)(m, { tooltipContent: k, children: R })),
      (e[17] = k),
      (e[18] = R),
      (e[19] = z))
    : (z = e[19]);
  ...
  e[21] === j
    ? (G = e[22])
    : ((G = (0, L.jsx)(f, { color: `outline`, size: `toolbar`, onClick: j, children: B })),
      (e[21] = j),
      (e[22] = G));
  let K;
  e[23] !== z || e[24] !== G
    ? ((K = (0, L.jsx)(O, {
        start: P,
        trailing: (0, L.jsxs)(`div`, { className: `flex items-center gap-2`, children: [z, G] }),
      })),
      (e[23] = z),
      (e[24] = G),
      (e[25] = K))
  ...
  e[26] === q
    ? (J = e[27])
    : ((J = (0, L.jsx)(v, { extension: !0, children: q })), (e[26] = q), (e[27] = J));
  let Y;
  e[28] === q
    ? (Y = e[29])
    : ((Y = (0, L.jsx)(v, {
        ...
        chromeExtension: !0,
        electron: !0,
        children: (0, L.jsx)(d.Header, { children: q }),
      })),
      (e[28] = q),
      (e[29] = Y));
  let X;
...
function H(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, L.jsx)(w, { className: `icon-lg text-token-foreground` })), (t[0] = r))
    : (r = t[0]);
  let i;
      ...
      : ((o = (0, L.jsx)(`div`, {
          ...
          children: (0, L.jsxs)(`div`, {
            ...
            children: [
              r,
              i,
              (0, L.jsx)(f, { color: `outline`, size: `medium`, onClick: n, children: a }),
            ],
          }),
        })),
        (t[3] = n),
...
function W(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (s = t[1]);
  let c;
  t[2] === a ? (c = t[3]) : ((c = a.map(G)), (t[2] = a), (t[3] = c));
  let l;
  t[4] === c
    ? (l = t[5])
    : ((l = (0, L.jsxs)(`div`, {
  ...
  let d;
  t[6] !== n || t[7] !== r || t[8] !== i
    ? ((d = (0, L.jsx)(k, { hasNextPage: n, isFetchingNextPage: r, onLoadNextPage: i })),
      (t[6] = n),
      (t[7] = r),
      (t[8] = i),
      (t[9] = d))
  ...
  return (
    t[10] !== l || t[11] !== d
      ? ((f = (0, L.jsxs)(`div`, { className: `pb-3`, children: [l, d] })),
        (t[10] = l),
        (t[11] = d),
        (t[12] = f))
      : (f = t[12]),
...
function G(e) {
  return (0, L.jsx)(K, { project: e }, e.id);
}
function K(e) {
  let t = (0, I.c)(40),
    { project: n } = e,
  ...
  t[8] === n.updated_at
    ? (p = t[9])
    : ((p = (0, L.jsx)(T, { dateString: n.updated_at })), (t[8] = n.updated_at), (t[9] = p));
  let m;
  ...
  let h;
  t[11] !== i || t[12] !== n.slug
    ? ((h = M(i) ?? n.slug), (t[11] = i), (t[12] = n.slug), (t[13] = h))
    : (h = t[13]);
  let g;
  t[14] === h
    ? (g = t[15])
    : ((g = (0, L.jsx)(`span`, { className: `truncate`, children: h })), (t[14] = h), (t[15] = g));
  let _;
  t[16] !== p || t[17] !== g
    ? ((_ = (0, L.jsxs)(`span`, {
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, L.jsxs)(`span`, {
        ...
        children: [
          ...
          (0, L.jsx)(E, { "aria-hidden": !0, className: `icon-2xs` }),
        ],
      })),
      (t[19] = v))
    : (v = t[19]);
  ...
  let b;
  t[22] !== y || t[23] !== f
    ? ((b = (0, L.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-px`, children: [f, y] })),
      (t[22] = y),
      (t[23] = f),
      (t[24] = b))
    : (b = t[24]);
  ...
  t[32] !== n.id || t[33] !== n.title
    ? ((C = (0, L.jsx)(Y, { projectId: n.id, projectTitle: n.title })),
      (t[32] = n.id),
      (t[33] = n.title),
      (t[34] = C))
    : (C = t[34]);
...
function q() {
  ...
  return (
    e[0] === t
      ...
      : ((n =
          t === `windows`
            ? (0, L.jsx)(R, { "aria-hidden": !0, className: `h-[50px] w-20 shrink-0` })
            : (0, L.jsx)(z, { "aria-hidden": !0, className: `h-[50px] w-20 shrink-0` })),
        (e[0] = t),
        (e[1] = n)),
    n
  );
...
function J(e) {
  let t = (0, I.c)(16),
    ...
    l;
  t[0] !== r || t[1] !== c
    ? ((l = () => b(c, F, { projectId: r })), (t[0] = r), (t[1] = c), (t[2] = l))
    : (l = t[2]);
  let d;
  t[3] === n
    ? (d = t[4])
    : ((d = (0, L.jsx)(N, { className: `icon-xs shrink-0`, accessPolicy: n, "aria-hidden": !0 })),
      (t[3] = n),
      (t[4] = d));
  let f = u,
    p = P(s),
...
function Y(e) {
  ...
  let p;
  t[3] !== n || t[4] !== c
    ? ((p = () => b(c, F, { projectId: n })), (t[3] = n), (t[4] = c), (t[5] = p))
    : (p = t[5]);
  let h, _;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, L.jsx)(A, { "aria-hidden": !0, className: `icon-xs` })),
      (_ = (0, L.jsx)(u, {
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, L.jsx)(y, { "aria-hidden": !0, className: `icon-xs` })), (t[18] = T))
    : (T = t[18]);
  let E;
  t[19] !== S || t[20] !== w
    ? ((E = (0, L.jsx)(m, {
...
export { B as AppgenPage };
//# sourceMappingURL=appgen-page-bS1p-_2c.js.map
