...
import { Xs as i } from "./app-server-manager-signals.js";
import { n as a, t as o } from "./jsx-runtime.js";
import { C as s, Q as c, S as l, at as u, wt as ee } from "./setting-storage.js";
import { t as d } from "./product-logger.js";
import { n as te } from "./rpc.js";
import { a as f } from "./statsig.js";
import { r as p } from "./toast-signal.js";
import { t as m } from "./app-intl-signal.js";
import { i as ne } from "./plugins-page-selectors-B-Roj-OI.js";
e(a());
var h = o(),
  g = (e) =>
    (0, h.jsxs)(`svg`, {
...
function b({ apps: e, plugins: t, skills: n }) {
  return {
    ...
    plugins: x(ne(t).map((e) => e.displayName ?? e.plugin.interface?.displayName ?? e.plugin.name)),
...
var V = u(l, !1),
  ...
  K = u(l, N);
function de({ isActiveRealtimeThreadVisible: e, isAppFocused: t, isRightPanelFullWidth: n }) {
...
function q(e, t) {
  ...
  return {
    ...
    text: I({ reason: t, mode: n, prompts: r, visibleThreadId: i, visibleThreadTitle: a }),
  };
}
var fe = class {
  ...
  xe = new (class {
    ...
    async start(e, { conversationId: t, manager: n, outputModality: r, prompt: a, source: o }) {
      ...
      try {
        ...
        ((this.session = i),
          ...
          await _({ manager: n, conversationId: t, outputModality: r, prompt: a, offerSdp: s }));
      } catch (n) {
    ...
    subscribeToRealtimeNotifications(e, t) {
      (this.unsubscribeRealtimeNotifications?.(),
        (this.unsubscribeRealtimeNotifications = t.addNotificationCallback(he, (t) => {
      ...
      if (!(this.conversationId == null || t.params.threadId !== this.conversationId))
        switch (t.method) {
          ...
          case `thread/realtime/started`:
            ...
            (e.set(Y, `active`),
              this.sendContextInject(e, this.conversationId, q(e, `realtime_started`)),
...
//# sourceMappingURL=realtime-controller-C.js.map
