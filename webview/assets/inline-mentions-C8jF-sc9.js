...
import { s as T } from "./apps-queries.js";
...
import { n as oe } from "./external-markdown-link.js";
import { a as se, i as B, n as ce, o as le, s as ue, t as de } from "./inline-mention-style.js";
import {
  c as V,
  d as H,
  h as U,
...
function rt(e) {
  let t = (0, Y.c)(25),
    ...
    y;
  t[0] !== o || t[1] !== n ? ((y = o ?? l(n)), (t[0] = o), (t[1] = n), (t[2] = y)) : (y = t[2]);
  let b = y,
    x;
...
function it(e) {
  let t = (0, Y.c)(28),
    { cwd: n, hostId: r, label: a, href: o, openInSidePanel: s, tooltipText: c } = e,
    l = n === void 0 ? null : n,
    u = s === void 0 ? !1 : s,
    { skills: d } = J(void 0, r),
    f;
  t[0] === a ? (f = t[1]) : ((f = a.split(`:`).at(-1)?.trim() ?? a), (t[0] = a), (t[1] = f));
  let p = f,
    m;
  ...
  if (t[4] !== a || t[5] !== h || t[6] !== p || t[7] !== d || t[8] !== c) {
    ...
    bb0: {
      ...
      if (e == null) {
        ...
        (t[12] === a
          ? (e = t[13])
          : ((e = (0, Q.jsxs)(Q.Fragment, { children: [`$`, a] })), (t[12] = a), (t[13] = e)),
          (v = e));
        break bb0;
      }
      ((g = F(e)), (_ = D(e) ?? c));
  ...
  let y = _,
    b;
  t[14] === Symbol.for(`react.memo_cache_sentinel`) ? ((b = V()), (t[14] = b)) : (b = t[14]);
  let x;
  t[15] === g
    ? (x = t[16])
  ...
  if (o == null) {
    let e;
    t[17] === Symbol.for(`react.memo_cache_sentinel`) ? ((e = V()), (t[17] = e)) : (e = t[17]);
    let n;
    return (
      t[18] !== g || t[19] !== y
  ...
  let C = y ?? o,
    w;
  return (
    t[21] !== S || t[22] !== l || t[23] !== r || t[24] !== o || t[25] !== u || t[26] !== C
      ? ((w = (0, Q.jsx)(dt, {
...
function at(e) {
  ...
  let { data: s } = T(o),
    c;
  t[2] === s ? (c = t[3]) : ((c = s === void 0 ? [] : s), (t[2] = s), (t[3] = c));
  let l = c,
    u;
  t[4] === i ? (u = t[5]) : ((u = i && O(i) ? i.slice(6) : ``), (t[4] = i), (t[5] = u));
  let d = u,
    f;
  t[6] !== d || t[7] !== l || t[8] !== r
    ? ((f = (d.length > 0 ? l.find((e) => e.id === d) : void 0) ?? l.find((e) => e.name === r)),
      (t[6] = d),
      (t[7] = l),
      (t[8] = r),
      (t[9] = f))
  ...
  let m = p.description ?? void 0,
    ...
    g;
  return (
    t[12] !== i || t[13] !== p.id || t[14] !== p.name || t[15] !== m || t[16] !== h || t[17] !== a
      ? ((g = (0, Q.jsx)($, {
          displayName: p.name,
          description: m,
          iconSmall: h,
...
function ot(e) {
  ...
  let { nativeApps: _ } = fe(h),
    v = U({ mentionPath: l, mentionDisplayName: r, nativeApps: _, computerPlugin: p }),
  ...
  if (t[0] !== o || t[1] !== i) {
    ...
    t[4] === i
      ...
      : ((e = (e) => {
        ...
        (t[5] = e));
    let n = o.find(e);
    ((s = ft), (c = n == null ? I : W(n)), (t[0] = o), (t[1] = i), (t[2] = s), (t[3] = c));
  } else ((s = t[2]), (c = t[3]));
  let l;
  return (
...
function dt(e) {
  ...
  n[12] !== D || n[13] !== T || n[14] !== l
    ? ((j = T && !t(D) && r(l)), (n[12] = D), (n[13] = T), (n[14] = l), (n[15] = j))
    : (j = n[15]);
  let M = j,
    ne;
  ...
  n[66] !== S
    ? ((de = () =>
        me(S, { column: O, cwd: p, endLine: f, hostId: m, line: u, openInSidePanel: b, path: l })),
      (n[59] = p),
      (n[60] = f),
      (n[61] = m),
      (n[62] = u),
...
function $(e) {
  let t = (0, Y.c)(12),
    ...
    u = s ?? ``,
    d;
  t[0] !== r || t[1] !== i || t[2] !== a || t[3] !== o || t[4] !== c || t[5] !== u
    ? ((d = K(null, {
        size: `small`,
        smallOnly: !0,
        alt: i,
  ...
  return (
    t[7] !== n || t[8] !== i || t[9] !== d || t[10] !== f
      ? ((p = (0, Q.jsx)(ft, { brandColor: n, icon: d, text: i, tooltipText: f })),
        (t[7] = n),
        (t[8] = i),
        (t[9] = d),
        (t[10] = f),
...
function pt(e) {
  ...
  let b;
  t[6] !== n || t[7] !== c
    ? ((b = de({ brandColor: n, style: c })), (t[6] = n), (t[7] = c), (t[8] = b))
    : (b = t[8]);
  let x;
  t[9] === g
    ? (x = t[10])
    : ((x = g == null ? null : (0, Q.jsx)(`span`, { className: se, children: g })),
      (t[9] = g),
      (t[10] = x));
  let S;
...
function mt({
  ...
  switch (P({ href: i, label: u })) {
    case `app`:
      return (0, Q.jsx)(at, { hostId: r, label: j(u), href: i, tooltipText: i }, n);
    case `plugin`:
      return (0, Q.jsx)(ot, { hostId: r, label: j(u), href: i, tooltipText: i }, n);
    case `agent`: {
      let e = A(i),
        t = te(i);
      return e == null && t == null
        ? null
        : (0, Q.jsx)(ut, { conversationId: e ?? void 0, label: j(u), tooltipText: i }, n);
    }
    case `mcp-resource`: {
      let e = ne(i);
      return e == null
        ? null
        : (0, Q.jsx)(st, { hostId: r, label: u, mention: e, tooltipText: e.resourceUri }, n);
    }
    case `skill`:
      return (0, Q.jsx)(
        it,
        {
          cwd: t,
          hostId: r,
          label: j(j(u) || i.split(`/`).slice(-2, -1)[0]?.replace(/-/g, ` `) || i),
          href: i,
          openInSidePanel: s,
          tooltipText: i,
        },
...
//# sourceMappingURL=inline-mentions-C8jF-sc9.js.map
