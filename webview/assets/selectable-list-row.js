...
function o(e) {
  let t = (0, i.c)(47),
    {
      ...
      secondaryTitle: h,
      secondLine: g,
      secondLineRightText: _,
      title: v,
    } = e,
    y = l === void 0 ? !1 : l,
    b;
  t[0] === f ? (b = t[1]) : ((b = { onSelect: f }), (t[0] = f), (t[1] = b));
  let x = r(b),
    S;
  t[2] === u
    ? (S = t[3])
    : ((S =
        u && (0, a.jsx)(`span`, { className: `flex min-h-6 shrink-0 items-center`, children: u })),
      (t[2] = u),
      (t[3] = S));
  let C;
  t[4] === v
  ...
  t[16] !== g || t[17] !== _
    ? ((O =
        ...
        (0, a.jsxs)(`div`, {
          ...
          children: [
            (0, a.jsx)(`div`, { className: `min-w-0 flex-1`, children: g }),
            _ &&
              (0, a.jsx)(`div`, {
  ...
  let A;
  t[22] !== k || t[23] !== S
    ? ((A = (0, a.jsxs)(`div`, { className: `flex min-w-0 items-start gap-2`, children: [S, k] })),
      (t[22] = k),
      (t[23] = S),
      (t[24] = A))
    : (A = t[24]);
  ...
  if (
    ...
    bb0: if (
      ...
      (t[39] === j
        ? (r = t[40])
        : ((r = (0, a.jsx)(`div`, { className: `pointer-events-none relative`, children: j })),
          (t[39] = j),
          (t[40] = r)),
        (N = (0, a.jsxs)(`div`, {
  ...
  let P;
  return (
    t[41] !== s || t[42] !== x || t[43] !== j || t[44] !== p || t[45] !== M
      ? ((P = (0, a.jsx)(`div`, {
          "aria-label": s,
          className: M,
          onContextMenu: p,
