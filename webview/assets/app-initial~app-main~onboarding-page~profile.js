...
function le({ dailyUsage: e, todayIso: t, view: n }) {
  let r = k({ columnCount: w(t), dailyUsage: e, startDateIso: T(t), todayIso: t });
  switch (n) {
    case `cumulative`:
      return he(r);
    case `daily`:
...
function ue({ dailyUsage: e, todayIso: t }) {
  let n = M(A(t), -175);
  return E(k({ columnCount: 26, dailyUsage: e, startDateIso: n, todayIso: t })).map((e, r) =>
    M(n, r) > t ? null : e,
  );
}
function S({ dailyUsage: e, todayIso: t }) {
  return k({ columnCount: w(t), dailyUsage: e, startDateIso: T(t), todayIso: t });
}
...
function ye(e) {
  let t = (0, X.c)(13),
    ...
    s = ne(Z),
    l;
  t[0] === s ? (l = t[1]) : ((l = s.get(Q, ee.SIX_HOURS)), (t[0] = s), (t[1] = l));
  let u = l,
    d;
  t[2] !== r || t[3] !== o
...
async function G(e) {
  ...
  return (
    await l
      .getInstance()
      .post(`/wham/profiles/me/photo`, te(await De(e, t)), {
