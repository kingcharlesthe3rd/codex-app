...
import { gr as o, to as s, vr as c } from "./app-server-manager-signals.js";
import { g as l, k as u, r as d } from "./vscode-api.js";
import { mn as f } from "./src-1.js";
...
function C(e) {
  let t = (0, S.c)(31),
    { cwd: n, hostConfig: r, onErrorMessage: s, showErrorToast: m } = e,
    h = m === void 0 ? !1 : m,
    g = i(a),
    _ = u(),
    y = p(),
    b;
  t[0] === r ? (b = t[1]) : ((b = o(r)), (t[0] = r), (t[1] = b));
  let x = b,
    C = n ?? ``,
    w;
  t[2] !== x || t[3] !== C
