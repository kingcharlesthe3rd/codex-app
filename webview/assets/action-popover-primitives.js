...
import { uo as o, xr as s, yr as c } from "./app-server-manager-signals.js";
import { A as l, _ as u, r as d } from "./vscode-api.js";
import { pn as f } from "./src-2.js";
...
import { n as y } from "./dialog-layout-B.js";
import { t as b } from "./with-window.js";
import { r as x } from "./diff-stats.js";
var S = a();
function C(e) {
  let t = (0, S.c)(31),
    { cwd: n, hostConfig: a, onErrorMessage: o, showErrorToast: m } = e,
    h = m === void 0 ? !1 : m,
    g = r(i),
    _ = l(),
    y = p(),
    b;
  t[0] === a ? (b = t[1]) : ((b = c(a)), (t[0] = a), (t[1] = b));
  let x = b,
    C = n ?? ``,
    w;
  t[2] !== x || t[3] !== C
  ...
  t[5] !== n || t[6] !== a
    ? ((T = async () => {
        ...
        await s(`git`).request({
          ...
          params: { cwd: f(n), hostConfig: a, operationSource: `review_model` },
        });
      }),
      (t[5] = n),
      (t[6] = a),
...
function E(e) {
  ...
  return (
    t[6] !== n || t[7] !== i || t[8] !== a
      ? ((o = (0, T.jsx)(y, { ...i, className: a, children: n })),
        (t[6] = n),
        (t[7] = i),
        (t[8] = a),
        (t[9] = o))
...
function A(e) {
  ...
  if (t[0] !== i || t[1] !== n || t[2] !== r) {
    ...
    (t[8] === i
      ...
      (l = (0, T.jsx)(b, { electron: !0, children: u(`medium`) })),
      (a = b),
      (o = !0),
      (s = u(`toolbar`)),
      (t[0] = i),
