...
import { g as o, k as s, r as c } from "./vscode-api.js";
import { wn as l } from "./src-4.js";
import { Ua as u, hr as d, pr as f } from "./app-server-manager-signals.js";
...
function C(e) {
  let t = (0, S.c)(31),
    { cwd: n, hostConfig: r, onErrorMessage: u, showErrorToast: m } = e,
    h = m === void 0 ? !1 : m,
    g = i(a),
    _ = s(),
    y = p(),
    b;
  t[0] === r ? (b = t[1]) : ((b = f(r)), (t[0] = r), (t[1] = b));
  let x = b,
    C = n ?? ``,
    w;
  t[2] !== x || t[3] !== C
  ...
  t[5] !== n || t[6] !== r
    ? ((T = async () => {
        ...
        await d(`git`).request({
          ...
          params: { cwd: l(n), hostConfig: r, operationSource: `review_model` },
        });
      }),
      (t[5] = n),
      (t[6] = r),
  ...
  t[8] !== n || t[9] !== x || t[10] !== y || t[11] !== _ || t[12] !== g
    ? ((E = async () => {
        ...
        let e = [_.invalidateQueries({ queryKey: c(`git-origins`) })];
...
function P(e) {
  ...
  t[11] !== s || t[12] !== c || t[13] !== l
    ? ((m = l
        ? (0, T.jsx)(x, { variant: `color`, linesAdded: s, linesRemoved: c })
        : (0, T.jsx)(`span`, {})),
      (t[11] = s),
      (t[12] = c),
      (t[13] = l),
