...
import { d as g, f as _, t as v } from "./format-skill-title.js";
...
import "./notion.js";
import { t as x } from "./external-link-source.js";
import { t as S } from "./rich-link.js";
...
import "./skills.js";
import { n as ee } from "./mention-icons.js";
import { t as te } from "./inline-mention-content.js";
import { t as ne } from "./app-shell-ref.js";
import "./globe.js";
import { t as C } from "./external-link-favicon.js";
import { n as re } from "./thread-scroll-controller-context-value.js";
var w = r(),
  T = e(t(), 1),
  ie = e(i(), 1),
  E = n(),
  ...
  ce = 32,
  le = -10,
  ue = `[data-turn-key], [data-content-search-turn-key]`,
  O = `color-mix(in srgb, var(--color-token-foreground) 14%, transparent)`,
  de = `color-mix(in srgb, var(--color-token-foreground) 5%, transparent)`,
  k = /\[((?:\\.|[^\]\n])+)\]\(((?:\\.|[^)\n])+)\)/g;
function fe(e) {
  let t = (0, w.c)(3),
    { items: n, onRevealItem: r } = e;
  if (n.length < D) return null;
  let i;
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, E.jsx)(pe, { items: n, onRevealItem: r })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
function pe(e) {
  let t = (0, w.c)(83),
    { items: n, onRevealItem: r } = e,
    { getScrollElement: i } = re(),
    o = (0, T.useContext)(ne),
    f = d(),
    g = n.at(-1)?.id ?? null,
    _;
  t[0] === g ? (_ = t[1]) : ((_ = () => new Set(g == null ? [] : [g])), (t[0] = g), (t[1] = _));
  let [v, y] = (0, T.useState)(_),
    [b, x] = (0, T.useState)(!1),
    [S, ee] = (0, T.useState)(!1),
    [te, C] = (0, T.useState)(!1),
    [D, le] = (0, T.useState)(!1),
    [O, de] = (0, T.useState)(null),
    k = (0, T.useRef)(null),
    fe = (0, T.useRef)(null),
    pe = (0, T.useRef)(null),
    A = (0, T.useRef)(null),
    ...
    N = u(),
    P;
  t[2] === n ? (P = t[3]) : ((P = n.map(me).join(`\0`)), (t[2] = n), (t[3] = P));
  let F = P,
    I;
  t[4] !== v || t[5] !== n || t[6] !== g
    ? ((I = n.find((e) => v.has(e.id))?.id ?? g), (t[4] = v), (t[5] = n), (t[6] = g), (t[7] = I))
    : (I = t[7]);
  let L = I,
    R;
  t[8] === L
    ...
    : ((R = () => {
      ...
      (t[8] = L),
      (t[9] = R));
  let Se = (0, T.useEffectEvent)(R),
    Ce;
  t[10] !== i || t[11] !== r || t[12] !== N
    ? ((Ce = async (e) => {
        let t = i();
        if (t == null) return;
        let n = he(t, e.id);
        if (n == null && r != null) {
          (await r(e), ye(he(t, e.id), N));
          return;
        }
        (n?.scrollIntoView({ behavior: `smooth`, block: `center` }), ye(n, N));
      }),
      (t[10] = i),
      (t[11] = r),
      (t[12] = N),
        ...
        let n = null,
          r = () => {
            n ??= window.requestAnimationFrame(() => {
              ...
              (le((t.getBoundingClientRect().left - r.left) / f >= ae + ce + oe + se), Se());
            });
          },
    ...
    ? ((ke = () => {
        ...
        let t = new Set(),
          ...
          s = () => {
            ...
            e.size !== 0 && y((t) => (t.size === e.size && [...t].every((t) => e.has(t)) ? t : e));
          },
  ...
  if (
    (t[29] !== L || t[30] !== D
      ? ((Me = [L, D]), (t[29] = L), (t[30] = D), (t[31] = Me))
      : (Me = t[31]),
    (0, T.useLayoutEffect)(je, Me),
    !D || O == null || typeof document > `u`)
  )
    return null;
  let V;
  t[32] === M
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ne = { opacity: 1 }), (t[34] = Ne))
    : (Ne = t[34]);
  let Pe;
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Pe = { opacity: 0 }), (t[35] = Pe))
    : (Pe = t[35]);
  let H;
  t[36] === N
    ? (H = t[37])
    : ((H = N ? { duration: 0 } : { duration: 0.15, ease: [0.23, 1, 0.32, 1] }),
      (t[36] = N),
      (t[37] = H));
  let Fe;
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Fe = (e) => {
        (ee(e), e && (_e(pe.current, k.current), x(!0)));
      }),
      (t[38] = Fe))
    : (Fe = t[38]);
  let Ie;
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Ie = t[39]);
  let U;
  t[40] !== v || t[41] !== z || t[42] !== S || t[43] !== n || t[44] !== Te
    ? ((U = S ? (0, E.jsx)(be, { items: n, activeItemIds: v, listRef: Te, onSelect: z }) : null),
      (t[40] = v),
      (t[41] = z),
      (t[42] = S),
      (t[43] = n),
  ...
  t[46] === U
    ? (W = t[47])
    : ((W = (0, E.jsx)(l, { onExitComplete: Ie, children: U })), (t[46] = U), (t[47] = W));
  let G;
  t[48] === n
    ? (G = t[49])
    : ((G = (e) => {
        if (e.button !== 0) return;
        let t = ve(n, e.currentTarget, e.target instanceof Element ? e.target : null);
        t != null &&
          ((j.current = !1),
          (A.current = {
            itemId: t.item.id,
  ...
  t[50] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Le = () => {
        ((k.current = null), A.current ?? C(!1));
      }),
      (t[50] = Le))
    : (Le = t[50]);
  let K;
  t[51] !== B || t[52] !== z || t[53] !== n
    ? ((K = (e) => {
        k.current =
          ve(n, e.currentTarget, e.target instanceof Element ? e.target : null)?.item.id ?? null;
        let t = A.current;
        ...
        let r = ve(n, e.currentTarget, document.elementFromPoint(e.clientX, e.clientY));
        r == null ||
          r.item.id === t.itemId ||
  ...
  t[55] === Re
    ...
    : ((q = s(
      ...
      (t[56] = q));
  let J;
  t[57] !== v || t[58] !== z || t[59] !== M || t[60] !== n
    ? ((J = n.map((e, t) =>
        (0, E.jsx)(
          `button`,
          {
            "data-thread-user-message-navigation-item-id": e.id,
            "aria-current": v.has(e.id) ? `true` : void 0,
  ...
  let Y;
  t[62] !== q || t[63] !== J
    ? ((Y = (0, E.jsx)(`div`, { className: q, children: J })),
      (t[62] = q),
      (t[63] = J),
      (t[64] = Y))
    : (Y = t[64]);
  let X;
  t[65] !== B || t[66] !== G || t[67] !== K || t[68] !== Y
    ? ((X = (0, E.jsx)(`div`, {
        ref: fe,
    ...
    : (X = t[69]);
  let Z;
  t[70] !== b || t[71] !== te || t[72] !== o || t[73] !== W || t[74] !== X
    ? ((Z = (0, E.jsx)(m, {
        align: `center`,
        delayDuration: 1e3,
        disableHoverOpen: te,
  ...
  return (
    t[80] !== O || t[81] !== Q
      ? (($ = (0, ie.createPortal)(Q, O)), (t[80] = O), (t[81] = Q), (t[82] = $))
      : ($ = t[82]),
    $
  );
}
...
function he(e, t) {
  return e.querySelector(`[data-content-search-unit-key="${L(t)}"]`);
}
function ge(e, t) {
  if (e == null) return;
  let n = A(e, t);
...
function A(e, t) {
  return t == null || e == null
    ? null
    : (e.querySelector(`[data-thread-user-message-navigation-item-id="${L(t)}"]`) ??
        e.querySelector(`[data-thread-user-message-navigation-group-item-ids~="${L(t)}"]`));
}
function ve(e, t, n) {
...
function ye(e, t) {
  (e?.querySelector(`[data-user-message-bubble]`) ?? e)?.animate?.(
    [{ backgroundColor: O }, { backgroundColor: O, offset: 0.35 }, { backgroundColor: de }],
...
function be(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== a || t[4] !== o) {
    ...
    ((s = c.div),
      t[15] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((m = { opacity: 0, translateX: le, scale: 0.8 }),
          (h = { opacity: 1, translateX: 0, scale: 1 }),
          (g = { opacity: 0, translateX: le, scale: 0.8 }),
          (t[15] = m),
          (t[16] = h),
          (t[17] = g))
    ...
    (t[20] !== n || t[21] !== a
      ? ((u = (e) =>
          e.type === `heartbeat-group`
            ? (0, E.jsx)(j, { activeItemIds: n, items: e.items, onSelect: a }, e.items[0]?.item.id)
            : (0, E.jsx)(P, { activeItemIds: n, item: e.item, onSelect: a }, e.item.id)),
        (t[20] = n),
        (t[21] = a),
        (t[22] = u))
      : (u = t[22]),
...
function j(e) {
  let t = (0, w.c)(26),
    ...
    l = r.some((e) => {
      ...
      : void 0,
    u;
  t[0] === r ? (u = t[1]) : ((u = r.map(N).join(` `)), (t[0] = r), (t[1] = u));
  let d, p;
  ...
  let _;
  t[8] === g ? (_ = t[9]) : ((_ = (0, E.jsx)(f, { className: g })), (t[8] = g), (t[9] = _));
  let v;
  t[10] !== m || t[11] !== _
    ? ((v = (0, E.jsxs)(`span`, {
  ...
  t[18] !== n || t[19] !== a || t[20] !== r || t[21] !== i
    ? ((x = a
        ? r.map((e) => {
            let { item: t } = e;
            return (0, E.jsx)(P, { activeItemIds: n, item: t, onSelect: i }, t.id);
          })
        : null),
      (t[18] = n),
      (t[19] = a),
  ...
  return (
    t[23] !== b || t[24] !== x
      ? ((S = (0, E.jsxs)(E.Fragment, { children: [b, x] })), (t[23] = b), (t[24] = x), (t[25] = S))
      : (S = t[25]),
    S
  );
}
...
function P(e) {
  ...
  t[5] === r.isHeartbeat
    ? (f = t[6])
    : ((f = r.isHeartbeat
        ? (0, E.jsx)(y, { className: `icon-xs justify-self-end text-token-description-foreground` })
        : null),
      (t[5] = r.isHeartbeat),
      (t[6] = f));
  ...
  let g;
  t[11] !== m || t[12] !== h
    ? ((g = (0, E.jsx)(`span`, { className: m, children: h })),
      (t[11] = m),
      (t[12] = h),
      (t[13] = g))
    : (g = t[13]);
  ...
  if (t[0] !== n) {
    ...
    for (let t of n.matchAll(k)) {
      ...
      let o = g(r).trim(),
        ...
        l;
      if (o.startsWith(`$`))
        ((s = ee()), (c = v(o.startsWith(`$[`) && o.endsWith(`]`) ? o.slice(2, -1) : o.slice(1))));
      else {
        let e = S(_(a));
        if (e == null) continue;
        let t = x(e);
        ((s = (t == null ? null : b(t.appId)) ?? (0, E.jsx)(C, { href: e })), (l = e));
      }
      (e.push(n.slice(i, t.index)),
        e.push((0, E.jsx)(te, { className: `first:pl-0`, icon: s, text: c, title: l }, t.index)),
        (i = t.index + t[0].length));
    }
    let a;
    (t[2] !== n || t[3] !== i ? ((a = n.slice(i)), (t[2] = n), (t[3] = i), (t[4] = a)) : (a = t[4]),
      e.push(a),
      (r = (0, E.jsx)(E.Fragment, { children: e })),
      (t[0] = n),
      (t[1] = r));
  } else r = t[1];
  return r;
...
function xe(e) {
  return e.some((e) =>
    [...e.addedNodes, ...e.removedNodes].some(
      (e) => e instanceof HTMLElement && (e.matches(ue) || e.querySelector(ue) != null),
    ),
  );
}
function L(e) {
...
export { fe as ThreadUserMessageNavigationRail };
