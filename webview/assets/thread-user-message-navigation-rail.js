...
function Ee(e) {
  ...
  if (t[0] !== n) {
    ...
    t[6] === n.isHeartbeat
      ? (c = t[7])
      : ((c = n.isHeartbeat
          ? (0, Z.jsx)(W, { className: `icon-xs shrink-0 text-token-description-foreground` })
          : null),
        (t[6] = n.isHeartbeat),
        (t[7] = c));
    let l;
...
function ke(e) {
  switch (e.type) {
    case `app`:
      return (0, Z.jsx)(H, { className: `icon-sm shrink-0 text-token-charts-blue` });
    case `commit`:
      return (0, Z.jsx)(F, { className: `icon-sm shrink-0` });
    case `file`:
      return (0, Ne.createElement)(G(e.label ?? void 0), { className: `icon-sm shrink-0` });
    case `google-drive`:
      return (0, Z.jsx)(A, { className: `icon-sm shrink-0` });
    case `image`:
      return (0, Z.jsx)(xe, { className: `icon-sm shrink-0` });
    case `pull-request`:
...
function je(e) {
  ...
  if (t[0] !== i) {
    ...
    for (; o < i.length; ) {
      ...
      if (t == null) break;
      o = t.end;
      let a = x(t.label).trim(),
        u = c(t.path),
        d,
        ee = a,
        f;
      if (l(u) || r(u)) ((d = se(a) ?? H), (ee = y(a)));
      else if (a.startsWith(`$`))
        ((d = K()), (ee = O(a.startsWith(`$[`) && a.endsWith(`]`) ? a.slice(2, -1) : a.slice(1))));
      else {
        let e = p(u);
        if (e == null) continue;
        let t = n(e);
        ((d = (t == null ? null : se(t.appId)) ?? (0, Z.jsx)(N, { href: e })), (f = e));
      }
      (e.push(i.slice(s, t.start)),
        e.push((0, Z.jsx)(Se, { className: `first:pl-0`, icon: d, text: ee, title: f }, t.start)),
        (s = t.end));
    }
    (e.push(i.slice(s)), (a = (0, Z.jsx)(Z.Fragment, { children: e })), (t[0] = i), (t[1] = a));
  } else a = t[1];
  return a;
}
var Me,
...
function He(e) {
  ...
  let [u, ee] = (0, Q.useState)(l),
    [f, te] = (0, Q.useState)(!1),
    [p, re] = (0, Q.useState)(null),
    [m, h] = (0, Q.useState)(null),
    [g, _] = (0, Q.useState)(!1),
    [ae, oe] = (0, Q.useState)(!1),
    [v, se] = (0, Q.useState)(null),
    ce = (0, Q.useRef)(null),
    y = (0, Q.useRef)(null),
    b = (0, Q.useRef)(!1),
    x = (0, Q.useId)(),
    ...
    C = ve(),
    de;
  t[2] === n ? (de = t[3]) : ((de = n.map(Ue).join(`\0`)), (t[2] = n), (t[3] = de));
  let w = de,
    pe;
  t[4] !== u || t[5] !== n || t[6] !== c
    ? ((pe = n.find((e) => u.has(e.id))?.id ?? c), (t[4] = u), (t[5] = n), (t[6] = c), (t[7] = pe))
    : (pe = t[7]);
  let T = pe,
    me;
  t[8] === T
    ? (me = t[9])
    : ((me = () => {
        y.current ?? Ge(ce.current, T);
      }),
      (t[8] = T),
      (t[9] = me));
  let he = (0, Q.useEffectEvent)(me),
    E;
  ...
  let D = ue(E),
    O;
  t[14] !== D || t[15] !== s
    ? ((O = (e) => (s.logProductEvent(ie, {}), D(e, `smooth`))),
      (t[14] = D),
      (t[15] = s),
      (t[16] = O))
    : (O = t[16]);
  ...
  t[19] !== a || t[20] !== he
        ...
        let n = null,
          r = () => {
            n ??= window.requestAnimationFrame(() => {
              ...
              (oe((i.left - r.left) / (a > 0 ? a : 1) >= et + nt), he());
            });
          },
    ...
    : (j = t[21]);
  let M;
  (t[22] === a ? (M = t[23]) : ((M = [a]), (t[22] = a), (t[23] = M)), (0, Q.useEffect)(j, M));
  let N, P;
  (t[24] !== a || t[25] !== w
    ? ((N = () => {
        let e = a();
  ...
  let I;
  if (
    (t[31] !== T || t[32] !== ae || t[33] !== p
      ? ((I = [T, ae, p]), (t[31] = T), (t[32] = ae), (t[33] = p), (t[34] = I))
      : (I = t[34]),
    (0, Q.useLayoutEffect)(F, I),
    !ae || v == null || typeof document > `u`)
  )
    return null;
  let L;
  t[35] === S
  ...
  t[39] === C
    ? (B = t[40])
    : ((B = C ? { duration: 0 } : { duration: 0.15, ease: [0.23, 1, 0.32, 1] }),
      (t[39] = C),
      (t[40] = B));
  let be;
  ...
  let xe = m?.button,
    Se = m?.item ?? n[0],
    V;
  t[42] === Se ? (V = t[43]) : ((V = (0, $.jsx)(Ee, { item: Se })), (t[42] = Se), (t[43] = V));
  let H = p == null ? void 0 : !0,
    U;
        ...
        (0, $.jsx)(
          `button`,
          {
            ...
            onClick: (t) => {
              ...
              (h({ button: t.currentTarget, item: e }), _(!0), _e(e));
            },
            onFocus: (t) => {
  ...
  t[62] === K
    ...
    : ((q = (0, $.jsx)(`div`, { className: `flex flex-col`, children: K })),
      ...
      (t[63] = q));
  let J;
  t[64] !== A || t[65] !== H || t[66] !== W || t[67] !== G || t[68] !== q
    ? ((J = (0, $.jsx)(`div`, {
        ref: ce,
    ...
    : (J = t[69]);
  let Y;
  t[70] !== g || t[71] !== o || t[72] !== xe || t[73] !== V || t[74] !== J || t[75] !== x
    ? ((Y = (0, $.jsx)(d, {
        align: `center`,
        delayOpen: !0,
        open: g,
