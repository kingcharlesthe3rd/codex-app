...
import { $ as B, Q as we } from "./app-initial~app-main~onboarding-page.js";
import {
  h as V,
  m as H,
...
import { n as q, r as Te } from "./thread-scroll-controller-context-value.js";
var J,
  Y,
  X = e(() => {
    (t(r()),
...
function Ee(e) {
  ...
  if (t[0] !== n) {
    ...
    t[6] === n.isHeartbeat
      ? (s = t[7])
      : ((s = n.isHeartbeat
          ? (0, Z.jsx)(Ce, { className: `icon-xs shrink-0 text-token-description-foreground` })
          : null),
        (t[6] = n.isHeartbeat),
        (t[7] = s));
    let c;
    t[8] === o
      ? (c = t[9])
      : ((c = (0, Z.jsx)(`span`, { className: `min-w-0 truncate`, children: o })),
        (t[8] = o),
        (t[9] = c));
    let l;
    (t[10] !== s || t[11] !== c
...
function ke(e) {
  switch (e.type) {
    case `app`:
      return (0, Z.jsx)(re, { className: `icon-sm shrink-0 text-token-charts-blue` });
    case `commit`:
      return (0, Z.jsx)(G, { className: `icon-sm shrink-0` });
    case `file`:
      return (0, Ne.createElement)(m(e.label ?? void 0), { className: `icon-sm shrink-0` });
    case `google-drive`:
      return (0, Z.jsx)(ae, { className: `icon-sm shrink-0` });
    case `image`:
      return (0, Z.jsx)(we, { className: `icon-sm shrink-0` });
    case `pull-request`:
...
function je(e) {
  ...
  if (t[0] !== n) {
    ...
    for (; i < n.length; ) {
      ...
      if (t == null) break;
      i = t.end;
      let r = M(t.label).trim(),
        o = R(t.path),
        s,
        c = r,
        u;
      if (w(o) || te(o)) ((s = ie(r) ?? re), (c = D(r)));
      else if (r.startsWith(`$`))
        ((s = ee()), (c = ge(r.startsWith(`$[`) && r.endsWith(`]`) ? r.slice(2, -1) : r.slice(1))));
      else {
        let e = h(o);
        if (e == null) continue;
        let t = d(e);
        ((s = (t == null ? null : ie(t.appId)) ?? (0, Z.jsx)(E, { href: e })), (u = e));
      }
      (e.push(n.slice(a, t.start)),
        e.push((0, Z.jsx)(l, { className: `first:pl-0`, icon: s, text: c, title: u }, t.start)),
        (a = t.end));
    }
    (e.push(n.slice(a)), (r = (0, Z.jsx)(Z.Fragment, { children: e })), (t[0] = n), (t[1] = r));
  } else r = t[1];
  return r;
}
var Me,
...
function He(e) {
  let t = (0, Ze.c)(84),
    { items: n, onRevealItem: r } = e,
    { getScrollElement: a } = Te(),
    o = (0, Q.useContext)(c),
    s = i(ve),
    l = n.at(-1)?.id ?? null,
    u;
  t[0] === l ? (u = t[1]) : ((u = () => new Set(l == null ? [] : [l])), (t[0] = l), (t[1] = u));
  let [d, ee] = (0, Q.useState)(u),
    ...
    C = le(),
    w;
  t[2] === n ? (w = t[3]) : ((w = n.map(Ue).join(`\0`)), (t[2] = n), (t[3] = w));
  let T = w,
    E;
  t[4] !== d || t[5] !== n || t[6] !== l
    ? ((E = n.find((e) => d.has(e.id))?.id ?? l), (t[4] = d), (t[5] = n), (t[6] = l), (t[7] = E))
    : (E = t[7]);
  let D = E,
    O;
  t[8] === D
    ? (O = t[9])
    : ((O = () => {
        y.current ?? Ge(oe.current, D);
      }),
      (t[8] = D),
      (t[9] = O));
  let ue = (0, Q.useEffectEvent)(O),
    k;
  t[10] !== a || t[11] !== r || t[12] !== C
    ? ((k = async (e, t) => {
        ...
        let i = We(n, e.id);
        if (i == null && r != null) {
          (await r(e), (i = We(n, e.id)), Je(i, C));
          return;
        }
        (i?.scrollIntoView({ behavior: t, block: `start` }), Je(i, C));
      }),
      (t[10] = a),
      (t[11] = r),
      (t[12] = C),
  ...
  let A = xe(k),
    j;
  t[14] !== A || t[15] !== s
    ? ((j = (e) => (s.logProductEvent(me, {}), A(e, `smooth`))),
      (t[14] = A),
      (t[15] = s),
      (t[16] = j))
    : (j = t[16]);
  ...
  t[19] !== a || t[20] !== ue
        ...
        let n = null,
          r = () => {
            n ??= window.requestAnimationFrame(() => {
              ...
              (ie((i.left - r.left) / (a > 0 ? a : 1) >= et + nt), ue());
            });
          },
    ...
    : (P = t[21]);
  let F;
  (t[22] === a ? (F = t[23]) : ((F = [a]), (t[22] = a), (t[23] = F)), (0, Q.useEffect)(P, F));
  let pe, he;
  (t[24] !== a || t[25] !== T
    ? ((pe = () => {
        let e = a();
        ...
        let t = new Set(),
          n = new Map(),
          r = new Set(),
          i = T.length === 0 ? [] : T.split(`\0`),
          o = new Set(i),
          s = () => {
            let e = i.findIndex((e) => t.has(e));
            if (e === -1) return;
            let n = (0, Qe.default)(i, (e) => t.has(e)),
              r = new Set(i.slice(e, n + 1));
            ee((e) => (e.size === r.size && [...e].every((e) => r.has(e)) ? e : r));
          },
  ...
  let _e;
  if (
    (t[31] !== D || t[32] !== _ || t[33] !== f
      ? ((_e = [D, _, f]), (t[31] = D), (t[32] = _), (t[33] = f), (t[34] = _e))
      : (_e = t[34]),
    (0, Q.useLayoutEffect)(ge, _e),
    !_ || v == null || typeof document > `u`)
  )
    return null;
  let I;
  t[35] === S
  ...
  t[39] === C
    ? (R = t[40])
    : ((R = C ? { duration: 0 } : { duration: 0.15, ease: [0.23, 1, 0.32, 1] }),
      (t[39] = C),
      (t[40] = R));
  let z;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (e) => {
        (!e && y.current != null) || (g(e), e || m(null));
      }),
      (t[41] = z))
    : (z = t[41]);
  let Se = p?.button,
    Ce = p?.item ?? n[0],
    B;
  t[42] === Ce ? (B = t[43]) : ((B = (0, $.jsx)(Ee, { item: Ce })), (t[42] = Ce), (t[43] = B));
  let we = f == null ? void 0 : !0,
    V;
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = () => {
      ...
      (W = () => {
        (ne(!1), y.current ?? m(null));
      }),
      (t[47] = U),
      (t[48] = W))
    : ((U = t[47]), (W = t[48]));
  let G;
  t[49] !== N || t[50] !== A || t[51] !== n
    ? ((G = (e) => {
        let t = y.current;
        if (t == null) {
          let t = qe(n, e.currentTarget, e.target instanceof Element ? e.target : null);
          t != null && m((e) => (e?.item.id === t.item.id ? e : t));
          return;
        }
    ...
    ? ((K = n.map((e, t) =>
        (0, $.jsx)(
          `button`,
          {
            ...
            "data-scrub-target": f === e.id ? !0 : void 0,
            "aria-current": d.has(e.id) ? `true` : void 0,
            "aria-describedby": h && p?.item.id === e.id ? x : void 0,
            ...
            onClick: (t) => {
              ...
              (m({ button: t.currentTarget, item: e }), g(!0), fe(e));
            },
            onFocus: (t) => {
              (m({ button: t.currentTarget, item: e }), g(!0));
            },
            children: (0, $.jsx)(`span`, {
              ...
              children: (0, $.jsx)(`span`, {
                className: ce(
                  ...
                  d.has(e.id) && f !== e.id && `bg-token-foreground opacity-60`,
                  f === e.id && `bg-token-foreground opacity-100`,
                ),
              }),
            }),
          },
  ...
  t[62] === K
    ...
    : ((q = (0, $.jsx)(`div`, { className: `flex flex-col`, children: K })),
      ...
      (t[63] = q));
  let J;
  t[64] !== N || t[65] !== we || t[66] !== H || t[67] !== G || t[68] !== q
    ? ((J = (0, $.jsx)(`div`, {
        ref: oe,
    ...
    : (J = t[69]);
  let Y;
  t[70] !== h || t[71] !== o || t[72] !== Se || t[73] !== B || t[74] !== J || t[75] !== x
    ? ((Y = (0, $.jsx)(se, {
        align: `center`,
        delayOpen: !0,
        open: h,
  ...
  return (
    t[81] !== v || t[82] !== X
      ? ((De = (0, $e.createPortal)(X, v)), (t[81] = v), (t[82] = X), (t[83] = De))
      : (De = t[83]),
    De
  );
}
