...
function Ee(e) {
  ...
  if (t[0] !== n) {
    ...
    t[6] === n.isHeartbeat
      ? (s = t[7])
      : ((s = n.isHeartbeat
          ? (0, Z.jsx)(l, { className: `icon-xs shrink-0 text-token-description-foreground` })
          : null),
        (t[6] = n.isHeartbeat),
        (t[7] = s));
    let c;
...
function ke(e) {
  switch (e.type) {
    case `app`:
      return (0, Z.jsx)(B, { className: `icon-sm shrink-0 text-token-charts-blue` });
    case `commit`:
      return (0, Z.jsx)(ne, { className: `icon-sm shrink-0` });
    case `file`:
    ...
    case `website`:
      return (0, Z.jsx)(ve, { className: `icon-sm shrink-0` });
  }
}
function Ae(e) {
  ...
  if (t[0] !== n) {
    ...
    for (; i < n.length;) {
      ...
      let r = w(t.label).trim(),
        ...
        c = r,
        l;
      if (k(o) || N(o)) ((s = L(r) ?? B), (c = I(r)));
      else if (r.startsWith(`$`))
        ((s = K()), (c = b(r.startsWith(`$[`) && r.endsWith(`]`) ? r.slice(2, -1) : r.slice(1))));
      else {
        let e = ye(o);
        if (e == null) continue;
        let t = j(e);
        ((s = (t == null ? null : L(t.appId)) ?? (0, Z.jsx)(W, { href: e })), (l = e));
      }
      (e.push(n.slice(a, t.start)),
        e.push((0, Z.jsx)(Se, { className: `first:pl-0`, icon: s, text: c, title: l }, t.start)),
        (a = t.end));
    }
...
function He(e) {
  ...
  let [u, ee] = (0, Q.useState)(l),
    ...
    S = xe(),
    C;
  t[2] === n ? (C = t[3]) : ((C = n.map(Ue).join(`\0`)), (t[2] = n), (t[3] = C));
  let w = C,
    T;
  t[4] !== u || t[5] !== n || t[6] !== c
    ? ((T = n.find((e) => u.has(e.id))?.id ?? c), (t[4] = u), (t[5] = n), (t[6] = c), (t[7] = T))
    : (T = t[7]);
  let E = T,
    me;
  t[8] === E
  ...
  let O = se(D),
    k;
  t[14] !== O || t[15] !== s
    ? ((k = (e) => (s.logProductEvent(le, {}), O(e, `smooth`))),
      (t[14] = O),
      (t[15] = s),
      (t[16] = k))
    : (k = t[16]);
  ...
  t[19] !== i || t[20] !== he
        ...
        let n = null,
          r = () => {
            n ??= window.requestAnimationFrame(() => {
              ...
              (ce((i.left - r.left) / (a > 0 ? a : 1) >= et + nt), he());
            });
          },
    ...
    : (M = t[21]);
  let N;
  (t[22] === i ? (N = t[23]) : ((N = [i]), (t[22] = i), (t[23] = N)), (0, Q.useEffect)(M, N));
  let ve, ye;
  (t[24] !== i || t[25] !== w
    ? ((ve = () => {
        let e = i();
  ...
  let P;
  if (
    (t[31] !== E || t[32] !== g || t[33] !== d
      ? ((P = [E, g, d]), (t[31] = E), (t[32] = g), (t[33] = d), (t[34] = P))
      : (P = t[34]),
    (0, Q.useLayoutEffect)(be, P),
  ...
  t[62] === K
    ...
    : ((q = (0, $.jsx)(`div`, { className: `flex flex-col`, children: K })),
      ...
      (t[63] = q));
  let J;
  t[64] !== j || t[65] !== we || t[66] !== H || t[67] !== G || t[68] !== q
    ? ((J = (0, $.jsx)(`div`, {
        ref: de,
    ...
    : (J = t[69]);
  let Y;
  t[70] !== m || t[71] !== o || t[72] !== Se || t[73] !== B || t[74] !== J || t[75] !== b
    ? ((Y = (0, $.jsx)(ae, {
        align: `center`,
        delayOpen: !0,
        open: m,
