...
import { n as q, r as Te } from "./thread-scroll-controller-context-value-C.js";
var J,
  Y,
  X = e(() => {
    (t(r()),
...
function Ee(e) {
  ...
  if (t[0] !== n) {
    ...
    t[6] === n.isHeartbeat
      ? (s = t[7])
      : ((s = n.isHeartbeat
          ? (0, Z.jsx)(B, { className: `icon-xs shrink-0 text-token-description-foreground` })
          : null),
        (t[6] = n.isHeartbeat),
        (t[7] = s));
    let c;
...
function ke(e) {
  switch (e.type) {
    case `app`:
      return (0, Z.jsx)(K, { className: `icon-sm shrink-0 text-token-charts-blue` });
    case `commit`:
      return (0, Z.jsx)(W, { className: `icon-sm shrink-0` });
    case `file`:
      return (0, Ne.createElement)(ie(e.label ?? void 0), { className: `icon-sm shrink-0` });
    case `google-drive`:
      return (0, Z.jsx)(h, { className: `icon-sm shrink-0` });
    case `image`:
      return (0, Z.jsx)(V, { className: `icon-sm shrink-0` });
    case `pull-request`:
...
function je(e) {
  ...
  if (t[0] !== n) {
    ...
    for (; i < n.length; ) {
      ...
      if (t == null) break;
      i = t.end;
      let r = k(t.label).trim(),
        o = I(t.path),
        s,
        u = r,
        ee;
      if (oe(o) || g(o)) ((s = d(r) ?? K), (u = m(r)));
      else if (r.startsWith(`$`))
        ((s = l()), (u = A(r.startsWith(`$[`) && r.endsWith(`]`) ? r.slice(2, -1) : r.slice(1))));
      else {
        let e = se(o);
        if (e == null) continue;
        let t = b(e);
        ((s = (t == null ? null : d(t.appId)) ?? (0, Z.jsx)(c, { href: e })), (ee = e));
      }
      (e.push(n.slice(a, t.start)),
        e.push((0, Z.jsx)(re, { className: `first:pl-0`, icon: s, text: u, title: ee }, t.start)),
        (a = t.end));
    }
...
function He(e) {
  let t = (0, Ze.c)(84),
    ...
    c = n.at(-1)?.id ?? null,
    l;
  t[0] === c ? (l = t[1]) : ((l = () => new Set(c == null ? [] : [c])), (t[0] = c), (t[1] = l));
  let [u, te] = (0, Q.useState)(l),
    [ne, re] = (0, Q.useState)(!1),
    [d, ie] = (0, Q.useState)(null),
    [f, p] = (0, Q.useState)(null),
    [m, h] = (0, Q.useState)(!1),
    [g, oe] = (0, Q.useState)(!1),
    [_, se] = (0, Q.useState)(null),
    ce = (0, Q.useRef)(null),
    v = (0, Q.useRef)(null),
    y = (0, Q.useRef)(!1),
    b = (0, Q.useId)(),
    ...
    S = ae(),
    ue;
  t[2] === n ? (ue = t[3]) : ((ue = n.map(Ue).join(`\0`)), (t[2] = n), (t[3] = ue));
  let C = ue,
    fe;
  t[4] !== u || t[5] !== n || t[6] !== c
    ? ((fe = n.find((e) => u.has(e.id))?.id ?? c), (t[4] = u), (t[5] = n), (t[6] = c), (t[7] = fe))
    : (fe = t[7]);
  let w = fe,
    T;
  t[8] === w
    ? (T = t[9])
    : ((T = () => {
        v.current ?? Ge(ce.current, w);
      }),
      (t[8] = w),
      (t[9] = T));
  let me = (0, Q.useEffectEvent)(T),
    E;
  ...
  let D = xe(E),
    O;
  t[14] !== D || t[15] !== s
    ? ((O = (e) => (s.logProductEvent(he, {}), D(e, `smooth`))),
      (t[14] = D),
      (t[15] = s),
      (t[16] = O))
    : (O = t[16]);
        ...
        let n = null,
          r = () => {
            n ??= window.requestAnimationFrame(() => {
              ...
              (oe((i.left - r.left) / (a > 0 ? a : 1) >= et + nt), me());
            });
          },
    ...
    ? ((ve = () => {
        ...
        let t = new Set(),
          ...
          s = () => {
            ...
            te((e) => (e.size === r.size && [...e].every((e) => r.has(e)) ? e : r));
          },
  ...
  if (
    (t[31] !== w || t[32] !== g || t[33] !== d
      ? ((P = [w, g, d]), (t[31] = w), (t[32] = g), (t[33] = d), (t[34] = P))
      : (P = t[34]),
  ...
  t[39] === S
    ? (R = t[40])
    : ((R = S ? { duration: 0 } : { duration: 0.15, ease: [0.23, 1, 0.32, 1] }),
      (t[39] = S),
      (t[40] = R));
  let z;
        ...
        (0, $.jsx)(
          `button`,
          {
            ...
            onClick: (t) => {
              ...
              (p({ button: t.currentTarget, item: e }), h(!0), _e(e));
            },
            onFocus: (t) => {
  ...
  t[62] === K
    ...
    : ((q = (0, $.jsx)(`div`, { className: `flex flex-col`, children: K })),
      ...
      (t[63] = q));
  let J;
  t[64] !== A || t[65] !== we || t[66] !== H || t[67] !== G || t[68] !== q
    ? ((J = (0, $.jsx)(`div`, {
        ref: ce,
    ...
    : (J = t[69]);
  let Y;
  t[70] !== m || t[71] !== a || t[72] !== Se || t[73] !== B || t[74] !== J || t[75] !== b
    ? ((Y = (0, $.jsx)(pe, {
        align: `center`,
        delayOpen: !0,
        open: m,
  ...
  return (
    t[81] !== _ || t[82] !== X
      ? ((De = (0, $e.createPortal)(X, _)), (t[81] = _), (t[82] = X), (t[83] = De))
      : (De = t[83]),
    De
  );
}
