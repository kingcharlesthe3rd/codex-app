...
function Ee(e) {
  ...
  if (t[0] !== n) {
    ...
    t[6] === n.isHeartbeat
      ? (s = t[7])
      : ((s = n.isHeartbeat
          ? (0, Z.jsx)(G, { className: `icon-xs shrink-0 text-token-description-foreground` })
          : null),
        (t[6] = n.isHeartbeat),
        (t[7] = s));
    let c;
...
function ke(e) {
  switch (e.type) {
    case `app`:
      return (0, Z.jsx)(v, { className: `icon-sm shrink-0 text-token-charts-blue` });
    case `commit`:
      return (0, Z.jsx)(W, { className: `icon-sm shrink-0` });
    case `file`:
      return (0, Ne.createElement)(H(e.label ?? void 0), { className: `icon-sm shrink-0` });
    case `google-drive`:
    ...
    case `website`:
      return (0, Z.jsx)(de, { className: `icon-sm shrink-0` });
  }
}
function Ae(e) {
...
function je(e) {
  ...
  if (t[0] !== n) {
    ...
    for (; i < n.length; ) {
      ...
      if (t == null) break;
      i = t.end;
      let r = o(t.label).trim(),
        s = _(t.path),
        c,
        u = r,
        d;
      if (ce(s) || E(s)) ((c = w(r) ?? v), (u = g(r)));
      else if (r.startsWith(`$`))
        ((c = P()), (u = l(r.startsWith(`$[`) && r.endsWith(`]`) ? r.slice(2, -1) : r.slice(1))));
      else {
        let e = z(s);
        if (e == null) continue;
        let t = be(e);
        ((c = (t == null ? null : w(t.appId)) ?? (0, Z.jsx)(I, { href: e })), (d = e));
      }
      (e.push(n.slice(a, t.start)),
        e.push((0, Z.jsx)(R, { className: `first:pl-0`, icon: c, text: u, title: d }, t.start)),
        (a = t.end));
    }
...
function He(e) {
  let t = (0, Ze.c)(84),
    { items: n, onRevealItem: a } = e,
    { getScrollElement: o } = Te(),
    s = (0, Q.useContext)(ve),
    l = u(c),
    d = n.at(-1)?.id ?? null,
    f;
  t[0] === d ? (f = t[1]) : ((f = () => new Set(d == null ? [] : [d])), (t[0] = d), (t[1] = f));
  let [p, ee] = (0, Q.useState)(f),
    [te, re] = (0, Q.useState)(!1),
    [m, ie] = (0, Q.useState)(null),
    [h, g] = (0, Q.useState)(null),
    [_, v] = (0, Q.useState)(!1),
    [ae, oe] = (0, Q.useState)(!1),
    [y, se] = (0, Q.useState)(null),
    ce = (0, Q.useRef)(null),
    b = (0, Q.useRef)(null),
    x = (0, Q.useRef)(!1),
    S = (0, Q.useId)(),
    ...
    w = ne(),
    le;
  t[2] === n ? (le = t[3]) : ((le = n.map(Ue).join(`\0`)), (t[2] = n), (t[3] = le));
  let T = le,
    de;
  t[4] !== p || t[5] !== n || t[6] !== d
    ? ((de = n.find((e) => p.has(e.id))?.id ?? d), (t[4] = p), (t[5] = n), (t[6] = d), (t[7] = de))
    : (de = t[7]);
  let E = de,
    fe;
  t[8] === E
    ? (fe = t[9])
    : ((fe = () => {
        b.current ?? Ge(ce.current, E);
      }),
      (t[8] = E),
      (t[9] = fe));
  let pe = (0, Q.useEffectEvent)(fe),
    D;
  t[10] !== o || t[11] !== a || t[12] !== w
    ? ((D = async (e, t) => {
        let n = o();
        if (n == null) return;
        let r = We(n, e.id);
        if (r == null && a != null) {
          (await a(e), (r = We(n, e.id)), Je(r, w));
          return;
        }
        (r?.scrollIntoView({ behavior: t, block: `start` }), Je(r, w));
      }),
      (t[10] = o),
      (t[11] = a),
      (t[12] = w),
  ...
  let O = ge(D),
    k;
  t[14] !== O || t[15] !== l
    ? ((k = (e) => (l.logProductEvent(_e, {}), O(e, `smooth`))),
      (t[14] = O),
      (t[15] = l),
      (t[16] = k))
    : (k = t[16]);
  ...
  t[19] !== o || t[20] !== pe
    ? ((M = () => {
        ...
        let n = null,
          r = () => {
            n ??= window.requestAnimationFrame(() => {
              ((n = null), se(e.parentElement));
              let r = e.getBoundingClientRect(),
                i = t.getBoundingClientRect(),
                a = e.offsetWidth > 0 ? r.width / e.offsetWidth : 1;
              (oe((i.left - r.left) / (a > 0 ? a : 1) >= et + nt), pe());
            });
          },
        ...
        return (
          a.observe(e.firstElementChild ?? e, { attributes: !0, attributeFilter: [`style`] }),
    ...
    : (M = t[21]);
  let N;
  (t[22] === o ? (N = t[23]) : ((N = [o]), (t[22] = o), (t[23] = N)), (0, Q.useEffect)(M, N));
  let P, F;
  (t[24] !== o || t[25] !== T
    ? ((P = () => {
        let e = o();
  ...
  let L;
  if (
    (t[31] !== E || t[32] !== ae || t[33] !== m
      ? ((L = [E, ae, m]), (t[31] = E), (t[32] = ae), (t[33] = m), (t[34] = L))
      : (L = t[34]),
    (0, Q.useLayoutEffect)(I, L),
    !ae || y == null || typeof document > `u`)
  )
    return null;
  let R;
  t[35] === C
  ...
  t[39] === w
    ? (V = t[40])
    : ((V = w ? { duration: 0 } : { duration: 0.15, ease: [0.23, 1, 0.32, 1] }),
      (t[39] = w),
      (t[40] = V));
  let H;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (e) => {
        (!e && b.current != null) || (v(e), e || g(null));
      }),
      (t[41] = H))
    : (H = t[41]);
  let ye = h?.button,
    be = h?.item ?? n[0],
    U;
  t[42] === be ? (U = t[43]) : ((U = (0, $.jsx)(Ee, { item: be })), (t[42] = be), (t[43] = U));
  let xe = m == null ? void 0 : !0,
    Se;
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ce = () => {
      ...
      (we = () => {
        (re(!1), b.current ?? g(null));
      }),
      (t[47] = Ce),
      (t[48] = we))
    : ((Ce = t[47]), (we = t[48]));
  let G;
  t[49] !== j || t[50] !== O || t[51] !== n
    ? ((G = (e) => {
        let t = b.current;
        if (t == null) {
          let t = qe(n, e.currentTarget, e.target instanceof Element ? e.target : null);
          t != null && g((e) => (e?.item.id === t.item.id ? e : t));
          return;
        }
    ...
    ? ((K = n.map((e, t) =>
        (0, $.jsx)(
          `button`,
          {
            ...
            "data-scrub-target": m === e.id ? !0 : void 0,
            "aria-current": p.has(e.id) ? `true` : void 0,
            "aria-describedby": _ && h?.item.id === e.id ? S : void 0,
            ...
            onClick: (t) => {
              ...
              (g({ button: t.currentTarget, item: e }), v(!0), he(e));
            },
            onFocus: (t) => {
              (g({ button: t.currentTarget, item: e }), v(!0));
            },
            children: (0, $.jsx)(`span`, {
              ...
              children: (0, $.jsx)(`span`, {
                className: i(
                  ...
                  p.has(e.id) && m !== e.id && `bg-token-foreground opacity-60`,
                  m === e.id && `bg-token-foreground opacity-100`,
                ),
              }),
            }),
          },
  ...
  t[62] === K
    ...
    : ((q = (0, $.jsx)(`div`, { className: `flex flex-col`, children: K })),
      ...
      (t[63] = q));
  let J;
  t[64] !== j || t[65] !== xe || t[66] !== W || t[67] !== G || t[68] !== q
    ? ((J = (0, $.jsx)(`div`, {
        ref: ce,
        ...
        onPointerCancelCapture: j,
        onPointerDownCapture: W,
        onPointerEnter: Ce,
        onPointerLeave: we,
        onPointerMove: G,
        onPointerUpCapture: j,
        children: q,
      })),
      (t[64] = j),
      (t[65] = xe),
    ...
    : (J = t[69]);
  let Y;
  t[70] !== _ || t[71] !== s || t[72] !== ye || t[73] !== U || t[74] !== J || t[75] !== S
    ? ((Y = (0, $.jsx)(me, {
        align: `center`,
        delayOpen: !0,
        open: _,
  ...
  return (
    t[81] !== y || t[82] !== X
      ? ((De = (0, $e.createPortal)(X, y)), (t[81] = y), (t[82] = X), (t[83] = De))
      : (De = t[83]),
    De
  );
}
