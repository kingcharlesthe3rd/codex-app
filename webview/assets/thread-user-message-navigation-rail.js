...
function Ee(e) {
  ...
  if (t[0] !== n) {
    ...
    t[6] === n.isHeartbeat
      ? (s = t[7])
      : ((s = n.isHeartbeat
          ? (0, Z.jsx)(te, { className: `icon-xs shrink-0 text-token-description-foreground` })
          : null),
        (t[6] = n.isHeartbeat),
        (t[7] = s));
    let c;
...
function ke(e) {
  switch (e.type) {
    ...
    case `file`:
      return (0, Ne.createElement)(U(e.label ?? void 0), { className: `icon-sm shrink-0` });
    case `google-drive`:
  ...
  if (t[0] !== n) {
    ...
    for (; i < n.length; ) {
      ...
      if (j(o) || O(o)) ((s = I(r) ?? H), (c = ye(r)));
        ...
        ((s = W()), (c = m(r.startsWith(`$[`) && r.endsWith(`]`) ? r.slice(2, -1) : r.slice(1))));
      else {
        let e = B(o);
        if (e == null) continue;
        let t = R(e);
        ((s = (t == null ? null : I(t.appId)) ?? (0, Z.jsx)(G, { href: e })), (l = e));
      }
...
function He(e) {
  ...
  let [u, ee] = (0, Q.useState)(l),
    ...
    S = oe(),
    fe;
  t[2] === n ? (fe = t[3]) : ((fe = n.map(Ue).join(`\0`)), (t[2] = n), (t[3] = fe));
  let C = fe,
    me;
  t[4] !== u || t[5] !== n || t[6] !== c
    ? ((me = n.find((e) => u.has(e.id))?.id ?? c), (t[4] = u), (t[5] = n), (t[6] = c), (t[7] = me))
    : (me = t[7]);
  let w = me,
    he;
  t[8] === w
  ...
  t[19] !== i || t[20] !== ge
    ...
    : (A = t[21]);
  let j;
  (t[22] === i ? (j = t[23]) : ((j = [i]), (t[22] = i), (t[23] = j)), (0, Q.useEffect)(A, j));
  let M, N;
  (t[24] !== i || t[25] !== C
    ? ((M = () => {
        let e = i();
  ...
  t[64] !== k || t[65] !== Ce || t[66] !== U || t[67] !== G || t[68] !== q
    ...
    : (J = t[69]);
  let Y;
  t[70] !== m || t[71] !== a || t[72] !== xe || t[73] !== V || t[74] !== J || t[75] !== b
    ? ((Y = (0, $.jsx)(ce, {
        align: `center`,
        delayOpen: !0,
        open: m,
