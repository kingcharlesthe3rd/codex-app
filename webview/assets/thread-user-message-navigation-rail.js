...
import { n as K, r as Ee } from "./thread-scroll-controller-context-value-B.js";
var q,
  J,
  Y = e(() => {
    (t(k()),
...
function De(e) {
  ...
  if (t[0] !== n) {
    ...
    if (e.length === 0) {
      ...
      let n;
      (t[4] === e ? (n = t[5]) : ((n = (0, Z.jsx)(je, { label: e })), (t[4] = e), (t[5] = n)),
        (s = n));
    }
    let c;
    t[6] === n.isHeartbeat
      ? (c = t[7])
      : ((c = n.isHeartbeat
          ? (0, Z.jsx)(be, { className: `icon-xs shrink-0 text-token-description-foreground` })
          : null),
        (t[6] = n.isHeartbeat),
        (t[7] = c));
    let l;
    t[8] === s
      ? (l = t[9])
      : ((l = (0, Z.jsx)(`span`, { className: `min-w-0 truncate`, children: s })),
        (t[8] = s),
        (t[9] = l));
    let u;
    (t[10] !== c || t[11] !== l
...
function Oe(e) {
  ...
  t[4] === i
    ? (a = t[5])
    : ((a = (0, Z.jsx)(`span`, { className: `max-w-36 truncate`, children: i })),
      (t[4] = i),
      (t[5] = a));
  let o;
  return (
...
function ke(e) {
  switch (e.type) {
    case `app`:
      return (0, Z.jsx)(I, { className: `icon-sm shrink-0 text-token-charts-blue` });
    case `commit`:
      return (0, Z.jsx)(W, { className: `icon-sm shrink-0` });
    case `file`:
      return (0, Ne.createElement)(v(e.label ?? void 0), { className: `icon-sm shrink-0` });
    case `google-drive`:
      return (0, Z.jsx)(S, { className: `icon-sm shrink-0` });
    case `image`:
      return (0, Z.jsx)(Ce, { className: `icon-sm shrink-0` });
    case `pull-request`:
      return (0, Z.jsx)(H, { className: `icon-sm shrink-0` });
    case `review`:
      return (0, Z.jsx)(J, { className: `icon-sm shrink-0` });
    case `website`:
      return (0, Z.jsx)(i, { className: `icon-sm shrink-0` });
  }
}
function Ae(e) {
...
function je(e) {
  ...
  if (t[0] !== r) {
    ...
    for (; a < r.length; ) {
      ...
      if (t == null) break;
      a = t.end;
      let i = F(t.label).trim(),
        s = me(t.path),
        c,
        d = i,
        f;
      if (L(s) || A(s)) ((c = j(i) ?? I), (d = M(i)));
      else if (i.startsWith(`$`))
        ((c = _()), (d = ie(i.startsWith(`$[`) && i.endsWith(`]`) ? i.slice(2, -1) : i.slice(1))));
      else {
        let e = u(s);
        if (e == null) continue;
        let t = y(e);
        ((c = (t == null ? null : j(t.appId)) ?? (0, Z.jsx)(l, { href: e })), (f = e));
      }
      (e.push(r.slice(o, t.start)),
        e.push((0, Z.jsx)(ye, { className: `first:pl-0`, icon: c, text: d, title: f }, t.start)),
        (o = t.end));
    }
    (e.push(r.slice(o)), (i = (0, Z.jsx)(Z.Fragment, { children: e })), (t[0] = r), (t[1] = i));
  } else i = t[1];
  return i;
}
var Me,
...
function Ve(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, $.jsx)(He, { items: n, onRevealItem: r })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
function He(e) {
  let t = (0, Ze.c)(84),
    { items: n, onRevealItem: r } = e,
    { getScrollElement: i } = Ee(),
    a = (0, Q.useContext)(Te),
    o = se(ne),
    s = n.at(-1)?.id ?? null,
    c;
  t[0] === s ? (c = t[1]) : ((c = () => new Set(s == null ? [] : [s])), (t[0] = s), (t[1] = c));
  let [l, u] = (0, Q.useState)(c),
    [f, ee] = (0, Q.useState)(!1),
    [p, te] = (0, Q.useState)(null),
    [m, h] = (0, Q.useState)(null),
    [g, _] = (0, Q.useState)(!1),
    [v, ie] = (0, Q.useState)(!1),
    [y, ae] = (0, Q.useState)(null),
    oe = (0, Q.useRef)(null),
    b = (0, Q.useRef)(null),
    x = (0, Q.useRef)(!1),
    S = (0, Q.useId)(),
    ...
    w = le(),
    T;
  t[2] === n ? (T = t[3]) : ((T = n.map(Ue).join(`\0`)), (t[2] = n), (t[3] = T));
  let E = T,
    ue;
  t[4] !== l || t[5] !== n || t[6] !== s
    ? ((ue = n.find((e) => l.has(e.id))?.id ?? s), (t[4] = l), (t[5] = n), (t[6] = s), (t[7] = ue))
    : (ue = t[7]);
  let D = ue,
    de;
  t[8] === D
    ? (de = t[9])
    : ((de = () => {
        b.current ?? Ge(oe.current, D);
      }),
      (t[8] = D),
      (t[9] = de));
  let fe = (0, Q.useEffectEvent)(de),
    pe;
  t[10] !== i || t[11] !== r || t[12] !== w
    ? ((pe = async (e, t) => {
        let n = i();
        if (n == null) return;
        let a = We(n, e.id);
        if (a == null && r != null) {
          (await r(e), (a = We(n, e.id)), Je(a, w));
          return;
        }
        (a?.scrollIntoView({ behavior: t, block: `start` }), Je(a, w));
      }),
      (t[10] = i),
      (t[11] = r),
      (t[12] = w),
  ...
  let O = ge(pe),
    me;
  t[14] !== O || t[15] !== o
    ? ((me = (e) => (o.logProductEvent(re, {}), O(e, `smooth`))),
      (t[14] = O),
      (t[15] = o),
      (t[16] = me))
    : (me = t[16]);
  ...
  t[19] !== i || t[20] !== fe
        ...
        let n = null,
          r = () => {
            n ??= window.requestAnimationFrame(() => {
              ((n = null), ae(e.parentElement));
              let r = e.getBoundingClientRect(),
                i = t.getBoundingClientRect(),
                a = e.offsetWidth > 0 ? r.width / e.offsetWidth : 1;
              (ie((i.left - r.left) / (a > 0 ? a : 1) >= et + nt), fe());
            });
          },
    ...
    : (j = t[21]);
  let M;
  (t[22] === i ? (M = t[23]) : ((M = [i]), (t[22] = i), (t[23] = M)), (0, Q.useEffect)(j, M));
  let N, P;
  (t[24] !== i || t[25] !== E
    ? ((N = () => {
        let e = i();
        ...
        let t = new Set(),
          ...
          s = () => {
            ...
            u((e) => (e.size === r.size && [...e].every((e) => r.has(e)) ? e : r));
          },
        ...
        return (
          d.observe(e, { childList: !0, subtree: !0 }),
          l(),
          () => {
  ...
  let I;
  if (
    (t[31] !== D || t[32] !== v || t[33] !== p
      ? ((I = [D, v, p]), (t[31] = D), (t[32] = v), (t[33] = p), (t[34] = I))
      : (I = t[34]),
    (0, Q.useLayoutEffect)(F, I),
    !v || y == null || typeof document > `u`)
  )
    return null;
  let L;
  t[35] === C
  ...
  t[39] === w
    ? (B = t[40])
    : ((B = w ? { duration: 0 } : { duration: 0.15, ease: [0.23, 1, 0.32, 1] }),
      (t[39] = w),
      (t[40] = B));
  let V;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (e) => {
        (!e && b.current != null) || (_(e), e || h(null));
      }),
      (t[41] = V))
    : (V = t[41]);
  let ye = m?.button,
    be = m?.item ?? n[0],
    H;
  t[42] === be ? (H = t[43]) : ((H = (0, $.jsx)(De, { item: be })), (t[42] = be), (t[43] = H));
  let xe = p == null ? void 0 : !0,
    Se;
  ...
  t[45] === n
    ...
    : ((U = (e) => {
        ...
        let t = qe(n, e.currentTarget, e.target instanceof Element ? e.target : null);
        t != null &&
          ((x.current = !1),
          ee(!0),
          (b.current = {
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ce = () => {
      ...
      (we = () => {
        (ee(!1), b.current ?? h(null));
      }),
      (t[47] = Ce),
      (t[48] = we))
    : ((Ce = t[47]), (we = t[48]));
  let W;
  t[49] !== A || t[50] !== O || t[51] !== n
    ? ((W = (e) => {
        let t = b.current;
        if (t == null) {
          let t = qe(n, e.currentTarget, e.target instanceof Element ? e.target : null);
    ...
    ? ((G = n.map((e, t) =>
        (0, $.jsx)(
          `button`,
          {
            ...
            "aria-current": l.has(e.id) ? `true` : void 0,
            "aria-describedby": g && m?.item.id === e.id ? S : void 0,
            ...
            onClick: (t) => {
              ...
              (h({ button: t.currentTarget, item: e }), _(!0), he(e));
            },
            onFocus: (t) => {
            ...
            children: (0, $.jsx)(`span`, {
              ...
              children: (0, $.jsx)(`span`, {
                className: _e(
                  ...
                  l.has(e.id) && p !== e.id && `bg-token-foreground opacity-60`,
  ...
  t[62] === G
    ? (K = t[63])
    : ((K = (0, $.jsx)(`div`, { className: `flex flex-col`, children: G })),
      (t[62] = G),
      (t[63] = K));
  let q;
  t[64] !== A || t[65] !== xe || t[66] !== U || t[67] !== W || t[68] !== K
    ? ((q = (0, $.jsx)(`div`, {
        ref: oe,
    ...
    : (q = t[69]);
  let J;
  t[70] !== g || t[71] !== a || t[72] !== ye || t[73] !== H || t[74] !== q || t[75] !== S
    ? ((J = (0, $.jsx)(ve, {
        align: `center`,
        delayOpen: !0,
        open: g,
  ...
  return (
    t[81] !== y || t[82] !== Y
      ? ((X = (0, $e.createPortal)(Y, y)), (t[81] = y), (t[82] = Y), (t[83] = X))
      : (X = t[83]),
    X
  );
}
...
function Ke(e, t) {
  return t == null || e == null
    ? null
    : e.querySelector(`[data-thread-user-message-navigation-item-id="${Xe(t)}"]`);
}
function qe(e, t, n) {
...
function Je(e, t) {
  (
    ...
    [{ backgroundColor: at }, { backgroundColor: at, offset: 0.35 }, { backgroundColor: ot }],
...
function Ye(e) {
  return e.some((e) =>
    [...e.addedNodes, ...e.removedNodes].some(
      (e) => e instanceof HTMLElement && (e.matches(it) || e.querySelector(it) != null),
    ),
  );
}
function Xe(e) {
