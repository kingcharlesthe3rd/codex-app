...
import { of as it, sf as at } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
import {
  n as ot,
  t as st,
} from "./app-initial~app-main~remote-conversation-page~hotkey-window-detail-layout~local-conversation-page.js";
function G(e, t) {
  e != null &&
...
function ct(e) {
  ...
  let h;
  t[2] !== r || t[3] !== a
    ? ((h = (0, J.jsx)(`label`, { className: `sr-only`, htmlFor: r, children: a })),
      (t[2] = r),
      (t[3] = a),
      (t[4] = h))
    : (h = t[4]);
...
function lt(e) {
  ...
  let g;
  t[12] !== f || t[13] !== h
    ? ((g = (0, J.jsxs)(`div`, { className: `flex items-center gap-3`, children: [f, h] })),
      (t[12] = f),
      (t[13] = h),
      (t[14] = g))
    : (g = t[14]);
...
function dt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, J.jsx)(`div`, { className: `mr-2 ml-2 h-4 w-px bg-token-border` })), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, J.jsx)(Ke, { className: `size-4 text-token-foreground` })), (t[1] = a))
    : (a = t[1]);
  let o;
  return (
    t[2] !== n || t[3] !== r
...
function ft() {
  ...
  e[2] !== i || e[3] !== a || e[4] !== t
    ? ((s = () => {
        (a === `browser` && (N(t, i), G(i, { type: `close-find` }), O(t, Te)), me(t));
      }),
      (e[2] = i),
      (e[3] = a),
      (e[4] = t),
  ...
  return (
    e[6] !== o || e[7] !== s
      ? ((c = (0, mt.jsx)(dt, { label: o, onClose: s })), (e[6] = o), (e[7] = s), (e[8] = c))
      : (c = e[8]),
    c
  );
}
...
function gt() {
  ...
  e[0] !== i || e[1] !== o || e[2] !== s || e[3] !== t
    ? ((c = (e) => {
        ...
        (j(t, e), e === `browser` && s.length > 0 && G(i, { type: `set-find-query`, query: s }));
      }),
      (e[0] = i),
      (e[1] = o),
      (e[2] = s),
...
function Ct() {
  let e = (0, kt.c)(33),
    ...
    m,
    h;
  e[0] !== s || e[1] !== l || e[2] !== o || e[3] !== d || e[4] !== f || e[5] !== c || e[6] !== t
    ? ((m = tt(t)),
      (h = Tt({
  ...
  (e[12] !== _ || e[13] !== t || e[14] !== b || e[15] !== S
    ? ((C = [_, b, S, t]), (e[12] = _), (e[13] = t), (e[14] = b), (e[15] = S), (e[16] = C))
    : (C = e[16]),
    (0, At.useEffect)(y, C));
  let w;
  e[17] !== s ||
...
function Tt({ activeTabs: e, browserConversationId: t, openPanels: n, tabs: r }) {
  if (t == null) return null;
  for (let r of ce) {
    if (!n[r]) continue;
    let i = $e(e[r], t);
...
function Lt() {
  ...
  let h;
  return (
    e[9] !== l || e[10] !== c || e[11] !== d || e[12] !== f || e[13] !== p || e[14] !== m
      ? ((h = (0, zt.jsx)(lt, {
          isVisible: l,
          matches: c,
          nextLabel: d,
...
function Vt() {
  ...
  return (
    e[7] !== i || e[8] !== l
      ? ((d = (0, Ut.jsx)(ut, { isVisible: i, label: l })), (e[7] = i), (e[8] = l), (e[9] = d))
      : (d = e[9]),
    d
  );
}
...
function Gt(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, Q.jsx)(yt, { className: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
...
function an(e) {
  ...
  (t[15] !== a || t[16] !== l
    ...
    (0, $.useEffect)(x, C));
  let w;
  t[19] !== o || t[20] !== s.bytesEstimate || t[21] !== s.fileCount || t[22] !== s.lineCount
    ? ((w = () => {
    ...
    : (w = t[23]);
  let T;
  (t[24] !== o || t[25] !== s ? ((T = [o, s]), (t[24] = o), (t[25] = s), (t[26] = T)) : (T = t[26]),
    (0, $.useEffect)(w, T));
  let E, O;
  (t[27] === o
    ? ((E = t[28]), (O = t[29]))
  ...
  t[37] !== o || t[38] !== a || t[39] !== l
    ? ((N = (e) => {
        if (e.hostId !== o || !l || a.value.routeKind !== `local-thread`) return;
  ...
  let I;
  return (
    t[44] === a ? (I = t[45]) : ((I = [a]), (t[44] = a), (t[45] = I)), (0, $.useEffect)(F, I), null
  );
}
function on(e, t) {
