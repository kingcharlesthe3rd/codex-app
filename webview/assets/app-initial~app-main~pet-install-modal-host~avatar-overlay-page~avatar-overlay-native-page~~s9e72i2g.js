...
function g(e) {
  let t = (0, _.c)(9),
    r = a(n),
    i = l(o.selectedAvatarId),
    s;
  t[0] !== e || t[1] !== i ? ((s = m(i, e)), (t[0] = e), (t[1] = i), (t[2] = s)) : (s = t[2]);
  let c;
  t[3] === r
    ? (c = t[4])
    : ((c = (e) => {
        u(r, o.selectedAvatarId, e);
      }),
      (t[3] = r),
      (t[4] = c));
  let d;
  return (
    t[5] !== i || t[6] !== s || t[7] !== c
      ? ((d = { selectedAvatar: s, selectedAvatarId: i, setSelectedAvatarId: c }),
        (t[5] = i),
        (t[6] = s),
        (t[7] = c),
        (t[8] = d))
