...
function fe(e) {
  switch (e) {
    case `hot`:
      return O.CODEX_THREAD_SWITCH_KIND_HOT;
    case `cold`:
      return O.CODEX_THREAD_SWITCH_KIND_COLD;
  }
}
var A,
  j,
            ...
            case `thread_switch_completed`: {
              ...
              ((this.pendingThreadSwitch = null),
                C(e, de, {
                  ...
                  switchKind: fe(t.defaults.needsResume ? `cold` : `hot`),
...
function he({ isPinned: e, onPinnedChange: t }) {
  return {
...
function ge({ isPinned: e, hasUnreadTurn: t, ariaLabel: n, onPin: r, onUnpin: i }) {
  if (t)
    return {
      rest: null,
      hover: (0, U.jsx)(`span`, { "aria-hidden": !0, className: `block h-5 w-5` }),
    };
  let a = (0, U.jsx)(z, { isPinned: e, ariaLabel: n, onPin: r, onUnpin: i });
...
function J(e) {
  ...
  t[12] === d
    ? (v = t[13])
    : ((v = (0, X.jsx)(re, { className: `sr-only`, children: d })), (t[12] = d), (t[13] = v));
  let y;
  t[14] !== p || t[15] !== d
    ? ((y = (0, X.jsx)(g, { children: (0, X.jsx)(ne, { title: d, subtitle: p }) })),
      (t[14] = p),
      (t[15] = d),
      (t[16] = y))
    : (y = t[16]);
  ...
  t[20] === b
    ? (S = t[21])
    : ((S = (0, X.jsx)(h, { color: `ghost`, type: `button`, onClick: b, children: x })),
      (t[20] = b),
      (t[21] = S));
  let C;
  t[22] === s
  ...
  let w;
  t[24] !== S || t[25] !== C
    ? ((w = (0, X.jsx)(g, { children: (0, X.jsxs)(ie, { children: [S, C] }) })),
      (t[24] = S),
      (t[25] = C),
      (t[26] = w))
    : (w = t[26]);
  ...
  t[27] !== w || t[28] !== _ || t[29] !== v || t[30] !== y
    ? ((T = (0, X.jsxs)(ee, { as: `form`, onSubmit: _, children: [v, y, w] })),
      (t[27] = w),
      (t[28] = _),
      (t[29] = v),
      (t[30] = y),
...
function xe(e) {
  let t = (0, Z.c)(6),
    { conversationId: n } = e,
    r = E(`459748632`) && n != null,
    i;
  t[0] !== r || t[1] !== n
    ? ((i = () => {
        !r || n == null || s.dispatchMessage(`open-in-new-window`, { path: l(n) });
      }),
      (t[0] = r),
      (t[1] = n),
      (t[2] = i))
...
var Q,
  ...
  we = e(() => {
    (u(),
      ...
      a(),
      N(),
      (Q = n(r, (e, { get: t }) => t(ae, e)?.type ?? null)),
      ($ = n(r, (e, { get: t }) =>
        Ce({
          hasConversation: t(y, e),
          hostId: t(b, e),
          latestTurnId: t(w, e),
          latestTurnStatus: t(le, e),
