import { n as e, r as t, s as n } from "./rolldown-runtime.js";
import {
  D as r,
  I as i,
  L as a,
...
function ke(e) {
  ...
  return (
    t[0] === i
      ? (s = t[1])
      : ((s = (0, je.jsx)(je.Fragment, { children: i })), (t[0] = i), (t[1] = s)),
    s
  );
}
var Ae,
    ...
    ((U = n(s(), 1)),
      ...
      (ze = (e) => {
        let {
          ...
          s = U.useRef(null),
          c = U.useRef(null),
          [l, u] = A({ prop: r, defaultProp: i ?? !1, onChange: a, caller: Fe });
        return (0, W.jsx)(Re, {
          scope: t,
          triggerRef: s,
          contentRef: c,
      ...
      (qe = U.forwardRef((e, t) => {
        ...
        return a.modal
          ? (0, W.jsx)(f, { present: r || a.open, children: (0, W.jsx)(Ye, { ...i, ref: t }) })
          : null;
      })),
      (qe.displayName = Ke),
      ...
      (Xe = U.forwardRef((e, t) => {
        ...
        return (0, W.jsx)(f, {
          present: r || a.open,
          children: a.modal ? (0, W.jsx)(Ze, { ...i, ref: t }) : (0, W.jsx)(Qe, { ...i, ref: t }),
        });
      })),
      (Xe.displayName = K),
      (Ze = U.forwardRef((e, t) => {
            ...
            children: [
              ...
              (0, W.jsxs)(W.Fragment, {
                children: [
                  ...
                  (0, W.jsx)(dt, { contentRef: c, descriptionId: s.descriptionId }),
                ],
              }),
            ],
          })
      ...
      ([st, ct] = ee(ot, { contentName: K, titleName: et, docsSlug: `dialog` })),
      (lt = ({ titleId: e }) => {
        let t = ct(ot),
...
function Dt(e) {
  let t = (0, q.c)(2),
    n;
  return (t[0] === e ? (n = t[1]) : ((n = (0, J.jsx)(_t, { ...e })), (t[0] = e), (t[1] = n)), n);
}
function Ot(e) {
  let t = (0, q.c)(2),
    n;
  return (t[0] === e ? (n = t[1]) : ((n = (0, J.jsx)(vt, { ...e })), (t[0] = e), (t[1] = n)), n);
}
function kt(e) {
  let t = (0, q.c)(8),
    n,
...
function At(e) {
  let t = (0, q.c)(45),
    ...
    v = f === void 0 ? !1 : f,
    y = p === void 0 ? !1 : p,
    { className: b, onPointerDown: x, onPointerDownOutside: S, style: C, ...w } = h,
    T = ue(),
    E = H(
    ...
    ? ((ne = g
        ? (0, J.jsxs)(yt, {
            ...
            children: [
              ...
              o ? (0, J.jsx)(`span`, { className: `sr-only`, children: o }) : null,
            ],
          })
        : null),
      (t[0] = a),
  ...
  let N;
  t[10] === M ? (N = t[11]) : ((N = (0, J.jsx)(ht, { className: M })), (t[10] = M), (t[11] = N));
  let se = Ne,
    ce = H(
      E,
      !v && D,
  ...
  t[12] !== l || t[13] !== y || t[14] !== T
    ? ((P = y && l == null ? { height: `calc(100dvh / ${T})`, width: `calc(100vw / ${T})` } : null),
      (t[12] = l),
      (t[13] = y),
      (t[14] = T),
      (t[15] = P))
  ...
  t[16] !== C || t[17] !== le || t[18] !== P
    ? ((F = { zoom: le, ...P, ...C }), (t[16] = C), (t[17] = le), (t[18] = P), (t[19] = F))
    : (F = t[19]);
  let I;
  t[20] !== S || t[21] !== _
    ? ((I = (e) => {
...
function Y(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Z.jsx)(`span`, { className: qt, children: n })), (t[0] = n), (t[1] = r)),
    r
  );
}
function Lt(e) {
  ...
  t[7] === m
    ? (v = t[8])
    : ((v = m ? (0, Z.jsx)(Y, { name: `DialogHeader` }) : null), (t[7] = m), (t[8] = v));
  let y;
  t[9] !== n || t[10] !== s || t[11] !== o
    ? ((y = n
        ? (0, Z.jsx)(`span`, {
  ...
  t[13] !== r || t[14] !== l || t[15] !== _
    ? ((b = r
        ? (0, Z.jsx)(`div`, { className: H(_, `min-w-0 font-semibold`, l), children: r })
        : null),
      (t[13] = r),
      (t[14] = l),
      (t[15] = _),
...
function Rt(e) {
  ...
  if (e.as === `form`) {
    ...
    t[6] === a
      ? (i = t[7])
      : ((i = a ? (0, Z.jsx)(Y, { name: `DialogBody` }) : null), (t[6] = a), (t[7] = i));
    let o;
    return (
  ...
  t[15] === a
    ? (l = t[16])
    : ((l = a ? (0, Z.jsx)(Y, { name: `DialogBody` }) : null), (t[15] = a), (t[16] = l));
  let u;
  return (
...
function zt(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== a) {
    ...
    ((l = H(`flex w-full items-center justify-end gap-3`, e && Q, r)),
      t[9] === e
        ? (u = t[10])
        : ((u = e ? (0, Z.jsx)(Y, { name: `DialogFooter` }) : null), (t[9] = e), (t[10] = u)),
      (d = (0, Z.jsx)(ke, {
        browser: !0,
        chromeExtension: !0,
        electron: !0,
...
function Vt(e) {
  ...
  t[3] === i
    ? (o = t[4])
    : ((o = i ? (0, Z.jsx)(Y, { name: `DialogSection` }) : null), (t[3] = i), (t[4] = o));
  let s;
  return (
    t[5] !== n || t[6] !== a || t[7] !== o
...
function Ht(e) {
  ...
  t[3] === i
    ? (o = t[4])
    : ((o = i ? (0, Z.jsx)(Y, { name: `FormRow` }) : null), (t[3] = i), (t[4] = o));
  let s;
  return (
    t[5] !== n || t[6] !== a || t[7] !== o
      ? ((s = (0, Z.jsxs)(`div`, { className: a, children: [o, n] })),
...
function Ut(e) {
  ...
  t[0] === r
    ? ((i = t[1]), (a = t[2]))
    : ((i = It()), (a = H(`flex flex-col gap-2`, i && Q, r)), (t[0] = r), (t[1] = i), (t[2] = a));
  let o;
  t[3] === i
    ? (o = t[4])
    : ((o = i ? (0, Z.jsx)(Y, { name: `FieldStack` }) : null), (t[3] = i), (t[4] = o));
  let s;
  return (
    t[5] !== n || t[6] !== a || t[7] !== o
      ? ((s = (0, Z.jsxs)(`div`, { className: a, children: [o, n] })),
...
function on(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, cn.jsx)(o, { className: `icon-2xs block shrink-0` })), (t[4] = o), (t[5] = c));
  let l;
  return (
    t[6] !== r || t[7] !== s || t[8] !== c
      ? ((l = (0, cn.jsx)(`button`, {
...
function dn({ isPinned: e, hasUnreadTurn: t, ariaLabel: n, onPin: r, onUnpin: i }) {
  if (t)
    return {
      rest: null,
      hover: (0, fn.jsx)(`span`, { "aria-hidden": !0, className: `block h-5 w-5` }),
    };
...
function yn(e) {
  ...
  t[12] === d
    ? (g = t[13])
    : ((g = (0, $.jsx)(Dt, { className: `sr-only`, children: d })), (t[12] = d), (t[13] = g));
  let _;
  t[14] !== p || t[15] !== d
    ? ((_ = (0, $.jsx)(Vt, { children: (0, $.jsx)(Lt, { title: d, subtitle: p }) })),
      (t[14] = p),
      (t[15] = d),
      (t[16] = _))
    : (_ = t[16]);
  ...
  t[20] === v
    ? (b = t[21])
    : ((b = (0, $.jsx)(j, { color: `ghost`, type: `button`, onClick: v, children: y })),
      (t[20] = v),
      (t[21] = b));
  let x;
  t[22] === s
  ...
  let S;
  t[24] !== b || t[25] !== x
    ? ((S = (0, $.jsx)(Vt, { children: (0, $.jsxs)(zt, { children: [b, x] }) })),
      (t[24] = b),
      (t[25] = x),
      (t[26] = S))
    : (S = t[26]);
...
function Cn(e) {
  ...
  t[0] !== r || t[1] !== n
    ? ((i = () => {
        !r || n == null || o.dispatchMessage(`open-in-new-window`, { path: l(n) });
      }),
      (t[0] = r),
      (t[1] = n),
      (t[2] = i))
