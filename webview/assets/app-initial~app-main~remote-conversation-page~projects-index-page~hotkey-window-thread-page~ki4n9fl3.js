...
import { $a as ie, Qa as ae } from "./app-initial~app-main~onboarding-page~profile.js";
import {
  h as oe,
  m as I,
...
function L(e) {
  switch (e) {
    case `hot`:
      return v.CODEX_THREAD_SWITCH_KIND_HOT;
    case `cold`:
      return v.CODEX_THREAD_SWITCH_KIND_COLD;
  }
}
var R,
  z,
            ...
            case `thread_switch_completed`: {
              ...
              ((this.pendingThreadSwitch = null),
                y(e, ne, {
                  ...
                  switchKind: L(t.defaults.needsResume ? `cold` : `hot`),
...
function V({ isPinned: e, onPinnedChange: t }) {
  return {
...
function H({ isPinned: e, hasUnreadTurn: t, ariaLabel: n, onPin: r, onUnpin: i }) {
  if (t)
    return {
      rest: null,
      hover: (0, U.jsx)(`span`, { "aria-hidden": !0, className: `block h-5 w-5` }),
    };
  let a = (0, U.jsx)(I, { isPinned: e, ariaLabel: n, onPin: r, onUnpin: i });
...
function ce(e) {
  let t = (0, Y.c)(37),
    ...
    s = o != null,
    u;
  t[0] === o ? (u = t[1]) : ((u = o != null && o.trim().length > 0), (t[0] = o), (t[1] = u));
  let f = u,
    p;
  t[2] === s
    ? (p = t[3])
  ...
  t[12] === m
    ? (y = t[13])
    : ((y = (0, X.jsx)(ee, { className: `sr-only`, children: m })), (t[12] = m), (t[13] = y));
  let x;
  t[14] !== g || t[15] !== m
    ? ((x = (0, X.jsx)(l, { children: (0, X.jsx)(d, { title: m, subtitle: g }) })),
      (t[14] = g),
      (t[15] = m),
      (t[16] = x))
    : (x = t[16]);
  let S;
  t[17] === i ? (S = t[18]) : ((S = () => i(!1)), (t[17] = i), (t[18] = S));
  let C;
  ...
  t[20] === S
    ? (w = t[21])
    : ((w = (0, X.jsx)(c, { color: `ghost`, type: `button`, onClick: S, children: C })),
      (t[20] = S),
      (t[21] = w));
  let T;
  t[22] === s
  ...
  let E;
  t[24] !== w || t[25] !== T
    ? ((E = (0, X.jsx)(l, { children: (0, X.jsxs)(b, { children: [w, T] }) })),
      (t[24] = w),
      (t[25] = T),
      (t[26] = E))
    : (E = t[26]);
  let D;
  t[27] !== E || t[28] !== v || t[29] !== y || t[30] !== x
    ? ((D = (0, X.jsxs)(F, { as: `form`, onSubmit: v, children: [y, x, E] })),
      (t[27] = E),
      (t[28] = v),
      (t[29] = y),
      (t[30] = x),
...
function de(e) {
  let t = (0, Z.c)(6),
    { conversationId: n } = e,
    r = j(`459748632`) && n != null,
    a;
  t[0] !== r || t[1] !== n
    ? ((a = () => {
        !r || n == null || k.dispatchMessage(`open-in-new-window`, { path: i(n) });
      }),
      (t[0] = r),
      (t[1] = n),
      (t[2] = a))
  ...
  return (
    t[3] !== r || t[4] !== o
      ? ((s = { canOpenThreadInNewWindow: r, openThreadInNewWindow: o }),
        (t[3] = r),
        (t[4] = o),
        (t[5] = s))
      : (s = t[5]),
...
var Q,
  ...
  me = e(() => {
    (r(),
      ...
      n(),
      ae(),
      (Q = E(g, (e, { get: t }) => t(T, e)?.type ?? null)),
      ($ = E(g, (e, { get: t }) =>
        pe({
          hasConversation: t(x, e),
          hostId: t(u, e),
          latestTurnId: t(S, e),
          latestTurnStatus: t(_, e),
