...
import { Xr as M, Yr as N } from "./app-initial~app-main~onboarding-page.js";
function ce(e) {
  switch (e) {
    case `hot`:
      return u.CODEX_THREAD_SWITCH_KIND_HOT;
    case `cold`:
      return u.CODEX_THREAD_SWITCH_KIND_COLD;
  }
}
var P,
  F,
            ...
            case `thread_switch_completed`: {
              ...
              ((this.pendingThreadSwitch = null),
                b(e, w, {
                  ...
                  switchKind: ce(t.defaults.needsResume ? `cold` : `hot`),
...
function B(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, H.jsx)(o, { className: `icon-2xs block shrink-0` })), (t[4] = o), (t[5] = c));
  let l;
  return (
    t[6] !== r || t[7] !== s || t[8] !== c
      ? ((l = (0, H.jsx)(`button`, {
...
function fe({ isPinned: e, onPinnedChange: t }) {
  return {
...
function pe({ isPinned: e, hasUnreadTurn: t, ariaLabel: n, onPin: r, onUnpin: i }) {
  if (t)
    return {
      rest: null,
      hover: (0, W.jsx)(`span`, { "aria-hidden": !0, className: `block h-5 w-5` }),
    };
  let a = (0, W.jsx)(B, { isPinned: e, ariaLabel: n, onPin: r, onUnpin: i });
...
function ge(e) {
  let t = (0, Y.c)(37),
    ...
    c = s != null,
    l;
  t[0] === s ? (l = t[1]) : ((l = s != null && s.trim().length > 0), (t[0] = s), (t[1] = l));
  let u = l,
    d;
  t[2] === c
    ? (d = t[3])
        ...
        ? u
          ? (0, X.jsx)(p, {
              ...
              values: {
                name: (0, X.jsx)(
                  `strong`,
                  { className: `font-semibold text-token-text-primary`, children: s },
                  `automation-name`,
                ),
              },
            })
  ...
  t[12] === f
    ? (v = t[13])
    : ((v = (0, X.jsx)(ee, { className: `sr-only`, children: f })), (t[12] = f), (t[13] = v));
  let y;
  t[14] !== h || t[15] !== f
    ? ((y = (0, X.jsx)(j, { children: (0, X.jsx)(o, { title: f, subtitle: h }) })),
      (t[14] = h),
      (t[15] = f),
      (t[16] = y))
    : (y = t[16]);
  let b;
  t[17] === i ? (b = t[18]) : ((b = () => i(!1)), (t[17] = i), (t[18] = b));
  let x;
  ...
  t[20] === b
    ? (S = t[21])
    : ((S = (0, X.jsx)(O, { color: `ghost`, type: `button`, onClick: b, children: x })),
      (t[20] = b),
      (t[21] = S));
  let C;
  t[22] === c
  ...
  let w;
  t[24] !== S || t[25] !== C
    ? ((w = (0, X.jsx)(j, { children: (0, X.jsxs)(te, { children: [S, C] }) })),
      (t[24] = S),
      (t[25] = C),
      (t[26] = w))
    : (w = t[26]);
  let T;
  t[27] !== w || t[28] !== _ || t[29] !== v || t[30] !== y
    ? ((T = (0, X.jsxs)(oe, { as: `form`, onSubmit: _, children: [v, y, w] })),
      (t[27] = w),
      (t[28] = _),
      (t[29] = v),
      (t[30] = y),
...
function ye(e) {
  let t = (0, Z.c)(6),
    { conversationId: n } = e,
    i = C(`459748632`) && n != null,
    o;
  t[0] !== i || t[1] !== n
    ? ((o = () => {
        !i || n == null || a.dispatchMessage(`open-in-new-window`, { path: r(n) });
      }),
      (t[0] = i),
      (t[1] = n),
      (t[2] = o))
  ...
  return (
    t[3] !== i || t[4] !== s
      ? ((c = { canOpenThreadInNewWindow: i, openThreadInNewWindow: s }),
        (t[3] = i),
        (t[4] = s),
        (t[5] = c))
      : (c = t[5]),
...
var Q,
  ...
  Se = e(() => {
    (m(),
      ...
      s(),
      N(),
      (Q = c(d, (e, { get: t }) => t(S, e)?.type ?? null)),
      ($ = c(d, (e, { get: t }) =>
        xe({
          hasConversation: t(n, e),
          hostId: t(ae, e),
          latestTurnId: t(T, e),
          latestTurnStatus: t(f, e),
          pendingRequestType: t(Q, e),
          resumeState: t(v, e),
        }),
      )));
  });
