...
var M = [`history`, `path`, `basename`, `stem`, `extname`, `dirname`],
  de = class {
    constructor(e) {
      let t;
      ((t = e ? (j(e) ? { path: e } : typeof e == `string` || pe(e) ? { value: e } : e) : {}),
    ...
    set basename(e) {
      (P(e, `basename`), N(e, `basename`), (this.path = k.join(this.dirname || ``, e)));
    }
    get dirname() {
      return typeof this.path == `string` ? k.dirname(this.path) : void 0;
    }
    set dirname(e) {
      (fe(this.basename, `dirname`), (this.path = k.join(e || ``, this.basename)));
    }
    get extname() {
    ...
    set path(e) {
      (j(e) && (e = le(e)), P(e, `path`), this.path !== e && this.history.push(e));
    }
    get stem() {
    ...
    use(e, ...t) {
      ...
      function s(e, t) {
        ...
        if (i === -1) n.push([e, ...t]);
          ...
          let [r, ...a] = t,
            o = n[i][1];
          (T(o) && T(r) && (r = (0, F.default)(!0, o, r)), (n[i] = [e, r, ...a]));
        }
      }
    }
  })().freeze();
...
function z(e) {
  if (!T(e) || typeof e.type != `string`) throw TypeError("Expected node, got `" + e + "`");
}
function _e(e, t, n) {
...
function Fe(e, t, n, r, i) {
  let a = ``;
  if (!ze(i) || (/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !Le(n))) return !1;
  let o = Re(n + r);
  if (!o[0]) return !1;
  let s = {
    type: `link`,
...
function We(e) {
  ...
  (n.type, (n.identifier = c(this.sliceSerialize(e)).toLowerCase()), (n.label = t));
}
function Ge(e) {
  this.exit(e);
}
...
at.peek = ot;
function tt() {
  return { canContainEols: [`delete`], enter: { strikethrough: rt }, exit: { strikethrough: it } };
}
function nt() {
  return {
...
function dt() {
  return {
    ...
    exit: { codeText: ht, table: pt, tableData: W, tableHeader: W, tableRow: W },
  };
}
function ft(e) {
  let t = e._align;
...
function vt() {
  return { exit: { taskListCheckValueChecked: K, taskListCheckValueUnchecked: K, paragraph: bt } };
}
function yt() {
  return { unsafe: [{ atBreak: !0, character: `-`, after: `[:|-]` }], handlers: { listItem: xt } };
}
function K(e) {
...
for (var Y = 48; Y < 123; ) ((J[Y] = q), Y++, Y === 58 ? (Y = 65) : Y === 91 && (Y = 97));
((J[43] = q),
  (J[45] = q),
  (J[46] = q),
  (J[95] = q),
...
function Pt(e, t, n) {
  ...
  function c(t) {
    if (h(t) && i.length < 5) return ((i += String.fromCodePoint(t)), e.consume(t), c);
    if (t === 58) {
      let n = i.toLowerCase();
...
function Bt(e) {
  return (
    e === null || e === 40 || e === 42 || e === 95 || e === 91 || e === 93 || e === 126 || a(e)
  );
}
function Vt(e) {
  return !h(e);
...
function qt(e, t, n) {
  ...
  function d(l) {
    if (o > 999 || (l === 93 && !s) || l === null || l === 91 || a(l)) return n(l);
    if (l === 93) {
      e.exit(`chunkString`);
...
function Jt(e, t, n) {
  ...
  function p(t) {
    if (s > 999 || (t === 93 && !l) || t === null || t === 91 || a(t)) return n(t);
    if (t === 93) {
      e.exit(`chunkString`);
...
function Qt(e) {
  ...
  return (
    (t ??= !0), { text: { 126: i }, insideSpan: { null: [i] }, attentionMarkers: { null: [126] } }
  );
  function a(e, t) {
    let r = -1;
    for (; ++r < e.length; )
      if (
        ...
        for (; i--; )
          if (
            ...
            e[i][1]._open &&
            e[r][1].end.offset - e[r][1].start.offset === e[i][1].end.offset - e[i][1].start.offset
          ) {
    ...
    for (r = -1; ++r < e.length; )
      e[r][1].type === `strikethroughSequenceTemporary` && (e[r][1].type = `data`);
    return e;
  }
  function o(e, n, i) {
    let a = this.previous,
...
function rn(e, t, n) {
      ...
      : _(t)
        ...
        : o(t)
          ...
          : ((s += 1),
            c && ((c = !1), (i += 1)),
            t === 124
              ? (e.enter(`tableCellDivider`), e.consume(t), e.exit(`tableCellDivider`), (c = !0), p)
              : (e.enter(`data`), m(t)));
  }
  function m(t) {
  ...
  function v(t) {
    return t === 45 || t === 58
      ? y(t)
      : t === 124
        ? ((c = !0), e.enter(`tableCellDivider`), e.consume(t), e.exit(`tableCellDivider`), ee)
        : w(t);
  }
  function ee(t) {
