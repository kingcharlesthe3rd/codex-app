...
var k,
  je = e(() => {
    k = { basename: Te, dirname: Ee, extname: De, join: Oe, sep: `/` };
  });
function Me() {
  return `/`;
}
...
var N,
  ...
  He = e(() => {
    (we(),
      ...
      Pe(),
      Re(),
      (N = [`history`, `path`, `basename`, `stem`, `extname`, `dirname`]),
      (Ve = class {
        constructor(e) {
          let t;
          ((t = e ? (A(e) ? { path: e } : typeof e == `string` || Be(e) ? { value: e } : e) : {}),
            (this.cwd = `cwd` in t ? `` : Ne.cwd()),
            (this.data = {}),
            (this.history = []),
            (this.messages = []),
            this.value,
          ...
          let r;
          for (r in t) N.includes(r) || (this[r] = t[r]);
        }
        get basename() {
          return typeof this.path == `string` ? k.basename(this.path) : void 0;
        }
        set basename(e) {
          (M(e, `basename`), j(e, `basename`), (this.path = k.join(this.dirname || ``, e)));
        }
        get dirname() {
          return typeof this.path == `string` ? k.dirname(this.path) : void 0;
        }
        set dirname(e) {
          (ze(this.basename, `dirname`), (this.path = k.join(e || ``, this.basename)));
        }
        get extname() {
          return typeof this.path == `string` ? k.extname(this.path) : void 0;
        }
        set extname(e) {
          if ((j(e, `extname`), ze(this.dirname, `extname`), e)) {
        ...
        set path(e) {
          (A(e) && (e = Ie(e)), M(e, `path`), this.path !== e && this.history.push(e));
        }
        get stem() {
...
function Ke(e) {
  if (!_e(e) || typeof e.type != `string`) throw TypeError("Expected node, got `" + e + "`");
}
function qe(e, t, n) {
  if (!n) throw Error("`" + e + "` finished async. Use `" + t + "` instead");
}
function L(e) {
  return Je(e) ? e : new Ve(e);
}
function Je(e) {
  return !!(e && typeof e == `object` && `message` in e && `messages` in e);
}
function Ye(e) {
  return typeof e == `string` || Xe(e);
}
function Xe(e) {
  return !!(e && typeof e == `object` && `byteLength` in e && `byteOffset` in e);
}
    ...
    (he(),
      ...
      (Qe = class e extends We {
        ...
        copy() {
          ...
          return (t.data((0, R.default)(!0, {}, this.namespace)), t);
        }
        data(e, t) {
          return typeof e == `string`
            ? arguments.length === 2
              ? (I(`data`, this.frozen), (this.namespace[e] = t), this)
              : (Ze.call(this.namespace, e) && this.namespace[e]) || void 0
            : e
              ? (I(`data`, this.frozen), (this.namespace = e), this)
              : this.namespace;
        }
        freeze() {
        ...
        process(e, t) {
          ...
          return (
            this.freeze(),
            P(`process`, this.parser || this.Parser),
            F(`process`, this.compiler || this.Compiler),
        ...
        processSync(e) {
          ...
          return (
            this.freeze(),
            P(`processSync`, this.parser || this.Parser),
            F(`processSync`, this.compiler || this.Compiler),
            this.process(e, r),
            qe(`processSync`, `process`, t),
            n
          );
          function r(e, r) {
            ((t = !0), me(e), (n = r));
        ...
        runSync(e, t) {
          let n = !1,
            r;
          return (this.run(e, t, i), qe(`runSync`, `run`, n), r);
          function i(e, t) {
            (me(e), (r = t), (n = !0));
          }
        }
        stringify(e, t) {
          ...
          return (F(`stringify`, r), Ke(e), r(e, n));
        }
        use(e, ...t) {
          let n = this.attachers,
            r = this.namespace;
          if ((I(`use`, this.frozen), e != null))
          ...
          function a(e) {
            ...
            (o(e.plugins), e.settings && (r.settings = (0, R.default)(!0, r.settings, e.settings)));
          }
          function o(e) {
            let t = -1;
            if (e != null)
          ...
          function s(e, t) {
            ...
            if (i === -1) n.push([e, ...t]);
              ...
              let [r, ...a] = t,
                o = n[i][1];
              (_e(o) && _e(r) && (r = (0, R.default)(!0, o, r)), (n[i] = [e, r, ...a]));
            }
          }
        }
      }),
...
function ct(e) {
  ...
  for (; ++r < n.length; ) {
    let e = n[r];
    t.push([lt(e[0]), ut(e[1])]);
  }
  return t;
}
function lt(e) {
  return typeof e == `string` ? new RegExp(at(e), `g`) : e;
}
function ut(e) {
...
function mt() {
  return {
    unsafe: [
      ...
      { character: `.`, before: `[Ww]`, after: `[\\-.\\w]`, inConstruct: B, notInConstruct: V },
      { character: `:`, before: `[ps]`, after: `\\/`, inConstruct: B, notInConstruct: V },
    ],
  };
}
function ht(e) {
...
function xt(e, t, n, r, i) {
  let a = ``;
  if (!Tt(i) || (/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !Ct(n))) return !1;
  let o = wt(n + r);
  if (!o[0]) return !1;
  let s = {
    type: `link`,
...
function Tt(e, t) {
  ...
  return (e.index === 0 || C(n) || i(n)) && (!t || n !== 47);
}
var B,
  V,
  Et = e(() => {
    (oe(), E(), T(), ft(), (B = `phrasing`), (V = [`autolink`, `link`, `image`, `label`]));
  }),
  Dt = e(() => {
    Et();
  });
...
function Mt(e) {
  ...
  (n.type, (n.identifier = o(this.sliceSerialize(e)).toLowerCase()), (n.label = t));
}
function Nt(e) {
  this.exit(e);
}
...
function Rt() {
  return {
    ...
    exit: {
      ...
      gfmFootnoteCall: Nt,
      gfmFootnoteDefinitionLabelString: Pt,
...
function zt(e) {
  ...
  return (
    ...
    {
      handlers: { footnoteDefinition: n, footnoteReference: Lt },
      ...
      e.children &&
        ...
        (o += a.move(
          (t
            ? `
`
            : ` `) + r.indentLines(r.containerFlow(e, a.current()), t ? Vt : Bt),
        ))),
      s(),
      o
    );
...
function Wt() {
  return { canContainEols: [`delete`], enter: { strikethrough: Kt }, exit: { strikethrough: qt } };
}
function Gt() {
  return {
    unsafe: [{ character: `~`, inConstruct: `phrasing`, notInConstruct: Xt }],
    handlers: { delete: Jt },
  };
}
function Kt(e) {
...
function en(e, t) {
  ...
  let d = -1;
  if (typeof r == `object` && `length` in r) for (; ++d < l; ) a[d] = nn(r[d]);
  else {
    let e = nn(r);
    for (; ++d < l; ) a[d] = e;
  }
...
function an() {
  return {
    enter: { table: on, tableData: ln, tableHeader: ln, tableRow: cn },
    exit: { codeText: un, table: sn, tableData: H, tableHeader: H, tableRow: H },
  };
}
function on(e) {
  let t = e._align;
...
function un(e) {
  let t = this.resume();
  this.data.inTable && (t = t.replace(/\\([\\|])/g, dn));
...
`),
  ...
  function l(e, t) {
    return en(e, { align: t, alignDelimiters: r, padding: n, stringLength: i });
  }
  function u(e, t, n) {
    let r = e.children,
      i = -1,
...
function hn() {
  return {
    exit: { taskListCheckValueChecked: _n, taskListCheckValueUnchecked: _n, paragraph: vn },
  };
}
function gn() {
  return { unsafe: [{ atBreak: !0, character: `-`, after: `[:|-]` }], handlers: { listItem: yn } };
}
function _n(e) {
...
function yn(e, t, n, r) {
  let i = e.children[0],
    ...
    s = n.createTracker(r);
  a && s.move(o);
  let c = ce.listItem(e, t, n, { ...r, ...s.current() });
...
function Sn() {
  return [pt(), Rt(), Wt(), an(), hn()];
}
function Cn(e) {
  return { extensions: [mt(), zt(e), Gt(), fn(e), gn()] };
}
var wn = e(() => {
    (Dt(), Ut(), Qt(), mn(), xn());
  }),
...
function Dn(e, t, n) {
  ...
  return o;
  function o(t) {
    return !U(t) || !Ln.call(r, r.previous) || W(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`), e.enter(`literalAutolinkEmail`), s(t));
  }
  function s(t) {
    return U(t) ? (e.consume(t), s) : t === 64 ? (e.consume(t), c) : n(t);
  }
  function c(t) {
    return t === 46
      ? e.check(zn, u, l)(t)
...
function On(e, t, n) {
  ...
  return i;
  function i(t) {
    return (t !== 87 && t !== 119) || !Fn.call(r, r.previous) || W(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`),
        e.enter(`literalAutolinkWww`),
        e.check(Rn, e.attempt(G, e.attempt(K, a), n), n)(t));
  }
  function a(n) {
...
function kn(e, t, n) {
  ...
  return s;
  function s(t) {
    return (t === 72 || t === 104) && In.call(r, r.previous) && !W(r.events)
      ? (e.enter(`literalAutolink`),
  ...
  function c(t) {
    if (g(t) && a.length < 5) return ((a += String.fromCodePoint(t)), e.consume(t), c);
    if (t === 58) {
      let n = a.toLowerCase();
  ...
  function u(t) {
    return t === null || ae(t) || w(t) || C(t) || i(t) ? n(t) : e.attempt(G, e.attempt(K, d), n)(t);
  }
  function d(n) {
...
function jn(e, t, n) {
  ...
  function s(t) {
    return t === 46 || t === 95
      ? e.check(q, l, c)(t)
      : t === null || w(t) || C(t) || (t !== 45 && i(t))
        ? l(t)
        : ((o = !0), e.consume(t), s);
  }
  function c(t) {
    return (t === 95 ? (r = !0) : ((a = r), (r = void 0)), e.consume(t), s);
  }
  function l(e) {
...
function Nn(e, t, n) {
  ...
  function i(e) {
    return e === null || e === 40 || e === 91 || w(e) || C(e) ? t(e) : r(e);
  }
  function a(e) {
    return g(e) ? o(e) : n(e);
  }
  ...
  Vn = e(() => {
    for (
      T(),
        ...
        G = { tokenize: jn, partial: !0 },
        K = { tokenize: Mn, partial: !0 },
        q = { tokenize: Nn, partial: !0 },
        zn = { tokenize: Pn, partial: !0 },
        J = { name: `wwwAutolink`, tokenize: On, previous: Fn },
        Bn = { name: `protocolAutolink`, tokenize: kn, previous: In },
        Y = { name: `emailAutolink`, tokenize: Dn, previous: Ln },
        X = {},
        Z = 48;
      Z < 123;
    )
...
function Un() {
  return {
    document: {
      91: { name: `gfmFootnoteDefinition`, tokenize: qn, continuation: { tokenize: Jn }, exit: Yn },
    },
    text: {
      91: { name: `gfmFootnoteCall`, tokenize: Kn },
      93: { name: `gfmPotentialFootnoteCall`, add: `after`, tokenize: Wn, resolveTo: Gn },
    },
  };
}
function Wn(e, t, n) {
  ...
  function c(i) {
    ...
    let c = o(r.sliceSerialize({ start: s.end, end: r.now() }));
...
function Kn(e, t, n) {
  ...
  function u(c) {
    if (a > 999 || (c === 93 && !s) || c === null || c === 91 || w(c)) return n(c);
    if (c === 93) {
      e.exit(`chunkString`);
      let a = e.exit(`gfmFootnoteCallString`);
      return i.includes(o(r.sliceSerialize(a)))
        ? (e.enter(`gfmFootnoteCallLabelMarker`),
          e.consume(c),
          e.exit(`gfmFootnoteCallLabelMarker`),
    ...
    return (w(c) || (s = !0), a++, e.consume(c), c === 92 ? d : u);
  }
  function d(t) {
...
function qn(e, t, n) {
  ...
  function d(t) {
    if (s > 999 || (t === 93 && !c) || t === null || t === 91 || w(t)) return n(t);
    if (t === 93) {
      e.exit(`chunkString`);
      let n = e.exit(`gfmFootnoteDefinitionLabelString`);
      return (
        (a = o(r.sliceSerialize(n))),
        e.enter(`gfmFootnoteDefinitionLabelMarker`),
        e.consume(t),
        e.exit(`gfmFootnoteDefinitionLabelMarker`),
    ...
    return (w(t) || (c = !0), s++, e.consume(t), t === 92 ? f : d);
  }
  function f(t) {
  ...
  function p(t) {
    return t === 58
      ? (e.enter(`definitionMarker`),
        ...
        y(e, m, `gfmFootnoteDefinitionWhitespace`))
      : n(t);
  }
  function m(e) {
    return t(e);
...
function Jn(e, t, n) {
  return e.check(v, t, e.attempt(Zn, t, n));
}
function Yn(e) {
...
var Zn,
  Qn = e(() => {
    (m(), _(), T(), u(), (Zn = { tokenize: Xn, partial: !0 }));
  }),
  $n = e(() => {
    Qn();
  });
function er(e) {
  let t = (e || {}).singleTilde,
    n = { name: `strikethrough`, tokenize: a, resolveAll: i };
  return (
      ...
      if (
        ...
        for (; i--; )
          if (
            ...
            e[i][1]._open &&
            e[n][1].end.offset - e[n][1].start.offset === e[i][1].end.offset - e[i][1].start.offset
          ) {
            ((e[n][1].type = `strikethroughSequence`), (e[i][1].type = `strikethroughSequence`));
            let a = {
                type: `strikethrough`,
            ...
            (c && r(s, s.length, 0, ee(c, e.slice(i + 1, n), t)),
              r(s, s.length, 0, [
                [`exit`, o, t],
                [`enter`, e[n][1], t],
                [`exit`, e[n][1], t],
...
function lr(e, t, n) {
  ...
  function s(e) {
    ...
    let i = t > -1 ? r.events[t][1].type : null,
      a = i === `tableHead` || i === `tableRow` ? ie : c;
    return a === ie && r.parser.lazy[r.now().line] ? n(e) : a(e);
  }
  function c(t) {
      ...
      : p(t)
        ...
        : l(t)
          ...
          : ((a += 1),
            o && ((o = !1), (i += 1)),
            t === 124
              ? (e.enter(`tableCellDivider`), e.consume(t), e.exit(`tableCellDivider`), (o = !0), d)
              : (e.enter(`data`), f(t)));
  }
  function f(t) {
  ...
  function h(t) {
    return t === 45 || t === 58
      ? _(t)
      : t === 124
        ? ((o = !0), e.enter(`tableCellDivider`), e.consume(t), e.exit(`tableCellDivider`), g)
        : b(t);
  }
  function g(t) {
    return l(t) ? y(e, _, `whitespace`)(t) : _(t);
  }
  function _(t) {
    return t === 58
      ? ((a += 1),
  ...
  function te(t) {
    return t === 45 ? (e.enter(`tableDelimiterFiller`), ne(t)) : b(t);
  }
  function ne(t) {
    return t === 45
      ? (e.consume(t), ne)
  ...
  function re(t) {
    return l(t) ? y(e, v, `whitespace`)(t) : v(t);
  }
  function v(n) {
    return n === 124
      ? h(n)
  ...
  function x(n) {
    return n === 124
      ? (e.enter(`tableCellDivider`), e.consume(n), e.exit(`tableCellDivider`), x)
      : n === null || p(n)
        ? (e.exit(`tableRow`), t(n))
        : l(n)
          ? y(e, x, `whitespace`)(n)
...
function ur(e, t) {
      ...
      ? m.type === `tableHead`
        ...
        : m.type === `tableRow` || m.type === `tableDelimiterRow`
          ...
          : i &&
            ...
            ? ((r = !1),
              o[2] === 0 &&
                (a[1] !== 0 && ((o[0] = o[1]), (d = Q(f, t, a, i, void 0, d)), (a = [0, 0, 0, 0])),
                (o[2] = n)))
            : m.type === `tableCellDivider` &&
              (r
                ? (r = !1)
                : (a[1] !== 0 && ((o[0] = o[1]), (d = Q(f, t, a, i, void 0, d))),
                  (a = o),
                  (o = [a[1], n, 0, 0])))
      : m.type === `tableHead`
        ? ((s = !0), (c = n))
  ...
  for (c !== 0 && dr(f, t, c, l, u), f.consume(t.events), n = -1; ++n < t.events.length; ) {
    let e = t.events[n];
    e[0] === `enter` && e[1].type === `table` && (e[1]._align = or(t.events, n));
  }
  return e;
}
function Q(e, t, n, r, i, a) {
  let o = r === 1 ? `tableHeader` : r === 2 ? `tableDelimiter` : `tableData`;
  n[0] !== 0 && ((a.end = Object.assign({}, $(t.events, n[0]))), e.add(n[0], 0, [[`exit`, a, t]]));
  let s = $(t.events, n[1]);
  if (
  ...
  return (
    i !== void 0 &&
      ((a.end = Object.assign({}, $(t.events, i))), e.add(i, 0, [[`exit`, a, t]]), (a = void 0)),
    a
  );
}
...
function hr(e, t, n) {
  ...
  function s(r) {
    return p(r) ? t(r) : l(r) ? e.check({ tokenize: gr }, t, n)(r) : n(r);
  }
}
function gr(e, t, n) {
...
var _r,
  vr = e(() => {
    (_(), T(), (_r = { name: `tasklistCheck`, tokenize: hr }));
  }),
  yr = e(() => {
    vr();
  });
function br(e) {
  return a([En(), Un(), er(e), cr(), mr()]);
}
var xr = e(() => {
  (c(), Hn(), $n(), nr(), pr(), yr());
});
function Sr(e) {
  ...
  (i.push(br(n)), a.push(Sn()), o.push(Cn(n)));
}
var Cr,
  wr = e(() => {
    (Tn(), xr(), (Cr = {}));
...
function kr(e) {
  ...
  if (!t) throw Error(`Unable to build workbook: no markdown table rows found.`);
  let n = [];
  for (let e of t.children) {
    let t = e.children.map((e) => Or(s(e)));
...
//# sourceMappingURL=workbook-from-markdown-2.js.map
