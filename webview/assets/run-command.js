...
import { o as t, s as n } from "./rpc-Hf-fxjh7.js";
import { a as r } from "./open-project-setup-dialog.js";
var i = new Map([
    [
      `newThread`,
      () => {
        t({ type: `windows.show_home`, windowId: n });
      },
    ],
    [
      `quickChat`,
    ...
    [
      `toggleSidebar`,
      () => {
        t({ type: `windows.sidebar.toggle`, windowId: n });
      },
    ],
    [
      `toggleBottomPanel`,
    ...
    [
      `toggleTerminal`,
      () => {
        t({ type: `windows.terminal.toggle`, windowId: n });
      },
    ],
    [
      `openBrowserTab`,
    ...
    [
      `toggleSidePanel`,
      () => {
        t({ type: `windows.review.toggle`, windowId: n });
      },
    ],
    [
      `toggleFileTreePanel`,
...
function o(e, t, { isActive: n }) {
  ...
  return (
    ...
    () => {
      ...
      n !== -1 && (t.splice(n, 1), t.length === 0 && a.delete(e));
    }
  );
}
function s(e, t, n) {
...
function c(e, t, n) {
  return u(e, t, `keyboard_shortcut`, n);
}
function l(e) {
  return d(e) != null;
}
function u(e, t, n, r) {
  ...
  for (let e = (i?.length ?? 0) - 1; e >= 0; e--) {
    let n = i?.[e];
    if (n != null && n.isActive()) return n.handler(t, r) !== !1;
  }
  let o = d(e);
  return o == null ? !1 : (o(n), !0);
}
function d(e) {
  for (let [t, n] of i) if (t === e) return n;
}
