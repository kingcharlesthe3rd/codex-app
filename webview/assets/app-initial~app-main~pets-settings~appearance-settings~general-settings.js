...
var mt,
  ht = e(() => {
    mt = `external-agent-config-import-settings`;
  }),
  H,
  gt,
  _t = e(() => {
...
function vt(e) {
  let t = c(z),
    ...
    o = Te(i, e),
    s = Se(e),
    l = { codeThemeId: Me(a, e).id, theme: o },
    u = (0, W.useRef)(l),
    d = (0, W.useRef)(l),
    f = (0, W.useRef)(0),
    p = (0, W.useRef)(Promise.resolve());
  f.current === 0 && ((u.current = l), (d.current = l));
  let m = (0, W.useCallback)(
      (e) => {
        ((u.current = e), ie(t, n, e.theme), ie(t, r, e.codeThemeId));
      },
      [n, r, t],
    ),
    h = (0, W.useCallback)(
      async (e, t) => {
        ...
        let n = async () => {
            try {
              ...
              throw (xt(u.current, e) && m(d.current), t);
            } finally {
              --f.current;
            }
          },
          r = p.current.then(n, n);
        ((p.current = r.catch(() => void 0)), await r);
      },
      [m],
    ),
    g = (0, W.useCallback)(
    ...
    v = (0, W.useCallback)(
      (e) => {
        _(U(u.current.theme, e)).catch(() => void 0);
      },
      [_],
    ),
    y = (0, W.useCallback)(
      (e) => {
        _(U(u.current.theme, { fonts: e })).catch(() => void 0);
      },
      [_],
    ),
    b = (0, W.useCallback)(
      async (t) => {
        let n = await ke(t, e);
        await g({ codeThemeId: t, theme: U(u.current.theme, n) });
      },
      [g, e],
    ),
    x = (0, W.useCallback)(
      () => Ct({ codeThemeId: u.current.codeThemeId, theme: u.current.theme, variant: e }),
      [e],
    ),
    S = (0, W.useCallback)(
      (t) => {
    ...
    w = u.current;
  return {
    canImportThemeString: S,
    codeThemes: s,
    exportThemeString: x,
    fonts: w.theme.fonts,
    importThemeString: C,
    selectedCodeTheme: Me(w.codeThemeId, e),
    setCodeThemeId: b,
    setFontsPatch: y,
    setThemePatch: v,
    theme: w.theme,
...
function yt(e, t, n) {
  ...
  return { codeThemeId: i.id, theme: Te(r.theme, t) };
}
function bt(e) {
  return e === `light`
    ? { chromeThemeSetting: f.lightChromeTheme, codeThemeSetting: f.lightCodeThemeId }
    : { chromeThemeSetting: f.darkChromeTheme, codeThemeSetting: f.darkCodeThemeId };
}
function U(e, t) {
  return {
    ...e,
...
function xt(e, t) {
  return e.codeThemeId === t.codeThemeId && St(e.theme, t.theme);
}
function St(e, t) {
  return (
    e.accent === t.accent &&
...
var W,
  ...
  At = e(() => {
    (o(),
      ...
      Oe(),
      (Tt = `codex-theme-v1:`),
      (Et = x((e) => typeof e == `string` && Ae(e))),
      (G = _().regex(/^#[0-9a-fA-F]{6}$/)),
      (Dt = _().nullable()),
      (Ot = v({
        accent: G,
        contrast: u().int().min(0).max(100),
        fonts: v({ code: Dt, ui: Dt }),
        ink: G,
        opaqueWindows: g(),
        semanticColors: v({ diffAdded: G, diffRemoved: G, skill: G }),
        surface: G,
      })),
      (kt = v({ codeThemeId: Et, theme: Ot, variant: a([`light`, `dark`]) })));
  });
function jt(e) {
  let t = (0, Mt.c)(7),
    { theme: n } = e,
...
function K(e) {
  ...
  return (
    t[5] !== n || t[6] !== s || t[7] !== c
      ? ((l = (0, It.jsx)(`div`, { className: s, style: c, children: n })),
        (t[5] = n),
        (t[6] = s),
        (t[7] = c),
        (t[8] = l))
...
var Ft,
  ...
  q,
  zt = e(() => {
    ((Rt = `_waveDot_1y69c_22`),
      (q = { waveDot: Rt, "working-dot-wave": `_working-dot-wave_1y69c_1` }));
  });
function Bt(e) {
  let t = (0, Vt.c)(12),
  ...
  t[3] === s
    ...
    : ((p = s
        ? (0, J.jsxs)(`span`, {
            ...
            children: [
              (0, J.jsx)(`span`, {
                className: B(`h-1 w-1 rounded-full bg-token-text-primary/70`, q.waveDot),
              }),
              (0, J.jsx)(`span`, {
                className: B(`h-1 w-1 rounded-full bg-token-text-primary/70`, q.waveDot),
              }),
        ...
        : (0, J.jsx)(Ee, { className: `icon rotate-180 text-token-text-primary` })),
      (t[3] = s),
      (t[4] = p));
  let m;
  return (
    t[5] !== r || t[6] !== l || t[7] !== u || t[8] !== d || t[9] !== f || t[10] !== p
      ? ((m = (0, J.jsx)(`button`, {
          className: l,
          "aria-hidden": u,
          "aria-label": r,
...
function Xt(e) {
  ...
  let p = Qt(f),
    m = p.isDetecting || i,
    h;
  t[4] !== p.importChoices || t[5] !== d
    ? ((h = p.importChoices.length === 0 ? null : at(d, p.importChoices)),
      (t[4] = p.importChoices),
      (t[5] = d),
      (t[6] = h))
    : (h = t[6]);
  ...
  let v = _,
    y;
  t[9] !== p.providerIds || t[10] !== g || t[11] !== v
    ? ((y = (e) => {
        g != null && v({ source: `settings`, action: e, ...rt(g, et(g), p.providerIds) });
      }),
      (t[9] = p.providerIds),
      (t[10] = g),
      (t[11] = v),
  ...
  t[16] !== p || t[17] !== b
    ? ((w = () => {
        (b(`skipped`), p.setImportDialogOpen(!1));
      }),
      (t[16] = p),
      (t[17] = b),
      (t[18] = w))
  ...
  let T = w,
    E;
  t[19] !== p.detectedItems || t[20] !== p.selectedImportProviderIds || t[21] !== g || t[22] !== d
    ? ((E =
  ...
  let D = E,
    O;
  t[24] !== p || t[25] !== v || t[26] !== D || t[27] !== T || t[28] !== l
    ? ((O =
    ...
    : (O = t[29]);
  let A;
  t[30] !== p.isImportDialogOpen || t[31] !== p.setImportDialogOpen || t[32] !== O
    ? ((A = (0, Q.jsx)(Ie, {
  ...
  if (l === `general-row`) {
    ...
    t[38] === r
      ? (c = t[39])
      : ((c = r
          ? (0, Q.jsx)(R, { ...Y.importedAgentSetup })
          : (0, Q.jsx)(R, { ...Y.externalAgentImport })),
        (t[38] = r),
        (t[39] = c));
    let l;
    t[40] !== p.latestImportedAtMs || t[41] !== r
      ? ((l = r
        ...
        (t[42] = l))
      : (l = t[42]);
    let u = m || p.isImporting || (!e && (!r || !i)),
      d = !e && i ? p.openCompletedImportDialog : S,
      f;
    t[43] !== p.isImporting || t[44] !== e || t[45] !== r || t[46] !== m
      ? ((f = p.isImporting
          ? (0, Q.jsx)(R, {
      ...
      : (f = t[47]);
    let h;
    t[48] !== p.isImporting || t[49] !== u || t[50] !== d || t[51] !== f
      ? ((h = (0, Q.jsx)(ee, {
          color: `secondary`,
          size: `toolbar`,
          disabled: u,
      ...
      : (h = t[52]);
    let _;
    t[53] !== c || t[54] !== l || t[55] !== h
      ? ((_ = (0, Q.jsx)(C, { id: mt, label: c, description: l, control: h })),
        (t[53] = c),
        (t[54] = l),
        (t[55] = h),
        (t[56] = _))
    ...
    let v = g == null ? null : M,
      y;
    return (
      t[57] !== s || t[58] !== _ || t[59] !== v
        ? ((y = (0, Q.jsxs)(Q.Fragment, { children: [_, v, s] })),
          (t[57] = s),
          (t[58] = _),
          (t[59] = v),
          (t[60] = y))
  ...
  let F;
  return (
    t[63] !== p.isImporting || t[64] !== M || t[65] !== g || t[66] !== m || t[67] !== S
      ? ((F = (0, Q.jsx)(Q.Fragment, {
          children: (0, Q.jsxs)(pt, {
            className: `gap-2`,
            children: [
              P,
              (0, Q.jsx)(pt.Content, {
                children: m
                  ? (0, Q.jsx)(K, {
                      children: (0, Q.jsx)(C, {
                        ...
                        control: (0, Q.jsx)(k, { className: `h-4 w-4` }),
                      }),
                    })
                  : (0, Q.jsx)(K, {
                      children:
...
function Qt({ hostId: e, onImportSuccess: t, workspaceRoots: n }) {
  let r = c(z),
    i = m(),
    a = it({ enabled: !0, workspaceRoots: n }),
    o = Xe(a.detectedItems),
    s =
      S(`external-agent-import-status`, {
        params: { hostId: e, providers: dt },
    ...
    [x, C] = (0, Z.useState)(!1),
    [w, E] = (0, Z.useState)(`items`),
    [D, O] = (0, Z.useState)([]),
    [A, j] = (0, Z.useState)(`idle`),
    M = Zt([s.latestImportedAtMs, g]),
    N = p ? v : M,
    P = a.isImporting || p,
    ee = (e) => {
      (O(e), E(`items`));
    },
    F = async ({ providerIds: n, selection: o }) => {
      if ((j(`idle`), !a.hasImportableItems)) {
        C(!1);
        return;
      }
      let s =
        n.length === 0
          ...
          : Ye({ detectedItems: a.detectedItems, providerIds: n, selection: o });
      if (s.length === 0) {
        C(!1);
        return;
      }
          ...
          content: ({ close: e, level: t }) =>
            (0, Q.jsx)(T, {
              ...
              children: (0, Q.jsxs)(`div`, {
                ...
                children: [
                  (0, Q.jsx)(k, { className: `icon-sm text-token-text-secondary` }),
                  (0, Q.jsx)(R, {
      ...
      try {
        ...
        ((d = n.length),
          ...
          await Promise.all([
            lt(i),
            i.invalidateQueries({ queryKey: b(`codex-agents-md`) }),
            n.length === 0
              ? Promise.resolve()
              : i.invalidateQueries({ queryKey: b(`workspace-root-options`, { hostId: e }) }),
          ]),
          u({ status: `success`, items: s }),
          _(Date.now()),
          t?.(),
          p.success(
            (0, Q.jsx)(R, {
  ...
  return {
    ...
    importDialogStep: w,
    importDialogStatus: A,
    importSelection: (e) => F({ providerIds: D, selection: e }),
    isImportDialogOpen: x,
    isCompletedImportDialogOpen: d,
    isDetecting: a.isDetecting,
    isImporting: P,
    lastCompletedImportProgress: l,
    latestImportedAtMs: N,
    openCompletedImportDialog: () => {
      l != null && f(!0);
    },
    openImportDialog: () => {
      (j(`idle`), O(o), E(`providers`), C(!0));
    },
...
function $t(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Q.jsx)(`div`, { className: `shrink-0 font-medium`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function en(e) {
  ...
  t[1] === f
    ...
    : ((p = () => {
      ...
      (t[2] = p));
  let m;
  (t[3] !== i || t[4] !== f ? ((m = [i, f]), (t[3] = i), (t[4] = f), (t[5] = m)) : (m = t[5]),
    (0, Z.useEffect)(p, m));
  let h;
  ...
  let y = i?.status,
    b;
  t[10] === y ? (b = t[11]) : ((b = sn(y)), (t[10] = y), (t[11] = b));
  let x = i?.status,
    S;
  t[12] === x ? (S = t[13]) : ((S = cn(x)), (t[12] = x), (t[13] = S));
  let C;
  t[14] === i ? (C = t[15]) : ((C = ln(i)), (t[14] = i), (t[15] = C));
  let w;
  t[16] !== n || t[17] !== i
    ? ((w = un(i, n)), (t[16] = n), (t[17] = i), (t[18] = w))
    : (w = t[18]);
  let T;
    ...
    ? ((E =
        i != null && i.items.length > 0
          ? (0, Q.jsx)(Le, {
              ...
              children: (0, Q.jsx)(tn, { codexHome: r, items: i.items, status: i.status }),
            })
          : null),
      (t[24] = r),
      (t[25] = i),
  ...
  t[37] !== D || t[38] !== k
    ? ((A = (0, Q.jsx)(Be, {
        ...
        children: (0, Q.jsxs)(`div`, { className: `relative min-h-0`, children: [D, k] }),
      })),
      (t[37] = D),
      (t[38] = k),
      (t[39] = A))
...
function tn(e) {
        ...
        e.length > 0
          ? (0, Q.jsxs)(Q.Fragment, {
              children: [
                ...
                e.map((e) => (0, Q.jsx)(an, { codexHome: n, item: e, status: i }, mn(e))),
              ],
            })
          : null),
      (s =
        c.length > 0
          ? (0, Q.jsxs)(Q.Fragment, {
              children: [
                ...
                c.map((e) => (0, Q.jsx)(an, { codexHome: n, item: e, status: i }, mn(e))),
              ],
            })
          : null),
      (t[0] = n),
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== s
      ? ((c = (0, Q.jsxs)(a, { children: [o, s] })), (t[6] = a), (t[7] = o), (t[8] = s), (t[9] = c))
      : (c = t[9]),
    c
  );
}
...
function an(e) {
  let t = (0, X.c)(13),
    ...
    a = L(),
    o;
  t[0] !== a || t[1] !== r ? ((o = Ve(a, r)), (t[0] = a), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s;
  t[3] !== n || t[4] !== r || t[5] !== i
    ? ((s = dn(r, n, i)), (t[3] = n), (t[4] = r), (t[5] = i), (t[6] = s))
    : (s = t[6]);
  let c;
  t[7] === i ? (c = t[8]) : ((c = (0, Q.jsx)(on, { status: i })), (t[7] = i), (t[8] = c));
  let l;
  return (
    t[9] !== o || t[10] !== s || t[11] !== c
      ? ((l = (0, Q.jsx)(C, { label: o, description: s, control: c })),
        (t[9] = o),
        (t[10] = s),
        (t[11] = c),
        (t[12] = l))
    ...
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(`span`, {
            ...
            children: (0, Q.jsx)(oe, { className: `icon-2xs text-token-success` }),
          })),
          (t[1] = e))
        : (e = t[1]),
      e
  ...
  return (
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Q.jsx)(`span`, {
          ...
          children: (0, Q.jsx)(me, { className: `icon-2xs text-token-editor-error-foreground` }),
        })),
        (t[2] = r))
      : (r = t[2]),
    r
...
function sn(e) {
  return e === `success`
    ? (0, Q.jsx)(oe, { className: `icon-md text-token-charts-green` })
    : e === `error`
      ? (0, Q.jsx)(E, { className: `icon-md text-token-danger` })
      : (0, Q.jsx)(k, { className: `icon-md` });
}
function cn(e) {
  return e === `success`
...
function dn(e, t, n) {
  let r = n === `success` ? fn(e) : e.description;
  if (e.cwd == null || e.cwd === ``) {
    let e = r
...
var X,
  ...
  gn = e(() => {
    ((X = r()),
      ...
      (hn = { importedSessionCount: 0, latestImportedAtMs: null }));
  });
function _n(e) {
  return d(e, vn) === !0;
}
