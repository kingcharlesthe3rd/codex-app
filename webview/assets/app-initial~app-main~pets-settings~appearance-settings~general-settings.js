...
var H,
  mt = e(() => {
    H = `external-agent-config-import-settings`;
  }),
  ht,
  gt,
  _t = e(() => {
...
function vt(e) {
  let t = m(S),
    { chromeThemeSetting: n, codeThemeSetting: r } = bt(e),
    i = h(n),
    a = h(r),
    o = ke(i, e),
    s = Oe(e),
    c = { codeThemeId: je(a, e).id, theme: o },
    l = (0, U.useRef)(c),
    u = (0, U.useRef)(c),
    d = (0, U.useRef)(0),
  ...
  let p = (0, U.useCallback)(
      (e) => {
        ((l.current = e), E(t, n, e.theme), E(t, r, e.codeThemeId));
      },
      [n, r, t],
    ),
    g = (0, U.useCallback)(
      async (e, t) => {
        ...
        let n = async () => {
            try {
              ...
              throw (St(l.current, e) && p(u.current), t);
            } finally {
              --d.current;
            }
          },
    ...
    _ = (0, U.useCallback)(
      async (e) => {
        await g(e, async () => {
          ...
          await I(n, e.theme);
          try {
            await I(r, e.codeThemeId);
          } catch (e) {
            throw (await I(n, t.theme).catch(() => void 0), e);
          }
          u.current = e;
        });
      },
      ...
      async (e) => {
        ...
        await g(t, async () => {
          ...
          if (i.codeThemeId !== t.codeThemeId) {
            await I(r, t.codeThemeId);
            try {
              await I(n, e);
            } catch (e) {
              throw (await I(r, i.codeThemeId).catch(() => void 0), e);
            }
            u.current = t;
            return;
          }
          (await I(n, e), (u.current = t));
        });
      },
      [n, r, g],
    ),
    y = (0, U.useCallback)(
      (e) => {
        v(xt(l.current.theme, e)).catch(() => void 0);
      },
      [v],
    ),
    b = (0, U.useCallback)(
      (e) => {
        v(xt(l.current.theme, { fonts: e })).catch(() => void 0);
      },
      [v],
    ),
    x = (0, U.useCallback)(
      async (t) => {
        let n = await Ee(t, e);
        await _({ codeThemeId: t, theme: xt(l.current.theme, n) });
      },
      [_, e],
    ),
    C = (0, U.useCallback)(
      () => wt({ codeThemeId: l.current.codeThemeId, theme: l.current.theme, variant: e }),
      [e],
    ),
    w = (0, U.useCallback)(
      (t) => {
    ...
    D = l.current;
  return {
    canImportThemeString: w,
    codeThemes: s,
    exportThemeString: C,
    fonts: D.theme.fonts,
    importThemeString: T,
    selectedCodeTheme: je(D.codeThemeId, e),
    setCodeThemeId: x,
    setFontsPatch: b,
    setThemePatch: y,
    theme: D.theme,
...
function yt(e, t, n) {
  ...
  return { codeThemeId: i.id, theme: ke(r.theme, t) };
}
function bt(e) {
  return e === `light`
    ? { chromeThemeSetting: _.lightChromeTheme, codeThemeSetting: _.lightCodeThemeId }
    : { chromeThemeSetting: _.darkChromeTheme, codeThemeSetting: _.darkCodeThemeId };
}
function xt(e, t) {
  return {
    ...e,
...
function St(e, t) {
  return e.codeThemeId === t.codeThemeId && Ct(e.theme, t.theme);
}
function Ct(e, t) {
  return (
    e.accent === t.accent &&
...
function Tt(e) {
  let t = e.trim();
  if (!t.startsWith(Et)) throw Error(`Theme share string mismatch`);
  let n = t.slice(15),
    r = n.startsWith(`{`) ? n : decodeURIComponent(n);
  return At.parse(JSON.parse(r));
}
var U,
  Et,
  Dt,
  ...
  jt = e(() => {
    (i(),
      ...
      De(),
      (Et = `codex-theme-v1:`),
      (Dt = fe((e) => typeof e == `string` && Ae(e))),
      (W = ve().regex(/^#[0-9a-fA-F]{6}$/)),
      (Ot = ve().nullable()),
      (kt = M({
        accent: W,
        contrast: me().int().min(0).max(100),
        fonts: M({ code: Ot, ui: Ot }),
        ink: W,
        opaqueWindows: re(),
        semanticColors: M({ diffAdded: W, diffRemoved: W, skill: W }),
        surface: W,
      })),
      (At = M({ codeThemeId: Dt, theme: kt, variant: ee([`light`, `dark`]) })));
  });
function Mt(e) {
  let t = (0, Nt.c)(7),
    { theme: n } = e,
...
function G(e) {
  let t = (0, It.c)(9),
    ...
    o = a === `default` ? `border border-token-border` : `bg-token-bg-secondary`,
    s;
  t[0] !== r || t[1] !== o
    ? ((s = c(
  ...
  return (
    t[5] !== n || t[6] !== s || t[7] !== l
      ? ((u = (0, Lt.jsx)(`div`, { className: s, style: l, children: n })),
        (t[5] = n),
        (t[6] = s),
        (t[7] = l),
        (t[8] = u))
...
var It,
  ...
  K,
  Bt = e(() => {
    ((zt = `_waveDot_1y69c_22`),
      (K = { waveDot: zt, "working-dot-wave": `_working-dot-wave_1y69c_1` }));
  });
function Vt(e) {
  let t = (0, Ht.c)(12),
    { className: n, label: r, onClick: i, show: a, showWorkingDots: o } = e,
    s = o === void 0 ? !1 : o,
    l = a ? `opacity-100` : `pointer-events-none opacity-0`,
    u;
  t[0] !== n || t[1] !== l
    ? ((u = c(
  ...
  t[3] === s
    ...
    : ((m = s
        ? (0, q.jsxs)(`span`, {
            ...
            children: [
              (0, q.jsx)(`span`, {
                className: c(`h-1 w-1 rounded-full bg-token-text-primary/70`, K.waveDot),
              }),
              (0, q.jsx)(`span`, {
                className: c(`h-1 w-1 rounded-full bg-token-text-primary/70`, K.waveDot),
              }),
        ...
        : (0, q.jsx)(Ie, { className: `icon rotate-180 text-token-text-primary` })),
      (t[3] = s),
      (t[4] = m));
  let h;
  return (
    t[5] !== r || t[6] !== u || t[7] !== d || t[8] !== f || t[9] !== p || t[10] !== m
      ? ((h = (0, q.jsx)(`button`, {
          className: u,
          "aria-hidden": d,
          "aria-label": r,
...
function Zt(e) {
  let t = (0, Y.c)(69),
    ...
    c = o === void 0 ? `section` : o,
    l = m(S),
    u = ue(),
    f;
  t[0] !== r || t[1] !== a || t[2] !== s
    ? ((f = { hostId: r, onImportSuccess: a, workspaceRoots: s }),
      (t[0] = r),
      (t[1] = a),
      (t[2] = s),
      (t[3] = f))
  ...
  let p = $t(f),
    h = p.isDetecting || i,
    g;
  t[4] !== p.importChoices || t[5] !== u
    ? ((g = p.importChoices.length === 0 ? null : ot(u, p.importChoices)),
      (t[4] = p.importChoices),
      (t[5] = u),
      (t[6] = g))
    : (g = t[6]);
  ...
  let y = v,
    b;
  t[9] !== p.providerIds || t[10] !== _ || t[11] !== y
    ? ((b = (e) => {
        _ != null && y({ source: `settings`, action: e, ...it(_, tt(_), p.providerIds) });
      }),
      (t[9] = p.providerIds),
      (t[10] = _),
      (t[11] = y),
  ...
  t[16] !== p || t[17] !== x
    ? ((E = () => {
        (x(`skipped`), p.setImportDialogOpen(!1));
      }),
      (t[16] = p),
      (t[17] = x),
      (t[18] = E))
  ...
  let D = E,
    O;
  t[19] !== p.detectedItems || t[20] !== p.selectedImportProviderIds || t[21] !== _ || t[22] !== u
    ? ((O =
        p.selectedImportProviderIds.length === 0
          ? _
          : st({
              detectedItems: p.detectedItems,
              intl: u,
              providerIds: p.selectedImportProviderIds,
            })),
      (t[19] = p.detectedItems),
      (t[20] = p.selectedImportProviderIds),
      (t[21] = _),
      (t[22] = u),
      (t[23] = O))
    : (O = t[23]);
  let k = O,
    A;
  t[24] !== p || t[25] !== y || t[26] !== k || t[27] !== D || t[28] !== c
    ? ((A =
        p.importDialogStep === `providers`
          ? (0, Z.jsx)(
              Ge,
              {
                appBrand: Le,
                ...
                onCustomize: p.selectImportProviders,
                onContinue: p.selectImportProviders,
                onSkip: D,
              },
              p.providerIds.join(`,`),
            )
          : k == null
            ...
            : (0, Z.jsx)(
                ct,
                {
                  ...
                  providerIds: p.selectedImportProviderIds,
                  summary: k,
                  isPending: p.isImporting,
                  hasError: p.importDialogStatus === `error`,
                  continueLabel:
                    c === `general-row`
                      ? (0, Z.jsx)(R, {
                  ...
                  onSkip: () => p.setImportDialogOpen(!1),
                  onContinue: (e) => {
                    p.importSelection(e);
                  },
                  onEvent: y,
                },
                p.selectedImportProviderIds.join(`,`),
              )),
      (t[24] = p),
      (t[25] = y),
      (t[26] = k),
    ...
    : (A = t[29]);
  let j;
  t[30] !== p.isImportDialogOpen || t[31] !== p.setImportDialogOpen || t[32] !== A
    ? ((j = (0, Z.jsx)(_e, {
        open: p.isImportDialogOpen,
        onOpenChange: p.setImportDialogOpen,
        size: `default`,
        children: A,
      })),
      (t[30] = p.isImportDialogOpen),
      (t[31] = p.setImportDialogOpen),
      (t[32] = A),
      (t[33] = j))
    : (j = t[33]);
  let M = j;
  if (c === `general-row`) {
    let e = _ != null,
      r = p.latestImportedAtMs != null,
      i = p.lastCompletedImportProgress != null;
    if (!e && !r && !i) return null;
    let a = p.isCompletedImportDialogOpen ? p.lastCompletedImportProgress : null,
      o;
    t[34] !== n || t[35] !== p.closeCompletedImportDialog || t[36] !== a
      ? ((o = (0, Z.jsx)(tn, {
          appName: z,
          progress: a,
          codexHome: n,
          onClose: p.closeCompletedImportDialog,
        })),
        (t[34] = n),
        (t[35] = p.closeCompletedImportDialog),
        (t[36] = a),
        (t[37] = o))
      : (o = t[37]);
    let s = o,
    ...
    t[38] === r
      ? (c = t[39])
      : ((c = r
          ? (0, Z.jsx)(R, { ...J.importedAgentSetup })
          : (0, Z.jsx)(R, { ...J.externalAgentImport })),
        (t[38] = r),
        (t[39] = c));
    let l;
    t[40] !== p.latestImportedAtMs || t[41] !== r
      ? ((l = r
          ? (0, Z.jsx)(R, {
              ...
              values: {
                relativeTime: (0, Z.jsx)(Pe, {
                  dateString: new Date(p.latestImportedAtMs ?? 0).toISOString(),
                }),
              },
            })
          : (0, Z.jsx)(R, {
        ...
        (t[40] = p.latestImportedAtMs),
        (t[41] = r),
        (t[42] = l))
      : (l = t[42]);
    let u = h || p.isImporting || (!e && (!r || !i)),
      f = !e && i ? p.openCompletedImportDialog : w,
      m;
    t[43] !== p.isImporting || t[44] !== e || t[45] !== r || t[46] !== h
      ? ((m = p.isImporting
          ? (0, Z.jsx)(R, {
      ...
      : (m = t[47]);
    let g;
    t[48] !== p.isImporting || t[49] !== u || t[50] !== f || t[51] !== m
      ? ((g = (0, Z.jsx)(d, {
          color: `secondary`,
          size: `toolbar`,
          disabled: u,
          loading: p.isImporting,
          onClick: f,
          children: m,
        })),
        (t[48] = p.isImporting),
      ...
      : (g = t[52]);
    let v;
    t[53] !== c || t[54] !== l || t[55] !== g
      ? ((v = (0, Z.jsx)(B, { id: H, label: c, description: l, control: g })),
        (t[53] = c),
        (t[54] = l),
        (t[55] = g),
        (t[56] = v))
    ...
    let y = _ == null ? null : M,
      b;
    return (
      t[57] !== s || t[58] !== v || t[59] !== y
        ? ((b = (0, Z.jsxs)(Z.Fragment, { children: [v, y, s] })),
          (t[57] = s),
          (t[58] = v),
          (t[59] = y),
          (t[60] = b))
  ...
  let F;
  return (
    t[63] !== p.isImporting || t[64] !== M || t[65] !== _ || t[66] !== h || t[67] !== w
      ? ((F = (0, Z.jsx)(Z.Fragment, {
          children: (0, Z.jsxs)(V, {
            className: `gap-2`,
            children: [
              P,
                ...
                children: h
                  ? (0, Z.jsx)(G, {
                      children: (0, Z.jsx)(B, {
                        ...
                        control: (0, Z.jsx)(ce, { className: `h-4 w-4` }),
                      }),
                    })
                  : (0, Z.jsx)(G, {
                      children:
...
function $t({ hostId: e, onImportSuccess: t, workspaceRoots: n }) {
  let r = m(S),
    i = Te(),
    a = at({ enabled: !0, workspaceRoots: n }),
    o = Ze(a.detectedItems),
    s =
      ne(`external-agent-import-status`, {
        params: { hostId: e, providers: ft },
        queryConfig: { refetchOnMount: !0, staleTime: 0 },
      }).data ?? gn,
    [c, l] = (0, X.useState)(null),
    [u, d] = (0, X.useState)(!1),
    [f, p] = (0, X.useState)(!1),
    [h, _] = (0, X.useState)(null),
    [v, y] = (0, X.useState)(null),
    [b, x] = (0, X.useState)(!1),
    [C, w] = (0, X.useState)(`items`),
    [T, E] = (0, X.useState)([]),
    [D, O] = (0, X.useState)(`idle`),
    k = Qt([s.latestImportedAtMs, h]),
    A = f ? v : k,
    M = a.isImporting || f,
    N = (e) => {
      (E(e), w(`items`));
    },
    P = async ({ providerIds: n, selection: o }) => {
      if ((O(`idle`), !a.hasImportableItems)) {
        x(!1);
        return;
      }
      let s =
        n.length === 0
          ? a.getSelectedItems(o)
          : Xe({ detectedItems: a.detectedItems, providerIds: n, selection: o });
      if (s.length === 0) {
        x(!1);
        return;
      }
          ...
          content: ({ close: e, level: t }) =>
            (0, Z.jsx)(g, {
              ...
              children: (0, Z.jsxs)(`div`, {
                ...
                children: [
                  (0, Z.jsx)(ce, { className: `icon-sm text-token-text-secondary` }),
                  (0, Z.jsx)(R, {
      ...
      try {
        u = `import`;
        let { projectRoots: n } = await a.importItems(s);
        ((f = n.length),
          (u = `complete_import`),
          await He({
            hostId: e,
            onImportedProjectRootsReady: (e) => {
              F(r, { importedProjectRoots: e });
            },
          ...
          await a.refetchDetectedItems(),
          (u = `invalidate_queries`),
          await Promise.all([
            ut(i),
            i.invalidateQueries({ queryKey: j(`codex-agents-md`) }),
            n.length === 0
              ? Promise.resolve()
              : i.invalidateQueries({ queryKey: j(`workspace-root-options`, { hostId: e }) }),
          ]),
          l({ status: `success`, items: s }),
          _(Date.now()),
          t?.(),
          m.success(
            (0, Z.jsx)(R, {
  ...
  return {
    ...
    importChoices: a.choices,
    importDialogStep: C,
    importDialogStatus: D,
    importSelection: (e) => P({ providerIds: T, selection: e }),
    isImportDialogOpen: b,
    isCompletedImportDialogOpen: u,
    isDetecting: a.isDetecting,
    isImporting: M,
    lastCompletedImportProgress: c,
    latestImportedAtMs: A,
    openCompletedImportDialog: () => {
      c != null && d(!0);
    },
    openImportDialog: () => {
      (O(`idle`), E(o), w(`providers`), x(!0));
    },
    detectedItems: a.detectedItems,
    providerIds: o,
    selectImportProviders: N,
    selectedImportProviderIds: T,
    unsupportedProjects: a.unsupportedProjects,
    setImportDialogOpen: x,
  };
}
function en(e) {
  let t = (0, Y.c)(7),
...
function tn(e) {
  ...
  t[1] === m
    ...
    : ((h = () => {
      ...
      (t[2] = h));
  let g;
  (t[3] !== i || t[4] !== m ? ((g = [i, m]), (t[3] = i), (t[4] = m), (t[5] = g)) : (g = t[5]),
    (0, X.useEffect)(h, g));
  let _;
  ...
  let x = i?.status,
    S;
  t[10] === x ? (S = t[11]) : ((S = cn(x)), (t[10] = x), (t[11] = S));
  let C = i?.status,
    w;
  t[12] === C ? (w = t[13]) : ((w = ln(C)), (t[12] = C), (t[13] = w));
  let T;
  t[14] === i ? (T = t[15]) : ((T = un(i)), (t[14] = i), (t[15] = T));
  let E;
  t[16] !== n || t[17] !== i
    ? ((E = dn(i, n)), (t[16] = n), (t[17] = i), (t[18] = E))
    : (E = t[18]);
  let D;
  t[19] !== w || t[20] !== T || t[21] !== E || t[22] !== S
    ? ((D = (0, Z.jsx)(f, {
        className: `gap-0`,
        children: (0, Z.jsx)(p, {
          icon: S,
    ...
    ? ((O =
        i != null && i.items.length > 0
          ? (0, Z.jsx)(f, {
              ...
              children: (0, Z.jsx)(nn, { codexHome: r, items: i.items, status: i.status }),
            })
          : null),
      (t[24] = r),
      (t[25] = i),
  ...
  t[37] !== k || t[38] !== j
    ? ((M = (0, Z.jsx)(be, {
        ...
        children: (0, Z.jsxs)(`div`, { className: `relative min-h-0`, children: [k, j] }),
      })),
      (t[37] = k),
      (t[38] = j),
      (t[39] = M))
        ...
        e.length > 0
          ? (0, Z.jsxs)(Z.Fragment, {
              children: [
                ...
                e.map((e) => (0, Z.jsx)(on, { codexHome: n, item: e, status: i }, hn(e))),
              ],
            })
          : null),
      (s =
        c.length > 0
          ? (0, Z.jsxs)(Z.Fragment, {
              children: [
                ...
                c.map((e) => (0, Z.jsx)(on, { codexHome: n, item: e, status: i }, hn(e))),
              ],
            })
          : null),
      (t[0] = n),
...
function on(e) {
  ...
  let s;
  t[3] !== n || t[4] !== r || t[5] !== i
    ? ((s = fn(r, n, i)), (t[3] = n), (t[4] = r), (t[5] = i), (t[6] = s))
    : (s = t[6]);
  let c;
  t[7] === i ? (c = t[8]) : ((c = (0, Z.jsx)(sn, { status: i })), (t[7] = i), (t[8] = c));
  let l;
  return (
    t[9] !== o || t[10] !== s || t[11] !== c
    ...
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsx)(`span`, {
            ...
            children: (0, Z.jsx)(ye, { className: `icon-2xs text-token-success` }),
          })),
          (t[1] = e))
        : (e = t[1]),
      e
  ...
  return (
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Z.jsx)(`span`, {
          ...
          children: (0, Z.jsx)(y, { className: `icon-2xs text-token-editor-error-foreground` }),
        })),
        (t[2] = r))
      : (r = t[2]),
    r
...
function cn(e) {
  return e === `success`
    ? (0, Z.jsx)(ye, { className: `icon-md text-token-charts-green` })
    : e === `error`
      ? (0, Z.jsx)(Be, { className: `icon-md text-token-danger` })
      : (0, Z.jsx)(ce, { className: `icon-md` });
}
function ln(e) {
  return e === `success`
...
function fn(e, t, n) {
  let r = n === `success` ? pn(e) : e.description;
  if (e.cwd == null || e.cwd === ``) {
    let e = r
    ...
    if (t != null && t !== ``) {
      ...
      ((e = e.split(t).join(`~/.codex`)),
        (e = e.split(Gt(n, `.claude`)).join(`~/.claude`)),
        (e = e.split(Gt(n, `.agents`)).join(`~/.agents`)));
    }
    return le(e);
  }
  let i = mn(e.cwd);
...
var Y,
  ...
  _n = e(() => {
    ((Y = L()),
      ...
      Qe(),
      (Z = l()),
      (Q = `external-agent-import`),
      (gn = { importedSessionCount: 0, latestImportedAtMs: null }));
  });
function vn(e) {
  return ie(e, yn) === !0;
}
...
//# sourceMappingURL=app-initial~app-main~pets-settings~appearance-settings~general-settings.js.map
