import { R as e, o as t, t as n } from "./app-scope.js";
import { js as r } from "./app-server-manager-signals.js";
import { f as i, g as a, k as o, m as s } from "./vscode-api.js";
import { c, r as l } from "./lib.js";
import { t as u } from "./invalidate-queries-and-broadcast.js";
import { d, s as f } from "./config-queries.js";
import { r as p } from "./toast-signal.js";
import { a as m, n as h } from "./apps-queries.js";
import { t as g } from "./use-plugins.js";
import { t as _ } from "./use-skills-J.js";
import { n as v, r as y } from "./plugin-config-edits.js";
import { a as b, t as x } from "./bundled-plugin-auto-install-preference.js";
import { n as S } from "./plugin-detail-queries.js";
...
function D(e) {
  ...
  i[3] === h
    ...
    : ((x = async (e) => {
        let { pluginId: t, enabled: n } = e;
        await Promise.all([h.cancelQueries({ queryKey: g }), h.cancelQueries({ queryKey: f })]);
        let r = h.getQueryData(f),
          i = h.getQueriesData({ queryKey: g }).flatMap(O);
        for (let [e, r] of i) h.setQueryData(e, N(r, t, n));
        if (r) {
          let e = { ...r.config };
          ((e.plugins = M(r.config.plugins, t, n)), h.setQueryData(f, { ...r, config: e }));
        }
  ...
  i[5] !== y || i[6] !== m
    ? ((S = (e, t) => {
        ...
        m.get(p).success(
          y.formatMessage(n ? E.enabledSuccess : E.disabledSuccess, { pluginName: r }),
        );
      }),
      (i[5] = y),
      (i[6] = m),
  ...
  i[8] !== y || i[9] !== h || i[10] !== m
    ? ((C = (e, t, n) => {
        (s.error(`Failed to update plugin enabled state`, { safe: {}, sensitive: { error: e } }),
          n?.previousUserConfig && h.setQueryData(f, n.previousUserConfig));
        for (let [e, t] of n?.previousPluginLists ?? []) h.setQueryData(e, t);
        m.get(p).danger(y.formatMessage(E.toggleError));
      }),
      (i[8] = y),
      (i[9] = h),
      (i[10] = m),
  ...
  i[12] === _
    ...
    : ((T = async () => {
      ...
      (i[13] = T));
  let D;
  i[14] !== b || i[15] !== x || i[16] !== S || i[17] !== C || i[18] !== T
...
function k(e) {
  ...
  i[0] !== l || i[1] !== f || i[2] !== d
    ? ((g = async (e) => {
        let { marketplaceName: t, pluginId: n, pluginName: i, requestPluginId: a } = e,
          o = y(n);
        (o != null && (await x(d, o, !0)),
          await r(`uninstall-plugin`, { hostId: l, pluginId: a ?? n }),
          F({ hostId: l, queryClient: f }),
          await b({ hostId: l, marketplaceName: t, pluginName: i }));
      }),
      (i[0] = l),
      (i[1] = f),
      (i[2] = d),
  ...
  i[4] !== h || i[5] !== d
    ? ((_ = (e, t) => {
        ...
        d.get(p).success(h.formatMessage(E.uninstallSuccess, { pluginName: n }));
      }),
      (v = (e) => {
        (s.error(`Failed to uninstall plugin`, { safe: {}, sensitive: { error: e } }),
          d.get(p).danger(h.formatMessage(E.uninstallError)));
      }),
      (i[4] = h),
      (i[5] = d),
      (i[6] = _),
  ...
  i[8] === m
    ...
    : ((S = () => {
      ...
      (i[9] = S));
  let C;
  i[10] !== g || i[11] !== _ || i[12] !== v || i[13] !== S
    ? ((C = { mutationFn: g, onSuccess: _, onError: v, onSettled: S }),
      (i[10] = g),
      (i[11] = _),
      (i[12] = v),
      (i[13] = S),
    ...
    : (C = i[14]);
  let T = a(C),
    D = T.isPending ? (T.variables?.pluginId ?? null) : null,
    O;
  return (
    i[15] !== T.mutateAsync || i[16] !== D
      ? ((O = { pendingUninstallPluginId: D, uninstallPlugin: T.mutateAsync }),
        (i[15] = T.mutateAsync),
        (i[16] = D),
        (i[17] = O))
      : (O = i[17]),
...
function A(e) {
  ...
  i[2] !== f || i[3] !== l
    ? ((h = (e, t) => {
      ...
      (g = (e) => {
        (s.error(`Failed to remove marketplace`, { safe: {}, sensitive: { error: e } }),
          l
            .get(p)
            .danger(
              f.formatMessage({
        ...
        if (e.errors.length > 0) {
          (s.error(`Failed to upgrade marketplaces`, {
            ...
            l
              .get(p)
              .danger(
                f.formatMessage(n == null ? E.marketplacesUpgradeError : E.marketplaceUpgradeError),
              ));
          return;
        }
        if (n != null) {
          l.get(p).success(f.formatMessage(E.marketplaceUpgradeSuccess, { marketplaceName: n }));
          return;
        }
        l.get(p).success(f.formatMessage(E.marketplacesUpgradeSuccess));
      }),
      (g = (e, t) => {
        let { marketplaceDisplayName: n } = t;
...
async function F({ hostId: e, queryClient: t }) {
  let n = h(e);
  await t
    .cancelQueries({ queryKey: n })
    .then(() => m({ hostId: e, queryClient: t }))
    .finally(() => i.dispatchMessage(`query-cache-invalidate`, { queryKey: n }))
    .catch((e) => {
      (t.invalidateQueries({ queryKey: n, refetchType: `none` }),
...
async function I(e) {
  await Promise.all([e(g), e(_), e(C), e(f), e(T)]);
}
