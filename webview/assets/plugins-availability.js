import { Li as e, Xs as t, ur as n } from "./app-server-manager-signals.js";
import {
  C as r,
  G as i,
  L as a,
...
import { C as m, s as h } from "./config-queries.js";
import { r as g } from "./toast-signal.js";
import { t as _ } from "./use-plugins.js";
...
import { t as S } from "./hooks-settings-queries.js";
async function C({ hostId: e, marketplacePath: t, pluginName: n }) {
  T(n) && (await f.chromeNativeHost?.install({ hostId: e, marketplacePath: t, pluginName: n }));
}
async function w({ hostId: e, marketplaceName: t, pluginName: n }) {
  T(n) && (await f.chromeNativeHost?.uninstall({ hostId: e, marketplaceName: t, pluginName: n }));
}
function T(e) {
...
function j(e) {
  ...
  n[4] === y
    ...
    : ((C = async (e) => {
        ...
        await Promise.all([y.cancelQueries({ queryKey: _ }), y.cancelQueries({ queryKey: h })]);
        let r = y.getQueryData(h),
          i = y.getQueriesData({ queryKey: _ }).flatMap(M);
        for (let [e, r] of i) y.setQueryData(e, L(r, t, n));
        if (r) {
          let e = { ...r.config };
          ((e.plugins = I(r.config.plugins, t, n)), y.setQueryData(h, { ...r, config: e }));
        }
  ...
  n[6] !== x || n[7] !== d
    ? ((w = (e, t) => {
        ...
        d.get(g).success(
          x.formatMessage(n ? A.enabledSuccess : A.disabledSuccess, { pluginName: r }),
        );
      }),
      (n[6] = x),
      (n[7] = d),
  ...
  n[9] !== x || n[10] !== y || n[11] !== d
    ? ((T = (e, t, n) => {
        (r.error(`Failed to update plugin enabled state`, { safe: {}, sensitive: { error: e } }),
  ...
  n[15] !== S || n[16] !== C || n[17] !== w || n[18] !== T || n[19] !== E
    ? ((D = { mutationFn: S, onMutate: C, onSuccess: w, onError: T, onSettled: E }),
      (n[15] = S),
      (n[16] = C),
      (n[17] = w),
      (n[18] = T),
...
function N(e) {
  ...
  n[0] !== a || n[1] !== s
    ? ((f = async (e) => {
        let { marketplaceName: n, pluginId: r, pluginName: i, requestPluginId: o } = e,
          c = y(r);
  ...
  n[3] !== d || n[4] !== s
    ? ((m = (e, t) => {
        ...
        s.get(g).success(d.formatMessage(A.uninstallSuccess, { pluginName: n }));
      }),
      (h = (e) => {
        (r.error(`Failed to uninstall plugin`, { safe: {}, sensitive: { error: e } }),
...
function P(e) {
  ...
  n[2] !== d || n[3] !== s
    ? ((m = (e, t) => {
      ...
      (h = (e) => {
        (r.error(`Failed to remove marketplace`, { safe: {}, sensitive: { error: e } }),
          s
            .get(g)
            .danger(
              d.formatMessage({
...
function F(e) {
  ...
  n[0] === a
    ...
    : ((f = async (e) => {
        let { marketplaceName: n } = e;
        return t(`upgrade-marketplaces`, { hostId: a, marketplaceName: n ?? null });
      }),
      (n[0] = a),
      (n[1] = f));
  let m, h;
  n[2] !== d || n[3] !== s
    ? ((m = (e, t) => {
        ...
        if (e.errors.length > 0) {
          (r.error(`Failed to upgrade marketplaces`, {
            ...
            s
              .get(g)
              .danger(
                d.formatMessage(n == null ? A.marketplacesUpgradeError : A.marketplaceUpgradeError),
              ));
          return;
        }
        if (n != null) {
          s.get(g).success(d.formatMessage(A.marketplaceUpgradeSuccess, { marketplaceName: n }));
          return;
        }
      ...
      (h = (e, t) => {
        let { marketplaceDisplayName: n } = t;
        (r.error(`Failed to upgrade marketplaces`, { safe: {}, sensitive: { error: e } }),
          s
            .get(g)
            .danger(
              d.formatMessage(
                n == null ? A.marketplacesUpgradeRequestError : A.marketplaceUpgradeError,
              ),
            ));
      }),
      (n[2] = d),
