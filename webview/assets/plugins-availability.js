...
import { g as r, k as i, m as a } from "./vscode-api.js";
import { As as o } from "./app-server-manager-signals.js";
import { c as s, r as c } from "./lib-1.js";
import { t as l } from "./invalidate-queries-and-broadcast.js";
import { d as u, s as d } from "./config-queries-BHYT-TjG.js";
...
import { a as _, c as v, t as y } from "./bundled-plugin-auto-install-preference.js";
import { t as b } from "./hooks-settings-queries.js";
var x = e(),
  S = [`user-saved-config`],
  C = c({
    enabledSuccess: {
...
function E(e) {
  ...
  i[0] !== c || i[1] !== u
    ? ((m = async (e) => {
        let { marketplaceName: t, pluginId: n, pluginName: r, requestPluginId: i } = e,
          a = g(n);
        (a != null && (await y(u, a, !0)),
          await o(`uninstall-plugin`, { hostId: c, pluginId: i ?? n }),
          await v({ hostId: c, marketplaceName: t, pluginName: r }));
      }),
      (i[0] = c),
      (i[1] = u),
      (i[2] = m))
  ...
  i[7] === d
    ...
    : ((b = () => {
      ...
      (i[8] = b));
  let S;
  i[9] !== m || i[10] !== h || i[11] !== _ || i[12] !== b
    ? ((S = { mutationFn: m, onSuccess: h, onError: _, onSettled: b }),
      (i[9] = m),
      (i[10] = h),
      (i[11] = _),
      (i[12] = b),
...
function D(e) {
  ...
  i[0] === c
    ...
    : ((m = async (e) => {
        ...
        await o(`remove-marketplace`, { hostId: c, marketplaceName: t });
      }),
      (i[0] = c),
      (i[1] = m));
  let h, g;
...
function O(e) {
  ...
  i[0] === c
    ...
    : ((m = async (e) => {
        let { marketplaceName: t } = e;
        return o(`upgrade-marketplaces`, { hostId: c, marketplaceName: t ?? null });
      }),
      (i[0] = c),
      (i[1] = m));
  let h, g;
