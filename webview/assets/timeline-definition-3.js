...
import "./dist-4.js";
import { n as a, r as o, t as s } from "./chunk-4.js";
import { K as c, a as l, b as u, o as d, y as f } from "./chunk-100.js";
import { t as p } from "./chunk-36.js";
import { f as m } from "./chunk-56.js";
var h = (function () {
  var e = a(function (e, t, n, r) {
    ...
    u = {
      ...
      table: [
        ...
        e(t, [2, 10], { 1: [2, 1] }),
        e(t, [2, 6]),
        { 12: 21, 14: n, 15: r, 17: i, 19: o, 20: s, 21: 17, 22: 18, 23: c, 24: l },
        e(t, [2, 8]),
        e(t, [2, 9]),
        e(t, [2, 11]),
        { 16: [1, 22] },
          ...
          switch (T[0]) {
            ...
            case 2:
              if (
                ...
                return E;
              (k &&
                ((n = n.slice(0, -1 * k * 2)), (i = i.slice(0, -1 * k)), (o = o.slice(0, -1 * k))),
...
var v = ``,
  ...
  j = a(function (e, t, n) {
    let r = { id: y++, section: v, type: v, task: e, score: t || 0, events: n ? [n] : [] };
    C.push(r);
  }, `addTask`),
  M = a(function (e) {
  ...
  te = a(function (e, n) {
    ...
    return (a(c, `ambivalent`), n.score > 3 ? o(i) : n.score < 3 ? s(i) : c(i), r);
  }, `drawFace`),
  ne = a(function (e, t) {
  ...
  ie = a(function (e, t, n, r) {
    ...
    ((o.x = t.x),
      ...
      (o.ry = 3),
      I(a, o),
      V(n)(t.task, a, o.x, o.y, o.width, o.height, { class: `task` }, n, t.colour));
  }, `drawTask`),
  ae = a(function (e, t) {
    I(e, {
      x: t.startx,
...
var ce = a(function (t, n, r, i, a, o = !1) {
    let { theme: s, look: c } = i,
      ...
      d = t.append(`g`);
    ((n.section = u),
      d.attr(`class`, (n.class ? n.class + ` ` : ``) + `timeline-node ` + (`section-` + u)));
    let f = d.append(`g`),
      p = d.append(`g`),
      m = p
        .append(`text`)
    ...
    if (
      ...
      (n.width += 2 * n.padding),
      p.attr(`transform`, `translate(` + n.width / 2 + `, ` + n.padding / 2 + `)`),
      l && p.attr(`transform`, `translate(${n.width / 2}, ${o ? n.padding / 2 + 3 : n.padding})`),
      ue(f, n, u, a, i),
  ...
  de = a(function (t, n, r, i) {
    ...
    let g = a.securityLevel,
      _;
    g === `sandbox` && (_ = e(`#i` + n));
    let v = e(g === `sandbox` ? _.nodes()[0].contentDocument.body : `body`).select(`#` + n);
    v.append(`g`);
    let y = i.db.getTasks(),
    ...
    if (
      ...
      (t.append(`stop`).attr(`offset`, `0%`).attr(`stop-color`, p).attr(`stop-opacity`, 1),
        t.append(`stop`).attr(`offset`, `100%`).attr(`stop-color`, m).attr(`stop-opacity`, 1));
    }
    c(void 0, v, a.timeline?.padding ?? 50, a.timeline?.useMaxWidth ?? !1);
  }, `draw`),
  W = a(function (e, t, n, r, i, a, s, c, l, u, d, f) {
    for (let c of t) {
      let t = { descr: c.task, section: n, number: n, width: 150, padding: 20, maxHeight: a };
      o.debug(`taskNode`, t);
  ...
  fe = a(function (e, t, n, r, i, a, s) {
    ...
    for (let l of t) {
      ...
      ((c += d), u.attr(`transform`, `translate(${r}, ${i})`), (i = i + 10 + d));
    }
    return ((i = l), c);
  }, `drawEvents`),
  ...
  _e = a(function (e, t, n, r) {
    ...
    f.forEach(function (e) {
      let t = { number: w, descr: e, section: w, width: D, padding: K, maxHeight: h },
    ...
    for (let [e, t] of l.entries()) {
      let n = { number: e, descr: t, section: t.section, width: G, padding: K, maxHeight: g },
    ...
    (o.debug(`maxSectionHeight before draw`, h), o.debug(`maxTaskHeight before draw`, g));
    let k = Math.max(g, O) + Z;
    T
      ? f.forEach((e) => {
          let t = l.filter((t) => t.section === e),
            n = { number: w, descr: e, section: w, width: D, padding: K, maxHeight: h };
  ...
  $ = a(function (e, t, n, r, i, a, s, c, l) {
    for (let u of t) {
      let t = { descr: u.task, section: n, number: n, width: G, padding: K, maxHeight: a };
      o.debug(`taskNode`, t);
  ...
  ve = a(function (e, t, n, r, i, a, s) {
    let c = a;
    for (let a of t) {
      let t = { descr: a, section: n, number: n, width: q, padding: K, maxHeight: 0 };
      o.debug(`eventNode`, t);
  ...
  Se = {
    ...
    renderer: {
      ...
      draw: a(
        (e, t, n, r) =>
          (r?.db?.getDirection?.() ?? `LR`) === `TD` ? ye.draw(e, t, n, r) : pe.draw(e, t, n, r),
        `draw`,
      ),
    },
    parser: g,
