...
import { Ut as L, Wt as R } from "./app-initial~app-main~automations-page.js";
import {
  $ as oe,
  D as se,
  E as ce,
...
function Se(e) {
  ...
  let te = p === g.PLUS,
    P;
  t[19] !== m || t[20] !== a
    ? ((P = je({ intl: m, pricingInfo: a, plan: g.PLUS })), (t[19] = m), (t[20] = a), (t[21] = P))
    : (P = t[21]);
  let ne, re;
  ...
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ae = t[24]);
  let F;
  t[25] !== n || t[26] !== o || t[27] !== s || t[28] !== l || t[29] !== te || t[30] !== P
    ? ((F = (0, $.jsx)(we, {
        currentPlan: n,
        isLoading: te,
        targetPlan: g.PLUS,
  ...
  t[42] !== M || t[43] !== N || t[44] !== F || t[45] !== L || t[46] !== A
    ? ((R = (0, $.jsxs)(`div`, { "aria-hidden": A, className: M, children: [N, F, L] })),
      (t[42] = M),
      (t[43] = N),
      (t[44] = F),
      (t[45] = L),
...
function Ce({ currentPlan: e, defaultTab: t, onClose: n, source: a }) {
  ...
  let O = (e, t) => {
    ...
    k = async (t, n, r) => {
      ...
      if (d == null || e === g.FREE || (n !== g.PLUS && n !== g.PROLITE && n !== g.PRO)) {
        O(i, r);
        return;
      }
      let a = J(n),
      ...
      try {
        ...
        if (f) {
          p({ kind: `scheduled_downgrade`, preview: e, updatedPlan: `chatgptprolite`, webUrl: i });
          return;
        }
    ...
    A = (e) => {
      f != null &&
        M(o, N, { ctaAction: e, modalType: f.kind, source: a, targetPlan: be(f.updatedPlan) });
    },
    ee = async () => {
      if (!(f == null || d == null)) {
        y(!0);
    ...
    children: [
      ...
      f == null
        ...
        : (0, $.jsx)(G, {
            ...
            onConfirm: () => {
              (A(
                f.kind === `saved_card_upgrade` && f.preview.amount_due.amount > 0
                  ? `pay_now`
                  : `confirm`,
              ),
                ee());
...
function we(e) {
  let t = (0, Z.c)(32),
    ...
    p;
  t[0] !== n || t[1] !== u
    ? ((p = he({ currentPlan: n, targetPlan: u })), (t[0] = n), (t[1] = u), (t[2] = p))
    : (p = t[2]);
  let m = p,
    h;
  t[3] !== n || t[4] !== u
    ? ((h = B({ currentPlan: n, targetPlan: u })), (t[3] = n), (t[4] = u), (t[5] = h))
    : (h = t[5]);
  let _ = h,
...
function ke(e) {
  ...
  t[0] === p
    ? (m = t[1])
    : ((m = O(`flex h-full min-h-0 flex-col rounded-2xl border p-4`, p)), (t[0] = p), (t[1] = m));
  let h = f === `large` && `h-10 justify-center`,
    g;
  t[2] === h ? (g = t[3]) : ((g = O(`flex flex-col gap-1`, h)), (t[2] = h), (t[3] = g));
  let _;
  t[4] === d
    ? (_ = t[5])
    : ((_ = (0, $.jsx)(`div`, {
  ...
  let b = f === `large` && `h-12 justify-center`,
    x;
  t[12] === b ? (x = t[13]) : ((x = O(`mt-3 flex flex-col`, b)), (t[12] = b), (t[13] = x));
  let S;
  t[14] !== c || t[15] !== f
    ? ((S =
        c == null
  ...
  let E = r == null ? `pt-8` : `gap-3`,
    D;
  t[30] === E ? (D = t[31]) : ((D = O(`mt-3 flex flex-col`, E)), (t[30] = E), (t[31] = D));
  let k;
  t[32] === r
    ? (k = t[33])
    : ((k =
...
function Pe() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(L, { className: `icon-sm text-token-charts-yellow` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
