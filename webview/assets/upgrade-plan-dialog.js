...
import { Jr as o } from "./app-server-manager-signals.js";
...
import { t as u } from "./clsx-Cir5-jBH.js";
import "./proxy.js";
...
import "./x.js";
import { Lr as f, Rr as p, t as m } from "./product-logger.js";
...
import { d as g, l as _, n as v, u as y } from "./dialog-layout-B.js";
...
import { t as x } from "./skus.js";
import "./codex-api-error.js";
import { t as S } from "./google-drive.js";
import "./_baseEach.js";
import "./_baseOrderBy.js";
import { p as C } from "./codex-api.js";
...
function L(e) {
  let t = (0, F.c)(94),
    ...
    m = c(),
    [h, b] = (0, te.useState)(p),
    [S, C] = (0, te.useState)(n === x.PRO ? x.PRO : x.PROLITE),
    w = n === x.GO || n === x.PLUS || n === x.PROLITE || n === x.PRO,
    T;
  ...
  t[9] === P
    ? (L = t[10])
    : ((L = u(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-3`, P)), (t[9] = P), (t[10] = L));
  let R;
  t[11] !== n ||
  t[12] !== a ||
  t[13] !== m ||
  ...
  t[17] !== w
    ? ((R = w
        ...
        : (0, I.jsx)(z, {
            currentPlan: n,
            targetPlan: x.FREE,
            price: re({ intl: m, pricingInfo: i, plan: x.FREE }),
            title: (0, I.jsx)(l, {
  ...
  let U;
  t[19] !== m || t[20] !== i
    ? ((U = re({ intl: m, pricingInfo: i, plan: x.PLUS })), (t[19] = m), (t[20] = i), (t[21] = U))
    : (U = t[21]);
  let W, le;
  ...
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ue = t[24]);
  let G;
  t[25] !== n || t[26] !== a || t[27] !== o || t[28] !== d || t[29] !== U
    ? ((G = (0, I.jsx)(z, {
        currentPlan: n,
        targetPlan: x.PLUS,
        price: U,
    ...
    ? ((K = w
        ? (0, I.jsxs)(I.Fragment, {
            children: [
              (0, I.jsx)(z, {
                currentPlan: n,
                targetPlan: x.PROLITE,
                price: re({ intl: m, pricingInfo: i, plan: x.PROLITE }),
                title: (0, I.jsx)(V, {
                  tier: (0, I.jsx)(l, {
                ...
                features: H(x.PROLITE),
                getPlansUrl: a,
                onCtaClick: o,
                onOpenUrl: d,
                planDetailsLabel: (0, I.jsx)(ne, { plan: x.PROLITE }),
              }),
              (0, I.jsx)(z, {
                currentPlan: n,
                targetPlan: x.PRO,
                price: re({ intl: m, pricingInfo: i, plan: x.PRO }),
                title: (0, I.jsx)(V, {
                  tier: (0, I.jsx)(l, {
                ...
                onCtaClick: o,
                onOpenUrl: d,
                planDetailsLabel: (0, I.jsx)(ne, { plan: x.PRO }),
              }),
            ],
          })
        : (0, I.jsx)(z, {
            currentPlan: n,
            targetPlan: S,
            price: re({ intl: m, pricingInfo: i, plan: S }),
            title: (0, I.jsxs)(`div`, {
            ...
            onCtaClick: o,
            onOpenUrl: d,
            planDetailsLabel: (0, I.jsx)(ne, { plan: S }),
          })),
      (t[31] = n),
      (t[32] = a),
      (t[33] = m),
  ...
  t[46] === fe
    ? (J = t[47])
    : ((J = u(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-2`, fe)),
      (t[46] = fe),
      (t[47] = J));
  ...
  t[57] !== a || t[58] !== o || t[59] !== d || t[60] !== Y
    ? ((X = (0, I.jsx)(B, {
        ...
        cta: ve,
        onClick: Y,
        targetPlan: x.SELF_SERVE_BUSINESS_USAGE_BASED,
        getPlansUrl: a,
        onCtaClick: o,
        onOpenUrl: d,
        planDetailsLabel: ye,
  ...
  t[72] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Te = t[72]);
  let $;
  t[73] !== a || t[74] !== o || t[75] !== d || t[76] !== Z || t[77] !== Q
    ? (($ = (0, I.jsx)(B, {
        title: be,
        subtitle: xe,
        priceLabel: Z,
        ...
        cta: we,
        onClick: Q,
        targetPlan: x.SELF_SERVE_BUSINESS,
        getPlansUrl: a,
        onCtaClick: o,
        onOpenUrl: d,
        planDetailsLabel: Te,
...
function R(e) {
  let t = (0, F.c)(30),
    { currentPlan: n, defaultTab: a, onClose: c, source: l } = e,
    u = r(i),
    { email: d } = b(),
    g = h(),
    { data: _ } = C(),
  ...
  let { data: y } = T(v),
    S;
  t[1] === y ? (S = t[2]) : ((S = { billingCurrency: y, enabled: !0 }), (t[1] = y), (t[2] = S));
  let { data: w } = E(S),
    ee;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = { logExposure: !1 }), (t[3] = ee))
    : (ee = t[3]);
  let k = O(ee),
    A = _?.plan_type,
    j,
  ...
  t[14] !== u || t[15] !== l
    ? ((z = (e, t) => {
        (t === x.SELF_SERVE_BUSINESS_USAGE_BASED &&
          m(u, o, { checkoutKind: `codex_team`, entryPoint: `direct_purchase_redirect` }),
          m(u, f, { ctaAction: e, source: l, targetPlan: t }));
      }),
      (t[14] = u),
      (t[15] = l),
      (t[16] = z))
  ...
  t[19] !== d || t[20] !== g
    ? ((V = (e) => {
        s.dispatchMessage(`open-in-browser`, {
          url: D({ loginHint: d, statsigClient: g, url: e }),
        });
      }),
      (t[19] = d),
      (t[20] = g),
...
function z(e) {
  let t = (0, F.c)(29),
    ...
    p;
  t[0] !== n || t[1] !== u
    ? ((p = j({ currentPlan: n, targetPlan: u })), (t[0] = n), (t[1] = u), (t[2] = p))
    : (p = t[2]);
  let m = p,
    h;
  t[3] !== n || t[4] !== u
    ? ((h = k({ currentPlan: n, targetPlan: u })), (t[3] = n), (t[4] = u), (t[5] = h))
    : (h = t[5]);
  let g = h,
    _;
  t[6] !== i || t[7] !== o || t[8] !== s
    ? ((_ = s == null ? null : (0, I.jsx)(W, { detailsLabel: s, getPlansUrl: i, onOpenUrl: o })),
      (t[6] = i),
      (t[7] = o),
      (t[8] = s),
      (t[9] = _))
    : (_ = t[9]);
  let v = m === `upgrade` ? `primary` : `outline`,
    y = m === `current`,
    b;
  t[10] !== m || t[11] !== a || t[12] !== o || t[13] !== u || t[14] !== g
    ? ((b = () => {
        g == null || m === `current` || (a(m, u), o(g));
      }),
      (t[10] = m),
      (t[11] = a),
      (t[12] = o),
  ...
  let C;
  return (
    t[23] !== r || t[24] !== c || t[25] !== _ || t[26] !== S || t[27] !== f
      ? ((C = (0, I.jsx)(U, {
          title: f,
          priceLabel: c,
          features: r,
...
function B(e) {
  let t = (0, F.c)(19),
    ...
    h;
  t[0] !== a || t[1] !== c || t[2] !== l
    ? ((h = (0, I.jsx)(W, { detailsLabel: l, getPlansUrl: a, onOpenUrl: c })),
      (t[0] = a),
      (t[1] = c),
      (t[2] = l),
      (t[3] = h))
...
function U(e) {
  let t = (0, F.c)(41),
    ...
    m;
  t[0] === p ? (m = t[1]) : ((m = u(`flex flex-col gap-1`, p)), (t[0] = p), (t[1] = m));
  let h;
  t[2] === d
    ? (h = t[3])
    : ((h = (0, I.jsx)(`div`, {
  ...
  let v = f === `large` && `h-12 justify-center`,
    y;
  t[10] === v ? (y = t[11]) : ((y = u(`mt-3 flex flex-col`, v)), (t[10] = v), (t[11] = y));
  let b;
  t[12] !== s || t[13] !== f
    ? ((b =
        s == null
  ...
  let w = r == null ? `pt-8` : `gap-3`,
    T;
  t[28] === w ? (T = t[29]) : ((T = u(`mt-3 flex flex-col`, w)), (t[28] = w), (t[29] = T));
  let E;
  t[30] === r
    ? (E = t[31])
    : ((E =
      ...
      (t[31] = E));
  let D;
  t[32] !== o || t[33] !== T || t[34] !== E
    ? ((D = (0, I.jsxs)(`div`, { className: T, children: [E, o] })),
      (t[32] = o),
      (t[33] = T),
      (t[34] = E),
      (t[35] = D))
...
function se() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, I.jsx)(S, { className: `icon-sm` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
