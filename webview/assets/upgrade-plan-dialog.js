...
import "./src-2.js";
import { fc as t, pc as n, si as r } from "./app-server-manager-signals.js";
...
import { h as m } from "./persisted-signal.js";
import "./rpc-2.js";
...
import { r as E, s as D, t as O } from "./get-codex-purchase-handoff-url.js";
import { i as k, l as A, r as ee, s as j } from "./plan-management-state.js";
import "./links.js";
import { t as M } from "./use-codex-pricing-url.js";
import { t as N } from "./conversation-starter-card.js";
...
function L(e) {
  let t = (0, F.c)(18),
    { ariaLabel: n, className: r, options: i, selectedId: a, onSelect: s } = e,
    c = (0, te.useId)(),
    l;
  t[0] === r
    ? (l = t[1])
    : ((l = o(`bg-token-foreground/10 inline-grid gap-1 rounded-2xl p-1`, r)),
      (t[0] = r),
      (t[1] = l));
  let u = `repeat(${i.length}, minmax(0, 1fr))`,
    d;
  t[2] === u ? (d = t[3]) : ((d = { gridTemplateColumns: u }), (t[2] = u), (t[3] = d));
  let f;
  if (t[4] !== c || t[5] !== s || t[6] !== i || t[7] !== a) {
    let e;
    (t[9] !== c || t[10] !== s || t[11] !== a
      ? ((e = (e) => {
          let t = e.id === a;
...
function R(e) {
  let t = (0, F.c)(94),
    ...
    u = d(),
    [p, m] = (0, te.useState)(`personal`),
    [h, g] = (0, te.useState)(n === b.PRO ? b.PRO : b.PROLITE),
    _ = n === b.GO || n === b.PLUS || n === b.PROLITE || n === b.PRO,
    v;
  ...
  t[6] !== T || t[7] !== p
    ...
    : (O = t[8]);
  let A = p !== `personal`,
    j = p !== `personal` && `invisible pointer-events-none`,
    M;
  t[9] === j
    ? (M = t[10])
    : ((M = o(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-3`, j)), (t[9] = j), (t[10] = M));
  let N;
  t[11] !== n ||
  t[12] !== i ||
  t[13] !== u ||
  ...
  t[17] !== _
    ? ((N = _
        ...
        : (0, I.jsx)(B, {
            currentPlan: n,
            targetPlan: b.FREE,
            price: ae({ intl: u, pricingInfo: r, plan: b.FREE }),
            title: (0, I.jsx)(f, {
  ...
  let P;
  t[19] !== u || t[20] !== r
    ? ((P = ae({ intl: u, pricingInfo: r, plan: b.PLUS })), (t[19] = u), (t[20] = r), (t[21] = P))
    : (P = t[21]);
  let R, z;
  ...
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (H = t[24]);
  let U;
  t[25] !== n || t[26] !== i || t[27] !== a || t[28] !== c || t[29] !== P
    ? ((U = (0, I.jsx)(B, {
        currentPlan: n,
        targetPlan: b.PLUS,
        price: P,
  ...
  t[38] !== _
    ? ((W = _
        ? (0, I.jsxs)(I.Fragment, {
            children: [
              (0, I.jsx)(B, {
                currentPlan: n,
                targetPlan: b.PROLITE,
                price: ae({ intl: u, pricingInfo: r, plan: b.PROLITE }),
                title: (0, I.jsx)(ne, {
                  tier: (0, I.jsx)(f, {
                ...
                features: re(b.PROLITE),
                getPlansUrl: i,
                onCtaClick: a,
                onOpenUrl: c,
                planDetailsLabel: (0, I.jsx)(ie, { plan: b.PROLITE }),
              }),
              (0, I.jsx)(B, {
                currentPlan: n,
                targetPlan: b.PRO,
                price: ae({ intl: u, pricingInfo: r, plan: b.PRO }),
                title: (0, I.jsx)(ne, {
                  tier: (0, I.jsx)(f, {
                ...
                onCtaClick: a,
                onOpenUrl: c,
                planDetailsLabel: (0, I.jsx)(ie, { plan: b.PRO }),
              }),
            ],
          })
        : (0, I.jsx)(B, {
            currentPlan: n,
            targetPlan: h,
            price: ae({ intl: u, pricingInfo: r, plan: h }),
            title: (0, I.jsxs)(`div`, {
            ...
            onCtaClick: a,
            onOpenUrl: c,
            planDetailsLabel: (0, I.jsx)(ie, { plan: h }),
          })),
      (t[31] = n),
      (t[32] = i),
      (t[33] = u),
    ...
    : (W = t[39]);
  let G;
  t[40] !== N || t[41] !== U || t[42] !== W || t[43] !== A || t[44] !== M
    ? ((G = (0, I.jsxs)(`div`, { "aria-hidden": A, className: M, children: [N, U, W] })),
      (t[40] = N),
      (t[41] = U),
      (t[42] = W),
      (t[43] = A),
    ...
    : (G = t[45]);
  let de = p !== `business`,
    fe = p !== `business` && `invisible pointer-events-none`,
    K;
  t[46] === fe
    ? (K = t[47])
    : ((K = o(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-2`, fe)),
      (t[46] = fe),
      (t[47] = K));
  ...
  t[57] !== i || t[58] !== a || t[59] !== c || t[60] !== q
    ? ((J = (0, I.jsx)(V, {
        ...
        cta: ve,
        onClick: q,
        targetPlan: b.SELF_SERVE_BUSINESS_USAGE_BASED,
        getPlansUrl: i,
        onCtaClick: a,
        onOpenUrl: c,
        planDetailsLabel: ye,
  ...
  let Y;
  t[64] !== u || t[65] !== r
    ? ((Y = oe({ intl: u, pricingInfo: r })), (t[64] = u), (t[65] = r), (t[66] = Y))
    : (Y = t[66]);
  let Se, Ce, we;
  ...
  t[72] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Te = t[72]);
  let Z;
  t[73] !== i || t[74] !== a || t[75] !== c || t[76] !== Y || t[77] !== X
    ? ((Z = (0, I.jsx)(V, {
        title: be,
        subtitle: xe,
        priceLabel: Y,
        ...
        cta: we,
        onClick: X,
        targetPlan: b.SELF_SERVE_BUSINESS,
        getPlansUrl: i,
        onCtaClick: a,
        onOpenUrl: c,
        planDetailsLabel: Te,
    ...
    : (Z = t[78]);
  let Q;
  t[79] !== de || t[80] !== K || t[81] !== J || t[82] !== Z
    ? ((Q = (0, I.jsxs)(`div`, { "aria-hidden": de, className: K, children: [J, Z] })),
      (t[79] = de),
      (t[80] = K),
      (t[81] = J),
      (t[82] = Z),
  ...
  let $;
  t[84] !== G || t[85] !== Q
    ? (($ = (0, I.jsxs)(`div`, { className: `grid`, children: [G, Q] })),
      (t[84] = G),
      (t[85] = Q),
      (t[86] = $))
    : ($ = t[86]);
...
function z(e) {
  let i = (0, F.c)(28),
    { currentPlan: a, onClose: o, source: u } = e,
    d = s(l),
    { email: f } = g(),
    p = h(),
    { data: v } = _(),
  ...
  let { data: x } = E(y),
    S;
  i[1] === x ? (S = i[2]) : ((S = { billingCurrency: x, enabled: !0 }), (i[1] = x), (i[2] = S));
  let { data: C } = D(S),
    w;
  i[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = { logExposure: !1 }), (i[3] = w))
    : (w = i[3]);
  let T = M(w),
    k = v?.plan_type,
    A,
  ...
  i[13] !== d || i[14] !== u
    ? ((L = (e, n) => {
        (n === b.SELF_SERVE_BUSINESS_USAGE_BASED &&
          m(d, r, { checkoutKind: `codex_team`, entryPoint: `direct_purchase_redirect` }),
          m(d, t, { ctaAction: e, source: u, targetPlan: n }));
      }),
      (i[13] = d),
      (i[14] = u),
      (i[15] = L))
  ...
  i[18] !== f || i[19] !== p
    ? ((B = (e) => {
        c.dispatchMessage(`open-in-browser`, {
          url: O({ loginHint: f, statsigClient: p, url: e }),
        });
      }),
      (i[18] = f),
      (i[19] = p),
  ...
  let V;
  return (
    i[21] !== a || i[22] !== T || i[23] !== z || i[24] !== B || i[25] !== P || i[26] !== L
      ? ((V = (0, I.jsx)(R, {
          open: !0,
          currentPlan: a,
          pricingInfo: P,
...
function B(e) {
  ...
  let p = d,
    m;
  t[3] !== n || t[4] !== l
    ? ((m = A({ currentPlan: n, targetPlan: l })), (t[3] = n), (t[4] = l), (t[5] = m))
    : (m = t[5]);
  let h = m,
    g;
  t[6] !== i || t[7] !== o || t[8] !== s
    ? ((g = s == null ? null : (0, I.jsx)(U, { detailsLabel: s, getPlansUrl: i, onOpenUrl: o })),
      (t[6] = i),
      (t[7] = o),
      (t[8] = s),
      (t[9] = g))
...
function V(e) {
  let t = (0, F.c)(19),
    ...
    m;
  t[0] !== a || t[1] !== c || t[2] !== l
    ? ((m = (0, I.jsx)(U, { detailsLabel: l, getPlansUrl: a, onOpenUrl: c })),
      (t[0] = a),
      (t[1] = c),
      (t[2] = l),
      (t[3] = m))
...
function ae({ intl: e, plan: t, pricingInfo: n }) {
  return n == null
    ? null
    : P({
        intl: e,
...
function se() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, I.jsx)(N, { className: `icon-sm`, name: `bubble-on-bubble` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function ce() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, I.jsx)(T, { className: `icon-sm text-token-charts-yellow` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
...
function ue() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, I.jsx)(N, { className: `icon-base`, name: `shield` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
export { R as UpgradePlanDialog, z as UpgradePlanDialogModal };
