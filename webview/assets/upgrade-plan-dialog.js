...
import { vr as o } from "./thread-context-inputs.js";
import { f as s } from "./vscode-api.js";
import "./isEqual.js";
import "./src.js";
import "./react-dom.js";
import { l as c, s as l } from "./lib-1.js";
...
import "./x.js";
import "./rpc.js";
import { c as p } from "./statsig.js";
import "./request.js";
import "./codex-api-error.js";
import "./markdown-to-search-text.js";
import "./marked.esm.js";
import { Kr as m, qr as h, t as g } from "./product-logger.js";
...
import { t as _ } from "./use-auth.js";
...
import { t as b } from "./google-drive.js";
import "./use-is-dark.js";
import "./with-window.js";
import { d as x, l as S, n as C, u as w } from "./dialog-layout.js";
import { t as T } from "./lightning-bolt.js";
import { a as E, l as D, n as O, r as k, t as A } from "./usage-queries.js";
import { n as j } from "./format-currency.js";
import "./links.js";
import { t as M } from "./use-codex-pricing-url.js";
import { i as ee, l as N, r as te, s as ne } from "./plan-management-state.js";
import { t as P } from "./conversation-starter-card-D5-kwyZS.js";
import { i as re, n as F, r as ie, t as I } from "./subscription-update-plan.js";
import { t as L } from "./plan-pricing.js";
var R = r(),
  z = e(t(), 1),
  B = n();
function V(e) {
  let t = (0, R.c)(96),
    ...
    g = c(),
    [_, v] = (0, z.useState)(m),
    [b, T] = (0, z.useState)(n === y.PRO ? y.PRO : y.PROLITE),
    E = n === y.GO || n === y.PLUS || n === y.PROLITE || n === y.PRO,
    D;
  ...
  t[6] !== k || t[7] !== _
    ...
    : (M = t[8]);
  let N = _ !== `personal`,
    ne = _ !== `personal` && `invisible pointer-events-none`,
    P;
  t[9] === ne
    ? (P = t[10])
    : ((P = u(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-3`, ne)),
      (t[9] = ne),
      (t[10] = P));
  let F;
  t[11] !== n ||
  ...
  t[17] !== E
    ? ((F = E
        ...
        : (0, B.jsx)(U, {
            currentPlan: n,
            targetPlan: y.FREE,
            price: le({ intl: g, pricingInfo: a, plan: y.FREE }),
            title: (0, B.jsx)(l, {
  ...
  let ie = h === y.PLUS,
    I;
  t[19] !== g || t[20] !== a
    ? ((I = le({ intl: g, pricingInfo: a, plan: y.PLUS })), (t[19] = g), (t[20] = a), (t[21] = I))
    : (I = t[21]);
  let L, V;
  ...
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (H = t[24]);
  let W;
  t[25] !== n || t[26] !== o || t[27] !== s || t[28] !== f || t[29] !== ie || t[30] !== I
    ? ((W = (0, B.jsx)(U, {
        currentPlan: n,
        isLoading: ie,
        targetPlan: y.PLUS,
  ...
  t[40] !== E
    ? ((G = E
        ? (0, B.jsxs)(B.Fragment, {
            children: [
              (0, B.jsx)(U, {
                currentPlan: n,
                isLoading: h === y.PROLITE,
                targetPlan: y.PROLITE,
                price: le({ intl: g, pricingInfo: a, plan: y.PROLITE }),
                title: (0, B.jsx)(oe, {
                  tier: (0, B.jsx)(l, {
                ...
                features: se(y.PROLITE),
                getPlansUrl: o,
                onCtaClick: s,
                onOpenUrl: f,
                planDetailsLabel: (0, B.jsx)(ce, { plan: y.PROLITE }),
              }),
              (0, B.jsx)(U, {
                currentPlan: n,
                isLoading: h === y.PRO,
                targetPlan: y.PRO,
                price: le({ intl: g, pricingInfo: a, plan: y.PRO }),
                title: (0, B.jsx)(oe, {
                  tier: (0, B.jsx)(l, {
                ...
                onCtaClick: s,
                onOpenUrl: f,
                planDetailsLabel: (0, B.jsx)(ce, { plan: y.PRO }),
              }),
            ],
          })
        : (0, B.jsx)(U, {
            ...
            isLoading: h === b,
            targetPlan: b,
            price: le({ intl: g, pricingInfo: a, plan: b }),
            title: (0, B.jsxs)(`div`, {
            ...
            onCtaClick: s,
            onOpenUrl: f,
            planDetailsLabel: (0, B.jsx)(ce, { plan: b }),
          })),
      (t[32] = n),
      (t[33] = o),
      (t[34] = g),
    ...
    : (G = t[41]);
  let K;
  t[42] !== P || t[43] !== F || t[44] !== W || t[45] !== G || t[46] !== N
    ? ((K = (0, B.jsxs)(`div`, { "aria-hidden": N, className: P, children: [F, W, G] })),
      (t[42] = P),
      (t[43] = F),
      (t[44] = W),
      (t[45] = G),
    ...
    : (K = t[47]);
  let he = _ !== `business`,
    ge = _ !== `business` && `invisible pointer-events-none`,
    q;
  t[48] === ge
    ? (q = t[49])
    : ((q = u(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-2`, ge)),
      (t[48] = ge),
      (t[49] = q));
  let _e, ve, ye, be, xe, Se;
  t[50] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_e = (0, B.jsx)(l, {
      ...
      (t[54] = xe),
      (t[55] = Se))
    : ((_e = t[50]), (ve = t[51]), (ye = t[52]), (be = t[53]), (xe = t[54]), (Se = t[55]));
  let J;
  t[56] === f
    ? (J = t[57])
    : ((J = () => {
  ...
  let X;
  t[66] !== g || t[67] !== a
    ? ((X = ue({ intl: g, pricingInfo: a })), (t[66] = g), (t[67] = a), (t[68] = X))
    : (X = t[68]);
  let Ee, De, Oe;
  ...
  t[74] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ke = t[74]);
  let Q;
  t[75] !== o || t[76] !== s || t[77] !== f || t[78] !== X || t[79] !== Z
    ? ((Q = (0, B.jsx)(ae, {
        title: we,
        subtitle: Te,
        priceLabel: X,
    ...
    : (Q = t[80]);
  let $;
  t[81] !== he || t[82] !== q || t[83] !== Y || t[84] !== Q
    ? (($ = (0, B.jsxs)(`div`, { "aria-hidden": he, className: q, children: [Y, Q] })),
      (t[81] = he),
      (t[82] = q),
      (t[83] = Y),
      (t[84] = Q),
  ...
  let Ae;
  t[86] !== K || t[87] !== $
    ? ((Ae = (0, B.jsxs)(`div`, { className: `grid`, children: [K, $] })),
      (t[86] = K),
      (t[87] = $),
      (t[88] = Ae))
    : (Ae = t[88]);
...
function H({ currentPlan: e, defaultTab: t, onClose: n, source: r }) {
  let l = i(a),
    u = c(),
    d = l.queryClient,
    { email: b } = _(),
    ...
    [T, ee] = (0, z.useState)(null),
    [N, te] = (0, z.useState)(!1),
    { data: ne } = E({ enabled: !0 }),
    { data: P } = D({ billingCurrency: ne, enabled: !0 }),
    re = M({ logExposure: !1 }),
    L = S?.plan_type;
  ((0, z.useEffect)(() => {
    L != null && L !== e.toString() && n();
  }, [e, L, n]),
    (0, z.useEffect)(() => {
      g(l, h, { defaultTab: t, source: r });
    }, [t, l, r]));
  let R = (e) => {
      s.dispatchMessage(`open-in-browser`, { url: e });
    },
    H = async (t, n) => {
      let r = j({ loginHint: b, statsigClient: x, url: t });
      if (S == null || e === y.FREE || (n !== y.PLUS && n !== y.PROLITE && n !== y.PRO)) {
        R(r);
        return;
      }
      let i = I(n),
        a = e === y.GO,
        o = e === y.PLUS && (n === y.PROLITE || n === y.PRO),
        s = e === y.PRO && n === y.PROLITE,
        c = e === y.PROLITE && n === y.PRO;
      if (!a && !o && !s && !c) {
        R(r);
        return;
      }
      ee(n);
      try {
        let e = await d.fetchQuery(O({ accountId: S.id, updatedPlan: i }));
        if (s) {
          w({ kind: `scheduled_downgrade`, preview: e, updatedPlan: `chatgptprolite`, webUrl: r });
          return;
        }
        let t = e.default_payment_method;
        if (
          !t?.card_last4?.trim() ||
          P?.minorUnitExponent == null ||
          P.currencyCode.toUpperCase() !== e.currency.toUpperCase()
        ) {
          R(r);
          return;
        }
    ...
    U = (e) => {
      C != null &&
        g(l, m, { ctaAction: e, modalType: C.kind, source: r, targetPlan: F(C.updatedPlan) });
    },
    ae = async () => {
      if (!(C == null || S == null)) {
        te(!0);
        try {
          let e = await k({ accountId: S.id, updatedPlan: C.updatedPlan });
          if (e.status == null || e.status === `pending`) {
            (w(null),
              e.status == null &&
                C.kind === `saved_card_upgrade` &&
                (l
                  .get(f)
                  .success(
                    u.formatMessage({
                ...
                n()),
              await Promise.all([
                d.invalidateQueries({ queryKey: [`accounts`, `check`] }),
                d.invalidateQueries({ queryKey: [`rate-limit-status`] }),
              ]));
            return;
          }
          (await A({ accountId: S.id }), R(C.webUrl), w(null));
        } catch {
          (R(C.webUrl), w(null));
        } finally {
          te(!1);
  ...
  return (0, B.jsxs)(B.Fragment, {
    children: [
      (0, B.jsx)(V, {
        ...
        getPlansUrl: re,
        onCtaClick: (e, t) => {
          (t === y.SELF_SERVE_BUSINESS_USAGE_BASED &&
            g(l, o, { checkoutKind: `codex_team`, entryPoint: `direct_purchase_redirect` }),
            g(l, m, { ctaAction: e, source: r, targetPlan: t }));
        },
        onOpenChange: (e) => {
          !e && C == null && n();
        },
      ...
      C == null
        ...
        : (0, B.jsx)(ie, {
            ...
            onConfirm: () => {
              (U(
                C.kind === `saved_card_upgrade` && C.preview.amount_due.amount > 0
                  ? `pay_now`
                  : `confirm`,
              ),
                ae());
            ...
            onGoToWeb: () => {
              (U(`go_to_web`), R(C.webUrl), w(null));
            },
            onOpenChange: (e) => {
              e || (U(`dismiss`), N || w(null));
            },
          }),
    ],
  });
...
function U(e) {
  let t = (0, R.c)(32),
    ...
    h;
  t[0] !== n || t[1] !== f
    ? ((h = ne({ currentPlan: n, targetPlan: f })), (t[0] = n), (t[1] = f), (t[2] = h))
    : (h = t[2]);
  let g = h,
    _;
  t[3] !== n || t[4] !== f
    ? ((_ = N({ currentPlan: n, targetPlan: f })), (t[3] = n), (t[4] = f), (t[5] = _))
    : (_ = t[5]);
  let v = _,
    b = (n === y.GO && f === y.PLUS) || (n === y.PLUS && f === y.PROLITE),
    x;
  t[6] !== i || t[7] !== s || t[8] !== c
    ? ((x = c == null ? null : (0, B.jsx)(G, { detailsLabel: c, getPlansUrl: i, onOpenUrl: s })),
      (t[6] = i),
      (t[7] = s),
      (t[8] = c),
      (t[9] = x))
    : (x = t[9]);
  let S = g === `upgrade` ? `primary` : `outline`,
    C = g === `current`,
    w;
  t[10] !== g || t[11] !== o || t[12] !== s || t[13] !== f || t[14] !== v
    ? ((w = () => {
        v == null || g === `current` || (o(g, f), s(v, f));
      }),
      (t[10] = g),
      (t[11] = o),
      (t[12] = s),
  ...
  t[16] !== g || t[17] !== m
    ...
    : (T = t[18]);
  let E;
  t[19] !== m || t[20] !== S || t[21] !== C || t[22] !== w || t[23] !== T
    ? ((E = (0, B.jsx)(d, {
  ...
  let D;
  return (
    t[25] !== r || t[26] !== u || t[27] !== E || t[28] !== b || t[29] !== x || t[30] !== p
      ? ((D = (0, B.jsx)(W, {
          highlighted: b,
          title: p,
          priceLabel: u,
...
function ae(e) {
  let t = (0, R.c)(20),
    ...
    h = p === y.SELF_SERVE_BUSINESS,
    g;
  t[0] !== a || t[1] !== c || t[2] !== l
    ? ((g = (0, B.jsx)(G, { detailsLabel: l, getPlansUrl: a, onOpenUrl: c })),
      (t[0] = a),
      (t[1] = c),
      (t[2] = l),
      (t[3] = g))
  ...
  return (
    t[1] === n
      ...
      : ((i = (0, B.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, B.jsx)(`span`, { className: `font-normal text-token-text-secondary`, children: n }),
          ],
        })),
        (t[1] = n),
        (t[2] = i)),
...
function W(e) {
  ...
  t[0] === m
    ? (h = t[1])
    : ((h = u(`flex h-full min-h-0 flex-col rounded-2xl border p-4`, m)), (t[0] = m), (t[1] = h));
  let g = p === `large` && `h-10 justify-center`,
    _;
  t[2] === g ? (_ = t[3]) : ((_ = u(`flex flex-col gap-1`, g)), (t[2] = g), (t[3] = _));
  let v;
  t[4] === f
    ? (v = t[5])
    : ((v = (0, B.jsx)(`div`, {
  ...
  let b;
  t[8] !== _ || t[9] !== v || t[10] !== y
    ? ((b = (0, B.jsxs)(`div`, { className: _, children: [v, y] })),
      (t[8] = _),
      (t[9] = v),
      (t[10] = y),
      (t[11] = b))
  ...
  let x = p === `large` && `h-12 justify-center`,
    S;
  t[12] === x ? (S = t[13]) : ((S = u(`mt-3 flex flex-col`, x)), (t[12] = x), (t[13] = S));
  let C;
  t[14] !== c || t[15] !== p
    ? ((C =
        c == null
          ...
          : (0, B.jsx)(`div`, {
              className: u(
                ...
                p === `large` ? `text-2xl font-normal` : `text-base font-medium`,
              ),
              children: c,
            })),
      (t[14] = c),
  ...
  t[19] !== S || t[20] !== C || t[21] !== w
    ? ((T = (0, B.jsxs)(`div`, { className: S, children: [C, w] })),
      (t[19] = S),
      (t[20] = C),
      (t[21] = w),
      (t[22] = T))
  ...
  let D = r == null ? `pt-8` : `gap-3`,
    O;
  t[30] === D ? (O = t[31]) : ((O = u(`mt-3 flex flex-col`, D)), (t[30] = D), (t[31] = O));
  let k;
  t[32] === r
    ? (k = t[33])
    : ((k =
        r == null ? null : (0, B.jsx)(`div`, { className: `flex h-5 items-center`, children: r })),
      (t[32] = r),
      (t[33] = k));
  let A;
  t[34] !== o || t[35] !== O || t[36] !== k
    ? ((A = (0, B.jsxs)(`div`, { className: O, children: [k, o] })),
      (t[34] = o),
      (t[35] = O),
      (t[36] = k),
      (t[37] = A))
  ...
  return (
    t[38] !== T || t[39] !== E || t[40] !== A || t[41] !== h || t[42] !== b
      ? ((j = (0, B.jsxs)(`section`, { className: h, children: [b, T, E, A] })),
        (t[38] = T),
        (t[39] = E),
        (t[40] = A),
        (t[41] = h),
...
function G(e) {
  ...
  t[4] === n
    ? (s = t[5])
    : ((s = (0, B.jsx)(`span`, { className: `sr-only`, children: n })), (t[4] = n), (t[5] = s));
  let c;
  return (
    t[6] !== a || t[7] !== s
      ? ((c = (0, B.jsxs)(`button`, {
...
function le({ intl: e, plan: t, pricingInfo: n }) {
  return n == null
    ? null
    : L({
        intl: e,
...
function ue({ intl: e, pricingInfo: t }) {
...
function de() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, B.jsx)(P, { className: `icon-sm`, name: `bubble-on-bubble` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function fe() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, B.jsx)(T, { className: `icon-sm text-token-charts-yellow` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function pe() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, B.jsx)(b, { className: `icon-sm` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function me() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, B.jsx)(P, { className: `icon-base`, name: `shield` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
export { V as UpgradePlanDialog, H as UpgradePlanDialogModal };
