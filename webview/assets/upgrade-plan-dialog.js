...
function Se(e) {
  let t = (0, Z.c)(96),
    ...
    g = m(),
    [_, b] = (0, Q.useState)(p),
    [x, S] = (0, Q.useState)(n === I.PRO ? I.PRO : I.PROLITE),
    C = n === I.GO || n === I.PLUS || n === I.PROLITE || n === I.PRO,
    w;
  ...
  t[9] === j
    ? (M = t[10])
    : ((M = P(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-3`, j)), (t[9] = j), (t[10] = M));
  let N;
  t[11] !== n ||
  t[12] !== o ||
  t[13] !== g ||
  ...
  t[17] !== C
    ? ((N = C
        ...
        : (0, $.jsx)(we, {
            currentPlan: n,
            targetPlan: I.FREE,
            price: je({ intl: g, pricingInfo: a, plan: I.FREE }),
            title: (0, $.jsx)(l, {
  ...
  let ee = h === I.PLUS,
    F;
  t[19] !== g || t[20] !== a
    ? ((F = je({ intl: g, pricingInfo: a, plan: I.PLUS })), (t[19] = g), (t[20] = a), (t[21] = F))
    : (F = t[21]);
  let te, ne;
  ...
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (re = t[24]);
  let L;
  t[25] !== n || t[26] !== o || t[27] !== s || t[28] !== u || t[29] !== ee || t[30] !== F
    ? ((L = (0, $.jsx)(we, {
        currentPlan: n,
        isLoading: ee,
        targetPlan: I.PLUS,
  ...
  t[40] !== C
    ? ((R = C
        ? (0, $.jsxs)($.Fragment, {
            children: [
              (0, $.jsx)(we, {
                currentPlan: n,
                isLoading: h === I.PROLITE,
                targetPlan: I.PROLITE,
                price: je({ intl: g, pricingInfo: a, plan: I.PROLITE }),
                title: (0, $.jsx)(Ee, {
                  tier: (0, $.jsx)(l, {
                ...
                features: De(I.PROLITE),
                getPlansUrl: o,
                onCtaClick: s,
                onOpenUrl: u,
                planDetailsLabel: (0, $.jsx)(Oe, { plan: I.PROLITE }),
              }),
              (0, $.jsx)(we, {
                currentPlan: n,
                isLoading: h === I.PRO,
                targetPlan: I.PRO,
                price: je({ intl: g, pricingInfo: a, plan: I.PRO }),
                title: (0, $.jsx)(Ee, {
                  tier: (0, $.jsx)(l, {
                ...
                onCtaClick: s,
                onOpenUrl: u,
                planDetailsLabel: (0, $.jsx)(Oe, { plan: I.PRO }),
              }),
            ],
          })
        : (0, $.jsx)(we, {
            ...
            isLoading: h === x,
            targetPlan: x,
            price: je({ intl: g, pricingInfo: a, plan: x }),
            title: (0, $.jsxs)(`div`, {
    ...
    : (R = t[41]);
  let z;
  t[42] !== M || t[43] !== N || t[44] !== L || t[45] !== R || t[46] !== A
    ? ((z = (0, $.jsxs)(`div`, { "aria-hidden": A, className: M, children: [N, L, R] })),
      (t[42] = M),
      (t[43] = N),
      (t[44] = L),
      (t[45] = R),
  ...
  t[48] === se
    ? (B = t[49])
    : ((B = P(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-2`, se)),
      (t[48] = se),
      (t[49] = B));
  let ce, le, ue, fe, pe, me;
  t[50] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = (0, $.jsx)(l, {
      ...
      (t[54] = pe),
      (t[55] = me))
    : ((ce = t[50]), (le = t[51]), (ue = t[52]), (fe = t[53]), (pe = t[54]), (me = t[55]));
  let V;
  t[56] === u
    ? (V = t[57])
    : ((V = (e) => {
        u(oe, I.SELF_SERVE_BUSINESS_USAGE_BASED, e);
      }),
      (t[56] = u),
      (t[57] = V));
  let he;
  ...
  t[59] !== o || t[60] !== s || t[61] !== u || t[62] !== V
    ? ((H = (0, $.jsx)(Te, {
        ...
        cta: me,
        onClick: V,
        targetPlan: I.SELF_SERVE_BUSINESS_USAGE_BASED,
        getPlansUrl: o,
        onCtaClick: s,
        onOpenUrl: u,
        planDetailsLabel: he,
  ...
  let U;
  t[66] !== g || t[67] !== a
    ? ((U = Me({ intl: g, pricingInfo: a })), (t[66] = g), (t[67] = a), (t[68] = U))
    : (U = t[68]);
  let ve, W, ye;
  ...
  t[74] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (be = t[74]);
  let K;
  t[75] !== o || t[76] !== s || t[77] !== u || t[78] !== U || t[79] !== G
    ? ((K = (0, $.jsx)(Te, {
        title: ge,
        subtitle: _e,
        priceLabel: U,
        ...
        cta: ye,
        onClick: G,
        targetPlan: I.SELF_SERVE_BUSINESS,
        getPlansUrl: o,
        onCtaClick: s,
        onOpenUrl: u,
        planDetailsLabel: be,
...
function Ce({ currentPlan: e, defaultTab: t, onClose: n, source: i }) {
  let o = b(c),
    ...
    [y, S] = (0, Q.useState)(!1),
    { data: C } = V({ enabled: !0 }),
    { data: w } = _e({ billingCurrency: C, enabled: !0 }),
    T = ue({ logExposure: !1 }),
    D = f?.plan_type;
  ((0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      g(o, r, { defaultTab: t, source: i });
    }, [t, o, i]));
  let k = (e, t) => {
      if (t != null) {
        x({ event: t, href: e, initiator: `open_in_browser_bridge` });
        return;
      }
      ne({ href: e, initiator: `open_in_browser_bridge` });
    },
    A = async (t, n, r) => {
      let i = H({ loginHint: u, statsigClient: d, url: t });
      if (O(r)) {
        k(i, r);
        return;
      }
      if (f == null || e === I.FREE || (n !== I.PLUS && n !== I.PROLITE && n !== I.PRO)) {
        k(i, r);
        return;
      }
      let a = J(n),
        o = e === I.GO,
        s = e === I.PLUS && (n === I.PROLITE || n === I.PRO),
        c = e === I.PRO && n === I.PROLITE,
        p = e === I.PROLITE && n === I.PRO;
      if (!o && !s && !c && !p) {
        k(i, r);
        return;
      }
      v(n);
      try {
        let e = await l.fetchQuery(B({ accountId: f.id, updatedPlan: a }));
        if (c) {
    ...
    j = (e) => {
      p != null &&
        g(o, M, { ctaAction: e, modalType: p.kind, source: i, targetPlan: be(p.updatedPlan) });
    },
    N = async () => {
      if (!(p == null || f == null)) {
        S(!0);
        try {
          let e = await me({ accountId: f.id, updatedPlan: p.updatedPlan });
          if (e.status == null || e.status === `pending`) {
            (h(null),
              e.status == null &&
                ...
                n()),
              await Promise.all([
                l.invalidateQueries({ queryKey: [`accounts`, `check`] }),
                l.invalidateQueries({ queryKey: [`rate-limit-status`] }),
              ]));
            return;
          }
          (await ce({ accountId: f.id }), k(p.webUrl), h(null));
        } catch {
          (k(p.webUrl), h(null));
        } finally {
          S(!1);
  ...
  return (0, $.jsxs)($.Fragment, {
    children: [
      (0, $.jsx)(Se, {
        ...
        getPlansUrl: T,
        onCtaClick: (e, t) => {
          (t === I.SELF_SERVE_BUSINESS_USAGE_BASED &&
            fe(o, {
              audience: `workspace`,
              checkoutKind: `codex_team`,
              entryPoint: `upgrade_plan_modal`,
            }),
            g(o, M, { ctaAction: e, source: i, targetPlan: t }));
        },
        onOpenChange: (e) => {
          !e && p == null && n();
        },
      ...
      p == null
        ...
        : (0, $.jsx)(G, {
            ...
            onGoToWeb: (e) => {
              (j(`go_to_web`), k(p.webUrl, e), h(null));
            },
            onOpenChange: (e) => {
              e || (j(`dismiss`), y || h(null));
            },
          }),
    ],
  });
...
function we(e) {
  let t = (0, Z.c)(32),
    ...
    m;
  t[0] !== n || t[1] !== d
    ? ((m = se({ currentPlan: n, targetPlan: d })), (t[0] = n), (t[1] = d), (t[2] = m))
    : (m = t[2]);
  let h = m,
    g;
  t[3] !== n || t[4] !== d
    ? ((g = he({ currentPlan: n, targetPlan: d })), (t[3] = n), (t[4] = d), (t[5] = g))
    : (g = t[5]);
  let _ = g,
    v = (n === I.GO && d === I.PLUS) || (n === I.PLUS && d === I.PROLITE),
    y;
  t[6] !== i || t[7] !== s || t[8] !== c
...
function Pe() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(z, { className: `icon-sm text-token-charts-yellow` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Fe() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(S, { className: `icon-sm` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
