...
async function de(e) {
  let t = [],
    n = null;
  do {
    let r = await k(`list-experimental-features`, { hostId: e, cursor: n, limit: R });
...
function fe(e) {
  ...
  t[2] === n
    ...
    : ((c = async (e) => {
        ...
        return k(`batch-write-config-value`, {
          hostId: n,
          edits: [{ keyPath: l(t), value: r, mergeStrategy: `upsert` }],
          filePath: null,
    ...
    ? ((u = (e) => {
      ...
      (d = (e, t, n) => {
        (a.error(`Failed to update experimental feature`, {
          ...
          n?.previousFeatures && r.setQueryData(o, n.previousFeatures));
      }),
      (t[4] = o),
      (t[5] = r),
      (t[6] = u),
  ...
  t[8] !== o || t[9] !== s || t[10] !== r
    ? ((f = async (e, t, n) => {
        await Promise.all([
          r.invalidateQueries({ queryKey: o }),
          n.featureName === `memories` ? s(D) : Promise.resolve(),
        ]);
      }),
      (t[8] = o),
      (t[9] = s),
  ...
  return (
    t[12] !== c || t[13] !== u || t[14] !== d || t[15] !== f
      ? ((m = { mutationFn: c, onMutate: u, onError: d, onSettled: f }),
        (t[12] = c),
        (t[13] = u),
        (t[14] = d),
        (t[15] = f),
...
function W({ ctrlKey: e, metaKey: t }) {
  return he.test(navigator.platform) ? t : e;
}
var he,
  G = e(() => {
    he = /Mac|iPhone|iPad|iPod/;
  });
function K(e) {
  return J.test(e);
}
...
function ge({ event: e, href: t, hostId: n, initiator: r, openTarget: i, originHostId: a }) {
  return (_e(t), X({ event: e, href: t, hostId: n, initiator: r, openTarget: i, originHostId: a }));
}
function X({
  disposition: e,
  event: t,
...
function xe(e, t, n) {
  if (n.validHosts !== null) {
    let e = n.validHosts;
    for (let n of e) if (ye(t, n)) return n;
  }
  let r = 0;
  if (t.startsWith(`.`)) for (; r < t.length && t[r] === `.`;) r += 1;
  return e.length === t.length - r ? null : be(t, e);
}
var Se = e(() => {});
function Ce(e, t) {
...
function Me(e) {
  if (
    e.length > 255 ||
    e.length === 0 ||
    (!je(e.charCodeAt(0)) && e.charCodeAt(0) !== 46 && e.charCodeAt(0) !== 95)
  )
    return !1;
  let t = -1,
    n = -1,
  ...
  for (let i = 0; i < r; i += 1) {
    ...
    if (r === 46) {
      ...
      t = i;
    } else if (!(je(r) || r === 45 || r === 95)) return !1;
    n = r;
  }
...
function Ve(e, t, n, r, i) {
  ...
  return typeof e != `string` ||
    (a.extractHostname
      ? a.mixedInputs
        ? (i.hostname = Te(e, Me(e)))
        : (i.hostname = Te(e, !1))
      : (i.hostname = e),
    a.detectIp && i.hostname !== null && ((i.isIp = ke(i.hostname)), i.isIp))
    ? i
    : a.validateHostname && a.extractHostname && i.hostname !== null && !Me(i.hostname)
      ? ((i.hostname = null), i)
      : (t === 0 ||
          i.hostname === null ||
          (n(i.hostname, a, i), t === 2 || i.publicSuffix === null) ||
          ((i.domain = xe(i.publicSuffix, i.hostname, a)), t === 3 || i.domain === null) ||
          ((i.subdomain = Re(i.hostname, i.domain)), t === 4) ||
          (i.domainWithoutSuffix = Ce(i.domain, i.publicSuffix)),
        i);
}
var He = e(() => {
  (Se(), we(), Ee(), Ae(), Ne(), Le(), ze());
});
function Ue(e, t, n) {
    ...
    ((Ke = (function () {
      ...
      (qe = (function () {
        let e = [1, {}],
          ...
          ee = [0, { lb: t, s3: t, website: t }],
          te = [2, { nodes: t }],
          ne = [0, { my: t }],
          C = [0, { s3: t, "s3-accesspoint": t, "s3-website": t }],
          re = [0, { s3: t, "s3-accesspoint": t }],
          ie = [0, { direct: t }],
          w = [0, { "webview-assets": t }],
          T = [0, { vfs: t, "webview-assets": t }],
          E = [
            0,
            {
              "execute-api": t,
          ...
          P = [0, { app: t }],
          F = [0, { site: t }],
          I = [1, { com: e, edu: e, net: e, org: e }],
          L = [0, { j: t }],
          de = [0, { dyn: t }],
          fe = [2, { web: t }],
          pe = [1, { co: e, com: e, edu: e, gov: e, net: e, org: e }],
          R = [0, { p: t }],
          z = [0, { user: t }],
          B = [1, { ms: t }],
          V = [0, { cdn: t }],
          ...
          K = [1, { framer: t }],
          q = [0, { forgot: t }],
          J = [0, { core: [0, { blob: t, file: t, web: t }], servicebus: t }],
          Y = [1, { gs: e }],
          ge = [0, { nes: e }],
          X = [1, { k12: e, cc: e, lib: e }],
          Z = [1, { cc: e }],
          Q = [1, { cc: e, lib: e }];
        return [
          0,
          {
            ac: [
              1,
              { com: e, edu: e, gov: e, mil: e, net: e, org: e, drr: t, feedback: t, forms: t },
            ],
            ad: e,
            ...
            au: [
              1,
              {
                ...
                edu: [
                  1,
                  { act: e, catholic: e, nsw: e, nt: e, qld: e, sa: e, tas: e, vic: e, wa: e },
                ],
            ...
            dk: [
              1,
              { biz: t, co: t, firm: t, reg: t, store: t, "123hjemmeside": t, myspreadshop: t },
            ],
            dm: pe,
            do: [
              1,
              { art: e, com: e, edu: e, gob: e, gov: e, mil: e, net: e, org: e, sld: e, web: e },
            ],
            dz: [
              1,
              { art: e, asso: e, com: e, edu: e, gov: e, net: e, org: e, pol: e, soc: e, tm: e },
            ],
            ec: [
              1,
              {
            ...
            eu: [
              1,
              {
                amazonwebservices: [
                  0,
                  { on: [0, { "eusc-de-east-1": [0, { "cognito-idp": M }] }] },
                ],
                cloudns: t,
                prvw: t,
                deuxfleurs: t,
            ...
            mw: [
              1,
              { ac: e, biz: e, co: e, com: e, coop: e, edu: e, gov: e, int: e, net: e, org: e },
            ],
            ...
            name: [1, { her: q, his: q, ispmanager: t, keenetic: t }],
            nc: [1, { asso: e, nom: e }],
            ne: e,
            net: [
              1,
              {
                ...
                massivegrid: [
                  0,
                  {
                    paas: [
                      0,
                      { "fr-1": t, "lon-1": t, "lon-2": t, "ny-1": t, "ny-2": t, "sg-1": t },
                    ],
                  },
                ],
            ...
            no: [
              1,
              {
                ...
                nordland: [
                  0,
                  { bo: e, "xn--b-5ga": e, bø: e, heroy: e, "xn--hery-ira": e, herøy: e },
                ],
                "nordre-land": e,
                nordreisa: e,
                "nore-og-uvdal": e,
            ...
            cloud: [
              1,
              {
                ...
                jote: t,
                jotelulu: t,
                k2: [0, { elastic: t, "ru-msk": ee, "ru-spb": ee, s3: t, website: t }],
                kuleuven: t,
                laravel: t,
                linkyard: t,
                magentosite: i,
            ...
            edeka: e,
            education: b,
            email: [1, { crisp: [0, { on: t }], intouch: t, tawk: R, tawkto: R }],
            emerck: e,
            energy: e,
            engineer: e,
            engineering: e,
...
`),
  ...
  if (/^[a-z][a-z0-9+.-]*:\/\//i.test(i)) return n ? (at(i) ?? i) : i;
  if (/^about:/i.test(i)) return i;
  if (h(i) && !i.startsWith(`//`) && !(i.startsWith(`/`) && r)) {
    let e = b(``, i),
      t = new URL(`file:///`);
    if (te(e)) {
      let n = e.indexOf(`/`, 2);
  ...
  let a = ct(i);
  if (nt(a)) return `http://${i}`;
  if (st(i, a)) return `https://${i}`;
  if (/\s/.test(i)) return dt(i);
  if (n) {
    let e = at(i);
    if (e != null) return e;
  }
...
function tt(e) {
  ...
  try {
    let e = new URL(t);
    if (e.protocol === `file:`) {
      let t = o(decodeURIComponent(e.pathname));
...
function nt(e) {
  return e != null && it(e.hostname);
}
function rt(e) {
  return e.protocol !== `http:` && e.protocol !== `https:` ? !1 : it(e.hostname);
}
function it(e) {
  return y(e);
}
function at(e) {
  ...
  return (n.protocol !== `http:` && n.protocol !== `https:`) ||
    ...
    n.port.length > 0
    ? null
    : ((n.hostname = ft), n.searchParams.append(pt, mt), n.toString());
}
function ot(e) {
...
function st(e, t) {
  return /\s/.test(e) || t == null
    ...
    : t.hostname.startsWith(`[`)
      ? lt(t.hostname)
      : t.hasPort || t.hostname.startsWith(`www.`) || lt(t.hostname) || ut(t.hostname);
}
function ct(e) {
  let t = e.search(/[/?#]/),
    n = t === -1 ? e : e.slice(0, t);
...
function ut(e) {
  let t = Qe(e, { allowPrivateDomains: !0 });
...
var ft,
  ...
  mt,
  ht = e(() => {
    (n(), $e(), x(), (ft = `golinks.io`), (pt = `trackSource`), (mt = `go_domain_redirect`));
  });
function gt(e) {
  return _t(e) != null;
}
...
function yt({ browserTabId: e, conversationId: n, isMultiBrowserTabsEnabled: r, url: i }) {
  if (r) {
  ...
  t.dispatchMessage(`browser-sidebar-command`, {
    browserTabId: e,
    conversationId: n,
    command: { type: `navigate`, url: i, source: `manual`, initiator: `app_menu` },
  });
}
function bt({ conversationId: e, url: n, source: r, initiator: i }) {
  let a = _t(n);
  return a == null
    ? !1
    : (t.dispatchHostMessage({
...
function St({ href: e, isBrowserSidebarEnabled: t }) {
  let n = q(e);
  return t && K(e) && (gt(e) || wt(n));
}
function Ct({ conversationId: e, href: t, initiator: n }) {
  let r = q(t),
    i = wt(r);
  return [
    {
      ...
      onSelect: () => {
        if (e == null || i) {
          Z({ href: r, initiator: n, openTarget: `in-app-browser` });
          return;
        }
        bt({ conversationId: e, url: t, source: `manual`, initiator: n });
      },
    },
    {
      ...
      onSelect: () => {
        Z({ href: r, initiator: n, openTarget: `external-browser` });
      },
    },
...
function Et(e) {
  ...
  let n;
  return (t[3] === e ? (n = t[4]) : ((n = (0, $.jsx)(Dt, { ...e })), (t[3] = e), (t[4] = n)), n);
}
function Dt(e) {
  let t = (0, kt.c)(4),
    n = v(U),
  ...
  return (
    t[0] !== n || t[1] !== e || t[2] !== r
      ? ((i = (0, $.jsx)(Ot, { ...e, conversationId: r, isBrowserSidebarEnabled: n })),
        (t[0] = n),
        (t[1] = e),
        (t[2] = r),
        (t[3] = i))
...
function Ot(e) {
  ...
  t[0] === e
    ...
    : (({
      ...
      (t[11] = f));
  let p;
  t[12] !== a || t[13] !== o || t[14] !== c || t[15] !== l
    ? ((p = (e) => {
        ge({ event: e, href: a, initiator: o, openTarget: c, originHostId: l });
      }),
      (t[12] = a),
      (t[13] = o),
      (t[14] = c),
  ...
  t[17] === m
    ...
    : ((h = (e) => {
      ...
      (t[18] = h));
  let g;
  t[19] !== n || t[20] !== a || t[21] !== m || t[22] !== u || t[23] !== h
    ? ((g = (0, $.jsx)(`a`, {
        ...u,
        href: a,
  ...
  let _ = g,
    v;
  t[25] !== _ || t[26] !== d || t[27] !== f
    ? ((v = d == null ? _ : (0, $.jsx)(re, { delayDuration: f, tooltipContent: d, children: _ })),
      (t[25] = _),
      (t[26] = d),
      (t[27] = f),
      (t[28] = v))
    : (v = t[28]);
  let y = v;
  if (!St({ href: a, isBrowserSidebarEnabled: s })) return y;
  let b = r ?? o,
    x;
  t[29] !== i || t[30] !== a || t[31] !== b
    ? ((x = Ct({ conversationId: i, href: a, initiator: b })),
      (t[29] = i),
      (t[30] = a),
      (t[31] = b),
      (t[32] = x))
  ...
  return (
    t[33] !== y || t[34] !== x
      ? ((S = (0, $.jsx)(N, { items: x, children: y })), (t[33] = y), (t[34] = x), (t[35] = S))
      : (S = t[35]),
    S
  );
}
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~appgen-page~remote-conversation-page~pull-reques~filfqv6y.js.map
