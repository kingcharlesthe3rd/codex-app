...
function s(e) {
  return e.targetLinks.length ? e.depth : e.sourceLinks.length ? t(e.sourceLinks, r) - 1 : 0;
}
function c(e) {
  return function () {
    return e;
...
function v() {
  ...
  ((O.update = function (e) {
    ...
    (O.nodeId = function (e) {
      return arguments.length ? ((x = typeof e == `function` ? e : c(e)), O) : x;
    }),
    (O.nodeAlign = function (e) {
      return arguments.length ? ((S = typeof e == `function` ? e : c(e)), O) : S;
    }),
    ...
    (O.nodes = function (e) {
      return arguments.length ? ((T = typeof e == `function` ? e : c(e)), O) : T;
    }),
    (O.links = function (e) {
      return arguments.length ? ((E = typeof e == `function` ? e : c(e)), O) : E;
    }),
    (O.linkSort = function (e) {
      return arguments.length ? ((w = e), O) : w;
    }),
    (O.size = function (e) {
      return arguments.length ? ((r = i = 0), (a = +e[0]), (s = +e[1]), O) : [a - r, s - i];
    }),
    (O.extent = function (e) {
  ...
  function A({ nodes: e }) {
    for (let t of e)
      t.value =
        t.fixedValue === void 0 ? Math.max(n(t.sourceLinks, f), n(t.targetLinks, f)) : t.fixedValue;
  }
  function j({ nodes: e }) {
    let t = e.length,
      n = new Set(e),
  ...
  function N({ nodes: t }) {
    ...
    for (let e of t) {
      ...
      ((e.layer = t), (e.x0 = r + t * i), (e.x1 = e.x0 + v), o[t] ? o[t].push(e) : (o[t] = [e]));
    }
  ...
  function R(e, t) {
    let n = e.length >> 1,
      r = e[n];
    (B(e, r.y0 - b, n - 1, t), z(e, r.y1 + b, n + 1, t), B(e, s, e.length - 1, t), z(e, i, 0, t));
  }
  function z(e, t, n, r) {
    for (; n < e.length; ++n) {
      let i = e[n],
  ...
  function H(e) {
    if (w === void 0) for (let { sourceLinks: t, targetLinks: n } of e) (t.sort(u), n.sort(l));
  }
  function U(e, t) {
...
C.prototype = w.prototype = {
    ...
    if (this._x1 === null) this._ += `M` + (this._x1 = e) + `,` + (this._y1 = t);
      ...
      if (!(Math.abs(u * s - c * l) > x) || !i)
        ...
        var f = n - a,
          ...
          b = v / _,
          S = v / g;
        (Math.abs(b - 1) > x && (this._ += `L` + (e + b * l) + `,` + (t + b * u)),
          (this._ +=
            `A` +
            i +
            `,` +
  ...
  arc: function (e, t, n, r, i, a) {
    ...
    (this._x1 === null
      ? (this._ += `M` + c + `,` + l)
      : (Math.abs(this._x1 - c) > x || Math.abs(this._y1 - l) > x) && (this._ += `L` + c + `,` + l),
      n &&
        (d < 0 && (d = (d % b) + b),
        d > S
          ? (this._ +=
...
//# sourceMappingURL=sankeyLinkHorizontal.js.map
