...
import { Qt as i, _n as a, js as o } from "./app-server-manager-signals.js";
import { m as s } from "./vscode-api.js";
import { At as c, Bt as l } from "./src-1.js";
import { c as u, r as d } from "./lib.js";
...
async function g(e, t, n, r) {
  ...
  let u = !1;
  try {
    (r === void 0 ? await h(t, n) : await h(t, n, r), (u = n), n && (await i(e, t)));
  } catch (e) {
    let n = o.getData();
    if ((l != null && n != null && a(n.threadIds, l.threadIds) && o.setData(s), u))
      try {
        await h(t, !1);
      } catch (e) {
        v(e);
...
function T({ conversationId: e, parentConversationId: t, scope: n, getMarkdown: r, intl: i }) {
  (async () => {
    await o(`ensure-conversation-history-loaded`, {
      conversationId: e,
...
function E() {
  ...
  e[0] !== i || e[1] !== n
    ? ((a = (e) => {
      ...
      (s = (e) => {
        ...
        o(`interrupt-conversation`, { conversationId: t, initiatedBy: `user` }).catch(() => {
  ...
  let p;
  return (
    e[11] !== a || e[12] !== s || e[13] !== c || e[14] !== l || e[15] !== d
      ? ((p = {
          archiveThread: a,
          interruptThread: s,
...
function D(e) {
  ...
  o(`mark-conversation-as-unread`, { conversationId: t, ...(n == null ? {} : { hostId: n }) });
}
