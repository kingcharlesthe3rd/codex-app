...
import { Xs as n, in as r, zt as i } from "./app-server-manager-signals.js";
import { C as a, G as o, S as s, V as c, X as l, Z as u, wt as d } from "./setting-storage.js";
import { r as f } from "./toast-signal.js";
import { t as p } from "./pinned-threads-query.js";
import { n as m } from "./set-pinned-thread.js";
import { t as h } from "./copy-to-clipboard.js";
  ...
  let s = t.query.snapshot(p),
    ...
    l =
      c == null
        ...
        : {
            threadIds: a
              ? e({ threadIds: c.threadIds, threadId: n, beforeThreadId: o ?? null })
              : c.threadIds.filter((e) => e !== n),
          };
  l != null && s.setData(l);
  let u = !1;
  try {
    (o === void 0 ? await m(n, a) : await m(n, a, o), (u = a), a && (await i(t, n)));
  } catch (e) {
    let t = s.getData();
    if ((l != null && t != null && r(t.threadIds, l.threadIds) && s.setData(c), u))
      try {
        await m(n, !1);
      } catch (e) {
        v(e);
...
function v(e) {
  a.error(`Failed to update sidebar thread membership`, { safe: {}, sensitive: { error: t(e) } });
}
var y = d(),
  b = c({
    archiveThreadError: {
...
function x(e, t) {
  ...
  let f = d,
    m;
  n[4] !== a || n[5] !== e || n[6] !== f
    ? ((m = a && e != null && f.includes(e)), (n[4] = a), (n[5] = e), (n[6] = f), (n[7] = m))
    : (m = n[7]);
  let h = m,
    _;
...
function T({ scope: e, getMarkdown: t, intl: n }) {
  (async () => {
    ...
    r == null ||
      r.trim().length === 0 ||
      (await h(r), e.get(f).success(n.formatMessage(b.copyConversationMarkdownSuccess)));
  })().catch(() => {
