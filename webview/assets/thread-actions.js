import { R as e, o as t, s as n, t as r } from "./app-scope.js";
import { m as i } from "./vscode-api.js";
import { Dt as a, Xt as o } from "./src-4.js";
import { As as s, Zt as c, gn as l } from "./app-server-manager-signals.js";
import { c as u, r as d } from "./lib-1.js";
  ...
  let i = e.query.snapshot(m),
    ...
    s =
      o == null
        ...
        : {
            threadIds: n
              ? a({ threadIds: o.threadIds, threadId: t, beforeThreadId: r ?? null })
              : o.threadIds.filter((e) => e !== t),
          };
  s != null && i.setData(s);
  let u = !1;
  try {
    (r === void 0 ? await h(t, n) : await h(t, n, r), (u = n), n && (await c(e, t)));
  } catch (e) {
    let n = i.getData();
    if ((s != null && n != null && l(n.threadIds, s.threadIds) && i.setData(o), u))
      try {
        await h(t, !1);
      } catch (e) {
        v(e);
...
function v(e) {
  i.error(`Failed to update sidebar thread membership`, { safe: {}, sensitive: { error: o(e) } });
}
var y = e(),
  b = d({
    archiveThreadError: {
...
function T({ conversationId: e, parentConversationId: t, scope: n, getMarkdown: r, intl: i }) {
  (async () => {
    await s(`ensure-conversation-history-loaded`, {
      conversationId: e,
    ...
    a == null ||
      a.trim().length === 0 ||
      (await p(a), n.get(f).success(i.formatMessage(b.copyConversationMarkdownSuccess)));
  })().catch(() => {
    n.get(f).danger(i.formatMessage(b.copyConversationMarkdownError));
  });
}
function E() {
  let e = (0, y.c)(17),
    ...
    ? ((a = (e) => {
        ...
        (o?.(),
          s(`archive-conversation`, {
            ...
            .catch(() => {
              (l?.(), n.get(f).danger(i.formatMessage(b.archiveThreadError)));
            }));
      }),
      (o = (e) => {
        let { conversationId: t } = e;
        s(`interrupt-conversation`, { conversationId: t }).catch(() => {
          n.get(f).danger(i.formatMessage(b.interruptThreadError));
        });
      }),
      (e[0] = i),
      (e[1] = n),
  ...
  e[4] !== i || e[5] !== n
    ? ((c = (e) => {
        let { conversationId: t, hostId: r, title: a } = e;
        s(`set-thread-title`, {
          conversationId: t,
          ...(r == null ? {} : { hostId: r }),
          title: a,
        }).catch(() => {
          n.get(f).danger(i.formatMessage(b.renameThreadError));
        });
      }),
      (l = (e) => {
        S({ scope: n, cwd: e, intl: i });
      }),
      (e[4] = i),
      (e[5] = n),
      (e[6] = c),
  ...
  let p;
  return (
    e[11] !== a || e[12] !== o || e[13] !== c || e[14] !== l || e[15] !== d
      ? ((p = {
          archiveThread: a,
          interruptThread: o,
...
function D(e) {
  ...
  s(`mark-conversation-as-unread`, { conversationId: t, ...(n == null ? {} : { hostId: n }) });
}
