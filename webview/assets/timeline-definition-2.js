...
import { z as t } from "./app-initial~app-main~onboarding-page~mermaid-diagram~xychartDiagram-PRI3JC2R~timeline-defin~dcen2xty.js";
import { a as n, o as r, s as i, t as a } from "./dist-1.js";
import { n as o, t as s } from "./src-1.js";
import { i as c, n as l, r as u, t as d } from "./chunk-49.js";
import { A as f, a as p, b as m, o as h, q as g, y as _ } from "./chunk-87.js";
import { n as v, t as y } from "./chunk-10.js";
import { p as b, u as x } from "./chunk-33.js";
function S(e, t) {
  e.each(function () {
    var e = o(this),
      n = e
      ...
      var e = l(function (e, t, n, r) {
        ...
        u = {
          ...
          table: [
            ...
            e(t, [2, 10], { 1: [2, 1] }),
            e(t, [2, 6]),
            { 12: 21, 14: n, 15: r, 17: i, 19: a, 20: o, 21: 17, 22: 18, 23: s, 24: c },
            e(t, [2, 8]),
            e(t, [2, 9]),
            e(t, [2, 11]),
            { 16: [1, 22] },
              ...
              switch (T[0]) {
                ...
                case 2:
                  if (
                    ...
                    (E = this.performAction.apply(D, [s, u, c, g.yy, T[1], i, a].concat(m))),
                    E !== void 0)
                  )
                    return E;
                  (k &&
...
` +
    ...
    (M = l(() => h, `getCommonDb`)),
    (N = l(function () {
      ((k.length = 0), (A.length = 0), (E = ``), (j.length = 0), (O = `LR`), p());
    }, `clear`)),
    (P = l(function (e) {
      O = e;
    }, `setDirection`)),
    ...
    (z = l(function (e, t, n) {
      let r = { id: D++, section: E, type: E, task: e, score: t || 0, events: n ? [n] : [] };
      j.push(r);
    }, `addTask`)),
    (B = l(function (e) {
    ...
    (te = l(function (e, n) {
      ...
      return (l(s, `ambivalent`), n.score > 3 ? a(i) : n.score < 3 ? o(i) : s(i), r);
    }, `drawFace`)),
    (ne = l(function (e, t) {
    ...
    (ae = l(function (e, t, n, r) {
      ...
      ((o.x = t.x),
        ...
        (o.ry = 3),
        W(a, o),
        J(n)(t.task, a, o.x, o.y, o.width, o.height, { class: `task` }, n, t.colour));
    }, `drawTask`)),
    (oe = l(function (e, t) {
      W(e, {
        x: t.startx,
    ...
    (le = l(function (e, t, n, r, i, a = !1) {
      let { theme: s, look: c } = r,
        ...
        d = e.append(`g`);
      ((t.section = u),
        d.attr(`class`, (t.class ? t.class + ` ` : ``) + `timeline-node ` + (`section-` + u)));
      let f = d.append(`g`),
        p = d.append(`g`),
        m = p
          .append(`text`)
      ...
      if (
        ...
        (t.width += 2 * t.padding),
        p.attr(`transform`, `translate(` + t.width / 2 + `, ` + t.padding / 2 + `)`),
        l && p.attr(`transform`, `translate(${t.width / 2}, ${a ? t.padding / 2 + 3 : t.padding})`),
        de(f, t, u, i, r),
    ...
    (fe = l(function (e, t, n, r) {
      ...
      let h = i.securityLevel,
        _;
      h === `sandbox` && (_ = o(`#i` + t));
      let v = o(h === `sandbox` ? _.nodes()[0].contentDocument.body : `body`).select(`#` + t);
      v.append(`g`);
      let y = r.db.getTasks(),
      ...
      x.forEach(function (e) {
        let t = { number: O, descr: e, section: O, width: 150, padding: 20, maxHeight: S },
      ...
      for (let [e, t] of y.entries()) {
        let n = { number: e, descr: t, section: t.section, width: 150, padding: 20, maxHeight: C },
      ...
      if (
        ...
        let e = v.select(`defs`),
          t = (e.empty() ? v.append(`defs`) : e)
            ...
            .attr(`x2`, `100%`)
            .attr(`y2`, `0%`);
        (t.append(`stop`).attr(`offset`, `0%`).attr(`stop-color`, d).attr(`stop-opacity`, 1),
          t.append(`stop`).attr(`offset`, `100%`).attr(`stop-color`, f).attr(`stop-opacity`, 1));
      }
      g(void 0, v, i.timeline?.padding ?? 50, i.timeline?.useMaxWidth ?? !1);
    }, `draw`)),
    (pe = l(function (e, t, n, r, i, a, o, s, l, u, d, f) {
      for (let s of t) {
        let t = { descr: s.task, section: n, number: n, width: 150, padding: 20, maxHeight: a };
        c.debug(`taskNode`, t);
    ...
    (me = l(function (e, t, n, r, i, a, o) {
      ...
      i += 100;
      for (let l of t) {
        let t = { descr: l, section: n, number: n, width: 150, padding: 20, maxHeight: 50 };
        c.debug(`eventNode`, t);
    ...
    (Ce = l(function (e, t, n, r) {
      ...
      u.forEach(function (e) {
        let t = { number: w, descr: e, section: w, width: D, padding: Z, maxHeight: d },
      ...
      for (let [e, t] of s.entries()) {
        let n = { number: e, descr: t, section: t.section, width: X, padding: Z, maxHeight: f },
        ...
        (t.events.length > 0 && (a += (t.events.length - 1) * $), (O = Math.max(O, a) + ve));
      }
      (c.debug(`maxSectionHeight before draw`, d), c.debug(`maxTaskHeight before draw`, f));
      let k = Math.max(f, O) + xe;
      T
        ? u.forEach((e) => {
            let t = s.filter((t) => t.section === e),
              n = { number: w, descr: e, section: w, width: D, padding: Z, maxHeight: d };
    ...
    (we = l(function (e, t, n, r, i, a, o, s, l) {
      for (let u of t) {
        let t = { descr: u.task, section: n, number: n, width: X, padding: Z, maxHeight: a };
        c.debug(`taskNode`, t);
    ...
    (Te = l(function (e, t, n, r, i, a, o) {
      let s = a;
      for (let a of t) {
        let t = { descr: a, section: n, number: n, width: Q, padding: Z, maxHeight: 0 };
        c.debug(`eventNode`, t);
    ...
    (ke = {
      ...
      renderer: {
        ...
        draw: l(
          (e, t, n, r) =>
            (r?.db?.getDirection?.() ?? `LR`) === `TD` ? Ee.draw(e, t, n, r) : he.draw(e, t, n, r),
          `draw`,
        ),
      },
      parser: w,
...
//# sourceMappingURL=timeline-definition-2.js.map
