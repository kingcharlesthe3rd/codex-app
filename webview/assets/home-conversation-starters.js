...
import { js as o } from "./app-server-manager-signals.js";
import { k as s } from "./vscode-api.js";
import { n as c } from "./react.js";
import "./isEqual.js";
import { fr as l } from "./src-1.js";
import { t as u } from "./react-dom.js";
import { c as d } from "./lib.js";
import { Gt as f, Kt as p, o as m } from "./persisted-signal.js";
...
function B(e) {
  ...
  let k;
  if (
    (t[4] !== u.accountId || t[5] !== u.userId || t[6] !== v || t[7] !== S || t[8] !== s
      ? ((k = [u.accountId, u.userId, v, S, s]),
        (t[4] = u.accountId),
        (t[5] = u.userId),
        (t[6] = v),
        (t[7] = S),
    ...
    ? ((Y = P.map((e, t) =>
        (0, I.jsx)(
          E,
          {
            ...
            onSelect: (n, r, i) => {
              (m(s, f, { promptId: e.id, promptIndex: t, promptType: R, mode: r }),
                x(n, r, e.skillName, i));
            },
