...
import { gp as I, hp as L } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
...
function fe(e) {
    ...
    ? ((k = G.map((e, t) =>
        (0, X.jsx)(
          R,
          {
            ...
            onSelect: (n, r, i) => {
              (N(s, ie, { promptId: e.id, promptIndex: t, promptType: Q, mode: r }),
                m(n, r, e.skillName, i));
            },
  ...
  t[26] !== O || t[27] !== A || t[28] !== b || t[29] !== x || t[30] !== S
    ? ((j = (0, X.jsxs)(`div`, { className: b, inert: x, "aria-hidden": S, children: [O, A] })),
      (t[26] = O),
      (t[27] = A),
      (t[28] = b),
      (t[29] = x),
  ...
  return (
    t[32] !== M || t[33] !== a
      ? ((P = a ? (0, Y.createPortal)(M, a) : M), (t[32] = M), (t[33] = a), (t[34] = P))
      : (P = t[34]),
    P
  );
}
    ...
    r[9] !== a
      ? ((f = (r, o, c, u) => {
          ...
          (e.setText(r),
            e.focus(),
            (async () => {
              let i = C(await F(`list-skills-for-host`, { hostId: n, cwds: [t] }), p);
              if (i) {
                if (e.getText() !== r) return;
                (e.setPromptText(r.replace(m, j({ name: i.name, path: i.path }))), e.focus());
                return;
              }
              let a = await l(p);
              if (!a) return;
              ...
              !o.success ||
                !o.destination ||
                ((async () => {
                  (await F(`list-skills-for-host`, { hostId: n, cwds: [t], forceReload: !0 }),
                ...
                e.getText() === r &&
                  (e.setPromptText(
                    r.replace(
                      m,
                      j({ name: a.name, path: q.default.join(o.destination, `SKILL.md`) }),
                    ),
                  ),
                  e.focus()));
            })());
