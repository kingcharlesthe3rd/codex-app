...
import { Tb as f, wb as p } from "./app-initial~app-main~onboarding-page.js";
import {
  Df as m,
  Im as h,
  Jv as g,
...
import { n as R, r as z, t as B } from "./conversation-starter-card-B.js";
...
function fe(e) {
  ...
  let v;
  if (
    (t[4] !== l.accountId || t[5] !== l.userId || t[6] !== d || t[7] !== m || t[8] !== a
    ...
    ? ((k = G.map((e, t) =>
        (0, X.jsx)(
          R,
          {
            ...
            onSelect: (n, r, i) => {
              (y(a, h, { promptId: e.id, promptIndex: t, promptType: Q, mode: r }),
                p(n, r, e.skillName, i));
            },
  ...
  return (
    t[32] !== M || t[33] !== i
      ? ((N = i ? (0, Y.createPortal)(M, i) : M), (t[32] = M), (t[33] = i), (t[34] = N))
      : (N = t[34]),
    N
  );
}
    ...
    r[9] !== a
      ? ((p = (r, o, c, d) => {
          ...
          (e.setText(r),
            e.focus(),
            (async () => {
              let i = k(await g(`list-skills-for-host`, { hostId: n, cwds: [t] }), p);
              if (i) {
                if (e.getText() !== r) return;
                (e.setPromptText(r.replace(m, P({ name: i.name, path: i.path }))), e.focus());
                return;
              }
              let a = await l(p);
              if (!a) return;
              ...
              !o.success ||
                !o.destination ||
                ((async () => {
                  (await g(`list-skills-for-host`, { hostId: n, cwds: [t], forceReload: !0 }),
                ...
                e.getText() === r &&
                  (e.setPromptText(
                    r.replace(
                      m,
                      P({ name: a.name, path: q.default.join(o.destination, `SKILL.md`) }),
                    ),
                  ),
                  e.focus()));
            })());
