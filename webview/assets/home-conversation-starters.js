...
import { $s as n, Ps as r, Xs as i } from "./app-server-manager-signals.js";
...
import { s as g } from "./prompt-text.js";
import "./use-environment.js";
import { C as _ } from "./composer-view-state.js";
...
function z(e) {
  ...
  t[14] !== W || t[15] !== G
    ...
    : (q = t[16]);
  let J;
  t[17] !== u.accountId || t[18] !== u.userId || t[19] !== v || t[20] !== c || t[21] !== o
    ? ((J = N.map((e, t) =>
        (0, F.jsx)(
          C,
          {
  ...
  return (
    t[31] !== Z || t[32] !== a
      ? ((Q = a ? (0, A.createPortal)(Z, a) : Z), (t[31] = Z), (t[32] = a), (t[33] = Q))
      : (Q = t[33]),
    Q
  );
}
    ...
    r[9] !== o
      ? ((p = (r, c, u, f) => {
          ...
          (e.setText(r),
            e.focus(),
            (async () => {
              let a = y(await i(`list-skills-for-host`, { hostId: n, cwds: [t] }), m);
              if (a) {
                if (e.getText() !== r) return;
                (e.setPromptText(r.replace(h, v({ name: a.name, path: a.path }))), e.focus());
                return;
              }
              let o = await l(m);
              if (!o) return;
              ...
              !c.success ||
                !c.destination ||
                ((async () => {
                  (await i(`list-skills-for-host`, { hostId: n, cwds: [t], forceReload: !0 }),
                ...
                e.getText() === r &&
                  (e.setPromptText(
                    r.replace(
                      h,
                      v({ name: o.name, path: M.default.join(c.destination, `SKILL.md`) }),
                    ),
                  ),
                  e.focus()));
            })());
