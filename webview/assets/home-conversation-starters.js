...
import { Wn as y } from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~project~okyna5mq.js";
import {
  $h as b,
  Gd as x,
  b as S,
...
import { n as U, r as ae, t as oe } from "./conversation-starter-card.js";
import { r as se, t as ce } from "./home-use-cases-data.js";
import { n as le, t as ue } from "./use-recommended-skills.js";
function W(e) {
  let t = ce.find((t) => t.id === e);
  if (!t) throw Error(`Missing home use case: ${e}`);
  return t;
}
var G,
  de = e(() => {
    (se(), (G = [W(`snake-game`), W(`one-page-pdf`), W(`create-plan`)]));
  });
function fe(e) {
  let t = (0, K.c)(35),
    { activeWorkspaceRoot: n, hostId: i, portalTarget: a } = e,
    o = d(r),
    s = re(),
    c = ie(),
    l = h(),
  ...
  let b;
  if (
    (t[4] !== c.accountId || t[5] !== c.userId || t[6] !== f || t[7] !== _ || t[8] !== o
      ? ((b = [c.accountId, c.userId, f, _, o]),
        (t[4] = c.accountId),
        (t[5] = c.userId),
        (t[6] = f),
        (t[7] = _),
    ...
    return null;
  let x = _ ? `opacity-100` : `pointer-events-none opacity-0`,
    S;
  t[10] === x
    ? (S = t[11])
    : ((S = te(
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, X.jsx)(B, { className: `icon-xs` })), (t[16] = O))
    : (O = t[16]);
  let k;
  t[17] !== E || t[18] !== D
    ? ((k = (0, X.jsx)(`div`, {
    ...
    : (k = t[19]);
  let A;
  t[20] !== g || t[21] !== s || t[22] !== o
    ? ((A = G.map((e, t) =>
        (0, X.jsx)(
          U,
          {
            icon: (0, X.jsx)(oe, { name: e.iconName }),
            mode: e.mode,
            initialCollaborationMode: e.initialCollaborationMode,
            onSelect: (n, r, i) => {
              (T(o, ne, { promptId: e.id, promptIndex: t, promptType: Q, mode: r }),
                g(n, r, e.skillName, i));
            },
  ...
  t[24] === A
    ...
    : ((j = (0, X.jsx)(`div`, { className: `grid grid-cols-3 gap-2`, children: A })),
      ...
      (t[25] = j));
  let M;
  t[26] !== k || t[27] !== j || t[28] !== S || t[29] !== C || t[30] !== w
    ? ((M = (0, X.jsxs)(`div`, { className: S, inert: C, "aria-hidden": w, children: [k, j] })),
      (t[26] = k),
      (t[27] = j),
      (t[28] = S),
      (t[29] = C),
  ...
  return (
    t[32] !== N || t[33] !== a
      ? ((P = a ? (0, Y.createPortal)(N, a) : N), (t[32] = N), (t[33] = a), (t[34] = P))
      : (P = t[34]),
    P
  );
}
...
function ge(e, t, n) {
  ...
  let { ensureSkillByName: l, installSkill: u } = le(c),
    f;
  return (
    r[2] !== t ||
    r[3] !== e ||
    ...
    r[9] !== a
      ? ((f = (r, s, c, d) => {
          ...
          (e.setText(r),
            e.focus(),
            (async () => {
              let i = j(await w(`list-skills-for-host`, { hostId: n, cwds: [t] }), p);
              if (i) {
                if (e.getText() !== r) return;
                (e.setPromptText(r.replace(m, I({ name: i.name, path: i.path }))), e.focus());
                return;
              }
              let a = await l(p);
              if (!a) return;
              ...
              !s.success ||
                !s.destination ||
                ((async () => {
                  (await w(`list-skills-for-host`, { hostId: n, cwds: [t], forceReload: !0 }),
                ...
                e.getText() === r &&
                  (e.setPromptText(
                    r.replace(
                      m,
                      I({ name: a.name, path: q.default.join(s.destination, `SKILL.md`) }),
                    ),
                  ),
                  e.focus()));
            })());
...
e(() => {
  ((K = i()),
    ...
    ($ = O(`has-hidden-home-conversation-starters`, !1)));
})();
