...
import { Hr as t, Nr as n, Wi as r, d as i, na as a, sa as o } from "./src-2.js";
import { Ho as s, sa as c } from "./app-server-manager-signals.js";
import { n as l } from "./jsx-runtime.js";
import {
  F as u,
  R as d,
  V as f,
...
var x = a({ dirs: r(o()).optional(), hostId: o().optional() }),
...
var k = d(p, ({ sourceHostId: e, sourceGitRoot: t, sourceWorkspaceRoot: n }, { get: r }) => {
  ...
  for (let e of r(y)) {
    ...
    o.set(e.hostId, {
      hostId: e.hostId,
      hostDisplayName: s(e.hostId, a).display_name,
      projects: [e],
    });
  }
  let c = [];
  for (let { hostDisplayName: e, hostId: a, projects: s } of o.values()) {
    let o = r(S, {
      params: { hostId: a, dirs: s.map((e) => e.remotePath) },
      source: `local_remote_dropdown`,
    });
    if (o?.isPending) {
      c.push({ status: `loading`, hostDisplayName: e, hostId: a });
      continue;
    }
    if (o?.isError) {
      c.push({ status: `error`, hostDisplayName: e, hostId: a });
      continue;
    }
    let l = s.find((e) => {
    ...
    l != null && c.push({ status: `ready`, hostDisplayName: e, project: l });
  }
  return c;
});
function A(e, t) {
...
function M(e, n) {
  c(e, t.ACTIVE_REMOTE_PROJECT_ID, n ?? void 0);
}
function N(e, n) {
  return c(e, t.REMOTE_PROJECTS, n);
}
function P() {
  let e = (0, w.c)(21),
    n = u(p),
    { data: r, isLoading: i } = b(t.REMOTE_PROJECTS),
    { data: a } = b(t.ACTIVE_REMOTE_PROJECT_ID),
    o;
  e[0] === r ? (o = e[1]) : ((o = r ?? []), (e[0] = r), (e[1] = o));
  let s = o,
    l;
  e[2] !== s || e[3] !== a
    ? ((l = s.find((e) => e.id === a) ?? null), (e[2] = s), (e[3] = a), (e[4] = l))
    : (l = e[4]);
  let d = l,
    f,
    m;
  (e[5] !== i || e[6] !== n || e[7] !== d || e[8] !== a
    ? ((f = () => {
        i || a == null || d != null || c(n, t.ACTIVE_REMOTE_PROJECT_ID, void 0);
      }),
      (m = [i, n, d, a]),
      (e[5] = i),
      (e[6] = n),
  ...
  let h = a ?? null,
    g;
  e[11] === n ? (g = e[12]) : ((g = (e) => M(n, e)), (e[11] = n), (e[12] = g));
  let _;
  e[13] === n ? (_ = e[14]) : ((_ = (e) => N(n, e)), (e[13] = n), (e[14] = _));
  let v;
  return (
    e[15] !== s || e[16] !== d || e[17] !== h || e[18] !== g || e[19] !== _
      ? ((v = {
