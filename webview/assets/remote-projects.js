...
import { t as s } from "./use-host-config-C.js";
import { c, s as l, ta as u } from "./thread-context-inputs.js";
import { n as d, r as f, u as p } from "./vscode-api.js";
import { Aa as m, Br as h, Lt as g, Ta as _, d as v, jr as y, pa as b } from "./src-1.js";
...
var A = r(o, ({ sourceHostId: e, sourceGitRoot: t, sourceWorkspaceRoot: n }, { get: r }) => {
  ...
  for (let { hostDisplayName: e, hostId: i, projects: s } of o.values()) {
    ...
    if (a?.isPending || o?.isPending) {
      u.push({ status: `loading`, hostDisplayName: e, hostId: i });
      continue;
    }
    if (a?.isError || o?.isError) {
      u.push({ status: `error`, hostDisplayName: e, hostId: i });
      continue;
    }
    let c = k({
      ...
      l = s.find(({ remotePath: e }) => e === c);
    l != null && u.push({ status: `ready`, hostDisplayName: e, project: l });
  }
  return u;
});
function j(e, t) {
...
function F(e, t) {
  u(e, h.ACTIVE_REMOTE_PROJECT_ID, t ?? void 0);
}
function I(e, t) {
  return u(e, h.REMOTE_PROJECTS, t);
}
function L() {
  let e = (0, T.c)(21),
    t = i(o),
  ...
  let c = s,
    l;
  e[2] !== c || e[3] !== a
    ? ((l = c.find((e) => e.id === a) ?? null), (e[2] = c), (e[3] = a), (e[4] = l))
    : (l = e[4]);
  let d = l,
    f,
    p;
  (e[5] !== r || e[6] !== t || e[7] !== d || e[8] !== a
    ? ((f = () => {
        r || a == null || d != null || u(t, h.ACTIVE_REMOTE_PROJECT_ID, void 0);
      }),
      (p = [r, t, d, a]),
      (e[5] = r),
      (e[6] = t),
  ...
  let v;
  return (
    e[15] !== c || e[16] !== d || e[17] !== m || e[18] !== g || e[19] !== _
      ? ((v = {
