...
import { l as n, o as r, p as i, t as a, z as o } from "./app-scope.js";
import { Ia as s, ls as c } from "./app-server-manager-signals.js";
import { n as l, r as u, u as d } from "./vscode-api.js";
import { Ft as f, Qi as p, d as m, ha as h, hr as g, ua as _, wr as v } from "./src-2.js";
import { o as y, s as b } from "./thread-context-inputs.js";
import { t as x } from "./use-global-state.js";
var S = _({ dirs: p(h()).optional(), hostId: h().optional() }),
  C = i(a, ({ params: e, source: t }, { queryClient: n }) => ({
...
var A = n(a, ({ sourceHostId: e, sourceGitRoot: t, sourceWorkspaceRoot: n }, { get: r }) => {
...
function M(e, t) {
  ...
  let n = m(e);
  return t?.find((e) => m(e.dir) === n) ?? null;
}
function N(e) {
  let t = e == null ? null : f(e);
  return t == null ? null : `${t.host}/${t.owner}/${t.repo}`.toLowerCase();
}
function P(e) {
  let t = g(e.trim()).replace(/\/+/g, `/`);
  return t === `/` ? t : t.replace(/\/+$/, ``);
}
function F(e, t) {
  s(e, v.ACTIVE_REMOTE_PROJECT_ID, t ?? void 0);
}
function I(e, t) {
  return s(e, v.REMOTE_PROJECTS, t);
}
function L() {
  let e = (0, T.c)(21),
    t = r(a),
    { data: n, isLoading: i } = x(v.REMOTE_PROJECTS),
    { data: o } = x(v.ACTIVE_REMOTE_PROJECT_ID),
    c;
  e[0] === n ? (c = e[1]) : ((c = n ?? []), (e[0] = n), (e[1] = c));
  let l = c,
    u;
  e[2] !== l || e[3] !== o
    ? ((u = l.find((e) => e.id === o) ?? null), (e[2] = l), (e[3] = o), (e[4] = u))
    : (u = e[4]);
  let d = u,
    f,
    p;
  (e[5] !== i || e[6] !== t || e[7] !== d || e[8] !== o
    ? ((f = () => {
        i || o == null || d != null || s(t, v.ACTIVE_REMOTE_PROJECT_ID, void 0);
      }),
      (p = [i, t, d, o]),
      (e[5] = i),
      (e[6] = t),
  ...
  let m = o ?? null,
    h;
  e[11] === t ? (h = e[12]) : ((h = (e) => F(t, e)), (e[11] = t), (e[12] = h));
  let g;
  e[13] === t ? (g = e[14]) : ((g = (e) => I(t, e)), (e[13] = t), (e[14] = g));
  let _;
  return (
    e[15] !== l || e[16] !== d || e[17] !== m || e[18] !== h || e[19] !== g
      ? ((_ = {
