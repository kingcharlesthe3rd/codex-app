...
import { d as i, h as a } from "./vscode-api.js";
import { i as o, l as s, s as c } from "./lib-1.js";
...
import { t as p } from "./tooltip-B.js";
import { t as m } from "./arrow-up.js";
import { n as h, r as g, t as _ } from "./speaker.js";
import { n as v, r as y, t as b } from "./use-recording-waveform-Cfd-Ecbb.js";
import { t as x } from "./regenerate.js";
import { t as S } from "./stop.js";
import { t as C } from "./x.js";
import { t as w } from "./badge.js";
import { t as T } from "./plus.js";
import { t as E } from "./composer-footer.js";
import { n as D } from "./rpc.js";
import { i as O, n as k, r as A, t as j } from "./transcribe-audio.js";
import { o as M } from "./statsig.js";
import { t as N } from "./microphone-input.js";
var P = r(),
  F = n();
function I(e) {
  let t = (0, P.c)(9),
    { disabled: n, onOpen: r } = e,
    i = n === void 0 ? !1 : n,
    a = s(),
    o;
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, F.jsx)(T, { className: `icon-sm` })), (t[4] = f))
    : (f = t[4]);
  let m;
  return (
    t[5] !== i || t[6] !== r || t[7] !== d
...
function B(e) {
  let t = (0, P.c)(29),
    ...
    d = s !== void 0 && s ? `mb-0` : `mb-2`,
    f;
  t[0] === d ? (f = t[1]) : ((f = l(`flex items-center gap-2 px-2`, d)), (t[0] = d), (t[1] = f));
  let m;
  t[2] === o
    ? (m = t[3])
    : ((m = o === void 0 ? (0, F.jsx)(I, { disabled: !0, onOpen: V }) : o), (t[2] = o), (t[3] = m));
  let h;
  t[4] === r
    ? (h = t[5])
    : ((h = (0, F.jsx)(`div`, {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, F.jsx)(S, { className: `icon-2xs` })), (t[10] = y))
    : (y = t[10]);
  let b;
  t[11] !== i.ariaLabel || t[12] !== i.disabled || t[13] !== i.onClick
    ...
    : (b = t[14]);
  let x;
  t[15] !== i.tooltipContent || t[16] !== b || t[17] !== c
    ? ((x = (0, F.jsx)(p, {
  ...
  let w;
  return (
    t[22] !== x || t[23] !== C || t[24] !== f || t[25] !== m || t[26] !== h || t[27] !== _
      ? ((w = (0, F.jsxs)(E, { className: f, children: [m, h, _, x, C] })),
        (t[22] = x),
        (t[23] = C),
        (t[24] = f),
        (t[25] = m),
...
function H(e) {
  let t = (0, P.c)(27),
    ...
    p;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, F.jsx)(c, { ...K.stopTooltip })), (t[0] = p))
    : (p = t[0]);
  let h;
  t[1] === f ? (h = t[2]) : ((h = f.formatMessage(K.stopAria)), (t[1] = f), (t[2] = h));
  let g;
  t[3] === a ? (g = t[4]) : ((g = () => a(`insert`)), (t[3] = a), (t[4] = g));
  let _;
  t[5] !== n || t[6] !== h || t[7] !== g
    ? ((_ = { tooltipContent: p, ariaLabel: h, onClick: g, disabled: n }),
      (t[5] = n),
      (t[6] = h),
      (t[7] = g),
      (t[8] = _))
  ...
  t[10] === f
    ...
    : ((y = f.formatMessage({
      ...
      (t[11] = y));
  let b;
  t[12] === a ? (b = t[13]) : ((b = () => a(`send`)), (t[12] = a), (t[13] = b));
  let x;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, F.jsx)(m, { className: `icon-sm text-token-dropdown-background` })), (t[14] = x))
    : (x = t[14]);
  let S;
  t[15] !== n || t[16] !== y || t[17] !== b
    ? ((S = { tooltipContent: v, ariaLabel: y, onClick: b, disabled: n, icon: x }),
      (t[15] = n),
      (t[16] = y),
      (t[17] = b),
      (t[18] = S))
...
function U(e) {
  ...
  bb0: switch (i) {
    case `starting`: {
      ...
      let i;
      (t[4] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((i = (0, F.jsx)(C, { className: `icon-2xs` })), (t[4] = i))
        : (i = t[4]),
        (k = i),
        (A = `bg-token-foreground text-token-dropdown-background enabled:hover:bg-token-foreground/80`));
      break bb0;
    }
    case `active`: {
      let e;
      ...
      (t[9] === m
        ...
        : ((i = (0, F.jsx)(`canvas`, {
          ...
          (t[10] = i)),
        (k = i),
        (A = `bg-token-charts-blue text-white enabled:hover:bg-token-charts-blue/90 enabled:active:bg-token-charts-blue/80`));
      break bb0;
    }
    case `stopping`: {
      let e;
      ...
      (t[15] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((i = (0, F.jsx)(d, { className: `icon-2xs` })), (t[15] = i))
        : (i = t[15]),
        (k = i),
        (A = `bg-token-foreground text-token-dropdown-background`));
    }
  }
  let j = S ? `mb-0` : `mb-2`,
    M;
  t[16] === j
    ? (M = t[17])
    : ((M = l(`flex items-center gap-2 px-2`, j)), (t[16] = j), (t[17] = M));
  let N, L;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, F.jsx)(I, { disabled: !0, onOpen: W })),
      (L = (0, F.jsx)(`div`, { className: `min-w-0 flex-1` })),
      (t[18] = N),
      (t[19] = L))
    : ((N = t[18]), (L = t[19]));
  let R;
          ...
          children: [
            (0, F.jsx)(p, {
              ...
              children: (0, F.jsx)(u, {
                ...
                onClick: o,
                children: n
                  ? (0, F.jsx)(g, { className: `icon-2xs` })
                  : (0, F.jsx)(y, { className: `icon-2xs` }),
              }),
            }),
            (0, F.jsx)(p, {
              tooltipContent: r
              ...
              children: (0, F.jsx)(u, {
                ...
                onClick: f,
                children: r
                  ? (0, F.jsx)(h, { className: `icon-2xs` })
                  : (0, F.jsx)(_, { className: `icon-2xs` }),
              }),
            }),
            (0, F.jsx)(p, {
              tooltipContent: O,
  ...
  t[35] === R
    ? (z = t[36])
    : ((z = (0, F.jsx)(`div`, { className: `flex shrink-0 items-center gap-2`, children: R })),
      (t[35] = R),
      (t[36] = z));
  let B;
  return (
    t[37] !== M || t[38] !== z
      ? ((B = (0, F.jsxs)(E, { className: M, children: [N, L, z] })),
        (t[37] = M),
        (t[38] = z),
        (t[39] = B))
      : (B = t[39]),
...
function G({
  className: e,
  color: t = `ghost`,
  idleIcon: n = (0, F.jsx)(y, { className: `icon-xs` }),
  isDictating: r = !1,
  isVisible: i,
  isTranscribing: a,
  canRetryDictation: o,
  ...
  let O = o && !a,
    k = `idle`;
  r ? (k = `dictating`) : O && (k = `retry`);
  let A, j, M;
  switch (k) {
    case `dictating`:
      ((A = b.formatMessage(K.stopAria)),
        (j = (0, F.jsx)(S, { className: `icon-xs` })),
        (M = (0, F.jsx)(c, { ...K.stopTooltip })));
      break;
    case `retry`:
      ((A = b.formatMessage({
  ...
  let N = () => {
    ...
    P = () => {
      if ((N(), !(!w.current || _ == null))) {
        if (((w.current = !1), (D.current = !0), T.current)) {
          E.current = !0;
          return;
        }
        _(`insert`);
  ...
  return (0, F.jsx)(p, {
    tooltipContent: (0, F.jsx)(`span`, { className: `text-token-foreground`, children: M }),
    shortcut: k === `idle` ? m : null,
    sideOffset: 4,
    portalContainer: v,
    children: (0, F.jsx)(u, {
      className: e,
        ...
        l ||
          ...
          (C.current = window.setTimeout(() => {
            ((C.current = null),
              ...
              (E.current = !1),
              g().finally(() => {
                ((T.current = !1), E.current && ((E.current = !1), _(`insert`)));
              }));
          }, z)));
      },
      onPointerUp: (e) => {
      ...
      children: a ? (0, F.jsx)(d, { className: `icon-xs` }) : j,
    }),
  });
}
var K = o({
...
function Y({
  ...
  let [d, p] = (0, R.useState)(!1),
    ...
    }),
    {
      ...
      waveformCanvasRef: L,
      startWaveformCapture: z,
      stopWaveformCapture: B,
      resetWaveformDisplay: V,
    } = b();
  ((F.current = {
    onTranscriptInsert: o,
    onTranscriptSend: s,
    ...
    (M.current = t));
  let H = () => {
      (S.current?.close(), (S.current = null), x.current?.close(), (x.current = null));
    },
    U = async (e) => {
      (S.current?.close(), (S.current = null));
      let t = x.current;
      if (((x.current = null), t == null)) return j(e);
      try {
        let e = await t.finish();
        if (e.trim().length > 0) return e;
      } catch (e) {
        a.warning(`[Composer] streaming dictation failed`, { safe: {}, sensitive: { error: e } });
      }
      return j(e);
    },
    W = async ({ action: t, audio: n, handlers: r }) => {
      O.current && h(!0);
      try {
        let a = await k({
          transcript: await U(n),
          surroundingText: r.getSurroundingText?.() ?? null,
          cleanupEnabled: e,
        });
        ((E.current = null), O.current && _(!1));
        let o = a.trim();
        o.length > 0 &&
          (i.getInstance().dispatchMessage(`global-dictation-record-history-item`, { text: o }),
          t === `send` ? r.onTranscriptSend(o) : r.onTranscriptInsert(o));
      } catch (e) {
        (a.error(`[Composer] dictation failed`, { safe: {}, sensitive: { error: e } }),
          O.current && ((E.current = { action: t, audio: n, handlers: r }), _(!0)),
    ...
    G = async () => {
      let e = w.current ?? `insert`,
        t = F.current;
      w.current = null;
      let n = Math.max(I, P.current == null ? 0 : performance.now() - P.current);
      P.current = null;
      let r = v.current,
        i = C.current;
      ((C.current = []),
      ...
      await W({ action: e, audio: new Blob(i, { type: o }), handlers: t });
    },
    K = f(async () => {
      if (d || m) return;
      let e = E.current;
    ...
    J = f((e) => {
      if (w.current != null) {
        w.current = e === `send` ? `send` : w.current;
        return;
      }
      if (((w.current = e), T.current)) return;
      let t = v.current;
      if (!t) {
        G();
        return;
  ...
  return (
    (0, R.useEffect)(
      () => (
        ...
        () => {
          O.current = !1;
          let e = v.current;
          e == null || e.state === `inactive` || (w.current ?? ((w.current = `insert`), e.stop()));
        }
      ),
      [],
    ),
    {
      ...
      startDictation: f(async () => {
        if (!(d || m || T.current)) {
          if (!M.current) {
            F.current.onUnsupported();
            return;
          }
          ((T.current = !0), (w.current = null));
          try {
            ((E.current = null),
              _(!1),
              B(),
              await D.systemPermissions?.requestMicrophoneAccess().catch(() => {}));
            let e = await N({ channelCount: 1 });
            ...
            ((P.current = performance.now()), (y.current = e), z(e));
            ...
            if (u) {
              ...
              ((S.current = t),
                t.start(e).then(
                  () => {
                    if (S.current === t) {
                      if (((S.current = null), !O.current || !M.current || y.current !== e)) {
                        t.close();
                        return;
                      }
                      x.current = t;
                  ...
                  (e) => {
                    S.current === t &&
                      ((S.current = null),
                      t.close(),
                      a.warning(`[Composer] unable to start streaming dictation`, {
                        safe: {},
                        sensitive: { error: e },
                      }));
                  },
            ...
            (a.error(`[Composer] unable to start dictation`, { safe: {}, sensitive: { error: e } }),
              O.current && F.current.onStartError(e));
            let t = v.current;
...
export { U as a, H as i, Y as n, I as o, G as r, J as t };
