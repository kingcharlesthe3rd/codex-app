...
import { i as r, l as i, n as a } from "./chunk-31.js";
import { L as o, R as s, b as c, h as l, j as u, k as d, w as f, y as p } from "./chunk-85.js";
import { n as m, r as h } from "./chunk-129.js";
import { n as g, t as _ } from "./chunk-144.js";
import { a as v, i as y, r as b, t as x } from "./chunk-132.js";
import { t as S } from "./rough.esm-1.js";
var C = t(async (e, t, a) => {
    let s,
    ...
    return (
      u
        ? f.attr(`transform`, `translate(` + -y.width / 2 + `, ` + -y.height / 2 + `)`)
...
var j = t((e, t) => {
  ...
  P = t(async (t, r) => {
    ...
    let i = c(),
      ...
      { labelStyles: u, nodeStyles: d, borderStyles: p, backgroundStyles: h } = y(r),
      _ = t
        .insert(`g`)
    ...
    C =
      r.labelType === `markdown`
        ? await m(x, r.label, { style: r.labelStyle, useHtmlLabels: b, isNode: !0, width: r.width })
    ...
    if (r.look === `handDrawn`) {
      let t = S.svg(_),
        n = v(r, { roughness: 0.7, fill: s, stroke: l, fillWeight: 3, seed: o }),
        i = t.path(N(D, O, T, E, 0), n);
      ((k = _.insert(() => (e.debug(`Rough node insert CXC`, i), i), `:first-child`)),
    ...
    if ((x.attr(`transform`, `translate(${r.x - w.width / 2}, ${r.y - r.height / 2 + A})`), u)) {
      let e = x.select(`span`);
      e && e.attr(`style`, u);
    }
  ...
  F = {
      ...
      if (t.look === `handDrawn`) {
        ...
        ((D = p.insert(`rect`, `:first-child`)),
          D.attr(`class`, `outer`)
            ...
            .attr(`height`, x)
            .attr(`data-look`, t.look),
          h.attr(`class`, `inner`).attr(`x`, w).attr(`y`, E).attr(`width`, b).attr(`height`, C));
      return (
        m.attr(`transform`, `translate(${t.x - _.width / 2}, ${T + 1 - (f(r) ? 0 : 3)})`),
    ...
    divider: t((e, t) => {
      let { themeVariables: n, handDrawnSeed: r } = c(),
        { nodeBorder: i } = n,
        a = e.insert(`g`).attr(`class`, t.cssClasses).attr(`id`, t.domId).attr(`data-look`, t.look),
    ...
    kanbanSection: t(async (t, r) => {
      ...
      if (r.look === `handDrawn`) {
        let t = S.svg(_),
          n = v(r, { roughness: 0.7, fill: s, stroke: l, fillWeight: 4, seed: o }),
...
async function ce(e, t) {
  ...
  if (t.look === `handDrawn`) {
    let e = S.svg(s),
      ...
      r = D(p),
      i = e.path(r, n);
    ((m = s.insert(() => i, `:first-child`).attr(`transform`, `translate(${-l / 2}, ${u / 2})`)),
      h && m.attr(`style`, h));
  } else m = q(s, l, u, p);
  return (
    r && m.attr(`style`, r),
...
function fe(t, n) {
  ...
  return (
    ...
    T(n, p),
    (n.intersect = function (t) {
      return (e.info(`crossedCircle intersect`, n, { radius: o, point: t }), W.circle(n, o, t));
    }),
    a
  );
}
...
async function Se(e, t) {
  ...
  if (t.width || t.height) {
    ...
    let n = e / 2 / (2.5 + e / 50);
    ((t.height = (t.height ?? 0) - o - n * 3), t.height < be && (t.height = be));
  }
...
function Te(t, n, { config: { themeVariables: r } }) {
  ...
  return (
    ...
    T(n, f),
    (n.intersect = function (t) {
      return (e.info(`filledCircle intersect`, n, { radius: 7, point: t }), W.circle(n, 7, t));
    }),
    o
  );
}
...
async function Ae(t, n) {
  ...
  return (
    ...
    T(n, b),
    (n.intersect = function (t) {
      return (e.info(`Pill intersect`, n, { radius: d, point: t }), W.polygon(n, h, t));
    }),
    s
  );
}
...
async function Me(e, t) {
  ...
  if (t.look === `handDrawn`) {
    let e = S.svg(c),
      ...
      r = je(0, 0, f, u, d),
      i = e.path(r, n);
    ((m = c.insert(() => i, `:first-child`).attr(`transform`, `translate(${-f / 2}, ${u / 2})`)),
      h && m.attr(`style`, h));
  } else m = q(c, f, u, p);
  return (
    r && m.attr(`style`, r),
...
async function Pe(t, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  if (n.icon) {
    let e = u.append(`g`);
    e.html(`<g>${await h(n.icon, { height: c, width: c, fallbackPrefix: `` })}</g>`);
  ...
  return (
    ...
    P.attr(`transform`, `translate(0,${p ? d.height / 2 + D / 2 : -d.height / 2 - D / 2})`),
    T(n, F),
    (n.intersect = function (t) {
...
async function Fe(t, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  let D = u.append(`g`);
  n.icon && D.html(`<g>${await h(n.icon, { height: c, width: c, fallbackPrefix: `` })}</g>`);
  ...
  return (
    ...
    te.attr(`transform`, `translate(0,${m ? d.height / 2 + p / 2 : -d.height / 2 - p / 2})`),
    T(n, L),
    (n.intersect = function (t) {
...
async function Ie(t, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  let o = n.assetHeight ?? 48,
    ...
    l = i?.wrappingWidth;
  n.width = Math.max(c, l ?? 0);
  let { shapeSvg: u, bbox: d, halfPadding: f, label: p } = await C(t, n, `icon-shape default`),
    m = n.pos === `t`,
    g = c + f * 2,
    _ = c + f * 2,
  ...
  return (
    ...
    ee.attr(`transform`, `translate(0,${m ? d.height / 2 + k / 2 : -d.height / 2 - k / 2})`),
    T(n, te),
    (n.intersect = function (t) {
      if ((e.info(`iconSquare intersect`, n, t), !n.label)) return W.rect(n, t);
      let r = n.x ?? 0,
...
async function Re(t, n, { config: { flowchart: r } }) {
  ...
  let E = x.rectangle(g, _, u, d, w),
    ...
    O = d + p.height + b,
    k = x.rectangle(-D / 2, -O / 2, D, O, { ...w, fill: `none`, stroke: `none` }),
  ...
  return (
    ...
    A.attr(`transform`, `translate(0,${h ? p.height / 2 + b / 2 : -p.height / 2 - b / 2})`),
    T(n, j),
    (n.intersect = function (t) {
      if ((e.info(`iconSquare intersect`, n, t), !n.label)) return W.rect(n, t);
      let r = n.x ?? 0,
...
async function ze(e, t) {
  ...
  if (t.look === `handDrawn`) {
    let e = S.svg(s),
      ...
      r = D(d),
      i = e.path(r, n);
    ((f = s.insert(() => i, `:first-child`).attr(`transform`, `translate(${-l / 2}, ${u / 2})`)),
      p && f.attr(`style`, p));
  } else f = q(s, l, u, d);
  return (
    r && f.attr(`style`, r),
...
async function Be(e, t, n) {
  ...
  if ((n?.rx && n.ry && ((p = n.rx), (m = n.ry)), t.look === `handDrawn`)) {
    let e = S.svg(o),
      n = v(t, {}),
      r = p || m ? e.path(N(u, d, c, l, p || 0), n) : e.rectangle(u, d, c, l, n);
...
async function He(e, t) {
  ...
  if (t.look === `handDrawn`) {
    let e = S.svg(s),
      ...
      r = D(d),
      i = e.path(r, n);
    ((f = s.insert(() => i, `:first-child`).attr(`transform`, `translate(${-u / 2}, ${l / 2})`)),
      p && f.attr(`style`, p));
  } else f = q(s, u, l, d);
  return (
    r && f.attr(`style`, r),
...
async function Xe(e, t) {
  ...
  if (t.width || t.height) {
    ...
    let n = e / 2 / (2.5 + e / 50);
    ((t.height = (t.height ?? 0) - s - n * 3), t.height < Je && (t.height = Je));
  }
  let { shapeSvg: c, bbox: l, label: u } = await C(e, t, E(t)),
...
async function $e(e, t) {
  ...
  let { shapeSvg: i, bbox: a, label: o } = await C(e, t, E(t)),
    ...
    u = !0;
  (t.width || t.height) &&
    ((u = !1), (t.width = (t?.width ?? 0) - c * 2), (t.height = (t?.height ?? 0) - l * 3));
...
async function it(t, r) {
  ...
  let g = d || [],
    _ = m.getBBox(),
    b = await M(u, Array.isArray(g) ? g.join(`<br/>`) : g, r.labelStyle, !0, !0),
    x = b.children[0],
    C = n(b);
  ...
  (n(b).attr(
    ...
    (h = u.node().getBBox()),
    u.attr(`transform`, `translate(` + -h.width / 2 + `, ` + (-h.height / 2 - w + 3) + `)`));
  ...
  if (r.look === `handDrawn`) {
    ...
    ((j = s.insert(() => (e.debug(`Rough node insert CXC`, i), a), `:first-child`)),
      (A = s.insert(() => (e.debug(`Rough node insert CXC`, i), i), `:first-child`)));
  } else
...
function dt(e, t, { config: { themeVariables: n } }) {
  ...
  let p = d.circle(0, 0, t.width, { ...f, stroke: o, strokeWidth: 2 }),
    m = s ?? c,
    h = ((t.width ?? 0) * 5) / 14,
    g = d.circle(0, 0, h, { ...f, fill: m, stroke: m, strokeWidth: 2, fillStyle: `solid` }),
...
async function gt(e, t) {
  ...
  (t.width || t.height) &&
    ...
    (t.width = Math.max((t?.width ?? 0) - a * 2 - ht * (t.height + o * 2), 10)));
...
async function Ft(e, t) {
  ...
  if (r.attributes.length === 0 && t.label) {
    let n = { rx: 0, ry: 0, labelPaddingX: m, labelPaddingY: m * 1.5, classes: `` };
    a(t.label, f) + n.labelPaddingX * 2 < f.er.minEntityWidth && (t.width = f.er.minEntityWidth);
  ...
  if (
    ...
    C.select(`.name`).attr(`transform`, `translate(` + -w.width / 2 + `, ` + (H + h / 2) + `)`),
    i != null && Nt.has(i))
  ) {
    let e = r.colorIndex ?? 0;
...
async function It(e, t, r, i = 0, o = 0, s = [], c = ``) {
  ...
  let f = d
    .node()
    .appendChild(await m(d, t, { width: a(t, r) + 100, style: c, useHtmlLabels: r.htmlLabels }, r));
...
async function zt(e, i, o, c = []) {
  ...
  if (h) {
            ...
            new Promise((r) => {
              function i() {
                if (((n.style.display = `flex`), (n.style.flexDirection = `column`), e)) {
                  let e = f.fontSize?.toString() ?? window.getComputedStyle(document.body).fontSize,
    ...
    (c.includes(`font-weight: bolder`) && n(_).selectAll(`tspan`).attr(`font-weight`, ``),
      (y = _.children.length));
    let e = _.children[0];
    ((_.textContent === `` || _.textContent.includes(`&gt`)) &&
      ((e.textContent =
        g[0] + g.substring(1).replaceAll(`&gt;`, `>`).replaceAll(`&lt;`, `<`).trim()),
      g[1] === ` ` && (e.textContent = e.textContent[0] + ` ` + e.textContent.substring(1))),
...
async function Bt(e, t) {
  ...
  let _ = d.members.length === 0 && d.methods.length === 0 && !r.class?.hideEmptyMembersBox,
    b = S.svg(f),
    x = v(t, {});
  t.look !== `handDrawn` && ((x.roughness = 0), (x.fillStyle = `solid`));
  ...
  let A = b.rectangle(
      D - o,
      O - o - (_ ? o : d.members.length === 0 && d.methods.length === 0 ? -o / 2 : 0),
      C + 2 * o,
      w + 2 * o + k,
      x,
    ),
  ...
  let M = j.node().getBBox(),
    N = f.select(`.annotation-group`).node().getBBox().height - (_ ? o / 2 : 0) || 0,
    P = f.select(`.label-group`).node().getBBox().height - (_ ? o / 2 : 0) || 0,
    F = f.select(`.members-group`).node().getBBox().height - (_ ? o / 2 : 0) || 0,
    I =
      (N +
        P +
        O +
  ...
  if (_ || d.members.length > 0 || d.methods.length > 0) {
    let e = N + P + F + O + s * 2 + o,
      n = b.line(M.x, E ? Math.max(I, e) : e, M.x + M.width, (E ? Math.max(I, e) : e) + 0.001, x);
    f.insert(() => n)
      .attr(`class`, `divider${t.look === `neo` && !a ? ` neo-line` : ``}`)
      .attr(`style`, g);
  }
...
async function Vt(e, t) {
  ...
  if (((h += g + 20), s)) {
    ...
    ((h += r),
      await $(p, `${a.verifyMethod ? `Verification: ${a.verifyMethod}` : ``}`, h, t.labelStyle));
  } else {
  ...
  return (
    ...
    i && t.look !== `handDrawn` && (f || d?.length) && p.selectAll(`path`).attr(`style`, i),
    p
  );
}
t(Vt, `requirementBox`);
async function $(e, t, i, o = ``) {
  ...
  let l = e.insert(`g`).attr(`class`, `label`).attr(`style`, o),
    ...
    f = await m(
      l,
      s(r(t)),
      { width: a(t, u) + 50, classes: `markdown-node-label`, useHtmlLabels: d, style: o },
      u,
    ),
    p;
  if (d) {
...
async function Ut(e, t, { config: n }) {
  ...
  d
    ...
    : ({ label: p, bbox: m } = await w(o, (`ticket` in t && t.ticket) || ``, f));
  ...
  let _ = t?.width || 0,
    ...
    D = -_ / 2,
    O = -x / 2;
  (c.attr(`transform`, `translate(` + (l - _ / 2) + `, ` + (-b - s.height / 2) + `)`),
    p.attr(`transform`, `translate(` + (l - _ / 2) + `, ` + (-b + s.height / 2) + `)`),
    h.attr(
      `transform`,
      `translate(` + (l + _ / 2 - g.width - 20) + `, ` + (-b + s.height / 2) + `)`,
    ));
  let k,
    { rx: A, ry: j } = t,
    { cssStyles: M } = t;
  if (t.look === `handDrawn`) {
    let e = S.svg(o),
      n = v(t, {}),
      r = A || j ? e.path(N(D, O, _, x, A || 0), n) : e.rectangle(D, O, _, x, n);
