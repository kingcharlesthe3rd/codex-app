...
import "./isEqual.js";
import { mr as s } from "./src-1.js";
import "./react-dom.js";
import { o as c } from "./lib.js";
import "./persisted-signal.js";
import { c as l, i as u, n as d, t as f } from "./proxy.js";
import { t as p } from "./AnimatePresence.js";
...
import { m as v } from "./chunk-109.js";
import { t as te } from "./github-mark.js";
import "./use-is-dark.js";
import { t as ne } from "./info.js";
import { t as y } from "./openai-blossom.js";
import { p as re } from "./links.js";
import { t as b } from "./code-snippet.js";
import "./copy.js";
import "./copy-button.js";
import { t as x } from "./plus.js";
import { t as S } from "./send-to-cloud.js";
import { t as C } from "./use-nux.js";
import { t as ie } from "./robot-6i7-3zen.js";
import { n as ae, t as oe } from "./use-ascii-engine.js";
var w = n(),
  T = e(t(), 1);
function se({ children: e, isValidProp: t, ...n }) {
  (t && d(t), (n = { ...(0, T.useContext)(u), ...n }), (n.isStatic = l(() => n.isStatic)));
  let r = (0, T.useMemo)(
    () => n,
    [JSON.stringify(n.transition), n.transformPagePoint, n.reducedMotion],
  );
  return (0, w.jsx)(u.Provider, { value: r, children: e });
}
var E = r(),
  D = 0,
  ce = 1,
  ...
  O = 3,
  ue = O + 1,
  k = `import mongoose, { Schema } from "mongoose";
...
function j() {
  ...
  e[0] !== d || e[1] !== n || e[2] !== t
    ? ((f = async () => {
        (await o(t, s.NUX_2025_09_15, !0),
          n === `2025-09-15-full-chatgpt-auth`
            ? await o(t, s.NUX_2025_09_15_FULL_CHATGPT_AUTH_VIEWED, !0)
            : n === `2025-09-15-apikey-auth` &&
              (await o(t, s.NUX_2025_09_15_APIKEY_AUTH_VIEWED, !0)),
          d(`/`));
      }),
      (e[0] = d),
      (e[1] = n),
  ...
  let p = f,
    m;
  return (
    e[4] !== c || e[5] !== u || e[6] !== l || e[7] !== p
      ? ((m = (0, w.jsx)(M, {
          initialStep: u,
          onAccept: p,
          hasCloudAccess: c,
          isUsingCopilotAuth: l,
        })),
        (e[4] = c),
        (e[5] = u),
        (e[6] = l),
...
function M(e) {
  let t = (0, E.c)(64),
    { initialStep: n, onAccept: r, hasCloudAccess: i, isUsingCopilotAuth: a } = e,
    [o, s] = T.useState(n),
    l = _e(560),
    u;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = {
      ...
      (t[0] = u))
    : (u = t[0]);
  let { columns: d, rows: h, lines: g } = oe(u),
    [_, ee] = T.useState(!1),
    v;
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = { opacity: 1, transition: { duration: 0.4, ease: `easeInOut`, delay: 0.01 } }),
      (t[6] = S))
    : (S = t[6]);
  let C;
        ...
        return o === O
          ? (0, w.jsxs)(`ul`, {
              ...
              children: [
                ...
                (0, w.jsx)(he, { isUsingCopilotAuth: a }),
              ],
            })
          : (0, w.jsx)(`div`, {
  ...
  t[17] !== d || t[18] !== g || t[19] !== h
    ? ((R = (0, w.jsx)(`div`, {
        ...
        style: L,
        children: (0, w.jsx)(ae, { lines: g, columns: d, rows: h, scale: 0.95, autoCover: !0 }),
      })),
      (t[17] = d),
      (t[18] = g),
      (t[19] = h),
    ...
    ? ((B =
        ...
        (0, w.jsx)(
          f.div,
          {
            ...
            animate: `active`,
            exit: `exit`,
            children: (0, w.jsx)(me, { variant: F, isWideViewport: l }),
          },
          `slide-${o}`,
        )),
      (t[22] = F),
  ...
  t[26] === B
    ...
    : ((V = (0, w.jsx)(`div`, {
        ...
        children: (0, w.jsx)(`div`, {
          ...
          children: (0, w.jsx)(p, { initial: !1, mode: `wait`, children: B }),
        }),
      })),
      (t[26] = B),
      (t[27] = V));
  ...
  t[28] !== o || t[29] !== j
    ? ((H =
        ...
        (0, w.jsx)(
          f.span,
          { variants: k, initial: `initial`, animate: `active`, exit: `exit`, children: j() },
          `title-${o}`,
        )),
      (t[28] = o),
      (t[29] = j),
  ...
  t[31] === H
    ...
    : ((U = (0, w.jsx)(`div`, {
        ...
        children: (0, w.jsx)(`h1`, {
          ...
          children: (0, w.jsx)(p, { initial: !1, mode: `wait`, children: H }),
        }),
      })),
      (t[31] = H),
      (t[32] = U));
  ...
  t[33] !== _ || t[34] !== r
    ...
    : (W = t[35]);
  let G;
  t[36] !== o || t[37] !== _ || t[38] !== ve
    ? ((G =
        !(o === O && _) &&
        (0, w.jsx)(
          f.div,
          { variants: k, initial: `initial`, animate: `active`, exit: `exit`, children: ve() },
          `copy-${o}`,
        )),
      (t[36] = o),
      (t[37] = _),
  ...
  t[40] !== W || t[41] !== G
    ? ((K = (0, w.jsx)(`div`, {
        ...
        children: (0, w.jsx)(p, { initial: !1, mode: `wait`, onExitComplete: W, children: G }),
      })),
      (t[40] = W),
      (t[41] = G),
      (t[42] = K))
  ...
  let Y;
  t[48] !== b || t[49] !== J
    ? ((Y = (0, w.jsx)(m, { type: `button`, size: `large`, onClick: b, children: J })),
      (t[48] = b),
      (t[49] = J),
      (t[50] = Y))
    : (Y = t[50]);
  ...
  let Q;
  t[58] !== V || t[59] !== Z
    ? ((Q = (0, w.jsxs)(se, { transition: z, children: [V, Z] })),
      (t[58] = V),
      (t[59] = Z),
      (t[60] = Q))
    : (Q = t[60]);
...
function me(e) {
        ...
        return n === `intro`
                ...
                (0, w.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, w.jsx)(`div`, {
                      ...
                      children: (0, w.jsx)(ee, { className: `text-token-dropdown-background` }),
                    }),
                  ],
                }),
              ],
          ...
          : n === `cloud`
            ? (0, w.jsxs)(`div`, {
                ...
                children: [
                  (0, w.jsx)(S, { className: `size-8` }),
                  (0, w.jsxs)(`div`, {
                    className: `flex w-full items-center justify-between gap-4`,
                    children: [
                      (0, w.jsx)(h, { className: `size-4` }),
                      (0, w.jsxs)(`div`, {
  ...
  return (
    t[7] !== l || t[8] !== u
      ? ((d = (0, w.jsx)(`div`, { style: l, "aria-hidden": !0, children: u })),
        (t[7] = l),
        (t[8] = u),
        (t[9] = d))
      : (d = t[9]),
...
function he(e) {
  ...
  return (
    t[5] !== a || t[6] !== r || t[7] !== i
      ? ((o = (0, w.jsx)(ge, { Icon: r, title: i, children: a })),
        (t[5] = a),
        (t[6] = r),
        (t[7] = i),
        (t[8] = o))
...
function ge(e) {
  ...
  t[0] === n
    ? (a = t[1])
    : ((a = (0, w.jsx)(n, { className: `icon-base mt-0.5 shrink-0 opacity-80` })),
      (t[0] = n),
      (t[1] = a));
  let o;
  t[2] === r
    ? (o = t[3])
    : ((o = (0, w.jsx)(`span`, { className: `block text-sm font-medium`, children: r })),
      (t[2] = r),
      (t[3] = o));
  let s;
  t[4] === i
  ...
  let c;
  t[6] !== o || t[7] !== s
    ? ((c = (0, w.jsxs)(`div`, { className: `text-sm`, children: [o, s] })),
      (t[6] = o),
      (t[7] = s),
      (t[8] = c))
    : (c = t[8]);
  ...
  return (
    t[9] !== a || t[10] !== c
      ? ((l = (0, w.jsxs)(`li`, { className: `flex items-start gap-3`, children: [a, c] })),
        (t[9] = a),
        (t[10] = c),
        (t[11] = l))
      : (l = t[11]),
