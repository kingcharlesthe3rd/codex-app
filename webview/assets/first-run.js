...
import "./isEqual.js";
import { xr as o } from "./src-4.js";
import { ha as s } from "./app-server-manager-signals.js";
import "./react-dom.js";
...
import { t as b } from "./code-snippet-Bu-o-Ykd.js";
import "./copy-D.js";
import "./copy-button.js";
import { t as x } from "./plus.js";
import { t as S } from "./send-to-cloud.js";
import { t as C } from "./use-nux.js";
import { n as ie, t as ae } from "./use-ascii-engine.js";
var w = n(),
  T = e(t(), 1);
function oe({ children: e, isValidProp: t, ...n }) {
...
function j() {
  ...
  e[0] !== d || e[1] !== n || e[2] !== t
    ? ((f = async () => {
        (await s(t, o.NUX_2025_09_15, !0),
          n === `2025-09-15-full-chatgpt-auth`
            ? await s(t, o.NUX_2025_09_15_FULL_CHATGPT_AUTH_VIEWED, !0)
            : n === `2025-09-15-apikey-auth` &&
              (await s(t, o.NUX_2025_09_15_APIKEY_AUTH_VIEWED, !0)),
          d(`/`));
      }),
      (e[0] = d),
      (e[1] = n),
...
function M(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = {
      ...
      (t[0] = u))
    : (u = t[0]);
  let { columns: d, rows: h, lines: g } = ae(u),
    [_, ee] = T.useState(!1),
    v;
  ...
  t[17] !== d || t[18] !== g || t[19] !== h
    ? ((R = (0, w.jsx)(`div`, {
        ...
        style: L,
        children: (0, w.jsx)(ie, { lines: g, columns: d, rows: h, scale: 0.95, autoCover: !0 }),
      })),
      (t[17] = d),
      (t[18] = g),
      (t[19] = h),
  ...
  let Q;
  t[58] !== V || t[59] !== Z
    ? ((Q = (0, w.jsxs)(oe, { transition: z, children: [V, Z] })),
      (t[58] = V),
      (t[59] = Z),
      (t[60] = Q))
    : (Q = t[60]);
