...
import { i as z, r as B } from "./app-initial~app-main~new-thread-panel-page.js";
...
function U() {
  ...
  e[0] !== c || e[1] !== n || e[2] !== t
    ? ((u = async () => {
        (await g(t, d.NUX_2025_09_15, !0),
          n === `2025-09-15-full-chatgpt-auth`
            ? await g(t, d.NUX_2025_09_15_FULL_CHATGPT_AUTH_VIEWED, !0)
            : n === `2025-09-15-apikey-auth` &&
              (await g(t, d.NUX_2025_09_15_APIKEY_AUTH_VIEWED, !0)),
          c(`/`));
      }),
      (e[0] = c),
      (e[1] = n),
...
function W(e) {
  ...
  t[40] !== R || t[41] !== z
    ? ((B = (0, X.jsx)(`div`, {
        ...
        children: (0, X.jsx)(ne, { initial: !1, mode: `wait`, onExitComplete: R, children: z }),
      })),
      (t[40] = R),
      (t[41] = z),
      (t[42] = B))
  ...
  let U;
  t[48] !== v || t[49] !== H
    ? ((U = (0, X.jsx)(te, { type: `button`, size: `large`, onClick: v, children: H })),
      (t[48] = v),
      (t[49] = H),
      (t[50] = U))
    : (U = t[50]);
...
function pe(e) {
                ...
                (0, X.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, X.jsx)(`div`, {
                      ...
                      children: (0, X.jsx)(M, { className: `text-token-dropdown-background` }),
                    }),
                  ],
                }),
              ],
  ...
  let l = c,
    u;
  t[2] !== o || t[3] !== i
    ? ((u = { width: i, height: o }), (t[2] = o), (t[3] = i), (t[4] = u))
    : (u = t[4]);
  let d;
  ...
  return (
    t[7] !== u || t[8] !== d
      ? ((f = (0, X.jsx)(`div`, { style: u, "aria-hidden": !0, children: d })),
        (t[7] = u),
        (t[8] = d),
        (t[9] = f))
      : (f = t[9]),
