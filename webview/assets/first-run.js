...
import { Li as n } from "./app-server-manager-signals.js";
...
function se({ children: e, isValidProp: t, ...n }) {
  (t && g(t), (n = { ...(0, w.useContext)(h), ...n }), (n.isStatic = m(() => n.isStatic)));
  let r = (0, w.useMemo)(
    () => n,
...
function j(e) {
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = { opacity: 1, transition: { duration: 0.4, ease: `easeInOut`, delay: 0.01 } }),
      (t[6] = x))
    : (x = t[6]);
  let S;
  ...
  t[17] !== d || t[18] !== m || t[19] !== p
    ? ((R = (0, C.jsx)(`div`, {
        ...
        style: L,
        children: (0, C.jsx)(ae, { lines: m, columns: d, rows: p, scale: 0.95, autoCover: !0 }),
      })),
      (t[17] = d),
      (t[18] = m),
      (t[19] = p),
  ...
  t[28] !== s || t[29] !== A
    ? ((H =
        ...
        (0, C.jsx)(
          ee.span,
          { variants: O, initial: `initial`, animate: `active`, exit: `exit`, children: A() },
          `title-${s}`,
        )),
      (t[28] = s),
      (t[29] = A),
  ...
  t[36] !== s || t[37] !== h || t[38] !== ve
    ? ((G =
        ...
        (0, C.jsx)(
          ee.div,
          { variants: O, initial: `initial`, animate: `active`, exit: `exit`, children: ve() },
          `copy-${s}`,
        )),
      (t[36] = s),
      (t[37] = h),
  ...
  t[40] !== W || t[41] !== G
    ? ((K = (0, C.jsx)(`div`, {
        ...
        children: (0, C.jsx)(te, { initial: !1, mode: `wait`, onExitComplete: W, children: G }),
      })),
      (t[40] = W),
      (t[41] = G),
      (t[42] = K))
  ...
  let Y;
  t[48] !== y || t[49] !== J
    ? ((Y = (0, C.jsx)(f, { type: `button`, size: `large`, onClick: y, children: J })),
      (t[48] = y),
      (t[49] = J),
      (t[50] = Y))
    : (Y = t[50]);
                ...
                (0, C.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, C.jsx)(`div`, {
                      ...
                      children: (0, C.jsx)(b, { className: `text-token-dropdown-background` }),
                    }),
                  ],
                }),
              ],
...
function I(e) {
  ...
  t[0] === n
    ? (a = t[1])
    : ((a = (0, C.jsx)(n, { className: `icon-base mt-0.5 shrink-0 opacity-80` })),
      (t[0] = n),
      (t[1] = a));
  let o;
  t[2] === r
    ? (o = t[3])
    : ((o = (0, C.jsx)(`span`, { className: `block text-sm font-medium`, children: r })),
      (t[2] = r),
      (t[3] = o));
  let s;
  t[4] === i
  ...
  return (
    t[9] !== a || t[10] !== c
      ? ((l = (0, C.jsxs)(`li`, { className: `flex items-start gap-3`, children: [a, c] })),
        (t[9] = a),
        (t[10] = c),
        (t[11] = l))
      : (l = t[11]),
