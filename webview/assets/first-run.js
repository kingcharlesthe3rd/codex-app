...
import { n as z, t as B } from "./app-initial~app-main~first-run~new-thread-panel-page.js";
import { i as V, n as ce, r as le, t as H } from "./use-ascii-engine.js";
function U() {
  let e = (0, J.c)(9),
    t = p(a),
    n = z(),
  ...
  e[0] !== c || e[1] !== n || e[2] !== t
    ? ((l = async () => {
        (await d(t, T.NUX_2025_09_15, !0),
          n === `2025-09-15-full-chatgpt-auth`
            ? await d(t, T.NUX_2025_09_15_FULL_CHATGPT_AUTH_VIEWED, !0)
            : n === `2025-09-15-apikey-auth` &&
              (await d(t, T.NUX_2025_09_15_APIKEY_AUTH_VIEWED, !0)),
          c(`/`));
      }),
      (e[0] = c),
      (e[1] = n),
...
function W(e) {
  ...
  t[17] !== d || t[18] !== p || t[19] !== f
    ? ((M = (0, X.jsx)(`div`, {
        ...
        style: j,
        children: (0, X.jsx)(le, { lines: p, columns: d, rows: f, scale: 0.95, autoCover: !0 }),
      })),
      (t[17] = d),
      (t[18] = p),
      (t[19] = f),
  ...
  t[40] !== R || t[41] !== z
    ? ((B = (0, X.jsx)(`div`, {
        ...
        children: (0, X.jsx)(ie, { initial: !1, mode: `wait`, onExitComplete: R, children: z }),
      })),
      (t[40] = R),
      (t[41] = z),
      (t[42] = B))
  ...
  let U;
  t[48] !== v || t[49] !== H
    ? ((U = (0, X.jsx)(ne, { type: `button`, size: `large`, onClick: v, children: H })),
      (t[48] = v),
      (t[49] = H),
      (t[50] = U))
    : (U = t[50]);
...
function pe(e) {
                ...
                (0, X.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, X.jsx)(`div`, {
                      ...
                      children: (0, X.jsx)(f, { className: `text-token-dropdown-background` }),
                    }),
                  ],
                }),
              ],
  ...
  let l = c,
    u;
  t[2] !== s || t[3] !== a
    ? ((u = { width: a, height: s }), (t[2] = s), (t[3] = a), (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] === l ? (d = t[6]) : ((d = l()), (t[5] = l), (t[6] = d));
  let p;
  return (
    t[7] !== u || t[8] !== d
      ? ((p = (0, X.jsx)(`div`, { style: u, "aria-hidden": !0, children: d })),
        (t[7] = u),
        (t[8] = d),
        (t[9] = p))
      : (p = t[9]),
...
function me(e) {
  ...
  return (
    t[5] !== a || t[6] !== r || t[7] !== i
      ? ((s = (0, X.jsx)(ge, { Icon: r, title: i, children: a })),
        (t[5] = a),
        (t[6] = r),
        (t[7] = i),
        (t[8] = s))
...
function ge(e) {
  ...
  t[0] === n
    ? (a = t[1])
    : ((a = (0, X.jsx)(n, { className: `icon-base mt-0.5 shrink-0 opacity-80` })),
      (t[0] = n),
      (t[1] = a));
  let o;
  t[2] === r
    ? (o = t[3])
    : ((o = (0, X.jsx)(`span`, { className: `block text-sm font-medium`, children: r })),
      (t[2] = r),
      (t[3] = o));
  let s;
  t[4] === i
  ...
  return (
    t[9] !== a || t[10] !== c
      ? ((l = (0, X.jsxs)(`li`, { className: `flex items-start gap-3`, children: [a, c] })),
        (t[9] = a),
        (t[10] = c),
        (t[11] = l))
      : (l = t[11]),
