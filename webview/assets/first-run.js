...
import { St as P, xt as F } from "./app-initial~app-main~automations-page.js";
import {
  Fa as I,
  Ia as L,
...
import { _t as B, gt as ae } from "./app-initial~app-main~onboarding-page.js";
import {
  E as oe,
  P as V,
...
function W() {
  ...
  e[0] !== u || e[1] !== r || e[2] !== t
    ? ((d = async () => {
        (await j(t, o.NUX_2025_09_15, !0),
          r === `2025-09-15-full-chatgpt-auth`
            ? await j(t, o.NUX_2025_09_15_FULL_CHATGPT_AUTH_VIEWED, !0)
            : r === `2025-09-15-apikey-auth` &&
              (await j(t, o.NUX_2025_09_15_APIKEY_AUTH_VIEWED, !0)),
          u(`/`));
      }),
      (e[0] = u),
      (e[1] = r),
  ...
  let f = d,
    p;
  return (
    e[4] !== a || e[5] !== l || e[6] !== s || e[7] !== f
      ? ((p = (0, Z.jsx)(G, {
          initialStep: l,
          onAccept: f,
          hasCloudAccess: a,
          isUsingCopilotAuth: s,
        })),
        (e[4] = a),
        (e[5] = l),
        (e[6] = s),
...
function G(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = {
      ...
      (t[0] = l))
    : (l = t[0]);
  let { columns: u, rows: p, lines: m } = se(l),
    [h, ee] = X.useState(!1),
    g;
        ...
        return o === $
          ? (0, Z.jsxs)(`ul`, {
              ...
              children: [
                ...
                (0, Z.jsx)(pe, { isUsingCopilotAuth: a }),
              ],
            })
          : (0, Z.jsx)(`div`, {
  ...
  t[17] !== u || t[18] !== m || t[19] !== p
    ? ((N = (0, Z.jsx)(`div`, {
        ...
        style: M,
        children: (0, Z.jsx)(ce, { lines: m, columns: u, rows: p, scale: 0.95, autoCover: !0 }),
      })),
      (t[17] = u),
      (t[18] = m),
      (t[19] = p),
    ...
    ? ((F =
        ...
        (0, Z.jsx)(
          ne.div,
          {
            ...
            animate: `active`,
            exit: `exit`,
            children: (0, Z.jsx)(fe, { variant: O, isWideViewport: c }),
          },
          `slide-${o}`,
        )),
      (t[22] = O),
  ...
  t[26] === F
    ...
    : ((I = (0, Z.jsx)(`div`, {
        ...
        children: (0, Z.jsx)(`div`, {
          ...
          children: (0, Z.jsx)(re, { initial: !1, mode: `wait`, children: F }),
        }),
      })),
      (t[26] = F),
      (t[27] = I));
  ...
  t[31] === L
    ...
    : ((R = (0, Z.jsx)(`div`, {
        ...
        children: (0, Z.jsx)(`h1`, {
          ...
          children: (0, Z.jsx)(re, { initial: !1, mode: `wait`, children: L }),
        }),
      })),
      (t[31] = L),
      (t[32] = R));
  ...
  t[33] !== h || t[34] !== r
    ...
    : (z = t[35]);
  let B;
  t[36] !== o || t[37] !== h || t[38] !== j
    ? ((B =
        !(o === $ && h) &&
        (0, Z.jsx)(
          ne.div,
          { variants: S, initial: `initial`, animate: `active`, exit: `exit`, children: j() },
          `copy-${o}`,
        )),
      (t[36] = o),
      (t[37] = h),
  ...
  t[40] !== z || t[41] !== B
    ? ((V = (0, Z.jsx)(`div`, {
        ...
        children: (0, Z.jsx)(re, { initial: !1, mode: `wait`, onExitComplete: z, children: B }),
      })),
      (t[40] = z),
      (t[41] = B),
      (t[42] = V))
  ...
  let W;
  t[48] !== v || t[49] !== U
    ? ((W = (0, Z.jsx)(f, { type: `button`, size: `large`, onClick: v, children: U })),
      (t[48] = v),
      (t[49] = U),
      (t[50] = W))
    : (W = t[50]);
  ...
  let q;
  t[58] !== I || t[59] !== K
    ? ((q = (0, Z.jsxs)(ie, { transition: P, children: [I, K] })),
      (t[58] = I),
      (t[59] = K),
      (t[60] = q))
    : (q = t[60]);
