...
import { dt as pe, lt as me } from "./app-initial~app-main~automations-page.js";
import {
  Bc as he,
  Er as ge,
  F as _e,
...
`)
  ...
  if (t[6] !== n || t[7] !== c || t[8] !== o || t[9] !== i) {
    ...
    t[18] === n.machine.label
      ? (g = t[19])
      : ((g = (0, W.jsx)(O, { label: h, valueAlignment: `end`, children: n.machine.label })),
        (t[18] = n.machine.label),
        (t[19] = g));
    let _;
...
function lt(e) {
  ...
  t[14] === r
    ? (h = t[15])
    : ((h = (0, G.jsx)(M, { color: `danger`, loading: r, type: `submit`, children: m })),
      (t[14] = r),
      (t[15] = h));
  let g;
  t[16] !== p || t[17] !== h
    ? ((g = (0, G.jsxs)(Pe, { children: [p, h] })), (t[16] = p), (t[17] = h), (t[18] = g))
    : (g = t[18]);
  let _;
...
function ut(e) {
  ...
  t[11] === n
    ? (p = t[12])
    : ((p = (0, G.jsx)(M, { color: `primary`, loading: n, type: `submit`, children: f })),
      (t[11] = n),
      (t[12] = p));
  let m;
  t[13] !== d || t[14] !== p
    ? ((m = (0, G.jsxs)(Pe, { children: [d, p] })), (t[13] = d), (t[14] = p), (t[15] = m))
    : (m = t[15]);
  let h;
  t[16] !== o || t[17] !== m
...
function Xt(e) {
  return F.safeGet(`/wham/environments/{environment_id}/with-creator-and-machine`, {
...
var fn,
  ...
  xn = e(() => {
    (c(),
      ...
      (gn = o(B, ({ scope: e }) => ({ mutationFn: en, onSuccess: () => dn(e) }))),
      (_n = o(B, ({ scope: e }) => ({
        mutationFn: (e) => tn(e),
...
function Sn(e) {
  ...
  t[2] !== m.data || t[3] !== i || t[4] !== f
    ? ((h = m.data?.find((e) => e.id === (f ?? i))?.id ?? m.data?.[0]?.id ?? null),
      (t[2] = m.data),
      (t[3] = i),
      (t[4] = f),
      (t[5] = h))
...
function An(e) {
  ...
  t[11] !== p
    ? ((b = (e) => {
        let { value: t } = e;
        if (Ot(t, d.data?.some((e) => e.id === t.machineId) === !0, n?.machine_id)) {
          if (n == null) {
            f.mutate(kt(t), {
              onSuccess: (e) => {
                (o
    ...
    ? ((E = (e) => {
        ...
        return (0, X.jsxs)(X.Fragment, {
          children: [
                ...
                children: (0, X.jsxs)(H, {
                  children: [
                    ...
                    (0, X.jsx)(w, {
                      ...
                      control:
                        n == null
                          ? (0, X.jsx)(Sn, { form: S, isPending: C, preferredConnectorId: a })
                          : (0, X.jsx)(K, {
                              "aria-label": c.formatMessage({
                          ...
                          control: d.isError
                            ? (0, X.jsxs)(`div`, {
                                ...
                                children: [
                                  o == null
                                    ? null
                                    : (0, X.jsx)(Ue, { disabled: !0, children: o.label }),
                                  (0, X.jsx)(M, {
                                    color: `secondary`,
            ...
            (0, X.jsx)(bt, { form: S, isPending: C, showAuthtranslator: m, showDockerInDocker: h }),
                  ...
                  s.length === 0
                    ...
                    : s.map((e) =>
                        (0, Z.jsx)(
                          ...
                          {
                            environment: e,
                            isPinning: S.isPending && S.variables?.environmentId === e.id,
                            onEdit: () => n(e.id),
                            onSelect: () => r(e.id),
                            onTogglePin: () => {
                              S.mutate(
...
function In(e) {
  ...
  let C;
  t[29] !== m || t[30] !== S
    ? ((C = (0, Z.jsxs)(Z.Fragment, { children: [m, S] })), (t[29] = m), (t[30] = S), (t[31] = C))
    : (C = t[31]);
  let w;
  t[32] !== n.label || t[33] !== c
    ? ((w = c.formatMessage(
...
function Hn(e) {
  ...
  let x = f.data,
    ...
    T;
  t[8] !== x.creator || t[9] !== u
    ? ((T = u != null && x.creator.id.includes(u)), (t[8] = x.creator), (t[9] = u), (t[10] = T))
    : (T = t[10]);
  let E = C && T,
  ...
  t[28] !== h
    ...
    : (A = t[29]);
  let j;
  t[30] === r ? (j = t[31]) : ((j = (0, Q.jsx)(Wn, { onClick: r })), (t[30] = r), (t[31] = j));
  let ie = x.description || void 0,
    N;
  t[32] === x ? (N = t[33]) : ((N = (0, Q.jsx)(rt, { environment: x })), (t[32] = x), (t[33] = N));
  let ae = g === `delete`,
    oe;
  ...
  t[52] !== m.isPending || t[53] !== le || t[54] !== F
    ? ((L = (0, Q.jsx)(ut, { isPending: m.isPending, open: le, onConfirm: F, onOpenChange: I })),
      (t[52] = m.isPending),
      (t[53] = le),
      (t[54] = F),
      (t[55] = L))
...
function Un(e) {
  ...
  if (i.isPending) {
    ...
    return (
      t[6] === e
        ? (a = t[7])
        : ((a = (0, Q.jsx)(me, { backSlot: e, title: n, children: i })), (t[6] = e), (t[7] = a)),
      a
    );
  }
...
function Wn(e) {
  ...
  return (
    t[2] === n
      ? (a = t[3])
      : ((a = (0, Q.jsxs)(M, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
        (t[2] = n),
        (t[3] = a)),
    a
  );
