...
import { J as we, K as Te } from "./app-initial~app-main~automations-page.js";
import {
  Oo as Ee,
  fi as De,
  ko as Oe,
...
import { n as $e, t as et } from "./esm.js";
...
function lt(e) {
  ...
  t[5] === c
    ? (f = t[6])
    : ((f = (0, G.jsx)(u, { title: c, subtitle: d })), (t[5] = c), (t[6] = f));
  let p;
  ...
  t[14] === r
    ? (_ = t[15])
    : ((_ = (0, G.jsx)(l, { color: `danger`, loading: r, type: `submit`, children: g })),
      (t[14] = r),
      (t[15] = _));
  let v;
  t[16] !== h || t[17] !== _
    ? ((v = (0, G.jsxs)(j, { children: [h, _] })), (t[16] = h), (t[17] = _), (t[18] = v))
    : (v = t[18]);
  let y;
  t[19] !== s || t[20] !== v || t[21] !== f
    ? ((y = (0, G.jsxs)(be, { as: `form`, onSubmit: s, children: [f, v] })),
      (t[19] = s),
      (t[20] = v),
      (t[21] = f),
      (t[22] = y))
  ...
  return (
    t[23] !== o || t[24] !== i || t[25] !== y
      ? ((b = (0, G.jsx)(ve, { open: i, onOpenChange: o, children: y })),
        (t[23] = o),
        (t[24] = i),
        (t[25] = y),
        (t[26] = b))
...
function ut(e) {
  ...
  t[11] === n
    ? (h = t[12])
    : ((h = (0, G.jsx)(l, { color: `primary`, loading: n, type: `submit`, children: m })),
      (t[11] = n),
      (t[12] = h));
  let g;
  t[13] !== p || t[14] !== h
    ? ((g = (0, G.jsxs)(j, { children: [p, h] })), (t[13] = p), (t[14] = h), (t[15] = g))
    : (g = t[15]);
  let _;
  t[16] !== o || t[17] !== g
    ? ((_ = (0, G.jsxs)(be, { as: `form`, onSubmit: o, children: [c, g] })),
      (t[16] = o),
      (t[17] = g),
      (t[18] = _))
    : (_ = t[18]);
  ...
  return (
    t[19] !== a || t[20] !== r || t[21] !== _
      ? ((v = (0, G.jsx)(ve, { open: r, onOpenChange: a, children: _ })),
        (t[19] = a),
        (t[20] = r),
        (t[21] = _),
        (t[22] = v))
...
var wt,
  q,
  Tt = e(() => {
    ((wt = he()), F(), S(), Ye(), r(), We(), je(), Ve(), gt(), (q = c()));
  });
function Et(e, t) {
  let n = Pt(e);
  return {
...
function Wt(e) {
  ...
  let f;
  t[7] !== r || t[8] !== a || t[9] !== d
    ? ((f = (0, J.jsx)(V, { description: r, label: a, control: d })),
      (t[7] = r),
      (t[8] = a),
      (t[9] = d),
      (t[10] = f))
...
function Gt(e) {
  ...
  let f;
  t[8] !== r || t[9] !== d
    ? ((f = (0, J.jsx)(V, { description: r, label: s, control: d })),
      (t[8] = r),
      (t[9] = d),
      (t[10] = f))
    : (f = t[10]);
...
var fn,
  ...
  xn = e(() => {
    (o(),
      ...
      (gn = P(O, ({ scope: e }) => ({ mutationFn: en, onSuccess: () => dn(e) }))),
      (_n = P(O, ({ scope: e }) => ({
        mutationFn: (e) => tn(e),
...
function Sn(e) {
  ...
  let l = me(c, 200),
    ...
    f = v(mn),
    p;
  t[2] !== f.data || t[3] !== i || t[4] !== u
    ? ((p = f.data?.find((e) => e.id === (u ?? i))?.id ?? f.data?.[0]?.id ?? null),
      (t[2] = f.data),
      (t[3] = i),
      (t[4] = u),
      (t[5] = p))
  ...
  let m = p,
    g;
  t[6] !== m || t[7] !== l
    ? ((g = { connectorId: m, query: l }), (t[6] = m), (t[7] = l), (t[8] = g))
    : (g = t[8]);
  let _ = T(hn, g),
    y;
          ...
          children: [
            f.isError
              ...
              : f.data?.length === 0
                ...
                : f.data != null && f.data.length > 1
                  ? (0, Y.jsxs)(Y.Fragment, {
                      children: [
                        (0, Y.jsxs)(L.Section, {
                          children: [
                            (0, Y.jsx)(L.SectionLabel, {
                              children: (0, Y.jsx)(R, {
                                  ...
                                  L.Item,
                                  {
                                    onSelect: () => {
                                      (n.setFieldValue(`repositoryId`, e.id),
                                        ...
                                        n.setFieldValue(`githubConnectorId`, At(e.id) ?? m));
                                    },
...
function An(e) {
  let t = (0, Mn.c)(35),
    ...
    _ = ge(`2664309699`),
    b;
  t[0] === c ? (b = t[1]) : ((b = p(c) || D(c)), (t[0] = c), (t[1] = b));
  let x = b,
    S = n ?? void 0,
    C;
  t[2] !== a || t[3] !== S ? ((C = Et(S, a)), (t[2] = a), (t[3] = S), (t[4] = C)) : (C = t[4]);
  let w;
  t[5] !== d ||
  t[6] !== n ||
  t[7] !== s ||
  ...
  t[11] !== m
    ? ((w = (e) => {
        let { value: t } = e;
        if (Ot(t, u.data?.some((e) => e.id === t.machineId) === !0, n?.machine_id)) {
          if (n == null) {
            d.mutate(kt(t), {
              onSuccess: (e) => {
                (o
  ...
  let T;
  t[13] !== C || t[14] !== w
    ? ((T = { defaultValues: C, onSubmit: w }), (t[13] = C), (t[14] = w), (t[15] = T))
    : (T = t[15]);
  let E = $e(T),
    k = d.isPending || m.isPending,
    A;
  t[16] === E
    ? (A = t[17])
    : ((A = (e) => {
  ...
  t[27] !== x
    ? ((j = (e) => {
        let t = Dt(e),
          i = u.data?.find((t) => t.id === e.machineId),
        ...
        return (0, X.jsxs)(X.Fragment, {
          children: [
                ...
                children: (0, X.jsxs)(H, {
                  children: [
                    ...
                    (0, X.jsx)(V, {
                      ...
                      control:
                        n == null
                          ? (0, X.jsx)(Sn, { form: E, isPending: k, preferredConnectorId: a })
                          : (0, X.jsx)(K, {
                              "aria-label": s.formatMessage({
                          ...
                          control: u.isError
                            ? (0, X.jsxs)(`div`, {
                                ...
                                children: [
                                  o == null
                                    ? null
                                    : (0, X.jsx)(Le, { disabled: !0, children: o.label }),
                                  (0, X.jsx)(l, {
                                    color: `secondary`,
                            ...
                            : (0, X.jsx)(h, {
                                triggerButton: (0, X.jsx)(Le, {
                                  disabled: u.isPending || k,
                                  children:
                                    i?.label ??
                                    o?.label ??
                                    (0, X.jsx)(R, {
            ...
            (0, X.jsx)(_t, { form: E, isPending: k }),
            (0, X.jsx)(Ht, { form: E, isPending: k }),
            (0, X.jsx)(vt, { form: E, isPending: k }),
            (0, X.jsx)(bt, { form: E, isPending: k, showAuthtranslator: g, showDockerInDocker: _ }),
            x ? (0, X.jsx)(St, { form: E, isPending: k }) : null,
            (0, X.jsxs)(`div`, {
    ...
    : (j = t[28]);
  let M;
  t[29] !== E.Subscribe || t[30] !== j
    ? ((M = (0, X.jsx)(E.Subscribe, { selector: jn, children: j })),
      (t[29] = E.Subscribe),
      (t[30] = j),
      (t[31] = M))
    : (M = t[31]);
...
function Pn(e) {
  ...
  let d = me(u, 200),
    p;
  t[2] === d ? (p = t[3]) : ((p = un(d)), (t[2] = d), (t[3] = p));
  let {
      data: m,
      fetchNextPage: h,
      hasNextPage: g,
  ...
  if (
    ...
    ((w = `flex flex-col gap-3`),
      ...
      (t[18] = T),
      (t[19] = E));
  } else ((w = t[17]), (T = t[18]), (E = t[19]));
  let D;
  t[20] !== m || t[21] !== h || t[22] !== g || t[23] !== _ || t[24] !== b
    ? ((D =
        m == null
          ? null
          : (0, Z.jsx)(Je, {
  ...
  let A;
  return (
    t[30] !== w || t[31] !== T || t[32] !== E || t[33] !== D || t[34] !== k
      ? ((A = (0, Z.jsxs)(`div`, { className: w, children: [T, E, D, k] })),
        (t[30] = w),
        (t[31] = T),
        (t[32] = E),
        (t[33] = D),
...
function In(e) {
  ...
  t[0] !== n.creator_id || t[1] !== s
    ? ((d = s != null && n.creator_id.includes(s)), (t[0] = n.creator_id), (t[1] = s), (t[2] = d))
    : (d = t[2]);
  let f = d,
    p = u && f,
    m;
  ...
  t[15] === n.is_pinned
    ? (y = t[16])
    : ((y = n.is_pinned
        ? (0, Z.jsx)(Be, { className: `icon-xs` })
        : (0, Z.jsx)(Ue, { className: `icon-xs` })),
      (t[15] = n.is_pinned),
      (t[16] = y));
  let b;
  t[17] !== r || t[18] !== o || t[19] !== m || t[20] !== v || t[21] !== y
    ? ((b = (0, Z.jsx)(l, {
        "aria-label": m,
        color: `ghost`,
        disabled: v,
  ...
  let x;
  t[23] !== _ || t[24] !== b
    ? ((x = (0, Z.jsx)(`span`, { className: _, children: b })),
      (t[23] = _),
      (t[24] = b),
      (t[25] = x))
    : (x = t[25]);
  let S;
  t[26] !== m || t[27] !== x
    ? ((S = (0, Z.jsx)(pe, { tooltipContent: m, children: x })),
      (t[26] = m),
      (t[27] = x),
      (t[28] = S))
    : (S = t[28]);
  let C;
  t[29] !== g || t[30] !== S
    ? ((C = (0, Z.jsxs)(Z.Fragment, { children: [g, S] })), (t[29] = g), (t[30] = S), (t[31] = C))
    : (C = t[31]);
  let w;
  t[32] !== n.label || t[33] !== c
    ? ((w = c.formatMessage(
...
function Bn() {
  ...
  if (o.length === 0) {
    ...
    e[8] === n
      ? (a = e[9])
      : ((a = (0, Q.jsx)(l, { color: `primary`, onClick: n, children: r })),
        (e[8] = n),
        (e[9] = a));
    let o;
    e[10] === i
    ...
    return (
      e[12] !== a || e[13] !== o
        ? ((s = (0, Q.jsx)(Te, { title: t, action: a, children: o })),
          (e[12] = a),
          (e[13] = o),
          (e[14] = s))
        : (s = e[14]),
  ...
  if (s) {
    ...
    return (
      e[20] !== t || e[21] !== r
        ? ((a = (0, Q.jsx)(Te, { backSlot: t, title: n, children: r })),
          (e[20] = t),
          (e[21] = r),
          (e[22] = a))
        : (a = e[22]),
  ...
  return (
    e[40] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((p = (0, Q.jsx)(Ce, { to: $, replace: !0 })), (e[40] = p))
      : (p = e[40]),
    p
  );
}
...
function Hn(e) {
  let t = (0, Gn.c)(64),
    ...
    p = v(yn),
    m = v(bn),
    [g, _] = (0, Kn.useState)(null);
  if (u.isPending || u.isError) {
    let e;
    ...
    return (
      t[5] !== e || t[6] !== i
        ? ((a = (0, Q.jsx)(Te, { backSlot: e, title: n, children: i })),
          (t[5] = e),
          (t[6] = i),
          (t[7] = a))
        : (a = t[7]),
  ...
  let b = u.data,
    ...
    C;
  t[8] !== b.creator || t[9] !== c
    ? ((C = c != null && b.creator.id.includes(c)), (t[8] = b.creator), (t[9] = c), (t[10] = C))
    : (C = t[10]);
  let w = x && C,
    E = x && (b.cache_settings?.post_setup_cache_enabled ?? !0),
    D;
  t[11] !== b.is_pinned || t[12] !== s
    ? ((D = b.is_pinned
        ? s.formatMessage({
  ...
  t[28] !== m
                ...
                w
                  ? (0, Q.jsx)(pe, {
                      ...
                      children: (0, Q.jsx)(l, {
                        ...
                        onClick: () => {
                          m.mutate(
                            { environmentId: b.id, etag: b.etag, isPinned: !b.is_pinned },
                            {
                              onError: () => {
                                o.get(z).danger(
                                  s.formatMessage({
    ...
    : (M = t[29]);
  let N;
  t[30] === r ? (N = t[31]) : ((N = (0, Q.jsx)(Wn, { onClick: r })), (t[30] = r), (t[31] = N));
  let te = b.description || void 0,
    ne;
  t[32] === b
    ? (ne = t[33])
    : ((ne = (0, Q.jsx)(rt, { environment: b })), (t[32] = b), (t[33] = ne));
  let re = g === `delete`,
    ie;
  t[34] !== d || t[35] !== b.id || t[36] !== s || t[37] !== i || t[38] !== o
    ? ((ie = () => {
        d.mutate(b.id, {
          onSuccess: () => {
            (o
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (e) => _(e ? `delete` : null)), (t[40] = ae))
    : (ae = t[40]);
  let oe;
  t[41] !== d.isPending || t[42] !== b.label || t[43] !== re || t[44] !== ie
    ? ((oe = (0, Q.jsx)(lt, {
  ...
  let se = g === `reset-cache`,
    P;
  t[46] !== b.id || t[47] !== s || t[48] !== p || t[49] !== o
    ? ((P = () => {
        p.mutate(b.id, {
          onSuccess: () => {
            (_(null),
  ...
  t[51] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (e) => _(e ? `reset-cache` : null)), (t[51] = F))
    : (F = t[51]);
  let ce;
  t[52] !== p.isPending || t[53] !== se || t[54] !== P
    ? ((ce = (0, Q.jsx)(ut, { isPending: p.isPending, open: se, onConfirm: P, onOpenChange: F })),
      (t[52] = p.isPending),
      (t[53] = se),
      (t[54] = P),
      (t[55] = ce))
...
function Un(e) {
  ...
  if (i.isError) {
    ...
    return (
      t[0] === e
        ? (r = t[1])
        : ((r = (0, Q.jsx)(Ce, { to: e, replace: !0 })), (t[0] = e), (t[1] = r)),
      r
    );
  }
  if (i.isPending) {
    ...
    return (
      t[6] === e
        ? (a = t[7])
        : ((a = (0, Q.jsx)(Te, { backSlot: e, title: n, children: i })), (t[6] = e), (t[7] = a)),
      a
    );
  }
  if (i.data.permissions?.can_write !== !0) {
    ...
    return (
      t[8] === e
        ? (r = t[9])
        : ((r = (0, Q.jsx)(Ce, { to: e, replace: !0 })), (t[8] = e), (t[9] = r)),
      r
    );
  }
  let a;
  ...
  return (
    t[16] !== a || t[17] !== s
      ? ((c = (0, Q.jsx)(Te, { backSlot: a, title: o, children: s })),
        (t[16] = a),
        (t[17] = s),
        (t[18] = c))
      : (c = t[18]),
...
function Wn(e) {
  ...
  return (
    t[2] === n
      ? (a = t[3])
      : ((a = (0, Q.jsxs)(l, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
        (t[2] = n),
        (t[3] = a)),
    a
  );
