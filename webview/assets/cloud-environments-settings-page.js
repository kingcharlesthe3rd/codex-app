...
import { a as r, f as i, m as a, o, p as s, s as c, t as l, z as u } from "./app-scope.js";
import "./app-server-manager-signals.js";
import { u as d } from "./vscode-api.js";
import "./isEqual.js";
import "./src-2.js";
import "./react-dom.js";
import { i as f, l as p, s as m, t as h } from "./lib.js";
...
import "./search.js";
import { d as E, i as D, l as O, n as k, r as A, u as j } from "./dialog-layout-B.js";
import "./with-window.js";
import { t as M } from "./use-debounced-value-Dw-7BPJJ.js";
import { t as N } from "./toggle.js";
...
import { i as P, r as te } from "./skus.js";
import { t as F } from "./pencil.js";
import "./chevron.js";
import { a as I, f as L, m as R } from "./chunk-9.js";
import { t as z } from "./arrow-left.js";
import "./links-p.js";
import "./x-circle.js";
import "./three-dots.js";
import { t as ne } from "./trash.js";
import { t as re } from "./pin-filled.js";
import { t as ie } from "./pin.js";
import { i as ae, t as B } from "./settings-shared.js";
import { t as V } from "./settings-content-layout.js";
import { t as oe } from "./more-menu-trigger-3O9O-Cbz.js";
import { r as H, t as U } from "./settings-row.js";
import { t as W } from "./settings-surface.js";
import { t as G } from "./settings-group.js";
import { t as K } from "./settings-empty-state.js";
import { t as se } from "./segmented-toggle.js";
import { t as q } from "./useForm.js";
import { i as ce } from "./cloud-preferences.js";
import { t as J } from "./page-search-input.js";
var le = e(t(), 1),
  Y = u(),
  X = n();
function ue(e) {
...
`)
  ...
  if (t[6] !== n || t[7] !== c || t[8] !== o || t[9] !== i) {
    ...
    t[15] === p
      ? (g = t[16])
      : ((g = (0, X.jsx)(H, { label: f, control: p })), (t[15] = p), (t[16] = g));
    let _;
    ...
    t[18] === n.machine.label
      ? (v = t[19])
      : ((v = (0, X.jsx)(H, { label: _, control: n.machine.label })),
        (t[18] = n.machine.label),
        (t[19] = v));
    let y;
    ...
    t[21] === b
      ? (x = t[22])
      : ((x = (0, X.jsx)(H, { label: y, control: b })), (t[21] = b), (t[22] = x));
    let S;
    t[23] === n.created_at
      ? (S = t[24])
      : ((S =
    ...
    let w = n.agent_network_access?.mode,
      T;
    t[26] === w ? (T = t[27]) : ((T = de(w)), (t[26] = w), (t[27] = T));
    let E;
    t[28] === T
      ? (E = t[29])
      : ((E = (0, X.jsx)(H, { label: C, control: T })), (t[28] = T), (t[29] = E));
    let D;
    ...
    t[31] === n.share_settings
      ? (O = t[32])
      : ((O = fe(n.share_settings)), (t[31] = n.share_settings), (t[32] = O));
    let k;
    t[33] === O
      ? (k = t[34])
      : ((k = (0, X.jsx)(H, { label: D, control: O })), (t[33] = O), (t[34] = k));
    let A;
    (t[35] !== v || t[36] !== x || t[37] !== S || t[38] !== E || t[39] !== k || t[40] !== g
      ? ((A = (0, X.jsx)(G, {
          children: (0, X.jsx)(G.Content, {
            children: (0, X.jsxs)(W, { children: [g, v, x, S, E, k] }),
          }),
        })),
        (t[35] = v),
        (t[36] = x),
...
function me(e) {
  ...
  t[5] === c
    ? (u = t[6])
    : ((u = (0, X.jsx)(D, { title: c, subtitle: l })), (t[5] = c), (t[6] = u));
  let d;
  ...
  t[14] === r
    ? (_ = t[15])
    : ((_ = (0, X.jsx)(g, { color: `danger`, loading: r, type: `submit`, children: h })),
      (t[14] = r),
      (t[15] = _));
  let v;
  t[16] !== p || t[17] !== _
    ? ((v = (0, X.jsxs)(A, { children: [p, _] })), (t[16] = p), (t[17] = _), (t[18] = v))
    : (v = t[18]);
  let y;
  t[19] !== s || t[20] !== v || t[21] !== u
    ? ((y = (0, X.jsxs)(k, { as: `form`, onSubmit: s, children: [u, v] })),
      (t[19] = s),
      (t[20] = v),
      (t[21] = u),
      (t[22] = y))
  ...
  return (
    t[23] !== o || t[24] !== i || t[25] !== y
      ? ((b = (0, X.jsx)(O, { open: i, onOpenChange: o, children: y })),
        (t[23] = o),
        (t[24] = i),
        (t[25] = y),
        (t[26] = b))
...
function he(e) {
  ...
  t[11] === n
    ? (p = t[12])
    : ((p = (0, X.jsx)(g, { color: `primary`, loading: n, type: `submit`, children: f })),
      (t[11] = n),
      (t[12] = p));
  let h;
  t[13] !== d || t[14] !== p
    ? ((h = (0, X.jsxs)(A, { children: [d, p] })), (t[13] = d), (t[14] = p), (t[15] = h))
    : (h = t[15]);
  let _;
  t[16] !== o || t[17] !== h
    ? ((_ = (0, X.jsxs)(k, { as: `form`, onSubmit: o, children: [c, h] })),
      (t[16] = o),
      (t[17] = h),
      (t[18] = _))
    : (_ = t[18]);
  ...
  return (
    t[19] !== a || t[20] !== r || t[21] !== _
      ? ((v = (0, X.jsx)(O, { open: r, onOpenChange: a, children: _ })),
        (t[19] = a),
        (t[20] = r),
        (t[21] = _),
        (t[22] = v))
...
function _e(e) {
  ...
  let s;
  t[4] !== n.Field || t[5] !== o
    ? ((s = (0, X.jsx)(n.Field, { name: `setupCommands`, children: o })),
      (t[4] = n.Field),
      (t[5] = o),
      (t[6] = s))
    : (s = t[6]);
  ...
  let l;
  t[10] !== n.Field || t[11] !== c
    ? ((l = (0, X.jsx)(n.Field, { name: `maintenanceSetupCommands`, children: c })),
      (t[10] = n.Field),
      (t[11] = c),
      (t[12] = l))
    : (l = t[12]);
  ...
  return (
    t[13] !== s || t[14] !== l
      ? ((u = (0, X.jsxs)(G, {
          children: [a, (0, X.jsx)(G.Content, { children: (0, X.jsxs)(W, { children: [s, l] }) })],
        })),
        (t[13] = s),
        (t[14] = l),
        (t[15] = u))
...
function ve(e) {
  ...
  return (
    t[4] !== n.Subscribe || t[5] !== a
      ? ((o = (0, X.jsx)(n.Subscribe, { selector: ye, children: a })),
        (t[4] = n.Subscribe),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
...
function be(e) {
  ...
  return (
    t[6] !== n.Subscribe || t[7] !== s
      ? ((c = (0, X.jsx)(n.Subscribe, { selector: xe, children: s })),
        (t[6] = n.Subscribe),
        (t[7] = s),
        (t[8] = c))
      : (c = t[8]),
...
function Se(e) {
  ...
  return (
    t[4] !== n.Subscribe || t[5] !== a
      ? ((o = (0, X.jsx)(n.Subscribe, { selector: Ce, children: a })),
        (t[4] = n.Subscribe),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
...
function Ee(e, t) {
  ...
  return {
    ...
    setupCommands: Me(e?.setup),
    maintenanceSetupCommands: Me(e?.maintenance_setup),
  ...
  n.some(({ key: e }) => e === ``)
    ...
    : new Set(n.map(({ identity: e }) => e)).size === n.length
      ? e.secrets.some(({ value: e }) => e.trim() === ``)
        ...
        : e.secrets.some(Re) && (t.secrets = `global-rename-value-required`)
...
function Oe(e, t, n) {
  return (t || e.machineId === n) && Object.keys(De(e)).length === 0;
}
function ke(e) {
  return {
    label: e.label.trim(),
...
function je(e, t) {
  return {
    ...
    secrets_with_domains: Fe(e.secrets, Pe(t)),
    share_settings: e.shareSettings,
    share_targets: Ne(e),
    auto_setup_settings: e.autoSetupSettings,
    cache_settings: e.cacheSettings,
...
function Fe(e, t) {
  ...
  for (let t of e) {
    ...
    if (t.previousDomain === void 0) {
      t.value !== `` && (n.add(Ie(e, i)), r.push({ name: e, domain: i, value: t.value }));
      continue;
    }
    let a = t.previousKey ?? t.key,
      o = Le(t.previousDomain);
    n.add(Ie(a, o));
    let s = a !== e,
      c = o !== i,
      l = t.value !== we;
    ...
    t[4] !== n.Subscribe || t[5] !== a
      ? ((o = (0, X.jsxs)(G, {
          children: [
            i,
            (0, X.jsx)(G.Content, {
              children: (0, X.jsx)(n.Subscribe, { selector: Be, children: a }),
            }),
          ],
        })),
        (t[4] = n.Subscribe),
...
function Ve(e) {
  let t = (0, Y.c)(17),
    ...
    s = p(),
    c;
  t[0] !== n || t[1] !== r || t[2] !== s || t[3] !== i || t[4] !== a || t[5] !== o
    ? ((c = n.map((e, t) =>
        (0, X.jsx)(
          H,
          {
            description: t === 0 ? r : void 0,
            label: t === 0 ? a : null,
            variant: `nested`,
            control: (0, X.jsxs)(`div`, {
  ...
  let l;
  t[7] !== n || t[8] !== o
    ? ((l = () => o([...n, { key: ``, value: `` }])), (t[7] = n), (t[8] = o), (t[9] = l))
    : (l = t[9]);
  let u;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, X.jsx)(m, {
  ...
  return (
    t[14] !== c || t[15] !== d
      ? ((f = (0, X.jsxs)(W, { children: [c, d] })), (t[14] = c), (t[15] = d), (t[16] = f))
      : (f = t[16]),
    f
  );
}
function He(e) {
  ...
  let c;
  t[6] !== n || t[7] !== a
    ? ((c = () => a([...n, { key: ``, value: `` }])), (t[6] = n), (t[7] = a), (t[8] = c))
    : (c = t[8]);
  let l;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, X.jsx)(m, {
  ...
  return (
    t[13] !== s || t[14] !== u
      ? ((d = (0, X.jsxs)(W, { children: [s, u] })), (t[13] = s), (t[14] = u), (t[15] = d))
      : (d = t[15]),
    d
  );
}
var Ue = 50,
  We = `connector_76869538009648d5b282a4bb21c3d157`,
  Ge = `templated_apps_GitHubEnterprise`,
  Ke = { "OAI-Product-Sku": `CODEX` };
function qe(e) {
  return C.safeGet(`/wham/environments/with-creators`, {
    parameters: { query: { cursor: e ?? void 0, limit: Ue } },
  });
}
async function Je() {
  let e = [],
  ...
  do {
    let n = await qe(t);
    (e.push(...n.items), (t = n.cursor ?? null));
  } while (t != null);
  return e;
}
function Ye(e) {
  return C.safeGet(`/wham/environments/{environment_id}/with-creator-and-machine`, {
    parameters: { path: { environment_id: e } },
  });
}
function Xe() {
  return C.safeGet(`/wham/machines`);
}
async function Ze() {
  let { connectors: e } = await C.safeGet(`/aip/connectors/product_specific`, {
      parameters: { query: { purpose: `hermes` } },
      additionalHeaders: Ke,
    }),
    t = e
      .filter((e) => e.status !== `DISABLED_BY_ADMIN` && (e.id === We || e.template_id === Ge))
      .sort((e, t) => (e.id === We ? -1 : t.id === We ? 1 : e.name.localeCompare(t.name))),
    n = await Promise.all(
      t.map((e) =>
        C.safeGet(`/aip/connectors/{connector_id}/link`, {
...
function Qe(e, t) {
  return C.safeGet(`/wham/github/repositories/search/all-installations`, {
    parameters: { query: { query: e, limit: 20, connector_id: t } },
  });
}
function $e(e) {
  return C.safePost(`/wham/environments`, { requestBody: e });
}
function et({ environmentId: e, requestBody: t }) {
  return C.safePatch(`/wham/environments/{environment_id}`, {
    parameters: { path: { environment_id: e } },
    requestBody: t,
  });
}
function tt(e) {
  return C.safeDelete(`/wham/environments/{environment_id}`, {
    parameters: { path: { environment_id: e } },
  });
}
function nt(e) {
  return C.safePost(`/wham/environments/{environment_id}/reset-cache`, {
    parameters: { path: { environment_id: e } },
  });
}
function rt({ environmentId: e, etag: t, isPinned: n }) {
  return et({ environmentId: e, requestBody: { etag: t, is_pinned: n } });
}
var it = a(l, () => ({
    queryKey: [`cloud-environments`],
    queryFn: Je,
    refetchOnMount: !0,
    retry: !1,
  ...
  ct = i(l, ({ scope: e }) => ({ mutationFn: $e, onSuccess: () => pt(e) })),
  lt = i(l, ({ scope: e }) => ({
    mutationFn: (e) => et(e),
    onSuccess: async (t, { environmentId: n }) => {
      await Promise.all([pt(e), e.query.invalidate(Q, n, { exact: !0 })]);
    },
  })),
  ut = i(l, ({ scope: e }) => ({
    mutationFn: tt,
    onSuccess: async (t, n) => {
      (e.queryClient.removeQueries({ queryKey: e.query.getOptions(Q, n).queryKey }), await pt(e));
    },
  })),
  dt = i(l, ({ scope: e }) => ({
    mutationFn: (e) => nt(e),
    onSuccess: (t, n) => e.query.invalidate(Q, n, { exact: !0 }),
  })),
  ft = i(l, ({ scope: e }) => ({
    mutationFn: (e) => rt(e),
    onSuccess: async (t, { environmentId: n }) => {
...
function mt(e) {
  let t = (0, Y.c)(24),
    { form: n, isPending: i, preferredConnectorId: a } = e,
    o = p(),
    [s, l] = (0, le.useState)(``),
    u;
  t[0] === s ? (u = t[1]) : ((u = s.trim()), (t[0] = s), (t[1] = u));
  let d = M(u, 200),
    [f, h] = (0, le.useState)(null),
    g = c(ot),
    y;
  t[2] !== g.data || t[3] !== a || t[4] !== f
    ? ((y = g.data?.find((e) => e.id === (f ?? a))?.id ?? g.data?.[0]?.id ?? null),
      (t[2] = g.data),
      (t[3] = a),
      (t[4] = f),
      (t[5] = y))
  ...
  let b = y,
    x;
  t[6] !== b || t[7] !== d
    ? ((x = { connectorId: b, query: d }), (t[6] = b), (t[7] = d), (t[8] = x))
    : (x = t[8]);
  let S = r(st, x),
    C;
  t[9] === s ? (C = t[10]) : ((C = s.trim()), (t[9] = s), (t[10] = C));
  let E = d !== C,
    D;
  t[11] !== b ||
  t[12] !== g ||
        ...
        return (0, X.jsxs)(T, {
          ...
          children: [
            ...
            b == null
              ...
              : (0, X.jsxs)(X.Fragment, {
                  children: [
                    (0, X.jsx)(w.SearchInput, {
                      "aria-label": o.formatMessage(gt.repositorySearch),
                      autoFocus: !0,
                      placeholder: o.formatMessage(gt.repositorySearch),
                      trailingContent:
                        S.isFetching || E ? (0, X.jsx)(_, { className: `icon-2xs` }) : void 0,
                      value: s,
                                  ...
                                  w.Item,
                                  {
                                    onSelect: () => {
                                      (n.setFieldValue(`repositoryId`, e.id),
                                        ...
                                        n.setFieldValue(`githubConnectorId`, Ae(e.id) ?? b));
                                    },
  ...
  let O;
  return (
    t[21] !== n.Subscribe || t[22] !== D
      ? ((O = (0, X.jsx)(n.Subscribe, { selector: ht, children: D })),
        (t[21] = n.Subscribe),
        (t[22] = D),
        (t[23] = O))
      : (O = t[23]),
...
function _t(e) {
  ...
  if (n == null) {
    ...
    return (
      t[0] !== r || t[1] !== i
        ? ((e = (0, X.jsx)(vt, { onCancel: r, onSaved: i })), (t[0] = r), (t[1] = i), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
...
function vt(e) {
  let t = (0, Y.c)(4),
    ...
    i = ce().data?.preferred_github_connector_id ?? null,
    a;
  return (
    t[0] !== n || t[1] !== r || t[2] !== i
      ? ((a = (0, X.jsx)(yt, {
...
function yt(e) {
  let t = (0, Y.c)(35),
    ...
    y = S(`2664309699`),
    x;
  t[0] === d ? (x = t[1]) : ((x = P(d) || te(d)), (t[0] = d), (t[1] = x));
  let C = x,
    E = n ?? void 0,
    D;
  t[2] !== a || t[3] !== E ? ((D = Ee(E, a)), (t[2] = a), (t[3] = E), (t[4] = D)) : (D = t[4]);
  let O;
  t[5] !== h ||
  t[6] !== n ||
  t[7] !== u ||
  ...
  t[11] !== _
    ? ((O = (e) => {
        let { value: t } = e;
        if (Oe(t, f.data?.some((e) => e.id === t.machineId) === !0, n?.machine_id)) {
          if (n == null) {
            h.mutate(ke(t), {
              onSuccess: (e) => {
                (s
          ...
          _.mutate(
            { environmentId: n.id, requestBody: je(t, n) },
            {
              onSuccess: () => {
                (s
                  .get(b)
  ...
  let k;
  t[13] !== D || t[14] !== O
    ? ((k = { defaultValues: D, onSubmit: O }), (t[13] = D), (t[14] = O), (t[15] = k))
    : (k = t[15]);
  let A = q(k),
    j = h.isPending || _.isPending,
    M;
  t[16] === A
    ? (M = t[17])
    : ((M = (e) => {
    ...
    ? ((N = (e) => {
        ...
        return (0, X.jsxs)(X.Fragment, {
          children: [
                ...
                children: (0, X.jsxs)(W, {
                  children: [
                    ...
                    (0, X.jsx)(H, {
                      ...
                      control:
                        n == null
                          ? (0, X.jsx)(mt, { form: A, isPending: j, preferredConnectorId: a })
                          : (0, X.jsx)(Z, {
                              "aria-label": u.formatMessage({
                          ...
                          control: f.isError
                            ? (0, X.jsxs)(`div`, {
                                ...
                                children: [
                                  o == null
                                    ? null
                                    : (0, X.jsx)(B, { disabled: !0, children: o.label }),
                                  (0, X.jsx)(g, {
                                    color: `secondary`,
            ...
            (0, X.jsx)(_e, { form: A, isPending: j }),
            (0, X.jsx)(ze, { form: A, isPending: j }),
            (0, X.jsx)(ve, { form: A, isPending: j }),
            (0, X.jsx)(be, { form: A, isPending: j, showAuthtranslator: v, showDockerInDocker: y }),
            C ? (0, X.jsx)(Se, { form: A, isPending: j }) : null,
            (0, X.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, X.jsx)(g, {
                  color: `primary`,
                  disabled: !Oe(e, i != null, n?.machine_id),
                  loading: j,
                  type: `submit`,
                  children:
                    n == null
  ...
  t[29] !== A.Subscribe || t[30] !== N
    ? ((F = (0, X.jsx)(A.Subscribe, { selector: bt, children: N })),
      (t[29] = A.Subscribe),
      (t[30] = N),
      (t[31] = F))
    : (F = t[31]);
...
function xt(e) {
  ...
  if (h.isError) {
    ...
    t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[1]);
    let n;
    t[2] === h ? (n = t[3]) : ((n = () => void h.refetch()), (t[2] = h), (t[3] = n));
    let r;
    t[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, X.jsx)(m, {
      ...
      t[5] === n
        ...
        : ((i = (0, X.jsx)(W, {
            children: (0, X.jsxs)(`div`, {
              ...
              children: [
                e,
                (0, X.jsx)(g, { color: `secondary`, onClick: n, size: `toolbar`, children: r }),
              ],
            }),
          })),
          (t[5] = n),
  ...
  let y = h.data,
    x = y.filter((e) => e.label.toLocaleLowerCase().includes(f)).sort(Ct),
    S;
  t[7] !== y.length || t[8] !== a || t[9] !== u
    ? ((S =
        y.length > 0
          ? (0, X.jsx)(J, {
  ...
  let C = W,
      ...
      x.length === 0
        ...
        : x.map((e) =>
            (0, X.jsx)(
              ...
              {
                environment: e,
                isPinning: v.isPending && v.variables?.environmentId === e.id,
                onEdit: () => n(e.id),
                onSelect: () => r(e.id),
                onTogglePin: () => {
                  v.mutate(
    ...
    T;
  t[11] !== C || t[12] !== w
    ? ((T = (0, X.jsx)(C, { children: w })), (t[11] = C), (t[12] = w), (t[13] = T))
    : (T = t[13]);
  let E;
  return (
    t[14] !== S || t[15] !== T
      ? ((E = (0, X.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [S, T] })),
        (t[14] = S),
        (t[15] = T),
        (t[16] = E))
      : (E = t[16]),
...
function St(e) {
  let t = (0, Y.c)(44),
    ...
    u;
  t[0] !== n.creator || t[1] !== s
    ? ((u = s != null && n.creator.id.includes(s)), (t[0] = n.creator), (t[1] = s), (t[2] = u))
    : (u = t[2]);
  let d = u,
    f = l && d,
    h;
  ...
  t[11] === n.is_pinned
    ...
    : ((b = n.is_pinned
        ...
        : (0, X.jsx)(ie, { className: `icon-xs` })),
      (t[11] = n.is_pinned),
      (t[12] = b));
  let x;
  t[13] !== r || t[14] !== o || t[15] !== h || t[16] !== v || t[17] !== b
    ? ((x = (0, X.jsx)(g, {
        "aria-label": h,
        color: `ghost`,
        disabled: v,
  ...
  let S;
  t[19] !== _ || t[20] !== x
    ? ((S = (0, X.jsx)(`span`, { className: _, children: x })),
      (t[19] = _),
      (t[20] = x),
      (t[21] = S))
    : (S = t[21]);
  let C;
  t[22] !== h || t[23] !== S
    ? ((C = (0, X.jsx)(y, { tooltipContent: h, children: S })),
      (t[22] = h),
      (t[23] = S),
      (t[24] = C))
    : (C = t[24]);
  let E;
  t[25] !== l || t[26] !== c || t[27] !== i
    ? ((E = l
        ? (0, X.jsx)(`div`, {
  ...
  let D;
  t[29] !== C || t[30] !== E
    ? ((D = (0, X.jsxs)(X.Fragment, { children: [C, E] })), (t[29] = C), (t[30] = E), (t[31] = D))
    : (D = t[31]);
  let O;
  t[32] !== n.label || t[33] !== c
    ? ((O = c.formatMessage(
  ...
  let A;
  return (
    t[38] !== n.label || t[39] !== a || t[40] !== O || t[41] !== k || t[42] !== D
      ? ((A = (0, X.jsx)(U, {
          actions: D,
          ariaLabel: O,
          description: k,
...
function Ct(e, t) {
  return !!e.is_pinned == !!t.is_pinned ? e.label.localeCompare(t.label) : e.is_pinned ? -1 : 1;
}
var $ = `/settings/cloud-environments`;
function wt() {
  let e = (0, Y.c)(41),
    t = L(),
    n = R(),
  ...
  e[2] === t.pathname
    ? (a = e[3])
    : ((a = t.pathname.slice(28).split(`/`).filter(Tt)), (e[2] = t.pathname), (e[3] = a));
  let o = a,
  ...
  if (o.length === 0) {
    ...
    e[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, X.jsx)(ae, { slug: `cloud-environments` })), (e[4] = t))
      : (t = e[4]);
    let n;
    ...
    e[8] === n
      ? (a = e[9])
      : ((a = (0, X.jsx)(g, { color: `primary`, onClick: n, children: r })),
        (e[8] = n),
        (e[9] = a));
    let o;
    e[10] === i
    ...
    return (
      e[12] !== a || e[13] !== o
        ? ((s = (0, X.jsx)(V, { title: t, action: a, children: o })),
          (e[12] = a),
          (e[13] = o),
          (e[14] = s))
        : (s = e[14]),
  ...
  if (s) {
    ...
    e[15] === i
      ? (t = e[16])
      : ((t = (0, X.jsx)(Ot, { onClick: () => i($) })), (e[15] = i), (e[16] = t));
    let n;
    ...
    return (
      e[20] !== t || e[21] !== r
        ? ((a = (0, X.jsx)(V, { backSlot: t, title: n, children: r })),
          (e[20] = t),
          (e[21] = r),
          (e[22] = a))
        : (a = e[22]),
  ...
  if (c != null && l) {
    ...
    return (
      e[26] !== c || e[27] !== t
        ? ((n = (0, X.jsx)(Dt, { environmentId: c, onBack: t })),
          (e[26] = c),
          (e[27] = t),
          (e[28] = n))
        : (n = e[28]),
  ...
  if (c != null && u) {
    ...
    return (
      e[35] !== c || e[36] !== t || e[37] !== n || e[38] !== r
        ? ((a = (0, X.jsx)(Et, { environmentId: c, onBack: t, onDeleted: n, onEdit: r })),
          (e[35] = c),
          (e[36] = t),
          (e[37] = n),
          (e[38] = r),
  ...
  return (
    e[40] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((d = (0, X.jsx)(I, { to: $, replace: !0 })), (e[40] = d))
      : (d = e[40]),
    d
  );
}
...
function Et(e) {
  let t = (0, Y.c)(64),
    { environmentId: n, onBack: i, onDeleted: a, onEdit: s } = e,
    u = o(l),
    d = p(),
    { userId: f } = ee(),
    h = r(Q, n),
    ...
    S = c(dt),
    C = c(ft),
    [E, D] = (0, le.useState)(null);
  if (h.isPending || h.isError) {
    let e;
    t[0] === i ? (e = t[1]) : ((e = (0, X.jsx)(Ot, { onClick: i })), (t[0] = i), (t[1] = e));
    let n;
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, X.jsx)(m, {
    ...
    return (
      t[5] !== e || t[6] !== r
        ? ((a = (0, X.jsx)(V, { backSlot: e, title: n, children: r })),
          (t[5] = e),
          (t[6] = r),
          (t[7] = a))
        : (a = t[7]),
  ...
  let O = h.data,
    k = O.permissions?.can_write === !0,
    A = O.permissions?.can_delete === !0,
    j;
  t[8] !== O.creator || t[9] !== f
    ? ((j = f != null && O.creator.id.includes(f)), (t[8] = O.creator), (t[9] = f), (t[10] = j))
    : (j = t[10]);
  let M = k && j,
    N = k && (O.cache_settings?.post_setup_cache_enabled ?? !0),
    P;
  t[11] !== O.is_pinned || t[12] !== d
    ? ((P = O.is_pinned
        ? d.formatMessage({
  ...
  t[28] !== C
                ...
                M
                  ? (0, X.jsx)(y, {
                      ...
                      children: (0, X.jsx)(g, {
                        ...
                        onClick: () => {
                          C.mutate(
                            { environmentId: O.id, etag: O.etag, isPinned: !O.is_pinned },
                            {
                              onError: () => {
                                u.get(b).danger(
                                  d.formatMessage({
    ...
    : (R = t[29]);
  let z;
  t[30] === i ? (z = t[31]) : ((z = (0, X.jsx)(Ot, { onClick: i })), (t[30] = i), (t[31] = z));
  let ae = O.description || void 0,
    B;
  t[32] === O ? (B = t[33]) : ((B = (0, X.jsx)(ue, { environment: O })), (t[32] = O), (t[33] = B));
  let H = E === `delete`,
    U;
  t[34] !== v || t[35] !== O.id || t[36] !== d || t[37] !== a || t[38] !== u
    ? ((U = () => {
        v.mutate(O.id, {
          onSuccess: () => {
            (u
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (e) => D(e ? `delete` : null)), (t[40] = G))
    : (G = t[40]);
  let K;
  t[41] !== v.isPending || t[42] !== O.label || t[43] !== H || t[44] !== U
    ? ((K = (0, X.jsx)(me, {
        environmentName: O.label,
      ...
      (t[45] = K))
    : (K = t[45]);
  let se = E === `reset-cache`,
    q;
  t[46] !== O.id || t[47] !== d || t[48] !== S || t[49] !== u
    ? ((q = () => {
        S.mutate(O.id, {
          onSuccess: () => {
            (D(null),
  ...
  t[51] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = (e) => D(e ? `reset-cache` : null)), (t[51] = ce))
    : (ce = t[51]);
  let J;
  t[52] !== S.isPending || t[53] !== se || t[54] !== q
    ? ((J = (0, X.jsx)(he, { isPending: S.isPending, open: se, onConfirm: q, onOpenChange: ce })),
      (t[52] = S.isPending),
      (t[53] = se),
      (t[54] = q),
      (t[55] = J))
...
function Dt(e) {
  ...
  if (a.isError) {
    ...
    return (
      t[0] === e
        ? (r = t[1])
        : ((r = (0, X.jsx)(I, { to: e, replace: !0 })), (t[0] = e), (t[1] = r)),
      r
    );
  }
  if (a.isPending) {
    let e;
    t[2] === i ? (e = t[3]) : ((e = (0, X.jsx)(Ot, { onClick: i })), (t[2] = i), (t[3] = e));
    let n;
    t[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, X.jsx)(m, {
    ...
    return (
      t[6] === e
        ? (a = t[7])
        : ((a = (0, X.jsx)(V, { backSlot: e, title: n, children: r })), (t[6] = e), (t[7] = a)),
      a
    );
  }
  if (a.data.permissions?.can_write !== !0) {
    ...
    return (
      t[8] === e
        ? (r = t[9])
        : ((r = (0, X.jsx)(I, { to: e, replace: !0 })), (t[8] = e), (t[9] = r)),
      r
    );
  }
  let o;
  t[10] === i ? (o = t[11]) : ((o = (0, X.jsx)(Ot, { onClick: i })), (t[10] = i), (t[11] = o));
  let s;
  ...
  let c;
  t[13] !== a.data || t[14] !== i
    ? ((c = (0, X.jsx)(_t, { environment: a.data, onCancel: i, onSaved: i }, a.data.id)),
      (t[13] = a.data),
      (t[14] = i),
      (t[15] = c))
    : (c = t[15]);
  ...
  return (
    t[16] !== o || t[17] !== c
      ? ((l = (0, X.jsx)(V, { backSlot: o, title: s, children: c })),
        (t[16] = o),
        (t[17] = c),
        (t[18] = l))
      : (l = t[18]),
...
function Ot(e) {
  ...
  return (
    t[2] === n
      ? (a = t[3])
      : ((a = (0, X.jsxs)(g, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
        (t[2] = n),
        (t[3] = a)),
    a
  );
}
export { wt as CloudEnvironmentsSettingsPage };
