...
`)
  ...
  if (t[6] !== n || t[7] !== c || t[8] !== o || t[9] !== i) {
    ...
    t[18] === n.machine.label
      ? (g = t[19])
      : ((g = (0, W.jsx)(V, { label: h, valueAlignment: `end`, children: n.machine.label })),
        (t[18] = n.machine.label),
        (t[19] = g));
    let _;
...
function lt(e) {
  ...
  t[14] === r
    ? (h = t[15])
    : ((h = (0, G.jsx)(j, { color: `danger`, loading: r, type: `submit`, children: m })),
      (t[14] = r),
      (t[15] = h));
  let g;
  t[16] !== p || t[17] !== h
    ? ((g = (0, G.jsxs)(ce, { children: [p, h] })), (t[16] = p), (t[17] = h), (t[18] = g))
    : (g = t[18]);
  let _;
...
function ut(e) {
  ...
  t[11] === n
    ? (p = t[12])
    : ((p = (0, G.jsx)(j, { color: `primary`, loading: n, type: `submit`, children: f })),
      (t[11] = n),
      (t[12] = p));
  let m;
  t[13] !== d || t[14] !== p
    ? ((m = (0, G.jsxs)(ce, { children: [d, p] })), (t[13] = d), (t[14] = p), (t[15] = m))
    : (m = t[15]);
  let h;
  t[16] !== o || t[17] !== m
...
var fn,
  ...
  xn = e(() => {
    (n(),
      ...
      (gn = l(i, ({ scope: e }) => ({ mutationFn: en, onSuccess: () => dn(e) }))),
      (_n = l(i, ({ scope: e }) => ({
        mutationFn: (e) => tn(e),
              ...
              : (0, Y.jsxs)(Y.Fragment, {
                  children: [
                    (0, Y.jsx)(F.SearchInput, {
                      ...
                      trailingContent:
                        v.isFetching || b ? (0, Y.jsx)(S, { className: `icon-2xs` }) : void 0,
                      value: s,
...
function An(e) {
  ...
  let v = g,
    y = n ?? void 0,
    x;
  t[2] !== o || t[3] !== y ? ((x = Et(y, o)), (t[2] = o), (t[3] = y), (t[4] = x)) : (x = t[4]);
  let S;
  t[5] !== f ||
  t[6] !== n ||
  t[7] !== l ||
  ...
  let C;
  t[13] !== x || t[14] !== S
    ? ((C = { defaultValues: x, onSubmit: S }), (t[13] = x), (t[14] = S), (t[15] = C))
    : (C = t[15]);
  let w = $e(C),
    ...
    ? ((O = (e) => {
        ...
        return (0, X.jsxs)(X.Fragment, {
          children: [
                ...
                children: (0, X.jsxs)(U, {
                  children: [
                    ...
                    (0, X.jsx)(B, {
                      ...
                      control:
                        n == null
                          ? (0, X.jsx)(Sn, { form: w, isPending: T, preferredConnectorId: o })
                          : (0, X.jsx)(K, {
                              "aria-label": l.formatMessage({
                          ...
                          control: d.isError
                            ? (0, X.jsxs)(`div`, {
                                ...
                                children: [
                                  a == null
                                    ? null
                                    : (0, X.jsx)(Fe, { disabled: !0, children: a.label }),
                                  (0, X.jsx)(j, {
                                    color: `secondary`,
            ...
            (0, X.jsx)(bt, { form: w, isPending: T, showAuthtranslator: m, showDockerInDocker: h }),
...
function Hn(e) {
  ...
  let y = f.data,
    ...
    C;
  t[8] !== y.creator || t[9] !== d
    ? ((C = d != null && y.creator.id.includes(d)), (t[8] = y.creator), (t[9] = d), (t[10] = C))
    : (C = t[10]);
  let w = b && C,
  ...
  t[28] !== h
    ...
    : (M = t[29]);
  let ee;
  t[30] === r ? (ee = t[31]) : ((ee = (0, Q.jsx)(Wn, { onClick: r })), (t[30] = r), (t[31] = ee));
  ...
  t[52] !== m.isPending || t[53] !== se || t[54] !== I
    ? ((le = (0, Q.jsx)(ut, { isPending: m.isPending, open: se, onConfirm: I, onOpenChange: ce })),
      (t[52] = m.isPending),
      (t[53] = se),
      (t[54] = I),
      (t[55] = le))
...
function Un(e) {
  ...
  if (i.isPending) {
    ...
    return (
      t[6] === e
        ? (a = t[7])
        : ((a = (0, Q.jsx)(We, { backSlot: e, title: n, children: i })), (t[6] = e), (t[7] = a)),
      a
    );
  }
  ...
  let c;
  t[13] !== i.data || t[14] !== r
    ? ((c = (0, Q.jsx)(On, { environment: i.data, onCancel: r, onSaved: r }, i.data.id)),
      (t[13] = i.data),
      (t[14] = r),
      (t[15] = c))
    : (c = t[15]);
...
function Wn(e) {
  ...
  return (
    t[2] === n
      ? (a = t[3])
      : ((a = (0, Q.jsxs)(j, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
        (t[2] = n),
        (t[3] = a)),
    a
  );
