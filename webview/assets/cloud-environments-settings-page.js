...
import { Aa as d } from "./thread-context-inputs.js";
import { u as f } from "./vscode-api.js";
import "./isEqual.js";
import "./src-1.js";
import "./react-dom.js";
import { i as p, l as m, s as h, t as g } from "./lib-1.js";
import "./proxy.js";
...
import { t as S } from "./regenerate.js";
import "./x.js";
import "./rpc-1.js";
...
import { a as T, f as E, m as D } from "./chunk-13.js";
...
import { t as k } from "./use-debounced-value.js";
import { i as A, r as j } from "./skus.js";
import { t as M } from "./arrow-left.js";
import "./with-window.js";
import { t as N } from "./pencil.js";
import { d as P, i as F, l as I, n as ee, r as L, u as R } from "./dialog-layout.js";
import "./links.js";
import "./x-circle.js";
import { r as z, t as te } from "./dropdown.js";
import "./three-dots.js";
import { t as ne } from "./pin-filled.js";
import { t as re } from "./pin.js";
import { t as ie } from "./trash-DL-ar7Ww.js";
import { t as B } from "./toggle.js";
import { i as V, t as H } from "./settings-shared.js";
import { t as ae } from "./settings-content-layout.js";
import { t as oe } from "./more-menu-trigger.js";
import { n as U, r as W, t as G } from "./settings-row.js";
import { t as K } from "./settings-surface.js";
import { t as q } from "./settings-group.js";
import { t as J } from "./infinite-scroll-pagination-spinner.js";
import { t as se } from "./page-search-input.js";
import { t as Y } from "./segmented-toggle-BJ-T19lF.js";
import { t as ce } from "./settings-empty-state.js";
import { t as le } from "./useForm.js";
import { i as ue } from "./cloud-preferences.js";
function de(e) {
  return e;
}
var fe = e(t(), 1),
...
`)
  ...
  if (t[6] !== n || t[7] !== c || t[8] !== o || t[9] !== i) {
    ...
    t[15] === p
      ? (m = t[16])
      : ((m = (0, Z.jsx)(U, { label: f, valueAlignment: `end`, children: p })),
        (t[15] = p),
        (t[16] = m));
    let _;
    ...
    t[18] === n.machine.label
      ? (v = t[19])
      : ((v = (0, Z.jsx)(U, { label: _, valueAlignment: `end`, children: n.machine.label })),
        (t[18] = n.machine.label),
        (t[19] = v));
    let y;
    ...
    t[21] === b
      ? (x = t[22])
      : ((x = (0, Z.jsx)(U, { label: y, valueAlignment: `end`, children: b })),
        (t[21] = b),
        (t[22] = x));
    let S;
    t[23] === n.created_at
    ...
    let w = n.agent_network_access?.mode,
      T;
    t[26] === w ? (T = t[27]) : ((T = me(w)), (t[26] = w), (t[27] = T));
    let E;
    t[28] === T
      ? (E = t[29])
      : ((E = (0, Z.jsx)(U, { label: C, valueAlignment: `end`, children: T })),
        (t[28] = T),
        (t[29] = E));
    let D;
    ...
    t[31] === n.share_settings
      ? (O = t[32])
      : ((O = he(n.share_settings)), (t[31] = n.share_settings), (t[32] = O));
    let k;
    t[33] === O
      ? (k = t[34])
      : ((k = (0, Z.jsx)(U, { label: D, valueAlignment: `end`, children: O })),
        (t[33] = O),
        (t[34] = k));
    let A;
    (t[35] !== v || t[36] !== x || t[37] !== S || t[38] !== E || t[39] !== k || t[40] !== m
      ? ((A = (0, Z.jsx)(q, {
          children: (0, Z.jsx)(q.Content, {
            children: (0, Z.jsxs)(K, { children: [m, v, x, S, E, k] }),
          }),
        })),
        (t[35] = v),
        (t[36] = x),
...
function _e(e) {
  ...
  t[5] === c
    ? (u = t[6])
    : ((u = (0, Z.jsx)(F, { title: c, subtitle: l })), (t[5] = c), (t[6] = u));
  let d;
  ...
  t[14] === r
    ? (g = t[15])
    : ((g = (0, Z.jsx)(_, { color: `danger`, loading: r, type: `submit`, children: m })),
      (t[14] = r),
      (t[15] = g));
  let v;
  t[16] !== p || t[17] !== g
    ? ((v = (0, Z.jsxs)(L, { children: [p, g] })), (t[16] = p), (t[17] = g), (t[18] = v))
    : (v = t[18]);
  let y;
  t[19] !== s || t[20] !== v || t[21] !== u
    ? ((y = (0, Z.jsxs)(ee, { as: `form`, onSubmit: s, children: [u, v] })),
      (t[19] = s),
      (t[20] = v),
      (t[21] = u),
      (t[22] = y))
  ...
  return (
    t[23] !== o || t[24] !== i || t[25] !== y
      ? ((b = (0, Z.jsx)(I, { open: i, onOpenChange: o, children: y })),
        (t[23] = o),
        (t[24] = i),
        (t[25] = y),
        (t[26] = b))
...
function ve(e) {
  ...
  t[11] === n
    ? (p = t[12])
    : ((p = (0, Z.jsx)(_, { color: `primary`, loading: n, type: `submit`, children: f })),
      (t[11] = n),
      (t[12] = p));
  let m;
  t[13] !== d || t[14] !== p
    ? ((m = (0, Z.jsxs)(L, { children: [d, p] })), (t[13] = d), (t[14] = p), (t[15] = m))
    : (m = t[15]);
  let g;
  t[16] !== o || t[17] !== m
    ? ((g = (0, Z.jsxs)(ee, { as: `form`, onSubmit: o, children: [c, m] })),
      (t[16] = o),
      (t[17] = m),
      (t[18] = g))
    : (g = t[18]);
  let v;
  return (
    t[19] !== a || t[20] !== r || t[21] !== g
      ? ((v = (0, Z.jsx)(I, { open: r, onOpenChange: a, children: g })),
        (t[19] = a),
        (t[20] = r),
        (t[21] = g),
        (t[22] = v))
...
function be(e) {
  ...
  let s;
  t[4] !== n.Field || t[5] !== o
    ? ((s = (0, Z.jsx)(n.Field, { name: `setupCommands`, children: o })),
      (t[4] = n.Field),
      (t[5] = o),
      (t[6] = s))
    : (s = t[6]);
  ...
  let l;
  t[10] !== n.Field || t[11] !== c
    ? ((l = (0, Z.jsx)(n.Field, { name: `maintenanceSetupCommands`, children: c })),
      (t[10] = n.Field),
      (t[11] = c),
      (t[12] = l))
    : (l = t[12]);
  ...
  return (
    t[13] !== s || t[14] !== l
      ? ((u = (0, Z.jsxs)(q, {
          children: [a, (0, Z.jsx)(q.Content, { children: (0, Z.jsxs)(K, { children: [s, l] }) })],
        })),
        (t[13] = s),
        (t[14] = l),
        (t[15] = u))
...
function xe(e) {
  ...
  return (
    t[4] !== n.Subscribe || t[5] !== a
      ? ((o = (0, Z.jsx)(n.Subscribe, { selector: Se, children: a })),
        (t[4] = n.Subscribe),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
...
function Ce(e) {
  ...
  return (
    t[6] !== n.Subscribe || t[7] !== s
      ? ((c = (0, Z.jsx)(n.Subscribe, { selector: we, children: s })),
        (t[6] = n.Subscribe),
        (t[7] = s),
        (t[8] = c))
      : (c = t[8]),
...
function Te(e) {
  ...
  return (
    t[4] !== n.Subscribe || t[5] !== a
      ? ((o = (0, Z.jsx)(n.Subscribe, { selector: Ee, children: a })),
        (t[4] = n.Subscribe),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
...
function ke(e, t) {
  ...
  return {
    ...
    setupCommands: Fe(e?.setup),
    maintenanceSetupCommands: Fe(e?.maintenance_setup),
  ...
  n.some(({ key: e }) => e === ``)
    ...
    : new Set(n.map(({ identity: e }) => e)).size === n.length
      ? e.secrets.some(({ value: e }) => e.trim() === ``)
        ...
        : e.secrets.some(Ve) && (t.secrets = `global-rename-value-required`)
...
function je(e, t, n) {
  return (t || e.machineId === n) && Object.keys(Ae(e)).length === 0;
}
function Me(e) {
  return {
    label: e.label.trim(),
...
function Pe(e, t) {
  return {
    ...
    secrets_with_domains: Re(e.secrets, Le(t)),
    share_settings: e.shareSettings,
    share_targets: Ie(e),
    auto_setup_settings: e.autoSetupSettings,
    cache_settings: e.cacheSettings,
...
function Re(e, t) {
  ...
  for (let t of e) {
    ...
    if (t.previousDomain === void 0) {
      t.value !== `` && (n.add(ze(e, i)), r.push({ name: e, domain: i, value: t.value }));
      continue;
    }
    let a = t.previousKey ?? t.key,
      o = Be(t.previousDomain);
    n.add(ze(a, o));
    let s = a !== e,
      c = o !== i,
      l = t.value !== De;
    ...
    t[4] !== n.Subscribe || t[5] !== a
      ? ((o = (0, Z.jsxs)(q, {
          children: [
            i,
            (0, Z.jsx)(q.Content, {
              children: (0, Z.jsx)(n.Subscribe, { selector: Ue, children: a }),
            }),
          ],
        })),
        (t[4] = n.Subscribe),
...
function We(e) {
  ...
  let d;
  t[7] !== r || t[8] !== a || t[9] !== u
    ? ((d = (0, Z.jsx)(W, { description: r, label: a, control: u })),
      (t[7] = r),
      (t[8] = a),
      (t[9] = u),
      (t[10] = d))
  ...
  return (
    t[16] !== d || t[17] !== f
      ? ((p = (0, Z.jsxs)(K, { children: [d, f] })), (t[16] = d), (t[17] = f), (t[18] = p))
      : (p = t[18]),
    p
  );
}
function Ge(e) {
  ...
  let d;
  t[8] !== r || t[9] !== u
    ? ((d = (0, Z.jsx)(W, { description: r, label: s, control: u })),
      (t[8] = r),
      (t[9] = u),
      (t[10] = d))
    : (d = t[10]);
...
var Ke = `connector_76869538009648d5b282a4bb21c3d157`,
  qe = `templated_apps_GitHubEnterprise`,
  Je = { "OAI-Product-Sku": `CODEX` };
function Ye(e, t, n) {
  return w.safeGet(`/wham/environments/search`, {
...
function Ze(e) {
  return w.safeGet(`/wham/environments/{environment_id}/with-creator-and-machine`, {
    parameters: { path: { environment_id: e } },
  });
}
function Qe() {
  return w.safeGet(`/wham/machines`);
}
async function $e() {
  let { connectors: e } = await w.safeGet(`/aip/connectors/product_specific`, {
      parameters: { query: { purpose: `hermes` } },
      additionalHeaders: Je,
    }),
    t = e
      .filter((e) => e.status !== `DISABLED_BY_ADMIN` && (e.id === Ke || e.template_id === qe))
      .sort((e, t) => (e.id === Ke ? -1 : t.id === Ke ? 1 : e.name.localeCompare(t.name))),
    n = await Promise.all(
      t.map((e) =>
        w.safeGet(`/aip/connectors/{connector_id}/link`, {
...
function et(e, t) {
  return w.safeGet(`/wham/github/repositories/search/all-installations`, {
    parameters: { query: { query: e, limit: 20, connector_id: t } },
  });
}
function tt(e) {
  return w.safePost(`/wham/environments`, { requestBody: e });
}
function nt({ environmentId: e, requestBody: t }) {
  return w.safePatch(`/wham/environments/{environment_id}`, {
    parameters: { path: { environment_id: e } },
    requestBody: t,
  });
}
function rt(e) {
  return w.safeDelete(`/wham/environments/{environment_id}`, {
    parameters: { path: { environment_id: e } },
  });
}
function it(e) {
  return w.safePost(`/wham/environments/{environment_id}/reset-cache`, {
    parameters: { path: { environment_id: e } },
  });
}
function at({ environmentId: e, etag: t, isPinned: n }) {
  return nt({ environmentId: e, requestBody: { etag: t, is_pinned: n } });
}
function ot(e) {
  return de({
    queryKey: [`cloud-environments`, `search`, e],
    queryFn: ({ pageParam: t }) => Ye(e, t, t == null ? 25 : 100),
...
var st = c(u, (e) => ({
  ...
  dt = a(u, ({ scope: e }) => ({ mutationFn: tt, onSuccess: () => gt(e) })),
  ft = a(u, ({ scope: e }) => ({
    mutationFn: (e) => nt(e),
    onSuccess: async (t, { environmentId: n }) => {
      await Promise.all([gt(e), e.query.invalidate(st, n, { exact: !0 })]);
    },
  })),
  pt = a(u, ({ scope: e }) => ({
    mutationFn: rt,
    onSuccess: async (t, n) => {
      (e.queryClient.removeQueries({ queryKey: e.query.getOptions(st, n).queryKey }), await gt(e));
    },
  })),
  mt = a(u, ({ scope: e }) => ({
    mutationFn: (e) => it(e),
    onSuccess: (t, n) => e.query.invalidate(st, n, { exact: !0 }),
  })),
  ht = a(u, ({ scope: e }) => ({
    mutationFn: (e) => at(e),
    onSuccess: async (t, { environmentId: n }) => {
...
function _t(e) {
  ...
  let d = k(u, 200),
    [f, p] = (0, fe.useState)(null),
    g = l(lt),
    _;
  t[2] !== g.data || t[3] !== a || t[4] !== f
    ? ((_ = g.data?.find((e) => e.id === (f ?? a))?.id ?? g.data?.[0]?.id ?? null),
      (t[2] = g.data),
      (t[3] = a),
      (t[4] = f),
      (t[5] = _))
        ...
        return (0, Z.jsxs)(te, {
          ...
          children: [
            ...
            b == null
              ...
              : (0, Z.jsxs)(Z.Fragment, {
                  children: [
                    (0, Z.jsx)(z.SearchInput, {
                      "aria-label": o.formatMessage(yt.repositorySearch),
                      autoFocus: !0,
                      placeholder: o.formatMessage(yt.repositorySearch),
                      trailingContent:
                        S.isFetching || w ? (0, Z.jsx)(v, { className: `icon-2xs` }) : void 0,
                      value: s,
                                  ...
                                  z.Item,
                                  {
                                    onSelect: () => {
                                      (n.setFieldValue(`repositoryId`, e.id),
                                        ...
                                        n.setFieldValue(`githubConnectorId`, Ne(e.id) ?? b));
                                    },
  ...
  return (
    t[21] !== n.Subscribe || t[22] !== T
      ? ((E = (0, Z.jsx)(n.Subscribe, { selector: vt, children: T })),
        (t[21] = n.Subscribe),
        (t[22] = T),
        (t[23] = E))
      : (E = t[23]),
...
function bt(e) {
  ...
  if (n == null) {
    ...
    return (
      t[0] !== r || t[1] !== i
        ? ((e = (0, Z.jsx)(xt, { onCancel: r, onSaved: i })), (t[0] = r), (t[1] = i), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
...
function xt(e) {
  let t = (0, X.c)(4),
    ...
    i = ue().data?.preferred_github_connector_id ?? null,
    a;
  return (
    t[0] !== n || t[1] !== r || t[2] !== i
      ? ((a = (0, Z.jsx)(St, {
...
function St(e) {
  let t = (0, X.c)(35),
    ...
    y = C(`2664309699`),
    b;
  t[0] === d ? (b = t[1]) : ((b = A(d) || j(d)), (t[0] = d), (t[1] = b));
  let S = b,
    w = n ?? void 0,
    T;
  t[2] !== a || t[3] !== w ? ((T = ke(w, a)), (t[2] = a), (t[3] = w), (t[4] = T)) : (T = t[4]);
  let E;
  t[5] !== p ||
  t[6] !== n ||
  t[7] !== c ||
  ...
  t[11] !== g
    ? ((E = (e) => {
        let { value: t } = e;
        if (je(t, f.data?.some((e) => e.id === t.machineId) === !0, n?.machine_id)) {
          if (n == null) {
            p.mutate(Me(t), {
              onSuccess: (e) => {
                (o
          ...
          g.mutate(
            { environmentId: n.id, requestBody: Pe(t, n) },
            {
              onSuccess: () => {
                (o
                  .get(x)
  ...
  let D;
  t[13] !== T || t[14] !== E
    ? ((D = { defaultValues: T, onSubmit: E }), (t[13] = T), (t[14] = E), (t[15] = D))
    : (D = t[15]);
  let k = le(D),
    M = p.isPending || g.isPending,
    N;
  t[16] === k
    ? (N = t[17])
    : ((N = (e) => {
        (e.preventDefault(), k.handleSubmit());
      }),
      (t[16] = k),
      (t[17] = N));
  let P;
  ...
  t[27] !== S
    ? ((P = (e) => {
        ...
        return (0, Z.jsxs)(Z.Fragment, {
          children: [
                ...
                children: (0, Z.jsxs)(K, {
                  children: [
                    ...
                    (0, Z.jsx)(W, {
                      ...
                      control:
                        n == null
                          ? (0, Z.jsx)(_t, { form: k, isPending: M, preferredConnectorId: a })
                          : (0, Z.jsx)(Q, {
                              "aria-label": c.formatMessage({
                          ...
                          control: f.isError
                            ? (0, Z.jsxs)(`div`, {
                                ...
                                children: [
                                  o == null
                                    ? null
                                    : (0, Z.jsx)(H, { disabled: !0, children: o.label }),
                                  (0, Z.jsx)(_, {
                                    color: `secondary`,
            ...
            (0, Z.jsx)(be, { form: k, isPending: M }),
            (0, Z.jsx)(He, { form: k, isPending: M }),
            (0, Z.jsx)(xe, { form: k, isPending: M }),
            (0, Z.jsx)(Ce, { form: k, isPending: M, showAuthtranslator: v, showDockerInDocker: y }),
            S ? (0, Z.jsx)(Te, { form: k, isPending: M }) : null,
            (0, Z.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, Z.jsx)(_, {
                  color: `primary`,
                  disabled: !je(e, i != null, n?.machine_id),
                  loading: M,
                  type: `submit`,
                  children:
                    n == null
    ...
    : (P = t[28]);
  let F;
  t[29] !== k.Subscribe || t[30] !== P
    ? ((F = (0, Z.jsx)(k.Subscribe, { selector: Ct, children: P })),
      (t[29] = k.Subscribe),
      (t[30] = P),
      (t[31] = F))
    : (F = t[31]);
...
function wt(e) {
  let t = (0, X.c)(36),
    ...
    [c, f] = (0, fe.useState)(``),
    p;
  t[0] === c ? (p = t[1]) : ((p = c.trim()), (t[0] = c), (t[1] = p));
  let g = k(p, 200),
    y;
  t[2] === g ? (y = t[3]) : ((y = ot(g)), (t[2] = g), (t[3] = y));
  let {
      data: b,
      fetchNextPage: S,
      hasNextPage: C,
  ...
  if (
    ...
    let e = b?.pages.flatMap(Tt) ?? [],
      s = e.sort(Xe);
    ((j = `flex flex-col gap-3`),
      (M =
        e.length > 0 || c !== ``
          ? (0, Z.jsx)(se, {
                  ...
                  s.length === 0
                    ...
                    : s.map((e) =>
                        (0, Z.jsx)(
                          ...
                          {
                            environment: e,
                            isPinning: A.isPending && A.variables?.environmentId === e.id,
                            onEdit: () => n(e.id),
                            onSelect: () => r(e.id),
                            onTogglePin: () => {
                              A.mutate(
      ...
      (t[18] = M),
      (t[19] = N));
  } else ((j = t[17]), (M = t[18]), (N = t[19]));
  let P;
  t[20] !== b || t[21] !== S || t[22] !== C || t[23] !== w || t[24] !== T
    ? ((P =
        b == null
          ? null
          : (0, Z.jsx)(J, {
  ...
  let I;
  return (
    t[30] !== j || t[31] !== M || t[32] !== N || t[33] !== P || t[34] !== F
      ? ((I = (0, Z.jsxs)(`div`, { className: j, children: [M, N, P, F] })),
        (t[30] = j),
        (t[31] = M),
        (t[32] = N),
        (t[33] = P),
...
function Et(e) {
  ...
  t[15] === n.is_pinned
    ...
    : ((x = n.is_pinned
      ...
      (t[16] = x));
  let S;
  t[17] !== r || t[18] !== o || t[19] !== p || t[20] !== y || t[21] !== x
    ? ((S = (0, Z.jsx)(_, {
        "aria-label": p,
        color: `ghost`,
        disabled: y,
  ...
  let C;
  t[23] !== v || t[24] !== S
    ? ((C = (0, Z.jsx)(`span`, { className: v, children: S })),
      (t[23] = v),
      (t[24] = S),
      (t[25] = C))
    : (C = t[25]);
  let w;
  t[26] !== p || t[27] !== C
    ? ((w = (0, Z.jsx)(b, { tooltipContent: p, children: C })),
      (t[26] = p),
      (t[27] = C),
      (t[28] = w))
    : (w = t[28]);
  let T;
  t[29] !== g || t[30] !== w
    ? ((T = (0, Z.jsxs)(Z.Fragment, { children: [g, w] })), (t[29] = g), (t[30] = w), (t[31] = T))
    : (T = t[31]);
  let E;
  t[32] !== n.label || t[33] !== c
    ? ((E = c.formatMessage(
  ...
  let O;
  return (
    t[38] !== n.label || t[39] !== a || t[40] !== E || t[41] !== D || t[42] !== T
      ? ((O = (0, Z.jsx)(G, {
          actions: T,
          ariaLabel: E,
          description: D,
...
function Dt() {
  ...
  e[2] === t.pathname
    ? (a = e[3])
    : ((a = t.pathname.slice(28).split(`/`).filter(Ot)), (e[2] = t.pathname), (e[3] = a));
  let o = a,
  ...
  if (o.length === 0) {
    ...
    e[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(V, { slug: `cloud-environments` })), (e[4] = t))
      : (t = e[4]);
    let n;
    ...
    e[8] === n
      ? (a = e[9])
      : ((a = (0, Z.jsx)(_, { color: `primary`, onClick: n, children: r })),
        (e[8] = n),
        (e[9] = a));
    let o;
    e[10] === i
    ...
    return (
      e[12] !== a || e[13] !== o
        ? ((s = (0, Z.jsx)(ae, { title: t, action: a, children: o })),
          (e[12] = a),
          (e[13] = o),
          (e[14] = s))
        : (s = e[14]),
  ...
  if (s) {
    ...
    e[15] === i
      ? (t = e[16])
      : ((t = (0, Z.jsx)(jt, { onClick: () => i($) })), (e[15] = i), (e[16] = t));
    let n;
    ...
    return (
      e[20] !== t || e[21] !== r
        ? ((a = (0, Z.jsx)(ae, { backSlot: t, title: n, children: r })),
          (e[20] = t),
          (e[21] = r),
          (e[22] = a))
        : (a = e[22]),
  ...
  if (c != null && l) {
    ...
    return (
      e[26] !== c || e[27] !== t
        ? ((n = (0, Z.jsx)(At, { environmentId: c, onBack: t })),
          (e[26] = c),
          (e[27] = t),
          (e[28] = n))
        : (n = e[28]),
  ...
  if (c != null && u) {
    ...
    return (
      e[35] !== c || e[36] !== t || e[37] !== n || e[38] !== r
        ? ((a = (0, Z.jsx)(kt, { environmentId: c, onBack: t, onDeleted: n, onEdit: r })),
          (e[35] = c),
          (e[36] = t),
          (e[37] = n),
          (e[38] = r),
  ...
  return (
    e[40] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((d = (0, Z.jsx)(T, { to: $, replace: !0 })), (e[40] = d))
      : (d = e[40]),
    d
  );
}
...
function kt(e) {
  let t = (0, X.c)(64),
    { environmentId: n, onBack: r, onDeleted: a, onEdit: o } = e,
    c = s(u),
    d = m(),
    { userId: f } = O(),
    p = i(st, n),
    ...
    y = l(mt),
    C = l(ht),
    [w, T] = (0, fe.useState)(null);
  if (p.isPending || p.isError) {
    let e;
    t[0] === r ? (e = t[1]) : ((e = (0, Z.jsx)(jt, { onClick: r })), (t[0] = r), (t[1] = e));
    let n;
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, Z.jsx)(h, {
    ...
    return (
      t[5] !== e || t[6] !== i
        ? ((a = (0, Z.jsx)(ae, { backSlot: e, title: n, children: i })),
          (t[5] = e),
          (t[6] = i),
          (t[7] = a))
        : (a = t[7]),
  ...
  let E = p.data,
    D = E.permissions?.can_write === !0,
    k = E.permissions?.can_delete === !0,
    A;
  t[8] !== E.creator || t[9] !== f
    ? ((A = f != null && E.creator.id.includes(f)), (t[8] = E.creator), (t[9] = f), (t[10] = A))
    : (A = t[10]);
  let j = D && A,
    M = D && (E.cache_settings?.post_setup_cache_enabled ?? !0),
    P;
  t[11] !== E.is_pinned || t[12] !== d
    ? ((P = E.is_pinned
        ? d.formatMessage({
  ...
  t[28] !== C
    ...
    : (L = t[29]);
  let R;
  t[30] === r ? (R = t[31]) : ((R = (0, Z.jsx)(jt, { onClick: r })), (t[30] = r), (t[31] = R));
  let B = E.description || void 0,
    V;
  t[32] === E ? (V = t[33]) : ((V = (0, Z.jsx)(pe, { environment: E })), (t[32] = E), (t[33] = V));
  let H = w === `delete`,
    U;
  t[34] !== g || t[35] !== E.id || t[36] !== d || t[37] !== a || t[38] !== c
    ? ((U = () => {
        g.mutate(E.id, {
          onSuccess: () => {
            (c
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = (e) => T(e ? `delete` : null)), (t[40] = W))
    : (W = t[40]);
  let G;
  t[41] !== g.isPending || t[42] !== E.label || t[43] !== H || t[44] !== U
    ? ((G = (0, Z.jsx)(_e, {
        environmentName: E.label,
  ...
  let q = w === `reset-cache`,
    J;
  t[46] !== E.id || t[47] !== d || t[48] !== y || t[49] !== c
    ? ((J = () => {
        y.mutate(E.id, {
          onSuccess: () => {
            (T(null),
  ...
  t[51] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (e) => T(e ? `reset-cache` : null)), (t[51] = se))
    : (se = t[51]);
  let Y;
  t[52] !== y.isPending || t[53] !== q || t[54] !== J
    ? ((Y = (0, Z.jsx)(ve, { isPending: y.isPending, open: q, onConfirm: J, onOpenChange: se })),
      (t[52] = y.isPending),
      (t[53] = q),
      (t[54] = J),
      (t[55] = Y))
...
function At(e) {
  ...
  if (a.isError) {
    ...
    return (
      t[0] === e
        ? (r = t[1])
        : ((r = (0, Z.jsx)(T, { to: e, replace: !0 })), (t[0] = e), (t[1] = r)),
      r
    );
  }
  if (a.isPending) {
    let e;
    t[2] === r ? (e = t[3]) : ((e = (0, Z.jsx)(jt, { onClick: r })), (t[2] = r), (t[3] = e));
    let n;
    t[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, Z.jsx)(h, {
    ...
    return (
      t[6] === e
        ? (a = t[7])
        : ((a = (0, Z.jsx)(ae, { backSlot: e, title: n, children: i })), (t[6] = e), (t[7] = a)),
      a
    );
  }
  if (a.data.permissions?.can_write !== !0) {
    ...
    return (
      t[8] === e
        ? (r = t[9])
        : ((r = (0, Z.jsx)(T, { to: e, replace: !0 })), (t[8] = e), (t[9] = r)),
      r
    );
  }
  let o;
  t[10] === r ? (o = t[11]) : ((o = (0, Z.jsx)(jt, { onClick: r })), (t[10] = r), (t[11] = o));
  let s;
  ...
  let c;
  t[13] !== a.data || t[14] !== r
    ? ((c = (0, Z.jsx)(bt, { environment: a.data, onCancel: r, onSaved: r }, a.data.id)),
      (t[13] = a.data),
      (t[14] = r),
      (t[15] = c))
    : (c = t[15]);
  ...
  return (
    t[16] !== o || t[17] !== c
      ? ((l = (0, Z.jsx)(ae, { backSlot: o, title: s, children: c })),
        (t[16] = o),
        (t[17] = c),
        (t[18] = l))
      : (l = t[18]),
...
function jt(e) {
  ...
  return (
    t[2] === n
      ? (a = t[3])
      : ((a = (0, Z.jsxs)(_, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
        (t[2] = n),
        (t[3] = a)),
    a
  );
}
export { Dt as CloudEnvironmentsSettingsPage };
