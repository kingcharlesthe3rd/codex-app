...
import { Dt as de, Tt as fe, en as pe, tn as me } from "./app-initial~app-main~automations-page.js";
import {
  $l as he,
  Cl as ge,
  Fi as _e,
...
import { n as Ge, t as Ke } from "./page-search-input-a2-XgvYV.js";
...
`)
  ...
  if (t[6] !== n || t[7] !== c || t[8] !== o || t[9] !== i) {
    ...
    t[15] === p
      ? (m = t[16])
      : ((m = (0, W.jsx)(S, { label: f, valueAlignment: `end`, children: p })),
        (t[15] = p),
        (t[16] = m));
    let h;
    ...
    t[18] === n.machine.label
      ? (g = t[19])
      : ((g = (0, W.jsx)(S, { label: h, valueAlignment: `end`, children: n.machine.label })),
        (t[18] = n.machine.label),
        (t[19] = g));
    let _;
    ...
    t[21] === v
      ? (y = t[22])
      : ((y = (0, W.jsx)(S, { label: _, valueAlignment: `end`, children: v })),
        (t[21] = v),
        (t[22] = y));
    let b;
    t[23] === n.created_at
    ...
    t[28] === w
      ? (T = t[29])
      : ((T = (0, W.jsx)(S, { label: x, valueAlignment: `end`, children: w })),
        (t[28] = w),
        (t[29] = T));
    let E;
    ...
    t[31] === n.share_settings
      ? (D = t[32])
      : ((D = at(n.share_settings)), (t[31] = n.share_settings), (t[32] = D));
    let O;
    t[33] === D
      ? (O = t[34])
      : ((O = (0, W.jsx)(S, { label: E, valueAlignment: `end`, children: D })),
        (t[33] = D),
        (t[34] = O));
    let k;
    (t[35] !== g || t[36] !== y || t[37] !== b || t[38] !== T || t[39] !== O || t[40] !== m
      ? ((k = (0, W.jsx)(H, {
          children: (0, W.jsx)(H.Content, {
            children: (0, W.jsxs)(U, { children: [m, g, y, b, T, O] }),
          }),
        })),
        (t[35] = g),
        (t[36] = y),
...
function lt(e) {
  ...
  t[5] === c
    ? (u = t[6])
    : ((u = (0, G.jsx)(Te, { title: c, subtitle: l })), (t[5] = c), (t[6] = u));
  let d;
  ...
  t[14] === r
    ? (h = t[15])
    : ((h = (0, G.jsx)(B, { color: `danger`, loading: r, type: `submit`, children: m })),
      (t[14] = r),
      (t[15] = h));
  let g;
  t[16] !== p || t[17] !== h
  ...
  t[19] !== s || t[20] !== g || t[21] !== u
    ? ((_ = (0, G.jsxs)(ke, { as: `form`, onSubmit: s, children: [u, g] })),
      (t[19] = s),
      (t[20] = g),
      (t[21] = u),
      (t[22] = _))
  ...
  return (
    t[23] !== o || t[24] !== i || t[25] !== _
      ? ((v = (0, G.jsx)(_e, { open: i, onOpenChange: o, children: _ })),
        (t[23] = o),
        (t[24] = i),
        (t[25] = _),
        (t[26] = v))
...
function ut(e) {
  ...
  t[11] === n
    ? (p = t[12])
    : ((p = (0, G.jsx)(B, { color: `primary`, loading: n, type: `submit`, children: f })),
      (t[11] = n),
      (t[12] = p));
  let m;
  t[13] !== d || t[14] !== p
  ...
  let h;
  t[16] !== o || t[17] !== m
    ? ((h = (0, G.jsxs)(ke, { as: `form`, onSubmit: o, children: [c, m] })),
      (t[16] = o),
      (t[17] = m),
      (t[18] = h))
    : (h = t[18]);
  ...
  return (
    t[19] !== a || t[20] !== r || t[21] !== h
      ? ((g = (0, G.jsx)(_e, { open: r, onOpenChange: a, children: h })),
        (t[19] = a),
        (t[20] = r),
        (t[21] = h),
        (t[22] = g))
...
var wt,
  q,
  Tt = e(() => {
    ((wt = s()), z(), Pe(), Ye(), Oe(), Ue(), T(), We(), gt(), (q = _()));
  });
function Et(e, t) {
  let n = Pt(e);
  return {
...
function Wt(e) {
  ...
  let d;
  t[7] !== r || t[8] !== a || t[9] !== u
    ? ((d = (0, J.jsx)(C, { description: r, label: a, control: u })),
      (t[7] = r),
      (t[8] = a),
      (t[9] = u),
      (t[10] = d))
  ...
  return (
    t[16] !== d || t[17] !== f
      ? ((p = (0, J.jsxs)(U, { children: [d, f] })), (t[16] = d), (t[17] = f), (t[18] = p))
      : (p = t[18]),
    p
  );
}
function Gt(e) {
  ...
  let d;
  t[8] !== r || t[9] !== u
    ? ((d = (0, J.jsx)(C, { description: r, label: s, control: u })),
      (t[8] = r),
      (t[9] = u),
      (t[10] = d))
    : (d = t[10]);
...
var Kt,
  J,
  qt = e(() => {
    ((Kt = s()), z(), Pe(), Ue(), T(), We(), Vt(), gt(), (J = _()));
  });
function Jt(e, t, n) {
  return M.safeGet(`/wham/environments/search`, {
...
function Xt(e) {
  return M.safeGet(`/wham/environments/{environment_id}/with-creator-and-machine`, {
    parameters: { path: { environment_id: e } },
  });
}
function Zt() {
  return M.safeGet(`/wham/machines`);
}
async function Qt() {
  let { connectors: e } = await M.safeGet(`/aip/connectors/product_specific`, {
    ...
    n = await Promise.all(
      t.map((e) =>
        M.safeGet(`/aip/connectors/{connector_id}/link`, {
...
function $t(e, t) {
  return M.safeGet(`/wham/github/repositories/search/all-installations`, {
    parameters: { query: { query: e, limit: 20, connector_id: t } },
  });
}
function en(e) {
  return M.safePost(`/wham/environments`, { requestBody: e });
}
function tn({ environmentId: e, requestBody: t }) {
  return M.safePatch(`/wham/environments/{environment_id}`, {
    parameters: { path: { environment_id: e } },
    requestBody: t,
  });
}
function nn(e) {
  return M.safeDelete(`/wham/environments/{environment_id}`, {
    parameters: { path: { environment_id: e } },
  });
}
function rn(e) {
  return M.safePost(`/wham/environments/{environment_id}/reset-cache`, {
    parameters: { path: { environment_id: e } },
  });
}
...
var fn,
  ...
  xn = e(() => {
    (d(),
      ...
      (gn = c(o, ({ scope: e }) => ({ mutationFn: en, onSuccess: () => dn(e) }))),
      (_n = c(o, ({ scope: e }) => ({
        mutationFn: (e) => tn(e),
...
function Sn(e) {
  ...
  t[2] !== p.data || t[3] !== i || t[4] !== u
    ? ((m = p.data?.find((e) => e.id === (u ?? i))?.id ?? p.data?.[0]?.id ?? null),
      (t[2] = p.data),
      (t[3] = i),
      (t[4] = u),
      (t[5] = m))
...
function An(e) {
  let t = (0, Mn.c)(35),
    ...
    m = N(`2664309699`),
    _;
  t[0] === l ? (_ = t[1]) : ((_ = ge(l) || Se(l)), (t[0] = l), (t[1] = _));
  let v = _,
    y = n ?? void 0,
    b;
  t[2] !== a || t[3] !== y ? ((b = Et(y, a)), (t[2] = a), (t[3] = y), (t[4] = b)) : (b = t[4]);
  let x;
  t[5] !== d ||
  t[6] !== n ||
  t[7] !== c ||
  ...
  let S;
  t[13] !== b || t[14] !== x
    ? ((S = { defaultValues: b, onSubmit: x }), (t[13] = b), (t[14] = x), (t[15] = S))
    : (S = t[15]);
  let w = $e(S),
    T = d.isPending || f.isPending,
    E;
  t[16] === w
    ? (E = t[17])
    : ((E = (e) => {
    ...
    ? ((D = (e) => {
        ...
        return (0, X.jsxs)(X.Fragment, {
          children: [
                ...
                children: (0, X.jsxs)(U, {
                  children: [
                    ...
                    (0, X.jsx)(C, {
                      ...
                      control:
                        n == null
                          ? (0, X.jsx)(Sn, { form: w, isPending: T, preferredConnectorId: a })
                          : (0, X.jsx)(K, {
                              "aria-label": c.formatMessage({
            ...
            (0, X.jsx)(bt, { form: w, isPending: T, showAuthtranslator: p, showDockerInDocker: m }),
  ...
  t[29] !== w.Subscribe || t[30] !== D
    ? ((O = (0, X.jsx)(w.Subscribe, { selector: jn, children: D })),
      (t[29] = w.Subscribe),
      (t[30] = D),
      (t[31] = O))
    : (O = t[31]);
...
function Pn(e) {
  ...
  let d = he(u, 200),
    f;
  t[2] === d ? (f = t[3]) : ((f = un(d)), (t[2] = d), (t[3] = f));
  let {
      data: p,
      fetchNextPage: _,
      hasNextPage: v,
  ...
  let O;
  t[20] !== p || t[21] !== _ || t[22] !== v || t[23] !== y || t[24] !== b
    ? ((O =
        p == null
          ? null
          : (0, Z.jsx)(Je, {
...
function In(e) {
  ...
  let x;
  t[26] !== p || t[27] !== y
    ? ((x = (0, Z.jsx)(k, { tooltipContent: p, children: y })),
      (t[26] = p),
      (t[27] = y),
      (t[28] = x))
    : (x = t[28]);
  let S;
  t[29] !== m || t[30] !== x
    ? ((S = (0, Z.jsxs)(Z.Fragment, { children: [m, x] })), (t[29] = m), (t[30] = x), (t[31] = S))
    : (S = t[31]);
  let C;
  t[32] !== n.label || t[33] !== c
    ? ((C = c.formatMessage(
  ...
  let T;
  return (
    t[38] !== n.label || t[39] !== a || t[40] !== C || t[41] !== w || t[42] !== S
      ? ((T = (0, Z.jsx)(E, {
          actions: S,
          ariaLabel: C,
          description: w,
...
function Bn() {
  ...
  if (o.length === 0) {
    ...
    e[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(Be, { slug: `cloud-environments` })), (e[4] = t))
      : (t = e[4]);
    let n;
    ...
    e[8] === n
      ? (a = e[9])
      : ((a = (0, Q.jsx)(B, { color: `primary`, onClick: n, children: r })),
        (e[8] = n),
        (e[9] = a));
    let o;
    e[10] === i
    ...
    return (
      e[12] !== a || e[13] !== o
        ? ((s = (0, Q.jsx)(fe, { title: t, action: a, children: o })),
          (e[12] = a),
          (e[13] = o),
          (e[14] = s))
        : (s = e[14]),
  ...
  if (s) {
    ...
    return (
      e[20] !== t || e[21] !== r
        ? ((a = (0, Q.jsx)(fe, { backSlot: t, title: n, children: r })),
          (e[20] = t),
          (e[21] = r),
          (e[22] = a))
        : (a = e[22]),
  ...
  return (
    e[40] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((d = (0, Q.jsx)(F, { to: $, replace: !0 })), (e[40] = d))
      : (d = e[40]),
    d
  );
}
...
function Hn(e) {
  ...
  if (u.isPending || u.isError) {
    ...
    return (
      t[5] !== e || t[6] !== i
        ? ((a = (0, Q.jsx)(fe, { backSlot: e, title: n, children: i })),
          (t[5] = e),
          (t[6] = i),
          (t[7] = a))
        : (a = t[7]),
  ...
  let y = u.data,
    x = y.permissions?.can_write === !0,
    S = y.permissions?.can_delete === !0,
    C;
  t[8] !== y.creator || t[9] !== l
    ? ((C = l != null && y.creator.id.includes(l)), (t[8] = y.creator), (t[9] = l), (t[10] = C))
    : (C = t[10]);
  let T = x && C,
    E = x && (y.cache_settings?.post_setup_cache_enabled ?? !0),
    O;
  ...
  t[28] !== m
    ...
    : (re = t[29]);
  let M;
  t[30] === r ? (M = t[31]) : ((M = (0, Q.jsx)(Wn, { onClick: r })), (t[30] = r), (t[31] = M));
  let ie = y.description || void 0,
    ae;
  t[32] === y
    ? (ae = t[33])
    : ((ae = (0, Q.jsx)(rt, { environment: y })), (t[32] = y), (t[33] = ae));
  let oe = _ === `delete`,
    N;
  t[34] !== d || t[35] !== y.id || t[36] !== c || t[37] !== i || t[38] !== s
    ? ((N = () => {
        d.mutate(y.id, {
          onSuccess: () => {
            (s
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (e) => v(e ? `delete` : null)), (t[40] = se))
    : (se = t[40]);
  let F;
  t[41] !== d.isPending || t[42] !== y.label || t[43] !== oe || t[44] !== N
    ? ((F = (0, Q.jsx)(lt, {
  ...
  t[51] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (le = t[51]);
  let L;
  t[52] !== p.isPending || t[53] !== ce || t[54] !== I
    ? ((L = (0, Q.jsx)(ut, { isPending: p.isPending, open: ce, onConfirm: I, onOpenChange: le })),
      (t[52] = p.isPending),
      (t[53] = ce),
      (t[54] = I),
      (t[55] = L))
...
function Un(e) {
  ...
  if (i.isError) {
    ...
    return (
      t[0] === e
        ? (r = t[1])
        : ((r = (0, Q.jsx)(F, { to: e, replace: !0 })), (t[0] = e), (t[1] = r)),
      r
    );
  }
  if (i.isPending) {
    ...
    return (
      t[6] === e
        ? (a = t[7])
        : ((a = (0, Q.jsx)(fe, { backSlot: e, title: n, children: i })), (t[6] = e), (t[7] = a)),
      a
    );
  }
  if (i.data.permissions?.can_write !== !0) {
    ...
    return (
      t[8] === e
        ? (r = t[9])
        : ((r = (0, Q.jsx)(F, { to: e, replace: !0 })), (t[8] = e), (t[9] = r)),
      r
    );
  }
  let a;
  ...
  return (
    t[16] !== a || t[17] !== s
      ? ((c = (0, Q.jsx)(fe, { backSlot: a, title: o, children: s })),
        (t[16] = a),
        (t[17] = s),
        (t[18] = c))
      : (c = t[18]),
...
function Wn(e) {
  let t = (0, Gn.c)(4),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(De, { className: `icon-xs` })),
      (i = (0, Q.jsx)(P, {
  ...
  return (
    t[2] === n
      ? (a = t[3])
      : ((a = (0, Q.jsxs)(B, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
        (t[2] = n),
        (t[3] = a)),
    a
  );
