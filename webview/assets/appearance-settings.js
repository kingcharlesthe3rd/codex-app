...
import "./src-2.js";
import { o as t } from "./gpu-tearing-debug-settings-B8w-l8Wh.js";
import { Ds as n, Os as r, Wo as i, js as a } from "./app-server-manager-signals.js";
...
import { v as _ } from "./persisted-signal-CweW-bgN.js";
import "./rpc-1.js";
import "./statsig.js";
import "./request.js";
...
import { n as R } from "./general-settings-2.js";
  ...
  if (
    ...
    t[19] === x
      ...
      : ((u = (e, t) => {
          x.logProductEvent(
            r,
            O({ action: e, selectedAvatar: t, source: a.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS }),
          );
        }),
        (t[19] = x),
        (t[20] = u));
                    ...
                    ? (0, V.jsx)(y, {
                        ...
                        onClick: () => {
                          (x.logProductEvent(
                            r,
                            O({
                              action: n.CODEX_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED,
...
function $({ defaultExpanded: e }) {
  let [t, n] = (0, z.useState)(!1),
    { avatarDirectory: r, avatarOptions: a, isError: o, isLoading: s, refetch: c } = L(),
    l = C(),
    { findSkillByName: u, forceReload: d } = S(void 0, i),
    { ensureSkillByName: f, installSkill: p } = N({ hostId: i, loadOnMount: !1 }),
    m = async () => {
      n(!0);
      try {
        l({
