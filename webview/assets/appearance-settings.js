...
import { Fo as n, Io as r, po as i, zo as a } from "./app-server-manager-signals.js";
...
import { G as l, S as u, U as d, X as f, Z as p, m, wt as h, y as g } from "./setting-storage.js";
...
function U(e) {
  ...
  t[9] === n
    ? (g = t[10])
    : ((g = (0, V.jsx)(`span`, { className: `font-mono text-xs break-all`, children: n })),
      (t[9] = n),
      (t[10] = g));
  let _;
  t[11] !== n || t[12] !== p
...
function G(e) {
  ...
  if (
    ...
    (t[34] === X
      ? (Z = t[35])
      : ((Z = (0, V.jsx)(C, { className: X, "aria-hidden": !0 })), (t[34] = X), (t[35] = Z)),
      t[36] !== S || t[37] !== w || t[38] !== G || t[39] !== Z || t[40] !== B || t[41] !== H
        ? ((P = (0, V.jsxs)(`button`, {
            type: `button`,
            className: B,
            "aria-controls": S,
