...
import { Ho as n, _s as r, ms as i, ps as a } from "./app-server-manager-signals.js";
...
import { F as l, I as u, f as d, h as f, lt as p, s as m } from "./vscode-api.js";
import { c as h, o as g } from "./lib-2.js";
import { v as _ } from "./persisted-signal.js";
import "./rpc-2.js";
import "./statsig.js";
import "./request.js";
...
import { n as C } from "./use-start-new-conversation.js";
...
import "./toggle.js";
import { t as T } from "./arrow-top-right.js";
import "./permissions-mode-visibility.js";
import { i as E } from "./settings-shared.js";
import "./folders-M.js";
import "./alert.js";
import { t as D } from "./settings-content-layout.js";
import { t as O } from "./avatar-overlay-analytics-CE-OXRnw.js";
import { a as k, i as A, t as j } from "./codex-avatar.js";
import { t as M } from "./avatar-overlay-open-state-signal.js";
import "./sun.js";
import { t as N } from "./use-recommended-skills-C0-7frYf.js";
...
import { n as R } from "./general-settings-1.js";
...
function H(e) {
  ...
  return (
    t[7] !== s || t[8] !== l || t[9] !== p
      ? ((m = (0, V.jsx)(`div`, { className: s, "data-avatar-id": l, children: p })),
        (t[7] = s),
        (t[8] = l),
        (t[9] = p),
        (t[10] = m))
...
function U(e) {
  ...
  t[9] === n
    ? (p = t[10])
    : ((p = (0, V.jsx)(`span`, { className: `font-mono text-xs break-all`, children: n })),
      (t[9] = n),
      (t[10] = p));
  let _;
  t[11] !== n || t[12] !== u
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, V.jsx)(g, {
      ...
      (x = (0, V.jsx)(T, { className: `icon-2xs` })),
      (t[14] = b),
      (t[15] = x))
    : ((b = t[14]), (x = t[15]));
  let S;
  t[16] === _
    ? (S = t[17])
    : ((S = (0, V.jsxs)(y, { color: `ghost`, onClick: _, size: `toolbar`, children: [b, x] })),
      (t[16] = _),
      (t[17] = S));
  let C;
  return (
    t[18] !== p || t[19] !== S
      ? ((C = (0, V.jsx)(P, { label: d, description: p, control: S })),
        (t[18] = p),
        (t[19] = S),
        (t[20] = C))
      : (C = t[20]),
...
function G(e) {
  ...
  if (
    ...
    t[19] === x
      ...
      : ((u = (e, t) => {
          x.logProductEvent(
            i,
            O({ action: e, selectedAvatar: t, source: r.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS }),
          );
        }),
        (t[19] = x),
        (t[20] = u));
    ...
    t[21] !== D || t[22] !== _
      ? ((A = (e) => {
          (D(e.id), _(a.CODEX_AVATAR_OVERLAY_ACTION_PET_SELECTED, e));
        }),
        (t[21] = D),
        (t[22] = _),
        (t[23] = A))
      : (A = t[23]);
    let M = A;
    ((R = `flex flex-col gap-[var(--padding-panel)]`), (N = I), (j = I.Content), (k = F));
    ...
    (t[34] === X
      ? (Z = t[35])
      : ((Z = (0, V.jsx)(w, { className: X, "aria-hidden": !0 })), (t[34] = X), (t[35] = Z)),
      t[36] !== S || t[37] !== C || t[38] !== G || t[39] !== Z || t[40] !== B || t[41] !== H
        ? ((P = (0, V.jsxs)(`button`, {
            type: `button`,
            className: B,
            "aria-controls": S,
        ...
        ? (0, V.jsxs)(`div`, {
            ...
            children: [
                    ...
                    ? (0, V.jsx)(y, {
                        ...
                        onClick: () => {
                          (x.logProductEvent(
                            i,
                            O({
                              action: a.CODEX_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED,
                              source: r.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS,
                              selectedAvatar: E,
                            }),
                          ),
                            m());
              ...
              f
                ...
                : null,
              e.map((e) =>
                (0, V.jsx)(J, { avatar: e, isSelected: e.id === E.id, onSelectAvatar: M }, e.id),
              ),
              n == null ? null : (0, V.jsx)(U, { avatarDirectory: n }),
              s.map((e) =>
                (0, V.jsx)(J, { avatar: e, isSelected: e.id === E.id, onSelectAvatar: M }, e.id),
              ),
            ],
      ...
      (t[17] = L),
      (t[18] = R));
  } else ((k = t[13]), (j = t[14]), (N = t[15]), (P = t[16]), (L = t[17]), (R = t[18]));
  let H;
  ...
  let W;
  t[47] !== j || t[48] !== H
    ? ((W = (0, V.jsx)(j, { children: H })), (t[47] = j), (t[48] = H), (t[49] = W))
    : (W = t[49]);
  let G;
  t[50] !== N || t[51] !== W
    ? ((G = (0, V.jsx)(N, { children: W })), (t[50] = N), (t[51] = W), (t[52] = G))
    : (G = t[52]);
  let Y;
  return (
    t[53] !== R || t[54] !== G
...
function J(e) {
  let t = (0, B.c)(11),
    ...
    a;
  t[0] === n ? (a = t[1]) : ((a = (0, V.jsx)(H, { avatar: n })), (t[0] = n), (t[1] = a));
  let o;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((o = r
        ? (0, V.jsx)(y, {
...
function Q(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, V.jsx)(x, { electron: !0, children: (0, V.jsx)($, { defaultExpanded: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function $({ defaultExpanded: e }) {
  let [t, r] = (0, z.useState)(!1),
    { avatarDirectory: i, avatarOptions: a, isError: o, isLoading: s, refetch: c } = L(),
    l = C(),
    { findSkillByName: u, forceReload: d } = S(void 0, n),
    { ensureSkillByName: f, installSkill: p } = N({ hostId: n, loadOnMount: !1 }),
    m = async () => {
      r(!0);
      try {
        l({
...
function ee() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, V.jsxs)(D, {
          title: (0, V.jsx)(E, { slug: `appearance` }),
