...
import { f as s, s as c } from "./vscode-api.js";
import "./isEqual.js";
import "./src-4.js";
import { a as l } from "./gpu-tearing-debug-settings.js";
import { us as u } from "./app-server-manager-signals.js";
import "./react-dom.js";
import { c as d, o as f } from "./lib-1.js";
import { B as p, U as m, c as h, z as g } from "./persisted-signal.js";
import { t as _ } from "./clsx.js";
import "./proxy.js";
import "./app-shell-state.js";
import { t as v } from "./codex-avatar.js";
...
import { t as A } from "./avatar-overlay-analytics.js";
...
import { n as z } from "./general-settings.js";
var B = e(t(), 1),
  V = r(),
  H = n();
function U(e) {
  ...
  let c = n?.id ?? `default`,
    ...
    f;
  t[3] !== l || t[4] !== u || t[5] !== d
    ? ((f = (0, H.jsx)(v, { assetRef: l, className: u, spritesheetUrl: d })),
      (t[3] = l),
      (t[4] = u),
      (t[5] = d),
      (t[6] = f))
...
function W(e) {
  ...
  let p;
  t[5] !== l || t[6] !== u
    ? ((p = { onSuccess: u, onError: l }), (t[5] = l), (t[6] = u), (t[7] = p))
    : (p = t[7]);
  let { mutate: m } = c(`open-file`, p),
    h;
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, H.jsx)(f, {
      ...
      (b = (0, H.jsx)(D, { className: `icon-2xs` })),
      (t[14] = v),
      (t[15] = b))
    : ((v = t[14]), (b = t[15]));
  let S;
  t[16] === _
    ? (S = t[17])
    : ((S = (0, H.jsxs)(y, { color: `ghost`, onClick: _, size: `toolbar`, children: [v, b] })),
      (t[16] = _),
      (t[17] = S));
  let C;
  return (
...
function K(e) {
  let t = (0, V.c)(56),
    ...
    S = (0, B.useId)(),
    [C, w] = (0, B.useState)(i),
    { selectedAvatar: T, setSelectedAvatarId: D } = M(r),
    O,
    k,
    j,
    P,
  ...
  if (
    ...
    t[19] === x
      ...
      : ((a = (e, t) => {
          x.logProductEvent(
            p,
            A({ action: e, selectedAvatar: t, source: m.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS }),
          );
        }),
        (t[19] = x),
        (t[20] = a));
    ...
    t[21] !== D || t[22] !== h
      ? ((M = (e) => {
          (D(e.id), h(g.CODEX_AVATAR_OVERLAY_ACTION_PET_SELECTED, e));
        }),
        (t[21] = D),
        (t[22] = h),
        (t[23] = M))
    ...
    (t[34] === X
      ? (Z = t[35])
      : ((Z = (0, H.jsx)(E, { className: X, "aria-hidden": !0 })), (t[34] = X), (t[35] = Z)),
      t[36] !== S || t[37] !== C || t[38] !== G || t[39] !== Z || t[40] !== B || t[41] !== V
        ? ((P = (0, H.jsxs)(`button`, {
            type: `button`,
            className: B,
            "aria-controls": S,
        ...
        ? (0, H.jsxs)(`div`, {
            ...
            children: [
                    ...
                    ? (0, H.jsx)(y, {
                        ...
                        onClick: () => {
                          (x.logProductEvent(
                            p,
                            A({
                              action: g.CODEX_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED,
                              source: m.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS,
                              selectedAvatar: T,
                            }),
                          ),
                            u());
              ...
              c
                ...
                : null,
              e.map((e) =>
                (0, H.jsx)(Y, { avatar: e, isSelected: e.id === T.id, onSelectAvatar: N }, e.id),
              ),
...
function ne({ defaultExpanded: e }) {
  let [t, n] = (0, B.useState)(!1),
    { avatarDirectory: r, avatarOptions: i, isError: a, isLoading: o, refetch: s } = L(),
    c = T(),
    { findSkillByName: l, forceReload: d } = w(void 0, u),
    { ensureSkillByName: f, installSkill: p } = R({ hostId: u, loadOnMount: !1 }),
    m = async () => {
      n(!0);
      try {
        c({
