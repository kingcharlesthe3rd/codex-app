...
import { S as t, n, t as r, x as i } from "./merge-1.js";
import {
  C as a,
  F as o,
  P as s,
...
import { i as d, n as f, r as me } from "./chunk-57.js";
import { I as he, f as ge, k as _e, m as p, r as ve, s as m } from "./chunk-56.js";
import { n as ye, t as be } from "./src-3.js";
import { t as xe } from "./dist-2.js";
function h(e, t) {
        ...
        for (let t of e) {
          if (n) {
            ...
            if (e < r) r -= e;
              ...
              if (i > 0 && i < 1)
                return { x: L((1 - i) * n.x + i * t.x, 5), y: L((1 - i) * n.y + i * t.y, 5) };
            }
          }
          n = t;
        }
          ...
          return (
            r.forEach((e, o) => {
              let s = w(`${e} `, n),
                c = w(a, n);
              if (s > t) {
                let { hyphenatedStrings: r, remainingWord: o } = K(e, t, `-`, n);
                (i.push(a, ...r), (a = o));
        ...
        (e, t) => {
          ...
          for (let e of o) {
            ...
            for (let r of s) {
              let o = U();
              o.text = r || `​`;
              let s = W(u, o).style(`font-size`, a).style(`font-weight`, i).style(`font-family`, e),
