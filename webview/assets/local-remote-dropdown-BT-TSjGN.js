...
import { c as Un, s as Wn } from "./app-initial~app-main~local-conversation-page-D.js";
import {
  n as Gn,
  r as Kn,
} from "./app-initial~app-main~remote-conversation-page~pull-requests-page~hotkey-window-thread-page~~b9vznyj4.js";
import { n as qn, r as Jn } from "./git-submodule-paths-query.js";
import { a as Yn, c as Xn, i as Zn, o as Qn, r as $n, s as er } from "./git-branch-switcher.js";
import { n as tr, t as nr } from "./dock.js";
import { n as rr, t as ir } from "./use-codex-worktrees.js";
function ar(e, t, n) {
  let r = (0, sr.c)(15),
    i = (0, ur.useDeferredValue)(e),
    a = t?.id,
    o;
  r[0] !== i || r[1] !== a
  ...
  let {
    ...
    p;
  r[3] !== s || r[4] !== t
    ? ((p = t == null ? null : (s.find((e) => e.id === t.id) ?? null)),
      (r[3] = s),
      (r[4] = t),
      (r[5] = p))
    : (p = r[5]);
  ...
  (r[6] !== s || r[7] !== m || r[8] !== n
    ...
    : ((g = r[9]), (v = r[10])),
    (0, ur.useEffect)(g, v));
  let y = c instanceof _ && c.status === 404,
    b;
  b =
    d.length > 0
      ? `list`
  ...
  let x;
  return (
    r[11] !== b || r[12] !== d || r[13] !== h
      ? ((x = { envListState: b, listToShow: d, zeroEnvironments: h }),
        (r[11] = b),
        (r[12] = d),
        (r[13] = h),
        (r[14] = x))
  ...
  return (
    await Promise.all(
      e.map(({ owner: e, repoName: t }) =>
        pt.safeGet(`/wham/environments/by-repo/{provider}/{repo_owner}/{repo_name}`, {
  ...
  hr = e(() => {
    ((sr = v()),
      ...
      (dr = d(s, () => ({
        ...
        queryFn: async () => pt.safeGet(`/wham/environments`),
        placeholderData: w,
        staleTime: S.FIVE_MINUTES,
      }))),
      (fr = d(s, ({ get: e }) => {
        let t = e(he, { params: void 0, source: `workspace_repo_owner_names` }),
          n = Je(t.data?.origins ?? []);
        return {
          queryKey: [
            `workspace`,
            ...
            `results`,
            ...(0, cr.default)(n, [`owner`, `repoName`]).flatMap(({ owner: e, repoName: t }) => [
              e,
              t,
            ]),
          ],
          enabled: t.isSuccess,
          staleTime: S.FIVE_MINUTES,
          queryFn: or.bind(null, n),
        };
      })),
      (pr = r(s, ({ get: e }) =>
        (0, lr.default)([...(e(fr).data ?? []), ...(e(dr).data ?? [])], (e) => e.id),
      )),
      (mr = b(s, ({ envQuery: e, selectedEnvironmentId: t }, { get: n }) => {
        let r = n(dr),
          i = n(fr).data ?? [],
...
function gr({ cloudAccess: e, hasGitRepository: t, isBrowser: n }) {
...
function yr(e) {
  let t = (0, Sr.c)(22),
    { composerMode: n, conversationId: r, disabled: i, setComposerMode: a, side: o } = e,
    s = o === void 0 ? `top` : o,
    [c, u] = (0, Cr.useState)(!1),
    [d, f] = E(Qe),
    { access: p } = kn(),
  ...
  t[0] !== m.cwd || t[1] !== m.hostConfig
    ? ((h = {
      ...
      (t[2] = h))
    : (h = t[2]);
  let g = gr({ cloudAccess: p, hasGitRepository: l(It, h)?.root != null, isBrowser: !1 });
  if (n !== `cloud` || !g) return null;
  let _;
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, wr.jsx)(nr, { className: `icon-xs` })), (t[5] = y))
    : (y = t[5]);
  let b;
  t[6] === d
    ? (b = t[7])
  ...
  let w;
  return (
    t[16] !== i || t[17] !== c || t[18] !== s || t[19] !== x || t[20] !== C
      ? ((w = (0, wr.jsx)(Ne, {
...
function br(e) {
  let t = (0, Sr.c)(35),
    { selectedEnvironment: n, setComposerMode: r, setSelectedEnvironment: a, closeDropdown: o } = e,
    [s, c] = (0, Cr.useState)(``),
    { envListState: l, listToShow: u, zeroEnvironments: d } = ar(s, n, a),
    f = St(),
    p;
  if (d) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, wr.jsx)(W, { href: i, className: Tr })), (t[0] = e))
      : (e = t[0]);
    let n;
    ...
    if (l === `loading`) {
      ...
      (t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((n = (0, wr.jsx)(`div`, {
            ...
            children: (0, wr.jsx)(ce, { className: `icon-xxs text-token-description-foreground` }),
          })),
          (t[2] = n))
        : (n = t[2]),
        (e = n));
      ...
      let s;
      if (t[5] !== o || t[6] !== u || t[7] !== n?.id || t[8] !== r || t[9] !== a) {
        let e;
        (t[11] !== o || t[12] !== n?.id || t[13] !== r || t[14] !== a
          ? ((e = (e) =>
              (0, wr.jsx)(
                K.Item,
                {
                  RightIcon: e.id === n?.id ? _e : void 0,
                  onClick: () => {
                    (r(`cloud`), a(e), o());
                  },
                  children: (0, wr.jsx)(`span`, {
      ...
      let f;
      (t[20] !== s || t[21] !== d
        ? ((f = (0, wr.jsxs)(wr.Fragment, { children: [s, c, d] })),
          (t[20] = s),
          (t[21] = d),
          (t[22] = f))
        : (f = t[22]),
    ...
    t[25] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((m = (e) => c(e.target.value)), (t[25] = m))
      : (m = t[25]);
    let h;
    t[26] !== s || t[27] !== d
      ? ((h = (0, wr.jsx)(K.Section, {
          className: `my-1`,
          children: (0, wr.jsx)(K.SearchInput, { placeholder: d, value: s, onChange: m }),
        })),
        (t[26] = s),
        (t[27] = d),
        (t[28] = h))
    ...
    let g;
    (t[29] !== e || t[30] !== h
      ? ((g = (0, wr.jsxs)(`div`, { className: `flex flex-col`, children: [h, e] })),
        (t[29] = e),
        (t[30] = h),
        (t[31] = g))
      : (g = t[31]),
  ...
  return (
    t[33] === p
      ? (h = t[34])
      : ((h = (0, wr.jsxs)(`div`, { className: `flex w-64 flex-col`, children: [m, p] })),
        (t[33] = p),
        (t[34] = h)),
    h
  );
...
function xr(e) {
  ze({ disposition: `current-tab`, event: e, href: i, initiator: `open_in_browser_bridge` });
}
var Sr,
  Cr,
  wr,
  ...
  Er = e(() => {
    ((Sr = v()),
      ...
      vr(),
      (wr = x()),
      (Tr = `icon-xs shrink-0 opacity-75 group-focus:opacity-100 group-hover:opacity-100`));
  });
function Dr({ isCompactWindow: e }) {
  return !e;
}
function Or({ codexWorktree: e, operation: t, threadHandoff: n }) {
  return t == null
    ? n == null
      ? e
        ? `to-local`
...
function Ar({ conversationId: e, operation: t, threadHandoff: n }) {
...
function Mr({ destinationHostId: e, destinationWorkspaceRoot: t, operation: n }) {
  return (
...
function Ur(e, t, n, r, i) {
  ...
  return (
    a[3] === i
      ? (s = a[4])
      : ((s = { select: Wr, staleTime: S.FIVE_SECONDS, ...i }), (a[3] = i), (a[4] = s)),
    Nt(e, t, `branch-exists`, o, r, s)
  );
}
function Wr(e) {
  return e.exists;
...
function qr(e) {
  ...
  return (
    t[4] !== o || t[5] !== s
      ? ((c = (0, Yr.jsx)(`div`, { className: o, children: s })),
        (t[4] = o),
        (t[5] = s),
        (t[6] = c))
      : (c = t[6]),
...
function Zr(e) {
  ...
  if (n.status === `queued` || n.status === `running`) {
    let e;
    return (
      t[0] === n ? (e = t[1]) : ((e = (0, J.jsx)(Qr, { operation: n })), (t[0] = n), (t[1] = e)), e
    );
  }
  if (n.status === `warning`) {
    let e;
    return (
      t[2] !== r || t[3] !== n
        ? ((e = (0, J.jsx)(ei, { operation: n, onClose: r })), (t[2] = r), (t[3] = n), (t[4] = e))
        : (e = t[4]),
      e
    );
  }
  if (n.status === `success`) {
    let e;
    return (
      t[5] === n ? (e = t[6]) : ((e = (0, J.jsx)($r, { operation: n })), (t[5] = n), (t[6] = e)), e
    );
  }
  let a;
  return (
    t[7] !== r || t[8] !== i || t[9] !== n
      ? ((a = (0, J.jsx)(ti, { operation: n, onClose: r, onRetry: i })),
        (t[7] = r),
        (t[8] = i),
        (t[9] = n),
        (t[10] = a))
...
function Qr(e) {
  ...
  t[11] !== r || t[12] !== a || t[13] !== o
    ? ((l = (0, J.jsx)(r, { className: a, children: o })),
      (t[11] = r),
      (t[12] = a),
      (t[13] = o),
      (t[14] = l))
  ...
  return (
    t[15] !== i || t[16] !== s || t[17] !== c || t[18] !== l
      ? ((u = (0, J.jsxs)(i, { className: s, children: [c, l] })),
        (t[15] = i),
        (t[16] = s),
        (t[17] = c),
        (t[18] = l),
...
function $r(e) {
  let t = (0, li.c)(8),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, J.jsx)(_e, { className: `icon-md text-token-charts-green` })), (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === n ? (i = t[2]) : ((i = oi(n)), (t[1] = n), (t[2] = i));
  let a;
  t[3] === n ? (a = t[4]) : ((a = si(n)), (t[3] = n), (t[4] = a));
  let o;
  return (
    t[5] !== i || t[6] !== a
      ? ((o = (0, J.jsx)(De, {
...
function ei(e) {
  let t = (0, li.c)(12),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, J.jsx)(Rr, { className: `icon-md text-token-editor-warning-foreground` })),
      (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === n ? (a = t[2]) : ((a = ii(n)), (t[1] = n), (t[2] = a));
  let o;
  ...
  return (
    t[9] !== o || t[10] !== c
      ? ((l = (0, J.jsxs)(De, { className: `gap-0 px-6 py-5`, children: [o, c] })),
        (t[9] = o),
        (t[10] = c),
        (t[11] = l))
      : (l = t[11]),
...
function ti(e) {
  let t = (0, li.c)(21),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, J.jsx)(cn, { className: `icon-md text-token-danger -ml-2` })), (t[0] = o))
    : (o = t[0]);
  let s;
  t[1] === n ? (s = t[2]) : ((s = ai(n)), (t[1] = n), (t[2] = s));
  let c;
  ...
  t[6] === a
    ...
    : ((l =
        a != null && a.output.length > 0
          ? (0, J.jsx)(Oe, {
              className: `pt-5`,
              children: (0, J.jsx)(qr, { command: a?.command, output: a.output }),
            })
          : null),
      (t[6] = a),
      (t[7] = l));
  ...
  let m;
  t[14] !== d || t[15] !== p
    ? ((m = (0, J.jsx)(Oe, { className: `pt-5`, children: (0, J.jsxs)(Ze, { children: [d, p] }) })),
      (t[14] = d),
      (t[15] = p),
      (t[16] = m))
    : (m = t[16]);
...
function ni(e) {
  return (0, J.jsx)(Vr, { className: `icon-md rotate-90 text-token-foreground` });
}
function ri(e) {
...
var li,
  J,
  ui = e(() => {
    ((li = v()), ut(), B(), I(), Xr(), Ve(), zr(), Hr(), Qt(), on(), (J = x()));
  });
function di(e) {
  let t = (0, fi.c)(8),
    n = St(),
    r = l(an, e),
    { data: i, isError: a, isLoading: o } = Ye(c.QUEUED_FOLLOW_UPS);
  switch (
    tn({
...
function mi(e) {
  let t = (0, _i.c)(109),
    {
      ...
      cwd: u,
      destinationHostId: d,
      destinationWorkspaceRoot: f,
      destinationLabel: p,
    } = e,
    m = St(),
    h = di(i),
    _ = l(yt, i) ?? !1,
    [v, y] = (0, vi.useState)(null),
    { data: b } = Ye(c.GIT_BRANCH_PREFIX),
    x = $t({ branchPrefix: b ?? void 0, conversationTitle: o }),
    S = qt(),
    C;
  ...
  let w = C.length === 0,
    ...
    ee;
  t[2] !== i || t[3] !== S
    ? ((ee = S.getMaybeForConversationId(i)?.getConversation(i)?.forkedFromId ?? null),
      (t[2] = i),
      (t[3] = S),
      (t[4] = ee))
    : (ee = t[4]);
  let O = ee,
    k;
  t[5] !== d || t[6] !== f || t[7] !== O
    ? ((k = [`move-thread`, `to-host-worktree`, `resolve-owned-worktree`, d, f, O]),
      (t[5] = d),
      (t[6] = f),
      (t[7] = O),
      (t[8] = k))
  ...
  let ne = n && O != null,
    A;
  t[14] !== k || t[15] !== te || t[16] !== ne
    ? ((A = { queryKey: k, queryFn: te, enabled: ne, staleTime: 0 }),
      (t[14] = k),
      (t[15] = te),
      (t[16] = ne),
      (t[17] = A))
  ...
  let { data: re } = g(A),
    ...
    ie = a.pastedTextAttachments.length > 0,
    M = n && !ie && w && E.length > 0 && !E.endsWith(`/`),
    ae;
  t[18] === M ? (ae = t[19]) : ((ae = { enabled: M }), (t[18] = M), (t[19] = ae));
  let { data: oe, isPending: N } = Ur(f, D, E, `move_to_host_worktree`, ae),
    P = null;
  if (h != null) P = h;
  else if (ie) {
    let e;
  ...
  let F = P != null,
    { activeOperationId: I } = Vt(),
    L = Wt(i),
    {
      addToHostWorktreeOperation: se,
      closeActiveOperation: ce,
      removeOperation: R,
      openOperation: le,
      updateOperation: z,
    } = Ht(),
    B = L != null && I === L.id,
    ue = n || B,
    de = L?.status === `success` || L?.status === `warning` || L?.status === `error`,
    V;
  t[30] !== ce || t[31] !== B || t[32] !== r || t[33] !== L || t[34] !== R || t[35] !== de
    ? ((V = (e) => {
        if (!e && B) {
          if (de) {
            (R(L.id), r(!1));
  ...
  if (B && L != null) {
    let e;
    t[49] !== ce || t[50] !== L.id || t[51] !== R || t[52] !== de
      ? ((e = () => {
          if (de) {
            R(L.id);
            return;
    ...
    t[60] !== z
      ...
      : (n = t[61]);
    let i;
    t[62] !== L || t[63] !== e || t[64] !== n
      ? ((i = (0, Y.jsx)(Zr, { operation: L, onClose: e, onRetry: n })),
        (t[62] = L),
        (t[63] = e),
        (t[64] = n),
        (t[65] = i))
    ...
    let a;
    return (
      t[66] !== ue || t[67] !== H || t[68] !== i
        ? ((a = (0, Y.jsx)($e, { size: `compact`, open: ue, onOpenChange: H, children: i })),
          (t[66] = ue),
          (t[67] = H),
          (t[68] = i),
          (t[69] = a))
  ...
  t[72] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, Y.jsx)(xn.Header, {
        icon: (0, Y.jsx)(Vr, { className: `icon-base rotate-90 text-token-foreground` }),
      })),
      (t[72] = me))
    : (me = t[72]);
  let W;
  ...
  let ge;
  t[80] !== W || t[81] !== he
    ? ((ge = (0, Y.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [W, he] })),
      (t[80] = W),
      (t[81] = he),
      (t[82] = ge))
    : (ge = t[82]);
  let _e;
  t[83] !== T || t[84] !== m || t[85] !== w
    ? ((_e = w
        ? (0, Y.jsxs)(`div`, {
  ...
  let ve;
  t[87] !== ge || t[88] !== _e
    ? ((ve = (0, Y.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [ge, _e] })),
      (t[87] = ge),
      (t[88] = _e),
      (t[89] = ve))
    : (ve = t[89]);
  ...
  t[95] === P
    ...
    : ((G =
      ...
      (t[96] = G));
  let Ce;
  t[97] !== ye || t[98] !== xe || t[99] !== G
    ? ((Ce = (0, Y.jsx)(xn.Footer, {
  ...
  let Te;
  return (
    t[105] !== H || t[106] !== n || t[107] !== we
      ? ((Te = (0, Y.jsx)($e, { size: `compact`, open: n, onOpenChange: H, children: we })),
        (t[105] = H),
        (t[106] = n),
        (t[107] = we),
        (t[108] = Te))
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, Y.jsx)(`span`, {
          ...
          children: (0, Y.jsx)(`span`, { className: `truncate`, children: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
function bi(e, t, n, r) {
  ...
  let u;
  return (
    i[7] === o ? (u = i[8]) : ((u = { staleTime: S.FIVE_SECONDS, ...o }), (i[7] = o), (i[8] = u)),
    Nt(e, t, `list-worktrees`, l, n, u)
  );
}
var xi,
  Si = e(() => {
...
function Ci(e) {
  let t = (0, Oi.c)(63),
    ...
    _ = $t({ branchPrefix: we(ee.branchPrefix) ?? void 0, conversationTitle: s }),
    v = h ?? (c || _),
    y = v.trim(),
    b = ot(l(Mt, i)),
    { data: x } = Ct(u, b, `move_to_local_dialog`),
    S = x?.root ?? null,
    C = S ?? u,
    w = lt(C),
    { data: E, isLoading: O, isFetching: k } = bi(S ?? u, b, `move_to_local_dialog`),
    { data: te } = rr(b, `move_to_local_dialog`),
    ne = ve(b.id),
    { data: A } = T(Yt),
    re = E?.worktrees,
    j;
  t[0] === te?.worktrees
    ? (j = t[1])
    : ((j = new Set((te?.worktrees ?? []).map(wi))), (t[0] = te?.worktrees), (t[1] = j));
  let ie = j,
    M;
  t[2] !== ne || t[3] !== ie
    ? ((M = (e) => ie.has(lt(e)) || o(e, ne)), (t[2] = ne), (t[3] = ie), (t[4] = M))
    : (M = t[4]);
  let ae = M,
    oe,
    N,
    ...
    I,
    L;
  if (t[5] !== u || t[6] !== ae || t[7] !== re || t[8] !== p || t[9] !== C || t[10] !== A?.labels) {
    let e;
    (t[17] === ae ? (e = t[18]) : ((e = (e) => !ae(e.root)), (t[17] = ae), (t[18] = e)),
      (N = yn({ cwd: u, sourceWorktreeRoot: C, repoWorktreeEntries: (re ?? []).filter(e) })));
    let n;
    (t[19] === A?.labels ? (n = t[20]) : ((n = A?.labels ?? {}), (t[19] = A?.labels), (t[20] = n)),
      (L = n),
      (F = N.find((e) => e.gitRoot === p) ?? N[0] ?? null));
    ...
    ((P = r == null ? null : D(r)),
      ...
      (t[15] = I),
      (t[16] = L));
  } else ((oe = t[11]), (N = t[12]), (P = t[13]), (F = t[14]), (I = t[15]), (L = t[16]));
  let se = I,
    ce = n && oe != null,
    R;
  t[21] === ce
    ? (R = t[22])
    : ((R = { enabled: ce, refetchOnMount: `always`, refetchOnWindowFocus: `always` }),
      (t[21] = ce),
      (t[22] = R));
  let { data: le, isLoading: z, isFetching: B } = pn(oe, b, `move_to_local_dialog`, R),
    ue = n && oe != null,
    de;
  t[23] === ue
    ? (de = t[24])
    : ((de = { enabled: ue, refetchOnMount: `always`, refetchOnWindowFocus: `always` }),
      (t[23] = ue),
      (t[24] = de));
  let { data: V, isLoading: H, isFetching: U } = Xn(oe, b, `move_to_local_dialog`, de),
    fe = (re ?? []).some((e) => {
      let t = lt(e.root);
      return !(
        ae(e.root) ||
    ...
    pe = O || k || (oe != null && (z || B || H || U)),
    me = V?.type === `success` && V.stagedCount + V.unstagedCount + V.untrackedCount > 0,
    W = null;
  if (f != null) W = f;
  else if (O || k) {
    let e;
  ...
  let he = b.kind === `local` ? `local` : `remote`,
    ge;
...
function Ti(e) {
  let t = (0, Oi.c)(109),
    ...
    te = T != null && w === T.id,
    ne = n || te,
    A = g != null || _ == null || v == null || y == null,
    re;
  t[0] !== f || t[1] !== m
    ? ((re = f == null ? null : Di({ workspaceRoot: f.workspaceRoot, workspaceRootLabels: m })),
      (t[0] = f),
      (t[1] = m),
      (t[2] = re))
    : (re = t[2]);
        ...
        A ||
          (O(
            E({
              ...
              sourceBranch: s,
              localBranch: s,
              request: { cwd: u, localGitRoot: _, localWorkspaceRoot: v, worktreeRoot: y },
              stepIds: [
  ...
  let ae = M,
    oe;
  t[15] !== D || t[16] !== te || t[17] !== r || t[18] !== x || t[19] !== T || t[20] !== ee
    ? ((oe = (e) => {
        if (!e && te) {
  ...
  if (te && T != null) {
    let e;
    t[22] !== D || t[23] !== T.id || t[24] !== T.status || t[25] !== ee
      ? ((e = () => {
          if (T.status === `success` || T.status === `error`) {
            ee(T.id);
            return;
    ...
    t[31] !== T || t[32] !== e || t[33] !== n
      ? ((r = (0, X.jsx)(Zr, { operation: T, onClose: e, onRetry: n })),
        (t[31] = T),
        (t[32] = e),
        (t[33] = n),
        (t[34] = r))
    ...
    let i;
    return (
      t[35] !== ne || t[36] !== N || t[37] !== r
        ? ((i = (0, X.jsx)($e, { size: `compact`, open: ne, onOpenChange: N, children: r })),
          (t[35] = ne),
          (t[36] = N),
          (t[37] = r),
          (t[38] = i))
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, X.jsx)(xn.Header, {
        icon: (0, X.jsx)(Vr, { className: `icon-base rotate-90 text-token-foreground` }),
      })),
      (t[41] = F))
    : (F = t[41]);
  let I;
  ...
  let B;
  t[58] !== z || t[59] !== I
    ? ((B = (0, X.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [I, z] })),
      (t[58] = z),
      (t[59] = I),
      (t[60] = B))
    : (B = t[60]);
        ...
        j == null
          ...
          : (0, X.jsxs)(`span`, {
              ...
              children: [
                ...
                (0, X.jsx)(Pe, { className: `icon-xs shrink-0 text-token-description-foreground` }),
              ],
            })),
      (t[63] = j),
      (t[64] = de));
  ...
  if (t[68] !== d || t[69] !== p || t[70] !== m) {
    ...
    (t[72] !== p || t[73] !== m
      ? ((e = (e) => {
          let t = Di({ workspaceRoot: e.workspaceRoot, workspaceRootLabels: m });
          return (0, X.jsx)(
            K.Item,
            {
              ...
              children: (0, X.jsx)(`span`, { className: `block truncate`, children: t }),
            },
            e.gitRoot,
          );
        }),
  ...
  let me;
  t[83] !== B || t[84] !== pe
    ? ((me = (0, X.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [B, pe] })),
      (t[83] = B),
      (t[84] = pe),
      (t[85] = me))
    : (me = t[85]);
  ...
  t[94] !== g || t[95] !== h
    ...
    : (_e = t[96]);
  let ve;
  t[97] !== W || t[98] !== ge || t[99] !== _e
    ? ((ve = (0, X.jsx)(xn.Footer, {
        className: `flex-col items-stretch gap-3`,
        right: (0, X.jsxs)(`div`, {
          className: `flex w-full flex-col gap-3`,
          children: [W, ge, _e],
  ...
  let be;
  return (
    t[105] !== N || t[106] !== n || t[107] !== ye
      ? ((be = (0, X.jsx)($e, { size: `compact`, open: n, onOpenChange: N, children: ye })),
        (t[105] = N),
        (t[106] = n),
        (t[107] = ye),
        (t[108] = be))
...
function Di({ workspaceRoot: e, workspaceRootLabels: t }) {
  let n = lt(e);
  return (
    (t[e]?.trim() ?? t[n]?.trim() ?? ``) ||
    e
...
function ji(e) {
  let t = (0, Fi.c)(95),
    ...
    h = l(yt, i) ?? !1,
    _ = ot(l(Mt, i)),
    [v, y] = (0, Ii.useState)(null),
    [b, x] = (0, Ii.useState)(null),
    [S, C] = (0, Ii.useState)(null),
    { activeOperationId: w } = Vt(),
    T = Wt(i),
    {
      addToWorktreeOperation: E,
      closeActiveOperation: D,
      removeOperation: O,
      openOperation: k,
      updateOperation: te,
    ...
    ne = T != null && w === T.id,
    A = n || ne,
    { data: re } = wn(u, _, `move_to_worktree_dialog`),
    j = we(ee.branchPrefix),
    ie;
  t[0] === n ? (ie = t[1]) : ((ie = { enabled: n }), (t[0] = n), (t[1] = ie));
  let { data: M, isLoading: ae, isFetching: oe } = pn(u, _, `move_to_worktree_dialog`, ie),
    N;
  t[2] !== i || t[3] !== u
    ? ((N = [`move-thread`, `to-worktree`, `resolve-owned-worktree`, i, u]),
      (t[2] = i),
      (t[3] = u),
      (t[4] = N))
    : (N = t[4]);
  ...
  let { data: I, isLoading: L } = g(F),
    ...
    z = n && R,
    B;
  t[13] === z ? (B = t[14]) : ((B = { enabled: z }), (t[13] = z), (t[14] = B));
  let {
      data: ue,
      isLoading: de,
      isFetching: V,
      isError: H,
      refetch: U,
    } = Qn(u, _, `move_to_worktree_dialog`, B),
    fe = ue === void 0 ? [] : ue,
    pe = n && ce,
    me;
  t[15] === pe ? (me = t[16]) : ((me = { enabled: pe }), (t[15] = pe), (t[16] = me));
  let { data: W } = Qn(u, _, `move_to_worktree_dialog`, me),
    he = W === void 0 ? [] : W,
    ge = I?.worktreeGitRoot != null && I?.worktreeWorkspaceRoot != null,
    _e;
  t[17] === c ? (_e = t[18]) : ((_e = (e) => !c || e !== c), (t[17] = c), (t[18] = _e));
  let ve = Pi({ branches: fe, defaultBranch: re ?? null }).filter(_e),
    ye = de || V,
    xe = $t({ branchPrefix: j ?? void 0, conversationTitle: o }),
    G = R && v && ve.includes(v) ? v : R ? (ve[0] ?? null) : null,
    Ce = ce ? (S ?? xe) : c,
    Te = Ce.trim(),
    Ee = Te.length === 0,
    De = Te.endsWith(`/`),
    Oe = re != null && Te === re,
    ke = ce && Te.length > 0 && he.includes(Te),
    Ae = le || L || (R && ye),
    je = null;
  if (m != null) je = m;
  else if (Ae) {
  ...
  let Ie = Fe,
    Re;
  t[33] !== D || t[34] !== ne || t[35] !== r || t[36] !== T || t[37] !== O
    ? ((Re = (e) => {
        if (!e && ne) {
          if (T?.status === `success` || T?.status === `error`) {
            (O(T.id), r(!1));
      ...
      Me ||
        (k(
          E({
            ...
            request: {
              cwd: u,
              defaultBranch: re ?? null,
              existingWorktreeGitRoot: I?.worktreeGitRoot ?? null,
              existingWorktreeWorkspaceRoot: I?.worktreeWorkspaceRoot ?? null,
              targetHasUncommittedChanges: I?.hasUncommittedChanges ?? !1,
            },
            stepIds: [
              ge ? `reuse-existing-worktree` : `create-new-worktree`,
              `stash-source-changes`,
              `checkout-local-branch`,
  ...
  if (ne && T != null) {
    let e;
    t[39] !== D || t[40] !== T.id || t[41] !== T.status || t[42] !== O
      ? ((e = () => {
          if (T.status === `success` || T.status === `error`) {
            O(T.id);
            return;
    ...
    t[48] !== T || t[49] !== e || t[50] !== n
      ? ((r = (0, Z.jsx)(Zr, { operation: T, onClose: e, onRetry: n })),
        (t[48] = T),
        (t[49] = e),
        (t[50] = n),
        (t[51] = r))
    ...
    let i;
    return (
      t[52] !== A || t[53] !== ze || t[54] !== r
        ? ((i = (0, Z.jsx)($e, { size: `compact`, open: A, onOpenChange: ze, children: r })),
          (t[52] = A),
          (t[53] = ze),
          (t[54] = r),
          (t[55] = i))
  ...
  t[56] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = (0, Z.jsx)(xn.Header, {
        icon: (0, Z.jsx)(Vr, { className: `icon-base rotate-90 text-token-foreground` }),
      })),
      (t[56] = Ue))
    : (Ue = t[56]);
  let We;
  ...
  let qe = R
      ...
      : null,
    Je;
  t[60] !== Be || t[61] !== p || t[62] !== ce || t[63] !== Ce
    ? ((Je = ce
        ? (0, Z.jsxs)(`div`, {
            className: `flex flex-col gap-2`,
            children: [
    ...
    : (Je = t[64]);
  let Ye;
  t[65] !== Ke || t[66] !== qe || t[67] !== Je
    ? ((Ye = (0, Z.jsxs)(`div`, { className: `flex flex-col gap-5`, children: [Ke, qe, Je] })),
      (t[65] = Ke),
      (t[66] = qe),
      (t[67] = Je),
      (t[68] = Ye))
  ...
  t[71] === Ae
    ...
    : ((Ze = Ae
      ...
      (t[72] = Ze));
  let Qe;
  t[73] !== Be || t[74] !== Me || t[75] !== Ae || t[76] !== Ze
    ? ((Qe = (0, Z.jsx)(Se, {
        className: `h-11 w-full justify-center rounded-full px-4 text-base font-medium`,
        color: `primary`,
        disabled: Me,
  ...
  t[78] !== je || t[79] !== Ae
    ...
    : (et = t[80]);
  let tt;
  t[81] !== Xe || t[82] !== Qe || t[83] !== et
    ? ((tt = (0, Z.jsx)(xn.Footer, {
        className: `flex-col items-stretch gap-3`,
        right: (0, Z.jsxs)(`div`, {
          className: `flex w-full flex-col gap-3`,
          children: [Xe, Qe, et],
    ...
    : (tt = t[84]);
  let nt;
  t[85] !== He.Root || t[86] !== Ue || t[87] !== Ye || t[88] !== tt
    ? ((nt = (0, Z.jsxs)(He.Root, { className: `gap-5`, children: [Ue, Ye, tt] })),
      (t[85] = He.Root),
      (t[86] = Ue),
      (t[87] = Ye),
      (t[88] = tt),
  ...
  let rt;
  return (
    t[90] !== Ve || t[91] !== ze || t[92] !== n || t[93] !== nt
      ? ((rt = (0, Z.jsx)(Ve, { size: `compact`, open: n, onOpenChange: ze, children: nt })),
        (t[90] = Ve),
        (t[91] = ze),
        (t[92] = n),
        (t[93] = nt),
...
function Pi({ branches: e, defaultBranch: t }) {
...
function Ri(e) {
  ...
  if (r) {
    let e;
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Wi.jsx)(W, { href: i, className: Gi })), (t[0] = e))
      : (e = t[0]);
    let n;
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  t[8] === l
    ? (u = t[9])
    : ((u = (0, Wi.jsx)(`span`, { className: `text-token-description-foreground`, children: l })),
      (t[8] = l),
      (t[9] = u));
  let d;
  return (
...
function Bi(e) {
  ...
  let h;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Wi.jsx)(it, { className: `icon-xxs` })), (t[4] = h))
    : (h = t[4]);
  let g;
  t[5] !== p || t[6] !== m
    ? ((g = (0, Wi.jsx)(Se, {
  ...
  t[30] !== o || t[31] !== n?.label
    ? ((w =
        ...
        (0, Wi.jsx)(`div`, {
          ...
          children: (0, Wi.jsxs)(`span`, {
            className: `flex items-center gap-1.5`,
            children: [
              (0, Wi.jsx)(nr, { className: `icon-xs` }),
              (0, Wi.jsx)(`span`, {
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Wi.jsx)(K.Separator, {})), (t[38] = E))
    : (E = t[38]);
  let D;
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, Wi.jsx)(W, { href: `${i}/settings/environments`, className: Gi })), (t[39] = D))
    : (D = t[39]);
  let ee;
  ...
  let O;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, Wi.jsx)(W, { href: Ki, className: Gi })), (t[41] = O))
    : (O = t[41]);
  let k;
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, Wi.jsxs)(K.Section, {
...
function Vi(e) {
  ze({ disposition: `current-tab`, event: e, href: Ki, initiator: `open_in_browser_bridge` });
}
function Hi(e) {
  ze({
...
var Ui,
  ...
  qi = e(() => {
    ((Ui = v()),
      ...
      Te(),
      (Wi = x()),
      (Gi = `icon-xs shrink-0 opacity-75 group-focus:opacity-100 group-hover:opacity-100`),
      (Ki = `https://platform.openai.com/docs/codex/overview#environment-configuration`));
  });
function Ji(e) {
  let t = (0, ha.c)(151),
    {
      ...
      isBrowser: m,
      isLocalModeRemote: h,
      currentLocalModeRemoteState: g,
      crossHostHandoffEnabled: _,
      ...
      worktreeTooltipText: ne,
      closeDropdown: A,
      openHandoffDialog: re,
      openHostWorktreeHandoffDialog: j,
    } = e,
    ie = f(s),
    M = St(),
    { activeMode: ae } = gn(a),
    ...
    I = F?.plan_type,
    L;
  t[0] === I ? (L = t[1]) : ((L = jn(I)?.pricePlan ?? null), (t[0] = I), (t[1] = L));
  let se = L,
    R = F?.rate_limit,
    le = F?.credits,
    z;
  t[2] !== I || t[3] !== R || t[4] !== le
    ? ((z = Bn(R, le, I)), (t[2] = I), (t[3] = R), (t[4] = le), (t[5] = z))
    : (z = t[5]);
  let B = z,
    ue,
    V,
  ...
  if (
    ...
    let e = Fn(F),
      n = Ln(F);
    ((V = Rn(e, { activeLimitName: n, selectedModel: N })),
      (ue = V.find(Zi)?.limitName ?? n ?? null),
      (H = zn(F, { activeLimitName: n, selectedModel: N })),
      (U = V.some(Xi) || !!B?.primary?.windowDurationMins || !!B?.secondary?.windowDurationMins),
      (t[6] = B?.primary?.windowDurationMins),
      (t[7] = B?.secondary?.windowDurationMins),
      (t[8] = F),
      (t[9] = N),
      ...
      (t[12] = H),
      (t[13] = U));
  } else ((ue = t[10]), (V = t[11]), (H = t[12]), (U = t[13]));
  let fe = U,
    pe = Nn(),
    me = An(),
    he = se != null && me !== `web`,
  ...
  t[14] !== c.hostConfig || t[15] !== w
    ...
    : (ve = t[16]);
  let ye = l(oe, ve),
    be = ye ?? M.formatMessage($.fallbackBranch),
    xe = Wt(a),
    G = v ? kr(xe) : xe,
    ...
    Te = l(Ot, a),
    { openOperation: Ee } = Ht(),
    De = o(h ? null : c.activeWorkspaceRoot, ge?.codexHome),
    Oe = ye ?? fa(xe, a) ?? (v ? Te : null),
    ke = Or({ codexWorktree: De, operation: Se, threadHandoff: d }),
    Ae = jr({
      conversationId: a,
      handoffBranch: Oe,
      handoffDirection: ke,
  ...
  t[20] === G
    ...
    : ((Pe =
        G?.status === `queued` || G?.status === `running`
          ? (0, Q.jsx)(ce, { className: `icon-2xs` })
          : G?.status === `error`
            ? (0, Q.jsx)(Rr, { className: `icon-2xs text-token-danger` })
            : G?.hasUnseenTerminalState && G.status === `warning`
              ? (0, Q.jsx)(Rr, { className: `icon-2xs text-token-editor-warning-foreground` })
              : (0, Q.jsx)(Vr, { className: `icon-2xs rotate-90` })),
      (t[20] = G),
      (t[21] = Pe));
  let Fe = Pe,
    Ie;
  t[22] !== Fe || t[23] !== G?.direction
    ? ((Ie =
  ...
  let Le = Ie,
    Re;
  t[25] !== we || t[26] !== Ne || t[27] !== M || t[28] !== Se
    ? ((Re = we ? M.formatMessage($.finishCurrentHandoffTooltip) : Se == null ? void 0 : Ne),
      (t[25] = we),
      (t[26] = Ne),
      (t[27] = M),
      (t[28] = Se),
  ...
  let ze = Re,
    Be = h
      ? M.formatMessage($.workRemotelyTooltipWithoutPath, {
          hostDisplayName: g?.connectionDisplayName ?? x,
        })
      : M.formatMessage($.workLocallyTooltip, { branchName: be }),
    Ve;
  t[30] !== A || t[31] !== re || t[32] !== Ee || t[33] !== Se
    ? ((Ve = () => {
        if ((A(), Se != null)) {
          (re(), Ee(Se.id));
          return;
    ...
    : (Ve = t[34]);
  let We = Ve,
    Ge = v && ((a != null && d != null) || G?.direction === `to-host-worktree`),
    Ke;
  t[35] !== n || t[36] !== c.hostConfig || t[37] !== w
    ? ((Ke = (0, Q.jsx)(ua, { composerMode: n, gitRoot: w, hostConfig: c.hostConfig })),
      (t[35] = n),
      (t[36] = c.hostConfig),
      (t[37] = w),
      (t[38] = Ke))
  ...
  let Je = p === `enabled` ? `min-w-[175px]` : `w-52`,
    Ye;
  t[44] === Je ? (Ye = t[45]) : ((Ye = Ue(`flex flex-col`, Je)), (t[44] = Je), (t[45] = Ye));
  let Xe;
  t[46] === u.isAttachedToStartedTask
    ? (Xe = t[47])
    : ((Xe = (0, Q.jsx)(K.Title, {
      ...
      (t[46] = u.isAttachedToStartedTask),
      (t[47] = Xe));
  let Ze = n === `local` ? _e : void 0,
    Qe;
  t[48] !== A || t[49] !== n || t[50] !== ie || t[51] !== r
    ? ((Qe = () => {
        (n !== `local` && st(ie, _t, { mode: `local` }), r(`local`), A());
      }),
      (t[48] = A),
      (t[49] = n),
      (t[50] = ie),
    ...
    : (Qe = t[52]);
  let $e;
  t[53] !== Ce || t[54] !== M || t[55] !== Be
    ? (($e = Ce ? M.formatMessage($.finishCurrentHandoffTooltip) : Be),
      (t[53] = Ce),
      (t[54] = M),
      (t[55] = Be),
      (t[56] = $e))
  ...
  t[57] === h
    ? (et = t[58])
    : ((et = h ? (0, Q.jsx)(q, { ...$.startInRemote }) : (0, Q.jsx)(q, { ...$.workLocally })),
      (t[57] = h),
      (t[58] = et));
  let tt;
  t[59] !== b || t[60] !== Ce || t[61] !== Ze || t[62] !== Qe || t[63] !== $e || t[64] !== et
    ? ((tt = (0, Q.jsx)(K.Item, {
        LeftIcon: b,
        RightIcon: Ze,
        disabled: Ce,
  ...
  t[75] !== ne
    ? ((nt =
        ...
        (0, Q.jsx)(K.Item, {
          LeftIcon: te,
          RightIcon: n === `worktree` ? _e : void 0,
          disabled: Ce,
          onClick: () => {
            (n !== `worktree` && st(ie, _t, { mode: `worktree` }), r(`worktree`), A());
          },
          tooltipText: Ce ? M.formatMessage($.finishCurrentHandoffTooltip) : ne,
          children: (0, Q.jsxs)(`span`, {
            className: `inline-flex items-center gap-1`,
            children: [
              h ? (0, Q.jsx)(q, { ...$.remoteWorktreeMode }) : (0, Q.jsx)(q, { ...$.worktreeMode }),
              qe,
            ],
          }),
        })),
  ...
  t[84] !== r
    ? ((rt =
        C || m
          ? p === `enabled`
            ? (0, Q.jsx)(K.Item, {
                LeftIcon: dn,
                RightIcon: n === `cloud` ? _e : void 0,
                disabled: Ce,
                onClick: () => {
                  (n !== `cloud` && st(ie, _t, { mode: `cloud` }), r(`cloud`));
                },
                tooltipText: Ce
                  ? M.formatMessage($.finishCurrentHandoffTooltip)
                  : M.formatMessage({
                ...
                children: (0, Q.jsx)(q, { ...$.runInCloud }),
              })
            : (0, Q.jsxs)(Q.Fragment, {
                children: [
                  (0, Q.jsx)(K.Item, {
                    LeftIcon: Hn,
                    rightIcon: (0, Q.jsx)(W, { href: i, className: _a }),
                    href: i,
                    onClick: Yi,
                    children: (0, Q.jsx)(q, {
    ...
    : (rt = t[85]);
  let it;
  t[86] !== p || t[87] !== k || t[88] !== E
    ? ((it = p === `enabled` ? (0, Q.jsx)(Qi, { selectedEnvironment: E, onClick: k }) : null),
      (t[86] = p),
      (t[87] = k),
      (t[88] = E),
      (t[89] = it))
  ...
  t[90] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((at = (0, Q.jsx)(`div`, { className: `mx-1 my-1.5 h-[0.5px] bg-token-foreground/10` })),
      (t[90] = at))
    : (at = t[90]);
  let ot;
  t[91] !== ue ||
  ...
  t[100] !== pe
    ? ((ot =
        ...
        (0, Q.jsx)(Kt, {
          ...
          suppressUpsell: H,
          selectedModel: N,
          planUpgradeOpensNativeSurface: he,
          onPlanUpgradeClick:
            se == null
              ? void 0
              : (e) => {
  ...
  let ct;
  t[102] !== it || t[103] !== ot
    ? ((ct = (0, Q.jsxs)(He, { extension: !0, children: [it, at, ot] })),
      (t[102] = it),
      (t[103] = ot),
      (t[104] = ct))
    : (ct = t[104]);
  ...
  t[114] !== pe
    ? ((lt =
        ...
        (0, Q.jsxs)(Q.Fragment, {
          children: [
            (0, Q.jsx)(`div`, { className: `mx-1 my-1.5 h-[0.5px] bg-token-foreground/10` }),
            (0, Q.jsx)(Kt, {
              rateLimits: V,
              activeLimitName: ue,
              planType: I,
        ...
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              ...
              (0, Q.jsxs)(K.Item, {
                ...
                tooltipText: ze,
                children: [
                  (0, Q.jsx)(K.ItemIcon, { children: Le }),
                  (0, Q.jsx)(ea, { useContinueLabel: _, direction: ke, isRemoteHost: h }),
                ],
              }),
            ],
          })
  ...
  return (
    ...
    t[148] !== ut ||
    t[149] !== dt
      ? ((ft = (0, Q.jsxs)(`div`, { className: Ye, children: [Xe, tt, nt, rt, ct, lt, ut, dt] })),
        (t[141] = Ye),
        (t[142] = Xe),
        (t[143] = tt),
        (t[144] = nt),
...
function Qi(e) {
  let t = (0, ha.c)(4),
    ...
    { zeroEnvironments: i } = ar(``),
    a;
  return (
    t[0] !== r || t[1] !== n || t[2] !== i
      ? ((a = (0, Q.jsx)(Ri, { selectedEnvironment: n, zeroEnvironments: i, onClick: r })),
        (t[0] = r),
        (t[1] = n),
        (t[2] = i),
        (t[3] = a))
...
function $i(e) {
  ...
  t[4] !== n || t[5] !== a || t[6] !== i || t[7] !== r
    ? ((b = a && Ar({ conversationId: n, operation: i, threadHandoff: r })),
      (t[4] = n),
      (t[5] = a),
      (t[6] = i),
      (t[7] = r),
  ...
  let x = b,
    S;
  t[9] !== _ || t[10] !== i
    ? ((S = i == null ? void 0 : _.formatMessage($.finishCurrentHandoffTooltip)),
      (t[9] = _),
      (t[10] = i),
      (t[11] = S))
    : (S = t[11]);
  ...
  t[12] !== w || t[13] !== i
    ? ((T =
        w != null && Mr({ destinationHostId: `local`, destinationWorkspaceRoot: w, operation: i })),
      (t[12] = w),
      (t[13] = i),
      (t[14] = T))
    : (T = t[14]);
  let E = T,
    D = w != null && !x && !E,
    ee;
  t[15] !== x || t[16] !== m || t[17] !== o || t[18] !== i || t[19] !== h || t[20] !== g
    ? ((ee = (e) => {
        let { destinationHostId: t, destinationWorkspaceRoot: n, destinationLabel: r } = e;
        if (i != null && Mr({ destinationHostId: t, destinationWorkspaceRoot: n, operation: i })) {
          (m(),
            h({
              currentBranch: o ?? ``,
              destinationHostId: t,
    ...
    : (ee = t[21]);
  let k = ee;
  if (i?.direction !== `to-host-worktree` && p == null && y.length === 0) return null;
  let te;
  t[22] === c
    ? (te = t[23])
    : ((te = c ? (0, Q.jsx)(K.Separator, {}) : null), (t[22] = c), (t[23] = te));
  let ne;
  t[24] !== C ||
  t[25] !== k ||
  t[26] !== s ||
    ...
    ? ((ne =
        w == null
          ...
          : (0, Q.jsxs)(K.Item, {
              ...
              children: [
                (0, Q.jsx)(K.ItemIcon, {
                  children: E ? s : (0, Q.jsx)(O, { className: `icon-2xs` }),
                }),
                (0, Q.jsx)(q, {
  ...
  if (
    ...
    let e;
    (t[40] !== x || t[41] !== C || t[42] !== k || t[43] !== s || t[44] !== _ || t[45] !== i
      ? ((e = (e) => {
          if (e.status !== `ready`) {
          ...
          return (0, Q.jsx)(
            ta,
            {
              hostDisplayName: t,
              disabled: a,
              icon: r ? s : (0, Q.jsx)(je, { className: `icon-2xs` }),
  ...
  let re;
  return (
    t[47] !== te || t[48] !== ne || t[49] !== A
      ? ((re = (0, Q.jsxs)(Q.Fragment, { children: [te, ne, A] })),
        (t[47] = te),
        (t[48] = ne),
        (t[49] = A),
        (t[50] = re))
...
function ta(e) {
  let t = (0, ha.c)(10),
    ...
    s;
  t[0] === i ? (s = t[1]) : ((s = (0, Q.jsx)(K.ItemIcon, { children: i })), (t[0] = i), (t[1] = s));
  let c;
  t[2] === n
    ? (c = t[3])
    : ((c = (0, Q.jsx)(q, {
  ...
  return (
    t[4] !== r || t[5] !== o || t[6] !== s || t[7] !== c || t[8] !== a
      ? ((l = (0, Q.jsxs)(K.Item, { disabled: r, onSelect: o, tooltipText: a, children: [s, c] })),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s),
        (t[7] = c),
...
function na(e) {
  let t = (0, ha.c)(11),
    ...
    [o, s] = (0, ga.useState)(``),
    { envListState: c, listToShow: l } = ar(o, n, i),
    u;
...
function ia(e) {
  ...
  return (
    t[11] === s
      ? (c = t[12])
      : ((c = (0, Q.jsx)(Q.Fragment, { children: s })), (t[11] = s), (t[12] = c)),
    c
  );
}
function aa(e) {
...
function sa(e) {
  let t = (0, ha.c)(64),
    {
      ...
      triggerVariant: _,
      openHandoffDialog: v,
      openHostWorktreeHandoffDialog: y,
  ...
  let C = l(oe, S),
    ...
    D = T?.status === `queued` || T?.status === `running`,
    ee = T?.direction === `to-host-worktree` && D,
    O = l(Ot, c),
    { openOperation: k } = Ht(),
    ne = C ?? fa(w, c) ?? (s ? O : null),
    A = jr({
      conversationId: c,
      handoffBranch: ne,
      handoffDirection: Or({ codexWorktree: !1, operation: E, threadHandoff: p }),
      operation: T,
      threadHandoff: p,
    }),
    re = ee,
  ...
  let P = N,
    F;
  t[11] !== ee || t[12] !== ie || t[13] !== x || t[14] !== E
    ? ((F = ee ? x.formatMessage($.finishCurrentHandoffTooltip) : E == null ? void 0 : ie),
      (t[11] = ee),
      (t[12] = ie),
      (t[13] = x),
      (t[14] = E),
  ...
  t[16] !== r || t[17] !== v || t[18] !== k || t[19] !== E
    ...
    : (L = t[20]);
  let se = L,
    R = s && ((c != null && p != null) || T?.direction === `to-host-worktree`),
    le = A || (R && (T?.direction === `to-host-worktree` || b != null)),
    z;
  t[21] !== u.cwd || t[22] !== A || t[23] !== le || t[24] !== s || t[25] !== _ || t[26] !== m
    ? ((z =
        _ === `summary-panel`
          ? (0, Q.jsx)(Sn, {
              icon: (0, Q.jsx)(te, { className: `icon-sm shrink-0 text-token-foreground` }),
              label: (0, Q.jsxs)(`span`, {
                className: `flex min-w-0 items-center gap-1 text-token-foreground`,
                children: [
                  (0, Q.jsx)(`span`, { className: `min-w-0 truncate`, children: m }),
                  A
                    ? (0, Q.jsx)(Pe, { className: `icon-2xs shrink-0 text-token-text-tertiary` })
                    : null,
                ],
              }),
              ...
              title: u.cwd ?? void 0,
              trailing:
                s && le ? (0, Q.jsx)(ue, { className: `icon-xs text-token-text-tertiary` }) : null,
            })
          : (0, Q.jsx)(Gn, {
              categoryLabel: null,
              collapse: `none`,
              icon: null,
              indicator: le ? `chevron` : `none`,
              value: m,
    ...
    : (z = t[27]);
  let B = z,
    de = _ === `summary-panel` && `w-full`,
    V;
  t[28] === de ? (V = t[29]) : ((V = Ue(de)), (t[28] = de), (t[29] = V));
  let H;
  t[30] !== a ||
  t[31] !== c ||
  t[32] !== o ||
    ...
    ? ((H = le
        ? (0, Q.jsx)(Ne, {
            ...
            triggerButton:
              _ === `summary-panel`
                ? B
                : (0, Q.jsx)(rt, { tooltipContent: h, tooltipMaxWidth: g, children: B }),
            children: (0, Q.jsxs)(`div`, {
              className: Ue(`flex flex-col`, s ? `min-w-[220px]` : `min-w-[180px]`),
              children: [
                s
                  ? (0, Q.jsx)(K.Title, {
                      children: (0, Q.jsx)(q, {
                ...
                A
                  ? (0, Q.jsxs)(K.Item, {
                      ...
                      tooltipText: I,
                      children: [
                        (0, Q.jsx)(K.ItemIcon, { children: P }),
                        (0, Q.jsx)(ea, {
                          useContinueLabel: s,
                          direction: `to-local`,
                          isRemoteHost: u.hostId !== wt,
                        }),
                      ],
                    })
                  : null,
                ...
                s && a === `enabled`
                  ? (0, Q.jsxs)(K.Item, {
                      ...
                      children: [
                        (0, Q.jsx)(K.ItemIcon, {
                          children: (0, Q.jsx)(dn, { className: `icon-2xs` }),
                        }),
                        (0, Q.jsx)(q, { ...$.runInCloud }),
                      ],
                    })
                  : null,
              ],
        ...
        : (0, Q.jsx)(rt, {
            ...
            children: (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(`div`, { className: `pointer-events-none`, children: B }),
            }),
          })),
      (t[30] = a),
      (t[31] = c),
  ...
  return (
    t[61] !== H || t[62] !== V
      ? ((U = (0, Q.jsx)(`div`, { className: V, children: H })),
        (t[61] = H),
        (t[62] = V),
        (t[63] = U))
      : (U = t[63]),
...
function ca(e) {
  ...
  let m = l(oe, p),
    ...
    _ = l(Ot, r),
    v = Or({
      codexWorktree: o(u ? null : a.activeWorkspaceRoot, f?.codexHome),
      operation: g,
      threadHandoff: c,
    }),
    y;
  ...
  if (
    (t[0] !== r || t[1] !== i || t[2] !== a
      ? ((o = {
        ...
        (t[3] = o))
      : (o = t[3]),
    !((l(qn, o)?.length ?? 0) > 0) || n !== `worktree`)
  )
    return null;
  let s;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(q, { ...$.worktreeSubmoduleWarning })), (t[4] = s))
    : (s = t[4]);
  let c;
  return (
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
...
function da(e) {
  let t = (0, ha.c)(9),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = un(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === r
    ? (o = t[3])
  ...
  return (
    t[6] !== o || t[7] !== s
      ? ((c = (0, Q.jsxs)(Q.Fragment, { children: [o, s] })), (t[6] = o), (t[7] = s), (t[8] = c))
      : (c = t[8]),
    c
  );
}
...
function pa({ executionTargetCwd: e, footerRemoteState: t, remoteConnections: n }) {
  ...
  if (t.isAttachedToStartedTask)
    return r.hostId === `local`
      ...
      : {
          hostId: r.hostId,
          connectionDisplayName: r.connectionDisplayName ?? ma(n, r.hostId),
  ...
  return a == null || a === `local` || o == null
    ? null
    : { hostId: a, connectionDisplayName: i?.connectionDisplayName ?? ma(n, a), projectPath: o };
}
function ma(e, t) {
...
var ha,
  ...
  ya = e(() => {
    ((ha = v()),
      ...
      ne(),
      (Q = x()),
      (_a = `icon-xs shrink-0 opacity-75 group-focus:opacity-100 group-hover:opacity-100`),
      (va = (0, ga.memo)(function (e) {
        let t = (0, ha.c)(177),
          ...
          b = p === void 0 ? !1 : p,
          x = m === void 0 ? `top` : m,
          S = h === void 0 ? `composer` : h,
          C = f(P),
          [w, ee] = (0, ga.useState)(!1),
          [ne, A] = (0, ga.useState)(!1),
          re = n === `cloud` || w,
          j = St(),
          ie = Ft(`505458`),
          M = Ft(`2256010998`),
          ae = Wt(i),
          oe = M || ae?.direction === `to-host-worktree`,
          { access: N } = kn(),
          F = k(i),
          I = a ?? F,
          ce = Et(),
          R;
        t[0] !== I.cwd || t[1] !== o || t[2] !== ce
          ? ((R = pa({ executionTargetCwd: I.cwd, footerRemoteState: o, remoteConnections: ce })),
            (t[0] = I.cwd),
            (t[1] = o),
            (t[2] = ce),
            (t[3] = R))
        ...
        let V = l(At, de),
          ...
          U = ue?.root ?? null,
          { data: fe } = T(Yt),
          pe = oe && w && I.hostId !== `local` ? fe?.roots : void 0,
          me;
        t[10] === pe ? (me = t[11]) : ((me = pe ?? []), (t[10] = pe), (t[11] = me));
        let W;
        t[12] === me
          ? (W = t[13])
          : ((W = { params: { hostId: wt, dirs: me }, source: `local_remote_dropdown` }),
            (t[12] = me),
            (t[13] = W));
        let { data: ge } = l(he, W),
          _e;
        t[14] === I.cwd
          ? (_e = t[15])
          : ((_e = I.cwd == null ? [] : [I.cwd]), (t[14] = I.cwd), (t[15] = _e));
        let ve;
        t[16] !== I.hostId || t[17] !== _e
          ? ((ve = { params: { hostId: I.hostId, dirs: _e }, source: `local_remote_dropdown` }),
            (t[16] = I.hostId),
            (t[17] = _e),
            (t[18] = ve))
          : (ve = t[18]);
          ...
          ? ((be =
              pe == null
                ...
                : L({
                    ...
                    sourceGitRoot: U,
                    sourceGitOrigins: ye?.origins,
                    destinationWorkspaceRoots: pe,
                    destinationGitOrigins: ge?.origins,
                  })),
            (t[19] = I.cwd),
            (t[20] = U),
            (t[21] = ge?.origins),
        ...
        let xe = be,
          G;
        t[25] !== N || t[26] !== H
          ? ((G = gr({ cloudAccess: N, hasGitRepository: H, isBrowser: !1 })),
            (t[25] = N),
            (t[26] = H),
            (t[27] = G))
          : (G = t[27]);
          ...
          : ((Oe = Te
              ? (0, Q.jsxs)(Q.Fragment, {
                  children: [
                    (0, Q.jsx)(q, { ...$.runInCloud }),
                    (0, Q.jsx)(`span`, {
                      className: rn.runLocationEnvironmentSuffix,
                      children: (0, Q.jsx)(q, {
              ...
              : (0, Q.jsxs)(Q.Fragment, {
                  children: [
                    (0, Q.jsx)(`span`, {
                      className: rn.defaultExternalFooterOnly,
                      children: (0, Q.jsx)(q, { ...$.selectEnvironment }),
                    }),
                    (0, Q.jsx)(`span`, {
                      className: Ue(rn.homeExternalFooterOnly, `hidden`),
                      children: (0, Q.jsx)(q, { ...$.runInCloud }),
                    }),
                  ],
                })),
        ...
        let Me = Ae,
          ...
          Ie;
        t[32] !== j || t[33] !== z
          ? ((Ie = z ? j.formatMessage($.startInRemote) : j.formatMessage($.workLocally)),
            (t[32] = j),
            (t[33] = z),
            (t[34] = Ie))
          : (Ie = t[34]);
        ...
        let K = We,
          Ge;
        (t[42] !== Fe || t[43] !== Le || t[44] !== Be || t[45] !== Ve || t[46] !== K
          ? ((Ge = {
              id: `local`,
              title: Le,
              description: Be,
        ...
        let Ke;
        t[48] !== j || t[49] !== z
          ? ((Ke = z ? j.formatMessage($.remoteWorktreeMode) : j.formatMessage($.worktreeMode)),
            (t[48] = j),
            (t[49] = z),
            (t[50] = Ke))
          : (Ke = t[50]);
        ...
        let Xe = Ye,
          Ze;
        (t[55] !== Ke || t[56] !== qe || t[57] !== Je || t[58] !== Xe
          ? ((Ze = {
              id: `worktree`,
              title: Ke,
              description: qe,
        ...
        t[60] === j
          ? ($e = t[61])
          : (($e = j.formatMessage($.runInCloud)), (t[60] = j), (t[61] = $e));
        let et;
        t[62] === j
          ? (et = t[63])
          : ((et = j.formatMessage({
        ...
        let it = nt,
          at;
        (t[66] !== $e || t[67] !== et || t[68] !== tt || t[69] !== it
          ? ((at = {
              id: `cloud`,
              title: $e,
              description: et,
        ...
        t[71] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((ot = (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(`span`, {
                className: `truncate`,
                children: (0, Q.jsx)(q, { ...$.worktreeSegment }),
              }),
            })),
            (t[71] = ot))
          : (ot = t[71]);
        ...
        t[81] !== s
          ? ((ft = () => {
              i == null ||
                ...
                se(C, ca, {
                  conversationId: i,
                  composerViewState: C.get(Ee),
                  executionTarget: I,
                  gitRoot: U,
                  isLocalModeRemote: z,
                  threadHandoff: s,
                  showCrossHostHandoff: oe,
                });
            }),
            (t[75] = i),
            (t[76] = I),
        ...
        t[83] !== i || t[84] !== C || t[85] !== s
          ...
          : (mt = t[86]);
        let ht = mt,
          gt = S === `summary-panel` ? `icon-sm text-token-foreground` : `icon-xs`,
          _t;
        t[87] !== n || t[88] !== z || t[89] !== gt
          ? ((_t =
              n === `cloud`
                ? (0, Q.jsx)(dn, { className: gt })
                : n === `worktree`
                  ? (0, Q.jsx)(te, { className: gt })
                  : z
                    ? (0, Q.jsx)(je, { className: gt })
                    : (0, Q.jsx)(O, { className: gt })),
            (t[87] = n),
            (t[88] = z),
            (t[89] = gt),
            (t[90] = _t))
              ...
              n === `cloud`
                ...
                : n === `worktree`
                  ? (0, Q.jsx)(`span`, {
                      className: `inline-flex items-center gap-1`,
                      children: z
                        ? (0, Q.jsx)(q, { ...$.remoteWorktreeMode })
                        : (0, Q.jsx)(q, { ...$.worktreeMode }),
                    })
                  : S === `summary-panel` && !z
                    ? (0, Q.jsx)(q, { ...$.localShort })
                    : z
                      ? (0, Q.jsx)(da, { rateLimit: null, isRemoteHost: z })
                      : (0, Q.jsxs)(Q.Fragment, {
                          children: [
                            (0, Q.jsx)(`span`, {
                              className: rn.defaultExternalFooterOnly,
                              children: (0, Q.jsx)(da, { rateLimit: null, isRemoteHost: !1 }),
                            }),
                            (0, Q.jsx)(`span`, {
                              className: Ue(rn.homeExternalFooterOnly, `hidden`),
                              children: (0, Q.jsx)(q, { ...$.localShort }),
                            }),
                          ],
                        })),
            (t[91] = ke),
        ...
        let bt = yt,
          xt;
        t[96] !== v || t[97] !== j || t[98] !== vt || t[99] !== bt || t[100] !== S
          ? ((xt =
              S === `summary-panel`
                ? (0, Q.jsx)(Sn, {
                    disabled: v,
                    icon: (0, Q.jsx)(`span`, { className: `shrink-0`, children: vt }),
                    label: (0, Q.jsxs)(`span`, {
                      className: `flex min-w-0 items-center gap-1 text-token-foreground`,
                      children: [
                        (0, Q.jsx)(`span`, { className: `min-w-0 truncate`, children: bt }),
                        v
                          ? null
                          : (0, Q.jsx)(Pe, {
              ...
              (0, Q.jsx)(Ne, {
                ...
                triggerButton:
                  S === `summary-panel`
                    ? Ct
                    : (0, Q.jsx)(rt, {
                        tooltipContent: (0, Q.jsx)(q, { ...$.localRemoteWhereRun }),
                        children: Ct,
                      }),
                children: (0, Q.jsx)(Ji, {
                  composerMode: n,
                  ...
                  isBrowser: !1,
                  isLocalModeRemote: z,
                  currentLocalModeRemoteState: le,
                  crossHostHandoffEnabled: M,
                  showCrossHostHandoff: oe,
                  localWorkspaceRootForHandoff: xe,
                  localModeIcon: Fe,
                  remoteLabel: Me,
                  showWorktree: we,
                  hasGitRepo: H,
                  gitRoot: U,
                  selectedEnvironment: Te,
                  setSelectedEnvironment: De,
                  environmentSelectorOpen: ne,
                  setEnvironmentSelectorOpen: A,
                  openEnvironmentSelector: dt,
                  worktreeTooltipText: ze,
                  closeDropdown: () => ee(!1),
                  openHandoffDialog: pt,
                  openHostWorktreeHandoffDialog: ht,
                }),
              })),
            (t[102] = Fe),
            (t[103] = N),
        ...
        let Mt = jt,
          Nt = y || (i == null && !z && !V && !H),
          Pt;
        t[152] !== Dt || t[153] !== Nt || t[154] !== b || t[155] !== Mt
          ? ((Pt = Nt ? null : b ? Mt : Dt()),
            (t[152] = Dt),
            (t[153] = Nt),
            (t[154] = b),
        ...
        t[157] === re
          ? (Rt = t[158])
          : ((Rt = re ? (0, Q.jsx)(En, {}) : null), (t[157] = re), (t[158] = Rt));
        let zt;
        t[159] !== Se || t[160] !== n || t[161] !== Te || t[162] !== r || t[163] !== De
          ? ((zt =
              Se && n === `cloud`
                ? (0, Q.jsx)(ra, {
                    selectedEnvironment: Te,
          ...
          : (zt = t[164]);
        let Bt;
        t[165] !== Se || t[166] !== n || t[167] !== Te || t[168] !== De
          ? ((Bt =
              Se && n === `cloud` && Te == null
                ? (0, Q.jsx)(oa, { setSelectedEnvironment: De })
                : null),
            (t[165] = Se),
            (t[166] = n),
            (t[167] = Te),
        ...
        t[170] === Lt
          ? (Vt = t[171])
          : ((Vt = (0, Q.jsx)(He, { extension: !0, electron: !0, browser: !0, children: Lt })),
            (t[170] = Lt),
            (t[171] = Vt));
        let Ht;
        return (
          t[172] !== Rt || t[173] !== zt || t[174] !== Bt || t[175] !== Vt
            ? ((Ht = (0, Q.jsxs)(Q.Fragment, { children: [Rt, zt, Bt, Vt] })),
              (t[172] = Rt),
              (t[173] = zt),
              (t[174] = Bt),
              (t[175] = Vt),
...
export { yr as a, _r as c, Nr as i, ya as n, Er as o, Dr as r, vr as s, va as t };
//# sourceMappingURL=local-remote-dropdown-BT-TSjGN.js.map
