...
import { Q as ee, Xs as f, za as p } from "./app-server-manager-signals.js";
import {
  C as m,
  L as te,
  T as ne,
...
import { u as se } from "./thread-context-inputs.js";
import { t as ce } from "./use-codex-home.js";
import { i as le, n as ue, r as de, t as fe } from "./use-is-plugins-enabled.js";
function pe() {
...
function y(e) {
  let t = 0;
  for (let n = 0; n < e.length; n += 1) t = (t * 31 + e.charCodeAt(n)) % v.length;
  return v[t] ?? ``;
}
var b = e(r(), 1),
  x = {
  ...
  try {
    let e = { path: r, hostId: t },
      i = await n.fetchQuery({
        queryFn: ({ signal: t }) => ie(`read-file-binary`, { params: e, signal: t }),
...
function N(e) {
  return {
    ...
    ...B({ marketplaceName: e.marketplaceName, marketplacePath: e.marketplacePath }),
  };
}
...
function V(e, n, r) {
  ...
  let o = fe(a) && (r?.enabled ?? !0),
    ...
    g = re(ee),
    _;
  i[2] !== e || i[3] !== g ? ((_ = g.includes(e)), (i[2] = e), (i[3] = g), (i[4] = _)) : (_ = i[4]);
  let v = _,
    y = o && v,
    b;
  i[5] !== e || i[6] !== y
  ...
  let E = de(w),
    A = n === void 0,
    j = Ae({ codexHome: ie, hostId: e, rootsOverrideCwd: n, workspaceRoots: m.data?.roots }),
    M = o && v && (n !== void 0 || m.isFetched),
    N;
  i[12] === Symbol.for(`react.memo_cache_sentinel`) ? ((N = pe()), (i[12] = N)) : (N = i[12]);
  let P = N,
    ...
    ? ((I = async () => {
        ...
        if (c != null) {
          let t = await f(`send-cli-request-for-host`, {
              ...
              params: { ...(j.length > 0 ? { cwds: j } : {}), installSuggestionPluginNames: c },
            }),
        ...
        let r = await f(
            ...
            u == null
              ...
              : { hostId: e, ...(j.length > 0 ? { cwds: j } : {}), marketplaceKinds: u },
          ),
        ...
        return {
          featuredPluginIds: P == null ? s : Ee({ buildFlavor: P, featuredPluginIds: s }),
  ...
  i[21] !== M || i[22] !== F || i[23] !== I
    ? ((L = { queryKey: F, queryFn: I, enabled: M, staleTime: h.FIVE_MINUTES, gcTime: 1 / 0 }),
      (i[21] = M),
      (i[22] = F),
      (i[23] = I),
      (i[24] = L))
  ...
  let K = R.data?.marketplaceLoadErrors ?? he,
    ...
    Y = (A && m.isLoading) || R.isLoading || C.isLoading || E.isLoading || x.isLoading,
    X = (A && m.isFetching) || R.isFetching || x.isFetching,
    Z;
  i[40] !== V || i[41] !== R
    ? ((Z = async () => {
        let e = (await R.refetch()).data?.plugins ?? k;
        return { availablePlugins: we({ plugins: e, ...V }), installedPlugins: Te(e) };
      }),
      (i[40] = V),
      (i[41] = R),
      (i[42] = Z))
...
function H(e) {
  ...
  t[2] !== r || t[3] !== i
    ? ((c = [...T, `marketplace-kind`, r, i]),
      (l = async () =>
        $((await f(`list-plugins`, { hostId: r, marketplaceKinds: [i] })).marketplaces)),
      (t[2] = r),
      (t[3] = i),
      (t[4] = c),
      (t[5] = l))
  ...
  return (
    t[6] !== c || t[7] !== l || t[8] !== u
      ? ((d = { queryKey: c, queryFn: l, enabled: u, staleTime: h.FIVE_MINUTES }),
        (t[6] = c),
        (t[7] = l),
        (t[8] = u),
        (t[9] = d))
...
function ye(e, t, n = O, r = null, i = !1) {
  return r == null
    ? xe(
        e,
        t,
        be({ additionalMarketplaceKinds: n, includeRemoteCatalog: !0, includeVerticalCatalog: !i }),
        i,
      )
    : [...T, e, t, `installed`, r, `curated-marketplace`, U(i)];
}
function be({ additionalMarketplaceKinds: e, includeRemoteCatalog: t, includeVerticalCatalog: n }) {
...
async function ke({ hostId: e, plugins: t, queryClient: n }) {
  ...
  async function i(a) {
    let o = t[a];
    if (o == null) return;
    let [s, c] = await Promise.all([S(o.composerIconPath, e, n), S(o.logoPath, e, n)]);
    ((s != null || c != null) &&
      (r[a] = {
        ...o,
  ...
  return (await Promise.all(Array.from({ length: Math.min(E, t.length) }, (e, t) => i(t))), r);
}
function Ae({ codexHome: e, hostId: t, rootsOverrideCwd: n, workspaceRoots: r }) {
  let i = t === `local` && e != null ? p(e, j) : null;
  return Z([...(typeof n == `string` ? [n] : (n ?? r ?? [])), ...(i == null ? [] : [i])], e);
}
function Z(e, t) {
  return Array.from(new Set(e.map((e) => e.trim()).filter((e) => d(e) && Q(e, t))));
}
function Q(e, t) {
  return t == null ? !0 : i(t) || n(t) ? i(e) || n(e) : e.startsWith(`/`) && !e.startsWith(`//`);
}
function $(e) {
  let t = new Map();
  for (let n of e)
