...
import { $ as ee, fs as f, po as p } from "./app-server-manager-signals.js";
import {
  A as te,
  I as ne,
  g as m,
...
import { n as le } from "./use-auth-CI-WraL2.js";
import { t as ue } from "./use-codex-home.js";
import { i as de, n as fe, r as pe, t as me } from "./use-is-plugins-enabled.js";
function he() {
...
var _e = h(),
  ...
  U = [`datadog`, `statsig`],
  W = new Set([`codex-official`, d, t, l, `openai-primary-runtime`].map(Ue));
function G(e) {
  return {
    ...Ze(e.summary),
...
function Ve({ buildFlavor: e, featuredPluginIds: t }) {
  ...
  return t.filter((e) => {
    let t = u(e);
    return t == null ? !0 : !r(t) || t === n;
  });
}
function He({ buildFlavor: e, plugins: t }) {
  let n = i(e);
  return t.filter((e) => !r(e.marketplaceName) || e.marketplaceName === n);
}
function Ue(e) {
  return e
    .trim()
...
function Je(e, t) {
  return Array.from(new Set(e.map((e) => e.trim()).filter((e) => s(e) && Ye(e, t))));
}
function Ye(e, t) {
