...
import { f as i, gt as a } from "./thread-context-inputs.js";
import { A as o, h as s, n as c, r as l, u as ee, v as te } from "./vscode-api.js";
import {
  Ir as u,
  Mr as d,
  Nr as f,
...
import { i as se, n as ce, r as le, t as ue } from "./use-is-plugins-enabled-Dn_J-WZf.js";
function de() {
...
var me = t(),
  ...
  W = [`datadog`, `statsig`],
  G = new Set([`codex-official`, g, h, _, `openai-primary-runtime`].map(Ue));
function K(e) {
  return {
    ...Ze(e.summary),
...
function we(e, t, s) {
  ...
  let k = le(O),
    fe = t === void 0,
    A = qe({ codexHome: ne, hostId: e, rootsOverrideCwd: t, workspaceRoots: y.data?.roots }),
...
function De(e) {
  let t = (0, me.c)(10),
    { enabled: n, hostId: i, marketplaceKind: a } = e,
    o = n === void 0 ? !0 : n,
    s;
  ...
  let c = ue(s),
    ...
    u;
  t[2] !== i || t[3] !== a
    ? ((l = [...R, `marketplace-kind`, i, a]),
      (u = async () =>
        Xe((await r(`list-plugins`, { hostId: i, marketplaceKinds: [a] })).marketplaces)),
      (t[2] = i),
      (t[3] = a),
      (t[4] = l),
      (t[5] = u))
  ...
  return (
    t[6] !== l || t[7] !== u || t[8] !== d
      ? ((f = { queryKey: l, queryFn: u, enabled: d, staleTime: ee.FIVE_MINUTES }),
        (t[6] = l),
        (t[7] = u),
        (t[8] = d),
        (t[9] = f))
...
function Ve({ buildFlavor: e, featuredPluginIds: t }) {
  ...
  return t.filter((e) => {
    let t = y(e);
    return t == null ? !0 : !ne(t) || t === n;
  });
}
function He({ buildFlavor: e, plugins: t }) {
  let n = v(e);
  return t.filter((e) => !ne(e.marketplaceName) || e.marketplaceName === n);
}
function Ue(e) {
  return e
    .trim()
...
function Je(e, t) {
  return Array.from(new Set(e.map((e) => e.trim()).filter((e) => d(e) && Ye(e, t))));
}
function Ye(e, t) {
  return t == null ? !0 : f(t) || p(t) ? f(e) || p(e) : e.startsWith(`/`) && !e.startsWith(`//`);
}
function Xe(e) {
  let t = new Map();
  for (let n of e)
