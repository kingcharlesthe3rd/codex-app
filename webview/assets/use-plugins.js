...
import { Ts as r, rt as i } from "./app-server-manager-signals.js";
import { A as a, h as o, n as s, r as c, u as l, v as ee } from "./vscode-api.js";
import {
  Sr as u,
  _r as d,
  _t as f,
...
import { a as ae, n as oe, r as se, t as ce } from "./use-in-app-browser-use-availability.js";
import { n as le } from "./use-auth.js";
  ...
  try {
    let e = { path: r, hostId: t },
      i = await n.fetchQuery({
        queryFn: ({ signal: t }) => s(`read-file-binary`, { params: e, signal: t }),
        queryKey: c(`read-file-binary`, e),
        retry: !1,
        gcTime: 1 / 0,
    ...
    return (
      o.warning(`Failed to inline local image`, {
        safe: {},
...
var me = n(),
  ...
  W = [`datadog`, `statsig`],
  G = new Set([`codex-official`, h, _, p, `openai-primary-runtime`].map(Ue));
function K(e) {
  return {
    ...Ze(e.summary),
...
function we(e, n, o) {
  let s = (0, me.c)(53),
    c;
  s[0] === e ? (c = s[1]) : ((c = { hostId: e }), (s[0] = e), (s[1] = c));
  let u = ae(c) && (o?.enabled ?? !0),
    d = o?.additionalMarketplaceKinds ?? _e,
    f = o?.installSuggestionPluginNames ?? null,
    p = ne(`4218407052`),
    m = pe(le(e)?.authMethod ?? null),
    h = ve;
  m ? (h = xe) : p && (h = be);
  let g = Ae({
      additionalMarketplaceKinds: d,
      includeRemoteCatalog: o?.includeRemoteCatalog ?? !0,
    ...
    b = t(i),
    x;
  s[2] !== e || s[3] !== b ? ((x = b.includes(e)), (s[2] = e), (s[3] = b), (s[4] = x)) : (x = s[4]);
  let S = x,
    C = u && S,
    w;
  s[5] !== e || s[6] !== C
    ? ((w = { enabled: C, hostId: e }), (s[5] = e), (s[6] = C), (s[7] = w))
    : (w = s[7]);
  let T = se(w),
    E;
  s[8] === e ? (E = s[9]) : ((E = { hostId: e }), (s[8] = e), (s[9] = E));
  let D = ce(E),
    O;
  s[10] === e ? (O = s[11]) : ((O = { hostId: e }), (s[10] = e), (s[11] = O));
  let k = oe(O),
    fe = n === void 0,
    A = qe({ codexHome: te, hostId: e, rootsOverrideCwd: n, workspaceRoots: y.data?.roots }),
    j = u && S && (n !== void 0 || y.isFetched),
    M;
  s[12] === Symbol.for(`react.memo_cache_sentinel`) ? ((M = de()), (s[12] = M)) : (M = s[12]);
  let N = M,
  ...
  s[19] !== A
    ...
    : (F = s[20]);
  let I;
  s[21] !== j || s[22] !== P || s[23] !== F
    ? ((I = { queryKey: P, queryFn: F, enabled: j, staleTime: l.FIVE_MINUTES, gcTime: 1 / 0 }),
      (s[21] = j),
      (s[22] = P),
      (s[23] = F),
      (s[24] = I))
  ...
  s[30] !== L.data?.plugins
    ? ((z = {
      ...
      (s[33] = H),
      (s[34] = U))
    : ((z = s[31]), (B = s[32]), (H = s[33]), (U = s[34]));
  let W;
  s[35] === B ? (W = s[36]) : ((W = Ie(B)), (s[35] = B), (s[36] = W));
  ...
  s[37] !== z || s[38] !== L
    ...
    : (X = s[39]);
  let Z;
  s[40] === _ ? (Z = s[41]) : ((Z = () => _(R)), (s[40] = _), (s[41] = Z));
  let Q;
  return (
    s[42] !== H ||
    s[43] !== U ||
...
function De(e) {
  ...
  return (
    t[6] !== u || t[7] !== d || t[8] !== f
      ? ((p = { queryKey: u, queryFn: d, enabled: f, staleTime: l.FIVE_MINUTES }),
        (t[6] = u),
        (t[7] = d),
        (t[8] = f),
        (t[9] = p))
...
function Je(e, t) {
  return Array.from(new Set(e.map((e) => e.trim()).filter((e) => g(e) && Ye(e, t))));
}
function Ye(e, t) {
  return t == null ? !0 : d(t) || te(t) ? d(e) || te(e) : e.startsWith(`/`) && !e.startsWith(`//`);
}
function Xe(e) {
  let t = new Map();
  for (let n of e)
