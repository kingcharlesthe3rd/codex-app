...
import { Z as i, o as a } from "./app-scope-CWE-zIhQ.js";
import { Zt as o } from "./use-host-config.js";
import {
  Aa as s,
  Lr as c,
  Ta as l,
...
import { A as C, F as w, I as T } from "./rpc-1.js";
import { f as E } from "./chunk-13.js";
import { c as D, d as O, m as k, p as A } from "./parse-directives.js";
import { t as j } from "./send-open-file-request.js";
import { p as ee } from "./codex-api-C.js";
import { a as M, i as N, n as P, o as F, t as te } from "./prompt-text.js";
import {
  T as ne,
  a as I,
  b as L,
...
import { r as le, t as B } from "./rich-link.js";
import { t as ue } from "./apps.js";
import { y as V } from "./use-plugins.js";
import { c as de, m as fe } from "./apps-queries.js";
import { n as pe, t as me } from "./known-app-icon.js";
import { t as he } from "./connector-logo-BJg-OSjk.js";
import { c as ge, o as _e, u as ve } from "./use-native-apps.electron.js";
import { n as ye, t as be } from "./mention-icons.js";
import { t as xe } from "./mcp.js";
import { t as H } from "./get-skill-icon.js";
...
import { t as Ae } from "./sites-color.js";
import { a as je, o as Me, t as Ne } from "./composer-suggestion-list.js";
import { t as Pe } from "./globe.js";
import { t as U } from "./sortBy.js";
import { r as Fe } from "./composer-top-menu-chrome.js";
...
import { r as $e } from "./format-skill-scope.js";
var et = `above-composer-portal`,
  tt = `above-composer-queue-portal`,
  J = `data-above-composer-portal`,
  nt = `data-above-composer-queue-portal`;
function rt(e) {
  return at({ attr: J, fallbackId: et, conversationId: e });
}
function it(e) {
  return at({ attr: nt, fallbackId: tt, conversationId: e });
}
function at({ attr: e, fallbackId: t, conversationId: n }) {
...
var ot = `Files`,
  st = [`text/uri-list`, `public.file-url`],
  ct = `DownloadURL`;
function lt(e) {
  if (e == null) return !1;
  if (Array.from(e.items ?? []).some((e) => e.kind === `file`)) return !0;
  let { types: t } = e;
  for (let e = 0; e < t.length; e += 1) if (t[e] === ot) return !0;
  return !1;
}
function ut(e) {
...
function dt(e) {
  return gt(e)
    .filter(({ file: e, isDirectory: t }) => !t && p(e))
    .map(({ file: e }) => e);
}
function ft(e, { includeDirectories: t = !0 } = {}) {
  let n = [],
    r = [];
  for (let { file: i, isDirectory: a } of gt(e)) {
    if (a) {
      t && r.push(i);
      continue;
    }
...
async function mt(e, t, n, r, i) {
  ...
  if (a == null && n != null)
    try {
      a = await n({ bytes: new Uint8Array(await e.arrayBuffer()), mimeType: e.type });
    } catch {
      return null;
    }
  return a == null || r == null ? a : r(a).catch(() => null);
}
function ht(e, t, n) {
  let r = [],
    i = new Set();
...
for (
  ...
  xt[48 + Y] = xt[96 + Y] = String(Y);
for (var Y = 1; Y <= 24; Y++) xt[Y + 111] = `F` + Y;
for (var Y = 65; Y <= 90; Y++)
  ((xt[Y] = String.fromCharCode(Y + 32)), (St[Y] = String.fromCharCode(Y)));
for (var Tt in xt) St.hasOwnProperty(Tt) || (St[Tt] = xt[Tt]);
function Et(e) {
  var t =
    (!(
      (Ct && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey) ||
      (wt && e.shiftKey && e.key && e.key.length == 1) ||
      e.key == `Unidentified`
    ) &&
      e.key) ||
    (e.shiftKey ? St : xt)[e.keyCode] ||
    e.key ||
    `Unidentified`;
  return (
    t == `Esc` && (t = `Escape`),
...
var Dt = typeof navigator < `u` && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
  Ot = typeof navigator < `u` && /Win/.test(navigator.platform);
function kt(e) {
  let t = e.split(/-(?!$)/),
    n = t[t.length - 1];
  n == `Space` && (n = ` `);
  ...
  for (let e = 0; e < t.length - 1; e++) {
    ...
    else if (/^mod$/i.test(n)) Dt ? (o = !0) : (i = !0);
...
function Mt(e) {
  return new Ye({ props: { handleKeyDown: Nt(e) } });
}
function Nt(e) {
  let t = At(e);
  return function (e, n) {
...
var Pt = l({
    kind: g(`mcp-capability`),
    mentionSearchTool: s(),
    path: m(l({ id: s(), title: s() })),
    server: s(),
    title: s(),
  }),
  Ft = f([`at-mention`, `skill-mention`, `slash-command`]),
  It = u(`type`, [
    l({ kind: Ft, type: g(`close`) }),
    l({ action: f([`complete-query`, `insert-mention`]), kind: Ft, type: g(`submit`) }),
  ]),
  Lt = u(`type`, [
    l({ type: g(`close`) }),
    l({ type: g(`dismiss`) }),
    l({ from: h(), trigger: g(`+`), type: g(`open-synthetic`) }),
    l({ source: Pt.nullable(), type: g(`set-source`) }),
  ]),
  Rt = /(?:^|\s)([/@$])([\p{L}\p{N}\p{M}.:_/\\-]*)$/u,
  X = new Ve(`composer-suggestion-ui`);
function zt({ triggers: e, onClose: t = () => {}, onSubmit: n = () => {} }) {
  return [
    new Ye({
      key: X,
      state: {
      ...
      props: {
        handleDOMEvents: {
          blur(e) {
            return (
              X.getState(e.state)?.active === !0 &&
                e.dispatch(e.state.tr.setMeta(X, { type: `dismiss` })),
              !1
            );
          },
        },
    ...
    Mt({
      Escape: (e, t) =>
        X.getState(e)?.active !== !0 || t == null
          ? !1
          : (t(e.tr.setMeta(X, { type: `dismiss` })), !0),
    }),
    Mt({
      Tab: (e, t) => Xt(e, t, `complete-query`, n),
      Enter: (e, t) => Xt(e, t, `insert-mention`, n),
    }),
  ];
}
function Bt(e, t) {
  let n = X.getState(e.state),
    r =
      n?.active === !0 && n.activation === `synthetic` && n.trigger === t
        ? { type: `close` }
        : { type: `open-synthetic`, from: e.state.selection.from, trigger: t };
  (e.dispatch(e.state.tr.setMeta(X, r)), e.focus());
}
function Vt(e) {
  e.dispatch(e.state.tr.setMeta(X, { type: `close` }));
}
function Ht(e) {
  e.dispatch(e.state.tr.setMeta(X, { type: `dismiss` }));
}
function Ut(e, t) {
  (e.dispatch(e.state.tr.setMeta(X, { type: `set-source`, source: t })), e.focus());
}
function Wt(e) {
  return It.safeParse(e).success;
}
function Gt() {
  return {
    active: !1,
...
function qt(e, t, n, r) {
  let i = e.mapping.map(t.range?.from ?? 0, -1),
    { selection: a } = n;
  if (!a.empty || a.from < i) return Gt();
  let o = Yt(a.$from, r);
  if (o != null && o.range.from >= i) return Z(o, null);
  let s = n.doc.textBetween(
    i,
    a.from,
    `
`,
...
`)
    ? Gt()
    : { ...t, anchorPos: i, query: s, range: { from: i, to: a.from }, source: null };
}
function Jt(e, t, n) {
  if (!e.selection.empty) return Gt();
  let r = Yt(e.selection.$from, n);
  if (r == null) return Gt();
  let i = t.dismissedMatch;
  return i?.from === r.range.from && i.trigger === r.trigger && r.query.startsWith(i.query)
    ? { ...Gt(), dismissedMatch: i }
    : Z(r, t.active && t.range?.from === r.range.from ? t.source : null);
}
function Yt(e, t) {
  if (e.depth === 0) return null;
  let n = e.nodeBefore?.text?.match(Rt),
    r = n?.[1],
    i = n?.[2];
  if (i == null || (r !== `/` && r !== `@` && r !== `$`)) return null;
  let a = t[r];
  return a == null
    ? null
    : { kind: a, query: i, range: { from: e.pos - i.length - 1, to: e.pos }, trigger: r };
}
function Z(e, t) {
  return {
    ...Gt(),
...
function Xt(e, t, n, r) {
  let i = X.getState(e);
  return i?.active !== !0 || i.kind == null || t == null ? !1 : (r(i.kind, n), !0);
}
function Zt(e) {
  return e != null && Lt.safeParse(e).success;
}
var Q = new Ve(`customKeymapPlugin`),
  Qt = 0;
function $t(e) {
  let t = {};
...
function en(e, t) {
  let n = `custom-keymap-subscription-${Qt}`;
  ((Qt += 1),
    e.dispatch(e.state.tr.setMeta(Q, { handlers: t, subscriptionId: n, type: `addHandlers` })));
  let r = !0;
  return () => {
    r &&
      ((r = !1),
      Q.getState(e.state)?.handlerSubscriptions[n] &&
        e.dispatch(e.state.tr.setMeta(Q, { subscriptionId: n, type: `removeHandlers` })));
  };
}
function tn(e = {}) {
  return new Ye({
    ...
    state: {
      ...
      apply(e, t) {
        ...
        if (n?.type === `addHandlers`) {
          ...
          return { handlerSubscriptions: e, handlers: $t(e) };
        }
        if (n?.type === `removeHandlers`) {
          ...
          return { handlerSubscriptions: r, handlers: $t(r) };
        }
        return t;
      },
    },
    props: {
      handleKeyDown(e, t) {
        let n = Q.getState(e.state).handlers[t.key];
        return n ? n(t) : !1;
      },
    },
  });
...
function rn() {
  let e = a(F);
  return an(e.value.kind === `local` ? e.value.conversationId : null);
}
function an(e) {
  return sn(e, rt);
}
...
function sn(e, t) {
  let n = (0, nn.c)(6),
    r;
  n[0] !== e || n[1] !== t
    ? ((r = (n) => cn(e, t, n)), (n[0] = e), (n[1] = t), (n[2] = r))
    : (r = n[2]);
  let i = r,
    a;
  return (
    n[3] !== e || n[4] !== t ? ((a = () => t(e)), (n[3] = e), (n[4] = t), (n[5] = a)) : (a = n[5]),
    (0, $.useSyncExternalStore)(i, a)
  );
}
function cn(e, t, n) {
...
function ln(e) {
  let t = (0, nn.c)(11),
    ...
    l = an(null),
    u;
  t[0] === c.pathname ? (u = t[1]) : ((u = je(c.pathname)), (t[0] = c.pathname), (t[1] = u));
  let d = u,
  ...
  t[2] !== a || t[3] !== f || t[4] !== o
    ? ((p = f
        ...
        : b(`absolute left-0 right-0`, a === `top` ? `bottom-full mb-2` : `top-full mt-1`, o)),
      (t[2] = a),
      (t[3] = f),
      (t[4] = o),
      (t[5] = p))
  ...
  let m = p,
    ...
    g;
  return (
    t[6] !== a || t[7] !== m || t[8] !== h || t[9] !== f
      ? ((g = {
          overlayPortalContainer: h,
          placement: a,
          shellClassName: m,
...
function pn({
  ...
  if (typeof document > `u`) return null;
  if (n != null && t != null)
    return mn({ anchorPos: t, composerController: n, placement: r, portalRoot: i, windowZoom: a });
  let o = e?.current;
  ...
  return {
    ...
    top: (d - u.top) / c + (r === `top` ? -fn : fn),
    width: l.width / c,
    fixedPosition: s === document.body,
    renderAbove: r === `top`,
  };
}
function mn({ anchorPos: e, composerController: t, placement: n, portalRoot: r, windowZoom: i }) {
  let a = t.view.dom,
  ...
  return {
    portalContainer: o,
    left: _n((l.left - c.left) / s, dn, u - f - dn),
    top: ((n === `top` ? l.top : l.bottom) - c.top) / s + (n === `top` ? -fn : fn),
    width: f,
...
function Sn(e) {
  let t = (0, nn.c)(32),
    ...
    { data: g } = ee(),
    _;
  t[0] === l ? (_ = t[1]) : ((_ = { hostId: l }), (t[0] = l), (t[1] = _));
  let x = de(_),
    S = x.data == null ? null : x.data.filter(Tn),
    { skills: C, isLoading: w } = Ce(c ?? s, l),
    T = V(),
    E;
  t[2] !== s || t[3] !== c
  ...
  let D = E,
    ...
    k;
  t[5] !== g?.name || t[6] !== h || t[7] !== D
    ? ((k = (e) => {
        let t = oe(e);
        return {
          ...t,
          key: t.path,
          scopeLabel: $e({ skill: e, intl: h, roots: D, adminLabel: g?.name ?? void 0 }),
          Icon: ye(),
        };
      }),
      (t[5] = g?.name),
  ...
  let A = Dn(
      [
        ...(0, yn.default)(C.filter((e) => e.enabled && Me(e, T)).map(k), wn),
        ...(S == null
          ? []
          : S.map((e) => {
              let t = R(e);
    ...
    j = A.length === 0 && (w || (S == null && x.isLoading)),
    M = new Map(A.map(Cn)),
    N = Ne,
    P;
  t[9] === n
    ? (P = t[10])
    : ((P = b(`max-h-[240px] electron:text-base`, n)), (t[9] = n), (t[10] = P));
  let F;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (F = t[11]);
  let te = (e) => {
      i(e == null ? null : (M.get(e.key) ?? null));
    },
    ne = (e) => {
      let t = M.get(e.key);
      t != null && (i(t), a(t));
  ...
  t[14] === h
    ? (L = t[15])
    : ((L = (e) => ({ content: (0, bn.jsx)(En, { intl: h, item: e }), key: e.key })),
      (t[14] = h),
      (t[15] = L));
  let re = A.map(L),
    ie;
  t[16] !== j || t[17] !== I || t[18] !== re
    ? ((ie = [{ emptyState: I, id: `skills-and-apps`, isLoading: j, items: re }]),
      (t[16] = j),
      (t[17] = I),
      (t[18] = re),
      (t[19] = ie))
...
function En(e) {
  ...
  t[0] !== n ||
  t[1] !== r.Icon ||
  t[2] !== r.appLogoDarkUrl ||
  t[3] !== r.appLogoUrl ||
  t[4] !== r.displayName ||
  t[5] !== r.kind
    ? ((i =
        r.kind === `app` && r.Icon != null
          ? (0, bn.jsx)(r.Icon, { className: `icon-xs shrink-0` })
          : r.kind === `app`
            ? (0, bn.jsx)(he, {
                alt: n.formatMessage(
                  {
                ...
                fallback: (0, bn.jsx)(xn, { className: `icon-xs shrink-0` }),
                logoDarkUrl: r.appLogoDarkUrl,
                logoUrl: r.appLogoUrl,
              })
            : r.Icon
              ? (0, bn.jsx)(r.Icon, { className: `icon-xs shrink-0` })
              : (0, bn.jsx)(xn, { className: `icon-xs shrink-0` })),
      (t[0] = n),
      (t[1] = r.Icon),
      (t[2] = r.appLogoDarkUrl),
      (t[3] = r.appLogoUrl),
  ...
  t[7] === r.displayName
    ? (a = t[8])
    : ((a = (0, bn.jsx)(`span`, { className: `flex-shrink-0 truncate`, children: r.displayName })),
      (t[7] = r.displayName),
      (t[8] = a));
  let o;
  t[9] === r.description
...
function An(e) {
  let t = (0, nn.c)(60),
    ...
    p = l === void 0 ? `dialog` : l,
    m = d === void 0 ? `z-50` : d,
    h = f === void 0 ? `default` : f,
    g = x(),
    _ = !!n.ui?.active,
    v;
  t[0] !== h || t[1] !== c || t[2] !== m
    ? ((v = { placement: c, zIndexClassName: m, variant: h }),
      (t[0] = h),
      (t[1] = c),
      (t[2] = m),
      (t[3] = v))
    : (v = t[3]);
  let {
      overlayPortalContainer: y,
      placement: S,
      shellClassName: C,
      usesExpandedTopTray: w,
    } = ln(v),
    T;
  t[4] !== s || t[5] !== o || t[6] !== _ || t[7] !== y
    ? ((T = (e) =>
        !_ || y != null || (s == null && o == null) || typeof window > `u`
          ? jn
  ...
  t[14] !== g
    ? ((D = () => {
      ...
      (t[15] = D))
    : (D = t[15]);
  let O = (0, $.useSyncExternalStore)(E, D),
    k;
  bb0: {
    if (O == null) {
      k = null;
    ...
    let e = n.ui?.anchorPos,
      r;
    (t[16] !== s || t[17] !== o || t[18] !== S || t[19] !== p || t[20] !== e || t[21] !== g
      ? ((r = pn({
          anchorRef: s,
          anchorPos: e,
          composerController: o,
  ...
  if (y != null) {
    ...
    return (
      t[38] !== y || t[39] !== e
        ? ((n = (0, kn.createPortal)(e, y)), (t[38] = y), (t[39] = e), (t[40] = n))
        : (n = t[40]),
      n
    );
  }
  if (A != null) {
    let e = A.fixedPosition ? `fixed` : `absolute`,
      n = A.renderAbove && `-translate-y-full`,
      r;
    t[41] !== e || t[42] !== n || t[43] !== m
      ? ((r = b(e, n, m)), (t[41] = e), (t[42] = n), (t[43] = m), (t[44] = r))
      : (r = t[44]);
    let i;
    t[45] !== A.left || t[46] !== A.top || t[47] !== A.width
      ? ((i = { left: A.left, top: A.top, width: A.width }),
        (t[45] = A.left),
        (t[46] = A.top),
        (t[47] = A.width),
        (t[48] = i))
    ...
    let o;
    return (
      t[53] !== A.portalContainer || t[54] !== a
        ? ((o = (0, kn.createPortal)(a, A.portalContainer)),
          (t[53] = A.portalContainer),
          (t[54] = a),
          (t[55] = o))
        : (o = t[55]),
      o
...
function Nn(e, t) {
  let n = X.getState(e.state);
  return n?.active !== !0 || (t != null && !n.query.startsWith(t)) ? !1 : (Ht(e), !0);
}
function Pn(e, { onAtMention: t, onSkillMention: n }) {
  switch (e.kind) {
    case `at-mention`:
  ...
  return (
    ...
    (0, $.useEffect)(() => {
      ...
      return (
        ...
        l != null && e.eventEmitter.addListener(`composer-suggestion-ui-event`, t),
        () => {
          (e.removeSubmitHandler(s),
            l != null && e.eventEmitter.removeListener(`composer-suggestion-ui-event`, t));
        }
      );
    }, [s, e, l]),
    (0, bn.jsx)(`div`, {
      ...
      onClick: (e) => {
        ...
        if (t != null) {
          ...
          t.kind === `file` &&
            (e.preventDefault(), e.stopPropagation(), j({ path: t.fsPath || t.path, cwd: null }));
        }
      },
...
function zn(e) {
  ...
  return t == null || n == null
    ? null
    : { kind: `mcp-resource`, path: re({ resourceUri: t, server: n }) };
}
function Bn(e) {
  let t = (0, nn.c)(14),
    n = Ke(e, Vn),
  ...
  t[3] !== e || t[4] !== n
    ? ((c = (t) => {
        bb16: switch (t) {
          case `complete-query`:
          case `insert-mention`:
            n && r.current ? l(r.current, t) : t === `insert-mention` && Vt(e.view);
            break bb16;
          case `close`:
        }
        r.current = null;
      ...
      (l = (t, r) => {
        ...
        Mn(
          Hn(t, r),
          { queryRange: { from: i, to: n.range.to }, replacementRange: n.range },
          {
    ...
    : ((c = t[5]), (l = t[6]));
  let u;
  t[7] === l ? (u = t[8]) : ((u = (e) => l(e, `insert-mention`)), (t[7] = l), (t[8] = u));
  let d;
  return (
    ...
    ? ((c = (t) => {
      ...
      (l = (t) => {
        ...
        Mn(
          ...
          { queryRange: { from: r, to: n.range.to }, replacementRange: n.range },
          {
            clearReplacementRange: () => e.clearSuggestion(n),
            insertMention: (t) => {
              e.insertMention(t, n);
...
var Xn = 1,
  ...
  er = class {
    ...
    get deletedBefore() {
      return (this.delInfo & (Xn | Qn)) > 0;
    }
    get deletedAfter() {
      return (this.delInfo & (Zn | Qn)) > 0;
    }
    get deletedAcross() {
...
var nr = Object.create(null),
  rr = class {
    ...
    static jsonID(e, t) {
      if (e in nr) throw RangeError(`Duplicate use of step JSON ID ` + e);
  ...
  ir = class e {
    ...
    static fromReplace(t, n, r, i) {
      try {
        ...
        if (t instanceof ze) return e.fail(t.message);
        throw t;
      }
    }
  };
function ar(e, t, n) {
  ...
  for (let i = 0; i < e.childCount; i++) {
    let a = e.child(i);
    (a.content.size && (a = a.copy(ar(a.content, t, a))),
...
var or = class e extends rr {
  ...
  apply(e) {
    ...
    return ir.fromReplace(e, this.from, this.to, i);
  }
  invert() {
...
rr.jsonID(`addMark`, or);
var sr = class e extends rr {
  constructor(e, t, n) {
    (super(), (this.from = e), (this.to = t), (this.mark = n));
  }
  apply(e) {
    let t = e.slice(this.from, this.to),
      n = new W(
        ar(t.content, (e) => e.mark(this.mark.removeFromSet(e.marks)), e),
        t.openStart,
        t.openEnd,
      );
    return ir.fromReplace(e, this.from, this.to, n);
  }
  invert() {
...
rr.jsonID(`removeMark`, sr);
var cr = class e extends rr {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return ir.fail(`No node at mark step's position`);
    let n = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
    return ir.fromReplace(e, this.pos, this.pos + 1, new W(q.from(n), 0, t.isLeaf ? 0 : 1));
  }
  invert(t) {
...
rr.jsonID(`addNodeMark`, cr);
var lr = class e extends rr {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
  ...
  invert(e) {
    let t = e.nodeAt(this.pos);
    return !t || !this.mark.isInSet(t.marks) ? this : new cr(this.pos, this.mark);
  }
  map(t) {
    let n = t.mapResult(this.pos, 1);
    return n.deletedAfter ? null : new e(n.pos, this.mark);
...
rr.jsonID(`removeNodeMark`, lr);
var ur = class e extends rr {
  constructor(e, t, n, r = !1) {
    (super(), (this.from = e), (this.to = t), (this.slice = n), (this.structure = r));
  }
  apply(e) {
    return this.structure && fr(e, this.from, this.to)
      ? ir.fail(`Structure replace would overwrite content`)
      : ir.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
...
rr.jsonID(`replace`, ur);
var dr = class e extends rr {
  ...
  apply(e) {
    if (this.structure && (fr(e, this.from, this.gapFrom) || fr(e, this.gapTo, this.to)))
      return ir.fail(`Structure gap-replace would overwrite content`);
    let t = e.slice(this.gapFrom, this.gapTo);
    if (t.openStart || t.openEnd) return ir.fail(`Gap is not a flat range`);
    let n = this.slice.insertAt(this.insert, t.content);
    return n ? ir.fromReplace(e, this.from, this.to, n) : ir.fail(`Content does not fit in gap`);
  }
  getMap() {
    return new tr([
      this.from,
...
function mr(e) {
  ...
  for (let n = e.depth; ; --n) {
    ...
    if (n == 0 || r.type.spec.isolating || !pr(r, i, a)) break;
  }
  return null;
}
...
function gr(e, t) {
  let n = e.resolve(t),
    r = n.index();
  return vr(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1);
}
function _r(e, t) {
...
function vr(e, t) {
  return !!(e && t && !e.isLeaf && _r(e, t));
}
function yr(e, t, n = t, r = W.empty) {
  if (t == n && !r.size) return null;
  let i = e.resolve(t),
    a = e.resolve(n);
  return br(i, a, r) ? new ur(t, n, r) : new xr(i, a, r).fit();
}
function br(e, t, n) {
  return (
    !n.openStart &&
...
var xr = class {
  ...
  fit() {
    ...
    let s = new W(i, a, o);
    return e > -1
      ? new dr(n.pos, e, this.$to.pos, this.$to.end(), s, t)
      : s.size || n.pos != this.$to.pos
        ? new ur(n.pos, r.pos, s)
        : null;
  }
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        let e,
          r = null;
        n
          ? ((r = wr(this.unplaced.content, n - 1).firstChild), (e = r.content))
        ...
        for (let e = this.depth; e >= 0; e--) {
          ...
          if (
            t == 1 &&
            (i
              ? o.matchType(i.type) || (c = o.fillBefore(q.from(i), !1))
  ...
  dropNode() {
    ...
    if (r.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new W(Sr(e, t - 1, 1), t - 1, i ? t - 1 : n);
    } else this.unplaced = new W(Sr(e, t, 1), t, n);
  }
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: r, wrap: i }) {
    ...
    for (; c < o.childCount; ) {
      ...
      (c++,
        (c > 1 || s == 0 || e.content.size) &&
          ((u = t),
          l.push(Tr(e.mark(d.allowedMarks(e.marks)), c == 1 ? s : 0, c == o.childCount ? f : -1))));
    }
    let p = c == o.childCount;
    (p || (f = -1),
      (this.placed = Cr(this.placed, t, q.from(l))),
    ...
    this.unplaced = p
      ? e == 0
        ? W.empty
        : new W(Sr(a.content, e - 1, 1), e - 1, f < 0 ? a.openEnd : e - 1)
      : new W(Sr(a.content, e, c), a.openStart, a.openEnd);
  }
  mustMoveInline() {
    ...
    if (
      !e.type.isTextblock ||
      !Er(this.$to, this.$to.depth, e.type, e.match, !1) ||
  ...
  openFrontierNode(e, t = null, n) {
    ...
    ((r.match = r.match.matchType(e)),
      (this.placed = Cr(this.placed, this.depth, q.from(e.create(t, n)))),
      this.frontier.push({ type: e, match: e.contentMatch }));
  }
  closeFrontierNode() {
    let e = this.frontier.pop().match.fillBefore(q.empty, !0);
    e.childCount && (this.placed = Cr(this.placed, this.frontier.length, e));
  }
};
function Sr(e, t, n) {
  return t == 0
    ? e.cutByIndex(n, e.childCount)
    : e.replaceChild(0, e.firstChild.copy(Sr(e.firstChild.content, t - 1, n)));
}
function Cr(e, t, n) {
  return t == 0
    ? e.append(n)
    : e.replaceChild(e.childCount - 1, e.lastChild.copy(Cr(e.lastChild.content, t - 1, n)));
}
function wr(e, t) {
...
function Tr(e, t, n) {
  ...
  let r = e.content;
  return (
    t > 1 && (r = r.replaceChild(0, Tr(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0))),
    t > 0 &&
      ((r = e.type.contentMatch.fillBefore(r).append(r)),
      n <= 0 && (r = r.append(e.type.contentMatch.matchFragment(r).fillBefore(q.empty, !0)))),
    e.copy(r)
  );
}
function Er(e, t, n, r, i) {
  ...
  return s && !Dr(n, a.content, o) ? s : null;
}
function Dr(e, t, n) {
...
var Or = class e extends rr {
  ...
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return ir.fail(`No node at attribute step's position`);
    let n = Object.create(null);
    for (let e in t.attrs) n[e] = t.attrs[e];
    n[this.attr] = this.value;
    let r = t.type.create(n, null, t.marks);
    return ir.fromReplace(e, this.pos, this.pos + 1, new W(q.from(r), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return tr.empty;
  }
...
var jr = (e, t) => (e.selection.empty ? !1 : (t && t(e.tr.deleteSelection().scrollIntoView()), !0));
function Mr(e, t) {
...
var Nr = (e, t, n) => {
  ...
  if (r.parent.content.size == 0 && (Pr(a, `end`) || G.isSelectable(a)))
    for (let n = r.depth; ; n--) {
      let o = yr(e.doc, r.before(n), r.after(n), W.empty);
      if (o && o.slice.size < o.to - o.from) {
        if (t) {
          let n = e.tr.step(o);
          (n.setSelection(
            Pr(a, `end`)
              ? He.findFrom(n.doc.resolve(n.mapping.map(i.pos, -1)), -1)
...
var Fr = (e, t, n) => {
  ...
  return !o || !G.isSelectable(o)
    ? !1
    : (t && t(e.tr.setSelection(G.create(e.doc, a.pos - o.nodeSize)).scrollIntoView()), !0);
};
function Ir(e) {
...
var Rr = (e, t, n) => {
    ...
    let a = i.nodeAfter;
    if (Xr(e, i, t, 1)) return !0;
    if (r.parent.content.size == 0 && (Pr(a, `start`) || G.isSelectable(a))) {
      let n = yr(e.doc, r.before(), r.after(), W.empty);
      if (n && n.slice.size < n.to - n.from) {
        if (t) {
          let r = e.tr.step(n);
          (r.setSelection(
            Pr(a, `start`)
              ? He.findFrom(r.doc.resolve(r.mapping.map(i.pos)), 1)
  ...
  zr = (e, t, n) => {
    ...
    return !o || !G.isSelectable(o)
      ? !1
      : (t && t(e.tr.setSelection(G.create(e.doc, a.pos)).scrollIntoView()), !0);
  };
function Br(e) {
  if (!e.parent.type.spec.isolating)
    for (let t = e.depth - 1; t >= 0; t--) {
...
var Ur = (e, t) => {
    ...
    if (t) {
      ...
      (i.setSelection(He.near(i.doc.resolve(r), 1)), t(i.scrollIntoView()));
    }
    return !0;
  },
  Wr = (e, t) => {
    let n = e.selection,
      { $from: r, $to: i } = n;
    if (n instanceof Je || r.parent.inlineContent || i.parent.inlineContent) return !1;
...
function Kr(e) {
  return (t, n) => {
    ...
    if (t.selection instanceof G && t.selection.node.isBlock)
      return !r.parentOffset || !hr(t.doc, r.pos)
        ? !1
    ...
    let u = t.tr;
    (t.selection instanceof K || t.selection instanceof Je) && u.deleteSelection();
    let d = u.mapping.map(r.pos),
      f = hr(u.doc, d, a.length, a);
    if (((f ||= ((a[0] = s ? { type: s } : null), hr(u.doc, d, a.length, a))), !f)) return !1;
...
var qr = Kr(),
  Jr = (e, t) => (t && t(e.tr.setSelection(new Je(e.doc))), !0);
function Yr(e, t, n) {
  let r = t.nodeBefore,
    i = t.nodeAfter,
    a = t.index();
  return !r || !i || !r.type.compatibleContent(i.type)
    ...
    : !r.content.size && t.parent.canReplace(a - 1, a)
      ...
      : !t.parent.canReplace(a, a + 1) || !(i.isTextblock || gr(e.doc, t.pos))
        ? !1
...
function Xr(e, t, n, r) {
  ...
  if (
    ...
    if (n) {
      ...
      s = q.from(i.copy(s));
      let c = e.tr.step(new dr(t.pos - 1, r, t.pos, r, new W(s, 1, 0), o.length, !0)),
        l = c.doc.resolve(r + 2 * o.length);
      (l.nodeAfter && l.nodeAfter.type == i.type && gr(c.doc, l.pos) && c.join(l.pos),
        n(c.scrollIntoView()));
    }
    return !0;
  }
  let u = a.type.spec.isolating || (r > 0 && c) ? null : He.findFrom(t, 1),
    d = u && u.$from.blockRange(u.$to),
    f = d && mr(d);
  if (f != null && f >= t.depth) return (n && n(e.tr.lift(d, f).scrollIntoView()), !0);
  if (l && Pr(a, `start`, !0) && Pr(i, `end`)) {
    let r = i,
      o = [];
...
function Zr(e) {
  return function (t, n) {
    ...
    return i.node(a).isTextblock
      ? (n && n(t.tr.setSelection(K.create(t.doc, e < 0 ? i.start(a) : i.end(a)))), !0)
      : !1;
  };
}
var Qr = Zr(-1),
...
var ti = ei(jr, Nr, Fr),
  ...
  ii = {
    "Ctrl-h": ri.Backspace,
    "Alt-Backspace": ri[`Mod-Backspace`],
    "Ctrl-d": ri.Delete,
    "Ctrl-Alt-Backspace": ri[`Mod-Delete`],
    "Alt-Delete": ri[`Mod-Delete`],
    "Alt-d": ri[`Mod-Delete`],
    "Ctrl-a": Qr,
    "Ctrl-e": $r,
  };
for (let e in ri) ii[e] = ri[e];
var ai = (
    typeof navigator < `u`
  ...
  di = function (e, t, n, r) {
    return n && (pi(e, t, n, r, -1) || pi(e, t, n, r, 1));
  },
  fi = /^(img|br|input|textarea|hr)$/i;
function pi(e, t, n, r, i) {
  for (;;) {
    if (e == n && t == r) return !0;
    if (t == (i < 0 ? 0 : mi(e))) {
      let n = e.parentNode;
      if (!n || n.nodeType != 1 || vi(e) || fi.test(e.nodeName) || e.contentEditable == `false`)
        return !1;
      ((t = oi(e) + (i < 0 ? 0 : 1)), (e = n));
...
function hi(e, t) {
  for (;;) {
    ...
    if (e.nodeType == 1 && t > 0) {
      ...
      ((e = e.childNodes[t - 1]), (t = mi(e)));
    } else if (e.parentNode && !vi(e)) ((t = oi(e)), (e = e.parentNode));
    else return null;
  }
}
function gi(e, t) {
  for (;;) {
    ...
    } else if (e.parentNode && !vi(e)) ((t = oi(e) + 1), (e = e.parentNode));
    else return null;
  }
}
function _i(e, t, n) {
  for (let r = t == 0, i = t == mi(e); r || i; ) {
    if (e == n) return !0;
    let t = oi(e);
...
var yi = function (e) {
  return e.focusNode && di(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset);
};
function bi(e, t) {
...
function Si(e, t, n) {
  if (e.caretPositionFromPoint)
    try {
      ...
      if (r) return { node: r.offsetNode, offset: Math.min(mi(r.offsetNode), r.offset) };
    } catch {}
  if (e.caretRangeFromPoint) {
    let r = e.caretRangeFromPoint(t, n);
    if (r) return { node: r.startContainer, offset: Math.min(mi(r.startContainer), r.startOffset) };
  }
}
var Ci = typeof navigator < `u` ? navigator : null,
  wi = typeof document < `u` ? document : null,
  Ti = (Ci && Ci.userAgent) || ``,
  Ei = /Edge\/(\d+)/.exec(Ti),
  Di = /MSIE \d/.exec(Ti),
  Oi = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Ti),
  ki = !!(Di || Oi || Ei),
  Ai = Di ? document.documentMode : Oi ? +Oi[1] : Ei ? +Ei[1] : 0,
  ji = !ki && /gecko\/(\d+)/i.test(Ti);
ji && +(/Firefox\/(\d+)/.exec(Ti) || [0, 0])[1];
var Mi = !ki && /Chrome\/(\d+)/.exec(Ti),
  Ni = !!Mi,
  Pi = Mi ? +Mi[1] : 0,
  Fi = !ki && !!Ci && /Apple Computer/.test(Ci.vendor),
  Ii = Fi && (/Mobile\/\w+/.test(Ti) || (!!Ci && Ci.maxTouchPoints > 2)),
  Li = Ii || (Ci ? /Mac/.test(Ci.platform) : !1),
  Ri = Ci ? /Win/.test(Ci.platform) : !1,
  zi = /Android \d/.test(Ti),
  Bi = !!wi && `webkitFontSmoothing` in wi.documentElement.style,
  Vi = Bi ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Hi(e) {
  ...
  for (let o = n || e.dom; o; ) {
    ...
    if (
      ...
      t.left < s.left + Ui(r, `left`)
        ...
        : t.right > s.right - Ui(r, `right`) && (c = t.right - s.right + Ui(i, `right`)),
      c || l)
    )
    ...
    o = u == `absolute` ? o.offsetParent : si(o);
  }
}
function Ki(e) {
  ...
  return { refDOM: r, refTop: i, stack: qi(e.dom) };
}
function qi(e) {
  let t = [],
    n = e.ownerDocument;
...
function Ji({ refDOM: e, refTop: t, stack: n }) {
...
function Qi(e, t) {
  ...
  for (let u = e.firstChild, d = 0; u; u = u.nextSibling, d++) {
    ...
    else if (u.nodeType == 3) e = li(u).getClientRects();
    else continue;
...
function aa(e, t) {
  ...
  if (!o || !e.dom.contains(o.nodeType == 1 ? o : o.parentNode)) {
    ...
    if (!ea(t, n) || ((o = ia(e.dom, t, n)), !o)) return null;
  }
  if (Fi) for (let e = o; r && e; e = si(e)) e.draggable && (r = void 0);
  if (((o = ta(o, t)), r)) {
    if (
      ji &&
      r.nodeType == 1 &&
...
function sa(e, t) {
  ...
  return Array.prototype.find.call(n, oa) || e.getBoundingClientRect();
}
var ca = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function la(e, t, n) {
  let { node: r, offset: i, atom: a } = e.docView.domFromPos(t, n < 0 ? -1 : 1),
    o = Bi || ji;
  if (r.nodeType == 3)
    if (o && (ca.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
      let e = sa(li(r, i, i), n);
      if (ji && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let t = sa(li(r, i - 1, i - 1), -1);
        if (t.top == e.top) {
          let n = sa(li(r, i, i + 1), -1);
          if (n.top != e.top) return ua(n, n.left < t.left);
        }
      }
      return e;
    } else {
        ...
        n < 0 && !i
          ...
          : n >= 0 && i == r.nodeValue.length
            ...
            : n < 0
              ? e--
              : t++,
        ua(sa(li(r, e, t), a), a < 0)
      );
    }
  if (!e.state.doc.resolve(t - (a || 0)).parent.inlineContent) {
    if (a == null && i && (n < 0 || i == mi(r))) {
      let e = r.childNodes[i - 1];
      if (e.nodeType == 1) return da(e.getBoundingClientRect(), !1);
    }
    if (a == null && i < mi(r)) {
      let e = r.childNodes[i];
      if (e.nodeType == 1) return da(e.getBoundingClientRect(), !0);
    }
    return da(r.getBoundingClientRect(), n >= 0);
  }
  if (a == null && i && (n < 0 || i == mi(r))) {
    let e = r.childNodes[i - 1],
      t =
        e.nodeType == 3
          ...
          : e.nodeType == 1 && (e.nodeName != `BR` || !e.nextSibling)
            ? e
            : null;
    if (t) return ua(sa(t, 1), !1);
  }
  if (a == null && i < mi(r)) {
    let e = r.childNodes[i];
    for (; e.pmViewDesc && e.pmViewDesc.ignoreForCoords; ) e = e.nextSibling;
    let t = e ? (e.nodeType == 3 ? li(e, 0, o ? 0 : 1) : e.nodeType == 1 ? e : null) : null;
    if (t) return ua(sa(t, -1), !0);
  }
  return ua(sa(r.nodeType == 3 ? li(r) : r, -n), n >= 0);
}
function ua(e, t) {
...
function pa(e, t, n) {
  ...
  return fa(e, t, () => {
    ...
    for (let e = t.firstChild; e; e = e.nextSibling) {
      ...
      else if (e.nodeType == 3) t = li(e, 0, e.nodeValue.length).getClientRects();
      else continue;
...
function ha(e, t, n) {
  ...
  let i = r.parentOffset,
    ...
    s = e.domSelection();
  return s
    ? !ma.test(r.parent.textContent) || !s.modify
      ? n == `left` || n == `backward`
        ? a
        : o
      : fa(e, t, () => {
...
function ya(e, t, n) {
  return ga == t && _a == n
    ? va
    : ((ga = t), (_a = n), (va = n == `up` || n == `down` ? pa(e, t, n) : ha(e, t, n)));
}
var ba = 0,
  xa = 1,
  Sa = 2,
  ...
  wa = class {
    ...
    localPosFromDOM(e, t, n) {
      ...
      let r;
      if (e == this.dom && this.contentDOM) r = t > oi(this.contentDOM);
    ...
    domFromPos(e, t) {
      ...
      if (t <= 0) {
        ...
        return e && t && r && !e.border && !e.domAtom
          ...
          : { node: this.contentDOM, offset: e ? oi(e.dom) + 1 : 0 };
      } else {
        let e,
          r = !0;
        for (
        ...
        return e && r && !e.border && !e.domAtom
          ? e.domFromPos(0, t)
          : { node: this.contentDOM, offset: e ? oi(e.dom) : this.contentDOM.childNodes.length };
      }
    }
    parseRange(e, t, n = 0) {
...
`
            ...
            for (let t = e, n; t; t = t.parentNode) {
              if ((n = t.nextSibling)) {
                n.nodeName == `BR` && (o = s = { node: n.parentNode, offset: oi(n) + 1 });
                break;
              }
              let e = t.pmViewDesc;
      ...
      if (ji && l.focusNode && l.focusNode != s.node && l.focusNode.nodeType == 1) {
        let e = l.focusNode.childNodes[l.focusOffset];
        e && e.contentEditable == `false` && (r = !0);
      }
      if (
        !(r || (u && Fi)) &&
        di(o.node, o.offset, l.anchorNode, l.anchorOffset) &&
        di(s.node, s.offset, l.focusNode, l.focusOffset)
      )
        return;
      let d = !1;
      if ((c.extend || e == t) && !(u && ji)) {
  ...
  Ta = class extends wa {
    ...
    matchesWidget(e) {
      return this.dirty == ba && e.type.eq(this.widget.type);
    }
    parseRule() {
      return { ignore: !0 };
    }
  ...
  Da = class e extends wa {
    ...
    static create(t, n, r, i) {
      let a = i.nodeViews[n.type.name],
        o = a && a(n, i, r);
      return (
        (!o || !o.dom) && (o = Le.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)),
        new e(t, n, o.dom, o.contentDOM || o.dom, o)
      );
    }
    parseRule() {
      return this.dirty & Ca || this.mark.type.spec.reparseInView
        ? null
        : { mark: this.mark.type.name, attrs: this.mark.attrs, contentElement: this.contentDOM };
    }
    matchesMark(e) {
      return this.dirty != Ca && this.mark.eq(e);
    }
    markDirty(e, t) {
      if ((super.markDirty(e, t), this.dirty != ba)) {
        let e = this.parent;
        for (; !e.node; ) e = e.parent;
        (e.dirty < this.dirty && (e.dirty = this.dirty), (this.dirty = ba));
      }
    }
    slice(t, n, r) {
      let i = e.create(this.parent, this.mark, !0, r),
        a = this.children,
        o = this.size;
      (n < o && (a = Ja(a, n, o, r)), t > 0 && (a = Ja(a, 0, t, r)));
  ...
  Oa = class e extends wa {
    ...
    static create(t, n, r, i, a, o) {
      ...
      if (n.isText) {
        ...
        let e = Le.renderSpec(document, n.type.spec.toDOM(n), null, n.attrs);
      ...
      return (
        (u = za(u, r, n)),
        l
          ? (c = new Ma(t, n, r, i, u, d || null, f, l, a, o + 1))
          : n.isText
    ...
    matchesNode(e, t, n) {
      return this.dirty == ba && e.eq(this.node) && Ba(t, this.outerDeco) && n.eq(this.innerDeco);
    }
    get size() {
    ...
    updateChildren(e, t) {
      ...
      (Ga(
        ...
        (t, i, a) => {
          (t.spec.marks
            ...
            : t.type.side >= 0 &&
              !a &&
              s.syncToMarks(
                i == this.node.childCount ? Ze.none : this.node.child(i).marks,
                n,
                e,
                i,
              ),
        ...
        s.destroyRest(),
        (s.changed || this.dirty == Sa) &&
          (a && this.protectLocalComposition(e, a),
          Na(this.contentDOM, this.children, e),
          Ii && Ka(this.dom)));
    }
    localCompositionInfo(e, t) {
      ...
      if (this.node.inlineContent) {
        let e = i.nodeValue,
          a = qa(this.node.content, e, n - t, r - t);
    ...
    protectLocalComposition(e, { node: t, pos: n, text: r }) {
      ...
      (e.input.compositionNodes.push(a),
        (this.children = Ja(this.children, n, n + r.length, e, a)));
    }
    update(e, t, n, r) {
      return this.dirty == Ca || !e.sameMarkup(this.node) ? !1 : (this.updateInner(e, t, n, r), !0);
    }
    updateInner(e, t, n, r) {
    ...
    updateOuterDeco(e) {
      if (Ba(e, this.outerDeco)) return;
      let t = this.nodeDOM.nodeType != 1,
        n = this.dom;
      ((this.dom = La(
        this.dom,
        this.nodeDOM,
        Ia(this.outerDeco, this.node, t),
        Ia(e, this.node, t),
      )),
...
function ka(e, t, n, r, i) {
  za(r, t, e);
  let a = new Oa(void 0, e, t, n, r, r, r, i, 0);
  return (a.contentDOM && a.updateChildren(i, 0), a);
}
var Aa = class e extends Oa {
    ...
    update(e, t, n, r) {
      return this.dirty == Ca || (this.dirty != ba && !this.inParent()) || !e.sameMarkup(this.node)
        ? !1
        : (this.updateOuterDeco(t),
          (this.dirty != ba || e.text != this.node.text) &&
  ...
  ja = class extends wa {
    ...
    matchesHack(e) {
      return this.dirty == ba && this.dom.nodeName == e;
    }
    get domAtom() {
      return !0;
    }
...
function za(e, t, n) {
  return La(e, e, Fa, Ia(t, n, e.nodeType != 1));
}
function Ba(e, t) {
...
var Ha = class {
  ...
  syncToMarks(e, t, n, r) {
    ...
    for (; a < e.length; ) {
      ...
      if (i > -1)
        ...
        let r = Da.create(this.top, e[a], t, n);
  ...
  updateNodeAt(e, t, n, r, i) {
    let a = this.top.children[r];
    return (
      a.dirty == Ca && a.dom == a.contentDOM && (a.dirty = Sa),
      ...
      if (s instanceof Oa) {
        ...
        if (!d && (u = this.recreateWrapper(s, e, t, n, r, a)))
          return (
            ...
            u.contentDOM && ((u.dirty = Sa), u.updateChildren(r, a + 1), (u.dirty = ba)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  recreateWrapper(e, t, n, r, i, a) {
    if (
      ...
      return null;
    let o = Oa.create(this.top, t, n, r, i, a);
    if (o.contentDOM) {
  ...
  addNode(e, t, n, r, i) {
    let a = Oa.create(this.top, e, t, n, r, i);
  ...
  addTextblockHacks() {
    let e = this.top.children[this.index - 1],
      t = this.top;
    for (; e instanceof Da; ) ((t = e), (e = t.children[t.children.length - 1]));
    (!e ||
      !(e instanceof Aa) ||
      /\n$/.test(e.node.text) ||
      (this.view.requiresGeckoHackNode && /\s$/.test(e.node.text))) &&
      ((Fi || Ni) && e && e.dom.contentEditable == `false` && this.addHackNode(`IMG`, t),
  ...
  outer: for (; i > 0; ) {
    ...
    for (;;)
      if (r) {
        ...
        if (e instanceof Da) ((n = e), (r = e.children.length));
        else {
          ((s = e), r--);
          break;
        }
...
function Ya(e, t = null) {
  ...
  if (yi(n)) {
    ...
    if (
      ...
      G.isSelectable(e) &&
      i.parent &&
      !(e.isInline && _i(n.focusNode, n.focusOffset, i.dom))
    ) {
      let e = i.posBefore;
...
function Xa(e) {
  return e.editable
    ? e.hasFocus()
    : co(e) && document.activeElement && document.activeElement.contains(e.dom);
}
function Za(e, t = !1) {
  let n = e.state.selection;
  if ((io(e, n), Xa(e))) {
    if (!t && e.input.mouseDown && e.input.mouseDown.allowDefault && Ni) {
      let t = e.domSelectionRange(),
        n = e.domObserver.currentSelection;
      if (
        t.anchorNode &&
        n.anchorNode &&
        di(t.anchorNode, t.anchorOffset, n.anchorNode, n.anchorOffset)
      ) {
        ((e.input.mouseDown.delayedSelectionSync = !0), e.domObserver.setCurSelection());
        return;
      }
    }
    if ((e.domObserver.disconnectSelection(), e.cursorWrapper)) ro(e);
    else {
      ...
      (Qa &&
        !(n instanceof K) &&
        (n.$from.parent.inlineContent || (a = $a(e, n.from)),
        !n.empty && !n.$from.parent.inlineContent && (o = $a(e, n.to))),
        ...
        n.visible
          ...
          : (e.dom.classList.add(`ProseMirror-hideselection`),
            `onselectionchange` in document && no(e)));
    }
...
function $a(e, t) {
  ...
  if (Fi && i && i.contentEditable == `false`) return eo(i);
...
function eo(e) {
  return (
    ...
    Fi && e.draggable && ((e.draggable = !1), (e.wasDraggable = !0)),
    e
  );
}
function to(e) {
  ...
  t.addEventListener(
    ...
    (e.input.hideSelectionGuard = () => {
      (n.anchorNode != r || n.anchorOffset != i) &&
        (t.removeEventListener(`selectionchange`, e.input.hideSelectionGuard),
        setTimeout(() => {
          (!Xa(e) || e.state.selection.visible) &&
            e.dom.classList.remove(`ProseMirror-hideselection`);
        }, 20));
    }),
  );
...
function ro(e) {
  ...
  let n = e.cursorWrapper.dom,
    r = n.nodeName == `IMG`;
  (r ? t.collapse(n.parentNode, oi(n) + 1) : t.collapse(n, 0),
    !r && !e.state.selection.visible && ki && Ai <= 11 && ((n.disabled = !0), (n.disabled = !1)));
}
function io(e, t) {
  if (t instanceof G) {
    let n = e.docView.descAt(t.from);
    n != e.lastSelectedViewDesc && (ao(e), n && n.selectNode(), (e.lastSelectedViewDesc = n));
  } else ao(e);
}
function ao(e) {
...
function so(e) {
  return e.editable && !e.hasFocus() ? !1 : co(e);
}
function co(e) {
  let t = e.domSelectionRange();
...
function lo(e) {
  ...
  return di(t.node, t.offset, n.anchorNode, n.anchorOffset);
}
function uo(e, t) {
  ...
  if (r instanceof K) {
    if (n.indexOf(`s`) > -1) {
      ...
      return i.isAtom || ((a = e.docView.descAt(o)) && !a.contentDOM)
        ? G.isSelectable(i)
          ? fo(e, new G(t < 0 ? e.state.doc.resolve(n.pos - i.nodeSize) : n))
          : Bi
            ? fo(e, new K(e.state.doc.resolve(t < 0 ? o : o + i.nodeSize)))
            : !1
        : !1;
    }
  } else if (r instanceof G && r.node.isInline) return fo(e, new K(t > 0 ? r.$to : r.$from));
  else {
    let n = uo(e.state, t);
    return n ? fo(e, n) : !1;
  }
...
function _o(e) {
  ...
  let i,
    a,
    o = !1;
  for (ji && n.nodeType == 1 && r < mo(n) && ho(n.childNodes[r], -1) && (o = !0); ; )
    if (r > 0) {
      ...
      for (; t && ho(t, -1); ) ((i = n.parentNode), (a = oi(t)), (t = t.previousSibling));
      if (t) ((n = t), (r = mo(n)));
      else {
...
function vo(e) {
  ...
  for (;;)
    if (r < i) {
      ...
      let t = n.nextSibling;
      for (; t && ho(t, 1); ) ((a = t.parentNode), (o = oi(t) + 1), (t = t.nextSibling));
      if (t) ((n = t), (r = 0), (i = mo(n)));
      else {
        if (((n = n.parentNode), n == e.dom)) break;
        r = i = 0;
...
function bo(e, t) {
  for (; e && t == e.childNodes.length && !vi(e); ) ((t = oi(e) + 1), (e = e.parentNode));
...
function xo(e, t) {
  for (; e && !t && !vi(e); ) ((t = oi(e)), (e = e.parentNode));
  for (; e && t; ) {
    let n = e.childNodes[t - 1];
    if (n.nodeType == 3) return n;
    if (n.nodeType == 1 && n.contentEditable == `false`) break;
...
function So(e, t, n) {
  if (t.nodeType != 3) {
    let e, r;
    (r = bo(t, n)) ? ((t = r), (n = 0)) : (e = xo(t, n)) && ((t = e), (n = e.nodeValue.length));
  }
...
function Co(e, t) {
  ...
  if (!(Ni || Ri) && n.parent.inlineContent) {
...
function wo(e, t, n) {
  let r = e.state.selection;
  if ((r instanceof K && !r.empty) || n.indexOf(`s`) > -1 || (Li && n.indexOf(`m`) > -1)) return !1;
  let { $from: i, $to: a } = r;
  if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? `up` : `down`)) {
    let n = uo(e.state, t);
    if (n && n instanceof G) return fo(e, n);
  }
  if (!i.parent.inlineContent) {
    let n = t < 0 ? i : a,
      o = r instanceof Je ? He.near(n, t) : He.findFrom(n, t);
    return o ? fo(e, o) : !1;
  }
  return !1;
}
...
function Do(e) {
  if (!Fi || e.state.selection.$head.parentOffset > 0) return !1;
...
function ko(e, t) {
  let n = t.keyCode,
    r = Oo(t);
  if (n == 8 || (Li && n == 72 && r == `c`)) return To(e, -1) || go(e, -1);
  if ((n == 46 && !t.shiftKey) || (Li && n == 68 && r == `c`)) return To(e, 1) || go(e, 1);
  if (n == 13 || n == 27) return !0;
  if (n == 37 || (Li && n == 66 && r == `c`)) {
    let t = n == 37 ? (Co(e, e.state.selection.from) == `ltr` ? -1 : 1) : -1;
    return po(e, t, r) || go(e, t);
  } else if (n == 39 || (Li && n == 70 && r == `c`)) {
    let t = n == 39 ? (Co(e, e.state.selection.from) == `ltr` ? 1 : -1) : 1;
    return po(e, t, r) || go(e, t);
  } else if (n == 38 || (Li && n == 80 && r == `c`)) return wo(e, -1, r) || go(e, -1);
  else if (n == 40 || (Li && n == 78 && r == `c`)) return Do(e) || wo(e, 1, r) || go(e, 1);
  else if (r == (Li ? `m` : `c`) && (n == 66 || n == 73 || n == 89 || n == 90)) return !0;
  return !1;
}
function Ao(e, t) {
  ...
  let o = e.someProp(`clipboardSerializer`) || Le.fromSchema(e.state.schema),
    s = Vo(),
  ...
  let l = c.firstChild,
    u,
    d = 0;
  for (; l && l.nodeType == 1 && (u = zo[l.nodeName.toLowerCase()]); ) {
...
`,
  ...
  if (
    ...
    s = Ko(Ro(s, +u[1], +u[2]), u[4]);
  else if (((s = W.maxOpen(No(s.content, i), !0)), s.openStart || s.openEnd)) {
    let e = 0,
      t = 0;
    for (
    ...
    if (
      (e.forEach((e) => {
        ...
        let t = r.findWrapping(e.type),
          n;
        if (!t) return (a = null);
        if ((n = a.length && i.length && Fo(t, i, e, a[a.length - 1], 0))) a[a.length - 1] = n;
        else {
          a.length && (a[a.length - 1] = Io(a[a.length - 1], i.length));
          let n = Po(e, t);
...
function Fo(e, t, n, r, i) {
  if (i < e.length && i < t.length && e[i] == t[i]) {
    let a = Fo(e, t, n, r.lastChild, i + 1);
    ...
    if (r.contentMatchAt(r.childCount).matchType(i == e.length - 1 ? n.type : e[i + 1]))
      return r.copy(r.content.append(q.from(Po(n, e, i + 1))));
  }
}
function Io(e, t) {
  if (t == 0) return e;
  let n = e.content.replaceChild(e.childCount - 1, Io(e.lastChild, t - 1)),
    r = e.contentMatchAt(e.childCount).fillBefore(q.empty, !0);
      ...
      (s =
        t < 0
          ? o
              ...
              .fillBefore(s, a <= i)
              .append(s)
          : s.append(o.contentMatchAt(o.childCount).fillBefore(q.empty, !0))),
    e.replaceChild(t < 0 ? 0 : e.childCount - 1, o.copy(s))
  );
}
function Ro(e, t, n) {
  return (
    t < e.openStart && (e = new W(Lo(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)),
    n < e.openEnd && (e = new W(Lo(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)),
    e
  );
}
var zo = {
...
function Uo(e) {
  ...
  return t
    ? ((Ho ||= t.defaultPolicy || t.createPolicy(`ProseMirrorClipboard`, { createHTML: (e) => e })),
      Ho.createHTML(e))
    : e;
}
function Wo(e) {
  ...
  let n = Vo().createElement(`div`),
    r = /<([a-z][^>\s]+)/i.exec(e),
    i;
  if (
    ((i = r && zo[r[1].toLowerCase()]) &&
      (e =
        i.map((e) => `<` + e + `>`).join(``) +
        e +
        i
  ...
  for (let t in qo) {
    ...
    e.dom.addEventListener(
      ...
      (e.input.eventHandlers[t] = (t) => {
        ns(e, t) && !ts(e, t) && (e.editable || !(t.type in Jo)) && n(e, t);
      }),
      Yo[t] ? { passive: !0 } : void 0,
    );
  }
  (Fi && e.dom.addEventListener(`input`, () => null), es(e));
}
function Qo(e, t) {
  ...
  e.someProp(`handleDOMEvents`, (t) => {
    for (let n in t)
      e.input.eventHandlers[n] ||
        e.dom.addEventListener(n, (e.input.eventHandlers[n] = (t) => ts(e, t)));
  });
}
function ts(e, t) {
...
function rs(e, t) {
  !ts(e, t) && qo[t.type] && (e.editable || !(t.type in Jo)) && qo[t.type](e, t);
}
((Jo.keydown = (e, t) => {
  let n = t;
  if (
    ...
    if (
      ...
      Ii && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
    ) {
      let t = Date.now();
      ((e.input.lastIOSEnter = t),
        (e.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          e.input.lastIOSEnter == t &&
            (e.someProp(`handleKeyDown`, (t) => t(e, bi(13, `Enter`))), (e.input.lastIOSEnter = 0));
        }, 200)));
    } else
      e.someProp(`handleKeyDown`, (t) => t(e, n)) || ko(e, n) ? n.preventDefault() : Qo(e, `key`);
}),
  (Jo.keyup = (e, t) => {
  ...
  (Jo.keypress = (e, t) => {
    let n = t;
    if (vs(e, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (Li && n.metaKey)) return;
...
function ls(e, t) {
  ...
  let n = e.state.doc.resolve(t),
    r = n.nodeAfter;
  return r && r.isAtom && G.isSelectable(r) ? (cs(e, new G(n), `pointer`), !0) : !1;
}
function us(e, t) {
  if (t == -1) return !1;
  let n = e.state.selection,
  ...
  return i == null ? !1 : (cs(e, G.create(e.state.doc, i), `pointer`), !0);
}
function ds(e, t, n, r, i) {
  return (
    ss(e, `handleClickOn`, t, n, r) ||
...
function fs(e, t, n, r) {
  return (
    ss(e, `handleDoubleClickOn`, t, n, r) || e.someProp(`handleDoubleClick`, (n) => n(e, t, r))
  );
}
function ps(e, t, n, r) {
  return (
    ss(e, `handleTripleClickOn`, t, n, r) ||
...
function ms(e, t, n) {
  ...
  let r = e.state.doc;
  if (t == -1) return r.inlineContent ? (cs(e, K.create(r, 0, r.content.size), `pointer`), !0) : !1;
  let i = r.resolve(t);
  for (let t = i.depth + 1; t > 0; t--) {
    let n = t > i.depth ? i.nodeAfter : i.node(t),
      a = i.before(t);
    if (n.inlineContent) cs(e, K.create(r, a + 1, a + 1 + n.content.size), `pointer`);
    else if (G.isSelectable(n)) cs(e, G.create(r, a), `pointer`);
    else continue;
    return !0;
  }
}
...
qo.mousedown = (e, t) => {
  ...
  let o = e.posAtCoords(is(n));
  o &&
    (a == `singleClick`
      ? (e.input.mouseDown && e.input.mouseDown.done(), (e.input.mouseDown = new _s(e, o, n, !!r)))
      : (a == `doubleClick` ? fs : ps)(e, o.pos, o.inside, n)
        ? n.preventDefault()
        : Qo(e, `pointer`));
};
var _s = class {
  ...
  up(e) {
    ...
    (this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(is(e))),
      ...
      this.allowDefault || !t
        ? Qo(this.view, `pointer`)
        : ds(this.view, t.pos, t.inside, e, this.selectNode)
          ? e.preventDefault()
          : e.button == 0 &&
              (this.flushed ||
                (Fi && this.mightDrag && !this.mightDrag.node.isAtom) ||
                (Ni &&
            ...
            ? (cs(this.view, He.near(this.view.state.doc.resolve(t.pos)), `pointer`),
              e.preventDefault())
            : Qo(this.view, `pointer`));
  }
  move(e) {
    (this.updateAllowDefault(e), Qo(this.view, `pointer`), e.buttons == 0 && this.done());
  }
...
((qo.touchstart = (e) => {
  ((e.input.lastTouch = Date.now()), hs(e), Qo(e, `pointer`));
}),
  (qo.touchmove = (e) => {
    ((e.input.lastTouch = Date.now()), Qo(e, `pointer`));
  }),
  (qo.contextmenu = (e) => hs(e)));
function vs(e, t) {
  return e.composing
    ? !0
    : Fi && Math.abs(t.timeStamp - e.input.compositionEndedAt) < 500
      ? ((e.input.compositionEndedAt = -2e8), !0)
      : !1;
}
var ys = zi ? 5e3 : -1;
Jo.compositionstart = Jo.compositionupdate = (e) => {
  if (!e.composing) {
    e.domObserver.flush();
    let { state: t } = e,
      n = t.selection.$to;
    if (
      ...
      ((e.markCursor = e.state.storedMarks || n.marks()), Ts(e, !0), (e.markCursor = null));
    else if (
      (Ts(e, !t.selection.empty),
      ji && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)
    ) {
      let t = e.domSelectionRange();
...
function Ss(e) {
  for (
    e.composing && ((e.input.composing = !1), (e.input.compositionEndedAt = ws()));
...
function Cs(e) {
  ...
  let n = hi(t.focusNode, t.focusOffset),
    r = gi(t.focusNode, t.focusOffset);
  if (n && r && n != r) {
    let t = r.pmViewDesc,
...
function Ts(e, t = !1) {
  if (!(zi && e.domObserver.flushingSoon >= 0)) {
    if ((e.domObserver.forceFlush(), Ss(e), t || (e.docView && e.docView.dirty))) {
      let n = Ya(e),
        r = e.state.selection;
      return (
        n && !n.eq(r)
...
var Ds = (ki && Ai < 15) || (Ii && Vi < 604);
qo.copy = Jo.cut = (e, t) => {
  let n = t,
    r = e.state.selection,
    i = n.type == `cut`;
  if (r.empty) return;
  let a = Ds ? null : n.clipboardData,
    { dom: o, text: s } = Ao(e, r.content());
  (a
    ? (n.preventDefault(),
      a.clearData(),
...
function ks(e, t) {
  ...
  setTimeout(() => {
    (e.focus(),
      ...
      n ? As(e, r.value, null, i, t) : As(e, r.textContent, r.innerHTML, i, t));
  }, 50);
}
function As(e, t, n, r, i) {
  let a = jo(e, t, n, r, e.state.selection.$from);
...
Jo.paste = (e, t) => {
  let n = t;
  if (e.composing && !zi) return;
  let r = Ds ? null : n.clipboardData,
    i = e.input.shiftKey && e.input.lastKeyCode != 45;
  r && As(e, js(r), r.getData(`text/html`), i, n) ? n.preventDefault() : ks(e, n);
};
var Ms = class {
    constructor(e, t, n) {
...
((qo.dragstart = (e, t) => {
  ...
  let i = e.state.selection,
    a = i.empty ? null : e.posAtCoords(is(n)),
    o;
  ...
  ((!n.dataTransfer.files.length || !Ni || Pi > 120) && n.dataTransfer.clearData(),
    n.dataTransfer.setData(Ds ? `Text` : `text/html`, s.innerHTML),
    (n.dataTransfer.effectAllowed = `copyMove`),
    Ds || n.dataTransfer.setData(`text/plain`, c),
    (e.dragging = new Ms(l, Ps(e, n), o)));
}),
  (qo.dragend = (e) => {
    let t = e.dragging;
    window.setTimeout(() => {
  ...
  (Jo.dragover = Jo.dragenter = (e, t) => t.preventDefault()),
  (Jo.drop = (e, t) => {
    try {
      Fs(e, t, e.dragging);
    } finally {
...
function Fs(e, t, n) {
  ...
  a
    ...
    : (a = jo(e, js(t.dataTransfer), Ds ? null : t.dataTransfer.getData(`text/html`), !1, i));
  let o = !!(n && Ps(e, t));
  ...
  if (!a) return;
  t.preventDefault();
  let s = a ? We(e.state.doc, i.pos, a) : i.pos;
  s ??= i.pos;
  let c = e.state.tr;
  if (o) {
    let { node: e } = n;
  ...
  if (
    ...
    (c.mapping.maps[c.mapping.maps.length - 1].forEach((e, n, r, i) => (t = i)),
      c.setSelection(oo(e, f, c.doc.resolve(t))));
  }
...
((qo.focus = (e) => {
  ...
  (qo.beforeinput = (e, t) => {
    if (Ni && zi && t.inputType == `deleteContentBackward`) {
      e.domObserver.flushSoon();
      let { domChangeCount: t } = e.input;
      setTimeout(() => {
        if (
          e.input.domChangeCount != t ||
          (e.dom.blur(), e.focus(), e.someProp(`handleKeyDown`, (t) => t(e, bi(8, `Backspace`))))
        )
          return;
...
var Ls = class e {
      ...
      return (
        ...
        (t instanceof e &&
          ((this.spec.key && this.spec.key == t.spec.key) ||
            (this.toDOM == t.toDOM && Is(this.spec, t.spec))))
      );
    }
    destroy(e) {
  ...
  Rs = class e {
    ...
    eq(t) {
      return this == t || (t instanceof e && Is(this.attrs, t.attrs) && Is(this.spec, t.spec));
    }
    static is(t) {
  ...
  Us = class e {
    constructor(e, t) {
      ((this.local = e.length ? e : Vs), (this.children = t.length ? t : Vs));
    }
    static create(e, t) {
      return t.length ? Zs(t, e, 0, Hs) : Ws;
    }
    find(e, t, n) {
      let r = [];
    ...
    map(e, t, n) {
      return this == Ws || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, n || Hs);
    }
    mapInner(t, n, r, i, a) {
      let o;
      ...
      return this.children.length
        ? Ks(this.children, o || [], t, n, r, i, a)
        : o
          ? new e(o.sort(Qs), Vs)
          : Ws;
    }
    add(t, n) {
      return n.length ? (this == Ws ? e.create(t, n) : this.addInner(t, n, 0)) : this;
    }
    addInner(t, n, r) {
      let i,
        a = 0;
      t.forEach((e, t) => {
        ...
        if ((s = Ys(n, e, o))) {
          ...
          (i[a] == t
            ...
            : i.splice(a, 0, t, t + e.nodeSize, Zs(s, e, o + 1, Hs)),
            (a += 3));
        }
      });
      let o = qs(a ? Xs(n) : n, -r);
      for (let e = 0; e < o.length; e++) o[e].type.valid(t, o[e]) || o.splice(e--, 1);
      return new e(o.length ? this.local.concat(o).sort(Qs) : this.local, i || this.children);
    }
    remove(e) {
      return e.length == 0 || this == Ws ? this : this.removeInner(e, 0);
    }
    removeInner(t, n) {
      let r = this.children,
        i = this.local;
      ...
      return r == this.children && i == this.local ? this : i.length || r.length ? new e(i, r) : Ws;
    }
    forChild(t, n) {
    ...
    locals(e) {
      return $s(this.localsInner(e));
    }
    localsInner(e) {
      if (this == Ws) return Vs;
      if (e.inlineContent || !this.local.some(Rs.is)) return this.local;
      let t = [];
      for (let e = 0; e < this.local.length; e++)
        this.local[e].type instanceof Rs || t.push(this.local[e]);
      return t;
    }
    forEachSet(e) {
      e(this);
...
((Us.empty = new Us([], [])), (Us.removeOverlap = $s));
var Ws = Us.empty,
  Gs = class e {
    constructor(e) {
      this.members = e;
    ...
    forChild(t, n) {
      ...
      for (let i = 0; i < this.members.length; i++) {
        ...
        a != Ws && (a instanceof e ? (r = r.concat(a.members)) : r.push(a));
      }
      return e.from(r);
    }
    eq(t) {
        ...
        default:
          return new e(
            t.every((e) => e instanceof Us)
              ? t
              : t.reduce((e, t) => e.concat(t instanceof Us ? t : t.members), []),
          );
      }
    }
    forEachSet(e) {
  ...
  for (let t = 0; t < s.length; t += 3)
    if (s[t + 1] < 0) {
      ...
      if (m && p == u && p + m.nodeSize == d) {
        ...
        r == Ws ? ((s[t + 1] = -2), (c = !0)) : ((s[t] = u), (s[t + 1] = d), (s[t + 2] = r));
      } else c = !0;
    }
  if (c) {
    let c = Zs(Js(s, e, t, n, i, a, o), r, 0, o);
    t = c.local;
...
function Zs(e, t, n, r) {
  ...
  t.forEach((t, o) => {
    ...
    if (s) {
      ...
      e != Ws && i.push(o, o + t.nodeSize, e);
    }
  });
  let o = qs(a ? Xs(e) : e, -n).sort(Qs);
  for (let e = 0; e < o.length; e++)
    o[e].type.valid(t, o[e]) || (r.onRemove && r.onRemove(o[e].spec), o.splice(e--, 1));
  return o.length || i.length ? new Us(o, i) : Ws;
}
function Qs(e, t) {
      ...
      for (let i = n + 1; i < t.length; i++) {
        ...
        if (a.from == r.from) {
          a.to != r.to &&
            ...
            ec(t, i + 1, a.copy(r.to, a.to)));
          continue;
        } else {
          a.from < r.to &&
            (t == e && (t = e.slice()),
            (t[n] = r.copy(r.from, a.from)),
            ec(t, i, r.copy(a.from, r.to)));
          break;
        }
      }
  }
...
var nc = {
  ...
  ac = class {
    ...
    start() {
      (this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, nc)),
        this.onCharData &&
    ...
    onSelectionChange() {
      if (so(this.view)) {
        ...
        if (ki && Ai <= 11 && !this.view.state.selection.empty) {
          let e = this.view.domSelectionRange();
          if (e.focusNode && di(e.focusNode, e.focusOffset, e.anchorNode, e.anchorOffset))
    ...
    ignoreSelectionChange(e) {
      ...
      let t = new Set(),
        n;
      for (let n = e.focusNode; n; n = si(n)) t.add(n);
      for (let r = e.anchorNode; r; r = si(r))
        if (t.has(r)) {
          n = r;
          break;
        }
    ...
    flush() {
      ...
      if (
        ...
        if (t.length == 2) {
          ...
          for (let r of t) {
            let t = r.parentNode;
            t && t.nodeName == `LI` && (!n || dc(e, n) != t) && r.remove();
          }
        }
      }
      let c = null;
      ...
      yi(n) &&
      (c = Ya(e)) &&
      c.eq(He.near(e.state.doc.resolve(0), 1))
        ? ((e.input.lastFocus = 0), Za(e), this.currentSelection.set(n), e.scrollToSelection())
        : (i > -1 || r) &&
          (i > -1 && (e.docView.markDirty(i, a), cc(e)),
          e.input.badSafariComposition && ((e.input.badSafariComposition = !1), fc(e, s)),
    ...
    registerMutation(e, t) {
      ...
      if (e.type == `childList`) {
        ...
        let r = e.previousSibling,
          i = e.nextSibling;
        if (ki && Ai <= 11 && e.addedNodes.length)
        ...
        let a = r && r.parentNode == e.target ? oi(r) + 1 : 0,
          o = n.localPosFromDOM(e.target, a, -1),
          s = i && i.parentNode == e.target ? oi(i) : e.target.childNodes.length;
...
function cc(e) {
  if (
    ...
    if (((e.requiresGeckoHackNode = ji), sc)) return;
    (console.warn(
...
function lc(e, t) {
  ...
  return (
    di(o.node, o.offset, i, a) && ([n, r, i, a] = [i, a, n, r]),
...
function pc(e, t, n) {
  ...
  if (
    (u &&
      ...
      yi(c) || l.push({ node: c.focusNode, offset: c.focusOffset })),
    Ni && e.input.lastKeyCode === 8)
  )
    for (let e = a; e > i; e--) {
  ...
  let d = e.state.doc,
    f = e.someProp(`domParser`) || Ue.fromSchema(e.state.schema),
    p = d.resolve(o),
    m = null,
    h = f.parse(r, {
      topNode: p.parent,
...
function mc(e) {
  ...
  if (e.nodeName == `BR` && e.parentNode) {
    if (Fi && /^(ul|ol)$/i.test(e.parentNode.nodeName)) {
      let e = document.createElement(`div`);
      return (e.appendChild(document.createElement(`li`)), { skip: e });
    } else if (e.parentNode.lastChild == e || (Fi && /^(tr|table)$/i.test(e.parentNode.nodeName)))
      return { ignore: !0 };
...
function gc(e, t, n, r, i) {
  ...
  if (((e.input.compositionPendingChanges = 0), t < 0)) {
    ...
    if (n && !e.state.selection.eq(n)) {
      if (
        ...
        e.someProp(`handleKeyDown`, (t) => t(e, bi(13, `Enter`)))
      )
        return;
  ...
  let m = xc(d.content, l.doc.content, l.from, f, p);
  if (
    (m && e.input.domChangeCount++,
    ((Ii && e.input.lastIOSEnter > Date.now() - 225) || zi) &&
      i.some((e) => e.nodeType == 1 && !hc.test(e.nodeName)) &&
      (!m || m.endA >= m.endB) &&
      e.someProp(`handleKeyDown`, (t) => t(e, bi(13, `Enter`))))
  ) {
  ...
  if (
    ...
    yc(u, m.start, m.endA, h, g) &&
    e.someProp(`handleKeyDown`, (t) => t(e, bi(8, `Backspace`)))
  ) {
    zi && Ni && e.domObserver.suppressSelectionUpdates();
    return;
  }
  (Ni && m.endB == m.start && (e.input.lastChromeDelete = Date.now()),
    zi &&
      !v &&
      h.start() != g.start() &&
      g.parentOffset == 0 &&
...
function _c(e, t, n) {
  return Math.max(n.anchor, n.head) > t.content.size
    ? null
    : oo(e, t.resolve(n.anchor), t.resolve(n.head));
}
function vc(e, t) {
  ...
  if (q.from(l).eq(e)) return { mark: s, type: o };
}
function yc(e, t, n, r, i) {
  if (n - t <= i.pos - r.pos || bc(r, !0, !1) < i.pos) return !1;
  let a = e.resolve(t);
  if (!r.parent.isTextblock) {
    let e = a.nodeAfter;
  ...
  let o = e.resolve(bc(a, !0, !0));
  return !o.parent.isTextblock || o.pos > n || bc(o, !0, !1) < n
    ? !1
...
function xc(e, t, n, r, i) {
  ...
  if (o < a && e.size < t.size) {
    let e = r <= a && r >= o ? a - r : 0;
    ((a -= e),
      a && a < t.size && Sc(t.textBetween(a - 1, a + 1)) && (a += e ? 1 : -1),
      (s = a + (s - o)),
      (o = a));
  } else if (s < a) {
    let t = r <= a && r >= s ? a - r : 0;
    ((a -= t),
      a && a < e.size && Sc(e.textBetween(a - 1, a + 1)) && (a += t ? 1 : -1),
      (o = a + (o - s)),
      (s = a));
  }
...
var Cc = class {
  constructor(e, t) {
    ((this._root = null),
      ...
      (this.editable = Ec(this)),
      Tc(this),
      (this.nodeViews = Oc(this)),
      (this.docView = ka(this.state.doc, wc(this), tc(this), this.dom, this)),
      (this.domObserver = new ac(this, (e, t, n, r) => gc(this, e, t, n, r))),
  ...
  updateStateInner(e, t) {
    let n = this.state,
      r = !1,
      i = !1;
    (e.storedMarks && this.composing && (Ss(this), (i = !0)), (this.state = e));
    let a = n.plugins != e.plugins || this._props.plugins != t.plugins;
    if (a || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let e = Oc(this);
      kc(e, this.nodeViews) && ((this.nodeViews = e), (r = !0));
    }
    ((a || t.handleDOMEvents != this._props.handleDOMEvents) && es(this),
      (this.editable = Ec(this)),
      Tc(this));
    let o = tc(this),
      s = wc(this),
    ...
    let u = c == `preserve` && i && this.dom.style.overflowAnchor == null && Ki(this);
    if (i) {
      ...
      !(
        ...
        ? Za(this, t)
        : (io(this, e.selection), this.domObserver.setCurSelection()),
        this.domObserver.start());
    }
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Ms(e.slice, e.move, r < 0 ? void 0 : G.create(this.state.doc, r));
  }
  someProp(e, t) {
  ...
  endOfTextblock(e, t) {
    return ya(this, t || this.state, e);
  }
  pasteHTML(e, t) {
    return As(this, ``, e, !1, t || new ClipboardEvent(`paste`));
  }
  pasteText(e, t) {
    return As(this, e, null, !0, t || new ClipboardEvent(`paste`));
  }
  ...
  destroy() {
    this.docView &&
      ...
      this.mounted
        ? (this.docView.update(this.state.doc, [], tc(this), this), (this.dom.textContent = ``))
  ...
  domSelectionRange() {
    ...
    return e
      ? (Fi &&
          ...
          xi(this.dom.ownerDocument) == this.dom &&
          uc(this, e)) ||
          e
...
Cc.prototype.dispatch = function (e) {
...
function wc(e) {
  ...
  return (
    ...
    (t.translate ||= `no`),
    [Bs.node(0, e.state.doc.content.size, t)]
  );
}
function Tc(e) {
  if (e.markCursor) {
    ...
    ((t.className = `ProseMirror-separator`),
      ...
      (e.cursorWrapper = {
        dom: t,
        deco: Bs.widget(e.state.selection.from, t, { raw: !0, marks: e.markCursor }),
      }));
...
var jc = class e extends He {
  constructor(e) {
    super(e, e);
  }
  map(t, n) {
    let r = t.resolve(n.map(this.head));
    return e.valid(r) ? new e(r) : He.near(r);
  }
  content() {
    return W.empty;
  }
  ...
  static valid(e) {
    let t = e.parent;
    if (t.inlineContent || !Pc(e) || !Fc(e)) return !1;
...
((jc.prototype.visible = !1), (jc.findFrom = jc.findGapCursorFrom), He.jsonID(`gapcursor`, jc));
var Mc = class e {
  constructor(e) {
    this.pos = e;
  }
  ...
  resolve(e) {
    ...
    return jc.valid(t) ? new jc(t) : He.near(t);
  }
};
function Nc(e) {
...
function Pc(e) {
  for (let t = e.depth; t >= 0; t--) {
    ...
    for (let e = r.child(n - 1); ; e = e.lastChild) {
      if ((e.childCount == 0 && !e.inlineContent) || Nc(e.type)) return !0;
  ...
  return new Ye({
    props: {
      ...
      createSelectionBetween(e, t, n) {
        return t.pos == n.pos && jc.valid(n) ? new jc(n) : null;
      },
      handleClick: zc,
      handleKeyDown: Lc,
...
function Rc(e, t) {
  ...
  return function (e, r, i) {
    ...
    let c = jc.findGapCursorFrom(o, t, s);
    return c ? (r && r(e.tr.setSelection(new jc(c))), !0) : !1;
  };
}
function zc(e, t, n) {
  if (!e || !e.editable) return !1;
  let r = e.state.doc.resolve(t);
  if (!jc.valid(r)) return !1;
  let i = e.posAtCoords({ left: n.clientX, top: n.clientY });
  return i && i.inside > -1 && G.isSelectable(e.state.doc.nodeAt(i.inside))
    ? !1
    : (e.dispatch(e.state.tr.setSelection(new jc(r))), !0);
}
function Bc(e, t) {
  if (t.inputType != `insertCompositionText` || !(e.state.selection instanceof jc)) return !1;
...
function Vc(e) {
  if (!(e.selection instanceof jc)) return null;
  let t = document.createElement(`div`);
  return (
    (t.className = `ProseMirror-gapcursor`),
    Us.create(e.doc, [Bs.widget(e.selection.head, t, { key: `gapcursor` })])
  );
}
var Hc = 200,
  Uc = function () {};
((Uc.prototype.append = function (e) {
  return e.length
    ? ((e = Uc.from(e)),
      (!this.length && e) ||
        (e.length < Hc && this.leafAppend(e)) ||
        (this.length < Hc && e.leafPrepend(this)) ||
        this.appendInner(e))
    : this;
}),
  ...
  (Uc.prototype.slice = function (e, t) {
    return (
      ...
      e >= t ? Uc.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, t))
    );
  }),
  ...
  (Uc.from = function (e) {
    return e instanceof Uc ? e : e && e.length ? new Wc(e) : Uc.empty;
  }));
var Wc = (function (e) {
  function t(t) {
  ...
  return (
    ...
    (t.prototype.leafAppend = function (e) {
      if (this.length + e.length <= Hc) return new t(this.values.concat(e.flatten()));
    }),
    (t.prototype.leafPrepend = function (e) {
      if (this.length + e.length <= Hc) return new t(e.flatten().concat(this.values));
    }),
...
var Gc = (function (e) {
  ...
  qc = class e {
          ...
          (t, n) => {
            ...
            if (i) {
              ...
              (e &&
                ...
                l.push(new Yc(n, void 0, void 0, l.length + u.length))),
                a--,
                n && i.appendMap(n, a));
    ...
    addTransform(t, n, r, i) {
      ...
      let l = o - r.depth;
      return (l > Zc && ((s = Jc(s, l)), (o -= l)), new e(s.append(a), o));
    }
    remapping(e, t) {
      let n = new Ge();
      return (
    ...
    addMaps(t) {
      return this.eventCount == 0
        ? this
        : new e(this.items.append(t.map((e) => new Yc(e))), this.eventCount);
    }
    rebased(t, n) {
      ...
      this.items.forEach((e) => {
        ...
        if (e.step) {
          ...
          (l && s++, r.push(new Yc(i, o, l)));
        } else r.push(new Yc(i));
      }, i);
      let l = [];
      for (let e = n; e < o; e++) l.push(new Yc(a.maps[e]));
      let u = new e(this.items.slice(0, i).append(l).append(r), s);
      return (u.emptyItemCount() > Kc && (u = u.compress(this.items.length - r.length)), u);
    }
    emptyItemCount() {
      let e = 0;
      return (
...
function Qc(e, t, n, r) {
  ...
  n.getMeta(cl) && (e = new Xc(e.done, e.undone, null, 0, -1));
  let o = n.getMeta(`appendedTransaction`);
  if (n.steps.length == 0) return e;
  if (o && o.getMeta(sl))
    return o.getMeta(sl).redo
      ? new Xc(
          e.done.addTransform(n, void 0, r, al(t)),
          e.undone,
          el(n.mapping.maps),
          e.prevTime,
          e.prevComposition,
      ...
      : new Xc(
          e.done,
          e.undone.addTransform(n, void 0, r, al(t)),
          null,
          e.prevTime,
          e.prevComposition,
        );
  if (n.getMeta(`addToHistory`) !== !1 && !(o && o.getMeta(`addToHistory`) === !1)) {
    let i = n.getMeta(`composition`),
      a =
        ...
        (!o &&
          e.prevComposition != i &&
          (e.prevTime < (n.time || 0) - r.newGroupDelay || !$c(n, e.prevRanges))),
      s = o ? tl(e.prevRanges, n.mapping) : el(n.mapping.maps);
    return new Xc(
      e.done.addTransform(n, a ? t.selection.getBookmark() : void 0, r, al(t)),
      qc.empty,
      s,
      n.time,
      i ?? e.prevComposition,
...
function nl(e, t, n) {
  ...
  let o = a.selection.resolve(a.transform.doc),
    ...
    c = new Xc(n ? s : a.remaining, n ? a.remaining : s, null, 0, -1);
  return a.transform.setSelection(o).setMeta(sl, { redo: n, historyState: c });
}
var rl = !1,
  il = null;
function al(e) {
...
function ol(e) {
  return e.setMeta(cl, !0);
}
var sl = new Ve(`history`),
  cl = new Ve(`closeHistory`);
function ll(e = {}) {
  return (
    ...
    new Ye({
      ...
      state: {
        init() {
          return new Xc(qc.empty, qc.empty, null, 0, -1);
        },
        apply(t, n, r) {
          return Qc(n, r, t, e);
        },
      ...
      props: {
        handleDOMEvents: {
          beforeinput(e, t) {
            let n = t.inputType,
              r = n == `historyUndo` ? dl : n == `historyRedo` ? fl : null;
...
var dl = ul(!1, !0),
  fl = ul(!0, !0);
function pl(e, { preferFileMentionFsPath: t = !1, preserveTextLinkMarks: n = !1 } = {}) {
  let r = ``,
    i = !1;
  function a(e) {
...
`),
    ...
    if (e.isText && e.text !== void 0) {
      ...
      t == null ? (r += e.text) : (r += k(e.text, `${n ? D : ``}${t.attrs.href}`));
    } else if (e.type.name === `atMention`)
      r += k(e.attrs.label, t ? A({ fsPath: e.attrs.fsPath, path: e.attrs.path }) : e.attrs.path);
      ...
      r += k(e.attrs.title, re({ resourceUri: e.attrs.resourceUri, server: e.attrs.server }));
    else if (e.type.name === `chatGptConversationMention` || e.type.name === `sitesProjectMention`)
      r += k(e.attrs.title, e.attrs.path);
    else if (
      ...
      r += k(`${t}${i}`, e.attrs.path);
    } else e.type.name === `richLink` && (r += k(e.attrs.displayText, e.attrs.href));
  }
  return (
    e.descendants((e) => a(e)),
    i &&
...
`);
  if (
    ...
    ml(e.state, e.dispatch);
    let t = r.slice(1),
      i = new W(
        q.fromArray(t.map((e) => n.nodes.paragraph.create(null, e === `` ? null : n.text(e)))),
        0,
        0,
      );
    (e.dispatch(e.state.tr.replaceSelection(i)), Nr(e.state, e.dispatch, e));
  }
}
var gl = new Ve(`placeholderPlugin`);
function _l(e) {
  return new Ye({
    key: gl,
    state: {
      ...
      apply(e, t) {
        return e.getMeta(gl) ? { placeholder: e.getMeta(gl).placeholder } : t;
      },
    },
    props: {
      decorations(e) {
        ...
        if (
          ...
          let n = [],
            { placeholder: r } = gl.getState(e);
          return (
            t.descendants((e, t) => {
              n.push(Bs.node(t, t + e.nodeSize, { class: `placeholder`, "data-placeholder": r }));
            }),
            Us.create(t, n)
          );
        }
...
var vl = 1e5,
  yl = 1e5,
  bl = 100;
function xl({ html: e, schema: t, text: n }) {
  if (e.length > vl || n.length > yl) return null;
  let r = 0,
    i,
    a = n.replaceAll(`\xA0`, ` `),
  ...
  let c = new Map();
  for (let e of s) {
    let t = B(e.getAttribute(`href`) ?? ``);
    t != null && !Sl(e) && c.set(e, t);
  }
...
var Cl = t((e) => {
    ...
    var D = Object.assign,
      ...
      j = {};
    function ee(e) {
      return O.call(j, e) ? !0 : O.call(A, e) ? !1 : k.test(e) ? (j[e] = !0) : ((A[e] = !0), !1);
    }
    var M = new Set(
...
`),
        ...
        case `button`:
          ...
          var Le = xe(e, r, a, pe, ye, Ne, Pe, fe);
          if ((e.push(`>`), Le?.forEach(ve, e), Se(e, de, V), typeof V == `string`)) {
            e.push(F(V));
            var Re = null;
          } else Re = V;
          return Re;
        case `form`:
          ...
          if (typeof Ve == `function`) {
            var K = be(r, Ve);
            K === null
              ? (e.push(` `, `action`, `="`, _e, `"`), (We = Ue = He = Ve = null), we(r, a))
              : ((Ve = K.action || ``),
                (He = K.encType),
                (Ue = K.method),
                (We = K.target),
          ...
          if (
            (Ve != null && H(e, `action`, Ve),
            He != null && H(e, `encType`, He),
            Ue != null && H(e, `method`, Ue),
            We != null && H(e, `target`, We),
            e.push(`>`),
            qe !== null &&
              (e.push(`<input type="hidden"`), ge(e, `name`, qe), e.push(`/>`), Ke?.forEach(ve, e)),
            Se(e, Be, ze),
            typeof ze == `string`)
          ) {
            e.push(F(ze));
          ...
          return Je;
        case `menuitem`:
          for (var Ye in (e.push(U(`menuitem`)), n))
            if (O.call(n, Ye)) {
              var q = n[Ye];
              if (q != null)
                switch (Ye) {
        ...
        case `object`:
          ...
          if ((e.push(`>`), Se(e, Ze, Xe), typeof Xe == `string`)) {
            e.push(F(Xe));
            var tt = null;
          } else tt = Xe;
          return tt;
        ...
        case `link`:
          ...
          if (
            ...
            if (typeof ct != `string` || n.disabled != null || n.onLoad || n.onError) lt = Te(e, n);
            else {
              ...
              if (pt !== null) {
                ...
                var mt = {
                  state: 0,
                  props: D({}, n, { "data-precedence": n.precedence, precedence: null }),
                };
                if (pt) {
            ...
            n.onLoad || n.onError
              ? (lt = Te(e, n))
              : (l && e.push(`<!-- -->`), (lt = at ? null : Te(a.hoistableChunks, n)));
          return lt;
        case `script`:
          var _t = c.tagScope & 1,
            vt = n.async;
          if (
            ...
            if (Ct !== null) {
              ...
              var wt = n;
              if (Ct) {
                Ct.length === 2 && ((wt = D({}, n)), ut(wt, Ct));
                var Y = St.get(bt);
                Y && (Y.length = 0);
              }
              var Tt = [];
              (a.scripts.add(Tt), Ae(Tt, wt));
            }
            (l && e.push(`<!-- -->`), (yt = null));
          }
          return yt;
        case `style`:
          ...
          if (
            ...
            (typeof Pt != `function` &&
              typeof Pt != `symbol` &&
              Pt != null &&
              e.push((`` + Pt).replace(Ee, De)),
              Se(e, jt, At),
              e.push(W(`style`)));
            var Ft = null;
          } else {
            var It = a.styles.get(Dt);
            if ((r.styleResources.hasOwnProperty(Ot) ? r.styleResources[Ot] : void 0) !== null) {
              ((r.styleResources[Ot] = null),
                It ||
                  ((It = { precedence: F(Dt), rules: [], hrefs: [], sheets: new Map() }),
                  a.styles.set(Dt, It)));
              ...
              if (!Lt || Lt === kt) {
                ...
                var Ht = Array.isArray(X) ? (2 > X.length ? X[0] : null) : X;
                (typeof Ht != `function` &&
                  typeof Ht != `symbol` &&
                  Ht != null &&
                  Rt.push((`` + Ht).replace(Ee, De)),
                  Se(Rt, zt, X));
              }
            }
            (It && s && s.styles.add(It), l && e.push(`<!-- -->`), (Ft = void 0));
          }
          return Ft;
        case `meta`:
          var Ut = c.tagScope & 1,
...
` +
            ...
            if (tn)
            ...
            else if (!r.imageResources.hasOwnProperty($t)) {
              r.imageResources[$t] = ae;
              var nn = n.crossOrigin,
                $ = typeof nn == `string` ? (nn === `use-credentials` ? nn : ``) : void 0,
                rn = a.headers,
                an;
              rn &&
              0 < rn.remainingCapacity &&
              typeof n.srcSet != `string` &&
              (n.fetchPriority === `high` || 500 > rn.highImagePreloads.length) &&
              ((an = dt(Zt, `image`, {
              ...
              0 <= (rn.remainingCapacity -= an.length + 2))
                ? ((a.resets.image[$t] = ae),
                  rn.highImagePreloads && (rn.highImagePreloads += `, `),
                  (rn.highImagePreloads += an))
                : ((tn = []),
                  Te(tn, {
                    rel: `preload`,
                    as: `image`,
                ...
                if (hn != null) {
                  ...
                  switch (mn) {
                    ...
                    case `className`:
                      gn = `class`;
                    default:
                      if (ee(mn) && typeof hn != `function` && typeof hn != `symbol` && !1 !== hn) {
                        if (!0 === hn) hn = ``;
    ...
    function qe(e) {
      ...
      if (n.length) {
        ...
        ((Ke = this.push(`</style>`)), (Ge = !0), (t.length = 0), (n.length = 0));
      }
    }
    function K(e) {
    ...
    function tt(e, t) {
      ...
      (t.stylesheets.forEach(function (t) {
        if (t.state !== 2)
          if (t.state === 3)
            (e.push(n), (t = G(`` + t.props.href)), e.push(t), e.push(`]`), (n = `,[`));
          else {
            e.push(n);
    ...
    function J(e, t, n) {
      ...
      (e.push(`,`), (r = G(r)), e.push(r), e.push(`,`), (r = G(t)), e.push(r));
    }
    function nt() {
...
` +
            ...
            default:
              ...
              if (
                ...
                switch (((i = []), (e = D({ rel: `preload`, href: e, as: t }, n)), Te(i, e), t)) {
                  case `font`:
    ...
    function ot(e, t) {
      ...
      if (n) {
        ...
        if (e) {
          ...
          (Te(a, D({ rel: `modulepreload`, href: e }, t)), i.bulkPreloads.add(a), Dr(n));
        }
      } else z.m(e, t);
    }
    function st(e, t, n) {
        ...
        if (e) {
          ...
          s !== null &&
            ...
            o ||
              ...
              a.styles.set(t, o)),
            (t = { state: 0, props: D({ rel: `stylesheet`, href: e, "data-precedence": t }, n) }),
            s &&
...
`:
    ...
    function yt(e, t) {
      ...
      (i !== void 0 &&
        (r.push(`<script`), et(r, e), r.push(`>`, (`` + i).replace(se, ce), `<\/script>`)),
        (i = n + `P:`));
      var s = n + `S:`;
      n += `B:`;
      var c = new Set(),
    ...
    function Bt(e, t, n) {
      switch (
        ((n = e[n]), n === void 0 ? e.push(t) : n !== t && (t.then(X, X), (t = n)), t.status)
      ) {
        case `fulfilled`:
          return t.value;
        case `rejected`:
    ...
    function cn() {
      ((Jt = qt = Kt = Gt = null), (Zt = !1), (Yt = null), ($ = 0), (Z = nn = null));
    }
    function ln(e, t) {
    ...
    function un(e, t, n) {
      ...
      return (
        (e = e === ln ? (typeof t == `function` ? t() : t) : n === void 0 ? t : n(t)),
        (Z.memoizedState = e),
        (e = Z.queue = { last: null, dispatch: null }),
        (e = e.dispatch = fn.bind(null, Gt, e)),
        [Z.memoizedState, e]
      );
    }
    function dn(e, t) {
      if (((Gt = rn()), (Z = on()), (t = t === void 0 ? null : t), Z !== null)) {
    ...
    function gn(e, t, n) {
      ...
      if (typeof e.$$FORM_ACTION == `function`) {
        ...
        if (i !== null && typeof s == `function`) {
          var c = i[1];
          s.call(e, i[2], i[3]) &&
            ((a = n === void 0 ? `k` + E(JSON.stringify([o, null, r]), 0) : `p` + n),
            c === a && (($t = r), (t = i[0])));
        }
        var l = e.bind(null, t);
        return (
...
` + c[r].replace(` at new `, ` at `);
    ...
    function Dn(e) {
      ...
      if (typeof e == `function`)
        return e.prototype && e.prototype.isReactComponent ? En(e, !0) : En(e, !1);
      if (typeof e == `object` && e) {
        switch (e.$$typeof) {
          case f:
...
` + e;
    ...
    function An(e, t, n, r, i, a, o, s, c, l, u) {
      ...
      ((this.destination = null),
        ...
        (this.onPostpone = l === void 0 ? X : l),
        (this.onAllReady = a === void 0 ? X : a),
        (this.onShellReady = o === void 0 ? X : o),
        (this.onShellError = s === void 0 ? X : s),
        (this.onFatalError = c === void 0 ? X : c),
...
` +
      ...
      for (; t !== null; ) {
        ...
        if (r !== null) {
          ...
          for (var i = 0; i < r.length; i++) {
            var a = r[i];
            (n !== null && vt(a.contentState, n), mr(e, a, null, null));
          }
        }
      ...
      if (t.replay !== null) {
        ...
        for (
          ...
          ((f = r[d]),
            ...
            (p = Ln(e, u, null, t.formatContext, d === 0 ? i.lastPushedText : !0, !0)),
    ...
    function Jn(e, t, n, r, i, a) {
      ...
      for (
        ...
        ((Zt = !1), (Qt = Q = 0), ($t = -1), (en = 0), ($ += 1), (Z = null), (e = r(i, a)));
      return (cn(), e);
    }
    ...
    function Xn(e, t, n, r, a, o) {
      if (typeof r == `function`)
        if (r.prototype && r.prototype.isReactComponent) {
          var _ = a;
          if (`ref` in a) for (var x in ((_ = {}), a)) x !== `ref` && (_[x] = a[x]);
          var C = r.defaultProps;
          if (C) for (var E in (_ === a && (_ = D({}, _, a)), C)) _[E] === void 0 && (_[E] = C[E]);
          ((a = _),
            (_ = Y),
            (C = r.contextType),
            typeof C == `object` && C && (_ = C._currentValue2),
            (_ = new r(a, _)));
          var O = _.state === void 0 ? null : _.state;
          if (
            ((_.updater = Mt),
            (_.props = a),
            (_.state = O),
            ...
            (_._reactInternals = C),
            (o = r.contextType),
            (_.context = typeof o == `object` && o ? o._currentValue2 : Y),
            (o = r.getDerivedStateFromProps),
            typeof o == `function` &&
              ((o = o(a, O)), (O = o == null ? O : D({}, O, o)), (_.state = O)),
            ...
            if (
              ...
              r !== _.state && Mt.enqueueReplaceState(_, _.state, null),
              ...
              if (
                ...
                for (C = o ? r[0] : _.state, O = !0, o = o ? 1 : 0; o < r.length; o++)
                  ((E = r[o]),
                    (E = typeof E == `function` ? E.call(_, C, a, void 0) : E),
                    E != null && (O ? ((O = !1), (C = D({}, C, E))) : D(C, E)));
                _.state = C;
              }
            else C.queue = null;
          if (((r = _.render()), e.status === 12)) throw null;
          ((a = t.keyPath), (t.keyPath = n), Qn(e, t, r, -1), (t.keyPath = a));
        } else {
          if (((r = Jn(e, t, n, r, a, void 0)), e.status === 12)) throw null;
          Yn(e, t, n, r, Q !== 0, Qt, $t);
        }
      else if (typeof r == `string`)
        if (((_ = t.blockedSegment), _ === null))
          ((_ = a.children),
            (C = t.formatContext),
            (O = t.keyPath),
          ...
          a: {
            switch (((t = _.chunks), (e = e.resumableState), r)) {
              case `title`:
              case `style`:
              case `script`:
              case `area`:
        ...
        switch (r) {
          ...
          case l:
          case s:
            ((r = t.keyPath), (t.keyPath = n), Qn(e, t, a.children, -1), (t.keyPath = r));
            return;
          case y:
            ((r = t.blockedSegment),
              r === null
                ? a.mode !== `hidden` &&
                  ((r = t.keyPath), (t.keyPath = n), or(e, t, a.children, -1), (t.keyPath = r))
                : a.mode !== `hidden` &&
            ...
            a: {
              ...
              a === `together`
                ? ((a = t.keyPath),
                  ...
                  (t.keyPath = a),
                  (t.row = _),
                  _ !== null && 0 < C.pendingTasks && (_.pendingTasks++, (C.next = _)))
                : ((a = t.keyPath), (t.keyPath = n), Qn(e, t, r, -1), (t.keyPath = a));
            }
            return;
          case S:
          ...
          case p:
            a: if (t.replay !== null) {
              ((r = t.keyPath),
                ...
                (C = t.row),
                (t.keyPath = n),
                (t.formatContext = fe(e.resumableState, _)),
                (t.row = null),
                (n = a.children));
              try {
                or(e, t, n, -1);
              } finally {
                ((t.keyPath = r), (t.formatContext = _), (t.row = C));
              }
            } else {
              ...
              a = a.children;
              var M = new Set(),
                N = Pn(e, t.row, M, null, null);
              e.trackedPostpones !== null && (N.trackedContentKeyPath = n);
              var P = Ln(e, x.chunks.length, N, t.formatContext, !1, !1);
              (x.children.push(P), (x.lastPushedText = !1));
              var F = Ln(e, 0, null, t.formatContext, !1, !1);
              if (((F.parentFlushed = !0), e.trackedPostpones !== null)) {
                ...
                try {
                  ...
                  ((N.status = 4),
                    e.status === 12
                      ? ((F.status = 3), (_ = e.fatalError))
                      : ((F.status = 4), (_ = n)),
                    (C = Bn(t.componentStack)),
                    (O = Vn(e, _, C)),
                    (N.errorDigest = O),
                    rr(e, N));
                } finally {
        ...
        if (typeof r == `object` && r)
          switch (r.$$typeof) {
            case f:
              if (`ref` in a) for (ee in ((_ = {}), a)) ee !== `ref` && (_[ee] = a[ee]);
              else _ = a;
              ((r = Jn(e, t, n, r.render, _, o)), Yn(e, t, n, r, Q !== 0, Qt, $t));
              return;
            case h:
              Xn(e, t, n, r.type, a, o);
              return;
            ...
            case u:
              ...
              return;
            case g:
              if (((_ = r._init), (r = _(r._payload)), e.status === 12)) throw null;
              Xn(e, t, n, r, a, o);
              return;
          }
    ...
    function $n(e, t) {
      ...
      if (n !== null) {
        if (typeof n == `object`) {
                      ...
                      if (_.length === 4) {
                        ...
                        try {
                          ...
                          if (
                            ...
                            throw (t.node === m ? (t.replay = h) : r.splice(n, 1), i);
                          (t.replay.pendingTasks--,
                        ...
                        if (s !== p) throw Error(i(490, `Suspense`, wt(s) || `Unknown`));
                        b: {
                          ((h = void 0),
                            (s = _[5]),
                            (u = _[2]),
          ...
          if (typeof n.then == `function`) return ((t.thenableState = null), Qn(e, t, _n(n), r));
          if (n.$$typeof === d) return Qn(e, t, n._currentValue2, r);
          throw (
    ...
    function er(e, t, n, r) {
      ...
      if (
        ...
        for (r = 0; r < s; r++)
          ((l = n[r]),
            (t.treeContext = Pt(o, s, r)),
            (u = c[r]),
            typeof u == `number` ? (Zn(e, t, u, l, r), delete c[r]) : or(e, t, l, r));
        ((t.treeContext = o), (t.keyPath = a));
        return;
      }
      for (c = 0; c < s; c++) ((r = n[c]), (t.treeContext = Pt(o, s, c)), or(e, t, r, c));
      ((t.treeContext = o), (t.keyPath = a));
    }
    function tr(e, t, n) {
      if (
        ...
        if (
          ...
          a === null
            ...
            : ((n = t.workingMap.get(a)),
              n === void 0 ? ((n = [a[1], a[2], [], r.id]), Ar(n, a[0], t)) : (n[3] = r.id));
        else {
          if (a === null) {
    ...
    function or(e, t, n, r) {
      ...
      if (l === null) {
        ...
        try {
          ...
          if ((cn(), (n = u === zt ? Ht() : u), e.status !== 12 && typeof n == `object` && n)) {
      ...
      throw (
        (t.formatContext = i), (t.context = a), (t.keyPath = o), (t.treeContext = s), jt(a), n
      );
    }
    function sr(e) {
        ...
        if (t.status !== 13 && t.status !== 14) {
          if (((r = e.replay), r === null)) {
            t.trackedPostpones !== null && i !== null
              ? ((r = t.trackedPostpones), Vn(t, n, a), nr(t, r, e, i), mr(t, null, e.row, i))
              : (Vn(t, n, a), Hn(t, n));
            return;
          }
          (r.pendingTasks--,
    ...
    function mr(e, t, n, r) {
      if (
        (n !== null && (--n.pendingTasks === 0 ? Un(e, n) : n.together && Gn(e, n)),
        e.allPendingTasks--,
        t === null)
      ) {
        ...
        if (t.pendingTasks === 0) {
          if (
            ...
            r !== null && r.parentFlushed && (r.status === 1 || r.status === 3) && pr(t, r),
    ...
    function hr(e) {
      if (e.status !== 14 && e.status !== 13) {
        ...
        try {
          ...
          for (c = 0; c < s.length; c++) {
            ...
            if (d === null) {
              ...
              if (l.replay.pendingTasks !== 0) {
                ...
                try {
                  ...
                  if (typeof p == `object` && p && typeof p.then == `function`) {
                    var m = l.ping;
                    (p.then(m, m), (l.thenableState = e === zt ? sn() : null));
                  } else {
              ...
              try {
                ...
                (cn(), (g.children.length = x), (g.chunks.length = S));
                ...
                if (u.status === 12 && u.trackedPostpones !== null) {
                  ...
                  ((g.status = 0), (l.thenableState = e === zt ? sn() : null));
                  var E = l.ping;
                  C.then(E, E);
                } else {
          ...
          ((bn = o), (re.H = n), (re.A = r), n === yn && jt(t), (Mn = a));
        }
      }
    }
    function gr(e, t, n) {
    ...
    function _r(e, t, n) {
      var r = t.boundary;
      if (r === null) return gr(e, t, n);
      var a = r.contentPreamble,
        o = r.fallbackPreamble;
      if (a === null || o === null) return !1;
      switch (r.status) {
        case 1:
          if ((Le(e.renderState, a), (e.byteSize += r.byteSize), (t = r.completedSegments[0]), !t))
            throw Error(i(391));
          return gr(e, t, n);
        case 5:
          if (e.trackedPostpones !== null) return !0;
        case 4:
          if (t.status === 1) return (Le(e.renderState, o), gr(e, t, n));
        default:
          return !0;
      }
    }
    ...
    function xr(e, t, n, r) {
      ...
      if (a.status !== 1)
        return (
          ...
          ze(t, e.renderState, a.rootSegmentID),
      ...
      if (
        ...
        throw Error(i(391));
      return (
        xr(e, t, n[0], r), (e = e.renderState.generateStaticMarkup ? !0 : t.push(`<!--/$-->`)), e
      );
    }
    function Sr(e, t, n, r) {
      return (
        Be(t, e.renderState, n.parentFormatContext, n.id),
        xr(e, t, n, r),
        Ve(t, n.parentFormatContext)
      );
    }
    function Cr(e, t, n) {
      br = n.byteSize;
...
$RC=function(a,b){if(b=document.getElementById(b))(a=document.getElementById(a))?(a.previousSibling.data="$~",$RB.push(a,b),2===$RB.length&&("number"!==typeof $RT?requestAnimationFrame($RV.bind(null,$RB)):(a=performance.now(),setTimeout($RV.bind(null,$RB),2300>a&&2E3<a?2300-a:$RT+300-a)))):b.parentNode.removeChild(b)};`)),
      ...
      try {
        if (!(0 < e.pendingRootTasks)) {
          ...
          if (r !== null) {
            ...
            ((f.length = 0), o.preconnects.forEach(Ye, t), o.preconnects.clear());
          ...
          for (n = 0; n < I.length; n++) {
            ...
            a: {
              ...
              (R !== null &&
                R.together &&
                L.pendingTasks === 1 &&
                (R.pendingTasks === 1 ? Wn(O, R, R.hoistables) : R.pendingTasks--),
                (ie = Je(k, L.contentState, O.renderState)));
            }
            if (!ie) {
        ...
        ((Tr = !1),
          e.allPendingTasks === 0 &&
            ...
            ((e.flushScheduled = !1),
            (n = e.resumableState),
            n.hasBody && ((I = W(`body`)), t.push(I)),
            n.hasHtml && ((n = W(`html`)), t.push(n)),
            (e.status = 14),
            t.push(null),
            (e.destination = null)));
      }
  ...
  wl = t((e) => {
    ...
    function Ne(e, t, n, r, i, a) {
      ...
      if (
        (d !== void 0 && (u.push(o), tr(u, e), u.push(nt, I((`` + d).replace(ke, Ae)), H)),
        (d = []),
        r !== void 0 &&
          (d.push(je), d.push(I((`` + JSON.stringify(r)).replace(ke, Ae))), d.push(Me)),
        (r = i
          ? {
              preconnects: ``,
              fontPreloads: ``,
        ...
        for (r = 0; r < f.length; r++)
          ((l = f[r]),
            ...
            u.push(Se, I(V(a)), K),
            n && u.push(we, I(V(n)), K),
            typeof s == `string` && u.push(Te, I(V(s)), K),
            typeof o == `string` && u.push(Ee, I(V(o)), K),
            tr(u, e),
            u.push(De));
      if (p !== void 0)
        for (t = 0; t < p.length; t++)
          ((s = p[t]),
            ...
            u.push(Ce, I(V(f)), K),
            n && u.push(we, I(V(n)), K),
            typeof a == `string` && u.push(Te, I(V(a)), K),
            typeof r == `string` && u.push(Ee, I(V(r)), K),
            tr(u, e),
            u.push(De));
      return i;
    }
    ...
    function W(e, t, n) {
      ...
      switch (t) {
        case `noscript`:
          return Fe(2, null, r | 1, null);
        case `select`:
          return Fe(2, n.value == null ? n.defaultValue : n.value, r, null);
        case `svg`:
          return Fe(4, null, r, null);
        case `picture`:
          return Fe(2, null, r | 2, null);
        case `math`:
          return Fe(5, null, r, null);
        case `foreignObject`:
          return Fe(2, null, r, null);
        case `table`:
          return Fe(6, null, r, null);
        case `thead`:
        case `tbody`:
        case `tfoot`:
          return Fe(7, null, r, null);
        case `colgroup`:
          return Fe(9, null, r, null);
        case `tr`:
          return Fe(8, null, r, null);
        case `head`:
          if (2 > e.insertionMode) return Fe(3, null, r, null);
          break;
        case `html`:
          if (e.insertionMode === 0) return Fe(1, null, r, null);
      }
      return 6 <= e.insertionMode || 2 > e.insertionMode
        ? Fe(2, null, r, null)
        : e.tagScope === r
          ? e
          : Fe(e.insertionMode, e.selectedValue, r, null);
    }
    function Le(e) {
      return e === null
        ? null
    ...
    function Re(e, t) {
      return (
        t.tagScope & 32 && (e.instructions |= 128),
        Fe(t.insertionMode, t.selectedValue, t.tagScope | 12, Le(t.viewTransition))
      );
    }
    function ze(e, t) {
      e = Le(t.viewTransition);
      var n = t.tagScope | 16;
      return (
        e !== null && e.share !== `none` && (n |= 64), Fe(t.insertionMode, t.selectedValue, n, e)
      );
    }
    var Be = L(`<!-- -->`);
    function Ve(e, t, n, r) {
      return t === `` ? r : (r && e.push(Be), e.push(I(V(t))), !0);
    }
    var He = new Map(),
      Ue = L(` style="`),
      We = L(`:`),
                ...
                (a =
                  typeof a == `number`
                    ? a === 0 || le.has(r)
                      ...
                      : I(a + `px`)
                    : I(V((`` + a).trim()))));
            n ? ((n = !1), e.push(Ue, o, We, a)) : e.push(G, o, We, a);
          }
        }
      n || e.push(K);
    }
    var Ke = L(` `),
      ...
      Je = L(`=""`);
    function Ye(e, t, n) {
      n && typeof n != `function` && typeof n != `symbol` && e.push(Ke, I(t), Je);
    }
    function q(e, t, n) {
      typeof n != `function` &&
        typeof n != `symbol` &&
        typeof n != `boolean` &&
        e.push(Ke, I(t), qe, I(V(n)), K);
    }
    var Xe = L(V(`javascript:throw new Error('React form unexpectedly submitted.')`)),
      Ze = L(`<input type="hidden"`);
    function Qe(e, t) {
      (this.push(Ze), $e(e), q(this, `name`, t), q(this, `value`, e), this.push(rt));
    }
    function $e(e) {
      if (typeof e != `string`) throw Error(i(480));
    }
    ...
    function tt(e, t, n, r, i, a, o, s) {
      ...
      if (typeof r == `function`) {
        var l = et(t, r);
        l === null
          ? (e.push(Ke, I(`formAction`), qe, Xe, K), (o = a = i = r = s = null), ct(t, n))
          : ((s = l.name),
            (r = l.action || ``),
            (i = l.encType),
            (a = l.method),
    ...
    function J(e, t, n) {
      switch (t) {
        ...
        case `formAction`:
          if (n == null || typeof n == `function` || typeof n == `symbol` || typeof n == `boolean`)
            break;
          ((n = me(`` + n)), e.push(Ke, I(t), qe, I(V(n)), K));
          break;
        case `defaultValue`:
        case `defaultChecked`:
        case `innerHTML`:
        ...
        case `xlinkHref`:
          if (typeof n == `function` || typeof n == `symbol` || typeof n == `boolean`) break;
          ((n = me(`` + n)), e.push(Ke, I(`xlink:href`), qe, I(V(n)), K));
          break;
        case `contentEditable`:
        case `spellCheck`:
        case `draggable`:
        ...
        case `focusable`:
        case `preserveAlpha`:
          typeof n != `function` && typeof n != `symbol` && e.push(Ke, I(t), qe, I(V(n)), K);
          break;
        case `inert`:
        case `allowFullScreen`:
        case `async`:
    ...
    function ct(e, t) {
      if (!(e.instructions & 16)) {
        ...
        var n = t.preamble,
          r = t.bootstrapChunks;
        (n.htmlChunks || n.headChunks) && r.length === 0
          ? (r.push(t.startInlineScript), tr(r, e), r.push(nt, st, H))
          : r.unshift(t.startInlineScript, nt, st, H);
      }
    }
    var lt = L(`<!--F!-->`),
      ut = L(`<!--F-->`);
    ...
    function xt(e, t, n) {
      ...
      return (e.push(nt), it(e, r, n), typeof n == `string` ? (e.push(I(V(n))), null) : n);
    }
    var St = L(`
`),
    ...
    function Et(e, t, n, r, a, o, s, c, l) {
      switch (t) {
        ...
        case `textarea`:
          ...
          if ((k === null && A !== null && (k = A), e.push(nt), j != null)) {
...
` &&
        ...
        case `input`:
          ...
          var le = tt(e, r, a, P, F, te, ne, N);
          return (
            ie === null ? ae !== null && Ye(e, `checked`, ae) : Ye(e, `checked`, ie),
        ...
        case `button`:
          ...
          var be = tt(e, r, a, fe, pe, he, ge, de);
          if ((e.push(nt), be?.forEach(Qe, e), it(e, ue, B), typeof B == `string`)) {
            e.push(I(V(B)));
            var xe = null;
          } else xe = B;
          return xe;
        case `form`:
          ...
          if (typeof Ce == `function`) {
            var je = et(r, Ce);
            je === null
              ? (e.push(Ke, I(`action`), qe, Xe, K), (Ee = Te = we = Ce = null), ct(r, a))
              : ((Ce = je.action || ``),
                (we = je.encType),
                (Te = je.method),
                (Ee = je.target),
          ...
          if (
            (Ce != null && J(e, `action`, Ce),
            we != null && J(e, `encType`, we),
            Te != null && J(e, `method`, Te),
            Ee != null && J(e, `target`, Ee),
            e.push(nt),
            Ae !== null && (e.push(Ze), q(e, `name`, Ae), e.push(rt), ke?.forEach(Qe, e)),
            it(e, Se, H),
            typeof H == `string`)
          ) {
            e.push(I(V(H)));
          ...
          return Me;
        case `menuitem`:
          for (var Ne in (e.push(Y(`menuitem`)), n))
            if (z.call(n, Ne)) {
              var Pe = n[Ne];
              if (Pe != null)
                switch (Ne) {
              ...
              if (W != null)
                switch (Ie) {
                  ...
                  case `data`:
                    var Le = me(`` + W);
                    if (Le === ``) break;
                    e.push(Ke, I(`data`), qe, I(V(Le)), K);
                    break;
                  default:
                    J(e, Ie, W);
                }
            }
          if ((e.push(nt), it(e, Fe, U), typeof U == `string`)) {
            e.push(I(V(U)));
            var Re = null;
          } else Re = U;
          return Re;
        case `title`:
          var ze = c.tagScope & 1,
            Ve = c.tagScope & 4;
          if (c.insertionMode === 4 || ze || n.itemProp != null) var He = ht(e, n);
          else Ve ? (He = null) : (ht(a.hoistableChunks, n), (He = void 0));
          return He;
        case `link`:
          var Ue = c.tagScope & 1,
            We = c.tagScope & 4,
          ...
          if (
            ...
            if (typeof $e != `string` || n.disabled != null || n.onLoad || n.onError) st = dt(e, n);
              ...
              var lt = a.styles.get($e),
                ut = r.styleResources.hasOwnProperty(Je) ? r.styleResources[Je] : void 0;
              if (ut !== null) {
                ((r.styleResources[Je] = null),
                  lt ||
                    ((lt = { precedence: I(V($e)), rules: [], hrefs: [], sheets: new Map() }),
                    a.styles.set($e, lt)));
                var Ct = {
                  state: 0,
                ...
                if (ut) {
                  ut.length === 2 && gr(Ct.props, ut);
                  var wt = a.preloads.stylesheets.get(Je);
                  wt && 0 < wt.length ? (wt.length = 0) : (Ct.state = 1);
                }
                (lt.sheets.set(Je, Ct), s && s.stylesheets.add(Ct));
              } else if (lt) {
                var Et = lt.sheets.get(Je);
            ...
            n.onLoad || n.onError
              ? (st = dt(e, n))
              : (l && e.push(Be), (st = We ? null : dt(a.hoistableChunks, n)));
          return st;
        case `script`:
          var Dt = c.tagScope & 1,
            kt = n.async;
          if (
            ...
            var jt = n.src;
            if (n.type === `module`)
              var Mt = r.moduleScriptResources,
                Nt = a.preloads.moduleScripts;
            else ((Mt = r.scriptResources), (Nt = a.preloads.scripts));
            var Pt = Mt.hasOwnProperty(jt) ? Mt[jt] : void 0;
            if (Pt !== null) {
              Mt[jt] = null;
              var Ft = n;
              if (Pt) {
                Pt.length === 2 && ((Ft = R({}, n)), gr(Ft, Pt));
                var It = Nt.get(jt);
                It && (It.length = 0);
              }
              var Lt = [];
              (a.scripts.add(Lt), yt(Lt, Ft));
            }
            (l && e.push(Be), (At = null));
          }
          return At;
            ...
            if ((r.styleResources.hasOwnProperty(zt) ? r.styleResources[zt] : void 0) !== null) {
              ...
              if (!Jt || Jt === Bt) {
                ...
                (typeof Qt != `function` &&
                  typeof Qt != `symbol` &&
                  Qt != null &&
                  Yt.push(I((`` + Qt).replace(ft, pt))),
                  it(Yt, Xt, Z));
              }
            }
            (qt && s && s.styles.add(qt), l && e.push(Be), (Kt = void 0));
          }
          return Kt;
        case `meta`:
          var $t = c.tagScope & 1,
            en = c.tagScope & 4;
          if (c.insertionMode === 4 || $t || n.itemProp != null) var tn = mt(e, n, `meta`);
          else
            (l && e.push(Be),
              (tn = en
                ? null
...
` &&
        ...
        case `img`:
          ...
          if (
            ...
            s !== null && c.tagScope & 64 && (s.suspenseyImages = !0);
            var un = typeof n.sizes == `string` ? n.sizes : void 0,
              dn = ln
                ? ln +
                  `
` +
                  (un || ``)
                : cn,
              fn = a.preloads.images,
              pn = fn.get(dn);
            if (pn)
              (n.fetchPriority === `high` || 10 > a.highImagePreloads.size) &&
                (fn.delete(dn), a.highImagePreloads.add(pn));
            else if (!r.imageResources.hasOwnProperty(dn)) {
              r.imageResources[dn] = ye;
              var mn = n.crossOrigin,
                hn = typeof mn == `string` ? (mn === `use-credentials` ? mn : ``) : void 0,
                gn = a.headers,
                _n;
              gn &&
              0 < gn.remainingCapacity &&
              typeof n.srcSet != `string` &&
              (n.fetchPriority === `high` || 500 > gn.highImagePreloads.length) &&
              ((_n = _r(cn, `image`, {
                imageSrcSet: n.srcSet,
                imageSizes: n.sizes,
                crossOrigin: hn,
              ...
              0 <= (gn.remainingCapacity -= _n.length + 2))
                ...
                : ((pn = []),
                  ...
                  n.fetchPriority === `high` || 10 > a.highImagePreloads.size
                    ? a.highImagePreloads.add(pn)
                    : (a.bulkPreloads.add(pn), fn.set(dn, pn)));
            }
          }
          return mt(e, n, `img`);
        case `base`:
        ...
        case `head`:
          if (2 > c.insertionMode) {
            ...
            (o !== null && e.push(gt), (vn.headChunks = []));
            var yn = bt(vn.headChunks, n, `head`);
          } else yn = xt(e, n, `head`);
          return yn;
        case `body`:
          if (2 > c.insertionMode) {
            ...
            (o !== null && e.push(_t), (bn.bodyChunks = []));
            var xn = bt(bn.bodyChunks, n, `body`);
          } else xn = xt(e, n, `body`);
          return xn;
        case `html`:
          if (c.insertionMode === 0) {
            ...
            (o !== null && e.push(vt), (Sn.htmlChunks = [Tt]));
            var Cn = bt(Sn.htmlChunks, n, `html`);
          } else Cn = xt(e, n, `html`);
          return Cn;
        default:
          if (t.indexOf(`-`) !== -1) {
                ...
                if (Dn != null) {
                  ...
                  switch (En) {
                    ...
                    case `className`:
                      On = `class`;
                    default:
                      if (ce(En) && typeof Dn != `function` && typeof Dn != `symbol` && !1 !== Dn) {
                        if (!0 === Dn) Dn = ``;
                        else if (typeof Dn == `object`) continue;
                        e.push(Ke, I(On), qe, I(V(Dn)), K);
                      }
                  }
                }
              }
            return (e.push(nt), it(e, Tn, wn), wn);
          }
      }
      return xt(e, n, t);
    }
    ...
    function Ot(e) {
      var t = Dt.get(e);
      return (t === void 0 && ((t = L(`</` + e + `>`)), Dt.set(e, t)), t);
    }
    function kt(e, t) {
      ((e = e.preamble),
        e.htmlChunks === null && t.htmlChunks && (e.htmlChunks = t.htmlChunks),
    ...
    var jt = L(`requestAnimationFrame(function(){$RT=performance.now()});`),
      Mt = L(`<template id="`),
      Nt = L(`"></template>`),
      Pt = L(`<!--&-->`),
      Ft = L(`<!--/&-->`),
    ...
    function Wt(e, t, n) {
      ...
      return (P(e, t.boundaryPrefix), P(e, I(n.toString(16))), F(e, Rt));
    }
    var Gt = L(`<div hidden id="`),
      ...
      nn = L(`">`),
      $ = L(`</tbody></table>`),
      rn = L(`<table hidden><tr id="`),
      an = L(`">`),
      on = L(`</tr></table>`),
      sn = L(`<table hidden><colgroup id="`),
      cn = L(`">`),
      ln = L(`</colgroup></table>`);
    function un(e, t, n, r) {
      switch (n.insertionMode) {
...
"$~";Promise.all(b).then($RC.bind(null,n,w),$RX.bind(null,n,"CSS failed to load"))};$RR("`),
    ...
    var Pn = L(` media="not all" data-precedence="`),
      Fn = L(`" data-href="`),
      In = L(`">`),
      Ln = L(`</style>`),
      Rn = !1,
    ...
    function Bn(e) {
      ...
      if (n.length) {
        for (
          P(this, be.startInlineStyle), P(this, Pn), P(this, e.precedence), P(this, Fn);
          r < n.length - 1;
          r++
        )
          (P(this, n[r]), P(this, Jn));
        for (P(this, n[r]), P(this, In), r = 0; r < t.length; r++) P(this, t[r]);
    ...
    function tr(e, t) {
      !(t.instructions & 32) &&
        ((t.instructions |= 32), e.push(er, I(V(`_` + t.idPrefix + `R_`)), K));
    }
    var nr = L(`[`),
      rr = L(`,[`),
      ir = L(`,`),
    ...
    function or(e, t) {
      ...
      (t.stylesheets.forEach(function (t) {
        if (t.state !== 2)
          if (t.state === 3) (P(e, n), P(e, I(Nn(`` + t.props.href))), P(e, ar), (n = rr));
          else {
            P(e, n);
            var r = t.props[`data-precedence`],
              a = t.props;
            for (var o in (P(e, I(Nn(me(`` + t.props.href)))),
            (r = `` + r),
            P(e, ir),
            P(e, I(Nn(r))),
            a))
    ...
    function sr(e, t, n) {
      ...
      (P(e, ir), P(e, I(Nn(r))), P(e, ir), P(e, I(Nn(t))));
    }
    function cr() {
      return { styles: new Set(), stylesheets: new Set(), suspenseyImages: !1 };
    }
...
` +
    ...
    function ia(e, t, n, r, i) {
      ...
      if (t.replay !== null) {
        ...
        for (
          ...
          try {
            (_a(e, t, f, d),
              p.lastPushedText && p.textEmbedded && p.chunks.push(Be),
              (p.status = 1),
    ...
    function sa(e, t, n, r, a, o) {
      if (typeof r == `function`)
        if (r.prototype && r.prototype.isReactComponent) {
          ...
          if (`ref` in a) for (var x in ((_ = {}), a)) x !== `ref` && (_[x] = a[x]);
          var C = r.defaultProps;
          if (C) for (var E in (_ === a && (_ = R({}, _, a)), C)) _[E] === void 0 && (_[E] = C[E]);
          ((a = _),
            (_ = kr),
            (C = r.contextType),
            typeof C == `object` && C && (_ = C._currentValue),
            (_ = new r(a, _)));
          var D = _.state === void 0 ? null : _.state;
          if (
            ((_.updater = Lr),
            (_.props = a),
            (_.state = D),
            ...
            (_._reactInternals = C),
            (o = r.contextType),
            (_.context = typeof o == `object` && o ? o._currentValue : kr),
            (o = r.getDerivedStateFromProps),
            typeof o == `function` &&
              ((o = o(a, D)), (D = o == null ? D : R({}, D, o)), (_.state = D)),
            typeof r.getDerivedStateFromProps != `function` &&
              typeof _.getSnapshotBeforeUpdate != `function` &&
              (typeof _.UNSAFE_componentWillMount == `function` ||
                typeof _.componentWillMount == `function`))
            ...
            if (
              ...
              typeof _.componentWillMount == `function` && _.componentWillMount(),
              typeof _.UNSAFE_componentWillMount == `function` && _.UNSAFE_componentWillMount(),
              r !== _.state && Lr.enqueueReplaceState(_, _.state, null),
              C.queue !== null && 0 < C.queue.length)
            )
              if (
                ((r = C.queue),
                ...
                for (C = o ? r[0] : _.state, D = !0, o = o ? 1 : 0; o < r.length; o++)
                  ((E = r[o]),
                    (E = typeof E == `function` ? E.call(_, C, a, void 0) : E),
        ...
        if (((_ = t.blockedSegment), _ === null))
          ...
          if (
            ...
            (o = t.keyPath),
            (t.keyPath = n),
            (t.formatContext = W(C, r, a)).insertionMode === 3)
          ) {
            ...
            try {
              ((n.status = 6),
                _a(e, t, D, -1),
                n.lastPushedText && n.textEmbedded && n.chunks.push(Be),
                (n.status = 1),
          ...
          case p:
            a: if (t.replay !== null) {
              ((r = t.keyPath),
                ...
                (C = t.row),
                (t.keyPath = n),
                (t.formatContext = ze(e.resumableState, _)),
                (t.row = null),
                (n = a.children));
              try {
                _a(e, t, n, -1);
              ...
              if (((P.parentFlushed = !0), e.trackedPostpones !== null)) {
                ...
                ((t = Ki(
                  ...
                  t.abortSet,
                  n,
                  ze(e.resumableState, t.formatContext),
                  t.context,
                  t.treeContext,
                  null,
                  _,
                ...
                ((t.blockedBoundary = M),
                  ...
                  (t.blockedSegment = P),
                  (t.keyPath = n),
                  (t.formatContext = ze(e.resumableState, o)),
                  (t.row = null),
                  (P.status = 6));
                try {
                  if (
        ...
        if (typeof r == `object` && r)
          switch (r.$$typeof) {
            case f:
              if (`ref` in a) for (A in ((_ = {}), a)) A !== `ref` && (_[A] = a[A]);
              else _ = a;
              ((r = aa(e, t, n, r.render, _, o)), oa(e, t, n, r, ai !== 0, oi, si));
              return;
            case h:
              sa(e, t, n, r.type, a, o);
              return;
    ...
    function ua(e, t) {
      ...
      if (n !== null) {
                  ...
                  for (r = h.nodes, n = 0; n < r.length; n++) {
                    ...
                    if (m === _[1]) {
                      if (_.length === 4) {
                        ...
                        if (s !== p) throw Error(i(490, `Suspense`, Or(s) || `Unknown`));
                        b: {
                          ((h = void 0),
                            (s = _[5]),
                            (u = _[2]),
                          ...
                          ((l =
                            ...
                            (t.hoistableState = l.contentState),
                            (t.keyPath = c),
                            (t.formatContext = ze(e.resumableState, b)),
                            (t.row = null),
                            (t.replay = { nodes: u, slots: f, pendingTasks: 1 }));
                          try {
                            if (
        ...
        typeof n == `string`
          ? ((r = t.blockedSegment),
            r !== null && (r.lastPushedText = Ve(r.chunks, n, e.renderState, r.lastPushedText)))
          : (typeof n == `number` || typeof n == `bigint`) &&
            ((r = t.blockedSegment),
            r !== null &&
              (r.lastPushedText = Ve(r.chunks, `` + n, e.renderState, r.lastPushedText)));
      }
    }
    function da(e, t, n, r) {
      var a = t.keyPath;
        ...
        for (var o = t.replay, s = o.nodes, c = 0; c < s.length; c++) {
          ...
          if (l[1] === r) {
            ...
            try {
              ...
              if (typeof i == `object` && i && (i === Gr || typeof i.then == `function`)) throw i;
      ...
      if (
        ...
        for (r = 0; r < s; r++)
          ((l = n[r]),
            (t.treeContext = zr(o, s, r)),
            (u = c[r]),
            typeof u == `number` ? (ca(e, t, u, l, r), delete c[r]) : _a(e, t, l, r));
        ((t.treeContext = o), (t.keyPath = a));
        return;
      }
      for (c = 0; c < s; c++) ((r = n[c]), (t.treeContext = zr(o, s, c)), _a(e, t, r, c));
      ((t.treeContext = o), (t.keyPath = a));
    }
    function fa(e, t, n) {
      if (
    ...
    function _a(e, t, n, r) {
      ...
      throw (
        (t.formatContext = i), (t.context = a), (t.keyPath = o), (t.treeContext = s), Ir(a), n
      );
    }
    function va(e) {
      var t = e.blockedBoundary,
        ...
        try {
          ...
          for (c = 0; c < s.length; c++) {
            ...
            if (d === null) {
              ...
              try {
                (ua(u, l),
                  g.lastPushedText && g.textEmbedded && g.chunks.push(Be),
                  l.abortSet.delete(l),
                  (g.status = 1),
          ...
          ((Oi = o), (he.H = n), (he.A = r), n === Di && Ir(t), (Ui = a));
        }
      }
    }
    function Oa(e, t, n) {
    ...
    function ka(e, t, n) {
      ...
      switch (r.status) {
        case 1:
          if ((kt(e.renderState, a), (e.byteSize += r.byteSize), (t = r.completedSegments[0]), !t))
            throw Error(i(391));
          return Oa(e, t, n);
        case 5:
          if (e.trackedPostpones !== null) return !0;
    ...
    function Pa(e, t, n, r) {
      return (
        un(t, e.renderState, n.parentFormatContext, n.id),
        Na(e, t, n, r),
        dn(t, n.parentFormatContext)
      );
    }
    function Fa(e, t, n) {
      Ma = n.byteSize;
      ...
      return (
        ...
        a
          ...
          : (!(r.instructions & 2) && ((r.instructions |= 2), P(t, gn)), P(t, _n)),
        (r = I(i.toString(16))),
    ...
    function Ia(e, t, n, r) {
      ...
      return o === n.rootSegmentID
        ...
        : (Pa(e, t, r, a),
          ...
          P(t, e.startInlineScript),
          P(t, nt),
          n.instructions & 1 ? P(t, pn) : ((n.instructions |= 1), P(t, fn)),
          P(t, e.segmentPrefix),
          (o = I(o.toString(16))),
          P(t, o),
          P(t, mn),
    ...
    function Ra(e, t) {
      ...
      try {
        if (!(0 < e.pendingRootTasks)) {
          ...
          (ee.splice(0, n), te(t), (M = new Uint8Array(2048)), (N = 0), (La = !0));
          ...
          for (n = 0; n < ne.length; n++) {
            ...
            a: {
              ...
              (R !== null &&
                R.together &&
                L.pendingTasks === 1 &&
                (R.pendingTasks === 1 ? ta(T, R, R.hoistables) : R.pendingTasks--),
                (ie = Hn(E, L.contentState, T.renderState)));
            }
            if (!ie) {
              ((e.destination = null), n++, ne.splice(0, n));
              return;
        ...
        return new Promise(function (r, i) {
          var a,
            ...
            c = Vi(
              e,
              t,
              Ne(t.resumableState, n ? n.nonce : void 0, void 0, void 0, void 0, void 0),
              n ? n.onError : void 0,
              o,
              function () {
                var e = new ReadableStream(
...
function El({
  ...
  let l =
      r == null
        ? null
        : (0, $.isValidElement)(r)
          ? (0, $.cloneElement)(r, { className: b(Te, r.props.className) })
          : (0, $.createElement)(r, { className: Te }),
    u = (0, Tl.renderToStaticMarkup)(
      (0, $.createElement)(
        `span`,
        {
          className: b(Ee, Oe, De, i ? `cursor-interaction` : void 0, t),
          style: ke({ brandColor: e, style: a }),
          title: typeof c == `string` && c.length > 0 ? c : void 0,
          ...n,
        },
        l == null ? null : (0, $.createElement)(`span`, { className: we }, l),
        (0, $.createElement)(`span`, { className: b(`min-w-0 break-words`, s) }, o),
      ),
    ),
    ...
    toDOM: (e) => {
      ...
      return El({
        ...
        dataAttributes: {
          ...
          ...O({ href: A({ fsPath: e.attrs.fsPath, path: e.attrs.path }), label: e.attrs.label }),
        },
      });
    },
    parseDOM: [
  ...
  Ol = {
    ...
    toDOM: (e) => {
      let t = e.attrs.displayName || e.attrs.name,
        ...
        r = typeof e.attrs.conversationId == `string` ? e.attrs.conversationId : null;
      return El({
        text: `@${t}`,
        interactive: !0,
        className: `hover:opacity-90`,
        textClassName: ne(n) == null ? `text-token-foreground` : void 0,
        dataAttributes: {
    ...
    toDOM: (e) => {
      ...
      return El({
        ...
        dataAttributes: {
          ...
          ...O({ href: re({ resourceUri: n, server: r }), label: i }),
        },
      });
    },
    parseDOM: [
  ...
  return {
    ...
    toDOM: (s) => {
      let c = s.attrs.displayName || s.attrs.name,
        ...
        u = e === `app-mention` && fe(s.attrs.iconSmall) != null ? `` : s.attrs.iconSmall;
      return El({
        text: c,
        icon:
          e === `skill-mention`
...
var Nl = new Xe({
    nodes: {
      ...
      atMention: Dl,
      agentMention: Ol,
      skillMention: Ml(`skill-mention`),
      appMention: Ml(`app-mention`),
      pluginMention: Ml(`plugin-mention`),
      richLink: {
        attrs: {
        ...
        toDOM: (e) =>
          El({
            ...
            icon: me(e.attrs.sourceAppId) ?? Pe,
      ...
      resourceMention: kl,
      chatGptConversationMention: Al,
      sitesProjectMention: jl,
    },
    marks: {
      link: {
...
function Fl(
  ...
  let l = a ? ((typeof a == `boolean` ? {} : a).triggers ?? [`/`]) : [],
    u = {
      ...(n ? { "@": `at-mention` } : {}),
      ...(i ? { $: `skill-mention` } : {}),
      ...Object.fromEntries(l.map((e) => [e, `slash-command`])),
    },
    d = new EventTarget(),
    f = new Pl(),
    p = o,
    m = new Cc(null, {
      ...
      state: Be.create({
        ...
        plugins: [
          ...
          ...zt({
            triggers: u,
            onSubmit(e, t) {
              f.emit(`composer-suggestion-ui-event`, { action: t, kind: e, type: `submit` });
            },
            onClose(e) {
              f.emit(`composer-suggestion-ui-event`, { kind: e, type: `close` });
            },
          }),
          Mt({
            ...ai,
            ...
            "Shift-Enter": (e, t) => ml(e, t),
            "Alt-Enter": (e, t) => ml(e, t),
            Enter: (e, t) => {
              if (X.getState(e)?.active === !0) return !0;
              if (p === `newline`) return ml(e, t);
              let n = e.doc.childCount > 1;
              return p === `cmdIfMultiline` && n ? ml(e, t) : (f.emit(`submit`), !0);
            },
            "Mod-Enter": () => (f.emit(`submit`), !0),
            "Mod-a": Jr,
            "Mod-z": dl,
            "Mod-y": fl,
            "Mod-Shift-z": fl,
      ...
      dispatchTransaction(e) {
        ...
        (m.updateState(t), d.dispatchEvent(new Event(Re)));
      },
      handlePaste(e, t) {
        if (t.defaultPrevented) return !0;
        let n = t.clipboardData,
          { imageFiles: i, otherFiles: a } = ft(n);
        if (
          (i.length > 0 && f.emit(`pasted-images`, i),
          a.length > 0 && f.emit(`pasted-files`, a),
          i.length > 0 || a.length > 0)
        )
          return !0;
        let o = n?.getData(`text/plain`);
        if (o == null) return !1;
        if (o.length >= 5e3 && f.emit(`pasted-text`, o)) return !0;
        e.dispatch(ol(e.state.tr));
        let l = B(o);
        ...
        let d = n?.getData(`text/html`);
        if (d != null && d.length > 0) {
          let t = xl({ html: d, schema: e.state.schema, text: o });
          if (t != null)
            return (e.dispatch(e.state.tr.replaceSelection(new W(t.content, 1, 1))), !0);
        }
        return (hl(e, o), !0);
      ...
      clipboardTextSerializer(e) {
        return pl(e.content, { preferFileMentionFsPath: !0 }).content;
      },
    });
  return (
    e != null && m.dispatch(m.state.tr.setSelection(K.atEnd(m.state.doc))),
    {
      view: m,
      eventEmitter: f,
      setEnterBehavior: (e) => {
...
var Il = class {
  ...
  getText() {
    return pl(this.view.state.doc).content;
  }
  getPersistedText() {
    return pl(this.view.state.doc, { preserveTextLinkMarks: !0 }).content;
  }
  hasText() {
  ...
  getMentionedAgentConversationIds() {
    ...
    return (
      this.view.state.doc.descendants((t) => {
        ...
        return (typeof n == `string` && n.length > 0 && e.add(d(n)), !0);
      }),
      Array.from(e)
    );
  }
  ...
  getMentionedThreadIdsKey() {
    ...
    return (
      this.view.state.doc.descendants((t) => {
        if (t.type.name !== `agentMention`) return !0;
        let n = typeof t.attrs.path == `string` ? ne(t.attrs.path) : null;
  ...
  isCursorAtEnd() {
    ...
    return n == null || !e.contains(n)
      ? !1
      : this.view.posAtDOM(n, t.anchorOffset, -1) === K.atEnd(this.view.state.doc).from;
  }
  setText(e) {
    let t = N({ schema: this.view.state.schema, text: e }),
...
`)
      ...
      (hl(this.view, e), this.view.focus());
      return;
    }
  ...
  setPlaceholder(e) {
    this.view.dispatch(this.view.state.tr.setMeta(gl, { placeholder: e }));
  }
  syncMentionMetadata({
    skills: e,
    apps: t = [],
    ...
    let a = new Map(),
      ...
      u = new Map();
    (e.forEach((e) => {
      (a.set(w(e.path), e), o.set(e.name.toLowerCase(), e));
    }),
      t.forEach((e) => {
        let t = se(e.id);
    ...
    (f.doc.descendants((e, t) => {
      ...
      let n = typeof e.attrs.path == `string` ? e.attrs.path : ``,
        ...
        p = zl({ nodeTypeName: e.type.name, path: n }),
        g = null;
      if (p === `app`) {
        let e = s.get(n),
        ...
        let t = l.get(n),
          ...
          s =
            typeof e.attrs.displayName == `string` && e.attrs.displayName.length > 0
              ? e.attrs.displayName
              : f,
          c = ve({ mentionPath: n, mentionDisplayName: s, nativeApps: r, computerPlugin: d }),
          p = o == null ? null : ce(o, i),
          m = o?.displayName ?? o?.plugin.name ?? ``,
          h = o == null ? `` : ce(o).displayName,
          _ =
            c.isComputerUse &&
            s.length > 0 &&
            s !== m &&
        ...
        let t = n.length > 0 ? a.get(w(n)) : void 0;
  ...
  insertAtMention(e, t) {
    let n = e.matchType === `directory` && !/[\\/]$/.test(e.path) ? `${e.path}/` : e.path;
    this.insertMentionNodeFromAtMention(Nl.nodes.atMention, { ...e, path: n }, t);
  }
  insertAgentMention(e, t) {
    this.insertMentionNodeFromAtMention(
      Nl.nodes.agentMention,
      {
  ...
  insertConfiguredAgentMention(e, t) {
    this.insertAgentMention(I(e), t);
  }
  insertMention(e, t) {
    let n = t ?? X.getState(this.view.state);
    n?.range != null && this.insertMentionInRange(e, n.range.from, n.range.to, !0);
  }
  setAtMentionSource(e, t) {
    ...
    (r(n.tr.insertText(``, i, t.range.to)), Ut(this.view, e));
  }
  insertSkillMentionAtSelection(e) {
    this.insertMentionAtSelection(oe(e));
  }
  ...
  clearSuggestion(e) {
    let t = e ?? X.getState(this.view.state);
    if (t?.range == null) return;
    let { state: n, dispatch: r } = this.view,
      { from: i, to: a } = t.range,
      o = n.tr.insertText(``, i, a);
    ((o = o.setSelection(K.create(o.doc, i))), r(o), Vt(this.view));
  }
  completeSuggestionQuery(e, t) {
    ...
    ((o = o.setSelection(K.create(o.doc, a + e.length))), i(o), this.view.focus());
  }
  insertMentionInRange(e, t, n, r = !1) {
    ...
    ((s = s.setSelection(K.create(s.doc, l))),
      r && (s = s.setMeta(X, { type: `close` })),
      a(s),
      this.view.focus());
  }
  insertResourceMentionFromAtMention(e, t, n) {
    this.insertMentionNodeFromAtMention(
      Nl.nodes.resourceMention,
      {
        brandColor: e.brandColor ?? ``,
        iconSmall: e.iconSmall,
  ...
  insertChatGptConversationMention(e, t) {
    this.insertMentionNodeFromAtMention(Nl.nodes.chatGptConversationMention, e, t);
  }
  insertSitesProjectMention(e, t) {
    this.insertMentionNodeFromAtMention(Nl.nodes.sitesProjectMention, e, t);
  }
  insertMentionNodeFromAtMention(e, t, n) {
    let r = n ?? X.getState(this.view.state);
    ...
    let { state: i, dispatch: a } = this.view,
      ...
      d = Ll(l, u);
    ((l = l.setSelection(K.create(l.doc, d))),
      (l = l.setMeta(X, { type: `close` })),
      a(l),
      this.view.focus());
  }
  addSubmitHandler(e) {
...
function zl({ nodeTypeName: e, path: t }) {
...
function Bl(e, t) {
  let { view: n, eventEmitter: r, setEnterBehavior: i } = Fl(e ?? null, t);
  return new Il(
    n,
    r,
    i,
