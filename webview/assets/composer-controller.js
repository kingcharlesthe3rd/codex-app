...
import { Co as o } from "./app-server-manager-signals.js";
import { Ar as s, p as c } from "./src-1.js";
...
import { A as h, F as g, P as _ } from "./rpc-1.js";
import { c as v, i as y, l as b, o as x } from "./format-skill-title.js";
import { t as S } from "./send-open-file-request.js";
import { f as C } from "./chunk-109.js";
import { n as ee, t as w } from "./known-app-icon.js";
import { p as T } from "./codex-api.js";
import { c as E, x as D } from "./apps-queries.js";
import { t as O } from "./connector-logo.js";
import { a as k, i as A, n as j, o as M, t as N } from "./prompt-text.js";
import {
  a as P,
  b as F,
  c as te,
  ...
  r as R,
  u as z,
} from "./mention-item-B.js";
import { r as ae, t as oe } from "./rich-link.js";
import { t as se } from "./apps.js";
import { y as ce } from "./use-plugins.js";
import { c as le, o as B, u as ue } from "./use-native-apps.electron.js";
import { n as V, t as de } from "./mention-icons.js";
import { t as fe } from "./mcp.js";
import { t as pe } from "./get-skill-icon.js";
import { t as me } from "./openai-blossom.js";
import { n as he } from "./use-skills-J.js";
import {
  a as ge,
  i as _e,
  n as ve,
...
import { t as H } from "./globe.js";
import { t as Se } from "./sortBy.js";
import { r as Ce } from "./composer-top-menu-chrome.js";
import { t as we } from "./connected-apps.js";
import { a as Te, i as Ee, n as De } from "./use-composer-controller.js";
import {
  a as Oe,
  c as ke,
  d as Ae,
...
import { t as J } from "./score-query-match-CZO-nWKm.js";
import { r as Ke } from "./format-skill-scope.js";
import { t as qe } from "./list-navigation.js";
var Je = `above-composer-portal`,
  Ye = `above-composer-queue-portal`,
  Xe = `data-above-composer-portal`,
  Ze = `data-above-composer-queue-portal`;
function Qe(e) {
  return et({ attr: Xe, fallbackId: Je, conversationId: e });
}
function $e(e) {
  return et({ attr: Ze, fallbackId: Ye, conversationId: e });
}
function et({ attr: e, fallbackId: t, conversationId: n }) {
...
function tt(e) {
  ...
  let { types: t } = e;
  for (let e = 0; e < t.length; e += 1) if (t[e] === Y) return !0;
  return !1;
}
function nt(e) {
  return st(e)
...
function rt(e) {
  let t = [],
    n = [];
  for (let { file: r, isDirectory: i } of st(e)) {
    if (i) {
      n.push(r);
      continue;
    }
...
function ut() {
  let e = a(M);
  return dt(e.value.kind === `local` ? e.value.conversationId : null);
}
function dt(e) {
  return pt(e, Qe);
}
...
function pt(e, t) {
  let n = (0, ct.c)(6),
    r;
  n[0] !== e || n[1] !== t
    ? ((r = (n) => mt(e, t, n)), (n[0] = e), (n[1] = t), (n[2] = r))
    : (r = n[2]);
  let i = r,
    a;
  return (
    n[3] !== e || n[4] !== t ? ((a = () => t(e)), (n[3] = e), (n[4] = t), (n[5] = a)) : (a = n[5]),
    (0, lt.useSyncExternalStore)(i, a)
  );
}
function mt(e, t, n) {
...
function ht(e) {
  let t = (0, ct.c)(10),
    ...
    l = dt(null),
    u;
  t[0] === c.pathname ? (u = t[1]) : ((u = Ve(c.pathname)), (t[0] = c.pathname), (t[1] = u));
  let d = u,
...
for (
  var gt = {
    ...
    vt = typeof navigator < `u` && /Mac/.test(navigator.platform),
    yt =
      typeof navigator < `u` &&
  ...
  gt[48 + bt] = gt[96 + bt] = String(bt);
for (var bt = 1; bt <= 24; bt++) gt[bt + 111] = `F` + bt;
for (var bt = 65; bt <= 90; bt++)
  ((gt[bt] = String.fromCharCode(bt + 32)), (_t[bt] = String.fromCharCode(bt)));
for (var xt in gt) _t.hasOwnProperty(xt) || (_t[xt] = gt[xt]);
function St(e) {
  var t =
    (!(
      (vt && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey) ||
      (yt && e.shiftKey && e.key && e.key.length == 1) ||
      e.key == `Unidentified`
    ) &&
      e.key) ||
    (e.shiftKey ? _t : gt)[e.keyCode] ||
    e.key ||
    `Unidentified`;
  return (
    t == `Esc` && (t = `Escape`),
...
var Ct = typeof navigator < `u` && /Mac|iP(hone|[oa]d)/.test(navigator.platform),
  wt = typeof navigator < `u` && /Win/.test(navigator.platform);
function Tt(e) {
  let t = e.split(/-(?!$)/),
    n = t[t.length - 1];
  n == `Space` && (n = ` `);
  ...
  for (let e = 0; e < t.length - 1; e++) {
    ...
    else if (/^mod$/i.test(n)) Ct ? (o = !0) : (i = !0);
...
function Ot(e) {
  return new Me({ props: { handleKeyDown: kt(e) } });
}
function kt(e) {
  let t = Et(e);
  return function (e, n) {
...
function Nt(e, t, n) {
  let { state: r } = e,
    i = t.getState(r);
  return i?.active !== !0 || !Mt(i, n) ? !1 : (e.dispatch(r.tr.setMeta(t, jt(i))), !0);
}
var Pt = 50;
function Ft(e, t) {
...
function It(e) {
  ...
  return [
    ...
    Ot({
      Escape: (e, n) =>
        t.getState(e)?.active && n !== void 0 ? (n(e.tr.setMeta(t, At)), a(), !0) : !1,
    }),
    Ot({
      Tab: (e, n) =>
        t.getState(e)?.active && n !== void 0
          ? (n(e.tr.setMeta(t, At)), i(`complete-query`), !0)
          : !1,
      Enter: (e, n) =>
        t.getState(e)?.active && n !== void 0
          ? (n(e.tr.setMeta(t, At)), i(`insert-mention`), !0)
          : !1,
    }),
  ];
}
...
var Rt = new Oe(`mention-ui`);
function zt(e = {}) {
  return It({ key: Rt, trigger: `@`, wordPattern: /(^|\s)(@[^@]*)$/, ...e });
}
var Bt = t((e) => {
    var t = n(),
      r = l();
    ...
    var re = t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
      ...
      z = ie.d;
    ie.d = { f: z.f, r: z.r, D: nt, C: rt, L: it, m: at, X: st, S: ot, M: ct };
    var ae = [],
      oe = null,
      se = /(<\/|<)(s)(cript)/gi;
    function ce(e, t, n, r) {
...
`),
        ...
        case `button`:
          ...
          var Ie = xe(e, r, a, pe, ye, je, Me, fe);
          if ((e.push(`>`), Ie?.forEach(ve, e), Se(e, de, V), typeof V == `string`)) {
            e.push(F(V));
            var K = null;
          } else K = V;
          return K;
        case `form`:
          ...
          if (typeof Re == `function`) {
            var J = be(r, Re);
            J === null
              ? (e.push(` `, `action`, `="`, _e, `"`), (Ve = Be = ze = Re = null), we(r, a))
              : ((Re = J.action || ``),
                (ze = J.encType),
                (Be = J.method),
                (Ve = J.target),
        ...
        case `title`:
          var Y = c.tagScope & 1,
            tt = c.tagScope & 4;
          if (c.insertionMode === 4 || Y || n.itemProp != null) var nt = ke(e, n);
          else tt ? (nt = null) : (ke(a.hoistableChunks, n), (nt = void 0));
          return nt;
        case `link`:
          var rt = c.tagScope & 1,
            it = c.tagScope & 4,
          ...
          if (
            ...
            if (typeof st != `string` || n.disabled != null || n.onLoad || n.onError) ct = Te(e, n);
            else {
              var dt = a.styles.get(st),
                ft = r.styleResources.hasOwnProperty(ot) ? r.styleResources[ot] : void 0;
              if (ft !== null) {
                ((r.styleResources[ot] = null),
                  dt ||
                    ((dt = { precedence: F(st), rules: [], hrefs: [], sheets: new Map() }),
                    a.styles.set(st, dt)));
                var pt = {
                  state: 0,
            ...
            n.onLoad || n.onError
              ? (ct = Te(e, n))
              : (l && e.push(`<!-- -->`), (ct = it ? null : Te(a.hoistableChunks, n)));
          return ct;
        case `script`:
          var gt = c.tagScope & 1,
            _t = n.async;
          if (
            ...
            var yt = n.src;
            if (n.type === `module`)
              var bt = r.moduleScriptResources,
                xt = a.preloads.moduleScripts;
            else ((bt = r.scriptResources), (xt = a.preloads.scripts));
...
` +
            ...
            if (nn)
              ...
              var Q = n.crossOrigin,
                rn = typeof Q == `string` ? (Q === `use-credentials` ? Q : ``) : void 0,
                an = a.headers,
                on;
              an &&
        ...
        if (typeof e == `string` && e) {
          ...
          if (!r.connectResources[a].hasOwnProperty(e)) {
            ...
            if ((s = r && 0 < r.remainingCapacity)) {
              if (
                ((s = `<` + (`` + e).replace(dt, ft) + `>; rel=preconnect`), typeof t == `string`)
              ) {
            ...
            default:
              ...
              if (
                ...
                (i = a.headers) &&
                  0 < i.remainingCapacity &&
                  t === `font` &&
                  ((l = ut(e, t, n)), 0 <= (i.remainingCapacity -= l.length + 2)))
              )
                ((a.resets.font[e] = ae),
      ...
      if (n) {
        ...
        if (e) {
          ...
          a !== null &&
            ...
            (t = E({ src: e, async: !0 }, t)),
            a && (a.length === 2 && lt(t, a), (e = i.preloads.scripts.get(e))) && (e.length = 0),
            (e = []),
            i.scripts.add(e),
            Ae(e, t),
            Dr(n));
      ...
      if (n) {
        ...
        if (e) {
          ...
          a !== null &&
            ...
            a &&
              (a.length === 2 && lt(t, a), (e = i.preloads.moduleScripts.get(e))) &&
              (e.length = 0),
            (e = []),
            i.scripts.add(e),
            Ae(e, t),
    ...
    function ut(e, t, n) {
      ...
      n))
        D.call(n, r) &&
          ((e = n[r]),
          typeof e == `string` &&
            (t += `; ` + r.toLowerCase() + `="` + (`` + e).replace(pt, mt) + `"`));
      return t;
    }
    var dt = /[<>\r\n]/g;
    function ft(e) {
...
`:
    ...
    function vt(e, t) {
      ...
      (i !== void 0 &&
        (r.push(`<script`), $e(r, e), r.push(`>`, (`` + i).replace(se, ce), `<\/script>`)),
        (i = n + `P:`));
      var s = n + `S:`;
      n += `B:`;
      var c = new Set(),
    ...
    function Ct(e) {
      ...
      if (typeof e == `object`)
        switch (e.$$typeof) {
          ...
          case g:
            return ((t = e.displayName || null), t === null ? Ct(e.type) || `Memo` : t);
          case _:
    ...
    function ln() {
      ((Yt = Jt = qt = Kt = null), (Qt = !1), (Xt = null), (rn = 0), (X = Q = null));
    }
    function un(e, t) {
    ...
    function dn(e, t, n) {
      ...
      return (
        ...
        (e = e.dispatch = pn.bind(null, Kt, e)),
        [X.memoizedState, e]
      );
    }
    function fn(e, t) {
      if (((Kt = an()), (X = sn()), (t = t === void 0 ? null : t), X !== null)) {
...
` +
    ...
    function Jn(e, t, n, r, i, a) {
      ...
      for (
        ...
        ((Qt = !1), ($t = Z = 0), (en = -1), (tn = 0), (rn += 1), (X = null), (e = r(i, a)));
      return (ln(), e);
    }
      ...
      if (typeof r == `function`)
        if (r.prototype && r.prototype.isReactComponent) {
          ...
          if (
            ...
            (l._reactInternals = C),
            (o = r.contextType),
            (l.context = typeof o == `object` && o ? o._currentValue2 : wt),
            ...
            if (
              ...
              r !== l.state && Mt.enqueueReplaceState(l, l.state, null),
            ...
            a: if (t.replay !== null) {
              ...
              if (((F.parentFlushed = !0), e.trackedPostpones !== null)) {
                ...
                try {
                  if (
                    (or(e, t, a, -1),
                    bt(F.chunks, e.renderState, F.lastPushedText, F.textEmbedded),
                    (F.status = 1),
                    pr(N, F),
        ...
        if (typeof r == `object` && r)
          switch (r.$$typeof) {
            case p:
              ...
              ((r = Jn(e, t, n, r.render, l, o)), Yn(e, t, n, r, Z !== 0, $t, en));
              return;
            case g:
              Xn(e, t, n, r.type, a, o);
              return;
    ...
    function $n(e, t) {
      ...
      if (n !== null) {
        if (typeof n == `object`) {
                  ...
                  for (r = h.nodes, n = 0; n < r.length; n++) {
                    ...
                    if (p === g[1]) {
                      if (g.length === 4) {
                        ...
                        if (s !== m) throw Error(i(490, `Suspense`, Ct(s) || `Unknown`));
                        b: {
                          ((h = void 0),
                            (s = g[5]),
                            (u = g[2]),
          ...
          if (typeof n.then == `function`) return ((t.thenableState = null), Qn(e, t, vn(n), r));
          if (n.$$typeof === f) return Qn(e, t, n._currentValue2, r);
          throw (
        ...
        typeof n == `string`
          ? ((r = t.blockedSegment),
            r !== null && (r.lastPushedText = yt(r.chunks, n, e.renderState, r.lastPushedText)))
          : (typeof n == `number` || typeof n == `bigint`) &&
            ((r = t.blockedSegment),
            r !== null &&
              (r.lastPushedText = yt(r.chunks, `` + n, e.renderState, r.lastPushedText)));
      }
    }
    function er(e, t, n, r) {
      var a = t.keyPath;
    ...
    function or(e, t, n, r) {
      ...
      if (l === null) {
        ...
        try {
          ...
          if ((ln(), (n = u === Bt ? Ut() : u), e.status !== 12 && typeof n == `object` && n)) {
    ...
    function hr(e) {
      if (e.status !== 14 && e.status !== 13) {
        ...
        try {
            ...
            if (d === null) {
              ...
              if (l.replay.pendingTasks !== 0) {
                ...
                try {
                  ...
                  if (typeof p == `object` && p && typeof p.then == `function`) {
                    var m = l.ping;
                    (p.then(m, m), (l.thenableState = e === Bt ? cn() : null));
                  } else {
              ...
              try {
                ...
                if (u.status === 12 && u.trackedPostpones !== null) {
                  ...
                  ((g.status = 0), (l.thenableState = e === Bt ? cn() : null));
                  var T = l.ping;
                  C.then(T, T);
                } else {
          ...
          ((xn = o), (re.H = n), (re.A = r), n === bn && jt(t), (Nn = a));
        }
      }
    }
    function gr(e, t, n) {
    ...
    function _r(e, t, n) {
      ...
      switch (r.status) {
        case 1:
          if ((Ie(e.renderState, a), (e.byteSize += r.byteSize), (t = r.completedSegments[0]), !t))
            throw Error(i(391));
          return gr(e, t, n);
        case 5:
          if (e.trackedPostpones !== null) return !0;
        case 4:
          if (t.status === 1) return (Ie(e.renderState, o), gr(e, t, n));
        default:
          return !0;
      }
    }
    ...
    function xr(e, t, n, r) {
      ...
      if (a.status !== 1)
        return (
          ...
          q(t, e.renderState, a.rootSegmentID),
          r && _t(r, a.fallbackState),
          yr(e, t, n, r),
          t.push(`<!--/$-->`)
        );
...
$RC=function(a,b){if(b=document.getElementById(b))(a=document.getElementById(a))?(a.previousSibling.data="$~",$RB.push(a,b),2===$RB.length&&("number"!==typeof $RT?requestAnimationFrame($RV.bind(null,$RB)):(a=performance.now(),setTimeout($RV.bind(null,$RB),2300>a&&2E3<a?2300-a:$RT+300-a)))):b.parentNode.removeChild(b)};`)),
  ...
  Vt = t((e) => {
    ...
    function je(e, t, n, r, i, a) {
      ...
      if (
        (d !== void 0 && (u.push(o), tr(u, e), u.push(tt, I((`` + d).replace(ke, Ae)), H)),
        (d = []),
        r !== void 0 && (d.push(U), d.push(I((`` + JSON.stringify(r)).replace(ke, Ae))), d.push(W)),
        (r = i
          ? {
              preconnects: ``,
              fontPreloads: ``,
    ...
    function K(e, t) {
      return (
        t.tagScope & 32 && (e.instructions |= 128),
        Ne(t.insertionMode, t.selectedValue, t.tagScope | 12, Ie(t.viewTransition))
      );
    }
    function q(e, t) {
      ...
      var n = t.tagScope | 16;
      return (
        e !== null && e.share !== `none` && (n |= 64), Ne(t.insertionMode, t.selectedValue, n, e)
      );
    }
    var Le = L(`<!-- -->`);
    function Re(e, t, n, r) {
    ...
    function Ze(e, t) {
      (this.push(Xe), Qe(e), Je(this, `name`, t), Je(this, `value`, e), this.push(nt));
    }
    function Qe(e) {
      if (typeof e != `string`) throw Error(i(480));
    }
    ...
    function et(e, t, n, r, i, a, o, s) {
      ...
      if (typeof r == `function`) {
        var l = $e(t, r);
        l === null
          ? (e.push(We, I(`formAction`), Ge, Ye, J), (o = a = i = r = s = null), st(t, n))
          : ((s = l.name),
            (r = l.action || ``),
            (i = l.encType),
            (a = l.method),
    ...
    function st(e, t) {
      if (!(e.instructions & 16)) {
        ...
        var n = t.preamble,
          r = t.bootstrapChunks;
        (n.htmlChunks || n.headChunks) && r.length === 0
          ? (r.push(t.startInlineScript), tr(r, e), r.push(tt, ot, H))
          : r.unshift(t.startInlineScript, tt, ot, H);
      }
    }
    var ct = L(`<!--F!-->`),
      lt = L(`<!--F-->`);
    ...
    function bt(e, t, n) {
      ...
      return (e.push(tt), rt(e, r, n), typeof n == `string` ? (e.push(I(V(n))), null) : n);
    }
    var xt = L(`
`),
    ...
    function Et(e, t, n, r, a, o, s, c, l) {
      switch (t) {
        ...
        case `a`:
          ...
          if ((e.push(tt), rt(e, d, u), typeof u == `string`)) {
            e.push(I(V(u)));
            var m = null;
          } else m = u;
          return m;
        ...
        case `textarea`:
          ...
          if ((O === null && k !== null && (O = k), e.push(tt), A != null)) {
...
` &&
        ...
        case `input`:
          ...
          var le = et(e, r, a, P, F, te, ne, N);
          return (
            ie === null ? ae !== null && qe(e, `checked`, ae) : qe(e, `checked`, ie),
            L === null ? re !== null && Y(e, `value`, re) : Y(e, `value`, L),
            e.push(nt),
            le?.forEach(Ze, e),
            null
          );
        case `button`:
          ...
          var be = et(e, r, a, fe, pe, he, ge, de);
          if ((e.push(tt), be?.forEach(Ze, e), rt(e, ue, B), typeof B == `string`)) {
            e.push(I(V(B)));
            var xe = null;
          } else xe = B;
          return xe;
        case `form`:
          ...
          if (typeof Ce == `function`) {
            var U = $e(r, Ce);
            U === null
              ? (e.push(We, I(`action`), Ge, Ye, J), (Ee = Te = we = Ce = null), st(r, a))
              : ((Ce = U.action || ``),
                (we = U.encType),
                (Te = U.method),
                (Ee = U.target),
          ...
          if (
            (Ce != null && Y(e, `action`, Ce),
            we != null && Y(e, `encType`, we),
            Te != null && Y(e, `method`, Te),
            Ee != null && Y(e, `target`, Ee),
            e.push(tt),
            Ae !== null && (e.push(Xe), Je(e, `name`, Ae), e.push(nt), ke?.forEach(Ze, e)),
            rt(e, Se, H),
            typeof H == `string`)
          ) {
            e.push(I(V(H)));
              ...
              if (Fe != null)
                switch (Pe) {
                  ...
                  case `data`:
                    var Ie = me(`` + Fe);
                    if (Ie === ``) break;
                    e.push(We, I(`data`), Ge, I(V(Ie)), J);
                    break;
                  default:
                    Y(e, Pe, Fe);
                }
            }
          if ((e.push(tt), rt(e, Ne, G), typeof G == `string`)) {
            e.push(I(V(G)));
            var K = null;
          } else K = G;
          return K;
        case `title`:
          var q = c.tagScope & 1,
            Re = c.tagScope & 4;
          if (c.insertionMode === 4 || q || n.itemProp != null) var ze = mt(e, n);
          else Re ? (ze = null) : (mt(a.hoistableChunks, n), (ze = void 0));
          return ze;
        case `link`:
          var Be = c.tagScope & 1,
            Ve = c.tagScope & 4,
          ...
          if (
            ...
            if (typeof Qe != `string` || n.disabled != null || n.onLoad || n.onError) ot = ut(e, n);
            else {
              var ct = a.styles.get(Qe),
                lt = r.styleResources.hasOwnProperty(Ke) ? r.styleResources[Ke] : void 0;
              if (lt !== null) {
                ((r.styleResources[Ke] = null),
                  ct ||
                    ((ct = { precedence: I(V(Qe)), rules: [], hrefs: [], sheets: new Map() }),
                    a.styles.set(Qe, ct)));
                var St = {
                  state: 0,
                ...
                if (lt) {
                  lt.length === 2 && gr(St.props, lt);
                  var Ct = a.preloads.stylesheets.get(Ke);
                  Ct && 0 < Ct.length ? (Ct.length = 0) : (St.state = 1);
                }
                (ct.sheets.set(Ke, St), s && s.stylesheets.add(St));
              } else if (ct) {
                var Et = ct.sheets.get(Ke);
            ...
            n.onLoad || n.onError
              ? (ot = ut(e, n))
              : (l && e.push(Le), (ot = Ve ? null : ut(a.hoistableChunks, n)));
          return ot;
        case `script`:
          var Dt = c.tagScope & 1,
            kt = n.async;
        ...
        case `style`:
          ...
          if (
            ...
            if ((r.styleResources.hasOwnProperty(Bt) ? r.styleResources[Bt] : void 0) !== null) {
              ((r.styleResources[Bt] = null),
                Jt ||
                  ((Jt = { precedence: I(V(zt)), rules: [], hrefs: [], sheets: new Map() }),
                  a.styles.set(zt, Jt)));
              var Yt = a.nonce.style;
              if (!Yt || Yt === Vt) {
                Jt.hrefs.push(I(V(Bt)));
                var Xt = Jt.rules,
                  X = null,
                  Zt = null,
                  Qt;
                ...
                (typeof $t != `function` &&
                  typeof $t != `symbol` &&
                  $t != null &&
                  Xt.push(I((`` + $t).replace(dt, ft))),
                  rt(Xt, Zt, X));
              }
            }
            (Jt && s && s.styles.add(Jt), l && e.push(Le), (qt = void 0));
          }
          return qt;
        case `meta`:
          var en = c.tagScope & 1,
...
` +
        ...
        case `head`:
          if (2 > c.insertionMode) {
            ...
            (o !== null && e.push(ht), (yn.headChunks = []));
            var bn = yt(yn.headChunks, n, `head`);
          } else bn = bt(e, n, `head`);
          return bn;
        case `body`:
          if (2 > c.insertionMode) {
            ...
            (o !== null && e.push(gt), (xn.bodyChunks = []));
            var Sn = yt(xn.bodyChunks, n, `body`);
          } else Sn = bt(e, n, `body`);
          return Sn;
        case `html`:
          if (c.insertionMode === 0) {
            ...
            (o !== null && e.push(_t), (Cn.htmlChunks = [Tt]));
            var wn = yt(Cn.htmlChunks, n, `html`);
          } else wn = bt(e, n, `html`);
          return wn;
        default:
          if (t.indexOf(`-`) !== -1) {
            ...
            return (e.push(tt), rt(e, En, Tn), Tn);
          }
      }
      return bt(e, n, t);
    }
    ...
    function dn(e, t, n, r) {
      switch (n.insertionMode) {
        ...
        case 7:
          return (P(e, nn), P(e, t.segmentPrefix), P(e, I(r.toString(16))), F(e, Q));
        case 8:
            ...
            ((a = n && 0 < n.remainingCapacity) &&
              ...
              a
                ? ((r.resets.dns[e] = null),
                  n.preconnects && (n.preconnects += `, `),
                  (n.preconnects += i))
                : ((i = []), ut(i, { href: e, rel: `dns-prefetch` }), r.preconnects.add(i)));
          }
          Ba(t);
        }
      } else ve.D(e);
...
` +
              ...
              ((u = _r(e, t, n)), 0 <= (i.remainingCapacity -= u.length + 2))
                ? ((a.resets.image[l] = ye),
                  ...
                  (i.highImagePreloads += u))
                : ((i = []),
                  ut(i, R({ rel: `preload`, href: o ? void 0 : e, as: t }, n)),
                  c === `high`
                    ? a.highImagePreloads.add(i)
                    : (a.bulkPreloads.add(i), a.preloads.images.set(l, i)));
              break;
            case `style`:
              if (i.styleResources.hasOwnProperty(e)) return;
              ((o = []),
                ut(o, R({ rel: `preload`, href: e, as: t }, n)),
                (i.styleResources[e] =
                  !n || (typeof n.crossOrigin != `string` && typeof n.integrity != `string`)
                    ? ye
                    : [n.crossOrigin, n.integrity]),
            ...
            default:
              ...
              if (
                ...
                switch (((i = []), (e = R({ rel: `preload`, href: e, as: t }, n)), ut(i, e), t)) {
                  case `font`:
                    a.fontPreloads.add(i);
                    break;
                  default:
    ...
    function fr(e, t) {
      ...
      if (n) {
        ...
        if (e) {
          ...
          (ut(a, R({ rel: `modulepreload`, href: e }, t)), i.bulkPreloads.add(a), Ba(n));
        }
      } else ve.m(e, t);
    }
    function pr(e, t, n) {
...
` +
      ...
      if (typeof r == `function`)
        if (r.prototype && r.prototype.isReactComponent) {
          ...
          if (
            ...
            (l._reactInternals = C),
            (o = r.contextType),
            (l.context = typeof o == `object` && o ? o._currentValue : kr),
            (o = r.getDerivedStateFromProps),
            typeof o == `function` &&
            ...
            if (
              ...
              typeof l.componentWillMount == `function` && l.componentWillMount(),
              typeof l.UNSAFE_componentWillMount == `function` && l.UNSAFE_componentWillMount(),
              r !== l.state && Lr.enqueueReplaceState(l, l.state, null),
              C.queue !== null && 0 < C.queue.length)
            )
              if (
                ((r = C.queue),
        ...
        if (((l = t.blockedSegment), l === null))
          ...
          if (
            ...
            (o = t.keyPath),
            (t.keyPath = n),
            (t.formatContext = Fe(C, r, a)).insertionMode === 3)
          ) {
          ...
          case m:
            a: if (t.replay !== null) {
              ((r = t.keyPath),
                ...
                (C = t.row),
                (t.keyPath = n),
                (t.formatContext = q(e.resumableState, l)),
                (t.row = null),
                (n = a.children));
              try {
                _a(e, t, n, -1);
              ...
              if (((P.parentFlushed = !0), e.trackedPostpones !== null)) {
                ((l = t.componentStack),
                  ...
                  (t.keyPath = C),
                  (t.formatContext = K(e.resumableState, o)),
                ...
                ((t = Ki(
                  ...
                  t.abortSet,
                  n,
                  q(e.resumableState, t.formatContext),
                  t.context,
                  t.treeContext,
                  null,
                  l,
                ...
                ((t.blockedBoundary = M),
                  ...
                  (t.blockedSegment = P),
                  (t.keyPath = n),
                  (t.formatContext = q(e.resumableState, o)),
                  (t.row = null),
                  (P.status = 6));
                try {
                  if (
                ...
                ((t = Ki(
                  ...
                  j,
                  [n[0], `Suspense Fallback`, n[2]],
                  K(e.resumableState, t.formatContext),
                  t.context,
                  t.treeContext,
                  t.row,
                  Xi(t.componentStack),
    ...
    function ua(e, t) {
      ...
      if (n !== null) {
                  ...
                  for (r = h.nodes, n = 0; n < r.length; n++) {
                    ...
                    if (p === g[1]) {
                      if (g.length === 4) {
                        ...
                        if (s !== m) throw Error(i(490, `Suspense`, Or(s) || `Unknown`));
                        b: {
                          ((h = void 0),
                            (s = g[5]),
                            (u = g[2]),
                          ...
                          ((l =
                            ...
                            (t.hoistableState = l.contentState),
                            (t.keyPath = c),
                            (t.formatContext = q(e.resumableState, b)),
                            (t.row = null),
                            (t.replay = { nodes: u, slots: d, pendingTasks: 1 }));
                          try {
                            if (
        ...
        typeof n == `string`
          ? ((r = t.blockedSegment),
            r !== null && (r.lastPushedText = Re(r.chunks, n, e.renderState, r.lastPushedText)))
          : (typeof n == `number` || typeof n == `bigint`) &&
            ((r = t.blockedSegment),
            r !== null &&
              (r.lastPushedText = Re(r.chunks, `` + n, e.renderState, r.lastPushedText)));
      }
    }
    function da(e, t, n, r) {
      var a = t.keyPath;
...
function Ut({
  ...
  let l =
      r == null
        ? null
        : (0, lt.isValidElement)(r)
          ? (0, lt.cloneElement)(r, { className: f(_e, r.props.className) })
          : (0, lt.createElement)(r, { className: _e }),
    u = (0, Ht.renderToStaticMarkup)(
      (0, lt.createElement)(
        `span`,
        {
          className: f(ve, be, ye, i ? `cursor-interaction` : void 0, t),
          style: xe({ brandColor: e, style: a }),
          title: typeof c == `string` && c.length > 0 ? c : void 0,
          ...n,
        },
        l == null ? null : (0, lt.createElement)(`span`, { className: ge }, l),
        (0, lt.createElement)(`span`, { className: f(`min-w-0 break-words`, s) }, o),
      ),
    ),
...
var Wt = new Oe(`skill-mention-ui`);
function Gt(e) {
  let t = `${e}-name`,
    n = `${e}-display-name`,
    r = `${e}-path`,
  ...
  return {
    ...
    toDOM: (s) => {
      let c = s.attrs.displayName || s.attrs.name,
        ...
        u = e === `app-mention` && D(s.attrs.iconSmall) != null ? `` : s.attrs.iconSmall;
      return Ut({
        text: c,
        icon:
          e === `skill-mention`
...
var Kt = Gt(`skill-mention`),
  qt = Gt(`app-mention`),
  Jt = Gt(`plugin-mention`);
function Yt(e = {}) {
  return It({ key: Wt, trigger: `$`, wordPattern: /(^|\s)(\$[^$]*)$/, ...e });
}
var Xt = new Oe(`slash-command-ui`),
  X = /(^|\s)(\/(?:(?<=^\/)[^/]*|[^\s/]*))$/,
  Zt = /(^|\s)([/@][^\s/@]*)$/;
function Qt({ triggers: e = [`/`], ...t } = {}) {
  return It({ key: Xt, trigger: e, wordPattern: e.length === 1 && e[0] === `/` ? X : Zt, ...t });
}
var Z = new Oe(`customKeymapPlugin`),
  $t = 0;
function en(e) {
  let t = {};
...
function tn(e, t) {
  let n = `custom-keymap-subscription-${$t}`;
  (($t += 1),
    e.dispatch(e.state.tr.setMeta(Z, { handlers: t, subscriptionId: n, type: `addHandlers` })));
  let r = !0;
  return () => {
    r &&
      ((r = !1),
      Z.getState(e.state)?.handlerSubscriptions[n] &&
        e.dispatch(e.state.tr.setMeta(Z, { subscriptionId: n, type: `removeHandlers` })));
  };
}
function nn(e = {}) {
  return new Me({
    ...
    state: {
      ...
      apply(e, t) {
        ...
        if (n?.type === `addHandlers`) {
          ...
          return { handlerSubscriptions: e, handlers: en(e) };
        }
        if (n?.type === `removeHandlers`) {
          ...
          return { handlerSubscriptions: r, handlers: en(r) };
        }
        return t;
      },
    },
    props: {
      handleKeyDown(e, t) {
        let n = Z.getState(e.state).handlers[t.key];
        return n ? n(t) : !1;
      },
    },
  });
    ...
    (0, Q.jsx)(`div`, {
      ...
      onClick: (e) => {
        ...
        if (t != null) {
          ...
          t.kind === `file` &&
            (e.preventDefault(), e.stopPropagation(), S({ path: t.fsPath || t.path, cwd: null }));
        }
      },
...
function cn(e) {
  ...
  return t == null || n == null
    ? null
    : { kind: `mcp-resource`, path: te({ resourceUri: t, server: n }) };
}
var ln = 360,
  un = 12,
  dn = 8;
function fn({
  ...
  if (typeof document > `u`) return null;
  if (n != null && t != null)
    return pn({ anchorPos: t, composerController: n, placement: r, portalRoot: i, windowZoom: a });
  let o = e?.current;
  if (o == null) return null;
  let s = mn({ anchorElement: o, portalRoot: i }),
    c = hn(s, a),
  ...
  return {
    ...
    top: (d - u.top) / c + (r === `top` ? -dn : dn),
    width: l.width / c,
    fixedPosition: s === document.body,
    renderAbove: r === `top`,
  };
}
function pn({ anchorPos: e, composerController: t, placement: n, portalRoot: r, windowZoom: i }) {
  let a = t.view.dom,
    o = mn({ anchorElement: a, portalRoot: r }),
    s = hn(o, i),
    c =
      o === document.body
  ...
  return {
    portalContainer: o,
    left: gn((l.left - c.left) / s, un, u - f - un),
    top: ((n === `top` ? l.top : l.bottom) - c.top) / s + (n === `top` ? -dn : dn),
    width: f,
    fixedPosition: o === document.body,
    renderAbove: n === `top`,
  };
}
function mn({ anchorElement: e, portalRoot: t }) {
...
function yn(e) {
  ...
  let y = E(v),
    b = y.data == null ? null : y.data.filter(Sn),
    { skills: x, isLoading: S } = he(c ?? s, l),
    C = ce(),
    w;
  t[2] !== s || t[3] !== c
    ? ((w = c ?? (s ? [s] : [])), (t[2] = s), (t[3] = c), (t[4] = w))
    : (w = t[4]);
  let D = w,
    k = g.formatMessage({
    ...
    A;
  t[5] !== _?.name || t[6] !== g || t[7] !== D
    ? ((A = (e) => {
        let t = ie(e);
        return {
          ...t,
          key: t.path,
          scopeLabel: Ke({ skill: e, intl: g, roots: D, adminLabel: _?.name ?? void 0 }),
          Icon: V(),
        };
      }),
      (t[5] = _?.name),
  ...
  let j = Cn(
      [
        ...(0, vn.default)(x.filter((e) => e.enabled && Ue(e, C)).map(A), xn),
        ...(b == null
          ? []
          : b.map((e) => {
              let t = I(e);
    ...
    M = j.map(bn),
    N = j.length === 0 && (S || (b == null && y.isLoading)),
    P = h === `default` ? `both` : `bottom`;
  Be({ isLoading: N, onRequestClose: o, query: r, resultCount: j.length });
  let {
      highlightedIndex: F,
      listRef: te,
      getItemProps: ne,
  ...
  t[9] === n
    ? (re = t[10])
    : ((re = f(`max-h-[240px] electron:text-base`, n)), (t[9] = n), (t[10] = re));
  let R = We,
    z = N
      ? (0, Q.jsx)(He, {
          children: (0, Q.jsx)(d, {
    ...
    ae;
  t[11] !== R || t[12] !== P || t[13] !== te || t[14] !== z
    ? ((ae = (0, Q.jsx)(R, { fadeMaskVariant: P, listRef: te, children: z })),
      (t[11] = R),
      (t[12] = P),
      (t[13] = te),
      (t[14] = z),
  ...
  let oe;
  return (
    t[16] !== L || t[17] !== h || t[18] !== re || t[19] !== ae
      ? ((oe = (0, Q.jsx)(L, { chromeVariant: h, className: re, children: ae })),
        (t[16] = L),
        (t[17] = h),
        (t[18] = re),
        (t[19] = ae),
...
function Cn(e, t) {
  ...
  return n.length === 0
    ? e
    : (0, _n.default)(
        e.map((e, t) => ({ item: e, score: wn(e, n), index: t })),
...
function wn(e, t) {
  return Math.max(J(e.name, t), J(e.displayName, t), J(e.path, t));
}
var Tn = e(l(), 1);
function En(e) {
  let t = (0, ct.c)(59),
  ...
  t[0] !== v || t[1] !== h || t[2] !== _
    ? ((x = { placement: h, zIndexClassName: _, variant: v }),
      ...
      (t[3] = x))
    : (x = t[3]);
  let { overlayPortalContainer: S, shellClassName: C, usesExpandedTopTray: ee } = ht(x),
    w;
  ...
  t[14] !== y
    ? ((E = () => {
      ...
      (t[15] = E))
    : (E = t[15]);
  let D = (0, lt.useSyncExternalStore)(T, E),
    O;
  bb0: {
    if (D == null) {
      O = null;
  ...
  if (S != null) {
    ...
    return (
      t[37] !== S || t[38] !== e
        ? ((n = (0, Tn.createPortal)(e, S)), (t[37] = S), (t[38] = e), (t[39] = n))
        : (n = t[39]),
      n
    );
  }
  if (k != null) {
    ...
    return (
      t[52] !== k.portalContainer || t[53] !== a
        ? ((o = (0, Tn.createPortal)(a, k.portalContainer)),
...
function kn(e) {
  return Rt.getState(e.view.state);
}
function An(e) {
  let t = (0, ct.c)(14),
    n = De(e, jn),
...
function jn(e) {
  return Wt.getState(e.view.state);
}
var Mn = 65535,
  Nn = 2 ** 16;
function Pn(e, t) {
...
var Ln = 1,
  ...
  Vn = class {
    ...
    get deletedBefore() {
      return (this.delInfo & (Ln | zn)) > 0;
    }
    get deletedAfter() {
      return (this.delInfo & (Rn | zn)) > 0;
    }
    get deletedAcross() {
      ...
      for (let o = 0; o < this.ranges.length; o += 3) {
        ...
        if (e <= u) {
          let i = c ? (e == s ? -1 : e == u ? 1 : t) : t,
            a = s + r + (i < 0 ? 0 : l);
          if (n) return a;
          let d = e == (t < 0 ? s : u) ? null : Pn(o / 3, e - s),
            f = e == s ? Rn : e == u ? Ln : zn;
          return ((t < 0 ? e != s : e != u) && (f |= Bn), new Vn(a, f, d));
        }
        r += l - c;
      }
      return n ? e + r : new Vn(e + r, 0, null);
    }
    touches(e, t) {
      let n = 0,
        r = Fn(t),
...
var Un = Object.create(null),
  $ = class {
    ...
    static jsonID(e, t) {
      if (e in Un) throw RangeError(`Duplicate use of step JSON ID ` + e);
  ...
  Wn = class e {
    ...
    static fromReplace(t, n, r, i) {
      try {
        ...
        if (t instanceof Ne) return e.fail(t.message);
        throw t;
      }
    }
  };
function Gn(e, t, n) {
  ...
  for (let i = 0; i < e.childCount; i++) {
    let a = e.child(i);
    (a.content.size && (a = a.copy(Gn(a.content, t, a))),
      a.isInline && (a = t(a, n, i)),
      r.push(a));
  }
  return U.fromArray(r);
}
var Kn = class e extends $ {
  constructor(e, t, n) {
  ...
  apply(e) {
    ...
    return Wn.fromReplace(e, this.from, this.to, i);
  }
  invert() {
...
var qn = class e extends $ {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      n = new W(
        Gn(t.content, (e) => e.mark(this.mark.removeFromSet(e.marks)), e),
        t.openStart,
        t.openEnd,
      );
    return Wn.fromReplace(e, this.from, this.to, n);
  }
  invert() {
...
$.jsonID(`removeMark`, qn);
var Jn = class e extends $ {
  constructor(e, t) {
    (super(), (this.pos = e), (this.mark = t));
  }
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return Wn.fail(`No node at mark step's position`);
    let n = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
    return Wn.fromReplace(e, this.pos, this.pos + 1, new W(U.from(n), 0, t.isLeaf ? 0 : 1));
  }
  invert(t) {
...
var Yn = class e extends $ {
  ...
  invert(e) {
    let t = e.nodeAt(this.pos);
    return !t || !this.mark.isInSet(t.marks) ? this : new Jn(this.pos, this.mark);
  }
  map(t) {
    let n = t.mapResult(this.pos, 1);
    return n.deletedAfter ? null : new e(n.pos, this.mark);
...
$.jsonID(`removeNodeMark`, Yn);
var Xn = class e extends $ {
  constructor(e, t, n, r = !1) {
    (super(), (this.from = e), (this.to = t), (this.slice = n), (this.structure = r));
  }
  apply(e) {
    return this.structure && Qn(e, this.from, this.to)
      ? Wn.fail(`Structure replace would overwrite content`)
      : Wn.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
...
var Zn = class e extends $ {
  ...
  apply(e) {
    ...
    if (t.openStart || t.openEnd) return Wn.fail(`Gap is not a flat range`);
    let n = this.slice.insertAt(this.insert, t.content);
    return n ? Wn.fromReplace(e, this.from, this.to, n) : Wn.fail(`Content does not fit in gap`);
  }
  getMap() {
    return new Hn([
      this.from,
...
function er(e) {
  ...
  for (let n = e.depth; ; --n) {
    ...
    if (n == 0 || r.type.spec.isolating || !$n(r, i, a)) break;
  }
  return null;
}
...
function nr(e, t) {
  let n = e.resolve(t),
    r = n.index();
  return ir(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1);
}
function rr(e, t) {
...
function ir(e, t) {
  return !!(e && t && !e.isLeaf && rr(e, t));
}
function ar(e, t, n = t, r = W.empty) {
  if (t == n && !r.size) return null;
  let i = e.resolve(t),
    a = e.resolve(n);
  return or(i, a, r) ? new Xn(t, n, r) : new sr(i, a, r).fit();
}
function or(e, t, n) {
  return (
    !n.openStart &&
...
var sr = class {
  ...
  fit() {
    ...
    let s = new W(i, a, o);
    return e > -1
      ? new Zn(n.pos, e, this.$to.pos, this.$to.end(), s, t)
      : s.size || n.pos != this.$to.pos
        ? new Xn(n.pos, r.pos, s)
        : null;
  }
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        let e,
          r = null;
        n
          ? ((r = ur(this.unplaced.content, n - 1).firstChild), (e = r.content))
  ...
  dropNode() {
    ...
    if (r.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new W(cr(e, t - 1, 1), t - 1, i ? t - 1 : n);
    } else this.unplaced = new W(cr(e, t, 1), t, n);
  }
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: n, inject: r, wrap: i }) {
    ...
    for (; c < o.childCount; ) {
      ...
      (c++,
        (c > 1 || s == 0 || e.content.size) &&
          ((u = t),
          l.push(dr(e.mark(d.allowedMarks(e.marks)), c == 1 ? s : 0, c == o.childCount ? f : -1))));
    }
    let p = c == o.childCount;
    (p || (f = -1),
      (this.placed = lr(this.placed, t, U.from(l))),
    ...
    this.unplaced = p
      ? e == 0
        ? W.empty
        : new W(cr(a.content, e - 1, 1), e - 1, f < 0 ? a.openEnd : e - 1)
      : new W(cr(a.content, e, c), a.openStart, a.openEnd);
  }
  mustMoveInline() {
  ...
  openFrontierNode(e, t = null, n) {
    ...
    ((r.match = r.match.matchType(e)),
      (this.placed = lr(this.placed, this.depth, U.from(e.create(t, n)))),
      this.frontier.push({ type: e, match: e.contentMatch }));
  }
  closeFrontierNode() {
    let e = this.frontier.pop().match.fillBefore(U.empty, !0);
    e.childCount && (this.placed = lr(this.placed, this.frontier.length, e));
  }
};
function cr(e, t, n) {
  return t == 0
    ? e.cutByIndex(n, e.childCount)
    : e.replaceChild(0, e.firstChild.copy(cr(e.firstChild.content, t - 1, n)));
}
function lr(e, t, n) {
  return t == 0
    ? e.append(n)
    : e.replaceChild(e.childCount - 1, e.lastChild.copy(lr(e.lastChild.content, t - 1, n)));
}
function ur(e, t) {
...
function dr(e, t, n) {
  ...
  let r = e.content;
  return (
    t > 1 && (r = r.replaceChild(0, dr(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0))),
    t > 0 &&
...
function fr(e, t, n, r, i) {
  ...
  return s && !pr(n, a.content, o) ? s : null;
}
function pr(e, t, n) {
...
var mr = class e extends $ {
  ...
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return Wn.fail(`No node at attribute step's position`);
    let n = Object.create(null);
    for (let e in t.attrs) n[e] = t.attrs[e];
    n[this.attr] = this.value;
    let r = t.type.create(n, null, t.marks);
    return Wn.fromReplace(e, this.pos, this.pos + 1, new W(U.from(r), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return Hn.empty;
  }
...
var _r = (e, t) => (e.selection.empty ? !1 : (t && t(e.tr.deleteSelection().scrollIntoView()), !0));
function vr(e, t) {
...
var yr = (e, t, n) => {
  ...
  if (r.parent.content.size == 0 && (br(a, `end`) || K.isSelectable(a)))
    for (let n = r.depth; ; n--) {
      let o = ar(e.doc, r.before(n), r.after(n), W.empty);
      if (o && o.slice.size < o.to - o.from) {
        if (t) {
          let n = e.tr.step(o);
          (n.setSelection(
            br(a, `end`)
              ? Fe.findFrom(n.doc.resolve(n.mapping.map(i.pos, -1)), -1)
...
var wr = (e, t, n) => {
    ...
    let a = i.nodeAfter;
    if (Ir(e, i, t, 1)) return !0;
    if (r.parent.content.size == 0 && (br(a, `start`) || K.isSelectable(a))) {
      let n = ar(e.doc, r.before(), r.after(), W.empty);
      if (n && n.slice.size < n.to - n.from) {
        if (t) {
          let r = e.tr.step(n);
          (r.setSelection(
            br(a, `start`)
              ? Fe.findFrom(r.doc.resolve(r.mapping.map(i.pos)), 1)
...
var kr = (e, t) => {
    ...
    let i = n.node(-1),
      a = n.indexAfter(-1),
      o = Or(i.contentMatchAt(a));
    if (!o || !i.canReplaceWith(a, a, o)) return !1;
    if (t) {
      let r = n.after(),
        i = e.tr.replaceWith(r, r, o.createAndFill());
      (i.setSelection(Fe.near(i.doc.resolve(r), 1)), t(i.scrollIntoView()));
    }
    return !0;
  },
  Ar = (e, t) => {
    let n = e.selection,
      { $from: r, $to: i } = n;
    if (n instanceof Le || r.parent.inlineContent || i.parent.inlineContent) return !1;
  ...
  jr = (e, t) => {
    ...
    if (n.depth > 1 && n.after() != n.end(-1)) {
      let r = n.before();
      if (tr(e.doc, r)) return (t && t(e.tr.split(r).scrollIntoView()), !0);
    }
    let r = n.blockRange(),
      i = r && er(r);
...
function Mr(e) {
  return (t, n) => {
    ...
    for (let t = r.depth; ; t--)
      if (r.node(t).isBlock) {
        ((c = r.end(t) == r.pos + (r.depth - t)),
          ...
          (s = Or(r.node(t - 1).contentMatchAt(r.indexAfter(t - 1)))));
    ...
    let u = t.tr;
    (t.selection instanceof q || t.selection instanceof Le) && u.deleteSelection();
    let d = u.mapping.map(r.pos),
      f = tr(u.doc, d, a.length, a);
    if (((f ||= ((a[0] = s ? { type: s } : null), tr(u.doc, d, a.length, a))), !f)) return !1;
...
var Nr = Mr(),
  Pr = (e, t) => (t && t(e.tr.setSelection(new Le(e.doc))), !0);
function Fr(e, t, n) {
  let r = t.nodeBefore,
    i = t.nodeAfter,
    a = t.index();
  return !r || !i || !r.type.compatibleContent(i.type)
    ...
    : !r.content.size && t.parent.canReplace(a - 1, a)
      ...
      : !t.parent.canReplace(a, a + 1) || !(i.isTextblock || nr(e.doc, t.pos))
        ? !1
...
function Ir(e, t, n, r) {
  ...
  if (
    ...
    if (n) {
      ...
      s = U.from(i.copy(s));
      let c = e.tr.step(new Zn(t.pos - 1, r, t.pos, r, new W(s, 1, 0), o.length, !0)),
        l = c.doc.resolve(r + 2 * o.length);
      (l.nodeAfter && l.nodeAfter.type == i.type && nr(c.doc, l.pos) && c.join(l.pos),
        n(c.scrollIntoView()));
    }
    return !0;
  }
  let u = a.type.spec.isolating || (r > 0 && c) ? null : Fe.findFrom(t, 1),
...
function $r(e, t, n, r, i) {
  for (;;) {
    ...
    if (t == (i < 0 ? 0 : ei(e))) {
      let n = e.parentNode;
      if (!n || n.nodeType != 1 || ii(e) || Qr.test(e.nodeName) || e.contentEditable == `false`)
        return !1;
      ((t = Kr(e) + (i < 0 ? 0 : 1)), (e = n));
...
function ci(e, t, n) {
  if (e.caretPositionFromPoint)
    try {
      ...
      if (r) return { node: r.offsetNode, offset: Math.min(ei(r.offsetNode), r.offset) };
    } catch {}
  if (e.caretRangeFromPoint) {
    let r = e.caretRangeFromPoint(t, n);
    if (r) return { node: r.startContainer, offset: Math.min(ei(r.startContainer), r.startOffset) };
  }
}
var li = typeof navigator < `u` ? navigator : null,
  ui = typeof document < `u` ? document : null,
  di = (li && li.userAgent) || ``,
  fi = /Edge\/(\d+)/.exec(di),
  pi = /MSIE \d/.exec(di),
  mi = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(di),
  hi = !!(pi || mi || fi),
  gi = pi ? document.documentMode : mi ? +mi[1] : fi ? +fi[1] : 0,
  _i = !hi && /gecko\/(\d+)/i.test(di);
_i && +(/Firefox\/(\d+)/.exec(di) || [0, 0])[1];
var vi = !hi && /Chrome\/(\d+)/.exec(di),
  yi = !!vi,
  bi = vi ? +vi[1] : 0,
  xi = !hi && !!li && /Apple Computer/.test(li.vendor),
  Si = xi && (/Mobile\/\w+/.test(di) || (!!li && li.maxTouchPoints > 2)),
  Ci = Si || (li ? /Mac/.test(li.platform) : !1),
  wi = li ? /Win/.test(li.platform) : !1,
  Ti = /Android \d/.test(di),
  Ei = !!ui && `webkitFontSmoothing` in ui.documentElement.style,
  Di = Ei ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Oi(e) {
...
function ji(e, t, n) {
  ...
  for (let o = n || e.dom; o; ) {
    ...
    let e = o,
      ...
      l = 0;
    if (
      (t.top < s.top + ki(r, `top`)
        ? (l = -(s.top - t.top + ki(i, `top`)))
        : t.bottom > s.bottom - ki(r, `bottom`) &&
          (l =
            t.bottom - t.top > s.bottom - s.top
              ? t.top + ki(i, `top`) - s.top
              : t.bottom - s.bottom + ki(i, `bottom`)),
      t.left < s.left + ki(r, `left`)
        ? (c = -(s.left - t.left + ki(i, `left`)))
        : t.right > s.right - ki(r, `right`) && (c = t.right - s.right + ki(i, `right`)),
      c || l)
    )
...
function Mi(e) {
  ...
  return { refDOM: r, refTop: i, stack: Ni(e.dom) };
}
function Ni(e) {
  let t = [],
    n = e.ownerDocument;
...
function Gi(e, t) {
  ...
  if (xi) for (let e = o; r && e; e = qr(e)) e.draggable && (r = void 0);
  if (((o = Vi(o, t)), r)) {
    if (
      _i &&
      r.nodeType == 1 &&
...
function Yi(e, t, n) {
  ...
  if (r.nodeType == 3)
    if (o && (Ji.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
      let e = qi(Yr(r, i, i), n);
      if (_i && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let t = qi(Yr(r, i - 1, i - 1), -1);
        if (t.top == e.top) {
          let n = qi(Yr(r, i, i + 1), -1);
  ...
  if (a == null && i < ei(r)) {
    ...
    let t = e ? (e.nodeType == 3 ? Yr(e, 0, o ? 0 : 1) : e.nodeType == 1 ? e : null) : null;
    if (t) return Xi(qi(t, -1), !0);
  }
  return Xi(qi(r.nodeType == 3 ? Yr(r) : r, -n), n >= 0);
}
function Xi(e, t) {
...
function ta(e, t, n) {
  ...
  let i = r.parentOffset,
    ...
    s = e.domSelection();
  return s
    ? !ea.test(r.parent.textContent) || !s.modify
      ? n == `left` || n == `backward`
        ? a
        : o
      : Qi(e, t, () => {
...
function aa(e, t, n) {
  return na == t && ra == n
    ? ia
    : ((na = t), (ra = n), (ia = n == `up` || n == `down` ? $i(e, t, n) : ta(e, t, n)));
}
var oa = 0,
  sa = 1,
  ca = 2,
    ...
    domFromPos(e, t) {
      ...
      if (t <= 0) {
        ...
        return e && t && r && !e.border && !e.domAtom
          ...
          : { node: this.contentDOM, offset: e ? Kr(e.dom) + 1 : 0 };
      } else {
        let e,
          r = !0;
        for (
        ...
        return e && r && !e.border && !e.domAtom
          ? e.domFromPos(0, t)
          : { node: this.contentDOM, offset: e ? Kr(e.dom) : this.contentDOM.childNodes.length };
      }
    }
    parseRange(e, t, n = 0) {
...
`
            ...
            for (let t = e, n; t; t = t.parentNode) {
              if ((n = t.nextSibling)) {
                n.nodeName == `BR` && (o = s = { node: n.parentNode, offset: Kr(n) + 1 });
                break;
              }
              let e = t.pmViewDesc;
      ...
      if (_i && l.focusNode && l.focusNode != s.node && l.focusNode.nodeType == 1) {
        let e = l.focusNode.childNodes[l.focusOffset];
        e && e.contentEditable == `false` && (r = !0);
      }
      if (
        !(r || (u && xi)) &&
        Zr(o.node, o.offset, l.anchorNode, l.anchorOffset) &&
        Zr(s.node, s.offset, l.focusNode, l.focusOffset)
      )
        return;
      let d = !1;
      if ((c.extend || e == t) && !(u && _i)) {
  ...
  pa = class e extends ua {
    ...
    static create(t, n, r, i) {
      let a = i.nodeViews[n.type.name],
        o = a && a(n, i, r);
      return (
        (!o || !o.dom) && (o = Ae.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)),
        new e(t, n, o.dom, o.contentDOM || o.dom, o)
      );
    }
    parseRule() {
      return this.dirty & la || this.mark.type.spec.reparseInView
        ? null
  ...
  ma = class e extends ua {
    ...
    static create(t, n, r, i, a, o) {
      ...
      if (n.isText) {
        ...
        let e = Ae.renderSpec(document, n.type.spec.toDOM(n), null, n.attrs);
      ...
      return (
        (u = Ta(u, r, n)),
        l
          ? (c = new va(t, n, r, i, u, d || null, f, l, a, o + 1))
          : n.isText
            ? new ga(t, n, r, i, u, f, a)
    ...
    updateChildren(e, t) {
      ...
      (ja(
        ...
        (t, i, a) => {
          (t.spec.marks
            ...
            : t.type.side >= 0 &&
              !a &&
              s.syncToMarks(
                i == this.node.childCount ? Ie.none : this.node.child(i).marks,
                n,
                e,
                i,
              ),
        ...
        s.destroyRest(),
        (s.changed || this.dirty == ca) &&
          (a && this.protectLocalComposition(e, a),
          ya(this.contentDOM, this.children, e),
          Si && Ma(this.dom)));
    }
    localCompositionInfo(e, t) {
      ...
      if (this.node.inlineContent) {
        let e = i.nodeValue,
          a = Na(this.node.content, e, n - t, r - t);
    ...
    protectLocalComposition(e, { node: t, pos: n, text: r }) {
      ...
      (e.input.compositionNodes.push(a),
        (this.children = Pa(this.children, n, n + r.length, e, a)));
    }
    update(e, t, n, r) {
...
var ga = class e extends ma {
    ...
    update(e, t, n, r) {
      return this.dirty == la || (this.dirty != oa && !this.inParent()) || !e.sameMarkup(this.node)
        ? !1
        : (this.updateOuterDeco(t),
          (this.dirty != oa || e.text != this.node.text) &&
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    if (o) {
      ...
      for (let e in o) {
        let a = o[e];
        a != null &&
          (n && i.length == 1 && i.push((r = new ba(t.isInline ? `span` : `div`))),
          e == `class`
...
var Oa = class {
  constructor(e, t, n) {
    ((this.lock = t),
      ...
      (this.changed = !1),
      (this.top = e),
      (this.preMatch = ka(e.node.content, e)));
  }
  destroyBetween(e, t) {
    if (e != t) {
  ...
  syncToMarks(e, t, n, r) {
    ...
    for (; a < e.length; ) {
      ...
      if (i > -1)
        ...
        let r = pa.create(this.top, e[a], t, n);
  ...
  updateNodeAt(e, t, n, r, i) {
    let a = this.top.children[r];
    return (
      a.dirty == la && a.dom == a.contentDOM && (a.dirty = ca),
      ...
      if (s instanceof ma) {
        ...
        if (!d && (u = this.recreateWrapper(s, e, t, n, r, a)))
          return (
            ...
            u.contentDOM && ((u.dirty = ca), u.updateChildren(r, a + 1), (u.dirty = oa)),
            (this.changed = !0),
            this.index++,
            !0
          );
  ...
  addTextblockHacks() {
    ...
    (!e ||
      ...
      ((xi || yi) && e && e.dom.contentEditable == `false` && this.addHackNode(`IMG`, t),
...
function Fa(e, t = null) {
  ...
  if (ai(n)) {
    ...
    if (
      ...
      K.isSelectable(e) &&
      i.parent &&
      !(e.isInline && ri(n.focusNode, n.focusOffset, i.dom))
    ) {
      let e = i.posBefore;
...
function Ia(e) {
  return e.editable
    ? e.hasFocus()
    : Ja(e) && document.activeElement && document.activeElement.contains(e.dom);
}
function La(e, t = !1) {
  ...
  if ((Wa(e, n), Ia(e))) {
    if (!t && e.input.mouseDown && e.input.mouseDown.allowDefault && yi) {
      ...
      if (
        t.anchorNode &&
        n.anchorNode &&
        Zr(t.anchorNode, t.anchorOffset, n.anchorNode, n.anchorOffset)
      ) {
    ...
    if ((e.domObserver.disconnectSelection(), e.cursorWrapper)) Ua(e);
      ...
      (Ra &&
        !(n instanceof q) &&
        (n.$from.parent.inlineContent || (a = za(e, n.from)),
        !n.empty && !n.$from.parent.inlineContent && (o = za(e, n.to))),
        ...
        n.visible
          ...
          : (e.dom.classList.add(`ProseMirror-hideselection`),
            `onselectionchange` in document && Ha(e)));
    }
...
function za(e, t) {
  ...
  if (xi && i && i.contentEditable == `false`) return Ba(i);
...
function Ba(e) {
  return (
    ...
    xi && e.draggable && ((e.draggable = !1), (e.wasDraggable = !0)),
    e
  );
}
function Va(e) {
  ...
  t.addEventListener(
    ...
    (e.input.hideSelectionGuard = () => {
      (n.anchorNode != r || n.anchorOffset != i) &&
        (t.removeEventListener(`selectionchange`, e.input.hideSelectionGuard),
        setTimeout(() => {
          (!Ia(e) || e.state.selection.visible) &&
            e.dom.classList.remove(`ProseMirror-hideselection`);
        }, 20));
    }),
  );
...
function Ua(e) {
  ...
  let n = e.cursorWrapper.dom,
    r = n.nodeName == `IMG`;
  (r ? t.collapse(n.parentNode, Kr(n) + 1) : t.collapse(n, 0),
    !r && !e.state.selection.visible && hi && gi <= 11 && ((n.disabled = !0), (n.disabled = !1)));
}
function Wa(e, t) {
  if (t instanceof K) {
...
function Qa(e, t, n) {
  ...
  if (r instanceof q) {
    if (n.indexOf(`s`) > -1) {
      ...
      return Za(e, new q(r.$anchor, a));
    } else if (!r.empty) return !1;
    else if (e.endOfTextblock(t > 0 ? `forward` : `backward`)) {
      let n = Xa(e.state, t);
      return n && n instanceof K ? Za(e, n) : !1;
    } else if (!(Ci && n.indexOf(`m`) > -1)) {
      let n = r.$head,
        i = n.textOffset ? null : t < 0 ? n.nodeBefore : n.nodeAfter,
        a;
      ...
      return i.isAtom || ((a = e.docView.descAt(o)) && !a.contentDOM)
        ? K.isSelectable(i)
          ? Za(e, new K(t < 0 ? e.state.doc.resolve(n.pos - i.nodeSize) : n))
          : Ei
            ? Za(e, new q(e.state.doc.resolve(t < 0 ? o : o + i.nodeSize)))
            : !1
        : !1;
    }
  } else if (r instanceof K && r.node.isInline) return Za(e, new q(t > 0 ? r.$to : r.$from));
  else {
    let n = Xa(e.state, t);
    return n ? Za(e, n) : !1;
  }
...
function no(e) {
  ...
  let i,
    a,
    o = !1;
  for (_i && n.nodeType == 1 && r < $a(n) && eo(n.childNodes[r], -1) && (o = !0); ; )
    if (r > 0) {
      ...
      for (; t && eo(t, -1); ) ((i = n.parentNode), (a = Kr(t)), (t = t.previousSibling));
      if (t) ((n = t), (r = $a(n)));
      else {
...
function ro(e) {
  ...
  for (;;)
    if (r < i) {
      ...
      let t = n.nextSibling;
      for (; t && eo(t, 1); ) ((a = t.parentNode), (o = Kr(t) + 1), (t = t.nextSibling));
      if (t) ((n = t), (r = 0), (i = $a(n)));
      else {
        if (((n = n.parentNode), n == e.dom)) break;
        r = i = 0;
...
function co(e, t) {
  ...
  if (!(yi || wi) && n.parent.inlineContent) {
...
function lo(e, t, n) {
  let r = e.state.selection;
  if ((r instanceof q && !r.empty) || n.indexOf(`s`) > -1 || (Ci && n.indexOf(`m`) > -1)) return !1;
  let { $from: i, $to: a } = r;
  if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? `up` : `down`)) {
    let n = Xa(e.state, t);
    if (n && n instanceof K) return Za(e, n);
  }
  if (!i.parent.inlineContent) {
    let n = t < 0 ? i : a,
      o = r instanceof Le ? Fe.near(n, t) : Fe.findFrom(n, t);
    return o ? Za(e, o) : !1;
  }
  return !1;
}
...
function po(e) {
  if (!xi || e.state.selection.$head.parentOffset > 0) return !1;
...
function ho(e, t) {
  ...
  } else if (n == 39 || (Ci && n == 70 && r == `c`)) {
    let t = n == 39 ? (co(e, e.state.selection.from) == `ltr` ? 1 : -1) : 1;
    return Qa(e, t, r) || to(e, t);
  } else if (n == 38 || (Ci && n == 80 && r == `c`)) return lo(e, -1, r) || to(e, -1);
  else if (n == 40 || (Ci && n == 78 && r == `c`)) return po(e) || lo(e, 1, r) || to(e, 1);
  else if (r == (Ci ? `m` : `c`) && (n == 66 || n == 73 || n == 89 || n == 90)) return !0;
  return !1;
}
function go(e, t) {
  ...
  let o = e.someProp(`clipboardSerializer`) || Ae.fromSchema(e.state.schema),
    s = Do(),
...
`,
  ...
  if (
    ...
    s = Mo(wo(s, +u[1], +u[2]), u[4]);
  else if (((s = W.maxOpen(yo(s.content, i), !0)), s.openStart || s.openEnd)) {
    let e = 0,
      t = 0;
    for (
...
function xo(e, t, n, r, i) {
  if (i < e.length && i < t.length && e[i] == t[i]) {
    ...
    if (r.contentMatchAt(r.childCount).matchType(i == e.length - 1 ? n.type : e[i + 1]))
      return r.copy(r.content.append(U.from(bo(n, e, i + 1))));
  }
}
function So(e, t) {
  if (t == 0) return e;
...
function wo(e, t, n) {
  return (
    t < e.openStart && (e = new W(Co(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)),
    n < e.openEnd && (e = new W(Co(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)),
    e
  );
}
var To = {
...
function ko(e) {
  ...
  return t
    ? ((Oo ||= t.defaultPolicy || t.createPolicy(`ProseMirrorClipboard`, { createHTML: (e) => e })),
      Oo.createHTML(e))
    : e;
}
function Ao(e) {
  ...
  let n = Do().createElement(`div`),
    r = /<([a-z][^>\s]+)/i.exec(e),
    i;
  if (
    ((i = r && To[r[1].toLowerCase()]) &&
      (e =
        i.map((e) => `<` + e + `>`).join(``) +
        e +
        i
  ...
  for (let t in No) {
    ...
    e.dom.addEventListener(
      ...
      (e.input.eventHandlers[t] = (t) => {
        Ho(e, t) && !Vo(e, t) && (e.editable || !(t.type in Po)) && n(e, t);
      }),
      Fo[t] ? { passive: !0 } : void 0,
    );
  }
  (xi && e.dom.addEventListener(`input`, () => null), Bo(e));
}
function Ro(e, t) {
  ...
  e.someProp(`handleDOMEvents`, (t) => {
    for (let n in t)
      e.input.eventHandlers[n] ||
        e.dom.addEventListener(n, (e.input.eventHandlers[n] = (t) => Vo(e, t)));
  });
}
function Vo(e, t) {
...
function Uo(e, t) {
  !Vo(e, t) && No[t.type] && (e.editable || !(t.type in Po)) && No[t.type](e, t);
}
((Po.keydown = (e, t) => {
  let n = t;
  if (
    ...
    if (
      ...
      Si && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
    ) {
      let t = Date.now();
      ((e.input.lastIOSEnter = t),
        (e.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          e.input.lastIOSEnter == t &&
            (e.someProp(`handleKeyDown`, (t) => t(e, oi(13, `Enter`))), (e.input.lastIOSEnter = 0));
        }, 200)));
    } else
      e.someProp(`handleKeyDown`, (t) => t(e, n)) || ho(e, n) ? n.preventDefault() : Ro(e, `key`);
}),
  (Po.keyup = (e, t) => {
  ...
  (Po.keypress = (e, t) => {
    let n = t;
    if (rs(e, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (Ci && n.metaKey)) return;
...
function Jo(e, t) {
  ...
  let n = e.state.doc.resolve(t),
    r = n.nodeAfter;
  return r && r.isAtom && K.isSelectable(r) ? (qo(e, new K(n), `pointer`), !0) : !1;
}
function Yo(e, t) {
  if (t == -1) return !1;
  let n = e.state.selection,
  ...
  return i == null ? !1 : (qo(e, K.create(e.state.doc, i), `pointer`), !0);
}
function Xo(e, t, n, r, i) {
  return (
    Ko(e, `handleClickOn`, t, n, r) ||
...
function Zo(e, t, n, r) {
  return (
    Ko(e, `handleDoubleClickOn`, t, n, r) || e.someProp(`handleDoubleClick`, (n) => n(e, t, r))
  );
}
function Qo(e, t, n, r) {
  return (
    Ko(e, `handleTripleClickOn`, t, n, r) ||
...
function $o(e, t, n) {
  ...
  let r = e.state.doc;
  if (t == -1) return r.inlineContent ? (qo(e, q.create(r, 0, r.content.size), `pointer`), !0) : !1;
  let i = r.resolve(t);
  for (let t = i.depth + 1; t > 0; t--) {
    let n = t > i.depth ? i.nodeAfter : i.node(t),
      a = i.before(t);
    if (n.inlineContent) qo(e, q.create(r, a + 1, a + 1 + n.content.size), `pointer`);
    else if (K.isSelectable(n)) qo(e, K.create(r, a), `pointer`);
    else continue;
    return !0;
  }
}
...
No.mousedown = (e, t) => {
  ...
  let o = e.posAtCoords(Wo(n));
  o &&
    (a == `singleClick`
      ? (e.input.mouseDown && e.input.mouseDown.done(), (e.input.mouseDown = new ns(e, o, n, !!r)))
      : (a == `doubleClick` ? Zo : Qo)(e, o.pos, o.inside, n)
        ? n.preventDefault()
        : Ro(e, `pointer`));
};
var ns = class {
  constructor(e, t, n, r) {
    ...
    (this.view.root.removeEventListener(`mouseup`, this.up),
      ...
      this.mightDrag &&
        ...
        this.view.domObserver.start()),
      this.delayedSelectionSync && setTimeout(() => La(this.view)),
      (this.view.input.mouseDown = null));
  }
  up(e) {
    if ((this.done(), !this.view.dom.contains(e.target))) return;
    let t = this.pos;
    (this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(Wo(e))),
      this.updateAllowDefault(e),
      this.allowDefault || !t
        ? Ro(this.view, `pointer`)
        : Xo(this.view, t.pos, t.inside, e, this.selectNode)
          ? e.preventDefault()
          : e.button == 0 &&
              (this.flushed ||
                (xi && this.mightDrag && !this.mightDrag.node.isAtom) ||
                (yi &&
            ...
            ? (qo(this.view, Fe.near(this.view.state.doc.resolve(t.pos)), `pointer`),
              e.preventDefault())
            : Ro(this.view, `pointer`));
  }
  move(e) {
...
((No.touchstart = (e) => {
  ((e.input.lastTouch = Date.now()), es(e), Ro(e, `pointer`));
}),
  (No.touchmove = (e) => {
    ((e.input.lastTouch = Date.now()), Ro(e, `pointer`));
  }),
  (No.contextmenu = (e) => es(e)));
function rs(e, t) {
  return e.composing
    ? !0
    : xi && Math.abs(t.timeStamp - e.input.compositionEndedAt) < 500
      ? ((e.input.compositionEndedAt = -2e8), !0)
      : !1;
}
var is = Ti ? 5e3 : -1;
Po.compositionstart = Po.compositionupdate = (e) => {
  if (!e.composing) {
    e.domObserver.flush();
    let { state: t } = e,
      n = t.selection.$to;
    if (
      ...
      ((e.markCursor = e.state.storedMarks || n.marks()), ds(e, !0), (e.markCursor = null));
    else if (
      (ds(e, !t.selection.empty),
      _i && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)
    ) {
      let t = e.domSelectionRange();
...
function ss(e, t) {
  (clearTimeout(e.input.composingTimeout),
    t > -1 && (e.input.composingTimeout = setTimeout(() => ds(e), t)));
}
function cs(e) {
  for (
    e.composing && ((e.input.composing = !1), (e.input.compositionEndedAt = us()));
...
function ls(e) {
  ...
  let n = ti(t.focusNode, t.focusOffset),
    r = ni(t.focusNode, t.focusOffset);
  if (n && r && n != r) {
    let t = r.pmViewDesc,
...
function ds(e, t = !1) {
  if (!(Ti && e.domObserver.flushingSoon >= 0)) {
    if ((e.domObserver.forceFlush(), cs(e), t || (e.docView && e.docView.dirty))) {
      let n = Fa(e),
        r = e.state.selection;
      return (
        n && !n.eq(r)
...
var ps = (hi && gi < 15) || (Si && Di < 604);
No.copy = Po.cut = (e, t) => {
  let n = t,
    r = e.state.selection,
    i = n.type == `cut`;
  if (r.empty) return;
  let a = ps ? null : n.clipboardData,
    { dom: o, text: s } = go(e, r.content());
  (a
    ? (n.preventDefault(),
      a.clearData(),
...
function hs(e, t) {
  ...
  setTimeout(() => {
    (e.focus(),
      ...
      n ? gs(e, r.value, null, i, t) : gs(e, r.textContent, r.innerHTML, i, t));
  }, 50);
}
...
Po.paste = (e, t) => {
  ...
  r && gs(e, _s(r), r.getData(`text/html`), i, n) ? n.preventDefault() : hs(e, n);
};
var vs = class {
    constructor(e, t, n) {
...
((No.dragstart = (e, t) => {
  ...
  let i = e.state.selection,
    a = i.empty ? null : e.posAtCoords(Wo(n)),
    o;
  ...
  ((!n.dataTransfer.files.length || !yi || bi > 120) && n.dataTransfer.clearData(),
    n.dataTransfer.setData(ps ? `Text` : `text/html`, s.innerHTML),
    (n.dataTransfer.effectAllowed = `copyMove`),
    ps || n.dataTransfer.setData(`text/plain`, c),
    (e.dragging = new vs(l, bs(e, n), o)));
}),
  (No.dragend = (e) => {
    let t = e.dragging;
    window.setTimeout(() => {
  ...
  (Po.dragover = Po.dragenter = (e, t) => t.preventDefault()),
  (Po.drop = (e, t) => {
    try {
      xs(e, t, e.dragging);
    } finally {
...
function xs(e, t, n) {
  ...
  a
    ...
    : (a = _o(e, _s(t.dataTransfer), ps ? null : t.dataTransfer.getData(`text/html`), !1, i));
  let o = !!(n && bs(e, t));
  ...
  if (!a) return;
  t.preventDefault();
  let s = a ? G(e.state.doc, i.pos, a) : i.pos;
  s ??= i.pos;
  let c = e.state.tr;
  if (o) {
    let { node: e } = n;
  ...
  if (
    ...
    (c.mapping.maps[c.mapping.maps.length - 1].forEach((e, n, r, i) => (t = i)),
      c.setSelection(Ka(e, f, c.doc.resolve(t))));
  }
...
((No.focus = (e) => {
  ...
  (No.beforeinput = (e, t) => {
    if (yi && Ti && t.inputType == `deleteContentBackward`) {
      e.domObserver.flushSoon();
      let { domChangeCount: t } = e.input;
      setTimeout(() => {
        if (
          e.input.domChangeCount != t ||
          (e.dom.blur(), e.focus(), e.someProp(`handleKeyDown`, (t) => t(e, oi(8, `Backspace`))))
        )
          return;
...
var Cs = class e {
    constructor(e, t) {
      ((this.toDOM = e), (this.spec = t || Os), (this.side = this.spec.side || 0));
    }
    map(e, t, n, r) {
      let { pos: i, deleted: a } = e.mapResult(t.from + r, this.side < 0 ? -1 : 1);
      return a ? null : new Es(i - n, i - n, this);
    }
    valid() {
      return !0;
    }
      ...
      return (
        ...
        (t instanceof e &&
          ((this.spec.key && this.spec.key == t.spec.key) ||
            (this.toDOM == t.toDOM && Ss(this.spec, t.spec))))
      );
    }
    destroy(e) {
  ...
  Ts = class e {
    ...
    map(e, t, n, r) {
      ...
      return a.deleted || a.pos <= i.pos ? null : new Es(i.pos - n, a.pos - n, this);
    }
    valid(e, t) {
  ...
  ks = class e {
    ...
    static create(e, t) {
      return t.length ? Ls(t, e, 0, Os) : As;
    }
    find(e, t, n) {
      let r = [];
    ...
    map(e, t, n) {
      return this == As || e.maps.length == 0 ? this : this.mapInner(e, t, 0, 0, n || Os);
    }
    mapInner(t, n, r, i, a) {
      let o;
      ...
      return this.children.length
        ? Ms(this.children, o || [], t, n, r, i, a)
        : o
          ? new e(o.sort(Rs), Ds)
          : As;
    }
    add(t, n) {
      return n.length ? (this == As ? e.create(t, n) : this.addInner(t, n, 0)) : this;
    }
    addInner(t, n, r) {
      let i,
        a = 0;
      t.forEach((e, t) => {
        ...
        if ((s = Fs(n, e, o))) {
          ...
          (i[a] == t
            ...
            : i.splice(a, 0, t, t + e.nodeSize, Ls(s, e, o + 1, Os)),
            (a += 3));
        }
      });
      let o = Ns(a ? Is(n) : n, -r);
      for (let e = 0; e < o.length; e++) o[e].type.valid(t, o[e]) || o.splice(e--, 1);
      return new e(o.length ? this.local.concat(o).sort(Rs) : this.local, i || this.children);
    }
    remove(e) {
      return e.length == 0 || this == As ? this : this.removeInner(e, 0);
    }
    removeInner(t, n) {
      let r = this.children,
        i = this.local;
      ...
      return r == this.children && i == this.local ? this : i.length || r.length ? new e(i, r) : As;
    }
    forChild(t, n) {
      ...
      for (let e = 0; e < this.local.length; e++) {
        let t = this.local[e];
        if (t.from < o && t.to > a && t.type instanceof ws) {
      ...
      if (i) {
        let t = new e(i.sort(Rs), Ds);
        return r ? new js([t, r]) : t;
      }
      return r || As;
    }
    eq(t) {
    ...
    localsInner(e) {
      if (this == As) return Ds;
      if (e.inlineContent || !this.local.some(ws.is)) return this.local;
      let t = [];
      for (let e = 0; e < this.local.length; e++)
        this.local[e].type instanceof ws || t.push(this.local[e]);
      return t;
    }
    forEachSet(e) {
      e(this);
...
((ks.empty = new ks([], [])), (ks.removeOverlap = zs));
var As = ks.empty,
  js = class e {
    constructor(e) {
      this.members = e;
    ...
    map(t, n) {
      let r = this.members.map((e) => e.map(t, n, Os));
      return e.from(r);
    }
    forChild(t, n) {
      if (n.isLeaf) return ks.empty;
      let r = [];
      for (let i = 0; i < this.members.length; i++) {
        let a = this.members[i].forChild(t, n);
        a != As && (a instanceof e ? (r = r.concat(a.members)) : r.push(a));
      }
      return e.from(r);
    }
    eq(t) {
    ...
    static from(t) {
      switch (t.length) {
        ...
        default:
          return new e(
            t.every((e) => e instanceof ks)
              ? t
              : t.reduce((e, t) => e.concat(t instanceof ks ? t : t.members), []),
          );
      }
    }
    forEachSet(e) {
  ...
  for (let t = 0; t < s.length; t += 3)
    if (s[t + 1] < 0) {
      ...
      if (m && p == u && p + m.nodeSize == d) {
        ...
        r == As ? ((s[t + 1] = -2), (c = !0)) : ((s[t] = u), (s[t + 1] = d), (s[t + 2] = r));
      } else c = !0;
    }
  if (c) {
    let c = Ls(Ps(s, e, t, n, i, a, o), r, 0, o);
    t = c.local;
...
function Ns(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    let i = e[r];
    n.push(new Es(i.from + t, i.to + t, i.type));
  }
  return n;
}
...
function Ls(e, t, n, r) {
  ...
  t.forEach((t, o) => {
    ...
    if (s) {
      a = !0;
      let e = Ls(s, t, n + o + 1, r);
      e != As && i.push(o, o + t.nodeSize, e);
    }
  });
  let o = Ns(a ? Is(e) : e, -n).sort(Rs);
  for (let e = 0; e < o.length; e++)
    o[e].type.valid(t, o[e]) || (r.onRemove && r.onRemove(o[e].spec), o.splice(e--, 1));
  return o.length || i.length ? new ks(o, i) : As;
}
function Rs(e, t) {
      ...
      for (let i = n + 1; i < t.length; i++) {
        ...
        if (a.from == r.from) {
          a.to != r.to &&
            ...
            Bs(t, i + 1, a.copy(r.to, a.to)));
          continue;
        } else {
          a.from < r.to &&
            (t == e && (t = e.slice()),
            (t[n] = r.copy(r.from, a.from)),
            Bs(t, i, r.copy(a.from, r.to)));
          break;
        }
      }
  }
...
function Vs(e) {
  ...
  return (
    ...
    e.cursorWrapper && t.push(ks.create(e.state.doc, [e.cursorWrapper.deco])),
    js.from(t)
  );
}
var Hs = {
  ...
  Gs = class {
    ...
    start() {
      (this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, Hs)),
        this.onCharData &&
    ...
    onSelectionChange() {
      if (qa(this.view)) {
        ...
        if (hi && gi <= 11 && !this.view.state.selection.empty) {
    ...
    ignoreSelectionChange(e) {
      ...
      for (let r = e.anchorNode; r; r = qr(r))
        if (t.has(r)) {
          n = r;
          break;
        }
    ...
    flush() {
      ...
      if (
        ...
        if (t.length == 2) {
          ...
          for (let r of t) {
            let t = r.parentNode;
            t && t.nodeName == `LI` && (!n || Zs(e, n) != t) && r.remove();
          }
        }
      }
      let c = null;
      ...
      c.eq(Fe.near(e.state.doc.resolve(0), 1))
        ? ((e.input.lastFocus = 0), La(e), this.currentSelection.set(n), e.scrollToSelection())
        : (i > -1 || r) &&
          (i > -1 && (e.docView.markDirty(i, a), Js(e)),
          e.input.badSafariComposition && ((e.input.badSafariComposition = !1), Qs(e, s)),
          this.handleDOMChange(i, a, o, s),
          e.docView && e.docView.dirty
            ? e.updateState(e.state)
            : this.currentSelection.eq(n) || La(e),
    ...
    registerMutation(e, t) {
      ...
      if (e.type == `childList`) {
        ...
        let r = e.previousSibling,
          i = e.nextSibling;
        if (hi && gi <= 11 && e.addedNodes.length)
        ...
        let a = r && r.parentNode == e.target ? Kr(r) + 1 : 0,
          o = n.localPosFromDOM(e.target, a, -1),
          s = i && i.parentNode == e.target ? Kr(i) : e.target.childNodes.length;
...
function Js(e) {
  if (
    ...
    if (((e.requiresGeckoHackNode = _i), qs)) return;
    (console.warn(
...
function Ys(e, t) {
  ...
  return (
    Zr(o.node, o.offset, i, a) && ([n, r, i, a] = [i, a, n, r]),
...
function $s(e, t, n) {
  ...
  if (
    (u &&
      ...
      ai(c) || l.push({ node: c.focusNode, offset: c.focusOffset })),
  ...
  let d = e.state.doc,
    f = e.someProp(`domParser`) || Re.fromSchema(e.state.schema),
    p = d.resolve(o),
    m = null,
    h = f.parse(r, {
      topNode: p.parent,
...
function ec(e) {
  ...
  if (e.nodeName == `BR` && e.parentNode) {
    if (xi && /^(ul|ol)$/i.test(e.parentNode.nodeName)) {
      let e = document.createElement(`div`);
      return (e.appendChild(document.createElement(`li`)), { skip: e });
    } else if (e.parentNode.lastChild == e || (xi && /^(tr|table)$/i.test(e.parentNode.nodeName)))
      return { ignore: !0 };
...
function nc(e, t, n, r, i) {
  ...
  if (((e.input.compositionPendingChanges = 0), t < 0)) {
    ...
    if (n && !e.state.selection.eq(n)) {
      if (
        ...
        e.someProp(`handleKeyDown`, (t) => t(e, oi(13, `Enter`)))
      )
        return;
  ...
  let m = sc(d.content, l.doc.content, l.from, f, p);
  if (
    (m && e.input.domChangeCount++,
    ((Si && e.input.lastIOSEnter > Date.now() - 225) || Ti) &&
      i.some((e) => e.nodeType == 1 && !tc.test(e.nodeName)) &&
      (!m || m.endA >= m.endB) &&
      e.someProp(`handleKeyDown`, (t) => t(e, oi(13, `Enter`))))
  ) {
  ...
  if (
    ...
    ac(u, m.start, m.endA, h, g) &&
    e.someProp(`handleKeyDown`, (t) => t(e, oi(8, `Backspace`)))
  ) {
    Ti && yi && e.domObserver.suppressSelectionUpdates();
    return;
  }
  (yi && m.endB == m.start && (e.input.lastChromeDelete = Date.now()),
    Ti &&
      !v &&
      h.start() != g.start() &&
      g.parentOffset == 0 &&
  ...
  if (v)
    if (h.pos == g.pos) {
      hi &&
        gi <= 11 &&
        h.parentOffset == 0 &&
        (e.domObserver.suppressSelectionUpdates(), setTimeout(() => La(e), 20));
...
function rc(e, t, n) {
  return Math.max(n.anchor, n.head) > t.content.size
    ? null
    : Ka(e, t.resolve(n.anchor), t.resolve(n.head));
}
function ic(e, t) {
...
function ac(e, t, n, r, i) {
  if (n - t <= i.pos - r.pos || oc(r, !0, !1) < i.pos) return !1;
  let a = e.resolve(t);
  if (!r.parent.isTextblock) {
    let e = a.nodeAfter;
  ...
  let o = e.resolve(oc(a, !0, !0));
  return !o.parent.isTextblock || o.pos > n || oc(o, !0, !1) < n
    ? !1
...
function sc(e, t, n, r, i) {
  ...
  if (o < a && e.size < t.size) {
    let e = r <= a && r >= o ? a - r : 0;
    ((a -= e),
      a && a < t.size && cc(t.textBetween(a - 1, a + 1)) && (a += e ? 1 : -1),
      (s = a + (s - o)),
      (o = a));
  } else if (s < a) {
    let t = r <= a && r >= s ? a - r : 0;
    ((a -= t),
      a && a < e.size && cc(e.textBetween(a - 1, a + 1)) && (a += t ? 1 : -1),
      (o = a + (o - s)),
      (s = a));
  }
...
var lc = class {
  constructor(e, t) {
    ((this._root = null),
      ...
      (this.editable = fc(this)),
      dc(this),
      (this.nodeViews = mc(this)),
      (this.docView = ha(this.state.doc, uc(this), Vs(this), this.dom, this)),
      (this.domObserver = new Gs(this, (e, t, n, r) => nc(this, e, t, n, r))),
  ...
  updateStateInner(e, t) {
    let n = this.state,
      r = !1,
      i = !1;
    (e.storedMarks && this.composing && (cs(this), (i = !0)), (this.state = e));
    let a = n.plugins != e.plugins || this._props.plugins != t.plugins;
    if (a || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let e = mc(this);
      hc(e, this.nodeViews) && ((this.nodeViews = e), (r = !0));
    }
    ((a || t.handleDOMEvents != this._props.handleDOMEvents) && Bo(this),
      (this.editable = fc(this)),
      dc(this));
    let o = Vs(this),
      s = uc(this),
    ...
    if (i) {
      ...
      let t =
        ...
        !n.selection.empty &&
        !e.selection.empty &&
        pc(n.selection, e.selection);
      if (l) {
        let n = yi ? (this.trackWrites = this.domSelectionRange().focusNode) : null;
        (this.composing && (this.input.compositionNode = ls(this)),
          (r || !this.docView.update(e.doc, s, o, this)) &&
            (this.docView.updateOuterDeco(s),
            this.docView.destroy(),
            (this.docView = ha(e.doc, s, o, this.dom, this))),
      ...
      !(
        ...
        ? La(this, t)
        : (Wa(this, e.selection), this.domObserver.setCurSelection()),
        this.domObserver.start());
    }
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new vs(e.slice, e.move, r < 0 ? void 0 : K.create(this.state.doc, r));
  }
  someProp(e, t) {
  ...
  pasteHTML(e, t) {
    return gs(this, ``, e, !1, t || new ClipboardEvent(`paste`));
  }
  pasteText(e, t) {
    return gs(this, e, null, !0, t || new ClipboardEvent(`paste`));
  }
  ...
  domSelectionRange() {
    ...
    return e
      ? (xi &&
          ...
          si(this.dom.ownerDocument) == this.dom &&
          Xs(this, e)) ||
          e
...
lc.prototype.dispatch = function (e) {
...
function uc(e) {
  ...
  return (
    ...
    (t.translate ||= `no`),
    [Es.node(0, e.state.doc.content.size, t)]
  );
}
function dc(e) {
  if (e.markCursor) {
    ...
    ((t.className = `ProseMirror-separator`),
      ...
      (e.cursorWrapper = {
        dom: t,
        deco: Es.widget(e.state.selection.from, t, { raw: !0, marks: e.markCursor }),
      }));
...
var _c = class e extends Fe {
  constructor(e) {
    super(e, e);
  }
  map(t, n) {
    let r = t.resolve(n.map(this.head));
    return e.valid(r) ? new e(r) : Fe.near(r);
  }
  content() {
    return W.empty;
  }
  ...
  static valid(e) {
    let t = e.parent;
    if (t.inlineContent || !bc(e) || !xc(e)) return !1;
...
((_c.prototype.visible = !1), (_c.findFrom = _c.findGapCursorFrom), Fe.jsonID(`gapcursor`, _c));
var vc = class e {
  constructor(e) {
    this.pos = e;
  }
  ...
  resolve(e) {
    ...
    return _c.valid(t) ? new _c(t) : Fe.near(t);
  }
};
function yc(e) {
...
function bc(e) {
  for (let t = e.depth; t >= 0; t--) {
    ...
    for (let e = r.child(n - 1); ; e = e.lastChild) {
      if ((e.childCount == 0 && !e.inlineContent) || yc(e.type)) return !0;
  ...
  return new Me({
    props: {
      ...
      createSelectionBetween(e, t, n) {
        return t.pos == n.pos && _c.valid(n) ? new _c(n) : null;
      },
      handleClick: Tc,
      handleKeyDown: Cc,
...
function wc(e, t) {
  ...
  return function (e, r, i) {
    ...
    let c = _c.findGapCursorFrom(o, t, s);
    return c ? (r && r(e.tr.setSelection(new _c(c))), !0) : !1;
  };
}
function Tc(e, t, n) {
  if (!e || !e.editable) return !1;
  let r = e.state.doc.resolve(t);
  if (!_c.valid(r)) return !1;
  let i = e.posAtCoords({ left: n.clientX, top: n.clientY });
  return i && i.inside > -1 && K.isSelectable(e.state.doc.nodeAt(i.inside))
    ? !1
    : (e.dispatch(e.state.tr.setSelection(new _c(r))), !0);
}
function Ec(e, t) {
  if (t.inputType != `insertCompositionText` || !(e.state.selection instanceof _c)) return !1;
...
function Dc(e) {
  if (!(e.selection instanceof _c)) return null;
  let t = document.createElement(`div`);
  return (
    (t.className = `ProseMirror-gapcursor`),
    ks.create(e.doc, [Es.widget(e.selection.head, t, { key: `gapcursor` })])
  );
}
var Oc = 200,
  kc = function () {};
((kc.prototype.append = function (e) {
  return e.length
    ? ((e = kc.from(e)),
      (!this.length && e) ||
  ...
  (kc.prototype.prepend = function (e) {
    return e.length ? kc.from(e).append(this) : this;
  }),
  (kc.prototype.appendInner = function (e) {
    return new jc(this, e);
  }),
  (kc.prototype.slice = function (e, t) {
    return (
      e === void 0 && (e = 0),
      t === void 0 && (t = this.length),
      e >= t ? kc.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, t))
    );
  }),
  (kc.prototype.get = function (e) {
    if (!(e < 0 || e >= this.length)) return this.getInner(e);
  }),
  (kc.prototype.forEach = function (e, t, n) {
    (t === void 0 && (t = 0),
      n === void 0 && (n = this.length),
      t <= n ? this.forEachInner(e, t, n, 0) : this.forEachInvertedInner(e, t, n, 0));
  }),
  (kc.prototype.map = function (e, t, n) {
  ...
  (kc.from = function (e) {
    return e instanceof kc ? e : e && e.length ? new Ac(e) : kc.empty;
  }));
var Ac = (function (e) {
  function t(t) {
  ...
  return (
    ...
    (t.prototype.leafAppend = function (e) {
      if (this.length + e.length <= Oc) return new t(this.values.concat(e.flatten()));
    }),
    (t.prototype.leafPrepend = function (e) {
      if (this.length + e.length <= Oc) return new t(e.flatten().concat(this.values));
    }),
...
var jc = (function (e) {
  ...
  Nc = class e {
          ...
          (t, n) => {
            ...
            if (i) {
              ...
              (e &&
                ...
                l.push(new Fc(n, void 0, void 0, l.length + u.length))),
                a--,
                n && i.appendMap(n, a));
    ...
    addTransform(t, n, r, i) {
      ...
      let l = o - r.depth;
      return (l > Lc && ((s = Pc(s, l)), (o -= l)), new e(s.append(a), o));
    }
    remapping(e, t) {
      let n = new ke();
      return (
    ...
    addMaps(t) {
      return this.eventCount == 0
        ? this
        : new e(this.items.append(t.map((e) => new Fc(e))), this.eventCount);
    }
    rebased(t, n) {
      ...
      this.items.forEach((e) => {
        ...
        if (e.step) {
          ...
          (l && s++, r.push(new Fc(i, o, l)));
        } else r.push(new Fc(i));
      }, i);
      let l = [];
      for (let e = n; e < o; e++) l.push(new Fc(a.maps[e]));
      let u = new e(this.items.slice(0, i).append(l).append(r), s);
      return (u.emptyItemCount() > Mc && (u = u.compress(this.items.length - r.length)), u);
    }
    emptyItemCount() {
      let e = 0;
      return (
    ...
    compress(t = this.items.length) {
      ...
      return (
        ...
        new e(kc.from(i.reverse()), a)
      );
    }
  };
Nc.empty = new Nc(kc.empty, 0);
function Pc(e, t) {
  let n;
  return (
    e.forEach((e, r) => {
...
function Rc(e, t, n, r) {
  ...
  n.getMeta(qc) && (e = new Ic(e.done, e.undone, null, 0, -1));
  let o = n.getMeta(`appendedTransaction`);
  if (n.steps.length == 0) return e;
  if (o && o.getMeta(Kc))
    return o.getMeta(Kc).redo
      ? new Ic(
          e.done.addTransform(n, void 0, r, Gc(t)),
          e.undone,
          Bc(n.mapping.maps),
          e.prevTime,
          e.prevComposition,
      ...
      : new Ic(
          e.done,
          e.undone.addTransform(n, void 0, r, Gc(t)),
          null,
          e.prevTime,
          e.prevComposition,
        );
  if (n.getMeta(`addToHistory`) !== !1 && !(o && o.getMeta(`addToHistory`) === !1)) {
    let i = n.getMeta(`composition`),
      a =
        ...
        (!o &&
          e.prevComposition != i &&
          (e.prevTime < (n.time || 0) - r.newGroupDelay || !zc(n, e.prevRanges))),
      s = o ? Vc(e.prevRanges, n.mapping) : Bc(n.mapping.maps);
    return new Ic(
      e.done.addTransform(n, a ? t.selection.getBookmark() : void 0, r, Gc(t)),
      Nc.empty,
      s,
      n.time,
      i ?? e.prevComposition,
...
function Hc(e, t, n) {
  ...
  let o = a.selection.resolve(a.transform.doc),
    ...
    c = new Ic(n ? s : a.remaining, n ? a.remaining : s, null, 0, -1);
  return a.transform.setSelection(o).setMeta(Kc, { redo: n, historyState: c });
}
var Uc = !1,
  Wc = null;
function Gc(e) {
...
var Kc = new Oe(`history`),
  qc = new Oe(`closeHistory`);
function Jc(e = {}) {
  return (
    ...
    new Me({
      ...
      state: {
        init() {
          return new Ic(Nc.empty, Nc.empty, null, 0, -1);
        },
        apply(t, n, r) {
          return Rc(n, r, t, e);
        },
      ...
      props: {
        handleDOMEvents: {
          beforeinput(e, t) {
            let n = t.inputType,
              r = n == `historyUndo` ? Xc : n == `historyRedo` ? Zc : null;
...
var Xc = Yc(!1, !0),
  Zc = Yc(!0, !0);
function Qc(e, { preferFileMentionFsPath: t = !1, preserveTextLinkMarks: n = !1 } = {}) {
  let r = ``,
    i = !1;
  function a(e) {
...
`),
    ...
    if (e.isText && e.text !== void 0) {
      ...
      t == null ? (r += e.text) : (r += b(e.text, `${n ? y : ``}${t.attrs.href}`));
    } else if (e.type.name === `atMention`)
      r += b(e.attrs.label, t ? v({ fsPath: e.attrs.fsPath, path: e.attrs.path }) : e.attrs.path);
      ...
      r += b(e.attrs.title, te({ resourceUri: e.attrs.resourceUri, server: e.attrs.server }));
    else if (e.type.name === `chatGptConversationMention`) r += b(e.attrs.title, e.attrs.path);
    else if (
      ...
      r += b(`${t}${i}`, e.attrs.path);
    } else e.type.name === `richLink` && (r += b(e.attrs.displayText, e.attrs.href));
  }
  return (
    e.descendants((e) => a(e)),
    i &&
...
`);
  if (
    ...
    (e.dispatch(e.state.tr.replaceSelection(i)), yr(e.state, e.dispatch, e));
  }
}
var tl = new Oe(`placeholderPlugin`);
function nl(e) {
  return new Me({
    key: tl,
    state: {
      ...
      apply(e, t) {
        return e.getMeta(tl) ? { placeholder: e.getMeta(tl).placeholder } : t;
      },
    },
    props: {
      decorations(e) {
        ...
        if (
          ...
          let n = [],
            { placeholder: r } = tl.getState(e);
          return (
            t.descendants((e, t) => {
              n.push(Es.node(t, t + e.nodeSize, { class: `placeholder`, "data-placeholder": r }));
            }),
            ks.create(t, n)
          );
        }
...
var rl = 1e5,
  il = 1e5,
  al = 100;
function ol({ html: e, schema: t, text: n }) {
  if (e.length > rl || n.length > il) return null;
  let r = 0,
    i,
    a = n.replaceAll(`\xA0`, ` `),
    o = new window.DOMParser().parseFromString(e, `text/html`),
    s = o.body.querySelectorAll(`a[href]`);
  if (s.length > al) return null;
  let c = new Map();
  for (let e of s) {
    let t = oe(e.getAttribute(`href`) ?? ``);
        ...
        toDOM: (e) => {
          ...
          return Ut({
            ...
            dataAttributes: {
              ...
              ...x({
                href: v({ fsPath: e.attrs.fsPath, path: e.attrs.path }),
                label: e.attrs.label,
              }),
            },
          });
        ...
        toDOM: (e) => {
          ...
          return Ut({
            ...
            dataAttributes: {
              ...
              ...x({ href: te({ resourceUri: n, server: r }), label: i }),
            },
          });
        },
        parseDOM: [
  ...
  let l = typeof a == `boolean` ? {} : a,
    ...
    p = new lc(null, {
        ...
        plugins: [
          ...
          Ot({
            ...
            Enter: (e, t) => {
              ...
              if (f === `newline`) return $c(e, t);
              let a = e.doc.childCount > 1;
              return f === `cmdIfMultiline` && a ? $c(e, t) : (d.emit(`submit`), !0);
            },
      ...
      dispatchTransaction(e) {
        ...
        (p.updateState(t), u.dispatchEvent(new Event(Ee)));
      },
      handlePaste(e, t) {
        if (t.defaultPrevented) return !0;
        let n = t.clipboardData,
          { imageFiles: i, otherFiles: a } = rt(n);
        if (
        ...
        if (f != null && f.length > 0) {
          let t = ol({ html: f, schema: e.state.schema, text: o });
          if (t != null)
            return (e.dispatch(e.state.tr.replaceSelection(new W(t.content, 1, 1))), !0);
        }
        return (el(e, o), !0);
      ...
      clipboardTextSerializer(e) {
        return Qc(e.content, { preferFileMentionFsPath: !0 }).content;
      },
    });
  return (
    e != null && p.dispatch(p.state.tr.setSelection(q.atEnd(p.state.doc))),
    {
      view: p,
      eventEmitter: d,
      setEnterBehavior: (e) => {
...
var dl = class {
  ...
  getText() {
    return Qc(this.view.state.doc).content;
  }
  getPersistedText() {
    return Qc(this.view.state.doc, { preserveTextLinkMarks: !0 }).content;
  }
  hasText() {
  ...
  setText(e) {
    let t = A({ schema: this.view.state.schema, text: e }),
...
`)
      ...
      (el(this.view, e), this.view.focus());
      return;
    }
  ...
  setPlaceholder(e) {
    this.view.dispatch(this.view.state.tr.setMeta(tl, { placeholder: e }));
  }
  syncMentionMetadata({
    skills: e,
    apps: t = [],
    ...
    let a = new Map(),
      ...
      u = new Map();
    (e.forEach((e) => {
      (a.set(_(e.path), e), o.set(e.name.toLowerCase(), e));
    }),
      t.forEach((e) => {
        let t = R(e.id);
    ...
    (f.doc.descendants((e, t) => {
      ...
      let n = typeof e.attrs.path == `string` ? e.attrs.path : ``,
        ...
        p = ml({ nodeTypeName: e.type.name, path: n }),
        g = null;
      if (p === `app`) {
        let e = s.get(n),
        ...
        let t = l.get(n),
          ...
          s =
            typeof e.attrs.displayName == `string` && e.attrs.displayName.length > 0
              ? e.attrs.displayName
              : f,
          c = ue({ mentionPath: n, mentionDisplayName: s, nativeApps: r, computerPlugin: d }),
          p = o == null ? null : z(o, i),
          m = o?.displayName ?? o?.plugin.name ?? ``,
          h = o == null ? `` : z(o).displayName,
          _ =
            c.isComputerUse &&
            s.length > 0 &&
            s !== m &&
        ...
        let t = n.length > 0 ? a.get(_(n)) : void 0;
      ...
      return (!g && !y) ||
        (!(
          ...
          !y)
        ? !0
        : ((h = !0), (m = m.setNodeMarkup(t, v, { ...e.attrs, ...g })), !0);
    }),
      h && p(m));
  }
  insertAtMention(e, t) {
    let n = t ?? Rt.getState(this.view.state);
    if (!n || n.anchorPos == null) return;
    let { state: r, dispatch: i } = this.view,
      a = n.anchorPos - 1,
      o = n.anchorPos + n.query.length,
      s = e.matchType === `directory` && !/[\\/]$/.test(e.path) ? `${e.path}/` : e.path,
      c = cl.nodes.atMention.create({ ...e, path: s }),
      l = r.tr.replaceRangeWith(a, o, c),
      u = fl(l, l.mapping.map(a) + c.nodeSize);
    ((l = l.setSelection(q.create(l.doc, u))),
      (l = l.setMeta(Rt, { active: !1, anchorPos: null, query: `` })),
      i(l),
      this.view.focus());
  }
  insertAgentMention(e, t) {
    ...
    let { state: r, dispatch: i } = this.view,
      a = n.anchorPos - 1,
      o = n.anchorPos + n.query.length,
      s = cl.nodes.agentMention.create({
        name: e.name,
    ...
    ((c = c.setSelection(q.create(c.doc, u))),
      (c = c.setMeta(Rt, { active: !1, anchorPos: null, query: `` })),
      i(c),
      this.view.focus());
  }
  ...
  insertSkillMention(e, t) {
    this.insertMention(ie(e), t);
  }
  insertSkillMentionFromSlashCommand(e, t) {
    this.insertMentionFromSlashCommand(ie(e), t);
  }
  insertMention(e, t) {
    let n = t ?? Wt.getState(this.view.state);
    !n || n.anchorPos == null || this.replaceQueryWithMention(e, n, Wt);
  }
  insertMentionFromSlashCommand(e, t) {
    let n = t ?? Xt.getState(this.view.state);
    !n || n.anchorPos == null || this.replaceQueryWithMention(e, n, Xt);
  }
  ...
  insertMentionFromAtMention(e, t) {
    let n = t ?? Rt.getState(this.view.state);
    !n || n.anchorPos == null || this.replaceQueryWithMention(e, n, Rt);
  }
  setAtMentionSource(e, t) {
    if (t.anchorPos == null) return;
    let { state: n, dispatch: r } = this.view,
      i = n.tr.insertText(``, t.anchorPos, t.anchorPos + t.query.length);
    ((i = i.setMeta(Rt, { active: !0, anchorPos: t.anchorPos, query: ``, source: e })),
      r(i),
      this.view.focus());
  }
  insertSkillMentionAtSelection(e) {
    this.insertMentionAtSelection(ie(e));
  }
  ...
  clearSlashCommand(e) {
    let t = e ?? Xt.getState(this.view.state);
    ...
    ((o = o.setSelection(q.create(o.doc, i))),
      (o = o.setMeta(Xt, { active: !1, anchorPos: null, query: `` })),
      r(o),
      this.view.focus());
  }
  ...
  insertResourceMentionFromAtMention(e, t, n) {
    ...
    let { state: r, dispatch: i } = this.view,
      a = n.anchorPos - 1,
      o = n.anchorPos + n.query.length,
      s = cl.nodes.resourceMention.create({
        brandColor: e.brandColor ?? ``,
        iconSmall: e.iconSmall,
  ...
  insertChatGptConversationMention(e, t) {
    ...
    let { state: r, dispatch: i } = this.view,
      a = n.anchorPos - 1,
      o = n.anchorPos + n.query.length,
      s = cl.nodes.chatGptConversationMention.create(e),
      c = r.tr.replaceRangeWith(a, o, s),
      l = c.mapping.map(a) + s.nodeSize,
      u = fl(c, l);
    ((c = c.setSelection(q.create(c.doc, u))),
...
function pl(e) {
  switch (e) {
    case `agent`:
      return cl.nodes.agentMention;
    case `app`:
      return cl.nodes.appMention;
    case `plugin`:
      return cl.nodes.pluginMention;
    case `skill`:
      return cl.nodes.skillMention;
  }
}
function ml({ nodeTypeName: e, path: t }) {
...
function hl(e, t) {
  let { view: n, eventEmitter: r, setEnterBehavior: i } = ul(e ?? null, t);
  return new dl(
    n,
    r,
    i,
