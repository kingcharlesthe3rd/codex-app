...
import "./dist-9.js";
import { n as r, r as i, t as a } from "./chunk-64.js";
import {
  B as o,
  C as s,
  V as c,
...
import { h as m, s as h } from "./chunk-50.js";
import "./chunk-17.js";
import "./chunk-68.js";
import "./chunk-146.js";
import { t as g } from "./chunk-40.js";
import { t as _ } from "./chunk-78.js";
import "./chunk-133.js";
import "./chunk-46.js";
import "./chunk-79.js";
import { r as v, t as y } from "./chunk-23.js";
var b = (function () {
  var e = r(function (e, t, n, r) {
    ...
    Y = {
      ...
      table: [
        ...
        { 13: [1, 70], 15: [1, 71] },
        e(t, [2, 17], { 63: 35, 12: 72, 17: [1, 73], 42: j, 65: y, 66: b, 67: x, 68: S, 69: C }),
        { 19: [1, 74] },
        e(t, [2, 14]),
...
var x = b,
  S = class {
      ...
      return (
        this.entities.has(e)
          ? !this.entities.get(e)?.alias &&
            t &&
            ((this.entities.get(e).alias = t), i.info(`Add alias '${t}' to entity '${e}'`))
          : (this.entities.set(e, {
    ...
    clear() {
      ((this.entities = new Map()), (this.classes = new Map()), (this.relationships = []), d());
    }
    getData() {
      let e = [],
        t = [],
...
var w = r(async function (t, n, r, a) {
    ...
    (Array.from(h).length > 0 &&
      ...
      m.insertTitle(u, `erDiagramTitleText`, s?.titleTopMargin ?? 25, a.db.getDiagramTitle()),
