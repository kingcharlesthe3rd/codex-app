import { $ as e, it as t, tt as n } from "./runtime.worker-3.js";
function r(e) {
  if (e) throw e;
}
var i = e((e, t) => {
...
function _(...e) {
  let t = -1,
    n;
  for (; ++t < e.length; ) (b(e[t]), e[t] && (n = n === void 0 ? e[t] : n + `/` + e[t]));
  return n === void 0 ? `.` : v(n);
}
function v(e) {
  b(e);
...
var D = class {
  constructor(e) {
    let t;
    ((t = e ? (C(e) ? { path: e } : typeof e == `string` || ee(e) ? { value: e } : e) : {}),
  ...
  set basename(e) {
    (k(e, `basename`), O(e, `basename`), (this.path = p.join(this.dirname || ``, e)));
  }
  get dirname() {
  ...
  ne = new (class e extends j {
    ...
    use(e, ...t) {
      ...
      function o(e) {
        ...
        (s(e.plugins), e.settings && (r.settings = (0, M.default)(!0, r.settings, e.settings)));
      }
      function s(e) {
        let t = -1;
        if (e != null)
      ...
      function c(e, t) {
        ...
        if (i === -1) n.push([e, ...t]);
          ...
          let [r, ...o] = t,
            s = n[i][1];
          (a(s) && a(r) && (r = (0, M.default)(!0, s, r)), (n[i] = [e, r, ...o]));
        }
      }
    }
  })().freeze();
...
function re(e) {
  if (!a(e) || typeof e.type != `string`) throw TypeError("Expected node, got `" + e + "`");
}
function ie(e, t, n) {
      ...
      for (r = n; r--; )
        if (
          ...
          (Le(d, -c),
            ...
            (l = L(l, Ne(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t))),
            (l = L(l, [
              [`exit`, a, t],
              [`enter`, s, t],
              [`exit`, s, t],
...
const He = { continuation: { tokenize: We }, exit: Ge, name: `blockQuote`, tokenize: Ue };
function Ue(e, t, n) {
  let r = this;
  return i;
  function i(t) {
...
function Qe(e, t, n) {
  ...
  function u(t) {
    return t === s
      ...
      : o < 3
        ? n(t)
        : (e.exit(`codeFencedFenceSequence`), U(t) ? K(e, d, `whitespace`)(t) : d(t));
  }
  function d(n) {
    return n === null || V(n)
...
function It(e, t, n) {
  ...
  function te(t) {
    ...
    return z(t) && o.length < 8 ? (e.consume(t), (o += String.fromCharCode(t)), te) : O(t);
  }
  function ne(t) {
  ...
  function P(t) {
    return t === null || V(t) ? (e.exit(`htmlFlowData`), F(t)) : (e.consume(t), P);
  }
  function F(n) {
...
function Kt(e, t) {
  ...
  return (
    ...
    (s = L(s, [[`enter`, u, t]])),
    (s = L(s, Ne(t.parser.constructs.insideSpan.null, e.slice(a + r + 4, o - 3), t))),
...
function qt(e, t, n) {
  ...
  function s(t) {
    return a
      ? a._inactive
        ? d(t)
        : ((o = r.parser.defined.includes(R(r.sliceSerialize({ start: a.end, end: r.now() })))),
          e.enter(`labelEnd`),
          e.enter(`labelMarker`),
          e.consume(t),
          e.exit(`labelMarker`),
...
function Jt(e, t, n) {
  ...
  function c(t) {
    return t === 34 || t === 39 || t === 40
      ? yt(e, l, n, `resourceTitle`, `resourceTitleMarker`, `resourceTitleString`)(t)
      : u(t);
  }
  function l(t) {
...
function an(e, t, n) {
  ...
  function c(t) {
    return t === i
      ? (e.consume(t), r++, c)
      : (e.exit(`thematicBreakSequence`), U(t) ? K(e, s, `whitespace`)(t) : s(t));
  }
}
const J = { continuation: { tokenize: ln }, exit: dn, name: `list`, tokenize: cn },
...
function cn(e, t, n) {
  ...
  function s(t) {
    ...
    if (i === `listUnordered` ? !r.containerState.marker || t === r.containerState.marker : Ce(t)) {
      if (
        (r.containerState.type || ((r.containerState.type = i), e.enter(i, { _container: !0 })),
        i === `listUnordered`)
      )
        return (e.enter(`listItemPrefix`), t === 42 || t === 45 ? e.check(rn, n, l)(t) : l(t));
      if (!r.interrupt || t === 49)
...
function hn(e, t, n) {
  ...
  function s(t) {
    return t === i
      ? (e.consume(t), s)
      : (e.exit(`setextHeadingLineSequence`), U(t) ? K(e, c, `lineSuffix`)(t) : c(t));
  }
  function c(r) {
  ...
  let t = this,
    n = e.attempt(
      ...
      e.attempt(
        ...
        i,
        K(e, e.attempt(this.parser.constructs.flow, i, e.attempt(ft, i)), `linePrefix`),
      ),
    );
  return n;
  function r(r) {
...
const Tn = {
  ...
  En = { 91: xt },
  Dn = { [-2]: et, [-1]: et, 32: et },
  On = { 35: Dt, 42: rn, 45: [pn, rn], 60: Mt, 61: pn, 95: rn, 96: Ze, 126: Ze },
  kn = { 38: Je, 92: Ke },
  An = {
    [-5]: tn,
    [-4]: tn,
...
function Pn(e, t, n) {
  ...
  function d(e) {
    return (
      (o = L(o, e)),
      g(),
      o[o.length - 1] === null ? (w(t, 0), (l.events = Ne(a, l.events, l)), l.events) : []
    );
  }
  function f(e, t) {
    return In(p(e), t);
...
function Kn(e) {
  ...
  function u(e, t) {
    ...
    if (r) r[0].type !== e.type && (t ? t.call(this, e, r[0]) : (r[1] || Yn).call(this, e, r[0]));
    else
      throw Error(
        "Cannot close `" + e.type + "` (" + c({ start: e.start, end: e.end }) + `): it’s not open`,
      );
  ...
  function E(e) {
    let t = this.stack[this.stack.length - 1].children,
      n = t[t.length - 1];
    ((!n || n.type !== `text`) &&
      ((n = we()), (n.position = { start: Y(e.start), end: void 0 }), t.push(n)),
      this.stack.push(n));
  }
  function D(e) {
...
function rr(e) {
  return t;
  function t(t, n, r) {
    return !!(ar(t) && e.call(this, t, typeof n == `number` ? n : void 0, r || void 0));
  }
}
function ir() {
  return !0;
  ...
  function s(e, i, c) {
    ...
    function u() {
      let l = sr,
        ...
        d,
        f;
      if ((!t || a(e, i, c[c.length - 1] || void 0)) && ((l = lr(n(e, c))), l[0] === !1)) return l;
...
function lr(e) {
  return Array.isArray(e) ? e : typeof e == `number` ? [!0, e] : e == null ? sr : [e];
}
function ur(e, t, n) {
  let r = $n((n || {}).ignore || []),
    i = dr(t),
...
function _r() {
  return {
    unsafe: [
      ...
      { character: `.`, before: `[Ww]`, after: `[\\-.\\w]`, inConstruct: mr, notInConstruct: hr },
      { character: `:`, before: `[ps]`, after: `\\/`, inConstruct: mr, notInConstruct: hr },
    ],
  };
}
function vr(e) {
...
function Tr(e, t, n, r, i) {
  let a = ``;
  if (!kr(i) || (/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !Dr(n))) return !1;
  let o = Or(n + r);
  if (!o[0]) return !1;
  let s = {
    type: `link`,
...
function Pr(e) {
  let t = this.resume(),
    n = this.stack[this.stack.length - 1];
  (n.type, (n.identifier = R(this.sliceSerialize(e)).toLowerCase()), (n.label = t));
}
function Fr(e) {
  this.exit(e);
}
...
Yr.peek = Xr;
function Gr() {
  return { canContainEols: [`delete`], enter: { strikethrough: qr }, exit: { strikethrough: Jr } };
}
function Kr() {
  return {
...
function Zi() {
  return {
    ...
    exit: { codeText: ra, table: $i, tableData: ta, tableHeader: ta, tableRow: ta },
  };
}
function Qi(e) {
  let t = e._align;
...
function oa() {
  return {
    exit: { taskListCheckValueChecked: ca, taskListCheckValueUnchecked: ca, paragraph: la },
  };
}
function sa() {
...
function Fa() {
  return {
    document: {
      91: { name: `gfmFootnoteDefinition`, tokenize: za, continuation: { tokenize: Ba }, exit: Va },
    },
    text: {
      91: { name: `gfmFootnoteCall`, tokenize: Ra },
      93: { name: `gfmPotentialFootnoteCall`, add: `after`, tokenize: Ia, resolveTo: La },
    },
  };
}
function Ia(e, t, n) {
...
function Ya(e, t) {
      ...
      ? m.type === `tableHead`
        ...
        : m.type === `tableRow` || m.type === `tableDelimiterRow`
          ...
          : i &&
            ...
            ? ((r = !1),
              o[2] === 0 &&
                (a[1] !== 0 && ((o[0] = o[1]), (d = Xa(f, t, a, i, void 0, d)), (a = [0, 0, 0, 0])),
                (o[2] = n)))
            : m.type === `tableCellDivider` &&
              (r
                ? (r = !1)
                : (a[1] !== 0 && ((o[0] = o[1]), (d = Xa(f, t, a, i, void 0, d))),
                  (a = o),
                  (o = [a[1], n, 0, 0])))
      : m.type === `tableHead`
        ? ((s = !0), (c = n))
  ...
  for (c !== 0 && Za(f, t, c, l, u), f.consume(t.events), n = -1; ++n < t.events.length; ) {
    let e = t.events[n];
    e[0] === `enter` && e[1].type === `table` && (e[1]._align = Ka(t.events, n));
  }
  return e;
}
...
//# sourceMappingURL=workbook-from-markdown-B5K-Sjeg.js.map
