...
import { i as m, n as h, r as g } from "./chunk-50.js";
import { b as _, h as v, k as y } from "./chunk-48.js";
import { n as b, t as x } from "./src-1.js";
import { g as S, u as C } from "./chunk-123.js";
import { i as w, n as T } from "./chunk-88.js";
import { i as E, n as D, r as O, t as ee } from "./chunk-83.js";
import { n as k, t as A } from "./chunk-61.js";
import { a as j, n as M, r as te } from "./chunk-51.js";
import { n as N, t as ne } from "./rough.esm-2.js";
import { i as P, r as F } from "./chunk-89.js";
function I(e, t) {
...
var V,
  ...
  le = e(() => {
    (D(),
      ...
      (q = h((e) => (e ? e.reduce((e, t) => e + `;` + t, ``) : ``), `getLabelStyles`)),
      (J = h(async (e, t) => {
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
        ...
        if (Math.abs(i - t.y) * o > Math.abs(r - t.x) * c) {
          ...
          return (
            m.debug(`sides calc abc89, Q ${l}, q ${e}, R ${u}, r ${s}`, { _x: i, _y: a }),
            s === 0 && ((i = t.x), (a = t.y)),
            u === 0 && (i = t.x),
            l === 0 && (a = t.y),
            { x: i, y: a }
        ...
        return (
          e.forEach((e) => {
            if ((m.info(`abc88 checking point`, e, t), !X(t, e) && !i)) {
              let a = Z(t, r, e);
              (m.debug(`abc88 inside`, e, r, a), m.debug(`abc88 intersection`, a, t));
              let o = !1;
              (n.forEach((e) => {
                o ||= e.x === a.x && e.y === a.y;
              }),
        ...
        for (let r = 0; r < e.length; r++)
          if (t.includes(r)) {
            ...
            (Math.abs(i.x - t.x) > 10 && Math.abs(i.y - t.y) >= 10
              ? (m.debug(`Corner point fixing`, Math.abs(i.x - t.x), Math.abs(i.y - t.y)),
                (d =
                  a.x === o.x
                    ? { x: c < 0 ? o.x - 5 + u : o.x + 5 - u, y: l < 0 ? o.y - u : o.y + u }
                    : { x: c < 0 ? o.x - u : o.x + u, y: l < 0 ? o.y - 5 + u : o.y + 5 - u }))
              : m.debug(`Corner point skipping fixing`, Math.abs(i.x - t.x), Math.abs(i.y - t.y)),
              n.push(d, s));
          } else n.push(e[r]);
        return n;
      }, `fixCorners`)),
      ...
      (ae = h(function (e, h, g, v, y, x, C, w = !1) {
        ...
        var A = x;
        let j = [];
        for (let e in h.cssCompiledStyles) te(e) || j.push(h.cssCompiledStyles[e]);
        ...
        (h.toCluster &&
          ...
          (O = !0)),
          h.fromCluster &&
            (m.debug(`from cluster abc88`, g.get(h.fromCluster), JSON.stringify(D, null, 2)),
        ...
        if (h.look === `handDrawn`) {
          ...
          let i =
            (t ? t + `;` + n + `;` : n) + `;` + (W ? W.reduce((e, t) => e + `;` + t, ``) : ``);
          ((H = e
            .append(`path`)
            .attr(`d`, U)
            .attr(`id`, h.id)
            .attr(`class`, ` ` + z + (h.classes ? ` ` + h.classes : ``) + (r ?? ``))
            .attr(`style`, i)),
            (G = i.match(/stroke:([^;]+)/)?.[1]),
