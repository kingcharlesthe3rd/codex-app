...
import { n as Be, t as Ve } from "./app-initial~app-main~select-workspace-page-DMB-jExv.js";
var q,
  He,
  Ue = e(() => {
    (t(p()),
...
var Ge,
  ...
  J,
  qe = e(() => {
    ((Ge = h()), (Ke = t(p(), 1)), V(), le(), ie(), Be(), N(), (J = _()));
  });
function Je() {
  let e = (0, X.c)(100),
    t = c(a),
    ...
    [i, s] = b(Ne),
    l = d(Me),
    { data: u, isFetching: f } = Ce(),
    p = u === void 0 ? [] : u,
    m = ee(),
    h;
  e[0] === m ? (h = e[1]) : ((h = (e) => !xe(e, m)), (e[0] = m), (e[1] = h));
  let g = p.filter(h).map(rt),
    { data: _, isFetching: w } = y(Te),
    { data: T, isFetching: te } = o(re, {
      params: { dirs: (0, Z.default)(ut(g), nt).sort(tt) },
      source: `onboarding_workspace_select`,
    }),
    { data: E, isFetching: O } = D(),
    {
      autoLaunchAction: k,
      isRemoteHost: ne,
      setWorkspaceOnboardingAutoLaunchApplied: A,
      workspaceOnboardingExperimentArm: j,
    } = De(),
    ie;
  e[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((ie = []), (e[2] = ie)) : (ie = e[2]);
  let [ae, M] = (0, Q.useState)(ie),
    oe;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((oe = {}), (e[3] = oe)) : (oe = e[3]);
  let [N, P] = (0, Q.useState)(oe),
    [F, I] = (0, Q.useState)(!1),
    [se, L] = (0, Q.useState)(null),
    ce = (0, Q.useRef)(!1),
    le;
  e[4] === r
    ? (le = e[5])
  ...
  let fe = le,
    ...
    B = _?.roots,
    V = B != null && B.length > 0,
    pe = dt({ tasks: g, gitOrigins: T?.origins, codexHome: E?.codexHome }),
    me = (0, Z.default)([...(B ?? []), ...pe, ...ae], et).sort($e),
    he;
  e[6] === _?.labels
    ? (he = e[7])
    : ((he = (e) => {
        let t = _?.labels?.[e]?.trim();
  ...
  let H = me.map(he),
    U = H.map(Qe),
    ve;
  e[8] === N ? (ve = e[9]) : ((ve = (e) => !!N[e]), (e[8] = N), (e[9] = ve));
  let W = U.filter(ve),
    Se =
      U.length > 0 && W.length === U.length
        ? !0
        : W.length > 0 && W.length < U.length
          ? `indeterminate`
          : !1,
    G;
  (e[10] !== U || e[11] !== t || e[12] !== N || e[13] !== M || e[14] !== P || e[15] !== j
    ? ((G = (e) => {
        M((t) => (0, Z.default)([...t, e.root], Ze));
        let n = { ...N, [e.root]: !0 };
        P(n);
        let r = U.includes(e.root);
        R(t, ye, {
          action: `toggle_root`,
          selectedWorkspacesCount: lt(n, U) + (r ? 0 : 1),
          totalWorkspacesCount: r ? U.length : U.length + 1,
          experimentArm: j,
          checked: !0,
        });
      }),
  ...
  e[24] !== j
    ? ((we = (e) => {
      ...
      (e[25] = we))
    : (we = e[25]),
    C(`electron-onboarding-skip-workspace-result`, we));
  let Ee;
  e[26] !== V || e[27] !== t || e[28] !== L || e[29] !== j
    ? ((Ee = () => {
        (L(null),
          R(t, _e, { hasExistingWorkspaces: V, source: `onboarding_modal`, experimentArm: j }),
          S.dispatchMessage(`electron-pick-workspace-root-option`, { allowMultiple: !1 }));
      }),
      (e[26] = V),
      (e[27] = t),
      (e[28] = L),
  ...
  e[44] !== j
    ? ((Fe = (e, n) => {
        (L(null), M((t) => (0, Z.default)([...t, e], Xe)));
        let r = { ...N, [e]: n };
        (P(r),
          R(t, ye, {
            action: `toggle_root`,
            checked: n,
            selectedWorkspacesCount: lt(r, U),
            totalWorkspacesCount: U.length,
            experimentArm: j,
          }));
      }),
  ...
  let Ie = Fe,
    Le;
  e[46] !== U || e[47] !== t || e[48] !== N || e[49] !== P || e[50] !== L || e[51] !== j
    ? ((Le = (e) => {
        L(null);
        let n = { ...N };
        for (let t of U) n[t] = e;
        (P(n),
          R(t, ye, {
            action: `select_all`,
            checked: e,
            selectedWorkspacesCount: lt(n, U),
            totalWorkspacesCount: U.length,
            experimentArm: j,
          }));
      }),
  ...
  e[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Be = { queryKey: [x, `paths-exist`] }), (e[53] = Be))
    : (Be = e[53]);
  let Ve = v(Be),
    q = f || w || te || O || Ve > 0,
    He = H.length > 0,
  ...
  e[54] !== Pe || e[55] !== q || e[56] !== k || e[57] !== A
    ...
    : (J = e[58]);
  let qe;
  (e[59] !== q || e[60] !== k || e[61] !== A
    ? ((qe = [q, k, A]), (e[59] = q), (e[60] = k), (e[61] = A), (e[62] = qe))
    : (qe = e[62]),
    (0, Q.useEffect)(J, qe));
  let Je;
  e[63] !== n ||
  ...
  e[70] !== j
    ? ((Je = (e, r) => {
        ...
        let a = e;
        (l(Math.floor(Date.now() / 1e3)),
          i === `workspace` && B != null && (a = (0, Z.default)([...B, ...e], Ye)),
          S.dispatchMessage(`electron-update-workspace-root-options`, { roots: a }),
          s(`auto`),
          (z.current += 1),
          ue.select(t, { path: e[0], projectId: e[0] }),
          n(`/`, { replace: !0, state: { focusComposerNonce: z.current } }));
      }),
      (e[63] = n),
      (e[64] = i),
      (e[65] = U.length),
  ...
  let Y = Je,
    at,
    st;
  (e[72] !== Y || e[73] !== We || e[74] !== q || e[75] !== W
    ? ((at = () => {
        We || Ke.current || q || (W.length !== 0 && ((Ke.current = !0), Y(W, !0)));
      }),
      (st = [Y, We, q, W]),
      (e[72] = Y),
      (e[73] = We),
      ...
      ? ((mt = (0, $.jsx)(Re, {
          children: Ge
            ...
            : (0, $.jsx)(ot, {
                ...
                availableOptions: H,
                selectedRoots: W,
                selectAllState: Se === `indeterminate` ? !1 : Se,
...
function rt(e) {
  return { kind: `local`, key: k(e.id), at: e.createdAt, conversation: e };
}
function Y(e) {
  let t = (0, X.c)(7),
...
function at(e) {
  ...
  t[1] !== n || t[2] !== r || t[3] !== s || t[4] !== c
    ? ((u = (0, $.jsx)(j, { className: n, color: r, size: s, onClick: c, children: l })),
      (t[1] = n),
      (t[2] = r),
      (t[3] = s),
      (t[4] = c),
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== d
      ? ((f = (0, $.jsx)(We, { triggerButton: d, onStartFromScratch: a, onUseExistingFolder: o })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = d),
        (t[9] = f))
...
function ot(e) {
  ...
  t[2] === n
    ...
    : ((b = n
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              (0, $.jsx)(te, { className: `h-4 w-4 text-token-foreground` }),
              (0, $.jsx)(`span`, {
  ...
  let E;
  t[25] !== C || t[26] !== T
    ? ((E = (0, $.jsxs)(`div`, { className: `flex w-full items-center gap-4`, children: [C, T] })),
      (t[25] = C),
      (t[26] = T),
      (t[27] = E))
    : (E = t[27]);
  ...
  let O;
  t[34] !== D || t[35] !== E
    ? ((O = (0, $.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [E, D] })),
      (t[34] = D),
      (t[35] = E),
      (t[36] = O))
    : (O = t[36]);
...
function st(e) {
  let t = (0, X.c)(14),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = Oe(a)), (t[0] = a), (t[1] = o));
  let s = o,
    c;
  t[2] === i
    ? (c = t[3])
...
function ct(e) {
  let t = (0, X.c)(21),
    ...
    c = o.root,
    l;
  t[0] === c ? (l = t[1]) : ((l = fe(c)), (t[0] = c), (t[1] = l));
  let u = l,
    d = z(c).replace(/\/+$/, ``),
    f,
    p;
  ...
  let _;
  t[7] !== f || t[8] !== p || t[9] !== h
    ? ((_ = { params: f, placeholderData: p, queryConfig: h }),
      (t[7] = f),
      (t[8] = p),
      (t[9] = h),
      (t[10] = _))
    : (_ = t[10]);
  let { data: v } = g(`paths-exist`, _);
  if (!(a || (v?.existingPaths ?? []).some((e) => z(e).replace(/\/+$/, ``) === d))) return null;
...
function dt({ tasks: e, gitOrigins: t, codexHome: n }) {
  ...
  return (0, Z.default)(
    r
      .map((e) => {
        let t = se(e, a);
        return !t?.root || !i(t.root, n)
          ? e
          : (a.reduce(
              (e, r) =>
                !t.originUrl || r.originUrl !== t.originUrl || i(r.root, n)
                  ? e
                  : e
