...
import { Dt as me, Et as he, kt as ge } from "./app-initial~app-main~automations-page.js";
import {
  f as _e,
  p as ve,
...
import { n as H, t as Le } from "./app-initial~app-main~select-workspace-page.js";
import {
  d as Re,
  s as ze,
...
function Ye() {
  let e = (0, X.c)(100),
    ...
    [i, o] = p(Fe),
    c = g(Ie),
    { data: d, isFetching: h } = ue(),
    _ = d === void 0 ? [] : d,
    v = Ne(),
    b;
  e[0] === v ? (b = e[1]) : ((b = (e) => !re(e, v)), (e[0] = v), (e[1] = b));
  let x = _.filter(b).map(it),
    { data: ee, isFetching: S } = f(ie),
    { data: te, isFetching: w } = m(Ce, {
      params: { dirs: (0, Z.default)(ut(x), rt).sort(nt) },
      source: `onboarding_workspace_select`,
    }),
    { data: T, isFetching: ne } = we(),
    {
      autoLaunchAction: D,
      isRemoteHost: k,
  ...
  let [oe, M] = (0, Q.useState)(ae),
    le;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((le = {}), (e[3] = le)) : (le = e[3]);
  let [N, P] = (0, Q.useState)(le),
    [F, I] = (0, Q.useState)(!1),
  ...
  let ve = _e,
    ye = (0, Q.useRef)(0),
    R = ee?.roots,
    be = R != null && R.length > 0,
    Se = dt({ tasks: x, gitOrigins: te?.origins, codexHome: T?.codexHome }),
    Te = (0, Z.default)([...(R ?? []), ...Se, ...oe], tt).sort(et),
    Ee;
  e[6] === ee?.labels
    ? (Ee = e[7])
    : ((Ee = (e) => {
        let t = ee?.labels?.[e]?.trim();
  ...
  let z = Te.map(Ee),
    B = z.map($e),
    De;
  e[8] === N ? (De = e[9]) : ((De = (e) => !!N[e]), (e[8] = N), (e[9] = De));
  let V = B.filter(De),
    Oe =
      B.length > 0 && V.length === B.length
        ...
        : V.length > 0 && V.length < B.length
          ...
          : !1,
    ke;
  (e[10] !== B || e[11] !== t || e[12] !== N || e[13] !== M || e[14] !== P || e[15] !== j
    ? ((ke = (e) => {
        M((t) => (0, Z.default)([...t, e.root], Qe));
        let n = { ...N, [e.root]: !0 };
        P(n);
      ...
      (e[16] = ke))
    : (ke = e[16]),
    s(`workspace-root-option-picked`, ke));
  let Ae;
  (e[17] !== B.length ||
  e[18] !== t ||
  e[19] !== I ||
  ...
  e[24] !== j
    ? ((Ae = (e) => {
      ...
      (e[25] = Ae))
    : (Ae = e[25]),
    s(`electron-onboarding-skip-workspace-result`, Ae));
  let je;
  e[26] !== be || e[27] !== t || e[28] !== L || e[29] !== j
    ? ((je = () => {
        (L(null),
          ce(t, C, { hasExistingWorkspaces: be, source: `onboarding_modal`, experimentArm: j }),
          a.dispatchMessage(`electron-pick-workspace-root-option`, { allowMultiple: !1 }));
      }),
      (e[26] = be),
      (e[27] = t),
      (e[28] = L),
  ...
  let Ve = ze,
    U;
  e[46] !== B || e[47] !== t || e[48] !== N || e[49] !== P || e[50] !== L || e[51] !== j
    ? ((U = (e) => {
        L(null);
        let n = { ...N };
  ...
  e[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = { queryKey: [y, `paths-exist`] }), (e[53] = Ue))
    : (Ue = e[53]);
  let We = u(Ue),
    W = h || S || w || ne || We > 0,
    G = z.length > 0,
    ...
    qe = (0, Q.useRef)(!1),
    q;
  e[54] !== Re || e[55] !== W || e[56] !== D || e[57] !== A
    ? ((q = () => {
        me.current ||
          W ||
          D !== `select_workspace_skip_to_playground` ||
          ((me.current = !0), A(!0), Re());
      }),
      (e[54] = Re),
      (e[55] = W),
    ...
    : (q = e[58]);
  let Je;
  (e[59] !== W || e[60] !== D || e[61] !== A
    ? ((Je = [W, D, A]), (e[59] = W), (e[60] = D), (e[61] = A), (e[62] = Je))
    : (Je = e[62]),
    (0, Q.useEffect)(q, Je));
  let Ye;
  e[63] !== n ||
  ...
  e[70] !== j
    ? ((Ye = (e, r) => {
        ...
        let s = e;
        (c(Math.floor(Date.now() / 1e3)),
          i === `workspace` && R != null && (s = (0, Z.default)([...R, ...e], Xe)),
          a.dispatchMessage(`electron-update-workspace-root-options`, { roots: s }),
          o(`auto`),
          (ye.current += 1),
          xe.select(t, { path: e[0], projectId: e[0] }),
          n(`/`, { replace: !0, state: { focusComposerNonce: ye.current } }));
      }),
      (e[63] = n),
      (e[64] = i),
      (e[65] = B.length),
  ...
  let J = Ye,
    Y,
    st;
  (e[72] !== J || e[73] !== K || e[74] !== W || e[75] !== V
    ? ((Y = () => {
        K || qe.current || W || (V.length !== 0 && ((qe.current = !0), J(V, !0)));
      }),
      (st = [J, K, W, V]),
      (e[72] = J),
      (e[73] = K),
      ...
      ? ((mt = (0, $.jsx)(Be, {
          children: Ke
            ...
            : (0, $.jsx)(ot, {
                ...
                availableOptions: z,
                selectedRoots: V,
                selectAllState: Oe === `indeterminate` ? !1 : Oe,
                handleToggleSelectAll: He,
...
function it(e) {
  return { kind: `local`, key: B(e.id), at: e.createdAt, conversation: e };
}
function J(e) {
  let t = (0, X.c)(7),
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = r ? (0, $.jsx)(G, { className: `h-10 w-10`, "aria-hidden": `true` }) : null),
      (t[0] = r),
      (t[1] = i));
  let a, o;
...
function Y(e) {
  ...
  t[1] !== n || t[2] !== r || t[3] !== s || t[4] !== c
    ? ((u = (0, $.jsx)(ne, { className: n, color: r, size: s, onClick: c, children: l })),
      (t[1] = n),
      (t[2] = r),
      (t[3] = s),
      (t[4] = c),
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== d
      ? ((f = (0, $.jsx)(K, { triggerButton: d, onStartFromScratch: a, onUseExistingFolder: o })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = d),
        (t[9] = f))
...
function ot(e) {
  ...
  t[2] === n
    ...
    : ((b = n
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              (0, $.jsx)(ee, { className: `h-4 w-4 text-token-foreground` }),
              (0, $.jsx)(`span`, {
  ...
  t[12] !== y
    ? ((x = r
        ? (0, $.jsxs)(Ve, {
            className: _e(n && `pointer-events-none opacity-50`),
...
function st(e) {
  let t = (0, X.c)(14),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = Re(a)), (t[0] = a), (t[1] = o));
  let s = o,
    c;
  t[2] === i
    ? (c = t[3])
...
function ct(e) {
  ...
  t[7] !== f || t[8] !== p || t[9] !== h
    ? ((g = { params: f, placeholderData: p, queryConfig: h }),
      ...
      (t[10] = g))
    : (g = t[10]);
  let { data: _ } = x(`paths-exist`, g);
  if (!(a || (_?.existingPaths ?? []).some((e) => A(e).replace(/\/+$/, ``) === d))) return null;
  ...
  let b;
  return (
    t[14] !== v || t[15] !== u || t[16] !== r || t[17] !== i || t[18] !== o.label || t[19] !== y
      ? ((b = (0, $.jsx)(He, {
          checkboxId: v,
          checkboxClassName: U,
          checked: i,
...
function dt({ tasks: e, gitOrigins: t, codexHome: n }) {
  ...
  return (0, Z.default)(
    r
      .map((e) => {
        let t = ye(e, i);
        return !t?.root || !v(t.root, n)
          ? e
          : (i.reduce(
              (e, r) =>
                !t.originUrl || r.originUrl !== t.originUrl || v(r.root, n)
                  ? e
                  : e
...
export { Ye as SelectWorkspacePage };
