...
import { u as O } from "./thread-context-inputs.js";
...
import "./folder.js";
import { a as oe, p as se } from "./sidebar-project-groups-Bs-6klyU.js";
...
import { n as ue } from "./is-subagent-conversation-Tg4-cSB_.js";
import { u as M } from "./workspace-onboarding-experiment.js";
import { i as de, t as fe } from "./workspace-onboarding-controller.js";
import { a as pe, i as N, n as P, r as F, t as me } from "./onboarding-shell.js";
var I = e(u(), 1);
function he(e, t) {
  let n = m(t),
    r = n.getQueryCache();
...
function B() {
  ...
  e[82] !== P
    ? ((ct = (e, n) => {
        (E(t, {
          ...
          E(t, {
            eventName: `codex_onboarding_completed`,
            metadata: { selected_workspaces_count: e.length, experiment_arm: P },
          }));
        let a = e;
        (l(Math.floor(Date.now() / 1e3)),
          o === `workspace` && q != null && (a = (0, R.default)([...q, ...e], ge)),
          T.dispatchMessage(`electron-update-workspace-root-options`, { roots: a }),
          s(`auto`),
          (Fe.current += 1),
  ...
  (e[84] !== $ || e[85] !== rt || e[86] !== Q || e[87] !== X
    ? ((lt = () => {
        rt || at.current || Q || (X.length !== 0 && ((at.current = !0), $(X, !0)));
      }),
      (ut = [$, rt, Q, X]),
      (e[84] = $),
      (e[85] = rt),
...
function V(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = r ? (0, z.jsx)(ce, { className: `h-10 w-10`, "aria-hidden": `true` }) : null),
      (t[0] = r),
      (t[1] = i));
  let a, o;
...
function H(e) {
  ...
  t[1] !== n || t[2] !== r || t[3] !== s || t[4] !== c
    ? ((u = (0, z.jsx)(te, { className: n, color: r, size: s, onClick: c, children: l })),
      (t[1] = n),
      (t[2] = r),
      (t[3] = s),
      (t[4] = c),
...
function Ee(e) {
  ...
  let w;
  t[14] !== S || t[15] !== C
    ? ((w = (0, z.jsxs)(`div`, { className: `flex w-full flex-col gap-2`, children: [S, C] })),
      (t[14] = S),
      (t[15] = C),
      (t[16] = w))
    : (w = t[16]);
  ...
  let O;
  t[25] !== T || t[26] !== D
    ? ((O = (0, z.jsxs)(`div`, { className: `flex w-full items-center gap-4`, children: [T, D] })),
      (t[25] = T),
      (t[26] = D),
      (t[27] = O))
    : (O = t[27]);
  ...
  let A;
  t[34] !== k || t[35] !== O
    ? ((A = (0, z.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [O, k] })),
      (t[34] = k),
      (t[35] = O),
      (t[36] = A))
    : (A = t[36]);
...
function W(e) {
  let t = (0, L.c)(21),
    { index: n, isDisabled: i, isSelected: s, skipExistenceCheck: c, option: l, onToggle: u } = e,
    d = l.root,
    f;
  ...
  if (!(c || (b?.existingPaths ?? []).some((e) => r(e).replace(/\/+$/, ``) === m))) return null;
  ...
  let w;
  return (
    t[14] !== x || t[15] !== p || t[16] !== i || t[17] !== s || t[18] !== l.label || t[19] !== C
      ? ((w = (0, z.jsx)(F, {
          checkboxId: x,
          checkboxClassName: me,
          checked: s,
