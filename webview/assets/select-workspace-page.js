...
import { Co as l, Jt as u, bn as d, ds as f } from "./app-server-manager-signals.js";
import { f as p, k as m, o as h, p as g, t as _ } from "./vscode-api.js";
import { i as v, n as ee } from "./react.js";
import "./isEqual.js";
import { J as y } from "./src-1.js";
import "./react-dom.js";
import { c as b, o as x } from "./lib.js";
import { Ut as S, nn as C, o as w, rn as T, tn as E } from "./persisted-signal.js";
...
import "./tooltip.js";
import { A as O, L as k, P as A } from "./rpc-1.js";
import "./statsig.js";
import "./request.js";
...
import { m as oe } from "./chunk-109.js";
...
function V() {
  let e = (0, R.c)(100),
    ...
    [i, l] = ee(se),
    d = v(ce),
    { data: f, isFetching: m } = j(),
    h = f === void 0 ? [] : f,
    y = de(),
    x;
  e[0] === y ? (x = e[1]) : ((x = (e) => !u(e, y)), (e[0] = y), (e[1] = x));
  let te = h.filter(x).map(Ee),
    { data: D, isFetching: ne } = s(re),
    { data: O, isFetching: k } = a(ae, {
      params: { dirs: (0, z.default)(Ae(te), Te).sort(we) },
      source: `onboarding_workspace_select`,
    }),
    { data: A, isFetching: ue } = ie(),
    {
      autoLaunchAction: M,
      isRemoteHost: me,
  ...
  let Ie = Fe,
    ...
    ze = je({ tasks: te, gitOrigins: O?.origins, codexHome: A?.codexHome }),
    Be = (0, z.default)([...(q ?? []), ...ze, ...ge], Ce).sort(Se),
    Ve;
  e[6] === D?.labels
    ? (Ve = e[7])
    : ((Ve = (e) => {
        let t = D?.labels?.[e]?.trim();
    ...
    ? ((Ke = (e) => {
        if ((G(!1), e.success)) {
          (w(t, C, {
            ...
            w(t, S, { selectedWorkspacesCount: 1, experimentArm: P }),
            K(null),
  ...
  e[26] !== Re || e[27] !== t || e[28] !== K || e[29] !== P
    ? ((qe = () => {
        (K(null),
          w(t, E, { hasExistingWorkspaces: Re, source: `onboarding_modal`, experimentArm: P }),
          p.dispatchMessage(`electron-pick-workspace-root-option`, {}));
      }),
      (e[26] = Re),
      (e[27] = t),
      (e[28] = K),
  ...
  e[70] !== P
    ? ((ut = (e, r) => {
        (w(t, C, {
          ...
          w(t, S, { selectedWorkspacesCount: e.length, experimentArm: P }));
        let a = e;
        (d(Math.floor(Date.now() / 1e3)),
          i === `workspace` && q != null && (a = (0, z.default)([...q, ...e], ve)),
          p.dispatchMessage(`electron-update-workspace-root-options`, { roots: a }),
          l(`auto`),
          (Le.current += 1),
...
function Ee(e) {
  return { kind: `local`, key: d(e.id), at: e.createdAt, conversation: e };
}
function H(e) {
  let t = (0, R.c)(7),
...
function U(e) {
  ...
  t[1] !== n || t[2] !== r || t[3] !== s || t[4] !== c
    ? ((u = (0, B.jsx)(D, { className: n, color: r, size: s, onClick: c, children: l })),
      (t[1] = n),
      (t[2] = r),
      (t[3] = s),
      (t[4] = c),
...
function Oe(e) {
  ...
  let S;
  t[14] !== y || t[15] !== b
    ? ((S = (0, B.jsxs)(`div`, { className: `flex w-full flex-col gap-2`, children: [y, b] })),
      (t[14] = y),
      (t[15] = b),
      (t[16] = S))
    : (S = t[16]);
  ...
  let O;
  t[25] !== C || t[26] !== E
    ? ((O = (0, B.jsxs)(`div`, { className: `flex w-full items-center gap-4`, children: [C, E] })),
      (t[25] = C),
      (t[26] = E),
      (t[27] = O))
    : (O = t[27]);
...
function G(e) {
  ...
  if (!(a || (ee?.existingPaths ?? []).some((e) => A(e).replace(/\/+$/, ``) === d))) return null;
