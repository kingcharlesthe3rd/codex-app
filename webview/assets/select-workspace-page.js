...
import { Z as r, a as i, j as a, o, s, t as c } from "./app-scope-CWE-zIhQ.js";
import { Zt as l, r as u, sn as d } from "./use-host-config.js";
import { f } from "./thread-context-inputs.js";
import { A as p, f as m, o as h, p as g, t as _ } from "./vscode-api.js";
import { i as v, n as y } from "./react.js";
import "./isEqual.js";
import { J as b } from "./src.js";
import "./react-dom.js";
...
import "./tooltip-B.js";
import "./plus.js";
import { A as E, F as D, R as ee } from "./rpc.js";
import "./statsig.js";
import "./request.js";
import "./markdown-to-search-text.js";
import "./marked.esm.js";
import { en as O, fn as k, mn as A, pn as j, t as M } from "./product-logger.js";
import { m as te } from "./chunk-13.js";
import "./parse-directives.js";
import "./platform.js";
import "./persisted-signal.js";
import { s as ne } from "./app-server-manager-hooks-D4-J16ZL.js";
...
import { n as re } from "./use-codex-home.js";
...
import { a as ae, i as oe } from "./onboarding-state.js";
import "./projectless-thread.js";
import "./use-platform.js";
import "./uniq.js";
import "./with-window.js";
import { t as se } from "./sidebar-thread-keys.js";
import "./use-is-remote-host.js";
import "./folder.js";
import { r as ce } from "./local-projects.js";
import { a as le } from "./sidebar-project-groups.js";
import "./_defineProperty.js";
import "./checkbox.js";
import "./minus.js";
import "./dropdown.js";
import { t as ue } from "./use-is-background-subagents-enabled.js";
import { u as N } from "./workspace-onboarding-experiment.js";
import { i as de, t as fe } from "./workspace-onboarding-controller.js";
import { n as pe, t as P } from "./add-project-menu-items.js";
import { a as me, i as F, n as I, r as he, t as L } from "./onboarding-shell.js";
var R = e(t(), 1);
function ge(e, t) {
  let n = p(t),
    r = n.getQueryCache();
  return R.useSyncExternalStore(
    R.useCallback((e) => r.subscribe(a.batchCalls(e)), [r]),
    () => n.isFetching(e),
    () => n.isFetching(e),
  );
}
...
function _e() {
  let e = (0, z.c)(100),
    ...
    [a, l] = y(ae),
    u = v(oe),
    { data: p, isFetching: h } = ne(),
    b = p === void 0 ? [] : p,
    S = ue(),
    C;
  e[0] === S ? (C = e[1]) : ((C = (e) => !d(e, S)), (e[0] = S), (e[1] = C));
  let w = b.filter(C).map(Ee),
    { data: T, isFetching: E } = s(f),
    { data: D, isFetching: ee } = i(ie, {
      params: { dirs: (0, B.default)(Ae(w), Te).sort(we) },
      source: `onboarding_workspace_select`,
    }),
    { data: se, isFetching: le } = re(),
    {
      autoLaunchAction: N,
      isRemoteHost: pe,
      setWorkspaceOnboardingAutoLaunchApplied: P,
      workspaceOnboardingExperimentArm: F,
    } = de(),
    I;
  e[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((I = []), (e[2] = I)) : (I = e[2]);
  let [he, L] = (0, R.useState)(I),
    _e;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((_e = {}), (e[3] = _e)) : (_e = e[3]);
  let [H, U] = (0, R.useState)(_e),
    [W, G] = (0, R.useState)(!1),
    [Ne, K] = (0, R.useState)(null),
    Pe = (0, R.useRef)(!1),
    Fe;
  e[4] === r
    ? (Fe = e[5])
  ...
  let Ie = Fe,
    ...
    ze = je({ tasks: w, gitOrigins: D?.origins, codexHome: se?.codexHome }),
    Be = (0, B.default)([...(q ?? []), ...ze, ...he], Ce).sort(Se),
    Ve;
  e[6] === T?.labels
    ? (Ve = e[7])
    : ((Ve = (e) => {
        let t = T?.labels?.[e]?.trim();
    ...
    We =
      J.length > 0 && Y.length === J.length
        ...
        : Y.length > 0 && Y.length < J.length
          ...
          : !1,
    Ge;
  (e[10] !== J || e[11] !== t || e[12] !== H || e[13] !== L || e[14] !== U || e[15] !== F
    ? ((Ge = (e) => {
        L((t) => (0, B.default)([...t, e.root], be));
        let n = { ...H, [e.root]: !0 };
        U(n);
    ...
    ? ((Ke = (e) => {
        if ((G(!1), e.success)) {
          (M(t, j, {
            ...
            M(t, O, { selectedWorkspacesCount: 1, experimentArm: F }),
            K(null),
  ...
  let qe;
  e[26] !== Re || e[27] !== t || e[28] !== K || e[29] !== F
    ? ((qe = () => {
        (K(null),
          M(t, k, { hasExistingWorkspaces: Re, source: `onboarding_modal`, experimentArm: F }),
          m.dispatchMessage(`electron-pick-workspace-root-option`, { allowMultiple: !1 }));
      }),
      (e[26] = Re),
      (e[27] = t),
      (e[28] = K),
  ...
  let $e = Qe,
    et;
  e[46] !== J || e[47] !== t || e[48] !== H || e[49] !== U || e[50] !== K || e[51] !== F
    ? ((et = (e) => {
        K(null);
        let n = { ...H };
  ...
  let rt = ge(nt),
    ...
    st = (0, R.useRef)(!1),
    ct;
  e[54] !== Ze || e[55] !== Z || e[56] !== N || e[57] !== P
    ? ((ct = () => {
        Pe.current ||
          Z ||
          N !== `select_workspace_skip_to_playground` ||
          ((Pe.current = !0), P(!0), Ze());
      }),
      (e[54] = Ze),
      (e[55] = Z),
    ...
    : (ct = e[58]);
  let lt;
  (e[59] !== Z || e[60] !== N || e[61] !== P
    ? ((lt = [Z, N, P]), (e[59] = Z), (e[60] = N), (e[61] = P), (e[62] = lt))
    : (lt = e[62]),
    (0, R.useEffect)(ct, lt));
  let ut;
  e[63] !== n ||
  ...
  e[70] !== F
    ? ((ut = (e, r) => {
        (M(t, j, {
          ...
          M(t, O, { selectedWorkspacesCount: e.length, experimentArm: F }));
        let i = e;
        (u(Math.floor(Date.now() / 1e3)),
          a === `workspace` && q != null && (i = (0, B.default)([...q, ...e], ve)),
          m.dispatchMessage(`electron-update-workspace-root-options`, { roots: i }),
          l(`auto`),
          (Le.current += 1),
          ce.select(t, { path: e[0], projectId: e[0] }),
...
function Ee(e) {
  return { kind: `local`, key: se(e.id), at: e.createdAt, conversation: e };
}
function H(e) {
  let t = (0, z.c)(7),
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = r ? (0, V.jsx)(pe, { className: `h-10 w-10`, "aria-hidden": `true` }) : null),
      (t[0] = r),
      (t[1] = i));
  let a, o;
...
function U(e) {
  ...
  t[1] !== n || t[2] !== r || t[3] !== s || t[4] !== c
    ? ((u = (0, V.jsx)(w, { className: n, color: r, size: s, onClick: c, children: l })),
      (t[1] = n),
      (t[2] = r),
      (t[3] = s),
      (t[4] = c),
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== d
      ? ((f = (0, V.jsx)(P, { triggerButton: d, onStartFromScratch: a, onUseExistingFolder: o })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = d),
        (t[9] = f))
...
function Oe(e) {
  ...
  t[2] === n
    ...
    : ((b = n
        ? (0, V.jsxs)(`div`, {
            ...
            children: [
              (0, V.jsx)(T, { className: `h-4 w-4 text-token-foreground` }),
              (0, V.jsx)(`span`, {
  ...
  t[12] !== y
    ? ((x = r
        ? (0, V.jsxs)(I, {
            className: C(n && `pointer-events-none opacity-50`),
  ...
  let E;
  t[14] !== b || t[15] !== x
    ? ((E = (0, V.jsxs)(`div`, { className: `flex w-full flex-col gap-2`, children: [b, x] })),
      (t[14] = b),
      (t[15] = x),
      (t[16] = E))
    : (E = t[16]);
  ...
  let A;
  t[25] !== D || t[26] !== k
    ? ((A = (0, V.jsxs)(`div`, { className: `flex w-full items-center gap-4`, children: [D, k] })),
      (t[25] = D),
      (t[26] = k),
      (t[27] = A))
    : (A = t[27]);
  ...
  let M;
  t[34] !== j || t[35] !== A
    ? ((M = (0, V.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [A, j] })),
      (t[34] = j),
      (t[35] = A),
      (t[36] = M))
    : (M = t[36]);
...
function G(e) {
  ...
  t[7] !== p || t[8] !== m || t[9] !== _
    ? ((v = { params: p, placeholderData: m, queryConfig: _ }),
      ...
      (t[10] = v))
    : (v = t[10]);
  let { data: y } = h(`paths-exist`, v);
  if (!(a || (y?.existingPaths ?? []).some((e) => D(e).replace(/\/+$/, ``) === f))) return null;
  ...
  let S;
  return (
    t[14] !== b || t[15] !== d || t[16] !== r || t[17] !== i || t[18] !== o.label || t[19] !== x
      ? ((S = (0, V.jsx)(he, {
          checkboxId: b,
          checkboxClassName: L,
          checked: i,
...
export { _e as SelectWorkspacePage };
