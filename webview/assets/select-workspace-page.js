...
import { n as Be, t as Ve } from "./app-initial~app-main~select-workspace-page.js";
var q,
  He,
  Ue = e(() => {
    (t(R()),
...
function We(e) {
  let t = (0, Ge.c)(12),
    {
      ...
      onOpenChange: a,
      onStartFromScratch: o,
      onUseExistingFolder: s,
      open: c,
      triggerButton: l,
    } = e,
    d = r === void 0 ? !1 : r,
  ...
  let h;
  return (
    t[5] !== n || t[6] !== a || t[7] !== c || t[8] !== p || t[9] !== m || t[10] !== l
      ? ((h = (0, J.jsxs)(j, {
          triggerButton: l,
          contentWidth: `menu`,
          onOpenChange: a,
...
var Ge,
  ...
  J,
  qe = e(() => {
    ((Ge = ce()), (Ke = t(R(), 1)), T(), pe(), ye(), Be(), I(), (J = U()));
  });
function Je() {
  let e = (0, X.c)(100),
    t = ie(l),
    ...
    [i, o] = Ee(Me),
    s = te(Fe),
    { data: c, isFetching: u } = E(),
    f = c === void 0 ? [] : c,
    p = ee(),
    m;
  e[0] === p ? (m = e[1]) : ((m = (e) => !oe(e, p)), (e[0] = p), (e[1] = m));
  let h = f.filter(m).map(rt),
    { data: _, isFetching: y } = se(D),
    { data: x, isFetching: C } = ae(be, {
      params: { dirs: (0, Z.default)(ut(h), nt).sort(tt) },
      source: `onboarding_workspace_select`,
    }),
    { data: T, isFetching: ne } = xe(),
    {
      autoLaunchAction: A,
      isRemoteHost: ce,
    ...
    le;
  e[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((le = []), (e[2] = le)) : (le = e[2]);
  let [ue, N] = (0, Q.useState)(le),
    P;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((P = {}), (e[3] = P)) : (P = e[3]);
  let [F, I] = (0, Q.useState)(P),
    [L, R] = (0, Q.useState)(!1),
    [de, z] = (0, Q.useState)(null),
    fe = (0, Q.useRef)(!1),
    pe;
  e[4] === r
    ? (pe = e[5])
  ...
  let me = pe,
    he = (0, Q.useRef)(0),
    B = _?.roots,
    ge = B != null && B.length > 0,
    _e = dt({ tasks: h, gitOrigins: x?.origins, codexHome: T?.codexHome }),
    ve = (0, Z.default)([...(B ?? []), ..._e, ...ue], et).sort($e),
    ye;
  e[6] === _?.labels
    ? (ye = e[7])
    : ((ye = (e) => {
  ...
  let V = ve.map(ye),
    H = V.map(Qe),
    U;
  e[8] === F ? (U = e[9]) : ((U = (e) => !!F[e]), (e[8] = F), (e[9] = U));
  let W = H.filter(U),
    Se =
      H.length > 0 && W.length === H.length
        ...
        : W.length > 0 && W.length < H.length
          ...
          : !1,
    G;
  (e[10] !== H || e[11] !== t || e[12] !== F || e[13] !== N || e[14] !== I || e[15] !== M
    ? ((G = (e) => {
      ...
      (e[16] = G))
    : (G = e[16]),
    k(`workspace-root-option-picked`, G));
  let Ce;
  (e[17] !== H.length ||
  e[18] !== t ||
  e[19] !== R ||
  ...
  e[24] !== M
    ? ((Ce = (e) => {
      ...
      (e[25] = Ce))
    : (Ce = e[25]),
    k(`electron-onboarding-skip-workspace-result`, Ce));
  let Te;
  e[26] !== ge || e[27] !== t || e[28] !== z || e[29] !== M
    ? ((Te = () => {
        (z(null),
          w(t, re, { hasExistingWorkspaces: ge, source: `onboarding_modal`, experimentArm: M }),
  ...
  let Ie = Pe,
    Le;
  e[46] !== H || e[47] !== t || e[48] !== F || e[49] !== I || e[50] !== z || e[51] !== M
    ? ((Le = (e) => {
        z(null);
        let n = { ...F };
  ...
  e[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Be = { queryKey: [O, `paths-exist`] }), (e[53] = Be))
    : (Be = e[53]);
  let Ve = g(Be),
    q = u || y || C || ne || Ve > 0,
    He = V.length > 0,
    ...
    Ke = (0, Q.useRef)(!1),
    J;
  e[54] !== je || e[55] !== q || e[56] !== A || e[57] !== j
    ? ((J = () => {
        fe.current ||
          q ||
          A !== `select_workspace_skip_to_playground` ||
          ((fe.current = !0), j(!0), je());
      }),
      (e[54] = je),
      (e[55] = q),
    ...
    : (J = e[58]);
  let qe;
  (e[59] !== q || e[60] !== A || e[61] !== j
    ? ((qe = [q, A, j]), (e[59] = q), (e[60] = A), (e[61] = j), (e[62] = qe))
    : (qe = e[62]),
    (0, Q.useEffect)(J, qe));
  let Je;
  e[63] !== n ||
  ...
  e[70] !== M
    ? ((Je = (e, r) => {
        ...
        let c = e;
        (s(Math.floor(Date.now() / 1e3)),
          i === `workspace` && B != null && (c = (0, Z.default)([...B, ...e], Ye)),
          a.dispatchMessage(`electron-update-workspace-root-options`, { roots: c }),
          o(`auto`),
          (he.current += 1),
          S.select(t, { path: e[0], projectId: e[0] }),
          n(`/`, { replace: !0, state: { focusComposerNonce: he.current } }));
      }),
      (e[63] = n),
      (e[64] = i),
      (e[65] = H.length),
...
function rt(e) {
  return { kind: `local`, key: ge(e.id), at: e.createdAt, conversation: e };
}
function Y(e) {
  let t = (0, X.c)(7),
...
function at(e) {
  ...
  t[1] !== n || t[2] !== r || t[3] !== s || t[4] !== c
    ? ((d = (0, $.jsx)(P, { className: n, color: r, size: s, onClick: c, children: l })),
      (t[1] = n),
      (t[2] = r),
      (t[3] = s),
      (t[4] = c),
...
function ot(e) {
  ...
  t[12] !== b
    ? ((S = r
        ? (0, $.jsxs)(Oe, {
            className: fe(n && `pointer-events-none opacity-50`),
  ...
  let C;
  t[14] !== x || t[15] !== S
    ? ((C = (0, $.jsxs)(`div`, { className: `flex w-full flex-col gap-2`, children: [x, S] })),
      (t[14] = x),
      (t[15] = S),
      (t[16] = C))
    : (C = t[16]);
  ...
  let D;
  t[25] !== w || t[26] !== E
    ? ((D = (0, $.jsxs)(`div`, { className: `flex w-full items-center gap-4`, children: [w, E] })),
      (t[25] = w),
      (t[26] = E),
      (t[27] = D))
    : (D = t[27]);
  ...
  let k;
  t[34] !== O || t[35] !== D
    ? ((k = (0, $.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [D, O] })),
      (t[34] = O),
      (t[35] = D),
      (t[36] = k))
    : (k = t[36]);
...
function ct(e) {
  let t = (0, X.c)(21),
    ...
    c = o.root,
    l;
  t[0] === c ? (l = t[1]) : ((l = Ce(c)), (t[0] = c), (t[1] = l));
  let u = l,
    d = G(c).replace(/\/+$/, ``),
    f,
    p;
  ...
  t[7] !== f || t[8] !== p || t[9] !== h
    ? ((g = { params: f, placeholderData: p, queryConfig: h }),
      ...
      (t[10] = g))
    : (g = t[10]);
  let { data: v } = F(`paths-exist`, g);
  if (!(a || (v?.existingPaths ?? []).some((e) => G(e).replace(/\/+$/, ``) === d))) return null;
