import { R as e, v as t } from "./app-scope.js";
    ...
    : ((_ = (e) => {
        ...
        if (c == null) {
          s({
            ...
            postInstallNewConversation: i?.postInstallNewConversation,
            plugin: a,
            requiredApps: o,
        ...
        s((t) => {
          ...
          return n == null
            ...
            : {
                ...
                postInstallNewConversation: t.postInstallNewConversation,
                plugin: t.plugin,
                app: n.app,
  ...
  return (
    ...
    e[22] !== v
      ? ((T = {
          ...
          openPluginInstall: f,
          openRequiredAppConnect: b,
          session: t,
          setPluginInstallNeedsApps: v,
        }),
        (e[14] = u),
        (e[15] = g),
        (e[16] = S),
