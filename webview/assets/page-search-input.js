...
import { Es as l, Ts as u } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
function d(e) {
  let t = (0, f.c)(30),
    {
      autoFocus: n,
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, p.jsx)(i, { className: `icon-sm text-token-text-secondary` })), (t[3] = w))
    : (w = t[3]);
  let T;
  t[4] !== r || t[5] !== l
    ? ((T = (0, p.jsx)(`label`, { className: `sr-only`, htmlFor: r, children: l })),
      (t[4] = r),
      (t[5] = l),
      (t[6] = T))
    : (T = t[6]);
