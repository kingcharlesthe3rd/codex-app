...
import { t as i } from "./x-circle.js";
import { s as a } from "./dropdown.js";
var o = t(),
  s = e();
function c(e) {
  let t = (0, o.c)(27),
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (0, s.jsx)(a, { className: `icon-sm text-token-text-secondary` })), (t[3] = C))
    : (C = t[3]);
  let w;
  t[4] !== l || t[5] !== f
    ? ((w = (0, s.jsx)(`label`, { className: `sr-only`, htmlFor: l, children: f })),
      (t[4] = l),
      (t[5] = f),
      (t[6] = w))
    : (w = t[6]);
    ...
    ? ((D =
        _.length > 0
          ? (0, s.jsx)(`button`, {
              ...
              children: (0, s.jsx)(i, { className: `icon-sm` }),
            })
          : null),
      (t[18] = b),
      (t[19] = h),
  ...
  let O;
  return (
    t[22] !== S || t[23] !== w || t[24] !== E || t[25] !== D
      ? ((O = (0, s.jsxs)(`div`, { className: S, children: [C, w, E, D] })),
        (t[22] = S),
        (t[23] = w),
        (t[24] = E),
        (t[25] = D),
