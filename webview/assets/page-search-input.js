...
import { t as a } from "./x-circle.js";
var o = t(),
  s = e();
function c(e) {
  let t = (0, o.c)(26),
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, s.jsx)(i, { className: `icon-sm text-token-text-secondary` })), (t[3] = S))
    : (S = t[3]);
  let C;
  t[4] !== l || t[5] !== f
    ? ((C = (0, s.jsx)(`label`, { className: `sr-only`, htmlFor: l, children: f })),
      (t[4] = l),
      (t[5] = f),
      (t[6] = C))
    : (C = t[6]);
    ...
    ? ((E =
        g.length > 0
          ? (0, s.jsx)(`button`, {
              ...
              children: (0, s.jsx)(a, { className: `icon-sm` }),
            })
          : null),
      (t[17] = y),
      (t[18] = m),
  ...
  let D;
  return (
    t[21] !== x || t[22] !== C || t[23] !== T || t[24] !== E
      ? ((D = (0, s.jsxs)(`div`, { className: x, children: [S, C, T, E] })),
        (t[21] = x),
        (t[22] = C),
        (t[23] = T),
        (t[24] = E),
