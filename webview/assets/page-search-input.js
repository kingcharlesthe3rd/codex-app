...
import { vc as l, yc as u } from "./app-initial~app-main~onboarding-page~profile.js";
function d(e) {
  let n = (0, f.c)(30),
    {
      autoFocus: r,
  ...
  n[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, p.jsx)(i, { className: `icon-sm text-token-text-secondary` })), (n[3] = w))
    : (w = n[3]);
  let T;
  n[4] !== a || n[5] !== u
    ? ((T = (0, p.jsx)(`label`, { className: `sr-only`, htmlFor: a, children: u })),
      (n[4] = a),
      (n[5] = u),
      (n[6] = T))
    : (T = n[6]);
    ...
    ? ((O =
        _.length > 0
          ? (0, p.jsx)(`button`, {
              ...
              children: (0, p.jsx)(l, { className: `icon-sm` }),
            })
          : null),
      (n[18] = x),
      (n[19] = h),
  ...
  let A;
  return (
    n[24] !== C || n[25] !== T || n[26] !== D || n[27] !== O || n[28] !== k
