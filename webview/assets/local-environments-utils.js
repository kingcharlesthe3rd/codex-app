...
import { n as d, t as f } from "./play-outline.js";
var p,
  m,
  h = e(() => {
    (t(n()),
...
function g(e) {
  ...
  return (
    t[0] !== i || t[1] !== a
      ? ((o = (0, v.jsx)(i, { className: a })), (t[0] = i), (t[1] = a), (t[2] = o))
      : (o = t[2]),
    o
  );
}
var _,
  ...
  y,
  b = e(() => {
    ((_ = r()), l(), h(), d(), o(), (v = i()), (y = { tool: a, run: f, debug: u, test: m }));
  }),
  x,
  S = e(() => {
    (s(),
...
function w(e) {
  return e.length > 0 ? e.map((e) => ({ ...e, id: k(), platform: e.platform ?? null })) : [];
}
function T(e) {
  return {
