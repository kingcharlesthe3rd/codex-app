...
rm -rf .cache/tmp`;
function v(e) {
  return { id: w(), name: e, icon: `tool`, command: ``, platform: null };
}
function y(e) {
  return e.length > 0 ? e.map((e) => ({ ...e, id: w(), platform: e.platform ?? null })) : [];
}
function b(e) {
  return {
...
function x({
  ...
  for (let e of s)
    (c.push(`[[actions]]`),
      c.push(`name = ${D(e.name)}`),
      e.icon && c.push(`icon = ${D(e.icon)}`),
      c.push(`command = ${D(e.command)}`),
      e.platform && c.push(`platform = ${D(e.platform)}`),
      c.push(``));
  return `${c
    .join(`
`)
...
function T(e, t, n, r) {
  ...
  if (
    ((t === `setup` || n.length > 0 || i.length > 0) &&
      (e.push(``), e.push(`[${t}]`), e.push(`script = ${D(n)}`)),
    i.length !== 0)
  ) {
    e.push(``);
    for (let [n, r] of i.entries())
      (e.push(`[${t}.${r.platform}]`),
        e.push(`script = ${D(r.script)}`),
        n < i.length - 1 && e.push(``));
  }
}
function E(e) {
...
export { x as a, b as c, f as d, h as i, S as l, _ as n, v as o, m as r, y as s, g as t, p as u };
