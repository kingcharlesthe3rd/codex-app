...
function C(e, t) {
  ...
  return (
    (t ??= ge),
    !!t && (n == `number` || (n != `symbol` && _e.test(e))) && e > -1 && e % 1 == 0 && e < t
  );
}
function w(e, t) {
  return e === t || (e !== e && t !== t);
...
function ot(e, t) {
  var n = this.__data__;
  return ((this.size += this.has(e) ? 0 : 1), (n[e] = W && t === void 0 ? at : t), this);
}
function G(e) {
  var t = -1,
    n = e == null ? 0 : e.length;
...
function lt(e) {
  var t = this.__data__,
    n = K(t, e);
  return n < 0 ? !1 : (n == t.length - 1 ? t.pop() : ct.call(t, n, 1), --this.size, !0);
}
function ut(e) {
  var t = this.__data__,
    n = K(t, e);
...
var J = S(n, `Map`);
function pt() {
  ((this.size = 0), (this.__data__ = { hash: new G(), map: new (J || q)(), string: new G() }));
}
function mt(e) {
  var t = typeof e;
...
function Z(e, t) {
  if (typeof e != `function` || (t != null && typeof t != `function`)) throw TypeError(yt);
  var n = function () {
    var r = arguments,
...
function wt(e, t) {
  ...
  if (n instanceof q) {
    var r = n.__data__;
    if (!J || r.length < Ct - 1) return (r.push([e, t]), (this.size = ++n.size), this);
