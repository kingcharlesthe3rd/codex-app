...
function o(e, n, r) {
  let o = i();
  (n === void 0 ? t.delete(e) : t.set(e, n), r && o(e, n), a(e));
}
function s(e, n) {
  let i = new Set([...t.keys(), ...Object.keys(e)]);
  (t.clear(),
...
function c() {
  return {
    getItem: (e, n) => (i(), t.has(e) ? t.get(e) : n),
    setItem: (e, t) => {
      if ((i(), t === void 0)) {
        o(e, void 0, !0);
        return;
    ...
    subscribe: (e, t, r) => {
      ...
      return (
        ...
        () => {
          let t = n.get(e);
          t && (t.delete(a), t.size === 0 && n.delete(e));
        }
      );
    },
  };
...
function p() {
  ...
  t.clear();
  let n = r;
  (n && e.forEach((e) => n(e, void 0)), e.forEach((e) => a(e)), h());
}
function m(e) {
...
export { l as a, p as c, c as i, u as l, f as n, s as o, h as r, m as s, e as t, d as u };
//# sourceMappingURL=persisted-atom-store.js.map
