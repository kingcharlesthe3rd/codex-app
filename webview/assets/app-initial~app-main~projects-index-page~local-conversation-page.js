...
import { Gd as xe, Wd as Se } from "./app-initial~app-main~onboarding-page~profile.js";
import {
  an as Ce,
  in as we,
  nn as Te,
...
var je,
  Me = e(() => {
    (I(), (je = x(`remote-host-globe-color-by-host-id`, void 0)));
  });
function Ne(e, { forbiddenHueRanges: t = [] } = {}) {
...
var Ie = e(() => {});
function Le({ chroma: e, hue: t }) {
  let n = (t * Math.PI) / 180,
    r = e * Math.cos(n),
    i = e * Math.sin(n),
    a = B + 0.3963377774 * r + 0.2158037573 * i,
    o = B - 0.1055613458 * r - 0.0638541728 * i,
    s = B - 0.0894841775 * r - 1.291485548 * i,
    c = a ** 3,
    l = o ** 3,
    u = s ** 3;
  return `#${[4.0767416621 * c - 3.3077115913 * l + 0.2309699292 * u, -1.2684380046 * c + 2.6097574011 * l - 0.3413193965 * u, -0.0041960863 * c - 0.7034186147 * l + 1.707614701 * u].map(Be).join(``)}`;
}
function Re({ hostCount: e, hostIndex: t }) {
  return e <= 1 ? (V + H) / 2 : V + ((H - V) / (e - 1)) * t;
}
function ze(e, t) {
  let n = Ne(e, { forbiddenHueRanges: Ve }),
    r = Object.keys(n).sort((e, t) => e.localeCompare(t));
  return Object.fromEntries(
    r.map((e, i) => [
      e,
      t?.[e] ?? Le({ chroma: Re({ hostCount: r.length, hostIndex: i }), hue: n[e] }),
    ]),
  );
}
function Be(e) {
...
function Ue(e) {
  ...
  let s = o,
    c;
  t[3] !== a || t[4] !== s ? ((c = ze(s, a)), (t[3] = a), (t[4] = s), (t[5] = c)) : (c = t[5]);
  let l = c[r],
    u;
  ...
  return (
    t[8] !== n || t[9] !== u
      ? ((d = (0, Ge.jsx)(ie, { className: n, style: u })), (t[8] = n), (t[9] = u), (t[10] = d))
      : (d = t[10]),
    d
  );
}
...
function Ze(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, G.jsx)(o, { className: `icon-2xs block shrink-0` })), (t[4] = o), (t[5] = c));
  let l;
  return (
    t[6] !== r || t[7] !== s || t[8] !== c
      ? ((l = (0, G.jsx)(`button`, {
...
var tt = e(() => {});
function nt(e, { canLogin: t, error: n, hostKind: r, state: i, surface: a }) {
  let o = e.formatMessage(rt(i, n));
  if (i === `error` && n != null) {
    let i = et(e, n);
    switch (n.code) {
      case `login-required`:
      ...
      case `update-required`:
        return r === `wsl`
          ...
          : a === `connections-row`
            ...
            : {
                action: { kind: `settings`, label: e.formatMessage(K.goToSettings) },
                label: o,
                message: i,
              };
      case `connection-failed`:
...
function dt(e, t = []) {
  let n = [],
    ...
    i = (t) => {
      let i = mt(t);
      i === `` || i === pt(e.label) || r.has(i) || (r.add(i), n.push(t));
    };
  if (
...
function pt(e) {
  return S(e).trim().toLocaleLowerCase();
}
function mt(e) {
  return e.kind === `path` ? e.value.trim().toLocaleLowerCase() : pt(e.value);
}
var ht = e(() => {
  ge();
});
...
async function vt(e, t, n) {
  let r = l(e.get, O.PINNED_PROJECT_IDS);
  await d(e, O.PINNED_PROJECT_IDS, n ? gt(r, t) : r?.filter((e) => e !== t));
}
function yt(e, t) {
...
function xt(e) {
  let t = (0, X.c)(44),
    ...
    s = fe(`open-file`),
    c = ae(),
    { data: l, isFetched: d, isLoadingError: p } = b(O.PROJECT_WRITABLE_ROOTS),
    { data: m } = b(O.PINNED_PROJECT_IDS),
    g;
  t[0] !== n.projectId || t[1] !== m
    ? ((g = m?.includes(n.projectId)), (t[0] = n.projectId), (t[1] = m), (t[2] = g))
    : (g = t[2]);
  let _ = !!g,
    v = c.map(Ct),
    y = ee(re, n.threadKeys),
    x = ne({ projectId: n.projectId, projectWritableRoots: h(l), legacyRoot: n.path ?? null }),
    S = d && !p && n.projectKind === `local` && (n.isLocalProject === !0 || n.path != null),
    C = dt(n, x).map((e) => {
      let t = e.kind === `path` && n.projectKind === `local`,
        r = e.kind === `path` ? ft(e.value) : e.value;
      return {
        actionLabel: t
          ? o.formatMessage(
              {
        ...
        onClick: t
          ? () => {
              Ae({ path: e.value, cwd: u(e.value), target: `fileManager`, openFile: s.mutate });
            }
          : void 0,
        value: r,
      };
  ...
  t[3] === n.projectKind
    ...
    : ((w =
        n.projectKind === `remote`
          ...
          : (0, Q.jsx)(_e, { className: `icon-xs shrink-0` })),
      (t[3] = n.projectKind),
      (t[4] = w));
  let T;
  t[5] !== n.label || t[6] !== n.projectId || t[7] !== w
    ? ((T = (0, Q.jsx)(de, {
  ...
  t[9] === n
    ...
    : ((E = (0, Q.jsx)(`span`, {
        ...
        children: (0, Q.jsx)(Dt, { group: n }),
      })),
      (t[9] = n),
      (t[10] = E));
  let D;
  t[11] !== o || t[12] !== _
    ? ((D = o.formatMessage(_ ? $.unpinProject : $.pinProject)),
      (t[11] = o),
      (t[12] = _),
      (t[13] = D))
    : (D = t[13]);
  ...
  t[14] !== n.projectId || t[15] !== a
    ...
    : ((k = t[16]), (A = t[17]));
  let j;
  t[18] !== _ || t[19] !== D || t[20] !== k || t[21] !== A
    ? ((j = (0, Q.jsx)(Ze, { ariaLabel: D, isPinned: _, onPin: k, onUnpin: A })),
      (t[18] = _),
      (t[19] = D),
      (t[20] = k),
      (t[21] = A),
  ...
  let M;
  t[23] !== j || t[24] !== E
    ? ((M = (0, Q.jsxs)(`div`, { className: `flex min-w-0 items-center gap-2`, children: [E, j] })),
      (t[23] = j),
      (t[24] = E),
      (t[25] = M))
    : (M = t[25]);
  let N;
  t[26] !== M || t[27] !== T
    ? ((N = (0, Q.jsx)(Y, { align: `center`, icon: T, children: M })),
      (t[26] = M),
      (t[27] = T),
      (t[28] = N))
    : (N = t[28]);
  let P;
  t[29] !== y || t[30] !== n.threadKeys.length || t[31] !== i
    ? ((P = (0, Q.jsx)(Tt, {
  ...
  let F;
  t[33] !== N || t[34] !== P
    ? ((F = (0, Q.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [N, P] })),
      (t[33] = N),
      (t[34] = P),
      (t[35] = F))
    : (F = t[35]);
  let I =
      C.length > 0
        ...
        : null,
    L;
  t[36] !== S || t[37] !== n || t[38] !== x
    ? ((L = S
        ? (0, Q.jsx)(`div`, {
            className: `flex min-w-0 flex-col gap-1 border-t border-token-border pt-1.5`,
            children: (0, Q.jsx)(kt, { group: n, initialSources: x }),
          })
        : null),
      (t[36] = S),
      (t[37] = n),
...
function St(e) {
  return (0, Q.jsxs)(
    Z.Fragment,
    {
      children: [
        (0, Q.jsx)(At, { row: e }),
        e.kind === `host` && e.hostId != null ? (0, Q.jsx)(wt, { hostId: e.hostId }) : null,
      ],
    },
    e.id,
  );
...
function wt(e) {
  let t = (0, X.c)(13),
    { hostId: n } = e,
    r = z(),
    { error: i, state: a } = Ce(n),
    o = m(n),
    c = a ?? `disconnected`,
    l;
  t[0] !== c || t[1] !== i || t[2] !== o.kind || t[3] !== r
    ? ((l = nt(r, {
        canLogin: !1,
        error: i,
        hostKind: o.kind,
  ...
  let { label: u, message: d } = l,
    ...
    h;
  t[5] === p ? (h = t[6]) : ((h = s(`block size-2 rounded-full`, p)), (t[5] = p), (t[6] = h));
  let g;
  t[7] === h ? (g = t[8]) : ((g = (0, Q.jsx)(`span`, { className: h })), (t[7] = h), (t[8] = g));
  let _ = f ? d : u,
    v;
  return (
    t[9] !== f || t[10] !== g || t[11] !== _
      ? ((v = (0, Q.jsx)(J, { icon: g, allowWrap: f, label: _ })),
        (t[9] = f),
        (t[10] = g),
        (t[11] = _),
        (t[12] = v))
...
function Tt(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== a || t[3] !== i) {
    ...
    bb0: {
      let e = Mt({ attentionCounts: n, chatCount: r, intl: a });
      if (!i) {
        let n;
        t[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((n = (0, Q.jsx)(be, { className: `icon-xs` })), (t[5] = n))
          : (n = t[5]);
        let r = (0, Q.jsx)(`span`, {
        ...
        (t[6] === r
          ? (i = t[7])
          : ((i = (0, Q.jsx)(Y, { icon: n, children: r })), (t[6] = r), (t[7] = i)),
          (o = i));
        break bb0;
      }
    }
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(be, { className: `icon-xs` })), (t[8] = s))
    : (s = t[8]);
  let c;
  t[9] !== r || t[10] !== a
    ? ((c = a.formatMessage($.chatCount, { count: r })), (t[9] = r), (t[10] = a), (t[11] = c))
    : (c = t[11]);
  let l;
  t[12] === c
    ? (l = t[13])
  ...
  t[14] !== n.waiting || t[15] !== a
    ? ((u =
        n.waiting > 0
          ? (0, Q.jsx)(J, {
              icon: (0, Q.jsx)(Ee, { className: `icon-xs` }),
  ...
  t[17] !== n.unread || t[18] !== a
    ? ((d =
        n.unread > 0
          ? (0, Q.jsx)(J, {
              icon: (0, Q.jsx)(`span`, { className: `h-3 w-3 rounded-full bg-token-charts-blue` }),
  ...
  t[20] !== n.active || t[21] !== a
    ? ((f =
        n.active > 0
          ? (0, Q.jsx)(J, {
              icon: (0, Q.jsx)(L, { className: `icon-xs` }),
      ...
      children: [
        t === 0
          ...
          : (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(ue, { ...$.statusSeparator }),
            }),
        e,
      ],
    },
...
function J(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = s(`min-w-0 text-sm leading-5 text-token-foreground`, a)), (t[0] = a), (t[1] = o));
  let c;
  t[2] !== i || t[3] !== o
    ? ((c = (0, Q.jsx)(`span`, { className: o, children: i })), (t[2] = i), (t[3] = o), (t[4] = c))
    : (c = t[4]);
  let l;
  return (
    t[5] !== r || t[6] !== c
      ? ((l = (0, Q.jsx)(Y, { icon: r, children: c })), (t[5] = r), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
function Dt(e) {
  let t = (0, X.c)(22),
    ...
    i = z(),
    a = ve(),
    { data: o } = b(O.LOCAL_PROJECTS),
    { data: s } = b(O.REMOTE_PROJECTS),
    [c, l] = (0, Z.useState)(!1),
    [u, p] = (0, Z.useState)(n.label),
    m = n.projectKind === `remote` || n.isLocalProject === !0 || n.path != null,
    h;
        ...
        (async () => {
          try {
            ...
            await P.rename({
              ...
              now: Date.now(),
              project: n,
              setGlobalSetting: (e, t) => d(r, e, t),
              updateWorkspaceRootLabel: (e, t) => {
                he({ label: t, path: e, queryClient: a });
              },
            });
          } catch {
            r.get(pe).danger(i.formatMessage($.renameError));
          }
        })();
      }),
      (t[0] = n),
  ...
  if (c) {
    ...
    t[7] === g
      ? (e = t[8])
      : ((e = (e) => {
          e.currentTarget.dataset.cancelRename !== `true` && g(e.currentTarget.value);
        }),
        (t[7] = g),
        (t[8] = e));
    let r;
...
function kt(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(D, { className: `icon-xs` })), (t[2] = s))
    : (s = t[2]);
  let c;
  t[3] !== n || t[4] !== r || t[5] !== i
    ? ((c = () => {
        se(i, { initialName: n.label, initialSources: r, project: n, showDeleteAction: !0 });
      }),
      (t[3] = n),
      (t[4] = r),
      (t[5] = i),
...
function At(e) {
  ...
  t[0] === o
    ? (c = t[1])
    : ((c = s(`min-w-0 flex-1 text-token-foreground`, o)), (t[0] = o), (t[1] = c));
  let l;
  t[2] !== n.value || t[3] !== c
    ? ((l = (0, Q.jsx)(`span`, {
  ...
  let u;
  return (
    t[5] !== n.actionLabel || t[6] !== n.icon || t[7] !== n.onClick || t[8] !== l
      ? ((u = (0, Q.jsx)(Y, { actionLabel: r, icon: i, onClick: a, children: l })),
        (t[5] = n.actionLabel),
        (t[6] = n.icon),
        (t[7] = n.onClick),
        (t[8] = l),
      ...
      children: [
        ...
        o
          ? (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(Se, { className: `icon-2xs`, "aria-hidden": !0 }),
            })
          : null,
      ],
    });
  ...
  switch (e.kind) {
    case `host`:
      return e.hostId == null
        ? (0, Q.jsx)(ie, {})
        : (0, Q.jsx)(Ue, { hostId: e.hostId, hostIdsForColorAssignment: t });
    case `path`:
      return (0, Q.jsx)(lt, {});
    case `repository`:
      return (0, Q.jsx)(ot, {});
...
function Mt({ attentionCounts: e, chatCount: t, intl: n }) {
  return [
    n.formatMessage($.chatCount, { count: t }),
    e.waiting > 0 ? n.formatMessage($.waitingCount, { count: e.waiting }) : null,
...
//# sourceMappingURL=app-initial~app-main~projects-index-page~local-conversation-page.js.map
