...
import { bg as O, xg as k } from "./app-initial~app-main~onboarding-page.js";
import {
  Sx as A,
  nx as j,
  rx as M,
...
function Fe(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, U.jsx)(o, { className: `icon-2xs block shrink-0` })), (t[4] = o), (t[5] = c));
  let l;
  return (
    t[6] !== r || t[7] !== s || t[8] !== c
      ? ((l = (0, U.jsx)(`button`, {
...
function Ve(e, t = []) {
  let n = [],
    ...
    i = (t) => {
      let i = We(t);
      i === `` || i === Ue(e.label) || r.has(i) || (r.add(i), n.push(t));
    };
  if (
...
function Ue(e) {
  return v(e).trim().toLocaleLowerCase();
}
function We(e) {
  return e.kind === `path` ? e.value.trim().toLocaleLowerCase() : Ue(e.value);
}
var Ge = e(() => {
  S();
});
...
async function q(e, t, n) {
  let r = s(e.get, a.PINNED_PROJECT_IDS);
  await o(e, a.PINNED_PROJECT_IDS, n ? Ke(r, t) : r?.filter((e) => e !== t));
}
function Je(e, t) {
...
function Xe(e) {
  let t = (0, X.c)(44),
    ...
    u = l(`open-file`),
    d = p(),
    { data: f, isFetched: m, isLoadingError: h } = E(a.PROJECT_WRITABLE_ROOTS),
    { data: g } = E(a.PINNED_PROJECT_IDS),
    _;
  t[0] !== n.projectId || t[1] !== g
    ? ((_ = g?.includes(n.projectId)), (t[0] = n.projectId), (t[1] = g), (t[2] = _))
    : (_ = t[2]);
  let v = !!_,
    y = d.map(Qe),
    b = te(oe, n.threadKeys),
    x = ne({ projectId: n.projectId, projectWritableRoots: re(f), legacyRoot: n.path ?? null }),
    S = m && !h && n.projectKind === `local` && (n.isLocalProject === !0 || n.path != null),
    w = Ve(n, x).map((e) => {
      let t = e.kind === `path` && n.projectKind === `local`,
        r = e.kind === `path` ? He(e.value) : e.value;
      return {
        actionLabel: t
          ? s.formatMessage(
              {
        ...
        onClick: t
          ? () => {
              he({ path: e.value, cwd: ee(e.value), target: `fileManager`, openFile: u.mutate });
            }
          : void 0,
        value: r,
      };
  ...
  t[3] === n.projectKind
    ...
    : ((T =
        n.projectKind === `remote`
          ? (0, Q.jsx)(Ae, { className: `icon-xs shrink-0` })
          : (0, Q.jsx)(ue, { className: `icon-xs shrink-0` })),
      (t[3] = n.projectKind),
      (t[4] = T));
  let D;
  t[5] !== n.label || t[6] !== n.projectId || t[7] !== T
    ? ((D = (0, Q.jsx)(ie, {
  ...
  t[9] === n
    ...
    : ((O = (0, Q.jsx)(`span`, {
        ...
        children: (0, Q.jsx)(nt, { group: n }),
      })),
      (t[9] = n),
      (t[10] = O));
  let k;
  t[11] !== s || t[12] !== v
    ? ((k = s.formatMessage(v ? $.unpinProject : $.pinProject)),
      (t[11] = s),
      (t[12] = v),
      (t[13] = k))
    : (k = t[13]);
  let A, j;
  t[14] !== n.projectId || t[15] !== o
    ? ((A = () => {
        q(o, n.projectId, !0);
      }),
      (j = () => {
    ...
    : ((A = t[16]), (j = t[17]));
  let M;
  t[18] !== v || t[19] !== k || t[20] !== A || t[21] !== j
    ? ((M = (0, Q.jsx)(Fe, { ariaLabel: k, isPinned: v, onPin: A, onUnpin: j })),
      (t[18] = v),
      (t[19] = k),
      (t[20] = A),
      (t[21] = j),
  ...
  let N;
  t[23] !== M || t[24] !== O
    ? ((N = (0, Q.jsxs)(`div`, { className: `flex min-w-0 items-center gap-2`, children: [O, M] })),
      (t[23] = M),
      (t[24] = O),
      (t[25] = N))
    : (N = t[25]);
  let F;
  t[26] !== N || t[27] !== D
    ? ((F = (0, Q.jsx)(Y, { align: `center`, icon: D, children: N })),
      (t[26] = N),
      (t[27] = D),
      (t[28] = F))
    : (F = t[28]);
  let I;
  t[29] !== b || t[30] !== n.threadKeys.length || t[31] !== i
    ? ((I = (0, Q.jsx)(et, {
  ...
  let L;
  t[33] !== F || t[34] !== I
    ? ((L = (0, Q.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [F, I] })),
      (t[33] = F),
      (t[34] = I),
      (t[35] = L))
    : (L = t[35]);
  ...
  t[36] !== S || t[37] !== n || t[38] !== x
    ? ((z = S
        ? (0, Q.jsx)(`div`, {
            className: `flex min-w-0 flex-col gap-1 border-t border-token-border pt-1.5`,
            children: (0, Q.jsx)(it, { group: n, initialSources: x }),
          })
        : null),
      (t[36] = S),
      (t[37] = n),
...
function Ze(e) {
  return (0, Q.jsxs)(
    Z.Fragment,
    {
      children: [
        (0, Q.jsx)(at, { row: e }),
        e.kind === `host` && e.hostId != null ? (0, Q.jsx)($e, { hostId: e.hostId }) : null,
      ],
    },
    e.id,
  );
...
function $e(e) {
  ...
  let { label: u, message: d } = l,
    ...
    m;
  t[5] === p ? (m = t[6]) : ((m = j(`block size-2 rounded-full`, p)), (t[5] = p), (t[6] = m));
  let h;
  t[7] === m ? (h = t[8]) : ((h = (0, Q.jsx)(`span`, { className: m })), (t[7] = m), (t[8] = h));
  let g = f ? d : u,
    _;
  return (
    t[9] !== f || t[10] !== h || t[11] !== g
...
function et(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== a || t[3] !== i) {
    ...
    bb0: {
      let e = st({ attentionCounts: n, chatCount: r, intl: a });
      if (!i) {
        let n;
        t[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((n = (0, Q.jsx)(ve, { className: `icon-xs` })), (t[5] = n))
          : (n = t[5]);
        let r = (0, Q.jsx)(`span`, {
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(ve, { className: `icon-xs` })), (t[8] = s))
    : (s = t[8]);
  let c;
  t[9] !== r || t[10] !== a
  ...
  t[14] !== n.waiting || t[15] !== a
    ? ((u =
        n.waiting > 0
          ? (0, Q.jsx)(J, {
              icon: (0, Q.jsx)(be, { className: `icon-xs` }),
  ...
  t[20] !== n.active || t[21] !== a
    ? ((f =
        n.active > 0
          ? (0, Q.jsx)(J, {
              icon: (0, Q.jsx)(de, { className: `icon-xs` }),
      ...
      children: [
        t === 0
          ...
          : (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(A, { ...$.statusSeparator }),
            }),
        e,
      ],
    },
...
function J(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = j(`min-w-0 text-sm leading-5 text-token-foreground`, a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] !== i || t[3] !== o
    ? ((s = (0, Q.jsx)(`span`, { className: o, children: i })), (t[2] = i), (t[3] = o), (t[4] = s))
    : (s = t[4]);
  let c;
  return (
    t[5] !== r || t[6] !== s
      ? ((c = (0, Q.jsx)(Y, { icon: r, children: s })), (t[5] = r), (t[6] = s), (t[7] = c))
      : (c = t[7]),
    c
  );
}
function nt(e) {
  let t = (0, X.c)(22),
    ...
    i = P(),
    s = g(),
    { data: l } = E(a.LOCAL_PROJECTS),
    { data: u } = E(a.REMOTE_PROJECTS),
    [d, f] = (0, Z.useState)(!1),
    [p, m] = (0, Z.useState)(n.label),
    h = n.projectKind === `remote` || n.isLocalProject === !0 || n.path != null,
    _;
  t[0] !== n || t[1] !== i || t[2] !== l || t[3] !== s || t[4] !== u || t[5] !== r
    ? ((_ = (e) => {
        let t = e.trim();
        if ((f(!1), t.length === 0 || t === n.label)) {
          m(n.label);
          return;
        }
        (async () => {
          try {
            if (n.projectKind === `remote`) {
              await o(
                r,
                a.REMOTE_PROJECTS,
                (u ?? []).map((e) => (e.id === n.projectId ? { ...e, label: t } : e)),
              );
              return;
            }
            await x.rename({
              ...
              now: Date.now(),
              project: n,
              setGlobalSetting: (e, t) => o(r, e, t),
              updateWorkspaceRootLabel: (e, t) => {
                ae({ label: t, path: e, queryClient: s });
              },
            });
          } catch {
            r.get(me).danger(i.formatMessage($.renameError));
          }
        })();
      }),
      (t[0] = n),
  ...
  if (d) {
    ...
    t[7] === v
      ? (e = t[8])
      : ((e = (e) => {
          e.currentTarget.dataset.cancelRename !== `true` && v(e.currentTarget.value);
        }),
        (t[7] = v),
        (t[8] = e));
    let r;
...
function it(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(Se, { className: `icon-xs` })), (t[2] = s))
    : (s = t[2]);
  let l;
  t[3] !== n || t[4] !== r || t[5] !== i
    ? ((l = () => {
...
function at(e) {
  ...
  t[0] === o
    ? (s = t[1])
    : ((s = j(`min-w-0 flex-1 text-token-foreground`, o)), (t[0] = o), (t[1] = s));
  let c;
  t[2] !== n.value || t[3] !== s
    ? ((c = (0, Q.jsx)(`span`, {
  ...
  return (
    t[5] !== n.actionLabel || t[6] !== n.icon || t[7] !== n.onClick || t[8] !== c
      ? ((l = (0, Q.jsx)(Y, { actionLabel: r, icon: i, onClick: a, children: c })),
        (t[5] = n.actionLabel),
        (t[6] = n.icon),
        (t[7] = n.onClick),
        (t[8] = c),
      ...
      children: [
        ...
        o
          ? (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(O, { className: `icon-2xs`, "aria-hidden": !0 }),
            })
          : null,
      ],
    });
  ...
  switch (e.kind) {
    case `host`:
      return e.hostId == null
        ? (0, Q.jsx)(z, {})
        : (0, Q.jsx)(De, { hostId: e.hostId, hostIdsForColorAssignment: t });
    case `path`:
      return (0, Q.jsx)(K, {});
    case `repository`:
      return (0, Q.jsx)(Re, {});
...
function st({ attentionCounts: e, chatCount: t, intl: n }) {
  return [
