...
import { Xd as Ce, Zd as we } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
var H,
  Te,
  Ee = e(() => {
    (t(u()),
...
function Fe(e, t) {
  ...
  return Object.fromEntries(
    r.map((e, i) => [
      e,
      t?.[e] ?? Ne({ chroma: Pe({ hostCount: r.length, hostIndex: i }), hue: n[e] }),
    ]),
  );
}
function Ie(e) {
...
function Be(e) {
  ...
  let s = o,
    c;
  t[3] !== a || t[4] !== s ? ((c = Fe(s, a)), (t[3] = a), (t[4] = s), (t[5] = c)) : (c = t[5]);
  let l = c[r],
    u;
  ...
  return (
    t[8] !== n || t[9] !== u
      ? ((d = (0, He.jsx)(j, { className: n, style: u })), (t[8] = n), (t[9] = u), (t[10] = d))
      : (d = t[10]),
    d
  );
}
...
function Qe(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, et.jsx)(o, { className: `icon-2xs block shrink-0` })), (t[4] = o), (t[5] = c));
  let l;
  return (
    t[6] !== r || t[7] !== s || t[8] !== c
      ? ((l = (0, et.jsx)(`button`, {
...
function Ct(e) {
  ...
  t[0] !== n.projectId || t[1] !== b
    ? ((x = b?.includes(n.projectId)), (t[0] = n.projectId), (t[1] = b), (t[2] = x))
    : (x = t[2]);
  let S = !!x,
    te = f.map(Tt),
    C = o(oe, n.threadKeys),
    w = h({ projectId: n.projectId, projectWritableRoots: _(p), legacyRoot: n.path ?? null }),
    T = m && !g && n.projectKind === `local` && (n.isLocalProject === !0 || n.path != null),
    ne = pt(n, w).map((e) => {
      ...
      return {
        ...
        onClick: t
          ? () => {
              ee({ path: e.value, cwd: v(e.value), target: `fileManager`, openFile: d.mutate });
            }
          : void 0,
        value: r,
      };
  ...
  t[18] !== S || t[19] !== k || t[20] !== A || t[21] !== j
    ? ((M = (0, Q.jsx)(Qe, { ariaLabel: k, isPinned: S, onPin: A, onUnpin: j })),
      (t[18] = S),
      (t[19] = k),
      (t[20] = A),
      (t[21] = j),
  ...
  let I;
  t[33] !== P || t[34] !== F
    ? ((I = (0, Q.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [P, F] })),
      (t[33] = P),
      (t[34] = F),
      (t[35] = I))
    : (I = t[35]);
...
function wt(e) {
  return (0, Q.jsxs)(
    Z.Fragment,
    {
      children: [
        (0, Q.jsx)(Mt, { row: e }),
        e.kind === `host` && e.hostId != null ? (0, Q.jsx)(Et, { hostId: e.hostId }) : null,
      ],
    },
    e.id,
  );
...
function Et(e) {
  ...
  let { label: l, message: u } = c,
    ...
    p;
  t[5] === f ? (p = t[6]) : ((p = F(`block size-2 rounded-full`, f)), (t[5] = f), (t[6] = p));
  let m;
  t[7] === p ? (m = t[8]) : ((m = (0, Q.jsx)(`span`, { className: p })), (t[7] = p), (t[8] = m));
  let h = d ? u : l,
    g;
  return (
    t[9] !== d || t[10] !== m || t[11] !== h
...
function J(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = F(`min-w-0 text-sm leading-5 text-token-foreground`, a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] !== i || t[3] !== o
...
function kt(e) {
  let t = (0, X.c)(22),
    ...
    _;
  t[0] !== n || t[1] !== o || t[2] !== l || t[3] !== c || t[4] !== u || t[5] !== r
    ? ((_ = (e) => {
        let t = e.trim();
...
function jt(e) {
  ...
  t[3] !== n || t[4] !== r || t[5] !== a
    ? ((u = () => {
        O(a, { initialName: n.label, initialSources: r, project: n, showDeleteAction: !0 });
      }),
      (t[3] = n),
      (t[4] = r),
      (t[5] = a),
...
function Mt(e) {
  ...
  t[0] === o
    ? (s = t[1])
    : ((s = F(`min-w-0 flex-1 text-token-foreground`, o)), (t[0] = o), (t[1] = s));
  let c;
  t[2] !== n.value || t[3] !== s
    ? ((c = (0, Q.jsx)(`span`, {
      ...
      children: [
        ...
        o
          ? (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(Ce, { className: `icon-2xs`, "aria-hidden": !0 }),
            })
          : null,
      ],
    });
