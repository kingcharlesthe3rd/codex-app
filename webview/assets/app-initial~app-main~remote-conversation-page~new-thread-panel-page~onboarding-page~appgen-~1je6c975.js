...
var Ke,
  ...
  lt = e(() => {
    (f(),
      ...
      (k = !0));
    try {
      k = Be(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`).exec(`a`)?.[0] === `a`;
    } catch {
      k = !1;
    }
    ((tt = Je
        ...
        return (
          ...
          (e.prototype.parseMessage = function (e, t, n) {
            for (var r = []; !this.isEOF(); ) {
              ...
              if (i === 123) {
                ...
                (this.bump(), r.push({ type: w.pound, location: O(o, this.clonePosition()) }));
          ...
          (e.prototype.parseTag = function (e, t) {
            ...
            if ((this.bumpSpace(), this.bumpIf(`/>`)))
              return {
                val: { type: w.literal, value: `<${r}/>`, location: O(n, this.clonePosition()) },
                err: null,
              };
            if (this.bumpIf(`>`)) {
              ...
              if (this.bumpIf(`</`)) {
                ...
                return r === this.parseTagName()
                  ...
                  : this.error(C.UNMATCHED_CLOSING_TAG, O(s, this.clonePosition()));
          ...
          (e.prototype.parseLiteral = function (e, t) {
            ...
            return { val: { type: w.literal, value: r, location: s }, err: null };
          }),
          ...
          (e.prototype.parseArgument = function (e, t) {
            ...
            if ((this.bump(), this.bumpSpace(), this.isEOF()))
              return this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE, O(n, this.clonePosition()));
            if (this.char() === 125)
              return (this.bump(), this.error(C.EMPTY_ARGUMENT, O(n, this.clonePosition())));
            ...
            switch (this.char()) {
              case 125:
                return (
                  this.bump(),
                  {
                    val: { type: w.argument, value: r, location: O(n, this.clonePosition()) },
                    err: null,
                  }
                );
              case 44:
                return (
                  ...
                  this.bumpSpace(),
                  this.isEOF()
                    ? this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE, O(n, this.clonePosition()))
                    : this.parseArgumentOptions(e, t, r, n)
                );
              default:
                return this.error(C.MALFORMED_ARGUMENT, O(n, this.clonePosition()));
            }
          }),
          (e.prototype.parseIdentifierIfPossible = function () {
            var e = this.clonePosition(),
              ...
              n = ot(this.message, t),
              r = t + n.length;
            return (this.bumpTo(r), { value: n, location: O(e, this.clonePosition()) });
          }),
          (e.prototype.parseArgumentOptions = function (e, t, n, r) {
            ...
            switch (a) {
              ...
              case `time`:
                ...
                if (s && tt(s?.style, `::`, 0)) {
                  ...
                  if (a === `number`) {
                    ...
                    return l.err
                      ? l
                      : { val: { type: w.number, value: n, location: p, style: l.val }, err: null };
                  } else {
                    if (m.length === 0) return this.error(C.EXPECT_DATE_TIME_SKELETON, p);
                    var h = m;
              ...
              case `select`:
                ...
                if ((this.bumpSpace(), !this.bumpIf(`,`)))
                  return this.error(C.EXPECT_SELECT_ARGUMENT_OPTIONS, O(g, d({}, g)));
                this.bumpSpace();
                ...
                return a === `select`
                  ? {
                      val: { type: w.select, value: n, options: nt(y.val), location: b },
                      err: null,
                    }
                  : {
                      val: {
          ...
          (e.prototype.tryParseArgumentClose = function (e) {
            return this.isEOF() || this.char() !== 125
              ? this.error(C.EXPECT_ARGUMENT_CLOSING_BRACE, O(e, this.clonePosition()))
          ...
          (e.prototype.tryParsePluralOrSelectOptions = function (e, t, n, r) {
            for (var i, a = !1, o = [], s = new Set(), c = r.value, l = r.location; ; ) {
              ...
              if (m.err) return m;
              (o.push([c, { value: p.val, location: O(f, this.clonePosition()) }]),
                s.add(c),
                this.bumpSpace(),
            ...
            return o.length === 0
              ...
              : this.requiresOtherClause && !a
                ? this.error(C.MISSING_OTHER_CLAUSE, O(this.clonePosition(), this.clonePosition()))
                : { val: o, err: null };
          }),
...
function dt(e) {
  e.forEach(function (e) {
    if ((delete e.location, ue(e) || de(e)))
      for (var t in e.options) (delete e.options[t].location, dt(e.options[t].value));
    else
...
function vt(e) {
  return e.length < 2
    ...
    : e.reduce(function (e, t) {
        var n = e[e.length - 1];
        return (
          !n || n.type !== N.literal || t.type !== N.literal ? e.push(t) : (n.value += t.value), e
        );
      }, []);
}
function yt(e) {
...
function bt(e, t, n, r, i, a, o) {
  if (e.length === 1 && ae(e[0])) return [{ type: N.literal, value: e[0].value }];
  for (var s = [], c = 0, l = e; c < l.length; c++) {
    ...
    if (fe(u)) {
      typeof a == `number` && s.push({ type: N.literal, value: n.getNumberFormat(t).format(a) });
      continue;
    }
    var d = u.value;
    ...
    if (oe(u)) {
      ((!f || typeof f == `string` || typeof f == `number`) &&
        ...
        s.push({ type: typeof f == `string` ? N.literal : N.object, value: f }));
      continue;
    }
    if (ce(u)) {
      var p =
        typeof u.style == `string` ? r.date[u.style] : he(u.style) ? u.style.parsedOptions : void 0;
    ...
    if (pe(u)) {
      ...
      (Array.isArray(_) || (_ = [_]),
        s.push.apply(
          s,
          _.map(function (e) {
            return { type: typeof e == `string` ? N.literal : N.object, value: e };
          }),
        ));
    }
    if (ue(u)) {
    ...
    e === void 0 && (e = { number: {}, dateTime: {}, pluralRules: {} }),
    {
      getNumberFormat: m(
        function () {
          ...
          return new ((e = Intl.NumberFormat).bind.apply(e, l([void 0], t, !1)))();
        },
      ...
      getDateTimeFormat: m(
        function () {
          for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
          return new ((e = Intl.DateTimeFormat).bind.apply(e, l([void 0], t, !1)))();
        },
          ...
          if (
            ...
            (this.format = function (e) {
              ...
              var n = t.reduce(function (e, t) {
                return (
                  !e.length || t.type !== N.literal || typeof e[e.length - 1] != `string`
                    ? e.push(t.value)
            ...
            (this.formatToParts = function (e) {
              return bt(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
            }),
            ...
            this.ast = e.__parse(t, d(d({}, c), { locale: this.resolvedLocale }));
          } else this.ast = t;
...
to autofix this issue`,
        ...
        if (Array.isArray(v) && v.length === 1 && v[0].type === w.literal) return v[0].value;
        if (!r && v && typeof v == `string` && !m) return v.replace(/'\{(.*?)\}'/gi, `{$1}`);
        if (((r = d(d({}, m), r || {})), (o = Vt(o, p)), (l = Vt(l, p)), !v)) {
          if (u === !1 && v === ``) return v;
          if (((!g || (a && a.toLowerCase() !== c.toLowerCase())) && f(new jt(n, a)), g))
            try {
...
`,
  ...
  try {
    ...
    return t(i, o)
      .formatToParts(c)
      .map(function (e) {
        return e.type === `literal` ? e : d(d({}, e), { value: s[e.value] || e.value });
      });
  } catch (e) {
    ...
    (f(),
      ...
      (tr = (function (e) {
        ...
        function t() {
          ...
          return (
            (t.cache = Nt()),
            (t.state = { cache: t.cache, intl: X($n(t.props), t.cache), prevConfig: $n(t.props) }),
            t
          );
        }
        return (
          ...
          (t.prototype.render = function () {
            return (
              Tn(this.state.intl),
              er.createElement(In, { value: this.state.intl }, this.props.children)
            );
          }),
  ...
  pr = e(() => {
    (f(),
      ...
      (fr = function (e) {
        ...
        wn(!a || !!(a && or(i)), `Cannot schedule update with unit longer than hour`);
        var c = Q.useState(),
          l = c[0],
          u = c[1],
          f = Q.useState(0),
...
function yr(e, t) {
  ...
  n[0] !== t || n[1] !== r
    ...
    : (i = n[2]);
  let a;
  (n[3] === t ? (a = n[4]) : ((a = [t]), (n[3] = t), (n[4] = a)), (0, xr.useEffect)(i, a));
}
var br,
  xr,
  Sr = e(() => {
  ...
  switch (t.type) {
    ...
    case `applyPatch`:
      return t.files.length === 1
        ...
        : e.formatMessage($.actionSummaryEditingFiles, { fileCount: t.files.length });
    case `networkAccess`:
      return e.formatMessage($.actionSummaryNetworkAccess, { target: t.target });
    case `mcpToolCall`:
    ...
    case `requestPermissions`:
      return t.reason == null
        ...
        : e.formatMessage($.actionSummaryPermissionRequestWithReason, { reason: t.reason });
  }
}
var $,
  Er = e(() => {
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~appgen-~1je6c975.js.map
