...
import { f as i, lt as a, p as o } from "./vscode-api.js";
import { c as ee, n as te, o as s } from "./lib-2.js";
import { n as c } from "./rpc-2.js";
...
async function b(e, t) {
  ...
  (m === e && (m = null),
    i.dispatchMessage(`global-dictation-completed`, { sessionId: e.sessionId, text: n }));
}
function x(e, t, n, r) {
  ((m = r),
    t(n),
...
function w() {
  ...
  e[1] === t
    ...
    : ((S = (e, n, r) => {
        ...
        (p(a.message),
          h(a.canRetry),
          u(`error`),
          i.dispatchMessage(`global-dictation-window-layout`, { sessionId: e, layout: `error` }));
      }),
      (e[1] = t),
      (e[2] = S));
  let w = S,
  ...
  e[7] === a
    ...
    : ((O = () => {
        a != null &&
          (i.dispatchMessage(`global-dictation-dismiss`, { sessionId: a }),
          c(null),
          p(null),
          h(!1));
      }),
  ...
  e[9] === a
    ? (A = e[10])
    : ((A = () => {
        a != null && i.dispatchMessage(`global-dictation-close`, { sessionId: a });
      }),
      (e[9] = a),
      (e[10] = A));
  let j = A,
  ...
  e[11] !== a || e[12] !== l
    ? ((M = () => {
        a == null || l !== `listening` || (u(`transcribing`), p(null), h(!1), T(a), v(a));
      }),
      (e[11] = a),
      (e[12] = l),
      (e[13] = M))
...
function fe(e) {
  i.dispatchMessage(`global-dictation-window-layout`, { sessionId: e, layout: `compact` });
}
