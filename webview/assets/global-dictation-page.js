...
import { a as pe, i as me, n as he, o as ge, r as _e, t as T } from "./global-dictation-orb.js";
import { n as ve, t as ye } from "./use-floating-window-pointer-interactivity.js";
var E,
  D,
  O,
  k,
...
function j() {
  ...
  return (
    queueMicrotask(() => {
      e && n.dispatchMessage(`global-dictation-renderer-ready`, {});
    }),
    () => {
      e = !1;
    }
...
function xe() {
  ...
  e[0] === r
    ? (c = e[1])
    : ((c = () => {
        r != null && n.dispatchMessage(`global-dictation-close`, { sessionId: r });
      }),
      (e[0] = r),
      (e[1] = c));
  let ee = c,
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = y(
      ...
      (e[3] = u))
    : (u = e[3]);
  let ne = a ? `size-10` : `size-0`,
    d;
  e[4] === ne
    ? (d = e[5])
    : ((d = y(`flex items-center justify-center`, ne)), (e[4] = ne), (e[5] = d));
  let f;
  e[6] === t
    ? (f = e[7])
    : ((f = (0, I.jsx)(T, {
...
function M(e) {
  n.dispatchMessage(`global-dictation-pointer-interaction-changed`, { isInteractive: e });
}
function N() {
  let e = (0, P.c)(94),
    t = ae(),
    ...
    [l, ne] = (0, F.useState)(null),
    [f, m] = (0, F.useState)(!1),
    [h, re] = (0, F.useState)(0),
    [g, v] = (0, F.useState)(`initializing`),
  ...
  e[1] === t
    ...
    : ((_e = (e, n) => {
        let r = fe(t, e, n);
        (x(r.message), C(r.canRetry), v(`error`));
      }),
      (e[1] = t),
      (e[2] = _e));
  let T = _e,
  ...
  e[6] === i
    ...
    : ((D = () => {
        i != null &&
          (n.dispatchMessage(`global-dictation-dismiss`, { sessionId: i }),
          o(null),
          x(null),
          C(!1));
      }),
  ...
  e[8] !== i || e[9] !== g
    ? ((A = () => {
        (i == null && g !== `idle`) ||
          n.dispatchMessage(`global-dictation-close`, { sessionId: i });
      }),
      (e[8] = i),
      (e[9] = g),
      (e[10] = A))
  ...
  (e[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (e) => {
      ...
      (e[16] = Ee))
    : ((N = e[15]), (Ee = e[16])),
    a(`global-dictation-idle`, N, Ee));
  let De;
  e[17] !== r || e[18] !== he || e[19] !== T || e[20] !== ue || e[21] !== de
    ? ((De = (e) => {
        (o(e.sessionId),
          m(!1),
          x(null),
  ...
  (e[23] === Symbol.for(`react.memo_cache_sentinel`) ? ((Oe = []), (e[23] = Oe)) : (Oe = e[23]),
    a(`global-dictation-start`, De, Oe));
  let ke, Ae;
  (e[24] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = (e) => {
        (v(`transcribing`), x(null), C(!1), ge(e.sessionId));
      }),
      (Ae = []),
      (e[24] = ke),
      (e[25] = Ae))
    : ((ke = e[24]), (Ae = e[25])),
    a(`global-dictation-stop`, ke, Ae));
  let je = g === `error` && `p-1`,
    L;
  e[26] === je
    ? (L = e[27])
  ...
  e[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Pe = y(k.darkTheme, `!rounded-full px-4 py-2`)), (e[28] = Pe))
    : (Pe = e[28]);
  let R;
  e[29] !== s || e[30] !== l
    ? ((R = (0, I.jsx)(Te, { configuredHotkey: s, configuredToggleHotkey: l })),
      ...
      (e[31] = R))
    : (R = e[31]);
  let Fe = g === `error` ? `w-fit` : `h-[30px] w-[120px]`,
    z;
  e[32] === Fe
    ? (z = e[33])
  ...
  e[34] !== t || e[35] !== g
    ? ((B =
      ...
      (e[36] = B))
    : (B = e[36]);
  let Ie = g === `error` ? `draggable` : `no-drag`,
    Le = (g === `initializing` || g === `idle`) && k.miniSurface,
    Re =
    ...
    Be = g !== `initializing` && g !== `idle` && k.expandedSurface,
    Ve = g !== `initializing` && g !== `idle` && `border-token-border-default/80`,
    He =
      (g === `listening` || g === `transcribing`) &&
      `h-[30px] w-[72px] justify-center rounded-full px-2`,
    Ue = g === `error` && `h-8 w-fit max-w-[304px] gap-2 rounded-2xl px-2`,
    V;
  e[37] !== Ie ||
  e[38] !== Le ||
  e[39] !== Re ||
  ...
  e[48] === g
    ...
    : ((U =
        g === `transcribing`
          ? (0, I.jsx)(oe, { className: `icon-xs text-token-text-secondary` })
          : null),
      (e[48] = g),
      (e[49] = U));
  let W;
  e[50] !== S || e[51] !== b || e[52] !== O || e[53] !== E || e[54] !== t || e[55] !== g
    ? ((W =
        g === `error`
          ? (0, I.jsxs)(I.Fragment, {
              children: [
                ...
                (0, I.jsx)(`button`, {
                  ...
                  onClick: O,
                  children: (0, I.jsx)(ce, { className: `icon-2xs` }),
                }),
              ],
            })
          : null),
...
function we(e) {
  ...
  return (
    t[3] !== n || t[4] !== a
      ? ((o = (0, I.jsx)(w, { items: a, children: n })), (t[3] = n), (t[4] = a), (t[5] = o))
      : (o = t[5]),
    o
  );
}
function Te(e) {
  ...
  if (n != null && r != null) {
    let e;
    t[0] === n ? (e = t[1]) : ((e = S(n)), (t[0] = n), (t[1] = e));
    let i;
    t[2] === e
      ? (i = t[3])
      : ((i = (0, I.jsx)(h, { keysLabel: e }, `hold`)), (t[2] = e), (t[3] = i));
    let a;
    t[4] === r ? (a = t[5]) : ((a = S(r)), (t[4] = r), (t[5] = a));
    let o;
    t[6] === a
      ? (o = t[7])
      : ((o = (0, I.jsx)(h, { keysLabel: a }, `toggle`)), (t[6] = a), (t[7] = o));
    let s;
    return (
      t[8] !== i || t[9] !== o
        ? ((s = (0, I.jsx)(_, {
  ...
  if (n != null) {
    let e;
    t[11] === n ? (e = t[12]) : ((e = S(n)), (t[11] = n), (t[12] = e));
    let r;
    return (
      t[13] === e
        ? (r = t[14])
        : ((r = (0, I.jsx)(_, {
            ...
            values: { shortcut: (0, I.jsx)(h, { keysLabel: e }, `hold`) },
          })),
          (t[13] = e),
          (t[14] = r)),
      r
  ...
  if (r != null) {
    let e;
    t[15] === r ? (e = t[16]) : ((e = S(r)), (t[15] = r), (t[16] = e));
    let n;
    return (
      t[17] === e
        ? (n = t[18])
        : ((n = (0, I.jsx)(_, {
            ...
            values: { shortcut: (0, I.jsx)(h, { keysLabel: e }, `toggle`) },
          })),
          (t[17] = e),
          (t[18] = n)),
      n
