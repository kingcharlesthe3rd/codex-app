...
import "./src-1.js";
import "./react-dom.js";
import { c as o, n as s, o as c } from "./lib.js";
...
import { t as re } from "./context-menu-Cx-ZCB4Y.js";
...
import { a as ce, i as le, n as ue, r as de, t as fe } from "./transcribe-audio.js";
import { t as pe } from "./use-recording-waveform.js";
import { t as me } from "./dictation-error-message.js";
import { t as he } from "./use-floating-window-pointer-interactivity.js";
var ge = r(),
  d = e(t(), 1),
  _e = 250,
  f = null,
...
async function ve(e, t, n, r) {
  if (f?.sessionId === e || m === e) return;
  ((p = null), f != null && ye(f.sessionId));
  let a = null;
  try {
    ((m = e),
    ...
    if (
      ...
      try {
        ...
        ((o.pendingStreamingSession = null),
          f === o && !o.isStopping ? (o.streamingSession = e) : e.close());
      } catch {
...
async function _(e) {
  ...
  try {
    ...
    if (e.chunks.length === 0 || Date.now() - e.startedAtMs < _e) {
    ...
    ((t = {
      ...
      await v(t, e.cleanupEnabled, e.streamingSession));
  } catch (n) {
    y(e.sessionId, e.controls.onTranscriptionFailed, n, t);
  }
}
async function be(e, t) {
  ...
  try {
    ...
    throw (y(e, n.onTranscriptionFailed, t, n), t);
  } finally {
    g === e && (g = null);
  }
}
async function v(e, t, n = null) {
  let r = await ue({
    transcript: n == null ? await fe(e.audio) : await xe(n, e.audio),
    cleanupEnabled: t,
  });
  (p === e && (p = null),
...
function C() {
  let e = (0, ge.c)(100),
    ...
    n = ae(`1025755912`),
    r = ae(le),
    [l, ie] = (0, d.useState)(null),
    [u, ue] = (0, d.useState)(null),
    [de, fe] = (0, d.useState)(null),
    [_e, f] = (0, d.useState)(!1),
    [p, m] = (0, d.useState)(0),
    [h, g] = (0, d.useState)(`initializing`),
    [_, v] = (0, d.useState)(null),
    [xe, y] = (0, d.useState)(!1),
    Se = (0, d.useRef)(null),
    b;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = { variant: `compact` }), (e[0] = b))
    : (b = e[0]);
  let {
      waveformCanvasRef: C,
      startWaveformCapture: De,
      stopWaveformCapture: Oe,
      resetWaveformDisplay: ke,
    } = pe(b),
    w;
  e[1] === t
    ? (w = e[2])
    : ((w = (e, n) => {
        let r = me(t, e, n);
        (v(r.message), y(r.canRetry), g(`error`));
      }),
      (e[1] = t),
      (e[2] = w));
  let T = w,
  ...
  (e[14] === p
    ...
    : ((A = {
        ...
        interactiveRegionRef: Se,
        onInteractiveChange: Te,
  ...
  (e[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (e) => {
        (ie(null),
          ue(e.configuredHotkey),
          fe(e.configuredToggleHotkey),
          f(!1),
          v(null),
          y(!1),
          m(we),
  ...
  let N;
  e[18] !== n || e[19] !== r || e[20] !== ke || e[21] !== T || e[22] !== De || e[23] !== Oe
    ? ((N = (e) => {
        (ie(e.sessionId),
          f(!1),
          v(null),
  ...
  (e[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Pe = (e) => {
        (g(`transcribing`), v(null), y(!1), ye(e.sessionId));
      }),
      (Fe = []),
      (e[26] = Pe),
      (e[27] = Fe))
    : ((Pe = e[26]), (Fe = e[27])),
    a(`global-dictation-stop`, Pe, Fe));
  let Ie;
  (e[28] === Symbol.for(`react.memo_cache_sentinel`) ? ((Ie = []), (e[28] = Ie)) : (Ie = e[28]),
    (0, d.useEffect)(Ce, Ie));
  let Le = h === `error` && `p-1`,
    F;
  e[29] === Le
  ...
  e[32] === Me
    ? (I = e[33])
    : ((I = [{ id: `close-window`, message: Re, onSelect: Me }]), (e[32] = Me), (e[33] = I));
  let ze = h !== `idle`,
    Be = h === `idle` && _e,
    Ve;
  e[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ve = ee(x.darkTheme, `!rounded-full px-4 py-2`)), (e[34] = Ve))
    : (Ve = e[34]);
  let L;
  e[35] !== u || e[36] !== de
    ? ((L = (0, S.jsx)(Ee, { configuredHotkey: u, configuredToggleHotkey: de })),
      (e[35] = u),
      (e[36] = de),
      (e[37] = L))
    : (L = e[37]);
  let He = h === `error` ? `w-fit` : `h-[30px] w-[120px]`,
    R;
  e[38] === He
    ? (R = e[39])
    : ((R = ee(`group flex items-end justify-center`, He)), (e[38] = He), (e[39] = R));
  let z;
  e[40] !== t || e[41] !== h
    ? ((z =
        h === `initializing`
      ...
      (e[42] = z))
    : (z = e[42]);
  let Ue = h === `error` ? `draggable` : `no-drag`,
    We = (h === `initializing` || h === `idle`) && x.miniSurface,
    Ge =
    ...
    qe = h !== `initializing` && h !== `idle` && x.expandedSurface,
    Je = h !== `initializing` && h !== `idle` && `border-token-border-default/80`,
    Ye =
      (h === `listening` || h === `transcribing`) &&
      `h-[30px] w-[72px] justify-center rounded-full px-2`,
    Xe = h === `error` && `h-8 w-fit max-w-[304px] gap-2 rounded-2xl px-2`,
    B;
  e[43] !== Ue ||
  e[44] !== We ||
  e[45] !== Ge ||
  ...
  e[50] !== Xe
    ? ((B = ee(
        `flex items-center overflow-hidden border shadow-lg shadow-black/20 transition-[width,height,border-radius] duration-100 [transition-timing-function:cubic-bezier(0.77,0,0.175,1)] forced-colors:bg-[Canvas] forced-colors:backdrop-blur-none motion-reduce:transition-none`,
        Ue,
        We,
        Ge,
        Ke,
  ...
  e[54] === h
    ...
    : ((H =
      ...
      (e[55] = H));
  let U;
  e[56] !== xe || e[57] !== _ || e[58] !== je || e[59] !== Ae || e[60] !== t || e[61] !== h
    ? ((U =
        h === `error`
          ? (0, S.jsxs)(S.Fragment, {
              children: [
  ...
  e[70] === h
    ...
    : ((q =
      ...
      (e[70] = h),
      (e[71] = q));
  let Ze = h === `error` ? _ : null,
    J;
  e[72] !== G || e[73] !== K || e[74] !== q || e[75] !== Ze
    ? ((J = (0, S.jsxs)(`span`, { className: `sr-only`, children: [G, K, q, Ze] })),
      (e[72] = G),
      (e[73] = K),
      (e[74] = q),
      (e[75] = Ze),
  ...
  e[85] !== R || e[86] !== Y
    ...
    : (X = e[87]);
  let Z;
  e[88] !== Ne || e[89] !== ze || e[90] !== Be || e[91] !== L || e[92] !== X
    ? ((Z = (0, S.jsx)(ne, {
        delayDuration: 250,
        disableHoverOpen: ze,
        disablePadding: !0,
  ...
  let Q;
  e[94] !== I || e[95] !== Z
    ? ((Q = (0, S.jsx)(re, { items: I, children: Z })), (e[94] = I), (e[95] = Z), (e[96] = Q))
    : (Q = e[96]);
  let $;
  return (
    e[97] !== F || e[98] !== Q
      ? (($ = (0, S.jsx)(`main`, { className: F, children: Q })),
        (e[97] = F),
        (e[98] = Q),
        (e[99] = $))
      : ($ = e[99]),
