...
import { B as i, G as a, U as ee, b as te, wt as o, y as s } from "./setting-storage.js";
import { n as c } from "./rpc.js";
...
async function ue(e, t, n) {
  ...
  try {
    ((h = e),
      ...
      (r = await navigator.mediaDevices.getUserMedia({ audio: { channelCount: 1 } })),
    ...
    throw (
      ...
      h === e && (h = null),
      g === e && (g = null),
      s.dispatchMessage(`global-dictation-failed`, { sessionId: e, stage: `recording` }),
      n
    );
  }
}
...
async function y(e) {
  ...
  try {
    ...
    if (e.chunks.length === 0 || Date.now() - e.startedAtMs < f) {
      s.dispatchMessage(`global-dictation-completed`, { sessionId: e.sessionId, text: `` });
      return;
    }
    ((t = {
...
async function b(e, t) {
  ...
  (m === e && (m = null),
    s.dispatchMessage(`global-dictation-completed`, { sessionId: e.sessionId, text: n }));
}
function x(e, t, n, r) {
  ((m = r),
    t(n),
    s.dispatchMessage(`global-dictation-failed`, { sessionId: e, stage: `transcription` }));
}
function S(e) {
...
function w() {
  ...
  e[1] === t
    ...
    : ((S = (e, n, r) => {
        ...
        (p(i.message),
          h(i.canRetry),
          u(`error`),
          s.dispatchMessage(`global-dictation-window-layout`, { sessionId: e, layout: `error` }));
      }),
      (e[1] = t),
      (e[2] = S));
  let w = S,
  ...
  e[9] === o
    ? (A = e[10])
    : ((A = () => {
        o != null && s.dispatchMessage(`global-dictation-close`, { sessionId: o });
      }),
      (e[9] = o),
      (e[10] = A));
  let j = A,
  ...
  e[11] !== o || e[12] !== l
    ? ((M = () => {
        o == null || l !== `listening` || (u(`transcribing`), p(null), h(!1), T(o), v(o));
      }),
      (e[11] = o),
      (e[12] = l),
      (e[13] = M))
  ...
  e[14] !== n || e[15] !== x || e[16] !== w || e[17] !== y || e[18] !== b
    ...
    : (P = e[19]);
  let F;
  (e[20] === Symbol.for(`react.memo_cache_sentinel`) ? ((F = []), (e[20] = F)) : (F = e[20]),
  ...
  e[24] === j
    ? (z = e[25])
    : ((z = [{ id: `close-window`, message: R, onSelect: j }]), (e[24] = j), (e[25] = z));
  let B;
  e[26] === t
    ? (B = e[27])
    : ((B = t.formatMessage({
  ...
  e[32] === l
    ...
    : ((G =
      ...
      (e[33] = G));
  let K;
  e[34] !== m || e[35] !== f || e[36] !== k || e[37] !== D || e[38] !== t || e[39] !== l
    ? ((K =
        l === `error`
          ? (0, C.jsxs)(C.Fragment, {
              children: [
...
function fe(e) {
  s.dispatchMessage(`global-dictation-window-layout`, { sessionId: e, layout: `compact` });
}
