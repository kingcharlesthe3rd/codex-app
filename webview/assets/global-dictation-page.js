...
import { a as fe, i as pe, n as me, o as he, r as ge, t as E } from "./global-dictation-orb.js";
import { n as _e, t as ve } from "./use-floating-window-pointer-interactivity.js";
var ye,
  D,
  O,
  k,
...
function xe() {
  ...
  e[0] === n
    ? (c = e[1])
    : ((c = () => {
        n != null && g.dispatchMessage(`global-dictation-close`, { sessionId: n });
      }),
      (e[0] = n),
      (e[1] = c));
  let l = c,
  ...
  e[4] === f
    ? (p = e[5])
    : ((p = r(`flex items-center justify-center`, f)), (e[4] = f), (e[5] = p));
  let m;
  e[6] === t
    ? (m = e[7])
    : ((m = (0, I.jsx)(E, {
...
function M(e) {
  g.dispatchMessage(`global-dictation-pointer-interaction-changed`, { isInteractive: e });
}
function N() {
  let e = (0, P.c)(94),
    t = h(),
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = { variant: `compact` }), (e[0] = T))
    : (T = e[0]);
  let {
      waveformCanvasRef: oe,
      startWaveformCapture: se,
      stopWaveformCapture: de,
      resetWaveformDisplay: me,
    } = le(T),
    ge;
  e[1] === t
    ? (ge = e[2])
    : ((ge = (e, n) => {
        let r = ue(t, e, n);
        (S(r.message), w(r.canRetry), b(`error`));
      }),
      (e[1] = t),
      (e[2] = ge));
  let E = ge,
  ...
  (e[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (e) => {
      ...
      (e[16] = Ee))
    : ((N = e[15]), (Ee = e[16])),
    re(`global-dictation-idle`, N, Ee));
  let De;
  e[17] !== n || e[18] !== me || e[19] !== E || e[20] !== se || e[21] !== de
    ? ((De = (e) => {
        (a(e.sessionId),
          p(!1),
          S(null),
  ...
  (e[23] === Symbol.for(`react.memo_cache_sentinel`) ? ((Oe = []), (e[23] = Oe)) : (Oe = e[23]),
    re(`global-dictation-start`, De, Oe));
  let ke, Ae;
  (e[24] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = (e) => {
        (b(`transcribing`), S(null), w(!1), he(e.sessionId));
      }),
      (Ae = []),
      (e[24] = ke),
      (e[25] = Ae))
    : ((ke = e[24]), (Ae = e[25])),
    re(`global-dictation-stop`, ke, Ae));
  let je = v === `error` && `p-1`,
    L;
  e[26] === je
    ? (L = e[27])
  ...
  e[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Pe = r(k.darkTheme, `!rounded-full px-4 py-2`)), (e[28] = Pe))
    : (Pe = e[28]);
  let R;
  e[29] !== o || e[30] !== l
  ...
  e[32] === Fe
    ? (z = e[33])
    : ((z = r(`group flex items-end justify-center`, Fe)), (e[32] = Fe), (e[33] = z));
  let B;
  e[34] !== t || e[35] !== v
    ? ((B =
        v === `initializing`
  ...
  e[48] === v
    ...
    : ((U =
      ...
      (e[49] = U));
  let W;
  e[50] !== C || e[51] !== x || e[52] !== O || e[53] !== ye || e[54] !== t || e[55] !== v
    ? ((W =
        v === `error`
          ? (0, I.jsxs)(I.Fragment, {
              children: [
...
function Te(e) {
  ...
  if (n != null && r != null) {
    ...
    t[6] === a
      ? (o = t[7])
      : ((o = (0, I.jsx)(b, { keysLabel: a }, `toggle`)), (t[6] = a), (t[7] = o));
    let s;
    return (
      t[8] !== i || t[9] !== o
        ? ((s = (0, I.jsx)(y, {
