...
import "./src-3.js";
import "./react-dom.js";
import { l as o, r as s, s as c } from "./lib-1.js";
...
import { r as d, t as f } from "./tooltip-B.js";
import { t as p } from "./context-menu.js";
import { r as ee, t as m } from "./use-recording-waveform-Cfd-Ecbb.js";
import { t as h } from "./regenerate.js";
import { t as g } from "./x.js";
import "./rpc-1.js";
import { i as te } from "./transcribe-audio.js";
import { o as _ } from "./statsig.js";
import "./microphone-input.js";
import "./request.js";
import "./codex-api-error.js";
import { t as v } from "./dictation-error-message.js";
import { i as ne, n as re, r as ie, t as ae } from "./global-dictation-orb-W.js";
...
function se() {
  ...
  return (
    e[1] === t
      ? (r = e[2])
      : ((r = t ? (0, C.jsx)(le, {}) : (0, C.jsx)(de, {})), (e[1] = t), (e[2] = r)),
    r
  );
}
function ce() {
...
function le() {
  ...
  e[0] === r
    ? (u = e[1])
    : ((u = () => {
        r != null && i.dispatchMessage(`global-dictation-close`, { sessionId: r });
      }),
      (e[0] = r),
      (e[1] = u));
  let d = u,
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = l(
      ...
      (e[3] = p))
    : (p = e[3]);
  let ee = o ? `size-10` : `size-0`,
    m;
  e[4] === ee
    ? (m = e[5])
    : ((m = l(`flex items-center justify-center`, ee)), (e[4] = ee), (e[5] = m));
  let h;
  e[6] !== t || e[7] !== n
    ? ((h = (0, C.jsx)(ae, {
        cleanupEnabled: t,
  ...
  return (
    e[12] !== d || e[13] !== g
      ? ((v = (0, C.jsx)(`main`, {
          className: p,
          children: (0, C.jsx)(me, { onClose: d, children: g }),
        })),
        (e[12] = d),
        (e[13] = g),
        (e[14] = v))
...
function de() {
  let e = (0, b.c)(96),
    ...
    n = _(`1025755912`),
    r = _(te),
    [s, d] = (0, x.useState)(null),
    [p, ae] = (0, x.useState)(null),
    [y, se] = (0, x.useState)(null),
    [ce, le] = (0, x.useState)(!1),
    [ue, de] = (0, x.useState)(0),
    [w, T] = (0, x.useState)(`initializing`),
    [ge, E] = (0, x.useState)(null),
    [_e, D] = (0, x.useState)(!1),
    ve = (0, x.useRef)(null),
    ye;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = { variant: `compact` }), (e[0] = ye))
    : (ye = e[0]);
  let {
      waveformCanvasRef: be,
      startWaveformCapture: xe,
      stopWaveformCapture: Se,
      resetWaveformDisplay: Ce,
    } = m(ye),
    O;
  e[1] === t
    ? (O = e[2])
    : ((O = (e, n) => {
        let r = v(t, e, n);
        (E(r.message), D(r.canRetry), T(`error`));
      }),
      (e[1] = t),
      (e[2] = O));
  let k = O,
  ...
  e[7] === s
    ...
    : ((j = () => {
        s != null &&
          (i.dispatchMessage(`global-dictation-dismiss`, { sessionId: s }),
          d(null),
          E(null),
          D(!1));
      }),
  ...
  e[9] !== s || e[10] !== w
    ? ((M = () => {
        (s == null && w !== `idle`) ||
          i.dispatchMessage(`global-dictation-close`, { sessionId: s });
      }),
      (e[9] = s),
      (e[10] = w),
      (e[11] = M))
  ...
  (e[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (e) => {
        (d(null),
          ae(e.configuredHotkey),
          se(e.configuredToggleHotkey),
          le(!1),
          E(null),
          D(!1),
          de(fe),
      ...
      (e[17] = Oe))
    : ((F = e[16]), (Oe = e[17])),
    a(`global-dictation-idle`, F, Oe));
  let I;
  e[18] !== n || e[19] !== r || e[20] !== Ce || e[21] !== k || e[22] !== xe || e[23] !== Se
    ? ((I = (e) => {
        (d(e.sessionId),
          le(!1),
          E(null),
    ...
    : (I = e[24]);
  let ke;
  (e[25] === Symbol.for(`react.memo_cache_sentinel`) ? ((ke = []), (e[25] = ke)) : (ke = e[25]),
    a(`global-dictation-start`, I, ke));
  let Ae, je;
  (e[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ae = (e) => {
        (T(`transcribing`), E(null), D(!1), ne(e.sessionId));
      }),
      (je = []),
      (e[26] = Ae),
      (e[27] = je))
    : ((Ae = e[26]), (je = e[27])),
    a(`global-dictation-stop`, Ae, je));
  let Me = w === `error` && `p-1`,
    L;
  e[28] === Me
    ? (L = e[29])
  ...
  e[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Fe = l(S.darkTheme, `!rounded-full px-4 py-2`)), (e[30] = Fe))
    : (Fe = e[30]);
  let R;
  e[31] !== p || e[32] !== y
    ? ((R = (0, C.jsx)(he, { configuredHotkey: p, configuredToggleHotkey: y })),
      (e[31] = p),
      (e[32] = y),
      (e[33] = R))
    : (R = e[33]);
  let Ie = w === `error` ? `w-fit` : `h-[30px] w-[120px]`,
    z;
  e[34] === Ie
    ? (z = e[35])
    : ((z = l(`group flex items-end justify-center`, Ie)), (e[34] = Ie), (e[35] = z));
  let B;
  e[36] !== t || e[37] !== w
    ? ((B =
        w === `initializing`
      ...
      (e[38] = B))
    : (B = e[38]);
  let Le = w === `error` ? `draggable` : `no-drag`,
    Re = (w === `initializing` || w === `idle`) && S.miniSurface,
    ze =
      (w === `initializing` || w === `idle`) &&
    ...
    Ve = w !== `initializing` && w !== `idle` && S.expandedSurface,
    He = w !== `initializing` && w !== `idle` && `border-token-border-default/80`,
    Ue =
      (w === `listening` || w === `transcribing`) &&
      `h-[30px] w-[72px] justify-center rounded-full px-2`,
    We = w === `error` && `h-8 w-fit max-w-[304px] gap-2 rounded-2xl px-2`,
    V;
  e[39] !== Le ||
  e[40] !== Re ||
  e[41] !== ze ||
  ...
  e[50] === w
    ...
    : ((U =
        w === `transcribing`
          ? (0, C.jsx)(u, { className: `icon-xs text-token-text-secondary` })
          : null),
      (e[50] = w),
      (e[51] = U));
  let W;
  e[52] !== _e || e[53] !== ge || e[54] !== Te || e[55] !== we || e[56] !== t || e[57] !== w
    ? ((W =
        w === `error`
          ? (0, C.jsxs)(C.Fragment, {
              children: [
                ...
                _e
                  ? (0, C.jsx)(`button`, {
                      ...
                      onClick: we,
                      children: (0, C.jsx)(h, { className: `icon-2xs` }),
                    })
                  : null,
                (0, C.jsx)(`button`, {
                  type: `button`,
                  ...
                  onClick: Te,
                  children: (0, C.jsx)(g, { className: `icon-2xs` }),
                }),
              ],
            })
          : null),
  ...
  e[66] === w
    ...
    : ((J =
      ...
      (e[66] = w),
      (e[67] = J));
  let Ge = w === `error` ? ge : null,
    Y;
  e[68] !== K || e[69] !== q || e[70] !== J || e[71] !== Ge
    ? ((Y = (0, C.jsxs)(`span`, { className: `sr-only`, children: [K, q, J, Ge] })),
      (e[68] = K),
      (e[69] = q),
      (e[70] = J),
      (e[71] = Ge),
  ...
  e[81] !== z || e[82] !== X
    ...
    : (Z = e[83]);
  let Q;
  e[84] !== De || e[85] !== Ne || e[86] !== Pe || e[87] !== R || e[88] !== Z
    ? ((Q = (0, C.jsx)(f, {
        delayDuration: 250,
        disableHoverOpen: Ne,
        disablePadding: !0,
  ...
  let $;
  e[90] !== Ee || e[91] !== Q
    ? (($ = (0, C.jsx)(me, { onClose: Ee, children: Q })), (e[90] = Ee), (e[91] = Q), (e[92] = $))
    : ($ = e[92]);
  let Ke;
  return (
    e[93] !== L || e[94] !== $
      ? ((Ke = (0, C.jsx)(`main`, { className: L, children: $ })),
        (e[93] = L),
        (e[94] = $),
        (e[95] = Ke))
      : (Ke = e[95]),
...
function me(e) {
  ...
  return (
    t[3] !== n || t[4] !== a
      ? ((o = (0, C.jsx)(p, { items: a, children: n })), (t[3] = n), (t[4] = a), (t[5] = o))
      : (o = t[5]),
    o
  );
}
function he(e) {
  ...
  if (n != null && r != null) {
    let e;
    t[0] === n ? (e = t[1]) : ((e = y(n)), (t[0] = n), (t[1] = e));
    let i;
    t[2] === e
      ? (i = t[3])
      : ((i = (0, C.jsx)(d, { keysLabel: e }, `hold`)), (t[2] = e), (t[3] = i));
    let a;
    t[4] === r ? (a = t[5]) : ((a = y(r)), (t[4] = r), (t[5] = a));
    let o;
    t[6] === a
      ? (o = t[7])
      : ((o = (0, C.jsx)(d, { keysLabel: a }, `toggle`)), (t[6] = a), (t[7] = o));
    let s;
    return (
      t[8] !== i || t[9] !== o
        ? ((s = (0, C.jsx)(c, {
  ...
  if (n != null) {
    let e;
    t[11] === n ? (e = t[12]) : ((e = y(n)), (t[11] = n), (t[12] = e));
    let r;
    return (
      t[13] === e
        ? (r = t[14])
        : ((r = (0, C.jsx)(c, {
            ...
            values: { shortcut: (0, C.jsx)(d, { keysLabel: e }, `hold`) },
          })),
          (t[13] = e),
          (t[14] = r)),
      r
  ...
  if (r != null) {
    let e;
    t[15] === r ? (e = t[16]) : ((e = y(r)), (t[15] = r), (t[16] = e));
    let n;
    return (
      t[17] === e
        ? (n = t[18])
        : ((n = (0, C.jsx)(c, {
            ...
            values: { shortcut: (0, C.jsx)(d, { keysLabel: e }, `toggle`) },
          })),
          (t[17] = e),
          (t[18] = n)),
      n
...
export { se as GlobalDictationPage };
