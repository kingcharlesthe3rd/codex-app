...
import {
  ...
  r as ge,
  t as _e,
} from "./global-dictation-orb-CBcl-6tx.js";
import {
  et as w,
  nt as T,
} from "./app-initial~app-main~worktree-init-v2-page~appgen-settings-page~page~appgen-page~remote-con~lblzrcac.js";
import { n as ve, t as E } from "./use-floating-window-pointer-interactivity.js";
var D,
  O,
  k,
  A,
...
function ye() {
  ...
  return (
    e[1] === t
      ? (r = e[2])
      : ((r = t ? (0, I.jsx)(be, {}) : (0, I.jsx)(xe, {})), (e[1] = t), (e[2] = r)),
    r
  );
}
function M() {
...
function be() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = _(
      ...
      (e[3] = d))
    : (d = e[3]);
  let f = a ? `size-10` : `size-0`,
    p;
  e[4] === f
    ? (p = e[5])
    : ((p = _(`flex items-center justify-center`, f)), (e[4] = f), (e[5] = p));
  let m;
  e[6] === t
    ? (m = e[7])
    : ((m = (0, I.jsx)(_e, {
...
function xe() {
  ...
  e[6] === o
    ...
    : ((O = () => {
        o != null &&
          (r.dispatchMessage(`global-dictation-dismiss`, { sessionId: o }),
          c(null),
          x(null),
          S(!1));
      }),
  ...
  e[8] !== o || e[9] !== v
    ? ((j = () => {
        (o == null && v !== `idle`) ||
          r.dispatchMessage(`global-dictation-close`, { sessionId: o });
      }),
      (e[8] = o),
      (e[9] = v),
      (e[10] = j))
  ...
  (e[23] === Symbol.for(`react.memo_cache_sentinel`) ? ((Oe = []), (e[23] = Oe)) : (Oe = e[23]),
    l(`global-dictation-start`, De, Oe));
  let ke, Ae;
  ...
  e[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Pe = _(A.darkTheme, `!rounded-full px-4 py-2`)), (e[28] = Pe))
    : (Pe = e[28]);
  let R;
  e[29] !== u || e[30] !== f
  ...
  e[32] === Fe
    ? (z = e[33])
    : ((z = _(`group flex items-end justify-center`, Fe)), (e[32] = Fe), (e[33] = z));
  let B;
  e[34] !== t || e[35] !== v
    ? ((B =
        v === `initializing`
  ...
  let Ie = v === `error` ? `draggable` : `no-drag`,
    Le = (v === `initializing` || v === `idle`) && A.miniSurface,
    Re =
    ...
    Be = v !== `initializing` && v !== `idle` && A.expandedSurface,
  ...
  e[48] === v
    ...
    : ((U =
        v === `transcribing`
          ? (0, I.jsx)(re, { className: `icon-xs text-token-text-secondary` })
          : null),
      (e[48] = v),
      (e[49] = U));
  let W;
  e[50] !== oe || e[51] !== b || e[52] !== k || e[53] !== D || e[54] !== t || e[55] !== v
    ? ((W =
        v === `error`
          ? (0, I.jsxs)(I.Fragment, {
              children: [
                ...
                oe
                  ? (0, I.jsx)(`button`, {
                      ...
                      onClick: D,
                      children: (0, I.jsx)(le, { className: `icon-2xs` }),
                    })
                  : null,
                (0, I.jsx)(`button`, {
                  type: `button`,
                  ...
                  onClick: k,
                  children: (0, I.jsx)(i, { className: `icon-2xs` }),
                }),
              ],
            })
          : null),
  ...
  e[79] !== z || e[80] !== X
    ...
    : (Z = e[81]);
  let Q;
  e[82] !== be || e[83] !== Me || e[84] !== Ne || e[85] !== R || e[86] !== Z
    ? ((Q = (0, I.jsx)(ne, {
        delayDuration: 250,
        disableHoverOpen: Me,
        disablePadding: !0,
...
function we(e) {
  ...
  return (
    t[3] !== r || t[4] !== o
      ? ((s = (0, I.jsx)(g, { items: o, children: r })), (t[3] = r), (t[4] = o), (t[5] = s))
      : (s = t[5]),
    s
  );
}
function Te(e) {
  ...
  if (n != null && r != null) {
    ...
    t[2] === e
      ? (i = t[3])
      : ((i = (0, I.jsx)(p, { keysLabel: e }, `hold`)), (t[2] = e), (t[3] = i));
    let o;
    t[4] === r ? (o = t[5]) : ((o = w(r)), (t[4] = r), (t[5] = o));
    let s;
    t[6] === o
      ? (s = t[7])
      : ((s = (0, I.jsx)(p, { keysLabel: o }, `toggle`)), (t[6] = o), (t[7] = s));
    let c;
    return (
      t[8] !== i || t[9] !== s
        ? ((c = (0, I.jsx)(a, {
    ...
    return (
      t[13] === e
        ...
        : ((r = (0, I.jsx)(a, {
            ...
            values: { shortcut: (0, I.jsx)(p, { keysLabel: e }, `hold`) },
          })),
          (t[13] = e),
          (t[14] = r)),
      r
    ...
    return (
      t[17] === e
        ...
        : ((n = (0, I.jsx)(a, {
            ...
            values: { shortcut: (0, I.jsx)(p, { keysLabel: e }, `toggle`) },
          })),
          (t[17] = e),
          (t[18] = n)),
      n
