...
import "./src-2.js";
import "./react-dom.js";
import { l as o, r as s, s as c } from "./lib.js";
...
import { r as d, t as ee } from "./tooltip.js";
import { t as f } from "./context-menu.js";
import { a as p, i as m } from "./transcribe-audio.js";
import { t as h } from "./regenerate.js";
import { t as te } from "./x.js";
import "./rpc-Hf-fxjh7.js";
import { o as ne } from "./statsig.js";
import "./request.js";
import { t as re } from "./use-recording-waveform.js";
import "./codex-api-error.js";
import { t as ie } from "./dictation-error-message.js";
import { i as ae, n as oe, r as se, t as ce } from "./global-dictation-orb.js";
import { n as g } from "./electron-menu-shortcuts.js";
import { t as le } from "./use-floating-window-pointer-interactivity.js";
var _ = r(),
  v = e(t(), 1),
  y = {
...
function ue() {
  ...
  return (
    e[1] === t
      ? (r = e[2])
      : ((r = t ? (0, b.jsx)(fe, {}) : (0, b.jsx)(me, {})), (e[1] = t), (e[2] = r)),
    r
  );
}
function de() {
...
function fe() {
  ...
  e[0] === t
    ? (s = e[1])
    : ((s = () => {
        t != null && i.dispatchMessage(`global-dictation-close`, { sessionId: t });
      }),
      (e[0] = t),
      (e[1] = s));
  let c = s,
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = l(
      ...
      (e[3] = d))
    : (d = e[3]);
  let ee = r ? `size-10` : `size-0`,
    f;
  e[4] === ee
    ? (f = e[5])
    : ((f = l(`flex items-center justify-center`, ee)), (e[4] = ee), (e[5] = f));
  let p;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, b.jsx)(ce, {
        onActiveSessionIdChange: n,
  ...
  return (
    e[9] !== c || e[10] !== m
      ? ((h = (0, b.jsx)(`main`, {
          className: d,
          children: (0, b.jsx)(_e, { onClose: c, children: m }),
        })),
        (e[9] = c),
        (e[10] = m),
        (e[11] = h))
...
function me() {
  let e = (0, _.c)(96),
    ...
    n = ne(`1025755912`),
    r = ne(m),
    [s, d] = (0, v.useState)(null),
    [f, ce] = (0, v.useState)(null),
    [g, ue] = (0, v.useState)(null),
    [de, fe] = (0, v.useState)(!1),
    [pe, me] = (0, v.useState)(0),
    [x, S] = (0, v.useState)(`initializing`),
    [C, w] = (0, v.useState)(null),
    [ye, T] = (0, v.useState)(!1),
    be = (0, v.useRef)(null),
    E;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = { variant: `compact` }), (e[0] = E))
    : (E = e[0]);
  let {
      waveformCanvasRef: xe,
      startWaveformCapture: Se,
      stopWaveformCapture: Ce,
      resetWaveformDisplay: we,
    } = re(E),
    D;
  e[1] === t
    ? (D = e[2])
    : ((D = (e, n) => {
        let r = ie(t, e, n);
        (w(r.message), T(r.canRetry), S(`error`));
      }),
      (e[1] = t),
      (e[2] = D));
  let O = D,
  ...
  (e[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (e) => {
      ...
      (e[17] = F))
    : ((P = e[16]), (F = e[17])),
    a(`global-dictation-idle`, P, F));
  let I;
  e[18] !== n || e[19] !== r || e[20] !== we || e[21] !== O || e[22] !== Se || e[23] !== Ce
    ? ((I = (e) => {
        (d(e.sessionId),
          fe(!1),
          w(null),
  ...
  (e[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ae = (e) => {
        (S(`transcribing`), w(null), T(!1), ae(e.sessionId));
      }),
      (je = []),
      (e[26] = Ae),
      (e[27] = je))
  ...
  e[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Fe = l(y.darkTheme, `!rounded-full px-4 py-2`)), (e[30] = Fe))
    : (Fe = e[30]);
  let R;
  e[31] !== f || e[32] !== g
    ? ((R = (0, b.jsx)(ve, { configuredHotkey: f, configuredToggleHotkey: g })),
      (e[31] = f),
      (e[32] = g),
      (e[33] = R))
    : (R = e[33]);
  let Ie = x === `error` ? `w-fit` : `h-[30px] w-[120px]`,
    z;
  e[34] === Ie
    ? (z = e[35])
  ...
  e[36] !== t || e[37] !== x
    ? ((B =
      ...
      (e[38] = B))
    : (B = e[38]);
  let Le = x === `error` ? `draggable` : `no-drag`,
    Re = (x === `initializing` || x === `idle`) && y.miniSurface,
    ze =
    ...
    Ve = x !== `initializing` && x !== `idle` && y.expandedSurface,
    He = x !== `initializing` && x !== `idle` && `border-token-border-default/80`,
    Ue =
      (x === `listening` || x === `transcribing`) &&
      `h-[30px] w-[72px] justify-center rounded-full px-2`,
    We = x === `error` && `h-8 w-fit max-w-[304px] gap-2 rounded-2xl px-2`,
    V;
  e[39] !== Le ||
  e[40] !== Re ||
  e[41] !== ze ||
  ...
  e[50] === x
    ...
    : ((U =
        x === `transcribing`
          ? (0, b.jsx)(u, { className: `icon-xs text-token-text-secondary` })
          : null),
      (e[50] = x),
      (e[51] = U));
  let W;
  e[52] !== ye || e[53] !== C || e[54] !== Ee || e[55] !== Te || e[56] !== t || e[57] !== x
    ? ((W =
        x === `error`
          ? (0, b.jsxs)(b.Fragment, {
              children: [
                ...
                ye
                  ? (0, b.jsx)(`button`, {
                      ...
                      onClick: Te,
                      children: (0, b.jsx)(h, { className: `icon-2xs` }),
                    })
                  : null,
                (0, b.jsx)(`button`, {
                  type: `button`,
                  ...
                  onClick: Ee,
                  children: (0, b.jsx)(te, { className: `icon-2xs` }),
                }),
              ],
            })
          : null),
  ...
  e[66] === x
    ...
    : ((J =
      ...
      (e[66] = x),
      (e[67] = J));
  let Ge = x === `error` ? C : null,
    Y;
  e[68] !== K || e[69] !== q || e[70] !== J || e[71] !== Ge
    ? ((Y = (0, b.jsxs)(`span`, { className: `sr-only`, children: [K, q, J, Ge] })),
      (e[68] = K),
      (e[69] = q),
      (e[70] = J),
      (e[71] = Ge),
  ...
  e[81] !== z || e[82] !== X
    ...
    : (Z = e[83]);
  let Q;
  e[84] !== Oe || e[85] !== Ne || e[86] !== Pe || e[87] !== R || e[88] !== Z
    ? ((Q = (0, b.jsx)(ee, {
        delayDuration: 250,
        disableHoverOpen: Ne,
        disablePadding: !0,
  ...
  let $;
  e[90] !== De || e[91] !== Q
    ? (($ = (0, b.jsx)(_e, { onClose: De, children: Q })), (e[90] = De), (e[91] = Q), (e[92] = $))
    : ($ = e[92]);
  let Ke;
  return (
    e[93] !== L || e[94] !== $
      ? ((Ke = (0, b.jsx)(`main`, { className: L, children: $ })),
        (e[93] = L),
        (e[94] = $),
        (e[95] = Ke))
      : (Ke = e[95]),
...
function _e(e) {
  ...
  return (
    t[3] !== n || t[4] !== a
      ? ((o = (0, b.jsx)(f, { items: a, children: n })), (t[3] = n), (t[4] = a), (t[5] = o))
      : (o = t[5]),
    o
  );
}
function ve(e) {
  ...
  if (n != null && r != null) {
    let e;
    t[0] === n ? (e = t[1]) : ((e = g(n)), (t[0] = n), (t[1] = e));
    let i;
    t[2] === e
      ? (i = t[3])
      : ((i = (0, b.jsx)(d, { keysLabel: e }, `hold`)), (t[2] = e), (t[3] = i));
    let a;
    t[4] === r ? (a = t[5]) : ((a = g(r)), (t[4] = r), (t[5] = a));
    let o;
    t[6] === a
      ? (o = t[7])
      : ((o = (0, b.jsx)(d, { keysLabel: a }, `toggle`)), (t[6] = a), (t[7] = o));
    let s;
    return (
      t[8] !== i || t[9] !== o
        ? ((s = (0, b.jsx)(c, {
  ...
  if (n != null) {
    let e;
    t[11] === n ? (e = t[12]) : ((e = g(n)), (t[11] = n), (t[12] = e));
    let r;
    return (
      t[13] === e
        ? (r = t[14])
        : ((r = (0, b.jsx)(c, {
            ...
            values: { shortcut: (0, b.jsx)(d, { keysLabel: e }, `hold`) },
          })),
          (t[13] = e),
          (t[14] = r)),
      r
  ...
  if (r != null) {
    let e;
    t[15] === r ? (e = t[16]) : ((e = g(r)), (t[15] = r), (t[16] = e));
    let n;
    return (
      t[17] === e
        ? (n = t[18])
        : ((n = (0, b.jsx)(c, {
            ...
            values: { shortcut: (0, b.jsx)(d, { keysLabel: e }, `toggle`) },
          })),
          (t[17] = e),
          (t[18] = n)),
      n
...
export { ue as GlobalDictationPage };
