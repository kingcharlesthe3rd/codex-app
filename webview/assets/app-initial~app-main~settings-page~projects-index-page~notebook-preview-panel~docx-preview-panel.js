...
function m(e) {
  ...
  t[26] !== o || t[27] !== E || t[28] !== w
    ? ((L = (0, _.isValidElement)(o)
        ? o
        : (0, _.createElement)(o, {
            className: a(E, w && `text-token-list-active-selection-icon-foreground`),
          })),
      (t[26] = o),
      (t[27] = E),
      (t[28] = w),
  ...
  let R;
  t[30] !== i || t[31] !== c
    ? ((R = i ? null : (0, v.jsx)(`span`, { className: `truncate`, children: c })),
      (t[30] = i),
      (t[31] = c),
      (t[32] = R))
    : (R = t[32]);
...
function h(e) {
  ...
  t[0] !== r || t[1] !== _
    ...
    : (y = t[2]);
  let b;
  t[3] !== o || t[4] !== c || t[5] !== h || t[6] !== m || t[7] !== p || t[8] !== f
    ? ((b = o
        ? (0, v.jsxs)(`div`, {
            className: a(
