...
function b(e) {
  ...
  t[0] === r
    ? (o = t[1])
    : ((o = f(`relative inline-flex shrink-0 items-center justify-center`, r)),
      (t[0] = r),
      (t[1] = o));
  let s;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = i
        ? (0, S.jsx)(u, { className: `app-brand-logo-shimmer-base size-full` })
        : (0, S.jsx)(g, {
            "aria-hidden": `true`,
  ...
  return (
    t[4] === o
      ? (l = t[5])
      : ((l = (0, S.jsxs)(`div`, { "aria-hidden": `true`, className: o, children: [s, c] })),
        (t[4] = o),
        (t[5] = l)),
    l
  );
...
function E(e) {
  ...
  t[0] === d
    ? (p = t[1])
    : ((p = f(`flex items-center justify-center`, d)), (t[0] = d), (t[1] = p));
  let m;
  ...
  t[7] === c
    ? (g = t[8])
    : ((g = c ? (0, k.jsx)(b, { className: `size-14` }) : null), (t[7] = c), (t[8] = g));
  let _;
  t[9] !== !1 || t[10] !== a || t[11] !== l
    ? ((_ = null), (t[9] = !1), (t[10] = a), (t[11] = l), (t[12] = _))
    : (_ = t[12]);
  let v;
  t[13] !== g || t[14] !== _
    ? ((v = (0, k.jsxs)(`div`, {
  ...
  return (
    t[16] !== v || t[17] !== p || t[18] !== m || t[19] !== h
      ? ((y = (0, k.jsxs)(`div`, { className: p, onClick: m, children: [h, v] })),
        (t[16] = v),
        (t[17] = p),
        (t[18] = m),
        (t[19] = h),
...
function j(e) {
  let t = (0, M.c)(2),
    ...
    r;
  return (
    t[0] === n ? (r = t[1]) : ((r = (0, N.jsx)(E, { debugName: n })), (t[0] = n), (t[1] = r)), r
  );
}
var M,
  N,
...
export { b as a, _ as c, A as i, P as n, T as o, E as r, g as s, j as t };
//# sourceMappingURL=app-initial~app-main~new-thread-panel-page~onboarding-page.js.map
