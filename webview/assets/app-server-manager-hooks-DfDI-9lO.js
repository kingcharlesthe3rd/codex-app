...
async function L({ scope: e, appServerRegistry: t, enabledRemoteHostIds: r, sortKey: i }) {
  return (
    await Promise.all(
      M(e, t).map((e) =>
        n(`refresh-recent-conversations-for-host`, { hostId: e.getHostId(), sortKey: i }),
      ),
    ),
    I({ appServerRegistry: t, enabledRemoteHostIds: r, sortKey: i })
  );
}
function R({ scope: e, appServerRegistry: t, sortKey: r, refreshesInFlightHostIds: i }) {
  for (let a of M(e, t)) {
    let e = a.getHostId();
...
function J() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = { queryKeyPrefix: `recent-conversations`, subscribeToManager: Y }), (e[0] = t))
      : (t = e[0]),
    Q(t)
  );
}
...
function X() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = { queryKeyPrefix: `recent-conversations-meta`, subscribeToManager: Z }), (e[0] = t))
      : (t = e[0]),
    Q(t)
  );
}
...
function Q(e) {
  ...
  let c = s,
    ...
    f = g(),
    p;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((p = new Set()), (t[2] = p)) : (p = t[2]);
  let m = (0, A.useRef)(p),
    h,
    C;
  (t[3] !== a || t[4] !== c || t[5] !== f || t[6] !== n || t[7] !== i || t[8] !== d || t[9] !== r
    ? ((h = () => {
        let e = () => {
          let e = z(c);
          (f.setQueryData(
            ...
            R({ scope: i, appServerRegistry: a, sortKey: d, refreshesInFlightHostIds: m.current }));
        };
        return (e(), P({ appServerRegistry: a, onStoreChange: e, subscribeToManager: r }));
      }),
      (C = [a, c, f, n, i, d, r]),
      (t[3] = a),
      (t[4] = c),
  ...
  t[16] !== a || t[17] !== c || t[18] !== i || t[19] !== d
    ? ((j = async () =>
        L({ scope: i, appServerRegistry: a, enabledRemoteHostIds: z(c), sortKey: d })),
      (t[16] = a),
      (t[17] = c),
      (t[18] = i),
      (t[19] = d),
...
//# sourceMappingURL=app-server-manager-hooks-DfDI-9lO.js.map
