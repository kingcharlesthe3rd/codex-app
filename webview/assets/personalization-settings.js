...
import { g as m, i as h, k as g, m as _, o as v, r as y, s as b, u as x } from "./vscode-api.js";
import "./isEqual.js";
import { Di as S, Ki as C, ea as w, mr as T, na as E, xn as D } from "./src-1.js";
import "./react-dom.js";
import { c as ee, o as O, r as k } from "./lib.js";
import { c as te } from "./persisted-signal.js";
...
import { s as W, w as re } from "./config-queries.js";
...
import { a as ae, i as oe, n as se, o as ce, r as le } from "./experimental-features-queries.js";
...
import { n as ve } from "./use-start-new-conversation-jDp-QANK.js";
import "./electron-menu-shortcuts.js";
import { u as ye } from "./links.js";
import "./search.js";
import { r as be, t as K } from "./dropdown.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as xe } from "./settings-host-context.js";
import { t as Se } from "./toggle.js";
import { i as Ce, t as we } from "./settings-shared.js";
import { t as Te } from "./use-personality.js";
import { t as q } from "./use-hotkey.js";
import { t as Ee } from "./settings-content-layout.js";
import "./extension-info-DYf-Ibez.js";
import { n as De } from "./settings-row.js";
import { n as Oe, t as J } from "./settings-group.js";
var Y = r(),
  X = e(t(), 1),
  ke = h(s, `codex-agents-md`, (e) => ({ params: { hostId: e }, staleTime: x.FIVE_SECONDS })),
  Z = k({
    personality: {
...
function Me(e, t) {
  ...
  n[6] !== t || n[7] !== r || n[8] !== c
    ? ((f = async (e) => {
        ...
        return (
          r.setQueryData(c, (e) => (e == null ? e : { ...e, config: l(e.config, n) })),
  ...
  n[10] !== r || n[11] !== c
    ? ((p = (e, t, n) => {
        (_.error(`Failed to update memory config`, { safe: {}, sensitive: { error: e } }),
  ...
  let v;
  return (
    n[15] !== d || n[16] !== f || n[17] !== p || n[18] !== h
      ? ((v = { mutationFn: d, onMutate: f, onError: p, onSettled: h }),
        (n[15] = d),
        (n[16] = f),
        (n[17] = p),
        (n[18] = h),
...
function Ie() {
  ...
  e[5] !== t || e[6] !== c
    ? ((d = async (e) => {
      ...
      (f = (e, n, r) => {
        (_.error(`Failed to update Chronicle config`, {
          safe: { error: String(e) },
          sensitive: {},
        }),
  ...
  e[9] === a
    ? (h = e[10])
    : ((h = async () => {
        await Promise.all([a(W), a([`user-saved-config`])]);
      }),
      (e[9] = a),
      (e[10] = h));
  let v;
  return (
    e[11] !== l || e[12] !== d || e[13] !== f || e[14] !== h
      ? ((v = { mutationFn: l, onMutate: d, onError: f, onSettled: h }),
        (e[11] = l),
        (e[12] = d),
        (e[13] = f),
        (e[14] = h),
...
function Le(e, t) {
  return Object.assign(structuredClone(e), { features: { ...Re(e.features, oe, t) } });
}
function Re(e, t, n) {
...
function ze({ onChronicleResearchPreviewToggled: e } = {}) {
  let t = a(s),
    ...
    u = ve(),
    d = Ie(),
    { data: f, isLoading: m } = G(T.CHRONICLE_CONSENT_ACCEPTED),
    { data: h, isLoading: b } = i(re, n),
    [x, C] = (0, X.useState)(!1),
    [w, E] = (0, X.useState)(!1),
    [D, k] = (0, X.useState)(null),
    [te, j] = (0, X.useState)(!1),
    M = v(`chronicle-permissions`, {
      queryConfig: {
        intervalMs: 1e3,
    ...
    L = I || !N,
    B = ne({
      accessibilityStatus: M.data?.accessibility,
      errorMessage: D,
      isSidecarPresent: M.data?.chronicleSidecarPresent === !0,
      isUpdatingChronicle: te,
      processState: M.data?.chronicleSidecarProcessState ?? `disabled`,
      screenRecordingStatus: M.data?.screenRecording,
    }),
    H = r.formatMessage({
  ...
  (0, X.useEffect)(() => {
    w && z(B.kind) && c(t, T.CHRONICLE_SETUP_COMPLETION_PENDING, !0);
  }, [w, t, B.kind]);
  let U = async ({ rememberConsentAccepted: n, showSetupDialog: r }) => {
      let i = F;
      (j(!0), k(null), C(!1), E(r));
      try {
        (n === !0 && (await c(t, T.CHRONICLE_CONSENT_ACCEPTED, !0)),
          r || c(t, T.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          await d.mutateAsync({ enabled: !0 }),
          e?.(i, !0),
          await l.invalidateQueries({ queryKey: y(`chronicle-permissions`) }));
      } catch (e) {
        let n = et(e);
        (c(t, T.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          k(n),
          _.error(`Failed to enable Chronicle`, {
            safe: { errorMessage: n },
            sensitive: { error: e },
          }));
      } finally {
    ...
    W = async () => {
      let n = F;
      (j(!0), k(null), c(t, T.CHRONICLE_SETUP_COMPLETION_PENDING, !1));
      try {
        ...
        children: [
          (0, Q.jsx)(De, {
            ...
            description: (0, Q.jsx)(Ge, {
              isCheckingPermissions: M.data == null && M.isFetching,
              permissions: M.data,
              chronicleFeatureEnabled: F,
            ...
            control: (0, Q.jsx)(P, {
              ...
              children: (0, Q.jsx)(`span`, {
                className: A(`inline-flex`, !N && `cursor-not-allowed`),
                tabIndex: N ? void 0 : 0,
                children: (0, Q.jsx)(Se, {
                  checked: F,
                  className: N ? void 0 : `pointer-events-none`,
                  disabled: L,
                  onChange: (e) => {
                    if (e) {
                      if (f === !0) {
          ...
          (0, Q.jsx)(R, {
            ...
            setupState: B,
            onOpenChange: (e) => {
              (e || c(t, T.CHRONICLE_SETUP_COMPLETION_PENDING, !1), E(e));
            },
            onAskCodex: () => {
              (c(t, T.CHRONICLE_SETUP_COMPLETION_PENDING, !1), E(!1), u({ prefillPrompt: V }));
            },
          }),
        ],
      });
...
function Be(e) {
  ...
  t[2] === s
    ...
    : ((l = s.formatMessage({
      ...
      (t[3] = l));
  let u;
  t[4] === l ? (u = t[5]) : ((u = (0, Q.jsx)(pe, { title: l })), (t[4] = l), (t[5] = u));
  let d;
  t[6] !== c || t[7] !== u
    ? ((d = (0, Q.jsxs)(de, { children: [c, u] })), (t[6] = c), (t[7] = u), (t[8] = d))
    : (d = t[8]);
  let f, p;
  ...
  let T;
  t[27] !== S || t[28] !== w
    ? ((T = (0, Q.jsx)(de, { children: (0, Q.jsxs)(ge, { className: _e, children: [S, w] }) })),
      (t[27] = S),
      (t[28] = w),
      (t[29] = T))
    : (T = t[29]);
  ...
  return (
    t[33] !== o || t[34] !== r || t[35] !== E
      ? ((D = (0, Q.jsx)(me, { open: r, onOpenChange: o, size: `default`, children: E })),
        (t[33] = o),
        (t[34] = r),
        (t[35] = E),
        (t[36] = D))
...
function rt({
  ...
  e.logProductEvent(L, { settingName: r, previousEnabled: t, selectedEnabled: n, ...i });
}
...
function ot() {
  ...
  e[6] === c
    ? (N = e[7])
    : ((N = () => u(`reset-memories-for-host`, { hostId: c })), (e[6] = c), (e[7] = N));
  let P, L;
  e[8] === t
    ? ((P = e[9]), (L = e[10]))
    : ((P = () => {
      ...
      (e[10] = L));
  let R;
  e[11] !== N || e[12] !== P || e[13] !== L
    ? ((R = { mutationFn: N, onSuccess: P, onError: L }),
      (e[11] = N),
      (e[12] = P),
      (e[13] = L),
      (e[14] = R))
  ...
  let z = m(R),
    B = ce(C, A),
    V;
  e[15] === C ? (V = e[16]) : ((V = C.find(ct)), (e[15] = C), (e[16] = V));
  let ne = V?.enabled === !0,
    U = _?.config,
    W;
  e[17] === U ? (W = e[18]) : ((W = d(U)), (e[17] = U), (e[18] = W));
  let G = W,
    ue = _?.config,
    fe;
  e[19] === ue ? (fe = e[20]) : ((fe = S(ue, oe)), (e[19] = ue), (e[20] = fe));
  let _e = fe === !0,
    ve = b || E.isPending || k.isPending || M.isPending || z.isPending,
    ye = ne && G.generateMemories && G.useMemories,
    be = l.kind === `local`,
    K = be && g && T?.chronicleSidecarPresent === !0,
    Ce;
  e[21] !== _e || e[22] !== ne || e[23] !== G || e[24] !== K
    ? ((Ce = {
  ...
  let q = Te,
    Ee;
  e[28] !== E || e[29] !== M || e[30] !== q || e[31] !== be || e[32] !== r || e[33] !== k
    ? ((Ee = (e) => {
        at({
          productLogger: r,
          previousState: q(),
          selectedEnabled: e,
          featureWrite: () => k.mutateAsync({ featureName: ae, enabled: e }),
          configWrite: () =>
            E.mutateAsync({
              edits: [
          ...
          ...(!e && be ? { chronicleDisable: () => M.mutateAsync({ enabled: !1 }) } : {}),
        });
      }),
      (e[28] = E),
      (e[29] = M),
  ...
  e[41] === n
    ...
    : ((Re = n.formatMessage({
      ...
      (e[42] = Re));
  let Be;
  e[43] !== ve || e[44] !== ye || e[45] !== ke || e[46] !== Re
    ? ((Be = (0, Q.jsx)(De, {
        label: Fe,
        description: Le,
        control: (0, Q.jsx)(Se, { checked: ye, disabled: ve, ariaLabel: Re, onChange: ke }),
      })),
      (e[43] = ve),
      (e[44] = ye),
      (e[45] = ke),
  ...
  e[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((He = (0, Q.jsx)(O, { ...Z.skipToolAssistedChats })),
      (Ue = (0, Q.jsx)(O, {
  ...
  e[54] === n
    ...
    : ((Ke = n.formatMessage({
      ...
      (e[55] = Ke));
  let qe;
  e[56] !== E || e[57] !== q || e[58] !== G.disableOnExternalContext || e[59] !== r
    ? ((qe = (e) => {
        it({
          productLogger: r,
  ...
  e[61] !== G.disableOnExternalContext || e[62] !== Ge || e[63] !== Ke || e[64] !== qe
    ? ((Je = (0, Q.jsx)(De, {
        label: He,
        description: Ue,
        control: (0, Q.jsx)(Se, { checked: We, disabled: Ge, ariaLabel: Ke, onChange: qe }),
      })),
  ...
  e[80] === z.isPending
    ? (lt = e[81])
    : ((lt = (0, Q.jsx)(j, { color: `ghost`, disabled: z.isPending, onClick: tt, children: ot })),
      (e[80] = z.isPending),
      (e[81] = lt));
  let ut;
  e[82] !== Me || e[83] !== r
    ? ((ut = () => {
        (r.logProductEvent(H, { resetScope: `all_memories` }), Me());
      }),
      (e[82] = Me),
      (e[83] = r),
      (e[84] = ut))
  ...
  e[86] !== z.isPending || e[87] !== ut
    ? ((ft = (0, Q.jsx)(j, { color: `danger`, loading: z.isPending, onClick: ut, children: dt })),
      (e[86] = z.isPending),
      (e[87] = ut),
      (e[88] = ft))
    : (ft = e[88]);
  ...
  e[89] !== lt || e[90] !== ft
    ? ((pt = (0, Q.jsxs)(he, {
        children: [et, (0, Q.jsx)(de, { children: (0, Q.jsxs)(ge, { children: [lt, ft] }) })],
      })),
      (e[89] = lt),
      (e[90] = ft),
      (e[91] = pt))
  ...
  let mt;
  e[92] !== p || e[93] !== pt
    ? ((mt = (0, Q.jsx)(me, { open: p, onOpenChange: h, size: `compact`, children: pt })),
      (e[92] = p),
      (e[93] = pt),
      (e[94] = mt))
    : (mt = e[94]);
...
function lt() {
  ...
  e[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Q.jsx)(Ce, { slug: `personalization` })), (e[22] = _))
    : (_ = e[22]);
  let v;
  ...
  e[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Q.jsx)(ue, { electron: !0, extension: !0, children: (0, Q.jsx)(ot, {}) })),
      (e[31] = b))
    : (b = e[31]);
  let x;
  return (
...
function ut(e) {
  let t = (0, Y.c)(40),
    ...
    { data: d, error: f, isFetching: p, refetch: m } = i(ke, n),
    h;
  t[0] !== o || t[1] !== c || t[2] !== r
    ? ((h = (e, t) => {
  ...
  let F;
  (t[19] !== N || t[20] !== P
    ? ((F = { accelerator: `CmdOrCtrl+S`, enabled: N, onKeyDown: P }),
      (t[19] = N),
      (t[20] = P),
      (t[21] = F))
    : (F = t[21]),
  ...
  t[24] === o
    ? (R = t[25])
    : ((R = o.formatMessage(Z.customInstructions)), (t[24] = o), (t[25] = R));
  let z = R,
    B;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, Q.jsx)(O, { ...Z.customInstructions })), (t[26] = B))
    : (B = t[26]);
  let V;
