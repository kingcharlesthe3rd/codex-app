...
function kt(e, t) {
  ...
  n[6] !== t || n[7] !== r || n[8] !== s
    ? ((u = async (e) => {
        ...
        return (
          r.setQueryData(s, (e) => (e == null ? e : { ...e, config: de(e.config, n) })),
  ...
  n[10] !== r || n[11] !== s
    ? ((d = (e, t, n) => {
        (v.error(`Failed to update memory config`, { safe: {}, sensitive: { error: e } }),
  ...
  let p;
  return (
    n[15] !== c || n[16] !== u || n[17] !== d || n[18] !== f
      ? ((p = { mutationFn: c, onMutate: u, onError: d, onSettled: f }),
        (n[15] = c),
        (n[16] = u),
        (n[17] = d),
        (n[18] = f),
...
function Nt() {
  let e = (0, It.c)(16),
    ...
    i = l(),
    a;
  e[0] === n ? (a = e[1]) : ((a = [...O, n]), (e[0] = n), (e[1] = a));
  let o = a,
    s;
  e[2] !== n || e[3] !== r?.configWriteTarget?.filePath
    ? ((s = (e) => {
        let { enabled: t } = e;
        return ve(`batch-write-config-value`, {
          hostId: n,
  ...
  e[5] !== t || e[6] !== o
    ? ((c = async (e) => {
      ...
      (u = (e, n, r) => {
        (v.error(`Failed to update Chronicle config`, {
          safe: { error: String(e) },
          sensitive: {},
        }),
  ...
  e[9] === i
    ? (d = e[10])
    : ((d = async () => {
        await Promise.all([i(O), i([`user-saved-config`])]);
      }),
      (e[9] = i),
      (e[10] = d));
  let f;
  return (
    e[11] !== s || e[12] !== c || e[13] !== u || e[14] !== d
...
function Pt(e, t) {
  return Object.assign(structuredClone(e), { features: { ...Ft(e.features, ge, t) } });
}
function Ft(e, t, n) {
...
function Bt({ onChronicleResearchPreviewToggled: e } = {}) {
  let t = _e(h),
    ...
    a = _t(),
    o = Nt(),
    { data: s, isLoading: c } = ce(B.CHRONICLE_CONSENT_ACCEPTED),
    { data: l, isLoading: u } = ye(He, n),
    [f, p] = (0, rn.useState)(!1),
    [m, _] = (0, rn.useState)(!1),
    [y, b] = (0, rn.useState)(null),
    [x, S] = (0, rn.useState)(!1),
    C = Ae(`chronicle-permissions`, {
    ...
    D = E || !w,
    O = at({
      accessibilityStatus: C.data?.accessibility,
      errorMessage: y,
      isSidecarPresent: C.data?.chronicleSidecarPresent === !0,
      isUpdatingChronicle: x,
      processState: C.data?.chronicleSidecarProcessState ?? `disabled`,
      screenRecordingStatus: C.data?.screenRecording,
    }),
    k = r.formatMessage({
  ...
  (0, rn.useEffect)(() => {
    m && lt(O.kind) && F(t, B.CHRONICLE_SETUP_COMPLETION_PENDING, !0);
  }, [m, t, O.kind]);
  let A = async ({ rememberConsentAccepted: n, showSetupDialog: r }) => {
      let a = T;
      (S(!0), b(null), p(!1), _(r));
      try {
        (n === !0 && (await F(t, B.CHRONICLE_CONSENT_ACCEPTED, !0)),
          r || F(t, B.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          await o.mutateAsync({ enabled: !0 }),
          e?.(a, !0),
          await i.invalidateQueries({ queryKey: d(`chronicle-permissions`) }));
      } catch (e) {
        let n = nn(e);
        (F(t, B.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          b(n),
          v.error(`Failed to enable Chronicle`, {
            safe: { errorMessage: n },
            sensitive: { error: e },
          }));
      } finally {
    ...
    j = async () => {
      let n = T;
      (S(!0), b(null), F(t, B.CHRONICLE_SETUP_COMPLETION_PENDING, !1));
      try {
        ...
        children: [
          (0, Z.jsx)(et, {
            ...
            description: (0, Z.jsx)(Kt, {
              isCheckingPermissions: C.data == null && C.isFetching,
              permissions: C.data,
              chronicleFeatureEnabled: T,
            ...
            control: (0, Z.jsx)(Fe, {
              ...
              children: (0, Z.jsx)(`span`, {
                className: V(`inline-flex`, !w && `cursor-not-allowed`),
                tabIndex: w ? void 0 : 0,
                children: (0, Z.jsx)(Ce, {
                  checked: T,
                  className: w ? void 0 : `pointer-events-none`,
                  disabled: D,
                  onChange: (e) => {
                    if (e) {
                      if (s === !0) {
          ...
          (0, Z.jsx)(ot, {
            ...
            setupState: O,
            onOpenChange: (e) => {
              (e || F(t, B.CHRONICLE_SETUP_COMPLETION_PENDING, !1), _(e));
            },
            onAskCodex: () => {
              (F(t, B.CHRONICLE_SETUP_COMPLETION_PENDING, !1), _(!1), a({ prefillPrompt: st }));
            },
          }),
        ],
      });
...
function Vt(e) {
  ...
  t[2] === s
    ...
    : ((u = s.formatMessage({
      ...
      (t[3] = u));
  let d;
  t[4] === u ? (d = t[5]) : ((d = (0, Z.jsx)(c, { title: u })), (t[4] = u), (t[5] = d));
  let f;
  t[6] !== l || t[7] !== d
    ? ((f = (0, Z.jsxs)(Ke, { children: [l, d] })), (t[6] = l), (t[7] = d), (t[8] = f))
    : (f = t[8]);
  let p, m;
  ...
  let T;
  t[20] !== n || t[21] !== C
    ? ((T = (0, Z.jsx)(ke, { color: `ghost`, disabled: n, onClick: C, children: w })),
      (t[20] = n),
      (t[21] = C),
      (t[22] = T))
    : (T = t[22]);
  ...
  let D;
  t[24] !== n || t[25] !== a
    ? ((D = (0, Z.jsx)(ke, { color: `primary`, loading: n, onClick: a, children: E })),
      (t[24] = n),
      (t[25] = a),
      (t[26] = D))
    : (D = t[26]);
  let O;
  t[27] !== T || t[28] !== D
    ? ((O = (0, Z.jsx)(Ke, { children: (0, Z.jsxs)(se, { className: Ee, children: [T, D] }) })),
      (t[27] = T),
      (t[28] = D),
      (t[29] = O))
    : (O = t[29]);
  ...
  return (
    t[33] !== o || t[34] !== r || t[35] !== k
      ? ((A = (0, Z.jsx)(le, { open: r, onOpenChange: o, size: `default`, children: k })),
        (t[33] = o),
        (t[34] = r),
        (t[35] = k),
        (t[36] = A))
                ...
                children: [
                  ...
                  (0, Z.jsx)(`button`, {
                    ...
                    children: (0, Z.jsx)(g, {
                      ...
                      values: {
                        status: (0, Z.jsx)(`span`, {
                          className: V(`font-medium`, en({ isChecking: r, status: n })),
...
function Zt(e) {
  let t = (0, X.c)(12),
    ...
    a;
  t[0] !== n || t[1] !== i
    ? ((a = V(`font-medium`, en({ isChecking: n, status: i }))), (t[0] = n), (t[1] = i), (t[2] = a))
    : (a = t[2]);
  let o;
  t[3] !== n || t[4] !== i
...
function on({
  ...
  return {
    chronicleResearchPreviewEnabled: e,
    chronicleResearchPreviewVisible: t,
    ...it({ isMemoryFeatureEnabled: n, memoryConfig: r }),
...
function cn({
  ...
  e.logProductEvent(Ge, { settingName: r, previousEnabled: t, selectedEnabled: n, ...i });
}
...
function fn() {
  let e = (0, hn.c)(98),
    ...
    u = pt(),
    { data: d } = ye(He, i),
    { data: f, isLoading: p } = ye(fe, i),
    m;
  e[0] === f ? (m = e[1]) : ((m = f === void 0 ? [] : f), (e[0] = f), (e[1] = m));
  let v = m,
    y;
  e[2] === u
    ? (y = e[3])
    : ((y = { queryConfig: { enabled: u, refetchOnMount: `always`, refetchOnWindowFocus: !0 } }),
      (e[2] = u),
      (e[3] = y));
  let { data: b } = Ae(`chronicle-permissions`, y),
    x = Dt(i),
    S;
  ...
  e[6] === i
    ? (D = e[7])
    : ((D = () => ve(`reset-memories-for-host`, { hostId: i })), (e[6] = i), (e[7] = D));
  let O, k;
  e[8] === t
    ? ((O = e[9]), (k = e[10]))
    : ((O = () => {
  ...
  e[11] !== D || e[12] !== O || e[13] !== k
    ? ((j = { mutationFn: D, onSuccess: O, onError: k }),
      (e[11] = D),
      (e[12] = O),
      (e[13] = k),
      (e[14] = j))
  ...
  let M = ze(j),
    ne = A(v, T),
    re;
  e[15] === v ? (re = e[16]) : ((re = v.find(mn)), (e[15] = v), (e[16] = re));
  let N = re?.enabled === !0,
    P = d?.config,
    F;
  e[17] === P ? (F = e[18]) : ((F = C(P)), (e[17] = P), (e[18] = F));
  let I = F,
    oe = d?.config,
    ce;
  e[19] === oe ? (ce = e[20]) : ((ce = we(oe, ge)), (e[19] = oe), (e[20] = ce));
  let de = ce === !0,
    pe = p || x.isPending || w.isPending || E.isPending || M.isPending,
    me = N && I.generateMemories && I.useMemories,
    he = a.kind === `local`,
    xe = he && u && b?.chronicleSidecarPresent === !0,
    Se;
  e[21] !== de || e[22] !== N || e[23] !== I || e[24] !== xe
    ? ((Se = {
        chronicleResearchPreviewEnabled: de,
        chronicleResearchPreviewVisible: xe,
        isMemoryFeatureEnabled: N,
        memoryConfig: I,
      }),
      (e[21] = de),
  ...
  let L = Ee,
    R;
  e[28] !== x || e[29] !== E || e[30] !== L || e[31] !== he || e[32] !== r || e[33] !== w
    ? ((R = (e) => {
        un({
          productLogger: r,
          previousState: L(),
          selectedEnabled: e,
          featureWrite: () => w.mutateAsync({ featureName: ee, enabled: e }),
          configWrite: () =>
            x.mutateAsync({
              edits: [
          ...
          ...(!e && he ? { chronicleDisable: () => E.mutateAsync({ enabled: !1 }) } : {}),
        });
      }),
      (e[28] = x),
      (e[29] = E),
  ...
  e[41] === n
    ...
    : ((V = n.formatMessage({
      ...
      (e[42] = V));
  let Pe;
  e[43] !== pe || e[44] !== me || e[45] !== De || e[46] !== V
    ? ((Pe = (0, Q.jsx)(et, {
        label: Ne,
        description: B,
        control: (0, Q.jsx)(Ce, { checked: me, disabled: pe, ariaLabel: V, onChange: De }),
      })),
      (e[43] = pe),
      (e[44] = me),
      (e[45] = De),
        ...
        ? (0, Q.jsx)(Bt, {
            onChronicleResearchPreviewToggled: (e, t) => {
              cn({
                ...
                state: L({ chronicleResearchPreviewEnabled: t }),
              });
            },
          })
        : null),
  ...
  e[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Fe = (0, Q.jsx)(g, { ...Y.skipToolAssistedChats })),
      (Ie = (0, Q.jsx)(g, {
      ...
      (e[53] = Ie))
    : ((Fe = e[52]), (Ie = e[53]));
  let Le = I.disableOnExternalContext,
    Re = pe || !N,
    Be;
  e[54] === n
    ? (Be = e[55])
    : ((Be = n.formatMessage({
      ...
      (e[55] = Be));
  let U;
  e[56] !== x || e[57] !== L || e[58] !== I.disableOnExternalContext || e[59] !== r
    ? ((U = (e) => {
        ln({
          productLogger: r,
          ...
          state: L({ memoryConfigPatch: { disableOnExternalContext: e } }),
          write: () =>
            x.mutateAsync({
              edits: [
    ...
    : (U = e[60]);
  let W;
  e[61] !== I.disableOnExternalContext || e[62] !== Re || e[63] !== Be || e[64] !== U
    ? ((W = (0, Q.jsx)(et, {
        label: Fe,
        description: Ie,
        control: (0, Q.jsx)(Ce, { checked: Le, disabled: Re, ariaLabel: Be, onChange: U }),
      })),
  ...
  e[70] === M.isPending
    ...
    : ((G = (0, Q.jsx)(et, {
      ...
      (e[71] = G));
  let Ye;
  e[72] !== Pe || e[73] !== H || e[74] !== W || e[75] !== G
    ? ((Ye = (0, Q.jsxs)(J, {
        className: `gap-2`,
        children: [
          Me,
          (0, Q.jsx)(J.Content, { children: (0, Q.jsxs)(St, { children: [Pe, H, W, G] }) }),
        ],
      })),
      (e[72] = Pe),
      (e[73] = H),
  ...
  e[80] === M.isPending
    ? (K = e[81])
    : ((K = (0, Q.jsx)(ke, { color: `ghost`, disabled: M.isPending, onClick: Ze, children: Qe })),
      (e[80] = M.isPending),
      (e[81] = K));
  let q;
  e[82] !== Oe || e[83] !== r
    ? ((q = () => {
        (r.logProductEvent(s, { resetScope: `all_memories` }), Oe());
      }),
      (e[82] = Oe),
      (e[83] = r),
      (e[84] = q))
  ...
  e[85] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (tt = e[85]);
  let nt;
  e[86] !== M.isPending || e[87] !== q
    ? ((nt = (0, Q.jsx)(ke, { color: `danger`, loading: M.isPending, onClick: q, children: tt })),
      (e[86] = M.isPending),
      (e[87] = q),
      (e[88] = nt))
    : (nt = e[88]);
  ...
  e[89] !== K || e[90] !== nt
    ? ((rt = (0, Q.jsxs)(qe, {
        children: [Xe, (0, Q.jsx)(Ke, { children: (0, Q.jsxs)(se, { children: [K, nt] }) })],
      })),
      (e[89] = K),
      (e[90] = nt),
      (e[91] = rt))
  ...
  let it;
  e[92] !== o || e[93] !== rt
    ? ((it = (0, Q.jsx)(le, { open: o, onOpenChange: l, size: `compact`, children: rt })),
      (e[92] = o),
      (e[93] = rt),
      (e[94] = it))
    : (it = e[94]);
  ...
  return (
    e[95] !== Ye || e[96] !== it
      ? ((at = (0, Q.jsxs)(Q.Fragment, { children: [Ye, it] })),
        (e[95] = Ye),
        (e[96] = it),
        (e[97] = at))
      : (at = e[97]),
...
function vn() {
  ...
  let { personality: a, setPersonality: o } = yt(i),
    s;
  ...
  e[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, $.jsx)(mt, { slug: `personalization` })), (e[22] = v))
    : (v = e[22]);
  let y;
  e[23] !== n || e[24] !== a || e[25] !== m || e[26] !== _ || e[27] !== o
    ? ((y = n
        ? (0, $.jsx)(J, {
    ...
    : (y = e[28]);
  let b;
  e[29] === r ? (b = e[30]) : ((b = (0, $.jsx)(yn, { hostId: r }, r)), (e[29] = r), (e[30] = b));
  let x;
  e[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(G, { electron: !0, extension: !0, children: (0, $.jsx)(fn, {}) })),
      (e[31] = x))
    : (x = e[31]);
  let S;
  return (
    e[32] !== y || e[33] !== b
      ? ((S = (0, $.jsxs)(ct, { title: v, children: [y, b, x] })),
        (e[32] = y),
        (e[33] = b),
        (e[34] = S))
      : (S = e[34]),
...
function yn(e) {
  let t = (0, xn.c)(40),
    ...
    { data: c, error: l, isFetching: u, refetch: f } = ye(wt, n),
    p;
  t[0] !== i || t[1] !== a || t[2] !== r
    ? ((p = (e, t) => {
  ...
  let _;
  t[7] !== p || t[8] !== m
    ? ((_ = { onSuccess: p, onError: m }), (t[7] = p), (t[8] = m), (t[9] = _))
    : (_ = t[9]);
  let v = re(`codex-agents-md-save`, _),
    y = c?.contents ?? ``,
    b = o ?? y,
    x = o != null && o !== y,
    S = c != null,
    ...
    T = l != null && c == null,
    E;
  t[10] !== b || t[11] !== n || t[12] !== x || t[13] !== S || t[14] !== w || t[15] !== v
    ? ((E = () => {
        !S || !x || w || v.mutate({ hostId: n, contents: b });
      }),
      (t[10] = b),
      (t[11] = n),
      (t[12] = x),
  ...
  let A;
  (t[19] !== O || t[20] !== k
    ? ((A = { accelerator: `CmdOrCtrl+S`, enabled: O, onKeyDown: k }),
      (t[19] = O),
      (t[20] = k),
      (t[21] = A))
    : (A = t[21]),
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, $.jsx)(g, { ...Y.customInstructions })), (t[26] = N))
    : (N = t[26]);
  let P;
