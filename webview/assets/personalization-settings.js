...
import { s as B, w as ne } from "./config-queries.js";
...
import { n as xe } from "./use-start-new-conversation.js";
import "./electron-menu-shortcuts.js";
import "./_defineProperty.js";
import { u as Se } from "./links.js";
import "./search-C0nm-Ej1.js";
import { r as Ce, t as we } from "./dropdown.js";
import "./chevron.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as Te } from "./toggle.js";
import { i as H, t as Ee } from "./settings-shared.js";
import { t as De } from "./use-personality.js";
import { t as Oe } from "./use-hotkey.js";
import { t as ke } from "./settings-host-context.js";
import { t as U } from "./settings-content-layout.js";
import { n as Ae } from "./settings-row.js";
import { n as je, t as W } from "./settings-group.js";
import { i as Me, r as Ne } from "./personalization-settings.search.js";
var G = w(),
  K = e(p(), 1),
  Pe = C(S, `codex-agents-md`, (e) => ({ params: { hostId: e }, staleTime: O.FIVE_SECONDS }));
function Fe(e) {
  return Le(e, Ie);
}
function Ie(e) {
...
function Le(e, t) {
  ...
  n[13] === a
    ? (p = n[14])
    : ((p = async () => {
        await Promise.all([a(B), a([`user-saved-config`])]);
      }),
      (n[13] = a),
      (n[14] = p));
  let m;
...
function Ve() {
  ...
  e[2] !== n || e[3] !== r?.configWriteTarget?.filePath
    ? ((s = (e) => {
        ...
        return u(`batch-write-config-value`, {
          hostId: n,
          edits: [{ keyPath: ze, value: t, mergeStrategy: `upsert` }],
  ...
  e[5] !== t || e[6] !== o
    ? ((c = async (e) => {
        ...
        return (
          t.setQueryData(o, (e) => (e == null ? e : { ...e, config: He(e.config, n) })),
  ...
  e[9] === i
    ? (d = e[10])
    : ((d = async () => {
        await Promise.all([i(B), i([`user-saved-config`])]);
      }),
      (e[9] = i),
      (e[10] = d));
  let p;
...
function He(e, t) {
  return Object.assign(structuredClone(e), { features: { ...Ue(e.features, ae, t) } });
}
function Ue(e, t, n) {
...
var q = m();
function We({ onChronicleResearchPreviewToggled: e } = {}) {
  let t = _(S),
    i = v(f),
    a = ee(),
    o = g(),
...
function J(e) {
  ...
  t[2] === s
    ...
    : ((l = s.formatMessage({
      ...
      (t[3] = l));
  let u;
  t[4] === l ? (u = t[5]) : ((u = (0, q.jsx)(he, { title: l })), (t[4] = l), (t[5] = u));
  let d;
  t[6] !== c || t[7] !== u
    ? ((d = (0, q.jsxs)(me, { children: [c, u] })), (t[6] = c), (t[7] = u), (t[8] = d))
    : (d = t[8]);
  let f, p;
  ...
  let S;
  t[20] !== n || t[21] !== b
    ? ((S = (0, q.jsx)(de, { color: `ghost`, disabled: n, onClick: b, children: x })),
      (t[20] = n),
      (t[21] = b),
      (t[22] = S))
    : (S = t[22]);
  ...
  let w;
  t[24] !== n || t[25] !== a
    ? ((w = (0, q.jsx)(de, { color: `primary`, loading: n, onClick: a, children: C })),
      (t[24] = n),
      (t[25] = a),
      (t[26] = w))
    : (w = t[26]);
  let T;
  t[27] !== S || t[28] !== w
    ? ((T = (0, q.jsx)(me, { children: (0, q.jsxs)(ve, { className: ye, children: [S, w] }) })),
      (t[27] = S),
      (t[28] = w),
      (t[29] = T))
    : (T = t[29]);
  ...
  return (
    t[33] !== o || t[34] !== r || t[35] !== E
      ? ((D = (0, q.jsx)(ge, { open: r, onOpenChange: o, size: `default`, children: E })),
        (t[33] = o),
        (t[34] = r),
        (t[35] = E),
        (t[36] = D))
...
function Z(e) {
  ...
  if (!r && l != null) {
    ...
    return (
      t[3] !== l || t[4] !== i
        ? ((e = (0, q.jsx)(Q, { permission: l, onOpenChronicleSetup: i })),
          (t[3] = l),
          (t[4] = i),
          (t[5] = e))
        : (e = t[5]),
  ...
  if (!r && s === `granted`) {
    let e =
      ...
      s;
    t[6] === a ? (s = t[7]) : ((s = (0, q.jsx)(Xe, { processState: a })), (t[6] = a), (t[7] = s));
    let c;
    t[8] !== e || t[9] !== s
      ? ((c = (0, q.jsx)(k, {
                    ...
                    children: (0, q.jsx)(k, {
                      ...
                      values: {
                        status: (0, q.jsx)(`span`, {
                          ...
                          children: (0, q.jsx)(Ze, { isChecking: r, status: n }),
                        }),
                      },
                    }),
                  }),
  ...
  return (
    t[19] !== r || t[20] !== s
      ? ((d = (0, q.jsx)(Ye, { isChecking: r, label: u, status: s })),
        (t[19] = r),
        (t[20] = s),
        (t[21] = d))
      : (d = t[21]),
...
function Q(e) {
  let t = (0, G.c)(8),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = (0, q.jsx)($, { permission: r })), (t[0] = r), (t[1] = i));
  let a;
...
function Ye(e) {
  ...
  let o;
  t[3] !== n || t[4] !== i
    ? ((o = (0, q.jsx)(Ze, { isChecking: n, status: i })), (t[3] = n), (t[4] = i), (t[5] = o))
    : (o = t[5]);
  let s;
  t[6] !== a || t[7] !== o
...
function ot() {
  ...
  let ue = re?.enabled === !0,
    fe = p?.config,
    pe;
  e[17] === fe ? (pe = e[18]) : ((pe = l(fe)), (e[17] = fe), (e[18] = pe));
  let V = pe,
    ye = p?.config,
    be;
  e[19] === ye ? (be = e[20]) : ((be = r(ye, ae)), (e[19] = ye), (e[20] = be));
  let xe = be === !0,
    Se = h || E.isPending || O.isPending || P.isPending || z.isPending,
    Ce = ue && V.generateMemories && V.useMemories,
    we = o.kind === `local`,
    H = we && f && w?.chronicleSidecarPresent === !0,
    Ee;
  e[21] !== xe || e[22] !== ue || e[23] !== V || e[24] !== H
    ? ((Ee = {
        chronicleResearchPreviewEnabled: xe,
        chronicleResearchPreviewVisible: H,
  ...
  let U = Oe,
    Pe;
  e[28] !== E || e[29] !== P || e[30] !== U || e[31] !== we || e[32] !== i || e[33] !== O
    ? ((Pe = (e) => {
        at({
          productLogger: i,
          previousState: U(),
          ...
          ...(!e && we ? { chronicleDisable: () => P.mutateAsync({ enabled: !1 }) } : {}),
        });
      }),
      (e[28] = E),
      (e[29] = P),
  ...
  e[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ze = (0, q.jsx)(k, { ...Me.memory })), (e[37] = ze))
    : (ze = e[37]);
  let Be;
  ...
  e[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((He = (0, q.jsx)(k, { ...Me.enableMemories })),
      (Ue = (0, q.jsx)(k, {
  ...
  e[41] === n
    ...
    : ((J = n.formatMessage({
      ...
      (e[42] = J));
  let Y;
  e[43] !== Se || e[44] !== Ce || e[45] !== Ie || e[46] !== J
    ? ((Y = (0, q.jsx)(Ae, {
        label: He,
        description: Ue,
        control: (0, q.jsx)(Te, { checked: Ce, disabled: Se, ariaLabel: J, onChange: Ie }),
      })),
      (e[43] = Se),
      (e[44] = Ce),
      (e[45] = Ie),
        ...
        ? (0, q.jsx)(We, {
            onChronicleResearchPreviewToggled: (e, t) => {
              rt({
                ...
                state: U({ chronicleResearchPreviewEnabled: t }),
              });
            },
          })
        : null),
  ...
  e[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ge = (0, q.jsx)(k, { ...Me.skipToolAssistedChats })),
      (Ke = (0, q.jsx)(k, {
      ...
      (e[53] = Ke))
    : ((Ge = e[52]), (Ke = e[53]));
  let qe = V.disableOnExternalContext,
    Je = Se || !ue,
    Z;
  e[54] === n
    ? (Z = e[55])
    : ((Z = n.formatMessage({
      ...
      (e[55] = Z));
  let Q;
  e[56] !== E || e[57] !== U || e[58] !== V.disableOnExternalContext || e[59] !== i
    ? ((Q = (e) => {
        it({
          productLogger: i,
          previousEnabled: V.disableOnExternalContext,
          selectedEnabled: e,
          settingName: `skip_tool_assisted_chats`,
          state: U({ memoryConfigPatch: { disableOnExternalContext: e } }),
          write: () =>
            E.mutateAsync({
              edits: [
      ...
      (e[56] = E),
      (e[57] = U),
      (e[58] = V.disableOnExternalContext),
      (e[59] = i),
      (e[60] = Q))
    : (Q = e[60]);
  let $;
  e[61] !== V.disableOnExternalContext || e[62] !== Je || e[63] !== Z || e[64] !== Q
    ? (($ = (0, q.jsx)(Ae, {
        label: Ge,
        description: Ke,
        control: (0, q.jsx)(Te, { checked: qe, disabled: Je, ariaLabel: Z, onChange: Q }),
      })),
      (e[61] = V.disableOnExternalContext),
      (e[62] = Je),
      (e[63] = Z),
      (e[64] = Q),
      (e[65] = $))
  ...
  e[70] === z.isPending
    ...
    : (($e = (0, q.jsx)(Ae, {
      ...
      (e[71] = $e));
  let et;
  e[72] !== Y || e[73] !== X || e[74] !== $ || e[75] !== $e
    ? ((et = (0, q.jsxs)(W, {
        id: Ne.memory,
        className: `gap-2`,
        children: [
          Be,
          (0, q.jsx)(W.Content, { children: (0, q.jsxs)(je, { children: [Y, X, $, $e] }) }),
        ],
      })),
      (e[72] = Y),
      (e[73] = X),
  ...
  e[80] === z.isPending
    ? (ut = e[81])
    : ((ut = (0, q.jsx)(de, { color: `ghost`, disabled: z.isPending, onClick: ot, children: lt })),
      (e[80] = z.isPending),
      (e[81] = ut));
  let dt;
  e[82] !== Re || e[83] !== i
    ? ((dt = () => {
        (i.logProductEvent(N, { resetScope: `all_memories` }), Re());
      }),
      (e[82] = Re),
      (e[83] = i),
      (e[84] = dt))
  ...
  e[86] !== z.isPending || e[87] !== dt
    ? ((pt = (0, q.jsx)(de, { color: `danger`, loading: z.isPending, onClick: dt, children: ft })),
      (e[86] = z.isPending),
      (e[87] = dt),
      (e[88] = pt))
    : (pt = e[88]);
  ...
  e[89] !== ut || e[90] !== pt
    ? ((mt = (0, q.jsxs)(_e, {
        children: [tt, (0, q.jsx)(me, { children: (0, q.jsxs)(ve, { children: [ut, pt] }) })],
      })),
      (e[89] = ut),
      (e[90] = pt),
      (e[91] = mt))
  ...
  let ht;
  e[92] !== s || e[93] !== mt
    ? ((ht = (0, q.jsx)(ge, { open: s, onOpenChange: d, size: `compact`, children: mt })),
      (e[92] = s),
      (e[93] = mt),
      (e[94] = ht))
    : (ht = e[94]);
  ...
  return (
    e[95] !== et || e[96] !== ht
      ? ((gt = (0, q.jsxs)(q.Fragment, { children: [et, ht] })),
        (e[95] = et),
        (e[96] = ht),
        (e[97] = gt))
      : (gt = e[97]),
...
function lt() {
  ...
  let { personality: a, setPersonality: o } = De(i),
    s;
  e[2] === t
    ? (s = e[3])
    : ((s = t.formatMessage({
  ...
  e[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, q.jsx)(H, { slug: `personalization` })), (e[22] = _))
    : (_ = e[22]);
  let v;
  e[23] !== n || e[24] !== a || e[25] !== m || e[26] !== g || e[27] !== o
    ? ((v = n
        ? (0, q.jsx)(W, {
            children: (0, q.jsx)(W.Content, {
              children: (0, q.jsx)(je, {
                children: (0, q.jsx)(Ae, {
                  label: (0, q.jsx)(k, {
  ...
  return (
    e[32] !== v || e[33] !== y
      ? ((x = (0, q.jsxs)(U, { title: _, children: [v, y, b] })),
        (e[32] = v),
        (e[33] = y),
        (e[34] = x))
      : (x = e[34]),
...
function ut(e) {
  let t = (0, G.c)(40),
    ...
    { data: c, error: l, isFetching: u, refetch: d } = y(Pe, n),
    f;
  t[0] !== i || t[1] !== a || t[2] !== r
    ? ((f = (e, t) => {
  ...
  t[24] === i
    ? (I = t[25])
    : ((I = i.formatMessage(Me.customInstructions)), (t[24] = i), (t[25] = I));
  let L = I,
    R;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, q.jsx)(k, { ...Me.customInstructions })), (t[26] = R))
    : (R = t[26]);
  let z;
