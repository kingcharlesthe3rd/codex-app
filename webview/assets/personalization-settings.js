...
function kt(e, t) {
  ...
  n[6] !== t || n[7] !== r || n[8] !== c
    ? ((u = async (e) => {
        ...
        return (
          r.setQueryData(c, (e) => (e == null ? e : { ...e, config: ne(e.config, n) })),
  ...
  n[10] !== r || n[11] !== c
    ? ((f = (e, t, n) => {
        (a.error(`Failed to update memory config`, { safe: {}, sensitive: { error: e } }),
  ...
  let g;
  return (
    n[15] !== l || n[16] !== u || n[17] !== f || n[18] !== m
      ? ((g = { mutationFn: l, onMutate: u, onError: f, onSettled: m }),
        (n[15] = l),
        (n[16] = u),
        (n[17] = f),
        (n[18] = m),
...
function Nt() {
  let e = (0, It.c)(16),
    ...
    i = fe(),
    o;
  e[0] === n ? (o = e[1]) : ((o = [...U, n]), (e[0] = n), (e[1] = o));
  let s = o,
    c;
  e[2] !== n || e[3] !== r?.configWriteTarget?.filePath
    ? ((c = (e) => {
        let { enabled: t } = e;
        return ae(`batch-write-config-value`, {
          hostId: n,
  ...
  e[5] !== t || e[6] !== s
    ? ((l = async (e) => {
        ...
        let r = t.getQueryData(s);
        return (
          t.setQueryData(s, (e) => (e == null ? e : { ...e, config: Pt(e.config, n) })),
      ...
      (f = (e, n, r) => {
        (a.error(`Failed to update Chronicle config`, {
          ...
          t.setQueryData(s, r?.previousUserConfig));
      }),
      (e[5] = t),
      (e[6] = s),
      (e[7] = l),
  ...
  let g;
  return (
    e[11] !== c || e[12] !== l || e[13] !== f || e[14] !== m
      ? ((g = { mutationFn: c, onMutate: l, onError: f, onSettled: m }),
        (e[11] = c),
        (e[12] = l),
        (e[13] = f),
        (e[14] = m),
...
function Pt(e, t) {
  return Object.assign(structuredClone(e), { features: { ...Ft(e.features, Ye, t) } });
}
function Ft(e, t, n) {
...
function Bt({ onChronicleResearchPreviewToggled: e } = {}) {
  let t = c(Te),
    ...
    o = pt(),
    s = Nt(),
    { data: l, isLoading: p } = We(O.CHRONICLE_CONSENT_ACCEPTED),
    { data: m, isLoading: g } = d(se, n),
    [_, v] = (0, rn.useState)(!1),
    [y, b] = (0, rn.useState)(!1),
    [x, C] = (0, rn.useState)(null),
    [w, E] = (0, rn.useState)(!1),
    D = T(`chronicle-permissions`, {
    ...
    ee = M || !k,
    N = Ie({
      accessibilityStatus: D.data?.accessibility,
      errorMessage: x,
      isSidecarPresent: D.data?.chronicleSidecarPresent === !0,
      isUpdatingChronicle: w,
      processState: D.data?.chronicleSidecarProcessState ?? `disabled`,
      screenRecordingStatus: D.data?.screenRecording,
    }),
    P = r.formatMessage({
  ...
  (0, rn.useEffect)(() => {
    y && Ne(N.kind) && B(t, O.CHRONICLE_SETUP_COMPLETION_PENDING, !0);
  }, [y, t, N.kind]);
  let F = async ({ rememberConsentAccepted: n, showSetupDialog: r }) => {
      let o = A;
      (E(!0), C(null), v(!1), b(r));
      try {
        (n === !0 && (await B(t, O.CHRONICLE_CONSENT_ACCEPTED, !0)),
          r || B(t, O.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          await s.mutateAsync({ enabled: !0 }),
          e?.(o, !0),
          await i.invalidateQueries({ queryKey: S(`chronicle-permissions`) }));
      } catch (e) {
        let n = nn(e);
        (B(t, O.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          C(n),
    ...
    I = async () => {
      let n = A;
      (E(!0), C(null), B(t, O.CHRONICLE_SETUP_COMPLETION_PENDING, !1));
      try {
        ...
        children: [
          (0, Z.jsx)(j, {
            ...
            description: (0, Z.jsx)(Kt, {
              isCheckingPermissions: D.data == null && D.isFetching,
              permissions: D.data,
            ...
            control: (0, Z.jsx)(ce, {
              ...
              children: (0, Z.jsx)(`span`, {
                className: ze(`inline-flex`, !k && `cursor-not-allowed`),
                tabIndex: k ? void 0 : 0,
                children: (0, Z.jsx)(Ge, {
                  checked: A,
          ...
          (0, Z.jsx)(ke, {
            ...
            setupState: N,
            onOpenChange: (e) => {
              (e || B(t, O.CHRONICLE_SETUP_COMPLETION_PENDING, !1), b(e));
            },
            onAskCodex: () => {
              (B(t, O.CHRONICLE_SETUP_COMPLETION_PENDING, !1), b(!1), o({ prefillPrompt: Me }));
            },
          }),
        ],
      });
...
function Vt(e) {
  ...
  t[2] === s
    ...
    : ((l = s.formatMessage({
      ...
      (t[3] = l));
  let u;
  t[4] === l ? (u = t[5]) : ((u = (0, Z.jsx)(dt, { title: l })), (t[4] = l), (t[5] = u));
  let d;
  t[6] !== c || t[7] !== u
    ? ((d = (0, Z.jsxs)(ot, { children: [c, u] })), (t[6] = c), (t[7] = u), (t[8] = d))
    : (d = t[8]);
  let f, p;
  ...
  let S;
  t[20] !== n || t[21] !== b
    ? ((S = (0, Z.jsx)(le, { color: `ghost`, disabled: n, onClick: b, children: x })),
      (t[20] = n),
      (t[21] = b),
      (t[22] = S))
    : (S = t[22]);
  ...
  let w;
  t[24] !== n || t[25] !== a
    ? ((w = (0, Z.jsx)(le, { color: `primary`, loading: n, onClick: a, children: C })),
      (t[24] = n),
      (t[25] = a),
      (t[26] = w))
    : (w = t[26]);
  let T;
  t[27] !== S || t[28] !== w
    ? ((T = (0, Z.jsx)(ot, { children: (0, Z.jsxs)(ct, { className: ut, children: [S, w] }) })),
      (t[27] = S),
      (t[28] = w),
      (t[29] = T))
    : (T = t[29]);
  ...
  return (
    t[33] !== o || t[34] !== r || t[35] !== E
      ? ((D = (0, Z.jsx)(rt, { open: r, onOpenChange: o, size: `default`, children: E })),
        (t[33] = o),
        (t[34] = r),
        (t[35] = E),
        (t[36] = D))
                ...
                children: [
                  ...
                  (0, Z.jsx)(`button`, {
                    ...
                    children: (0, Z.jsx)(q, {
                      ...
                      values: {
                        status: (0, Z.jsx)(`span`, {
                          className: ze(`font-medium`, en({ isChecking: r, status: n })),
...
function Zt(e) {
  let t = (0, X.c)(12),
    ...
    a;
  t[0] !== n || t[1] !== i
    ? ((a = ze(`font-medium`, en({ isChecking: n, status: i }))),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a))
    : (a = t[2]);
...
function on({
  ...
  return {
    chronicleResearchPreviewEnabled: e,
    chronicleResearchPreviewVisible: t,
    ...De({ isMemoryFeatureEnabled: n, memoryConfig: r }),
...
function cn({
  ...
  e.logProductEvent(he, { settingName: r, previousEnabled: t, selectedEnabled: n, ...i });
}
...
function fn() {
  let e = (0, hn.c)(98),
    ...
    l = Ae(),
    { data: m } = d(se, i),
    { data: h, isLoading: g } = d(Qe, i),
    _;
  e[0] === h ? (_ = e[1]) : ((_ = h === void 0 ? [] : h), (e[0] = h), (e[1] = _));
  let v = _,
    y;
  e[2] === l
    ? (y = e[3])
    : ((y = { queryConfig: { enabled: l, refetchOnMount: `always`, refetchOnWindowFocus: !0 } }),
      (e[2] = l),
      (e[3] = y));
  let { data: b } = T(`chronicle-permissions`, y),
    x = Dt(i),
    S;
  ...
  e[6] === i
    ? (D = e[7])
    : ((D = () => ae(`reset-memories-for-host`, { hostId: i })), (e[6] = i), (e[7] = D));
  let O, k;
  e[8] === t
    ? ((O = e[9]), (k = e[10]))
    : ((O = () => {
  ...
  let M = p(A),
    ee = Xe(v, w),
    N;
  e[15] === v ? (N = e[16]) : ((N = v.find(mn)), (e[15] = v), (e[16] = N));
  let F = N?.enabled === !0,
    I = m?.config,
    te;
  e[17] === I ? (te = e[18]) : ((te = ie(I)), (e[17] = I), (e[18] = te));
  let L = te,
    R = m?.config,
    z;
  e[19] === R ? (z = e[20]) : ((z = f(R, Ye)), (e[19] = R), (e[20] = z));
  let ne = z === !0,
    re = g || x.isPending || C.isPending || E.isPending || M.isPending,
    B = F && L.generateMemories && L.useMemories,
    ce = a.kind === `local`,
    V = ce && l && b?.chronicleSidecarPresent === !0,
    ue;
  e[21] !== ne || e[22] !== F || e[23] !== L || e[24] !== V
    ? ((ue = {
        chronicleResearchPreviewEnabled: ne,
  ...
  let H = fe,
    me;
  e[28] !== x || e[29] !== E || e[30] !== H || e[31] !== ce || e[32] !== r || e[33] !== C
    ? ((me = (e) => {
        un({
          productLogger: r,
          previousState: H(),
          selectedEnabled: e,
          featureWrite: () => C.mutateAsync({ featureName: $e, enabled: e }),
          configWrite: () =>
            x.mutateAsync({
              edits: [
          ...
          ...(!e && ce ? { chronicleDisable: () => E.mutateAsync({ enabled: !1 }) } : {}),
        });
      }),
      (e[28] = x),
      (e[29] = E),
  ...
  e[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ve = (0, Q.jsx)(q, { ...Y.memory })), (e[37] = ve))
    : (ve = e[37]);
  let ye;
  e[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, Q.jsx)(Ct.Header, {
        title: ve,
        subtitle: (0, Q.jsx)(q, {
  ...
  e[41] === n
    ...
    : ((G = n.formatMessage({
      ...
      (e[42] = G));
  let K;
  e[43] !== re || e[44] !== B || e[45] !== he || e[46] !== G
    ? ((K = (0, Q.jsx)(j, {
        label: xe,
        description: W,
        control: (0, Q.jsx)(Ge, { checked: B, disabled: re, ariaLabel: G, onChange: he }),
      })),
      (e[43] = re),
      (e[44] = B),
      (e[45] = he),
  ...
  e[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((J = (0, Q.jsx)(q, { ...Y.skipToolAssistedChats })),
      (Ee = (0, Q.jsx)(q, {
      ...
      (e[53] = Ee))
    : ((J = e[52]), (Ee = e[53]));
  let De = L.disableOnExternalContext,
    Oe = re || !F,
    ke;
  e[54] === n
    ? (ke = e[55])
    : ((ke = n.formatMessage({
      ...
      (e[55] = ke));
  let je;
  e[56] !== x || e[57] !== H || e[58] !== L.disableOnExternalContext || e[59] !== r
    ? ((je = (e) => {
        ln({
          productLogger: r,
          previousEnabled: L.disableOnExternalContext,
          selectedEnabled: e,
          settingName: `skip_tool_assisted_chats`,
          state: H({ memoryConfigPatch: { disableOnExternalContext: e } }),
          write: () =>
            x.mutateAsync({
              edits: [
      ...
      (e[56] = x),
      (e[57] = H),
      (e[58] = L.disableOnExternalContext),
      (e[59] = r),
      (e[60] = je))
    : (je = e[60]);
  let Me;
  e[61] !== L.disableOnExternalContext || e[62] !== Oe || e[63] !== ke || e[64] !== je
    ? ((Me = (0, Q.jsx)(j, {
        label: J,
        description: Ee,
        control: (0, Q.jsx)(Ge, { checked: De, disabled: Oe, ariaLabel: ke, onChange: je }),
      })),
      (e[61] = L.disableOnExternalContext),
      (e[62] = Oe),
      (e[63] = ke),
      (e[64] = je),
      (e[65] = Me))
  ...
  e[70] === M.isPending
    ...
    : ((Le = (0, Q.jsx)(j, {
      ...
      (e[71] = Le));
  let Re;
  e[72] !== K || e[73] !== Ce || e[74] !== Me || e[75] !== Le
    ? ((Re = (0, Q.jsxs)(Ct, {
        className: `gap-2`,
        children: [
          ye,
          (0, Q.jsx)(Ct.Content, { children: (0, Q.jsxs)(gt, { children: [K, Ce, Me, Le] }) }),
        ],
      })),
      (e[72] = K),
      (e[73] = Ce),
  ...
  e[80] === M.isPending
    ? (He = e[81])
    : ((He = (0, Q.jsx)(le, { color: `ghost`, disabled: M.isPending, onClick: Be, children: Ve })),
      (e[80] = M.isPending),
      (e[81] = He));
  let Ue;
  e[82] !== ge || e[83] !== r
    ? ((Ue = () => {
        (r.logProductEvent(pe, { resetScope: `all_memories` }), ge());
      }),
      (e[82] = ge),
      (e[83] = r),
      (e[84] = Ue))
  ...
  e[85] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (We = e[85]);
  let Ke;
  e[86] !== M.isPending || e[87] !== Ue
    ? ((Ke = (0, Q.jsx)(le, { color: `danger`, loading: M.isPending, onClick: Ue, children: We })),
      (e[86] = M.isPending),
      (e[87] = Ue),
      (e[88] = Ke))
    : (Ke = e[88]);
  ...
  e[89] !== He || e[90] !== Ke
    ? ((qe = (0, Q.jsxs)(ft, {
        children: [ze, (0, Q.jsx)(ot, { children: (0, Q.jsxs)(ct, { children: [He, Ke] }) })],
      })),
      (e[89] = He),
      (e[90] = Ke),
      (e[91] = qe))
  ...
  let Ze;
  e[92] !== o || e[93] !== qe
    ? ((Ze = (0, Q.jsx)(rt, { open: o, onOpenChange: s, size: `compact`, children: qe })),
      (e[92] = o),
      (e[93] = qe),
      (e[94] = Ze))
    : (Ze = e[94]);
  ...
  return (
    e[95] !== Re || e[96] !== Ze
      ? ((et = (0, Q.jsxs)(Q.Fragment, { children: [Re, Ze] })),
        (e[95] = Re),
        (e[96] = Ze),
        (e[97] = et))
      : (et = e[97]),
...
function vn() {
  ...
  let { personality: a, setPersonality: o } = bt(i),
    s;
  ...
  e[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(vt, { slug: `personalization` })), (e[22] = _))
    : (_ = e[22]);
  let v;
  ...
  e[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, $.jsx)(it, { electron: !0, extension: !0, children: (0, $.jsx)(fn, {}) })),
      (e[31] = b))
    : (b = e[31]);
  let x;
  return (
    e[32] !== v || e[33] !== y
      ? ((x = (0, $.jsxs)(Pe, { title: _, children: [v, y, b] })),
        (e[32] = v),
        (e[33] = y),
        (e[34] = x))
      : (x = e[34]),
...
function yn(e) {
  let t = (0, xn.c)(40),
    ...
    { data: l, error: u, isFetching: f, refetch: p } = d(wt, n),
    m;
  t[0] !== i || t[1] !== a || t[2] !== r
    ? ((m = (e, t) => {
  ...
  let _;
  t[7] !== m || t[8] !== g
    ? ((_ = { onSuccess: m, onError: g }), (t[7] = m), (t[8] = g), (t[9] = _))
    : (_ = t[9]);
  let y = v(`codex-agents-md-save`, _),
    ...
    D = u != null && l == null,
    O;
  t[10] !== x || t[11] !== n || t[12] !== C || t[13] !== w || t[14] !== E || t[15] !== y
    ? ((O = () => {
        !w || !C || E || y.mutate({ hostId: n, contents: x });
      }),
      (t[10] = x),
      (t[11] = n),
      (t[12] = C),
  ...
  let ee;
  (t[19] !== j || t[20] !== M
    ? ((ee = { accelerator: `CmdOrCtrl+S`, enabled: j, onKeyDown: M }),
      (t[19] = j),
      (t[20] = M),
      (t[21] = ee))
    : (ee = t[21]),
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = (0, $.jsx)(q, { ...Y.customInstructions })), (t[26] = L))
    : (L = t[26]);
  let R;
