...
import { Ai as u, M as d, ji as f, ta as p } from "./thread-context-inputs.js";
import { A as m, _ as h, h as g, i as _, o as v, r as y, s as b, u as x } from "./vscode-api.js";
import "./isEqual.js";
import { Aa as S, Br as C, En as w, Oa as T, ba as E, ta as D } from "./src.js";
import "./react-dom.js";
import { i as O, l as ee, s as k } from "./lib-1.js";
import { t as A } from "./clsx.js";
import "./proxy.js";
import { t as j } from "./button-oF-qgtAS.js";
...
function Ie() {
  ...
  let v;
  return (
    e[11] !== u || e[12] !== f || e[13] !== p || e[14] !== _
      ? ((v = { mutationFn: u, onMutate: f, onError: p, onSettled: _ }),
        (e[11] = u),
        (e[12] = f),
        (e[13] = p),
        (e[14] = _),
...
function ze({ onChronicleResearchPreviewToggled: e } = {}) {
  let t = a(s),
    ...
    l = ve(),
    u = Ie(),
    { data: f, isLoading: h } = G(C.CHRONICLE_CONSENT_ACCEPTED),
  ...
  (0, X.useEffect)(() => {
    w && B(R.kind) && p(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !0);
  }, [w, t, R.kind]);
  let U = async ({ rememberConsentAccepted: n, showSetupDialog: r }) => {
      let i = I;
      (M(!0), O(null), S(!1), T(r));
      try {
        (n === !0 && (await p(t, C.CHRONICLE_CONSENT_ACCEPTED, !0)),
          r || p(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          await u.mutateAsync({ enabled: !0 }),
          e?.(i, !0),
          await c.invalidateQueries({ queryKey: y(`chronicle-permissions`) }));
      } catch (e) {
        let n = et(e);
        (p(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          O(n),
    ...
    re = async () => {
      let n = I;
      (M(!0), O(null), p(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1));
      try {
    ...
    : (0, Q.jsxs)(Q.Fragment, {
        children: [
          ...
          (0, Q.jsx)(z, {
            ...
            setupState: R,
            onOpenChange: (e) => {
              (e || p(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1), T(e));
            },
            onAskCodex: () => {
              (p(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1), T(!1), l({ prefillPrompt: H }));
            },
          }),
        ],
      });
...
function ot() {
  ...
  let ne = H?.enabled === !0,
    re = _?.config,
    W;
  e[17] === re ? (W = e[18]) : ((W = f(re)), (e[17] = re), (e[18] = W));
  let G = W,
    ue = _?.config,
    fe;
