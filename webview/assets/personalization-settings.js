...
import { Ht as t, Ji as n, Zn as r, ia as i, na as a, zr as o } from "./src-2.js";
import {
  Bo as s,
  Gi as c,
  Ki as l,
...
import { v as A } from "./persisted-signal.js";
import "./rpc-2.js";
...
import { t as z } from "./use-global-state.js";
import { t as B } from "./invalidate-queries-and-broadcast.js";
import "./thread-context-inputs.js";
import { C as ne, s as V } from "./config-queries.js";
import "./_baseEach.js";
import "./_baseOrderBy.js";
import { a as re, i as ie, n as ae, o as oe, r as se } from "./experimental-features-queries.js";
...
import { a as fe, d as U, i as pe, l as me, n as he, r as ge, t as _e } from "./dialog-layout.js";
...
import "./search.js";
import { r as xe, t as Se } from "./dropdown.js";
import "./chevron.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as Ce } from "./toggle.js";
import { i as W, t as we } from "./settings-shared.js";
import { t as Te } from "./use-personality.js";
import { t as Ee } from "./use-hotkey.js";
...
import { n as ke, t as K } from "./settings-group.js";
import { i as Ae, r as je } from "./personalization-settings.search.js";
var q = w(),
  J = e(p(), 1),
...
function Fe(e, t) {
  ...
  n[6] !== t || n[7] !== r || n[8] !== s
    ? ((d = async (e) => {
        ...
        return (
          r.setQueryData(s, (e) => (e == null ? e : { ...e, config: c(e.config, n) })),
  ...
  n[13] === a
    ? (p = n[14])
    : ((p = async () => {
        await Promise.all([a(V), a([`user-saved-config`])]);
      }),
      (n[13] = a),
      (n[14] = p));
  let m;
...
function ze() {
  ...
  e[2] !== n || e[3] !== r?.configWriteTarget?.filePath
    ? ((s = (e) => {
        ...
        return u(`batch-write-config-value`, {
          hostId: n,
          edits: [{ keyPath: Le, value: t, mergeStrategy: `upsert` }],
  ...
  e[5] !== t || e[6] !== o
    ? ((c = async (e) => {
        ...
        return (
          t.setQueryData(o, (e) => (e == null ? e : { ...e, config: Be(e.config, n) })),
  ...
  e[9] === i
    ? (d = e[10])
    : ((d = async () => {
        await Promise.all([i(V), i([`user-saved-config`])]);
      }),
      (e[9] = i),
      (e[10] = d));
  let p;
...
function Be(e, t) {
  return Object.assign(structuredClone(e), { features: { ...Ve(e.features, ie, t) } });
}
function Ve(e, t, n) {
  let r = Re.safeParse(e);
  return { ...(r.success ? r.data : {}), [t]: n };
}
var Y = m();
function He({ onChronicleResearchPreviewToggled: e } = {}) {
  let n = _(S),
    r = v(f),
    i = ee(),
    a = g(),
    s = ye(),
    c = ze(),
    { data: l, isLoading: u } = z(o.CHRONICLE_CONSENT_ACCEPTED),
    { data: p, isLoading: m } = y(ne, r),
    [b, C] = (0, J.useState)(!1),
    [w, D] = (0, J.useState)(!1),
    [O, A] = (0, J.useState)(null),
    [j, M] = (0, J.useState)(!1),
  ...
  (0, J.useEffect)(() => {
    w && F(ae.kind) && d(n, o.CHRONICLE_SETUP_COMPLETION_PENDING, !0);
  }, [w, n, ae.kind]);
  let se = async ({ rememberConsentAccepted: t, showSetupDialog: r }) => {
      let i = I;
      (M(!0), A(null), C(!1), D(r));
      try {
        (t === !0 && (await d(n, o.CHRONICLE_CONSENT_ACCEPTED, !0)),
          r || d(n, o.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          await c.mutateAsync({ enabled: !0 }),
          e?.(i, !0),
          await a.invalidateQueries({ queryKey: E(`chronicle-permissions`) }));
      } catch (e) {
        let t = et(e);
        (d(n, o.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          A(t),
    ...
    ce = async () => {
      let t = I;
      (M(!0), A(null), d(n, o.CHRONICLE_SETUP_COMPLETION_PENDING, !1));
      try {
        (await c.mutateAsync({ enabled: !1 }), e?.(t, !1));
      } catch {
      } finally {
        M(!1);
      }
    ...
    : (0, Y.jsxs)(Y.Fragment, {
        children: [
          ...
          (0, Y.jsx)(X, {
            open: b,
            onOpenChange: C,
            chronicleDisplayName: oe,
            isPending: B,
            onContinue: () => {
              se({ rememberConsentAccepted: !0, showSetupDialog: !0 });
            },
          }),
          (0, Y.jsx)(te, {
            open: w,
            setupState: ae,
            onOpenChange: (e) => {
              (e || d(n, o.CHRONICLE_SETUP_COMPLETION_PENDING, !1), D(e));
            },
            onAskCodex: () => {
              (d(n, o.CHRONICLE_SETUP_COMPLETION_PENDING, !1), D(!1), s({ prefillPrompt: L }));
            },
          }),
        ],
      });
...
function X(e) {
  ...
  t[0] === i
    ...
    : ((c = (0, Y.jsx)(U, {
        asChild: !0,
        children: (0, Y.jsx)(`h2`, { className: `sr-only`, children: i }),
      })),
      (t[0] = i),
      (t[1] = c));
  let l;
  t[2] === s
    ...
    : ((l = s.formatMessage({
      ...
      (t[3] = l));
  let u;
  t[4] === l ? (u = t[5]) : ((u = (0, Y.jsx)(pe, { title: l })), (t[4] = l), (t[5] = u));
  let d;
  t[6] !== c || t[7] !== u
    ? ((d = (0, Y.jsxs)(fe, { children: [c, u] })), (t[6] = c), (t[7] = u), (t[8] = d))
    : (d = t[8]);
  let f, p;
  ...
  let S;
  t[20] !== n || t[21] !== b
    ? ((S = (0, Y.jsx)(H, { color: `ghost`, disabled: n, onClick: b, children: x })),
      (t[20] = n),
      (t[21] = b),
      (t[22] = S))
    : (S = t[22]);
  ...
  let w;
  t[24] !== n || t[25] !== a
    ? ((w = (0, Y.jsx)(H, { color: `primary`, loading: n, onClick: a, children: C })),
      (t[24] = n),
      (t[25] = a),
      (t[26] = w))
    : (w = t[26]);
  let T;
  t[27] !== S || t[28] !== w
    ? ((T = (0, Y.jsx)(fe, { children: (0, Y.jsxs)(ge, { className: _e, children: [S, w] }) })),
      (t[27] = S),
      (t[28] = w),
      (t[29] = T))
    : (T = t[29]);
  ...
  return (
    t[33] !== o || t[34] !== r || t[35] !== E
      ? ((D = (0, Y.jsx)(me, { open: r, onOpenChange: o, size: `default`, children: E })),
        (t[33] = o),
        (t[34] = r),
        (t[35] = E),
        (t[36] = D))
...
function Q(e) {
  return (0, Y.jsx)(`span`, { className: `font-bold text-token-foreground/90`, children: e });
}
function Ue(e) {
  return (0, Y.jsx)(`span`, { className: `font-bold text-token-foreground/90`, children: e });
}
...
function $(e) {
  ...
  if (!r && l != null) {
    ...
    return (
      t[3] !== l || t[4] !== i
        ? ((e = (0, Y.jsx)(qe, { permission: l, onOpenChronicleSetup: i })),
          (t[3] = l),
          (t[4] = i),
          (t[5] = e))
        : (e = t[5]),
  ...
  if (!r && s === `granted`) {
    let e =
      ...
      s;
    t[6] === a ? (s = t[7]) : ((s = (0, Y.jsx)(Xe, { processState: a })), (t[6] = a), (t[7] = s));
    let c;
    t[8] !== e || t[9] !== s
      ? ((c = (0, Y.jsx)(k, {
          ...
          values: { status: (0, Y.jsx)(`span`, { className: e, children: s }) },
        })),
        (t[8] = e),
        (t[9] = s),
        (t[10] = c))
                    ...
                    children: (0, Y.jsx)(k, {
                      ...
                      values: {
                        status: (0, Y.jsx)(`span`, {
                          ...
                          children: (0, Y.jsx)(Ze, { isChecking: r, status: n }),
                        }),
                      },
                    }),
                  }),
    ...
    return (
      t[15] !== c || t[16] !== l
        ? ((u = (0, Y.jsx)(`span`, {
            ...
            children: (0, Y.jsxs)(`span`, { className: `min-w-0 truncate`, children: [c, l] }),
          })),
          (t[15] = c),
          (t[16] = l),
          (t[17] = u))
  ...
  return (
    t[19] !== r || t[20] !== s
      ? ((d = (0, Y.jsx)(Ye, { isChecking: r, label: u, status: s })),
        (t[19] = r),
        (t[20] = s),
        (t[21] = d))
      : (d = t[21]),
...
function qe(e) {
  let t = (0, q.c)(8),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = (0, Y.jsx)(Je, { permission: r })), (t[0] = r), (t[1] = i));
  let a;
...
function Ye(e) {
  ...
  let o;
  t[3] !== n || t[4] !== i
    ? ((o = (0, Y.jsx)(Ze, { isChecking: n, status: i })), (t[3] = n), (t[4] = i), (t[5] = o))
    : (o = t[5]);
  let s;
  t[6] !== a || t[7] !== o
    ? ((s = (0, Y.jsx)(`span`, { className: a, children: o })), (t[6] = a), (t[7] = o), (t[8] = s))
    : (s = t[8]);
  let c;
  return (
    t[9] !== r || t[10] !== s
...
function ot() {
  ...
  let z = b(R),
    B = oe(x, te),
    V;
  e[15] === x ? (V = e[16]) : ((V = x.find(ct)), (e[15] = x), (e[16] = V));
  let le = V?.enabled === !0,
    ue = p?.config,
    de;
  e[17] === ue ? (de = e[18]) : ((de = l(ue)), (e[17] = ue), (e[18] = de));
  let U = de,
    _e = p?.config,
    ve;
  e[19] === _e ? (ve = e[20]) : ((ve = t(_e, ie)), (e[19] = _e), (e[20] = ve));
  let ye = ve === !0,
    be = h || E.isPending || O.isPending || P.isPending || z.isPending,
    xe = le && U.generateMemories && U.useMemories,
    Se = o.kind === `local`,
    W = Se && f && w?.chronicleSidecarPresent === !0,
    we;
  e[21] !== ye || e[22] !== le || e[23] !== U || e[24] !== W
    ? ((we = {
        chronicleResearchPreviewEnabled: ye,
        chronicleResearchPreviewVisible: W,
        isMemoryFeatureEnabled: le,
        memoryConfig: U,
      }),
      (e[21] = ye),
      (e[22] = le),
  ...
  let G = Ee,
    Me;
  e[28] !== E || e[29] !== P || e[30] !== G || e[31] !== Se || e[32] !== i || e[33] !== O
    ? ((Me = (e) => {
        at({
          productLogger: i,
          previousState: G(),
          selectedEnabled: e,
          featureWrite: () => O.mutateAsync({ featureName: re, enabled: e }),
          configWrite: () =>
            E.mutateAsync({
              edits: [
          ...
          ...(!e && Se ? { chronicleDisable: () => P.mutateAsync({ enabled: !1 }) } : {}),
        });
      }),
      (e[28] = E),
      (e[29] = P),
  ...
  e[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Le = (0, Y.jsx)(k, { ...Ae.memory })), (e[37] = Le))
    : (Le = e[37]);
  let Re;
  ...
  e[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Be = (0, Y.jsx)(k, { ...Ae.enableMemories })),
      (Ve = (0, Y.jsx)(k, {
  ...
  e[41] === r
    ...
    : ((X = r.formatMessage({
      ...
      (e[42] = X));
  let Z;
  e[43] !== be || e[44] !== xe || e[45] !== Pe || e[46] !== X
    ? ((Z = (0, Y.jsx)(Oe, {
        label: Be,
        description: Ve,
        control: (0, Y.jsx)(Ce, { checked: xe, disabled: be, ariaLabel: X, onChange: Pe }),
      })),
      (e[43] = be),
      (e[44] = xe),
      (e[45] = Pe),
  ...
  e[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = (0, Y.jsx)(k, { ...Ae.skipToolAssistedChats })),
      (We = (0, Y.jsx)(k, {
      ...
      (e[53] = We))
    : ((Ue = e[52]), (We = e[53]));
  let Ge = U.disableOnExternalContext,
    Ke = be || !le,
    $;
  e[54] === r
    ? ($ = e[55])
    : (($ = r.formatMessage({
      ...
      (e[55] = $));
  let qe;
  e[56] !== E || e[57] !== G || e[58] !== U.disableOnExternalContext || e[59] !== i
    ? ((qe = (e) => {
        it({
          productLogger: i,
          previousEnabled: U.disableOnExternalContext,
          selectedEnabled: e,
          settingName: `skip_tool_assisted_chats`,
          state: G({ memoryConfigPatch: { disableOnExternalContext: e } }),
          write: () =>
            E.mutateAsync({
              edits: [
      ...
      (e[56] = E),
      (e[57] = G),
      (e[58] = U.disableOnExternalContext),
      (e[59] = i),
      (e[60] = qe))
    : (qe = e[60]);
  let Je;
  e[61] !== U.disableOnExternalContext || e[62] !== Ke || e[63] !== $ || e[64] !== qe
    ? ((Je = (0, Y.jsx)(Oe, {
        label: Ue,
        description: We,
        control: (0, Y.jsx)(Ce, { checked: Ge, disabled: Ke, ariaLabel: $, onChange: qe }),
      })),
      (e[61] = U.disableOnExternalContext),
      (e[62] = Ke),
      (e[63] = $),
      (e[64] = qe),
      (e[65] = Je))
  ...
  e[70] === z.isPending
    ...
    : (($e = (0, Y.jsx)(Oe, {
      ...
      (e[71] = $e));
  let et;
  e[72] !== Z || e[73] !== Q || e[74] !== Je || e[75] !== $e
    ? ((et = (0, Y.jsxs)(K, {
        id: je.memory,
        className: `gap-2`,
        children: [
          Re,
          (0, Y.jsx)(K.Content, { children: (0, Y.jsxs)(ke, { children: [Z, Q, Je, $e] }) }),
        ],
      })),
      (e[72] = Z),
      (e[73] = Q),
  ...
  e[80] === z.isPending
    ? (ut = e[81])
    : ((ut = (0, Y.jsx)(H, { color: `ghost`, disabled: z.isPending, onClick: ot, children: lt })),
      (e[80] = z.isPending),
      (e[81] = ut));
  let dt;
  e[82] !== Ie || e[83] !== i
    ? ((dt = () => {
        (i.logProductEvent(N, { resetScope: `all_memories` }), Ie());
      }),
      (e[82] = Ie),
      (e[83] = i),
      (e[84] = dt))
  ...
  e[86] !== z.isPending || e[87] !== dt
    ? ((pt = (0, Y.jsx)(H, { color: `danger`, loading: z.isPending, onClick: dt, children: ft })),
      (e[86] = z.isPending),
      (e[87] = dt),
      (e[88] = pt))
    : (pt = e[88]);
  ...
  e[89] !== ut || e[90] !== pt
    ? ((mt = (0, Y.jsxs)(he, {
        children: [tt, (0, Y.jsx)(fe, { children: (0, Y.jsxs)(ge, { children: [ut, pt] }) })],
      })),
      (e[89] = ut),
      (e[90] = pt),
      (e[91] = mt))
  ...
  let ht;
  e[92] !== c || e[93] !== mt
    ? ((ht = (0, Y.jsx)(me, { open: c, onOpenChange: d, size: `compact`, children: mt })),
      (e[92] = c),
      (e[93] = mt),
      (e[94] = ht))
    : (ht = e[94]);
  ...
  return (
    e[95] !== et || e[96] !== ht
      ? ((gt = (0, Y.jsxs)(Y.Fragment, { children: [et, ht] })),
        (e[95] = et),
        (e[96] = ht),
        (e[97] = gt))
      : (gt = e[97]),
...
function lt() {
  ...
  let { personality: a, setPersonality: o } = Te(i),
    s;
  e[2] === t
    ? (s = e[3])
    : ((s = t.formatMessage({
  ...
  e[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Y.jsx)(W, { slug: `personalization` })), (e[22] = _))
    : (_ = e[22]);
  let v;
  e[23] !== n || e[24] !== a || e[25] !== m || e[26] !== g || e[27] !== o
    ? ((v = n
        ? (0, Y.jsx)(K, {
            children: (0, Y.jsx)(K.Content, {
              children: (0, Y.jsx)(ke, {
                children: (0, Y.jsx)(Oe, {
                  label: (0, Y.jsx)(k, {
    ...
    : (v = e[28]);
  let y;
  e[29] === r ? (y = e[30]) : ((y = (0, Y.jsx)(ut, { hostId: r }, r)), (e[29] = r), (e[30] = y));
  let b;
  e[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Y.jsx)(de, { electron: !0, extension: !0, children: (0, Y.jsx)(ot, {}) })),
      (e[31] = b))
    : (b = e[31]);
  let x;
  return (
    e[32] !== v || e[33] !== y
      ? ((x = (0, Y.jsxs)(G, { title: _, children: [v, y, b] })),
        (e[32] = v),
        (e[33] = y),
        (e[34] = x))
      : (x = e[34]),
...
function ut(e) {
  let t = (0, q.c)(40),
    ...
    { data: c, error: l, isFetching: u, refetch: d } = y(Me, n),
    f;
  t[0] !== i || t[1] !== a || t[2] !== r
    ? ((f = (e, t) => {
  ...
  t[24] === i
    ? (I = t[25])
    : ((I = i.formatMessage(Ae.customInstructions)), (t[24] = i), (t[25] = I));
  let L = I,
    R;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, Y.jsx)(k, { ...Ae.customInstructions })), (t[26] = R))
    : (R = t[26]);
  let z;
