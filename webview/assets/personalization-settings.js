...
import { Gi as t, Gn as n, Li as r, Rt as i, kr as a, qi as o } from "./src-C.js";
import {
  Li as s,
  Xs as c,
  bi as l,
...
import { r as A } from "./product-logger.js";
import "./rpc.js";
...
import { C as N, s as P } from "./config-queries.js";
import "./_baseEach.js";
...
import { a as ie, d as U, i as ae, l as oe, n as se, r as ce, t as le } from "./dialog-layout.js";
...
var q = k(),
  ...
  Y = w(v, `codex-agents-md`, (e) => ({ params: { hostId: e }, staleTime: C.FIVE_SECONDS }));
function ke(e) {
  return je(e, Ae);
}
function Ae(e) {
...
function je(e, t) {
  ...
  n[6] !== t || n[7] !== r || n[8] !== s
    ? ((d = async (e) => {
        ...
        return (
          r.setQueryData(s, (e) => (e == null ? e : { ...e, config: l(e.config, n) })),
...
function Fe() {
  ...
  e[5] !== t || e[6] !== o
    ? ((l = async (e) => {
        ...
        return (
          t.setQueryData(o, (e) => (e == null ? e : { ...e, config: Ie(e.config, n) })),
...
function Ie(e, t) {
  return Object.assign(structuredClone(e), { features: { ...Le(e.features, F, t) } });
}
function Le(e, t, n) {
    ...
    : (0, X.jsxs)(X.Fragment, {
        children: [
          ...
          (0, X.jsx)(Se, {
            ...
            onAskCodex: () => {
              (s(t, a.CHRONICLE_SETUP_COMPLETION_PENDING, !1), O(!1), c({ prefillPrompt: Ce }));
            },
          }),
        ],
      });
...
function ze(e) {
  ...
  t[2] === s
    ...
    : ((l = s.formatMessage({
      ...
      (t[3] = l));
  let u;
  t[4] === l ? (u = t[5]) : ((u = (0, X.jsx)(ae, { title: l })), (t[4] = l), (t[5] = u));
  let d;
  t[6] !== c || t[7] !== u
    ? ((d = (0, X.jsxs)(ie, { children: [c, u] })), (t[6] = c), (t[7] = u), (t[8] = d))
    : (d = t[8]);
  let f, p;
  ...
  let C;
  t[20] !== n || t[21] !== x
    ? ((C = (0, X.jsx)(B, { color: `ghost`, disabled: n, onClick: x, children: S })),
      (t[20] = n),
      (t[21] = x),
      (t[22] = C))
    : (C = t[22]);
  ...
  let T;
  t[24] !== n || t[25] !== a
    ? ((T = (0, X.jsx)(B, { color: `primary`, loading: n, onClick: a, children: w })),
      (t[24] = n),
      (t[25] = a),
      (t[26] = T))
    : (T = t[26]);
  let E;
  t[27] !== C || t[28] !== T
    ? ((E = (0, X.jsx)(ie, { children: (0, X.jsxs)(ce, { className: le, children: [C, T] }) })),
      (t[27] = C),
      (t[28] = T),
      (t[29] = E))
    : (E = t[29]);
  ...
  return (
    t[33] !== o || t[34] !== r || t[35] !== D
      ? ((O = (0, X.jsx)(oe, { open: r, onOpenChange: o, size: `default`, children: D })),
        (t[33] = o),
        (t[34] = r),
        (t[35] = D),
        (t[36] = O))
...
function Q(e) {
  return (0, X.jsx)(`span`, { className: `font-bold text-token-foreground/90`, children: e });
}
function $(e) {
  return (0, X.jsx)(`span`, { className: `font-bold text-token-foreground/90`, children: e });
}
...
function Ue(e) {
  ...
  if (!r && s === `granted`) {
    let e =
      ...
      s;
    t[6] === a ? (s = t[7]) : ((s = (0, X.jsx)(qe, { processState: a })), (t[6] = a), (t[7] = s));
    let c;
    t[8] !== e || t[9] !== s
      ? ((c = (0, X.jsx)(y, {
                ...
                children: [
                  ...
                  (0, X.jsx)(`button`, {
                    ...
                    children: (0, X.jsx)(y, {
                      ...
                      values: {
                        status: (0, X.jsx)(`span`, {
                          className: h(`font-medium`, Ye({ isChecking: r, status: n })),
                          children: (0, X.jsx)(Je, { isChecking: r, status: n }),
                        }),
                      },
                    }),
                  }),
    ...
    return (
      t[15] !== c || t[16] !== l
        ? ((u = (0, X.jsx)(`span`, {
            ...
            children: (0, X.jsxs)(`span`, { className: `min-w-0 truncate`, children: [c, l] }),
          })),
          (t[15] = c),
          (t[16] = l),
          (t[17] = u))
...
function We(e) {
  let t = (0, q.c)(8),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = (0, X.jsx)(Ge, { permission: r })), (t[0] = r), (t[1] = i));
  let a;
...
function Ke(e) {
  let t = (0, q.c)(12),
    ...
    a;
  t[0] !== n || t[1] !== i
    ? ((a = h(`font-medium`, Ye({ isChecking: n, status: i }))), (t[0] = n), (t[1] = i), (t[2] = a))
    : (a = t[2]);
  let o;
  t[3] !== n || t[4] !== i
    ? ((o = (0, X.jsx)(Je, { isChecking: n, status: i })), (t[3] = n), (t[4] = i), (t[5] = o))
    : (o = t[5]);
  let s;
  t[6] !== a || t[7] !== o
    ? ((s = (0, X.jsx)(`span`, { className: a, children: o })), (t[6] = a), (t[7] = o), (t[8] = s))
    : (s = t[8]);
  let c;
  return (
    t[9] !== r || t[10] !== s
...
function et({
  ...
  e.trackStructuredEvent(De, { settingName: r, previousEnabled: t, selectedEnabled: n, ...i });
}
...
function rt() {
  ...
  e[2] === d
    ? (C = e[3])
    : ((C = {
        queryConfig: { enabled: d, refetchOnMount: `always`, refetchOnWindowFocus: `always` },
      }),
      (e[2] = d),
      (e[3] = C));
  ...
  e[6] === a
    ? (P = e[7])
    : ((P = () => c(`reset-memories-for-host`, { hostId: a })), (e[6] = a), (e[7] = P));
  let z, V;
  e[8] === t
    ? ((z = e[9]), (V = e[10]))
    : ((z = () => {
  ...
  let Y = De,
    Ae;
  e[28] !== T || e[29] !== M || e[30] !== Y || e[31] !== Se || e[32] !== r || e[33] !== k
    ? ((Ae = (e) => {
        nt({
          productLogger: r,
          previousState: Y(),
          ...
          ...(!e && Se ? { chronicleDisable: () => M.mutateAsync({ enabled: !1 }) } : {}),
        });
      }),
      (e[28] = T),
      (e[29] = M),
  ...
  e[43] !== ve || e[44] !== be || e[45] !== je || e[46] !== Z
    ? ((Q = (0, X.jsx)(Te, {
        label: Le,
        description: ze,
        control: (0, X.jsx)(me, { checked: be, disabled: ve, ariaLabel: Z, onChange: je }),
      })),
      (e[43] = ve),
      (e[44] = be),
      (e[45] = je),
  ...
  e[54] === n
    ...
    : ((We = n.formatMessage({
      ...
      (e[55] = We));
  let Ge;
  e[56] !== T || e[57] !== Y || e[58] !== W.disableOnExternalContext || e[59] !== r
    ? ((Ge = (e) => {
        tt({
          productLogger: r,
    ...
    : (Ge = e[60]);
  let Ke;
  e[61] !== W.disableOnExternalContext || e[62] !== Ue || e[63] !== We || e[64] !== Ge
    ? ((Ke = (0, X.jsx)(Te, {
        label: Be,
        description: Ve,
        control: (0, X.jsx)(me, { checked: He, disabled: Ue, ariaLabel: We, onChange: Ge }),
      })),
  ...
  e[72] !== Q || e[73] !== $ || e[74] !== Ke || e[75] !== Ze
    ? ((Qe = (0, X.jsxs)(K, {
        ...
        children: [
          Ie,
          (0, X.jsx)(K.Content, { children: (0, X.jsxs)(Ee, { children: [Q, $, Ke, Ze] }) }),
        ],
      })),
      (e[72] = Q),
      (e[73] = $),
  ...
  e[80] === U.isPending
    ? (ct = e[81])
    : ((ct = (0, X.jsx)(B, { color: `ghost`, disabled: U.isPending, onClick: ot, children: st })),
      (e[80] = U.isPending),
      (e[81] = ct));
  let lt;
  e[82] !== Ne || e[83] !== r
  ...
  e[86] !== U.isPending || e[87] !== lt
    ? ((dt = (0, X.jsx)(B, { color: `danger`, loading: U.isPending, onClick: lt, children: ut })),
      (e[86] = U.isPending),
      (e[87] = lt),
      (e[88] = dt))
    : (dt = e[88]);
  ...
  e[89] !== ct || e[90] !== dt
    ? ((ft = (0, X.jsxs)(se, {
        children: [rt, (0, X.jsx)(ie, { children: (0, X.jsxs)(ce, { children: [ct, dt] }) })],
      })),
      (e[89] = ct),
      (e[90] = dt),
      (e[91] = ft))
  ...
  let pt;
  e[92] !== s || e[93] !== ft
    ? ((pt = (0, X.jsx)(oe, { open: s, onOpenChange: l, size: `compact`, children: ft })),
      (e[92] = s),
      (e[93] = ft),
      (e[94] = pt))
    : (pt = e[94]);
...
function ot() {
  ...
  e[23] !== n || e[24] !== a || e[25] !== m || e[26] !== g || e[27] !== o
                        ...
                        (0, X.jsx)(
                          pe.Item,
                          {
                            ...
                            children: (0, X.jsxs)(`div`, {
                              ...
                              children: [
                                (0, X.jsx)(`span`, { className: `text-sm`, children: e.label }),
                                (0, X.jsx)(`span`, {
    ...
    : (v = e[28]);
  let b;
  e[29] === r ? (b = e[30]) : ((b = (0, X.jsx)(st, { hostId: r }, r)), (e[29] = r), (e[30] = b));
  let x;
  e[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, X.jsx)(H, { electron: !0, extension: !0, children: (0, X.jsx)(rt, {}) })),
      (e[31] = x))
    : (x = e[31]);
  let S;
  return (
...
function st(e) {
  ...
  let h = T(`codex-agents-md-save`, m),
    ...
    k = l != null && c == null,
    A;
  t[10] !== S || t[11] !== n || t[12] !== C || t[13] !== w || t[14] !== O || t[15] !== h
    ? ((A = () => {
