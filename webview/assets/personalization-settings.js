...
import { Di as u, Oi as d, Qi as f, j as p } from "./thread-context-inputs.js";
import { A as m, _ as h, h as g, i as _, o as v, r as y, s as b, u as x } from "./vscode-api.js";
import "./isEqual.js";
import { Aa as S, Br as C, En as w, Oa as T, ba as E, ta as D } from "./src-3.js";
import "./react-dom.js";
import { i as O, l as ee, s as k } from "./lib-1.js";
...
import { C as ie, s as W } from "./config-queries.js";
...
import { a as de, d as fe, i as pe, l as me, n as he, r as ge, t as _e } from "./dialog-layout.js";
...
import { n as ye } from "./use-hotkey.js";
import { d as be } from "./links.js";
import { r as K, t as xe } from "./dropdown.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as Se } from "./settings-host-context.js";
import { t as Ce } from "./toggle.js";
import { i as we, t as Te } from "./settings-shared.js";
import { t as q } from "./use-personality.js";
...
var Y = r(),
  X = e(t(), 1),
  ke = _(s, `codex-agents-md`, (e) => ({ params: { hostId: e }, staleTime: x.FIVE_SECONDS })),
  Z = O({
    personality: {
...
function Me(e, t) {
  ...
  n[6] !== t || n[7] !== r || n[8] !== l
    ? ((f = async (e) => {
        ...
        return (
          r.setQueryData(l, (e) => (e == null ? e : { ...e, config: u(e.config, n) })),
  ...
  let v;
  return (
    n[15] !== d || n[16] !== f || n[17] !== p || n[18] !== _
      ? ((v = { mutationFn: d, onMutate: f, onError: p, onSettled: _ }),
        (n[15] = d),
        (n[16] = f),
        (n[17] = p),
        (n[18] = _),
...
function Ie() {
  ...
  e[5] !== t || e[6] !== l
    ? ((d = async (e) => {
        ...
        return (
          t.setQueryData(l, (e) => (e == null ? e : { ...e, config: Le(e.config, n) })),
...
function ze({ onChronicleResearchPreviewToggled: e } = {}) {
  let t = a(s),
    ...
    l = ve(),
    u = Ie(),
    { data: d, isLoading: h } = G(C.CHRONICLE_CONSENT_ACCEPTED),
    { data: _, isLoading: b } = i(ie, n),
    [x, S] = (0, X.useState)(!1),
    [w, T] = (0, X.useState)(!1),
  ...
  (0, X.useEffect)(() => {
    w && B(R.kind) && f(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !0);
  }, [w, t, R.kind]);
  let U = async ({ rememberConsentAccepted: n, showSetupDialog: r }) => {
      let i = I;
      (M(!0), O(null), S(!1), T(r));
      try {
        (n === !0 && (await f(t, C.CHRONICLE_CONSENT_ACCEPTED, !0)),
          r || f(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          await u.mutateAsync({ enabled: !0 }),
          e?.(i, !0),
          await c.invalidateQueries({ queryKey: y(`chronicle-permissions`) }));
      } catch (e) {
        let n = et(e);
        (f(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          O(n),
    ...
    re = async () => {
      let n = I;
      (M(!0), O(null), f(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1));
      try {
    ...
    : (0, Q.jsxs)(Q.Fragment, {
        children: [
          ...
          (0, Q.jsx)(z, {
            ...
            setupState: R,
            onOpenChange: (e) => {
              (e || f(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1), T(e));
            },
            onAskCodex: () => {
              (f(t, C.CHRONICLE_SETUP_COMPLETION_PENDING, !1), T(!1), l({ prefillPrompt: H }));
            },
          }),
        ],
      });
...
function ot() {
  ...
  e[2] === g
    ...
    : ((C = {
      ...
      (e[2] = g),
      (e[3] = C));
  let { data: w } = v(`chronicle-permissions`, C),
    T = Ae(u),
    E;
  e[4] === u ? (E = e[5]) : ((E = { hostId: u }), (e[4] = u), (e[5] = E));
  let O = le(E),
    A = I(`875176429`),
    M = Ie(),
    N;
  e[6] === u
    ? (N = e[7])
    : ((N = () => c(`reset-memories-for-host`, { hostId: u })), (e[6] = u), (e[7] = N));
  let P, R;
  e[8] === t
    ? ((P = e[9]), (R = e[10]))
    : ((P = () => {
  ...
  let B = h(z),
    V = ce(S, A),
    H;
  e[15] === S ? (H = e[16]) : ((H = S.find(ct)), (e[15] = S), (e[16] = H));
  let ne = H?.enabled === !0,
    re = _?.config,
    W;
  e[17] === re ? (W = e[18]) : ((W = d(re)), (e[17] = re), (e[18] = W));
  let G = W,
    ue = _?.config,
    fe;
  e[19] === ue ? (fe = e[20]) : ((fe = D(ue, oe)), (e[19] = ue), (e[20] = fe));
  let _e = fe === !0,
    ve = b || T.isPending || O.isPending || M.isPending || B.isPending,
    ye = ne && G.generateMemories && G.useMemories,
    be = f.kind === `local`,
    K = be && g && w?.chronicleSidecarPresent === !0,
    xe;
  ...
  let q = Te,
    Ee;
  e[28] !== T || e[29] !== M || e[30] !== q || e[31] !== be || e[32] !== r || e[33] !== O
    ? ((Ee = (e) => {
        at({
          productLogger: r,
          previousState: q(),
          selectedEnabled: e,
          featureWrite: () => O.mutateAsync({ featureName: ae, enabled: e }),
          configWrite: () =>
            T.mutateAsync({
              edits: [
  ...
  e[43] !== ve || e[44] !== ye || e[45] !== ke || e[46] !== Re
    ? ((Be = (0, Q.jsx)(De, {
        label: Fe,
        description: Le,
        control: (0, Q.jsx)(Ce, { checked: ye, disabled: ve, ariaLabel: Re, onChange: ke }),
      })),
      (e[43] = ve),
      (e[44] = ye),
      (e[45] = ke),
  ...
  e[54] === n
    ...
    : ((Ke = n.formatMessage({
      ...
      (e[55] = Ke));
  let qe;
  e[56] !== T || e[57] !== q || e[58] !== G.disableOnExternalContext || e[59] !== r
    ? ((qe = (e) => {
        it({
          productLogger: r,
  ...
  e[82] !== Me || e[83] !== r
    ? ((ut = () => {
        (r.logProductEvent(U, { resetScope: `all_memories` }), Me());
      }),
      (e[82] = Me),
      (e[83] = r),
      (e[84] = ut))
  ...
  let mt;
  e[92] !== p || e[93] !== pt
    ? ((mt = (0, Q.jsx)(me, { open: p, onOpenChange: m, size: `compact`, children: pt })),
      (e[92] = p),
      (e[93] = pt),
      (e[94] = mt))
    : (mt = e[94]);
...
function ut(e) {
  let t = (0, Y.c)(40),
    ...
    { data: d, error: f, isFetching: p, refetch: h } = i(ke, n),
    g;
  t[0] !== o || t[1] !== c || t[2] !== r
    ? ((g = (e, t) => {
  ...
  t[24] === o
    ? (z = t[25])
    : ((z = o.formatMessage(Z.customInstructions)), (t[24] = o), (t[25] = z));
  let B = z,
    V;
