...
import { g as c, i as l, k as u, m as d, o as f, r as p, s as m, u as h } from "./vscode-api.js";
import "./isEqual.js";
import { Ii as g, Ki as _, Wi as v, Wt as y, jn as b, xr as x } from "./src-4.js";
import {
  As as S,
  ea as C,
  ha as w,
...
import "./react-dom.js";
import { c as ee, o as O, r as k } from "./lib-1.js";
import { c as A } from "./persisted-signal.js";
...
import "./rpc-2.js";
import { o as I } from "./statsig-DoZ-0xit.js";
import "./request.js";
import {
  a as te,
  c as ne,
...
import { s as U, w as ie } from "./config-queries-BHYT-TjG.js";
...
import { a as oe, i as se, n as ce, o as le, r as ue } from "./experimental-features-queries.js";
...
import { a as fe, d as pe, i as me, l as he, n as ge, r as _e, t as ve } from "./dialog-layout.js";
import "./local-projects.js";
import "./select-project.js";
import "./_defineProperty.js";
import "./initial-route-atom.js";
import { n as ye } from "./use-start-new-conversation.js";
import "./electron-menu-shortcuts.js";
import { u as be } from "./links.js";
import "./search.js";
import { r as xe, t as G } from "./dropdown.js";
import "./chevron.js";
import "./sortBy.js";
...
import { t as K } from "./use-hotkey.js";
import { t as De } from "./settings-content-layout.js";
import { n as Oe } from "./settings-row.js";
import { n as ke, t as q } from "./settings-group.js";
var J = r(),
  Y = e(t(), 1),
  Ae = l(s, `codex-agents-md`, (e) => ({ params: { hostId: e }, staleTime: h.FIVE_SECONDS })),
  X = k({
    personality: {
...
function Ne(e, t) {
  let n = (0, J.c)(20),
    ...
    o = H(),
    s;
  n[0] === e ? (s = n[1]) : ((s = [...U, e]), (n[0] = e), (n[1] = s));
  let l = s,
    f;
  n[2] !== t || n[3] !== e || n[4] !== a?.configWriteTarget?.filePath
    ? ((f = (n) =>
        S(`batch-write-config-value`, {
          hostId: e,
          edits: t(n).map(Pe),
  ...
  n[6] !== t || n[7] !== r || n[8] !== l
    ? ((p = async (e) => {
        ...
        let i = r.getQueryData(l);
        return (
          r.setQueryData(l, (e) => (e == null ? e : { ...e, config: C(e.config, n) })),
  ...
  n[10] !== r || n[11] !== l
    ? ((m = (e, t, n) => {
        (d.error(`Failed to update memory config`, { safe: {}, sensitive: { error: e } }),
          r.setQueryData(l, n?.previousUserConfig));
      }),
      (n[10] = r),
      (n[11] = l),
      (n[12] = m))
  ...
  n[13] === o
    ? (h = n[14])
    : ((h = async () => {
        await Promise.all([o(U), o([`user-saved-config`])]);
      }),
      (n[13] = o),
      (n[14] = h));
  let g;
  return (
    n[15] !== f || n[16] !== p || n[17] !== m || n[18] !== h
      ? ((g = { mutationFn: f, onMutate: p, onError: m, onSettled: h }),
        (n[15] = f),
        (n[16] = p),
        (n[17] = m),
        (n[18] = h),
...
function Le() {
  let e = (0, J.c)(16),
    ...
    a = H(),
    s;
  e[0] === n ? (s = e[1]) : ((s = [...U, n]), (e[0] = n), (e[1] = s));
  let l = s,
    f;
  e[2] !== n || e[3] !== r?.configWriteTarget?.filePath
    ? ((f = (e) => {
        let { enabled: t } = e;
        return S(`batch-write-config-value`, {
          hostId: n,
          edits: [{ keyPath: Fe, value: t, mergeStrategy: `upsert` }],
  ...
  e[5] !== t || e[6] !== l
    ? ((p = async (e) => {
        ...
        return (
          t.setQueryData(l, (e) => (e == null ? e : { ...e, config: Re(e.config, n) })),
          { previousUserConfig: r }
        );
      }),
      (m = (e, n, r) => {
        (d.error(`Failed to update Chronicle config`, {
          safe: { error: String(e) },
          sensitive: {},
        }),
          t.setQueryData(l, r?.previousUserConfig));
      }),
      (e[5] = t),
      (e[6] = l),
      (e[7] = p),
...
function Re(e, t) {
  return Object.assign(structuredClone(e), { features: { ...Z(e.features, se, t) } });
}
function Z(e, t, n) {
...
function ze({ onChronicleResearchPreviewToggled: e } = {}) {
  let t = a(s),
    ...
    l = ye(),
    m = Le(),
    { data: h, isLoading: g } = W(x.CHRONICLE_CONSENT_ACCEPTED),
    { data: _, isLoading: v } = i(ie, n),
    [b, S] = (0, Y.useState)(!1),
    [C, T] = (0, Y.useState)(!1),
    [E, k] = (0, Y.useState)(null),
    [A, M] = (0, Y.useState)(!1),
    N = f(`chronicle-permissions`, {
      queryConfig: {
        intervalMs: 1e3,
  ...
  (0, Y.useEffect)(() => {
    C && z(R.kind) && w(t, x.CHRONICLE_SETUP_COMPLETION_PENDING, !0);
  }, [C, t, R.kind]);
  let H = async ({ rememberConsentAccepted: n, showSetupDialog: r }) => {
      let i = I;
      (M(!0), k(null), S(!1), T(r));
      try {
        (n === !0 && (await w(t, x.CHRONICLE_CONSENT_ACCEPTED, !0)),
          r || w(t, x.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          await m.mutateAsync({ enabled: !0 }),
          e?.(i, !0),
          await c.invalidateQueries({ queryKey: p(`chronicle-permissions`) }));
      } catch (e) {
        let n = et(e);
        (w(t, x.CHRONICLE_SETUP_COMPLETION_PENDING, !1),
          k(n),
          d.error(`Failed to enable Chronicle`, {
            safe: { errorMessage: n },
            sensitive: { error: e },
          }));
      } finally {
    ...
    U = async () => {
      let n = I;
      (M(!0), k(null), w(t, x.CHRONICLE_SETUP_COMPLETION_PENDING, !1));
      try {
        (await m.mutateAsync({ enabled: !1 }), e?.(n, !1));
      } catch {
      } finally {
        M(!1);
      }
    ...
    : (0, Q.jsxs)(Q.Fragment, {
        children: [
          (0, Q.jsx)(Oe, {
            ...
            control: (0, Q.jsx)(F, {
              ...
              children: (0, Q.jsx)(`span`, {
                className: j(`inline-flex`, !P && `cursor-not-allowed`),
                tabIndex: P ? void 0 : 0,
                children: (0, Q.jsx)(Ce, {
                  checked: I,
          ...
          (0, Q.jsx)(L, {
            ...
            setupState: R,
            onOpenChange: (e) => {
              (e || w(t, x.CHRONICLE_SETUP_COMPLETION_PENDING, !1), T(e));
            },
            onAskCodex: () => {
              (w(t, x.CHRONICLE_SETUP_COMPLETION_PENDING, !1), T(!1), l({ prefillPrompt: V }));
            },
          }),
        ],
      });
...
function Be(e) {
  ...
  t[2] === s
    ...
    : ((l = s.formatMessage({
      ...
      (t[3] = l));
  let u;
  t[4] === l ? (u = t[5]) : ((u = (0, Q.jsx)(me, { title: l })), (t[4] = l), (t[5] = u));
  let d;
  t[6] !== c || t[7] !== u
    ? ((d = (0, Q.jsxs)(fe, { children: [c, u] })), (t[6] = c), (t[7] = u), (t[8] = d))
    : (d = t[8]);
  let f, p;
  ...
  let S;
  t[20] !== n || t[21] !== b
    ? ((S = (0, Q.jsx)(M, { color: `ghost`, disabled: n, onClick: b, children: x })),
      (t[20] = n),
      (t[21] = b),
      (t[22] = S))
    : (S = t[22]);
  ...
  let w;
  t[24] !== n || t[25] !== a
    ? ((w = (0, Q.jsx)(M, { color: `primary`, loading: n, onClick: a, children: C })),
      (t[24] = n),
      (t[25] = a),
      (t[26] = w))
    : (w = t[26]);
  let T;
  t[27] !== S || t[28] !== w
    ? ((T = (0, Q.jsx)(fe, { children: (0, Q.jsxs)(_e, { className: ve, children: [S, w] }) })),
      (t[27] = S),
      (t[28] = w),
      (t[29] = T))
    : (T = t[29]);
  ...
  return (
    t[33] !== o || t[34] !== r || t[35] !== E
      ? ((D = (0, Q.jsx)(he, { open: r, onOpenChange: o, size: `default`, children: E })),
        (t[33] = o),
        (t[34] = r),
        (t[35] = E),
        (t[36] = D))
                ...
                children: [
                  ...
                  (0, Q.jsx)(`button`, {
                    ...
                    children: (0, Q.jsx)(O, {
                      ...
                      values: {
                        status: (0, Q.jsx)(`span`, {
                          className: j(`font-medium`, $({ isChecking: r, status: n })),
...
function Xe(e) {
  let t = (0, J.c)(12),
    ...
    a;
  t[0] !== n || t[1] !== i
    ? ((a = j(`font-medium`, $({ isChecking: n, status: i }))), (t[0] = n), (t[1] = i), (t[2] = a))
    : (a = t[2]);
  let o;
  t[3] !== n || t[4] !== i
...
function tt({
  ...
  return {
    chronicleResearchPreviewEnabled: e,
    chronicleResearchPreviewVisible: t,
    ...B({ isMemoryFeatureEnabled: n, memoryConfig: r }),
...
function ot() {
  let e = (0, J.c)(98),
    ...
    m = te(),
    { data: h } = i(ie, l),
    { data: g, isLoading: _ } = i(ce, l),
    v;
  e[0] === g ? (v = e[1]) : ((v = g === void 0 ? [] : g), (e[0] = g), (e[1] = v));
  let b = v,
    x;
  e[2] === m
    ? (x = e[3])
    : ((x = {
        queryConfig: { enabled: m, refetchOnMount: `always`, refetchOnWindowFocus: `always` },
      }),
      (e[2] = m),
      (e[3] = x));
  let { data: C } = f(`chronicle-permissions`, x),
    w = je(l),
    D;
  e[4] === l ? (D = e[5]) : ((D = { hostId: l }), (e[4] = l), (e[5] = D));
  let k = ue(D),
    j = I(`875176429`),
    N = Le(),
    P;
  e[6] === l
    ? (P = e[7])
    : ((P = () => S(`reset-memories-for-host`, { hostId: l })), (e[6] = l), (e[7] = P));
  let F, L;
  e[8] === t
    ? ((F = e[9]), (L = e[10]))
    : ((F = () => {
  ...
  let z = c(R),
    B = le(b, j),
    V;
  e[15] === b ? (V = e[16]) : ((V = b.find(ct)), (e[15] = b), (e[16] = V));
  let re = V?.enabled === !0,
    H = h?.config,
    U;
  e[17] === H ? (U = e[18]) : ((U = E(H)), (e[17] = H), (e[18] = U));
  let W = U,
    de = h?.config,
    pe;
  e[19] === de ? (pe = e[20]) : ((pe = y(de, se)), (e[19] = de), (e[20] = pe));
  let ve = pe === !0,
    ye = _ || w.isPending || k.isPending || N.isPending || z.isPending,
    be = re && W.generateMemories && W.useMemories,
    xe = u.kind === `local`,
    G = xe && m && C?.chronicleSidecarPresent === !0,
    we;
  e[21] !== ve || e[22] !== re || e[23] !== W || e[24] !== G
    ? ((we = {
        chronicleResearchPreviewEnabled: ve,
        chronicleResearchPreviewVisible: G,
        isMemoryFeatureEnabled: re,
        memoryConfig: W,
      }),
      (e[21] = ve),
      (e[22] = re),
  ...
  let K = Ee,
    De;
  e[28] !== w || e[29] !== N || e[30] !== K || e[31] !== xe || e[32] !== r || e[33] !== k
    ? ((De = (e) => {
        at({
          productLogger: r,
          previousState: K(),
          selectedEnabled: e,
          featureWrite: () => k.mutateAsync({ featureName: oe, enabled: e }),
          configWrite: () =>
            w.mutateAsync({
              edits: [
          ...
          ...(!e && xe ? { chronicleDisable: () => N.mutateAsync({ enabled: !1 }) } : {}),
        });
      }),
      (e[28] = w),
      (e[29] = N),
  ...
  e[41] === n
    ...
    : ((Z = n.formatMessage({
      ...
      (e[42] = Z));
  let Be;
  e[43] !== ye || e[44] !== be || e[45] !== Ae || e[46] !== Z
    ? ((Be = (0, Q.jsx)(Oe, {
        label: Ie,
        description: Re,
        control: (0, Q.jsx)(Ce, { checked: be, disabled: ye, ariaLabel: Z, onChange: Ae }),
      })),
      (e[43] = ye),
      (e[44] = be),
      (e[45] = Ae),
        ...
        ? (0, Q.jsx)(ze, {
            onChronicleResearchPreviewToggled: (e, t) => {
              rt({
                ...
                state: K({ chronicleResearchPreviewEnabled: t }),
              });
            },
          })
        : null),
  ...
  e[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((He = (0, Q.jsx)(O, { ...X.skipToolAssistedChats })),
      (Ue = (0, Q.jsx)(O, {
      ...
      (e[53] = Ue))
    : ((He = e[52]), (Ue = e[53]));
  let We = W.disableOnExternalContext,
    Ge = ye || !re,
    Ke;
  e[54] === n
    ? (Ke = e[55])
    : ((Ke = n.formatMessage({
      ...
      (e[55] = Ke));
  let qe;
  e[56] !== w || e[57] !== K || e[58] !== W.disableOnExternalContext || e[59] !== r
    ? ((qe = (e) => {
        it({
          productLogger: r,
          ...
          state: K({ memoryConfigPatch: { disableOnExternalContext: e } }),
          write: () =>
            w.mutateAsync({
              edits: [
    ...
    : (qe = e[60]);
  let Je;
  e[61] !== W.disableOnExternalContext || e[62] !== Ge || e[63] !== Ke || e[64] !== qe
    ? ((Je = (0, Q.jsx)(Oe, {
        label: He,
        description: Ue,
        control: (0, Q.jsx)(Ce, { checked: We, disabled: Ge, ariaLabel: Ke, onChange: qe }),
      })),
  ...
  e[72] !== Be || e[73] !== Ve || e[74] !== Je || e[75] !== $
    ? (($e = (0, Q.jsxs)(q, {
        ...
        children: [
          Fe,
          (0, Q.jsx)(q.Content, { children: (0, Q.jsxs)(ke, { children: [Be, Ve, Je, $] }) }),
        ],
      })),
      (e[72] = Be),
      (e[73] = Ve),
  ...
  e[80] === z.isPending
    ? (lt = e[81])
    : ((lt = (0, Q.jsx)(M, { color: `ghost`, disabled: z.isPending, onClick: tt, children: ot })),
      (e[80] = z.isPending),
      (e[81] = lt));
  let ut;
  e[82] !== Ne || e[83] !== r
    ? ((ut = () => {
        (r.logProductEvent(ne, { resetScope: `all_memories` }), Ne());
      }),
      (e[82] = Ne),
      (e[83] = r),
      (e[84] = ut))
  ...
  e[85] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (dt = e[85]);
  let ft;
  e[86] !== z.isPending || e[87] !== ut
    ? ((ft = (0, Q.jsx)(M, { color: `danger`, loading: z.isPending, onClick: ut, children: dt })),
      (e[86] = z.isPending),
      (e[87] = ut),
      (e[88] = ft))
    : (ft = e[88]);
  ...
  e[89] !== lt || e[90] !== ft
    ? ((pt = (0, Q.jsxs)(ge, {
        children: [et, (0, Q.jsx)(fe, { children: (0, Q.jsxs)(_e, { children: [lt, ft] }) })],
      })),
      (e[89] = lt),
      (e[90] = ft),
      (e[91] = pt))
  ...
  let mt;
  e[92] !== d || e[93] !== pt
    ? ((mt = (0, Q.jsx)(he, { open: d, onOpenChange: p, size: `compact`, children: pt })),
      (e[92] = d),
      (e[93] = pt),
      (e[94] = mt))
    : (mt = e[94]);
...
function lt() {
  ...
  let { personality: a, setPersonality: o } = Ee(i),
    s;
  e[2] === t ? (s = e[3]) : ((s = t.formatMessage(X.friendly)), (e[2] = t), (e[3] = s));
  let c;
  e[4] === t
    ? (c = e[5])
    : ((c = t.formatMessage({
  ...
  e[6] !== s || e[7] !== c
    ...
    : (l = e[8]);
  let u;
  e[9] === t ? (u = e[10]) : ((u = t.formatMessage(X.pragmatic)), (e[9] = t), (e[10] = u));
  let d;
  e[11] === t
    ? (d = e[12])
    : ((d = t.formatMessage({
  ...
  e[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Q.jsx)(de, { electron: !0, extension: !0, children: (0, Q.jsx)(ot, {}) })),
      (e[31] = b))
    : (b = e[31]);
  let x;
  return (
    e[32] !== v || e[33] !== y
      ? ((x = (0, Q.jsxs)(De, { title: _, children: [v, y, b] })),
        (e[32] = v),
        (e[33] = y),
        (e[34] = x))
      : (x = e[34]),
...
function ut(e) {
  let t = (0, J.c)(40),
    ...
    o = ee(),
    c = u(),
    [l, d] = (0, Y.useState)(null),
    { data: f, error: h, isFetching: g, refetch: _ } = i(Ae, n),
    v;
  t[0] !== o || t[1] !== c || t[2] !== r
    ? ((v = (e, t) => {
        (c.setQueryData(p(`codex-agents-md`, { hostId: t.hostId }), {
          path: e.path,
          contents: t.contents,
        }),
          d(null),
  ...
  let b;
  t[7] !== v || t[8] !== y
    ? ((b = { onSuccess: v, onError: y }), (t[7] = v), (t[8] = y), (t[9] = b))
    : (b = t[9]);
  let x = m(`codex-agents-md-save`, b),
    S = f?.contents ?? ``,
    C = l ?? S,
    w = l != null && l !== S,
    T = f != null,
  ...
  let I;
  (t[19] !== P || t[20] !== F
    ? ((I = { accelerator: `CmdOrCtrl+S`, enabled: P, onKeyDown: F }),
      (t[19] = P),
      (t[20] = F),
      (t[21] = I))
    : (I = t[21]),
  ...
  t[24] === o
    ? (L = t[25])
    : ((L = o.formatMessage(X.customInstructions)), (t[24] = o), (t[25] = L));
  let R = L,
    z;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, Q.jsx)(O, { ...X.customInstructions })), (t[26] = z))
    : (z = t[26]);
  let B;
