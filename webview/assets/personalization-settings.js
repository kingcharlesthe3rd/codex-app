...
function kt(e, t) {
  ...
  n[6] !== t || n[7] !== i || n[8] !== l
    ? ((d = async (e) => {
        ...
        return (
          i.setQueryData(l, (e) => (e == null ? e : { ...e, config: Pe(e.config, n) })),
  ...
  n[10] !== i || n[11] !== l
    ? ((f = (e, t, n) => {
        (r.error(`Failed to update memory config`, { safe: {}, sensitive: { error: e } }),
...
function Nt() {
  ...
  e[5] !== t || e[6] !== c
    ? ((u = async (e) => {
        ...
        return (
          t.setQueryData(c, (e) => (e == null ? e : { ...e, config: Pt(e.config, n) })),
          { previousUserConfig: r }
        );
      }),
      (d = (e, n, i) => {
...
function Pt(e, t) {
  return Object.assign(structuredClone(e), { features: { ...Ft(e.features, Se, t) } });
}
function Ft(e, t, n) {
    ...
    : (0, Z.jsxs)(Z.Fragment, {
        children: [
          ...
          (0, Z.jsx)(qe, {
            ...
            onAskCodex: () => {
              (V(t, o.CHRONICLE_SETUP_COMPLETION_PENDING, !1), S(!1), u({ prefillPrompt: et }));
            },
          }),
        ],
      });
...
function Vt(e) {
  ...
  t[2] === s
    ...
    : ((l = s.formatMessage({
      ...
      (t[3] = l));
  let u;
  t[4] === l ? (u = t[5]) : ((u = (0, Z.jsx)(De, { title: l })), (t[4] = l), (t[5] = u));
  let d;
  t[6] !== c || t[7] !== u
    ? ((d = (0, Z.jsxs)(R, { children: [c, u] })), (t[6] = c), (t[7] = u), (t[8] = d))
    : (d = t[8]);
  let f, p;
  ...
  let S;
  t[20] !== n || t[21] !== b
    ? ((S = (0, Z.jsx)(ne, { color: `ghost`, disabled: n, onClick: b, children: x })),
      (t[20] = n),
      (t[21] = b),
      (t[22] = S))
    : (S = t[22]);
  ...
  let w;
  t[24] !== n || t[25] !== a
    ? ((w = (0, Z.jsx)(ne, { color: `primary`, loading: n, onClick: a, children: C })),
      (t[24] = n),
      (t[25] = a),
      (t[26] = w))
    : (w = t[26]);
  let T;
  t[27] !== S || t[28] !== w
    ? ((T = (0, Z.jsx)(R, { children: (0, Z.jsxs)(we, { className: ce, children: [S, w] }) })),
      (t[27] = S),
      (t[28] = w),
      (t[29] = T))
    : (T = t[29]);
  ...
  return (
    t[33] !== o || t[34] !== r || t[35] !== E
      ? ((D = (0, Z.jsx)(Te, { open: r, onOpenChange: o, size: `default`, children: E })),
        (t[33] = o),
        (t[34] = r),
        (t[35] = E),
        (t[36] = D))
                ...
                children: [
                  ...
                  (0, Z.jsx)(`button`, {
                    ...
                    children: (0, Z.jsx)(G, {
                      ...
                      values: {
                        status: (0, Z.jsx)(`span`, {
                          className: he(`font-medium`, en({ isChecking: r, status: n })),
...
function fn() {
  let e = (0, hn.c)(98),
    ...
    h;
  e[0] === p ? (h = e[1]) : ((h = p === void 0 ? [] : p), (e[0] = p), (e[1] = h));
  let g = h,
    _;
  e[2] === d
    ? (_ = e[3])
    : ((_ = { queryConfig: { enabled: d, refetchOnMount: `always`, refetchOnWindowFocus: !0 } }),
      (e[2] = d),
      (e[3] = _));
  ...
  e[6] === i
    ? (E = e[7])
    : ((E = () => We(`reset-memories-for-host`, { hostId: i })), (e[6] = i), (e[7] = E));
  let O, k;
  e[8] === t
    ? ((O = e[9]), (k = e[10]))
    : ((O = () => {
  ...
  let z = _e,
    ve;
  e[28] !== y || e[29] !== w || e[30] !== z || e[31] !== ue || e[32] !== r || e[33] !== S
    ? ((ve = (e) => {
        un({
          productLogger: r,
          previousState: z(),
          ...
          ...(!e && ue ? { chronicleDisable: () => w.mutateAsync({ enabled: !1 }) } : {}),
        });
      }),
      (e[28] = y),
      (e[29] = w),
  ...
  e[43] !== oe || e[44] !== ce || e[45] !== ye || e[46] !== Me
    ? ((B = (0, Q.jsx)(it, {
        label: Ae,
        description: je,
        control: (0, Q.jsx)(de, { checked: ce, disabled: oe, ariaLabel: Me, onChange: ye }),
      })),
      (e[43] = oe),
      (e[44] = ce),
      (e[45] = ye),
  ...
  e[54] === n
    ...
    : ((Le = n.formatMessage({
      ...
      (e[55] = Le));
  let U;
  e[56] !== y || e[57] !== z || e[58] !== I.disableOnExternalContext || e[59] !== r
    ? ((U = (e) => {
        ln({
          productLogger: r,
    ...
    : (U = e[60]);
  let W;
  e[61] !== I.disableOnExternalContext || e[62] !== Ie || e[63] !== Le || e[64] !== U
    ? ((W = (0, Q.jsx)(it, {
        label: V,
        description: H,
        control: (0, Q.jsx)(de, { checked: Fe, disabled: Ie, ariaLabel: Le, onChange: U }),
      })),
  ...
  e[72] !== B || e[73] !== Pe || e[74] !== W || e[75] !== qe
    ? ((Je = (0, Q.jsxs)(yt, {
        ...
        children: [
          Oe,
          (0, Q.jsx)(yt.Content, { children: (0, Q.jsxs)(xt, { children: [B, Pe, W, qe] }) }),
        ],
      })),
      (e[72] = B),
      (e[73] = Pe),
  ...
  e[80] === j.isPending
    ? ($e = e[81])
    : (($e = (0, Q.jsx)(ne, { color: `ghost`, disabled: j.isPending, onClick: Ze, children: Qe })),
      (e[80] = j.isPending),
      (e[81] = $e));
  let et;
  e[82] !== Ce || e[83] !== r
  ...
  e[86] !== j.isPending || e[87] !== et
    ? ((q = (0, Q.jsx)(ne, { color: `danger`, loading: j.isPending, onClick: et, children: K })),
      (e[86] = j.isPending),
      (e[87] = et),
      (e[88] = q))
    : (q = e[88]);
  ...
  e[89] !== $e || e[90] !== q
    ? ((nt = (0, Q.jsxs)(re, {
        children: [Ye, (0, Q.jsx)(R, { children: (0, Q.jsxs)(we, { children: [$e, q] }) })],
      })),
      (e[89] = $e),
      (e[90] = q),
      (e[91] = nt))
  ...
  let J;
  e[92] !== l || e[93] !== nt
    ? ((J = (0, Q.jsx)(Te, { open: l, onOpenChange: u, size: `compact`, children: nt })),
      (e[92] = l),
      (e[93] = nt),
      (e[94] = J))
    : (J = e[94]);
...
function vn() {
  ...
  e[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, $.jsx)(me, { electron: !0, extension: !0, children: (0, $.jsx)(fn, {}) })),
      (e[31] = b))
    : (b = e[31]);
  let x;
  return (
...
function yn(e) {
  ...
  let b = O(`codex-agents-md-save`, y),
    ...
    D = f != null && d == null,
    ee;
  t[10] !== S || t[11] !== n || t[12] !== C || t[13] !== w || t[14] !== E || t[15] !== b
    ? ((ee = () => {
