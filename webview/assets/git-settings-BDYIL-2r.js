...
import { Z as r, o as ee, t as te } from "./app-scope-CWE-zIhQ.js";
import { _ as i } from "./vscode-api.js";
import "./isEqual.js";
import { C as a, y as o } from "./src-3.js";
import "./react-dom.js";
import { i as s, l as c, s as l } from "./lib-1.js";
import { t as u } from "./button.js";
import { a as d, i as f } from "./setting-storage.js";
...
import { n as b } from "./use-hotkey.js";
import "./links.js";
import { t as re } from "./toggle.js";
import { i as x } from "./settings-shared.js";
import { t as S } from "./settings-content-layout.js";
import { r as C } from "./settings-row.js";
...
function ce() {
  let e = (0, oe.c)(66),
    ...
    n = c(),
    [r, a] = (0, se.useState)(!1),
    [s, u] = (0, se.useState)(null),
    m = d(o.autoCleanupEnabled),
    ne = d(o.keepCount),
    h;
  e[0] === t ? (h = e[1]) : ((h = (e) => f(t, o.autoCleanupEnabled, e)), (e[0] = t), (e[1] = h));
  let g, _;
  e[2] !== n || e[3] !== t
    ? ((g = (e, r) => {
        if (r) {
  ...
  let v;
  e[6] !== h || e[7] !== g || e[8] !== _
    ? ((v = { mutationFn: h, onSuccess: g, onError: _ }),
      (e[6] = h),
      (e[7] = g),
      (e[8] = _),
      (e[9] = v))
  ...
  let y = i(v),
    b;
  e[10] === t ? (b = e[11]) : ((b = (e) => f(t, o.keepCount, e)), (e[10] = t), (e[11] = b));
  let x, S;
  e[12] !== n || e[13] !== t
    ? ((x = () => {
        (u(null),
  ...
  e[16] !== b || e[17] !== x || e[18] !== S
    ? ((ie = { mutationFn: b, onSuccess: x, onError: S }),
      (e[16] = b),
      (e[17] = x),
      (e[18] = S),
      (e[19] = ie))
  ...
  e[23] === y
    ? (j = e[24])
    : ((j = () => {
        (u(null), a(!1), y.mutate(!1));
      }),
      (e[23] = y),
      (e[24] = j));
  let M = j,
    N;
  e[25] !== O || e[26] !== ne || e[27] !== s || e[28] !== w
    ? ((N = () => {
        if (O || s == null) return;
        let e = s.trim(),
  ...
  e[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, E.jsx)(l, { ...T.automaticWorktreeDeletion })),
      (I = (0, E.jsx)(l, {
  ...
  e[34] !== m || e[35] !== A || e[36] !== D || e[37] !== L
    ? ((R = (0, E.jsx)(C, {
        label: F,
        description: I,
        control: (0, E.jsx)(re, { checked: m, disabled: D, onChange: A, ariaLabel: L }),
      })),
      (e[34] = m),
      (e[35] = A),
      (e[36] = D),
  ...
  e[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, E.jsx)(l, { ...T.autoDeleteLimit })), (e[39] = z))
    : (z = e[39]);
  let B;
  e[40] === m
    ? (B = e[41])
  ...
  e[47] === n
    ...
    : ((U = n.formatMessage({
      ...
      (e[48] = U));
  let W;
  e[49] !== P || e[50] !== O || e[51] !== ce || e[52] !== V || e[53] !== H || e[54] !== U
    ? ((W = (0, E.jsx)(`div`, {
        className: `ml-6`,
  ...
  let K;
  e[59] !== M || e[60] !== r
    ? ((K = (0, E.jsx)(le, { open: r, onOpenChange: a, onConfirm: M })),
      (e[59] = M),
      (e[60] = r),
      (e[61] = K))
    : (K = e[61]);
...
function le(e) {
  ...
  t[5] === a
    ? (s = t[6])
    : ((s = (0, E.jsx)(u, { color: `ghost`, onClick: a, children: o })), (t[5] = a), (t[6] = s));
  let c;
  t[7] === ee
    ? (c = t[8])
    : ((c = () => {
  ...
  t[10] === c
    ? (f = t[11])
    : ((f = (0, E.jsx)(u, { color: `danger`, onClick: c, children: d })), (t[10] = c), (t[11] = f));
  let p;
  t[12] !== s || t[13] !== f
    ? ((p = (0, E.jsxs)(v, {
        children: [te, i, (0, E.jsx)(h, { children: (0, E.jsxs)(y, { children: [s, f] }) })],
      })),
      (t[12] = s),
      (t[13] = f),
      (t[14] = p))
  ...
  return (
    t[15] !== r || t[16] !== n || t[17] !== p
      ? ((m = (0, E.jsx)(_, { open: n, showDialogClose: !1, onOpenChange: r, children: p })),
        (t[15] = r),
        (t[16] = n),
        (t[17] = p),
        (t[18] = m))
...
function D() {
  let e = (0, oe.c)(218),
    ...
    r = m(`2764989143`),
    o = m(`2553306736`),
    [s, h] = (0, se.useState)(null),
    g = d(a.branchPrefix),
    _ = d(a.alwaysForcePush),
    v = d(a.createPullRequestAsDraft),
    y = d(a.pullRequestMergeMethod),
    le = d(a.showSidebarPrIcons),
    D = d(a.commitInstructions),
    O = d(a.pullRequestInstructions),
    k;
  e[0] === t ? (k = e[1]) : ((k = (e) => f(t, a.branchPrefix, e)), (e[0] = t), (e[1] = k));
  let A, j;
  e[2] !== n || e[3] !== t
    ? ((A = () => {
        (h(null),
  ...
  let N = i(M),
    P;
  e[10] === t ? (P = e[11]) : ((P = (e) => f(t, a.alwaysForcePush, e)), (e[10] = t), (e[11] = P));
  let F, I;
  e[12] !== n || e[13] !== t
    ? ((F = (e, r) => {
        r
  ...
  e[20] === t
    ? (z = e[21])
    : ((z = (e) => f(t, a.pullRequestMergeMethod, e)), (e[20] = t), (e[21] = z));
  let B, V;
  e[22] !== n || e[23] !== t
    ? ((V = () => {
        t.get(p).success(
  ...
  e[30] === t
    ? (W = e[31])
    : ((W = (e) => f(t, a.createPullRequestAsDraft, e)), (e[30] = t), (e[31] = W));
  let G, K;
  e[32] !== n || e[33] !== t
    ? ((G = (e, r) => {
        r
  ...
  e[40] === t
    ? (de = e[41])
    : ((de = (e) => f(t, a.showSidebarPrIcons, e)), (e[40] = t), (e[41] = de));
  let fe, pe;
  e[42] !== n || e[43] !== t
    ? ((fe = (e, r) => {
        r
  ...
  e[46] !== de || e[47] !== fe || e[48] !== pe
    ...
    : (me = e[49]);
  let he = i(me),
    [ge, _e] = (0, se.useState)(null),
    [ve, ye] = (0, se.useState)(null),
    be;
  e[50] === t
    ? (be = e[51])
    : ((be = (e) => f(t, a.commitInstructions, e)), (e[50] = t), (e[51] = be));
  let xe, Se;
  e[52] !== n || e[53] !== t
    ? ((xe = () => {
        (_e(null),
  ...
  e[60] === t
    ? (we = e[61])
    : ((we = (e) => f(t, a.pullRequestInstructions, e)), (e[60] = t), (e[61] = we));
  let Te, Ee;
  e[62] !== n || e[63] !== t
    ? ((Te = () => {
        (ye(null),
    ...
    : ((Te = e[64]), (Ee = e[65]));
  let De;
  e[66] !== we || e[67] !== Te || e[68] !== Ee
    ? ((De = { mutationFn: we, onSuccess: Te, onError: Ee }),
      (e[66] = we),
      (e[67] = Te),
      (e[68] = Ee),
      (e[69] = De))
  ...
  let et = $e,
    tt = (Ae && !X) || (Le && !Q) || (Be && !$),
    nt;
  e[98] !== He || e[99] !== Qe || e[100] !== et
    ? ((nt = (e) => {
        (e.preventDefault(), He(), Qe(), et());
      }),
      (e[98] = He),
      (e[99] = Qe),
      (e[100] = et),
  ...
  let rt;
  (e[102] !== tt || e[103] !== nt
    ? ((rt = { accelerator: `CmdOrCtrl+S`, enabled: tt, onKeyDown: nt }),
      (e[102] = tt),
      (e[103] = nt),
      (e[104] = rt))
    : (rt = e[104]),
  ...
  e[105] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((it = (0, E.jsx)(x, { slug: `git-settings` })), (e[105] = it))
    : (it = e[105]);
  let at, ot;
  e[106] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((at = (0, E.jsx)(l, { ...T.branchPrefix })),
      (ot = (0, E.jsx)(l, {
  ...
  e[113] === n
    ...
    : ((lt = n.formatMessage({
      ...
      (e[114] = lt));
  let ut;
  e[115] !== ke || e[116] !== He || e[117] !== X || e[118] !== st || e[119] !== ct || e[120] !== lt
    ? ((ut = (0, E.jsx)(C, {
        label: at,
        description: ot,
    ...
    : (ut = e[121]);
  let dt;
  e[122] !== Je || e[123] !== n || e[124] !== Z || e[125] !== r || e[126] !== y
    ? ((dt = r
        ? (0, E.jsx)(C, {
            label: (0, E.jsx)(l, { ...T.pullRequestMergeMethod }),
            description: (0, E.jsx)(l, {
            ...
            control: (0, E.jsx)(ae, {
              ...
              options: [
                {
                  id: `merge`,
                  label: (0, E.jsx)(l, { ...T.merge }),
                  ariaLabel: n.formatMessage(T.merge),
                  disabled: Z,
                },
                {
                  id: `squash`,
                  label: (0, E.jsx)(l, { ...T.squash }),
                  ariaLabel: n.formatMessage(T.squash),
                  disabled: Z,
                },
              ],
            }),
  ...
  e[128] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ft = (0, E.jsx)(l, { ...T.showPullRequestIcons })),
      (pt = (0, E.jsx)(l, {
  ...
  e[132] === n
    ...
    : ((ht = n.formatMessage({
      ...
      (e[133] = ht));
  let gt;
  e[134] !== Ne || e[135] !== Pe || e[136] !== mt || e[137] !== ht
    ? ((gt = (0, E.jsx)(C, {
        label: ft,
        description: pt,
        control: (0, E.jsx)(re, { checked: Pe, disabled: Ne, onChange: mt, ariaLabel: ht }),
      })),
      (e[134] = Ne),
      (e[135] = Pe),
      (e[136] = mt),
  ...
  e[139] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_t = (0, E.jsx)(l, { ...T.alwaysForcePush })),
      (vt = (0, E.jsx)(l, {
  ...
  e[143] === n
    ...
    : ((bt = n.formatMessage({
      ...
      (e[144] = bt));
  let xt;
  e[145] !== _ || e[146] !== je || e[147] !== yt || e[148] !== bt
    ? ((xt = (0, E.jsx)(C, {
        label: _t,
        description: vt,
        control: (0, E.jsx)(re, { checked: _, disabled: je, onChange: yt, ariaLabel: bt }),
      })),
      (e[145] = _),
      (e[146] = je),
      (e[147] = yt),
  ...
  e[150] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((St = (0, E.jsx)(l, { ...T.createDraftPullRequests })),
      (Ct = (0, E.jsx)(l, {
  ...
  e[154] === n
    ...
    : ((Tt = n.formatMessage({
      ...
      (e[155] = Tt));
  let Et;
  e[156] !== v || e[157] !== Me || e[158] !== wt || e[159] !== Tt
    ? ((Et = (0, E.jsx)(C, {
        label: St,
        description: Ct,
        control: (0, E.jsx)(re, { checked: v, disabled: Me, onChange: wt, ariaLabel: Tt }),
      })),
      (e[156] = v),
      (e[157] = Me),
      (e[158] = wt),
  ...
  e[161] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Dt = (0, E.jsx)(ne, { electron: !0, children: (0, E.jsx)(ce, {}) })), (e[161] = Dt))
    : (Dt = e[161]);
  let Ot;
  e[162] !== ut || e[163] !== dt || e[164] !== gt || e[165] !== xt || e[166] !== Et
    ? ((Ot = (0, E.jsx)(w, {
        children: (0, E.jsx)(w.Content, {
          children: (0, E.jsxs)(ie, { children: [ut, dt, gt, xt, Et, Dt] }),
        }),
      })),
      (e[162] = ut),
      (e[163] = dt),
  ...
  e[168] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((kt = (0, E.jsx)(l, { ...T.commitInstructions })),
      (At = (0, E.jsx)(l, {
  ...
  e[170] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Mt = e[170]);
  let Nt;
  e[171] !== Qe || e[172] !== J.isPending || e[173] !== jt
    ? ((Nt = (0, E.jsx)(w.Header, {
        title: kt,
        subtitle: At,
        actions: (0, E.jsx)(u, {
  ...
  e[180] === n
    ...
    : ((It = n.formatMessage({
      ...
      (e[181] = It));
  let Lt;
  e[182] !== Ie || e[183] !== Q || e[184] !== Pt || e[185] !== Ft || e[186] !== It
    ? ((Lt = (0, E.jsx)(w.Content, {
  ...
  let Rt;
  e[188] !== Nt || e[189] !== Lt
    ? ((Rt = (0, E.jsxs)(w, { children: [Nt, Lt] })), (e[188] = Nt), (e[189] = Lt), (e[190] = Rt))
    : (Rt = e[190]);
  let zt, Bt;
  e[191] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((zt = (0, E.jsx)(l, { ...T.pullRequestInstructions })),
      (Bt = (0, E.jsx)(l, {
  ...
  e[193] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Ht = e[193]);
  let Ut;
  e[194] !== et || e[195] !== Y.isPending || e[196] !== Vt
    ? ((Ut = (0, E.jsx)(w.Header, {
        title: zt,
        subtitle: Bt,
        actions: (0, E.jsx)(u, {
  ...
  e[203] === n
    ...
    : ((Kt = n.formatMessage({
      ...
      (e[204] = Kt));
  let qt;
  e[205] !== $ || e[206] !== ze || e[207] !== Wt || e[208] !== Gt || e[209] !== Kt
    ? ((qt = (0, E.jsx)(w.Content, {
        children: (0, E.jsx)(`textarea`, {
          className: `mt-1.5 w-full rounded-md border border-token-input-border bg-token-input-background px-2.5 py-2 text-sm text-token-input-foreground outline-none placeholder:text-token-input-placeholder-foreground focus:border-token-focus-border`,
          value: ze,
          onChange: Wt,
  ...
  let Jt;
  e[211] !== Ut || e[212] !== qt
    ? ((Jt = (0, E.jsxs)(w, { children: [Ut, qt] })), (e[211] = Ut), (e[212] = qt), (e[213] = Jt))
    : (Jt = e[213]);
  let Yt;
  return (
    e[214] !== Ot || e[215] !== Rt || e[216] !== Jt
      ? ((Yt = (0, E.jsxs)(S, { title: it, children: [Ot, Rt, Jt] })),
        (e[214] = Ot),
        (e[215] = Rt),
        (e[216] = Jt),
        (e[217] = Yt))
...
export { D as GitSettings };
//# sourceMappingURL=git-settings-BDYIL-2r.js.map
