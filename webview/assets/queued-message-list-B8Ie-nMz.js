...
import {
  i as z,
  n as B,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~appgen-~n1rtl5kd.js";
var V,
  be,
  H = e(() => {
    (t(n()),
...
function G(e) {
  let t = (0, we.c)(40),
    {
      ...
      onDeleteMessage: u,
      onSendNowMessage: d,
      onReorderMessages: te,
      onQueueingChange: f,
      onResumeInterruptedQueue: m,
    } = e,
    h = ce(),
    g;
  t[0] === n ? (g = t[1]) : ((g = n.map(Se)), (t[0] = n), (t[1] = g));
  let _ = g,
    v;
  t[2] !== _ || t[3] !== te
    ? ((v = { messageIds: _, onReorderMessages: te }), (t[2] = _), (t[3] = te), (t[4] = v))
    : (v = t[4]);
  let y = q(v);
    ...
    t[27] !== d
      ? ((e = (e) => {
          let {
            ...
            } = M(e.context.commentAttachments ?? []),
            c = ue(e.context.fileAttachments, e.context.generatedPastedTextAttachmentPaths);
          return (0, J.jsx)(
            K,
            {
              messageId: e.id,
              messageText: Ce(h, {
                ...
                imageCommentCount: e.context.imageCommentDraft?.comments.length ?? 0,
                pastedTextAttachmentPreview:
                  e.context.pastedTextAttachments?.[0]?.preview ?? (c == null ? void 0 : ``),
                pastedTextAttachmentCount: e.context.pastedTextAttachments?.length ?? c?.length,
  ...
  t[29] === x
    ? (S = t[30])
    : ((S = (0, J.jsx)(re, { initial: !1, children: x })), (t[29] = x), (t[30] = S));
  let C;
  t[31] !== _ || t[32] !== S
    ? ((C = (0, J.jsx)(c, { items: _, strategy: ee, children: S })),
      (t[31] = _),
      (t[32] = S),
      (t[33] = C))
    : (C = t[33]);
  let w;
  t[34] !== y || t[35] !== C
    ? ((w = (0, J.jsx)(p, { ...y, children: C })), (t[34] = y), (t[35] = C), (t[36] = w))
    : (w = t[36]);
  let T;
  return (
    t[37] !== b || t[38] !== w
...
function K(e) {
  let t = (0, we.c)(92),
    ...
    p = ce(),
    m;
  t[0] === n ? (m = t[1]) : ((m = { id: n }), (t[0] = n), (t[1] = m));
  let {
      attributes: h,
      listeners: g,
      setNodeRef: _,
    ...
    T = i ? Te.retryQueuedMessage : Te.sendQueuedMessageNow,
    E;
  t[2] === y ? (E = t[3]) : ((E = o.Translate.toString(y)), (t[2] = y), (t[3] = E));
  let D;
  t[4] !== E || t[5] !== x
    ? ((D = { transform: E, transition: x }), (t[4] = E), (t[5] = x), (t[6] = D))
    : (D = t[6]);
  let ae, oe, se, le;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = { height: 0, opacity: 0 }),
      (oe = { height: `auto`, opacity: 1 }),
      (se = { height: 0, opacity: 0 }),
      (le = { duration: 0.18 }),
      (t[7] = ae),
      (t[8] = oe),
      (t[9] = se),
      (t[10] = le))
    : ((ae = t[7]), (oe = t[8]), (se = t[9]), (le = t[10]));
  let ue = c || re ? `opacity-60` : void 0,
    de = re ? `opacity-100` : `opacity-0 group-hover:opacity-100`,
    k;
  t[11] === de
    ? (k = t[12])
    : ((k = C(
  ...
  t[13] === k
    ? (A = t[14])
    : ((A = (0, J.jsx)(fe, { className: k, "aria-hidden": !0 })), (t[13] = k), (t[14] = A));
  let he;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((he = (0, J.jsx)(be, { className: `icon-2xs text-token-input-placeholder-foreground/70` })),
      (t[15] = he))
    : (he = t[15]);
  let j;
  t[16] !== h || t[17] !== g || t[18] !== v || t[19] !== A
    ? ((j = (0, J.jsxs)(`span`, {
        ref: v,
  ...
  let I;
  t[31] !== p || t[32] !== T
    ? ((I = p.formatMessage(T)), (t[31] = p), (t[32] = T), (t[33] = I))
    : (I = t[33]);
  let L;
  t[34] !== n || t[35] !== ee
    ? ((L = (e) => {
  ...
  t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ve = (0, J.jsx)(xe, { className: `icon-2xs shrink-0` })), (t[37] = ve))
    : (ve = t[37]);
  let R;
  t[38] === T ? (R = t[39]) : ((R = (0, J.jsx)(O, { ...T })), (t[38] = T), (t[39] = R));
  let z;
  ...
  t[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = (0, J.jsx)(pe, { className: `icon-2xs` })), (t[52] = U))
    : (U = t[52]);
  let W;
  t[53] !== V || t[54] !== H
    ? ((W = (0, J.jsx)(ne, {
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, J.jsx)(te, { className: `icon-2xs` })), (t[58] = Se))
    : (Se = t[58]);
  let K;
  t[59] === G
    ? (K = t[60])
  ...
  t[72] !== X || t[73] !== Z
    ...
    : (Q = t[74]);
  let Ee;
  t[75] !== K || t[76] !== Y || t[77] !== Q
    ? ((Ee = (0, J.jsxs)(b, { align: `end`, triggerButton: K, children: [Y, Q] })),
      (t[75] = K),
      (t[76] = Y),
      (t[77] = Q),
      (t[78] = Ee))
    : (Ee = t[78]);
  let De;
  t[79] !== B || t[80] !== W || t[81] !== Ee
    ? ((De = (0, J.jsxs)(J.Fragment, { children: [B, W, Ee] })),
      (t[79] = B),
      (t[80] = W),
      (t[81] = Ee),
      (t[82] = De))
    : (De = t[82]);
  let $;
  t[83] !== j || t[84] !== P || t[85] !== De || t[86] !== ue
    ? (($ = (0, J.jsx)(_e, { className: ue, icon: j, title: P, actions: De })),
      (t[83] = j),
      (t[84] = P),
      (t[85] = De),
      (t[86] = ue),
...
function q(e) {
  ...
  let a = s(d(m, i)),
    o;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = [L, I]), (t[1] = o)) : (o = t[1]);
  let c;
  t[2] !== n || t[3] !== r
    ? ((c = (e) => {
  ...
  return (
    t[5] !== a || t[6] !== c
      ? ((l = { sensors: a, collisionDetection: g, modifiers: o, onDragEnd: c }),
        (t[5] = a),
        (t[6] = c),
        (t[7] = l))
      : (l = t[7]),
...
function Ce(
  e,
  {
    ...
    selectedTextAttachmentCount: c = 0,
  },
) {
  ...
  return n > 0 || r > 0 || i > 0 || a > 0
    ? B(e, { annotationCount: n, designTweakCount: r, commentCount: i + a })
    : c > 0
      ? e.formatMessage(
          {
...
export { G as QueuedMessageList };
//# sourceMappingURL=queued-message-list-B8Ie-nMz.js.map
