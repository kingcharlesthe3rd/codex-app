...
import { g as r, n as i, t as a } from "./chunk-44.js";
import {
  B as o,
  L as s,
  V as l,
...
import { t as g } from "./dist-Y1G-iXdi.js";
import { a as _, s as v } from "./chunk-143.js";
var y = g(),
  b = (function () {
    var e = t(function (e, t, n, r) {
      ...
      J = {
        ...
        table: [
          ...
          { 1: [2, 8] },
          e(re, [2, 15]),
          e(ie, [2, 17], { 21: 22, 19: 130, 22: n, 23: r, 24: i, 26: a, 28: o }),
          e(re, [2, 37], {
            19: 20,
            20: 21,
            21: 22,
...
var x = b,
  ...
  me = t(function (e, t, n) {
    ...
    ((l.fontWeight = `bold`),
      (l.fontSize += 2),
      (l.fontColor = o),
      Y(n)(t.label.text, r, t.x, t.y + t.label.Y, t.width, t.height, { fill: `#444444` }, l),
      t.type &&
        t.type.text !== `` &&
        ((l = n.boundaryFont()),
        (l.fontColor = o),
        Y(n)(t.type.text, r, t.x, t.y + t.type.Y, t.width, t.height, { fill: `#444444` }, l)),
      t.descr &&
        t.descr.text !== `` &&
        ((l = n.boundaryFont()),
        (l.fontSize -= 2),
        (l.fontColor = o),
        Y(n)(t.descr.text, r, t.x, t.y + t.descr.Y, t.width, t.height, { fill: `#444444` }, l)));
  }, `drawBoundary`),
  he = t(function (e, t, n) {
    ...
    return (
      ...
      (d.fontSize += 2),
      (d.fontColor = a),
      Y(n)(t.label.text, s, t.x, t.y + t.label.Y, t.width, t.height, { fill: a }, d),
      ...
      t.descr &&
        ...
        ((d = n.personFont()),
        (d.fontColor = a),
        Y(n)(t.descr.text, s, t.x, t.y + t.descr.Y, t.width, t.height, { fill: a }, d)),
      t.height
    );
  }, `drawC4Shape`),
  ge = t(function (e, t) {
...
var Z = {},
  Oe = class {
    ...
    insert(e) {
      ...
      let t =
        ...
        i = r + e.height;
      ((t >= this.data.widthLimit || n >= this.data.widthLimit || this.nextData.cnt > Ee) &&
  ...
  ke = t(function (e) {
    (p(Z, e),
      e.fontFamily &&
        (Z.personFontFamily = Z.systemFontFamily = Z.messageFontFamily = e.fontFamily),
      e.fontSize && (Z.personFontSize = Z.systemFontSize = Z.messageFontSize = e.fontSize),
      e.fontWeight &&
        (Z.personFontWeight = Z.systemFontWeight = Z.messageFontWeight = e.fontWeight));
  }, `setConf`),
  Ae = t(
    (e, t) => ({
      fontFamily: e[t + `FontFamily`],
...
var Ne = t(function (e, t, n) {
        ...
        : n < i && r < a
          ...
          : n < i && r > a
            ...
            : n > i &&
              r > a &&
              (p =
                f >= d ? new $(n, s - (e.width / 2) * d) : new $(o - ((e.height / 2) * l) / u, r)),
      p
    );
  }, `getIntersectPoint`),
  Ie = t(function (e, t) {
    ...
    let r = Fe(e, n);
    return (
      (n.x = e.x + e.width / 2), (n.y = e.y + e.height / 2), { startPoint: r, endPoint: Fe(t, n) }
    );
  }, `getIntersectPoints`),
  Le = t(function (e, t, n, r, a) {
    ...
    for (let e of t) {
      ...
      let t = e.wrap && Z.wrap,
        a = Me(Z);
      r.db.getC4Type() === `C4Dynamic` && (e.label.text = o + `: ` + e.label.text);
      let s = i(e.label.text, a);
      (Q(`label`, e, t, a, s),
        e.techn && e.techn.text !== `` && ((s = i(e.techn.text, a)), Q(`techn`, e, t, a, s)),
        e.descr && e.descr.text !== `` && ((s = i(e.descr.text, a)), Q(`descr`, e, t, a, s)));
...
function Re(e, t, n, r, i) {
  ...
  for (let [o, s] of r.entries()) {
    ...
    if (o == 0 || o % De === 0) {
      ...
      let e = a.data.stopx === a.data.startx ? a.data.startx : a.data.stopx + Z.diagramMarginX,
        t = a.data.starty;
      a.setData(e, e, t, t);
    }
    a.name = s.alias;
...
var ze = {
    ...
    draw: t(function (t, r, i, a) {
      ...
      let m = new Oe(a);
      (m.setData(Z.diagramMarginX, Z.diagramMarginX, Z.diagramMarginY, Z.diagramMarginY),
      ...
      (p.attr(
        `viewBox`,
        g.startx - Z.diagramMarginX + ` -` + (Z.diagramMarginY + y) + ` ` + v + ` ` + (_ + y),
      ),
        e.debug(`models:`, g));
    }, `draw`),
  },
