      ...
      (Oe = L(
        ...
        ({ cwd: e, enabled: t, hostConfig: n, operationSource: r, query: i }, { get: a }) => {
          ...
          return M(
            ...
            C(n),
            n,
            { enabled: t, select: (e) => e.branches, staleTime: m.FIVE_SECONDS },
          );
        },
        { key: Ee },
      )));
...
function Ne(e, t, n, r) {
  ...
  return (
    i[2] === r
      ? (o = i[3])
      : ((o = { select: Pe, staleTime: m.FIVE_SECONDS, ...r }), (i[2] = r), (i[3] = o)),
...
function Le(e, t, n, r) {
  ...
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((d = async (e, t, n, i, s) => {
        (o &&
          e?.status === `success` &&
          O(a, { commonDir: o.commonDir, root: o.root }, { changeType: `head`, hostKey: c }),
  ...
  i[10] !== n || i[11] !== r || i[12] !== u || i[13] !== d
    ? ((f = { source: n, mutationKey: u, ...r, onSettled: d }),
      ...
      (i[14] = f))
    : (f = i[14]);
  let p = y(`git-checkout-branch`, f),
    m,
    h;
  i[15] !== t.id || i[16] !== p
    ? ((m = (e, n) => {
        p.mutate({ ...e, hostId: t.id }, n);
      }),
      (h = (e, n) => p.mutateAsync({ ...e, hostId: t.id }, n)),
      (i[15] = t.id),
      (i[16] = p),
      (i[17] = m),
      (i[18] = h))
...
function Be(e, t, n, r) {
  ...
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((d = async (e, t, n, i, s) => {
        (o && O(a, o, { changeType: n?.mode === `synced` ? `synced-branch` : `head`, hostKey: c }),
          r?.onSettled && (await r.onSettled(e, t, n, i, s)));
      }),
      (i[5] = o),
      (i[6] = c),
...
function Ke(e) {
  let t = (0, et.c)(86),
    ...
    j;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((j = []), (t[0] = j)) : (j = t[0]);
  let [M, N] = (0, Z.useState)(j),
    [P, F] = (0, Z.useState)(`idle`),
    ae;
  t[1] !== n || t[2] !== r || t[3] !== a
    ? ((ae = {
        cwd: n,
  ...
  let I = ie(de, ae),
    ...
    U = Be(n, r, $),
    W;
  t[5] === n ? (W = t[6]) : ((W = n == null ? null : g(n)), (t[5] = n), (t[6] = W));
  let G = W,
    K;
  t[7] !== G || t[8] !== r
  ...
  t[30] !== q || t[31] !== m
    ? ((we = () => {
        q != null && (m.set(be, q, ``), F(`idle`), D(qe), S(!1), T(!0));
      }),
      (t[30] = q),
      (t[31] = m),
      (t[32] = we))
  ...
  let Te = we,
    Ee;
  t[33] !== he || t[34] !== _e || t[35] !== ye || t[36] !== O
    ? ((Ee = (e) => {
        if (e === `success` && O != null) {
          let e = O;
          if ((ye(), e.type === `checkout`)) {
            he(e.branch);
            return;
          }
          _e(e.branch);
  ...
  t[38] === d
    ...
    : ((ke = (e) => {
      ...
      (t[38] = d),
      (t[39] = ke));
  let Ae = u({ currentBranch: L, disabled: J, isPending: J, switchTooltipText: oe }),
    je;
  t[40] !== he ||
  t[41] !== Y ||
  t[42] !== L ||
  ...
  t[55] !== je
    ...
    : (Me = t[56]);
  let Ne;
  t[57] !== z || t[58] !== _e || t[59] !== n || t[60] !== r || t[61] !== C || t[62] !== J
    ? ((Ne = C
        ? (0, Q.jsx)(Ye, {
            open: C,
            onOpenChange: w,
...
function Je(e) {
  let t = (0, et.c)(53),
    ...
    [m, h] = (0, Z.useState)(``),
    g = d(m, 200),
    { data: _, refetch: v } = Ae(r, a, $),
    y;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = { enabled: !0 }), (t[0] = y))
    : (y = t[0]);
  let { data: te, isLoading: b, isFetching: x, isError: S, refetch: C } = Ne(r, a, $, y),
    w = te === void 0 ? [] : te,
    ne;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ne = { enabled: !0 }), (t[1] = ne))
    : (ne = t[1]);
  let { data: T, refetch: re } = ue(r, a, $, ne),
    E,
    D;
  (t[2] !== o || t[3] !== C || t[4] !== re || t[5] !== v
    ? ((E = () => {
        o && Promise.all([C(), re(), v()]);
      }),
      (D = [o, C, re, v]),
      (t[2] = o),
      (t[3] = C),
    ...
    (0, Z.useEffect)(E, D));
  let O;
  t[8] === m ? (O = t[9]) : ((O = m.trim()), (t[8] = m), (t[9] = O));
  let k = O,
    A;
  t[10] === g ? (A = t[11]) : ((A = g.trim()), (t[10] = g), (t[11] = A));
  let j = A,
    M = k !== j,
    N = j.length > 0,
    P;
  t[12] !== r || t[13] !== a || t[14] !== j || t[15] !== N
    ? ((P = { cwd: r, hostConfig: a, operationSource: $, query: j, enabled: N }),
      (t[12] = r),
      (t[13] = a),
      (t[14] = j),
      (t[15] = N),
      (t[16] = P))
    : (P = t[16]);
  let { data: F, isFetching: ae, isError: I, refetch: L } = ie(Oe, P),
    R = Ze({ branches: w, currentBranch: n, defaultBranch: T }),
    z = !b && !x && !S && w.length === 0,
    B = $e(_),
    V;
  t[17] !== z || t[18] !== p
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (0, Q.jsx)(G.Separator, {})), (t[42] = se))
    : (se = t[42]);
  let ce = z || s,
    Y;
  t[43] === f
  ...
  return (
    t[50] !== oe || t[51] !== X
      ? ((de = (0, Q.jsxs)(Q.Fragment, { children: [oe, se, X] })),
        (t[50] = oe),
        (t[51] = X),
        (t[52] = de))
      : (de = t[52]),
...
function Ye(e) {
  let t = (0, et.c)(57),
    ...
    p;
  t[0] !== f || t[1] !== i
    ? ((p = he({ branchPrefix: f, conversationTitle: i })), (t[0] = f), (t[1] = i), (t[2] = p))
    : (p = t[2]);
  let [m, h] = (0, Z.useState)(p),
    g = n && a != null,
    _;
  t[3] === g ? (_ = t[4]) : ((_ = { enabled: g }), (t[3] = g), (t[4] = _));
  let { data: v, isLoading: y, isFetching: te, isError: b } = Ne(a, s, $, _),
    x,
    S,
    C,
    T;
  if (t[5] !== m || t[6] !== v) {
    x = v === void 0 ? [] : v;
    let e = Ze({ branches: x, currentBranch: ``, defaultBranch: null });
    ((T = m.trim()),
      (S = T.endsWith(`/`)),
      (C = T.length > 0 && e.includes(T)),
      (t[5] = m),
      (t[6] = v),
      (t[7] = x),
      (t[8] = S),
      (t[9] = C),
      (t[10] = T));
  } else ((x = t[7]), (S = t[8]), (C = t[9]), (T = t[10]));
  let E = C,
    ie = !y && !te && !b && x.length === 0,
    D = !c && !y && !te && !ie && T.length > 0 && !S && !E && a != null,
    O;
  ...
  let L;
  t[31] !== P || t[32] !== I
    ? ((L = (0, Q.jsxs)(J, { className: `flex flex-col gap-2`, children: [k, P, I] })),
      (t[31] = P),
      (t[32] = I),
      (t[33] = L))
    : (L = t[33]);
  ...
  t[37] === R
    ? (B = t[38])
    : ((B = (0, Q.jsx)(ae, { color: `secondary`, onClick: R, children: z })),
      (t[37] = R),
      (t[38] = B));
  let V = !D,
    H;
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (U = t[42]);
  let W;
  t[43] !== c || t[44] !== V || t[45] !== H
    ? ((W = (0, Q.jsx)(ae, { color: `primary`, disabled: V, loading: c, onClick: H, children: U })),
      (t[43] = c),
      (t[44] = V),
      (t[45] = H),
      (t[46] = W))
  ...
  let G;
  t[47] !== B || t[48] !== W
    ? ((G = (0, Q.jsx)(J, { children: (0, Q.jsxs)(ne, { children: [B, W] }) })),
      (t[47] = B),
      (t[48] = W),
      (t[49] = G))
    : (G = t[49]);
  let K;
  t[50] !== L || t[51] !== G
    ? ((K = (0, Q.jsxs)(oe, { "data-codex-branch-create-dialog": ``, children: [O, L, G] })),
      (t[50] = L),
      (t[51] = G),
      (t[52] = K))
    : (K = t[52]);
  ...
  return (
    t[53] !== r || t[54] !== n || t[55] !== K
      ? ((q = (0, Q.jsx)(re, { size: `feature`, open: n, onOpenChange: r, children: K })),
        (t[53] = r),
        (t[54] = n),
        (t[55] = K),
        (t[56] = q))
...
function Xe(e) {
  ...
  t[4] === n
    ? (_ = t[5])
    : ((_ = { enabled: n, staleTime: m.FIVE_SECONDS }), (t[4] = n), (t[5] = _));
  let { data: v } = W(a, s, `review-summary`, h, $, _),
    y;
  t[6] === a ? (y = t[7]) : ((y = g(a)), (t[6] = a), (t[7] = y));
  let te;
  t[8] === y
    ? (te = t[9])
    : ((te = { cwd: y, operationSource: $, source: `unstaged` }), (t[8] = y), (t[9] = te));
  let b;
  t[10] === n
    ? (b = t[11])
    : ((b = { enabled: n, staleTime: m.FIVE_SECONDS }), (t[10] = n), (t[11] = b));
  let { data: x } = W(a, s, `review-summary`, te, $, b),
    S,
    C,
    w,
    T,
  ...
  if (
    ...
    let e = [v, x],
      a = xe(e),
      s = a?.totalAdditions ?? 0,
      l = a?.totalDeletions ?? 0,
      p = s + l > 0,
      m = i.length > 0,
      h;
    t[29] === f ? (h = t[30]) : ((h = $e(f)), (t[29] = f), (t[30] = h));
    let g = h,
      _;
    t[31] !== d || t[32] !== c
      ? ((_ =
          ...
          ? (0, Q.jsxs)(`span`, {
              ...
              children: [
                ...
                (0, Q.jsx)(u, {
                  ...
                  values: { fileCount: g, branchName: ee },
                }),
              ],
            })
          : (0, Q.jsx)(u, {
    ...
    ((S = t[20]),
      ...
      (k = t[28]));
  let A;
  t[35] !== S || t[36] !== D || t[37] !== O
    ? ((A = (0, Q.jsx)(S, { className: D, children: O })),
      (t[35] = S),
      (t[36] = D),
      (t[37] = O),
      (t[38] = A))
  ...
  t[42] === j
    ? (N = t[43])
    : ((N = (0, Q.jsx)(ae, { color: `secondary`, onClick: j, children: M })),
      (t[42] = j),
      (t[43] = N));
  let P;
  ...
  t[45] === l
    ? (F = t[46])
    : ((F = (0, Q.jsx)(ae, { color: `primary`, onClick: l, children: P })),
      (t[45] = l),
      (t[46] = F));
  let I;
  t[47] !== N || t[48] !== F
    ? ((I = (0, Q.jsx)(J, { children: (0, Q.jsxs)(ne, { children: [N, F] }) })),
      (t[47] = N),
      (t[48] = F),
      (t[49] = I))
    : (I = t[49]);
  let L;
  t[50] !== C || t[51] !== A || t[52] !== I || t[53] !== k
    ? ((L = (0, Q.jsxs)(C, { children: [k, A, I] })),
      (t[50] = C),
      (t[51] = A),
      (t[52] = I),
      (t[53] = k),
  ...
  let R;
  return (
    t[55] !== w || t[56] !== T || t[57] !== E || t[58] !== ie || t[59] !== L
      ? ((R = (0, Q.jsx)(w, { size: T, open: E, onOpenChange: ie, children: L })),
        (t[55] = w),
        (t[56] = T),
        (t[57] = E),
        (t[58] = ie),
