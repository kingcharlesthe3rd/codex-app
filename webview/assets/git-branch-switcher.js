...
import { a as r, o as i, p as a, t as o, z as s } from "./app-scope.js";
import {
  St as c,
  Tr as l,
  br as u,
...
import { A as g, s as _, u as v } from "./vscode-api.js";
import { pn as y, w as b } from "./src-2.js";
import { l as x, s as S } from "./lib.js";
...
import { a as te, i as ne, l as re, n as D, r as ie } from "./dialog-layout-B.js";
import { t as O } from "./use-debounced-value-Dw-7BPJJ.js";
import { t as k } from "./plus.js";
import { n as ae } from "./git-current-branch-query.js";
import { t as A } from "./use-git-default-branch.js";
import { r as j } from "./diff-stats.js";
import { B as M, N, V as P, n as F, r as I, t as L } from "./git-branch-picker-dropdown-content.js";
import { t as oe } from "./get-default-branch-name.js";
var R = a(
    o,
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r }) => u(e, h(n), n, r, { enabled: t }),
    { key: B },
  ),
  z = a(
    o,
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r, query: i }, { get: a }) => {
      let o = a(R, { cwd: e, enabled: t, hostConfig: n, operationSource: r }).data;
      return d(
        `search-branches`,
        o,
        ...
        h(n),
        n,
        { enabled: t, select: (e) => e.branches, staleTime: v.FIVE_SECONDS },
      );
    },
    { key: V },
  );
function B({ cwd: e, enabled: t, hostConfig: n, operationSource: r }) {
  return JSON.stringify({ cwd: e ?? null, enabled: t, hostConfig: n, operationSource: r });
}
function V({ cwd: e, enabled: t, hostConfig: n, operationSource: r, query: i }) {
...
function ce(e, t, n, r) {
  ...
  let c = String(e),
    l;
  i[5] === c ? (l = i[6]) : ((l = y(c)), (i[5] = c), (i[6] = l));
  let u;
  i[7] !== n || i[8] !== l
    ? ((u = { cwd: l, operationSource: n }), (i[7] = n), (i[8] = l), (i[9] = u))
    : (u = i[9]);
  let d = s ?? v.FIVE_SECONDS,
    p;
  return (
    i[10] !== o || i[11] !== d
      ? ((p = { staleTime: d, ...o }), (i[10] = o), (i[11] = d), (i[12] = p))
      : (p = i[12]),
    f(e, t, `status-summary`, u, n, p)
  );
}
function H(e, t, n, r) {
  let i = (0, se.c)(4),
  ...
  return (
    i[2] === r
      ? (o = i[3])
      : ((o = { select: U, staleTime: v.FIVE_SECONDS, ...r }), (i[2] = r), (i[3] = o)),
    f(e, t, `recent-branches`, a, n, o)
  );
}
function U(e) {
  return e.branches;
...
function le(e, t, n, r) {
  let i = (0, se.c)(23),
    ...
    { data: o } = m(e, t, n),
    s;
  i[0] === t ? (s = i[1]) : ((s = h(t)), (i[0] = t), (i[1] = s));
  let c = s,
    l = e ?? null,
    u;
  i[2] !== t.id || i[3] !== l
    ? ((u = [`vscode`, `git-checkout-branch`, l, t.id]), (i[2] = t.id), (i[3] = l), (i[4] = u))
    : (u = i[4]);
  let d;
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((d = async (e, t, n, i, s) => {
        (o &&
          e?.status === `success` &&
          p(a, { commonDir: o.commonDir, root: o.root }, { changeType: `head`, hostKey: c }),
  ...
  i[10] !== n || i[11] !== r || i[12] !== u || i[13] !== d
    ? ((f = { source: n, mutationKey: u, ...r, onSettled: d }),
      (i[10] = n),
      (i[11] = r),
      (i[12] = u),
      (i[13] = d),
      (i[14] = f))
    : (f = i[14]);
  let v = _(`git-checkout-branch`, f),
    y,
    b;
  i[15] !== t.id || i[16] !== v
    ? ((y = (e, n) => {
        v.mutate({ ...e, hostId: t.id }, n);
      }),
      (b = (e, n) => v.mutateAsync({ ...e, hostId: t.id }, n)),
      (i[15] = t.id),
      (i[16] = v),
      (i[17] = y),
      (i[18] = b))
  ...
  let x;
  return (
    i[19] !== v || i[20] !== y || i[21] !== b
      ? ((x = { ...v, mutate: y, mutateAsync: b }),
        (i[19] = v),
        (i[20] = y),
        (i[21] = b),
        (i[22] = x))
...
function W(e, t, n, r) {
  ...
  let c = s,
    ...
    u;
  i[2] !== t.id || i[3] !== l
    ? ((u = [`vscode`, `git-create-branch`, l, t.id]), (i[2] = t.id), (i[3] = l), (i[4] = u))
    : (u = i[4]);
  let d;
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((d = async (e, t, n, i, s) => {
        (o && p(a, o, { changeType: n?.mode === `synced` ? `synced-branch` : `head`, hostKey: c }),
          r?.onSettled && (await r.onSettled(e, t, n, i, s)));
      }),
      (i[5] = o),
      (i[6] = c),
...
function ue(e) {
  return Array.from(e)
    .filter((e) => !/\s/u.test(e) && !G.has(e))
    .join(``);
}
var K = e(t(), 1),
  q = n(),
  J = `composer_branch_switcher`;
function Y(e) {
  let t = (0, se.c)(86),
    {
      gitRoot: n,
  ...
  let [F, L] = (0, K.useState)(P),
    [oe, R] = (0, K.useState)(`idle`),
    z;
  t[1] !== n || t[2] !== a || t[3] !== u
    ? ((z = {
        cwd: n,
  ...
  let B = r(ae, z),
    ...
    ue = W(n, a, J),
    Y;
  t[5] === n ? (Y = t[6]) : ((Y = n == null ? null : y(n)), (t[5] = n), (t[6] = Y));
  let pe = Y,
    me;
  t[7] !== pe || t[8] !== a
    ? ((me = pe == null ? null : { cwd: pe, hostId: a.id }), (t[7] = pe), (t[8] = a), (t[9] = me))
    : (me = t[9]);
  let he = me,
    Q = G.isPending || ue.isPending,
    ge = b.formatMessage({
  ...
  t[26] !== xe
    ? ((Te = async (e) => {
        if (!(Q || n == null))
          try {
            let t = await ue.mutateAsync({ cwd: n, branch: e, mode: `worktree`, failIfExists: !0 });
            if (t.status === `error`) {
              xe(t.error);
              return;
            }
  ...
  t[30] !== he || t[31] !== v
    ? ((je = () => {
        he != null && (v.set(N, he, ``), R(`idle`), A(X), ne(!1), O(!0));
      }),
      (t[30] = he),
      (t[31] = v),
      (t[32] = je))
  ...
  let Me = je,
    Ne;
  t[33] !== we || t[34] !== Ee || t[35] !== Oe || t[36] !== j
    ? ((Ne = (e) => {
        if (e === `success` && j != null) {
          let e = j;
  ...
  let Pe = Ne;
  if (!ce)
    return u && B.isSuccess
      ? m({ currentBranch: null, disabled: !1, isPending: !1, switchTooltipText: ge })
      : null;
  if (n == null) return p?.({ currentBranch: V }) ?? null;
  let Fe = E,
    Ie;
  t[38] === h
    ? (Ie = t[39])
    : ((Ie = (e) => {
      ...
      (t[38] = h),
      (t[39] = Ie));
  let Le = m({ currentBranch: V, disabled: Q, isPending: Q, switchTooltipText: ge }),
    Re;
  t[40] !== we ||
  t[41] !== $ ||
  t[42] !== V ||
  ...
  t[55] !== Re
    ...
    : (ze = t[56]);
  let Be;
  t[57] !== H || t[58] !== Ee || t[59] !== n || t[60] !== a || t[61] !== re || t[62] !== Q
    ? ((Be = re
        ? (0, q.jsx)(de, {
            open: re,
            onOpenChange: D,
  ...
  return (
    t[81] !== ze || t[82] !== Be || t[83] !== Ve || t[84] !== He
      ? ((Ue = (0, q.jsxs)(q.Fragment, { children: [ze, Be, Ve, He] })),
        (t[81] = ze),
        (t[82] = Be),
        (t[83] = Ve),
        (t[84] = He),
...
function Z(e) {
  let t = (0, se.c)(53),
    ...
    [f, p] = (0, K.useState)(``),
    m = O(f, 200),
    { data: h, refetch: g } = ce(i, a, J),
    _;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = { enabled: !0 }), (t[0] = _))
    : (_ = t[0]);
  let { data: v, isLoading: y, isFetching: b, isError: ee, refetch: C } = H(i, a, J, _),
    w = v === void 0 ? [] : v,
    E;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = { enabled: !0 }), (t[1] = E))
    : (E = t[1]);
  let { data: te, refetch: ne } = A(i, a, J, E),
    re,
    D;
  (t[2] !== o || t[3] !== C || t[4] !== ne || t[5] !== g
    ...
    (0, K.useEffect)(re, D));
  let ie;
  t[8] === f ? (ie = t[9]) : ((ie = f.trim()), (t[8] = f), (t[9] = ie));
  let ae = ie,
    j;
  ...
  t[12] !== i || t[13] !== a || t[14] !== M || t[15] !== P
    ? ((F = { cwd: i, hostConfig: a, operationSource: J, query: M, enabled: P }),
      (t[12] = i),
      (t[13] = a),
      (t[14] = M),
      (t[15] = P),
      (t[16] = F))
    : (F = t[16]);
  let { data: I, isFetching: oe, isError: R, refetch: B } = r(z, F),
    V = pe({ branches: w, currentBranch: n, defaultBranch: te }),
    U = !y && !b && !ee && w.length === 0,
    le = he(h),
    W;
  t[17] !== U || t[18] !== d
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, q.jsx)(T.Separator, {})), (t[42] = me))
    : (me = t[42]);
  let Q = U || s,
    ge;
  t[43] === u
  ...
  return (
    t[50] !== fe || t[51] !== $
      ? ((ve = (0, q.jsxs)(q.Fragment, { children: [fe, me, $] })),
        (t[50] = fe),
        (t[51] = $),
        (t[52] = ve))
      : (ve = t[52]),
...
function de(e) {
  let t = (0, se.c)(57),
    ...
    d;
  t[0] !== u || t[1] !== i
    ? ((d = oe({ branchPrefix: u, conversationTitle: i })), (t[0] = u), (t[1] = i), (t[2] = d))
    : (d = t[2]);
  let [f, p] = (0, K.useState)(d),
    m = n && a != null,
    h;
  t[3] === m ? (h = t[4]) : ((h = { enabled: m }), (t[3] = m), (t[4] = h));
  let { data: g, isLoading: _, isFetching: v, isError: y } = H(a, o, J, h),
    w,
    T,
    E,
    O;
  if (t[5] !== f || t[6] !== g) {
    w = g === void 0 ? [] : g;
    let e = pe({ branches: w, currentBranch: ``, defaultBranch: null });
    ((O = f.trim()),
      (T = O.endsWith(`/`)),
      (E = O.length > 0 && e.includes(O)),
      (t[5] = f),
      (t[6] = g),
      (t[7] = w),
      (t[8] = T),
      (t[9] = E),
      (t[10] = O));
  } else ((w = t[7]), (T = t[8]), (E = t[9]), (O = t[10]));
  let k = E,
    ae = !_ && !v && !y && w.length === 0,
    A = !s && !_ && !v && !ae && O.length > 0 && !T && !k && a != null,
    j;
  ...
  let B;
  t[31] !== R || t[32] !== z
    ? ((B = (0, q.jsxs)(te, { className: `flex flex-col gap-2`, children: [M, R, z] })),
      (t[31] = R),
      (t[32] = z),
      (t[33] = B))
    : (B = t[33]);
  ...
  t[37] === V
    ? (U = t[38])
    : ((U = (0, q.jsx)(ee, { color: `secondary`, onClick: V, children: ce })),
      (t[37] = V),
      (t[38] = U));
  let le = !A,
    W;
  ...
  let X;
  t[47] !== U || t[48] !== Y
    ? ((X = (0, q.jsx)(te, { children: (0, q.jsxs)(ie, { children: [U, Y] }) })),
      (t[47] = U),
      (t[48] = Y),
      (t[49] = X))
    : (X = t[49]);
  let Z;
  t[50] !== B || t[51] !== X
    ? ((Z = (0, q.jsxs)(D, { "data-codex-branch-create-dialog": ``, children: [j, B, X] })),
      (t[50] = B),
      (t[51] = X),
      (t[52] = Z))
    : (Z = t[52]);
  let de;
  return (
    t[53] !== r || t[54] !== n || t[55] !== Z
      ? ((de = (0, q.jsx)(re, { size: `feature`, open: n, onOpenChange: r, children: Z })),
        (t[53] = r),
        (t[54] = n),
        (t[55] = Z),
        (t[56] = de))
...
function fe(e) {
  let t = (0, se.c)(61),
    ...
    { data: u } = ce(a, o, J),
    d;
  t[0] === a ? (d = t[1]) : ((d = y(a)), (t[0] = a), (t[1] = d));
  let p;
  t[2] === d
    ? (p = t[3])
    : ((p = { cwd: d, includeUntrackedFiles: !1, operationSource: J, source: `staged` }),
      (t[2] = d),
      (t[3] = p));
  let m;
  t[4] === n
    ? (m = t[5])
    : ((m = { enabled: n, staleTime: v.FIVE_SECONDS }), (t[4] = n), (t[5] = m));
  let { data: h } = f(a, o, `review-summary`, p, J, m),
    g;
  t[6] === a ? (g = t[7]) : ((g = y(a)), (t[6] = a), (t[7] = g));
  let _;
  t[8] === g
    ? (_ = t[9])
    : ((_ = { cwd: g, operationSource: J, source: `unstaged` }), (t[8] = g), (t[9] = _));
  let b;
  t[10] === n
    ? (b = t[11])
    : ((b = { enabled: n, staleTime: v.FIVE_SECONDS }), (t[10] = n), (t[11] = b));
  let { data: C } = f(a, o, `review-summary`, _, J, b),
    w,
    T,
    E,
    O,
  ...
  if (
    ...
    let e = [h, C],
      ...
      f = i.length > 0,
      p;
    t[29] === u ? (p = t[30]) : ((p = he(u)), (t[29] = u), (t[30] = p));
    let m = p,
      g;
    t[31] !== l || t[32] !== s
      ? ((g =
    ...
    ((w = t[20]),
      ...
      (F = t[28]));
  let I;
  t[35] !== w || t[36] !== A || t[37] !== N
    ? ((I = (0, q.jsx)(w, { className: A, children: N })),
      (t[35] = w),
      (t[36] = A),
      (t[37] = N),
      (t[38] = I))
  ...
  t[42] === L
    ? (R = t[43])
    : ((R = (0, q.jsx)(ee, { color: `secondary`, onClick: L, children: oe })),
      (t[42] = L),
      (t[43] = R));
  let z;
  ...
  t[45] === c
    ? (B = t[46])
    : ((B = (0, q.jsx)(ee, { color: `primary`, onClick: c, children: z })),
      (t[45] = c),
      (t[46] = B));
  let V;
  t[47] !== R || t[48] !== B
    ? ((V = (0, q.jsx)(te, { children: (0, q.jsxs)(ie, { children: [R, B] }) })),
      (t[47] = R),
      (t[48] = B),
      (t[49] = V))
    : (V = t[49]);
  let H;
  t[50] !== T || t[51] !== I || t[52] !== V || t[53] !== F
    ? ((H = (0, q.jsxs)(T, { children: [F, I, V] })),
      (t[50] = T),
      (t[51] = I),
      (t[52] = V),
      (t[53] = F),
  ...
  let U;
  return (
    t[55] !== E || t[56] !== O || t[57] !== k || t[58] !== ae || t[59] !== H
      ? ((U = (0, q.jsx)(E, { size: O, open: k, onOpenChange: ae, children: H })),
        (t[55] = E),
        (t[56] = O),
        (t[57] = k),
        (t[58] = ae),
...
export { z as a, ce as i, ue as n, H as r, Y as t };
