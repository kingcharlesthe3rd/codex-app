      ...
      (Oe = a(
        ...
        ({ cwd: e, enabled: t, hostConfig: n, operationSource: r, query: i }, { get: a }) => {
          ...
          return B(
            ...
            U(n),
            n,
            { enabled: t, select: (e) => e.branches, staleTime: g.FIVE_SECONDS },
          );
        },
        { key: Ee },
      )));
...
function Ne(e, t, n, r) {
  ...
  return (
    i[2] === r
      ? (o = i[3])
      : ((o = { select: Pe, staleTime: g.FIVE_SECONDS, ...r }), (i[2] = r), (i[3] = o)),
...
function Le(e, t, n, r) {
  ...
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((d = async (e, t, n, i, s) => {
        (o &&
          e?.status === `success` &&
          L(a, { commonDir: o.commonDir, root: o.root }, { changeType: `head`, hostKey: c }),
...
function Be(e, t, n, r) {
  ...
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((d = async (e, t, n, i, s) => {
        (o && L(a, o, { changeType: n?.mode === `synced` ? `synced-branch` : `head`, hostKey: c }),
          r?.onSettled && (await r.onSettled(e, t, n, i, s)));
      }),
      (i[5] = o),
      (i[6] = c),
...
function Ke(e) {
  ...
  let L = o(b, F),
    ...
    U = Be(n, r, $),
    W;
  t[5] === n ? (W = t[6]) : ((W = n == null ? null : _(n)), (t[5] = n), (t[6] = W));
  let G = W,
    K;
  t[7] !== G || t[8] !== r
  ...
  if (!z)
    return c && L.isSuccess
      ? f({ currentBranch: null, disabled: !1, isPending: !1, switchTooltipText: J })
      : null;
  ...
  t[38] === p
    ...
    : ((ke = (e) => {
      ...
      (t[38] = p),
      (t[39] = ke));
  let Ae = f({ currentBranch: R, disabled: q, isPending: q, switchTooltipText: J }),
    je;
  t[40] !== _e ||
  t[41] !== X ||
  t[42] !== R ||
  ...
  t[55] !== je
    ...
    : (Me = t[56]);
  let Ne;
  t[57] !== B || t[58] !== ye || t[59] !== n || t[60] !== r || t[61] !== w || t[62] !== q
    ? ((Ne = w
        ? (0, Q.jsx)(Ye, {
            open: w,
            onOpenChange: T,
...
function Je(e) {
  ...
  t[12] !== r || t[13] !== i || t[14] !== j || t[15] !== P
    ? ((re = { cwd: r, hostConfig: i, operationSource: $, query: j, enabled: P }),
      (t[12] = r),
      (t[13] = i),
      (t[14] = j),
      (t[15] = P),
...
function Ye(e) {
  let t = (0, et.c)(57),
    ...
    d;
  t[0] !== u || t[1] !== i
    ? ((d = ue({ branchPrefix: u, conversationTitle: i })), (t[0] = u), (t[1] = i), (t[2] = d))
    : (d = t[2]);
  ...
  let L;
  t[31] !== F || t[32] !== I
    ? ((L = (0, Q.jsxs)(D, { className: `flex flex-col gap-2`, children: [A, F, I] })),
      (t[31] = F),
      (t[32] = I),
      (t[33] = L))
    : (L = t[33]);
  ...
  let G;
  t[50] !== L || t[51] !== W
    ? ((G = (0, Q.jsxs)(T, { "data-codex-branch-create-dialog": ``, children: [k, L, W] })),
      (t[50] = L),
      (t[51] = W),
      (t[52] = G))
    : (G = t[52]);
  ...
  return (
    t[53] !== r || t[54] !== n || t[55] !== G
      ? ((K = (0, Q.jsx)(ie, { size: `feature`, open: n, onOpenChange: r, children: G })),
        (t[53] = r),
        (t[54] = n),
        (t[55] = G),
        (t[56] = K))
...
function Xe(e) {
  ...
  t[2] === d
    ? (f = t[3])
    : ((f = { cwd: d, includeUntrackedFiles: !1, operationSource: $, source: `staged` }),
      (t[2] = d),
      (t[3] = f));
  let p;
  t[4] === n
  ...
  t[8] === h
    ? (v = t[9])
    : ((v = { cwd: h, operationSource: $, source: `unstaged` }), (t[8] = h), (t[9] = v));
  let y;
  t[10] === n
    ? (y = t[11])
    : ((y = { enabled: n, staleTime: g.FIVE_SECONDS }), (t[10] = n), (t[11] = y));
  ...
  return (
    t[55] !== S || t[56] !== C || t[57] !== w || t[58] !== E || t[59] !== L
      ? ((R = (0, Q.jsx)(S, { size: C, open: w, onOpenChange: E, children: L })),
        (t[55] = S),
        (t[56] = C),
        (t[57] = w),
        (t[58] = E),
