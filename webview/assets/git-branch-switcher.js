...
import { t as C } from "./use-debounced-value.js";
...
var L = S(
    h,
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: i }) => r(e, s(n), n, i, { enabled: t }),
    { key: z },
  ),
  R = S(
    h,
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r, query: i }, { get: a }) => {
      let c = a(L, { cwd: e, enabled: t, hostConfig: n, operationSource: r }).data;
      return o(
        `search-branches`,
        c,
        c == null ? null : { root: c.root, operationSource: r, query: i, limit: 20 },
        s(n),
        n,
...
function le(e, t, r, i) {
  let o = (0, ce.c)(13),
    s;
  o[0] === i ? (s = o[1]) : ((s = i === void 0 ? {} : i), (o[0] = i), (o[1] = s));
  let c, l;
  o[2] === s
    ? ((c = o[3]), (l = o[4]))
...
function V(e, t, n, r) {
  ...
  return (
    i[2] === r
      ? (s = i[3])
      : ((s = { select: H, staleTime: y.FIVE_SECONDS, ...r }), (i[2] = r), (i[3] = s)),
...
function ue(e, t, n, r) {
  ...
  let d = u,
    ...
    p;
  a[2] !== t.id || a[3] !== f
    ? ((p = [`vscode`, `git-checkout-branch`, f, t.id]), (a[2] = t.id), (a[3] = f), (a[4] = p))
    : (p = a[4]);
  let h;
  a[5] !== l || a[6] !== d || a[7] !== r || a[8] !== o
    ? ((h = async (e, t, n, a, s) => {
        (l &&
          e?.status === `success` &&
          i(o, { commonDir: l.commonDir, root: l.root }, { changeType: `head`, hostKey: d }),
...
function U(e, t, n, r) {
  ...
  let d = u,
    ...
    p;
  a[2] !== t.id || a[3] !== f
    ? ((p = [`vscode`, `git-create-branch`, f, t.id]), (a[2] = t.id), (a[3] = f), (a[4] = p))
    : (p = a[4]);
  let h;
  a[5] !== l || a[6] !== d || a[7] !== r || a[8] !== o
    ? ((h = async (e, t, n, a, s) => {
        (l && i(o, l, { changeType: n?.mode === `synced` ? `synced-branch` : `head`, hostKey: d }),
          r?.onSettled && (await r.onSettled(e, t, n, a, s)));
      }),
      (a[5] = l),
      (a[6] = d),
...
function J(e) {
  ...
  let z = v(T, R),
    ...
    de = U(r, i, q),
    J;
  t[5] === r ? (J = t[6]) : ((J = r == null ? null : n(r)), (t[5] = r), (t[6] = J));
  let me = J,
    Z;
  t[7] !== me || t[8] !== i
    ? ((Z = me == null ? null : { cwd: me, hostId: i.id }), (t[7] = me), (t[8] = i), (t[9] = Z))
    : (Z = t[9]);
  let he = Z,
  ...
  t[55] !== Re
    ...
    : (ze = t[56]);
  let Be;
  t[57] !== V || t[58] !== Ee || t[59] !== r || t[60] !== i || t[61] !== re || t[62] !== Q
    ? ((Be = re
        ? (0, K.jsx)(fe, {
            open: re,
            onOpenChange: ie,
...
function X(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = { enabled: !0 }), (t[0] = y))
    : (y = t[0]);
  let { data: b, isLoading: x, isFetching: S, isError: ee, refetch: w } = V(r, i, q, y),
    te = b === void 0 ? [] : b,
    T;
  ...
  t[12] !== r || t[13] !== i || t[14] !== j || t[15] !== N
    ? ((P = { cwd: r, hostConfig: i, operationSource: q, query: j, enabled: N }),
      (t[12] = r),
      (t[13] = i),
      (t[14] = j),
      (t[15] = N),
...
function fe(e) {
  let n = (0, ce.c)(57),
    ...
    f;
  n[0] !== d || n[1] !== a
    ? ((f = P({ branchPrefix: d, conversationTitle: a })), (n[0] = d), (n[1] = a), (n[2] = f))
    : (f = n[2]);
  ...
  let z;
  n[31] !== L || n[32] !== R
    ? ((z = (0, K.jsxs)(E, { className: `flex flex-col gap-2`, children: [j, L, R] })),
      (n[31] = L),
      (n[32] = R),
      (n[33] = z))
    : (z = n[33]);
  ...
  return (
    n[53] !== i || n[54] !== r || n[55] !== X
      ? ((fe = (0, K.jsx)(re, { size: `feature`, open: r, onOpenChange: i, children: X })),
        (n[53] = i),
        (n[54] = r),
        (n[55] = X),
        (n[56] = fe))
...
function pe(e) {
  ...
  t[2] === m
    ? (h = t[3])
    : ((h = { cwd: m, includeUntrackedFiles: !1, operationSource: q, source: `staged` }),
      (t[2] = m),
      (t[3] = h));
  let _;
  t[4] === r
  ...
  t[8] === b
    ? (x = t[9])
    : ((x = { cwd: b, operationSource: q, source: `unstaged` }), (t[8] = b), (t[9] = x));
  let S;
  t[10] === r
    ? (S = t[11])
    : ((S = { enabled: r, staleTime: y.FIVE_SECONDS }), (t[10] = r), (t[11] = S));
  ...
  return (
    t[55] !== T || t[56] !== D || t[57] !== O || t[58] !== oe || t[59] !== V
      ? ((H = (0, K.jsx)(T, { size: D, open: O, onOpenChange: oe, children: V })),
        (t[55] = T),
        (t[56] = D),
        (t[57] = O),
        (t[58] = oe),
