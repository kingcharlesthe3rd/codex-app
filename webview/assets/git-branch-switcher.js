...
import { Z as r, a as i, o as a, p as o, t as s } from "./app-scope-CWE-zIhQ.js";
import {
  Ft as c,
  Hn as l,
  Mn as u,
...
import { C as y, _n as b } from "./src.js";
import { l as x, s as S } from "./lib-1.js";
import { t as ee } from "./button-oF-qgtAS.js";
import { a as C } from "./setting-storage.js";
import { r as w } from "./toast-signal.js";
import { t as T } from "./plus.js";
import { t as E } from "./use-debounced-value.js";
import { n as D } from "./git-current-branch-query.js";
import { a as te, i as ne, l as O, n as re, r as ie } from "./dialog-layout.js";
import { r as k, t as ae } from "./dropdown.js";
...
var R = o(
    s,
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r }) => d(e, p(n), n, r, { enabled: t }),
    { key: B },
  ),
  z = o(
    s,
...
function le(e, t, n, r) {
  let i = (0, se.c)(23),
    ...
    { data: o } = l(e, t, n),
    s;
  i[0] === t ? (s = i[1]) : ((s = p(t)), (i[0] = t), (i[1] = s));
  let c = s,
    u = e ?? null,
    d;
  i[2] !== t.id || i[3] !== u
    ? ((d = [`vscode`, `git-checkout-branch`, u, t.id]), (i[2] = t.id), (i[3] = u), (i[4] = d))
    : (d = i[4]);
  let f;
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((f = async (e, t, n, i, s) => {
        (o &&
          e?.status === `success` &&
          h(a, { commonDir: o.commonDir, root: o.root }, { changeType: `head`, hostKey: c }),
    ...
    : (f = i[9]);
  let m;
  i[10] !== n || i[11] !== r || i[12] !== d || i[13] !== f
    ? ((m = { source: n, mutationKey: d, ...r, onSettled: f }),
      (i[10] = n),
      (i[11] = r),
      (i[12] = d),
      (i[13] = f),
...
function W(e, t, n, r) {
  ...
  let c = s,
    ...
    d;
  i[2] !== t.id || i[3] !== u
    ? ((d = [`vscode`, `git-create-branch`, u, t.id]), (i[2] = t.id), (i[3] = u), (i[4] = d))
    : (d = i[4]);
  let f;
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((f = async (e, t, n, i, s) => {
        (o && h(a, o, { changeType: n?.mode === `synced` ? `synced-branch` : `head`, hostKey: c }),
          r?.onSettled && (await r.onSettled(e, t, n, i, s)));
      }),
      (i[5] = o),
      (i[6] = c),
...
function Y(e) {
  ...
  let B = i(D, z),
    ...
    ue = W(n, r, J),
    Y;
  t[5] === n ? (Y = t[6]) : ((Y = n == null ? null : b(n)), (t[5] = n), (t[6] = Y));
  let pe = Y,
    me;
  t[7] !== pe || t[8] !== r
    ? ((me = pe == null ? null : { cwd: pe, hostId: r.id }), (t[7] = pe), (t[8] = r), (t[9] = me))
    : (me = t[9]);
  let he = me,
  ...
  t[30] !== he || t[31] !== v
    ? ((je = () => {
        he != null && (v.set(N, he, ``), R(`idle`), A(X), te(!1), ie(!0));
      }),
      (t[30] = he),
      (t[31] = v),
      (t[32] = je))
  ...
  t[38] === h
    ...
    : ((Ie = (e) => {
      ...
      (t[38] = h),
      (t[39] = Ie));
  let Le = p({ currentBranch: V, disabled: Q, isPending: Q, switchTooltipText: ge }),
    Re;
  t[40] !== we ||
  t[41] !== $ ||
  t[42] !== V ||
  ...
  t[55] !== Re
    ...
    : (ze = t[56]);
  let Be;
  t[57] !== H || t[58] !== Ee || t[59] !== n || t[60] !== r || t[61] !== ne || t[62] !== Q
    ? ((Be = ne
        ? (0, q.jsx)(de, {
            open: ne,
            onOpenChange: O,
...
function Z(e) {
  let t = (0, se.c)(53),
    ...
    [f, p] = (0, K.useState)(``),
    m = E(f, 200),
    { data: h, refetch: g } = ce(r, a, J),
    _;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = { enabled: !0 }), (t[0] = _))
    : (_ = t[0]);
  let { data: v, isLoading: y, isFetching: b, isError: ee, refetch: C } = H(r, a, J, _),
    w = v === void 0 ? [] : v,
    D;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = { enabled: !0 }), (t[1] = D))
    : (D = t[1]);
  let { data: te, refetch: ne } = A(r, a, J, D),
    O,
    re;
  ...
  let M = j,
    ...
    P = M.length > 0,
    F;
  t[12] !== r || t[13] !== a || t[14] !== M || t[15] !== P
    ? ((F = { cwd: r, hostConfig: a, operationSource: J, query: M, enabled: P }),
      (t[12] = r),
      (t[13] = a),
      (t[14] = M),
      (t[15] = P),
      (t[16] = F))
    : (F = t[16]);
  let { data: L, isFetching: oe, isError: R, refetch: B } = i(z, F),
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, q.jsx)(k.Separator, {})), (t[42] = me))
    : (me = t[42]);
  let Q = U || s,
    ge;
  t[43] === u
...
function de(e) {
  ...
  let { data: g, isLoading: _, isFetching: v, isError: b } = H(a, o, J, h),
    w,
    T,
    E,
    D;
  ...
  let k = E,
    ae = !_ && !v && !b && w.length === 0,
    A = !s && !_ && !v && !ae && D.length > 0 && !T && !k && a != null,
    j;
  ...
  let Z;
  t[50] !== B || t[51] !== X
    ? ((Z = (0, q.jsxs)(re, { "data-codex-branch-create-dialog": ``, children: [j, B, X] })),
      (t[50] = B),
      (t[51] = X),
      (t[52] = Z))
    : (Z = t[52]);
  ...
  return (
    t[53] !== r || t[54] !== n || t[55] !== Z
      ? ((de = (0, q.jsx)(O, { size: `feature`, open: n, onOpenChange: r, children: Z })),
        (t[53] = r),
        (t[54] = n),
        (t[55] = Z),
        (t[56] = de))
...
function fe(e) {
  ...
  t[10] === n
    ? (y = t[11])
    : ((y = { enabled: n, staleTime: v.FIVE_SECONDS }), (t[10] = n), (t[11] = y));
  let { data: C } = f(a, o, `review-summary`, _, J, y),
    w,
    T,
    E,
    D,
  ...
  t[35] !== w || t[36] !== A || t[37] !== N
    ? ((F = (0, q.jsx)(w, { className: A, children: N })),
      (t[35] = w),
      (t[36] = A),
      (t[37] = N),
      (t[38] = F))
  ...
  t[42] === I
    ? (R = t[43])
    : ((R = (0, q.jsx)(ee, { color: `secondary`, onClick: I, children: oe })),
      (t[42] = I),
      (t[43] = R));
  let z;
  ...
  t[47] !== R || t[48] !== B
    ...
    : (V = t[49]);
  let H;
  t[50] !== T || t[51] !== F || t[52] !== V || t[53] !== P
    ? ((H = (0, q.jsxs)(T, { children: [P, F, V] })),
      (t[50] = T),
      (t[51] = F),
      (t[52] = V),
      (t[53] = P),
  ...
  let U;
  return (
    t[55] !== E || t[56] !== D || t[57] !== k || t[58] !== ae || t[59] !== H
      ? ((U = (0, q.jsx)(E, { size: D, open: k, onOpenChange: ae, children: H })),
        (t[55] = E),
        (t[56] = D),
        (t[57] = k),
        (t[58] = ae),
