...
import { Kn as t, S as n } from "./src-2.js";
import {
  Hn as r,
  Qn as i,
  Yn as a,
...
import { a as ne, i as re, l as ie, n as E, r as ae } from "./dialog-layout.js";
import { r as D, t as O } from "./dropdown.js";
import { t as oe } from "./plus-d3DP-DMx.js";
import { t as k } from "./use-git-default-branch-CNI-XiEj.js";
...
function J(e) {
  ...
  n[30] !== he || n[31] !== y
    ? ((je = () => {
        he != null && (y.set(M, he, ``), L(`idle`), k(Y), re(!1), D(!0));
      }),
      (n[30] = he),
      (n[31] = y),
      (n[32] = je))
  ...
  let Me = je,
    Ne;
  n[33] !== we || n[34] !== Ee || n[35] !== Oe || n[36] !== A
    ? ((Ne = (e) => {
        if (e === `success` && A != null) {
          let e = A;
...
function X(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = { enabled: !0 }), (t[1] = T))
    : (T = t[1]);
  let { data: ne, refetch: re } = k(r, i, q, T),
    ie,
    E;
...
function Z(e) {
  let t = (0, ce.c)(57),
    ...
    f;
  t[0] !== d || t[1] !== a
    ? ((f = se({ branchPrefix: d, conversationTitle: a })), (t[0] = d), (t[1] = a), (t[2] = f))
    : (f = t[2]);
  ...
  let O = T,
    oe = !v && !y && !b && ee.length === 0,
    k = !c && !v && !y && !oe && D.length > 0 && !C && !O && o != null,
    A;
  ...
  let z;
  t[31] !== L || t[32] !== R
    ? ((z = (0, K.jsxs)(ne, { className: `flex flex-col gap-2`, children: [j, L, R] })),
      (t[31] = L),
      (t[32] = R),
      (t[33] = z))
    : (z = t[33]);
  ...
  let X;
  t[50] !== z || t[51] !== Y
    ? ((X = (0, K.jsxs)(E, { "data-codex-branch-create-dialog": ``, children: [A, z, Y] })),
      (t[50] = z),
      (t[51] = Y),
      (t[52] = X))
    : (X = t[52]);
...
function fe(e) {
  ...
  n[42] === I
    ? (L = n[43])
    : ((L = (0, K.jsx)(w, { color: `secondary`, onClick: I, children: se })),
      (n[42] = I),
      (n[43] = L));
  let R;
  ...
  let H;
  return (
    n[55] !== T || n[56] !== D || n[57] !== O || n[58] !== oe || n[59] !== V
