...
import { C as y, _n as b } from "./src-3.js";
...
var R = o(
    s,
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r }) => p(e, f(n), n, r, { enabled: t }),
    { key: B },
  ),
  z = o(
    s,
...
function le(e, t, n, r) {
  ...
  let c = s,
    ...
    p;
  i[2] !== t.id || i[3] !== l
    ? ((p = [`vscode`, `git-checkout-branch`, l, t.id]), (i[2] = t.id), (i[3] = l), (i[4] = p))
    : (p = i[4]);
  let m;
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((m = async (e, t, n, i, s) => {
        (o &&
          e?.status === `success` &&
          u(a, { commonDir: o.commonDir, root: o.root }, { changeType: `head`, hostKey: c }),
...
function W(e, t, n, r) {
  ...
  let c = s,
    ...
    p;
  i[2] !== t.id || i[3] !== l
    ? ((p = [`vscode`, `git-create-branch`, l, t.id]), (i[2] = t.id), (i[3] = l), (i[4] = p))
    : (p = i[4]);
  let m;
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((m = async (e, t, n, i, s) => {
        (o && u(a, o, { changeType: n?.mode === `synced` ? `synced-branch` : `head`, hostKey: c }),
          r?.onSettled && (await r.onSettled(e, t, n, i, s)));
      }),
      (i[5] = o),
      (i[6] = c),
...
function fe(e) {
  let t = (0, se.c)(61),
    ...
    { data: d } = ce(a, o, J),
    f;
  t[0] === a ? (f = t[1]) : ((f = b(a)), (t[0] = a), (t[1] = f));
  let p;
  t[2] === f
    ? (p = t[3])
    : ((p = { cwd: f, includeUntrackedFiles: !1, operationSource: J, source: `staged` }),
      (t[2] = f),
      (t[3] = p));
  let m;
  t[4] === n
  ...
  let { data: h } = c(a, o, `review-summary`, p, J, m),
    g;
  ...
  let { data: C } = c(a, o, `review-summary`, _, J, y),
    w,
    T,
    E,
    D,
  ...
  t[45] === l
    ? (B = t[46])
    : ((B = (0, q.jsx)(ee, { color: `primary`, onClick: l, children: z })),
      (t[45] = l),
      (t[46] = B));
  let V;
  t[47] !== R || t[48] !== B
