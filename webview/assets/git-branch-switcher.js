...
import { k as g, s as _, u as v } from "./vscode-api.js";
import { mn as y, w as b } from "./src-1.js";
import { c as x, o as S } from "./lib.js";
...
import { a as te, i as ne, l as re, n as D, r as ie } from "./dialog-layout.js";
...
var R = a(
    s,
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r }) => u(e, f(n), n, r, { enabled: t }),
    { key: B },
  ),
  z = a(
    s,
...
function le(e, t, n, r) {
  ...
  i[10] !== n || i[11] !== r || i[12] !== u || i[13] !== d
    ? ((m = { source: n, mutationKey: u, ...r, onSettled: d }),
      (i[10] = n),
      (i[11] = r),
      (i[12] = u),
      (i[13] = d),
...
function Y(e) {
  ...
  t[55] !== Re
    ...
    : (ze = t[56]);
  let Be;
  t[57] !== H || t[58] !== Ee || t[59] !== n || t[60] !== r || t[61] !== re || t[62] !== Q
    ? ((Be = re
        ? (0, q.jsx)(de, {
            open: re,
            onOpenChange: D,
...
function Z(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = { enabled: !0 }), (t[1] = E))
    : (E = t[1]);
  let { data: te, refetch: ne } = A(r, a, J, E),
    re,
    D;
  ...
  t[12] !== r || t[13] !== a || t[14] !== M || t[15] !== P
    ? ((F = { cwd: r, hostConfig: a, operationSource: J, query: M, enabled: P }),
      ...
      (t[16] = F))
    : (F = t[16]);
  let { data: I, isFetching: oe, isError: R, refetch: B } = i(z, F),
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, q.jsx)(O.Separator, {})), (t[42] = me))
    : (me = t[42]);
  let Q = U || s,
    ge;
  t[43] === u
...
function fe(e) {
  ...
  t[2] === d
    ? (f = t[3])
    : ((f = { cwd: d, includeUntrackedFiles: !1, operationSource: J, source: `staged` }),
      (t[2] = d),
      (t[3] = f));
  let p;
  t[4] === n
    ? (p = t[5])
    : ((p = { enabled: n, staleTime: v.FIVE_SECONDS }), (t[4] = n), (t[5] = p));
  let { data: h } = m(a, o, `review-summary`, f, J, p),
    g;
  ...
  let { data: C } = m(a, o, `review-summary`, _, J, b),
    w,
    T,
    E,
    O,
