      ...
      (Oe = _(
        ...
        ({ cwd: e, enabled: t, hostConfig: n, operationSource: r, query: i }, { get: a }) => {
          ...
          return L(
            ...
            U(n),
            n,
            { enabled: t, select: (e) => e.branches, staleTime: h.FIVE_SECONDS },
          );
        },
        { key: Ee },
      )));
...
function Ne(e, t, n, r) {
  ...
  return (
    i[2] === r
      ? (o = i[3])
      : ((o = { select: Pe, staleTime: h.FIVE_SECONDS, ...r }), (i[2] = r), (i[3] = o)),
...
function Le(e, t, n, r) {
  ...
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((f = async (e, t, n, i, s) => {
        (o &&
          e?.status === `success` &&
          N(a, { commonDir: o.commonDir, root: o.root }, { changeType: `head`, hostKey: c }),
...
function Be(e, t, n, r) {
  ...
  i[5] !== o || i[6] !== c || i[7] !== r || i[8] !== a
    ? ((f = async (e, t, n, i, s) => {
        (o && N(a, o, { changeType: n?.mode === `synced` ? `synced-branch` : `head`, hostKey: c }),
          r?.onSettled && (await r.onSettled(e, t, n, i, s)));
      }),
      (i[5] = o),
      (i[6] = c),
...
function Ke(e) {
  ...
  let z = c(v, R),
    ...
    K = Be(n, r, $),
    ie;
  t[5] === n ? (ie = t[6]) : ((ie = n == null ? null : u(n)), (t[5] = n), (t[6] = ie));
  let q = ie,
    ae;
  t[7] !== q || t[8] !== r
    ? ((ae = q == null ? null : { cwd: q, hostId: r.id }), (t[7] = q), (t[8] = r), (t[9] = ae))
    : (ae = t[9]);
  let oe = ae,
  ...
  t[26] !== me
    ? ((ve = async (e) => {
        if (!(J || n == null))
          try {
            let t = await K.mutateAsync({ cwd: n, branch: e, mode: `worktree`, failIfExists: !0 });
            if (t.status === `error`) {
              me(t.error);
              return;
            }
  ...
  if (!V)
    return a && z.isSuccess
      ? f({ currentBranch: null, disabled: !1, isPending: !1, switchTooltipText: Y })
      : null;
  ...
  t[38] === p
    ...
    : ((ke = (e) => {
      ...
      (t[38] = p),
      (t[39] = ke));
  let Ae = f({ currentBranch: B, disabled: J, isPending: J, switchTooltipText: Y }),
    je;
  t[40] !== _e ||
  t[41] !== X ||
  t[42] !== B ||
  ...
  t[55] !== je
    ...
    : (Me = t[56]);
  let Ne;
  t[57] !== H || t[58] !== ye || t[59] !== n || t[60] !== r || t[61] !== w || t[62] !== J
    ? ((Ne = w
        ? (0, Q.jsx)(Ye, {
            open: w,
            onOpenChange: T,
...
function Je(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = { enabled: !0 }), (t[0] = _))
    : (_ = t[0]);
  let { data: v, isLoading: y, isFetching: ee, isError: te, refetch: b } = Ne(r, i, $, _),
    S = v === void 0 ? [] : v,
    C;
  ...
  t[12] !== r || t[13] !== i || t[14] !== j || t[15] !== P
    ? ((F = { cwd: r, hostConfig: i, operationSource: $, query: j, enabled: P }),
      (t[12] = r),
      (t[13] = i),
      (t[14] = j),
      (t[15] = P),
...
function Ye(e) {
  let t = (0, et.c)(57),
    ...
    f;
  t[0] !== d || t[1] !== i
    ? ((f = k({ branchPrefix: d, conversationTitle: i })), (t[0] = d), (t[1] = i), (t[2] = f))
    : (f = t[2]);
  ...
  let I;
  t[31] !== P || t[32] !== F
    ? ((I = (0, Q.jsxs)(be, { className: `flex flex-col gap-2`, children: [O, P, F] })),
      (t[31] = P),
      (t[32] = F),
      (t[33] = I))
    : (I = t[33]);
  ...
  t[43] !== s || t[44] !== ne || t[45] !== V
    ? ((U = (0, Q.jsx)(B, { color: `primary`, disabled: ne, loading: s, onClick: V, children: H })),
      (t[43] = s),
      (t[44] = ne),
      (t[45] = V),
      (t[46] = U))
  ...
  let W;
  t[47] !== z || t[48] !== U
    ? ((W = (0, Q.jsx)(be, { children: (0, Q.jsxs)(Se, { children: [z, U] }) })),
      (t[47] = z),
      (t[48] = U),
      (t[49] = W))
    : (W = t[49]);
  let G;
  t[50] !== I || t[51] !== W
    ? ((G = (0, Q.jsxs)(we, { "data-codex-branch-create-dialog": ``, children: [D, I, W] })),
      (t[50] = I),
      (t[51] = W),
      (t[52] = G))
    : (G = t[52]);
  ...
  return (
    t[53] !== r || t[54] !== n || t[55] !== G
      ? ((K = (0, Q.jsx)(ye, { size: `feature`, open: n, onOpenChange: r, children: G })),
        (t[53] = r),
        (t[54] = n),
        (t[55] = G),
        (t[56] = K))
...
function Xe(e) {
  ...
  t[10] === n
    ? (y = t[11])
    : ((y = { enabled: n, staleTime: h.FIVE_SECONDS }), (t[10] = n), (t[11] = y));
  ...
  let L;
  t[47] !== N || t[48] !== F
    ? ((L = (0, Q.jsx)(be, { children: (0, Q.jsxs)(Se, { children: [N, F] }) })),
      (t[47] = N),
      (t[48] = F),
      (t[49] = L))
    : (L = t[49]);
  ...
  return (
    t[55] !== C || t[56] !== w || t[57] !== T || t[58] !== E || t[59] !== R
      ? ((z = (0, Q.jsx)(C, { size: w, open: T, onOpenChange: E, children: R })),
        (t[55] = C),
        (t[56] = w),
        (t[57] = T),
        (t[58] = E),
