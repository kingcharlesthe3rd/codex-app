...
import { c as a, d as o, i as s, n as c, t as l, u } from "./dist-12.js";
import { t as d } from "./dist-1.js";
...
function S(e) {
  let {
    ...
    [p, h] = l({ prop: n, defaultProp: i ?? !1, onChange: c, caller: _ }),
    [v, y] = m.useState(null),
    [x, S] = m.useState(null),
    C = m.useRef(!1),
  ...
  k = m.forwardRef(({ __scopeCheckbox: e, ...t }, n) => {
    ...
    m.useEffect(() => {
      ...
      if (S !== o && n) {
        ...
        ((e.indeterminate = j(o)), n.call(e, j(o) ? !1 : o), e.dispatchEvent(t));
      }
    }, [v, S, o, i]);
    let w = m.useRef(j(o) ? !1 : o);
    return (0, g.jsx)(s.input, {
      type: `checkbox`,
      "aria-hidden": !0,
...
function P(e) {
  let t = (0, N.c)(22),
    ...
    c;
  t[0] === e
    ? ((n = t[1]), (r = t[2]), (a = t[3]), (o = t[4]), (s = t[5]), (c = t[6]))
    : (({ className: r, checked: n, defaultChecked: a, onCheckedChange: o, disabled: c, ...s } = e),
      (t[0] = e),
      (t[1] = n),
      (t[2] = r),
      (t[3] = a),
