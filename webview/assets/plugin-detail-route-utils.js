import { oa as e, pt as t, st as n, ua as r, vt as i, xt as a } from "./src-2.js";
import { o } from "./use-plugins.js";
import { _ as s } from "./mention-item.js";
var c = r({
  openInstallModal: e(!0).optional(),
  openedFromPluginsPage: e(!0).optional(),
}).passthrough();
function l(e, n) {
  return t({ hostId: n?.hostId, pluginId: e.plugin.id, ...o(e), source: n?.source });
}
function u(e, n) {
  let r = s(e);
  return r == null ? null : t({ hostId: n?.hostId, pluginId: r });
}
function d({
...
function x(e, t) {
  return (
    ...
    a(e.plugin.shareContext.remotePluginId, t)
  );
}
