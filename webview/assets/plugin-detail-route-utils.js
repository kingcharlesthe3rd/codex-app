import { Zi as e, pt as t, qi as n, st as r, vt as i, xt as a } from "./src-1.js";
import { _ as o } from "./mention-item-B.js";
import { o as s } from "./use-plugins.js";
var c = e({
  openInstallModal: n(!0).optional(),
  openedFromPluginsPage: n(!0).optional(),
}).passthrough();
function l(e, n) {
  return t({ hostId: n?.hostId, pluginId: e.plugin.id, ...s(e), source: n?.source });
}
function u(e, n) {
  let r = o(e);
...
function f({ fallbackRequestedPluginId: e, plugins: t, requestedPluginId: n }) {
  if (i(n)) {
    let e = t.find((e) => b(e, n));
    if (e != null) return e;
  }
  let r = t.find((e) => y(e, n)) ?? null;
...
export { _ as a, f as c, m as i, p as l, h as n, l as o, d as r, u as s, g as t, v as u };
