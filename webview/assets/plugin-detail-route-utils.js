import { Li as e, Vi as t, ht as n, it as r, ut as i, vt as a } from "./src-4.js";
...
function c(e, t) {
  return i({ hostId: t?.hostId, pluginId: e.plugin.id, ...o(e), source: t?.source });
}
function l({
...
function u({ fallbackRequestedPluginId: e, plugins: t, requestedPluginId: r }) {
  if (n(r)) {
    let e = t.find((e) => v(e, r));
    if (e != null) return e;
  }
  let i = t.find((e) => _(e, r)) ?? null;
  return i != null || e == null || e === r ? i : u({ plugins: t, requestedPluginId: e });
}
function d(e) {
