import { f as e, i as t, l as n, n as r } from "./chunk-129.js";
import { t as i } from "./src-2.js";
import { n as a, r as o } from "./chunk-65.js";
import {
  A as s,
  I as c,
  L as l,
...
import { n as _, r as v } from "./chunk-100.js";
import { t as y } from "./chunk-75.js";
import { a as b, i as x, r as S, t as C } from "./chunk-4.js";
import { t as w } from "./rough.esm-2.js";
var T = a(async (r, o, s) => {
    let l,
    ...
    let d = r
      ...
      g;
    g = o.label === void 0 ? `` : typeof o.label == `string` ? o.label : o.label[0];
    ...
    if (u) {
      ...
      ((y = t.getBoundingClientRect()), n.attr(`width`, y.width), n.attr(`height`, y.height));
    }
    return (
      u
...
a(N, `applyStyle`);
async function P(e) {
  let t = i(document.createElementNS(`http://www.w3.org/2000/svg`, `foreignObject`)),
...
var F = a(async (e, n, r, i) => {
  ...
  L = a(async (e, t) => {
    ...
    let n = f(),
      ...
      { labelStyles: l, nodeStyles: u, borderStyles: d, backgroundStyles: p } = x(t),
      h = e
        .insert(`g`)
      ...
      S = await _(v, t.label, { style: t.labelStyle, useHtmlLabels: g, isNode: !0 }),
      C = S.getBBox();
    ...
    if (t.look === `handDrawn`) {
      let e = w.svg(h),
        n = b(t, { roughness: 0.7, fill: s, stroke: c, fillWeight: 3, seed: a }),
        r = e.path(I(D, O, T, E, 0), n);
      ((k = h.insert(() => (o.debug(`Rough node insert CXC`, r), r), `:first-child`)),
    ...
    if ((v.attr(`transform`, `translate(${t.x - C.width / 2}, ${t.y - t.height / 2 + A})`), l)) {
      let e = v.select(`span`);
      e && e.attr(`style`, l);
    }
  ...
  R = {
      ...
      if (t.look === `handDrawn`) {
        ...
        ((D = d.insert(`rect`, `:first-child`)),
          D.attr(`class`, `outer`)
            ...
            .attr(`height`, x)
            .attr(`data-look`, t.look),
          h.attr(`class`, `inner`).attr(`x`, C).attr(`y`, E).attr(`width`, b).attr(`height`, S));
      return (
        p.attr(
          `transform`,
    ...
    kanbanSection: a(async (e, t) => {
      ...
      if (t.look === `handDrawn`) {
        let e = w.svg(h),
          n = b(t, { roughness: 0.7, fill: s, stroke: c, fillWeight: 4, seed: a }),
...
function ge(e, t) {
  ...
  return (
    ...
    D(t, p),
    (t.intersect = function (e) {
      return (o.info(`crossedCircle intersect`, t, { radius: a, point: e }), U.circle(t, a, e));
    }),
    i
  );
}
...
async function Ee(e, t) {
  ...
  if (t.look === `handDrawn`) {
    ...
    (d.attr(`class`, `basic label-container`).attr(`style`, i),
      e.attr(`class`, `outer-circle`).attr(`style`, i).attr(`r`, l).attr(`cx`, 0).attr(`cy`, 0),
      t.attr(`class`, `inner-circle`).attr(`style`, i).attr(`r`, u).attr(`cx`, 0).attr(`cy`, 0));
  }
  return (
    D(t, d),
    (t.intersect = function (e) {
...
function De(e, t, { config: { themeVariables: n } }) {
  ...
  return (
    ...
    s && s.length > 0 && t.look !== `handDrawn` && f.selectAll(`path`).attr(`style`, s),
    i && t.look !== `handDrawn` && f.selectAll(`path`).attr(`style`, i),
    D(t, f),
    (t.intersect = function (e) {
      return (o.info(`filledCircle intersect`, t, { radius: 7, point: e }), U.circle(t, 7, e));
    }),
    a
  );
}
...
async function Oe(e, t) {
  ...
  let h = k(d),
    g = p.path(h, m),
    _ = i.insert(() => g, `:first-child`).attr(`transform`, `translate(${-l / 2}, ${l / 2})`);
  return (
...
async function Ae(e, t) {
  ...
  return (
    ...
    D(t, g),
    (t.intersect = function (e) {
      return (o.info(`Pill intersect`, t, { radius: l, point: e }), U.polygon(t, p, e));
    }),
    i
  );
}
...
async function Ne(e, t, { config: { themeVariables: n, flowchart: r } }) {
  ...
  if (t.icon) {
    let e = u.append(`g`);
    e.html(`<g>${await v(t.icon, { height: c, width: c, fallbackPrefix: `` })}</g>`);
  ...
  return (
    ...
    P.attr(`transform`, `translate(0,${p ? d.height / 2 + E / 2 : -d.height / 2 - E / 2})`),
    D(t, F),
    (t.intersect = function (e) {
...
async function Pe(e, t, { config: { themeVariables: n, flowchart: r } }) {
  ...
  let E = u.append(`g`);
  t.icon && E.html(`<g>${await v(t.icon, { height: c, width: c, fallbackPrefix: `` })}</g>`);
  let O = E.node().getBBox(),
    ...
    I = N + d.height + p,
    L = y.rectangle(-F / 2, -I / 2, F, I, { ...S, fill: `transparent`, stroke: `none` }),
  ...
  return (
    ...
    R.attr(`transform`, `translate(0,${m ? d.height / 2 + p / 2 : -d.height / 2 - p / 2})`),
    D(t, z),
    (t.intersect = function (e) {
...
async function Fe(e, t, { config: { themeVariables: n, flowchart: r } }) {
  ...
  let a = t.assetHeight ?? 48,
    ...
    l = r?.wrappingWidth;
  t.width = Math.max(c, l ?? 0);
  let { shapeSvg: u, bbox: d, halfPadding: f, label: p } = await T(e, t, `icon-shape default`),
    m = t.pos === `t`,
    h = c + f * 2,
    g = c + f * 2,
  ...
  let M = A.path(I(E, O, g, h, 5), j),
    ...
    P = h + d.height + k,
    F = A.rectangle(-N / 2, -P / 2, N, P, { ...j, fill: `transparent`, stroke: `none` }),
  ...
  return (
    ...
    L.attr(`transform`, `translate(0,${m ? d.height / 2 + k / 2 : -d.height / 2 - k / 2})`),
    D(t, R),
    (t.intersect = function (e) {
      if ((o.info(`iconSquare intersect`, t, e), !t.label)) return U.rect(t, e);
      let n = t.x ?? 0,
...
async function Le(e, t, { config: { flowchart: n } }) {
  ...
  let l = Math.max(t.label ? (c ?? 0) : 0, t?.assetWidth ?? i),
    u = t.constraint === `on` && t?.assetHeight ? t.assetHeight * t.imageAspectRatio : l,
  ...
  let C = y.rectangle(g, _, u, d, S),
    ...
    O = d + p.height + v,
    k = y.rectangle(-E / 2, -O / 2, E, O, { ...S, fill: `none`, stroke: `none` }),
  ...
  return (
    ...
    A.attr(`transform`, `translate(0,${h ? p.height / 2 + v / 2 : -p.height / 2 - v / 2})`),
    D(t, j),
    (t.intersect = function (e) {
      if ((o.info(`iconSquare intersect`, t, e), !t.label)) return U.rect(t, e);
      let n = t.x ?? 0,
...
async function J(e, t, r) {
  ...
  if ((r?.rx && r.ry && ((p = r.rx), (m = r.ry)), t.look === `handDrawn`)) {
    let e = w.svg(o),
      r = b(t, {}),
      i = p || m ? e.path(I(u, d, c, l, p || 0), r) : e.rectangle(u, d, c, l, r);
...
async function Xe(e, t, { config: { themeVariables: n } }) {
  let { labelStyles: r, nodeStyles: i } = x(t);
  ((t.labelStyle = r), t.useHtmlLabels || g().flowchart?.htmlLabels !== !1 || (t.centerLabel = !0));
  let { shapeSvg: a, bbox: o, label: s } = await T(e, t, O(t)),
...
async function Qe(e, t) {
  ...
  if (t.look === `handDrawn`) {
    ...
    ((l = i
      ...
      u && l.attr(`style`, u));
  } else ((l = W(i, o, o, c)), l.attr(`transform`, `translate(${-o / 2 + s}, ${o / 2})`));
  return (
    r && l.attr(`style`, r),
    D(t, l),
    (t.calcIntersect = function (e, t) {
...
async function et(e, t) {
  ...
  let g = u || [],
    _ = p.getBBox(),
    v = l.node().appendChild(await F(g.join ? g.join(`<br/>`) : g, t.labelStyle, !0, !0)),
    y = v.children[0],
    S = i(v);
  ((h = y.getBoundingClientRect()), S.attr(`width`, h.width), S.attr(`height`, h.height));
  let C = (t.padding || 0) / 2;
  (i(v).attr(
    `transform`,
    `translate( ` +
    ...
    i(p).attr(
      `transform`,
      `translate( ` + (h.width < _.width ? 0 : -(_.width - h.width) / 2) + `, 0)`,
    ),
    (h = l.node().getBBox()),
    l.attr(`transform`, `translate(` + -h.width / 2 + `, ` + (-h.height / 2 - C + 3) + `)`));
  ...
  if (t.look === `handDrawn`) {
    ...
    ((j = s.insert(() => (o.debug(`Rough node insert CXC`, r), i), `:first-child`)),
      (A = s.insert(() => (o.debug(`Rough node insert CXC`, r), r), `:first-child`)));
  } else
...
async function yt(e, t) {
  ...
  let v = k(p),
    y = g.path(v, _),
    S = i.insert(() => y, `:first-child`).attr(`transform`, `translate(${-u / 2}, ${u / 2})`);
  return (
...
async function Ct(e, t) {
  ...
  if (n.attributes.length === 0 && t.label) {
    let n = { rx: 0, ry: 0, labelPaddingX: o, labelPaddingY: o * 1.5, classes: `` };
    r(t.label, a) + n.labelPaddingX * 2 < a.er.minEntityWidth && (t.width = a.er.minEntityWidth);
    let i = await J(e, t, n);
    if (!m(a.htmlLabels)) {
      let e = i.select(`text`),
        t = e.node()?.getBBox();
      ...
      e &&
        ...
        r.attr(`class`).includes(`attribute-name`)
          ...
          : r.attr(`class`).includes(`attribute-keys`)
            ? (c += y + S)
            : r.attr(`class`).includes(`attribute-comment`) && (c += y + S + C));
    }
    r.attr(`transform`, `translate(${R + o / 2 + c}, ${l + z + p.height + s / 2})`);
  }),
    f.select(`.name`).attr(`transform`, `translate(` + -p.width / 2 + `, ` + (z + s / 2) + `)`));
...
async function X(e, t, n, a = 0, o = 0, c = [], l = ``) {
  ...
  let d = u
    .node()
    .appendChild(await _(u, t, { width: r(t, n) + 100, style: l, useHtmlLabels: n.htmlLabels }, n));
...
async function Z(e, n, o, s = []) {
  ...
  if (f) {
    ...
    ((y = e.innerHTML.split(`<br>`).length),
      e.innerHTML.includes(`</math>`) && (y += e.innerHTML.split(`<mrow>`).length - 1));
    ...
    (s.includes(`font-weight: bolder`) && i(h).selectAll(`tspan`).attr(`font-weight`, ``),
      (y = h.children.length));
    let e = h.children[0];
    ((h.textContent === `` || h.textContent.includes(`&gt`)) &&
      ((e.textContent =
        p[0] + p.substring(1).replaceAll(`&gt;`, `>`).replaceAll(`&lt;`, `<`).trim()),
      p[1] === ` ` && (e.textContent = e.textContent[0] + ` ` + e.textContent.substring(1))),
      e.textContent === `undefined` && (e.textContent = ``),
      (v = h.getBBox()));
  }
  return (c.attr(`transform`, `translate(0,` + (-v.height / (2 * y) + o) + `)`), v.height);
}
a(Z, `addText`);
async function Tt(e, t) {
  let n = f(),
  ...
  let h = s.members.length === 0 && s.methods.length === 0 && !n.class?.hideEmptyMembersBox,
    g = w.svg(c),
    _ = b(t, {});
  t.look !== `handDrawn` && ((_.roughness = 0), (_.fillStyle = `solid`));
  let v = l.width,
  ...
  let S = -v / 2,
    ...
    T = g.rectangle(
      S - r,
      C - r - (h ? r : s.members.length === 0 && s.methods.length === 0 ? -r / 2 : 0),
      v + 2 * r,
      y + 2 * r + (h ? r * 2 : s.members.length === 0 && s.methods.length === 0 ? -r : 0),
      _,
    ),
  ...
  c.selectAll(`.text`).each((e, t, n) => {
    ...
    let d = u + C + r - (h ? r : s.members.length === 0 && s.methods.length === 0 ? -r / 2 : 0);
    o || (d -= 4);
    let f = S;
  ...
  let k = c.select(`.annotation-group`).node().getBBox().height - (h ? r / 2 : 0) || 0,
    A = c.select(`.label-group`).node().getBBox().height - (h ? r / 2 : 0) || 0,
    j = c.select(`.members-group`).node().getBBox().height - (h ? r / 2 : 0) || 0;
  ...
  if (h || s.members.length > 0 || s.methods.length > 0) {
    let e = g.line(O.x, k + A + j + C + a * 2 + r, O.x + O.width, k + A + j + C + r + a * 2, _);
    c.insert(() => e)
      .attr(`class`, `divider`)
      .attr(`style`, p);
  }
...
async function Et(e, t) {
  ...
  if (((d += f + 20), s)) {
    ...
    ((d += r),
      await Q(l, `${a.verifyMethod ? `Verification: ${a.verifyMethod}` : ``}`, d, t.labelStyle));
  } else {
...
async function Q(e, n, a, o = ``) {
  ...
  let s = e.insert(`g`).attr(`class`, `label`).attr(`style`, o),
    ...
    d = await _(
      s,
      l(t(n)),
      { width: r(n, c) + 50, classes: `markdown-node-label`, useHtmlLabels: u, style: o },
      c,
    ),
    p;
  if (u) {
  ...
  return (s.attr(`transform`, `translate(${-p.width / 2},${-p.height / 2 + a})`), p.height);
}
a(Q, `addText`);
var Dt = a((e) => {
  switch (e) {
...
async function Ot(e, t, { config: n }) {
  ...
  d
    ...
    : ({ label: p, bbox: m } = await E(o, (`ticket` in t && t.ticket) || ``, f));
  let { label: h, bbox: g } = await E(o, (`assigned` in t && t.assigned) || ``, f);
  t.width = a;
  let _ = t?.width || 0,
  ...
  if (t.look === `handDrawn`) {
    let e = w.svg(o),
      n = b(t, {}),
      r = A || j ? e.path(I(S, C, _, y, A || 0), n) : e.rectangle(S, C, _, y, n);
...
export { It as a, zt as c, ee as i, Lt as l, Rt as n, Ft as o, F as r, T as s, te as t, D as u };
