...
import { Gn as te, Kn as ne } from "./app-initial~app-main~automations-page.js";
import { a as re, o as m } from "./workbook-1.js";
import {
  $ as ie,
  A as ae,
  C as h,
...
import { n as M, t as ye } from "./PopcornPageNumberNavigation.js";
import {
  $ as be,
  A as xe,
  B as Se,
...
function W(e, t, n) {
  (U({ slide: e, left: 72, top: 48, width: 620, height: 50, text: t, fontSize: 30, bold: !0 }),
    U({
      slide: e,
      left: 72,
      top: 100,
...
function G(e, t, n, r, i, a) {
  (U({ slide: e, left: t, top: n, width: r, height: 24, text: i, fontSize: 14, bold: !0 }),
    U({
      slide: e,
      left: t,
      top: n + 22,
...
function q(e, t) {
  ...
  let a = K({ slide: n, left: 72, top: 300, width: 346, height: 208, fill: Y.cloud });
  ((a.line.fill = Y.blue),
    (a.line.width = 1),
    G(
      n,
  ...
  let o = K({ slide: n, left: 444, top: 300, width: 346, height: 208, fill: Y.lavender });
  ...
  let s = K({ slide: n, left: 816, top: 300, width: 390, height: 208, fill: Y.mintTint });
  ((s.line.fill = Y.mint),
    G(
      n,
      842,
...
function Tt(e) {
  ...
  (t.shapes.add({
    ...
    G(t, 154, 378, 270, `Process shapes`, `Flowchart decision, rect, and terminator geometries.`),
    G(
      t,
      510,
      378,
    ...
    G(t, 900, 378, 230, `Transforms`, `Rotated and gradient-filled accent chevron.`));
}
function Et(e) {
  let t = H(e, `#FAFBFF`);
  W(
  ...
  let r = K({ slide: t, left: 474, top: 176, width: 326, height: 240, fill: `#FFFFFF` });
  ((r.text = [
...
`),
  ...
  let i = K({ slide: t, left: 840, top: 176, width: 354, height: 240, fill: `#F8FBFF` });
...
function Ot(e) {
  ...
  ((u.xValues = [1.5, 3.2, 6.8, 12.4, 24.9]),
    ...
    G(t, 846, 418, 356, `Scatter`, `XY data with connected markers and explicit axis titles.`));
}
function kt(e, t, n) {
  let r = H(e);
  W(
...
function At(e) {
  ...
  let n = K({ slide: t, left: 72, top: 154, width: 1136, height: 388, fill: `#FFFFFF` });
  n.line.fill = `#BFDBFE`;
  let r = t.images.add({
...
function Mt() {
  let e = re.create(),
    t = D(),
    n = pe();
  return (q(e, n), J(e), St(e), wt(e), Tt(e), Et(e), Dt(e), Ot(e), kt(e, t, n), At(e), jt(e), e);
}
var Nt,
  Pt,
  Y,
...
var qt,
  ...
  Yt = e(() => {
    (ce(),
      ...
      (Jt = class {
        id = qt++;
        #e = T(`presentation-main-controller`);
        #t = Vt();
        #n = new Set();
        #r = new Set();
        #i = [];
        ...
        #C(e) {
          switch (e.kind) {
            ...
            case `inspector`:
              ...
              return;
            case `debug-log`:
              T(e.namespace).debug(e.message, e.details);
              return;
            default:
              return e;
          }
...
function tn(e, t, n, r) {
  let i = $t(t, r),
    a = dt({ ...e, x: e.x - i.left, y: e.y - i.top }, { width: i.width, height: i.height }, n),
    ...
    (0, qn.jsx)(qn.Fragment, {
      children: (0, Kn.useMemo)(
        ...
        let p = d === e.threadId,
          ...
          ne = e.target.kind === `slide` ? e.slideLabel : (e.target.elementName ?? e.slideLabel);
        return (0, qn.jsx)(
          We,
          {
            open: p,
            ...
            trigger: (0, qn.jsx)(`button`, {
              ...
              children: (0, qn.jsx)(ve, { className: `size-4` }),
            }),
            content: (0, qn.jsx)(pt, {
...
function yr({
  ...
  let ge = (0, X.useRef)(null),
    ...
    M = (0, X.useRef)(null),
    [ye, xe] = (0, X.useState)(null),
    [Ce, N] = (0, X.useState)(null),
    we = (0, X.useRef)(null);
  we.current = Ce;
  let [Te, P] = (0, X.useState)([]),
    ke = (0, X.useRef)([]);
  ke.current = Te;
  let je = (0, X.useRef)(null),
    ...
    Je = I.viewportInsets,
    Xe = Tr(I.width, I.height, F, h.selectedSlideFrame, Je) ?? h.slideRect,
    L = Xe === h.slideRect ? h : { ...h, slideRect: Xe },
    R = h.slideIds[h.selectedSlideIdx] ?? `slide-${h.selectedSlideIdx}`,
    z = h.slideLabels[h.selectedSlideIdx] ?? `Slide ${h.selectedSlideIdx + 1}`,
    B = (0, X.useMemo)(() => Er(L), [L]),
    Ze = (0, X.useMemo)(() => $n({ snapshot: h }), [h]),
    Qe = (0, X.useMemo)(() => {
      let e = L.slideRect;
      return e ? { left: e.left, top: e.top, width: e.width, height: e.height } : null;
    }, [L.slideRect]),
    $e = (0, X.useMemo)(
      () => (O?.target ? ir(O.target, L.slideRect) : null),
      [O?.target, L.slideRect],
    ),
    et = (0, X.useMemo)(
      () => (O?.target ? ar(O.target, L.slideRect) : null),
      [O?.target, L.slideRect],
    ),
    tt = $e ?? et,
    rt = (0, X.useMemo)(() => (!E || !ye ? null : ur(ye.start, ye.current)), [E, ye]),
    V = (0, X.useMemo)(() => {
      if (!rt || !ye) return null;
      let e = er({ snapshot: h, frame: rt, anchorPoint: ye.current });
      return e ? ir(e, L.slideRect) : null;
    }, [ye, rt, h, L.slideRect]),
    at = (0, X.useMemo)(
      () =>
        rt
          ? dr(h.selectedSlideElementTargets, rt).flatMap((e) => {
          ...
          : [],
      [rt, h.selectedSlideElementTargets],
    ),
    st = (0, X.useMemo)(
      () => (O?.target.type === `presentation-region` ? O.target.containedElements : []),
      [O],
    ),
    ct = (0, X.useMemo)(
      () =>
        _e && h.hoveredElementId
          ? (h.selectedSlideElementTargets.find((e) => e.id === h.hoveredElementId) ?? null)
          : null,
      ...
      () =>
        ...
        (!E || !l
          ...
          : ct
            ...
            : null),
      [$e, E, ct, l, V, R, z, h.selectedSlideIdx, L.slideRect],
    ),
    {
      annotations: dt,
    ...
    } = Pe(p?.annotation?.handleRef, { onDismissAnnotation: We, onDismissAllAnnotations: Ue }),
    gt = (0, X.useMemo)(() => dt.filter((e) => e.target.slideId === R), [R, dt]),
    _t = (0, X.useMemo)(
    ...
    { drawings: bt, addPendingDrawing: H } = Oe(p?.drawing?.handleRef),
    xt = (0, X.useMemo)(() => bt.filter((e) => e.target.slideId === R), [R, bt]),
    U = (0, X.useMemo)(
      () =>
        new me(
          {
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      ...
      let n =
        g.current && se.current
          ? e.attachViewport({ host: g.current, canvas: se.current, overlayCanvas: _.current })
          : void 0;
      return (
    ...
    (0, X.useEffect)(() => {
      ...
      (h.selectedElementIds.length !== 1 ||
        ...
        (b.current = null);
    }, [h.primarySelectedElementId, h.selectedElementIds, h.textEditState, h.textLayoutBlocks]),
    (0, X.useEffect)(() => {
      h.selectedSlideFrame && t.hasInitializedCamera() && e.setViewportCamera(F);
    }, [F, e, t, h.selectedSlideFrame]),
    (0, X.useEffect)(() => {
      let e = g.current;
      !h.selectedSlideFrame ||
        !e ||
        U.updateState({ state: o ? h.textEditState : null, blocks: h.textLayoutBlocks });
    }, [o, F, h.selectedSlideFrame, h.textEditState, h.textLayoutBlocks, U]),
    (0, X.useEffect)(() => {
  ...
  let W = (0, X.useCallback)(() => {
    ...
    Ct = (0, X.useCallback)(
      (e) => {
        e == null ||
          ...
          !D ||
          !d ||
          ((je.current = R), (ke.current = [...ke.current, e]), P(ke.current));
      },
      [R, D, d],
    ),
    wt = (0, X.useCallback)(
      (e) => {
        ...
        let a = { width: r.clientWidth, height: r.clientHeight },
          ...
          l = tr({
            ...
            frame: c,
            viewportBounds: s,
            containedElements: dr(h.selectedSlideElementTargets, c).flatMap((e) => {
              let t = h.selectedSlideElementTargets.find((t) => t.id === e);
              return t
                ? [
                    {
        ...
        let u = Re(`drawing`),
          d = rr(l);
        H({ drawingId: u, artifactKind: `presentation`, label: d, target: l, strokes: e });
        let ee = { x: s.left + s.width / 2, y: s.top + s.height / 2 };
        Ee({
          cropRect: s,
          viewportSize: a,
          baseCanvas: i,
          overlayCanvases: [_.current, ce.current],
          strokes: e,
          projectPoint: St,
        })
          .then((t) => {
      ...
      [H, St, p?.drawing, h, L.slideRect],
    ),
    Tt = (e) => {
      ((j.current = !1),
        A(e.annotationId),
        k({ mode: `edit`, annotationId: e.annotationId, target: e.target, body: e.body }));
    },
    Et = (e = `saved`, t = `button`) => {
      if (!O?.target) return;
      let n = O.body.trim();
    ...
    Dt = () => {
      O?.mode === `edit` && (ht(O.annotationId), A((e) => (e === O.annotationId ? null : e)), q());
    };
  ((0, X.useEffect)(() => {
    (E || (O?.mode !== `edit` && k(null)), (!E || !l) && (xe(null), (M.current = null)));
  }, [E, O?.mode, l]),
    (0, X.useEffect)(() => {
      if (D && d) {
        (k(null), xe(null), (M.current = null), ve(!1), e.setHoveredElementId(null));
        return;
      }
      let t = f !== Fe.current;
      (G(), ke.current.length > 0 && !t && K());
    }, [G, K, e, f, D, d]),
    (0, X.useEffect)(() => {
      if (f === Fe.current) return;
      Fe.current = f;
      let e = ke.current;
      if (e.length === 0) {
        K();
    ...
    (0, X.useEffect)(() => {
      O && O.target.slideId !== R && (A(null), xe(null), (M.current = null), k(null));
    }, [O, R]),
    (0, X.useEffect)(
      () => () => {
        G();
    ...
    (0, X.useEffect)(() => {
      je.current == null || je.current === R || K();
    }, [K, R]),
    (0, X.useEffect)(() => {
      let e = g.current,
        t = ce.current,
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      ...
      if ((Ot(n), D && d)) {
        ...
        (Dr(t, v),
          ...
          Ge({ color: it, strokeWidth: 3, points: [n] }),
          t.preventDefault(),
          t.stopPropagation());
        return;
      }
      ...
      if (E && l) {
        ...
        if ((r != null && i === `replace` && k(null), !n)) {
          (r != null && i !== `replace` && J(), (M.current = null), xe(null));
          return;
        }
        let a = sr(h.selectedSlideElementTargets, n, F.k);
        e.setHoveredElementId(a);
        let o = a == null ? null : (h.selectedSlideElementTargets.find((e) => e.id === a) ?? null);
        ((M.current = {
      ...
      if (!o) {
        ...
        let i = sr(h.selectedSlideElementTargets, n, F.k);
      ...
      let r = U.isActive(),
        i =
          ...
          b.current === h.primarySelectedElementId
            ? h.primarySelectedElementId
            : void 0;
      if ((r || i) && U.tryPointerDown(n, { shiftKey: t.shiftKey, restrictToBlockId: i })) {
        (t.preventDefault(),
          (y.current = `text`),
          (x.current = null),
          (S.current = null),
      ...
      let a = h.primarySelectedElementId
          ? h.selectedSlideElementTargets.find((e) => e.id === h.primarySelectedElementId)
          : null,
        s = h.selectedElementIds.length === 1 ? (a?.frame ?? null) : null,
        c = h.selectedElementIds.length === 1 && a ? lr([a], n, F.k) : null,
        u = c ? null : fr(s, n, F.k),
        ee = !c && !u && !!a?.canRotate && pr(s, n, F.k),
        f = c
          ? c.endpoint === `from`
            ? `connector-from`
            : `connector-to`
        ...
        p =
          c?.elementId ??
          (f === `move` ? sr(h.selectedSlideElementTargets, n, F.k) : h.primarySelectedElementId);
      if (!p) {
        if (((x.current = null), (S.current = null), (C.current = !1), r)) return;
        (Dr(t, v),
          (y.current = `marquee`),
          (b.current = null),
    ...
    At = (t) => {
      ...
      if (E && l) {
        ...
        ve(!0);
        let i = sr(h.selectedSlideElementTargets, n, F.k);
        (e.setHoveredElementId(i), (t.currentTarget.style.cursor = he.current ? `` : be));
        return;
      }
      if (y.current === `text`) {
        n && U.pointerMove(n);
      ...
      if (y.current === `element` && n) {
        (S.current && Math.hypot(n.x - S.current.x, n.y - S.current.y) > jr && (C.current = !0),
      ...
      if (!o) {
        ...
        let r = n ? sr(h.selectedSlideElementTargets, n, F.k) : null;
      ...
      let r = h.primarySelectedElementId
        ...
        a = h.selectedElementIds.length === 1 && r ? lr([r], n, F.k) : null;
      if (a) {
      ...
      if (i && r?.canRotate && pr(i, n, F.k)) {
        (e.setHoveredElementId(h.primarySelectedElementId), (t.currentTarget.style.cursor = He()));
        return;
      }
      ...
      let c = sr(h.selectedSlideElementTargets, n, F.k);
      (e.setHoveredElementId(c), (t.currentTarget.style.cursor = c ? `move` : ``));
    },
    jt = (t, n) => {
      if (D && d) {
        if (v.current != null && v.current !== t.pointerId) return;
        Ot(Cr(t, g.current, F, h, Je));
        let e = we.current;
        (Or(t, v), (Me.current = null), Ge(null), n && Ct(e));
        return;
      }
      if (E && l) {
        if (v.current != null && v.current !== t.pointerId) return;
        (Ot(Cr(t, g.current, F, h, Je)), Or(t, v));
        let r = M.current;
        if (((M.current = null), xe(null), !n || !r)) return;
        let i = Cr(t, g.current, F, h, Je);
        if (!i) return;
        let a = ur(r.start, i),
        ...
        if (o) {
          if (r.clickedElementTarget) {
            ...
            (e.setHoveredElementId(null),
              ve(!1),
              p?.annotation?.onStart?.(`annotation_mode_pointer`, { annotationMode: l }),
              (j.current = !1),
      ...
      let r = y.current;
      if (!r) return;
      if ((Ot(Cr(t, g.current, F, h, Je)), Or(t, v), r === `text`)) {
      ...
      y.current = null;
      let i = x.current,
        a = !!n && !C.current && !!i && h.textLayoutBlocks.some((e) => e.id === i);
      ((x.current = null),
        (S.current = null),
        (C.current = !1),
    ...
    Mt = (t) => {
      ...
      if (!o) return;
      let n = wr(t.clientX, t.clientY, g.current, F, h, Je);
      n &&
    ...
    Nt = (e) =>
      !e.metaKey && !e.ctrlKey
        ...
        : e.key === `0`
          ...
          : e.key === `=` || e.key === `+`
            ? (t.zoomTo(nn(h.zoom + 0.1, h.fitScale ?? 1), { settled: !0 }), e.preventDefault(), !0)
            : e.key === `-`
    ...
    Pt = (t) => {
      if (
        ...
        if (
          ...
          r !== h.selectedSlideIdx && (e.setSelectedSlideIdx(r), t.preventDefault());
          return;
        }
        if (!o) {
          if (t.key === `Escape` && O) {
        ...
        if (t.key === `Enter` && h.selectedElementIds.length === 1 && h.primarySelectedElementId) {
            ...
            `div`,
            {
              children: [
                ...
                (0, Z.jsx)(nt, {
                  ...
                  position: n,
                  selected: O?.mode === `edit` && O.annotationId === e.annotationId,
                  title: e.label,
                  onMouseEnter: () => {
                    A(e.annotationId);
                  },
...
function Kr({
  ...
  headerTitleContent: ee,
  zoomToFitLabel: p,
  renderHeaderZoomControl: te,
  onClose: re,
  renderSlideThumbnailOverlay: m,
  className: ie,
  enablePageNavigation: ae,
  theme: h = `web`,
  isEditing: g = !0,
  hideSpeakerNotes: se = !1,
  reviewTools: _,
  onHyperlinkClick: ce,
  ...
  if (!C) return null;
  let w = An(C),
    { panels: le, stageOverlays: ue } = (0, Q.useMemo)(() => Zt(t), [t]),
    de = b && _?.annotation?.enabled !== !1,
    [T, E] = (0, Q.useState)(!1),
    D = x && _?.drawing?.enabled !== !1,
    [O, k] = (0, Q.useState)(!1),
    [pe, me] = (0, Q.useState)(0),
    A = (0, Q.useMemo)(() => new Ir(), []);
  ((0, Q.useEffect)(() => {
    de || E(!1);
  }, [de]),
    (0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      !T || !de || (C.clearElementSelection(), C.setHoveredElementId(null));
    }, [de, T, C]),
    (0, Q.useEffect)(() => {
  ...
  let [he, j] = (0, Q.useState)(() =>
      Object.fromEntries(le.map((e) => [e.id, e.defaultOpen ?? !1])),
    ),
    [_e, ve] = (0, Q.useState)(Zr),
    [M, be] = (0, Q.useState)(() => Object.fromEntries(w.slideIds.map((e) => [e, null]))),
    [Se, Ce] = (0, Q.useState)(() => Object.fromEntries(w.slideIds.map((e) => [e, null]))),
    [N, we] = (0, Q.useState)(() => w.slideIds),
    ...
    F = (0, Q.useRef)(Se),
    Ke = (0, Q.useRef)(N),
    qe = f(c(o, { activationConstraint: { distance: 4 } })),
    I = (0, Q.useMemo)(() => [ne], []),
    Ye = r === `left`,
    Xe = r === `bottom`,
    L = h === `codex`,
    ...
    $e = !se && Le && _e > 0,
    et = (0, Q.useMemo)(
      () => ({ left: Qe ? Qr : 0, top: 0, right: 0, bottom: $e ? Wr(_e, h) : 0 }),
      [_e, $e, Qe, h],
    );
  ((0, Q.useEffect)(() => {
  ...
  let nt = (0, Q.useMemo)(
      () => Object.fromEntries(w.slideIds.map((e, t) => [e, w.slideLabels[t] ?? `Slide ${t + 1}`])),
      [w.slideIds, w.slideLabels],
    ),
    rt = (0, Q.useMemo)(() => Object.fromEntries(w.slideIds.map((e, t) => [e, t])), [w.slideIds]),
    V = w.slideIds[w.selectedSlideIdx] ?? null,
    it = w.fitScale ?? (w.slideRect && w.zoom > 0 ? w.slideRect.scale / w.zoom : null),
    at = it ? rn(it) : null,
    ot = w.slideRect?.scale ?? rn(it ? it * w.zoom : w.zoom),
    st = at != null && Math.abs(w.zoom - 1) < ti,
    ct = z && (!Me || Pe),
    lt = !ct,
    ut = Ze && !ct,
    dt = (e) => {
    ...
    bt = (0, Q.useCallback)(
      async (e, t) => {
        ...
        if (
          ...
          try {
            await ht();
            let t = await C.requestSlideThumbnail(e, r ? { cssMaxPx: ri } : void 0);
  ...
  ((0, Q.useEffect)(() => {
    ...
    (e && (We.current.delete(`rail:${e}`), We.current.delete(`stacked-page:${e}`)),
      bt(w.selectedSlideIdx, { force: !0 }),
      e &&
        F.current[e] != null &&
        bt(w.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [bt, w.presentationVersion, w.selectedSlideIdx, w.slideIds]),
    (0, Q.useEffect)(() => {
              ...
              for (let t of e) {
                ...
                let r =
                    t.target.getAttribute(`data-thumbnail-cache-kind`) === `stacked-page`
                      ...
                      : `rail`,
                  i = r === `stacked-page`;
                (bt(n, { cacheKind: r, force: i }),
                  bt(n + 1, { cacheKind: r, force: i }),
    ...
    }, [bt, w.presentationVersion, w.slideCount]));
  let H = (0, Q.useCallback)(
    ...
    W = (0, Q.useCallback)(
      (e) => {
        ...
        let r = Ke.current,
          i = r.indexOf(t),
          a = r.indexOf(n);
        i < 0 || a < 0 || i === a || (we((e) => Gr(e, i, a)), C.moveSlide(i, a));
      },
      [C],
    ),
    G = (0, Q.useCallback)((e) => {
    ...
    J = (0, Q.useCallback)(
                      ...
                      N.map((n, i) => {
                        ...
                        return (0, $.jsx)(
                          mi,
                          {
                            slideId: n,
                            index: i,
                            snapshotIndex: rt[n] ?? -1,
                            label: nt[n] ?? `Slide ${i + 1}`,
                            thumbnail: a,
                            isSelected: n === V,
      ...
      [P, yt, gt, N, I, U, W, xt, vt, g, _t, m, V, mt, qe, rt, nt, M],
    );
  return (0, $.jsx)(`div`, {
    className: n(
      ...
      children: [
        (0, $.jsx)(oe, {
          ...
          centeredContent: ut
            ...
            : null,
          actions: (0, $.jsxs)(`div`, {
            className: n(`flex items-center`, L ? `gap-1` : `gap-2`),
            children: [
              _?.annotation && de
                ? (0, $.jsx)(Te, {
                    active: T,
                    onClick: () => {
                      let e = !T;
                      (e && (_?.annotation?.onModeEnabled?.(), k(!1)), E(e));
                    },
  ...
  gi = e(() => {
    (ee(),
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            ...
            (0, $.jsxs)(`div`, {
              ...
              className: n(`relative overflow-hidden border bg-white`, re, p ? `shadow-lg` : null),
              style: {
                ...oi,
                ...ie,
                borderColor: a ? si : ui,
      ...
      (mi = (0, Q.memo)(function ({
        ...
        slideButtonTestIdPrefix: ee = `popcorn-presentation-slide`,
        onRegisterButtonRef: f,
      }) {
        let {
            attributes: te,
            listeners: ne,
        ...
        return (0, $.jsx)(B, {
          ...
          trigger: (0, $.jsx)(`div`, {
            ref: re,
            style: {
              transform: p.Translate.toString(m),
...
function _i({
  ...
  artifactSearchEnabled: se = !1,
  commentThreadsEnabled: _ = !1,
  workerFactory: ce,
}) {
  let v = Ue({ initialCrdtState: s, externalCrdtUpdates: t }),
    y = (0, Si.useRef)(c),
    b = (0, Si.useRef)(null),
    x = ge(
      void 0,
  ...
  return (
    (0, Si.useEffect)(() => {
      x && y.current !== c && ((y.current = c), x.replaceFromProto(c ?? vi().toProto()));
    }, [x, c]),
    (0, Si.useEffect)(() => {
      if (!x || m == null) return;
      let e = () => {
...
var Si, Ci;
e(() => {
  (m(), a(), (Si = t(i())), gi(), Yt(), h(), z(), tt(), (Ci = r()));
})();
export { _i as PopcornElectronPresentationPanel };
//# sourceMappingURL=PopcornElectronPresentationPanel-DH8-0GS4.js.map
