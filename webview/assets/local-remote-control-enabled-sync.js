import { Ft as e, Xs as t, po as n } from "./app-server-manager-signals.js";
async function r(n, r, i, { shouldApplyStatus: a = () => !0 } = {}) {
  let o = await t(`set-remote-control-enabled-for-host`, { enabled: i, hostId: r });
  return (a() && e(n, r, o), o);
}
var i,
  a,
...
async function c(e, t, { force: l = !1 } = {}) {
  ...
  try {
    let n = await d;
    return u === o ? ((i = t), n) : (a != null && a !== t && (await c(e, a, { force: !0 })), n);
  } catch (e) {
