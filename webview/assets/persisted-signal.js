import { _ as e, g as t, t as n, u as r } from "./app-scope.js";
...
function _() {
  ...
  a.clear();
  let t = s;
  (t && e.forEach((e) => t(e, void 0)), e.forEach((e) => l(e)), y());
}
function v() {
...
function b(e, t) {
  return (
    O({ initialValue: t, key: e }),
    {
      cache: `signal`,
      resolve(t, n) {
        return E.resolve(t, n, e).value$.atom;
      },
      scope: n,
    }
  );
...
var S = new Map(),
  ...
  w = !1,
  T = t(n, []),
  E = r(n, (e, { signal: t }) => ({ key: e, value$: t(void 0) }));
function D(e) {
  return (
    C.add(e),
