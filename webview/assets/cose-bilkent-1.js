...
import { n as s, t as c } from "./cytoscape.esm-1.js";
import { t as l } from "./cytoscape-cose-bilkent-Ds-77Hh7.js";
function u(e, t) {
  e.forEach((e) => {
    let n = {
      id: e.id,
...
function f(e) {
  return new Promise((t) => {
    let r = a(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`),
      i = c({
...
async function h(e, t) {
  ...
  try {
    ...
    let t = await f(e),
      ...
      i = m(t);
    return (
      n.debug(`Layout completed: ${r.length} nodes, ${i.length} edges`), { nodes: r, edges: i }
    );
  } catch (e) {
