...
import { t as o } from "./cytoscape-cose-bilkent-Ds-77Hh7.js";
...
function f(e) {
  return new Promise((t) => {
    let r = n(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`),
      i = a({
    ...
    (r.remove(),
      ...
      i.layout({ name: `cose-bilkent`, quality: `proof`, styleEnabled: !1, animate: !1 }).run(),
      i.ready((e) => {
...
async function h(e, t) {
  ...
  try {
    ...
    let t = await f(e),
      ...
      r = m(t);
    return (
      s.debug(`Layout completed: ${n.length} nodes, ${r.length} edges`), { nodes: n, edges: r }
    );
  } catch (e) {
