...
import { t as i } from "./cytoscape.esm-2.js";
...
function l(e) {
  return new Promise((n) => {
    let a = t(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`),
      o = i({
...
async function f(e, t) {
  ...
  try {
    ...
    let t = await l(e),
      ...
      i = d(t);
    return (
      r.debug(`Layout completed: ${n.length} nodes, ${i.length} edges`), { nodes: n, edges: i }
    );
  } catch (e) {
