...
import { Z as i, s as a, t as o, u as s } from "./app-scope-CWE-zIhQ.js";
import {
  At as c,
  Dt as l,
  Mt as u,
...
import { f as g } from "./thread-context-inputs.js";
import { a as _, n as v, o as y, r as b, u as x } from "./vscode-api.js";
import { l as S, r as C, s as w } from "./lib-1.js";
import { t as T } from "./clsx.js";
import { t as E } from "./button.js";
import { t as D } from "./chevron-right.js";
import { t as O } from "./tooltip-B.js";
import { t as k } from "./context-menu.js";
import { t as A } from "./arrow-up.js";
import { I as j } from "./rpc-1.js";
import { t as M } from "./chevron.js";
import { O as N, R as ee, Y as P, o as F, p as I, s as L } from "./pdf-1.js";
import { t as R } from "./link-external.js";
import { t as z } from "./open-workspace-file.js";
import { t as B } from "./mime-types.js";
import { p as V } from "./codex-api.js";
import { d as te } from "./apps-queries.js";
import { t as H } from "./github-mark.js";
import { t as U } from "./focus-composer.js";
import { t as W } from "./error-boundary-DOI-M2iu.js";
import { t as ne } from "./codex.js";
import { n as G, r as K, t as q } from "./open-target-selection.js";
import { t as re } from "./copy-to-clipboard.js";
import { n as J } from "./use-skills.js";
import { n as ie } from "./use-resize-observer.js";
import { t as ae } from "./format-relative-date-time.js";
import { a as oe, c as Y, i as se, n as ce, r as le } from "./composer-controller.js";
import { n as ue } from "./markdown-1.js";
import { t as de } from "./github-details.js";
import { i as fe } from "./use-composer-controller.js";
import { t as pe } from "./at-mention-list.js";
import { t as me } from "./anchored-autocomplete-overlay.js";
import { n as he, t as ge } from "./prompt-editor-DCa--dg4.js";
import { n as _e, r as ve, t as ye } from "./rich-preview-primitives.js";
import { n as be, t as xe } from "./markdown-surface.js";
import { t as Se } from "./use-autocomplete-overlay-placement.js";
var X = i(),
  Z = r();
function Ce(e) {
  let t = (0, X.c)(14),
    ...
    o;
  t[0] === n ? (o = t[1]) : ((o = T(`relative overflow-auto`, n)), (t[0] = n), (t[1] = o));
  let s = r ? `grid-cols-1` : `grid-cols-2`,
    c;
  t[2] === s ? (c = t[3]) : ((c = T(`grid gap-px`, s)), (t[2] = s), (t[3] = c));
  let l;
  t[4] !== i || t[5] !== a || t[6] !== r
...
function Te(e) {
  ...
  t[7] !== u || t[8] !== f
    ...
    : (p = t[9]);
  let { data: m, isLoading: g, isError: _ } = y(`read-git-file-binary`, p),
    v = n ? `` : i,
    b = r?.hostId ?? `local`,
    x;
  t[10] !== v || t[11] !== b
    ? ((x = { path: v, hostId: b }), (t[10] = v), (t[11] = b), (t[12] = x))
    : (x = t[12]);
  let S = !n && a,
    C;
  ...
  t[15] !== x || t[16] !== C
    ...
    : (w = t[17]);
  let { data: T, isLoading: E, isError: D } = y(`read-file-binary`, w);
  if (!a) {
    let e;
    return (
  ...
  let O = n ? m?.contentsBase64 : T?.contentsBase64,
    ...
    A;
  t[19] === i ? (A = t[20]) : ((A = i ? (0, we.lookup)(i) : !1), (t[19] = i), (t[20] = A));
  let j = A,
  ...
  let N = `data:${M};base64,${O}`,
    ...
    F;
  return (
    t[24] !== N || t[25] !== ee || t[26] !== P
      ? ((F = { dataUrl: N, isLoading: ee, isError: P }),
        (t[24] = N),
        (t[25] = ee),
        (t[26] = P),
        (t[27] = F))
...
function Ee(e) {
  ...
  let d = u,
    ...
    p;
  t[2] !== s || t[3] !== d
    ? ((p = (0, Z.jsx)(De, { preview: s, alt: d })), (t[2] = s), (t[3] = d), (t[4] = p))
    : (p = t[4]);
  let m;
  t[5] !== c || t[6] !== d
    ? ((m = (0, Z.jsx)(De, { preview: c, alt: d })), (t[5] = c), (t[6] = d), (t[7] = m))
    : (m = t[7]);
  let h;
  return (
    t[8] !== r || t[9] !== f || t[10] !== p || t[11] !== m
      ? ((h = (0, Z.jsx)(Ce, { className: r, showAfterOnly: f, before: p, after: m })),
        (t[8] = r),
        (t[9] = f),
        (t[10] = p),
        (t[11] = m),
...
function Oe(e) {
  ...
  t[7] !== d || t[8] !== f
    ...
    : (p = t[9]);
  let { data: m, isLoading: h, isError: g } = y(`read-file`, p),
    _ = m?.contents ?? null;
  if (!c) return i;
  if (h) {
    let e = s ? `overflow-auto` : `overflow-clip`,
      n;
    t[10] !== r || t[11] !== e
      ? ((n = T(`relative`, e, r)), (t[10] = r), (t[11] = e), (t[12] = n))
      : (n = t[12]);
    let i;
    t[13] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, Z.jsx)(ye, { className: `justify-center py-6 text-sm` })), (t[13] = i))
      : (i = t[13]);
    let a;
    return (
      t[14] === n
  ...
  let v = s ? `normal` : `subtle`,
    b = s ? `auto` : `clip`,
    x;
  t[16] === _
    ? (x = t[17])
    : ((x = (0, Z.jsx)(be, { enableMetadataPreview: !0, markdown: _ })), (t[16] = _), (t[17] = x));
  let S;
  return (
    t[18] !== r || t[19] !== v || t[20] !== b || t[21] !== x
      ? ((S = (0, Z.jsx)(xe, { background: v, className: r, overflow: b, children: x })),
        (t[18] = r),
        (t[19] = v),
        (t[20] = b),
        (t[21] = x),
...
function Ae(e, t, n) {
  for (n of e.keys()) if (je(n, t)) return n;
}
function je(e, t) {
  var n, r, i;
  if (e === t) return !0;
  if (e && t && (n = e.constructor) === t.constructor) {
    ...
    if (n === Array) {
      if ((r = e.length) === t.length) for (; r-- && je(e[r], t[r]); );
      return r === -1;
    }
    if (n === Set) {
      if (e.size !== t.size) return !1;
      for (r of e)
        if (((i = r), (i && typeof i == `object` && ((i = Ae(t, i)), !i)) || !t.has(i))) return !1;
      return !0;
    }
    if (n === Map) {
      if (e.size !== t.size) return !1;
      for (r of e)
        if (
          ((i = r[0]), (i && typeof i == `object` && ((i = Ae(t, i)), !i)) || !je(r[1], t.get(i)))
        )
          return !1;
      return !0;
    }
    ...
    if (!n || typeof e == `object`) {
      for (n in ((r = 0), e))
        if ((ke.call(e, n) && ++r && !ke.call(t, n)) || !(n in t) || !je(e[n], t[n])) return !1;
...
var Ne = [`onCopy`, `onCut`, `onPaste`],
  Pe = [`onCompositionEnd`, `onCompositionStart`, `onCompositionUpdate`],
  Fe = [`onFocus`, `onBlur`],
  Ie = [`onInput`, `onInvalid`, `onReset`, `onSubmit`],
  Le = [`onLoad`, `onError`],
  Re = [`onKeyDown`, `onKeyPress`, `onKeyUp`],
  ze = [
    `onAbort`,
    `onCanPlay`,
    `onCanPlayThrough`,
  ...
  He = [`onSelect`],
  Ue = [`onTouchCancel`, `onTouchEnd`, `onTouchMove`, `onTouchStart`],
  We = [
    `onPointerDown`,
    `onPointerMove`,
    `onPointerUp`,
  ...
  Ge = [`onScroll`],
  Ke = [`onWheel`],
  qe = [`onAnimationStart`, `onAnimationEnd`, `onAnimationIteration`],
  Je = [`onTransitionEnd`],
  Ye = [`onToggle`],
  Xe = [`onChange`],
  Ze = [
...
var tt = t((e, t) => {
  ...
  $ = e(n(), 1),
  nt = (0, $.createContext)(null),
  rt = `noopener noreferrer nofollow`,
  it = class {
    constructor() {
    ...
    get page() {
      return (
        Q(this.pdfViewer, `PDF viewer is not initialized.`), this.pdfViewer.currentPageNumber || 0
      );
    }
    set page(e) {
      (Q(this.pdfViewer, `PDF viewer is not initialized.`), (this.pdfViewer.currentPageNumber = e));
    }
    get rotation() {
      return 0;
    }
      ...
      return new Promise((t) => {
        ...
        new Promise((e) => {
          ...
          (Q(this.pdfViewer, `PDF viewer is not initialized.`),
            Q(n >= 1 && n <= this.pagesCount, `"${n}" is not a valid page number.`),
...
function at({ children: e, type: t }) {
  return (0, Z.jsx)(`div`, {
    className: `react-pdf__message react-pdf__message--${t}`,
    children: e,
  });
}
var ot = { NEED_PASSWORD: 1, INCORRECT_PASSWORD: 2 };
function st(e, t) {
  switch (t.type) {
    case `RESOLVE`:
...
function ct() {
  return (0, $.useReducer)(st, { value: void 0, error: void 0 });
}
var lt = e(tt(), 1),
  ut = typeof window < `u`,
  dt = ut && window.location.protocol === `file:`;
function ft(e) {
  return e !== void 0;
}
function pt(e) {
...
function gt(e) {
  return (Q(ut, `isBlob can only be used in a browser environment`), e instanceof Blob);
}
function _t(e) {
  return mt(e) && /^data:/.test(e);
}
function vt(e) {
  Q(_t(e), `Invalid data URI.`);
  let [t = ``, n = ``] = e.split(`,`);
  return t.split(`;`).indexOf(`base64`) === -1 ? unescape(n) : atob(n);
}
function yt() {
  return (ut && window.devicePixelRatio) || 1;
}
var bt = `On Chromium based browsers, you can use --allow-file-access-from-files flag for debugging purposes.`;
function xt() {
  (0, lt.default)(
    !dt,
    `Loading PDF as base64 strings/URLs may not work on protocols other than HTTP/HTTPS. ${bt}`,
  );
}
function St(e) {
  e?.cancel && e.cancel();
...
var { PDFDataRangeTransport: Et } = P,
  Dt = (e, t) => {
    switch (t) {
      case ot.NEED_PASSWORD:
        e(prompt(`Enter the password to open this PDF file.`));
        break;
      case ot.INCORRECT_PASSWORD:
...
var kt = (0, $.forwardRef)(function (
  ...
  (0, $.useImperativeHandle)(S, () => ({ linkService: M, pages: N, viewer: I }), []);
  function L() {
    g && g();
  }
  function R() {
    D && ((0, lt.default)(!1, D.toString()), h && h(D));
  }
  function z() {
    w({ type: `RESET` });
  }
  ...
  let B = (0, $.useCallback)(async () => {
    if (!a) return null;
    if (typeof a == `string`) return _t(a) ? { data: vt(a) } : (xt(), { url: a });
    if (a instanceof Et) return { range: a };
    if (ht(a)) return { data: a };
    if (ut && gt(a)) return { data: await Tt(a) };
    if (
      (Q(
        typeof a == `object`,
        `Invalid parameter in file, need either Uint8Array, string or a parameter object`,
      ),
      Q(Ot(a), `Invalid parameter object: need either .data, .range or .url`),
  ...
  function te() {
    j && ((0, lt.default)(!1, j.toString()), d && d(j));
  }
  ((0, $.useEffect)(
    function () {
      k({ type: `RESET` });
  ...
  function G() {
    ...
    return (0, Z.jsx)(nt.Provider, { value: W, children: n });
  }
  function K() {
    return a
      ? A == null
        ? (0, Z.jsx)(at, { type: `loading`, children: typeof c == `function` ? c() : c })
        : A === !1
          ? (0, Z.jsx)(at, { type: `error`, children: typeof n == `function` ? n() : n })
          : G()
      : (0, Z.jsx)(at, { type: `no-data`, children: typeof l == `function` ? l() : l });
  }
  return (0, Z.jsx)(`div`, {
    className: T(`react-pdf__Document`, t),
    ref: o,
    ...ne,
    children: K(),
  });
...
var Mt = (0, $.createContext)(null);
function Nt() {
  return (0, $.useContext)(Mt);
}
function Pt() {
  let e = At(),
    t = Nt();
  ...
  (Q(
    ...
    Q(i, `Attempted to load page annotations, but no linkService was specified.`));
  let [m, h] = ct(),
    { value: g, error: _ } = m,
    v = (0, $.useRef)(null);
  (0, lt.default)(
  ...
  function b() {
    _ && ((0, lt.default)(!1, _.toString()), a && a(_));
  }
  ((0, $.useEffect)(
    function () {
      h({ type: `RESET` });
  ...
  function S(e) {
    ((0, lt.default)(!1, `${e}`), s && s(e));
  }
  let C = (0, $.useMemo)(() => l.getViewport({ scale: p, rotation: f }), [l, f, p]);
  return (
    (0, $.useEffect)(
      function () {
        if (!u || !l || !i || !g) return;
    ...
    (0, Z.jsx)(`div`, { className: T(`react-pdf__Page__annotations`, `annotationLayer`), ref: v })
  );
}
var Ft = {
    Document: null,
...
function zt(e) {
  return Rt(e) ? e.children.length === 1 && 0 in e.children && `id` in e.children[0] : !1;
}
function Bt(e) {
  let t = {};
  if (Rt(e)) {
...
function Vt(e) {
  ...
  if (Rt(e)) {
    if (
      (e.alt !== void 0 && (t[`aria-label`] = e.alt), e.lang !== void 0 && (t.lang = e.lang), zt(e))
    ) {
      let [n] = e.children;
      if (n) {
        let e = Vt(n);
...
function Ht(e) {
  return e ? { ...Bt(e), ...Vt(e) } : null;
}
function Ut({ className: e, node: t }) {
  let n = (0, $.useMemo)(() => Ht(t), [t]),
    r = (0, $.useMemo)(
      () => (!Rt(t) || zt(t) ? null : t.children.map((e, t) => (0, Z.jsx)(Ut, { node: e }, t))),
      [t],
    );
...
function Wt() {
  ...
  function u() {
    o && ((0, lt.default)(!1, o.toString()), t && t(o));
  }
  return (
    (0, $.useEffect)(
      function () {
    ...
    a ? (0, Z.jsx)(Ut, { className: `react-pdf__Page__structTree structTree`, node: a }) : null
  );
}
var Gt = L;
function Kt(e) {
  ...
  function h(e) {
    wt(e) || ((0, lt.default)(!1, e.toString()), a && a(e));
  }
  let g = (0, $.useMemo)(() => s.getViewport({ scale: d * i, rotation: u }), [i, s, u, d]),
    _ = (0, $.useMemo)(() => s.getViewport({ scale: d, rotation: u }), [s, u, d]);
  (0, $.useEffect)(
    function () {
      if (!s) return;
      s.cleanup();
      ...
      let t = {
        annotationMode: c ? Gt.ENABLE_FORMS : Gt.ENABLE,
        canvas: e,
...
function Jt() {
  ...
  function _() {
    m && ((0, lt.default)(!1, m.toString()), n && n(m));
  }
  ((0, $.useEffect)(
    function () {
      f({ type: `RESET` });
  ...
  let v = (0, $.useCallback)(() => {
    ...
    y = (0, $.useCallback)(
      (e) => {
        wt(e) || ((0, lt.default)(!1, e.toString()), i && i(e));
      },
      [i],
    );
  function b() {
  ...
  let S = (0, $.useMemo)(() => o.getViewport({ scale: u, rotation: l }), [o, l, u]);
  return (
    (0, $.useLayoutEffect)(
      function () {
        if (!o || !p) return;
    ...
    (0, Z.jsx)(`div`, {
      className: T(`react-pdf__Page__textContent`, `textLayer`),
      onMouseUp: x,
      onMouseDown: b,
      ref: h,
    })
...
function Xt(e) {
  ...
  function ie() {
    ...
    if (n && ee) {
      if (!pt(K) || !G.current) return;
      ee(K, G.current);
    }
  }
  function ae() {
    ne && ((0, lt.default)(!1, ne.toString()), S && S(ne));
  }
  ((0, $.useEffect)(
    function () {
      U({ type: `RESET` });
  ...
  let oe = (0, $.useMemo)(
      () =>
        pt(K) && q && pt(re) && pt(J)
          ...
          : null,
      [t, r, c, l, d, g, _, v, y, b, x, w, E, D, O, k, A, W, K, q, F, L, re, J],
    ),
    Y = (0, $.useMemo)(() => Qe(te, () => W && (J ? Ct(W, J) : void 0)), [te, W, J]),
    se = `${K}@${J}/${re}`;
  function ce() {
    switch (I) {
      case `custom`:
        return (
          Q(s, `renderMode was set to "custom", but no customRenderer was passed.`),
          (0, Z.jsx)(s, {}, `${se}_custom`)
        );
      case `none`:
        return null;
      default:
        return (0, Z.jsx)(Kt, { canvasRef: i }, `${se}_canvas`);
    }
  }
  function le() {
    return L ? (0, Z.jsx)(Jt, {}, `${se}_text`) : null;
  }
  function ue() {
    return P ? (0, Z.jsx)(Pt, {}, `${se}_annotations`) : null;
  }
  function de() {
    function e(e) {
      return !!e?.page;
    ...
    return (0, Z.jsxs)(Mt.Provider, { value: oe, children: [ce(), le(), ue(), t] });
  }
  function fe() {
    return q
      ? N === null || W == null
        ? (0, Z.jsx)(at, { type: `loading`, children: typeof m == `function` ? m() : m })
        : N === !1 || W === !1
          ? (0, Z.jsx)(at, { type: `error`, children: typeof u == `function` ? u() : u })
          : de()
      : (0, Z.jsx)(at, { type: `no-data`, children: typeof h == `function` ? h() : h });
  }
  return (0, Z.jsx)(`div`, {
    className: T(t, o),
    "data-page-number": q,
...
var Zt = `pointer-events-none absolute right-0.5 top-0.5 z-20 flex items-center gap-0.5 rounded-full bg-token-side-bar-background/90 px-0.5 py-0.5 shadow-sm ring-1 ring-token-border/60 opacity-0 transition-opacity group-hover/pdf-preview:pointer-events-auto group-hover/pdf-preview:opacity-100 group-focus-within/pdf-preview:pointer-events-auto group-focus-within/pdf-preview:opacity-100`;
function Qt(e) {
  let t = (0, X.c)(27),
    {
      canGoToNextPage: n,
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, Z.jsx)(D, { className: `icon-2xs rotate-180` })), (t[4] = m))
    : (m = t[4]);
  let h;
  t[5] !== o || t[6] !== u || t[7] !== p
    ? ((h = (0, Z.jsx)(E, {
  ...
  let g;
  t[9] !== u || t[10] !== h
    ? ((g = (0, Z.jsx)(O, { tooltipContent: u, children: h })),
      (t[9] = u),
      (t[10] = h),
      (t[11] = g))
    : (g = t[11]);
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, Z.jsx)(D, { className: `icon-2xs` })), (t[15] = y))
    : (y = t[15]);
  let b;
  ...
  let x;
  t[20] !== f || t[21] !== b
    ? ((x = (0, Z.jsx)(O, { tooltipContent: f, children: b })),
      (t[20] = f),
      (t[21] = b),
      (t[22] = x))
    : (x = t[22]);
  ...
  return (
    t[23] !== x || t[24] !== g || t[25] !== _
      ? ((C = (0, Z.jsxs)(`div`, { className: Zt, children: [g, _, x] })),
        (t[23] = x),
        (t[24] = g),
        (t[25] = _),
        (t[26] = C))
...
function nn(e) {
  ...
  let l = n.before == null && n.after != null,
    u;
  t[0] === n.before ? (u = t[1]) : ((u = on(n.before)), (t[0] = n.before), (t[1] = u));
  let d = u,
    f;
  t[2] === n.after ? (f = t[3]) : ((f = on(n.after)), (t[2] = n.after), (t[3] = f));
  let p = f,
    m = `pdf-before-${d}`,
    h;
  t[4] !== o || t[5] !== m
    ? ((h = (0, Z.jsx)(rn, { preview: o }, m)), (t[4] = o), (t[5] = m), (t[6] = h))
    : (h = t[6]);
  let g = `pdf-after-${p}`,
    _;
  t[7] !== s || t[8] !== g
    ? ((_ = (0, Z.jsx)(rn, { preview: s }, g)), (t[7] = s), (t[8] = g), (t[9] = _))
    : (_ = t[9]);
  let v;
  return (
    t[10] !== r || t[11] !== l || t[12] !== h || t[13] !== _
      ? ((v = (0, Z.jsx)(Ce, { className: r, showAfterOnly: l, before: h, after: _ })),
        (t[10] = r),
        (t[11] = l),
        (t[12] = h),
        (t[13] = _),
            ...
            ? (0, Z.jsx)(`div`, {
                ...
                children: (0, Z.jsx)(W, {
                  ...
                  children: (0, Z.jsx)(kt, {
                    ...
                    children: (0, Z.jsx)(Xt, {
                      className: T(`overflow-hidden rounded-sm shadow-sm`),
                      pageNumber: d,
...
function cn({ data: e, preferredTargetOverride: t }) {
  ...
  return {
    visibleTargets: G({ targets: i, availableTargets: r, includeHiddenTargets: !0, mode: e?.mode }),
    primaryTarget: K({
...
async function dn({ cwd: e, hostId: t, openPath: n, queryClient: r }) {
  return (e ?? n)
    ? r.fetchQuery({
        queryKey: b(`open-in-targets`, { cwd: e, hostId: t, path: n }),
        queryFn: () => v(`open-in-targets`, { params: { cwd: e, hostId: t, path: n } }),
        staleTime: x.ONE_MINUTE,
      })
    : null;
}
async function fn(e, t) {
  ...
  n &&
    (t.persistPreferred &&
      e
        .get(ln, { cwd: t.cwd, hostId: t.hostId, openPath: t.openPath })
...
function mn(e) {
  ...
  t[7] !== i
    ? ((u = async () => {
        let { primaryTarget: e, visibleTargets: t } = cn({
            data: r ? await r() : null,
            preferredTargetOverride: i,
          }),
          u = [
          ...
          e &&
            ...
            u.push({
              ...
              submenu: t.map((e) => ({
                ...
                messageValues: { target: e.label },
                icon: e.icon,
                onSelect: () => l(e.target, q(e), e.appPath),
              })),
            })),
...
function hn(e) {
  ...
  return (
    t[4] !== n || t[5] !== r || t[6] !== a
      ? ((o = (0, Z.jsx)(k, { getItems: a, disableNative: r, children: n })),
        (t[4] = n),
        (t[5] = r),
        (t[6] = a),
        (t[7] = o))
...
function gn(e) {
  ...
  let y = v,
    ...
    x;
  t[5] !== a || t[6] !== b ? ((x = T(b, a)), (t[5] = a), (t[6] = b), (t[7] = x)) : (x = t[7]);
  let S;
  t[8] !== o || t[9] !== g || t[10] !== h
    ? ((S = T(
        `flex flex-wrap items-center justify-between gap-3`,
        h ? T(`px-3 py-2.5`, (g || o != null) && `border-b border-token-border/24`) : `mb-3`,
      )),
      (t[8] = o),
      (t[9] = g),
      (t[10] = h),
  ...
  let C;
  t[12] !== u || t[13] !== y
    ? ((C = u == null ? y : (0, Z.jsx)(O, { delayDuration: 250, tooltipContent: u, children: y })),
      (t[12] = u),
      (t[13] = y),
      (t[14] = C))
    : (C = t[14]);
  ...
  t[15] !== l || t[16] !== S || t[17] !== C
    ? ((w = (0, Z.jsxs)(`div`, { className: S, children: [C, l] })),
      (t[15] = l),
      (t[16] = S),
      (t[17] = C),
      (t[18] = w))
  ...
  let k;
  return (
    t[23] !== d || t[24] !== w || t[25] !== E || t[26] !== D || t[27] !== x
      ? ((k = (0, Z.jsxs)(`div`, { className: x, onPointerDownCapture: d, children: [w, E, D] })),
        (t[23] = d),
        (t[24] = w),
        (t[25] = E),
        (t[26] = D),
...
function yn(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(`span`, {
        ...
        children: (0, Z.jsx)(H, { className: `size-2` }),
      })),
      (t[0] = r))
    : (r = t[0]);
  let i;
...
function bn(e) {
  ...
  if (
    ...
    t[9] !== i.authorAvatarUrl || t[10] !== i.authorLogin
      ? ((e = i.authorAvatarUrl ?? vn(i.authorLogin, 32)),
    ...
    (t[12] === p ? (d = t[13]) : ((d = T(`bg-token-bg-primary/20`, p)), (t[12] = p), (t[13] = d)),
...
function xn(e) {
  ...
  if (t[0] !== r || t[1] !== n || t[2] !== i || t[3] !== s || t[4] !== P || t[5] !== j) {
    let { authorLogin: e, text: a } = s == null ? { authorLogin: null, text: i ?? `` } : l(s);
    ((L = n ?? s?.authorLogin ?? e),
      (z = s == null ? (i ?? ``) : a),
      (I =
        L ??
    ...
    let o = r ?? s?.authorAvatarUrl ?? (L == null ? null : vn(L, 48)),
      c = o != null && o !== P,
      u = j.formatMessage(
        {
          id: `pullRequestsPage.detail.commentAuthorAvatarAlt`,
  ...
  if (x) {
                ...
                children: [
                  ...
                  u == null
                    ...
                    : (0, Z.jsx)(`span`, {
                        ...
                        children: (0, Z.jsx)(ae, { dateString: u }),
                      }),
                ],
              })
            : null),
    ...
    let l;
    t[30] === c ? (l = t[31]) : ((l = T(`flex min-w-0 gap-2 py-1`, c)), (t[30] = c), (t[31] = l));
    let d;
    t[32] === V
      ? (d = t[33])
    ...
    t[34] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (f = t[34]);
    let p;
    t[35] === z ? (p = t[36]) : ((p = de(z)), (t[35] = z), (t[36] = p));
    let m;
    t[37] === p
      ? (m = t[38])
      : ((m = (0, Z.jsx)(ue, {
    ...
    let _;
    return (
      t[42] !== l || t[43] !== d || t[44] !== h
        ? ((_ = (0, Z.jsxs)(`div`, { className: l, children: [d, h] })),
          (t[42] = l),
          (t[43] = d),
          (t[44] = h),
          (t[45] = _))
  ...
  let te = s == null ? [] : d(s).slice(1),
    H = D.map(wn),
    U = [...te, ...H],
    W;
  t[46] !== s || t[47] !== k
    ? ((W = k && s != null ? Tn(s) : null), (t[46] = s), (t[47] = k), (t[48] = W))
    : (W = t[48]);
  let ne = W,
    G = L != null || u != null,
    K = A === `card`,
    q;
  t[49] === V ? (q = t[50]) : ((q = (0, Z.jsx)(yn, { children: V })), (t[49] = V), (t[50] = q));
  let re = q,
    J = N
      ? null
      : (0, Z.jsxs)(`div`, {
  ...
  let oe = ie,
    Y;
  t[54] !== K || t[55] !== oe || t[56] !== u || t[57] !== N || t[58] !== ne || t[59] !== ee
    ? ((Y =
        ne != null || u != null || K
          ? (0, Z.jsxs)(`div`, {
                ...
                K
                  ? (0, Z.jsx)(O, {
                      ...
                      children: (0, Z.jsx)(E, {
                        ...
                        uniform: !0,
                        onClick: (e) => {
                          (e.preventDefault(), e.stopPropagation(), ee(Sn));
                        },
                        children: (0, Z.jsx)(M, {
                          className: N
        ...
        y == null
          ...
          : (0, Z.jsx)(O, {
              ...
              children: (0, Z.jsx)(`a`, {
                ...
                rel: `noreferrer`,
                target: `_blank`,
                children: (0, Z.jsx)(R, { className: `icon-xs` }),
              }),
            })),
      (t[61] = j),
      (t[62] = y),
  ...
  return (
    t[64] !== I || t[65] !== le
      ? ((fe = (0, Z.jsxs)(Z.Fragment, { children: [I, le] })),
        (t[64] = I),
        (t[65] = le),
        (t[66] = fe))
      : (fe = t[66]),
    G
      ? (0, Z.jsx)(gn, {
          ...
          footer: N ? null : p,
          footerFlush: w,
          footerHasTopPadding: U.length > 0,
          headerAccessory: se,
...
function On(e) {
  let t = (0, X.c)(107),
    ...
    b = v === void 0 ? !1 : v,
    x;
  t[0] === h ? (x = t[1]) : ((x = h ? c(h) : ``), (t[0] = h), (t[1] = x));
  let C = x,
    ...
    R,
    z;
  t[2] !== d || t[3] !== u || t[4] !== F?.profile_picture_url || t[5] !== I
    ? ((R =
        u ??
        I.formatMessage({
      ...
      (L = d ?? F?.profile_picture_url ?? null),
      (z = I.formatMessage(
        {
  ...
  let H = te,
    W;
  t[12] === Symbol.for(`react.memo_cache_sentinel`) ? ((W = ge()), (t[12] = W)) : (W = t[12]);
  let G = W,
    K;
  (t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = () => {
  ...
  (t[19] === h
    ...
    : ((ae = () => {
        let e = h != null;
        (!P.current && e && (M(!1), G.view.dom.blur()), (P.current = e));
      }),
      (oe = [G, h]),
      (t[19] = h),
      (t[20] = ae),
    ...
    (0, $.useEffect)(ae, oe));
  let Y;
  if (t[22] !== O || t[23] !== h || t[24] !== C || t[25] !== b) {
    if (((Y = !1), !b))
      if (h) Y = O !== C;
      else {
        let e;
    ...
    ((t[22] = O), (t[23] = h), (t[24] = C), (t[25] = b), (t[26] = Y));
  } else Y = t[26];
  let se;
  t[29] !== Y || t[30] !== g
    ? ((se = () => {
        g && ee.current !== Y && ((ee.current = Y), g(Y));
      }),
      (t[29] = Y),
      (t[30] = g),
      (t[31] = se))
  ...
  if (!b && h?.replyToReviewThreadId != null) {
    ...
    t[64] === y
      ? (s = t[65])
      : ((s = y ? null : (0, Z.jsx)(A, { className: `icon-xs` })), (t[64] = y), (t[65] = s));
    let c;
    t[66] !== ue || t[67] !== y || t[68] !== i || t[69] !== o || t[70] !== s
      ? ((c = (0, Z.jsx)(E, {
          "aria-label": i,
          color: `primary`,
          disabled: o,
  ...
  let ve;
  return (
    t[100] !== H || t[101] !== R || t[102] !== re || t[103] !== pe || t[104] !== me || t[105] !== _e
      ? ((ve = (0, Z.jsx)(`div`, {
          ref: N,
...
function kn(e) {
  ...
  t[0] === n.view
    ? (i = t[1])
    : ((i = () => {
        n.view.isDestroyed || n.view.setProps({ editable: jn });
      }),
      (t[0] = n.view),
      (t[1] = i));
  let a;
  (t[2] === n ? (a = t[3]) : ((a = [n]), (t[2] = n), (t[3] = a)), (0, $.useEffect)(i, a));
  let o;
  return (
    t[4] !== n || t[5] !== r
      ? ((o = (0, Z.jsx)(se, {
...
function Mn(e) {
  ...
  t[31] !== L
    ...
    : (R = t[32]);
  let z;
  t[33] !== S || t[34] !== n || t[35] !== v.ui || t[36] !== F || t[37] !== R
    ? ((z = (0, Z.jsx)(me, {
        anchorRef: g,
        composerController: n,
        isActive: F,
  ...
  let V = i ?? !!a,
    H;
  t[43] !== v.handleMentionEvent || t[44] !== y.handleMentionEvent
    ? ((H = (e) => {
        oe(e, { onAtMention: v.handleMentionEvent, onSkillMention: y.handleMentionEvent });
      }),
      (t[43] = v.handleMentionEvent),
      (t[44] = y.handleMentionEvent),
      (t[45] = H))
    : (H = t[45]);
  let U;
  t[46] !== n || t[47] !== d || t[48] !== m || t[49] !== V || t[50] !== H
    ? ((U = (0, Z.jsx)(se, {
        className: Dn,
        composerController: n,
        disableAutoFocus: V,
  ...
  let W;
  return (
    t[52] !== f || t[53] !== P || t[54] !== z || t[55] !== B || t[56] !== U
      ? ((W = (0, Z.jsxs)(`div`, {
          ref: g,
          className: `relative`,
          onFocus: f,
...
function Pn(e) {
  ...
  let C = x,
    T;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((T = new Set()), (t[2] = T)) : (T = t[2]);
  let D = (0, $.useRef)(T),
    { updateDrafts: O } = En(_ ?? null),
    k,
    A;
  (t[3] !== _ || t[4] !== O
    ? ((k = () => {
  ...
  if (t[8] !== o || t[9] !== n || t[10] !== i || t[11] !== s || t[12] !== c || t[13] !== r) {
    bb0: {
      ...
      let e = new Set((o ?? []).map(Bn)),
        a = new Set((c ?? []).map(zn)),
        l = (o ?? []).flatMap((e) => (a.has(f(e)) ? [] : [{ comment: e, source: `user` }])),
        d = (c ?? []).map((t) => ({ attached: e.has(f(t)), comment: t, source: `readonly` })),
        p = (s ?? []).map(Rn),
        m = [...l, ...d, ...p];
      if (m.length === 0) {
        let e;
      ...
      P = m
        .filter((e) => {
          let { comment: t } = e;
          return u(t.position.path, n, r);
        })
        .map(Ln);
    }
    ((t[8] = o), (t[9] = n), (t[10] = i), (t[11] = s), (t[12] = c), (t[13] = r), (t[14] = P));
  } else P = t[14];
  let F = P,
    I;
  bb1: {
    ...
    let e;
    (t[18] === N ? (e = t[19]) : ((e = Object.entries(N).map(In)), (t[18] = N), (t[19] = e)),
      (I = e));
  }
  let L = I,
    R;
        ...
        switch (n.kind) {
          case `comment`: {
                    ...
                    ? (0, Z.jsx)(E, {
                        ...
                        onClick: (r) => {
                          (r.preventDefault(),
                            r.stopPropagation(),
                            d?.(
                              e ? (o ?? []).filter((e) => f(e) !== t) : [...(o ?? []), n.comment],
                            ));
                        },
                        children: e
                          ? (0, Z.jsx)(w, {
            ...
            return (0, Z.jsx)(On, {
              ...
              onDelete: () => {
                (t(i, !1), g?.(), d?.(o?.filter((e) => e !== n.comment) ?? []));
              },
            });
          }
          case `draft-comment`:
...
function Vn({ instanceId: e, path: t, side: n, lineNumber: r }) {
  return `${e}::${j(t)}::${pn(n, r)}`;
}
export {
  hn as a,
