...
import { O as d, R as f, Y as p, o as m, p as h, s as g } from "./pdf-2.js";
import {
  B as _,
  G as v,
  S as y,
...
import { p as A } from "./codex-api-B.js";
import { u as j } from "./apps-queries.js";
...
import { n as L } from "./use-resize-observer.js";
import { t as R } from "./chevron-right.js";
import { t as z } from "./context-menu.js";
import { t as B } from "./copy-to-clipboard.js";
...
import { a as q, c as re, i as J, n as ie, o as ae, t as oe } from "./prompt-editor.js";
import { t as se } from "./at-mention-list-1.js";
import { i as ce } from "./use-composer-controller.js";
import { n as le, r as Y, t as ue } from "./rich-preview-primitives.js";
import { n as de, t as fe } from "./markdown-surface.js";
import { t as pe } from "./anchored-autocomplete-overlay.js";
import { t as me } from "./use-autocomplete-overlay-placement.js";
var X = O(),
  Z = l();
function he(e) {
  let t = (0, X.c)(14),
  ...
  let d;
  t[8] !== c || t[9] !== l
    ? ((d = (0, Z.jsx)(`div`, { className: c, children: l })), (t[8] = c), (t[9] = l), (t[10] = d))
    : (d = t[10]);
  let f;
  return (
    t[11] !== o || t[12] !== d
...
function _e(e) {
  ...
  let C;
  t[15] !== b || t[16] !== S
    ? ((C = { params: b, queryConfig: S }), (t[15] = b), (t[16] = S), (t[17] = C))
    : (C = t[17]);
  ...
  let O = n ? h?.contentsBase64 : w?.contentsBase64,
    k;
  t[19] === i ? (k = t[20]) : ((k = i ? (0, ge.lookup)(i) : !1), (t[19] = i), (t[20] = k));
  let A = k,
...
function ve(e) {
  ...
  let d = u,
    ...
    p;
  t[2] !== s || t[3] !== d
    ? ((p = (0, Z.jsx)(ye, { preview: s, alt: d })), (t[2] = s), (t[3] = d), (t[4] = p))
    : (p = t[4]);
  let m;
  t[5] !== c || t[6] !== d
    ? ((m = (0, Z.jsx)(ye, { preview: c, alt: d })), (t[5] = c), (t[6] = d), (t[7] = m))
    : (m = t[7]);
  let h;
  return (
    t[8] !== r || t[9] !== f || t[10] !== p || t[11] !== m
      ? ((h = (0, Z.jsx)(he, { className: r, showAfterOnly: f, before: p, after: m })),
        (t[8] = r),
        (t[9] = f),
        (t[10] = p),
        (t[11] = m),
...
function be(e) {
  ...
  if (g) {
    ...
    t[13] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, Z.jsx)(ue, { className: `justify-center py-6 text-sm` })), (t[13] = i))
      : (i = t[13]);
    let a;
    return (
      t[14] === n
  ...
  t[16] === v
    ? (x = t[17])
    : ((x = (0, Z.jsx)(de, { enableMetadataPreview: !0, markdown: v })), (t[16] = v), (t[17] = x));
  let S;
  return (
    t[18] !== r || t[19] !== y || t[20] !== b || t[21] !== x
      ? ((S = (0, Z.jsx)(fe, { background: y, className: r, overflow: b, children: x })),
        (t[18] = r),
        (t[19] = y),
        (t[20] = b),
        (t[21] = x),
...
function Ce(e, t) {
  ...
  if (e && t && (n = e.constructor) === t.constructor) {
    ...
    if (n === Set) {
      ...
      for (r of e)
        if (((i = r), (i && typeof i == `object` && ((i = Se(t, i)), !i)) || !t.has(i))) return !1;
      return !0;
    }
    if (n === Map) {
      if (e.size !== t.size) return !1;
      for (r of e)
        if (
          ((i = r[0]), (i && typeof i == `object` && ((i = Se(t, i)), !i)) || !Ce(r[1], t.get(i)))
        )
          return !1;
      return !0;
    }
    ...
    if (!n || typeof e == `object`) {
      for (n in ((r = 0), e))
        if ((xe.call(e, n) && ++r && !xe.call(t, n)) || !(n in t) || !Ce(e[n], t[n])) return !1;
...
function ct(e) {
  return (Q(nt, `isBlob can only be used in a browser environment`), e instanceof Blob);
}
function lt(e) {
...
var xt = (0, $.forwardRef)(function (
  ...
  (0, $.useImperativeHandle)(w, () => ({ linkService: N, pages: P, viewer: ee }), []);
  function L() {
    v && v();
  }
  function R() {
  ...
  function K() {
    return a
      ? j == null
        ? (0, Z.jsx)(Ze, { type: `loading`, children: typeof c == `function` ? c() : c })
        : j === !1
          ? (0, Z.jsx)(Ze, { type: `error`, children: typeof n == `function` ? n() : n })
          : G()
      : (0, Z.jsx)(Ze, { type: `no-data`, children: typeof l == `function` ? l() : l });
  }
  return (0, Z.jsx)(`div`, {
...
function Et() {
  ...
  let T = (0, $.useMemo)(() => l.getViewport({ scale: h, rotation: p }), [l, p, h]);
  return (
    (0, $.useEffect)(
      function () {
        if (!d || !l || !i || !v) return;
    ...
    (0, Z.jsx)(`div`, { className: u(`react-pdf__Page__annotations`, `annotationLayer`), ref: b })
  );
}
var Dt = {
    Document: null,
...
function Ft({ className: e, node: t }) {
  let n = (0, $.useMemo)(() => Pt(t), [t]),
    r = (0, $.useMemo)(
      () => (!At(t) || jt(t) ? null : t.children.map((e, t) => (0, Z.jsx)(Ft, { node: e }, t))),
      [t],
    );
...
function It() {
  ...
  return (
    ...
    a ? (0, Z.jsx)(Ft, { className: `react-pdf__Page__structTree structTree`, node: a }) : null
  );
}
var Lt = g;
function Rt(e) {
...
function Bt() {
  ...
  let w = (0, $.useMemo)(() => o.getViewport({ scale: f, rotation: l }), [o, l, f]);
  return (
    (0, $.useLayoutEffect)(
      function () {
        if (!o || !h) return;
...
function Ht(e) {
  ...
  let oe = (0, $.useMemo)(
    ...
    se = (0, $.useMemo)(() => We(te, () => W && (J ? ht(W, J) : void 0)), [te, W, J]),
    ce = `${K}@${J}/${re}`;
  function le() {
    switch (ee) {
      case `custom`:
  ...
  function de() {
    ...
    return (0, Z.jsxs)(wt.Provider, { value: oe, children: [le(), Y(), ue(), t] });
  }
  function fe() {
    return q
      ? N === null || W == null
        ? (0, Z.jsx)(Ze, { type: `loading`, children: typeof h == `function` ? h() : h })
        : N === !1 || W === !1
          ? (0, Z.jsx)(Ze, { type: `error`, children: typeof d == `function` ? d() : d })
          : de()
      : (0, Z.jsx)(Ze, { type: `no-data`, children: typeof g == `function` ? g() : g });
  }
  return (0, Z.jsx)(`div`, {
    className: u(t, o),
    "data-page-number": q,
...
function Jt(e) {
  ...
  let p = f,
    ...
    h;
  t[4] !== o || t[5] !== m
    ? ((h = (0, Z.jsx)(Yt, { preview: o }, m)), (t[4] = o), (t[5] = m), (t[6] = h))
    : (h = t[6]);
  let g = `pdf-after-${p}`,
    _;
  t[7] !== s || t[8] !== g
    ? ((_ = (0, Z.jsx)(Yt, { preview: s }, g)), (t[7] = s), (t[8] = g), (t[9] = _))
    : (_ = t[9]);
  let v;
  return (
    t[10] !== r || t[11] !== l || t[12] !== h || t[13] !== _
      ? ((v = (0, Z.jsx)(he, { className: r, showAfterOnly: l, before: h, after: _ })),
        (t[10] = r),
        (t[11] = l),
        (t[12] = h),
        (t[13] = _),
...
function Yt(e) {
  ...
  return (
    t[17] !== g || t[18] !== _
      ? ((v = (0, Z.jsxs)(`div`, { className: `group/pdf-preview relative`, children: [g, _] })),
        (t[17] = g),
        (t[18] = _),
        (t[19] = v))
      : (v = t[19]),
...
async function nn({ cwd: e, hostId: t, openPath: n, queryClient: r }) {
  return (e ?? n)
    ? r.fetchQuery({
        ...
        queryFn: () => T(`open-in-targets`, { params: { cwd: e, hostId: t, path: n } }),
        staleTime: S.ONE_MINUTE,
      })
    : null;
}
...
function un(e) {
  ...
  let U = H,
    W;
  t[12] === Symbol.for(`react.memo_cache_sentinel`) ? ((W = oe()), (t[12] = W)) : (W = t[12]);
  let G = W,
    q;
  (t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = () => {
  ...
  if (!S && h?.replyToReviewThreadId != null) {
    ...
    t[64] === x
      ? (s = t[65])
      : ((s = x ? null : (0, Z.jsx)(K, { className: `icon-xs` })), (t[64] = x), (t[65] = s));
    let c;
  ...
  let ye;
  return (
    t[100] !== U || t[101] !== z || t[102] !== J || t[103] !== ge || t[104] !== _e || t[105] !== ve
      ? ((ye = (0, Z.jsx)(`div`, {
          ref: M,
...
function mn(e) {
  ...
  let T = me(w),
    E;
  t[4] === Symbol.for(`react.memo_cache_sentinel`) ? ((E = { hostId: o }), (t[4] = E)) : (E = t[4]);
  let D = j(E),
    { skills: O } = W(_),
    k,
    A;
...
function gn(e) {
  ...
  let [M, P] = (0, $.useState)(j),
    F;
  if (t[8] !== l || t[9] !== a || t[10] !== s || t[11] !== u || t[12] !== d || t[13] !== o) {
    bb0: {
      if (!s) {
        let e;
      ...
      let e = new Set((l ?? []).map(Sn)),
        n = new Set((d ?? []).map(xn)),
        c = (l ?? []).flatMap((e) => (n.has(r(e)) ? [] : [{ comment: e, source: `user` }])),
        f = (d ?? []).map((t) => ({ attached: e.has(r(t)), comment: t, source: `readonly` })),
        p = (u ?? []).map(bn),
        m = [...c, ...f, ...p];
      if (m.length === 0) {
        let e;
    ...
    ((t[8] = l), (t[9] = a), (t[10] = s), (t[11] = u), (t[12] = d), (t[13] = o), (t[14] = F));
  } else F = t[14];
  let I = F,
    ee;
  bb1: {
  ...
  t[29] !== x || t[30] !== a
    ? ((te = (e) => {
        let { lineNumber: t, side: r, startLine: i, startSide: o, localDiffHunk: s } = e;
        if (!x) return;
        let c = an(r, t);
        P((e) => {
          if (e[c]) return e;
        ...
        switch (n.kind) {
          case `comment`: {
            if (n.source === `readonly`) {
              let e = n.attached === !0,
                t = r(n.comment),
                i = `url` in n.comment && typeof n.comment.url == `string` ? n.comment.url : null,
                  ...
                  g == null
                    ? (0, Z.jsx)(N, {
                        ...
                        onClick: (i) => {
                          (i.preventDefault(),
                            i.stopPropagation(),
                            p?.(
                              e ? (l ?? []).filter((e) => r(e) !== t) : [...(l ?? []), n.comment],
                            ));
                        },
                        children: e
                          ? (0, Z.jsx)(b, {
                    ...
                    : o
                      ? (0, Z.jsx)(N, {
                          ...
                          size: `toolbar`,
                          onClick: (e) => {
                            (e.preventDefault(), e.stopPropagation(), g(n.comment));
                          },
                          children: (0, Z.jsx)(b, {
