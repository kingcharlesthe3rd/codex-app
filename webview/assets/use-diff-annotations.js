...
import { O as d, R as f, Y as p, o as m, p as h, s as g } from "./pdf-1.js";
import {
  I as _,
  a as v,
  h as y,
...
import { c as E, n as D, o as O } from "./lib-2.js";
import { d as k } from "./thread-context-inputs.js";
import { p as A } from "./codex-api.js";
import { d as j } from "./apps-queries.js";
import { t as M } from "./tooltip.js";
import { t as N } from "./button.js";
import { t as P } from "./open-workspace-file-CJcJ-CWR.js";
...
import { n as L, r as R, t as z } from "./open-target-selection.js";
...
import { i as re, t as W } from "./pull-request-readonly-comment.js";
import { t as G } from "./arrow-up.js";
import { i as K, n as ie, o as q, r as ae } from "./composer-controller.js";
import { r as oe } from "./use-composer-controller.js";
import { t as se } from "./at-mention-list-1.js";
import { t as ce } from "./anchored-autocomplete-overlay.js";
import { n as le, t as ue } from "./prompt-editor.js";
import { n as J, r as de, t as fe } from "./rich-preview-primitives.js";
import { n as pe, t as me } from "./markdown-surface.js";
...
function xe(e) {
  ...
  if (g) {
    ...
    t[13] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, X.jsx)(fe, { className: `justify-center py-6 text-sm` })), (t[13] = i))
      : (i = t[13]);
    let a;
    return (
      t[14] === n
  ...
  t[16] === v
    ? (x = t[17])
    : ((x = (0, X.jsx)(pe, { enableMetadataPreview: !0, markdown: v })), (t[16] = v), (t[17] = x));
  let C;
  return (
    t[18] !== r || t[19] !== y || t[20] !== b || t[21] !== x
      ? ((C = (0, X.jsx)(me, { background: y, className: r, overflow: b, children: x })),
        (t[18] = r),
        (t[19] = y),
        (t[20] = b),
        (t[21] = x),
...
var Je = t((e, t) => {
  ...
  Ze = class {
    ...
    get page() {
      return (
        Z(this.pdfViewer, `PDF viewer is not initialized.`), this.pdfViewer.currentPageNumber || 0
      );
    }
    set page(e) {
...
function cn(e) {
  ...
  return (
    t[6] !== a || t[7] !== c
      ? ((l = { drafts: a, updateDrafts: c }), (t[6] = a), (t[7] = c), (t[8] = l))
      : (l = t[8]),
    l
  );
}
...
function un(e) {
  let t = (0, Y.c)(107),
    ...
    b = v === void 0 ? !1 : v,
    x;
  t[0] === h ? (x = t[1]) : ((x = h ? r(h) : ``), (t[0] = h), (t[1] = x));
  let S = x,
    C = h?.position.start_line ?? s ?? o,
    w = h?.position.line ?? o,
    [T, D] = (0, Q.useState)(S),
  ...
  let H = V,
    U;
  t[12] === Symbol.for(`react.memo_cache_sentinel`) ? ((U = ue()), (t[12] = U)) : (U = t[12]);
  let W = U,
    K;
  (t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = () => {
  ...
  if (!b && h?.replyToReviewThreadId != null) {
    ...
    let c;
    t[66] !== me || t[67] !== y || t[68] !== r || t[69] !== o || t[70] !== s
      ? ((c = (0, X.jsx)(N, {
          "aria-label": r,
          color: `primary`,
          disabled: o,
        ...
        children:
          C === w
            ...
            : (0, X.jsx)(O, {
                ...
                values: {
                  endLine: `${a === `deletions` ? `L` : `R`}${w}`,
                  startLine: `${a === `deletions` ? `L` : `R`}${C}`,
                },
              }),
      })),
      (t[96] = w),
...
function mn(e) {
  ...
  let T = he(w),
    E;
  t[4] === Symbol.for(`react.memo_cache_sentinel`) ? ((E = { hostId: i }), (t[4] = E)) : (E = t[4]);
  let D = j(E),
    { skills: O } = ne(_),
    k,
    A;
  ...
  (t[17] !== n || t[18] !== d ? ((F = [n, d]), (t[17] = n), (t[18] = d), (t[19] = F)) : (F = t[19]),
    (0, Q.useEffect)(P, F));
  let I;
  t[20] !== r || t[21] !== l || t[22] !== o || t[23] !== s || t[24] !== m
    ? ((I = (e) => {
        let t = e.relatedTarget;
        o && r === s && (!t || !l.current?.contains(t)) && m?.();
      }),
      (t[20] = r),
      (t[21] = l),
      (t[22] = o),
...
function gn(e) {
  ...
  let [M, P] = (0, Q.useState)(j),
    F;
  if (t[8] !== l || t[9] !== r || t[10] !== s || t[11] !== u || t[12] !== d || t[13] !== i) {
    bb0: {
      if (!s) {
        let e;
      ...
      let e = new Set((l ?? []).map(Sn)),
        a = new Set((d ?? []).map(xn)),
        c = (l ?? []).flatMap((e) => (a.has(o(e)) ? [] : [{ comment: e, source: `user` }])),
        f = (d ?? []).map((t) => ({ attached: e.has(o(t)), comment: t, source: `readonly` })),
        p = (u ?? []).map(bn),
        m = [...c, ...f, ...p];
      if (m.length === 0) {
        let e;
      ...
      F = m
        .filter((e) => {
          let { comment: t } = e;
          return n(t.position.path, r, i);
        })
        .map(yn);
    }
    ((t[8] = l), (t[9] = r), (t[10] = s), (t[11] = u), (t[12] = d), (t[13] = i), (t[14] = F));
  } else F = t[14];
  let I = F,
    ee;
  bb1: {
  ...
  t[29] !== y || t[30] !== r
    ? ((ne = (e) => {
        let { lineNumber: t, side: n, startLine: i, startSide: o, localDiffHunk: s } = e;
        if (!y) return;
        let c = an(n, t);
        P((e) => {
          if (e[c]) return e;
          ...
          return {
            ...
            [c]: {
              ...
              lineNumber: t,
              path: l,
              ...(i != null && (i !== t || o !== n) ? { startLine: i } : {}),
              ...(o != null && o !== n ? { startSide: o } : {}),
          ...
          case `comment`: {
            if (n.source === `readonly`) {
              let e = n.attached === !0,
                ...
                a = g != null && i != null && !(l ?? []).some((e) => e.replyToReviewThreadId === i),
                s;
              return (
                (s =
                  g == null
                    ? (0, X.jsx)(N, {
                        ...
                        onClick: (r) => {
                          (r.preventDefault(),
                            r.stopPropagation(),
                            p?.(
                              e ? (l ?? []).filter((e) => o(e) !== t) : [...(l ?? []), n.comment],
                            ));
                        },
                        children: e
                          ? (0, X.jsx)(O, {
            ...
            return (0, X.jsx)(un, {
              ...
              onSubmit: (e) => {
                t(r, !1);
                let i = (l ?? []).map((t) => (t === n.comment ? e : t));
                p?.(i);
              },
              onDelete: () => {
                (t(r, !1), _?.(), p?.(l?.filter((e) => e !== n.comment) ?? []));
              },
            });
          }
          case `draft-comment`:
