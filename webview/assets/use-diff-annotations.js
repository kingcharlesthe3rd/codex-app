...
import { c as x, n as S, o as C } from "./lib.js";
...
import { t as O } from "./context-menu-Cx-ZCB4Y.js";
import { F as k } from "./rpc-1.js";
...
import { O as I, R as L, Y as R, o as z, p as B, s as V } from "./pdf-1.js";
...
import { n as G, r as K, t as re } from "./open-target-selection.js";
import { t as ie } from "./copy-to-clipboard.js";
import { n as q } from "./use-skills-J.js";
import { n as ae } from "./use-resize-observer.js";
import { t as oe } from "./format-relative-date-time.js";
import { n as se } from "./markdown-DuQ7-Xtp.js";
import { t as J } from "./github-details.js";
import { i as ce, n as le, r as ue, s as Y } from "./composer-controller.js";
...
function De(e) {
  let t = (0, X.c)(67),
    ...
    B,
    V;
  if (t[0] !== r || t[1] !== n || t[2] !== i || t[3] !== s || t[4] !== I || t[5] !== M) {
    let { authorLogin: e, text: a } = s == null ? { authorLogin: null, text: i ?? `` } : d(s);
    ((z = n ?? s?.authorLogin ?? e),
      (B = s == null ? (i ?? ``) : a),
      (R =
        z ??
    ...
    let o = r ?? s?.authorAvatarUrl ?? (z == null ? null : we(z, 48)),
      c = o != null && o !== I,
      l = M.formatMessage(
        {
          id: `pullRequestsPage.detail.commentAuthorAvatarAlt`,
    ...
    ((V = c
      ...
      : (0, Z.jsx)(`span`, {
          ...
          children: R.slice(0, 1).toUpperCase(),
        })),
      (t[0] = r),
      (t[1] = n),
      (t[2] = i),
  ...
  if (S) {
                ...
                children: [
                  ...
                  u == null
                    ...
                    : (0, Z.jsx)(`span`, {
                        ...
                        children: (0, Z.jsx)(oe, { dateString: u }),
                      }),
                ],
              })
            : null),
    ...
    let l;
    t[30] === c ? (l = t[31]) : ((l = w(`flex min-w-0 gap-2 py-1`, c)), (t[30] = c), (t[31] = l));
    let d;
    t[32] === H
      ? (d = t[33])
      : ((d = (0, Z.jsx)(`span`, { className: `shrink-0`, children: H })),
        (t[32] = H),
        (t[33] = d));
    let f;
    t[34] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (f = t[34]);
    let p;
    t[35] === B ? (p = t[36]) : ((p = J(B)), (t[35] = B), (t[36] = p));
    let m;
    t[37] === p
      ? (m = t[38])
      : ((m = (0, Z.jsx)(se, {
  ...
  let ee = s == null ? [] : l(s).slice(1),
    te = O.map(Ae),
    U = [...ee, ...te],
    W;
  t[46] !== s || t[47] !== k
    ? ((W = k && s != null ? je(s) : null), (t[46] = s), (t[47] = k), (t[48] = W))
    : (W = t[48]);
  let ne = W,
    G = z != null || u != null,
    K = A === `card`,
    re;
  t[49] === H ? (re = t[50]) : ((re = (0, Z.jsx)(Te, { children: H })), (t[49] = H), (t[50] = re));
  let ie = re,
    q = N
      ? null
      : (0, Z.jsxs)(`div`, {
  ...
  let ce = ae,
    le;
  t[54] !== K || t[55] !== ce || t[56] !== u || t[57] !== N || t[58] !== ne || t[59] !== P
    ? ((le =
        ne != null || u != null || K
          ? (0, Z.jsxs)(`div`, {
  ...
  return (
    t[64] !== R || t[65] !== de
      ? ((fe = (0, Z.jsxs)(Z.Fragment, { children: [R, de] })),
        (t[64] = R),
        (t[65] = de),
        (t[66] = fe))
      : (fe = t[66]),
...
function Pe(e) {
  ...
  let d = n && a,
    p;
  t[5] === d ? (p = t[6]) : ((p = { enabled: d }), (t[5] = d), (t[6] = p));
  let m;
  t[7] !== u || t[8] !== p
    ? ((m = { params: u, queryConfig: p }), (t[7] = u), (t[8] = p), (t[9] = m))
    : (m = t[9]);
  let { data: h, isLoading: g, isError: _ } = v(`read-git-file-binary`, m),
    y = n ? `` : i,
    b = r?.hostId ?? `local`,
    x;
  t[10] !== y || t[11] !== b
...
var { PDFDataRangeTransport: Ft } = R,
  It = (e, t) => {
    switch (t) {
...
var Rt = (0, Q.forwardRef)(function (
  ...
  (0, Q.useImperativeHandle)(S, () => ({ linkService: M, pages: N, viewer: I }), []);
  function R() {
    g && g();
  }
  function z() {
  ...
  let se = (0, Q.useMemo)(
      () =>
        St(K) && re && St(ie) && St(q)
          ...
          : null,
      [t, r, c, l, d, g, _, v, y, b, x, T, E, D, O, k, A, W, K, re, I, R, ie, q],
    ),
    J = (0, Q.useMemo)(() => st(ee, () => W && (q ? Mt(W, q) : void 0)), [ee, W, q]),
    ce = `${K}@${q}/${ie}`;
  function le() {
    switch (L) {
      case `custom`:
...
function Dn(e) {
  let t = (0, X.c)(107),
    ...
    b = v === void 0 ? !1 : v,
    S;
  t[0] === h ? (S = t[1]) : ((S = h ? p(h) : ``), (t[0] = h), (t[1] = S));
  let w = S,
    E = h?.position.start_line ?? o ?? a,
    D = h?.position.line ?? a,
    [O, k] = (0, Q.useState)(w),
    [A, j] = (0, Q.useState)(!h && !b),
    M = (0, Q.useRef)(null),
    N = (0, Q.useRef)(null),
    F = (0, Q.useRef)(h != null),
    { data: I } = ee(),
...
function jn(e) {
  ...
  let T = xe(w),
    E;
  t[4] === Symbol.for(`react.memo_cache_sentinel`) ? ((E = { hostId: f }), (t[4] = E)) : (E = t[4]);
  let D = te(E),
    { skills: O } = q(_),
    k,
    A;
  ...
  (t[17] !== n || t[18] !== u ? ((P = [n, u]), (t[17] = n), (t[18] = u), (t[19] = P)) : (P = t[19]),
    (0, Q.useEffect)(N, P));
  let F;
  t[20] !== r || t[21] !== c || t[22] !== a || t[23] !== o || t[24] !== m
    ? ((F = (e) => {
        let t = e.relatedTarget;
        a && r === o && (!t || !c.current?.contains(t)) && m?.();
      }),
      (t[20] = r),
      (t[21] = c),
      (t[22] = a),
  ...
  t[31] !== R
    ...
    : (z = t[32]);
  let B;
  t[33] !== S || t[34] !== n || t[35] !== v.ui || t[36] !== I || t[37] !== z
    ? ((B = (0, Z.jsx)(pe, {
        anchorRef: g,
        composerController: n,
        isActive: I,
  ...
  let U;
  return (
    t[50] !== p || t[51] !== F || t[52] !== B || t[53] !== V || t[54] !== ee
      ? ((U = (0, Z.jsxs)(`div`, {
          ref: g,
          className: `relative`,
          onFocus: p,
  ...
  let t = (0, X.c)(51),
    {
      ...
      onCommentsChange: d,
      commentAuthorLabel: f,
      commentAuthorAvatarUrl: p,
  ...
  if (t[8] !== o || t[9] !== n || t[10] !== i || t[11] !== s || t[12] !== c || t[13] !== r) {
    bb0: {
      ...
      let e = new Set((o ?? []).map(zn)),
        a = new Set((c ?? []).map(Rn)),
        l = (o ?? []).flatMap((e) => (a.has(u(e)) ? [] : [{ comment: e, source: `user` }])),
        d = (c ?? []).map((t) => ({ attached: e.has(u(t)), comment: t, source: `readonly` })),
        f = (s ?? []).map(Ln),
        p = [...l, ...d, ...f];
      if (p.length === 0) {
        let e;
          ...
          case `comment`: {
            if (n.source === `readonly`) {
              let e = n.attached === !0,
                ...
                a = m != null && i != null && !(o ?? []).some((e) => e.replyToReviewThreadId === i),
                s;
              return (
                (s =
                  m == null
                    ? (0, Z.jsx)(T, {
                        ...
                        onClick: (r) => {
                          (r.preventDefault(),
                            r.stopPropagation(),
                            d?.(
                              e ? (o ?? []).filter((e) => u(e) !== t) : [...(o ?? []), n.comment],
                            ));
                        },
                        children: e
                          ? (0, Z.jsx)(C, {
                    ...
                    : a
                      ? (0, Z.jsx)(T, {
                          ...
                          size: `toolbar`,
                          onClick: (e) => {
                            (e.preventDefault(), e.stopPropagation(), m(n.comment));
                          },
                          children: (0, Z.jsx)(C, {
