...
import { G as o, St as s, g as c, js as l, ms as u } from "./app-server-manager-signals.js";
import { m as d } from "./vscode-api.js";
import { n as f } from "./react.js";
import { Ai as p, Oi as m, Si as h, Ti as g, ki as _, wi as v, yi as y } from "./src-1.js";
...
var k = e(),
  ...
  P = b((e) => a(A)),
  F = b((e) => a(null)),
  I = n(i, (e, { get: t }) => t(s, e)?.at(-1)?.params ?? null);
function ee(e, { requirements: t, resolvedConfig: n }) {
  switch (e) {
    case `STEPS_PROSE`:
      return g(`granular`, t) && v(n ?? void 0, `granular`) === `granular` ? `granular` : `auto`;
    case `STEPS_COMMANDS`:
      return `auto`;
  }
}
...
function ie(e) {
  let n = (0, k.c)(10),
    ...
    d;
  n[0] !== c || n[1] !== l || n[2] !== u
    ? ((d = h({ approvalPolicy: c, approvalsReviewer: l, sandboxPolicy: u })),
      (n[0] = c),
      (n[1] = l),
      (n[2] = u),
      (n[3] = d))
  ...
  let f = d,
    p = null;
  f != null && f !== `full-access` && f !== `custom` && (p = f);
  let m = f != null,
    g;
  return (
    n[4] !== a || n[5] !== m || n[6] !== f || n[7] !== p || n[8] !== s
      ? ((g = {
          hasThreadSelection: m,
          selectionSource: a,
          threadSandboxPolicy: s,
          threadMode: f,
          threadPreferredNonFullAccessMode: p,
        }),
        (n[4] = a),
        (n[5] = m),
        (n[6] = f),
...
function oe(e) {
  let n = (0, k.c)(18),
    ...
    { data: l } = r(S),
    d = o !== void 0,
    f = d ? (o ?? null) : (s ?? l?.roots?.[0] ?? null),
    p = d && f == null,
    [h] = u(`statsig_default_enable_features`),
    _ = d ? `preserve-null` : `fallback-to-workspace`,
    v = !p,
    y;
  n[0] !== a || n[1] !== _ || n[2] !== v
    ? ((y = { hostId: a, cwdMode: _, enabled: v }), (n[0] = a), (n[1] = _), (n[2] = v), (n[3] = y))
    : (y = n[3]);
  let { data: b, isPending: x } = w(f, y),
    T;
  n[4] === a ? (T = n[5]) : ((T = { hostId: a }), (n[4] = a), (n[5] = T));
  let { data: E, isPending: D } = t(C, T),
    O = E?.requirements ?? null,
    A = b?.config ?? null,
    j;
  n[6] !== D || n[7] !== O
    ? ((j = D || g(`auto`, O) || g(`guardian-approvals`, O)), (n[6] = D), (n[7] = O), (n[8] = j))
    : (j = n[8]);
  let M = j,
    N;
  n[9] !== h || n[10] !== M || n[11] !== A
    ? ((N = M && m(A ?? void 0) !== !1 && h === void 0),
      (n[9] = h),
      (n[10] = M),
      (n[11] = A),
      (n[12] = N))
    : (N = n[12]);
  let P = p || D || x || N,
    F = h?.guardian_approval === !0,
    I;
  return (
    n[13] !== O || n[14] !== A || n[15] !== P || n[16] !== F
      ? ((I = {
...
function z(e) {
  let n = (0, k.c)(60),
    ...
    u = s === void 0 ? `composer` : s,
    m = t(c, i),
    { data: h } = r(S),
    g = a !== void 0,
    _ = g ? (a ?? null) : (m ?? h?.roots?.[0] ?? null),
    v = g && _ == null,
    b = T(),
    x;
  n[0] !== i || n[1] !== a || n[2] !== o
  ...
  let C = oe(x),
    ...
    E;
  n[4] !== i || n[5] !== u
    ? ((E = { conversationId: i, stateScope: u }), (n[4] = i), (n[5] = u), (n[6] = E))
    : (E = n[6]);
  let D = re(E),
    [A, N] = f(O),
    [P, I] = f(j),
    [ee, L] = f(M),
    R;
  n[7] === i ? (R = n[8]) : ((R = F(i)), (n[7] = i), (n[8] = R));
  let [ae, z] = f(R),
    { hasThreadSelection: ce, selectionSource: B, threadMode: V, threadSandboxPolicy: H } = ie(i),
    U = ae?.selectionSource === B ? ae.mode : null,
    W = ne(o, A, w),
    le = C.isConfigDataPending || p(C.requirements, C.resolvedConfig).includes(W),
    ue = A[o],
    G = (v || C.isConfigDataPending) && (ue == null || ue === `auto` || ue === `granular`),
    K;
  n[9] !== A || n[10] !== o
    ? ((K = Object.hasOwn(A, o)), (n[9] = A), (n[10] = o), (n[11] = K))
    : (K = n[11]);
  let q = K,
    J;
  n[12] !== i || n[13] !== _ || n[14] !== C.resolvedConfig || n[15] !== H
    ? ((J = (e) => {
        ...
        return l(`update-thread-settings-for-next-turn`, {
          conversationId: i,
          threadSettings: {
  ...
  if (D === `draft`) {
    ...
    let a;
    return (
      n[22] !== L || n[23] !== r || n[24] !== i || n[25] !== e || n[26] !== t
        ? ((a = {
            agentMode: e,
  ...
  if (D === `global-default`) {
    let e;
    n[28] !== A || n[29] !== o || n[30] !== Z || n[31] !== N || n[32] !== Y
      ? ((e = (e) => {
  ...
  let de = U ?? V ?? w,
    fe = U != null || ce,
    pe = U == null && V == null && (v || C.isConfigDataPending),
    me = U != null,
    Q;
