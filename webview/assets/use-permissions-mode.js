import { Bt as e, Gt as t, Lt as n, Pt as r, Ut as i, Wt as a, zt as o } from "./src-2.js";
import { H as s, _t as c, fs as l, g as u, qo as d } from "./app-server-manager-signals.js";
import { I as f, P as p, R as m, at as h, g, h as _, lt as v } from "./vscode-api.js";
import { n as y } from "./react.js";
import { o as b } from "./statsig.js";
import { t as ee } from "./thread-context-inputs.js";
import { c as x, v as S } from "./config-queries.js";
import { r as C } from "./persisted-atom.js";
...
var O = v(),
  ...
  N = C((e) => h(k)),
  P = C((e) => h(null)),
  F = m(_, (e, { get: t }) => t(c, e)?.at(-1)?.params ?? null);
...
function oe(t) {
  let n = (0, O.c)(18),
    ...
    { data: c } = f(ee),
    l = o !== void 0,
    m = l ? (o ?? null) : (s ?? c?.roots?.[0] ?? null),
    h = l && m == null,
    [g] = d(`statsig_default_enable_features`),
