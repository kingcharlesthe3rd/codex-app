import { R as e, a as t, l as n, s as r, t as i, v as a } from "./app-scope.js";
import { m as o } from "./vscode-api.js";
import { n as s } from "./react.js";
import { Gt as c, Ht as l, It as u, Kt as d, Vt as f, qt as p, zt as m } from "./src-4.js";
import {
  As as h,
  W as g,
  g as ee,
...
import { r as y } from "./persisted-atom.js";
import { o as b } from "./statsig-DoZ-0xit.js";
import { t as x } from "./thread-context-inputs.js";
import { c as S, y as C } from "./config-queries-BHYT-TjG.js";
import { i as w } from "./thread-detail-level.js";
import { i as T, n as E, r as D } from "./permissions-mode-defaults.js";
var O = e(),
  ...
  N = y((e) => a(k)),
  P = y((e) => a(null)),
  F = n(i, (e, { get: t }) => t(v, e)?.at(-1)?.params ?? null);
function te(e, { requirements: t, resolvedConfig: n }) {
  switch (e) {
    case `STEPS_PROSE`:
      return l(`granular`, t) && f(n ?? void 0, `granular`) === `granular` ? `granular` : `auto`;
    case `STEPS_COMMANDS`:
      return `auto`;
  }
}
...
function ae(e) {
  let n = (0, O.c)(10),
    ...
    u;
  n[0] !== s || n[1] !== c || n[2] !== l
    ? ((u = m({ approvalPolicy: s, approvalsReviewer: c, sandboxPolicy: l })),
      (n[0] = s),
      (n[1] = c),
      (n[2] = l),
      (n[3] = u))
...
function oe(e) {
  let n = (0, O.c)(18),
    { conversationId: i, hostId: a, cwdOverride: o } = e,
    s = t(ee, i),
    { data: u } = r(x),
    d = o !== void 0,
    f = d ? (o ?? null) : (s ?? u?.roots?.[0] ?? null),
    p = d && f == null,
    [m] = _(`statsig_default_enable_features`),
    h = d ? `preserve-null` : `fallback-to-workspace`,
    g = !p,
    v;
  n[0] !== a || n[1] !== h || n[2] !== g
    ? ((v = { hostId: a, cwdMode: h, enabled: g }), (n[0] = a), (n[1] = h), (n[2] = g), (n[3] = v))
    : (v = n[3]);
  let { data: y, isPending: b } = C(f, v),
    w;
  n[4] === a ? (w = n[5]) : ((w = { hostId: a }), (n[4] = a), (n[5] = w));
  let { data: T, isPending: E } = t(S, w),
    D = T?.requirements ?? null,
    k = y?.config ?? null,
    A;
  n[6] !== E || n[7] !== D
    ? ((A = E || l(`auto`, D) || l(`guardian-approvals`, D)), (n[6] = E), (n[7] = D), (n[8] = A))
    : (A = n[8]);
  let j = A,
    M;
  n[9] !== m || n[10] !== j || n[11] !== k
    ? ((M = j && c(k ?? void 0) !== !1 && m === void 0),
      (n[9] = m),
      (n[10] = j),
      (n[11] = k),
      (n[12] = M))
...
function z(e) {
  let n = (0, O.c)(60),
    { conversationId: i, cwdOverride: a, hostId: c, stateScope: l } = e,
    d = l === void 0 ? `composer` : l,
    f = t(ee, i),
    { data: m } = r(x),
    g = a !== void 0,
    _ = g ? (a ?? null) : (f ?? m?.roots?.[0] ?? null),
    v = g && _ == null,
    y = w(),
    b;
  n[0] !== i || n[1] !== a || n[2] !== c
    ? ((b = { conversationId: i, cwdOverride: a, hostId: c }),
      (n[0] = i),
      (n[1] = a),
      (n[2] = c),
      (n[3] = b))
  ...
  let S = oe(b),
    ...
    T;
  n[4] !== i || n[5] !== d
    ? ((T = { conversationId: i, stateScope: d }), (n[4] = i), (n[5] = d), (n[6] = T))
    : (T = n[6]);
  let D = ie(T),
    [k, M] = s(E),
    [N, F] = s(A),
  ...
  let [R, z] = s(L),
    ...
    W = re(c, k, C),
    le = S.isConfigDataPending || p(S.requirements, S.resolvedConfig).includes(W),
    ue = k[c],
    G = (v || S.isConfigDataPending) && (ue == null || ue === `auto` || ue === `granular`),
    K;
  n[9] !== k || n[10] !== c
    ? ((K = Object.hasOwn(k, c)), (n[9] = k), (n[10] = c), (n[11] = K))
    : (K = n[11]);
  let q = K,
    J;
  n[12] !== i || n[13] !== _ || n[14] !== S.resolvedConfig || n[15] !== H
    ? ((J = (e) => {
        ...
        return h(`update-thread-settings-for-next-turn`, {
          conversationId: i,
          threadSettings: {
  ...
  n[17] === i
    ? (X = n[18])
    : ((X = (e) => {
        o.error(`Failed to set thread permissions mode`, {
  ...
  if (D === `global-default`) {
    let e;
    n[28] !== k || n[29] !== c || n[30] !== Z || n[31] !== M || n[32] !== Y
      ? ((e = (e) => {
          k[c] !== e && (M({ ...k, [c]: e }), Y(e)?.catch(Z));
        }),
        (n[28] = k),
        (n[29] = c),
        (n[30] = Z),
...
function ce(e) {
  let t = (0, O.c)(30),
    ...
    c;
  t[0] !== n || t[1] !== o
    ? ((c = { conversationId: n, stateScope: o }), (t[0] = n), (t[1] = o), (t[2] = c))
    : (c = t[2]);
  let l = ie(c),
    [u, d] = s(D),
    [f, p] = s(M),
    m;
  t[3] === n ? (m = t[4]) : ((m = n == null ? M : N(n)), (t[3] = n), (t[4] = m));
  let [h, g] = s(m),
    { hasThreadSelection: ee, threadMode: _, threadPreferredNonFullAccessMode: v } = ae(n),
    y;
  ...
  let { agentMode: b } = z(y),
    x;
  t[10] !== i || t[11] !== u ? ((x = T(i, u)), (t[10] = i), (t[11] = u), (t[12] = x)) : (x = t[12]);
  let S = x;
  if (l === `draft`) {
    let e = f.isSet ? f.value : S,
      n;
    t[13] === p
      ? (n = t[14])
      : ((n = (e) => {
  ...
  let C = h.isSet ? h.value : ee && b === _ ? v : null,
    w;
  t[25] === g
    ? (w = t[26])
    : ((w = (e) => {
