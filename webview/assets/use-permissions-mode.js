...
import { It as f, it as p, k as m, n as h } from "./thread-context-inputs.js";
...
import { c as te, v as ne } from "./config-queries.js";
import { i as j } from "./thread-detail-level.js";
import { n as M, r as N, t as P } from "./permissions-mode-defaults.js";
var re = 100,
  ie = `:read-only`,
  F = `:workspace`;
...
function oe(e, t, n) {
  let r = t?.allowedPermissionProfiles,
    ...
    o = t?.defaultPermissions ?? a ?? (r?.[ie] === !0 && r[F] === !0 ? F : null);
  return { profiles: i, defaultProfileId: o != null && i.some(({ id: e }) => e === o) ? o : null };
}
var se = a(s, ({ hostId: e, cwd: t }) => ({
  queryKey: I(e, t),
  queryFn: () => ae(e, t),
...
function fe({ defaultWorkspaceWriteMode: e, isWindowsSandboxRequired: t }) {
...
function z(e, t, n, r = null) {
  return r != null && e.includes(r)
    ...
    : e.includes(`custom`)
      ? `custom`
      : !V(e) && e.includes(`full-access`)
        ? `full-access`
        : t != null && e.includes(t)
          ? t
          : n;
}
function B(e, t, n, r, i = null, a, o) {
  return t == null
    ? le(e, r, i)
      ? null
...
var pe = e(),
  U = { isSet: !1, value: null },
  me = { isSet: !1, value: null },
  he = l(null),
  ge = n(s, () => ({})),
  _e = l(!1),
  W = l(U),
  ve = c((e) => l(U)),
  ye = c((e) => l(null)),
  G = r(s, (e, { get: t }) => t(f, e)?.at(-1)?.params ?? null);
function be(e, { requirements: t, resolvedConfig: n }) {
  switch (e) {
    case `STEPS_PROSE`:
...
function Ce(e) {
  ...
  return !Te() || r === `global-default` ? `global-default` : (t ?? `draft`);
}
function we(e) {
  let n = (0, pe.c)(11),
    r = t(p, e),
  ...
  let m = d != null,
    ...
    g;
  return (
    n[4] !== a || n[5] !== m || n[6] !== h || n[7] !== d || n[8] !== f || n[9] !== o
      ? ((g = {
          hasThreadSelection: m,
          selectionSource: a,
...
function Ee(e) {
  let n = (0, pe.c)(19),
    ...
    f = l && u == null,
    [p] = d(`statsig_default_enable_features`),
    g = ee(),
  ...
  n[0] !== i || n[1] !== _ || n[2] !== v
    ...
    : (b = n[3]);
  let { data: x, isPending: S } = ne(u, b),
    C;
  n[4] === i ? (C = n[5]) : ((C = { hostId: i }), (n[4] = i), (n[5] = C));
  let { data: w, isPending: T } = t(te, C),
  ...
  let A = k,
    j;
  n[9] !== p || n[10] !== A || n[11] !== g || n[12] !== D
    ? ((j = A && O(D ?? void 0) !== !1 && (p === void 0 || g)),
      (n[9] = p),
      (n[10] = A),
      (n[11] = g),
      (n[12] = D),
    ...
    : (j = n[13]);
  let M = f || T || S || j,
    N = p?.guardian_approval === !0,
    P;
  return (
    n[14] !== E || n[15] !== D || n[16] !== M || n[17] !== N
      ? ((P = {
          isConfigDataPending: M,
          isGuardianApprovalEnabledByStatsig: N,
          requirements: E,
          resolvedConfig: D,
        }),
        (n[14] = E),
...
function De(e) {
  ...
  let A = t(se, O),
    ...
    ne = xe(w, E),
    M = ue(te?.defaultProfileId, be(w, E)),
    N = M == null ? (te?.defaultProfileId ?? null) : null,
    re = M ?? ne,
    ie = te != null && k(E.requirements).length === 0 && N == null,
    F;
  n[7] !== r || n[8] !== d
    ? ((F = { conversationId: r, stateScope: d }), (n[7] = r), (n[8] = d), (n[9] = F))
    : (F = n[9]);
  let ae = Ce(F),
    I = r == null && d === `composer`,
    [L, R] = v(P),
    ...
    z;
  n[10] !== x || n[11] !== c
    ? ((z = JSON.stringify([c, x])), (n[10] = x), (n[11] = c), (n[12] = z))
    : (z = n[12]);
  let B = z,
    V = fe[B] ?? me,
    H = V.isSet ? V.value : N,
  ...
  n[13] !== B || n[14] !== f
    ? ((U = (e) => {
        f.set(ge, (t) => ({ ...t, [B]: { isSet: !0, value: e } }));
      }),
      (n[13] = B),
      (n[14] = f),
      (n[15] = U))
  ...
  let W = U,
    [ve, G] = v(_e),
    K;
  n[16] === r ? (K = n[17]) : ((K = ye(r)), (n[16] = r), (n[17] = K));
  let [Te, q] = v(K),
    {
      hasThreadSelection: De,
      selectionSource: ke,
      threadPermissionProfileId: J,
      threadMode: Y,
      threadSandboxPolicy: Ae,
    } = we(r),
    je = Te?.selectionSource === ke ? Te.mode : null,
    Me = L[c],
    Ne;
  n[18] !== L || n[19] !== c
    ? ((Ne = Object.hasOwn(L, c)), (n[18] = L), (n[19] = c), (n[20] = Ne))
    : (Ne = n[20]);
  let Pe = Ne,
    Fe = D(E.requirements, E.resolvedConfig),
    Ie = Se(c, L, ne),
    Le = M != null && (!I || !V.isSet) && (Me == null || !le(Me, Fe)) ? M : Ie,
    Re = E.isConfigDataPending || Fe.includes(Le),
    ze = (C || E.isConfigDataPending) && (Me == null || Me === `auto` || Me === `granular`),
    Be;
  n[21] !== r || n[22] !== x || n[23] !== E.resolvedConfig || n[24] !== Ae
    ? ((Be = (e) => {
        if (r == null) return null;
        let t = b(
          e,
          Ae?.type === `workspaceWrite` ? Ae.writableRoots : x == null ? [] : [x],
          E.resolvedConfig,
        );
  ...
  if (ae === `draft`) {
    let e = ce ?? Le,
      t = ve || Pe,
      r = (ce == null && (ze || (!V.isSet && ee))) || (H == null && ie),
      i;
    n[28] !== de || n[29] !== W || n[30] !== G
      ? ((i = (e) => {
          (W(null), de(e), G(!0));
        }),
        (n[28] = de),
  ...
  if (ae === `global-default`) {
    ...
    n[49] !== X
      ? ((e = (e) => {
          (I && W(null), L[c] !== e && R({ ...L, [c]: e }), X(e)?.catch(Z));
        }),
        (n[43] = L),
        (n[44] = c),
        (n[45] = I),
    ...
    let a = i,
      o;
    n[56] !== r || n[57] !== I || n[58] !== Z || n[59] !== W || n[60] !== G
      ? ((o = (e) => {
          if (I) {
            (W(e), G(!0));
            return;
    ...
    if (r != null && Y != null && !Re) {
      let e;
      return (
        n[62] !== t || n[63] !== s || n[64] !== a || n[65] !== Y || n[66] !== J
          ? ((e = {
              agentMode: Y,
    ...
    let l = Pe || (I && (V.isSet || N != null)),
      d = ze || (I && !V.isSet && ee) || (I && H == null && ie),
      f = I ? H : J,
      p = I || J == null,
      m;
    return (
  ...
  let He = je ?? Y ?? re,
    Ue = je != null || De,
    We = je == null && Y == null && (C || E.isConfigDataPending),
    Ge = je != null,
    Q;
  n[77] !== Z || n[78] !== ke || n[79] !== q || n[80] !== X
    ? ((Q = (e) => {
        (q({ mode: e, selectionSource: ke }),
          X(e)?.catch((e) => {
            (q(null), Z(e));
          }));
      }),
  ...
  return (
    ...
    n[92] !== J
      ? ((Ke = {
          agentMode: He,
          hasSetInitialAgentMode: Ue,
          isAgentModePending: We,
          permissionProfileId: J,
          shouldSendPermissionOverrides: Ge,
          setAgentMode: Q,
          setHasSetInitialAgentMode: Oe,
...
function ke(e) {
  ...
  let c = Ce(s),
    ...
    [d, f] = v(W),
    p;
  t[3] === n ? (p = t[4]) : ((p = n == null ? W : ve(n)), (t[3] = n), (t[4] = p));
  let [m, h] = v(p),
    { hasThreadSelection: g, threadMode: _, threadPreferredNonFullAccessMode: y } = we(n),
    b;
  t[5] !== n || t[6] !== r || t[7] !== i || t[8] !== o
    ? ((b = { conversationId: n, cwdOverride: r, hostId: i, stateScope: o }),
      ...
      (t[9] = b))
    : (b = t[9]);
  let { agentMode: x } = De(b),
    S;
  t[10] !== i || t[11] !== l ? ((S = N(i, l)), (t[10] = i), (t[11] = l), (t[12] = S)) : (S = t[12]);
  let C = S;
  if (c === `draft`) {
...
function J(e, t) {
  (t.set(he, null), e.set(ge, {}), t.set(W, U), t.set(_e, !1));
}
function Y(e, t, n) {
  e.set(ve(t), { isSet: !0, value: Ae(e, n) });
}
function Ae(e, t) {
  let n = e.get(W);
  return n.isSet ? n.value : N(t, e.get(M));
}
export {
  oe as _,
  q as a,
