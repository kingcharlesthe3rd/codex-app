...
import { $s as a, Ws as o, fo as s, g as c, ht as l } from "./app-server-manager-signals.js";
import { $ as u, S as d, Y as f, Z as p, bt as m, wt as h } from "./setting-storage.js";
import { o as g } from "./statsig.js";
import { t as _ } from "./thread-context-inputs.js";
import { c as v, v as y } from "./config-queries.js";
...
function N(e, { requirements: r, resolvedConfig: i }) {
  switch (e) {
    case `STEPS_PROSE`:
      return n(`granular`, r) && t(i ?? void 0, `granular`) === `granular` ? `granular` : `auto`;
    case `STEPS_COMMANDS`:
      return `auto`;
  }
}
...
function F(t, n) {
  ...
  return i.find((e) => e !== `full-access`) ?? (i.includes(`full-access`) ? `full-access` : r);
}
function ee(e, t, n) {
  let r = t[e];
...
function ne(e) {
  let t = (0, w.c)(16),
    ...
    S;
  t[0] !== a || t[1] !== b || t[2] !== x
    ? ((S = { hostId: a, cwdMode: b, enabled: x }), (t[0] = a), (t[1] = b), (t[2] = x), (t[3] = S))
    : (S = t[3]);
  let { data: C, isPending: T } = y(m, S),
    ...
    A;
  t[4] !== D || t[5] !== O
    ? ((A = D || n(`auto`, O) || n(`guardian-approvals`, O)), (t[4] = D), (t[5] = O), (t[6] = A))
    : (A = t[6]);
  let j = A,
    M;
  t[7] !== g || t[8] !== j || t[9] !== k
...
function z(e) {
  ...
  let y = ne(v),
    ...
    C;
  t[4] !== n || t[5] !== s
    ? ((C = { conversationId: n, stateScope: s }), (t[4] = n), (t[5] = s), (t[6] = C))
    : (C = t[6]);
  let T = te(C),
    [O, j] = a(S),
    [M, N] = a(E),
    [P, L] = a(D),
    R;
  t[7] === n ? (R = t[8]) : ((R = n == null ? E : k(n)), (t[7] = n), (t[8] = R));
  let [z, B] = a(R),
    V;
  t[9] === n ? (V = t[10]) : ((V = n == null ? D : A(n)), (t[9] = n), (t[10] = V));
  let [re, H] = a(V),
    { hasLatestTurnSelection: ie, latestTurnMode: ae } = I(n),
    U = ee(i, O, x),
    W = O[i],
    G = (h || y.isConfigDataPending) && (W == null || W === `auto` || W === `granular`),
    K;
  t[11] !== O || t[12] !== i
  ...
  let $;
  return (
    t[41] !== H || t[42] !== Z || t[43] !== Q || t[44] !== J || t[45] !== Y || t[46] !== X
      ? (($ = {
          agentMode: J,
...
function B(e) {
  let t = (0, w.c)(30),
    ...
    c;
  t[0] !== n || t[1] !== s
    ? ((c = { conversationId: n, stateScope: s }), (t[0] = n), (t[1] = s), (t[2] = c))
    : (c = t[2]);
  let l = te(c),
    [u, d] = a(C),
    [f, p] = a(O),
    m;
  t[3] === n ? (m = t[4]) : ((m = n == null ? O : j(n)), (t[3] = n), (t[4] = m));
  let [h, g] = a(m),
    {
  ...
  let { agentMode: S } = z(b),
    T;
  t[10] !== i || t[11] !== u ? ((T = x(i, u)), (t[10] = i), (t[11] = u), (t[12] = T)) : (T = t[12]);
  let E = T;
  if (l === `draft`) {
  ...
  if (l === `global-default`) {
    ...
    return (
      t[22] !== E || t[23] !== e
        ? ((n = { preferredNonFullAccessMode: E, setPreferredNonFullAccessMode: e }),
          (t[22] = E),
          (t[23] = e),
          (t[24] = n))
        : (n = t[24]),
  ...
  return (
    t[27] !== D || t[28] !== k
      ? ((A = { preferredNonFullAccessMode: D, setPreferredNonFullAccessMode: k }),
        (t[27] = D),
        (t[28] = k),
        (t[29] = A))
      : (A = t[29]),
...
function re(e, t, n, r) {
  (e.set(k(t), e.get(E) ?? r), e.set(j(t), { isSet: !0, value: H(e, n) }), e.set(A(t), !0));
}
function H(e, t) {
  let n = e.get(O);
