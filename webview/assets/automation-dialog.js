...
import { Vi as o, ds as s, v as c } from "./app-server-manager-signals.js";
import { Ar as l, fi as u, li as d, mi as f, oi as p, pi as m, ui as h } from "./src-1.js";
import { c as g, n as _, o as v, r as y } from "./lib.js";
import { t as b } from "./clsx-Cir5-jBH.js";
import { t as x } from "./button-DO-oxX3-.js";
...
import { w as E } from "./config-queries.js";
import { i as D } from "./models-and-reasoning-efforts.js";
import { n as O } from "./model-queries.js";
import { t as k } from "./chevron.js";
import { t as A } from "./clock.js";
import { f as j } from "./apps-queries.js";
import { t as M } from "./info.js";
import { m as N } from "./use-plugins.js";
import { a as P } from "./locale-resolver.js";
import { s as F, t as I } from "./use-native-apps.electron.js";
import { a as L, i as R, l as z, n as ee, r as B, t as te } from "./dialog-layout.js";
import { n as ne } from "./use-skills-J.js";
import { a as re, c as V, i as ie, n as ae, r as H, t as oe } from "./reasoning-minimal.js";
import { t as se } from "./pinned-threads-query.js";
import { _ as ce } from "./links.js";
import {
  C as le,
  f as ue,
  g as de,
...
import { i as _e, n as K, t as ve } from "./popover.js";
import { t as ye } from "./worktree.js";
import { t as be } from "./cube.js";
import {
  a as xe,
  d as Se,
  f as Ce,
...
import { t as Oe } from "./laptop.js";
import { i as ke, n as Ae, r as je, s as Me, t as Ne } from "./composer-controller.js";
import { r as Pe } from "./use-composer-controller.js";
import { t as Fe } from "./model-and-reasoning-effort-translations.js";
import { t as Ie } from "./at-mention-list-1.js";
...
function Ue(e) {
  let t = d(e ?? []);
  return t == null
    ? { model: p, reasoningEffort: null, profile: null, isLoading: !0 }
    : {
        model: t.model,
        reasoningEffort: u({ model: t, reasoningEffort: null }),
        profile: null,
        isLoading: !1,
      };
}
...
function et(e) {
  ...
  if (t[5] !== c || t[6] !== i || t[7] !== r?.threadIds || t[8] !== e) {
    let n = new Map((i ?? []).filter(rt).map(nt)),
      a = r?.threadIds ?? [],
      s = new Set(a),
      f = a.flatMap((e) => {
        let t = n.get(e);
  ...
  return (
    t[11] !== u || t[12] !== d
      ? ((p = { options: u, hasPinnedThreads: d }), (t[11] = u), (t[12] = d), (t[13] = p))
      : (p = t[13]),
    p
  );
}
...
var st = `flex flex-col gap-2`,
  ...
  _t = 260,
  vt = 208,
  yt = { none: oe, minimal: oe, low: H, medium: ae, high: ie, xhigh: re, max: re },
  bt = [
    {
      id: `hourly`,
      labelMessage: _({
...
function Dt(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, J.jsx)(M, { className: `icon-sm` })), (t[5] = s))
    : (s = t[5]);
  let c;
  t[6] === o
    ? (c = t[7])
...
function jt(e) {
  let t = (0, q.c)(110),
    {
      ...
      open: k,
      onOpenChange: A,
      forceShowNameInput: M,
      dialogSize: P,
      expandPrompt: z,
      allowedKinds: re,
    } = e,
    V = D === void 0 ? `inline` : D,
    ie = P === void 0 ? `xxwide` : P,
    ae = z === void 0 ? !1 : z,
    H = g(),
    oe = (0, Q.useRef)(null),
    se = (0, Q.useRef)(null),
    ...
    [U] = (0, Q.useState)(Ft),
    W;
  t[0] === n ? (W = t[1]) : ((W = ge(n)), (t[0] = n), (t[1] = W));
  let G = W,
    _e = n.cwds.length > 0 && !G ? n.cwds : p,
    K = je(U),
    ve = Ae(U),
    ye;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ye = t[2]);
  let be = j(ye),
    { availablePlugins: xe } = N(s, _e),
    Se;
  t[3] === xe ? (Se = t[4]) : ((Se = F(xe)), (t[3] = xe), (t[4] = Se));
  let Ce = Se != null,
    we;
  t[5] === Ce ? (we = t[6]) : ((we = { enabled: Ce }), (t[5] = Ce), (t[6] = we));
  let { nativeApps: Te } = I(we),
    { skills: Ee } = ne(_e),
    De,
    Oe;
  (t[7] !== be || t[8] !== xe || t[9] !== Ee || t[10] !== Te || t[11] !== U
    ? ((Oe = () => {
        U.syncMentionMetadata({ skills: Ee, apps: be, plugins: xe, nativeApps: Te });
      }),
      (De = [be, xe, Ee, Te, U]),
      (t[7] = be),
      (t[8] = xe),
  ...
  let Ue = ze,
    We,
    Ke;
  if (t[23] !== m || t[24] !== H || t[25] !== p || t[26] !== _) {
    let e;
    t[29] === m
      ? (e = t[30])
    ...
    (t[31] === H
      ...
      : ((r = H.formatMessage({
        ...
        (t[32] = r)),
      (Ke = r),
      (We = Ve({ workspaceGroups: _, roots: n, formatRootLabel: m })),
      (t[23] = m),
      (t[24] = H),
      (t[25] = p),
      (t[26] = _),
  ...
  let X = qe,
    ...
    { data: Je } = i(E, a(c)),
    Ye = w(`1488233300`),
    Xe = (re ?? (Ye ? [`cron`, `heartbeat`] : [`cron`])).includes(`heartbeat`),
  ...
  t[35] !== o || t[36] !== n || t[37] !== l
    ? ((it = o ? null : (0, J.jsx)(Ge, { draft: n, action: l ? `save` : `create` })),
      (t[35] = o),
      (t[36] = n),
      (t[37] = l),
      (t[38] = it))
  ...
  let ht = mt,
    gt = V === `dialog` ? L : `div`,
    _t = V === `dialog` ? ee : `div`,
    vt = V === `dialog` ? void 0 : `flex flex-col gap-4`,
    yt = ae ? ft : V === `dialog` ? ut : dt,
    bt;
  t[43] !== ce || t[44] !== n.name || t[45] !== r
    ? ((bt = (e) =>
        (0, J.jsx)(Et, {
          id: ce,
          autoFocus: e,
  ...
  if (
    ...
    bb0: {
          ...
          children: (0, J.jsxs)(_t, {
            ...
            children: [
              ...
              V === `dialog` && !l && le
                ...
                : null,
              le && V !== `dialog` ? (0, J.jsx)(gt, { className: st, children: xt(!l) }) : null,
              (0, J.jsx)(gt, {
                className: st,
                children: (0, J.jsxs)(`div`, {
                  ref: se,
                  ...
                  children: [
                    ...
                    (0, J.jsx)(Me, {
                      ...
                      onSkillMentionHandler: ve.handleMentionEvent,
                      onSubmit: Ue,
                    }),
                  ],
                }),
                          ...
                          children: [
                            ...
                            ot
                              ? (0, J.jsx)(Zt, {
                                  ...
                                  onSelect: (e) => {
                                    r((t) =>
                                      he({ draft: t, threadId: e.threadId, title: e.title }),
                                    );
                                  },
                                })
                              : (0, J.jsx)(Be, {
      ...
      if (V === `dialog`) {
        ...
        t[104] === l
          ? (c = t[105])
          : ((c = l ? void 0 : { height: `auto` }), (t[104] = l), (t[105] = c));
        let u;
...
function zt(e) {
  ...
  if (
    ...
    let F = g ? (r.intervalMinutes ?? 30) : r.intervalHours,
      I;
    t[28] !== F || t[29] !== f || t[30] !== g
      ? ((I = g
          ? F === 1
            ? f.formatMessage({
    ...
    y = ve;
    let B;
    t[35] === a ? (B = t[36]) : ((B = b(`min-w-0`, a)), (t[35] = a), (t[36] = B));
    let te;
    t[37] === u
      ? (te = t[38])
      : ((te = u ? (0, J.jsx)(A, { className: `icon-xs shrink-0` }) : null),
        (t[37] = u),
        (t[38] = te));
    let ne;
    t[39] === m
            ...
            n === `hourly` && P
              ? (0, J.jsxs)(`label`, {
                  ...
                  children: [
                    ...
                    (0, J.jsx)(`span`, { className: `shrink-0`, children: L }),
                  ],
                })
              : null),
          (t[54] = z),
  ...
  t[76] !== j ||
  t[77] !== M
    ? ((I = (0, J.jsxs)(`div`, { className: E, children: [D, O, j, M, P, F] })),
      (t[71] = P),
      (t[72] = F),
      (t[73] = E),
      (t[74] = D),
    ...
    : (I = t[78]);
  let L;
  t[79] !== _ || t[80] !== C || t[81] !== w || t[82] !== I
    ? ((L = (0, J.jsx)(_, { align: C, className: w, children: I })),
      (t[79] = _),
      (t[80] = C),
      (t[81] = w),
      (t[82] = I),
  ...
  let R;
  return (
    t[84] !== y || t[85] !== T || t[86] !== L
      ? ((R = (0, J.jsxs)(y, { children: [T, L] })),
        (t[84] = y),
        (t[85] = T),
        (t[86] = L),
        (t[87] = R))
...
function Bt(e) {
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = () => {
      ...
      (y = (0, J.jsx)(A, { className: `icon-2xs` })),
      (t[14] = v),
      (t[15] = y))
    : ((v = t[14]), (y = t[15]));
  let S;
  t[16] !== a || t[17] !== _ || t[18] !== f
    ? ((S = (0, J.jsx)(x, {
        "aria-label": f,
        "aria-expanded": a,
        color: _,
...
function Jt(e) {
  let t = (0, q.c)(34),
    ...
    { data: m } = O(),
    h;
  t[0] === p.locale ? (h = t[1]) : ((h = P(p.locale)), (t[0] = p.locale), (t[1] = h));
  let _ = h,
    y = m?.models == null,
    C;
  t[2] === p
  ...
  t[13] === f
    ? (D = t[14])
    : ((D = f
        ? (0, J.jsx)(k, { className: `icon-2xs shrink-0 text-token-input-placeholder-foreground` })
        : null),
      (t[13] = f),
      (t[14] = D));
  let A;
  t[15] !== E || t[16] !== D || t[17] !== C || t[18] !== w || t[19] !== T
    ? ((A = (0, J.jsxs)(x, {
        "aria-label": C,
        size: `composerSm`,
        color: `ghost`,
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (j = t[21]);
  let M;
  t[22] !== m?.models || t[23] !== c || t[24] !== n || t[25] !== _
    ? ((M = m?.models.map((e) =>
        (0, J.jsx)(
          W.Item,
          {
            ...
            tooltipText: _ ? (e.description ?? void 0) : void 0,
            onSelect: () => {
              c(e.model);
            },
            children: (0, J.jsx)(`span`, {
...
function Yt(e) {
  ...
  if (t[0] !== w?.models || t[1] !== n || t[2] !== r) {
    let e = u({ model: h(w?.models ?? [], n), reasoningEffort: r });
    ((T = D(e) ? e : null), (t[0] = w?.models), (t[1] = n), (t[2] = r), (t[3] = T));
  } else T = t[3];
  let E = T,
    A = E == null ? ae : yt[E],
    j,
  ...
  if (
      ...
      : ((r =
          E == null
            ...
            : (0, J.jsx)(v, {
                ...
                values: { reasoning: (0, J.jsx)(Fe, { effort: E }) },
              })),
        (t[24] = E),
        (t[25] = r));
    let i = r,
    ...
    let c;
    t[30] !== A || t[31] !== p
      ? ((c = p ? (0, J.jsx)(A, { className: `icon-xs shrink-0` }) : null),
        (t[30] = A),
        (t[31] = p),
        (t[32] = c))
      : (c = t[32]);
    let u;
    t[33] !== y || t[34] !== E || t[35] !== f
      ? ((u = f
          ? (0, J.jsx)(`span`, {
              className: `truncate text-left text-token-foreground`,
              children:
    ...
    t[37] === _
      ...
      : ((h = _
        ...
        (t[38] = h));
    let g;
    t[39] !== o || t[40] !== s || t[41] !== c || t[42] !== u || t[43] !== h
      ? ((g = (0, J.jsxs)(x, {
          "aria-label": o,
          size: `composerSm`,
          color: `ghost`,
    ...
    ((M = G),
      ...
      (z = `sm`),
      (N = n == null || e.length === 0),
      t[45] !== i || t[46] !== f || t[47] !== T
        ? ((P = f ? T : (0, J.jsx)(C, { tooltipContent: i, children: T })),
          (t[45] = i),
          (t[46] = f),
          (t[47] = T),
          (t[48] = P))
      ...
      t[49] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        : (F = t[49]),
      (j = W.Section),
      (I = `flex flex-col [--edge-fade-distance:1.5rem]`));
    let D;
    (t[50] !== l || t[51] !== E
      ? ((D = (e) => {
          ...
          return (0, J.jsx)(
            ...
            {
              LeftIcon: t,
              RightIcon: e.reasoningEffort === E ? S : void 0,
              onSelect: () => {
                l(e.reasoningEffort);
              },
    ...
    ((j = t[15]),
      ...
      (z = t[23]));
  let ee;
  t[53] !== j || t[54] !== I || t[55] !== L
    ? ((ee = (0, J.jsx)(j, { className: I, children: L })),
      (t[53] = j),
      (t[54] = I),
      (t[55] = L),
      (t[56] = ee))
...
function Zt(e) {
  ...
  t[10] === d
    ? (E = t[11])
    : ((E = d ? (0, J.jsx)(le, { className: `icon-xs shrink-0` }) : null),
      (t[10] = d),
      (t[11] = E));
  let D;
  t[12] === C
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (O = t[14]);
  let A;
  t[15] !== m || t[16] !== w || t[17] !== T || t[18] !== E || t[19] !== D
    ? ((A = (0, J.jsxs)(x, {
        "aria-label": w,
        size: `composerSm`,
        color: `ghost`,
...
function Qt(e) {
  ...
  if (
    ...
    let i = Tt.filter(e),
      ...
      D;
    t[18] === a ? (D = t[19]) : ((D = b(`min-w-0`, a)), (t[18] = a), (t[19] = D));
    let O = f ? (0, J.jsx)(s, { className: `icon-xs shrink-0` }) : null,
      A = d
        ? (0, J.jsx)(`span`, {
            className: `truncate text-left text-token-foreground`,
    ...
    ((m = G),
      (w = u),
      (T = `sm`),
      (E = d ? N : (0, J.jsx)(C, { tooltipContent: g, children: N })),
      (h = `flex flex-col`),
    ...
    (t[27] !== p || t[28] !== l || t[29] !== n
      ...
      (t[14] = T),
      (t[15] = E));
  } else ((m = t[9]), (h = t[10]), (_ = t[11]), (y = t[12]), (w = t[13]), (T = t[14]), (E = t[15]));
  let D;
  t[31] !== h || t[32] !== _ || t[33] !== y
    ? ((D = (0, J.jsxs)(`div`, { className: h, children: [_, y] })),
      (t[31] = h),
      (t[32] = _),
      (t[33] = y),
      (t[34] = D))
  ...
  let O;
  return (
    t[35] !== m || t[36] !== D || t[37] !== w || t[38] !== T || t[39] !== E
      ? ((O = (0, J.jsx)(m, { align: w, contentWidth: T, triggerButton: E, children: D })),
        (t[35] = m),
        (t[36] = D),
        (t[37] = w),
        (t[38] = T),
...
function $t(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, J.jsx)(k, { className: `icon-xxs shrink-0 text-token-description-foreground` })),
      (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] !== n || t[6] !== c || t[7] !== l
