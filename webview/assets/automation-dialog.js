...
import { Mi as t, Ni as n, Oi as r, Qr as i, Ti as a, ji as o, ki as s } from "./src-2.js";
import { Ei as c, Wo as l, v as u } from "./app-server-manager-signals.js";
import { n as d, t as f } from "./jsx-runtime.js";
import { t as p } from "./clsx.js";
import { I as m, P as h, lt as g } from "./vscode-api.js";
import { c as _, n as v, o as y, r as b } from "./lib-2.js";
import { o as x } from "./statsig.js";
import { c as S } from "./app-server-manager-hooks.js";
import { w as C } from "./config-queries.js";
import { f as w } from "./apps-queries.js";
import { t as T } from "./tooltip.js";
import { t as E } from "./button.js";
import { n as D } from "./model-queries.js";
import { m as O } from "./use-plugins.js";
import { t as k } from "./info.js";
import { i as A } from "./locale-resolver.js";
import { t as j, u as M } from "./use-native-apps.electron.js";
import { a as N, i as P, l as F, n as I, r as L, t as ee } from "./dialog-layout.js";
...
import { t as H } from "./pinned-threads-query.js";
import { _ as oe } from "./links.js";
import {
  f as se,
  g as ce,
  h as le,
...
import { i as ge, n as _e, t as G } from "./popover.js";
import { t as K } from "./chevron.js";
import { t as ve } from "./worktree.js";
import { n as ye } from "./format-automation-next-run-label.js";
import { t as be } from "./automation-queries.js";
import { t as xe } from "./laptop.js";
import { i as Se, n as Ce, o as we, r as Te, t as Ee } from "./composer-controller.js";
import { r as De } from "./use-composer-controller.js";
import { t as Oe } from "./model-and-reasoning-effort-translations.js";
import { t as ke } from "./at-mention-list-1.js";
import { a as Ae, d as je, f as Me, l as Ne, n as Pe, s as Fe } from "./automation-schedule.js";
import { n as Ie, t as Le } from "./conversation-starter-card.js";
import { n as Re } from "./home-use-cases-data.js";
import { n as ze, t as Be } from "./project-dropdown-options.js";
import { t as Ve } from "./anchored-autocomplete-overlay.js";
function He(e) {
  let t = r(e ?? []);
  return t == null
    ? { model: a, reasoningEffort: null, profile: null, isLoading: !0 }
    : {
        model: t.model,
        reasoningEffort: o({ model: t, reasoningEffort: null }),
        profile: null,
        isLoading: !1,
      };
}
...
function We(e) {
  ...
  if (t[0] !== n || t[1] !== i) {
    ...
    bb0: {
      let { missingRequirements: e } = de(n);
      if (e.length === 0) {
        o = null;
        break bb0;
      }
  ...
  t[0] !== a || t[1] !== n
    ? ((s = Xe.map((e) =>
        (0, J.jsx)(
          ...
          {
            className: `w-full`,
            icon: (0, J.jsx)(Le, { name: e.iconName }),
            mode: `local`,
            onSelect: (t) => {
              n({
...
function $e(e) {
  ...
  let l = s,
    u,
    d;
  if (t[5] !== l || t[6] !== o || t[7] !== a?.threadIds || t[8] !== e) {
    let n = new Map((o ?? []).filter(nt).map(tt)),
      r = a?.threadIds ?? [],
      s = new Set(r),
      f = r.flatMap((e) => {
        let t = n.get(e);
  ...
  return (
    t[11] !== u || t[12] !== d
      ? ((f = { options: u, hasPinnedThreads: d }), (t[11] = u), (t[12] = d), (t[13] = f))
      : (f = t[13]),
    f
  );
}
...
var ot = `flex flex-col gap-2`,
  ...
  ht = 260,
  gt = 208,
  _t = { none: ae, minimal: ae, low: ie, medium: V, high: ne, xhigh: z },
  vt = [
    {
      id: `hourly`,
      labelMessage: v({
  ...
  St = Array.from({ length: bt / xt }, (e, t) => {
    let n = t * xt;
    return Fe(Math.floor(n / 60), n % 60);
  }),
  Ct = [
    {
      id: `local`,
...
function At(e) {
  let t = (0, q.c)(110),
    ...
    [W] = (0, Q.useState)(Pt),
    ge;
  t[0] === n ? (ge = t[1]) : ((ge = me(n)), (t[0] = n), (t[1] = ge));
  let _e = ge,
    G = n.cwds.length > 0 && !_e ? n.cwds : f,
    K = Te(W),
    ve = Ce(W),
    ye;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ye = t[2]);
  let be = w(ye),
    { availablePlugins: xe } = O(l, G),
    Ee;
  t[3] === xe ? (Ee = t[4]) : ((Ee = M(xe)), (t[3] = xe), (t[4] = Ee));
  let Oe = Ee != null,
    Ae;
  t[5] === Oe ? (Ae = t[6]) : ((Ae = { enabled: Oe }), (t[5] = Oe), (t[6] = Ae));
  let { nativeApps: je } = j(Ae),
    { skills: Me } = te(G),
    Ne,
    Pe;
  (t[7] !== be || t[8] !== xe || t[9] !== Me || t[10] !== je || t[11] !== W
    ? ((Pe = () => {
        W.syncMentionMetadata({ skills: Me, apps: be, plugins: xe, nativeApps: je });
      }),
      (Ne = [be, xe, Me, je, W]),
      (t[7] = be),
      (t[8] = xe),
  ...
  let Ue = He,
    Ge,
    Y;
  if (t[23] !== g || t[24] !== H || t[25] !== f || t[26] !== v) {
    let e;
    t[29] === g
      ? (e = t[30])
    ...
    (t[31] === H
      ...
      : ((r = H.formatMessage({
        ...
        (t[32] = r)),
      (Y = r),
      (Ge = Be({ workspaceGroups: v, roots: n, formatRootLabel: g })),
      (t[23] = g),
      (t[24] = H),
      (t[25] = f),
      (t[26] = v),
  ...
  let Z = X,
    ...
    rt = nt.mode,
    it;
  t[35] !== i || t[36] !== n || t[37] !== a
    ? ((it = i ? null : (0, J.jsx)(We, { draft: n, action: a ? `save` : `create` })),
      (t[35] = i),
      (t[36] = n),
      (t[37] = a),
      (t[38] = it))
  ...
  let at = it,
    $ = n.kind === `heartbeat`,
    st;
  t[39] === n ? (st = t[40]) : ((st = se(n)), (t[39] = n), (t[40] = st));
  let dt = st,
    ft = ue({ allowThreadDestination: Xe }),
    pt;
  t[41] === r
    ? (pt = t[42])
    : ((pt = (e) => {
  ...
  let mt = pt,
    ht = V === `dialog` ? N : `div`,
    gt = V === `dialog` ? I : `div`,
    _t = V === `dialog` ? void 0 : `flex flex-col gap-4`,
    vt = ae ? ut : V === `dialog` ? ct : lt,
    yt;
  t[43] !== he || t[44] !== n.name || t[45] !== r
    ? ((yt = (e) =>
        (0, J.jsx)(Tt, {
          id: he,
          autoFocus: e,
  ...
  if (
    ...
    bb0: {
          ...
          children: (0, J.jsxs)(gt, {
            ...
            children: [
              ...
              V === `dialog` && !a && U
                ...
                : null,
              U && V !== `dialog` ? (0, J.jsx)(ht, { className: ot, children: bt(!a) }) : null,
              (0, J.jsx)(ht, {
                className: ot,
                children: (0, J.jsxs)(`div`, {
                  ref: de,
                          ...
                          children: [
                            ...
                            $
                              ? (0, J.jsx)(Yt, {
                                  ...
                                  onSelect: (e) => {
                                    r((t) =>
                                      pe({ draft: t, threadId: e.threadId, title: e.title }),
                                    );
                                  },
                                })
                              : (0, J.jsx)(ze, {
      ...
      if (V === `dialog`) {
        ...
        t[104] === a
          ? (l = t[105])
          : ((l = a ? void 0 : { height: `auto` }), (t[104] = a), (t[105] = l));
        let u;
        (t[106] !== s || t[107] !== c || t[108] !== l
          ? ((u = { onEscapeKeyDown: s, onPointerDownOutside: c, style: l }),
            (t[106] = s),
            (t[107] = c),
            (t[108] = l),
            (t[109] = u))
          ...
          (Ot = (0, J.jsx)(Dt, {
            ...
            onOpenChange: R ?? Mt,
            size: ie,
            dialogCloseClassName: a ? void 0 : `top-[22px]`,
            contentProps: u,
            children: a
              ? e()
              : (0, J.jsx)(kt, {
                  composer: e,
                  onSelectTemplateDraft: o,
...
function Rt(e) {
  ...
  if (
    ...
    t[37] === u
      ? (R = t[38])
      : ((R = u ? (0, J.jsx)(he, { className: `icon-xs shrink-0` }) : null),
        (t[37] = u),
        (t[38] = R));
    let z;
    t[39] === h
...
function zt(e) {
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = () => {
      ...
      (b = (0, J.jsx)(he, { className: `icon-2xs` })),
      (t[14] = y),
      (t[15] = b))
    : ((y = t[14]), (b = t[15]));
  let x;
...
function Wt(e) {
  ...
  return Fe(Math.floor(r / 60), r % 60);
}
function Gt(e, t) {
  let n = Ne(e);
  return n
...
function qt(e) {
  ...
  t[6] === d
    ? (C = t[7])
    : ((C = d ? (0, J.jsx)(B, { className: `icon-xs shrink-0` }) : null), (t[6] = d), (t[7] = C));
  let w;
...
function Jt(e) {
  let n = (0, q.c)(65),
    ...
    { data: x } = D(),
    S;
  n[0] !== x?.models || n[1] !== r || n[2] !== i
    ? ((S = o({ model: s(x?.models ?? [], r), reasoningEffort: i })),
      (n[0] = x?.models),
      (n[1] = r),
      (n[2] = i),
      (n[3] = S))
  ...
  if (
      ...
      : ((i =
          C == null
            ...
            : (0, J.jsx)(y, {
                ...
                values: { reasoning: (0, J.jsx)(Oe, { effort: C }) },
              })),
        (n[24] = C),
        (n[25] = i));
    let a = i,
    ...
    n[26] === b
      ...
      : ((o = b.formatMessage({
        ...
        (n[27] = o));
    let s;
    n[28] === c ? (s = n[29]) : ((s = p(`min-w-0`, c)), (n[28] = c), (n[29] = s));
    let l;
    n[30] !== w || n[31] !== g
    ...
    n[37] === v
      ...
      : ((d = v
        ...
        (n[38] = d));
    let _;
    n[39] !== o || n[40] !== s || n[41] !== l || n[42] !== u || n[43] !== d
      ? ((_ = (0, J.jsxs)(E, {
          "aria-label": o,
          size: `composerSm`,
          color: `ghost`,
    ...
    ((k = W),
      ...
      (I = `sm`),
      (A = r == null || e.length === 0),
      n[45] !== a || n[46] !== h || n[47] !== S
        ? ((j = h ? S : (0, J.jsx)(T, { tooltipContent: a, children: S })),
          (n[45] = a),
          (n[46] = h),
          (n[47] = S),
          (n[48] = j))
      ...
      ? ((D = (e) => {
          ...
          return (0, J.jsx)(
            U.Item,
            {
              ...
              children: (0, J.jsx)(Oe, { effort: e.reasoningEffort }),
            },
            e.reasoningEffort,
          );
        }),
...
function Yt(e) {
  ...
  t[10] === d
    ? (w = t[11])
    : ((w = d ? (0, J.jsx)(ye, { className: `icon-xs shrink-0` }) : null),
      (t[10] = d),
      (t[11] = w));
  let T;
  t[12] === x
