...
import { Lr as o, _i as s, gi as c, mi as l, pi as u, ui as d, vi as f } from "./src-4.js";
import { ji as p, us as m, v as h } from "./app-server-manager-signals.js";
import { c as g, n as _, o as v, r as y } from "./lib-1.js";
import { t as b } from "./clsx.js";
import { t as x } from "./button.js";
import { t as S } from "./check-md.js";
import { t as C } from "./tooltip.js";
import { o as w } from "./statsig-DoZ-0xit.js";
import { c as T } from "./app-server-manager-hooks.js";
import { w as E } from "./config-queries-BHYT-TjG.js";
import { i as D } from "./models-and-reasoning-efforts.js";
import { n as O } from "./model-queries.js";
import { t as k } from "./clock.js";
import { f as A } from "./apps-queries.js";
import { m as j } from "./use-plugins.js";
import { t as M } from "./info.js";
import { a as N } from "./locale-resolver.js";
import { s as P, t as F } from "./use-native-apps.electron.js";
import { a as I, i as L, l as R, n as ee, r as z, t as te } from "./dialog-layout.js";
import { n as ne } from "./use-skills.js";
import { a as re, c as ie, i as B, n as ae, r as oe, t as V } from "./reasoning-minimal.js";
...
import { i as ve, n as W, t as G } from "./popover.js";
...
import { i as ke, n as Ae, o as je, r as Me, t as Ne } from "./composer-controller.js";
...
function Ue(e) {
  let t = u(e ?? []);
  return t == null
    ? { model: d, reasoningEffort: null, profile: null, isLoading: !0 }
    : {
        model: t.model,
        reasoningEffort: c({ model: t, reasoningEffort: null }),
        profile: null,
        isLoading: !1,
      };
}
function We({ model: e, models: t }) {
  let n = l(t ?? [], e);
  return n?.displayName ? ie(n.displayName) : (e ?? ``);
}
var q = r(),
  J = n();
function Ge(e) {
...
function et(e) {
  ...
  return (
    t[11] !== l || t[12] !== u
      ? ((d = { options: l, hasPinnedThreads: u }), (t[11] = l), (t[12] = u), (t[13] = d))
      : (d = t[13]),
    d
  );
}
...
var st = `flex flex-col gap-2`,
  ...
  _t = 260,
  vt = 208,
  yt = { none: V, minimal: V, low: oe, medium: ae, high: B, xhigh: re, max: re },
  bt = [
    {
      id: `hourly`,
      labelMessage: _({
...
function jt(e) {
  let t = (0, q.c)(110),
    {
      ...
      open: k,
      onOpenChange: M,
      forceShowNameInput: N,
      dialogSize: R,
      expandPrompt: re,
      allowedKinds: ie,
    } = e,
    B = D === void 0 ? `inline` : D,
    ae = R === void 0 ? `xxwide` : R,
    oe = re === void 0 ? !1 : re,
    V = g(),
    se = (0, Q.useRef)(null),
    ce = (0, Q.useRef)(null),
    ...
    [H] = (0, Q.useState)(Ft),
    U;
  t[0] === n ? (U = t[1]) : ((U = _e(n)), (t[0] = n), (t[1] = U));
  let ve = U,
    W = n.cwds.length > 0 && !ve ? n.cwds : f,
    G = Me(H),
    K = Ae(H),
    ye;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ye = t[2]);
  let be = A(ye),
    { availablePlugins: xe } = j(m, W),
    Se;
  t[3] === xe ? (Se = t[4]) : ((Se = P(xe)), (t[3] = xe), (t[4] = Se));
  let Ce = Se != null,
    we;
  t[5] === Ce ? (we = t[6]) : ((we = { enabled: Ce }), (t[5] = Ce), (t[6] = we));
  let { nativeApps: Te } = F(we),
    { skills: Ee } = ne(W),
    De,
    Oe;
  (t[7] !== be || t[8] !== xe || t[9] !== Ee || t[10] !== Te || t[11] !== H
    ? ((Oe = () => {
        H.syncMentionMetadata({ skills: Ee, apps: be, plugins: xe, nativeApps: Te });
      }),
      (De = [be, xe, Ee, Te, H]),
      (t[7] = be),
      (t[8] = xe),
  ...
  let Ue = ze,
    We,
    Ke;
  if (t[23] !== p || t[24] !== V || t[25] !== f || t[26] !== _) {
    let e;
    t[29] === p
      ? (e = t[30])
      : ((e = (e, t) => p(e).localeCompare(p(t))), (t[29] = p), (t[30] = e));
    let n = [...f].sort(e),
      r;
    (t[31] === V
      ? (r = t[32])
      : ((r = V.formatMessage({
        ...
        (t[32] = r)),
      (Ke = r),
      (We = Ve({ workspaceGroups: _, roots: n, formatRootLabel: p })),
      (t[23] = p),
      (t[24] = V),
      (t[25] = f),
      (t[26] = _),
  ...
  t[35] !== o || t[36] !== n || t[37] !== s
    ? ((it = o ? null : (0, J.jsx)(Ge, { draft: n, action: s ? `save` : `create` })),
      (t[35] = o),
      (t[36] = n),
      (t[37] = s),
      (t[38] = it))
  ...
  let ht = mt,
    gt = B === `dialog` ? I : `div`,
    _t = B === `dialog` ? ee : `div`,
    vt = B === `dialog` ? void 0 : `flex flex-col gap-4`,
    yt = oe ? ft : B === `dialog` ? ut : dt,
    bt;
  t[43] !== le || t[44] !== n.name || t[45] !== r
    ? ((bt = (e) =>
        (0, J.jsx)(Et, {
          id: le,
          autoFocus: e,
  ...
  if (
    ...
    t[72] !== Z?.models ||
    t[73] !== G.addMention ||
    t[74] !== G.closeAutocomplete ||
    t[75] !== G.handleMentionEvent ||
    t[76] !== G.setSelectedMention ||
    t[77] !== G.ui ||
    t[78] !== W ||
    t[79] !== S ||
    t[80] !== d ||
          ...
          children: (0, J.jsxs)(_t, {
            ...
            children: [
              ...
              B === `dialog` && !s && me
                ...
                : null,
              me && B !== `dialog` ? (0, J.jsx)(gt, { className: st, children: xt(!s) }) : null,
              (0, J.jsx)(gt, {
                className: st,
                children: (0, J.jsxs)(`div`, {
                  ref: ce,
                  ...
                  children: [
                    ...
                    (0, J.jsx)(je, {
                      ...
                      onSkillMentionHandler: K.handleMentionEvent,
                      onSubmit: Ue,
                    }),
                  ],
                }),
...
function zt(e) {
  ...
  if (
    ...
    let P = g ? (r.intervalMinutes ?? 30) : r.intervalHours,
      F;
    t[28] !== P || t[29] !== f || t[30] !== g
      ? ((F = g
          ? P === 1
            ? f.formatMessage({
    ...
    y = G;
    let z;
    t[35] === a ? (z = t[36]) : ((z = b(`min-w-0`, a)), (t[35] = a), (t[36] = z));
    let te;
    t[37] === u
      ? (te = t[38])
      : ((te = u ? (0, J.jsx)(k, { className: `icon-xs shrink-0` }) : null),
        (t[37] = u),
        (t[38] = te));
    let ne;
    t[39] === m
  ...
  t[76] !== A ||
  t[77] !== j
    ? ((F = (0, J.jsxs)(`div`, { className: E, children: [D, O, A, j, N, P] })),
      (t[71] = N),
      (t[72] = P),
      (t[73] = E),
      (t[74] = D),
    ...
    : (F = t[78]);
  let I;
  t[79] !== _ || t[80] !== C || t[81] !== w || t[82] !== F
    ? ((I = (0, J.jsx)(_, { align: C, className: w, children: F })),
      (t[79] = _),
      (t[80] = C),
      (t[81] = w),
      (t[82] = F),
  ...
  let L;
  return (
    t[84] !== y || t[85] !== T || t[86] !== I
      ? ((L = (0, J.jsxs)(y, { children: [T, I] })),
        (t[84] = y),
        (t[85] = T),
        (t[86] = I),
        (t[87] = L))
...
function Bt(e) {
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = () => {
      ...
      (y = (0, J.jsx)(k, { className: `icon-2xs` })),
      (t[14] = v),
      (t[15] = y))
    : ((v = t[14]), (y = t[15]));
  let S;
...
function Jt(e) {
  let t = (0, q.c)(34),
    ...
    { data: m } = O(),
    h;
  t[0] === p.locale ? (h = t[1]) : ((h = N(p.locale)), (t[0] = p.locale), (t[1] = h));
  let _ = h,
    y = m?.models == null,
    C;
  t[2] === p
    ...
    ? ((j = m?.models.map((e) =>
        (0, J.jsx)(
          H.Item,
          {
            ...
            children: (0, J.jsx)(`span`, {
              className: `truncate`,
              children: ie(e.displayName || e.model),
            }),
          },
          e.model,
        ),
...
function Yt(e) {
  ...
  if (t[0] !== w?.models || t[1] !== n || t[2] !== r) {
    let e = c({ model: l(w?.models ?? [], n), reasoningEffort: r });
  ...
  if (
    ...
    t[26] === y
      ...
      : ((o = y.formatMessage({
        ...
        (t[27] = o));
    let c;
    t[28] === a ? (c = t[29]) : ((c = b(`min-w-0`, a)), (t[28] = a), (t[29] = c));
    let l;
    t[30] !== k || t[31] !== h
      ? ((l = h ? (0, J.jsx)(k, { className: `icon-xs shrink-0` }) : null),
        (t[30] = k),
        (t[31] = h),
        (t[32] = l))
      : (l = t[32]);
    let u;
    t[33] !== y || t[34] !== E || t[35] !== m
      ? ((u = m
          ? (0, J.jsx)(`span`, {
              className: `truncate text-left text-token-foreground`,
              children:
    ...
    t[37] === _
      ...
      : ((d = _
        ...
        (t[38] = d));
    let g;
    t[39] !== o || t[40] !== c || t[41] !== l || t[42] !== u || t[43] !== d
      ? ((g = (0, J.jsxs)(x, {
          "aria-label": o,
          size: `composerSm`,
          color: `ghost`,
  ...
  t[53] !== A || t[54] !== F || t[55] !== I
    ? ((ee = (0, J.jsx)(A, { className: F, children: I })),
      (t[53] = A),
      (t[54] = F),
      (t[55] = I),
      (t[56] = ee))
...
function Qt(e) {
  ...
  if (
    ...
    ((m = U),
      (w = u),
      (T = `sm`),
      (E = d ? M : (0, J.jsx)(C, { tooltipContent: g, children: M })),
      (h = `flex flex-col`),
