...
import { U as o, r as s } from "./use-host-config-C.js";
import { M as c } from "./thread-context-inputs.js";
import { Bi as l, ai as u, zi as d } from "./src-1.js";
import { i as f, l as p, r as m, s as h } from "./lib-1.js";
import { t as g } from "./clsx.js";
import { t as _ } from "./button.js";
import { t as v } from "./check-md.js";
import { t as y } from "./tooltip-B.js";
import { o as b } from "./statsig.js";
import { t as x } from "./chevron.js";
import { t as S } from "./clock-Cid-cc8u.js";
import { c as C } from "./app-server-manager-hooks.js";
import { C as w } from "./config-queries.js";
import { i as T } from "./models-and-reasoning-efforts.js";
import { n as E } from "./model-queries.js";
import { m as D } from "./use-plugins.js";
import { f as O } from "./apps-queries.js";
import { t as k } from "./info.js";
import { s as A, t as j } from "./use-native-apps.electron.js";
import { a as M, i as N, l as P, n as F, r as I, t as L } from "./dialog-layout.js";
import { n as R } from "./use-skills.js";
import { t as ee } from "./pinned-threads-query.js";
import { v as te } from "./links.js";
import { r as ne, t as z } from "./dropdown.js";
import { t as B } from "./worktree.js";
import { i as re, n as V, t as ie } from "./popover.js";
import {
  a as H,
  d as ae,
  f as oe,
...
import { t as K } from "./pin.js";
import { t as ge } from "./laptop.js";
import { a as _e, c as ve, i as ye, n as be, r as xe, t as Se } from "./composer-controller.js";
import { i as Ce } from "./use-composer-controller.js";
import { t as q } from "./model-and-reasoning-effort-translations.js";
import { n as we, t as Te } from "./model-and-reasoning-dropdown.js";
import { t as Ee } from "./at-mention-list.js";
import { n as De, t as Oe } from "./conversation-starter-card-D5-kwyZS.js";
import { n as ke } from "./home-use-cases-data.js";
import { n as Ae, t as je } from "./project-dropdown-options.js";
  ...
  if (t[0] !== n || t[1] !== i) {
    ...
    bb0: {
      ...
      t[4] === i
        ? (r = t[5])
        : ((r = (e, t) =>
            Fe({ intl: i, requirement: e, position: t === 0 ? `initial` : `continuation` })),
          (t[4] = i),
          (t[5] = r));
      let s = e.map(r);
...
function Fe({ intl: e, requirement: t, position: n }) {
  switch (t) {
    case `name`:
      return n === `initial`
        ? e.formatMessage({
...
var Q = f({
  ...
  Le = Z({ mode: `daily`, weekdays: X, time: `09:00` }),
  Re = new Map([
  ...
  ze = new Map([
    ...
    [`weekly-release-notes`, Z({ mode: `weekly`, weekdays: [`FR`], time: `09:00` })],
    [`daily-standup`, Z({ mode: `weekdays`, weekdays: Ie, time: `09:00` })],
    [`nightly-ci-report`, Z({ mode: `daily`, weekdays: X, time: `21:00` })],
    [`daily-classic-game`, Z({ mode: `daily`, weekdays: X, time: `14:00` })],
    [`skill-progression-map`, Z({ mode: `weekly`, weekdays: [`FR`], time: `10:00` })],
    [`weekly-engineering-summary`, Z({ mode: `weekly`, weekdays: [`FR`], time: `16:00` })],
    [`performance-regression-watch`, Z({ mode: `daily`, weekdays: X, time: `09:00` })],
    [`dependency-sdk-drift`, Z({ mode: `daily`, weekdays: X, time: `11:00` })],
    [`test-gap-detection`, Z({ mode: `daily`, weekdays: X, time: `15:00` })],
    [`pre-release-check`, Z({ mode: `weekly`, weekdays: [`TH`], time: `13:00` })],
    [`agents-docs-sync`, Z({ mode: `weekly`, weekdays: [`FR`], time: `11:00` })],
    [`weekly-pr-summary`, Z({ mode: `weekly`, weekdays: [`MO`], time: `09:00` })],
    [`issue-triage`, Z({ mode: `weekdays`, weekdays: Ie, time: `09:30` })],
    [
      `ci-monitor`,
      Z({
        mode: `custom`,
    ...
    [`performance-audit`, Z({ mode: `weekly`, weekdays: [`MO`], time: `14:00` })],
    [`changelog-update`, Z({ mode: `weekly`, weekdays: [`FR`], time: `16:00` })],
  ]),
  Be = ke().map((e) => ({
    id: e.id,
    iconName: e.iconName,
    nameMessage: Re.get(e.id) ?? Q.defaultDraftName,
    promptMessage: e.automationPromptMessage ?? e.promptMessage,
    scheduleConfig: ze.get(e.id) ?? Le,
  }));
function Ve(e) {
  let t = (0, J.c)(6),
  ...
  t[0] !== a || t[1] !== n
    ? ((s = Be.map((e) =>
        (0, Y.jsx)(
          ...
          {
            className: `w-full`,
            icon: (0, Y.jsx)(Oe, { name: e.iconName }),
            mode: `local`,
            onSelect: (t) => {
              n({
  ...
  return (
    t[3] !== o || t[4] !== s
      ? ((c = (0, Y.jsx)(`div`, { className: o, children: s })), (t[3] = o), (t[4] = s), (t[5] = c))
      : (c = t[5]),
    c
  );
}
...
function Ue(e) {
  ...
  let c = s,
    d,
    f;
  if (t[5] !== c || t[6] !== i || t[7] !== r?.threadIds || t[8] !== e) {
    let n = new Map((i ?? []).filter(Ke).map(Ge)),
      a = r?.threadIds ?? [],
      s = new Set(a),
      l = a.flatMap((e) => {
        let t = n.get(e);
  ...
  return (
    t[11] !== d || t[12] !== f
      ? ((p = { options: d, hasPinnedThreads: f }), (t[11] = d), (t[12] = f), (t[13] = p))
      : (p = t[13]),
    p
  );
}
...
var Xe = `flex flex-col gap-2`,
  Ze = `bg-token-input-background text-token-input-foreground placeholder:text-token-input-placeholder-foreground w-full rounded-md border border-token-input-border px-2.5 py-1.5 text-base outline-none focus:border-token-focus-border`,
  Qe = `text-token-input-foreground placeholder:text-token-input-placeholder-foreground m-0 w-full min-w-0 appearance-none bg-transparent p-0 text-lg leading-tight outline-none`,
  $e = g(
  ...
  lt = [
    ...
    ...ct.filter((e) => e.id !== `hourly`),
  ],
  ut = 1440,
  dt = 15,
  ft = Array.from({ length: ut / dt }, (e, t) => {
    let n = t * dt;
    return W(Math.floor(n / 60), n % 60);
  }),
  pt = [
    {
      id: `local`,
...
function gt(e) {
  let t = (0, J.c)(11),
    ...
    a;
  t[0] !== r || t[1] !== n
    ? ((a = (0, Y.jsx)(Tt, { isReadOnlySandbox: n, isDangerFullAccess: r })),
      (t[0] = r),
      (t[1] = n),
      (t[2] = a))
    : (a = t[2]);
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Y.jsx)(k, { className: `icon-sm` })), (t[5] = s))
    : (s = t[5]);
  let c;
  t[6] === o
    ? (c = t[7])
...
function _t(e) {
  ...
  t[0] === s
    ? (f = t[1])
    : ((f = g(`flex max-h-[95vh] flex-col overflow-hidden`, s)), (t[0] = s), (t[1] = f));
  let p;
  return (
    t[2] !== n ||
    t[3] !== c ||
...
function vt(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Y.jsx)(Ve, { columns: `two`, onSelectAction: n })), (t[0] = n), (t[1] = r)),
    r
  );
}
function yt(e) {
  ...
  t[8] !== u || t[9] !== s
    ? ((v = (e) => {
        ...
        return t
          ? (0, Y.jsx)(`div`, {
              className: g(`absolute top-5 z-20`, s ? `right-14` : `right-4`),
  ...
  let y;
  return (
    t[11] !== o || t[12] !== d || t[13] !== f || t[14] !== v
      ? ((y = (0, Y.jsx)(Ye, {
          initialOverlayOpen: o,
          baseContent: d,
          overlayContent: f,
          overlayHeader: m,
          overlayHeightOffset: rt,
          minHeight: nt,
          baseFadeDurationMs: it,
          sizeDurationMs: at,
          overlayFadeDurationMs: ot,
          overlayHeaderFadeDurationMs: st,
...
function bt(e) {
  let t = (0, J.c)(109),
    {
      ...
      open: E,
      onOpenChange: k,
      forceShowNameInput: P,
      dialogSize: ee,
      expandPrompt: te,
      allowedKinds: ne,
    } = e,
    z = T === void 0 ? `inline` : T,
    B = ee === void 0 ? `xxwide` : ee,
    re = te === void 0 ? !1 : te,
    V = p(),
    ie = (0, $.useRef)(null),
    H = (0, $.useRef)(null),
    ...
    [U] = (0, $.useState)(wt),
    se;
  t[0] === n ? (se = t[1]) : ((se = he(n)), (t[0] = n), (t[1] = se));
  let ce = se,
    W = n.cwds.length > 0 && !ce ? n.cwds : f,
    G = xe(U),
    K = be(U),
    ge;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ge = t[2]);
  let Se = O(ge),
    { availablePlugins: q } = D(s, W),
    we;
  t[3] === q ? (we = t[4]) : ((we = A(q)), (t[3] = q), (t[4] = we));
  let Te = we != null,
    De;
  t[5] === Te ? (De = t[6]) : ((De = { enabled: Te }), (t[5] = Te), (t[6] = De));
  let { nativeApps: Oe } = j(De),
    { skills: ke } = R(W),
    Ne,
    Fe;
  (t[7] !== Se || t[8] !== q || t[9] !== ke || t[10] !== Oe || t[11] !== U
    ? ((Fe = () => {
        U.syncMentionMetadata({ skills: ke, apps: Se, plugins: q, nativeApps: Oe });
      }),
      (Ne = [Se, q, ke, Oe, U]),
      (t[7] = Se),
      (t[8] = q),
  ...
  let Re = Le,
    ze,
    Be;
  if (t[23] !== m || t[24] !== V || t[25] !== f || t[26] !== v) {
    let e;
    t[29] === m
      ? (e = t[30])
    ...
    (t[31] === V
      ...
      : ((r = V.formatMessage({
        ...
        (t[32] = r)),
      (Be = r),
      (ze = je({ workspaceGroups: v, roots: n, formatRootLabel: m })),
      (t[23] = m),
      (t[24] = V),
      (t[25] = f),
      (t[26] = v),
  ...
  let We = He,
    { data: Ge } = i(w, a(c)),
    Ke = b(`1488233300`),
    qe = (ne ?? (Ke ? [`cron`, `heartbeat`] : [`cron`])).includes(`heartbeat`),
    { options: Je, hasPinnedThreads: Ye } = Ue(n.targetThreadId),
    Ze = Ge?.config.sandbox_mode === `read-only`,
    Qe = Ge?.config.sandbox_mode === `danger-full-access`,
    nt = n.scheduleConfig,
    rt = nt.mode,
    it;
  t[35] !== o || t[36] !== n || t[37] !== l
    ? ((it = o ? null : (0, Y.jsx)(Pe, { draft: n, action: l ? `save` : `create` })),
      (t[35] = o),
      (t[36] = n),
      (t[37] = l),
      (t[38] = it))
  ...
  let at = it,
    ot = n.kind === `heartbeat`,
    st;
  t[39] === n ? (st = t[40]) : ((st = le(n)), (t[39] = n), (t[40] = st));
  let ct = st,
    lt = fe({ allowThreadDestination: qe }),
    ut;
  t[41] === r
    ? (ut = t[42])
    : ((ut = (e) => {
  ...
  let dt = ut,
    ft = z === `dialog` ? M : `div`,
    pt = z === `dialog` ? F : `div`,
    mt = z === `dialog` ? void 0 : `flex flex-col gap-4`,
    vt = re ? tt : z === `dialog` ? $e : et,
    bt;
  t[43] !== ae || t[44] !== n.name || t[45] !== r
    ? ((bt = (e) =>
        (0, Y.jsx)(ht, {
          id: ae,
          autoFocus: e,
    ...
    : (bt = t[46]);
  let Tt = bt,
    Et = n.name.length > 0 || n.prompt.length > 0,
    Dt;
  t[47] === r
    ? (Dt = t[48])
    : ((Dt = () => {
  ...
  if (
    ...
    t[71] !== u ||
    t[72] !== G.addMention ||
    t[73] !== G.closeAutocomplete ||
    t[74] !== G.handleMentionEvent ||
    t[75] !== G.setSelectedMention ||
    t[76] !== G.ui ||
    t[77] !== W ||
    t[78] !== S ||
    t[79] !== d ||
    ...
    jt = Symbol.for(`react.early_return_sentinel`);
    bb0: {
      let e = (e) =>
        (0, Y.jsx)(`form`, {
          id: C,
              ...
              z === `dialog` && !l && oe
                ? (0, Y.jsx)(ft, {
                    ...
                    children: (0, Y.jsxs)(`div`, {
                      ...
                      children: [
                        (0, Y.jsx)(`div`, { className: `min-w-0 flex-1`, children: Tt(!0) }),
                        (0, Y.jsxs)(`div`, {
                          className: `flex items-center gap-2 pr-10`,
                          children: [
                            (0, Y.jsx)(gt, { isReadOnlySandbox: Ze, isDangerFullAccess: Qe }),
                            Et
                              ? (0, Y.jsx)(_, {
                                  color: `ghost`,
                                  size: `toolbar`,
                ...
                : null,
              oe && z !== `dialog` ? (0, Y.jsx)(ft, { className: Xe, children: Tt(!l) }) : null,
              (0, Y.jsx)(ft, {
                className: Xe,
                children: (0, Y.jsxs)(`div`, {
                  ref: H,
                  ...
                  children: [
                    ...
                    (0, Y.jsx)(ye, {
                      ...
                      onSuggestionHandler: (e) => {
                        _e(e, {
                          onAtMention: G.handleMentionEvent,
                          onSkillMention: K.handleMentionEvent,
                        });
                      },
                      onSubmit: Re,
                    }),
                          ...
                          children: [
                            ...
                            ot
                              ? (0, Y.jsx)(Rt, {
                                  ...
                                  onSelect: (e) => {
                                    r((t) =>
                                      me({ draft: t, threadId: e.threadId, title: e.title }),
                                    );
                                  },
                                })
                              : (0, Y.jsx)(Ae, {
      ...
      if (z === `dialog`) {
        ...
        t[103] === l
          ? (c = t[104])
          : ((c = l ? void 0 : { height: `auto` }), (t[103] = l), (t[104] = c));
        let u;
        (t[105] !== o || t[106] !== s || t[107] !== c
          ? ((u = { onEscapeKeyDown: o, onPointerDownOutside: s, style: c }),
            (t[105] = o),
            (t[106] = s),
            (t[107] = c),
            (t[108] = u))
          ...
          (jt = (0, Y.jsx)(_t, {
            ...
            onOpenChange: k ?? St,
            size: B,
            dialogCloseClassName: l ? void 0 : `top-[22px]`,
            contentProps: u,
            children: l
              ? e()
              : (0, Y.jsx)(yt, {
    ...
    ((t[49] = pt),
      ...
      (t[97] = At),
      (t[98] = jt));
  } else ((At = t[97]), (jt = t[98]));
  return jt === Symbol.for(`react.early_return_sentinel`) ? At : jt;
}
function xt(e) {
  e.preventDefault();
}
...
function Ot(e) {
  let t = (0, J.c)(88),
    ...
    m;
  t[0] !== f || t[1] !== r
    ? ((m = It({ scheduleConfig: r, intl: f })), (t[0] = f), (t[1] = r), (t[2] = m))
    : (m = t[2]);
  let v = m,
    y = r.weekdays[0] ?? mt[0].id,
    b,
    C,
    w,
    T,
  ...
  if (
    ...
    let o = d === `heartbeat`,
      ...
      m = o && n === `hourly`,
      P = n === `hourly` && o;
    w = n === `daily` || n === `weekdays` || n === `weekly`;
    let F = m ? (r.intervalMinutes ?? 30) : r.intervalHours,
      I;
    t[28] !== F || t[29] !== f || t[30] !== m
      ? ((I = m
          ? F === 1
            ? f.formatMessage({
    ...
    t[32] !== f || t[33] !== m
      ...
      : (R = t[34]);
    let ee = R,
      te = n === `custom` ? `!w-96 min-w-96` : o ? `!w-56 min-w-56` : `!w-40 min-w-40`;
    C = ie;
    let z;
    t[35] === a ? (z = t[36]) : ((z = g(`min-w-0`, a)), (t[35] = a), (t[36] = z));
    let B;
    t[37] === u
      ? (B = t[38])
      : ((B = u ? (0, Y.jsx)(S, { className: `icon-xs shrink-0` }) : null),
        (t[37] = u),
        (t[38] = B));
    let H;
    t[39] === v
                  ...
                  children: [
                    ...
                    (0, Y.jsx)(`input`, {
                      ...
                      onChange: (e) => {
                        ...
                        let n = ae(Number(t));
                        n != null && N({ intervalHours: n });
                      },
                      onBlur: (e) => {
                        e.currentTarget.value.length === 0 && (e.currentTarget.value = String(F));
                      },
                    }),
                    (0, Y.jsx)(`span`, { className: `shrink-0`, children: L }),
                  ],
                })
              : null),
          (t[54] = ee),
      ...
      (M =
        n === `weekly`
          ? (0, Y.jsx)(Bt, {
              ...
              className: `w-full`,
              options: mt.map((e) => ({ id: e.id, label: f.formatMessage(e.longLabelMessage) })),
              selectedId: e.id,
  ...
  t[62] !== r.time || t[63] !== w || t[64] !== N
    ...
    : (P = t[65]);
  let F;
  t[66] !== f || t[67] !== r.customRrule || t[68] !== n || t[69] !== N
    ? ((F =
        n === `custom`
          ? (0, Y.jsx)(`input`, {
              ...
              className: g(Ze, `w-full text-sm font-mono`),
              ...
              value: r.customRrule,
              onChange: (e) => {
                N({ customRrule: e.currentTarget.value });
              },
            })
          : null),
      (t[66] = f),
  ...
  t[76] !== j ||
  t[77] !== M
    ? ((I = (0, Y.jsxs)(`div`, { className: O, children: [k, A, j, M, P, F] })),
      (t[71] = P),
      (t[72] = F),
      (t[73] = O),
      (t[74] = k),
    ...
    : (I = t[78]);
  let L;
  t[79] !== b || t[80] !== T || t[81] !== E || t[82] !== I
    ? ((L = (0, Y.jsx)(b, { align: T, className: E, children: I })),
      (t[79] = b),
      (t[80] = T),
      (t[81] = E),
      (t[82] = I),
  ...
  let R;
  return (
    t[84] !== C || t[85] !== D || t[86] !== L
      ? ((R = (0, Y.jsxs)(C, { children: [D, L] })),
        (t[84] = C),
        (t[85] = D),
        (t[86] = L),
        (t[87] = R))
...
function kt(e) {
  let t = (0, J.c)(32),
    ...
    [a, o] = (0, $.useState)(!1),
    s;
  t[0] === n ? (s = t[1]) : ((s = Pt(n)), (t[0] = n), (t[1] = s));
  let c = s,
    l;
  t[2] === i
    ? (l = t[3])
  ...
  let f = d,
    m;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = g(Ze, `w-full !pr-8 text-sm [&::-webkit-calendar-picker-indicator]:hidden`)),
      (t[7] = m))
    : (m = t[7]);
  let h;
  t[8] === r
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = () => {
      ...
      (x = (0, Y.jsx)(S, { className: `icon-2xs` })),
      (t[14] = b),
      (t[15] = x))
    : ((b = t[14]), (x = t[15]));
  let C;
  t[16] !== a || t[17] !== y || t[18] !== f
    ? ((C = (0, Y.jsx)(_, {
        "aria-label": f,
        "aria-expanded": a,
        color: y,
  ...
  let w;
  t[20] !== C || t[21] !== v
    ? ((w = (0, Y.jsxs)(`div`, { className: `relative w-full`, children: [v, C] })),
      (t[20] = C),
      (t[21] = v),
      (t[22] = w))
    : (w = t[22]);
  ...
  return (
    t[29] !== w || t[30] !== T
      ? ((E = (0, Y.jsxs)(`div`, { className: `flex w-full flex-col gap-1`, children: [w, T] })),
        (t[29] = w),
        (t[30] = T),
        (t[31] = E))
      : (E = t[31]),
...
function Pt(e) {
  ...
  let n = t.hour * 60 + t.minute,
    r = (Math.floor(n / dt) * dt) % ut;
  return W(Math.floor(r / 60), r % 60);
}
function Ft(e, t) {
  let n = se(e);
  return n
...
function It({ scheduleConfig: e, intl: t }) {
  if (e.mode === `custom`)
...
function Lt(e) {
  let t = (0, J.c)(35),
    { selectedModel: n, reasoningEffort: r, align: i, className: a, onSelect: o } = e,
    s = i === void 0 ? `start` : i,
    c = p(),
    { data: l } = E(),
    u,
    f;
  if (t[0] !== l?.models || t[1] !== r || t[2] !== n) {
    u = l?.models.find((e) => e.model === n) ?? null;
    let e = d({ model: u, reasoningEffort: r });
    ((f = T(e) ? e : null), (t[0] = l?.models), (t[1] = r), (t[2] = n), (t[3] = u), (t[4] = f));
  } else ((u = t[3]), (f = t[4]));
  let m = f,
    h = n == null || l?.models == null,
    v = n ?? ``,
    y = l?.models,
    b;
  t[5] !== o || t[6] !== n
  ...
  t[8] === c
    ...
    : ((S = c.formatMessage({
      ...
      (t[9] = S));
  let C;
  t[10] === a ? (C = t[11]) : ((C = g(`min-w-0`, a)), (t[10] = a), (t[11] = C));
  let w;
  t[12] !== c || t[13] !== n || t[14] !== u?.displayName
    ? ((w =
        n != null && n.trim().length > 0
          ? (0, Y.jsx)(we, {
              model: n,
              displayName: u?.displayName ?? n,
  ...
  t[18] !== D || t[19] !== w
    ? ((O = (0, Y.jsxs)(`span`, {
        className: `flex max-w-48 min-w-0 items-center gap-1.5 text-left`,
        children: [w, D],
      })),
      (t[18] = D),
      (t[19] = w),
...
function Rt(e) {
  let t = (0, J.c)(41),
    ...
    b;
  t[0] !== r || t[1] !== n
    ? ((b = r.find((e) => e.threadId === n) ?? null), (t[0] = r), (t[1] = n), (t[2] = b))
    : (b = t[2]);
  let S = b,
    C;
  t[3] !== m || t[4] !== S?.title
  ...
  t[6] === m
    ...
    : ((T = m.formatMessage({
      ...
      (t[7] = T));
  let E;
  t[8] === o ? (E = t[9]) : ((E = g(`min-w-0`, o)), (t[8] = o), (t[9] = E));
  let D;
  t[10] === d
    ? (D = t[11])
    : ((D = d ? (0, Y.jsx)(K, { className: `icon-xs shrink-0` }) : null), (t[10] = d), (t[11] = D));
  let O;
  t[12] === w
    ? (O = t[13])
    : ((O = (0, Y.jsx)(`span`, {
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (k = t[14]);
  let A;
  t[15] !== y || t[16] !== T || t[17] !== E || t[18] !== D || t[19] !== O
    ? ((A = (0, Y.jsxs)(_, {
        "aria-label": T,
        size: `composerSm`,
        color: `ghost`,
    ...
    (t[27] !== m || t[28] !== l || t[29] !== n
      ? ((e = (e) =>
          (0, Y.jsx)(
            ...
            {
              LeftIcon: K,
              RightIcon: e.threadId === n ? v : void 0,
              ...
              children: (0, Y.jsxs)(`div`, {
                ...
                children: [
                  (0, Y.jsx)(`span`, { className: `truncate`, children: e.title }),
                  e.isPinned
                    ? null
                    : (0, Y.jsx)(`span`, {
...
function zt(e) {
  ...
  if (
    ...
    let i = pt.filter(e),
      o = i.find((e) => e.id === n) ?? pt.find((e) => e.id === n) ?? i[0],
      s = o.icon,
      p = m.formatMessage(
        {
      ...
      O;
    t[18] === a ? (O = t[19]) : ((O = g(`min-w-0`, a)), (t[18] = a), (t[19] = O));
    let k = f ? (0, Y.jsx)(s, { className: `icon-xs shrink-0` }) : null,
      A = d
        ? (0, Y.jsx)(`span`, {
            className: `truncate text-left text-token-foreground`,
    ...
    ((b = z),
      (T = u),
      (E = `sm`),
      (D = d ? N : (0, Y.jsx)(y, { tooltipContent: p, children: N })),
      (S = `flex flex-col`),
    ...
    (t[27] !== m || t[28] !== l || t[29] !== n
      ...
      (t[14] = E),
      (t[15] = D));
  } else ((b = t[9]), (S = t[10]), (C = t[11]), (w = t[12]), (T = t[13]), (E = t[14]), (D = t[15]));
  let O;
  t[31] !== S || t[32] !== C || t[33] !== w
    ? ((O = (0, Y.jsxs)(`div`, { className: S, children: [C, w] })),
      (t[31] = S),
      (t[32] = C),
      (t[33] = w),
      (t[34] = O))
  ...
  let k;
  return (
    t[35] !== b || t[36] !== O || t[37] !== T || t[38] !== E || t[39] !== D
      ? ((k = (0, Y.jsx)(b, { align: T, contentWidth: E, triggerButton: D, children: O })),
        (t[35] = b),
        (t[36] = O),
        (t[37] = T),
        (t[38] = E),
...
function Bt(e) {
  ...
  t[0] === r
    ? (c = t[1])
    : ((c = g(Ze, `flex items-center justify-between gap-2 text-left text-sm`, r)),
      (t[0] = r),
      (t[1] = c));
  let l;
  t[2] === o
    ? (l = t[3])
    : ((l = (0, Y.jsx)(`span`, { className: `truncate`, children: o })), (t[2] = o), (t[3] = l));
  let u;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Y.jsx)(x, { className: `icon-xxs shrink-0 text-token-description-foreground` })),
      (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] !== n || t[6] !== c || t[7] !== l
