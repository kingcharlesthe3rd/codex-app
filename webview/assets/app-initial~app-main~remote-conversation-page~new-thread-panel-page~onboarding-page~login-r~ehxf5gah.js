...
import { fb as w, pb as ne } from "./app-initial~app-main~onboarding-page.js";
import {
  Dr as T,
  J as E,
  Jv as re,
...
var ve,
  ...
  R = e(() => {
    (l(),
      N(),
      (ve = C(de, (e, { signal: t }) => ({ error$: t(null), phase$: t(`idle`) }))),
      (L = u(de, !1)));
  });
async function ye({ allowUnelevatedFallback: e, mode: t, setError: n, setPhase: r, start: i }) {
  let a = t === `unelevated`,
...
var B,
  V,
  xe = e(() => {
    (I(), (B = `Windows sandbox setup did not start.`), (V = `Windows sandbox setup failed.`));
  });
function H(e) {
  return [...Y, e];
}
...
async function Ce(e) {
  try {
    return (await re(`get-windows-sandbox-readiness-for-host`, { hostId: e })).status;
  } catch (e) {
    throw (
      a.error(`Failed to load Windows sandbox readiness`, { safe: {}, sensitive: { error: e } }), e
    );
  }
}
function U(e) {
...
function Q(e, t) {
    ...
    ? ((N = async (e, n) =>
        _e(r.get(u.phase$)) || !me(T, e)
          ...
          : ye({
              ...
              start: () =>
                re(`start-windows-sandbox-setup-for-host`, { hostId: l, mode: e, cwd: t }),
            })),
      (n[17] = T),
      (n[18] = t),
      (n[19] = l),
  ...
  n[59] !== C || n[60] !== w || n[61] !== p || n[62] !== I
    ...
    : (Z = n[63]);
  let Q;
  n[64] === I ? (Q = n[65]) : ((Q = () => I(`elevated`, !1)), (n[64] = I), (n[65] = Q));
  let $;
  return (
    n[66] !== S ||
    n[67] !== C ||
...
function Oe(e) {
  ...
  let { data: c, isError: l, isPending: u, refetch: d } = W(s),
    ...
    m = (n && i) || (o && u),
    h = null;
  !m && o && (c === `notConfigured` ? (h = `setup`) : c === `updateRequired` && (h = `update`));
  let g = h != null,
    _;
  t[2] === d
    ? (_ = t[3])
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~login-r~ehxf5gah.js.map
