...
import { J as F, _n as I } from "./src.js";
import { i as L, l as R, r as z, s as ne } from "./lib-1.js";
...
import { r as re, t as q } from "./tooltip-B.js";
import { t as ie } from "./context-menu.js";
import { r as J } from "./toast-signal.js";
import { t as Y } from "./stop.js";
import { A as X, w as ae } from "./rpc.js";
import { o as oe } from "./statsig.js";
import { t as se } from "./waveform.js";
import { m as ce } from "./chunk-13.js";
import { l as le, n as ue, t as Z, w as de } from "./sidebar-signals.js";
...
import {
  ...
  s as it,
  u as at,
} from "./sidebar-thread-row-signals-ZqNv-_WT.js";
...
import { n as _t, r as vt } from "./remote-host-globe-icon.js";
import { t as yt } from "./archive.js";
import { a as bt, o as xt, r as St } from "./thread-actions.js";
import { t as Ct } from "./get-attached-heartbeat-automation-for-thread.js";
import { n as wt, r as Tt, t as Et } from "./sidebar-task-pr-chip-signals.js";
import { h as Dt } from "./automation-schedule.js";
import { C as Ot } from "./automation-shared-g.js";
...
function It(e, t) {
  let n = _e(t);
  n != null && Xe.start(`thread_switch_completed`, { conversationId: n, needsResume: e.get(y, n) });
}
function Lt(e, t, n = null) {
  (e.get(Z) === t && e.get(ue) === n) || (e.get(Z) !== t && It(e, t), le(e, t, n));
}
function Rt(e, t, n) {
  ...
  let r = e.query.getData(E)?.roots?.[0] ?? null;
  Ne(e, t, {
    activeProject: n,
...
function Kt(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = { onArchiveStart: E, onArchiveSuccess: k, onArchiveError: O }), (t[2] = A))
    : (A = t[2]);
  let j = A,
    M;
  ...
  if (
    ...
    (t[35] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (u = t[35]),
      (L = u),
      t[36] === a ? (R = t[37]) : ((R = B(`flex flex-col`, a)), (t[36] = a), (t[37] = R)),
      (z = `list`),
      (G = o),
      (F = H),
      (K = !1),
    ...
    ((F = t[23]),
      ...
      (q = t[31]));
  let ie;
  t[38] !== F || t[39] !== K || t[40] !== re || t[41] !== q
    ? ((ie = (0, $.jsx)(F, { initial: K, custom: re, children: q })),
      (t[38] = F),
      (t[39] = K),
      (t[40] = re),
      (t[41] = q),
  ...
  t[43] !== s || t[44] !== c || t[45] !== n.length
    ? ((J = n.length === 0 && s ? (0, $.jsx)(`div`, { className: c, children: s }) : null),
      (t[43] = s),
      (t[44] = c),
      (t[45] = n.length),
      (t[46] = J))
...
function Zt(e) {
  ...
  t[0] === n.icon
    ...
    : ((r = (0, Vt.cloneElement)(n.icon, {
        className: B(`icon-2xs block shrink-0`, n.icon.props.className),
      })),
      (t[0] = n.icon),
      (t[1] = r));
  let i = r,
  ...
  t[2] === n.className
    ? (o = t[3])
    : ((o = B(`flex h-5 w-5 items-center justify-center leading-none`, n.className)),
      (t[2] = n.className),
      (t[3] = o));
  let s;
  ...
  return (
    t[8] !== n.tooltipContent || t[9] !== c
      ? ((l = (0, $.jsx)(q, { tooltipContent: n.tooltipContent, children: c })),
  ...
  if (t[2] !== n || t[3] !== a) {
    ...
    (t[5] === a
      ...
      : ((e = (e) => {
          ...
          return t
            ? (0, $.jsx)(q, { side: a, tooltipContent: e.ariaLabel, children: n }, e.id)
...
function tn(e) {
  ...
  let te = ee,
    C = v.find((e) => e.hostId === n)?.displayName ?? n,
    w;
  t[7] !== te || t[8] !== c || t[9] !== m || t[10] !== n || t[11] !== r || t[12] !== i
    ? ((w = (e) => {
        (e.preventDefault(), te != null && (m != null && i.set(vt, { ...c, [n]: te }), r()));
      }),
      (t[7] = te),
      (t[8] = c),
      (t[9] = m),
  ...
  let V;
  t[35] !== F || t[36] !== B
    ? ((V = (0, $.jsxs)(`div`, { className: `flex items-center gap-3`, children: [F, B] })),
      (t[35] = F),
      (t[36] = B),
      (t[37] = V))
    : (V = t[37]);
  ...
  t[40] === x
    ? (W = t[41])
    : ((W = (0, $.jsx)(Pt, { className: `h-48 w-full`, color: x, onChange: k })),
      (t[40] = x),
      (t[41] = W));
  let G;
  t[42] !== H || t[43] !== W
    ? ((G = (0, $.jsx)(`div`, { "aria-label": H, children: W })),
      (t[42] = H),
      (t[43] = W),
      (t[44] = G))
    : (G = t[44]);
  let K;
  t[45] !== V || t[46] !== G
    ? ((K = (0, $.jsxs)(Ce, { className: `gap-3 pt-4`, children: [V, G] })),
      (t[45] = V),
      (t[46] = G),
      (t[47] = K))
    : (K = t[47]);
  ...
  t[49] === j
    ? (q = t[50])
    : ((q = (0, $.jsx)(U, { color: `secondary`, type: `button`, onClick: j, children: re })),
      (t[49] = j),
      (t[50] = q));
  let ie = te == null,
    J;
  ...
  t[52] === ie
    ? (Y = t[53])
    : ((Y = (0, $.jsx)(U, { color: `primary`, disabled: ie, type: `submit`, children: J })),
      (t[52] = ie),
      (t[53] = Y));
  let X;
  t[54] !== q || t[55] !== Y
    ? ((X = (0, $.jsx)(Ce, { className: `pt-4`, children: (0, $.jsxs)(De, { children: [q, Y] }) })),
      (t[54] = q),
      (t[55] = Y),
      (t[56] = X))
    : (X = t[56]);
  let ae;
  t[57] !== T || t[58] !== K || t[59] !== X || t[60] !== P
    ? ((ae = (0, $.jsxs)(Ee, { as: `form`, onSubmit: T, children: [P, K, X] })),
      (t[57] = T),
      (t[58] = K),
      (t[59] = X),
      (t[60] = P),
  ...
  return (
    t[62] !== ae || t[63] !== M
      ? ((oe = (0, $.jsx)(Te, { open: !0, onOpenChange: M, size: `compact`, children: ae })),
        (t[62] = ae),
        (t[63] = M),
        (t[64] = oe))
      : (oe = t[64]),
...
function dn(e) {
  let t = (0, zt.c)(13),
    ...
    o = i(b, r),
    s = i(T, r),
    c = fn({ latestTurnStatus: i(D, r), resumeState: a, streamRole: o, threadRuntimeStatus: s }),
    l = un[c],
    u;
  t[0] === n
    ? (u = t[1])
    : ((u = B(`flex size-3 items-center justify-center`, n)), (t[0] = n), (t[1] = u));
  let d = ln[c],
    f;
  t[2] === d ? (f = t[3]) : ((f = B(`block size-2 rounded-full`, d)), (t[2] = d), (t[3] = f));
  let p;
  ...
  return (
    t[10] !== m || t[11] !== l
      ? ((h = (0, $.jsx)(q, { tooltipContent: l, children: m })),
        (t[10] = m),
        (t[11] = l),
        (t[12] = h))
      : (h = t[12]),
          ...
          : [
              {
                ...
                icon: (0, $.jsx)(Y, { className: r == null ? void 0 : `translate-x-0.5` }),
                onClick: i.onClick,
              },
            ]),
      (t[0] = r),
...
function wn(e) {
  let t = (0, zt.c)(130),
    ...
    X = i(he, n) ?? D?.title,
    ae = i(te, n),
    le = i(S, n) ?? D?.workspaceKind,
    {
      archiveThread: ue,
      markThreadAsUnread: Z,
      renameThread: de,
    ...
    De;
  t[0] !== v || t[1] !== m || t[2] !== _
    ? ((De = { onArchiveStart: m, onArchiveSuccess: _, onArchiveError: v }),
      (t[0] = v),
      (t[1] = m),
      (t[2] = _),
      (t[3] = De))
  ...
  let { canOpenThreadInNewWindow: Ge, openThreadInNewWindow: Ke } = Be(We),
    Je = le !== `projectless`,
    Ye;
  t[6] !== U || t[7] !== L ? ((Ye = F(L, U)), (t[6] = U), (t[7] = L), (t[8] = Ye)) : (Ye = t[8]);
  let Xe = Ye,
    Ze = L != null,
    Q = le === `projectless` && (L == null || L === `~`) ? (ae ?? y ?? null) : L,
    Qe = re && Y ? { id: `active-status`, icon: (0, $.jsx)(dn, { conversationId: n }) } : null,
    $e = null,
    et;
  ...
  if (W === n && G !== `inactive`) {
    ...
    let n = e,
      r;
    t[23] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, $.jsx)(se, { className: `icon-2xs shrink-0` })), (t[23] = r))
      : (r = t[23]);
    let i;
    t[24] === n
      ? (i = t[25])
    ...
    let a;
    (t[26] !== n || t[27] !== i
      ? ((a = (0, $.jsx)(q, { tooltipContent: n, children: i })),
        (t[26] = n),
        (t[27] = i),
        (t[28] = a))
      : (a = t[28]),
  ...
  let dt = ut,
    pt;
  t[34] !== ue || t[35] !== je || t[36] !== n || t[37] !== Ne || t[38] !== Me || t[39] !== D?.hostId
    ? ((pt = () => {
        (je(),
          ue({
            conversationId: n,
  ...
  let Tt = K(wt),
    Et;
  t[51] !== n || t[52] !== E || t[53] !== de || t[54] !== O || t[55] !== D?.hostId || t[56] !== X
    ? ((Et = () => {
  ...
  t[89] !== D?.hostId
    ? ((It = () => [
        ...
        { id: `archive-thread`, message: St.archiveThread, onSelect: _t },
        {
          ...
          enabled: B !== !0,
          onSelect: () => {
            Z({ conversationId: n, hostId: D?.hostId });
          },
        },
        ...cn({ scope: O, canToggleActiveStatus: re, showActiveStatus: Y }),
  ...
  t[99] !== Rt
    ? ((Bt = (e) => {
        ...
        return (0, $.jsx)(Cn, {
          ...
          pinAction: Rt
            ? {
                ariaLabel: N.formatMessage(C ? Le : Ve),
                isPinned: C,
                onClick: () => {
                  xt(O, n, !C);
                },
  ...
  t[118] !== Lt || t[119] !== Re || t[120] !== qt
    ? ((Jt = Re ? qt : (0, $.jsx)(ie, { getItems: Lt, children: qt })),
      (t[118] = Lt),
      (t[119] = Re),
      (t[120] = qt),
      (t[121] = Jt))
...
var En = (0, Vt.memo)(function (e) {
  let t = (0, zt.c)(40),
    ...
    C = u === void 0 ? null : u,
    w = p === void 0 ? !1 : p,
    T = m === void 0 ? `default` : m,
    E;
  t[0] !== C || t[1] !== n
    ? ((E = { locationId: C, threadKey: n }), (t[0] = C), (t[1] = n), (t[2] = E))
    : (E = t[2]);
  let D = i(de, E),
    O = i(Qe, n),
    k = i(at, n),
  ...
  let U = H,
    W;
  return (
    t[36] !== U || t[37] !== D || t[38] !== n
      ? ((W = (0, $.jsx)(Dn, { threadKey: n, isActive: D, ...U })),
        (t[36] = U),
        (t[37] = D),
        (t[38] = n),
        (t[39] = W))
...
function On(e) {
  let t = (0, zt.c)(121),
    {
      ...
      showPinActionOnHover: te,
      variant: C,
      shortcutLabel: T,
      hoverCardHostConfig: E,
    ...
    X = q,
    oe = q,
    { cancelPendingWorktree: se, renamePendingWorktree: le, setPendingWorktreePinned: ue } = Ie(),
    Z = n.kind === `local` ? n.conversationId : null,
  ...
  let Xe = Ye,
    Ze;
  t[13] !== Y || t[14] !== je
    ? ((Ze = !Y && je != null ? (0, $.jsx)(Zt, { badge: je }) : null),
      (t[13] = Y),
      (t[14] = je),
      (t[15] = Ze))
    : (Ze = t[15]);
  ...
  t[16] !== X || t[17] !== T
    ? ((Qe =
        X || T == null
          ? void 0
          : (0, $.jsx)(`div`, {
              className: B(gt, `text-token-description-foreground`),
              children: (0, $.jsx)(re, { keysLabel: T }),
            })),
      (t[16] = X),
      (t[17] = T),
      (t[18] = Qe))
  ...
  t[43] !== U
    ? ((st = function (e) {
        let t = e.pendingWorktree,
            ...
            (document.dispatchEvent(new PointerEvent(`pointercancel`)),
              Se(W, Oe, {
                ...
                onSave: (e) => {
                  let n = e.trim(),
                    r = t.label.trim();
                  n.length === 0 || n === r || le(t.id, n);
                },
              }));
          },
          o = G.formatMessage(r ? Le : Ve),
          l =
            c && !H
              ? Ge({
                  isPinned: r,
          ...
          u = y
            ? () => {
                (Lt(W, n, g), y(), K(`/worktree-init-v2/${t.id}`));
              }
            : void 0,
          d = (e) => {
        ...
        return (0, $.jsx)(ie, {
          ...
          children: (0, $.jsx)(mt, {
            ...
            onDoubleClick: d,
            onArchive: i,
            dataAttributes: ae.sidebarThreadRow({
              active: s,
              hostId: t.hostId,
              id: n,
    ...
    ? ((vt = function (e) {
        let t = e.conversationId,
          ...
          h = () => {
            (pe !== !0 &&
              n != null &&
              (v(W, t, n.hostId), W.get(O, n.hostId)?.activateThreadSummary(t)),
              z && y?.());
          },
          _ =
            c && !p
              ? Ge({
                  isPinned: r,
                  hasUnreadTurn: !m && l === !0,
                  ariaLabel: G.formatMessage(r ? Le : Ve),
                  onPin: () => {
                    Xe(t, !0);
                  },
                  onUnpin: () => {
              ...
              : { rest: null, hover: null },
          b = o,
          x = pe === !0 ? (_e ?? n?.title ?? o ?? ``) : (o ?? n?.title ?? _e ?? ``),
          S = V || d == null ? void 0 : (0, $.jsx)(lt, { dateString: new Date(d).toISOString() });
        return (0, $.jsx)(wn, {
          conversationId: t,
          isAutomationRun: a,
...
function Rn(e) {
  ...
  t[9] === g
    ? (D = t[10])
    : ((D = B(`isolate flex flex-col [contain:layout]`, g)), (t[9] = g), (t[10] = D));
  let O = l?.isGrouped,
    k,
    A;
  t[11] === d
  ...
  return (
    t[40] !== M || t[41] !== D
      ? ((N = (0, $.jsx)(`div`, { className: D, children: M })),
        (t[40] = M),
        (t[41] = D),
        (t[42] = N))
      : (N = t[42]),
...
function Un(e) {
  return X(e).trim().toLocaleLowerCase();
}
function Wn(e) {
