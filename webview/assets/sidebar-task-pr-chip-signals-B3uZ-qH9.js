...
import { p as Ae } from "./statsig.js";
...
function k({ sectionOrder: e, customSectionIds: t, includeCloudSection: n, showChatsFirst: r }) {
  let i = qe(t),
...
function Ke({ sectionOrder: e, visibleSectionKeys: t, nextVisibleSectionKeys: n }) {
  return Ye(t, n) ? Je({ sectionOrder: e, visibleSectionKeys: t, nextVisibleSectionKeys: n }) : e;
}
function qe(e) {
  let t = new Set();
  return e.flatMap((e) => (t.has(e) ? [] : (t.add(e), [D(e)])));
}
function Je({ sectionOrder: e, visibleSectionKeys: t, nextVisibleSectionKeys: n }) {
  let r = new Set(t),
    i = 0;
  return e.map((e) => {
    if (!r.has(e)) return e;
...
var A = Ee(x, null),
  ...
  nt = Oe(x, ({ sectionId: e, currentThreadKey: t }) => {
    ...
    return b(x, ({ get: r }) => {
      ...
      let { allSidebarThreadKeys: a } = r(r(Ie, { currentConversationId: ye(t) })),
        o = oe({ items: r(r(Le, a)), threadIds: i.threadIds, sortKey: i.sortKey });
      return ((n = rt(n, o)), n);
    });
  });
function rt(e, t) {
...
function I(e, t) {
  return {
    threadIds: L(
      e
        .flatMap((e, n) => (R(e) == null ? [] : [{ task: e, timestamp: ot(e, t), index: n }]))
...
function H(e, t) {
  return q(e, (e) => {
    ...
    return r != null && g(r.threadIds, i.threadIds) ? n : { ...n, [t.projectId]: i };
  });
}
function ft(e, t) {
  return Promise.all([
  ...
  let n = async () => {
      ...
      c(i[t.threadId], t.assignment) ||
        (await m(
          ...
          r({ assignments: i, conversationId: t.threadId, assignment: t.assignment }),
        ));
    },
    i = vt.then(n, n);
  return ((vt = i.catch(() => {})), i);
...
function bt(e, t) {
  let n = async () => {
      let { value: n } = await S(`get-global-state`, { params: { key: o.PROJECTLESS_THREAD_IDS } }),
...
function xt({
  ...
  let s = r.find((t) => t.task.kind === `local` && t.task.conversation.id === e.threadId)?.task;
  if (s?.kind !== `local`) return null;
  let c = t.find((e) => e.threadKeys.includes(s.key)),
    l = u({ cwd: s.conversation.cwd ?? null, assignment: o?.[s.conversation.id] });
...
function Ot(e, { emoji: t, name: n }) {
  ...
  r != null &&
    (r.kind === `create`
      ? wt(e, { emoji: t, name: n, threadId: r.threadId, wasPinned: r.wasPinned })
  ...
  if (c === `chats`)
    return Z(
      Promise.all([
        ...
        ft(e, { tasks: [...i.map((e) => e.task), u], threadId: o, beforeThreadId: l }),
        _(e, o),
    ...
    if (u.kind === `remote`)
      return Z(
        Promise.all([
          ...
          H(e, {
            projectId: i.projectId,
            tasks: [...Fe(i.threadKeys, new Map(r.map((e) => [e.task.key, e]))), u],
            threadId: o,
            beforeThreadId: l,
          }),
          _(e, o),
...
function X(e) {
  return e.catch((e) => {
    y.error(`Failed to save sidebar custom sections`, { safe: {}, sensitive: { error: s(e) } });
  });
}
function Z(e) {
  return e.catch((e) => {
    y.error(`Failed to save thread project assignment`, { safe: {}, sensitive: { error: s(e) } });
  });
}
var Q = we({
  moveTo: {
...
var Ht = De(x, `gh-pr-status`, ({ cwd: e, enabled: t, headBranch: n, hostId: r }) => ({
    enabled: t,
...
function qt(e, t) {
  ...
  return {
    ...
    iconBadge: { id: `pr-status`, icon: (0, $.jsx)(T, { status: e }), tooltipContent: null },
  };
}
function Jt(e, t, n, r, i) {
  return {
    hoverCardSection: {
      id: `pr`,
      rows: [
        { id: `pr-status`, icon: (0, $.jsx)(T, { status: e }), label: Yt(e, i) },
        {
          id: `checks-summary`,
          icon:
            r === `none`
    ...
    iconBadge: { id: `pr-status`, icon: (0, $.jsx)(Ve, { state: t }), tooltipContent: null },
  };
}
function Yt(e, t) {
  switch (e) {
...
//# sourceMappingURL=sidebar-task-pr-chip-signals-B3uZ-qH9.js.map
