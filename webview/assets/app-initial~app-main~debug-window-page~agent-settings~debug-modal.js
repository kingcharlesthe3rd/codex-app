...
function u(e) {
  let i = e.getLayer(`2096615506`).get(n, o),
    a = t.safeParse(i);
  return (
    a.success ||
      r.info(`Invalid Codex runtime install config; using default runtime`, {
        safe: {},
        sensitive: { runtimeInstallConfig: i, error: a.error },
      }),
    { source: i === o ? `default` : `statsig-layer`, value: a.success ? a.data : o }
  );
}
function d(e) {
  (r.info(`Codex runtime config selected`, {
    ...
    a.dispatchMessage(`codex-runtimes-config-changed`, { config: f(e.value) }));
}
function f(e) {
  return { runtimes: { [n]: e } };
}
