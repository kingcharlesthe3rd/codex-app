...
import { a as ee, i as F, n as te, o as I, r as L, u as ne } from "./dist-5.js";
var R = e(t());
function z(e, t, n) {
  let r = e.slice();
...
function ce(e) {
  let { children: t, id: n, items: r, strategy: i = U, disabled: a = !1 } = e,
    ...
    d = T(W, n),
    f = s.rect !== null,
    p = (0, R.useMemo)(() => r.map((e) => (typeof e == `object` && `id` in e ? e.id : e)), [r]),
    m = o != null,
...
function ge(e) {
  let {
    ...
    oe = ae
      ? ((V && ae ? z : null) ??
        (s ?? v)({ rects: h, activeNodeRect: N, activeIndex: f, overIndex: g, index: b }))
      : null,
    H = ie(f) && ie(g) ? a({ id: o, items: u, activeIndex: f, overIndex: g }) : b,
    U = D?.id,
  ...
  function ve() {
    ...
    if (!((V && !A(j)) || !l) && (B || ge)) return M.Transition.toString({ ...l, property: fe });
  }
}
function _e(e, t) {
...
function He({
  ...
  return (0, K.jsxs)(`button`, {
    ...
    style: { left: e.left + e.width, top: e.top + e.height + Re, transform: `translateX(-100%)` },
    onMouseDown: a,
    onClick: (e) => {
      (a(e), t());
    },
...
var ct = e(m()),
  ...
  gt = { "--codex-chat-font-size": `13px`, fontSize: `var(--codex-chat-font-size, 13px)` },
  ...
  Mt = (0, R.forwardRef)(function (
    ...
    let x = (0, R.useRef)(null),
      ...
      ),
      {
        ...
        middleware: [
          h(dt + ft),
          v({ fallbackPlacements: [`left-start`], padding: ut, ...(j ? { boundary: j } : {}) }),
          ...
          children: (0, K.jsxs)(`div`, {
            ...
            children: [
              (0, K.jsx)(`div`, {
                className: i(
                  yt,
                  T ? `top-2 bottom-11 w-[calc(100%-32px)]` : `top-2 bottom-2 w-[calc(100%-60px)]`,
                ),
                children: (0, K.jsx)(`div`, {
                  ...
                  children: (0, K.jsx)(`textarea`, {
                    ...
                    rows: 1,
                    className: i(ht, !T && `!overflow-hidden whitespace-nowrap`),
                    style: {
...
function Nt({ text: e, hasMultipleBlocks: t, measureElement: n, surfaceElement: r }) {
  let i = e.trim();
...
function Pt(e) {
  ...
  let n = e.querySelector(`[data-browser-comment-submit]`)?.getBoundingClientRect().width ?? St;
...
function Kt(e) {
  let t = Math.min(zt, Math.max(1, e.containerWidth - X * 2)),
    ...
    r = Vt / 2 + Bt,
    i = Gt(e.markerPoint.left - n / 2, X, Math.max(X, e.containerWidth - n - X)),
  ...
  return o + Y <= e.containerHeight - X
    ...
    : { left: i, top: Gt(a, X, Math.max(X, e.containerHeight - Y - X)), maxWidth: t };
}
function qt({
  body: e,
  markerPosition: t,
    ...
    children: [
      ...
      (0, K.jsx)(F, {
        children: (0, K.jsx)(te, {
          ...
          children: t.map((e) => {
            if (e.kind === `separator`)
              return (0, K.jsx)(I, { className: `bg-token-border-light my-1 h-px` }, e.id);
            let t = e.icon;
            return (0, K.jsxs)(
              L,
              {
...
var fn = new Intl.DateTimeFormat(void 0, { dateStyle: `medium`, timeStyle: `short` }),
  pn = [`👍`, `❤️`, `👀`, `✅`],
...
function bn({
  ...
  let [g, _] = (0, R.useState)(!1),
    [v, y] = (0, R.useState)(!1),
    b = (0, R.useMemo)(() => hn(e.editedAt ?? e.createdAt), [e.createdAt, e.editedAt]),
    x = o.trim(),
            ...
            children: [
              (0, K.jsxs)(`div`, {
                ...
                children: [
                  ...
                  b
                    ? (0, K.jsxs)(`div`, {
                        className: i(`text-token-description-foreground mt-0.5`, mn),
...
var Xn = class {
  ...
  zoomTo(e, t) {
    ...
    this.setCamera(on(this.#p, r, i, e, this.#i.minZoom, this.#i.maxZoom), { settled: t?.settled });
  }
  panByScroll(e, t) {
  ...
  #y(e) {
    return this.#i.clampCamera
      ? this.#i.clampCamera({ ...e, k: rn(e.k, this.#i.minZoom, this.#i.maxZoom) })
      : sn(
...
function ir(e) {
  let t = $n(e.externalCrdtUpdates);
  return {
    initialCrdtState: rr({ initialCrdtState: e.initialCrdtState, externalCrdtUpdates: t }),
...
function cr({ artifactLabel: e, controller: t, externalCrdtUpdates: n, onCrdtUpdate: r }) {
  let i = (0, R.useRef)(0),
    a = (0, R.useRef)(n ?? []),
      ...
      return (
        (async () => {
          ...
          try {
            ...
            if (r) return;
            s({ kind: `failed`, artifactLabel: e, errorMessage: or(t, e), pendingUpdateCount: a });
          }
        })(),
        () => {
          r = !0;
