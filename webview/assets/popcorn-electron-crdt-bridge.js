...
import { a as d, i as f, n as p, o as m, r as h, u as g } from "./dist-1.js";
import { q as _ } from "./workbook-2.js";
import {
  B as v,
  D as y,
  F as b,
...
import { a as D, i as O, n as k, r as A } from "./dist-4.js";
import {
  _ as j,
  c as ee,
  g as M,
...
function He(e, t) {
  switch (t) {
    case `bottom-left`:
      return { fontFamily: q, left: e.left, top: e.top + e.height + J };
    case `bottom-right`:
      return {
        fontFamily: q,
        left: e.left + e.width,
        top: e.top + e.height + J,
        transform: `translateX(-100%)`,
      };
    case `top-left`:
      return { fontFamily: q, left: e.left, top: e.top - J, transform: `translateY(-100%)` };
    case `top-right`:
      return {
        fontFamily: q,
        left: e.left + e.width,
...
function Qe({ drawingId: e, screenshot: t, markerViewportPoint: n, viewportSize: r }) {
  return {
    ...
    : (0, K.jsxs)(`svg`, {
        ...
        children: [
          ...
          (0, K.jsx)(`g`, {
            ...
            children: e.map((e, n) =>
              (0, K.jsx)(tt, { stroke: e, projectPoint: t }, `${n}-${e.points.length}`),
            ),
          }),
        ],
      });
...
function ot({ active: e, disabled: t = !1, onClick: n, testId: r = `popcorn-annotation-button` }) {
  return (0, K.jsx)(at, {
    active: e,
...
function st({ active: e, disabled: t = !1, onClick: n, testId: r = `popcorn-drawing-button` }) {
  return (0, K.jsx)(at, {
    active: e,
    disabled: t,
    onClick: n,
  ...
  Nt = (0, L.forwardRef)(function (
    ...
    let y = (0, L.useRef)(null),
      ...
      ),
      {
        ...
        middleware: [
          a(dt + ft),
          c({ fallbackPlacements: [`left-start`], padding: ut, ...(M ? { boundary: M } : {}) }),
          l({ padding: ut, ...(M ? { boundary: M } : {}) }),
          u({
            padding: ut,
            ...(M ? { boundary: M } : {}),
    ...
    if (
      ...
      (0, L.useLayoutEffect)(() => {
        ...
        if (n) {
          ((e.style.height = `0px`),
            (e.style.height = `${Math.min(Math.max(e.scrollHeight, t * mt), ht)}px`));
          return;
        }
        e.style.height = `${mt}px`;
      }, [k, C, r]),
      (0, L.useEffect)(() => {
        P.setReference(te);
      }, [P, te]),
    ...
    let B = (0, K.jsx)(`div`, {
      ...
      style: { position: I, left: ne ?? 0, top: ie ?? 0, width: lt },
      onMouseDown: (e) => {
        e.stopPropagation();
      },
          ...
          children: (0, K.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, K.jsx)(`span`, {
                ...
                "aria-hidden": `true`,
                className: St,
                style: { fontSize: `var(--codex-chat-font-size, 13px)`, lineHeight: `${mt}px` },
                children: r,
              }),
              k
                ? (0, K.jsxs)(`div`, {
    ...
    return n ? (0, ct.createPortal)(B, n) : B;
  });
...
var rn = typeof window > `u` ? L.useEffect : L.useLayoutEffect,
  an = 1;
function on(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
...
function Sn({
  ...
  let [f, p] = (0, L.useState)(!1),
    [m, h] = (0, L.useState)(!1),
    g = (0, L.useMemo)(() => _n(e.editedAt ?? e.createdAt), [e.createdAt, e.editedAt]),
    _ = a.trim(),
...
var Qn = class {
  ...
  zoomTo(e, t) {
    ...
    this.setCamera(cn(this.#p, r, i, e, this.#i.minZoom, this.#i.maxZoom), { settled: t?.settled });
  }
  panByScroll(e, t) {
...
function ir(e, t) {
  ...
  for (let n = 0; n < e.length; n += 1) {
    let r = e[n],
      i = t[n];
    if (!r || !i || !rr(r, i)) return !1;
  }
  return !0;
}
function ar(e) {
  let t = tr(e.externalCrdtUpdates);
  return (
...
function or(e) {
  let t = tr(e.externalCrdtUpdates);
  return {
    initialCrdtState: ar({ initialCrdtState: e.initialCrdtState, externalCrdtUpdates: t }),
...
function lr({ initialCrdtState: e, externalCrdtUpdates: t }) {
  let n = (0, L.useRef)(null);
  n.current ??= or({ initialCrdtState: e, externalCrdtUpdates: t });
  let r = n.current;
  return {
    initialCrdtState: r.initialCrdtState,
    externalCrdtUpdates: sr({ bootstrapState: r, updates: t }),
  };
}
function ur({ artifactLabel: e, controller: t, externalCrdtUpdates: n, onCrdtUpdate: r }) {
  let i = (0, L.useRef)(0),
    a = (0, L.useRef)(n ?? []),
    [o, s] = (0, L.useState)(null),
    c = n ?? [];
  ir(a.current, c) || (a.current = c);
  let l = a.current;
  return (
    (0, L.useEffect)(() => {
    ...
    (0, L.useEffect)(() => {
      ...
      return (
        (async () => {
          ...
          s(a >= er ? { kind: `restoring`, pendingUpdateCount: a } : null);
          try {
            let e = nr(n, i.current);
            if (r || (e && (await t.applyCrdtUpdate(e), r))) return;
            ((i.current = n.length), s(null));
          } catch (t) {
            if (r) return;
            s({ kind: `failed`, artifactLabel: e, errorMessage: cr(t, e), pendingUpdateCount: a });
          }
        })(),
        () => {
          r = !0;
...
function dr({ artifactLabel: e, restoreState: t }) {
  return t
    ? (0, K.jsx)(`div`, {
