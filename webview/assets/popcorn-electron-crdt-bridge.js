...
import { a as d, i as f, n as p, o as m, r as h, u as g } from "./dist-12.js";
...
import { a as D, i as O, n as k, r as A } from "./dist-2.js";
import {
  _ as j,
  c as ee,
  g as M,
...
function ce(e) {
  let { children: t, id: n, items: r, strategy: i = U, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: c, over: l, measureDroppableContainers: u } = ee(),
    d = j(W, n),
    f = s.rect !== null,
    p = (0, L.useMemo)(() => r.map((e) => (typeof e == `object` && `id` in e ? e.id : e)), [r]),
    m = o != null,
  ...
  return L.createElement(se.Provider, { value: x }, t);
}
var le = (e) => {
    let { id: t, items: n, activeIndex: r, overIndex: i } = e;
    return R(n, r, i).indexOf(t);
  },
  ue = (e) => {
    let {
      containerId: t,
  ...
  fe = `transform`,
  pe = F.Transition.toString({ property: fe, duration: 0, easing: `linear` }),
  ...
  return (
    M(() => {
      if (!t && n !== s.current && r.current) {
        let e = i.current;
        if (e) {
          let t = ne(r.current, { ignoreTransform: !0 }),
            n = {
              x: e.left - t.left,
              y: e.top - t.top,
...
function ge(e) {
  let {
    ...
    }),
    {
      ...
      transform: R,
    } = te({ id: o, data: x, attributes: { ...me, ...n }, disabled: y.draggable }),
    ie = N(E, j),
    B = !!D,
    ae = B && !m && z(f) && z(g),
    V = !_ && M,
    oe = ae
      ...
      : null,
    H = z(f) && z(g) ? a({ id: o, items: u, activeIndex: f, overIndex: g }) : b,
    U = D?.id,
    W = (0, L.useRef)({ activeId: U, items: u, newIndex: H, containerId: d }),
  ...
  function ve() {
    ...
    if (!((V && !P(O)) || !l) && (B || ge)) return F.Transition.toString({ ...l, property: fe });
  }
}
function _e(e, t) {
...
var K = n(),
  ...
  Ie = `-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro", "Segoe UI", sans-serif`,
  Le = `data:image/svg+xml,${encodeURIComponent(Fe)}`;
`${Le}`;
...
function Ue({
  ...
  return (0, K.jsxs)(`button`, {
    ...
    "data-testid": r,
    className: `pointer-events-auto absolute z-40 inline-flex h-6 min-w-max cursor-interaction items-center gap-2 whitespace-nowrap rounded-full border-0 bg-white py-[3px] pr-[3px] pl-2 text-[12px] leading-[18px] font-[400] tracking-[-0.3px] text-black shadow-[0_8px_18px_-6px_rgba(0,0,0,0.55)] ring-[1px] ring-black/10 hover:bg-[color-mix(in_srgb,white_92%,var(--color-token-foreground)_8%)]`,
    style: {
      fontFamily: Ie,
      left: e.left + e.width,
      top: e.top + e.height + ze,
...
function nt({ stroke: e, projectPoint: t }) {
  ...
  if (n.length === 1) {
    let [t] = n;
    return t
      ? (0, K.jsx)(`circle`, { cx: t.x, cy: t.y, r: e.strokeWidth / 2, fill: e.color })
      : null;
  }
  return (0, K.jsx)(`path`, {
    d: Je(n),
...
function rt({ strokes: e, projectPoint: t, testId: n, clipBounds: r }) {
  let i = `popcorn-drawing-overlay-${(0, L.useId)().replace(/[:]/g, ``)}`;
  return e.length === 0
    ? null
    : (0, K.jsxs)(`svg`, {
        "data-testid": n,
        ...
        children: [
          ...
          (0, K.jsx)(`g`, {
            ...
            children: e.map((e, n) =>
              (0, K.jsx)(nt, { stroke: e, projectPoint: t }, `${n}-${e.points.length}`),
            ),
          }),
        ],
      });
  ...
  Nt = (0, L.forwardRef)(function (
    ...
    let y = (0, L.useRef)(null),
      ...
      ),
      {
        ...
        middleware: [
          a(ft + pt),
          c({ fallbackPlacements: [`left-start`], padding: dt, ...(M ? { boundary: M } : {}) }),
          l({ padding: dt, ...(M ? { boundary: M } : {}) }),
          u({
            padding: dt,
            ...(M ? { boundary: M } : {}),
      ...
      R = C ? mt : q,
      ie = F == null ? void 0 : F + (mt - R) / 2 + pt,
      z = (0, L.useCallback)(
        (e) => {
          if (((y.current = e), P.setFloating(e), typeof _ == `function`)) {
            _(e);
            return;
          }
          _ && (_.current = e);
    ...
    if (
      ...
      (0, L.useLayoutEffect)(() => {
        ...
        if (n) {
          ((e.style.height = `0px`),
            (e.style.height = `${Math.min(Math.max(e.scrollHeight, t * J), ht)}px`));
          return;
        }
        e.style.height = `${J}px`;
      }, [k, C, r]),
      ...
      (0, L.useEffect)(() => {
        e && re?.();
      }, [e?.height, e?.left, e?.top, e?.width, r, C, re]),
      !e)
    )
      return null;
    let B = (0, K.jsx)(`div`, {
      ...
      style: { position: I, left: ne ?? 0, top: ie ?? 0, width: ut },
      onMouseDown: (e) => {
        e.stopPropagation();
      },
      children: (0, K.jsx)(`form`, {
        ...
        style: _t,
        onSubmit: (e) => {
          (e.preventDefault(), A && p(k ? `saved` : `direct`));
        },
          ...
          children: (0, K.jsxs)(`div`, {
            ...
            children: [
              (0, K.jsx)(`div`, {
                className: i(
                  bt,
                  j ? `top-2 bottom-11 w-[calc(100%-32px)]` : `top-2 bottom-2 w-[calc(100%-60px)]`,
                ),
                children: (0, K.jsx)(`div`, {
                  ...
                  children: (0, K.jsx)(`textarea`, {
                    ...
                    onKeyDown: (e) => {
                      ...
                      e.key === `Enter` &&
                        ...
                        (e.preventDefault(),
                        e.stopPropagation(),
                        p(k || e.metaKey || e.ctrlKey ? `saved` : `direct`));
                    },
              ...
              (0, K.jsx)(`span`, {
                ...
                "aria-hidden": `true`,
                className: St,
                style: { fontSize: `var(--codex-chat-font-size, 13px)`, lineHeight: `${J}px` },
                children: r,
              }),
              k
                ? (0, K.jsxs)(`div`, {
                    ...
                    children: [
                      (0, K.jsx)(`button`, {
                        ...
                        onClick: h,
                        children: (0, K.jsx)(v, { className: `size-4` }),
                      }),
                      (0, K.jsxs)(`div`, {
    ...
    return n ? (0, lt.createPortal)(B, n) : B;
  });
...
var Y = 32,
  ...
  Vt = 12,
  Ht = 26,
  Ut = `var(--color-token-dropdown-background, var(--color-token-main-surface-primary, white))`,
  Wt = `var(--color-token-foreground, var(--color-token-text-primary, rgb(38, 38, 38)))`,
  Gt = `var(--color-token-border-default, var(--color-token-border-light, rgba(13, 13, 13, 0.08)))`;
function Kt(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
function qt(e) {
  let t = Math.min(Bt, Math.max(1, e.containerWidth - X * 2)),
    n = Math.min(e.previewWidth && e.previewWidth > 0 ? e.previewWidth : t, t),
    r = Ht / 2 + Vt,
    i = Kt(e.markerPoint.left - n / 2, X, Math.max(X, e.containerWidth - n - X)),
  ...
  return o + Y <= e.containerHeight - X
    ...
    : { left: i, top: Kt(a, X, Math.max(X, e.containerHeight - Y - X)), maxWidth: t };
}
function Jt({
  body: e,
  markerPosition: t,
...
function $t(e) {
  return e === `codex` ? Qt : Zt;
}
function en(e) {
  return `#ffffff`;
}
function tn({ trigger: e, actions: t }) {
  return (0, K.jsxs)(d, {
    children: [
      (0, K.jsx)(g, { asChild: !0, children: e }),
      (0, K.jsx)(f, {
        children: (0, K.jsx)(p, {
          className: `border-token-border-light bg-token-bg-primary z-50 min-w-[160px] rounded-xl border p-1 shadow-lg`,
          children: t.map((e) => {
            if (e.kind === `separator`)
              return (0, K.jsx)(m, { className: `bg-token-border-light my-1 h-px` }, e.id);
            let t = e.icon;
            return (0, K.jsxs)(
              h,
              {
...
var nn = typeof window > `u` ? L.useEffect : L.useLayoutEffect,
  rn = 1;
function an(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
...
function fn(e) {
  ...
  return {
    centerX: (n.x + r.x) / 2,
    centerY: (n.y + r.y) / 2,
    distance: Math.max(rn, Math.hypot(i, a)),
  };
}
var pn = new Intl.DateTimeFormat(void 0, { dateStyle: `medium`, timeStyle: `short` }),
  mn = [`👍`, `❤️`, `👀`, `✅`],
  Q = `text-[length:var(--codex-chat-font-size,13px)] leading-5`,
  hn = `text-[11px] leading-4`;
function gn(e) {
  if (!e) return ``;
  let t = new Date(e);
  return Number.isNaN(t.getTime()) ? `` : pn.format(t);
}
function _n(e) {
  switch (e) {
    case `resolved`:
...
function vn({ open: e, onOpenChange: t, trigger: n, children: r }) {
  return (0, K.jsxs)(O, {
    open: e,
    onOpenChange: t,
    children: [
      (0, K.jsx)(D, { asChild: !0, children: n }),
      (0, K.jsx)(A, {
        children: (0, K.jsx)(k, {
          side: `bottom`,
          align: `end`,
...
function yn({ label: e, active: t, count: n, onClick: r, interactive: a }) {
  let o = i(
  ...
  return !a || !r
    ...
    : (0, K.jsx)(`button`, { type: `button`, className: o, onClick: r, children: `${e} ${n}` });
}
function bn({ value: e, onChange: t, onSubmit: n }) {
  let r = e.trim();
  return (0, K.jsxs)(`div`, {
...
function xn({
  ...
  let [f, p] = (0, L.useState)(!1),
    [m, h] = (0, L.useState)(!1),
    g = (0, L.useMemo)(() => gn(e.editedAt ?? e.createdAt), [e.createdAt, e.editedAt]),
    _ = a.trim(),
            ...
            children: [
              (0, K.jsxs)(`div`, {
                ...
                children: [
                  ...
                  g
                    ? (0, K.jsxs)(`div`, {
                        className: i(`text-token-description-foreground mt-0.5`, hn),
                    ...
                    children: (0, K.jsxs)(`div`, {
                      ...
                      children: [
                        (0, K.jsxs)($, {
                          ...
                          children: [(0, K.jsx)(x, { className: `size-4` }), `Edit`],
                        }),
                        (0, K.jsxs)($, {
                          destructive: !0,
                          onClick: () => {
                          ...
                          children: [(0, K.jsx)(v, { className: `size-4` }), `Delete`],
                        }),
                      ],
                    }),
                  })
...
function Sn({
  ...
  let g = s && c != null,
    ...
    [b, x] = (0, L.useState)(``),
    [S, T] = (0, L.useState)(!1),
    [E, D] = (0, L.useState)(null),
    [O, k] = (0, L.useState)(``);
  (0, L.useEffect)(() => {
    E != null && !o.some((e) => e.id === E) && (D(null), k(``));
  }, [o, E]);
  let A = n === `resolved` ? [r, gn(a)].filter(Boolean).join(` · `) : null;
  return (0, K.jsxs)(`div`, {
        ...
        children: [
          (0, K.jsxs)(`div`, {
            ...
            children: [
              ...
              A
                ? (0, K.jsx)(`div`, {
                    className: i(`text-token-description-foreground mt-1`, hn),
                    children: A,
                  })
                : null,
            ],
                      ...
                      children: [
                        n === `resolved`
                          ? d
                            ? (0, K.jsxs)($, {
                                ...
                                children: [(0, K.jsx)(y, { className: `size-4` }), `Reopen thread`],
                              })
                            : null
                          : u
                            ? (0, K.jsxs)($, {
                        ...
                        f
                          ? (0, K.jsxs)($, {
                              ...
                              children: [(0, K.jsx)(v, { className: `size-4` }), `Delete thread`],
                            })
                          : null,
                      ],
                    }),
...
function On(e) {
  ...
  return {
    visibleSize: n,
    halfVisibleSize: n / 2,
    hitRadius: Math.max(4, Tn / t),
    rotationBand: Math.max(6, En / t),
  };
}
function kn(e) {
  ...
  let t =
      e.deltaMode === WheelEvent.DOM_DELTA_LINE
        ...
        : e.deltaMode === WheelEvent.DOM_DELTA_PAGE
          ...
          : zn,
    n = 2 ** (-e.deltaY * t * Hn);
  return Math.max(Un, Math.min(Wn, n));
}
function Yn(e, t, n) {
...
var Zn = class {
  ...
  #n = (e) => {
    ...
    if (e.ctrlKey) {
      let n = this.#a;
      if (!n) return;
      let r = dn(n, e.clientX, e.clientY),
        i = Jn(e),
        a = this.#p.k * i,
        o = this.#b(a);
  ...
  #r = (e) => {
    ...
    if (e.type === `pointerup` || e.type === `pointercancel` || e.type === `pointerleave`) {
      ...
      ((this.#o = null),
        ...
        (this.#s = !1),
        (this.#c = null),
        (this.#d = performance.now() + Gn),
        this.#i.onCameraSettled?.(this.#p));
      return;
    }
    let n = dn(t, e.clientX, e.clientY);
    ...
    if (this.#e.has(e.pointerId)) {
      if ((this.#e.set(e.pointerId, n), e.type !== `pointermove` || this.#e.size < 2)) {
        if (e.type === `pointermove` && this.#e.size === 1 && this.#c?.pointerId === e.pointerId) {
          e.preventDefault();
  ...
  zoomTo(e, t) {
    ...
    this.setCamera(sn(this.#p, r, i, e, this.#i.minZoom, this.#i.maxZoom), { settled: t?.settled });
  }
  panByScroll(e, t) {
  ...
  #_() {
    ...
    this.setCamera({ k: r, x: t.centerX - e.anchorWorldX * r, y: t.centerY - e.anchorWorldY * r });
  }
  #v() {
  ...
  #y(e) {
    return this.#i.clampCamera
      ? this.#i.clampCamera({ ...e, k: an(e.k, this.#i.minZoom, this.#i.maxZoom) })
      : cn(
          { ...e, k: an(e.k, this.#i.minZoom, this.#i.maxZoom) },
