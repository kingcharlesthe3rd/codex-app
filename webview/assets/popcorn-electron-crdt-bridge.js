...
import { K as r } from "./workbook-DBfv-lpS.js";
...
import { a as h, c as g, l as _, n as v, o as y, s as b } from "./floating-ui.react-dom.js";
import { a as x, i as S, n as C, r as w } from "./dist-11.js";
import {
  _ as T,
  c as E,
  g as D,
...
import { a as N, i as P, n as ne, o as F, r as re, u as I } from "./dist-4.js";
var L = e(t());
function R(e, t, n) {
  let r = e.slice();
...
function ce(e) {
  let { children: t, id: n, items: r, strategy: i = U, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: c, over: l, measureDroppableContainers: u } = E(),
    d = T(W, n),
    f = s.rect !== null,
...
var le = (e) => {
  ...
  fe = `transform`,
  pe = te.Transition.toString({ property: fe, duration: 0, easing: `linear` }),
  ...
  return (
    D(() => {
      if (!t && n !== s.current && r.current) {
        let e = i.current;
        if (e) {
          let t = ee(r.current, { ignoreTransform: !0 }),
            n = {
              x: e.left - t.left,
              y: e.top - t.top,
...
function ge(e) {
  let {
    ...
    }),
    {
      ...
      transform: R,
    } = k({ id: o, data: x, attributes: { ...me, ...n }, disabled: y.draggable }),
    ie = O(E, P),
    B = !!D,
    ae = B && !m && z(f) && z(g),
    V = !_ && F,
    oe = ae
      ? ((V && ae ? R : null) ??
        (s ?? v)({ rects: h, activeNodeRect: j, activeIndex: f, overIndex: g, index: b }))
      : null,
  ...
  function ve() {
    ...
    if (!((V && !A(ee)) || !l) && (B || ge)) return te.Transition.toString({ ...l, property: fe });
  }
}
function _e(e, t) {
  ...
  Nt = (0, L.forwardRef)(function (
    ...
    let x = (0, L.useRef)(null),
      ...
      ),
      {
        ...
        middleware: [
          h(ft + pt),
          v({ fallbackPlacements: [`left-start`], padding: dt, ...(j ? { boundary: j } : {}) }),
          y({ padding: dt, ...(j ? { boundary: j } : {}) }),
          b({
            padding: dt,
            ...(j ? { boundary: j } : {}),
    ...
    let B = (0, K.jsx)(`div`, {
      ...
      style: { position: re, left: ne ?? 0, top: ie ?? 0, width: ut },
      onMouseDown: (e) => {
        e.stopPropagation();
      },
      children: (0, K.jsx)(`form`, {
        ...
        style: _t,
        onSubmit: (e) => {
          (e.preventDefault(), A && c(k ? `saved` : `direct`));
        },
                  ...
                  children: (0, K.jsx)(`textarea`, {
                    ...
                    onKeyDown: (e) => {
                      ...
                      e.key === `Enter` &&
                        ...
                        (e.preventDefault(),
                        e.stopPropagation(),
                        c(k || e.metaKey || e.ctrlKey ? `saved` : `direct`));
                    },
                    placeholder: `Add a comment…`,
                    rows: 1,
                    className: i(gt, !T && `!overflow-hidden whitespace-nowrap`),
                    style: {
              ...
              k
                ? (0, K.jsxs)(`div`, {
                    ...
                    className: i(
                      xt,
                      `justify-between`,
                      T ? `scale-100 opacity-100` : `pointer-events-none scale-95 opacity-0`,
                    ),
                    children: [
                      (0, K.jsx)(`button`, {
                        type: `button`,
...
function xn({
  ...
  let [g, _] = (0, L.useState)(!1),
    [v, y] = (0, L.useState)(!1),
    b = (0, L.useMemo)(() => gn(e.editedAt ?? e.createdAt), [e.createdAt, e.editedAt]),
    x = o.trim(),
                    ...
                    children: (0, K.jsxs)(`div`, {
                      ...
                      children: [
                        (0, K.jsxs)($, {
                          ...
                          children: [(0, K.jsx)(c, { className: `size-4` }), `Edit`],
                        }),
                        (0, K.jsxs)($, {
                          destructive: !0,
                          onClick: () => {
                          ...
                          children: [(0, K.jsx)(a, { className: `size-4` }), `Delete`],
                        }),
                      ],
                    }),
                  })
            ...
            ? (0, K.jsxs)(`div`, {
                ...
                children: [
                  (0, K.jsx)(`textarea`, {
                    ...
                    onKeyDown: (e) => {
                      e.key !== `Enter` || e.shiftKey || (e.preventDefault(), x && f());
                    },
                  }),
                  (0, K.jsxs)(`div`, {
...
function Sn({
  ...
  let A = n === `resolved` ? [r, gn(s)].filter(Boolean).join(` · `) : null;
  return (0, K.jsxs)(`div`, {
                      ...
                      children: [
                        n === `resolved`
                          ? h
                            ? (0, K.jsxs)($, {
                                ...
                                children: [(0, K.jsx)(o, { className: `size-4` }), `Reopen thread`],
                              })
                            : null
                          : m
                            ? (0, K.jsxs)($, {
                        ...
                        g
                          ? (0, K.jsxs)($, {
                              ...
                              children: [(0, K.jsx)(a, { className: `size-4` }), `Delete thread`],
                            })
                          : null,
                      ],
                    }),
