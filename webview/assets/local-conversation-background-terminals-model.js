...
import { st as t } from "./src-2.js";
import { $ as n, Bc as r, Q as i, Vc as a, _t as o, g as s } from "./app-server-manager-signals.js";
import { n as c, t as l } from "./jsx-runtime.js";
import { L as u, f as d, h as f, lt as p } from "./vscode-api.js";
import { o as m, r as h } from "./lib-2.js";
import { h as g } from "./persisted-signal-CweW-bgN.js";
import { o as _ } from "./statsig.js";
import { t as v } from "./button.js";
import { n as y } from "./local-conversation-title-signals.js";
import { a as b, d as x, i as S, l as C, n as w, r as ee } from "./dialog-layout.js";
import { n as T } from "./format-automation-next-run-label.js";
var E = new (class {
...
var L = u(f, ({ get: e }) => {
  ...
  for (let r of e(n))
    for (let n of e(i, r))
      t.push({ cwd: e(s, n), hostId: r, id: n, title: e(y, n), turns: e(o, n) ?? [] });
  return t;
});
function R(e) {
  let t = [];
