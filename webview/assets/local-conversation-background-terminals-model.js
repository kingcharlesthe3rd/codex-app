...
import { Es as t, Q as n, Ts as r, Z as i, g as a, ht as o } from "./app-server-manager-signals.js";
import { t as s } from "./jsx-runtime.js";
import { Q as c, S as l, U as u, V as d, wt as f, y as p } from "./setting-storage.js";
import { r as m } from "./product-logger.js";
import { o as h } from "./statsig.js";
import { t as g } from "./button.js";
import { n as _ } from "./local-conversation-title-signals.js";
import { a as v, d as y, i as b, l as ee, n as te, r as x } from "./dialog-layout.js";
...
function D(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, E.jsx)(S, { className: `icon-2xs block shrink-0` })), (t[4] = s))
    : (s = t[4]);
  let c;
  return (
    t[5] !== r || t[6] !== o
...
function j({ isPinned: e, hasUnreadTurn: t, ariaLabel: n, onPin: r, onUnpin: i }) {
  if (t)
    return {
      rest: null,
      hover: (0, E.jsx)(`span`, { "aria-hidden": !0, className: `block h-5 w-5` }),
    };
...
function M(e) {
  ...
  t[12] === f
    ? (S = t[13])
    : ((S = (0, E.jsx)(y, { className: `sr-only`, children: f })), (t[12] = f), (t[13] = S));
  let C;
  t[14] !== m || t[15] !== f
    ? ((C = (0, E.jsx)(v, { children: (0, E.jsx)(b, { title: f, subtitle: m }) })),
      (t[14] = m),
      (t[15] = f),
      (t[16] = C))
    : (C = t[16]);
  ...
  t[20] === w
    ? (O = t[21])
    : ((O = (0, E.jsx)(g, { color: `ghost`, type: `button`, onClick: w, children: D })),
      (t[20] = w),
      (t[21] = O));
  let k;
  t[22] === s
...
function P(t) {
  ...
  n[0] !== i || n[1] !== r
    ? ((a = () => {
        !i || r == null || p.dispatchMessage(`open-in-new-window`, { path: e(r) });
      }),
      (n[0] = i),
      (n[1] = r),
      (n[2] = a))
...
var ne = c(l, ({ get: e }) => {
  ...
  for (let r of e(n))
    for (let n of e(i, r))
      t.push({ cwd: e(a, n), hostId: r, id: n, title: e(_, n), turns: e(o, n) ?? [] });
  return t;
});
function L(e) {
  let t = [];
