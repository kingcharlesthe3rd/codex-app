...
import { D as n, Jn as r, Kn as i } from "./src-2.js";
import { t as a } from "./preload-helper.js";
import { Uo as o, Wo as s, Zn as c, uo as l } from "./app-server-manager-signals.js";
...
import { t as ke } from "./clsx.js";
import { t as Ae } from "./react-dom.js";
import {
  F as je,
  I as P,
  P as Me,
...
import { c as Re, o as F, r as ze } from "./lib-2.js";
import { g as Be } from "./persisted-signal-CweW-bgN.js";
import { o as Ve } from "./statsig.js";
import { t as He } from "./use-is-dark.js";
import { n as Ue } from "./window-zoom-context.js";
import { i as We, t as Ge } from "./route-scope.js";
import { t as Ke } from "./button.js";
import { a as qe } from "./setting-storage.js";
import {
  a as Je,
  c as Ye,
  d as Xe,
  ...
  t as nt,
  u as rt,
} from "./open-workspace-file-CJcJ-CWR.js";
import { r as it } from "./mcp-capability-signals.js";
import { t as at } from "./proxy.js";
import { W as ot, _ as st, g as ct, h as lt, ot as ut, w as dt } from "./app-shell-state.js";
import { r as ft } from "./use-transform.js";
import { l as pt, r as mt } from "./app-shell.js";
import { a as ht, c as gt, f as _t, n as vt, o as yt, u as bt } from "./diff-view-mode.js";
import {
  A as xt,
  B as St,
  F as Ct,
...
import { t as en } from "./hash-code.js";
import { t as tn } from "./app-intl-signal-B.js";
import { n as nn, r as rn } from "./use-resolved-theme-variant.js";
import { r as an } from "./thread-panel-state.js";
import { n as on } from "./get-file-icon.js";
import { t as sn } from "./json-2.js";
import { t as cn } from "./image-square.js";
...
import { t as fn } from "./check-md.js";
import { t as pn } from "./chevron-right.js";
import { n as mn } from "./use-resize-observer.js";
import { r as hn, t as gn } from "./dropdown.js";
import { t as _n } from "./three-dots.js";
import { n as vn, r as yn } from "./code-snippet.js";
import { t as bn } from "./copy.js";
import { r as xn } from "./right-panel-composer-overlay-scroll-reserve.js";
import { t as Sn } from "./mcp-capability-view-frame.js";
import { t as Cn } from "./use-diff-comment-sources.js";
import { l as wn, r as Tn, s as En, u as Dn } from "./pull-request-code-review-comments.js";
import { t as On } from "./file-tree-search-input.js";
import {
  d as kn,
  f as An,
  l as jn,
...
import { r as Gn } from "./artifact-preview-header.js";
import { t as Kn } from "./folders.js";
import { t as qn } from "./history.js";
import { t as Jn } from "./workspace-directory-tree.js";
var Yn = -1,
  Xn = class {
    __id = `file-renderer:${++Yn}`;
    highlighter;
    renderCache;
    computedLang = `text`;
    lineAnnotations = {};
    lineCache;
    constructor(e = { theme: Xt }, t, n) {
      ((this.options = e),
        (this.onRenderUpdate = t),
        (this.workerManager = n),
        n?.isWorkingPool() !== !0 && (this.highlighter = ye(e.theme ?? Xt) ? ae() : void 0));
    }
    setOptions(e) {
      this.options = e;
    }
    ...
    hydrate(e) {
      ...
      (n != null && !Zn(t, n.options) && (n = void 0),
        ...
        this.workerManager?.isWorkingPool() === !0
          ...
          : (this.highlighter ??
            ((this.computedLang = e.lang ?? m(e.name)), this.initializeHighlighter())));
    }
    getRenderOptions(e) {
      let t = (() => {
          if (this.workerManager?.isWorkingPool() === !0)
            return this.workerManager.getFileRenderOptions();
          let { theme: e = Xt, tokenizeMaxLineLength: t = 1e3 } = this.options;
          return { theme: e, useTokenTransformer: T(this.options), tokenizeMaxLineLength: t };
        })(),
        { renderCache: n } = this;
    ...
    getOrCreateLineCache(e) {
      if (e.cacheKey == null) return ((this.lineCache = void 0), x(e.contents));
      let { lineCache: t } = this;
      return (
        (t == null || t.cacheKey !== e.cacheKey) &&
          (t = { cacheKey: e.cacheKey, lines: x(e.contents) }),
        (this.lineCache = t),
        t.lines
      );
    }
      ...
      if (
        ...
        ((this.renderCache.result == null ||
          (!this.renderCache.highlighted &&
            (e !== this.renderCache.file || !y(this.renderCache.renderRange, t)))) &&
        ...
        this.computedLang = e.lang ?? m(e.name);
        let t = this.highlighter != null && ye(r.theme),
    ...
    async asyncHighlight(e) {
      this.computedLang = e.lang ?? m(e.name);
      let t = this.highlighter != null && C(S(this.options.theme)),
        n = this.highlighter != null && O(this.computedLang);
      return (
    ...
    renderFileWithHighlighter(e, t, n = !1) {
      ...
      return { result: v(e, t, r, { forcePlainText: n }), options: r };
    }
      ...
      return (
        w({
          ...
          callback: ({ lineIndex: t, lineNumber: r }) => {
            ...
            if (i != null) {
              (s.children.push(de(`context`, r, `${t}`)), o.push(i), l++);
              let e = this.lineAnnotations[r];
              e != null &&
                (s.children.push(xe(`context`, `annotation`, 1)),
                o.push(
                  re({
                    type: `annotation`,
                    hunkIndex: 0,
    ...
    renderHeader(e) {
      ...
      return b({ fileOrDiff: e, mode: t });
    }
    renderFullHTML(e) {
      return ge(this.renderFullAST(e));
    }
    renderFullAST(e, t = []) {
      return (
        t.push(
          _e({ tagName: `code`, children: this.renderCodeAST(e), properties: { "data-code": `` } }),
        ),
        { ...e.preAST, children: t }
      );
    }
    ...
    renderPartialHTML(e, t = !1) {
      return ge(t ? _e({ tagName: `code`, children: e, properties: { "data-code": `` } }) : e);
    }
    async initializeHighlighter() {
      return ((this.highlighter = await ie(Oe(this.computedLang, this.options))), this.highlighter);
    }
...
var $n = [],
  ...
  tr = class {
    ...
    file;
    renderRange;
    constructor(e = { theme: Xt }, t, n = !1) {
      ((this.options = e),
        (this.workerManager = t),
        (this.isContainerManaged = n),
        (this.fileRenderer = new Xn(e, this.handleHighlightRender, this.workerManager)),
        (this.resizeManager = new f()),
        (this.interactionManager = new ce(`file`, we(e))),
    ...
    setOptions(e) {
      e != null && ((this.options = e), this.interactionManager.setOptions(we(e)));
    }
    mergeOptions(e) {
      this.options = { ...this.options, ...e };
    }
    ...
    render({
      ...
      let { collapsed: s = !1, themeType: c = `system` } = this.options,
        ...
        d =
          a != null && (a.length > 0 || this.lineAnnotations.length > 0)
            ...
            : !1,
        f = !p(this.file, e);
      if (!s && !n && y(l, this.renderRange) && !f && !d) return !1;
      ((this.renderRange = l),
        (this.file = e),
        this.fileRenderer.setOptions({
          ...this.options,
      ...
      if (
        ...
        try {
          let n = this.fileRenderer.renderFile(e, Zt);
    ...
    renderAnnotations() {
      ...
      if (t != null && this.lineAnnotations.length > 0)
        for (let [n, r] of this.lineAnnotations.entries()) {
          ...
          if (a == null || !Qn(r, a.annotation)) {
            a?.element.remove();
            let e = t(r);
            if (e == null) continue;
            ((a = { element: ee(k(r)), annotation: r }),
    ...
    applyHeaderToDOM(e, t) {
      ...
      if (a != null) {
        let e = a(n) ?? void 0;
        ((this.headerCustom = this.upsertHeaderSlotElement(t, this.headerCustom, qt, e)),
          this.headerPrefix?.remove(),
          this.headerMetadata?.remove(),
          (this.headerPrefix = void 0),
          (this.headerMetadata = void 0));
        ...
        let e = i?.(n) ?? void 0,
          r = o?.(n) ?? void 0;
        ((this.headerPrefix = this.upsertHeaderSlotElement(t, this.headerPrefix, Kt, e)),
          (this.headerMetadata = this.upsertHeaderSlotElement(t, this.headerMetadata, Gt, r)),
          this.headerCustom?.remove(),
          (this.headerCustom = void 0));
      }
    }
    ...
    applyPreNodeAttributes(e, { totalLines: t }) {
      ...
      pe(i, this.appliedPreAttributes) || (De(e, i), (this.appliedPreAttributes = i));
    }
    applyErrorToDOM(e, t) {
      this.cleanupErrorWrapper();
...
var ir = -1,
  ar = class extends tr {
    __id = `virtualized-file:${++ir}`;
    top;
    height = 0;
    heightCache = new Map();
    isVisible = !1;
    isSetup = !1;
    constructor(e, t, n = Wt, r, i = !1) {
  ...
  cr = t((e) => {
    ...
    function he(e) {
      (le.current === e && (M(ce), M(le)), de.current === e && (M(de), (Qf._currentValue = ie)));
    }
    var ge, _e;
    function ve(e) {
      if (ge === void 0)
...
` +
    ...
    var Ce = Object.prototype.hasOwnProperty,
      ...
      P = t.unstable_UserBlockingPriority,
    ...
    var Sn = {
      ...
      Nn = xn(p({}, Sn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Pn = xn(
        p({}, Sn, {
    ...
    function gr() {
      lr && (lr.detachEvent(`onpropertychange`, R), (I = lr = null));
    }
    function R(e) {
      if (e.propertyName === `value` && L(I)) {
        var t = [];
        (cr(t, I, e, rn(e)), ln(ur, t));
      }
    }
    function _r(e, t, n) {
      e === `focusin`
        ? (gr(), (lr = t), (I = n), lr.attachEvent(`onpropertychange`, R))
        : e === `focusout` && gr();
    }
    function vr(e) {
      if (e === `selectionchange` || e === `keyup` || e === `keydown`) return L(I);
    }
    function yr(e, t) {
    ...
    function fi(e, t, n, r, a, o) {
      ...
      if (((r = e), typeof e == `function`)) li(e) && (s = 1);
        ...
        a: switch (e) {
          case ee:
            return ((e = ci(31, n, t, a)), (e.elementType = ee), (e.lanes = o), e);
          case _:
          ...
          case v:
            ...
            break;
          case y:
            return ((e = ci(12, n, t, a | 2)), (e.elementType = y), (e.lanes = o), e);
          case C:
            return ((e = ci(13, n, t, a)), (e.elementType = C), (e.lanes = o), e);
          case w:
            return ((e = ci(19, n, t, a)), (e.elementType = w), (e.lanes = o), e);
          default:
    ...
    function vi(e, t) {
      if (typeof e == `object` && e) {
        var n = _i.get(e);
        return n === void 0 ? ((t = { value: e, source: t, stack: Se(t) }), _i.set(e, t), t) : n;
      }
    ...
    function Ia(e) {
      ...
      function l(e, t, n, r) {
        ...
        return i === _
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` && i && i.$$typeof === E && Da(i) === t.type))
      ...
      function f(e, t, n) {
        ...
        if (typeof t == `object` && t) {
          switch (t.$$typeof) {
            case h:
              return (
                (n = fi(t.type, t.key, t.props, null, e.mode, n)), Pa(n, t), (n.return = e), n
              );
            case g:
          ...
          if (re(t) || k(t)) return ((t = pi(t, e.mode, n, null)), (t.return = e), t);
      ...
      function m(e, t, n, r, i) {
        ...
        if (typeof r == `object` && r) {
          ...
          if (re(r) || k(r)) return ((e = e.get(n) || null), d(t, e, r, i, null));
                ...
                for (var l = o.key; r !== null; ) {
                  if (r.key === l) {
                    if (((l = o.type), l === _)) {
                      ...
                      r.elementType === l ||
                      (typeof l == `object` && l && l.$$typeof === E && Da(l) === r.type)
                    ) {
    ...
    function pc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((ao(t), a))
          ...
          if (((r = q), r !== null && ((s = nt(r, n)), s !== 0 && s !== o.retryLane)))
    ...
    function Sc(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (((s = q), s !== null && ((r = nt(s, n)), r !== 0 && r !== l.retryLane)))
      ...
      return a
        ? (so(t),
          ...
          u === null ? ((c = pi(c, a, n, null)), (c.flags |= 2)) : (c = ui(u, c)),
          (c.return = t),
          (r.return = t),
          (r.sibling = c),
          (t.child = r),
          ...
          c === null
            ...
            : ((a = c.cachePool),
              a === null
                ? (a = ba())
                : ((l = oa._currentValue), (a = a.parent === l ? a : { parent: l, pool: l })),
          ...
          return (
            e === null &&
              ...
              ((a = r = z) &&
                ...
                r === null
                  ? (a = !1)
                  : ((t.stateNode = r), (Ni = t), (z = cf(r.firstChild)), (Fi = !1), (a = !0))),
              a || Li(t)),
            me(t),
            (a = t.type),
            (o = t.pendingProps),
          ...
          return (
            ...
            e === null
              ...
              : ((e.lanes & n) !== 0 && (Va(e, t), Ja(t, null, null, n), qa()),
                ...
                (o = t.memoizedState),
                a.parent === r
                  ? ((r = o.cache), qi(t, oa, r), r !== a.cache && Xi(t, [oa], n, !0))
                  : ((a = { parent: r, cache: r }),
                    (t.memoizedState = a),
    ...
    function Ic(e, t) {
      (t !== null && (e.flags |= 4),
        e.flags & 16384 && ((t = e.tag === 22 ? 536870912 : Xe()), (e.lanes |= t), (Yl |= t)));
    }
    function Lc(e, t) {
      if (!B)
        switch (e.tailMode) {
      ...
      switch ((ji(t), t.tag)) {
        ...
        case 27:
          if ((he(t), (n = ue.current), (a = t.type), e !== null && t.stateNode != null))
            ...
            ((e = ce.current), Bi(t) ? Ri(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Nc(t)));
          }
          return (W(t), null);
        case 5:
        ...
        case 6:
          if (e && t.stateNode != null) e.memoizedProps !== r && Nc(t);
            ...
            if (((e = ue.current), Bi(t))) {
              if (((e = t.stateNode), (n = t.memoizedProps), (r = null), (a = Ni), a !== null))
                switch (a.tag) {
                  case 27:
                  case 5:
                    r = a.memoizedProps;
    ...
    function md(e, t, n, r, i) {
      if (t === `submit` && n && n.stateNode === i) {
        var a = fd((i[lt] || null).action),
          o = r.submitter;
        o &&
          ((t = (t = o[lt] || null) ? fd(t.formAction) : o.getAttribute(`formAction`)),
          t !== null && ((a = t), (o = null)));
      ...
      ln(function () {
        ...
        if (!(t & 7)) {
          ...
          switch (((y = r ? yt(r) : window), e)) {
            case `focusin`:
              (or(y) || y.contentEditable === `true`) && ((Ar = y), (jr = r), (Mr = null));
              break;
            case `focusout`:
              Mr = jr = Ar = null;
              break;
  ...
  return (0, I.jsxs)(I.Fragment, {
    children: [
      u == null
        ? (0, I.jsxs)(I.Fragment, {
            children: [
              d != null && (0, I.jsx)(`div`, { slot: `header-prefix`, children: d }),
              f != null && (0, I.jsx)(`div`, { slot: `header-metadata`, children: f }),
            ],
          })
        : (0, I.jsx)(`div`, { slot: qt, children: u }),
      i != null && a?.map((e, t) => (0, I.jsx)(`div`, { slot: k(e), children: i(e) }, t)),
      l != null && (0, I.jsx)(`div`, { slot: `gutter-utility-slot`, style: Te, children: l(c) }),
    ],
  });
}
var L = e(u(), 1),
  dr = typeof window > `u` ? L.useEffect : L.useLayoutEffect;
function fr({
  file: e,
  options: t,
  lineAnnotations: n,
  ...
  let l = N(),
    ...
    f = ue((r) => {
      if (r != null) {
        ...
        (l == null
          ? (d.current = new tr(
              pr({ hasCustomHeader: s, hasGutterRenderUtility: o, options: t }),
              c ? void 0 : u,
              !0,
            ))
          : (d.current = new ar(
  ...
  return (
    dr(() => {
      ...
      let i = pr({ hasCustomHeader: s, hasGutterRenderUtility: o, options: t }),
        a = !ve(d.current.options, i);
      (d.current.setOptions(i),
        d.current.render({ file: e, lineAnnotations: n, forceRender: a }),
        r !== void 0 && d.current.setSelectedLines(r));
    }),
    { ref: f, getHoveredLine: (0, L.useCallback)(() => d.current?.getHoveredLine(), []) }
  );
}
function pr({ options: e, hasCustomHeader: t, hasGutterRenderUtility: n }) {
  return n || t
...
function vr({
  ...
  if ((Ot(n, { includeShadowRoots: !0 }), i || e == null)) return;
  let a = gr(e.matches).get(r);
  a == null ||
    a.length === 0 ||
    yr({ activeMatchId: t, fileDiffElement: n, query: e.query, sourceMatches: a }) ||
    Mt({ target: n, query: e.query, maxMatches: a.length, includeShadowRoots: !0 }).matches.forEach(
      (e, n) => {
        let r = a[n];
        r != null && (wt({ element: e, matchId: r.id }), r.id === t && e.classList.add(Dt));
      },
    );
}
function yr({ activeMatchId: e, fileDiffElement: t, query: n, sourceMatches: r }) {
  ...
  for (let r of i.values()) {
    a = !0;
    let i = Tt({ container: t, lineNumber: r.lineNumber, side: r.side, includeShadowRoots: !0 });
    i != null &&
      ((o = !0),
      Mt({
        target: i,
        ...
        let i = r.matches[n];
        i != null && (wt({ element: t, matchId: i.id }), i.id === e && t.classList.add(Dt));
      }));
  }
...
function Sr(e) {
  let t = e.split(/[\\/]/).pop()?.toLowerCase() ?? ``,
    n = br.get(t);
  if (n != null) return n;
  for (let [e, n] of xr) if (t.endsWith(e)) return n;
}
function Cr(e) {
  let t = (0, R.c)(15),
  ...
  let c = s,
    l;
  t[1] !== r || t[2] !== c ? ((l = Xe(r, c)), (t[1] = r), (t[2] = c), (t[3] = l)) : (l = t[3]);
  let u = l,
    d;
  t[4] !== r || t[5] !== i || t[6] !== o || t[7] !== c
    ? ((d = Qe({ fileViewer: i, path: r, readContents: o, resourceUri: c })),
      (t[4] = r),
      (t[5] = i),
      (t[6] = o),
      (t[7] = c),
...
function wr(e) {
  let t = (0, R.c)(22),
    ...
    l;
  t[0] === i ? (l = t[1]) : ((l = Mr(i)), (t[0] = i), (t[1] = l));
  let u;
  t[2] !== a || t[3] !== s
    ? ((u = (e) => {
    ...
    : (u = t[4]);
  let d;
  t[5] === i ? (d = t[6]) : ((d = Nr(i)), (t[5] = i), (t[6] = d));
  let f;
  t[7] === d
    ? (f = t[8])
  ...
  t[14] !== r || t[15] !== i || t[16] !== o || t[17] !== c
    ? ((m = (0, I.jsx)(Tr, { labels: r, line: i, onOpenBlameLink: o, repositoryWebUrl: c })),
      (t[14] = r),
      (t[15] = i),
      (t[16] = o),
      (t[17] = c),
  ...
  return (
    t[19] !== p || t[20] !== m
      ? ((h = (0, I.jsxs)(I.Fragment, { children: [p, m] })), (t[19] = p), (t[20] = m), (t[21] = h))
      : (h = t[21]),
    h
  );
}
function Tr(e) {
  ...
  let s = o,
    c;
  t[3] === r ? (c = t[4]) : ((c = Or(r)), (t[3] = r), (t[4] = c));
  let l = c,
    u;
  t[5] !== r || t[6] !== a ? ((u = kr(r, a)), (t[5] = r), (t[6] = a), (t[7] = u)) : (u = t[7]);
  let d = u,
    f;
  t[8] !== r || t[9] !== a ? ((f = Ar(r, a)), (t[8] = r), (t[9] = a), (t[10] = f)) : (f = t[10]);
  let p = f,
    m;
  t[11] === r.authorTime
    ? (m = t[12])
    : ((m = Rr(r.authorTime)), (t[11] = r.authorTime), (t[12] = m));
  let h = m,
    g;
  t[13] === s
    ? (g = t[14])
    : ((g = (0, I.jsx)(`span`, { "data-file-blame-tooltip-title": ``, children: s })),
      (t[13] = s),
      (t[14] = g));
  let _;
  t[15] !== l || t[16] !== r || t[17] !== i
    ? ((_ = l == null ? Nr(r) : (0, I.jsx)(Dr, { link: l, onOpenBlameLink: i })),
      (t[15] = l),
      (t[16] = r),
      (t[17] = i),
      (t[18] = _))
  ...
  t[19] !== n.author || t[20] !== _
    ? ((v = (0, I.jsx)(Er, { label: n.author, children: _ })),
      (t[19] = n.author),
      (t[20] = _),
      (t[21] = v))
    : (v = t[21]);
  let y;
  t[22] !== h || t[23] !== n.date
    ? ((y = h && (0, I.jsx)(Er, { label: n.date, children: h })),
      (t[22] = h),
      (t[23] = n.date),
      (t[24] = y))
    : (y = t[24]);
  ...
  t[25] !== d || t[26] !== r.commitSha || t[27] !== i
    ? ((b = d == null ? r.commitSha.slice(0, 8) : (0, I.jsx)(Dr, { link: d, onOpenBlameLink: i })),
      (t[25] = d),
      (t[26] = r.commitSha),
      (t[27] = i),
      (t[28] = b))
  ...
  t[29] !== n.commit || t[30] !== b
    ? ((x = (0, I.jsx)(Er, { label: n.commit, children: b })),
      (t[29] = n.commit),
      (t[30] = b),
      (t[31] = x))
    : (x = t[31]);
  ...
  t[32] !== n.pullRequest || t[33] !== i || t[34] !== p
    ? ((S =
        ...
        (0, I.jsx)(Er, {
          label: n.pullRequest,
          children: (0, I.jsx)(Dr, { link: p, onOpenBlameLink: i }),
        })),
      (t[32] = n.pullRequest),
      (t[33] = i),
      (t[34] = p),
  ...
  t[36] !== x || t[37] !== S || t[38] !== v || t[39] !== y
    ? ((C = (0, I.jsxs)(`span`, { "data-file-blame-tooltip-meta": ``, children: [v, y, x, S] })),
      (t[36] = x),
      (t[37] = S),
      (t[38] = v),
      (t[39] = y),
...
function Er(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, I.jsx)(`span`, { "data-file-blame-tooltip-label": ``, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
    ? (a = t[3])
    : ((a = (0, I.jsx)(`span`, { "data-file-blame-tooltip-value": ``, children: n })),
      (t[2] = n),
      (t[3] = a));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, I.jsxs)(I.Fragment, { children: [i, a] })), (t[4] = i), (t[5] = a), (t[6] = o))
      : (o = t[6]),
    o
  );
}
...
function kr(e, t) {
  return Fr(e.commitSha)
    ? jr(t, `commit/${encodeURIComponent(e.commitSha)}`, e.commitSha.slice(0, 8))
    : null;
}
function Ar(e, t) {
  let n = Lr(e.summary);
  return n == null ? null : jr(t, `pull/${n}`, `#${n}`);
}
function jr(e, t, n) {
  return e == null || !Ir(e) ? null : { label: n, url: `${e.replace(/\/+$/, ``)}/${t}` };
}
function Mr(e) {
  return [Nr(e), Rr(e.authorTime), Pr(e)].filter((e) => !!e).join(` `);
}
function Nr(e) {
...
function Gr(e) {
  let t = Hr.get(e);
  if (t != null) return t;
  let n = (0, Vr.createRoot)(e);
  return (Hr.set(e, n), n);
}
function Kr(e) {
  let t = e.querySelector(`[data-file-blame-gutter]`);
  t != null && (Hr.get(t)?.unmount(), Hr.delete(t), t.remove());
}
function qr(e) {
  return e.metadata.hunks.flatMap((e) => {
    ...
    for (let r of e.hunkContent) {
      ...
      } else r.deletions > 0 && t.push(Xr(e, n));
      n += r.additions;
    }
    return t;
  });
...
function $r(e) {
        ...
        (s = e.map((t, n) => {
          ...
          return (0, I.jsxs)(
            `li`,
            {
              ...
              children: [
                (0, I.jsx)(`span`, {
                  className: ke(`whitespace-nowrap`, r && `font-medium text-token-text-primary`),
                  children: t,
                }),
                r
                  ? null
  ...
  let f;
  t[11] !== o || t[12] !== s
    ? ((f = (0, I.jsx)(`ol`, { className: o, children: s })), (t[11] = o), (t[12] = s), (t[13] = f))
    : (f = t[13]);
  let p;
  t[14] !== c || t[15] !== f
  ...
  return (
    t[19] !== l || t[20] !== u || t[21] !== p || t[22] !== m
      ? ((h = (0, I.jsxs)(`nav`, { "aria-label": l, className: u, children: [p, m] })),
        (t[19] = l),
        (t[20] = u),
        (t[21] = p),
        (t[22] = m),
...
function ti({
  ...
  let o = () => kt({ container: e, matchId: t, includeShadowRoots: n });
  ...
  return {
    ...
    async ensureVisible(t, n) {
      ...
      let i = r.getFileContainer(t.path),
        a = jt(t);
      if ((i == null ? null : kt({ container: i, matchId: a, includeShadowRoots: !0 })) == null) {
        if (
          n?.signal?.aborted ||
          (n?.signal == null
...
function ii(e, t) {
  ...
  for (let s of t)
    for (let t of s.hunks) {
      ...
      let { offsets: l, totalMatches: u, isCapped: d } = Et(c, n, ni - r.length);
      ((i += u), d && (o = !0));
...
var ci = 20,
  li = 8;
function ui({ contents: e, getFileContainer: t, path: n }) {
  return ri({
    contextId: `file:${n}`,
    getFiles: () => [
      {
    ...
    scrollAdapter: {
      ...
      scrollToLocation: async (e, r) => {
        ...
        let i = t();
        i != null && (await fi(i, e.lineStart, r));
      },
    },
  });
}
...
async function fi(e, t, n) {
  for (let r = 0; r < li; r++) {
    if (n?.signal?.aborted || !pi(e, t)) return;
    await ei();
  }
}
function pi(e, t) {
...
function hi(e) {
  ...
  return Number.isFinite(n) ? n : ci;
}
function gi(e) {
  let t = (0, R.c)(5),
    { type: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = (0, I.jsx)(_i, { type: n })), (t[0] = n), (t[1] = r));
  let i;
...
function vi() {
  let e = (0, R.c)(31),
    ...
    u = P($t),
    d;
  e[0] === t.value ? (d = e[1]) : ((d = We(t.value)), (e[0] = t.value), (e[1] = d));
  let f = d,
  ...
  bb0: {
    ...
    (e[6] !== l || e[7] !== s || e[8] !== n || e[9] !== t
      ? ((r = Tn({ comments: [...n, ...(t ?? [])], filePaths: s.map(yi), workspaceRoot: l })),
        (e[6] = l),
        (e[7] = s),
        (e[8] = n),
        (e[9] = t),
    ...
    ? ((x = (e) => {
        s.some((t) => t.path === e) &&
          requestAnimationFrame(() => {
            (Bt(t, e), !n && bi(e)?.scrollIntoView({ behavior: `auto`, block: `start` }));
          });
      }),
      (e[11] = s),
      (e[12] = n),
  ...
  let S = x,
    C;
  e[15] === t ? (C = e[16]) : ((C = (e) => Lt(t, e)), (e[15] = t), (e[16] = C));
  let w;
  e[17] !== o || e[18] !== C
    ? ((w = (0, I.jsx)(`div`, {
...
function wi(e) {
  let t = je(Ge),
    ...
    u = ft(l);
  !n && u.get() !== l && u.set(l);
  let { isMounted: d, opacity: f, animatedSize: p } = mt({ animation: r, size: u, isVisible: s }),
    m = (0, L.useCallback)(
      (e) => {
        if (e < ut(Ci)) {
          dt(t, !1);
  ...
  return !d && !s
    ...
    : (0, I.jsxs)(at.div, {
        ref: a,
        style: { maxWidth: `${Si * 100}%`, opacity: f, width: p },
...
`,
  ...
  Oi = `${be({ includeDiffHeader: !1, includeSimpleLineSeparators: !1, rootSelector: `[data-file]`, surface: `var(--color-token-main-surface-primary)` })}
${Ti}
${Ei}
`;
function ki(e) {
...
function Ai(e) {
  ...
  t[0] !== n || t[1] !== s
    ? ((d = {
        params: { hostId: n, path: s, contentSampleByteLimit: r, contentSampleMaxFileBytes: Ye },
      }),
      (t[0] = n),
      (t[1] = s),
      (t[2] = d))
    : (d = t[2]);
  let { data: f, isError: p } = Ie(`read-file-metadata`, d),
    m;
  if (t[3] !== s) {
    let e = Je(s);
    ((m = e != null && et(e.importKind)), (t[3] = s), (t[4] = m));
  } else m = t[4];
  let h = m,
    g = f?.contentKind,
    _;
  t[5] !== s || t[6] !== g ? ((_ = $e(s, g)), (t[5] = s), (t[6] = g), (t[7] = _)) : (_ = t[7]);
  let v = _,
    y = f?.contentKind,
    b;
  t[8] !== s || t[9] !== y ? ((b = tt(s, y)), (t[8] = s), (t[9] = y), (t[10] = b)) : (b = t[10]);
  let x = b,
    S = P(ht),
    C = Me(it, n),
    w;
  t[11] !== C || t[12] !== s
    ? ((w = rt(s, C)), (t[11] = C), (t[12] = s), (t[13] = w))
    : (w = t[13]);
  let T = w,
    E = Ve(`1420162012`),
    ee = T != null && a == null,
    D = (x === `toggle` || ee) && a == null,
    O = f?.contentKind,
    k;
  t[14] !== s || t[15] !== O
    ? ((k = Ze(s, O)), (t[14] = s), (t[15] = O), (t[16] = k))
    : (k = t[16]);
  let te = k;
  if (p || (f && !f.isFile)) {
    let e;
    return (
      t[17] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, I.jsx)(Hi, { isError: !0, isLoading: !1 })), (t[17] = e))
        : (e = t[17]),
      e
    );
  }
  if (f == null) {
    ...
    return (
      t[18] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, I.jsx)(Hi, { isError: !1, isLoading: !0 })), (t[18] = e))
        : (e = t[18]),
      e
    );
  }
  ...
  if (T != null && D && S) {
    j = !0;
    let e;
    (t[19] !== n || t[20] !== T || t[21] !== s
      ? ((e = (0, I.jsx)(Fi, { fileViewer: T, hostId: n, path: s })),
        (t[19] = n),
        (t[20] = T),
        (t[21] = s),
        (t[22] = e))
    ...
    j = ee;
    let e;
    (t[23] === te ? (e = t[24]) : ((e = (0, I.jsx)(gi, { type: te })), (t[23] = te), (t[24] = e)),
      (ne = e));
  } else if (f && f.sizeBytes != null && f.sizeBytes > 10485760) {
    let e;
    (t[25] === f.sizeBytes
      ? (e = t[26])
      : ((e = (0, I.jsx)(Vi, { sizeBytes: f.sizeBytes })), (t[25] = f.sizeBytes), (t[26] = e)),
      (ne = e));
  } else if (v != null && (x === `always` || (D && S))) {
    j = D;
    let e;
    (t[27] !== E || t[28] !== n || t[29] !== s || t[30] !== v
      ? ((e = (0, I.jsx)(Pi, { gitBlameFeatureEnabled: E, hostId: n, path: s, previewKind: v })),
        (t[27] = E),
        (t[28] = n),
        (t[29] = s),
        (t[30] = v),
...
function ji(e) {
  ...
  let S;
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, I.jsx)(Kn, { className: `icon-sm` })), (t[12] = S))
    : (S = t[12]);
  let C;
  t[13] !== b || t[14] !== x
    ? ((C = (0, I.jsx)(
  ...
  t[19] !== g || t[20] !== a || t[21] !== T
    ? ((E = (0, I.jsx)($r, { cwd: g, path: a, trailingContent: T })),
      (t[19] = g),
      (t[20] = a),
      (t[21] = T),
      (t[22] = E))
  ...
  let ee = `${r}:${a}`,
    D;
  t[23] !== n || t[24] !== ee
    ? ((D = (0, I.jsx)(`div`, { className: `min-w-0 flex-1`, children: n }, ee)),
      (t[23] = n),
      (t[24] = ee),
      (t[25] = D))
    : (D = t[25]);
  ...
  let k;
  t[32] !== D || t[33] !== O
    ? ((k = (0, I.jsxs)(`div`, { className: `flex min-h-0 flex-1`, children: [D, O] })),
      (t[32] = D),
      (t[33] = O),
      (t[34] = k))
    : (k = t[34]);
...
function Mi() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, I.jsx)(Kn, { className: `icon-lg text-token-text-secondary` })), (e[0] = t))
    : (t = e[0]);
  let n;
...
function Ni(e) {
  ...
  let d;
  t[9] !== r || t[10] !== i
    ? ((d = (0, I.jsx)(Gn, { hostId: r, path: i, showLabel: !0 })),
      (t[9] = r),
      (t[10] = i),
      (t[11] = d))
    : (d = t[11]);
  ...
  return (
    t[12] !== u || t[13] !== d
      ? ((f = (0, I.jsxs)(I.Fragment, { children: [u, d] })), (t[12] = u), (t[13] = d), (t[14] = f))
      : (f = t[14]),
    f
  );
}
function z(e) {
  ...
  t[10] !== n || t[11] !== r || t[12] !== l || t[13] !== c
    ? ((E = function (e) {
        (e.preventDefault(), Wn(l, r, { hostId: n, tabId: c }) && h(!1));
      }),
      (t[10] = n),
      (t[11] = r),
      (t[12] = l),
  ...
  t[18] !== l || t[19] !== p
    ? ((k = function (e) {
        (e.preventDefault(), l.set(gt, !p), h(!1));
      }),
      (t[18] = l),
      (t[19] = p),
      (t[20] = k))
  ...
  t[21] !== d || t[22] !== l
    ? ((ne = function (e) {
        e.preventDefault();
        let t = !d;
        (l.set(vt, t), t && Be(l, { eventName: `codex_file_viewer_git_blame_enabled` }), h(!1));
      }),
      (t[21] = d),
      (t[22] = l),
      (t[23] = ne))
  ...
  t[26] !== n || t[27] !== r || t[28] !== l.queryClient
    ? ((ie = function (e) {
        (e.preventDefault(), un(l.queryClient, { hostId: n, path: r }), h(!1));
      }),
      (t[26] = n),
      (t[27] = r),
      (t[28] = l.queryClient),
  ...
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, I.jsx)(_n, { className: `icon-xs` })), (t[30] = oe))
    : (oe = t[30]);
  let se;
  t[31] === _
    ? (se = t[32])
  ...
  t[34] === j
    ? (N = t[35])
    : ((N = (0, I.jsx)(hn.Item, { onSelect: j, LeftIcon: bn, children: M })),
      (t[34] = j),
      (t[35] = N));
  let ce;
  ...
  t[37] === ae
    ? (le = t[38])
    : ((le = (0, I.jsx)(hn.Item, { onSelect: ae, LeftIcon: bn, children: ce })),
      (t[37] = ae),
      (t[38] = le));
  let ue;
  t[39] !== ee || t[40] !== a
  ...
  t[42] !== O || t[43] !== f || t[44] !== x || t[45] !== o
    ? ((de = o ? (0, I.jsx)(hn.Item, { onSelect: O, LeftIcon: f ? sn : cn, children: x }) : null),
      (t[42] = O),
      (t[43] = f),
      (t[44] = x),
      (t[45] = o),
  ...
  t[47] !== te || t[48] !== s || t[49] !== y || t[50] !== p
    ? ((fe = s ? (0, I.jsx)(hn.Item, { onSelect: te, LeftIcon: p ? vn : yn, children: y }) : null),
      (t[47] = te),
      (t[48] = s),
      (t[49] = y),
      (t[50] = p),
...
function B(e) {
  ...
  if (u == null) {
    ...
    return (
      t[3] !== d || t[4] !== f
        ? ((e = (0, I.jsx)(Hi, { isError: d, isLoading: f })), (t[3] = d), (t[4] = f), (t[5] = e))
        : (e = t[5]),
      e
    );
  }
...
function Pi(e) {
  ...
  let s = o,
    c;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, I.jsx)(Hi, { isError: !0, isLoading: !1 })), (t[3] = c))
    : (c = t[3]);
  let l = c;
  switch (a) {
    case `image`: {
    ...
    case `markdown`: {
      let e;
      t[6] !== n || t[7] !== r || t[8] !== i
        ? ((e = (0, I.jsx)(B, { gitBlameFeatureEnabled: n, hostId: r, path: i })),
          (t[6] = n),
          (t[7] = r),
          (t[8] = i),
          (t[9] = e))
...
function Fi(e) {
  ...
  t[0] !== r || t[1] !== i
    ? ((a = async (e) => {
        if (e === `blob`) {
          let { contentsBase64: e } = await Fe(`read-file-binary`, {
            params: { hostId: r, path: i },
          });
          if (e == null) throw Error(`File could not be read.`);
          return { blob: e };
        }
        let { contents: t } = await Fe(`read-file`, { params: { hostId: r, path: i } });
        return { text: t };
      }),
      (t[0] = r),
      (t[1] = i),
...
function Ii({
  ...
  let f = je(Ge),
    ...
    { data: re } = c(
      ...
      v,
      `blame-file`,
      (e) => ({ cwd: h ?? i(e.root), operationSource: `review_model`, path: l }),
      `review_model`,
      { enabled: _ && h != null, staleTime: Le.FIVE_SECONDS },
    ),
    ...
    ae = (0, L.useMemo)(() => Jr(y?.diff ?? null), [y?.diff]),
    oe = ee?.path === l ? ee.lineNumber : null,
    se = (0, L.useRef)(null),
    M = (0, L.useRef)(null),
    N = rn(nn()),
    ce = We(f.value) ?? `new-conversation`,
    le = f.value.routeKind === `local-thread` ? f.value.conversationId : null,
    { commentProps: ue } = Cn({
      conversationId: ce,
      enablePullRequestComments: P(At) !== `last-turn`,
      localConversationId: le,
    }),
    de = s == null ? null : { end: a ?? s, start: s },
    fe = `${l}:${s ?? ``}:${a ?? ``}`,
    [pe, me] = (0, L.useState)(null),
    ge = pe?.key === fe ? pe.lines : de,
    _e = P(gt),
    ve = qe(n.lightCodeThemeId),
    ye = qe(n.darkCodeThemeId),
    be = He(),
    xe = N === `light` ? _t(ve, `light`) : _t(ye, `dark`);
  bt(void 0);
  let we = (0, L.useMemo)(
      () => ui({ contents: e, getFileContainer: () => x.current, path: l }),
      [e, x, l],
    ),
    Te = (0, L.useMemo)(() => {
      let t = Sr(l);
      return {
        cacheKey: `review-file-source:${en(r)}:${en(l)}:${en(e)}`,
        contents: e,
        name: l,
        ...(t == null ? {} : { lang: t }),
      };
    }, [e, r, l]),
    {
      ...
      onSelectionClear: () => {
        me({ key: fe, lines: null });
      },
      conversationId: ce,
      ...ue,
    }),
    Ae = (0, L.useMemo)(() => Ee.map(Ui).filter((e) => e != null), [Ee]);
  function Pe() {
    M.current = null;
  }
  function Fe({ event: e, lineNumber: t }) {
    (e.metaKey || e.ctrlKey) && nt({ cwd: h, hostId: r, line: t, path: l });
  }
  function Ie(e, t) {
    De.has(Nn(`additions`, e)) ||
      Oe({ side: `additions`, lineNumber: e, ...(t != null && t !== e ? { startLine: t } : {}) });
  }
  function F(e) {
    let t = Math.max(e.start, e.end);
    (me({ key: fe, lines: e }), Ie(t, Math.min(e.start, e.end)));
  }
  function ze() {
    let e = se.current ?? M.current?.lineNumber;
    ((se.current = null), e != null && Ie(e));
  }
  function Be(e) {
    let t = Wi(e);
  ...
  let Ke = (0, L.useCallback)(
      (e) => {
        Ur(
          ...
          (e) => {
            Ne.dispatchMessage(`open-in-browser`, { url: e });
          },
          (e) => {
    ...
    children: (0, I.jsx)(Se.Provider, {
      ...
      children: (0, I.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, I.jsx)(Li, { sourceSearchSource: we }),
          (0, I.jsx)(`div`, {
            ref: $e,
            "data-review-path": l,
            children:
...
function Vi(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((i = Ki(Ye)), (t[1] = i)) : (i = t[1]);
  let a;
  t[2] === n ? (a = t[3]) : ((a = Ki(n)), (t[2] = n), (t[3] = a));
  let o;
  return (
    t[4] === a
      ? (o = t[5])
...
function Yi(e, t, n = {}) {
  let {
    ...
    v = Vn(e),
    y = p ?? e.get(tn).formatMessage(Ji.openFileTabTitle),
    b = on(t ?? void 0),
    x = t == null ? y : Bn({ cwd: v, path: t });
  t != null && Rn(e, { cwd: v, hostId: g, path: t });
  let S = h.openTab(e, qi, {
    ...(t == null ? {} : { contextMenuItems: (e) => zn(e, { cwd: v, hostId: g, path: t }) }),
    defaultState: Ln,
    ...
    props: {
      ...
      onSelectFile: (n, r) => {
        (Yi(e, n, { controller: h, hostId: g, isPreview: t == null ? !1 : r?.isPreview }),
          t ?? h.closeTab(e, _));
      },
    ...
    onMove: (n, r) => ({
      props: {
        ...
        workspaceRoot: m ?? null,
        onSelectFile: (n, i) => {
          (Yi(e, n, { controller: r, hostId: g, isPreview: t == null ? !1 : i?.isPreview }),
            t ?? r.closeTab(e, _));
        },
        ...(c == null ? {} : { initialLine: c }),
        ...(i == null ? {} : { initialEndLine: i }),
    ...
    id: _,
    title: t == null ? y : (p ?? l(t)),
    tooltip: x,
  });
  (u && h.resetTabState(e, S), t ?? dt(e, !0, { animate: !1 }), Un(e, e.get(h.tabs$)));
}
export { ti as a, hr as c, ri as i, lr as l, ki as n, ei as o, wi as r, _r as s, Yi as t };
//# sourceMappingURL=review-file-source-tab-Bnr-J27I.js.map
