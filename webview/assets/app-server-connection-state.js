...
import { n as a } from "./spinner.js";
import { t as o } from "./tooltip.js";
import { m as s } from "./chunk-109.js";
import { t as c } from "./use-app-server-connection-state-CCnw-hJJ.js";
import { t as l } from "./alert-2.js";
function u(e, t) {
  switch (t.code) {
...
var h = t(),
  g = e(),
  _ = {
    connecting: (0, g.jsx)(a, {}),
    restarting: (0, g.jsx)(a, {}),
...
function y(e) {
  let t = (0, h.c)(33),
    { hostId: r, onLoginRequiredClick: a } = e,
    l = n(),
    u = s(),
    { error: d, state: f } = c(r);
  ...
  let m =
      ...
      (d?.code === `login-required` && a == null),
    y = d?.code === `login-required` && a != null,
    b;
  t[0] !== d || t[1] !== l || t[2] !== y || t[3] !== f
  ...
  t[9] === D.iconClassName
    ? (O = t[10])
    : ((O = i(`icon-2xs inline-flex shrink-0 items-center justify-center`, D.iconClassName)),
      (t[9] = D.iconClassName),
      (t[10] = O));
  let k = _[f],
    A;
