...
import { a as r, l as i, n as a, o, r as s, s as c, t as l } from "./dist-1.js";
import { a as u, i as d, n as f, r as ee, t as te } from "./chunk-64.js";
function p(e) {
  return function (t) {
...
function ae() {
  ...
  let g,
    ...
    S = Je();
  t.isSupported =
    typeof oe == `function` && typeof ce == `function` && y && y.createHTMLDocument !== void 0;
  let {
      MUSTACHE_EXPR: Le,
      ERB_EXPR: Re,
      TMPLIT_EXPR: Be,
    ...
    q = function () {
      ...
      if (!(G && G === e)) {
        if (
          ((!e || typeof e != `object`) && (e = {}),
          (e = h(e)),
          (U = bt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? `text/html` : e.PARSER_MEDIA_TYPE),
          (W = U === `application/xhtml+xml` ? ve : _e),
          (w = b(e, `ALLOWED_TAGS`) ? m({}, e.ALLOWED_TAGS, W) : Qe),
          (T = b(e, `ALLOWED_ATTR`) ? m({}, e.ALLOWED_ATTR, W) : E),
          (H = b(e, `ALLOWED_NAMESPACES`) ? m({}, e.ALLOWED_NAMESPACES, ve) : gt),
          (ft = b(e, `ADD_URI_SAFE_ATTR`) ? m(h(pt), e.ADD_URI_SAFE_ATTR, W) : pt),
          (ut = b(e, `ADD_DATA_URI_TAGS`) ? m(h(dt), e.ADD_DATA_URI_TAGS, W) : dt),
          ...
          e.FORBID_CONTENTS && (R === lt && (R = h(R)), m(R, e.FORBID_CONTENTS, W)),
          e.ADD_FORBID_CONTENTS && (R === lt && (R = h(R)), m(R, e.ADD_FORBID_CONTENTS, W)),
          ct && (w[`#text`] = !0),
          ...
          : e.namespaceURI === mt
            ? t.namespaceURI === z
              ...
              : t.namespaceURI === ht
                ...
                : !!St[n]
            : e.namespaceURI === z
              ? (t.namespaceURI === ht && !vt[r]) || (t.namespaceURI === mt && !_t[r])
                ? !1
                : !St[n] && (yt[n] || !J[n])
  ...
  let Dt = function (e) {
    ...
    Ot = function (e, t, r) {
      if ($e[t] || (ot && (t === `id` || t === `name`) && (r in n || r in K))) return !1;
      if (
        !(A && !$e[t] && x(Ve, t)) &&
        !(et && x(Ue, t)) &&
    ...
    At = function (e) {
      ...
      for (; i--; ) {
        ...
        if (
          ...
          (u = r.attrValue),
          st && (c === `id` || c === `name`) && (X(a, e), (u = `user-content-` + u)),
          tt &&
            x(
        ...
        if (u !== l)
          try {
            (o ? e.setAttributeNS(o, a, u) : e.setAttribute(a, u), Z(e) ? Y(e) : me(t.removed));
          } catch {
            X(a, e);
          }
      }
  ...
  return (
    (t.sanitize = function (e) {
      ...
      if ((nt || q(n), (t.removed = []), typeof e == `string` && (I = !1), I)) {
        ...
        if (!F && !N && !P && e.indexOf(`<`) === -1) return g && at ? g.createHTML(e) : e;
...
` +
    ...
    (t.setConfig = function () {
      (q(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}), (nt = !0));
    }),
...
`,
      ...
      (j = `#ffffff`),
      (M = `#f2f2f2`),
      (N = f((e, t) => (t ? s(e, { s: -40, l: 10 }) : s(e, { s: -40, l: -10 })), `mkBorder`)),
      (tt = class {
        static {
          f(this, `Theme`);
        }
        ...
        updateColors() {
          if (
            ...
            (this.secondaryColor = this.secondaryColor || s(this.primaryColor, { h: -120 })),
            (this.tertiaryColor = this.tertiaryColor || s(this.primaryColor, { h: 180, l: 5 })),
            ...
            (this.secondaryTextColor = this.secondaryTextColor || a(this.secondaryColor)),
            (this.tertiaryTextColor = this.tertiaryTextColor || a(this.tertiaryColor)),
            ...
            (this.edgeLabelBackground =
              this.edgeLabelBackground ||
              (this.darkMode ? r(this.secondaryColor, 30) : this.secondaryColor)),
            ...
            (this.activationBorderColor = this.activationBorderColor || r(this.secondaryColor, 10)),
            (this.activationBkgColor = this.activationBkgColor || this.secondaryColor),
            (this.sequenceNumberColor = this.sequenceNumberColor || a(this.lineColor)),
            ...
            (this.cScale8 = this.cScale8 || s(this.primaryColor, { h: 210, l: 150 })),
          ...
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleInv` + e] = this[`cScaleInv` + e] || a(this[`cScale` + e]);
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this.darkMode
              ? (this[`cScalePeer` + e] = this[`cScalePeer` + e] || o(this[`cScale` + e], 10))
              : (this[`cScalePeer` + e] = this[`cScalePeer` + e] || r(this[`cScale` + e], 10));
          ...
          for (let t = 0; t < 5; t++)
            ((this[`surface` + t] =
              this[`surface` + t] || s(this.mainBkg, { h: 180, s: -15, l: e * (5 + t * 3) })),
              (this[`surfacePeer` + t] =
                this[`surfacePeer` + t] ||
          ...
          ((this.classText = this.classText || this.textColor),
            ...
            (this.fillType3 = this.fillType3 || s(this.secondaryColor, { h: 64 })),
            (this.fillType4 = this.fillType4 || s(this.primaryColor, { h: -64 })),
            (this.fillType5 = this.fillType5 || s(this.secondaryColor, { h: -64 })),
            (this.fillType6 = this.fillType6 || s(this.primaryColor, { h: 128 })),
            (this.fillType7 = this.fillType7 || s(this.secondaryColor, { h: 128 })),
            ...
            (this.quadrant2Fill = this.quadrant2Fill || s(this.primaryColor, { r: 5, g: 5, b: 5 })),
            (this.quadrant3Fill =
              this.quadrant3Fill || s(this.primaryColor, { r: 10, g: 10, b: 10 })),
            (this.quadrant4Fill =
              this.quadrant4Fill || s(this.primaryColor, { r: 15, g: 15, b: 15 })),
            (this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor),
            (this.quadrant2TextFill =
              this.quadrant2TextFill || s(this.primaryTextColor, { r: -5, g: -5, b: -5 })),
            (this.quadrant3TextFill =
              this.quadrant3TextFill || s(this.primaryTextColor, { r: -10, g: -10, b: -10 })),
            (this.quadrant4TextFill =
              this.quadrant4TextFill || s(this.primaryTextColor, { r: -15, g: -15, b: -15 })),
      ...
      (nt = class {
        ...
        updateColors() {
          ...
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] =
              this[`surface` + e] || s(this.mainBkg, { h: 30, s: -30, l: -(-10 + e * 4) })),
              (this[`surfacePeer` + e] =
                this[`surfacePeer` + e] || s(this.mainBkg, { h: 30, s: -30, l: -(-7 + e * 4) })));
          ...
          ((this.pieTitleTextSize = this.pieTitleTextSize || `25px`),
            ...
            (this.pieOpacity = this.pieOpacity || `0.7`));
          for (let e = 0; e < 8; e++)
            this[`venn` + (e + 1)] = this[`venn` + (e + 1)] ?? o(this[`cScale` + e], 30);
          ((this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor),
            (this.vennSetTextColor = this.vennSetTextColor ?? this.textColor),
            (this.quadrant1Fill = this.quadrant1Fill || this.primaryColor),
            (this.quadrant2Fill = this.quadrant2Fill || s(this.primaryColor, { r: 5, g: 5, b: 5 })),
            ...
            (this.gitInv6 = this.gitInv6 || a(this.git6)),
            (this.gitInv7 = this.gitInv7 || a(this.git7)),
            (this.gitBranchLabel0 = this.gitBranchLabel0 || a(this.labelTextColor)),
            (this.gitBranchLabel1 = this.gitBranchLabel1 || this.labelTextColor),
            (this.gitBranchLabel2 = this.gitBranchLabel2 || this.labelTextColor),
            (this.gitBranchLabel3 = this.gitBranchLabel3 || a(this.labelTextColor)),
        ...
        updateColors() {
          ...
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            ((this[`cScale` + e] = r(this[`cScale` + e], 10)),
              (this[`cScalePeer` + e] = this[`cScalePeer` + e] || r(this[`cScale` + e], 25)));
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleInv` + e] = this[`cScaleInv` + e] || s(this[`cScale` + e], { h: 180 });
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] =
              this[`surface` + e] || s(this.mainBkg, { h: 30, l: -(5 + e * 5) })),
              (this[`surfacePeer` + e] =
                this[`surfacePeer` + e] || s(this.mainBkg, { h: 30, l: -(7 + e * 5) })));
          if (
            ((this.scaleLabelColor =
      ...
      (at = class {
        ...
        updateColors() {
          ...
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] =
              this[`surface` + e] || s(this.mainBkg, { h: 30, s: -30, l: -(5 + e * 5) })),
              (this[`surfacePeer` + e] =
                this[`surfacePeer` + e] || s(this.mainBkg, { h: 30, s: -30, l: -(8 + e * 5) })));
          ((this.nodeBkg = this.mainBkg),
            (this.nodeBorder = this.border1),
            (this.clusterBkg = this.secondBkg),
            (this.clusterBorder = this.border2),
      ...
      (st = class {
        ...
        updateColors() {
          ...
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleLabel` + e] = this[`cScaleLabel` + e] || this.scaleLabelColor;
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] = this[`surface` + e] || s(this.mainBkg, { l: -(5 + e * 5) })),
              (this[`surfacePeer` + e] =
      ...
      (I = class {
        ...
        updateColors() {
          ...
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] =
              this[`surface` + e] || s(this.mainBkg, { h: 180, s: -15, l: i * (5 + e * 3) })),
              (this[`surfacePeer` + e] =
                this[`surfacePeer` + e] ||
          ...
          ((this.classText = this.classText || this.textColor),
            ...
            (this.quadrant2Fill = this.quadrant2Fill || s(e, { r: 5, g: 5, b: 5 })),
            (this.quadrant3Fill = this.quadrant3Fill || s(e, { r: 10, g: 10, b: 10 })),
            (this.quadrant4Fill = this.quadrant4Fill || s(e, { r: 15, g: 15, b: 15 })),
            (this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor),
            (this.quadrant2TextFill =
              this.quadrant2TextFill || s(this.primaryTextColor, { r: -5, g: -5, b: -5 })),
            (this.quadrant3TextFill =
      ...
      (yt = gt),
      (U = f((e) => {
        if ((d.debug(`sanitizeDirective called with`, e), !(typeof e != `object` || !e))) {
          if (Array.isArray(e)) {
            e.forEach((e) => U(e));
            return;
          }
          for (let t of Object.keys(e)) {
            ...
            for (let n of [`themeCSS`, `fontFamily`, `altFontFamily`])
              t.includes(n) && (d.debug(`sanitizing css option`, t), (e[t] = bt(e[t])));
          }
          if (e.themeVariables)
      ...
      (St = f((e, t) => {
        ...
        if (((n = A(n, r)), r.theme && r.theme in V)) {
          ...
          n.theme && n.theme in V && (n.themeVariables = V[n.theme].getThemeVariables(e));
        }
        return ((J = n), jt(J), J);
      }, `updateCurrentConfig`)),
      (Ct = f(
      ...
      (Et = f((e) => {
        e &&
          ([`secure`, ...(K.secure ?? [])].forEach((t) => {
            Object.hasOwn(e, t) &&
              (d.debug(`Denied attempt to modify a secure key ${t}`, e[t]), delete e[t]);
          }),
      ...
      (Nt = f(
        (e) => (
          e.flowchart?.htmlLabels != null && At(`FLOWCHART_HTML_LABELS_DEPRECATED`),
          G(e.htmlLabels ?? e.flowchart?.htmlLabels ?? !0)
        ),
        `getEffectiveHtmlLabels`,
      )),
      (Pt = /<br\s*\/?>/gi),
      (Ft = f((e) => (e ? Ut(e).replace(/\\n/g, `#br#`).split(`#br#`) : [``]), `getRows`)),
      (It = (() => {
        let e = !1;
        return () => {
          e ||= (Xe(), !0);
      ...
      (tn = f(async (e, n) => {
          ...
          return e.replace(Qt, `MathML is unsupported in this environment.`);
        {
          let { default: r } = await t(
            ...
            i = n.forceLegacyMathML || (!Zt() && n.legacyMathML) ? `htmlAndMathml` : `mathml`;
          return e
            .split(Pt)
            .map((e) =>
              $t(e)
      ...
      (un = f((e, t, n, r) => {
        let i = ``;
        return (
          e in ln && ln[e] ? (i = ln[e]({ ...n, svgId: r })) : d.warn(`No theme found for ${e}`),
          ` & {
...
`,
      ...
      (Nn = {}),
      (Pn = f((e, t, n) => {
        (Nn[e] && Tn.warn(`Diagram with id ${e} already registered. Overwriting.`),
          (Nn[e] = t),
          n && $e(e, n),
          dn(e, t.styles),
