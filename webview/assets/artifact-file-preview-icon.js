...
function s(e) {
  let t = (0, c.c)(15),
    { getImagePreviewSrc: n, iconClassName: i, imageClassName: o, path: s } = e,
    u;
  t[0] !== n || t[1] !== s
  ...
  if (d != null) {
    let e;
    t[3] === o ? (e = t[4]) : ((e = r(`shrink-0 object-cover`, o)), (t[3] = o), (t[4] = e));
    let n;
    return (
      t[5] !== d || t[6] !== e
  ...
  let f;
  t[8] === s ? (f = t[9]) : ((f = a(s)), (t[8] = s), (t[9] = f));
  let p = f,
    m;
  t[10] === i ? (m = t[11]) : ((m = r(`shrink-0`, i)), (t[10] = i), (t[11] = m));
  let h;
  return (
    t[12] !== p || t[13] !== m
