...
import { Ft as xe, Pt as Se } from "./app-initial~app-main~automations-page.js";
import {
  d as Ce,
  f as we,
  p as Te,
...
function bt(e) {
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, J.jsx)(E, { className: `icon-xs` })), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] === m
    ? (g = t[10])
    : ((g = (0, J.jsx)(re, {
        tooltipContent: p,
        children: (0, J.jsx)(L, { color: `ghost`, size: `icon`, "aria-label": m, children: h }),
      })),
      (t[9] = m),
      (t[10] = g));
  let _;
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, J.jsx)(K, { ...jt.codexForChrome })), (t[15] = x))
    : (x = t[15]);
  let S;
  t[16] === i
    ? (S = t[17])
...
function wt(e) {
  Ue({ href: e, initiator: `open_in_browser_bridge` });
}
function Tt() {
...
function Nt() {
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Ft.jsx)(ht, { className: `icon-xs` })), (e[5] = c))
    : (c = e[5]);
  let l;
  e[6] !== a || e[7] !== s
    ? ((l = (0, Ft.jsx)(L, {
  ...
  return (
    e[9] !== r || e[10] !== l
      ? ((u = (0, Ft.jsx)(re, { tooltipContent: o, shortcut: r, children: l })),
        (e[9] = r),
        (e[10] = l),
        (e[11] = u))
      : (u = e[11]),
...
function Bt(e) {
  ...
  let s = r.error instanceof g && r.error.status === 404;
...
var qt = e(() => {}),
  Jt,
  Yt = e(() => {
    (Je(), (Jt = Le(`cloudTasksEnvironmentFilterId`, null)));
  });
function Xt(e) {
  let t = (0, Zt.c)(15),
    ...
    ? ((u =
        n.length > 0
          ? (0, Qt.jsx)(`button`, {
              ...
              children: (0, Qt.jsx)(ge, { className: `icon-2xs` }),
            })
          : null),
      (t[5] = o),
      (t[6] = r),
...
function sn(e) {
  let t = (0, ln.c)(64),
    ...
    [c, l] = d(Jt),
    u = Qe(),
    { data: f, isLoading: p, isError: m, refetch: h } = Pe(),
    g;
  t[0] === o ? (g = t[1]) : ((g = o.trim()), (t[0] = o), (t[1] = g));
  let _ = g.length > 0,
    v;
  t[2] === _ ? (v = t[3]) : ((v = { enabled: _ }), (t[2] = _), (t[3] = v));
  let { data: y, isLoading: b, isError: x, refetch: S } = Ge(o, v),
    C;
  if (t[4] !== o || t[5] !== f || t[6] !== y || t[7] !== u) {
    bb0: {
      let e = o.trim(),
        n = e.length > 0 ? (y ?? []) : (f ?? []);
      if (e.length === 0 && u) {
    ...
    ((t[4] = o), (t[5] = f), (t[6] = y), (t[7] = u), (t[8] = C));
  } else C = t[8];
  let w = C,
    T;
  t[13] !== c || t[14] !== f
    ? ((T = f?.find((e) => e.id === c) ?? null), (t[13] = c), (t[14] = f), (t[15] = T))
    : (T = t[15]);
  let E = T,
    D;
  ...
  let O = c ? `default` : `icon`,
    k;
  t[17] === n ? (k = t[18]) : ((k = we(`mr-1`, n)), (t[17] = n), (t[18] = k));
  let A;
  ...
  t[25] !== M || t[26] !== O || t[27] !== k
    ? ((N = (0, Y.jsx)(Fe, {
        ...
        children: (0, Y.jsx)(re, {
          tooltipContent: D,
          children: (0, Y.jsx)(L, { color: `ghost`, size: O, className: k, children: M }),
        }),
      })),
      (t[25] = M),
      (t[26] = O),
  ...
  let I;
  t[33] !== te || t[34] !== F
    ? ((I = (0, Y.jsx)(cn, { isSelected: te, onClick: F, children: ne })),
      (t[33] = te),
      (t[34] = F),
      (t[35] = I))
    : (I = t[35]);
  ...
  t[40] !== o || t[41] !== z
    ? ((V = (0, Y.jsx)(q.Section, {
        className: `my-1`,
        children: (0, Y.jsx)(q.SearchInput, { placeholder: z, value: o, onChange: B }),
      })),
      (t[40] = o),
      (t[41] = z),
      (t[42] = V))
  ...
  return (
    t[60] !== i || t[61] !== N || t[62] !== W
      ? ((G = (0, Y.jsxs)(Xe, { open: i, onOpenChange: a, children: [N, W] })),
        (t[60] = i),
        (t[61] = N),
        (t[62] = W),
        (t[63] = G))
...
function cn(e) {
  let t = (0, ln.c)(11),
    ...
    a = r && `font-medium`,
    o;
  t[0] === a ? (o = t[1]) : ((o = we(an, a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = r ? (0, Y.jsx)(se, { className: `icon-2xs shrink-0 opacity-75` }) : null),
      (t[4] = r),
      (t[5] = c));
  let l;
  return (
...
function fn(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, X.jsx)(Ee, { className: `icon-2xs` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === s
    ? (l = t[4])
  ...
  return (
    t[27] !== a || t[28] !== S || t[29] !== l
      ? ((C = (0, X.jsxs)(Xe, { open: a, onOpenChange: o, children: [l, S] })),
        (t[27] = a),
        (t[28] = S),
        (t[29] = l),
        (t[30] = C))
...
function mn(e) {
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = r ? (0, X.jsx)(se, { className: `icon-2xs shrink-0 opacity-75` }) : null),
      (t[4] = r),
      (t[5] = c));
  let l;
  return (
...
function En({
  ...
  let s = e ?? [],
    ...
    l = (0, On.default)(
      ...
      return { kind: `remote`, key: Ve(e.id), at: t * 1e3, task: e };
    }),
    u = c.map((e) => {
      ...
      return { kind: `local`, key: Re(e.id), at: n, conversation: e };
    }),
    d = n.map((e) => ({
...
var On,
  kn,
  An = e(() => {
    ((On = t(G(), 1)), l(), (kn = t(c(), 1)), rt(), ce(), qe(), j(), le(), a(), y(), wn());
  });
function jn(e) {
  let t = (0, In.c)(33),
    {
    ...
    [m] = d(Jt),
    h = c ? f : `recent`,
    g = ne(`/local/:conversationId`)?.params?.conversationId ?? null,
    { data: _ } = Pe(),
    v = it(),
    y;
  t[0] !== m || t[1] !== c || t[2] !== _
    ? ((y = c ? (_?.find((e) => e.id === m) ?? null) : null),
      (t[0] = m),
      (t[1] = c),
      (t[2] = _),
      (t[3] = y))
  ...
  let S = r.filter(x),
    ...
    k = D
      ...
      : O,
    A = D ? S.filter((e) => Kt(z(e), E)) : S,
    j = D
      ? C.filter((e) =>
          e.kind === `remote`
            ? Kt(e.task.title, E)
            : e.kind === `local`
              ? Kt(z(e.conversation), E)
              : Kt(Nn(e.pendingWorktree, l), E),
        )
      : C,
    M;
  t[6] !== s || t[7] !== w
    ? ((M = (0, Z.jsx)(q.Section, {
        children: (0, Z.jsx)(Xt, { searchQuery: w, onQueryChange: T, autoFocus: s }),
      })),
      (t[6] = s),
      (t[7] = w),
      (t[8] = M))
        ...
        : n.isLoading
          ...
          : k.length === 0
            ? D
              ? (0, Z.jsx)(yn, {})
              : (0, Z.jsx)(en, {})
            : k.map((e) => (0, Z.jsx)(ct, { task: e.task, onClose: i }, e.key))),
    I =
      h === `local` &&
      (A.length
        ? A.map((e) =>
  ...
  t[21] !== h
    ...
    : (re = t[22]);
  let R;
  t[23] !== te.Section || t[24] !== F || t[25] !== I || t[26] !== re
    ? ((R = (0, Z.jsxs)(te.Section, {
...
var In,
  ...
  Vn = e(() => {
    ((In = i()),
      ...
      ot(),
      (Z = r()),
      (Rn = Le(`recent-tasks-filter`, `recent`)),
      (zn = (0, Ln.memo)(function (e) {
        ...
        t[0] === r
          ? (o = t[1])
          : ((o = r == null ? void 0 : (0, Z.jsx)(tt, { dateString: new Date(r).toISOString() })),
            (t[0] = r),
            (t[1] = o));
        let s;
        return (
          t[2] !== n || t[3] !== i || t[4] !== a || t[5] !== o
            ? ((s = (0, Z.jsx)(st, { conversationId: n, isActive: i, metaContent: o, onClick: a })),
              (t[2] = n),
              (t[3] = i),
              (t[4] = a),
              (t[5] = o),
      ...
      (Bn = (0, Ln.memo)(function (e) {
        ...
        switch (n.kind) {
          case `remote`: {
            ...
            return (
              t[0] !== n.task || t[1] !== i
                ? ((e = (0, Z.jsx)(ct, { task: n.task, onClose: i })),
                  (t[0] = n.task),
                  (t[1] = i),
                  (t[2] = e))
                : (e = t[2]),
...
function Hn(e) {
  ...
  let b = y,
    ...
    C,
    w;
  if (t[9] !== l || t[10] !== u || t[11] !== r || t[12] !== c.pathname || t[13] !== b.length) {
    let e;
    t[18] === u
      ? (e = t[19])
    ...
    ((x = b.length + n.length),
      ...
      (t[16] = C),
      (t[17] = w));
  } else ((x = t[14]), (S = t[15]), (C = t[16]), (w = t[17]));
  let E = w,
    D;
  t[20] !== E || t[21] !== x || t[22] !== o
    ? ((D = E
        ? o.formatMessage(
            {
  ...
  t[24] !== s || t[25] !== d || t[26] !== _
    ...
    : (k = t[27]);
  let A;
  (t[28] === d ? (A = t[29]) : ((A = [d]), (t[28] = d), (t[29] = A)), (0, Kn.useEffect)(k, A));
  let j, N;
  ...
  t[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (0, Q.jsx)(K, {
      ...
      (t[32] = P))
    : (P = t[32]);
  let te = S ? `ghostActive` : `ghost`,
    F = S ? `default` : `icon`,
    ne = S && `max-w-full min-w-0 !px-0 !py-0 hover:!bg-transparent hover:opacity-80`,
    I;
  t[33] === ne ? (I = t[34]) : ((I = we(`relative`, ne)), (t[33] = ne), (t[34] = I));
  let R = S ? void 0 : O,
    z;
  t[35] === E
    ? (z = t[36])
    : ((z = E
      ...
      (t[36] = z));
  let B;
  t[37] !== r || t[38] !== S || t[39] !== C
    ? ((B = S
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              (0, Q.jsx)(`span`, { className: we(`min-w-0 truncate`, !1), children: r }),
              (0, Q.jsx)(Ee, { className: `icon-2xs shrink-0 text-token-text-tertiary` }),
            ],
          })
        : C
          ? (0, Q.jsx)(`span`, {
          ...
          : (0, Q.jsx)(T, { className: `icon-xs hover:opacity-80` })),
      (t[37] = r),
      (t[38] = S),
      (t[39] = C),
      (t[40] = B))
  ...
  t[53] !== H
    ...
    : (U = t[54]);
  let W;
  t[55] === l ? (W = t[56]) : ((W = l ?? []), (t[55] = l), (t[56] = W));
  let G;
  t[57] !== m || t[58] !== d || t[59] !== _ || t[60] !== a || t[61] !== W
    ? ((G = (0, Q.jsx)(jn, {
        cloudtasksQuery: _,
...
function Jn(e) {
  ...
  t[28] === n
    ? (_ = t[29])
    : ((_ = we(`draggable extension:px-panel`, n)), (t[28] = n), (t[29] = _));
  let v = `justify-between`,
    y;
  t[30] === v
    ? (y = t[31])
    : ((y = we(`flex items-center electron:h-toolbar extension:py-row-y`, v)),
      (t[30] = v),
      (t[31] = y));
  let b;
  ...
  t[42] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(ft, { extension: !0, children: (0, $.jsx)(Se, {}) })), (t[42] = w))
    : (w = t[42]);
  let T;
  ...
  t[60] === k
    ? (A = t[61])
    : ((A = (0, $.jsx)(ft, { extension: !0, children: k })), (t[60] = k), (t[61] = A));
  let j;
  return (
...
function Xn() {
  je(`newThread`, `header_new_thread`);
}
function Zn(e) {
  let t = (0, $n.c)(21),
    { mergedTasks: n, onBack: r, showBackButton: i } = e,
    a = M().pathname === `/`,
    o = ne(`/local/:conversationId`)?.params?.conversationId ?? null,
    s;
  t[0] === o ? (s = t[1]) : ((s = o == null ? null : m(o)), (t[0] = o), (t[1] = s));
  let c = s,
    l = ne(`/remote/:taskId`)?.params?.taskId ?? null,
    { data: u } = We(l),
    d = f(he, c),
    p = f(S, c);
  if (l && u?.task?.title) {
