...
import { R as r, a as i, h as a, o, p as s, s as c, t as l } from "./app-scope.js";
import {
  At as u,
  Dt as d,
  ds as f,
...
import { gi as x, j as S } from "./src-1.js";
import { c as C, o as w } from "./lib.js";
import {
  Bt as T,
  Vt as E,
  it as D,
...
import { r as re } from "./remote-connection-visibility.js";
import { t as ie } from "./use-model-settings.js";
import { t as z } from "./use-auth.js";
import { n as ae } from "./model-queries-ChI-PsJH.js";
import { n as oe } from "./use-webview-execution-target.js";
import { f as se, m as B } from "./chunk-109.js";
import { n as ce, t as le } from "./use-service-tier-settings.js";
import { p as ue } from "./codex-api.js";
import { c as de } from "./apps-queries.js";
import { n as fe, r as pe } from "./experimental-features-queries.js";
import { h as me, r as he, t as V } from "./onboarding-state.js";
import { t as H } from "./x.js";
import { t as ge } from "./skus.js";
import { t as _e } from "./use-platform.js";
import { r as U, t as ve } from "./ambient-suggestions-connected-apps-consent.js";
import { t as ye } from "./app-intl-signal-D.js";
import { t as W } from "./with-window.js";
import { t as be } from "./use-is-remote-host.js";
import { n as xe, t as Se } from "./use-fast-mode-personalized-estimate.js";
import { t as Ce } from "./codex-Cx4-XOqq.js";
import { r as we } from "./modal-controller-state.js";
import { t as Te } from "./lightning-bolt.js";
...
function Y(e) {
  ...
  t[34] === a
    ? (j = t[35])
    : ((j = N(`text-token-text-secondary mt-0.5 text-base leading-relaxed text-pretty`, a)),
      (t[34] = a),
      (t[35] = j));
  let M;
  t[36] !== s || t[37] !== j
    ? ((M = (0, q.jsx)(`div`, { className: j, children: s })),
      (t[36] = s),
      (t[37] = j),
      (t[38] = M))
    : (M = t[38]);
  ...
  t[39] !== y || t[40] !== x || t[41] !== A || t[42] !== M
    ? ((P = (0, q.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [A, M, y, x] })),
      (t[39] = y),
      (t[40] = x),
      (t[41] = A),
      (t[42] = M),
...
function Ie() {
  let e = (0, K.c)(13),
    t = o(l),
    { authMethod: n, email: r, isLoading: i, planAtLogin: a } = z(),
    s = n === `chatgpt`,
    u;
  e[0] === s ? (u = e[1]) : ((u = { queryConfig: { enabled: s } }), (e[0] = s), (e[1] = u));
  let { data: d, isLoading: p } = v(`account-info`, u),
    ...
    _ = ne(),
    y = I(S.enabled),
    b = x({ authMethod: n, email: d?.email ?? r, plan: d?.plan ?? a }),
    C = g && b && y === !0 && m === !1,
    { data: w, isLoading: T } = de({ enabled: C, hostId: f }),
    E;
  e[2] === w ? (E = e[3]) : ((E = w === void 0 ? [] : w), (e[2] = w), (e[3] = E));
  let D = E,
    O;
  e[4] === D ? (O = e[5]) : ((O = ve(D)), (e[4] = D), (e[5] = O));
  let k = Le({
...
var X = e(t(), 1),
  ...
  He = s(l, ({ get: e }) => {
    ...
    return {
      ...
      queryFn: async () => ({
        accountId: t,
        response: await R.safeGet(`/beacons/home`, {
...
async function Q(e, t, n) {
  try {
    await R.safePost(`/beacons/event`, {
      requestBody:
        n == null
...
function $e() {
  let e = (0, K.c)(30),
    t = o(l),
    { accountId: n, authMethod: r, isLoading: i, userId: a } = z(),
    { data: s } = ue(),
    u = ee(),
    d = c(Be),
    f = c(He),
    ...
    h,
    g;
  if (e[0] !== n || e[1] !== r || e[2] !== s?.id || e[3] !== i || e[4] !== u || e[5] !== a) {
...
var at = P(`has-seen-app-upsell-banner`, !1);
function ot(e) {
  let t = (0, K.c)(6),
    { platform: n, isLoading: r } = _e(),
    { authMethod: i, planAtLogin: a, isLoading: o } = z(),
    s = i === `chatgpt`,
    c = i === `apikey`,
    l = s || c,
    u;
...
function ct(e) {
  ...
  let g, _;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)(Te, { className: `icon-sm text-[#FFC93C]` })),
      (_ = (0, q.jsx)(w, {
    ...
    : ((g = t[1]), (_ = t[2]));
  let v;
  t[3] !== r || t[4] !== s || t[5] !== p || t[6] !== c || t[7] !== u || t[8] !== d || t[9] !== f
    ? ((v = () => {
        if (r == null) return;
        (u(!0), k(p, O, {}));
        let e = s.model === r.model ? Promise.resolve() : d(r.model, s.reasoningEffort);
        Promise.all([f(m(r)?.id ?? `priority`, `home_banner`), e]).finally(() => {
          (c(!0), u(!1));
        });
      }),
      (t[3] = r),
...
var lt = P(`has-seen-fast-mode-home-banner`, !1);
function ut() {
  let e = (0, K.c)(19),
    t = o(l),
    n = C(),
    { isServiceTierAllowed: r } = ce(),
    { data: i } = ae(),
    [a, s] = y(lt),
    { modelSettings: c, setModelAndReasoningEffort: f } = ie(),
    { serviceTierSettings: p, setServiceTier: m } = le(),
    [h, g] = (0, X.useState)(!1),
    _ = (0, X.useRef)(!1),
    v = i?.models,
    b;
  e[0] === v ? (b = e[1]) : ((b = u(v, d)), (e[0] = v), (e[1] = b));
  let x = b,
    S = r && x != null && !a && p.selectedServiceTier == null && !p.isLoading,
    { estimate: T, estimateStatus: E } = xe(S),
    O = !a && S && E !== `ready` && E !== `failed`,
    A = S && E === `ready` && T != null,
    j,
    M;
  (e[2] !== A || e[3] !== t
    ? ((j = () => {
        !A || _.current || ((_.current = !0), k(t, D, {}));
      }),
      (M = [t, A]),
      (e[2] = A),
      (e[3] = t),
...
var dt = `multi_agent`,
  ft = P(`has-seen-multi-agent-composer-banner`, !1);
function pt() {
  let e = (0, K.c)(5),
    { hostId: t } = oe(Ae()),
    n = ke(),
    [r] = y(ft),
    { data: a, isLoading: o } = i(fe, t),
    s;
...
function gt(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, q.jsx)(w, {
      ...
      (D = (0, q.jsx)(Pe, { className: `icon-sm` })),
      (O = (0, q.jsx)(w, {
      ...
      (t[7] = D),
      (t[8] = O))
    : ((x = t[5]), (S = t[6]), (D = t[7]), (O = t[8]));
  let A;
  t[9] !== i || t[10] !== n || t[11] !== r || t[12] !== c || t[13] !== s || t[14] !== d
    ? ((A = () => {
        m(!0);
...
function yt(e) {
  ...
  t[0] !== n || t[1] !== i
    ? ((a = () => {
        we(i, Me, { initialAvailableCount: n, isRateLimitReached: !1, onResetComplete: bt });
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a))
...
var St = 1440 * 60 * 1e3,
  Ct = j(`rate-limit-reset-home-announcement-dismissal-by-account-id`, {});
function wt() {
  let e = (0, K.c)(9),
    t = o(l),
    { accountId: n, isLoading: r } = z(),
    i = c(Ct),
    { data: a, isLoading: s } = c(p),
  ...
  e[0] !== n || e[1] !== u || e[2] !== t
    ? ((m = () => {
      ...
      (e[3] = m))
    : (m = e[3]);
  let h = n != null && u > 0 && (d == null || d.availableCount < u || f - d.dismissedAtMs >= St),
    g = r || (a == null && s),
    _;
  return (
...
function Tt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, q.jsx)(w, {
      ...
      (c = (0, q.jsx)(De, { className: `icon-sm` })),
      (u = (0, q.jsx)(w, {
...
function Et() {
  ...
  let o = g(a),
    s;
  e[1] === o ? (s = e[2]) : ((s = o?.some(Dt) ?? !1), (e[1] = o), (e[2] = s));
  let l = s,
    u = !n && o === void 0,
    d = !u && r && !i && !n && l,
    f;
...
function Ot() {
  ...
  e[0] !== r || e[1] !== t.pathname
    ? ((i = me({ hideFirstNewThreadOnboardingPromos: r, pathname: t.pathname })),
      (e[0] = r),
      (e[1] = t.pathname),
      (e[2] = i))
    : (i = e[2]);
