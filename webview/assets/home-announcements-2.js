...
import { t as V } from "./skus.js";
import { t as oe } from "./use-platform.js";
import { r as H, t as se } from "./ambient-suggestions-connected-apps-consent.js";
import { t as ce } from "./app-intl-signal.js";
import { t as U } from "./with-window.js";
import { t as le } from "./use-is-remote-host.js";
import { n as ue, t as de } from "./use-fast-mode-personalized-estimate-DXUK-1Pd.js";
import { i as fe, t as pe } from "./use-is-fast-mode-enabled.js";
import { t as me } from "./lightning-bolt.js";
import { t as he } from "./badge.js";
import { t as W } from "./remote-connections-onboarding-signals.js";
...
function J(e) {
  ...
  t[34] === a
    ? (M = t[35])
    : ((M = d(`text-token-text-secondary mt-0.5 text-base leading-relaxed text-pretty`, a)),
      (t[34] = a),
      (t[35] = M));
  let N;
  t[36] !== s || t[37] !== M
  ...
  t[39] !== b || t[40] !== S || t[41] !== j || t[42] !== N
    ? ((P = (0, K.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [j, N, b, S] })),
      (t[39] = b),
      (t[40] = S),
      (t[41] = j),
      (t[42] = N),
...
function Ce() {
  ...
  let { data: d, isLoading: f } = x(`account-info`, u),
    ...
    O;
  e[2] === E ? (O = e[3]) : ((O = E === void 0 ? [] : E), (e[2] = E), (e[3] = O));
  let j = O,
    M;
...
function Be() {
  ...
  let g = m,
    v;
  e[8] === i ? (v = e[9]) : ((v = Le({ isAuthLoading: i })), (e[8] = i), (e[9] = v));
  let y = v,
    b,
    x;
...
function Ve(e) {
  ...
  return (
    t[9] !== r || t[10] !== i || t[11] !== c
      ? ((l = (0, K.jsx)(He, { beacon: r, localActionHandlers: i, onDismiss: c })),
        (t[9] = r),
        (t[10] = i),
        (t[11] = c),
        (t[12] = l))
...
function He(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
      ...
      a = (e) => {
        ...
        if (!(i == null && t == null))
          return {
            label: e.text,
            onClick: () => {
              if ((Z(n, `click`, e.id), t?.({ action: e, beacon: n }) !== !0 && i != null)) {
                if (!i.startsWith(`/`)) {
    ...
    ((s = J),
      ...
      (t[8] = p),
      (t[9] = m));
  } else ((s = t[3]), (c = t[4]), (l = t[5]), (u = t[6]), (d = t[7]), (p = t[8]), (m = t[9]));
  let h;
  t[12] === a
    ? (h = t[13])
    : ((h = a.formatMessage({
...
function Ge(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, K.jsx)(`img`, { alt: ``, src: be, className: `h-8 w-8 shrink-0` })), (t[1] = o))
    : (o = t[1]);
  let s;
...
function Je() {
  ...
  return (
    e[0] !== i || e[1] !== a || e[2] !== n || e[3] !== o
      ? ((s = { isEligible: o, isLoading: i, message: a, setHasSeenAppUpsellBanner: n }),
        (e[0] = i),
        (e[1] = a),
        (e[2] = n),
        (e[3] = o),
...
function Ye(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((_ = t[1]), (v = t[2]));
  let y;
  t[3] !== r || t[4] !== s || t[5] !== f || t[6] !== c || t[7] !== l || t[8] !== u || t[9] !== d
    ? ((y = () => {
        if (r == null) return;
...
function Ze() {
  ...
  (e[2] !== E || e[3] !== t
    ? ((O = () => {
        !E || v.current || ((v.current = !0), D(t, { eventName: `codex_fast_mode_banner_viewed` }));
      }),
      (k = [t, E]),
      (e[2] = E),
      (e[3] = t),
...
function it(e) {
  let t = (0, G.c)(31),
    ...
    a = f(),
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = { hostId: c }), (t[0] = o)) : (o = t[0]);
  let l = L(o),
  ...
  if (
    (t[1] !== b || t[2] !== i
      ? ((x = () => {
          !b ||
            y.current ||
            ((y.current = !0), D(i, { eventName: `codex_multi_agent_banner_viewed` }));
        }),
        (S = [i, b]),
        (t[1] = b),
        (t[2] = i),
  ...
  let O;
  t[9] !== a || t[10] !== n || t[11] !== i || t[12] !== u || t[13] !== l || t[14] !== g
    ? ((O = () => {
        v(!0);
...
function lt() {
  ...
  e[0] !== r || e[1] !== t.pathname
    ? ((i = re({ hideFirstNewThreadOnboardingPromos: r, pathname: t.pathname })),
      (e[0] = r),
      (e[1] = t.pathname),
      (e[2] = i))
    : (i = e[2]);
  ...
  let l = c === `1`,
    u;
  e[6] !== t.hash || e[7] !== t.pathname || e[8] !== t.state || e[9] !== n || e[10] !== s
    ? ((u = () => {
  ...
  return (
    e[18] !== f || e[19] !== p
      ? ((m = (0, K.jsxs)(K.Fragment, { children: [f, p] })), (e[18] = f), (e[19] = p), (e[20] = m))
      : (m = e[20]),
    m
  );
}
function ut(e) {
  ...
  let m;
  t[6] !== f || t[7] !== p
    ? ((m = (0, K.jsx)(Se, { onDismiss: f, onDisable: p })), (t[6] = f), (t[7] = p), (t[8] = m))
    : (m = t[8]);
  let h;
  t[9] !== r || t[10] !== m
  ...
  t[19] === c.navigate
    ? (S = t[20])
    : ((S = (0, K.jsx)(ot, { navigate: c.navigate })), (t[19] = c.navigate), (t[20] = S));
  let C;
  ...
  t[29] === u
    ? (A = t[30])
    : ((A = u.content == null ? null : (0, K.jsx)(Ye, { ...u })), (t[29] = u), (t[30] = A));
  let j;
...
function dt(e) {
  ...
  t[11] === a
    ? (g = t[12])
    : ((g = a.content == null ? null : (0, K.jsx)(Ye, { ...a })), (t[11] = a), (t[12] = g));
  let _;
