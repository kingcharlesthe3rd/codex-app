...
import { f as u, o as d } from "./vscode-api.js";
import { n as f, r as p } from "./react.js";
import { bi as m, k as h } from "./src-4.js";
import {
  Et as g,
  On as _,
  Ot as v,
...
import { c as C, o as w } from "./lib-1.js";
import {
  Bt as T,
  Ht as E,
  Vt as D,
...
import { c as ee, o as te, u as ne } from "./statsig-DoZ-0xit.js";
...
import { f as se, m as B } from "./chunk-8.js";
import { p as ce } from "./codex-api.js";
import { c as le } from "./apps-queries.js";
import { n as ue, r as de } from "./experimental-features-queries.js";
import { h as fe, r as pe, t as V } from "./onboarding-state.js";
import { n as me, t as he } from "./use-service-tier-settings.js";
...
import { t as ye } from "./app-intl-signal.js";
...
import { t as Ae } from "./use-active-conversation-id-Cz-4XoGC.js";
...
function Ie() {
  ...
  let { data: f, isLoading: p } = d(`account-info`, u),
    g = c(U),
    _ = g != null,
    v = te(`2425897452`),
    y = ne(),
    b = I(h.enabled),
    x = m({ authMethod: n, email: f?.email ?? r, plan: f?.plan ?? a }),
    C = v && x && b === !0 && g === !1,
    { data: w, isLoading: T } = le({ enabled: C, hostId: S }),
    E;
  ...
  let k = Le({
      ...
      isLoadingApps: T,
      isLoadingEligibilityInputs: i || !_ || y || p,
      shouldLoadApps: C,
    }),
    A,
    j;
...
function tt(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
          ...
          return {
            ...
            onClick: () => {
              if ((Q(n, `click`, e.id), t?.({ action: e, beacon: n }) !== !0 && i != null)) {
                if (!i.startsWith(`/`)) {
                  u.dispatchMessage(`open-in-browser`, { url: i });
                  return;
                }
                o(i);
              }
    ...
    ((s = Y),
      ...
      (t[8] = p),
      (t[9] = m));
  } else ((s = t[3]), (c = t[4]), (l = t[5]), (d = t[6]), (f = t[7]), (p = t[8]), (m = t[9]));
  let h;
  t[12] === a
    ? (h = t[13])
    : ((h = a.formatMessage({
...
function ct(e) {
  ...
  let h, g;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, q.jsx)(Te, { className: `icon-sm text-[#FFC93C]` })),
      (g = (0, q.jsx)(w, {
  ...
  t[3] !== r || t[4] !== s || t[5] !== p || t[6] !== c || t[7] !== u || t[8] !== d || t[9] !== f
    ? ((_ = () => {
        ...
        Promise.all([f(v(r)?.id ?? `priority`, `home_banner`), e]).finally(() => {
          (c(!0), u(!1));
        });
      }),
      (t[3] = r),
...
function ut() {
  let e = (0, K.c)(19),
    t = o(l),
    n = C(),
    { isServiceTierAllowed: r } = me(),
    { data: i } = ae(),
    [a, s] = f(lt),
    { modelSettings: c, setModelAndReasoningEffort: u } = ie(),
    { serviceTierSettings: d, setServiceTier: p } = he(),
    [m, h] = (0, X.useState)(!1),
    _ = (0, X.useRef)(!1),
    v = i?.models,
    y;
  e[0] === v ? (y = e[1]) : ((y = b(v, g)), (e[0] = v), (e[1] = y));
  let x = y,
...
function gt(e) {
  let t = (0, K.c)(31),
    ...
    i = C(),
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: S }), (t[0] = a)) : (a = t[0]);
  let s = de(a),
    [, c] = x(`composer_prefill`),
    [u, d] = f(ft),
    [p, m] = (0, X.useState)(!1),
    h = (0, X.useRef)(!1),
    g = !u,
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, q.jsx)(w, {
      ...
      (O = (0, q.jsx)(Pe, { className: `icon-sm` })),
      (A = (0, q.jsx)(w, {
...
function wt() {
  ...
  e[0] !== n || e[1] !== u || e[2] !== t
    ? ((p = () => {
      ...
      (e[3] = p))
    : (p = e[3]);
  let m = n != null && u > 0 && (d == null || d.availableCount < u || f - d.dismissedAtMs >= St),
    h = r || (a == null && s),
    g;
  return (
    e[4] !== u || e[5] !== p || e[6] !== m || e[7] !== h
      ? ((g = { availableCount: u, dismiss: p, isEligible: m, isLoading: h }),
        (e[4] = u),
        (e[5] = p),
        (e[6] = m),
        (e[7] = h),
...
function Ot() {
  ...
  return (
    e[18] !== d || e[19] !== f
      ? ((m = (0, q.jsxs)(q.Fragment, { children: [d, f] })), (e[18] = d), (e[19] = f), (e[20] = m))
      : (m = e[20]),
    m
  );
}
