...
import { i as Ct, r as wt, t as Tt } from "./ambient-suggestions-connected-apps-consent.js";
import {
  n as Et,
  t as Dt,
...
function G(e) {
  ...
  t[34] === a
    ? (j = t[35])
    : ((j = Ue(`text-token-text-secondary mt-0.5 text-base leading-relaxed text-pretty`, a)),
      (t[34] = a),
      (t[35] = j));
  let M;
  t[36] !== s || t[37] !== j
...
function Yt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, J.jsx)(g, {
      ...
      (o = (0, J.jsx)(mt, { className: `icon-sm` })),
      (s = (0, J.jsx)(g, {
...
function Qt() {
  let e = (0, en.c)(13),
    t = z(h),
    { authMethod: n, email: r, isLoading: i, planAtLogin: a } = Ae(),
    o = n === `chatgpt`,
    s;
  e[0] === o ? (s = e[1]) : ((s = { queryConfig: { enabled: o } }), (e[0] = o), (e[1] = s));
  let { data: c, isLoading: l } = Le(`account-info`, s),
    u = B(wt),
    d = u != null,
    f = R(`2425897452`),
    p = v(),
    m = ee(nt.enabled),
    g = Ve({ authMethod: n, email: c?.email ?? r, plan: c?.plan ?? a }),
    _ = f && g && m === !0 && u === !1,
    { data: y, isLoading: b } = le({ enabled: _, hostId: w }),
    x;
  e[2] === y ? (x = e[3]) : ((x = y === void 0 ? [] : y), (e[2] = y), (e[3] = x));
  let S = x,
    C;
  e[4] === S ? (C = e[5]) : ((C = Tt(S)), (e[4] = S), (e[5] = C));
  let T = $t({
      hasConnectedApps: C.length > 0,
      isLoadingApps: b,
      isLoadingEligibilityInputs: i || !d || p || l,
      shouldLoadApps: _,
    }),
    E,
    D;
...
async function dn(e, t, n) {
  try {
    await te.safePost(`/beacons/event`, {
      requestBody:
        n == null
...
function hn() {
  let e = (0, gn.c)(30),
    t = z(h),
    { accountId: n, authMethod: r, isLoading: i, userId: o } = Ae(),
    { data: s } = $e(),
    c = a(),
    l = B(xn),
    u = B(Cn),
    ...
    p,
    m;
  if (e[0] !== n || e[1] !== r || e[2] !== s?.id || e[3] !== i || e[4] !== c || e[5] !== o) {
    let t = c.getContext().user?.customIDs?.account_id;
    ((p = n ?? s?.id ?? t ?? o ?? null),
      (m = ln({ accountId: p, authMethod: r, isAuthLoading: i })),
      (e[0] = n),
      (e[1] = r),
      (e[2] = s?.id),
      (e[3] = i),
  ...
  let v = _,
    y,
    b;
  (e[10] !== p || e[11] !== t || e[12] !== g
    ? ((y = () => {
        (t.set(vn, p), t.set(yn, g));
      }),
      (b = [p, t, g]),
      (e[10] = p),
      (e[11] = t),
      ...
      (e[14] = b))
    : ((y = e[13]), (b = e[14])),
    (0, _n.useLayoutEffect)(y, b));
  let x, S;
  (e[15] !== u.data || e[16] !== t
    ? ((x = () => {
        u.data?.accountId != null &&
          u.data.beacon != null &&
          t.set(Sn, { accountId: u.data.accountId, beacon: u.data.beacon });
      }),
      (S = [u.data, t]),
      (e[15] = u.data),
      (e[16] = t),
  ...
  let C =
      u.data?.accountId === p
        ? (u.data.beacon ??
          (u.data.shouldKeepLastServedBeacon && f?.accountId === p ? f.beacon : null))
        : null,
    w;
  if (e[19] !== l || e[20] !== C || e[21] !== p || e[22] !== g) {
    let t = C != null && p != null ? fn(p, C.beacon_id) : null;
    ((w = g && C != null && t != null && !l.has(t) ? C : null),
      (e[19] = l),
      (e[20] = C),
      (e[21] = p),
      (e[22] = g),
  ...
  let T = w,
    ...
    k;
  return (
    e[24] !== T || e[25] !== p || e[26] !== E || e[27] !== D || e[28] !== O
      ? ((k = {
          accountId: p,
          beacon: T,
          isEligible: D,
  ...
  wn = e(() => {
    ((gn = V()),
      ...
      (Cn = N(h, ({ get: e }) => {
        let t = e(vn);
        return {
          queryKey: [`codex-app-home-beacon`, t, e(lt).locale],
          enabled: e(yn),
          refetchOnMount: !1,
          ...
          queryFn: async () => ({
            accountId: t,
            response: await te.safeGet(`/beacons/home`, {
...
function En(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
          ...
          return {
            ...
            onClick: (r) => {
              if ((dn(n, `click`, e.id), t?.({ action: e, beacon: n }) !== !0 && i != null)) {
                if (!i.startsWith(`/`)) {
                  Se({ event: r, href: i, initiator: `open_in_browser_bridge` });
                  return;
                }
                o(i);
              }
    ...
    ((s = G),
      ...
      (t[8] = p),
      (t[9] = m));
  } else ((s = t[3]), (l = t[4]), (u = t[5]), (d = t[6]), (f = t[7]), (p = t[8]), (m = t[9]));
  let h;
  t[12] === a
    ? (h = t[13])
    : ((h = a.formatMessage(
...
var kn,
  ...
  jn,
  Mn = e(() => {
    ((kn = V()), _(), (An = t(He(), 1)), M(), p(), gt(), wn(), Pe(), q(), U(), d(), (jn = H()));
  });
function Nn(e) {
  let t = (0, Pn.c)(16),
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Fn.jsx)(`img`, { alt: ``, src: Ft, className: `h-8 w-8 shrink-0` })), (t[1] = o))
    : (o = t[1]);
  let s;
...
var Pn,
  Fn,
  In = e(() => {
    ((Pn = V()), M(), Nt(), Pe(), q(), U(), (Fn = H()));
  });
function Ln(e) {
  let t = (0, zn.c)(6),
    { platform: n, isLoading: r } = pe(),
    { authMethod: i, planAtLogin: a, isLoading: o } = Ae(),
    s = i === `chatgpt`,
    c = i === `apikey`,
    l = s || c,
    u;
  t[0] === l ? (u = t[1]) : ((u = { queryConfig: { enabled: l } }), (t[0] = l), (t[1] = u));
  let { data: d, isLoading: f } = Le(`account-info`, u),
    p = i === `copilot`,
    m = n === `macOS`,
    h = d?.plan ?? a,
    _ = h === Xe.FREE || h === Xe.GO,
...
var zn,
  ...
  Hn = e(() => {
    ((zn = V()),
      ...
      i(),
      (Bn = H()),
      (Vn = ge(`has-seen-app-upsell-banner`, !1)));
  });
function Un(e) {
  let t = (0, Wn.c)(25),
    {
  ...
  let f, p;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Gn.jsx)(Mt, { className: `icon-sm text-[#FFC93C]` })),
      (p = (0, Gn.jsx)(g, {
    ...
    : ((f = t[1]), (p = t[2]));
  let m;
  t[3] !== r || t[4] !== u || t[5] !== o || t[6] !== s || t[7] !== l
    ? ((m = () => {
        r != null &&
          (s(!0),
          A(u, he, {}),
          l(Ye(r)?.id ?? `priority`, `home_banner`).finally(() => {
            (o(!0), s(!1));
          }));
      }),
      (t[3] = r),
...
var Wn,
  Gn,
  Kn = e(() => {
    ((Wn = V()), k(), _(), M(), q(), At(), U(), n(), d(), De(), (Gn = H()));
  });
function qn() {
  let e = (0, Jn.c)(18),
    t = z(h),
    n = D(),
    { isServiceTierAllowed: r } = ie(),
    { data: i } = Oe(),
    [a, o] = W(Zn),
    { modelSettings: s } = T(),
    { serviceTierSettings: c, setServiceTier: l } = Ke(),
    [u, d] = (0, Yn.useState)(!1),
    f = (0, Yn.useRef)(!1),
    p = i?.models,
    m;
  e[0] !== s.model || e[1] !== p
    ? ((m = Ee(p, s.model, Ge)), (e[0] = s.model), (e[1] = p), (e[2] = m))
    : (m = e[2]);
  let _ = m,
    v = r && _ != null && !a && c.selectedServiceTier == null && !c.isLoading,
    { estimate: y, estimateStatus: b } = Ot(v),
  ...
  (e[3] !== S || e[4] !== t
    ? ((C = () => {
        !S || f.current || ((f.current = !0), A(t, xe, {}));
      }),
      (w = [t, S]),
      (e[3] = S),
      (e[4] = t),
...
var Jn,
  ...
  Qn = e(() => {
    ((Jn = V()),
      ...
      kt(),
      (Xn = H()),
      (Zn = ge(`has-seen-fast-mode-home-banner`, !1)));
  });
function $n() {
  let e = (0, tr.c)(5),
    { hostId: t } = ye(st()),
...
var tr,
  ...
  ir = e(() => {
    ((tr = V()),
      ...
      S(),
      (nr = `multi_agent`),
      (rr = ge(`has-seen-multi-agent-composer-banner`, !1)));
  });
function ar(e) {
  let t = (0, or.c)(31),
    { onTryNow: n } = e,
    ...
    a = D(),
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = { hostId: w }), (t[0] = o)) : (o = t[0]);
  let s = re(o),
    [, l] = L(`composer_prefill`),
    [u, d] = W(rr),
    [f, p] = (0, sr.useState)(!1),
    m = (0, sr.useRef)(!1),
    _ = !u,
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Y.jsx)(g, {
      ...
      (S = (0, Y.jsx)(Kt, { className: `icon-sm` })),
      (C = (0, Y.jsx)(g, {
      ...
      (t[7] = S),
      (t[8] = C))
    : ((b = t[5]), (x = t[6]), (S = t[7]), (C = t[8]));
  let T;
  t[9] !== a || t[10] !== n || t[11] !== i || t[12] !== l || t[13] !== s || t[14] !== d
    ? ((T = () => {
        p(!0);
        ...
        (A(i, r, { action: `try_now` }),
          s.mutateAsync({ featureName: cr, enabled: !0 }).finally(() => {
...
function ur(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, X.jsx)(`span`, {
      ...
      (s = (0, X.jsx)(Vt, { className: `icon-sm` })),
      (l = (0, X.jsx)(g, {
...
function br(e) {
  ...
  t[0] !== n || t[1] !== i
    ? ((a = () => {
        ze(i, It, { initialAvailableCount: n, isRateLimitReached: !1, onResetComplete: xr });
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a))
...
var Cr,
  Z,
  wr = e(() => {
    ((Cr = V()), _(), M(), Be(), q(), se(), U(), Pt(), d(), (Z = H()));
  });
function Tr() {
  let e = (0, Er.c)(9),
    t = z(h),
    { accountId: n, isLoading: r } = Ae(),
    i = B(Or),
    { data: a, isLoading: o } = B(u),
  ...
  e[0] !== n || e[1] !== s || e[2] !== t
    ? ((d = () => {
        n != null &&
          t.set(Or, (e) => ({ ...e, [n]: { availableCount: s, dismissedAtMs: Date.now() } }));
      }),
      (e[0] = n),
      (e[1] = s),
      (e[2] = t),
      (e[3] = d))
    : (d = e[3]);
  let f = n != null && s > 0 && (c == null || c.availableCount < s || l - c.dismissedAtMs >= Dr),
    p = r || (a == null && o),
    m;
  return (
    e[4] !== s || e[5] !== d || e[6] !== f || e[7] !== p
      ? ((m = { availableCount: s, dismiss: d, isEligible: f, isLoading: p }),
        (e[4] = s),
        (e[5] = d),
        (e[6] = f),
        (e[7] = p),
...
var Er,
  ...
  kr = e(() => {
    ((Er = V()),
      ...
      et(),
      (Dr = 1440 * 60 * 1e3),
      (Or = ne(`rate-limit-reset-home-announcement-dismissal-by-account-id`, {})));
  });
function Ar(e) {
  let t = (0, jr.c)(17),
    { navigate: n } = e,
  ...
  t[4] !== n || t[5] !== r
    ? ((u = {
        label: l,
        onClick: () => {
          (r.set(_t, !0), n(`/settings/connections`));
        },
        className: `px-3 max-[400px]:flex-1 max-[400px]:justify-center`,
      }),
      (t[4] = n),
...
function Lr() {
  ...
  e[0] !== r || e[1] !== t.pathname
    ? ((i = yt({ hideFirstNewThreadOnboardingPromos: r, pathname: t.pathname })),
      (e[0] = r),
      (e[1] = t.pathname),
      (e[2] = i))
    : (i = e[2]);
  ...
  e[3] === t.search
    ? (s = e[4])
    : ((s = new URLSearchParams(t.search)), (e[3] = t.search), (e[4] = s));
  let c = s,
    l;
  e[5] !== t.hash || e[6] !== t.pathname || e[7] !== t.state || e[8] !== n || e[9] !== c
    ? ((l = () => {
        if (!c.has(`welcomeV2Onboarding`)) return;
        c.delete(St);
        let e = c.toString();
        n(
...
function Rr(e) {
  ...
  return (
    ...
    t[50] !== h ||
    t[51] !== y
      ? ((R = (0, $.jsx)(_r, { entries: [h, y, x, T, k, N, L] })),
        (t[45] = x),
        (t[46] = T),
        (t[47] = k),
        (t[48] = N),
