...
function _(e) {
  ...
  let j = A,
    M;
  t[1] === i ? (M = t[2]) : ((M = i.map(v)), (t[1] = i), (t[2] = M));
  let N;
  t[3] !== O || t[4] !== M
  ...
  t[8] === u
    ? (B = t[9])
    : ((B = u == null ? null : (0, C.jsx)(g, { children: u })), (t[8] = u), (t[9] = B));
  let V = R
      ? T === `vertical`
    ...
    H;
  t[10] === V ? (H = t[11]) : ((H = n(V)), (t[10] = V), (t[11] = H));
  let U;
  t[12] !== P ||
  t[13] !== r ||
  t[14] !== f ||
  ...
  t[26] === s
    ? (q = t[27])
    : ((q = n(`mx-auto w-full max-w-[var(--thread-content-max-width)]`, s)),
      (t[26] = s),
      (t[27] = q));
  let J;
  t[28] !== a || t[29] !== q
    ? ((J = (0, C.jsx)(`div`, { className: q, children: a })),
      (t[28] = a),
      (t[29] = q),
      (t[30] = J))
    : (J = t[30]);
...
function y(e) {
  let t = (0, x.c)(22),
    { id: r, title: i, action: a, count: o, stickyHeader: s, showDivider: c, children: l } = e,
    u = s === void 0 ? !1 : s,
    d = c === void 0 ? !0 : c,
    f = (0, S.useContext)(w),
    p;
  ...
  t[11] === a
    ? (y = t[12])
    : ((y = a ? (0, C.jsx)(`div`, { className: `shrink-0`, children: a }) : null),
      (t[11] = a),
      (t[12] = y));
  let b;
...
function b(e) {
  let t = (0, x.c)(11),
    ...
    f;
  t[0] !== a || t[1] !== r || t[2] !== s || t[3] !== l || t[4] !== c || t[5] !== u
    ? ((f =
        c === `vertical`
          ? (0, C.jsx)(`div`, {
                    ...
                    children: [
                      ...
                      a == null
                        ...
                        : (0, C.jsxs)(`div`, {
                            ...
                            children: [
                              (0, C.jsx)(`div`, { className: `h-6 w-px bg-token-border-light` }),
                              a,
                            ],
                          }),
                    ],
  ...
  return (
    t[7] !== o || t[8] !== d || t[9] !== f
      ? ((p = (0, C.jsx)(`nav`, { "aria-label": o, className: d, children: f })),
        (t[7] = o),
        (t[8] = d),
        (t[9] = f),
        (t[10] = p))
...
var x,
  ...
  w,
  T = e(() => {
    ((x = c()), s(), (S = t(a(), 1)), o(), h(), (C = r()), (w = (0, S.createContext)(null)));
  });
