...
function _(e) {
  ...
  let V = R
    ...
    H;
  t[10] === V ? (H = t[11]) : ((H = a(V)), (t[10] = V), (t[11] = H));
  let U;
  t[12] !== P ||
  t[13] !== n ||
  t[14] !== f ||
  ...
  t[26] === s
    ? (q = t[27])
    : ((q = a(`mx-auto w-full max-w-[var(--thread-content-max-width)]`, s)),
      (t[26] = s),
      (t[27] = q));
  let J;
  t[28] !== i || t[29] !== q
...
function y(e) {
  let t = (0, x.c)(22),
    { id: n, title: r, action: i, count: o, stickyHeader: s, showDivider: c, children: l } = e,
    u = s === void 0 ? !1 : s,
    d = c === void 0 ? !0 : c,
    f = (0, S.useContext)(w),
    p;
...
function b(e) {
  let t = (0, x.c)(11),
    ...
    f;
  t[0] !== r || t[1] !== n || t[2] !== o || t[3] !== l || t[4] !== s || t[5] !== u
    ? ((f =
        s === `vertical`
          ? (0, C.jsx)(`div`, {
...
var x,
  ...
  w,
  T = e(() => {
    ((x = r()), o(), (S = t(n(), 1)), s(), h(), (C = i()), (w = (0, S.createContext)(null)));
  });
