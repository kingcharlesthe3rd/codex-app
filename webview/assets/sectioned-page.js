...
function y(e) {
  let t = (0, x.c)(22),
    { id: n, title: r, action: i, count: a, stickyHeader: o, showDivider: s, children: l } = e,
    u = o === void 0 ? !1 : o,
    d = s === void 0 ? !0 : s,
    f = (0, S.useContext)(w),
    p;
  ...
  t[11] === i
    ? (y = t[12])
    : ((y = i ? (0, C.jsx)(`div`, { className: `shrink-0`, children: i }) : null),
      (t[11] = i),
      (t[12] = y));
  let b;
...
function b(e) {
  let t = (0, x.c)(11),
    ...
    f;
  t[0] !== r || t[1] !== n || t[2] !== a || t[3] !== l || t[4] !== s || t[5] !== u
    ? ((f =
        s === `vertical`
          ? (0, C.jsx)(`div`, {
  ...
  return (
    t[7] !== i || t[8] !== d || t[9] !== f
      ? ((p = (0, C.jsx)(`nav`, { "aria-label": i, className: d, children: f })),
        (t[7] = i),
        (t[8] = d),
        (t[9] = f),
        (t[10] = p))
...
var x,
  ...
  w,
  T = e(() => {
    ((x = r()), s(), (S = t(n(), 1)), a(), h(), (C = i()), (w = (0, S.createContext)(null)));
  });
