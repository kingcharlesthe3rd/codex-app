...
function y(e) {
  let t = (0, x.c)(22),
    { id: n, title: r, action: i, count: a, stickyHeader: o, showDivider: c, children: l } = e,
    u = o === void 0 ? !1 : o,
    d = c === void 0 ? !0 : c,
    f = (0, S.useContext)(w),
    p;
...
function b(e) {
  let t = (0, x.c)(11),
    ...
    f;
  t[0] !== r || t[1] !== n || t[2] !== o || t[3] !== l || t[4] !== c || t[5] !== u
    ? ((f =
        c === `vertical`
          ? (0, C.jsx)(`div`, {
...
var x,
  ...
  w,
  T = e(() => {
    ((x = r()), i(), (S = t(o(), 1)), n(), h(), (C = c()), (w = (0, S.createContext)(null)));
  });
