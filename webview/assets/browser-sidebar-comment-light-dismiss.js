...
import { o as s } from "./vscode-api.js";
import { Yr as c, ei as l } from "./src-4.js";
import { us as u } from "./app-server-manager-signals.js";
import { c as d, o as f } from "./lib-1.js";
import { t as p } from "./clsx.js";
import { t as m } from "./button.js";
import { t as h } from "./check-md.js";
import { t as g } from "./chevron-right.js";
import { r as _, t as v } from "./tooltip.js";
import { c as y, s as b } from "./format-skill-title.js";
import { r as x } from "./toast-signal.js";
import { t as S } from "./arrow-up.js";
import { d as C } from "./apps-queries.js";
import { s as w } from "./mention-item.js";
import { t as T } from "./rich-link.js";
import { n as E } from "./use-skills.js";
import { t as D } from "./electron-menu-shortcuts.js";
import { t as O } from "./data-url-from-svg.js";
import { r as k } from "./keyboard-modifier-state.js";
import { r as A, t as j } from "./dropdown.js";
import { t as M } from "./trash.js";
import {
  a as N,
  c as P,
  i as F,
...
import { r as ue } from "./use-composer-controller.js";
import { t as de } from "./at-mention-list-1.js";
import { n as fe, t as pe } from "./prompt-editor.js";
import { t as me } from "./arrow-rotate-ccw.js";
import { t as he } from "./drag.js";
import { t as ge } from "./link.js";
var R = e(t()),
  z = n(),
  _e = (e) =>
    (0, z.jsxs)(`svg`, {
  ...
  ve = 10,
  V = 15,
  ye = `border-token-charts-blue/40 bg-[var(--annotation-mode-button-annotation-background)] !text-token-text-link-foreground enabled:hover:bg-[var(--annotation-mode-button-annotation-hover-background)]`;
function be(e) {
  let t = (0, B.c)(56),
    n,
    r,
  ...
  let [g, _] = (0, R.useState)(!1),
    ...
    x = y ? ve : V,
    S = `translate-x-0`;
  n && (S = v ? `translate-x-0.5` : `-translate-x-0.5`);
  let C = n ? i : l,
    w;
  t[13] !== n || t[14] !== x
    ? ((w = n
        ? {
            "--annotation-mode-button-annotation-background": xe(`charts-blue`, ve),
            "--annotation-mode-button-annotation-hover-background": xe(`charts-blue`, x),
          }
        : {}),
      (t[13] = n),
      (t[14] = x),
  ...
  let T;
  t[16] !== h || t[17] !== w
    ? ((T = { ...h, ...w }), (t[16] = h), (t[17] = w), (t[18] = T))
    : (T = t[18]);
  let E = T,
    D = n ? `max-w-40 justify-start px-2.5` : `max-w-8 justify-center px-0`,
    O = n && ye,
    k;
  t[19] !== o || t[20] !== D || t[21] !== O
    ? ((k = p(
  ...
  let M = n ? `justify-start` : `w-full justify-center`,
    N;
  t[30] === M ? (N = t[31]) : ((N = p(`flex min-w-0 items-center`, M)), (t[30] = M), (t[31] = N));
  let P;
  t[32] === S
    ? (P = t[33])
    : ((P = p(
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, z.jsx)(_e, {
        className: p(`absolute inset-0 size-full rotate-0 scale-100 opacity-100`),
      })),
      (t[34] = F))
    : (F = t[34]);
  let I;
  t[35] === P
    ? (I = t[36])
    : ((I = (0, z.jsx)(`span`, { className: P, children: F })), (t[35] = P), (t[36] = I));
  let ee = n ? `ms-1 max-w-32 opacity-100` : `ms-0 max-w-0 opacity-0`,
    L;
  t[37] === ee
    ? (L = t[38])
    : ((L = p(
  ...
  let te;
  t[39] !== i || t[40] !== L
    ? ((te = (0, z.jsx)(`span`, { className: L, children: i })),
      (t[39] = i),
      (t[40] = L),
      (t[41] = te))
    : (te = t[41]);
  let ne;
  t[42] !== N || t[43] !== I || t[44] !== te
    ? ((ne = (0, z.jsxs)(`span`, { className: N, children: [I, te] })),
      (t[42] = N),
      (t[43] = I),
      (t[44] = te),
      (t[45] = ne))
...
function Ce({ canEditDesign: e, showAdjustEntry: t }) {
  return t && e;
}
var we = /\[((?:\\.|[^\]\n])+)\]\(((?:\\.|[^)\n])+)\)/g;
function H(e) {
  let t = [],
    n = 0,
    r;
  for (we.lastIndex = 0; (r = we.exec(e)) != null; ) {
    let i = U(r[1], r[2]);
    i != null &&
...
var je = { numericInput: `_numericInput_dz8fh_1`, colorInput: `_colorInput_dz8fh_19` },
  ...
  K = `min-w-0 rounded-lg border border-token-input-border bg-token-input-background text-token-input-foreground shadow-sm outline-none transition-colors focus-within:border-token-focus-border focus-within:ring-1 focus-within:ring-token-focus-border`,
  q = `min-w-0 appearance-none border-0 bg-transparent font-mono text-xs text-token-input-foreground outline-none ring-0 placeholder:text-token-input-placeholder-foreground focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0`,
  Pe = je.colorInput,
  Fe = `w-[192px] max-w-full`,
  Ie = `w-[168px] max-w-full`,
  Le = `w-[112px]`,
  Re = je.numericInput,
  ze = `url("${O(`<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 16 16' fill='none'><path d='M8 1 11 4H9v4H7V4H5l3-3Z' fill='#475569'/><path d='M8 15 5 12h2V8h2v4h2l-3 3Z' fill='#475569'/></svg>`)}") 8 8, ns-resize`,
  Be = 4,
  Ve = Be;
function He(e) {
  let t = (0, B.c)(61),
  ...
  t[0] !== i?.margin || t[1] !== i?.padding
    ? ((f = () => ({ margin: i?.margin === !0, padding: i?.padding === !0 })),
      ...
      (t[2] = f))
    : (f = t[2]);
  let [p, m] = (0, R.useState)(f),
    [h, g] = (0, R.useState)(!1),
    _;
  t[3] === r ? (_ = t[4]) : ((_ = () => jt(r)), (t[3] = r), (t[4] = _));
  let [v, y] = (0, R.useState)(_),
    b;
  t[5] === r ? (b = t[6]) : ((b = bt(r)), (t[5] = r), (t[6] = b));
  let x = b,
    S,
    C,
    w,
          ...
          (0, z.jsx)(
            qe,
            {
              ...
              onDimensionValueChange: (e, t) => {
                f((n) => (v.dimensions ? ht(n, e, t) : dt(n, e, { value: t })));
              },
              ...
              onSpacingLockToggle: (e, t) => {
                let n = At(e, t),
                  r = !v[n];
                (y((e) => ({ ...e, [n]: r })), r && f((n) => pt(n, e, t)));
              },
              onSpacingValueChange: (e, t, n) => {
                f((r) => (Pt(v, e, t) ? mt(r, e, t, n) : dt(r, t, { value: n })));
              },
              ...
              onDeclarationReset: (e) => {
                let t = kt(e);
                f((n) => (t != null && Pt(v, t, e) ? yt(n, t, e) : vt(n, e)));
              },
            },
            e.id,
          )),
  ...
  t[49] !== C || t[50] !== w || t[51] !== T
    ? ((k = (0, z.jsxs)(`div`, { className: C, children: [w, T] })),
      (t[49] = C),
      (t[50] = w),
      (t[51] = T),
      (t[52] = k))
  ...
  return (
    t[57] !== S || t[58] !== A || t[59] !== O
      ? ((j = (0, z.jsxs)(`div`, { className: O, children: [S, A] })),
        (t[57] = S),
        (t[58] = A),
        (t[59] = O),
        (t[60] = j))
...
function Ge(e) {
  ...
  t[0] === n.targetLabel
    ? (c = t[1])
    : ((c = xt(n.targetLabel)), (t[0] = n.targetLabel), (t[1] = c));
  let l = c,
    u;
  t[2] === s
    ? (u = t[3])
  ...
  t[4] === l
    ? (p = t[5])
    : ((p = (0, z.jsx)(`span`, { className: `min-w-0 truncate font-medium`, children: l })),
      (t[4] = l),
      (t[5] = p));
  let m;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, z.jsx)(he, { className: `icon-xs shrink-0` })), (t[6] = m))
    : (m = t[6]);
  let h;
  t[7] === f
    ? (h = t[8])
  ...
  let g;
  return (
    t[9] !== r || t[10] !== i || t[11] !== a || t[12] !== o || t[13] !== p || t[14] !== h
      ? ((g = (0, z.jsxs)(`div`, {
...
function Ke(e) {
  ...
  t[2] !== s || t[3] !== n || t[4] !== o || t[5] !== i
    ? ((u = n
        ? (0, z.jsx)(`span`, {
            className: p(K, Fe, `flex min-h-7 min-w-0 items-center px-3`),
            children: (0, z.jsx)(`input`, {
              ...
              className: p(q, `h-7 w-full text-left`),
  ...
  let g = n && r,
    _;
  return (
    t[8] !== a || t[9] !== l || t[10] !== g || t[11] !== m
      ? ((_ = (0, z.jsxs)(`div`, {
          className: `contents`,
          children: [h, (0, z.jsx)(Ye, { showReset: g, resetLabel: l, onReset: a, children: m })],
        })),
        (t[8] = a),
        (t[9] = l),
        (t[10] = g),
...
function qe(e) {
  let t = (0, B.c)(21),
    ...
    v;
  t[0] === c ? (v = t[1]) : ((v = c ? (0, z.jsx)(Je, {}) : null), (t[0] = c), (t[1] = v));
  let y;
  t[2] !== n ||
  t[3] !== r ||
  t[4] !== a ||
  ...
  t[16] !== s.sections
    ? ((y = s.sections.map((e, t) => {
        ...
        return (0, z.jsxs)(
          ...
          {
            className: `contents`,
            children: [t > 0 && wt(e) && !wt(s.sections[t - 1]) ? (0, z.jsx)(Je, {}) : null, c],
          },
          Ct(e),
        );
      })),
  ...
  return (
    t[18] !== v || t[19] !== y
      ? ((b = (0, z.jsxs)(z.Fragment, { children: [v, y] })), (t[18] = v), (t[19] = y), (t[20] = b))
      : (b = t[20]),
    b
  );
}
...
function Ye(e) {
  ...
  t[0] !== c || t[1] !== s || t[2] !== o
    ? ((u = o
        ? (0, z.jsx)(m, {
            ...
            uniform: !0,
            onClick: c,
            children: (0, z.jsx)(me, { className: `icon-2xs` }),
          })
        : null),
      (t[0] = c),
      (t[1] = s),
  ...
  t[4] === n
    ? (d = t[5])
    : ((d = (0, z.jsx)(`span`, { className: `flex max-w-full min-w-0 justify-end`, children: n })),
      (t[4] = n),
      (t[5] = d));
  let f;
  t[6] !== u || t[7] !== d
...
function Xe(e) {
  let t = (0, B.c)(24),
    ...
    h = u === void 0 ? !1 : u,
    g = d(),
    _ = h ? `w-full pr-9` : m && `ml-1 pl-3`,
    v;
  t[0] === _
    ? (v = t[1])
    : ((v = p(`relative flex min-h-7 min-w-0 items-center text-sm text-token-text-secondary`, _)),
      (t[0] = _),
      (t[1] = v));
  let y;
  t[2] !== r.property || t[3] !== g
    ? ((y = Yt(g, r.property)), (t[2] = r.property), (t[3] = g), (t[4] = y))
    : (y = t[4]);
  let b;
  t[5] !== r.property || t[6] !== m
    ? ((b = (0, z.jsx)(`span`, {
        className: `block truncate`,
        children: (0, z.jsx)(lt, { property: r.property, spacingAxisOnly: m }),
      })),
      (t[5] = r.property),
      (t[6] = m),
      (t[7] = b))
  ...
  return (
    t[21] !== x || t[22] !== S
      ? ((C = (0, z.jsxs)(`div`, { className: `contents`, children: [x, S] })),
        (t[21] = x),
        (t[22] = S),
        (t[23] = C))
      : (C = t[23]),
...
function Qe(e) {
  ...
  if (
    ...
    let d = l,
      C;
    (t[20] === o ? (C = t[21]) : ((C = At(o, `vertical`)), (t[20] = o), (t[21] = C)), (x = C));
    let w;
    (t[22] === o ? (w = t[23]) : ((w = At(o, `horizontal`)), (t[22] = o), (t[23] = w)), (h = w));
    let T;
    (t[24] !== m || t[25] !== a || t[26] !== o || t[27] !== x
      ? ((T = a[x]
          ? m.formatMessage(
              {
    ...
    t[34] === o
      ...
      : ((D = (0, z.jsx)(`span`, {
          className: `truncate`,
          children: (0, z.jsx)(lt, { property: o }),
        })),
        (t[34] = o),
        (t[35] = D));
    let O = i && `rotate-90`,
    ...
    t[36] === O
      ? (k = t[37])
      : ((k = p(`icon-2xs shrink-0 text-token-text-tertiary transition-transform`, O)),
        (t[36] = O),
        (t[37] = k));
    let A;
    (t[38] === k ? (A = t[39]) : ((A = (0, z.jsx)(g, { className: k })), (t[38] = k), (t[39] = A)),
      t[40] !== d || t[41] !== c || t[42] !== A || t[43] !== D
        ? ((y = (0, z.jsx)(`span`, {
      ...
      (t[14] = x),
      (t[15] = S));
  } else ((h = t[9]), (_ = t[10]), (v = t[11]), (y = t[12]), (b = t[13]), (x = t[14]), (S = t[15]));
  let C;
  t[45] !== v || t[46] !== y || t[47] !== b
    ? ((C = (0, z.jsxs)(`div`, { className: v, children: [y, b] })),
      (t[45] = v),
      (t[46] = y),
      (t[47] = b),
      (t[48] = C))
  ...
  return (
    t[63] !== C || t[64] !== w
      ? ((T = (0, z.jsxs)(z.Fragment, { children: [C, w] })), (t[63] = C), (t[64] = w), (t[65] = T))
      : (T = t[65]),
    T
  );
}
...
function et(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, z.jsx)(`span`, {
        className: `truncate`,
        children: (0, z.jsx)(lt, { property: `gap` }),
      })),
      (t[3] = h))
    : (h = t[3]);
  let _ = i && `rotate-90`,
  ...
  t[4] === _
    ? (v = t[5])
    : ((v = p(`icon-2xs shrink-0 text-token-text-tertiary transition-transform`, _)),
      (t[4] = _),
      (t[5] = v));
  let y;
  t[6] === v ? (y = t[7]) : ((y = (0, z.jsx)(g, { className: v })), (t[6] = v), (t[7] = y));
  let b;
  t[8] !== m || t[9] !== s || t[10] !== y
    ? ((b = (0, z.jsx)(`span`, {
        className: `flex min-h-7 min-w-0 items-center pr-2`,
  ...
  t[12] !== n || t[13] !== r || t[14] !== i || t[15] !== c || t[16] !== l || t[17] !== a
    ? ((x = i
        ? (0, z.jsx)(`span`, { "aria-hidden": `true` })
        : r
          ? (0, z.jsx)(st, { columnGap: n, rowGap: a, onScrubActiveChange: c, onValueChange: l })
          : (0, z.jsxs)(`span`, {
              className: p(
                K,
                `block min-h-7 w-full truncate px-3 py-1 text-right font-mono text-xs text-token-input-foreground`,
  ...
  let S;
  t[19] !== b || t[20] !== x
    ? ((S = (0, z.jsxs)(`div`, { className: `contents`, children: [b, x] })),
      (t[19] = b),
      (t[20] = x),
      (t[21] = S))
    : (S = t[21]);
  ...
  return (
    t[30] !== S || t[31] !== C
      ? ((w = (0, z.jsxs)(z.Fragment, { children: [S, C] })), (t[30] = S), (t[31] = C), (t[32] = w))
      : (w = t[32]),
    w
  );
}
...
function nt(e) {
  ...
  let p;
  t[0] !== i || t[1] !== o || t[2] !== c
    ? ((p = (0, z.jsx)(rt, { isLocked: i, label: o, onClick: c })),
      (t[0] = i),
      (t[1] = o),
      (t[2] = c),
      (t[3] = p))
  ...
  return (
    t[33] !== x || t[34] !== _
      ? ((S = (0, z.jsxs)(z.Fragment, { children: [_, x] })), (t[33] = x), (t[34] = _), (t[35] = S))
      : (S = t[35]),
    S
  );
}
function rt(e) {
  ...
  t[1] === o
    ? (s = t[2])
    : ((s = p(`absolute top-1/2 right-0 z-10 h-3.5 w-3.5 -translate-y-1/2 !rounded-full p-0`, o)),
      (t[1] = o),
      (t[2] = s));
  let c;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, z.jsx)(ge, { className: `icon-3xs` })), (t[3] = c))
    : (c = t[3]);
  let l;
  return (
    t[4] !== r || t[5] !== i || t[6] !== s
...
function it(e) {
  let t = (0, B.c)(45),
    ...
    s = d(),
    c;
  t[0] === n ? (c = t[1]) : ((c = Rt(n)), (t[0] = n), (t[1] = c));
  let l = c;
  if (Ht(n.property)) {
    let e;
    return (
  ...
  if (n.property === `opacity`) {
    ...
    t[7] !== n.property || t[8] !== s
      ? ((e = Yt(s, n.property)), (t[7] = n.property), (t[8] = s), (t[9] = e))
      : (e = t[9]);
    let r;
    return (
      t[10] !== n.property ||
  ...
  if (Ut(n)) {
    ...
    t[18] !== n.property || t[19] !== s
      ? ((e = Yt(s, n.property)), (t[18] = n.property), (t[19] = s), (t[20] = e))
      : (e = t[20]);
    let r;
    return (
      t[21] !== n.property ||
  ...
  t[29] !== n.property || t[30] !== s
    ? ((u = Yt(s, n.property)), (t[29] = n.property), (t[30] = s), (t[31] = u))
    : (u = t[31]);
  let f = n.property === `font-family` || n.property === `font-weight`,
    p = n.property,
    m;
  t[32] !== n || t[33] !== s
    ? ((m = Oe(s, n)), (t[32] = n), (t[33] = s), (t[34] = m))
    : (m = t[34]);
  let h;
  return (
    t[35] !== n.property ||
...
function J(e) {
  let t = (0, B.c)(15),
    ...
    l;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = p(K, Le, `flex min-h-7 min-w-0 items-center px-3`)), (t[0] = l))
    : (l = t[0]);
  let u = !r && `text-token-input-placeholder-foreground`,
    d;
  t[1] === u
    ? (d = t[2])
    : ((d = p(q, Re, `h-7 w-full truncate text-left`, u)), (t[1] = u), (t[2] = d));
  let f;
  t[3] !== i || t[4] !== o ? ((f = Kt(o, i)), (t[3] = i), (t[4] = o), (t[5] = f)) : (f = t[5]);
  let m;
  return (
    t[6] !== n ||
    t[7] !== s ||
...
function at(e) {
  let t = (0, B.c)(27),
    ...
    l;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = p(K, Le, `flex min-h-7 min-w-0 items-center gap-1 px-3`)), (t[0] = l))
    : (l = t[0]);
  let u = !r && `text-token-input-placeholder-foreground`,
    d;
  t[1] === u
    ...
    : ((d = p(q, Re, `h-7 w-full truncate text-left`, u)), (t[1] = u), (t[2] = d));
  let m;
  t[3] === o ? (m = t[4]) : ((m = Q(o) ?? ``), (t[3] = o), (t[4] = m));
  let h;
  t[5] !== i || t[6] !== a || t[7] !== o
    ? ((h = Q(i ?? ``) ?? Lt(a, i ?? o) ?? void 0), (t[5] = i), (t[6] = a), (t[7] = o), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== i || t[10] !== o
    ? ((g = Z(o) ?? Z(i ?? ``) ?? 0), (t[9] = i), (t[10] = o), (t[11] = g))
    : (g = t[11]);
  let _;
  t[12] === c
    ? (_ = t[13])
  ...
  return (
    t[25] === v
      ? (b = t[26])
      : ((b = (0, z.jsxs)(`span`, { className: l, children: [v, y] })), (t[25] = v), (t[26] = b)),
    b
  );
}
function Y(e) {
  ...
  if (s === `font-family`) {
    ...
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = p(K, Ie, `flex min-h-7 min-w-0 items-center overflow-hidden`)), (t[5] = e))
      : (e = t[5]);
    let r = !i && `text-token-input-placeholder-foreground`,
      s;
    t[6] === r
      ? (s = t[7])
      : ((s = p(q, `h-7 min-w-0 flex-1 truncate px-3 text-left`, r)), (t[6] = r), (t[7] = s));
    let d;
    t[8] === u
      ? (d = t[9])
      : ((d = (e) => {
    ...
    t[16] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((m = (0, z.jsx)(g, { className: `icon-2xs rotate-90` })), (t[16] = m))
      : (m = t[16]);
    let _;
    t[17] === n
      ? (_ = t[18])
    ...
    return (
      t[32] !== b || t[33] !== f
        ? ((x = (0, z.jsxs)(`span`, { className: e, children: [f, b] })),
          (t[32] = b),
          (t[33] = f),
          (t[34] = x))
        : (x = t[34]),
  ...
  if (c.length === 0) {
    ...
    t[35] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = p(K, `flex min-h-7 w-full min-w-0 items-center px-3`)), (t[35] = e))
      : (e = t[35]);
    let r = !i && `text-token-input-placeholder-foreground`,
      o;
    t[36] === r
      ? (o = t[37])
      : ((o = p(q, `h-7 w-full truncate text-left`, r)), (t[36] = r), (t[37] = o));
    let s;
    t[38] === u
      ? (s = t[39])
      : ((s = (e) => {
  ...
  t[46] === _
    ...
    : ((v = p(
      ...
      (t[46] = _),
      (t[47] = v));
  let y = m?.label ?? (l.length === 0 ? a : l),
    b = i ? `text-token-input-foreground` : `text-token-input-placeholder-foreground`,
    x;
  t[48] === b
    ? (x = t[49])
    : ((x = p(`min-w-0 flex-1 truncate font-mono text-xs`, b)), (t[48] = b), (t[49] = x));
  let S = m?.label ?? (l || a),
    C;
  t[50] !== x || t[51] !== S
    ? ((C = (0, z.jsx)(`span`, { className: x, children: S })),
      (t[50] = x),
      (t[51] = S),
      (t[52] = C))
    : (C = t[52]);
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, z.jsx)(g, { className: `icon-2xs shrink-0 rotate-90 text-token-text-tertiary` })),
      (t[53] = w))
    : (w = t[53]);
  let T;
  t[54] !== n || t[55] !== v || t[56] !== y || t[57] !== C
    ? ((T = (0, z.jsxs)(`button`, {
        "aria-label": n,
        className: v,
        title: y,
...
function ot(e) {
  let t = (0, B.c)(9),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = p(K, `-ml-6 grid min-h-7 w-[calc(100%+1.5rem)] grid-cols-4 overflow-hidden`)),
      (t[0] = s))
    : (s = t[0]);
  let c;
    ...
    ? ((c = Me.map((e, t) => {
        ...
        return (0, z.jsx)(
          ct,
          {
            ...
            scrubValue: l ? (Z(s.value) ?? Z(s.placeholderValue ?? ``) ?? 0) : null,
            step: l ? `any` : void 0,
            title: s.value,
            type: l ? `number` : void 0,
            placeholder:
              Q(s.placeholderValue ?? ``) ??
              Lt(s.property, s.placeholderValue ?? s.value) ??
              void 0,
            value: l ? (c ?? ``) : s.value,
...
function st(e) {
  let t = (0, B.c)(7),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = p(K, `grid min-h-7 w-full grid-cols-2 overflow-hidden`)), (t[0] = s))
    : (s = t[0]);
  let c;
  return (
    t[1] !== n || t[2] !== o || t[3] !== i || t[4] !== a || t[5] !== r
      ? ((c = (0, z.jsx)(`span`, {
          ...
          children: [n, r].map((e, t) => {
            let n = Q(e.value),
              r = e.value.length === 0 || n != null || Lt(e.property, e.value) != null;
            return (0, z.jsx)(
              ct,
              {
                ariaLabel: Yt(o, e.property),
                className: p(
                  q,
                  r && Re,
                  `min-h-7 w-full px-1 text-center`,
                ...
                scrubValue: r
                  ? (Z(e.value) ??
                    Z(e.placeholderValue ?? ``) ??
                    Number(Lt(e.property, e.placeholderValue ?? e.value) ?? `0`))
                  : null,
                step: r ? `any` : void 0,
                title: e.value,
                type: r ? `number` : void 0,
                placeholder:
                  Q(e.placeholderValue ?? ``) ??
                  Lt(e.property, e.placeholderValue ?? e.value) ??
                  void 0,
                value: r ? (n ?? ``) : e.value,
                onScrubActiveChange: i,
                onValueChange: (t) => {
...
function ct(e) {
  ...
  t[0] !== d || t[1] !== f || t[2] !== g
    ? ((C = (e) => {
        ...
        (e.preventDefault(),
          ...
          (e.currentTarget.style.cursor = ze),
          (r.cursor = ze),
  ...
  t[4] !== i || t[5] !== y || t[6] !== b || t[7] !== c || t[8] !== l || t[9] !== u || t[10] !== d
    ? ((T = (e) => {
        ...
        if ((e.preventDefault(), !t.hasScrubbed && Math.abs(n) < Ve)) return;
        if (!t.hasScrubbed) {
          let n = e.currentTarget.ownerDocument.body.style;
          ((n.cursor = ze), (n.userSelect = `none`), (t.hasScrubbed = !0), y?.(c, e.currentTarget));
        }
        let r = Math.trunc(n / Be),
          a = Vt(t.startValue + r * d, u, l);
        if (a === t.lastValue) {
          e.preventDefault();
          return;
        }
  ...
  t[20] === r
    ? (F = t[21])
    : ((F = p(r, `touch-none cursor-text hover:cursor-ns-resize active:cursor-ns-resize`)),
      (t[20] = r),
      (t[21] = F));
  let I;
  t[22] === b
...
function lt(e) {
  ...
  switch (n) {
    ...
    default: {
      let e;
      t[22] === n ? (e = t[23]) : ((e = Jt(n)), (t[22] = n), (t[23] = e));
      let r;
      return (
        t[24] === e
          ? (r = t[25])
          : ((r = (0, z.jsx)(z.Fragment, { children: e })), (t[24] = e), (t[25] = r)),
        r
      );
    }
  }
...
function ut(e) {
  let t = (0, B.c)(21),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = p(K, Fe, `flex min-h-7 min-w-0 items-center gap-2 px-2`)),
      (s = p(
        Pe,
  ...
  let c = i || r,
    l;
  t[2] === c ? (l = t[3]) : ((l = qt(c)), (t[2] = c), (t[3] = l));
  let u;
  t[4] === a
    ? (u = t[5])
    : ((u = (e) => {
  ...
  let d;
  t[6] !== l || t[7] !== u
    ? ((d = (0, z.jsx)(`input`, { className: s, type: `color`, value: l, onChange: u })),
      (t[6] = l),
      (t[7] = u),
      (t[8] = d))
    : (d = t[8]);
  ...
  t[9] === f
    ? (m = t[10])
    : ((m = p(q, `h-7 w-full truncate text-left`, f)), (t[9] = f), (t[10] = m));
  let h;
  t[11] === a
    ? (h = t[12])
    : ((h = (e) => {
  ...
  t[13] !== r || t[14] !== m || t[15] !== h || t[16] !== i
    ? ((g = (0, z.jsx)(`input`, { className: m, value: i, placeholder: r, title: i, onChange: h })),
      (t[13] = r),
      (t[14] = m),
      (t[15] = h),
      (t[16] = i),
  ...
  return (
    t[18] !== g || t[19] !== d
      ? ((_ = (0, z.jsxs)(`span`, { className: o, children: [d, g] })),
        (t[18] = g),
        (t[19] = d),
        (t[20] = _))
      : (_ = t[20]),
...
function ht(e, t, n) {
  let r = e.declarations.find((e) => e.property === t),
    ...
    o = r == null ? null : Z(r.value),
    s = a == null ? null : Z(a.value),
    c = Z(n);
  return o == null || s == null || c == null || o === 0
    ? dt(e, t, { value: n })
    : ft(e, [
        { property: t, value: n },
        { property: i, value: `${Bt((s / o) * c)}px` },
      ]);
}
function gt(e, t) {
  let n = bt(e);
...
function _t(e) {
  let t = bt(e);
  return t == null ? e : gt(e, t.previousValue);
}
function vt(e, t) {
  let n = e.declarations.find((e) => e.property === t);
  return n == null ? e : dt(e, t, { value: n.previousValue });
}
function yt(e, t, n) {
...
function Tt(e) {
  ...
  for (let n of [`color`, `font`, `border`, `layout`, `other`]) {
    let r = e.filter((e) => Et(e) === n).sort(Dt);
...
function Ot(e) {
  ...
  if (e.kind === `flex-spacing`) return Ne.indexOf(`gap`);
  let t = Ne.indexOf(e.declaration.property);
  return t < 0 ? Ne.length : t;
}
function kt(e) {
...
function jt(e) {
  return {
    dimensions: !1,
    "margin-horizontal": Mt(e.declarations, `margin`, `horizontal`),
    "margin-vertical": Mt(e.declarations, `margin`, `vertical`),
    "padding-horizontal": Mt(e.declarations, `padding`, `horizontal`),
    "padding-vertical": Mt(e.declarations, `padding`, `vertical`),
  };
}
function Mt(e, t, n) {
  let [r, i] = Ft(t, n),
  ...
  return (
    a != null && o != null && a.value.trim() !== `0` && Z(a.value) !== 0 && Nt(a.value, o.value)
  );
}
function Nt(e, t) {
...
function Lt(e, t) {
  return Gt(e) && t.trim() === `normal` ? `0` : null;
}
function Rt(e) {
  return (
    e.placeholderValue ??
...
function Ut(e) {
  return (
    Wt(e.property) &&
    (e.value.length === 0 ||
      Q(e.placeholderValue ?? ``) != null ||
      Q(e.value) != null ||
      Lt(e.property, e.value) != null ||
      Lt(e.property, e.placeholderValue ?? ``) != null)
  );
}
function Wt(e) {
  return (
...
function Kt(e, t) {
  return e.trim().length === 0 && t != null ? zt(t) : zt(e);
}
function qt(e) {
  let t = e?.trim() ?? ``,
...
function Xt({
  ...
  let i = t.trim();
  return {
    designDraft: !r || n == null ? null : Zt(n, e, i),
...
function Zt(e, t, n) {
  ...
  return {
    ...
    provenance: tn(i, e.provenance, t?.provenance ?? []),
    selector: e.selector,
...
var nn = p(
  ...
  rn = `-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro", "Segoe UI", sans-serif`,
  an = {
    ...
    "--font-sans": rn,
    "--vscode-font-family": rn,
    fontFamily: rn,
  },
  on = `pointer-events-none absolute inset-x-0 top-0 flex flex-col justify-end pb-2`,
  sn = `pointer-events-none absolute inset-x-0 flex flex-col overflow-visible bg-transparent`,
  cn = `pointer-events-auto relative overflow-hidden rounded-[22px] bg-token-dropdown-background shadow-md ring-1 ring-token-border-light transition-[height,width,opacity] ease-[cubic-bezier(0.23,1,0.32,1)] motion-reduce:transition-none`,
  ln = `absolute left-4 min-w-0 overflow-hidden transition-[left,width,top,bottom] duration-[140ms] ease-[cubic-bezier(0.23,1,0.32,1)] motion-reduce:transition-none`,
  un = `absolute inset-x-0 bottom-0 flex h-12 items-center pl-2 pr-3 origin-bottom-left transition-[opacity,transform] duration-150 ease-out motion-reduce:transition-none`,
  dn = `pointer-events-none absolute top-0 left-0 whitespace-pre text-base leading-normal font-sans opacity-0`,
  ...
  fn = `min-w-0 max-w-full text-base leading-6 font-sans text-token-foreground`,
  pn = `font-semibold`,
  mn = 28,
  hn = 8,
  gn = 32,
  ...
  bn = 40,
  xn = 4,
  Sn = `!max-h-[180px] overflow-y-auto`,
  Cn = `!max-h-full overflow-y-auto`,
  wn = `top-3`,
  Tn = `top-24`,
  En = `pt-24`,
  Dn = `pr-[52px]`,
  On = `max-h-[84px] min-h-[48px] overflow-hidden`,
  kn = `!h-auto !max-h-[84px] overflow-y-auto pb-2`,
  An = `flex min-h-0 flex-col px-4 pb-12`,
  jn = 8,
  Mn = 90,
  Nn = 150;
function Pn(e) {
  ...
  if (l.surfaceMode === `preview`) {
    ...
    return (
      t[0] !== S || t[1] !== l || t[2] !== A || t[3] !== d
        ? ((e = (0, z.jsx)(Fn, { session: l, showAdjustEntry: A, windowHeight: d, onMounted: S })),
          (t[0] = S),
          (t[1] = l),
          (t[2] = A),
          (t[3] = d),
...
function Fn(e) {
  ...
  (t[0] !== a || t[1] !== n.sessionId
    ? ((g = () => {
        ...
        let t = e.getBoundingClientRect(),
          ...
          i = h.current;
        (i?.width === r.width && i?.height === r.height) || ((h.current = r), a(n.sessionId, r));
      }),
      (t[0] = a),
      (t[1] = n.sessionId),
      (t[2] = g))
    : (g = t[2]),
    (0, R.useLayoutEffect)(g, [a, u, n.sessionId, l, i]));
  let _ = an,
    v;
  t[3] === n.previewAlignment
    ? (v = t[4])
    : ((v = p(`flex h-full w-full`, Kn(n.previewAlignment))),
      (t[3] = n.previewAlignment),
      (t[4] = v));
  let y = f ? `items-start py-2` : `items-center`,
    b;
  t[5] === y ? (b = t[6]) : ((b = p($, y)), (t[5] = y), (t[6] = b));
  let x;
  t[7] === i ? (x = t[8]) : ((x = { height: i }), (t[7] = i), (t[8] = x));
  let S = f ? `items-start` : `items-center`,
    C;
  t[9] === S ? (C = t[10]) : ((C = p(`flex min-w-0 gap-2`, S)), (t[9] = S), (t[10] = C));
  let w;
  t[11] === l
    ? (w = t[12])
    : ((w = l
        ? (0, z.jsx)(`span`, {
            ...
            children: (0, z.jsx)(I, { className: `icon-sm` }),
          })
        : null),
      (t[11] = l),
      (t[12] = w));
  let T = f
    ...
    E;
  t[13] === T ? (E = t[14]) : ((E = p(fn, T)), (t[13] = T), (t[14] = E));
  let D;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = { fontSize: `var(--codex-chat-font-size)` }), (t[15] = D))
    : (D = t[15]);
  let O = s.length > 0 ? Gn(s) : u,
    k;
  t[16] !== E || t[17] !== D || t[18] !== O
    ? ((k = (0, z.jsx)(`div`, { className: E, style: D, children: O })),
      (t[16] = E),
      (t[17] = D),
      (t[18] = O),
      (t[19] = k))
  ...
  t[20] !== w || t[21] !== k || t[22] !== C
    ? ((A = (0, z.jsxs)(`div`, { className: C, children: [w, k] })),
      (t[20] = w),
      (t[21] = k),
      (t[22] = C),
      (t[23] = A))
  ...
  t[24] !== A || t[25] !== b || t[26] !== x
    ? ((j = (0, z.jsx)(`div`, { ref: m, className: b, style: x, children: A })),
      (t[24] = A),
      (t[25] = b),
      (t[26] = x),
      (t[27] = j))
  ...
  let M;
  t[28] !== j || t[29] !== v
    ? ((M = (0, z.jsx)(`div`, { className: v, children: j })),
      (t[28] = j),
      (t[29] = v),
      (t[30] = M))
    : (M = t[30]);
...
function In({
  ...
  showAdjustEntry: l = !0,
  keyboardEventTarget: g,
  onSubmit: _,
  onDirectSubmit: y,
  onDesignChangeDelete: b,
  onDesignChangeUpdate: w,
  onDesignScrubPropertyChange: T,
  onTweaksEditorOpenChange: O,
  onDelete: A,
  onCancel: j,
  onEscape: he,
  onMounted: ge,
  onBodyChange: _e,
  onAttachmentPreviewOpenChange: B,
  onLightDismissibilityChange: ve,
  allowImageAttachments: V = !0,
  allowDirectSubmit: ye,
  defaultCreateSubmitMode: be,
  inputAriaLabel: xe,
  placeholder: Se,
}) {
  let we = i(o),
  ...
  let [Ee, De] = (0, R.useState)(U),
    [Oe, ke] = (0, R.useState)(() => e.attachedImages ?? []),
    [Ae, je] = (0, R.useState)(() => (l ? (e.designEditorState ?? Te ?? null) : null)),
    G = (0, R.useRef)(Te ?? null),
    [Me, Ne] = (0, R.useState)(() => Ae != null && (n || e.target.mode === `design` || Te != null)),
    K = l ? Ae : null,
    q = l && Me,
    [Pe, Fe] = (0, R.useState)(!1),
    [Ie, Le] = (0, R.useState)(!1),
    [Re, ze] = (0, R.useState)(!1),
    [Be, Ve] = (0, R.useState)(!1),
    [Ue, We] = (0, R.useState)(null),
    [Ge, Ke] = (0, R.useState)(!1),
    [qe, Je] = (0, R.useState)(!1),
    [Ye, Xe] = (0, R.useState)({ x: 0, y: 0 }),
    Ze = (e) => {
      (Je(e), B?.(e));
    },
    Qe = (e) => {
    ...
    [$e, et] = (0, R.useState)(!1),
    [tt, nt] = (0, R.useState)(!1),
    rt = a(k),
    it = (0, R.useRef)(U),
    J = (0, R.useRef)(e.attachedImages ?? []),
    at = (0, R.useRef)(null),
    Y = (0, R.useRef)(K);
  Y.current = K;
  let ot = (0, R.useRef)(null),
    st = (0, R.useRef)(null),
    ct = (0, R.useRef)(null),
    lt = (0, R.useRef)(null),
    ut = (0, R.useRef)(null),
    ...
    mt = (0, R.useRef)(null),
    ht = (0, R.useRef)(null),
    { data: gt } = s(`workspace-root-options`, { params: { hostId: u } }),
    _t = (0, R.useMemo)(() => {
      if (gt?.roots.length) return gt.roots;
      if (e.cwd != null) return [e.cwd];
    }, [e.cwd, gt?.roots]),
    vt = ce(W),
    yt = oe(W),
    bt = null;
  vt.ui?.active === !0 ? (bt = `at`) : yt.ui?.active === !0 && (bt = `skill`);
  let xt = Ce({ canEditDesign: K != null, showAdjustEntry: l }),
    St = q && K != null,
    Ct = e.target.mode === `edit` || Re || q,
    wt = e.target.mode === `edit` && !q,
    { hasCommentText: Tt } = Xt({
      baselineDesignGroup: G.current,
      commentText: Ee,
      designEditorState: K,
      isDesignSubmissionMode: St,
    }),
    { designDraft: Et } = Xt({
      baselineDesignGroup: G.current,
      commentText: Ee,
      designEditorState: K,
      isDesignSubmissionMode: K != null,
    }),
    Dt = Yn({
      baselineDesignGroup: G.current,
      designDraft: Et,
      designEditorState: K,
      isDesignEditorOpen: q,
    }),
    Ot = ne(u),
    kt = Ot === !0,
    {
      isDictating: X,
      isTranscribing: At,
      canRetryDictation: jt,
      recordingDurationMs: Mt,
      retryDictation: Nt,
      waveformCanvasRef: Pt,
      startDictation: Ft,
      stopDictation: It,
    } = F({
      enabled: kt,
      getSurroundingText: () => W.getText(),
      onTranscriptInsert: (e) => {
        W.view.isDestroyed || W.appendText(e);
      },
      onTranscriptSend: (t) => {
        if (W.view.isDestroyed) return;
        W.appendText(t);
        let n = W.getText().trim();
        if (n.length === 0) return;
        let r = { body: n, ...(J.current.length === 0 ? {} : { attachedImages: J.current }) };
        if (e.target.mode === `create` && be === `direct`) {
          y(r);
          return;
        }
        _(r);
    ...
    Z = V && Oe.length > 0,
    Lt = Ct || X || Z,
    Rt = e.target.mode !== `edit` && !Re && !Z,
    zt = e.target.mode !== `edit` && !q && (Ct || Z),
    Q = zt && !Ct,
    Bt = Lt ? 120 : 44,
    Vt = Math.min(Math.max(t - 120, 0), 88),
    Ht = C(),
    { skills: Ut } = E(_t),
    Wt = (0, R.useCallback)(
      (t, n, r = Y.current) => {
        ve(qn(e.target.mode, U, t, e.attachedImages ?? [], n, G.current, r));
      },
      [ve, e.attachedImages, U, e.target.mode],
    ),
    Gt = (0, R.useCallback)(
      (e, t = st.current) => {
        let n = q && Qn(e, ct.current, t);
        Ve((e) => (e === n ? e : n));
      },
      [q],
    ),
    ...
    qt = (0, R.useCallback)(() => {
      let t = W.getText();
      if (it.current === t) return;
      ((it.current = t),
        De(t),
        _e?.(t),
        ze(
          e.target.mode !== `edit` &&
            Zn(t, W.view.state.doc.childCount > 1, ct.current, ot.current),
        ),
        Gt(t),
        Wt(t, J.current));
      let n = Y.current;
      St && n != null && w?.(Zt(n, G.current, t.trim()));
    }, [W, St, _e, w, e.target.mode, Gt, Wt]);
  ((0, R.useEffect)(() => ue(W.view, qt), [W, qt]),
    (0, R.useEffect)(() => {
      W.syncMentionMetadata({ skills: Ut, apps: Ht });
    }, [Ht, Ut, W]),
    (0, R.useLayoutEffect)(() => {
      if (lt.current === e.sessionId) return;
      ...
      (W.setPromptText(U),
        ...
        ze(
          e.target.mode !== `edit` &&
            Zn(U, W.view.state.doc.childCount > 1, ct.current, ot.current),
        ),
        Wt(U, t));
    }, [W, e.attachedImages, U, e.sessionId, e.target.mode, _e, Wt]),
    (0, R.useLayoutEffect)(() => {
      let t = ot.current?.getBoundingClientRect();
      if (t == null) return;
      let n = { width: Math.ceil(t.width), height: Math.ceil(t.height) },
        r = dt.current;
      (ut.current === e.sessionId && r?.width === n.width && r?.height === n.height) ||
        ((ut.current = e.sessionId), (dt.current = n), ge(e.sessionId, n, q ? c : void 0));
    }, [Oe, Ee, q, Re, Be, ge, e.sessionId, Bt, t]),
    (0, R.useEffect)(
      () => () => {
        (pt.current != null && globalThis.clearTimeout(pt.current),
          mt.current != null && globalThis.clearTimeout(mt.current));
      },
      [],
    ));
  let Jt = (0, R.useEffectEvent)(() => {
    if (qe) return;
    let e = W.view.dom,
      t = e.ownerDocument.activeElement,
      n = e.closest(`form`);
    (t != null && n?.contains(t) && !e.contains(t)) || W.focus();
  });
  (0, R.useEffect)(() => {
    if (g == null) return;
    let e = () => {
    ...
    return (
      ...
      g.document.hasFocus() && e(),
      () => {
        g.removeEventListener(`focus`, e);
      }
    );
  }, [g]);
  let Yt = H.formatMessage({
    ...
    $ = e.target.mode === `edit` ? e.target.commentId : null,
    fn = Ot == null || Ot,
    pn = $ == null && !Ct && !Tt && Ot == null,
    mn = !X && (fn || pn) && (Ct || !Tt),
    hn = !pn && !X && (Ct || Tt || !kt),
    gn = Dt ? (G.current == null ? Et != null || Tt : !Qt(Et, G.current)) : Tt,
    _n = te(),
    vn = D(),
    yn = g?.document.body ?? null,
    bn = $ == null && ye && tt && rt,
    xn = vn ? `⏎` : `Enter`,
    Pn = vn ? `⌘⏎` : `Ctrl+Enter`,
    Fn = Dt ? `saved` : ye ? be : `saved`,
    In = Fn === `direct` ? !bn : bn,
    Wn = G.current?.status === `queued` ? G.current : null,
    Gn = $ != null || q || Wn != null,
    Kn = Ct && !X && Gn,
    Jn =
      Ue == null || Ae == null
        ? null
        : Ue.rows.flatMap((e) => {
            let t = Ln(Ae.declarations, e.property);
      ...
      (e) =>
        new Promise((t) => {
          let n = new FileReader(),
            ...
            i = ie(e, window.electronBridge?.getPathForFile) ?? void 0;
          ((n.onload = (e) => {
    ...
    $n = (0, R.useCallback)(
      (e) => {
        V &&
          Promise.all(e.map((e) => Xn(e))).then((e) => {
            let t = e.filter((e) => e != null);
            if (t.length === 0) return;
            let n = [...J.current, ...t];
            ((J.current = n), ke(n), Wt(it.current, n));
          });
      },
      [V, Xn, Wt],
    ),
    er = () => {
      let e = W.getText(),
        t = Xt({
          baselineDesignGroup: G.current,
          commentText: e,
          designEditorState: Y.current,
          isDesignSubmissionMode: Y.current != null,
        }),
        n = Yn({
          baselineDesignGroup: G.current,
      ...
      if (t.designDraft == null && !t.hasCommentText) {
        n && G.current != null && b?.(G.current.id);
        return;
      }
      _({
        body: t.trimmedCommentText,
        ...(!V || J.current.length === 0 ? {} : { attachedImages: J.current }),
  ...
  ((0, R.useEffect)(() => {
    ...
    return (
      W.addPastedImagesHandler(e),
      () => {
        W.removePastedImagesHandler(e);
      }
    );
  }, [$n, V, W]),
    ee({
      ...
      stopDictation: It,
      keyboardEventTarget: g,
      shouldHandleDictation: () => tt,
    }),
    (0, R.useEffect)(() => {
      if (g == null || $ != null) return;
      let e = () => {
          let e = g.document.activeElement;
          nt(e != null && W.view.dom.contains(e));
        },
        t = () => {
      ...
      return (
        e(),
        g.document.addEventListener(`focusin`, t),
        g.document.addEventListener(`focusout`, t),
        g.addEventListener(`blur`, n),
        () => {
          (g.document.removeEventListener(`focusin`, t),
            g.document.removeEventListener(`focusout`, t),
            g.removeEventListener(`blur`, n));
        }
      );
    }, [W, $, g]));
  let ir = (e) => {
      ...
      if (St && e.key === `Enter` && !e.altKey && !e.shiftKey && (e.metaKey || e.ctrlKey)) {
    ...
    sr = () => {
      pt.current != null && (globalThis.clearTimeout(pt.current), (pt.current = null));
    },
    cr = () => {
      mt.current != null && (globalThis.clearTimeout(mt.current), (mt.current = null));
    },
    lr = () => {
      l && (sr(), Le(!1), Ne(!0), O?.(!0));
    },
    ur = () => {
      if ((sr(), Ne(!1), Ve(!1), O?.(!1), Fe(!1), !Rt)) {
        Le(!1);
        return;
      }
      (Le(!0),
        (pt.current = globalThis.setTimeout(() => {
          (Le(!1), (pt.current = null));
        }, Mn)));
    },
    dr = (e) => {
      if (q) {
    ...
    fr = (e) => {
      let t = Zt(e, G.current, it.current.trim());
      ((Y.current = e), je(e), Wt(it.current, J.current, e), w?.(t));
    },
    pr = (e, t) => {
      T?.(e);
      let n = at.current?.getBoundingClientRect();
      if (e == null) {
        (cr(),
          Ke(!1),
          (mt.current = globalThis.setTimeout(() => {
            (We(null), (mt.current = null));
          }, Nn)));
        return;
      }
      if ((cr(), t == null || n == null)) {
      ...
      let i = r.dataset.browserSidebarDesignScrubPeerProperty,
        a =
          i == null
            ? null
            : (Array.from(
                ot.current?.querySelectorAll(`[data-browser-sidebar-design-scrub-property]`) ?? [],
    ...
    mr = xt,
    hr = (e) => {
      if (!q || !e.isPrimary || e.button !== 0 || ot.current == null || !Rn(e)) return;
      let t = ot.current.getBoundingClientRect(),
        n = e.currentTarget.ownerDocument.defaultView;
      ((ht.current = {
        baseLeft: t.left - Ye.x,
        baseTop: t.top - Ye.y,
        cardHeight: t.height,
        cardWidth: t.width,
        offsetX: Ye.x,
    ...
    gr = (e) => {
      ...
      let n = t.offsetX + e.clientX - t.startClientX,
        ...
        i = jn - t.baseLeft,
        a = t.viewportWidth - t.cardWidth - jn - t.baseLeft,
        o = jn - t.baseTop,
        s = t.viewportHeight - t.cardHeight - jn - t.baseTop;
      (e.preventDefault(),
        Xe({
    ...
    _r = (e) => {
      ht.current?.pointerId === e.pointerId &&
        ((ht.current = null), e.currentTarget.releasePointerCapture(e.pointerId));
    };
  return (0, z.jsxs)(`form`, {
    ...
    children: [
                ...
                children: [
                  bt === `at`
                    ? (0, z.jsx)(de, {
                        ...
                        hostId: u,
                        keyboardEventTarget: g,
                        onAddContext: vt.addMention,
                        onRequestClose: vt.closeAutocomplete,
                        onUpdateSelectedMention: vt.setSelectedMention,
                        query: vt.ui?.query ?? ``,
                        roots: _t ?? [],
                        skillRoots: _t,
                        source: vt.ui?.source ?? null,
                      })
                    : null,
                  bt === `skill`
                    ? (0, z.jsx)(re, {
      ...
      (0, z.jsxs)(`div`, {
        ref: at,
        className: sn,
        style: { top: Vt, height: q || zt ? void 0 : 120 },
        children: [
          (0, z.jsxs)(`div`, {
            ref: ot,
            ...
            className: p(
              cn,
              q ? `w-[344px] max-w-full` : `w-[294px] max-w-full`,
              $e && `bg-token-menu-background ring-token-focus-border`,
              Ge ? `opacity-0 duration-[300ms]` : `duration-[150ms]`,
            ),
            style:
              q || zt
                ? { transform: `translate3d(${Ye.x}px, ${Ye.y}px, 0px)` }
                : { height: Bt, transform: `translate3d(${Ye.x}px, ${Ye.y}px, 0px)` },
            onDragEnter: (e) => {
              !V ||
                !ae(e.dataTransfer) ||
                (e.preventDefault(),
            ...
            onDragLeave: (e) => {
              !V ||
                ...
                (e.preventDefault(),
                e.stopPropagation(),
                (ft.current = Math.max(0, ft.current - 1)),
                ft.current === 0 && et(!1));
            },
            onDrop: (e) => {
              if (!V || !ae(e.dataTransfer)) return;
              (e.preventDefault(), e.stopPropagation());
              let t = le(e.dataTransfer);
              (t.length > 0 && $n(t), or());
            },
            children: [
              mr
                ? (0, z.jsx)(m, {
                    ...
                    children: (0, z.jsx)(`span`, {
                      "data-browser-sidebar-design-editor-entry-enter": !q && Ie ? `` : void 0,
                    ...
                    children: Oe.map((e, t) =>
                      (0, z.jsx)(
                        P,
                        {
                          src: e.dataUrl,
                          filename: e.filename,
                          previewPortalContainer: g?.document.body ?? null,
                          onPreviewCloseAutoFocus: Qe,
                          onPreviewOpenChange: Ze,
                          onRemove: () => {
                            let e = J.current.filter((e, n) => n !== t);
                            ((J.current = e), ke(e), Wt(it.current, e));
                          },
                        },
                        `${e.filename ?? `image`}-${t}`,
                      ),
              ...
              q && K != null
                ? (0, z.jsxs)(`div`, {
                    ...
                    className: p(An, Z ? En : `pt-2`, Be ? `gap-0` : `gap-2`),
                    onPointerCancel: _r,
                    onPointerDown: hr,
                    onPointerMove: gr,
                    onPointerUp: _r,
                    children: [
                      (0, z.jsx)(`div`, {
                        ...
                        className: p(
                          ...
                          mr && `ml-8`,
                          Be ? On : `h-7 min-h-0 overflow-hidden`,
                        ),
                        children: (0, z.jsx)(`div`, {
                          className: p(`min-h-0`, !Be && `h-full`),
                          children: (0, z.jsx)(se, {
                            className: p(
                              nn,
                              Be && kn,
                            ...
                            minHeight: `1.5rem`,
                            placeholder: rn,
                            onMentionHandler: vt.handleMentionEvent,
                            onSkillMentionHandler: yt.handleMentionEvent,
                            onSubmit: nr,
                          }),
                        }),
                      }),
                      (0, z.jsx)(
                        ...
                        {
                          defaultExpandedSpacingGroups: r,
                          dropdownPortalContainer: g?.document.body ?? null,
                          editorState: K,
                          isEditable: !0,
                          onDragHandlePointerCancel: _r,
                          onDragHandlePointerDown: hr,
                          onDragHandlePointerMove: gr,
                          onDragHandlePointerUp: _r,
                          onScrubActiveChange: pr,
                          onUpdate: fr,
                        },
                        K.id,
                      ),
                ...
                : (0, z.jsx)(z.Fragment, {
                    children: (0, z.jsx)(`div`, {
                      ...
                      children: (0, z.jsx)(`div`, {
                        className: p(
                          zt ? `min-h-0 translate-y-0.5` : `h-full min-h-0 translate-y-0.5`,
                        ),
                        children: (0, z.jsx)(se, {
                          className: p(
                            nn,
              ...
              (0, z.jsxs)(`div`, {
                ...
                className: p(
                  un,
                  $ == null ? `justify-start gap-1.5` : `justify-between`,
                  Kn ? `scale-100 opacity-100` : `invisible pointer-events-none scale-95 opacity-0`,
                ),
                children: [
                  $ == null
                    ? Wn != null && b != null
                      ? (0, z.jsx)(m, {
                          ...
                          uniform: !0,
                          children: (0, z.jsx)(M, { className: `icon-sm` }),
                        })
                      : null
                    : (0, z.jsx)(m, {
                        "aria-label": en,
                      ...
                      hn
                        ? St
                          ? (0, z.jsx)(m, {
                              ...
                              children: (0, z.jsx)(h, { className: `icon-sm` }),
                            })
                          : (0, z.jsx)(v, {
                              side: `top`,
                              sideOffset: 4,
                              ...
                              tooltipContent: (0, z.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, z.jsx)(Vn, {
                                    keysLabel: xn,
                                    children:
                                      Fn === `direct` ? (0, z.jsx)(Bn, {}) : (0, z.jsx)(zn, {}),
                                  }),
                                  ye
                                    ? (0, z.jsx)(Vn, {
                                        keysLabel: Pn,
                                        children:
                                          Fn === `direct` ? (0, z.jsx)(zn, {}) : (0, z.jsx)(Bn, {}),
                                      })
                                    : null,
                                ],
                              }),
                              children: (0, z.jsx)(m, {
                                ...
                                children: In
                                  ? (0, z.jsx)(S, { className: `icon-sm` })
                                  : (0, z.jsx)(h, { className: `icon-sm` }),
                              }),
                            })
                        : null,
                    ],
          ...
          Ue != null && Jn != null && Jn.length === Ue.rows.length
            ? (0, z.jsxs)(`div`, {
                "aria-hidden": `true`,
                className: `pointer-events-none absolute z-20`,
                "data-browser-comment-design-scrub-clone": !0,
                style: {
                  height: Ue.rect.height,
                  left: Ue.rect.left,
                  top: Ue.rect.top,
                  width: Ue.rect.width,
                },
...
function Vn(e) {
  ...
  t[0] === n
    ...
    : ((i = (0, z.jsx)(`span`, { className: `text-token-foreground`, children: n })),
      ...
      (t[1] = i));
  let a;
  t[2] === r ? (a = t[3]) : ((a = (0, z.jsx)(_, { keysLabel: r })), (t[2] = r), (t[3] = a));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, z.jsxs)(`div`, {
...
function qn(e, t, n, r, i, a, o) {
  ...
  switch (e) {
    case `create`:
      return l(n) && i.length === 0 && c;
    case `edit`:
      return s === t.trim() && Xn(r, i) && c;
    case `design`:
...
function Zn(e, t, n, r) {
  ...
  let a = $n(r),
    o = tr(e, n);
  return a == null || o == null ? i.length >= bn : o + yn > a;
}
function Qn(e, t, n) {
  ...
  let r = er(n),
    i = tr(e, t);
  return r == null || i == null ? !1 : i + xn > r;
}
function $n(e) {
  if (e == null) return null;
  let t = e.getBoundingClientRect();
  if (t.width === 0) return null;
  let n = e.querySelector(`[data-browser-comment-submit]`)?.getBoundingClientRect().width ?? mn,
    r = e.querySelector(`[data-browser-sidebar-design-editor-toggle]`) == null ? 0 : gn;
  return t.width - _n - vn - r - n - hn;
}
function er(e) {
  if (e == null) return null;
  let t = e.getBoundingClientRect();
...
var nr = `browser-comment-popup-shake`;
function rr({ animationFrameRef: e, animationWindow: t, editorWrapper: n }) {
  n != null &&
    (n.classList.remove(nr),
    e.current != null && t.cancelAnimationFrame(e.current),
    (e.current = t.requestAnimationFrame(() => {
      ((e.current = null), n.classList.add(nr));
    })));
}
function ir({ isLightDismissible: e, isLightDismissArmed: t }) {
  return e || t ? `dismiss` : `shake`;
}
export { H as a, Pn as i, ir as n, be as o, rr as r, nr as t };
