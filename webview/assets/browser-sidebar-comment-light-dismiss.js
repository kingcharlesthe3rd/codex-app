...
import { r as he } from "./use-composer-controller.js";
...
var F = { numericInput: `_numericInput_dz8fh_1`, colorInput: `_colorInput_dz8fh_19` },
  ...
  Fe = `w-[112px]`,
  Ie = F.numericInput,
  U = `url("${O(`<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 16 16' fill='none'><path d='M8 1 11 4H9v4H7V4H5l3-3Z' fill='#475569'/><path d='M8 15 5 12h2V8h2v4h2l-3 3Z' fill='#475569'/></svg>`)}") 8 8, ns-resize`,
  W = 4,
  Le = W;
function Re(e) {
  let t = (0, I.c)(61),
  ...
  t[11] === l
    ...
    : ((w = l
        ? (0, R.jsx)(`span`, {
            ...
            children: (0, R.jsx)(se, { className: `icon-sm` }),
          })
        : null),
      (t[11] = l),
      (t[12] = w));
...
function kn({
  ...
  let [je, Me] = (0, L.useState)(F),
    ...
    [Ne, Pe] = (0, L.useState)(() => (u ? (e.designEditorState ?? I ?? null) : null)),
    H = (0, L.useRef)(I ?? null),
  ...
  let bt = Se({ canEditDesign: U != null, showAdjustEntry: u }),
    xt = W && U != null,
    ...
    an = (0, L.useCallback)(() => {
      ...
      ((q.current = t),
        ...
        qt(t, J.current));
      let n = Y.current;
      xt && n != null && w?.(Wt(n, H.current, t.trim()));
    }, [z, xt, Ce, w, e.target.mode, Jt, qt]);
  ((0, L.useEffect)(() => he(z.view, an), [z, an]),
    (0, L.useEffect)(() => {
    ...
    (0, L.useLayoutEffect)(() => {
      ...
      (ut.current === e.sessionId && r?.width === n.width && r?.height === n.height) ||
        ((ut.current = e.sessionId), (dt.current = n), xe(e.sessionId, n, W ? l : void 0));
  ...
  let sn = P.formatMessage({
      ...
      (e) =>
        new Promise((t) => {
          let n = new FileReader(),
            ...
            i = pe(e, window.electronBridge?.getPathForFile) ?? void 0;
          ((n.onload = (e) => {
    ...
    er = () => {
      ...
      if (t.designDraft == null && !t.hasCommentText) {
        n && H.current != null && b?.(H.current.id);
        return;
      }
      _({
  ...
  let ir = (e) => {
    ...
    fr = (e) => {
      ...
      ((Y.current = e), Pe(e), qt(q.current, J.current, e), w?.(t));
    },
    pr = (e, t) => {
      T?.(e);
      ...
      (0, R.jsxs)(`div`, {
        ...
        children: [
          (0, R.jsxs)(`div`, {
            ...
            onDrop: (e) => {
              if (!N || !ce(e.dataTransfer)) return;
              (e.preventDefault(), e.stopPropagation());
              let t = me(e.dataTransfer);
              (t.length > 0 && $n(t), or());
            },
            children: [
              mr
