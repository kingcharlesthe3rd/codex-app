...
import { Dr as t, Sr as n, Tr as r, Zr as i, m as a, ni as o, xr as s } from "./src-C.js";
import {
  Ia as c,
  Jr as l,
  Yr as u,
...
import { n as I } from "./rpc.js";
import { d as L, o as R } from "./statsig.js";
import { n as ee } from "./use-auth.js";
import { t as te } from "./use-debounced-value.js";
import { u as z } from "./apps-queries.js";
import { r as ne } from "./toast-signal.js";
import { r as B, t as re } from "./tooltip.js";
import { _ as ie, o as ae } from "./mention-item.js";
import { r as V, t as oe } from "./use-collaboration-mode.js";
import { t as H } from "./button.js";
import { t as se } from "./spinner.js";
import { t as U } from "./mime-types.js";
import { t as W } from "./composer-footer.js";
import { t as ce } from "./apps.js";
...
import { a as fe, d as pe, i as q, l as me, n as he, r as ge, u as _e } from "./dialog-layout.js";
...
import { r as Te } from "./keyboard-modifier-state.js";
import { t as Ee } from "./badge.js";
import { r as X, t as De } from "./dropdown.js";
import { t as Oe } from "./trash.js";
import { a as ke, i as Ae } from "./use-native-apps.electron.js";
import { n as je } from "./json.js";
import { t as Me } from "./image-square.js";
...
import { i as Le } from "./plugins-page-selectors-B-Roj-OI.js";
import { t as Re } from "./arrow-up.js";
import {
  a as ze,
  c as Be,
  d as Ve,
...
import { t as Je } from "./use-is-appshot-available.js";
import { r as Ye, t as Xe } from "./attachment-remove-button.js";
import { t as Ze } from "./appshot-logo.js";
...
import { t as nt } from "./plan.js";
import { t as rt } from "./appshot-window.js";
import { t as it } from "./undo.js";
import { t as at } from "./regenerate.js";
import { i as ot, n as st, r as ct, t as lt } from "./use-recording-waveform.js";
import { t as ut } from "./use-hotkey.js";
import { t as dt } from "./arrow-rotate-ccw.js";
import { t as ft } from "./drag.js";
import { t as pt } from "./link.js";
...
async function vt(
  ...
  (_.info(`Appshot capture request created`, {
    ...
    xt(),
    F(e, { eventName: `codex_appshot_capture_started`, metadata: { source: s } }),
    ht.set(u, {
      scope: e,
      attachmentGen: n(),
...
function Dt(e) {
  ...
  t[8] === n
    ? (u = t[9])
    : ((u = (0, Q.jsx)(H, { color: `ghost`, type: `button`, onClick: n, children: l })),
      (t[8] = n),
      (t[9] = u));
  let d;
...
function Mt(e) {
  ...
  let D = E,
    O;
  t[6] !== D || t[7] !== d ? ((O = d ?? [D]), (t[6] = D), (t[7] = d), (t[8] = O)) : (O = t[8]);
  let k = O,
    A = k[S] ?? D,
    j = S > 0 ? S - 1 : null,
  ...
  if (
    ...
    t[23] !== p || t[24] !== n
      ? ((c = (0, Q.jsx)(`span`, {
          ...
          children: (0, Q.jsx)(`img`, { src: n, alt: p, className: `size-20 object-cover` }),
        })),
        (t[23] = p),
        (t[24] = n),
        (t[25] = c))
...
function Pt(e) {
  ...
  return (
    t[13] !== h || t[14] !== g || t[15] !== _ || t[16] !== v
      ? ((y = (0, Q.jsxs)(X.Item, { disabled: h, onSelect: g, children: [_, v] })),
        (t[13] = h),
        (t[14] = g),
        (t[15] = _),
        (t[16] = v),
...
function Lt(e) {
  ...
  let M = w ?? ``,
    N;
  t[19] !== n || t[20] !== M ? ((N = [n, M]), (t[19] = n), (t[20] = M), (t[21] = N)) : (N = t[21]);
  let P;
  t[22] !== C || t[23] !== N
    ? ((P = { cacheKey: N, enabled: C, staleTime: 0 }), (t[22] = C), (t[23] = N), (t[24] = P))
    : (P = t[24]);
  let F;
  t[25] !== j || t[26] !== P
    ? ((F = { params: j, queryConfig: P }), (t[25] = j), (t[26] = P), (t[27] = F))
    : (F = t[27]);
  let { data: I, error: L, isLoading: R } = k(`remote-workspace-directory-entries`, F),
  ...
  t[35] !== e.selectedPath
    ? ((B = zt(ne)),
      C &&
        ...
        (!m || ne === ee) &&
        (B =
          o && z.some((t) => t.type === `directory` && t.path === e.selectedPath)
            ? ee
            : I.parentPath),
      (t[28] = C),
      (t[29] = I),
...
function zt(e) {
  ...
  return o === `.` || o === i ? null : t && e.includes(`\\`) ? o.replaceAll(`/`, `\\`) : o;
}
function Bt(e) {
  let t = (0, Z.c)(13),
...
function Vt(e) {
  ...
  let u = i ? void 0 : a,
    d;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(je, { className: `icon-xs shrink-0 text-token-description-foreground` })),
      (t[4] = d))
    : (d = t[4]);
  let f;
  t[5] === n.name
...
function Ut(e) {
  ...
  return (
    t[30] !== S || t[31] !== y
      ? ((C = (0, Q.jsxs)(Q.Fragment, { children: [y, S] })), (t[30] = S), (t[31] = y), (t[32] = C))
      : (C = t[32]),
    C
  );
}
...
function Gt() {
  ...
  return async ({
    ...
    (await O(`pick-files`, { params: { ...(t ? { imagesOnly: !0 } : {}), pickerTitle: n } }))
      .files ?? [];
}
var Kt = e(U(), 1),
  qt = (0, $.memo)(function (e) {
    ...
    let J = ve,
      Y,
      ye;
    if (t[9] !== j || t[10] !== ce || t[11] !== le || t[12] !== ae || t[13] !== K) {
      ((Y = function (t) {
      ...
      be = async function () {
        if (!j)
          try {
            ...
            (o.length > 0 && n(o),
              k && a.length > 0 && (p !== `local` && u != null ? u(a) : l((e) => [...e, ...a])));
          } catch {
            M.get(ne).danger(
              N.formatMessage({
    ...
    t[41] === Ce
      ? (Te = t[42])
      : ((Te = (0, Q.jsxs)(`div`, { className: `flex items-center gap-1`, children: [Ce, we] })),
        (t[41] = Ce),
        (t[42] = Te));
    let X;
    t[43] === ye
    ...
    t[45] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (Oe = t[45]);
    let ke;
    t[46] !== de || t[47] !== j || t[48] !== se || t[49] !== U || t[50] !== ye || t[51] !== X
      ? ((ke = (0, Q.jsx)(H, {
          size: `composer`,
          color: `ghost`,
          uniform: !0,
    ...
    t[79] !== k
      ...
      : (Me = t[80]);
    let Ne;
    t[81] !== j || t[82] !== Y || t[83] !== ie || t[84] !== Ae || t[85] !== Me || t[86] !== Se
      ? ((Ne = (0, Q.jsx)(De, {
          open: ie,
          disabled: j,
          onOpenChange: Y,
      ...
      : (Ne = t[87]);
    let Fe;
    t[88] !== f || t[89] !== p || t[90] !== xe || t[91] !== R || t[92] !== z || t[93] !== G
      ? ((Fe = G
          ? (0, Q.jsx)(me, {
              open: R,
              onOpenChange: (e) => {
...
function Jt(e) {
  ...
  t[69] !== W || t[70] !== C || t[71] !== O
    ...
    : (ye = t[72]);
  let be;
  t[73] !== I || t[74] !== re || t[75] !== ve || t[76] !== J || t[77] !== Y || t[78] !== ye
    ? ((be = (0, Q.jsxs)(`div`, {
        className: `flex w-full items-center justify-between gap-2`,
        children: [
          _e,
  ...
  t[80] !== ge || t[81] !== be
    ...
    : (xe = t[82]);
  let Se;
  t[83] !== r || t[84] !== ae || t[85] !== le || t[86] !== s || t[87] !== d || t[88] !== O
    ? ((Se = d
        ? (0, Q.jsx)(X.Item, {
            LeftIcon: At,
            leftIconClassName: `icon-xs`,
  ...
  return (
    ...
    t[99] !== Se ||
    t[100] !== Ce
      ? ((we = (0, Q.jsxs)(Q.Fragment, { children: [fe, pe, q, me, he, xe, Se, Ce] })),
        (t[94] = fe),
        (t[95] = pe),
        (t[96] = q),
        (t[97] = he),
...
async function tn(e) {
  try {
    let t = await O(`read-file-binary`, { params: { path: e.fsPath, hostId: f } });
...
function ln(e) {
  let t = (0, Z.c)(29),
    ...
    u;
  t[0] === l ? (u = t[1]) : ((u = g(`flex items-center gap-2 px-2`, l)), (t[0] = l), (t[1] = u));
  let d;
  t[2] === o
    ? (d = t[3])
    : ((d =
  ...
  let x;
  return (
    t[22] !== y || t[23] !== b || t[24] !== u || t[25] !== d || t[26] !== p || t[27] !== h
...
function _n(e) {
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, Q.jsx)(Re, { className: `icon-sm text-token-dropdown-background` })), (t[14] = y))
    : (y = t[14]);
  let b;
  t[15] !== n || t[16] !== g || t[17] !== _
    ? ((b = { tooltipContent: h, ariaLabel: g, onClick: _, disabled: n, icon: y }),
      (t[15] = n),
      (t[16] = g),
      (t[17] = _),
      (t[18] = b))
...
function vn(e) {
  ...
  t[35] === D
    ? (O = t[36])
    : ((O = (0, Q.jsx)(`div`, { className: `flex shrink-0 items-center gap-2`, children: D })),
      (t[35] = D),
      (t[36] = O));
  let k;
  return (
...
function On({
  ...
  let k = async ({ action: e, audio: t, handlers: n }) => {
      ...
      try {
        ...
        let i = r.trim();
        i.length > 0 &&
          (j.getInstance().dispatchMessage(`global-dictation-record-history-item`, { text: i }),
          e === `send` ? n.onTranscriptSend(i) : n.onTranscriptInsert(i));
      } catch (r) {
        (_.error(`[Composer] dictation failed`, { safe: {}, sensitive: { error: r } }),
          b.current && ((y.current = { action: e, audio: t, handlers: n }), p(!0)),
    ...
    A = async () => {
      let e = v.current ?? `insert`,
        t = C.current;
      v.current = null;
      let n = Math.max(w, S.current == null ? 0 : performance.now() - S.current);
      S.current = null;
      let r = m.current,
        i = g.current;
      ((g.current = []),
    ...
    (0, $.useEffect)(
      () => (
        ...
        () => {
          b.current = !1;
          let e = m.current;
          e == null || e.state === `inactive` || (v.current ?? ((v.current = `insert`), e.stop()));
        }
      ),
      [],
    ),
      ...
      startDictation: Y(async () => {
        if (!(c || u)) {
          ...
          try {
            ...
            (_.error(`[Composer] unable to start dictation`, { safe: {}, sensitive: { error: e } }),
...
function An({ hasFocusedComposer: e, isComposerFocused: t, isPrimaryComposer: n }) {
  return t || (n && !e);
}
function jn() {
...
function Nn(e) {
  ...
  t[8] !== v || t[9] !== r || t[10] !== d || t[11] !== g
    ? ((y = (e) => {
        !d ||
          ...
          P.dispatchMessage(`global-dictation-in-app-started`, { sessionId: e.sessionId }),
          !(r || m.current) && g());
      }),
      (t[8] = v),
      (t[9] = r),
  ...
  t[14] !== d || t[15] !== o
    ...
    : (x = t[16]);
  let S;
  (t[17] === Symbol.for(`react.memo_cache_sentinel`) ? ((S = []), (t[17] = S)) : (S = t[17]),
  ...
  t[22] === o
    ...
    : ((O = (e) => {
      ...
      (t[23] = O));
  let k;
  (t[24] !== s || t[25] !== T || t[26] !== D || t[27] !== O || t[28] !== C || t[29] !== w
    ? ((k = {
        accelerator: C,
        enabled: w,
        ignoreWithin: T,
...
var Kn = { numericInput: `_numericInput_dz8fh_1`, colorInput: `_colorInput_dz8fh_19` },
          ...
          (0, Q.jsx)(
            dr,
            {
              ...
              onSpacingValueChange: (e, t, n) => {
                f((r) => (ti(v, e, t) ? Pr(r, e, t, n) : jr(r, t, { value: n })));
              },
...
function ur(e) {
  ...
  return (
    t[8] !== a || t[9] !== l || t[10] !== p || t[11] !== d
      ? ((m = (0, Q.jsxs)(`div`, {
          className: `contents`,
          children: [f, (0, Q.jsx)(pr, { showReset: p, resetLabel: l, onReset: a, children: d })],
        })),
        (t[8] = a),
        (t[9] = l),
        (t[10] = p),
...
function dr(e) {
  let t = (0, Z.c)(21),
    ...
    v;
  t[0] === c ? (v = t[1]) : ((v = c ? (0, Q.jsx)(fr, {}) : null), (t[0] = c), (t[1] = v));
  let y;
  t[2] !== n ||
  t[3] !== r ||
  t[4] !== a ||
  ...
  t[16] !== s.sections
    ? ((y = s.sections.map((e, t) => {
        ...
        return (0, Q.jsxs)(
          ...
          {
            className: `contents`,
            children: [t > 0 && Wr(e) && !Wr(s.sections[t - 1]) ? (0, Q.jsx)(fr, {}) : null, c],
          },
          Ur(e),
        );
      })),
...
function mr(e) {
  ...
  t[0] === h
    ? (_ = t[1])
    : ((_ = g(`relative flex min-h-7 min-w-0 items-center text-sm text-token-text-secondary`, h)),
      (t[0] = h),
      (t[1] = _));
  let y;
...
function gr(e) {
  ...
  if (
    ...
    let v = l,
      S;
    (t[20] === o ? (S = t[21]) : ((S = Zr(o, `vertical`)), (t[20] = o), (t[21] = S)), (b = S));
    let C;
    (t[22] === o ? (C = t[23]) : ((C = Zr(o, `horizontal`)), (t[22] = o), (t[23] = C)), (p = C));
    let w;
    ...
    t[36] === D
      ? (O = t[37])
      : ((O = g(`icon-2xs shrink-0 text-token-text-tertiary transition-transform`, D)),
        (t[36] = D),
        (t[37] = O));
    let k;
    (t[38] === O ? (k = t[39]) : ((k = (0, Q.jsx)(Ce, { className: O })), (t[38] = O), (t[39] = k)),
      ...
      (t[14] = b),
      (t[15] = x));
  } else ((p = t[9]), (m = t[10]), (h = t[11]), (_ = t[12]), (y = t[13]), (b = t[14]), (x = t[15]));
  let S;
  ...
  return (
    t[63] !== S || t[64] !== C
      ? ((w = (0, Q.jsxs)(Q.Fragment, { children: [S, C] })), (t[63] = S), (t[64] = C), (t[65] = w))
      : (w = t[65]),
    w
  );
}
...
function vr(e) {
  ...
  t[4] === m
    ? (h = t[5])
    : ((h = g(`icon-2xs shrink-0 text-token-text-tertiary transition-transform`, m)),
      (t[4] = m),
      (t[5] = h));
  let _;
  t[6] === h ? (_ = t[7]) : ((_ = (0, Q.jsx)(Ce, { className: h })), (t[6] = h), (t[7] = _));
  let y;
  t[8] !== f || t[9] !== s || t[10] !== _
    ? ((y = (0, Q.jsx)(`span`, {
        className: `flex min-h-7 min-w-0 items-center pr-2`,
  ...
  t[12] !== n || t[13] !== r || t[14] !== i || t[15] !== c || t[16] !== l || t[17] !== a
    ? ((b = i
        ? (0, Q.jsx)(`span`, { "aria-hidden": `true` })
        : r
          ? (0, Q.jsx)(Dr, { columnGap: n, rowGap: a, onScrubActiveChange: c, onValueChange: l })
          : (0, Q.jsxs)(`span`, {
              className: g(
                Xn,
                `block min-h-7 w-full truncate px-3 py-1 text-right font-mono text-xs text-token-input-foreground`,
  ...
  return (
    t[30] !== x || t[31] !== S
      ? ((C = (0, Q.jsxs)(Q.Fragment, { children: [x, S] })), (t[30] = x), (t[31] = S), (t[32] = C))
      : (C = t[32]),
    C
  );
}
...
function xr(e) {
  ...
  t[1] === o
    ? (s = t[2])
    : ((s = g(`absolute top-1/2 right-0 z-10 h-3.5 w-3.5 -translate-y-1/2 !rounded-full p-0`, o)),
      (t[1] = o),
      (t[2] = s));
  let c;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
...
function Sr(e) {
  ...
  if (fi(n)) {
    ...
    t[18] !== n.property || t[19] !== s
      ? ((e = vi(s, n.property)), (t[18] = n.property), (t[19] = s), (t[20] = e))
      : (e = t[20]);
    let r;
    return (
      t[21] !== n.property ||
...
function Cr(e) {
  ...
  t[1] === u
    ? (d = t[2])
    : ((d = g(Zn, nr, `h-7 w-full truncate text-left`, u)), (t[1] = u), (t[2] = d));
  let f;
  t[3] !== i || t[4] !== o ? ((f = hi(o, i)), (t[3] = i), (t[4] = o), (t[5] = f)) : (f = t[5]);
  let p;
  return (
    t[6] !== n ||
    t[7] !== s ||
...
function wr(e) {
  let t = (0, Z.c)(27),
    ...
    l;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = g(Xn, tr, `flex min-h-7 min-w-0 items-center gap-1 px-3`)), (t[0] = l))
    : (l = t[0]);
  let u = !r && `text-token-input-placeholder-foreground`,
    d;
  t[1] === u
  ...
  let p;
  t[5] !== i || t[6] !== a || t[7] !== o
    ? ((p = ci(i ?? ``) ?? ai(a, i ?? o) ?? void 0), (t[5] = i), (t[6] = a), (t[7] = o), (t[8] = p))
    : (p = t[8]);
  let m;
  t[9] !== i || t[10] !== o
...
function Tr(e) {
  ...
  if (s === `font-family`) {
    let e;
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = g(Xn, er, `flex min-h-7 min-w-0 items-center overflow-hidden`)), (t[5] = e))
      : (e = t[5]);
    let r = !i && `text-token-input-placeholder-foreground`,
      s;
    t[6] === r
      ? (s = t[7])
      : ((s = g(Zn, `h-7 min-w-0 flex-1 truncate px-3 text-left`, r)), (t[6] = r), (t[7] = s));
    let d;
    t[8] === u
      ? (d = t[9])
      : ((d = (e) => {
  ...
  if (c.length === 0) {
    ...
    t[35] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = g(Xn, `flex min-h-7 w-full min-w-0 items-center px-3`)), (t[35] = e))
      : (e = t[35]);
    let r = !i && `text-token-input-placeholder-foreground`,
      o;
    t[36] === r
      ? (o = t[37])
      : ((o = g(Zn, `h-7 w-full truncate text-left`, r)), (t[36] = r), (t[37] = o));
    let s;
    t[38] === u
      ? (s = t[39])
      : ((s = (e) => {
  ...
  t[48] === v
    ? (y = t[49])
    : ((y = g(`min-w-0 flex-1 truncate font-mono text-xs`, v)), (t[48] = v), (t[49] = y));
  let b = p?.label ?? (l || a),
    x;
  t[50] !== y || t[51] !== b
...
function Er(e) {
  let t = (0, Z.c)(9),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = g(Xn, `-ml-6 grid min-h-7 w-[calc(100%+1.5rem)] grid-cols-4 overflow-hidden`)),
      (t[0] = s))
    : (s = t[0]);
  let c;
    ...
    ? ((c = Jn.map((e, t) => {
        ...
        return (0, Q.jsx)(
          Or,
          {
            ...
            scrubValue: l ? (ii(s.value) ?? ii(s.placeholderValue ?? ``) ?? 0) : null,
            step: l ? `any` : void 0,
            title: s.value,
...
function Dr(e) {
  let t = (0, Z.c)(7),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = g(Xn, `grid min-h-7 w-full grid-cols-2 overflow-hidden`)), (t[0] = s))
    : (s = t[0]);
  let c;
  return (
    t[1] !== n || t[2] !== o || t[3] !== i || t[4] !== a || t[5] !== r
      ? ((c = (0, Q.jsx)(`span`, {
          ...
          children: [n, r].map((e, t) => {
            let n = ci(e.value),
              r = e.value.length === 0 || n != null || ai(e.property, e.value) != null;
            return (0, Q.jsx)(
              Or,
              {
                ...
                scrubValue: r
                  ? (ii(e.value) ??
                    ...
                    Number(ai(e.property, e.placeholderValue ?? e.value) ?? `0`))
                  : null,
                step: r ? `any` : void 0,
                title: e.value,
...
function Or(e) {
  ...
  t[4] !== i || t[5] !== y || t[6] !== b || t[7] !== c || t[8] !== l || t[9] !== u || t[10] !== d
    ? ((T = (e) => {
        ...
        if (!t.hasScrubbed) {
          ...
          ((n.cursor = rr), (n.userSelect = `none`), (t.hasScrubbed = !0), y?.(c, e.currentTarget));
        }
  ...
  t[20] === r
    ? (F = t[21])
    : ((F = g(r, `touch-none cursor-text hover:cursor-ns-resize active:cursor-ns-resize`)),
      (t[20] = r),
      (t[21] = F));
  let I;
  t[22] === b
...
function Ar(e) {
  ...
  t[9] === f
    ? (p = t[10])
    : ((p = g(Zn, `h-7 w-full truncate text-left`, f)), (t[9] = f), (t[10] = p));
  let m;
  t[11] === a
    ? (m = t[12])
    : ((m = (e) => {
  ...
  t[13] !== r || t[14] !== p || t[15] !== m || t[16] !== i
    ? ((h = (0, Q.jsx)(`input`, { className: p, value: i, placeholder: r, title: i, onChange: m })),
      (t[13] = r),
      (t[14] = p),
      (t[15] = m),
      (t[16] = i),
...
function $r(e, t, n) {
  ...
  return (
    a != null && o != null && a.value.trim() !== `0` && ii(a.value) !== 0 && ei(a.value, o.value)
  );
}
function ei(e, t) {
  ...
  if (l.surfaceMode === `preview`) {
    ...
    return (
      t[0] !== S || t[1] !== l || t[2] !== A || t[3] !== d
        ? ((e = (0, Q.jsx)(ra, { session: l, showAdjustEntry: A, windowHeight: d, onMounted: S })),
          (t[0] = S),
          (t[1] = l),
          (t[2] = A),
          (t[3] = d),
...
function ra(e) {
  ...
  let S = d ? `items-start` : `items-center`,
    C;
  t[9] === S ? (C = t[10]) : ((C = g(`flex min-w-0 gap-2`, S)), (t[9] = S), (t[10] = C));
  let w;
  t[11] === l
    ? (w = t[12])
    : ((w = l
...
function ia({
  ...
  let [R, ee] = (0, $.useState)(F),
    ...
    [ie, ae] = (0, $.useState)(() => (a ? (e.designEditorState ?? I ?? null) : null)),
    V = (0, $.useRef)(I ?? null),
    [oe, se] = (0, $.useState)(() => ie != null && (n || e.target.mode === `design` || I != null)),
    U = a ? ie : null,
    W = a && oe,
    [ce, le] = (0, $.useState)(!1),
    [G, K] = (0, $.useState)(!1),
  ...
  let st = In({ canEditDesign: U != null, showAdjustEntry: a }),
    ...
    gt = ht === !0,
    {
      ...
      onTranscriptSend: (t) => {
        ...
        let r = { body: n, ...(Ae.current.length === 0 ? {} : { attachedImages: Ae.current }) };
  ...
  ((0, $.useEffect)(() => et(L.view, Rt), [L, Rt]),
    ...
    (0, $.useLayoutEffect)(() => {
      ...
      (Je.current === e.sessionId && r?.width === n.width && r?.height === n.height) ||
        ((Je.current = e.sessionId), (Ye.current = n), y(e.sessionId, n, W ? i : void 0));
  ...
  let Bt = P.formatMessage({
    ...
    un = () => {
      ...
      s({
        ...
        ...(!D || Ae.current.length === 0 ? {} : { attachedImages: Ae.current }),
  ...
  let mn = (e) => {
    ...
    wn = (e, t) => {
      ...
      (ge(!0),
        me({
          rect: { height: f - u, left: c - n.left, top: u - n.top, width: l - c },
          rows: s.map((e) => ({
            controlRect: {
    ...
    Tn = st,
    Dn = (e) => {
      if (!W || !e.isPrimary || e.button !== 0 || Pe.current == null || !oa(e)) return;
      let t = Pe.current.getBoundingClientRect(),
    ...
    An = (e) => {
      tt.current?.pointerId === e.pointerId &&
        ((tt.current = null), e.currentTarget.releasePointerCapture(e.pointerId));
    };
          ...
          (0, Q.jsxs)(`div`, {
            ...
            style:
              W || Dt
                ...
                : { height: kt, transform: `translate3d(${J.x}px, ${J.y}px, 0px)` },
            onDragEnter: (e) => {
              !D ||
                !Ue(e.dataTransfer) ||
                (e.preventDefault(),
            ...
            children: [
              Tn
                ? (0, Q.jsx)(H, {
                    ...
                    onClick: Sn,
                    children: (0, Q.jsx)(`span`, {
                      "data-browser-sidebar-design-editor-entry-enter": !W && G ? `` : void 0,
                              ...
                              tooltipContent: (0, Q.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, Q.jsx)(la, {
                                    keysLabel: tn,
                                    children:
                                      rn === `direct` ? (0, Q.jsx)(ca, {}) : (0, Q.jsx)(sa, {}),
                                  }),
                                  O
                                    ? (0, Q.jsx)(la, {
                                        keysLabel: nn,
                                        children:
                                          rn === `direct` ? (0, Q.jsx)(sa, {}) : (0, Q.jsx)(ca, {}),
                                      })
                                    : null,
                                ],
                              }),
...
function la(e) {
  ...
  t[0] === n
    ...
    : ((i = (0, Q.jsx)(`span`, { className: `text-token-foreground`, children: n })),
      ...
      (t[1] = i));
  let a;
  t[2] === r ? (a = t[3]) : ((a = (0, Q.jsx)(B, { keysLabel: r })), (t[2] = r), (t[3] = a));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, Q.jsxs)(`div`, {
...
function xa(e) {
  ...
  let n = e.querySelector(`[data-browser-comment-submit]`)?.getBoundingClientRect().width ?? Ii,
    r = e.querySelector(`[data-browser-sidebar-design-editor-toggle]`) == null ? 0 : Ri;
