...
import { r as s } from "./use-host-config-C.js";
import { o as c } from "./vscode-api.js";
import { Si as l, _i as u } from "./src-1.js";
import { l as d, s as f } from "./lib-1.js";
import { t as p } from "./clsx.js";
import { t as m } from "./button.js";
import { t as h } from "./check-md.js";
import { t as g } from "./chevron-right.js";
import { r as _, t as v } from "./tooltip-B.js";
import { r as y } from "./toast-signal.js";
import { t as b } from "./arrow-up.js";
import { i as x, r as S, t as C } from "./use-dictation.js";
import { _ as w, g as T } from "./parse-directives.js";
import { s as E } from "./mention-item.js";
import { t as D } from "./rich-link.js";
import { d as O } from "./apps-queries.js";
import { n as k } from "./use-skills.js";
import { t as A } from "./electron-menu-shortcuts.js";
import { t as j } from "./data-url-from-svg.js";
import { r as M } from "./keyboard-modifier-state.js";
import { r as N, t as ee } from "./dropdown.js";
import { t as te } from "./drag.js";
import {
  S as ne,
  a as re,
  b as ie,
...
import { t as ue } from "./trash-DL-ar7Ww.js";
import { a as de, i as fe, n as pe, r as me } from "./use-dictation-hotkey-BeNd-bZT.js";
import { i as he } from "./use-composer-controller.js";
import { t as ge } from "./use-is-dictation-supported.js";
import { t as _e } from "./at-mention-list.js";
import { n as ve, t as ye } from "./prompt-editor-DCa--dg4.js";
import { t as be } from "./arrow-rotate-ccw.js";
import { t as xe } from "./link.js";
function Se({ canEditDesign: e, showAdjustEntry: t }) {
  return t && e;
}
var Ce = /\[((?:\\.|[^\]\n])+)\]\(((?:\\.|[^)\n])+)\)/g;
function we(e) {
  let t = [],
    n = 0,
    r;
  for (Ce.lastIndex = 0; (r = Ce.exec(e)) != null; ) {
    let i = Te(r[1], r[2]);
    i != null &&
...
var De = [
  ...
  Oe = [`100`, `200`, `300`, `400`, `500`, `600`, `700`, `800`, `900`];
function ke(e, t) {
  return t.property === `font-family`
    ? F([t.value, t.previousValue], De)
...
var I = { numericInput: `_numericInput_dz8fh_1`, colorInput: `_colorInput_dz8fh_19` },
  L = r(),
  R = e(t(), 1),
  z = n(),
  ...
  V = `min-w-0 rounded-lg border border-token-input-border bg-token-input-background text-token-input-foreground shadow-sm outline-none transition-colors focus-within:border-token-focus-border focus-within:ring-1 focus-within:ring-token-focus-border`,
  H = `min-w-0 appearance-none border-0 bg-transparent font-mono text-xs text-token-input-foreground outline-none ring-0 placeholder:text-token-input-placeholder-foreground focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0`,
  Ne = I.colorInput,
  Pe = `w-[192px] max-w-full`,
  U = `w-[168px] max-w-full`,
  Fe = `w-[112px]`,
  Ie = I.numericInput,
  W = `url("${j(`<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='0 0 16 16' fill='none'><path d='M8 1 11 4H9v4H7V4H5l3-3Z' fill='#475569'/><path d='M8 15 5 12h2V8h2v4h2l-3 3Z' fill='#475569'/></svg>`)}") 8 8, ns-resize`,
  G = 4,
  Le = G;
function Re(e) {
  let t = (0, L.c)(61),
  ...
  let [p, m] = (0, R.useState)(f),
    [h, g] = (0, R.useState)(!1),
    _;
  t[3] === r ? (_ = t[4]) : ((_ = () => wt(r)), (t[3] = r), (t[4] = _));
  let [v, y] = (0, R.useState)(_),
    b;
  t[5] === r ? (b = t[6]) : ((b = pt(r)), (t[5] = r), (t[6] = b));
  let x = b,
    S,
    C,
    w,
          ...
          (0, z.jsx)(
            Ue,
            {
              ...
              onDimensionValueChange: (e, t) => {
                f((n) => (v.dimensions ? ct(n, e, t) : at(n, e, { value: t })));
              },
              ...
              onSpacingLockToggle: (e, t) => {
                let n = Ct(e, t),
                  r = !v[n];
                (y((e) => ({ ...e, [n]: r })), r && f((n) => ot(n, e, t)));
              },
              onSpacingValueChange: (e, t, n) => {
                f((r) => (Dt(v, e, t) ? st(r, e, t, n) : at(r, t, { value: n })));
              },
              ...
              onDeclarationReset: (e) => {
                let t = St(e);
                f((n) => (t != null && Dt(v, t, e) ? ft(n, t, e) : dt(n, e)));
              },
            },
            e.id,
          )),
...
function Ve(e) {
  ...
  t[0] === n.targetLabel
    ? (c = t[1])
    : ((c = mt(n.targetLabel)), (t[0] = n.targetLabel), (t[1] = c));
  let l = c,
    u;
  t[2] === s
    ? (u = t[3])
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, z.jsx)(te, { className: `icon-xs shrink-0` })), (t[6] = m))
    : (m = t[6]);
  let h;
  t[7] === f
    ? (h = t[8])
...
function He(e) {
  ...
  t[2] !== s || t[3] !== n || t[4] !== o || t[5] !== i
    ? ((u = n
        ? (0, z.jsx)(`span`, {
            className: p(V, Pe, `flex min-h-7 min-w-0 items-center px-3`),
            children: (0, z.jsx)(`input`, {
              ...
              className: p(H, `h-7 w-full text-left`),
  ...
  return (
    t[8] !== a || t[9] !== l || t[10] !== g || t[11] !== m
      ? ((_ = (0, z.jsxs)(`div`, {
          className: `contents`,
          children: [h, (0, z.jsx)(Ge, { showReset: g, resetLabel: l, onReset: a, children: m })],
        })),
        (t[8] = a),
        (t[9] = l),
        (t[10] = g),
...
function Ue(e) {
  let t = (0, L.c)(21),
    ...
    v;
  t[0] === c ? (v = t[1]) : ((v = c ? (0, z.jsx)(We, {}) : null), (t[0] = c), (t[1] = v));
  let y;
  t[2] !== n ||
  t[3] !== r ||
  t[4] !== a ||
  ...
  t[16] !== s.sections
    ? ((y = s.sections.map((e, t) => {
        ...
        return (0, z.jsxs)(
          ...
          {
            className: `contents`,
            children: [t > 0 && _t(e) && !_t(s.sections[t - 1]) ? (0, z.jsx)(We, {}) : null, c],
          },
          gt(e),
        );
      })),
  ...
  t[0] !== c || t[1] !== s || t[2] !== o
    ? ((u = o
        ? (0, z.jsx)(m, {
            ...
            uniform: !0,
            onClick: c,
            children: (0, z.jsx)(be, { className: `icon-2xs` }),
          })
        : null),
      (t[0] = c),
      (t[1] = s),
...
function K(e) {
  ...
  t[2] !== r.property || t[3] !== g
    ? ((y = Ut(g, r.property)), (t[2] = r.property), (t[3] = g), (t[4] = y))
    : (y = t[4]);
  let b;
  t[5] !== r.property || t[6] !== m
    ? ((b = (0, z.jsx)(`span`, {
        className: `block truncate`,
        children: (0, z.jsx)(J, { property: r.property, spacingAxisOnly: m }),
      })),
      (t[5] = r.property),
      (t[6] = m),
      (t[7] = b))
...
function qe(e) {
  ...
  if (
    ...
    let d = l,
      C;
    (t[20] === o ? (C = t[21]) : ((C = Ct(o, `vertical`)), (t[20] = o), (t[21] = C)), (x = C));
    let w;
    (t[22] === o ? (w = t[23]) : ((w = Ct(o, `horizontal`)), (t[22] = o), (t[23] = w)), (h = w));
    let T;
...
function Ye(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, z.jsx)(`span`, {
        className: `truncate`,
        children: (0, z.jsx)(J, { property: `gap` }),
      })),
      (t[3] = h))
    : (h = t[3]);
  let _ = i && `rotate-90`,
  ...
  t[12] !== n || t[13] !== r || t[14] !== i || t[15] !== c || t[16] !== l || t[17] !== a
    ? ((x = i
        ? (0, z.jsx)(`span`, { "aria-hidden": `true` })
        : r
          ? (0, z.jsx)(rt, { columnGap: n, rowGap: a, onScrubActiveChange: c, onValueChange: l })
          : (0, z.jsxs)(`span`, {
              className: p(
                V,
                `block min-h-7 w-full truncate px-3 py-1 text-right font-mono text-xs text-token-input-foreground`,
...
function q(e) {
  ...
  let p;
  t[0] !== i || t[1] !== o || t[2] !== c
    ? ((p = (0, z.jsx)(Ze, { isLocked: i, label: o, onClick: c })),
      (t[0] = i),
      (t[1] = o),
      (t[2] = c),
      (t[3] = p))
...
function Ze(e) {
  ...
  let c;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, z.jsx)(xe, { className: `icon-3xs` })), (t[3] = c))
    : (c = t[3]);
  let l;
  return (
    t[4] !== r || t[5] !== i || t[6] !== s
...
function Qe(e) {
  let t = (0, L.c)(45),
    ...
    s = d(),
    c;
  t[0] === n ? (c = t[1]) : ((c = jt(n)), (t[0] = n), (t[1] = c));
  let l = c;
  if (It(n.property)) {
    let e;
    return (
  ...
  if (n.property === `opacity`) {
    ...
    t[7] !== n.property || t[8] !== s
      ? ((e = Ut(s, n.property)), (t[7] = n.property), (t[8] = s), (t[9] = e))
      : (e = t[9]);
    let r;
    return (
      t[10] !== n.property ||
  ...
  if (Lt(n)) {
    ...
    t[18] !== n.property || t[19] !== s
      ? ((e = Ut(s, n.property)), (t[18] = n.property), (t[19] = s), (t[20] = e))
      : (e = t[20]);
    let r;
    return (
      t[21] !== n.property ||
  ...
  t[29] !== n.property || t[30] !== s
    ? ((u = Ut(s, n.property)), (t[29] = n.property), (t[30] = s), (t[31] = u))
    : (u = t[31]);
  let f = n.property === `font-family` || n.property === `font-weight`,
    p = n.property,
    m;
  t[32] !== n || t[33] !== s
    ? ((m = ke(s, n)), (t[32] = n), (t[33] = s), (t[34] = m))
    : (m = t[34]);
  let h;
  return (
    t[35] !== n.property ||
...
function $e(e) {
  let t = (0, L.c)(15),
    ...
    l;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = p(V, Fe, `flex min-h-7 min-w-0 items-center px-3`)), (t[0] = l))
    : (l = t[0]);
  let u = !r && `text-token-input-placeholder-foreground`,
    d;
  t[1] === u
    ? (d = t[2])
    : ((d = p(H, Ie, `h-7 w-full truncate text-left`, u)), (t[1] = u), (t[2] = d));
  let f;
  t[3] !== i || t[4] !== o ? ((f = Bt(o, i)), (t[3] = i), (t[4] = o), (t[5] = f)) : (f = t[5]);
  let m;
  return (
    t[6] !== n ||
    t[7] !== s ||
...
function et(e) {
  let t = (0, L.c)(27),
    ...
    l;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = p(V, Fe, `flex min-h-7 min-w-0 items-center gap-1 px-3`)), (t[0] = l))
    : (l = t[0]);
  let u = !r && `text-token-input-placeholder-foreground`,
    d;
  t[1] === u
    ...
    : ((d = p(H, Ie, `h-7 w-full truncate text-left`, u)), (t[1] = u), (t[2] = d));
  let m;
  t[3] === o ? (m = t[4]) : ((m = Nt(o) ?? ``), (t[3] = o), (t[4] = m));
  let h;
  t[5] !== i || t[6] !== a || t[7] !== o
    ? ((h = Nt(i ?? ``) ?? At(a, i ?? o) ?? void 0), (t[5] = i), (t[6] = a), (t[7] = o), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== i || t[10] !== o
    ? ((g = Q(o) ?? Q(i ?? ``) ?? 0), (t[9] = i), (t[10] = o), (t[11] = g))
    : (g = t[11]);
  let _;
  t[12] === c
    ? (_ = t[13])
...
function tt(e) {
  ...
  if (s === `font-family`) {
    ...
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = p(V, U, `flex min-h-7 min-w-0 items-center overflow-hidden`)), (t[5] = e))
      : (e = t[5]);
    let r = !i && `text-token-input-placeholder-foreground`,
      s;
    t[6] === r
      ? (s = t[7])
      : ((s = p(H, `h-7 min-w-0 flex-1 truncate px-3 text-left`, r)), (t[6] = r), (t[7] = s));
    let d;
    t[8] === u
      ? (d = t[9])
      : ((d = (e) => {
  ...
  if (c.length === 0) {
    ...
    t[35] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = p(V, `flex min-h-7 w-full min-w-0 items-center px-3`)), (t[35] = e))
      : (e = t[35]);
    let r = !i && `text-token-input-placeholder-foreground`,
      o;
    t[36] === r
      ? (o = t[37])
      : ((o = p(H, `h-7 w-full truncate text-left`, r)), (t[36] = r), (t[37] = o));
    let s;
    t[38] === u
      ? (s = t[39])
      : ((s = (e) => {
...
function nt(e) {
  let t = (0, L.c)(9),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = p(V, `-ml-6 grid min-h-7 w-[calc(100%+1.5rem)] grid-cols-4 overflow-hidden`)),
      (t[0] = s))
    : (s = t[0]);
  let c;
    ...
    ? ((c = je.map((e, t) => {
        ...
        return (0, z.jsx)(
          it,
          {
            ...
            scrubValue: l ? (Q(s.value) ?? Q(s.placeholderValue ?? ``) ?? 0) : null,
            step: l ? `any` : void 0,
            title: s.value,
            type: l ? `number` : void 0,
            placeholder:
              Nt(s.placeholderValue ?? ``) ??
              At(s.property, s.placeholderValue ?? s.value) ??
              void 0,
            value: l ? (c ?? ``) : s.value,
...
function rt(e) {
  let t = (0, L.c)(7),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = p(V, `grid min-h-7 w-full grid-cols-2 overflow-hidden`)), (t[0] = s))
    : (s = t[0]);
  let c;
  return (
    t[1] !== n || t[2] !== o || t[3] !== i || t[4] !== a || t[5] !== r
      ? ((c = (0, z.jsx)(`span`, {
          ...
          children: [n, r].map((e, t) => {
            let n = Nt(e.value),
              r = e.value.length === 0 || n != null || At(e.property, e.value) != null;
            return (0, z.jsx)(
              it,
              {
                ariaLabel: Ut(o, e.property),
                className: p(
                  H,
                  r && Ie,
                  `min-h-7 w-full px-1 text-center`,
                ...
                scrubValue: r
                  ? (Q(e.value) ??
                    ...
                    Number(At(e.property, e.placeholderValue ?? e.value) ?? `0`))
                  : null,
                step: r ? `any` : void 0,
                title: e.value,
                type: r ? `number` : void 0,
                placeholder:
                  Nt(e.placeholderValue ?? ``) ??
                  At(e.property, e.placeholderValue ?? e.value) ??
                  void 0,
                value: r ? (n ?? ``) : e.value,
                onScrubActiveChange: i,
                onValueChange: (t) => {
...
function it(e) {
  ...
  t[0] !== d || t[1] !== f || t[2] !== g
    ? ((C = (e) => {
        ...
        (e.preventDefault(),
          ...
          (e.currentTarget.style.cursor = W),
          (r.cursor = W),
  ...
  t[4] !== i || t[5] !== y || t[6] !== b || t[7] !== c || t[8] !== l || t[9] !== u || t[10] !== d
    ? ((T = (e) => {
        ...
        if ((e.preventDefault(), !t.hasScrubbed && Math.abs(n) < Le)) return;
        if (!t.hasScrubbed) {
          let n = e.currentTarget.ownerDocument.body.style;
          ((n.cursor = W), (n.userSelect = `none`), (t.hasScrubbed = !0), y?.(c, e.currentTarget));
        }
        let r = Math.trunc(n / G),
          a = Ft(t.startValue + r * d, u, l);
        if (a === t.lastValue) {
          e.preventDefault();
          return;
        }
  ...
  t[20] === r
    ? (te = t[21])
    : ((te = p(r, `touch-none cursor-text hover:cursor-ns-resize active:cursor-ns-resize`)),
      (t[20] = r),
      (t[21] = te));
  let ne;
  t[22] === b
...
function J(e) {
  ...
  switch (n) {
    ...
    default: {
      let e;
      t[22] === n ? (e = t[23]) : ((e = Ht(n)), (t[22] = n), (t[23] = e));
      let r;
      return (
        t[24] === e
          ? (r = t[25])
...
function Y(e) {
  let t = (0, L.c)(21),
    ...
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = p(V, Pe, `flex min-h-7 min-w-0 items-center gap-2 px-2`)),
      (s = p(
        Ne,
  ...
  let c = i || r,
    l;
  t[2] === c ? (l = t[3]) : ((l = Vt(c)), (t[2] = c), (t[3] = l));
  let u;
  t[4] === a
    ? (u = t[5])
    : ((u = (e) => {
  ...
  t[9] === f
    ? (m = t[10])
    : ((m = p(H, `h-7 w-full truncate text-left`, f)), (t[9] = f), (t[10] = m));
  let h;
  t[11] === a
    ? (h = t[12])
    : ((h = (e) => {
...
function ct(e, t, n) {
  let r = e.declarations.find((e) => e.property === t),
    ...
    o = r == null ? null : Q(r.value),
    s = a == null ? null : Q(a.value),
    c = Q(n);
  return o == null || s == null || c == null || o === 0
    ? at(e, t, { value: n })
    : X(e, [
        { property: t, value: n },
        { property: i, value: `${Pt((s / o) * c)}px` },
      ]);
}
function lt(e, t) {
  let n = pt(e);
...
function ut(e) {
  let t = pt(e);
  return t == null ? e : lt(e, t.previousValue);
}
function dt(e, t) {
  let n = e.declarations.find((e) => e.property === t);
  return n == null ? e : at(e, t, { value: n.previousValue });
}
function ft(e, t, n) {
...
function vt(e) {
  ...
  for (let n of [`color`, `font`, `border`, `layout`, `other`]) {
    let r = e.filter((e) => yt(e) === n).sort(bt);
...
function xt(e) {
  ...
  if (e.kind === `flex-spacing`) return Me.indexOf(`gap`);
  let t = Me.indexOf(e.declaration.property);
  return t < 0 ? Me.length : t;
}
function St(e) {
...
function wt(e) {
  return {
    dimensions: !1,
    "margin-horizontal": Tt(e.declarations, `margin`, `horizontal`),
    "margin-vertical": Tt(e.declarations, `margin`, `vertical`),
    "padding-horizontal": Tt(e.declarations, `padding`, `horizontal`),
    "padding-vertical": Tt(e.declarations, `padding`, `vertical`),
  };
}
function Tt(e, t, n) {
  let [r, i] = Ot(t, n),
  ...
  return (
    a != null && o != null && a.value.trim() !== `0` && Q(a.value) !== 0 && Et(a.value, o.value)
  );
}
function Et(e, t) {
...
function At(e, t) {
  return zt(e) && t.trim() === `normal` ? `0` : null;
}
function jt(e) {
  return (
    e.placeholderValue ??
...
function Lt(e) {
  return (
    Rt(e.property) &&
    (e.value.length === 0 ||
      Nt(e.placeholderValue ?? ``) != null ||
      Nt(e.value) != null ||
      At(e.property, e.value) != null ||
      At(e.property, e.placeholderValue ?? ``) != null)
  );
}
function Rt(e) {
  return (
...
function Bt(e, t) {
  return e.trim().length === 0 && t != null ? Mt(t) : Mt(e);
}
function Vt(e) {
  let t = e?.trim() ?? ``,
...
function Wt({
  ...
  let i = t.trim();
  return {
    designDraft: !r || n == null ? null : Gt(n, e, i),
...
function Gt(e, t, n) {
  ...
  return {
    ...
    provenance: Yt(i, e.provenance, t?.provenance ?? []),
    selector: e.selector,
...
var Xt = p(
  ...
  Zt = `-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro", "Segoe UI", sans-serif`,
  Qt = {
    ...
    "--font-sans": Zt,
    "--vscode-font-family": Zt,
    fontFamily: Zt,
  },
  $t = `pointer-events-none absolute inset-x-0 top-0 flex flex-col justify-end pb-2`,
  en = `pointer-events-none absolute inset-x-0 flex flex-col overflow-visible bg-transparent`,
  tn = `pointer-events-auto relative overflow-hidden rounded-[22px] bg-token-dropdown-background shadow-md ring-1 ring-token-border-light transition-[height,width,opacity] ease-[cubic-bezier(0.23,1,0.32,1)] motion-reduce:transition-none`,
  nn = `absolute left-4 min-w-0 overflow-hidden transition-[left,width,top,bottom] duration-[140ms] ease-[cubic-bezier(0.23,1,0.32,1)] motion-reduce:transition-none`,
  rn = `absolute inset-x-0 bottom-0 flex h-12 items-center pl-2 pr-3 origin-bottom-left transition-[opacity,transform] duration-150 ease-out motion-reduce:transition-none`,
  an = `pointer-events-none absolute top-0 left-0 whitespace-pre text-base leading-normal font-sans opacity-0`,
  on = `box-border flex h-full w-fit max-w-full overflow-hidden rounded-[22px] bg-token-dropdown-background px-4 shadow-md ring-1 ring-token-border-light`,
  sn = `min-w-0 max-w-full text-base leading-6 font-sans text-token-foreground`,
  cn = `font-semibold`,
  ln = 28,
  un = 8,
  dn = 32,
  ...
  mn = 40,
  hn = 4,
  gn = `!max-h-[180px] overflow-y-auto`,
  _n = `!max-h-full overflow-y-auto`,
  vn = `top-3`,
  yn = `top-24`,
  bn = `pt-24`,
  xn = `pr-[52px]`,
  Sn = `max-h-[84px] min-h-[48px] overflow-hidden`,
  Cn = `!h-auto !max-h-[84px] overflow-y-auto pb-2`,
  wn = `flex min-h-0 flex-col px-4 pb-12`,
  Tn = 8,
  En = 90,
  Dn = 150;
function On(e) {
  ...
  if (l.surfaceMode === `preview`) {
    ...
    return (
      t[0] !== S || t[1] !== l || t[2] !== A || t[3] !== d
        ? ((e = (0, z.jsx)(kn, { session: l, showAdjustEntry: A, windowHeight: d, onMounted: S })),
          (t[0] = S),
          (t[1] = l),
          (t[2] = A),
          (t[3] = d),
...
function kn(e) {
  ...
  t[3] === n.previewAlignment
    ? (v = t[4])
    : ((v = p(`flex h-full w-full`, Bn(n.previewAlignment))),
      (t[3] = n.previewAlignment),
      (t[4] = v));
  let y = f ? `items-start py-2` : `items-center`,
    b;
  t[5] === y ? (b = t[6]) : ((b = p(on, y)), (t[5] = y), (t[6] = b));
  let x;
  ...
  t[11] === l
    ...
    : ((w = l
        ? (0, z.jsx)(`span`, {
            ...
            children: (0, z.jsx)(de, { className: `icon-sm` }),
          })
        : null),
      (t[11] = l),
      (t[12] = w));
  let T = f
    ...
    E;
  t[13] === T ? (E = t[14]) : ((E = p(sn, T)), (t[13] = T), (t[14] = E));
  let D;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = { fontSize: `var(--codex-chat-font-size)` }), (t[15] = D))
    : (D = t[15]);
  let O = s.length > 0 ? zn(s) : u,
    k;
...
function An({
  ...
  onSubmit: _,
  onDirectSubmit: w,
  onDesignChangeDelete: T,
  onDesignChangeUpdate: E,
  onDesignScrubPropertyChange: D,
  onTweaksEditorOpenChange: j,
  onDelete: N,
  onCancel: ee,
  onEscape: te,
  onMounted: xe,
  onBodyChange: Ce,
  onAttachmentPreviewOpenChange: we,
  onLightDismissibilityChange: Te,
  allowImageAttachments: P = !0,
  allowDirectSubmit: Ee,
  defaultCreateSubmitMode: De,
  inputAriaLabel: Oe,
  placeholder: ke,
}) {
  let Ae = i(o),
  ...
  ve(
    (0, R.useCallback)(() => {
      B.view.isDestroyed || B.destroy();
    }, [B]),
  );
  let [je, Me] = (0, R.useState)(I),
    [V, H] = (0, R.useState)(() => e.attachedImages ?? []),
    [Ne, Pe] = (0, R.useState)(() => (l ? (e.designEditorState ?? L ?? null) : null)),
    U = (0, R.useRef)(L ?? null),
    [Fe, Ie] = (0, R.useState)(() => Ne != null && (n || e.target.mode === `design` || L != null)),
    W = l ? Ne : null,
    G = l && Fe,
    [Le, ze] = (0, R.useState)(!1),
    [Be, Ve] = (0, R.useState)(!1),
    [He, Ue] = (0, R.useState)(!1),
    [We, Ge] = (0, R.useState)(!1),
    [K, Ke] = (0, R.useState)(null),
    [qe, Je] = (0, R.useState)(!1),
    [Ye, Xe] = (0, R.useState)(!1),
    [q, Ze] = (0, R.useState)({ x: 0, y: 0 }),
    Qe = (e) => {
      (Xe(e), we?.(e));
    },
    $e = (e) => {
    ...
    [et, tt] = (0, R.useState)(!1),
    [nt, rt] = (0, R.useState)(!1),
    it = a(M),
    J = (0, R.useRef)(I),
    Y = (0, R.useRef)(e.attachedImages ?? []),
    at = (0, R.useRef)(null),
    X = (0, R.useRef)(W);
  X.current = W;
  let ot = (0, R.useRef)(null),
    ...
    mt = (0, R.useRef)(null),
    ht = (0, R.useRef)(null),
    { data: gt } = c(`workspace-root-options`, { params: { hostId: s } }),
    _t = (0, R.useMemo)(() => {
  ...
  let xt = Se({ canEditDesign: W != null, showAdjustEntry: l }),
    St = G && W != null,
    Z = e.target.mode === `edit` || He || G,
    Ct = e.target.mode === `edit` && !G,
    { hasCommentText: wt } = Wt({
      baselineDesignGroup: U.current,
      commentText: je,
      designEditorState: W,
    ...
    Ot = Dt === !0,
    {
      isDictating: kt,
      isTranscribing: Q,
      canRetryDictation: At,
      recordingDurationMs: jt,
      retryDictation: Mt,
      waveformCanvasRef: Nt,
      startDictation: Pt,
      stopDictation: Ft,
    } = C({
      enabled: Ot,
      getSurroundingText: () => B.getText(),
      onTranscriptInsert: (e) => {
        B.view.isDestroyed || B.appendText(e);
      },
      onTranscriptSend: (t) => {
        if (B.view.isDestroyed) return;
        B.appendText(t);
        let n = B.getText().trim();
        if (n.length === 0) return;
        let r = {
          body: n,
          submitSource: `dictation`,
          ...(Y.current.length === 0 ? {} : { attachedImages: Y.current }),
        };
        if (e.target.mode === `create` && De === `direct`) {
          w(r);
          return;
        }
        _(r);
    ...
    It = P && V.length > 0,
    Lt = Z || kt || It,
    Rt = e.target.mode !== `edit` && !He && !It,
    zt = e.target.mode !== `edit` && !G && (Z || It),
    Bt = zt && !Z,
    Vt = Lt ? 120 : 44,
    Ht = Math.min(Math.max(t - 120, 0), 88),
    Ut = O(),
    { skills: qt } = k(_t),
    Jt = (0, R.useCallback)(
      (t, n, r = X.current) => {
        Te(Vn(e.target.mode, I, t, e.attachedImages ?? [], n, U.current, r));
      },
      [Te, e.attachedImages, I, e.target.mode],
    ),
    Yt = (0, R.useCallback)(
      (e, t = st.current) => {
        let n = G && Kn(e, ct.current, t);
        Ge((e) => (e === n ? e : n));
      },
      [G],
    ),
    ...
    on = (0, R.useCallback)(() => {
      ...
      ((J.current = t),
        ...
        Ue(
          e.target.mode !== `edit` &&
            Gn(t, B.view.state.doc.childCount > 1, ct.current, ot.current),
        ),
        Yt(t),
        Jt(t, Y.current));
      let n = X.current;
      St && n != null && E?.(Gt(n, U.current, t.trim()));
    }, [B, St, Ce, E, e.target.mode, Yt, Jt]);
  ((0, R.useEffect)(() => he(B.view, on), [B, on]),
    (0, R.useEffect)(() => {
      B.syncMentionMetadata({ skills: qt, apps: Ut });
    }, [Ut, qt, B]),
    (0, R.useLayoutEffect)(() => {
      ...
      (B.setPromptText(I),
        ...
        Ue(
          e.target.mode !== `edit` &&
            Gn(I, B.view.state.doc.childCount > 1, ct.current, ot.current),
        ),
        Jt(I, t));
    }, [B, e.attachedImages, I, e.sessionId, e.target.mode, Ce, Jt]),
    (0, R.useLayoutEffect)(() => {
      ...
      (ut.current === e.sessionId && r?.width === n.width && r?.height === n.height) ||
        ((ut.current = e.sessionId), (dt.current = n), xe(e.sessionId, n, G ? u : void 0));
    }, [V, je, G, He, We, xe, e.sessionId, Vt, t]),
    (0, R.useEffect)(
      () => () => {
  ...
  let sn = (0, R.useEffectEvent)(() => {
    if (Ye) return;
    let e = B.view.dom,
      t = e.ownerDocument.activeElement,
      n = e.closest(`form`);
    (t != null && n?.contains(t) && !e.contains(t)) || B.focus();
  });
  (0, R.useEffect)(() => {
    if (g == null) return;
    let e = () => {
  ...
  let cn = F.formatMessage({
    ...
    pn = Dt == null || Dt,
    mn = $ == null && !Z && !wt && Dt == null,
    hn = !kt && (pn || mn) && (Z || !wt),
    On = !mn && !kt && (Z || wt || !Ot),
    kn = Et ? (U.current == null ? Tt != null || wt : !Kt(Tt, U.current)) : wt,
    An = me(),
    Rn = A(),
    zn = g?.document.body ?? null,
    Bn = $ == null && Ee && nt && it,
    Hn = Rn ? `⏎` : `Enter`,
    Wn = Rn ? `⌘⏎` : `Ctrl+Enter`,
    qn = Et ? `saved` : Ee ? De : `saved`,
    Jn = qn === `direct` ? !Bn : Bn,
    Yn = U.current?.status === `queued` ? U.current : null,
    Xn = $ != null || G || Yn != null,
    Zn = Z && !kt && Xn,
    Qn =
      K == null || Ne == null
        ? null
        : K.rows.flatMap((e) => {
            let t = jn(Ne.declarations, e.property);
      ...
      (e) =>
        new Promise((t) => {
          let n = new FileReader(),
            ...
            i = le(e, window.electronBridge?.getPathForFile) ?? void 0;
          ((n.onload = (e) => {
    ...
    er = (0, R.useCallback)(
      (e) => {
        P &&
          Promise.all(e.map((e) => $n(e))).then((e) => {
            let t = e.filter((e) => e != null);
            if (t.length === 0) return;
            let n = [...Y.current, ...t];
            ((Y.current = n), H(n), Jt(J.current, n));
          });
      },
      [P, $n, Jt],
    ),
    tr = (e = `button`) => {
      let t = B.getText(),
        n = Wt({
          baselineDesignGroup: U.current,
          commentText: t,
          designEditorState: X.current,
          isDesignSubmissionMode: X.current != null,
        }),
        r = Un({
          baselineDesignGroup: U.current,
      ...
      if (n.designDraft == null && !n.hasCommentText) {
        r && U.current != null && T?.(U.current.id);
        return;
      }
      _({
        body: n.trimmedCommentText,
        submitSource: e,
        ...(!P || Y.current.length === 0 ? {} : { attachedImages: Y.current }),
  ...
  ((0, R.useEffect)(() => {
    ...
    return (
      B.addPastedImagesHandler(e),
      () => {
        B.removePastedImagesHandler(e);
      }
    );
  }, [er, P, B]),
    pe({
      ...
      stopDictation: Ft,
      keyboardEventTarget: g,
      shouldHandleDictation: () => nt,
    }),
    (0, R.useEffect)(() => {
      if (g == null || $ != null) return;
      let e = () => {
          let e = g.document.activeElement;
          rt(e != null && B.view.dom.contains(e));
        },
        t = () => {
  ...
  let ar = (e) => {
    ...
    dr = () => {
      if ((cr(), Ie(!1), Ge(!1), j?.(!1), ze(!1), !Rt)) {
        Ve(!1);
        return;
      }
      (Ve(!0),
        (pt.current = globalThis.setTimeout(() => {
          (Ve(!1), (pt.current = null));
        }, En)));
    },
    fr = (e) => {
      if (G) {
    ...
    pr = (e) => {
      let t = Gt(e, U.current, J.current.trim());
      ((X.current = e), Pe(e), Jt(J.current, Y.current, e), E?.(t));
    },
    mr = (e, t) => {
      D?.(e);
    ...
    hr = xt,
    gr = (e) => {
      re(e, { onAtMention: vt.handleMentionEvent, onSkillMention: yt.handleMentionEvent });
    },
    _r = (e) => {
      if (!G || !e.isPrimary || e.button !== 0 || ot.current == null || !Mn(e)) return;
      let t = ot.current.getBoundingClientRect(),
    ...
    vr = (e) => {
      ...
      let n = t.offsetX + e.clientX - t.startClientX,
        ...
        i = Tn - t.baseLeft,
        a = t.viewportWidth - t.cardWidth - Tn - t.baseLeft,
        o = Tn - t.baseTop,
        s = t.viewportHeight - t.cardHeight - Tn - t.baseTop;
      (e.preventDefault(),
        Ze({
  ...
  return (0, z.jsxs)(`form`, {
    ...
    children: [
      ...
      (0, z.jsxs)(`div`, {
        ref: at,
        className: en,
        style: { top: Ht, height: G || zt ? void 0 : 120 },
        children: [
          (0, z.jsxs)(`div`, {
            ref: ot,
            ...
            className: p(
              ...
              et && `bg-token-menu-background ring-token-focus-border`,
              qe ? `opacity-0 duration-[300ms]` : `duration-[150ms]`,
            ),
            style:
              G || zt
                ? { transform: `translate3d(${q.x}px, ${q.y}px, 0px)` }
                : { height: Vt, transform: `translate3d(${q.x}px, ${q.y}px, 0px)` },
            onDragEnter: (e) => {
              !P ||
                !ie(e.dataTransfer) ||
                (e.preventDefault(),
            ...
            children: [
              hr
                ? (0, z.jsx)(m, {
                    ...
                    children: (0, z.jsx)(`span`, {
                      "data-browser-sidebar-design-editor-entry-enter": !G && Be ? `` : void 0,
                    ...
                    children: V.map((e, t) =>
                      (0, z.jsx)(
                        fe,
                        {
                          ...
                          onPreviewCloseAutoFocus: $e,
                          onPreviewOpenChange: Qe,
                          onRemove: () => {
                            let e = Y.current.filter((e, n) => n !== t);
                            ((Y.current = e), H(e), Jt(J.current, e));
                          },
                        },
                        `${e.filename ?? `image`}-${t}`,
                      ),
              ...
              G && W != null
                ? (0, z.jsxs)(`div`, {
                    ...
                    className: p(wn, It ? bn : `pt-2`, We ? `gap-0` : `gap-2`),
                    onPointerCancel: yr,
                    onPointerDown: _r,
                    onPointerMove: vr,
                    onPointerUp: yr,
                    children: [
                      (0, z.jsx)(`div`, {
                        ...
                        className: p(
                          ...
                          hr && `ml-8`,
                          We ? Sn : `h-7 min-h-0 overflow-hidden`,
                        ),
                        children: (0, z.jsx)(`div`, {
                          className: p(`min-h-0`, !We && `h-full`),
                          children: (0, z.jsx)(ae, {
                            className: p(
                              Xt,
                              We && Cn,
                            ...
                            minHeight: `1.5rem`,
                            placeholder: fn,
                            onSuggestionHandler: gr,
                            onSubmit: () => rr(`keyboard`),
                          }),
                        }),
                      }),
                      (0, z.jsx)(
                        Re,
                        {
                          ...
                          editorState: W,
                          isEditable: !0,
                          onDragHandlePointerCancel: yr,
                          onDragHandlePointerDown: _r,
                          onDragHandlePointerMove: vr,
                          onDragHandlePointerUp: yr,
                          onScrubActiveChange: mr,
                          onUpdate: pr,
                        },
                        W.id,
                      ),
                    ...
                    children: (0, z.jsx)(`div`, {
                      ...
                      children: (0, z.jsx)(`div`, {
                        ...
                        children: (0, z.jsx)(ae, {
                          ...
                          placeholder: fn,
                          onSuggestionHandler: gr,
                          onSubmit: $ == null ? () => rr(`keyboard`) : () => tr(`keyboard`),
                        }),
                      }),
                    }),
                  }),
              ...
              (0, z.jsxs)(`div`, {
                ...
                className: p(
                  ...
                  Zn ? `scale-100 opacity-100` : `invisible pointer-events-none scale-95 opacity-0`,
                ),
                children: [
                  $ == null
                    ? Yn != null && T != null
                      ? (0, z.jsx)(m, {
                          ...
                          uniform: !0,
                          children: (0, z.jsx)(ue, { className: `icon-sm` }),
                        })
                      : null
                    : (0, z.jsx)(m, {
                        "aria-label": un,
                              ...
                              tooltipContent: (0, z.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, z.jsx)(Fn, {
                                    keysLabel: Hn,
                                    children:
                                      qn === `direct` ? (0, z.jsx)(Pn, {}) : (0, z.jsx)(Nn, {}),
                                  }),
                                  Ee
                                    ? (0, z.jsx)(Fn, {
                                        keysLabel: Wn,
                                        children:
                                          qn === `direct` ? (0, z.jsx)(Nn, {}) : (0, z.jsx)(Pn, {}),
                                      })
                                    : null,
                                ],
                              }),
          ...
          K != null && Qn != null && Qn.length === K.rows.length
            ? (0, z.jsxs)(`div`, {
                "aria-hidden": `true`,
...
function Gn(e, t, n, r) {
  ...
  let a = qn(r),
    o = Yn(e, n);
  return a == null || o == null ? i.length >= mn : o + pn > a;
}
function Kn(e, t, n) {
  ...
  let r = Jn(n),
    i = Yn(e, t);
  return r == null || i == null ? !1 : i + hn > r;
}
function qn(e) {
  if (e == null) return null;
  let t = e.getBoundingClientRect();
  if (t.width === 0) return null;
  let n = e.querySelector(`[data-browser-comment-submit]`)?.getBoundingClientRect().width ?? ln,
    r = e.querySelector(`[data-browser-sidebar-design-editor-toggle]`) == null ? 0 : dn;
  return t.width - fn - $ - r - n - un;
}
function Jn(e) {
  if (e == null) return null;
  let t = e.getBoundingClientRect();
...
var Xn = `browser-comment-popup-shake`;
function Zn({ animationFrameRef: e, animationWindow: t, editorWrapper: n }) {
  n != null &&
    (n.classList.remove(Xn),
    e.current != null && t.cancelAnimationFrame(e.current),
    (e.current = t.requestAnimationFrame(() => {
      ((e.current = null), n.classList.add(Xn));
    })));
}
function Qn({ isLightDismissible: e, isLightDismissArmed: t }) {
  return e || t ? `dismiss` : `shake`;
}
export { we as a, On as i, Qn as n, Zn as r, Xn as t };
