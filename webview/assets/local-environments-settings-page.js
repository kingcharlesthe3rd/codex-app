...
import { Xn as c, ar as l, gr as u, sr as d, us as f } from "./app-server-manager-signals.js";
import { k as p, o as m, r as h, s as g } from "./vscode-api.js";
import "./isEqual.js";
import { $t as _, J as v, Zt as y, en as b } from "./src-1.js";
import "./react-dom.js";
...
import { a as P, h as F, r as I } from "./open-project-setup-dialog.js";
...
import "./search.js";
import { r as z, t as ie } from "./dropdown.js";
import { i as ae, n as B, r as oe, t as V } from "./popover.js";
...
function je(e) {
  let t = (0, X.c)(59),
    ...
    ee = j(n),
    te;
  t[0] !== ee || t[1] !== r ? ((te = v(r, ee)), (t[0] = ee), (t[1] = r), (t[2] = te)) : (te = t[2]);
  let ne = te,
    P = f(n),
    { data: F } = d(r, P, `local_environment_editor`),
    I;
  ...
  t[5] !== F || t[6] !== L || t[7] !== k
    ? ((re = {
      ...
      (t[8] = re))
    : (re = t[8]);
  let ae = l(`set-config-value`, P, re),
  ...
  t[28] !== r
    ? ((ue = {
        onSuccess: () => {
          (k.invalidateQueries({
            queryKey: h(`local-environment-config`, { configPath: o, hostId: n }),
          }),
            k.invalidateQueries({ queryKey: h(`local-environment`, { configPath: o, hostId: n }) }),
            k.invalidateQueries({
  ...
  let W = g(`local-environment-config-save`, ue),
    fe;
  t[30] !== o || t[31] !== n || t[32] !== W || t[33] !== U
    ? ((fe = (e) => {
        let { value: t } = e,
          r = Pe(t, U);
        t.name.length !== 0 && W.mutate({ configPath: o, hostId: n, raw: r });
      }),
      (t[30] = o),
      (t[31] = n),
      (t[32] = W),
  ...
  t[51] !== r
    ? ((he = (e) => {
        ...
        Pe(t, U);
        let a = ve.map((e) => ({
            label: D.formatMessage(e.message),
            value: e.value,
...
function He(e) {
  ...
  t[23] === s
    ...
    : ((k = s
      ...
      (t[24] = k));
  let A;
  t[25] !== D || t[26] !== O || t[27] !== k
    ? ((A = (0, Z.jsxs)(J, {
        children: [
          E,
          (0, Z.jsxs)(J.Content, { className: `gap-[var(--padding-panel)]`, children: [D, O, k] }),
        ],
      })),
      (t[25] = D),
      (t[26] = O),
  ...
  t[31] !== c || t[32] !== j
    ? ((M = (0, Z.jsx)(`div`, {
        className: `flex justify-end`,
        children: (0, Z.jsx)(T, { color: `primary`, size: `toolbar`, onClick: c, children: j }),
      })),
      (t[31] = c),
      (t[32] = j),
      (t[33] = M))
...
function Xe(e) {
  ...
  let { data: c, isLoading: l, error: u } = m(`local-environments`, s),
    ...
    _ = fe(h),
    v = n.isCodexWorktree ? ce : ne,
    y = n.repositoryData?.ownerRepo?.owner ?? null,
    b = l,
    C = u != null,
    D = h.length > 0 || g.length > 0,
    O;
  t[3] === o
    ? (O = t[4])
    : ((O = o.formatMessage({
...
function nt() {
  ...
  let g = h,
    ...
    [v, y] = (0, Te.useState)(r),
    [b, x] = (0, Te.useState)(s),
    [C, w] = (0, Te.useState)(l === `edit`),
    T = v ?? null,
    E;
  e[10] !== T || e[11] !== g
    ? ((E = T != null && g.includes(T) ? T : null), (e[10] = T), (e[11] = g), (e[12] = E))
    : (E = e[12]);
  let D = E,
    O = D == null ? null : (_.find((e) => e.path === D) ?? null),
    k = D == null,
    j;
  e[13] === u
    ? (j = e[14])
  ...
  let { data: ke, error: Ae, isLoading: Me } = m(`local-environment`, Oe),
    ...
    Ie;
  e[59] !== ee || e[60] !== z || e[61] !== C || e[62] !== D || e[63] !== O
    ? ((Ie =
        D == null
          ? null
          : (0, Z.jsx)(De, {
  ...
  if (k) {
    ...
    let n;
    return (
      e[66] !== M || e[67] !== oe || e[68] !== ae || e[69] !== u || e[70] !== _ || e[71] !== p
        ? ((n = (0, Z.jsx)(it, {
            subtitle: t,
            children: (0, Z.jsx)(qe, {
              groups: _,
