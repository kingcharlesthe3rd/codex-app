...
import { n as Dt, t as Ot } from "./esm-1.js";
function kt(e, t) {
  let n = tt(e) ?? e;
  return t?.label ?? n;
}
...
function jt(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, J.jsx)(`span`, {
      ...
      (u = (0, J.jsx)(xe, { className: `icon-xs text-token-text-secondary` })),
      (t[5] = l),
      (t[6] = u))
    : ((l = t[5]), (u = t[6]));
  let f;
  t[7] === s
    ? (f = t[8])
    : ((f = (0, J.jsx)(`span`, { className: `text-token-text-primary`, children: s })),
      (t[7] = s),
      (t[8] = f));
  let p;
  t[9] === i
    ...
    : ((p =
        i === `edit`
          ? (0, J.jsxs)(J.Fragment, {
              children: [
                (0, J.jsx)(xe, { className: `icon-xs text-token-text-secondary` }),
                (0, J.jsx)(`span`, {
                  children: (0, J.jsx)(d, {
  ...
  let m;
  t[11] !== f || t[12] !== p
    ? ((m = (0, J.jsxs)(`div`, { className: `flex items-center gap-1`, children: [l, u, f, p] })),
      (t[11] = f),
      (t[12] = p),
      (t[13] = m))
    : (m = t[13]);
...
function Ht(e) {
  ...
  return (
    t[14] !== l || t[15] !== f || t[16] !== p
      ? ((m = (0, Wt.jsx)(ze, { icon: l, label: f, description: p, control: null })),
        (t[14] = l),
        (t[15] = f),
        (t[16] = p),
        (t[17] = m))
...
function Kt(e) {
  let t = (0, on.c)(67),
    ...
    b = n(),
    { data: x } = T(),
    { data: C, error: w, refetch: te } = O(i),
    D = C?.codexHome,
    A;
  t[0] !== D || t[1] !== o?.isCodexWorktree || t[2] !== a
    ? ((A = o?.isCodexWorktree === !0 || (D != null && ne(a, D))),
      (t[0] = D),
  ...
  let j = A,
    N = y(i),
    { data: P } = ee(a, N, `local_environment_editor`),
    re;
  t[4] !== i || t[5] !== a
    ? ((re = { hostId: i, workspaceRoot: a }), (t[4] = i), (t[5] = a), (t[6] = re))
    : (re = t[6]);
  let { updateSelection: ie } = nt(re),
    F;
  t[7] !== P || t[8] !== N || t[9] !== _
    ? ((F = {
        onSuccess: (e, t) => {
          !e.success || !P || it(_, P, N, t.value, `local_environment_editor`);
        },
      }),
      (t[7] = P),
      (t[8] = N),
      ...
      (t[10] = F))
    : (F = t[10]);
  let ae = pe(`set-config-value`, N, F),
    [I, oe] = (0, sn.useState)(`default`),
    [se, ce] = (0, sn.useState)(`default`),
    [le, ue] = (0, sn.useState)(!c),
    R,
    z;
  if (
    t[11] !== l?.actions ||
  ...
  t[30] !== a
    ? ((fe = {
        onSuccess: async (e) => {
          let { configPath: t } = e;
          (b.invalidateQueries({
            queryKey: u(`local-environment-config`, { configPath: t, hostId: i }),
          }),
            b.invalidateQueries({
              queryKey: u(`local-environment`, { configPath: t, hostId: i }),
            }));
          let n = () =>
            b.invalidateQueries({
              queryKey: u(`local-environments`, { hostId: i, workspaceRoot: a }),
            });
          if (le) {
            if (
              !(await Et({
                ...
                configPath: t,
                gitRoot: P?.root ?? null,
                refreshEnvironments: n,
                selectForWorkspace: ie,
      ...
      (t[31] = fe))
    : (fe = t[31]);
  let B = r(`local-environment-config-save`, fe),
    V;
  t[32] !== s || t[33] !== i || t[34] !== B || t[35] !== z
    ? ((V = (e) => {
        let { value: t } = e,
          n = Xt(t, z);
        t.name.length !== 0 && B.mutate({ configPath: s, hostId: i, raw: n });
      }),
      (t[32] = s),
      (t[33] = i),
      (t[34] = B),
  ...
  let me;
  t[37] !== de || t[38] !== V
    ? ((me = { defaultValues: de, onSubmit: V }), (t[37] = de), (t[38] = V), (t[39] = me))
    : (me = t[39]);
  let H = Dt(me),
    he;
  t[40] === H
  ...
  t[59] !== a
    ? ((U = (e) => {
        ...
        Xt(t, z);
        let r = ht.map((e) => ({
            label: v.formatMessage(e.message),
            value: e.value,
          ...
          c = Zt({
            values: t,
            isDirty: n,
            isSelectionReady: !le || ((o != null || D != null) && (!j || P?.root != null)),
            selectionError: o == null && w != null,
          ...
          m = (e, n, r) => {
            if (n === `default`) {
              H.setFieldValue(e === `setup` ? `setupScript` : `cleanupScript`, r);
              return;
            }
            let { scriptField: i, scripts: a } = $t(t, e);
            H.setFieldValue(i, { ...a, [n]: r });
          },
          g = () => {
            H.setFieldValue(`actions`, [...t.actions, xt(``)]);
          },
          _ = (e) => {
            H.setFieldValue(
              `actions`,
            ...
            (0, X.jsxs)(K, {
              children: [
                ...
                (0, X.jsxs)(K.Content, {
                  ...
                  children: [
                    (0, X.jsx)(q, {
                      children: (0, X.jsx)(Ht, { workspaceRoot: a, workspaceGroup: o }),
                    }),
                    p
                      ? (0, X.jsx)(`div`, {
                    ...
                    (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, X.jsx)(`input`, {
                          ...
                          value: t.name,
                          onChange: (e) => {
                            H.setFieldValue(`name`, e.target.value);
                          },
                        }),
                      ],
                    }),
                      ...
                      children: [
                        ...
                        (0, X.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, X.jsx)(`textarea`, {
                              id: `local-environment-setup-script-${I}`,
                ...
                children: [
                  ...
                  (0, X.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, X.jsx)(`textarea`, {
                        id: `local-environment-cleanup-script-${se}`,
                        className: `focus-visible:ring-token-focus w-full rounded-md border border-token-border bg-token-input-background px-2.5 py-2 font-mono text-sm text-token-text-primary outline-none focus-visible:ring-2`,
                        value: en(t, `cleanup`, se),
                        placeholder: bt,
                        rows: 6,
                        onChange: (e) => {
                          m(`cleanup`, se, e.target.value);
                        },
                      }),
                    ],
                  }),
              ...
              children: [
                ...
                (0, X.jsxs)(K.Content, {
                  ...
                  children: [
                    (0, X.jsx)(`div`, {
                      className: `text-sm text-token-text-secondary`,
                      children: (0, X.jsx)(d, { ...Pt.actionsDescription }),
                    }),
                    t.actions.length === 0
                      ? (0, X.jsx)(q, {
                          children: (0, X.jsx)(`div`, {
                            className: `p-3 text-sm text-token-text-secondary`,
                            children: (0, X.jsx)(d, { ...Pt.actionsEmpty }),
                          }),
                        })
                      : (0, X.jsx)(`div`, {
                          className: `flex flex-col gap-3`,
                          children: t.actions.map((e) => {
                            let t = r.find((t) => t.value === (e.icon ?? `tool`)) ?? r[0],
                              n = e.platform != null,
                              a = e.platform ?? i;
                            return (0, X.jsxs)(
                              `div`,
                                      ...
                                      (0, X.jsx)(`div`, {
                                        ...
                                        children: (0, X.jsx)(S, {
                                          ...
                                          children: (0, X.jsx)(L, {
                                            ...
                                            children: (0, X.jsx)(Pe, { className: `icon-sm` }),
                                          }),
                                        }),
                                      }),
                                    ],
    ...
    : (U = t[60]);
  let ge;
  t[61] !== H.Subscribe || t[62] !== U
    ? ((ge = (0, X.jsx)(H.Subscribe, { selector: qt, children: U })),
      (t[61] = H.Subscribe),
      (t[62] = U),
      (t[63] = ge))
    : (ge = t[63]);
...
function ln(e) {
  ...
  t[9] !== c || t[10] !== te
    ? ((T = (0, Z.jsx)(K.Header, {
        title: w,
        actions: (0, Z.jsx)(L, { color: `primary`, size: `toolbar`, onClick: c, children: te }),
      })),
      (t[9] = c),
      (t[10] = te),
      (t[11] = T))
  ...
  let A;
  t[23] !== k || t[24] !== T
    ? ((A = (0, Z.jsxs)(K, { children: [T, k] })), (t[23] = k), (t[24] = T), (t[25] = A))
    : (A = t[25]);
  let j;
  t[26] !== f ||
  t[27] !== v ||
              ...
              (0, Z.jsxs)(K, {
                children: [
                  (0, Z.jsx)(K.Header, {
                    ...
                    subtitle: (0, Z.jsx)(d, { ...Pt.actionsDescription }),
                  }),
                  (0, Z.jsx)(K.Content, {
                    children: (0, Z.jsx)(q, {
                      children:
                        f.length > 0
                          ? f.map(un)
                          : (0, Z.jsx)(ze, {
                              label: (0, Z.jsx)(d, { ...Pt.actionsEmpty }),
                              control: null,
                            }),
                    }),
                  }),
  ...
  let M;
  return (
    t[39] !== A || t[40] !== j || t[41] !== C
      ? ((M = (0, Z.jsxs)(Z.Fragment, { children: [C, A, j] })),
        (t[39] = A),
        (t[40] = j),
        (t[41] = C),
        (t[42] = M))
...
var pn,
  Z,
  mn = e(() => {
    ((pn = w()), p(), U(), We(), Ft(), Lt(), Ye(), Ne(), ut(), yt(), Vt(), Gt(), (Z = V()));
  });
function hn(e) {
  let t = (0, wn.c)(14),
    {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(d, { ...Pt.selectProject })), (t[0] = c))
    : (c = t[0]);
  let l;
  ...
  t[2] === a
    ...
    : ((u = (0, Q.jsx)(K.Header, {
        title: c,
        actions: (0, Q.jsx)(L, { color: `secondary`, size: `toolbar`, onClick: a, children: l }),
      })),
      (t[2] = a),
      (t[3] = u));
  let f;
  ...
  return (
    t[11] !== u || t[12] !== f
      ? ((p = (0, Q.jsxs)(K, { className: `gap-2`, children: [u, f] })),
        (t[11] = u),
        (t[12] = f),
        (t[13] = p))
      : (p = t[13]),
...
function gn(e) {
  ...
  return (
    t[23] !== l || t[24] !== u || t[25] !== f || t[26] !== p
      ? ((h = (0, Q.jsx)(`div`, { className: l, role: u, "aria-label": f, children: p })),
        (t[23] = l),
        (t[24] = u),
        (t[25] = f),
        (t[26] = p),
...
function vn(e) {
  ...
  t[0] !== n.path || t[1] !== r
    ? ((s = { params: { hostId: r, workspaceRoot: n.path }, select: yn }),
      ...
      (t[2] = s))
    : (s = t[2]);
  let { data: c, isLoading: u, error: f } = je(`local-environments`, s),
    p = c === void 0 ? [] : c,
    [m, h] = (0, Tn.useState)(!1),
    { projectEnvironments: g, inheritedEnvironments: _ } = Sn(p, n.path),
    v = ot(g),
    y = n.isCodexWorktree ? Be : Ae,
  ...
  t[11] === y
    ? (M = t[12])
    : ((M = (0, Q.jsx)(y, { className: `icon-sm shrink-0 text-token-text-secondary` })),
      (t[11] = y),
      (t[12] = M));
  let N;
  t[13] === n.label
    ? (N = t[14])
    : ((N = (0, Q.jsx)(`span`, { className: `truncate font-medium`, children: n.label })),
      (t[13] = n.label),
      (t[14] = N));
  let P;
  t[15] === b
  ...
  return (
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((re = (0, Q.jsx)(l, { className: `icon-xs` })), (t[20] = re))
      : (re = t[20]),
    (0, Q.jsxs)(q, {
      className: `p-0`,
      children: [
...
function bn(e) {
  ...
  let v;
  t[13] !== r || t[14] !== a
    ? ((v = (0, Q.jsx)(L, { color: `ghost`, size: `toolbar`, onClick: a, children: r })),
      (t[13] = r),
      (t[14] = a),
      (t[15] = v))
    : (v = t[15]);
...
function Dn() {
  let e = (0, An.c)(109),
    ...
    r = we(),
    a = re(Ke) != null,
    o = a ? qe(t, n.state) : null,
    s;
  e[0] === t ? (s = e[1]) : ((s = t.get(`workspaceRoot`)), (e[0] = t), (e[1] = s));
  let l = s,
    u;
  e[2] === t ? (u = e[3]) : ((u = t.get(`configPath`)), (e[2] = t), (e[3] = u));
  let f = u,
    p;
  e[4] === t ? (p = e[5]) : ((p = t.get(`mode`)), (e[4] = t), (e[5] = p));
  let m = p,
    { selectedHostId: h } = Le(),
    v = o?.hostId ?? h,
    { data: y, isLoading: b } = Te(i, { hostId: v }),
    x;
  e[6] === y?.roots ? (x = e[7]) : ((x = y?.roots ?? []), (e[6] = y?.roots), (e[7] = x));
  let ee = x,
    S = Re(c(Se), v),
    [C, w] = (0, jn.useState)(o?.workspaceRoot ?? l),
    [te, T] = (0, jn.useState)(o?.configPath ?? f),
    [E, D] = (0, jn.useState)(o != null || m === `edit`),
    O = C ?? null,
    k = O != null && (o != null || ee.includes(O)) ? O : null,
    A = k == null ? null : (S.find((e) => e.path === k) ?? null),
    j = k == null,
    M;
  e[8] === v
    ? (M = e[9])
  ...
  let ne = P,
    ie;
  e[14] !== o || e[15] !== r || e[16] !== D
    ? ((ie = () => {
        if (o != null) {
          r(o.returnTo, { replace: !0 });
          return;
        }
        D(!1);
      }),
  ...
  let se = oe,
    ...
    L;
  e[26] !== v || e[27] !== ce
    ? ((L = { hostId: v, workspaceRoot: ce }), (e[26] = v), (e[27] = ce), (e[28] = L))
    : (L = e[28]);
  let le = !j && k != null,
    R;
  e[29] === le ? (R = e[30]) : ((R = { enabled: le }), (e[29] = le), (e[30] = R));
  let z;
  e[31] !== L || e[32] !== R
    ? ((z = { params: L, queryConfig: R, select: On }), (e[31] = L), (e[32] = R), (e[33] = z))
    : (z = e[33]);
  let { data: de, isLoading: fe, error: B } = je(`local-environments`, z),
    V;
  e[34] === de ? (V = e[35]) : ((V = de === void 0 ? [] : de), (e[34] = de), (e[35] = V));
  let pe = V,
    H;
  e[36] === pe ? (H = e[37]) : ((H = ot(pe)), (e[36] = pe), (e[37] = H));
  let he = H,
    U;
  e[38] !== o || e[39] !== pe || e[40] !== B || e[41] !== fe || e[42] !== k
    ? ((U = o != null && o.configPath == null && !fe && B == null && k != null ? rt(pe, k) : null),
      (e[38] = o),
      (e[39] = pe),
      (e[40] = B),
      (e[41] = fe),
    ...
    : (U = e[43]);
  let ge = U,
    _e = te ?? o?.configPath ?? ge ?? (o == null ? he : null),
    ve = _e ?? ``,
    ye;
  e[44] !== v || e[45] !== ve
    ? ((ye = { configPath: ve, hostId: v }), (e[44] = v), (e[45] = ve), (e[46] = ye))
    : (ye = e[46]);
  let be = !j && k != null && _e != null,
    xe;
  e[47] === be ? (xe = e[48]) : ((xe = { enabled: be }), (e[47] = be), (e[48] = xe));
  let Ce;
  e[49] !== ye || e[50] !== xe
    ? ((Ce = { params: ye, queryConfig: xe }), (e[49] = ye), (e[50] = xe), (e[51] = Ce))
    : (Ce = e[51]);
  let { data: W, isLoading: Ee, error: De } = je(`local-environment-config`, Ce),
    Oe = W?.configPath ?? ``,
    Ae;
  e[52] !== v || e[53] !== Oe
    ? ((Ae = { configPath: Oe, hostId: v }), (e[52] = v), (e[53] = Oe), (e[54] = Ae))
    : (Ae = e[54]);
  let Me = !j && k != null && !!W?.exists,
    Ne;
  e[55] === Me ? (Ne = e[56]) : ((Ne = { enabled: Me }), (e[55] = Me), (e[56] = Ne));
  let Pe;
  e[57] !== Ae || e[58] !== Ne
    ? ((Pe = { params: Ae, queryConfig: Ne }), (e[57] = Ae), (e[58] = Ne), (e[59] = Pe))
    : (Pe = e[59]);
  let { data: Fe, error: Ie, isLoading: ze } = je(`local-environment`, Pe),
    Be = Fe?.environment.type === `success` ? Fe.environment.environment : null,
    Ve = Fe?.environment.type === `error` ? Fe.environment.error.message : null,
    He = De?.message ?? Ie?.message ?? B?.message ?? null,
    Ue;
  e[60] !== ne || e[61] !== F || e[62] !== E || e[63] !== k || e[64] !== A
    ? ((Ue =
        k == null
          ? null
          : (0, $.jsx)(jt, {
  ...
  if (a && o == null) {
    ...
    return (
      e[66] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, $.jsx)(me, { to: `/settings/local-environments`, replace: !0 })), (e[66] = t))
        : (t = e[66]),
      t
    );
  }
  if (j) {
    ...
    let n;
    return (
      e[68] !== N || e[69] !== se || e[70] !== I || e[71] !== v || e[72] !== S || e[73] !== b
        ? ((n = (0, $.jsx)(kn, {
            subtitle: t,
            children: (0, $.jsx)(hn, {
              groups: S,
...
function kn(e) {
  let t = (0, An.c)(5),
    ...
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(Xe, { slug: `local-environments` })), (t[0] = a))
    : (a = t[0]);
  let o;
  return (
    t[1] !== n || t[2] !== i || t[3] !== r
      ? ((o = (0, $.jsx)(lt, { title: a, subtitle: r, backSlot: n, children: i })),
        (t[1] = n),
        (t[2] = i),
        (t[3] = r),
        (t[4] = o))
