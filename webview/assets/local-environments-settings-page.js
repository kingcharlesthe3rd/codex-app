...
import { _n as G, hn as Ge } from "./app-initial~app-main~automations-page.js";
import {
  X as Ke,
  Y as qe,
  dt as Je,
...
import { n as Dt, t as Ot } from "./esm-2.js";
function kt(e, t) {
  let n = $e(e) ?? e;
  return t?.label ?? n;
}
...
function jt(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, J.jsx)(`span`, {
      ...
      (d = (0, J.jsx)(R, { className: `icon-xs text-token-text-secondary` })),
      (t[5] = l),
      (t[6] = d))
    : ((l = t[5]), (d = t[6]));
  let f;
  ...
  t[9] === i
    ...
    : ((p =
        i === `edit`
          ? (0, J.jsxs)(J.Fragment, {
              children: [
                (0, J.jsx)(R, { className: `icon-xs text-token-text-secondary` }),
                (0, J.jsx)(`span`, {
                  children: (0, J.jsx)(u, {
  ...
  let m;
  t[11] !== f || t[12] !== p
    ? ((m = (0, J.jsxs)(`div`, { className: `flex items-center gap-1`, children: [l, d, f, p] })),
      (t[11] = f),
      (t[12] = p),
      (t[13] = m))
    : (m = t[13]);
...
function Ht(e) {
  ...
  return (
    t[14] !== l || t[15] !== f || t[16] !== p
      ? ((m = (0, Wt.jsx)(W, { icon: l, label: f, description: p, control: null })),
        (t[14] = l),
        (t[15] = f),
        (t[16] = p),
        (t[17] = m))
...
function Kt(e) {
  let t = (0, on.c)(67),
    ...
    _ = ce(),
    { data: v } = ke(),
    { data: y, error: ee, refetch: x } = Ne(n),
    S = y?.codexHome,
    C;
  t[0] !== S || t[1] !== i?.isCodexWorktree || t[2] !== r
    ? ((C = i?.isCodexWorktree === !0 || (S != null && b(r, S))),
      (t[0] = S),
  ...
  let w = C,
    T = d(n),
    { data: E } = le(r, T, `local_environment_editor`),
    D;
  t[4] !== n || t[5] !== r
    ? ((D = { hostId: n, workspaceRoot: r }), (t[4] = n), (t[5] = r), (t[6] = D))
    : (D = t[6]);
  let { updateSelection: k } = rt(D),
    A;
  t[7] !== E || t[8] !== T || t[9] !== h
    ? ((A = {
        onSuccess: (e, t) => {
          !e.success || !E || ct(h, E, T, t.value, `local_environment_editor`);
        },
      }),
      (t[7] = E),
      (t[8] = T),
      ...
      (t[10] = A))
    : (A = t[10]);
  let j = he(`set-config-value`, T, A),
    [M, N] = (0, sn.useState)(`default`),
    [P, F] = (0, sn.useState)(`default`),
    [ae, oe] = (0, sn.useState)(!s),
    se,
    I;
  if (
    t[11] !== c?.actions ||
  ...
  t[30] !== r
    ? ((de = {
        onSuccess: async (e) => {
          let { configPath: t } = e;
          (_.invalidateQueries({
            queryKey: o(`local-environment-config`, { configPath: t, hostId: n }),
          }),
            _.invalidateQueries({
              queryKey: o(`local-environment`, { configPath: t, hostId: n }),
            }));
          let i = () =>
            _.invalidateQueries({
              queryKey: o(`local-environments`, { hostId: n, workspaceRoot: r }),
            });
          if (ae) {
            if (
              !(await Et({
      ...
      (t[31] = de))
    : (de = t[31]);
  let L = ne(`local-environment-config-save`, de),
    R;
  t[32] !== a || t[33] !== n || t[34] !== L || t[35] !== I
    ? ((R = (e) => {
        let { value: t } = e,
          r = Xt(t, I);
        t.name.length !== 0 && L.mutate({ configPath: a, hostId: n, raw: r });
      }),
      (t[32] = a),
      (t[33] = n),
      (t[34] = L),
  ...
  let fe;
  t[37] !== ue || t[38] !== R
    ? ((fe = { defaultValues: ue, onSubmit: R }), (t[37] = ue), (t[38] = R), (t[39] = fe))
    : (fe = t[39]);
  let B = Dt(fe),
    pe;
  t[40] === B
  ...
  t[59] !== r
    ? ((me = (e) => {
        ...
        Xt(t, I);
        let a = ht.map((e) => ({
            label: g.formatMessage(e.message),
            value: e.value,
          ...
          c = Zt({
            values: t,
            isDirty: n,
            isSelectionReady: !ae || ((i != null || S != null) && (!w || E?.root != null)),
            selectionError: i == null && ee != null,
          ...
          m = (e, n, r) => {
            if (n === `default`) {
              B.setFieldValue(e === `setup` ? `setupScript` : `cleanupScript`, r);
              return;
            }
                      ...
                      children: [
                        ...
                        (0, X.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, X.jsx)(`textarea`, {
                              id: `local-environment-setup-script-${M}`,
                                      ...
                                      (0, X.jsx)(`div`, {
                                        ...
                                        children: (0, X.jsx)(Se, {
                                          ...
                                          children: (0, X.jsx)(z, {
                                            ...
                                            children: (0, X.jsx)(re, { className: `icon-sm` }),
                                          }),
                                        }),
                                      }),
                                    ],
    ...
    : (me = t[60]);
  let V;
  t[61] !== B.Subscribe || t[62] !== me
    ? ((V = (0, X.jsx)(B.Subscribe, { selector: qt, children: me })),
      (t[61] = B.Subscribe),
      (t[62] = me),
      (t[63] = V))
    : (V = t[63]);
...
function ln(e) {
  let t = (0, pn.c)(43),
    ...
    l = i && a != null,
    d;
  t[0] === a?.actions ? (d = t[1]) : ((d = a?.actions ?? []), (t[0] = a?.actions), (t[1] = d));
  let f = d,
    p = a?.setup.script ?? ``,
    m = a?.cleanup?.script ?? ``,
    ...
    ee = h.length > 0 || g.length > 0 || _.length > 0,
    te = v.length > 0 || y.length > 0 || b.length > 0,
    x;
  ...
  t[9] !== c || t[10] !== re
    ? ((C = (0, Z.jsx)(q.Header, {
        title: S,
        actions: (0, Z.jsx)(z, { color: `primary`, size: `toolbar`, onClick: c, children: re }),
      })),
      (t[9] = c),
      (t[10] = re),
      (t[11] = C))
  ...
  t[19] !== w || t[20] !== T || t[21] !== E
    ? ((D = (0, Z.jsxs)(q.Content, { children: [w, T, E] })),
      (t[19] = w),
      (t[20] = T),
      (t[21] = E),
      (t[22] = D))
  ...
  let O;
  t[23] !== D || t[24] !== C
    ? ((O = (0, Z.jsxs)(q, { children: [C, D] })), (t[23] = D), (t[24] = C), (t[25] = O))
    : (O = t[25]);
  let k;
  t[26] !== f ||
  t[27] !== v ||
  ...
  let A;
  return (
    t[39] !== O || t[40] !== k || t[41] !== ne
      ? ((A = (0, Z.jsxs)(Z.Fragment, { children: [ne, O, k] })),
        (t[39] = O),
        (t[40] = k),
        (t[41] = ne),
        (t[42] = A))
...
var pn,
  Z,
  mn = e(() => {
    ((pn = F()), S(), M(), Ke(), Ft(), Lt(), ut(), Ue(), lt(), yt(), Vt(), Gt(), (Z = U()));
  });
function hn(e) {
  let t = (0, wn.c)(14),
    {
  ...
  t[2] === a
    ...
    : ((d = (0, Q.jsx)(q.Header, {
        title: c,
        actions: (0, Q.jsx)(z, { color: `secondary`, size: `toolbar`, onClick: a, children: l }),
      })),
      (t[2] = a),
      (t[3] = d));
  let f;
  ...
  return (
    t[11] !== d || t[12] !== f
      ? ((p = (0, Q.jsxs)(q, { className: `gap-2`, children: [d, f] })),
        (t[11] = d),
        (t[12] = f),
        (t[13] = p))
      : (p = t[13]),
...
function gn(e) {
  ...
  if (
    ...
    ((t[0] = n),
      ...
      (t[10] = p),
      (t[11] = m));
  } else ((l = t[7]), (d = t[8]), (f = t[9]), (p = t[10]), (m = t[11]));
  if (m !== Symbol.for(`react.early_return_sentinel`)) return m;
  let h;
  return (
    t[23] !== l || t[24] !== d || t[25] !== f || t[26] !== p
      ? ((h = (0, Q.jsx)(`div`, { className: l, role: d, "aria-label": f, children: p })),
        (t[23] = l),
        (t[24] = d),
        (t[25] = f),
        (t[26] = p),
...
function vn(e) {
  let t = (0, wn.c)(21),
    { group: n, hostId: r, onCreateEnvironment: i, onSelectEnvironment: o } = e,
    s = te(),
    c;
  t[0] !== n.path || t[1] !== r
    ? ((c = { params: { hostId: r, workspaceRoot: n.path }, select: yn }),
      (t[0] = n.path),
      (t[1] = r),
      (t[2] = c))
    : (c = t[2]);
  let { data: l, isLoading: d, error: f } = pe(`local-environments`, c),
    p = l === void 0 ? [] : l,
    [m, h] = (0, Tn.useState)(!1),
    { projectEnvironments: g, inheritedEnvironments: _ } = Sn(p, n.path),
    v = it(g),
    y = n.isCodexWorktree ? E : L,
    b = n.repositoryData?.ownerRepo?.owner ?? null,
    ee = d,
    x = f != null,
    ne = g.length > 0 || _.length > 0,
    S;
  t[3] === s
    ? (S = t[4])
    : ((S = s.formatMessage({
  ...
  t[11] === y
    ? (j = t[12])
    : ((j = (0, Q.jsx)(y, { className: `icon-sm shrink-0 text-token-text-secondary` })),
      (t[11] = y),
      (t[12] = j));
  let M;
  t[13] === n.label
    ? (M = t[14])
    : ((M = (0, Q.jsx)(`span`, { className: `truncate font-medium`, children: n.label })),
      (t[13] = n.label),
      (t[14] = M));
  let N;
  t[15] === b
  ...
  return (
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((F = (0, Q.jsx)(a, { className: `icon-xs` })), (t[20] = F))
      : (F = t[20]),
    (0, Q.jsxs)(K, {
      className: `p-0`,
      children: [
                ...
                : x
                  ? (0, Q.jsx)(`div`, {
                      ...
                      children: (0, Q.jsx)(`div`, {
                        ...
                        children: (0, Q.jsx)(`span`, { children: A }),
                      }),
                    })
                  : (0, Q.jsxs)(`div`, {
...
function bn(e) {
  ...
  let v;
  t[13] !== r || t[14] !== a
    ? ((v = (0, Q.jsx)(z, { color: `ghost`, size: `toolbar`, onClick: a, children: r })),
      (t[13] = r),
      (t[14] = a),
      (t[15] = v))
    : (v = t[15]);
...
function Dn() {
  ...
  let d = l,
    f;
  e[4] === t ? (f = e[5]) : ((f = t.get(`mode`)), (e[4] = t), (e[5] = f));
  let p = f,
    { selectedHostId: g } = Ve(),
    _ = o?.hostId ?? g,
    { data: v, isLoading: y } = k(Fe, { hostId: _ }),
    b;
  e[6] === v?.roots ? (b = e[7]) : ((b = v?.roots ?? []), (e[6] = v?.roots), (e[7] = b));
  let te = b,
    x = Be(A(we), _),
    [ne, S] = (0, jn.useState)(o?.workspaceRoot ?? c),
    [re, C] = (0, jn.useState)(o?.configPath ?? d),
    [w, E] = (0, jn.useState)(o != null || p === `edit`),
    D = ne ?? null,
    O = D != null && (o != null || te.includes(D)) ? D : null,
    j = O == null ? null : (x.find((e) => e.path === O) ?? null),
    M = O == null,
    N;
  e[8] === _
    ? (N = e[9])
  ...
  let ie = F,
    ae;
  e[14] !== o || e[15] !== i || e[16] !== E
    ? ((ae = () => {
        if (o != null) {
          i(o.returnTo, { replace: !0 });
          return;
        }
        E(!1);
      }),
  ...
  let I = le,
    ...
    de;
  e[26] !== _ || e[27] !== ue
    ? ((de = { hostId: _, workspaceRoot: ue }), (e[26] = _), (e[27] = ue), (e[28] = de))
    : (de = e[28]);
  let L = !M && O != null,
    R;
  e[29] === L ? (R = e[30]) : ((R = { enabled: L }), (e[29] = L), (e[30] = R));
  let fe;
  e[31] !== de || e[32] !== R
    ? ((fe = { params: de, queryConfig: R, select: On }), (e[31] = de), (e[32] = R), (e[33] = fe))
    : (fe = e[33]);
  let { data: z, isLoading: B, error: me } = pe(`local-environments`, fe),
    V;
  e[34] === z ? (V = e[35]) : ((V = z === void 0 ? [] : z), (e[34] = z), (e[35] = V));
  let he = V,
    ge;
  e[36] === he ? (ge = e[37]) : ((ge = it(he)), (e[36] = he), (e[37] = ge));
  let _e = ge,
    ve;
  e[38] !== o || e[39] !== he || e[40] !== me || e[41] !== B || e[42] !== O
    ? ((ve = o != null && o.configPath == null && !B && me == null && O != null ? st(he, O) : null),
      (e[38] = o),
      (e[39] = he),
      (e[40] = me),
      (e[41] = B),
    ...
    : (ve = e[43]);
  let ye = ve,
    be = re ?? o?.configPath ?? ye ?? (o == null ? _e : null),
    xe = be ?? ``,
    Se;
  e[44] !== _ || e[45] !== xe
    ? ((Se = { configPath: xe, hostId: _ }), (e[44] = _), (e[45] = xe), (e[46] = Se))
    : (Se = e[46]);
  let Ce = !M && O != null && be != null,
    Te;
  e[47] === Ce ? (Te = e[48]) : ((Te = { enabled: Ce }), (e[47] = Ce), (e[48] = Te));
  let Ee;
  e[49] !== Se || e[50] !== Te
    ? ((Ee = { params: Se, queryConfig: Te }), (e[49] = Se), (e[50] = Te), (e[51] = Ee))
    : (Ee = e[51]);
  let { data: H, isLoading: Oe, error: ke } = pe(`local-environment-config`, Ee),
    Ae = H?.configPath ?? ``,
    U;
  e[52] !== _ || e[53] !== Ae
    ? ((U = { configPath: Ae, hostId: _ }), (e[52] = _), (e[53] = Ae), (e[54] = U))
    : (U = e[54]);
  let je = !M && O != null && !!H?.exists,
    Me;
  e[55] === je ? (Me = e[56]) : ((Me = { enabled: je }), (e[55] = je), (e[56] = Me));
  let Ne;
  e[57] !== U || e[58] !== Me
    ? ((Ne = { params: U, queryConfig: Me }), (e[57] = U), (e[58] = Me), (e[59] = Ne))
    : (Ne = e[59]);
  let { data: Pe, error: Ie, isLoading: ze } = pe(`local-environment`, Ne),
    W = Pe?.environment.type === `success` ? Pe.environment.environment : null,
    He = Pe?.environment.type === `error` ? Pe.environment.error.message : null,
    Ue = ke?.message ?? Ie?.message ?? me?.message ?? null,
    We;
  e[60] !== ie || e[61] !== oe || e[62] !== w || e[63] !== O || e[64] !== j
    ? ((We =
        O == null
          ? null
          : (0, $.jsx)(jt, {
  ...
  if (a && o == null) {
    ...
    return (
      e[66] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, $.jsx)(r, { to: `/settings/local-environments`, replace: !0 })), (e[66] = t))
        : (t = e[66]),
      t
    );
  }
  if (M) {
    ...
    let n;
    return (
      e[68] !== P || e[69] !== I || e[70] !== ce || e[71] !== _ || e[72] !== x || e[73] !== y
        ? ((n = (0, $.jsx)(kn, {
            subtitle: t,
            children: (0, $.jsx)(hn, {
              groups: x,
  ...
  return (
    e[106] !== G || e[107] !== qe
      ? ((Je = (0, $.jsx)(kn, { backSlot: G, children: qe })),
        (e[106] = G),
        (e[107] = qe),
        (e[108] = Je))
      : (Je = e[108]),
...
function kn(e) {
  ...
  return (
    t[1] !== n || t[2] !== i || t[3] !== r
      ? ((o = (0, $.jsx)(Ge, { title: a, subtitle: r, backSlot: n, children: i })),
        (t[1] = n),
        (t[2] = i),
        (t[3] = r),
        (t[4] = o))
