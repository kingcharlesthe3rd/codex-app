...
import { Mn as t, U as n, jn as r, kn as i } from "./src-2.js";
import {
  Bo as a,
  Qn as o,
  Vn as s,
...
import { i as te, r as ne } from "./open-project-setup-dialog.js";
...
import "./search.js";
import { r as R, t as ie } from "./dropdown.js";
import { t as ae } from "./segmented-toggle.js";
import { i as oe, n as se, r as z, t as ce } from "./popover.js";
import { t as le } from "./trash.js";
import { t as B } from "./chevron.js";
import { t as ue } from "./worktree.js";
import { t as V } from "./code-snippet.js";
import "./copy.js";
import "./copy-button.js";
import { t as H } from "./plus.js";
import { t as de } from "./get-project-name.js";
import { r as fe, t as pe } from "./local-environments.js";
import "./flask.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { i as U } from "./settings-shared.js";
import { n as me, t as he } from "./settings-host-context.js";
import { t as W } from "./settings-content-layout.js";
import { n as G } from "./settings-row.js";
import { n as K, t as q } from "./settings-group.js";
...
function De(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Z.jsx)(`span`, {
      ...
      (u = (0, Z.jsx)(P, { className: `icon-xs text-token-text-secondary` })),
      (t[5] = l),
      (t[6] = u))
    : ((l = t[5]), (u = t[6]));
  let d;
  ...
  t[9] === i
    ...
    : ((f =
        i === `edit`
          ? (0, Z.jsxs)(Z.Fragment, {
              children: [
                (0, Z.jsx)(P, { className: `icon-xs text-token-text-secondary` }),
                (0, Z.jsx)(`span`, {
                  children: (0, Z.jsx)(w, {
...
function je(e) {
  let t = (0, X.c)(59),
    ...
    ee = M(r),
    te;
  t[0] !== ee || t[1] !== l ? ((te = n(l, ee)), (t[0] = ee), (t[1] = l), (t[2] = te)) : (te = t[2]);
  let ne = te,
    P = a(r),
    { data: F } = o(l, P, `local_environment_editor`),
    I;
  t[3] === P ? (I = t[4]) : ((I = u(P)), (t[3] = P), (t[4] = I));
  let re = I,
    oe;
  t[5] !== F || t[6] !== re || t[7] !== D
    ? ((oe = {
      ...
      (t[8] = oe))
    : (oe = t[8]);
  let se = c(`set-config-value`, P, oe),
    [z, ce] = (0, Te.useState)(`default`),
    [B, ue] = (0, Te.useState)(`default`),
    V,
    H;
  if (
    t[9] !== g?.actions ||
  ...
  t[28] !== l
    ? ((pe = {
        onSuccess: () => {
          (D.invalidateQueries({
            queryKey: x(`local-environment-config`, { configPath: f, hostId: r }),
          }),
            D.invalidateQueries({ queryKey: x(`local-environment`, { configPath: f, hostId: r }) }),
            D.invalidateQueries({
              queryKey: x(`local-environments`, { hostId: r, workspaceRoot: l }),
            }),
            T.get(O).success(
              E.formatMessage({
      ...
      (t[29] = pe))
    : (pe = t[29]);
  let U = S(`local-environment-config-save`, pe),
    me;
  t[30] !== f || t[31] !== r || t[32] !== U || t[33] !== H
    ? ((me = (e) => {
        let { value: t } = e,
          n = Pe(t, H);
        t.name.length !== 0 && U.mutate({ configPath: f, hostId: r, raw: n });
      }),
      (t[30] = f),
      (t[31] = r),
      (t[32] = U),
  ...
  let he;
  t[35] !== fe || t[36] !== me
    ? ((he = { defaultValues: fe, onSubmit: me }), (t[35] = fe), (t[36] = me), (t[37] = he))
    : (he = t[37]);
  let W = we(he),
    G;
  t[38] === W
  ...
  t[51] !== l
    ? ((J = (e) => {
        ...
        let r = ve.map((e) => ({
          ...
          i = Re(j?.platform),
          a = ze(E),
          o = Fe({ values: t, isDirty: n, isSaving: U.isPending }),
          s = Ie(o),
          c = o != null,
          u = (e, n, r) => {
            if (n === `default`) {
          ...
          f = () => {
            W.setFieldValue(`actions`, [...t.actions, be(``)]);
          },
          p = (e) => {
            W.setFieldValue(
              `actions`,
            ...
            (0, Z.jsxs)(q, {
              children: [
                ...
                (0, Z.jsxs)(q.Content, {
                  ...
                  children: [
                    (0, Z.jsx)(K, {
                      children: (0, Z.jsx)(Ae, { workspaceRoot: l, workspaceGroup: d }),
                    }),
                    _
                      ? (0, Z.jsx)(`div`, {
                ...
                children: [
                  ...
                  (0, Z.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, Z.jsx)(`textarea`, {
                        id: `local-environment-cleanup-script-${B}`,
                        className: `focus-visible:ring-token-focus w-full rounded-md border border-token-border bg-token-input-background px-2.5 py-2 font-mono text-sm text-token-text-primary outline-none focus-visible:ring-2`,
                        value: Le(t, `cleanup`, B),
                        placeholder: ye,
                        rows: 6,
                        onChange: (e) => {
                          u(`cleanup`, B, e.target.value);
                        },
                      }),
                    ],
                  }),
                                      ...
                                      (0, Z.jsx)(`div`, {
                                        ...
                                        children: (0, Z.jsx)(k, {
                                          ...
                                          children: (0, Z.jsx)(A, {
                                            ...
                                            children: (0, Z.jsx)(le, { className: `icon-sm` }),
                                          }),
                                        }),
                                      }),
                                    ],
    ...
    : (J = t[52]);
  let Y;
  t[53] !== W.Subscribe || t[54] !== J
    ? ((Y = (0, Z.jsx)(W.Subscribe, { selector: Me, children: J })),
      (t[53] = W.Subscribe),
      (t[54] = J),
      (t[55] = Y))
    : (Y = t[55]);
...
function He(e) {
  ...
  let d = u,
    ...
    b = m.length > 0 || h.length > 0 || g.length > 0,
  ...
  t[25] !== E || t[26] !== D || t[27] !== O
    ? ((k = (0, Z.jsxs)(q, {
        children: [
          T,
          (0, Z.jsxs)(q.Content, { className: `gap-[var(--padding-panel)]`, children: [E, D, O] }),
        ],
      })),
      (t[25] = E),
      (t[26] = D),
  ...
  t[31] !== c || t[32] !== j
    ? ((M = (0, Z.jsx)(`div`, {
        className: `flex justify-end`,
        children: (0, Z.jsx)(A, { color: `primary`, size: `toolbar`, onClick: c, children: j }),
      })),
      (t[31] = c),
      (t[32] = j),
      (t[33] = M))
...
function Ke(e) {
  ...
  t[2] === a
    ...
    : ((u = (0, Z.jsx)(q.Header, {
        title: c,
        actions: (0, Z.jsx)(A, { color: `secondary`, size: `toolbar`, onClick: a, children: l }),
      })),
      (t[2] = a),
      (t[3] = u));
  let d;
  ...
  return (
    t[11] !== u || t[12] !== d
      ? ((f = (0, Z.jsxs)(q, { className: `gap-2`, children: [u, d] })),
        (t[11] = u),
        (t[12] = d),
        (t[13] = f))
      : (f = t[13]),
...
function Ye(e) {
  ...
  t[0] !== n.path || t[1] !== r
    ? ((s = { params: { hostId: r, workspaceRoot: n.path }, select: Xe }),
      ...
      (t[2] = s))
    : (s = t[2]);
  let { data: c, isLoading: l, error: u } = b(`local-environments`, s),
    d = c === void 0 ? [] : c,
    [f, m] = (0, Te.useState)(!1),
    { projectEnvironments: h, inheritedEnvironments: g } = $e(d, n.path),
    _ = pe(h),
    v = n.isCodexWorktree ? ue : ee,
  ...
  t[11] === v
    ? (F = t[12])
    : ((F = (0, Z.jsx)(v, { className: `icon-sm shrink-0 text-token-text-secondary` })),
      (t[11] = v),
      (t[12] = F));
  let I;
  t[13] === n.label
    ? (I = t[14])
    : ((I = (0, Z.jsx)(`span`, { className: `truncate font-medium`, children: n.label })),
      (t[13] = n.label),
      (t[14] = I));
  let L;
  t[15] === y
  ...
  return (
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((R = (0, Z.jsx)(H, { className: `icon-xs` })), (t[20] = R))
      : (R = t[20]),
    (0, Z.jsxs)(K, {
      className: `p-0`,
      children: [
                ...
                : S
                  ? (0, Z.jsx)(`div`, {
                      ...
                      children: (0, Z.jsx)(`div`, {
                        ...
                        children: (0, Z.jsx)(`span`, { children: P }),
                      }),
                    })
                  : (0, Z.jsxs)(`div`, {
...
function Ze(e) {
  let t = (0, X.c)(19),
    ...
    o;
  t[0] === n.configPath ? (o = t[1]) : ((o = Qe(n.configPath)), (t[0] = n.configPath), (t[1] = o));
  let s = o,
  ...
  let v;
  t[13] !== r || t[14] !== a
    ? ((v = (0, Z.jsx)(A, { color: `ghost`, size: `toolbar`, onClick: a, children: r })),
      (t[13] = r),
      (t[14] = a),
      (t[15] = v))
    : (v = t[15]);
...
function tt() {
  ...
  let { data: u, isLoading: d } = _(D, l),
    f;
  e[8] === u?.roots ? (f = e[9]) : ((f = u?.roots ?? []), (e[8] = u?.roots), (e[9] = f));
  let p = f,
    m = me(g(F), c),
    [h, v] = (0, Te.useState)(r),
    [y, x] = (0, Te.useState)(a),
    [S, C] = (0, Te.useState)(s === `edit`),
    T = h ?? null,
    O;
  e[10] !== T || e[11] !== p
    ? ((O = T != null && p.includes(T) ? T : null), (e[10] = T), (e[11] = p), (e[12] = O))
    : (O = e[12]);
  let k = O,
  ...
  let z = se,
    ...
    le;
  e[31] !== c || e[32] !== ce
    ? ((le = { hostId: c, workspaceRoot: ce }), (e[31] = c), (e[32] = ce), (e[33] = le))
    : (le = e[33]);
  let B = !j && k != null,
    ue;
  e[34] === B ? (ue = e[35]) : ((ue = { enabled: B }), (e[34] = B), (e[35] = ue));
  let V;
  e[36] !== le || e[37] !== ue
    ? ((V = { params: le, queryConfig: ue, select: nt }), (e[36] = le), (e[37] = ue), (e[38] = V))
    : (V = e[38]);
  let { data: H, isLoading: de, error: fe } = b(`local-environments`, V),
    U;
  e[39] === H ? (U = e[40]) : ((U = H === void 0 ? [] : H), (e[39] = H), (e[40] = U));
  let W = U,
    G;
  e[41] === W ? (G = e[42]) : ((G = pe(W)), (e[41] = W), (e[42] = G));
  let J = y ?? G ?? null,
    ge = J ?? ``,
    _e;
  e[43] !== c || e[44] !== ge
    ? ((_e = { configPath: ge, hostId: c }), (e[43] = c), (e[44] = ge), (e[45] = _e))
    : (_e = e[45]);
  let ve = !j && k != null && J != null,
    ye;
  ...
  e[48] !== _e || e[49] !== ye
    ...
    : (be = e[50]);
  let { data: Y, isLoading: xe, error: Se } = b(`local-environment-config`, be),
    Ce = Y?.configPath ?? ``,
    we;
  e[51] !== c || e[52] !== Ce
    ? ((we = { configPath: Ce, hostId: c }), (e[51] = c), (e[52] = Ce), (e[53] = we))
    : (we = e[53]);
  ...
  e[56] !== we || e[57] !== Q
    ...
    : (Oe = e[58]);
  let { data: ke, error: Ae, isLoading: Me } = b(`local-environment`, Oe),
    ...
    Fe = Se?.message ?? Ae?.message ?? fe?.message ?? null,
    Ie;
  e[59] !== P || e[60] !== ie || e[61] !== S || e[62] !== k || e[63] !== A
    ? ((Ie =
        k == null
          ? null
          : (0, Z.jsx)(De, {
  ...
  if (j) {
    ...
    let n;
    return (
      e[66] !== N || e[67] !== z || e[68] !== oe || e[69] !== c || e[70] !== m || e[71] !== d
        ? ((n = (0, Z.jsx)(rt, {
            subtitle: t,
            children: (0, Z.jsx)(Ke, {
              groups: m,
              ...
              isLoading: d,
              onAddWorkspace: N,
              onCreateEnvironment: z,
              onSelectEnvironment: oe,
            }),
          })),
          (e[66] = N),
          (e[67] = z),
  ...
  if (Le) {
    ...
    return (
      e[75] === $
        ? (r = e[76])
        : ((r = (0, Z.jsx)(rt, { backSlot: $, children: n })), (e[75] = $), (e[76] = r)),
      r
    );
  }
  if (!Y || k == null) {
    ...
    return (
      e[79] === $
        ? (r = e[80])
        : ((r = (0, Z.jsx)(rt, { backSlot: $, children: n })), (e[79] = $), (e[80] = r)),
      r
    );
  }
  if (S) {
...
function rt(e) {
  let t = (0, X.c)(5),
    ...
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(U, { slug: `local-environments` })), (t[0] = a))
    : (a = t[0]);
  let o;
  return (
    t[1] !== n || t[2] !== i || t[3] !== r
      ? ((o = (0, Z.jsx)(W, { title: a, subtitle: r, backSlot: n, children: i })),
        (t[1] = n),
        (t[2] = i),
        (t[3] = r),
        (t[4] = o))
