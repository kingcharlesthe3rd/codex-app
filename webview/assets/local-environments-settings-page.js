...
import { n as c } from "./use-host-config.js";
import { Vn as l, d as u, zn as d } from "./thread-context-inputs.js";
import { A as f, o as p, r as m, s as h } from "./vscode-api.js";
import "./isEqual.js";
import { J as g, en as _, tn as v } from "./src-3.js";
import "./react-dom.js";
import { i as y, l as ee, s as b } from "./lib-1.js";
...
import "./check-md.js";
import { t as w } from "./chevron-right.js";
import { t as te } from "./tooltip-B.js";
import { r as T } from "./toast-signal.js";
import "./x.js";
import { t as E } from "./plus.js";
import { I as D } from "./rpc-1.js";
import "./statsig.js";
import "./request.js";
...
import { _ as k, a as A, f as j, m as M, p as N } from "./chunk-13.js";
...
import { n as P } from "./use-codex-home.js";
import { t as F } from "./use-os-info.js";
...
import { t as L } from "./folder.js";
import "./settings.cog.js";
import "./bug.js";
import "./modal-controller-state.js";
import "./dialog-layout.js";
import { a as ne, r as R } from "./open-project-setup-dialog.js";
import "./local-projects.js";
import "./select-project.js";
import { f as re } from "./sidebar-project-group-signals.js";
import "./sidebar-project-groups.js";
import "./_defineProperty.js";
import { i as z, t as ie } from "./local-environment-create-route.js";
import { t as ae } from "./checkbox.js";
import "./minus.js";
import { f as oe } from "./links.js";
import { r as se, t as ce } from "./dropdown.js";
import { t as le } from "./worktree.js";
import { i as B, n as ue, r as de, t as V } from "./popover.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as fe, r as pe } from "./settings-host-context.js";
import { t as me } from "./get-project-name.js";
import "./git-config-value-query.js";
import { a as H, i as he, r as ge, s as _e } from "./local-environment-selection.js";
import "./copy-button.js";
import { t as ve } from "./trash-DL-ar7Ww.js";
import { t as U } from "./code-snippet-B.js";
import "./copy.js";
...
import { t as ye } from "./segmented-toggle.js";
...
import { t as Ae } from "./useForm.js";
var X = r(),
  je = e(t(), 1);
function Z(e, t) {
  let n = me(e) ?? e;
...
function Me(e) {
  let t = (0, X.c)(17),
    ...
    o;
  t[0] !== r || t[1] !== n ? ((o = Z(n, r)), (t[0] = r), (t[1] = n), (t[2] = o)) : (o = t[2]);
  let s = o,
    c;
  t[3] === a
    ? (c = t[4])
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(`span`, {
      ...
      (u = (0, Q.jsx)(w, { className: `icon-xs text-token-text-secondary` })),
      (t[5] = l),
      (t[6] = u))
    : ((l = t[5]), (u = t[6]));
  let d;
  t[7] === s
    ? (d = t[8])
    : ((d = (0, Q.jsx)(`span`, { className: `text-token-text-primary`, children: s })),
      (t[7] = s),
      (t[8] = d));
  let f;
  t[9] === i
    ...
    : ((f =
        i === `edit`
          ? (0, Q.jsxs)(Q.Fragment, {
              children: [
                (0, Q.jsx)(w, { className: `icon-xs text-token-text-secondary` }),
                (0, Q.jsx)(`span`, {
                  children: (0, Q.jsx)(b, {
  ...
  let p;
  t[11] !== d || t[12] !== f
    ? ((p = (0, Q.jsxs)(`div`, { className: `flex items-center gap-1`, children: [l, u, d, f] })),
      (t[11] = d),
      (t[12] = f),
      (t[13] = p))
    : (p = t[13]);
...
function Ie(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Q.jsx)(`div`, { className: `text-sm text-token-text-secondary`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function Le(e) {
  let t = (0, X.c)(18),
    ...
    i;
  t[0] !== r || t[1] !== n ? ((i = Z(n, r)), (t[0] = r), (t[1] = n), (t[2] = i)) : (i = t[2]);
  let a = i,
    o = r?.repositoryData?.rootFolder,
    s = o && o !== a ? `(${o})` : null,
    c = r?.isCodexWorktree ? le : L,
    l;
  t[3] === c
    ? (l = t[4])
  ...
  t[5] === a
    ? (u = t[6])
    : ((u = (0, Q.jsx)(`span`, { className: `truncate`, children: a })), (t[5] = a), (t[6] = u));
  let d;
  t[7] === s
    ? (d = t[8])
    : ((d = s
  ...
  t[12] === n
    ? (p = t[13])
    : ((p = (0, Q.jsx)(`span`, { className: `truncate`, children: n })), (t[12] = n), (t[13] = p));
  let m;
  return (
    t[14] !== l || t[15] !== f || t[16] !== p
      ? ((m = (0, Q.jsx)(K, { icon: l, label: f, description: p, control: null })),
        (t[14] = l),
        (t[15] = f),
        (t[16] = p),
        (t[17] = m))
...
function Re(e) {
  let t = (0, X.c)(67),
    ...
    w = f(),
    { data: E } = F(),
    { data: D, error: O, refetch: k } = P(n),
    A = D?.codexHome,
    j;
  t[0] !== A || t[1] !== i?.isCodexWorktree || t[2] !== r
    ? ((j = i?.isCodexWorktree === !0 || (A != null && g(r, A))),
      (t[0] = A),
  ...
  let M = j,
    N = c(n),
    { data: I } = l(r, N, `local_environment_editor`),
    L;
  t[4] !== n || t[5] !== r
    ? ((L = { hostId: n, workspaceRoot: r }), (t[4] = n), (t[5] = r), (t[6] = L))
    : (L = t[6]);
  let { updateSelection: ne } = he(L),
    R;
  t[7] !== I || t[8] !== N || t[9] !== x
    ? ((R = {
        onSuccess: (e, t) => {
          !e.success || !I || ge(x, I, N, t.value, `local_environment_editor`);
        },
      }),
      (t[7] = I),
      (t[8] = N),
      ...
      (t[10] = R))
    : (R = t[10]);
  let re = d(`set-config-value`, N, R),
    [z, ie] = (0, je.useState)(`default`),
    [oe, le] = (0, je.useState)(`default`),
    [B, ue] = (0, je.useState)(!u),
    de,
    V;
  if (
    t[11] !== p?.actions ||
  ...
  t[30] !== r
    ? ((pe = {
        onSuccess: async (e) => {
          let { configPath: t } = e;
          (w.invalidateQueries({
            queryKey: m(`local-environment-config`, { configPath: t, hostId: n }),
          }),
            w.invalidateQueries({
              queryKey: m(`local-environment`, { configPath: t, hostId: n }),
            }));
          let i = () =>
            w.invalidateQueries({
              queryKey: m(`local-environments`, { hostId: n, workspaceRoot: r }),
            });
          if (B) {
            if (
              !(await Ce({
      ...
      (t[31] = pe))
    : (pe = t[31]);
  let H = h(`local-environment-config-save`, pe),
    _e;
  t[32] !== o || t[33] !== n || t[34] !== H || t[35] !== V
    ? ((_e = (e) => {
        let { value: t } = e,
          r = He(t, V);
        t.name.length !== 0 && H.mutate({ configPath: o, hostId: n, raw: r });
      }),
      (t[32] = o),
      (t[33] = n),
      (t[34] = H),
  ...
  let U;
  t[37] !== fe || t[38] !== _e
    ? ((U = { defaultValues: fe, onSubmit: _e }), (t[37] = fe), (t[38] = _e), (t[39] = U))
    : (U = t[39]);
  let W = Ae(U),
    G;
  t[40] === W
  ...
  t[59] !== r
    ? ((K = (e) => {
        ...
        let a = ke.map((e) => ({
          ...
          c = Ue({
            values: t,
            isDirty: n,
            isSelectionReady: !B || ((i != null || A != null) && (!M || I?.root != null)),
            selectionError: i == null && O != null,
          ...
          d = (e, n, r) => {
            if (n === `default`) {
              W.setFieldValue(e === `setup` ? `setupScript` : `cleanupScript`, r);
              return;
            }
            let { scriptField: i, scripts: a } = Ge(t, e);
            W.setFieldValue(i, { ...a, [n]: r });
          },
          f = () => {
            W.setFieldValue(`actions`, [...t.actions, Te(``)]);
          },
          p = (e) => {
            W.setFieldValue(
              `actions`,
            ...
            (0, Q.jsxs)(J, {
              children: [
                ...
                (0, Q.jsxs)(J.Content, {
                  ...
                  children: [
                    (0, Q.jsx)(q, {
                      children: (0, Q.jsx)(Le, { workspaceRoot: r, workspaceGroup: i }),
                    }),
                    _
                      ? (0, Q.jsx)(`div`, {
                    ...
                    (0, Q.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, Q.jsx)(`input`, {
                          ...
                          value: t.name,
                          onChange: (e) => {
                            W.setFieldValue(`name`, e.target.value);
                          },
                        }),
                      ],
                    }),
                      ...
                      children: [
                        ...
                        (0, Q.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, Q.jsx)(`textarea`, {
                              id: `local-environment-setup-script-${z}`,
                ...
                children: [
                  ...
                  (0, Q.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, Q.jsx)(`textarea`, {
                        id: `local-environment-cleanup-script-${oe}`,
                        className: `focus-visible:ring-token-focus w-full rounded-md border border-token-border bg-token-input-background px-2.5 py-2 font-mono text-sm text-token-text-primary outline-none focus-visible:ring-2`,
                        value: Ke(t, `cleanup`, oe),
                        placeholder: we,
                        rows: 6,
                        onChange: (e) => {
                          d(`cleanup`, oe, e.target.value);
                        },
                      }),
                    ],
                  }),
              ...
              children: [
                ...
                (0, Q.jsxs)(J.Content, {
                  ...
                  children: [
                    (0, Q.jsx)(`div`, {
                      className: `text-sm text-token-text-secondary`,
                      children: (0, Q.jsx)(b, { ...Ne.actionsDescription }),
                    }),
                    t.actions.length === 0
                      ? (0, Q.jsx)(q, {
                          children: (0, Q.jsx)(`div`, {
                            className: `p-3 text-sm text-token-text-secondary`,
                            children: (0, Q.jsx)(b, { ...Ne.actionsEmpty }),
                          }),
                        })
                      : (0, Q.jsx)(`div`, {
                          className: `flex flex-col gap-3`,
    ...
    : (K = t[60]);
  let Y;
  t[61] !== W.Subscribe || t[62] !== K
    ? ((Y = (0, Q.jsx)(W.Subscribe, { selector: ze, children: K })),
      (t[61] = W.Subscribe),
      (t[62] = K),
      (t[63] = Y))
    : (Y = t[63]);
...
function He(e, t) {
  return Y({
    ...
    setupPlatformScripts: Ye(e.setupPlatformScripts),
    cleanupScript: e.cleanupScript,
    cleanupPlatformScripts: Ye(e.cleanupPlatformScripts),
    actions: e.actions,
  });
}
function Ue({ values: e, isDirty: t, isSelectionReady: n, selectionError: r, isSaving: i }) {
  return i
    ? `saving`
    : n
      ? e.name.length === 0
...
function $(e) {
  return [
    { id: `darwin`, label: e.formatMessage(Pe.darwin) },
    { id: `linux`, label: e.formatMessage(Pe.linux) },
    { id: `win32`, label: e.formatMessage(Pe.win32) },
  ];
}
function Je(e) {
  return [
...
function Xe(e) {
  ...
  let d = u,
    ...
    x = _.length > 0 || v.length > 0 || y.length > 0,
    C;
  ...
  t[3] !== r || t[4] !== n
    ? ((w = (0, Q.jsxs)(J, {
        children: [
          ...
          (0, Q.jsx)(J.Content, {
            children: (0, Q.jsx)(q, {
              children: (0, Q.jsx)(Le, { workspaceRoot: n, workspaceGroup: r }),
            }),
          }),
        ],
      })),
  ...
  t[9] !== c || t[10] !== T
    ? ((E = (0, Q.jsx)(J.Header, {
        title: te,
        actions: (0, Q.jsx)(S, { color: `primary`, size: `toolbar`, onClick: c, children: T }),
      })),
      (t[9] = c),
      (t[10] = T),
      (t[11] = E))
  ...
  t[19] !== D || t[20] !== O || t[21] !== k
    ? ((A = (0, Q.jsxs)(J.Content, { children: [D, O, k] })),
      (t[19] = D),
      (t[20] = O),
      (t[21] = k),
      (t[22] = A))
  ...
  let j;
  t[23] !== A || t[24] !== E
    ? ((j = (0, Q.jsxs)(J, { children: [E, A] })), (t[23] = A), (t[24] = E), (t[25] = j))
    : (j = t[25]);
  let M;
  t[26] !== d ||
  t[27] !== _ ||
              ...
              (0, Q.jsxs)(J, {
                children: [
                  (0, Q.jsx)(J.Header, {
                    ...
                    subtitle: (0, Q.jsx)(b, { ...Ne.actionsDescription }),
                  }),
                  (0, Q.jsx)(J.Content, {
                    children: (0, Q.jsx)(q, {
                      children:
                        d.length > 0
                          ? d.map(Ze)
                          : (0, Q.jsx)(K, {
                              label: (0, Q.jsx)(b, { ...Ne.actionsEmpty }),
                              control: null,
                            }),
                    }),
                  }),
  ...
  let N;
  return (
    t[39] !== j || t[40] !== M || t[41] !== w
      ? ((N = (0, Q.jsxs)(Q.Fragment, { children: [w, j, M] })),
        (t[39] = j),
        (t[40] = M),
        (t[41] = w),
        (t[42] = N))
...
function Ze(e, t) {
  return (0, Q.jsx)(
    K,
    {
      icon: (0, Q.jsx)(`span`, {
        className: `text-token-text-secondary`,
        children: (0, Q.jsx)(xe, { icon: e.icon ?? `tool` }),
      }),
      label: e.name,
      control: null,
    },
...
function Qe(e) {
  ...
  t[2] === o
    ? (c = t[3])
    : ((c = (0, Q.jsx)(`div`, { className: `text-sm text-token-text-secondary`, children: o })),
      (t[2] = o),
      (t[3] = c));
  let l;
  t[4] !== s || t[5] !== c
    ? ((l = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [s, c] })),
      (t[4] = s),
      (t[5] = c),
      (t[6] = l))
    : (l = t[6]);
  ...
  t[7] === n
    ? (u = t[8])
    : ((u = n.length > 0 ? (0, Q.jsx)($e, { platform: `darwin`, script: n }) : null),
      (t[7] = n),
      (t[8] = u));
  let d;
  t[9] === r
    ? (d = t[10])
    : ((d = r.length > 0 ? (0, Q.jsx)($e, { platform: `linux`, script: r }) : null),
      (t[9] = r),
      (t[10] = d));
  let f;
  t[11] === i
    ? (f = t[12])
    : ((f = i.length > 0 ? (0, Q.jsx)($e, { platform: `win32`, script: i }) : null),
      (t[11] = i),
      (t[12] = f));
  let p;
  return (
    t[13] !== l || t[14] !== u || t[15] !== d || t[16] !== f
      ? ((p = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [l, u, d, f] })),
        (t[13] = l),
        (t[14] = u),
        (t[15] = d),
        (t[16] = f),
...
function et(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(b, { ...Ne.selectProject })), (t[0] = c))
    : (c = t[0]);
  let l;
  ...
  t[2] === a
    ...
    : ((u = (0, Q.jsx)(J.Header, {
        title: c,
        actions: (0, Q.jsx)(S, { color: `secondary`, size: `toolbar`, onClick: a, children: l }),
      })),
      (t[2] = a),
      (t[3] = u));
  let d;
  ...
  return (
    t[11] !== u || t[12] !== d
      ? ((f = (0, Q.jsxs)(J, { className: `gap-2`, children: [u, d] })),
        (t[11] = u),
        (t[12] = d),
        (t[13] = f))
      : (f = t[13]),
...
function tt(e) {
  ...
  return (
    t[23] !== l || t[24] !== u || t[25] !== d || t[26] !== f
      ? ((m = (0, Q.jsx)(`div`, { className: l, role: u, "aria-label": d, children: f })),
        (t[23] = l),
        (t[24] = u),
        (t[25] = d),
        (t[26] = f),
...
function rt(e) {
  let t = (0, X.c)(21),
    ...
    s;
  t[0] !== n.path || t[1] !== r
    ? ((s = { params: { hostId: r, workspaceRoot: n.path }, select: it }),
      (t[0] = n.path),
      (t[1] = r),
      (t[2] = s))
    : (s = t[2]);
  let { data: c, isLoading: l, error: u } = p(`local-environments`, s),
    d = c === void 0 ? [] : c,
    [f, m] = (0, je.useState)(!1),
    { projectEnvironments: h, inheritedEnvironments: g } = st(d, n.path),
    _ = H(h),
    v = n.isCodexWorktree ? le : L,
    y = n.repositoryData?.ownerRepo?.owner ?? null,
    w = l,
    te = u != null,
    T = h.length > 0 || g.length > 0,
    D;
  t[3] === o
    ? (D = t[4])
    : ((D = o.formatMessage({
  ...
  t[11] === v
    ? (ne = t[12])
    : ((ne = (0, Q.jsx)(v, { className: `icon-sm shrink-0 text-token-text-secondary` })),
      (t[11] = v),
      (t[12] = ne));
  let R;
  t[13] === n.label
    ? (R = t[14])
    : ((R = (0, Q.jsx)(`span`, { className: `truncate font-medium`, children: n.label })),
      (t[13] = n.label),
      (t[14] = R));
  let re;
  t[15] === y
    ? (re = t[16])
    : ((re = y
        ? (0, Q.jsx)(`span`, { className: `truncate text-token-text-secondary`, children: y })
        : null),
      (t[15] = y),
      (t[16] = re));
  let z;
  ...
  return (
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((ie = (0, Q.jsx)(E, { className: `icon-xs` })), (t[20] = ie))
      : (ie = t[20]),
    (0, Q.jsxs)(q, {
      className: `p-0`,
      children: [
                ...
                : te
                  ? (0, Q.jsx)(`div`, {
                      ...
                      children: (0, Q.jsx)(`div`, {
                        ...
                        children: (0, Q.jsx)(`span`, { children: I }),
                      }),
                    })
                  : (0, Q.jsxs)(`div`, {
...
function at(e) {
  let t = (0, X.c)(19),
    ...
    o;
  t[0] === n.configPath ? (o = t[1]) : ((o = ot(n.configPath)), (t[0] = n.configPath), (t[1] = o));
  let s = o,
    ...
    m;
  t[2] !== f || t[3] !== p
    ? ((m = (0, Q.jsx)(`span`, { className: f, children: p })), (t[2] = f), (t[3] = p), (t[4] = m))
    : (m = t[4]);
  let h;
  t[5] === d
    ? (h = t[6])
  ...
  let v;
  t[13] !== r || t[14] !== a
    ? ((v = (0, Q.jsx)(S, { color: `ghost`, size: `toolbar`, onClick: a, children: r })),
      (t[13] = r),
      (t[14] = a),
      (t[15] = v))
    : (v = t[15]);
...
function st(e, t) {
  let n = D(t),
    r = [],
    i = [];
  for (let t of e) ct(t.configPath) === n ? r.push(t) : i.push(t);
...
function lt() {
  let e = (0, X.c)(109),
    ...
    r = M(),
    a = N(ie) != null,
    s = a ? z(t, n.state) : null,
    c;
  e[0] === t ? (c = e[1]) : ((c = t.get(`workspaceRoot`)), (e[0] = t), (e[1] = c));
  let l = c,
    d;
  e[2] === t ? (d = e[3]) : ((d = t.get(`configPath`)), (e[2] = t), (e[3] = d));
  let f = d,
    m;
  e[4] === t ? (m = e[5]) : ((m = t.get(`mode`)), (e[4] = t), (e[5] = m));
  let h = m,
    { selectedHostId: g } = fe(),
    _ = s?.hostId ?? g,
    { data: v, isLoading: y } = i(u, { hostId: _ }),
    ee;
  e[6] === v?.roots ? (ee = e[7]) : ((ee = v?.roots ?? []), (e[6] = v?.roots), (e[7] = ee));
  let x = ee,
    S = pe(o(re), _),
    [C, w] = (0, je.useState)(s?.workspaceRoot ?? l),
    [te, T] = (0, je.useState)(s?.configPath ?? f),
    [E, D] = (0, je.useState)(s != null || h === `edit`),
    O = C ?? null,
    P = O != null && (s != null || x.includes(O)) ? O : null,
  ...
  let ce = se,
    le;
  e[14] !== s || e[15] !== r || e[16] !== D
    ? ((le = () => {
        if (s != null) {
          r(s.returnTo, { replace: !0 });
          return;
        }
        D(!1);
      }),
  ...
  let me = V,
    ...
    ge;
  e[26] !== _ || e[27] !== he
    ? ((ge = { hostId: _, workspaceRoot: he }), (e[26] = _), (e[27] = he), (e[28] = ge))
    : (ge = e[28]);
  let ve = !I && P != null,
    U;
  e[29] === ve ? (U = e[30]) : ((U = { enabled: ve }), (e[29] = ve), (e[30] = U));
  let W;
  e[31] !== ge || e[32] !== U
    ? ((W = { params: ge, queryConfig: U, select: ut }), (e[31] = ge), (e[32] = U), (e[33] = W))
    : (W = e[33]);
  let { data: G, isLoading: K, error: ye } = p(`local-environments`, W),
    Y;
  e[34] === G ? (Y = e[35]) : ((Y = G === void 0 ? [] : G), (e[34] = G), (e[35] = Y));
  let be = Y,
    xe;
  e[36] === be ? (xe = e[37]) : ((xe = H(be)), (e[36] = be), (e[37] = xe));
  let Se = xe,
    Ce;
  e[38] !== s || e[39] !== be || e[40] !== ye || e[41] !== K || e[42] !== P
    ? ((Ce = s != null && s.configPath == null && !K && ye == null && P != null ? _e(be, P) : null),
      (e[38] = s),
      (e[39] = be),
      (e[40] = ye),
      (e[41] = K),
    ...
    : (Ce = e[43]);
  let we = Ce,
    Te = te ?? s?.configPath ?? we ?? (s == null ? Se : null),
    Ee = Te ?? ``,
    De;
  e[44] !== _ || e[45] !== Ee
    ? ((De = { configPath: Ee, hostId: _ }), (e[44] = _), (e[45] = Ee), (e[46] = De))
    : (De = e[46]);
  let Oe = !I && P != null && Te != null,
    ke;
  e[47] === Oe ? (ke = e[48]) : ((ke = { enabled: Oe }), (e[47] = Oe), (e[48] = ke));
  let Ae;
  e[49] !== De || e[50] !== ke
    ? ((Ae = { params: De, queryConfig: ke }), (e[49] = De), (e[50] = ke), (e[51] = Ae))
    : (Ae = e[51]);
  let { data: Z, isLoading: Ne, error: Pe } = p(`local-environment-config`, Ae),
    Fe = Z?.configPath ?? ``,
    Ie;
  e[52] !== _ || e[53] !== Fe
    ? ((Ie = { configPath: Fe, hostId: _ }), (e[52] = _), (e[53] = Fe), (e[54] = Ie))
    : (Ie = e[54]);
  let Le = !I && P != null && !!Z?.exists,
    ze;
  e[55] === Le ? (ze = e[56]) : ((ze = { enabled: Le }), (e[55] = Le), (e[56] = ze));
  let Be;
  e[57] !== Ie || e[58] !== ze
    ? ((Be = { params: Ie, queryConfig: ze }), (e[57] = Ie), (e[58] = ze), (e[59] = Be))
    : (Be = e[59]);
  let { data: Ve, error: He, isLoading: Ue } = p(`local-environment`, Be),
    We = Ve?.environment.type === `success` ? Ve.environment.environment : null,
    Ge = Ve?.environment.type === `error` ? Ve.environment.error.message : null,
    Ke = Pe?.message ?? He?.message ?? ye?.message ?? null,
    qe;
  e[60] !== ce || e[61] !== B || e[62] !== E || e[63] !== P || e[64] !== F
    ? ((qe =
        P == null
          ? null
          : (0, Q.jsx)(Me, {
  ...
  if (a && s == null) {
    ...
    return (
      e[66] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, Q.jsx)(A, { to: `/settings/local-environments`, replace: !0 })), (e[66] = t))
        : (t = e[66]),
      t
    );
  }
  if (I) {
    ...
    let n;
    return (
      e[68] !== ae || e[69] !== me || e[70] !== de || e[71] !== _ || e[72] !== S || e[73] !== y
        ? ((n = (0, Q.jsx)(dt, {
            subtitle: t,
            children: (0, Q.jsx)(et, {
              groups: S,
  ...
  if (Je) {
    ...
    return (
      e[77] === $
        ? (r = e[78])
        : ((r = (0, Q.jsx)(dt, { backSlot: $, children: n })), (e[77] = $), (e[78] = r)),
      r
    );
  }
  if (!Z || P == null) {
    ...
    return (
      e[81] === $
        ? (r = e[82])
        : ((r = (0, Q.jsx)(dt, { backSlot: $, children: n })), (e[81] = $), (e[82] = r)),
      r
    );
  }
  if (E) {
    ...
    e[91] !== F
      ? ((t = (0, Q.jsx)(Re, {
          ...
          initialEnvironment: We,
          parseErrorMessage: Ge,
          readErrorMessage: Ke,
          onSaved: B,
        })),
        (e[83] = Z.configPath),
    ...
    return (
      e[93] !== $ || e[94] !== t
        ? ((n = (0, Q.jsx)(dt, { backSlot: $, children: t })),
          (e[93] = $),
          (e[94] = t),
          (e[95] = n))
        : (n = e[95]),
  ...
  return (
    e[106] !== $ || e[107] !== Ze
      ? ((Qe = (0, Q.jsx)(dt, { backSlot: $, children: Ze })),
        (e[106] = $),
        (e[107] = Ze),
        (e[108] = Qe))
      : (Qe = e[108]),
...
function dt(e) {
  let t = (0, X.c)(5),
    ...
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Q.jsx)(W, { slug: `local-environments` })), (t[0] = a))
    : (a = t[0]);
  let o;
  return (
    t[1] !== n || t[2] !== i || t[3] !== r
      ? ((o = (0, Q.jsx)(G, { title: a, subtitle: r, backSlot: n, children: i })),
        (t[1] = n),
        (t[2] = i),
        (t[3] = r),
        (t[4] = o))
...
export { lt as LocalEnvironmentsSettings };
