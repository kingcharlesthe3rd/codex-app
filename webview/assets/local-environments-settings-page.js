...
import { k as c, o as l, r as u, s as d } from "./vscode-api.js";
import "./isEqual.js";
import { G as f, ln as p, sn as m, un as h } from "./src-4.js";
import {
  Fo as g,
  ir as _,
  ls as v,
...
import { u as k } from "./thread-context-inputs.js";
import "./selectable-remote-connections-signal-DJZ-ZbLr.js";
import "./sidebar-signals.js";
import "./use-global-state.js";
import { t as A } from "./use-codex-home.js";
import { t as j } from "./use-os-info.js";
import { r as M } from "./toast-signal.js";
import "./remote-projects.js";
import { _ as te } from "./chunk-8.js";
import "./_baseEach.js";
...
import { a as re, h as N, r as P } from "./open-project-setup-dialog.js";
import "./local-projects.js";
import "./select-project.js";
import "./sidebar-project-groups.js";
import "./_defineProperty.js";
import { t as F } from "./arrow-left.js";
import { t as I } from "./checkbox.js";
import "./minus.js";
import { d as ie } from "./links.js";
import "./search.js";
import { r as L, t as ae } from "./dropdown.js";
import { i as R, n as oe, r as z, t as se } from "./popover.js";
import { t as ce } from "./trash.js";
import { t as B } from "./chevron.js";
import { t as le } from "./worktree.js";
import "./flask.js";
import { t as V } from "./code-snippet-Bu-o-Ykd.js";
import "./copy-D.js";
import "./copy-button.js";
import { t as H } from "./plus.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as ue, t as de } from "./settings-host-context.js";
import { t as fe } from "./get-project-name.js";
import { r as U, t as pe } from "./local-environments-e.js";
import { i as me } from "./settings-shared.js";
...
import { t as he } from "./segmented-toggle.js";
import {
  a as J,
  c as ge,
  i as _e,
...
function De(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Z.jsx)(`span`, {
      ...
      (u = (0, Z.jsx)(D, { className: `icon-xs text-token-text-secondary` })),
      (t[5] = l),
      (t[6] = u))
    : ((l = t[5]), (u = t[6]));
  let d;
  ...
  t[9] === i
    ...
    : ((f =
        i === `edit`
          ? (0, Z.jsxs)(Z.Fragment, {
              children: [
                (0, Z.jsx)(D, { className: `icon-xs text-token-text-secondary` }),
                (0, Z.jsx)(`span`, {
                  children: (0, Z.jsx)(S, {
...
function je(e) {
  let t = (0, X.c)(59),
    ...
    te = A(n),
    ne;
  t[0] !== te || t[1] !== r ? ((ne = f(r, te)), (t[0] = te), (t[1] = r), (t[2] = ne)) : (ne = t[2]);
  let re = ne,
    N = v(n),
    { data: P } = _(r, N, `local_environment_editor`),
    F;
  t[3] === N ? (F = t[4]) : ((F = ee(N)), (t[3] = N), (t[4] = F));
  let ie = F,
    R;
  t[5] !== P || t[6] !== ie || t[7] !== D
    ? ((R = {
      ...
      (t[8] = R))
    : (R = t[8]);
  let oe = y(`set-config-value`, N, R),
    [z, se] = (0, Te.useState)(`default`),
    [B, le] = (0, Te.useState)(`default`),
    V,
    H;
  if (
    t[9] !== p?.actions ||
  ...
  t[28] !== r
    ? ((de = {
        onSuccess: () => {
          (D.invalidateQueries({
            queryKey: u(`local-environment-config`, { configPath: o, hostId: n }),
          }),
            D.invalidateQueries({ queryKey: u(`local-environment`, { configPath: o, hostId: n }) }),
            D.invalidateQueries({
              queryKey: u(`local-environments`, { hostId: n, workspaceRoot: r }),
            }),
            w
              .get(M)
              .success(
      ...
      (t[29] = de))
    : (de = t[29]);
  let U = d(`local-environment-config-save`, de),
    pe;
  t[30] !== o || t[31] !== n || t[32] !== U || t[33] !== H
    ? ((pe = (e) => {
        let { value: t } = e,
          r = Pe(t, H);
        t.name.length !== 0 && U.mutate({ configPath: o, hostId: n, raw: r });
      }),
      (t[30] = o),
      (t[31] = n),
      (t[32] = U),
  ...
  let me;
  t[35] !== ue || t[36] !== pe
    ? ((me = { defaultValues: ue, onSubmit: pe }), (t[35] = ue), (t[36] = pe), (t[37] = me))
    : (me = t[37]);
  let W = we(me),
    G;
  t[38] === W
  ...
  t[51] !== r
    ? ((J = (e) => {
        ...
        let a = ve.map((e) => ({
          ...
          o = Re(k?.platform),
          s = ze(E),
          c = Fe({ values: t, isDirty: n, isSaving: U.isPending }),
          l = Ie(c),
          u = c != null,
          d = (e, n, r) => {
            if (n === `default`) {
            ...
            (0, Z.jsxs)(q, {
              children: [
                ...
                (0, Z.jsxs)(q.Content, {
                  ...
                  children: [
                    (0, Z.jsx)(K, {
                      children: (0, Z.jsx)(Ae, { workspaceRoot: r, workspaceGroup: i }),
                    }),
                    h
                      ? (0, Z.jsx)(`div`, {
...
function He(e) {
  ...
  t[31] !== c || t[32] !== A
    ? ((j = (0, Z.jsx)(`div`, {
        className: `flex justify-end`,
        children: (0, Z.jsx)(T, { color: `primary`, size: `toolbar`, onClick: c, children: A }),
      })),
      (t[31] = c),
      (t[32] = A),
      (t[33] = j))
...
function qe(e) {
  ...
  t[2] === a
    ...
    : ((u = (0, Z.jsx)(q.Header, {
        title: c,
        actions: (0, Z.jsx)(T, { color: `secondary`, size: `toolbar`, onClick: a, children: l }),
      })),
      (t[2] = a),
      (t[3] = u));
  let d;
...
function Xe(e) {
  ...
  t[0] !== n.path || t[1] !== r
    ? ((s = { params: { hostId: r, workspaceRoot: n.path }, select: Ze }),
      ...
      (t[2] = s))
    : (s = t[2]);
  let { data: c, isLoading: u, error: d } = l(`local-environments`, s),
    f = c === void 0 ? [] : c,
    [p, m] = (0, Te.useState)(!1),
    { projectEnvironments: h, inheritedEnvironments: g } = et(f, n.path),
    _ = pe(h),
    v = n.isCodexWorktree ? le : ne,
    y = n.repositoryData?.ownerRepo?.owner ?? null,
    ee = u,
    b = d != null,
    C = h.length > 0 || g.length > 0,
    D;
  t[3] === o
    ? (D = t[4])
    : ((D = o.formatMessage({
  ...
  t[11] === v
    ? (P = t[12])
    : ((P = (0, Z.jsx)(v, { className: `icon-sm shrink-0 text-token-text-secondary` })),
      (t[11] = v),
      (t[12] = P));
  let F;
  t[13] === n.label
    ? (F = t[14])
    : ((F = (0, Z.jsx)(`span`, { className: `truncate font-medium`, children: n.label })),
      (t[13] = n.label),
      (t[14] = F));
  let I;
  t[15] === y
  ...
  return (
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((L = (0, Z.jsx)(H, { className: `icon-xs` })), (t[20] = L))
      : (L = t[20]),
    (0, Z.jsxs)(K, {
      className: `p-0`,
      children: [
                ...
                : b
                  ? (0, Z.jsx)(`div`, {
                      ...
                      children: (0, Z.jsx)(`div`, {
                        ...
                        children: (0, Z.jsx)(`span`, { children: N }),
                      }),
                    })
                  : (0, Z.jsxs)(`div`, {
...
function Qe(e) {
  ...
  let v;
  t[13] !== r || t[14] !== a
    ? ((v = (0, Z.jsx)(T, { color: `ghost`, size: `toolbar`, onClick: a, children: r })),
      (t[13] = r),
      (t[14] = a),
      (t[15] = v))
    : (v = t[15]);
...
function nt() {
  ...
  let r = n,
    a;
  e[2] === t ? (a = e[3]) : ((a = t.get(`configPath`)), (e[2] = t), (e[3] = a));
  let s = a,
    c;
  ...
  let u = c,
    { selectedHostId: d } = de(),
    f;
  e[6] === d ? (f = e[7]) : ((f = { hostId: d }), (e[6] = d), (e[7] = f));
  let { data: p, isLoading: m } = i(k, f),
    h;
  e[8] === p?.roots ? (h = e[9]) : ((h = p?.roots ?? []), (e[8] = p?.roots), (e[9] = h));
  let g = h,
    _ = ue(o(N), d),
    [v, y] = (0, Te.useState)(r),
    [ee, b] = (0, Te.useState)(s),
    [x, C] = (0, Te.useState)(u === `edit`),
    w = v ?? null,
    T;
  e[10] !== w || e[11] !== g
  ...
  let se = z,
    ...
    B;
  e[31] !== d || e[32] !== ce
    ? ((B = { hostId: d, workspaceRoot: ce }), (e[31] = d), (e[32] = ce), (e[33] = B))
    : (B = e[33]);
  let le = !O && E != null,
    V;
  e[34] === le ? (V = e[35]) : ((V = { enabled: le }), (e[34] = le), (e[35] = V));
  let H;
  e[36] !== B || e[37] !== V
    ? ((H = { params: B, queryConfig: V, select: rt }), (e[36] = B), (e[37] = V), (e[38] = H))
    : (H = e[38]);
  let { data: fe, isLoading: U, error: me } = l(`local-environments`, H),
    W;
  e[39] === fe ? (W = e[40]) : ((W = fe === void 0 ? [] : fe), (e[39] = fe), (e[40] = W));
  let G = W,
    he;
  e[41] === G ? (he = e[42]) : ((he = pe(G)), (e[41] = G), (e[42] = he));
  let J = ee ?? he ?? null,
    ge = J ?? ``,
    _e;
  e[43] !== d || e[44] !== ge
    ? ((_e = { configPath: ge, hostId: d }), (e[43] = d), (e[44] = ge), (e[45] = _e))
    : (_e = e[45]);
  let ve = !O && E != null && J != null,
    ye;
  ...
  e[48] !== _e || e[49] !== ye
    ...
    : (be = e[50]);
  let { data: Y, isLoading: xe, error: Se } = l(`local-environment-config`, be),
    Ce = Y?.configPath ?? ``,
    we;
  e[51] !== d || e[52] !== Ce
    ? ((we = { configPath: Ce, hostId: d }), (e[51] = d), (e[52] = Ce), (e[53] = we))
    : (we = e[53]);
  ...
  e[56] !== we || e[57] !== Q
    ...
    : (Oe = e[58]);
  let { data: ke, error: Ae, isLoading: Me } = l(`local-environment`, Oe),
    ...
    Fe = Se?.message ?? Ae?.message ?? me?.message ?? null,
    Ie;
  e[59] !== ne || e[60] !== ae || e[61] !== x || e[62] !== E || e[63] !== D
    ? ((Ie =
        E == null
          ? null
          : (0, Z.jsx)(De, {
  ...
  if (O) {
    ...
    let n;
    return (
      e[66] !== j || e[67] !== se || e[68] !== oe || e[69] !== d || e[70] !== _ || e[71] !== m
        ? ((n = (0, Z.jsx)(it, {
            subtitle: t,
            children: (0, Z.jsx)(qe, {
              groups: _,
...
function it(e) {
  let t = (0, X.c)(5),
    ...
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(me, { slug: `local-environments` })), (t[0] = a))
    : (a = t[0]);
  let o;
  return (
    t[1] !== n || t[2] !== i || t[3] !== r
