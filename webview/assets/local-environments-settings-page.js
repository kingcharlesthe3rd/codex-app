...
function jt(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, J.jsx)(`span`, {
      ...
      (u = (0, J.jsx)(Ee, { className: `icon-xs text-token-text-secondary` })),
      (t[5] = l),
      (t[6] = u))
    : ((l = t[5]), (u = t[6]));
  let d;
  ...
  t[9] === i
    ...
    : ((f =
        i === `edit`
          ? (0, J.jsxs)(J.Fragment, {
              children: [
                (0, J.jsx)(Ee, { className: `icon-xs text-token-text-secondary` }),
                (0, J.jsx)(`span`, {
                  children: (0, J.jsx)(W, {
...
function Ht(e) {
  ...
  return (
    t[14] !== l || t[15] !== f || t[16] !== p
      ? ((m = (0, Wt.jsx)(nt, { icon: l, label: f, description: p, control: null })),
        (t[14] = l),
        (t[15] = f),
        (t[16] = p),
        (t[17] = m))
...
function Kt(e) {
  let t = (0, on.c)(67),
    ...
    v = h(),
    { data: b } = We(),
    { data: te, error: x, refetch: ne } = P(r),
    C = te?.codexHome,
    w;
  t[0] !== C || t[1] !== s?.isCodexWorktree || t[2] !== o
    ? ((w = s?.isCodexWorktree === !0 || (C != null && i(o, C))),
      (t[0] = C),
      (t[1] = s?.isCodexWorktree),
      (t[2] = o),
      (t[3] = w))
    : (w = t[3]);
  let E = w,
    D = Re(r),
    { data: k } = n(o, D, `local_environment_editor`),
    A;
  t[4] !== r || t[5] !== o
    ? ((A = { hostId: r, workspaceRoot: o }), (t[4] = r), (t[5] = o), (t[6] = A))
    : (A = t[6]);
  let { updateSelection: re } = p(A),
    ie;
  t[7] !== k || t[8] !== D || t[9] !== g
    ? ((ie = {
        onSuccess: (e, t) => {
          !e.success || !k || ee(g, k, D, t.value, `local_environment_editor`);
        },
      }),
      (t[7] = k),
      (t[8] = D),
      ...
      (t[10] = ie))
    : (ie = t[10]);
  let j = O(`set-config-value`, D, ie),
    [M, ae] = (0, sn.useState)(`default`),
    [oe, se] = (0, sn.useState)(`default`),
    [F, ce] = (0, sn.useState)(!l),
    I,
    L;
  if (
    t[11] !== u?.actions ||
  ...
  t[30] !== o
    ? ((de = {
        onSuccess: async (e) => {
          let { configPath: t } = e;
          (v.invalidateQueries({
            queryKey: T(`local-environment-config`, { configPath: t, hostId: r }),
          }),
            v.invalidateQueries({
              queryKey: T(`local-environment`, { configPath: t, hostId: r }),
            }));
          let n = () =>
            v.invalidateQueries({
              queryKey: T(`local-environments`, { hostId: r, workspaceRoot: o }),
            });
          if (F) {
            if (
              !(await Et({
      ...
      (t[31] = de))
    : (de = t[31]);
  let R = y(`local-environment-config-save`, de),
    z;
  t[32] !== c || t[33] !== r || t[34] !== R || t[35] !== L
    ? ((z = (e) => {
        let { value: t } = e,
          n = Xt(t, L);
        t.name.length !== 0 && R.mutate({ configPath: c, hostId: r, raw: n });
      }),
      (t[32] = c),
      (t[33] = r),
      (t[34] = R),
  ...
  let fe;
  t[37] !== le || t[38] !== z
    ? ((fe = { defaultValues: le, onSubmit: z }), (t[37] = le), (t[38] = z), (t[39] = fe))
    : (fe = t[39]);
  let B = Dt(fe),
    he;
  t[40] === B
  ...
  t[59] !== o
    ? ((V = (e) => {
        ...
        let r = ht.map((e) => ({
          ...
          c = Zt({
            values: t,
            isDirty: n,
            isSelectionReady: !F || ((s != null || C != null) && (!E || k?.root != null)),
            selectionError: s == null && x != null,
            ...
            (0, X.jsxs)(q, {
              children: [
                ...
                (0, X.jsxs)(q.Content, {
                  ...
                  children: [
                    (0, X.jsx)(K, {
                      children: (0, X.jsx)(Ht, { workspaceRoot: o, workspaceGroup: s }),
                    }),
                    d
                      ? (0, X.jsx)(`div`, {
                  ...
                  (0, X.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, X.jsx)(`textarea`, {
                        ...
                        className: `focus-visible:ring-token-focus w-full rounded-md border border-token-border bg-token-input-background px-2.5 py-2 font-mono text-sm text-token-text-primary outline-none focus-visible:ring-2`,
                        value: en(t, `cleanup`, oe),
                        placeholder: bt,
                        rows: 6,
                        onChange: (e) => {
                          p(`cleanup`, oe, e.target.value);
                        },
                      }),
                    ],
                  }),
                                      ...
                                      (0, X.jsx)(`div`, {
                                        ...
                                        children: (0, X.jsx)(pe, {
                                          ...
                                          children: (0, X.jsx)(N, {
                                            ...
                                            children: (0, X.jsx)(Je, { className: `icon-sm` }),
                                          }),
                                        }),
                                      }),
                                    ],
    ...
    : (V = t[60]);
  let ge;
  t[61] !== B.Subscribe || t[62] !== V
    ? ((ge = (0, X.jsx)(B.Subscribe, { selector: qt, children: V })),
      (t[61] = B.Subscribe),
      (t[62] = V),
      (t[63] = ge))
    : (ge = t[63]);
...
function ln(e) {
  ...
  t[9] !== c || t[10] !== S
    ? ((C = (0, Z.jsx)(q.Header, {
        title: ne,
        actions: (0, Z.jsx)(N, { color: `primary`, size: `toolbar`, onClick: c, children: S }),
      })),
      (t[9] = c),
      (t[10] = S),
      (t[11] = C))
  ...
  let A;
  return (
    t[39] !== O || t[40] !== k || t[41] !== x
      ? ((A = (0, Z.jsxs)(Z.Fragment, { children: [x, O, k] })),
        (t[39] = O),
        (t[40] = k),
        (t[41] = x),
        (t[42] = A))
...
var pn,
  Z,
  mn = e(() => {
    ((pn = o()), U(), I(), B(), Ft(), Lt(), ut(), tt(), lt(), yt(), Vt(), Gt(), (Z = k()));
  });
function hn(e) {
  let t = (0, wn.c)(14),
    {
  ...
  t[2] === a
    ...
    : ((u = (0, Q.jsx)(q.Header, {
        title: c,
        actions: (0, Q.jsx)(N, { color: `secondary`, size: `toolbar`, onClick: a, children: l }),
      })),
      (t[2] = a),
      (t[3] = u));
  let d;
...
function vn(e) {
  ...
  let { data: c, isLoading: l, error: u } = v(`local-environments`, s),
    ...
    _ = ne(m),
    y = n.isCodexWorktree ? re : se,
    ee = n.repositoryData?.ownerRepo?.owner ?? null,
    b = l,
    te = u != null,
  ...
  t[11] === y
    ? (ie = t[12])
    : ((ie = (0, Q.jsx)(y, { className: `icon-sm shrink-0 text-token-text-secondary` })),
      (t[11] = y),
      (t[12] = ie));
  let j;
  t[13] === n.label
    ? (j = t[14])
    : ((j = (0, Q.jsx)(`span`, { className: `truncate font-medium`, children: n.label })),
      (t[13] = n.label),
      (t[14] = j));
  let M;
  t[15] === ee
    ? (M = t[16])
    : ((M = ee
        ? (0, Q.jsx)(`span`, { className: `truncate text-token-text-secondary`, children: ee })
        : null),
      (t[15] = ee),
      (t[16] = M));
  let ae;
  ...
  return (
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((P = (0, Q.jsx)(be, { className: `icon-xs` })), (t[20] = P))
      : (P = t[20]),
    (0, Q.jsxs)(K, {
      className: `p-0`,
      children: [
...
function bn(e) {
  ...
  let v;
  t[13] !== r || t[14] !== a
    ? ((v = (0, Q.jsx)(N, { color: `ghost`, size: `toolbar`, onClick: a, children: r })),
      (t[13] = r),
      (t[14] = a),
      (t[15] = v))
    : (v = t[15]);
...
function Dn() {
  ...
  let d = u,
    { selectedHostId: f } = Qe(),
    p = a?.hostId ?? f,
    { data: h, isLoading: _ } = m(Fe, { hostId: p }),
    y;
  e[6] === h?.roots ? (y = e[7]) : ((y = h?.roots ?? []), (e[6] = h?.roots), (e[7] = y));
  let ee = y,
    b = et(w(ge), p),
    [te, x] = (0, jn.useState)(a?.workspaceRoot ?? s),
    [S, C] = (0, jn.useState)(a?.configPath ?? l),
    [T, E] = (0, jn.useState)(a != null || d === `edit`),
    D = te ?? null,
  ...
  let ce = F,
    ...
    L;
  e[26] !== p || e[27] !== I
    ? ((L = { hostId: p, workspaceRoot: I }), (e[26] = p), (e[27] = I), (e[28] = L))
    : (L = e[28]);
  let le = !A && O != null,
    ue;
  e[29] === le ? (ue = e[30]) : ((ue = { enabled: le }), (e[29] = le), (e[30] = ue));
  let de;
  e[31] !== L || e[32] !== ue
    ? ((de = { params: L, queryConfig: ue, select: On }), (e[31] = L), (e[32] = ue), (e[33] = de))
    : (de = e[33]);
  let { data: R, isLoading: z, error: fe } = v(`local-environments`, de),
    pe;
  e[34] === R ? (pe = e[35]) : ((pe = R === void 0 ? [] : R), (e[34] = R), (e[35] = pe));
  let B = pe,
    me;
  e[36] === B ? (me = e[37]) : ((me = ne(B)), (e[36] = B), (e[37] = me));
  let he = me,
    V;
  e[38] !== a || e[39] !== B || e[40] !== fe || e[41] !== z || e[42] !== O
    ? ((V = a != null && a.configPath == null && !z && fe == null && O != null ? g(B, O) : null),
      (e[38] = a),
      (e[39] = B),
      (e[40] = fe),
      (e[41] = z),
    ...
    : (V = e[43]);
  let _e = V,
    ve = S ?? a?.configPath ?? _e ?? (a == null ? he : null),
    ye = ve ?? ``,
    be;
  e[44] !== p || e[45] !== ye
    ? ((be = { configPath: ye, hostId: p }), (e[44] = p), (e[45] = ye), (e[46] = be))
    : (be = e[46]);
  let xe = !A && O != null && ve != null,
    Se;
  e[47] === xe ? (Se = e[48]) : ((Se = { enabled: xe }), (e[47] = xe), (e[48] = Se));
  let we;
  e[49] !== be || e[50] !== Se
    ? ((we = { params: be, queryConfig: Se }), (e[49] = be), (e[50] = Se), (e[51] = we))
    : (we = e[51]);
  let { data: H, isLoading: Te, error: Ee } = v(`local-environment-config`, we),
    De = H?.configPath ?? ``,
    Oe;
  e[52] !== p || e[53] !== De
    ? ((Oe = { configPath: De, hostId: p }), (e[52] = p), (e[53] = De), (e[54] = Oe))
    : (Oe = e[54]);
  let Ae = !A && O != null && !!H?.exists,
    U;
  e[55] === Ae ? (U = e[56]) : ((U = { enabled: Ae }), (e[55] = Ae), (e[56] = U));
  let Ne;
  e[57] !== Oe || e[58] !== U
    ? ((Ne = { params: Oe, queryConfig: U }), (e[57] = Oe), (e[58] = U), (e[59] = Ne))
    : (Ne = e[59]);
  let { data: Le, error: Re, isLoading: Be } = v(`local-environment`, Ne),
    ...
    We = Ee?.message ?? Re?.message ?? fe?.message ?? null,
    Ge;
  e[60] !== N || e[61] !== P || e[62] !== T || e[63] !== O || e[64] !== k
    ? ((Ge =
        O == null
          ? null
          : (0, $.jsx)(jt, {
  ...
  if (i && a == null) {
    ...
    return (
      e[66] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, $.jsx)(ke, { to: `/settings/local-environments`, replace: !0 })), (e[66] = t))
        : (t = e[66]),
      t
    );
  }
  if (A) {
    ...
    let n;
    return (
      e[68] !== j || e[69] !== ce || e[70] !== se || e[71] !== p || e[72] !== b || e[73] !== _
        ? ((n = (0, $.jsx)(kn, {
            subtitle: t,
            children: (0, $.jsx)(hn, {
              groups: b,
...
function kn(e) {
  let t = (0, An.c)(5),
    ...
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(ct, { slug: `local-environments` })), (t[0] = a))
    : (a = t[0]);
  let o;
  return (
    t[1] !== n || t[2] !== i || t[3] !== r
