...
function jt(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, J.jsx)(`span`, {
      ...
      (u = (0, J.jsx)(R, { className: `icon-xs text-token-text-secondary` })),
      (t[5] = l),
      (t[6] = u))
    : ((l = t[5]), (u = t[6]));
  let d;
  ...
  let p;
  t[11] !== d || t[12] !== f
    ? ((p = (0, J.jsxs)(`div`, { className: `flex items-center gap-1`, children: [l, u, d, f] })),
      (t[11] = d),
      (t[12] = f),
      (t[13] = p))
    : (p = t[13]);
...
function Ht(e) {
  ...
  return (
    t[14] !== l || t[15] !== f || t[16] !== p
      ? ((m = (0, Wt.jsx)(b, { icon: l, label: f, description: p, control: null })),
        (t[14] = l),
        (t[15] = f),
        (t[16] = p),
        (t[17] = m))
...
function Kt(e) {
  let t = (0, on.c)(67),
    ...
    v = f(),
    { data: ee } = ce(),
    { data: te, error: b, refetch: x } = je(n),
    S = te?.codexHome,
    C;
  t[0] !== S || t[1] !== i?.isCodexWorktree || t[2] !== r
    ? ((C = i?.isCodexWorktree === !0 || (S != null && h(r, S))),
      (t[0] = S),
  ...
  let w = C,
    T = ge(n),
    { data: E } = se(r, T, `local_environment_editor`),
    D;
  t[4] !== n || t[5] !== r
    ? ((D = { hostId: n, workspaceRoot: r }), (t[4] = n), (t[5] = r), (t[6] = D))
    : (D = t[6]);
  let { updateSelection: O } = tt(D),
    k;
  t[7] !== E || t[8] !== T || t[9] !== p
    ? ((k = {
        onSuccess: (e, t) => {
          !e.success || !E || ot(p, E, T, t.value, `local_environment_editor`);
        },
      }),
      (t[7] = E),
      (t[8] = T),
      ...
      (t[10] = k))
    : (k = t[10]);
  let A = oe(`set-config-value`, T, k),
    [j, M] = (0, sn.useState)(`default`),
    [N, ne] = (0, sn.useState)(`default`),
    [P, ie] = (0, sn.useState)(!o),
    ae,
    I;
  if (
    t[11] !== s?.actions ||
  ...
  t[30] !== r
    ? ((ue = {
        onSuccess: async (e) => {
          let { configPath: t } = e;
          (v.invalidateQueries({
            queryKey: _(`local-environment-config`, { configPath: t, hostId: n }),
          }),
            v.invalidateQueries({
              queryKey: _(`local-environment`, { configPath: t, hostId: n }),
            }));
          let i = () =>
            v.invalidateQueries({
              queryKey: _(`local-environments`, { hostId: n, workspaceRoot: r }),
            });
          if (P) {
            if (
              !(await Et({
      ...
      (t[31] = ue))
    : (ue = t[31]);
  let L = m(`local-environment-config-save`, ue),
    de;
  ...
  let fe;
  t[37] !== le || t[38] !== de
    ? ((fe = { defaultValues: le, onSubmit: de }), (t[37] = le), (t[38] = de), (t[39] = fe))
    : (fe = t[39]);
  let R = Dt(fe),
    z;
  t[40] === R
  ...
  t[59] !== r
    ? ((B = (e) => {
        ...
        let a = ht.map((e) => ({
          ...
          c = Zt({
            values: t,
            isDirty: n,
            isSelectionReady: !P || ((i != null || S != null) && (!w || E?.root != null)),
            selectionError: i == null && b != null,
          ...
          p = (e, n, r) => {
            if (n === `default`) {
              R.setFieldValue(e === `setup` ? `setupScript` : `cleanupScript`, r);
              return;
            }
            let { scriptField: i, scripts: a } = $t(t, e);
            R.setFieldValue(i, { ...a, [n]: r });
          },
          m = () => {
            R.setFieldValue(`actions`, [...t.actions, xt(``)]);
          },
          h = (e) => {
            R.setFieldValue(
              `actions`,
                    ...
                    (0, X.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, X.jsx)(`input`, {
                          ...
                          value: t.name,
                          onChange: (e) => {
                            R.setFieldValue(`name`, e.target.value);
                          },
                        }),
                      ],
                    }),
                      ...
                      children: [
                        ...
                        (0, X.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, X.jsx)(`textarea`, {
                              id: `local-environment-setup-script-${j}`,
                ...
                children: [
                  ...
                  (0, X.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, X.jsx)(`textarea`, {
                        id: `local-environment-cleanup-script-${N}`,
                        className: `focus-visible:ring-token-focus w-full rounded-md border border-token-border bg-token-input-background px-2.5 py-2 font-mono text-sm text-token-text-primary outline-none focus-visible:ring-2`,
                        value: en(t, `cleanup`, N),
                        placeholder: bt,
                        rows: 6,
                        onChange: (e) => {
                          p(`cleanup`, N, e.target.value);
                        },
                      }),
                    ],
                  }),
              ...
              children: [
                ...
                (0, X.jsxs)(q.Content, {
                  ...
                  children: [
                    (0, X.jsx)(`div`, {
                      className: `text-sm text-token-text-secondary`,
                      children: (0, X.jsx)(H, { ...Pt.actionsDescription }),
                    }),
                    t.actions.length === 0
                      ? (0, X.jsx)(K, {
                          children: (0, X.jsx)(`div`, {
                            className: `p-3 text-sm text-token-text-secondary`,
                            children: (0, X.jsx)(H, { ...Pt.actionsEmpty }),
                          }),
                        })
                      : (0, X.jsx)(`div`, {
                          className: `flex flex-col gap-3`,
                                      ...
                                      (0, X.jsx)(`div`, {
                                        ...
                                        children: (0, X.jsx)(re, {
                                          ...
                                          children: (0, X.jsx)(F, {
                                            ...
                                            children: (0, X.jsx)(y, { className: `icon-sm` }),
                                          }),
                                        }),
                                      }),
                                    ],
    ...
    : (B = t[60]);
  let V;
  t[61] !== R.Subscribe || t[62] !== B
    ? ((V = (0, X.jsx)(R.Subscribe, { selector: qt, children: B })),
      (t[61] = R.Subscribe),
      (t[62] = B),
      (t[63] = V))
    : (V = t[63]);
...
function ln(e) {
  ...
  let d = u,
    ...
    te = _.length > 0 || v.length > 0 || y.length > 0,
    x;
  ...
  t[9] !== c || t[10] !== w
    ? ((T = (0, Z.jsx)(q.Header, {
        title: C,
        actions: (0, Z.jsx)(F, { color: `primary`, size: `toolbar`, onClick: c, children: w }),
      })),
      (t[9] = c),
      (t[10] = w),
      (t[11] = T))
  ...
  t[19] !== E || t[20] !== D || t[21] !== O
    ? ((k = (0, Z.jsxs)(q.Content, { children: [E, D, O] })),
      (t[19] = E),
      (t[20] = D),
      (t[21] = O),
      (t[22] = k))
  ...
  let A;
  t[23] !== k || t[24] !== T
    ? ((A = (0, Z.jsxs)(q, { children: [T, k] })), (t[23] = k), (t[24] = T), (t[25] = A))
    : (A = t[25]);
  let j;
  t[26] !== d ||
  t[27] !== _ ||
              ...
              (0, Z.jsxs)(q, {
                children: [
                  (0, Z.jsx)(q.Header, {
                    ...
                    subtitle: (0, Z.jsx)(H, { ...Pt.actionsDescription }),
                  }),
                  (0, Z.jsx)(q.Content, {
                    children: (0, Z.jsx)(K, {
                      children:
                        d.length > 0
                          ? d.map(un)
                          : (0, Z.jsx)(b, {
                              label: (0, Z.jsx)(H, { ...Pt.actionsEmpty }),
                              control: null,
                            }),
                    }),
                  }),
  ...
  let M;
  return (
    t[39] !== A || t[40] !== j || t[41] !== S
      ? ((M = (0, Z.jsxs)(Z.Fragment, { children: [S, A, j] })),
        (t[39] = A),
        (t[40] = j),
        (t[41] = S),
        (t[42] = M))
...
var pn,
  Z,
  mn = e(() => {
    ((pn = r()), V(), B(), Ye(), Ft(), Lt(), ut(), E(), st(), yt(), Vt(), Gt(), (Z = n()));
  });
function hn(e) {
  let t = (0, wn.c)(14),
    {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(H, { ...Pt.selectProject })), (t[0] = c))
    : (c = t[0]);
  let l;
  ...
  return (
    t[11] !== u || t[12] !== d
      ? ((f = (0, Q.jsxs)(q, { className: `gap-2`, children: [u, d] })),
        (t[11] = u),
        (t[12] = d),
        (t[13] = f))
      : (f = t[13]),
...
function vn(e) {
  ...
  t[0] !== n.path || t[1] !== r
    ? ((s = { params: { hostId: r, workspaceRoot: n.path }, select: yn }),
      ...
      (t[2] = s))
    : (s = t[2]);
  let { data: c, isLoading: l, error: u } = v(`local-environments`, s),
    d = c === void 0 ? [] : c,
    [f, p] = (0, Tn.useState)(!1),
    { projectEnvironments: m, inheritedEnvironments: h } = Sn(d, n.path),
    g = nt(m),
    _ = n.isCodexWorktree ? et : Be,
  ...
  t[11] === _
    ? (j = t[12])
    : ((j = (0, Q.jsx)(_, { className: `icon-sm shrink-0 text-token-text-secondary` })),
      (t[11] = _),
      (t[12] = j));
  let M;
  t[13] === n.label
  ...
  return (
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((P = (0, Q.jsx)(Le, { className: `icon-xs` })), (t[20] = P))
      : (P = t[20]),
    (0, Q.jsxs)(K, {
      className: `p-0`,
      children: [
...
function bn(e) {
  ...
  let v;
  t[13] !== r || t[14] !== a
    ? ((v = (0, Q.jsx)(F, { color: `ghost`, size: `toolbar`, onClick: a, children: r })),
      (t[13] = r),
      (t[14] = a),
      (t[15] = v))
    : (v = t[15]);
...
function Dn() {
  ...
  let p = f,
    { selectedHostId: m } = T(),
    h = a?.hostId ?? m,
    { data: g, isLoading: _ } = d(M, { hostId: h }),
    y;
  e[6] === g?.roots ? (y = e[7]) : ((y = g?.roots ?? []), (e[6] = g?.roots), (e[7] = y));
  let te = y,
    b = S(u(Ne), h),
    [x, C] = (0, jn.useState)(a?.workspaceRoot ?? s),
    [w, E] = (0, jn.useState)(a?.configPath ?? l),
    [D, k] = (0, jn.useState)(a != null || p === `edit`),
    A = x ?? null,
    j = A != null && (a != null || te.includes(A)) ? A : null,
    P = j == null ? null : (b.find((e) => e.path === j) ?? null),
    re = j == null,
    F;
  e[8] === h
    ? (F = e[9])
  ...
  let fe = L,
    ...
    R;
  e[26] !== h || e[27] !== pe
    ? ((R = { hostId: h, workspaceRoot: pe }), (e[26] = h), (e[27] = pe), (e[28] = R))
    : (R = e[28]);
  let z = !re && j != null,
    B;
  e[29] === z ? (B = e[30]) : ((B = { enabled: z }), (e[29] = z), (e[30] = B));
  let V;
  e[31] !== R || e[32] !== B
    ? ((V = { params: R, queryConfig: B, select: On }), (e[31] = R), (e[32] = B), (e[33] = V))
    : (V = e[33]);
  let { data: me, isLoading: U, error: he } = v(`local-environments`, V),
    ge;
  e[34] === me ? (ge = e[35]) : ((ge = me === void 0 ? [] : me), (e[34] = me), (e[35] = ge));
  let _e = ge,
    ve;
  e[36] === _e ? (ve = e[37]) : ((ve = nt(_e)), (e[36] = _e), (e[37] = ve));
  let be = ve,
    xe;
  e[38] !== a || e[39] !== _e || e[40] !== he || e[41] !== U || e[42] !== j
    ? ((xe = a != null && a.configPath == null && !U && he == null && j != null ? at(_e, j) : null),
      (e[38] = a),
      (e[39] = _e),
      (e[40] = he),
      (e[41] = U),
    ...
    : (xe = e[43]);
  let Ce = xe,
    we = w ?? a?.configPath ?? Ce ?? (a == null ? be : null),
    Te = we ?? ``,
    Ee;
  e[44] !== h || e[45] !== Te
    ? ((Ee = { configPath: Te, hostId: h }), (e[44] = h), (e[45] = Te), (e[46] = Ee))
    : (Ee = e[46]);
  let De = !re && j != null && we != null,
    Oe;
  e[47] === De ? (Oe = e[48]) : ((Oe = { enabled: De }), (e[47] = De), (e[48] = Oe));
  let ke;
  e[49] !== Ee || e[50] !== Oe
    ? ((ke = { params: Ee, queryConfig: Oe }), (e[49] = Ee), (e[50] = Oe), (e[51] = ke))
    : (ke = e[51]);
  let { data: W, isLoading: je, error: Me } = v(`local-environment-config`, ke),
    Pe = W?.configPath ?? ``,
    Fe;
  e[52] !== h || e[53] !== Pe
    ? ((Fe = { configPath: Pe, hostId: h }), (e[52] = h), (e[53] = Pe), (e[54] = Fe))
    : (Fe = e[54]);
  let Ie = !re && j != null && !!W?.exists,
    Le;
  e[55] === Ie ? (Le = e[56]) : ((Le = { enabled: Ie }), (e[55] = Ie), (e[56] = Le));
  let Re;
  e[57] !== Fe || e[58] !== Le
    ? ((Re = { params: Fe, queryConfig: Le }), (e[57] = Fe), (e[58] = Le), (e[59] = Re))
    : (Re = e[59]);
  let { data: ze, error: Be, isLoading: Ve } = v(`local-environment`, Re),
    He = ze?.environment.type === `success` ? ze.environment.environment : null,
    Ue = ze?.environment.type === `error` ? ze.environment.error.message : null,
    We = Me?.message ?? Be?.message ?? he?.message ?? null,
    Ge;
  e[60] !== oe || e[61] !== ce || e[62] !== D || e[63] !== j || e[64] !== P
    ? ((Ge =
        j == null
          ? null
          : (0, $.jsx)(jt, {
  ...
  if (i && a == null) {
    ...
    return (
      e[66] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, $.jsx)(I, { to: `/settings/local-environments`, replace: !0 })), (e[66] = t))
        : (t = e[66]),
      t
    );
  }
  if (re) {
    ...
    let n;
    return (
      e[68] !== ie || e[69] !== fe || e[70] !== ue || e[71] !== h || e[72] !== b || e[73] !== _
        ? ((n = (0, $.jsx)(kn, {
            subtitle: t,
            children: (0, $.jsx)(hn, {
              groups: b,
...
function kn(e) {
  let t = (0, An.c)(5),
    ...
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(lt, { slug: `local-environments` })), (t[0] = a))
    : (a = t[0]);
  let o;
  return (
    t[1] !== n || t[2] !== i || t[3] !== r
      ? ((o = (0, $.jsx)(xe, { title: a, subtitle: r, backSlot: n, children: i })),
        (t[1] = n),
        (t[2] = i),
        (t[3] = r),
        (t[4] = o))
