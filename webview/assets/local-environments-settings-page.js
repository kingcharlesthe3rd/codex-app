...
import { Bn as l, Hn as u, d } from "./thread-context-inputs.js";
import { A as f, o as p, r as m, s as h } from "./vscode-api.js";
import "./isEqual.js";
import { J as g, en as _, tn as v } from "./src.js";
import "./react-dom.js";
import { i as y, l as ee, s as b } from "./lib-1.js";
import { t as x } from "./clsx.js";
import "./proxy.js";
import { t as S } from "./button-oF-qgtAS.js";
...
function Re(e) {
  ...
  let M = j,
    N = c(n),
    { data: I } = u(r, N, `local_environment_editor`),
    L;
  t[4] !== n || t[5] !== r
...
function lt() {
  ...
  let l = c,
    u;
  e[2] === t ? (u = e[3]) : ((u = t.get(`configPath`)), (e[2] = t), (e[3] = u));
  let f = u,
    m;
  ...
  let h = m,
    { selectedHostId: g } = fe(),
    _ = s?.hostId ?? g,
    { data: v, isLoading: y } = i(d, { hostId: _ }),
    ee;
