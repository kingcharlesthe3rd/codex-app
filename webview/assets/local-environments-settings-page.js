...
import { i as ee, r as P } from "./open-project-setup-dialog.js";
import { t as te } from "./folder.js";
import "./local-task-row-signals.js";
import { u as ne } from "./sidebar-project-group-signals.js";
...
function je(e) {
  let t = (0, X.c)(59),
    ...
    ee = M(n),
    P;
  t[0] !== ee || t[1] !== c ? ((P = i(c, ee)), (t[0] = ee), (t[1] = c), (t[2] = P)) : (P = t[2]);
  let te = P,
    ne = u(n),
  ...
  t[28] !== c
    ? ((de = {
        onSuccess: () => {
          (D.invalidateQueries({
            queryKey: w(`local-environment-config`, { configPath: f, hostId: n }),
          }),
            D.invalidateQueries({ queryKey: w(`local-environment`, { configPath: f, hostId: n }) }),
            D.invalidateQueries({
              queryKey: w(`local-environments`, { hostId: n, workspaceRoot: c }),
            }),
            T.get(O).success(
              E.formatMessage({
            ...
            (0, Z.jsxs)(J, {
              children: [
                ...
                (0, Z.jsxs)(J.Content, {
                  ...
                  children: [
                    (0, Z.jsx)(q, {
                      children: (0, Z.jsx)(Ae, { workspaceRoot: c, workspaceGroup: d }),
                    }),
                    b
                      ? (0, Z.jsx)(`div`, {
                    ...
                    S
                      ? (0, Z.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            v.length > 0 ? (0, Z.jsx)(Ge, { platform: `darwin`, script: v }) : null,
                            y.length > 0 ? (0, Z.jsx)(Ge, { platform: `linux`, script: y }) : null,
                            b.length > 0 ? (0, Z.jsx)(Ge, { platform: `win32`, script: b }) : null,
                          ],
                        })
                      : null,
                  ],
...
function Ye(e) {
  ...
  t[11] === b
    ? (F = t[12])
    : ((F = (0, Z.jsx)(b, { className: `icon-sm shrink-0 text-token-text-secondary` })),
      (t[11] = b),
      (t[12] = F));
  let I;
  t[13] === n.label
  ...
  t[15] === x
    ? (L = t[16])
    : ((L = x
        ? (0, Z.jsx)(`span`, { className: `truncate text-token-text-secondary`, children: x })
        : null),
      (t[15] = x),
      (t[16] = L));
  let re;
