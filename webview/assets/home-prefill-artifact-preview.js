...
import { au as c, ou as l } from "./app-initial~app-main~onboarding-page.js";
function u(e) {
  let t = (0, f.c)(4),
...
function d(e) {
  let t = (0, f.c)(6),
    { hostId: n, locationKey: r, previewFiles: o } = e,
    s = a(i),
    c = (0, p.useRef)(null),
    u,
    d;
  (t[0] !== n || t[1] !== r || t[2] !== o || t[3] !== s
    ? ((u = () => {
        if (!(o == null || o.length === 0 || c.current === r)) {
          c.current = r;
          for (let e of o) {
            let t = e.fsPath || e.path;
            t == null || t.length === 0 || l(s, t, { hostId: n, title: e.label });
          }
        }
      }),
      (d = [n, r, o, s]),
