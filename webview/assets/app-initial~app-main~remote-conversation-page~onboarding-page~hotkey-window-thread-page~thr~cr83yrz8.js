...
function f(e) {
  ...
  t[13] !== n || t[14] !== A
    ? ((N = n
        ? {
            "--annotation-mode-button-annotation-background": p(`charts-blue`, v),
            "--annotation-mode-button-annotation-hover-background": p(`charts-blue`, A),
          }
        : {}),
      (t[13] = n),
      (t[14] = A),
  ...
  let V = n ? `justify-start` : `w-full justify-center`,
    H;
  t[30] === V ? (H = t[31]) : ((H = c(`flex min-w-0 items-center`, V)), (t[30] = V), (t[31] = H));
  let U;
  t[32] === j
    ? (U = t[33])
    : ((U = c(
  ...
  t[35] === U
    ? (G = t[36])
    : ((G = (0, _.jsx)(`span`, { className: U, children: W })), (t[35] = U), (t[36] = G));
  ...
  let J;
  t[39] !== i || t[40] !== q
    ? ((J = (0, _.jsx)(`span`, { className: q, children: i })),
      (t[39] = i),
      (t[40] = q),
      (t[41] = J))
    : (J = t[41]);
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~onboarding-page~hotkey-window-thread-page~thr~cr83yrz8.js.map
