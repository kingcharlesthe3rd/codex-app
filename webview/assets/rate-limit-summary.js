...
import { n as _, r as v } from "./dropdown.js";
...
function S(e) {
  let t = (0, b.c)(6),
    ...
    o;
  t[0] !== a || t[1] !== r || t[2] !== i
    ? ((o = g({ intl: a, minutes: r, variant: i })), (t[0] = a), (t[1] = r), (t[2] = i), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] === o
...
function C(e) {
  let t = (0, b.c)(77),
    {
      ...
      suppressUpsell: f,
      selectedModel: p,
      availableRateLimitResetCount: g,
  ...
  if (
    ...
    let e = h(a, { activeLimitName: l, selectedModel: p }),
      n;
    (t[19] !== l || t[20] !== f
      ? ((n = f ?? !m(l)), (t[19] = l), (t[20] = f), (t[21] = n))
      : (n = t[21]),
      (M = n),
      (j = E === `compact`),
      (A = _),
  ...
  t[27] !== N || t[28] !== P || t[29] !== F
    ...
    : (B = t[30]);
  let V;
  t[31] !== k || t[32] !== B || t[33] !== I || t[34] !== L || t[35] !== R || t[36] !== z
    ? ((V = (0, x.jsx)(k, {
        LeftIcon: I,
        RightIcon: L,
        tooltipText: R,
  ...
  t[38] === re
    ? (H = t[39])
    : ((H = i(`grid items-center gap-y-1.5 py-1`, re)), (t[38] = re), (t[39] = H));
  let U;
  if (t[40] !== j || t[41] !== a) {
    let e;
    (t[43] === j
  ...
  t[45] !== H || t[46] !== U
    ...
    : (W = t[47]);
  let G;
  t[48] !== j || t[49] !== C || t[50] !== d || t[51] !== M
    ? ((G =
        !M &&
        (0, x.jsx)(te, {
          planType: d,
          className: i(j && `pl-[calc(var(--padding-row-x)+1.25rem)] pr-[var(--padding-row-x)]`),
          onPlanUpgradeClick: C,
        })),
      (t[48] = j),
      (t[49] = C),
  ...
  let ie = j ? `icon-xs text-token-description-foreground` : void 0,
    ...
    q;
  t[57] === ae ? (q = t[58]) : ((q = i(ae)), (t[57] = ae), (t[58] = q));
  let oe = j ? `text-token-foreground` : `text-token-description-foreground`,
    J;
  t[59] === oe ? (J = t[60]) : ((J = i(oe)), (t[59] = oe), (t[60] = J));
  let Y;
  ...
  t[62] === J
    ? (X = t[63])
    : ((X = (0, x.jsx)(`span`, { className: J, children: Y })), (t[62] = J), (t[63] = X));
  let Z;
  t[64] !== ie || t[65] !== q || t[66] !== X
    ? ((Z = (0, x.jsx)(v.Item, {
        RightIcon: c,
...
function ee(e) {
  let t = (0, b.c)(19),
    ...
    s = n?.primary,
    c;
  t[0] === s ? (c = t[1]) : ((c = l(s)), (t[0] = s), (t[1] = c));
  let u = c,
    d = n?.secondary,
    f;
  t[2] === d ? (f = t[3]) : ((f = l(d)), (t[2] = d), (t[3] = f));
  let p = f;
  if (!u && !p) return null;
  let m;
  t[4] !== o || t[5] !== a
  ...
  let h;
  t[7] !== o || t[8] !== n || t[9] !== u
    ? ((h = u && (0, x.jsx)(w, { bucket: n.primary ?? null, compact: o })),
      (t[7] = o),
      (t[8] = n),
      (t[9] = u),
      (t[10] = h))
    : (h = t[10]);
  let g;
  t[11] !== o || t[12] !== n || t[13] !== p
    ? ((g = p && (0, x.jsx)(w, { bucket: n.secondary ?? null, compact: o })),
      (t[11] = o),
      (t[12] = n),
      (t[13] = p),
      (t[14] = g))
...
function w(e) {
  ...
  let o;
  if (t[0] !== n.resetsAt) {
    let e = p(n.resetsAt ?? null);
    ((o = e == null ? null : d(e)), (t[0] = n.resetsAt), (t[1] = o));
  } else o = t[1];
  let s = o,
    c,
    m,
  ...
  if (t[2] !== n.usedPercent || t[3] !== n.windowDurationMins || t[4] !== r) {
    ...
    let s = r && `shrink-0`,
      l;
    t[11] === s ? (l = t[12]) : ((l = i(s)), (t[11] = s), (t[12] = l));
    let d = n.windowDurationMins ?? null,
      p;
    t[13] === d ? (p = t[14]) : ((p = (0, x.jsx)(S, { minutes: d })), (t[13] = d), (t[14] = p));
    let _;
    (t[15] !== p || t[16] !== l
      ? ((_ = (0, x.jsx)(`span`, { className: l, children: p })),
        (t[15] = p),
        (t[16] = l),
        (t[17] = _))
      : (_ = t[17]),
      t[18] !== _ || t[19] !== o
        ? ((g = (0, x.jsx)(`span`, { className: o, children: _ })),
          (t[18] = _),
          (t[19] = o),
          (t[20] = g))
        : (g = t[20]));
    ...
    (t[21] === v
      ? (h = t[22])
      : ((h = i(`text-token-description-foreground flex gap-1 text-end`, v)),
        (t[21] = v),
        (t[22] = h)),
      (c = `shrink-0`),
      (m = u(e)),
      ...
      (t[7] = h),
      (t[8] = g));
  } else ((c = t[5]), (m = t[6]), (h = t[7]), (g = t[8]));
  let _;
  t[23] !== c || t[24] !== m
    ? ((_ = (0, x.jsx)(`span`, { className: c, children: m })),
      (t[23] = c),
      (t[24] = m),
      (t[25] = _))
    : (_ = t[25]);
  ...
  t[26] === s
    ...
    : ((v =
        ...
        (0, x.jsxs)(x.Fragment, {
          children: [
            (0, x.jsx)(`span`, { className: `shrink-0`, children: (0, x.jsx)(a, {}) }),
            (0, x.jsx)(`span`, {
              title: s,
              className: i(
      ...
      (t[27] = v));
  let y;
  t[28] !== h || t[29] !== _ || t[30] !== v
    ? ((y = (0, x.jsxs)(`span`, { className: h, children: [_, v] })),
      (t[28] = h),
      (t[29] = _),
      (t[30] = v),
      (t[31] = y))
  ...
  return (
    t[32] !== g || t[33] !== y
      ? ((C = (0, x.jsxs)(x.Fragment, { children: [g, y] })), (t[32] = g), (t[33] = y), (t[34] = C))
      : (C = t[34]),
    C
  );
}
  ...
  switch (n) {
    ...
    case `finserv`: {
      ...
      return (
        t[13] === i
          ? (n = t[14])
          : ((n = (0, x.jsx)(v.Item, { className: i, allowWrap: !0, children: e })),
            (t[13] = i),
            (t[14] = n)),
        n
      );
