...
function S(e) {
  let t = (0, b.c)(6),
    ...
    o;
  t[0] !== a || t[1] !== r || t[2] !== i
    ? ((o = c({ intl: a, minutes: r, variant: i })), (t[0] = a), (t[1] = r), (t[2] = i), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] === o
...
function C(e) {
  ...
  i[27] !== N || i[28] !== P || i[29] !== F
    ...
    : (B = i[30]);
  let V;
  i[31] !== k || i[32] !== B || i[33] !== I || i[34] !== L || i[35] !== R || i[36] !== z
    ? ((V = (0, x.jsx)(k, {
        LeftIcon: I,
        RightIcon: L,
        tooltipText: R,
  ...
  i[38] === re
    ? (H = i[39])
    : ((H = t(`grid items-center gap-y-1.5 py-1`, re)), (i[38] = re), (i[39] = H));
  let U;
  if (i[40] !== j || i[41] !== c) {
    let e;
    (i[43] === j
  ...
  i[62] === J
    ? (X = i[63])
    : ((X = (0, x.jsx)(`span`, { className: J, children: Y })), (i[62] = J), (i[63] = X));
  let Z;
...
function w(e) {
  ...
  return (
    n[32] !== m || n[33] !== y
      ? ((C = (0, x.jsxs)(x.Fragment, { children: [m, y] })), (n[32] = m), (n[33] = y), (n[34] = C))
      : (C = n[34]),
    C
  );
}
  ...
  switch (n) {
    ...
    case `finserv`: {
      ...
      return (
        t[13] === i
          ? (n = t[14])
          : ((n = (0, x.jsx)(_.Item, { className: i, allowWrap: !0, children: e })),
            (t[13] = i),
            (t[14] = n)),
        n
      );
