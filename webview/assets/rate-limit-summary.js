...
import { l as n, s as r } from "./lib-1.js";
import { t as i } from "./clsx.js";
import { t as a } from "./bullet-separator.js";
...
import { S as u, T as d, _ as f, b as p, v as m, w as h } from "./rate-limit-status.js";
import { l as g, r as _ } from "./use-rate-limit.js";
import { n as v, r as y } from "./dropdown.js";
import { t as b } from "./speedometer.js";
var x = t(),
  S = e();
function C(e) {
  let t = (0, x.c)(6),
    ...
    o;
  t[0] !== a || t[1] !== r || t[2] !== i
    ? ((o = m({ intl: a, minutes: r, variant: i })), (t[0] = a), (t[1] = r), (t[2] = i), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] === o
      ? (s = t[5])
      : ((s = (0, S.jsx)(S.Fragment, { children: o })), (t[4] = o), (t[5] = s)),
    s
  );
}
function w(e) {
  let t = (0, x.c)(53),
    {
      ...
      suppressUpsell: p,
      selectedModel: m,
      availableRateLimitResetCount: h,
      onRateLimitResetClick: C,
      onPlanUpgradeClick: w,
      onRequestLimitIncreaseClick: E,
      isLoading: D,
      showLearnMore: A,
      layout: j,
    } = e,
    ...
    N = D === void 0 ? !1 : D,
    P = A === void 0 ? !0 : A,
    F = j === void 0 ? `default` : j,
    I = n(),
    L = c(`1767204071`);
  if (!N && a.length === 0 && M === 0) return null;
  let R, z, B, V, H, U, W, G, K, q, J;
  if (
    t[0] !== u ||
    t[1] !== I ||
    t[2] !== L ||
    ...
    let e = _(a, { activeLimitName: u, selectedModel: m }),
      n;
    (t[19] !== u || t[20] !== p
      ? ((n = p ?? !g(u)), (t[19] = u), (t[20] = p), (t[21] = n))
      : (n = t[21]),
      (V = n),
      (B = F === `compact`),
      (z = v),
  ...
  t[27] !== W || t[28] !== G || t[29] !== K
    ? ((Y = (0, S.jsxs)(`span`, { className: W, children: [G, K] })),
      (t[27] = W),
      (t[28] = G),
      (t[29] = K),
      (t[30] = Y))
    : (Y = t[30]);
  let X;
  t[31] !== R || t[32] !== H || t[33] !== U || t[34] !== Y || t[35] !== q || t[36] !== J
    ? ((X = (0, S.jsx)(R, {
        LeftIcon: q,
        RightIcon: J,
        tooltipText: H,
    ...
    ? ((Z = (0, S.jsx)(`div`, {
        ...
        children: N
          ? (0, S.jsx)(y.Item, {
              LeftIcon: o,
              className: i(
                B && `pl-[calc(var(--padding-row-x)+1.25rem)] pr-[var(--padding-row-x)]`,
              ),
              disabled: !0,
              children: (0, S.jsx)(r, {
          ...
          : (0, S.jsxs)(S.Fragment, {
              children: [
                (0, S.jsx)(`div`, {
                  ...
                  children: a.map((e, t) => {
                    let n = g(e.limitName) ? null : e.limitName;
                    return (0, S.jsx)(
                      T,
                      { rateLimit: e.snapshot, limitName: n, compact: B },
                ...
                M > 0
                  ? (0, S.jsx)(y.Item, {
                      ...
                      children: (0, S.jsx)(r, {
                        ...
                        values: { availableRateLimitResetCount: M },
                      }),
                    })
                  : null,
                P &&
                  (0, S.jsx)(y.Item, {
                    RightIcon: l,
                    rightIconClassName: B ? `icon-xs text-token-description-foreground` : void 0,
                    className: i(
                      B && `pl-[calc(var(--padding-row-x)+1.25rem)] pr-[var(--padding-row-x)]`,
                    ),
                    ...
                    children: (0, S.jsx)(`span`, {
                      className: i(
                        B ? `text-token-foreground` : `text-token-description-foreground`,
                      ),
                      children: (0, S.jsx)(r, {
  ...
  let Q;
  return (
    t[49] !== z || t[50] !== X || t[51] !== Z
      ? ((Q = (0, S.jsx)(z, { trigger: X, children: Z })),
        (t[49] = z),
        (t[50] = X),
        (t[51] = Z),
        (t[52] = Q))
...
function T(e) {
  let t = (0, x.c)(19),
    { rateLimit: n, limitName: a, compact: o } = e,
    s = n?.primary,
    c;
  t[0] === s ? (c = t[1]) : ((c = h(s)), (t[0] = s), (t[1] = c));
  let l = c,
    u = n?.secondary,
    d;
  t[2] === u ? (d = t[3]) : ((d = h(u)), (t[2] = u), (t[3] = d));
  let f = d;
  if (!l && !f) return null;
  let p;
  t[4] !== o || t[5] !== a
  ...
  let m;
  t[7] !== o || t[8] !== n || t[9] !== l
    ? ((m = l && (0, S.jsx)(E, { bucket: n.primary ?? null, compact: o })),
      (t[7] = o),
      (t[8] = n),
      (t[9] = l),
      (t[10] = m))
    : (m = t[10]);
  let g;
  t[11] !== o || t[12] !== n || t[13] !== f
    ? ((g = f && (0, S.jsx)(E, { bucket: n.secondary ?? null, compact: o })),
      (t[11] = o),
      (t[12] = n),
      (t[13] = f),
      (t[14] = g))
  ...
  return (
    t[15] !== p || t[16] !== m || t[17] !== g
      ? ((_ = (0, S.jsxs)(S.Fragment, { children: [p, m, g] })),
        (t[15] = p),
        (t[16] = m),
        (t[17] = g),
        (t[18] = _))
...
function E(e) {
  ...
  let o;
  if (t[0] !== n.resetsAt) {
    let e = d(n.resetsAt ?? null);
    ((o = e == null ? null : p(e)), (t[0] = n.resetsAt), (t[1] = o));
  } else o = t[1];
  let s = o,
    c,
    l,
  ...
  if (t[2] !== n.usedPercent || t[3] !== n.windowDurationMins || t[4] !== r) {
    let e = u(n.usedPercent ?? 0),
      a = r && `flex min-w-0 items-center gap-1`,
      o;
    t[9] === a
      ? (o = t[10])
      : ((o = i(`text-token-foreground font-medium`, a)), (t[9] = a), (t[10] = o));
    let s = r && `shrink-0`,
      d;
    t[11] === s ? (d = t[12]) : ((d = i(s)), (t[11] = s), (t[12] = d));
    let p = n.windowDurationMins ?? null,
      h;
    t[13] === p ? (h = t[14]) : ((h = (0, S.jsx)(C, { minutes: p })), (t[13] = p), (t[14] = h));
    let _;
    (t[15] !== h || t[16] !== d
      ? ((_ = (0, S.jsx)(`span`, { className: d, children: h })),
        (t[15] = h),
        (t[16] = d),
        (t[17] = _))
      : (_ = t[17]),
      t[18] !== _ || t[19] !== o
        ? ((g = (0, S.jsx)(`span`, { className: o, children: _ })),
          (t[18] = _),
          (t[19] = o),
          (t[20] = g))
        : (g = t[20]));
    ...
    (t[21] === v
      ? (m = t[22])
      : ((m = i(`text-token-description-foreground flex gap-1 text-end`, v)),
        (t[21] = v),
        (t[22] = m)),
      (c = `shrink-0`),
      (l = f(e)),
      ...
      (t[7] = m),
      (t[8] = g));
  } else ((c = t[5]), (l = t[6]), (m = t[7]), (g = t[8]));
  let _;
  t[23] !== c || t[24] !== l
    ? ((_ = (0, S.jsx)(`span`, { className: c, children: l })),
      (t[23] = c),
      (t[24] = l),
      (t[25] = _))
    : (_ = t[25]);
  ...
  t[26] === s
    ...
    : ((v =
        ...
        (0, S.jsxs)(S.Fragment, {
          children: [
            (0, S.jsx)(`span`, { className: `shrink-0`, children: (0, S.jsx)(a, {}) }),
            (0, S.jsx)(`span`, {
              title: s,
              className: i(
      ...
      (t[27] = v));
  let y;
  t[28] !== m || t[29] !== _ || t[30] !== v
    ? ((y = (0, S.jsxs)(`span`, { className: m, children: [_, v] })),
      (t[28] = m),
      (t[29] = _),
      (t[30] = v),
      (t[31] = y))
  ...
  return (
    t[32] !== g || t[33] !== y
      ? ((b = (0, S.jsxs)(S.Fragment, { children: [g, y] })), (t[32] = g), (t[33] = y), (t[34] = b))
      : (b = t[34]),
    b
  );
}
...
function O(e) {
  let t = (0, x.c)(19),
    { planType: n, className: i, onPlanUpgradeClick: a, onRequestLimitIncreaseClick: o } = e;
  if (o != null) {
    let e;
    ...
    return (
      t[1] !== i || t[2] !== o
        ? ((n = (0, S.jsx)(y.Item, { className: i, onClick: o, children: e })),
          (t[1] = i),
          (t[2] = o),
          (t[3] = n))
        : (n = t[3]),
  ...
  switch (n) {
    ...
    case `finserv`: {
      ...
      return (
        t[17] === i
          ? (n = t[18])
          : ((n = (0, S.jsx)(y.Item, { className: i, allowWrap: !0, children: e })),
            (t[17] = i),
            (t[18] = n)),
        n
      );
