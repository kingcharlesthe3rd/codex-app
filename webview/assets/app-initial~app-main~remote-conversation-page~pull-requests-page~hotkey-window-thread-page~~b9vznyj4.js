...
function w(e) {
  ...
  t[0] === e
    ...
    : (({
      ...
      (t[8] = l));
  let d;
  t[9] === i ? (d = t[10]) : ((d = p(y.externalFooterItem, `min-w-0`, i)), (t[9] = i), (t[10] = d));
  let f;
...
function T(e) {
  ...
  t[0] === r
    ? (c = t[1])
    : ((c = p(y.externalFooterItem, `flex min-w-0 items-center gap-1`, r)), (t[0] = r), (t[1] = c));
  let l;
  ...
  return (
    t[8] !== c || t[9] !== l
      ? ((u = (0, k.jsx)(`div`, { className: c, children: l })),
        (t[8] = c),
        (t[9] = l),
        (t[10] = u))
      : (u = t[10]),
...
function E(e) {
  let t = (0, D.c)(26),
    { categoryLabel: n, collapse: r, icon: i, indicator: a, value: c, valueClassName: l } = e,
    u = h(`2700454473`) ? `icon-xs` : `icon-2xs`,
  ...
  bb0: switch (a) {
    ...
    case `chevron`: {
      ...
      t[3] === u
        ...
        : ((e = p(
          ...
          (t[4] = e));
      let n;
      (t[5] === e ? (n = t[6]) : ((n = (0, k.jsx)(d, { className: e })), (t[5] = e), (t[6] = n)),
        (T = n));
      break bb0;
    }
    case `collapsible-chevron`: {
      ...
      t[7] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = p(y.secondaryChevron, y.externalFooterItemChevron, `inline-flex`)), (t[7] = e))
        : (e = t[7]);
      let n;
      t[8] === u
        ? (n = t[9])
        : ((n = p(u, `shrink-0 text-token-input-placeholder-foreground`)), (t[8] = u), (t[9] = n));
      let r;
      (t[10] === n
        ? (r = t[11])
        : ((r = (0, k.jsx)(`span`, { className: e, children: (0, k.jsx)(d, { className: n }) })),
          (t[10] = n),
          (t[11] = r)),
        (T = r));
    }
  ...
  t[12] === i
    ? (E = t[13])
    : ((E =
        i == null ? null : (0, k.jsx)(`span`, { className: `inline-flex shrink-0`, children: i })),
      (t[12] = i),
      (t[13] = E));
  let A;
  t[14] !== n ||
  ...
  t[20] !== x
    ? ((A =
        n != null || c != null
          ? (0, k.jsxs)(`span`, {
              className: p(
                y.externalFooterItemText,
                n != null && y.externalFooterItemTextWithCategoryLabel,
              ...
              children: [
                n == null
                  ...
                  : (0, k.jsx)(`span`, {
                      className: p(
                        y.externalFooterItemCategoryLabel,
                ...
                (0, k.jsx)(v, {
                  ...
                  children: (0, k.jsx)(`span`, {
                    ref: C,
                    className: p(
                      y.externalFooterItemValueContent,
                      `block max-w-full min-w-0 truncate`,
                      w && y.externalFooterItemValueOverflowing,
                    ),
  ...
  let j;
  return (
    t[22] !== E || t[23] !== A || t[24] !== T
      ? ((j = (0, k.jsxs)(k.Fragment, { children: [E, A, T] })),
        (t[22] = E),
        (t[23] = A),
        (t[24] = T),
        (t[25] = j))
...
var D,
  ...
  k,
  A = e(() => {
    ((D = r()), f(), (O = t(n(), 1)), c(), l(), m(), a(), g(), _(), b(), (k = i()));
  });
export { C as a, S as i, w as n, A as r, T as t };
