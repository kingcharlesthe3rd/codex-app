...
import { g_ as _, h_ as v, m_ as y, p_ as b } from "./app-initial~app-main~onboarding-page.js";
var x,
  S,
  C = e(() => {
    (t(d()),
...
function w(e) {
  ...
  t[0] === e
    ...
    : (({
      ...
      (t[8] = l));
  let d;
  t[9] === i ? (d = t[10]) : ((d = f(v.externalFooterItem, `min-w-0`, i)), (t[9] = i), (t[10] = d));
  let p;
...
function T(e) {
  ...
  t[0] === r
    ? (c = t[1])
    : ((c = f(v.externalFooterItem, `flex min-w-0 items-center gap-1`, r)), (t[0] = r), (t[1] = c));
  let l;
...
function E(e) {
  let t = (0, D.c)(26),
    { categoryLabel: n, collapse: i, icon: o, indicator: s, value: l, valueClassName: u } = e,
    d = r(`2700454473`) ? `icon-xs` : `icon-2xs`,
  ...
  bb0: switch (s) {
    ...
    case `chevron`: {
      ...
      t[3] === d
        ...
        : ((e = f(
          ...
          (t[4] = e));
      let n;
      (t[5] === e ? (n = t[6]) : ((n = (0, k.jsx)(c, { className: e })), (t[5] = e), (t[6] = n)),
        (T = n));
      break bb0;
    }
    case `collapsible-chevron`: {
      ...
      t[7] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = f(v.secondaryChevron, v.externalFooterItemChevron, `inline-flex`)), (t[7] = e))
        : (e = t[7]);
      let n;
      t[8] === d
        ? (n = t[9])
        : ((n = f(d, `shrink-0 text-token-input-placeholder-foreground`)), (t[8] = d), (t[9] = n));
      let r;
      (t[10] === n
        ? (r = t[11])
        : ((r = (0, k.jsx)(`span`, { className: e, children: (0, k.jsx)(c, { className: n }) })),
          (t[10] = n),
          (t[11] = r)),
        (T = r));
    }
  ...
  t[12] === o
    ? (E = t[13])
    : ((E =
        o == null ? null : (0, k.jsx)(`span`, { className: `inline-flex shrink-0`, children: o })),
      (t[12] = o),
      (t[13] = E));
  let A;
  t[14] !== n ||
  ...
  t[20] !== x
    ? ((A =
        n != null || l != null
          ? (0, k.jsxs)(`span`, {
              className: f(
                v.externalFooterItemText,
                n != null && v.externalFooterItemTextWithCategoryLabel,
              ...
              children: [
                n == null
                  ...
                  : (0, k.jsx)(`span`, {
                      className: f(
                        v.externalFooterItemCategoryLabel,
                ...
                (0, k.jsx)(b, {
                  ...
                  children: (0, k.jsx)(`span`, {
                    ref: C,
                    className: f(
                      v.externalFooterItemValueContent,
                      `block max-w-full min-w-0 truncate`,
                      w && v.externalFooterItemValueOverflowing,
                    ),
...
var D,
  ...
  k,
  A = e(() => {
    ((D = s()), l(), (O = t(d(), 1)), o(), h(), m(), i(), n(), y(), _(), (k = g()));
  });
