...
import { Pc as y, el as b } from "./app-initial~app-main~onboarding-page.js";
import {
  Ax as x,
  Bp as S,
  Cb as C,
...
var Ae,
  ...
  Me,
  Ne = e(() => {
    (f(), x(), (Ae = new URL(h)), (je = `${Ae.pathname}/purchase/`), (Me = `3800100299`));
  });
function Pe(e) {
...
function He(e) {
  ...
  let s = n && !a && i != null,
    c;
  t[4] === i ? (c = t[5]) : ((c = async () => (i == null ? null : tt(i))), (t[4] = i), (t[5] = c));
  let u;
  return (
    t[6] !== o || t[7] !== s || t[8] !== c
      ? ((u = {
...
function Ke({ accountId: e, updatedPlan: t }) {
  return L.safePost(`/subscriptions/update`, { requestBody: { account_id: e, updated_plan: t } });
}
function qe({ accountId: e }) {
  return L.safePost(`/subscriptions/update/cancel_pending`, { requestBody: { account_id: e } });
}
function Je() {
  let e = (0, G.c)(16),
    t = o(ce),
  ...
  e[1] !== n || e[2] !== t
    ? ((i = {
        ...
        mutationFn: Ze,
        onSuccess: (e) => {
          Pe(e.immediate_top_up_status) || W({ scope: t, queryClient: n, response: e });
        },
      }),
      (e[1] = n),
      (e[2] = t),
  ...
  e[1] === r
    ...
    : ((i = [...vt, r, `save`]),
      (a = async (e) => {
        ...
        return L.safePatch(`/accounts/{account_id}/workspace_admin_requests/{request_id}`, {
...
function U(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = { queryConfig: { enabled: s, staleTime: m.ONE_MINUTE } }), (t[0] = s), (t[1] = c));
...
function W({ scope: e, queryClient: t, response: n }) {
  (t.setQueryData(dt, n), n.immediate_top_up_status === `succeeded` && e.query.invalidate(N));
}
function nt(e, t) {
...
function rt() {
  return L.safeGet(`/accounts/check/{version}`, { parameters: { path: { version: Ct } } });
}
function it(e) {
...
async function lt(e) {
  return L.safePost(`/accounts/send_add_credits_nudge_email`, { requestBody: e });
}
function ut(e) {
  return {
...
function Et(e, t) {
  return te(e, jt[t], { disableExposureLog: !1 }).get(`is_custom_checkout_enabled`, !1);
}
...
var jt,
  Mt = e(() => {
    (k(), be(), b(), w(), x(), (jt = { personal: `2336405413`, workspace: `3431030460` }));
  });
function Nt({ intl: e, amount: t, currencyCode: n, currencyFractionDigits: r }) {
...
function Rt(e) {
  return e.isEnabled ? (e.rechargeMonthlyLimit == null ? `` : K(e.rechargeMonthlyLimit)) : ``;
}
function zt(e) {
  let t = Jt(e);
  switch (t.kind) {
...
function Ht({ value: e, pricingInfo: t }) {
  ...
  switch (n.kind) {
    ...
    case `invalid`:
      return `not-whole-number`;
    case `valid`:
      return n.value < Vt(t) ? `below-minimum` : n.value % 250 == 0 ? null : `invalid-increment`;
  }
}
function Ut({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r }) {
  let i = Wt({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r });
  if (i == null) return null;
  let a = Math.round(i);
  return Math.abs(i - a) > 1e-6 ? null : String(a);
}
function Wt({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r }) {
  let i = K(e)
    .replaceAll(n, ``)
    .replaceAll(r, `.`)
    .replace(/[^\d.]/g, ``);
...
function tn({ intl: e, pricingInfo: t }) {
  return (
    an({ intl: e, amount: 0, pricingInfo: t })?.find((e) => e.type === `currency`)?.value ?? null
  );
}
...
function sn(e) {
  ...
  let C;
  t[20] !== g || t[21] !== S
    ? ((C = (0, q.jsxs)(`div`, { className: `grid grid-cols-4 gap-2`, children: [g, S] })),
      (t[20] = g),
      (t[21] = S),
      (t[22] = C))
    : (C = t[22]);
        ...
        : (0, q.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, q.jsx)(cn, {
                ...
                value: r,
                pricingInfo: a,
                placeholder: en({ intl: n, creditQuantity: s, pricingInfo: a }) ?? ``,
                hasError: o != null,
  ...
  t[33] !== o || t[34] !== s || t[35] !== c
    ? ((T =
        o == null ? null : (0, q.jsx)(ln, { fieldError: o, minimumQuantity: s, quantityStep: c })),
      (t[33] = o),
      (t[34] = s),
      (t[35] = c),
      (t[36] = T))
  ...
  return (
    t[37] !== w || t[38] !== T || t[39] !== C
      ? ((E = (0, q.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [C, w, T] })),
        (t[37] = w),
        (t[38] = T),
        (t[39] = C),
        (t[40] = E))
...
function cn(e) {
  ...
  if (t[0] !== p || t[1] !== n || t[2] !== i || t[3] !== f || t[4] !== r) {
    let e = f
      ? en({ intl: n, creditQuantity: Number.parseInt(K(r), 10), pricingInfo: i })
      : nn({ intl: n, creditQuantity: Number.parseInt(K(r), 10), pricingInfo: i });
    ((_ = p ?? e ?? r),
  ...
  return (
    t[35] !== D || t[36] !== T || t[37] !== E
      ? ((O = (0, q.jsxs)(`div`, { className: `relative`, children: [T, E, D] })),
        (t[35] = D),
        (t[36] = T),
        (t[37] = E),
        (t[38] = O))
...
function dn({ intl: e, value: t, pricingInfo: n }) {
  ...
  let { groupSeparator: i, decimalSeparator: a } = pn({ intl: e, pricingInfo: n });
  return Ut({ value: r, pricingInfo: n, groupSeparator: i, decimalSeparator: a });
}
function fn({ intl: e, value: t, pricingInfo: n }) {
  let r = t.trim();
  if (r.length === 0) return null;
  let { groupSeparator: i, decimalSeparator: a } = pn({ intl: e, pricingInfo: n });
  return Wt({ value: r, pricingInfo: n, groupSeparator: i, decimalSeparator: a });
}
...
function mn({ intl: e, value: t, pricingInfo: n }) {
  let { groupSeparator: r, decimalSeparator: i } = pn({ intl: e, pricingInfo: n }),
...
function vn(e) {
  ...
  t[12] === o
    ? (S = t[13])
    : ((S = o == null ? null : (0, J.jsx)(ln, { fieldError: o })), (t[12] = o), (t[13] = S));
  let C;
  t[14] !== x || t[15] !== S
    ? ((C = (0, J.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [v, x, S] })),
      (t[14] = x),
      (t[15] = S),
      (t[16] = C))
    : (C = t[16]);
  ...
  t[33] === s
    ? (A = t[34])
    : ((A = s == null ? null : (0, J.jsx)(ln, { fieldError: s })), (t[33] = s), (t[34] = A));
  let j;
  t[35] !== k || t[36] !== A
    ? ((j = (0, J.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [T, k, A] })),
      (t[35] = k),
      (t[36] = A),
      (t[37] = j))
    : (j = t[37]);
...
function xn(e) {
  let t = (0, Y.c)(39),
    { source: n, creditDetails: r, pricingInfo: i, onOpenChange: a, dialogDescriptionId: s } = e,
    c = o(ce),
    { email: l } = fe(),
    u = A(),
    d = oe(),
  ...
  t[10] !== r || t[11] !== d || t[12] !== i || t[13] !== M
    ? ((N = (0, Z.jsx)(Nn, { intl: d, creditDetails: r, pricingInfo: i, actions: M })),
      (t[10] = r),
      (t[11] = d),
      (t[12] = i),
      (t[13] = M),
  ...
  t[21] !== u
    ? ((P = () => {
        (_(!0),
          x ??
            Fn({ scope: c, source: n, email: l, quantity: f, onOpenChange: a, statsigClient: u }));
      }),
      (t[15] = l),
      (t[16] = a),
      (t[17] = f),
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ne = t[26]);
  let I;
  t[27] !== m || t[28] !== d || t[29] !== i || t[30] !== f || t[31] !== ee || t[32] !== F
    ? ((I = (0, Z.jsx)(Ce, {
...
function Cn(e) {
  ...
  let [k, j] = (0, X.useState)(O),
    N;
  t[6] !== g || t[7] !== r
    ? ((N = () => r !== `add-credits` || !T(g, `2317709095`)), (t[6] = g), (t[7] = r), (t[8] = N))
    : (N = t[8]);
  ...
  let we = Se,
    Te;
  t[15] !== ue || t[16] !== E
    ? ((Te = ue ? `invalid-currency-amount` : zt(E)), (t[15] = ue), (t[16] = E), (t[17] = Te))
    : (Te = t[17]);
  let Ee = Te,
    De;
  t[18] !== pe || t[19] !== k || t[20] !== b
    ? ((De = pe ? `invalid-currency-amount` : Gt({ monthlyLimit: k, targetBalance: b })),
      (t[18] = pe),
      (t[19] = k),
      (t[20] = b),
      (t[21] = De))
  ...
  let Oe = De,
    V,
    ke;
  t[22] !== ue || t[23] !== pe || t[24] !== E || t[25] !== k || t[26] !== i || t[27] !== b
    ? ((V = ue || pe ? null : Kt({ minimumBalance: E, targetBalance: b, monthlyLimit: k })),
  ...
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Fe = [`usage-settings`, `credit-reload`, `manage-payment`]), (t[31] = Fe))
    : (Fe = t[31]);
  let Ie;
  t[32] !== _ || t[33] !== m
    ? ((Ie = {
  ...
  t[50] !== l
    ? ((Re = async () => {
        if ((ne(!0), B)) {
          we ??
            Fn({ scope: m, source: n, email: h, quantity: b, onOpenChange: f, statsigClient: g });
          return;
        }
        if ((re(!0), ae(!0), !(H == null || z)))
          try {
            if ((Ne(), V == null)) return;
            let e = H === `enable` ? await c.mutateAsync(V) : await l.mutateAsync(V);
            if ((F(m, M, { action: H, source: n }), Pe(e.immediate_top_up_status))) {
              (ge(!0),
                ve(
                  rn({
                    intl: _,
  ...
  t[98] !== a || t[99] !== _ || t[100] !== s || t[101] !== Ke
    ? ((qe = (0, Z.jsx)(Nn, { intl: _, creditDetails: a, pricingInfo: s, actions: Ke })),
      (t[98] = a),
      (t[99] = _),
      (t[100] = s),
      (t[101] = Ke),
  ...
  t[141] !== U || t[142] !== tt || t[143] !== W
    ? ((nt = (0, Z.jsxs)(Ce, { className: `gap-4 pt-4`, children: [U, tt, W] })),
      (t[141] = U),
      (t[142] = tt),
      (t[143] = W),
      (t[144] = nt))
...
function On(e) {
  let t = (0, Y.c)(16),
    ...
    s;
  t[0] !== n || t[1] !== i || t[2] !== o
    ? ((s = nn({ intl: n, creditQuantity: Number.parseInt(K(i), 10), pricingInfo: o })),
      (t[0] = n),
      (t[1] = i),
      (t[2] = o),
      (t[3] = s))
  ...
  let c = s,
    l;
  t[4] !== n || t[5] !== o || t[6] !== r
    ? ((l = nn({ intl: n, creditQuantity: Number.parseInt(K(r), 10), pricingInfo: o })),
      (t[4] = n),
      (t[5] = o),
      (t[6] = r),
      (t[7] = l))
  ...
  let u = l,
    d;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((d = nn({ intl: n, creditQuantity: Number.parseInt(K(a), 10), pricingInfo: o })),
      (t[8] = n),
      (t[9] = a),
      (t[10] = o),
      (t[11] = d))
...
function kn(e) {
  ...
  t[6] === c
    ? (u = t[7])
    : ((u = c === `button` ? (0, Z.jsx)(jn, { children: (0, Z.jsx)(An, {}) }) : (0, Z.jsx)(An, {})),
      (t[6] = c),
      (t[7] = u));
  let d;
  return (
    t[8] !== l || t[9] !== u
      ? ((d = (0, Z.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [l, u] })),
        (t[8] = l),
        (t[9] = u),
        (t[10] = d))
      : (d = t[10]),
...
function Nn(e) {
  ...
  t[7] === a
    ? (l = t[8])
    : ((l = (0, Z.jsx)(`div`, { className: `shrink-0`, children: a })), (t[7] = a), (t[8] = l));
  let u;
  return (
    t[9] !== c || t[10] !== l
      ? ((u = (0, Z.jsxs)(`div`, {
...
function Pn({ intl: e, creditDetails: t, pricingInfo: n }) {
  return t == null || t.unlimited
    ? null
    : (nn({ intl: e, creditQuantity: Math.floor(Number(t.balance ?? 0)), pricingInfo: n }) ??
        e.formatNumber(0));
}
function Fn({ scope: e, source: t, email: n, quantity: r, onOpenChange: i, statsigClient: a }) {
  let o = K(r);
...
function Rn(e) {
  ...
  let p;
  t[7] !== o || t[8] !== a
    ? ((p = (0, Z.jsx)(De, { title: a, subtitle: o })), (t[7] = o), (t[8] = a), (t[9] = p))
    : (p = t[9]);
  let m;
  ...
  t[14] === s
    ? (h = t[15])
    : ((h = (0, Z.jsx)(Ce, { className: `pt-4`, children: s })), (t[14] = s), (t[15] = h));
  let g;
  return (
    t[16] !== l || t[17] !== u || t[18] !== m || t[19] !== h
      ? ((g = (0, Z.jsxs)(Oe, { as: `form`, onSubmit: u, children: [m, l, h] })),
        (t[16] = l),
        (t[17] = u),
        (t[18] = m),
        (t[19] = h),
...
function Un(e) {
  ...
  t[15] === n
    ? (s = t[16])
    : ((s = { "aria-describedby": n, onOpenAutoFocus: Wn }), (t[15] = n), (t[16] = s));
  let c;
  t[17] !== i || t[18] !== e
    ? ((c = (t) => {
...
function Gn(e) {
  ...
  return (
    t[23] !== _ || t[24] !== l || t[25] !== d || t[26] !== p
      ? ((v = (0, Q.jsxs)(Oe, { className: `gap-0 px-4 py-4`, children: [l, d, p, _] })),
        (t[23] = _),
        (t[24] = l),
        (t[25] = d),
        (t[26] = p),
    ...
    e[0] !== r || e[1] !== t || e[2] !== n
      ? ((i = (e) => {
          if (e.intent === `purchase` && e.isCustomCheckoutEnabled) {
            Ot(
              H({ loginHint: r, statsigClient: n, url: `${h}/purchase/credits?quantity=1000` }),
              e.event,
            );
            return;
          }
          ...
          if (Qn({ intent: e.intent, isCombinedModalEnabled: i }) === `combined-modal`) {
            (F(t, ie, { isAutoReloadEnabledAtOpen: e.isAutoReloadEnabled, source: e.source }),
              V(t, Yn, {
                source: e.source,
                variant: $n({ intent: e.intent, isAutoReloadEnabled: e.isAutoReloadEnabled }),
              }));
            return;
          }
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~new-thread-panel-page~appgen-library-page~hot~byb29nd9.js.map
