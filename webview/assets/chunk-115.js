import { i as e, r as t } from "./src-6.js";
import { h as n, o as r } from "./chunk-34.js";
import {
  B as i,
  C as a,
  V as o,
...
import { t as p } from "./chunk-25.js";
import { t as m } from "./chunk-64.js";
import { r as h } from "./chunk-7.js";
var g = (function () {
  ...
  pe = {
    ...
    draw: t(async function (t, r, i, a) {
      ...
      ((l.type = a.type),
        ...
        await h(l, d));
      try {
        (typeof a.db.getLinks == `function` ? a.db.getLinks() : new Map()).forEach((t, n) => {
      ...
      (n.insertTitle(d, `statediagramTitleText`, s?.titleTopMargin ?? 25, a.db.getDiagramTitle()),
    ...
    (e.trace(`items`, n),
      n.forEach((e) => {
        switch (e.stmt) {
          ...
          case C:
            {
              (X(t, e.state1, r, i, a, o, s, c), X(t, e.state2, r, i, a, o, s, c));
              let n = s === `neo`,
                l = {
                  id: `edge` + G,
                  start: e.state1.id,
...
var X = t((t, n, r, i, a, o, s, c) => {
    ...
    if ((e.info(`dataFetcher parsedItem`, n, f, m), l !== `root`)) {
      ...
      if (
        ...
        t &&
          t.id !== `root` &&
          (e.trace(`Setting node `, l, ` to be child of its parent `, t.id), (f.parentId = t.id)),
        (f.centerLabel = !0),
        n.note)
      ) {
        let e = {
    ...
    n.doc && (e.trace(`Adding nodes children `), me(n, n.doc, r, i, a, !o, s, c));
  }, `dataFetcher`),
  ge = t(() => {
    (W.clear(), (G = 0));
  }, `reset`),
  ...
  ve = class {
    ...
    getRootDocV2() {
      return (
        this.docTranslator({ id: S, stmt: S }, { id: S, stmt: S, doc: this.rootDoc }, !0),
        { id: S, doc: this.rootDoc }
      );
    }
    addState(t, n = D, r = void 0, i = void 0, a = void 0, o = void 0, s = void 0, c = void 0) {
      let l = t?.trim();
    ...
    addLink(t, n, r) {
      (this.links.set(t, { url: n, tooltip: r }), e.warn(`Adding link`, t, n, r));
    }
    getLinks() {
      return this.links;
    }
