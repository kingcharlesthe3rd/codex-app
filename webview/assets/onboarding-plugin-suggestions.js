...
import { _x as t, yx as n } from "./app-initial~app-main~new-thread-panel-page.js";
import { ar as r, ir as i } from "./app-initial~app-main~automations-page.js";
function a(e) {
...
function c({ roles: e, promptsByRole: t, limit: n = l }) {
  ...
  for (let [e, t] of r.entries()) {
    let r = t[i[e]];
    if (((i[e] += 1), !(!r || s.has(r)) && (s.add(r), a.push(r), a.length >= n))) return a;
  }
  for (; a.length < n;) {
    let e = !1;
    for (let t = 0; t < r.length; t += 1) {
      let o = r[t][i[t]];
      if (((i[t] += 1), !(!o || s.has(o)) && (s.add(o), a.push(o), (e = !0), a.length >= n))) break;
    }
    if (!e) break;
  }
  return a;
...
function p({ intl: e, mailProvider: t, plan: n = null, plugins: r = [], roles: a }) {
