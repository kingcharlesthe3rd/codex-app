...
import { Hi as t, Vi as n, qi as r } from "./src-C.js";
...
import { U as s, Z as c, wt as l } from "./setting-storage.js";
import { f as u } from "./chunk-8.js";
...
import { t as p } from "./file-kind.js";
...
import "./minus.js";
import "./search.js";
import { a as m } from "./mcp-capability-signals.js";
import "./dropdown.js";
import "./chevron.js";
import "./macbook.js";
import "./worktree.js";
...
import { n as g, t as _ } from "./mcp-capability-file-viewer-frame.js";
...
var v = l(),
  ...
  C = t({ filePath: r(), contents: r(), line: n().optional(), column: n().optional() });
function w(e) {
...
function T() {
  let e = (0, v.c)(20),
    ...
    n = c(m),
    r;
  e[0] === t.state ? (r = e[1]) : ((r = w(t.state) ? t.state : null), (e[0] = t.state), (e[1] = r));
  let i = r;
  if (!i) {
    let t;
    return (
      e[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, x.jsx)(`div`, { className: `h-full` })), (e[2] = t))
        : (t = e[2]),
      t
    );
  }
...
`,
  ...
  e[6] !== n || e[7] !== i.filePath
    ? ((l = g(i.filePath, n)), (e[6] = n), (e[7] = i.filePath), (e[8] = l))
    : (l = e[8]);
  let d = l;
  if (d != null) {
    let t;
    return (
      e[9] !== d || e[10] !== o || e[11] !== i.filePath
        ? ((t = (0, x.jsx)(E, { contents: o, filePath: i.filePath, fileViewer: d })),
          (e[9] = d),
          (e[10] = o),
          (e[11] = i.filePath),
          (e[12] = t))
  ...
  if ((0, y.lookup)(i.filePath) === `application/pdf`) {
    let t;
    return (
  ...
  if (p(i.filePath)) {
    ...
    e[14] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, x.jsx)(`div`, { className: `h-full bg-token-main-surface-primary` })),
        (e[14] = t))
      : (t = e[14]);
    let n;
    return (
      e[15] !== o || e[16] !== i.filePath
        ? ((n = (0, x.jsx)(b.Suspense, {
            fallback: t,
            children: (0, x.jsx)(S, { contents: o, filePath: i.filePath }),
          })),
          (e[15] = o),
          (e[16] = i.filePath),
          (e[17] = n))
  ...
  let f;
  return (
    e[18] === o ? (f = e[19]) : ((f = (0, x.jsx)(D, { contents: o })), (e[18] = o), (e[19] = f)), f
  );
}
function E(e) {
  let t = (0, v.c)(21),
    { contents: n, filePath: r, fileViewer: i } = e,
    [a, o] = (0, b.useState)(!0),
    c = a ? `secondary` : `ghost`,
    l;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((l = () => o(!0)), (t[0] = l)) : (l = t[0]);
  let u;
  ...
  let p = !a,
    m = a ? `ghost` : `secondary`,
    h;
  t[5] === Symbol.for(`react.memo_cache_sentinel`) ? ((h = () => o(!1)), (t[5] = h)) : (h = t[5]);
  let g;
    ...
    ? ((C = (0, x.jsx)(`div`, {
        ...
        children: a
          ? (0, x.jsx)(_, {
              ...
              filePath: r,
              fileViewer: i,
              readResourceText: async () => n,
            })
          : (0, x.jsx)(D, { contents: n }),
      })),
      (t[13] = n),
      (t[14] = r),
      (t[15] = i),
