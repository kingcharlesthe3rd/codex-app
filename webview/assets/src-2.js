...
var n = e(() => {}),
  ...
  a,
  o = e(() => {
    (n(), (a = t(`4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab`)));
  }),
  s = e(() => {
    (i(), o());
  });
...
var S = e(() => {});
function C(e) {
  for (var t = this, n = w(t, e), r = [t]; t !== n; ) ((t = t.parent), r.push(t));
...
var j = e(() => {});
function M(e, t) {
  e instanceof Map ? ((e = [void 0, e]), t === void 0 && (t = F)) : t === void 0 && (t = P);
  for (var n = new R(e), r, i = [n], a, o, s, c; (r = i.pop()); )
    if ((o = t(r.data)) && (c = (o = Array.from(o)).length))
      for (r.children = o, s = c - 1; s >= 0; --s)
        (i.push((a = o[s] = new R(o[s]))), (a.parent = r), (a.depth = r.depth + 1));
...
function Y() {
  ...
  function i(i) {
    var o = i.height + 1;
    return (
      (i.x0 = i.y0 = n), (i.x1 = e), (i.y1 = t / o), i.eachBefore(a(t, o)), r && i.eachBefore(G), i
    );
  }
  function a(e, t) {
    return function (r) {
      r.children && q(r, r.x0, (e * (r.depth + 1)) / t, r.x1, (e * (r.depth + 2)) / t);
      var i = r.x0,
        a = r.y0,
        o = r.x1 - n,
        s = r.y1 - n;
...
function ce() {
  ...
  function u(e) {
    return (
      (e.x0 = e.y0 = 0), (e.x1 = n), (e.y1 = r), e.eachBefore(d), (i = [0]), t && e.eachBefore(G), e
    );
  }
  function d(t) {
    var n = i[t.depth],
  ...
  return (
    ...
    (u.paddingInner = function (e) {
      return arguments.length ? ((a = typeof e == `function` ? e : U(+e)), u) : a;
    }),
    ...
    (u.paddingTop = function (e) {
      return arguments.length ? ((o = typeof e == `function` ? e : U(+e)), u) : o;
    }),
    (u.paddingRight = function (e) {
      return arguments.length ? ((s = typeof e == `function` ? e : U(+e)), u) : s;
    }),
    (u.paddingBottom = function (e) {
      return arguments.length ? ((c = typeof e == `function` ? e : U(+e)), u) : c;
    }),
    (u.paddingLeft = function (e) {
      return arguments.length ? ((l = typeof e == `function` ? e : U(+e)), u) : l;
    }),
    u
  );
}
