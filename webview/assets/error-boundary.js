...
import { R as r, c as i, h as a, s as o, t as s } from "./app-scope.js";
import { _s as c, vs as l, ys as u } from "./app-server-manager-signals.js";
import { m as d } from "./vscode-api.js";
import { F as f, N as p, P as m, Yr as h } from "./src-1.js";
import { o as g } from "./lib.js";
import { t as ee } from "./button-DO-oxX3-.js";
import { t as te } from "./spinner.js";
import { n as ne } from "./rpc-1.js";
import { m as re } from "./chunk-109.js";
...
function dt(e) {
  if (He(e)) return { message: e.message, name: e.name, stack: e.stack, ...pt(e) };
  if (Xe(e)) {
    let t = { type: e.type, target: ft(e.target), currentTarget: ft(e.currentTarget), ...pt(e) };
    return (typeof CustomEvent < `u` && tt(e, CustomEvent) && (t.detail = e.detail), t);
  } else return e;
}
function ft(e) {
  try {
...
var Za = class {
  ...
  captureEvent(e, t, n) {
    let r = k();
    if (t?.originalException && Et(t.originalException)) return (_ && S.log(Va), r);
    let i = { event_id: r, ...t },
  ...
  _captureEvent(e, t = {}, n = P(), r = F()) {
    return (
      _ && to(e) && S.log(`Captured error event \`${Ra(e)[0] || `<unknown>`}\``),
      this._processEvent(e, t, n, r).then(
        (e) => e.event_id,
        (e) => {
          _ && (Ya(e) ? S.log(e.message) : Ja(e) ? S.warn(e.message) : S.warn(e));
        },
      )
    );
  }
    ...
    return {
      ...
      processEvent(t) {
        ...
        try {
          if (Yo(t, e))
            return (
              _ && S.warn(`Event dropped due to being a duplicate of previously captured event.`),
              null
            );
        } catch {}
        return (e = t);
  ...
  sf = (e = {}) => {
    ...
    return {
      ...
      afterAllSetup(e) {
        let n = st();
        if (
          (_ !== `off` && $d(e, { linkPreviousTrace: _, consistentTraceSampling: ce }), K.location)
        ) {
          if (ae) {
            let t = j();
            cf(e, {
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      return (
        t[4] === e
          ? (a = t[5])
          : ((a = (0, $.jsxs)(ee, { onClick: e, children: [n, i] })), (t[4] = e), (t[5] = a)),
        a
      );
    }
    case `ready`: {
...
function Yf(e) {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(se, { electron: !0, children: (0, $.jsx)(Vf, {}) })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
    ? ((s = () => {
