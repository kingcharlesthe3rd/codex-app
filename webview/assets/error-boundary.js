...
import { A as t, M as n, j as r, mi as i } from "./src-2.js";
import { Jo as a, Ko as o, qo as s } from "./app-server-manager-signals.js";
import { n as c, t as l } from "./jsx-runtime.js";
import { I as u, W as d, f, g as p, h as m, lt as h } from "./vscode-api.js";
...
function oi({ parentSpan: e, spanArguments: t, forceTransaction: n, scope: r }) {
  if (!U()) {
    let r = new yr();
    return (
      (n || !e) && hr(r, { sampled: `false`, sample_rate: `0`, transaction: t.name, ...vr(r) }), r
    );
  }
  let i = F(),
    a;
