...
import { A as t, M as n, _i as r, j as i } from "./src-2.js";
import { Qo as a, Xo as o, Zo as s } from "./app-server-manager-signals.js";
import { n as c, t as l } from "./jsx-runtime.js";
import { I as u, L as d, W as f, g as p, h as m, lt as h } from "./vscode-api.js";
import { o as g } from "./lib-2.js";
import { m as ee } from "./chunk-12.js";
...
import { t as ae } from "./download.js";
...
function ce(e) {
  ...
  return ((t.version = t.version || `10.29.0`), (t[se] = t[`10.29.0`] || {}));
}
function le(e, t, n = y) {
...
var S = { enable: pe, disable: me, isEnabled: he, log: ge, warn: _e, error: ve },
  xe = 50,
  Se = /\(error: (.*)\)/,
...
function dt(e) {
  try {
    return Ze(e) ? D(e) : Object.prototype.toString.call(e);
  } catch {
    return `<unknown>`;
  }
}
...
function gt(e, t, n = !1) {
  return T(e) ? (Qe(t) ? t.test(e) : T(t) ? (n ? e === t : e.includes(t)) : !1) : !1;
}
function _t(e, t = [], n = !1) {
...
function Pt(e, t = {}) {
  if (
    ...
    t.sid && (e.sid = t.sid.length === 32 ? t.sid : A()),
  ...
  Ut = class e {
    constructor() {
      ((this._notifyingListeners = !1),
        ...
        (this._propagationContext = { traceId: Rt(), sampleRand: Math.random() }));
    }
    clone() {
      let t = new e();
      return (
    ...
    clear() {
      return (
        ...
        Bt(this, void 0),
        (this._attachments = []),
        this.setPropagationContext({ traceId: Rt(), sampleRand: Math.random() }),
        this._notifyScopeListeners(),
        this
      );
    }
    ...
    captureException(e, t) {
      let n = t?.event_id || A();
      if (!this._client)
        return (v && S.warn(`No client configured on scope - will not capture exception!`), n);
    ...
    captureMessage(e, t, n) {
      let r = n?.event_id || A();
      if (!this._client)
        return (v && S.warn(`No client configured on scope - will not capture message!`), r);
    ...
    captureEvent(e, t) {
      ...
      return this._client
        ...
        : (v && S.warn(`No client configured on scope - will not capture event!`), n);
    }
...
function Wt() {
  return le(`defaultCurrentScope`, () => new Ut());
}
function Gt() {
  return le(`defaultIsolationScope`, () => new Ut());
}
var Kt = class {
  constructor(e, t) {
    let n;
    n = e || new Ut();
    let r;
    ((r = t || new Ut()), (this._stack = [{ scope: n }]), (this._isolationScope = r));
  }
  withScope(e) {
...
function P() {
  return Qt(b()).getCurrentScope();
}
function F() {
  return Qt(b()).getIsolationScope();
}
function $t() {
  return le(`globalScope`, () => new Ut());
}
function en(...e) {
  let t = Qt(b());
  if (e.length === 2) {
...
function Cn(e) {
  if (e) return En(Object.entries(e).reduce((e, [t, n]) => (n && (e[`${bn}${t}`] = n), e), {}));
}
function wn(e) {
...
function jn(e) {
  ...
  return Mn({ host: a, pass: i, path: c, projectId: l, port: o, protocol: n, publicKey: r });
}
function Mn(e) {
  return {
    protocol: e.protocol,
...
function Bn(e, t) {
  let n = zn(e),
    r = Sn(t);
  if (!n?.traceId) return { traceId: Rt(), sampleRand: Math.random() };
  let i = Un(n, r);
...
function Vn(e = Rt(), t = N(), n) {
  let r = ``;
  return (n !== void 0 && (r = n ? `-1` : `-0`), `${e}-${t}${r}`);
}
function Hn(e = Rt(), t = N(), n) {
...
var nr = `_sentryChildSpans`,
  rr = `_sentryRootSpan`;
function ir(e, t) {
  (k(t, rr, e[rr] || e), e[nr] ? e[nr].add(t) : k(e, nr, new Set([t])));
}
function ar(e, t) {
  e[nr] && e[nr].delete(t);
}
...
var br = class {
  constructor(e = {}) {
    ((this._traceId = e.traceId || Rt()), (this._spanId = e.spanId || N()));
  }
  spanContext() {
...
function Vr(e, t, n, r) {
  let i = Rr(n);
  return Or(
    { sent_at: new Date().toISOString(), ...(i && { sdk: i }), ...(!!r && t && { dsn: An(t) }) },
...
function Kr(e, t, n, r = H()) {
  let i = r && V(r);
  i &&
    (v && S.log(`[Measurement] Setting measurement on root span: ${e} = ${t} ${n}`),
...
var Jr = 1e3,
  Yr = class {
    ...
    _convertSpanToTransaction() {
      if (!Zr(B(this))) return;
      this._name ||=
        (v && S.warn("Transaction has no name, falling back to `<unlabeled transaction>`."),
      ...
      let a = {
          ...
          spans:
            r.length > Jr
              ? r.sort((e, t) => e.start_timestamp - t.start_timestamp).slice(0, Jr)
              : r,
          start_timestamp: this._startTime,
          timestamp: this._endTime,
    ...
    pi(a)(() => {
      let n = P(),
        ...
        s =
          e.onlyIfParent && !o
            ? new br()
            : si({ parentSpan: o, spanArguments: r, forceTransaction: i, scope: n });
      return (
        Bt(n, s),
        ei(
          () => t(s),
...
function ai(e) {
  ...
  return (e.scope ? (t) => en(e.scope, t) : i === void 0 ? (e) => e() : (e) => oi(i, e))(() => {
    let t = P(),
      a = fi(t, i);
...
function oi(e, t) {
  let n = li();
  return n.withActiveSpan ? n.withActiveSpan(e, t) : en((n) => (Bt(n, e || void 0), t(n)));
}
function si({ parentSpan: e, spanArguments: t, forceTransaction: n, scope: r }) {
  if (!U()) {
    let r = new br();
    return (
      (n || !e) && gr(r, { sampled: `false`, sample_rate: `0`, transaction: t.name, ...yr(r) }), r
    );
  }
  let i = F(),
    a;
...
function ui(e, t, n) {
  ...
  let s = o.parentSampled ?? n,
    ...
    [u, d, f] = t.getScopeData().sdkProcessingMetadata[ri]
      ...
      : ni(
          i,
          { name: a, parentSampled: s, attributes: c, parentSampleRate: Ln(l.dsc?.sample_rate) },
          l.sampleRand,
        ),
    p = new Yr({
      ...e,
  ...
  return (
    !u &&
      r &&
      (v && S.log(`[Tracing] Discarding root span because its trace was not chosen to be sampled.`),
...
function di(e, t, n) {
  let { spanId: r, traceId: i } = e.spanContext(),
    ...
    o = a ? new Yr({ ...n, parentSpanId: r, traceId: i, sampled: a }) : new br({ traceId: i });
  ir(e, o);
  let s = I();
...
function yi(e, t = {}) {
    ...
    apply(e, t, n) {
      ...
      let c = p.getOptions().ignoreSpans,
        u = o?.reduce(
          (e, t) => {
            let n = B(t);
            return !n.timestamp || (c && dr(n, c)) ? e : e ? Math.max(e, n.timestamp) : n.timestamp;
          },
          void 0,
        ),
        m = s.start_timestamp,
  ...
  function ne(e) {
    (ee(), n.set(e, !0), _(j() + u / 1e3));
  }
  function re(e) {
    (n.has(e) && n.delete(e), n.size === 0 && te(j() + c / 1e3));
  }
  function ie(e) {
    ...
    (u.forEach((t) => {
      t.isRecording() &&
        ...
        t.end(e),
        v &&
          S.log(`[Tracing] Cancelling span since span ended early`, JSON.stringify(t, void 0, 2)));
      ...
      if (v) {
        ...
        i
          ? o ||
            S.log(`[Tracing] Discarding span since it finished after idle span final timeout`, e)
          : S.log(`[Tracing] Discarding span since it happened after idle span was finished`, e);
      }
      (!o || !i) && (ar(g, t), d++);
    }),
  ...
  return (
    s.push(
      p.on(`spanStart`, (e) => {
        r ||
          ...
          (or(g).includes(e) && ne(e.spanContext().spanId));
      }),
    ),
    s.push(
      p.on(`spanEnd`, (e) => {
    ...
    setTimeout(() => {
      r || (g.setStatus({ code: 2, message: `deadline_exceeded` }), (a = _i), g.end());
    }, l),
    g
  );
}
function bi(e) {
  let t = ai(e);
  return (Bt(P(), t), v && S.log(`[Tracing] Started span is an idle span`), t);
}
var xi = 0,
  Si = 1,
  Ci = 2;
...
var Ei = class e {
  ...
  _executeHandlers() {
    ...
    ((this._handlers = []),
      e.forEach((e) => {
        e[0] ||=
          (this._state === Si && e[1](this._value), this._state === Ci && e[2](this._value), !0);
      }));
  }
  _runExecutor(e) {
    let t = (e, t) => {
...
function Fi(e, t) {
  ((e.contexts = { trace: Kn(t), ...e.contexts }),
    (e.sdkProcessingMetadata = { dynamicSamplingContext: yr(t), ...e.sdkProcessingMetadata }));
...
function Hi(e, t, n, r, i, a) {
  let { normalizeDepth: o = 3, normalizeMaxBreadth: s = 1e3 } = e,
    c = { ...t, event_id: t.event_id || n.event_id || A(), timestamp: t.timestamp || Ot() },
...
var Zi = [`user`, `level`, `extra`, `contexts`, `tags`, `fingerprint`, `propagationContext`];
function Qi(e) {
...
function ia(e) {
  let t = F(),
    ...
    a = t.getSession();
  return (a?.status === `ok` && Pt(a, { status: `exited` }), aa(), t.setSession(i), i);
}
function aa() {
  let e = F(),
    t = P().getSession() || e.getSession();
  (t && Ft(t), oa(), e.setSession());
}
function oa() {
  let e = F(),
    t = I(),
...
function va(e, t, n) {
  if (n[t.name]) {
    v && S.log(`Integration skipped because it was already installed: ${t.name}`);
    return;
  }
  if (
    ((n[t.name] = t),
    !pa.includes(t.name) && typeof t.setupOnce == `function` && (t.setupOnce(), pa.push(t.name)),
        ...
        t({ body: Mr(o) }).then(
          (e) => (
            e.statusCode !== void 0 &&
              ...
              v &&
              S.warn(`Sentry responded with status code ${e.statusCode} to sent event.`),
            (r = Fa(r, e)),
            e
          ),
          (e) => {
            throw (
              s(`network_error`), v && S.error(`Encountered error running transport request:`, e), e
            );
          },
        ),
      )
...
var Za = class {
  ...
  captureEvent(e, t, n) {
    let r = A();
    if (t?.originalException && Tt(t.originalException)) return (v && S.log(Va), r);
    let i = { event_id: r, ...t },
  ...
  recordDroppedEvent(e, t, n = 1) {
    if (this._options.sendClientReports) {
      let r = `${e}:${t}`;
      (v && S.log(`Recording outcome: "${r}"${n > 1 ? ` (${n} times)` : ``}`),
  ...
  _captureEvent(e, t = {}, n = P(), r = F()) {
    return (
      v && to(e) && S.log(`Captured error event \`${Ra(e)[0] || `<unknown>`}\``),
      this._processEvent(e, t, n, r).then(
        (e) => e.event_id,
        (e) => {
          v && (Ya(e) ? S.log(e.message) : Ja(e) ? S.warn(e.message) : S.warn(e));
        },
      )
    );
  }
  _processEvent(e, t, n, r) {
    ...
    return this._prepareEvent(e, t, n, r)
      .then((e) => {
        ...
        return t.data && t.data.__sentry__ === !0 ? e : $a(eo(this, i, e, t), c);
      })
      .then((i) => {
        if (i === null) {
  ...
  _process(e, t) {
    (this._numProcessing++,
      this._promiseBuffer.add(e).then(
        ...
        (e) => (this._numProcessing--, e === ka && this.recordDroppedEvent(`queue_overflow`, t), e),
      ));
  }
  _clearOutcomes() {
...
function ao(e) {
  ...
  return (
    Object.values(e).forEach((e) => {
      Array.isArray(e) ? (t += e.length * oo(e[0])) : Je(e) ? (t += oo(e)) : (t += 100);
    }),
    t
  );
}
...
function _o(e, t, n = [t], r = `npm`) {
  ...
  ((i.sdk ||= {
    ...
    packages: n.map((e) => ({ name: `${r}:@sentry/${e}`, version: se })),
    version: se,
  }),
    (e._metadata = i));
}
function vo(e = {}) {
  ...
  let r = e.scope || P(),
    ...
    a = i ? qn(i) : yo(r),
    o = Cn(i ? yr(i) : vr(t, r));
  if (!Rn.test(a)) return (S.warn(`Invalid sentry-trace data. Cannot generate trace data`), {});
...
function No(e, t) {
  return t?.length ? Ra(e).some((e) => _t(e, t)) : !1;
}
function Po(e, t) {
...
function Ro(e) {
  try {
    ...
    return (v && S.error(`Cannot extract url for event ${St(e)}`), null);
  }
}
function zo(e) {
...
function Bo(e, t, n, r, i, a) {
  ...
  o && (i.exception.values = Vo(e, t, r, a.originalException, n, i.exception.values, o, 0));
}
    ...
    Array.isArray(r.errors) &&
      r.errors.forEach((r, a) => {
        if (E(r, Error)) {
          ...
          let l = e(t, r),
            u = c.length;
          (Uo(l, `errors[${a}]`, u, s), (c = Vo(e, t, n, r, i, [l, ...c], l, u)));
        }
      }),
    c
  );
...
function Go() {
  `console` in y &&
    ue.forEach(function (e) {
      e in y.console &&
        O(y.console, e, function (t) {
          return (
            (fe[e] = t),
            function (...t) {
              (w(`console`, { args: t, level: e }), fe[e]?.apply(y.console, t));
            }
          );
        });
    });
    ...
    return {
      ...
      processEvent(t) {
        ...
        try {
          if (Yo(t, e))
            return (
              v && S.warn(`Event dropped due to being a duplicate of previously captured event.`),
              null
            );
        } catch {}
        return (e = t);
...
function Xo(e, t) {
  let n = e.message,
    r = t.message;
  return !((!n && !r) || (n && !r) || (!n && r) || n !== r || !$o(e, t) || !Qo(e, t));
}
function Zo(e, t) {
  let n = es(t),
    r = es(e);
  return !(!n || !r || n.type !== r.type || n.value !== r.value || !$o(e, t) || !Qo(e, t));
}
function Qo(e, t) {
  let n = ke(e),
    r = ke(t);
    ...
    O(y, `fetch`, function (t) {
      return function (...n) {
        ...
        return (
          e || w(`fetch`, { ...o }),
          t.apply(y, n).then(
            async (t) => (e ? e(t) : w(`fetch`, { ...o, endTimestamp: j() * 1e3, response: t }), t),
            (e) => {
              if (
                (w(`fetch`, { ...o, endTimestamp: j() * 1e3, error: e }),
                He(e) && e.stack === void 0 && ((e.stack = r.stack), k(e, `framesToPop`, 1)),
...
function ys(e) {
  ...
  vs(t, () => {
    w(`fetch-body-resolved`, { endTimestamp: j() * 1e3, response: e });
  });
}
function bs(e, t) {
...
function Ss(e) {
  ...
  if (e.length === 2) {
    let [t, n] = e;
    return { url: xs(t), method: bs(n, `method`) ? String(n.method).toUpperCase() : `GET` };
  }
  let t = e[0];
  return { url: xs(t), method: bs(t, `method`) ? String(t.method).toUpperCase() : `GET` };
}
function Cs(e) {
  let [t, n] = e;
  try {
...
function Is(e) {
  ...
  {
    S.log(`IPC was not configured in preload script, falling back to custom protocol and fetch`);
    let e = (window.__SENTRY_RENDERER_ID__ = A()),
      n = { [Fs]: e };
    return {
      sendRendererStart: () => {
...
function Hs(e, t = {}) {
  ...
  (ct(r, e), k(e, `__sentry_wrapped__`, r));
  try {
...
function ec(e, t, n, r) {
  ...
  return (wt(i), (i.level = `error`), n?.event_id && (i.event_id = n.event_id), wi(i));
}
...
function nc(e, t, n, r, i) {
  ...
  return He(t)
    ? Ks(e, t)
    : Ye(t) || Xe(t)
      ? ((a = Gs(e, t, n, i)), wt(a, { synthetic: !0 }), a)
      : ((a = rc(e, t, n, r)), Ct(a, `${t}`, void 0), wt(a, { synthetic: !0 }), a);
}
function rc(e, t, n, r) {
  let i = {};
  if (r && n) {
...
var sc = class extends Za {
  ...
  eventFromMessage(e, t = `info`, n) {
    return tc(this._options.stackParser, e, t, n, this._options.attachStacktrace);
  }
  _prepareEvent(e, t, n, r) {
  ...
  dc = (e, t, n, r) => {
    ...
    return (o) => {
      t.value >= 0 &&
        (o || r) &&
        ((a = t.value - (i ?? 0)),
        (a || i === void 0) && ((i = t.value), (t.delta = a), (t.rating = uc(t.value, n)), e(t)));
    };
  },
  fc = (e = !0) => {
...
var gc = -1,
  _c = new Set(),
  vc = () => (q.document?.visibilityState === `hidden` && !q.document?.prerendering ? 0 : 1 / 0),
  yc = (e) => {
    if (xc(e) && gc > -1) {
      if (e.type === `visibilitychange` || e.type === `pagehide`) for (let e of _c) e();
      isFinite(gc) ||
        ((gc = e.type === `visibilitychange` ? e.timeStamp : 0), hc(`prerenderingchange`, yc, !0));
    }
  },
  bc = () => {
    if (q.document && gc < 0) {
      ...
      ((gc =
        (q.document.prerendering
          ...
          : globalThis.performance
              ...
              .filter((t) => t.name === `hidden` && t.startTime > e)[0]?.startTime) ?? vc()),
...
var Sc = () => `v5-${Date.now()}-${Math.floor(Math.random() * 8999999999999) + 0xe8d4a51000}`,
  Cc = (e, t = -1) => {
    let n = fc(),
      r = `navigate`;
    return (
      ...
      { name: e, value: t, rating: `good`, delta: 0, entries: [], id: Sc(), navigationType: r }
    );
  },
  wc = new WeakMap();
function Tc(e, t) {
...
var Ec = class e {
          ...
          for (let t of e)
            t.name === `first-contentful-paint` &&
              ...
              t.startTime < n.firstHiddenTime &&
                ((r.value = Math.max(t.startTime - pc(), 0)), r.entries.push(t), i(!0)));
        });
  ...
  Bc = () => {
    `interactionCount` in performance ||
      Rc ||
      (Rc = Dc(`event`, Lc, { type: `event`, buffered: !0, durationThreshold: 0 }));
  },
  Vc = 10,
  Hc = 0,
  Uc = () => zc() - Hc,
  Wc = class e {
    ...
    _resetInteractions() {
      ((Hc = zc()), (this._longestInteractionList.length = 0), this._longestInteractionMap.clear());
    }
    _estimateP98LongestInteraction() {
      let e = Math.min(this._longestInteractionList.length - 1, Math.floor(Uc() / 50));
    ...
    _processEntry(e) {
      ...
      if (n || this._longestInteractionList.length < Vc || e.duration > t._latency) {
        if (
          (n
  ...
  Qc = (e, t = {}) => {
    kc(() => {
      let n = bc(),
        ...
        o = (e) => {
          ...
          for (let t of e)
            (a._processEntry(t),
              t.startTime < n.firstHiddenTime &&
                ((r.value = Math.max(t.startTime - pc(), 0)), (r.entries = [t]), i()));
        },
      ...
      if (s) {
        ...
        for (let e of [`keydown`, `click`, `visibilitychange`]) mc(e, a, { capture: !0 });
      }
    });
  },
  $c = [800, 1800],
  ...
  tl = (e, t = {}) => {
    ...
    el(() => {
      let e = fc();
      e && ((n.value = Math.max(e.responseStart - pc(), 0)), (n.entries = [e]), r(!0));
    });
  },
  nl = {},
  rl = {},
...
function vl(e, t, n, r, i = !1) {
  bl(e, t);
  let a;
  return (rl[e] || ((a = n()), (rl[e] = !0)), r && t({ metric: r }), xl(e, t, i ? a : void 0));
}
function yl(e) {
  let t = {};
...
function jl(e, t, n, r) {
  ...
  let i = t ? J((M() || 0) + t.startTime) : j(),
    a = P().getScopeData().transactionName,
    o = t ? D(t.sources[0]?.node) : `Layout shift`,
    s = {
...
function Nl(e, t, n, r) {
  ...
  let i = J((M() || 0) + (t?.startTime || 0)),
    a = P().getScopeData().transactionName,
    o = t ? D(t.element) : `Largest contentful paint`,
    s = {
  ...
  t &&
    (t.element && (s[`lcp.element`] = D(t.element)),
    t.id && (s[`lcp.id`] = t.id),
...
var Il = 2147483647,
  ...
  Z,
  Rl;
function zl({ recordClsStandaloneSpans: e, recordLcpStandaloneSpans: t, client: n }) {
  let r = El();
  if (r && M()) {
...
function Jl(e, t, n, r, i, a) {
  if (ql(t) || ([`mark`, `measure`].includes(t.entryType) && _t(t.name, a))) return;
  let o = fc(!1),
...
function eu(e, t, n, r, i, a, o) {
  ...
  let u = { ...c, ...Pl(t) },
    d = a + r;
  wl(e, d, d + i, { name: n.replace(q.location.origin, ``), op: s, attributes: u });
}
function tu(e) {
  let t = q.navigator;
  if (!t) return;
  ...
  (n &&
    ...
    Cl(t.deviceMemory) && e.setAttribute(`deviceMemory`, `${t.deviceMemory} GB`),
...
function nu(e, t) {
  (Z &&
    ...
    (Z.element && e.setAttribute(`lcp.element`, D(Z.element)),
    ...
    Rl?.sources &&
      ...
      Rl.sources.forEach((t, n) => e.setAttribute(`cls.source.${n + 1}`, D(t.node))));
}
function ru(e, t, n) {
  n.forEach(([n, r]) => {
    let i = e[n];
    i != null && ((typeof i == `number` && i < Il) || typeof i == `string`) && (t[r] = i);
  });
}
function iu(e) {
  let t = fc(!1);
...
function au() {
  return El() && M() ? fl(`element`, ou) : () => void 0;
}
var ou = ({ entries: e }) => {
    let t = H(),
      n = t ? V(t) : void 0,
    ...
    e.forEach((e) => {
      ...
      let n = t.name,
        i = t.renderTime,
        a = t.loadTime,
        [o, s] = a ? [J(a), `load-time`] : i ? [J(i), `render-time`] : [j(), `entry-emission`],
  ...
  (q.document.addEventListener(`click`, t, !1),
    ...
    [`EventTarget`, `Node`].forEach((t) => {
      ...
      n?.hasOwnProperty?.(`addEventListener`) &&
        (O(n, `addEventListener`, function (t) {
...
function hu(e, t = !1) {
  return (n) => {
    ...
    (k(n, `_sentryCaptured`, !0), r && !r._sentryId && k(r, `_sentryId`, A()));
    let i = n.type === `keypress` ? `input` : n.type;
    (pu(n) || (e({ event: n, name: i, global: t }), (lu = n.type), (uu = r ? r._sentryId : void 0)),
      clearTimeout(cu),
      (cu = q.setTimeout(() => {
        ((uu = void 0), (lu = void 0));
      }, su)));
...
function yu() {
  ...
  (O(q.history, `pushState`, e), O(q.history, `replaceState`, e));
}
function bu(e) {
  try {
...
function Su(e) {
  ...
  if (r && typeof r.createElement == `function`)
    try {
      ...
      lc && S.warn(`Could not create sandbox iframe for ${e} check, bailing to window.${e}: `, t);
    }
    ...
    apply(e, t, n) {
      ...
      let s = () => {
        ...
        if (e && t.readyState === 4) {
          ...
          w(`xhr`, { endTimestamp: j() * 1e3, startTimestamp: i, xhr: t, virtualError: r });
        }
      };
      return (
        ...
        (t.setRequestHeader = new Proxy(t.setRequestHeader, {
          apply(e, t, n) {
            let [r, i] = n,
              a = t[wu];
            return (a && T(r) && T(i) && (a.request_headers[r.toLowerCase()] = i), e.apply(t, n));
          },
        })),
        e.apply(t, n)
      );
      ...
      apply(e, t, n) {
        ...
        return r
          ? (n[0] !== void 0 && (r.body = n[0]),
            w(`xhr`, { startTimestamp: j() * 1e3, xhr: t }),
            e.apply(t, n))
          : e.apply(t, n);
      },
    })));
...
var Iu = ({ metric: e }) => {
  ...
  let { interactionId: r } = n,
    ...
    d = Tl({
      name: c?.elementName || D(n.target),
      transaction: u,
      attributes: { [z]: `auto.http.browser.inp`, [R]: `ui.interaction.${i}`, [un]: n.duration },
      startTime: a,
    });
  d && (d.addEvent(`inp`, { [on]: `millisecond`, [sn]: e.value }), d.end(a + t));
};
function Lu() {
  ...
  Xu = we(qu, [
    ...
    (e) => {
      ...
      if (t) {
        ...
        let e = t[3],
          n = t[1] || `?`;
        return (([n, e] = Zu(n, e)), Hu(e, n, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0));
      }
    },
  ]),
  Zu = (e, t) => {
...
function nd(e, t) {
  return function (n) {
    ...
    try {
      let e = n.event,
        t = sd(e) ? e.target : e;
      ((r = D(t, { keyAttrs: a, maxStringLength: o })), (i = st(t)));
    } catch {
      r = `<unknown>`;
    }
    ...
    if (r && !(t.fetchData.url.match(/sentry_key/) && t.fetchData.method === `POST`))
      if ((t.fetchData.method, t.fetchData.url, t.error)) {
        ...
        let o = { input: t.args, response: i, startTimestamp: n, endTimestamp: r },
          s = { category: `fetch`, data: a, type: `http`, level: ls(a.status_code) };
...
var cd =
  ...
  ud = G((e = {}) => {
    ...
    return {
      name: ld,
      setupOnce() {
        (t.setTimeout && O(K, `setTimeout`, dd),
          t.setInterval && O(K, `setInterval`, dd),
          t.requestAnimationFrame && O(K, `requestAnimationFrame`, fd),
          t.XMLHttpRequest && `XMLHttpRequest` in K && O(XMLHttpRequest.prototype, `send`, pd));
        let e = t.eventTarget;
...
function dd(e) {
  return function (...t) {
    let n = t[0];
    return (
      (t[0] = Hs(n, { mechanism: { handled: !1, type: `auto.browser.browserapierrors.${C(e)}` } })),
      e.apply(this, t)
    );
  };
}
...
function md(e, t) {
  let n = K[e]?.prototype;
  n?.hasOwnProperty?.(`addEventListener`) &&
    (O(n, `addEventListener`, function (n) {
...
var Vd = new WeakMap(),
  Hd = new Map(),
  Ud = { traceFetch: !0, traceXHR: !0, enableHTTPTimings: !0, trackFetchStreamPerformance: !1 };
function Wd(e, t) {
  let {
      traceFetch: n,
      traceXHR: r,
  ...
  (n &&
    ...
    hs((e) => {
      ...
      if ((e.response && e.fetchData.__span && Vd.set(e.response, e.fetchData.__span), t)) {
    ...
    r &&
      Tu((e) => {
        ...
        t && (o && Gd(t), c?.(t, { headers: Bd(e.xhr.__sentry_xhr_v3__?.request_headers) }));
      }));
}
function Gd(e) {
  let { url: t } = B(e).data;
...
function qd(e, t, n, r, i, a) {
  ...
  if (e.endTimestamp && u) {
    ...
    n &&
      ...
      (pn(n, s.status_code), n.end(), a?.(n, { headers: Bd(Ou(o)), error: e.error }), delete r[t]);
    return;
  }
  let d = Rd(c),
    f = mo(d || c),
...
function Jd(e, t, n) {
  let { "sentry-trace": r, baggage: i, traceparent: a } = vo({ span: t, propagateTraceparent: n });
  r && Yd(e, r, i, a);
}
function Yd(e, t, n, r) {
  ...
  K.document
    ? K.document.addEventListener(`visibilitychange`, () => {
        ...
        if (K.document.hidden && t) {
          let e = `cancelled`,
            { op: n, status: r } = B(t);
          (Q && S.log(`[Tracing] Transaction: ${e} -> since tab moved to the background, op: ${n}`),
  ...
  n &&
    e.on(`beforeSampling`, (e) => {
      ...
      (t.setPropagationContext({
        ...n,
        dsc: { ...n.dsc, sample_rate: String(i.sampleRate), sampled: String(rf(i.spanContext)) },
...
function ef(e, t, n) {
  ...
  return o.traceId === r.trace_id
    ...
    : (Date.now() / 1e3 - e.startTimestamp <= 3600 &&
        (Q && S.log(`Adding previous_trace ${o} link to span ${{ op: r.op, ...t.spanContext() }}`),
    ...
    return {
      ...
      setup(e) {
        ...
        function t() {
          ...
          t &&
            !B(t).timestamp &&
            (Q && S.log(`[Tracing] Finishing current active span with op: ${B(t).op}`),
        ...
        (e.on(`startNavigationSpan`, (n, r) => {
          ...
          (i.setPropagationContext({
            ...
            x(e, { op: `navigation`, ...n, parentSpan: null, forceTransaction: !0 }));
        }),
          e.on(`startPageLoadSpan`, (n, r = {}) => {
            if (I() !== e) return;
            t();
            let i = Bn(r.sentryTrace || uf(`sentry-trace`), r.baggage || uf(`baggage`)),
              a = P();
          ...
          e.on(`endPageloadSpan`, () => {
            b && fe && (fe.setAttribute(an, `reportPageLoaded`), fe.end());
          }));
      },
      afterAllSetup(e) {
        let n = ot();
        if (
          (v !== `off` && $d(e, { linkPreviousTrace: v, consistentTraceSampling: se }), K.location)
        ) {
          if (ie) {
            let t = M();
            cf(e, {
...
function lf(e, t, n) {
  ...
  return (
    ...
    r && !i && a.setSDKProcessingMetadata({ normalizedRequest: { ...Us(), url: r } }),
    pf(e)
  );
}
function uf(e) {
  ...
  a &&
    addEventListener(
      ...
      () => {
        ...
        if (((o &&= (o.setAttribute(an, `interactionInterrupted`), o.end(), void 0)), !i.name)) {
          Q &&
            S.warn(
...
function bf(e) {
  let t;
  return Ia(e, async (e) => ((t ||= Rs()), t.sendEnvelope(e.body), { statusCode: 200 }));
}
var xf = 50,
  [, Sf] = qu,
  [, Cf] = js(),
...
var Nf = f(m, {
  ...
  Pf = d(m, ({ get: e }) => e(Nf).isUpdateReady),
  Ff = d(m, ({ get: e }) => e(Nf).lifecycleState),
  If = d(m, ({ get: e }) => e(Nf).downloadProgressPercent),
  Lf = d(m, ({ get: e }) => e(Nf).installProgressPercent),
  Rf = d(m, ({ get: e }) => e(Nf).relaunchNotice);
function zf(e) {
  switch (e) {
    case `ready`:
    case `downloading`:
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      t[0] === r
        ...
        : ((e = () => {
            if (r === `macOS`) {
              te.appUpdates?.installUpdate();
              return;
            }
            te.appUpdates?.checkForUpdates();
          }),
          (t[0] = r),
          (t[1] = e));
      let n, i;
      t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((n = (0, $.jsx)(ae, { className: `icon-xs` })),
          (i = (0, $.jsx)(g, {
...
function Yf(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(ie, { className: `icon-lg text-token-error-foreground` })),
      (a = (0, $.jsx)(g, {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(oe, { electron: !0, children: (0, $.jsx)(Vf, {}) })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
    ? ((s = () => {
