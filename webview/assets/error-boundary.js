...
import { _o as a, vo as o } from "./app-server-manager-signals.js";
import { n as s, t as c } from "./jsx-runtime.js";
import { C as l, S as u, U as d, Z as f, at as p, wt as m, y as h } from "./setting-storage.js";
import { m as g } from "./chunk-8.js";
...
var S = { enable: de, disable: fe, isEnabled: pe, log: me, warn: he, error: ge },
  ye = 50,
  be = /\(error: (.*)\)/,
...
function we(e) {
  ...
  return (
    ...
    t.reverse(),
    xe.test(Te(t).function || ``) && (t.pop(), xe.test(Te(t).function || ``) && t.pop()),
    t
      .slice(0, ye)
      .map((e) => ({ ...e, filename: e.filename || Te(t).filename, function: e.function || `?` }))
  );
}
function Te(e) {
  return e[e.length - 1] || {};
...
function E(e, t = {}) {
  ...
  try {
    ...
    for (
      ...
      n &&
      i++ < 5 &&
      ((o = it(n, s)), !(o === `html` || (i > 1 && a + r.length * 3 + o.length >= c)));
    )
...
function lt(e) {
  if (Be(e)) return { message: e.message, name: e.name, stack: e.stack, ...dt(e) };
  if (Je(e)) {
    let t = { type: e.type, target: ut(e.target), currentTarget: ut(e.currentTarget), ...dt(e) };
...
function ht(e, t, n = !1) {
  return T(e) ? (Xe(t) ? t.test(e) : T(t) ? (n ? e === t : e.includes(t)) : !1) : !1;
}
function gt(e, t = [], n = !1) {
...
function Pt(e, t) {
  let n = {};
  (t ? (n = { status: t }) : e.status === `ok` && (n = { status: `exited` }), Nt(e, n));
}
function Ft(e) {
  return {
    sid: `${e.sid}`,
...
var Bt = 100,
  Vt = class e {
    ...
    addBreadcrumb(e, t) {
      ...
      if (n <= 0) return this;
      let r = { timestamp: Dt(), ...e, message: e.message ? pt(e.message, 2048) : e.message };
      return (
    ...
    setSDKProcessingMetadata(e) {
      return ((this._sdkProcessingMetadata = It(this._sdkProcessingMetadata, e, 2)), this);
    }
...
var Wt = class {
  constructor(e, t) {
    ...
    n = e || new Vt();
    let r;
    ((r = t || new Vt()), (this._stack = [{ scope: n }]), (this._isolationScope = r));
  }
  withScope(e) {
...
function xn(e) {
  if (e) return wn(Object.entries(e).reduce((e, [t, n]) => (n && (e[`${vn}${t}`] = n), e), {}));
}
function Sn(e) {
...
function kn(e) {
  ...
  return An({ host: a, pass: i, path: c, projectId: l, port: o, protocol: n, publicKey: r });
}
function An(e) {
  return {
    protocol: e.protocol,
...
function zr(e, t, n, r) {
  let i = Ir(n);
  return Er(
    { sent_at: new Date().toISOString(), ...(i && { sdk: i }), ...(!!r && t && { dsn: On(t) }) },
  ...
  qr = class {
    ...
    _convertSpanToTransaction() {
      ...
      let a = {
          ...
          spans:
            r.length > Kr
              ? r.sort((e, t) => e.start_timestamp - t.start_timestamp).slice(0, Kr)
              : r,
          start_timestamp: this._startTime,
          timestamp: this._endTime,
    ...
    di(a)(() => {
      let n = P(),
        ...
        s =
          e.onlyIfParent && !o
            ? new vr()
            : ai({ parentSpan: o, spanArguments: r, forceTransaction: i, scope: n });
      return (
        Rt(n, s),
        Qr(
          () => t(s),
...
function ri(e) {
  ...
  return (e.scope ? (t) => Qt(e.scope, t) : i === void 0 ? (e) => e() : (e) => ii(i, e))(() => {
    let t = P(),
      a = ui(t, i);
...
function ii(e, t) {
  let n = si();
  return n.withActiveSpan ? n.withActiveSpan(e, t) : Qt((n) => (Rt(n, e || void 0), t(n)));
}
function ai({ parentSpan: e, spanArguments: t, forceTransaction: n, scope: r }) {
  if (!U()) {
    let r = new vr();
    return (
      (n || !e) && mr(r, { sampled: `false`, sample_rate: `0`, transaction: t.name, ..._r(r) }), r
    );
  }
  let i = F(),
    a;
...
function ci(e, t, n) {
  ...
  let s = o.parentSampled ?? n,
    ...
    [u, d, f] = t.getScopeData().sdkProcessingMetadata[ti]
      ...
      : ei(
          i,
          { name: a, parentSampled: s, attributes: c, parentSampleRate: Fn(l.dsc?.sample_rate) },
          l.sampleRand,
        ),
    p = new qr({
      ...e,
...
function li(e, t, n) {
  let { spanId: r, traceId: i } = e.spanContext(),
    ...
    o = a ? new qr({ ...n, parentSpanId: r, traceId: i, sampled: a }) : new vr({ traceId: i });
  nr(e, o);
  let s = I();
...
function _i(e, t = {}) {
    ...
    apply(e, t, n) {
      ...
      let c = p.getOptions().ignoreSpans,
        u = o?.reduce(
          (e, t) => {
            let n = B(t);
            return !n.timestamp || (c && lr(n, c)) ? e : e ? Math.max(e, n.timestamp) : n.timestamp;
          },
          void 0,
        ),
        m = s.start_timestamp,
  ...
  return (
    ...
    setTimeout(() => {
      r || (g.setStatus({ code: 2, message: `deadline_exceeded` }), (a = hi), g.end());
    }, l),
    g
  );
}
...
var wi = class e {
  ...
  _executeHandlers() {
    ...
    ((this._handlers = []),
      e.forEach((e) => {
        e[0] ||=
          (this._state === bi && e[1](this._value), this._state === xi && e[2](this._value), !0);
      }));
  }
  _runExecutor(e) {
    let t = (e, t) => {
...
function Ni(e, t) {
  ((e.contexts = { trace: Wn(t), ...e.contexts }),
    (e.sdkProcessingMetadata = { dynamicSamplingContext: _r(t), ...e.sdkProcessingMetadata }));
...
function Bi(e, t, n, r, i, a) {
  let { normalizeDepth: o = 3, normalizeMaxBreadth: s = 1e3 } = e,
    c = { ...t, event_id: t.event_id || n.event_id || k(), timestamp: t.timestamp || Dt() },
...
var Yi = [`user`, `level`, `extra`, `contexts`, `tags`, `fingerprint`, `propagationContext`];
function Xi(e) {
...
function na(e) {
  let t = F(),
    ...
    i = Mt({ user: n.getUser() || t.getUser(), ...(r && { userAgent: r }), ...e }),
    a = t.getSession();
  return (a?.status === `ok` && Nt(a, { status: `exited` }), ra(), t.setSession(i), i);
}
function ra() {
  let e = F(),
...
function ga(e, t, n) {
  ...
  if (
    ((n[t.name] = t),
    !da.includes(t.name) && typeof t.setupOnce == `function` && (t.setupOnce(), da.push(t.name)),
...
var Ya = class {
  constructor(e) {
    ...
    ((this._options.enableLogs =
      ...
      this._options.enableLogs && Ja(this, `afterCaptureLog`, `flushLogs`, no, ya),
  ...
  captureEvent(e, t, n) {
    let r = k();
    if (t?.originalException && wt(t.originalException)) return (_ && S.log(za), r);
    let i = { event_id: r, ...t },
  ...
  _updateSessionFromEvent(e, t) {
    ...
    let a = e.status === `ok`;
    ((a && e.errors === 0) || (a && n)) &&
      (Nt(e, { ...(n && { status: `crashed` }), errors: e.errors || Number(r || n) }),
  ...
  _captureEvent(e, t = {}, n = P(), r = F()) {
    return (
      _ && $a(e) && S.log(`Captured error event \`${Ia(e)[0] || `<unknown>`}\``),
      this._processEvent(e, t, n, r).then(
        (e) => e.event_id,
        (e) => {
          _ && (qa(e) ? S.log(e.message) : Ka(e) ? S.warn(e.message) : S.warn(e));
        },
      )
    );
  }
  _processEvent(e, t, n, r) {
    ...
    return this._prepareEvent(e, t, n, r)
      .then((e) => {
        ...
        return t.data && t.data.__sentry__ === !0 ? e : Za(Qa(this, i, e, t), c);
      })
      .then((i) => {
        if (i === null) {
  ...
  _process(e, t) {
    (this._numProcessing++,
      this._promiseBuffer.add(e).then(
        ...
        (e) => (this._numProcessing--, e === Da && this.recordDroppedEvent(`queue_overflow`, t), e),
      ));
  }
  _clearOutcomes() {
...
function ro(e) {
  ...
  return (
    Object.values(e).forEach((e) => {
      Array.isArray(e) ? (t += e.length * io(e[0])) : Ke(e) ? (t += io(e)) : (t += 100);
    }),
    t
  );
}
...
function go(e = {}) {
  ...
  let r = e.scope || P(),
    ...
    a = i ? Gn(i) : _o(r),
    o = xn(i ? _r(i) : gr(t, r));
  if (!In.test(a)) return (S.warn(`Invalid sentry-trace data. Cannot generate trace data`), {});
...
function Ro(e, t, n, r, i, a) {
  ...
  o && (i.exception.values = zo(e, t, r, a.originalException, n, i.exception.values, o, 0));
}
    ...
    Array.isArray(r.errors) &&
      r.errors.forEach((r, a) => {
        if ($e(r, Error)) {
          ...
          let l = e(t, r),
            u = c.length;
          (Vo(l, `errors[${a}]`, u, s), (c = zo(e, t, n, r, i, [l, ...c], l, u)));
        }
      }),
    c
  );
...
function Jo(e, t) {
  let n = e.message,
    r = t.message;
  return !((!n && !r) || (n && !r) || (!n && r) || n !== r || !Zo(e, t) || !Xo(e, t));
}
function Yo(e, t) {
  let n = Qo(t),
    r = Qo(e);
  return !(!n || !r || n.type !== r.type || n.value !== r.value || !Zo(e, t) || !Xo(e, t));
}
function Xo(e, t) {
  let n = De(e),
    r = De(t);
          ...
          t.apply(v, n).then(
            ...
            (e) => {
              if (
                ...
                Be(e) && e.stack === void 0 && ((e.stack = r.stack), O(e, `framesToPop`, 1)),
...
function bs(e) {
  ...
  if (e.length === 2) {
    let [t, n] = e;
    return { url: ys(t), method: vs(n, `method`) ? String(n.method).toUpperCase() : `GET` };
  }
  let t = e[0];
  return { url: ys(t), method: vs(t, `method`) ? String(t.method).toUpperCase() : `GET` };
}
function xs(e) {
  let [t, n] = e;
  try {
...
function Qs(e, t, n, r) {
  ...
  return (Ct(i), (i.level = `error`), n?.event_id && (i.event_id = n.event_id), Si(i));
}
...
function ec(e, t, n, r, i) {
  ...
  return Be(t)
    ...
    : qe(t) || Je(t)
      ...
      : ((a = tc(e, t, n, r)), St(a, `${t}`, void 0), Ct(a, { synthetic: !0 }), a);
}
function tc(e, t, n, r) {
  let i = {};
  if (r && n) {
...
var ac = class extends Ya {
  ...
  eventFromMessage(e, t = `info`, n) {
    return $s(this._options.stackParser, e, t, n, this._options.attachStacktrace);
  }
  _prepareEvent(e, t, n, r) {
  ...
  lc = (e, t, n, r) => {
    ...
    return (o) => {
      t.value >= 0 &&
        (o || r) &&
        ((a = t.value - (i ?? 0)),
        (a || i === void 0) && ((i = t.value), (t.delta = a), (t.rating = cc(t.value, n)), e(t)));
    };
  },
  uc = (e = !0) => {
...
var mc = -1,
  hc = new Set(),
  gc = () => (q.document?.visibilityState === `hidden` && !q.document?.prerendering ? 0 : 1 / 0),
  _c = (e) => {
    if (yc(e) && mc > -1) {
      if (e.type === `visibilitychange` || e.type === `pagehide`) for (let e of hc) e();
      isFinite(mc) ||
        ((mc = e.type === `visibilitychange` ? e.timeStamp : 0), pc(`prerenderingchange`, _c, !0));
    }
  },
  vc = () => {
    if (q.document && mc < 0) {
      ...
      ((mc =
        (q.document.prerendering
          ...
          : globalThis.performance
              ...
              .filter((t) => t.name === `hidden` && t.startTime > e)[0]?.startTime) ?? gc()),
...
var bc = () => `v5-${Date.now()}-${Math.floor(Math.random() * 8999999999999) + 0xe8d4a51000}`,
  xc = (e, t = -1) => {
    let n = uc(),
      r = `navigate`;
    return (
      ...
      { name: e, value: t, rating: `good`, delta: 0, entries: [], id: bc(), navigationType: r }
    );
  },
  Sc = new WeakMap();
function Cc(e, t) {
...
var wc = class e {
          ...
          for (let t of e)
            t.name === `first-contentful-paint` &&
              ...
              t.startTime < n.firstHiddenTime &&
                ((r.value = Math.max(t.startTime - dc(), 0)), r.entries.push(t), i(!0)));
        });
  ...
  Rc = () => {
    `interactionCount` in performance ||
      Ic ||
      (Ic = Tc(`event`, Fc, { type: `event`, buffered: !0, durationThreshold: 0 }));
  },
  zc = 10,
  Bc = 0,
  Vc = () => Lc() - Bc,
  Hc = class e {
    ...
    _resetInteractions() {
      ((Bc = Lc()), (this._longestInteractionList.length = 0), this._longestInteractionMap.clear());
    }
    _estimateP98LongestInteraction() {
      let e = Math.min(this._longestInteractionList.length - 1, Math.floor(Vc() / 50));
    ...
    _processEntry(e) {
      ...
      if (n || this._longestInteractionList.length < zc || e.duration > t._latency) {
        if (
          (n
  ...
  Xc = (e, t = {}) => {
    Dc(() => {
      let n = vc(),
        ...
        o = (e) => {
          ...
          for (let t of e)
            (a._processEntry(t),
              t.startTime < n.firstHiddenTime &&
                ((r.value = Math.max(t.startTime - dc(), 0)), (r.entries = [t]), i()));
        },
      ...
      if (s) {
        ...
        for (let e of [`keydown`, `click`, `visibilitychange`]) fc(e, a, { capture: !0 });
      }
    });
  },
  Zc = [800, 1800],
  ...
  $c = (e, t = {}) => {
    ...
    Qc(() => {
      let e = uc();
      e && ((n.value = Math.max(e.responseStart - dc(), 0)), (n.entries = [e]), r(!0));
    });
  },
  el = {},
  tl = {},
...
function gl(e, t, n, r, i = !1) {
  vl(e, t);
  let a;
  return (tl[e] || ((a = n()), (tl[e] = !0)), r && t({ metric: r }), yl(e, t, i ? a : void 0));
}
function _l(e) {
  let t = {};
...
var Pl = 2147483647,
  ...
  Z,
  Il;
function Ll({ recordClsStandaloneSpans: e, recordLcpStandaloneSpans: t, client: n }) {
  let r = wl();
  if (r && j()) {
...
function Kl(e, t, n, r, i, a) {
  if (Gl(t) || ([`mark`, `measure`].includes(t.entryType) && gt(t.name, a))) return;
  let o = uc(!1),
...
function Ql(e, t, n, r, i, a, o) {
  ...
  let u = { ...c, ...Ml(t) },
    d = a + r;
  Sl(e, d, d + i, { name: n.replace(q.location.origin, ``), op: s, attributes: u });
}
function $l(e) {
  let t = q.navigator;
  if (!t) return;
  ...
  (n &&
    ...
    xl(t.deviceMemory) && e.setAttribute(`deviceMemory`, `${t.deviceMemory} GB`),
...
function eu(e, t) {
  (Z &&
    ...
    Il?.sources &&
      ...
      Il.sources.forEach((t, n) => e.setAttribute(`cls.source.${n + 1}`, E(t.node))));
}
function tu(e, t, n) {
  n.forEach(([n, r]) => {
    let i = e[n];
    i != null && ((typeof i == `number` && i < Pl) || typeof i == `string`) && (t[r] = i);
  });
}
function nu(e) {
  let t = uc(!1);
...
function pu(e, t = !1) {
  return (n) => {
    ...
    (du(n) || (e({ event: n, name: i, global: t }), (su = n.type), (cu = r ? r._sentryId : void 0)),
      clearTimeout(ou),
      (ou = q.setTimeout(() => {
        ((cu = void 0), (su = void 0));
      }, au)));
...
function bu(e) {
  ...
  if (r && typeof r.createElement == `function`)
    try {
      ...
      sc && S.warn(`Could not create sandbox iframe for ${e} check, bailing to window.${e}: `, t);
    }
...
var Pu = ({ metric: e }) => {
  ...
  let { interactionId: r } = n,
    ...
    d = Cl({
      ...
      transaction: u,
      attributes: { [z]: `auto.http.browser.inp`, [R]: `ui.interaction.${i}`, [cn]: n.duration },
      startTime: a,
    });
  d && (d.addEvent(`inp`, { [rn]: `millisecond`, [an]: e.value }), d.end(a + t));
};
function Fu() {
  ...
  Ju = Se(Gu, [
    ...
    (e) => {
      ...
      if (t) {
        ...
        let e = t[3],
          n = t[1] || `?`;
        return (([n, e] = Yu(n, e)), Bu(e, n, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0));
      }
    },
  ]),
  Yu = (e, t) => {
    ...
    if (r && !(t.fetchData.url.match(/sentry_key/) && t.fetchData.method === `POST`))
      if ((t.fetchData.method, t.fetchData.url, t.error)) {
        ...
        let o = { input: t.args, response: i, startTimestamp: n, endTimestamp: r },
          s = { category: `fetch`, data: a, type: `http`, level: ss(a.status_code) };
    ...
    return {
      ...
      setupOnce() {
        (t.setTimeout && D(K, `setTimeout`, ld),
          ...
          t.XMLHttpRequest && `XMLHttpRequest` in K && D(XMLHttpRequest.prototype, `send`, dd));
        let e = t.eventTarget;
...
function ld(e) {
  return function (...t) {
    let n = t[0];
    return (
      (t[0] = Bs(n, { mechanism: { handled: !1, type: `auto.browser.browserapierrors.${C(e)}` } })),
      e.apply(this, t)
    );
  };
}
...
var zd = new WeakMap(),
  Bd = new Map(),
  Vd = { traceFetch: !0, traceXHR: !0, enableHTTPTimings: !0, trackFetchStreamPerformance: !1 };
function Hd(e, t) {
  let {
      traceFetch: n,
      traceXHR: r,
  ...
  (n &&
    ...
    ps((e) => {
      ...
      if ((e.response && e.fetchData.__span && zd.set(e.response, e.fetchData.__span), t)) {
    ...
    r &&
      Cu((e) => {
        ...
        t && (o && Ud(t), c?.(t, { headers: Rd(e.xhr.__sentry_xhr_v3__?.request_headers) }));
      }));
}
function Ud(e) {
  let { url: t } = B(e).data;
...
function Gd(e, t, n, r, i, a) {
  ...
  if (e.endTimestamp && u) {
    ...
    n &&
      ...
      (dn(n, s.status_code), n.end(), a?.(n, { headers: Rd(Eu(o)), error: e.error }), delete r[t]);
    return;
  }
  let d = Id(c),
    f = fo(d || c),
...
function Kd(e, t, n) {
  let { "sentry-trace": r, baggage: i, traceparent: a } = go({ span: t, propagateTraceparent: n });
  r && qd(e, r, i, a);
}
function qd(e, t, n, r) {
  ...
  n &&
    e.on(`beforeSampling`, (e) => {
      ...
      (t.setPropagationContext({
        ...n,
        dsc: { ...n.dsc, sample_rate: String(i.sampleRate), sampled: String(tf(i.spanContext)) },
  ...
  af = (e = {}) => {
    ...
    return {
      ...
      setup(e) {
        ...
        (e.on(`startNavigationSpan`, (n, r) => {
          ...
          (i.setPropagationContext({
            ...
            fe(e, { op: `navigation`, ...n, parentSpan: null, forceTransaction: !0 }));
        }),
          e.on(`startPageLoadSpan`, (n, r = {}) => {
            if (I() !== e) return;
            t();
            let i = Rn(r.sentryTrace || cf(`sentry-trace`), r.baggage || cf(`baggage`)),
              a = P();
      ...
      afterAllSetup(e) {
        let n = at();
        if (
          (y !== `off` && Zd(e, { linkPreviousTrace: y, consistentTraceSampling: se }), K.location)
        ) {
          if (ae) {
            let t = j();
            of(e, {
...
function sf(e, t, n) {
  ...
  return (
    ...
    r && !i && a.setSDKProcessingMetadata({ normalizedRequest: { ...Vs(), url: r } }),
    df(e)
  );
}
function cf(e) {
  ...
  a &&
    addEventListener(
      ...
      () => {
        ...
        if (((o &&= (o.setAttribute(nn, `interactionInterrupted`), o.end(), void 0)), !i.name)) {
          Q &&
            S.warn(
...
function vf(e) {
  let t;
  return Pa(e, async (e) => ((t ||= Is()), t.sendEnvelope(e.body), { statusCode: 200 }));
}
var yf = 50,
  [, bf] = Gu,
  [, xf] = ks(),
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      t[0] === r
        ? (e = t[1])
        : ((e = () => {
            h.dispatchMessage(r === `macOS` ? `install-app-update` : `check-app-update`, {});
          }),
          (t[0] = r),
          (t[1] = e));
      let n, i;
...
function Vf(e) {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(ae, { electron: !0, children: (0, $.jsx)(Nf, {}) })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
    ? ((s = () => {
