...
import { c as r, g as i, s as a, t as o, z as s } from "./app-scope.js";
import { As as c, js as l, ks as u } from "./app-server-manager-signals.js";
import { h as d } from "./vscode-api.js";
import { F as f, N as p, P as m, ci as h } from "./src-2.js";
import { s as g } from "./lib.js";
import { t as _ } from "./button.js";
import { t as ee } from "./spinner.js";
import { n as te } from "./rpc-Hf-fxjh7.js";
import { t as ne } from "./with-window.js";
import { t as re } from "./use-platform.js";
import { m as ie } from "./chunk-9.js";
import { t as ae } from "./info-1.js";
...
var x = { enable: me, disable: he, isEnabled: ge, log: _e, warn: ve, error: ye },
  Se = 50,
  Ce = /\(error: (.*)\)/,
  we = /captureMessage|captureException/;
function Te(...e) {
...
`);
    for (let e = n; e < a.length; e++) {
      ...
      let o = Ce.test(n) ? n.replace(Ce, `$1`) : n;
      if (!o.match(/\S*Error: /)) {
        for (let e of t) {
          let t = e(o);
          if (t) {
...
function De(e) {
  ...
  return (
    ...
    t.reverse(),
    we.test(Oe(t).function || ``) && (t.pop(), we.test(Oe(t).function || ``) && t.pop()),
    t
      .slice(0, Se)
      .map((e) => ({ ...e, filename: e.filename || Oe(t).filename, function: e.function || `?` }))
  );
}
function Oe(e) {
  return e[e.length - 1] || {};
...
function S(e) {
  try {
    return !e || typeof e != `function` ? ke : e.name || ke;
  } catch {
    return ke;
  }
}
...
function Ve() {
  ((ze = y.onunhandledrejection),
    (y.onunhandledrejection = function (e) {
      return (C(`unhandledrejection`, e), ze ? ze.apply(this, arguments) : !0);
    }),
...
function E(e, t = {}) {
  ...
  try {
    ...
    for (
      ...
      n &&
      i++ < 5 &&
      ((o = ot(n, s)), !(o === `html` || (i > 1 && a + r.length * 3 + o.length >= c)));
    )
...
function dt(e) {
  if (Ue(e)) return { message: e.message, name: e.name, stack: e.stack, ...pt(e) };
  if (Ze(e)) {
    let t = { type: e.type, target: ft(e.target), currentTarget: ft(e.currentTarget), ...pt(e) };
    return (typeof CustomEvent < `u` && T(e, CustomEvent) && (t.detail = e.detail), t);
  } else return e;
}
function ft(e) {
  try {
    return Qe(e) ? E(e) : Object.prototype.toString.call(e);
  } catch {
    return `<unknown>`;
  }
}
...
function gt(e, t) {
  ...
  for (let t = 0; t < e.length; t++) {
    let r = e[t];
    try {
      nt(r) ? n.push(je(r)) : n.push(String(r));
    } catch {
...
function _t(e, t, n = !1) {
  return w(e) ? ($e(t) ? t.test(e) : w(t) ? (n ? e === t : e.includes(t)) : !1) : !1;
}
function vt(e, t = [], n = !1) {
...
function It(e, t) {
  let n = {};
  (t ? (n = { status: t }) : e.status === `ok` && (n = { status: `exited` }), Ft(e, n));
}
function Lt(e) {
  return {
    sid: `${e.sid}`,
...
function Rt(e, t, n = 2) {
  ...
  let r = { ...e };
  for (let e in t) Object.prototype.hasOwnProperty.call(t, e) && (r[e] = Rt(r[e], t[e], n - 1));
  return r;
}
function M() {
  return k();
  ...
  Ut = class e {
    ...
    update(t) {
      ...
      let n = typeof t == `function` ? t(this) : t,
        ...
        } = (n instanceof e ? n.getScopeData() : Xe(n) ? t : void 0) || {};
      return (
    ...
    addBreadcrumb(e, t) {
      ...
      if (n <= 0) return this;
      let r = { timestamp: kt(), ...e, message: e.message ? ht(e.message, 2048) : e.message };
      return (
    ...
    setSDKProcessingMetadata(e) {
      return ((this._sdkProcessingMetadata = Rt(this._sdkProcessingMetadata, e, 2)), this);
    }
...
function lr() {
  ...
  ((e.tag = `sentry_tracingErrorCallback`), (cr = !0), Le(e), Be(e));
}
function U(e) {
...
function dr(e, t) {
  ...
  for (let n of t) {
    if (pr(n)) {
      if (_t(e.description, n)) return (v && ur(e), !0);
      continue;
    }
...
function yi(e, t = {}) {
  ...
  function ne(e) {
    (_(), n.set(e, !0), te(A() + u / 1e3));
  }
  function re(e) {
    (n.has(e) && n.delete(e), n.size === 0 && ee(A() + c / 1e3));
  }
  function ie(e) {
  ...
  return (
    ...
    s.push(
      p.on(`idleSpanEnableAutoFinish`, (e) => {
        e === g && ((o = !0), ee(), n.size && te());
      }),
    ),
    t.disableAutoFinish || ee(),
    setTimeout(() => {
...
function bi(e) {
  let t = ai(e);
  return (Bt(P(), t), v && x.log(`[Tracing] Started span is an idle span`), t);
}
var xi = 0,
  Si = 1,
  Ci = 2;
...
function Oi(e, t, n, r) {
  ...
  return (
    ...
    et(a) ? a.then((e) => Oi(e, t, n, r + 1)) : Oi(a, t, n, r + 1)
  );
}
function ki(e, t) {
...
function Hi(e, t, n, r, i, a) {
  let { normalizeDepth: o = 3, normalizeMaxBreadth: s = 1e3 } = e,
    c = { ...t, event_id: t.event_id || n.event_id || k(), timestamp: t.timestamp || kt() },
...
function ia(e) {
  let t = F(),
    ...
    i = Pt({ user: n.getUser() || t.getUser(), ...(r && { userAgent: r }), ...e }),
    a = t.getSession();
  return (a?.status === `ok` && Ft(a, { status: `exited` }), aa(), t.setSession(i), i);
}
function aa() {
  let e = F(),
    ...
    return n
      .add(() =>
        t({ body: Mr(o) }).then(
          ...
          (e) => {
            throw (
              s(`network_error`), v && x.error(`Encountered error running transport request:`, e), e
            );
          },
        ),
      )
...
function La(e, t, n) {
  let r = [{ type: `client_report` }, { timestamp: n || kt(), discarded_events: e }];
  return Or(t ? { dsn: t } : {}, [r]);
}
function Ra(e) {
  let t = [];
...
var Za = class {
  ...
  captureEvent(e, t, n) {
    let r = k();
    if (t?.originalException && Et(t.originalException)) return (v && x.log(Va), r);
    let i = { event_id: r, ...t },
  ...
  _updateSessionFromEvent(e, t) {
    ...
    let a = e.status === `ok`;
    ((a && e.errors === 0) || (a && n)) &&
      (Ft(e, { ...(n && { status: `crashed` }), errors: e.errors || Number(r || n) }),
  ...
  _captureEvent(e, t = {}, n = P(), r = F()) {
    return (
      v && to(e) && x.log(`Captured error event \`${Ra(e)[0] || `<unknown>`}\``),
      this._processEvent(e, t, n, r).then(
        (e) => e.event_id,
        (e) => {
          v && (Ya(e) ? x.log(e.message) : Ja(e) ? x.warn(e.message) : x.warn(e));
        },
      )
    );
  }
...
function ao(e) {
  ...
  return (
    Object.values(e).forEach((e) => {
      Array.isArray(e) ? (t += e.length * oo(e[0])) : Ye(e) ? (t += oo(e)) : (t += 100);
    }),
    t
  );
}
...
function vo(e = {}) {
  ...
  let r = e.scope || P(),
    ...
    a = i ? qn(i) : yo(r),
    o = Cn(i ? yr(i) : vr(t, r));
  if (!Rn.test(a)) return (x.warn(`Invalid sentry-trace data. Cannot generate trace data`), {});
...
function Ro(e) {
  try {
    ...
    return (v && x.error(`Cannot extract url for event ${Ct(e)}`), null);
  }
}
function zo(e) {
          ...
          t.apply(y, n).then(
            ...
            (e) => {
              if (
                ...
                Ue(e) && e.stack === void 0 && ((e.stack = r.stack), O(e, `framesToPop`, 1)),
...
function ec(e, t, n, r) {
  ...
  return (Tt(i), (i.level = `error`), n?.event_id && (i.event_id = n.event_id), wi(i));
}
...
function nc(e, t, n, r, i) {
  let a;
  if (Ge(t) && t.error) return Ks(e, t.error);
  if (Ke(t) || qe(t)) {
    let i = t;
    if (`stack` in t) a = Ks(e, t);
    else {
      let t = i.name || (Ke(i) ? `DOMError` : `DOMException`),
  ...
  return Ue(t)
    ...
    : Xe(t) || Ze(t)
      ...
      : ((a = rc(e, t, n, r)), wt(a, `${t}`, void 0), Tt(a, { synthetic: !0 }), a);
}
function rc(e, t, n, r) {
  let i = {};
  if (r && n) {
...
function Jl(e, t, n, r, i, a) {
  if (ql(t) || ([`mark`, `measure`].includes(t.entryType) && vt(t.name, a))) return;
  let o = fc(!1),
  ...
  try {
    ...
    if (typeof n == `object`) {
      for (let [t, r] of Object.entries(n))
        if (r && Ye(r)) e[`sentry.browser.measure.detail.${t}`] = r;
        else if (r !== void 0)
          try {
...
function nu(e, t) {
  (Z &&
    ...
    Rl?.sources &&
      ...
      Rl.sources.forEach((t, n) => e.setAttribute(`cls.source.${n + 1}`, E(t.node))));
}
function ru(e, t, n) {
  n.forEach(([n, r]) => {
    let i = e[n];
  ...
  if (
    (q.addEventListener(`popstate`, () => {
      let e = q.location.href,
        t = _u;
      ((_u = e), t !== e && C(`history`, { from: t, to: e }));
    }),
    !ds())
  )
    return;
...
function Su(e) {
  ...
  if (r && typeof r.createElement == `function`)
    try {
      ...
      lc && x.warn(`Could not create sandbox iframe for ${e} check, bailing to window.${e}: `, t);
    }
...
function Ou(e) {
  ...
  try {
    ...
    return (lc && x.error(t, `Failed to get xhr response headers`, e), {});
  }
  return t
    ? t
        .split(`\r
    ...
    return {
      ...
      setupOnce() {
        (t.setTimeout && D(K, `setTimeout`, dd),
          ...
          t.XMLHttpRequest && `XMLHttpRequest` in K && D(XMLHttpRequest.prototype, `send`, pd));
        let e = t.eventTarget;
...
function dd(e) {
  return function (...t) {
    let n = t[0];
    return (
      (t[0] = Hs(n, { mechanism: { handled: !1, type: `auto.browser.browserapierrors.${S(e)}` } })),
      e.apply(this, t)
    );
  };
}
        ...
        e in n &&
          ...
          D(n, e, function (t) {
            let n = {
              ...
              r = ut(t);
            return (r && (n.mechanism.data.handler = S(r)), Hs(t, n));
          });
      }),
      e.apply(this, t)
    );
...
function Id(e = {}) {
  ...
  return so(sc, {
    ...
    stackParser: Ee(e.stackParser || Xu),
...
var Nf = i(o, {
  ...
  Pf = r(o, ({ get: e }) => e(Nf).isUpdateReady),
  Ff = r(o, ({ get: e }) => e(Nf).lifecycleState),
  If = r(o, ({ get: e }) => e(Nf).downloadProgressPercent),
  Lf = r(o, ({ get: e }) => e(Nf).installProgressPercent),
  Rf = r(o, ({ get: e }) => e(Nf).relaunchNotice);
function zf(e) {
  switch (e) {
    case `ready`:
    case `downloading`:
...
function Yf(e) {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(ne, { electron: !0, children: (0, $.jsx)(Vf, {}) })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
    ? ((s = () => {
