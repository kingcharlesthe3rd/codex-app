var e = `Codex Light`,
  ...
  r = [
    ...
    { scope: [`string`, `constant.other.symbol`], settings: { foreground: `#008809` } },
    {
    ...
    { scope: `punctuation.definition.constant`, settings: { foreground: `#BD5800` } },
    ...
    { scope: [`storage`, `storage.type`, `storage.modifier`], settings: { foreground: `#D53538` } },
    ...
    { scope: `variable.parameter.function`, settings: { foreground: `#666666` } },
    { scope: `function.parameter`, settings: { foreground: `#666666` } },
    { scope: `variable.parameter`, settings: { foreground: `#666666` } },
    { scope: `variable.parameter.function.language.python`, settings: { foreground: `#BD5800` } },
    { scope: `variable.parameter.function.python`, settings: { foreground: `#BD5800` } },
    {
      scope: [
        `support.function`,
    ...
    { scope: `keyword.other.special-method`, settings: { foreground: `#751ED9` } },
    ...
    { scope: [`support.class`, `entity.name.type.class`], settings: { foreground: `#751ED9` } },
    {
      scope: [`entity.name.class`, `variable.other.class.js`, `variable.other.class.ts`],
      settings: { foreground: `#751ED9` },
    },
    { scope: `entity.name.class.identifier.namespace.type`, settings: { foreground: `#751ED9` } },
    { scope: `entity.name.type.namespace`, settings: { foreground: `#BD5800` } },
    { scope: `entity.other.inherited-class`, settings: { foreground: `#751ED9` } },
    ...
    { scope: `keyword.operator.assignment.compound`, settings: { foreground: `#D53538` } },
    {
    ...
    { scope: `punctuation.separator.key-value`, settings: { foreground: `#666666` } },
    ...
    { scope: `keyword.operator.expression.import`, settings: { foreground: `#751ED9` } },
    { scope: `keyword.operator.module`, settings: { foreground: `#D53538` } },
    { scope: `support.type.object.console`, settings: { foreground: `#BD5800` } },
    {
    ...
    { scope: `support.constant.property.math`, settings: { foreground: `#BD5800` } },
    ...
    { scope: `support.variable.property.process`, settings: { foreground: `#BD5800` } },
    { scope: `meta.property.object`, settings: { foreground: `#BD5800` } },
    { scope: `variable.parameter.function.js`, settings: { foreground: `#BD5800` } },
    {
    ...
    { scope: `punctuation.section.embedded`, settings: { foreground: `#BD5800` } },
    ...
    { scope: `support.type.type.flowtype`, settings: { foreground: `#751ED9` } },
    { scope: `support.type.primitive`, settings: { foreground: `#751ED9` } },
    { scope: `support.variable.magic.python`, settings: { foreground: `#D53538` } },
    {
    ...
    { scope: `keyword.operator.logical.python`, settings: { foreground: `#D53538` } },
    { scope: `meta.function-call.generic.python`, settings: { foreground: `#751ED9` } },
    {
      scope: `constant.character.format.placeholder.other.python`,
      settings: { foreground: `#BD5800` },
    },
    { scope: `meta.function.decorator.python`, settings: { foreground: `#751ED9` } },
    {
      scope: [`support.token.decorator.python`, `meta.function.decorator.identifier.python`],
      settings: { foreground: `#0071EA` },
    },
    { scope: `storage.modifier.lifetime.rust`, settings: { foreground: `#666666` } },
    ...
    { scope: `keyword.operator.misc.rust`, settings: { foreground: `#666666` } },
    { scope: `keyword.operator.sigil.rust`, settings: { foreground: `#D53538` } },
    { scope: `support.constant.core.rust`, settings: { foreground: `#BD5800` } },
    { scope: [`meta.function.c`, `meta.function.cpp`], settings: { foreground: `#D53538` } },
    {
      scope: [
    ...
    { scope: `keyword.operator.instanceof.java`, settings: { foreground: `#D53538` } },
    { scope: `meta.definition.variable.name.java`, settings: { foreground: `#D53538` } },
    { scope: `token.variable.parameter.java`, settings: { foreground: `#666666` } },
    ...
    { scope: `keyword.operator.assignment.go`, settings: { foreground: `#BD5800` } },
    {
    ...
    { scope: `keyword.operator.error-control.php`, settings: { foreground: `#D53538` } },
    ...
    { scope: `keyword.operator.regexp.php`, settings: { foreground: `#D53538` } },
    { scope: `keyword.operator.comparison.php`, settings: { foreground: `#0071EA` } },
    {
    ...
    { scope: `variable.other.generic-type.haskell`, settings: { foreground: `#D53538` } },
    { scope: `storage.type.haskell`, settings: { foreground: `#BD5800` } },
    { scope: `storage.type.cs`, settings: { foreground: `#BD5800` } },
    { scope: `entity.name.variable.local.cs`, settings: { foreground: `#D53538` } },
    ...
    { scope: `storage.modifier.import.groovy`, settings: { foreground: `#BD5800` } },
    { scope: `meta.method.groovy`, settings: { foreground: `#751ED9` } },
    { scope: `meta.definition.variable.name.groovy`, settings: { foreground: `#D53538` } },
    {
      scope: `meta.definition.class.inherited.classes.groovy`,
      settings: { foreground: `#008809` },
    },
    { scope: `support.variable.semantic.hlsl`, settings: { foreground: `#BD5800` } },
    {
      scope: [
    ...
    { scope: [`text.variable`, `text.bracketed`], settings: { foreground: `#D53538` } },
    { scope: [`support.type.swift`, `support.type.vb.asp`], settings: { foreground: `#BD5800` } },
    { scope: `meta.scope.prerequisites.makefile`, settings: { foreground: `#D53538` } },
    { scope: `source.makefile`, settings: { foreground: `#BD5800` } },
    { scope: `source.ini`, settings: { foreground: `#008809` } },
    { scope: `constant.language.symbol.ruby`, settings: { foreground: `#0071EA` } },
    {
      scope: [`function.parameter.ruby`, `function.parameter.cs`],
      settings: { foreground: `#666666` },
    },
    { scope: `constant.language.symbol.elixir`, settings: { foreground: `#0071EA` } },
    {
    ...
    { scope: `constant.character.character-class.regexp.xi`, settings: { foreground: `#D53538` } },
    ...
    { scope: `punctuation.definition.tag.xi`, settings: { foreground: `#666666` } },
    {
    ...
    { scope: `punctuation.separator.list.comma.css`, settings: { foreground: `#666666` } },
    { scope: `support.type.vendored.property-name.css`, settings: { foreground: `#0071EA` } },
    { scope: `support.type.property-name.css`, settings: { foreground: `#0071EA` } },
    { scope: `support.type.property-name`, settings: { foreground: `#666666` } },
    { scope: `support.constant.property-value`, settings: { foreground: `#666666` } },
    { scope: `support.constant.font-name`, settings: { foreground: `#BD5800` } },
    {
    ...
    { scope: `inline-color-decoration rgb-value`, settings: { foreground: `#BD5800` } },
    ...
    { scope: `invalid.illegal.bad-ampersand.html`, settings: { foreground: `#666666` } },
    { scope: `markup.heading`, settings: { foreground: `#D53538` } },
    {
      scope: [`markup.heading punctuation.definition.heading`, `entity.name.section`],
      settings: { foreground: `#751ED9` },
    },
    { scope: `entity.name.section.markdown`, settings: { foreground: `#D53538` } },
    { scope: `punctuation.definition.heading.markdown`, settings: { foreground: `#D53538` } },
    ...
    { scope: [`markup.bold`, `todo.bold`], settings: { foreground: `#BD5800` } },
    { scope: `punctuation.definition.bold`, settings: { foreground: `#BD5800` } },
    { scope: `punctuation.definition.bold.markdown`, settings: { foreground: `#BD5800` } },
    {
    ...
    { scope: `punctuation.definition.metadata.markdown`, settings: { foreground: `#D53538` } },
    {
      scope: [`markup.inline.raw.markdown`, `markup.inline.raw.string.markdown`],
      settings: { foreground: `#008809` },
    },
    { scope: `punctuation.definition.list.begin.markdown`, settings: { foreground: `#D53538` } },
    { scope: `punctuation.definition.list.markdown`, settings: { foreground: `#D53538` } },
    {
    ...
    { scope: `constant.other.character-class.regexp`, settings: { foreground: `#D53538` } },
    { scope: `keyword.operator.quantifier.regexp`, settings: { foreground: `#BD5800` } },
    ...
    { scope: `support.type.property-name.json`, settings: { foreground: `#D53538` } },
    { scope: `support.type.property-name.json punctuation`, settings: { foreground: `#D53538` } },
    {
