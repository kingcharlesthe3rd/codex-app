import { a as e, i as t, n, r } from "./src-4.js";
const i = {
...
const l = new (class {
    ...
    set(e, t) {
      return (
        (this.color = t), (this.changed = !1), (this.data = e), (this.type.type = s.ALL), this
      );
    }
    _ensureHSL() {
      let e = this.data,
...
function Je() {
  ...
  let v,
    ...
    C = qe();
  t.isSupported =
    typeof re == `function` && typeof _ == `function` && b && b.createHTMLDocument !== void 0;
  let {
      MUSTACHE_EXPR: ae,
      ERB_EXPR: oe,
      TMPLIT_EXPR: T,
    ...
    bt = function () {
      ...
      if (!(q && q === e)) {
        if (
          ((!e || typeof e != `object`) && (e = {}),
          (e = A(e)),
          (_t = vt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? `text/html` : e.PARSER_MEDIA_TYPE),
          (K = _t === `application/xhtml+xml` ? ge : he),
          (j = E(e, `ALLOWED_TAGS`) ? k({}, e.ALLOWED_TAGS, K) : Le),
          (M = E(e, `ALLOWED_ATTR`) ? k({}, e.ALLOWED_ATTR, K) : Re),
          (ft = E(e, `ALLOWED_NAMESPACES`) ? k({}, e.ALLOWED_NAMESPACES, ge) : pt),
          (st = E(e, `ADD_URI_SAFE_ATTR`) ? k(A(ct), e.ADD_URI_SAFE_ATTR, K) : ct),
          (at = E(e, `ADD_DATA_URI_TAGS`) ? k(A(ot), e.ADD_DATA_URI_TAGS, K) : ot),
          ...
          e.FORBID_CONTENTS && (U === it && (U = A(U)), k(U, e.FORBID_CONTENTS, K)),
          e.ADD_FORBID_CONTENTS && (U === it && (U = A(U)), k(U, e.ADD_FORBID_CONTENTS, K)),
          nt && (j[`#text`] = !0),
          ...
          : e.namespaceURI === lt
            ? t.namespaceURI === W
              ...
              : t.namespaceURI === ut
                ...
                : !!St[n]
            : e.namespaceURI === W
              ? (t.namespaceURI === ut && !ht[r]) || (t.namespaceURI === lt && !mt[r])
                ? !1
                : !St[n] && (gt[n] || !xt[n])
  ...
  let Et = function (e) {
      ...
      if (
        ...
        return (Y(e), !0);
      if (!(P.tagCheck instanceof Function && P.tagCheck(r)) && (!j[r] || Be[r])) {
        if (
          !Be[r] &&
          Ot(r) &&
        ...
        if (nt && !U[r]) {
          ...
          if (n && t) {
            ...
            for (let i = r - 1; i >= 0; --i) {
              let r = h(n[i], !0);
              ((r.__removalCount = (e.__removalCount || 0) + 1), t.insertBefore(r, ee(e)));
            }
          }
        }
        return (Y(e), !0);
    ...
    Dt = function (e, t, r) {
      if (He[t] || (B && (t === `id` || t === `name`) && (r in n || r in J))) return !1;
      if (
        !(Xe && !He[t] && D(ce, t)) &&
        !(Ye && D(le, t)) &&
          ...
          if (
            !(
              (Ot(e) &&
                ...
                ((N.attributeNameCheck instanceof RegExp && D(N.attributeNameCheck, t)) ||
    ...
    kt = function (e) {
      ...
      for (; i--; ) {
        ...
        if (
          ...
          (u = r.attrValue),
          V && (c === `id` || c === `name`) && (X(a, e), (u = `user-content-` + u)),
          $e &&
            D(
        ...
        if (v && typeof p == `object` && typeof p.getAttributeType == `function` && !o)
        ...
        if (u !== l)
          try {
            (o ? e.setAttributeNS(o, a, u) : e.setAttribute(a, u), Tt(e) ? Y(e) : fe(t.removed));
          } catch {
            X(a, e);
          }
      }
  ...
  return (
    (t.sanitize = function (e) {
      ...
      if ((et || bt(n), (t.removed = []), typeof e == `string` && (rt = !1), rt)) {
        if (e.nodeName) {
          let t = K(e.nodeName);
          if (!j[t] || Be[t]) throw xe(`root node is forbidden and cannot be sanitized in-place`);
        }
      } else if (e instanceof s)
        ((i = wt(`<!---->`)),
          (o = i.ownerDocument.importNode(e, !0)),
          (o.nodeType === We.element && o.nodeName === `BODY`) || o.nodeName === `HTML`
            ? (i = o)
            : i.appendChild(o));
      else {
        if (!L && !F && !I && e.indexOf(`<`) === -1) return v && z ? v.createHTML(e) : e;
      ...
      if (rt) return e;
      if (L) {
        if (R) for (l = ne.call(i.ownerDocument); i.firstChild; ) l.appendChild(i.firstChild);
        else l = i;
        return ((M.shadowroot || M.shadowrootmode) && (l = ie.call(r, l, !0)), l);
      }
...
` +
    ...
    (t.setConfig = function () {
      (bt(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}), (et = !0));
    }),
...
`,
  ...
  z = `#ffffff`,
  B = `#f2f2f2`,
  V = r((e, t) => (t ? x(e, { s: -40, l: 10 }) : x(e, { s: -40, l: -10 })), `mkBorder`),
  nt = class {
    static {
      r(this, `Theme`);
    }
    ...
    updateColors() {
      if (
        ...
        (this.primaryBorderColor = this.primaryBorderColor || V(this.primaryColor, this.darkMode)),
        ...
        (this.noteBorderColor = this.noteBorderColor || V(this.noteBkgColor, this.darkMode)),
        (this.noteBkgColor = this.noteBkgColor || `#fff5ad`),
        (this.noteTextColor = this.noteTextColor || `#333`),
        (this.secondaryTextColor = this.secondaryTextColor || S(this.secondaryColor)),
        (this.tertiaryTextColor = this.tertiaryTextColor || S(this.tertiaryColor)),
        ...
        (this.activationBorderColor = this.activationBorderColor || b(this.secondaryColor, 10)),
        (this.activationBkgColor = this.activationBkgColor || this.secondaryColor),
        (this.sequenceNumberColor = this.sequenceNumberColor || S(this.lineColor)),
        ...
        (this.activeTaskBkgColor = this.activeTaskBkgColor || y(this.primaryColor, 23)),
      ...
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        this.darkMode
          ? (this[`cScalePeer` + e] = this[`cScalePeer` + e] || y(this[`cScale` + e], 10))
      ...
      for (let t = 0; t < 5; t++)
        ((this[`surface` + t] =
          this[`surface` + t] || x(this.mainBkg, { h: 180, s: -15, l: e * (5 + t * 3) })),
          (this[`surfacePeer` + t] =
            this[`surfacePeer` + t] || x(this.mainBkg, { h: 180, s: -15, l: e * (8 + t * 3) })));
      ((this.classText = this.classText || this.textColor),
        ...
        (this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || z),
        (this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || B),
  ...
  H = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] =
          this[`surface` + e] || x(this.mainBkg, { h: 30, s: -30, l: -(-10 + e * 4) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || x(this.mainBkg, { h: 30, s: -30, l: -(-7 + e * 4) })));
      ...
      ((this.pieTitleTextSize = this.pieTitleTextSize || `25px`),
        ...
        (this.pieOpacity = this.pieOpacity || `0.7`));
      for (let e = 0; e < 8; e++)
        this[`venn` + (e + 1)] = this[`venn` + (e + 1)] ?? y(this[`cScale` + e], 30);
      ((this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor),
        (this.vennSetTextColor = this.vennSetTextColor ?? this.textColor),
        (this.quadrant1Fill = this.quadrant1Fill || this.primaryColor),
        (this.quadrant2Fill = this.quadrant2Fill || x(this.primaryColor, { r: 5, g: 5, b: 5 })),
    ...
    updateColors() {
      ...
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        ((this[`cScale` + e] = b(this[`cScale` + e], 10)),
          (this[`cScalePeer` + e] = this[`cScalePeer` + e] || b(this[`cScale` + e], 25)));
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        this[`cScaleInv` + e] = this[`cScaleInv` + e] || x(this[`cScale` + e], { h: 180 });
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] = this[`surface` + e] || x(this.mainBkg, { h: 30, l: -(5 + e * 5) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || x(this.mainBkg, { h: 30, l: -(7 + e * 5) })));
      if (
        ((this.scaleLabelColor =
  ...
  ot = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] =
          this[`surface` + e] || x(this.mainBkg, { h: 30, s: -30, l: -(5 + e * 5) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || x(this.mainBkg, { h: 30, s: -30, l: -(8 + e * 5) })));
      ((this.nodeBkg = this.mainBkg),
        (this.nodeBorder = this.border1),
        (this.clusterBkg = this.secondBkg),
        (this.clusterBorder = this.border2),
  ...
  ct = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        this[`cScaleLabel` + e] = this[`cScaleLabel` + e] || this.scaleLabelColor;
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] = this[`surface` + e] || x(this.mainBkg, { l: -(5 + e * 5) })),
          (this[`surfacePeer` + e] =
  ...
  ut = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] =
          this[`surface` + e] || x(this.mainBkg, { h: 180, s: -15, l: r * (5 + e * 3) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || x(this.mainBkg, { h: 180, s: -15, l: r * (8 + e * 3) })));
      ((this.classText = this.classText || this.textColor),
        ...
        (this.quadrant3Fill = this.quadrant3Fill || x(e, { r: 10, g: 10, b: 10 })),
        (this.quadrant4Fill = this.quadrant4Fill || x(e, { r: 15, g: 15, b: 15 })),
        (this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor),
        (this.quadrant2TextFill =
          this.quadrant2TextFill || x(this.primaryTextColor, { r: -5, g: -5, b: -5 })),
        (this.quadrant3TextFill =
  ...
  Dt = r(
    (e) => (
      (Z = R({}, X)),
      (Z = R(Z, e)),
      e.theme && q[e.theme] && (Z.themeVariables = q[e.theme].getThemeVariables(e.themeVariables)),
      Et(Z, Q),
      Z
    ),
    `setSiteConfig`,
  ...
  Nt = r((e) => {
    e &&
      ([`secure`, ...(Z.secure ?? [])].forEach((n) => {
        Object.hasOwn(e, n) &&
          (t.debug(`Denied attempt to modify a secure key ${n}`, e[n]), delete e[n]);
      }),
  ...
  zt = r((e) => {
    e && (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) && Rt(`LAZY_LOAD_DEPRECATED`);
  }, `checkConfig`),
  Bt = r(() => {
    let e = {};
    Tt && (e = R(e, Tt));
...
var Kt = r((e) => (Wt(), P.sanitize(e)), `removeScript`),
  ...
  fn = r(async (e, t) => {
    ...
    {
      let { default: n } = await import(`./katex-1.js`),
        r = t.forceLegacyMathML || (!cn() && t.legacyMathML) ? `htmlAndMathml` : `mathml`;
      return e
        .split(Ht)
        .map((e) =>
          un(e)
  ...
  bn = r((e, n, r, i) => {
    let a = ``;
    return (
      e in yn && yn[e] ? (a = yn[e]({ ...r, svgId: i })) : t.warn(`No theme found for ${e}`),
      ` & {
