...
function W(e) {
  ...
  if (g) {
    ...
    t[8] === n
      ? (e = t[9])
      : ((e = _(`flex h-full items-center justify-center bg-token-main-surface-primary`, n)),
        (t[8] = n),
        (t[9] = e));
    let r;
  ...
  return (
    t[13] !== n || t[14] !== m.contents || t[15] !== v
      ? ((y = (0, Q.jsx)(G, { className: n, contents: m.contents, filePath: v })),
        (t[13] = n),
        (t[14] = m.contents),
        (t[15] = v),
        (t[16] = y))
...
function G({ className: e, contents: n, filePath: r }) {
  ...
  function J(e) {
    R != null && (O(e), W({ chainId: R.chainId, endIndex: e, modelIndex: o, startIndex: e }));
  }
  function Y(e) {
    D == null ||
      R == null ||
  ...
  return (
    ...
    (0, Z.useEffect)(() => {
      let e = M.current;
      e == null || p !== `idle` || k == null || U == null || (e.zoomTo(U, 350, !0), e.render());
    }, [U, k, p]),
    P.length === 0 || F == null
      ? (0, Q.jsx)(ne, {
          className: e,
...
function K(e) {
  let t = (0, X.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = _(`h-2.5 w-2.5 rounded-sm`, r)), (t[0] = r), (t[1] = i));
  let a;
