...
import { C as te } from "./app-initial~app-main~worktree-init-v2-page~appgen-publication-terms-route~remote-conversati~oykv7gy7.js";
var a,
  o,
  ne = e(() => {
    (t(i()),
            ...
            (0, m.jsxs)(`defs`, {
              children: [
                (0, m.jsxs)(`linearGradient`, {
                  ...
                  children: [
                    (0, m.jsx)(`stop`, { stopColor: `#1293F1` }),
                    (0, m.jsx)(`stop`, { offset: 1, stopColor: `#043CCC` }),
                  ],
                }),
                (0, m.jsxs)(`radialGradient`, {
                  ...
                  children: [
                    (0, m.jsx)(`stop`, { offset: 0.0811439, stopColor: `#367AF2` }),
                    (0, m.jsx)(`stop`, { offset: 0.871875, stopColor: `#001A8F` }),
                  ],
                }),
                (0, m.jsxs)(`radialGradient`, {
                  ...
                  children: [
                    (0, m.jsx)(`stop`, { offset: 0.586954, stopColor: `#2763E5`, stopOpacity: 0 }),
                    (0, m.jsx)(`stop`, { offset: 0.973806, stopColor: `#58AAFE` }),
                  ],
                }),
                (0, m.jsxs)(`linearGradient`, {
                  ...
                  gradientUnits: `userSpaceOnUse`,
                  children: [
                    (0, m.jsx)(`stop`, { offset: 0.0673077, stopColor: `#59B6FB` }),
                    (0, m.jsx)(`stop`, { offset: 0.721154, stopColor: `#7A7CF4` }),
                  ],
                }),
              ],
            }),
            ...
            (0, _.jsxs)(`defs`, {
              children: [
                (0, _.jsxs)(`linearGradient`, {
                  ...
                  gradientUnits: `userSpaceOnUse`,
                  children: [
                    (0, _.jsx)(`stop`, { offset: 0.0240385, stopColor: `#F35AAA` }),
                    (0, _.jsx)(`stop`, { offset: 0.528846, stopColor: `#E1473D` }),
                    (0, _.jsx)(`stop`, { offset: 1, stopColor: `#B0212C` }),
                  ],
                }),
                (0, _.jsxs)(`radialGradient`, {
                  ...
                  children: [
                    (0, _.jsx)(`stop`, { stopColor: `#F8193E` }),
                    (0, _.jsx)(`stop`, { offset: 0.939062, stopColor: `#920616` }),
                  ],
                }),
                (0, _.jsxs)(`radialGradient`, {
                  ...
                  children: [
                    (0, _.jsx)(`stop`, { offset: 0.575893, stopColor: `#FFB055`, stopOpacity: 0 }),
                    (0, _.jsx)(`stop`, { offset: 0.973806, stopColor: `#FFF2BE` }),
                  ],
                }),
                (0, _.jsxs)(`linearGradient`, {
                  ...
                  gradientUnits: `userSpaceOnUse`,
                  children: [
                    (0, _.jsx)(`stop`, { stopColor: `#FF8F29` }),
                    (0, _.jsx)(`stop`, { offset: 0.850962, stopColor: `#FE80AD` }),
                  ],
                }),
              ],
            }),
            ...
            (0, y.jsxs)(`defs`, {
              children: [
                (0, y.jsxs)(`linearGradient`, {
                  ...
                  gradientUnits: `userSpaceOnUse`,
                  children: [
                    (0, y.jsx)(`stop`, { offset: 0.177885, stopColor: `#4AA647` }),
                    (0, y.jsx)(`stop`, { offset: 1, stopColor: `#13551B` }),
                  ],
                }),
                (0, y.jsxs)(`radialGradient`, {
                  ...
                  children: [
                    (0, y.jsx)(`stop`, { stopColor: `#20A85E` }),
                    (0, y.jsx)(`stop`, { offset: 0.94375, stopColor: `#09442A` }),
                  ],
                }),
                (0, y.jsxs)(`radialGradient`, {
                  ...
                  children: [
                    (0, y.jsx)(`stop`, { offset: 0.580357, stopColor: `#33A662`, stopOpacity: 0 }),
                    (0, y.jsx)(`stop`, { offset: 0.973806, stopColor: `#98F0B0` }),
                  ],
                }),
                (0, y.jsxs)(`linearGradient`, {
                  ...
                  gradientUnits: `userSpaceOnUse`,
                  children: [
                    (0, y.jsx)(`stop`, { stopColor: `#B5E480` }),
                    (0, y.jsx)(`stop`, { offset: 0.850962, stopColor: `#5FC34C` }),
                  ],
                }),
              ],
            }),
...
function Z(e, t) {
  ...
  let n = t ?? (e ? Le.lookup(e) : !1);
  if (typeof n == `string`) {
    let e = Be.find(({ prefix: e }) => n.startsWith(e));
    if (e) return e.key;
  }
  return `file`;
}
...
function He({ path: e, matchType: t }) {
  return t === `directory` ? Q.folder : Q[Z(e)];
}
function Ue() {
  return J;
}
...
function Ge({ brandColor: e, style: t }) {
  return e == null
    ? t
    : {
        ...t,
...
var Ke,
  ...
  $,
  Ze = e(() => {
    ((Ke = `group/inline-mention cursor-pointer`),
      (qe = `inline-mention-brand-aware font-medium text-[color:var(--inline-mention-color)] [--inline-mention-color:var(--inline-mention-resolved-base-color,var(--inline-mention-base-color))] [--inline-mention-base-color:color-mix(in_srgb,var(--color-token-text-link-foreground)_80%,var(--color-token-foreground)_20%)]`),
      (Je = `px-0.5`),
      (Ye = `relative mr-[3px] inline-block h-[1lh] w-4 align-bottom`),
      (Xe = `icon-xs absolute top-1/2 -translate-y-1/2`),
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~appgen-publication-terms-route~remote-conversati~coa484up.js.map
