...
import { h as d, o as f } from "./chunk-48.js";
import { t as p } from "./chunk-41.js";
import { t as m } from "./chunk-77.js";
import { r as h } from "./chunk-23.js";
var g = (function () {
...
var _ = g,
  ...
  pe = {
    ...
    draw: e(async function (e, n, r, i) {
      ...
      (d.insertTitle(u, `statediagramTitleText`, o?.titleTopMargin ?? 25, i.db.getDiagramTitle()),
    ...
    (t.trace(`items`, n),
      n.forEach((t) => {
        switch (t.stmt) {
          ...
          case C:
            {
              (X(e, t.state1, r, i, a, o, s, u), X(e, t.state2, r, i, a, o, s, u));
              let n = s === `neo`,
                d = {
                  id: `edge` + G,
                  start: t.state1.id,
...
var X = e((e, n, r, i, a, o, s, u) => {
    ...
    if ((t.info(`dataFetcher parsedItem`, n, f, m), d !== `root`)) {
      ...
      if (
        ...
        e &&
          e.id !== `root` &&
          (t.trace(`Setting node `, d, ` to be child of its parent `, e.id), (f.parentId = e.id)),
        (f.centerLabel = !0),
        n.note)
      ) {
        let e = {
    ...
    n.doc && (t.trace(`Adding nodes children `), me(n, n.doc, r, i, a, !o, s, u));
  }, `dataFetcher`),
  ge = e(() => {
    (W.clear(), (G = 0));
  }, `reset`),
  ...
  ve = class {
    ...
    addState(e, n = D, r = void 0, i = void 0, a = void 0, o = void 0, s = void 0, u = void 0) {
      let d = e?.trim();
      ...
      if (
        (i &&
          ...
          (Array.isArray(i) ? i : [i]).forEach((e) => this.addDescription(d, e.trim()))),
        a)
      ) {
        let e = this.currentDocument.states.get(d);
        if (!e) throw Error(`State not found: ${d}`);
      ...
      (o &&
        ...
        (Array.isArray(o) ? o : [o]).forEach((e) => this.setCssClass(d, e.trim()))),
        s &&
          (t.info(`Setting state styles`, d, s),
          (Array.isArray(s) ? s : [s]).forEach((e) => this.setStyle(d, e.trim()))),
        u &&
          (t.info(`Setting state styles`, d, s),
          (Array.isArray(u) ? u : [u]).forEach((e) => this.setTextStyle(d, e.trim()))));
    }
    clear(e) {
      ((this.nodes = []),
        (this.edges = []),
