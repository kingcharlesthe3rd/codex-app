...
import {
  ...
  r as Ra,
  t as za,
} from "./app-initial~app-main~worktree-init-v2-page~appgen-settings-page~page~appgen-publication-ter~g5252vxb.js";
import {
  A as Ba,
  D as Va,
  O as Ha,
...
var Jo,
  ...
  Zo = e(() => {
    (jo(),
      (Jo = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e),
      (Yo = 1e-7),
      (Xo = 12));
  }),
  Qo,
  ...
  is,
  as = e(() => {
    (Zo(), $o(), ts(), (ns = qo(0.33, 1.53, 0.69, 0.99)), (rs = es(ns)), (is = Qo(rs)));
  }),
  os,
  ss = e(() => {
    (as(), (os = (e) => ((e *= 2) < 1 ? 0.5 * rs(e) : 0.5 * (2 - 2 ** (-10 * (e - 1))))));
  }),
  cs,
  ls,
  us,
  ds = e(() => {
    ($o(), ts(), (cs = (e) => 1 - Math.sin(Math.acos(e))), (ls = es(cs)), (us = Qo(cs)));
  }),
  fs,
  ps,
  ms,
  hs = e(() => {
    (Zo(), (fs = qo(0.42, 0, 1, 1)), (ps = qo(0, 0, 0.58, 1)), (ms = qo(0.42, 0, 0.58, 1)));
  }),
  gs,
  _s = e(() => {
    ...
    (yo(),
      ...
      (ws = (e) => {
        if (bs(e)) {
          ...
          return (vo(Ss[e] !== void 0, `Invalid easing type '${e}'`, `invalid-easing-type`), Ss[e]);
        return e;
      }));
  }),
  K = e(() => {
...
function Ms(e, t) {
  let n = !1,
    ...
    h = () => {
      ...
      ((n = !1),
        bo.useManualTiming || (i.delta = r ? 1e3 / 60 : Math.max(Math.min(a - i.timestamp, Ns), 1)),
        (i.timestamp = a),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
  ...
  zs = e(() => {
    (K(),
      ...
      ({
        ...
        state: Ls,
        steps: Rs,
      } = Ms(typeof requestAnimationFrame < `u` ? requestAnimationFrame : Ao, !0)));
  });
function Bs() {
  Vs = void 0;
}
var Vs,
  ...
  Us = e(() => {
    (K(),
      ...
      (Hs = {
        now: () => (
          Vs === void 0 &&
            Hs.set(Ls.isProcessing || bo.useManualTiming ? Ls.timestamp : performance.now()),
          Vs
        ),
        set: (e) => {
  ...
  tc = e(() => {
    (K(),
      (Qs = { test: (e) => typeof e == `number`, parse: parseFloat, transform: (e) => e }),
...
var vc,
  ...
  Ec = e(() => {
    ((bc = (e) => ({
      ...
      (Cc = bc(`vh`)),
      (wc = bc(`vw`)),
      (Tc = { ...Sc, parse: (e) => Sc.parse(e) / 100, transform: (e) => Sc.transform(e * 100) }));
  }),
  Dc,
  Oc = e(() => {
    (tc(),
  ...
  Ac = e(() => {
    (yc(),
      ...
      (kc = {
        ...
        parse: (e) => (hc.test(e) ? hc.parse(e) : Dc.test(e) ? Dc.parse(e) : vc.parse(e)),
        transform: (e) =>
          typeof e == `string` ? e : e.hasOwnProperty(`red`) ? hc.transform(e) : Dc.transform(e),
        getAnimatableNone: (e) => {
          let t = kc.parse(e);
...
function Nc(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(ic)?.length || 0) + (e.match(jc)?.length || 0) > 0
  );
}
function Pc(e) {
  let t = e.toString(),
...
function Ic(e) {
  ...
  return (e) => {
    ...
    for (let a = 0; a < r; a++)
      if (((i += t[a]), e[a] !== void 0)) {
        let t = n[a];
        t === Rc ? (i += nc(e[a])) : t === zc ? (i += kc.transform(e[a])) : (i += e[a]);
      }
    return i;
  };
}
...
var Rc,
  ...
  Kc = e(() => {
    (Ac(),
      ...
      (Wc = (e) => (typeof e == `number` ? 0 : kc.test(e) ? kc.getAnimatableNone(e) : e)),
      (Gc = { test: Nc, parse: Fc, createTransformer: Ic, getAnimatableNone: Lc }));
  });
function qc(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function fl(e, t) {
  let n = { ...e, ...t },
    r = {};
  for (let i in n) e[i] !== void 0 && t[i] !== void 0 && (r[i] = ul(e[i])(e[i], t[i]));
  return (e) => {
...
function Tl(e, t = 100, n) {
  let r = n({ ...e, keyframes: [0, t] }),
    i = Math.min(Sl(r), Cl);
  return { type: `keyframes`, ease: (e) => r.next(i * e).value / t, duration: Bo(i) };
}
var El = e(() => {
  (K(), wl());
});
...
function Ml({
  ...
  let s = 5 / e,
    c = Nl(i, a, s);
  if (((e = zo(e)), isNaN(c))) return { stiffness: Al.stiffness, damping: Al.damping, duration: e };
  {
    let t = c ** 2 * r;
...
var Vl,
  ...
  Ul = e(() => {
    (K(),
      ...
      (Bl.applyToOptions = (e) => {
        let t = Tl(e, 100, Bl);
        return ((e.ease = t.ease), (e.duration = zo(t.duration)), (e.type = `keyframes`), e);
      }));
  });
function Wl({
  keyframes: e,
...
function ql(e, t, { clamp: n = !0, ease: r, mixer: i } = {}) {
  let a = e.length;
  if (
    (vo(a === t.length, `Both input and output ranges must be the same length`, `range-length`),
    a === 1)
  )
    return () => t[0];
...
function nu({ duration: e = 300, keyframes: t, times: n, ease: r = `easeInOut` }) {
...
var cu,
  lu = e(() => {
    (Gl(), ru(), Ul(), (cu = { decay: Wl, inertia: Wl, tween: nu, keyframes: nu, spring: Bl }));
  }),
  uu,
  du = e(() => {
    uu = class {
  ...
  mu = e(() => {
    (K(),
      ...
      (pu = class extends uu {
        ...
        pause() {
          ((this.state = `paused`), this.updateTime(Hs.now()), (this.holdTime = this.currentTime));
        }
        complete() {
      ...
      (Ku = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (Hu.add(this), Uu || ((Uu = !0), Fs.read(Bu), Fs.resolveKeyframes(zu)))
        ...
        cancel() {
          this.state === `scheduled` && (Hu.delete(this), (this.state = `pending`));
        }
        resume() {
...
function gd({ type: e, ...t }) {
  return md(e) && id() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
var _d = e(() => {
    (ad(), hd());
  }),
          ...
          ((this.animation = fd(t, n, r, c, i)),
            ...
            (this.animation.onfinish = () => {
              if (((this.finishedTime = this.time), !i)) {
                ...
                (this.updateMotionValue ? this.updateMotionValue(e) : Xu(t, n, e),
    ...
    (K(),
      ...
      (Td = class extends vd {
        ...
        updateMotionValue(e) {
          ...
          (t.setWithVelocity(o.sample(s - wd).value, o.sample(s).value, wd), o.stop());
        }
      }));
  }),
  Dd,
      ...
      (Dd = (e, t) =>
        t === `zIndex`
          ...
          : !!(
              typeof e == `number` ||
              Array.isArray(e) ||
              (typeof e == `string` && (Gc.test(e) || e === `0`) && !e.startsWith(`url(`))
            )));
  });
function kd(e) {
  let t = e[0];
...
var Fd,
  ...
  Ld = e(() => {
    (K(),
      ...
      (Id = Oo(() => Object.hasOwnProperty.call(Element.prototype, `animate`))));
  }),
  Rd,
  zd,
  Bd = e(() => {
      ...
      (zd = class extends uu {
        ...
        onKeyframesResolved(e, t, n, r) {
          ...
          let u = {
            ...
            d = !c && Pd(u) ? new Td({ ...u, element: u.motionValue.owner.current }) : new pu(u);
        ...
        get animation() {
          return (this._animation || (this.keyframeResolver?.resume(), Vu()), this._animation);
        }
        get duration() {
...
var Jd,
  Yd,
  Xd = e(() => {
    (K(), Zs(), (Jd = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u), (Yd = 4));
  });
function Zd(e, t) {
...
var Qd = e(() => {}),
  $d,
  ef = e(() => {
    (Mu(), ($d = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...Au])));
  }),
  tf,
  nf = e(() => {
  ...
  sf,
  cf = e(() => {
    (nf(), tc(), Ec(), af(), (of = [Qs, q, Sc, xc, wc, Cc, tf]), (sf = (e) => of.find(rf(e))));
  });
function lf(e) {
  return typeof e == `number` ? e === 0 : e === null ? !0 : e === `none` || e === `0` || Eo(e);
}
var uf = e(() => {
  K();
});
...
function Tf(e, t) {
  let n = Cf(e);
  return (n !== mf && (n = Gc), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
var Ef = e(() => {
  (Kc(), hf(), wf());
});
function Df(e, t, n) {
  ...
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !Of.has(t) && Pc(t).values.length && (i = e[r]), r++);
  }
    ...
    (ef(),
      ...
      (Af = class extends Ku {
        ...
        readKeyframes() {
          ...
          if ((this.resolveNoneKeyframes(), !$d.has(n) || e.length !== 2)) return;
          let [r, i] = e,
            a = sf(r),
            o = sf(i);
          if (a !== o)
        ...
        resolveNoneKeyframes() {
          let { unresolvedKeyframes: e, name: t } = this,
            n = [];
          for (let t = 0; t < e.length; t++) (e[t] === null || lf(e[t])) && n.push(t);
          n.length && Df(e, n, t);
        }
        measureInitialState() {
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = Lu[t](e.measureViewportBox(), window.getComputedStyle(e.current))),
    ...
    (K(),
      ...
      (Hf = class {
        ...
        getVelocity() {
          ...
          return Ho(parseFloat(this.current) - parseFloat(this.prevFrameValue), t);
        }
        start(e) {
          return (
            this.stop(),
    ...
    (dp(),
      (mp = (e, t) => {
        ...
        let r = fp(() => {
          ...
          (n.addEventListener(`keyup`, e, t), n.addEventListener(`blur`, () => pp(n, `cancel`), t));
        });
  ...
  let [r, i, a] = Qf(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        ...
        s = (e) => {
          o(e, r === window || r === document || n.useGlobalTarget || rp(r, e.target));
        },
        c = (e) => {
          o(e, !1);
        };
...
var Ap = e(() => {
  ...
  Mp,
  Np = e(() => {
    (Ac(), Kc(), cf(), af(), (jp = [...of, kc, Gc]), (Mp = (e) => jp.find(rf(e))));
  }),
  J = e(() => {
    (Bd(),
      Gd(),
    ...
    ((Yp = o()),
      ...
      (Qp = ({
        ...
        return (
          ...
          o === `popLayout` &&
            (e = (0, Yp.jsx)(Hp, { isPresent: n, anchorX: s, root: c, children: e })),
...
function km({ children: e, isValidProp: t, ...n }) {
  (t && Tm(t), (n = { ...(0, jm.useContext)(Fp), ...n }), (n.isStatic = eo(() => n.isStatic)));
  let r = (0, jm.useMemo)(
    () => n,
...
var zm = e(() => {}),
  ...
  Vm,
  Hm = e(() => {
    ((Bm = [`animate`, `whileInView`, `whileFocus`, `whileHover`, `whileTap`, `whileDrag`, `exit`]),
      (Vm = [`initial`, ...Bm]));
  });
function Um(e) {
...
function Km(e, t) {
  if (Um(e)) {
    ...
    return { initial: t === !1 || Rm(t) ? t : void 0, animate: Rm(n) ? n : void 0 };
  }
...
function th(e, { layout: t, layoutId: n }) {
  return (
    ju.has(e) || e.startsWith(`origin`) || ((t || n !== void 0) && (!!$m[e] || e === `opacity`))
  );
}
var nh = e(() => {
  (J(), eh());
...
function sh(e, t, n) {
  ...
  if (
    (t.transform || (o || n ? (r.transform = rh(t, e.transform, n)) : (r.transform &&= `none`)), s)
  ) {
...
function Dh(e, t, n, r) {
  let i = (0, Oh.useMemo)(() => {
    let n = Ch();
    return (xh(n, t, Th(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function Mh(e) {
  return typeof e != `string` || e.includes(`-`) ? !1 : !!(Ah.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
var Nh = e(() => {
  jh();
});
...
function qh(e, t, n) {
  let { style: r } = e,
    i = {};
  for (let a in r)
    (Tp(r[a]) || (t.style && Tp(t.style[a])) || th(a, e) || n?.getValue(a)?.liveStyle !== void 0) &&
      (i[a] = r[a]);
  return i;
}
var Jh = e(() => {
  ...
  Yh,
  Xh = e(() => {
    (Kh(), uh(), Jh(), (Yh = Gh({ scrapeMotionValuesFromProps: qh, createRenderState: lh })));
  });
function Zh(e, t, n) {
  let r = qh(e, t, n);
  for (let n in e)
    if (Tp(e[n]) || Tp(t[n])) {
      let t = Au.indexOf(n) === -1 ? n : `attr` + n.charAt(0).toUpperCase() + n.substring(1);
      r[t] = e[n];
    }
  return r;
}
var Qh = e(() => {
  ...
  $h,
  eg = e(() => {
    (Kh(), wh(), Qh(), ($h = Gh({ scrapeMotionValuesFromProps: Zh, createRenderState: Ch })));
  }),
  tg,
  ng = e(() => {
...
function gg(e, t, n, r, i) {
  ...
  u && !u.projection && i && (u.type === `html` || u.type === `svg`) && _g(l.current, n, i, d);
  let f = (0, yg.useRef)(!1);
...
function _g(e, t, n, r) {
  ...
  ((e.projection = new n(e.latestValues, t[`data-framer-portal-id`] ? void 0 : vg(e.parent))),
...
function xg(e, { forwardMotionProps: t = !1 } = {}, n, r) {
  ...
  function a(a, o) {
    ...
    if (!l && ro) {
      Cg(c, n);
      let t = wg(c);
      ((s = t.MeasureLayout), (u.visualElement = gg(e, d, c, r, t.ProjectionNode)));
    }
    return (0, Tg.jsxs)(Pm.Provider, {
      value: u,
      children: [
        s && u.visualElement ? (0, Tg.jsx)(s, { visualElement: u.visualElement, ...c }) : null,
...
function Og(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) => (a === `create` ? r : (n.has(a) || n.set(a, xg(a, void 0, e, t)), n.get(a))),
  });
}
var kg = e(() => {
  Dg();
...
function Ig(e) {
  return Fg(e) || Lg(e) || e.z || e.rotate || e.rotateX || e.rotateY || e.skewX || e.skewY;
}
function Lg(e) {
...
function Ug(e, { x: t, y: n }) {
  (Hg(e.x, t.translate, t.scale, t.originPoint), Hg(e.y, n.translate, n.scale, n.originPoint));
}
...
function qg(e, t) {
  (Kg(e.x, t.x, t.scaleX, t.scale, t.originX), Kg(e.y, t.y, t.scaleY, t.scale, t.originY));
}
var Jg,
  Yg,
  Xg = e(() => {
  ...
  g_ = e(() => {
    (J(),
      ...
      (h_ = class {
        ...
        measureViewportBox() {
          return this.current ? this.measureInstanceViewportBox(this.current, this.props) : r_();
        }
        getStaticValue(e) {
        ...
        getValue(e, t) {
          ...
          return (
            n === void 0 &&
              t !== void 0 &&
              ((n = Rf(t === null ? void 0 : t, { owner: this })), this.addValue(e, n)),
            n
          );
        }
        readValue(e, t) {
        ...
        on(e, t) {
          return (this.events[e] || (this.events[e] = new Lo()), this.events[e].add(t));
        }
        notify(e, ...t) {
...
var S_,
  C_ = e(() => {
    (J(),
      ...
      (S_ = class extends __ {
        constructor() {
          (super(...arguments), (this.type = `html`), (this.renderInstance = y_));
        }
        readValueFromInstance(e, t) {
          if (ju.has(t)) return this.projection?.isProjecting ? _u(t) : Ou(e, t);
          {
            let n = x_(e),
...
var D_ = e(() => {
  ...
  M_ = e(() => {
    ((A_ = r(d(), 1)),
      ...
      k_(),
      Nh(),
      (j_ = (e, t) => (Mh(e) ? new O_(t) : new S_(t, { allowProjection: e !== A_.Fragment }))));
  });
function N_(e, t, n) {
  let r = e.getProps();
...
var J_,
  ...
  tv = e(() => {
    (J(),
      ...
      (ev = (e, { keyframes: t }) =>
        t.length > 2 ? Q_ : ju.has(e) ? (e.startsWith(`scale`) ? Z_(t[1]) : X_) : $_));
  });
function nv({
  when: e,
  delay: t,
        ...
        (o) => {
          ...
          if (
            ((u.type === !1 || (u.duration === 0 && !u.repeatDelay)) &&
              (Md(u), u.delay === 0 && (d = !0)),
            (bo.instantAnimations || bo.skipAnimations) && ((d = !0), Md(u), (u.delay = 0)),
...
function sv(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    (U_(e, t), r.start(iv(t, r, i, e.shouldReduceMotion && $d.has(t) ? { type: !1 } : o, e, d)));
    let f = r.animation;
    f && c.push(f);
  }
  return (
  ...
  for (let c of e.variantChildren)
    (c.notify(`AnimationStart`, t),
      s.push(
        dv(c, t, {
          ...o,
          delay: n + (typeof r == `function` ? 0 : r) + lv(e.variantChildren, c, r, i, a),
...
function xv(e) {
  return (t) => Promise.all(t.map(({ animation: t, options: n }) => mv(e, t, n)));
}
function Sv(e) {
  let t = xv(e),
    n = Tv(),
  ...
  function o(a) {
    ...
    for (let t = 0; t < Dv; t++) {
      ...
      if (
        ...
        (p.protectedKeys = { ...u }),
        (!p.isActive && g === null) || (!m && !p.prevProp) || Im(m) || typeof m == `boolean`)
      )
        continue;
...
function qv(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.translate >= ry && e.translate <= iy) || isNaN(e.translate)) && (e.translate = 0));
}
function Jv(e, t, n, r) {
  (qv(e.x, t.x, n.x, r ? r.originX : void 0), qv(e.y, t.y, n.y, r ? r.originY : void 0));
}
function Yv(e, t, n) {
...
var $v,
  ...
  iy,
  ay = e(() => {
    (J(), ($v = 1e-4), (ey = 1 - $v), (ty = 1 + $v), (ny = 0.01), (ry = 0 - ny), (iy = 0 + ny));
  });
function oy(e) {
  return [e(`x`), e(`y`)];
}
...
function hy({ point: e }, t) {
  return { point: e, delta: my(e, _y(t)), offset: my(e, gy(t)), velocity: vy(t, 0.1) };
}
function gy(e) {
  return e[0];
}
    ...
    (J(),
      ...
      (yy = class {
        ...
        updateHandlers(e) {
          ...
          (this.removeListeners && this.removeListeners(), Is(this.updatePoint));
        }
      }));
  });
    ...
    (J(),
      ...
      (Iy = class {
            ...
            r !== this.constraints &&
              ...
              oy((e) => {
                this.constraints !== !1 &&
                  ...
                  (this.constraints[e] = Dy(n.layoutBox[e], this.constraints[e]));
              }));
        }
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (U_(this.visualElement, e), n.start(iv(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
        ...
        addListeners() {
          ...
          let e = this.visualElement.current,
            ...
            n = () => {
              ...
              rg(e) && e.current && (this.constraints = this.resolveRefConstraints());
            },
            { projection: r } = this.visualElement,
            i = r.addEventListener(`measure`, n);
          (r && !r.layout && (r.root && r.root.updateScroll(), r.updateLayout()), Fs.read(n));
          let a = Rv(window, `resize`, () => this.scalePositionWithinConstraints()),
  ...
  Hy = e(() => {
    (J(),
      ...
      (Vy = class extends kv {
        ...
        mount() {
          this.removePointerDownListener = Uv(this.node.current, `pointerdown`, (e) =>
  ...
  cb = e(() => {
    (K(),
      ...
      (sb = class {
        ...
        forEach(e) {
          (this.isDirty && this.children.sort(ab), (this.isDirty = !1), this.children.forEach(e));
        }
      }));
  });
function lb(e, t) {
...
function db(e, t, n, r, i, a) {
  i
    ? ((e.opacity = Qc(0, n.opacity ?? 1, vb(r))), (e.opacityExit = Qc(t.opacity ?? 1, 0, yb(r))))
  ...
  for (let i = 0; i < hb; i++) {
    ...
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || _b(o) === _b(s)
        ? ((e[a] = Math.max(Qc(gb(o), gb(s), r), 0)), (Sc.test(s) || Sc.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
...
function Tb(e, t, n, r, i) {
  return ((e -= t), (e = Bg(e, 1 / n, r)), i !== void 0 && (e = Bg(e, 1 / i, r)), e);
}
function Eb(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  if (
    (Sc.test(t) && ((t = parseFloat(t)), (t = Qc(o.min, o.max, t / 100) - o.min)),
    typeof t != `number`)
  )
    return;
  let s = Qc(a.min, a.max, r);
  (e === a && (s -= t), (e.min = Tb(e.min, t, n, s, i)), (e.max = Tb(e.max, t, n, s, i)));
}
...
var kb,
  Ab,
  jb = e(() => {
    (J(), Xg(), (kb = [`x`, `scaleX`, `originX`]), (Ab = [`y`, `scaleY`, `originY`]));
  });
function Mb(e) {
  ...
  Hb = e(() => {
    (K(),
      (Vb = class {
        ...
        remove(e) {
          if (
            (po(this.members, e), e === this.prevLead && (this.prevLead = void 0), e === this.lead)
          ) {
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = vx++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            Os.value && (hx.nodes = hx.calculatedTargetDeltas = hx.calculatedProjections = 0),
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0), this.nodes && this.nodes.forEach(ax), this.animationId++);
    }
    ...
    willUpdate(e = !0) {
      ...
      if (
        (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && Kb(this),
    ...
    scheduleUpdateProjection() {
      this.projectionUpdateScheduled ||
        ((this.projectionUpdateScheduled = !0), Fs.preRender(this.updateProjection, !1, !0));
    }
        ...
        if (
          ...
          e && e.layout && this.animationProgress !== 1
            ? ((this.relativeParent = e),
              ...
              Qv(this.relativeTargetOrigin, this.layout.layoutBox, e.layout.layoutBox),
              Sb(this.relativeTarget, this.relativeTargetOrigin))
            : (this.relativeParent = this.relativeTarget = void 0);
        }
        if (!(!this.relativeTarget && !this.targetDelta)) {
          if (
            (this.target || ((this.target = r_()), (this.targetWithTransforms = r_())),
            this.relativeTarget &&
            this.relativeTargetOrigin &&
            this.relativeParent &&
            this.relativeParent.target
              ? (this.forceRelativeParentToResolveTarget(),
                Xv(this.target, this.relativeTarget, this.relativeParent.target))
              : this.targetDelta
                ? (this.resumingFrom
    ...
    getClosestProjectingParent() {
      if (!(!this.parent || Fg(this.parent.latestValues) || Lg(this.parent.latestValues)))
    ...
    setAnimationOrigin(e, t = !1) {
      ...
      ((this.mixTargetDelta = (t) => {
        ...
        (sx(a.x, e.x, n),
          ...
          s && ((this.animationValues = i), db(i, r, this.latestValues, n, u, l)),
        ...
        (this.pendingAnimation = Fs.update(() => {
          ((Uy.hasAnimatedSinceResize = !0),
            ...
            (this.currentAnimation = rb(this.motionValue, [0, 1e3], {
              ...
              onComplete: () => {
                (Ws.layout--, e.onComplete && e.onComplete(), this.completeAnimation());
              },
            })),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(_x), this.currentAnimation.stop()),
    ...
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        ...
        (Sb(t, n), qg(t, i), Jv(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
    ...
    applyProjectionStyles(e, t) {
      ...
      this.options.layoutId && (e.pointerEvents = r === this ? Bh(t?.pointerEvents) || `` : `none`);
    }
    clearSnapshot() {
...
function px(e, t, n) {
  return e === `position` || (e === `preserve-aspect` && !Kv(Rb(t), Rb(n), 0.2));
}
function mx(e) {
    ...
    (Sx(),
      ...
      (Ex = qb({
        ...
        defaultParent: () => {
          if (!Tx.current) {
            let e = new Cx({});
            (e.mount(window), e.setOptions({ layoutScroll: !0 }), (Tx.current = e));
          }
          return Tx.current;
        },
        resetTransform: (e, t) => {
      ...
      (jx = class extends kv {
        mount() {
          ...
          e &&
            (this.unmount = tp(
              e,
              (e, t) => (Ax(this.node, t, `Start`), (e) => Ax(this.node, e, `End`)),
            ));
        }
        unmount() {}
      }));
...
function Rx({ root: e, ...t }) {
  ...
  let r = Vx.get(n),
    i = JSON.stringify(t);
  return (r[i] || (r[i] = new IntersectionObserver(Ux, { root: e, ...t })), r[i]);
}
function zx(e, t, n) {
  let r = Rx(t);
  return (
...
function vS(e, t = {}) {
  ...
  if (n) return hS(r);
  let i = oS(r());
  return ((0, yS.useInsertionEffect)(() => Dp(i, e, t), [i, JSON.stringify(t)]), i);
}
var yS,
  bS = e(() => {
    (J(), (yS = r(d(), 1)), Ip(), cS(), _S());
...
function NS(e, t, n, r, i, a) {
  MS(e, i, a);
  for (let o = 0; o < t.length; o++) e.push({ value: t[o], at: Qc(i, a, r[o]), easing: vs(n, o) });
}
var PS = e(() => {
  (J(), K());
});
    ...
    let g = 0,
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if ((T > 0 && Yl(u, T), c.length === 1 && c.unshift(null), m)) {
          (vo(m < GS, `Repeat count too high, must be less than 20`, `repeat-count-high`),
            (b = OS(b, m)));
          let e = [...c],
            t = [...u];
          ...
          for (let r = 0; r < m; r++) {
            ...
            for (let i = 0; i < e.length; i++)
              (u.push(t[i] + (r + 1)), y.push(i === 0 ? `linear` : vs(n, i - 1)));
          }
          FS(u, m);
        }
        let E = w + b;
...
function iC(e, t, n) {
  let r = [];
  return (
    zS(e, t, n, { spring: Bl }).forEach(({ keyframes: e, transition: t }, n) => {
      r.push(...nC(n, e, t));
    }),
    r
  );
    ...
    (fe(),
      (bC = Fe({
        detail: R([
          ...
          Fe({ error_code: Se().optional(), message: Se(), type: Se().optional() }).transform(
    ...
    ((CC = r(d(), 1)),
      ...
      (jC = (e) => {
        let {
          ...
          c = CC.useRef(null),
          [l, u] = CC.useState(!1),
          [d, f] = wn({ prop: r, defaultProp: i ?? !1, onChange: a, caller: TC });
        return (0, wC.jsx)(yi, {
          ...s,
      ...
      (NC = CC.forwardRef((e, t) => {
        ...
        return (
          CC.useEffect(() => (o(), () => s()), [o, s]), (0, wC.jsx)(Mi, { ...a, ...r, ref: t })
        );
      })),
      (NC.displayName = MC),
      (PC = `PopoverTrigger`),
      (FC = CC.forwardRef((e, t) => {
        ...
        return i.hasCustomAnchor ? s : (0, wC.jsx)(Mi, { asChild: !0, ...a, children: s });
      })),
      (FC.displayName = PC),
      (IC = `PopoverPortal`),
      ...
      (zC = (e) => {
        ...
        return (0, wC.jsx)(LC, {
          ...
          children: (0, wC.jsx)(it, {
            present: n || a.open,
            children: (0, wC.jsx)(Wi, { asChild: !0, container: i, children: r }),
          }),
        });
      }),
      (zC.displayName = IC),
      ...
      (VC = CC.forwardRef((e, t) => {
        ...
        return (0, wC.jsx)(it, {
          present: r || a.open,
          children: a.modal ? (0, wC.jsx)(UC, { ...i, ref: t }) : (0, wC.jsx)(WC, { ...i, ref: t }),
        });
      })),
      (VC.displayName = BC),
  ...
  (n[3] !== r || n[4] !== e || n[5] !== o || n[6] !== a || n[7] !== i
    ? ((p = () => {
            ...
            yw(e)
              .then((e) => {
                ((n = !0),
                  ...
                  !t &&
                    (c(!1), u(Sw(e, { isCopilotApiAvailable: r, useCopilotAuthIfAvailable: i }))));
              })
              .catch(() => {
        ...
        return (
          ...
          () => {
            ((t = !0), s != null && clearTimeout(s), e.removeAuthStatusCallback(d));
          }
        );
      }),
      (m = [e, r, o, a, i]),
...
function Fw(e) {
  let t = (0, Lw.c)(2),
    n;
  return (
    t[0] === e ? (n = t[1]) : ((n = e == null ? void 0 : { hostId: e }), (t[0] = e), (t[1] = n)),
    F(jn, n)
  );
}
function Iw(e) {
...
function tT() {
  ...
  let s = o,
    c;
  e[2] !== s || e[3] !== i
    ? ((c = s.find((e) => e.id === i) ?? null), (e[2] = s), (e[3] = i), (e[4] = c))
    : (c = e[4]);
  let l = c,
    u,
    d;
  (e[5] !== r || e[6] !== t || e[7] !== l || e[8] !== i
    ? ((u = () => {
        r || i == null || l != null || mn(t, V.ACTIVE_REMOTE_PROJECT_ID, void 0);
      }),
      (d = [r, t, l, i]),
      (e[5] = r),
      (e[6] = t),
  ...
  let g;
  return (
    e[15] !== s || e[16] !== l || e[17] !== f || e[18] !== p || e[19] !== m || e[20] !== h
      ? ((g = {
          isLoading: f,
...
var nT,
  ...
  aT = e(() => {
    ((nT = s()),
      ...
      Ht(),
      Da(),
      (iT = Ce(W, ({ sourceHostId: e, sourceGitRoot: t, sourceWorkspaceRoot: n }, { get: r }) => {
        if (e !== `local` || t == null || n == null) return [];
        let i = r($n),
          a = r(Ww, { params: { hostId: e, dirs: [n] }, source: `local_remote_dropdown` }),
          o = new Map();
        for (let e of r(Lt)) {
        ...
        for (let { hostDisplayName: e, hostId: i, projects: c } of o.values()) {
          ...
          u != null && s.push({ status: `ready`, hostDisplayName: e, project: u });
        }
        return s;
      })));
  });
...
function _T(e) {
  ...
  if (lT(e) || oT(e)) ((r = e), (t = vT(e)), (n = yT(e)));
    ...
    let o = e.name;
    if (((r = o), UT.call(e, `weight`) && ((i = e.weight), i <= 0))) throw Error(HT(o));
...
function ST(e, t, { getFn: n = Y.getFn, fieldNormWeight: r = Y.fieldNormWeight } = {}) {
  let i = new XT({ getFn: n, fieldNormWeight: r });
  return (i.setKeys(e.map(_T)), i.setSources(t), i.create(), i);
}
function CT(e, { getFn: t = Y.getFn, fieldNormWeight: n = Y.fieldNormWeight } = {}) {
...
function ET(
  ...
  for (; (_ = e.indexOf(t, m)) > -1; ) {
    let e = wT(t, { currentLocation: _, expectedLocation: f, distance: i, ignoreLocation: l });
...
function IT(e, t, { includeMatches: n = Y.includeMatches, includeScore: r = Y.includeScore } = {}) {
  let i = [];
  return (
    n && i.push(PT),
    r && i.push(FT),
...
var LT,
  ...
  CE = e(() => {
    ((LT = 1 / 0),
      ...
      (HT = (e) => `Property 'weight' in key '${e}' must be a positive integer`),
      ...
      (XT = class {
        constructor({ getFn: e = Y.getFn, fieldNormWeight: t = Y.fieldNormWeight } = {}) {
          ((this.norm = xT(t, 3)), (this.getFn = e), (this.isCreated = !1), this.setIndexRecords());
        }
        setSources(e = []) {
          this.docs = e;
        }
      ...
      ($T = class {
        ...
        searchIn(e) {
          ...
          if (((e = t ? e : e.toLowerCase()), (e = n ? QT(e) : e), this.pattern === e)) {
        ...
        _searchStringList(e) {
          ...
          return (
            n.forEach(({ v: e, i: n, n: i }) => {
              ...
              a &&
                r.push({ item: e, idx: n, matches: [{ score: o, value: e, norm: i, indices: s }] });
            }),
            r
          );
        }
...
function TE(e, t, n) {
  if (e == null) return e;
  if (n == null)
    return t === `reset` ? { ...e, available_count: Math.max(e.available_count - 1, 0) } : e;
  ...
  return r == null
    ...
    : {
        ...e,
        available_count:
          r.status === `available` ? Math.max(e.available_count - 1, 0) : e.available_count,
...
function jE(e) {
  return {
    enabled: e != null,
    queryFn: async () =>
      oa.safeGet(`/wham/tasks/{task_id}`, { parameters: { path: { task_id: e ?? `` } } }),
    queryKey: [`task`, e],
    staleTime: B.FIVE_SECONDS,
  };
}
function ME(e) {
  return {
    enabled: e != null,
    queryFn: async () =>
      oa.safeGet(`/wham/tasks/{task_id}/turns`, { parameters: { path: { task_id: e ?? `` } } }),
...
function IE(e) {
  let t = (0, AD.c)(2),
    n;
  return (t[0] === e ? (n = t[1]) : ((n = jE(e)), (t[0] = e), (t[1] = n)), D(n));
}
function LE(e, t, n) {
  let r = (0, AD.c)(11),
    i;
...
function RE(e, t, n) {
  ...
  return (
    r[6] !== i || r[7] !== a || r[8] !== o
      ? ((s = { queryKey: i, enabled: a, staleTime: B.FIVE_SECONDS, queryFn: o }),
        (r[6] = i),
        (r[7] = a),
        (r[8] = o),
        (r[9] = s))
...
function VE(e, t) {
  ...
  return (
    n[9] !== o || n[10] !== s || n[11] !== c || n[12] !== l
      ? ((u = { queryKey: o, enabled: s, queryFn: c, staleTime: B.FIVE_MINUTES, select: l }),
        (n[9] = o),
        (n[10] = s),
        (n[11] = c),
        (n[12] = l),
...
function GE(e) {
  ...
  return oa.safeGet(`/wham/environments/by-repo/{provider}/{repo_owner}/{repo_name}`, {
...
async function qE() {
  return JE((await be(`git-origins`, { source: `workspace_repo_owner_names` })).origins);
}
function JE(e) {
  let t = [];
...
async function XE({ repoName: e, filename: t, contentType: n, anticipatedFileSize: r }) {
...
async function eD(e) {
  ...
  if (
    ...
    for (let n of e.images) t.push(n);
  if (e.commentAttachments?.length) for (let n of e.commentAttachments) t.push(L(n));
...
function sD(e) {
  ...
  t[3] === a
    ? (c = t[4])
    : ((c = [`persistent-referral-invite-eligibility`, a]), (t[3] = a), (t[4] = c));
  let l;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = () => oa.safeGet(`/referrals/invite/eligibility`, { parameters: { query: s } })),
      (t[5] = l))
    : (l = t[5]);
  let u;
  return (
    t[6] !== i || t[7] !== c
      ? ((u = { enabled: i, queryKey: c, queryFn: l, staleTime: B.FIVE_SECONDS }),
        (t[6] = i),
        (t[7] = c),
        (t[8] = u))
      : (u = t[8]),
...
async function mD(e) {
  await oa.safePost(`/wham/tasks/{task_id}/cancel`, { parameters: { path: { task_id: e } } });
}
function hD() {
  let e = (0, AD.c)(2),
    t = ge(),
...
function CD(e) {
  ...
  t[0] === e
    ? (r = t[1])
    : ((r = () =>
        oa.safePost(`/wham/tasks/{task_id}/mark_read`, { parameters: { path: { task_id: e } } })),
      (t[0] = e),
      (t[1] = r));
  let i;
  t[2] !== n || t[3] !== e
...
function wD(e) {
  ...
  return (
    t[1] !== e || t[2] !== i
      ? ((a = { queryKey: r, queryFn: TD, staleTime: B.ONE_MINUTE, enabled: i, refetchOnMount: e }),
        (t[1] = e),
        (t[2] = i),
        (t[3] = a))
      : (a = t[3]),
...
function ED(e) {
  ...
  return (
    t[5] !== s || t[6] !== c
      ? ((l = { queryKey: s, queryFn: DD, staleTime: B.TEN_MINUTES, enabled: c }),
        (t[5] = s),
        (t[6] = c),
        (t[7] = l))
      : (l = t[7]),
...
function kD(e) {
  let t = (0, AD.c)(8),
    ...
    o = n?.account_ordering && n.account_ordering.length > 0 ? n.account_ordering[0] : void 0,
    s;
  t[0] !== o || t[1] !== n
...
function FD(e) {
  return (
    e === VD.EDUCATION_CBP || e === VD.DEPRECATED_EDU || e === VD.DEPRECATED_EDU_2 || e === `k12`
  );
}
function ID(e) {
  return e === VD.QUORUM;
...
function LD(e) {
  return e === VD.SELF_SERVE_BUSINESS || e === VD.SELF_SERVE_BUSINESS_USAGE_BASED;
}
function RD(e) {
  return (
    e === `business` ||
  ...
  switch (e.routeKind) {
    case `home`:
      return {
        ...
        entrypoint: `home`,
        ...(t?.focusComposerNonce == null ? {} : { focusComposerNonce: t.focusComposerNonce }),
        kind: `new`,
        routeConversationId: n,
      };
    case `new-thread-panel`:
      return { aeonStartTarget: null, entrypoint: `panel`, kind: `new`, routeConversationId: n };
    case `local-thread`:
...
var JD,
  YD = e(() => {
    (h(),
      ...
      (JD = b(`ComposerScope`, {
        key: (e) =>
          e.kind === `new` && e.entrypoint === `home` && e.focusComposerNonce != null
...
function XD({ cwd: e, hostId: t, isFollowUp: n = !1, isLoading: r = !1 }) {
  return n || r || e == null || e === `/` || e === `~` ? null : JSON.stringify([t, e]);
}
function ZD(e, t) {
  ...
  PO = e(() => {
    (h(),
      ...
      (MO = H(sn, ({ get: e }) => {
        ...
        return (
          bO(
            r.filter((e) => !gO(e) && e.previous_turn_id === n.previous_turn_id),
            n.id,
          ) ?? n
        );
      })),
...
function Ok(e) {
  return { browserUse: e.formatMessage(RO.label), computerUse: e.formatMessage(Hk.computerUse) };
}
function kk() {
  return { browserUse: RO.label.defaultMessage, computerUse: Hk.computerUse.defaultMessage };
}
function Ak(e) {
  let t = e?.brandColor;
...
function jk({ conversationId: e, displayName: t }) {
  let n = Nk(t);
  return { kind: `agent`, name: n.toLowerCase(), displayName: n, conversationId: e, path: $O(e) };
}
function Mk(e) {
  return { kind: `agent`, name: e.roleName, displayName: e.roleName, path: ek(e.roleName) };
}
function Nk(e) {
  let t = e.trim();
...
function Wk(e) {
  ...
  for (let e of Gk) if (e.hostnames.some((e) => t === e || t.endsWith(`.${e}`))) return e;
  return null;
}
var Gk,
  Kk = e(() => {
...
function Jk(e) {
  ...
  let n = new URL(t),
    r = Wk(t);
  return r == null ? null : { displayText: Xk(t, n, r), href: t, sourceAppId: r.appId };
}
...
function lA(
  e,
  t,
  { restoreMarkdownLinksAsTextLinks: n = !1, restorePathLinksAsFileMentions: r = !0 } = {},
) {
  ...
  for (; m < t.length; ) {
    ...
    let D = yk({ href: T, label: C }),
      ...
      k = bk(C);
    if (o && D === `plugin`)
      p.push(o.create({ name: k, displayName: k, path: T, description: ``, iconSmall: `` }));
    else if (D === `app` || D === `skill`) {
      let t = C.startsWith(`$`) ? k : C;
      D === `app` && a
        ? p.push(a.create({ name: ZO(t), displayName: t, path: T, description: ``, iconSmall: `` }))
        : D === `skill` && i
          ? p.push(
              i.create({ name: t, displayName: Ct(t), path: T, description: ``, iconSmall: `` }),
            )
          : p.push(e.text(`[${S}](${b})`));
    } else if (D === `agent` && c) {
      ...
      n != null || r != null || i != null
        ? p.push(c.create({ name: t, displayName: t, conversationId: n, path: T }))
        : p.push(e.text(`[${S}](${b})`));
    } else if (D === `mcp-resource` && l) {
      let t = mk(T);
      t == null ? p.push(e.text(`[${S}](${b})`)) : p.push(l.create({ ...t, title: C }));
...
`)
    .map((t) =>
      i.create(
        null,
        lA(e, t, { restoreMarkdownLinksAsTextLinks: n, restorePathLinksAsFileMentions: r }),
      ),
    );
...
var fA,
  pA = e(() => {
    (hn(), Uk(), iA(), tn(), (fA = /^(?:[A-Za-z][A-Za-z0-9+.-]*:\/\/|www\.|mailto:|tel:)/));
  });
function mA(e, t) {
  let n = e.get(WA),
...
function SA(e, t, n) {
  ...
  r.length !== 0 &&
    hA(e, (e) => {
      e.selectedTextAttachments.push({ id: Kt(), text: n == null ? r : t, source: n });
    });
}
function CA(e, t, n) {
  let r = n.trim();
  ...
  lj = e(() => {
    ((AA = s()),
      ...
      (VA = H(JD, ({ get: e, scope: t }) => {
        ...
        switch (r.kind) {
          case `file`:
            return { ...n, fileAttachments: vr([...n.fileAttachments, r.file]) };
          case `image`: {
            let { image: e } = r;
            return {
              ...n,
              imageAttachments: [...n.imageAttachments.filter((t) => t.id !== e.id), e],
            };
          }
        }
      })),
...
async function dj(e, { directoryName: t, prompt: n } = {}) {
  if (!uj(e)) return { cwd: e[0] ?? null, projectlessOutputDirectory: null, workspaceRoots: e };
  let {
    cwd: r,
    outputDirectory: i,
    workspaceRoot: a,
  } = await be(`projectless-thread-cwd`, { params: { directoryName: t, prompt: n ?? null } });
  return { cwd: r, projectlessOutputDirectory: i, workspaceRoots: [a] };
}
async function fj({ projectId: e, projectWritableRoots: t, legacyRoot: n = e, prompt: r }) {
  ...
  return { cwd: a.cwd, workspaceRoots: [a.workspaceRoot, ...i], generatedWorkspace: a };
}
var pj = e(() => {
  (ve(), Ve());
});
function mj() {
  ...
  e[4] === n
    ...
    : ((c = (e) => {
        ...
        n((e) =>
          e.kind === `preparingApp` && e.hostId === r && e.plugin.plugin.id === a.plugin.id
            ? {
                ...i,
  ...
  e[6] === n
    ...
    : ((u = (e) => {
        ...
        n((e) =>
          e.kind === `preparingApp` && e.hostId === t && e.plugin.plugin.id === r
            ? { kind: `closed` }
            : e,
        );
      }),
  ...
  e[8] === n
    ...
    : ((f = (e) => {
        let { hostId: t, pluginId: r } = e;
        n((e) =>
          e.kind === `preparingApp` && e.hostId === t && e.plugin.plugin.id === r ? vj(t, e) : e,
        );
      }),
      (e[8] = n),
      (e[9] = f));
  ...
  e[18] === n
    ? (S = e[19])
    : ((S = (e) => {
        let { apps: t, browserExtensions: r, connectingAppId: i, options: a, plugin: o } = e,
          s = t.map(_j),
          c = s.find((e) => e.app.id === i);
        if (c == null) {
          n({ ...a, kind: `needsApps`, plugin: o, requiredApps: s, requiredBrowserExtensions: r });
          return;
        }
        n({
          ...a,
...
async function Oj(e) {
  let t = [],
    n = null;
  do {
    let r = await Yt(`list-experimental-features`, { hostId: e, cursor: n, limit: jj });
...
function Fj(e) {
  let t = (0, Ij.c)(10),
    ...
    c;
  t[0] === o ? (c = t[1]) : ((c = o === void 0 ? [] : o), (t[0] = o), (t[1] = c));
  let l = c,
    u;
  if (t[2] !== r || t[3] !== l) {
    let e;
    (t[5] === r ? (e = t[6]) : ((e = (e) => e.name === r), (t[5] = r), (t[6] = e)),
      (u = l.find(e)),
      (t[2] = r),
      (t[3] = l),
      (t[4] = u));
...
function Bj(e) {
  ...
  t[3] !== s?.accounts || t[4] !== u
    ? ((d = s?.accounts?.find((e) => e.id === u)), (t[3] = s?.accounts), (t[4] = u), (t[5] = d))
    : (d = t[5]);
  let f = d,
    p = f == null && (!l || c !== 0),
    m = n && r && p,
  ...
  t[6] === m
    ? (h = t[7])
    : ((h = { queryConfig: { enabled: m, staleTime: B.ONE_MINUTE } }), (t[6] = m), (t[7] = h));
  ...
  let S = x,
    C;
  t[10] === v ? (C = t[11]) : ((C = [`accounts`, `settings`, v]), (t[10] = v), (t[11] = C));
  let w = n && v != null && S && r,
    T;
  t[12] === v
    ? (T = t[13])
  ...
  let { data: O, isLoading: k } = D(E),
    A = !r || (y != null && (!S || (O?.beta_settings?.windows_computer_use ?? !1))),
    j = n && r && ((l && !p) || _ || k),
    M;
  return (
    t[18] !== A || t[19] !== j
      ? ((M = { enabled: A, isLoading: j }), (t[18] = A), (t[19] = j), (t[20] = M))
      : (M = t[20]),
    M
  );
}
...
var Uj,
  Wj,
  Gj = e(() => {
    ((Uj = s()), C(), (Wj = r(d(), 1)), fw(), dt(), je(), _t(), HD(), Ve(), Pt(), Lj());
  });
function Kj(e) {
  let t = (0, Jj.c)(12),
...
function rM(e) {
  ...
  let a = i,
    o;
  return (t[2] === a ? (o = t[3]) : ((o = a.find(iM)), (t[2] = a), (t[3] = o)), o?.enabled ?? !0);
}
function iM(e) {
  return e.name === oM;
}
...
function EN(e) {
  let t = 0;
  for (let n = 0; n < e.length; n += 1) t = (t * 31 + e.charCodeAt(n)) % DN.length;
  return DN[t] ?? ``;
}
var DN,
  ON = e(() => {
  ...
  try {
    let e = { path: r, hostId: t },
      i = await n.fetchQuery({
        queryFn: ({ signal: t }) => be(`read-file-binary`, { params: e, signal: t }),
...
function FN(e) {
  return {
    ...
    ...UN({ marketplaceName: e.marketplaceName, marketplacePath: e.marketplacePath }),
  };
}
...
function WN(e, t, n) {
  ...
  let E = Kj(w),
    O = t === void 0,
    k = vP({ codexHome: h, hostId: e, rootsOverrideCwd: t, workspaceRoots: m.data?.roots }),
    A = a && v && (t !== void 0 || m.isFetched),
    j;
  r[12] === Symbol.for(`react.memo_cache_sentinel`) ? ((j = cM()), (r[12] = j)) : (j = r[12]);
  let M = j,
    ...
    ? ((P = async () => {
        if (s != null) {
          let t = await Yt(`send-cli-request-for-host`, {
              ...
              params: { ...(k.length > 0 ? { cwds: k } : {}), installSuggestionPluginNames: s },
            }),
        ...
        let t = await Yt(
            ...
            d == null
              ...
              : { hostId: e, ...(k.length > 0 ? { cwds: k } : {}), marketplaceKinds: d },
          ),
          n = tP(t.marketplaces, u),
          r = xP(n, p.getQueryData(N)?.plugins),
          i = M == null ? r : pP({ buildFlavor: M, plugins: r }),
          a = RN(t.featuredPluginIds).filter((e) => !u.some((t) => e.endsWith(`@${t}`)));
        return {
          featuredPluginIds: M == null ? a : fP({ buildFlavor: M, featuredPluginIds: a }),
          marketplaceLoadErrors: t.marketplaceLoadErrors,
          marketplaces: gP(n),
  ...
  let ie = F.data?.marketplaceLoadErrors ?? OP,
    ...
    oe = (O && m.isLoading) || F.isLoading || C.isLoading || E.isLoading || x.isLoading,
    se = (O && m.isFetching) || F.isFetching || x.isFetching,
    ce;
  r[38] !== I || r[39] !== F
    ? ((ce = async () => {
        let e = (await F.refetch()).data?.plugins ?? MP;
        return { availablePlugins: rP({ plugins: e, ...I }), installedPlugins: iP(e) };
      }),
      (r[38] = I),
      (r[39] = F),
      (r[40] = ce))
...
function JN(e) {
  ...
  let s = rM(o),
    ...
    l;
  t[2] !== r || t[3] !== i
    ? ((l = [...wP, `marketplace-kind`, r, i]), (t[2] = r), (t[3] = i), (t[4] = l))
    : (l = t[4]);
  let u = l,
    d;
  t[5] !== r || t[6] !== i || t[7] !== c || t[8] !== u
    ? ((d = async () =>
        xP(
          (await Yt(`list-plugins`, { hostId: r, marketplaceKinds: [i] })).marketplaces,
          c.getQueryData(u),
        )),
      (t[5] = r),
      (t[6] = i),
...
function XN(e, t, n = kP, r = null, i = !1, a = !1) {
  return r == null
    ? $N(
        e,
        t,
        QN({ additionalMarketplaceKinds: n, includeRemoteCatalog: !0, includeVerticalCatalog: !i }),
        i,
        a,
      )
...
function QN({ additionalMarketplaceKinds: e, includeRemoteCatalog: t, includeVerticalCatalog: n }) {
...
function aP({ enabled: e, hostId: t, installed: n, pluginId: r, queryClient: i }) {
  (i.setQueriesData({ queryKey: [...wP, t] }, (t) => {
    ...
    i.setQueriesData({ queryKey: [...wP, `detail`, t] }, (t) =>
      t == null || t.summary.id !== r || (t.summary.installed === n && t.summary.enabled === e)
        ? t
        : { ...t, summary: { ...t.summary, enabled: e, installed: n } },
    ));
}
function oP({ enabled: e, installed: t, pluginId: n, plugins: r }) {
  return r.some((r) => r.plugin.id === n && (r.plugin.installed !== t || r.plugin.enabled !== e))
    ? r.map((r) =>
        r.plugin.id === n ? { ...r, plugin: { ...r.plugin, enabled: e, installed: t } } : r,
      )
    : r;
}
function sP(
...
async function _P({ hostId: e, plugins: t, queryClient: n }) {
  ...
  return (await Promise.all(Array.from({ length: Math.min(EP, t.length) }, (e, t) => i(t))), r);
}
function vP({ codexHome: e, hostId: t, rootsOverrideCwd: n, workspaceRoots: r }) {
  let i = t === `local` && e != null ? qr(e, IP) : null;
  return yP([...(typeof n == `string` ? [n] : (n ?? r ?? [])), ...(i == null ? [] : [i])], e);
}
function yP(e, t) {
  return Array.from(new Set(e.map((e) => e.trim()).filter((e) => Me(e) && bP(e, t))));
}
function bP(e, t) {
  return t == null
    ? !0
...
function xP(e, t = MP) {
  ...
  for (let t of e)
    for (let e of t.plugins) {
      ...
      let s = null;
      if ((a.plugin.installed ? (s = a.plugin) : e.installed && (s = e), s == null)) {
        n.set(e.id, o);
        continue;
      }
      n.set(e.id, {
  ...
  let i = new Map(t.map((e) => [e.plugin.id, e])),
    ...
    o = Array.from(n.values()).map((e) => {
      ...
      return !e.plugin.installed || t == null || r.has(e.plugin.id)
        ? e
        : ((a ||=
            e.marketplaceName !== t.marketplaceName || e.marketplacePath !== t.marketplacePath),
          {
            ...t,
            plugin: {
              ...e.plugin,
              ...
              name: t.plugin.name,
              remotePluginId: t.plugin.remotePluginId ?? e.plugin.remotePluginId,
...
function SP(e, t) {
  ...
  if (c != null || l != null) return { composerIconPath: c, logoDarkPath: u, logoPath: l };
  let d = EN(e.id);
...
var CP,
  ...
  zP = e(() => {
    ((CP = s()),
      ...
      (LP = [`datadog`, `statsig`]),
      (RP = new Set([`codex-official`, Oe, ee, Be, `openai-primary-runtime`].map(mP))));
  });
  ...
  if (o == null)
    try {
      ...
      return (
        ...
        rF({ app: e, openInBrowser: r }) ? { kind: `browser-fallback` } : { kind: `failed` }
      );
    }
  if (o == null) return { kind: `failed` };
  let s = XP(o);
  if (YP(o) || s === `UNSUPPORTED`)
    return rF({ app: e, openInBrowser: r }) ? { kind: `browser-fallback` } : { kind: `failed` };
  try {
...
async function UP({
  ...
  if (t === `missing_link`) return HP({ app: e, openInBrowser: i, queryClient: a });
  let s = r?.trim();
  if (s)
    try {
      let t = (
...
var iF,
  ...
  gF = i((e, t) => {
    ...
    function o(e, t, o) {
      return (
        (e = i(e)), (t = o ? void 0 : t), t === void 0 ? (r(e) ? a(e) : n(e)) : e.match(t) || []
      );
    }
    t.exports = o;
  }),
...
function OF({ actions: e }) {
  return e
    .filter((e) => e.is_enabled !== !1 || e.disabled_reason === `disabled_by_admin`)
    .map((e) => ({
      accessBadges: kF(e),
      description: e.description,
...
function HF(e) {
  ...
  let a = i,
    o;
  return (t[2] === a ? (o = t[3]) : ((o = a.some(UF)), (t[2] = a), (t[3] = o)), o);
}
function UF(e) {
...
function qF(e) {
  ...
  t[6] === o
    ? (p = t[7])
    : ((p = async () => aI({ forceRefetch: !1, hostId: o })), (t[6] = o), (t[7] = p));
  let m = a && l && d,
    h;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = [`data`, `dataUpdatedAt`, `error`, `fetchStatus`, `status`]), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== f || t[10] !== p || t[11] !== m
    ? ((g = {
  ...
  t[16] !== l || t[17] !== _
    ...
    : (x = t[18]);
  let S;
  t[19] === y ? (S = t[20]) : ((S = async () => y.mutateAsync()), (t[19] = y), (t[20] = S));
  let C = b ?? _.error ?? null,
    w;
  return (
    t[21] !== y.isPending || t[22] !== _ || t[23] !== x || t[24] !== S || t[25] !== C
      ? ((w = {
          ..._,
          data: x,
...
function JF(e) {
  let t = (0, pI.c)(14),
    ...
    o = i ? n : void 0,
    s;
  t[0] === o ? (s = t[1]) : ((s = o == null ? void 0 : cI(o)), (t[0] = o), (t[1] = s));
  let c = s,
    l;
  t[2] === c ? (l = t[3]) : ((l = [...vI, ...(c ?? []).map(YF)]), (t[2] = c), (t[3] = l));
  let u = l,
    d;
  t[4] !== c || t[5] !== a
    ? ((d = async () => {
...
function $F(e) {
  let t = (0, pI.c)(5),
    n = e ?? ``,
    r;
  t[0] === n ? (r = t[1]) : ((r = BP(n, { includeActions: !0 })), (t[0] = n), (t[1] = r));
  let i = e != null,
    a;
  return (
    t[2] !== r || t[3] !== i
...
async function iI({ forceRefetch: e, hostId: t }) {
  try {
    let n = async (r) => {
      let i = await Yt(`list-apps`, { hostId: t, cursor: r, limit: mI, forceRefetch: e });
      return i.nextCursor == null ? i.data : [...i.data, ...(await n(i.nextCursor))];
    };
    return uI({ apps: await n(null) });
  } catch (e) {
    throw (
      l.error(`Failed to load apps list`, { safe: { error: String(e) }, sensitive: {} }),
      ...
      (MI = (e) =>
        (0, jI.jsxs)(`svg`, {
          ...
          children: [
            ...
            (0, jI.jsx)(`rect`, { x: 64.001, y: 114, width: 64, height: 12, rx: 6, fill: `white` }),
            (0, jI.jsx)(`rect`, { x: 64.001, y: 143, width: 48, height: 12, rx: 6, fill: `white` }),
            (0, jI.jsxs)(`defs`, {
              children: [
                (0, jI.jsxs)(`filter`, {
                  ...
                  children: [
                    (0, jI.jsx)(`feFlood`, { floodOpacity: 0, result: `BackgroundImageFix` }),
                    (0, jI.jsx)(`feBlend`, {
                      mode: `normal`,
                      in: `SourceGraphic`,
        ...
        (0, PI.jsxs)(`svg`, {
          ...
          children: [
            ...
            (0, PI.jsxs)(`g`, {
              ...
              children: [
                (0, PI.jsx)(`path`, { fill: `#0ebc5f`, d: `M24 32h160v128H24z` }),
                (0, PI.jsx)(`g`, {
            ...
            (0, PI.jsxs)(`defs`, {
              children: [
                ...
                (0, PI.jsxs)(`filter`, {
                  ...
                  filterUnits: `userSpaceOnUse`,
                  children: [
                    (0, PI.jsx)(`feFlood`, { floodOpacity: 0, result: `BackgroundImageFix` }),
                    (0, PI.jsx)(`feBlend`, {
                      in: `SourceGraphic`,
                      in2: `BackgroundImageFix`,
                      result: `shape`,
              ...
              children: [
                ...
                (0, LI.jsxs)(`linearGradient`, {
                  ...
                  children: [
                    ...
                    (0, LI.jsx)(`stop`, { offset: 0.78, stopColor: `#ffbe00`, stopOpacity: 0 }),
                  ],
                }),
                (0, LI.jsxs)(`filter`, {
                  ...
                  filterUnits: `userSpaceOnUse`,
                  children: [
                    (0, LI.jsx)(`feFlood`, { floodOpacity: 0, result: `BackgroundImageFix` }),
                    (0, LI.jsx)(`feBlend`, {
                      in: `SourceGraphic`,
                      in2: `BackgroundImageFix`,
                      result: `shape`,
            ...
            (0, iL.jsxs)(`defs`, {
              children: [
                ...
                (0, iL.jsxs)(`filter`, {
                  ...
                  filterUnits: `userSpaceOnUse`,
                  children: [
                    (0, iL.jsx)(`feFlood`, { floodOpacity: 0, result: `BackgroundImageFix` }),
                    (0, iL.jsx)(`feBlend`, {
                      in: `SourceGraphic`,
                      in2: `BackgroundImageFix`,
                      result: `shape`,
...
function OL(e) {
  if (e.type === `childList`) {
    ...
    for (let n of Array.from(e.addedNodes))
      n instanceof HTMLLinkElement && n.rel === `stylesheet` && (DL(n), (t = !0));
...
function kL() {
  ...
  (EL(),
    ...
    GL.observe(document.documentElement, { attributes: !0, attributeFilter: [`class`, `style`] }));
  let e = document.head;
  (e &&
...
function YL(e) {
  ...
  if (
    ...
    bb0: {
      ...
      let e;
      t[12] !== r || t[13] !== a
        ? ((e = XL({ appInfo: r, knownAppId: a })), (t[12] = r), (t[13] = a), (t[14] = e))
        : (e = t[14]);
      let n = e;
      if (n != null) {
        let e;
      ...
      if (
        ((f = ZL({ logoUrl: o ?? r?.logoUrl, logoDarkUrl: s ?? r?.logoUrlDark, isDarkTheme: l })),
  ...
  if (h != null) {
    ...
    return (
      t[18] !== n || t[19] !== h || t[20] !== u || t[21] !== d
        ? ((e = (0, rR.jsx)($L, { className: d, alt: n, connectorLogoRequest: h, fallback: u })),
          (t[18] = n),
          (t[19] = h),
          (t[20] = u),
          (t[21] = d),
  ...
  return (
    t[23] !== n || t[24] !== u || t[25] !== d || t[26] !== f
      ? ((g = (0, rR.jsx)(eR, { alt: n, className: d, src: f, fallback: u }, f)),
        (t[23] = n),
        (t[24] = u),
        (t[25] = d),
        (t[26] = f),
...
function $L(e) {
  ...
  return (
    t[0] !== r || t[1] !== n || t[2] !== o || t[3] !== a
      ? ((s = (0, rR.jsx)(eR, { className: n, alt: r, fallback: a, src: o }, o)),
        (t[0] = r),
        (t[1] = n),
        (t[2] = o),
        (t[3] = a),
...
function eR(e) {
  ...
  if (o) return a;
  let c;
  t[0] === r ? (c = t[1]) : ((c = G(`object-contain`, r)), (t[0] = r), (t[1] = c));
  let l;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = () => {
        s(!0);
...
function CR({ event: e, href: t, hostId: n, initiator: r, openTarget: i, originHostId: a }) {
  return (
    DR(t), wR({ event: e, href: t, hostId: n, initiator: r, openTarget: i, originHostId: a })
  );
}
function wR({
  disposition: e,
...
function NR({ localId: e, remoteId: t, pendingClientThreadId: n, pendingId: r }) {
...
function VR(e, t) {
  return re({ hostId: t?.hostId, pluginId: e.plugin.id, ...HN(e), source: t?.source });
}
function HR(e, t) {
  let n = fk(e);
...
function WR({ fallbackRequestedPluginId: e, plugins: t, requestedPluginId: n }) {
  if (le(n)) {
    let e = t.find((e) => ez(e, n));
    if (e != null) return e;
  }
  let r = t.find((e) => $R(e, n)) ?? null;
  return r != null || e == null || e === n ? r : WR({ plugins: t, requestedPluginId: e });
}
function GR(e) {
...
async function oz({ hostId: e, marketplacePath: t, pluginName: n }) {
  cz(n) && (await ut.chromeNativeHost?.install({ hostId: e, marketplacePath: t, pluginName: n }));
}
async function sz({ hostId: e, marketplaceName: t, pluginName: n }) {
  cz(n) && (await ut.chromeNativeHost?.uninstall({ hostId: e, marketplaceName: t, pluginName: n }));
}
function cz(e) {
...
function dz(e, t) {
  ...
  return (
    ...
    n.folderPath == null
      ...
      : u.dispatchMessage(`electron-set-active-workspace-root`, { root: n.folderPath }),
    n.projectId
  );
}
async function fz(e, t, n) {
  let r = e.query.snapshot(Rn, V.PROJECT_WRITABLE_ROOTS);
  (await r.getOrFetch(), r.setData((e) => ({ value: { ...pe(e?.value), [t]: n } })));
}
async function pz({
  ...
  if (o.folderPath != null) {
    (u.dispatchMessage(`electron-rename-workspace-root-option`, { root: o.folderPath, label: s }),
      a?.(o.folderPath, s));
    return;
  }
  let c = e?.[o.projectId];
...
async function mz({
  ...
  let l = yz(a),
    { roots: u } = await t({ legacyRoot: l.folderPath, projectId: l.projectId });
  return (
    await Promise.all(
      bz(s).map(async (t) => {
        ({ roots: u } = await e({ legacyRoot: l.folderPath, projectId: l.projectId, root: t }));
      }),
    ),
    u
  );
    ...
    c =
      s.metadataProjectId == null
        ...
        : [
            a(
              V.LOCAL_PROJECTS,
              Te({ localProjects: t ?? {}, projectId: s.metadataProjectId, project: null }),
            ),
...
async function xz({ projectId: e, prompt: t, validateProjectId: n = !1 }) {
  let [{ value: r }, { value: i }, a] = await Promise.all([
      ...
      n ? be(`workspace-root-options`, { params: { hostId: ka } }) : Promise.resolve(null),
    ]),
    o = He(r),
    s = Object.hasOwn(o, e);
...
`)}`,
  ...
  let l = await fj({ projectId: e, projectWritableRoots: c, legacyRoot: s ? null : e, prompt: t });
  return {
    cwd: l.cwd,
...
function Ez({
  ...
  let o = i ?? a;
  if (o?.hostId === t)
    return Dz({ type: `remote-project`, projectId: o.id, hostId: o.hostId, path: o.remotePath });
}
function Dz(e) {
  switch (e.type) {
    case `local-project`:
      return e.projectId == null || e.projectId === `~`
        ? void 0
        : { projectKind: `local`, projectId: e.projectId, pendingCoreUpdate: !1 };
    case `remote-project`:
      return {
        projectKind: `remote`,
    ...
    case `assignment`: {
      if (
        ...
        !(e.assignment.projectKind === `local`
          ...
          : e.executionHostId !== `local` &&
            (e.assignment.hostId == null || e.assignment.hostId === e.executionHostId))
      )
        return;
    ...
    ((Nz = r(d(), 1)),
      ...
      (Vz = (e) => {
        let {
          ...
          c = Rz(t),
          l = Nz.useRef(null),
          [u, d] = wn({ prop: i, defaultProp: a ?? !1, onChange: o, caller: Fz });
        return (0, Pz.jsx)(zz, {
          scope: t,
          triggerId: ua(),
          triggerRef: l,
      ...
      (fB = (e) => {
        let { __scopeDropdownMenu: t, children: n, open: r, onOpenChange: i, defaultOpen: a } = e,
          o = Rz(t),
          [s, c] = wn({ prop: r, defaultProp: a ?? !1, onChange: i, caller: `DropdownMenuSub` });
...
function GB(e) {
  ...
  return (
    t[8] !== i || t[9] !== a || t[10] !== o || t[11] !== c
      ? ((l = (0, X.jsx)(vB, { ref: i, "aria-disabled": o, className: c, ...a })),
        (t[8] = i),
        (t[9] = a),
        (t[10] = o),
        (t[11] = c),
...
function qB(e) {
  ...
  let P = N,
    ee = h ?? `icon-xs`,
    F;
  t[32] === ee ? (F = t[33]) : ((F = G(ee, pV.icon)), (t[32] = ee), (t[33] = F));
  let I = F,
    L;
        ...
        i == null
          ? (0, X.jsxs)(`div`, {
              ...
              children: [
                P,
                (0, X.jsx)(`span`, {
                  "data-tooltip-overflow-target": x === `trigger-overflows` ? `` : void 0,
                  className: G(`flex-1 min-w-0`, T ? `whitespace-normal` : `truncate`),
                  children: j,
                }),
                re,
              ],
              ...
              children: [
                ...
                (0, X.jsxs)(`div`, {
                  ...
                  children: [
                    (0, X.jsx)(`span`, {
                      "data-tooltip-overflow-target": x === `trigger-overflows` ? `` : void 0,
                      className: G(`min-w-0`, T ? `whitespace-normal` : `truncate`),
                      children: j,
                    }),
                    (0, X.jsx)(`span`, {
                      className: G(`min-w-0`, E ? `whitespace-normal` : `truncate`),
                      children: i,
                    }),
                  ],
                }),
  ...
  let R = ie,
    ...
    oe;
  t[49] !== o || t[50] !== ae
    ? ((oe = G(`no-drag`, pV.itemBase, ae, o)), (t[49] = o), (t[50] = ae), (t[51] = oe))
    : (oe = t[51]);
  let se = s ? void 0 : d,
    ce = s ? void 0 : f,
    le = c && `!text-token-foreground focus:!outline-none`,
    ue;
  t[52] === le ? (ue = t[53]) : ((ue = G(le, `flex flex-col`)), (t[52] = le), (t[53] = ue));
  let de;
  t[54] !== D || t[55] !== c || t[56] !== R || t[57] !== ue
    ...
    : (de = t[58]);
  let fe;
  t[59] !== s || t[60] !== p || t[61] !== oe || t[62] !== se || t[63] !== ce || t[64] !== de
    ? ((fe = (0, X.jsx)(CB, {
        asChild: !0,
        className: oe,
        onClick: se,
...
function JB(e) {
  ...
  let c = a ? `cursor-default opacity-50` : pV.itemInteractive,
    l;
  t[7] !== i || t[8] !== c
    ? ((l = G(`no-drag`, pV.itemBase, c, i)), (t[7] = i), (t[8] = c), (t[9] = l))
    : (l = t[9]);
  let u;
  t[10] === o
    ? (u = t[11])
  ...
  t[12] === r
    ? (d = t[13])
    : ((d = (0, X.jsx)(`span`, { className: `truncate`, children: r })), (t[12] = r), (t[13] = d));
  let f;
  t[14] === n
    ? (f = t[15])
    : ((f =
  ...
  let p;
  t[16] !== d || t[17] !== f
    ? ((p = (0, X.jsxs)(`div`, { className: `flex min-w-0 flex-1 flex-col`, children: [d, f] })),
      (t[16] = d),
      (t[17] = f),
      (t[18] = p))
    : (p = t[18]);
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, X.jsx)(DB, { children: (0, X.jsx)(li, { className: `icon-xs` }) })), (t[19] = m))
    : (m = t[19]);
  let h;
  t[20] === p
    ? (h = t[21])
  ...
  return (
    t[22] !== a || t[23] !== s || t[24] !== l || t[25] !== u || t[26] !== h
      ? ((g = (0, X.jsx)(wB, { className: l, disabled: a, onSelect: u, ...s, children: h })),
        (t[22] = a),
        (t[23] = s),
        (t[24] = l),
        (t[25] = u),
...
function YB(e) {
  let t = (0, cV.c)(6),
    ...
    o;
  t[0] !== r || t[1] !== a
    ? ((o = G(`inline-flex items-center justify-center leading-none`, a, pV.icon, r)),
      (t[0] = r),
      (t[1] = a),
      (t[2] = o))
    : (o = t[2]);
...
function XB(e) {
  ...
  return (
    t[8] !== i || t[9] !== a || t[10] !== o
      ? ((s = (0, X.jsx)(`input`, { className: a, autoFocus: !0, onKeyDown: o, ...i })),
        (t[8] = i),
        (t[9] = a),
        (t[10] = o),
        (t[11] = s))
...
function ZB(e) {
  ...
  t[6] === n
    ? (s = t[7])
    : ((s = G(pV.content, `px-[var(--padding-row-x)] py-[var(--padding-row-y)]`, n)),
      (t[6] = n),
      (t[7] = s));
  let c;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, X.jsx)(ln, { className: `icon-2xs shrink-0 text-token-text-tertiary` })),
      (t[8] = c))
    : (c = t[8]);
  let l;
  t[9] === r
  ...
  t[17] === o
    ? (f = t[18])
    : ((f = o ? (0, X.jsx)(`div`, { className: `shrink-0`, children: o }) : null),
      (t[17] = o),
      (t[18] = f));
  let p;
  return (
...
function $B(e) {
  let t = (0, cV.c)(6),
    ...
    a;
  t[0] !== n || t[1] !== i
    ? ((a = G(`w-full px-[var(--padding-row-x)]`, i, n)), (t[0] = n), (t[1] = i), (t[2] = a))
    : (a = t[2]);
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, X.jsx)(`div`, { className: `h-[1px] w-full bg-token-menu-border` })), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] === a
      ? (s = t[5])
      : ((s = (0, X.jsx)(`div`, { className: a, children: o })), (t[4] = a), (t[5] = s)),
    s
  );
}
function eV(e) {
  let t = (0, cV.c)(5),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = G(mV.sectionLabel, r)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
      ? ((a = (0, X.jsx)(`div`, { className: i, children: n })), (t[2] = n), (t[3] = i), (t[4] = a))
      : (a = t[4]),
    a
  );
}
function tV(e) {
  ...
  return (
    t[5] !== n || t[6] !== p
      ? ((m = (0, X.jsx)(`div`, { className: p, children: n })), (t[5] = n), (t[6] = p), (t[7] = m))
      : (m = t[7]),
    m
  );
}
  ...
  let ee =
      ...
      (0, X.jsx)(yB, {
        ...
        children: (0, X.jsx)(gV.Content, {
          ...
          style: { maxHeight: WB(b) ?? uV.maxHeight, zoom: x == null && k !== 1 ? k : void 0 },
          children: i,
        }),
      }),
    F;
  return (
    t[6] !== s || t[7] !== j || t[8] !== M.Root || t[9] !== N || t[10] !== P || t[11] !== ee
      ? ((F = (0, X.jsxs)(M.Root, {
          dir: s,
          modal: !1,
          open: N,
...
function rV(e) {
  ...
  if (t[0] !== o || t[1] !== l || t[2] !== n) {
    ...
    t[4] !== o || t[5] !== n.props
      ? ((e = (e) => {
          (n.props.onSelect?.(e),
            !e.defaultPrevented && (e.preventDefault(), e.stopPropagation(), !o && c(iV)));
        }),
        (t[4] = o),
        (t[5] = n.props),
        (t[6] = e))
    ...
    let d;
    t[11] === s ? (d = t[12]) : ((d = (0, X.jsx)(Ri, { className: s })), (t[11] = s), (t[12] = d));
    let f;
    t[13] !== i || t[14] !== d
      ? ((f = (0, X.jsx)(tS.span, {
          "aria-hidden": !0,
  ...
  t[22] === p
    ? (m = t[23])
    : ((m = (0, X.jsx)(lm, { initial: !1, children: p })), (t[22] = p), (t[23] = m));
  let h;
  return (
...
function aV(e) {
  ...
  if (
    ...
    let e =
      x === `bare`
        ? G(BB.content, `z-50 m-0 flex min-w-[180px] select-none flex-col overflow-y-auto p-0`)
        : G(
            BB.content,
    ...
    t[29] !== i || t[30] !== n || t[31] !== a || t[32] !== f
      ? ((S =
          ...
          (0, X.jsxs)(`div`, {
            className: pV.content,
            children: [
              i ? (0, X.jsx)(i, { className: G(a ?? `icon-xs`, pV.icon) }) : null,
              (0, X.jsx)(`span`, { className: `min-w-0 flex-1 truncate`, children: n }),
              (0, X.jsx)(Ri, {
                className: G(`icon-xs text-token-input-placeholder-foreground`, pV.icon),
              }),
            ],
          })),
        (t[29] = i),
    ...
    (t[34] !== b || t[35] !== s || t[36] !== u || t[37] !== S
      ? ((k = (0, X.jsx)(jB, { className: s, disabled: b, onClick: u, children: S })),
        (t[34] = b),
        (t[35] = s),
        (t[36] = u),
        (t[37] = S),
      ...
      (t[21] = D),
      (t[22] = O));
  } else ((C = t[17]), (w = t[18]), (T = t[19]), (E = t[20]), (D = t[21]), (O = t[22]));
  let k = !c,
    A = c ? dV : uV,
    j = S === 1 ? void 0 : S,
    M;
  ...
  t[50] === r
    ? (N = t[51])
    : ((N = (0, X.jsx)(`div`, { dir: `ltr`, children: r })), (t[50] = r), (t[51] = N));
  let P;
  ...
  let ee;
  t[58] !== w || t[59] !== P
    ? ((ee = (0, X.jsx)(w, { children: P })), (t[58] = w), (t[59] = P), (t[60] = ee))
    : (ee = t[60]);
  let F;
  return (
...
function sV(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, X.jsx)(`div`, { className: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
      ...
      (fV = (e) => {
        ...
        if (!r) {
          ...
          return (
            t[0] === n
              ? (e = t[1])
              : ((e = (0, X.jsx)(X.Fragment, { children: n })), (t[0] = n), (t[1] = e)),
            e
          );
        }
        let u;
        t[2] === a ? (u = t[3]) : ((u = G(`max-w-64 text-pretty`, a)), (t[2] = a), (t[3] = u));
        let d;
        t[4] !== u || t[5] !== r
...
function OV(e) {
  ...
  t[16] === u.subtitle
    ? (E = t[17])
    : ((E = (0, MV.jsx)(U, { ...u.subtitle })), (t[16] = u.subtitle), (t[17] = E));
  let D;
  t[18] !== T || t[19] !== E
    ? ((D = (0, MV.jsx)(Ua, { children: (0, MV.jsx)(qa, { title: T, subtitle: E }) })),
      (t[18] = T),
      (t[19] = E),
      (t[20] = D))
    : (D = t[20]);
  ...
  t[39] === s
    ? (F = t[40])
    : ((F = (0, MV.jsx)(kn, { color: `outline`, type: `button`, onClick: s, children: ee })),
      (t[39] = s),
      (t[40] = F));
  let I;
  ...
  t[42] === v
    ? (L = t[43])
    : ((L = (0, MV.jsx)(kn, { color: `primary`, type: `submit`, disabled: v, children: I })),
      (t[42] = v),
      (t[43] = L));
  let te;
  t[44] !== F || t[45] !== L
    ? ((te = (0, MV.jsx)(Ua, { children: (0, MV.jsxs)(Ga, { children: [F, L] }) })),
      (t[44] = F),
      (t[45] = L),
      (t[46] = te))
    : (te = t[46]);
  ...
  t[47] !== S || t[48] !== P || t[49] !== te || t[50] !== D
    ? ((ne = (0, MV.jsxs)(Ja, { as: `form`, onSubmit: S, children: [D, P, te] })),
      (t[47] = S),
      (t[48] = P),
      (t[49] = te),
      (t[50] = D),
...
function BV(e) {
  ...
  return (
    t[0] === e
      ? (n = t[1])
      : ((n = (0, KV.jsx)(XC, { "data-slot": `popover`, ...e })), (t[0] = e), (t[1] = n)),
    n
  );
}
function VV(e) {
  ...
  return (
    t[0] === e
      ? (n = t[1])
      : ((n = (0, KV.jsx)(ZC, { "data-slot": `popover-anchor`, ...e })), (t[0] = e), (t[1] = n)),
    n
  );
}
function HV(e) {
  ...
  return (
    t[0] === e
      ? (n = t[1])
      : ((n = (0, KV.jsx)(QC, { "data-slot": `popover-trigger`, ...e })), (t[0] = e), (t[1] = n)),
    n
  );
}
function UV(e) {
  ...
  return (
    t[22] !== S || t[23] !== p
      ? ((C = p ? S : (0, KV.jsx)($C, { children: S })), (t[22] = S), (t[23] = p), (t[24] = C))
      : (C = t[24]),
    C
  );
}
function WV(e) {
  ...
  return (
    t[5] !== r || t[6] !== i
      ? ((a = (0, KV.jsx)(`div`, { "data-slot": `popover-title`, className: i, ...r })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = a))
      : (a = t[7]),
...
function XV(e) {
  let t = (0, QV.c)(41),
    ...
    [y, b] = (0, $V.useState)(!1),
    x;
  t[0] === f ? (x = t[1]) : ((x = G(`h-7 w-7 rounded-md !p-1`, f)), (t[0] = f), (t[1] = x));
  let S;
  ...
  let T;
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, eH.jsx)(`div`, { className: `mx-3 border-t border-token-border` })), (t[19] = T))
    : (T = t[19]);
  let E;
...
var QV,
  ...
  nH = e(() => {
    ((QV = s()),
      ...
      YV(),
      (eH = o()),
      (tH = [`black`, `red`, `orange`, `yellow`, `green`, `blue`, `purple`, `pink`]));
  }),
  rH,
  iH,
  aH = e(() => {
...
function zU(e) {
  ...
  return (
    t[0] !== a || t[1] !== n
      ? ((o = (0, VU.jsx)(a, { className: n })), (t[0] = a), (t[1] = n), (t[2] = o))
      : (o = t[2]),
    o
  );
}
...
function WU(e) {
  ...
  if (r.marker.kind === `emoji`) {
    ...
    (t[0] === r.marker.emoji
      ? (e = t[1])
      : ((e = (0, KU.jsx)(`span`, { className: `leading-none`, children: r.marker.emoji })),
        (t[0] = r.marker.emoji),
        (t[1] = e)),
      (a = e));
    ...
    (t[2] === r.marker.icon
      ? (e = t[3])
      : ((e = (0, KU.jsx)(zU, { className: `icon-xs`, icon: r.marker.icon, source: `codex` })),
        (t[2] = r.marker.icon),
        (t[3] = e)),
      (a = e));
  }
...
function XU(e) {
  ...
  t[2] !== o || t[3] !== g || t[4] !== n || t[5] !== d
    ? ((y = (e) => {
        ...
        mn(d, V.PROJECT_APPEARANCES, te({ projectAppearances: g, projectId: n, appearance: e }));
      }),
      (t[2] = o),
      (t[3] = g),
      (t[4] = n),
  ...
  t[14] !== a || t[15] !== f
    ? ((E = _e.map((e) => ({
        ...
        icon:
          e === `folder`
            ? a
            : (0, QU.jsx)(zU, { className: `size-full`, icon: e, source: `codex` }),
  ...
  t[23] !== _ || t[24] !== a || t[25] !== l
    ? ((A =
        _ == null
          ? a
          : (0, QU.jsx)(WU, { appearance: _, className: l ?? `size-5`, fallbackIcon: a })),
      (t[23] = _),
      (t[24] = a),
      (t[25] = l),
      (t[26] = A))
...
function fW({ pendingRequestType: e, requests: t, resumeState: n, threadRuntimeStatus: r }) {
  return t == null || n == null
    ? null
    : n === `needs_resume`
      ? r?.type === `active` && r.activeFlags.includes(`waitingOnApproval`) && qn(t)
        ? `approval`
...
function _W(e, t) {
  ...
  if (t.type === `snapshot`) {
    ...
    return n.initialized &&
      ...
      : (e.set(TW, {
          ...
          hostsById: new Map(t.snapshot.hosts.map((e) => [e.hostId, e.isComplete])),
          entries: r,
          entriesByKey: i,
        }),
        `applied`);
  ...
  if (r.revision === n.revision) {
    ...
    return (e.set(TW, { ...n, isComplete: r.isComplete, hostsById: t }), `applied`);
  }
  ...
  for (let e of r.removedHostIds) for (let [t, n] of i) n.hostId === e && i.delete(t);
  return (
    e.set(TW, {
      initialized: !0,
      revision: r.revision,
...
function PW(e) {
  return e.some((e) => e === `waiting` || e === `unread`) ? nG : e.includes(`active`) ? tG : null;
}
function FW(e) {
  return e.length === 0
    ? QW
...
function LW(e, t) {
  return (
    e === t || (e != null && t != null && e.key === t.key && e.at === t.at && e.task === t.task)
  );
}
function RW(e, t) {
  return (
...
function zW(e, t, n) {
  ...
  let i = e(Ti, t),
    ...
    o = r?.summary ?? null;
  return KW(
    n === `updated_at` ? (a ?? o?.recencyAt ?? o?.updatedAt ?? null) : (i ?? o?.createdAt ?? null),
    i ?? o?.createdAt ?? null,
  );
}
function BW(e, t) {
  return KW(t === `updated_at` ? (e.recencyAt ?? e.updatedAt) : e.createdAt, e.createdAt);
}
function VW(e, t) {
  let n = MR(t);
  switch (n?.kind) {
...
function HW(e, t) {
  ...
  return (
    (n != null && e(Fi, t)?.getConversation(t) == null ? n.hasUnreadTurn : e(lW, t) === !0) ||
    e(kW).unreadAutomationThreadIds.has(t)
  );
}
...
var JW,
  ...
  DG = e(() => {
    (C(),
      ...
      (iG = oe(W, () => ({
        ...
        queryFn: async () => {
          try {
            ...
            if (e instanceof ke && (e.status === 401 || e.status === 403 || e.status === 404))
              return [];
            throw e;
          }
        },
      ...
      (aG = H(W, ({ get: e }) => e(Ut) ?? [])),
      (oG = H(W, ({ get: e }) =>
        (e(Ut) ?? []).filter((e) => e.autoConnect).sort((e, t) => e.hostId.localeCompare(t.hostId)),
      )),
      ...
      (uG = H(W, ({ get: e }) => {
        ...
        for (let n of new Set([ka, m, ...e(sG)]))
          for (let r of e(Qr, n)) {
            if (t.get(r)?.hasLiveConversation === !0 || e(ea, r) != null) continue;
            let i = t.get(r)?.summary ?? null;
            t.set(r, { hasLiveConversation: !0, summary: i?.hostId === n ? i : null });
          }
        return t;
      })),
      (dG = H(
        ...
        ({ get: e }) => {
          let t = e(xn),
            n = Array.from(e(uG).keys()).map((n) => ({ conversationId: n, at: zW(e, n, t) }));
          return n.length === 0
            ? XW
      ...
      (fG = Ce(W, (e, { get: t }) => t(iG).data?.find((t) => t.id === e) ?? null)),
      (pG = nt(W, (e) => {
        let t = null;
        return H(W, ({ get: n }) => {
          let r = n(xn),
          ...
          if (i?.hasLiveConversation === !1) {
            ...
            return t?.at === o.at && t.isInProgress === o.isInProgress && t.conversation === a
              ? t
              : ((t = o), o);
          }
          let a = n(Ti, e),
          ...
          return t != null &&
            ...
            (t.conversation.threadRuntimeStatus ?? null) === (m.threadRuntimeStatus ?? null) &&
      ...
      (mG = Ce(
        ...
        (e, { get: t }) => {
          let n = t(fG, e);
          return n == null ? null : { kind: `remote`, key: AR(n.id), at: GW(n, t(xn)), task: n };
        },
        { isEqual: LW },
      )),
      (hG = Ce(
        ...
        (e, { get: t }) => {
          ...
          return n == null
            ? null
            : { kind: `pending-worktree`, key: jR(n.id), at: n.createdAt, pendingWorktree: n };
        },
        { isEqual: RW },
      )),
      (gG = Ce(W, (e, { get: t }) => {
        ...
        switch (n?.kind) {
          case `local`: {
            ...
            return {
              ...
              workspaceKind: t(an, n.conversationId) ?? r?.workspaceKind ?? null,
            };
          }
          case `remote`:
            return t(mG, n.taskId);
      ...
      (bG = H(W, ({ get: e }) => [...e(yG)].sort((t, n) => VW(e, n) - VW(e, t)), { isEqual: jW })),
      (xG = Ce(
        W,
        (e, { get: t }) =>
          e.length === 0
      ...
      (CG = Ce(W, (e, { get: t }) => {
        ...
        switch (n?.kind) {
          ...
          case `remote`: {
            ...
            let i = r?.task_status_display?.latest_turn_status_display?.turn_status;
            return i === `in_progress` || i === `pending` ? `active` : `idle`;
          }
          case `pending-worktree`:
            return t(lG, n.pendingWorktreeId)?.needsAttention === !0 ? `waiting` : `idle`;
          case void 0:
            return `idle`;
        }
      })),
      (wG = Ce(W, (e, { get: t }) => PW(e.map((e) => t(CG, e))))),
      (TG = Ce(W, (e, { get: t }) => (e.length === 0 ? eG : IW(e.map((e) => t(CG, e)))))),
      (EG = Ce(W, (e, { get: t }) =>
        e.flatMap((e) => {
          let n = t(_G, e);
          return n == null ? [] : [n];
...
function OG(e) {
  return e.flatMap((e) => {
    ...
    if (e.kind === `remote`) {
      ...
      return n || !r ? [] : [{ kind: `remote`, taskId: e.task.id, threadKey: AR(e.task.id) }];
    }
    return [];
  });
}
...
function IG(e) {
  ...
  let f;
  t[9] !== u || t[10] !== d
    ? ((f = (0, RG.jsx)(Ua, { children: (0, RG.jsx)(qa, { title: u, subtitle: d }) })),
      (t[9] = u),
      (t[10] = d),
      (t[11] = f))
    : (f = t[11]);
  ...
  let _;
  t[20] !== s || t[21] !== g
    ? ((_ = (0, RG.jsx)(kn, { color: `danger`, type: `submit`, disabled: s, children: g })),
      (t[20] = s),
      (t[21] = g),
      (t[22] = _))
    : (_ = t[22]);
  let v;
  t[23] !== _ || t[24] !== h
    ? ((v = (0, RG.jsx)(Ua, { children: (0, RG.jsxs)(Ga, { children: [h, _] }) })),
      (t[23] = _),
      (t[24] = h),
      (t[25] = v))
    : (v = t[25]);
  ...
  return (
    t[30] !== c || t[31] !== y
      ? ((b = (0, RG.jsx)(Va, { open: !0, onOpenChange: c, size: `compact`, children: y })),
        (t[30] = c),
        (t[31] = y),
        (t[32] = b))
      : (b = t[32]),
...
function BG(e) {
  ...
  let _ = g,
    v;
  return (
    t[13] !== h.length || t[14] !== _ || t[15] !== d || t[16] !== o || t[17] !== n
      ? ((v = (0, qG.jsx)(IG, {
          open: !0,
          onOpenChange: o,
          onConfirm: _,
      ...
      m == null ||
        ...
        (async () => {
          try {
            ...
            a.get(ji).danger(o.formatMessage(JG.removeError, { projectLabel: t }));
          } finally {
            c(!1);
          }
        })());
...
function HG({ projectId: e, projectLabel: t, onOpenChange: n, onDropdownOpenChange: r }) {
  let i = x(W),
    a = ya(),
    [o, s] = (0, KG.useState)(!1),
    { data: c } = cw(V.PROJECT_ORDER),
    { data: l } = cw(V.PINNED_PROJECT_IDS),
    { remoteProjects: u, selectedRemoteProjectId: d, setRemoteProjects: f } = tT();
  return (0, qG.jsx)(UG, {
    projectLabel: t,
    isRemoving: o,
    removeDisabled: !1,
      ...
      o ||
        ...
        (async () => {
          try {
            ...
            i.get(ji).danger(a.formatMessage(JG.removeError, { projectLabel: t }));
          } finally {
            s(!1);
          }
        })());
...
function UG(e) {
  ...
  t[8] === l
    ? (d = t[9])
    : ((d = (0, qG.jsx)(Ua, { children: (0, qG.jsx)(qa, { title: l, subtitle: u }) })),
      (t[8] = l),
      (t[9] = d));
  let f;
  ...
  let _;
  t[18] !== g || t[19] !== h
    ? ((_ = (0, qG.jsx)(kn, { color: `danger`, type: `submit`, disabled: h, children: g })),
      (t[18] = g),
      (t[19] = h),
      (t[20] = _))
    : (_ = t[20]);
  let v;
  t[21] !== _ || t[22] !== m
    ? ((v = (0, qG.jsx)(Ua, { children: (0, qG.jsxs)(Ga, { children: [m, _] }) })),
      (t[21] = _),
      (t[22] = m),
      (t[23] = v))
    : (v = t[23]);
  ...
  return (
    t[28] !== s || t[29] !== y
      ? ((b = (0, qG.jsx)(Va, { open: !0, onOpenChange: s, size: `compact`, children: y })),
        (t[28] = s),
        (t[29] = y),
        (t[30] = b))
      : (b = t[30]),
...
function QG({ groups: e, includeEmptyGroup: t }) {
  return !t || e.some((e) => e.kind === `local`)
    ? e
    : [{ key: `local`, kind: `local`, hostId: null, hostDisplayName: null, threadKeys: [] }, ...e];
}
function $G(e, t) {
  let n = new Set(e.map((e) => e.key)),
...
function hK(e, t) {
  ...
  return e.map((e) => {
    let t = [...e.threadKeys].sort((e, t) => (n.get(e) ?? 2 ** 53 - 1) - (n.get(t) ?? 2 ** 53 - 1));
...
function vK(e, t, n) {
  ...
  return (e?.roots ?? []).map((a) => {
    let o = Pe(a),
      ...
      u = Ne(a, n),
      d = (e?.labels?.[a] ?? e?.labels?.[o] ?? ``).trim() || (0, WK.default)(EK(a)) || ``,
      f = i[o] ?? void 0,
...
function SK(e, t, n, r, i, a) {
  ...
  return (
    e.forEach((e) => {
      if (e.kind === `local`) qK(e, n, c, r, a?.gitOriginsByHostId, i, a?.primaryHostId, a);
...
function jK(e, t, n, r, i) {
  ...
  return Array.from(o.entries())
    .map(([e, t]) => ({ hostId: e, dirs: (0, GK.default)(t).sort((e, t) => e.localeCompare(t)) }))
    .filter(({ hostId: e, dirs: n }) => e === t || n.length > 0);
}
function MK(e, t) {
  let n = new Map(t.map(({ hostId: e, dirs: t }) => [e, new Set(t.map(Pe))]));
  return e
    .map(({ hostId: e, dirs: t }) => ({ hostId: e, dirs: t.filter((t) => !n.get(e)?.has(Pe(t))) }))
    .filter(({ dirs: e }) => e.length > 0);
}
function NK({ gitOrigins: e, gitOriginsByHostId: t, hostId: n, primaryHostId: r }) {
  return n && t?.[n] ? t[n] : n && t && n !== r ? [] : (e ?? []);
}
function PK(e, t) {
  let n = wK(e, t ?? []);
  return n?.commonDir
    ? Pe(n.commonDir).replace(/\/+$/, ``) !== `${Pe(n.root).replace(/\/+$/, ``)}/.git`
    : !1;
}
  ...
  let s = t[Pe(o)] ?? null,
    c =
      i.hostId === `local`
        ? OK(r, o)
        : (n.find(
            (e) => e.projectKind === `remote` && e.hostId === i.hostId && Pe(e.path) === Pe(o),
          ) ?? null);
  c &&
    ((s && c.repositoryData?.ownerRepo != null && !CK(c.repositoryData.ownerRepo, s)) ||
    ...
    ((HK = r(sK(), 1)),
      ...
      (qK = (e, t, n, r, i, a, o = ka, s) => {
        let c = e.hostId == null || A(e.hostId) ? o : e.hostId,
          ...
          d =
            u != null && (u.projectKind === `local` ? c === o : u.hostId != null && c === u.hostId)
              ? AK(u, t)
              : null;
        if (d != null) {
        ...
        let g = [];
        if (g.length === 1) {
          (t.find((e) => e.projectId === g[0]?.id) ?? null)?.threadKeys.push(e.key);
          return;
        }
        if (g.length > 1) return;
        let _ = NK({ gitOrigins: r, gitOriginsByHostId: i, hostId: c ?? void 0, primaryHostId: o });
        if (Ne(f, a) || (m && PK(f, _))) {
          let r = FK(f, e.conversationId, t, n, _, s?.threadWorkspaceRootHints, e.summary != null);
          r && (p = r);
        }
        ...
        y &&
          ...
          p !== f && s?.onDiscoverThreadWorkspaceRootHint?.(e.conversationId, y.path));
      }));
  });
function YK(e, t) {
  let n = Object.entries(t);
  if (n.length === 0 || e.get(Dt, V.THREAD_WORKSPACE_ROOT_HINTS).isLoading) return;
  ...
  vq = e(() => {
    (C(),
      ...
      (cq = H(W, ({ get: e }) => {
        let t = e(fr),
          n =
            e(dR, { hostConfig: e(Jn, t), operationSource: `sidebar_workspace_groups` }).data
              ?.available === !0,
          r = jK([], t, e(ar).data?.roots, []).find(({ hostId: e }) => e === t)?.dirs ?? iq;
        return e(Ww, {
      ...
      (mq = Ce(W, (e, { get: t }) => {
        ...
        let o = t(fr),
          ...
          m = Object.fromEntries(d.map(({ hostId: e }, t) => [e, p[t]?.data?.origins ?? aq]));
        ...
        let h = jK(s, o, r, u, t(jn, void 0).data?.codexHome),
          ...
          v = Object.fromEntries(g.map(({ hostId: e }, t) => [e, _[t]?.data?.origins ?? aq])),
          ...
          C = e.projectlessThreadIds == null ? void 0 : new Set(e.projectlessThreadIds);
        return {
          groups:
            s.length === 0
              ? b
              : SK(
                  ...
                  t(jn, void 0).data?.codexHome,
                  {
                    ...
                    threadWorkspaceRootHints: na(t, V.THREAD_WORKSPACE_ROOT_HINTS),
      ...
      (hq = Ce(W, (e, { get: t }) => {
        ...
        return eK(
          ZG({ groups: XG({ entries: t(EG, e), remoteConnections: n }), remoteConnections: r }),
          na(t, V.CONNECTION_GROUP_ORDER),
        );
      })),
      (gq = Ce(W, (e, { get: t }) => tq(e.groupIds, na(t, eq(e.organizeMode)), e.organizeMode))),
      (_q = Ce(W, (e, { get: t }) => {
        let n = e ?? [],
          r = t(sq, n).data;
        return {
...
function yq(e) {
  ...
  let c = s,
    ...
    g;
  t[2] !== m || t[3] !== r || t[4] !== d || t[5] !== p || t[6] !== f || t[7] !== u
    ? ((g = async (e) => {
...
function Cq(e) {
  ...
  let ee = wq,
    F;
  t[4] !== A || t[5] !== y || t[6] !== l || t[7] !== u || t[8] !== d || t[9] !== g || t[10] !== C
    ? ((F = async (e) => {
  ...
  t[18] === m
    ? (ae = t[19])
    : ((ae = (0, Z.jsx)(Ua, {
        children: (0, Z.jsx)(qa, { title: (0, Z.jsx)(Ka, { className: `contents`, children: m }) }),
      })),
      (t[18] = m),
      (t[19] = ae));
  let oe;
  ...
  t[21] === v
    ? (se = t[22])
    : ((se = (0, Z.jsx)(`label`, { htmlFor: v, className: `sr-only`, children: oe })),
      (t[21] = v),
      (t[22] = se));
  ...
  t[23] === ce
    ...
    : ((le = G(
      ...
      (t[24] = le));
  let ue;
  t[25] !== n || t[26] !== r || t[27] !== a || t[28] !== o || t[29] !== y || t[30] !== c
    ? ((ue =
        r == null
          ? null
          : (0, Z.jsx)(XU, {
  ...
  t[46] !== se || t[47] !== he
    ? ((z = (0, Z.jsx)(Ua, {
        className: `gap-2`,
        children: (0, Z.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [se, he] }),
      })),
      (t[46] = se),
      (t[47] = he),
      (t[48] = z))
    ...
    : ((we =
        C.length === 0
          ? (0, Z.jsxs)(`div`, {
              ...
              children: [
                (0, Z.jsx)(yV, { className: `icon-sm text-token-description-foreground` }),
                (0, Z.jsx)(`div`, {
  ...
  t[68] === l
    ? (Oe = t[69])
    : ((Oe = (0, Z.jsx)(kn, { color: `ghost`, type: `button`, onClick: l, children: De })),
      (t[68] = l),
      (t[69] = Oe));
  let ke;
  t[70] !== A || t[71] !== p
    ? ((ke = (0, Z.jsx)(kn, { color: `primary`, type: `submit`, loading: A, children: p })),
      (t[70] = A),
      (t[71] = p),
      (t[72] = ke))
    : (ke = t[72]);
  ...
  t[79] !== z || t[80] !== Te || t[81] !== je || t[82] !== R || t[83] !== ae
    ...
    : (Me = t[84]);
  let Ne;
  t[85] !== i || t[86] !== a || t[87] !== o || t[88] !== O || t[89] !== l || t[90] !== _
    ? ((Ne =
        O && i != null
          ? (0, Z.jsx)(VG, {
              project: i,
  ...
  return (
    t[92] !== Me || t[93] !== Ne || t[94] !== ie
      ? ((B = (0, Z.jsxs)(Va, { open: !0, onOpenChange: ie, size: `default`, children: [Me, Ne] })),
        (t[92] = Me),
        (t[93] = Ne),
        (t[94] = ie),
        (t[95] = B))
...
function wq() {
  u.dispatchMessage(`electron-pick-workspace-root-option`, { allowMultiple: !0 });
}
function Tq(e) {
  let t = (0, Aq.c)(20),
  ...
  let o = a,
    s;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Z.jsx)(yV, { className: `icon-sm shrink-0 text-token-description-foreground` })),
      (t[2] = s))
    : (s = t[2]);
  let c;
  t[3] === o
...
async function kq(e, t, n) {
  ...
  (await r.getOrFetch(),
    await mn(
      ...
      te({ projectAppearances: p(r.getData()?.value), projectId: t, appearance: n }),
    ));
}
var Aq,
  jq,
...
function Nq(e) {
  Ya(e, DV, {
    ...
    trimOnSave: !0,
    onSave: (e) => {
      u.dispatchMessage(`electron-create-new-workspace-root-option`, { projectName: e });
    },
  });
}
function Pq(e) {
...
function Fq(e, { initialName: t, initialSources: n, project: r, showDeleteAction: i }) {
  Ya(e, Sq, { initialName: t, initialSources: n, project: r, showDeleteAction: i });
}
function Iq() {
  u.dispatchMessage(`electron-add-new-workspace-root-option`, {});
}
function Lq({ hostId: e, setActive: t } = {}) {
  u.dispatchHostMessage({ type: `open-create-remote-project-modal`, hostId: e, setActive: t });
}
var Rq,
  zq = e(() => {
...
var Kq,
  ...
  _J = e(() => {
    (Kn(),
      ...
      (Qq = () => {
        u.dispatchHostMessage({ type: `navigate-to-route`, path: `/settings/mcp-settings` });
      }),
      ($q = () => {
        u.dispatchHostMessage({ type: `navigate-to-route`, path: `/settings/personalization` });
      }),
      (eJ = () => {
        u.dispatchHostMessage({ type: `navigate-to-route`, path: `/settings/keyboard-shortcuts` });
      }),
      (tJ = () => {
...
function vJ(e, t, n) {
  let r = (0, xJ.c)(21),
    i;
  r[0] === n ? (i = r[1]) : ((i = n === void 0 ? {} : n), (r[0] = n), (r[1] = i));
  let { contextHandler: a, enabled: o, isActive: s, keyboardHandler: c, menuItem: l } = i,
    u = o === void 0 ? !0 : o,
    d = x(W),
    f;
  ...
  let h = (0, SJ.useEffectEvent)(m),
    g;
  r[8] !== u || r[9] !== h || r[10] !== e || r[11] !== p || r[12] !== l || r[13] !== d
    ? ((g = () => {
        if (!u) return;
...
function FJ(e, t, n) {
  ...
  let d = u,
    ...
    p;
  r[4] !== a || r[5] !== d ? ((p = [...zJ, a, d]), (r[4] = a), (r[5] = d), (r[6] = p)) : (p = r[6]);
  let m = p,
    h;
  r[7] !== a || r[8] !== d
  ...
  r[10] !== f || r[11] !== m || r[12] !== h
    ? ((g = { queryKey: m, queryFn: h, enabled: f, staleTime: B.FIVE_MINUTES, gcTime: 1 / 0 }),
      (r[10] = f),
      (r[11] = m),
      (r[12] = h),
      (r[13] = g))
  ...
  r[22] !== a || r[23] !== o || r[24] !== d || r[25] !== m
    ? ((w = async function () {
        let e = await Yt(`list-skills-for-host`, { hostId: a, cwds: d, forceReload: !0 });
        o.setQueryData(m, e);
      }),
      (r[22] = a),
      (r[23] = o),
  ...
  let A = k,
    ...
    N;
  r[31] === _ ? (N = r[32]) : ((N = () => _.refetch()), (r[31] = _), (r[32] = N));
  let P;
  return (
    r[33] !== A || r[34] !== E || r[35] !== x || r[36] !== j || r[37] !== M || r[38] !== N
      ? ((P = {
          skills: x,
          isLoading: j,
          isFetching: M,
...
var LJ,
  ...
  zJ,
  BJ = e(() => {
    ((LJ = s()), C(), h(), (RJ = r(d(), 1)), wt(), Ai(), CJ(), Ht(), Ta(), je(), (zJ = [`skills`]));
  });
function VJ() {
  let e = (0, YJ.c)(28),
    t = x(W),
  ...
  e[0] === t
    ...
    : ((r = (e) => {
        ...
        (t.set($J, (e) => KJ(e, { oauthState: n, appId: r, resumeTarget: i })),
          t.set(eY, (e) => KJ(e ?? XJ, { oauthState: n, appId: r, resumeTarget: i })));
      }),
      (e[0] = t),
      (e[1] = r));
  let i = r,
  ...
  e[4] === t
    ...
    : ((s = (e) => {
        t.set($J, (t) => {
          let n = t[e];
          return n == null || !n.claimed ? t : { ...t, [e]: { ...n, claimed: !1 } };
        });
      }),
      (e[4] = t),
      (e[5] = s));
  ...
  e[8] === n
    ? (d = e[9])
    : ((d = (e, t) =>
        Object.values(n).some((n) => n.appId === e && n.completed && qJ(n.resumeTarget, t))),
      (e[8] = n),
      (e[9] = d));
  let f = d,
    p;
  e[10] === n
    ? (p = e[11])
    : ((p = (e, t) =>
        Object.values(n).some((n) => n.appId === e && n.claimed && qJ(n.resumeTarget, t))),
      (e[10] = n),
      (e[11] = p));
  let m = p,
    h;
  e[12] === n
    ? (h = e[13])
    : ((h = (e, t) => Object.values(n).some((n) => n.appId === e && qJ(n.resumeTarget, t))),
      (e[12] = n),
      (e[13] = h));
  let g = h,
    _;
  e[14] === t
    ? (_ = e[15])
    : ((_ = (e) => {
        let { app: n, hostId: r, redirectUrl: i, returnTo: a, resumeTarget: o } = e,
        ...
        (t.set($J, (e) => ({ ...e, [c]: l })),
          s.kind === `plugin-install` && t.set(eY, (e) => ({ ...(e ?? XJ), [c]: l })));
      }),
      (e[14] = t),
      (e[15] = _));
  let v = _,
...
function HJ() {
  let e = (0, YJ.c)(8),
    ...
    c;
  return (
    e[0] !== r || e[1] !== i || e[2] !== a || e[3] !== n || e[4] !== o || e[5] !== t || e[6] !== s
      ? ((c = async (e) => {
          ...
          if (u.length === 0) return (i({ oauthState: p }), { kind: `missing-callback-data` });
          r(u);
          let m;
          try {
            ...
            (GJ({ appId: e.link.connector_id, hostId: f, queryClient: t }),
              (m = { kind: `success`, appId: e.link.connector_id, appName: n }));
          } catch (e) {
            let t = e;
            l.error(`Failed to finish app OAuth callback`, { safe: {}, sensitive: { error: t } });
            let n = (t instanceof Error ? yC(t) : null)?.message.trim();
            m = n ? { kind: `request-failed`, message: n } : { kind: `request-failed` };
          }
          if (
            (m.kind === `success` &&
              n([`mcp-settings`, `app-connect`, m.appId]).catch((e) => {
                l.error(`Failed to refresh app connect state after OAuth callback`, {
                  safe: { appId: m.appId },
                  sensitive: { error: e },
                });
              }),
            m.kind === `success` && d?.resumeTarget.kind === `connector-auth-elicitation`)
          )
            try {
...
function GJ({ appId: e, hostId: t, queryClient: n }) {
  n.setQueryData(oI(t), (t) => t?.map((t) => (t.id === e ? { ...t, isAccessible: !0 } : t)));
}
function KJ(e, { oauthState: t, appId: n, resumeTarget: r }) {
  ...
  return n == null
    ? e
    : Object.fromEntries(
        Object.entries(e).filter(([, e]) => e.appId !== n || !qJ(e.resumeTarget, r)),
      );
}
function qJ(e, t) {
  if (t == null) return !0;
...
function nY(e) {
  ...
  let { hostId: r, onConnectStarted: i } = n,
    ...
    o = r ?? `local`,
    s = cn(`2761268526`),
    { clearPendingAppConnect: c, isAppConnectPending: l, markAppConnectOAuthPending: u } = VJ(),
  ...
  t[7] !== o || t[8] !== a?.location || t[9] !== u
    ? ((v = (e) => {
        ...
        u({ app: t, hostId: o, redirectUrl: n, returnTo: iY(a?.location), resumeTarget: r });
      }),
      (t[7] = o),
      (t[8] = a?.location),
      (t[9] = u),
...
function rY(e) {
  let t = e?.trim();
  t && TR({ href: t, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
}
function iY(e) {
  return e == null
...
function cY(e) {
  ...
  let Ae = I === `outline` && fe && !de ? `opacity-20` : `opacity-50`,
    je;
  t[70] === Ae ? (je = t[71]) : ((je = G(`icon-2xs`, Ae)), (t[70] = Ae), (t[71] = je));
  let Me;
  t[72] !== re || t[73] !== je
    ? ((Me = (0, fY.jsx)(re, { className: je })), (t[72] = re), (t[73] = je), (t[74] = Me))
    : (Me = t[74]);
  let Ne;
  t[75] !== _e || t[76] !== I || t[77] !== fe || t[78] !== L || t[79] !== ke || t[80] !== Me
    ? ((Ne = (0, fY.jsx)(kn, {
        "aria-label": _e,
        color: I,
        size: L,
  ...
  t[82] !== r || t[83] !== Pe || t[84] !== Fe
    ? ((Ie = G(`inline-flex self-start items-stretch overflow-hidden`, Pe, Fe, r)),
      (t[82] = r),
      (t[83] = Pe),
      (t[84] = Fe),
      (t[85] = Ie))
    : (Ie = t[85]);
  let Le;
  t[86] !== De || t[87] !== j || t[88] !== M || t[89] !== N || t[90] !== P || t[91] !== ee
    ? ((Le =
        M == null
          ? De
          : (0, fY.jsx)(Dn, {
              ...
              sideOffset: ee,
              delayOpen: N,
              children: (0, fY.jsx)(`span`, { className: `inline-flex min-w-0`, children: De }),
            })),
      (t[86] = De),
      (t[87] = j),
      (t[88] = M),
    ...
    ? ((Be =
        b == null || x === !0
          ...
          : (0, fY.jsx)(Dn, {
              tooltipContent: b,
              delayOpen: N,
              children: (0, fY.jsx)(`span`, { className: `inline-flex`, children: B }),
            })),
      (t[96] = B),
      (t[97] = b),
      (t[98] = x),
  ...
  t[101] !== a || t[102] !== oe
    ? ((Ve =
        oe === `menu`
          ? (0, fY.jsx)(`div`, { className: `flex min-w-[160px] flex-col gap-0.5`, children: a })
          : a),
      (t[101] = a),
      (t[102] = oe),
      (t[103] = Ve))
  ...
  let Ue;
  return (
    t[116] !== _ || t[117] !== v || t[118] !== Ie || t[119] !== Le || t[120] !== He
      ? ((Ue = (0, fY.jsxs)(`div`, { ref: _, className: Ie, ...v, children: [Le, He] })),
        (t[116] = _),
        (t[117] = v),
        (t[118] = Ie),
        (t[119] = Le),
...
var uY,
  ...
  fY,
  pY = e(() => {
    ((uY = s()), Pa(), (dY = r(d(), 1)), va(), _V(), Ma(), ha(), Hi(), Ar(), (fY = o()));
  });
function mY(e) {
  switch (wY(e)) {
    case `docx`:
  ...
  return (
    e.find((e) =>
      e.id === `connector_5f3c8c41a1e54ad7a76272c89e2554fa`
        ? !0
        : [e.id, e.name, ...e.pluginDisplayNames].some((e) => TY(e) === `google-drive`),
    ) ?? null
  );
}
function gY(e) {
...
async function yY({ hostId: e, path: t, title: n }) {
  ...
  let i = Or(t),
    a = EY(t),
    o = xY({ fileBytes: Ln(r.contentsBase64), filename: i, mimeType: a, title: n ?? i }),
    s = Et(o.body),
    c = (
...
function PY(e) {
  let t = (0, zY.c)(31),
    { hostId: n, marketplacePath: r, pluginName: i, remoteMarketplaceName: a, enabled: o } = e,
    s = o === void 0 ? !0 : o,
    c = n ?? `local`,
    l;
  ...
  t[7] !== c || t[8] !== r || t[9] !== i || t[10] !== a
    ? ((y = IY({ hostId: c, marketplacePath: r, pluginName: i, remoteMarketplaceName: a })),
      (t[7] = c),
      (t[8] = r),
      (t[9] = i),
      (t[10] = a),
  ...
  if (!v) {
    ...
    return (
      t[22] === _
        ? (e = t[23])
        : ((e = { errorMessage: null, isLoading: _, plugin: null, refetch: FY }),
          (t[22] = _),
          (t[23] = e)),
      e
    );
  ...
  return (
    t[26] !== S.isLoading || t[27] !== T || t[28] !== C || t[29] !== w
      ? ((E = { errorMessage: C, isLoading: S.isLoading, plugin: w, refetch: T }),
        (t[26] = S.isLoading),
        (t[27] = T),
        (t[28] = C),
        (t[29] = w),
...
async function FY() {}
function IY({ hostId: e, marketplacePath: t, pluginName: n, remoteMarketplaceName: r }) {
  return [...BY, e, t ?? ``, r ?? ``, n ?? ``];
}
function LY(e) {
...
function RY(
  e,
  { logoDataUrl: t, logoDarkDataUrl: n, composerIconDataUrl: r, skillImageDataUrls: i },
) {
...
var zY,
  BY,
  VY = e(() => {
    ((zY = s()), C(), Ai(), Gj(), sM(), PN(), zP(), Da(), je(), (BY = [`plugins`, `detail`]));
  });
  ...
  YY = e(() => {
    (Er(),
      ...
      (KY = tt(W, ({ hostId: e, cwd: t }) => ({
        queryKey: [...GY, e, t],
        queryFn: () => {
          if (t == null) throw Error(`Cannot list hooks without a project root`);
      ...
      (qY = tt(W, ({ hostId: e, cwds: t }) => ({
        queryKey: [...GY, e, t],
        queryFn: () => {
          if (t == null || t.length === 0) throw Error(`Cannot list hooks without project roots`);
          return Yt(`list-hooks-for-host`, { hostId: e, cwds: t });
        },
        staleTime: B.FIVE_MINUTES,
      ...
      (JY = ae(W, (e) => ({
        ...
        onMutate: async (t, { client: n }) => {
          ...
          let r = n.getQueriesData({ predicate: ({ queryKey: t }) => UY(t, e) });
          return (
            n.setQueriesData({ predicate: ({ queryKey: t }) => UY(t, e) }, (e) => WY(e, t)),
            { previousResponses: r }
          );
        },
...
function QY(e) {
  ...
  t[3] === i
    ...
    : ((c = async (e) => {
        ...
        await Promise.all([i.cancelQueries({ queryKey: wP }), i.cancelQueries({ queryKey: Gr })]);
        let r = i.getQueryData(Gr),
          a = i.getQueriesData({ queryKey: wP }).flatMap($Y);
        for (let [e, r] of a) i.setQueryData(e, aX(r, t, n));
        if (r) {
          let e = { ...r.config };
          ((e.plugins = iX(r.config.plugins, t, n)), i.setQueryData(Gr, { ...r, config: e }));
        }
  ...
  t[5] !== o || t[6] !== r
    ? ((u = (e, t) => {
        ...
        r.get(ji).success(
          o.formatMessage(n ? fX.enabledSuccess : fX.disabledSuccess, { pluginName: i }),
        );
      }),
      (t[5] = o),
      (t[6] = r),
  ...
  t[8] !== o || t[9] !== i || t[10] !== r
    ? ((d = (e, t, n) => {
        (l.error(`Failed to update plugin enabled state`, { safe: {}, sensitive: { error: e } }),
  ...
  t[14] !== s || t[15] !== c || t[16] !== u || t[17] !== d || t[18] !== f
    ? ((p = { mutationFn: s, onMutate: c, onSuccess: u, onError: d, onSettled: f }),
      (t[14] = s),
      (t[15] = c),
      (t[16] = u),
      (t[17] = d),
...
function eX(e) {
  ...
  t[2] !== c || t[3] !== n || t[4] !== i || t[5] !== r
    ? ((d = async (e) => {
        let { marketplaceName: t, pluginId: a, pluginName: o, requestPluginId: s } = e,
          d = Qn(a);
        (d != null && (await XY(r, d, !0)),
          ...
          i
            ...
            .finally(() => u.dispatchMessage(`query-cache-invalidate`, { queryKey: c }))
            .catch((e) => {
  ...
  t[7] !== n || t[8] !== o || t[9] !== i || t[10] !== r
    ? ((f = (e, t) => {
        ...
        (oX(i, n, s), r.get(ji).success(o.formatMessage(fX.uninstallSuccess, { pluginName: a })));
      }),
      (t[7] = n),
      (t[8] = o),
      (t[9] = i),
  ...
  t[12] !== o || t[13] !== r
    ? ((p = (e, t) => {
        let { marketplaceName: n, pluginId: i, pluginName: a, requestPluginId: s } = t;
...
function nX(e) {
  ...
  return (
    t[13] !== f.mutateAsync || t[14] !== p
      ? ((m = { pendingRemoveMarketplaceName: p, removeMarketplace: f.mutateAsync }),
        (t[13] = f.mutateAsync),
        (t[14] = p),
        (t[15] = m))
      : (m = t[15]),
...
function rX(e) {
  ...
  t[0] === n
    ...
    : ((o = async (e) => {
        let { marketplaceName: t } = e;
        return Yt(`upgrade-marketplaces`, { hostId: n, marketplaceName: t ?? null });
      }),
      (t[0] = n),
      (t[1] = o));
  let s, c;
  t[2] !== a || t[3] !== r
    ? ((s = (e, t) => {
        ...
        if (e.errors.length > 0) {
          (l.error(`Failed to upgrade marketplaces`, {
            ...
            r
              ...
              .danger(
                a.formatMessage(
                  n == null ? fX.marketplacesUpgradeError : fX.marketplaceUpgradeError,
                ),
              ));
          return;
        }
        if (n != null) {
          r.get(ji).success(a.formatMessage(fX.marketplaceUpgradeSuccess, { marketplaceName: n }));
          return;
        }
      ...
      (c = (e, t) => {
        let { marketplaceDisplayName: n } = t;
        (l.error(`Failed to upgrade marketplaces`, { safe: {}, sensitive: { error: e } }),
          r
            .get(ji)
            .danger(
              a.formatMessage(
                n == null ? fX.marketplacesUpgradeRequestError : fX.marketplaceUpgradeError,
              ),
            ));
      }),
      (t[2] = a),
  ...
  let f = de(d),
    ...
    m = f.isPending && f.variables.marketplaceName != null ? f.variables.marketplaceName : null,
    h;
  t[13] === f
    ? (h = t[14])
    : ((h = async (e) => {
...
function oX(e, t, n) {
  (e.setQueriesData({ queryKey: [...wP, `marketplace-kind`, t] }, (e) =>
    ...
    e.setQueriesData({ predicate: ({ queryKey: e }) => LY(e) && e[2] === t }, (e) =>
      e == null || e.summary.id !== n || (!e.summary.installed && !e.summary.enabled)
        ? e
        : { ...e, summary: { ...e.summary, enabled: !1, installed: !1 } },
    ));
}
function sX(e, t) {
  return e.some((e) => e.plugin.id === t && (e.plugin.installed || e.plugin.enabled))
    ? e.map((e) =>
        e.plugin.id === t ? { ...e, plugin: { ...e.plugin, enabled: !1, installed: !1 } } : e,
      )
    : e;
}
function cX(e) {
...
function jX(e) {
  ...
  t[4] === n
    ? (f = t[5])
    : ((f = (0, PX.jsx)(`div`, { ref: c, children: n })), (t[4] = n), (t[5] = f));
  let p;
  t[6] !== a || t[7] !== f
...
function IX(e) {
  ...
  t[32] !== _ || t[33] !== D || t[34] !== T
    ? ((O = (0, RX.jsx)(`span`, { className: T, "data-state": _, children: D })),
      (t[32] = _),
      (t[33] = D),
      (t[34] = T),
      (t[35] = O))
...
function nZ(e) {
  ...
  let T = w,
    E;
  t[2] === C ? (E = t[3]) : ((E = [`mcp-settings`, `app-connect`, C]), (t[2] = C), (t[3] = E));
  let O = S && n != null,
    k;
  t[4] === n
    ? (k = t[5])
  ...
  t[10] === C
    ? (N = t[11])
    : ((N = [`mcp-settings`, `app-connect`, `tos`, C]), (t[10] = C), (t[11] = N));
  let P = S && n != null,
    ee;
  t[12] === n
    ? (ee = t[13])
  ...
  t[14] !== N || t[15] !== P || t[16] !== ee
    ? ((F = { queryKey: N, enabled: P, staleTime: B.FIVE_MINUTES, queryFn: ee }),
      (t[14] = N),
      (t[15] = P),
      (t[16] = ee),
      (t[17] = F))
  ...
  t[20] === M
    ? (re = t[21])
    : ((re = M == null ? !1 : JX(M.link_params_schema)), (t[20] = M), (t[21] = re));
  let ie = re,
    R = i == null && !L && (j.isError || M == null || ie || ne === `UNSUPPORTED`),
    ae;
    ...
    ? ((le = (e) => {
        switch (e.kind) {
          case `connected-directly`:
            ...
            return;
          case `oauth-started`:
            (n != null && u?.({ app: { id: n.id, name: n.name }, redirectUrl: e.redirectUrl }),
          ...
          case `browser-fallback`:
            ...
            return;
          case `failed`:
            (h && g.get(ji).danger(n?.installUrl?.trim() ? KP(_) : qP(_)), p && T(!1));
            return;
        }
      }),
      (t[32] = n),
  ...
  t[46] === n.installUrl
    ? (_e = t[47])
    : ((_e = n.installUrl?.trim() || null), (t[46] = n.installUrl), (t[47] = _e));
  let ve = _e,
    ye;
  ...
  let De;
  t[56] !== Te || t[57] !== Ee
    ? ((De = { title: Te, description: Ee }), (t[56] = Te), (t[57] = Ee), (t[58] = De))
    : (De = t[58]);
  let Oe;
  t[59] === _
    ? (Oe = t[60])
  ...
  let Ae;
  t[63] !== Oe || t[64] !== ke
    ? ((Ae = { title: Oe, description: ke }), (t[63] = Oe), (t[64] = ke), (t[65] = Ae))
    : (Ae = t[65]);
  let je;
  t[66] === _
    ? (je = t[67])
  ...
  let Ne;
  t[70] !== je || t[71] !== Me
    ? ((Ne = { title: je, description: Me }), (t[70] = je), (t[71] = Me), (t[72] = Ne))
    : (Ne = t[72]);
  let Pe;
  t[73] !== De || t[74] !== Ae || t[75] !== Ne
    ? ((Pe = [De, Ae, Ne]), (t[73] = De), (t[74] = Ae), (t[75] = Ne), (t[76] = Pe))
    : (Pe = t[76]);
  let Fe = Pe,
    Ie;
  t[77] === I.data?.blurbs
  ...
  let Le = Ie,
    ...
    ze =
      y?.connectorId === C ? y.enabled : I.data?.personalization_default === `PERSONALIZE_ALWAYS`,
  ...
  t[104] !== ne ||
  t[105] !== R
    ? ((Ke = i == null && !L && !m && !z && !me && !R && ne === `OAUTH` && !!n.installUrl?.trim()),
      (t[98] = n.installUrl),
      (t[99] = i),
      (t[100] = m),
      (t[101] = z),
  ...
  if (xe != null) {
    let e = z ? void 0 : `external-browser`,
      n;
    (t[107] !== xe || t[108] !== e
      ? ((n = (0, Q.jsx)(DX, { className: `icon-xs`, href: xe, openTarget: e })),
        (t[107] = xe),
        (t[108] = e),
        (t[109] = n))
      : (n = t[109]),
  ...
  let Xe;
  t[111] !== i || t[112] !== j.isError || t[113] !== L || t[114] !== ne || t[115] !== ie
    ? ((Xe = L
        ? (0, Q.jsxs)(`span`, {
  ...
  let Ze = Xe,
    Qe;
  t[117] !== Se || t[118] !== m || t[119] !== z || t[120] !== me || t[121] !== ne || t[122] !== R
    ? ((Qe = m
        ? (0, Q.jsx)(U, {
  ...
  t[124] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((et = { "aria-describedby": void 0, style: { maxHeight: dZ, width: uZ } }), (t[124] = et))
    : (et = t[124]);
  let V;
  ...
  t[131] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((at = (0, Q.jsx)(KX, { className: `icon-sm text-token-text-secondary` })), (t[131] = at))
    : (at = t[131]);
  let ot;
  ...
  t[156] !== pt || t[157] !== mt
    ? ((ht = (0, Q.jsx)(jX, {
        ...
        children: (0, Q.jsxs)(`div`, { className: `flex flex-col gap-4`, children: [pt, mt] }),
      })),
      (t[156] = pt),
      (t[157] = mt),
      (t[158] = ht))
  ...
  let gt = L || m || me,
    _t;
  t[159] !== Ye || t[160] !== $e
    ? ((_t = (0, Q.jsxs)(`span`, { className: `flex items-center gap-1`, children: [$e, Ye] })),
      (t[159] = Ye),
      (t[160] = $e),
      (t[161] = _t))
    : (_t = t[161]);
  ...
  let bt;
  t[171] !== vt || t[172] !== yt
    ? ((bt = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [vt, yt] })),
      (t[171] = vt),
      (t[172] = yt),
      (t[173] = bt))
    : (bt = t[173]);
...
function rZ(e) {
  TR({ href: e, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
}
var iZ,
  aZ,
  Q,
...
function pZ({ clickAction: e, clickSource: t, context: n, productLogger: r, resourceKind: i }) {
  let a = mZ(i);
  a != null &&
...
function _Z(e) {
  ...
  return (
    t[5] !== n || t[6] !== a || t[7] !== s || t[8] !== c
      ? ((l = (0, wZ.jsx)(nZ, { app: n, onOpenChange: s, onConnected: c, onOAuthStarted: a })),
        (t[5] = n),
        (t[6] = a),
        (t[7] = s),
        (t[8] = c),
...
function yZ({
  ...
  let d = x(JD),
    ...
    A = async (r) => {
      ...
      pZ({
        clickAction: Tn.CODEX_GOOGLE_WORKSPACE_RESOURCE_CLICK_ACTION_UPLOAD_LOCAL_FILE,
        clickSource: e,
        context: {
    ...
    j = async (e) => {
      try {
        await S({ pluginDisplayName: iz(e), pluginId: e.plugin.id, enabled: !0 });
      } catch {
        return;
      }
    },
...
var jZ,
  ...
  FZ,
  IZ = e(() => {
    ((jZ = [25, 50, 100, 150, 200]), (MZ = jZ), (NZ = 10), (PZ = 400), (FZ = 0.01));
  });
function LZ(e) {
  let t = (0, GZ.c)(13),
    {
  ...
  t[5] === r
    ? (u = t[6])
    : ((u = (0, $.jsx)(`div`, { className: `min-w-0 justify-self-center`, children: r })),
      (t[5] = r),
      (t[6] = u));
  let d;
  t[7] === o
...
function RZ(e) {
  ...
  return (
    t[23] !== y || t[24] !== m || t[25] !== h
      ? ((b = (0, $.jsxs)(`div`, { className: `flex items-center gap-0.5`, children: [m, h, y] })),
        (t[23] = y),
        (t[24] = m),
        (t[25] = h),
        (t[26] = b))
...
function BZ(e) {
  ...
  let {
    ...
    T;
  t[2] !== l || t[3] !== i || t[4] !== o
    ? ((T = { cwd: l, hostId: i, openPath: o }), (t[2] = l), (t[3] = i), (t[4] = o), (t[5] = T))
    : (T = t[5]);
  let {
      canLoadTargets: E,
      preferredTarget: D,
  ...
  if (
    ...
    let e = lr({ targets: O, availableTargets: k, includeHiddenTargets: !0, mode: A }),
      r = Xi({ preferredTarget: D, targets: O, availableTargets: k, mode: A }),
      s = e.filter(VZ),
      c;
    (t[33] === o ? (c = t[34]) : ((c = mY(o)), (t[33] = o), (t[34] = c)), (F = c != null));
    let b;
    t[35] === f
      ? (b = t[36])
      : ((b = f.formatMessage({
    ...
    t[44] !== N || t[45] !== C || t[46] !== o
      ? ((te = (e, t) => {
          C(() => {
            N(e.target, { appPath: e.appPath, path: o, persistPreferred: t && Hr(e) });
          });
        }),
        (t[44] = N),
        (t[45] = C),
    ...
    t[55] !== m
      ? ((R =
          E && (m || !j || M)
            ? (0, $.jsx)(Tr, { cwd: l, delayMs: m ? 0 : qZ, hostId: i, openPath: o })
            : null),
        (t[49] = E),
        (t[50] = l),
        (t[51] = j),
        ...
        : (0, $.jsx)(cY, {
            ...
            children: (0, $.jsxs)(`span`, {
              ...
              children: [
                r == null
                  ? null
                  : (0, $.jsx)(`img`, { alt: ``, src: r.icon, className: `icon-sm` }),
                r == null || d
                  ? (0, $.jsx)(`span`, {
...
function HZ({ hostId: e, path: t, sizeBytes: n }) {
  ...
  let d = async () => {
    s(!0);
    try {
      let { sizeBytes: n } = await be(`read-file-metadata`, { params: { hostId: e, path: t } });
      if ((n == null || n > 47185920) && g(a)) {
        await be(`save-file`, {
          params: { kind: `remote-file`, hostId: e, sourcePath: t, suggestedFilename: Or(t) },
        });
        return;
      }
      if (n == null || n > 47185920) throw Error(`File is too large to download directly`);
      let { contentsBase64: r } = await be(`read-file-binary`, { params: { hostId: e, path: t } });
      if (r == null) return;
      await be(`save-file`, {
        params: { kind: `contents`, suggestedFilename: Or(t), contentsBase64: r },
      });
    } catch {
      r.get(ji).danger(u);
    } finally {
...
function cQ({
  ...
  let A = ya(),
    ...
    _e = ge[0] ?? z,
    ve = ge.at(-1) ?? z,
    ye = z == null ? null : A.formatNumber(z / 100, { style: `percent`, maximumFractionDigits: 0 }),
    be = bQ(e, t),
    xe = (e) => {
    ...
    Ae = (0, SQ.useCallback)((e) => {
      ...
      P((e) => (e?.width === t && e.height === n ? e : { width: t, height: n }));
    }, []),
    je = (0, SQ.useCallback)(
      (t) => {
        let n = lQ(t);
  ...
  let Pe = ({ clientX: t, clientY: n, zoomPercent: r }) => {
      ...
      ((j.scrollLeft += c.left + c.width * o - t), (j.scrollTop += c.top + c.height * s - n));
    },
    Fe = (t) => {
      if (j == null) {
      ...
      Pe({ clientX: n.left + n.width / 2, clientY: n.top + n.height / 2, zoomPercent: t });
    },
    Ie = (e) => {
      z != null && Fe(fQ({ currentZoomPercent: z, direction: e, zoomRamp: ge }));
    },
    Le = () => {
    ...
    ze = bi((e) => {
      ...
      let n = gQ({ event: e, fallbackPoint: re.current, previewViewportNode: j });
    ...
    Be = (0, SQ.useCallback)(
      (e) => {
        let t = ne.current;
        if (t !== e) {
          if ((t?.removeEventListener(`wheel`, ze), (ne.current = e), M(e), e == null)) {
            P(null);
            return;
          }
    ...
    Ve = (e) => {
      if (((re.current = { clientX: e.clientX, clientY: e.clientY }), e.pointerType !== `touch`))
        return;
      if (
      ...
      R.current = null;
      let t = vQ(ie.current);
      ae.current = t == null || z == null ? null : { distance: t.distance, zoomPercent: z };
    },
    He = (e) => {
      if (
        ...
        j == null ||
          ...
          (R.current.pointerId === e.pointerId &&
            (e.preventDefault(),
            e.stopPropagation(),
            (j.scrollLeft = R.current.scrollLeft - (e.clientX - R.current.clientX)),
            (j.scrollTop = R.current.scrollTop - (e.clientY - R.current.clientY))));
      }
    },
    Ue = (e) => {
      ...
      let n = vQ(ie.current);
      ((R.current = null),
        (ae.current = n == null || z == null ? null : { distance: n.distance, zoomPercent: z }));
    };
  ((0, SQ.useEffect)(() => {
    if (!i) return;
    let e = ZZ(),
  ...
  let We = (0, wQ.jsxs)(`div`, {
    ...
    children: [
                ...
                : (0, wQ.jsx)(`button`, {
                    ...
                    children: (0, wQ.jsx)(`span`, {
                      className: G(
                        ...
                        c.active && `bg-token-text-link-foreground px-3 py-1 text-white`,
                        !c.active && `p-1`,
                      ),
                      children: c.label,
                    }),
      ...
      w == null
        ...
        : (0, wQ.jsx)(`button`, {
            type: `button`,
            className: G(DQ, `absolute top-1/2 left-3 z-10 -translate-y-1/2 p-0`),
            "aria-label": de,
            onClick: (e) => {
      ...
      C == null
        ...
        : (0, wQ.jsx)(`button`, {
            type: `button`,
            className: G(DQ, `absolute top-1/2 right-3 z-10 -translate-y-1/2 p-0`),
            "aria-label": fe,
            onClick: (e) => {
      ...
      (0, wQ.jsxs)(`div`, {
        ...
        children: [
          y
            ...
            : (0, wQ.jsx)(Ka, {
                asChild: !0,
                children: (0, wQ.jsx)(`h2`, { className: `sr-only`, children: oe }),
              }),
          o ??
            (0, wQ.jsx)(
              `img`,
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~remote-conversation-page~pull-requests-page~plug~kmtatxxf.js.map
