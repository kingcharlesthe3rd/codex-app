import { Z as e, o as t, s as n, t as r } from "./app-scope-CWE-zIhQ.js";
import { Bt as i } from "./use-host-config.js";
import { h as a } from "./vscode-api.js";
import { Ar as o, Mt as s } from "./src-3.js";
import { i as c, l } from "./lib-1.js";
import { r as u } from "./toast-signal.js";
import { a as d, c as f } from "./sidebar-thread-keys.js";
import { t as p } from "./copy-to-clipboard.js";
import { t as m } from "./pinned-threads-query.js";
import { n as h } from "./set-pinned-thread.js";
function g({ threadIds: e, visibleThreadIds: t, nextVisibleThreadIds: n }) {
  let r = new Set(t),
    i = 0,
    a = [];
  for (let t of e) {
...
function _({ visibleThreadKeys: e, pendingVisibleThreadOrder: t }) {
  return t == null || !C(t.previousVisibleThreadKeys, e) || !w(t.nextVisibleThreadKeys, e)
    ? e
    : t.nextVisibleThreadKeys;
}
function v({ visibleThreadKeys: e, activeThreadKey: t, overThreadKey: n }) {
  ...
  let i = e.query.snapshot(m),
    ...
    o =
      a == null
        ...
        : {
            threadIds: n
              ? s({ threadIds: a.threadIds, threadId: t, beforeThreadId: r ?? null })
              : a.threadIds.filter((e) => e !== t),
          };
  o != null && i.setData(o);
  try {
    r === void 0 ? await h(t, n) : await h(t, n, r);
  } catch (e) {
    let t = i.getData();
    (o != null && t != null && C(t.threadIds, o.threadIds) && i.setData(a), D(e));
  }
}
function D(e) {
  a.error(`Failed to update sidebar thread membership`, { safe: {}, sensitive: { error: o(e) } });
}
var O = e(),
  k = c({
    archiveThreadError: {
...
function A(e, i) {
  ...
  let f = d,
    p;
  a[4] !== c || a[5] !== e || a[6] !== f
    ? ((p = c && e != null && f.includes(e)), (a[4] = c), (a[5] = e), (a[6] = f), (a[7] = p))
    : (p = a[7]);
  let h = p,
    g;
  a[8] !== c || a[9] !== e || a[10] !== h || a[11] !== l
    ? ((g = () => {
        !c || e == null || E(l, e, !h);
      }),
      (a[8] = c),
  ...
  return (
    a[13] !== h || a[14] !== _
      ? ((v = { isPinned: h, togglePin: _ }), (a[13] = h), (a[14] = _), (a[15] = v))
      : (v = a[15]),
    v
  );
}
function j({ scope: e, cwd: t, intl: n }) {
  t &&
    p(t).then(
      () => {
        e.get(u).success(n.formatMessage(k.copyWorkingDirectorySuccess));
      },
      () => {
        e.get(u).danger(n.formatMessage(k.copyWorkingDirectoryError));
      },
    );
}
function M(e) {
...
function P({ conversationId: e, parentConversationId: t, scope: n, getMarkdown: r, intl: a }) {
  (async () => {
    ...
    o == null ||
      o.trim().length === 0 ||
      (await p(o), n.get(u).success(a.formatMessage(k.copyConversationMarkdownSuccess)));
  })().catch(() => {
    n.get(u).danger(a.formatMessage(k.copyConversationMarkdownError));
  });
}
function F() {
  let e = (0, O.c)(17),
    ...
    ? ((o = (e) => {
        ...
        (s?.(),
          i(`archive-conversation`, {
            ...
            .catch(() => {
              (l?.(), n.get(u).danger(a.formatMessage(k.archiveThreadError)));
            }));
      }),
      (s = (e) => {
        let { conversationId: t } = e;
        i(`interrupt-conversation`, { conversationId: t, initiatedBy: `user` }).catch(() => {
          n.get(u).danger(a.formatMessage(k.interruptThreadError));
        });
      }),
      (e[0] = a),
      (e[1] = n),
  ...
  e[4] !== a || e[5] !== n
    ? ((c = (e) => {
        let { conversationId: t, hostId: r, title: o } = e;
        i(`set-thread-title`, {
          conversationId: t,
          ...(r == null ? {} : { hostId: r }),
          title: o,
        }).catch(() => {
          n.get(u).danger(a.formatMessage(k.renameThreadError));
        });
      }),
      (d = (e) => {
        j({ scope: n, cwd: e, intl: a });
      }),
      (e[4] = a),
      (e[5] = n),
      (e[6] = c),
  ...
  let p;
  return (
    e[11] !== o || e[12] !== s || e[13] !== c || e[14] !== d || e[15] !== f
      ? ((p = {
          archiveThread: o,
          interruptThread: s,
          markThreadAsUnread: I,
          renameThread: c,
          copyWorkingDirectory: d,
          copySessionId: M,
          copyAppLink: N,
          copyConversationMarkdown: f,
        }),
        (e[11] = o),
        (e[12] = s),
        (e[13] = c),
...
//# sourceMappingURL=thread-actions-B.js.map
