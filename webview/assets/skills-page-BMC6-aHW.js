...
import { Ar as h, t as g } from "./product-logger.js";
import { n as ee } from "./selectable-remote-connections-signal.js";
import { p as te } from "./codex-api.js";
import { M as _ } from "./mention-item.js";
import { r as ne } from "./skill-utils.js";
import { t as v } from "./use-is-plugins-enabled-B.js";
import { n as re } from "./use-start-new-conversation.js";
import { b as y } from "./links.js";
import { t as ie } from "./use-connected-remote-connections.js";
import { i as ae } from "./settings-host-context.js";
import { n as oe, t as se } from "./format-skill-scope.js";
import { t as ce } from "./thread-page-header.js";
import { t as b } from "./large-empty-state.js";
import { t as le } from "./page-search-input.js";
import {
  N as x,
  _ as ue,
  g as de,
...
import { t as me } from "./use-element-in-view.js";
import { a as he, i as ge, n as _e, o as w, r as ve, t as T } from "./plugins-page.js";
import { t as ye } from "./settings-host-dropdown.js";
var E = r(),
  D = e(t(), 1),
  O = n();
function k() {
...
function be() {
  ...
  let S = x,
    [C, _e] = (0, D.useState)(s),
    w;
  e[2] !== b || e[3] !== C ? ((w = ae(C, b)), (e[2] = b), (e[3] = C), (e[4] = w)) : (w = e[4]);
  let T = w,
    [k, be] = (0, D.useState)(null),
    [A, Ee] = (0, D.useState)(null),
    Oe;
  e[5] !== A || e[6] !== k
    ? ((Oe = { container: k, target: A }), (e[5] = A), (e[6] = k), (e[7] = Oe))
    : (Oe = e[7]);
  let ke = me(Oe),
    [j, Ae] = (0, D.useState)(``),
    [je, Me] = (0, D.useState)(!1),
    Ne = l(ve),
    Pe = c(ve),
    {
      forceReloadSkills: Fe,
      installedSkillMatchKeys: Ie,
      isFetching: Le,
      isLoading: M,
      markSkillsUpdated: N,
      skills: P,
    ...
    {
      canInstallRecommendedSkills: Re,
      defaultRecommendedRepoRoot: ze,
      skillCreatorPath: I,
    } = pe(T),
    { errorMessage: Be, isLoading: Ve, refresh: He, repoRoot: Ue, skills: We } = ue(ze, T),
    Ge;
  ...
  let Ke;
  e[9] !== Fe || e[10] !== T
    ? ((Ke = { forceReloadSkills: Fe, hostId: T, onInstalled: Ge }),
      (e[9] = Fe),
      (e[10] = T),
      (e[11] = Ke))
    : (Ke = e[11]);
  let { installRecommendedSkill: qe, installingSkillId: Je } = fe(Ke),
    Ye;
  e[12] === n ? (Ye = e[13]) : ((Ye = se({ scope: `repo`, intl: n })), (e[12] = n), (e[13] = Ye));
  let Xe = Ye,
    Ze = r?.name ?? void 0,
    Qe;
  e[14] !== n || e[15] !== Ze
    ? ((Qe = se({ scope: `admin`, intl: n, adminLabel: Ze })),
      (e[14] = n),
      (e[15] = Ze),
      (e[16] = Qe))
    : (Qe = e[16]);
  let $e = Qe,
    et;
  e[17] !== n || e[18] !== $e || e[19] !== Xe || e[20] !== F
    ? ((et = (e) => {
        let { scope: t, skillPath: r } = e;
        return se({
          scope: t,
          intl: n,
          repoLabel: oe({ skillPath: r, roots: F, fallbackLabel: Xe }),
          adminLabel: $e,
        });
      }),
      (e[17] = n),
  ...
  let at = it,
    ot;
  (e[28] === Symbol.for(`react.memo_cache_sentinel`) ? ((ot = []), (e[28] = ot)) : (ot = e[28]),
    (0, D.useEffect)(Se, ot));
  let L;
  e[29] === ke
    ? (L = e[30])
  ...
  e[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, O.jsx)(p, { className: `icon-xs` })), (e[37] = B))
    : (B = e[37]);
  let V;
  e[38] === je
    ? (V = e[39])
  ...
  e[49] !== j || e[50] !== U || e[51] !== W
    ...
    : (G = e[52]);
  let K;
  e[53] !== Ne || e[54] !== t || e[55] !== Pe || e[56] !== I || e[57] !== v
    ? ((K = () => {
        if (!I) return;
        g(t, h, {});
        let e = ge({ creatorPath: I, isFirstOpen: !Ne, kind: `skill` });
        (Ne || Pe(!0), v({ prefillPrompt: e, startInSidebar: !0 }));
      }),
      (e[53] = Ne),
      (e[54] = t),
      (e[55] = Pe),
  ...
  e[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ut = (0, O.jsx)(m, { className: `icon-xs` })),
      (dt = (0, O.jsx)(d, {
  ...
  let Y;
  e[69] !== L || e[70] !== J
    ? ((Y = (0, O.jsx)(ce, { start: L, trailing: J })), (e[69] = L), (e[70] = J), (e[71] = Y))
    : (Y = e[71]);
  let ft;
...
function we(e) {
  ...
  return (
    t[2] !== r || t[3] !== i
      ? ((a = (0, O.jsxs)(`section`, { className: `flex flex-col gap-4`, children: [i, r] })),
        (t[2] = r),
        (t[3] = i),
        (t[4] = a))
      : (a = t[4]),
...
function Te(e) {
  ...
  let u;
  return (
    t[14] === l ? (u = t[15]) : ((u = (0, O.jsx)(w, { children: l })), (t[14] = l), (t[15] = u)), u
  );
}
function Ee(e) {
  let t = (0, E.c)(2),
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, O.jsx)(`span`, { className: `text-token-description-foreground`, children: n })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function De(e) {
    ...
    bb0: {
      ...
      if (i) {
        ...
        (t[17] === i
          ...
          : ((n = (0, O.jsx)(`div`, {
              className: `flex min-h-0 flex-1 items-center justify-center`,
              children: (0, O.jsx)(b, { title: e, description: i }),
            })),
            (t[17] = i),
            (t[18] = n)),
          (h = n));
  ...
  return (
    t[28] !== p || t[29] !== m
      ? ((g = (0, O.jsx)(p, { children: m })), (t[28] = p), (t[29] = m), (t[30] = g))
      : (g = t[30]),
    g
  );
}
export { k as t };
//# sourceMappingURL=skills-page-BMC6-aHW.js.map
