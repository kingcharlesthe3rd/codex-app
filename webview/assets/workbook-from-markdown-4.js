...
function we(...e) {
  let t = -1,
    n;
  for (; ++t < e.length; ) (M(e[t]), e[t] && (n = n === void 0 ? e[t] : n + `/` + e[t]));
  ...
  Re = e(() => {
    (be(),
      ...
      (Le = class {
        constructor(e) {
          let t;
          ((t = e ? (P(e) ? { path: e } : typeof e == `string` || Ie(e) ? { value: e } : e) : {}),
        ...
        set basename(e) {
          (I(e, `basename`), F(e, `basename`), (this.path = N.join(this.dirname || ``, e)));
        }
        get dirname() {
          return typeof this.path == `string` ? N.dirname(this.path) : void 0;
        }
        set dirname(e) {
          (Fe(this.basename, `dirname`), (this.path = N.join(e || ``, this.basename)));
        }
        get extname() {
        ...
        set path(e) {
          (P(e) && (e = Me(e)), I(e, `path`), this.path !== e && this.history.push(e));
        }
        get stem() {
      ...
      (Je = class e extends Be {
        ...
        use(e, ...t) {
          ...
          function a(e) {
            ...
            (o(e.plugins), e.settings && (r.settings = (0, H.default)(!0, r.settings, e.settings)));
          }
          function o(e) {
            let t = -1;
            if (e != null)
          ...
          function s(e, t) {
            ...
            if (i === -1) n.push([e, ...t]);
              ...
              let [r, ...a] = t,
                o = n[i][1];
              (A(o) && A(r) && (r = (0, H.default)(!0, o, r)), (n[i] = [e, r, ...a]));
            }
          }
        }
      }),
...
function ut() {
  return {
    unsafe: [
      ...
      { character: `.`, before: `[Ww]`, after: `[\\-.\\w]`, inConstruct: W, notInConstruct: G },
      { character: `:`, before: `[ps]`, after: `\\/`, inConstruct: W, notInConstruct: G },
    ],
  };
}
function dt(e) {
...
function _t(e, t, n, r, i) {
  let a = ``;
  if (!xt(i) || (/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !yt(n))) return !1;
  let o = bt(n + r);
  if (!o[0]) return !1;
  let s = {
    type: `link`,
...
var W,
  G,
  St = e(() => {
    (i(), k(), b(), ct(), (W = `phrasing`), (G = [`autolink`, `link`, `image`, `label`]));
  }),
  Ct = e(() => {
    St();
  });
...
function Bt() {
  return { canContainEols: [`delete`], enter: { strikethrough: Ht }, exit: { strikethrough: Ut } };
}
function Vt() {
  return {
...
function en() {
  return {
    ...
    exit: { codeText: on, table: nn, tableData: K, tableHeader: K, tableRow: K },
  };
}
function tn(e) {
  let t = e._align;
...
function dn() {
  return {
    exit: { taskListCheckValueChecked: pn, taskListCheckValueUnchecked: pn, paragraph: mn },
  };
}
function fn() {
  return { unsafe: [{ atBreak: !0, character: `-`, after: `[:|-]` }], handlers: { listItem: hn } };
}
function pn(e) {
...
function Tn(e, t, n) {
  ...
  function c(t) {
    if (_(t) && i.length < 5) return ((i += String.fromCodePoint(t)), e.consume(t), c);
    if (t === 58) {
      let n = i.toLowerCase();
