...
import { _n as n } from "./app-server-manager-signals.js";
...
import { c as m, i as h } from "./statsig.js";
...
import { t as N } from "./checkbox.js";
...
function re(e) {
  return e.isEnabled ? (e.rechargeMonthlyLimit == null ? `` : L(e.rechargeMonthlyLimit)) : ``;
}
function ie(e) {
  let t = R(e);
  switch (t.kind) {
...
function se({ value: e, pricingInfo: t }) {
  ...
  switch (n.kind) {
    ...
    case `invalid`:
      return `not-whole-number`;
    case `valid`:
      return n.value < oe(t) ? `below-minimum` : n.value % 250 == 0 ? null : `invalid-increment`;
  }
}
function ce({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r }) {
  let i = le({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r });
  if (i == null) return null;
  let a = Math.round(i);
  return Math.abs(i - a) > 1e-6 ? null : String(a);
}
function le({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r }) {
  let i = L(e)
    .replaceAll(n, ``)
    .replaceAll(r, `.`)
    .replace(/[^\d.]/g, ``);
...
function he({ intl: e, pricingInfo: t }) {
  return (
    _e({ intl: e, amount: 0, pricingInfo: t })?.find((e) => e.type === `currency`)?.value ?? null
  );
}
...
function ve(e) {
  ...
  let g = h,
    _ = i === `preset`,
    v;
  t[2] !== n || t[3] !== _ || t[4] !== d || t[5] !== f || t[6] !== o || t[7] !== g
    ? ((v = ee.map((e) =>
        (0, U.jsx)(
          be,
          {
  ...
  let T;
  t[20] !== v || t[21] !== w
    ? ((T = (0, U.jsxs)(`div`, { className: `grid grid-cols-4 gap-2`, children: [v, w] })),
      (t[20] = v),
      (t[21] = w),
      (t[22] = T))
    : (T = t[22]);
        ...
        : (0, U.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, U.jsx)(W, {
                ...
                value: r,
                pricingInfo: o,
                placeholder: z({ intl: n, creditQuantity: l, pricingInfo: o }) ?? ``,
                hasError: s != null,
  ...
  t[33] !== s || t[34] !== l || t[35] !== u
    ? ((D =
        s == null ? null : (0, U.jsx)(ye, { fieldError: s, minimumQuantity: l, quantityStep: u })),
      (t[33] = s),
      (t[34] = l),
      (t[35] = u),
      (t[36] = D))
  ...
  return (
    t[37] !== E || t[38] !== D || t[39] !== T
      ? ((O = (0, U.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [T, E, D] })),
        (t[37] = E),
        (t[38] = D),
        (t[39] = T),
        (t[40] = O))
...
function W(e) {
  ...
  if (t[0] !== h || t[1] !== n || t[2] !== i || t[3] !== m || t[4] !== r) {
    let e = m
      ? z({ intl: n, creditQuantity: Number.parseInt(L(r), 10), pricingInfo: i })
      : B({ intl: n, creditQuantity: Number.parseInt(L(r), 10), pricingInfo: i });
    ((y = h ?? e ?? r),
  ...
  t[12] !== _ || t[13] !== h || t[14] !== p || t[15] !== f
    ? ((T = () => {
        ((h == null || _ != null) && g(null), f?.(h != null && h.length > 0 && _ == null), p());
      }),
      (t[12] = _),
      (t[13] = h),
      (t[14] = p),
  ...
  return (
    t[35] !== k || t[36] !== D || t[37] !== O
      ? ((A = (0, U.jsxs)(`div`, { className: `relative`, children: [D, O, k] })),
        (t[35] = k),
        (t[36] = D),
        (t[37] = O),
        (t[38] = A))
...
function be(e) {
  let t = (0, V.c)(18),
    { creditQuantity: n, pricingInfo: r, isSelected: i, intl: o, onClick: s } = e,
    l;
  t[0] !== n || t[1] !== o || t[2] !== r
...
function xe({ intl: e, value: t, pricingInfo: n }) {
  ...
  let { groupSeparator: i, decimalSeparator: a } = G({ intl: e, pricingInfo: n });
  return ce({ value: r, pricingInfo: n, groupSeparator: i, decimalSeparator: a });
}
function Se({ intl: e, value: t, pricingInfo: n }) {
  let r = t.trim();
  if (r.length === 0) return null;
  let { groupSeparator: i, decimalSeparator: a } = G({ intl: e, pricingInfo: n });
  return le({ value: r, pricingInfo: n, groupSeparator: i, decimalSeparator: a });
}
...
function K({ intl: e, value: t, pricingInfo: n }) {
  let { groupSeparator: r, decimalSeparator: i } = G({ intl: e, pricingInfo: n }),
...
function Ce(e) {
  ...
  t[12] === s
    ? (w = t[13])
    : ((w = s == null ? null : (0, U.jsx)(ye, { fieldError: s })), (t[12] = s), (t[13] = w));
  let T;
  t[14] !== C || t[15] !== w
    ? ((T = (0, U.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [b, C, w] })),
      (t[14] = C),
      (t[15] = w),
      (t[16] = T))
    : (T = t[16]);
  ...
  t[33] === l
    ? (M = t[34])
    : ((M = l == null ? null : (0, U.jsx)(ye, { fieldError: l })), (t[33] = l), (t[34] = M));
  let N;
  t[35] !== j || t[36] !== M
    ? ((N = (0, U.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [D, j, M] })),
      (t[35] = j),
      (t[36] = M),
      (t[37] = N))
    : (N = t[37]);
...
function Te(e) {
  let t = (0, V.c)(35),
    { creditDetails: n, pricingInfo: r, onOpenChange: i, dialogDescriptionId: a } = e,
    s = o(),
  ...
  t[10] !== n || t[11] !== s || t[12] !== r || t[13] !== k
    ? ((A = (0, U.jsx)(Ie, { intl: s, creditDetails: n, pricingInfo: r, actions: k })),
      (t[10] = n),
      (t[11] = s),
      (t[12] = r),
      (t[13] = k),
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (F = t[22]);
  let I;
  t[23] !== d || t[24] !== s || t[25] !== r || t[26] !== l || t[27] !== M || t[28] !== N
    ? ((I = (0, U.jsx)(y, {
...
function De(e) {
  ...
  let Te = J,
    Ee;
  t[12] !== z || t[13] !== O
    ? ((Ee = z ? `invalid-currency-amount` : ie(O)), (t[12] = z), (t[13] = O), (t[14] = Ee))
    : (Ee = t[14]);
  let De = Ee,
    Pe;
  t[15] !== B || t[16] !== j || t[17] !== S
    ? ((Pe = B ? `invalid-currency-amount` : ue({ monthlyLimit: j, targetBalance: S })),
      (t[15] = B),
      (t[16] = j),
      (t[17] = S),
      (t[18] = Pe))
  ...
  let Fe = Pe,
    Y,
    Le;
  t[19] !== z || t[20] !== B || t[21] !== O || t[22] !== j || t[23] !== r || t[24] !== S
    ? ((Y = z || B ? null : de({ minimumBalance: O, targetBalance: S, monthlyLimit: j })),
  ...
  t[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ke = [`usage-settings`, `credit-reload`, `manage-payment`]), (t[28] = Ke))
    : (Ke = t[28]);
  let qe;
  t[29] !== v || t[30] !== g
    ? ((qe = {
    ...
    ? ((Ye = async () => {
        ...
        if ((le(!0), R(!0), !(X == null || K)))
          try {
            ...
            if (
              T(
                (X === `enable` ? await u.mutateAsync(Y) : await f.mutateAsync(Y))
  ...
  t[94] !== i || t[95] !== v || t[96] !== a || t[97] !== nt
    ? ((rt = (0, U.jsx)(Ie, { intl: v, creditDetails: i, pricingInfo: a, actions: nt })),
      (t[94] = i),
      (t[95] = v),
      (t[96] = a),
      (t[97] = nt),
  ...
  t[137] !== dt || t[138] !== ft || t[139] !== pt
    ? (($ = (0, U.jsxs)(y, { className: `gap-4 pt-4`, children: [dt, ft, pt] })),
      (t[137] = dt),
      (t[138] = ft),
      (t[139] = pt),
      (t[140] = $))
...
function je(e) {
  ...
  return (
    t[16] !== f || t[17] !== m
      ? ((h = (0, U.jsxs)(U.Fragment, { children: [f, m] })), (t[16] = f), (t[17] = m), (t[18] = h))
      : (h = t[18]),
    h
  );
}
function Me(e) {
  let t = (0, V.c)(16),
    ...
    s;
  t[0] !== n || t[1] !== i || t[2] !== o
    ? ((s = B({ intl: n, creditQuantity: Number.parseInt(L(i), 10), pricingInfo: o })),
      (t[0] = n),
      (t[1] = i),
      (t[2] = o),
      (t[3] = s))
  ...
  let l = s,
    u;
  t[4] !== n || t[5] !== o || t[6] !== r
    ? ((u = B({ intl: n, creditQuantity: Number.parseInt(L(r), 10), pricingInfo: o })),
      (t[4] = n),
      (t[5] = o),
      (t[6] = r),
      (t[7] = u))
  ...
  let d = u,
    f;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((f = B({ intl: n, creditQuantity: Number.parseInt(L(a), 10), pricingInfo: o })),
      (t[8] = n),
      (t[9] = a),
      (t[10] = o),
      (t[11] = f))
            ...
            l == null || d == null
              ...
              : p == null
                ...
                : (0, U.jsx)(c, {
                    ...
                    values: { thresholdAmount: l, targetAmount: d, monthlyLimitAmount: p },
                  }),
        })),
        (t[12] = p),
        (t[13] = d),
...
function Ne(e) {
  ...
  t[6] === c
    ? (u = t[7])
    : ((u = c === `button` ? (0, U.jsx)(Fe, { children: (0, U.jsx)(Pe, {}) }) : (0, U.jsx)(Pe, {})),
      (t[6] = c),
      (t[7] = u));
  let d;
  return (
    t[8] !== l || t[9] !== u
      ? ((d = (0, U.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [l, u] })),
        (t[8] = l),
        (t[9] = u),
        (t[10] = d))
      : (d = t[10]),
...
function Ie(e) {
  ...
  t[7] === a
    ? (u = t[8])
    : ((u = (0, U.jsx)(`div`, { className: `flex shrink-0 items-center gap-2`, children: a })),
      (t[7] = a),
      (t[8] = u));
  let d;
  return (
...
function Le({ intl: e, creditDetails: t, pricingInfo: n }) {
  return t == null || t.unlimited
    ? null
    : (B({ intl: e, creditQuantity: Math.floor(Number(t.balance ?? 0)), pricingInfo: n }) ??
        e.formatNumber(0));
}
...
function Ve(e) {
  ...
  t[10] === s
    ? (m = t[11])
    : ((m = (0, U.jsx)(y, { className: `pt-4`, children: s })), (t[10] = s), (t[11] = m));
  let h;
  return (
...
function X(e) {
  ...
  t[14] === n
    ? (o = t[15])
    : ((o = { "aria-describedby": n, onOpenAutoFocus: He }), (t[14] = n), (t[15] = o));
  let s;
  t[16] !== i || t[17] !== e
    ? ((s = (t) => {
...
function Ue(e) {
  ...
  t[20] !== h || t[21] !== _
    ? ((S = (0, U.jsx)(y, {
        className: `pt-4`,
        children: (0, U.jsxs)(`div`, { className: `flex justify-end gap-3`, children: [h, _] }),
      })),
      (t[20] = h),
      (t[21] = _),
      (t[22] = S))
  ...
  return (
    t[23] !== S || t[24] !== u || t[25] !== f || t[26] !== m
      ? ((w = (0, U.jsxs)(C, { className: `gap-0 px-4 py-4`, children: [u, f, m, S] })),
        (t[23] = S),
        (t[24] = u),
        (t[25] = f),
        (t[26] = m),
...
function We(e) {
  ...
  let { data: c, isError: l, refetch: d } = M(s),
    { enableAutoTopUpMutation: f, updateAutoTopUpMutation: p, disableAutoTopUpMutation: m } = O(),
    h;
  ...
  if (i === `one-time-purchase`) {
    if (T) {
      ...
      return (
        t[10] !== N || t[11] !== i
          ? ((e = (0, U.jsx)(X, { open: !0, variant: i, state: `loading`, onOpenChange: N })),
            (t[10] = N),
            (t[11] = i),
            (t[12] = e))
          : (e = t[12]),
    ...
    return (
      t[22] !== N || t[23] !== l || t[24] !== d || t[25] !== i
        ? ((e = l
            ...
            : (0, U.jsx)(X, { open: !0, variant: i, state: `loading`, onOpenChange: N })),
          (t[22] = N),
          (t[23] = l),
          (t[24] = d),
          (t[25] = i),
  ...
  return (
    e[0] !== t || e[1] !== n
      ? ((r = (e) => {
          ...
          if (Ke({ intent: e.intent, isCombinedModalEnabled: r }) === `combined-modal`) {
            w(t, We, {
...
//# sourceMappingURL=rate-limit-rows-CYWI-x0e.js.map
