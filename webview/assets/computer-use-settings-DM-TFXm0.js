...
import { do as n } from "./app-server-manager-signals.js";
...
import { a as y, m as b, p as x } from "./chunk-8.js";
...
import "./tooltip.js";
import { D as C } from "./mention-item.js";
...
import { i as D, r as O } from "./use-is-plugins-enabled.js";
import "./browser-sidebar-availability.js";
import { m as k, v as A } from "./use-plugins.js";
import "./with-window.js";
import "./window-app-action-helpers.js";
import "./plugin-detail-route-utils.js";
import { a as j, i as M, s as N } from "./use-plugin-install-flow.js";
...
import { l as le, t as ue } from "./browser-use-origin-state-queries.js";
import { t as de } from "./settings-content-layout.js";
import { n as q } from "./settings-row.js";
import { n as fe, t as J } from "./settings-group.js";
  ...
  t[5] === n.isConnected
    ...
    : ((s = (0, Q.jsx)(`span`, {
        ...
        children: n.isConnected
          ? (0, Q.jsx)(l, { ...be.connected })
          : (0, Q.jsx)(l, { ...be.disconnected }),
      })),
      (t[5] = n.isConnected),
      (t[6] = s));
  let c;
...
var Se = `` + new URL(`chrome-production-large-BLPyHeGg.png`, import.meta.url).href,
  Ce = `computer-use`,
  we = `computer-use`,
  Te = `chrome`,
  Ee = `chrome-dev`,
...
function Ae() {
  ...
  e[6] === i
    ? (u = e[7])
    : ((u = (0, Q.jsx)(je, { computerUseAvailability: i })), (e[6] = i), (e[7] = u));
  let d;
  e[8] !== n || e[9] !== i.available || e[10] !== a
    ? ((d = a === `macOS` && i.available && n ? (0, Q.jsx)(ze, {}) : null),
      (e[8] = n),
      (e[9] = i.available),
      (e[10] = a),
      (e[11] = d))
  ...
  let p;
  e[12] !== u || e[13] !== d
    ? ((p = (0, Q.jsxs)(J, { children: [c, (0, Q.jsxs)(J.Content, { children: [u, d] })] })),
      (e[12] = u),
      (e[13] = d),
      (e[14] = p))
    : (p = e[14]);
  ...
  return (
    e[17] !== p || e[18] !== m
      ? ((h = (0, Q.jsxs)(de, { title: o, subtitle: s, children: [p, m] })),
        (e[17] = p),
        (e[18] = m),
        (e[19] = h))
      : (h = e[19]),
...
function je(e) {
  ...
  let d = k(a, u),
    f = pe(a),
    p;
  t[3] !== f || t[4] !== d.availablePlugins
    ? ((p = X(d.availablePlugins, we, f)), (t[3] = f), (t[4] = d.availablePlugins), (t[5] = p))
    : (p = t[5]);
  let m = p,
    h;
  t[6] !== f || t[7] !== d.availablePlugins
    ? ((h = Ge(d.availablePlugins, f)), (t[6] = f), (t[7] = d.availablePlugins), (t[8] = h))
    : (h = t[8]);
  let g = h,
    ...
    y;
  t[9] !== g || t[10] !== _ || t[11] !== a
    ? ((y = { hostId: a, plugin: g, shouldReadBrowserExtension: _ }),
      (t[9] = g),
      (t[10] = _),
      (t[11] = a),
      (t[12] = y))
  ...
  if (
    ...
    let e;
    if (
      (t[23] !== g || t[24] !== c || t[25] !== o
        ? ((e =
            g == null && o && !c.isLoading && !c.allowed
              ? [
                  {
                    description: (0, Q.jsx)(l, { ...C.restrictedAvailabilityDescription }),
                    icon: (0, Q.jsx)(`img`, {
                      alt: ``,
      ...
      (t[29] === m
        ? (r = t[30])
        : ((r = { plugin: m, title: e, description: n }), (t[29] = m), (t[30] = r)),
        S.push(r));
    }
    if (g != null) {
      let e;
      t[31] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        : (e = t[31]);
      let n;
      t[32] === x ? (n = t[33]) : ((n = (0, Q.jsx)(xe, { status: x })), (t[32] = x), (t[33] = n));
      let r;
      t[34] !== v || t[35] !== i
        ? ((r = v
            ? (0, Q.jsx)(w, {
...
function Ne() {
  ...
  e[1] !== o || e[2] !== a.installedPlugins
    ? ((s = Ge(a.installedPlugins, o)), (e[1] = o), (e[2] = a.installedPlugins), (e[3] = s))
    : (s = e[3]);
  let u = s,
    f = u?.plugin.installed === !0,
    p = f && u.plugin.enabled,
    h;
  e[4] !== u || e[5] !== f || e[6] !== r
    ? ((h = { hostId: r, plugin: u, shouldReadBrowserExtension: f }),
      (e[4] = u),
      (e[5] = f),
      (e[6] = r),
      (e[7] = h))
  ...
  e[12] === _
    ...
    : ((O = () => {
        _?.url != null &&
          v.dispatchMessage(`open-in-browser`, { url: _.url, useExternalBrowser: !0 });
      }),
      (e[12] = _),
      (e[13] = O));
  let A;
  ...
  let N;
  e[24] !== j || e[25] !== M
    ? ((N = (0, Q.jsxs)(`div`, { className: `flex items-center gap-2`, children: [j, M] })),
      (e[24] = j),
      (e[25] = M),
      (e[26] = N))
    : (N = e[26]);
  ...
  let F;
  e[28] !== x || e[29] !== C
    ? ((F = C ? null : (0, Q.jsx)(Fe, { installed: x })), (e[28] = x), (e[29] = C), (e[30] = F))
    : (F = e[30]);
  let I;
  ...
  e[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, Q.jsxs)(J, {
      ...
      (V = (0, Q.jsx)(Y, { kind: `denied`, resource: `downloads`, surface: `googleChrome` })),
      (H = (0, Q.jsx)(Y, { kind: `allowed`, resource: `downloads`, surface: `googleChrome` })),
      (U = (0, Q.jsx)(Y, { kind: `denied`, resource: `uploads`, surface: `googleChrome` })),
      (W = (0, Q.jsx)(Y, { kind: `allowed`, resource: `uploads`, surface: `googleChrome` })),
      (G = (0, Q.jsx)(ge, {})),
      (e[33] = R),
      (e[34] = z),
      (e[35] = B),
...
function Pe(e) {
  ...
  t[4] === n
    ...
    : ((h = {
      ...
      (t[5] = h));
  let g;
  t[6] !== f || t[7] !== h ? ((g = [f, h]), (t[6] = f), (t[7] = h), (t[8] = g)) : (g = t[8]);
  let _ = g,
    v;
  t[9] !== s || t[10] !== _
    ? ((v = _.find((e) => e.id === s) ?? _[0]), (t[9] = s), (t[10] = _), (t[11] = v))
    : (v = t[11]);
  let y = v,
    b = o.isPending,
    x;
  t[12] !== s || t[13] !== b || t[14] !== n || t[15] !== r || t[16] !== o
    ? ((x = async (e) => {
        if (!(e === s || b))
          try {
  ...
  t[21] === O
    ? (k = t[22])
    : ((k = (0, Q.jsx)(`span`, { className: `truncate`, children: O })), (t[21] = O), (t[22] = k));
  let A;
  t[23] !== D || t[24] !== k
    ? ((A = (0, Q.jsx)(se, { className: `w-[152px]`, disabled: D, children: k })),
      (t[23] = D),
      (t[24] = k),
      (t[25] = A))
    : (A = t[25]);
  let j;
  t[26] !== s || t[27] !== C || t[28] !== b || t[29] !== _
    ? ((j = (0, Q.jsx)(`div`, {
  ...
  let N;
  return (
    t[35] !== M || t[36] !== w || t[37] !== T
      ? ((N = (0, Q.jsx)(q, { label: w, description: T, control: M })),
        (t[35] = M),
        (t[36] = w),
        (t[37] = T),
        (t[38] = N))
...
function Fe(e) {
  ...
  return (
    t[8] !== i || t[9] !== c || t[10] !== u
      ? ((d = (0, Q.jsxs)(`span`, { className: i, children: [c, u] })),
        (t[8] = i),
        (t[9] = c),
        (t[10] = u),
        (t[11] = d))
...
function Ie() {
  ...
  e[4] === n
    ? (a = e[5])
    : ((a = (0, Q.jsxs)(w, { color: `ghost`, size: `toolbar`, onClick: n, children: [r, i] })),
      (e[4] = n),
      (e[5] = a));
  let o, s;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(l, {
      ...
      (s = (0, Q.jsx)(B, { className: `icon-xs text-token-text-secondary` })),
      (e[6] = o),
      (e[7] = s))
    : ((o = e[6]), (s = e[7]));
  let c;
...
function Le() {
  ...
  let a;
  e[2] === t.data ? (a = e[3]) : ((a = Ve(t.data) ? t.data : ke), (e[2] = t.data), (e[3] = a));
  let o = a,
    c;
  e[4] === o
    ? (c = e[5])
    : ((c = $.find((e) => e.value === o) ?? $.find(Re) ?? $[0]), (e[4] = o), (e[5] = c));
  let l = c,
  ...
  e[12] === m
    ? (_ = e[13])
    : ((_ = (0, Q.jsx)(`div`, { className: `w-max max-w-[calc(100vw-2rem)]`, children: m })),
      (e[12] = m),
      (e[13] = _));
  let v;
  return (
    e[14] !== d || e[15] !== f || e[16] !== _
      ? ((v = (0, Q.jsx)(W, { triggerButton: d, align: `start`, disabled: f, children: _ })),
        (e[14] = d),
        (e[15] = f),
        (e[16] = _),
        (e[17] = v))
...
function ze() {
  ...
  let f;
  e[5] !== a || e[6] !== u
    ? ((f = { mutationFn: ne, onSuccess: a, onError: u }), (e[5] = a), (e[6] = u), (e[7] = f))
    : (f = e[7]);
  let m = g(f);
  ...
  e[15] === m
    ...
    : ((C = (e) => {
      ...
      (e[16] = C));
  let w;
  e[17] !== i.data.enabled || e[18] !== b || e[19] !== x || e[20] !== C
    ? ((w = (0, Q.jsx)(K, { ariaLabel: b, checked: i.data.enabled, disabled: x, onChange: C })),
      (e[17] = i.data.enabled),
      (e[18] = b),
      (e[19] = x),
      (e[20] = C),
  ...
  return (
    e[22] !== _ || e[23] !== w
      ? ((T = (0, Q.jsx)(fe, {
          children: (0, Q.jsx)(q, { icon: _, label: v, description: y, control: w }),
        })),
        (e[22] = _),
        (e[23] = w),
        (e[24] = T))
...
function He() {
  ...
  return (
    e[5] === n.data
      ? (a = e[6])
      : ((a = (0, Q.jsx)(Ue, { approvals: n.data })), (e[5] = n.data), (e[6] = a)),
    a
  );
}
function Ue(e) {
  ...
  t[2] !== a || t[3] !== f
    ? ((p = async () => {
        a != null && (await f.mutateAsync(a.bundleIdentifier), s(null));
      }),
      (t[2] = a),
      (t[3] = f),
      (t[4] = p))
  ...
  let E;
  t[16] !== T || t[17] !== x
    ? ((E = (0, Q.jsx)(P, { children: (0, Q.jsx)(F, { title: x, subtitle: T }) })),
      (t[16] = T),
      (t[17] = x),
      (t[18] = E))
    : (E = t[18]);
  ...
  t[21] === f.isPending
    ? (k = t[22])
    : ((k = (0, Q.jsx)(w, { color: `ghost`, disabled: f.isPending, onClick: D, children: O })),
      (t[21] = f.isPending),
      (t[22] = k));
  let A;
  t[23] === m
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (j = t[25]);
  let M;
  t[26] !== f.isPending || t[27] !== A
    ? ((M = (0, Q.jsx)(w, { color: `danger`, loading: f.isPending, onClick: A, children: j })),
      (t[26] = f.isPending),
      (t[27] = A),
      (t[28] = M))
    : (M = t[28]);
  ...
  let z;
  t[32] !== E || t[33] !== N
    ? ((z = (0, Q.jsxs)(L, { children: [E, N] })), (t[32] = E), (t[33] = N), (t[34] = z))
    : (z = t[34]);
  let B;
  t[35] !== z || t[36] !== v
    ? ((B = (0, Q.jsx)(I, { open: v, onOpenChange: y, size: `compact`, children: z })),
      (t[35] = z),
      (t[36] = v),
      (t[37] = B))
    : (B = t[37]);
  ...
  return (
    t[38] !== B || t[39] !== _
      ? ((V = (0, Q.jsxs)(Q.Fragment, { children: [_, B] })), (t[38] = B), (t[39] = _), (t[40] = V))
      : (V = t[40]),
    V
  );
}
...
function Ge(e, n) {
  let r = A();
  return (
    (r === t.Dev ? X(e, Ee, n) : t.isInternal(r) ? (X(e, De, n) ?? X(e, Ee, n)) : null) ??
    X(e, Te, n)
  );
}
function Ke(e) {
...
//# sourceMappingURL=computer-use-settings-DM-TFXm0.js.map
