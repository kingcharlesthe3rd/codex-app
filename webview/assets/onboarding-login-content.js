...
import { ds as n, js as r } from "./app-server-manager-signals.js";
import { c as i, o as a } from "./lib.js";
import { t as o } from "./button-DO-oxX3-.js";
async function s({ hostId: e = n, signal: t, useStreamlinedLogin: i }) {
  let a = l(t);
  return e === `local`
    ? r(`login-with-chatgpt`, { abortController: a, useStreamlinedLogin: i })
    : r(`login-with-chatgpt-for-host`, { abortController: a, hostId: e, useStreamlinedLogin: i });
}
function c({ signal: e } = {}) {
  return r(`login-with-chatgpt-device-code`, { abortController: l(e) });
}
function l(e) {
