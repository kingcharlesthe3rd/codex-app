...
import { mt as d, pt as f } from "./app-initial~app-main~automations-page.js";
import {
  Q as p,
  Z as m,
...
async function h({
  ...
  let o = _(r);
  return n === `local`
    ? c(`login-with-chatgpt`, {
        abortController: o,
        ...(i && e != null ? { appBrand: e } : {}),
        useHostedLoginSuccessPage: i,
        useStreamlinedLogin: a,
      })
    : c(`login-with-chatgpt-for-host`, {
        abortController: o,
        hostId: n,
        ...(i && e != null ? { appBrand: e } : {}),
        useHostedLoginSuccessPage: i,
...
function g({ signal: e } = {}) {
  return c(`login-with-chatgpt-device-code`, { abortController: _(e) });
}
function _(e) {
...
function y({
  authUrl: e,
  sourceSurfaceStableId: t = x.StableID.get(f),
  ...
  try {
    ...
    if ((t && b(a, t, n), i && a.searchParams.set(T, `true`), !r)) return a.toString();
    let o = new URL(C);
    return (
  ...
  if (r) {
    ...
    t[1] === h
      ...
      : ((r = h.formatMessage({
        ...
        (t[2] = r));
    let o;
    t[3] === u ? (o = t[4]) : ((o = (e) => u(e.target.value)), (t[3] = u), (t[4] = o));
    let l;
    t[5] !== n || t[6] !== r || t[7] !== o
      ? ((l = (0, A.jsxs)(`label`, {
    ...
    let f;
    t[12] !== n || t[13] !== i
      ? ((f = n.trim().length === 0 || i), (t[12] = n), (t[13] = i), (t[14] = f))
      : (f = t[14]);
    let g;
    ...
    let v;
    t[20] !== d || t[21] !== _
      ? ((v = (0, A.jsxs)(`div`, { className: `flex items-center gap-2`, children: [d, _] })),
        (t[20] = d),
        (t[21] = _),
        (t[22] = v))
      : (v = t[22]);
    ...
    return (
      t[23] !== l || t[24] !== v
        ? ((y = (0, A.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [l, v] })),
          (t[23] = l),
          (t[24] = v),
          (t[25] = y))
        : (y = t[25]),
