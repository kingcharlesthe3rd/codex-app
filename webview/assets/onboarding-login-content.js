...
import { As as n, us as r } from "./app-server-manager-signals.js";
import { c as i, o as a } from "./lib-1.js";
import { t as o } from "./button.js";
async function s({ hostId: e = r, signal: t, useStreamlinedLogin: i }) {
  let a = l(t);
  return e === `local`
...
function c({ signal: e } = {}) {
  return n(`login-with-chatgpt-device-code`, { abortController: l(e) });
}
function l(e) {
