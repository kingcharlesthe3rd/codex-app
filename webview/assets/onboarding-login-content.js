import { Xs as e, po as t } from "./app-server-manager-signals.js";
...
async function s({ hostId: n = t, signal: r, useStreamlinedLogin: i }) {
  ...
  return n === `local`
    ...
    : e(`login-with-chatgpt-for-host`, { abortController: a, hostId: n, useStreamlinedLogin: i });
}
function c({ signal: t } = {}) {
  ...
  if (a) {
    ...
    t[1] === _
      ...
      : ((r = _.formatMessage({
        ...
        (t[2] = r));
    let a;
    t[3] === p ? (a = t[4]) : ((a = (e) => p(e.target.value)), (t[3] = p), (t[4] = a));
    let c;
    t[5] !== n || t[6] !== r || t[7] !== a
      ? ((c = (0, d.jsxs)(`label`, {
