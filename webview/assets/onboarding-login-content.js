...
async function h({
  ...
  let o = _(n);
  return t === `local`
    ? s(`login-with-chatgpt`, {
        abortController: o,
        ...(i && e != null ? { appBrand: e } : {}),
        useHostedLoginSuccessPage: i,
        useStreamlinedLogin: a,
      })
    : s(`login-with-chatgpt-for-host`, {
        abortController: o,
        hostId: t,
        ...(i && e != null ? { appBrand: e } : {}),
        useHostedLoginSuccessPage: i,
...
function g({ signal: e } = {}) {
  return s(`login-with-chatgpt-device-code`, { abortController: _(e) });
}
function _(e) {
  ...
  if (a) {
    ...
    n[1] === h
      ...
      : ((i = h.formatMessage({
        ...
        (n[2] = i));
    let a;
    n[3] === u ? (a = n[4]) : ((a = (e) => u(e.target.value)), (n[3] = u), (n[4] = a));
    let s;
    n[5] !== r || n[6] !== i || n[7] !== a
      ? ((s = (0, A.jsxs)(`label`, {
    ...
    let p;
    n[12] !== r || n[13] !== o
      ? ((p = r.trim().length === 0 || o), (n[12] = r), (n[13] = o), (n[14] = p))
      : (p = n[14]);
    let g;
    ...
    let v;
    n[20] !== f || n[21] !== _
      ? ((v = (0, A.jsxs)(`div`, { className: `flex items-center gap-2`, children: [f, _] })),
        (n[20] = f),
        (n[21] = _),
        (n[22] = v))
      : (v = n[22]);
    ...
    return (
      n[23] !== s || n[24] !== v
        ? ((y = (0, A.jsxs)(`div`, { className: `flex w-full flex-col gap-3`, children: [s, v] })),
          (n[23] = s),
          (n[24] = v),
          (n[25] = y))
        : (y = n[25]),
