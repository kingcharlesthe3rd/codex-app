import { Ht as e, Qi as t, _a as n, ea as r, ha as i, la as a, pa as o, ua as s } from "./src-2.js";
...
var l = new Set([`text/html`, `text/html;profile=mcp-app`]),
  ...
  m = s({
    ...
    ui: s({ resourceUri: i().optional() }).strip().optional(),
  ...
  h = s({
    _meta: s({
      ...
      "openai/widgetHeightHint": a()
        .finite()
        .positive()
        .optional()
        .catch(void 0),
      "openai/widgetPrefersBorder": r().optional(),
      ui: s({
        csp: s({
          baseUriDomains: p.optional(),
          connectDomains: p.optional(),
