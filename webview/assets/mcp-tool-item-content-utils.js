import { Ki as e, Wi as t, aa as n, la as r, na as i, sa as a, ta as o, xn as s } from "./src-2.js";
...
var l = new Set([`text/html`, `text/html;profile=mcp-app`]),
  ...
  p = t(a()).transform(E),
  m = i({
    connectorId: a().optional(),
    connector_id: a().optional(),
    "openai/outputTemplate": a().optional(),
    ui: i({ resourceUri: a().optional() }).strip().optional(),
    "ui/resourceUri": a().optional(),
  }).passthrough(),
  h = i({
    _meta: i({
      "openai/widgetCSP": i({
        ...
        .strip()
        .optional(),
      "openai/widgetDomain": a().optional(),
      "openai/widgetHeightHint": o()
        .finite()
        .positive()
        .optional()
        .catch(void 0),
      "openai/widgetPrefersBorder": e().optional(),
      ui: i({
        csp: i({
          baseUriDomains: p.optional(),
          connectDomains: p.optional(),
