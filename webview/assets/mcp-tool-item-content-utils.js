import { Ut as e, Vi as t, Xi as n, Zi as r, ea as i, ia as a, na as o, zi as s } from "./src-1.js";
...
var l = new Set([`text/html`, `text/html;profile=mcp-app`]),
  ...
  p = s(o()).transform(E),
  m = r({
    connectorId: o().optional(),
    connector_id: o().optional(),
    "openai/outputTemplate": o().optional(),
    ui: r({ resourceUri: o().optional() }).strip().optional(),
    "ui/resourceUri": o().optional(),
  }).passthrough(),
  h = r({
    _meta: r({
      "openai/widgetCSP": r({
        ...
        .strip()
        .optional(),
      "openai/widgetDomain": o().optional(),
      "openai/widgetHeightHint": n()
        .finite()
        .positive()
        .optional()
        .catch(void 0),
      "openai/widgetPrefersBorder": t().optional(),
      ui: r({
        csp: r({
          baseUriDomains: p.optional(),
          connectDomains: p.optional(),
...
function O({ locale: t, originScope: n, widgetDomain: r }) {
  return e({ locale: t, subdomain: A({ originScope: n, widgetDomain: r }) });
}
