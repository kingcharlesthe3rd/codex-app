import { $t as e, Bi as t, Ji as n, Ki as r, Vi as i, Wi as a, ji as o, ki as s } from "./src-4.js";
...
var l = new Set([`text/html`, `text/html;profile=mcp-app`]),
  ...
  p = s(r()).transform(E),
  m = i({
    connectorId: r().optional(),
    connector_id: r().optional(),
    "openai/outputTemplate": r().optional(),
    ui: i({ resourceUri: r().optional() }).strip().optional(),
    "ui/resourceUri": r().optional(),
  }).passthrough(),
  h = i({
    _meta: i({
      "openai/widgetCSP": i({
        ...
        .strip()
        .optional(),
      "openai/widgetDomain": r().optional(),
      "openai/widgetHeightHint": t()
        .finite()
        .positive()
        .optional()
        .catch(void 0),
      "openai/widgetPrefersBorder": o().optional(),
      ui: i({
        csp: i({
          baseUriDomains: p.optional(),
          connectDomains: p.optional(),
