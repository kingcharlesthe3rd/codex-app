...
function Yt(e, t, n) {
  let r = e.threadKeys.flatMap((e) => {
    ...
    a = Qt(p({ projectId: e.projectId, projectWritableRoots: t, legacyRoot: e.path ?? null }));
  return {
    group: e,
...
function tn(e) {
  ...
  t[0] !== r || t[1] !== i || t[2] !== a.label || t[3] !== c
    ? ((l =
        i && c != null ? `${r ?? ``}${r == null ? `` : `: `}${c}` : c == null ? a.label : tt(c)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a.label),
      (t[3] = c),
  ...
  if (i && n != null) {
    ...
    (t[7] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Y.jsx)(G, { className: `icon-xs shrink-0 text-token-description-foreground` })),
        (t[7] = e))
      : (e = t[7]),
      (f = e));
  } else {
  ...
  t[18] !== s || t[19] !== d || t[20] !== o || t[21] !== a.label || t[22] !== h || t[23] !== c
    ? ((v = d
        ? (0, Y.jsx)(`button`, {
            ...
            onClick: () => {
              T({ path: c, cwd: g(c), target: `fileManager`, openFile: o.mutate });
            },
            children: h,
          })
        : (0, Y.jsx)(`div`, {
...
function nn(e) {
  ...
  let a;
  t[3] === i ? (a = t[4]) : ((a = (0, Y.jsx)(C, { dateString: i })), (t[3] = i), (t[4] = a));
  let o;
  return (
    t[5] !== r || t[6] !== a
      ? ((o = (0, Y.jsx)(k, { nowMs: r, children: a })), (t[5] = r), (t[6] = a), (t[7] = o))
      : (o = t[7]),
    o
  );
}
...
function yn(e) {
  let t = (0, Z.c)(119),
    { expanded: n, now: a, onShowAllChange: s, onToggleExpanded: c, row: l, showAll: u } = e,
    d = o(r),
    f = Le(),
    m = bt(),
    g = ze(gt),
  ...
  t[0] !== _ || t[1] !== l.group.projectId
    ? ((y = _?.includes(l.group.projectId)), (t[0] = _), (t[1] = l.group.projectId), (t[2] = y))
    : (y = t[2]);
  let b = y === !0,
    x;
  ...
  t[34] === z
    ? (B = t[35])
    : ((B = (0, $.jsx)(se, { "aria-hidden": `true`, className: z })), (t[34] = z), (t[35] = B));
  let V;
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ne = K(un, `flex min-w-0 items-center gap-2 text-token-text-secondary max-[920px]:hidden`)),
      (t[48] = ne))
    : (ne = t[48]);
  ...
  t[49] !== l.sources || t[50] !== re || t[51] !== W || t[52] !== G
    ? ((ae = (0, $.jsx)(en, { hostId: re, hostLabel: W, isRemote: G, sources: l.sources })),
      (t[49] = l.sources),
      (t[50] = re),
      (t[51] = W),
      (t[52] = G),
  ...
  t[65] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((le = K(un, `text-token-text-secondary max-[680px]:hidden`)), (t[65] = le))
    : (le = t[65]);
  let ue;
  ...
  t[97] !== fe || t[98] !== he || t[99] !== be
    ...
    : (xe = t[100]);
  let Se;
  t[101] !== T || t[102] !== D || t[103] !== U || t[104] !== ce || t[105] !== ue || t[106] !== xe
    ? ((Se = (0, $.jsxs)(`div`, {
        "data-project-row": !0,
        className: A,
        onClick: T,
...
function bn(e) {
  ...
  let i;
  return (
    t[0] === n ? (i = t[1]) : ((i = (0, $.jsx)(St, { hostId: n })), (t[0] = n), (t[1] = i)), i
  );
}
function xn(e) {
  let t = (0, Z.c)(57),
  ...
  let D = E,
    O;
  t[12] !== l || t[13] !== g
    ? ((O = l.formatMessage(g ? ut : st)), (t[12] = l), (t[13] = g), (t[14] = O))
    : (O = t[14]);
  let k = O,
    A;
  t[15] === i
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = K(un, `col-span-2 flex min-w-0 items-center gap-3 max-[920px]:col-span-1`)),
      (t[17] = j))
    : (j = t[17]);
  let M = p ?? null,
    N;
  ...
  let V = p ?? null,
    H;
  t[33] !== C || t[34] !== V
    ? ((H = (0, $.jsx)(wn, { entry: V, onOpenThread: C })), (t[33] = C), (t[34] = V), (t[35] = H))
    : (H = t[35]);
  let te;
  ...
  return (
    t[51] !== T || t[52] !== I || t[53] !== z || t[54] !== G || t[55] !== A
      ? ((ie = (0, $.jsxs)(`div`, { className: A, onClick: T, children: [I, z, G] })),
        (t[51] = T),
        (t[52] = I),
        (t[53] = z),
        (t[54] = G),
...
function Dn(e) {
  let t = (0, Z.c)(50),
    { canEditLocalProject: n, initialSources: i, localProjectSourcesEnabled: s, row: c } = e,
    l = o(r),
    u = Le(),
    d = m(M),
  ...
  t[5] === C
    ...
    : ((T = (0, $.jsx)(ee, {
      ...
      (t[6] = T));
  let E;
  t[7] !== n || t[8] !== i || t[9] !== c.group || t[10] !== c.name || t[11] !== l
    ? ((E = n
        ? (0, $.jsx)(q.Item, {
            LeftIcon: It,
            onSelect: () => {
    ...
    : (E = t[12]);
  let D;
  t[13] !== n || t[14] !== i || t[15] !== s || t[16] !== c.group || t[17] !== c.name || t[18] !== l
    ? ((D =
        n && s
          ? (0, $.jsx)(q.Item, {
              LeftIcon: hn,
  ...
  t[22] === O
    ? (j = t[23])
    : ((j = (0, $.jsx)(q.Item, { LeftIcon: rt, disabled: O, onSelect: k, children: A })),
      (t[22] = O),
      (t[23] = j));
  let N;
  ...
  t[35] !== b || t[36] !== c.group || t[37] !== c.name || t[38] !== d
    ...
    : (I = t[39]);
  let L;
  t[40] !== b || t[41] !== c.group.projectId || t[42] !== c.group.projectKind || t[43] !== c.name
    ? ((L =
