...
import { Gd as lt, Wd as ut } from "./app-initial~app-main~onboarding-page~profile.js";
import {
  an as dt,
  in as ft,
  nn as pt,
...
import { n as Bt, t as Vt } from "./page-search-input.js";
import { n as Ht, t as Ut } from "./use-element-in-view.js";
import { n as Wt } from "./infinite-scroll-pagination-spinner.js";
import { n as Gt, t as Kt } from "./thread-overflow-menu-CM-Eo7JH.js";
function qt({
  cloudRows: e = [],
  groups: t,
...
function Jt(e, t, n) {
  let r = e.threadKeys.flatMap((e) => {
    ...
    a = Zt(z({ projectId: e.projectId, projectWritableRoots: t, legacyRoot: e.path ?? null }));
  return {
    group: e,
...
function Yt(e, t, n) {
  switch (n) {
    case `modified`:
      return (e.modifiedAt ?? 0) - (t.modifiedAt ?? 0) || Xt(e, t);
    case `name`:
      return Xt(e, t);
    case `sources`:
      return (
...
function Zt(e) {
  return e.map((e) => ({ kind: `folder`, label: P(e), path: e }));
}
var Qt = e(() => {
  (q(), xe());
});
...
function en(e) {
  ...
  t[0] !== r || t[1] !== i || t[2] !== a.label || t[3] !== c
    ? ((u =
        i && c != null ? `${r ?? ``}${r == null ? `` : `: `}${c}` : c == null ? a.label : It(c)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a.label),
      (t[3] = c),
  ...
  if (i && n != null) {
    ...
    (t[7] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, X.jsx)(rt, { className: `icon-xs shrink-0 text-token-description-foreground` })),
        (t[7] = e))
      : (e = t[7]),
      (p = e));
  } else {
  ...
  t[13] === a.label
    ? (m = t[14])
    : ((m = (0, X.jsx)(`span`, { className: `min-w-0 truncate`, children: a.label })),
      (t[13] = a.label),
      (t[14] = m));
  let h;
  t[15] !== p || t[16] !== m
    ? ((h = (0, X.jsxs)(X.Fragment, { children: [p, m] })), (t[15] = p), (t[16] = m), (t[17] = h))
    : (h = t[17]);
  let g = h,
    _;
  t[18] !== s || t[19] !== f || t[20] !== o || t[21] !== a.label || t[22] !== g || t[23] !== c
    ? ((_ = f
        ? (0, X.jsx)(`button`, {
            type: `button`,
            ...
            onClick: () => {
              gt({ path: c, cwd: l(c), target: `fileManager`, openFile: o.mutate });
            },
            children: g,
          })
        : (0, X.jsx)(`div`, {
  ...
  return (
    t[25] !== d || t[26] !== _
      ? ((v = (0, X.jsx)(me, { tooltipContent: d, children: _ })),
        (t[25] = d),
        (t[26] = _),
        (t[27] = v))
      : (v = t[27]),
...
function tn(e) {
  ...
  let i;
  t[1] === n ? (i = t[2]) : ((i = new Date(nn(n)).toISOString()), (t[1] = n), (t[2] = i));
  let a;
  t[3] === i ? (a = t[4]) : ((a = (0, X.jsx)(st, { dateString: i })), (t[3] = i), (t[4] = a));
  let o;
  return (
    t[5] !== r || t[6] !== a
      ? ((o = (0, X.jsx)(at, { nowMs: r, children: a })), (t[5] = r), (t[6] = a), (t[7] = o))
      : (o = t[7]),
    o
  );
}
...
var rn,
  ...
  dn = e(() => {
    ((rn = he()),
      ...
      n(),
      (X = o()),
      (an = `grid grid-cols-[minmax(0,2fr)_minmax(16rem,1fr)_4rem_8rem] gap-x-4 max-[920px]:grid-cols-[minmax(0,1fr)_4rem_8rem] max-[680px]:grid-cols-[minmax(0,1fr)_8rem]`),
      (on = `relative before:pointer-events-none before:absolute before:-inset-x-3 before:rounded-lg before:bg-token-list-hover-background before:opacity-0 hover:before:opacity-100`),
      (sn = `after:pointer-events-none after:absolute after:-top-px after:-inset-x-3 after:h-px after:bg-token-main-surface-primary after:opacity-0 hover:after:opacity-100`),
      (cn = `border-b border-token-border [&:has(+_[data-project-row-wrapper]:has(>_[data-project-row]:hover))]:border-b-transparent`),
      (ln = `relative z-10`),
      (un = `h-8 w-8 shrink-0 rounded-lg !p-1 text-token-text-secondary hover:text-token-foreground focus-visible:text-token-foreground data-[state=open]:text-token-foreground`));
  });
function fn(e) {
  return (
...
function _n() {
  let e = ue(),
    t = b(M),
    { data: n } = C(U.THREAD_PROJECT_ASSIGNMENTS),
    { data: r } = C(U.PROJECTLESS_THREAD_IDS),
    { data: i } = C(U.PROJECT_WRITABLE_ROOTS),
    { groups: o } = O(pe, {
      enabled: !0,
  ...
  return (
    ...
    (0, $.jsxs)(`div`, {
      ...
      children: [
        (0, $.jsx)(H, { extension: !0, children: D }),
        (0, $.jsx)(H, {
          browser: !0,
          chromeExtension: !0,
          electron: !0,
          children: (0, $.jsx)(Te.Header, { children: D }),
        }),
        (0, $.jsx)(`div`, {
          ref: h,
                              ...
                              return e.kind === `cloud`
                                ...
                                : (0, $.jsx)(
                                    yn,
                                    {
                                      expanded: t,
                                      now: te,
                                      onShowAllChange: (t) => A(e.projectId, t),
                                      onToggleExpanded: () => ne(e.id),
                                      row: e,
                                      showAll: x.has(e.projectId),
                                    },
                                    e.id,
                                  );
                            }),
...
function vn(e) {
  ...
  t[3] === r
    ? (u = t[4])
    : ((u = (0, $.jsx)(`span`, { className: `truncate`, children: r })), (t[3] = r), (t[4] = u));
  let d;
  t[5] !== n || t[6] !== o
    ? ((d = n
        ? (0, $.jsx)(j, {
...
function yn(e) {
  let t = (0, Z.c)(119),
    ...
    f = Qe(),
    h = ge(Tt),
    { data: g } = C(U.PINNED_PROJECT_IDS),
    { data: _ } = C(U.PROJECT_WRITABLE_ROOTS),
    v;
  t[0] !== g || t[1] !== s.group.projectId
    ? ((v = g?.includes(s.group.projectId)), (t[0] = g), (t[1] = s.group.projectId), (t[2] = v))
    : (v = t[2]);
  let y = v === !0,
    b;
  t[3] !== _ || t[4] !== s.group.path || t[5] !== s.group.projectId
    ? ((b = z({
        projectId: s.group.projectId,
        projectWritableRoots: ee(_),
    ...
    : (b = t[6]);
  let x = b,
    S = s.group.projectKind === `local` && (s.group.isLocalProject === !0 || s.group.path != null),
    te;
  t[7] === o
    ? (te = t[8])
    : ((te = (e) => {
  ...
  t[9] !== s.group || t[10] !== f
    ...
    : (T = t[11]);
  let E = T,
    D = !n && `[&:has(>_[data-project-row]:hover)]:border-b-transparent`,
    O;
  t[12] === D ? (O = t[13]) : ((O = a(cn, D)), (t[12] = D), (t[13] = O));
  let k;
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = a(ln, `flex min-w-0 items-center gap-3`)), (t[15] = A))
    : (A = t[15]);
  let M;
  t[16] !== n || t[17] !== s.group.projectKind
    ? ((M =
        s.group.projectKind === `remote`
          ? (0, $.jsx)(pt, { className: `icon-xs shrink-0` })
          : (0, $.jsx)(Fe, { className: `icon-xs shrink-0`, open: n })),
      (t[16] = n),
      (t[17] = s.group.projectKind),
      (t[18] = M))
    : (M = t[18]);
  let N;
  t[19] !== s.group.projectId || t[20] !== s.name || t[21] !== M
    ? ((N = (0, $.jsx)(ye, {
        projectId: s.group.projectId,
        projectName: s.name,
  ...
  t[34] === B
    ? (V = t[35])
    : ((V = (0, $.jsx)(j, { "aria-hidden": `true`, className: B })), (t[34] = B), (t[35] = V));
  let H;
  t[36] !== n || t[37] !== I || t[38] !== L || t[39] !== V
    ? ((H = (0, $.jsx)(`button`, {
        type: `button`,
  ...
  let G;
  t[45] !== N || t[46] !== W
    ? ((G = (0, $.jsxs)(`div`, { className: A, children: [N, W] })),
      (t[45] = N),
      (t[46] = W),
      (t[47] = G))
    : (G = t[47]);
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = a(ln, `flex min-w-0 items-center gap-2 text-token-text-secondary max-[920px]:hidden`)),
      (t[48] = K))
    : (K = t[48]);
  let q = s.group.projectKind === `remote` ? s.group.hostId : null,
    re =
      s.group.projectKind === `remote` ? (s.group.hostDisplayName ?? s.group.hostId ?? null) : null,
    ie = s.group.projectKind === `remote`,
    ae;
  t[49] !== s.sources || t[50] !== q || t[51] !== re || t[52] !== ie
    ? ((ae = (0, $.jsx)($t, { hostId: q, hostLabel: re, isRemote: ie, sources: s.sources })),
      (t[49] = s.sources),
      (t[50] = q),
      (t[51] = re),
      (t[52] = ie),
  ...
  let se;
  t[62] !== ae || t[63] !== oe
    ? ((se = (0, $.jsxs)(`span`, { className: K, children: [ae, oe] })),
      (t[62] = ae),
      (t[63] = oe),
      (t[64] = se))
    : (se = t[64]);
  ...
  t[65] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = a(ln, `text-token-text-secondary max-[680px]:hidden`)), (t[65] = ce))
    : (ce = t[65]);
  let le;
  t[66] !== r || t[67] !== s.modifiedAt
    ? ((le = (0, $.jsx)(`span`, {
        className: ce,
        children: (0, $.jsx)(tn, { modifiedAt: s.modifiedAt, now: r }),
      })),
      (t[66] = r),
      (t[67] = s.modifiedAt),
      (t[68] = le))
  ...
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((de = a(ln, `flex min-w-0 justify-end gap-1`)), (t[69] = de))
    : (de = t[69]);
  let fe;
  t[70] !== S || t[71] !== x || t[72] !== h || t[73] !== s
    ? ((fe = (0, $.jsx)(Dn, {
        canEditLocalProject: S,
        initialSources: x,
        localProjectSourcesEnabled: h,
        row: s,
      })),
      (t[70] = S),
      (t[71] = x),
  ...
  t[78] !== g || t[79] !== s.group.projectId || t[80] !== l
    ? ((me = () => {
        p(l, U.PINNED_PROJECT_IDS, kn(g, s.group.projectId));
      }),
      (t[78] = g),
  ...
  t[82] === y
    ...
    : ((he = y
        ...
        : (0, $.jsx)(Dt, { className: `icon-xs` })),
      (t[82] = y),
      (t[83] = he));
  let J;
  t[84] !== pe || t[85] !== me || t[86] !== he
    ? ((J = (0, $.jsx)(u, {
        "aria-label": pe,
        className: un,
        color: `ghostMuted`,
  ...
  let be;
  t[90] !== s.group || t[91] !== f
    ? ((be = () => f(s.group)), (t[90] = s.group), (t[91] = f), (t[92] = be))
    : (be = t[92]);
  let xe;
  t[93] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xe = (0, $.jsx)(Ct, { className: `icon-xs` })), (t[93] = xe))
    : (xe = t[93]);
  let Se;
  t[94] !== ve || t[95] !== be
    ? ((Se = (0, $.jsx)(u, {
    ...
    : (Se = t[96]);
  let Ce;
  t[97] !== fe || t[98] !== J || t[99] !== Se
    ? ((Ce = (0, $.jsxs)(`span`, { className: de, children: [fe, J, Se] })),
      (t[97] = fe),
      (t[98] = J),
      (t[99] = Se),
      (t[100] = Ce))
    : (Ce = t[100]);
  let we;
  t[101] !== w || t[102] !== E || t[103] !== G || t[104] !== se || t[105] !== le || t[106] !== Ce
    ? ((we = (0, $.jsxs)(`div`, {
        "data-project-row": !0,
        className: k,
        onClick: w,
...
function bn(e) {
  ...
  let i;
  return (
    t[0] === n ? (i = t[1]) : ((i = (0, $.jsx)(ze, { hostId: n })), (t[0] = n), (t[1] = i)), i
  );
}
function xn(e) {
  let t = (0, Z.c)(57),
    ...
    g = O(Ne, i),
    _;
  t[0] === i ? (_ = t[1]) : ((_ = se(i)), (t[0] = i), (t[1] = _));
  let v = _,
    y = v != null,
    ee =
      f?.kind === `local`
        ? (h ?? f.summary?.updatedAt ?? null)
        : f?.kind === `remote`
          ? (f.task.updated_at ?? f.task.created_at ?? null)
          : null,
    b;
  t[2] !== c || t[3] !== l || t[4] !== o || t[5] !== i
    ? ((b = () => {
        (He(o, i), Ie(o, i, l, c));
      }),
      (t[2] = c),
  ...
  let T = w,
    E;
  t[12] !== s || t[13] !== g
    ? ((E = s.formatMessage(g ? bt : yt)), (t[12] = s), (t[13] = g), (t[14] = E))
    : (E = t[14]);
  let k = E,
    A;
  t[15] === r
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = a(ln, `col-span-2 flex min-w-0 items-center gap-3 max-[920px]:col-span-1`)),
      (t[17] = j))
    : (j = t[17]);
  let M = f ?? null,
    P;
  t[18] !== p || t[19] !== M
    ? ((P = (0, $.jsx)(Cn, { entry: M, localConversationId: p })),
      (t[18] = p),
      (t[19] = M),
      (t[20] = P))
    : (P = t[20]);
  ...
  let I;
  t[23] !== F || t[24] !== P
    ? ((I = (0, $.jsxs)(`div`, { className: j, children: [P, F] })),
      (t[23] = F),
      (t[24] = P),
      (t[25] = I))
    : (I = t[25]);
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = a(ln, `text-token-text-secondary max-[680px]:hidden`)), (t[26] = L))
    : (L = t[26]);
  let R;
  t[27] !== ee || t[28] !== d
    ? ((R = ee == null ? null : (0, $.jsx)(tn, { modifiedAt: ee, now: d })),
      (t[27] = ee),
      (t[28] = d),
      (t[29] = R))
    : (R = t[29]);
  ...
  t[30] === R
    ? (z = t[31])
    : ((z = (0, $.jsx)(`span`, { className: L, children: R })), (t[30] = R), (t[31] = z));
  let B;
  t[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = a(ln, `flex min-w-0 justify-end gap-1`)), (t[32] = B))
    : (B = t[32]);
  let V = f ?? null,
    H;
  t[33] !== S || t[34] !== V
    ? ((H = (0, $.jsx)(wn, { entry: V, onOpenThread: S })), (t[33] = S), (t[34] = V), (t[35] = H))
    : (H = t[35]);
  let U;
  t[36] !== y || t[37] !== g || t[38] !== k || t[39] !== T
    ? ((U = y
        ? (0, $.jsx)(u, {
            "aria-label": k,
            className: a(
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, $.jsx)(N, { className: `icon-xs` })), (t[43] = G))
    : (G = t[43]);
  let K;
  t[44] !== S || t[45] !== W
    ? ((K = (0, $.jsx)(u, {
    ...
    : (K = t[46]);
  let q;
  t[47] !== H || t[48] !== U || t[49] !== K
    ? ((q = (0, $.jsxs)(`span`, { className: B, children: [H, U, K] })),
      (t[47] = H),
      (t[48] = U),
      (t[49] = K),
      (t[50] = q))
  ...
  let re;
  return (
    t[51] !== te || t[52] !== I || t[53] !== z || t[54] !== q || t[55] !== A
      ? ((re = (0, $.jsxs)(`div`, { className: A, onClick: te, children: [I, z, q] })),
        (t[51] = te),
        (t[52] = I),
        (t[53] = z),
        (t[54] = q),
...
function Tn(e) {
  ...
  t[2] === c
    ? (l = t[3])
    : ((l = a(un, `opacity-0 group-hover/thread-row:opacity-100 focus-visible:opacity-100`, c)),
      (t[2] = c),
      (t[3] = l));
  let d;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(Ee, { className: `icon-xs` })), (t[4] = d))
    : (d = t[4]);
  let f;
  t[5] !== s || t[6] !== l
    ? ((f = (0, $.jsx)(u, {
  ...
  t[11] === p
    ? (h = t[12])
    : ((h = (0, $.jsx)(J.Item, { LeftIcon: N, onSelect: p, children: m })),
      (t[11] = p),
      (t[12] = h));
  let g;
  return (
...
function Dn(e) {
  let t = (0, Z.c)(50),
    ...
    s = ue(),
    l = b(K),
    d = O(h, a.group.threadKeys),
    f;
  t[0] === d ? (f = t[1]) : ((f = I(d)), (t[0] = d), (t[1] = f));
  let p = f,
    [g, v] = (0, Q.useState)(!1),
    [y, ee] = (0, Q.useState)(!1),
    [x, S] = (0, Q.useState)(!1),
  ...
  let w;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(Ee, { className: `icon-xs` })), (t[4] = w))
    : (w = t[4]);
  let T;
  t[5] === C
    ? (T = t[6])
  ...
  t[22] === k
    ? (M = t[23])
    : ((M = (0, $.jsx)(J.Item, { LeftIcon: jt, disabled: k, onSelect: A, children: j })),
      (t[22] = k),
      (t[23] = M));
  let N;
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (N = t[24]);
  let P;
  t[25] !== g || t[26] !== M || t[27] !== T || t[28] !== E || t[29] !== D
    ? ((P = (0, $.jsxs)(_, {
        align: `end`,
        contentWidth: `xs`,
        open: g,
    ...
    : (P = t[30]);
  let L;
  t[31] !== y || t[32] !== a.group.threadKeys || t[33] !== a.name
    ? ((L = y
        ? (0, $.jsx)(Ce, {
            projectLabel: a.name,
    ...
    : (L = t[34]);
  let R;
  t[35] !== x || t[36] !== a.group || t[37] !== a.name || t[38] !== l
    ? ((R =
        x && a.group.projectKind === `local`
          ? (0, $.jsx)(F, {
              project: a.group,
              projectLabel: a.name,
    ...
    : (R = t[39]);
  let z;
  t[40] !== x || t[41] !== a.group.projectId || t[42] !== a.group.projectKind || t[43] !== a.name
    ? ((z =
        x && a.group.projectKind === `remote`
          ? (0, $.jsx)(c, {
  ...
  let B;
  return (
    t[45] !== P || t[46] !== L || t[47] !== R || t[48] !== z
      ? ((B = (0, $.jsxs)($.Fragment, { children: [P, L, R, z] })),
        (t[45] = P),
        (t[46] = L),
        (t[47] = R),
        (t[48] = z),
