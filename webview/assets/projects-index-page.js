...
import { bt as K, xt as oe } from "./app-initial~app-main~automations-page.js";
import {
  d as se,
  f as q,
  p as ce,
...
function Yt(e, t, n) {
  let r = e.threadKeys.flatMap((e) => {
    ...
    a = Qt(d({ projectId: e.projectId, projectWritableRoots: t, legacyRoot: e.path ?? null }));
  return {
    group: e,
...
function tn(e) {
  ...
  t[0] !== r || t[1] !== i || t[2] !== a.label || t[3] !== c
    ? ((u =
        i && c != null ? `${r ?? ``}${r == null ? `` : `: `}${c}` : c == null ? a.label : yt(c)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a.label),
      (t[3] = c),
  ...
  if (i && n != null) {
    ...
    (t[7] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Y.jsx)(ze, { className: `icon-xs shrink-0 text-token-description-foreground` })),
        (t[7] = e))
      : (e = t[7]),
      (m = e));
  } else {
  ...
  let _;
  t[15] !== m || t[16] !== h
    ? ((_ = (0, Y.jsxs)(Y.Fragment, { children: [m, h] })), (t[15] = m), (t[16] = h), (t[17] = _))
    : (_ = t[17]);
  let v = _,
    y;
  t[18] !== s || t[19] !== f || t[20] !== o || t[21] !== a.label || t[22] !== v || t[23] !== c
    ? ((y = f
        ? (0, Y.jsx)(`button`, {
            type: `button`,
            ...
            onClick: () => {
              We({ path: c, cwd: l(c), target: `fileManager`, openFile: o.mutate });
            },
            children: v,
          })
        : (0, Y.jsx)(`div`, {
...
function nn(e) {
  ...
  let a;
  t[3] === i ? (a = t[4]) : ((a = (0, Y.jsx)(Be, { dateString: i })), (t[3] = i), (t[4] = a));
  let o;
  return (
    t[5] !== r || t[6] !== a
      ? ((o = (0, Y.jsx)(Je, { nowMs: r, children: a })), (t[5] = r), (t[6] = a), (t[7] = o))
      : (o = t[7]),
    o
  );
}
...
function yn(e) {
  let t = (0, Z.c)(119),
    { expanded: n, now: r, onShowAllChange: i, onToggleExpanded: a, row: s, showAll: c } = e,
    l = o(ae),
    f = ie(),
    p = ct(),
    m = M(It),
  ...
  t[0] !== g || t[1] !== s.group.projectId
    ? ((y = g?.includes(s.group.projectId)), (t[0] = g), (t[1] = s.group.projectId), (t[2] = y))
    : (y = t[2]);
  let b = y === !0,
    x;
  t[3] !== v || t[4] !== s.group.path || t[5] !== s.group.projectId
    ...
    : (x = t[6]);
  let S = x,
    C = s.group.projectKind === `local` && (s.group.isLocalProject === !0 || s.group.path != null),
    w;
  t[7] === a
    ? (w = t[8])
    : ((w = (e) => {
  ...
  t[34] === ne
    ? (B = t[35])
    : ((B = (0, $.jsx)(le, { "aria-hidden": `true`, className: ne })), (t[34] = ne), (t[35] = B));
  let re;
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = q(un, `flex min-w-0 items-center gap-2 text-token-text-secondary max-[920px]:hidden`)),
      (t[48] = U))
    : (U = t[48]);
  ...
  t[49] !== s.sources || t[50] !== G || t[51] !== K || t[52] !== oe
    ? ((se = (0, $.jsx)(en, { hostId: G, hostLabel: K, isRemote: oe, sources: s.sources })),
      (t[49] = s.sources),
      (t[50] = G),
      (t[51] = K),
      (t[52] = oe),
  ...
  t[65] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((de = q(un, `text-token-text-secondary max-[680px]:hidden`)), (t[65] = de))
    : (de = t[65]);
  let fe;
  ...
  t[97] !== me || t[98] !== ye || t[99] !== Ce
    ...
    : (Te = t[100]);
  let Ee;
  t[101] !== T || t[102] !== D || t[103] !== H || t[104] !== ue || t[105] !== fe || t[106] !== Te
    ? ((Ee = (0, $.jsxs)(`div`, {
        "data-project-row": !0,
        className: A,
        onClick: T,
...
function bn(e) {
  ...
  let i;
  return (
    t[0] === n ? (i = t[1]) : ((i = (0, $.jsx)(wt, { hostId: n })), (t[0] = n), (t[1] = i)), i
  );
}
function xn(e) {
  let t = (0, Z.c)(57),
  ...
  let E = T,
    k;
  t[12] !== s || t[13] !== h
    ? ((k = s.formatMessage(h ? jt : At)), (t[12] = s), (t[13] = h), (t[14] = k))
    : (k = t[14]);
  let A = k,
    j;
  t[15] === r
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = q(un, `col-span-2 flex min-w-0 items-center gap-3 max-[920px]:col-span-1`)),
      (t[17] = M))
    : (M = t[17]);
  let N = f ?? null,
    P;
  ...
  let B = f ?? null,
    V;
  t[33] !== S || t[34] !== B
    ? ((V = (0, $.jsx)(wn, { entry: B, onOpenThread: S })), (t[33] = S), (t[34] = B), (t[35] = V))
    : (V = t[35]);
  let H;
  ...
  return (
    t[51] !== w || t[52] !== I || t[53] !== z || t[54] !== K || t[55] !== j
      ? ((oe = (0, $.jsxs)(`div`, { className: j, onClick: w, children: [I, z, K] })),
        (t[51] = w),
        (t[52] = I),
        (t[53] = z),
        (t[54] = K),
...
function Dn(e) {
  ...
  t[5] === x
    ...
    : ((C = (0, $.jsx)(ee, {
      ...
      (t[6] = C));
  let T;
  t[7] !== n || t[8] !== r || t[9] !== a.group || t[10] !== a.name || t[11] !== l
    ? ((T = n
        ? (0, $.jsx)(J.Item, {
            LeftIcon: qe,
            onSelect: () => {
    ...
    : (T = t[12]);
  let E;
  t[13] !== n || t[14] !== r || t[15] !== i || t[16] !== a.group || t[17] !== a.name || t[18] !== l
    ? ((E =
        n && i
          ? (0, $.jsx)(J.Item, {
              LeftIcon: hn,
  ...
  t[22] === D
    ? (A = t[23])
    : ((A = (0, $.jsx)(J.Item, { LeftIcon: Qe, disabled: D, onSelect: O, children: k })),
      (t[22] = D),
      (t[23] = A));
  let j;
  ...
  t[35] !== y || t[36] !== a.group || t[37] !== a.name || t[38] !== d
    ...
    : (P = t[39]);
  let F;
  t[40] !== y || t[41] !== a.group.projectId || t[42] !== a.group.projectKind || t[43] !== a.name
    ? ((F =
