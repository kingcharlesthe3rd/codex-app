...
import { An as We, jn as Ge } from "./app-initial~app-main~automations-page.js";
import {
  g as Ke,
  m as qe,
  p as Je,
...
function Yt(e, t, n) {
  let r = e.threadKeys.flatMap((e) => {
    ...
    a = Qt(le({ projectId: e.projectId, projectWritableRoots: t, legacyRoot: e.path ?? null }));
  return {
    group: e,
...
function Qt(e) {
  return e.map((e) => ({ kind: `folder`, label: W(e), path: e }));
}
var $t = e(() => {
  (_(), de());
});
...
function tn(e) {
  ...
  t[0] !== r || t[1] !== i || t[2] !== a.label || t[3] !== c
    ? ((l =
        i && c != null ? `${r ?? ``}${r == null ? `` : `: `}${c}` : c == null ? a.label : vt(c)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a.label),
      (t[3] = c),
  ...
  if (i && n != null) {
    ...
    (t[7] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Y.jsx)(pe, { className: `icon-xs shrink-0 text-token-description-foreground` })),
        (t[7] = e))
      : (e = t[7]),
      (f = e));
  } else {
  ...
  t[13] === a.label
    ? (p = t[14])
    : ((p = (0, Y.jsx)(`span`, { className: `min-w-0 truncate`, children: a.label })),
      (t[13] = a.label),
      (t[14] = p));
  let m;
  t[15] !== f || t[16] !== p
    ? ((m = (0, Y.jsxs)(Y.Fragment, { children: [f, p] })), (t[15] = f), (t[16] = p), (t[17] = m))
    : (m = t[17]);
  let h = m,
    g;
  t[18] !== s || t[19] !== d || t[20] !== o || t[21] !== a.label || t[22] !== h || t[23] !== c
    ? ((g = d
        ? (0, Y.jsx)(`button`, {
            type: `button`,
            ...
            onClick: () => {
              ce({ path: c, cwd: y(c), target: `fileManager`, openFile: o.mutate });
            },
            children: h,
          })
        : (0, Y.jsx)(`div`, {
  ...
  return (
    t[25] !== u || t[26] !== g
      ? ((_ = (0, Y.jsx)(he, { tooltipContent: u, children: g })),
        (t[25] = u),
        (t[26] = g),
        (t[27] = _))
      : (_ = t[27]),
...
function nn(e) {
  ...
  let a;
  t[3] === i ? (a = t[4]) : ((a = (0, Y.jsx)(Je, { dateString: i })), (t[3] = i), (t[4] = a));
  let o;
  return (
    t[5] !== r || t[6] !== a
      ? ((o = (0, Y.jsx)(qe, { nowMs: r, children: a })), (t[5] = r), (t[6] = a), (t[7] = o))
      : (o = t[7]),
    o
  );
}
...
function _n() {
  let e = ee(),
    t = N(g),
    { data: n } = A(ue.THREAD_PROJECT_ASSIGNMENTS),
    { data: r } = A(ue.PROJECTLESS_THREAD_IDS),
    { data: i } = A(ue.PROJECT_WRITABLE_ROOTS),
    { groups: a } = M(F, {
      enabled: !0,
    ...
    D = (e) => {
      ...
      d(u === `ascending` ? `descending` : `ascending`);
    },
    O = (e) => {
      y((t) => {
        let n = new Set(t);
  ...
  return (
    ...
    (0, $.jsxs)(`div`, {
      ...
      children: [
        (0, $.jsx)(Ae, { extension: !0, children: E }),
        (0, $.jsx)(Ae, {
          browser: !0,
          chromeExtension: !0,
          electron: !0,
          children: (0, $.jsx)(Qe.Header, { children: E }),
        }),
        (0, $.jsx)(`div`, {
          ref: m,
                              ...
                              return e.kind === `cloud`
                                ...
                                : (0, $.jsx)(
                                    yn,
                                    {
                                      expanded: t,
                                      now: S,
                                      onShowAllChange: (t) => k(e.projectId, t),
                                      onToggleExpanded: () => O(e.id),
                                      row: e,
                                      showAll: b.has(e.projectId),
                                    },
                                    e.id,
                                  );
                            }),
...
function yn(e) {
  let t = (0, Z.c)(119),
    { expanded: n, now: r, onShowAllChange: i, onToggleExpanded: a, row: o, showAll: s } = e,
    c = te(u),
    l = ee(),
    d = kt(),
    p = O(yt),
    { data: m } = A(ue.PINNED_PROJECT_IDS),
    { data: h } = A(ue.PROJECT_WRITABLE_ROOTS),
    g;
  t[0] !== m || t[1] !== o.group.projectId
    ? ((g = m?.includes(o.group.projectId)), (t[0] = m), (t[1] = o.group.projectId), (t[2] = g))
    : (g = t[2]);
  let _ = g === !0,
    v;
  t[3] !== h || t[4] !== o.group.path || t[5] !== o.group.projectId
    ? ((v = le({
        projectId: o.group.projectId,
        projectWritableRoots: we(h),
        legacyRoot: o.group.path ?? null,
      })),
      (t[3] = h),
      (t[4] = o.group.path),
      (t[5] = o.group.projectId),
      (t[6] = v))
    : (v = t[6]);
  let y = v,
    x = o.group.projectKind === `local` && (o.group.isLocalProject === !0 || o.group.path != null),
    S;
  t[7] === a
    ? (S = t[8])
    : ((S = (e) => {
  ...
  t[9] !== o.group || t[10] !== d
    ? ((T = (e) => {
        e.defaultPrevented || fn(e.target) || d(o.group);
      }),
      (t[9] = o.group),
      (t[10] = d),
      (t[11] = T))
  ...
  let E = T,
    ...
    k;
  t[12] === D ? (k = t[13]) : ((k = q(ln, D)), (t[12] = D), (t[13] = k));
  let j;
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = q(un, `flex min-w-0 items-center gap-3`)), (t[15] = M))
    : (M = t[15]);
  let N;
  t[16] !== n || t[17] !== o.group.projectKind
    ? ((N =
        o.group.projectKind === `remote`
          ? (0, $.jsx)(Xe, { className: `icon-xs shrink-0` })
          : (0, $.jsx)($e, { className: `icon-xs shrink-0`, open: n })),
      (t[16] = n),
      (t[17] = o.group.projectKind),
      (t[18] = N))
    : (N = t[18]);
  let P;
  t[19] !== o.group.projectId || t[20] !== o.name || t[21] !== N
    ? ((P = (0, $.jsx)(I, {
        projectId: o.group.projectId,
        projectName: o.name,
  ...
  t[23] === o.name
    ...
    : ((F = (0, $.jsx)(`span`, {
      ...
      (t[24] = F));
  let L;
  t[25] !== o.group.hostId || t[26] !== o.group.projectKind
    ? ((L =
        o.group.projectKind === `remote` && o.group.hostId != null
          ? (0, $.jsx)(bn, { hostId: o.group.hostId })
          : null),
      (t[25] = o.group.hostId),
      (t[26] = o.group.projectKind),
      (t[27] = L))
    : (L = t[27]);
  let R;
  t[28] === l
  ...
  t[34] === V
    ? (H = t[35])
    : ((H = (0, $.jsx)(ne, { "aria-hidden": `true`, className: V })), (t[34] = V), (t[35] = H));
  let U;
  ...
  let re;
  t[45] !== P || t[46] !== W
    ? ((re = (0, $.jsxs)(`div`, { className: M, children: [P, W] })),
      (t[45] = P),
      (t[46] = W),
      (t[47] = re))
    : (re = t[47]);
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = q(un, `flex min-w-0 items-center gap-2 text-token-text-secondary max-[920px]:hidden`)),
      (t[48] = G))
    : (G = t[48]);
  let ie = o.group.projectKind === `remote` ? o.group.hostId : null,
    ae =
      o.group.projectKind === `remote` ? (o.group.hostDisplayName ?? o.group.hostId ?? null) : null,
    se = o.group.projectKind === `remote`,
    ce;
  t[49] !== o.sources || t[50] !== ie || t[51] !== ae || t[52] !== se
    ? ((ce = (0, $.jsx)(en, { hostId: ie, hostLabel: ae, isRemote: se, sources: o.sources })),
      (t[49] = o.sources),
      (t[50] = ie),
      (t[51] = ae),
      (t[52] = se),
  ...
  let de;
  t[62] !== ce || t[63] !== K
    ? ((de = (0, $.jsxs)(`span`, { className: G, children: [ce, K] })),
      (t[62] = ce),
      (t[63] = K),
      (t[64] = de))
    : (de = t[64]);
  ...
  t[65] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((fe = q(un, `text-token-text-secondary max-[680px]:hidden`)), (t[65] = fe))
    : (fe = t[65]);
  let pe;
  t[66] !== r || t[67] !== o.modifiedAt
    ? ((pe = (0, $.jsx)(`span`, {
        className: fe,
        children: (0, $.jsx)(nn, { modifiedAt: o.modifiedAt, now: r }),
      })),
      (t[66] = r),
      (t[67] = o.modifiedAt),
      (t[68] = pe))
  ...
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = q(un, `flex min-w-0 justify-end gap-1`)), (t[69] = me))
    : (me = t[69]);
  let he;
  t[70] !== x || t[71] !== y || t[72] !== p || t[73] !== o
    ? ((he = (0, $.jsx)(Dn, {
        canEditLocalProject: x,
        initialSources: y,
  ...
  t[75] !== l || t[76] !== _
    ...
    : (ge = t[77]);
  let _e;
  t[78] !== m || t[79] !== o.group.projectId || t[80] !== c
    ? ((_e = () => {
        w(c, ue.PINNED_PROJECT_IDS, kn(m, o.group.projectId));
      }),
      (t[78] = m),
      (t[79] = o.group.projectId),
      (t[80] = c),
      (t[81] = _e))
    : (_e = t[81]);
  let ve;
  ...
  let xe;
  t[90] !== o.group || t[91] !== d
    ? ((xe = () => d(o.group)), (t[90] = o.group), (t[91] = d), (t[92] = xe))
    : (xe = t[92]);
  let Se;
  t[93] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, $.jsx)(ct, { className: `icon-xs` })), (t[93] = Se))
    : (Se = t[93]);
  let Ce;
  t[94] !== be || t[95] !== xe
    ? ((Ce = (0, $.jsx)(oe, {
    ...
    : (Ce = t[96]);
  let J;
  t[97] !== he || t[98] !== ye || t[99] !== Ce
    ? ((J = (0, $.jsxs)(`span`, { className: me, children: [he, ye, Ce] })),
      (t[97] = he),
      (t[98] = ye),
      (t[99] = Ce),
      (t[100] = J))
    : (J = t[100]);
  let Te;
  t[101] !== C || t[102] !== E || t[103] !== re || t[104] !== de || t[105] !== pe || t[106] !== J
    ? ((Te = (0, $.jsxs)(`div`, {
        "data-project-row": !0,
        className: j,
        onClick: C,
...
function bn(e) {
  ...
  let i;
  return (
    t[0] === n ? (i = t[1]) : ((i = (0, $.jsx)(lt, { hostId: n })), (t[0] = n), (t[1] = i)), i
  );
}
function xn(e) {
  let t = (0, Z.c)(57),
    ...
    m = M(Nt, i),
    h;
  t[0] === i ? (h = t[1]) : ((h = Te(i)), (t[0] = i), (t[1] = h));
  let g = h,
    _ = g != null,
    v =
      d?.kind === `local`
  ...
  t[7] === b
    ? (x = t[8])
    : ((x = (e) => {
        e.defaultPrevented || e.detail > 1 || fn(e.target) || b();
      }),
      (t[7] = b),
      (t[8] = x));
  let S = x,
  ...
  let w = C,
    T;
  t[12] !== o || t[13] !== m
    ? ((T = o.formatMessage(m ? Lt : It)), (t[12] = o), (t[13] = m), (t[14] = T))
    : (T = t[14]);
  let D = T,
    O;
  t[15] === r
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = q(un, `col-span-2 flex min-w-0 items-center gap-3 max-[920px]:col-span-1`)),
      (t[17] = k))
    : (k = t[17]);
  let A = d ?? null,
    j;
  t[18] !== f || t[19] !== A
    ? ((j = (0, $.jsx)(Cn, { entry: A, localConversationId: f })),
      (t[18] = f),
      (t[19] = A),
      (t[20] = j))
    : (j = t[20]);
  ...
  t[21] === n
    ? (N = t[22])
    : ((N = (0, $.jsx)(`div`, { className: `min-w-0 flex-1`, children: n })),
      (t[21] = n),
      (t[22] = N));
  let P;
  t[23] !== N || t[24] !== j
    ? ((P = (0, $.jsxs)(`div`, { className: k, children: [j, N] })),
      (t[23] = N),
      (t[24] = j),
      (t[25] = P))
    : (P = t[25]);
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = q(un, `text-token-text-secondary max-[680px]:hidden`)), (t[26] = F))
    : (F = t[26]);
  let I;
  t[27] !== v || t[28] !== l
    ? ((I = v == null ? null : (0, $.jsx)(nn, { modifiedAt: v, now: l })),
      (t[27] = v),
      (t[28] = l),
      (t[29] = I))
    : (I = t[29]);
  ...
  t[30] === I
    ? (L = t[31])
    : ((L = (0, $.jsx)(`span`, { className: F, children: I })), (t[30] = I), (t[31] = L));
  let R;
  t[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = q(un, `flex min-w-0 justify-end gap-1`)), (t[32] = R))
    : (R = t[32]);
  let z = d ?? null,
    B;
  t[33] !== b || t[34] !== z
    ? ((B = (0, $.jsx)(wn, { entry: z, onOpenThread: b })), (t[33] = b), (t[34] = z), (t[35] = B))
    : (B = t[35]);
  let V;
  t[36] !== _ || t[37] !== m || t[38] !== D || t[39] !== w
    ? ((V = _
        ? (0, $.jsx)(oe, {
            "aria-label": D,
            className: q(
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = (0, $.jsx)(ie, { className: `icon-xs` })), (t[43] = U))
    : (U = t[43]);
  let W;
  t[44] !== b || t[45] !== H
    ? ((W = (0, $.jsx)(oe, {
  ...
  t[47] !== B || t[48] !== V || t[49] !== W
    ? ((ne = (0, $.jsxs)(`span`, { className: R, children: [B, V, W] })),
      (t[47] = B),
      (t[48] = V),
      (t[49] = W),
      (t[50] = ne))
  ...
  let G;
  return (
    t[51] !== S || t[52] !== P || t[53] !== L || t[54] !== ne || t[55] !== O
      ? ((G = (0, $.jsxs)(`div`, { className: O, onClick: S, children: [P, L, ne] })),
        (t[51] = S),
        (t[52] = P),
        (t[53] = L),
        (t[54] = ne),
...
function Cn(e) {
  let t = (0, Z.c)(12),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = dt(a)), (t[0] = a), (t[1] = o));
  let s = M(Et, o),
    c = M(D, r),
    l = M(U, r),
    u = M(xe, r),
...
function Tn(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(Ie, { className: `icon-xs` })), (t[4] = l))
    : (l = t[4]);
  let u;
  t[5] !== o || t[6] !== c
    ? ((u = (0, $.jsx)(oe, {
  ...
  t[11] === d
    ? (m = t[12])
    : ((m = (0, $.jsx)(J.Item, { LeftIcon: ie, onSelect: d, children: p })),
      (t[11] = d),
      (t[12] = m));
  let h;
  return (
...
function Dn(e) {
  let t = (0, Z.c)(50),
    { canEditLocalProject: n, initialSources: r, localProjectSourcesEnabled: o, row: s } = e,
    c = te(u),
    l = ee(),
    p = N(se),
    m = M(T, s.group.threadKeys),
    h;
  t[0] === m ? (h = t[1]) : ((h = a(m)), (t[0] = m), (t[1] = h));
  let g = h,
    [_, v] = (0, Q.useState)(!1),
    [y, x] = (0, Q.useState)(!1),
    [S, C] = (0, Q.useState)(!1),
  ...
  let E;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, $.jsx)(Ie, { className: `icon-xs` })), (t[4] = E))
    : (E = t[4]);
  let D;
  t[5] === w
    ? (D = t[6])
    : ((D = (0, $.jsx)(oe, {
      ...
      (t[6] = D));
  let O;
  t[7] !== n || t[8] !== r || t[9] !== s.group || t[10] !== s.name || t[11] !== c
    ? ((O = n
        ? (0, $.jsx)(J.Item, {
            LeftIcon: d,
            onSelect: () => {
    ...
    : (O = t[12]);
  let k;
  t[13] !== n || t[14] !== r || t[15] !== o || t[16] !== s.group || t[17] !== s.name || t[18] !== c
    ? ((k =
        n && o
          ? (0, $.jsx)(J.Item, {
              LeftIcon: hn,
  ...
  t[22] === A
    ? (F = t[23])
    : ((F = (0, $.jsx)(J.Item, { LeftIcon: ht, disabled: A, onSelect: j, children: P })),
      (t[22] = A),
      (t[23] = F));
  let I;
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (I = t[24]);
  let L;
  t[25] !== _ || t[26] !== F || t[27] !== D || t[28] !== O || t[29] !== k
    ? ((L = (0, $.jsxs)(V, {
        align: `end`,
        contentWidth: `xs`,
        open: _,
    ...
    : (L = t[30]);
  let z;
  t[31] !== y || t[32] !== s.group.threadKeys || t[33] !== s.name
    ? ((z = y
        ? (0, $.jsx)(je, {
            projectLabel: s.name,
        ...
        : null),
      (t[31] = y),
      (t[32] = s.group.threadKeys),
      (t[33] = s.name),
      (t[34] = z))
    : (z = t[34]);
  let B;
  t[35] !== S || t[36] !== s.group || t[37] !== s.name || t[38] !== p
    ? ((B =
        S && s.group.projectKind === `local`
          ? (0, $.jsx)(R, {
              project: s.group,
              projectLabel: s.name,
    ...
    : (B = t[39]);
  let H;
  t[40] !== S || t[41] !== s.group.projectId || t[42] !== s.group.projectKind || t[43] !== s.name
    ? ((H =
        S && s.group.projectKind === `remote`
          ? (0, $.jsx)(Oe, {
          ...
          : null),
      (t[40] = S),
      (t[41] = s.group.projectId),
      (t[42] = s.group.projectKind),
      (t[43] = s.name),
      (t[44] = H))
    : (H = t[44]);
  let U;
  return (
    t[45] !== L || t[46] !== z || t[47] !== B || t[48] !== H
      ? ((U = (0, $.jsxs)($.Fragment, { children: [L, z, B, H] })),
        (t[45] = L),
        (t[46] = z),
        (t[47] = B),
        (t[48] = H),
