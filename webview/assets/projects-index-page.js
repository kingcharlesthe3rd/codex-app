...
import { At as Ie, kt as Le } from "./app-initial~app-main~automations-page.js";
import {
  C as Re,
  E as ze,
  Gt as Be,
...
function Yt(e, t, n) {
  let r = e.threadKeys.flatMap((e) => {
    ...
    a = Qt(y({ projectId: e.projectId, projectWritableRoots: t, legacyRoot: e.path ?? null }));
  return {
    group: e,
...
function Qt(e) {
  return e.map((e) => ({ kind: `folder`, label: s(e), path: e }));
}
var $t = e(() => {
  (o(), l());
});
...
function tn(e) {
  ...
  t[0] !== r || t[1] !== i || t[2] !== a.label || t[3] !== c
    ? ((l =
        i && c != null ? `${r ?? ``}${r == null ? `` : `: `}${c}` : c == null ? a.label : bt(c)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a.label),
      (t[3] = c),
  ...
  if (i && n != null) {
    ...
    (t[7] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Y.jsx)(z, { className: `icon-xs shrink-0 text-token-description-foreground` })),
        (t[7] = e))
      : (e = t[7]),
      (m = e));
  } else {
  ...
  let _ = g,
    v;
  t[18] !== s || t[19] !== p || t[20] !== o || t[21] !== a.label || t[22] !== _ || t[23] !== c
    ? ((v = p
        ? (0, Y.jsx)(`button`, {
            type: `button`,
            ...
            onClick: () => {
              pe({ path: c, cwd: f(c), target: `fileManager`, openFile: o.mutate });
            },
            children: _,
          })
        : (0, Y.jsx)(`div`, {
  ...
  return (
    t[25] !== u || t[26] !== v
      ? ((y = (0, Y.jsx)(re, { tooltipContent: u, children: v })),
        (t[25] = u),
        (t[26] = v),
        (t[27] = y))
      : (y = t[27]),
...
function nn(e) {
  ...
  return (
    t[5] !== r || t[6] !== a
      ? ((o = (0, Y.jsx)(He, { nowMs: r, children: a })), (t[5] = r), (t[6] = a), (t[7] = o))
      : (o = t[7]),
    o
  );
}
...
function _n() {
  let e = Fe(),
    t = h(F),
    { data: n } = Ce(c.THREAD_PROJECT_ASSIGNMENTS),
    { data: r } = Ce(c.PROJECTLESS_THREAD_IDS),
    { data: a } = Ce(c.PROJECT_WRITABLE_ROOTS),
    { groups: o } = u(ve, {
      enabled: !0,
  ...
  return (
    ...
    (0, $.jsxs)(`div`, {
      ...
      children: [
        (0, $.jsx)(N, { extension: !0, children: k }),
        (0, $.jsx)(N, {
          browser: !0,
          chromeExtension: !0,
          electron: !0,
...
function yn(e) {
  let t = (0, Z.c)(119),
    { expanded: r, now: a, onShowAllChange: o, onToggleExpanded: s, row: l, showAll: u } = e,
    d = m(n),
    f = Fe(),
    p = st(),
    h = Ae(ft),
    { data: g } = Ce(c.PINNED_PROJECT_IDS),
    { data: _ } = Ce(c.PROJECT_WRITABLE_ROOTS),
    v;
  t[0] !== g || t[1] !== l.group.projectId
    ? ((v = g?.includes(l.group.projectId)), (t[0] = g), (t[1] = l.group.projectId), (t[2] = v))
    : (v = t[2]);
  let b = v === !0,
    x;
  t[3] !== _ || t[4] !== l.group.path || t[5] !== l.group.projectId
    ? ((x = y({
        projectId: l.group.projectId,
        projectWritableRoots: i(_),
    ...
    : (x = t[6]);
  let S = x,
    C = l.group.projectKind === `local` && (l.group.isLocalProject === !0 || l.group.path != null),
    w;
  t[7] === s
    ? (w = t[8])
    : ((w = (e) => {
  ...
  t[9] !== l.group || t[10] !== p
    ...
    : (E = t[11]);
  let D = E,
    O = !r && `[&:has(>_[data-project-row]:hover)]:border-b-transparent`,
    k;
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (j = t[15]);
  let M;
  t[16] !== r || t[17] !== l.group.projectKind
    ? ((M =
        l.group.projectKind === `remote`
          ? (0, $.jsx)(Et, { className: `icon-xs shrink-0` })
          : (0, $.jsx)(ct, { className: `icon-xs shrink-0`, open: r })),
      (t[16] = r),
  ...
  t[30] === s
    ...
    : ((L = (e) => {
      ...
      (t[30] = s),
      (t[31] = L));
  let R = r ? `rotate-0 opacity-100` : `-rotate-90`,
    z;
  t[32] === R
    ? (z = t[33])
    : ((z = K(
  ...
  t[34] === z
    ? (B = t[35])
    : ((B = (0, $.jsx)(he, { "aria-hidden": `true`, className: z })), (t[34] = z), (t[35] = B));
  let V;
  t[36] !== r || t[37] !== I || t[38] !== L || t[39] !== B
    ? ((V = (0, $.jsx)(`button`, {
        type: `button`,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = K(un, `flex min-w-0 items-center gap-2 text-token-text-secondary max-[920px]:hidden`)),
      (t[48] = W))
    : (W = t[48]);
  let te = l.group.projectKind === `remote` ? l.group.hostId : null,
    G =
      l.group.projectKind === `remote` ? (l.group.hostDisplayName ?? l.group.hostId ?? null) : null,
    re = l.group.projectKind === `remote`,
    ie;
  t[49] !== l.sources || t[50] !== te || t[51] !== G || t[52] !== re
    ? ((ie = (0, $.jsx)(en, { hostId: te, hostLabel: G, isRemote: re, sources: l.sources })),
      (t[49] = l.sources),
      (t[50] = te),
      (t[51] = G),
      (t[52] = re),
  ...
  let oe;
  t[62] !== ie || t[63] !== ae
    ? ((oe = (0, $.jsxs)(`span`, { className: W, children: [ie, ae] })),
      (t[62] = ie),
      (t[63] = ae),
      (t[64] = oe))
    : (oe = t[64]);
  ...
  t[65] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = K(un, `text-token-text-secondary max-[680px]:hidden`)), (t[65] = se))
    : (se = t[65]);
  let ce;
  ...
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((le = K(un, `flex min-w-0 justify-end gap-1`)), (t[69] = le))
    : (le = t[69]);
  let ue;
  t[70] !== C || t[71] !== S || t[72] !== h || t[73] !== l
    ? ((ue = (0, $.jsx)(Dn, {
  ...
  t[75] !== f || t[76] !== b
    ...
    : (de = t[77]);
  let fe;
  t[78] !== g || t[79] !== l.group.projectId || t[80] !== d
    ? ((fe = () => {
        je(d, c.PINNED_PROJECT_IDS, kn(g, l.group.projectId));
      }),
      (t[78] = g),
  ...
  t[82] === b
    ...
    : ((pe = b
        ...
        : (0, $.jsx)(St, { className: `icon-xs` })),
      (t[82] = b),
      (t[83] = pe));
  let me;
  t[84] !== de || t[85] !== fe || t[86] !== pe
    ? ((me = (0, $.jsx)(ee, {
        "aria-label": de,
        className: X,
        color: `ghostMuted`,
  ...
  let ve;
  t[90] !== l.group || t[91] !== p
    ? ((ve = () => p(l.group)), (t[90] = l.group), (t[91] = p), (t[92] = ve))
    : (ve = t[92]);
  let ye;
  t[93] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, $.jsx)(kt, { className: `icon-xs` })), (t[93] = ye))
    : (ye = t[93]);
  let be;
  t[94] !== ge || t[95] !== ve
    ? ((be = (0, $.jsx)(ee, {
    ...
    : (be = t[96]);
  let xe;
  t[97] !== ue || t[98] !== me || t[99] !== be
    ? ((xe = (0, $.jsxs)(`span`, { className: le, children: [ue, me, be] })),
      (t[97] = ue),
      (t[98] = me),
      (t[99] = be),
      (t[100] = xe))
    : (xe = t[100]);
  let q;
  t[101] !== T || t[102] !== D || t[103] !== U || t[104] !== oe || t[105] !== ce || t[106] !== xe
    ? ((q = (0, $.jsxs)(`div`, {
        "data-project-row": !0,
        className: A,
        onClick: T,
...
function bn(e) {
  ...
  let i;
  return (
    t[0] === n ? (i = t[1]) : ((i = (0, $.jsx)(Bt, { hostId: n })), (t[0] = n), (t[1] = i)), i
  );
}
function xn(e) {
  let t = (0, Z.c)(57),
    { children: r, className: i, threadKey: a } = e,
    o = m(n),
    s = Fe(),
    c = Ne(),
    l = w(),
    ...
    g = u(lt, a),
    _;
  t[0] === a ? (_ = t[1]) : ((_ = fe(a)), (t[0] = a), (t[1] = _));
  let v = _,
    y = v != null,
    b =
      f?.kind === `local`
  ...
  let D = E,
    O;
  t[12] !== s || t[13] !== g
    ? ((O = s.formatMessage(g ? Ft : Pt)), (t[12] = s), (t[13] = g), (t[14] = O))
    : (O = t[14]);
  let k = O,
    j;
  t[15] === i
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = K(un, `col-span-2 flex min-w-0 items-center gap-3 max-[920px]:col-span-1`)),
      (t[17] = M))
    : (M = t[17]);
  let N = f ?? null,
    P;
  ...
  t[21] === r
    ? (F = t[22])
    : ((F = (0, $.jsx)(`div`, { className: `min-w-0 flex-1`, children: r })),
      (t[21] = r),
      (t[22] = F));
  let I;
  t[23] !== F || t[24] !== P
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((te = (0, $.jsx)(Se, { className: `icon-xs` })), (t[43] = te))
    : (te = t[43]);
  let ne;
  t[44] !== S || t[45] !== W
    ? ((ne = (0, $.jsx)(ee, {
    ...
    : (ne = t[46]);
  let G;
  t[47] !== H || t[48] !== U || t[49] !== ne
    ? ((G = (0, $.jsxs)(`span`, { className: B, children: [H, U, ne] })),
      (t[47] = H),
      (t[48] = U),
      (t[49] = ne),
      (t[50] = G))
  ...
  let re;
  return (
    t[51] !== T || t[52] !== I || t[53] !== z || t[54] !== G || t[55] !== j
      ? ((re = (0, $.jsxs)(`div`, { className: j, onClick: T, children: [I, z, G] })),
        (t[51] = T),
        (t[52] = I),
        (t[53] = z),
        (t[54] = G),
...
function Cn(e) {
  let t = (0, Z.c)(12),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = At(a)), (t[0] = a), (t[1] = o));
  let s = u(at, o),
    c = u(ge, r),
    l = u(te, r),
    d = u(Te, r),
...
function Tn(e) {
  ...
  t[2] === s
    ? (c = t[3])
    : ((c = K(X, `opacity-0 group-hover/thread-row:opacity-100 focus-visible:opacity-100`, s)),
      (t[2] = s),
      (t[3] = c));
  let l;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(S, { className: `icon-xs` })), (t[4] = l))
    : (l = t[4]);
  let u;
  t[5] !== o || t[6] !== c
    ? ((u = (0, $.jsx)(ee, {
  ...
  t[11] === d
    ? (p = t[12])
    : ((p = (0, $.jsx)(q.Item, { LeftIcon: Se, onSelect: d, children: f })),
      (t[11] = d),
      (t[12] = p));
  let m;
  return (
...
function Dn(e) {
  let t = (0, Z.c)(50),
    { canEditLocalProject: r, initialSources: i, localProjectSourcesEnabled: a, row: o } = e,
    s = m(n),
    c = Fe(),
    l = h(G),
    d = u(P, o.group.threadKeys),
    f;
  t[0] === d ? (f = t[1]) : ((f = oe(d)), (t[0] = d), (t[1] = f));
  let p = f,
    [g, _] = (0, Q.useState)(!1),
    [v, y] = (0, Q.useState)(!1),
    [b, x] = (0, Q.useState)(!1),
  ...
  let w;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(S, { className: `icon-xs` })), (t[4] = w))
    : (w = t[4]);
  let T;
  t[5] === C
    ? (T = t[6])
    : ((T = (0, $.jsx)(ee, {
      ...
      (t[6] = T));
  let E;
  t[7] !== r || t[8] !== i || t[9] !== o.group || t[10] !== o.name || t[11] !== s
    ? ((E = r
        ? (0, $.jsx)(q.Item, {
            LeftIcon: Ve,
            onSelect: () => {
    ...
    : (E = t[12]);
  let O;
  t[13] !== r || t[14] !== i || t[15] !== a || t[16] !== o.group || t[17] !== o.name || t[18] !== s
    ? ((O =
        r && a
          ? (0, $.jsx)(q.Item, {
              LeftIcon: hn,
  ...
  t[22] === k
    ? (N = t[23])
    : ((N = (0, $.jsx)(q.Item, { LeftIcon: Ye, disabled: k, onSelect: A, children: j })),
      (t[22] = k),
      (t[23] = N));
  let F;
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (F = t[24]);
  let I;
  t[25] !== g || t[26] !== N || t[27] !== T || t[28] !== E || t[29] !== O
    ? ((I = (0, $.jsxs)(B, {
        align: `end`,
        contentWidth: `xs`,
        open: g,
    ...
    : (I = t[30]);
  let L;
  t[31] !== v || t[32] !== o.group.threadKeys || t[33] !== o.name
    ? ((L = v
        ? (0, $.jsx)(D, {
            projectLabel: o.name,
        ...
        : null),
      (t[31] = v),
      (t[32] = o.group.threadKeys),
      (t[33] = o.name),
      (t[34] = L))
    : (L = t[34]);
  let R;
  t[35] !== b || t[36] !== o.group || t[37] !== o.name || t[38] !== l
    ? ((R =
    ...
    : (R = t[39]);
  let z;
  t[40] !== b || t[41] !== o.group.projectId || t[42] !== o.group.projectKind || t[43] !== o.name
    ? ((z =
        b && o.group.projectKind === `remote`
          ...
          : null),
      (t[40] = b),
      (t[41] = o.group.projectId),
      (t[42] = o.group.projectKind),
      (t[43] = o.name),
      (t[44] = z))
    : (z = t[44]);
  let V;
  return (
    t[45] !== I || t[46] !== L || t[47] !== R || t[48] !== z
      ? ((V = (0, $.jsxs)($.Fragment, { children: [I, L, R, z] })),
        (t[45] = I),
        (t[46] = L),
        (t[47] = R),
        (t[48] = z),
