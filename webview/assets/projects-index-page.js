...
import { Lt as c, Qi as l, zt as u } from "./thread-context-inputs.js";
import { s as d } from "./vscode-api.js";
import "./isEqual.js";
import { Br as f, Et as p, Tt as m, _n as h } from "./src-3.js";
import "./react-dom.js";
...
import { o as Te } from "./thread-actions-B.js";
import "./popover.js";
...
import { n as J, r as Ee, t as Y } from "./sidebar-task-pr-chip-signals-DY-sc_91.js";
...
function et(e) {
  let t = (0, Z.c)(119),
    { expanded: n, now: r, onShowAllChange: i, onToggleExpanded: o, row: c, showAll: u } = e,
    d = a(s),
    h = ee(),
    v = he(),
    y = ne(xe),
  ...
  t[78] !== b || t[79] !== c.group.projectId || t[80] !== d
    ? ((J = () => {
        l(d, f.PINNED_PROJECT_IDS, ht(b, c.group.projectId));
      }),
      (t[78] = b),
...
function nt(e) {
  ...
  let ie = O,
    ae;
  t[12] !== l || t[13] !== v
    ? ((ae = l.formatMessage(v ? de : fe)), (t[12] = l), (t[13] = v), (t[14] = ae))
    : (ae = t[14]);
  let oe = ae,
    k;
  t[15] === r
...
function it(e) {
  ...
  let l = i(Ee, s),
    ...
    d = i(M, r),
    f = i(c, r),
    p = n?.kind === `remote` ? l?.iconBadge : a?.iconBadge,
    m;
