...
import { qr as t, tr as n } from "./src-2.js";
import { k as r, pi as i, vt as a } from "./app-server-manager-signals.js";
...
import { c as D, n as O, o as k, r as A } from "./lib-2.js";
import { l as j, p as M } from "./persisted-signal-CweW-bgN.js";
import { n as N } from "./rpc-1.js";
import { E as P } from "./codex-api.js";
import { n as ee } from "./window-zoom-context.js";
import { t as F } from "./tooltip.js";
import { i as I, t as L } from "./route-scope.js";
import { t as R } from "./button.js";
import { r as z } from "./reduced-motion-preference.js";
import { t as B } from "./spinner.js";
import { t as V } from "./proxy.js";
import { G as H, Z as U } from "./single-value.js";
import {
  $ as W,
  A as te,
  B as G,
...
import { n as Ye, r as Xe, t as Ze } from "./use-transform.js";
import { t as Qe } from "./AnimatePresence.js";
import { t as $e } from "./use-platform.js";
import { n as et, s as tt, t as nt } from "./app-shell-tab-controller.js";
import { t as rt } from "./browser-sidebar-manager.js";
import { a as it, l as at, r as ot, t as st } from "./error-boundary.js";
import { t as ct } from "./download.js";
import { t as lt } from "./with-window.js";
import { r as ut, t as dt } from "./use-window-controls-safe-area.js";
import { t as ft } from "./use-stable-callback.js";
import { t as pt } from "./use-register-command.js";
import { r as mt } from "./run-command.js";
import { r as ht } from "./modal-controller-state.js";
import {
  a as gt,
  d as _t,
  i as vt,
...
import { t as Ct } from "./context-menu.js";
import { t as wt } from "./loading-page.js";
import { i as Tt, n as Et, r as Dt, t as Ot } from "./sortable.esm.js";
import { t as kt } from "./get-resize-observer-entry-size.js";
import { n as At, r as jt } from "./use-resize-observer.js";
import { a as Mt } from "./command-keybindings.js";
import { n as Nt, t as Pt } from "./expand.js";
import { a as Ft, t as It } from "./keyboard-modifier-state.js";
import { t as Lt } from "./use-merged-ref.js";
import { t as Rt } from "./arrow-left.js";
import { t as zt } from "./app-shell-bottom-panel-scroll-sync.js";
import { a as Bt, r as Vt, t as Ht } from "./image-preview-shortcuts.js";
var Z = e(o(), 1);
function Ut(e, t, n) {
...
var Q = s(),
  ...
  $ = T(),
  Kt = `color-mix(in srgb, var(--color-token-foreground) 5%, var(--color-token-main-surface-primary))`,
  qt = `min(32rem, var(--radix-tooltip-content-available-width), calc(100vw - 16px))`;
function Jt(e) {
  let t = (0, $.c)(79),
    n,
    r,
  ...
  let R;
  t[22] !== L || t[23] !== ee || t[24] !== v
    ? ((R = (0, Q.jsx)(`span`, { ref: ee, className: L, children: v })),
      (t[22] = L),
      (t[23] = ee),
      (t[24] = v),
      (t[25] = R))
  ...
  t[26] === d
    ? (B = t[27])
    : ((B = { ...d, "--app-shell-tab-background": Kt }), (t[26] = d), (t[27] = B));
  let V = B,
    H;
  t[28] === u
    ? (H = t[29])
  ...
  let U = j && `group-hover/tab:bg-[var(--app-shell-tab-background)]`,
    ...
    te;
  t[30] !== U || t[31] !== W
    ? ((te = c(`pointer-events-none absolute inset-0 z-0 rounded-md`, U, W)),
      (t[30] = U),
      (t[31] = W),
      (t[32] = te))
    : (te = t[32]);
  ...
  t[33] === te
    ? (G = t[34])
    : ((G = (0, Q.jsx)(`div`, { className: te })), (t[33] = te), (t[34] = G));
  let K = S && `text-token-text-primary`,
    q = !S && `text-token-text-secondary`,
    J;
  t[35] !== K || t[36] !== q
    ? ((J = c(`no-drag relative flex flex-1 items-center gap-2 z-10 text-sm min-w-0 `, K, q)),
      (t[35] = K),
      (t[36] = q),
      (t[37] = J))
    : (J = t[37]);
  ...
  t[46] !== O || t[47] !== C || t[48] !== l || t[49] !== v
    ? ((ne =
        ...
        (0, Q.jsx)(`div`, {
          ...
          onClick: l,
          onMouseDown: Yt,
          children: (0, Q.jsx)(Gt, { className: `icon-xs` }),
        })),
      (t[46] = O),
      (t[47] = C),
      (t[48] = l),
...
function Xt(e) {
  ...
  let H;
  t[20] !== B || t[21] !== M
    ? ((H = { transform: B, transition: M }), (t[20] = B), (t[21] = M), (t[22] = H))
    : (H = t[22]);
  let U, W;
  ...
  let K;
  t[52] !== F || t[53] !== G
    ? ((K = (0, Q.jsx)(Ct, { getItems: F, children: G })), (t[52] = F), (t[53] = G), (t[54] = K))
    : (K = t[54]);
  let q = o ? `opacity-100` : `opacity-0`,
    J;
  t[55] === q
    ? (J = t[56])
    : ((J = c(
  ...
  return (
    ...
    t[67] !== u
      ? ((X = (0, Q.jsxs)(V.div, {
          "data-app-shell-tab-controller": I,
          "data-tab-id": u,
          ref: A,
          className: z,
          style: H,
...
var rn = `data-tab-preview-pin-exempt`;
function an(e) {
  let t = (0, $.c)(20),
    {
      afterList: n,
    ...
    d = (0, Z.useContext)(Qt)?.dragState ?? null,
    f;
  t[0] !== s || t[1] !== d || t[2] !== c
    ? ((f = nn(c, s, d)), (t[0] = s), (t[1] = d), (t[2] = c), (t[3] = f))
    : (f = t[3]);
  let p = f,
    m = l?.tabId ?? null,
    h;
  ...
  t[12] !== l || t[13] !== u || t[14] !== s || t[15] !== a
    ? ((g =
        l == null
          ...
          : (0, Q.jsx)(dn, { controller: s, tab: l }, u)),
      (t[12] = l),
      (t[13] = u),
      (t[14] = s),
      (t[15] = a),
...
function on(e) {
  ...
  let { setNodeRef: S } = _(x),
    C = (0, Z.useContext)(Qt)?.dragState ?? null,
    w,
    T,
    E,
    D,
  ...
  if (
    ...
    let e = l.map(cn),
      r;
    t[32] === l ? (r = t[33]) : ((r = l.map(sn)), (t[32] = l), (t[33] = r));
    let i = r;
    ...
    (t[43] === y
      ...
      t[47] === g
        ? (M = t[48])
        : ((M = (0, Q.jsx)(ln, { onVisibleChange: d, root: g })), (t[47] = g), (t[48] = M)),
      (w = Ot),
      (R = i),
      (z = Dt),
      (ee = `tablist`));
      ...
      (L = l.map((t) => {
        ...
        return (0, Q.jsx)(
          Xt,
          {
            ...
            isActive: r,
            separatorIndex: i,
            showTrailingSeparator: i < e.length - 1 && !r && !un(i, f),
            tab: t,
          },
          t.tabId,
        );
    ...
    ((w = t[15]),
      ...
      (z = t[31]));
  let B;
  t[52] !== ee || t[53] !== F || t[54] !== I || t[55] !== L
    ? ((B = (0, Q.jsx)(`div`, { role: ee, className: F, style: I, children: L })),
      (t[52] = ee),
      (t[53] = F),
      (t[54] = I),
      (t[55] = L),
  ...
  let H;
  t[62] !== T || t[63] !== g
    ? ((H = (0, Q.jsx)(ln, { onVisibleChange: p, root: g, rootMargin: T })),
      (t[62] = T),
      (t[63] = g),
      (t[64] = H))
    : (H = t[64]);
  ...
  let te = f ? `opacity-0` : `opacity-100`,
    G;
  t[67] === te
    ? (G = t[68])
    : ((G = c(
  ...
  let K;
  t[69] !== W || t[70] !== G
    ? ((K = (0, Q.jsx)(`div`, { "aria-hidden": !0, style: W, className: G })),
      (t[69] = W),
      (t[70] = G),
      (t[71] = K))
    : (K = t[71]);
  ...
  let X;
  return (
    t[89] !== N || t[90] !== P || t[91] !== J || t[92] !== Y
      ? ((X = (0, Q.jsxs)(`div`, { className: N, children: [P, J, Y] })),
        (t[89] = N),
        (t[90] = P),
        (t[91] = J),
        (t[92] = Y),
...
var dn = (0, Z.memo)(function (e) {
  ...
  t[0] !== n || t[1] !== i || t[2] !== r.isPreview || t[3] !== r.tabId
    ? ((a = (e) => {
        pn(e.nativeEvent) || (r.isPreview && n.pinTab(i, r.tabId));
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = r.isPreview),
  ...
  let f;
  t[13] !== d || t[14] !== r.tabId
    ? ((f = (0, Q.jsx)(st, { name: `AppShellTabPanel`, resetKey: u, fallback: mn, children: d })),
      (t[13] = d),
      (t[14] = r.tabId),
      (t[15] = f))
    : (f = t[15]);
  ...
  return (
    t[2] === n
      ...
      : ((a = (0, Q.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, Q.jsx)(R, { color: `secondary`, size: `default`, onClick: n, children: i }),
          ],
        })),
        (t[2] = n),
        (t[3] = a)),
...
function pn(e) {
  return e.composedPath().some((e) => e instanceof Element && e.hasAttribute(rn));
}
function mn(e) {
  return (0, Q.jsx)(fn, {
    onRetry: () => {
...
function gn() {
  ...
  return (
    e[13] !== o || e[14] !== i || e[15] !== u
      ? ((d = (0, Q.jsx)(F, { tooltipContent: o, shortcut: i, delayOpen: !0, children: u })),
        (e[13] = o),
        (e[14] = i),
        (e[15] = u),
        (e[16] = d))
...
function _n() {
  return mt(`toggleMaximizeSidePanel`, `side_panel_full_width_button`);
}
function vn() {
  let e = y(ie),
    t = y(_e),
    ...
    i = y(he),
    a = y(Ge),
    { headerLeftWidth: o, headerRightWidth: s } = He(),
...
function bn(e) {
  ...
  t[4] === n
    ? (c = t[5])
    : ((c = (e) => {
        (e.preventDefault(), n(), N.appUpdates?.installUpdate());
      }),
      (t[4] = n),
      (t[5] = c));
  let l, u;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(_t, { className: `sr-only`, children: i })),
      (u = (0, Q.jsx)(St, { className: `sr-only`, children: o })),
      (t[6] = l),
      (t[7] = u))
    : ((l = t[6]), (u = t[7]));
  let d;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(gt, { children: (0, Q.jsx)(vt, { title: i, subtitle: o }) })), (t[8] = d))
    : (d = t[8]);
  let f;
  ...
  t[10] === n
    ? (p = t[11])
    : ((p = (0, Q.jsx)(R, { color: `secondary`, onClick: n, children: f })),
      (t[10] = n),
      (t[11] = p));
  let m;
  ...
  t[13] === p
    ? (h = t[14])
    : ((h = (0, Q.jsx)(gt, { children: (0, Q.jsxs)(xt, { children: [p, m] }) })),
      (t[13] = p),
      (t[14] = h));
  let g;
  t[15] !== h || t[16] !== c
    ? ((g = (0, Q.jsxs)(bt, { as: `form`, onSubmit: c, children: [l, u, d, h] })),
      (t[15] = h),
      (t[16] = c),
      (t[17] = g))
    : (g = t[17]);
...
function wn() {
  return ut() && window.electronBridge?.showApplicationMenu != null;
}
var Tn = A({
    file: {
    ...
    window: {
      ...
      description: `Label for the Window menu in the desktop application menu bar`,
    },
    help: {
  ...
  En = [
    { id: n.file, message: Tn.file },
    { id: n.edit, message: Tn.edit },
    { id: n.view, message: Tn.view },
    { id: n.window, message: Tn.window },
    { id: n.help, message: Tn.help },
  ];
function Dn() {
  let e = D(),
  ...
  return (0, Q.jsx)(`div`, {
    ...
    children: En.map(({ id: n, message: r }) =>
      (0, Q.jsx)(
        `button`,
        {
          type: `button`,
...
var An = S(w, On),
  jn = S(w, { width: window.innerWidth, height: window.innerHeight }),
  Mn = {
    px$: b(w, ({ get: e }) => e(An).x),
    py$: b(w, ({ get: e }) => e(An).y),
    hasKnownVelocity$: b(w, ({ get: e }) => e(An).hasKnownVelocity),
    vx$: b(w, ({ get: e }) => e(An).velocityX),
    vy$: b(w, ({ get: e }) => e(An).velocityY),
    speed$: b(w, ({ get: e }) => e(An).speed),
    ...
    ? ((w = () => {
        ...
        let e = (e) => ({ x: e.clientX / d, y: e.clientY / d }),
          t = (t) => {
            ...
            if (n == null) return;
            let r = e(t);
            ((h ? r.x : r.y) !== n.startPosition && (n.didMove = !0), c(Pn(u, r, n)));
          },
          n = (t) => {
            t.preventDefault();
            let n = m.current;
...
function Bn(e) {
  ...
  let j;
  t[9] === A ? (j = t[10]) : ((j = A.some(Un)), (t[9] = A), (t[10] = j));
  let M = !o && !l && (f > 0 || j),
    N,
    ee;
  (t[11] === s
    ? ((N = t[12]), (ee = t[13]))
    : ((N = () => () => {
        (s.set(De, !1), s.set(je, !1), s.set(we, !1));
      }),
      (ee = [s]),
      (t[11] = s),
      (t[12] = N),
  ...
  t[15] !== i || t[16] !== s
    ? ((L = () => {
        if ((s.set(we, !0), i != null)) {
          i();
          return;
        }
        mt(`toggleSidebar`, `sidebar_trigger`);
      }),
      (t[15] = i),
      (t[16] = s),
      (t[17] = L))
  ...
  t[34] !== b
    ...
    : (U = t[35]);
  let W;
  t[36] === c ? (W = t[37]) : ((W = c.formatMessage(Gn.navigateBack)), (t[36] = c), (t[37] = W));
  let te = !g,
    G;
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, Q.jsx)(k, { ...Gn.navigateBack })), (t[38] = G))
    : (G = t[38]);
  let K;
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, Q.jsx)(Rt, { className: `icon-xs` })), (t[39] = K))
    : (K = t[39]);
  let q;
  t[40] !== S || t[41] !== W || t[42] !== te
    ? ((q = (0, Q.jsx)(Wn, {
        ariaLabel: W,
        disabled: te,
        shortcut: S,
    ...
    : (q = t[43]);
  let J;
  t[44] === c ? (J = t[45]) : ((J = c.formatMessage(Gn.navigateForward)), (t[44] = c), (t[45] = J));
  let Y = !_,
    X;
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((X = (0, Q.jsx)(k, { ...Gn.navigateForward })), (t[46] = X))
    : (X = t[46]);
  let ne;
  ...
  t[52] !== q || t[53] !== re
    ? ((ie = (0, Q.jsx)(lt, {
        electron: !0,
        extension: !0,
        children: (0, Q.jsxs)(Q.Fragment, { children: [q, re] }),
      })),
      (t[52] = q),
      (t[53] = re),
      (t[54] = ie))
...
function Vn() {
  return mt(`navigateForward`, `sidebar_forward`);
}
function Hn() {
  return mt(`navigateBack`, `sidebar_back`);
}
function Un(e) {
...
function Jn(e, t) {
  return Number.isFinite(e) ? Math.max(160, Math.min(e, t * 0.5)) : Kn;
}
function Yn(e) {
  return Jn(j(qn, 280), e);
}
function Xn(e, t) {
  M(qn, Jn(e, t));
}
...
function er({
  ...
  let a = v(L),
    { isMounted: o, opacity: s, animatedSize: c } = Zn({ animation: y(Ue), size: n, isVisible: i }),
    l = Wt`${n}px`;
  return !o && !i
    ? null
    : (0, Q.jsxs)(V.div, {
        ...
        children: [
          (0, Q.jsx)(Nn, {
            ...
            onResizeEnd: (e) => {
              e < Ie(160) || Xn(Jn(e, r.get()), r.get());
            },
          }),
          (0, Q.jsx)(`div`, {
            className: `absolute inset-0 min-h-0 overflow-hidden`,
            children: (0, Q.jsx)(V.div, {
...
function tr() {
  let e = (0, $.c)(27),
    ...
    o = y(se),
    s = y(et.activeTab$),
    c = (0, Z.useSyncExternalStore)(Bt, Ht, Ht),
    l = y(Fe),
    u,
    d,
    f;
  ...
  let p = f,
    m;
  e[5] !== d || e[6] !== p
    ? ((m = p == null || d == null ? null : { browserTabId: p, conversationId: d }),
      (e[5] = d),
      (e[6] = p),
      (e[7] = m))
    : (m = e[7]);
  let h = m,
    g = l && ((s?.isClosable ?? !1) || h != null),
    _ = i && (r?.isClosable ?? !1),
    b;
  e[8] === h
    ? (b = e[9])
    : ((b = () => (h == null ? null : rt.getSnapshot(h.conversationId, h.browserTabId))),
      (e[8] = h),
      (e[9] = b));
  let x = b,
    S = (0, Z.useSyncExternalStore)(ar, x, x)?.tabType === t.WEB ? h : null,
    w = S?.conversationId ?? null,
    T = S?.browserTabId ?? null,
    D,
    O;
  (e[10] !== _ ||
  e[11] !== u ||
  ...
  e[17] !== T
    ? ((D = () => {
        C.dispatchMessage(`app-shell-shortcut-state-changed`, {
          canAcceptAppshotShortcut: u,
          bottomPanelCanCloseActiveTab: _,
          focusArea: a,
          imagePreviewOpen: c,
          terminalFocused: o,
          rightPanelBrowserConversationId: w,
          rightPanelBrowserTabId: T,
          rightPanelCanCloseActiveTab: g,
        });
      }),
      (O = [u, _, a, c, o, g, w, T]),
      (e[10] = _),
    ...
    (0, Z.useEffect)(D, O));
  let k;
  (e[20] === Symbol.for(`react.memo_cache_sentinel`) ? ((k = []), (e[20] = k)) : (k = e[20]),
    (0, Z.useEffect)(rr, k));
  let A;
  (e[21] === Symbol.for(`react.memo_cache_sentinel`) ? ((A = []), (e[21] = A)) : (A = e[21]),
    E(`image-preview-zoom-command`, nr, A));
  let j, M;
  return (
    e[22] !== s || e[23] !== p || e[24] !== n
      ? ((j = (e) => {
          let { panelId: t } = e;
          bb80: switch (t) {
            case `bottom`:
            ...
            case `right`:
              ...
              p != null && s != null && et.closeTab(n, s.tabId);
          }
        }),
        (M = [s, p, n]),
        (e[22] = s),
        ...
        (e[26] = M))
      : ((j = e[25]), (M = e[26])),
    E(`close-active-app-shell-tab`, j, M),
    null
  );
}
function nr(e) {
...
var or = `[&_a]:pointer-events-auto [&_button]:pointer-events-auto [&_input]:pointer-events-auto [&_select]:pointer-events-auto [&_textarea]:pointer-events-auto`;
function sr({ isHeaderEdgeScroll: e, isApplicationMenuBarEnabled: t }) {
  let {
      headerLeftWidth: n,
      headerRightWidth: r,
  ...
  return (0, Q.jsx)(Ct, {
    ...
    children: (0, Q.jsxs)(V.header, {
      ...
      style: t ? { left: s } : {},
      children: [
        (0, Q.jsx)(cr, { entries: p, fitWidth: n, slotWidth: t ? o : i, side: `start` }),
        C &&
          (0, Q.jsxs)(`div`, {
            "aria-hidden": h,
            ...
            children: [
              u != null &&
                (0, Q.jsx)(`div`, {
                  className: c(`pointer-events-none w-full min-w-0 flex-1`, or),
                  children: u,
                }),
              b &&
                (0, Q.jsx)(`div`, {
        ...
        (0, Q.jsx)(cr, { entries: m, fitWidth: r, slotWidth: l, side: `end` }),
      ],
    }),
  });
}
function cr({ entries: e, fitWidth: t, side: n, slotWidth: r }) {
  ...
  return (0, Q.jsxs)(Q.Fragment, {
    children: [
      ...
      (0, Q.jsx)(V.div, {
        ...
        children: (0, Q.jsx)(lr, { entries: e, fillSlot: !0 }),
      }),
    ],
  });
}
...
function mr({ children: e, paddingTop: t }) {
  let n = v(w),
    { leftPanelAnimatedWidth: r, leftPanelWidth: i } = He(),
    [a, o] = (0, Z.useState)(!1),
    s = y(Ve),
    l = Wt`${i}px`;
  return (0, Q.jsxs)(V.aside, {
    className: c(
    ...
    children: [
      (0, Q.jsx)(V.div, {
        ...
        style: { minWidth: l, width: l, opacity: y(Se) },
        children: e,
      }),
      (0, Q.jsx)(Nn, {
        disabled: s,
...
var hr = (0, Z.createContext)({ current: null }),
  gr = (0, Z.createContext)(null);
function _r({
  children: e,
  isRightPanelOpen: t,
  mainContentWidth: n,
  ...
  let o = v(L),
    ...
    m = Wt`${r}px`,
    {
      ...
      animatedSize: _,
      progress: b,
    } = Zn({ animation: d, size: r, isVisible: t });
  return (
    Ut(b, `change`, () => {
      f.set(f.get() + 1);
    }),
...
function yr(e, t) {
  ...
  let r = U(Me({ ...e, mainContentWidth: t.get() }));
...
function br(e) {
  ...
  t[2] === r
    ? (h = t[3])
    : ((h = (e) => {
        let t = Sr(e.active.data.current);
  ...
  t[4] !== o || t[5] !== r
    ? ((y = (e) => {
        ...
        let n = Sr(e.over?.data.current);
        if (n != null)
          if (n.kind === `app-shell-tab`) {
            if (n.tabId === t.tabId) return;
            if (n.controller === t.sourceController) {
              (en(r, t.sourceController, t.tabId, n.tabId), m(t.sourceController, null));
              return;
            }
  ...
  t[7] !== o || t[8] !== r
    ? ((x = (e) => {
        ...
        (o != null &&
          t != null &&
          ($t(r, t), o.isDraggedTabActive && t.sourceController.activateTab(r, t.tabId)),
          s(null),
          (c.current = null));
      }),
      (t[7] = o),
  ...
  t[15] === o
    ? (E = t[16])
    : ((E = o == null ? null : (0, Q.jsx)(xr, { dragState: o })), (t[15] = o), (t[16] = E));
  let D;
  t[17] === E
    ? (D = t[18])
  ...
  return (
    t[27] !== O || t[28] !== T
      ? ((k = (0, Q.jsx)(Qt.Provider, { value: T, children: O })),
        (t[27] = O),
        (t[28] = T),
        (t[29] = k))
      : (k = t[29]),
...
function Cr(e) {
  let t = h(e),
    n = t.filter((e) => Sr(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab`);
  if (n.length > 0) return n;
  let r =
      t.find((e) => Sr(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab-strip`) ??
      null,
    i = r == null ? null : Sr(r.data?.droppableContainer.data.current);
  if (r != null && i?.kind === `app-shell-tab-strip`) {
    let t = e.droppableContainers.filter((e) => {
      let t = Sr(e.data.current);
...
var wr = `data-app-shell-focus-area`,
  Tr = 96,
  Er = 16,
  Dr = 960,
  Or = 720,
    ...
    onMount: (e, t) => {
      ...
      let a = t.watch(({ get: a }) => {
        ...
        if (u) {
          ...
          (r === void 0 && ((r = o), (i = s)),
            (a || (n && !d)) && !c && !d && ((n = !1), (r = void 0), (i = void 0), t.set(je, !1)),
            e(!1));
          return;
        }
...
function Pr({ bottomPanelSlot: e, children: t, leftPanelSlot: n, rightPanelSlot: r }) {
  let i = v(L),
    a = (0, Z.useRef)(null),
    [o, s] = (0, Z.useState)(null),
    l = n?.children,
  ...
  let M = Xe(J()),
    N = Ze(M, (e) => `${Math.max(0, e - Ar * 2)}px`),
    { isMounted: P, animatedSize: F } = Zn({ animation: y(Se), size: M, isVisible: O }),
    I = Xe(window.innerWidth),
    R = Xe(window.innerHeight - 46),
    B = Xe(Yn(R.get())),
    H = y(Ue),
    U = Ze([B, R], ([e, t]) => Jn(e, t)),
    W = Ze([H, U], ([e, t]) => e * t),
    ...
    Y = Xe(0),
    ne = Xe(0),
    re = Ze([I, F], ([e, t]) => Math.max(0, e - t)),
    {
      rightPanelAnimatedWidth: ie,
      rightPanelWidth: ae,
      rightPanelWidthRatio: oe,
      widthMode: se,
    } = vr({ isFullWidth: h, mainContentWidth: re }),
    ce = Ze([I, oe], ([e, t]) =>
      be({
        isRightPanelOpen: f,
        mainContentWidth: e,
        rightPanelWidthMode: se,
    ...
    ve = ft(({ width: e }) => {
      ...
      (!r && !a) ||
        ...
        (m.current = n),
        ((r && O && f && t) || (a && n)) &&
          (i.get(te) === `right-panel` && Ee(i, `main`),
          i.get(he) && i.set(he, !1),
          i.get(ye) && qe(i, !1)),
        a && n && i.get(Ge) && K(i, !1));
    }),
    ...
    Te = (0, Z.useCallback)((e) => {
      s(e);
    }, []),
    De = (0, Z.useMemo)(() => Lt(Te, we), [we, Te]);
  return (
    Ut(W, `change`, (e) => {
      let t = e - de.current;
    ...
    (0, Q.jsx)(hr.Provider, {
      value: a,
      children: (0, Q.jsx)(gr.Provider, {
        value: o,
        children: (0, Q.jsx)(zt.Provider, {
          value: _e,
          children: (0, Q.jsxs)(Ae.Provider, {
            value: me,
            children: [
              (0, Q.jsx)(yn, {}),
              (0, Q.jsx)(tr, {}),
              (0, Q.jsxs)(V.div, {
                ...
                onFocusCapture: (e) => {
                  (Ee(i, Rr(e.target)), Pe(i, zr(e.target)));
                },
                  ...
                  (0, Q.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, Q.jsx)(`main`, {
                        ...
                        children: (0, Q.jsxs)(br, {
                          children: [
                            (0, Q.jsx)(sr, {
                              isHeaderEdgeScroll: k,
                              isApplicationMenuBarEnabled: x,
                            }),
                            (0, Q.jsxs)(`div`, {
...
function Fr(e) {
  let t = (0, $.c)(15),
    ...
    p = i || d,
    m;
  t[0] === s ? (m = t[1]) : ((m = s ? { duration: 0 } : Be), (t[0] = s), (t[1] = m));
  let h = m,
    g;
  t[2] !== n ||
  t[3] !== r ||
              ...
              (0, Q.jsxs)(`aside`, {
                ...
                children: [
                  (0, Q.jsx)(V.div, {
                    ...
                    children: (0, Q.jsx)(Bn, { hideUnreadBadge: !0, onToggleSidebar: l }),
                  }),
  ...
  return (
    t[13] === g
      ? (_ = t[14])
      : ((_ = (0, Q.jsx)(Qe, { initial: !1, children: g })), (t[13] = g), (t[14] = _)),
    _
  );
}
function Ir(e) {
...
function Rr(e) {
  ...
  let t = e.closest(`[${wr}]`)?.getAttribute(wr);
...
function Br() {
  ...
  return Number.isFinite(e) ? Tr * e : Tr * Er;
}
function Vr() {
  let e = (0, $.c)(6),
    t = y(it),
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (n = e[0]);
  let r;
  e[1] === t ? (r = e[2]) : ((r = at(t) ? (0, Q.jsx)(Cn, {}) : null), (e[1] = t), (e[2] = r));
  let i;
...
function Yr(e) {
  let t = (0, $.c)(9),
    ...
    s;
  t[0] !== o || t[1] !== i
    ? ((s = i ?? Ce(o.value.routeTemplate)), (t[0] = o), (t[1] = i), (t[2] = s))
    : (s = t[2]);
  let c = s;
  ai(o, ae, n);
  let l, u;
  return (
    t[3] !== a || t[4] !== c || t[5] !== o || t[6] !== i
      ? ((l = () => {
          if (!(a === 600 && i == null))
            return (
              o.set(W, { defaultWidth: a, storageKey: c }),
              () => {
                o.set(W, null);
              }
            );
...
function Xr(e) {
  let { children: t } = e;
  return (ai(v(L), ie, t), null);
}
function Zr(e) {
  let { children: t } = e;
  return (ai(v(L), ge, t), null);
}
function Qr(e) {
  let { children: t } = e;
  return (ai(v(L), _e, t), null);
}
function $r() {
  return null;
}
...
function ti(e) {
  let { children: t } = e;
  return (ai(v(L), re, t), null);
}
function ni(e) {
  let { children: t } = e;
  return (ai(v(L), ue, t), null);
}
function ri(e) {
  let { children: t } = e;
  return (ai(v(L), Y, t), null);
}
function ii(e) {
  let { children: t } = e;
  return (ai(v(L), ce, t), null);
}
function ai(e, t, n) {
  let r = (0, $.c)(9),
    i,
...
function ci(e) {
  let t = (0, $.c)(7),
    { children: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = li(n)), (t[0] = n), (t[1] = r));
...
function ui(e) {
  return (0, Z.isValidElement)(e) && e.type === Hr;
}
function di(e) {
...
var pi = {
  ...
  Content: (0, Z.memo)(oi),
  Header: (0, Z.memo)(Ur),
  HeaderAction: (0, Z.memo)(Wr),
  HeaderContextMenuItem: (0, Z.memo)(Gr),
  MainContentLayout: (0, Z.memo)(si),
  BottomPanel: $r,
  BottomPanelTabs: (0, Z.memo)(ei),
  BottomPanelTabsEmptyState: (0, Z.memo)(ti),
  BottomPanelTabListAfter: (0, Z.memo)(ni),
  BottomPanelTabListAfterSticky: (0, Z.memo)(ri),
  BottomPanelOutlet: (0, Z.memo)(ii),
  RightPanel: Kr,
  RightPanelTabs: (0, Z.memo)(qr),
  RightPanelTabsEmptyState: (0, Z.memo)(Jr),
  RightPanelTabListAfter: (0, Z.memo)(Xr),
  RightPanelTabListAfterSticky: (0, Z.memo)(Qr),
  RightPanelTabListBefore: (0, Z.memo)(Zr),
  RightPanelOutlet: (0, Z.memo)(Yr),
};
export {
  yn as _,
  Rn as a,
