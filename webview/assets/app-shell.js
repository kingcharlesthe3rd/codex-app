...
import { Hs as r, gt as i, k as a, zs as o } from "./app-server-manager-signals.js";
import { n as s, t as c } from "./jsx-runtime.js";
import { t as l } from "./clsx.js";
import { a as u, d, f, i as p, n as m, p as h, s as g, t as _, u as v } from "./core.esm.js";
import {
  B as y,
  G as b,
  Q as x,
...
import { E as ee } from "./codex-api-B.js";
...
import { r as te } from "./reduced-motion-preference.js";
import { c as L, i as R, s as z, t as B } from "./proxy.js";
import { G as V, X as H, Z as U, ft as W, pt as G, rt as K } from "./single-value.js";
import {
  $ as q,
  A as J,
  B as Y,
...
import { a as ct, d as lt, i as ut, l as dt, n as ft, r as pt, u as mt } from "./dialog-layout.js";
...
import { i as bt, n as xt, r as St, t as Ct } from "./sortable.esm.js";
import { t as wt } from "./get-resize-observer-entry-size-Bj-GuBki.js";
import { n as Tt, r as Et } from "./use-resize-observer.js";
import { t as Dt } from "./context-menu.js";
import { a as Ot } from "./command-keybindings.js";
import { n as kt, t as At } from "./expand.js";
import { a as jt, t as Mt } from "./keyboard-modifier-state.js";
...
function Qt(e) {
  ...
  let U = H,
    ...
    G;
  t[28] !== d || t[29] !== te
    ? ((G = { ...d, "--app-shell-tab-background": te }), (t[28] = d), (t[29] = te), (t[30] = G))
    : (G = t[30]);
  let K = G,
    q;
  t[31] === u
    ...
    ? ((fe =
        ...
        (0, Q.jsx)(`span`, {
          className: l(
            ...
            w && M ? `to-[var(--app-shell-tab-background)]` : `to-token-main-surface-primary`,
...
function en(e) {
  let t = (0, $.c)(70),
    ...
    C;
  t[0] !== n || t[1] !== c
    ? ((C = { controller: n, kind: `app-shell-tab`, tabId: c }), (t[0] = n), (t[1] = c), (t[2] = C))
    : (C = t[2]);
  let w;
  ...
  t[16] === L
    ...
    : ((R = l(
      ...
      (t[17] = R));
  let z;
  t[18] === j ? (z = t[19]) : ((z = h.Translate.toString(j)), (t[18] = j), (t[19] = z));
  let V;
  t[20] !== z || t[21] !== ee
    ? ((V = { transform: z, transition: ee }), (t[20] = z), (t[21] = ee), (t[22] = V))
    : (V = t[22]);
  let H, U;
  ...
  let K;
  t[53] !== I || t[54] !== G
    ? ((K = (0, Q.jsx)(Dt, { getItems: I, children: G })), (t[53] = I), (t[54] = G), (t[55] = K))
    : (K = t[55]);
...
function rn(e, t) {
  let n = e.get(t.sourceController.tabIds$),
    r = n.indexOf(t.tabId);
  r === -1 || r === t.sourceIndex || e.set(t.sourceController.tabIds$, xt(n, r, t.sourceIndex));
}
function an(e, t, n, r) {
...
function un(e) {
  ...
  if (
    ...
    let v = `${h ?? 0}px`;
    t[41] === v ? (A = t[42]) : ((A = { scrollPaddingInlineEnd: v }), (t[41] = v), (t[42] = A));
    ...
    (t[43] === y
      ...
      t[47] === g
        ? (ee = t[48])
        : ((ee = (0, Q.jsx)(pn, { onVisibleChange: d, root: g })), (t[47] = g), (t[48] = ee)),
      (w = Ct),
      (L = i),
      (R = St),
      (P = `tablist`));
    let x = E ? `z-20` : `z-0`;
    (t[49] === x ? (F = t[50]) : ((F = l(`relative flex`, x)), (t[49] = x), (t[50] = F)),
  ...
  t[52] !== P || t[53] !== F || t[54] !== I || t[55] !== te
    ? ((z = (0, Q.jsx)(`div`, { role: P, className: F, style: I, children: te })),
      (t[52] = P),
      (t[53] = F),
      (t[54] = I),
      (t[55] = te),
...
var hn = (0, Z.memo)(function (e) {
  ...
  let f;
  t[13] !== d || t[14] !== r.tabId
    ? ((f = (0, Q.jsx)(at, { name: `AppShellTabPanel`, resetKey: u, fallback: vn, children: d })),
      (t[13] = d),
      (t[14] = r.tabId),
      (t[15] = f))
    : (f = t[15]);
...
function _n(e) {
  return e.composedPath().some((e) => e instanceof Element && e.hasAttribute(cn));
}
function vn(e) {
  return (0, Q.jsx)(gn, {
    onRetry: () => {
...
function bn() {
  ...
  return (
    e[13] !== o || e[14] !== i || e[15] !== u
      ? ((d = (0, Q.jsx)(N, { tooltipContent: o, shortcut: i, delayOpen: !0, children: u })),
        (e[13] = o),
        (e[14] = i),
        (e[15] = u),
        (e[16] = d))
...
function En(e) {
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(ct, { children: (0, Q.jsx)(ut, { title: i, subtitle: o }) })), (t[8] = d))
    : (d = t[8]);
  let f;
  ...
  t[13] === p
    ? (h = t[14])
    : ((h = (0, Q.jsx)(ct, { children: (0, Q.jsxs)(pt, { children: [p, m] }) })),
      (t[13] = p),
      (t[14] = h));
  let g;
  t[15] !== h || t[16] !== c
    ? ((g = (0, Q.jsxs)(ft, { as: `form`, onSubmit: c, children: [l, u, d, h] })),
      (t[15] = h),
      (t[16] = c),
      (t[17] = g))
    : (g = t[17]);
...
function Mn(e) {
  ...
  t[0] === l
    ? (m = t[1])
    : ((m = (e) => ({ x: e.clientX / l, y: e.clientY / l })), (t[0] = l), (t[1] = m));
  let h = m,
    g;
  t[2] === p ? (g = t[3]) : ((g = (e) => (p ? e.x : e.y)), (t[2] = p), (t[3] = g));
  let _ = g,
    v,
    y;
  (t[4] !== c || t[5] !== p || t[6] !== u || t[7] !== a || t[8] !== o || t[9] !== s || t[10] !== l
    ? ((v = () => {
        if (!u) return;
        let e = (e) => ({ x: e.clientX / l, y: e.clientY / l }),
          ...
          n = (t) => {
            ...
            if (n == null) return;
            let r = e(t);
            ((p ? r.x : r.y) !== n.startPosition && (n.didMove = !0), s(Nn(c, r, n)));
          },
          r = (n) => {
            n.preventDefault();
            let r = f.current;
  ...
  t[18] !== r || t[19] !== a || t[20] !== o || t[21] !== s
    ? ((S = (e) => {
        e.detail === 2 && (e.preventDefault(), (f.current = null), d(!1), o?.(!1), s(r), a?.(r));
      }),
      (t[18] = r),
      (t[19] = a),
      (t[20] = o),
  ...
  return (
    t[23] !== c || t[24] !== C || t[25] !== x || t[26] !== u
      ? ((w = (0, Q.jsx)(Pn, { edge: c, isResizing: u, onClick: C, onPointerDown: x })),
        (t[23] = c),
        (t[24] = C),
        (t[25] = x),
        (t[26] = u),
...
function Pn(e) {
  ...
  let m =
    ...
    g;
  t[6] !== m || t[7] !== h
    ? ((g = l(`sidebar-resize-handle-line pointer-events-none m-auto opacity-0`, m, h)),
      (t[6] = m),
      (t[7] = h),
      (t[8] = g))
    : (g = t[8]);
  let _;
  t[9] === g ? (_ = t[10]) : ((_ = (0, Q.jsx)(`div`, { className: g })), (t[9] = g), (t[10] = _));
  let v;
  return (
...
function zn(e) {
  ...
  t[2] === d
    ? (f = t[3])
    : ((f = { taskFilter: `current`, limit: 20, enabled: d }), (t[2] = d), (t[3] = f));
  let p = ee(f),
    m = D(Ln),
    h = D(Rn),
  ...
  let x = y,
    w = l ? Fn : In,
    O;
  t[7] === p.data ? (O = t[8]) : ((O = p.data ?? []), (t[7] = p.data), (t[8] = O));
  let k;
  ...
  t[17] === s
    ? ((F = t[18]), (I = t[19]))
    : ((F = () => Te(s, !0)), (I = () => Te(s, !1)), (t[17] = s), (t[18] = F), (t[19] = I));
  let te;
  t[20] === w
    ? (te = t[21])
    : ((te = (0, Q.jsx)(w, { className: `icon-xs` })), (t[20] = w), (t[21] = te));
  let L;
  t[22] === A
    ? (L = t[23])
    : ((L = A
  ...
  let R;
  t[24] !== te || t[25] !== L
    ? ((R = (0, Q.jsxs)(`span`, { className: `relative inline-flex`, children: [te, L] })),
      (t[24] = te),
      (t[25] = L),
      (t[26] = R))
    : (R = t[26]);
  let z;
  t[27] !== x || t[28] !== P || t[29] !== F || t[30] !== I || t[31] !== R || t[32] !== g
    ? ((z = (0, Q.jsx)(Wn, {
        ariaLabel: x,
        shortcut: g,
        tooltipContent: N,
    ...
    : (z = t[33]);
  let B;
  t[34] === c ? (B = t[35]) : ((B = c.formatMessage(Gn.navigateBack)), (t[34] = c), (t[35] = B));
  let V = !m,
    H;
  ...
  t[38] !== _ || t[39] !== B || t[40] !== V
    ...
    : (W = t[41]);
  let G;
  t[42] === c ? (G = t[43]) : ((G = c.formatMessage(Gn.navigateForward)), (t[42] = c), (t[43] = G));
  let K = !h,
    q;
  ...
  return (
    t[53] !== z || t[54] !== X
      ? ((ne = (0, Q.jsxs)(`div`, { className: `flex items-center gap-1`, children: [z, X] })),
        (t[53] = z),
        (t[54] = X),
        (t[55] = ne))
      : (ne = t[55]),
...
function Wn(e) {
  ...
  t[0] === u
    ? (f = t[1])
    : ((f = u == null ? void 0 : { viewTransitionName: u }), (t[0] = u), (t[1] = f));
  let p;
  t[2] !== n || t[3] !== r || t[4] !== d || t[5] !== a || t[6] !== o || t[7] !== s || t[8] !== f
    ? ((p = (0, Q.jsx)(I, {
        "aria-label": n,
        color: `ghost`,
        disabled: d,
...
function tr(e) {
  ...
  (t[0] === a
    ...
    Vt(r, `change`, o));
  let s;
  t[2] !== r || t[3] !== n ? ((s = [r, n]), (t[2] = r), (t[3] = n), (t[4] = s)) : (s = t[4]);
  let c = Kt(s, nr),
    l = i || r.get() > 0,
    u;
  return (
...
function ir({
  ...
  let a = T(F),
    { isMounted: o, opacity: s, animatedSize: c } = tr({ animation: D(We), size: n, isVisible: i }),
    l = Wt`${n}px`;
  return !o && !i
    ? null
    : (0, Q.jsxs)(B.div, {
...
function ar() {
  let e = (0, $.c)(25),
    ...
    d;
  e[0] !== s || e[1] !== n.value
    ? ((u = P(n.value)), (d = tt(s, u)), (e[0] = s), (e[1] = n.value), (e[2] = u), (e[3] = d))
    : ((u = e[2]), (d = e[3]));
  let f = d,
    p;
  e[4] !== u || e[5] !== f
  ...
  e[7] === m
    ? (_ = e[8])
    : ((_ = () => (m == null ? null : $e.getSnapshot(m.conversationId, m.browserTabId))),
      (e[7] = m),
      (e[8] = _));
  let v = _,
  ...
  e[15] !== x
    ...
    (0, Z.useEffect)(S, C));
  let w;
  (e[18] === Symbol.for(`react.memo_cache_sentinel`) ? ((w = []), (e[18] = w)) : (w = e[18]),
    (0, Z.useEffect)(sr, w));
  let E;
  (e[19] === Symbol.for(`react.memo_cache_sentinel`) ? ((E = []), (e[19] = E)) : (E = e[19]),
...
function dr({ isHeaderEdgeScroll: e, isWindowsMenuBarEnabled: t }) {
  ...
  return (0, Q.jsx)(Dt, {
    ...
    children: (0, Q.jsxs)(B.header, {
      ...
      style: t ? { left: s } : {},
      children: [
        (0, Q.jsx)(fr, { entries: p, fitWidth: n, slotWidth: t ? o : i, side: `start` }),
        S &&
          (0, Q.jsxs)(`div`, {
            "aria-hidden": h,
...
function pr(e) {
  ...
  if (t[0] !== n || t[1] !== i) {
    ...
    (t[5] === c
      ? (a = t[6])
      : ((a = l(`inline-flex h-full items-center gap-1.5`, c)), (t[5] = c), (t[6] = a)),
      (o = e.map(hr)),
      (s = r.map(mr)),
      (t[0] = n),
      (t[1] = i),
...
function mr(e, t) {
  ...
  return (0, Q.jsx)(
    `div`,
    {
      className: l(`no-drag pointer-events-auto flex shrink-0 items-center`, t === 0 && `ms-auto`),
      children: r,
    },
    n,
  );
...
function wr(e) {
        ...
        if (n != null)
          if (n.kind === `app-shell-tab`) {
            ...
            if (n.controller === t.sourceController) {
              (an(r, t.sourceController, t.tabId, n.tabId), u(t.sourceController, null));
              return;
            }
  ...
  let C = S,
    w;
  t[13] === o ? (w = t[14]) : ((w = { dragState: o }), (t[13] = o), (t[14] = w));
  let E;
  t[15] === o
    ? (E = t[16])
    : ((E = o == null ? null : (0, Q.jsx)(Tr, { dragState: o })), (t[15] = o), (t[16] = E));
  let D;
  t[17] === E
    ? (D = t[18])
    : ((D = (0, Q.jsx)(m, { adjustScale: !1, children: E })), (t[17] = E), (t[18] = D));
  let O;
  t[19] !== n ||
  t[20] !== x ||
  t[21] !== C ||
...
function Dr(e) {
  let t = g(e),
    n = t.filter((e) => Er(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab`);
  if (n.length > 0) return n;
  let r =
      t.find((e) => Er(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab-strip`) ??
      null,
...
function Rr({ bottomPanelSlot: e, children: t, leftPanelSlot: n, rightPanelSlot: r }) {
  let i = T(F),
    a = (0, Z.useRef)(null),
    [o, s] = (0, Z.useState)(null),
    c = n?.children,
  ...
  let j = Ht(X()),
    ...
    { isMounted: M, animatedSize: N } = tr({ animation: D(He), size: j, isVisible: E }),
                    ...
                    children: [
                      (0, Q.jsx)(Xe, {
                        ...
                        children:
                          ...
                          (0, Q.jsx)(
                            vr,
                            { paddingTop: v ? `0px` : `var(--height-toolbar)`, children: c },
                      ...
                      (0, Q.jsx)(`main`, {
                        ...
                        children: (0, Q.jsxs)(wr, {
                          children: [
                            (0, Q.jsx)(dr, { isHeaderEdgeScroll: O, isWindowsMenuBarEnabled: v }),
                            (0, Q.jsxs)(`div`, {
                                  ...
                                  children: (0, Q.jsx)(`div`, {
                                    ...
                                    children: (0, Q.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, Q.jsx)(`div`, {
                                          "aria-hidden": !0,
                                          "data-app-shell-main-content-top-fade": A,
...
function zr(e) {
  let t = (0, $.c)(15),
    ...
    p = i || d,
    m;
  t[0] === s ? (m = t[1]) : ((m = s ? { duration: 0 } : Oe), (t[0] = s), (t[1] = m));
  let h = m,
    g;
  t[2] !== n ||
  t[3] !== p ||
        ...
        ? (0, Q.jsxs)(B.aside, {
            ...
            children: [
              (0, Q.jsx)(B.div, {
                ...
                children: (0, Q.jsx)(zn, { hideUnreadBadge: !0, onToggleSidebar: c }),
              }),
  ...
  return (
    t[13] === g
      ? (_ = t[14])
      : ((_ = (0, Q.jsx)(Xe, { initial: !1, children: g })), (t[13] = g), (t[14] = _)),
    _
  );
}
function Br(e) {
...
function Gr() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (n = e[0]);
  let r;
  e[1] === t ? (r = e[2]) : ((r = rt(t) ? (0, Q.jsx)(Tn, {}) : null), (e[1] = t), (e[2] = r));
  let i;
  ...
  return (
    t[4] !== e.id || t[5] !== n
      ? ((a = () => (
          ...
          () => {
            (n.set(le.ids$, (t) => t.filter((t) => t !== e.id)), n.set(le.byId, e.id, null));
          }
        )),
        (o = [e.id, n]),
        (t[4] = e.id),
...
function ui(e) {
  let t = (0, $.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(yt, { debugName: `AppShellContent`, fillParent: !0 })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
