...
import { A as u, Cn as d, Zr as f } from "./app-server-manager-signals.js";
import { f as p, p as m } from "./vscode-api.js";
import { Cn as h, Tr as g } from "./src-1.js";
import { t as _ } from "./react-dom.js";
import { c as v, n as y, o as b, r as x } from "./lib.js";
import { Br as S, Wr as C } from "./persisted-signal.js";
...
import { t as Re } from "./button-DO-oxX3-.js";
...
import { t as We } from "./context-menu-Cx-ZCB4Y.js";
import { n as Ge } from "./rpc-1.js";
import {
  a as Ke,
  d as qe,
  f as Je,
...
import { i as nt, t as X } from "./route-scope.js";
import { t as rt } from "./constants.js";
import { t as it } from "./use-platform.js";
import { c as at, n as ot, r as st, t as ct } from "./app-shell-tab-controller.js";
import { t as lt } from "./browser-sidebar-manager.js";
import { a as ut, l as dt, r as ft, t as pt } from "./error-boundary.js";
import { t as mt } from "./download.js";
import { t as ht } from "./with-window.js";
import { r as gt, t as _t } from "./use-window-controls-safe-area.js";
import { t as vt } from "./use-register-command.js";
import { r as yt } from "./modal-controller-state.js";
import {
  a as bt,
  d as xt,
  i as St,
...
import { N as Dt } from "./open-project-setup-dialog.js";
import { r as Ot } from "./run-command.js";
import { r as kt } from "./sidebar-thread-row-signals-De-atrPX.js";
import { t as At } from "./loading-page.js";
import { i as jt, n as Mt, r as Nt, t as Pt } from "./sortable.esm.js";
import { t as Ft } from "./get-resize-observer-entry-size.js";
import { n as It, r as Lt } from "./use-resize-observer.js";
import { a as Rt } from "./command-keybindings.js";
...
function an(e) {
  ...
  t[3] !== m || t[4] !== S || t[5] !== o.dndId
    ? ((C = { data: S, disabled: m, id: o.dndId, strategy: Nt }),
      (t[3] = m),
      (t[4] = S),
      (t[5] = o.dndId),
      (t[6] = C))
...
var sn = (0, Z.createContext)(null);
function cn(e, t) {
  let n = e.get(t.sourceController.tabIds$),
    r = n.indexOf(t.tabId);
  r !== -1 &&
    (r !== t.sourceIndex && e.set(t.sourceController.tabIds$, Mt(n, r, t.sourceIndex)),
...
function ln(e, t, n, r) {
  let i = e.get(t.tabIds$),
    a = i.indexOf(n),
    o = i.indexOf(r);
  a === -1 || o === -1 || a === o || e.set(t.tabIds$, Mt(i, a, o));
}
function un(e, t, n, r) {
...
var pn = `data-tab-preview-pin-exempt`;
function mn(e) {
  let t = (0, $.c)(20),
    {
      afterList: n,
    ...
    f = (0, Z.useContext)(sn)?.dragState ?? null,
    p;
  t[0] !== s || t[1] !== f || t[2] !== l
    ? ((p = fn(l, s, f)), (t[0] = s), (t[1] = f), (t[2] = l), (t[3] = p))
    : (p = t[3]);
  let m = p,
    h = u?.tabId ?? null,
    g;
  ...
  t[12] !== u || t[13] !== d || t[14] !== s || t[15] !== a
    ? ((_ =
        u == null
          ...
          : (0, Q.jsx)(bn, { controller: s, tab: u }, d)),
      (t[12] = u),
      (t[13] = d),
      (t[14] = s),
      (t[15] = a),
...
function hn(e) {
  ...
  let { setNodeRef: b } = tt(y),
    x = (0, Z.useContext)(sn)?.dragState ?? null,
    S,
    C,
    T,
    E,
  ...
  if (
    ...
    let e = c.map(_n),
      r;
    t[32] === c ? (r = t[33]) : ((r = c.map(gn)), (t[32] = c), (t[33] = r));
    let i = r;
    ...
    (t[43] === v
      ...
      t[47] === h
        ? (j = t[48])
        : ((j = (0, Q.jsx)(vn, { onVisibleChange: u, root: h })), (t[47] = h), (t[48] = j)),
      (S = Pt),
      (R = i),
      (z = Nt),
      (P = `tablist`));
      ...
      (L = c.map((t) => {
        ...
        return (0, Q.jsx)(
          an,
          {
            ...
            isActive: r,
            separatorIndex: i,
            showTrailingSeparator: i < e.length - 1 && !r && !yn(i, d),
            tab: t,
          },
          t.tabId,
        );
  ...
  let H;
  t[62] !== C || t[63] !== h
    ? ((H = (0, Q.jsx)(vn, { onVisibleChange: f, root: h, rootMargin: C })),
      (t[62] = C),
      (t[63] = h),
      (t[64] = H))
    : (H = t[64]);
...
var bn = (0, Z.memo)(function (e) {
  ...
  t[0] !== n || t[1] !== i || t[2] !== r.isPreview || t[3] !== r.tabId
    ? ((a = (e) => {
        Sn(e.nativeEvent) || (r.isPreview && n.pinTab(i, r.tabId));
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = r.isPreview),
  ...
  let p;
  t[13] !== f || t[14] !== r.tabId
    ? ((p = (0, Q.jsx)(pt, { name: `AppShellTabPanel`, resetKey: d, fallback: Cn, children: f })),
      (t[13] = f),
      (t[14] = r.tabId),
      (t[15] = p))
    : (p = t[15]);
...
function Sn(e) {
  return e.composedPath().some((e) => e instanceof Element && e.hasAttribute(pn));
}
function Cn(e) {
  return (0, Q.jsx)(xn, {
    onRetry: () => {
...
function Tn() {
  let e = (0, $.c)(17),
    ...
    n = v(),
    r = c(P),
    a = i(Rt, `toggleMaximizeSidePanel`),
    o;
  e[0] !== n || e[1] !== r
    ? ((o = r
        ? n.formatMessage({
...
function Dn() {
  let e = c(J),
    ...
    i = c(P),
    a = c(Ae),
    { headerLeftWidth: o, headerRightWidth: s } = ae(),
    l = Qt`max(0px, calc(${s}px)`;
  return (0, Q.jsx)(mn, {
...
function kn(e) {
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(xt, { className: `sr-only`, children: i })),
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(bt, { children: (0, Q.jsx)(St, { title: i, subtitle: o }) })), (t[8] = d))
    : (d = t[8]);
  let f;
  ...
  t[13] === p
    ? (h = t[14])
    : ((h = (0, Q.jsx)(bt, { children: (0, Q.jsxs)(Tt, { children: [p, m] }) })),
      (t[13] = p),
      (t[14] = h));
  let g;
  t[15] !== h || t[16] !== c
    ? ((g = (0, Q.jsxs)(wt, { as: `form`, onSubmit: c, children: [l, u, d, h] })),
      (t[15] = h),
      (t[16] = c),
      (t[17] = g))
    : (g = t[17]);
...
function Nn() {
  return gt() && window.electronBridge?.showApplicationMenu != null;
}
var Pn = x({
    file: {
  ...
  Fn = [
    { id: h.file, message: Pn.file },
    { id: h.edit, message: Pn.edit },
    { id: h.view, message: Pn.view },
    { id: h.help, message: Pn.help },
  ];
function In() {
  let e = v(),
  ...
  return (0, Q.jsx)(`div`, {
    ...
    children: Fn.map(({ id: n, message: r }) =>
      (0, Q.jsx)(
        `button`,
        {
          type: `button`,
...
var zn = o(l, Ln),
  Bn = o(l, { width: window.innerWidth, height: window.innerHeight }),
  Vn = {
    px$: a(l, ({ get: e }) => e(zn).x),
    py$: a(l, ({ get: e }) => e(zn).y),
    hasKnownVelocity$: a(l, ({ get: e }) => e(zn).hasKnownVelocity),
    vx$: a(l, ({ get: e }) => e(zn).velocityX),
    vy$: a(l, ({ get: e }) => e(zn).velocityY),
    speed$: a(l, ({ get: e }) => e(zn).speed),
    ...
    ? ((w = () => {
        ...
        let e = (e) => ({ x: e.clientX / d, y: e.clientY / d }),
          t = (t) => {
            ...
            if (n == null) return;
            let r = e(t);
            ((h ? r.x : r.y) !== n.startPosition && (n.didMove = !0), c(Un(u, r, n)));
          },
          n = (t) => {
            t.preventDefault();
            let n = m.current;
...
var Gn = (e) =>
  ...
  Jn = o(l, !1),
  Yn = a(l, ({ get: e }) => {
    let { automationThreadIds: t, unreadRunCount: n } = e(kt);
    return (
      n +
      e(Dt).filter((e) => {
        let n = d(e);
...
function Xn(e) {
  ...
  let { hideUnreadBadge: r, onToggleSidebar: a } = n,
    ...
    g = c(qn),
    _ = c(Jn),
    y = i(Rt, `toggleSidebar`),
    x = i(Rt, `navigateBack`),
    S = i(Rt, `navigateForward`),
    C;
  t[2] !== d || t[3] !== f
    ? ((C = f
        ? d.formatMessage({
  ...
  t[28] !== y
    ...
    : (L = t[29]);
  let R;
  t[30] === d ? (R = t[31]) : ((R = d.formatMessage(er.navigateBack)), (t[30] = d), (t[31] = R));
  let z = !g,
    B;
  t[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, Q.jsx)(b, { ...er.navigateBack })), (t[32] = B))
    : (B = t[32]);
  let V;
  ...
  t[34] !== x || t[35] !== R || t[36] !== z
    ...
    : (H = t[37]);
  let U;
  t[38] === d ? (U = t[39]) : ((U = d.formatMessage(er.navigateForward)), (t[38] = d), (t[39] = U));
  let W = !_,
    G;
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, Q.jsx)(b, { ...er.navigateForward })), (t[40] = G))
    : (G = t[40]);
  let K;
...
var er = x({
  ...
  tr = 280,
  nr = `app-shell:bottom-panel-height`;
function rr(e, t) {
  return Number.isFinite(e) ? Math.max(160, Math.min(e, t * 0.5)) : tr;
}
function ir(e) {
  return rr(S(nr, 280), e);
}
function ar(e, t) {
  C(nr, rr(e, t));
}
...
function lr({
  ...
  let a = s(X),
    { isMounted: o, opacity: l, animatedSize: u } = or({ animation: c(Oe), size: n, isVisible: i }),
    d = Qt`${n}px`;
  return !o && !i
    ? null
    : (0, Q.jsxs)(T.div, {
...
function ur() {
  ...
  e[6] === d
    ? (b = e[7])
    : ((b = () => (d == null ? null : lt.getSnapshot(d.conversationId, d.browserTabId))),
      (e[6] = d),
      (e[7] = b));
  let x = b,
    S;
  e[8] === _
    ? (S = e[9])
    : ((S = () => (_ == null ? null : lt.getSnapshot(_.conversationId, _.browserTabId))),
      (e[8] = _),
      (e[9] = S));
  let C = S,
    w = (0, Z.useSyncExternalStore)(lt.subscribe, x, x),
    T = (0, Z.useSyncExternalStore)(lt.subscribe, C, C),
    E = w?.tabType === g.WEB,
    D = T?.tabType === g.WEB,
  ...
  (e[25] === Symbol.for(`react.memo_cache_sentinel`) ? ((F = []), (e[25] = F)) : (F = e[25]),
    m(`image-preview-zoom-command`, dr, F));
  let I, L;
  return (
    e[26] !== n || e[27] !== d || e[28] !== o || e[29] !== _ || e[30] !== t
      ? ((I = (e) => {
          ...
          bb95: switch (r) {
            case `bottom`:
              if (ct.closeActiveTab(t)) break bb95;
              d != null && n != null && ct.closeTab(t, n.tabId);
              break bb95;
            case `right`:
              if (ot.closeActiveTab(t)) break bb95;
              _ != null && o != null && ot.closeTab(t, o.tabId);
          }
        }),
        (L = [n, d, o, _, t]),
        (e[26] = n),
...
var hr = `[&_a]:pointer-events-auto [&_button]:pointer-events-auto [&_input]:pointer-events-auto [&_select]:pointer-events-auto [&_textarea]:pointer-events-auto`;
function gr({ isHeaderEdgeScroll: e, isApplicationMenuBarEnabled: t }) {
  let {
      headerLeftWidth: n,
      headerRightWidth: r,
  ...
  return (0, Q.jsx)(We, {
    ...
    children: (0, Q.jsxs)(T.header, {
      ...
      style: t ? { left: s } : {},
      children: [
        (0, Q.jsx)(_r, { entries: p, fitWidth: n, slotWidth: t ? o : i, side: `start` }),
        S &&
          (0, Q.jsxs)(`div`, {
            "aria-hidden": h,
            ...
            children: [
              u != null &&
                (0, Q.jsx)(`div`, {
                  className: w(`pointer-events-none w-full min-w-0 flex-1`, hr),
                  children: u,
                }),
              y &&
                (0, Q.jsx)(`div`, {
        ...
        (0, Q.jsx)(_r, { entries: m, fitWidth: r, slotWidth: l, side: `end` }),
      ],
    }),
  });
}
function _r({ entries: e, fitWidth: t, side: n, slotWidth: r }) {
  ...
  return (0, Q.jsxs)(Q.Fragment, {
    children: [
      ...
      (0, Q.jsx)(T.div, {
        ...
        children: (0, Q.jsx)(vr, { entries: e, fillSlot: !0 }),
      }),
    ],
  });
}
...
function Cr({ children: e, paddingTop: t }) {
  let n = s(l),
  ...
  return (0, Q.jsxs)(T.aside, {
    ...
    children: [
      (0, Q.jsx)(T.div, {
        ...
        style: { minWidth: d, width: d, opacity: c(ie) },
        children: e,
      }),
      (0, Q.jsx)(Hn, {
        disabled: u,
...
function wr({
  ...
  let o = s(X),
    ...
    h = Qt`${r}px`,
    {
      ...
      animatedSize: v,
      progress: y,
    } = or({ animation: f, size: r, isVisible: t });
  return (
    Zt(y, `change`, () => {
      p.set(p.get() + 1);
    }),
...
function Or(e) {
  ...
  t[5] === r
    ? (h = t[6])
    : ((h = (e) => {
        let t = jr(e.active.data.current);
  ...
  t[7] !== o || t[8] !== r
    ? ((_ = (e) => {
        ...
        let n = jr(e.over?.data.current);
        if (n != null)
          if (n.kind === `app-shell-tab`) {
            if (n.tabId === t.tabId) return;
            if (n.controller === t.sourceController) {
              (ln(r, t.sourceController, t.tabId, n.tabId), f(t.sourceController, null, `before`));
              return;
            }
            f(n.controller, n.tabId, Pr(e));
  ...
  t[12] !== o || t[13] !== r
    ? ((x = (e) => {
        let t = l.current;
        (o != null && t != null && cn(r, t), c(null), (l.current = null));
      }),
      (t[12] = o),
      (t[13] = r),
      (t[14] = x))
  ...
  t[22] === o
    ? (D = t[23])
    : ((D = o == null ? null : (0, Q.jsx)(Ar, { dragState: o })), (t[22] = o), (t[23] = D));
  let O;
  t[24] === D
    ? (O = t[25])
    : ((O = (0, Q.jsx)(Xe, { adjustScale: !1, zIndex: rt, children: D })),
      (t[24] = D),
      (t[25] = O));
  let k;
  t[26] !== E || t[27] !== O
    ? ((k = (0, Dr.createPortal)((0, Q.jsxs)(Q.Fragment, { children: [E, O] }), document.body)),
      (t[26] = E),
      (t[27] = O),
      (t[28] = k))
    : (k = t[28]);
  ...
  return (
    t[38] !== T || t[39] !== A
      ? ((j = (0, Q.jsx)(sn.Provider, { value: T, children: A })),
        (t[38] = T),
        (t[39] = A),
        (t[40] = j))
      : (j = t[40]),
...
function Mr(e) {
  let t = $e(e),
    n = t.filter((e) => jr(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab`);
  if (n.length > 0) return Nr(n, e);
  let r =
      t.find((e) => jr(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab-strip`) ??
      null,
    i = r == null ? null : jr(r.data?.droppableContainer.data.current);
  if (r != null && i?.kind === `app-shell-tab-strip`) {
    let t = e.droppableContainers.filter((e) => {
      let t = jr(e.data.current);
      return t?.kind === `app-shell-tab` && t.controller === i.controller;
    });
    return t.length > 0 ? Nr(Ke({ ...e, droppableContainers: t }), e) : [r];
  }
  return Nr(Ke(e), e);
}
function Nr(e, t) {
  return e.map((e) => {
    let n = jr(e.data?.droppableContainer.data.current),
    ...
    return n?.kind !== `app-shell-tab` || r == null
      ...
      : {
          ...
          data: {
            ...e.data,
            appShellTabInsertionPlacement: dn(t.pointerCoordinates?.x ?? null, r.left, r.width),
          },
        };
  });
}
...
function Wr({ bottomPanelSlot: e, children: t, leftPanelSlot: n, rightPanelSlot: r }) {
  let i = s(X),
    a = (0, Z.useRef)(null),
  ...
  let I = Fe(M()),
    L = Ie(I, (e) => `${Math.max(0, e - Br * 2)}px`),
    { isMounted: z, animatedSize: B } = or({ animation: c(ie), size: I, isVisible: k }),
    ...
    re = Ie([V, B], ([e, t]) => Math.max(0, e - t)),
    {
      ...
      widthMode: ce,
    } = Tr({ isFullWidth: g, mainContentWidth: re }),
    le = Ie([V, se], ([e, t]) =>
      be({
        isRightPanelOpen: p,
        mainContentWidth: e,
              ...
              (0, Q.jsxs)(T.div, {
                ...
                onBlurCapture: (e) => {
                  (e.relatedTarget instanceof Node && e.currentTarget.contains(e.relatedTarget)) ||
                    (e.relatedTarget != null && ke(i, Jr(e.relatedTarget)), Te(i, !1));
                },
                onFocusCapture: (e) => {
                  (ke(i, Jr(e.target)), Te(i, Yr(e.target)));
                },
...
function Gr(e) {
  let t = (0, $.c)(15),
    ...
    m = i || f,
    h;
  t[0] === c ? (h = t[1]) : ((h = c ? { duration: 0 } : fe), (t[0] = c), (t[1] = h));
  let g = h,
    _;
  t[2] !== n ||
  t[3] !== r ||
              ...
              (0, Q.jsxs)(`aside`, {
                ...
                children: [
                  (0, Q.jsx)(T.div, {
                    ...
                    children: (0, Q.jsx)(Xn, { hideUnreadBadge: !0, onToggleSidebar: u }),
                  }),
...
function Xr() {
  ...
  return Number.isFinite(e) ? Fr * e : Fr * Ir;
}
function Zr() {
  let e = (0, $.c)(6),
    t = c(ut),
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (n = e[0]);
  let r;
  e[1] === t ? (r = e[2]) : ((r = dt(t) ? (0, Q.jsx)(Mn, {}) : null), (e[1] = t), (e[2] = r));
  let i;
...
function ai(e) {
  let t = (0, $.c)(9),
    ...
    c;
  t[0] !== o || t[1] !== i
    ? ((c = i ?? ge(o.value.routeTemplate)), (t[0] = o), (t[1] = i), (t[2] = c))
    : (c = t[2]);
  let l = c;
  hi(o, Ce, n);
  let u, d;
  return (
    t[3] !== a || t[4] !== l || t[5] !== o || t[6] !== i
      ? ((u = () => {
          if (!(a === 600 && i == null))
            return (
              o.set(ce, { defaultWidth: a, storageKey: l }),
              () => {
                o.set(ce, null);
              }
            );
...
function oi(e) {
  let { children: t } = e;
  return (hi(s(X), J, t), null);
}
function si(e) {
  let { children: t } = e;
  return (hi(s(X), Y, t), null);
}
function ci(e) {
  let { children: t } = e;
  return (hi(s(X), q, t), null);
}
function li() {
  return null;
}
...
function di(e) {
  let { children: t } = e;
  return (hi(s(X), z, t), null);
}
function fi(e) {
  let { children: t } = e;
  return (hi(s(X), N, t), null);
}
function pi(e) {
  let { children: t } = e;
  return (hi(s(X), I, t), null);
}
function mi(e) {
  let { children: t } = e;
  return (hi(s(X), H, t), null);
}
function hi(e, t, n) {
  let r = (0, $.c)(9),
    i,
...
function gi(e) {
  let t = (0, $.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(At, { debugName: `AppShellContent`, fillParent: !0 })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function vi(e) {
  let t = (0, $.c)(7),
    { children: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = yi(n)), (t[0] = n), (t[1] = r));
...
function bi(e) {
  return (0, Z.isValidElement)(e) && e.type === Qr;
}
function xi(e) {
  return (0, Z.isValidElement)(e) && e.type === ni;
}
function Si(e) {
  return (0, Z.isValidElement)(e) && e.type === li;
}
var Ci = {
  Root: (0, Z.memo)(vi),
  LeftPanel: Qr,
  Content: (0, Z.memo)(gi),
  Header: (0, Z.memo)($r),
  HeaderAction: (0, Z.memo)(ei),
  HeaderContextMenuItem: (0, Z.memo)(ti),
  MainContentLayout: (0, Z.memo)(_i),
  BottomPanel: li,
  BottomPanelTabs: (0, Z.memo)(ui),
  BottomPanelTabsEmptyState: (0, Z.memo)(di),
  BottomPanelTabListAfter: (0, Z.memo)(fi),
  BottomPanelTabListAfterSticky: (0, Z.memo)(pi),
  BottomPanelOutlet: (0, Z.memo)(mi),
  RightPanel: ni,
  RightPanelTabs: (0, Z.memo)(ri),
  RightPanelTabsEmptyState: (0, Z.memo)(ii),
  RightPanelTabListAfter: (0, Z.memo)(oi),
  RightPanelTabListAfterSticky: (0, Z.memo)(ci),
  RightPanelTabListBefore: (0, Z.memo)(si),
  RightPanelOutlet: (0, Z.memo)(ai),
};
export {
  On as _,
  qn as a,
