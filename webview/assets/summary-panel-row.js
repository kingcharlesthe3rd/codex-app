...
function a(e) {
  ...
  let L = I,
    R = m ?? `truncate`,
    z;
  t[25] === R ? (z = t[26]) : ((z = n(`text-base`, R)), (t[25] = R), (t[26] = z));
  let B;
  t[27] !== p || t[28] !== z
  ...
  let W;
  t[43] !== f || t[44] !== U
    ? ((W = (0, i.jsxs)(i.Fragment, { children: [f, U] })), (t[43] = f), (t[44] = U), (t[45] = W))
    : (W = t[45]);
  let G = W,
    K = d || void 0,
    q = c ?? l,
