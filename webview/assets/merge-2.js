...
function b(e, t, n) {
  var r = e._x1 - e._x0,
    ...
    o = (n - e._y1) / (i || (r < 0 && -0)),
    s = (a * i + o * r) / (r + i);
  return (y(a) + y(o)) * Math.min(Math.abs(a), Math.abs(o), 0.5 * Math.abs(s)) || 0;
}
function x(e, t) {
  var n = e._x1 - e._x0;
...
var k = (function () {
  ...
  A = ue(
    k
      ? function (e, t) {
          return k(e, `toString`, { configurable: !0, enumerable: !1, value: O(t), writable: !0 });
        }
      : r,
  );
function j(e, t, n) {
...
function F(e, t, n) {
  return (
    ...
    function () {
      for (var r = arguments, i = -1, a = P(r.length - t, 0), o = Array(a); ++i < a;)
        o[i] = r[t + i];
      i = -1;
...
function L(t, n, r) {
  if (!e(r)) return !1;
  var i = typeof n;
  return (i == `number` ? c(r) && h(n, r.length) : i == `string` && n in r) ? a(r[n], t) : !1;
}
function R(e) {
