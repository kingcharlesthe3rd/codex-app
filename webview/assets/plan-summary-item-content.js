...
import { i as f, l as ee, s as p } from "./lib.js";
import { t as m } from "./clsx-Cir5-jBH.js";
import { t as h } from "./proxy.js";
import { t as g } from "./button.js";
import { t as _ } from "./tooltip.js";
import { r as te } from "./product-logger.js";
import { o as v } from "./statsig.js";
import { n as y } from "./request.js";
import { t as b } from "./animations.js";
import { r as x, t as S } from "./modal-controller-state.js";
import { a as ne, i as C, l as re, n as w, o as ie, r as ae } from "./dialog-layout-B.js";
import { t as T } from "./with-window.js";
import { t as E } from "./chevron.js";
import { t as D } from "./download.js";
import { t as O } from "./copy-to-clipboard.js";
import { t as oe } from "./thinking-shimmer.js";
import { t as k } from "./copy-button.js";
import { t as se } from "./arrow-top-right.js";
import { n as ce, t as A } from "./markdown-surface.js";
import { t as j } from "./feedback-form-dialog.js";
var le = e(t()),
  M = n(),
  N = (e) =>
    (0, M.jsxs)(`svg`, {
  ...
  F = o(),
  ue = `codex-thread-report-reasons`;
function I(e) {
  let t = (0, F.c)(82),
  ...
  t[0] === i
    ? (l = t[1])
    : ((l = { queryKey: [ue, i], queryFn: () => ge(i), staleTime: u.ONE_MINUTE }),
      (t[0] = i),
      (t[1] = l));
  let f = d(l),
    m;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = { mutationFn: _e }), (t[2] = m))
    : (m = t[2]);
  let h = s(m),
    [_, te] = (0, le.useState)(``),
    [v, y] = (0, le.useState)(null),
    b;
  t[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((b = []), (t[3] = b)) : (b = t[3]);
  let [x, S] = (0, le.useState)(b),
    T = x.length === 0 ? null : x[x.length - 1],
    E,
    D,
    O,
    oe,
    k;
  t[4] !== T?.details_placeholder ||
  t[5] !== T?.link_attachment ||
  t[6] !== T?.sub_reasons ||
  t[7] !== f.data?.reasons ||
  t[8] !== v
    ? ((k = T?.sub_reasons ?? f.data?.reasons ?? []),
      (O = k.find((e) => e.id === v) ?? null),
      (E = T?.details_placeholder != null),
      (D = T?.link_attachment != null),
      (oe = E || (O != null && he(O))),
      (t[4] = T?.details_placeholder),
      (t[5] = T?.link_attachment),
      (t[6] = T?.sub_reasons),
      ...
      (t[12] = oe),
      (t[13] = k))
    : ((E = t[9]), (D = t[10]), (O = t[11]), (oe = t[12]), (k = t[13]));
  let se = oe,
    ce = O == null || f.isPending || h.isPending,
    A = h.isSuccess || f.isError,
    j = !A && !se && !D && ce,
    N;
  t[14] === r
    ? (N = t[15])
  ...
  t[30] !== a
    ? ((B = (e) => {
        ...
        if (D && T?.link_attachment != null) {
          c.dispatchMessage(`open-in-browser`, { url: T.link_attachment });
          return;
        }
        if (E && T != null) {
          h.mutate({ details: _.trim(), entityType: i, reasonId: T.id, threadId: a });
          return;
        }
        if (O != null) {
          if (he(O)) {
            h.mutate({ details: ``, entityType: i, reasonId: O.id, threadId: a });
            return;
          }
          (S((e) => [...e, O]), y(null), te(``));
        }
  ...
  t[32] === h.isSuccess
    ? (H = t[33])
    : ((H = (0, M.jsx)(fe, { success: h.isSuccess })), (t[32] = h.isSuccess), (t[33] = H));
  let U;
  t[34] !== T || t[35] !== f.data || t[36] !== h.isSuccess
    ? ((U = R({ activeReason: T, reportReasons: f.data, isSuccess: h.isSuccess })),
      (t[34] = T),
      (t[35] = f.data),
      (t[36] = h.isSuccess),
      (t[37] = U))
  ...
  t[38] !== H || t[39] !== U
    ? ((W = (0, M.jsx)(ne, {
        children: (0, M.jsx)(C, { title: H, subtitle: U, titleSize: `dialog` }),
      })),
      (t[38] = H),
      (t[39] = U),
      (t[40] = W))
              ...
              ? (0, M.jsxs)(ie, {
                  ...
                  children: [
                    (0, M.jsx)(`textarea`, {
                      ...
                      placeholder: T.details_placeholder ?? void 0,
                    ...
                    T.subtext == null ? null : (0, M.jsx)(L, { children: T.subtext }),
                  ],
                })
              : D
                ? (0, M.jsx)(L, {
                ...
                : (0, M.jsx)(me, { reasons: k, selectedReasonId: v, setSelectedReasonId: y })),
      (t[41] = T),
      (t[42] = _),
      (t[43] = o),
      (t[44] = E),
  ...
  let q;
  t[54] !== G || t[55] !== K
    ? ((q = (0, M.jsxs)(ne, { children: [G, K] })), (t[54] = G), (t[55] = K), (t[56] = q))
    : (q = t[56]);
  let J;
  t[57] !== T || t[58] !== z || t[59] !== n || t[60] !== h.isPending || t[61] !== h.isSuccess
    ? ((J =
        (T != null || n != null) && !h.isSuccess
          ? (0, M.jsx)(g, {
              color: `secondary`,
    ...
    : (J = t[62]);
  let Y;
  t[63] !== D || t[64] !== se || t[65] !== A
    ? ((Y = (0, M.jsx)(pe, { close: A, isLinkStep: D, isSubmitStep: se })),
      (t[63] = D),
      (t[64] = se),
      (t[65] = A),
      (t[66] = Y))
    : (Y = t[66]);
  let X;
  t[67] !== j || t[68] !== h.isPending || t[69] !== Y
    ? ((X = (0, M.jsx)(g, {
        color: `primary`,
        disabled: j,
        loading: h.isPending,
  ...
  let Z;
  t[71] !== J || t[72] !== X
    ? ((Z = (0, M.jsx)(ne, { children: (0, M.jsxs)(ae, { children: [J, X] }) })),
      (t[71] = J),
      (t[72] = X),
      (t[73] = Z))
    : (Z = t[73]);
  let Q;
  t[74] !== V || t[75] !== W || t[76] !== q || t[77] !== Z
    ? ((Q = (0, M.jsxs)(w, { as: `form`, className: `gap-4`, onSubmit: V, children: [W, q, Z] })),
      (t[74] = V),
      (t[75] = W),
      (t[76] = q),
      (t[77] = Z),
  ...
  return (
    t[79] !== P || t[80] !== Q
      ? (($ = (0, M.jsx)(re, { open: !0, onOpenChange: P, size: `wide`, children: Q })),
        (t[79] = P),
        (t[80] = Q),
        (t[81] = $))
      : ($ = t[81]),
...
function R({ activeReason: e, isSuccess: t, reportReasons: n }) {
...
async function _e({ details: e, entityType: t, reasonId: n, threadId: r }) {
  await l
    .getInstance()
    .post(
      `/report_flow/report`,
...
var z = `https://help.openai.com/en/articles/5722486-how-your-data-is-used-to-improve-model-performance`,
  B = `safety_or_legal_concern`,
  V = f({
  ...
  H = {
    thumbs_down: [
      { id: `wrong_presentation_length`, label: V.wrongPresentationLength },
      { id: `poor_writing`, label: V.poorWriting },
      { id: `poor_style_format_or_visuals`, label: V.poorStyleFormatOrVisuals },
      { id: `wrong_topics_or_subtopics`, label: V.wrongTopicsOrSubtopics },
      { id: `didnt_follow_my_instructions`, label: V.didntFollowMyInstructions },
      { id: `didnt_follow_my_template`, label: V.didntFollowMyTemplate },
      { id: `incorrect_content`, label: V.incorrectContent },
      { id: B, label: V.safetyOrLegalConcern },
    ],
    thumbs_up: [
      { id: `good_content`, label: V.goodContent },
      { id: `good_writing_quality`, label: V.goodWritingQuality },
      { id: `good_style_format_or_visuals`, label: V.goodStyleFormatOrVisuals },
      { id: `followed_my_instructions_well`, label: V.followedMyInstructionsWell },
      { id: `generated_quickly`, label: V.generatedQuickly },
    ],
  },
  U = {
    thumbs_down: [
      { id: `incorrect_or_incomplete`, label: V.incorrectOrIncomplete },
      { id: `didnt_follow_my_instructions`, label: V.didntFollowMyInstructions },
      { id: `off_track_or_wrong_scope`, label: V.offTrackOrWrongScope },
      { id: `lost_context`, label: V.lostContext },
      { id: `slow_or_buggy`, label: V.slowOrBuggy },
      { id: B, label: V.safetyOrLegalConcern },
      { id: `other`, label: V.other },
    ],
    thumbs_up: [
      { id: `solved_my_task`, label: V.solvedMyTask },
      { id: `followed_my_instructions`, label: V.followedMyInstructions },
      { id: `good_code_or_output_quality`, label: V.goodCodeOrOutputQuality },
      { id: `fast_and_efficient`, label: V.fastAndEfficient },
      { id: `useful_autonomy`, label: V.usefulAutonomy },
      { id: `other`, label: V.other },
    ],
  };
function W(e) {
  let t = (0, F.c)(17),
    { hasArtifacts: n, reportEntityType: o, threadId: s, turnId: c } = e,
    l = n === void 0 ? !1 : n,
    u = o === void 0 ? `thread` : o,
    d = r(a),
    [f, ee] = (0, le.useState)(null),
    m = i(te),
    h = v(`584954669`),
    g;
  if (
    ...
    g = (t, n, r) => {
      let i = n === void 0 ? `` : n,
        ...
        o = h ? a : a.filter(q);
      x(d, j, {
        belowFreeformContent: (0, M.jsx)(`div`, {
          className: `text-sm text-token-description-foreground`,
          children: (0, M.jsx)(p, {
  ...
  return (
    t[14] !== y || t[15] !== f
      ? ((b = (0, M.jsxs)(M.Fragment, {
          children: [
            (0, M.jsx)(J, { rating: `thumbs_up`, selectedRating: f, onClick: y }),
            (0, M.jsx)(J, { rating: `thumbs_down`, selectedRating: f, onClick: y }),
          ],
        })),
        (t[14] = y),
        (t[15] = f),
...
function K(e) {
  (e.preventDefault(), c.dispatchMessage(`open-in-browser`, { url: z }));
}
function q(e) {
  return e.id !== B;
}
function J(e) {
  ...
  let d = n === `thumbs_down` ? `icon-xs rotate-180` : `icon-xs`,
    f;
  t[6] !== c || t[7] !== d
    ? ((f = (0, M.jsx)(c, { className: d })), (t[6] = c), (t[7] = d), (t[8] = f))
    : (f = t[8]);
  let p;
  ...
  return (
    t[14] !== s || t[15] !== p
      ? ((m = (0, M.jsx)(_, { tooltipContent: s, children: p })),
        (t[14] = s),
        (t[15] = p),
        (t[16] = m))
      : (m = t[16]),
...
function Z(e) {
  let t = (0, F.c)(92),
    ...
    S = u === void 0 ? `thread` : u,
    ne = d === void 0 ? !0 : d,
    [C, re] = (0, le.useState)(y),
    w = ee(),
    ie = i(te),
    ae = ne && n.completed,
    j;
  t[0] !== n.completed || t[1] !== n.content
    ? ((j = n.completed && n.content.trim().length > 0),
      (t[0] = n.completed),
      (t[1] = n.content),
      (t[2] = j))
    : (j = t[2]);
  ...
  t[3] !== n.completed || t[4] !== n.content
    ? ((P = n.completed && n.content.trim().length > 0),
      (t[3] = n.completed),
      (t[4] = n.content),
      (t[5] = P))
    : (P = t[5]);
  let ue = P,
    I = N && !0,
    de = ue && !0,
    fe = f != null && ie.submitCodexAnalyticsEvent != null,
    pe = fe && !1,
    me = fe && !0,
    L;
  t[6] === w
  ...
  t[14] === n.content
    ...
    : ((B = () => {
        ...
        ((r.href = t), (r.download = X), r.click(), URL.revokeObjectURL(t));
      }),
      (t[14] = n.content),
      (t[15] = B));
  let V = B,
    H;
  t[16] !== r || t[17] !== n.content || t[18] !== ie || t[19] !== f
    ? ((H = (e) => {
        (f != null &&
          ie.submitCodexAnalyticsEvent?.({
            action: `copy`,
            eventKind: `action`,
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = m(`text-token-foreground text-base font-semibold leading-tight`)), (t[21] = K))
    : (K = t[21]);
  let q;
  t[22] === n.completed
    ? (q = t[23])
  ...
  let J;
  t[24] !== G || t[25] !== q
    ? ((J = (0, M.jsx)(oe, { active: G, className: K, children: q })),
      (t[24] = G),
      (t[25] = q),
      (t[26] = J))
    : (J = t[26]);
                ...
                ue
                  ? (0, M.jsx)(_, {
                      ...
                      children: (0, M.jsx)(g, {
                        ...
                        children: (0, M.jsx)(D, { className: `icon-2xs` }),
                      }),
                    })
                  : null,
                N ? (0, M.jsx)(k, { iconOnly: !0, iconClassName: `icon-2xs`, onCopy: U }) : null,
                pe
                  ? (0, M.jsx)(W, { hasArtifacts: x, reportEntityType: S, threadId: r, turnId: f })
                  : null,
                (0, M.jsx)(_, {
                  tooltipContent: (0, M.jsx)(p, {
  ...
  let ve;
  t[44] !== U || t[45] !== I
    ? ((ve = I ? (0, M.jsx)(k, { iconOnly: !0, iconClassName: `icon-2xs`, onCopy: U }) : null),
      (t[44] = U),
      (t[45] = I),
      (t[46] = ve))
    : (ve = t[46]);
  let ye;
  t[47] !== r || t[48] !== x || t[49] !== S || t[50] !== me || t[51] !== f
    ? ((ye = me
        ? (0, M.jsx)(W, { hasArtifacts: x, reportEntityType: S, threadId: r, turnId: f })
        : null),
      (t[47] = r),
  ...
  t[55] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xe = () => {
      ...
      (t[55] = xe))
    : (xe = t[55]);
  let Se = C ? `rotate-180` : `rotate-0`,
    Ce;
  t[56] === Se
    ? (Ce = t[57])
    : ((Ce = m(`icon-2xs transition-transform`, Se)), (t[56] = Se), (t[57] = Ce));
  let we;
  t[58] === Ce
    ? (we = t[59])
    : ((we = (0, M.jsx)(E, { className: Ce })), (t[58] = Ce), (t[59] = we));
  let Te;
  t[60] !== ge || t[61] !== we
    ? ((Te = (0, M.jsx)(g, {
        color: `ghost`,
  ...
  let Ee;
  t[63] !== be || t[64] !== Te
    ? ((Ee = (0, M.jsx)(_, { tooltipContent: be, children: Te })),
      (t[63] = be),
      (t[64] = Te),
      (t[65] = Ee))
    : (Ee = t[65]);
  let De;
  t[66] !== Z || t[67] !== $ || t[68] !== ve || t[69] !== ye || t[70] !== Ee
    ? ((De = (0, M.jsxs)(`div`, {
        className: `flex items-center gap-1`,
        children: [Z, $, ve, ye, Ee],
      })),
  ...
  let je = !n.completed,
    Me;
  t[77] !== r || t[78] !== a || t[79] !== v || t[80] !== n.content || t[81] !== je
    ? ((Me = (0, M.jsx)(ce, {
        markdown: n.content,
        conversationId: r,
        hideCodeBlocks: v,
  ...
  return (
    t[89] !== Oe || t[90] !== Pe
      ? ((Fe = (0, M.jsxs)(A, { children: [Oe, Pe] })), (t[89] = Oe), (t[90] = Pe), (t[91] = Fe))
      : (Fe = t[91]),
    Fe
  );
}
