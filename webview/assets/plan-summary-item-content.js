...
import { _ as s, f as c, g as l, l as u, u as d } from "./vscode-api.js";
import { c as f, o as p, r as m } from "./lib.js";
import { c as h } from "./persisted-signal.js";
import { t as g } from "./clsx-Cir5-jBH.js";
import { t as _ } from "./proxy.js";
import { t as v } from "./button-DO-oxX3-.js";
import { t as y } from "./tooltip.js";
import { o as b } from "./statsig.js";
import { n as x } from "./request.js";
...
import { r as T, t as E } from "./modal-controller-state.js";
import { a as te, i as D, l as ne, n as O, o as re, r as ie } from "./dialog-layout.js";
import { t as k } from "./thinking-shimmer.js";
import { t as ae } from "./animations.js";
import { t as A } from "./copy-button.js";
import { t as oe } from "./arrow-top-right.js";
import { n as se, t as j } from "./markdown-surface.js";
import { t as M } from "./feedback-form-dialog.js";
var ce = e(t()),
  N = n(),
  P = (e) =>
    (0, N.jsxs)(`svg`, {
  ...
  I = r(),
  le = `codex-thread-report-reasons`;
function L(e) {
  let t = (0, I.c)(82),
  ...
  t[0] === i
    ? (u = t[1])
    : ((u = { queryKey: [le, i], queryFn: () => he(i), staleTime: d.ONE_MINUTE }),
      (t[0] = i),
      (t[1] = u));
  let m = s(u),
    h;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { mutationFn: ge }), (t[2] = h))
    : (h = t[2]);
  let g = l(h),
    [_, y] = (0, ce.useState)(``),
    [b, x] = (0, ce.useState)(null),
    S;
  t[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((S = []), (t[3] = S)) : (S = t[3]);
  let [C, ee] = (0, ce.useState)(S),
    w = C.length === 0 ? null : C[C.length - 1],
    T,
    E,
    k,
    ae,
    A;
  t[4] !== w?.details_placeholder ||
  t[5] !== w?.link_attachment ||
  t[6] !== w?.sub_reasons ||
  t[7] !== m.data?.reasons ||
  t[8] !== b
    ? ((A = w?.sub_reasons ?? m.data?.reasons ?? []),
      (k = A.find((e) => e.id === b) ?? null),
      (T = w?.details_placeholder != null),
      (E = w?.link_attachment != null),
      (ae = T || (k != null && me(k))),
      (t[4] = w?.details_placeholder),
      (t[5] = w?.link_attachment),
      (t[6] = w?.sub_reasons),
      ...
      (t[12] = ae),
      (t[13] = A))
    : ((T = t[9]), (E = t[10]), (k = t[11]), (ae = t[12]), (A = t[13]));
  let oe = ae,
    se = k == null || m.isPending || g.isPending,
    j = g.isSuccess || m.isError,
    M = !j && !oe && !E && se,
    P;
  t[14] === r
    ? (P = t[15])
  ...
  t[30] !== a
    ? ((V = (e) => {
        ...
        if (E && w?.link_attachment != null) {
          c.dispatchMessage(`open-in-browser`, { url: w.link_attachment });
          return;
        }
        if (T && w != null) {
          g.mutate({ details: _.trim(), entityType: i, reasonId: w.id, threadId: a });
          return;
        }
        if (k != null) {
          if (me(k)) {
            g.mutate({ details: ``, entityType: i, reasonId: k.id, threadId: a });
            return;
          }
          (ee((e) => [...e, k]), x(null), y(``));
        }
  ...
  t[32] === g.isSuccess
    ? (U = t[33])
    : ((U = (0, N.jsx)(de, { success: g.isSuccess })), (t[32] = g.isSuccess), (t[33] = U));
  let W;
  t[34] !== w || t[35] !== m.data || t[36] !== g.isSuccess
    ? ((W = z({ activeReason: w, reportReasons: m.data, isSuccess: g.isSuccess })),
      (t[34] = w),
      (t[35] = m.data),
      (t[36] = g.isSuccess),
      (t[37] = W))
  ...
  t[38] !== U || t[39] !== W
    ? ((G = (0, N.jsx)(te, {
        children: (0, N.jsx)(D, { title: U, subtitle: W, titleSize: `dialog` }),
      })),
      (t[38] = U),
      (t[39] = W),
      (t[40] = G))
              ...
              ? (0, N.jsxs)(re, {
                  ...
                  children: [
                    (0, N.jsx)(`textarea`, {
                      ...
                      placeholder: w.details_placeholder ?? void 0,
                    ...
                    w.subtext == null ? null : (0, N.jsx)(R, { children: w.subtext }),
                  ],
                })
              : E
                ? (0, N.jsx)(R, {
                ...
                : (0, N.jsx)(pe, { reasons: A, selectedReasonId: b, setSelectedReasonId: x })),
      (t[41] = w),
      (t[42] = _),
      (t[43] = o),
      (t[44] = T),
  ...
  let J;
  t[54] !== K || t[55] !== q
    ? ((J = (0, N.jsxs)(te, { children: [K, q] })), (t[54] = K), (t[55] = q), (t[56] = J))
    : (J = t[56]);
  let Y;
  t[57] !== w || t[58] !== B || t[59] !== n || t[60] !== g.isPending || t[61] !== g.isSuccess
    ? ((Y =
        (w != null || n != null) && !g.isSuccess
          ? (0, N.jsx)(v, {
              color: `secondary`,
    ...
    : (Y = t[62]);
  let X;
  t[63] !== E || t[64] !== oe || t[65] !== j
    ? ((X = (0, N.jsx)(fe, { close: j, isLinkStep: E, isSubmitStep: oe })),
      (t[63] = E),
      (t[64] = oe),
      (t[65] = j),
      (t[66] = X))
    : (X = t[66]);
  let Z;
  t[67] !== M || t[68] !== g.isPending || t[69] !== X
    ? ((Z = (0, N.jsx)(v, {
        color: `primary`,
        disabled: M,
        loading: g.isPending,
  ...
  let Q;
  t[71] !== Y || t[72] !== Z
    ? ((Q = (0, N.jsx)(te, { children: (0, N.jsxs)(ie, { children: [Y, Z] }) })),
      (t[71] = Y),
      (t[72] = Z),
      (t[73] = Q))
    : (Q = t[73]);
  let _e;
  t[74] !== H || t[75] !== G || t[76] !== J || t[77] !== Q
    ? ((_e = (0, N.jsxs)(O, { as: `form`, className: `gap-4`, onSubmit: H, children: [G, J, Q] })),
      (t[74] = H),
      (t[75] = G),
      (t[76] = J),
      (t[77] = Q),
  ...
  return (
    t[79] !== F || t[80] !== _e
      ? (($ = (0, N.jsx)(ne, { open: !0, onOpenChange: F, size: `wide`, children: _e })),
        (t[79] = F),
        (t[80] = _e),
        (t[81] = $))
      : ($ = t[81]),
...
function z({ activeReason: e, isSuccess: t, reportReasons: n }) {
...
async function he(e) {
  return (await u.getInstance().get(`/report_flow/reasons/${e}`, x())).body;
}
async function ge({ details: e, entityType: t, reasonId: n, threadId: r }) {
  await u
    .getInstance()
    .post(
      `/report_flow/report`,
...
var B = `https://help.openai.com/en/articles/5722486-how-your-data-is-used-to-improve-model-performance`,
  V = `safety_or_legal_concern`,
  H = m({
  ...
  U = {
    thumbs_down: [
      { id: `wrong_presentation_length`, label: H.wrongPresentationLength },
      { id: `poor_writing`, label: H.poorWriting },
      { id: `poor_style_format_or_visuals`, label: H.poorStyleFormatOrVisuals },
      { id: `wrong_topics_or_subtopics`, label: H.wrongTopicsOrSubtopics },
      { id: `didnt_follow_my_instructions`, label: H.didntFollowMyInstructions },
      { id: `didnt_follow_my_template`, label: H.didntFollowMyTemplate },
      { id: `incorrect_content`, label: H.incorrectContent },
      { id: V, label: H.safetyOrLegalConcern },
    ],
    thumbs_up: [
      { id: `good_content`, label: H.goodContent },
      { id: `good_writing_quality`, label: H.goodWritingQuality },
      { id: `good_style_format_or_visuals`, label: H.goodStyleFormatOrVisuals },
      { id: `followed_my_instructions_well`, label: H.followedMyInstructionsWell },
      { id: `generated_quickly`, label: H.generatedQuickly },
    ],
  },
  W = {
    thumbs_down: [
      { id: `incorrect_or_incomplete`, label: H.incorrectOrIncomplete },
      { id: `didnt_follow_my_instructions`, label: H.didntFollowMyInstructions },
      { id: `off_track_or_wrong_scope`, label: H.offTrackOrWrongScope },
      { id: `lost_context`, label: H.lostContext },
      { id: `slow_or_buggy`, label: H.slowOrBuggy },
      { id: V, label: H.safetyOrLegalConcern },
      { id: `other`, label: H.other },
    ],
    thumbs_up: [
      { id: `solved_my_task`, label: H.solvedMyTask },
      { id: `followed_my_instructions`, label: H.followedMyInstructions },
      { id: `good_code_or_output_quality`, label: H.goodCodeOrOutputQuality },
      { id: `fast_and_efficient`, label: H.fastAndEfficient },
      { id: `useful_autonomy`, label: H.usefulAutonomy },
      { id: `other`, label: H.other },
    ],
  };
function G(e) {
  ...
  if (
    ...
    v = (t, n, r) => {
      let i = n === void 0 ? `` : n,
        ...
        o = _ ? a : a.filter(J);
      T(d, M, {
        belowFreeformContent: (0, N.jsx)(`div`, {
          className: `text-sm text-token-description-foreground`,
          children: (0, N.jsx)(p, {
        ...
        onSubmit: (n) => {
          ...
          return g.submitCodexAnalyticsEvent?.({
  ...
  let y;
  t[8] !== v || t[9] !== g || t[10] !== f || t[11] !== s || t[12] !== c
    ? ((y = (e) => {
        if (f === e) {
          m(null);
          return;
  ...
  return (
    t[14] !== x || t[15] !== f
      ? ((S = (0, N.jsxs)(N.Fragment, {
          children: [
            (0, N.jsx)(Y, { rating: `thumbs_up`, selectedRating: f, onClick: x }),
            (0, N.jsx)(Y, { rating: `thumbs_down`, selectedRating: f, onClick: x }),
          ],
        })),
        (t[14] = x),
        (t[15] = f),
...
function q(e) {
  (e.preventDefault(), c.dispatchMessage(`open-in-browser`, { url: B }));
}
function J(e) {
  return e.id !== V;
}
function Y(e) {
  ...
  let d = n === `thumbs_down` ? `icon-xs rotate-180` : `icon-xs`,
    p;
  t[6] !== c || t[7] !== d
    ? ((p = (0, N.jsx)(c, { className: d })), (t[6] = c), (t[7] = d), (t[8] = p))
    : (p = t[8]);
  let m;
  t[9] !== s || t[10] !== l || t[11] !== u || t[12] !== p
    ? ((m = (0, N.jsx)(v, {
        color: `ghost`,
        size: `icon`,
        "aria-pressed": l,
  ...
  return (
    t[14] !== s || t[15] !== m
      ? ((h = (0, N.jsx)(y, { tooltipContent: s, children: m })),
        (t[14] = s),
        (t[15] = m),
        (t[16] = h))
      : (h = t[16]),
...
function Q(e) {
  let t = (0, I.c)(92),
    ...
    E = u === void 0 ? `thread` : u,
    te = d === void 0 ? !0 : d,
    [D, ne] = (0, ce.useState)(x),
    O = f(),
    re = a(h),
    ie = te && n.completed,
    M;
  t[0] !== n.completed || t[1] !== n.content
    ? ((M = n.completed && n.content.trim().length > 0),
      (t[0] = n.completed),
      (t[1] = n.content),
      (t[2] = M))
    : (M = t[2]);
  ...
  t[3] !== n.completed || t[4] !== n.content
    ? ((F = n.completed && n.content.trim().length > 0),
      (t[3] = n.completed),
      (t[4] = n.content),
      (t[5] = F))
    : (F = t[5]);
  let le = F,
    L = P && !0,
    ue = le && !0,
    de = m != null && re.submitCodexAnalyticsEvent != null,
    fe = de && !1,
    pe = de && !0,
    R;
  t[6] === O
  ...
  t[14] === n.content
    ...
    : ((V = () => {
        ...
        ((r.href = t), (r.download = Z), r.click(), URL.revokeObjectURL(t));
      }),
      (t[14] = n.content),
      (t[15] = V));
  let H = V,
    U;
  t[16] !== r || t[17] !== n.content || t[18] !== re || t[19] !== m
    ? ((U = (e) => {
        (m != null &&
          re.submitCodexAnalyticsEvent?.({
            action: `copy`,
            eventKind: `action`,
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = g(`text-token-foreground text-base font-semibold leading-tight`)), (t[21] = q))
    : (q = t[21]);
  let J;
  t[22] === n.completed
    ? (J = t[23])
  ...
  let Y;
  t[24] !== K || t[25] !== J
    ? ((Y = (0, N.jsx)(k, { active: K, className: q, children: J })),
      (t[24] = K),
      (t[25] = J),
      (t[26] = Y))
    : (Y = t[26]);
                ...
                le
                  ? (0, N.jsx)(y, {
                      ...
                      children: (0, N.jsx)(v, {
                        ...
                        children: (0, N.jsx)(C, { className: `icon-2xs` }),
                      }),
                    })
                  : null,
                P ? (0, N.jsx)(A, { iconOnly: !0, iconClassName: `icon-2xs`, onCopy: W }) : null,
                fe
                  ? (0, N.jsx)(G, { hasArtifacts: T, reportEntityType: E, threadId: r, turnId: m })
                  : null,
                (0, N.jsx)(y, {
                  tooltipContent: (0, N.jsx)(p, {
  ...
  let ve;
  t[44] !== W || t[45] !== L
    ? ((ve = L ? (0, N.jsx)(A, { iconOnly: !0, iconClassName: `icon-2xs`, onCopy: W }) : null),
      (t[44] = W),
      (t[45] = L),
      (t[46] = ve))
    : (ve = t[46]);
  let ye;
  t[47] !== r || t[48] !== T || t[49] !== E || t[50] !== pe || t[51] !== m
    ? ((ye = pe
        ? (0, N.jsx)(G, { hasArtifacts: T, reportEntityType: E, threadId: r, turnId: m })
        : null),
      (t[47] = r),
  ...
  t[55] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xe = () => {
      ...
      (t[55] = xe))
    : (xe = t[55]);
  let Se = D ? `rotate-180` : `rotate-0`,
    Ce;
  t[56] === Se
    ? (Ce = t[57])
    : ((Ce = g(`icon-2xs transition-transform`, Se)), (t[56] = Se), (t[57] = Ce));
  let we;
  t[58] === Ce
    ? (we = t[59])
    : ((we = (0, N.jsx)(S, { className: Ce })), (t[58] = Ce), (t[59] = we));
  let Te;
  t[60] !== he || t[61] !== we
    ? ((Te = (0, N.jsx)(v, {
        color: `ghost`,
  ...
  let Ee;
  t[63] !== be || t[64] !== Te
    ? ((Ee = (0, N.jsx)(y, { tooltipContent: be, children: Te })),
      (t[63] = be),
      (t[64] = Te),
      (t[65] = Ee))
    : (Ee = t[65]);
  let De;
  t[66] !== Q || t[67] !== $ || t[68] !== ve || t[69] !== ye || t[70] !== Ee
    ? ((De = (0, N.jsxs)(`div`, {
        className: `flex items-center gap-1`,
        children: [Q, $, ve, ye, Ee],
      })),
  ...
  let je = !n.completed,
    Me;
  t[77] !== r || t[78] !== i || t[79] !== b || t[80] !== n.content || t[81] !== je
    ? ((Me = (0, N.jsx)(se, {
        markdown: n.content,
        conversationId: r,
        hideCodeBlocks: b,
  ...
  return (
    t[89] !== Oe || t[90] !== Pe
      ? ((Fe = (0, N.jsxs)(j, { children: [Oe, Pe] })), (t[89] = Oe), (t[90] = Pe), (t[91] = Fe))
      : (Fe = t[91]),
    Fe
  );
}
