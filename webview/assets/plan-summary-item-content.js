...
import { _ as s, f as c, l, u, v as d } from "./vscode-api.js";
import { i as f, l as ee, s as p } from "./lib-1.js";
...
import { n as y } from "./request.js";
import { t as b } from "./chevron.js";
import { r as te } from "./product-logger.js";
import { t as x } from "./download.js";
import { t as ne } from "./with-window.js";
import { t as S } from "./copy-to-clipboard.js";
import { r as C, t as w } from "./modal-controller-state.js";
import { a as re, i as T, l as ie, n as E, o as ae, r as oe } from "./dialog-layout.js";
import { t as D } from "./thinking-shimmer.js";
import { t as se } from "./animations.js";
import { t as O } from "./copy-button.js";
import { t as ce } from "./arrow-top-right.js";
import { n as le, t as k } from "./markdown-surface.js";
import { t as A } from "./feedback-form-dialog-U7w-wHRu.js";
var ue = e(t()),
  j = n(),
  M = (e) =>
    (0, j.jsxs)(`svg`, {
  ...
  P = r(),
  de = `codex-thread-report-reasons`;
function F(e) {
  let t = (0, P.c)(82),
  ...
  t[0] === i
    ? (l = t[1])
    : ((l = { queryKey: [de, i], queryFn: () => _e(i), staleTime: u.ONE_MINUTE }),
      (t[0] = i),
      (t[1] = l));
  let f = d(l),
    m;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = { mutationFn: ve }), (t[2] = m))
    : (m = t[2]);
  let h = s(m),
    [_, v] = (0, ue.useState)(``),
    [y, b] = (0, ue.useState)(null),
    te;
  t[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((te = []), (t[3] = te)) : (te = t[3]);
  let [x, ne] = (0, ue.useState)(te),
    S = x.length === 0 ? null : x[x.length - 1],
    C,
    w,
    D,
    se,
    O;
  t[4] !== S?.details_placeholder ||
  t[5] !== S?.link_attachment ||
  t[6] !== S?.sub_reasons ||
  t[7] !== f.data?.reasons ||
  t[8] !== y
    ? ((O = S?.sub_reasons ?? f.data?.reasons ?? []),
      (D = O.find((e) => e.id === y) ?? null),
      (C = S?.details_placeholder != null),
      (w = S?.link_attachment != null),
      (se = C || (D != null && ge(D))),
      (t[4] = S?.details_placeholder),
      (t[5] = S?.link_attachment),
      (t[6] = S?.sub_reasons),
      ...
      (t[12] = se),
      (t[13] = O))
    : ((C = t[9]), (w = t[10]), (D = t[11]), (se = t[12]), (O = t[13]));
  let ce = se,
    le = D == null || f.isPending || h.isPending,
    k = h.isSuccess || f.isError,
    A = !k && !ce && !w && le,
    M;
  t[14] === r
    ? (M = t[15])
  ...
  t[30] !== a
    ? ((z = (e) => {
        ...
        if (w && S?.link_attachment != null) {
          c.dispatchMessage(`open-in-browser`, { url: S.link_attachment });
          return;
        }
        if (C && S != null) {
          h.mutate({ details: _.trim(), entityType: i, reasonId: S.id, threadId: a });
          return;
        }
        if (D != null) {
          if (ge(D)) {
            h.mutate({ details: ``, entityType: i, reasonId: D.id, threadId: a });
            return;
          }
          (ne((e) => [...e, D]), b(null), v(``));
        }
  ...
  t[32] === h.isSuccess
    ? (V = t[33])
    : ((V = (0, j.jsx)(pe, { success: h.isSuccess })), (t[32] = h.isSuccess), (t[33] = V));
  let H;
  t[34] !== S || t[35] !== f.data || t[36] !== h.isSuccess
    ? ((H = L({ activeReason: S, reportReasons: f.data, isSuccess: h.isSuccess })),
      (t[34] = S),
      (t[35] = f.data),
      (t[36] = h.isSuccess),
      (t[37] = H))
  ...
  t[38] !== V || t[39] !== H
    ? ((U = (0, j.jsx)(re, {
        children: (0, j.jsx)(T, { title: V, subtitle: H, titleSize: `dialog` }),
      })),
      (t[38] = V),
      (t[39] = H),
      (t[40] = U))
              ...
              ? (0, j.jsxs)(ae, {
                  ...
                  children: [
                    (0, j.jsx)(`textarea`, {
                      ...
                      placeholder: S.details_placeholder ?? void 0,
                    ...
                    S.subtext == null ? null : (0, j.jsx)(I, { children: S.subtext }),
                  ],
                })
              : w
                ? (0, j.jsx)(I, {
                ...
                : (0, j.jsx)(he, { reasons: O, selectedReasonId: y, setSelectedReasonId: b })),
      (t[41] = S),
      (t[42] = _),
      (t[43] = o),
      (t[44] = C),
  ...
  let K;
  t[54] !== W || t[55] !== G
    ? ((K = (0, j.jsxs)(re, { children: [W, G] })), (t[54] = W), (t[55] = G), (t[56] = K))
    : (K = t[56]);
  let q;
  t[57] !== S || t[58] !== R || t[59] !== n || t[60] !== h.isPending || t[61] !== h.isSuccess
    ? ((q =
        (S != null || n != null) && !h.isSuccess
          ? (0, j.jsx)(g, {
              color: `secondary`,
    ...
    : (q = t[62]);
  let J;
  t[63] !== w || t[64] !== ce || t[65] !== k
    ? ((J = (0, j.jsx)(me, { close: k, isLinkStep: w, isSubmitStep: ce })),
      (t[63] = w),
      (t[64] = ce),
      (t[65] = k),
      (t[66] = J))
    : (J = t[66]);
  let Y;
  t[67] !== A || t[68] !== h.isPending || t[69] !== J
    ? ((Y = (0, j.jsx)(g, {
        color: `primary`,
        disabled: A,
        loading: h.isPending,
  ...
  let X;
  t[71] !== q || t[72] !== Y
    ? ((X = (0, j.jsx)(re, { children: (0, j.jsxs)(oe, { children: [q, Y] }) })),
      (t[71] = q),
      (t[72] = Y),
      (t[73] = X))
    : (X = t[73]);
  let Z;
  t[74] !== B || t[75] !== U || t[76] !== K || t[77] !== X
    ? ((Z = (0, j.jsxs)(E, { as: `form`, className: `gap-4`, onSubmit: B, children: [U, K, X] })),
      (t[74] = B),
      (t[75] = U),
      (t[76] = K),
      (t[77] = X),
  ...
  return (
    t[79] !== N || t[80] !== Z
      ? ((Q = (0, j.jsx)(ie, { open: !0, onOpenChange: N, size: `wide`, children: Z })),
        (t[79] = N),
        (t[80] = Z),
        (t[81] = Q))
      : (Q = t[81]),
...
function he(e) {
  let t = (0, P.c)(12),
    { reasons: n, selectedReasonId: r, setSelectedReasonId: i } = e,
    a = ee(),
    o;
  t[0] === a
    ? (o = t[1])
...
function L({ activeReason: e, isSuccess: t, reportReasons: n }) {
  return t ? null : e == null ? (n?.header_explanation ?? n?.header ?? null) : e.cta;
}
function ge(e) {
  return (
...
async function _e(e) {
  return (await l.getInstance().get(`/report_flow/reasons/${e}`, y())).body;
}
async function ve({ details: e, entityType: t, reasonId: n, threadId: r }) {
  await l
    .getInstance()
    .post(
      `/report_flow/report`,
...
var R = `https://help.openai.com/en/articles/5722486-how-your-data-is-used-to-improve-model-performance`,
  z = `safety_or_legal_concern`,
  B = f({
  ...
  V = {
    thumbs_down: [
      { id: `wrong_presentation_length`, label: B.wrongPresentationLength },
      { id: `poor_writing`, label: B.poorWriting },
      { id: `poor_style_format_or_visuals`, label: B.poorStyleFormatOrVisuals },
      { id: `wrong_topics_or_subtopics`, label: B.wrongTopicsOrSubtopics },
      { id: `didnt_follow_my_instructions`, label: B.didntFollowMyInstructions },
      { id: `didnt_follow_my_template`, label: B.didntFollowMyTemplate },
      { id: `incorrect_content`, label: B.incorrectContent },
      { id: z, label: B.safetyOrLegalConcern },
    ],
    thumbs_up: [
      { id: `good_content`, label: B.goodContent },
      { id: `good_writing_quality`, label: B.goodWritingQuality },
      { id: `good_style_format_or_visuals`, label: B.goodStyleFormatOrVisuals },
      { id: `followed_my_instructions_well`, label: B.followedMyInstructionsWell },
      { id: `generated_quickly`, label: B.generatedQuickly },
    ],
  },
  H = {
    thumbs_down: [
      { id: `incorrect_or_incomplete`, label: B.incorrectOrIncomplete },
      { id: `didnt_follow_my_instructions`, label: B.didntFollowMyInstructions },
      { id: `off_track_or_wrong_scope`, label: B.offTrackOrWrongScope },
      { id: `lost_context`, label: B.lostContext },
      { id: `slow_or_buggy`, label: B.slowOrBuggy },
      { id: z, label: B.safetyOrLegalConcern },
      { id: `other`, label: B.other },
    ],
    thumbs_up: [
      { id: `solved_my_task`, label: B.solvedMyTask },
      { id: `followed_my_instructions`, label: B.followedMyInstructions },
      { id: `good_code_or_output_quality`, label: B.goodCodeOrOutputQuality },
      { id: `fast_and_efficient`, label: B.fastAndEfficient },
      { id: `useful_autonomy`, label: B.usefulAutonomy },
      { id: `other`, label: B.other },
    ],
  };
function U(e) {
  let t = (0, P.c)(17),
    { hasArtifacts: n, reportEntityType: r, threadId: s, turnId: c } = e,
    l = n === void 0 ? !1 : n,
    u = r === void 0 ? `thread` : r,
    d = i(o),
    [f, ee] = (0, ue.useState)(null),
    m = a(te),
    h = v(`584954669`),
    g;
  if (
    ...
    g = (t, n, r) => {
      let i = n === void 0 ? `` : n,
        ...
        o = h ? a : a.filter(K);
      C(d, A, {
        belowFreeformContent: (0, j.jsx)(`div`, {
          className: `text-sm text-token-description-foreground`,
          children: (0, j.jsx)(p, {
        ...
        onSubmit: (n) => {
          ...
          return m.submitCodexAnalyticsEvent?.({
            ...
            threadId: s,
            turnId: c,
            metadata: { details: r, has_artifacts: l, selected_option: i },
          });
        },
        options: o,
      });
  ...
  let _;
  t[8] !== g || t[9] !== m || t[10] !== f || t[11] !== s || t[12] !== c
    ? ((_ = (e) => {
        if (f === e) {
          ee(null);
          return;
  ...
  return (
    t[14] !== y || t[15] !== f
      ? ((b = (0, j.jsxs)(j.Fragment, {
          children: [
            (0, j.jsx)(q, { rating: `thumbs_up`, selectedRating: f, onClick: y }),
            (0, j.jsx)(q, { rating: `thumbs_down`, selectedRating: f, onClick: y }),
          ],
        })),
        (t[14] = y),
        (t[15] = f),
...
function G(e) {
  (e.preventDefault(), c.dispatchMessage(`open-in-browser`, { url: R }));
}
function K(e) {
  return e.id !== z;
}
function q(e) {
  ...
  let d = n === `thumbs_down` ? `icon-xs rotate-180` : `icon-xs`,
    f;
  t[6] !== c || t[7] !== d
    ? ((f = (0, j.jsx)(c, { className: d })), (t[6] = c), (t[7] = d), (t[8] = f))
    : (f = t[8]);
  let p;
  ...
  return (
    t[14] !== s || t[15] !== p
      ? ((m = (0, j.jsx)(_, { tooltipContent: s, children: p })),
        (t[14] = s),
        (t[15] = p),
        (t[16] = m))
      : (m = t[16]),
...
function X(e) {
  let t = (0, P.c)(92),
    ...
    w = u === void 0 ? `thread` : u,
    re = d === void 0 ? !0 : d,
    [T, ie] = (0, ue.useState)(y),
    E = ee(),
    ae = a(te),
    oe = re && n.completed,
    A;
  t[0] !== n.completed || t[1] !== n.content
    ? ((A = n.completed && n.content.trim().length > 0),
      (t[0] = n.completed),
      (t[1] = n.content),
      (t[2] = A))
    : (A = t[2]);
  ...
  t[3] !== n.completed || t[4] !== n.content
    ? ((N = n.completed && n.content.trim().length > 0),
      (t[3] = n.completed),
      (t[4] = n.content),
      (t[5] = N))
    : (N = t[5]);
  let de = N,
    F = M && !0,
    fe = de && !0,
    pe = f != null && ae.submitCodexAnalyticsEvent != null,
    me = pe && !1,
    he = pe && !0,
    I;
  t[6] === E
  ...
  let _e = ge,
    ve;
  t[11] !== r || t[12] !== n.content
    ? ((ve = () => {
        c.dispatchMessage(`show-plan-summary`, { planContent: n.content, conversationId: r });
      }),
      (t[11] = r),
      (t[12] = n.content),
      (t[13] = ve))
  ...
  t[14] === n.content
    ...
    : ((z = () => {
        ...
        ((r.href = t), (r.download = Y), r.click(), URL.revokeObjectURL(t));
      }),
      (t[14] = n.content),
      (t[15] = z));
  let B = z,
    V;
  t[16] !== r || t[17] !== n.content || t[18] !== ae || t[19] !== f
    ? ((V = (e) => {
        (f != null &&
          ae.submitCodexAnalyticsEvent?.({
            action: `copy`,
            eventKind: `action`,
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = m(`text-token-foreground text-base font-semibold leading-tight`)), (t[21] = G))
    : (G = t[21]);
  let K;
  t[22] === n.completed
    ? (K = t[23])
  ...
  let q;
  t[24] !== W || t[25] !== K
    ? ((q = (0, j.jsx)(D, { active: W, className: G, children: K })),
      (t[24] = W),
      (t[25] = K),
      (t[26] = q))
    : (q = t[26]);
                ...
                de
                  ? (0, j.jsx)(_, {
                      ...
                      children: (0, j.jsx)(g, {
                        ...
                        children: (0, j.jsx)(x, { className: `icon-2xs` }),
                      }),
                    })
                  : null,
                M ? (0, j.jsx)(O, { iconOnly: !0, iconClassName: `icon-2xs`, onCopy: H }) : null,
                me
                  ? (0, j.jsx)(U, { hasArtifacts: C, reportEntityType: w, threadId: r, turnId: f })
                  : null,
                (0, j.jsx)(_, {
  ...
  let ye;
  t[44] !== H || t[45] !== F
    ? ((ye = F ? (0, j.jsx)(O, { iconOnly: !0, iconClassName: `icon-2xs`, onCopy: H }) : null),
      (t[44] = H),
      (t[45] = F),
      (t[46] = ye))
    : (ye = t[46]);
  let be;
  t[47] !== r || t[48] !== C || t[49] !== w || t[50] !== he || t[51] !== f
    ? ((be = he
        ? (0, j.jsx)(U, { hasArtifacts: C, reportEntityType: w, threadId: r, turnId: f })
        : null),
      (t[47] = r),
  ...
  t[55] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = () => {
      ...
      (t[55] = Se))
    : (Se = t[55]);
  let Ce = T ? `rotate-180` : `rotate-0`,
    we;
  t[56] === Ce
    ? (we = t[57])
    : ((we = m(`icon-2xs transition-transform`, Ce)), (t[56] = Ce), (t[57] = we));
  let Te;
  t[58] === we
    ? (Te = t[59])
    : ((Te = (0, j.jsx)(b, { className: we })), (t[58] = we), (t[59] = Te));
  let Ee;
  t[60] !== _e || t[61] !== Te
    ? ((Ee = (0, j.jsx)(g, {
        color: `ghost`,
  ...
  let De;
  t[63] !== xe || t[64] !== Ee
    ? ((De = (0, j.jsx)(_, { tooltipContent: xe, children: Ee })),
      (t[63] = xe),
      (t[64] = Ee),
      (t[65] = De))
    : (De = t[65]);
  let $;
  t[66] !== X || t[67] !== Q || t[68] !== ye || t[69] !== be || t[70] !== De
    ? (($ = (0, j.jsxs)(`div`, {
        className: `flex items-center gap-1`,
        children: [X, Q, ye, be, De],
      })),
      (t[66] = X),
      (t[67] = Q),
      (t[68] = ye),
  ...
  let ke = T ? J : `auto`,
    Ae;
  t[75] === ke ? (Ae = t[76]) : ((Ae = { height: ke }), (t[75] = ke), (t[76] = Ae));
  let je = !n.completed,
    Me;
  t[77] !== r || t[78] !== i || t[79] !== v || t[80] !== n.content || t[81] !== je
    ? ((Me = (0, j.jsx)(le, {
        markdown: n.content,
        conversationId: r,
        hideCodeBlocks: v,
  ...
  return (
    t[89] !== Oe || t[90] !== Pe
      ? ((Fe = (0, j.jsxs)(k, { children: [Oe, Pe] })), (t[89] = Oe), (t[90] = Pe), (t[91] = Fe))
      : (Fe = t[91]),
    Fe
  );
}
