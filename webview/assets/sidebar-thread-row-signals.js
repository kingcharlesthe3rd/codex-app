...
import { r as o, xr as s } from "./src-4.js";
import {
  Ao as c,
  Cn as l,
  En as u,
...
import { A as y, O as b, S as x, m as S } from "./open-project-setup-dialog.js";
...
function N({ chatLabel: e, task: t, projectLabelByThreadKey: n, projectlessThreadIds: r }) {
  ...
  if (
    ...
    return e;
  if (t.kind === `local`) return (t.conversation.cwd ? c(t.conversation.cwd) : ``) || e;
...
var ee = [],
  ...
  R = i(r, `inbox-items`, {
    params: { limit: 200 },
    refetchInterval: a.ONE_MINUTE,
    staleTime: a.FIVE_SECONDS,
  }),
  z = t(r, ({ get: e }) => e(C).data?.threadIds ?? L),
  B = t(r, ({ get: e }) => {
    let t = e(R).data;
    return { ...Q(t?.items ?? ee), unreadRunCount: t?.unreadRunCounts.total ?? 0 };
  }),
  V = t(r, ({ get: e }) => {
    let t = h(e, s.THREAD_PROJECT_ASSIGNMENTS),
      n = h(e, s.PROJECTLESS_THREAD_IDS);
    return e(S, {
      threadKeys: e(b),
      enabled: !0,
  ...
  U = n(r, (e, { get: t }) => {
    ...
    switch (n?.kind) {
      case `pending-worktree`:
        return t(x, n.pendingWorktreeId)?.isPinned === !0;
      case `local`:
      case `remote`: {
        let n = l(e);
  ...
  K = n(r, (e, { get: t }) => {
    ...
    let r = h(t, s.PROJECTLESS_THREAD_IDS);
    return N({
  ...
  Y = n(r, (e, { get: t }) => {
    ...
    return n?.kind === `local`
      ? o({
          ...
          assignment: h(t, s.THREAD_PROJECT_ASSIGNMENTS)?.[n.conversation.id],
        })
      : null;
  }),
  X = n(r, (e, { get: t }) =>
    e == null ? null : (h(t, s.THREAD_WORKSPACE_ROOT_HINTS)?.[e] ?? null),
  ),
  Z = n(r, (e, { get: t }) =>
    e == null ? null : (h(t, s.SIDEBAR_THREAD_METADATA)?.[e]?.labelColor ?? null),
  );
function Q(e) {
  let t = new Set(),
    n = new Map();
...
function $(e, t) {
  ...
  let r = e(m, t);
  return r == null ? !1 : r === 0 ? n === `resuming` : e(f, t) === `inProgress`;
}
export {
  k as C,
  O as S,
