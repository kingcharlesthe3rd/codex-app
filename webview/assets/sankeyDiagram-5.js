...
import { t as n } from "./ordinal.js";
import { Y as r } from "./runtime.worker-2.js";
import {
  B as i,
  C as a,
  K as o,
...
function S(e) {
  return e.targetLinks.length ? e.depth : e.sourceLinks.length ? g(e.sourceLinks, v) - 1 : 0;
}
function C(e) {
  return function () {
    return e;
...
function N() {
  let e = 0,
    ...
    p = 6;
  function m() {
    let e = { nodes: d.apply(null, arguments), links: f.apply(null, arguments) };
  ...
  ((m.update = function (e) {
    ...
    (m.nodeId = function (e) {
      return arguments.length ? ((s = typeof e == `function` ? e : C(e)), m) : s;
    }),
    (m.nodeAlign = function (e) {
      return arguments.length ? ((c = typeof e == `function` ? e : C(e)), m) : c;
    }),
    ...
    (m.nodes = function (e) {
      return arguments.length ? ((d = typeof e == `function` ? e : C(e)), m) : d;
    }),
    (m.links = function (e) {
      return arguments.length ? ((f = typeof e == `function` ? e : C(e)), m) : f;
    }),
  ...
  function y({ nodes: e }) {
    for (let t of e)
      t.value =
        t.fixedValue === void 0 ? Math.max(_(t.sourceLinks, D), _(t.targetLinks, D)) : t.fixedValue;
  }
  function b({ nodes: e }) {
    let t = e.length,
      n = new Set(e),
  ...
  function H(e) {
    if (u === void 0) for (let { sourceLinks: t, targetLinks: n } of e) (t.sort(T), n.sort(w));
  }
  function U(e, t) {
...
R.prototype = z.prototype = {
  ...
  bezierCurveTo: function (e, t, n, r, i, a) {
    this._ +=
      `C` + +e + `,` + +t + `,` + +n + `,` + +r + `,` + (this._x1 = +i) + `,` + (this._y1 = +a);
  },
    ...
    if (this._x1 === null) this._ += `M` + (this._x1 = e) + `,` + (this._y1 = t);
      ...
      if (!(Math.abs(u * s - c * l) > I) || !i)
        ...
        var f = n - a,
          ...
          y = v / _,
          b = v / g;
        (Math.abs(y - 1) > I && (this._ += `L` + (e + y * l) + `,` + (t + y * u)),
          (this._ +=
            `A` +
            i +
            `,` +
  ...
  arc: function (e, t, n, r, i, a) {
    ...
    (this._x1 === null
      ? (this._ += `M` + c + `,` + l)
      : (Math.abs(this._x1 - c) > I || Math.abs(this._y1 - l) > I) && (this._ += `L` + c + `,` + l),
      n &&
        (d < 0 && (d = (d % F) + F),
        d > L
          ? (this._ +=
  ...
  le = {
    ...
    getGraph: e(
      () => ({
        ...
        links: Y.map((e) => ({ source: e.source.ID, target: e.target.ID, value: e.value })),
      }),
      `getGraph`,
    ),
    addLink: se,
...
//# sourceMappingURL=sankeyDiagram-5.js.map
