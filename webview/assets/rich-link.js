import { t as e } from "./external-link-source-8ZO-FxHp.js";
function t(e) {
  let t = e.trim();
...
function n(n) {
  ...
  let a = new URL(r),
    o = e(r);
  return o == null ? null : { displayText: i(r, a, o), href: r, sourceAppId: o.appId };
}
function r({ displayText: t, href: n }) {
  let r;
  try {
    r = new URL(n);
  } catch {
  ...
  let i = e(n);
  return i == null ? null : { displayText: t, href: n, sourceAppId: i.appId };
}
function i(e, t, n) {
  switch (n.appId) {
    case `figma`:
...
function o(e) {
  let t = c(e);
  return t == null ? null : u(t.replace(/-[a-f0-9]{32}$/iu, ``));
}
function s(e) {
  let t = c(e);
