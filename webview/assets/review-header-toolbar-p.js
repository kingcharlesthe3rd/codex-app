...
import { k as o, r as s, s as c } from "./vscode-api.js";
import { La as l, Ra as u, Va as d } from "./app-server-manager-signals.js";
import { c as f, o as p } from "./lib-1.js";
...
import { t as y } from "./check-circle-filled.js";
import { t as b } from "./clock.js";
import { t as x } from "./warning.js";
import { t as S } from "./route-scope.js";
import { J as C, r as w } from "./review-navigation-model.js";
import { n as T, t as E } from "./json-1.js";
import { t as D } from "./image-square.js";
import { r as O, t as k } from "./dropdown.js";
import { t as A } from "./three-dots.js";
import { t as j } from "./unselected-circle.js";
import { n as M, t as N } from "./comment.js";
import { n as P, r as F } from "./code-snippet-Bu-o-Ykd.js";
import { p as I } from "./use-diff-annotations.js";
import { t as L } from "./pull-request-open.js";
import { t as R } from "./regenerate.js";
import { t as z } from "./score-query-match.js";
import { n as B, t as V } from "./diff-unified.js";
import { t as H } from "./middle-truncated-text.js";
import { t as U } from "./document-search.js";
var W = n(),
  G = 5.75,
  K = 2 * Math.PI * G,
  q = 1.5;
function J({ className: e = `icon-sm shrink-0`, checks: t }) {
  let n = ee(t),
    r = m(`text-token-description-foreground`, e);
  if (n.length === 0) return (0, W.jsx)(j, { className: r });
  let i = n.length > 1 ? q : 0,
    a = 0;
  return (0, W.jsx)(`svg`, {
    "aria-hidden": !0,
    className: r,
...
var Y = e(t()),
  ...
  X = r(),
  re = `flex items-center gap-2 px-[var(--padding-row-x)] py-[var(--padding-row-y)]`,
  ie = `min-w-0 truncate text-sm`;
function ae(e) {
  let t = (0, X.c)(5),
  ...
  return (
    t[2] !== r || t[3] !== i
      ? ((a = (0, W.jsx)(`span`, { className: i, children: r })),
        (t[2] = r),
        (t[3] = i),
        (t[4] = a))
      : (a = t[4]),
...
function oe(e) {
  ...
  t[4] === a
    ? (c = t[5])
    : ((c = a == null ? null : (0, W.jsx)(`span`, { className: `shrink-0`, children: a })),
      (t[4] = a),
      (t[5] = c));
  let l;
  return (
...
function se(e) {
  ...
  t[0] === o
    ...
    : ((c =
        o?.kind === `icon`
          ? (0, W.jsx)(`span`, { className: `shrink-0 text-token-text-tertiary`, children: o.icon })
          : o?.kind === `pill`
            ? (0, W.jsx)(ae, { label: o.label })
            : o?.kind === `text`
              ? (0, W.jsx)(`span`, {
  ...
  t[2] === i
    ? (u = t[3])
    : ((u = (0, W.jsx)(`span`, { className: `shrink-0`, children: i })), (t[2] = i), (t[3] = u));
  let d;
  t[4] === a
    ? (d = t[5])
    : ((d = (0, W.jsx)(`span`, {
...
function ce(e) {
  ...
  t[0] === i
    ? (o = t[1])
    : ((o = (0, W.jsx)(O.SectionLabel, { children: i })), (t[0] = i), (t[1] = o));
  let s;
  t[2] === r
    ? (s = t[3])
    : ((s = (0, W.jsx)(`div`, {
        className: `flex max-h-[104px] flex-col overflow-y-auto`,
        children: (0, W.jsx)(le, { groups: r }),
      })),
      (t[2] = r),
      (t[3] = s));
  let c;
  t[4] !== o || t[5] !== s
    ? ((c = (0, W.jsxs)(`div`, { className: `flex flex-col`, children: [o, s] })),
      (t[4] = o),
      (t[5] = s),
      (t[6] = c))
    : (c = t[6]);
  ...
  return (
    t[7] !== a || t[8] !== c
      ? ((l = (0, W.jsx)(`div`, { className: a, children: c })), (t[7] = a), (t[8] = c), (t[9] = l))
      : (l = t[9]),
    l
  );
}
function le(e) {
  let t = (0, X.c)(4),
    { groups: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = n.flatMap(de).map(ue)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, W.jsx)(W.Fragment, { children: r })), (t[2] = r), (t[3] = i)),
    i
  );
}
function ue(e, t) {
  return (0, W.jsx)(fe, { item: e }, t);
}
function de(e) {
  return e.items;
}
function fe(e) {
  ...
  let a = r && `group-hover:underline`,
    o;
  t[2] === a ? (o = t[3]) : ((o = m(ie, `text-token-foreground`, a)), (t[2] = a), (t[3] = o));
  let s;
  t[4] !== n.label || t[5] !== o
    ? ((s = (0, W.jsx)(`span`, { className: o, children: n.label })),
      (t[4] = n.label),
      (t[5] = o),
      (t[6] = s))
    : (s = t[6]);
  ...
  t[7] === n.description
    ...
    : ((c =
        n.description == null
          ? null
          : (0, W.jsx)(`span`, {
              className: m(ie, `text-token-description-foreground`),
  ...
  if (!r) {
    ...
    return (
      t[20] === p
        ? (e = t[21])
        : ((e = (0, W.jsx)(`div`, { className: re, children: p })), (t[20] = p), (t[21] = e)),
      e
    );
  }
  let h;
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = m(re, `group w-full cursor-interaction text-left`)), (t[22] = h))
    : (h = t[22]);
  let g;
  return (
    t[23] !== p || t[24] !== n.onSelect
      ? ((g = (0, W.jsx)(`button`, {
          className: h,
          onClick: n.onSelect,
          type: `button`,
...
function pe(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i) {
    ...
    ((c = `max-w-[220px]`),
      ...
      t[7] === i
        ? (o = t[8])
        : ((o = (0, W.jsx)(O.SectionLabel, { children: i })), (t[7] = i), (t[8] = o)),
      (s =
        e.length === 0
          ? (0, W.jsx)(O.Message, { compact: !0, children: n })
          : (0, W.jsx)(`div`, {
              className: `flex max-h-[104px] flex-col overflow-y-auto`,
              children: e.map(me),
            })),
  ...
  let l;
  t[9] !== a || t[10] !== o || t[11] !== s
    ? ((l = (0, W.jsxs)(`div`, { className: a, children: [o, s] })),
      (t[9] = a),
      (t[10] = o),
      (t[11] = s),
      (t[12] = l))
  ...
  return (
    t[13] !== c || t[14] !== l
      ? ((u = (0, W.jsx)(`div`, { className: c, children: l })),
        (t[13] = c),
        (t[14] = l),
        (t[15] = u))
      : (u = t[15]),
  ...
  return (0, W.jsx)(
    v,
    {
      ...
      children: (0, W.jsxs)(`div`, {
        className: re,
        children: [
          (0, W.jsx)(`span`, { className: `shrink-0 text-token-foreground`, children: e.icon }),
          (0, W.jsx)(`span`, { className: m(ie, `text-token-foreground`), children: e.label }),
        ],
      }),
    },
    t,
...
function ge(e) {
  let t = (0, X.c)(4),
    { groups: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = n.map(_e)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, W.jsx)(`div`, {
          ...
          children: (0, W.jsx)(`div`, { className: `flex flex-col gap-2`, children: r }),
        })),
        (t[2] = r),
        (t[3] = i)),
    i
...
function _e(e, t) {
  return (0, W.jsxs)(
    `div`,
    {
      className: m(`flex flex-col gap-1`, t > 0 && `border-token-border/60 border-t pt-2`),
      children: [
        (0, W.jsx)(O.SectionLabel, { children: e.title }),
        (0, W.jsx)(`div`, {
          className: `flex flex-col gap-2 px-1 pb-1`,
          children: e.comments.map(ve),
        }),
      ],
    },
    t,
...
function ve(e, t) {
  ...
  return (0, W.jsx)(
    `div`,
    {
      ...
      children: (0, W.jsx)(I, {
        comment: r,
        metadataAccessory: ye(n),
        metadataTooltipContent: r.position?.path == null ? null : (0, W.jsx)(be, { comment: r }),
        surface: `card`,
        url: r.url ?? null,
      }),
    },
...
function be(e) {
  let t = (0, X.c)(16),
    { comment: n } = e;
  if (n.position?.path == null) return null;
  let r;
  t[0] === n ? (r = t[1]) : ((r = d(n)), (t[0] = n), (t[1] = r));
  let { startLine: i, startSide: a, endLine: o, endSide: s } = r,
    c;
  t[2] !== n || t[3] !== o || t[4] !== s || t[5] !== i || t[6] !== a
    ? ((c =
        i === o && a === s
          ? (0, W.jsx)(p, {
  ...
  t[8] === n.position.path
    ...
    : ((f = (0, W.jsx)(`span`, {
        ...
        title: n.position.path,
        children: n.position.path,
      })),
      (t[8] = n.position.path),
      (t[9] = f));
  let m;
  t[10] !== n.position.line || t[11] !== l
    ? ((m =
        n.position.line == null
          ? null
          : (0, W.jsx)(`span`, {
              className: `text-xs leading-4 text-token-description-foreground`,
              children: l,
            })),
      (t[10] = n.position.line),
      (t[11] = l),
      (t[12] = m))
    : (m = t[12]);
  let h;
...
function xe({ canFix: e = !1, checks: t, intl: n, onFixCheck: r, onOpenCheck: i }) {
  let a = Se({ canFix: e, checks: t, intl: n, onFixCheck: r, onOpenCheck: i });
  if (a.length !== 0) return (0, W.jsx)(ce, { groups: a, title: Ee(t, n) });
}
function Se({ canFix: e = !1, checks: t, intl: n, onFixCheck: r, onOpenCheck: i }) {
  let a = [],
    o = [],
    s = [],
    c = [],
...
function Ce({ checks: e, ciStatus: t }) {
  if (e.length === 0)
    switch (t) {
      case `failing`:
        return (0, W.jsx)(M, { className: `icon-sm shrink-0 text-token-charts-red` });
      case `none`:
        return (0, W.jsx)(b, { className: `icon-sm shrink-0` });
      case `passing`:
        return (0, W.jsx)(y, { className: `icon-sm shrink-0 text-token-charts-green` });
      case `pending`:
        return (0, W.jsx)(ne, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    }
  return t === `none`
    ? (0, W.jsx)(b, { className: `icon-sm shrink-0` })
    : (0, W.jsx)(J, { checks: e });
}
function we(e) {
  switch (e) {
  ...
  return r.length === 0
    ...
    : (0, W.jsxs)(`span`, {
        ...
        children: [
          ...
          (0, W.jsx)(`span`, { className: `font-normal text-token-foreground/60`, children: r }),
        ],
      });
}
function De(e, t) {
  return [
    Q(e.filter((e) => e.status === `failing`).length, `failing`, t),
    Q(e.filter((e) => e.status === `pending`).length, `pending`, t),
    Q(e.filter((e) => e.status === `skipped`).length, `skipped`, t),
    Q(e.filter((e) => e.status === `unknown`).length, `unknown`, t),
    Q(e.filter((e) => e.status === `passing`).length, `successful`, t),
  ]
    .filter((e) => e != null)
    .join(`, `);
}
...
function Oe(e) {
  switch (e) {
    ...
    case `pending`:
      return (0, W.jsx)(ne, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    case `skipped`:
      return (0, W.jsx)(te, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `successful`:
      return (0, W.jsx)(y, { className: `icon-sm shrink-0 text-token-charts-green` });
    case `unknown`:
      return (0, W.jsx)(te, { className: `icon-sm shrink-0 text-token-description-foreground` });
...
function Fe(e) {
  ...
  if (t[0] !== r || t[1] !== n || t[2] !== a) {
    let { Icon: e, iconClassName: i } = We({ status: n, tone: a });
    ((o = e), (s = m(r, i)), (t[0] = r), (t[1] = n), (t[2] = a), (t[3] = o), (t[4] = s));
  } else ((o = t[3]), (s = t[4]));
  let c;
  return (
    t[5] !== o || t[6] !== s
      ? ((c = (0, W.jsx)(o, { className: s })), (t[5] = o), (t[6] = s), (t[7] = c))
      : (c = t[7]),
    c
  );
}
function Ie(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== a) {
    let { Icon: e, iconClassName: i } = Ge({ state: r, tone: a });
    ((o = e), (s = m(n, i)), (t[0] = n), (t[1] = r), (t[2] = a), (t[3] = o), (t[4] = s));
  } else ((o = t[3]), (s = t[4]));
  let c;
  return (
    t[5] !== o || t[6] !== s
...
var Re = { draft: Ae, open: L, merged: Me, closed: ke },
  ze = {
  ...
  Be = { draft: Ae, failing: je, in_progress: Ne, merged: Me, ready: Pe, successful: Pe },
  Ve = {
    draft: `text-token-description-foreground`,
  ...
  Ue = `text-token-description-foreground`;
function We({ status: e, tone: t }) {
  return {
    Icon: Re[e],
    iconClassName: t === `currentColor` ? `text-current` : t === `neutral` ? Ue : ze[e],
  };
}
function Ge({ state: e, tone: t }) {
  return {
    Icon: Be[e],
    iconClassName:
      t === `currentColor` ? m(`text-current`, He[e]) : t === `neutral` ? m(Ue, He[e]) : Ve[e],
  };
}
var Ke = (e) =>
    (0, W.jsxs)(`svg`, {
...
function Je({
  ...
  let v = r.length,
    y = [],
    b = xe({ canFix: e, checks: t, intl: o, onFixCheck: u, onOpenCheck: d }),
    S = Ce({ checks: t, ciStatus: n }),
    C = we(n);
  return (
    h.includes(`checks-none`) && y.push({ icon: S, key: `checks-none`, label: C }),
    h.includes(`checks-failing`) &&
      y.push({
        accessory: (0, W.jsx)(p, {
    ...
    h.includes(`checks-pending`) &&
      y.push({ flyoutContent: b, icon: S, key: `checks-pending`, label: C }),
    h.includes(`checks-successful`) &&
      y.push({ flyoutContent: b, icon: S, key: `checks-successful`, label: C }),
    y.push(Ze({ flyoutContent: Qe(m, o), intl: o, reviewStatus: f })),
    y.push(
      Ye({
    ...
    h.includes(`merging-blocked`) &&
      y.push({
        disabled: !0,
        icon: (0, W.jsx)(x, { className: `icon-sm shrink-0 text-token-charts-red` }),
        key: `merging-blocked`,
        label: (0, W.jsx)(p, {
    ...
    h.includes(`ready-to-merge`) &&
      y.push({
        ...
        icon: s.isPending
          ? (0, W.jsx)(g, { className: `icon-sm shrink-0` })
          : (0, W.jsx)(_, { className: `icon-sm shrink-0 text-token-description-foreground` }),
        key: `ready-to-merge`,
        label: (0, W.jsx)(p, {
...
function Ye({
  ...
  return {
    ...
    actionDisabled: !t,
    disabled: r === 0,
    flyoutContent: Xe(e, t, n, i, a, s),
    icon: (0, W.jsx)(N, { className: `icon-sm shrink-0` }),
    key: `comments`,
    label:
      r > 0
        ? i.formatMessage(
...
function Ze({ flyoutContent: e, intl: t, reviewStatus: n }) {
  let r = e != null,
    i = r
      ? void 0
      : t.formatMessage({
  ...
  switch (n) {
    case `approved`:
      return {
        disabled: !r,
        flyoutContent: e,
        icon: (0, W.jsx)(_, { className: `icon-sm shrink-0 text-token-description-foreground` }),
    ...
    case `review_required`:
      return {
        disabled: !r,
        flyoutContent: e,
        icon: (0, W.jsx)(b, { className: `icon-sm shrink-0 text-token-description-foreground` }),
        key: `awaiting-review`,
        label: (0, W.jsx)(p, {
...
function $e(e, t) {
  return [
    $(`approved`, e.approved, t),
    $(`requested`, e.requested, t),
    $(`changes-requested`, e.changesRequested, t),
    $(
      `commented`,
      e.commented.filter(
        (t) =>
...
function $(e, t, n) {
  return t.length === 0
    ? null
    : { reviewers: t.map((t) => ({ accessoryLabel: et(e, n), icon: tt(e), label: t })) };
}
function et(e, t) {
  switch (e) {
    case `approved`:
...
function tt(e) {
  switch (e) {
    case `approved`:
      return (0, W.jsx)(_, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `requested`:
      return (0, W.jsx)(b, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `commented`:
      return (0, W.jsx)(N, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `changes-requested`:
      return (0, W.jsx)(x, { className: `icon-sm shrink-0 text-token-charts-red` });
  }
}
function nt(e, t, n) {
...
function rt(e) {
  let t = (0, X.c)(20),
    { cwd: n, headBranch: r, hostId: i, operationSource: a, onSuccess: l } = e,
    u = o(),
    d;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((d = nt(n, r, i)), (t[0] = n), (t[1] = r), (t[2] = i), (t[3] = d))
    : (d = t[3]);
  let f;
  t[4] !== r || t[5] !== l || t[6] !== u
    ? ((f = (e, t) => {
        if (e.status === `success`) {
          if (r != null) {
            let e = (e) => {
              u.setQueryData(s(`gh-pr-status`, e), it);
            };
            (e({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
              e({ cwd: t.cwd, headBranch: r, hostId: t.hostId, number: t.number, repo: t.repo }),
              Promise.all([
                u.invalidateQueries({ queryKey: s(`gh-pr-body`) }),
                u.invalidateQueries({ queryKey: s(`gh-pr-checks`) }),
                u.invalidateQueries({ queryKey: s(`gh-pr-comments`) }),
                u.invalidateQueries({
                  queryKey: s(`gh-pr-summary`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
                }),
                u.invalidateQueries({
                  queryKey: s(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
                }),
                u.invalidateQueries({
  ...
  let p;
  t[8] !== a || t[9] !== d || t[10] !== f
    ? ((p = { source: a, mutationKey: d, onSuccess: f }),
      (t[8] = a),
      (t[9] = d),
      (t[10] = f),
      (t[11] = p))
    : (p = t[11]);
  let m = c(`gh-pr-merge`, p),
    h,
    g;
  t[12] !== i || t[13] !== m
    ? ((h = (e, t) => {
...
function ot(e, t) {
  ...
  return n.length === 0
    ...
    : e
        .map((e) => {
          let t = z(ct(e.displayPath).fileName, n);
          return { entry: e, score: t > 0 ? t : z(e.displayPath, n) };
        })
        .filter(({ score: e }) => e > 0)
...
function lt() {
  let e = (0, X.c)(5),
    ...
    n = a(C),
    r;
  e[0] === t ? (r = e[1]) : ((r = (e) => w(t, e)), (e[0] = t), (e[1] = r));
  let o;
  return (
    e[2] !== n || e[3] !== r
      ? ((o = (0, W.jsx)(ut, { entries: n, onSelectPath: r })), (e[2] = n), (e[3] = r), (e[4] = o))
      : (o = e[4]),
    o
  );
}
function ut(e) {
  ...
  if (t[0] !== n || t[1] !== i || t[2] !== r || t[3] !== s || t[4] !== a) {
    ...
    t[9] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((m = (0, W.jsx)(U, { className: `icon-xs text-token-description-foreground` })),
        (t[9] = m))
      : (m = t[9]);
    let g;
    t[10] === d
    ...
    let _;
    t[12] !== d || t[13] !== g
      ? ((_ = (0, W.jsx)(v, { tooltipContent: d, delayOpen: !0, children: g })),
        (t[12] = d),
        (t[13] = g),
        (t[14] = _))
      : (_ = t[14]);
    ...
    let b;
    (t[16] !== d || t[17] !== a
      ? ((b = (0, W.jsx)(O.SearchInput, { autoFocus: !0, placeholder: d, value: a, onChange: y })),
        (t[16] = d),
        (t[17] = a),
        (t[18] = b))
      : (b = t[18]),
            ...
            : e.map((e) =>
                (0, W.jsx)(
                  O.Item,
                  {
                    ...
                    children: (0, W.jsx)(dt, { displayPath: e.displayPath }),
                  },
                  e.path,
                ),
              ),
...
function dt(e) {
  let t = (0, X.c)(9),
    { displayPath: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = ct(n)), (t[0] = n), (t[1] = r));
  let { fileName: i, parentPath: a } = r,
    o;
  t[2] === i
    ? (o = t[3])
    : ((o = (0, W.jsx)(`span`, { className: `shrink-0 text-token-foreground`, children: i })),
      (t[2] = i),
      (t[3] = o));
  let s;
  t[4] === a
...
function gt(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, W.jsx)(A, { className: `icon-xs text-token-description-foreground` })), (t[11] = j))
    : (j = t[11]);
  let M;
  t[12] === E
    ? (M = t[13])
  ...
  let N;
  t[14] !== E || t[15] !== M
    ? ((N = (0, W.jsx)(v, { tooltipContent: E, delayOpen: !0, children: M })),
      (t[14] = E),
      (t[15] = M),
      (t[16] = N))
    : (N = t[16]);
  ...
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (z = t[35]);
  let B;
  t[36] !== a || t[37] !== o || t[38] !== b || t[39] !== u
    ? ((B = u
        ? (0, W.jsx)(yt, { Icon: R, label: b, onClick: () => a?.(), disabled: o || !a })
        : null),
      (t[36] = a),
      (t[37] = o),
      (t[38] = b),
  ...
  let V = r.wrap ? P : F,
    H;
  t[41] !== r.onToggleWrap || t[42] !== V || t[43] !== S
    ? ((H = (0, W.jsx)(yt, { Icon: V, label: S, onClick: r.onToggleWrap })),
      (t[41] = r.onToggleWrap),
      (t[42] = V),
      (t[43] = S),
      (t[44] = H))
    : (H = t[44]);
  let U = r.expanded ? mt : pt,
    G;
  t[45] !== r.onToggleExpanded || t[46] !== w || t[47] !== U
    ? ((G = (0, W.jsx)(yt, { Icon: U, label: w, onClick: r.onToggleExpanded })),
    ...
    : (G = t[48]);
  let K;
  t[49] === r ? (K = t[50]) : ((K = (0, W.jsx)(vt, { diffControls: r })), (t[49] = r), (t[50] = K));
  let q;
  return (
    t[51] !== L || t[52] !== B || t[53] !== H || t[54] !== G || t[55] !== K
      ? ((q = (0, W.jsxs)(`div`, {
          className: `flex items-center gap-1.5`,
          children: [L, z, B, H, G, K],
        })),
        (t[51] = L),
        (t[52] = B),
        (t[53] = H),
...
function _t(e) {
  ...
  let j = D,
    M;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, W.jsx)(A, { className: `icon-xs` })), (t[11] = M))
    : (M = t[11]);
  let N;
  t[12] === E
    ? (N = t[13])
  ...
  let I;
  t[14] !== E || t[15] !== N
    ? ((I = (0, W.jsx)(v, { tooltipContent: E, delayOpen: !0, children: N })),
      (t[14] = E),
      (t[15] = N),
      (t[16] = I))
    : (I = t[16]);
  let L;
  t[17] !== a || t[18] !== o || t[19] !== b || t[20] !== u
    ? ((L = u
        ? (0, W.jsx)(O.Item, {
            onSelect: (e) => {
  ...
  let B = r.wrap ? P : F,
    V;
  t[24] !== z || t[25] !== B || t[26] !== S
    ? ((V = (0, W.jsx)(O.Item, { onSelect: z, LeftIcon: B, children: S })),
      (t[24] = z),
      (t[25] = B),
      (t[26] = S),
      (t[27] = V))
  ...
  let U = r.expanded ? mt : pt,
    G;
  t[30] !== w || t[31] !== H || t[32] !== U
    ? ((G = (0, W.jsx)(O.Item, { onSelect: H, LeftIcon: U, children: w })),
      (t[30] = w),
      (t[31] = H),
      (t[32] = U),
      (t[33] = G))
  ...
  let J;
  return (
    t[49] !== g || t[50] !== I || t[51] !== L || t[52] !== V || t[53] !== G || t[54] !== q
      ? ((J = (0, W.jsxs)(k, {
          open: g,
          onOpenChange: _,
          align: `end`,
...
function vt(e) {
  ...
  return (
    t[5] !== a || t[6] !== o || t[7] !== s
      ? ((c = (0, W.jsx)(yt, { Icon: o, label: a, onClick: s })),
        (t[5] = a),
        (t[6] = o),
        (t[7] = s),
        (t[8] = c))
...
function yt(e) {
  let t = (0, X.c)(12),
    ...
    u;
  t[0] === n ? (u = t[1]) : ((u = (0, W.jsx)(n, { className: `icon-xs` })), (t[0] = n), (t[1] = u));
  let d;
  ...
  return (
    t[9] !== r || t[10] !== d
      ? ((f = (0, W.jsx)(v, { tooltipContent: r, children: d })),
        (t[9] = r),
        (t[10] = d),
        (t[11] = f))
      : (f = t[11]),
...
function bt(e) {
  ...
  t[22] === l
    ...
    : ((z = l
      ...
      (t[23] = z));
  let B;
  t[24] !== w || t[25] !== S || t[26] !== R || t[27] !== z
    ? ((B = (0, W.jsx)(O.Item, { onSelect: w, "aria-label": S, LeftIcon: R, children: z })),
      (t[24] = w),
      (t[25] = S),
      (t[26] = R),
      (t[27] = z),
  ...
  t[29] === r
    ...
    : ((H = r
      ...
      (t[30] = H));
  let U;
  t[31] !== A || t[32] !== V || t[33] !== H
    ? ((U = (0, W.jsx)(O.Item, { onSelect: A, LeftIcon: V, children: H })),
      (t[31] = A),
      (t[32] = V),
      (t[33] = H),
      (t[34] = U))
  ...
  let q;
  return (
    t[44] !== B || t[45] !== U || t[46] !== G || t[47] !== K || t[48] !== L
      ? ((q = (0, W.jsxs)(W.Fragment, { children: [L, B, U, G, K] })),
        (t[44] = B),
        (t[45] = U),
        (t[46] = G),
        (t[47] = K),
...
//# sourceMappingURL=review-header-toolbar-p.js.map
