import { d as e, p as t, t as n } from "./app-scope.js";
import { Os as r, Ts as i } from "./app-server-manager-signals.js";
...
var s = [`hooks`],
  c = t(n, ({ hostId: e, cwd: t }) => ({
    ...
    queryFn: () => {
      ...
      return i(`list-hooks-for-host`, { hostId: e, cwds: [t] });
    },
