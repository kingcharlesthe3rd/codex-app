import { d as e, f as t, t as n } from "./app-scope.js";
import { f as r, u as i } from "./vscode-api.js";
import { As as a, Ms as o } from "./app-server-manager-signals.js";
var s = [`hooks`],
  c = t(n, ({ hostId: e, cwd: t }) => ({
    queryKey: [...s, e, t],
    queryFn: () => {
      if (t == null) throw Error(`Cannot list hooks without a project root`);
      return a(`list-hooks-for-host`, { hostId: e, cwds: [t] });
    },
    staleTime: i.FIVE_MINUTES,
    refetchOnWindowFocus: `always`,
    enabled: t != null,
  })),
  l = t(n, ({ hostId: e, cwds: t }) => ({
    queryKey: [...s, e, t],
    queryFn: () => {
...
async function u(e, t, n = {}) {
  let { broadcast: i = !1, refetchType: a } = n;
  (await e.invalidateQueries({
    predicate: ({ queryKey: e }) => e[0] === s[0] && e[1] === t,
    refetchType: a,
  }),
    i && r.dispatchMessage(`query-cache-invalidate`, { queryKey: s }));
}
var d = e(n, (e) => ({
  mutationFn: (t) =>
