import { d as e, p as t, t as n } from "./app-scope-CWE-zIhQ.js";
import { Bt as r } from "./use-host-config-C.js";
import { ka as i } from "./thread-context-inputs.js";
...
var s = [`hooks`],
  c = t(n, ({ hostId: e, cwd: t }) => ({
    ...
    queryFn: () => {
      ...
      return r(`list-hooks-for-host`, { hostId: e, cwds: [t] });
    },
...
async function u(e, t, n = {}) {
  ...
  (await e.invalidateQueries({
    ...
    r && a.dispatchMessage(`query-cache-invalidate`, { queryKey: s }));
}
var d = e(n, (e) => ({
  mutationFn: (t) =>
    r(`batch-write-config-value`, {
      hostId: e,
      edits: [
        {
          keyPath: `hooks.state`,
