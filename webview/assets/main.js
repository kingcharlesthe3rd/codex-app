import { n as e, r as t, t as n } from "./chunk.js";
import { a as r, d as i, s as a } from "./reduce.js";
import { a as o } from "./flatten-CNrC-h2I.js";
function s(e, t) {
  return a(o(e, t), 1);
}
function c(e, t) {
  ...
  Ue = e(() => {
    ((function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return Z.objectLiteral(t) && m.is(t.range) && (Z.string(t.uri) || Z.undefined(t.uri));
        }
        e.is = n;
      })((h ||= {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (m.is(t.originSelectionRange) || Z.undefined(t.originSelectionRange))
          );
        }
        e.is = n;
      })((g ||= {})),
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (Z.undefined(t.additionalTextEdits) || Z.typedArray(t.additionalTextEdits, C.is))
          );
        }
        e.is = n;
      })((ne ||= {})),
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (Z.undefined(t.relatedInformation) || Z.typedArray(t.relatedInformation, y.is))
          );
        }
        e.is = n;
      })((x ||= {})),
          ...
          return (
            ...
            (t.options === void 0 ||
              ((t.options.overwrite === void 0 || Z.boolean(t.options.overwrite)) &&
                (t.options.ignoreIfExists === void 0 || Z.boolean(t.options.ignoreIfExists)))) &&
      ...
      (N = class {
        ...
        manage(e, t) {
          let n;
          if ((T.is(e) ? (n = e) : ((n = this.nextId()), (t = e)), this._annotations[n] !== void 0))
      ...
      (oe = class {
        ...
        createFile(e, t, n) {
          ...
          if (
            (r === void 0
              ? (i = O.create(e, n))
              : ((a = T.is(r) ? r : this._changeAnnotations.manage(r)), (i = O.create(e, n, a))),
        ...
        renameFile(e, t, n, r) {
          ...
          if (
            (i === void 0
              ? (a = k.create(e, t, r))
              : ((o = T.is(i) ? i : this._changeAnnotations.manage(i)), (a = k.create(e, t, r, o))),
        ...
        deleteFile(e, t, n) {
          ...
          if (
            (r === void 0
              ? (i = A.create(e, n))
              : ((a = T.is(r) ? r : this._changeAnnotations.manage(r)), (i = A.create(e, n, a))),
            this._workspaceEdit.documentChanges.push(i),
            a !== void 0)
          )
            return a;
      ...
      (function (e) {
        function t(e) {
          ...
          return (
            !!t &&
            Z.objectLiteral(t) &&
            (L.is(t.contents) || K.is(t.contents) || Z.typedArray(t.contents, K.is)) &&
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return Z.defined(t) && m.is(t.range) && (Z.undefined(t.command) || S.is(t.command));
        }
        e.is = n;
      })((Se ||= {})),
      (function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return Z.defined(t) && m.is(t.range) && (Z.undefined(t.target) || Z.string(t.target));
        }
        e.is = n;
      })((we ||= {})),
      (function (e) {
        ...
        function n(t) {
          let n = t;
          return Z.objectLiteral(n) && m.is(n.range) && (n.parent === void 0 || e.is(n.parent));
        }
        e.is = n;
      })((Te ||= {})),
      (function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return t != null && m.is(t.range) && (Z.string(t.expression) || t.expression === void 0);
        }
        e.is = n;
      })((je ||= {})),
      (function (e) {
...
` &&
  ...
  qe = class e {
    ...
    getLineOffsets() {
      return (
        this._lineOffsets === void 0 && (this._lineOffsets = Ye(this._content, !0)),
        this._lineOffsets
      );
    }
    positionAt(e) {
...
function Ye(e, t, n = 0) {
  ...
  for (let t = 0; t < e.length; t++) {
    ...
    Xe(i) && (i === 13 && t + 1 < e.length && e.charCodeAt(t + 1) === 10 && t++, r.push(n + t + 1));
  }
  return r;
}
function Xe(e) {
