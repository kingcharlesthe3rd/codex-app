import { Jr as e, Yr as t, br as n, xr as r } from "./app-server-manager-signals.js";
...
import { a as c, i as l, n as u, s as d, t as f } from "./inline-mentions-C8jF-sc9.js";
var p = o(),
  m = i(),
  h = /(```[\s\S]*?```|`[^`\n]+`|```[\s\S]*|`[^`\n]*\n|`[^`\n]*$)/g,
  g = /\[((?:\\.|[^\]\n])+)\]\(((?:\\.|[^)\n])+)\)/g;
...
function b(e, t, i, a) {
  ...
  for (let [f, p] of o.entries()) {
    if ((p.index > l && s.push(e.slice(l, p.index)), u(p.content)))
      ...
      n(e)
        ? s.push((0, m.jsx)(c, { reference: r(e), cwd: i, hostId: a }, `${t}-file-${f}`))
        : s.push(p.content);
...
function x(n, r, i, a) {
  ...
  for (; (u = g.exec(n)) != null; ) {
    ...
    (_ == null
      ? o.push((0, m.jsx)(s, { href: g, originHostId: a, children: h }, `${r}-link-${d}`))
      : o.push(_),
