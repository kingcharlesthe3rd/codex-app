...
import { a as r, i, o as a, s as o, t as s, z as c } from "./app-scope.js";
import {
  Ea as l,
  Ts as u,
  Xn as d,
...
import "./isEqual.js";
import { Ft as D, ft as O, hr as k, ht as A, mr as j, pn as M, w as N } from "./src-2.js";
import "./react-dom.js";
import { i as P, l as ee, s as F } from "./lib.js";
import { c as I } from "./persisted-signal.js";
import { t as L } from "./clsx-Cir5-jBH.js";
import { t as R } from "./proxy.js";
import { x as z } from "./app-shell-state.js";
import { t as B } from "./AnimatePresence.js";
import { t as V } from "./app-shell.js";
import { t as H } from "./persisted-atom.js";
import { t as U } from "./bullet-separator.js";
import { t as te } from "./button.js";
import { a as ne, i as W } from "./setting-storage.js";
...
import { A as J, F as Y, N as oe, r as se, z as ce } from "./product-logger.js";
...
import { d as le } from "./thread-context-inputs.js";
...
import { a as fe, i as pe, l as me, n as he, r as ge } from "./dialog-layout-B.js";
...
import "./bug.js";
import "./chrome.js";
import { t as be } from "./codex-Dw-qSlib.js";
import "./notion.js";
...
import { t as Se } from "./link-external.js";
...
import { o as Ce } from "./remote-projects.js";
import "./collaboration-mode-queries.js";
import { t as we } from "./chevron.js";
import "./clock.js";
import "./warning.js";
import { m as Te, s as Ee } from "./shiki-highlight-provider-gate.js";
import "./core.esm.js";
import "./katex-3.js";
import "./pdf.js";
import { _ as De, m as Oe, n as ke } from "./chunk-9.js";
import { t as Ae } from "./use-service-tier-settings.js";
import "./known-app-icon.js";
import "./branch-D.js";
import { t as je } from "./github-mark.js";
...
import { t as Me } from "./route-scope.js";
...
import { c as Pe, i as Fe, s as Ie, t as Le } from "./diff-view-mode.js";
import "./app-shell-tab-controller.js";
import "./browser-sidebar-manager.js";
import "./review-navigation-model.js";
import { t as Re } from "./file-tree-search-input.js";
import { t as ze } from "./parse-diff-BMY7-MEq.js";
import "./file-diff.js";
...
import { u as Ve } from "./sidebar-project-group-signals.js";
...
import { t as He } from "./build-worktree-label-from-input.js";
import { i as Ue } from "./pending-worktree-store.js";
...
import { n as We, t as Ge } from "./loading-page.js";
...
import { t as Je } from "./format-relative-date-time.js";
...
import { n as ot } from "./markdown-1.js";
...
import { t as st } from "./github-details.js";
import { h as ct, m as lt, p as ut } from "./use-diff-annotations.js";
import { t as dt } from "./pull-request-open.js";
import { c as ft, h as pt, r as mt, t as ht } from "./automation-schedule.js";
import { t as gt } from "./get-attached-heartbeat-automation-for-thread.js";
import "./use-is-background-subagents-enabled.js";
import "./sortBy.js";
import "./local-environments.js";
import { r as _t } from "./local-environment-selection.js";
import { t as vt } from "./check-lg.js";
...
function an(e) {
  ...
  if (t[0] !== o || t[1] !== r || t[2] !== i || t[3] !== s || t[4] !== a) {
    let e = Xe({ canFix: o, checks: r, intl: s, onFixCheck: a, onOpenCheck: on });
...
function on(e) {
  e.link != null && v.dispatchMessage(`open-in-browser`, { url: e.link });
}
function sn(e) {
  switch (e) {
    case `failing`:
...
function cn(e) {
  return (0, $.jsx)(`span`, {
    ...
    children: (0, $.jsx)(nt, { className: L(`icon-3xs`, e) }),
  });
}
function ln(e) {
  let t = (0, Z.c)(5),
...
function yn() {
  return ht({ ...mt(), intervalHours: 1, intervalMinutes: fn });
}
function bn(e) {
  return e
...
function wn() {
  return [
    ...
    `Use ::${d}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
...
function Tn({ conversationId: e, pendingWorktreeId: t }) {
  return e == null ? (t == null ? null : A(t)) : O(e);
}
function En(e) {
  let t = (0, Z.c)(31),
    { hostId: n, item: r, onSuccess: i, repo: o } = e,
    c = a(s),
    d = ee(),
    f = Oe(),
    { createPendingWorktree: p } = Ue(),
    m;
  t[0] !== n || t[1] !== r.cwd
    ? ((m = { conversationId: null, cwdOverride: r.cwd, hostId: n }),
      ...
      (t[2] = m))
    : (m = t[2]);
  let { agentMode: h, isAgentModePending: g } = Ne(m),
    { activeMode: v } = xe(null),
    { serviceTierSettings: b } = Ae(null),
    x;
  t[3] !== n || t[4] !== r.cwd
    ? ((x = { hostId: n, workspaceRoot: r.cwd }), (t[3] = n), (t[4] = r.cwd), (t[5] = x))
    : (x = t[5]);
  let { resolvedConfigPath: S } = _t(x),
    C;
  t[6] !== v ||
  t[7] !== h ||
  t[8] !== p ||
  ...
  t[14] !== b
    ? ((C = async (e) => {
        let t = hn({ includeReviewComments: e, item: r, repo: o }),
          i = [{ type: `text`, text: t, text_elements: [] }],
          { config: a } = await u(`read-config-for-host`, {
            hostId: n,
            includeLayers: !1,
            cwd: r.cwd,
          }),
          s = {
            ...
            agentMode: h,
            model: null,
            serviceTier: b.serviceTierForRequest,
            reasoningEffort: null,
            collaborationMode: v,
            config: l(a),
          },
        ...
        return p({
          ...
          heartbeatAutomation: gn({ includeReviewComments: e, item: r, name: c, repo: o }),
        });
      }),
      (t[6] = v),
      (t[7] = h),
    ...
    : (C = t[15]);
  let w;
  t[16] !== r.url || t[17] !== f || t[18] !== i || t[19] !== c
    ? ((w = (e) => {
        (Nt(c, { pendingWorktreeId: e, pullRequestUrl: r.url }), i(), f(A(e)));
      }),
      (t[16] = r.url),
      (t[17] = f),
      (t[18] = i),
  ...
  t[21] !== d || t[22] !== c
    ? ((T = (e) => {
        (y.error(`Error starting pull request merge helper`, { safe: {}, sensitive: { error: e } }),
          c
            .get(K)
            .danger(
              d.formatMessage(
  ...
  return (
    t[28] !== g || t[29] !== D
      ? ((O = { ...D, isAgentModePending: g }), (t[28] = g), (t[29] = D), (t[30] = O))
      : (O = t[30]),
    O
  );
}
function Dn(e) {
  let t = (0, Z.c)(102),
    { className: n, hostId: r, item: c, repo: l, size: u, stopPropagation: d, surface: f } = e,
    ...
    y = g(),
    b = i(Mt, c.url),
    x = o(b.conversationId$),
    S = o(b.pendingWorktreeId$),
    T = o(pt),
    E = ee(),
    D = Oe(),
    O = o(Pt),
    ...
    [j, M] = (0, Q.useState)(!1),
    N;
  t[0] !== E || t[1] !== v || t[2] !== y || t[3] !== _
    ? ((N = (e) => {
        (v.logProductEvent(oe, {
          action: J.CODEX_AUTOMATION_ACTION_UPDATED,
          source: ce.CODEX_AUTOMATION_SOURCE_PR_MERGE_HELPER,
          success: !0,
          ...ft(e.item),
        }),
          y.invalidateQueries({ queryKey: C(`list-automations`) }),
          _.get(K).success(
            E.formatMessage({
  ...
  let I;
  t[9] !== N || t[10] !== P
    ? ((I = { onSuccess: N, onError: P }), (t[9] = N), (t[10] = P), (t[11] = I))
    : (I = t[11]);
  let L = w(`automation-update`, I),
    R = (0, Q.useId)(),
    z = r ?? c.hostId ?? `local`,
    B = T.data,
    V = T.isLoading || T.isFetching,
    H,
    U,
    ne;
  if (t[12] !== B?.items || t[13] !== T.isError || t[14] !== V || t[15] !== x || t[16] !== S) {
    H = gt({ automations: B?.items ?? [], conversationId: x, includePausedAutomations: !0 });
    let e = x == null && S != null;
    ((U = H?.status === `PAUSED`),
      (ne = mn({
        automationStatus: H?.status,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (re = t[20]);
  let G;
  t[21] !== c || t[22] !== l || t[23] !== z
    ? ((G = { hostId: z, item: c, onSuccess: re, repo: l }),
      (t[21] = c),
      (t[22] = l),
      (t[23] = z),
      (t[24] = G))
    : (G = t[24]);
  let q = En(G),
    ae = q.isPending || q.isAgentModePending,
    le = q.isPending || L.isPending || (!U && !W && q.isAgentModePending),
    X;
  t[25] !== H ||
  t[26] !== W ||
  t[27] !== U ||
  ...
  t[37] !== S
    ? ((X = (e) => {
        if ((m && e.stopPropagation(), U && H != null)) {
          (Vt(_, { action: `merge_with_codex_resumed`, item: c, surface: h }), L.mutate(_n(H)));
          return;
        }
        if (W) {
          let e = Tn({ conversationId: x, pendingWorktreeId: S });
          e != null &&
            (Vt(_, { action: `merge_with_codex_task_opened`, item: c, surface: h }), D(e));
          return;
        }
        if (!q.isAgentModePending) {
          if (O) {
            (Vt(_, { action: `merge_with_codex_started`, item: c, surface: h }), q.mutate(!1));
            return;
          }
          (Vt(_, { action: `merge_with_codex_dialog_opened`, item: c, surface: h }), A(!1), M(!0));
        }
      }),
      (t[25] = H),
      (t[26] = W),
  ...
  let ue = X,
    de;
  t[39] !== k || t[40] !== c || t[41] !== _ || t[42] !== q || t[43] !== h
    ? ((de = (e) => {
        (e.preventDefault(),
          !q.isAgentModePending &&
            (Vt(_, { action: `merge_with_codex_started`, item: c, surface: h }), q.mutate(k)));
      }),
      (t[39] = k),
      (t[40] = c),
      (t[41] = _),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xe = (0, $.jsx)(be, { className: `icon-xxs` })), (t[46] = xe))
    : (xe = t[46]);
  let Se;
  t[47] !== W || t[48] !== U
    ? ((Se = U
    ...
    : (Se = t[49]);
  let Ce;
  t[50] !== n || t[51] !== ue || t[52] !== le || t[53] !== p || t[54] !== Se
    ? ((Ce = (0, $.jsx)(ie, {
        tooltipContent: ye,
        children: (0, $.jsxs)(te, {
          className: n,
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Te = (0, $.jsx)(be, { className: `icon-sm text-token-foreground` })),
      (Ee = (0, $.jsx)(F, {
  ...
  t[63] === E
    ...
    : ((Me = E.formatMessage({
      ...
      (t[64] = Me));
  let Ne;
  t[65] !== k || t[66] !== q.isPending || t[67] !== Me
    ? ((Ne = (0, $.jsx)(fe, {
        ...
        children: (0, $.jsxs)(`label`, {
          ...
          children: [
            Ae,
            (0, $.jsx)(ve, { checked: k, disabled: je, ariaLabel: Me, size: `sm`, onChange: A }),
          ],
        }),
      })),
      (t[65] = k),
  ...
  t[69] === _
    ...
    : ((Pe = (e) => {
      ...
      (t[70] = Pe));
  let Fe;
  t[71] !== O || t[72] !== R || t[73] !== q.isPending || t[74] !== Pe
    ? ((Fe = (0, $.jsx)(Ke, { id: R, checked: O, disabled: q.isPending, onCheckedChange: Pe })),
      (t[71] = O),
      (t[72] = R),
      (t[73] = q.isPending),
      (t[74] = Pe),
  ...
  t[85] === ae
    ? (He = t[86])
    : ((He = (0, $.jsx)(te, { color: `primary`, loading: ae, type: `submit`, children: Ve })),
      (t[85] = ae),
      (t[86] = He));
  let Ue;
  t[87] !== Le || t[88] !== Be || t[89] !== He
    ? ((Ue = (0, $.jsxs)(ge, { children: [Le, Be, He] })),
      (t[87] = Le),
      (t[88] = Be),
      (t[89] = He),
      (t[90] = Ue))
  ...
  return (
    t[99] !== Ce || t[100] !== Ge
      ? ((qe = (0, $.jsxs)($.Fragment, { children: [Ce, Ge] })),
        (t[99] = Ce),
        (t[100] = Ge),
        (t[101] = qe))
      : (qe = t[101]),
...
function On(e) {
  let t = (0, Z.c)(96),
    { hostId: n, item: r, pullRequestBody: i, request: o, surface: c } = e,
    l = c === void 0 ? `pull_request_page` : c,
    u = a(s),
    d = ee(),
    f = g(),
    p = Ft(),
    [m, h] = (0, Q.useState)(!1),
    _ = ne(N.pullRequestMergeMethod),
    v;
  t[0] !== n ||
  t[1] !== r.cwd ||
  t[2] !== r.headBranch ||
  ...
  t[6] !== o
    ? ((v = async () => {
        await Promise.all([
          ...
          f.invalidateQueries({ queryKey: C(`gh-pr-body`, o) }),
          f.invalidateQueries({ queryKey: C(`gh-pr-checks`, o) }),
          f.invalidateQueries({ queryKey: C(`gh-pr-comments`, o) }),
          f.invalidateQueries({
  ...
  t[8] !== y || t[9] !== _ || t[10] !== u
    ? ((b = (e) => {
        (async () => {
          (await y(),
            e && _ !== `squash` && (await W(u, N.pullRequestMergeMethod, `squash`)),
            h(!1));
        })();
      }),
      (t[8] = y),
  ...
  let O = dn(D),
    ...
    P = !k || j || A || i?.canMerge !== !0 || w.isPending,
    I = !k || j || (!M && A) || E.isPending,
    L = !k || j || O.isPending,
    R;
  t[24] !== A || t[25] !== j || t[26] !== k || t[27] !== r || t[28] !== i || t[29] !== p
    ? ((R = p && k && !j && !A && i.canMerge !== !0 && pn(r)),
      (t[24] = A),
      (t[25] = j),
      (t[26] = k),
      (t[27] = r),
        ...
        (Vt(u, { action: i.isDraft ? `mark_ready` : `mark_draft`, item: r, surface: l }),
          O.mutate(
            { action: e, cwd: r.cwd, number: r.number, repo: i.repo },
            {
              onSuccess: (t) => {
                if (t.status !== `success`) {
                  u.get(K).danger(t.error);
                  return;
                }
                (u.get(K).success(kn(e, d)), x(!1));
              },
            },
          ));
      }),
          ...
          E.mutate(
            ...
            },
            {
              onSuccess: (t) => {
                ...
                (u.get(K).success(kn(`toggle-auto-merge`, d)), x(m && e));
              },
            },
          ));
      }),
  ...
  t[59] === A
    ...
    : ((ae = A
      ...
      (t[60] = ae));
  let J;
  t[61] !== O.isPending || t[62] !== L || t[63] !== H || t[64] !== ae
    ? ((J = (0, $.jsx)(te, {
        color: `outline`,
        disabled: L,
        loading: O.isPending,
  ...
  t[66] === E.isPending
    ? (Y = t[67])
    : ((Y = E.isPending ? (0, $.jsx)(re, { className: `icon-xxs` }) : null),
      (t[66] = E.isPending),
      (t[67] = Y));
  let oe;
  t[68] === Y
    ? (oe = t[69])
    : ((oe = (0, $.jsx)(`span`, { className: `inline-flex w-3 justify-center`, children: Y })),
      (t[68] = Y),
      (t[69] = oe));
  let se;
  ...
  t[71] === d
    ...
    : ((ce = d.formatMessage({
      ...
      (t[72] = ce));
  let le;
  t[73] !== I || t[74] !== ie || t[75] !== M || t[76] !== ce
    ? ((le = (0, $.jsx)(ve, { checked: M, disabled: I, ariaLabel: ce, size: `sm`, onChange: ie })),
      (t[73] = I),
      (t[74] = ie),
      (t[75] = M),
      (t[76] = ce),
...
function zn(e) {
  ...
  t[2] === ee
    ...
    : ((oe = () => {
      ...
      (t[3] = oe));
  let se;
  (t[4] === Symbol.for(`react.memo_cache_sentinel`) ? ((se = []), (t[4] = se)) : (se = t[4]),
    (0, Q.useLayoutEffect)(oe, se));
  let ce;
  t[5] === ee
    ? (ce = t[6])
    : ((ce = () => {
      ...
      (t[6] = ce));
  let le;
  (t[7] === Symbol.for(`react.memo_cache_sentinel`) ? ((le = []), (t[7] = le)) : (le = t[7]),
    (0, Q.useEffect)(ce, le));
  let X, ue;
  ...
  t[28] !== k
    ? ((de = () => {
        ...
        U.current ? i && Vn([W, re, ie], V) : (Vn([W, re, ie], V), (U.current = !0));
        let a = () => {
          ((te.current = t), (ne.current = D));
        };
        if (x > 0 && T && t <= x && !ae) {
          (er({ containerWidth: t, minRightWidth: y, isOpen: E, node: e, rafRef: B }), a());
          return;
        }
        let o = Wn(t);
        if (!T) {
        ...
        if (!E) {
          let { rightWidth: n, boundedLeftRatio: r } = Qn({
            ...
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: o * Kn(G.current),
          });
          G.current = r;
          let i = Zn(K.current > 0 ? K.current : n, o);
          ((K.current = i),
            nr({
              containerWidth: t,
              handleWidth: 0,
        ...
        let u = B.current;
        return () => {
          (u != null && (cancelAnimationFrame(u), B.current === u && (B.current = null)),
  ...
  t[44] !== O ||
  t[45] !== k
    ? ((fe = [P, D, E, Y, x, ae, T, J, S, C, F, v, y, w, O, k]),
      (t[30] = P),
      (t[31] = x),
      (t[32] = Y),
      (t[33] = D),
  ...
  t[87] !== _
    ? ((_e = (e) => {
        ...
        if (!t || !n) return;
        if (J) {
          er({ containerWidth: n, minRightWidth: y, isOpen: !1, node: t, rafRef: B });
          return;
        }
        let r = Wn(n),
          { rightWidth: i, boundedLeftRatio: a } = Qn({
            ...
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: r * Kn(G.current),
          });
        G.current = a;
        let o = Zn(K.current > 0 ? K.current : i, r);
        ((K.current = o),
          nr({
            containerWidth: n,
            handleWidth: 0,
  ...
  t[101] !== k
    ? ((ye = (e) => {
        ...
        if (C || !T) return;
        if ((Hn([W, re, ie], V), _?.(!0), J)) {
          er({ containerWidth: n, minRightWidth: y, isOpen: !0, node: t, rafRef: B });
          return;
        }
        let {
          boundedLeftWidth: r,
  ...
  let Se = xe,
    Ce;
  t[108] !== ve || t[109] !== D || t[110] !== E || t[111] !== be || t[112] !== F || t[113] !== Se
    ? ((Ce = {
        isLeftOpen: D,
        isRightOpen: E,
        isResizing: F,
  ...
  let we = Ce,
    ...
    Oe;
  t[115] !== a || t[116] !== De
    ? ((Oe = L(`group/split-view relative h-full w-full min-w-0 overflow-hidden`, De, a)),
      (t[115] = a),
      (t[116] = De),
      (t[117] = Oe))
    : (Oe = t[117]);
  ...
  t[157] !== Oe || t[158] !== Ie || t[159] !== Le || t[160] !== Ge
    ? ((Ke = (0, $.jsxs)(`div`, { ref: z, className: Oe, children: [Ie, Le, Ge] })),
      (t[157] = Oe),
      (t[158] = Ie),
      (t[159] = Le),
      (t[160] = Ge),
...
var ir = b(s, `gh-current-user`, (e) => ({ params: { hostId: e }, staleTime: T.ONE_MINUTE })),
  ar = 25,
  or = 100,
  sr = 50,
  cr = 0,
...
function ur(e) {
  ...
  t[33] === T
    ? (E = t[34])
    : ((E = (0, $.jsx)(tt, { diffControls: T, showHideWhitespace: !1, showLoadFullFiles: !1 })),
      (t[33] = T),
      (t[34] = E));
  ...
  let j;
  t[44] !== _ || t[45] !== A
    ? ((j = (0, $.jsx)(ie, { tooltipContent: _, delayOpen: !0, children: A })),
      (t[44] = _),
      (t[45] = A),
      (t[46] = j))
    : (j = t[46]);
...
function fr({
  ...
  let m = a(s),
    ...
    L = (0, Q.useCallback)(
      (e) => {
        let t = Dt(e),
          n = j.current.get(t);
        (j.current.delete(t), n != null && I(n, !1));
      },
      [I],
    ),
    R = (0, Q.useCallback)((e) => {
    ...
    { data: B, isLoading: V } = x(`gh-pr-diff`, {
      source: `pull_request_board`,
      params: { cwd: e, hostId: t, number: i, repo: u ?? null },
      queryConfig: { refetchOnWindowFocus: `always`, staleTime: T.FIVE_SECONDS },
    }),
    [H] = (0, Q.useState)(() => new Te()),
    U = (0, Q.useCallback)(
      (e) => {
        if (e != null) {
          H.setup(e);
    ...
    ne = B?.status === `success` ? ze(B.unifiedDiff) : [],
    ...
    q = (0, Q.useMemo)(
      () =>
        l == null || l.length === 0 ? void 0 : Tt({ comments: l, filePaths: W, workspaceRoot: e }),
      [e, W, l],
    );
  function ae(e) {
  ...
  let J = (0, Q.useCallback)(
      (n) => {
        ...
        (j.current.set(Dt(r), n), I(n, !0), z.mutate(r));
      },
      [e, t, i, z, u, I],
    ),
    Y = (0, Q.useCallback)(
...
function mr(e) {
  ...
  let P = N,
    F = O && `w-full`,
    I;
  t[17] === F ? (I = t[18]) : ((I = L(`flex flex-col gap-2`, F)), (t[17] = F), (t[18] = I));
  let R;
  ...
  let H;
  return (
    t[31] !== A || t[32] !== B || t[33] !== V || t[34] !== I
      ? ((H = (0, $.jsxs)(`form`, { className: I, onSubmit: A, children: [B, V] })),
        (t[31] = A),
        (t[32] = B),
        (t[33] = V),
        (t[34] = I),
...
function _r(e) {
  ...
  t[10] === v
    ? (y = t[11])
    : ((y = L(`flex min-w-0 items-center gap-2`, v)), (t[10] = v), (t[11] = y));
  let b;
  t[12] === s
    ? (b = t[13])
    : ((b = (e) => {
  ...
  t[24] === a
    ? (C = t[25])
    : ((C = a ? null : (0, $.jsx)(q, { className: `icon-xs` })), (t[24] = a), (t[25] = C));
  let w;
  ...
  let T;
  t[31] !== p || t[32] !== w
    ? ((T = (0, $.jsx)(ie, { delayDuration: 250, tooltipContent: p, children: w })),
      (t[31] = p),
      (t[32] = w),
      (t[33] = T))
    : (T = t[33]);
...
function br(e) {
  let t = (0, Z.c)(24),
    { item: n } = e,
    r = i(Mt, n.url),
    a = o(r.conversationId$),
    s = o(r.pendingWorktreeId$),
    c = o(r.ciJobsFixed$),
    l = o(r.mergeConflictsResolved$),
    u = o(pt),
    d = u.data,
    f,
    p,
    m;
  if (t[0] !== d?.items || t[1] !== a || t[2] !== s) {
    let e = gt({ automations: d?.items ?? [], conversationId: a, includePausedAutomations: !0 });
    f = a == null && s != null;
    let n;
    (t[6] !== a || t[7] !== s
      ? ((n = Tn({ conversationId: a, pendingWorktreeId: s })), (t[6] = a), (t[7] = s), (t[8] = n))
      : (n = t[8]),
      (m = n),
  ...
  let h = p;
  if ((a == null && s == null) || (!f && u.isLoading) || h == null) return null;
  let g;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, $.jsx)(X.SectionLabel, {
        children: (0, $.jsx)(F, {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(be, { className: `icon-xs shrink-0` })), (t[10] = _))
    : (_ = t[10]);
  let v;
  t[11] === h
    ? (v = t[12])
...
function wr(e) {
  ...
  let s;
  t[4] !== i || t[5] !== a
    ? ((s = i && a ? (0, $.jsx)(U, { className: `shrink-0` }) : null),
      (t[4] = i),
      (t[5] = a),
      (t[6] = s))
    : (s = t[6]);
...
function Tr(e) {
  ...
  t[23] !== f ||
  t[24] !== d
    ? ((I = [p, r.isAuthor, r.state, r.url, f, d]),
      (t[19] = p),
      (t[20] = r.isAuthor),
      (t[21] = r.state),
      (t[22] = r.url),
      ...
      (t[25] = I))
    : (I = t[25]),
    S(`copy-working-directory`, P, I));
  let R;
  t[26] === r.state
    ? (R = t[27])
    : ((R = (0, $.jsx)(et, { className: `icon-sm shrink-0`, state: r.state })),
      (t[26] = r.state),
      (t[27] = R));
  let z;
  t[28] === r.title
  ...
  let H;
  t[35] !== R || t[36] !== V
    ? ((H = (0, $.jsxs)(`div`, { className: `flex min-w-0 items-center gap-2`, children: [R, V] })),
      (t[35] = R),
      (t[36] = V),
      (t[37] = H))
    : (H = t[37]);
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ne = (0, $.jsx)(`span`, { className: `shrink-0`, children: `->` })), (t[40] = ne))
    : (ne = t[40]);
  let W;
  t[41] === r.baseBranch
    ? (W = t[42])
  ...
  let G;
  t[46] !== H || t[47] !== re
    ? ((G = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [H, re] })),
      (t[46] = H),
      (t[47] = re),
      (t[48] = G))
    : (G = t[48]);
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((J = (0, $.jsx)($e, { className: `icon-xs` })), (t[53] = J))
    : (J = t[53]);
  let Y;
  t[54] !== N || t[55] !== q
    ? ((Y = (0, $.jsx)(te, {
  ...
  let oe;
  t[57] !== K || t[58] !== Y
    ? ((oe = (0, $.jsx)(ie, { tooltipContent: K, children: Y })),
      (t[57] = K),
      (t[58] = Y),
      (t[59] = oe))
    : (oe = t[59]);
  ...
  t[64] !== r || t[65] !== f || t[66] !== d
    ? ((le = () => {
        (Vt(f, { action: `open_in_browser`, item: r, surface: d }),
          v.dispatchMessage(`open-in-browser`, { url: r.url }));
      }),
      (t[64] = r),
      (t[65] = f),
      (t[66] = d),
  ...
  t[68] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((X = (0, $.jsx)(Se, { className: `icon-xs` })), (t[68] = X))
    : (X = t[68]);
  let ue;
  t[69] !== ce || t[70] !== le
    ? ((ue = (0, $.jsx)(te, {
  ...
  let de;
  t[72] !== se || t[73] !== ue
    ? ((de = (0, $.jsx)(ie, { tooltipContent: se, children: ue })),
      (t[72] = se),
      (t[73] = ue),
      (t[74] = de))
    : (de = t[74]);
  ...
  t[77] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = (0, $.jsx)(ae, { className: `icon-xs` })), (t[77] = pe))
    : (pe = t[77]);
  let me;
  t[78] !== i || t[79] !== fe
    ? ((me = (0, $.jsx)(te, {
    ...
    ? ((_e = u
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              ...
              g === `code-review`
                ? (0, $.jsx)(ur, { isFileTreeOpen: _, onFileTreeOpenChange: y })
                : null,
            ],
          })
        : null),
    ...
    ? ((ve = (0, $.jsx)(`div`, {
        ...
        children:
          g === `code-review`
            ...
            : (0, $.jsx)(Er, { hostId: n, item: r, relatedThreads: o, request: C, surface: d }),
      })),
      (t[97] = g),
      (t[98] = n),
      (t[99] = _),
...
function Ar(e) {
  ...
  t[12] !== o.reviewers || t[13] !== r
    ? ((p = Ze(o.reviewers, r)), (t[12] = o.reviewers), (t[13] = r), (t[14] = p))
    : (p = t[14]);
  let m;
  ...
  t[16] === p
    ? (h = t[17])
    : ((h = (0, $.jsx)(Ye, { emptyMessage: f, groups: p, title: m })), (t[16] = p), (t[17] = h));
  let g;
  return (
    t[18] !== d || t[19] !== h
      ? ((g = (0, $.jsxs)(`div`, {
...
function Mr(e) {
  ...
  let o;
  t[0] !== n || t[1] !== r
    ? ((o = it({ checks: n, ciStatus: r })), (t[0] = n), (t[1] = r), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === r ? (s = t[4]) : ((s = at(r)), (t[3] = r), (t[4] = s));
  let c = i ? 180 : 0,
    l;
  t[5] === c ? (l = t[6]) : ((l = { rotate: c }), (t[5] = c), (t[6] = l));
  let u;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(we, { className: `icon-2xs` })), (t[7] = u))
    : (u = t[7]);
  let d;
  t[8] === l
    ? (d = t[9])
  ...
  t[19] === m
    ? (h = t[20])
    : ((h = (0, $.jsx)(B, { initial: !1, children: m })), (t[19] = m), (t[20] = h));
  let g;
  return (
    t[21] !== h || t[22] !== p
...
function Pr(e) {
  ...
  if (c.activityItems.length === 0) {
    ...
    t[11] === g
      ? (e = t[12])
      : ((e = (0, $.jsx)(X.SectionLabel, { children: g })), (t[11] = g), (t[12] = e));
    let n;
  ...
  t[16] === g
    ? (_ = t[17])
    : ((_ = (0, $.jsx)(X.SectionLabel, { children: g })), (t[16] = g), (t[17] = _));
  let v;
  if (
...
function Rr(e) {
  ...
  t[5] === r
    ? (c = t[6])
    : ((c = (0, $.jsx)(te, { color: `ghost`, size: `composerSm`, onClick: r, children: s })),
      (t[5] = r),
      (t[6] = c));
  let l;
  return (
...
function zr(e) {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (d = t[13]);
  let f;
  t[14] === n.createdAt ? (f = t[15]) : ((f = ct(n.createdAt)), (t[14] = n.createdAt), (t[15] = f));
  let p;
  t[16] === n.createdAt
    ? (p = t[17])
    : ((p = (0, $.jsx)(`span`, {
        className: `inline`,
        children: (0, $.jsx)(Je, { dateString: n.createdAt }),
      })),
      (t[16] = n.createdAt),
      (t[17] = p));
  let m;
  ...
  let g;
  t[21] !== h || t[22] !== f
    ? ((g = (0, $.jsx)(ie, { delayDuration: 250, tooltipContent: f, children: h })),
      (t[21] = h),
      (t[22] = f),
      (t[23] = g))
    : (g = t[23]);
...
function Ur(e) {
  switch (e) {
    case `approved`:
      return { Icon: vt, iconClassName: `text-token-charts-green` };
    case `changes_requested`:
      return { Icon: ae, iconClassName: `text-token-charts-red` };
    case `merged`:
      return { Icon: Qe, iconClassName: `text-token-charts-purple` };
    case `opened`:
      return { Icon: dt, iconClassName: `text-token-charts-green` };
  }
}
function Wr(e) {
...
function qr() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, $.jsx)(X.SectionLabel, { children: (0, $.jsx)(Zr, {}) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(jt, {
            icon: (0, $.jsx)(re, { className: `icon-sm shrink-0 text-token-text-tertiary` }),
            label: (0, $.jsx)(F, {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(X.SectionLabel, { children: (0, $.jsx)(Qr, {}) }),
            (0, $.jsx)(Xr, {}),
          ],
        })),
        (e[0] = t))
...
function Qr(e) {
  ...
  t[1] === r
    ? (a = t[2])
    : ((a = r ? (0, $.jsx)(re, { className: `icon-xxs text-token-description-foreground` }) : null),
      (t[1] = r),
      (t[2] = a));
  let o;
  return (
...
function ei(e) {
  let t = (0, Z.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(re, { className: `icon-xxs` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function ni(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, $.jsx)(X.SectionLabel, { className: `px-0 py-0`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function si(e) {
  ...
  let { data: D, isLoading: O } = x(`gh-pr-board`, E),
    k = ne(N.pullRequestMergeMethod),
    A = D?.status === `success` ? D.items : [],
    j = Jt(A),
    P = j.find(ci)?.items[0] ?? null,
    I = $t({ items: A, selectedPullRequestNumber: a, selectedPullRequestUrl: o }),
    L = `${s ?? ``}:${n}:${y ?? ``}`,
    R = a != null || o != null;
  (0, Q.useEffect)(() => {
    P == null || R || g === L || (_(L), c(P, { replace: !0 }));
  }, [L, g, P, R, c]);
  let z;
  t[15] === d
    ? (z = t[16])
    : ((z = (e) => ({ id: bi(e.key), title: d.formatMessage(xi(e.key)) })),
      (t[15] = d),
      (t[16] = z));
  let B = j.map(z),
    H = Yt(f ?? []),
    U = I == null ? oi : (H.get(I.headBranch.trim()) ?? oi),
    te;
  ...
  t[25] === ie
    ? (K = t[26])
    : ((K = (0, $.jsx)(V.Header, { children: ie })), (t[25] = ie), (t[26] = K));
  let q = Rt,
    ae;
  t[27] === d
    ? (ae = t[28])
  ...
  let Y =
            ...
            : j.map((e) =>
                (0, $.jsx)(
                  hi,
                  {
                    ...
                    column: e,
                    mergeMethod: k ?? `merge`,
                    selectedPullRequestNumber: I?.number ?? a,
                    selectedPullRequestUrl: I?.url ?? o,
                    repo: r?.repo ?? null,
                    showRepo: b,
                    onSelectPullRequest: c,
                    onToggleSection: () => {
    ...
    oe;
  return (
    t[32] !== q || t[33] !== B || t[34] !== ae || t[35] !== J || t[36] !== Y
      ? ((oe = (0, $.jsx)(q, {
          ariaLabel: ae,
    ...
    (0, $.jsxs)(`div`, {
      ...
      children: [
        (0, $.jsx)(ui, {
          hostId: I?.hostId ?? r?.hostId,
          item: I,
          relatedThreads: U,
          repo: I?.repo ?? r?.repo ?? null,
          onClose: G,
        }),
        K,
        oe,
...
function ui(e) {
  let t = (0, Z.c)(10),
    { hostId: n, item: r, relatedThreads: i, repo: o, onClose: s } = e,
    c = a(Me),
    l = r != null,
    u,
    d;
  ...
  let f;
  return (
    t[4] !== n || t[5] !== r || t[6] !== s || t[7] !== i || t[8] !== o
      ? ((f = (0, $.jsx)(V.RightPanelOutlet, {
          children: (0, $.jsx)(Tr, { hostId: n, item: r, relatedThreads: i, repo: o, onClose: s }),
        })),
        (t[4] = n),
        (t[5] = r),
        (t[6] = s),
...
function hi(e) {
  ...
  t[2] === h
    ? (g = t[3])
    : ((g = L(`icon-2xs shrink-0 transition-transform`, h)), (t[2] = h), (t[3] = g));
  let _;
  t[4] === g ? (_ = t[5]) : ((_ = (0, $.jsx)(we, { className: g })), (t[4] = g), (t[5] = _));
  let v;
...
function gi(e) {
  ...
  let u = l,
    ...
    p;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(je, { className: `icon-sm shrink-0` })), (t[7] = p))
    : (p = t[7]);
  let m;
  t[8] === u
    ? (m = t[9])
  ...
  t[10] === h
    ? (g = t[11])
    : ((g = L(`icon-2xs text-token-input-placeholder-foreground transition-transform`, h)),
      (t[10] = h),
      (t[11] = g));
  let _;
  t[12] === g ? (_ = t[13]) : ((_ = (0, $.jsx)(we, { className: g })), (t[12] = g), (t[13] = _));
  let v;
  ...
  let S;
  t[21] !== b || t[22] !== y
    ? ((S = (0, $.jsx)(X.Item, { className: y, onClick: b, children: x })),
      (t[21] = b),
      (t[22] = y),
      (t[23] = S))
    : (S = t[23]);
  ...
  return (
    t[32] !== d || t[33] !== S || t[34] !== w || t[35] !== v
      ? ((T = (0, $.jsxs)(ue, { onOpenChange: f, open: d, triggerButton: v, children: [S, C, w] })),
        (t[32] = d),
        (t[33] = S),
        (t[34] = w),
        (t[35] = v),
...
function _i(e) {
  let t = (0, Z.c)(63),
    { item: n, mergeMethod: r, onSelectPullRequest: i, repo: o, selected: c, showRepo: l } = e,
    u = a(s),
    d = ee(),
    f = g(),
    p = Ft(),
  ...
  let _ = rt(h),
    y;
  t[9] !== n || t[10] !== r || t[11] !== _ || t[12] !== o || t[13] !== u
    ? ((y = async (e) => {
        (e.stopPropagation(), Vt(u, { action: `merge`, item: n, surface: `pull_request_page` }));
        let t = await _.mutateAsync({ cwd: n.cwd, mergeMethod: r, number: n.number, repo: o });
        t.status !== `success` && u.get(K).danger(t.error);
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = _),
  ...
  let b = y,
    x;
  t[15] !== b || t[16] !== n || t[17] !== _.isPending || t[18] !== p || t[19] !== o
    ? ((x = vi({
    ...
    ? ((w = {
        ...
        onSelect: () => {
          (Vt(u, { action: `copy_url`, item: n, surface: `pull_request_page` }),
            Be(n.url).then(
              () => {
                u.get(K).success(d.formatMessage(ai.copyUrlSuccess));
              },
              () => {
                u.get(K).danger(d.formatMessage(ai.copyUrlError));
              },
            ));
        },
      }),
    ...
    ? ((T = {
        ...
        onSelect: () => {
          (Vt(u, { action: `open_in_browser`, item: n, surface: `pull_request_page` }),
            v.dispatchMessage(`open-in-browser`, { url: n.url }));
        },
      }),
      (t[25] = n),
      (t[26] = u),
  ...
  t[31] === n.state
    ? (O = t[32])
    : ((O = (0, $.jsx)(et, { className: `icon-sm shrink-0 translate-y-[2px]`, state: n.state })),
      (t[31] = n.state),
      (t[32] = O));
  let k;
  ...
  return (
    t[60] !== D || t[61] !== I
      ? ((L = (0, $.jsx)(G, { items: D, children: I })), (t[60] = D), (t[61] = I), (t[62] = L))
      : (L = t[62]),
    L
  );
}
...
var Si = H(`pull-request-board:last-selected-repo-key`, null);
function Ci() {
  let e = (0, Z.c)(39),
    t = ee(),
    n = Oe(),
    ...
    c = i.get(`repoKey`),
    l;
  e[0] === i ? (l = e[1]) : ((l = Zt(i.get(`view`))), (e[0] = i), (e[1] = l));
  let u = l,
    d;
  e[2] === i ? (d = e[3]) : ((d = i.get(`pullRequestUrl`)), (e[2] = i), (e[3] = d));
  let f = d,
    p;
  e[4] === i ? (p = e[5]) : ((p = en(i.get(`pullRequestNumber`))), (e[4] = i), (e[5] = p));
  let m = p,
    h = o(Ve),
    { isLoading: g } = o(le),
    _;
  ...
  e[15] !== n || e[16] !== i || e[17] !== C
    ...
    : (w = e[18]);
  let T;
  e[19] !== n || e[20] !== i || e[21] !== u || e[22] !== C
    ? ((T = (e, t) => {
        let r = new URLSearchParams(i);
        (C != null && r.set(`repoKey`, C),
          r.set(`view`, u),
          e == null
            ? (r.delete(`pullRequestNumber`), r.delete(`pullRequestUrl`))
            : (r.set(`pullRequestNumber`, String(e.number)), r.set(`pullRequestUrl`, e.url)),
          n(
