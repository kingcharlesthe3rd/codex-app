...
import { At as t, Kn as n, Nr as r, S as i, st as a, ut as o, vn as s } from "./src-2.js";
import {
  Rn as c,
  Ts as l,
  Uo as u,
...
import { m as x, s as S } from "./shiki-highlight-provider-gate.js";
...
import { n as R } from "./react.js";
import { c as z, o as B, r as V } from "./lib-2.js";
import { _ as ne, m as re, n as ie } from "./chunk-12.js";
import "./known-app-icon.js";
import "./branch.js";
import { t as ae } from "./github-mark.js";
import "./google-drive-CC-Egn92.js";
import "./notion.js";
import { c as H, g as U, v as W } from "./persisted-signal-CweW-bgN.js";
import "./rpc-1.js";
import "./statsig.js";
import "./request.js";
import { c as G } from "./app-server-manager-hooks.js";
import "./invalidate-queries-and-broadcast.js";
import { d as K } from "./thread-context-inputs.js";
...
import { t as Y } from "./route-scope.js";
import "./prompt-text.js";
import { t as oe } from "./persisted-atom.js";
import "./mention-item-C.js";
import { t as X } from "./use-collaboration-mode.js";
import "./use-model-settings.js";
import { t as se } from "./button.js";
import { a as ce, i as le } from "./setting-storage.js";
...
import { o as fe } from "./remote-projects.js";
import "./collaboration-mode-queries.js";
import "./thread-detail-level.js";
import "./permissions-mode-defaults.js";
import { c as pe } from "./use-permissions-mode.js";
import { t as me } from "./proxy.js";
import { x as he } from "./app-shell-state.js";
import { t as ge } from "./AnimatePresence.js";
import { t as _e } from "./app-shell.js";
import { t as ve } from "./use-service-tier-settings.js";
import "./apps.js";
import { t as ye } from "./x.js";
...
import { a as Oe, i as ke, l as Ae, n as je, r as Me } from "./dialog-layout.js";
...
import { r as Fe } from "./pending-worktree-store-B7c-n7Re.js";
import "./electron-menu-shortcuts.js";
import "./local-task-row-signals-n.js";
import { u as Ie } from "./sidebar-project-group-signals.js";
import "./sidebar-project-groups.js";
import "./_defineProperty.js";
import "./homepage-logo.js";
import { n as Le, t as Re } from "./loading-page.js";
...
import { t as ze } from "./checkbox.js";
import "./minus.js";
import "./badge-Bpp-zYoJ.js";
import { t as Be } from "./animations-D-vdA-0W.js";
import "./chat.js";
import "./clock.js";
import "./search-C0nm-Ej1.js";
import { r as Ve, t as He } from "./dropdown.js";
import "./globe.js";
import "./three-dots.js";
import { t as Ue } from "./chevron.js";
import { t as We } from "./format-relative-date-time.js";
import "./warning.js";
import "./unselected-circle-BN-IdXY-.js";
import { c as Ge, i as Ke, l as qe, p as Je, r as Ye, s as Xe } from "./pull-request-status.js";
import "./x-circle-filled.js";
import { n as Ze } from "./markdown-2.js";
import "./code-snippet.js";
import "./copy.js";
import "./copy-button.js";
import "./plus-d3DP-DMx.js";
import "./image-preview-dialog.js";
import { t as Qe } from "./github-details.js";
import { n as $e, r as et, t as tt } from "./pull-request-readonly-comment.js";
import { t as nt } from "./pull-request-open.js";
import { t as rt } from "./automation-queries.js";
import { t as it } from "./get-attached-heartbeat-automation-for-thread.js";
import "./use-is-background-subagents-enabled.js";
import "./local-environments.js";
import { r as at } from "./local-environment-selection.js";
import { t as ot } from "./arrow-up.js";
import { t as st } from "./bullet-separator.js";
import { t as ct } from "./check-lg.js";
import "./sortBy.js";
...
import { t as Dt } from "./file-tree-search-input.js";
...
import { t as jt } from "./folders.js";
...
import { a as Nt, c as Pt, s as Ft, t as It } from "./use-is-pull-request-merge-helper-enabled.js";
import { t as Lt } from "./selectable-list-row.js";
import { n as Rt, t as zt } from "./sectioned-page.js";
import { t as Bt } from "./segmented-toggle-BGk-vwSF.js";
import { t as Vt } from "./pull-request-fix-button.js";
var Z = N(),
  Ht = [`unmet_checks`, `draft`, `ready`, `merged`],
  Ut = { authored: `is:pr author:@me`, review: `is:pr is:open review-requested:@me` };
function Wt({ gitOrigins: e, workspaceGroups: n }) {
  let i = new Map(e.flatMap((e) => (e.originUrl == null ? [] : [[r(e.dir), e.originUrl]]))),
    a = new Map();
  for (let e of n) {
    let n = e.repositoryData?.ownerRepo;
    if (n == null || e.path == null) continue;
    let o = i.get(r(e.path));
    if (o == null) continue;
    let s = t(o);
    if (s == null) continue;
    let c = `${n.owner}/${n.repoName}`,
      l = `${s.owner}/${s.repo}`,
...
function Gt({ repoOptions: e, requestedRepoKey: t }) {
  return t === `all` ? null : (e.find((e) => e.key === t) ?? e[0] ?? null);
}
function Kt(e) {
  return Ht.map((t) => ({ key: t, items: e.filter((e) => en(e, t)) })).filter(
    (e) => e.items.length > 0,
  );
}
function qt(e) {
...
function Xt({ searchQuery: e, selectedFilterView: t }) {
  return t === `authored` && e.trim() === Jt(`authored`) ? null : e;
}
function Zt({ items: e, selectedPullRequestNumber: t, selectedPullRequestUrl: n }) {
...
function $t({ currentCwd: e, currentIsCodexWorktree: t, nextCwd: n, nextIsCodexWorktree: r }) {
...
var Q = e(y(), 1);
function tn(e, { action: t, item: n, surface: r }) {
  U(e, {
    eventName: `codex_pull_request_action_clicked`,
    metadata: { action: t, surface: r, state: n.state, is_author: n.isAuthor },
  });
}
function nn(e, { item: t, surface: n }) {
  U(e, {
    eventName: `codex_pull_request_selected`,
    metadata: { surface: n, state: t.state, is_author: t.isAuthor },
  });
}
function rn(e, { kind: t, surface: n }) {
  U(e, { eventName: `codex_pull_request_comment_posted`, metadata: { kind: t, surface: n } });
}
function an({ scope: e, event: t, intl: n, url: r }) {
  r &&
    De(r, t).then(
      () => {
        e.get(q).success(
...
function on(e) {
  ...
  if (t[0] !== o || t[1] !== r || t[2] !== i || t[3] !== s || t[4] !== a) {
    let e = Xe({ canFix: o, checks: r, intl: s, onFixCheck: a, onOpenCheck: sn });
          ...
          e.items.map((e, n) =>
            (0, $.jsx)(
              Mt,
              {
                ...
                icon: cn(e.status),
                label: (0, $.jsx)(J, {
                  tooltipContent: (0, $.jsx)(un, { status: e.status }),
                  children: (0, $.jsx)(`span`, {
...
function sn(e) {
  e.link != null && A.dispatchMessage(`open-in-browser`, { url: e.link });
}
function cn(e) {
  switch (e) {
    case `failing`:
      return ln(`text-token-charts-red`);
    case `pending`:
      return ln(`text-token-charts-yellow`);
    case `skipped`:
      return ln(`text-token-text-tertiary`);
    case `successful`:
      return ln(`text-token-charts-green`);
    case `unknown`:
      return ln(`text-token-text-tertiary`);
  }
}
function ln(e) {
  return (0, $.jsx)(`span`, {
    ...
    children: (0, $.jsx)(mt, { className: C(`icon-3xs`, e) }),
  });
}
function un(e) {
  let t = (0, Z.c)(5),
...
function dn({ cwd: e, headBranch: t, hostId: n }) {
...
function fn(e) {
  let t = (0, Z.c)(20),
    ...
    c;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((c = dn({ cwd: n, headBranch: r, hostId: i })),
      (t[0] = n),
      (t[1] = r),
      (t[2] = i),
      (t[3] = c))
    ...
    ? ((l = (e, t) => {
        ...
        (n({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
          ...
          Promise.all([
            ...
            s.invalidateQueries({
              queryKey: I(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
            }),
            s.invalidateQueries({
...
function gn({ includeReviewComments: e, item: t, repo: n }) {
  return [
    f,
    ``,
    ...Sn({ item: t, repo: n }),
...
function _n({ includeReviewComments: e, item: t, name: n, repo: r }) {
  return { name: n, prompt: yn({ includeReviewComments: e, item: t, repo: r }), rrule: bn() };
}
function vn(e) {
  return {
    id: e.id,
...
function yn({ includeReviewComments: e, item: t, repo: n }) {
  return [
...
function bn() {
  return vt({ ..._t(), intervalHours: 1, intervalMinutes: pn });
}
function xn(e) {
  return e
...
function Tn() {
  return [
    ...
    `Use ::${c}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
    `Do not count unrelated flakes, attempted fixes, or work that was already counted in an earlier turn.`,
  ].join(`
`);
}
function En({ conversationId: e, pendingWorktreeId: t }) {
...
function Dn(e) {
  let t = (0, Z.c)(31),
    ...
    l = z(),
    u = re(),
    { createPendingWorktree: d } = Fe(),
    f;
  t[0] !== n || t[1] !== r.cwd
    ? ((f = { conversationId: null, cwdOverride: r.cwd, hostId: n }),
      (t[0] = n),
      (t[1] = r.cwd),
      (t[2] = f))
    : (f = t[2]);
  let { agentMode: m, isAgentModePending: g } = pe(f),
    { activeMode: _ } = X(null),
    { serviceTierSettings: v } = ve(null),
    y;
  t[3] !== n || t[4] !== r.cwd
    ? ((y = { hostId: n, workspaceRoot: r.cwd }), (t[3] = n), (t[4] = r.cwd), (t[5] = y))
    : (y = t[5]);
  let { resolvedConfigPath: b } = at(y),
    x;
  t[6] !== _ ||
  t[7] !== m ||
  t[8] !== d ||
  ...
  t[14] !== v
    ? ((x = async (e) => {
        let t = gn({ includeReviewComments: e, item: r, repo: a }),
        ...
        return d({
          ...
          heartbeatAutomation: _n({ includeReviewComments: e, item: r, name: c, repo: a }),
        });
      }),
      (t[6] = _),
      (t[7] = m),
    ...
    : (x = t[15]);
  let S;
  t[16] !== r.url || t[17] !== u || t[18] !== i || t[19] !== c
    ? ((S = (e) => {
        (Pt(c, { pendingWorktreeId: e, pullRequestUrl: r.url }), i(), u(o(e)));
      }),
      (t[16] = r.url),
      (t[17] = u),
      (t[18] = i),
  ...
  t[21] !== l || t[22] !== c
    ? ((C = (e) => {
        (j.error(`Error starting pull request merge helper`, { safe: {}, sensitive: { error: e } }),
          c
            .get(q)
            .danger(
              l.formatMessage(
  ...
  return (
    t[28] !== g || t[29] !== E
      ? ((D = { ...E, isAgentModePending: g }), (t[28] = g), (t[29] = E), (t[30] = D))
      : (D = t[30]),
    D
  );
}
function On(e) {
  let t = (0, Z.c)(102),
    { className: n, hostId: r, item: i, repo: a, size: o, stopPropagation: s, surface: c } = e,
    ...
    g = w(),
    y = D(Nt, i.url),
    b = E(y.conversationId$),
    x = E(y.pendingWorktreeId$),
    S = E(rt),
    C = z(),
    O = re(),
    k = E(Ft),
    ...
    [M, N] = (0, Q.useState)(!1),
    P;
  t[0] !== C || t[1] !== h || t[2] !== g || t[3] !== m
    ? ((P = (e) => {
        (h.logProductEvent(v, {
          action: d.CODEX_AUTOMATION_ACTION_UPDATED,
          source: l.CODEX_AUTOMATION_SOURCE_PR_MERGE_HELPER,
          success: !0,
          ...gt(e.item),
        }),
          g.invalidateQueries({ queryKey: I(`list-automations`) }),
          m
            .get(q)
            .success(
              C.formatMessage({
        ...
        (h.logProductEvent(v, {
          ...
          failureReason:
            ...
            `Automation does not exist in the app and could not be updated. It may have been deleted manually by the user.`
              ? _.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION
              : _.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
        }),
          m
            .get(q)
            .danger(
  ...
  let L;
  t[9] !== P || t[10] !== F
    ? ((L = { onSuccess: P, onError: F }), (t[9] = P), (t[10] = F), (t[11] = L))
    : (L = t[11]);
  let R = te(`automation-update`, L),
    V = (0, Q.useId)(),
    ne = r ?? i.hostId ?? `local`,
    ie = S.data,
    ae = S.isLoading || S.isFetching,
    H,
    U,
    G;
  if (t[12] !== ie?.items || t[13] !== S.isError || t[14] !== ae || t[15] !== b || t[16] !== x) {
    H = it({ automations: ie?.items ?? [], conversationId: b, includePausedAutomations: !0 });
    let e = b == null && x != null;
    ((U = H?.status === `PAUSED`),
      (G = hn({
        automationStatus: H?.status,
        hasConversation: b != null,
        isAutomationsLoading: ae,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Y = t[20]);
  let oe;
  t[21] !== i || t[22] !== a || t[23] !== ne
    ? ((oe = { hostId: ne, item: i, onSuccess: Y, repo: a }),
      (t[21] = i),
      (t[22] = a),
      (t[23] = ne),
      (t[24] = oe))
  ...
  let X = Dn(oe),
    ...
    le = X.isPending || R.isPending || (!U && !K && X.isAgentModePending),
    ue;
  t[25] !== H ||
  t[26] !== K ||
  t[27] !== U ||
  ...
  t[37] !== x
    ? ((ue = (e) => {
        if ((f && e.stopPropagation(), U && H != null)) {
          (tn(m, { action: `merge_with_codex_resumed`, item: i, surface: p }), R.mutate(vn(H)));
          return;
        }
        if (K) {
          let e = En({ conversationId: b, pendingWorktreeId: x });
          e != null &&
            (tn(m, { action: `merge_with_codex_task_opened`, item: i, surface: p }), O(e));
          return;
        }
        if (!X.isAgentModePending) {
          if (k) {
            (tn(m, { action: `merge_with_codex_started`, item: i, surface: p }), X.mutate(!1));
            return;
          }
          (tn(m, { action: `merge_with_codex_dialog_opened`, item: i, surface: p }), j(!1), N(!0));
        }
      }),
      (t[25] = H),
      (t[26] = K),
  ...
  let de = ue,
    fe;
  t[39] !== A || t[40] !== i || t[41] !== m || t[42] !== X || t[43] !== p
    ? ((fe = (e) => {
        (e.preventDefault(),
          !X.isAgentModePending &&
            (tn(m, { action: `merge_with_codex_started`, item: i, surface: p }), X.mutate(A)));
      }),
      (t[39] = A),
      (t[40] = i),
      (t[41] = m),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((he = (0, $.jsx)(Ee, { className: `icon-xxs` })), (t[46] = he))
    : (he = t[46]);
  let ge;
  t[47] !== K || t[48] !== U
    ? ((ge = U
    ...
    : (ge = t[49]);
  let _e;
  t[50] !== n || t[51] !== de || t[52] !== le || t[53] !== u || t[54] !== ge
    ? ((_e = (0, $.jsx)(J, {
        tooltipContent: me,
        children: (0, $.jsxs)(se, {
          className: n,
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, $.jsx)(Ee, { className: `icon-sm text-token-foreground` })),
      (be = (0, $.jsx)(B, {
  ...
  t[63] === C
    ...
    : ((Te = C.formatMessage({
      ...
      (t[64] = Te));
  let De;
  t[65] !== A || t[66] !== X.isPending || t[67] !== Te
    ? ((De = (0, $.jsx)(Oe, {
        ...
        children: (0, $.jsxs)(`label`, {
          ...
          children: [
            Ce,
            (0, $.jsx)(lt, { checked: A, disabled: we, ariaLabel: Te, size: `sm`, onChange: j }),
          ],
        }),
      })),
      (t[65] = A),
  ...
  t[69] === m
    ...
    : ((Ne = (e) => {
      ...
      (t[70] = Ne));
  let Pe;
  t[71] !== k || t[72] !== V || t[73] !== X.isPending || t[74] !== Ne
    ? ((Pe = (0, $.jsx)(ze, { id: V, checked: k, disabled: X.isPending, onCheckedChange: Ne })),
      (t[71] = k),
      (t[72] = V),
      (t[73] = X.isPending),
      (t[74] = Ne),
  ...
  t[85] === ce
    ? (He = t[86])
    : ((He = (0, $.jsx)(se, { color: `primary`, loading: ce, type: `submit`, children: Ve })),
      (t[85] = ce),
      (t[86] = He));
  let Ue;
  t[87] !== Ie || t[88] !== Be || t[89] !== He
    ? ((Ue = (0, $.jsxs)(Me, { children: [Ie, Be, He] })),
      (t[87] = Ie),
      (t[88] = Be),
      (t[89] = He),
      (t[90] = Ue))
...
function kn(e) {
  let t = (0, Z.c)(96),
    { hostId: n, item: r, pullRequestBody: a, request: o, surface: s } = e,
  ...
  t[6] !== o
    ? ((g = async () => {
        await Promise.all([
          ...
          d.invalidateQueries({
            queryKey: I(`gh-pr-status`, { cwd: r.cwd, headBranch: r.headBranch, hostId: n }),
          }),
          d.invalidateQueries({
            queryKey: I(`gh-pr-status`, {
              cwd: r.cwd,
  ...
  t[8] !== _ || t[9] !== h || t[10] !== l
    ? ((v = (e) => {
        (async () => {
          (await _(),
            e && h !== `squash` && (await le(l, i.pullRequestMergeMethod, `squash`)),
            m(!1));
        })();
      }),
      (t[8] = _),
  ...
  let D = fn(E),
    O = a != null,
    k = a?.isDraft ?? r.state === `draft`,
    A = r.state === `merged` || a?.hasOpenPr === !1,
    j = a?.isAutoMergeEnabled === !0,
    M = !O || A || k || a?.canMerge !== !0 || x.isPending,
    N = !O || A || (!j && k) || C.isPending,
    P = !O || A || D.isPending,
    F;
  t[24] !== k || t[25] !== A || t[26] !== O || t[27] !== r || t[28] !== a || t[29] !== f
    ? ((F = f && O && !A && !k && a.canMerge !== !0 && mn(r)),
      (t[24] = k),
      (t[25] = A),
      (t[26] = O),
      (t[27] = r),
  ...
  t[37] !== c
    ? ((R = () => {
        ...
        (tn(l, { action: a.isDraft ? `mark_ready` : `mark_draft`, item: r, surface: c }),
          D.mutate(
            { action: e, cwd: r.cwd, number: r.number, repo: a.repo },
            {
              onSuccess: (t) => {
                if (t.status !== `success`) {
                  l.get(q).danger(t.error);
                  return;
                }
                (l.get(q).success(An(e, u)), y(!1));
              },
            },
          ));
      }),
  ...
  t[47] !== c
    ? ((ne = (e) => {
        a != null &&
          (tn(l, { action: e ? `enable_auto_merge` : `disable_auto_merge`, item: r, surface: c }),
          C.mutate(
            {
            ...
            },
            {
              onSuccess: (t) => {
                ...
                (l.get(q).success(An(`toggle-auto-merge`, u)), y(p && e));
              },
            },
          ));
      }),
  ...
  t[57] !== c
    ? ((ie = () => {
        a != null &&
          (tn(l, { action: `merge`, item: r, surface: c }),
          x.mutate(
            { cwd: r.cwd, mergeMethod: L, number: r.number, repo: a.repo },
            {
              onSuccess: (e) => {
                if (e.status !== `success`) {
                  jn({
  ...
  t[59] === k
    ...
    : ((H = k
      ...
      (t[60] = H));
  let U;
  t[61] !== D.isPending || t[62] !== P || t[63] !== V || t[64] !== H
    ? ((U = (0, $.jsx)(se, {
        color: `outline`,
        disabled: P,
        loading: D.isPending,
  ...
  t[66] === C.isPending
    ? (W = t[67])
    : ((W = C.isPending ? (0, $.jsx)(ue, { className: `icon-xxs` }) : null),
      (t[66] = C.isPending),
      (t[67] = W));
  let G;
  t[68] === W
    ? (G = t[69])
    : ((G = (0, $.jsx)(`span`, { className: `inline-flex w-3 justify-center`, children: W })),
      (t[68] = W),
      (t[69] = G));
  let K;
  ...
  t[71] === u
    ...
    : ((J = u.formatMessage({
      ...
      (t[72] = J));
  let Y;
  t[73] !== N || t[74] !== re || t[75] !== j || t[76] !== J
    ? ((Y = (0, $.jsx)(lt, { checked: j, disabled: N, ariaLabel: J, size: `sm`, onChange: re })),
      (t[73] = N),
      (t[74] = re),
      (t[75] = j),
      (t[76] = J),
...
function jn({ scope: e, error: t, intl: n, mergeMethod: r, onSquashRetry: i }) {
...
function Bn(e) {
  let t = (0, Z.c)(165),
    ...
    j = k.getItem(A, NaN),
    ee = Number.isFinite(j) && j <= 1,
    M;
  t[0] === l ? (M = t[1]) : ((M = Jn(l)), (t[0] = l), (t[1] = M));
  let N = ee ? qn(j) : M,
    [P, F] = (0, Q.useState)(0),
    [I, te] = (0, Q.useState)(!1),
    L = (0, Q.useRef)(null),
  ...
  t[2] === F
    ...
    : ((oe = () => {
      ...
      (t[3] = oe));
  let X;
  (t[4] === Symbol.for(`react.memo_cache_sentinel`) ? ((X = []), (t[4] = X)) : (X = t[4]),
    (0, Q.useLayoutEffect)(oe, X));
  let se;
  t[5] === F
    ? (se = t[6])
    : ((se = () => {
  ...
  (t[7] === Symbol.for(`react.memo_cache_sentinel`) ? ((ce = []), (t[7] = ce)) : (ce = t[7]),
    (0, Q.useEffect)(se, ce));
  let le, ue;
  (t[8] !== P || t[9] !== E || t[10] !== S || t[11] !== w || t[12] !== g
    ? ((le = () => {
        !P || !E || (!S && !w && g?.(!0));
      }),
      (ue = [P, E, S, w, g]),
  ...
  t[28] !== A
    ? ((de = () => {
        ...
        V.current ? i && Hn([ie, ae, U], z) : (Hn([ie, ae, U], z), (V.current = !0));
        let a = () => {
          ((ne.current = t), (re.current = O));
        };
        if (x > 0 && E && t <= x && !q) {
          (tr({ containerWidth: t, minRightWidth: y, isOpen: D, node: e, rafRef: R }), a());
          return;
        }
        let o = Gn(t);
        if (!E) {
        ...
        if (!D) {
          let { rightWidth: n, boundedLeftRatio: r } = $n({
            containerWidth: t,
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: o * qn(W.current),
          });
          W.current = r;
          let i = Qn(G.current > 0 ? G.current : n, o);
          ((G.current = i),
            rr({
              containerWidth: t,
              handleWidth: 0,
        ...
        let u = R.current;
        return () => {
          (u != null && (cancelAnimationFrame(u), R.current === u && (R.current = null)),
  ...
  t[44] !== k ||
  t[45] !== A
    ? ((fe = [P, O, D, Y, x, q, E, J, S, w, I, v, y, T, k, A]),
      (t[30] = P),
      (t[31] = x),
      (t[32] = Y),
      (t[33] = O),
  ...
  t[87] !== _
    ? ((_e = (e) => {
        ...
        if (!t || !n) return;
        if (J) {
          tr({ containerWidth: n, minRightWidth: y, isOpen: !1, node: t, rafRef: R });
          return;
        }
        let r = Gn(n),
          { rightWidth: i, boundedLeftRatio: a } = $n({
            containerWidth: n,
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: r * qn(W.current),
          });
        W.current = a;
        let o = Qn(G.current > 0 ? G.current : i, r);
        ((G.current = o),
          rr({
            containerWidth: n,
            handleWidth: 0,
  ...
  t[101] !== A
    ? ((ye = (e) => {
        ...
        if (w || !E) return;
        if ((Un([ie, ae, U], z), _?.(!0), J)) {
          tr({ containerWidth: n, minRightWidth: y, isOpen: !0, node: t, rafRef: R });
          return;
        }
        let {
          boundedLeftWidth: r,
  ...
  let be = ye,
    xe;
  t[103] !== ve || t[104] !== be || t[105] !== S || t[106] !== w
    ? ((xe = (e) => {
        if (e === `left`) {
          if (S) {
            ve(`left`);
  ...
  let Se = xe,
    Ce;
  t[108] !== ve || t[109] !== O || t[110] !== D || t[111] !== be || t[112] !== I || t[113] !== Se
    ? ((Ce = {
        isLeftOpen: O,
        isRightOpen: D,
        isResizing: I,
  ...
  let we = Ce,
    Te = E && !J && O && D,
    Ee = `min(calc(100% - ${b}px), max(0px, ${O && D ? `calc(var(--split-left-width, 100%) - (${b}px / 2))` : `calc(100% - (${b}px / 2))`}))`,
    De = I && `cursor-col-resize`,
    Oe;
  t[115] !== a || t[116] !== De
    ? ((Oe = C(`group/split-view relative h-full w-full min-w-0 overflow-hidden`, De, a)),
      (t[115] = a),
      (t[116] = De),
      (t[117] = Oe))
    : (Oe = t[117]);
  ...
  t[127] !== Ae || t[128] !== Me || t[129] !== Fe
    ? ((Ie = (0, $.jsx)(`div`, { ref: ie, className: Ae, style: Me, children: Fe })),
      (t[127] = Ae),
      (t[128] = Me),
      (t[129] = Fe),
      (t[130] = Ie))
        ...
        ? (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(Q.Activity, {
              ...
              children: (0, $.jsx)(`div`, {
                ...
                style: { transitionDelay: D ? `${Ln}ms` : `0ms` },
                children: i,
              }),
            }),
          })
  ...
  t[153] !== Ve || t[154] !== Ue || t[155] !== We
    ? ((Ge = (0, $.jsx)(`div`, { ref: U, className: Ve, style: Ue, children: We })),
      (t[153] = Ve),
      (t[154] = Ue),
      (t[155] = We),
      (t[156] = Ge))
  ...
  t[157] !== Oe || t[158] !== Ie || t[159] !== Le || t[160] !== Ge
    ? ((Ke = (0, $.jsxs)(`div`, { ref: L, className: Oe, children: [Ie, Le, Ge] })),
      (t[157] = Oe),
      (t[158] = Ie),
      (t[159] = Le),
      (t[160] = Ge),
  ...
  return (
    t[162] !== we || t[163] !== Ke
      ? ((qe = (0, $.jsx)(zn.Provider, { value: we, children: Ke })),
        (t[162] = we),
        (t[163] = Ke),
        (t[164] = qe))
      : (qe = t[164]),
...
function $n({ containerWidth: e, minLeftWidth: t, minRightWidth: n, leftWidth: r }) {
  let i = Gn(e),
    a = Zn(r, e, t, n),
    o = Qn(Math.max(0, i - a), i);
  return { openAvailableWidth: i, boundedLeftWidth: a, boundedLeftRatio: Yn(i, a), rightWidth: o };
}
function er(e, t) {
  let n = Math.min(t, e),
    r = e * In;
  return Qn(Math.max(n, r), e);
}
function tr({ containerWidth: e, minRightWidth: t, isOpen: n, node: r, rafRef: i }) {
  let a = er(e, t);
  rr({
    containerWidth: e,
    handleWidth: 0,
...
var ar = M(ee, `gh-current-user`, (e) => ({ params: { hostId: e }, staleTime: L.ONE_MINUTE })),
  or = 25,
  sr = 100,
  cr = 50,
  lr = 0,
  ur = `pull-request-code-review-file-tree-left`;
function dr(e) {
  let t = (0, Z.c)(50),
  ...
  t[33] === C
    ? (w = t[34])
    : ((w = (0, $.jsx)(pt, { diffControls: C, showHideWhitespace: !1, showLoadFullFiles: !1 })),
      (t[33] = C),
      (t[34] = w));
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, $.jsx)(jt, { className: `icon-xs` })), (t[38] = k))
    : (k = t[38]);
  let A;
  t[39] !== h || t[40] !== n || t[41] !== D || t[42] !== O
    ? ((A = (0, $.jsx)(se, {
        "aria-label": h,
        "aria-pressed": n,
        color: D,
  ...
  let j;
  t[44] !== h || t[45] !== A
    ? ((j = (0, $.jsx)(J, { tooltipContent: h, delayOpen: !0, children: A })),
      (t[44] = h),
      (t[45] = A),
      (t[46] = j))
    : (j = t[46]);
  ...
  return (
    t[47] !== j || t[48] !== w
      ? ((ee = (0, $.jsxs)(`div`, { className: `flex items-center gap-px`, children: [w, j] })),
        (t[47] = j),
        (t[48] = w),
        (t[49] = ee))
      : (ee = t[49]),
...
function pr({
  ...
  let l = T(ee),
    ...
    [g, _] = (0, Q.useState)(),
    [v, y] = (0, Q.useState)({}),
    [b, C] = (0, Q.useState)(null),
    [w, D] = (0, Q.useState)(``),
    k = (0, Q.useRef)(new Map()),
    [A, j] = (0, Q.useState)(() => new Set()),
    { data: M } = O(ar, t),
    N = (0, Q.useCallback)((e, t) => {
      let n = m(e);
      j((e) => {
    ...
    F = (0, Q.useCallback)(
      (e) => {
        let t = Et(e),
          n = k.current.get(t);
        (k.current.delete(t), n != null && N(n, !1));
      },
      [N],
    ),
    I = (0, Q.useCallback)((e) => {
    ...
    { data: V, isLoading: ne } = P(`gh-pr-diff`, {
      source: `pull_request_board`,
      params: { cwd: e, hostId: t, number: r, repo: o ?? null },
      queryConfig: { refetchOnWindowFocus: `always`, staleTime: L.FIVE_SECONDS },
    }),
    [re] = (0, Q.useState)(() => new x()),
    ie = (0, Q.useCallback)(
      (e) => {
        if (e != null) {
          re.setup(e);
    ...
    H = V?.status === `success` ? we(V.unifiedDiff) : [],
    U = H.map((e) => e.metadata.name),
    W = M?.status === `success` ? M.avatarUrl : void 0,
    G =
      M?.status === `success`
        ? M.login
        : f.formatMessage({
    ...
    K = w.trim().length === 0 ? U : U.filter((e) => e.includes(w.trim())),
    J = (0, Q.useMemo)(
      () =>
        a == null || a.length === 0 ? void 0 : wt({ comments: a, filePaths: U, workspaceRoot: e }),
      [e, U, a],
    );
  function Y(e) {
  ...
  let oe = (0, Q.useCallback)(
      (n) => {
        ...
        (k.current.set(Et(i), n), N(n, !0), R.mutate(i));
      },
      [e, t, r, R, o, N],
    ),
    X = (0, Q.useCallback)(
      (e, t) => {
        let n = St({ currentComments: v[e] ?? [], nextComments: t });
        (C(null), y((n) => ({ ...n, [e]: t })));
        for (let e of n) oe(e);
      },
      [v, oe],
...
function hr(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (b = t[0]);
  let x = te(`gh-pr-comment`, b),
    { data: S } = O(ar, i),
    w;
  t[1] === g ? (w = t[2]) : ((w = g.trim()), (t[1] = g), (t[2] = w));
  let E = w,
    D = l != null,
    k;
  t[3] !== i ||
  ...
  t[12] !== E
    ? ((k = async (e) => {
        if ((e.preventDefault(), !E || x.isPending)) return;
        y(null);
        let t = await x
          .mutateAsync({
            body: E,
        ...
        (rn(m, { kind: D ? `reply` : `comment`, surface: p }), _(``), await s().catch(gr));
      }),
      (t[3] = i),
      (t[4] = D),
      (t[5] = a),
    ...
    : (k = t[13]);
  let A = k,
    j = S?.status === `success` ? S : void 0,
    M;
  t[14] !== h || t[15] !== j
    ? ((M = br({ intl: h, user: j })), (t[14] = h), (t[15] = j), (t[16] = M))
    : (M = t[16]);
  let N = M,
    P = D && `w-full`,
    F;
  t[17] === P ? (F = t[18]) : ((F = C(`flex flex-col gap-2`, P)), (t[17] = P), (t[18] = F));
  let I;
  ...
  t[29] === v
    ...
    : ((B =
        v == null
          ? null
          : (0, $.jsx)(`div`, { className: `px-1 text-sm text-token-charts-red`, children: v })),
      (t[29] = v),
      (t[30] = B));
  let V;
  return (
    t[31] !== A || t[32] !== R || t[33] !== B || t[34] !== F
      ? ((V = (0, $.jsxs)(`form`, { className: F, onSubmit: A, children: [R, B] })),
        (t[31] = A),
        (t[32] = R),
        (t[33] = B),
        (t[34] = F),
...
function vr(e) {
  ...
  t[10] === v
    ? (y = t[11])
    : ((y = C(`flex min-w-0 items-center gap-2`, v)), (t[10] = v), (t[11] = y));
  let b;
  t[12] === s
    ? (b = t[13])
    : ((b = (e) => {
  ...
  t[24] === a
    ? (w = t[25])
    : ((w = a ? null : (0, $.jsx)(ot, { className: `icon-xs` })), (t[24] = a), (t[25] = w));
  let T;
  t[26] !== a || t[27] !== u || t[28] !== p || t[29] !== w
    ? ((T = (0, $.jsx)(se, {
        "aria-label": p,
        color: `primary`,
        disabled: u,
  ...
  let E;
  t[31] !== p || t[32] !== T
    ? ((E = (0, $.jsx)(J, { delayDuration: 250, tooltipContent: p, children: T })),
      (t[31] = p),
      (t[32] = T),
      (t[33] = E))
    : (E = t[33]);
  ...
  return (
    t[34] !== n || t[35] !== E || t[36] !== y || t[37] !== x || t[38] !== S
      ? ((D = (0, $.jsxs)(`div`, { className: y, children: [n, x, S, E] })),
        (t[34] = n),
        (t[35] = E),
        (t[36] = y),
        (t[37] = x),
...
function xr(e) {
  let t = (0, Z.c)(24),
    { item: n } = e,
    r = D(Nt, n.url),
    i = E(r.conversationId$),
    a = E(r.pendingWorktreeId$),
    o = E(r.ciJobsFixed$),
    s = E(r.mergeConflictsResolved$),
    c = E(rt),
    l = c.data,
    u,
    d,
  ...
  if (t[0] !== l?.items || t[1] !== i || t[2] !== a) {
    let e = it({ automations: l?.items ?? [], conversationId: i, includePausedAutomations: !0 });
    u = i == null && a != null;
    let n;
    (t[6] !== i || t[7] !== a
      ? ((n = En({ conversationId: i, pendingWorktreeId: a })), (t[6] = i), (t[7] = a), (t[8] = n))
      : (n = t[8]),
      (f = n),
      (d = Sr({ automationStatus: e?.status, isTaskStarting: u })),
      (t[0] = l?.items),
      (t[1] = i),
      (t[2] = a),
      (t[3] = u),
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, $.jsx)(Ee, { className: `icon-xs shrink-0` })), (t[10] = h))
    : (h = t[10]);
  let g;
  t[11] === p
    ? (g = t[12])
    : ((g = (0, $.jsxs)(`span`, {
        ...
        children: [
          h,
          (0, $.jsx)(`span`, { className: `truncate`, children: (0, $.jsx)(Cr, { status: p }) }),
        ],
      })),
      (t[11] = p),
      (t[12] = g));
  let _;
  t[13] !== o || t[14] !== s
    ? ((_ = (0, $.jsx)(Tr, { ciJobsFixed: o, mergeConflictsResolved: s })),
      (t[13] = o),
      (t[14] = s),
      (t[15] = _))
    : (_ = t[15]);
  let v;
  t[16] !== g || t[17] !== _
    ? ((v = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [g, _] })),
      (t[16] = g),
      (t[17] = _),
      (t[18] = v))
    : (v = t[18]);
  let y;
  t[19] === f ? (y = t[20]) : ((y = (0, $.jsx)(wr, { taskRoute: f })), (t[19] = f), (t[20] = y));
  let b;
  return (
    t[21] !== v || t[22] !== y
      ? ((b = (0, $.jsxs)(`div`, {
...
function Sr({ automationStatus: e, isTaskStarting: t }) {
  switch (t ? `STARTING` : e) {
    case `STARTING`:
      return `STARTING`;
    case `ACTIVE`:
...
function Tr(e) {
  ...
  let s;
  t[4] !== i || t[5] !== a
    ? ((s = i && a ? (0, $.jsx)(st, { className: `shrink-0` }) : null),
      (t[4] = i),
      (t[5] = a),
      (t[6] = s))
    : (s = t[6]);
...
function Er(e) {
  let t = (0, Z.c)(112),
    ...
    d = T(Y),
    f = z(),
    [p, m] = (0, Q.useState)(`pull-request`),
    h = l ? p : `pull-request`,
    [g, _] = (0, Q.useState)(!1),
    v;
  t[0] !== n || t[1] !== r || t[2] !== o
    ? ((v = Kr({ hostId: n, item: r, repo: o })), (t[0] = n), (t[1] = r), (t[2] = o), (t[3] = v))
    : (v = t[3]);
  let y = v,
    b = h === `code-review`,
    x;
  t[4] === b
    ? (x = t[5])
    : ((x = { enabled: b, intervalMs: L.ONE_MINUTE, staleTime: L.ONE_MINUTE }),
      (t[4] = b),
      (t[5] = x));
  let S;
  t[6] !== y || t[7] !== x
    ? ((S = { source: `pull_request_board`, params: y, queryConfig: x }),
      ...
      (t[8] = S))
    : (S = t[8]);
  let { data: w, refetch: E } = P(`gh-pr-comments`, S),
    D;
  t[9] === w
    ? (D = t[10])
    : ((D = w?.status === `success` ? w.commentAttachments : []), (t[9] = w), (t[10] = D));
  let O = D,
    k;
  t[11] !== f || t[12] !== r || t[13] !== d || t[14] !== u
    ? ((k = function (e) {
        (tn(d, { action: `copy_url`, item: r, surface: u }),
          an({ scope: d, event: e, intl: f, url: r.url }));
      }),
      (t[11] = f),
      (t[12] = r),
      (t[13] = d),
  ...
  t[23] !== d ||
  t[24] !== u
    ? ((M = [f, r.isAuthor, r.state, r.url, d, u]),
      (t[19] = f),
      (t[20] = r.isAuthor),
      (t[21] = r.state),
      (t[22] = r.url),
      ...
      (t[25] = M))
    : (M = t[25]),
    F(`copy-working-directory`, ee, M));
  let N;
  t[26] === r.state
    ? (N = t[27])
    : ((N = (0, $.jsx)(Ye, { className: `icon-sm shrink-0`, state: r.state })),
      (t[26] = r.state),
      (t[27] = N));
  let I;
  t[28] === r.title
  ...
  let V;
  t[35] !== N || t[36] !== R
    ? ((V = (0, $.jsxs)(`div`, { className: `flex min-w-0 items-center gap-2`, children: [N, R] })),
      (t[35] = N),
      (t[36] = R),
      (t[37] = V))
    : (V = t[37]);
  ...
  t[38] === r.headBranch
    ? (ne = t[39])
    : ((ne = (0, $.jsx)(`span`, { className: `truncate`, children: r.headBranch })),
      (t[38] = r.headBranch),
      (t[39] = ne));
  let re;
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = (0, $.jsx)(`span`, { className: `shrink-0`, children: `->` })), (t[40] = re))
    : (re = t[40]);
  let ie;
  t[41] === r.baseBranch
    ? (ie = t[42])
    : ((ie = (0, $.jsx)(`span`, { className: `truncate`, children: r.baseBranch })),
      (t[41] = r.baseBranch),
      (t[42] = ie));
  let ae;
  t[43] !== ne || t[44] !== ie
  ...
  let H;
  t[46] !== V || t[47] !== ae
    ? ((H = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [V, ae] })),
      (t[46] = V),
      (t[47] = ae),
      (t[48] = H))
    : (H = t[48]);
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, $.jsx)(ft, { className: `icon-xs` })), (t[53] = G))
    : (G = t[53]);
  let K;
  t[54] !== j || t[55] !== W
    ? ((K = (0, $.jsx)(se, {
  ...
  let q;
  t[57] !== U || t[58] !== K
    ? ((q = (0, $.jsx)(J, { tooltipContent: U, children: K })),
      (t[57] = U),
      (t[58] = K),
      (t[59] = q))
    : (q = t[59]);
  ...
  t[64] !== r || t[65] !== d || t[66] !== u
    ? ((ce = () => {
        (tn(d, { action: `open_in_browser`, item: r, surface: u }),
          A.dispatchMessage(`open-in-browser`, { url: r.url }));
      }),
      (t[64] = r),
      (t[65] = d),
      (t[66] = u),
  ...
  t[68] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((le = (0, $.jsx)(de, { className: `icon-xs` })), (t[68] = le))
    : (le = t[68]);
  let ue;
  t[69] !== X || t[70] !== ce
    ? ((ue = (0, $.jsx)(se, {
  ...
  let fe;
  t[72] !== oe || t[73] !== ue
    ? ((fe = (0, $.jsx)(J, { tooltipContent: oe, children: ue })),
      (t[72] = oe),
      (t[73] = ue),
      (t[74] = fe))
    : (fe = t[74]);
  ...
  t[77] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, $.jsx)(ye, { className: `icon-xs` })), (t[77] = me))
    : (me = t[77]);
  let he;
  t[78] !== i || t[79] !== pe
    ? ((he = (0, $.jsx)(se, {
    ...
    ? ((ve = l
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              ...
              h === `code-review`
                ? (0, $.jsx)(dr, { isFileTreeOpen: g, onFileTreeOpenChange: _ })
                : null,
            ],
          })
        : null),
    ...
    ? ((be = (0, $.jsx)(`div`, {
        ...
        children:
          h === `code-review`
            ...
            : (0, $.jsx)(Dr, { hostId: n, item: r, relatedThreads: a, request: y, surface: u }),
      })),
      (t[97] = h),
      (t[98] = n),
      (t[99] = g),
...
function Dr(e) {
  let t = (0, Z.c)(26),
    ...
    s = It(),
    c;
  t[0] === a ? (c = t[1]) : ((c = (0, $.jsx)(Ar, { request: a })), (t[0] = a), (t[1] = c));
  let l;
  t[2] !== r || t[3] !== s
    ? ((l = s ? (0, $.jsx)(xr, { item: r }) : null), (t[2] = r), (t[3] = s), (t[4] = l))
    : (l = t[4]);
  let u;
  t[5] === i ? (u = t[6]) : ((u = (0, $.jsx)(Or, { threads: i })), (t[5] = i), (t[6] = u));
  let d, f;
  t[7] === a
    ? ((d = t[8]), (f = t[9]))
    : ((d = (0, $.jsx)(jr, { request: a })),
      (f = (0, $.jsx)(Mr, { request: a })),
      (t[7] = a),
      (t[8] = d),
      (t[9] = f));
  let p, m, h;
  t[10] !== n || t[11] !== r || t[12] !== a || t[13] !== o
    ? ((p = (0, $.jsx)(Fr, { hostId: n, item: r, request: a, surface: o })),
      (m = (0, $.jsx)(Ir, { hostId: n, item: r, request: a, surface: o })),
      (h = (0, $.jsx)(Lr, { hostId: n, item: r, request: a, surface: o })),
      (t[10] = n),
      (t[11] = r),
      (t[12] = a),
      (t[13] = o),
...
function Or(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (r = t[0]);
  let i;
  t[1] === n ? (i = t[2]) : ((i = n.map(kr)), (t[1] = n), (t[2] = i));
  let a;
  return (
    t[3] === i
      ? (a = t[4])
...
function Ar(e) {
  let t = (0, Z.c)(16),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = { intervalMs: L.ONE_MINUTE, staleTime: L.ONE_MINUTE }), (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = P(`gh-pr-body`, i),
  ...
  if (s) {
    ...
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[3]);
    let n;
    t[4] === o ? (n = t[5]) : ((n = ni(o)), (t[4] = o), (t[5] = n));
    let r;
    return (
      t[6] === n
        ? (r = t[7])
        : ((r = (0, $.jsx)(ri, { title: e, description: n })), (t[6] = n), (t[7] = r)),
      r
    );
  }
  if (l || a == null) {
...
function jr(e) {
  let t = (0, Z.c)(21),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = { intervalMs: L.ONE_MINUTE, staleTime: L.ONE_MINUTE }), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === n
    ? (a = t[2])
    : ((a = { source: `pull_request_board`, params: n, queryConfig: i }), (t[1] = n), (t[2] = a));
  let { data: o, error: s, isError: c, isFetching: l, isLoading: u } = P(`gh-pr-comments`, a);
  if (c) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(B, {
      ...
      : (e = t[3]);
    let n;
    t[4] === s ? (n = t[5]) : ((n = ni(s)), (t[4] = s), (t[5] = n));
    let r;
    return (
      t[6] === n
        ? (r = t[7])
  ...
  t[12] !== o.reviewers || t[13] !== r
    ? ((p = dt(o.reviewers, r)), (t[12] = o.reviewers), (t[13] = r), (t[14] = p))
    : (p = t[14]);
  let m;
...
function Mr(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = P(`gh-pr-checks`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(B, {
  ...
  t[11] !== a.checks || t[12] !== a.ciStatus
    ? ((d = (0, $.jsx)(Nr, { checks: a.checks, ciStatus: a.ciStatus })),
      (t[11] = a.checks),
      (t[12] = a.ciStatus),
      (t[13] = d))
    : (d = t[13]);
...
function Nr(e) {
  ...
  let o;
  t[0] !== n || t[1] !== r
    ? ((o = Ge({ checks: n, ciStatus: r })), (t[0] = n), (t[1] = r), (t[2] = o))
    : (o = t[2]);
  let s;
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(Ue, { className: `icon-2xs` })), (t[7] = u))
    : (u = t[7]);
  let d;
  t[8] === l
    ? (d = t[9])
  ...
  t[11] !== i || t[12] !== o || t[13] !== s || t[14] !== d
    ? ((p = (0, $.jsx)(Mt, { ariaExpanded: i, icon: o, label: s, trailing: d, onClick: f })),
      (t[11] = i),
      (t[12] = o),
      (t[13] = s),
      (t[14] = d),
  ...
  t[19] === m
    ? (h = t[20])
    : ((h = (0, $.jsx)(ge, { initial: !1, children: m })), (t[19] = m), (t[20] = h));
  let g;
  return (
    t[21] !== h || t[22] !== p
...
function Fr(e) {
  let t = (0, Z.c)(36),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = { intervalMs: L.ONE_MINUTE, staleTime: L.ONE_MINUTE }), (t[0] = o))
    : (o = t[0]);
  let s;
  t[1] === i
    ? (s = t[2])
  ...
  let {
    ...
    m = d && c != null,
    h;
  t[3] === m ? (h = t[4]) : ((h = (0, $.jsx)($r, { isFetching: m })), (t[3] = m), (t[4] = h));
  let g = h;
  if (u) {
    let e;
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[5]);
    let n;
    t[6] === l ? (n = t[7]) : ((n = ni(l)), (t[6] = l), (t[7] = n));
    let r;
    return (
      t[8] === n
        ? (r = t[9])
        : ((r = (0, $.jsx)(ri, { title: e, description: n })), (t[8] = n), (t[9] = r)),
      r
    );
  }
  if (f || c == null) {
  ...
  if (c.activityItems.length === 0) {
    ...
    t[11] === g
      ? (e = t[12])
      : ((e = (0, $.jsx)(Ve.SectionLabel, { children: g })), (t[11] = g), (t[12] = e));
    let n;
  ...
  t[16] === g
    ? (_ = t[17])
    : ((_ = (0, $.jsx)(Ve.SectionLabel, { children: g })), (t[16] = g), (t[17] = _));
  let v;
  if (
...
function Ir(e) {
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== a || t[6] !== s || t[7] !== c
      ? ((l = (0, $.jsx)(hr, { hostId: n, item: r, repo: s, surface: a, onCommentPosted: c })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = a),
        (t[6] = s),
...
function Lr(e) {
  ...
  t[1] === i
    ? (s = t[2])
    : ((s = { source: `pull_request_board`, params: i, queryConfig: o }), (t[1] = i), (t[2] = s));
  let { data: c, error: l, isError: u, isFetching: d, isLoading: f } = P(`gh-pr-body`, s);
  if (!r.isAuthor) return null;
  if (u) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[3]);
    let n;
    t[4] === l ? (n = t[5]) : ((n = ni(l)), (t[4] = l), (t[5] = n));
    let r;
    return (
      t[6] === n
        ? (r = t[7])
  ...
  t[11] !== n || t[12] !== r || t[13] !== i || t[14] !== a || t[15] !== m || t[16] !== h
    ? ((g = (0, $.jsx)(kn, { hostId: n, item: r, pullRequestBody: h, request: i, surface: a }, m)),
      (t[11] = n),
      (t[12] = r),
      (t[13] = i),
      (t[14] = a),
...
function Rr(e) {
  ...
  if (r.type === `event`) {
    let e;
    return (
      t[0] === r ? (e = t[1]) : ((e = (0, $.jsx)(Br, { item: r })), (t[0] = r), (t[1] = e)), e
    );
  }
  let u;
...
function zr(e) {
  let t = (0, Z.c)(10),
    { item: n, onReply: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = Gr(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === a
    ? (o = t[3])
  ...
  t[5] === r
    ? (c = t[6])
    : ((c = (0, $.jsx)(se, { color: `ghost`, size: `composerSm`, onClick: r, children: s })),
      (t[5] = r),
      (t[6] = c));
  let l;
  return (
...
function Br(e) {
  ...
  t[10] !== a || t[11] !== n
    ? ((u = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(Vr, { actorLabel: a, item: n }),
      })),
      (t[10] = a),
      (t[11] = n),
      (t[12] = u))
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (d = t[13]);
  let f;
  t[14] === n.createdAt ? (f = t[15]) : ((f = et(n.createdAt)), (t[14] = n.createdAt), (t[15] = f));
  let p;
  t[16] === n.createdAt
    ? (p = t[17])
    : ((p = (0, $.jsx)(`span`, {
        className: `inline`,
        children: (0, $.jsx)(We, { dateString: n.createdAt }),
      })),
      (t[16] = n.createdAt),
      (t[17] = p));
  let m;
...
function Vr(e) {
  let t = (0, Z.c)(10),
    ...
    a;
  t[0] !== i || t[1] !== r.event
    ? ((a = Hr(r.event, i)), (t[0] = i), (t[1] = r.event), (t[2] = a))
    : (a = t[2]);
  let o = a,
    s;
  t[3] === o ? (s = t[4]) : ((s = (0, $.jsx)(`span`, { children: o })), (t[3] = o), (t[4] = s));
  let c;
  t[5] === n ? (c = t[6]) : ((c = (0, $.jsx)(Ur, { children: n })), (t[5] = n), (t[6] = c));
  let l;
  return (
    t[7] !== s || t[8] !== c
...
function Wr(e) {
  switch (e) {
    case `approved`:
      return { Icon: ct, iconClassName: `text-token-charts-green` };
    case `changes_requested`:
      return { Icon: ye, iconClassName: `text-token-charts-red` };
    case `merged`:
      return { Icon: Ke, iconClassName: `text-token-charts-purple` };
    case `opened`:
...
function Kr({ hostId: e, item: t, repo: n }) {
...
function Jr() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, $.jsx)(Ve.SectionLabel, { children: (0, $.jsx)(Qr, {}) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(Mt, {
            icon: (0, $.jsx)(ue, { className: `icon-sm shrink-0 text-token-text-tertiary` }),
            label: (0, $.jsx)(B, {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(Ve.SectionLabel, { children: (0, $.jsx)($r, {}) }),
            (0, $.jsx)(Zr, {}),
          ],
        })),
        (e[0] = t))
    ...
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, $.jsx)(ei, { className: `w-32` }),
            (0, $.jsx)(ei, { className: `w-11/12` }),
          ],
        })),
        (e[0] = t))
      : (t = e[0]),
...
function $r(e) {
  ...
  t[1] === r
    ? (a = t[2])
    : ((a = r ? (0, $.jsx)(ue, { className: `icon-xxs text-token-description-foreground` }) : null),
      (t[1] = r),
      (t[2] = a));
  let o;
  return (
...
function ti(e) {
  let t = (0, Z.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(ue, { className: `icon-xxs` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function ri(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, $.jsx)(Ve.SectionLabel, { className: `px-0 py-0`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function ci(e) {
  let t = (0, Z.c)(38),
    {
      selectedFilterView: r,
      repoOption: a,
      repoOptions: o,
      selectedPullRequestNumber: s,
      selectedPullRequestUrl: c,
      selectedRepoKey: l,
      onSelectPullRequest: u,
      onSelectFilterView: d,
      onSelectRepo: f,
    } = e,
    p = z(),
    { data: m } = G(),
  ...
  t[1] === r
    ? (b = t[2])
    : ((b = Xt({ searchQuery: Jt(r), selectedFilterView: r })), (t[1] = r), (t[2] = b));
  let x = b,
    S = l === `all`,
    C;
  t[3] !== x ||
  ...
  t[8] !== o
    ? ((C = S
        ? { repos: o.map(ui), searchQuery: x }
        : { cwd: n(a?.cwd ?? `/`), hostId: a?.hostId, repo: a?.repo ?? null, searchQuery: x }),
      (t[3] = x),
      (t[4] = S),
      (t[5] = a?.cwd),
      (t[6] = a?.hostId),
      ...
      (t[9] = C))
    : (C = t[9]);
  let w = S ? o.length > 0 : a != null,
    T;
  t[10] === w
    ? (T = t[11])
    : ((T = { enabled: w, intervalMs: L.THIRTY_SECONDS, staleTime: L.THIRTY_SECONDS }),
      (t[10] = w),
      (t[11] = T));
  let E;
  t[12] !== C || t[13] !== T
    ? ((E = { source: `pull_request_board`, params: C, queryConfig: T }),
      (t[12] = C),
      (t[13] = T),
      (t[14] = E))
    : (E = t[14]);
  let { data: D, isLoading: O } = P(`gh-pr-board`, E),
    k = ce(i.pullRequestMergeMethod),
    A = D?.status === `success` ? D.items : [],
    j = Kt(A),
    ee = j.find(li)?.items[0] ?? null,
    M = Zt({ items: A, selectedPullRequestNumber: s, selectedPullRequestUrl: c }),
    N = `${l ?? ``}:${r}:${x ?? ``}`,
    F = s != null || c != null;
  (0, Q.useEffect)(() => {
    ee == null || F || v === N || (y(N), u(ee, { replace: !0 }));
  }, [N, v, ee, F, u]);
  let I;
  t[15] === p
    ? (I = t[16])
    : ((I = (e) => ({ id: xi(e.key), title: p.formatMessage(Si(e.key)) })),
      (t[15] = p),
      (t[16] = I));
  let te = j.map(I),
    R = qt(m ?? []),
    V = M == null ? si : (R.get(M.headBranch.trim()) ?? si),
    ne;
    ...
    ? ((re = (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(_i, { repoOptions: o, selectedRepoKey: l, onSelect: f }),
          }),
        ],
      })),
      (t[18] = f),
  ...
  t[25] === ie
    ? (H = t[26])
    : ((H = (0, $.jsx)(_e.Header, { children: ie })), (t[25] = ie), (t[26] = H));
  let U = zt,
    W;
  t[27] === p
    ? (W = t[28])
  ...
  let K;
  t[29] !== d || t[30] !== r
    ? ((K = (0, $.jsx)(hi, { selectedFilterView: r, onSelectFilterView: d })),
      (t[29] = d),
      (t[30] = r),
      (t[31] = K))
    : (K = t[31]);
  let q =
      D?.status === `error`
        ...
        : O
          ...
          : A.length === 0
            ? (0, $.jsx)(pi, { isAllReposSelected: S, selectedFilterView: r })
            : j.map((e) =>
                (0, $.jsx)(
                  gi,
                  {
                    ...
                    column: e,
                    mergeMethod: k ?? `merge`,
                    selectedPullRequestNumber: M?.number ?? s,
                    selectedPullRequestUrl: M?.url ?? c,
                    repo: a?.repo ?? null,
                    showRepo: S,
                    onSelectPullRequest: u,
                    onToggleSection: () => {
                      _((t) => ({ ...t, [e.key]: t[e.key] !== !0 }));
                    },
                  },
                  e.key,
                ),
    ...
    J;
  return (
    t[32] !== U || t[33] !== te || t[34] !== W || t[35] !== K || t[36] !== q
      ? ((J = (0, $.jsx)(U, {
          ariaLabel: W,
    ...
    (0, $.jsxs)(`div`, {
      ...
      children: [
        (0, $.jsx)(di, {
          hostId: M?.hostId ?? a?.hostId,
          item: M,
          relatedThreads: V,
          repo: M?.repo ?? a?.repo ?? null,
          onClose: ae,
        }),
        H,
        J,
...
function di(e) {
  ...
  return (
    t[4] !== n || t[5] !== r || t[6] !== o || t[7] !== i || t[8] !== a
      ? ((d = (0, $.jsx)(_e.RightPanelOutlet, {
          children: (0, $.jsx)(Er, { hostId: n, item: r, relatedThreads: i, repo: a, onClose: o }),
        })),
        (t[4] = n),
        (t[5] = r),
        (t[6] = o),
  ...
  return (
    e[4] !== n || e[5] !== r
      ? ((i = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(yt, { description: n, title: r }),
        })),
        (e[4] = n),
        (e[5] = r),
        (e[6] = i))
...
function pi(e) {
  let t = (0, Z.c)(9),
    ...
    a;
  t[0] !== i || t[1] !== n || t[2] !== r
    ? ((a = mi({ intl: i, isAllReposSelected: n, selectedFilterView: r })),
      (t[0] = i),
      (t[1] = n),
      (t[2] = r),
      (t[3] = a))
  ...
  return (
    t[6] !== a || t[7] !== o
      ? ((s = (0, $.jsx)(`div`, {
          className: `flex h-full min-h-full items-center justify-center`,
          children: (0, $.jsx)(yt, { description: a, title: o }),
        })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s))
...
function mi({ intl: e, isAllReposSelected: t, selectedFilterView: n }) {
  switch (t ? `all` : n) {
    case `all`:
...
function gi(e) {
  let t = (0, Z.c)(31),
    ...
    d;
  t[0] === r.key ? (d = t[1]) : ((d = xi(r.key)), (t[0] = r.key), (t[1] = d));
  let f = d,
    p = !n,
    m = `${f}-items`,
    h = n && `-rotate-90`,
  ...
  t[2] === h
    ? (g = t[3])
    : ((g = C(`icon-2xs shrink-0 transition-transform`, h)), (t[2] = h), (t[3] = g));
  let _;
  t[4] === g ? (_ = t[5]) : ((_ = (0, $.jsx)(Ue, { className: g })), (t[4] = g), (t[5] = _));
  let v;
  t[6] === r.key ? (v = t[7]) : ((v = bi(r.key)), (t[6] = r.key), (t[7] = v));
  let y;
...
function _i(e) {
  ...
  t[3] !== a || t[4] !== o || t[5] !== c?.label
    ? ((l = o ? a.formatMessage(ai.allRepos) : c?.label),
      (t[3] = a),
      (t[4] = o),
      (t[5] = c?.label),
      (t[6] = l))
  ...
  let u = l,
    ...
    p;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(ae, { className: `icon-sm shrink-0` })), (t[7] = p))
    : (p = t[7]);
  let m;
  t[8] === u
    ? (m = t[9])
  ...
  t[10] === h
    ? (g = t[11])
    : ((g = C(`icon-2xs text-token-input-placeholder-foreground transition-transform`, h)),
      (t[10] = h),
      (t[11] = g));
  let _;
  t[12] === g ? (_ = t[13]) : ((_ = (0, $.jsx)(Ue, { className: g })), (t[12] = g), (t[13] = _));
  let v;
  ...
  let x;
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(B, { ...ai.allRepos })), (t[20] = x))
    : (x = t[20]);
  let S;
  t[21] !== b || t[22] !== y
    ? ((S = (0, $.jsx)(Ve.Item, { className: y, onClick: b, children: x })),
      (t[21] = b),
      (t[22] = y),
      (t[23] = S))
    : (S = t[23]);
  ...
  let E;
  return (
    t[32] !== d || t[33] !== S || t[34] !== T || t[35] !== v
      ? ((E = (0, $.jsxs)(He, { onOpenChange: f, open: d, triggerButton: v, children: [S, w, T] })),
        (t[32] = d),
        (t[33] = S),
        (t[34] = T),
        (t[35] = v),
...
function vi(e) {
  let t = (0, Z.c)(63),
    { item: n, mergeMethod: r, onSelectPullRequest: i, repo: a, selected: o, showRepo: s } = e,
    c = T(ee),
    l = z(),
    u = w(),
    d = It(),
  ...
  t[0] !== l || t[1] !== u || t[2] !== c
    ? ((f = (e) => {
        e.status === `success` &&
          (u.invalidateQueries({ queryKey: I(`gh-pr-board`) }),
          c
            .get(q)
            .success(
              l.formatMessage({
    ...
    : (f = t[3]);
  let p;
  t[4] !== n.cwd || t[5] !== n.headBranch || t[6] !== n.hostId || t[7] !== f
    ? ((p = {
        cwd: n.cwd,
  ...
  let m = ht(p),
    h;
  t[9] !== n || t[10] !== r || t[11] !== m || t[12] !== a || t[13] !== c
    ? ((h = async (e) => {
        (e.stopPropagation(), tn(c, { action: `merge`, item: n, surface: `pull_request_page` }));
        let t = await m.mutateAsync({ cwd: n.cwd, mergeMethod: r, number: n.number, repo: a });
        t.status !== `success` && c.get(q).danger(t.error);
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = m),
  ...
  let g = h,
    _;
  t[15] !== g || t[16] !== n || t[17] !== m.isPending || t[18] !== d || t[19] !== a
    ? ((_ = yi({
        isMergePending: m.isPending,
        pullRequestMergeHelperEnabled: d,
        item: n,
        repo: a,
        onMergePullRequest: g,
      })),
      (t[15] = g),
      (t[16] = n),
      (t[17] = m.isPending),
  ...
  let v = _,
    y;
  t[21] !== l || t[22] !== n || t[23] !== c
    ? ((y = {
        id: `copy-pull-request-url`,
        message: oi.copyUrl,
        onSelect: () => {
          (tn(c, { action: `copy_url`, item: n, surface: `pull_request_page` }),
            De(n.url).then(
              () => {
                c.get(q).success(l.formatMessage(oi.copyUrlSuccess));
              },
              () => {
                c.get(q).danger(l.formatMessage(oi.copyUrlError));
              },
            ));
        },
      }),
  ...
  t[25] !== n || t[26] !== c
    ? ((b = {
        ...
        message: oi.openInBrowser,
        onSelect: () => {
          (tn(c, { action: `open_in_browser`, item: n, surface: `pull_request_page` }),
            A.dispatchMessage(`open-in-browser`, { url: n.url }));
        },
      }),
      (t[25] = n),
      (t[26] = c),
    ...
    : (b = t[27]);
  let x;
  t[28] !== y || t[29] !== b ? ((x = [y, b]), (t[28] = y), (t[29] = b), (t[30] = x)) : (x = t[30]);
  let S = x,
    C;
  t[31] === n.state
    ? (C = t[32])
    : ((C = (0, $.jsx)(Ye, { className: `icon-sm shrink-0 translate-y-[2px]`, state: n.state })),
      (t[31] = n.state),
      (t[32] = C));
  let E;
  t[33] !== n || t[34] !== i || t[35] !== c
    ? ((E = () => {
        (nn(c, { item: n, surface: `pull_request_page` }), i(n));
      }),
      (t[33] = n),
      (t[34] = i),
      (t[35] = c),
  ...
  t[37] !== n.additions || t[38] !== n.deletions
    ? ((D = (0, $.jsx)(ut, { linesAdded: n.additions, linesRemoved: n.deletions })),
      (t[37] = n.additions),
      (t[38] = n.deletions),
      (t[39] = D))
    : (D = t[39]);
  ...
  return (
    t[60] !== S || t[61] !== N
      ? ((P = (0, $.jsx)(Ne, { items: S, children: N })), (t[60] = S), (t[61] = N), (t[62] = P))
      : (P = t[62]),
    P
  );
}
...
function Si(e) {
  switch (e) {
    ...
    case `ready`:
      return ii.ready;
    case `unmet_checks`:
      return ii.unmetChecks;
  }
}
var Ci = oe(`pull-request-board:last-selected-repo-key`, null);
function wi() {
  let e = (0, Z.c)(39),
    t = z(),
    n = re(),
    ...
    o = r.get(`repoKey`),
    s;
  e[0] === r ? (s = e[1]) : ((s = Yt(r.get(`view`))), (e[0] = r), (e[1] = s));
  let c = s,
    l;
  e[2] === r ? (l = e[3]) : ((l = r.get(`pullRequestUrl`)), (e[2] = r), (e[3] = l));
  let u = l,
    d;
  e[4] === r ? (d = e[5]) : ((d = Qt(r.get(`pullRequestNumber`))), (e[4] = r), (e[5] = d));
  let f = d,
    p = E(Ie),
    { isLoading: m } = E(K),
    h;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { params: void 0, source: `pull_requests_page` }), (e[6] = h))
    : (h = e[6]);
  let { data: g, isLoading: _ } = O(fe, h),
    v = Wt({ gitOrigins: g?.origins ?? [], workspaceGroups: p }),
    y = o ?? i,
    b = Gt({ repoOptions: v, requestedRepoKey: y }),
    x = y === `all` ? `all` : (b?.key ?? null);
  if (m || _) {
    let t;
    return (
  ...
  let S;
  e[15] !== n || e[16] !== r || e[17] !== x
    ? ((S = (e) => {
        let t = new URLSearchParams(r);
        (x != null && t.set(`repoKey`, x),
          t.set(`view`, e),
    ...
    : (S = e[18]);
  let C;
  e[19] !== n || e[20] !== r || e[21] !== c || e[22] !== x
    ? ((C = (e, t) => {
        let i = new URLSearchParams(r);
        (x != null && i.set(`repoKey`, x),
          i.set(`view`, c),
          e == null
  ...
  return (
    ...
    e[37] !== w
      ? ((T = (0, $.jsx)(ci, {
          selectedFilterView: c,
          repoOption: b,
          repoOptions: v,
          selectedPullRequestNumber: f,
          selectedPullRequestUrl: u,
          selectedRepoKey: x,
          onSelectFilterView: S,
          onSelectPullRequest: C,
          onSelectRepo: w,
        })),
        (e[29] = v),
