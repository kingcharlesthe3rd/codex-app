...
import { n as E } from "./react.js";
import "./isEqual.js";
import { Bt as D, Ft as O, ar as k, ft as A, ht as j, mn as M, w as N } from "./src-1.js";
import "./react-dom.js";
import { c as P, o as F, r as I } from "./lib.js";
import { A as L, D as R, I as z, M as B, c as V, zr as ee } from "./persisted-signal.js";
...
import { t as Y } from "./context-menu-Cx-ZCB4Y.js";
import "./rpc-1.js";
import "./statsig.js";
import "./request.js";
...
import "./clock.js";
import "./warning.js";
import { m as pe, s as me } from "./shiki-highlight-provider-gate.js";
import "./core.esm.js";
import "./katex-1.js";
import "./pdf-1.js";
import { _ as he, m as ge, n as _e } from "./chunk-109.js";
import { t as ve } from "./use-service-tier-settings.js";
import "./known-app-icon.js";
import "./branch.js";
import { t as ye } from "./github-mark.js";
...
import { c as xe } from "./use-permissions-mode.js";
import "./apps.js";
import "./info.js";
...
import "./bug.js";
import "./chrome.js";
import { t as Ae } from "./codex-Cx4-XOqq.js";
import "./openai-blossom.js";
import "./pencil.js";
import "./filesystem-media-src.js";
import "./inline-mentions.js";
import { t as je } from "./copy-to-clipboard.js";
import "./workspace-file-context-menu.js";
import "./use-register-command.js";
import "./modal-controller-state.js";
import { a as Me, i as Ne, l as Pe, n as Fe, r as Ie } from "./dialog-layout.js";
import { h as Le } from "./open-project-setup-dialog.js";
...
import { t as Re } from "./build-worktree-label-from-input-CWcK-Fwd.js";
import { r as ze } from "./pending-worktree-store.js";
...
import { n as Be, t as Ve } from "./loading-page.js";
...
import { t as He } from "./checkbox.js";
import "./minus.js";
import "./badge.js";
import { t as Ue } from "./animations.js";
import "./chat.js";
import { t as We } from "./folders.js";
import "./search.js";
import { r as Ge, t as Ke } from "./dropdown.js";
import "./globe.js";
...
import "./comment.js";
import { n as at } from "./markdown-DuQ7-Xtp.js";
...
function Kt({ gitOrigins: e, workspaceGroups: t }) {
  let n = new Map(e.flatMap((e) => (e.originUrl == null ? [] : [[k(e.dir), e.originUrl]]))),
    r = new Map();
  for (let e of t) {
    let t = e.repositoryData?.ownerRepo;
    if (t == null || e.path == null) continue;
    let i = n.get(k(e.path));
    if (i == null) continue;
    let a = O(i);
    if (a == null) continue;
...
function on(e) {
  e.link != null && g.dispatchMessage(`open-in-browser`, { url: e.link });
}
function sn(e) {
  switch (e) {
    case `failing`:
...
function dn(e) {
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((l = (e, t) => {
        ...
        let n = (e) => {
          s.setQueryData(C(`gh-pr-status`, e), (e) => {
            if (e?.status !== `success`) return e;
            switch (t.action) {
              case `toggle-auto-merge`:
                return { ...e, isAutoMergeEnabled: t.enabled };
        ...
        (n({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
          ...
          Promise.all([
            s.invalidateQueries({ queryKey: C(`gh-pr-body`) }),
            s.invalidateQueries({ queryKey: C(`gh-pr-checks`) }),
            s.invalidateQueries({ queryKey: C(`gh-pr-comments`) }),
            s.invalidateQueries({
...
function Tn({ conversationId: e, pendingWorktreeId: t }) {
  return e == null ? (t == null ? null : j(t)) : A(e);
}
function En(e) {
  let t = (0, Z.c)(31),
  ...
  t[0] !== n || t[1] !== r.cwd
    ? ((m = { conversationId: null, cwdOverride: r.cwd, hostId: n }),
      ...
      (t[2] = m))
    : (m = t[2]);
  let { agentMode: h, isAgentModePending: g } = xe(m),
    { activeMode: v } = se(null),
    { serviceTierSettings: y } = ve(null),
    x;
  t[3] !== n || t[4] !== r.cwd
    ? ((x = { hostId: n, workspaceRoot: r.cwd }), (t[3] = n), (t[4] = r.cwd), (t[5] = x))
    : (x = t[5]);
  let { resolvedConfigPath: S } = gt(x),
    C;
  t[6] !== v ||
  t[7] !== h ||
  t[8] !== d ||
  ...
  t[14] !== y
    ? ((C = async (e) => {
        let t = hn({ includeReviewComments: e, item: r, repo: a }),
          ...
          { config: o } = await p(`read-config-for-host`, {
            hostId: n,
            includeLayers: !1,
            cwd: r.cwd,
          }),
          s = {
            ...
            agentMode: h,
            model: null,
            serviceTier: y.serviceTierForRequest,
            reasoningEffort: null,
            collaborationMode: v,
            config: f(o),
          },
    ...
    : (C = t[15]);
  let w;
  t[16] !== r.url || t[17] !== u || t[18] !== i || t[19] !== s
    ? ((w = (e) => {
        (Nt(s, { pendingWorktreeId: e, pullRequestUrl: r.url }), i(), u(j(e)));
      }),
      (t[16] = r.url),
      (t[17] = u),
      (t[18] = i),
...
function Dn(e) {
  ...
  t[0] !== E || t[1] !== _ || t[2] !== v || t[3] !== g
    ? ((N = (e) => {
        (_.logProductEvent(L, {
          ...
          v.invalidateQueries({ queryKey: C(`list-automations`) }),
          g
            .get(le)
            .success(
              E.formatMessage({
        ...
        (_.logProductEvent(L, {
          ...
          failureReason:
            ...
            `Automation does not exist in the app and could not be updated. It may have been deleted manually by the user.`
              ? B.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION
              : B.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
        }),
          g
            .get(le)
            .danger(
  ...
  let ee;
  t[9] !== N || t[10] !== I
    ? ((ee = { onSuccess: N, onError: I }), (t[9] = N), (t[10] = I), (t[11] = ee))
    : (ee = t[11]);
  let H = w(`automation-update`, ee),
    U = (0, Q.useId)(),
    te = r ?? i.hostId ?? `local`,
    ne = T.data,
    ...
    G,
    q;
  if (t[12] !== ne?.items || t[13] !== T.isError || t[14] !== re || t[15] !== x || t[16] !== S) {
    W = ht({ automations: ne?.items ?? [], conversationId: x, includePausedAutomations: !0 });
    let e = x == null && S != null;
    ((G = W?.status === `PAUSED`),
      (q = mn({
  ...
  t[37] !== S
    ? ((ce = (e) => {
        if ((m && e.stopPropagation(), G && W != null)) {
          (Vt(g, { action: `merge_with_codex_resumed`, item: i, surface: h }), H.mutate(_n(W)));
          return;
        }
        if (ie) {
          let e = Tn({ conversationId: x, pendingWorktreeId: S });
          e != null &&
        ...
        if (!X.isAgentModePending) {
          if (O) {
            (Vt(g, { action: `merge_with_codex_started`, item: i, surface: h }), X.mutate(!1));
            return;
          }
  ...
  let ue = ce,
    de;
  t[39] !== k || t[40] !== i || t[41] !== g || t[42] !== X || t[43] !== h
    ? ((de = (e) => {
        (e.preventDefault(),
          !X.isAgentModePending &&
            (Vt(g, { action: `merge_with_codex_started`, item: i, surface: h }), X.mutate(k)));
      }),
      (t[39] = k),
      (t[40] = i),
      (t[41] = g),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, $.jsx)(Ae, { className: `icon-xxs` })), (t[46] = me))
    : (me = t[46]);
  let he;
  t[47] !== ie || t[48] !== G
    ? ((he = G
    ...
    : (he = t[49]);
  let _e;
  t[50] !== n || t[51] !== ue || t[52] !== se || t[53] !== p || t[54] !== he
    ? ((_e = (0, $.jsx)(J, {
        tooltipContent: pe,
        children: (0, $.jsxs)(K, {
          className: n,
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, $.jsx)(Ae, { className: `icon-sm text-token-foreground` })),
      (be = (0, $.jsx)(F, {
  ...
  t[71] !== O || t[72] !== U || t[73] !== X.isPending || t[74] !== De
    ? ((Oe = (0, $.jsx)(He, { id: U, checked: O, disabled: X.isPending, onCheckedChange: De })),
      (t[71] = O),
      (t[72] = U),
      (t[73] = X.isPending),
      (t[74] = De),
  ...
  t[85] === oe
    ? (Ve = t[86])
    : ((Ve = (0, $.jsx)(K, { color: `primary`, loading: oe, type: `submit`, children: Be })),
      (t[85] = oe),
      (t[86] = Ve));
  let Ue;
  t[87] !== je || t[88] !== ze || t[89] !== Ve
    ? ((Ue = (0, $.jsxs)(Ie, { children: [je, ze, Ve] })),
      (t[87] = je),
      (t[88] = ze),
      (t[89] = Ve),
      (t[90] = Ue))
...
function On(e) {
  ...
  t[6] !== a
    ? ((_ = async () => {
        await Promise.all([
          f.invalidateQueries({ queryKey: C(`gh-pr-board`) }),
          f.invalidateQueries({ queryKey: C(`gh-pr-body`, a) }),
          f.invalidateQueries({ queryKey: C(`gh-pr-checks`, a) }),
          f.invalidateQueries({ queryKey: C(`gh-pr-comments`, a) }),
          f.invalidateQueries({
            queryKey: C(`gh-pr-status`, { cwd: r.cwd, headBranch: r.headBranch, hostId: n }),
          }),
          f.invalidateQueries({
            queryKey: C(`gh-pr-status`, {
              cwd: r.cwd,
  ...
  t[8] !== v || t[9] !== g || t[10] !== u
    ? ((b = (e) => {
        (async () => {
          (await v(),
            e && g !== `squash` && (await ie(u, N.pullRequestMergeMethod, `squash`)),
            h(!1));
        })();
      }),
      (t[8] = v),
  ...
  let O = dn(D),
    k = i != null,
    A = i?.isDraft ?? r.state === `draft`,
    j = r.state === `merged` || i?.hasOpenPr === !1,
    M = i?.isAutoMergeEnabled === !0,
    I = !k || j || A || i?.canMerge !== !0 || w.isPending,
    L = !k || j || (!M && A) || E.isPending,
    R = !k || j || O.isPending,
    z;
  t[24] !== A || t[25] !== j || t[26] !== k || t[27] !== r || t[28] !== i || t[29] !== p
    ? ((z = p && k && !j && !A && i.canMerge !== !0 && pn(r)),
      (t[24] = A),
      (t[25] = j),
      (t[26] = k),
      (t[27] = r),
          ...
          E.mutate(
            ...
            },
            {
              onSuccess: (t) => {
                ...
                (u.get(le).success(kn(`toggle-auto-merge`, d)), x(m && e));
              },
            },
          ));
      }),
  ...
  t[59] === A
    ...
    : ((W = A
      ...
      (t[60] = W));
  let G;
  t[61] !== O.isPending || t[62] !== R || t[63] !== H || t[64] !== W
    ? ((G = (0, $.jsx)(K, {
        color: `outline`,
        disabled: R,
        loading: O.isPending,
  ...
  t[66] === E.isPending
    ? (J = t[67])
    : ((J = E.isPending ? (0, $.jsx)(ae, { className: `icon-xxs` }) : null),
      (t[66] = E.isPending),
      (t[67] = J));
  let Y;
  t[68] === J
  ...
  t[71] === d
    ...
    : ((oe = d.formatMessage({
      ...
      (t[72] = oe));
  let se;
  t[73] !== L || t[74] !== te || t[75] !== M || t[76] !== oe
    ? ((se = (0, $.jsx)(vt, { checked: M, disabled: L, ariaLabel: oe, size: `sm`, onChange: te })),
      (t[73] = L),
      (t[74] = te),
      (t[75] = M),
      (t[76] = oe),
...
function zn(e) {
  ...
  t[28] !== k
    ? ((de = () => {
        ...
        U.current ? i && Vn([re, W, G], B) : (Vn([re, W, G], B), (U.current = !0));
        let a = () => {
  ...
  t[53] !== L
    ? ((pe = (e) => {
        ...
        J ||
          ...
          (V.current = t.getBoundingClientRect().left),
          S || g?.(!0),
          C || _?.(!0),
          L(!0));
      }),
...
var ir = v(c, `gh-current-user`, (e) => ({ params: { hostId: e }, staleTime: T.ONE_MINUTE })),
  ar = 25,
  or = 100,
  sr = 50,
  cr = 0,
...
function ur(e) {
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, $.jsx)(We, { className: `icon-xs` })), (t[38] = k))
    : (k = t[38]);
  let A;
...
function fr({
  ...
  let m = o(c),
    ...
    R = (0, Q.useCallback)(
      (e) => {
        let t = Dt(e),
          n = j.current.get(t);
        (j.current.delete(t), n != null && L(n, !1));
      },
      [L],
    ),
    z = (0, Q.useCallback)((e) => {
    ...
    { data: V, isLoading: ee } = x(`gh-pr-diff`, {
      source: `pull_request_board`,
      params: { cwd: e, hostId: t, number: r, repo: u ?? null },
      queryConfig: { refetchOnWindowFocus: `always`, staleTime: T.FIVE_SECONDS },
    }),
    [H] = (0, Q.useState)(() => new pe()),
    U = (0, Q.useCallback)(
      (e) => {
        if (e != null) {
          H.setup(e);
    ...
    ne = V?.status === `success` ? Oe(V.unifiedDiff) : [],
    ...
    K = k.trim().length === 0 ? re : re.filter((e) => e.includes(k.trim())),
    q = (0, Q.useMemo)(
      () =>
  ...
  function ie(e) {
    (S(e), y.current.get(e)?.scrollIntoView({ block: `start` }));
  }
  let ae = (0, Q.useCallback)(
      (n) => {
        ...
        (j.current.set(Dt(i), n), L(n, !0), B.mutate(i));
      },
      [e, t, r, B, u, L],
    ),
    J = (0, Q.useCallback)(
...
function mr(e) {
  ...
  t[12] !== D
    ? ((k = async (e) => {
        ...
        (Ht(g, { kind: O ? `reply` : `comment`, surface: h }), y(``), await l().catch(hr));
      }),
      (t[3] = r),
      (t[4] = O),
      (t[5] = a),
    ...
    : (k = t[13]);
  let A = k,
    j = T?.status === `success` ? T : void 0,
    N;
  t[14] !== _ || t[15] !== j
    ? ((N = yr({ intl: _, user: j })), (t[14] = _), (t[15] = j), (t[16] = N))
    : (N = t[16]);
  let F = N,
    I = O && `w-full`,
    L;
  ...
  let ee;
  return (
    t[31] !== A || t[32] !== B || t[33] !== V || t[34] !== L
      ? ((ee = (0, $.jsxs)(`form`, { className: L, onSubmit: A, children: [B, V] })),
        (t[31] = A),
        (t[32] = B),
        (t[33] = V),
        (t[34] = L),
        ...
        c == null
          ...
          : (0, $.jsx)(J, {
              ...
              children: (0, $.jsx)(K, {
                ...
                uniform: !0,
                onClick: c,
                children: (0, $.jsx)(Se, { className: `icon-xs` }),
              }),
            })),
      (t[21] = d),
      (t[22] = c),
...
function br(e) {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(Ae, { className: `icon-xs shrink-0` })), (t[10] = _))
    : (_ = t[10]);
  let v;
  t[11] === h
    ? (v = t[12])
...
function Tr(e) {
  let t = (0, Z.c)(112),
    ...
    b;
  t[0] !== n || t[1] !== r || t[2] !== s
    ? ((b = Gr({ hostId: n, item: r, repo: s })), (t[0] = n), (t[1] = r), (t[2] = s), (t[3] = b))
    : (b = t[3]);
  let C = b,
    w = _ === `code-review`,
    E;
  t[4] === w
    ? (E = t[5])
    : ((E = { enabled: w, intervalMs: T.ONE_MINUTE, staleTime: T.ONE_MINUTE }),
      (t[4] = w),
      (t[5] = E));
  let D;
  t[6] !== C || t[7] !== E
    ? ((D = { source: `pull_request_board`, params: C, queryConfig: E }),
      (t[6] = C),
      (t[7] = E),
      (t[8] = D))
    : (D = t[8]);
  let { data: O, refetch: k } = x(`gh-pr-comments`, D),
    A;
  t[9] === O
    ? (A = t[10])
  ...
  t[11] !== p || t[12] !== r || t[13] !== f || t[14] !== d
    ? ((M = function (e) {
        (Vt(f, { action: `copy_url`, item: r, surface: d }),
          rn({ scope: f, event: e, intl: p, url: r.url }));
      }),
      (t[11] = p),
      (t[12] = r),
      (t[13] = f),
  ...
  t[23] !== f ||
  t[24] !== d
    ? ((L = [p, r.isAuthor, r.state, r.url, f, d]),
      (t[19] = p),
      (t[20] = r.isAuthor),
      (t[21] = r.state),
      (t[22] = r.url),
  ...
  t[64] !== r || t[65] !== f || t[66] !== d
    ? ((se = () => {
        (Vt(f, { action: `open_in_browser`, item: r, surface: d }),
          g.dispatchMessage(`open-in-browser`, { url: r.url }));
      }),
      (t[64] = r),
      (t[65] = f),
      (t[66] = d),
  ...
  t[77] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = (0, $.jsx)(Se, { className: `icon-xs` })), (t[77] = pe))
    : (pe = t[77]);
  let me;
  t[78] !== i || t[79] !== fe
    ? ((me = (0, $.jsx)(K, {
    ...
    ? ((_e = u
        ? (0, $.jsxs)(`div`, {
            className: H(
              ...
              _ === `pull-request` ? `border-b border-token-border` : null,
            ),
            children: [
              (0, $.jsx)(zt, {
              ...
              _ === `code-review`
                ? (0, $.jsx)(ur, { isFileTreeOpen: v, onFileTreeOpenChange: y })
                : null,
            ],
          })
        : null),
    ...
    ? ((ve = (0, $.jsx)(`div`, {
        ...
        children:
          _ === `code-review`
            ...
            : (0, $.jsx)(Er, { hostId: n, item: r, relatedThreads: a, request: C, surface: d }),
      })),
      (t[97] = _),
      (t[98] = n),
      (t[99] = v),
...
function kr(e) {
  let t = (0, Z.c)(16),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = { intervalMs: T.ONE_MINUTE, staleTime: T.ONE_MINUTE }), (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = x(`gh-pr-body`, i),
...
function Ar(e) {
  let t = (0, Z.c)(21),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = { intervalMs: T.ONE_MINUTE, staleTime: T.ONE_MINUTE }), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === n
    ? (a = t[2])
    : ((a = { source: `pull_request_board`, params: n, queryConfig: i }), (t[1] = n), (t[2] = a));
  let { data: o, error: s, isError: c, isFetching: l, isLoading: u } = x(`gh-pr-comments`, a);
  if (c) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(F, {
  ...
  t[16] === p
    ? (h = t[17])
    : ((h = (0, $.jsx)(Je, { emptyMessage: f, groups: p, title: m })), (t[16] = p), (t[17] = h));
  let g;
  return (
    t[18] !== d || t[19] !== h
      ? ((g = (0, $.jsxs)(`div`, {
...
function jr(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = x(`gh-pr-checks`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(F, {
...
function Mr(e) {
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(fe, { className: `icon-2xs` })), (t[7] = u))
    : (u = t[7]);
  let d;
  t[8] === l
    ? (d = t[9])
...
function Pr(e) {
  let t = (0, Z.c)(36),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = { intervalMs: T.ONE_MINUTE, staleTime: T.ONE_MINUTE }), (t[0] = o))
    : (o = t[0]);
  let s;
  t[1] === i
    ? (s = t[2])
  ...
  let {
    ...
    m = d && c != null,
    h;
  t[3] === m ? (h = t[4]) : ((h = (0, $.jsx)(Qr, { isFetching: m })), (t[3] = m), (t[4] = h));
  let g = h;
  if (u) {
    let e;
  ...
  if (c.activityItems.length === 0) {
    ...
    t[11] === g
      ? (e = t[12])
      : ((e = (0, $.jsx)(Ge.SectionLabel, { children: g })), (t[11] = g), (t[12] = e));
    let n;
  ...
  t[16] === g
    ? (_ = t[17])
    : ((_ = (0, $.jsx)(Ge.SectionLabel, { children: g })), (t[16] = g), (t[17] = _));
  let v;
  if (
...
function Fr(e) {
  ...
  t[0] !== o || t[1] !== i
    ? ((c = async () => {
        await o.invalidateQueries({ queryKey: C(`gh-pr-comments`, i) });
      }),
      (t[0] = o),
      (t[1] = i),
      (t[2] = c))
...
function Ir(e) {
  ...
  t[1] === i
    ? (s = t[2])
    : ((s = { source: `pull_request_board`, params: i, queryConfig: o }), (t[1] = i), (t[2] = s));
  let { data: c, error: l, isError: u, isFetching: d, isLoading: f } = x(`gh-pr-body`, s);
  if (!r.isAuthor) return null;
  if (u) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  t[11] !== n || t[12] !== r || t[13] !== i || t[14] !== a || t[15] !== m || t[16] !== h
    ? ((g = (0, $.jsx)(On, { hostId: n, item: r, pullRequestBody: h, request: i, surface: a }, m)),
      (t[11] = n),
      (t[12] = r),
      (t[13] = i),
      (t[14] = a),
...
function Ur(e) {
  switch (e) {
    ...
    case `changes_requested`:
      return { Icon: Se, iconClassName: `text-token-charts-red` };
    case `merged`:
...
function qr() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, $.jsx)(Ge.SectionLabel, { children: (0, $.jsx)(Zr, {}) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(Ge.SectionLabel, { children: (0, $.jsx)(Qr, {}) }),
            (0, $.jsx)(Xr, {}),
          ],
        })),
        (e[0] = t))
...
function ni(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, $.jsx)(Ge.SectionLabel, { className: `px-0 py-0`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function si(e) {
  ...
  t[8] !== i
    ? ((S = b
        ? { repos: i.map(li), searchQuery: y }
        : { cwd: M(r?.cwd ?? `/`), hostId: r?.hostId, repo: r?.repo ?? null, searchQuery: y }),
      (t[3] = y),
      (t[4] = b),
      (t[5] = r?.cwd),
      (t[6] = r?.hostId),
  ...
  t[10] === C
    ? (w = t[11])
    : ((w = { enabled: C, intervalMs: T.THIRTY_SECONDS, staleTime: T.THIRTY_SECONDS }),
      (t[10] = C),
      (t[11] = w));
  let E;
  t[12] !== S || t[13] !== w
    ? ((E = { source: `pull_request_board`, params: S, queryConfig: w }),
      (t[12] = S),
      (t[13] = w),
      (t[14] = E))
    : (E = t[14]);
  let { data: D, isLoading: O } = x(`gh-pr-board`, E),
    k = q(N.pullRequestMergeMethod),
    A = D?.status === `success` ? D.items : [],
    j = Jt(A),
    I = j.find(ci)?.items[0] ?? null,
    L = $t({ items: A, selectedPullRequestNumber: a, selectedPullRequestUrl: o }),
    R = `${s ?? ``}:${n}:${y ?? ``}`,
    z = a != null || o != null;
  (0, Q.useEffect)(() => {
    I == null || z || g === R || (_(R), c(I, { replace: !0 }));
  }, [R, g, I, z, c]);
  let B;
  t[15] === d
    ? (B = t[16])
  ...
  let Y =
      D?.status === `error`
        ...
        : O
          ...
          : A.length === 0
            ? (0, $.jsx)(fi, { isAllReposSelected: b, selectedFilterView: n })
            : j.map((e) =>
                (0, $.jsx)(
                  hi,
                  {
...
function li(e) {
  return { cwd: M(e.cwd), hostId: e.hostId, repo: e.repo };
}
function ui(e) {
  let t = (0, Z.c)(10),
...
function hi(e) {
  ...
  let _;
  t[4] === g ? (_ = t[5]) : ((_ = (0, $.jsx)(fe, { className: g })), (t[4] = g), (t[5] = _));
  let v;
...
function gi(e) {
  ...
  let u = l,
    ...
    p;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(ye, { className: `icon-sm shrink-0` })), (t[7] = p))
    : (p = t[7]);
  let m;
  t[8] === u
    ? (m = t[9])
  ...
  t[10] === h
    ...
    : ((g = H(`icon-2xs text-token-input-placeholder-foreground transition-transform`, h)),
      ...
      (t[11] = g));
  let _;
  t[12] === g ? (_ = t[13]) : ((_ = (0, $.jsx)(fe, { className: g })), (t[12] = g), (t[13] = _));
  let v;
  ...
  let S;
  t[21] !== b || t[22] !== y
    ? ((S = (0, $.jsx)(Ge.Item, { className: y, onClick: b, children: x })),
      (t[21] = b),
      (t[22] = y),
      (t[23] = S))
    : (S = t[23]);
  ...
  return (
    t[32] !== d || t[33] !== S || t[34] !== w || t[35] !== v
      ? ((T = (0, $.jsxs)(Ke, { onOpenChange: f, open: d, triggerButton: v, children: [S, C, w] })),
        (t[32] = d),
        (t[33] = S),
        (t[34] = w),
        (t[35] = v),
...
function _i(e) {
  ...
  let _ = nt(h),
    v;
  t[9] !== n || t[10] !== r || t[11] !== _ || t[12] !== a || t[13] !== u
    ? ((v = async (e) => {
        (e.stopPropagation(), Vt(u, { action: `merge`, item: n, surface: `pull_request_page` }));
        let t = await _.mutateAsync({ cwd: n.cwd, mergeMethod: r, number: n.number, repo: a });
        t.status !== `success` && u.get(le).danger(t.error);
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = _),
  ...
  let b = v,
    x;
  t[15] !== b || t[16] !== n || t[17] !== _.isPending || t[18] !== p || t[19] !== a
    ? ((x = vi({
        isMergePending: _.isPending,
    ...
    ? ((w = {
        ...
        onSelect: () => {
          (Vt(u, { action: `copy_url`, item: n, surface: `pull_request_page` }),
            je(n.url).then(
              () => {
                u.get(le).success(d.formatMessage(ai.copyUrlSuccess));
              },
              () => {
                u.get(le).danger(d.formatMessage(ai.copyUrlError));
              },
            ));
        },
      }),
    ...
    ? ((T = {
        ...
        onSelect: () => {
          (Vt(u, { action: `open_in_browser`, item: n, surface: `pull_request_page` }),
            g.dispatchMessage(`open-in-browser`, { url: n.url }));
        },
      }),
      (t[25] = n),
      (t[26] = u),
...
function Ci() {
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (_ = e[6]);
  let { data: v, isLoading: y } = i(ue, _),
    b = Kt({ gitOrigins: v?.origins ?? [], workspaceGroups: h }),
    x = c ?? a,
    S = qt({ repoOptions: b, requestedRepoKey: x }),
    C = x === `all` ? `all` : (S?.key ?? null);
  if (g || y) {
    let t;
    return (
  ...
  let w;
  e[15] !== n || e[16] !== r || e[17] !== C
    ? ((w = (e) => {
        let t = new URLSearchParams(r);
        (C != null && t.set(`repoKey`, C),
          t.set(`view`, e),
    ...
    : (w = e[18]);
  let T;
  e[19] !== n || e[20] !== r || e[21] !== u || e[22] !== C
    ? ((T = (e, t) => {
        let i = new URLSearchParams(r);
        (C != null && i.set(`repoKey`, C),
          i.set(`view`, u),
          e == null
  ...
  return (
    ...
    e[37] !== D
      ? ((O = (0, $.jsx)(si, {
          ...
          selectedRepoKey: C,
          onSelectFilterView: w,
          onSelectPullRequest: T,
          onSelectRepo: D,
        })),
        (e[29] = b),
        (e[30] = u),
