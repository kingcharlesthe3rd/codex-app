...
import { Bt as l, Tt as u, gt as d, mt as f, n as p } from "./use-host-config.js";
import { Dn as m, f as h, zi as g } from "./thread-context-inputs.js";
import {
  A as _,
  _ as v,
  f as y,
...
import "./isEqual.js";
import { Ar as O, C as k, Lt as A, _n as j, gt as M, jr as N, pt as P } from "./src-3.js";
import "./react-dom.js";
...
import { c as we } from "./use-permissions-mode.js";
...
/* empty css                    */ import { n as ut } from "./markdown-2.js";
...
import { i as Tt, o as Et, r as Dt } from "./diff-unified.js";
...
import { t as It } from "./segmented-toggle.js";
import { t as Lt } from "./selectable-list-row.js";
import { n as Rt, t as zt } from "./sectioned-page-D9NF-CUm.js";
...
function Rn() {
  return [
    ...
    `Use ::${m}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
...
function Bn(e) {
  ...
  t[0] !== n || t[1] !== r.cwd
    ? ((p = { conversationId: null, cwdOverride: r.cwd, hostId: n }),
      ...
      (t[2] = p))
    : (p = t[2]);
  let { agentMode: m, isAgentModePending: h, permissionProfileId: _ } = we(p),
  ...
  return (
    t[29] !== h || t[30] !== k
      ? ((A = { ...k, isAgentModePending: h }), (t[29] = h), (t[30] = k), (t[31] = A))
      : (A = t[31]),
    A
  );
}
...
function Li() {
  ...
  let { data: y, isLoading: b } = i(xe, v),
    x = Kt({ gitOrigins: y?.origins ?? [], workspaceGroups: g }),
    S = c ?? a,
