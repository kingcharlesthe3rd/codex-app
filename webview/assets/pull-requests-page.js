...
import { Ar as t, At as n, Gn as r, S as i, st as a, ut as o, vn as s } from "./src-2.js";
import {
  Bo as c,
  Ea as l,
  Rn as u,
...
import { _ as ne, m as re, n as ie } from "./chunk-9.js";
import "./known-app-icon.js";
import "./branch.js";
import { t as ae } from "./github-mark.js";
import "./google-drive-CC-Egn92.js";
import "./notion.js";
import { c as H, g as U, v as W } from "./persisted-signal.js";
import "./rpc-2.js";
import "./statsig.js";
import "./request.js";
...
import { t as oe } from "./persisted-atom-C.js";
...
import { t as ge } from "./app-shell.js";
import { t as _e } from "./AnimatePresence.js";
...
import "./globe.js";
import { t as Ue } from "./segmented-toggle.js";
import "./three-dots.js";
import { t as We } from "./chevron.js";
import { t as Ge } from "./format-relative-date-time.js";
import "./warning.js";
...
import { n as Qe } from "./markdown.js";
import "./code-snippet.js";
import "./copy.js";
import "./copy-button.js";
import "./plus.js";
import "./image-preview-dialog.js";
import { a as $e, n as et, r as tt, t as nt } from "./pull-request-readonly-comment.js";
import { t as rt } from "./pull-request-open.js";
import { t as it } from "./automation-queries-t.js";
import { t as at } from "./get-attached-heartbeat-automation-for-thread.js";
import "./use-is-background-subagents-enabled.js";
import "./local-environments.js";
import { r as ot } from "./local-environment-selection.js";
import { t as st } from "./arrow-up.js";
import { t as ct } from "./bullet-separator.js";
...
import { n as gt } from "./diff-stats.js";
...
import { t as Tt } from "./file-tree-search-input.js";
import "./codex-analytics-attribution.js";
import "./use-target-apps.js";
import { i as Et, o as Dt, r as Ot } from "./diff-unified.js";
...
import { t as kt } from "./folders-M.js";
...
import { c as jt, r as Mt, t as Nt } from "./automation-schedule.js";
import { a as Pt, c as Ft, s as It, t as Lt } from "./use-is-pull-request-merge-helper-enabled.js";
import { t as Rt } from "./selectable-list-row.js";
import { n as zt, t as Bt } from "./sectioned-page.js";
...
function Wt({ gitOrigins: e, workspaceGroups: r }) {
  let i = new Map(e.flatMap((e) => (e.originUrl == null ? [] : [[t(e.dir), e.originUrl]]))),
    a = new Map();
  for (let e of r) {
    let r = e.repositoryData?.ownerRepo;
    if (r == null || e.path == null) continue;
    let o = i.get(t(e.path));
    if (o == null) continue;
    let s = n(o);
    if (s == null) continue;
    let c = `${r.owner}/${r.repoName}`,
      l = `${s.owner}/${s.repo}`,
...
function on(e) {
  ...
  if (t[0] !== o || t[1] !== r || t[2] !== i || t[3] !== s || t[4] !== a) {
    let e = Ze({ canFix: o, checks: r, intl: s, onFixCheck: a, onOpenCheck: sn });
...
function bn() {
  return Nt({ ...Mt(), intervalHours: 1, intervalMinutes: pn });
}
function xn(e) {
  return e
...
function Tn() {
  return [
    ...
    `Use ::${u}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
...
function Dn(e) {
  ...
  t[0] !== n || t[1] !== r.cwd
    ? ((f = { conversationId: null, cwdOverride: r.cwd, hostId: n }),
      ...
      (t[2] = f))
    : (f = t[2]);
  let { agentMode: m, isAgentModePending: h } = pe(f),
    { activeMode: g } = X(null),
    { serviceTierSettings: _ } = ve(null),
    y;
  t[3] !== n || t[4] !== r.cwd
    ? ((y = { hostId: n, workspaceRoot: r.cwd }), (t[3] = n), (t[4] = r.cwd), (t[5] = y))
    : (y = t[5]);
  let { resolvedConfigPath: b } = ot(y),
    x;
  t[6] !== g ||
  t[7] !== m ||
  t[8] !== d ||
  ...
  t[16] !== r.url || t[17] !== u || t[18] !== i || t[19] !== c
    ? ((S = (e) => {
        (Ft(c, { pendingWorktreeId: e, pullRequestUrl: r.url }), i(), u(o(e)));
      }),
      (t[16] = r.url),
      (t[17] = u),
      (t[18] = i),
  ...
  return (
    t[28] !== h || t[29] !== E
      ? ((D = { ...E, isAgentModePending: h }), (t[28] = h), (t[29] = E), (t[30] = D))
      : (D = t[30]),
    D
  );
}
function On(e) {
  let t = (0, Z.c)(102),
    ...
    u = s === void 0 ? !1 : s,
    d = c === void 0 ? `pull_request_page` : c,
    p = T(ee),
    h = E(W),
    v = w(),
    y = D(Pt, i.url),
    ...
    [M, N] = (0, Q.useState)(!1),
    P;
  t[0] !== C || t[1] !== h || t[2] !== v || t[3] !== p
    ? ((P = (e) => {
        (h.logProductEvent(f, {
          action: g.CODEX_AUTOMATION_ACTION_UPDATED,
          source: m.CODEX_AUTOMATION_SOURCE_PR_MERGE_HELPER,
          success: !0,
          ...jt(e.item),
        }),
          v.invalidateQueries({ queryKey: I(`list-automations`) }),
          p
            .get(q)
            .success(
              C.formatMessage({
  ...
  if (t[12] !== ie?.items || t[13] !== S.isError || t[14] !== ae || t[15] !== b || t[16] !== x) {
    H = at({ automations: ie?.items ?? [], conversationId: b, includePausedAutomations: !0 });
    let e = b == null && x != null;
    ((U = H?.status === `PAUSED`),
      (G = hn({
  ...
  t[37] !== x
    ? ((ue = (e) => {
        if ((u && e.stopPropagation(), U && H != null)) {
          (tn(p, { action: `merge_with_codex_resumed`, item: i, surface: d }), R.mutate(vn(H)));
          return;
        }
        if (K) {
          let e = En({ conversationId: b, pendingWorktreeId: x });
          e != null &&
            (tn(p, { action: `merge_with_codex_task_opened`, item: i, surface: d }), O(e));
          return;
        }
        if (!X.isAgentModePending) {
          if (k) {
            (tn(p, { action: `merge_with_codex_started`, item: i, surface: d }), X.mutate(!1));
            return;
          }
          (tn(p, { action: `merge_with_codex_dialog_opened`, item: i, surface: d }), j(!1), N(!0));
        }
      }),
      (t[25] = H),
      (t[26] = K),
  ...
  let de = ue,
    fe;
  t[39] !== A || t[40] !== i || t[41] !== p || t[42] !== X || t[43] !== d
    ? ((fe = (e) => {
        (e.preventDefault(),
          !X.isAgentModePending &&
            (tn(p, { action: `merge_with_codex_started`, item: i, surface: d }), X.mutate(A)));
      }),
      (t[39] = A),
      (t[40] = i),
      (t[41] = p),
  ...
  t[47] !== K || t[48] !== U
    ...
    : (ge = t[49]);
  let _e;
  t[50] !== n || t[51] !== de || t[52] !== le || t[53] !== l || t[54] !== ge
    ? ((_e = (0, $.jsx)(J, {
        tooltipContent: me,
        children: (0, $.jsxs)(se, {
          className: n,
  ...
  t[65] !== A || t[66] !== X.isPending || t[67] !== Te
    ? ((De = (0, $.jsx)(Oe, {
        ...
        children: (0, $.jsxs)(`label`, {
          ...
          children: [
            Ce,
            (0, $.jsx)(ut, { checked: A, disabled: we, ariaLabel: Te, size: `sm`, onChange: j }),
          ],
        }),
      })),
      (t[65] = A),
...
function kn(e) {
  ...
  t[73] !== N || t[74] !== re || t[75] !== j || t[76] !== J
    ? ((Y = (0, $.jsx)(ut, { checked: j, disabled: N, ariaLabel: J, size: `sm`, onChange: re })),
      (t[73] = N),
      (t[74] = re),
      (t[75] = j),
      (t[76] = J),
...
function dr(e) {
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, $.jsx)(kt, { className: `icon-xs` })), (t[38] = k))
    : (k = t[38]);
  let A;
...
function pr({
  ...
  let d = T(ee),
    ...
    J = (0, Q.useMemo)(
      () =>
        a == null || a.length === 0 ? void 0 : St({ comments: a, filePaths: U, workspaceRoot: e }),
      [e, U, a],
    );
  function Y(e) {
  ...
  let oe = (0, Q.useCallback)(
      (n) => {
        ...
        (k.current.set(wt(i), n), N(n, !0), R.mutate(i));
      },
      [e, t, r, R, o, N],
    ),
    X = (0, Q.useCallback)(
      (e, t) => {
        let n = bt({ currentComments: v[e] ?? [], nextComments: t });
        (C(null), y((n) => ({ ...n, [e]: t })));
        for (let e of n) oe(e);
      },
      [v, oe],
...
function vr(e) {
  ...
  t[24] === a
    ? (w = t[25])
    : ((w = a ? null : (0, $.jsx)(st, { className: `icon-xs` })), (t[24] = a), (t[25] = w));
  let T;
...
function xr(e) {
  ...
  if (t[0] !== l?.items || t[1] !== i || t[2] !== a) {
    let e = at({ automations: l?.items ?? [], conversationId: i, includePausedAutomations: !0 });
    u = i == null && a != null;
    let n;
    (t[6] !== i || t[7] !== a
...
function Tr(e) {
  ...
  let s;
  t[4] !== i || t[5] !== a
    ? ((s = i && a ? (0, $.jsx)(ct, { className: `shrink-0` }) : null),
      (t[4] = i),
      (t[5] = a),
      (t[6] = s))
    : (s = t[6]);
...
function Er(e) {
  ...
  t[26] === r.state
    ? (N = t[27])
    : ((N = (0, $.jsx)(Xe, { className: `icon-sm shrink-0`, state: r.state })),
      (t[26] = r.state),
      (t[27] = N));
  let I;
  t[28] === r.title
...
function Nr(e) {
  ...
  let o;
  t[0] !== n || t[1] !== r
    ? ((o = Ke({ checks: n, ciStatus: r })), (t[0] = n), (t[1] = r), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === r ? (s = t[4]) : ((s = Je(r)), (t[3] = r), (t[4] = s));
  let c = i ? 180 : 0,
    l;
  ...
  t[11] !== i || t[12] !== o || t[13] !== s || t[14] !== d
    ? ((p = (0, $.jsx)(At, { ariaExpanded: i, icon: o, label: s, trailing: d, onClick: f })),
      (t[11] = i),
      (t[12] = o),
      (t[13] = s),
      (t[14] = d),
  ...
  t[19] === m
    ? (h = t[20])
    : ((h = (0, $.jsx)(_e, { initial: !1, children: m })), (t[19] = m), (t[20] = h));
  let g;
  return (
    t[21] !== h || t[22] !== p
...
function Br(e) {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (d = t[13]);
  let f;
  t[14] === n.createdAt ? (f = t[15]) : ((f = tt(n.createdAt)), (t[14] = n.createdAt), (t[15] = f));
  let p;
  t[16] === n.createdAt
    ? (p = t[17])
    : ((p = (0, $.jsx)(`span`, {
        className: `inline`,
        children: (0, $.jsx)(Ge, { dateString: n.createdAt }),
      })),
      (t[16] = n.createdAt),
      (t[17] = p));
  let m;
...
function ci(e) {
  ...
  t[1] === n
    ? (b = t[2])
    : ((b = Xt({ searchQuery: Jt(n), selectedFilterView: n })), (t[1] = n), (t[2] = b));
  let x = b,
    S = l === `all`,
    C;
  t[3] !== x ||
  ...
  t[8] !== o
    ? ((C = S
        ...
        : { cwd: r(a?.cwd ?? `/`), hostId: a?.hostId, repo: a?.repo ?? null, searchQuery: x }),
      (t[3] = x),
      (t[4] = S),
      (t[5] = a?.cwd),
      (t[6] = a?.hostId),
  ...
  t[25] === ie
    ? (H = t[26])
    : ((H = (0, $.jsx)(ge.Header, { children: ie })), (t[25] = ie), (t[26] = H));
  let U = Bt,
    W;
  t[27] === p
    ? (W = t[28])
  ...
  let K;
  t[29] !== d || t[30] !== n
    ? ((K = (0, $.jsx)(hi, { selectedFilterView: n, onSelectFilterView: d })),
      (t[29] = d),
      (t[30] = n),
      (t[31] = K))
    : (K = t[31]);
  let q =
      D?.status === `error`
        ...
        : O
          ...
          : A.length === 0
            ? (0, $.jsx)(pi, { isAllReposSelected: S, selectedFilterView: n })
            : j.map((e) =>
                (0, $.jsx)(
                  gi,
                  {
...
function ui(e) {
  return { cwd: r(e.cwd), hostId: e.hostId, repo: e.repo };
}
function di(e) {
  let t = (0, Z.c)(10),
...
function gi(e) {
  ...
  return (
    t[27] !== f || t[28] !== x || t[29] !== b
      ? ((S = (0, $.jsx)(zt, { id: f, title: b, children: x })),
        (t[27] = f),
        (t[28] = x),
        (t[29] = b),
        (t[30] = S))
...
function vi(e) {
  ...
  t[31] === n.state
    ? (C = t[32])
    : ((C = (0, $.jsx)(Xe, { className: `icon-sm shrink-0 translate-y-[2px]`, state: n.state })),
      (t[31] = n.state),
      (t[32] = C));
  let E;
  ...
  t[37] !== n.additions || t[38] !== n.deletions
    ? ((D = (0, $.jsx)(gt, { linesAdded: n.additions, linesRemoved: n.deletions })),
      (t[37] = n.additions),
      (t[38] = n.deletions),
      (t[39] = D))
    : (D = t[39]);
