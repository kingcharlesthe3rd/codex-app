...
import { R as r, a as i, i as a, o, s, t as c } from "./app-scope.js";
import {
  f as l,
  g as u,
  i as d,
...
import { n as y } from "./react.js";
import "./isEqual.js";
import { Mt as b, S as x, Xt as S, fr as C, ft as w, lt as T, wn as E } from "./src-4.js";
import {
  As as D,
  Ea as O,
  La as k,
...
import { A as L, D as R, I as z, Lr as B, M as V, c as ee } from "./persisted-signal.js";
import { t as H } from "./clsx.js";
import { t as U } from "./proxy.js";
import { x as te } from "./app-shell-state.js";
import { t as ne } from "./AnimatePresence.js";
import { t as re } from "./app-shell.js";
import { t as W } from "./persisted-atom.js";
import { t as G } from "./bullet-separator.js";
import { t as K } from "./button.js";
import { a as q, i as ie } from "./setting-storage.js";
...
import { d as oe } from "./thread-context-inputs.js";
...
import { o as ue } from "./remote-projects.js";
import "./collaboration-mode-queries.js";
import { t as de } from "./arrow-up.js";
import "./check-circle-filled.js";
import "./clock.js";
import "./warning.js";
import { m as fe, s as pe } from "./shiki-highlight-provider-gate.js";
import "./core.esm.js";
import "./katex-2.js";
import "./pdf-1.js";
import { _ as me, m as he, n as ge } from "./chunk-8.js";
...
import { c as ye } from "./use-permissions-mode.js";
import { t as be } from "./use-service-tier-settings.js";
import "./apps.js";
import { t as xe } from "./x.js";
...
import { c as Se, i as Ce, s as we, t as Te } from "./diff-view-mode.js";
import "./app-shell-tab-controller.js";
import "./browser-sidebar-manager.js";
import "./review-navigation-model.js";
import { t as Ee } from "./file-tree-search-input.js";
import { t as De } from "./parse-diff.js";
import "./file-diff.js";
import "./sumBy.js";
...
import "./download.js";
import { t as Oe } from "./with-window.js";
...
import { a as je, i as Me, l as Ne, n as Pe, r as Fe } from "./dialog-layout.js";
import { h as Ie } from "./open-project-setup-dialog.js";
...
import { t as Le } from "./build-worktree-label-from-input.js";
import { r as Re } from "./pending-worktree-store.js";
...
import { n as ze, t as Be } from "./loading-page.js";
...
import "./minus.js";
import "./badge.js";
import { t as He } from "./animations.js";
import "./chat.js";
...
import { t as qe } from "./format-relative-date-time.js";
...
import {
  ...
  v as rt,
  y as it,
} from "./review-header-toolbar-p.js";
import "./comment.js";
import { n as at } from "./markdown.js";
...
import { t as ot } from "./github-details.js";
import { h as st, m as ct, p as lt } from "./use-diff-annotations.js";
import { t as ut } from "./pull-request-open.js";
import { c as dt, h as ft, r as pt, t as mt } from "./automation-schedule.js";
import { t as ht } from "./get-attached-heartbeat-automation-for-thread.js";
import "./use-is-background-subagents-enabled.js";
import "./sortBy.js";
import "./local-environments-e.js";
import { r as gt } from "./local-environment-selection.js";
import { t as _t } from "./check-lg.js";
import "./composer-controller.js";
/* empty css                    */ import "./composer-top-menu-chrome.js";
import { t as vt } from "./toggle.js";
import "./connected-apps.js";
import "./regenerate.js";
import "./undo-C.js";
import "./use-composer-controller.js";
import "./use-composer-top-menu-max-height.js";
import { r as yt } from "./diff-stats.js";
...
import { i as Ot, o as kt, r as At } from "./diff-unified.js";
...
import { t as It } from "./selectable-list-row.js";
import { n as Lt, t as Rt } from "./sectioned-page.js";
import { t as zt } from "./segmented-toggle.js";
...
function Kt({ gitOrigins: e, workspaceGroups: t }) {
  let n = new Map(e.flatMap((e) => (e.originUrl == null ? [] : [[C(e.dir), e.originUrl]]))),
    r = new Map();
  for (let e of t) {
    let t = e.repositoryData?.ownerRepo;
    if (t == null || e.path == null) continue;
    let i = n.get(C(e.path));
    if (i == null) continue;
    let a = b(i);
    if (a == null) continue;
...
var Q = e(t(), 1);
function rn({ scope: e, event: t, intl: n, url: r }) {
  r &&
    Ae(r, t).then(
      () => {
        e.get(le).success(
...
function an(e) {
  ...
  if (t[0] !== o || t[1] !== r || t[2] !== i || t[3] !== s || t[4] !== a) {
    let e = Ye({ canFix: o, checks: r, intl: s, onFixCheck: a, onOpenCheck: on });
          ...
          e.items.map((e, n) =>
            (0, $.jsx)(
              jt,
              {
                ...
                icon: sn(e.status),
                label: (0, $.jsx)(J, {
                  tooltipContent: (0, $.jsx)(ln, { status: e.status }),
                  children: (0, $.jsx)(`span`, {
...
function on(e) {
  e.link != null && l.dispatchMessage(`open-in-browser`, { url: e.link });
}
function sn(e) {
  switch (e) {
    case `failing`:
      return cn(`text-token-charts-red`);
    case `pending`:
      return cn(`text-token-charts-yellow`);
    case `skipped`:
      return cn(`text-token-text-tertiary`);
    case `successful`:
      return cn(`text-token-charts-green`);
    case `unknown`:
      return cn(`text-token-text-tertiary`);
  }
}
function cn(e) {
  return (0, $.jsx)(`span`, {
    ...
    children: (0, $.jsx)(tt, { className: H(`icon-3xs`, e) }),
  });
}
function ln(e) {
  let t = (0, Z.c)(5),
...
function un({ cwd: e, headBranch: t, hostId: n }) {
...
function dn(e) {
  let t = (0, Z.c)(20),
    ...
    c;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((c = un({ cwd: n, headBranch: r, hostId: i })),
      (t[0] = n),
      (t[1] = r),
      (t[2] = i),
      (t[3] = c))
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((l = (e, t) => {
        ...
        let n = (e) => {
          s.setQueryData(g(`gh-pr-status`, e), (e) => {
            if (e?.status !== `success`) return e;
            switch (t.action) {
              case `toggle-auto-merge`:
                return { ...e, isAutoMergeEnabled: t.enabled };
        ...
        (n({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
          ...
          Promise.all([
            s.invalidateQueries({ queryKey: g(`gh-pr-body`) }),
            s.invalidateQueries({ queryKey: g(`gh-pr-checks`) }),
            s.invalidateQueries({ queryKey: g(`gh-pr-comments`) }),
            s.invalidateQueries({
              queryKey: g(`gh-pr-summary`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
            }),
            s.invalidateQueries({
              queryKey: g(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
            }),
            s.invalidateQueries({
              queryKey: g(`gh-pr-status`, {
                cwd: t.cwd,
                headBranch: r,
                hostId: t.hostId,
                number: t.number,
  ...
  t[12] !== i || t[13] !== d
    ? ((p = (e, t) => {
      ...
      (m = (e, t) => d.mutateAsync({ ...e, hostId: i }, t)),
      (t[12] = i),
      (t[13] = d),
      (t[14] = p),
      (t[15] = m))
  ...
  let h;
  return (
    t[16] !== d || t[17] !== p || t[18] !== m
      ? ((h = { ...d, mutate: p, mutateAsync: m }),
        (t[16] = d),
        (t[17] = p),
        (t[18] = m),
        (t[19] = h))
...
function hn({ includeReviewComments: e, item: t, repo: n }) {
  return [
    A,
    ``,
    ...xn({ item: t, repo: n }),
...
function gn({ includeReviewComments: e, item: t, name: n, repo: r }) {
  return { name: n, prompt: vn({ includeReviewComments: e, item: t, repo: r }), rrule: yn() };
}
function _n(e) {
  return {
    id: e.id,
...
function vn({ includeReviewComments: e, item: t, repo: n }) {
  return [
...
function yn() {
  return mt({ ...pt(), intervalHours: 1, intervalMinutes: fn });
}
function bn(e) {
  return e
...
function wn() {
  return [
    ...
    `Use ::${j}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
    `Do not count unrelated flakes, attempted fixes, or work that was already counted in an earlier turn.`,
  ].join(`
`);
}
function Tn({ conversationId: e, pendingWorktreeId: t }) {
  return e == null ? (t == null ? null : w(t)) : T(e);
}
function En(e) {
  let t = (0, Z.c)(31),
    ...
    l = P(),
    d = he(),
    { createPendingWorktree: f } = Re(),
    m;
  t[0] !== n || t[1] !== r.cwd
    ? ((m = { conversationId: null, cwdOverride: r.cwd, hostId: n }),
      (t[0] = n),
      (t[1] = r.cwd),
      (t[2] = m))
    : (m = t[2]);
  let { agentMode: h, isAgentModePending: g } = ye(m),
    { activeMode: _ } = se(null),
    { serviceTierSettings: v } = be(null),
    y;
  t[3] !== n || t[4] !== r.cwd
    ? ((y = { hostId: n, workspaceRoot: r.cwd }), (t[3] = n), (t[4] = r.cwd), (t[5] = y))
    : (y = t[5]);
  let { resolvedConfigPath: b } = gt(y),
    x;
  t[6] !== _ ||
  t[7] !== h ||
  t[8] !== f ||
  ...
  t[14] !== v
    ? ((x = async (e) => {
        let t = hn({ includeReviewComments: e, item: r, repo: a }),
          i = [{ type: `text`, text: t, text_elements: [] }],
          { config: o } = await D(`read-config-for-host`, {
            hostId: n,
            includeLayers: !1,
            cwd: r.cwd,
          }),
        ...
        return f({
          ...
          heartbeatAutomation: gn({ includeReviewComments: e, item: r, name: c, repo: a }),
        });
      }),
      (t[6] = _),
      (t[7] = h),
    ...
    : (x = t[15]);
  let C;
  t[16] !== r.url || t[17] !== d || t[18] !== i || t[19] !== s
    ? ((C = (e) => {
        (Nt(s, { pendingWorktreeId: e, pullRequestUrl: r.url }), i(), d(w(e)));
      }),
      (t[16] = r.url),
      (t[17] = d),
      (t[18] = i),
  ...
  t[21] !== l || t[22] !== s
    ? ((T = (e) => {
        (p.error(`Error starting pull request merge helper`, { safe: {}, sensitive: { error: e } }),
          s
            .get(le)
            .danger(
              l.formatMessage(
    ...
    : (T = t[23]);
  let E;
  t[24] !== x || t[25] !== C || t[26] !== T
    ? ((E = { mutationFn: x, onSuccess: C, onError: T }),
      (t[24] = x),
      (t[25] = C),
      (t[26] = T),
      (t[27] = E))
  ...
  return (
    t[28] !== g || t[29] !== O
      ? ((k = { ...O, isAgentModePending: g }), (t[28] = g), (t[29] = O), (t[30] = k))
      : (k = t[30]),
    k
  );
}
function Dn(e) {
  let t = (0, Z.c)(102),
    { className: n, hostId: r, item: i, repo: l, size: u, stopPropagation: d, surface: p } = e,
    m = u === void 0 ? `default` : u,
    h = d === void 0 ? !1 : d,
    v = p === void 0 ? `pull_request_page` : p,
    y = o(c),
    b = s(ee),
    x = f(),
    S = a(Mt, i.url),
    C = s(S.conversationId$),
    w = s(S.pendingWorktreeId$),
    T = s(ft),
    E = P(),
    D = he(),
    O = s(Pt),
    ...
    [j, M] = (0, Q.useState)(!1),
    N;
  t[0] !== E || t[1] !== b || t[2] !== x || t[3] !== y
    ? ((N = (e) => {
        (b.logProductEvent(L, {
          action: R.CODEX_AUTOMATION_ACTION_UPDATED,
          source: z.CODEX_AUTOMATION_SOURCE_PR_MERGE_HELPER,
          success: !0,
          ...dt(e.item),
        }),
          x.invalidateQueries({ queryKey: g(`list-automations`) }),
          y
            .get(le)
            .success(
              E.formatMessage({
        ...
        (b.logProductEvent(L, {
          ...
          failureReason:
            ...
            `Automation does not exist in the app and could not be updated. It may have been deleted manually by the user.`
              ? V.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION
              : V.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
        }),
          y
            .get(le)
            .danger(
  ...
  let B;
  t[9] !== N || t[10] !== I
    ? ((B = { onSuccess: N, onError: I }), (t[9] = N), (t[10] = I), (t[11] = B))
    : (B = t[11]);
  let H = _(`automation-update`, B),
    U = (0, Q.useId)(),
    te = r ?? i.hostId ?? `local`,
    ne = T.data,
    re = T.isLoading || T.isFetching,
    W,
    G,
    q;
  if (t[12] !== ne?.items || t[13] !== T.isError || t[14] !== re || t[15] !== C || t[16] !== w) {
    W = ht({ automations: ne?.items ?? [], conversationId: C, includePausedAutomations: !0 });
    let e = C == null && w != null;
    ((G = W?.status === `PAUSED`),
      (q = mn({
        automationStatus: W?.status,
        hasConversation: C != null,
        isAutomationsLoading: re,
        isAutomationsQueryError: T.isError,
        isTaskStarting: e,
      })),
      (t[12] = ne?.items),
      (t[13] = T.isError),
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ae = t[20]);
  let Y;
  t[21] !== i || t[22] !== l || t[23] !== te
    ? ((Y = { hostId: te, item: i, onSuccess: ae, repo: l }),
      (t[21] = i),
      (t[22] = l),
      (t[23] = te),
      (t[24] = Y))
    : (Y = t[24]);
  let X = En(Y),
    oe = X.isPending || X.isAgentModePending,
    se = X.isPending || H.isPending || (!G && !ie && X.isAgentModePending),
    ce;
  t[25] !== W ||
  t[26] !== ie ||
  t[27] !== G ||
  ...
  t[37] !== w
    ? ((ce = (e) => {
        if ((h && e.stopPropagation(), G && W != null)) {
          (Vt(y, { action: `merge_with_codex_resumed`, item: i, surface: v }), H.mutate(_n(W)));
          return;
        }
        if (ie) {
          let e = Tn({ conversationId: C, pendingWorktreeId: w });
          e != null &&
            (Vt(y, { action: `merge_with_codex_task_opened`, item: i, surface: v }), D(e));
          return;
        }
        if (!X.isAgentModePending) {
          if (O) {
            (Vt(y, { action: `merge_with_codex_started`, item: i, surface: v }), X.mutate(!1));
            return;
          }
          (Vt(y, { action: `merge_with_codex_dialog_opened`, item: i, surface: v }), A(!1), M(!0));
        }
      }),
      (t[25] = W),
      (t[26] = ie),
  ...
  let ue = ce,
    de;
  t[39] !== k || t[40] !== i || t[41] !== y || t[42] !== X || t[43] !== v
    ? ((de = (e) => {
        (e.preventDefault(),
          !X.isAgentModePending &&
            (Vt(y, { action: `merge_with_codex_started`, item: i, surface: v }), X.mutate(k)));
      }),
      (t[39] = k),
      (t[40] = i),
      (t[41] = y),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, $.jsx)(ke, { className: `icon-xxs` })), (t[46] = me))
    : (me = t[46]);
  let ge;
  t[47] !== ie || t[48] !== G
    ? ((ge = G
    ...
    : (ge = t[49]);
  let _e;
  t[50] !== n || t[51] !== ue || t[52] !== se || t[53] !== m || t[54] !== ge
    ? ((_e = (0, $.jsx)(J, {
        tooltipContent: pe,
        children: (0, $.jsxs)(K, {
          className: n,
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, $.jsx)(ke, { className: `icon-sm text-token-foreground` })),
      (be = (0, $.jsx)(F, {
  ...
  t[63] === E
    ...
    : ((Te = E.formatMessage({
      ...
      (t[64] = Te));
  let Ee;
  t[65] !== k || t[66] !== X.isPending || t[67] !== Te
    ? ((Ee = (0, $.jsx)(je, {
        ...
        children: (0, $.jsxs)(`label`, {
          ...
          children: [
            Ce,
            (0, $.jsx)(vt, { checked: k, disabled: we, ariaLabel: Te, size: `sm`, onChange: A }),
          ],
        }),
      })),
      (t[65] = k),
  ...
  t[69] === y
    ...
    : ((De = (e) => {
      ...
      (t[70] = De));
  let Oe;
  t[71] !== O || t[72] !== U || t[73] !== X.isPending || t[74] !== De
    ? ((Oe = (0, $.jsx)(Ve, { id: U, checked: O, disabled: X.isPending, onCheckedChange: De })),
      (t[71] = O),
      (t[72] = U),
      (t[73] = X.isPending),
      (t[74] = De),
  ...
  t[85] === oe
    ? (He = t[86])
    : ((He = (0, $.jsx)(K, { color: `primary`, loading: oe, type: `submit`, children: Be })),
      (t[85] = oe),
      (t[86] = He));
  let Ue;
  t[87] !== Ie || t[88] !== ze || t[89] !== He
    ? ((Ue = (0, $.jsxs)(Fe, { children: [Ie, ze, He] })),
      (t[87] = Ie),
      (t[88] = ze),
      (t[89] = He),
      (t[90] = Ue))
  ...
  return (
    t[99] !== _e || t[100] !== Ge
      ? ((Ke = (0, $.jsxs)($.Fragment, { children: [_e, Ge] })),
        (t[99] = _e),
        (t[100] = Ge),
        (t[101] = Ke))
      : (Ke = t[101]),
...
function On(e) {
  ...
  t[6] !== a
    ? ((y = async () => {
        await Promise.all([
          p.invalidateQueries({ queryKey: g(`gh-pr-board`) }),
          p.invalidateQueries({ queryKey: g(`gh-pr-body`, a) }),
          p.invalidateQueries({ queryKey: g(`gh-pr-checks`, a) }),
          p.invalidateQueries({ queryKey: g(`gh-pr-comments`, a) }),
          p.invalidateQueries({
            queryKey: g(`gh-pr-summary`, { cwd: r.cwd, headBranch: r.headBranch, hostId: n }),
          }),
          p.invalidateQueries({
            queryKey: g(`gh-pr-status`, { cwd: r.cwd, headBranch: r.headBranch, hostId: n }),
          }),
          p.invalidateQueries({
            queryKey: g(`gh-pr-status`, {
              cwd: r.cwd,
  ...
  t[8] !== b || t[9] !== v || t[10] !== u
    ? ((S = (e) => {
        (async () => {
          (await b(),
            e && v !== `squash` && (await ie(u, x.pullRequestMergeMethod, `squash`)),
            _(!1));
        })();
      }),
      (t[8] = b),
  ...
  let k = dn(O),
    ...
    I = !A || M || j || i?.canMerge !== !0 || T.isPending,
    L = !A || M || (!N && j) || D.isPending,
    R = !A || M || k.isPending,
    z;
  t[24] !== j || t[25] !== M || t[26] !== A || t[27] !== r || t[28] !== i || t[29] !== m
    ? ((z = m && A && !M && !j && i.canMerge !== !0 && pn(r)),
      (t[24] = j),
      (t[25] = M),
      (t[26] = A),
      (t[27] = r),
        ...
        (Vt(u, { action: i.isDraft ? `mark_ready` : `mark_draft`, item: r, surface: l }),
          k.mutate(
            { action: e, cwd: r.cwd, number: r.number, repo: i.repo },
            {
              onSuccess: (t) => {
                if (t.status !== `success`) {
                  u.get(le).danger(t.error);
                  return;
                }
                (u.get(le).success(kn(e, d)), C(!1));
              },
            },
          ));
      }),
          ...
          D.mutate(
            ...
            },
            {
              onSuccess: (t) => {
                ...
                (u.get(le).success(kn(`toggle-auto-merge`, d)), C(h && e));
              },
            },
          ));
      }),
  ...
  t[59] === j
    ...
    : ((W = j
      ...
      (t[60] = W));
  let G;
  t[61] !== k.isPending || t[62] !== R || t[63] !== H || t[64] !== W
    ? ((G = (0, $.jsx)(K, {
        color: `outline`,
        disabled: R,
        loading: k.isPending,
  ...
  t[66] === D.isPending
    ? (J = t[67])
    : ((J = D.isPending ? (0, $.jsx)(ae, { className: `icon-xxs` }) : null),
      (t[66] = D.isPending),
      (t[67] = J));
  let Y;
  t[68] === J
    ? (Y = t[69])
    : ((Y = (0, $.jsx)(`span`, { className: `inline-flex w-3 justify-center`, children: J })),
      (t[68] = J),
      (t[69] = Y));
  let X;
  ...
  t[71] === d
    ...
    : ((oe = d.formatMessage({
      ...
      (t[72] = oe));
  let se;
  t[73] !== L || t[74] !== te || t[75] !== N || t[76] !== oe
    ? ((se = (0, $.jsx)(vt, { checked: N, disabled: L, ariaLabel: oe, size: `sm`, onChange: te })),
      (t[73] = L),
      (t[74] = te),
      (t[75] = N),
      (t[76] = oe),
...
function An({ scope: e, error: t, intl: n, mergeMethod: r, onSquashRetry: i }) {
...
var jn = 12,
  ...
  Fn = 0.9,
  In = 150,
  Ln = { version: 0, listeners: new Set() },
  Rn = (0, Q.createContext)(null);
function zn(e) {
  let t = (0, Z.c)(165),
    {
      id: n,
    ...
    M;
  t[0] === l ? (M = t[1]) : ((M = qn(l)), (t[0] = l), (t[1] = M));
  let N = j ? Kn(A) : M,
    [P, F] = (0, Q.useState)(0),
    [I, L] = (0, Q.useState)(!1),
    R = (0, Q.useRef)(null),
  ...
  t[28] !== k
    ? ((de = () => {
        ...
        U.current ? i && Vn([re, W, G], V) : (Vn([re, W, G], V), (U.current = !0));
        let a = () => {
          ((te.current = t), (ne.current = D));
        };
        if (x > 0 && T && t <= x && !ae) {
          (er({ containerWidth: t, minRightWidth: y, isOpen: E, node: e, rafRef: z }), a());
          return;
        }
        let o = Wn(t);
        if (!T) {
        ...
        if (!E) {
          let { rightWidth: n, boundedLeftRatio: r } = Qn({
            containerWidth: t,
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: o * Kn(K.current),
          });
          K.current = r;
          let i = Zn(q.current > 0 ? q.current : n, o);
          ((q.current = i),
            nr({
              containerWidth: t,
              handleWidth: 0,
        ...
        let u = z.current;
        return () => {
          (u != null && (cancelAnimationFrame(u), z.current === u && (z.current = null)),
  ...
  t[44] !== O ||
  t[45] !== k
    ? ((fe = [P, D, E, Y, x, ae, T, J, S, C, I, v, y, w, O, k]),
      (t[30] = P),
      (t[31] = x),
      (t[32] = Y),
      (t[33] = D),
  ...
  t[53] !== L
    ? ((pe = (e) => {
        ...
        J ||
          ...
          (ee.current = t.getBoundingClientRect().left),
          S || g?.(!0),
          C || _?.(!0),
          L(!0));
      }),
  ...
  t[87] !== _
    ? ((_e = (e) => {
        ...
        if (!t || !n) return;
        if (J) {
          er({ containerWidth: n, minRightWidth: y, isOpen: !1, node: t, rafRef: z });
          return;
        }
        let r = Wn(n),
          { rightWidth: i, boundedLeftRatio: a } = Qn({
            containerWidth: n,
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: r * Kn(K.current),
          });
        K.current = a;
        let o = Zn(q.current > 0 ? q.current : i, r);
        ((q.current = o),
          nr({
            containerWidth: n,
            handleWidth: 0,
  ...
  t[101] !== k
    ? ((ye = (e) => {
        ...
        if (C || !T) return;
        if ((Hn([re, W, G], V), _?.(!0), J)) {
          er({ containerWidth: n, minRightWidth: y, isOpen: !0, node: t, rafRef: z });
          return;
        }
        let {
          boundedLeftWidth: r,
  ...
  let we = Ce,
    ...
    Oe;
  t[115] !== a || t[116] !== De
    ? ((Oe = H(`group/split-view relative h-full w-full min-w-0 overflow-hidden`, De, a)),
      (t[115] = a),
      (t[116] = De),
      (t[117] = Oe))
    : (Oe = t[117]);
  ...
  t[127] !== Ae || t[128] !== Me || t[129] !== Fe
    ? ((Ie = (0, $.jsx)(`div`, { ref: re, className: Ae, style: Me, children: Fe })),
      (t[127] = Ae),
      (t[128] = Me),
      (t[129] = Fe),
      (t[130] = Ie))
        ...
        ? (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(Q.Activity, {
              ...
              children: (0, $.jsx)(`div`, {
                ...
                style: { transitionDelay: E ? `${In}ms` : `0ms` },
                children: i,
              }),
            }),
          })
  ...
  t[153] !== Ve || t[154] !== Ue || t[155] !== We
    ? ((Ge = (0, $.jsx)(`div`, { ref: G, className: Ve, style: Ue, children: We })),
      (t[153] = Ve),
      (t[154] = Ue),
      (t[155] = We),
      (t[156] = Ge))
  ...
  t[157] !== Oe || t[158] !== Ie || t[159] !== Le || t[160] !== Ge
    ? ((Ke = (0, $.jsxs)(`div`, { ref: R, className: Oe, children: [Ie, Le, Ge] })),
      (t[157] = Oe),
      (t[158] = Ie),
      (t[159] = Le),
      (t[160] = Ge),
  ...
  return (
    t[162] !== we || t[163] !== Ke
      ? ((qe = (0, $.jsx)(Rn.Provider, { value: we, children: Ke })),
        (t[162] = we),
        (t[163] = Ke),
        (t[164] = qe))
      : (qe = t[164]),
...
function Qn({ containerWidth: e, minLeftWidth: t, minRightWidth: n, leftWidth: r }) {
  let i = Wn(e),
    a = Xn(r, e, t, n),
    o = Zn(Math.max(0, i - a), i);
  return { openAvailableWidth: i, boundedLeftWidth: a, boundedLeftRatio: Jn(i, a), rightWidth: o };
}
function $n(e, t) {
  let n = Math.min(t, e),
    r = e * Fn;
  return Zn(Math.max(n, r), e);
}
function er({ containerWidth: e, minRightWidth: t, isOpen: n, node: r, rafRef: i }) {
  let a = $n(e, t);
  nr({
    containerWidth: e,
    handleWidth: 0,
...
var ir = d(c, `gh-current-user`, (e) => ({ params: { hostId: e }, staleTime: v.ONE_MINUTE })),
  ar = 25,
  or = 100,
  sr = 50,
  cr = 0,
  lr = `pull-request-code-review-file-tree-left`;
function ur(e) {
  let t = (0, Z.c)(50),
  ...
  t[33] === T
    ? (E = t[34])
    : ((E = (0, $.jsx)(et, { diffControls: T, showHideWhitespace: !1, showLoadFullFiles: !1 })),
      (t[33] = T),
      (t[34] = E));
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, $.jsx)(Ue, { className: `icon-xs` })), (t[38] = k))
    : (k = t[38]);
  let A;
  ...
  let j;
  t[44] !== _ || t[45] !== A
    ? ((j = (0, $.jsx)(J, { tooltipContent: _, delayOpen: !0, children: A })),
      (t[44] = _),
      (t[45] = A),
      (t[46] = j))
    : (j = t[46]);
...
function fr({
  ...
  repo: u,
  onCommentPosted: d,
  surface: f = `pull_request_page`,
}) {
  let p = o(c),
    h = N(t ?? `local`),
    g = P(),
    y = s(Te),
    b = (0, Q.useRef)(new Map()),
    [x, S] = (0, Q.useState)(),
    [C, w] = (0, Q.useState)({}),
    [T, E] = (0, Q.useState)(null),
    [D, O] = (0, Q.useState)(``),
    A = (0, Q.useRef)(new Map()),
    [j, M] = (0, Q.useState)(() => new Set()),
    { data: I } = i(ir, t),
    L = (0, Q.useCallback)((e, t) => {
      let n = k(e);
      M((e) => {
    ...
    R = (0, Q.useCallback)(
      (e) => {
        let t = Dt(e),
          n = A.current.get(t);
        (A.current.delete(t), n != null && L(n, !1));
      },
      [L],
    ),
    z = (0, Q.useCallback)((e) => {
    ...
    { data: V, isLoading: ee } = m(`gh-pr-diff`, {
      source: `pull_request_board`,
      params: { cwd: e, hostId: t, number: r, repo: u ?? null },
      queryConfig: { refetchOnWindowFocus: `always`, staleTime: v.FIVE_SECONDS },
    }),
    [H] = (0, Q.useState)(() => new fe()),
    U = (0, Q.useCallback)(
      (e) => {
        if (e != null) {
          H.setup(e);
    ...
    ne = V?.status === `success` ? De(V.unifiedDiff) : [],
    re = ne.map((e) => e.metadata.name),
    W = I?.status === `success` ? I.avatarUrl : void 0,
    G =
      I?.status === `success`
        ? I.login
        : g.formatMessage({
    ...
    K = D.trim().length === 0 ? re : re.filter((e) => e.includes(D.trim())),
    q = (0, Q.useMemo)(
      () =>
        l == null || l.length === 0 ? void 0 : Tt({ comments: l, filePaths: re, workspaceRoot: e }),
      [e, re, l],
    );
  function ie(e) {
    (S(e), b.current.get(e)?.scrollIntoView({ block: `start` }));
  }
  let ae = (0, Q.useCallback)(
      (n) => {
        ...
        (A.current.set(Dt(i), n), L(n, !0), B.mutate(i));
      },
      [e, t, r, B, u, L],
    ),
    J = (0, Q.useCallback)(
      (e, t) => {
        let n = Ct({ currentComments: C[e] ?? [], nextComments: t });
        (E(null), w((n) => ({ ...n, [e]: t })));
        for (let e of n) ae(e);
      },
      [C, ae],
...
function mr(e) {
  let t = (0, Z.c)(36),
    ...
    C;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = { source: `pull_request_board` }), (t[0] = C))
    : (C = t[0]);
  let w = _(`gh-pr-comment`, C),
    { data: T } = i(ir, r),
    D;
  t[1] === y ? (D = t[2]) : ((D = y.trim()), (t[1] = y), (t[2] = D));
  let O = D,
    k = d != null,
    A;
  t[3] !== r ||
  ...
  t[12] !== O
    ? ((A = async (e) => {
        if ((e.preventDefault(), !O || w.isPending)) return;
        S(null);
        let t = await w
          .mutateAsync({
            body: O,
        ...
        (Ht(g, { kind: k ? `reply` : `comment`, surface: h }), b(``), await l().catch(hr));
      }),
      (t[3] = r),
      (t[4] = k),
      (t[5] = a),
    ...
    : (A = t[13]);
  let j = A,
    M = T?.status === `success` ? T : void 0,
    N;
  t[14] !== v || t[15] !== M
    ? ((N = yr({ intl: v, user: M })), (t[14] = v), (t[15] = M), (t[16] = N))
    : (N = t[16]);
  let F = N,
    I = k && `w-full`,
    L;
  t[17] === I ? (L = t[18]) : ((L = H(`flex flex-col gap-2`, I)), (t[17] = I), (t[18] = L));
  let R;
  ...
  t[29] === x
    ...
    : ((V =
        x == null
          ? null
          : (0, $.jsx)(`div`, { className: `px-1 text-sm text-token-charts-red`, children: x })),
      (t[29] = x),
      (t[30] = V));
  let ee;
  return (
    t[31] !== j || t[32] !== B || t[33] !== V || t[34] !== L
      ? ((ee = (0, $.jsxs)(`form`, { className: L, onSubmit: j, children: [B, V] })),
        (t[31] = j),
        (t[32] = B),
        (t[33] = V),
        (t[34] = L),
...
function _r(e) {
  ...
  t[10] === v
    ? (y = t[11])
    : ((y = H(`flex min-w-0 items-center gap-2`, v)), (t[10] = v), (t[11] = y));
  let b;
  t[12] === s
    ? (b = t[13])
    : ((b = (e) => {
  ...
  t[24] === a
    ? (C = t[25])
    : ((C = a ? null : (0, $.jsx)(de, { className: `icon-xs` })), (t[24] = a), (t[25] = C));
  let w;
  ...
  let T;
  t[31] !== p || t[32] !== w
    ? ((T = (0, $.jsx)(J, { delayDuration: 250, tooltipContent: p, children: w })),
      (t[31] = p),
      (t[32] = w),
      (t[33] = T))
    : (T = t[33]);
...
function br(e) {
  ...
  if (t[0] !== d?.items || t[1] !== i || t[2] !== o) {
    let e = ht({ automations: d?.items ?? [], conversationId: i, includePausedAutomations: !0 });
    f = i == null && o != null;
    let n;
    (t[6] !== i || t[7] !== o
      ? ((n = Tn({ conversationId: i, pendingWorktreeId: o })), (t[6] = i), (t[7] = o), (t[8] = n))
      : (n = t[8]),
      (m = n),
      (p = xr({ automationStatus: e?.status, isTaskStarting: f })),
      (t[0] = d?.items),
      (t[1] = i),
      (t[2] = o),
      (t[3] = f),
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(ke, { className: `icon-xs shrink-0` })), (t[10] = _))
    : (_ = t[10]);
  let v;
  t[11] === h
    ? (v = t[12])
    : ((v = (0, $.jsxs)(`span`, {
        ...
        children: [
          _,
          (0, $.jsx)(`span`, { className: `truncate`, children: (0, $.jsx)(Sr, { status: h }) }),
        ],
      })),
      (t[11] = h),
      (t[12] = v));
  let y;
  t[13] !== c || t[14] !== l
    ? ((y = (0, $.jsx)(wr, { ciJobsFixed: c, mergeConflictsResolved: l })),
      (t[13] = c),
      (t[14] = l),
      (t[15] = y))
    : (y = t[15]);
  ...
  t[16] !== v || t[17] !== y
    ...
    : (b = t[18]);
  let x;
  t[19] === m ? (x = t[20]) : ((x = (0, $.jsx)(Cr, { taskRoute: m })), (t[19] = m), (t[20] = x));
  let S;
  return (
    t[21] !== b || t[22] !== x
      ? ((S = (0, $.jsxs)(`div`, {
...
function xr({ automationStatus: e, isTaskStarting: t }) {
  switch (t ? `STARTING` : e) {
    case `STARTING`:
      return `STARTING`;
    case `ACTIVE`:
...
function wr(e) {
  ...
  let s;
  t[4] !== i || t[5] !== a
    ? ((s = i && a ? (0, $.jsx)(G, { className: `shrink-0` }) : null),
      (t[4] = i),
      (t[5] = a),
      (t[6] = s))
    : (s = t[6]);
...
function Tr(e) {
  let t = (0, Z.c)(112),
    ...
    d = c === void 0 ? !0 : c,
    f = u === void 0 ? `pull_request_page` : u,
    p = o(ve),
    g = P(),
    [_, y] = (0, Q.useState)(`pull-request`),
    b = d ? _ : `pull-request`,
    [x, S] = (0, Q.useState)(!1),
    C;
  t[0] !== n || t[1] !== r || t[2] !== s
    ? ((C = Gr({ hostId: n, item: r, repo: s })), (t[0] = n), (t[1] = r), (t[2] = s), (t[3] = C))
    : (C = t[3]);
  let w = C,
    T = b === `code-review`,
    E;
  t[4] === T
    ? (E = t[5])
    : ((E = { enabled: T, intervalMs: v.ONE_MINUTE, staleTime: v.ONE_MINUTE }),
      (t[4] = T),
      (t[5] = E));
  let D;
  t[6] !== w || t[7] !== E
    ? ((D = { source: `pull_request_board`, params: w, queryConfig: E }),
      (t[6] = w),
      (t[7] = E),
      (t[8] = D))
    : (D = t[8]);
  let { data: O, refetch: k } = m(`gh-pr-comments`, D),
    A;
  t[9] === O
    ? (A = t[10])
  ...
  let j = A,
    M;
  t[11] !== g || t[12] !== r || t[13] !== p || t[14] !== f
    ? ((M = function (e) {
        (Vt(p, { action: `copy_url`, item: r, surface: f }),
          rn({ scope: p, event: e, intl: g, url: r.url }));
      }),
      (t[11] = g),
      (t[12] = r),
      (t[13] = p),
  ...
  let N = M,
    I;
  t[16] !== N || t[17] !== p.value.pathname
    ? ((I = () => {
        p.value.pathname === `/pull-requests` && N();
      }),
      (t[16] = N),
      (t[17] = p.value.pathname),
      (t[18] = I))
    : (I = t[18]);
  let L;
  (t[19] !== g ||
  ...
  t[23] !== p ||
  t[24] !== f
    ? ((L = [g, r.isAuthor, r.state, r.url, p, f]),
      (t[19] = g),
      (t[20] = r.isAuthor),
      (t[21] = r.state),
      (t[22] = r.url),
      ...
      (t[25] = L))
    : (L = t[25]),
    h(`copy-working-directory`, I, L));
  let R;
  t[26] === r.state
    ? (R = t[27])
    : ((R = (0, $.jsx)($e, { className: `icon-sm shrink-0`, state: r.state })),
      (t[26] = r.state),
      (t[27] = R));
  let z;
  t[28] === r.title
  ...
  let V;
  t[32] !== z || t[33] !== B
    ? ((V = (0, $.jsxs)(`div`, { className: `flex min-w-0 items-center gap-2`, children: [z, B] })),
      (t[32] = z),
      (t[33] = B),
      (t[34] = V))
    : (V = t[34]);
  ...
  t[38] === r.headBranch
    ? (U = t[39])
    : ((U = (0, $.jsx)(`span`, { className: `truncate`, children: r.headBranch })),
      (t[38] = r.headBranch),
      (t[39] = U));
  let te;
  ...
  t[41] === r.baseBranch
    ? (ne = t[42])
    : ((ne = (0, $.jsx)(`span`, { className: `truncate`, children: r.baseBranch })),
      (t[41] = r.baseBranch),
      (t[42] = ne));
  let re;
  t[43] !== U || t[44] !== ne
  ...
  let W;
  t[46] !== ee || t[47] !== re
    ? ((W = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [ee, re] })),
      (t[46] = ee),
      (t[47] = re),
      (t[48] = W))
    : (W = t[48]);
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ie = (0, $.jsx)(Qe, { className: `icon-xs` })), (t[53] = ie))
    : (ie = t[53]);
  let ae;
  t[54] !== N || t[55] !== q
    ? ((ae = (0, $.jsx)(K, {
  ...
  let Y;
  t[57] !== G || t[58] !== ae
    ? ((Y = (0, $.jsx)(J, { tooltipContent: G, children: ae })),
      (t[57] = G),
      (t[58] = ae),
      (t[59] = Y))
    : (Y = t[59]);
  ...
  t[62] === g
    ...
    : ((oe = g.formatMessage({
      ...
      (t[63] = oe));
  let se;
  t[64] !== r || t[65] !== p || t[66] !== f
    ? ((se = () => {
        (Vt(p, { action: `open_in_browser`, item: r, surface: f }),
          l.dispatchMessage(`open-in-browser`, { url: r.url }));
      }),
      (t[64] = r),
      (t[65] = p),
      (t[66] = f),
  ...
  t[68] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((le = (0, $.jsx)(ce, { className: `icon-xs` })), (t[68] = le))
    : (le = t[68]);
  let ue;
  t[69] !== oe || t[70] !== se
    ? ((ue = (0, $.jsx)(K, {
  ...
  let de;
  t[72] !== X || t[73] !== ue
    ? ((de = (0, $.jsx)(J, { tooltipContent: X, children: ue })),
      (t[72] = X),
      (t[73] = ue),
      (t[74] = de))
    : (de = t[74]);
  ...
  t[77] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = (0, $.jsx)(xe, { className: `icon-xs` })), (t[77] = pe))
    : (pe = t[77]);
  let me;
  t[78] !== i || t[79] !== fe
    ? ((me = (0, $.jsx)(K, {
    ...
    ? ((_e = d
        ? (0, $.jsxs)(`div`, {
            className: H(
              ...
              b === `pull-request` ? `border-b border-token-border` : null,
            ),
            children: [
              (0, $.jsx)(zt, {
              ...
              b === `code-review`
                ? (0, $.jsx)(ur, { isFileTreeOpen: x, onFileTreeOpenChange: S })
                : null,
            ],
          })
        : null),
    ...
    ? ((ye = (0, $.jsx)(`div`, {
        ...
        children:
          b === `code-review`
            ...
            : (0, $.jsx)(Er, { hostId: n, item: r, relatedThreads: a, request: w, surface: f }),
      })),
      (t[97] = b),
      (t[98] = n),
      (t[99] = x),
...
function Er(e) {
  let t = (0, Z.c)(26),
    ...
    s = Ft(),
    c;
  t[0] === a ? (c = t[1]) : ((c = (0, $.jsx)(kr, { request: a })), (t[0] = a), (t[1] = c));
  let l;
  t[2] !== r || t[3] !== s
    ? ((l = s ? (0, $.jsx)(br, { item: r }) : null), (t[2] = r), (t[3] = s), (t[4] = l))
    : (l = t[4]);
  let u;
  t[5] === i ? (u = t[6]) : ((u = (0, $.jsx)(Dr, { threads: i })), (t[5] = i), (t[6] = u));
  let d, f;
  t[7] === a
    ? ((d = t[8]), (f = t[9]))
    : ((d = (0, $.jsx)(Ar, { request: a })),
      (f = (0, $.jsx)(jr, { request: a })),
      (t[7] = a),
      (t[8] = d),
      (t[9] = f));
  let p, m, h;
  t[10] !== n || t[11] !== r || t[12] !== a || t[13] !== o
    ? ((p = (0, $.jsx)(Pr, { hostId: n, item: r, request: a, surface: o })),
      (m = (0, $.jsx)(Fr, { hostId: n, item: r, request: a, surface: o })),
      (h = (0, $.jsx)(Ir, { hostId: n, item: r, request: a, surface: o })),
      (t[10] = n),
      (t[11] = r),
      (t[12] = a),
      (t[13] = o),
...
function Dr(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (r = t[0]);
  let i;
  t[1] === n ? (i = t[2]) : ((i = n.map(Or)), (t[1] = n), (t[2] = i));
  let a;
  return (
    t[3] === i
      ? (a = t[4])
...
function kr(e) {
  let t = (0, Z.c)(16),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = { intervalMs: v.ONE_MINUTE, staleTime: v.ONE_MINUTE }), (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = m(`gh-pr-body`, i),
  ...
  if (s) {
    ...
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[3]);
    let n;
    t[4] === o ? (n = t[5]) : ((n = ti(o)), (t[4] = o), (t[5] = n));
    let r;
    return (
      t[6] === n
        ? (r = t[7])
        : ((r = (0, $.jsx)(ni, { title: e, description: n })), (t[6] = n), (t[7] = r)),
      r
    );
  }
  if (l || a == null) {
...
function Ar(e) {
  let t = (0, Z.c)(21),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = { intervalMs: v.ONE_MINUTE, staleTime: v.ONE_MINUTE }), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === n
    ? (a = t[2])
    : ((a = { source: `pull_request_board`, params: n, queryConfig: i }), (t[1] = n), (t[2] = a));
  let { data: o, error: s, isError: c, isFetching: l, isLoading: u } = m(`gh-pr-comments`, a);
  if (c) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(F, {
      ...
      : (e = t[3]);
    let n;
    t[4] === s ? (n = t[5]) : ((n = ti(s)), (t[4] = s), (t[5] = n));
    let r;
    return (
      t[6] === n
        ? (r = t[7])
  ...
  t[12] !== o.reviewers || t[13] !== r
    ? ((p = Xe(o.reviewers, r)), (t[12] = o.reviewers), (t[13] = r), (t[14] = p))
    : (p = t[14]);
  let h;
  ...
  t[16] === p
    ? (g = t[17])
    : ((g = (0, $.jsx)(Je, { emptyMessage: f, groups: p, title: h })), (t[16] = p), (t[17] = g));
  let _;
  return (
    t[18] !== d || t[19] !== g
      ? ((_ = (0, $.jsxs)(`div`, {
...
function jr(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = m(`gh-pr-checks`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(F, {
  ...
  t[11] !== a.checks || t[12] !== a.ciStatus
    ? ((d = (0, $.jsx)(Mr, { checks: a.checks, ciStatus: a.ciStatus })),
      (t[11] = a.checks),
      (t[12] = a.ciStatus),
      (t[13] = d))
    : (d = t[13]);
...
function Mr(e) {
  ...
  let o;
  t[0] !== n || t[1] !== r
    ? ((o = rt({ checks: n, ciStatus: r })), (t[0] = n), (t[1] = r), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === r ? (s = t[4]) : ((s = it(r)), (t[3] = r), (t[4] = s));
  let c = i ? 180 : 0,
    l;
  t[5] === c ? (l = t[6]) : ((l = { rotate: c }), (t[5] = c), (t[6] = l));
  let u;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(Ke, { className: `icon-2xs` })), (t[7] = u))
    : (u = t[7]);
  let d;
  t[8] === l
    ? (d = t[9])
  ...
  t[19] === m
    ? (h = t[20])
    : ((h = (0, $.jsx)(ne, { initial: !1, children: m })), (t[19] = m), (t[20] = h));
  let g;
  return (
    t[21] !== h || t[22] !== p
...
function Pr(e) {
  let t = (0, Z.c)(36),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = { intervalMs: v.ONE_MINUTE, staleTime: v.ONE_MINUTE }), (t[0] = o))
    : (o = t[0]);
  let s;
  t[1] === i
    ? (s = t[2])
  ...
  let {
    ...
    h = d && c != null,
    g;
  t[3] === h ? (g = t[4]) : ((g = (0, $.jsx)(Qr, { isFetching: h })), (t[3] = h), (t[4] = g));
  let _ = g;
  if (u) {
    let e;
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[5]);
    let n;
    t[6] === l ? (n = t[7]) : ((n = ti(l)), (t[6] = l), (t[7] = n));
    let r;
    return (
      t[8] === n
        ? (r = t[9])
        : ((r = (0, $.jsx)(ni, { title: e, description: n })), (t[8] = n), (t[9] = r)),
      r
    );
  }
  if (f || c == null) {
  ...
  if (c.activityItems.length === 0) {
    ...
    t[11] === _
      ? (e = t[12])
      : ((e = (0, $.jsx)(We.SectionLabel, { children: _ })), (t[11] = _), (t[12] = e));
    let n;
  ...
  t[16] === _
    ? (y = t[17])
    : ((y = (0, $.jsx)(We.SectionLabel, { children: _ })), (t[16] = _), (t[17] = y));
  let b;
  if (
  ...
  t[31] === b
    ? (x = t[32])
    : ((x = (0, $.jsx)(`div`, { className: `flex flex-col gap-3`, children: b })),
      (t[31] = b),
      (t[32] = x));
  let S;
  return (
    t[33] !== y || t[34] !== x
      ? ((S = (0, $.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [y, x] })),
        (t[33] = y),
        (t[34] = x),
        (t[35] = S))
      : (S = t[35]),
...
function Fr(e) {
  ...
  t[0] !== o || t[1] !== i
    ? ((c = async () => {
        await o.invalidateQueries({ queryKey: g(`gh-pr-comments`, i) });
      }),
      (t[0] = o),
      (t[1] = i),
      (t[2] = c))
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== a || t[6] !== s || t[7] !== c
      ? ((l = (0, $.jsx)(mr, { hostId: n, item: r, repo: s, surface: a, onCommentPosted: c })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = a),
        (t[6] = s),
...
function Ir(e) {
  ...
  t[1] === i
    ? (s = t[2])
    : ((s = { source: `pull_request_board`, params: i, queryConfig: o }), (t[1] = i), (t[2] = s));
  let { data: c, error: l, isError: u, isFetching: d, isLoading: f } = m(`gh-pr-body`, s);
  if (!r.isAuthor) return null;
  if (u) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[3]);
    let n;
    t[4] === l ? (n = t[5]) : ((n = ti(l)), (t[4] = l), (t[5] = n));
    let r;
    return (
      t[6] === n
        ? (r = t[7])
  ...
  t[8] !== d || t[9] !== f
    ? ((p =
      ...
      (t[10] = p))
    : (p = t[10]);
  let h = `${r.number}:${r.headBranch}`,
    g = c ?? null,
    _;
  t[11] !== n || t[12] !== r || t[13] !== i || t[14] !== a || t[15] !== h || t[16] !== g
    ? ((_ = (0, $.jsx)(On, { hostId: n, item: r, pullRequestBody: g, request: i, surface: a }, h)),
      (t[11] = n),
      (t[12] = r),
      (t[13] = i),
      (t[14] = a),
  ...
  return (
    t[18] !== p || t[19] !== _
      ? ((y = (0, $.jsxs)(`div`, { className: `relative flex flex-col gap-2`, children: [p, _] })),
        (t[18] = p),
        (t[19] = _),
        (t[20] = y))
      : (y = t[20]),
...
function Lr(e) {
  ...
  if (r.type === `event`) {
    let e;
    return (
      t[0] === r ? (e = t[1]) : ((e = (0, $.jsx)(zr, { item: r })), (t[0] = r), (t[1] = e)), e
    );
  }
  let u;
...
function Rr(e) {
  let t = (0, Z.c)(10),
    { item: n, onReply: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = Wr(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === a
    ? (o = t[3])
  ...
  t[5] === r
    ? (c = t[6])
    : ((c = (0, $.jsx)(K, { color: `ghost`, size: `composerSm`, onClick: r, children: s })),
      (t[5] = r),
      (t[6] = c));
  let l;
  return (
...
function zr(e) {
  ...
  t[10] !== a || t[11] !== n
    ? ((u = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(Br, { actorLabel: a, item: n }),
      })),
      (t[10] = a),
      (t[11] = n),
      (t[12] = u))
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (d = t[13]);
  let f;
  t[14] === n.createdAt ? (f = t[15]) : ((f = st(n.createdAt)), (t[14] = n.createdAt), (t[15] = f));
  let p;
  t[16] === n.createdAt
    ? (p = t[17])
    : ((p = (0, $.jsx)(`span`, {
        className: `inline`,
        children: (0, $.jsx)(qe, { dateString: n.createdAt }),
      })),
      (t[16] = n.createdAt),
      (t[17] = p));
  let m;
  ...
  let g;
  t[21] !== h || t[22] !== f
    ? ((g = (0, $.jsx)(J, { delayDuration: 250, tooltipContent: f, children: h })),
      (t[21] = h),
      (t[22] = f),
      (t[23] = g))
    : (g = t[23]);
...
function Br(e) {
  let t = (0, Z.c)(10),
    ...
    a;
  t[0] !== i || t[1] !== r.event
    ? ((a = Vr(r.event, i)), (t[0] = i), (t[1] = r.event), (t[2] = a))
    : (a = t[2]);
  let o = a,
    s;
  t[3] === o ? (s = t[4]) : ((s = (0, $.jsx)(`span`, { children: o })), (t[3] = o), (t[4] = s));
  let c;
  t[5] === n ? (c = t[6]) : ((c = (0, $.jsx)(Hr, { children: n })), (t[5] = n), (t[6] = c));
  let l;
  return (
    t[7] !== s || t[8] !== c
...
function Ur(e) {
  switch (e) {
    case `approved`:
      return { Icon: _t, iconClassName: `text-token-charts-green` };
    case `changes_requested`:
      return { Icon: xe, iconClassName: `text-token-charts-red` };
    case `merged`:
      return { Icon: Ze, iconClassName: `text-token-charts-purple` };
    case `opened`:
      return { Icon: ut, iconClassName: `text-token-charts-green` };
  }
}
function Wr(e) {
...
function Gr({ hostId: e, item: t, repo: n }) {
...
function qr() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, $.jsx)(We.SectionLabel, { children: (0, $.jsx)(Zr, {}) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(jt, {
            icon: (0, $.jsx)(ae, { className: `icon-sm shrink-0 text-token-text-tertiary` }),
            label: (0, $.jsx)(F, {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(We.SectionLabel, { children: (0, $.jsx)(Qr, {}) }),
            (0, $.jsx)(Xr, {}),
          ],
        })),
        (e[0] = t))
    ...
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, $.jsx)($r, { className: `w-32` }),
            (0, $.jsx)($r, { className: `w-11/12` }),
          ],
        })),
        (e[0] = t))
      : (t = e[0]),
...
function Qr(e) {
  ...
  t[1] === r
    ? (a = t[2])
    : ((a = r ? (0, $.jsx)(ae, { className: `icon-xxs text-token-description-foreground` }) : null),
      (t[1] = r),
      (t[2] = a));
  let o;
  return (
...
function ei(e) {
  let t = (0, Z.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(ae, { className: `icon-xxs` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function ni(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, $.jsx)(We.SectionLabel, { className: `px-0 py-0`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function si(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = { merged: !0 }), (t[0] = p))
    : (p = t[0]);
  let [h, g] = (0, Q.useState)(p),
    [_, y] = (0, Q.useState)(null),
    b;
  t[1] === n
    ? (b = t[2])
    : ((b = Qt({ searchQuery: Xt(n), selectedFilterView: n })), (t[1] = n), (t[2] = b));
  let S = b,
    C = s === `all`,
    w;
  t[3] !== S ||
  ...
  t[8] !== i
    ? ((w = C
        ? { repos: i.map(li), searchQuery: S }
        : { cwd: E(r?.cwd ?? `/`), hostId: r?.hostId, repo: r?.repo ?? null, searchQuery: S }),
      (t[3] = S),
      (t[4] = C),
      (t[5] = r?.cwd),
      (t[6] = r?.hostId),
      ...
      (t[9] = w))
    : (w = t[9]);
  let T = C ? i.length > 0 : r != null,
    D;
  t[10] === T
    ? (D = t[11])
    : ((D = { enabled: T, intervalMs: v.THIRTY_SECONDS, staleTime: v.THIRTY_SECONDS }),
      (t[10] = T),
      (t[11] = D));
  let O;
  t[12] !== w || t[13] !== D
    ? ((O = { source: `pull_request_board`, params: w, queryConfig: D }),
      (t[12] = w),
      (t[13] = D),
      (t[14] = O))
    : (O = t[14]);
  let { data: k, isLoading: A } = m(`gh-pr-board`, O),
    j = q(x.pullRequestMergeMethod),
    M = k?.status === `success` ? k.items : [],
    N = Jt(M),
    I = N.find(ci)?.items[0] ?? null,
    L = $t({ items: M, selectedPullRequestNumber: a, selectedPullRequestUrl: o }),
    R = `${s ?? ``}:${n}:${S ?? ``}`,
    z = a != null || o != null;
  (0, Q.useEffect)(() => {
    I == null || z || _ === R || (y(R), c(I, { replace: !0 }));
  }, [R, _, I, z, c]);
  let B;
  t[15] === d
    ? (B = t[16])
    : ((B = (e) => ({ id: bi(e.key), title: d.formatMessage(xi(e.key)) })),
      (t[15] = d),
      (t[16] = B));
  let V = N.map(B),
    ee = Yt(f ?? []),
    H = L == null ? oi : (ee.get(L.headBranch.trim()) ?? oi),
    U;
    ...
    ? ((te = (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(gi, { repoOptions: i, selectedRepoKey: s, onSelect: u }),
          }),
        ],
      })),
      (t[18] = u),
  ...
  t[25] === ne
    ? (G = t[26])
    : ((G = (0, $.jsx)(re.Header, { children: ne })), (t[25] = ne), (t[26] = G));
  let K = Rt,
    ie;
  t[27] === d
    ? (ie = t[28])
  ...
  let J;
  t[29] !== l || t[30] !== n
    ? ((J = (0, $.jsx)(mi, { selectedFilterView: n, onSelectFilterView: l })),
      (t[29] = l),
      (t[30] = n),
      (t[31] = J))
    : (J = t[31]);
  let Y =
      k?.status === `error`
        ...
        : A
          ...
          : M.length === 0
            ? (0, $.jsx)(fi, { isAllReposSelected: C, selectedFilterView: n })
            : N.map((e) =>
                (0, $.jsx)(
                  hi,
                  {
                    ...
                    column: e,
                    mergeMethod: j ?? `merge`,
                    selectedPullRequestNumber: L?.number ?? a,
                    selectedPullRequestUrl: L?.url ?? o,
                    repo: r?.repo ?? null,
                    showRepo: C,
                    onSelectPullRequest: c,
                    onToggleSection: () => {
                      g((t) => ({ ...t, [e.key]: t[e.key] !== !0 }));
                    },
                  },
                  e.key,
                ),
    ...
    oe;
  return (
    t[32] !== K || t[33] !== V || t[34] !== ie || t[35] !== J || t[36] !== Y
      ? ((oe = (0, $.jsx)(K, {
          ariaLabel: ie,
    ...
    (0, $.jsxs)(`div`, {
      ...
      children: [
        (0, $.jsx)(ui, {
          hostId: L?.hostId ?? r?.hostId,
          item: L,
          relatedThreads: H,
          repo: L?.repo ?? r?.repo ?? null,
          onClose: W,
        }),
        G,
        oe,
...
function li(e) {
  return { cwd: E(e.cwd), hostId: e.hostId, repo: e.repo };
}
function ui(e) {
  let t = (0, Z.c)(10),
  ...
  return (
    t[4] !== n || t[5] !== r || t[6] !== s || t[7] !== i || t[8] !== a
      ? ((f = (0, $.jsx)(re.RightPanelOutlet, {
          children: (0, $.jsx)(Tr, { hostId: n, item: r, relatedThreads: i, repo: a, onClose: s }),
        })),
        (t[4] = n),
        (t[5] = r),
        (t[6] = s),
  ...
  return (
    e[4] !== n || e[5] !== r
      ? ((i = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(bt, { description: n, title: r }),
        })),
        (e[4] = n),
        (e[5] = r),
        (e[6] = i))
...
function fi(e) {
  let t = (0, Z.c)(9),
    ...
    a;
  t[0] !== i || t[1] !== n || t[2] !== r
    ? ((a = pi({ intl: i, isAllReposSelected: n, selectedFilterView: r })),
      (t[0] = i),
      (t[1] = n),
      (t[2] = r),
      (t[3] = a))
  ...
  return (
    t[6] !== a || t[7] !== o
      ? ((s = (0, $.jsx)(`div`, {
          className: `flex h-full min-h-full items-center justify-center`,
          children: (0, $.jsx)(bt, { description: a, title: o }),
        })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s))
...
function pi({ intl: e, isAllReposSelected: t, selectedFilterView: n }) {
  switch (t ? `all` : n) {
    case `all`:
...
function hi(e) {
  let t = (0, Z.c)(31),
    ...
    d;
  t[0] === r.key ? (d = t[1]) : ((d = bi(r.key)), (t[0] = r.key), (t[1] = d));
  let f = d,
    p = !n,
    m = `${f}-items`,
    h = n && `-rotate-90`,
  ...
  t[2] === h
    ? (g = t[3])
    : ((g = H(`icon-2xs shrink-0 transition-transform`, h)), (t[2] = h), (t[3] = g));
  let _;
  t[4] === g ? (_ = t[5]) : ((_ = (0, $.jsx)(Ke, { className: g })), (t[4] = g), (t[5] = _));
  let v;
  t[6] === r.key ? (v = t[7]) : ((v = yi(r.key)), (t[6] = r.key), (t[7] = v));
  let y;
  ...
  return (
    t[27] !== f || t[28] !== x || t[29] !== b
      ? ((S = (0, $.jsx)(Lt, { id: f, title: b, children: x })),
        (t[27] = f),
        (t[28] = x),
        (t[29] = b),
        (t[30] = S))
...
function gi(e) {
  ...
  t[3] !== a || t[4] !== o || t[5] !== c?.label
    ? ((l = o ? a.formatMessage(ii.allRepos) : c?.label),
      (t[3] = a),
      (t[4] = o),
      (t[5] = c?.label),
      (t[6] = l))
  ...
  let u = l,
    ...
    p;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(_e, { className: `icon-sm shrink-0` })), (t[7] = p))
    : (p = t[7]);
  let m;
  t[8] === u
    ? (m = t[9])
  ...
  t[10] === h
    ? (g = t[11])
    : ((g = H(`icon-2xs text-token-input-placeholder-foreground transition-transform`, h)),
      (t[10] = h),
      (t[11] = g));
  let _;
  t[12] === g ? (_ = t[13]) : ((_ = (0, $.jsx)(Ke, { className: g })), (t[12] = g), (t[13] = _));
  let v;
  ...
  let x;
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(F, { ...ii.allRepos })), (t[20] = x))
    : (x = t[20]);
  let S;
  t[21] !== b || t[22] !== y
    ? ((S = (0, $.jsx)(We.Item, { className: y, onClick: b, children: x })),
      (t[21] = b),
      (t[22] = y),
      (t[23] = S))
    : (S = t[23]);
  ...
  return (
    t[32] !== d || t[33] !== S || t[34] !== w || t[35] !== v
      ? ((T = (0, $.jsxs)(Ge, { onOpenChange: f, open: d, triggerButton: v, children: [S, C, w] })),
        (t[32] = d),
        (t[33] = S),
        (t[34] = w),
        (t[35] = v),
...
function _i(e) {
  let t = (0, Z.c)(63),
    { item: n, mergeMethod: r, onSelectPullRequest: i, repo: a, selected: s, showRepo: u } = e,
    d = o(c),
    p = P(),
    m = f(),
    h = Ft(),
  ...
  t[0] !== p || t[1] !== m || t[2] !== d
    ? ((_ = (e) => {
        e.status === `success` &&
          (m.invalidateQueries({ queryKey: g(`gh-pr-board`) }),
          d
            .get(le)
            .success(
              p.formatMessage({
  ...
  let y = nt(v),
    b;
  t[9] !== n || t[10] !== r || t[11] !== y || t[12] !== a || t[13] !== d
    ? ((b = async (e) => {
        (e.stopPropagation(), Vt(d, { action: `merge`, item: n, surface: `pull_request_page` }));
        let t = await y.mutateAsync({ cwd: n.cwd, mergeMethod: r, number: n.number, repo: a });
        t.status !== `success` && d.get(le).danger(t.error);
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = y),
  ...
  let x = b,
    S;
  t[15] !== x || t[16] !== n || t[17] !== y.isPending || t[18] !== h || t[19] !== a
    ? ((S = vi({
        isMergePending: y.isPending,
        pullRequestMergeHelperEnabled: h,
        item: n,
        repo: a,
        onMergePullRequest: x,
      })),
      (t[15] = x),
      (t[16] = n),
      (t[17] = y.isPending),
  ...
  let C = S,
    w;
  t[21] !== p || t[22] !== n || t[23] !== d
    ? ((w = {
        id: `copy-pull-request-url`,
        message: ai.copyUrl,
        onSelect: () => {
          (Vt(d, { action: `copy_url`, item: n, surface: `pull_request_page` }),
            Ae(n.url).then(
              () => {
                d.get(le).success(p.formatMessage(ai.copyUrlSuccess));
              },
              () => {
                d.get(le).danger(p.formatMessage(ai.copyUrlError));
              },
            ));
        },
      }),
  ...
  t[25] !== n || t[26] !== d
    ? ((T = {
        ...
        message: ai.openInBrowser,
        onSelect: () => {
          (Vt(d, { action: `open_in_browser`, item: n, surface: `pull_request_page` }),
            l.dispatchMessage(`open-in-browser`, { url: n.url }));
        },
      }),
      (t[25] = n),
      (t[26] = d),
    ...
    : (T = t[27]);
  let E;
  t[28] !== w || t[29] !== T ? ((E = [w, T]), (t[28] = w), (t[29] = T), (t[30] = E)) : (E = t[30]);
  let D = E,
    O;
  t[31] === n.state
    ? (O = t[32])
    : ((O = (0, $.jsx)($e, { className: `icon-sm shrink-0 translate-y-[2px]`, state: n.state })),
      (t[31] = n.state),
      (t[32] = O));
  let k;
  t[33] !== n || t[34] !== i || t[35] !== d
    ? ((k = () => {
        (Bt(d, { item: n, surface: `pull_request_page` }), i(n));
      }),
      (t[33] = n),
      (t[34] = i),
      (t[35] = d),
  ...
  t[37] !== n.additions || t[38] !== n.deletions
    ? ((A = (0, $.jsx)(yt, { linesAdded: n.additions, linesRemoved: n.deletions })),
      (t[37] = n.additions),
      (t[38] = n.deletions),
      (t[39] = A))
    : (A = t[39]);
  ...
  return (
    t[60] !== D || t[61] !== L
      ? ((R = (0, $.jsx)(Y, { items: D, children: L })), (t[60] = D), (t[61] = L), (t[62] = R))
      : (R = t[62]),
    R
  );
}
...
function xi(e) {
  switch (e) {
    ...
    case `ready`:
      return ri.ready;
    case `unmet_checks`:
      return ri.unmetChecks;
  }
}
var Si = W(`pull-request-board:last-selected-repo-key`, null);
function Ci() {
  let e = (0, Z.c)(39),
    t = P(),
    n = he(),
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = { params: void 0, source: `pull_requests_page` }), (e[6] = _))
    : (_ = e[6]);
  let { data: v, isLoading: b } = i(ue, _),
    x = Kt({ gitOrigins: v?.origins ?? [], workspaceGroups: h }),
    S = c ?? a,
