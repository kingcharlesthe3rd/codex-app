...
import { A as tn, O as nn, j as rn, k as an } from "./app-initial~app-main~automations-page.js";
import {
  a as on,
  o as sn,
...
import {
  n as jn,
  t as Mn,
} from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~pull-requests-page~new-~dacyny7u.js";
import { n as Nn, t as Pn } from "./segmented-toggle.js";
import { n as Fn, t as In } from "./selectable-list-row-Bca-1Z31.js";
...
function nr({ gitOrigins: e, workspaceGroups: t }) {
  let n = new Map(e.flatMap((e) => (e.originUrl == null ? [] : [[je(e.dir), e.originUrl]]))),
    r = new Map();
  for (let e of t) {
    let t = e.repositoryData?.ownerRepo;
    if (t == null || e.path == null) continue;
    let i = n.get(je(e.path));
    if (i == null) continue;
    let a = We(i);
    if (a == null) continue;
...
function gr(e) {
  ...
  if (t[0] !== n || t[1] !== a || t[2] !== r || t[3] !== i) {
    ...
    ((l = `max-w-[220px]`),
      ...
      t[8] === i
        ? (s = t[9])
        : ((s = (0, Cr.jsx)(Be.SectionLabel, { children: i })), (t[8] = i), (t[9] = s)),
      (c =
        e.length === 0
          ? (0, Cr.jsx)(Be.Message, { compact: !0, children: n })
          : (0, Cr.jsx)(`div`, {
    ...
    Ae,
    {
      ...
      children: (0, Cr.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, Cr.jsx)(`span`, { className: De(Tr, `text-token-foreground`), children: e.label }),
        ],
      }),
    },
    t,
...
function xr(e) {
  switch (e) {
    case `approved`:
      return (0, Cr.jsx)(U, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `requested`:
      return (0, Cr.jsx)(pt, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `commented`:
      return (0, Cr.jsx)(bt, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `changes-requested`:
      return (0, Cr.jsx)(Ye, { className: `icon-sm shrink-0 text-token-charts-red` });
  }
}
var Sr,
  Cr,
...
function kr(e) {
  ...
  t[28] !== k
    ? ((fe = () => {
        ...
        te.current ? i && jr([V, ie, ae], B) : (jr([V, ie, ae], B), (te.current = !0));
        let a = () => {
          ((ne.current = t), (re.current = D));
        };
        if (x > 0 && T && t <= x && !W) {
          (Wr({ containerWidth: t, minRightWidth: y, isOpen: E, node: e, rafRef: z }), a());
          return;
        }
        let o = Pr(t);
        if (!T) {
  ...
  t[44] !== O ||
  t[45] !== k
    ? ((pe = [P, D, E, K, x, W, T, G, S, C, I, v, y, w, O, k]),
      (t[30] = P),
      (t[31] = x),
      (t[32] = K),
      (t[33] = D),
  ...
  t[87] !== _
    ? ((ve = (e) => {
        ...
        if (!t || !n) return;
        if (G) {
          Wr({ containerWidth: n, minRightWidth: y, isOpen: !1, node: t, rafRef: z });
          return;
        }
        let r = Pr(n),
  ...
  t[101] !== k
    ? ((be = (e) => {
        ...
        if (C || !T) return;
        if ((Mr([V, ie, ae], B), _?.(!0), G)) {
          Wr({ containerWidth: n, minRightWidth: y, isOpen: !0, node: t, rafRef: z });
          return;
        }
        let {
          boundedLeftWidth: r,
  ...
  let xe = be,
    Se;
  t[103] !== ye || t[104] !== xe || t[105] !== S || t[106] !== C
    ? ((Se = (e) => {
        if (e === `left`) {
          if (S) {
            ye(`left`);
  ...
  let Ce = Se,
    we;
  t[108] !== ye || t[109] !== D || t[110] !== E || t[111] !== xe || t[112] !== I || t[113] !== Ce
    ? ((we = {
        isLeftOpen: D,
        isRightOpen: E,
        isResizing: I,
  ...
  let Te = we,
    ...
    ke = I && `cursor-col-resize`,
    Ae;
  t[115] !== a || t[116] !== ke
    ? ((Ae = De(`group/split-view relative h-full w-full min-w-0 overflow-hidden`, ke, a)),
      (t[115] = a),
      (t[116] = ke),
      (t[117] = Ae))
    : (Ae = t[117]);
  ...
  t[127] !== Me || t[128] !== Pe || t[129] !== Le
    ? ((Re = (0, Jr.jsx)(`div`, { ref: V, className: Me, style: Pe, children: Le })),
      (t[127] = Me),
      (t[128] = Pe),
      (t[129] = Le),
      (t[130] = Re))
        ...
        T && !G && D
          ? (0, Jr.jsx)(`div`, {
              ...
              className: De(
                ...
                Ee ? `opacity-100` : `opacity-0 pointer-events-none`,
                c,
              ),
              style: {
                width: `${b}px`,
  ...
  t[141] !== s || t[142] !== Be || t[143] !== Ve || t[144] !== He
    ? ((Ue = De(
      ...
      (t[145] = Ue))
    : (Ue = t[145]);
  let We = I ? `none` : `width, transform, opacity`,
    Ge;
  t[146] === We
    ? (Ge = t[147])
    : ((Ge = {
  ...
  t[157] !== Ae || t[158] !== Re || t[159] !== ze || t[160] !== qe
    ? ((Je = (0, Jr.jsxs)(`div`, { ref: R, className: Ae, children: [Re, ze, qe] })),
      (t[157] = Ae),
      (t[158] = Re),
      (t[159] = ze),
      (t[160] = qe),
  ...
  return (
    t[162] !== Te || t[163] !== Je
      ? ((Ye = (0, Jr.jsx)(ni.Provider, { value: Te, children: Je })),
        (t[162] = Te),
        (t[163] = Je),
        (t[164] = Ye))
      : (Ye = t[164]),
...
var ai,
  ...
  li = e(() => {
    (c(),
      T(),
      r(),
      (ci = j(d, `gh-current-user`, (e) => ({ params: { hostId: e }, staleTime: v.ONE_MINUTE }))));
  });
function ui(e) {
  let t = (0, mi.c)(50),
  ...
  t[33] === C
    ? (w = t[34])
    : ((w = (0, Y.jsx)(jt, { diffControls: C, showHideWhitespace: !1, showLoadFullFiles: !1 })),
      (t[33] = C),
      (t[34] = w));
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, Y.jsx)(Mn, { className: `icon-xs` })), (t[38] = O))
    : (O = t[38]);
  let k;
  t[39] !== h || t[40] !== n || t[41] !== T || t[42] !== D
    ? ((k = (0, Y.jsx)(be, {
        "aria-label": h,
        "aria-pressed": n,
        color: T,
  ...
  let A;
  t[44] !== h || t[45] !== k
    ? ((A = (0, Y.jsx)(Ae, { tooltipContent: h, delayOpen: !0, children: k })),
      (t[44] = h),
      (t[45] = k),
      (t[46] = A))
    : (A = t[46]);
  ...
  return (
    t[47] !== A || t[48] !== w
      ? ((j = (0, Y.jsxs)(`div`, { className: `flex items-center gap-px`, children: [w, A] })),
        (t[47] = A),
        (t[48] = w),
        (t[49] = j))
      : (j = t[49]),
...
function fi({
  ...
  let l = ne(d),
    ...
    [_, y] = (0, hi.useState)(),
    [b, x] = (0, hi.useState)({}),
    [S, C] = (0, hi.useState)(null),
    [w, T] = (0, hi.useState)(``),
    D = (0, hi.useRef)(new Map()),
    [k, A] = (0, hi.useState)(() => new Set()),
    { data: j } = V(ci, t),
    M = (0, hi.useCallback)((e, t) => {
      let n = xe(e);
      A((e) => {
    ...
    N = (0, hi.useCallback)(
      (e) => {
        let t = kt(e),
          n = D.current.get(t);
        (D.current.delete(t), n != null && M(n, !1));
      },
      [M],
    ),
    P = (0, hi.useCallback)((e) => {
      let t = xe(e),
        n = e.position.path;
      x((e) => ({ ...e, [n]: (e[n] ?? []).filter((e) => xe(e) !== t) }));
    }, []),
    F = O(`gh-pr-comment`, {
    ...
    { data: I, isLoading: L } = Se(`gh-pr-diff`, {
      source: `pull_request_board`,
      params: { cwd: e, hostId: t, number: r, repo: o ?? null },
      queryConfig: { refetchOnWindowFocus: !0, staleTime: v.FIVE_SECONDS },
    }),
    [R] = (0, hi.useState)(() => new Yt()),
    z = (0, hi.useCallback)(
      (e) => {
        if (e != null) {
          R.setup(e);
    ...
    ee = I?.status === `success` ? Kt(I.unifiedDiff) : [],
    te = ee.map((e) => e.metadata.name),
    re = j?.status === `success` ? j.avatarUrl : void 0,
    ie =
      j?.status === `success`
        ? j.login
        : p.formatMessage({
    ...
    ae = w.trim().length === 0 ? te : te.filter((e) => e.includes(w.trim())),
    U = (0, hi.useMemo)(
      () =>
        a == null || a.length === 0 ? void 0 : $t({ comments: a, filePaths: te, workspaceRoot: e }),
      [e, te, a],
    );
  function oe(e) {
    (y(e), g.current.get(e)?.scrollIntoView({ block: `start` }));
  }
  let W = (0, hi.useCallback)(
      (n) => {
        let i = {
          body: Xt(n),
          cwd: e,
        ...
        (D.current.set(kt(i), n), M(n, !0), F.mutate(i));
      },
      [e, t, r, F, o, M],
    ),
    G = (0, hi.useCallback)(
      (e, t) => {
        let n = Mt({ currentComments: b[e] ?? [], nextComments: t });
        (C(null), x((n) => ({ ...n, [e]: t })));
        for (let e of n) W(e);
      },
      [b, W],
                ...
                left: (0, Y.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, Y.jsx)(`div`, {
                      ...
                      children: (0, Y.jsx)(Et, {
                        activePath: _,
                        commentCountByPath: U,
                        cwd: e,
                        onSelectPath: oe,
                        entries: ae.map((e) => ({ displayPath: e, path: e })),
                      }),
                    }),
                  ],
                }),
...
function Si(e) {
  let t = (0, Oi.c)(36),
    {
      ...
      replyToReviewThreadId: c,
      repo: l,
      surface: u,
    } = e,
    f = n === void 0 ? !1 : n,
    p = u === void 0 ? `pull_request_page` : u,
    m = ne(d),
    h = E(),
    [g, _] = (0, ki.useState)(``),
  ...
  t[12] !== T
    ? ((k = async (e) => {
        ...
        (tr(m, { kind: D ? `reply` : `comment`, surface: p }), _(``), await o().catch(Ci));
      }),
      (t[3] = r),
      (t[4] = D),
      (t[5] = i),
  ...
  let A = k,
    ...
    M;
  t[14] !== h || t[15] !== j
    ? ((M = Di({ intl: h, user: j })), (t[14] = h), (t[15] = j), (t[16] = M))
    : (M = t[16]);
  let N = M,
    P = D && `w-full`,
    F;
  t[17] === P ? (F = t[18]) : ((F = De(`flex flex-col gap-2`, P)), (t[17] = P), (t[18] = F));
  let I;
  ...
  t[29] === v
    ...
    : ((z =
        v == null
          ? null
          : (0, Ai.jsx)(`div`, { className: `px-1 text-sm text-token-charts-red`, children: v })),
      (t[29] = v),
      (t[30] = z));
  let B;
  return (
    t[31] !== A || t[32] !== R || t[33] !== z || t[34] !== F
      ? ((B = (0, Ai.jsxs)(`form`, { className: F, onSubmit: A, children: [R, z] })),
        (t[31] = A),
        (t[32] = R),
        (t[33] = z),
        (t[34] = F),
...
function Ti(e) {
  ...
  t[10] === y
    ? (b = t[11])
    : ((b = De(`flex min-w-0 items-center gap-2`, y)), (t[10] = y), (t[11] = b));
  let x;
  t[12] === c
    ? (x = t[13])
    : ((x = (e) => {
      ...
      (t[13] = x));
  let S;
  t[14] !== r || t[15] !== i || t[16] !== g || t[17] !== a || t[18] !== v || t[19] !== x
    ? ((S = (0, Ai.jsx)(`textarea`, {
        "aria-label": g,
        autoFocus: r,
        ...
        l == null
          ...
          : (0, Ai.jsx)(Ae, {
              ...
              children: (0, Ai.jsx)(be, {
                ...
                uniform: !0,
                onClick: l,
                children: (0, Ai.jsx)(o, { className: `icon-xs` }),
              }),
            })),
      (t[21] = f),
      (t[22] = l),
  ...
  t[24] === a
    ? (w = t[25])
    : ((w = a ? null : (0, Ai.jsx)(te, { className: `icon-xs` })), (t[24] = a), (t[25] = w));
  let T;
  t[26] !== a || t[27] !== d || t[28] !== m || t[29] !== w
    ? ((T = (0, Ai.jsx)(be, {
        "aria-label": m,
        color: `primary`,
        disabled: d,
  ...
  let D;
  t[31] !== m || t[32] !== T
    ? ((D = (0, Ai.jsx)(Ae, { delayDuration: 250, tooltipContent: m, children: T })),
      (t[31] = m),
      (t[32] = T),
      (t[33] = D))
    : (D = t[33]);
  let O;
  return (
    t[34] !== n || t[35] !== D || t[36] !== b || t[37] !== S || t[38] !== C
      ? ((O = (0, Ai.jsxs)(`div`, { className: b, children: [n, S, C, D] })),
        (t[34] = n),
        (t[35] = D),
        (t[36] = b),
        (t[37] = S),
...
function Mi(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Pi.jsx)(xt, { className: `icon-sm shrink-0`, state: r })), (t[0] = r), (t[1] = i));
  let a;
  t[2] === n.title
    ? (a = t[3])
    : ((a = (0, Pi.jsx)(`div`, {
...
function Ii(e) {
  let t = (0, Vi.c)(24),
    { item: n } = e,
    r = S(rn, n.url),
    i = H(r.conversationId$),
    o = H(r.pendingWorktreeId$),
    s = H(r.ciJobsFixed$),
    c = H(r.mergeConflictsResolved$),
    l = H(Zt),
    u = l.data,
    d,
    p,
    m;
  if (t[0] !== u?.items || t[1] !== i || t[2] !== o) {
    let e = Tn({ automations: u?.items ?? [], conversationId: i, includePausedAutomations: !0 });
    d = i == null && o != null;
    let n;
    (t[6] !== i || t[7] !== o
      ? ((n = Jn({ conversationId: i, pendingWorktreeId: o })), (t[6] = i), (t[7] = o), (t[8] = n))
      : (n = t[8]),
      (m = n),
      (p = Li({ automationStatus: e?.status, isTaskStarting: d })),
      (t[0] = u?.items),
      (t[1] = i),
      (t[2] = o),
      (t[3] = d),
      (t[4] = p),
      (t[5] = m));
  } else ((d = t[3]), (p = t[4]), (m = t[5]));
  let h = p;
  if ((i == null && o == null) || (!d && l.isLoading) || h == null) return null;
  let g;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, X.jsx)(Be.SectionLabel, {
        children: (0, X.jsx)(f, {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, X.jsx)(a, { className: `icon-xs shrink-0` })), (t[10] = _))
    : (_ = t[10]);
  let v;
  t[11] === h
    ? (v = t[12])
    : ((v = (0, X.jsxs)(`span`, {
        ...
        children: [
          _,
          (0, X.jsx)(`span`, { className: `truncate`, children: (0, X.jsx)(Ri, { status: h }) }),
        ],
      })),
      (t[11] = h),
      (t[12] = v));
  let y;
  t[13] !== s || t[14] !== c
    ? ((y = (0, X.jsx)(Bi, { ciJobsFixed: s, mergeConflictsResolved: c })),
      (t[13] = s),
      (t[14] = c),
      (t[15] = y))
    : (y = t[15]);
  let b;
  t[16] !== v || t[17] !== y
    ? ((b = (0, X.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [v, y] })),
      (t[16] = v),
      (t[17] = y),
      (t[18] = b))
    : (b = t[18]);
  let x;
  t[19] === m ? (x = t[20]) : ((x = (0, X.jsx)(zi, { taskRoute: m })), (t[19] = m), (t[20] = x));
  let C;
  return (
    t[21] !== b || t[22] !== x
      ? ((C = (0, X.jsxs)(`div`, {
...
function Bi(e) {
  ...
  let s;
  t[4] !== i || t[5] !== a
    ? ((s = i && a ? (0, X.jsx)(on, { className: `shrink-0` }) : null),
      (t[4] = i),
      (t[5] = a),
      (t[6] = s))
    : (s = t[6]);
...
var Vi,
  X,
  Hi = e(() => {
    ((Vi = q()), g(), k(), u(), At(), Dn(), sn(), G(), Oe(), z(), tn(), $n(), (X = Re()));
  });
function Ui(e) {
  let t = (0, Z.c)(104),
    {
    ...
    p = ne(B),
    m = E(),
    [h, g] = (0, xa.useState)(`pull-request`),
    _ = u ? h : `pull-request`,
    [y, b] = (0, xa.useState)(!1),
    x;
  t[0] !== n || t[1] !== r || t[2] !== s
    ? ((x = la({ hostId: n, item: r, repo: s })), (t[0] = n), (t[1] = r), (t[2] = s), (t[3] = x))
    : (x = t[3]);
  let S = x,
    C = _ === `code-review`,
    w;
  t[4] === C
    ? (w = t[5])
    : ((w = { enabled: C, intervalMs: v.ONE_MINUTE, staleTime: v.ONE_MINUTE }),
      (t[4] = C),
      (t[5] = w));
  let T;
  t[6] !== S || t[7] !== w
    ? ((T = { source: `pull_request_board`, params: S, queryConfig: w }),
      ...
      (t[8] = T))
    : (T = t[8]);
  let { data: D, refetch: O } = Se(`gh-pr-comments`, T),
    k;
  t[9] === D
    ? (k = t[10])
    : ((k = D?.status === `success` ? D.commentAttachments : []), (t[9] = D), (t[10] = k));
  let A = k,
    j;
  t[11] !== m || t[12] !== r || t[13] !== p || t[14] !== d
    ? ((j = function (e) {
        (er(p, { action: `copy_url`, item: r, surface: d }),
          Dr({ scope: p, event: e, intl: m, url: r.url }));
      }),
      (t[11] = m),
      (t[12] = r),
      (t[13] = p),
  ...
  let M = j,
    N;
  t[16] !== M || t[17] !== p.value.pathname
    ? ((N = () => {
        p.value.pathname === `/pull-requests` && M();
      }),
      (t[16] = M),
  ...
  t[23] !== p ||
  t[24] !== d
    ? ((P = [m, r.isAuthor, r.state, r.url, p, d]),
      (t[19] = m),
      (t[20] = r.isAuthor),
      (t[21] = r.state),
      (t[22] = r.url),
      ...
      (t[25] = P))
    : (P = t[25]),
    R(`copy-working-directory`, N, P));
  let F;
  t[26] === r
    ? (F = t[27])
    : ((F = (0, Q.jsx)(Mi, { item: r, state: r.state })), (t[26] = r), (t[27] = F));
  let I;
  t[28] === r.headBranch
    ? (I = t[29])
    : ((I = (0, Q.jsx)(`span`, { className: `truncate`, children: r.headBranch })),
      (t[28] = r.headBranch),
      (t[29] = I));
  let L;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = (0, Q.jsx)(`span`, { className: `shrink-0`, children: `->` })), (t[30] = L))
    : (L = t[30]);
  let z;
  t[31] === r.baseBranch
    ? (z = t[32])
    : ((z = (0, Q.jsx)(`span`, { className: `truncate`, children: r.baseBranch })),
      (t[31] = r.baseBranch),
      (t[32] = z));
  let ee;
  t[33] !== I || t[34] !== z
  ...
  let te;
  t[36] !== F || t[37] !== ee
    ? ((te = (0, Q.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [F, ee] })),
      (t[36] = F),
      (t[37] = ee),
      (t[38] = te))
    : (te = t[38]);
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ie = (0, Q.jsx)(Ht, { className: `icon-xs` })), (t[43] = ie))
    : (ie = t[43]);
  let ae;
  t[44] !== M || t[45] !== V
    ? ((ae = (0, Q.jsx)(be, {
  ...
  let H;
  t[47] !== re || t[48] !== ae
    ? ((H = (0, Q.jsx)(Ae, { tooltipContent: re, children: ae })),
      (t[47] = re),
      (t[48] = ae),
      (t[49] = H))
    : (H = t[49]);
  ...
  t[52] === m
    ...
    : ((W = m.formatMessage({
      ...
      (t[53] = W));
  let G;
  t[54] !== r || t[55] !== p || t[56] !== d
    ? ((G = (e) => {
        (er(p, { action: `open_in_browser`, item: r, surface: d }),
          oe({ event: e, href: r.url, initiator: `pull_request_link` }));
      }),
      (t[54] = r),
      (t[55] = p),
      (t[56] = d),
  ...
  t[58] === r.url
    ? (K = t[59])
    : ((K = (0, Q.jsx)(Te, { href: r.url, className: `icon-xs` })), (t[58] = r.url), (t[59] = K));
  let se;
  t[60] !== W || t[61] !== G || t[62] !== K
    ? ((se = (0, Q.jsx)(be, {
        "aria-label": W,
        color: `ghost`,
        size: `toolbar`,
  ...
  let ce;
  t[64] !== U || t[65] !== se
    ? ((ce = (0, Q.jsx)(Ae, { tooltipContent: U, children: se })),
      (t[64] = U),
      (t[65] = se),
      (t[66] = ce))
    : (ce = t[66]);
  ...
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ue = (0, Q.jsx)(o, { className: `icon-xs` })), (t[69] = ue))
    : (ue = t[69]);
  let q;
  t[70] !== i || t[71] !== le
    ? ((q = (0, Q.jsx)(be, {
    ...
    ? ((pe = u
        ? (0, Q.jsxs)(`div`, {
            ...
            children: [
              ...
              _ === `code-review`
                ? (0, Q.jsx)(ui, { isFileTreeOpen: y, onFileTreeOpenChange: b })
                : null,
            ],
          })
        : null),
...
function qi(e) {
  ...
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = Se(`gh-pr-body`, i),
...
function Ji(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = Se(`gh-pr-comments`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(f, {
  ...
  t[13] === a.reviewers
    ? (m = t[14])
    : ((m = (0, Q.jsx)(gr, { emptyMessage: d, reviewers: a.reviewers, title: p })),
      (t[13] = a.reviewers),
      (t[14] = m));
  let h;
  return (
...
function Yi(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = Se(`gh-pr-checks`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(f, {
...
function Xi(e) {
  ...
  let o;
  t[0] !== n || t[1] !== r
    ? ((o = On({ checks: n, ciStatus: r })), (t[0] = n), (t[1] = r), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === r ? (s = t[4]) : ((s = En(r)), (t[3] = r), (t[4] = s));
  let c = i ? 180 : 0,
    l;
  t[5] === c ? (l = t[6]) : ((l = { rotate: c }), (t[5] = c), (t[6] = l));
  let u;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Q.jsx)(me, { className: `icon-2xs` })), (t[7] = u))
    : (u = t[7]);
  let d;
  t[8] === l
    ? (d = t[9])
  ...
  t[11] !== i || t[12] !== o || t[13] !== s || t[14] !== d
    ? ((p = (0, Q.jsx)(st, { ariaExpanded: i, icon: o, label: s, trailing: d, onClick: f })),
      (t[11] = i),
      (t[12] = o),
      (t[13] = s),
      (t[14] = d),
  ...
  t[19] === m
    ? (h = t[20])
    : ((h = (0, Q.jsx)(Ie, { initial: !1, children: m })), (t[19] = m), (t[20] = h));
  let g;
  return (
    t[21] !== h || t[22] !== p
...
function Qi(e) {
  ...
  let {
    ...
    h = d && c != null,
    g;
  t[3] === h ? (g = t[4]) : ((g = (0, Q.jsx)(ga, { isFetching: h })), (t[3] = h), (t[4] = g));
  let _ = g;
  if (u) {
    let e;
  ...
  if (c.activityItems.length === 0) {
    ...
    t[11] === _
      ? (e = t[12])
      : ((e = (0, Q.jsx)(Be.SectionLabel, { children: _ })), (t[11] = _), (t[12] = e));
    let n;
    t[13] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, Q.jsx)(Be.Message, {
          compact: !0,
          children: (0, Q.jsx)(f, {
  ...
  t[16] === _
    ? (y = t[17])
    : ((y = (0, Q.jsx)(Be.SectionLabel, { children: _ })), (t[16] = _), (t[17] = y));
  let b;
  if (
    ...
    let e;
    (t[25] !== c.repo || t[26] !== n || t[27] !== r || t[28] !== m || t[29] !== a
      ? ((e = (e) =>
          (0, Q.jsx)(
            ta,
            {
  ...
  t[31] === b
    ? (x = t[32])
    : ((x = (0, Q.jsx)(`div`, { className: `flex flex-col gap-3`, children: b })),
      (t[31] = b),
      (t[32] = x));
  let S;
  return (
    t[33] !== y || t[34] !== x
      ? ((S = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [y, x] })),
        (t[33] = y),
        (t[34] = x),
        (t[35] = S))
      : (S = t[35]),
...
function $i(e) {
  ...
  t[0] !== o || t[1] !== i
    ? ((l = async () => {
        await o.invalidateQueries({ queryKey: s(`gh-pr-comments`, i) });
      }),
      (t[0] = o),
      (t[1] = i),
      (t[2] = l))
  ...
  let u;
  return (
    t[3] !== n || t[4] !== r || t[5] !== a || t[6] !== c || t[7] !== l
      ? ((u = (0, Q.jsx)(Si, { hostId: n, item: r, repo: c, surface: a, onCommentPosted: l })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = a),
        (t[6] = c),
...
function ea(e) {
  ...
  t[1] === i
    ? (s = t[2])
    : ((s = { source: `pull_request_board`, params: i, queryConfig: o }), (t[1] = i), (t[2] = s));
  let { data: c, error: l, isError: u, isFetching: d, isLoading: p } = Se(`gh-pr-body`, s);
  ...
  t[11] !== n || t[12] !== r || t[13] !== i || t[14] !== a || t[15] !== h || t[16] !== g
    ? ((_ = (0, Q.jsx)(Vn, { hostId: n, item: r, pullRequestBody: g, request: i, surface: a }, h)),
      (t[11] = n),
      (t[12] = r),
      (t[13] = i),
      (t[14] = a),
  ...
  return (
    t[18] !== m || t[19] !== _
      ? ((y = (0, Q.jsxs)(`div`, { className: `relative flex flex-col gap-2`, children: [m, _] })),
        (t[18] = m),
        (t[19] = _),
        (t[20] = y))
      : (y = t[20]),
...
function ra(e) {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (d = t[13]);
  let p;
  t[14] === n.createdAt ? (p = t[15]) : ((p = hn(n.createdAt)), (t[14] = n.createdAt), (t[15] = p));
  let m;
  t[16] === n.createdAt
    ? (m = t[17])
    : ((m = (0, Q.jsx)(`span`, {
        className: `inline`,
        children: (0, Q.jsx)(_n, { dateString: n.createdAt }),
      })),
      (t[16] = n.createdAt),
      (t[17] = m));
  let h;
  ...
  t[19] === m
    ? (g = t[20])
    : ((g = (0, Q.jsxs)(`span`, { className: `shrink-0`, children: [m, h] })),
      (t[19] = m),
      (t[20] = g));
  let _;
  t[21] !== g || t[22] !== p
    ? ((_ = (0, Q.jsx)(Ae, { delayDuration: 250, tooltipContent: p, children: g })),
      (t[21] = g),
      (t[22] = p),
      (t[23] = _))
    : (_ = t[23]);
  ...
  let y;
  return (
    t[27] !== v || t[28] !== c || t[29] !== l
      ? ((y = (0, Q.jsxs)(`div`, { className: c, children: [l, v] })),
        (t[27] = v),
        (t[28] = c),
        (t[29] = l),
        (t[30] = y))
...
function sa(e) {
  switch (e) {
    ...
    case `changes_requested`:
      return { Icon: o, iconClassName: `text-token-charts-red` };
    case `merged`:
      return { Icon: ut, iconClassName: `text-token-charts-purple` };
    case `opened`:
...
function da() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, Q.jsx)(Be.SectionLabel, { children: (0, Q.jsx)(ha, {}) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(st, {
            icon: (0, Q.jsx)(Me, { className: `icon-sm shrink-0 text-token-text-tertiary` }),
            label: (0, Q.jsx)(f, {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsxs)(`div`, {
          ...
          children: [
            (0, Q.jsx)(Be.SectionLabel, { children: (0, Q.jsx)(ga, {}) }),
            (0, Q.jsx)(ma, {}),
          ],
        })),
        (e[0] = t))
...
function ga(e) {
  ...
  t[1] === r
    ? (a = t[2])
    : ((a = r ? (0, Q.jsx)(Me, { className: `icon-xxs text-token-description-foreground` }) : null),
      (t[1] = r),
      (t[2] = a));
  let o;
  return (
...
function va(e) {
  let t = (0, Z.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(Me, { className: `icon-xxs` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function ba(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Q.jsx)(Be.SectionLabel, { className: `px-0 py-0`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function Ca(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { merged: !0 }), (t[0] = h))
    : (h = t[0]);
  let [g, _] = (0, za.useState)(h),
    [y, b] = (0, za.useState)(null),
    x;
  t[1] === n
    ? (x = t[2])
    : ((x = cr({ searchQuery: or(n), selectedFilterView: n })), (t[1] = n), (t[2] = x));
  let S = x,
    C = s === `all`,
    T;
  t[3] !== S ||
  ...
  t[8] !== i
    ? ((T = C
        ? { repos: i.map(Ta), searchQuery: S }
        : { cwd: w(r?.cwd ?? `/`), hostId: r?.hostId, repo: r?.repo ?? null, searchQuery: S }),
      (t[3] = S),
      (t[4] = C),
      (t[5] = r?.cwd),
      (t[6] = r?.hostId),
      ...
      (t[9] = T))
    : (T = t[9]);
  let D = C ? i.length > 0 : r != null,
    O;
  t[10] === D
    ? (O = t[11])
    : ((O = { enabled: D, intervalMs: v.THIRTY_SECONDS, staleTime: v.THIRTY_SECONDS }),
      (t[10] = D),
      (t[11] = O));
  let k;
  t[12] !== T || t[13] !== O
    ? ((k = { source: `pull_request_board`, params: T, queryConfig: O }),
      (t[12] = T),
      (t[13] = O),
      (t[14] = k))
    : (k = t[14]);
  let { data: A, isLoading: j } = Se(`gh-pr-board`, k),
    M = F(pe.pullRequestMergeMethod),
    N = A?.status === `success` ? A.items : [],
    P = ir(N),
    I = P.find(wa)?.items[0] ?? null,
    L = lr({ items: N, selectedPullRequestNumber: a, selectedPullRequestUrl: o }),
    R = `${s ?? ``}:${n}:${S ?? ``}`,
    z = a != null || o != null;
  (0, za.useEffect)(() => {
    I == null || z || y === R || (b(R), c(I, { replace: !0 }));
  }, [R, y, I, z, c]);
  let B;
  t[15] === d
    ? (B = t[16])
    : ((B = (e) => ({ id: Ia(e.key), title: d.formatMessage(La(e.key)) })),
      (t[15] = d),
      (t[16] = B));
  let ee = P.map(B),
    te = ar(m ?? []),
    ne = L == null ? Ua : (te.get(L.headBranch.trim()) ?? Ua),
    re;
  ...
  t[25] === ie
    ? (H = t[26])
    : ((H = (0, $.jsx)(Cn.Header, { children: ie })), (t[25] = ie), (t[26] = H));
  let U = zn,
    oe;
  t[27] === d
    ? (oe = t[28])
  ...
  let W;
  t[29] !== l || t[30] !== n
    ? ((W = (0, $.jsx)(Aa, { selectedFilterView: n, onSelectFilterView: l })),
      (t[29] = l),
      (t[30] = n),
      (t[31] = W))
    : (W = t[31]);
  let G =
      A?.status === `error`
        ...
        : j
          ...
          : N.length === 0
            ? (0, $.jsx)(Oa, { isAllReposSelected: C, selectedFilterView: n })
            : P.map((e) =>
                (0, $.jsx)(
                  ja,
                  {
    ...
    K;
  return (
    t[32] !== U || t[33] !== ee || t[34] !== oe || t[35] !== W || t[36] !== G
      ? ((K = (0, $.jsx)(U, {
          ariaLabel: oe,
...
function Ta(e) {
  return { cwd: w(e.cwd), hostId: e.hostId, repo: e.repo };
}
function Ea(e) {
  let t = (0, Ra.c)(10),
  ...
  return (
    e[4] !== n || e[5] !== r
      ? ((i = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(Ct, { description: n, title: r }),
        })),
        (e[4] = n),
        (e[5] = r),
        (e[6] = i))
...
function Oa(e) {
  ...
  return (
    t[6] !== a || t[7] !== o
      ? ((s = (0, $.jsx)(`div`, {
          className: `flex h-full min-h-full items-center justify-center`,
          children: (0, $.jsx)(Ct, { description: a, title: o }),
        })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s))
...
function ja(e) {
  ...
  t[2] === h
    ? (g = t[3])
    : ((g = De(`icon-2xs shrink-0 transition-transform`, h)), (t[2] = h), (t[3] = g));
  let _;
  t[4] === g ? (_ = t[5]) : ((_ = (0, $.jsx)(me, { className: g })), (t[4] = g), (t[5] = _));
  let v;
...
function Ma(e) {
  ...
  let u = l,
    ...
    m;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(Qe, { className: `icon-sm shrink-0` })), (t[7] = m))
    : (m = t[7]);
  let h;
  t[8] === u
    ? (h = t[9])
    : ((h = (0, $.jsx)(`span`, { className: `max-w-[220px] truncate`, children: u })),
      (t[8] = u),
      (t[9] = h));
  let g = d && `rotate-180`,
    _;
  t[10] === g
    ? (_ = t[11])
    : ((_ = De(`icon-2xs text-token-input-placeholder-foreground transition-transform`, g)),
      (t[10] = g),
      (t[11] = _));
  let v;
  t[12] === _ ? (v = t[13]) : ((v = (0, $.jsx)(me, { className: _ })), (t[12] = _), (t[13] = v));
  let y;
  t[14] !== d || t[15] !== h || t[16] !== v
    ? ((y = (0, $.jsxs)(be, {
        color: `outline`,
        size: `toolbar`,
        "aria-expanded": d,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(f, { ...Va.allRepos })), (t[20] = S))
    : (S = t[20]);
  let C;
  t[21] !== x || t[22] !== b
    ? ((C = (0, $.jsx)(Be.Item, { className: b, onClick: x, children: S })),
      (t[21] = x),
      (t[22] = b),
      (t[23] = C))
    : (C = t[23]);
  ...
  let D;
  return (
    t[32] !== d || t[33] !== C || t[34] !== T || t[35] !== y
      ? ((D = (0, $.jsxs)(de, { onOpenChange: p, open: d, triggerButton: y, children: [C, w, T] })),
        (t[32] = d),
        (t[33] = C),
        (t[34] = T),
        (t[35] = y),
...
function Na(e) {
  let t = (0, Ra.c)(63),
    { item: n, mergeMethod: r, onSelectPullRequest: i, repo: a, selected: o, showRepo: c } = e,
    l = ne(d),
    u = E(),
    p = fe(),
    m = an(),
  ...
  t[0] !== u || t[1] !== p || t[2] !== l
    ? ((h = (e) => {
        e.status === `success` &&
          (p.invalidateQueries({ queryKey: s(`gh-pr-board`) }),
          l
            .get(Le)
            .success(
              u.formatMessage({
  ...
  let _ = Kn(g),
    v;
  t[9] !== n || t[10] !== r || t[11] !== _ || t[12] !== a || t[13] !== l
    ? ((v = async (e) => {
        (e.stopPropagation(), er(l, { action: `merge`, item: n, surface: `pull_request_page` }));
        let t = await _.mutateAsync({ cwd: n.cwd, mergeMethod: r, number: n.number, repo: a });
        t.status !== `success` && l.get(Le).danger(t.error);
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = _),
  ...
  let y = v,
    b;
  t[15] !== y || t[16] !== n || t[17] !== _.isPending || t[18] !== m || t[19] !== a
    ? ((b = Pa({
        isMergePending: _.isPending,
        pullRequestMergeHelperEnabled: m,
        item: n,
        repo: a,
        onMergePullRequest: y,
      })),
      (t[15] = y),
      (t[16] = n),
      (t[17] = _.isPending),
  ...
  let x = b,
    S;
  t[21] !== u || t[22] !== n || t[23] !== l
    ? ((S = {
        id: `copy-pull-request-url`,
        message: Ha.copyUrl,
        onSelect: () => {
          (er(l, { action: `copy_url`, item: n, surface: `pull_request_page` }),
            P(n.url).then(
              () => {
                l.get(Le).success(u.formatMessage(Ha.copyUrlSuccess));
              },
              () => {
                l.get(Le).danger(u.formatMessage(Ha.copyUrlError));
              },
            ));
        },
      }),
  ...
  t[25] !== n || t[26] !== l
    ? ((C = {
        ...
        onSelect: () => {
          (er(l, { action: `open_in_browser`, item: n, surface: `pull_request_page` }),
            Ke({ href: n.url, initiator: `pull_request_link` }));
        },
      }),
      (t[25] = n),
      (t[26] = l),
    ...
    : (C = t[27]);
  let w;
  t[28] !== S || t[29] !== C ? ((w = [S, C]), (t[28] = S), (t[29] = C), (t[30] = w)) : (w = t[30]);
  let T = w,
    D;
  t[31] === n.state
    ? (D = t[32])
    : ((D = (0, $.jsx)(xt, { className: `icon-sm shrink-0 translate-y-[2px]`, state: n.state })),
      (t[31] = n.state),
      (t[32] = D));
  let O;
  t[33] !== n || t[34] !== i || t[35] !== l
    ? ((O = () => {
        (Hn(l, { item: n, surface: `pull_request_page` }), i(n));
      }),
      (t[33] = n),
      (t[34] = i),
      (t[35] = l),
  ...
  t[37] !== n.additions || t[38] !== n.deletions
    ? ((k = (0, $.jsx)(dt, { linesAdded: n.additions, linesRemoved: n.deletions })),
      (t[37] = n.additions),
      (t[38] = n.deletions),
      (t[39] = k))
    : (k = t[39]);
  ...
  return (
    t[60] !== T || t[61] !== F
      ? ((I = (0, $.jsx)(ye, { items: T, children: F })), (t[60] = T), (t[61] = F), (t[62] = I))
      : (I = t[62]),
    I
  );
}
...
function Ga() {
  let e = (0, Ka.c)(39),
    ...
    o = r.get(`repoKey`),
    s;
  e[0] === r ? (s = e[1]) : ((s = sr(r.get(`view`))), (e[0] = r), (e[1] = s));
  let c = s,
    l;
  e[2] === r ? (l = e[3]) : ((l = r.get(`pullRequestUrl`)), (e[2] = r), (e[3] = l));
  let u = l,
    d;
  e[4] === r ? (d = e[5]) : ((d = ur(r.get(`pullRequestNumber`))), (e[4] = r), (e[5] = d));
  let f = d,
    p = H(Ne),
    { isLoading: m } = H(I),
    h;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (h = e[6]);
  let { data: g, isLoading: v } = V(ze, h),
    y = nr({ gitOrigins: g?.origins ?? [], workspaceGroups: p }),
    b = o ?? i,
  ...
  if (y.length === 0) {
    ...
    return (
      e[12] !== n || e[13] !== r
        ? ((i = (0, qa.jsx)(`div`, {
            className: `flex h-full items-center justify-center`,
            children: (0, qa.jsx)(Ct, { description: n, title: r }),
          })),
          (e[12] = n),
          (e[13] = r),
          (e[14] = i))
  ...
  return (
    ...
    e[37] !== T
      ? ((D = (0, qa.jsx)(Ca, {
          ...
          selectedRepoKey: S,
          onSelectFilterView: C,
          onSelectPullRequest: w,
          onSelectRepo: T,
        })),
        (e[29] = y),
        (e[30] = c),
...
e(() => {
  ((Ka = q()),
    ...
    Wa(),
    (qa = Re()),
    (Ja = re(`pull-request-board:last-selected-repo-key`, null)));
})();
