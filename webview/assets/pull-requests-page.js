...
import { C as Nt, S as Pt, b as Ft, x as It } from "./app-initial~app-main~automations-page.js";
import {
  i as Lt,
  r as Rt,
...
import { n as Nn, t as Pn } from "./segmented-toggle.js";
import { n as Fn, t as In } from "./selectable-list-row-Djcu-1mL.js";
import { n as Ln, r as Rn, t as zn } from "./sectioned-page.js";
import {
  _ as Bn,
  a as Vn,
  b as Hn,
...
function nr({ gitOrigins: e, workspaceGroups: t }) {
  let n = new Map(e.flatMap((e) => (e.originUrl == null ? [] : [[a(e.dir), e.originUrl]]))),
    r = new Map();
  for (let e of t) {
    let t = e.repositoryData?.ownerRepo;
    if (t == null || e.path == null) continue;
    let i = n.get(a(e.path));
    if (i == null) continue;
    let o = O(i);
    if (o == null) continue;
    let s = `${t.owner}/${t.repoName}`,
      c = `${o.owner}/${o.repo}`,
      l = o.host === `github.com` ? c : `${o.host}/${c}`,
      u = { cwd: e.path, hostId: e.hostId, key: l, label: s, repo: l },
      d = r.get(l);
    (d == null ||
      dr({
        currentCwd: d.option.cwd,
        currentIsCodexWorktree: d.isCodexWorktree,
        nextCwd: u.cwd,
        nextIsCodexWorktree: e.isCodexWorktree,
      })) &&
      r.set(l, { isCodexWorktree: e.isCodexWorktree, option: u });
  }
  return Array.from(r.values())
    .map((e) => e.option)
    .sort((e, t) => e.label.localeCompare(t.label));
}
function rr({ repoOptions: e, requestedRepoKey: t }) {
  return t === `all` ? null : (e.find((e) => e.key === t) ?? e[0] ?? null);
}
function ir(e) {
  return pr
    .map((t) => ({ key: t, items: e.filter((e) => fr(e, t)) }))
...
function cr({ searchQuery: e, selectedFilterView: t }) {
  return t === `authored` && e.trim() === or(`authored`) ? null : e;
}
function lr({ items: e, selectedPullRequestNumber: t, selectedPullRequestUrl: n }) {
...
function dr({ currentCwd: e, currentIsCodexWorktree: t, nextCwd: n, nextIsCodexWorktree: r }) {
...
var pr,
  ...
  hr = e(() => {
    (l(),
      Dt(),
      (pr = [`unmet_checks`, `draft`, `ready`, `merged`]),
      (mr = { authored: `is:pr author:@me`, review: `is:pr is:open review-requested:@me` }));
  });
function gr(e) {
  let t = (0, Sr.c)(17),
  ...
  if (t[0] !== n || t[1] !== a || t[2] !== r || t[3] !== i) {
    ...
    ((l = `max-w-[220px]`),
      ...
      t[8] === i
        ? (s = t[9])
        : ((s = (0, Cr.jsx)(rt.SectionLabel, { children: i })), (t[8] = i), (t[9] = s)),
      (c =
        e.length === 0
          ? (0, Cr.jsx)(rt.Message, { compact: !0, children: n })
          : (0, Cr.jsx)(`div`, {
  ...
  t[10] !== o || t[11] !== s || t[12] !== c
    ? ((u = (0, Cr.jsxs)(`div`, { className: o, children: [s, c] })),
      (t[10] = o),
      (t[11] = s),
      (t[12] = c),
      (t[13] = u))
  ...
  return (
    t[14] !== l || t[15] !== u
      ? ((d = (0, Cr.jsx)(`div`, { className: l, children: u })),
        (t[14] = l),
        (t[15] = u),
        (t[16] = d))
      : (d = t[16]),
  ...
  return (0, Cr.jsx)(
    ht,
    {
      ...
      children: (0, Cr.jsxs)(`div`, {
        className: wr,
        children: [
          (0, Cr.jsx)(`span`, { className: `shrink-0 text-token-foreground`, children: e.icon }),
          (0, Cr.jsx)(`span`, { className: tt(Tr, `text-token-foreground`), children: e.label }),
        ],
      }),
    },
    t,
...
function vr(e, t) {
  return [
    ...yr(`approved`, e.approved, t),
    ...yr(`requested`, e.requested, t),
    ...yr(`requested`, e.requestedTeams, t),
    ...yr(`changes-requested`, e.changesRequested, t),
    ...yr(
      `commented`,
      e.commented.filter(
        (t) =>
...
function yr(e, t, n) {
  return t.map((t) => ({ accessoryLabel: br(e, n), icon: xr(e), label: t }));
}
function br(e, t) {
  switch (e) {
    case `approved`:
...
function xr(e) {
  switch (e) {
    case `approved`:
      return (0, Cr.jsx)(Re, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `requested`:
      return (0, Cr.jsx)(Qt, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `commented`:
      return (0, Cr.jsx)(tn, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `changes-requested`:
      return (0, Cr.jsx)(mn, { className: `icon-sm shrink-0 text-token-charts-red` });
  }
}
var Sr,
  Cr,
  ...
  Er = e(() => {
    ((Sr = _()),
      ...
      an(),
      (Cr = b()),
      (wr = `flex items-center gap-2 px-[var(--padding-row-x)] py-[var(--padding-row-y)]`),
      (Tr = `min-w-0 truncate text-sm`));
  });
function Dr({ scope: e, event: t, intl: n, url: r }) {
  r &&
    me(r, t).then(
      () => {
        e.get(Je).success(
...
function kr(e) {
  let t = (0, qr.c)(165),
    ...
    M;
  t[0] === l ? (M = t[1]) : ((M = Lr(l)), (t[0] = l), (t[1] = M));
  let ee = j ? Ir(A) : M,
    [N, P] = (0, J.useState)(0),
    [F, I] = (0, J.useState)(!1),
    L = (0, J.useRef)(null),
  ...
  t[2] === P
    ...
    : ((se = () => {
      ...
      (t[3] = se));
  let ce;
  (t[4] === Symbol.for(`react.memo_cache_sentinel`) ? ((ce = []), (t[4] = ce)) : (ce = t[4]),
    (0, J.useLayoutEffect)(se, ce));
  let le;
  t[5] === P
    ? (le = t[6])
    : ((le = () => {
  ...
  (t[7] === Symbol.for(`react.memo_cache_sentinel`) ? ((ue = []), (t[7] = ue)) : (ue = t[7]),
    (0, J.useEffect)(le, ue));
  let de, fe;
  (t[8] !== N || t[9] !== T || t[10] !== S || t[11] !== C || t[12] !== g
    ? ((de = () => {
        !N || !T || (!S && !C && g?.(!0));
      }),
      (fe = [N, T, S, C, g]),
  ...
  t[28] !== k
    ? ((pe = () => {
        ...
        te.current ? i && jr([ie, V, ae], z) : (jr([ie, V, ae], z), (te.current = !0));
        let a = () => {
          ((ne.current = t), (re.current = D));
        };
        if (x > 0 && T && t <= x && !W) {
          (Wr({ containerWidth: t, minRightWidth: y, isOpen: E, node: e, rafRef: R }), a());
          return;
        }
        let o = Pr(t);
        if (!T) {
        ...
        if (!E) {
          let { rightWidth: n, boundedLeftRatio: r } = Hr({
            containerWidth: t,
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: o * Ir(H.current),
          });
          H.current = r;
          let i = Vr(U.current > 0 ? U.current : n, o);
          ((U.current = i),
            Kr({
              containerWidth: t,
              handleWidth: 0,
  ...
  t[44] !== O ||
  t[45] !== k
    ? ((me = [N, D, E, K, x, W, T, G, S, C, F, v, y, w, O, k]),
      (t[30] = N),
      (t[31] = x),
      (t[32] = K),
      (t[33] = D),
  ...
  t[87] !== _
    ? ((ye = (e) => {
        ...
        if (!t || !n) return;
        if (G) {
          Wr({ containerWidth: n, minRightWidth: y, isOpen: !1, node: t, rafRef: R });
          return;
        }
        let r = Pr(n),
          { rightWidth: i, boundedLeftRatio: a } = Hr({
            containerWidth: n,
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: r * Ir(H.current),
          });
        H.current = a;
        let o = Vr(U.current > 0 ? U.current : i, r);
        ((U.current = o),
          Kr({
            containerWidth: n,
            handleWidth: 0,
  ...
  t[101] !== k
    ? ((xe = (e) => {
        ...
        if (C || !T) return;
        if ((Mr([ie, V, ae], z), _?.(!0), G)) {
          Wr({ containerWidth: n, minRightWidth: y, isOpen: !0, node: t, rafRef: R });
          return;
        }
        let {
          boundedLeftWidth: r,
  ...
  let Se = xe,
    Ce;
  t[103] !== be || t[104] !== Se || t[105] !== S || t[106] !== C
    ? ((Ce = (e) => {
        if (e === `left`) {
          if (S) {
            be(`left`);
  ...
  let we = Ce,
    Te;
  t[108] !== be || t[109] !== D || t[110] !== E || t[111] !== Se || t[112] !== F || t[113] !== we
    ? ((Te = {
        isLeftOpen: D,
        isRightOpen: E,
        isResizing: F,
  ...
  let Ee = Te,
    De = T && !G && D && E,
    Oe = `min(calc(100% - ${b}px), max(0px, ${D && E ? `calc(var(--split-left-width, 100%) - (${b}px / 2))` : `calc(100% - (${b}px / 2))`}))`,
    ke = F && `cursor-col-resize`,
    Ae;
  t[115] !== a || t[116] !== ke
    ? ((Ae = tt(`group/split-view relative h-full w-full min-w-0 overflow-hidden`, ke, a)),
      (t[115] = a),
      (t[116] = ke),
      (t[117] = Ae))
    : (Ae = t[117]);
  let je = !D && `pointer-events-none`,
    Me;
  t[118] !== o || t[119] !== je
    ? ((Me = tt(
  ...
  t[121] === Ne
    ? (Pe = t[122])
    : ((Pe = { width: `var(--split-left-width, 100%)`, contain: `strict`, transitionProperty: Ne }),
      (t[121] = Ne),
      (t[122] = Pe));
  let Fe = D ? `visible` : `hidden`,
    Ie = `${n}-left`,
    Le;
  t[123] !== r || t[124] !== Fe || t[125] !== Ie
    ? ((Le = (0, Jr.jsx)(`div`, {
        className: `h-full min-w-0`,
        children: (0, Jr.jsx)(J.Activity, { mode: Fe, name: Ie, children: r }),
      })),
      (t[123] = r),
      (t[124] = Fe),
      (t[125] = Ie),
    ...
    : (Le = t[126]);
  let Re;
  t[127] !== Me || t[128] !== Pe || t[129] !== Le
    ? ((Re = (0, Jr.jsx)(`div`, { ref: ie, className: Me, style: Pe, children: Le })),
      (t[127] = Me),
      (t[128] = Pe),
      (t[129] = Le),
      (t[130] = Re))
  ...
  t[139] !== F
    ? ((ze =
        T && !G && D
          ? (0, Jr.jsx)(`div`, {
              ...
              className: tt(
                ...
                De ? `opacity-100` : `opacity-0 pointer-events-none`,
                c,
              ),
              style: {
                width: `${b}px`,
      ...
      (t[140] = ze))
    : (ze = t[140]);
  let Be = G ? `main-surface z-30 shadow-[-16px_0_32px_rgba(0,0,0,0.28)]` : `z-10`,
    Ve = E ? `opacity-100` : `opacity-0`,
    He = !E && `pointer-events-none`,
    Ue;
  t[141] !== s || t[142] !== Be || t[143] !== Ve || t[144] !== He
    ? ((Ue = tt(
      ...
      (t[145] = Ue))
    : (Ue = t[145]);
  let We = F ? `none` : `width, transform, opacity`,
    Ge;
  t[146] === We
    ? (Ge = t[147])
    : ((Ge = {
  ...
  t[148] !== E || t[149] !== T || t[150] !== n || t[151] !== i
        ...
        ? (0, Jr.jsx)(`div`, {
            ...
            children: (0, Jr.jsx)(J.Activity, {
              ...
              children: (0, Jr.jsx)(`div`, {
                ...
                style: { transitionDelay: E ? `${ei}ms` : `0ms` },
                children: i,
              }),
            }),
          })
    ...
    : (Ke = t[152]);
  let qe;
  t[153] !== Ue || t[154] !== Ge || t[155] !== Ke
    ? ((qe = (0, Jr.jsx)(`div`, { ref: ae, className: Ue, style: Ge, children: Ke })),
      (t[153] = Ue),
      (t[154] = Ge),
      (t[155] = Ke),
      (t[156] = qe))
    : (qe = t[156]);
  let Je;
  t[157] !== Ae || t[158] !== Re || t[159] !== ze || t[160] !== qe
    ? ((Je = (0, Jr.jsxs)(`div`, { ref: L, className: Ae, children: [Re, ze, qe] })),
      (t[157] = Ae),
      (t[158] = Re),
      (t[159] = ze),
      (t[160] = qe),
  ...
  return (
    t[162] !== Ee || t[163] !== Je
      ? ((Ye = (0, Jr.jsx)(ni.Provider, { value: Ee, children: Je })),
        (t[162] = Ee),
        (t[163] = Je),
        (t[164] = Ye))
      : (Ye = t[164]),
...
function Hr({ containerWidth: e, minLeftWidth: t, minRightWidth: n, leftWidth: r }) {
  let i = Pr(e),
    a = Br(r, e, t, n),
    o = Vr(Math.max(0, i - a), i);
  return { openAvailableWidth: i, boundedLeftWidth: a, boundedLeftRatio: Rr(i, a), rightWidth: o };
}
function Ur(e, t) {
  let n = Math.min(t, e),
    r = e * $r;
  return Vr(Math.max(n, r), e);
}
function Wr({ containerWidth: e, minRightWidth: t, isOpen: n, node: r, rafRef: i }) {
  let a = Ur(e, t);
  Kr({
    containerWidth: e,
    handleWidth: 0,
...
var qr,
  ...
  ri = e(() => {
    ((qr = _()),
      ...
      ($r = 0.9),
      (ei = 150),
      (ti = { version: 0, listeners: new Set() }),
      (ni = (0, J.createContext)(null)));
  });
function ii(e) {
  let t = (0, ai.c)(23),
    {
  ...
  t[0] !== n || t[1] !== f
    ? ((_ = (e) => {
      ...
      (t[2] = _))
    : (_ = t[2]);
  let v = s.metadata.additionLines ? `line-info` : `metadata`,
    y;
  t[3] !== p || t[4] !== h
    ? ((y = () => {
        p.set(W, !h);
...
var ai,
  ...
  li = e(() => {
    (r(),
      v(),
      h(),
      (ci = S(i, `gh-current-user`, (e) => ({ params: { hostId: e }, staleTime: x.ONE_MINUTE }))));
  });
function ui(e) {
  let t = (0, mi.c)(50),
  ...
  t[31] !== s
    ? ((w = {
        ...
        onToggleWrap: v,
        hideWhitespace: !1,
        onToggleHideWhitespace: di,
        expanded: f,
        onToggleExpanded: y,
        richPreviewEnabled: l,
        onToggleRichPreview: b,
        wordDiffsEnabled: u,
        onToggleWordDiffs: x,
        loadFullFilesEnabled: d,
        onToggleLoadFullFiles: S,
      }),
      (t[20] = o),
      (t[21] = f),
      (t[22] = d),
  ...
  t[33] === T
    ? (E = t[34])
    : ((E = (0, Y.jsx)(Kt, { diffControls: T, showHideWhitespace: !1, showLoadFullFiles: !1 })),
      (t[33] = T),
      (t[34] = E));
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, Y.jsx)(he, { className: `icon-xs` })), (t[38] = k))
    : (k = t[38]);
  let A;
  t[39] !== g || t[40] !== n || t[41] !== D || t[42] !== O
    ? ((A = (0, Y.jsx)(Be, {
        "aria-label": g,
        "aria-pressed": n,
        color: D,
  ...
  let j;
  t[44] !== g || t[45] !== A
    ? ((j = (0, Y.jsx)(ht, { tooltipContent: g, delayOpen: !0, children: A })),
      (t[44] = g),
      (t[45] = A),
      (t[46] = j))
    : (j = t[46]);
  ...
  return (
    t[47] !== j || t[48] !== E
      ? ((M = (0, Y.jsxs)(`div`, { className: `flex items-center gap-px`, children: [E, j] })),
        (t[47] = j),
        (t[48] = E),
        (t[49] = M))
      : (M = t[49]),
...
function fi({
  ...
  repo: l,
  onCommentPosted: u,
  surface: d = `pull_request_page`,
}) {
  let f = c(i),
    p = _t(t ?? `local`),
    m = Ot(),
    h = C(se),
    g = (0, hi.useRef)(new Map()),
    [_, v] = (0, hi.useState)(),
    [b, S] = (0, hi.useState)({}),
    [w, T] = (0, hi.useState)(null),
    [E, O] = (0, hi.useState)(``),
    k = (0, hi.useRef)(new Map()),
    [j, M] = (0, hi.useState)(() => new Set()),
    { data: P } = o(ci, t),
    F = (0, hi.useCallback)((e, t) => {
      let n = At(e);
      M((e) => {
    ...
    I = (0, hi.useCallback)(
      (e) => {
        let t = ge(e),
          n = k.current.get(t);
        (k.current.delete(t), n != null && F(n, !1));
      },
      [F],
    ),
    L = (0, hi.useCallback)((e) => {
      let t = At(e),
        n = e.position.path;
      S((e) => ({ ...e, [n]: (e[n] ?? []).filter((e) => At(e) !== t) }));
    }, []),
    R = D(`gh-pr-comment`, {
    ...
    { data: B, isLoading: te } = y(`gh-pr-diff`, {
      source: `pull_request_board`,
      params: { cwd: e, hostId: t, number: r, repo: l ?? null },
      queryConfig: { refetchOnWindowFocus: !0, staleTime: x.FIVE_SECONDS },
    }),
    [ne] = (0, hi.useState)(() => new N()),
    re = (0, hi.useCallback)(
      (e) => {
        if (e != null) {
          ne.setup(e);
    ...
    V = B?.status === `success` ? ee(B.unifiedDiff) : [],
    ae = V.map((e) => e.metadata.name),
    H = P?.status === `success` ? P.avatarUrl : void 0,
    U =
      P?.status === `success`
        ? P.login
        : m.formatMessage({
    ...
    W = E.trim().length === 0 ? ae : ae.filter((e) => e.includes(E.trim())),
    G = (0, hi.useMemo)(
      () =>
        s == null || s.length === 0 ? void 0 : ce({ comments: s, filePaths: ae, workspaceRoot: e }),
      [e, ae, s],
    );
  function K(e) {
    (v(e), g.current.get(e)?.scrollIntoView({ block: `start` }));
  }
  let le = (0, hi.useCallback)(
      (n) => {
        let i = {
          body: ue(n),
          cwd: e,
        ...
        (k.current.set(ge(i), n), F(n, !0), R.mutate(i));
      },
      [e, t, r, R, l, F],
    ),
    fe = (0, hi.useCallback)(
      (e, t) => {
        let n = oe({ currentComments: b[e] ?? [], nextComments: t });
        (T(null), S((n) => ({ ...n, [e]: t })));
        for (let e of n) le(e);
      },
      [b, le],
                ...
                left: (0, Y.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, Y.jsx)(`div`, {
                      ...
                      children: (0, Y.jsx)(A, {
                        activePath: _,
                        commentCountByPath: G,
                        cwd: e,
                        onSelectPath: K,
                        entries: W.map((e) => ({ displayPath: e, path: e })),
                      }),
                    }),
                  ],
                }),
                  ...
                  children: (0, Y.jsx)(`div`, {
                    ...
                    children: V.map((t) =>
                      (0, Y.jsx)(
                        ...
                        {
                          ref: (e) => {
                            ie(t.metadata.name, e);
                          },
                          children: (0, Y.jsx)(ii, {
                            comments: b[t.metadata.name] ?? [],
                            commentAuthorAvatarUrl: H,
                            commentAuthorLabel: U,
                            cwd: e,
                            diffMode: h,
                            file: t,
                            hostConfig: p,
...
var mi,
  ...
  xi = e(() => {
    ((mi = _()),
      ...
      (vi = 50),
      (yi = 0),
      (bi = `pull-request-code-review-file-tree-left`));
  });
function Si(e) {
  let t = (0, Oi.c)(36),
    {
  ...
  t[12] !== O
    ? ((A = async (e) => {
        if ((e.preventDefault(), !O || C.isPending)) return;
        x(null);
        ...
        (tr(g, { kind: k ? `reply` : `comment`, surface: h }), y(``), await l().catch(Ci));
      }),
      (t[3] = r),
      (t[4] = k),
      (t[5] = a),
  ...
  let j = A,
    ...
    ee;
  t[14] !== _ || t[15] !== M
    ? ((ee = Di({ intl: _, user: M })), (t[14] = _), (t[15] = M), (t[16] = ee))
    : (ee = t[16]);
  let N = ee,
    P = k && `w-full`,
    F;
  t[17] === P ? (F = t[18]) : ((F = tt(`flex flex-col gap-2`, P)), (t[17] = P), (t[18] = F));
  let I;
  ...
  t[29] === b
    ...
    : ((z =
        b == null
          ? null
          : (0, Ai.jsx)(`div`, { className: `px-1 text-sm text-token-charts-red`, children: b })),
      (t[29] = b),
      (t[30] = z));
  let B;
  return (
    t[31] !== j || t[32] !== R || t[33] !== z || t[34] !== F
      ? ((B = (0, Ai.jsxs)(`form`, { className: F, onSubmit: j, children: [R, z] })),
        (t[31] = j),
        (t[32] = R),
        (t[33] = z),
        (t[34] = F),
...
function Ti(e) {
  ...
  t[10] === v
    ? (y = t[11])
    : ((y = tt(`flex min-w-0 items-center gap-2`, v)), (t[10] = v), (t[11] = y));
  let b;
  t[12] === s
    ? (b = t[13])
    : ((b = (e) => {
        ...
        c == null
          ...
          : (0, Ai.jsx)(ht, {
              ...
              children: (0, Ai.jsx)(Be, {
                ...
                uniform: !0,
                onClick: c,
                children: (0, Ai.jsx)(st, { className: `icon-xs` }),
              }),
            })),
      (t[21] = d),
      (t[22] = c),
  ...
  t[24] === a
    ? (C = t[25])
    : ((C = a ? null : (0, Ai.jsx)(ie, { className: `icon-xs` })), (t[24] = a), (t[25] = C));
  let w;
  ...
  let T;
  t[31] !== p || t[32] !== w
    ? ((T = (0, Ai.jsx)(ht, { delayDuration: 250, tooltipContent: p, children: w })),
      (t[31] = p),
      (t[32] = w),
      (t[33] = T))
    : (T = t[33]);
  ...
  return (
    t[34] !== n || t[35] !== T || t[36] !== y || t[37] !== x || t[38] !== S
      ? ((E = (0, Ai.jsxs)(`div`, { className: y, children: [n, x, S, T] })),
        (t[34] = n),
        (t[35] = T),
        (t[36] = y),
        (t[37] = x),
...
function Mi(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Pi.jsx)(Jt, { className: `icon-sm shrink-0`, state: r })), (t[0] = r), (t[1] = i));
  let a;
  t[2] === n.title
    ? (a = t[3])
    : ((a = (0, Pi.jsx)(`div`, {
...
function Ii(e) {
  let t = (0, Vi.c)(24),
    { item: n } = e,
    r = d(Nt, n.url),
    i = C(r.conversationId$),
    a = C(r.pendingWorktreeId$),
    o = C(r.ciJobsFixed$),
    s = C(r.mergeConflictsResolved$),
    c = C(Xt),
    l = c.data,
    u,
    f,
  ...
  if (t[0] !== l?.items || t[1] !== i || t[2] !== a) {
    let e = Mn({ automations: l?.items ?? [], conversationId: i, includePausedAutomations: !0 });
    u = i == null && a != null;
    let n;
    (t[6] !== i || t[7] !== a
      ? ((n = Jn({ conversationId: i, pendingWorktreeId: a })), (t[6] = i), (t[7] = a), (t[8] = n))
      : (n = t[8]),
      (p = n),
      (f = Li({ automationStatus: e?.status, isTaskStarting: u })),
      (t[0] = l?.items),
      (t[1] = i),
      (t[2] = a),
      (t[3] = u),
      (t[4] = f),
      (t[5] = p));
  } else ((u = t[3]), (f = t[4]), (p = t[5]));
  let m = f;
  if ((i == null && a == null) || (!u && c.isLoading) || m == null) return null;
  let h;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, X.jsx)(rt.SectionLabel, {
        children: (0, X.jsx)(q, {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, X.jsx)(Cn, { className: `icon-xs shrink-0` })), (t[10] = g))
    : (g = t[10]);
  let _;
  t[11] === m
    ? (_ = t[12])
    : ((_ = (0, X.jsxs)(`span`, {
        ...
        children: [
          g,
          (0, X.jsx)(`span`, { className: `truncate`, children: (0, X.jsx)(Ri, { status: m }) }),
        ],
      })),
      (t[11] = m),
      (t[12] = _));
  let v;
  t[13] !== o || t[14] !== s
    ? ((v = (0, X.jsx)(Bi, { ciJobsFixed: o, mergeConflictsResolved: s })),
      (t[13] = o),
      (t[14] = s),
      (t[15] = v))
    : (v = t[15]);
  let y;
  t[16] !== _ || t[17] !== v
    ? ((y = (0, X.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [_, v] })),
      (t[16] = _),
      (t[17] = v),
      (t[18] = y))
    : (y = t[18]);
  let b;
  t[19] === p ? (b = t[20]) : ((b = (0, X.jsx)(zi, { taskRoute: p })), (t[19] = p), (t[20] = b));
  let x;
  return (
    t[21] !== y || t[22] !== b
      ? ((x = (0, X.jsxs)(`div`, {
...
function Li({ automationStatus: e, isTaskStarting: t }) {
  switch (t ? `STARTING` : e) {
    case `STARTING`:
      return `STARTING`;
    case `ACTIVE`:
...
function Bi(e) {
  ...
  let s;
  t[4] !== i || t[5] !== a
    ? ((s = i && a ? (0, X.jsx)(Rt, { className: `shrink-0` }) : null),
      (t[4] = i),
      (t[5] = a),
      (t[6] = s))
    : (s = t[6]);
...
var Vi,
  X,
  Hi = e(() => {
    ((Vi = _()), u(), Ct(), Mt(), Yt(), An(), Lt(), je(), ot(), Sn(), Pt(), $n(), (X = b()));
  });
function Ui(e) {
  let t = (0, Z.c)(104),
    {
    ...
    f = c(Et),
    p = Ot(),
    [m, h] = (0, xa.useState)(`pull-request`),
    g = u ? m : `pull-request`,
    [_, v] = (0, xa.useState)(!1),
    b;
  t[0] !== n || t[1] !== r || t[2] !== o
    ? ((b = la({ hostId: n, item: r, repo: o })), (t[0] = n), (t[1] = r), (t[2] = o), (t[3] = b))
    : (b = t[3]);
  let S = b,
    C = g === `code-review`,
    w;
  t[4] === C
    ? (w = t[5])
    : ((w = { enabled: C, intervalMs: x.ONE_MINUTE, staleTime: x.ONE_MINUTE }),
      (t[4] = C),
      (t[5] = w));
  let T;
  t[6] !== S || t[7] !== w
    ? ((T = { source: `pull_request_board`, params: S, queryConfig: w }),
      (t[6] = S),
      (t[7] = w),
      (t[8] = T))
    : (T = t[8]);
  let { data: E, refetch: D } = y(`gh-pr-comments`, T),
    O;
  t[9] === E
    ? (O = t[10])
    : ((O = E?.status === `success` ? E.commentAttachments : []), (t[9] = E), (t[10] = O));
  let A = O,
    j;
  t[11] !== p || t[12] !== r || t[13] !== f || t[14] !== d
    ? ((j = function (e) {
        (er(f, { action: `copy_url`, item: r, surface: d }),
          Dr({ scope: f, event: e, intl: p, url: r.url }));
      }),
      (t[11] = p),
      (t[12] = r),
      (t[13] = f),
  ...
  let M = j,
    ee;
  t[16] !== M || t[17] !== f.value.pathname
    ? ((ee = () => {
        f.value.pathname === `/pull-requests` && M();
      }),
      (t[16] = M),
  ...
  t[23] !== f ||
  t[24] !== d
    ? ((N = [p, r.isAuthor, r.state, r.url, f, d]),
      (t[19] = p),
      (t[20] = r.isAuthor),
      (t[21] = r.state),
      (t[22] = r.url),
      ...
      (t[25] = N))
    : (N = t[25]),
    k(`copy-working-directory`, ee, N));
  let P;
  t[26] === r
    ? (P = t[27])
    : ((P = (0, Q.jsx)(Mi, { item: r, state: r.state })), (t[26] = r), (t[27] = P));
  let F;
  t[28] === r.headBranch
    ? (F = t[29])
    : ((F = (0, Q.jsx)(`span`, { className: `truncate`, children: r.headBranch })),
      (t[28] = r.headBranch),
      (t[29] = F));
  let I;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (0, Q.jsx)(`span`, { className: `shrink-0`, children: `->` })), (t[30] = I))
    : (I = t[30]);
  let L;
  t[31] === r.baseBranch
    ? (L = t[32])
    : ((L = (0, Q.jsx)(`span`, { className: `truncate`, children: r.baseBranch })),
      (t[31] = r.baseBranch),
      (t[32] = L));
  let R;
  t[33] !== F || t[34] !== L
  ...
  let z;
  t[36] !== P || t[37] !== R
    ? ((z = (0, Q.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [P, R] })),
      (t[36] = P),
      (t[37] = R),
      (t[38] = z))
    : (z = t[38]);
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ne = (0, Q.jsx)(ln, { className: `icon-xs` })), (t[43] = ne))
    : (ne = t[43]);
  let re;
  t[44] !== M || t[45] !== te
    ? ((re = (0, Q.jsx)(Be, {
  ...
  let ie;
  t[47] !== B || t[48] !== re
    ? ((ie = (0, Q.jsx)(ht, { tooltipContent: B, children: re })),
      (t[47] = B),
      (t[48] = re),
      (t[49] = ie))
    : (ie = t[49]);
  ...
  t[52] === p
    ...
    : ((ae = p.formatMessage({
      ...
      (t[53] = ae));
  let H;
  t[54] !== r || t[55] !== f || t[56] !== d
    ? ((H = (e) => {
        (er(f, { action: `open_in_browser`, item: r, surface: d }),
          Ze({ event: e, href: r.url, initiator: `pull_request_link` }));
      }),
      (t[54] = r),
      (t[55] = f),
      (t[56] = d),
  ...
  t[58] === r.url
    ? (U = t[59])
    : ((U = (0, Q.jsx)(Fe, { href: r.url, className: `icon-xs` })), (t[58] = r.url), (t[59] = U));
  let oe;
  t[60] !== ae || t[61] !== H || t[62] !== U
    ? ((oe = (0, Q.jsx)(Be, {
        "aria-label": ae,
        color: `ghost`,
        size: `toolbar`,
  ...
  let W;
  t[64] !== V || t[65] !== oe
    ? ((W = (0, Q.jsx)(ht, { tooltipContent: V, children: oe })),
      (t[64] = V),
      (t[65] = oe),
      (t[66] = W))
    : (W = t[66]);
  ...
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, Q.jsx)(st, { className: `icon-xs` })), (t[69] = K))
    : (K = t[69]);
  let se;
  t[70] !== i || t[71] !== G
    ? ((se = (0, Q.jsx)(Be, {
    ...
    ? ((ue = u
        ? (0, Q.jsxs)(`div`, {
            ...
            children: [
              ...
              g === `code-review`
                ? (0, Q.jsx)(ui, { isFileTreeOpen: _, onFileTreeOpenChange: v })
                : null,
            ],
          })
        : null),
    ...
    ? ((de = (0, Q.jsx)(`div`, {
        ...
        children:
          g === `code-review`
            ...
            : (0, Q.jsx)(Wi, { hostId: n, item: r, relatedThreads: a, request: S, surface: d }),
      })),
      (t[89] = g),
      (t[90] = n),
      (t[91] = _),
...
function Wi(e) {
  let t = (0, Z.c)(26),
    ...
    s = It(),
    c;
  t[0] === a ? (c = t[1]) : ((c = (0, Q.jsx)(qi, { request: a })), (t[0] = a), (t[1] = c));
  let l;
  t[2] !== r || t[3] !== s
    ? ((l = s ? (0, Q.jsx)(Ii, { item: r }) : null), (t[2] = r), (t[3] = s), (t[4] = l))
    : (l = t[4]);
  let u;
  t[5] === i ? (u = t[6]) : ((u = (0, Q.jsx)(Gi, { threads: i })), (t[5] = i), (t[6] = u));
  let d, f;
  t[7] === a
    ? ((d = t[8]), (f = t[9]))
    : ((d = (0, Q.jsx)(Ji, { request: a })),
      (f = (0, Q.jsx)(Yi, { request: a })),
      (t[7] = a),
      (t[8] = d),
      (t[9] = f));
  let p, m, h;
  t[10] !== n || t[11] !== r || t[12] !== a || t[13] !== o
    ? ((p = (0, Q.jsx)(Qi, { hostId: n, item: r, request: a, surface: o })),
      (m = (0, Q.jsx)($i, { hostId: n, item: r, request: a, surface: o })),
      (h = (0, Q.jsx)(ea, { hostId: n, item: r, request: a, surface: o })),
      (t[10] = n),
      (t[11] = r),
      (t[12] = a),
      (t[13] = o),
...
function Gi(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (r = t[0]);
  let i;
  t[1] === n ? (i = t[2]) : ((i = n.map(Ki)), (t[1] = n), (t[2] = i));
  let a;
  return (
    t[3] === i
      ? (a = t[4])
...
function qi(e) {
  let t = (0, Z.c)(16),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = { intervalMs: x.ONE_MINUTE, staleTime: x.ONE_MINUTE }), (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = y(`gh-pr-body`, i),
  ...
  if (s) {
    ...
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[3]);
    let n;
    t[4] === o ? (n = t[5]) : ((n = ya(o)), (t[4] = o), (t[5] = n));
    let r;
    return (
      t[6] === n
        ? (r = t[7])
        : ((r = (0, Q.jsx)(ba, { title: e, description: n })), (t[6] = n), (t[7] = r)),
      r
    );
  }
  if (l || a == null) {
...
function Ji(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = y(`gh-pr-comments`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(q, {
  ...
  t[13] === a.reviewers
    ? (p = t[14])
    : ((p = (0, Q.jsx)(gr, { emptyMessage: d, reviewers: a.reviewers, title: f })),
      (t[13] = a.reviewers),
      (t[14] = p));
  let m;
  return (
...
function Yi(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = y(`gh-pr-checks`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(q, {
  ...
  t[11] !== a.checks || t[12] !== a.ciStatus
    ? ((d = (0, Q.jsx)(Xi, { checks: a.checks, ciStatus: a.ciStatus })),
      (t[11] = a.checks),
      (t[12] = a.ciStatus),
      (t[13] = d))
    : (d = t[13]);
...
function Xi(e) {
  ...
  let o;
  t[0] !== n || t[1] !== r
    ? ((o = jn({ checks: n, ciStatus: r })), (t[0] = n), (t[1] = r), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === r ? (s = t[4]) : ((s = kn(r)), (t[3] = r), (t[4] = s));
  let c = i ? 180 : 0,
    l;
  t[5] === c ? (l = t[6]) : ((l = { rotate: c }), (t[5] = c), (t[6] = l));
  let u;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Q.jsx)(qe, { className: `icon-2xs` })), (t[7] = u))
    : (u = t[7]);
  let d;
  t[8] === l
    ? (d = t[9])
  ...
  t[11] !== i || t[12] !== o || t[13] !== s || t[14] !== d
    ? ((p = (0, Q.jsx)(_n, { ariaExpanded: i, icon: o, label: s, trailing: d, onClick: f })),
      (t[11] = i),
      (t[12] = o),
      (t[13] = s),
      (t[14] = d),
  ...
  t[19] === m
    ? (h = t[20])
    : ((h = (0, Q.jsx)(at, { initial: !1, children: m })), (t[19] = m), (t[20] = h));
  let g;
  return (
    t[21] !== h || t[22] !== p
      ? ((g = (0, Q.jsxs)(`div`, { className: `relative z-10 flex flex-col`, children: [p, h] })),
        (t[21] = h),
        (t[22] = p),
        (t[23] = g))
      : (g = t[23]),
...
function Qi(e) {
  let t = (0, Z.c)(36),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = { intervalMs: x.ONE_MINUTE, staleTime: x.ONE_MINUTE }), (t[0] = o))
    : (o = t[0]);
  let s;
  t[1] === i
    ? (s = t[2])
  ...
  let {
    ...
    m = d && c != null,
    h;
  t[3] === m ? (h = t[4]) : ((h = (0, Q.jsx)(ga, { isFetching: m })), (t[3] = m), (t[4] = h));
  let g = h;
  if (u) {
    let e;
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[5]);
    let n;
    t[6] === l ? (n = t[7]) : ((n = ya(l)), (t[6] = l), (t[7] = n));
    let r;
    return (
      t[8] === n
        ? (r = t[9])
        : ((r = (0, Q.jsx)(ba, { title: e, description: n })), (t[8] = n), (t[9] = r)),
      r
    );
  }
  if (f || c == null) {
  ...
  if (c.activityItems.length === 0) {
    ...
    t[11] === g
      ? (e = t[12])
      : ((e = (0, Q.jsx)(rt.SectionLabel, { children: g })), (t[11] = g), (t[12] = e));
    let n;
    t[13] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, Q.jsx)(rt.Message, {
          compact: !0,
          children: (0, Q.jsx)(q, {
    ...
    return (
      t[14] === e
        ? (r = t[15])
        : ((r = (0, Q.jsxs)(`div`, { className: `flex flex-col`, children: [e, n] })),
          (t[14] = e),
          (t[15] = r)),
      r
    );
  ...
  t[16] === g
    ? (_ = t[17])
    : ((_ = (0, Q.jsx)(rt.SectionLabel, { children: g })), (t[16] = g), (t[17] = _));
  let v;
  if (
  ...
  t[31] === v
    ? (b = t[32])
    : ((b = (0, Q.jsx)(`div`, { className: `flex flex-col gap-3`, children: v })),
      (t[31] = v),
      (t[32] = b));
  let S;
  return (
    t[33] !== _ || t[34] !== b
      ? ((S = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [_, b] })),
        (t[33] = _),
        (t[34] = b),
        (t[35] = S))
      : (S = t[35]),
...
function $i(e) {
  ...
  t[0] !== o || t[1] !== i
    ? ((c = async () => {
        await o.invalidateQueries({ queryKey: m(`gh-pr-comments`, i) });
      }),
      (t[0] = o),
      (t[1] = i),
      (t[2] = c))
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== a || t[6] !== s || t[7] !== c
      ? ((l = (0, Q.jsx)(Si, { hostId: n, item: r, repo: s, surface: a, onCommentPosted: c })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = a),
        (t[6] = s),
...
function ea(e) {
  ...
  t[1] === i
    ? (s = t[2])
    : ((s = { source: `pull_request_board`, params: i, queryConfig: o }), (t[1] = i), (t[2] = s));
  let { data: c, error: l, isError: u, isFetching: d, isLoading: f } = y(`gh-pr-body`, s);
  ...
  if (u) {
    ...
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (e = t[3]);
    let n;
    t[4] === l ? (n = t[5]) : ((n = ya(l)), (t[4] = l), (t[5] = n));
    let r;
    return (
      t[6] === n
        ? (r = t[7])
  ...
  t[11] !== n || t[12] !== r || t[13] !== i || t[14] !== a || t[15] !== m || t[16] !== h
    ? ((g = (0, Q.jsx)(Vn, { hostId: n, item: r, pullRequestBody: h, request: i, surface: a }, m)),
      (t[11] = n),
      (t[12] = r),
      (t[13] = i),
      (t[14] = a),
  ...
  return (
    t[18] !== p || t[19] !== g
      ? ((_ = (0, Q.jsxs)(`div`, { className: `relative flex flex-col gap-2`, children: [p, g] })),
        (t[18] = p),
        (t[19] = g),
        (t[20] = _))
      : (_ = t[20]),
...
function ta(e) {
  ...
  if (r.type === `event`) {
    let e;
    return (
      t[0] === r ? (e = t[1]) : ((e = (0, Q.jsx)(ra, { item: r })), (t[0] = r), (t[1] = e)), e
    );
  }
  let u;
...
function na(e) {
  let t = (0, Z.c)(10),
    { item: n, onReply: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = ca(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === a
    ? (o = t[3])
  ...
  t[5] === r
    ? (c = t[6])
    : ((c = (0, Q.jsx)(Be, { color: `ghost`, size: `composerSm`, onClick: r, children: s })),
      (t[5] = r),
      (t[6] = c));
  let l;
  return (
...
function ra(e) {
  ...
  let l;
  t[7] !== o || t[8] !== s
    ? ((l = (0, Q.jsx)(o, { className: s })), (t[7] = o), (t[8] = s), (t[9] = l))
    : (l = t[9]);
  let u;
  t[10] !== a || t[11] !== n
    ? ((u = (0, Q.jsx)(`span`, {
        className: `min-w-0 truncate`,
        children: (0, Q.jsx)(ia, { actorLabel: a, item: n }),
      })),
      (t[10] = a),
      (t[11] = n),
      (t[12] = u))
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (d = t[13]);
  let f;
  t[14] === n.createdAt ? (f = t[15]) : ((f = H(n.createdAt)), (t[14] = n.createdAt), (t[15] = f));
  let p;
  t[16] === n.createdAt
    ? (p = t[17])
    : ((p = (0, Q.jsx)(`span`, {
        className: `inline`,
        children: (0, Q.jsx)(K, { dateString: n.createdAt }),
      })),
      (t[16] = n.createdAt),
      (t[17] = p));
  let m;
  ...
  let g;
  t[21] !== h || t[22] !== f
    ? ((g = (0, Q.jsx)(ht, { delayDuration: 250, tooltipContent: f, children: h })),
      (t[21] = h),
      (t[22] = f),
      (t[23] = g))
    : (g = t[23]);
...
function ia(e) {
  let t = (0, Z.c)(10),
    ...
    a;
  t[0] !== i || t[1] !== r.event
    ? ((a = aa(r.event, i)), (t[0] = i), (t[1] = r.event), (t[2] = a))
    : (a = t[2]);
  let o = a,
    s;
  t[3] === o ? (s = t[4]) : ((s = (0, Q.jsx)(`span`, { children: o })), (t[3] = o), (t[4] = s));
  let c;
  t[5] === n ? (c = t[6]) : ((c = (0, Q.jsx)(oa, { children: n })), (t[5] = n), (t[6] = c));
  let l;
  return (
    t[7] !== s || t[8] !== c
      ? ((l = (0, Q.jsxs)(`span`, { className: `inline-flex gap-1`, children: [s, c] })),
        (t[7] = s),
        (t[8] = c),
        (t[9] = l))
      : (l = t[9]),
...
function oa(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Q.jsx)(`span`, { className: `font-medium text-token-foreground`, children: n })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function sa(e) {
  switch (e) {
    case `approved`:
      return { Icon: bn, iconClassName: `text-token-charts-green` };
    case `changes_requested`:
      return { Icon: st, iconClassName: `text-token-charts-red` };
    case `merged`:
      return { Icon: on, iconClassName: `text-token-charts-purple` };
    case `opened`:
      return { Icon: Wt, iconClassName: `text-token-charts-green` };
  }
}
function ca(e) {
...
function la({ hostId: e, item: t, repo: n }) {
...
function da() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, Q.jsx)(rt.SectionLabel, { children: (0, Q.jsx)(ha, {}) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(_n, {
            icon: (0, Q.jsx)(Ae, { className: `icon-sm shrink-0 text-token-text-tertiary` }),
            label: (0, Q.jsx)(q, {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsxs)(`div`, {
          ...
          children: [
            (0, Q.jsx)(rt.SectionLabel, { children: (0, Q.jsx)(ga, {}) }),
            (0, Q.jsx)(ma, {}),
          ],
        })),
        (e[0] = t))
    ...
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, Q.jsx)(_a, { className: `w-32` }),
            (0, Q.jsx)(_a, { className: `w-11/12` }),
          ],
        })),
        (e[0] = t))
      : (t = e[0]),
...
function ga(e) {
  ...
  t[1] === r
    ? (a = t[2])
    : ((a = r ? (0, Q.jsx)(Ae, { className: `icon-xxs text-token-description-foreground` }) : null),
      (t[1] = r),
      (t[2] = a));
  let o;
  return (
...
function _a(e) {
  ...
  return (
    t[5] !== r || t[6] !== i
      ? ((a = (0, Q.jsx)(`span`, { ...r, "aria-hidden": `true`, className: i })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = a))
      : (a = t[7]),
...
function va(e) {
  let t = (0, Z.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(Ae, { className: `icon-xxs` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
      ...
      : ((i = (0, Q.jsxs)(`div`, {
          ...
          children: [r, (0, Q.jsx)(`span`, { className: `sr-only`, children: n })],
        })),
        (t[1] = n),
        (t[2] = i)),
    i
...
function ba(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Q.jsx)(rt.SectionLabel, { className: `px-0 py-0`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function Ca(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = { merged: !0 }), (t[0] = p))
    : (p = t[0]);
  let [m, h] = (0, za.useState)(p),
    [g, _] = (0, za.useState)(null),
    v;
  t[1] === n
    ? (v = t[2])
    : ((v = cr({ searchQuery: or(n), selectedFilterView: n })), (t[1] = n), (t[2] = v));
  let b = v,
    S = s === `all`,
    C;
  t[3] !== b ||
  ...
  t[8] !== i
    ? ((C = S
        ? { repos: i.map(Ta), searchQuery: b }
        : { cwd: T(r?.cwd ?? `/`), hostId: r?.hostId, repo: r?.repo ?? null, searchQuery: b }),
      (t[3] = b),
      (t[4] = S),
      (t[5] = r?.cwd),
      (t[6] = r?.hostId),
      ...
      (t[9] = C))
    : (C = t[9]);
  let w = S ? i.length > 0 : r != null,
    D;
  t[10] === w
    ? (D = t[11])
    : ((D = { enabled: w, intervalMs: x.THIRTY_SECONDS, staleTime: x.THIRTY_SECONDS }),
      (t[10] = w),
      (t[11] = D));
  let O;
  t[12] !== C || t[13] !== D
    ? ((O = { source: `pull_request_board`, params: C, queryConfig: D }),
      (t[12] = C),
      (t[13] = D),
      (t[14] = O))
    : (O = t[14]);
  let { data: k, isLoading: A } = y(`gh-pr-board`, O),
    j = Ve(E.pullRequestMergeMethod),
    M = k?.status === `success` ? k.items : [],
    ee = ir(M),
    N = ee.find(wa)?.items[0] ?? null,
    P = lr({ items: M, selectedPullRequestNumber: a, selectedPullRequestUrl: o }),
    F = `${s ?? ``}:${n}:${b ?? ``}`,
    I = a != null || o != null;
  (0, za.useEffect)(() => {
    N == null || I || g === F || (_(F), c(N, { replace: !0 }));
  }, [F, g, N, I, c]);
  let L;
  t[15] === d
    ? (L = t[16])
    : ((L = (e) => ({ id: Ia(e.key), title: d.formatMessage(La(e.key)) })),
      (t[15] = d),
      (t[16] = L));
  let R = ee.map(L),
    z = ar(f ?? []),
    B = P == null ? Ua : (z.get(P.headBranch.trim()) ?? Ua),
    te;
    ...
    ? ((ne = (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsx)(`div`, {
            ...
            children: (0, $.jsx)(Ma, { repoOptions: i, selectedRepoKey: s, onSelect: u }),
          }),
        ],
      })),
      (t[18] = u),
  ...
  t[25] === re
    ? (V = t[26])
    : ((V = (0, $.jsx)(ye.Header, { children: re })), (t[25] = re), (t[26] = V));
  let ae = zn,
    H;
  t[27] === d
    ? (H = t[28])
  ...
  let U;
  t[29] !== l || t[30] !== n
    ? ((U = (0, $.jsx)(Aa, { selectedFilterView: n, onSelectFilterView: l })),
      (t[29] = l),
      (t[30] = n),
      (t[31] = U))
    : (U = t[31]);
  let oe =
      k?.status === `error`
        ...
        : A
          ...
          : M.length === 0
            ? (0, $.jsx)(Oa, { isAllReposSelected: S, selectedFilterView: n })
            : ee.map((e) =>
                (0, $.jsx)(
                  ja,
                  {
                    ...
                    column: e,
                    mergeMethod: j ?? `merge`,
                    selectedPullRequestNumber: P?.number ?? a,
                    selectedPullRequestUrl: P?.url ?? o,
                    repo: r?.repo ?? null,
                    showRepo: S,
                    onSelectPullRequest: c,
                    onToggleSection: () => {
    ...
    W;
  return (
    t[32] !== ae || t[33] !== R || t[34] !== H || t[35] !== U || t[36] !== oe
      ? ((W = (0, $.jsx)(ae, {
          ariaLabel: H,
    ...
    (0, $.jsxs)(`div`, {
      ...
      children: [
        (0, $.jsx)(Ea, {
          hostId: P?.hostId ?? r?.hostId,
          item: P,
          relatedThreads: B,
          repo: P?.repo ?? r?.repo ?? null,
          onClose: ie,
        }),
        V,
        W,
...
function Ea(e) {
  ...
  return (
    t[4] !== n || t[5] !== r || t[6] !== o || t[7] !== i || t[8] !== a
      ? ((f = (0, $.jsx)(ye.RightPanelOutlet, {
          children: (0, $.jsx)(Ui, { hostId: n, item: r, relatedThreads: i, repo: a, onClose: o }),
        })),
        (t[4] = n),
        (t[5] = r),
        (t[6] = o),
  ...
  return (
    e[4] !== n || e[5] !== r
      ? ((i = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)($t, { description: n, title: r }),
        })),
        (e[4] = n),
        (e[5] = r),
        (e[6] = i))
...
function Oa(e) {
  let t = (0, Ra.c)(9),
    ...
    a;
  t[0] !== i || t[1] !== n || t[2] !== r
    ? ((a = ka({ intl: i, isAllReposSelected: n, selectedFilterView: r })),
      (t[0] = i),
      (t[1] = n),
      (t[2] = r),
      (t[3] = a))
  ...
  return (
    t[6] !== a || t[7] !== o
      ? ((s = (0, $.jsx)(`div`, {
          className: `flex h-full min-h-full items-center justify-center`,
          children: (0, $.jsx)($t, { description: a, title: o }),
        })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s))
...
function ka({ intl: e, isAllReposSelected: t, selectedFilterView: n }) {
  switch (t ? `all` : n) {
    case `all`:
...
function ja(e) {
  let t = (0, Ra.c)(31),
    ...
    d;
  t[0] === r.key ? (d = t[1]) : ((d = Ia(r.key)), (t[0] = r.key), (t[1] = d));
  let f = d,
    p = !n,
    m = `${f}-items`,
    h = n && `-rotate-90`,
  ...
  t[2] === h
    ? (g = t[3])
    : ((g = tt(`icon-2xs shrink-0 transition-transform`, h)), (t[2] = h), (t[3] = g));
  let _;
  t[4] === g ? (_ = t[5]) : ((_ = (0, $.jsx)(qe, { className: g })), (t[4] = g), (t[5] = _));
  let v;
  t[6] === r.key ? (v = t[7]) : ((v = Fa(r.key)), (t[6] = r.key), (t[7] = v));
  let y;
  ...
  return (
    t[27] !== f || t[28] !== x || t[29] !== b
      ? ((S = (0, $.jsx)(Ln, { id: f, title: b, children: x })),
        (t[27] = f),
        (t[28] = x),
        (t[29] = b),
        (t[30] = S))
...
function Ma(e) {
  ...
  t[3] !== a || t[4] !== o || t[5] !== c?.label
    ? ((l = o ? a.formatMessage(Va.allRepos) : c?.label),
      (t[3] = a),
      (t[4] = o),
      (t[5] = c?.label),
      (t[6] = l))
  ...
  let u = l,
    ...
    p;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(Me, { className: `icon-sm shrink-0` })), (t[7] = p))
    : (p = t[7]);
  let m;
  t[8] === u
    ? (m = t[9])
  ...
  t[10] === h
    ? (g = t[11])
    : ((g = tt(`icon-2xs text-token-input-placeholder-foreground transition-transform`, h)),
      (t[10] = h),
      (t[11] = g));
  let _;
  t[12] === g ? (_ = t[13]) : ((_ = (0, $.jsx)(qe, { className: g })), (t[12] = g), (t[13] = _));
  let v;
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(q, { ...Va.allRepos })), (t[20] = x))
    : (x = t[20]);
  let S;
  t[21] !== b || t[22] !== y
    ? ((S = (0, $.jsx)(rt.Item, { className: y, onClick: b, children: x })),
      (t[21] = b),
      (t[22] = y),
      (t[23] = S))
    : (S = t[23]);
...
function Na(e) {
  let t = (0, Ra.c)(63),
    { item: n, mergeMethod: r, onSelectPullRequest: a, repo: o, selected: s, showRepo: l } = e,
    u = c(i),
    d = Ot(),
    f = g(),
    p = It(),
  ...
  t[0] !== d || t[1] !== f || t[2] !== u
    ? ((h = (e) => {
        e.status === `success` &&
          (f.invalidateQueries({ queryKey: m(`gh-pr-board`) }),
          u
            .get(Je)
            .success(
              d.formatMessage({
    ...
    : (h = t[3]);
  let _;
  t[4] !== n.cwd || t[5] !== n.headBranch || t[6] !== n.hostId || t[7] !== h
    ? ((_ = {
        cwd: n.cwd,
  ...
  let v = Kn(_),
    y;
  t[9] !== n || t[10] !== r || t[11] !== v || t[12] !== o || t[13] !== u
    ? ((y = async (e) => {
        (e.stopPropagation(), er(u, { action: `merge`, item: n, surface: `pull_request_page` }));
        let t = await v.mutateAsync({ cwd: n.cwd, mergeMethod: r, number: n.number, repo: o });
        t.status !== `success` && u.get(Je).danger(t.error);
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = v),
  ...
  let b = y,
    x;
  t[15] !== b || t[16] !== n || t[17] !== v.isPending || t[18] !== p || t[19] !== o
    ? ((x = Pa({
        isMergePending: v.isPending,
  ...
  t[21] !== d || t[22] !== n || t[23] !== u
    ? ((C = {
        ...
        message: Ha.copyUrl,
        onSelect: () => {
          (er(u, { action: `copy_url`, item: n, surface: `pull_request_page` }),
            me(n.url).then(
              () => {
                u.get(Je).success(d.formatMessage(Ha.copyUrlSuccess));
              },
              () => {
                u.get(Je).danger(d.formatMessage(Ha.copyUrlError));
              },
            ));
        },
      }),
  ...
  t[25] !== n || t[26] !== u
    ? ((w = {
        ...
        message: Ha.openInBrowser,
        onSelect: () => {
          (er(u, { action: `open_in_browser`, item: n, surface: `pull_request_page` }),
            We({ href: n.url, initiator: `pull_request_link` }));
        },
      }),
      (t[25] = n),
      (t[26] = u),
    ...
    : (w = t[27]);
  let T;
  t[28] !== C || t[29] !== w ? ((T = [C, w]), (t[28] = C), (t[29] = w), (t[30] = T)) : (T = t[30]);
  let E = T,
    D;
  t[31] === n.state
    ? (D = t[32])
    : ((D = (0, $.jsx)(Jt, { className: `icon-sm shrink-0 translate-y-[2px]`, state: n.state })),
      (t[31] = n.state),
      (t[32] = D));
  let O;
  t[33] !== n || t[34] !== a || t[35] !== u
    ? ((O = () => {
        (Hn(u, { item: n, surface: `pull_request_page` }), a(n));
      }),
      (t[33] = n),
      (t[34] = a),
      (t[35] = u),
  ...
  t[37] !== n.additions || t[38] !== n.deletions
    ? ((k = (0, $.jsx)(nn, { linesAdded: n.additions, linesRemoved: n.deletions })),
      (t[37] = n.additions),
      (t[38] = n.deletions),
      (t[39] = k))
    : (k = t[39]);
  ...
  return (
    t[60] !== E || t[61] !== N
      ? ((P = (0, $.jsx)(re, { items: E, children: N })), (t[60] = E), (t[61] = N), (t[62] = P))
      : (P = t[62]),
    P
  );
}
...
function Ga() {
  let e = (0, Ka.c)(39),
    ...
    s = r.get(`repoKey`),
    c;
  e[0] === r ? (c = e[1]) : ((c = sr(r.get(`view`))), (e[0] = r), (e[1] = c));
  let l = c,
    u;
  e[2] === r ? (u = e[3]) : ((u = r.get(`pullRequestUrl`)), (e[2] = r), (e[3] = u));
  let d = u,
    f;
  e[4] === r ? (f = e[5]) : ((f = ur(r.get(`pullRequestNumber`))), (e[4] = r), (e[5] = f));
  let p = f,
    m = C(ft),
    { isLoading: h } = C(Vt),
    g;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = { params: void 0, source: `pull_requests_page` }), (e[6] = g))
    : (g = e[6]);
  let { data: _, isLoading: v } = o(Ie, g),
    y = nr({ gitOrigins: _?.origins ?? [], workspaceGroups: m }),
    b = s ?? i,
    x = rr({ repoOptions: y, requestedRepoKey: b }),
    S = b === `all` ? `all` : (x?.key ?? null);
  if (h || v) {
    let t;
    return (
  ...
  if (y.length === 0) {
    ...
    return (
      e[12] !== n || e[13] !== r
        ? ((i = (0, qa.jsx)(`div`, {
            className: `flex h-full items-center justify-center`,
            children: (0, qa.jsx)($t, { description: n, title: r }),
          })),
          (e[12] = n),
          (e[13] = r),
          (e[14] = i))
  ...
  let T;
  e[15] !== n || e[16] !== r || e[17] !== S
    ? ((T = (e) => {
        let t = new URLSearchParams(r);
        (S != null && t.set(`repoKey`, S),
          t.set(`view`, e),
    ...
    : (T = e[18]);
  let E;
  e[19] !== n || e[20] !== r || e[21] !== l || e[22] !== S
    ? ((E = (e, t) => {
        let i = new URLSearchParams(r);
        (S != null && i.set(`repoKey`, S),
          i.set(`view`, l),
          e == null
  ...
  return (
    ...
    e[37] !== D
      ? ((O = (0, qa.jsx)(Ca, {
          ...
          repoOption: x,
          repoOptions: y,
          selectedPullRequestNumber: p,
          selectedPullRequestUrl: d,
          selectedRepoKey: S,
...
e(() => {
  ((Ka = _()),
    ...
    Wa(),
    (qa = b()),
    (Ja = lt(`pull-request-board:last-selected-repo-key`, null)));
})();
export { Ga as PullRequestsPage };
