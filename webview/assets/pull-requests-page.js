...
import { An as dt, jn as ft } from "./app-initial~app-main~automations-page.js";
import {
  d as pt,
  f as mt,
  p as ht,
...
import {
  ...
  s as jn,
  t as Mn,
} from "./app-initial~app-main~remote-conversation-page~pull-requests-page~hotkey-window-thread-page~~dag4dvlp.js";
...
function nr({ gitOrigins: e, workspaceGroups: t }) {
  let n = new Map(e.flatMap((e) => (e.originUrl == null ? [] : [[S(e.dir), e.originUrl]]))),
    r = new Map();
  for (let e of t) {
    let t = e.repositoryData?.ownerRepo;
    if (t == null || e.path == null) continue;
    let i = n.get(S(e.path));
    if (i == null) continue;
    let a = E(i);
    if (a == null) continue;
...
function gr(e) {
  ...
  if (t[0] !== n || t[1] !== a || t[2] !== r || t[3] !== i) {
    ...
    ((l = `max-w-[220px]`),
      ...
      t[8] === i
        ? (s = t[9])
        : ((s = (0, Cr.jsx)(Tt.SectionLabel, { children: i })), (t[8] = i), (t[9] = s)),
      (c =
        e.length === 0
          ? (0, Cr.jsx)(Tt.Message, { compact: !0, children: n })
          : (0, Cr.jsx)(`div`, {
    ...
    Ne,
    {
      ...
      children: (0, Cr.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, Cr.jsx)(`span`, { className: mt(Tr, `text-token-foreground`), children: e.label }),
        ],
      }),
    },
    t,
...
function xr(e) {
  switch (e) {
    case `approved`:
      return (0, Cr.jsx)(Ye, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `requested`:
      return (0, Cr.jsx)(me, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `commented`:
      return (0, Cr.jsx)(P, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `changes-requested`:
      return (0, Cr.jsx)(se, { className: `icon-sm shrink-0 text-token-charts-red` });
  }
}
var Sr,
  Cr,
...
function kr(e) {
  ...
  t[28] !== k
    ? ((pe = () => {
        ...
        te.current ? i && jr([ie, V, H], B) : (jr([ie, V, H], B), (te.current = !0));
        let a = () => {
        ...
        if (!E) {
          let { rightWidth: n, boundedLeftRatio: r } = Hr({
            ...
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: o * Ir(U.current),
          });
          U.current = r;
          let i = Vr(W.current > 0 ? W.current : n, o);
          ((W.current = i),
            Kr({
              containerWidth: t,
              handleWidth: 0,
  ...
  t[44] !== O ||
  t[45] !== k
    ? ((me = [P, D, E, K, x, oe, T, G, S, C, I, v, y, w, O, k]),
      (t[30] = P),
      (t[31] = x),
      (t[32] = K),
      (t[33] = D),
    ...
    ? ((ye = (e) => {
        ...
        let r = Pr(n),
          { rightWidth: i, boundedLeftRatio: a } = Hr({
            ...
            minLeftWidth: v,
            minRightWidth: y,
            leftWidth: r * Ir(U.current),
          });
        U.current = a;
        let o = Vr(W.current > 0 ? W.current : i, r);
        ((W.current = o),
          Kr({
            containerWidth: n,
            handleWidth: 0,
  ...
  let Ee = Te,
    ...
    Ae;
  t[115] !== a || t[116] !== ke
    ? ((Ae = mt(`group/split-view relative h-full w-full min-w-0 overflow-hidden`, ke, a)),
      (t[115] = a),
      (t[116] = ke),
      (t[117] = Ae))
    : (Ae = t[117]);
  ...
  let Be = G ? `main-surface z-30 shadow-[-16px_0_32px_rgba(0,0,0,0.28)]` : `z-10`,
    ...
    We;
  t[141] !== s || t[142] !== Be || t[143] !== Ve || t[144] !== Ue
    ? ((We = mt(
  ...
  t[153] !== We || t[154] !== Ke || t[155] !== qe
    ? ((Je = (0, Jr.jsx)(`div`, { ref: H, className: We, style: Ke, children: qe })),
      (t[153] = We),
      (t[154] = Ke),
      (t[155] = qe),
      (t[156] = Je))
    : (Je = t[156]);
  let Ye;
  t[157] !== Ae || t[158] !== Re || t[159] !== ze || t[160] !== Je
    ? ((Ye = (0, Jr.jsxs)(`div`, { ref: R, className: Ae, children: [Re, ze, Je] })),
      (t[157] = Ae),
      (t[158] = Re),
      (t[159] = ze),
      (t[160] = Je),
...
var ai,
  ...
  li = e(() => {
    (st(),
      b(),
      C(),
      (ci = T(lt, `gh-current-user`, (e) => ({ params: { hostId: e }, staleTime: x.ONE_MINUTE }))));
  });
function ui(e) {
  let t = (0, mi.c)(50),
  ...
  t[33] === T
    ? (E = t[34])
    : ((E = (0, Y.jsx)(N, { diffControls: T, showHideWhitespace: !1, showLoadFullFiles: !1 })),
      (t[33] = T),
      (t[34] = E));
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, Y.jsx)(K, { className: `icon-xs` })), (t[38] = k))
    : (k = t[38]);
  let A;
  ...
  let j;
  t[44] !== _ || t[45] !== A
    ? ((j = (0, Y.jsx)(Ne, { tooltipContent: _, delayOpen: !0, children: A })),
      (t[44] = _),
      (t[45] = A),
      (t[46] = j))
    : (j = t[46]);
...
function fi({
  ...
  let d = c(lt),
    ...
    [_, v] = (0, hi.useState)(),
    [b, S] = (0, hi.useState)({}),
    [C, w] = (0, hi.useState)(null),
    [T, E] = (0, hi.useState)(``),
    O = (0, hi.useRef)(new Map()),
    [k, M] = (0, hi.useState)(() => new Set()),
    { data: N } = p(ci, t),
    P = (0, hi.useCallback)((e, t) => {
      let n = Ce(e);
      M((e) => {
    ...
    F = (0, hi.useCallback)(
      (e) => {
        let t = re(e),
          n = O.current.get(t);
        (O.current.delete(t), n != null && P(n, !1));
      },
      [P],
    ),
    R = (0, hi.useCallback)((e) => {
      let t = Ce(e),
        n = e.position.path;
      S((e) => ({ ...e, [n]: (e[n] ?? []).filter((e) => Ce(e) !== t) }));
    }, []),
    z = y(`gh-pr-comment`, {
    ...
    V = B?.status === `success` ? yn(B.unifiedDiff) : [],
    H = V.map((e) => e.metadata.name),
    W = N?.status === `success` ? N.avatarUrl : void 0,
    ae =
      N?.status === `success`
        ? N.login
        : m.formatMessage({
    ...
    oe = T.trim().length === 0 ? H : H.filter((e) => e.includes(T.trim())),
    G = (0, hi.useMemo)(
      () =>
        a == null || a.length === 0 ? void 0 : j({ comments: a, filePaths: H, workspaceRoot: e }),
      [e, H, a],
    );
  function K(e) {
    (v(e), g.current.get(e)?.scrollIntoView({ block: `start` }));
  }
  let se = (0, hi.useCallback)(
      (n) => {
        let i = {
          body: Se(n),
          cwd: e,
        ...
        (O.current.set(re(i), n), P(n, !0), z.mutate(i));
      },
      [e, t, r, z, o, P],
    ),
    ce = (0, hi.useCallback)(
      (e, t) => {
        let n = U({ currentComments: b[e] ?? [], nextComments: t });
        (w(null), S((n) => ({ ...n, [e]: t })));
        for (let e of n) se(e);
      },
      [b, se],
                  ...
                  children: [
                    ...
                    (0, Y.jsx)(`div`, {
                      ...
                      children: (0, Y.jsx)(A, {
                        ...
                        cwd: e,
                        onSelectPath: K,
                        entries: oe.map((e) => ({ displayPath: e, path: e })),
                      }),
                    }),
                  ],
                }),
...
function Si(e) {
  let t = (0, Oi.c)(36),
    ...
    f = n === void 0 ? !1 : n,
    m = d === void 0 ? `pull_request_page` : d,
    h = c(lt),
    _ = at(),
    [v, b] = (0, ki.useState)(``),
    [x, S] = (0, ki.useState)(null),
    C;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = { source: `pull_request_board` }), (t[0] = C))
    : (C = t[0]);
  let w = y(`gh-pr-comment`, C),
    { data: T } = p(ci, r),
    E;
  ...
  t[12] !== D
    ? ((k = async (e) => {
        if ((e.preventDefault(), !D || w.isPending)) return;
        S(null);
        let t = await w
          .mutateAsync({
            body: D,
        ...
        (tr(h, { kind: O ? `reply` : `comment`, surface: m }), b(``), await o().catch(Ci));
      }),
      (t[3] = r),
      (t[4] = O),
      (t[5] = i),
  ...
  let A = k,
    ...
    M;
  t[14] !== _ || t[15] !== j
    ? ((M = Di({ intl: _, user: j })), (t[14] = _), (t[15] = j), (t[16] = M))
    : (M = t[16]);
  let N = M,
    P = O && `w-full`,
    F;
  t[17] === P ? (F = t[18]) : ((F = mt(`flex flex-col gap-2`, P)), (t[17] = P), (t[18] = F));
  let I;
  ...
  t[29] === x
    ...
    : ((z =
        x == null
          ? null
          : (0, Ai.jsx)(`div`, { className: `px-1 text-sm text-token-charts-red`, children: x })),
      (t[29] = x),
      (t[30] = z));
  let B;
  return (
...
function Ti(e) {
  ...
  t[10] === v
    ? (y = t[11])
    : ((y = mt(`flex min-w-0 items-center gap-2`, v)), (t[10] = v), (t[11] = y));
  let b;
  t[12] === s
    ? (b = t[13])
    : ((b = (e) => {
        ...
        c == null
          ...
          : (0, Ai.jsx)(Ne, {
              ...
              children: (0, Ai.jsx)(Pe, {
                ...
                uniform: !0,
                onClick: c,
                children: (0, Ai.jsx)(nt, { className: `icon-xs` }),
              }),
            })),
      (t[21] = d),
      (t[22] = c),
  ...
  t[24] === a
    ? (C = t[25])
    : ((C = a ? null : (0, Ai.jsx)(Vt, { className: `icon-xs` })), (t[24] = a), (t[25] = C));
  let w;
  ...
  let T;
  t[31] !== p || t[32] !== w
    ? ((T = (0, Ai.jsx)(Ne, { delayDuration: 250, tooltipContent: p, children: w })),
      (t[31] = p),
      (t[32] = w),
      (t[33] = T))
    : (T = t[33]);
...
function Mi(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Pi.jsx)(O, { className: `icon-sm shrink-0`, state: r })), (t[0] = r), (t[1] = i));
  let a;
  t[2] === n.title
    ? (a = t[3])
    : ((a = (0, Pi.jsx)(`div`, {
...
function Ii(e) {
  let t = (0, Vi.c)(24),
    { item: n } = e,
    r = f(jn, n.url),
    i = u(r.conversationId$),
    a = u(r.pendingWorktreeId$),
    o = u(r.ciJobsFixed$),
    s = u(r.mergeConflictsResolved$),
    c = u(pe),
    l = c.data,
    d,
    p,
  ...
  if (t[0] !== l?.items || t[1] !== i || t[2] !== a) {
    let e = On({ automations: l?.items ?? [], conversationId: i, includePausedAutomations: !0 });
    d = i == null && a != null;
    let n;
    (t[6] !== i || t[7] !== a
  ...
  let h = p;
  if ((i == null && a == null) || (!d && c.isLoading) || h == null) return null;
  let g;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, X.jsx)(Tt.SectionLabel, {
        children: (0, X.jsx)(q, {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, X.jsx)(sn, { className: `icon-xs shrink-0` })), (t[10] = _))
    : (_ = t[10]);
  let v;
  t[11] === h
    ? (v = t[12])
  ...
  let y;
  t[13] !== o || t[14] !== s
    ? ((y = (0, X.jsx)(Bi, { ciJobsFixed: o, mergeConflictsResolved: s })),
      (t[13] = o),
      (t[14] = s),
      (t[15] = y))
    : (y = t[15]);
...
function Bi(e) {
  ...
  let s;
  t[4] !== i || t[5] !== a
    ? ((s = i && a ? (0, X.jsx)(dt, { className: `shrink-0` }) : null),
      (t[4] = i),
      (t[5] = a),
      (t[6] = s))
    : (s = t[6]);
...
var Vi,
  X,
  Hi = e(() => {
    ((Vi = i()), s(), it(), We(), te(), En(), ft(), rt(), yt(), rn(), An(), $n(), (X = r()));
  });
function Ui(e) {
  let t = (0, Z.c)(104),
    {
    ...
    b;
  t[0] !== n || t[1] !== r || t[2] !== s
    ? ((b = la({ hostId: n, item: r, repo: s })), (t[0] = n), (t[1] = r), (t[2] = s), (t[3] = b))
    : (b = t[3]);
  let S = b,
    C = _ === `code-review`,
    w;
  ...
  t[6] !== S || t[7] !== w
    ? ((T = { source: `pull_request_board`, params: S, queryConfig: w }),
      ...
      (t[8] = T))
    : (T = t[8]);
  let { data: E, refetch: O } = D(`gh-pr-comments`, T),
    A;
  t[9] === E
    ? (A = t[10])
    : ((A = E?.status === `success` ? E.commentAttachments : []), (t[9] = E), (t[10] = A));
  let j = A,
    M;
  t[11] !== m || t[12] !== r || t[13] !== p || t[14] !== f
    ? ((M = function (e) {
        (er(p, { action: `copy_url`, item: r, surface: f }),
  ...
  t[23] !== p ||
  t[24] !== f
    ? ((F = [m, r.isAuthor, r.state, r.url, p, f]),
      (t[19] = m),
      (t[20] = r.isAuthor),
      (t[21] = r.state),
      (t[22] = r.url),
      ...
      (t[25] = F))
    : (F = t[25]),
    o(`copy-working-directory`, P, F));
  let I;
  t[26] === r
    ? (I = t[27])
    : ((I = (0, Q.jsx)(Mi, { item: r, state: r.state })), (t[26] = r), (t[27] = I));
  let L;
  t[28] === r.headBranch
    ? (L = t[29])
    : ((L = (0, Q.jsx)(`span`, { className: `truncate`, children: r.headBranch })),
      (t[28] = r.headBranch),
      (t[29] = L));
  let R;
  ...
  let ee;
  t[36] !== I || t[37] !== B
    ? ((ee = (0, Q.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [I, B] })),
      (t[36] = I),
      (t[37] = B),
      (t[38] = ee))
    : (ee = t[38]);
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = (0, Q.jsx)(k, { className: `icon-xs` })), (t[43] = re))
    : (re = t[43]);
  let ie;
  t[44] !== N || t[45] !== ne
    ? ((ie = (0, Q.jsx)(Pe, {
  ...
  let V;
  t[47] !== te || t[48] !== ie
    ? ((V = (0, Q.jsx)(Ne, { tooltipContent: te, children: ie })),
      (t[47] = te),
      (t[48] = ie),
      (t[49] = V))
    : (V = t[49]);
  ...
  t[52] === m
    ...
    : ((U = m.formatMessage({
      ...
      (t[53] = U));
  let W;
  t[54] !== r || t[55] !== p || t[56] !== f
    ? ((W = (e) => {
        (er(p, { action: `open_in_browser`, item: r, surface: f }),
          kt({ event: e, href: r.url, initiator: `pull_request_link` }));
      }),
      (t[54] = r),
      (t[55] = p),
      (t[56] = f),
  ...
  t[58] === r.url
    ? (ae = t[59])
    : ((ae = (0, Q.jsx)(Ct, { href: r.url, className: `icon-xs` })), (t[58] = r.url), (t[59] = ae));
  let oe;
  t[60] !== U || t[61] !== W || t[62] !== ae
    ? ((oe = (0, Q.jsx)(Pe, {
        "aria-label": U,
        color: `ghost`,
        size: `toolbar`,
  ...
  let G;
  t[64] !== H || t[65] !== oe
    ? ((G = (0, Q.jsx)(Ne, { tooltipContent: H, children: oe })),
      (t[64] = H),
      (t[65] = oe),
      (t[66] = G))
    : (G = t[66]);
  ...
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (0, Q.jsx)(nt, { className: `icon-xs` })), (t[69] = se))
    : (se = t[69]);
  let ce;
  t[70] !== i || t[71] !== K
    ? ((ce = (0, Q.jsx)(Pe, {
    ...
    ? ((fe = (0, Q.jsx)(`div`, {
        ...
        children:
          _ === `code-review`
            ...
            : (0, Q.jsx)(Wi, { hostId: n, item: r, relatedThreads: a, request: S, surface: f }),
      })),
      (t[89] = _),
      (t[90] = n),
      (t[91] = v),
...
function qi(e) {
  ...
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = D(`gh-pr-body`, i),
...
function Ji(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = D(`gh-pr-comments`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(q, {
...
function Yi(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = D(`gh-pr-checks`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(q, {
...
function Xi(e) {
  ...
  let o;
  t[0] !== n || t[1] !== r
    ? ((o = Dn({ checks: n, ciStatus: r })), (t[0] = n), (t[1] = r), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === r ? (s = t[4]) : ((s = Tn(r)), (t[3] = r), (t[4] = s));
  let c = i ? 180 : 0,
    l;
  t[5] === c ? (l = t[6]) : ((l = { rotate: c }), (t[5] = c), (t[6] = l));
  let u;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Q.jsx)(gt, { className: `icon-2xs` })), (t[7] = u))
    : (u = t[7]);
  let d;
  t[8] === l
    ? (d = t[9])
  ...
  t[11] !== i || t[12] !== o || t[13] !== s || t[14] !== d
    ? ((p = (0, Q.jsx)(B, { ariaExpanded: i, icon: o, label: s, trailing: d, onClick: f })),
      (t[11] = i),
      (t[12] = o),
      (t[13] = s),
      (t[14] = d),
  ...
  t[19] === m
    ? (h = t[20])
    : ((h = (0, Q.jsx)(Pt, { initial: !1, children: m })), (t[19] = m), (t[20] = h));
  let g;
  return (
    t[21] !== h || t[22] !== p
...
function Qi(e) {
  ...
  if (c.activityItems.length === 0) {
    ...
    t[11] === g
      ? (e = t[12])
      : ((e = (0, Q.jsx)(Tt.SectionLabel, { children: g })), (t[11] = g), (t[12] = e));
    let n;
    t[13] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, Q.jsx)(Tt.Message, {
          compact: !0,
          children: (0, Q.jsx)(q, {
  ...
  t[16] === g
    ? (_ = t[17])
    : ((_ = (0, Q.jsx)(Tt.SectionLabel, { children: g })), (t[16] = g), (t[17] = _));
  let v;
  if (
  ...
  t[31] === v
    ? (y = t[32])
    : ((y = (0, Q.jsx)(`div`, { className: `flex flex-col gap-3`, children: v })),
      (t[31] = v),
      (t[32] = y));
  let b;
  return (
    t[33] !== _ || t[34] !== y
      ? ((b = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-3`, children: [_, y] })),
        (t[33] = _),
        (t[34] = y),
        (t[35] = b))
      : (b = t[35]),
...
function ea(e) {
  ...
  t[1] === i
    ? (s = t[2])
    : ((s = { source: `pull_request_board`, params: i, queryConfig: o }), (t[1] = i), (t[2] = s));
  let { data: c, error: l, isError: u, isFetching: d, isLoading: f } = D(`gh-pr-body`, s);
...
function na(e) {
  ...
  t[5] === r
    ? (c = t[6])
    : ((c = (0, Q.jsx)(Pe, { color: `ghost`, size: `composerSm`, onClick: r, children: s })),
      (t[5] = r),
      (t[6] = c));
  let l;
  return (
...
function ra(e) {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (d = t[13]);
  let f;
  t[14] === n.createdAt ? (f = t[15]) : ((f = mn(n.createdAt)), (t[14] = n.createdAt), (t[15] = f));
  let p;
  t[16] === n.createdAt
    ? (p = t[17])
    : ((p = (0, Q.jsx)(`span`, {
        className: `inline`,
        children: (0, Q.jsx)(zt, { dateString: n.createdAt }),
      })),
      (t[16] = n.createdAt),
      (t[17] = p));
  let m;
  ...
  let g;
  t[21] !== h || t[22] !== f
    ? ((g = (0, Q.jsx)(Ne, { delayDuration: 250, tooltipContent: f, children: h })),
      (t[21] = h),
      (t[22] = f),
      (t[23] = g))
    : (g = t[23]);
...
function sa(e) {
  switch (e) {
    case `approved`:
      return { Icon: vn, iconClassName: `text-token-charts-green` };
    case `changes_requested`:
      return { Icon: nt, iconClassName: `text-token-charts-red` };
    case `merged`:
      return { Icon: ye, iconClassName: `text-token-charts-purple` };
    case `opened`:
      return { Icon: xe, iconClassName: `text-token-charts-green` };
  }
}
function ca(e) {
...
function da() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, Q.jsx)(Tt.SectionLabel, { children: (0, Q.jsx)(ha, {}) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(B, {
            icon: (0, Q.jsx)(we, { className: `icon-sm shrink-0 text-token-text-tertiary` }),
            label: (0, Q.jsx)(q, {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsxs)(`div`, {
          ...
          children: [
            (0, Q.jsx)(Tt.SectionLabel, { children: (0, Q.jsx)(ga, {}) }),
            (0, Q.jsx)(ma, {}),
          ],
        })),
        (e[0] = t))
...
function ga(e) {
  ...
  t[1] === r
    ? (a = t[2])
    : ((a = r ? (0, Q.jsx)(we, { className: `icon-xxs text-token-description-foreground` }) : null),
      (t[1] = r),
      (t[2] = a));
  let o;
  return (
...
function va(e) {
  let t = (0, Z.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(we, { className: `icon-xxs` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function ba(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Q.jsx)(Tt.SectionLabel, { className: `px-0 py-0`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function Ca(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = { merged: !0 }), (t[0] = p))
    : (p = t[0]);
  let [m, _] = (0, za.useState)(p),
    [v, y] = (0, za.useState)(null),
    b;
  t[1] === n
    ? (b = t[2])
    : ((b = cr({ searchQuery: or(n), selectedFilterView: n })), (t[1] = n), (t[2] = b));
  let S = b,
    C = s === `all`,
    w;
  t[3] !== S ||
  ...
  t[8] !== i
    ? ((w = C
        ...
        : { cwd: g(r?.cwd ?? `/`), hostId: r?.hostId, repo: r?.repo ?? null, searchQuery: S }),
      (t[3] = S),
      (t[4] = C),
      (t[5] = r?.cwd),
      (t[6] = r?.hostId),
  ...
  t[10] === T
    ? (E = t[11])
    : ((E = { enabled: T, intervalMs: x.THIRTY_SECONDS, staleTime: x.THIRTY_SECONDS }),
      (t[10] = T),
      (t[11] = E));
  let O;
  t[12] !== w || t[13] !== E
    ? ((O = { source: `pull_request_board`, params: w, queryConfig: E }),
      (t[12] = w),
      (t[13] = E),
      (t[14] = O))
    : (O = t[14]);
  let { data: k, isLoading: A } = D(`gh-pr-board`, O),
    j = et(h.pullRequestMergeMethod),
    M = k?.status === `success` ? k.items : [],
    N = ir(M),
    P = N.find(wa)?.items[0] ?? null,
    F = lr({ items: M, selectedPullRequestNumber: a, selectedPullRequestUrl: o }),
    I = `${s ?? ``}:${n}:${S ?? ``}`,
    L = a != null || o != null;
  (0, za.useEffect)(() => {
    P == null || L || v === I || (y(I), c(P, { replace: !0 }));
  }, [I, v, P, L, c]);
  let R;
  t[15] === d
    ? (R = t[16])
    : ((R = (e) => ({ id: Ia(e.key), title: d.formatMessage(La(e.key)) })),
      (t[15] = d),
      (t[16] = R));
  let z = N.map(R),
    B = ar(f ?? []),
    ee = F == null ? Ua : (B.get(F.headBranch.trim()) ?? Ua),
    te;
  ...
  t[25] === re
    ? (V = t[26])
    : ((V = (0, $.jsx)(G.Header, { children: re })), (t[25] = re), (t[26] = V));
  let H = zn,
    U;
  t[27] === d
    ? (U = t[28])
  ...
  let ae =
    ...
    oe;
  return (
    t[32] !== H || t[33] !== z || t[34] !== U || t[35] !== W || t[36] !== ae
      ? ((oe = (0, $.jsx)(H, {
          ariaLabel: U,
...
function Ta(e) {
  return { cwd: g(e.cwd), hostId: e.hostId, repo: e.repo };
}
function Ea(e) {
  let t = (0, Ra.c)(10),
  ...
  return (
    e[4] !== n || e[5] !== r
      ? ((i = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(R, { description: n, title: r }),
        })),
        (e[4] = n),
        (e[5] = r),
        (e[6] = i))
...
function Oa(e) {
  ...
  return (
    t[6] !== a || t[7] !== o
      ? ((s = (0, $.jsx)(`div`, {
          className: `flex h-full min-h-full items-center justify-center`,
          children: (0, $.jsx)(R, { description: a, title: o }),
        })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s))
...
function ja(e) {
  ...
  t[2] === h
    ? (g = t[3])
    : ((g = mt(`icon-2xs shrink-0 transition-transform`, h)), (t[2] = h), (t[3] = g));
  let _;
  t[4] === g ? (_ = t[5]) : ((_ = (0, $.jsx)(gt, { className: g })), (t[4] = g), (t[5] = _));
  let v;
...
function Ma(e) {
  ...
  let u = l,
    ...
    p;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(wt, { className: `icon-sm shrink-0` })), (t[7] = p))
    : (p = t[7]);
  let m;
  t[8] === u
    ? (m = t[9])
  ...
  t[10] === h
    ? (g = t[11])
    : ((g = mt(`icon-2xs text-token-input-placeholder-foreground transition-transform`, h)),
      (t[10] = h),
      (t[11] = g));
  let _;
  t[12] === g ? (_ = t[13]) : ((_ = (0, $.jsx)(gt, { className: g })), (t[12] = g), (t[13] = _));
  let v;
  ...
  let S;
  t[21] !== b || t[22] !== y
    ? ((S = (0, $.jsx)(Tt.Item, { className: y, onClick: b, children: x })),
      (t[21] = b),
      (t[22] = y),
      (t[23] = S))
    : (S = t[23]);
  ...
  return (
    t[32] !== d || t[33] !== S || t[34] !== w || t[35] !== v
      ? ((T = (0, $.jsxs)(Et, { onOpenChange: f, open: d, triggerButton: v, children: [S, C, w] })),
        (t[32] = d),
        (t[33] = S),
        (t[34] = w),
        (t[35] = v),
...
function Na(e) {
  ...
  t[0] !== u || t[1] !== d || t[2] !== l
    ? ((p = (e) => {
        e.status === `success` &&
          (d.invalidateQueries({ queryKey: w(`gh-pr-board`) }),
          l
            .get(Qe)
            .success(
              u.formatMessage({
  ...
  let h = Kn(m),
    g;
  t[9] !== n || t[10] !== r || t[11] !== h || t[12] !== a || t[13] !== l
    ? ((g = async (e) => {
        (e.stopPropagation(), er(l, { action: `merge`, item: n, surface: `pull_request_page` }));
        let t = await h.mutateAsync({ cwd: n.cwd, mergeMethod: r, number: n.number, repo: a });
        t.status !== `success` && l.get(Qe).danger(t.error);
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = h),
  ...
  let v = g,
    y;
  t[15] !== v || t[16] !== n || t[17] !== h.isPending || t[18] !== f || t[19] !== a
    ? ((y = Pa({
        isMergePending: h.isPending,
        pullRequestMergeHelperEnabled: f,
        item: n,
        repo: a,
        onMergePullRequest: v,
      })),
      (t[15] = v),
      (t[16] = n),
      (t[17] = h.isPending),
    ...
    ? ((x = {
        ...
        onSelect: () => {
          (er(l, { action: `copy_url`, item: n, surface: `pull_request_page` }),
            qe(n.url).then(
              () => {
                l.get(Qe).success(u.formatMessage(Ha.copyUrlSuccess));
              },
              () => {
                l.get(Qe).danger(u.formatMessage(Ha.copyUrlError));
              },
            ));
        },
      }),
  ...
  t[25] !== n || t[26] !== l
    ? ((S = {
        ...
        onSelect: () => {
          (er(l, { action: `open_in_browser`, item: n, surface: `pull_request_page` }),
            jt({ href: n.url, initiator: `pull_request_link` }));
        },
      }),
      (t[25] = n),
      (t[26] = l),
    ...
    : (S = t[27]);
  let C;
  t[28] !== x || t[29] !== S ? ((C = [x, S]), (t[28] = x), (t[29] = S), (t[30] = C)) : (C = t[30]);
  let T = C,
    E;
  t[31] === n.state
    ? (E = t[32])
    : ((E = (0, $.jsx)(O, { className: `icon-sm shrink-0 translate-y-[2px]`, state: n.state })),
      (t[31] = n.state),
      (t[32] = E));
  let D;
  ...
  t[37] !== n.additions || t[38] !== n.deletions
    ? ((k = (0, $.jsx)(hn, { linesAdded: n.additions, linesRemoved: n.deletions })),
      (t[37] = n.additions),
      (t[38] = n.deletions),
      (t[39] = k))
    : (k = t[39]);
  ...
  return (
    t[60] !== T || t[61] !== P
      ? ((F = (0, $.jsx)(Le, { items: T, children: P })), (t[60] = T), (t[61] = P), (t[62] = F))
      : (F = t[62]),
    F
  );
}
...
function Ga() {
  ...
  let f = l,
    m;
  e[4] === r ? (m = e[5]) : ((m = ur(r.get(`pullRequestNumber`))), (e[4] = r), (e[5] = m));
  let h = m,
    g = u(St),
    { isLoading: _ } = u(Re),
    v;
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (v = e[6]);
  let { data: y, isLoading: b } = p(bt, v),
    x = nr({ gitOrigins: y?.origins ?? [], workspaceGroups: g }),
    S = o ?? i,
    C = rr({ repoOptions: x, requestedRepoKey: S }),
  ...
  if (x.length === 0) {
    ...
    return (
      e[12] !== n || e[13] !== r
        ? ((i = (0, qa.jsx)(`div`, {
            className: `flex h-full items-center justify-center`,
            children: (0, qa.jsx)(R, { description: n, title: r }),
          })),
          (e[12] = n),
          (e[13] = r),
          (e[14] = i))
...
e(() => {
  ((Ka = i()),
    ...
    Wa(),
    (qa = r()),
    (Ja = Dt(`pull-request-board:last-selected-repo-key`, null)));
})();
