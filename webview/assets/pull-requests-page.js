...
import "./isEqual.js";
import { Ar as O, C as k, Lt as A, _n as j, gt as M, jr as N, pt as P } from "./src.js";
import "./react-dom.js";
...
import { t as U } from "./app-shell-0b-x_r3Z.js";
import { t as ee } from "./persisted-atom.js";
import { t as te } from "./bullet-separator.js";
import { t as ne } from "./button-oF-qgtAS.js";
...
import { c as ye } from "./app-server-manager-hooks-D4-J16ZL.js";
...
import { n as Rt, t as zt } from "./sectioned-page.js";
...
function Bn(e) {
  ...
  let {
      ...
      shouldSendPermissionOverrides: y,
    } = we(p),
    { activeMode: x } = Ce(null),
    { serviceTierSettings: S } = Se(null),
    C;
  t[3] !== n || t[4] !== r.cwd
    ? ((C = { hostId: n, workspaceRoot: r.cwd }), (t[3] = n), (t[4] = r.cwd), (t[5] = C))
    : (C = t[5]);
  let { resolvedConfigPath: w } = ct(C),
    T;
  t[6] !== x ||
  t[7] !== h ||
  t[8] !== f ||
  ...
  t[16] !== y
    ? ((T = async (e) => {
        let t = kn({ includeReviewComments: e, item: r, repo: a }),
          ...
          s = {
            ...
            shouldSendPermissionOverrides: y,
            model: null,
            serviceTier: S.serviceTierForRequest,
            reasoningEffort: null,
            collaborationMode: x,
            config: m(o),
          },
    ...
    : (T = t[17]);
  let E;
  t[18] !== r.url || t[19] !== d || t[20] !== i || t[21] !== s
    ? ((E = (e) => {
  ...
  t[26] !== T || t[27] !== E || t[28] !== D
    ? ((k = { mutationFn: T, onSuccess: E, onError: D }),
      (t[26] = T),
      (t[27] = E),
      (t[28] = D),
      (t[29] = k))
  ...
  return (
    t[30] !== g || t[31] !== A
      ? ((j = { ...A, isAgentModePending: g }), (t[30] = g), (t[31] = A), (t[32] = j))
      : (j = t[32]),
    j
  );
}
