...
function nr({ gitOrigins: e, workspaceGroups: t }) {
  let n = new Map(e.flatMap((e) => (e.originUrl == null ? [] : [[w(e.dir), e.originUrl]]))),
    r = new Map();
  for (let e of t) {
    let t = e.repositoryData?.ownerRepo;
    if (t == null || e.path == null) continue;
    let i = n.get(w(e.path));
    if (i == null) continue;
    let a = ce(i);
    if (a == null) continue;
...
function gr(e) {
  ...
  if (t[0] !== n || t[1] !== a || t[2] !== r || t[3] !== i) {
    ...
    ((l = `max-w-[220px]`),
      ...
      t[8] === i
        ? (s = t[9])
        : ((s = (0, Cr.jsx)(Ae.SectionLabel, { children: i })), (t[8] = i), (t[9] = s)),
      (c =
        e.length === 0
          ? (0, Cr.jsx)(Ae.Message, { compact: !0, children: n })
          : (0, Cr.jsx)(`div`, {
    ...
    Ee,
    {
      ...
      children: (0, Cr.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, Cr.jsx)(`span`, { className: l(Tr, `text-token-foreground`), children: e.label }),
        ],
      }),
    },
    t,
...
function xr(e) {
  switch (e) {
    case `approved`:
      return (0, Cr.jsx)(Le, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `requested`:
      return (0, Cr.jsx)(tn, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `commented`:
      return (0, Cr.jsx)(rn, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `changes-requested`:
      return (0, Cr.jsx)(ln, { className: `icon-sm shrink-0 text-token-charts-red` });
  }
}
var Sr,
  Cr,
...
function kr(e) {
  let t = (0, qr.c)(165),
    ...
    P;
  t[0] === u ? (P = t[1]) : ((P = Lr(u)), (t[0] = u), (t[1] = P));
  let ee = N ? Ir(M) : P,
    [F, te] = (0, J.useState)(0),
    [I, L] = (0, J.useState)(!1),
    R = (0, J.useRef)(null),
  ...
  t[2] === te
    ...
    : ((ue = () => {
      ...
      (t[3] = ue));
  let de;
  (t[4] === Symbol.for(`react.memo_cache_sentinel`) ? ((de = []), (t[4] = de)) : (de = t[4]),
    (0, J.useLayoutEffect)(ue, de));
  let fe;
  t[5] === te
    ? (fe = t[6])
    : ((fe = () => {
  ...
  t[28] !== j
    ? ((ge = () => {
        ...
        re.current ? i && jr([V, H, oe], B) : (jr([V, H, oe], B), (re.current = !0));
        let a = () => {
          ((ie.current = t), (ae.current = k));
        };
        if (C > 0 && D && t <= C && !le) {
          (Wr({ containerWidth: t, minRightWidth: x, isOpen: O, node: e, rafRef: z }), a());
          return;
        }
        let o = Pr(t);
        if (!D) {
        ...
        if (!O) {
          ...
          U.current = r;
          let i = Vr(se.current > 0 ? se.current : n, o);
          ((se.current = i),
            Kr({
              containerWidth: t,
              handleWidth: 0,
  ...
  t[44] !== A ||
  t[45] !== j
    ? ((_e = [F, k, O, G, C, le, D, W, w, T, I, b, x, E, A, j]),
      (t[30] = F),
      (t[31] = C),
      (t[32] = G),
      (t[33] = k),
  ...
  t[53] !== L
    ? ((ve = (e) => {
        ...
        W ||
          ...
          (ne.current = t.getBoundingClientRect().left),
          w || _?.(!0),
          T || y?.(!0),
          L(!0));
      }),
  ...
  t[87] !== y
    ? ((Se = (e) => {
        ...
        if (!t || !n) return;
        if (W) {
          Wr({ containerWidth: n, minRightWidth: x, isOpen: !1, node: t, rafRef: z });
          return;
        }
        let r = Pr(n),
        ...
        U.current = a;
        let o = Vr(se.current > 0 ? se.current : i, r);
        ((se.current = o),
          Kr({
            containerWidth: n,
            handleWidth: 0,
  ...
  t[101] !== j
    ? ((Ce = (e) => {
        ...
        if (T || !D) return;
        if ((Mr([V, H, oe], B), y?.(!0), W)) {
          Wr({ containerWidth: n, minRightWidth: x, isOpen: !0, node: t, rafRef: z });
          return;
        }
        let {
          boundedLeftWidth: r,
  ...
  let we = Ce,
    Te;
  t[103] !== K || t[104] !== we || t[105] !== w || t[106] !== T
    ? ((Te = (e) => {
        if (e === `left`) {
          if (w) {
            K(`left`);
  ...
  let Ee = Te,
    De;
  t[108] !== K || t[109] !== k || t[110] !== O || t[111] !== we || t[112] !== I || t[113] !== Ee
    ? ((De = { isLeftOpen: k, isRightOpen: O, isResizing: I, collapse: K, expand: we, toggle: Ee }),
      (t[108] = K),
      (t[109] = k),
      (t[110] = O),
      (t[111] = we),
  ...
  let Oe = De,
    ...
    q;
  t[115] !== a || t[116] !== je
    ? ((q = l(`group/split-view relative h-full w-full min-w-0 overflow-hidden`, je, a)),
      (t[115] = a),
      (t[116] = je),
      (t[117] = q))
    : (q = t[117]);
  ...
  t[121] === Pe
    ? (Fe = t[122])
    : ((Fe = { width: `var(--split-left-width, 100%)`, contain: `strict`, transitionProperty: Pe }),
      (t[121] = Pe),
      (t[122] = Fe));
  let Ie = k ? `visible` : `hidden`,
    Le = `${n}-left`,
    Re;
  t[123] !== r || t[124] !== Ie || t[125] !== Le
    ? ((Re = (0, Jr.jsx)(`div`, {
        className: `h-full min-w-0`,
        children: (0, Jr.jsx)(J.Activity, { mode: Ie, name: Le, children: r }),
      })),
      (t[123] = r),
      (t[124] = Ie),
      (t[125] = Le),
    ...
    : (Re = t[126]);
  let ze;
  t[127] !== Ne || t[128] !== Fe || t[129] !== Re
    ? ((ze = (0, Jr.jsx)(`div`, { ref: V, className: Ne, style: Fe, children: Re })),
      (t[127] = Ne),
      (t[128] = Fe),
      (t[129] = Re),
      (t[130] = ze))
  ...
  t[139] !== I
    ? ((Be =
      ...
      (t[140] = Be))
    : (Be = t[140]);
  let Ve = W ? `main-surface z-30 shadow-[-16px_0_32px_rgba(0,0,0,0.28)]` : `z-10`,
    He = O ? `opacity-100` : `opacity-0`,
    Ue = !O && `pointer-events-none`,
    We;
        ...
        ? (0, Jr.jsx)(`div`, {
            ...
            children: (0, Jr.jsx)(J.Activity, {
              ...
              children: (0, Jr.jsx)(`div`, {
                ...
                style: { transitionDelay: O ? `${ei}ms` : `0ms` },
                children: i,
              }),
            }),
          })
  ...
  t[153] !== We || t[154] !== Ke || t[155] !== qe
    ? ((Je = (0, Jr.jsx)(`div`, { ref: oe, className: We, style: Ke, children: qe })),
      (t[153] = We),
      (t[154] = Ke),
      (t[155] = qe),
      (t[156] = Je))
    : (Je = t[156]);
  let Ye;
  t[157] !== q || t[158] !== ze || t[159] !== Be || t[160] !== Je
    ? ((Ye = (0, Jr.jsxs)(`div`, { ref: R, className: q, children: [ze, Be, Je] })),
      (t[157] = q),
      (t[158] = ze),
      (t[159] = Be),
      (t[160] = Je),
  ...
  return (
    t[162] !== Oe || t[163] !== Ye
      ? ((Xe = (0, Jr.jsx)(ni.Provider, { value: Oe, children: Ye })),
        (t[162] = Oe),
        (t[163] = Ye),
        (t[164] = Xe))
      : (Xe = t[164]),
...
var ai,
  ...
  li = e(() => {
    (r(),
      Te(),
      n(),
      (ci = le(te, `gh-current-user`, (e) => ({
        params: { hostId: e },
        staleTime: ue.ONE_MINUTE,
      }))));
  });
function ui(e) {
  let t = (0, mi.c)(50),
  ...
  t[33] === E
    ? (D = t[34])
    : ((D = (0, Y.jsx)(on, { diffControls: E, showHideWhitespace: !1, showLoadFullFiles: !1 })),
      (t[33] = E),
      (t[34] = D));
  let O = n ? `secondary` : `ghost`,
    k;
  t[35] !== n || t[36] !== r
    ? ((k = () => {
        r(!n);
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, Y.jsx)(tt, { className: `icon-xs` })), (t[38] = A))
    : (A = t[38]);
  let M;
  t[39] !== _ || t[40] !== n || t[41] !== O || t[42] !== k
    ? ((M = (0, Y.jsx)(p, {
        "aria-label": _,
        "aria-pressed": n,
        color: O,
  ...
  let N;
  t[44] !== _ || t[45] !== M
    ? ((N = (0, Y.jsx)(Ee, { tooltipContent: _, delayOpen: !0, children: M })),
      (t[44] = _),
      (t[45] = M),
      (t[46] = N))
    : (N = t[46]);
  ...
  return (
    t[47] !== N || t[48] !== D
      ? ((P = (0, Y.jsxs)(`div`, { className: `flex items-center gap-px`, children: [D, N] })),
        (t[47] = N),
        (t[48] = D),
        (t[49] = P))
      : (P = t[49]),
...
function fi({
  ...
  let l = g(te),
    ...
    d = K(),
    f = T(Ge),
    p = (0, hi.useRef)(new Map()),
    [m, h] = (0, hi.useState)(),
    [_, v] = (0, hi.useState)({}),
    [y, b] = (0, hi.useState)(null),
    [S, w] = (0, hi.useState)(``),
    E = (0, hi.useRef)(new Map()),
    [D, O] = (0, hi.useState)(() => new Set()),
    { data: k } = F(ci, t),
    A = (0, hi.useCallback)((e, t) => {
      let n = C(e);
      O((e) => {
    ...
    j = (0, hi.useCallback)(
      (e) => {
        let t = at(e),
          n = E.current.get(t);
        (E.current.delete(t), n != null && A(n, !1));
      },
      [A],
    ),
    M = (0, hi.useCallback)((e) => {
      let t = C(e),
        n = e.position.path;
      v((e) => ({ ...e, [n]: (e[n] ?? []).filter((e) => C(e) !== t) }));
    }, []),
    N = Ne(`gh-pr-comment`, {
    ...
    { data: P, isLoading: ee } = ge(`gh-pr-diff`, {
      source: `pull_request_board`,
      params: { cwd: e, hostId: t, number: r, repo: o ?? null },
      queryConfig: { refetchOnWindowFocus: !0, staleTime: ue.FIVE_SECONDS },
    }),
    [I] = (0, hi.useState)(() => new yn()),
    L = (0, hi.useCallback)(
      (e) => {
        if (e != null) {
          I.setup(e);
    ...
    z = P?.status === `success` ? gn(P.unifiedDiff) : [],
    B = z.map((e) => e.metadata.name),
    ne = k?.status === `success` ? k.avatarUrl : void 0,
    re =
      k?.status === `success`
        ? k.login
        : d.formatMessage({
    ...
    ie = S.trim().length === 0 ? B : B.filter((e) => e.includes(S.trim())),
    ae = (0, hi.useMemo)(
      () =>
        a == null || a.length === 0 ? void 0 : ct({ comments: a, filePaths: B, workspaceRoot: e }),
      [e, B, a],
    );
  function V(e) {
    (h(e), p.current.get(e)?.scrollIntoView({ block: `start` }));
  }
  let H = (0, hi.useCallback)(
      (n) => {
        let i = {
          body: dt(n),
          cwd: e,
        ...
        (E.current.set(at(i), n), A(n, !0), N.mutate(i));
      },
      [e, t, r, N, o, A],
    ),
    oe = (0, hi.useCallback)(
      (e, t) => {
        let n = lt({ currentComments: _[e] ?? [], nextComments: t });
        (b(null), v((n) => ({ ...n, [e]: t })));
        for (let e of n) H(e);
      },
      [_, H],
                ...
                left: (0, Y.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, Y.jsx)(`div`, {
                      ...
                      children: (0, Y.jsx)(We, {
                        activePath: m,
                        commentCountByPath: ae,
                        cwd: e,
                        onSelectPath: V,
                        entries: ie.map((e) => ({ displayPath: e, path: e })),
                      }),
                    }),
                  ],
                }),
...
function Si(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (S = t[0]);
  let C = Ne(`gh-pr-comment`, S),
    { data: w } = F(ci, r),
    T;
  t[1] === v ? (T = t[2]) : ((T = v.trim()), (t[1] = v), (t[2] = T));
  let E = T,
    D = c != null,
    O;
  t[3] !== r ||
  ...
  t[12] !== E
    ? ((O = async (e) => {
        if ((e.preventDefault(), !E || C.isPending)) return;
        x(null);
        ...
        (tr(h, { kind: D ? `reply` : `comment`, surface: m }), y(``), await o().catch(Ci));
      }),
      (t[3] = r),
      (t[4] = D),
      (t[5] = i),
    ...
    : (O = t[13]);
  let k = O,
    A = w?.status === `success` ? w : void 0,
    j;
  t[14] !== _ || t[15] !== A
    ? ((j = Di({ intl: _, user: A })), (t[14] = _), (t[15] = A), (t[16] = j))
    : (j = t[16]);
  let M = j,
    N = D && `w-full`,
    P;
  t[17] === N ? (P = t[18]) : ((P = l(`flex flex-col gap-2`, N)), (t[17] = N), (t[18] = P));
  let ee;
  ...
  let z;
  return (
    t[31] !== k || t[32] !== L || t[33] !== R || t[34] !== P
      ? ((z = (0, Ai.jsxs)(`form`, { className: P, onSubmit: k, children: [L, R] })),
        (t[31] = k),
        (t[32] = L),
        (t[33] = R),
        (t[34] = P),
...
function Ti(e) {
  ...
  t[10] === b
    ? (x = t[11])
    : ((x = l(`flex min-w-0 items-center gap-2`, b)), (t[10] = b), (t[11] = x));
  let S;
  t[12] === s
    ? (S = t[13])
    : ((S = (e) => {
      ...
      (t[13] = S));
  let C;
  t[14] !== r || t[15] !== i || t[16] !== _ || t[17] !== a || t[18] !== y || t[19] !== S
    ? ((C = (0, Ai.jsx)(`textarea`, {
        "aria-label": _,
        autoFocus: r,
        ...
        c == null
          ...
          : (0, Ai.jsx)(Ee, {
              ...
              children: (0, Ai.jsx)(p, {
                ...
                uniform: !0,
                onClick: c,
                children: (0, Ai.jsx)(k, { className: `icon-xs` }),
              }),
            })),
      (t[21] = f),
      (t[22] = c),
  ...
  t[24] === a
    ? (T = t[25])
    : ((T = a ? null : (0, Ai.jsx)(It, { className: `icon-xs` })), (t[24] = a), (t[25] = T));
  let E;
  t[26] !== a || t[27] !== d || t[28] !== h || t[29] !== T
    ? ((E = (0, Ai.jsx)(p, {
        "aria-label": h,
        color: `primary`,
        disabled: d,
  ...
  let D;
  t[31] !== h || t[32] !== E
    ? ((D = (0, Ai.jsx)(Ee, { delayDuration: 250, tooltipContent: h, children: E })),
      (t[31] = h),
      (t[32] = E),
      (t[33] = D))
    : (D = t[33]);
  let O;
  return (
    t[34] !== n || t[35] !== D || t[36] !== x || t[37] !== C || t[38] !== w
      ? ((O = (0, Ai.jsxs)(`div`, { className: x, children: [n, C, w, D] })),
        (t[34] = n),
        (t[35] = D),
        (t[36] = x),
        (t[37] = C),
...
function Mi(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Pi.jsx)(Wt, { className: `icon-sm shrink-0`, state: r })), (t[0] = r), (t[1] = i));
  let a;
  t[2] === n.title
    ? (a = t[3])
    : ((a = (0, Pi.jsx)(`div`, {
...
function Ii(e) {
  let t = (0, Vi.c)(24),
    { item: n } = e,
    r = N(ht, n.url),
    i = T(r.conversationId$),
    a = T(r.pendingWorktreeId$),
    o = T(r.ciJobsFixed$),
    s = T(r.mergeConflictsResolved$),
    c = T(Sn),
    l = c.data,
    u,
    d,
  ...
  if (t[0] !== l?.items || t[1] !== i || t[2] !== a) {
    ...
    (t[6] !== i || t[7] !== a
      ...
      : (n = t[8]),
      (f = n),
      (d = Li({ automationStatus: e?.status, isTaskStarting: u })),
      (t[0] = l?.items),
      (t[1] = i),
      (t[2] = a),
      (t[3] = u),
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, X.jsx)(Lt, { className: `icon-xs shrink-0` })), (t[10] = h))
    : (h = t[10]);
  let g;
  t[11] === p
    ? (g = t[12])
    : ((g = (0, X.jsxs)(`span`, {
        ...
        children: [
          h,
          (0, X.jsx)(`span`, { className: `truncate`, children: (0, X.jsx)(Ri, { status: p }) }),
        ],
      })),
      (t[11] = p),
      (t[12] = g));
  let _;
  t[13] !== o || t[14] !== s
    ? ((_ = (0, X.jsx)(Bi, { ciJobsFixed: o, mergeConflictsResolved: s })),
      (t[13] = o),
      (t[14] = s),
      (t[15] = _))
    : (_ = t[15]);
  let v;
  t[16] !== g || t[17] !== _
    ? ((v = (0, X.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [g, _] })),
      (t[16] = g),
      (t[17] = _),
      (t[18] = v))
    : (v = t[18]);
  let y;
  t[19] === f ? (y = t[20]) : ((y = (0, X.jsx)(zi, { taskRoute: f })), (t[19] = f), (t[20] = y));
  let b;
  return (
    t[21] !== v || t[22] !== y
      ? ((b = (0, X.jsxs)(`div`, {
...
function Bi(e) {
  ...
  let s;
  t[4] !== i || t[5] !== a
    ? ((s = i && a ? (0, X.jsx)(_t, { className: `shrink-0` }) : null),
      (t[4] = i),
      (t[5] = a),
      (t[6] = s))
    : (s = t[6]);
...
var Vi,
  X,
  Hi = e(() => {
    ((Vi = ke()), a(), be(), we(), Cn(), An(), gt(), P(), W(), kt(), vt(), $n(), (X = u()));
  });
function Ui(e) {
  let t = (0, Z.c)(104),
    {
    ...
    f = g(j),
    m = K(),
    [h, _] = (0, xa.useState)(`pull-request`),
    v = u ? h : `pull-request`,
    [y, b] = (0, xa.useState)(!1),
    x;
  t[0] !== n || t[1] !== r || t[2] !== o
    ? ((x = la({ hostId: n, item: r, repo: o })), (t[0] = n), (t[1] = r), (t[2] = o), (t[3] = x))
    : (x = t[3]);
  let S = x,
    C = v === `code-review`,
    w;
  t[4] === C
    ? (w = t[5])
    : ((w = { enabled: C, intervalMs: ue.ONE_MINUTE, staleTime: ue.ONE_MINUTE }),
      (t[4] = C),
      (t[5] = w));
  let T;
  t[6] !== S || t[7] !== w
    ? ((T = { source: `pull_request_board`, params: S, queryConfig: w }),
      ...
      (t[8] = T))
    : (T = t[8]);
  let { data: E, refetch: D } = ge(`gh-pr-comments`, T),
    O;
  t[9] === E
    ? (O = t[10])
  ...
  let A = O,
    M;
  t[11] !== m || t[12] !== r || t[13] !== f || t[14] !== d
    ? ((M = function (e) {
        (er(f, { action: `copy_url`, item: r, surface: d }),
          Dr({ scope: f, event: e, intl: m, url: r.url }));
      }),
      (t[11] = m),
      (t[12] = r),
      (t[13] = f),
  ...
  t[23] !== f ||
  t[24] !== d
    ? ((ee = [m, r.isAuthor, r.state, r.url, f, d]),
      (t[19] = m),
      (t[20] = r.isAuthor),
      (t[21] = r.state),
      (t[22] = r.url),
      ...
      (t[25] = ee))
    : (ee = t[25]),
    Ie(`copy-working-directory`, P, ee));
  let F;
  t[26] === r
    ? (F = t[27])
  ...
  t[28] === r.headBranch
    ? (te = t[29])
    : ((te = (0, Q.jsx)(`span`, { className: `truncate`, children: r.headBranch })),
      (t[28] = r.headBranch),
      (t[29] = te));
  let I;
  ...
  let z;
  t[36] !== F || t[37] !== R
    ? ((z = (0, Q.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-1`, children: [F, R] })),
      (t[36] = F),
      (t[37] = R),
      (t[38] = z))
    : (z = t[38]);
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = (0, Q.jsx)(Yt, { className: `icon-xs` })), (t[43] = re))
    : (re = t[43]);
  let ie;
  t[44] !== N || t[45] !== ne
    ? ((ie = (0, Q.jsx)(p, {
  ...
  let ae;
  t[47] !== B || t[48] !== ie
    ? ((ae = (0, Q.jsx)(Ee, { tooltipContent: B, children: ie })),
      (t[47] = B),
      (t[48] = ie),
      (t[49] = ae))
    : (ae = t[49]);
  ...
  t[54] !== r || t[55] !== f || t[56] !== d
    ? ((oe = (e) => {
        (er(f, { action: `open_in_browser`, item: r, surface: d }),
          Ue({ event: e, href: r.url, initiator: `pull_request_link` }));
      }),
      (t[54] = r),
      (t[55] = f),
      (t[56] = d),
  ...
  t[58] === r.url
    ? (U = t[59])
    : ((U = (0, Q.jsx)(_e, { href: r.url, className: `icon-xs` })), (t[58] = r.url), (t[59] = U));
  let se;
  t[60] !== H || t[61] !== oe || t[62] !== U
    ? ((se = (0, Q.jsx)(p, {
        "aria-label": H,
        color: `ghost`,
        size: `toolbar`,
  ...
  let ce;
  t[64] !== V || t[65] !== se
    ? ((ce = (0, Q.jsx)(Ee, { tooltipContent: V, children: se })),
      (t[64] = V),
      (t[65] = se),
      (t[66] = ce))
    : (ce = t[66]);
  ...
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = (0, Q.jsx)(k, { className: `icon-xs` })), (t[69] = W))
    : (W = t[69]);
  let G;
  t[70] !== i || t[71] !== le
    ? ((G = (0, Q.jsx)(p, {
    ...
    ? ((pe = u
        ? (0, Q.jsxs)(`div`, {
            className: l(
              ...
              v === `pull-request` ? `border-b border-token-border` : null,
            ),
            children: [
              (0, Q.jsx)(Pn, {
...
function qi(e) {
  let t = (0, Z.c)(16),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = { intervalMs: ue.ONE_MINUTE, staleTime: ue.ONE_MINUTE }), (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = ge(`gh-pr-body`, i),
...
function Ji(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = ge(`gh-pr-comments`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(q, {
...
function Yi(e) {
  ...
  t[1] === n
    ? (i = t[2])
    : ((i = { source: `pull_request_board`, params: n, queryConfig: r }), (t[1] = n), (t[2] = i));
  let { data: a, error: o, isError: s, isFetching: c, isLoading: l } = ge(`gh-pr-checks`, i);
  if (s) {
    let e;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(q, {
...
function Xi(e) {
  ...
  t[0] !== n || t[1] !== r
    ...
    : (o = t[2]);
  let c;
  t[3] === r ? (c = t[4]) : ((c = kn(r)), (t[3] = r), (t[4] = c));
  let l = i ? 180 : 0,
    u;
  t[5] === l ? (u = t[6]) : ((u = { rotate: l }), (t[5] = l), (t[6] = u));
  let d;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(L, { className: `icon-2xs` })), (t[7] = d))
    : (d = t[7]);
  let f;
  t[8] === u
    ? (f = t[9])
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (p = t[10]);
  let m;
  t[11] !== i || t[12] !== o || t[13] !== c || t[14] !== f
    ? ((m = (0, Q.jsx)(Dn, { ariaExpanded: i, icon: o, label: c, trailing: f, onClick: p })),
      (t[11] = i),
      (t[12] = o),
      (t[13] = c),
      (t[14] = f),
  ...
  t[19] === h
    ? (g = t[20])
    : ((g = (0, Q.jsx)(A, { initial: !1, children: h })), (t[19] = h), (t[20] = g));
  let _;
  return (
    t[21] !== g || t[22] !== m
      ? ((_ = (0, Q.jsxs)(`div`, { className: `relative z-10 flex flex-col`, children: [m, g] })),
        (t[21] = g),
        (t[22] = m),
        (t[23] = _))
      : (_ = t[23]),
...
function Qi(e) {
  let t = (0, Z.c)(36),
    ...
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = { intervalMs: ue.ONE_MINUTE, staleTime: ue.ONE_MINUTE }), (t[0] = o))
    : (o = t[0]);
  let s;
  t[1] === i
    ? (s = t[2])
  ...
  if (c.activityItems.length === 0) {
    ...
    t[11] === g
      ? (e = t[12])
      : ((e = (0, Q.jsx)(Ae.SectionLabel, { children: g })), (t[11] = g), (t[12] = e));
    let n;
    t[13] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, Q.jsx)(Ae.Message, {
          compact: !0,
          children: (0, Q.jsx)(q, {
  ...
  t[16] === g
    ? (_ = t[17])
    : ((_ = (0, Q.jsx)(Ae.SectionLabel, { children: g })), (t[16] = g), (t[17] = _));
  let v;
  if (
...
function $i(e) {
  ...
  t[0] !== o || t[1] !== i
    ? ((c = async () => {
        await o.invalidateQueries({ queryKey: H(`gh-pr-comments`, i) });
      }),
      (t[0] = o),
      (t[1] = i),
      (t[2] = c))
...
function ea(e) {
  ...
  t[1] === i
    ? (s = t[2])
    : ((s = { source: `pull_request_board`, params: i, queryConfig: o }), (t[1] = i), (t[2] = s));
  let { data: c, error: l, isError: u, isFetching: d, isLoading: f } = ge(`gh-pr-body`, s);
...
function na(e) {
  ...
  t[5] === r
    ? (c = t[6])
    : ((c = (0, Q.jsx)(p, { color: `ghost`, size: `composerSm`, onClick: r, children: s })),
      (t[5] = r),
      (t[6] = c));
  let l;
  return (
...
function ra(e) {
  ...
  let u;
  t[7] !== o || t[8] !== s
    ? ((u = (0, Q.jsx)(o, { className: s })), (t[7] = o), (t[8] = s), (t[9] = u))
    : (u = t[9]);
  let d;
  t[10] !== a || t[11] !== n
    ? ((d = (0, Q.jsx)(`span`, {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (f = t[13]);
  let p;
  t[14] === n.createdAt ? (p = t[15]) : ((p = Ot(n.createdAt)), (t[14] = n.createdAt), (t[15] = p));
  let m;
  t[16] === n.createdAt
    ? (m = t[17])
    : ((m = (0, Q.jsx)(`span`, {
        className: `inline`,
        children: (0, Q.jsx)(jt, { dateString: n.createdAt }),
      })),
      (t[16] = n.createdAt),
      (t[17] = m));
  let h;
  ...
  let _;
  t[21] !== g || t[22] !== p
    ? ((_ = (0, Q.jsx)(Ee, { delayDuration: 250, tooltipContent: p, children: g })),
      (t[21] = g),
      (t[22] = p),
      (t[23] = _))
    : (_ = t[23]);
  ...
  let y;
  return (
    t[27] !== v || t[28] !== c || t[29] !== u
      ? ((y = (0, Q.jsxs)(`div`, { className: c, children: [u, v] })),
        (t[27] = v),
        (t[28] = c),
        (t[29] = u),
        (t[30] = y))
...
function sa(e) {
  switch (e) {
    ...
    case `changes_requested`:
      return { Icon: k, iconClassName: `text-token-charts-red` };
    case `merged`:
...
function da() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, Q.jsx)(Ae.SectionLabel, { children: (0, Q.jsx)(ha, {}) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(Dn, {
            icon: (0, Q.jsx)(Se, { className: `icon-sm shrink-0 text-token-text-tertiary` }),
            label: (0, Q.jsx)(q, {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsxs)(`div`, {
          ...
          children: [
            (0, Q.jsx)(Ae.SectionLabel, { children: (0, Q.jsx)(ga, {}) }),
            (0, Q.jsx)(ma, {}),
          ],
        })),
        (e[0] = t))
...
function ga(e) {
  ...
  t[1] === r
    ? (a = t[2])
    : ((a = r ? (0, Q.jsx)(Se, { className: `icon-xxs text-token-description-foreground` }) : null),
      (t[1] = r),
      (t[2] = a));
  let o;
  return (
...
function va(e) {
  let t = (0, Z.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(Se, { className: `icon-xxs` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function ba(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Q.jsx)(Ae.SectionLabel, { className: `px-0 py-0`, children: r })),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === n
...
function Ca(e) {
  ...
  t[8] !== i
    ? ((w = C
        ? { repos: i.map(Ta), searchQuery: x }
        : { cwd: f(r?.cwd ?? `/`), hostId: r?.hostId, repo: r?.repo ?? null, searchQuery: x }),
      (t[3] = x),
      (t[4] = C),
      (t[5] = r?.cwd),
      (t[6] = r?.hostId),
  ...
  t[10] === T
    ? (E = t[11])
    : ((E = { enabled: T, intervalMs: ue.THIRTY_SECONDS, staleTime: ue.THIRTY_SECONDS }),
      (t[10] = T),
      (t[11] = E));
  let D;
  t[12] !== w || t[13] !== E
    ? ((D = { source: `pull_request_board`, params: w, queryConfig: E }),
      ...
      (t[14] = D))
    : (D = t[14]);
  let { data: O, isLoading: k } = ge(`gh-pr-board`, D),
    A = _(S.pullRequestMergeMethod),
    j = O?.status === `success` ? O.items : [],
    M = ir(j),
    N = M.find(wa)?.items[0] ?? null,
    P = lr({ items: j, selectedPullRequestNumber: a, selectedPullRequestUrl: o }),
    ee = `${s ?? ``}:${n}:${x ?? ``}`,
    F = a != null || o != null;
  (0, za.useEffect)(() => {
    N == null || F || v === ee || (y(ee), c(N, { replace: !0 }));
  }, [ee, v, N, F, c]);
  let te;
  t[15] === d
    ? (te = t[16])
    : ((te = (e) => ({ id: Ia(e.key), title: d.formatMessage(La(e.key)) })),
      (t[15] = d),
      (t[16] = te));
  let I = M.map(te),
    L = ar(p ?? []),
    R = P == null ? Ua : (L.get(P.headBranch.trim()) ?? Ua),
    z;
  ...
  t[25] === ne
    ? (ie = t[26])
    : ((ie = (0, $.jsx)(Ke.Header, { children: ne })), (t[25] = ne), (t[26] = ie));
  let ae = zn,
    V;
  t[27] === d
    ? (V = t[28])
  ...
  let H;
  t[29] !== l || t[30] !== n
    ? ((H = (0, $.jsx)(Aa, { selectedFilterView: n, onSelectFilterView: l })),
      (t[29] = l),
      (t[30] = n),
      (t[31] = H))
    : (H = t[31]);
  let oe =
    ...
    U;
  return (
    t[32] !== ae || t[33] !== I || t[34] !== V || t[35] !== H || t[36] !== oe
      ? ((U = (0, $.jsx)(ae, {
          ariaLabel: V,
...
function Ta(e) {
  return { cwd: f(e.cwd), hostId: e.hostId, repo: e.repo };
}
function Ea(e) {
  let t = (0, Ra.c)(10),
  ...
  return (
    e[4] !== n || e[5] !== r
      ? ((i = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(fn, { description: n, title: r }),
        })),
        (e[4] = n),
        (e[5] = r),
        (e[6] = i))
...
function Oa(e) {
  ...
  return (
    t[6] !== a || t[7] !== o
      ? ((s = (0, $.jsx)(`div`, {
          className: `flex h-full min-h-full items-center justify-center`,
          children: (0, $.jsx)(fn, { description: a, title: o }),
        })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s))
...
function ja(e) {
  let t = (0, Ra.c)(31),
    ...
    f;
  t[0] === r.key ? (f = t[1]) : ((f = Ia(r.key)), (t[0] = r.key), (t[1] = f));
  let p = f,
    m = !n,
    h = `${p}-items`,
    g = n && `-rotate-90`,
  ...
  t[2] === g
    ? (_ = t[3])
    : ((_ = l(`icon-2xs shrink-0 transition-transform`, g)), (t[2] = g), (t[3] = _));
  let v;
  t[4] === _ ? (v = t[5]) : ((v = (0, $.jsx)(L, { className: _ })), (t[4] = _), (t[5] = v));
  let y;
  t[6] === r.key ? (y = t[7]) : ((y = Fa(r.key)), (t[6] = r.key), (t[7] = y));
  let b;
  t[8] === y ? (b = t[9]) : ((b = (0, $.jsx)(`span`, { children: y })), (t[8] = y), (t[9] = b));
  let x;
  ...
  return (
    t[27] !== p || t[28] !== S || t[29] !== x
      ? ((C = (0, $.jsx)(Ln, { id: p, title: x, children: S })),
        (t[27] = p),
        (t[28] = S),
        (t[29] = x),
        (t[30] = C))
...
function Ma(e) {
  ...
  t[3] !== a || t[4] !== o || t[5] !== c?.label
    ? ((u = o ? a.formatMessage(Va.allRepos) : c?.label),
      (t[3] = a),
      (t[4] = o),
      (t[5] = c?.label),
      (t[6] = u))
  ...
  let d = u,
    ...
    h;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, $.jsx)(De, { className: `icon-sm shrink-0` })), (t[7] = h))
    : (h = t[7]);
  let g;
  t[8] === d
    ? (g = t[9])
    : ((g = (0, $.jsx)(`span`, { className: `max-w-[220px] truncate`, children: d })),
      (t[8] = d),
      (t[9] = g));
  let _ = f && `rotate-180`,
    v;
  t[10] === _
    ? (v = t[11])
    : ((v = l(`icon-2xs text-token-input-placeholder-foreground transition-transform`, _)),
      (t[10] = _),
      (t[11] = v));
  let y;
  t[12] === v ? (y = t[13]) : ((y = (0, $.jsx)(L, { className: v })), (t[12] = v), (t[13] = y));
  let x;
  t[14] !== f || t[15] !== g || t[16] !== y
    ? ((x = (0, $.jsxs)(p, {
        color: `outline`,
        size: `toolbar`,
        "aria-expanded": f,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(q, { ...Va.allRepos })), (t[20] = w))
    : (w = t[20]);
  let T;
  t[21] !== C || t[22] !== S
    ? ((T = (0, $.jsx)(Ae.Item, { className: S, onClick: C, children: w })),
      (t[21] = C),
      (t[22] = S),
      (t[23] = T))
    : (T = t[23]);
  ...
  let O;
  return (
    t[32] !== f || t[33] !== T || t[34] !== D || t[35] !== x
      ? ((O = (0, $.jsxs)(b, { onOpenChange: m, open: f, triggerButton: x, children: [T, E, D] })),
        (t[32] = f),
        (t[33] = T),
        (t[34] = D),
        (t[35] = x),
...
function Na(e) {
  ...
  t[0] !== l || t[1] !== u || t[2] !== c
    ? ((p = (e) => {
        e.status === `success` &&
          (u.invalidateQueries({ queryKey: H(`gh-pr-board`) }),
          c
            .get(Fe)
            .success(
              l.formatMessage({
  ...
  let h = Kn(m),
    _;
  t[9] !== n || t[10] !== r || t[11] !== h || t[12] !== a || t[13] !== c
    ? ((_ = async (e) => {
        (e.stopPropagation(), er(c, { action: `merge`, item: n, surface: `pull_request_page` }));
        let t = await h.mutateAsync({ cwd: n.cwd, mergeMethod: r, number: n.number, repo: a });
        t.status !== `success` && c.get(Fe).danger(t.error);
      }),
      (t[9] = n),
      (t[10] = r),
      (t[11] = h),
  ...
  t[21] !== l || t[22] !== n || t[23] !== c
    ? ((x = {
        ...
        message: Ha.copyUrl,
        onSelect: () => {
          (er(c, { action: `copy_url`, item: n, surface: `pull_request_page` }),
            xn(n.url).then(
              () => {
                c.get(Fe).success(l.formatMessage(Ha.copyUrlSuccess));
              },
              () => {
                c.get(Fe).danger(l.formatMessage(Ha.copyUrlError));
              },
            ));
        },
      }),
  ...
  t[25] !== n || t[26] !== c
    ? ((S = {
        ...
        onSelect: () => {
          (er(c, { action: `open_in_browser`, item: n, surface: `pull_request_page` }),
            d({ href: n.url, initiator: `pull_request_link` }));
        },
      }),
      (t[25] = n),
      (t[26] = c),
  ...
  t[31] === n.state
    ? (T = t[32])
    : ((T = (0, $.jsx)(Wt, { className: `icon-sm shrink-0 translate-y-[2px]`, state: n.state })),
      (t[31] = n.state),
      (t[32] = T));
  let E;
  t[33] !== n || t[34] !== i || t[35] !== c
    ? ((E = () => {
        (Hn(c, { item: n, surface: `pull_request_page` }), i(n));
      }),
      (t[33] = n),
      (t[34] = i),
      (t[35] = c),
  ...
  t[37] !== n.additions || t[38] !== n.deletions
    ? ((D = (0, $.jsx)(wn, { linesAdded: n.additions, linesRemoved: n.deletions })),
      (t[37] = n.additions),
      (t[38] = n.deletions),
      (t[39] = D))
    : (D = t[39]);
  ...
  return (
    t[60] !== w || t[61] !== M
      ? ((N = (0, $.jsx)(yt, { items: w, children: M })), (t[60] = w), (t[61] = M), (t[62] = N))
      : (N = t[62]),
    N
  );
}
...
function Ga() {
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (g = e[6]);
  let { data: _, isLoading: v } = F(h, g),
    y = nr({ gitOrigins: _?.origins ?? [], workspaceGroups: p }),
    b = o ?? i,
  ...
  if (y.length === 0) {
    ...
    return (
      e[12] !== n || e[13] !== r
        ? ((i = (0, qa.jsx)(`div`, {
            className: `flex h-full items-center justify-center`,
            children: (0, qa.jsx)(fn, { description: n, title: r }),
          })),
          (e[12] = n),
          (e[13] = r),
          (e[14] = i))
...
e(() => {
  ((Ka = ke()),
    ...
    Wa(),
    (qa = u()),
    (Ja = pe(`pull-request-board:last-selected-repo-key`, null)));
})();
