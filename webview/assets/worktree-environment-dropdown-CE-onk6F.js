...
function E(e) {
  ...
  if (
    ...
    let e = ee(i),
      c;
    (t[25] === f ? (c = t[26]) : ((c = f ? o(f) : null), (t[25] = f), (t[26] = c)), (F = c));
    let l = i.find((e) => o(e.configPath) === F) ?? null,
      u = !a && !s;
    P = e && E ? i.filter((t) => o(t.configPath) !== o(e.configPath)) : i;
    let d = ie({ isLoading: a, selectedEnvironment: l });
    ((N = te), (I = D), (L = M), (R = S), (z = C));
    let g;
    ...
    t[28] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      : (b = t[28]);
    let w;
    t[29] === n ? (w = t[30]) : ((w = m(`whitespace-nowrap`, n)), (t[29] = n), (t[30] = w));
    let k = r == null ? `secondary` : `sm`,
      A;
    t[31] === T
      ? (A = t[32])
      : ((A = T ? (0, j.jsx)(_, { className: `icon-xs` }) : null), (t[31] = T), (t[32] = A));
    let K = a ? `pending` : `collapsible-chevron`,
      q;
    (t[33] === r ? (q = t[34]) : ((q = m(`max-w-40`, r)), (t[33] = r), (t[34] = q)),
      t[35] !== d || t[36] !== w || t[37] !== k || t[38] !== A || t[39] !== K || t[40] !== q
        ? ((B = (0, j.jsx)(p, {
            tooltipContent: g,
            children: (0, j.jsx)(ne, {
              categoryLabel: b,
      ...
      t[43] !== h || t[44] !== f || t[45] !== u
        ? ((H = u
            ? (0, j.jsx)(y.Item, {
                RightIcon: f == null ? v : void 0,
                onClick: () => {
                  (h(null), M(!1));
                },
                children: (0, j.jsx)(x, {
      ...
      (U =
        E && e
          ? (0, j.jsx)(y.Item, {
              RightIcon: F != null && o(e.configPath) === F ? v : void 0,
              onClick: () => {
                (h(e.configPath), M(!1));
              },
  ...
  t[53] !== f
    ? ((K = a
        ? (0, j.jsx)(`div`, {
            ...
            children: (0, j.jsx)(u, { className: `icon-xxs` }),
          })
        : s
          ? (0, j.jsx)(y.Message, {
              compact: !0,
  ...
  t[64] === Y
    ...
    : ((Z = (0, j.jsx)(y.Section, {
        ...
        children: (0, j.jsx)(y.Item, { LeftIcon: w, onClick: Y, children: X }),
      })),
      (t[64] = Y),
      (t[65] = Z));
  let Q;
...
//# sourceMappingURL=worktree-environment-dropdown-CE-onk6F.js.map
