...
import { n as Pe, t as Fe } from "./app-initial~app-main~select-workspace-page.js";
import {
  a as Ie,
  i as Le,
  n as Re,
...
function Je() {
  let e = (0, X.c)(100),
    ...
    [a, o] = u(Ae),
    s = x(Oe),
    { data: c, isFetching: p } = ve(),
    m = c === void 0 ? [] : c,
    h = Ne(),
    g;
  e[0] === h ? (g = e[1]) : ((g = (e) => !de(e, h)), (e[0] = h), (e[1] = g));
  let y = m.filter(g).map(rt),
    { data: S, isFetching: C } = b(Ce),
    { data: ee, isFetching: w } = l(D, {
      params: { dirs: (0, Z.default)(ut(y), nt).sort(tt) },
    ...
    re;
  e[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((re = []), (e[2] = re)) : (re = e[2]);
  let [ie, N] = (0, Q.useState)(re),
    ae;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((ae = {}), (e[3] = ae)) : (ae = e[3]);
  ...
  let le = ce,
    ue = (0, Q.useRef)(0),
    z = S?.roots,
    fe = z != null && z.length > 0,
    pe = dt({ tasks: y, gitOrigins: ee?.origins, codexHome: E?.codexHome }),
    me = (0, Z.default)([...(z ?? []), ...pe, ...ie], et).sort($e),
    he;
  e[6] === S?.labels
    ? (he = e[7])
    : ((he = (e) => {
    ...
    G =
      H.length > 0 && W.length === H.length
        ...
        : W.length > 0 && W.length < H.length
          ...
          : !1,
    ye;
  (e[10] !== H || e[11] !== t || e[12] !== P || e[13] !== N || e[14] !== F || e[15] !== M
    ? ((ye = (e) => {
        N((t) => (0, Z.default)([...t, e.root], Ze));
        let n = { ...P, [e.root]: !0 };
        F(n);
        let r = H.includes(e.root);
        V(t, ke, {
          action: `toggle_root`,
          selectedWorkspacesCount: lt(n, H) + (r ? 0 : 1),
      ...
      (e[16] = ye))
    : (ye = e[16]),
    T(`workspace-root-option-picked`, ye));
  let be;
  (e[17] !== H.length ||
  e[18] !== t ||
  e[19] !== L ||
  ...
  e[24] !== M
    ? ((be = (e) => {
      ...
      (e[25] = be))
    : (be = e[25]),
    T(`electron-onboarding-skip-workspace-result`, be));
  let xe;
  e[26] !== fe || e[27] !== t || e[28] !== R || e[29] !== M
    ? ((xe = () => {
        (R(null),
          V(t, je, { hasExistingWorkspaces: fe, source: `onboarding_modal`, experimentArm: M }),
          f.dispatchMessage(`electron-pick-workspace-root-option`, { allowMultiple: !1 }));
      }),
      (e[26] = fe),
      (e[27] = t),
      (e[28] = R),
  ...
  e[44] !== M
    ? ((Fe = (e, n) => {
        (R(null), N((t) => (0, Z.default)([...t, e], Xe)));
        let r = { ...P, [e]: n };
        (F(r),
          V(t, ke, {
            action: `toggle_root`,
            checked: n,
            selectedWorkspacesCount: lt(r, H),
            totalWorkspacesCount: H.length,
            experimentArm: M,
          }));
      }),
  ...
  let Le = Fe,
    Re;
  e[46] !== H || e[47] !== t || e[48] !== P || e[49] !== F || e[50] !== R || e[51] !== M
    ? ((Re = (e) => {
        R(null);
        let n = { ...P };
        ...
        (F(n),
          V(t, ke, {
            action: `select_all`,
            checked: e,
            selectedWorkspacesCount: lt(n, H),
            totalWorkspacesCount: H.length,
            experimentArm: M,
          }));
      }),
  ...
  e[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Be = { queryKey: [d, `paths-exist`] }), (e[53] = Be))
    : (Be = e[53]);
  let Ve = _(Be),
    q = p || C || w || O || Ve > 0,
    He = B.length > 0,
  ...
  (e[59] !== q || e[60] !== k || e[61] !== j
    ? ((qe = [q, k, j]), (e[59] = q), (e[60] = k), (e[61] = j), (e[62] = qe))
    : (qe = e[62]),
    (0, Q.useEffect)(J, qe));
  let Je;
  e[63] !== n ||
  ...
  e[70] !== M
    ? ((Je = (e, r) => {
        ...
        let i = e;
        (s(Math.floor(Date.now() / 1e3)),
          a === `workspace` && z != null && (i = (0, Z.default)([...z, ...e], Ye)),
          f.dispatchMessage(`electron-update-workspace-root-options`, { roots: i }),
          o(`auto`),
          (ue.current += 1),
          te.select(t, { path: e[0], projectId: e[0] }),
      ...
      ? ((mt = (0, $.jsx)(Ie, {
          children: Ge
            ...
            : (0, $.jsx)(ot, {
                ...
                availableOptions: B,
                selectedRoots: W,
                selectAllState: G === `indeterminate` ? !1 : G,
...
function rt(e) {
  return { kind: `local`, key: le(e.id), at: e.createdAt, conversation: e };
}
function Y(e) {
  let t = (0, X.c)(7),
...
function at(e) {
  ...
  t[1] !== n || t[2] !== r || t[3] !== s || t[4] !== c
    ? ((u = (0, $.jsx)(A, { className: n, color: r, size: s, onClick: c, children: l })),
      (t[1] = n),
      (t[2] = r),
      (t[3] = s),
      (t[4] = c),
...
function ot(e) {
  ...
  t[2] === n
    ...
    : ((b = n
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              (0, $.jsx)(M, { className: `h-4 w-4 text-token-foreground` }),
              (0, $.jsx)(`span`, {
  ...
  t[12] !== y
    ? ((x = r
        ? (0, $.jsxs)(Re, {
            className: R(n && `pointer-events-none opacity-50`),
...
function ct(e) {
  ...
  let v;
  t[7] !== f || t[8] !== p || t[9] !== _
    ? ((v = { params: f, placeholderData: p, queryConfig: _ }),
      (t[7] = f),
      (t[8] = p),
      (t[9] = _),
      (t[10] = v))
    : (v = t[10]);
  let { data: y } = m(`paths-exist`, v);
  if (!(a || (y?.existingPaths ?? []).some((e) => C(e).replace(/\/+$/, ``) === d))) return null;
  ...
  let S;
  return (
    t[14] !== b || t[15] !== u || t[16] !== r || t[17] !== i || t[18] !== o.label || t[19] !== x
      ? ((S = (0, $.jsx)(Be, {
          checkboxId: b,
          checkboxClassName: Ve,
          checked: i,
...
function dt({ tasks: e, gitOrigins: t, codexHome: r }) {
  let i = ut(e);
  ...
  return (0, Z.default)(
    i
      .map((e) => {
        let t = oe(e, a);
        return !t?.root || !n(t.root, r)
          ? e
          : (a.reduce(
              (e, i) =>
                !t.originUrl || i.originUrl !== t.originUrl || n(i.root, r)
                  ? e
                  : e
...
//# sourceMappingURL=select-workspace-page-DE-vYbKX.js.map
