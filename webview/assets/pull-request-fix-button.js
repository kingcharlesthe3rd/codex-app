...
import { An as n, On as r, kn as i, o as a } from "./persisted-signal.js";
import { t as o } from "./button-DO-oxX3-.js";
import { t as s } from "./tooltip.js";
function c(e, { action: t, item: n, surface: i }) {
  a(e, r, { action: t, surface: i, state: n.state, isAuthor: n.isAuthor });
}
function l(e, { item: t, surface: r }) {
  a(e, n, { surface: r, state: t.state, isAuthor: t.isAuthor });
}
function u(e, { kind: t, surface: n }) {
  a(e, i, { kind: t, surface: n });
}
var d = t(),
  f = e();
function p(e) {
