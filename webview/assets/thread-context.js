...
import { D as t, at as n, g as r, gr as i } from "./app-server-manager-signals.js";
import { i as a, r as o } from "./src-1.js";
    ...
    switch (i.value.routeKind) {
      ...
      case `local-thread`: {
        ...
        return {
          cwd:
            c?.cwd ??
            o({ assignment: s, cwd: e(r, i.value.conversationId) }) ??
            e(f).data?.roots?.[0] ??
            null,
          hostId:
            c?.hostId ??
            ...
            e(n, i.value.conversationId),
        };
      }
      case `remote-thread`:
      case `chatgpt-thread`:
        return { cwd: null, hostId: e(n, null) };
      case `other`:
