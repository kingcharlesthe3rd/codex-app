...
import { E as t, Qn as n, g as r, tt as i } from "./app-server-manager-signals.js";
import { Q as a } from "./setting-storage.js";
import { a as o, c as s, o as c, r as l, s as u, t as d } from "./thread-context-inputs.js";
...
var m = a(f, ({ get: n, scope: a }) => {
    switch (a.value.routeKind) {
      ...
      case `local-thread`: {
        ...
        return {
          cwd: l?.cwd ?? o?.path ?? n(r, a.value.conversationId) ?? n(d).data?.roots?.[0] ?? null,
          hostId:
            l?.hostId ??
            (o == null ? null : e(o)) ??
