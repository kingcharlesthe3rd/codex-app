...
import { n } from "./vscode-api.js";
import { n as r } from "./react.js";
import { i, l as a } from "./lib-1.js";
...
function b(e) {
  ...
  ((0, c.useEffect)(() => {
    ...
    (0, c.useEffect)(() => {
      ...
      if (
        ...
        (v.failedAtMs != null && a - v.failedAtMs < m)
      )
        return;
      let s = !1;
      return (
  ...
  let T = (0, c.useMemo)(
    () =>
      !e || i || p == null || p.rolloutCountWithCompletedTurns < 1 || p.estimatedSavedMs < u
        ? null
        : {
