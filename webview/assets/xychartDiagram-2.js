...
import "./src-4.js";
import { t } from "./band.js";
import { t as n } from "./line-DIsP-Yv_.js";
import "./dist-5.js";
...
import { t as y } from "./chunk-130.js";
var b = (function () {
  var e = r(function (e, t, n, r) {
    ...
    k = {
      ...
      table: [
        ...
        e(t, n, { 4: 2, 7: 4, 6: 9, 3: 10, 5: i, 8: [1, 11], 34: a, 35: o, 36: s }),
        {
          1: [2, 4],
          9: 12,
          10: [1, 13],
  ...
  k = class extends O {
    ...
    recalculateScale() {
      ((this.scale = t()
        ...
        .paddingOuter(0)
        .align(0.5)),
        i.trace(`BandAxis axis final categories, range: `, this.categories, this.getRange()));
    }
    getTickValues() {
...
function j(e, t, n, r) {
  let i = new T(r);
  return C(e) ? new k(t, n, e.categories, e.title, i) : new A(t, n, [e.min, e.max], e.title, i);
}
r(j, `getAxis`);
var M = class {
  constructor(e, t, n, r) {
  ...
  calculateSpace(e) {
    ...
    return (
      t.width <= n &&
        ...
        this.chartData.title &&
        ((this.boundingRect.width = n), (this.boundingRect.height = r), (this.showChartTitle = !0)),
      { width: this.boundingRect.width, height: this.boundingRect.height }
    );
  }
  getDrawableElements() {
    ...
    getDrawableElements() {
      ...
      for (let [t, n] of this.chartData.plots.entries())
        switch (n.type) {
          case `line`:
            {
              let r = new ee(n, this.xAxis, this.yAxis, this.chartConfig.chartOrientation, t);
...
r(K, `setTmpSVGG`);
function q(e) {
  e === `horizontal` ? (I.chartOrientation = `horizontal`) : (I.chartOrientation = `vertical`);
}
r(q, `setOrientation`);
function J(e) {
...
r(J, `setXAxisTitle`);
function Y(e, t) {
  ((R.xAxis = { type: `linear`, title: R.xAxis.title, min: e, max: t }), (B = !0));
}
r(Y, `setXAxisRangeData`);
function X(e) {
  ((R.xAxis = { type: `band`, title: R.xAxis.title, categories: e.map((e) => G(e.text)) }),
    (B = !0));
}
r(X, `setXAxisBand`);
function oe(e) {
...
r(oe, `setYAxisTitle`);
function se(e, t) {
  ((R.yAxis = { type: `linear`, title: R.yAxis.title, min: e, max: t }), (V = !0));
}
...
function ce(e) {
  ...
  R.yAxis = { type: `linear`, title: R.yAxis.title, min: Math.min(r, t), max: Math.max(i, n) };
}
...
function Z(e) {
  ...
  if ((V || ce(e), C(R.xAxis) && (t = R.xAxis.categories.map((t, n) => [t, e[n]])), w(R.xAxis))) {
    let n = R.xAxis.min,
      r = R.xAxis.max,
      i = (r - n) / (e.length - 1),
      a = [];
...
function le(e, t) {
  let n = Z(t);
  (R.plots.push({ type: `line`, strokeFill: Q(P), strokeWidth: 2, data: n }), P++);
}
r(le, `setLineData`);
function $(e, t) {
  let n = Z(t);
...
r($, `setBarData`);
function ue() {
  if (R.plots.length === 0) throw Error(`No Plot to render, please provide a plot with some data`);
            ...
            if (
              ...
              if (c.chartOrientation === `horizontal`) {
                ...
                let a = e.data
                  ...
                  u = r((e) => (n ? e.data.y - 10 : e.data.y + 10), `determineLabelYPosition`);
                t.selectAll(`text`)
                  .data(a)
                  .enter()
                  .append(`text`)
