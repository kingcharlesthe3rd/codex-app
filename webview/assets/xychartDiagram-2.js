...
import { I as r, N as i, k as a } from "./runtime.worker.js";
import {
  B as o,
  C as s,
  E as c,
  ...
  var e = t(function (e, t, n, r) {
    ...
    k = {
      ...
      table: [
        ...
        e(n, r, { 4: 2, 7: 4, 6: 9, 3: 10, 5: i, 8: [1, 11], 34: a, 35: o, 36: s }),
        {
          1: [2, 4],
          9: 12,
          10: [1, 13],
  ...
  k = class extends O {
    ...
    recalculateScale() {
      ((this.scale = r()
        ...
        .paddingOuter(0)
        .align(0.5)),
        e.trace(`BandAxis axis final categories, range: `, this.categories, this.getRange()));
    }
    getTickValues() {
            ...
            if (
              ...
              if (c.chartOrientation === `horizontal`) {
                ...
                let a = 0.7,
                  ...
                  f = t(
                    (e) => (r ? e.data.x + e.data.width + 10 : e.data.x + e.data.width - 10),
                ...
                let a = e.data
                  ...
                  u = t((e) => (r ? e.data.y - 10 : e.data.y + 10), `determineLabelYPosition`);
                n.selectAll(`text`)
                  .data(a)
                  .enter()
                  .append(`text`)
