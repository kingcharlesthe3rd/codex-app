...
import { Dd as x, Od as S } from "./app-initial~app-main~onboarding-page.js";
import { Tt as C, wt as w } from "./app-initial~app-main~automations-page.js";
import {
  h as T,
  m as E,
        ...
        ? (0, R.jsx)(`div`, {
            ...
            children: (0, R.jsx)(c, {
              ...
              children: (0, R.jsx)(m, {
                ...
                onClick: i,
                children: (0, R.jsx)(u, { className: `icon-xs` }),
              }),
            }),
          })
        : null),
...
function P(e) {
  let t = (0, L.c)(18),
    { title: n, mainWindowPath: i, canCollapseToHome: o } = e,
    s = o === void 0 ? !0 : o,
    l = v(),
    u;
  t[0] !== s || t[1] !== l
  ...
  t[6] === i
    ? (p = t[7])
    : ((p = () => {
        a.dispatchMessage(`open-in-main-window`, { path: i });
      }),
      (t[6] = i),
      (t[7] = p));
  let h;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, R.jsx)(w, { className: `icon-sm` })), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== f || t[10] !== p
    ? ((g = (0, R.jsx)(c, {
  ...
  let _;
  t[12] !== u || t[13] !== g
    ? ((_ = (0, R.jsxs)(R.Fragment, { children: [u, g] })), (t[12] = u), (t[13] = g), (t[14] = _))
    : (_ = t[14]);
  let y;
  return (
    t[15] !== _ || t[16] !== n
      ? ((y = (0, R.jsx)(N, { title: n, onDismiss: I, rightActions: _ })),
        (t[15] = _),
        (t[16] = n),
        (t[17] = y))
      : (y = t[17]),
...
function F() {
  o.hotkeyWindowHotkeys?.collapseToHome();
}
function I() {
  o.hotkeyWindowHotkeys?.dismiss();
}
var L,
  R,
  z,
...
function V() {
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, G.jsx)(`div`, { className: `min-h-0 flex-1`, children: (0, G.jsx)(y, {}) })),
      (e[4] = o))
    : (o = e[4]);
  let s;
  return (
...
function H(e) {
  (e.preventDefault(), e.stopPropagation(), o.hotkeyWindowHotkeys?.collapseToHome());
}
var U, W, G;
e(() => {
  ((U = l()), (W = t(b(), 1)), f(), O(), s(), B(), k(), M(), (G = h()));
})();
export { V as HotkeyWindowDetailLayout };
//# sourceMappingURL=hotkey-window-detail-layout-5uR_-jac.js.map
