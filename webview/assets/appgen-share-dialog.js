...
import { ei as s, ii as c, ri as l } from "./thread-context-inputs.js";
...
import { p as y } from "./codex-api-C.js";
import { t as b } from "./use-debounced-value.js";
import { t as x } from "./copy-to-clipboard.js";
import { r as S } from "./modal-controller-state.js";
import { a as C, d as w, i as T, l as E, n as D, r as O, u as k } from "./dialog-layout.js";
import { t as A } from "./sites-color.js";
import { t as j } from "./globe.js";
import { t as M } from "./arrow-up-right-lg.js";
import { t as N } from "./building.js";
import { t as ee } from "./lock.js";
import { n as P } from "./appgen-url-n_yb-0uU.js";
import { t as F } from "./link.js";
import { a as te, i as ne, r as re, t as ie } from "./appgen-access.js";
import {
  a as ae,
  i as I,
  l as L,
...
function fe(e) {
  let t = (0, R.c)(104),
    ...
    { email: m } = v(),
    { data: g } = y(),
    x = g?.structure === `workspace`,
    { data: O, isError: k, isLoading: A } = i(l, r),
    j = i(c, r),
    [M, N] = (0, de.useState)(``),
    ee;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((ee = []), (t[0] = ee)) : (ee = t[0]);
  let [P, F] = (0, de.useState)(ee),
    ie;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((ie = []), (t[1] = ie)) : (ie = t[1]);
  let [I, L] = (0, de.useState)(ie),
    [ce, le] = (0, de.useState)(null),
    ue;
  t[2] === M ? (ue = t[3]) : ((ue = M.trim()), (t[2] = M), (t[3] = ue));
  let fe = ue,
    Se = b(fe, 200),
    { data: we } = oe(x ? M : ``),
    { data: B } = i(s, x ? Se : null),
    Te = Se === fe,
    { data: V } = i(s, x ? `` : null),
    H,
    U,
  ...
  if (
    ...
    ((G = De(B)),
      ...
      (W = H?.allowed_users ?? []),
      (U = H?.allowed_groups ?? []));
    let e = new Set(W.map(ve));
    q = se({
      currentAccountUserId: g?.account_user_id,
      existingAccountUserIds: e,
      selectedAccountUserIds: P.map(_e),
      workspaceUsers: we,
    });
    let n = new Set(U.map(ge));
    J = new Set(K.map(he));
    let r;
    t[20] !== n || t[21] !== I
      ? ((r = (e) => !n.has(e.id) && !I.some((t) => t.id === e.id)),
        (t[20] = n),
        (t[21] = I),
        (t[22] = r))
      : (r = t[22]);
    let i = G.filter(r),
      a;
    (t[23] === u ? (a = t[24]) : ((a = (e) => ke(e, u)), (t[23] = u), (t[24] = a)),
      (Y = [...i.map(a), ...(q?.map(Ae) ?? [])]),
      (t[4] = B),
      (t[5] = V),
      (t[6] = g?.account_user_id),
  ...
  let je = Y,
    Me;
  if (t[25] !== u || t[26] !== I || t[27] !== P) {
    let e;
    (t[29] === u ? (e = t[30]) : ((e = (e) => ke(e, u)), (t[29] = u), (t[30] = e)),
      (Me = [...I.map(e), ...P.map(Ae)]),
      (t[25] = u),
      (t[26] = I),
      (t[27] = P),
    ...
    : ((Pe =
        O == null
          ...
          : (0, z.jsx)(p, {
              ...
              values: { siteTitle: O.title },
            })),
      (t[31] = O),
      (t[32] = Pe));
  let Fe = Pe,
    X = ce ?? H?.access_mode ?? null,
    Z = x && X !== `public`,
    Ie = H != null && X !== H.access_mode,
    Le = Z && Ne.length > 0,
    Re;
  t[33] !== u || t[34] !== d
    ? ((Re = function () {
  ...
  t[47] !== j
    ? ((ze = function () {
        ...
        let e = re({
          accessGroups: G,
          accessMode: X,
          allowedUserEmails: [...W, ...P].map(me),
          canManageInvitees: Z,
          existingGroups: U,
          knownAccessGroups: K,
          selectedGroups: I,
        });
        j.mutateAsync(e).then(
          () => {
            (F([]), L([]), le(null));
          },
          () => {
  ...
  t[51] !== Q || t[52] !== j
    ? ((Ge = function (e) {
        return j.mutateAsync(e).then(pe, (e) => {
          throw (Q(), e);
        });
      }),
      (t[51] = Q),
  ...
  let Ke = Ge,
    qe;
  t[54] !== H || t[55] !== G || t[56] !== K || t[57] !== Ke
    ? ((qe = function (e) {
        if (H == null) return Promise.resolve();
        switch (e.kind) {
          case `user`:
            return Ke(te(H, e.user.account_user_id));
          case `group`:
            return Ke(
              ne({ accessGroups: G, accessPolicy: H, group: e.group, knownAccessGroups: K }),
            );
        }
      }),
      (t[54] = H),
  ...
  let Je = qe,
    Ye;
  t[59] !== O || t[60] !== Je || t[61] !== d
    ? ((Ye = function (e) {
        O != null &&
          S(d, ye, {
            label: e.kind === `group` ? e.group.name : Ce(e.user),
            onConfirm: () => Je(e),
            siteTitle: O.title,
          });
      }),
  ...
  t[66] === Fe
    ...
    : (($e = (0, z.jsxs)(`div`, {
        ...
        children: [
          (0, z.jsx)(w, { className: `sr-only`, children: Fe }),
          (0, z.jsx)(T, { title: Fe, titleClassName: `truncate pr-8` }),
        ],
      })),
      (t[66] = Fe),
      (t[67] = $e));
    ...
    ? ((et = A
        ...
        : k || O == null || H == null
          ...
          : (0, z.jsxs)(z.Fragment, {
              children: [
                (0, z.jsx)(C, {
                  children: (0, z.jsx)(be, { liveUrl: O.current_live_url, title: O.title }),
                }),
                Z
                  ? (0, z.jsx)(C, {
                      children: (0, z.jsx)(ae, {
                        ...
                        options: !Te || B == null || V == null || q == null ? void 0 : je,
                        ...
                        onRemoveOption: (e) => {
                          ...
                          bb173: switch (t.kind) {
                            case `group`:
                              L((e) => e.filter((e) => e.id !== t.group.id));
                              break bb173;
                            case `user`:
                              F((e) =>
                ...
                (0, z.jsx)(xe, {
                  accessPolicy: H,
                  activeAccessGroups: U,
                  activeAccessUsers: W,
                  availableAccessModes: O.available_access_modes,
                  canManageInvitees: Z,
                  isWorkspaceAccount: x,
                  removableAccessGroupIds: J,
                  selectedAccessMode: X,
                  ownerEmail: m,
                  ownerId: g?.account_user_id,
                  onAccessModeChange: We,
      ...
      (t[89] = et))
    : (et = t[89]);
  let tt = A || k || O == null || H == null ? void 0 : O.current_live_url,
    nt;
  t[90] !== X ||
  t[91] !== Be ||
  t[92] !== Ie ||
  ...
  t[95] !== j.isPending
    ...
    : (nt = t[96]);
  let $;
  t[97] !== $e || t[98] !== et || t[99] !== nt
    ? (($ = (0, z.jsxs)(D, { className: `px-4 py-3`, children: [$e, et, nt] })),
      (t[97] = $e),
      (t[98] = et),
      (t[99] = nt),
      (t[100] = $))
...
function ye(e) {
  ...
  let g;
  t[14] !== d || t[15] !== h
    ? ((g = (0, z.jsx)(T, { title: d, titleClassName: `truncate pr-8`, subtitle: h })),
      (t[14] = d),
      (t[15] = h),
      (t[16] = g))
    : (g = t[16]);
  ...
  let v;
  t[18] !== o || t[19] !== r
    ? ((v = (0, z.jsx)(m, { color: `secondary`, disabled: o, onClick: r, children: _ })),
      (t[18] = o),
      (t[19] = r),
      (t[20] = v))
    : (v = t[20]);
  ...
  t[22] === o
    ? (b = t[23])
    : ((b = (0, z.jsx)(m, { color: `danger`, loading: o, type: `submit`, children: y })),
      (t[22] = o),
      (t[23] = b));
  let x;
  t[24] !== b || t[25] !== v
    ? ((x = (0, z.jsx)(C, { children: (0, z.jsxs)(O, { children: [v, b] }) })),
      (t[24] = b),
      (t[25] = v),
      (t[26] = x))
    : (x = t[26]);
...
function be(e) {
  let t = (0, R.c)(12),
    { liveUrl: n, title: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = P(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, z.jsx)(`span`, {
        className: `flex size-10 shrink-0 items-center justify-center`,
        children: (0, z.jsx)(A, { className: `icon-md` }),
      })),
      (t[2] = o))
    : (o = t[2]);
  let s;
  ...
  return (
    t[9] !== s || t[10] !== l
      ? ((u = (0, z.jsxs)(`div`, {
          ...
          children: [
            o,
            (0, z.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-0.5`, children: [s, l] }),
          ],
        })),
        (t[9] = s),
        (t[10] = l),
...
function xe(e) {
  ...
  if (
    ...
    let e = Se({ activeAccessUsers: r, currentAccountUserId: d, currentUserEmail: u }),
    ...
    ((v = t[11]), (y = t[12]), (b = t[13]), (x = t[14]), (S = t[15]), (w = t[16]), (T = t[17]));
  let E;
  ...
  let D;
  t[40] !== y || t[41] !== b || t[42] !== x || t[43] !== E
    ? ((D = (0, z.jsxs)(`div`, { className: y, children: [b, x, E] })),
      (t[40] = y),
      (t[41] = b),
      (t[42] = x),
      (t[43] = E),
  ...
  let O;
  return (
    t[45] !== v || t[46] !== S || t[47] !== w || t[48] !== T || t[49] !== D
      ? ((O = (0, z.jsxs)(v, { className: S, children: [w, T, D] })),
        (t[45] = v),
        (t[46] = S),
        (t[47] = w),
        (t[48] = T),
...
function Se({ activeAccessUsers: e, currentAccountUserId: t, currentUserEmail: n }) {
...
function U(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i) {
    let e = ie({ availableAccessModes: n, currentAccessMode: r, isWorkspaceAccount: i });
    ((s = ue), (c = e.map(G)), (t[0] = n), (t[1] = r), (t[2] = i), (t[3] = s), (t[4] = c));
  } else ((s = t[3]), (c = t[4]));
  let l;
  return (
    t[5] !== s || t[6] !== o || t[7] !== a || t[8] !== c
      ? ((l = (0, z.jsx)(s, { options: c, value: a, renderLabel: W, onChange: o })),
        (t[5] = s),
        (t[6] = o),
        (t[7] = a),
        (t[8] = c),
...
function W(e) {
  return (0, z.jsx)(p, { ...je[e] });
}
function G(e) {
  let { disabled: t, value: n } = e;
  return { disabled: t, Icon: K(n), value: n };
}
function K(e) {
  switch (e) {
    case `admins_only`:
...
function Ee(e) {
  let t = (0, R.c)(35),
    ...
    y;
  t[0] !== s || t[1] !== c
    ? ((y = J({ action: `copyLink`, isSaving: s, liveUrl: c })), (t[0] = s), (t[1] = c), (t[2] = y))
    : (y = t[2]);
  let b = y,
    S;
  t[3] !== s || t[4] !== c
    ? ((S = J({ action: `visit`, isSaving: s, liveUrl: c })), (t[3] = s), (t[4] = c), (t[5] = S))
    : (S = t[5]);
  let w = S,
    T;
  t[6] === d ? (T = t[7]) : ((T = { onClick: d }), (t[6] = d), (t[7] = T));
  let E;
  t[8] === n
    ? (E = t[9])
    : ((E =
  ...
  let D;
  t[10] !== d || t[11] !== E
    ? ((D = { label: E, onClick: d }), (t[10] = d), (t[11] = E), (t[12] = D))
    : (D = t[12]);
  let O;
  t[13] !== T || t[14] !== D
    ? ((O = { invite: T, share: D }), (t[13] = T), (t[14] = D), (t[15] = O))
    : (O = t[15]);
  let k;
  t[16] === l ? (k = t[17]) : ((k = { onClick: l }), (t[16] = l), (t[17] = k));
  let A;
  t[18] !== b || t[19] !== h || t[20] !== s || t[21] !== c || t[22] !== v || t[23] !== w
    ? ((A =
        c === void 0
          ? null
          : (0, z.jsxs)(`div`, {
                ...
                (0, z.jsx)(g, {
                  ...
                  children: (0, z.jsx)(`span`, {
                    ...
                    children: (0, z.jsxs)(m, {
                      ...
                      size: `toolbar`,
                      onClick: () => {
                        c != null && u.dispatchMessage(`open-in-browser`, { url: c });
                      },
                      children: [
...
function q() {}
function J({ action: e, isSaving: t, liveUrl: n }) {
  if (n == null)
    switch (e) {
      case `copyLink`:
        return (0, z.jsx)(p, {
...
function Oe(...e) {
  return {
    tenant_groups: Y(e.flatMap((e) => e?.tenant_groups ?? [])),
    workspace_groups: Y(e.flatMap((e) => e?.workspace_groups ?? [])),
  };
}
function Y(e) {
...
export { fe as t };
//# sourceMappingURL=appgen-share-dialog.js.map
