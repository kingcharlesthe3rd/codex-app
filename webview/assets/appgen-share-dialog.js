...
function ze(e) {
  ...
  let [S, C] = (0, Q.useState)(b),
    T;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((T = []), (t[1] = T)) : (T = t[1]);
  ...
  t[54] !== M || t[55] !== F || t[56] !== I || t[57] !== Ie
    ? ((Le = function (e) {
        ...
        switch (e.kind) {
          ...
          case `group`:
            return Ie(
              Se({ accessGroups: F, accessPolicy: M, group: e.group, knownAccessGroups: I }),
            );
        }
      }),
      (t[54] = M),
                ...
                V
                  ? (0, $.jsx)(k, {
                      children: (0, $.jsx)(Re, {
                        ...
                        options: !le || A == null || j == null || L == null ? void 0 : ve,
...
function Ke(e) {
  ...
  let m;
  t[14] !== d || t[15] !== p
    ? ((m = (0, $.jsx)(de, { title: d, titleClassName: `truncate pr-8`, subtitle: p })),
      (t[14] = d),
      (t[15] = p),
      (t[16] = m))
    : (m = t[16]);
  ...
  let g;
  t[18] !== o || t[19] !== r
    ? ((g = (0, $.jsx)(O, { color: `secondary`, disabled: o, onClick: r, children: h })),
      (t[18] = o),
      (t[19] = r),
      (t[20] = g))
    : (g = t[20]);
  ...
  t[22] === o
    ? (v = t[23])
    : ((v = (0, $.jsx)(O, { color: `danger`, loading: o, type: `submit`, children: _ })),
      (t[22] = o),
      (t[23] = v));
  let y;
  t[24] !== v || t[25] !== g
...
function Ze(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i) {
    let e = xe({ availableAccessModes: n, currentAccessMode: r, isWorkspaceAccount: i });
...
function Qe(e) {
  ...
  let g = h,
    _;
  t[3] !== s || t[4] !== c
    ? ((_ = et({ action: `visit`, isSaving: s, liveUrl: c })), (t[3] = s), (t[4] = c), (t[5] = _))
    : (_ = t[5]);
  let v = _,
    y;
  ...
  let w;
  t[18] !== g || t[19] !== d || t[20] !== s || t[21] !== c || t[22] !== f || t[23] !== v
    ? ((w =
        c === void 0
          ? null
          : (0, $.jsxs)(`div`, {
                  ...
                  children: (0, $.jsx)(`span`, {
                    ...
                    children: (0, $.jsxs)(O, {
                      ...
                      children: [
                        c == null
                          ? null
                          : (0, $.jsx)(T, { className: `icon-xs`, ExternalIcon: Ce, href: c }),
                        (0, $.jsx)(R, {
