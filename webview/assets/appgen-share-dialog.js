...
import { Mi as s, Oi as c, ji as l } from "./app-server-manager-signals.js";
import { f as u } from "./vscode-api.js";
import { c as d, o as f, r as p } from "./lib.js";
...
import { t as k } from "./sites-color.js";
import { t as A } from "./globe.js";
import { t as te } from "./building.js";
import { t as j } from "./arrow-up-right-lg-BG8h--9V.js";
import { t as M } from "./lock.js";
import { t as N } from "./link.js";
import { i as ne, n as re, o as ie, r as ae, s as oe } from "./appgen-url.js";
import {
  a as se,
  i as P,
  l as ce,
...
function he(e) {
  let t = (0, F.c)(99),
    ...
    { email: m } = _(),
    { data: g } = y(),
    { data: x, isError: O, isLoading: ee } = i(l, r),
    k = i(s, r),
    [A, te] = (0, me.useState)(``),
    j;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((j = []), (t[0] = j)) : (j = t[0]);
  let [M, N] = (0, me.useState)(j),
    re;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((re = []), (t[1] = re)) : (re = t[1]);
  let [P, ce] = (0, me.useState)(re),
    [de, fe] = (0, me.useState)(null),
    pe;
  t[2] === A ? (pe = t[3]) : ((pe = A.trim()), (t[2] = A), (t[3] = pe));
  let he = pe,
    Te = b(he, 200),
    { data: De } = le(A),
    { data: L } = i(c, Te),
  ...
  if (
    ...
    W = ue({
      ...
      selectedAccountUserIds: M.map(be),
      workspaceUsers: De,
    });
  ...
  t[46] !== k
    ? ((He = function () {
        ...
        k.mutateAsync({
          access_mode: q,
          allowed_user_emails: ae([...V, ...M].map(_e)),
          ...ne({
            accessGroups: H,
            knownAccessGroups: U,
            existingGroups: B,
  ...
  t[49] !== J || t[50] !== k
    ? ((Ke = function (e) {
        return k.mutateAsync(e).then(ge, (e) => {
          throw (J(), e);
        });
      }),
      (t[49] = J),
  ...
  t[52] !== z || t[53] !== H || t[54] !== U || t[55] !== qe
    ? ((Je = function (e) {
        ...
        switch (e.kind) {
          case `user`:
            return qe(oe(z, e.user.account_user_id));
          case `group`:
            return qe(
  ...
  t[64] === Re
    ...
    : ((X = (0, I.jsxs)(`div`, {
        ...
        children: [
          (0, I.jsx)(w, { className: `sr-only`, children: Re }),
          (0, I.jsx)(T, { title: Re, titleClassName: `truncate pr-8` }),
        ],
      })),
      (t[64] = Re),
      (t[65] = X));
    ...
    ? ((Z = ee
        ...
        : O || x == null || z == null
          ...
          : (0, I.jsxs)(I.Fragment, {
              children: [
                (0, I.jsx)(C, {
                  children: (0, I.jsx)(Ce, { liveUrl: x.current_live_url, title: x.title }),
                }),
                (0, I.jsx)(C, {
                  children: (0, I.jsx)(se, {
                    ...
                    onRemoveOption: (e) => {
                      ...
                      bb143: switch (t.kind) {
                        case `group`:
                          ...
                          break bb143;
                        case `user`:
                          N((e) => e.filter((e) => e.account_user_id !== t.user.account_user_id));
                      }
                    },
                    onSelectOption: (e) => {
                      let { target: t } = e;
      ...
      (t[85] = Z))
    : (Z = t[85]);
  let $e = ee || O || x == null || z == null ? void 0 : x.current_live_url,
    Q;
  t[86] !== Ue || t[87] !== ze || t[88] !== Be || t[89] !== $e || t[90] !== k.isPending
    ? ((Q = (0, I.jsx)(ke, {
  ...
  t[92] !== X || t[93] !== Z || t[94] !== Q
    ? (($ = (0, I.jsxs)(D, { className: `px-4 py-3`, children: [X, Z, Q] })),
      (t[92] = X),
      (t[93] = Z),
      (t[94] = Q),
      (t[95] = $))
...
function Se(e) {
  ...
  let g;
  t[14] !== d || t[15] !== h
    ? ((g = (0, I.jsx)(T, { title: d, titleClassName: `truncate pr-8`, subtitle: h })),
      (t[14] = d),
      (t[15] = h),
      (t[16] = g))
    : (g = t[16]);
  ...
  t[22] === o
    ? (b = t[23])
    : ((b = (0, I.jsx)(m, { color: `danger`, loading: o, type: `submit`, children: y })),
      (t[22] = o),
      (t[23] = b));
  let x;
  t[24] !== b || t[25] !== v
    ? ((x = (0, I.jsx)(C, { children: (0, I.jsxs)(O, { children: [v, b] }) })),
      (t[24] = b),
      (t[25] = v),
      (t[26] = x))
    : (x = t[26]);
...
function Ce(e) {
  let t = (0, F.c)(12),
    { liveUrl: n, title: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = re(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, I.jsx)(`span`, {
        className: `flex size-10 shrink-0 items-center justify-center`,
        children: (0, I.jsx)(k, { className: `icon-md` }),
      })),
      (t[2] = o))
    : (o = t[2]);
  let s;
...
function we(e) {
  ...
  if (
    ...
    (t[21] === p
      ...
      (t[13] = b),
      (t[14] = x));
  } else ((h = t[8]), (g = t[9]), (_ = t[10]), (v = t[11]), (y = t[12]), (b = t[13]), (x = t[14]));
  let S;
  ...
  let w;
  t[32] !== g || t[33] !== _ || t[34] !== v || t[35] !== S
    ? ((w = (0, I.jsxs)(`div`, { className: g, children: [_, v, S] })),
      (t[32] = g),
      (t[33] = _),
      (t[34] = v),
      (t[35] = S),
  ...
  let T;
  return (
    t[37] !== h || t[38] !== y || t[39] !== b || t[40] !== x || t[41] !== w
      ? ((T = (0, I.jsxs)(h, { className: y, children: [b, x, w] })),
        (t[37] = h),
        (t[38] = y),
        (t[39] = b),
        (t[40] = x),
...
function ke(e) {
  let t = (0, F.c)(27),
    ...
    _;
  t[0] !== i || t[1] !== s
    ? ((_ = G({ action: `copyLink`, isSaving: i, liveUrl: s })), (t[0] = i), (t[1] = s), (t[2] = _))
    : (_ = t[2]);
  let y = _,
    b;
  t[3] !== i || t[4] !== s
    ? ((b = G({ action: `visit`, isSaving: i, liveUrl: s })), (t[3] = i), (t[4] = s), (t[5] = b))
    : (b = t[5]);
  let S = b,
    w;
  t[6] === l
    ? (w = t[7])
    : ((w = { invite: { onClick: l }, share: { onClick: l } }), (t[6] = l), (t[7] = w));
  let T;
  t[8] === c ? (T = t[9]) : ((T = { onClick: c }), (t[8] = c), (t[9] = T));
  let E;
  t[10] !== y || t[11] !== p || t[12] !== i || t[13] !== s || t[14] !== h || t[15] !== S
    ? ((E =
        s === void 0
          ? null
          : (0, I.jsxs)(`div`, {
