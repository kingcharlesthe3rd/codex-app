...
import { h as n } from "./vscode-api.js";
import { Lr as r, Mr as i } from "./src-3.js";
import { t as a } from "./marked.esm.js";
var o = Symbol(`rendererSentryEventData`),
  s = null;
function c(e, t) {
...
function p(e) {
  return typeof e != `object` || !e ? null : (e[o] ?? null);
}
var m = new Set([
    `GH`,
    `IA`,
...
function v(e, t, n) {
  ...
  if (r != null) return r;
  let i = e.toLowerCase();
  return h.get(i) ?? (n === `title` ? (t > 0 && g.has(i) ? i : b(i)) : t === 0 ? b(i) : i);
}
function y(e) {
  let t = e.toUpperCase();
  if (m.has(t)) return t;
...
function ne(e) {
  let { path: t, line: n, column: r, endLine: i, endColumn: a } = w(e);
  ...
  if (!o) {
    let e = c.toLowerCase();
    if (e.length > S && !C.has(e)) return !1;
  }
  return !0;
}
function re(e) {
...
function E(e) {
  ...
  try {
    ...
    let n = r(decodeURIComponent(e.pathname));
    return e.host.length === 0 || e.host === `localhost` ? n : `//${e.host}${n}`;
  } catch {
    return null;
  }
}
var ae = `codex-text-link://`,
  D = `data-prompt-link-label`,
  O = `data-prompt-link-href`;
function oe(e) {
  return e.replaceAll(`](${ae}`, `](`);
}
function se(e) {
...
function pe({ fsPath: e, path: t }) {
  let n = e != null && e.length > 0 ? e : t;
  return /[\\/]$/.test(t) && !/[\\/]$/.test(n) ? `${n}/` : n;
}
function me({ href: e, label: t }) {
  if (!(e == null || e.length === 0)) return { [O]: e, [D]: t };
}
function he(e) {
  let t = e.getAttribute(O),
    n = e.getAttribute(D);
  return t == null || t.length === 0 || n == null ? null : le(n, t);
}
function ge(e) {
  return e
    .split(`:`)
...
function Se(e, t = {}) {
  ...
  if (n === ``) return `{}`;
  if (!Ce(n)) throw TypeError(`Unexpected input format`);
  let r = ``;
  xe.reset(n);
  for (let e of xe)
...
var we = /[ \t\v\f\ufeff]+/,
  ...
  Ee = /[.#](?:(?!-?\d)(?:[a-zA-Z0-9\xA0-\uFFFF_-])+)/,
  De = RegExp(`(?<==)(?:true|false)`),
  Oe = RegExp(
...
var M = k.default.states({
  main: {
    WhiteSpace: we,
    AttributeShorthand: Ee,
    BooleanLiteral: {
      match: De,
      value(e) {
        return e === `true`;
    ...
    SingleQuotedValue: { match: ke, value: j, type: () => `StringLiteral` },
    DoubleQuotedLiteral: { match: Ae, value: j, type: () => `StringLiteral` },
    UnquotedLiteral: { match: je, value: j, type: () => `StringLiteral` },
    AttributeName: Te,
    Separator: `=`,
  },
});
function Ne(e) {
  ...
  Object.defineProperties(r, {
    toString: { writable: !1, enumerable: !1, configurable: !1, value: () => Me(r) },
    getTokens: {
      writable: !1,
      enumerable: !1,
      configurable: !1,
      value: () => Array.from(M.reset(e)),
    },
  });
  let i = [];
...
var Pe = k.default.compile({
  spaces: /[\t\v\f\ufeff ]+/,
  name: /[a-zA-Z][\w-]*/,
  attrs: { match: /\{.*\}/, value: (e) => Ne(e.slice(1, -1)) },
...
var P = `__codex_directive_escaped_double_quote__`,
  F = `__codex_directive_escaped_single_quote__`,
  I = `__codex_directive_quoted_backslash__`,
  L = `__codex_directive_quoted_closing_bracket__`,
  R = `__codex_directive_quoted_closing_brace__`,
  Ve = `__codex_directive_`,
  He = [`:::`, `::`],
  Ue = `markdown-directive-tokenizer-failure`,
  We = nt();
function Ge(e, t = Ke(e)) {
  let n = e.includes(`{`) && t ? qe(e) : e;
  return n.includes(`:::`) ? Je(n) : n;
}
function Ke(e) {
  let t = e.indexOf(`:`);
  for (; t !== -1; ) {
...
`,
      ...
      c = s === -1 ? e.length : s,
      l = c > o && e.charCodeAt(c - 1) === 13 ? c - 1 : c,
      u = ot(e, o, l),
      d = e.slice(u, l),
      f = /^(`{3,}|~{3,})/.exec(d)?.[1];
    if (n != null)
      f?.startsWith(n) &&
        f.length >= r &&
        d.slice(f.length).trim().length === 0 &&
        ((n = null), (r = 0));
    else if (f != null && (f[0] !== "`" || !d.slice(f.length).includes("`")))
      ((n = f.charAt(0)), (r = f.length));
    else if (t && ct(e, u, l)) {
      t = !1;
      let n = l < c ? `:::\r` : `:::`;
      e.slice(o, c) !== n && ((i ??= ``), (i += e.slice(a, o)), (i += n), (a = c));
    } else !t && st(e, u) && (t = !0);
    if (s === -1) break;
    o = s + 1;
  }
  return i == null ? e : i + e.slice(a);
}
function z(e) {
  for (let t of e)
    if (
      (ut(t) && Object.assign(t, Ye(t)),
      `tokens` in t && Array.isArray(t.tokens) && z(t.tokens),
      dt(t))
    )
      for (let e of t.items) z(e.tokens);
}
function Ye(e) {
  return {
    type: `codexDirective`,
...
function Ze(e, t) {
  ...
  let n = t;
  for (; e[n] === `:` && n - t < 3; ) n += 1;
  if (!B(e.charCodeAt(n))) return null;
  for (n += 1; V(e.charCodeAt(n)); ) n += 1;
  return e[n] === `[` && ((n = Qe(e, n + 1)), n === -1) ? null : e[n] === `{` ? n : null;
}
function Qe(e, t) {
  let n = t;
  for (; n < e.length; ) {
...
`
    ...
    if (o === `\\` && e[r + 1] === n) {
      ((a += e.slice(i, r)), (a += n === `"` ? P : F), (r += 2), (i = r));
      continue;
    }
    if (o === `\\`) {
      ((a += e.slice(i, r)), (a += I), (r += 1), (i = r));
      continue;
    }
    if (o === `]`) {
      ((a += e.slice(i, r)), (a += L), (r += 1), (i = r));
      continue;
    }
    if (o === `}`) {
      ((a += e.slice(i, r)), (a += R), (r += 1), (i = r));
      continue;
    }
    (o === n && (n = null), (r += 1));
  }
...
function it(e) {
  let t = 0;
  for (; e[t] === `:` && t < 3; ) t += 1;
  if (!B(e.charCodeAt(t))) return `unknown`;
  let n = t + 1;
  for (; V(e.charCodeAt(n)); ) n += 1;
  return e.slice(t, n);
}
function at(e, t) {
  let n = e.indexOf(t);
  for (; n !== -1; ) {
    if (B(e.charCodeAt(n + t.length)) && lt(e, n)) return n;
    n = e.indexOf(t, n + 1);
  }
}
function ot(e, t, n) {
...
function st(e, t) {
  return e.startsWith(`:::`, t) && B(e.charCodeAt(t + 3));
}
function ct(e, t, n) {
...
function V(e) {
  return B(e) || (e >= 48 && e <= 57) || e === 45 || e === 95;
}
var H = {
  breaks: !0,
  gfm: !0,
...
function G(e) {
  let t = e.charCodeAt(0) === 65279 ? 1 : 0,
    n = jt(e, t);
  if (!At(e.slice(t, n))) return null;
  let r = Y(e, n),
    i = r;
  for (; i < e.length; ) {
    let t = jt(e, i);
    if (At(e.slice(i, t))) {
      let n = yt(e.slice(r, i));
      return n.hasMetadataSyntax ? { body: e.slice(Y(e, t)), entries: n.entries } : null;
    }
    i = Y(e, t);
  }
  return null;
...
function yt(e) {
  ...
  for (; i < t.length; ) {
    let e = t[i],
      a = e.trim();
    if (a.length === 0 || a.startsWith(`#`) || Ot(e)) {
      i += 1;
      continue;
    }
    let o = e.indexOf(`:`),
...
function bt(e) {
  return J(e) || e.startsWith(`{`) ? null : e.startsWith(`[`) ? Ct(e) : K(e);
}
function xt(e, t) {
  let n = [],
    r = t,
...
function St(e) {
  let t = e[0];
  return t === `"` || t === `'` ? K(e) : Et(e) ? null : K(e);
}
function K(e) {
  let t = e[0];
  return e.startsWith(`[`) || e.startsWith(`{`) || J(e)
    ? null
    : t === `"` || t === `'`
      ? (q(e, 0, !0)?.value ?? null)
      : e;
...
function Ct(e) {
  let t = [],
    n = 1;
  for (; n < e.length; ) {
    if (((n = Mt(e, n)), e[n] === `]`)) return e.slice(n + 1).trim().length === 0 ? t : null;
    let r = wt(e, n);
...
function wt(e, t) {
  let n = e[t];
  if (n === `"` || n === `'`) return q(e, t, !1);
  if (n === `[` || n === `{`) return null;
  let r = t;
  for (; r < e.length && e[r] !== `,` && e[r] !== `]`; ) r += 1;
  let i = e.slice(t, r).trim();
  return i.length === 0 || Et(i) ? null : { value: i, nextIndex: r };
}
function q(e, t, n) {
  let r = e[t],
    i = ``,
...
function kt(e) {
  return e != null && Ot(e) && e.trim().length > 0;
}
function At(e) {
...
function Pt(e) {
  ...
  for (; t + 1 < e.length; ) {
    let n = zt(e[t]),
      r = Ft(e, t + 1),
      i = r == null ? null : Ft(e, r + 1),
      a = Bt(r == null ? void 0 : e[r]),
      o = zt(i == null ? void 0 : e[i]);
    ...
    if (n != null && a != null && r != null && Rt(n, a)) {
      if (!Lt(n, a)) {
        t += 1;
        continue;
      }
...
function It(e) {
  if ((`tokens` in e && Array.isArray(e.tokens) && X(e.tokens), e.type === `list`))
    for (let t of e.items) X(t.tokens);
}
function Lt(e, t) {
...
function Q(e) {
  for (let t of e) (nn(t) && en(t), `tokens` in t && Array.isArray(t.tokens) && Q(t.tokens));
}
function Zt(e) {
  for (let t = 0; t < e.length; t += 1) {
    let n = e[t];
    if (n == null || (`tokens` in n && Array.isArray(n.tokens) && Zt(n.tokens), !on(n))) continue;
    let r = [...n.tokens],
      i = t + 1,
      a = i;
    for (;;) {
...
function Qt(e) {
  for (let t of e)
    `tokens` in t &&
      ...
      ((t.tokens = t.tokens.flatMap((e) => (rn(e) ? $t(e) : [e]))), Qt(t.tokens));
}
function $t(e) {
  let t = 0,
    n = [];
  for (let r of e.raw.matchAll(Gt)) {
    let i = r.index,
      a = r[1]?.trim() ?? ``,
      o = i == null ? null : i + r[0].length,
      s = o == null ? null : Nt(e.raw, o),
      c = o == null || s == null ? `` : e.raw.slice(o, s).trim().replace(/\\/g, `/`),
      l = E(c);
    if (i == null || a.length === 0 || c.length === 0 || s == null || l == null) continue;
    i > t && n.push($(e.raw.slice(t, i)));
    let u = e.raw.slice(i, s + 1);
    (n.push(
      r[0].startsWith(`!`)
        ? { type: `image`, raw: u, href: l, title: null, text: a }
        : { type: `link`, raw: u, href: l, title: null, text: a, tokens: [$(a)] },
    ),
      (t = s + 1));
  }
  return t === 0 ? [e] : (t < e.raw.length && n.push($(e.raw.slice(t))), n);
}
function $(e) {
  ...
  for (let t of e.items) {
    ...
    (e?.type === `heading` &&
      ...
      (t.tokens[0] = {
        ...
        raw: e.raw,
        text: n,
        tokens: e.tokens == null ? [$(n)] : [$(r), ...e.tokens],
      }),
      t.loose && (t.tokens = t.tokens.map((e) => (rn(e) ? tn(e) : e))),
      Q(t.tokens));
  }
}
function tn(e) {
...
var sn = /^::[a-zA-Z0-9-]+.*$/gm;
function cn(e, t) {
  let r = t?.lineStartNames == null ? e : dn(e, t.lineStartNames);
  if (r == null) return [];
  let i = [];
  return (
    un(qt(r, void 0), i),
    n.debug(`[parseDirectives] directives found`, {
      safe: { directiveCount: i.length, directiveNames: i.map((e) => e.name).join(`,`) },
      sensitive: {},
    }),
    i
  );
...
function un(e, t) {
  for (let n of e)
    (gn(n) && n.name.length > 0 && t.push({ name: n.name, attributes: hn(n.attributes) }),
      `tokens` in n && Array.isArray(n.tokens) && un(n.tokens, t));
}
function dn(e, t) {
  if (t.length === 0 || !fn(e, t)) return null;
  let n = new Set(t),
    r = [],
    i = 0;
  for (; i <= e.length; ) {
...
function mn(e, t, n) {
  ...
  let r = t;
  for (; e[r] === `:` && r - t < 3; ) r += 1;
  if (!_n(e.charCodeAt(r))) return null;
  let i = r + 1;
  for (; i < n && vn(e.charCodeAt(i)); ) i += 1;
...
function vn(e) {
  return _n(e) || (e >= 48 && e <= 57) || e === 45 || e === 95;
}
export {
  l as A,
  ne as C,
