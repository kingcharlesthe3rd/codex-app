...
import { Hr as t, Nr as n } from "./src-2.js";
import {
  C as r,
  Cn as i,
  E as a,
...
import { d as F, n as I } from "./thread-context-inputs.js";
import { n as ce } from "./selectable-remote-connections-signal.js";
import { O as L } from "./sidebar-signals.js";
import { o as R } from "./remote-projects.js";
import { i as le, n as ue } from "./local-task-row-signals-n.js";
import {
  i as de,
  n as fe,
  o as pe,
...
var _e = e(u(), 1),
  ...
  K = O(M, ({ get: e }) => e(ce) ?? []),
  Ce = O(M, ({ get: e }) =>
    (e(ce) ?? []).filter((e) => e.autoConnect).sort((e, t) => e.hostId.localeCompare(t.hostId)),
  ),
  q = O(M, ({ get: e }) => new Set(e(Ce).map((e) => e.hostId))),
  we = O(M, ({ get: e }) => Ve(e).map((e) => e.id)),
  J = k(M, (e, { get: t }) => Ve(t).find((t) => t.id === e) ?? null),
  Te = O(M, ({ get: e }) => {
    let t = e(L),
      n = [l, ...e(q)],
      r = new Set(),
    ...
    for (let a of n)
      for (let n of e(o, a))
        r.has(n) || (e(m, n) ?? (r.add(n), i.push({ conversationId: n, at: Ie(e, n, t) })));
    return i.length === 0
      ? ((H = ye), H)
  ...
  Ee = k(M, (e, { get: t }) => t(G).data?.find((t) => t.id === e) ?? null),
  De = P(M, (e) => {
    let t = null;
    return O(M, ({ get: n }) => {
      let i = n(L),
      ...
      let j = {
        kind: `local`,
        key: g(A.id),
        at: Be(i === `updated_at` ? l : o, o),
        conversation: A,
        isInProgress: Le({ latestTurnStatus: m, resumeState: u, turnCount: d }),
      };
      return t != null &&
        t.key === j.key &&
        t.at === j.at &&
        ...
        (t.conversation.source ?? null) === D &&
        (t.conversation.threadRuntimeStatus ?? null) === ae &&
  ...
  Oe = P(M, (e) => {
    ...
    return O(M, ({ get: n }) => {
      ...
      let i = { kind: `remote`, key: D(r.id), at: ze(r, n(L)), task: r };
  ...
  Y = k(M, (e, { get: t }) => {
    ...
    switch (n?.kind) {
      case `local`:
        return t(t(De, n.conversationId));
      case `remote`:
        return t(t(Oe, n.taskId));
      case `pending-worktree`:
        return t(t(ke, n.pendingWorktreeId));
      case void 0:
        return null;
    }
  }),
  ...
  je = O(M, ({ get: e }) => {
    let t = e(L),
      n = (0, _e.default)(e(G).data ?? be, `id`).map((e) => ({ key: D(e.id), at: ze(e, t) })),
      r = e(Te).map((n) => ({ key: g(n), at: Ie(e, n, t) })),
      i = e(we).flatMap((t) => {
        let n = e(J, t);
...
function Ie(e, t, n) {
  let r = e(v, t),
    i = e(p, t);
  return Be(n === `updated_at` ? i : r, r);
}
function Le({ latestTurnStatus: e, resumeState: t, turnCount: n }) {
...
function Ve(e) {
  return b(e, `pending_worktrees`) ?? ve;
}
...
var Ye = [],
  ...
  Q = [],
  Ze = O(M, ({ get: e }) => [
    ...(b(e, `remote_ssh_connections`) ?? []),
    ...(b(e, `remote_control_connections`) ?? []),
  ]),
  Qe = ae(M, () => ({
  ...
  $e = oe(M, `paths-exist`, (e) => ({
    enabled: e.length > 0,
    params: { hostId: l, paths: e },
  ...
  tt = O(M, ({ get: e }) => {
    let n = e(F).data,
      r = e(et).data?.origins ?? Q,
      i = ft(e);
    return ge(
      [...de(n, r, e(I, void 0).data?.codexHome), ...he(y(e, t.LOCAL_PROJECTS)), ...fe(i, e(K))],
      y(e, t.PROJECT_ORDER),
    );
  }),
  nt = O(M, ({ get: e }) => e(F).data?.roots),
  rt = O(M, ({ get: e }) => e(F).data?.labels ?? {}),
  it = k(M, (e, { get: r }) => {
    let i = r(F),
      a = i.data?.roots,
      o = i.data?.labels ?? {},
    ...
    let g = z(l, c, a, d),
      _ = pe(g, f),
      v = _.map(({ hostId: e, dirs: t }) =>
        r(R, { params: { hostId: e, dirs: t }, source: `sidebar_workspace_task_groups_task_dirs` }),
      ),
      ee = Object.fromEntries(_.map(({ hostId: e }, t) => [e, v[t]?.data?.origins ?? Q])),
      b = Object.fromEntries(
        g.map(({ hostId: e }) => {
          let t = new Map((h[e] ?? Q).map((e) => [n(e.dir), e]));
          return (
            ee[e]?.forEach((e) => {
              t.set(n(e.dir), e);
            }),
      ...
      x = ge(
        [
          ...
          ...he(y(r, t.LOCAL_PROJECTS)),
          ...fe(u, r(K)),
        ],
        y(r, t.PROJECT_ORDER),
      ),
      S = {},
      te = l.some((e) => e.kind === `remote`),
        ...
        l.length === 0
          ...
          : me(
              ...
              r(I, void 0).data?.codexHome,
              {
                ...
                threadWorkspaceRootHints: y(r, t.THREAD_WORKSPACE_ROOT_HINTS),
  ...
  at = k(M, (e, { get: n }) => {
    let r = n(Ze).filter((e) => n(C, e.hostId) === `connected`);
    return Ge(
      Ue({ groups: He({ entries: n(X, e), remoteConnections: n(Ze) }), remoteConnections: r }),
      y(n, t.CONNECTION_GROUP_ORDER),
    );
  }),
  ot = k(M, (e, { get: t }) => pt(e.groupIds, y(t, $(e.organizeMode)), e.organizeMode)),
  st = k(M, (e, { get: t }) => {
    let r = e ?? [],
      i = t($e, r).data;
    return {
      existingWorkspaceRootSet: new Set(
        (i?.existingPaths ?? []).map((e) => n(e).replace(/\/+$/, ``)),
      ),
...
function ct(e, n) {
  ...
  if (r.length === 0 || e.get(w, t.THREAD_WORKSPACE_ROOT_HINTS).isLoading) return;
  let i = { ...y(e.get, t.THREAD_WORKSPACE_ROOT_HINTS) },
    a = !1;
  for (let [e, t] of r) i[e] !== t && ((i[e] = t), (a = !0));
  a && T(e, t.THREAD_WORKSPACE_ROOT_HINTS, i);
}
async function lt(e, t, n, r) {
  if (!mt(n, r)) return;
  let i = ut(t, n, r, y(e.get, $(t)));
  await T(e, $(t), i);
}
function ut(e, t, n, r) {
  let i = pt(t, r, e),
...
function dt(e, t) {
  ...
  let r = n(e.path).replace(/\/+$/, ``);
  return !(
    t.workspaceRootSet.has(e.path) &&
    t.hasPathsExistResult &&
    t.existingWorkspaceRootSet.has(r)
  );
}
function ft(e) {
  let n = y(e, t.REMOTE_PROJECTS) ?? [],
    r = e(q);
  return n.filter((e) => r.has(e.hostId));
}
function $(e) {
  switch (e) {
    case `connection`:
      return t.CONNECTION_GROUP_ORDER;
    case `project`:
      return t.PROJECT_ORDER;
  }
}
function pt(e, t, n) {
