...
import { t as le } from "./request.js";
import { n as N, u as P } from "./thread-context-inputs.js";
import { r as ue } from "./device-connections.js";
import { D as F } from "./sidebar-signals.js";
import { n as de } from "./local-task-row-signals.js";
import {
  i as fe,
  n as pe,
  o as me,
  ...
  t as R,
  u as ge,
} from "./sidebar-project-groups-Bs-6klyU.js";
var _e = e(ae(), 1),
  ve = [],
  ye = [],
  be = [],
  ...
  G = ce(k, () => ({
    ...
    queryFn: async () => {
      try {
        ...
        if (e instanceof oe && (e.status === 401 || e.status === 403 || e.status === 404))
          return [];
        throw e;
      }
    },
  ...
  Ee = O(k, ({ get: e }) => {
    ...
    for (let a of n)
      for (let n of e(u, a))
        r.has(n) || (e(b, n) ?? (r.add(n), i.push({ conversationId: n, at: Le(e, n, t) })));
    return i.length === 0
      ? ((H = xe), H)
  ...
  Ae = M(k, (e) => {
    ...
    return O(k, ({ get: n }) => {
      let r = n(J, e);
      if (r == null) return ((t = null), null);
      let i = { kind: `pending-worktree`, key: p(r.id), at: r.createdAt, pendingWorktree: r };
      return t != null &&
        t.key === i.key &&
        t.at === i.at &&
  ...
  je = D(k, (e, { get: t }) => {
    ...
    switch (n?.kind) {
      case `local`:
        return (t(d, n.conversationId)?.getConversation(n.conversationId) ?? null) == null
          ? null
          : {
              kind: `local`,
              key: n.key,
  ...
  Me = O(k, ({ get: e }) => {
    let t = e(F),
      n = (0, _e.default)(e(G).data ?? Se, `id`).map((e) => ({ key: y(e.id), at: Be(e, t) })),
...
var Ze = [],
  ...
  rt = O(k, ({ get: e }) => {
    ...
    return e(I, {
      params: {
        hostId: t,
        dirs: L([], t, e(P).data?.roots, []).find(({ hostId: e }) => e === t)?.dirs ?? Qe,
      },
  ...
  it = O(k, ({ get: e }) => {
    let t = e(P).data,
      ...
      i = ht(e);
    return ge(
      [...fe(t, r, e(N, void 0).data?.codexHome), ...R(c(e, n.LOCAL_PROJECTS)), ...pe(i, e(K))],
      c(e, n.PROJECT_ORDER),
    );
  }),
  ...
  st = D(k, (e, { get: r }) => {
    ...
    let l = r(T),
      ...
      g = Object.fromEntries(p.map(({ hostId: e }, t) => [e, h[t]?.data?.origins ?? Q]));
    if (h.length > 0 && i.isLoading && h.every((e) => e.isLoading))
      return { ...s, isWorkspaceRootOptionsLoading: !0 };
    let _ = L(u, l, a, f),
      v = me(_, p),
      ee = v.map(({ hostId: e, dirs: t }) =>
        r(I, { params: { hostId: e, dirs: t }, source: `sidebar_workspace_task_groups_task_dirs` }),
      ),
      y = Object.fromEntries(v.map(({ hostId: e }, t) => [e, ee[t]?.data?.origins ?? Q])),
  ...
  ct = D(k, (e, { get: t }) => {
    ...
    return qe(
      Ge({ groups: We({ entries: t(X, e), remoteConnections: t(et) }), remoteConnections: r }),
      c(t, n.CONNECTION_GROUP_ORDER),
    );
  }),
  lt = D(k, (e, { get: t }) => gt(e.groupIds, c(t, $(e.organizeMode)), e.organizeMode)),
  ut = D(k, (e, { get: n }) => {
    let r = e ?? [],
      i = n(nt, r).data;
    return {
...
function dt(e, t) {
  ...
  if (r.length === 0 || e.get(a, n.THREAD_WORKSPACE_ROOT_HINTS).isLoading) return;
