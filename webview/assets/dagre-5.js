...
import "./chunk-4.js";
import { a as l, c as u, i as d, l as f, n as p, t as m, u as h } from "./chunk-99.js";
import { a as g, i as _, n as v, r as y, t as b } from "./chunk-12.js";
function x(t) {
  var n = {
...
var w = new Map(),
      ...
      i.forEach((i) => {
        if (t.children(i).length > 0) A(i, t, n, r);
          ...
          (o.info(`cp `, i, ` to `, r, ` with parent `, e),
            n.setNode(i, a),
            r !== t.parent(i) &&
              (o.warn(`Setting parent`, i, t.parent(i)), n.setParent(i, t.parent(i))),
            e !== r && i !== e
  ...
  F = a((e, t) => {
    ...
    (e.nodes().forEach(function (t) {
      e.children(t).length > 0 &&
        (o.warn(`Cluster identified`, t, ` Replacement id in edges: `, N(t, e, t)),
        T.set(t, j(t, e)),
    ...
    (e.edges().forEach(function (t) {
      ...
      (o.warn(`Edge ` + t.v + ` -> ` + t.w + `: ` + JSON.stringify(t)),
        o.warn(`Edge ` + t.v + ` -> ` + t.w + `: ` + JSON.stringify(e.edge(t))));
      let r = t.v,
        i = t.w;
      if (
        (o.warn(`Fix XXX`, w, `ids:`, t.v, t.w, `Translating: `, w.get(t.v), ` --- `, w.get(t.w)),
        w.get(t.v) || w.get(t.w))
      ) {
        if (
    ...
    for (let r of n)
      if (
        ...
        w.get(r)?.clusterData?.dir &&
          ((n = w.get(r).clusterData.dir), o.warn(`Fixing dir`, w.get(r).clusterData.dir, n));
  ...
  z = a(async (e, t, r, i, s, p) => {
    ...
    (t.nodes() ? o.info(`Recursive render XXX`, t.nodes()) : o.info(`No nodes found for`, t),
...
Parent cluster`,
            ...
            t.setNode(s.id, n),
            t.parent(e) || (o.trace(`Setting parent`, e, s.id), t.setParent(e, s.id, n)));
        }
        if ((o.info(`(Insert) Node XXX` + e + `: ` + JSON.stringify(t.node(e))), n?.clusterNode)) {
          ...
          t.children(e).length > 0
            ? (o.trace(`Cluster - the non recursive path XBX`, e, n.id, n, n.width, `Graph:`, t),
              o.trace(N(n.id, t)),
      ...
      await a(async () => {
        let e = t.edges().map(async function (e) {
          ...
          (o.info(`Edge ` + e.v + ` -> ` + e.w + `: ` + JSON.stringify(e)),
            o.info(`Edge ` + e.v + ` -> ` + e.w + `: `, e, ` `, JSON.stringify(t.edge(e))),
            o.info(`Fix`, w, `ids:`, e.v, e.w, `Translating: `, w.get(e.v), w.get(e.w)),
            await y(C, n));
        });
        await Promise.all(e);
      }, `processEdges`)(),
      ...
      await Promise.all(
        R(t).map(async function (e) {
          ...
          if (
            ...
            (o.info(`A pure cluster node XBX1`, e, n.id, n.x, n.y, n.width, n.height, t.parent(e)),
              (n.height += D),
              t.node(n.parentId));
            let r = n?.padding / 2 || 0,
