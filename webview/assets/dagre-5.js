...
import { t as w } from "./graphlib-3.js";
var ie = class {
  constructor() {
    var e = {};
  ...
  function t(n) {
    ...
    if ((i.length && r(i, t), Object.prototype.hasOwnProperty.call(a, `minRank`))) {
      ...
      for (var o = a.minRank, s = a.maxRank + 1; o < s; ++o)
        (M(e, `borderLeft`, `_bl`, n, a, o), M(e, `borderRight`, `_br`, n, a, o));
    }
  }
  r(e.children(), t);
}
...
function Ce(e) {
  var t = e.graph().rankdir.toLowerCase();
  ((t === `bt` || t === `rl`) && Te(e), (t === `lr` || t === `rl`) && (Ee(e), N(e)));
}
function N(e) {
...
function Ae(e, t) {
  function n(i) {
    r(t.nodeEdges(i), function (r) {
      var a = r.v,
        o = i === a ? r.w : a;
      !e.hasNode(o) && !L(t, r) && (e.setNode(o, {}), e.setEdge(i, o, {}), n(o));
    });
  }
...
function Ye(e, t, n) {
  var i = Xe(e),
    a = new w({ compound: !0 }).setGraph({ root: i }).setDefaultNodeLabel(function (t) {
      return e.node(t);
    });
  return (
...
function nt(e) {
  ...
  function n(e) {
    return function (t) {
      t.merged ||
        ((_(t.barycenter) || _(e.barycenter) || t.barycenter >= e.barycenter) && rt(e, t));
    };
  }
  function i(t) {
    return function (n) {
...
function st(e, t, n, i) {
  ...
  r(f, function (t) {
    if (e.children(t.v).length) {
      var r = st(e, t.v, n, i);
      ((d[t.v] = r), Object.prototype.hasOwnProperty.call(r, `barycenter`) && lt(t, r));
    }
  });
  var p = tt(f, n);
  ct(p, d);
...
function Gt(e) {
  r(e.edges(), function (t) {
    ...
    if (n.width && n.height) {
      var r = e.node(t.v);
      O(e, `edge-proxy`, { rank: (e.node(t.w).rank - r.rank) / 2 + r.rank, e: t }, `_ep`);
    }
  });
}
function Kt(e) {
