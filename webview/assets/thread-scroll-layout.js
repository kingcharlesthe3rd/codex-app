...
function C({
  ...
  let h = ee(() => `${Math.abs(e?.get() ?? 0)}px`),
    ...
    z = (0, D.useCallback)(
      (e) => {
        if (((_.current = e), !(e == null || R == null)))
          return R((t) => {
            P.current || w(e) || c(e, p(e) + t);
          });
      },
      [R],
    ),
    ...
    Q = m(async () => {
      if (!(N.current || o == null)) {
        N.current = !0;
        try {
          for (; _.current != null && T(_.current) && (await o()) !== `stop`; );
        } catch {
        } finally {
          N.current = !1;
        }
  ...
  ((0, D.useLayoutEffect)(() => {
      ...
      let t = () => {
        ...
        n = () => {
          ...
          n != null &&
            ...
            (q(), c(e, n.distanceFromBottomPx + n.wheelDistanceFromBottomPx));
          let r = S.current,
            i = M.current;
          if (i == null) {
            t();
    ...
    (0, D.useImperativeHandle)(l, () => ({ scrollToBottom: $ })));
  let ae = (0, D.useMemo)(
      () => ({
        addScrollListener: H,
