...
import { T as s, w as c, x as ee } from "./rpc-Hf-fxjh7.js";
...
import { t as ae } from "./thread-scroll-controller-context-value.js";
var oe = r(),
  l = e(t(), 1),
  u = n(),
  se = 260,
...
function d(e) {
  let t = (0, oe.c)(69),
    ...
    m = (0, l.useRef)(f ?? 0),
    h;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((h = new Set()), (t[0] = h)) : (h = t[0]);
  let ye = (0, l.useRef)(h),
    g;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((g = new Set()), (t[1] = g)) : (g = t[1]);
  let be = (0, l.useRef)(g),
    _ = (0, l.useRef)(null),
    xe = (0, l.useRef)(!1),
    Se = (0, l.useRef)(!1),
    v = (0, l.useRef)(null),
    Ce = (0, l.useContext)(re),
    y;
  t[2] === Ce
    ? (y = t[3])
    : ((y = (e) => {
        if (((p.current = e), !(e == null || Ce == null)))
          return Ce((t) => {
            xe.current || ue(e) || s(e, c(e) + t);
          });
      }),
      (t[2] = Ce),
      (t[3] = y));
    ...
    ? ((L = () => {
        ...
        let t = () => {
          ...
          n = () => {
            ...
            _.current = i;
            let a = c(e);
            for (let e of be.current) e(a, n);
          },
          r = () => {
            ((_.current = performance.now()), D(), t());
          };
        return (
  ...
  t[43] === A
    ...
    : ((U = (e) => {
        ...
        r !== t &&
          ...
          (ve.current = t),
          !(xe.current || Se.current) && (r == null || ue(n) || A(`instant`, (e) => c(e) + t - r)));
      }),
      (t[43] = A),
      (t[44] = U));
  let Ne = ne(U),
    Pe = he ? `[content-visibility:visible]` : `[content-visibility:auto]`,
    W;
  t[45] === Pe ? (W = t[46]) : ((W = i(`relative h-full flex-1`, Pe)), (t[45] = Pe), (t[46] = W));
  let G;
  ...
  t[50] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = i(ie, `relative flex flex-1 shrink-0 flex-col pb-8`)), (t[50] = q))
    : (q = t[50]);
  let J;
  t[51] === r
    ? (J = t[52])
    : ((J = (0, u.jsx)(`div`, { "data-mcp-app-portal-target": `true`, className: q, children: r })),
      (t[51] = r),
      (t[52] = J));
  let Y;
  t[53] !== d || t[54] !== Ne
    ? ((Y = d
        ? (0, u.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, u.jsx)(`div`, { className: i(`relative z-10 flex flex-col`, ie), children: d }),
            ],
          })
        : null),
      (t[53] = d),
  ...
  let Z;
  t[60] !== we || t[61] !== X
    ? ((Z = (0, u.jsx)(`div`, { ref: we, ...ee.timelineScroll, className: G, children: X })),
      (t[60] = we),
      (t[61] = X),
      (t[62] = Z))
    : (Z = t[62]);
  ...
  return (
    t[66] !== Me || t[67] !== Q
      ? (($ = (0, u.jsx)(ae, { value: Me, children: Q })), (t[66] = Me), (t[67] = Q), (t[68] = $))
      : ($ = t[68]),
    $
  );
}
