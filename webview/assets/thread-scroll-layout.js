...
import { n as x, t as re } from "./thread-scroll-controller-context-value.js";
var S = e(() => {});
function C({
  contentX: e,
  children: t,
  ...
  let m = te(() => `${Math.abs(e?.get() ?? 0)}px`),
    ...
    z = (0, D.useCallback)(
      (e) => {
        if (((h.current = e), !(e == null || R == null)))
          return R((t) => {
            P.current || w(e) || g(e, p(e) + t);
          });
      },
      [R],
    ),
    B = f(() => h.current),
    V = (0, D.useCallback)(() => S.current, []),
    H = f(
      (e) => (
        C.current.add(e),
        e(S.current),
    ...
    Z = f(() => {
      let e = h.current;
      if (e == null || I.current != null) return;
      let t = {
    ...
    Q = f(async () => {
      if (!(N.current || o == null)) {
        N.current = !0;
        try {
          for (; h.current != null && T(h.current) && (await o()) !== `stop`;);
        } catch {
        } finally {
          N.current = !1;
        }
    ...
    $ = f(() => {
      ...
      let n = performance.now(),
        r = (e) => {
          ...
          if ((g(i, t * (1 - (1 - (1 - a) ** 3))), a < 1 && !w(i))) {
            L.current = window.requestAnimationFrame(r);
            return;
          }
          (g(i, 0), G());
        };
  ...
  ((0, D.useLayoutEffect)(() => {
      ...
      let t = () => {
        ...
        n = () => {
          ...
          n != null &&
            ...
            (q(), g(e, n.distanceFromBottomPx + n.wheelDistanceFromBottomPx));
          let r = S.current,
            i = M.current;
          if (i == null) {
            t();
          ...
          let o = p(e);
          o > r && T(e) && Q();
          for (let e of A.current) e(o, r);
        },
        r = (t) => {
          let n = I.current;
          (n != null && `deltaY` in t
            ? (n.wheelDistanceFromBottomPx -= ie(t, e.clientHeight))
            : q(),
    ...
    (0, D.useImperativeHandle)(c, () => ({ scrollToBottom: $ })));
  let ae = (0, D.useMemo)(
      () => ({
        addScrollListener: H,
    ...
    oe = ee((e) => {
      ...
      r !== t &&
        ...
        (x.current = t),
        !(P.current || F.current) && (r == null || w(n) || J(`instant`, (e) => p(e) + t - r)));
    }),
    se = e == null ? void 0 : { x: e, "--thread-wide-block-inline-shift": m };
  return (0, O.jsx)(re, {
    value: ae,
              ...
              ? (0, O.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, O.jsx)(`div`, {
                      ...
                      className: _(`relative z-10 flex flex-col`, b),
                      children: n,
                    }),
                  ],
                })
...
function E(e) {
  return e.scrollHeight - e.clientHeight - p(e);
}
function ie(e, t) {
  return e.deltaMode === N ? e.deltaY * M : e.deltaMode === P ? e.deltaY * t : e.deltaY;
}
var D,
  O,
  k,
