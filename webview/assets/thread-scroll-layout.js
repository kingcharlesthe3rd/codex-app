...
import { n as x, t as re } from "./thread-scroll-controller-context-value-C.js";
var S = e(() => {});
function C({
  contentX: e,
  children: t,
  ...
  ((0, O.useLayoutEffect)(() => {
    ...
    (0, O.useEffect)(() => {
      ...
      let t = () => {
        ...
        r = (t) => {
          let n = L.current;
          (n != null && `deltaY` in t ? (n.wheelDistanceFromBottomPx -= D(t, e.clientHeight)) : q(),
  ...
  let ae = (0, O.useMemo)(
    ...
    oe = c((e) => {
      ...
      r !== t &&
        ...
        (x.current = t),
        !(F.current || I.current) && (r == null || w(n) || J(`instant`, (e) => m(e) + t - r)));
    }),
