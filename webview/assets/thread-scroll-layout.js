...
import { n as x, t as S } from "./thread-scroll-controller-context-value-B.js";
var C = e(() => {});
function w({
  contentX: e,
  children: t,
  ...
  let h = te(() => `${Math.abs(e?.get() ?? 0)}px`),
    ...
    re = (0, k.useCallback)(
      (e) => {
        if (((g.current = e), !(e == null || B == null)))
          return B((t) => {
            I.current || T(e) || _(e, r(e) + t);
          });
      },
      [B],
    ),
    ...
    Q = f(async () => {
      if (!(F.current || l == null)) {
        F.current = !0;
        try {
          for (; g.current != null && E(g.current) && (await l()) !== `stop`; );
        } catch {
        } finally {
          F.current = !1;
        }
    ...
    $ = f(() => {
      ...
      let n = performance.now(),
        i = (e) => {
          ...
          let a = Math.min(1, (e - n) / j);
          if ((_(r, t * (1 - (1 - (1 - a) ** 3))), a < 1 && !T(r))) {
      ...
      let t = () => {
        ...
        n = () => {
          ...
          n != null &&
            ...
            (q(), _(e, n.distanceFromBottomPx + n.wheelDistanceFromBottomPx));
          let i = C.current,
            a = P.current;
          if (a == null) {
            t();
  ...
  let ae = (0, k.useMemo)(
    ...
    oe = o((e) => {
      ...
      i !== t &&
        ...
        (x.current = t),
        !(I.current || L.current) && (i == null || T(n) || J(`instant`, (e) => r(e) + t - i)));
    }),
...
function D(e) {
  return e.scrollHeight - e.clientHeight - r(e);
}
function O(e, t) {
