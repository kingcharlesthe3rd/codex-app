...
import { B as o, w as te, z as s } from "./rpc-1.js";
import { t as ne } from "./get-resize-observer-entry-size-DrKQ-0pS.js";
...
function u(e) {
  let t = (0, se.c)(70),
    {
      ...
      ref: me,
      initialOffset: he,
      remoteHostedPIPAnchorHostId: ge,
    } = e,
    _e = fe === void 0 ? !1 : fe,
    d = he === void 0 ? 0 : he,
    f = (0, c.useRef)(null),
    [ve, ye] = (0, c.useState)(!1),
    be = (0, c.useRef)(null),
    p = (0, c.useRef)(d ?? 0),
    m;
  ...
  t[2] === y
    ? (b = t[3])
    : ((b = (e) => {
        if (((f.current = e), !(e == null || y == null)))
          return y((t) => {
            _.current || de(e) || o(e, s(e) + t);
          });
      }),
      (t[2] = y),
      (t[3] = b));
  ...
  t[12] === E
    ...
    : ((A = (e, t) => {
        ...
        (n.scrollTo({ behavior: e, top: r === 0 ? 0 : -r }), E(r));
      }),
      (t[12] = E),
      (t[13] = A));
  let j = a(A),
    ...
    ? ((R = () => {
        ...
        let t = () => {
          ...
          n = () => {
            ...
            g.current = i;
            let ee = s(e);
            for (let e of Se.current) e(ee, n);
          },
          r = () => {
            ((g.current = performance.now()), O(), t());
          };
        return (
  ...
  (t[30] === O
    ...
    (0, c.useEffect)(B, V));
  let H;
  (t[33] === F ? (H = t[34]) : ((H = () => ({ scrollToBottom: F })), (t[33] = F), (t[34] = H)),
    (0, c.useImperativeHandle)(me, H));
  let U;
  t[35] !== De ||
  t[36] !== Oe ||
  t[37] !== Te ||
  ...
  t[43] === j
    ...
    : ((W = (e) => {
        ...
        r !== t &&
          ...
          (be.current = t),
          !(_.current || Ce.current) && (r == null || de(n) || j(`instant`, (e) => s(e) + t - r)));
      }),
      (t[43] = j),
      (t[44] = W));
  let Ne = re(W),
    Pe = _e ? `[content-visibility:visible]` : `[content-visibility:auto]`,
    G;
  t[45] === Pe ? (G = t[46]) : ((G = i(`relative h-full flex-1`, Pe)), (t[45] = Pe), (t[46] = G));
  let K;
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (K = t[47]);
  let q;
  t[48] === n ? (q = t[49]) : ((q = n == null ? void 0 : { x: n }), (t[48] = n), (t[49] = q));
  let Fe;
  t[50] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Fe = i(ae, `relative flex flex-1 shrink-0 flex-col pb-8`)), (t[50] = Fe))
    : (Fe = t[50]);
  let J;
  t[51] === r
    ? (J = t[52])
        ...
        ? (0, l.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, l.jsx)(`div`, {
                ...
                className: i(`relative z-10 flex flex-col`, ae),
                children: u,
              }),
            ],
          })
  ...
  t[56] !== q || t[57] !== J || t[58] !== Y
    ...
    : (X = t[59]);
  let Z;
  t[60] !== ge || t[61] !== we || t[62] !== X
    ? ((Z = (0, l.jsx)(`div`, {
        ref: we,
        "data-pip-anchor-host": ge,
        ...te.timelineScroll,
        className: K,
        children: X,
      })),
  ...
  let Q;
  t[64] !== G || t[65] !== Z
    ? ((Q = (0, l.jsx)(`div`, { className: G, children: Z })),
      (t[64] = G),
      (t[65] = Z),
      (t[66] = Q))
    : (Q = t[66]);
  ...
  return (
    t[67] !== Me || t[68] !== Q
      ? (($ = (0, l.jsx)(oe, { value: Me, children: Q })), (t[67] = Me), (t[68] = Q), (t[69] = $))
      : ($ = t[69]),
    $
  );
}
