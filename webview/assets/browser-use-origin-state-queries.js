import { Xs as e } from "./app-server-manager-signals.js";
import {
  C as t,
  L as n,
  S as r,
...
function m(n) {
  ...
  r[0] !== i || r[1] !== a
    ? ((o = async () => {
        await Promise.all([a(f), e(`clear-prewarmed-threads-for-host`, { hostId: i })]);
      }),
      (r[0] = i),
      (r[1] = a),
      (r[2] = o))
  ...
  return (
    r[5] !== o || r[6] !== s
      ? ((l = { mutationFn: h, onSuccess: o, onError: s }), (r[5] = o), (r[6] = s), (r[7] = l))
      : (l = r[7]),
    c(l)
  );
}
  ...
  return (
    e[0] === r
      ...
      : ((i = {
          ...
          onError: (e) => {
            (t.error(`Failed to update browser-use file transfer approval mode`, {
              safe: { error: String(e) },
              sensitive: {},
            }),
              r.invalidateQueries({ queryKey: f }));
  ...
  return (
    e[0] === r
      ...
      : ((i = {
          ...
          onError: (e) => {
            (t.error(`Failed to update browser-use file transfer origin state`, {
              safe: { error: String(e) },
              sensitive: {},
            }),
              r.invalidateQueries({ queryKey: f }));
