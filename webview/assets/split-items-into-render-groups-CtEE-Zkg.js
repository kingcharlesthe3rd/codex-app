...
function D({ apps: e, functionName: t, serverName: n, toolName: r }) {
  ...
  for (let t of e) {
    let e = O(t);
    if (e.some((e) => A(e, i)) || e.some((e) => j(a, e)) || o.some((t) => e.some((e) => j(t, e))))
      return t;
  }
  return null;
}
function O(e) {
  ...
  return t.filter((e, n) => (e.length === 0 ? !1 : t.findIndex((t) => A(t, e)) === n));
}
function k(e) {
  return e
    .trim()
...
function ee({ summary: e, cwd: t, intl: n, threadDetailLevel: r, formatSearchQuery: i }) {
...
function me(e, t) {
  ...
  return r.length === 0 ? null : { logoUrl: null, logoUrlDark: null, name: o(r) };
}
function he(e, t) {
  return !1;
}
function ge(e) {
  if (!/^\s*curl(?:\s|$)/.test(e) || ue.test(e) || de.test(e) || fe.test(e)) return !1;
...
function ye(e, t) {
  ...
  for (let [u, d] of Object.entries(e.changes)) {
    if (d.type === `add`) {
      (n.push(u),
        e.success == null && t ? i.push(u) : (e.success ?? (r.push(u), (a += xe(d.content)))));
      continue;
    }
    if (d.type === `delete`) {
...
function V(e, t, n) {
  return (0, B.jsxs)(`span`, {
    ...
    children: [
      n === `summary-text`
        ? null
        : (0, B.jsx)(w, { className: `icon-xs shrink-0 text-token-text-secondary` }),
      (0, B.jsx)(C, {
        active: !e.completed,
...
var Te = f({
  ...
  Ee = t({ target: t({ type: n(), environment: t({ type: n() }).optional() }) }),
  De = [
  ...
  return n == null
    ...
    : (0, B.jsxs)(`span`, {
        ...
        children: [
          t === `summary-text`
            ? null
            : (0, B.jsx)(T, { className: `icon-xs shrink-0 text-token-text-secondary` }),
          (0, B.jsx)(C, {
            active: !e.completed,
...
function Z({
  ...
  for (let r = 0; r < e.length; ) {
    ...
    if (i && r === i.startIndex) {
      ...
      if (o != null) {
        let e = ze({ groupedUnits: a, isCurrentToolActivity: s, summary: i.summary });
        u.push({ kind: `collapsed-tool-activity`, key: J(o, i.startIndex), units: a, summary: e });
      }
      ((r = i.endIndex), (d += 1));
      continue;
    }
...
var Ge = e(i(), 1);
function Ke({ agentItems: e, isTurnInProgress: t, isAnyNonAgentItemInProgress: n }) {
  let r = [],
    i = null,
    a = !1,
    o = !1,
...
var Xe = (e) => e.type === `patch` && e.approvalRequestId != null && e.success == null,
  Ze = (e) => e.type === `exec` && e.approvalRequestId != null && e.output?.exitCode === void 0,
...
//# sourceMappingURL=split-items-into-render-groups-CtEE-Zkg.js.map
