...
function je(e) {
  ...
  return (
    t[4] !== a || t[5] !== o
      ? ((s = (0, X.jsx)(A, { activities: o, children: a })), (t[4] = a), (t[5] = o), (t[6] = s))
      : (s = t[6]),
    s
  );
}
...
async function Pe(e, t, n) {
  ...
  let { config: i } = await y(`read-config-for-host`, {
    hostId: e.hostId,
    includeLayers: !1,
    cwd: e.sourceWorkspaceRoot,
  });
...
function Le(e) {
  let t = (0, Z.c)(54),
    ...
    g = Ee(),
    _ = re(),
    { pendingWorktreeId: oe } = ie(),
    v = i ?? oe,
    {
      cancelPendingWorktree: y,
      clearPendingWorktreeAttention: ce,
      continuePendingWorktree: b,
      createPendingWorktree: x,
      retryPendingWorktree: S,
      setPendingWorktreePinned: C,
    } = _e(),
    { retryPendingWorktreeConversationStart: w } = ye(),
    T = Se(v),
    D = Ce().find((e) => e.pendingWorktreeId === v),
    O = fe({
      mutationFn: async (e) => {
        ...
        if (T)
          if ((y(T.id), t))
            try {
              let e = await ke({ entry: T, workspaceRoot: T.sourceWorkspaceRoot });
              (be(p, {
                ...
                T.clientThreadId == null
                  ? ue(p, { conversationId: e, pendingWorktreeId: T.id }) || Oe(T, e)
                  : me(p, { clientThreadId: T.clientThreadId, conversationId: e }),
                s?.(e),
                s == null && T.clientThreadId == null && h(f(e)));
            } catch (e) {
              let t = e;
              throw (
                y(T.id),
                ...
                p
                  ...
                  .danger(
                    _.formatMessage(
                      ...
                      { br: (0, $.jsx)(`br`, {}), error: le(t) },
                    ),
                  ),
                t
              );
            }
          else (ge(p, T.id), g(Re(T)));
      },
    }),
    k;
  t[0] !== x || t[1] !== _ || t[2] !== h || t[3] !== T || t[4] !== p
    ? ((k = async () => {
        if (!T) return;
        let e =
          T.launchMode === `start-conversation`
            ? (T.startConversationParamsInput.collaborationMode?.settings.model ?? null)
        ...
        h(
          de(
            await Ne({
              ...
              intl: _,
              pendingWorktree: T,
              serviceTier: await ve(p, T.hostId, e),
            }),
          ),
        );
      }),
  ...
  if (
    ...
    (0, Q.useEffect)(I, L),
    O.isPending || O.isSuccess || T === void 0)
  )
    return null;
  if (D?.state === `succeeded` && !te)
    return (0, $.jsx)(a, { to: f(D.conversationId), replace: !0 });
  ...
  if (!T) {
    ...
    return (
      t[20] === u
        ? (e = t[21])
        : ((e = (0, $.jsx)(a, { to: u, replace: !0 })), (t[20] = u), (t[21] = e)),
      e
    );
  }
  let R;
  t[22] === T.phase ? (R = t[23]) : ((R = we(T.phase)), (t[22] = T.phase), (t[23] = R));
  let z = R,
    B = D?.state === `failed`,
    V = D?.state === `starting`,
    H = T.phase === `failed` || B,
    U = T.launchMode === `create-stable-worktree`,
    W = T.phase === `failed` && T.worktreeGitRoot != null && T.worktreeWorkspaceRoot != null,
    G = W && !U,
                    ...
                    children: [
                      T.phase === `failed` &&
                        (0, $.jsx)(E, {
                          color: `secondary`,
                          onClick: () => {
                            if ((xe(p, T.hostId), T.localEnvironmentConfigPath != null)) {
                              h(
                                Te({
...
function ze(e) {
  ...
  t[2] === a
    ? (o = t[3])
    : ((o = a && (0, $.jsx)(C, { pullRequestNumber: a })), (t[2] = a), (t[3] = o));
  let s;
  t[4] !== n || t[5] !== r
    ? ((s = (0, $.jsx)(g, { message: r, sentAtMs: null, hostId: n, alwaysShowActions: !0 })),
      (t[4] = n),
      (t[5] = r),
      (t[6] = s))
    : (s = t[6]);
