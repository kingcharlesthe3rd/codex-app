...
import { Bt as we, Ht as M } from "./app-initial~app-main~automations-page.js";
import {
  Au as N,
  ht as P,
  ju as Te,
...
import { i as V } from "./app-initial~app-main~worktree-init-v2-page~appgen-page~remote-conversation-page~pull-reques~l0drf339-C.js";
import {
  a as H,
  i as De,
...
function je(e) {
  ...
  return (
    t[4] !== a || t[5] !== o
      ? ((s = (0, X.jsx)(F, { activities: o, children: a })), (t[4] = a), (t[5] = o), (t[6] = s))
      : (s = t[6]),
    s
  );
}
...
function Le(e) {
            ...
            try {
              ...
              (de(p, {
                ...
                T.clientThreadId == null
                  ? Ce(p, { conversationId: e, pendingWorktreeId: T.id }) || Oe(T, e)
                  : Se(p, { clientThreadId: T.clientThreadId, conversationId: e }),
                l?.(e),
  ...
  let R;
  t[22] === T.phase ? (R = t[23]) : ((R = pe(T.phase)), (t[22] = T.phase), (t[23] = R));
  let z = R,
    B = E?.state === `failed`,
    V = E?.state === `starting`,
    H = T.phase === `failed` || B,
                    ...
                    children: [
                      T.phase === `failed` &&
                        (0, $.jsx)(_, {
                          color: `secondary`,
                          onClick: () => {
                            if ((Te(p, T.hostId), T.localEnvironmentConfigPath != null)) {
                              h(
                                we({
...
function ze(e) {
  ...
  t[2] === a
    ? (o = t[3])
    : ((o = a && (0, $.jsx)(R, { pullRequestNumber: a })), (t[2] = a), (t[3] = o));
  let s;
  t[4] !== n || t[5] !== r
