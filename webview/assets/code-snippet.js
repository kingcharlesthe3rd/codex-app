const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./highlight-code.js", "./chunk-Bj-mKKzh.js", "./core.js"]),
) => i.map((i) => d[i]);
...
var b = (e) => {
  ...
  w = g(() => t(() => import(`./highlight-code.js`), __vite__mapDeps([0, 1, 2]), import.meta.url)),
  T = `
`,
  E = 120,
  D = x.memo(function (e) {
...
function O(e) {
  ...
  let K = G,
    q;
  t[17] !== o || t[18] !== R
    ? ((q = R != null && o.startsWith(R.code) ? R : null), (t[17] = o), (t[18] = R), (t[19] = q))
    : (q = t[19]);
  let J = q,
    Y;
...
`),
      n;
    t[24] !== o || t[25] !== J
      ? ((n = J == null ? o : o.slice(J.code.length)), (t[24] = o), (t[25] = J), (t[26] = n))
      : (n = t[26]);
    let r = n;
    ((Y = K
...
function te(e) {
  ...
  t[8] !== n || t[9] !== u || t[10] !== f || t[11] !== h
    ? ((w = (0, v.jsx)(j, { shouldWrap: h, className: u, onCopy: f, children: n })),
      (t[8] = n),
      (t[9] = u),
      (t[10] = f),
      (t[11] = h),
