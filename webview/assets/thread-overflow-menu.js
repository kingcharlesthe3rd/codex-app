...
async function lt({
  ...
  let { instructions: o } = await l(`developer-instructions`, {
    params: { cwd: t, hostId: n, instructionOverrides: i, threadId: e },
  });
  return T(`fork-conversation-from-latest`, {
    hostId: n,
    conversationId: e,
    cwd: t,
...
async function ft(
  ...
  let u = se(l),
    ...
    p = u.openTab(
      e,
      (e) =>
        (0, X.jsx)(B, { fillParent: !0, debugName: `LocalConversationSideChatLoadingTab.pending` }),
      {
  ...
  try {
    let s = await lt({
      ...
      hostId: a,
      collaborationMode: o,
      instructionOverrides: b(e.get(v), e.get(xe, n) ?? o?.settings.model ?? null),
      parentNavigationPath: `${e.value.pathname}${e.value.search ?? ``}`,
    });
    return (
      u.openTab(e, t, {
        activate: l === `bottom` ? e.get(_e) : e.get(A),
        icon: (0, X.jsx)(q, { className: `icon-sm` }),
        onClose: () => {
          (M(e, n, s),
            T(`discard-conversation-from-cache`, { conversationId: s }).catch((e) => {
              m.warning(`Failed to discard side chat`, {
...
var X,
  Z,
  pt = e(() => {
    (N(), _(), x(), K(), V(), d(), w(), a(), C(), dt(), I(), (X = F()), (Z = `sidechat-loading:`));
  });
function mt({
  conversationId: e,
  ...
  let v = ue(le),
    ...
    T = we(),
    [fe, D] = (0, Q.useState)(!1),
    [k, me] = (0, Q.useState)(null),
    [A, j] = (0, Q.useState)(null),
    [_e, ve] = (0, Q.useState)(null),
    [M, N] = (0, Q.useState)(!1),
    P = E(ne, e);
  E(de, e);
  let { isPinned: F, togglePin: I } = Ie(e, { canPin: s }),
    xe = E(H, `toggleThreadPin`),
    Ce = s ? xe : null,
    Te = E(H, `renameThread`),
    Ee = E(H, `archiveThread`),
    Oe = E(H, `copyWorkingDirectory`),
    ke = E(H, `copySessionId`),
    Ae = E(H, `copyDeeplink`),
    Me = E(H, `copyConversationMarkdown`),
    Le = E(H, `openSideChat`),
    { canOpenThreadInNewWindow: z, openThreadInNewWindow: ze } = tt({ conversationId: e }),
    B = E(ot, e),
    Be = B.isEligible,
    V = r != null && !Fe(),
    Ve = E(pe, e),
      ...
      e != null &&
        oe({
          ...
          onArchiveStart:
            h === `home`
              ? () => {
                  T(`/`, { replace: !0, state: { focusComposerNonce: Date.now(), prefillCwd: i } });
                }
              : void 0,
        });
    },
    W = (t) => {
      (async () => {
        ...
        try {
          n = We({
            automations: (await l(`list-automations`)).items,
            conversationId: e,
            includePausedAutomations: !0,
          });
        } catch (e) {
          m.error(`Error checking heartbeat automation before archive`, {
            safe: {},
            sensitive: { error: e },
          });
        }
    ...
    Ke = (t) => {
      if (t != null) {
        Re({ scope: v, automationId: t.id, title: t.name });
        return;
      }
      Pe({
        scope: v,
    ...
    G = () => {
      e == null ||
        ...
        ft(v, r, {
          ...
          (m.error(`Error opening side chat`, { safe: {}, sensitive: { error: e } }),
            v
              .get(ye)
              .danger(
                y.formatMessage({
  ...
  if (
    (ae(
      ...
      () => {
        e != null &&
          t != null &&
          x({ conversationId: e, parentConversationId: n ?? null, getMarkdown: t });
      },
  ...
  let K = i != null,
    Xe = async () => {
      let t = await qe(v, { sourceConversationId: e, sourceWorkspaceRoot: i });
      t != null && T(`/local/${t}`);
    },
    Qe = async () => {
      let t = await Ye(v, {
      ...
      t != null && i != null && T(`/worktree-init-v2/${t}`);
    },
    $e = () => {
      k != null && (D(!1), U(k));
    },
    nt = F ? rt : et,
    J = F ? at : Ue,
    it = y.formatMessage(R.moreActions),
    st = _ ?? `icon-sm`,
    lt = !c && !0,
    ut = z,
    ...
    children: [
      (0, $.jsxs)(he, {
        ...
        triggerButton: (0, $.jsx)(ge, {
          ...
          "aria-label": it,
          children: (0, $.jsx)(Ne, { className: st }),
        }),
        align: g,
        contentWidth: `menu`,
        children: [
          ...
          (0, $.jsx)(L.Item, {
            ...
            LeftIcon: u,
            keyboardShortcut: Te,
            children: (0, $.jsx)(f, { ...R.renameThread }),
          }),
          (0, $.jsx)(L.Item, {
            onSelect: () => W(ee),
            LeftIcon: Ge,
            keyboardShortcut: Ee,
            children: (0, $.jsx)(f, { ...R.archiveThread }),
          }),
          null,
          (0, $.jsx)(L.Separator, {}),
          V
          ...
          (0, $.jsxs)(L.FlyoutSubmenuItem, {
            ...
            children: [
              (0, $.jsx)(L.Item, {
                ...
                keyboardShortcut: Oe,
                disabled: !i,
                children: (0, $.jsx)(f, { ...R.copyWorkingDirectory }),
              }),
              (0, $.jsx)(L.Item, {
                onSelect: () => C(e),
                LeftIcon: O,
                keyboardShortcut: ke,
                children: (0, $.jsx)(f, { ...R.copySessionId }),
              }),
              (0, $.jsx)(L.Item, {
                onSelect: () => b(e),
                LeftIcon: O,
                keyboardShortcut: Ae,
                children: (0, $.jsx)(f, { ...R.copyAppLink }),
              }),
              e != null && t != null
                ? (0, $.jsx)(L.Item, {
                    onSelect: () =>
                    ...
                    LeftIcon: O,
                    keyboardShortcut: Me,
                    children: (0, $.jsx)(f, { ...R.copyConversationMarkdown }),
                  })
                : null,
            ],
          }),
            ...
            ? (0, $.jsxs)(L.FlyoutSubmenuItem, {
                ...
                children: [
                  (0, $.jsx)(L.Item, {
                    ...
                    LeftIcon: d ? ce : je,
                    children: (0, $.jsx)(f, { ...(d ? R.forkIntoSameWorktree : R.forkIntoLocal) }),
                  }),
                  (0, $.jsx)(L.Item, {
                    onSelect: () => {
                      Qe();
                    ...
                    LeftIcon: ce,
                    disabled: !K,
                    children: (0, $.jsx)(f, { ...R.forkIntoWorktree }),
                  }),
                ],
              })
            : null,
          ...
          ut ? (0, $.jsx)(L.Separator, {}) : null,
          z
            ? (0, $.jsx)(L.Item, {
                onSelect: ze,
                LeftIcon: ct,
                children: (0, $.jsx)(f, { ...R.openInNewWindow }),
              })
            : null,
        ],
      }),
      A == null
        ...
        : (0, $.jsx)(be, {
            ...
            onClose: () => j(null),
            onSave: (t) => {
              se({ conversationId: e, title: t });
            },
          }),
      (0, $.jsx)(Ze, { heartbeatAutomationName: _e, open: fe, onOpenChange: D, onConfirm: $e }),
    ],
  });
}
function ht(e) {
  let t = (0, gt.c)(12),
    ...
    s;
  t[0] !== o?.items || t[1] !== r
    ? ((s = We({ automations: o?.items ?? [], conversationId: r, includePausedAutomations: !0 })),
      (t[0] = o?.items),
      (t[1] = r),
      (t[2] = s))
    : (s = t[2]);
  ...
  let d = !l && !n,
    p = l ? R.editAutomation : R.addAutomation,
    m;
  t[6] === p ? (m = t[7]) : ((m = (0, $.jsx)(f, { ...p })), (t[6] = p), (t[7] = m));
  let h;
  return (
    t[8] !== u || t[9] !== d || t[10] !== m
      ? ((h = (0, $.jsx)(L.Item, { onSelect: u, LeftIcon: Ae, disabled: d, children: m })),
        (t[8] = u),
        (t[9] = d),
        (t[10] = m),
        (t[11] = h))
