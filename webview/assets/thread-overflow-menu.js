...
import { An as Me } from "./app-initial~app-main~remote-conversation-page~onboarding-page~hotkey-window-thread-page~thr~bsekxs5f.js";
import {
  I as Ne,
  L as R,
  R as Pe,
...
import { St as Ke, bt as W, xt as qe } from "./app-initial~app-main~onboarding-page.js";
import {
  Et as G,
  _ as Je,
  p as K,
...
import { i as Ye, r as Xe } from "./app-initial~app-main~new-thread-panel-page~onboarding-page.js";
import {
  a as Ze,
  c as Qe,
  d as $e,
...
async function lt({
  ...
  let { instructions: o } = await c(`developer-instructions`, {
    params: { cwd: t, hostId: n, instructionOverrides: i, threadId: e },
  });
  return j(`fork-conversation-from-latest`, {
    hostId: n,
    conversationId: e,
    cwd: t,
...
async function ft(
  ...
  let u = q(l),
    ...
    p = u.openTab(
      ...
      {
        icon: (0, X.jsx)(B, { className: `icon-sm` }),
        id: `${Z}${n}:${d}`,
        isClosable: !1,
        title: f,
      },
  ...
  try {
    let s = await lt({
      ...
      hostId: a,
      collaborationMode: o,
      instructionOverrides: I(e.get(F), e.get(ve, n) ?? o?.settings.model ?? null),
      parentNavigationPath: `${e.value.pathname}${e.value.search ?? ``}`,
    });
    return (
      u.openTab(e, t, {
        activate: l === `bottom` ? e.get(O) : e.get(M),
        icon: (0, X.jsx)(B, { className: `icon-sm` }),
        onClose: () => {
          (me(e, n, s),
            j(`discard-conversation-from-cache`, { conversationId: s }).catch((e) => {
...
function mt({
  ...
  let v = o(be),
    ...
    T = Se(),
    [me, O] = (0, Q.useState)(!1),
    [k, ge] = (0, Q.useState)(null),
    [A, j] = (0, Q.useState)(null),
    [M, ve] = (0, Q.useState)(null),
    [N, F] = (0, Q.useState)(!1),
    xe = i(ye, e);
  i(he, e);
  let { isPinned: I, togglePin: L } = Pe(e, { canPin: d }),
    Ce = i(K, `toggleThreadPin`),
    we = d ? Ce : null,
    De = i(K, `renameThread`),
    Oe = i(K, `archiveThread`),
    ke = i(K, `copyWorkingDirectory`),
    Me = i(K, `copySessionId`),
    Ne = i(K, `copyDeeplink`),
    Fe = i(K, `copyConversationMarkdown`),
    Ie = i(K, `openSideChat`),
    { canOpenThreadInNewWindow: z, openThreadInNewWindow: Be } = tt({ conversationId: e }),
    V = i(ot, e),
    Ue = V.isEligible,
    H = a != null && !Ae(),
    Ge = i(_e, e),
      ...
      e != null &&
        le({
          ...
          onArchiveStart:
            h === `home`
              ? () => {
                  T(`/`, { replace: !0, state: { focusComposerNonce: Date.now(), prefillCwd: l } });
                }
              : void 0,
        });
    },
    G = (t) => {
      (async () => {
        ...
        try {
          n = Ve({
            automations: (await c(`list-automations`)).items,
            conversationId: e,
    ...
    Je = (t) => {
      if (t != null) {
        qe({ scope: v, automationId: t.id, title: t.name });
        return;
      }
      Ke({
        scope: v,
  ...
  if (
    (ue(
      ...
      () => {
        e != null &&
          t != null &&
          S({ conversationId: e, parentConversationId: n ?? null, getMarkdown: t });
      },
      { enabled: e != null && t != null },
    ),
    ue(`openSideChat`, q, { enabled: e != null && H }),
    _(
      `toggle-thread-pin`,
      () => {
        d && L();
  ...
  let Ye = l != null,
    Xe = async () => {
      let t = await He(v, { sourceConversationId: e, sourceWorkspaceRoot: l });
      t != null && T(`/local/${t}`);
    },
    Qe = async () => {
      let t = await ze(v, {
        localEnvironmentSelectionsByWorkspace: U,
        sourceConversationId: e,
        sourceWorkspaceRoot: l,
      });
      t != null && l != null && T(`/worktree-init-v2/${t}`);
    },
    $e = () => {
      k != null && (O(!1), W(k));
    },
    ...
    lt = !p && !0,
    ut = z,
    Y = V.reason === `turn_in_progress`;
  return (0, $.jsxs)($.Fragment, {
    children: [
      (0, $.jsxs)(pe, {
        open: N,
        onOpenChange: F,
        triggerButton: (0, $.jsx)(de, {
          size: `icon`,
          color: re,
          className: te ?? `no-drag`,
          "aria-label": it,
          children: (0, $.jsx)(ie, { className: st }),
        }),
        align: ee,
        contentWidth: `menu`,
        children: [
          ...
          (0, $.jsx)(D.Item, {
            ...
            LeftIcon: je,
            keyboardShortcut: De,
            children: (0, $.jsx)(P, { ...R.renameThread }),
          }),
          (0, $.jsx)(D.Item, {
            onSelect: () => G(g),
            LeftIcon: Le,
            keyboardShortcut: Oe,
            children: (0, $.jsx)(P, { ...R.archiveThread }),
          }),
          null,
          (0, $.jsx)(D.Separator, {}),
          H
          ...
          (0, $.jsxs)(D.FlyoutSubmenuItem, {
            ...
            children: [
              (0, $.jsx)(D.Item, {
                ...
                keyboardShortcut: ke,
                disabled: !l,
                children: (0, $.jsx)(P, { ...R.copyWorkingDirectory }),
              }),
              (0, $.jsx)(D.Item, {
                onSelect: () => C(e),
                LeftIcon: E,
                keyboardShortcut: Me,
                children: (0, $.jsx)(P, { ...R.copySessionId }),
              }),
              (0, $.jsx)(D.Item, {
                onSelect: () => x(e),
                LeftIcon: E,
                keyboardShortcut: Ne,
                children: (0, $.jsx)(P, { ...R.copyAppLink }),
              }),
              e != null && t != null
                ? (0, $.jsx)(D.Item, {
                    onSelect: () =>
                    ...
                    LeftIcon: E,
                    keyboardShortcut: Fe,
                    children: (0, $.jsx)(P, { ...R.copyConversationMarkdown }),
                  })
                : null,
            ],
          }),
            ...
            ? (0, $.jsxs)(D.FlyoutSubmenuItem, {
                ...
                children: [
                  (0, $.jsx)(D.Item, {
                    ...
                    LeftIcon: m ? oe : ne,
                    children: (0, $.jsx)(P, { ...(m ? R.forkIntoSameWorktree : R.forkIntoLocal) }),
                  }),
                  (0, $.jsx)(D.Item, {
                    onSelect: () => {
                      Qe();
                    ...
                    LeftIcon: oe,
                    disabled: !Ye,
                    children: (0, $.jsx)(P, { ...R.forkIntoWorktree }),
                  }),
                ],
              })
            : null,
          ...
          z
            ? (0, $.jsx)(D.Item, {
                onSelect: Be,
                LeftIcon: ct,
                children: (0, $.jsx)(P, { ...R.openInNewWindow }),
              })
            : null,
        ],
      }),
      A == null
        ...
        : (0, $.jsx)(se, {
            ...
            onClose: () => j(null),
            onSave: (t) => {
              b({ conversationId: e, title: t });
            },
          }),
      (0, $.jsx)(Ze, { heartbeatAutomationName: M, open: me, onOpenChange: O, onConfirm: $e }),
    ],
  });
}
function ht(e) {
  let t = (0, gt.c)(12),
    ...
    s;
  t[0] !== o?.items || t[1] !== r
    ? ((s = Ve({ automations: o?.items ?? [], conversationId: r, includePausedAutomations: !0 })),
      (t[0] = o?.items),
      (t[1] = r),
      (t[2] = s))
    : (s = t[2]);
  ...
  let f = !l && !n,
    ...
    m;
  t[6] === p ? (m = t[7]) : ((m = (0, $.jsx)(P, { ...p })), (t[6] = p), (t[7] = m));
  let h;
  return (
    t[8] !== u || t[9] !== f || t[10] !== m
      ? ((h = (0, $.jsx)(D.Item, { onSelect: u, LeftIcon: z, disabled: f, children: m })),
        (t[8] = u),
        (t[9] = f),
        (t[10] = m),
        (t[11] = h))
