...
async function ft(
  ...
  let u = _(l),
    ...
    p = u.openTab(
      e,
      (e) =>
        (0, X.jsx)(v, { fillParent: !0, debugName: `LocalConversationSideChatLoadingTab.pending` }),
      {
  ...
  try {
    let s = await lt({
      ...
      hostId: i,
      collaborationMode: a,
      instructionOverrides: N(e.get(A), e.get(P, n) ?? a?.settings.model ?? null),
    ...
    return (
      u.openTab(e, t, {
        ...
        onClose: () => {
          (Oe(e, n, s),
            M(`discard-conversation-from-cache`, { conversationId: s }).catch((e) => {
...
function mt({
  ...
  let { isPinned: P, togglePin: F } = se(e, { canPin: s }),
    ...
    Ne = p(x, `openSideChat`),
    { canOpenThreadInNewWindow: z, openThreadInNewWindow: Fe } = Ge({ conversationId: e }),
    B = p(Xe, e),
    Ie = B.isEligible,
    V = r != null && !Re(),
    Be = p(pe, e),
      ...
      e != null &&
        re({
          ...
          onArchiveStart:
            m === `home`
              ? () => {
                  D(`/`, { replace: !0, state: { focusComposerNonce: Date.now(), prefillCwd: i } });
                }
              : void 0,
        });
    },
  ...
  if (
    (Pe(
      ...
      () => {
        e != null &&
          t != null &&
          w({ conversationId: e, parentConversationId: n ?? null, getMarkdown: t });
      },
  ...
  return (0, $.jsxs)($.Fragment, {
    children: [
            ...
            ? (0, $.jsxs)(R.FlyoutSubmenuItem, {
                ...
                children: [
                  (0, $.jsx)(R.Item, {
                    ...
                    LeftIcon: d ? $e : et,
                    children: (0, $.jsx)(L, { ...(d ? S.forkIntoSameWorktree : S.forkIntoLocal) }),
                  }),
                  (0, $.jsx)(R.Item, {
                    onSelect: () => {
                      Qe();
      ...
      (0, $.jsx)(Ue, { heartbeatAutomationName: fe, open: ue, onOpenChange: O, onConfirm: rt }),
    ],
  });
}
function ht(e) {
  ...
  let f = !l && !n,
    ...
    m;
  t[6] === p ? (m = t[7]) : ((m = (0, $.jsx)(L, { ...p })), (t[6] = p), (t[7] = m));
  let h;
  return (
    t[8] !== u || t[9] !== f || t[10] !== m
      ? ((h = (0, $.jsx)(R.Item, { onSelect: u, LeftIcon: E, disabled: f, children: m })),
        (t[8] = u),
        (t[9] = f),
        (t[10] = m),
        (t[11] = h))
