...
import { _t as Ae, vt as je } from "./app-initial~app-main~automations-page.js";
import {
  Ba as Me,
  Cn as Ne,
  Gn as Pe,
...
async function ft(
  ...
  try {
    let s = await lt({
      ...
      hostId: a,
      collaborationMode: o,
      instructionOverrides: j(e.get(Te), e.get(F, r) ?? o?.settings.model ?? null),
...
function mt({
  ...
  let { isPinned: P, togglePin: F } = Ve(e, { canPin: u }),
    ...
    Ie = r(g, `openSideChat`),
    { canOpenThreadInNewWindow: B, openThreadInNewWindow: Le } = Ye({ conversationId: e }),
    H = r(Ae, e),
    Re = H.isEligible,
    U = s != null && !le(),
    ze = r(Oe, e),
      ...
      e != null &&
        oe({
          ...
          onArchiveStart:
            m === `home`
              ? () => {
                  T(`/`, { replace: !0, state: { focusComposerNonce: Date.now(), prefillCwd: c } });
                }
              : void 0,
        });
    },
  ...
  if (
    (de(
      ...
      () => {
        e != null &&
          t != null &&
          S({ conversationId: e, parentConversationId: i ?? null, getMarkdown: t });
      },
  ...
  return (0, $.jsxs)($.Fragment, {
    children: [
            ...
            ? (0, $.jsxs)(A.FlyoutSubmenuItem, {
                ...
                children: [
                  (0, $.jsx)(A.Item, {
                    ...
                    LeftIcon: f ? re : ne,
                    children: (0, $.jsx)(z, { ...(f ? V.forkIntoSameWorktree : V.forkIntoLocal) }),
                  }),
                  (0, $.jsx)(A.Item, {
                    onSelect: () => {
                      et();
      ...
      (0, $.jsx)(Je, { heartbeatAutomationName: ye, open: ue, onOpenChange: E, onConfirm: nt }),
    ],
  });
}
function ht(e) {
  ...
  let d = !l && !n,
    ...
    p;
  t[6] === f ? (p = t[7]) : ((p = (0, $.jsx)(z, { ...f })), (t[6] = f), (t[7] = p));
  let m;
  return (
    t[8] !== u || t[9] !== d || t[10] !== p
      ? ((m = (0, $.jsx)(A.Item, { onSelect: u, LeftIcon: U, disabled: d, children: p })),
        (t[8] = u),
        (t[9] = d),
        (t[10] = p),
        (t[11] = m))
