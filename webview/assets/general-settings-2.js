...
import { zs as c } from "./app-server-manager-signals.js";
import {
  A as l,
  _ as u,
  a as d,
...
import { t as v } from "./useQueries.js";
import {
  A as y,
  C as b,
  E as x,
...
import { i as A, l as j, s as M } from "./lib.js";
import { t as N } from "./clsx-Cir5-jBH.js";
import { n as P, y as F } from "./app-shell-state.js";
import { t as I } from "./button.js";
import { a as L, i as R } from "./setting-storage.js";
...
import { St as ee, _r as U, r as te, t as ne } from "./product-logger.js";
import { n as re } from "./rpc-Hf-fxjh7.js";
import { a as ie, l as ae, o as oe } from "./statsig.js";
import { t as se } from "./invalidate-queries-and-broadcast.js";
import { t as ce } from "./thread-context-inputs.js";
import { a as le, r as W, t as ue } from "./dropdown.js";
import {
  a as de,
  d as fe,
  i as pe,
...
import { t as be } from "./use-codex-home.js";
import { t as xe } from "./use-os-info.js";
import { t as Se } from "./use-platform.js";
import { t as Ce } from "./browser-sidebar-availability.js";
import { t as we } from "./chevron.js";
import { m as Te } from "./chunk-9.js";
import { n as Ee, t as De } from "./use-service-tier-settings.js";
import { i as Oe, n as ke, r as Ae, t as je } from "./thread-detail-level.js";
import { o as Me, r as Ne } from "./use-permissions-mode.js";
import { l as Pe } from "./diff-view-mode.js";
import { n as Fe, t as Ie } from "./file-diff.js";
import { t as Le } from "./terminal.js";
import { t as Re } from "./font-settings.js";
import { n as ze, t as Be } from "./use-resolved-theme-variant.js";
import { a as Ve, c as He, i as Ue, o as We, r as Ge, t as Ke } from "./locale-resolver.js";
import { t as qe } from "./copy-to-clipboard.js";
import { n as Je } from "./electron-menu-shortcuts.js";
import { l as Ye } from "./links-p.js";
import {
  c as Xe,
  i as Ze,
  l as Qe,
...
import { i as rt, n as it, t as at } from "./popover.js";
import { t as ot } from "./trash.js";
import { t as st } from "./copy.js";
...
import { t as _t } from "./use-enter-behavior.js";
import { n as vt, o as yt, t as bt } from "./permissions-mode-visibility.js";
import { i as xt, t as St } from "./settings-shared.js";
import { t as Ct } from "./settings-content-layout.js";
import { t as wt } from "./extension-info.js";
import { t as Tt } from "./sun.js";
import { r as J } from "./settings-row.js";
import { t as Et } from "./settings-surface.js";
import { y as Dt } from "./external-agent-import-step.js";
import { t as Y } from "./settings-group.js";
import { n as Ot, t as kt } from "./hotkey-window-state.js";
import { t as At } from "./segmented-toggle.js";
import { t as jt } from "./statsig-url-config.js";
import { t as Mt } from "./open-in-targets-query.js";
import { n as Nt, r as Pt, t as Ft } from "./keyboard-event-accelerator.js";
function It(e) {
  return e?.supported !== !1;
}
var Lt = d(o, `global-dictation-history`, { staleTime: g.FIVE_SECONDS }),
  Rt = d(o, `global-dictation-hotkey-state`, { staleTime: g.FIVE_SECONDS }),
  X = A({
    theme: {
  ...
  Q = e(t(), 1),
  $ = n(),
  zt = `const themePreview: ThemeConfig = {
  surface: "sidebar",
  accent: "#2563eb",
  contrast: 42,
};
`,
  Bt = `const themePreview: ThemeConfig = {
  surface: "sidebar-elevated",
  accent: "#0ea5e9",
  contrast: 68,
};
`,
  Vt = `-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif`,
  Ht = Fe(
    { name: `src/theme-preview.ts`, contents: zt },
    { name: `src/theme-preview.ts`, contents: Bt },
  );
function Ut() {
  let e = (0, Z.c)(11),
    t = ze(),
  ...
  if (e[0] !== t || e[1] !== n || e[2] !== i) {
    ...
    (e[5] !== n || e[6] !== i
      ? ((s = (e) =>
          (0, $.jsx)(Gt, { showCodeFont: n, showTranslucentSidebarToggle: i, variant: e }, e)),
        (e[5] = n),
        (e[6] = i),
        (e[7] = s))
      : (s = e[7]),
...
function Gt({ showCodeFont: e, showTranslucentSidebarToggle: t, variant: n }) {
  let r = i(o),
    a = j(),
    s = a.formatMessage(X.chromeThemeAccent),
    c = a.formatMessage(X.chromeThemeBackground),
    l = a.formatMessage(X.chromeThemeForeground),
    u = a.formatMessage(X.chromeThemeContrast),
    d = a.formatMessage(X.chromeThemeTranslucentSidebar),
    {
    ...
    O = [
      {
        ...
        key: `ui`,
        label: a.formatMessage(X.chromeThemeUiFont),
        placeholder: Vt,
      },
    ];
  e &&
    O.push({
      ...
      key: `code`,
      label: a.formatMessage(X.chromeThemeCodeFont),
      placeholder: Re,
    });
  let k = (e, t) => {
      switch (e) {
...
function qt(e) {
  ...
  t[18] === v
    ? (b = t[19])
    : ((b = (0, $.jsx)(I, { color: `ghost`, size: `toolbar`, onClick: v, children: y })),
      (t[18] = v),
      (t[19] = b));
  let x = !r,
    S;
  ...
  let w;
  t[24] !== C || t[25] !== b
    ? ((w = (0, $.jsx)(de, { children: (0, $.jsxs)(ge, { className: _e, children: [b, C] }) })),
      (t[24] = C),
      (t[25] = b),
      (t[26] = w))
    : (w = t[26]);
...
function Jt(e) {
  let t = (0, Z.c)(17),
    ...
    c;
  t[0] === a ? (c = t[1]) : ((c = (0, $.jsx)(et, { theme: a })), (t[0] = a), (t[1] = c));
  let l;
  t[2] === i.label
    ? (l = t[3])
    : ((l = (0, $.jsx)(`span`, {
...
function Xt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (l = t[0]);
  let u;
  t[1] === r ? (u = t[2]) : ((u = an(r)), (t[1] = r), (t[2] = u));
  let d;
  t[3] !== u || t[4] !== r
    ? ((d = { backgroundColor: r, color: u }), (t[3] = u), (t[4] = r), (t[5] = d))
    : (d = t[5]);
  let f;
  t[6] === r ? (f = t[7]) : ((f = an(r)), (t[6] = r), (t[7] = f));
  ...
  t[29] !== C || t[30] !== r
    ? ((w = (0, $.jsx)(it, {
        ...
        sideOffset: 8,
        onOpenAutoFocus: Zt,
        children: (0, $.jsx)(nt, { className: `h-34 w-34`, color: r, onChange: C }),
      })),
      (t[29] = C),
      (t[30] = r),
      (t[31] = w))
  ...
  return (
    t[32] !== a || t[33] !== S || t[34] !== w
      ? ((T = (0, $.jsxs)(at, { open: a, onOpenChange: l, children: [S, w] })),
        (t[32] = a),
        (t[33] = S),
        (t[34] = w),
        (t[35] = T))
...
function dn() {
  let e = (0, Z.c)(43),
    ...
    r = a(bt),
    s;
  e[0] === r ? (s = e[1]) : ((s = vt(r)), (e[0] = r), (e[1] = s));
  let l = s,
    u;
  ...
  if (e[3] !== d || e[4] !== f) {
    let t = Ne(f, d);
    ((p = ut({ ...d, defaultWorkspaceWriteMode: t })), (e[3] = d), (e[4] = f), (e[5] = p));
  } else p = e[5];
  let { showGuardianOption: m } = p,
    { value: h } = ie(ln),
    g;
  e[6] === h ? (g = e[7]) : ((g = un(h)), (e[6] = h), (e[7] = g));
  let _ = g,
    v;
  e[8] === _
    ? (v = e[9])
  ...
  e[10] === t
    ? (b = e[11])
    : ((b = (e, n) => {
        t.set(bt, (t) => yt({ mode: e, visible: n, settings: t }));
      }),
      (e[10] = t),
      (e[11] = b));
  let x = b,
  ...
  e[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(M, { ...q.permissions }) })), (e[12] = S))
    : (S = e[12]);
  let C, w;
  e[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (0, $.jsx)(M, { ...q.defaultPermissions })),
      (w = (0, $.jsx)(M, {
  ...
  e[17] === T
    ...
    : ((E = (0, $.jsx)(J, {
        label: C,
        description: w,
        control: (0, $.jsx)(K, { checked: !0, disabled: !0, onChange: fn, ariaLabel: T }),
      })),
      (e[17] = T),
      (e[18] = E));
  let D;
  ...
  e[30] === n
    ...
    : ((P = n.formatMessage({
      ...
      (e[31] = P));
  let F;
  e[32] !== A || e[33] !== N || e[34] !== P
    ? ((F = (0, $.jsx)(K, { checked: A, onChange: N, ariaLabel: P })),
      (e[32] = A),
      (e[33] = N),
      (e[34] = P),
      (e[35] = F))
  ...
  let I;
  e[36] !== k || e[37] !== F
    ? ((I = (0, $.jsx)(J, { label: O, description: k, control: F })),
      (e[36] = k),
      (e[37] = F),
      (e[38] = I))
    : (I = e[38]);
  ...
  return (
    e[39] !== E || e[40] !== D || e[41] !== I
      ? ((L = (0, $.jsxs)(Y, {
          className: `gap-2`,
          children: [S, (0, $.jsxs)(Et, { children: [E, D, I] })],
        })),
        (e[39] = E),
        (e[40] = D),
        (e[41] = I),
...
function pn() {
  let e = (0, Z.c)(55),
    ...
    n = j(),
    r = L(b.turnMode),
    a = L(b.permissionsEnabled),
    s = L(b.questionsEnabled),
    c = r ?? `unfocused`,
    l;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(M, { ...q.never })), (e[0] = l))
    : (l = e[0]);
  let u;
  e[1] === n ? (u = e[2]) : ((u = n.formatMessage(q.never)), (e[1] = n), (e[2] = u));
  let d;
  e[3] === u ? (d = e[4]) : ((d = { id: `off`, label: l, ariaLabel: u }), (e[3] = u), (e[4] = d));
  let f;
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, $.jsx)(M, { ...q.onlyWhenUnfocused })), (e[5] = f))
    : (f = e[5]);
  let p;
  e[6] === n ? (p = e[7]) : ((p = n.formatMessage(q.onlyWhenUnfocused)), (e[6] = n), (e[7] = p));
  let m;
  e[8] === p
    ? (m = e[9])
  ...
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, $.jsx)(M, { ...q.always })), (e[10] = h))
    : (h = e[10]);
  let g;
  e[11] === n ? (g = e[12]) : ((g = n.formatMessage(q.always)), (e[11] = n), (e[12] = g));
  let _;
  e[13] === g
    ? (_ = e[14])
  ...
  e[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(M, { ...q.turnCompletionNotifications })),
      (S = (0, $.jsx)(M, {
  ...
  e[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, $.jsx)(M, { ...q.permissionNotifications })),
      (O = (0, $.jsx)(M, {
  ...
  e[34] === n
    ? (N = e[35])
    : ((N = n.formatMessage(q.permissionNotifications)), (e[34] = n), (e[35] = N));
  let P;
  e[36] !== k || e[37] !== A || e[38] !== N
    ? ((P = (0, $.jsx)(J, {
        label: D,
        description: O,
        control: (0, $.jsx)(K, { checked: k, onChange: A, ariaLabel: N }),
      })),
      (e[36] = k),
      (e[37] = A),
      (e[38] = N),
  ...
  e[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, $.jsx)(M, { ...q.questionNotifications })),
      (I = (0, $.jsx)(M, {
  ...
  e[44] === n
    ? (H = e[45])
    : ((H = n.formatMessage(q.questionNotifications)), (e[44] = n), (e[45] = H));
  let ee;
  e[46] !== z || e[47] !== V || e[48] !== H
    ? ((ee = (0, $.jsx)(J, {
        label: F,
        description: I,
        control: (0, $.jsx)(K, { checked: z, onChange: V, ariaLabel: H }),
      })),
      (e[46] = z),
      (e[47] = V),
      (e[48] = H),
  ...
  let te;
  return (
    e[51] !== E || e[52] !== P || e[53] !== ee
      ? ((te = (0, $.jsxs)($.Fragment, { children: [E, P, ee, U] })),
        (e[51] = E),
        (e[52] = P),
        (e[53] = ee),
        (e[54] = te))
...
function mn() {
  let e = (0, Z.c)(12),
    t = i(o),
    n = j(),
    { authMethod: r, email: a, planAtLogin: s } = ye(),
    c = r === `chatgpt`,
    l;
  e[0] === c ? (l = e[1]) : ((l = { queryConfig: { enabled: c } }), (e[0] = c), (e[1] = l));
  let { data: u } = p(`account-info`, l),
    d = L(E.enabled);
  if (!D({ authMethod: r, email: u?.email ?? a, plan: u?.plan ?? s })) return null;
  let f, m;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, $.jsx)(M, { ...q.suggestedPrompts })),
      (m = (0, $.jsx)(M, {
  ...
  return (
    e[8] !== h || e[9] !== g || e[10] !== _
      ? ((v = (0, $.jsx)(J, {
          label: f,
          description: m,
          control: (0, $.jsx)(K, { checked: h, ariaLabel: g, onChange: _ }),
        })),
        (e[8] = h),
        (e[9] = g),
        (e[10] = _),
...
var hn = {
    chatgpt: `` + new URL(`icon-chatgpt-D0-PxdGO.png`, import.meta.url).href,
...
function _n() {
  let e = (0, Z.c)(23),
    t = j(),
    { isServiceTierAllowed: n } = Ee(),
    { serviceTierSettings: r, setServiceTier: i } = De();
  ...
  let l = r.isLoading,
    u;
  e[5] !== t || e[6] !== o.label
    ? ((u = ft(t, o.label)), (e[5] = t), (e[6] = o.label), (e[7] = u))
    : (u = e[7]);
  let d;
  e[8] !== r.isLoading || e[9] !== u
    ? ((d = (0, $.jsx)(St, { disabled: l, children: u })),
      (e[8] = r.isLoading),
      (e[9] = u),
      (e[10] = d))
    : (d = e[10]);
...
var vn = [
  { id: `coding`, icon: Le, value: je },
  { id: `everyday`, icon: Dt, value: ke },
];
function yn() {
  let e = (0, Z.c)(24),
    t = i(o),
    ...
    p,
    m;
  if (e[0] !== s || e[1] !== n || e[2] !== r || e[3] !== t) {
    let i = Ae(s),
      a = i === `STEPS_PROSE` ? `everyday` : `coding`;
    ((c = Y),
      (p = `gap-4`),
      e[11] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((m = (0, $.jsx)(Y.Header, {
            title: (0, $.jsx)(M, { ...q.workMode }),
            subtitle: (0, $.jsx)(M, {
      ...
      (f = vn.map((e) =>
        (0, $.jsx)(
          bn,
          {
            ...
            selected: a === e.id,
            onSelect: () => {
              (R(t, O.conversationDetailMode, e.value),
                r.logProductEvent(U, {
                  previousWorkMode: a,
                  selectedWorkMode: e.id,
                  previousThreadDetailLevel: i,
...
function bn(e) {
  ...
  t[11] === f
    ? (p = t[12])
    : ((p = N(`flex size-[17px] shrink-0 items-center justify-center rounded-full`, f)),
      (t[11] = f),
      (t[12] = p));
  ...
  t[13] === m
    ? (h = t[14])
    : ((h = N(`size-[7px] rounded-full bg-[color:var(--gray-0)]`, m)), (t[13] = m), (t[14] = h));
  let g;
  t[15] === h
    ? (g = t[16])
    ...
    case `everyday`: {
      ...
      return (
        t[1] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, $.jsx)(M, { ...q.forEverydayWork })), (t[1] = e))
          : (e = t[1]),
        e
      );
    }
...
var Cn = [`powershell`, `commandPrompt`, `gitBash`, `wsl`],
  wn,
  Tn = ``,
  En = [Tn],
  Dn = [`Jane Doe`, `Acme Widget`, `checkout-form.tsx`, `useCartState`],
  On = [`microphone-input-devices`];
function kn() {
  let e = (0, Z.c)(56),
    t = oe(`2423536643`),
    n = oe(`1244621283`),
    ...
    p;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(xt, { slug: `general-settings` })), (e[0] = p))
    : (p = e[0]);
  let m;
  e[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsxs)(G, { electron: !0, children: [(0, $.jsx)(yn, {}), (0, $.jsx)(dn, {})] })),
      (e[1] = m))
    : (m = e[1]);
  let h;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let _;
  e[4] !== u || e[5] !== l
    ? ((_ = l && u ? (0, $.jsx)(rr, {}) : null), (e[4] = u), (e[5] = l), (e[6] = _))
    : (_ = e[6]);
  let v;
  e[7] === _
    ? (v = e[8])
    : ((v = (0, $.jsxs)(G, { electron: !0, children: [g, _] })), (e[7] = _), (e[8] = v));
  let y, b, x;
  ...
  let S;
  e[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(G, { electron: !0, children: (0, $.jsx)($n, {}) })), (e[12] = S))
    : (S = e[12]);
  let C;
  e[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (0, $.jsx)(G, { electron: !0, children: (0, $.jsx)(hr, {}) })), (e[13] = C))
    : (C = e[13]);
  let w;
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(G, { electron: !0, children: (0, $.jsx)(gr, {}) })), (e[14] = w))
    : (w = e[14]);
  let T, E, D;
  e[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(G, { electron: !0, children: (0, $.jsx)(Dr, {}) })),
      (E = (0, $.jsx)(_n, {})),
      (D = (0, $.jsx)(xr, {})),
      (e[15] = T),
      (e[16] = E),
      (e[17] = D))
    : ((T = e[15]), (E = e[16]), (D = e[17]));
  let O;
  e[18] === s
    ? (O = e[19])
    : ((O = s ? (0, $.jsx)(G, { electron: !0, children: (0, $.jsx)(mn, {}) }) : null),
      (e[18] = s),
      (e[19] = O));
  let k = f.data?.roots,
    A;
  e[20] !== f.isLoading || e[21] !== d || e[22] !== k
    ? ((A = (0, $.jsx)(G, {
        electron: !0,
        children: (0, $.jsx)(Ze, {
          variant: `general-row`,
          codexHome: d,
          hostId: c,
          isActiveWorkspaceLoading: f.isLoading,
          workspaceRoots: k,
        }),
      })),
      (e[20] = f.isLoading),
  ...
  e[24] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, $.jsx)(G, { electron: !0, children: (0, $.jsx)(In, {}) })), (e[24] = j))
    : (j = e[24]);
  let N;
  e[25] !== O || e[26] !== A || e[27] !== v
    ? ((N = (0, $.jsxs)(Y, {
        className: `gap-2`,
        children: [
          h,
          (0, $.jsx)(Y.Content, {
            children: (0, $.jsxs)(Et, { children: [v, y, b, x, S, C, w, T, E, D, O, A, j] }),
          }),
        ],
      })),
      (e[25] = O),
  ...
  e[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, $.jsxs)(Y, {
        children: [
          ...
          (0, $.jsx)(Y.Content, {
            children: (0, $.jsxs)(Et, {
              children: [(0, $.jsx)(br, {}), (0, $.jsx)(yr, {}), (0, $.jsx)(Er, {})],
            }),
          }),
        ],
      })),
    ...
    : (F = e[30]);
  let I;
  e[31] === r ? (I = e[32]) : ((I = r ? (0, $.jsx)(Vn, {}) : null), (e[31] = r), (e[32] = I));
  let L;
  e[33] === I
    ? (L = e[34])
    : ((L = (0, $.jsx)(G, { electron: !0, children: I })), (e[33] = I), (e[34] = L));
  let R;
  e[35] === i ? (R = e[36]) : ((R = i ? (0, $.jsx)(An, {}) : null), (e[35] = i), (e[36] = R));
  let z;
  e[37] === R
    ? (z = e[38])
    : ((z = (0, $.jsx)(G, { electron: !0, children: R })), (e[37] = R), (e[38] = z));
  let B;
  e[39] !== n || e[40] !== o
    ? ((B = n && o ? (0, $.jsx)(Un, {}) : null), (e[39] = n), (e[40] = o), (e[41] = B))
    : (B = e[41]);
  let V;
  e[42] === B
    ? (V = e[43])
    : ((V = (0, $.jsx)(G, { electron: !0, children: B })), (e[42] = B), (e[43] = V));
  let H;
  e[44] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(M, { ...q.notifications }) })), (e[44] = H))
    : (H = e[44]);
  let ee;
  e[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, $.jsx)(G, {
        ...
        children: (0, $.jsxs)(Y, {
          children: [
            H,
            (0, $.jsx)(Y.Content, { children: (0, $.jsx)(Et, { children: (0, $.jsx)(pn, {}) }) }),
          ],
        }),
      })),
      (e[45] = ee))
    : (ee = e[45]);
  let U;
  e[46] === t ? (U = e[47]) : ((U = t ? (0, $.jsx)(Fn, {}) : null), (e[46] = t), (e[47] = U));
  let te;
  e[48] === U
    ? (te = e[49])
    : ((te = (0, $.jsx)(G, { electron: !0, children: U })), (e[48] = U), (e[49] = te));
  let ne;
  return (
    e[50] !== N || e[51] !== L || e[52] !== z || e[53] !== V || e[54] !== te
      ? ((ne = (0, $.jsxs)(Ct, { title: p, children: [m, N, F, L, z, V, ee, te] })),
        (e[50] = N),
        (e[51] = L),
        (e[52] = z),
        (e[53] = V),
...
function An() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(M, { ...q.realtimeVoice }) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
    e[1] === Symbol.for(`react.memo_cache_sentinel`)
...
function jn() {
  let e = (0, Z.c)(58),
    t = i(o),
    n = j(),
    r = L(C.microphoneInputDeviceId),
    a = typeof navigator < `u` && navigator.mediaDevices?.enumerateDevices != null,
    s;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = { enabled: a, queryFn: Nn, queryKey: On, staleTime: g.FIVE_SECONDS }), (e[0] = s))
    : (s = e[0]);
  let c = _(s),
    l,
    u,
  ...
  if (e[1] !== c.data || e[2] !== n || e[3] !== r) {
    ...
    (e[7] === n
      ? (t = e[8])
      : ((t = n.formatMessage(q.microphoneSystemDefault)), (e[7] = n), (e[8] = t)),
      (d = t));
    let i;
  ...
  e[15] === c
    ? (f = e[16])
    : ((f = async function () {
        (await re.systemPermissions?.requestMicrophoneAccess(), await c.refetch());
      }),
      (e[15] = c),
      (e[16] = f));
  let p = f,
  ...
  e[21] === u
    ...
    : ((y = (0, $.jsx)(St, {
      ...
      (e[21] = u),
      (e[22] = y));
  let b = r == null ? B : void 0,
    x;
  e[23] === t
    ? (x = e[24])
    : ((x = () => {
        R(t, C.microphoneInputDeviceId, null);
      }),
      (e[23] = t),
      (e[24] = x));
  let S;
  e[25] !== d || e[26] !== b || e[27] !== x
    ? ((S = (0, $.jsx)(W.Item, { RightIcon: b, onSelect: x, children: d })),
      (e[25] = d),
      (e[26] = b),
      (e[27] = x),
      (e[28] = S))
  ...
  e[29] === l.length
    ? (w = e[30])
    : ((w = l.length > 0 ? (0, $.jsx)(W.Separator, {}) : null), (e[29] = l.length), (e[30] = w));
  let T;
    ...
    (e[36] !== n || e[37] !== t || e[38] !== r
      ? ((i = (e, i) => {
          ...
          return (0, $.jsx)(
            W.Item,
            {
              RightIcon: e.deviceId === r ? B : void 0,
              onSelect: () => {
                R(t, C.microphoneInputDeviceId, e.deviceId);
              },
              children: a,
            },
            e.deviceId,
...
function Pn() {
  let e = (0, Z.c)(21),
    t = i(o),
    n = j(),
    r = L(C.realtimeVoiceAvatarMode),
    a;
  e[0] === t
    ? (a = e[1])
    : ((a = function (e) {
        R(t, C.realtimeVoiceAvatarMode, e);
      }),
      (e[0] = t),
      (e[1] = a));
  let s = a,
    ...
    l;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(M, { ...q.realtimeVoiceAvatar })),
      (l = (0, $.jsx)(M, {
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(M, { ...q.realtimeVoiceAvatarOrb })), (e[4] = u))
    : (u = e[4]);
  let d;
  e[5] === n
    ? (d = e[6])
    : ((d = n.formatMessage(q.realtimeVoiceAvatarOrb)), (e[5] = n), (e[6] = d));
  let f;
  e[7] === d ? (f = e[8]) : ((f = { id: `orb`, label: u, ariaLabel: d }), (e[7] = d), (e[8] = f));
  let p;
  e[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(M, { ...q.realtimeVoiceAvatarPet })), (e[9] = p))
    : (p = e[9]);
  let m;
  e[10] === n
    ? (m = e[11])
    : ((m = n.formatMessage(q.realtimeVoiceAvatarPet)), (e[10] = n), (e[11] = m));
  let h;
  e[12] === m
    ? (h = e[13])
  ...
  let _;
  return (
    e[17] !== s || e[18] !== r || e[19] !== g
      ? ((_ = (0, $.jsx)(J, {
          label: c,
          description: l,
          control: (0, $.jsx)(At, { selectedId: r, onSelect: s, options: g }),
        })),
        (e[17] = s),
        (e[18] = r),
        (e[19] = g),
...
function Fn() {
  ...
  if (e[0] !== n || e[1] !== t || e[2] !== r) {
    ...
    ((l = Y),
      ...
      (e[6] = u),
      (e[7] = d));
  } else ((s = e[3]), (c = e[4]), (l = e[5]), (u = e[6]), (d = e[7]));
  let f;
  e[9] !== s || e[10] !== u
    ? ((f = (0, $.jsx)(s, { children: u })), (e[9] = s), (e[10] = u), (e[11] = f))
    : (f = e[11]);
  let p;
  e[12] !== c || e[13] !== f
...
function In() {
  let e = (0, Z.c)(7),
    ...
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((n = (0, $.jsx)(M, { ...q.openSourceLicenses })),
      (r = (0, $.jsx)(M, {
  ...
  return (
    e[5] === i
      ...
      : ((o = (0, $.jsx)(J, {
          label: n,
          description: r,
          control: (0, $.jsx)(I, { color: `secondary`, size: `toolbar`, onClick: i, children: a }),
        })),
        (e[5] = i),
        (e[6] = o)),
    o
...
function Ln() {
  ...
  e[1] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((r = e[1]), (i = e[2]));
  let a;
  e[3] === t ? (a = e[4]) : ((a = t ? (0, $.jsx)(wr, {}) : null), (e[3] = t), (e[4] = a));
  let o, s;
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(_r, {})), (s = (0, $.jsx)(Tr, {})), (e[5] = o), (e[6] = s))
    : ((o = e[5]), (s = e[6]));
  let c;
  e[7] === a
    ? (c = e[8])
    : ((c = (0, $.jsx)(Y, {
        children: (0, $.jsx)(Y.Content, {
          children: (0, $.jsxs)(Et, { children: [r, i, a, o, s] }),
        }),
      })),
      (e[7] = a),
      (e[8] = c));
  let l;
  e[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(G, { electron: !0, children: (0, $.jsx)(pr, {}) })), (e[9] = l))
    : (l = e[9]);
  let u;
  return (
    e[10] === c
      ? (u = e[11])
      : ((u = (0, $.jsxs)($.Fragment, { children: [c, l] })), (e[10] = c), (e[11] = u)),
    u
  );
}
function Rn() {
  let e = (0, Z.c)(1),
    t = re.hotkeyWindowHotkeys;
  if (t == null) return null;
  let n;
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, $.jsx)(zn, { hotkeyWindowHotkeys: t })), (e[0] = n))
      : (n = e[0]),
    n
  );
}
function zn(e) {
  ...
  t[2] !== c || t[3] !== r
    ? ((_ = async (e) => {
        (r.query.setData(Ot, e.state),
          await Promise.all([c(kt), c(m(`codex-command-keymap-state`))]));
      }),
      (t[2] = c),
      (t[3] = r),
      (t[4] = _))
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(M, { ...q.popoutWindowHotkey })), (t[14] = T))
    : (T = t[14]);
  let E;
  ...
  t[18] === D
    ...
    : ((O = (0, $.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [E, D] })),
      ...
      (t[19] = O));
  let k;
  t[20] !== x || t[21] !== S || t[22] !== w || t[23] !== s || t[24] !== l || t[25] !== y
    ? ((k = l
        ? (0, $.jsxs)(`div`, {
            className: `flex items-center gap-2`,
            children: [
  ...
  return (
    t[27] !== k || t[28] !== O
      ? ((A = (0, $.jsx)(J, { label: T, description: O, control: k })),
        (t[27] = k),
        (t[28] = O),
        (t[29] = A))
      : (A = t[29]),
...
function Vn() {
  let e = (0, Z.c)(2),
    t;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(M, { ...q.popoutWindow }) })), (e[0] = t))
    : (t = e[0]);
  let n;
  return (
    e[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, $.jsxs)(Y, {
          children: [
            t,
            (0, $.jsx)(Y.Content, {
              children: (0, $.jsxs)(Et, { children: [(0, $.jsx)(Rn, {}), (0, $.jsx)(Hn, {})] }),
            }),
          ],
        })),
        (e[1] = n))
...
function Hn() {
  let e = (0, Z.c)(10),
    t = i(o),
    n = j(),
    r = L(C.hotkeyWindowProjectlessDefaultEnabled),
    a,
    s;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(M, { ...q.projectlessChat })),
      (s = (0, $.jsx)(M, {
  ...
  e[2] === t
    ? (l = e[3])
    : ((l = (e) => {
        R(t, C.hotkeyWindowProjectlessDefaultEnabled, e);
      }),
      (e[2] = t),
      (e[3] = l));
  let u;
...
function Un() {
  ...
  let n;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((n = (0, $.jsx)(Y.Header, { title: (0, $.jsx)(M, { ...q.dictation }) })), (e[0] = n))
    : (n = e[0]);
  let r;
  e[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(jn, {})), (e[1] = r))
  ...
  e[2] === t
    ? ((i = e[3]), (o = e[4]), (s = e[5]))
    : ((i = (0, $.jsx)(Jn, { hotkeyState: t, mode: `hold` })),
      (o = (0, $.jsx)(Jn, { hotkeyState: t, mode: `toggle` })),
      (s = (0, $.jsx)(Wn, { hotkeyState: t })),
      (e[2] = t),
      (e[3] = i),
      (e[4] = o),
      (e[5] = s));
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(Gn, {})), (l = (0, $.jsx)(Xn, {})), (e[6] = c), (e[7] = l))
    : ((c = e[6]), (l = e[7]));
  let u;
  return (
    e[8] !== i || e[9] !== o || e[10] !== s
      ? ((u = (0, $.jsxs)(Y, {
          children: [
            n,
            (0, $.jsx)(Y.Content, { children: (0, $.jsxs)(Et, { children: [r, i, o, s, c, l] }) }),
          ],
        })),
        (e[8] = i),
        (e[9] = o),
...
function Wn(e) {
  ...
  t[0] !== a || t[1] !== i
    ? ((o = {
      ...
      (t[2] = o))
    : (o = t[2]);
  let s = h(`global-dictation-set-keep-visible`, o),
    c,
    u;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(M, { ...q.keepGlobalDictationVisible })),
      (u = (0, $.jsx)(M, {
  ...
  let _;
  return (
    t[9] !== d || t[10] !== f || t[11] !== p || t[12] !== g
      ? ((_ = (0, $.jsx)(J, {
          label: c,
          description: u,
          control: (0, $.jsx)(K, { checked: d, disabled: f, onChange: p, ariaLabel: g }),
        })),
        (t[9] = d),
        (t[10] = f),
        (t[11] = p),
...
function Gn() {
  let e = (0, Z.c)(22),
    t = i(o),
    n = j(),
    r = L(C.dictationDictionary),
    [a, s] = (0, Q.useState)(null),
    [c, l] = (0, Q.useState)(!1),
    u = (0, Q.useRef)(!1),
    d = a ?? r,
    f = d != null && d.length > 0 ? d : En,
    p;
  e[0] === c
    ? (p = e[1])
    : ((p = function () {
  ...
  e[2] === t
    ? (h = e[3])
    : ((h = async function (e) {
        let n = e.map(qn).filter(Kn);
        (await R(t, C.dictationDictionary, n), s(null));
      }),
      (e[2] = t),
      (e[3] = h));
  let g = h,
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(M, { ...q.dictationDictionary }),
      })),
      (e[4] = _))
    : (_ = e[4]);
  let v;
  ...
  e[6] === y
    ? (b = e[7])
    : ((b = N(`icon-xs shrink-0 text-token-input-placeholder-foreground transition-transform`, y)),
      (e[6] = y),
      (e[7] = b));
  let x;
  e[8] === b ? (x = e[9]) : ((x = (0, $.jsx)(we, { className: b })), (e[8] = b), (e[9] = x));
  let S;
                      ...
                      children: [
                        (0, $.jsx)(`input`, {
                          ...
                          onKeyDown: (e) => {
                            if (e.key !== `Enter`) return;
                            e.preventDefault();
                            let n = [...f.slice(0, t + 1), Tn, ...f.slice(t + 1)];
                            ((u.current = !0),
                              s(n),
                        ...
                        (0, $.jsx)(I, {
                          ...
                          children: (0, $.jsx)(ot, { className: `icon-2xs` }),
                        }),
                      ],
                    },
                    t,
  ...
  return (
    e[19] !== S || e[20] !== w
      ? ((T = (0, $.jsxs)(`div`, { children: [S, w] })), (e[19] = S), (e[20] = w), (e[21] = T))
      : (T = e[21]),
    T
  );
}
...
function Jn(e) {
  ...
  t[0] !== c || t[1] !== s
    ? ((y = {
      ...
      (t[2] = y))
    : (y = t[2]);
  let b = h(r === `hold` ? `global-dictation-set-hotkey` : `global-dictation-set-toggle-hotkey`, y),
    x;
  t[3] !== a || t[4] !== i || t[5] !== b
    ? ((x = async function (e) {
        v(null);
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = function () {
        ((u.current += 1), (d.current = null), g(!1));
      }),
      (t[7] = C))
    : (C = t[7]);
  let w = C,
  ...
  t[8] === S
    ? (T = t[9])
    : ((T = function (e) {
        ((u.current += 1), (d.current = null), g(!1), S(e));
      }),
      (t[8] = S),
      (t[9] = T));
  let E = T,
  ...
  t[12] !== O || t[13] !== o
    ? ((k = function () {
        (v(null), g(!0), (u.current += 1), (d.current = null), o === `macOS` && O(u.current));
      }),
      (t[12] = O),
      (t[13] = o),
      (t[14] = k))
    : (k = t[14]);
  let A = k,
    N = i ? (n?.configuredToggleHotkey ?? null) : (n?.configuredHotkey ?? null),
    P;
  t[15] !== N || t[16] !== a
    ? ((P =
        N == null
  ...
  t[18] === i
    ? (L = t[19])
    : ((L = i
        ? (0, $.jsx)(M, { ...q.toggleDictationHotkey })
        : (0, $.jsx)(M, { ...q.holdToDictateHotkey })),
      (t[18] = i),
      (t[19] = L));
  let R;
  t[20] === i
            ...
            children: [
              (0, $.jsx)(`input`, {
                ...
                onKeyUp: (e) => {
                  ...
                  let t = Pt(e.nativeEvent);
                  t != null && d.current === t && E(t);
                },
                "aria-label": i
                  ? a.formatMessage({
...
function Xn() {
  ...
  if (e[0] !== r || e[1] !== n?.items || e[2] !== t) {
    ...
    bb0: {
      let a = n?.items.filter(Zn).slice(0, 4);
      if (a == null || a.length === 0) {
        let t;
        e[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(`div`, {
              className: `text-sm text-token-text-primary`,
              children: (0, $.jsx)(M, { ...q.recentDictations }),
            })),
            (e[5] = t))
          : (t = e[5]);
        let n;
...
function Qn(e) {
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, $.jsx)(st, { className: `icon-sm` })), (t[9] = f))
    : (f = t[9]);
  let p;
  ...
  let m;
  t[14] !== c || t[15] !== p
    ? ((m = (0, $.jsx)(V, { tooltipContent: c, children: p })),
      (t[14] = c),
      (t[15] = p),
      (t[16] = m))
    : (m = t[16]);
...
function $n() {
  let e = (0, Z.c)(10),
    ...
    n = j(),
    { platform: r } = Se(),
    a = L(x.macMenuBarEnabled);
  if (r !== `macOS`) return null;
  let s, c;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, $.jsx)(M, { ...q.showInMenuBar })),
      (c = (0, $.jsx)(M, {
...
function er() {
  let e = (0, Z.c)(39),
    ...
    n = se(),
    i;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((i = { cwd: null }), (e[0] = i)) : (i = e[0]);
  let { data: a } = r(Mt, i),
    o;
  e[1] !== n || e[2] !== t
    ? ((o = {
  ...
  if (e[4] !== a?.preferredTarget || e[5] !== a?.targets || e[6] !== s) {
    let t = a?.targets ?? [],
      n = a?.preferredTarget ?? t.find(nr)?.target ?? null,
      r = t.filter(tr),
      i = r.find((e) => e.target === n);
    ((u = J),
      e[17] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((y = (0, $.jsx)(M, { ...q.defaultFileOpenDestination })),
          (b = (0, $.jsx)(M, {
    ...
    let o = r.length === 0,
      l = i
        ? (0, $.jsx)(cr, { icon: i.icon, label: i.label })
        : (0, $.jsx)(M, {
    ...
    (e[19] !== o || e[20] !== l
      ? ((g = (0, $.jsx)(St, { disabled: o, children: l })), (e[19] = o), (e[20] = l), (e[21] = g))
      : (g = e[21]),
      (_ = r.length === 0),
      (v = `end`),
      ...
      : ((m = (e) =>
          (0, $.jsx)(
            W.Item,
            {
              ...
              children: (0, $.jsx)(cr, { icon: e.icon, label: e.label }),
            },
            e.id,
          )),
        (e[22] = s),
  ...
  e[24] !== d || e[25] !== f
    ...
    : (x = e[26]);
  let S;
  e[27] !== c || e[28] !== x || e[29] !== p || e[30] !== g || e[31] !== _ || e[32] !== v
    ? ((S = (0, $.jsx)(c, {
        contentWidth: p,
        triggerButton: g,
        disabled: _,
  ...
  let C;
  return (
    e[34] !== u || e[35] !== S || e[36] !== y || e[37] !== b
      ? ((C = (0, $.jsx)(u, { label: y, description: b, control: S })),
        (e[34] = u),
        (e[35] = S),
        (e[36] = y),
        (e[37] = b),
...
function rr() {
  let e = (0, Z.c)(11),
    t = i(o),
    n = L(x.openLinkInTargetPreference),
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  e[3] === n
    ? (l = e[4])
    : ((l = (0, $.jsx)(St, { children: (0, $.jsx)(ir, { target: n }) })), (e[3] = n), (e[4] = l));
  let u;
  e[5] !== t || e[6] !== n
    ? ((u = (0, $.jsx)(`div`, {
        ...
        children: a.map((e) =>
          (0, $.jsx)(
            ...
            {
              onSelect: () => {
                R(t, x.openLinkInTargetPreference, e);
              },
              RightIcon: n === e ? B : void 0,
              children: (0, $.jsx)(`span`, {
                className: `text-sm`,
                children: (0, $.jsx)(ir, { target: e }),
              }),
            },
            e,
          ),
...
function ar() {
  ...
  e[0] === r
    ? (a = e[1])
    : ((a = { queryConfig: { enabled: r, staleTime: g.ONE_MINUTE } }), (e[0] = r), (e[1] = a));
  let { data: s, isLoading: c } = p(`terminal-shell-options`, a),
    l = L(C.integratedTerminalShell);
  if (!r) return null;
  let u;
  e[2] === s?.availableShells
    ? (u = e[3])
    : ((u = s?.availableShells ?? []), (e[2] = s?.availableShells), (e[3] = u));
  let d = u,
    f,
    m,
    h,
  ...
  if (e[4] !== d || e[5] !== l || e[6] !== c || e[7] !== t) {
    ...
    ((m = J),
      e[19] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((x = (0, $.jsx)(M, { ...q.integratedTerminalShell })),
          (S = (0, $.jsx)(M, {
    ...
    (e[21] !== o || e[22] !== s
      ? ((v = (0, $.jsx)(St, { disabled: o, children: s })), (e[21] = o), (e[22] = s), (e[23] = v))
      : (v = e[23]),
      (y = `end`),
      (b = o),
      (h = `w-[220px] max-w-xs`));
    ...
    (e[24] !== t || e[25] !== i
      ? ((u = (e) =>
          (0, $.jsx)(
            ...
            {
              onSelect: () => {
                R(t, C.integratedTerminalShell, e);
              },
              RightIcon: i === e ? B : void 0,
              children: (0, $.jsx)(`span`, {
                className: `text-sm`,
                children: (0, $.jsx)(sr, { value: e }),
              }),
            },
            e,
          )),
  ...
  let w;
  e[27] !== h || e[28] !== _
    ? ((w = (0, $.jsx)(`div`, { className: h, children: _ })),
      (e[27] = h),
      (e[28] = _),
      (e[29] = w))
    : (w = e[29]);
  let T;
  e[30] !== f || e[31] !== v || e[32] !== y || e[33] !== b || e[34] !== w
    ? ((T = (0, $.jsx)(f, { triggerButton: v, align: y, disabled: b, children: w })),
      (e[30] = f),
      (e[31] = v),
      (e[32] = y),
      (e[33] = b),
  ...
  let E;
  return (
    e[36] !== m || e[37] !== T || e[38] !== x || e[39] !== S
      ? ((E = (0, $.jsx)(m, { label: x, description: S, control: T })),
        (e[36] = m),
        (e[37] = T),
        (e[38] = x),
        (e[39] = S),
...
function or() {
  let e = i(o),
    ...
    u = dt(),
    d = L(C.runCodexInWsl);
  if (!c || d === void 0) return null;
  wn ??= d;
  let p = [
      {
        value: !1,
        label: (0, $.jsx)(M, { ...q.windowsNative }),
        description: (0, $.jsx)(M, {
      ...
      {
        value: !0,
        label: (0, $.jsx)(M, { ...q.windowsSubsystemForLinux }),
        description: (0, $.jsx)(M, {
    ...
    m = p.find((e) => e.value === d) ?? p[0],
    h = p.find((e) => e.value === wn) ?? m,
    g = d !== wn,
    _ = u.isPending || a;
  return (0, $.jsx)(J, {
    label: (0, $.jsx)(M, { ...q.agentEnvironment }),
    ...
    control: (0, $.jsx)(ue, {
      triggerButton: (0, $.jsxs)(St, {
        disabled: _,
        children: [
          a ? (0, $.jsx)(z, { className: `icon-2xs text-token-text-secondary` }) : null,
          m.label,
        ],
      }),
      disabled: _,
          ...
          (0, $.jsx)(
            W.Item,
            {
              onSelect: () => {
                (async () => {
                  if ((r(null), !t.value)) {
                    await R(e, C.runCodexInWsl, t.value);
                    return;
                  }
                  s(!0);
                  try {
                    let n;
                    try {
                      n = await f(`wsl-bash-availability`);
                    } catch {
                      r({ distro: null });
                      return;
                    }
...
function lr() {
  let e = (0, Z.c)(48),
    t = i(o),
    n = j(),
    r = ae(`72216192`)?.get(`enable_i18n`, !0),
    [a, s] = (0, Q.useState)(``),
    c = L(C.localeOverride),
    l;
  e[0] === n.locale
    ? (l = e[1])
    : ((l = [
        { code: Ke, label: Ue(Ke, Ke), localizedLabel: Ue(`en`, n.locale) },
        ...Ge().map((e) => ({
          code: e.locale,
          label: Ue(e.locale, e.locale),
          localizedLabel: Ue(e.locale, n.locale),
        })),
      ].sort(ur)),
      (e[0] = n.locale),
      (e[1] = l));
  let u = l,
    ...
    f;
  e[2] !== u || e[3] !== c
    ? ((f = u.find((e) => We(e.code, c)) ?? null), (e[2] = u), (e[3] = c), (e[4] = f))
    : (f = e[4]);
  let p = f,
    m;
  if (e[5] !== a || e[6] !== u) {
  ...
  e[8] === t
    ? (g = e[9])
    : ((g = (e) => {
        ne(t, ee, { selection: e ?? `auto`, surface: `settings` });
      }),
      (e[8] = t),
      (e[9] = g));
  let _ = g,
  ...
  let w;
  e[15] !== x || e[16] !== S
    ? ((w = (0, $.jsx)(St, { disabled: x, children: S })), (e[15] = x), (e[16] = S), (e[17] = w))
    : (w = e[17]);
  let T;
  e[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (e) => s(e.target.value)), (e[18] = T))
    : (T = e[18]);
  let E;
  e[19] === n
    ? (E = e[20])
  ...
  e[21] !== a || e[22] !== E
    ? ((D = (0, $.jsx)(`div`, {
        className: `pb-1`,
        children: (0, $.jsx)(le, { value: a, onChange: T, placeholder: E }),
      })),
      (e[21] = a),
      (e[22] = E),
      (e[23] = D))
    : (D = e[23]);
  let O = d == null ? B : void 0,
    k;
  e[24] !== _ || e[25] !== t
    ? ((k = () => {
        (async () => {
          try {
            (await R(t, C.localeOverride, null), _(null));
          } catch {}
        })();
      }),
      (e[24] = _),
  ...
  e[27] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, $.jsx)(M, { ...q.autoDetectLanguage })), (e[27] = A))
    : (A = e[27]);
  let N;
  e[28] !== O || e[29] !== k
    ? ((N = (0, $.jsx)(W.Item, { RightIcon: O, onSelect: k, children: A })),
      (e[28] = O),
      (e[29] = k),
      (e[30] = N))
    : (N = e[30]);
          ...
          return (0, $.jsx)(
            W.Item,
            {
              ...
              onSelect: () => {
                (async () => {
                  try {
                    let n = Ve(e.code) ? Ke : e.code;
                    (await R(t, C.localeOverride, n), _(n));
                  } catch {}
                })();
              },
              children: (0, $.jsxs)(`span`, {
  ...
  e[40] === P
    ? (F = e[41])
    : ((F = (0, $.jsx)(`div`, { className: `max-h-80 overflow-y-auto`, children: P })),
      (e[40] = P),
      (e[41] = F));
  let I;
  return (
    e[42] !== D || e[43] !== N || e[44] !== F || e[45] !== b || e[46] !== w
      ? ((I = (0, $.jsx)(J, {
          label: v,
          description: y,
          control: (0, $.jsxs)(ue, {
...
function dr() {
  ...
  e[19] !== v || e[20] !== f || e[21] !== h
    ? ((b = [f, h, v]), (e[19] = v), (e[20] = f), (e[21] = h), (e[22] = b))
    : (b = e[22]);
  let x;
  return (
    e[23] !== s || e[24] !== r || e[25] !== b
      ? ((x = (0, $.jsx)(J, {
          label: c,
          description: l,
          control: (0, $.jsx)(At, { selectedId: r, onSelect: s, options: b }),
        })),
        (e[23] = s),
        (e[24] = r),
        (e[25] = b),
...
function fr() {
  let e = i(o),
    t = j(),
    n = L(y.usePointerCursors);
  return (0, $.jsx)(J, {
    label: (0, $.jsx)(M, { ...X.pointerCursors }),
    description: (0, $.jsx)(M, {
...
function pr() {
  let e = (0, Z.c)(37),
    ...
    { platform: r } = Se(),
    { data: s } = a(wt),
    c = L(y.dockIconPreference);
  if (r !== `macOS` || hn == null || s?.buildFlavor === S.Agent) return null;
  let { chatgpt: l, codexDark: u, codexLight: d } = hn,
    f = s?.appBrand ?? T.Codex,
    p = s?.appIconMedium ?? (f === T.ChatGPT ? l : d),
    m,
    h,
    g,
    _,
  ...
  if (e[0] !== f || e[1] !== c || e[2] !== n || e[3] !== t || e[4] !== p) {
    let r = [
      { id: `app-default`, imageUrl: p, label: X.dockIconDefault },
      { id: `codex-light`, imageUrl: d, label: X.dockIconCodexLight },
      { id: `codex-dark`, imageUrl: u, label: X.dockIconCodexDark },
    ];
    ((g = Y), (C = `gap-2`));
    let i;
    e[14] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((i = (0, $.jsx)(M, { ...X.dockIcon })), (e[14] = i))
      : (i = e[14]);
    let a;
    (e[15] === f ? (a = e[16]) : ((a = w(f)), (e[15] = f), (e[16] = a)),
      ...
      (v = `radiogroup`),
      e[19] === n ? (b = e[20]) : ((b = n.formatMessage(X.dockIcon)), (e[19] = n), (e[20] = b)),
      (x = r.map((e) =>
        (0, $.jsx)(
          mr,
          {
            imageUrl: e.imageUrl,
            label: (0, $.jsx)(M, { ...e.label }),
            selected: e.id === c,
            onSelect: () => {
              R(t, y.dockIconPreference, e.id);
            },
    ...
    ((m = e[5]),
      ...
      (E = e[13]));
  let D;
  e[21] !== _ || e[22] !== v || e[23] !== b || e[24] !== x
    ? ((D = (0, $.jsx)(`div`, { className: _, role: v, "aria-label": b, children: x })),
      (e[21] = _),
      (e[22] = v),
      (e[23] = b),
      (e[24] = x),
  ...
  let O;
  e[26] !== m || e[27] !== D
    ? ((O = (0, $.jsx)(m, { children: D })), (e[26] = m), (e[27] = D), (e[28] = O))
    : (O = e[28]);
  let k;
  e[29] !== h || e[30] !== O
    ? ((k = (0, $.jsx)(h, { children: O })), (e[29] = h), (e[30] = O), (e[31] = k))
    : (k = e[31]);
  let A;
  return (
    e[32] !== g || e[33] !== C || e[34] !== E || e[35] !== k
      ? ((A = (0, $.jsxs)(g, { className: C, children: [E, k] })),
        (e[32] = g),
        (e[33] = C),
        (e[34] = E),
        (e[35] = k),
...
function mr(e) {
  ...
  t[6] === d
    ? (f = t[7])
    : ((f = N(`flex size-[17px] shrink-0 items-center justify-center rounded-full`, d)),
      (t[6] = d),
      (t[7] = f));
  ...
  t[8] === p
    ? (m = t[9])
    : ((m = N(`size-[7px] rounded-full bg-[color:var(--gray-0)]`, p)), (t[8] = p), (t[9] = m));
  let h;
  t[10] === m
    ? (h = t[11])
...
function hr() {
  ...
  e[2] === t
    ...
    : ((l = (e) => {
      ...
      (e[3] = l));
  let u;
  e[4] === n ? (u = e[5]) : ((u = n.formatMessage(q.bottomPanel)), (e[4] = n), (e[5] = u));
  let d;
  return (
    e[6] !== r || e[7] !== l || e[8] !== u
      ? ((d = (0, $.jsx)(J, {
          label: s,
          description: c,
          control: (0, $.jsx)(K, { checked: r, onChange: l, ariaLabel: u }),
        })),
        (e[6] = r),
        (e[7] = l),
        (e[8] = u),
...
function gr() {
  let e = (0, Z.c)(21),
    t = i(o),
    n = j(),
    r = L(C.defaultTerminalLocation);
  if (a(P) === !1) return null;
  let s;
  e[0] === t
    ? (s = e[1])
    : ((s = function (e) {
        R(t, C.defaultTerminalLocation, e);
      }),
      (e[0] = t),
      (e[1] = s));
  let c = s,
    ...
    u;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, $.jsx)(M, { ...q.defaultTerminalLocation })),
      (u = (0, $.jsx)(M, {
  ...
  let d;
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(M, { ...q.terminalLocationBottom })), (e[4] = d))
    : (d = e[4]);
  let f;
  e[5] === n
    ? (f = e[6])
    : ((f = n.formatMessage(q.terminalLocationBottom)), (e[5] = n), (e[6] = f));
  let p;
  e[7] === f
    ? (p = e[8])
  ...
  let m;
  e[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(M, { ...q.terminalLocationRight })), (e[9] = m))
    : (m = e[9]);
  let h;
  e[10] === n
    ? (h = e[11])
    : ((h = n.formatMessage(q.terminalLocationRight)), (e[10] = n), (e[11] = h));
  let g;
  e[12] === h
    ? (g = e[13])
  ...
  return (
    e[17] !== r || e[18] !== c || e[19] !== _
      ? ((v = (0, $.jsx)(J, {
          label: l,
          description: u,
          control: (0, $.jsx)(At, { selectedId: r, onSelect: c, options: _ }),
        })),
        (e[17] = r),
        (e[18] = c),
        (e[19] = _),
...
function _r() {
  let e = (0, Z.c)(21),
    t = i(o),
    n = j(),
    r = L(y.diffMarkerStyle),
    a;
  e[0] === t
    ? (a = e[1])
    : ((a = function (e) {
        R(t, y.diffMarkerStyle, e);
      }),
      (e[0] = t),
      (e[1] = a));
  let s = a,
...
function vr() {
  let e = (0, Z.c)(27),
    t = i(o),
    n = j(),
    r = L(y.reducedMotionPreference),
    a;
  e[0] === t
    ? (a = e[1])
    : ((a = function (e) {
        R(t, y.reducedMotionPreference, e);
      }),
      (e[0] = t),
      (e[1] = a));
  let s = a,
  ...
  let u;
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(M, { ...X.reducedMotionSystem })), (e[4] = u))
    : (u = e[4]);
  let d;
...
function yr() {
  let e = (0, Z.c)(27),
    ...
    { enterBehavior: a } = _t(),
    s;
  e[0] === a ? (s = e[1]) : ((s = Je(mt(a))), (e[0] = a), (e[1] = s));
  let c = s,
    l;
  e[2] === t
    ? (l = e[3])
    : ((l = function (e) {
        R(t, C.followUpQueueMode, e);
      }),
      (e[2] = t),
      (e[3] = l));
  let u = l,
    d;
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, $.jsx)(M, { ...q.followUpBehavior })), (e[4] = d))
    : (d = e[4]);
  let f;
  e[5] === c
    ? (f = e[6])
  ...
  e[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(M, { ...q.queue })), (e[7] = p))
    : (p = e[7]);
  let m;
  e[8] === n ? (m = e[9]) : ((m = n.formatMessage(q.queue)), (e[8] = n), (e[9] = m));
  let h;
  e[10] === m
    ? (h = e[11])
  ...
  let g;
  e[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, $.jsx)(M, { ...q.steer })), (e[12] = g))
    : (g = e[12]);
  let _;
  e[13] === n ? (_ = e[14]) : ((_ = n.formatMessage(q.steer)), (e[13] = n), (e[14] = _));
  let v;
  e[15] === _
    ? (v = e[16])
  ...
  e[20] !== u || e[21] !== r || e[22] !== y
    ? ((b = (0, $.jsx)(At, { selectedId: r, onSelect: u, options: y })),
      (e[20] = u),
      (e[21] = r),
      (e[22] = y),
      (e[23] = b))
  ...
  return (
    e[24] !== b || e[25] !== f
      ? ((x = (0, $.jsx)(J, { className: `gap-6`, label: d, description: f, control: b })),
        (e[24] = b),
        (e[25] = f),
        (e[26] = x))
      : (x = e[26]),
...
function br() {
  let e = (0, Z.c)(9),
    t = i(o),
    n = j(),
    r = L(C.showContextWindowUsage),
    a;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(M, { ...q.showContextWindowUsage })), (e[0] = a))
    : (a = e[0]);
  let s = r === !0,
    c;
  e[1] === t
    ? (c = e[2])
    : ((c = (e) => {
        R(t, C.showContextWindowUsage, e);
      }),
      (e[1] = t),
      (e[2] = c));
  let l;
...
function xr() {
  let e = (0, Z.c)(21),
    t = i(o),
    n = j(),
    r = L(C.reviewDelivery) ?? `inline`,
    a;
  e[0] === t
    ? (a = e[1])
    : ((a = function (e) {
        R(t, C.reviewDelivery, e);
      }),
      (e[0] = t),
      (e[1] = a));
  let s = a,
  ...
  let u;
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, $.jsx)(M, { ...q.inline })), (e[4] = u))
    : (u = e[4]);
  let d;
  e[5] === n ? (d = e[6]) : ((d = n.formatMessage(q.inline)), (e[5] = n), (e[6] = d));
  let f;
  e[7] === d
    ? (f = e[8])
  ...
  let p;
  e[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(M, { ...q.detached })), (e[9] = p))
    : (p = e[9]);
  let m;
  e[10] === n ? (m = e[11]) : ((m = n.formatMessage(q.detached)), (e[10] = n), (e[11] = m));
  let h;
  e[12] === m
    ? (h = e[13])
...
function Cr() {
  ...
  e[0] !== r || e[1] !== t
    ? ((a = function (e) {
        ...
        ((e.value = String(n)), n !== r && R(t, y.sansFontSize, n));
      }),
      (e[0] = r),
      (e[1] = t),
      (e[2] = a))
...
function wr() {
  ...
  e[0] !== r || e[1] !== t
    ? ((a = function (e) {
        ...
        ((e.value = String(n)), n !== r && R(t, y.codeFontSize, n));
      }),
      (e[0] = r),
      (e[1] = t),
      (e[2] = a))
...
function Tr() {
  let e = i(o),
    ...
    { platform: n } = Se(),
    r = n === `macOS`,
    a = L(y.useFontSmoothing) ?? !0;
  return r
    ? (0, $.jsx)(J, {
        label: (0, $.jsx)(M, { ...X.fontSmoothing }),
        description: (0, $.jsx)(M, {
...
function Er() {
  ...
  e[0] === r
    ? (s = e[1])
    : ((s = (0, $.jsx)(M, { ...q.requireModifierEnter, values: { modifierSymbol: r } })),
      (e[0] = r),
      (e[1] = s));
  let c;
  e[2] === r
  ...
  e[4] === t
    ...
    : ((l = (e) => {
        ...
        R(t, C.composerEnterBehavior, n);
      }),
      (e[4] = t),
      (e[5] = l));
  let u;
  e[6] !== a || e[7] !== l
    ? ((u = (0, $.jsx)(K, { checked: a, onChange: l })), (e[6] = a), (e[7] = l), (e[8] = u))
    : (u = e[8]);
  let d;
  return (
    e[9] !== s || e[10] !== c || e[11] !== u
      ? ((d = (0, $.jsx)(J, { label: s, description: c, control: u })),
        (e[9] = s),
        (e[10] = c),
        (e[11] = u),
        (e[12] = d))
...
function Dr() {
  let e = (0, Z.c)(10),
    ...
    r = n !== `windows`,
    a = j(),
    s = L(C.preventSleepWhileRunning);
  if (!r) return null;
  let c, l;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(M, { ...q.preventSleepWhileRunning })),
      (l = (0, $.jsx)(M, {
  ...
  e[2] === t
    ? (d = e[3])
    : ((d = (e) => {
        R(t, C.preventSleepWhileRunning, e);
      }),
      (e[2] = t),
      (e[3] = d));
  let f;
  e[4] === a
    ? (f = e[5])
    : ((f = a.formatMessage(q.preventSleepWhileRunning)), (e[4] = a), (e[5] = f));
  let p;
  return (
    e[6] !== u || e[7] !== d || e[8] !== f
      ? ((p = (0, $.jsx)(J, {
          label: c,
          description: l,
          control: (0, $.jsx)(K, { checked: u, onChange: d, ariaLabel: f }),
        })),
        (e[6] = u),
        (e[7] = d),
        (e[8] = f),
...
export { Rn as i, Ln as n, kn as r, or as t };
