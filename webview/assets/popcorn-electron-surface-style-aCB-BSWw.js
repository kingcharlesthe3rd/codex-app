...
function ye(e) {
  let { children: t, id: n, items: r, strategy: i = Te, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: c, over: l, measureDroppableContainers: u } = O(),
    d = ee(Ee, n),
    f = s.rect !== null,
...
function xe(e) {
  let {
    ...
    }),
    {
      ...
      transform: ce,
    } = y({ id: o, data: C, attributes: { ...Ne, ...n }, disabled: b.draggable }),
    le = te(k, ie),
    N = !!A,
    ue = N && !m && he(f) && he(g),
    de = !_ && M,
    fe = ue
      ? ((de && ue ? ce : null) ??
        (s ?? v)({ rects: h, activeNodeRect: ne, activeIndex: f, overIndex: g, index: x }))
      : null,
    ...
    ge = be({ disabled: !me, index: x, node: ee, rect: T });
  return (
    (0, L.useEffect)(() => {
  ...
  function _e() {
    ...
    if (!((de && !S(j)) || !l) && (N || me)) return D.Transition.toString({ ...l, property: je });
  }
}
function Se(e, t) {
...
var L,
  ...
  Pe = e(() => {
    ((L = t(o())),
      ...
      (je = `transform`),
      (Me = D.Transition.toString({ property: je, duration: 0, easing: `linear` })),
...
function tt({
  ...
  let f = s != null || c != null || l != null || u != null || d != null,
    ...
    m = {
      ...
      width: 26,
      height: 26,
      transform: i ? `translate(-50%, -50%) scale(1.08)` : `translate(-50%, -50%)`,
    },
    h =
      e == null
        ? null
...
function Mt({
  ...
  return (0, V.jsx)(`button`, {
    ...
    children: (0, V.jsxs)(`span`, {
      className: n(`flex min-w-0 items-center`, e ? `justify-start` : `w-full justify-center`),
      children: [
        o({
          className: n(
      ...
      (gn = (0, H.forwardRef)(function (
        {
          ...
          mode: c = `create`,
          onDelete: l,
          testId: u = `popcorn-annotation-editor`,
        },
        _,
      ) {
        let v = (0, H.useRef)(null),
          ...
          ),
          {
            ...
            middleware: [
              p(Kt + qt),
              h({ fallbackPlacements: [`left-start`], padding: Gt, ...(O ? { boundary: O } : {}) }),
              g({ padding: Gt, ...(O ? { boundary: O } : {}) }),
              d({
                padding: Gt,
                ...(O ? { boundary: O } : {}),
          ...
          ce = (0, H.useCallback)(
            (e) => {
              if (((v.current = e), j.setFloating(e), typeof _ == `function`)) {
                _(e);
                return;
              }
              _ && (_.current = e);
                  ...
                  (0, U.jsx)(`div`, {
                    ...
                    children: (0, U.jsx)(`div`, {
                      ...
                      children: (0, U.jsx)(`textarea`, {
                        ...
                        rows: 1,
                        className: n(Qt, !S && `!overflow-hidden whitespace-nowrap`),
                        style: {
...
var q,
  ...
  qn,
  Jn = e(() => {
    ((Kn = t(o())), (qn = typeof window > `u` ? Kn.useEffect : Kn.useLayoutEffect));
  });
function Yn(e, t, n) {
  return Math.min(n, Math.max(t, e));
}
...
function cr({ onClick: e, children: t, destructive: r = !1 }) {
...
function lr({ label: e, active: t, count: r, onClick: i, interactive: a }) {
  let o = n(
  ...
  return !a || !i
    ...
    : (0, X.jsx)(`button`, { type: `button`, className: o, onClick: i, children: `${e} ${r}` });
}
function ur({ value: e, onChange: t, onSubmit: r }) {
  let i = e.trim();
  return (0, X.jsxs)(`div`, {
...
function dr({
  ...
  let [f, p] = (0, Y.useState)(!1),
    [m, h] = (0, Y.useState)(!1),
    g = (0, Y.useMemo)(() => ar(e.editedAt ?? e.createdAt), [e.createdAt, e.editedAt]),
    _ = a.trim(),
          ...
          (0, X.jsxs)(`div`, {
            ...
            children: [
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    className: n(`text-token-text-primary truncate font-medium`, Z),
                    children: e.author.displayName,
                  }),
                  g
                    ? (0, X.jsxs)(`div`, {
                        className: n(`text-token-description-foreground mt-0.5`, gr),
...
function fr({
  ...
  let E = r === `resolved` ? [i, ar(a)].filter(Boolean).join(` · `) : null;
  return (0, X.jsxs)(`div`, {
        ...
        children: [
          (0, X.jsxs)(`div`, {
            ...
            children: [
              ...
              E
                ? (0, X.jsx)(`div`, {
                    className: n(`text-token-description-foreground mt-1`, gr),
                    children: E,
                  })
                : null,
            ],
...
//# sourceMappingURL=popcorn-electron-surface-style-aCB-BSWw.js.map
