...
import { l as s } from "./lib.js";
import { t as c } from "./clsx-Cir5-jBH.js";
import { o as l } from "./statsig.js";
import { n as u } from "./electron-menu-shortcuts.js";
import { n as d } from "./use-hotkey-Ct4Y-I9A.js";
import { i as f } from "./command-keybindings.js";
import { t as p } from "./image-preview-dialog.js";
import { t as m } from "./attachment-remove-button.js";
var h = e(t()),
  g = n(),
  _ = (e) =>
    (0, g.jsx)(`svg`, {
...
function y(e) {
  ...
  let M = j,
    N;
  t[3] !== x || t[4] !== n
    ? ((N = { alt: x, src: n }), (t[3] = x), (t[4] = n), (t[5] = N))
    : (N = t[5]);
  let P = N,
    F;
  t[6] !== P || t[7] !== _ ? ((F = _ ?? [P]), (t[6] = P), (t[7] = _), (t[8] = F)) : (F = t[8]);
  let I = F,
    L = I[k] ?? P,
    R = k > 0 ? k - 1 : null,
    z = k + 1 < I.length ? k + 1 : null,
    B;
  if (
    t[9] !== x ||
    t[10] !== T ||
    ...
    let e =
      ...
      i = T ? `size-[54px]` : `size-20`,
      o = C ? `cursor-interaction` : `cursor-default`,
      s;
    t[19] !== i || t[20] !== o
      ? ((s = c(
    ...
    t[22] !== M || t[23] !== C
      ? ((l = C
          ? (e) => {
              (e.key === `Enter` || e.key === ` `) && (e.preventDefault(), M(!0));
            }
          : void 0),
        (t[22] = M),
        (t[23] = C),
    ...
    let u;
    t[25] !== x || t[26] !== n
      ? ((u = (0, g.jsx)(`img`, { src: n, alt: x, className: `size-full object-cover` })),
        (t[25] = x),
        (t[26] = n),
        (t[27] = u))
      : (u = t[27]);
...
var b = `[data-codex-terminal]`,
  x = `input,textarea,[contenteditable]:not([contenteditable='false' i])`;
function S() {
  return r(f, `composer.startDictation`);
}
function C() {
  let e = (0, v.c)(2),
    t = S();
...
function w({ composerInput: e, focusedElement: t, isActiveComposer: n }) {
  return n && (e.contains(t) || t?.closest(x) == null);
}
function T(e) {
  let t = (0, v.c)(31),
    {
  ...
  let T = w,
    D;
  t[2] !== n || t[3] !== m || t[4] !== i || t[5] !== u || t[6] !== f
    ? ((D = () => (!n || i || (m != null && E(u, m)) ? !1 : f == null || f())),
      (t[2] = n),
      (t[3] = m),
      (t[4] = i),
      (t[5] = u),
  ...
  t[14] !== g || t[15] !== c
    ? ((j = (e) => {
        !g || y.current !== e.sessionId || ((y.current = null), c(`insert`));
      }),
      (t[14] = g),
      (t[15] = c),
      (t[16] = j))
  ...
  let N = _ ?? ``,
    ...
    F = m ?? void 0,
    I;
  t[18] !== O || t[19] !== r || t[20] !== T
    ? ((I = (e) => {
        if ((e.preventDefault(), e.stopPropagation(), !O() || r || C.current)) {
          x.current = !1;
          return;
        }
        ((x.current = !0), T());
  ...
  t[22] === c
    ...
    : ((L = (e) => {
        (e.preventDefault(),
          e.stopPropagation(),
          !(!x.current || y.current != null) && ((x.current = !1), c(`insert`)));
      }),
      (t[22] = c),
      (t[23] = L));
  let R;
  (t[24] !== u || t[25] !== F || t[26] !== I || t[27] !== L || t[28] !== N || t[29] !== P
    ? ((R = {
        accelerator: N,
        enabled: P,
        ignoreWithin: F,
...
export { _ as a, y as i, T as n, C as r, w as t };
//# sourceMappingURL=use-dictation-hotkey-Dha-bSbZ.js.map
