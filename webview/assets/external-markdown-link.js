...
import { Ha as a, Ra as o } from "./app-server-manager-signals.js";
...
import { a as y, i as b, n as ee, o as te, r as ne, s as x } from "./inline-mention-style.js";
function S(e) {
  try {
    let t = new URL(e);
...
function L(e, t, n, r, i) {
  ...
  return typeof e != `string` ||
    ...
    ? i
    : a.validateHostname && a.extractHostname && i.hostname !== null && !P(i.hostname)
      ? ((i.hostname = null), i)
      : (t === 0 ||
          i.hostname === null ||
          (n(i.hostname, a, i), t === 2 || i.publicSuffix === null) ||
          ((i.domain = k(i.publicSuffix, i.hostname, a)), t === 3 || i.domain === null) ||
...
`),
  ...
  if (o(r) && !r.startsWith(`//`) && !(r.startsWith(`/`) && n)) {
    ...
    if (t(e)) {
      let t = e.indexOf(`/`, 2);
      return ((n.host = e.slice(2, t)), (n.pathname = e.slice(t)), n.toString());
    }
...
function de(e, t) {
  return /\s/.test(e) || t == null
    ...
    : t.hostname.startsWith(`[`)
      ? J(t.hostname)
      : t.hasPort || t.hostname.startsWith(`www.`) || J(t.hostname) || Y(t.hostname);
}
function q(e) {
  let t = e.search(/[/?#]/),
    n = t === -1 ? e : e.slice(0, t);
...
function Z({ conversationId: e, url: t, source: n, initiator: r }) {
  ...
  return i == null
    ? !1
    : (f.dispatchHostMessage({ type: `toggle-browser-panel`, open: !0, source: n, initiator: r }),
...
function he({ conversationId: e, href: t, isBrowserSidebarEnabled: n }) {
  let r = $(t);
  return Q({ conversationId: e, href: t, isBrowserSidebarEnabled: n }) && (fe(t) || be(r));
}
function $(e) {
  ...
  return [
    {
      ...
      onSelect: () => {
        ...
        Z({ conversationId: e, url: t, source: `manual`, initiator: `markdown_link_context_menu` });
      },
    },
    {
      ...
      onSelect: () => {
        if (r) {
          f.dispatchMessage(`open-in-browser`, { url: n, useExternalBrowser: !0 });
          return;
        }
        f.dispatchMessage(`open-in-browser`, { url: n, useExternalBrowser: !0 });
      },
...
function xe(e) {
  ...
  if (!i) {
    ...
    return (
      t[0] === n
        ? (e = t[1])
        : ((e = (0, T.jsx)(T.Fragment, { children: n })), (t[0] = n), (t[1] = e)),
      e
    );
  }
  ...
  t[11] === n
    ? (v = t[12])
    : ((v = (0, T.jsx)(`span`, { className: `break-words whitespace-normal`, children: n })),
      (t[11] = n),
      (t[12] = v));
  let S;
  t[13] !== _ || t[14] !== v
  ...
  let k;
  t[23] !== s || t[24] !== i
    ? ((k = ge({ conversationId: s, href: i })), (t[23] = s), (t[24] = i), (t[25] = k))
    : (k = t[25]);
  let A;
  return (
    t[26] !== O || t[27] !== k
      ? ((A = (0, T.jsx)(g, { items: k, children: O })), (t[26] = O), (t[27] = k), (t[28] = A))
      : (A = t[28]),
    A
  );
}
