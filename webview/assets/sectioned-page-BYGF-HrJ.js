...
function h(e) {
  ...
  let j = A,
    M;
  t[1] === r ? (M = t[2]) : ((M = r.map(g)), (t[1] = r), (t[2] = M));
  let N;
  t[3] !== O || t[4] !== M
  ...
  let V = R
    ...
    H;
  t[10] === V ? (H = t[11]) : ((H = i(V)), (t[10] = V), (t[11] = H));
  let U;
  t[12] !== P ||
  t[13] !== n ||
  t[14] !== y ||
  ...
  t[26] === u
    ? (q = t[27])
    : ((q = i(`mx-auto w-full max-w-[var(--thread-content-max-width)]`, u)),
      (t[26] = u),
      (t[27] = q));
  let J;
  t[28] !== a || t[29] !== q
...
function _(e) {
  let t = (0, o.c)(19),
    { id: n, title: r, action: a, stickyHeader: c, showDivider: l, children: u } = e,
    d = c === void 0 ? !1 : c,
    m = l === void 0 ? !0 : l,
    h = (0, s.useContext)(p),
    g;
  ...
  let _ =
    ...
    v = m && `border-b border-token-border-light`,
    y;
  t[3] !== _ || t[4] !== v
    ? ((y = i(
  ...
  t[8] === a
    ? (x = t[9])
    : ((x = a ? (0, f.jsx)(`div`, { className: `shrink-0`, children: a }) : null),
      (t[8] = a),
      (t[9] = x));
  let S;
  t[10] !== y || t[11] !== b || t[12] !== x
    ? ((S = (0, f.jsxs)(`div`, { className: y, children: [b, x] })),
      (t[10] = y),
      (t[11] = b),
      (t[12] = x),
      (t[13] = S))
...
function v(e) {
  let t = (0, o.c)(11),
    ...
    m;
  t[0] !== r || t[1] !== n || t[2] !== c || t[3] !== u || t[4] !== l || t[5] !== d
    ? ((m =
        l === `vertical`
          ? (0, f.jsx)(`div`, {
...
//# sourceMappingURL=sectioned-page-BYGF-HrJ.js.map
