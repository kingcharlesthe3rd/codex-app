...
import { Fi as t, O as n } from "./src-2.js";
import {
  Ct as r,
  Et as i,
  Ko as a,
...
import { n as S, r as C } from "./react.js";
import { c as w, o as T } from "./lib-2.js";
import { f as E, m as D } from "./chunk-12.js";
import { g as O, t as k } from "./persisted-signal-CweW-bgN.js";
import { c as A, d as j, o as M } from "./statsig.js";
import { t as N } from "./request.js";
import { r as P } from "./remote-connection-visibility.js";
import { t as F } from "./use-auth-CI-WraL2.js";
import { p as I } from "./codex-api.js";
import { c as L } from "./apps-queries.js";
import { n as ee, r as te } from "./experimental-features-queries.js";
import { t as R } from "./persisted-atom.js";
import { t as ne } from "./use-model-settings.js";
import { t as re } from "./button.js";
import { a as ie, i as ae } from "./setting-storage.js";
import { n as oe } from "./model-queries.js";
import { n as se } from "./use-webview-execution-target.js";
import { h as ce, r as le, t as ue } from "./onboarding-state.js";
import { n as de, t as fe } from "./use-service-tier-settings.js";
import { t as z } from "./x.js";
import { t as B } from "./skus.js";
import { t as pe } from "./use-platform.js";
import { r as V, t as me } from "./ambient-suggestions-connected-apps-consent.js";
import { t as he } from "./app-intl-signal-B.js";
import { t as H } from "./with-window.js";
import { t as ge } from "./use-is-remote-host.js";
import { n as _e, t as ve } from "./use-fast-mode-personalized-estimate.js";
import { t as ye } from "./codex.js";
import { r as be } from "./modal-controller-state.js";
import { t as xe } from "./lightning-bolt.js";
import { t as Se } from "./badge-Bpp-zYoJ.js";
import { t as U } from "./remote-connections-onboarding-signals.js";
import { t as Ce } from "./globe.js";
import { t as we } from "./face.js";
import { t as Te } from "./use-is-background-subagents-enabled.js";
import { t as Ee } from "./use-active-conversation-id.js";
import { n as De, t as Oe } from "./rate-limit-reset-modal-BG-T1c9v.js";
import { t as ke } from "./banner.js";
import { t as Ae } from "./team.js";
var W = b(),
  G = d();
function K(e) {
  let t = (0, W.c)(13),
...
function q(e) {
  ...
  t[34] === a
    ? (M = t[35])
    : ((M = f(`text-token-text-secondary mt-0.5 text-base leading-relaxed text-pretty`, a)),
      (t[34] = a),
      (t[35] = M));
  let N;
  t[36] !== s || t[37] !== M
    ? ((N = (0, G.jsx)(`div`, { className: M, children: s })),
      (t[36] = s),
      (t[37] = M),
      (t[38] = N))
    : (N = t[38]);
  ...
  t[39] !== b || t[40] !== S || t[41] !== j || t[42] !== N
    ? ((P = (0, G.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [j, N, b, S] })),
      (t[39] = b),
      (t[40] = S),
      (t[41] = j),
      (t[42] = N),
...
function je(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, G.jsx)(T, {
      ...
      (o = (0, G.jsx)(we, { className: `icon-sm` })),
      (s = (0, G.jsx)(T, {
...
function Me() {
  let e = (0, W.c)(13),
    r = p(y),
    { authMethod: i, email: a, isLoading: o, planAtLogin: s } = F(),
    l = i === `chatgpt`,
    u;
  ...
  let { data: d, isLoading: f } = x(`account-info`, u),
    ...
    v = j(),
    b = ie(n.enabled),
    S = t({ authMethod: i, email: d?.email ?? a, plan: d?.plan ?? s }),
    C = _ && S && b === !0 && m === !1,
    { data: w, isLoading: T } = L({ enabled: C, hostId: c }),
    E;
  e[2] === w ? (E = e[3]) : ((E = w === void 0 ? [] : w), (e[2] = w), (e[3] = E));
  let D = E,
    O;
  e[4] === D ? (O = e[5]) : ((O = me(D)), (e[4] = D), (e[5] = O));
  let k = Ne({
      hasConnectedApps: O.length > 0,
      isLoadingApps: T,
      isLoadingEligibilityInputs: o || !g || v || f,
      shouldLoadApps: C,
    }),
    A,
    N;
...
var J = e(u(), 1),
  ...
  Re = m(y, ({ get: e }) => {
    let t = e(Pe);
    return {
      queryKey: [`codex-app-home-beacon`, t, e(he).locale],
      enabled: e(Y),
      refetchOnMount: !1,
      ...
      queryFn: async () => ({
        accountId: t,
        response: await N.safeGet(`/beacons/home`, {
...
function ze({ actionId: e, beaconId: t }) {
  return `${t}:${e}`;
}
function Be(e) {
...
function Ve({ accountId: e, response: t }) {
  return t.beacon_ui_response == null
    ? { accountId: e, beacon: null, shouldKeepLastServedBeacon: !0 }
    : { accountId: e, beacon: Be(t), shouldKeepLastServedBeacon: !1 };
}
function He(e) {
  let t = Ue(e.action_v2);
  return t != null && We(t) ? t : null;
}
function Ue(e) {
...
function Ge({ accountId: e, authMethod: t, isAuthLoading: n }) {
  return !n && t === `chatgpt` && e != null;
}
function Ke({ isAuthLoading: e }) {
  return e;
}
async function X(e, t, n) {
  try {
    await N.safePost(`/beacons/event`, {
      requestBody:
        n == null
...
function Ye() {
  let e = (0, W.c)(30),
    t = p(y),
    { accountId: n, authMethod: r, isLoading: i, userId: a } = F(),
    { data: o } = I(),
    s = A(),
    c = h(Ie),
    l = h(Re),
  ...
  if (e[0] !== n || e[1] !== r || e[2] !== o?.id || e[3] !== i || e[4] !== s || e[5] !== a) {
    ...
    ((f = n ?? o?.id ?? t ?? a ?? null),
      (m = Ge({ accountId: f, authMethod: r, isAuthLoading: i })),
      (e[0] = n),
      (e[1] = r),
      (e[2] = o?.id),
      (e[3] = i),
  ...
  let g = m,
    _;
  e[8] === i ? (_ = e[9]) : ((_ = Ke({ isAuthLoading: i })), (e[8] = i), (e[9] = _));
  let v = _,
    b,
    x;
  (e[10] !== f || e[11] !== t || e[12] !== g
    ? ((b = () => {
        (t.set(Pe, f), t.set(Y, g));
      }),
      (x = [f, t, g]),
      (e[10] = f),
      (e[11] = t),
  ...
  (e[15] !== l.data || e[16] !== t
    ? ((S = () => {
        l.data?.accountId != null &&
          l.data.beacon != null &&
          t.set(Le, { accountId: l.data.accountId, beacon: l.data.beacon });
      }),
      (C = [l.data, t]),
      (e[15] = l.data),
      (e[16] = t),
  ...
  if (e[19] !== c || e[20] !== w || e[21] !== f || e[22] !== g) {
    let t = w != null && f != null ? Z(f, w.beacon_id) : null;
  ...
  let E = T,
    ...
    j;
  return (
    e[24] !== E || e[25] !== f || e[26] !== D || e[27] !== O || e[28] !== k
      ? ((j = {
          accountId: f,
          beacon: E,
          isEligible: O,
...
function Xe(e) {
  ...
  return (
    t[9] !== r || t[10] !== i || t[11] !== c
      ? ((l = (0, G.jsx)(Ze, { beacon: r, localActionHandlers: i, onDismiss: c })),
        (t[9] = r),
        (t[10] = i),
        (t[11] = c),
        (t[12] = l))
...
function Ze(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
    let e = n.action_items.find($e),
      i = n.action_items.find(Qe),
      a = (e) => {
        if (e == null || e.text == null) return;
        let t = r?.[ze({ actionId: e.id, beaconId: n.beacon_id })],
          i = He(e);
        if (!(i == null && t == null))
          return {
            label: e.text,
            onClick: () => {
              if ((X(n, `click`, e.id), t?.({ action: e, beacon: n }) !== !0 && i != null)) {
                if (!i.startsWith(`/`)) {
                  v.dispatchMessage(`open-in-browser`, { url: i });
                  return;
                }
                o(i);
              }
...
function et(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, G.jsx)(`img`, { alt: ``, src: De, className: `h-8 w-8 shrink-0` })), (t[1] = o))
    : (o = t[1]);
  let s;
...
var tt = R(`has-seen-app-upsell-banner`, !1);
function nt(e) {
  let t = (0, W.c)(6),
    { platform: n, isLoading: r } = pe(),
    { authMethod: i, planAtLogin: a, isLoading: o } = F(),
    s = i === `chatgpt`,
    c = i === `apikey`,
    l = s || c,
    u;
...
function it(e) {
  ...
  let h, g;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, G.jsx)(xe, { className: `icon-sm text-[#FFC93C]` })),
      (g = (0, G.jsx)(T, {
    ...
    : ((h = t[1]), (g = t[2]));
  let _;
  t[3] !== r || t[4] !== o || t[5] !== f || t[6] !== c || t[7] !== l || t[8] !== u || t[9] !== d
    ? ((_ = () => {
        if (r == null) return;
        (l(!0), O(f, { eventName: `codex_fast_mode_banner_cta_clicked` }));
        let e = o.model === r.model ? Promise.resolve() : u(r.model, o.reasoningEffort);
        Promise.all([d(s(r)?.id ?? `priority`, `home_banner`), e]).finally(() => {
          (c(!0), l(!1));
        });
      }),
      (t[3] = r),
...
var at = R(`has-seen-fast-mode-home-banner`, !1);
function Q() {
  let e = (0, W.c)(19),
    t = p(y),
    n = w(),
    { isServiceTierAllowed: a } = de(),
    { data: o } = oe(),
    [s, c] = S(at),
    { modelSettings: l, setModelAndReasoningEffort: u } = ne(),
    { serviceTierSettings: d, setServiceTier: f } = fe(),
    [m, h] = (0, J.useState)(!1),
    g = (0, J.useRef)(!1),
    _ = o?.models,
    v;
  e[0] === _ ? (v = e[1]) : ((v = i(_, r)), (e[0] = _), (e[1] = v));
  let b = v,
    x = a && b != null && !s && d.selectedServiceTier == null && !d.isLoading,
    { estimate: C, estimateStatus: E } = _e(x),
    D = !s && x && E !== `ready` && E !== `failed`,
    k = x && E === `ready` && C != null,
    A,
    j;
  (e[2] !== k || e[3] !== t
    ? ((A = () => {
        !k || g.current || ((g.current = !0), O(t, { eventName: `codex_fast_mode_banner_viewed` }));
      }),
      (j = [t, k]),
      (e[2] = k),
      (e[3] = t),
  ...
  e[6] === C
    ...
    : ((M =
        C == null
          ...
          : (0, G.jsx)(T, {
              ...ve.bodyPersonalized,
              values: { threadCountLabel: C.threadCountLabel, duration: C.savedDuration },
            })),
      (e[6] = C),
      (e[7] = M));
  let N = M,
...
var ot = `multi_agent`,
  st = R(`has-seen-multi-agent-composer-banner`, !1);
function ct() {
  let e = (0, W.c)(5),
    { hostId: t } = se(Ee()),
    n = Te(),
    [r] = S(st),
    { data: i, isLoading: a } = g(ee, t),
    o;
  e[0] === i ? (o = e[1]) : ((o = i?.some(lt) ?? !1), (e[0] = i), (e[1] = o));
  let s = o,
    c = n && !r && a,
    l = n && !r && !s,
    u;
...
function dt(e) {
  let t = (0, W.c)(31),
    ...
    i = w(),
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: c }), (t[0] = a)) : (a = t[0]);
  let o = te(a),
    [, s] = l(`composer_prefill`),
    [u, d] = S(st),
    [f, m] = (0, J.useState)(!1),
    h = (0, J.useRef)(!1),
    g = !u,
  ...
  if (
    (t[1] !== g || t[2] !== r
      ? ((_ = () => {
          !g ||
            h.current ||
            ((h.current = !0), O(r, { eventName: `codex_multi_agent_banner_viewed` }));
        }),
        (v = [r, g]),
        (t[1] = g),
        (t[2] = r),
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, G.jsx)(T, {
      ...
      (t[7] = C),
      (t[8] = E))
    : ((b = t[5]), (x = t[6]), (C = t[7]), (E = t[8]));
  let D;
  t[9] !== i || t[10] !== n || t[11] !== r || t[12] !== s || t[13] !== o || t[14] !== d
    ? ((D = () => {
        m(!0);
        ...
        (O(r, {
          ...
          o.mutateAsync({ featureName: ut, enabled: !0 }).finally(() => {
            (n ? n() : s({ text: e }), d(!0), m(!1));
          }));
      }),
      (t[9] = i),
      (t[10] = n),
  ...
  t[21] !== r || t[22] !== d
    ? ((j = () => {
        (O(r, { eventName: `codex_multi_agent_banner_dismissed` }), d(!0));
      }),
      (t[21] = r),
      (t[22] = d),
      (t[23] = j))
...
function mt(e) {
  ...
  t[0] !== n || t[1] !== i
    ? ((a = () => {
        be(i, Oe, { initialAvailableCount: n, isRateLimitReached: !1, onResetComplete: ht });
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a))
  ...
  return (
    t[3] !== r || t[4] !== a
      ? ((o = (0, G.jsx)(gt, { onDismiss: r, onSeeResets: a })), (t[3] = r), (t[4] = a), (t[5] = o))
      : (o = t[5]),
    o
  );
}
...
var _t = 1440 * 60 * 1e3,
  $ = k(`rate-limit-reset-home-announcement-dismissal-by-account-id`, {});
function vt() {
  let e = (0, W.c)(9),
    t = p(y),
    { accountId: n, isLoading: r } = F(),
    i = h($),
    { data: a, isLoading: s } = h(o),
  ...
  e[0] !== n || e[1] !== c || e[2] !== t
    ? ((d = () => {
        n != null &&
          t.set($, (e) => ({ ...e, [n]: { availableCount: c, dismissedAtMs: Date.now() } }));
      }),
      (e[0] = n),
      (e[1] = c),
      (e[2] = t),
      (e[3] = d))
    : (d = e[3]);
  let f = n != null && c > 0 && (l == null || l.availableCount !== c || u - l.dismissedAtMs >= _t),
    m = r || (a == null && s),
    g;
  return (
    e[4] !== c || e[5] !== d || e[6] !== f || e[7] !== m
      ? ((g = { availableCount: c, dismiss: d, isEligible: f, isLoading: m }),
        (e[4] = c),
        (e[5] = d),
        (e[6] = f),
        (e[7] = m),
...
function yt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, G.jsx)(T, {
      ...
      (s = (0, G.jsx)(Ce, { className: `icon-sm` })),
      (c = (0, G.jsx)(T, {
...
function bt() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = { waitForRemoteSshConnections: !0 }), (e[0] = o))
    : (o = e[0]);
  let s = a(o),
    c;
  e[1] === s ? (c = e[2]) : ((c = s?.some(xt) ?? !1), (e[1] = s), (e[2] = c));
  let l = c,
    u = !n && s === void 0,
    d = !u && r && !i && !n && l,
    f;
...
function St() {
  ...
  e[0] !== r || e[1] !== t.pathname
    ? ((i = ce({ hideFirstNewThreadOnboardingPromos: r, pathname: t.pathname })),
      (e[0] = r),
      (e[1] = t.pathname),
      (e[2] = i))
    : (i = e[2]);
  ...
  e[16] === a
    ...
    : ((f = (0, G.jsx)(H, {
        extension: !0,
        children: (0, G.jsx)(wt, { shouldHideOnboardingPromos: a }),
      })),
      (e[16] = a),
      (e[17] = f));
  let p;
...
function Ct(e) {
  ...
  let h;
  t[6] !== p || t[7] !== m
    ? ((h = (0, G.jsx)(je, { onDismiss: p, onDisable: m })), (t[6] = p), (t[7] = m), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== r || t[10] !== h
  ...
  t[12] !== s.availableCount || t[13] !== s.dismiss
    ? ((_ = (0, G.jsx)(mt, { availableCount: s.availableCount, onDismiss: s.dismiss })),
  ...
  t[19] !== c.accountId || t[20] !== c.beacon
    ? ((x =
        c.beacon != null && c.accountId != null
          ? (0, G.jsx)(Xe, { accountId: c.accountId, beacon: c.beacon })
          : null),
      (t[19] = c.accountId),
      (t[20] = c.beacon),
      (t[21] = x))
  ...
  t[26] === l.navigate
    ? (T = t[27])
    : ((T = (0, G.jsx)(yt, { navigate: l.navigate })), (t[26] = l.navigate), (t[27] = T));
  let E;
  ...
  t[36] === d
    ? (N = t[37])
    : ((N = d.content == null ? null : (0, G.jsx)(it, { ...d })), (t[36] = d), (t[37] = N));
  let P;
  ...
  return (
    t[42] !== S || t[43] !== E || t[44] !== A || t[45] !== P || t[46] !== g || t[47] !== v
      ? ((F = (0, G.jsx)(pt, { entries: [g, v, S, E, A, P] })),
        (t[42] = S),
        (t[43] = E),
        (t[44] = A),
        (t[45] = P),
...
function wt(e) {
  ...
  t[11] === a
    ? (g = t[12])
    : ((g = a.content == null ? null : (0, G.jsx)(it, { ...a })), (t[11] = a), (t[12] = g));
  let _;
