...
import { Z as r, a as i, g as a, m as o, o as s, s as c, t as l } from "./app-scope-CWE-zIhQ.js";
import { a as u, o as d, r as f } from "./use-host-config.js";
import { Gt as p, Kt as m, Ut as h, ln as g } from "./thread-context-inputs.js";
import { f as _, o as v } from "./vscode-api.js";
import { n as y, r as b } from "./react.js";
import { A as x, Hi as S } from "./src.js";
import { l as C, s as w } from "./lib-1.js";
import { t as T } from "./clsx.js";
import { t as E } from "./persisted-atom.js";
import { t as D } from "./button-oF-qgtAS.js";
import { a as O, i as k } from "./setting-storage.js";
import { t as A } from "./x.js";
import { t as j } from "./badge.js";
import { c as M, o as N, u as P } from "./statsig.js";
...
import { f as re, m as B } from "./chunk-13.js";
import { t as ie } from "./persisted-signal.js";
import { r as ae } from "./remote-connection-visibility.js";
import { t as V } from "./use-auth.js";
import { n as oe } from "./model-queries.js";
import { n as se } from "./use-model-settings.js";
import { n as ce } from "./use-webview-execution-target.js";
import { n as le, t as ue } from "./use-service-tier-settings.js";
import { p as de } from "./codex-api.js";
import { h as fe, r as pe, t as me } from "./onboarding-state.js";
import { t as he } from "./skus.js";
import { t as ge } from "./use-platform.js";
import { n as _e, r as ve } from "./experimental-features-queries.js";
import { c as ye } from "./apps-queries.js";
import { r as H, t as be } from "./ambient-suggestions-connected-apps-consent.js";
import { t as xe } from "./app-intl-signal.js";
import { n as Se } from "./app-identity.js";
import { t as Ce } from "./with-window.js";
import { t as we } from "./use-is-remote-host.js";
import { n as Te, t as Ee } from "./use-fast-mode-personalized-estimate.js";
import { t as De } from "./codex.js";
import { r as Oe } from "./modal-controller-state.js";
import { t as ke } from "./lightning-bolt.js";
import { t as U } from "./remote-connections-onboarding-signals.js";
import { t as Ae } from "./globe.js";
import { t as je } from "./use-is-background-subagents-enabled.js";
import { t as Me } from "./use-active-conversation-id.js";
import { n as Ne, t as Pe } from "./rate-limit-reset-modal.js";
import { t as Fe } from "./banner.js";
import { t as Ie } from "./face-BkY0-VYb.js";
import { t as Le } from "./team.js";
var W = r(),
  G = n();
function K(e) {
  let t = (0, W.c)(13),
  ...
  t[0] === r
    ? (o = t[1])
    : ((o = r ? (0, G.jsx)(r, { className: `icon-xs` }) : null), (t[0] = r), (t[1] = o));
  let s;
  return (
    t[2] !== n.ariaLabel ||
    t[3] !== n.className ||
...
function q(e) {
  ...
  t[0] !== n || t[1] !== m || t[2] !== c || t[3] !== d || t[4] !== f
    ? ((g = (e) =>
        (0, G.jsxs)(`div`, {
          ...
          children: [
            f ? (0, G.jsx)(K, { action: f }) : null,
            d ? (0, G.jsx)(K, { action: d }) : null,
            c ? (0, G.jsx)(K, { action: c }) : null,
          ],
        })),
      (t[0] = n),
      (t[1] = m),
  ...
  t[34] === a
    ? (N = t[35])
    : ((N = T(`text-token-text-secondary mt-0.5 text-base leading-relaxed text-pretty`, a)),
      (t[34] = a),
      (t[35] = N));
  let P;
  t[36] !== s || t[37] !== N
    ? ((P = (0, G.jsx)(`div`, { className: N, children: s })),
      (t[36] = s),
      (t[37] = N),
      (t[38] = P))
    : (P = t[38]);
  let F;
  t[39] !== y || t[40] !== x || t[41] !== M || t[42] !== P
    ? ((F = (0, G.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [M, P, y, x] })),
      (t[39] = y),
      (t[40] = x),
      (t[41] = M),
      (t[42] = P),
...
function Re(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, G.jsx)(w, {
      ...
      (o = (0, G.jsx)(Ie, { className: `icon-sm` })),
      (s = (0, G.jsx)(w, {
...
function ze() {
  let e = (0, W.c)(13),
    t = s(l),
    { authMethod: n, email: r, isLoading: i, planAtLogin: a } = V(),
    o = n === `chatgpt`,
    u;
  e[0] === o ? (u = e[1]) : ((u = { queryConfig: { enabled: o } }), (e[0] = o), (e[1] = u));
  let { data: d, isLoading: p } = v(`account-info`, u),
    m = c(H),
    h = m != null,
    g = N(`2425897452`),
    _ = P(),
    y = O(x.enabled),
    b = S({ authMethod: n, email: d?.email ?? r, plan: d?.plan ?? a }),
    C = g && b && y === !0 && m === !1,
    { data: w, isLoading: T } = ye({ enabled: C, hostId: f }),
    E;
  e[2] === w ? (E = e[3]) : ((E = w === void 0 ? [] : w), (e[2] = w), (e[3] = E));
  let D = E,
    A;
  e[4] === D ? (A = e[5]) : ((A = be(D)), (e[4] = D), (e[5] = A));
  let j = Be({
      hasConnectedApps: A.length > 0,
      isLoadingApps: T,
      isLoadingEligibilityInputs: i || !h || _ || p,
      shouldLoadApps: C,
    }),
    M,
    F;
...
var J = e(t(), 1),
  ...
  Ge = o(l, ({ get: e }) => {
    let t = e(Ve);
    return {
      queryKey: [`codex-app-home-beacon`, t, e(xe).locale],
      enabled: e(Y),
      refetchOnMount: !1,
      ...
      queryFn: async () => ({
        accountId: t,
        response: await F.safeGet(`/beacons/home`, {
...
function Ke({ actionId: e, beaconId: t }) {
  return `${t}:${e}`;
}
function qe(e) {
...
function Je({ accountId: e, response: t }) {
  return t.beacon_ui_response == null
    ? { accountId: e, beacon: null, shouldKeepLastServedBeacon: !0 }
    : { accountId: e, beacon: qe(t), shouldKeepLastServedBeacon: !1 };
}
function Ye(e) {
  let t = Xe(e.action_v2);
  return t != null && Ze(t) ? t : null;
}
function Xe(e) {
...
function Qe({ accountId: e, authMethod: t, isAuthLoading: n }) {
  return !n && t === `chatgpt` && e != null;
}
function $e({ isAuthLoading: e }) {
  return e;
}
async function X(e, t, n) {
  try {
    await F.safePost(`/beacons/event`, {
      requestBody:
        n == null
...
function nt() {
  let e = (0, W.c)(30),
    t = s(l),
    { accountId: n, authMethod: r, isLoading: i, userId: a } = V(),
    { data: o } = de(),
    u = M(),
    d = c(Ue),
    f = c(Ge),
    ...
    h,
    g;
  if (e[0] !== n || e[1] !== r || e[2] !== o?.id || e[3] !== i || e[4] !== u || e[5] !== a) {
    let t = u.getContext().user?.customIDs?.account_id;
    ((h = n ?? o?.id ?? t ?? a ?? null),
      (g = Qe({ accountId: h, authMethod: r, isAuthLoading: i })),
      (e[0] = n),
      (e[1] = r),
      (e[2] = o?.id),
      (e[3] = i),
  ...
  let _ = g,
    v;
  e[8] === i ? (v = e[9]) : ((v = $e({ isAuthLoading: i })), (e[8] = i), (e[9] = v));
  let y = v,
    b,
    x;
  (e[10] !== h || e[11] !== t || e[12] !== _
    ? ((b = () => {
        (t.set(Ve, h), t.set(Y, _));
      }),
      (x = [h, t, _]),
      (e[10] = h),
      (e[11] = t),
  ...
  (e[15] !== f.data || e[16] !== t
    ? ((S = () => {
        f.data?.accountId != null &&
          f.data.beacon != null &&
          t.set(We, { accountId: f.data.accountId, beacon: f.data.beacon });
      }),
      (C = [f.data, t]),
      (e[15] = f.data),
      (e[16] = t),
  ...
  let w =
      f.data?.accountId === h
        ? (f.data.beacon ??
          (f.data.shouldKeepLastServedBeacon && m?.accountId === h ? m.beacon : null))
        : null,
    T;
  if (e[19] !== d || e[20] !== w || e[21] !== h || e[22] !== _) {
    let t = w != null && h != null ? Z(h, w.beacon_id) : null;
    ((T = _ && w != null && t != null && !d.has(t) ? w : null),
      (e[19] = d),
      (e[20] = w),
      (e[21] = h),
      (e[22] = _),
  ...
  let E = T,
    ...
    A;
  return (
    e[24] !== E || e[25] !== h || e[26] !== D || e[27] !== O || e[28] !== k
      ? ((A = {
          accountId: h,
          beacon: E,
          isEligible: O,
...
function rt(e) {
  ...
  return (
    t[9] !== r || t[10] !== i || t[11] !== u
      ? ((d = (0, G.jsx)(it, { beacon: r, localActionHandlers: i, onDismiss: u })),
        (t[9] = r),
        (t[10] = i),
        (t[11] = u),
        (t[12] = d))
...
function it(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
    let e = n.action_items.find(ot),
      i = n.action_items.find(at),
      a = (e) => {
        if (e == null || e.text == null) return;
        let t = r?.[Ke({ actionId: e.id, beaconId: n.beacon_id })],
          i = Ye(e);
        if (!(i == null && t == null))
          return {
            label: e.text,
...
function st(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, G.jsx)(`img`, { alt: ``, src: Ne, className: `h-8 w-8 shrink-0` })), (t[1] = o))
    : (o = t[1]);
  let s;
...
var ct = E(`has-seen-app-upsell-banner`, !1);
function lt(e) {
  let t = (0, W.c)(6),
    { platform: n, isLoading: r } = ge(),
    { authMethod: i, planAtLogin: a, isLoading: o } = V(),
    s = i === `chatgpt`,
    c = i === `apikey`,
    l = s || c,
    u;
  t[0] === l ? (u = t[1]) : ((u = { queryConfig: { enabled: l } }), (t[0] = l), (t[1] = u));
  let { data: d, isLoading: f } = v(`account-info`, u),
    p = i === `copilot`,
    m = n === `macOS`,
    h = d?.plan ?? a,
    g = h === he.FREE || h === he.GO,
...
function dt(e) {
  ...
  let g, _;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, G.jsx)(ke, { className: `icon-sm text-[#FFC93C]` })),
      (_ = (0, G.jsx)(w, {
    ...
    : ((g = t[1]), (_ = t[2]));
  let v;
  t[3] !== r || t[4] !== o || t[5] !== m || t[6] !== c || t[7] !== u || t[8] !== d || t[9] !== f
    ? ((v = () => {
        if (r == null) return;
        (u(!0), z(m, ee, {}));
        let e = o.model === r.model ? Promise.resolve() : d(r.model, o.reasoningEffort);
        Promise.all([f(p(r)?.id ?? `priority`, `home_banner`), e]).finally(() => {
          (c(!0), u(!1));
        });
      }),
      (t[3] = r),
...
var ft = E(`has-seen-fast-mode-home-banner`, !1);
function Q() {
  let e = (0, W.c)(19),
    t = s(l),
    n = C(),
    { isServiceTierAllowed: r } = le(),
    { data: i } = oe(),
    [a, o] = y(ft),
    { modelSettings: c, setModelAndReasoningEffort: u } = se(),
    { serviceTierSettings: d, setServiceTier: f } = ue(),
    [p, g] = (0, J.useState)(!1),
    _ = (0, J.useRef)(!1),
    v = i?.models,
    b;
  e[0] === v ? (b = e[1]) : ((b = m(v, h)), (e[0] = v), (e[1] = b));
  let x = b,
    S = r && x != null && !a && d.selectedServiceTier == null && !d.isLoading,
    { estimate: T, estimateStatus: E } = Te(S),
    D = !a && S && E !== `ready` && E !== `failed`,
    O = S && E === `ready` && T != null,
    k,
    A;
  (e[2] !== O || e[3] !== t
    ? ((k = () => {
        !O || _.current || ((_.current = !0), z(t, ne, {}));
      }),
      (A = [t, O]),
      (e[2] = O),
      (e[3] = t),
...
var pt = `multi_agent`,
  mt = E(`has-seen-multi-agent-composer-banner`, !1);
function ht() {
  let e = (0, W.c)(5),
    { hostId: t } = ce(Me()),
    n = je(),
    [r] = y(mt),
    { data: a, isLoading: o } = i(_e, t),
    s;
  e[0] === a ? (s = e[1]) : ((s = a?.some(gt) ?? !1), (e[0] = a), (e[1] = s));
  let c = s,
    l = n && !r && o,
    u = n && !r && !c,
    d;
  return (
    e[2] !== l || e[3] !== u
      ? ((d = { isEligible: u, isLoading: l }), (e[2] = l), (e[3] = u), (e[4] = d))
      : (d = e[4]),
    d
  );
}
function gt(e) {
  return e.name === pt && e.enabled;
}
var _t = `multi_agent`;
function vt(e) {
  let t = (0, W.c)(31),
    ...
    i = C(),
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: f }), (t[0] = a)) : (a = t[0]);
  let o = ve(a),
    [, c] = d(`composer_prefill`),
    [u, p] = y(mt),
    [m, h] = (0, J.useState)(!1),
    g = (0, J.useRef)(!1),
    _ = !u,
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, G.jsx)(w, {
      ...
      (T = (0, G.jsx)(Le, { className: `icon-sm` })),
      (E = (0, G.jsx)(w, {
      ...
      (t[7] = T),
      (t[8] = E))
    : ((x = t[5]), (S = t[6]), (T = t[7]), (E = t[8]));
  let D;
  t[9] !== i || t[10] !== n || t[11] !== r || t[12] !== c || t[13] !== o || t[14] !== p
    ? ((D = () => {
        h(!0);
        ...
        (z(r, I, { action: `try_now` }),
          o.mutateAsync({ featureName: _t, enabled: !0 }).finally(() => {
            (n ? n() : c({ text: e }), p(!0), h(!1));
          }));
      }),
      (t[9] = i),
      (t[10] = n),
...
function xt(e) {
  ...
  t[0] !== n || t[1] !== i
    ? ((a = () => {
        Oe(i, Pe, { initialAvailableCount: n, isRateLimitReached: !1, onResetComplete: St });
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a))
  ...
  return (
    t[3] !== r || t[4] !== a
      ? ((o = (0, G.jsx)(Ct, { onDismiss: r, onSeeResets: a })), (t[3] = r), (t[4] = a), (t[5] = o))
      : (o = t[5]),
    o
  );
}
...
var wt = 1440 * 60 * 1e3,
  $ = ie(`rate-limit-reset-home-announcement-dismissal-by-account-id`, {});
function Tt() {
  let e = (0, W.c)(9),
    t = s(l),
    { accountId: n, isLoading: r } = V(),
    i = c($),
    { data: a, isLoading: o } = c(g),
    u = a?.rate_limit_reset_credits?.available_count ?? 0,
    d = n == null ? null : i?.[n],
    f = Date.now(),
    p;
  e[0] !== n || e[1] !== u || e[2] !== t
    ? ((p = () => {
        n != null &&
          t.set($, (e) => ({ ...e, [n]: { availableCount: u, dismissedAtMs: Date.now() } }));
      }),
      (e[0] = n),
      (e[1] = u),
      (e[2] = t),
      (e[3] = p))
    : (p = e[3]);
  let m = n != null && u > 0 && (d == null || d.availableCount < u || f - d.dismissedAtMs >= wt),
    h = r || (a == null && o),
    _;
  return (
    e[4] !== u || e[5] !== p || e[6] !== m || e[7] !== h
      ? ((_ = { availableCount: u, dismiss: p, isEligible: m, isLoading: h }),
        (e[4] = u),
        (e[5] = p),
        (e[6] = m),
        (e[7] = h),
...
function Et(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, G.jsx)(w, {
      ...
      (c = (0, G.jsx)(Ae, { className: `icon-sm` })),
      (u = (0, G.jsx)(w, {
      ...
      (t[2] = c),
      (t[3] = u))
    : ((a = t[0]), (o = t[1]), (c = t[2]), (u = t[3]));
  let d;
  t[4] !== n || t[5] !== r
    ? ((d = {
        label: u,
        onClick: () => {
          (r.set(U, !0), n(`/settings/connections`));
        },
        className: `px-3 max-[400px]:flex-1 max-[400px]:justify-center`,
      }),
      (t[4] = n),
...
function Dt() {
  ...
  let o = u(a),
    s;
  e[1] === o ? (s = e[2]) : ((s = o?.some(Ot) ?? !1), (e[1] = o), (e[2] = s));
  let l = s,
    d = !n && o === void 0,
    f = !d && r && !i && !n && l,
    p;
  return (
    e[3] !== d || e[4] !== t || e[5] !== f
      ? ((p = { isEligible: f, isLoading: d, navigate: t }),
        (e[3] = d),
        (e[4] = t),
        (e[5] = f),
        (e[6] = p))
...
function kt() {
  ...
  e[0] !== r || e[1] !== t.pathname
    ? ((i = fe({ hideFirstNewThreadOnboardingPromos: r, pathname: t.pathname })),
      (e[0] = r),
      (e[1] = t.pathname),
      (e[2] = i))
    : (i = e[2]);
  ...
  e[16] === a
    ...
    : ((f = (0, G.jsx)(Ce, {
        extension: !0,
        children: (0, G.jsx)(jt, { shouldHideOnboardingPromos: a }),
      })),
      (e[16] = a),
      (e[17] = f));
  let p;
  return (
    e[18] !== d || e[19] !== f
      ? ((p = (0, G.jsxs)(G.Fragment, { children: [d, f] })), (e[18] = d), (e[19] = f), (e[20] = p))
      : (p = e[20]),
    p
  );
}
function At(e) {
  let t = (0, W.c)(49),
    ...
    { onDismiss: a, onDisable: o } = ze(),
    s = Tt(),
    c = nt(),
    l = Dt(),
    u = ht(),
    d = Q(),
    f = !c.shouldSuppressVanillaPromos,
    p;
  t[0] !== n || t[1] !== a
    ? ((p = () => {
        (a(), n());
  ...
  let h;
  t[6] !== p || t[7] !== m
    ? ((h = (0, G.jsx)(Re, { onDismiss: p, onDisable: m })), (t[6] = p), (t[7] = m), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== r || t[10] !== h
    ? ((g = { isEligible: r, isLoading: !1, content: h }), (t[9] = r), (t[10] = h), (t[11] = g))
    : (g = t[11]);
  let _;
  t[12] !== s.availableCount || t[13] !== s.dismiss
    ? ((_ = (0, G.jsx)(xt, { availableCount: s.availableCount, onDismiss: s.dismiss })),
      (t[12] = s.availableCount),
      (t[13] = s.dismiss),
      (t[14] = _))
    : (_ = t[14]);
  let v;
  t[15] !== s.isEligible || t[16] !== s.isLoading || t[17] !== _
    ? ((v = { isEligible: s.isEligible, isLoading: s.isLoading, content: _ }),
      (t[15] = s.isEligible),
      (t[16] = s.isLoading),
      (t[17] = _),
      (t[18] = v))
    : (v = t[18]);
  let y = !i && c.isEligible,
    b = !i && c.isLoading,
    x;
  t[19] !== c.accountId || t[20] !== c.beacon
    ? ((x =
        c.beacon != null && c.accountId != null
          ? (0, G.jsx)(rt, { accountId: c.accountId, beacon: c.beacon })
          : null),
      (t[19] = c.accountId),
      (t[20] = c.beacon),
      (t[21] = x))
  ...
  t[22] !== y || t[23] !== b || t[24] !== x
    ? ((S = { isEligible: y, isLoading: b, content: x }),
      ...
      (t[25] = S))
    : (S = t[25]);
  let C = !i && f && l.isEligible,
    w = !i && f && l.isLoading,
    T;
  t[26] === l.navigate
    ? (T = t[27])
    : ((T = (0, G.jsx)(Et, { navigate: l.navigate })), (t[26] = l.navigate), (t[27] = T));
  let E;
  ...
  let A;
  t[33] !== D || t[34] !== O
    ? ((A = { isEligible: D, isLoading: O, content: k }), (t[33] = D), (t[34] = O), (t[35] = A))
    : (A = t[35]);
  let j = !i && f && d.isEligible,
    M = !i && f && d.isLoading,
    N;
  t[36] === d
    ? (N = t[37])
    : ((N = d.content == null ? null : (0, G.jsx)(dt, { ...d })), (t[36] = d), (t[37] = N));
  let P;
  t[38] !== j || t[39] !== M || t[40] !== N
    ? ((P = { isEligible: j, isLoading: M, content: N }),
      (t[38] = j),
      (t[39] = M),
      (t[40] = N),
      (t[41] = P))
  ...
  let F;
  return (
    t[42] !== S || t[43] !== E || t[44] !== A || t[45] !== P || t[46] !== g || t[47] !== v
      ? ((F = (0, G.jsx)(bt, { entries: [g, v, S, E, A, P] })),
        (t[42] = S),
        (t[43] = E),
        (t[44] = A),
        (t[45] = P),
...
function jt(e) {
  ...
  t[11] === a
    ? (g = t[12])
    : ((g = a.content == null ? null : (0, G.jsx)(dt, { ...a })), (t[11] = a), (t[12] = g));
  let _;
...
export { kt as t };
//# sourceMappingURL=home-announcements.js.map
