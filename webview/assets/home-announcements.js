...
import { n as Wt, t as Gt } from "./team.js";
function Kt(e) {
  let t = (0, qt.c)(13),
    { action: n } = e,
    r = n.icon,
...
function K(e) {
  ...
  t[0] !== n || t[1] !== m || t[2] !== c || t[3] !== d || t[4] !== f
    ? ((g = (e) =>
        (0, q.jsxs)(`div`, {
          ...
          children: [
            f ? (0, q.jsx)(Kt, { action: f }) : null,
            d ? (0, q.jsx)(Kt, { action: d }) : null,
            c ? (0, q.jsx)(Kt, { action: c }) : null,
          ],
        })),
      (t[0] = n),
      (t[1] = m),
  ...
  t[14] !== m || t[15] !== h || t[16] !== _
    ? ((C = h && m === `aside` ? _() : null), (t[14] = m), (t[15] = h), (t[16] = _), (t[17] = C))
    : (C = t[17]);
  let w = C,
    T;
  t[18] !== m || t[19] !== h || t[20] !== _
    ? ((T = h && m === `bodyOnNarrow` ? _(`max-[400px]:hidden`) : null),
      (t[18] = m),
      (t[19] = h),
      (t[20] = _),
      (t[21] = T))
  ...
  t[34] === a
    ? (M = t[35])
    : ((M = Ge(`text-token-text-secondary mt-0.5 text-base leading-relaxed text-pretty`, a)),
      (t[34] = a),
      (t[35] = M));
  let N;
  t[36] !== s || t[37] !== M
...
function Jt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Y.jsx)(U, {
      ...
      (o = (0, Y.jsx)(gt, { className: `icon-sm` })),
      (s = (0, Y.jsx)(U, {
...
function Zt() {
  let e = (0, $t.c)(13),
    t = s(G),
    { authMethod: n, email: r, isLoading: i, planAtLogin: a } = Xe(),
    o = n === `chatgpt`,
    l;
  e[0] === o ? (l = e[1]) : ((l = { queryConfig: { enabled: o } }), (e[0] = o), (e[1] = l));
  let { data: u, isLoading: d } = v(`account-info`, l),
    f = c(kt),
    p = f != null,
    h = ue(`2425897452`),
    _ = se(),
    y = Ee(m.enabled),
    b = g({ authMethod: n, email: u?.email ?? r, plan: u?.plan ?? a }),
    x = h && b && y === !0 && f === !1,
    { data: S, isLoading: C } = nt({ enabled: x, hostId: Fe }),
    w;
  e[2] === S ? (w = e[3]) : ((w = S === void 0 ? [] : S), (e[2] = S), (e[3] = w));
  let T = w,
    E;
  e[4] === T ? (E = e[5]) : ((E = At(T)), (e[4] = T), (e[5] = E));
  let D = Qt({
      hasConnectedApps: E.length > 0,
      isLoadingApps: C,
      isLoadingEligibilityInputs: i || !p || _ || d,
      shouldLoadApps: x,
    }),
    O,
    k;
...
var $t,
  en = e(() => {
    (($t = r()), a(), h(), Ye(), at(), W(), he(), Ne(), I(), _(), Ot());
  });
function tn({ actionId: e, beaconId: t }) {
  return `${t}:${e}`;
}
function nn(e) {
...
function rn({ accountId: e, response: t }) {
  return t.beacon_ui_response == null
    ? { accountId: e, beacon: null, shouldKeepLastServedBeacon: !0 }
    : { accountId: e, beacon: nn(t), shouldKeepLastServedBeacon: !1 };
}
function an(e) {
  let t = on(e.action_v2);
  return t != null && sn(t) ? t : null;
}
function on(e) {
...
function cn({ accountId: e, authMethod: t, isAuthLoading: n }) {
  return !n && t === `chatgpt` && e != null;
}
function ln({ isAuthLoading: e }) {
  return e;
}
async function un(e, t, n) {
  try {
    await Oe.safePost(`/beacons/event`, {
      requestBody:
        n == null
...
function mn() {
  let e = (0, hn.c)(30),
    t = s(G),
    { accountId: n, authMethod: r, isLoading: i, userId: a } = Xe(),
    { data: o } = it(),
    l = me(),
    u = c(bn),
    d = c(Sn),
    ...
    m,
    h;
  if (e[0] !== n || e[1] !== r || e[2] !== o?.id || e[3] !== i || e[4] !== l || e[5] !== a) {
    let t = l.getContext().user?.customIDs?.account_id;
    ((m = n ?? o?.id ?? t ?? a ?? null),
      (h = cn({ accountId: m, authMethod: r, isAuthLoading: i })),
      (e[0] = n),
      (e[1] = r),
      (e[2] = o?.id),
      (e[3] = i),
  ...
  let g = h,
    _;
  e[8] === i ? (_ = e[9]) : ((_ = ln({ isAuthLoading: i })), (e[8] = i), (e[9] = _));
  let v = _,
    y,
    b;
  (e[10] !== m || e[11] !== t || e[12] !== g
    ? ((y = () => {
        (t.set(_n, m), t.set(vn, g));
      }),
      (b = [m, t, g]),
      (e[10] = m),
      (e[11] = t),
      ...
      (e[14] = b))
    : ((y = e[13]), (b = e[14])),
    (0, gn.useLayoutEffect)(y, b));
  let x, S;
  (e[15] !== d.data || e[16] !== t
    ? ((x = () => {
        d.data?.accountId != null &&
          d.data.beacon != null &&
          t.set(xn, { accountId: d.data.accountId, beacon: d.data.beacon });
      }),
      (S = [d.data, t]),
      (e[15] = d.data),
      (e[16] = t),
  ...
  let C =
      d.data?.accountId === m
        ...
        : null,
    w;
  if (e[19] !== u || e[20] !== C || e[21] !== m || e[22] !== g) {
    let t = C != null && m != null ? dn(m, C.beacon_id) : null;
    ((w = g && C != null && t != null && !u.has(t) ? C : null),
      (e[19] = u),
      (e[20] = C),
      (e[21] = m),
      (e[22] = g),
  ...
  let T = w,
    ...
    k;
  return (
    e[24] !== T || e[25] !== m || e[26] !== E || e[27] !== D || e[28] !== O
      ? ((k = {
          accountId: m,
          beacon: T,
          isEligible: D,
  ...
  Cn = e(() => {
    ((hn = r()),
      ...
      (Sn = p(G, ({ get: e }) => {
        let t = e(_n);
        return {
          queryKey: [`codex-app-home-beacon`, t, e(O).locale],
          enabled: e(vn),
          refetchOnMount: !1,
          ...
          queryFn: async () => ({
            accountId: t,
            response: await Oe.safeGet(`/beacons/home`, {
...
function wn(e) {
  ...
  return (
    t[9] !== r || t[10] !== i || t[11] !== l
      ? ((u = (0, An.jsx)(Tn, { beacon: r, localActionHandlers: i, onDismiss: l })),
        (t[9] = r),
        (t[10] = i),
        (t[11] = l),
        (t[12] = u))
...
function Tn(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
    let e = n.action_items.find(Dn),
      i = n.action_items.find(En),
      a = (e) => {
        if (e == null || e.text == null) return;
        let t = r?.[tn({ actionId: e.id, beaconId: n.beacon_id })],
          i = an(e);
        if (!(i == null && t == null))
          return {
            label: e.text,
            onClick: (r) => {
              if ((un(n, `click`, e.id), t?.({ action: e, beacon: n }) !== !0 && i != null)) {
                if (!i.startsWith(`/`)) {
                  et({ event: r, href: i, initiator: `open_in_browser_bridge` });
                  return;
                }
                o(i);
              }
...
var On,
  ...
  An,
  jn = e(() => {
    ((On = r()), a(), (kn = t(i(), 1)), V(), xe(), jt(), Cn(), st(), J(), R(), W(), (An = n()));
  });
function Mn(e) {
  let t = (0, Nn.c)(16),
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Pn.jsx)(`img`, { alt: ``, src: vt, className: `h-8 w-8 shrink-0` })), (t[1] = o))
    : (o = t[1]);
  let s;
...
var Nn,
  Pn,
  Fn = e(() => {
    ((Nn = r()), V(), bt(), st(), J(), R(), (Pn = n()));
  });
function In(e) {
  let t = (0, Rn.c)(6),
    { platform: n, isLoading: r } = ce(),
    { authMethod: i, planAtLogin: a, isLoading: o } = Xe(),
    s = i === `chatgpt`,
    c = i === `apikey`,
    l = s || c,
    u;
...
var Rn,
  ...
  Vn = e(() => {
    ((Rn = r()),
      ...
      _(),
      (zn = n()),
      (Bn = Qe(`has-seen-app-upsell-banner`, !1)));
  });
function Hn(e) {
  let t = (0, Un.c)(25),
    {
  ...
  let f, p;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Wn.jsx)(Vt, { className: `icon-sm text-[#FFC93C]` })),
      (p = (0, Wn.jsx)(U, {
    ...
    : ((f = t[1]), (p = t[2]));
  let m;
  t[3] !== r || t[4] !== u || t[5] !== o || t[6] !== c || t[7] !== l
    ? ((m = () => {
        r != null &&
          (c(!0),
          z(u, ie, {}),
          l(ne(r)?.id ?? `priority`, `home_banner`).finally(() => {
            (o(!0), c(!1));
          }));
      }),
      (t[3] = r),
...
var Un,
  Wn,
  Gn = e(() => {
    ((Un = r()), pe(), a(), V(), J(), zt(), R(), te(), W(), _e(), (Wn = n()));
  });
function Kn() {
  let e = (0, qn.c)(18),
    t = s(G),
    n = H(),
    { isServiceTierAllowed: r } = x(),
    { data: i } = T(),
    [a, o] = l(Xn),
    { modelSettings: c } = k(),
    { serviceTierSettings: u, setServiceTier: d } = N(),
    [f, p] = (0, Jn.useState)(!1),
    m = (0, Jn.useRef)(!1),
    h = i?.models,
    g;
  e[0] !== c.model || e[1] !== h
    ? ((g = ae(h, c.model, de)), (e[0] = c.model), (e[1] = h), (e[2] = g))
    : (g = e[2]);
  let _ = g,
    v = r && _ != null && !a && u.selectedServiceTier == null && !u.isLoading,
    { estimate: y, estimateStatus: b } = Lt(v),
    S = !a && v && b !== `ready` && b !== `failed`,
    C = v && b === `ready` && y != null,
    w,
    E;
  (e[3] !== C || e[4] !== t
    ? ((w = () => {
        !C || m.current || ((m.current = !0), z(t, Te, {}));
      }),
      (E = [t, C]),
      (e[3] = C),
      (e[4] = t),
...
var qn,
  ...
  Zn = e(() => {
    ((qn = r()),
      ...
      Rt(),
      (Yn = n()),
      (Xn = Qe(`has-seen-fast-mode-home-banner`, !1)));
  });
function Qn() {
  let e = (0, er.c)(5),
    { hostId: t } = y(j()),
    n = ft(),
    [r] = l(nr),
    { data: i, isLoading: a } = d(rt, t),
    o;
  e[0] === i ? (o = e[1]) : ((o = i?.some($n) ?? !1), (e[0] = i), (e[1] = o));
  let s = o,
    c = n && !r && a,
    u = n && !r && !s,
    f;
  return (
    e[2] !== c || e[3] !== u
      ? ((f = { isEligible: u, isLoading: c }), (e[2] = c), (e[3] = u), (e[4] = f))
      : (f = e[4]),
    f
  );
}
function $n(e) {
  return e.name === tr && e.enabled;
}
var er,
  tr,
  nr,
  rr = e(() => {
    ((er = r()),
      ...
      ot(),
      (tr = `multi_agent`),
      (nr = Qe(`has-seen-multi-agent-composer-banner`, !1)));
  });
function ir(e) {
  let t = (0, ar.c)(31),
    { onTryNow: n } = e,
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, X.jsx)(U, {
      ...
      (b = (0, X.jsx)(Gt, { className: `icon-sm` })),
      (x = (0, X.jsx)(U, {
  ...
  let S;
  t[9] !== i || t[10] !== n || t[11] !== r || t[12] !== c || t[13] !== o || t[14] !== d
    ? ((S = () => {
        p(!0);
...
function lr(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(`span`, {
      ...
      (s = (0, Z.jsx)(Le, { className: `icon-sm` })),
      (c = (0, Z.jsx)(U, {
...
function yr(e) {
  ...
  t[0] !== n || t[1] !== i
    ? ((a = () => {
        Ht(i, yt, { initialAvailableCount: n, isRateLimitReached: !1, onResetComplete: br });
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a))
...
var Sr,
  Q,
  Cr = e(() => {
    ((Sr = r()), a(), V(), Ut(), J(), pt(), R(), _t(), W(), (Q = n()));
  });
function wr() {
  let e = (0, Tr.c)(9),
    t = s(G),
    { accountId: n, isLoading: r } = Xe(),
    i = c(Dr),
    { data: a, isLoading: o } = c(ye),
    l = a?.rate_limit_reset_credits?.available_count ?? 0,
    u = n == null ? null : i?.[n],
    d = Date.now(),
    f;
  e[0] !== n || e[1] !== l || e[2] !== t
    ? ((f = () => {
        n != null &&
          t.set(Dr, (e) => ({ ...e, [n]: { availableCount: l, dismissedAtMs: Date.now() } }));
      }),
      (e[0] = n),
      (e[1] = l),
      (e[2] = t),
      (e[3] = f))
    : (f = e[3]);
  let p = n != null && l > 0 && (u == null || u.availableCount < l || d - u.dismissedAtMs >= Er),
    m = r || (a == null && o),
    h;
  return (
    e[4] !== l || e[5] !== f || e[6] !== p || e[7] !== m
      ? ((h = { availableCount: l, dismiss: f, isEligible: p, isLoading: m }),
        (e[4] = l),
        (e[5] = f),
        (e[6] = p),
        (e[7] = m),
...
var Tr,
  ...
  Or = e(() => {
    ((Tr = r()),
      ...
      be(),
      (Er = 1440 * 60 * 1e3),
      (Dr = ve(`rate-limit-reset-home-announcement-dismissal-by-account-id`, {})));
  });
function kr(e) {
  let t = (0, Ar.c)(17),
    { navigate: n } = e,
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, jr.jsx)(U, {
      ...
      (c = (0, jr.jsx)(tt, { className: `icon-sm` })),
      (l = (0, jr.jsx)(U, {
      ...
      (t[2] = c),
      (t[3] = l))
    : ((a = t[0]), (o = t[1]), (c = t[2]), (l = t[3]));
  let u;
  t[4] !== n || t[5] !== r
    ? ((u = {
        label: l,
        onClick: () => {
          (r.set(Ct, !0), n(`/settings/connections`));
        },
        className: `px-3 max-[400px]:flex-1 max-[400px]:justify-center`,
      }),
      (t[4] = n),
...
function Lr() {
  ...
  e[0] !== r || e[1] !== t.pathname
    ? ((i = Dt({ hideFirstNewThreadOnboardingPromos: r, pathname: t.pathname })),
      (e[0] = r),
      (e[1] = t.pathname),
      (e[2] = i))
    : (i = e[2]);
  ...
  return (
    e[16] !== d || e[17] !== f
      ? ((p = (0, $.jsxs)($.Fragment, { children: [d, f] })), (e[16] = d), (e[17] = f), (e[18] = p))
      : (p = e[18]),
    p
  );
}
function Rr(e) {
  ...
  t[22] !== s.accountId || t[23] !== s.beacon
    ? ((w =
        s.beacon != null && s.accountId != null
          ? (0, $.jsx)(wn, { accountId: s.accountId, beacon: s.beacon })
          : null),
      (t[22] = s.accountId),
      (t[23] = s.beacon),
      (t[24] = w))
  ...
  t[39] === u
    ? (I = t[40])
    : ((I = u.content == null ? null : (0, $.jsx)(Hn, { ...u })), (t[39] = u), (t[40] = I));
  let L;
  ...
  return (
    ...
    t[50] !== h ||
    t[51] !== y
      ? ((ee = (0, $.jsx)(gr, { entries: [h, y, x, T, k, N, L] })),
        (t[45] = x),
        (t[46] = T),
        (t[47] = k),
        (t[48] = N),
...
function zr(e) {
  ...
  t[11] === a
    ? (g = t[12])
    : ((g = a.content == null ? null : (0, $.jsx)(Hn, { ...a })), (t[11] = a), (t[12] = g));
  let _;
