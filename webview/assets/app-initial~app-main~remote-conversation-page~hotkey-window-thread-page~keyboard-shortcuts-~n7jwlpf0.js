...
function qt() {
  b.dispatchMessage(`open-in-browser`, { url: Yt });
}
var Jt,
  Yt,
  Xt = e(() => {
    (u(), (Jt = `1728613635`), (Yt = `https://chatgpt.com/gifts/credits`));
  }),
  Zt,
  Qt,
  B = e(() => {
    (T(),
      (Zt = Me(`has-seen-gift-credits-home-banner`, !1)),
      (Qt = Me(`gift-credits-profile-coachmark-pending`, !1)));
  }),
  V,
  $t,
  en = e(() => {
...
function dn() {
  ...
  return (
    e[0] !== n || e[1] !== r
      ? ((i = n && r.get(mn, !1)), (e[0] = n), (e[1] = r), (e[2] = i))
      : (i = e[2]),
    i
  );
}
...
function gn() {
  let e = (0, q.c)(21),
    ...
    a = et(`3909937021`),
    o = tt(),
    { data: s, isLoading: c, hasEverErrored: l } = xe(),
    u;
  e[0] === r
    ? (u = e[1])
    : ((u = { queryConfig: { enabled: r, staleTime: _.ONE_MINUTE } }), (e[0] = r), (e[1] = u));
  let { data: d, isLoading: f } = h(`account-info`, u),
    p = s?.plan_type ?? (!c || l ? d?.plan : void 0),
    m;
  e[2] === p ? (m = e[3]) : ((m = vn(p)), (e[2] = p), (e[3] = m));
  let g = m,
    v,
    y,
    ee,
  ...
  if (
    ...
    ((v = r && c && !l),
      ...
      (e[15] = ee),
      (e[16] = b));
  } else ((v = e[13]), (y = e[14]), (ee = e[15]), (b = e[16]));
  let te = n || (r && f) || v || ee || y,
    ne;
  return (
    e[17] !== p || e[18] !== b || e[19] !== te
      ? ((ne = { ...b, isUsageSettingsAccessLoading: te, plan: p }),
        (e[17] = p),
        (e[18] = b),
        (e[19] = te),
        (e[20] = ne))
...
var q,
  ...
  bn = e(() => {
    ((q = p()),
      ...
      f(),
      (J = `1636924626`),
      (yn = `enable_free_go_usage_settings`));
  }),
  xn,
  Sn = e(() => {
    (l(), n(), (xn = c(r, !1)));
...
function Y({ currentAccount: e, accounts: t }) {
  return Cn(e) ? (t == null ? !0 : t.some((e) => !Cn(e))) : !1;
}
function wn({ authMethod: e, plan: t, currentAccount: n, accounts: r }) {
  return e !== `chatgpt` || (t !== E.FREE && t !== E.GO) || n == null || r == null
    ? !1
    : !Y({ currentAccount: n, accounts: r });
}
var X = e(() => {
  me();
});
function Z(e) {
  ...
  let f = d,
    ...
    he = T || pe,
    _e;
  t[4] === T ? (_e = t[5]) : ((_e = { queryConfig: { enabled: T } }), (t[4] = T), (t[5] = _e));
  let { data: ve } = h(`account-info`, _e),
    D = w?.plan_type ?? ve?.plan ?? re,
    we;
  t[6] !== T || t[7] !== D ? ((we = T && Be(D)), (t[6] = T), (t[7] = D), (t[8] = we)) : (we = t[8]);
  let Oe = we,
    Ae = ce?.accounts,
    je;
  t[9] !== w || t[10] !== x || t[11] !== D || t[12] !== Ae
    ? ((je = wn({ authMethod: x, plan: D, currentAccount: w, accounts: Ae })),
      (t[9] = w),
      (t[10] = x),
      (t[11] = D),
      (t[12] = Ae),
  ...
  let Me = je,
    Ne;
  t[14] === D ? (Ne = t[15]) : ((Ne = Ot(D)?.pricePlan ?? null), (t[14] = D), (t[15] = Ne));
  let k = Ne,
    Pe = !he && S != null,
    Fe = !E && se,
    Ie = !he && S == null && ae,
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((We = { logExposure: !1 }), (t[16] = We))
    : (We = t[16]);
  let Ke = Dt(We),
    qe;
  t[17] === Ke ? (qe = t[18]) : ((qe = Ke()), (t[17] = Ke), (t[18] = qe));
  let A = qe,
    j = yt(),
    Ye = Je(`/remote/:taskId`),
    Qe;
  t[19] !== j || t[20] !== Ye
    ? ((Qe = j ?? (Ye?.params.taskId == null ? null : ee(Ye.params.taskId))),
      (t[19] = j),
      (t[20] = Ye),
      (t[21] = Qe))
    : (Qe = t[21]);
  let $e = Qe,
    ...
    M;
  t[22] !== tt || t[23] !== j
    ? ((M = j == null ? void 0 : { workspaceRoot: tt }), (t[22] = tt), (t[23] = j), (t[24] = M))
    : (M = t[24]);
  let N = M,
    { activeMode: it } = ht($e),
    ot = it?.settings.model ?? null,
    ct = i(te, `settings`),
    lt = Xe(),
    { data: F } = v(nt),
    ut = Nt(F),
  ...
  t[25] === F?.plan_type
    ? (ft = t[26])
    : ((ft = Ot(F?.plan_type)?.pricePlan ?? null), (t[25] = F?.plan_type), (t[26] = ft));
  let pt = ft,
    gt = Rt(ut, { activeLimitName: dt, selectedModel: ot }),
    vt = Bt(F, { activeLimitName: dt, selectedModel: ot }),
    xt = F?.rate_limit_reset_credits?.available_count ?? 0,
    { isUsageSettingsVisible: St, isUsageSettingsAccessLoading: Ct } = gn(),
    Et = u && Oe && St && !Ct,
    kt = w?.id ?? m ?? ve?.accountId ?? null,
    jt;
  t[27] !== Et || t[28] !== kt
    ? ((jt = { accountId: kt, enabled: Et }), (t[27] = Et), (t[28] = kt), (t[29] = jt))
    : (jt = t[29]);
  let { data: Mt } = It(jt),
    Pt = On(Mt === void 0 ? null : Mt),
    Ft = Pt != null,
    I = gt;
  Oe && ((I = []), Pt != null && (I = [Pt]));
  let Ht = Oe ? null : dt,
  ...
  t[34] !== w?.name || t[35] !== B
    ...
    : (nn = t[36]);
  let U = nn,
    W = w?.profile_picture_url ?? null,
    [an, on] = (0, jn.useState)(null),
    sn;
  t[37] !== lt || t[38] !== a || t[39] !== _
    ? ((sn = async () => {
        if (_ != null)
          try {
            (await ne(_),
  ...
  t[41] === f
    ? (ln = t[42])
    : ((ln = (e) => {
        (f(!1), Te({ event: e, href: _t, initiator: `open_in_browser_bridge` }));
      }),
      (t[41] = f),
      (t[42] = ln));
  let un = ln,
  ...
  t[43] === f
    ? (K = t[44])
    : ((K = () => {
        (f(!1), b.dispatchHostMessage({ type: `navigate-to-route`, path: `/settings/usage` }));
      }),
      (t[43] = f),
      (t[44] = K));
  let fn = K,
    pn;
  t[45] !== a || t[46] !== f || t[47] !== L
    ? ((pn = () => {
        (f(!1),
          oe(a, zt, { initialAvailableCount: L, isRateLimitReached: !1, onResetComplete: Tn }));
      }),
      (t[45] = a),
      (t[46] = f),
      (t[47] = L),
  ...
  t[49] !== p || t[50] !== a
    ? ((hn = async () => {
        (await Ge(a, `use-copilot-auth-if-available`, !1),
          await at(`logout`, { hostId: Ze }),
          p(`/login`));
      }),
      (t[49] = p),
      (t[50] = a),
    ...
    ? ((vn = function (e) {
        return W && W !== an
          ? (0, Q.jsx)(`img`, {
              src: W,
              alt: ``,
              className: De(`rounded-full`, e.className),
              onError: () => {
                on(W);
              },
            })
          : (0, Q.jsx)(ie, { className: e.className });
      }),
      (t[52] = W),
      (t[53] = an),
      (t[54] = vn))
  ...
  if (
    ...
    if (((J = []), T)) {
      if (g) {
        ...
        t[80] === g
          ? (n = t[81])
          : ((n = (0, Q.jsx)(O, { LeftIcon: mt, disabled: !0, children: g })),
            (t[80] = g),
            (t[81] = n));
        let r;
        (t[82] !== e || t[83] !== n
      ...
      if (!ue) {
        let e;
        (t[85] !== q || t[86] !== U
          ? ((e = (0, Q.jsx)(O, { LeftIcon: q, disabled: !0, children: U }, `account`)),
            (t[85] = q),
            (t[86] = U),
            (t[87] = e))
          : (e = t[87]),
      ...
      if (Me) {
        let e = Xt ? le : void 0,
          n;
        t[88] !== A || t[89] !== e
          ? ((n = (0, Q.jsx)(fe, { className: Pn, href: A, PrimaryIcon: e })),
            (t[88] = A),
            (t[89] = e),
            (t[90] = n))
          : (n = t[90]);
        let r;
        t[91] !== A || t[92] !== k || t[93] !== z || t[94] !== a || t[95] !== f
          ? ((r = (e) => {
              (f(!1),
                z({
                  scope: a,
        ...
        (t[98] !== n || t[99] !== r
          ? ((o = (0, Q.jsx)(
              O,
              { LeftIcon: cn, rightIcon: n, onClick: r, children: i },
              `upgrade-account`,
            )),
            (t[98] = n),
            (t[99] = r),
    ...
    if (Pe) {
      let e;
      t[104] !== S || t[105] !== a || t[106] !== C || t[107] !== f
        ? ((e = () => {
            (f(!1), Ge(a, `use-copilot-auth-if-available`, !1), C(S));
          }),
          (t[104] = S),
          (t[105] = a),
          (t[106] = C),
      ...
      (t[110] === e
        ? (r = t[111])
        : ((r = (0, Q.jsx)(O, { onClick: e, LeftIcon: rn, children: n }, `switch-to-openai`)),
          (t[110] = e),
          (t[111] = r)),
        J.push(r));
    } else if (Fe) {
      let e;
      t[112] !== a || t[113] !== C || t[114] !== f
        ? ((e = () => {
            (f(!1), Ge(a, `use-copilot-auth-if-available`, !0), C(`copilot`));
          }),
          (t[112] = a),
          (t[113] = C),
          (t[114] = f),
      ...
      (t[117] === e
        ? (r = t[118])
        : ((r = (0, Q.jsx)(O, { onClick: e, LeftIcon: rn, children: n }, `switch-to-copilot`)),
          (t[117] = e),
          (t[118] = r)),
        J.push(r));
    }
    if (Ie) {
      ...
      (t[123] === e
        ? (r = t[124])
        : ((r = (0, Q.jsx)(O, { onClick: e, LeftIcon: be, children: n }, `sign-in-openai`)),
          (t[123] = e),
          (t[124] = r)),
        J.push(r));
    }
  ...
  let bn = yn,
    Sn;
  t[126] !== c || t[127] !== s || t[128] !== l || t[129] !== n
    ? ((Sn =
        s && c
          ? (0, Q.jsx)(ze, {
              disableHoverOpen: !0,
  ...
  t[131] === J.length
    ? (Y = t[132])
    : ((Y = J.length > 0 && (0, Q.jsx)(ke.Separator, {})), (t[131] = J.length), (t[132] = Y));
  let X;
  t[133] !== Re || t[134] !== p || t[135] !== a || t[136] !== f || t[137] !== N
    ? ((X =
        Re &&
        (0, Q.jsx)(O, {
          LeftIcon: mt,
          onClick: () => {
            (He(a, Ve, { source: `profile_dropdown` }),
              f(!1),
              p(`/settings/profile`, { state: N }));
          },
          children: (0, Q.jsx)(P, {
    ...
    : (X = t[138]);
  let Z;
  t[139] !== p || t[140] !== f || t[141] !== N
    ? ((Z = () => {
        (f(!1), p(`/settings/${Wt}`, { state: N }));
      }),
      (t[139] = p),
      (t[140] = f),
      (t[141] = N),
  ...
  let In;
  t[144] !== ct || t[145] !== Z
    ? ((In = (0, Q.jsx)(O, { LeftIcon: ie, keyboardShortcut: ct, onClick: Z, children: Fn })),
      (t[144] = ct),
      (t[145] = Z),
      (t[146] = In))
    : (In = t[146]);
  let Ln;
  t[147] !== X || t[148] !== In
    ? ((Ln = (0, Q.jsxs)(Ee, { browser: !0, electron: !0, children: [X, In] })),
      (t[147] = X),
      (t[148] = In),
      (t[149] = Ln))
    : (Ln = t[149]);
  ...
  t[150] === f
    ? (Rn = t[151])
    : ((Rn = () => {
        (f(!1), b.dispatchMessage(`show-settings`, { section: Wt }));
      }),
      (t[150] = f),
      (t[151] = Rn));
  let zn;
  ...
  t[153] === Rn
    ...
    : ((Bn = (0, Q.jsx)(Ee, {
        extension: !0,
        children: (0, Q.jsx)(O, { LeftIcon: Ut, onClick: Rn, children: zn }),
      })),
      (t[153] = Rn),
      (t[154] = Bn));
  let Vn;
  t[155] !== s || t[156] !== f
    ...
    : (Vn = t[157]);
  let Hn;
  t[158] !== T || t[159] !== en || t[160] !== un
    ? ((Hn =
        T && en()
          ? (0, Q.jsx)(O, {
              LeftIcon: bt,
              rightIcon: (0, Q.jsx)(fe, { href: _t, className: Pn }),
              onClick: un,
              children: (0, Q.jsx)(P, {
  ...
  t[162] === f
    ? ($ = t[163])
    : (($ = () => {
        (f(!1), b.dispatchMessage(`open-keyboard-shortcuts`, {}));
      }),
      (t[162] = f),
      (t[163] = $));
  let Un;
  ...
  t[165] === $
    ...
    : ((Wn = (0, Q.jsx)(Ee, {
        extension: !0,
        children: (0, Q.jsx)(O, { LeftIcon: tn, onClick: $, children: Un }),
      })),
      (t[165] = $),
      (t[166] = Wn));
  let Gn;
  t[167] !== B || t[168] !== T || t[169] !== H
    ? ((Gn = T && H != null ? (0, Q.jsx)(Dn, { isPersonalAccount: B(), layer: H }) : null),
      (t[167] = B),
      (t[168] = T),
      (t[169] = H),
      (t[170] = Gn))
  ...
  t[171] === Gn
    ? (Kn = t[172])
    : ((Kn = (0, Q.jsx)(Ee, { electron: !0, children: Gn })), (t[171] = Gn), (t[172] = Kn));
  let qn;
  t[173] === R
    ? (qn = t[174])
    : ((qn = R ? (0, Q.jsx)(ke.Separator, {}) : null), (t[173] = R), (t[174] = qn));
  let Jn;
  t[175] === qn
    ? (Jn = t[176])
    : ((Jn = (0, Q.jsx)(Ee, { electron: !0, children: qn })), (t[175] = qn), (t[176] = Jn));
  let Yn;
  t[177] !== Ft ||
  t[178] !== mn ||
  t[179] !== fn ||
  ...
  t[190] !== I
    ? ((Yn = R
        ? (0, Q.jsx)(st, {
            ...
            suppressUpsell: Ft ? !1 : vt,
            selectedModel: ot,
            availableRateLimitResetCount: L,
            onRateLimitResetClick: mn,
            layout: `compact`,
            planUpgradeOpensNativeSurface: Yt,
            showLearnMore: !Ft,
            onRequestLimitIncreaseClick: Ft ? fn : void 0,
            onPlanUpgradeClick:
              pt == null
                ? void 0
                : (e) => {
  ...
  t[192] === Yn
    ? (Xn = t[193])
    : ((Xn = (0, Q.jsx)(Ee, { electron: !0, children: Yn })), (t[192] = Yn), (t[193] = Xn));
  let Zn;
  t[194] !== _n || t[195] !== a || t[196] !== f || t[197] !== Le
    ? ((Zn =
        Le &&
        (0, Q.jsx)(O, {
          onClick: () => {
            (f(!1), oe(a, kn, { onConfirm: _n }));
          },
          LeftIcon: rn,
          children: (0, Q.jsx)(P, {
  ...
  t[209] !== Zn
    ? ((Qn = (0, Q.jsxs)(`div`, {
        ...
        children: [J, Y, Ln, Bn, Vn, Hn, Wn, Kn, Jn, Xn, Zn],
      })),
      (t[199] = J),
      (t[200] = Y),
      (t[201] = Ln),
  ...
  let $n;
  return (
    t[211] !== u || t[212] !== Cn || t[213] !== f || t[214] !== Qn
      ? (($n = (0, Q.jsx)(Se, {
          open: u,
          onOpenChange: f,
          contentWidth: `panel`,
  ...
  return t == null
    ...
    : {
        ...
        snapshot: {
          limitId: null,
          limitName: null,
          primary: { usedPercent: t.usedPercent, windowDurationMins: dt, resetsAt: null },
          secondary: null,
          credits: null,
...
function kn(e) {
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(ce, { asChild: !0, children: (0, Q.jsx)(`span`, { children: a }) })),
      (t[6] = l))
    : (l = t[6]);
  let u;
  ...
  t[9] === n
    ? (f = t[10])
    : ((f = (0, Q.jsx)(ge, { color: `ghost`, type: `button`, onClick: n, children: d })),
      (t[9] = n),
      (t[10] = f));
  let p;
  ...
  t[12] === f
    ? (m = t[13])
    : ((m = (0, Q.jsxs)(Pe, { className: `gap-2`, children: [f, p] })), (t[12] = f), (t[13] = m));
  let h;
  t[14] !== c || t[15] !== m
    ? ((h = (0, Q.jsxs)(D, {
        as: `form`,
  ...
  return (
    t[17] !== n || t[18] !== h
      ? ((g = (0, Q.jsx)(Ie, { open: !0, onOpenChange: n, size: `narrow`, children: h })),
        (t[17] = n),
        (t[18] = h),
        (t[19] = g))
      : (g = t[19]),
...
var An,
  ...
  Fn = e(() => {
    ((An = p()),
      ...
      (Mn = `1038162578`),
      (Nn = `3648137593`),
      (Pn = `icon-xs shrink-0 opacity-75 group-focus:opacity-100 group-hover:opacity-100`));
  });
export {
  Wt as C,
  L as D,
