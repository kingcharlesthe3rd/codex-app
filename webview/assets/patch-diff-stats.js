...
import { t as r } from "./parse-diff-BMY7-MEq.js";
import { n as i } from "./use-resize-observer.js";
var a = n(),
  o = e(t(), 1);
function s() {
  let e = (0, a.c)(7),
  ...
  return (
    e[4] !== t || e[5] !== f
      ? ((p = { elementHeightPx: t, elementRef: f }), (e[4] = t), (e[5] = f), (e[6] = p))
      : (p = e[6]),
    p
  );
}
...
function l(e, t) {
  ...
  let n = u(e),
    i = r(e)[0];
  return i && (i.additions > 0 || i.deletions > 0 || (n.added === 0 && n.deleted === 0))
    ? {
        added: i.additions,
        deleted: i.deletions,
        openLocation: { path: t, line: i.firstAdditionLine ?? i.firstDeletionLine ?? 1 },
      }
...
//# sourceMappingURL=patch-diff-stats.js.map
