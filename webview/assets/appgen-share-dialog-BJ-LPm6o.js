...
import { p as f } from "./codex-api-B.js";
...
import { t as E } from "./globe.js";
import { t as D } from "./copy-to-clipboard.js";
import { t as O } from "./building.js";
import { t as k } from "./arrow-up-right-lg.js";
import { t as A } from "./link.js";
import {
  c as ee,
  d as te,
  f as ne,
...
function _e(e) {
  ...
  if (
    ...
    let i = H.filter(r),
      a;
    (t[23] === l ? (a = t[24]) : ((a = (e) => Ne(e, l)), (t[23] = l), (t[24] = a)),
      (K = [...i.map(a), ...(W?.map(Pe) ?? [])]),
      (t[4] = I),
      (t[5] = R),
      (t[6] = g?.account_user_id),
  ...
  if (t[25] !== l || t[26] !== N || t[27] !== j) {
    let e;
    (t[29] === l ? (e = t[30]) : ((e = (e) => Ne(e, l)), (t[29] = l), (t[30] = e)),
      (Fe = [...N.map(e), ...j.map(Pe)]),
      (t[25] = l),
      (t[26] = N),
      (t[27] = j),
  ...
  t[52] !== z || t[53] !== H || t[54] !== U || t[55] !== qe
    ? ((Je = function (e) {
        ...
        switch (e.kind) {
          ...
          case `group`:
            return qe(
              ne({ accessGroups: H, accessPolicy: z, group: e.group, knownAccessGroups: U }),
            );
        }
      }),
      (t[52] = z),
    ...
    ? ((Z = E
        ...
        : w || C == null || z == null
          ...
          : (0, F.jsxs)(F.Fragment, {
              children: [
                (0, F.jsx)(v, {
                  children: (0, F.jsx)(Te, { liveUrl: C.current_live_url, title: C.title }),
                }),
                (0, F.jsx)(v, {
                  children: (0, F.jsx)(le, {
                    ...
                    options: !L || I == null || R == null || W == null ? void 0 : Me,
                    ...
                    onRemoveOption: (e) => {
                      ...
                      bb143: switch (t.kind) {
                        case `group`:
                          ...
                          break bb143;
                        case `user`:
                          oe((e) => e.filter((e) => e.account_user_id !== t.user.account_user_id));
                      }
                    },
                    onSelectOption: (e) => {
                      let { target: t } = e;
...
function we(e) {
  ...
  let h;
  t[14] !== f || t[15] !== m
    ? ((h = (0, F.jsx)(b, { title: f, titleClassName: `truncate pr-8`, subtitle: m })),
      (t[14] = f),
      (t[15] = m),
      (t[16] = h))
    : (h = t[16]);
  ...
  let T;
  t[18] !== s || t[19] !== r
    ? ((T = (0, F.jsx)(g, { color: `secondary`, disabled: s, onClick: r, children: _ })),
      (t[18] = s),
      (t[19] = r),
      (t[20] = T))
    : (T = t[20]);
  ...
  t[22] === s
    ? (D = t[23])
    : ((D = (0, F.jsx)(g, { color: `danger`, loading: s, type: `submit`, children: E })),
      (t[22] = s),
      (t[23] = D));
  let O;
  t[24] !== D || t[25] !== T
  ...
  return (
    t[9] !== c || t[10] !== u
      ? ((d = (0, F.jsxs)(`div`, {
          ...
          children: [
            s,
            (0, F.jsxs)(`div`, { className: `flex min-w-0 flex-col gap-0.5`, children: [c, u] }),
          ],
        })),
        (t[9] = c),
        (t[10] = u),
...
function Ee(e) {
  ...
  if (
    ...
    let e = De({ activeAccessUsers: i, currentAccountUserId: u, currentUserEmail: l }),
    ...
    (t[16] !== o.access_mode || t[17] !== d || t[18] !== r || t[19] !== s
      ? ((S = (0, F.jsx)(
          V,
          { initialAccessMode: o.access_mode, selectedAccessMode: s, onAccessModeChange: d },
          r,
        )),
        (t[16] = o.access_mode),
        (t[17] = d),
    ...
    (t[21] === p
      ...
      (t[13] = x),
      (t[14] = S));
  } else ((h = t[8]), (g = t[9]), (_ = t[10]), (y = t[11]), (b = t[12]), (x = t[13]), (S = t[14]));
  let C;
...
function De({ activeAccessUsers: e, currentAccountUserId: t, currentUserEmail: n }) {
...
function V(e) {
  ...
  return (
    t[3] !== a || t[4] !== i || t[5] !== r || t[6] !== o
      ? ((s = (0, F.jsx)(a, { options: o, value: r, renderLabel: H, onChange: i })),
        (t[3] = a),
        (t[4] = i),
        (t[5] = r),
        (t[6] = o),
...
function ke(e) {
  let t = (0, P.c)(27),
    ...
    y;
  t[0] !== c || t[1] !== l
    ? ((y = K({ action: `copyLink`, isSaving: c, liveUrl: l })), (t[0] = c), (t[1] = l), (t[2] = y))
    : (y = t[2]);
  let b = y,
    x;
  t[3] !== c || t[4] !== l
    ? ((x = K({ action: `visit`, isSaving: c, liveUrl: l })), (t[3] = c), (t[4] = l), (t[5] = x))
    : (x = t[5]);
  let S = x,
    C;
  t[6] === f
    ? (C = t[7])
    : ((C = { invite: { onClick: f }, share: { onClick: f } }), (t[6] = f), (t[7] = C));
  let w;
  t[8] === d ? (w = t[9]) : ((w = { onClick: d }), (t[8] = d), (t[9] = w));
  let T;
  t[10] !== b || t[11] !== p || t[12] !== c || t[13] !== l || t[14] !== _ || t[15] !== S
    ? ((T =
        l === void 0
          ? null
          : (0, F.jsxs)(`div`, {
                ...
                (0, F.jsx)(h, {
                  ...
                  children: (0, F.jsx)(`span`, {
                    ...
                    children: (0, F.jsxs)(g, {
                      ...
                      size: `toolbar`,
                      onClick: () => {
                        l != null && u.dispatchMessage(`open-in-browser`, { url: l });
                      },
                      children: [
...
//# sourceMappingURL=appgen-share-dialog-BJ-LPm6o.js.map
