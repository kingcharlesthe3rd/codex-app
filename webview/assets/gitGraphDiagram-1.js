...
import { n as re, t as ie } from "./src-1.js";
import { g as ae, m as oe, r as se, u as ce } from "./chunk-123.js";
import { n as le, t as ue } from "./chunk-17.js";
import { n as de, t as fe } from "./mermaid-parser.core-1.js";
import { n as pe, t as me } from "./chunk-122.js";
function m() {
  return oe({ length: 7 });
}
function he(e, t) {
...
function g(e) {
  ...
  let i = [r, n.id, n.seq];
  for (let e in y.records.branches) y.records.branches.get(e) === n.id && i.push(e);
  ...
  (ue(),
    ...
    (be = n(function (e) {
      ...
      ((y.records.head = s),
        ...
        y.records.commits.has(s.id) && t.warn(`Commit ID ${s.id} already exists`),
    ...
    (xe = n(function (e) {
      ...
      (y.records.branches.set(n, y.records.head == null ? null : y.records.head.id),
    ...
    (b = n((e) => {
      ...
      if (!y.records.branches.has(n)) {
        ...
        throw (
          (e.hash = { text: `merge ${n}`, token: `merge ${n}`, expected: [`branch ${n}`] }), e
        );
      }
      if (u === void 0 || !u) {
    ...
    (Ee = n((e, t, n) => {
      ...
      (e.forEach((e) => {
        ...
        (n.parents.length ? ((r = Oe(n)), (i = Math.max(r, i))) : a.push(n), ke(n, r));
      }),
        (r = i),
        a.forEach((e) => {
          Ae(e, r, n);
      ...
      (J === `BT` && (c && Ee(u, t, o), (u = u.reverse())),
        u.forEach((e) => {
          ...
          if (r) {
            ...
            (je(i, n, s, e, H.get(n.branch)?.index ?? 0, t), Me(a, n, s, o), Ne(a, n, s, o));
          }
          (J === `TB` || J === `BT`
    ...
    (Le = n((e, t, r, i, a) => {
      let o = (J === `TB` || J === `BT` ? r.x < i.x : r.y < i.y) ? t.branch : e.branch,
    ...
    ($ = n((e, t, n, r) => {
      ...
      n.type === _.MERGE && t.id !== n.parents[0] && (d = H.get(t.branch)?.index);
      let f;
      if (o) {
      ...
      t.forEach((e, t) => {
        ...
        (a.attr(`x1`, 0),
          ...
          J === `TB`
            ...
            : J === `BT` && (a.attr(`y1`, q), a.attr(`x1`, i), a.attr(`y2`, W), a.attr(`x2`, i)),
          K.push(i));
        let o = e.name,
          s = Y(o),
          c = n.insert(`rect`),
          ...
          J === `TB`
            ...
            : J === `BT`
              ? (c.attr(`x`, i - u.width / 2 - 10).attr(`y`, q),
                l.attr(`transform`, `translate(` + (i - u.width / 2 - 5) + `, ` + q + `)`))
              : c.attr(`transform`, `translate(-19, ` + (i - u.height / 2) + `)`));
      });
    }, `drawBranches`)),
...
`,
          ...
          (s.forEach((e, t) => {
            ...
            Re(c, G),
            Z(c, G, !0),
            ae.insertTitle(c, `gitTitleText`, I.titleTopMargin ?? 0, o.getDiagramTitle()),
