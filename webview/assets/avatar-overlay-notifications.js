...
import { n as t } from "./react.js";
import { t as n } from "./persisted-atom.js";
import { a as r, i } from "./avatar-overlay-pill-dismiss-button.js";
function a(e, t) {
  return e
    .map((e) =>
      [
        ...
        e.action?.path ?? ``,
        e.waitingRequest == null ? `` : r(e.waitingRequest, t),
      ].join(``),
    )
    .join(`\0`);
}
var o = e(),
  s = 192 / 208,
  c = `--codex-avatar-width`,
  l = 80,
  u = 224,
  d = n(`avatar-overlay-mascot-width-px`, null);
function f() {
  let e = (0, o.c)(7),
    [n, r] = t(d),
    i;
  e[0] === n ? (i = e[1]) : ((i = n == null ? null : m(n)), (e[0] = n), (e[1] = i));
  let a;
  e[2] === r
    ? (a = e[3])
    : ((a = (e) => {
  ...
  return (
    e[4] !== i || e[5] !== a
      ? ((s = { mascotWidthPx: i, setMascotWidthPx: a }), (e[4] = i), (e[5] = a), (e[6] = s))
      : (s = e[6]),
    s
  );
}
function p(e) {
  if (e != null) return { [c]: `${m(e)}px` };
}
function m(e) {
  return Number.isFinite(e) ? Math.round(Math.min(u, Math.max(l, e))) : 112;
}
var h = 180 * 1e3,
  g = 3600 * 1e3,
  _ = 1440 * 60 * 1e3,
...
function b({
  ...
  return {
    ...
    notifications: i.sort(E).map((e) => e.notification),
  };
}
function x({ intl: e, petName: t, startedAtMs: n }) {
  return {
    action: null,
...
function S(e, t) {
  ...
  return n != null && t >= n
    ...
    : {
        ...
        notificationPriority: D(e.status),
        updatedAtMs: e.updatedAtMs,
      };
}
function C(e) {
...
export { p as a, m as i, b as n, f as o, s as r, a as s, x as t };
//# sourceMappingURL=avatar-overlay-notifications.js.map
