...
import { n as b, r as x } from "./chunk-63.js";
import { F as Ce, f as we, m as S, r as C, s as w } from "./chunk-62.js";
import { t as Te } from "./dist-8.js";
    ...
    for (let t of e) {
      if (n) {
        ...
        if (e < r) r -= e;
          ...
          if (i > 0 && i < 1)
            return { x: I((1 - i) * n.x + i * t.x, 5), y: I((1 - i) * n.y + i * t.y, 5) };
        }
      }
      n = t;
    }
...
var B = 0,
  V = b(() => (B++, `id-` + Math.random().toString(36).substr(2, 12) + `-` + B), `generateId`);
function H(e) {
  let t = ``;
    ...
    (e, t) => {
      ...
      for (let e of o) {
        ...
        for (let r of s) {
          let o = He();
          o.text = r || `​`;
          let s = Ue(u, o).style(`font-size`, a).style(`font-weight`, i).style(`font-family`, e),
