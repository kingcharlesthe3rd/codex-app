...
function p(e) {
  ...
  let R;
  n[28] !== r || n[29] !== L
    ? ((R = (0, f.jsx)(r, { className: L })), (n[28] = r), (n[29] = L), (n[30] = R))
    : (R = n[30]);
  let z;
  n[31] !== o || n[32] !== s
    ? ((z = o ? null : (0, f.jsx)(`span`, { className: `truncate`, children: s })),
      (n[31] = o),
      (n[32] = s),
      (n[33] = z))
    : (z = n[33]);
...
function m(e) {
  let n = (0, u.c)(13),
    ...
    l;
  n[0] === i ? (l = n[1]) : ((l = t(`flex flex-col gap-1`, i)), (n[0] = i), (n[1] = l));
  let d;
  n[2] !== a || n[3] !== o || n[4] !== c || n[5] !== s
    ? ((d = a
        ? (0, f.jsxs)(`div`, {
            className: t(`flex items-center justify-between gap-2`, s ?? `pr-0.5 pl-2`),
            children: [
              (0, f.jsx)(`div`, {
                className: t(
                  `min-w-0 flex-1`,
                  c ?? `text-base text-token-input-placeholder-foreground opacity-75`,
                ),
                children: a,
              }),
              o == null ? null : (0, f.jsx)(`div`, { className: `shrink-0`, children: o }),
            ],
          })
        : null),
      (n[2] = a),
  ...
  n[7] === r
    ? (p = n[8])
    : ((p = (0, f.jsx)(`div`, { className: `flex flex-col gap-px`, children: r })),
      (n[7] = r),
      (n[8] = p));
  let m;
  return (
