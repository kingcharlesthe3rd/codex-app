...
import { R as t, h as n, o as r, t as i } from "./app-scope.js";
import { p as a } from "./vscode-api.js";
import { t as o } from "./clsx.js";
import { t as s } from "./proxy.js";
import { C as c, u as l } from "./app-shell-state.js";
import { t as u } from "./AnimatePresence.js";
import { t as d } from "./use-register-command.js";
import { t as f } from "./badge.js";
...
function h() {
  ...
  d(`toggleSidebar`, o);
  let s;
  (e[2] === t ? (s = e[3]) : ((s = [t]), (e[2] = t), (e[3] = s)), a(`toggle-sidebar`, o, s));
}
var g = e();
function _(e) {
  let t = (0, m.c)(50),
  ...
  let I = S && `text-token-list-active-selection-icon-foreground`,
    L;
  t[25] !== w || t[26] !== I ? ((L = o(w, I)), (t[25] = w), (t[26] = I), (t[27] = L)) : (L = t[27]);
  let R;
  t[28] !== n || t[29] !== L
    ? ((R = (0, g.jsx)(n, { className: L })), (t[28] = n), (t[29] = L), (t[30] = R))
    : (R = t[30]);
  let z;
  t[31] !== a || t[32] !== s
    ? ((z = a ? null : (0, g.jsx)(`span`, { className: `truncate`, children: s })),
      (t[31] = a),
      (t[32] = s),
      (t[33] = z))
    : (z = t[33]);
...
function v(e) {
  ...
  t[3] !== a || t[4] !== c || t[5] !== d || t[6] !== l
    ? ((_ = a
        ? (0, g.jsxs)(`div`, {
            className: o(`flex items-center justify-between gap-2`, l ?? `pr-0.5 pl-2`),
            children: [
              (0, g.jsx)(`div`, {
                className: o(
                  `min-w-0 flex-1`,
  ...
  t[8] !== n || t[9] !== i || t[10] !== a
    ? ((v =
        i == null
          ? (0, g.jsx)(`div`, { className: `flex flex-col gap-px`, children: n })
          : (0, g.jsx)(u, {
              initial: !1,
              children: i
                ? null
