...
import { r as p, t as m } from "./dropdown.js";
import "./search.js";
import {
  a as h,
  d as g,
...
import { t as C } from "./toggle.js";
import "./chevron.js";
import { t as w } from "./check-circle-filled.js";
import { t as T } from "./checkbox.js";
import "./minus.js";
import "./links-p.js";
import { t as E } from "./settings-shared.js";
import { n as D, r as O, t as k } from "./browser-profile-import-query.js";
import { n as A, t as j } from "./google-chrome.js";
import { r as M } from "./settings-row.js";
import { t as N } from "./settings-surface.js";
var P = r(),
  F = e(t()),
  I = n(),
  L = (e) =>
...
function ee(e) {
  let t = (0, P.c)(54),
    {
      ...
      selectedProfile: v,
      onCancel: C,
      onElevatedChromeConsentChange: w,
      onImport: T,
  ...
  if (m != null) {
    ...
    return (
      t[0] !== C || t[1] !== m
        ? ((e = (0, I.jsx)(W, { result: m, onDone: C })), (t[0] = C), (t[1] = m), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  let A = v?.hasCookies === !0 && i,
    j = v?.hasPasswords === !0 && a,
    M = v == null || (!A && !j) || (p && !n),
    F;
  t[3] === T
    ? (F = t[4])
            ...
            subtitle: (0, I.jsx)(S, {
              ...
              children: (0, I.jsx)(`div`, {
                children: (0, I.jsx)(s, {
                  ...
                  defaultMessage: `Choose data to bring over to the Codex browser`,
  ...
  t[16] === d?.length
    ...
    : ((G =
      ...
      (t[17] = G));
  let K;
  t[18] !== A || t[19] !== j || t[20] !== o || t[21] !== E || t[22] !== D || t[23] !== v
    ? ((K =
        v != null &&
        (0, I.jsxs)(N, {
          children: [
    ...
    : (K = t[24]);
  let q;
  t[25] !== n || t[26] !== o || t[27] !== w || t[28] !== p
    ? ((q = p && (0, I.jsx)(H, { checked: n, disabled: o, onChange: w })),
      (t[25] = n),
      (t[26] = o),
      (t[27] = w),
      (t[28] = p),
  ...
  let J;
  t[30] !== r || t[31] !== f
    ? ((J = (0, I.jsx)(ne, { importFailed: r, profileDiscoveryFailed: f })),
      (t[30] = r),
      (t[31] = f),
      (t[32] = J))
    : (J = t[32]);
  let Y;
  t[33] !== J || t[34] !== U || t[35] !== G || t[36] !== K || t[37] !== q
    ? ((Y = (0, I.jsxs)(h, { className: `gap-3`, children: [U, G, K, q, J] })),
      (t[33] = J),
      (t[34] = U),
      (t[35] = G),
      (t[36] = K),
  ...
  let $;
  t[47] !== X || t[48] !== Q
    ? (($ = (0, I.jsx)(h, { children: (0, I.jsxs)(b, { className: x, children: [X, Q] }) })),
      (t[47] = X),
      (t[48] = Q),
      (t[49] = $))
    : ($ = t[49]);
  ...
  return (
    t[50] !== F || t[51] !== Y || t[52] !== $
      ? ((ie = (0, I.jsxs)(y, { as: `form`, onSubmit: F, children: [ee, Y, $] })),
        (t[50] = F),
        (t[51] = Y),
        (t[52] = $),
        (t[53] = ie))
...
function te(e) {
  let t = (0, P.c)(27),
    ...
    f;
  t[0] === o ? (f = t[1]) : ((f = o ? q(o) : null), (t[0] = o), (t[1] = f));
  let h = f,
    g;
  t[2] === o ? (g = t[3]) : ((g = o ? J(o) : void 0), (t[2] = o), (t[3] = g));
  let _ = g,
    v = a?.length === 1,
    y = v || void 0,
    b = v && `pointer-events-none`,
    x;
  t[4] === b ? (x = t[5]) : ((x = c(`min-w-0 flex-1`, b)), (t[4] = b), (t[5] = x));
  let S = v ? `hidden` : void 0,
    C = v ? void 0 : n,
    w = v ? -1 : void 0,
    T;
  t[6] !== r || t[7] !== o
    ? ((T = (0, I.jsx)(B, { isLoading: r, selectedProfile: o })),
      (t[6] = r),
      (t[7] = o),
      (t[8] = T))
    : (T = t[8]);
                  ...
                  children: (0, I.jsx)(p.Section, {
                    ...
                    children: a?.map((e) => {
                      ...
                      return (0, I.jsx)(
                        ...
                        {
                          "aria-label": J(e),
                          RightIcon: t === h ? d : void 0,
                          onSelect: () => u(e),
                          children: (0, I.jsx)(G, { profile: e }),
                        },
                        t,
                      );
                    }),
...
function B(e) {
  ...
  let i;
  return (
    t[2] === r ? (i = t[3]) : ((i = (0, I.jsx)(G, { profile: r })), (t[2] = r), (t[3] = i)), i
  );
}
function V(e) {
  let t = (0, P.c)(16),
  ...
  t[7] !== r || t[8] !== c || t[9] !== o || t[10] !== f
    ? ((p = (0, I.jsx)(C, { "aria-labelledby": c, checked: r, disabled: f, onChange: o })),
      (t[7] = r),
      (t[8] = c),
      (t[9] = o),
      (t[10] = f),
  ...
  return (
    t[12] !== u || t[13] !== d || t[14] !== p
      ? ((m = (0, I.jsx)(M, { icon: u, label: d, control: p })),
        (t[12] = u),
        (t[13] = d),
        (t[14] = p),
        (t[15] = m))
...
function H(e) {
  ...
  let c;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((c = (0, I.jsx)(T, { checked: n, disabled: r, onCheckedChange: i })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = i),
      (t[5] = c))
...
function W(e) {
            ...
            subtitle: (0, I.jsx)(S, {
              ...
              children: (0, I.jsx)(`div`, {
                children: (0, I.jsx)(s, {
                  ...
                  defaultMessage: `Your data is now available in Codex’s browser`,
  ...
  t[3] === n.passwords
    ? (c = t[4])
    : ((c = n.passwords != null && (0, I.jsx)(K, { kind: `passwords` })),
      (t[3] = n.passwords),
      (t[4] = c));
  let u;
  t[5] === n.cookies
    ? (u = t[6])
    : ((u = n.cookies != null && (0, I.jsx)(K, { kind: `cookies` })),
      (t[5] = n.cookies),
      (t[6] = u));
  let d;
  t[7] !== c || t[8] !== u
    ? ((d = (0, I.jsx)(h, { children: (0, I.jsxs)(N, { children: [c, u] }) })),
      (t[7] = c),
      (t[8] = u),
      (t[9] = d))
    : (d = t[9]);
  ...
  t[11] === r
    ...
    : ((p = (0, I.jsx)(h, {
        children: (0, I.jsx)(b, {
          ...
          children: (0, I.jsx)(l, { color: `primary`, onClick: r, type: `button`, children: f }),
        }),
      })),
      (t[11] = r),
      (t[12] = p));
  ...
  return (
    t[13] !== d || t[14] !== p
      ? ((m = (0, I.jsxs)(y, { children: [o, d, p] })), (t[13] = d), (t[14] = p), (t[15] = m))
      : (m = t[15]),
    m
  );
}
function G(e) {
  ...
  bb0: switch (n.source) {
    case `atlas`: {
      let e;
      (t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, I.jsx)(`img`, { alt: ``, className: `size-4 shrink-0 rounded-[22%]`, src: A })),
          (t[0] = e))
        : (e = t[0]),
        (r = e));
      break bb0;
    ...
    case `chrome`: {
      let e;
      (t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, I.jsx)(j, { className: `size-4 shrink-0` })), (t[1] = e))
        : (e = t[1]),
        (r = e));
    }
  }
...
function K(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, I.jsx)(w, { className: `size-5 text-token-text-primary` })), (t[4] = a))
    : (a = t[4]);
  let o;
  return (
    t[5] !== r || t[6] !== i
      ? ((o = (0, I.jsx)(M, { control: a, icon: r, label: i })), (t[5] = r), (t[6] = i), (t[7] = o))
      : (o = t[7]),
    o
  );
}
...
function re(e) {
  let t = (0, P.c)(50),
    ...
    g;
  t[0] === r ? (g = t[1]) : ((g = k(r, !0)), (t[0] = r), (t[1] = g));
  let _ = a(g),
    y;
  t[2] === r ? (y = t[3]) : ((y = { mutationFn: (e) => O(r, e) }), (t[2] = r), (t[3] = y));
  let b = i(y),
    x = _.data,
    S;
  t[4] !== x || t[5] !== s
    ? ((S = x?.find((e) => Z(e) === s) ?? D(x ?? [])[0] ?? x?.[0] ?? null),
      (t[4] = x),
      (t[5] = s),
      (t[6] = S))
    : (S = t[6]);
  let C = S,
    ...
    E =
      ...
      C?.source === `chrome`,
    A;
  t[7] === C ? (A = t[8]) : ((A = C ? Z(C) : null), (t[7] = C), (t[8] = A));
  let j = A,
    M = j != null && m === j,
    N;
  t[9] === b.data ? (N = t[10]) : ((N = b.data != null && Q(b.data)), (t[9] = b.data), (t[10] = N));
  let L = N,
    R = b.data != null && !L ? b.data : null,
    z,
    te;
  (t[11] !== o || t[12] !== n
    ? ((z = () => {
  ...
  t[20] === j
    ...
    : ((W = (e) => {
      ...
      (t[21] = W));
  let G;
  t[22] !== w || t[23] !== b || t[24] !== T || t[25] !== E || t[26] !== C
    ? ((G = () => {
        C != null && b.mutate(X(C, w, T, E));
      }),
      (t[22] = w),
      (t[23] = b),
      (t[24] = T),
  ...
  t[44] !== K
    ? ((q = (0, I.jsx)(ee, {
        ...
        isLoadingProfiles: _.isLoading,
        profiles: x,
        profilesHaveError: _.isError,
