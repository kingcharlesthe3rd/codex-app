...
function pe(e) {
  let t = (0, Z.c)(60),
    {
      ...
      selectedProfile: h,
      onCancel: g,
      onElevatedChromeConsentChange: _,
      onImport: v,
      onImportCookiesChange: y,
      onImportPasswordsChange: b,
      onProfilePickerOpenChange: x,
      onSelectProfile: S,
    } = e;
  if (m != null) {
    let e;
    return (
      t[0] !== n || t[1] !== g || t[2] !== m || t[3] !== l
        ? ((e = (0, Q.jsx)(be, {
            cookieAccessFailureMessage: n,
            showCloseBrowserGuidance: l,
            result: m,
  ...
  let w = h?.hasCookies === !0 && a,
    T = h?.hasPasswords === !0 && o,
    E = h == null || (!w && !T) || (p && !r),
    D;
  t[5] === v
    ? (D = t[6])
  ...
  t[20] !== h || t[21] !== l
    ...
    : (F = t[22]);
  let I;
  t[23] !== w || t[24] !== T || t[25] !== s || t[26] !== y || t[27] !== b || t[28] !== h
    ? ((I =
        h != null &&
        (0, Q.jsxs)(ie, {
          children: [
            (0, Q.jsx)(ge, {
              available: h.hasPasswords,
              checked: T,
              disabled: s,
              kind: `passwords`,
              onChange: b,
    ...
    : (I = t[29]);
  let L;
  t[30] !== r || t[31] !== s || t[32] !== _ || t[33] !== p
    ? ((L = p && (0, Q.jsx)(_e, { checked: r, disabled: s, onChange: _ })),
      (t[30] = r),
      (t[31] = s),
      (t[32] = _),
      (t[33] = p),
  ...
  let R;
  t[35] !== i || t[36] !== f
    ? ((R = (0, Q.jsx)(ve, { importFailed: i, profileDiscoveryFailed: f })),
      (t[35] = i),
      (t[36] = f),
      (t[37] = R))
    : (R = t[37]);
  let z;
  t[38] !== L || t[39] !== R || t[40] !== N || t[41] !== P || t[42] !== F || t[43] !== I
    ? ((z = (0, Q.jsxs)(G, { className: `gap-3`, children: [N, P, F, I, L, R] })),
      (t[38] = L),
      (t[39] = R),
      (t[40] = N),
      (t[41] = P),
  ...
  let K;
  t[53] !== V || t[54] !== U
    ? ((K = (0, Q.jsx)(G, { children: (0, Q.jsxs)(q, { className: te, children: [V, U] }) })),
      (t[53] = V),
      (t[54] = U),
      (t[55] = K))
    : (K = t[55]);
  let J;
  return (
    t[56] !== D || t[57] !== z || t[58] !== K
      ? ((J = (0, Q.jsxs)(re, { as: `form`, onSubmit: D, children: [j, z, K] })),
        (t[56] = D),
        (t[57] = z),
        (t[58] = K),
        (t[59] = J))
...
function me(e) {
  let t = (0, Z.c)(27),
    ...
    l;
  t[0] === o ? (l = t[1]) : ((l = o ? De(o) : null), (t[0] = o), (t[1] = l));
  let u = l,
    d;
  t[2] === o ? (d = t[3]) : ((d = o ? Oe(o) : void 0), (t[2] = o), (t[3] = d));
  let f = d,
    p = a?.length === 1,
    m = p || void 0,
    h = p && `pointer-events-none`,
    g;
  t[4] === h ? (g = t[5]) : ((g = j(`min-w-0 flex-1`, h)), (t[4] = h), (t[5] = g));
  let _ = p ? `hidden` : void 0,
    v = p ? void 0 : n,
    y = p ? -1 : void 0,
    b;
  t[6] !== r || t[7] !== o
    ? ((b = (0, Q.jsx)(he, { isLoading: r, selectedProfile: o })),
      (t[6] = r),
      (t[7] = o),
      (t[8] = b))
    : (b = t[8]);
...
function ge(e) {
  ...
  let u;
  t[4] !== c || t[5] !== s
    ? ((u = (0, Q.jsx)(`span`, { id: s, children: c })), (t[4] = c), (t[5] = s), (t[6] = u))
    : (u = t[6]);
  let d = !n || i,
    f;
  t[7] !== r || t[8] !== s || t[9] !== o || t[10] !== d
    ? ((f = (0, Q.jsx)(I, { "aria-labelledby": s, checked: r, disabled: d, onChange: o })),
      (t[7] = r),
      (t[8] = s),
      (t[9] = o),
      (t[10] = d),
  ...
  return (
    t[12] !== l || t[13] !== u || t[14] !== f
      ? ((p = (0, Q.jsx)(_, { icon: l, label: u, control: f })),
        (t[12] = l),
        (t[13] = u),
        (t[14] = f),
        (t[15] = p))
...
function _e(e) {
  ...
  let s;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((s = (0, Q.jsx)(B, { checked: n, disabled: r, onCheckedChange: i })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = i),
      (t[5] = s))
...
function be(e) {
  let t = (0, Z.c)(40),
    ...
    s;
  t[0] === i.cookies ? (s = t[1]) : ((s = ke(i.cookies)), (t[0] = i.cookies), (t[1] = s));
  let c = s,
    l = c && ((i.cookies?.imported ?? 0) > 0 || i.cookies?.status === `partial-success`),
  ...
  let m = p,
    ...
    g;
  t[7] !== m || t[8] !== f
    ? ((g = m && f.some(xe)), (t[7] = m), (t[8] = f), (t[9] = g))
    : (g = t[9]);
  let _ = g,
    v = c || m,
    y;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, Q.jsx)(ee, {
        ...
        children: (0, Q.jsx)(`h2`, {
          className: `sr-only`,
          children: (0, Q.jsx)(k, { ...Ae.complete }),
        }),
      })),
      (t[10] = y))
    : (y = t[10]);
  let b = v ? `sr-only` : void 0,
    x;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, Q.jsx)(k, { ...Ae.complete })), (t[11] = x))
    : (x = t[11]);
  let S;
  t[12] === v
    ? (S = t[13])
  ...
  t[14] !== b || t[15] !== S
    ? ((w = (0, Q.jsxs)(G, {
        children: [y, (0, Q.jsx)(ne, { subtitleClassName: b, title: x, subtitle: S })],
      })),
      (t[14] = b),
      (t[15] = S),
      (t[16] = w))
    : (w = t[16]);
  let T;
  t[17] !== h || t[18] !== m || t[19] !== _ || t[20] !== i.passwords
    ? ((T =
        i.passwords != null &&
        (0, Q.jsx)(Ee, {
          failureMessage: m ? (0, Q.jsx)(we, { accessFailed: h, partiallyFailed: _ }) : void 0,
          kind: `passwords`,
        })),
      (t[17] = h),
      (t[18] = m),
  ...
  let D;
  t[30] !== T || t[31] !== E
    ? ((D = (0, Q.jsx)(G, { children: (0, Q.jsxs)(ie, { children: [T, E] }) })),
      (t[30] = T),
      (t[31] = E),
      (t[32] = D))
    : (D = t[32]);
  ...
  t[34] === a
    ...
    : ((A = (0, Q.jsx)(G, {
        children: (0, Q.jsx)(q, {
          ...
          children: (0, Q.jsx)(C, { color: `primary`, onClick: a, type: `button`, children: O }),
        }),
      })),
      (t[34] = a),
      (t[35] = A));
  let j;
  return (
    t[36] !== w || t[37] !== D || t[38] !== A
      ? ((j = (0, Q.jsxs)(re, { children: [w, D, A] })),
        (t[36] = w),
        (t[37] = D),
        (t[38] = A),
        (t[39] = j))
...
function Te(e) {
  ...
  bb0: switch (n.source) {
    case `atlas`: {
      let e;
      (t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(`img`, { alt: ``, className: `size-4 shrink-0 rounded-[22%]`, src: p })),
          (t[0] = e))
        : (e = t[0]),
        (r = e));
      break bb0;
    ...
    case `chrome`: {
      let e;
      (t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(c, { className: `size-4 shrink-0` })), (t[1] = e))
        : (e = t[1]),
        (r = e));
    }
  }
...
function Ee(e) {
  ...
  t[4] === n
    ...
    : ((o =
        n == null
          ? (0, Q.jsx)(N, { className: `size-5 text-token-text-primary` })
  ...
  return (
    t[7] !== i || t[8] !== a || t[9] !== o || t[10] !== s
      ? ((c = (0, Q.jsx)(_, { control: o, description: s, icon: i, label: a })),
        (t[7] = i),
        (t[8] = a),
        (t[9] = o),
        (t[10] = s),
...
function Me(e) {
  let t = (0, Fe.c)(51),
    ...
    [g, _] = (0, $.useState)(null),
    v;
  t[0] === r ? (v = t[1]) : ((v = h(r, !0)), (t[0] = r), (t[1] = v));
  let y = o(v),
    b;
  t[2] === r ? (b = t[3]) : ((b = { mutationFn: (e) => m(r, e) }), (t[2] = r), (t[3] = b));
  let x = s(b),
    C = y.data,
    w;
  t[4] !== C || t[5] !== a
    ? ((w = C?.find((e) => Pe(e) === a) ?? d(C ?? [])[0] ?? C?.[0] ?? null),
      (t[4] = C),
      (t[5] = a),
      (t[6] = w))
    : (w = t[6]);
  let T = w,
    E = T?.hasCookies === !0 && l,
    D = T?.hasPasswords === !0 && f,
    O = typeof document < `u` && document.documentElement.dataset.codexOs === `win32`,
    k = typeof document < `u` && document.documentElement.dataset.codexOs === `darwin`,
    A = O && T?.source === `chrome`,
    j;
  t[7] === T ? (j = t[8]) : ((j = T ? Pe(T) : null), (t[7] = T), (t[8] = j));
  let M = j,
    N = M != null && g === M,
    P = x.data ?? null,
    F,
  ...
  t[16] === R
    ...
    : ((z = (e) => {
      ...
      (t[16] = R),
      (t[17] = z));
  let B = !x.isPending && P == null,
    V;
  t[18] === P ? (V = t[19]) : ((V = void 0), (t[18] = P), (t[19] = V));
  let H;
  t[20] === M
    ? (H = t[21])
    : ((H = (e) => {
      ...
      (t[21] = H));
  let W;
  t[22] !== E || t[23] !== x || t[24] !== D || t[25] !== A || t[26] !== T
    ? ((W = () => {
        T != null && x.mutate(Ne(T, E, D, A));
      }),
      (t[22] = E),
      (t[23] = x),
      (t[24] = D),
  ...
  t[45] !== G
    ? ((K = (0, Ie.jsx)(pe, {
        cookieAccessFailureMessage: V,
        elevatedChromeConsent: N,
        hasImportError: x.isError,
        importCookies: l,
        importPasswords: f,
        isImporting: x.isPending,
        isLoadingProfiles: y.isLoading,
        showCloseBrowserGuidance: k,
        profiles: C,
        profilesHaveError: y.isError,
        requiresElevatedChromeConsent: A,
        result: P,
        selectedProfile: T,
        onCancel: R,
