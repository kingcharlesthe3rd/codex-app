...
function fe(e) {
  let t = (0, Q.c)(60),
    {
      ...
      isImporting: u,
      isLoadingProfiles: f,
      showCloseBrowserGuidance: m,
      profilePickerOpen: h,
      profiles: g,
      profilesHaveError: _,
      requiresElevatedChromeConsent: y,
      result: b,
      selectedProfile: x,
      onCancel: C,
  ...
  let A = x?.hasCookies === !0 && c,
    j = x?.hasPasswords === !0 && l,
    M = x == null || (!A && !j) || (y && !a),
    N;
  t[5] === T
    ? (N = t[6])
  ...
  t[20] !== x || t[21] !== m
    ...
    : (H = t[22]);
  let U;
  t[23] !== A || t[24] !== j || t[25] !== u || t[26] !== E || t[27] !== D || t[28] !== x
    ? ((U =
        x != null &&
        (0, $.jsxs)(ae, {
          children: [
            (0, $.jsx)(he, {
              available: x.hasPasswords,
              checked: j,
              disabled: u,
              kind: `passwords`,
              onChange: D,
    ...
    : (U = t[29]);
  let W;
  t[30] !== a || t[31] !== u || t[32] !== w || t[33] !== y
    ? ((W = y && (0, $.jsx)(ge, { checked: a, disabled: u, onChange: w })),
      (t[30] = a),
      (t[31] = u),
      (t[32] = w),
      (t[33] = y),
  ...
  let G;
  t[35] !== s || t[36] !== _
    ? ((G = (0, $.jsx)(_e, { importFailed: s, profileDiscoveryFailed: _ })),
      (t[35] = s),
      (t[36] = _),
      (t[37] = G))
    : (G = t[37]);
  ...
  t[38] !== W || t[39] !== G || t[40] !== B || t[41] !== V || t[42] !== H || t[43] !== U
    ? ((K = (0, $.jsxs)(I, { className: `gap-3`, children: [B, V, H, U, W, G] })),
      (t[38] = W),
      (t[39] = G),
      (t[40] = B),
      (t[41] = V),
  ...
  let Y;
  t[53] !== q || t[54] !== J
    ? ((Y = (0, $.jsx)(I, { children: (0, $.jsxs)(d, { className: v, children: [q, J] }) })),
      (t[53] = q),
      (t[54] = J),
      (t[55] = Y))
    : (Y = t[55]);
  ...
  return (
    t[56] !== N || t[57] !== K || t[58] !== Y
      ? ((ne = (0, $.jsxs)(L, { as: `form`, onSubmit: N, children: [R, K, Y] })),
        (t[56] = N),
        (t[57] = K),
        (t[58] = Y),
        (t[59] = ne))
...
function pe(e) {
  ...
  let d = u,
    f;
  t[2] === s ? (f = t[3]) : ((f = s ? De(s) : void 0), (t[2] = s), (t[3] = f));
  let p = f,
    m = o?.length === 1,
    g = m || void 0,
    _ = m && `pointer-events-none`,
    v;
  t[4] === _ ? (v = t[5]) : ((v = T(`min-w-0 flex-1`, _)), (t[4] = _), (t[5] = v));
  let y = m ? `hidden` : void 0,
    x = m ? void 0 : n,
    S = m ? -1 : void 0,
    C;
  t[6] !== r || t[7] !== s
    ? ((C = (0, $.jsx)(me, { isLoading: r, selectedProfile: s })),
      (t[6] = r),
      (t[7] = s),
      (t[8] = C))
    : (C = t[8]);
...
function me(e) {
  ...
  let a;
  return (
    t[2] === r ? (a = t[3]) : ((a = (0, $.jsx)(we, { profile: r })), (t[2] = r), (t[3] = a)), a
  );
}
function he(e) {
  let t = (0, Q.c)(16),
    { available: n, checked: r, disabled: a, kind: o, onChange: s } = e,
    c = `browser-profile-import-${o}-label`,
    l,
    u;
  if (o === `cookies`) {
    let e;
    (t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, $.jsx)(i, { ...Z.cookies })), (t[0] = e))
      : (e = t[0]),
      (l = e));
    let n;
    (t[1] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let d;
  t[4] !== l || t[5] !== c
    ? ((d = (0, $.jsx)(`span`, { id: c, children: l })), (t[4] = l), (t[5] = c), (t[6] = d))
    : (d = t[6]);
  let f = !n || a,
    p;
  t[7] !== r || t[8] !== c || t[9] !== s || t[10] !== f
    ? ((p = (0, $.jsx)(_, { "aria-labelledby": c, checked: r, disabled: f, onChange: s })),
      (t[7] = r),
      (t[8] = c),
      (t[9] = s),
      (t[10] = f),
  ...
  return (
    t[12] !== u || t[13] !== d || t[14] !== p
      ? ((m = (0, $.jsx)(H, { icon: u, label: d, control: p })),
        (t[12] = u),
        (t[13] = d),
        (t[14] = p),
        (t[15] = m))
...
function ge(e) {
  let t = (0, Q.c)(9),
    { checked: n, disabled: r, onChange: a } = e,
    o;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(`p`, {
  ...
  let c;
  t[2] !== n || t[3] !== r || t[4] !== a
    ? ((c = (0, $.jsx)(K, { checked: n, disabled: r, onCheckedChange: a })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = a),
      (t[5] = c))
...
function ye(e) {
  let t = (0, Q.c)(40),
    { cookieAccessFailureMessage: r, showCloseBrowserGuidance: a, result: s, onDone: c } = e,
    l = s.cookies?.status === `failed_to_copy`,
    u;
  t[0] === s.cookies ? (u = t[1]) : ((u = Oe(s.cookies)), (t[0] = s.cookies), (t[1] = u));
  let f = u,
    m = f && ((s.cookies?.imported ?? 0) > 0 || s.cookies?.status === `partial-success`),
    h = s.passwords?.profile,
    g = s.passwords?.account,
    _,
    y;
  t[2] !== s.passwords || t[3] !== h || t[4] !== g
    ? ((_ = [s.passwords, h, g]),
      (y = _.some(Oe)),
      (t[2] = s.passwords),
      (t[3] = h),
  ...
  let b = y,
    ...
    C;
  t[7] !== b || t[8] !== _
    ? ((C = b && _.some(be)), (t[7] = b), (t[8] = _), (t[9] = C))
    : (C = t[9]);
  let w = C,
    T = f || b,
    E;
  ...
  t[14] !== D || t[15] !== k
    ? ((A = (0, $.jsxs)(I, {
        children: [E, (0, $.jsx)(n, { subtitleClassName: D, title: O, subtitle: k })],
      })),
      (t[14] = D),
      (t[15] = k),
      (t[16] = A))
    : (A = t[16]);
  let j;
  t[17] !== x || t[18] !== b || t[19] !== w || t[20] !== s.passwords
    ? ((j =
        s.passwords != null &&
        (0, $.jsx)(Te, {
          failureMessage: b ? (0, $.jsx)(Ce, { accessFailed: x, partiallyFailed: w }) : void 0,
          kind: `passwords`,
        })),
      (t[17] = x),
      (t[18] = b),
  ...
  let N;
  t[30] !== j || t[31] !== M
    ? ((N = (0, $.jsx)(I, { children: (0, $.jsxs)(ae, { children: [j, M] }) })),
      (t[30] = j),
      (t[31] = M),
      (t[32] = N))
    : (N = t[32]);
  ...
  t[34] === c
    ...
    : ((F = (0, $.jsx)(I, {
        children: (0, $.jsx)(d, {
          ...
          children: (0, $.jsx)(S, { color: `primary`, onClick: c, type: `button`, children: P }),
        }),
      })),
      (t[34] = c),
      (t[35] = F));
  let R;
  return (
    t[36] !== A || t[37] !== N || t[38] !== F
      ? ((R = (0, $.jsxs)(L, { children: [A, N, F] })),
        (t[36] = A),
        (t[37] = N),
        (t[38] = F),
        (t[39] = R))
...
function Se(e) {
  let t = (0, Q.c)(7),
    { accessFailed: n, showCloseBrowserGuidance: r, message: a, partiallyFailed: o, source: s } = e;
  if (n) {
    if (a != null) {
      let e;
      return (
        t[0] === a
          ? (e = t[1])
          : ((e = (0, $.jsx)($.Fragment, { children: a })), (t[0] = a), (t[1] = e)),
        e
      );
    }
    if (!r) {
...
function we(e) {
  ...
  bb0: switch (n.source) {
    case `atlas`: {
      let e;
      (t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(`img`, { alt: ``, className: `size-4 shrink-0 rounded-[22%]`, src: V })),
          (t[0] = e))
        : (e = t[0]),
        (r = e));
      break bb0;
    ...
    case `chrome`: {
      let e;
      (t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(z, { className: `size-4 shrink-0` })), (t[1] = e))
        : (e = t[1]),
        (r = e));
    }
  }
...
function Te(e) {
  ...
  t[4] === n
    ...
    : ((s =
        n == null
          ? (0, $.jsx)(k, { className: `size-5 text-token-text-primary` })
          : (0, $.jsx)(G, { className: `size-5 text-token-error-foreground` })),
      (c =
        n == null
          ? void 0
          : (0, $.jsx)(`span`, {
  ...
  return (
    t[7] !== a || t[8] !== o || t[9] !== s || t[10] !== c
      ? ((l = (0, $.jsx)(H, { control: s, description: c, icon: a, label: o })),
        (t[7] = a),
        (t[8] = o),
        (t[9] = s),
        (t[10] = c),
...
function je(e) {
  let t = (0, Pe.c)(51),
    ...
    [s, c] = (0, Fe.useState)(!0),
    [l, d] = (0, Fe.useState)(!0),
    [p, h] = (0, Fe.useState)(null),
    g;
  t[0] === r ? (g = t[1]) : ((g = ne(r, !0)), (t[0] = r), (t[1] = g));
  let _ = m(g),
    v;
  t[2] === r ? (v = t[3]) : ((v = { mutationFn: (e) => J(r, e) }), (t[2] = r), (t[3] = v));
  let y = A(v),
    b = _.data,
    x;
  t[4] !== b || t[5] !== a
    ? ((x = b?.find((e) => Ne(e) === a) ?? re(b ?? [])[0] ?? b?.[0] ?? null),
      (t[4] = b),
      (t[5] = a),
      (t[6] = x))
    : (x = t[6]);
  let S = x,
    ...
    D = T && S?.source === `chrome`,
    O;
  t[7] === S ? (O = t[8]) : ((O = S ? Ne(S) : null), (t[7] = S), (t[8] = O));
  let k = O,
    j = k != null && p === k,
    M = y.data ?? null,
    N,
