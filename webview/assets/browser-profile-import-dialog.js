...
import { _ as i, v as a } from "./vscode-api.js";
import "./isEqual.js";
import "./src-3.js";
import "./react-dom.js";
import { i as o, s } from "./lib-1.js";
...
import { a as m, d as h, i as g, l as _, n as v, r as y, t as b, u as x } from "./dialog-layout.js";
import { t as S } from "./checkbox.js";
import "./minus.js";
import "./links.js";
import { r as C, t as w } from "./dropdown.js";
import { t as T } from "./x-circle-filled-Do-SvWo6.js";
import { t as E } from "./toggle.js";
import { t as D } from "./settings-shared.js";
import { n as O, r as k, t as A } from "./browser-profile-import-query.js";
import { n as j, t as M } from "./google-chrome.js";
import { r as N } from "./settings-row.js";
import { t as ee } from "./settings-surface.js";
var P = r(),
  F = e(t()),
  I = n(),
  L = (e) =>
    (0, I.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, I.jsx)(`circle`, { cx: 12, cy: 7, r: 1, fill: `currentColor` }),
        (0, I.jsx)(`circle`, { cx: 7.5, cy: 11, r: 1, fill: `currentColor` }),
        (0, I.jsx)(`circle`, { cx: 11.5, cy: 15, r: 1, fill: `currentColor` }),
        (0, I.jsx)(`circle`, { cx: 16, cy: 12.5, r: 1, fill: `currentColor` }),
      ],
    }),
  R = (e) =>
    (0, I.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, I.jsx)(`circle`, { cx: 6.5, cy: 5.5, r: 0.75, fill: `currentColor` }),
        (0, I.jsx)(`path`, {
...
function te(e) {
  let t = (0, P.c)(55),
    {
      ...
      selectedProfile: C,
      onCancel: w,
      onElevatedChromeConsentChange: T,
      onImport: E,
      onImportCookiesChange: D,
      onImportPasswordsChange: O,
      onProfilePickerOpenChange: k,
      onSelectProfile: A,
    } = e;
  if (S != null) {
    let e;
    return (
      t[0] !== n || t[1] !== w || t[2] !== S
        ? ((e = (0, I.jsx)(G, { cookieAccessFailureMessage: n, result: S, onDone: w })),
          (t[0] = n),
          (t[1] = w),
          (t[2] = S),
          (t[3] = e))
  ...
  let j = C?.hasCookies === !0 && a,
    M = C?.hasPasswords === !0 && o,
    N = C == null || (!j && !M) || (_ && !r),
    F;
  t[4] === E
    ? (F = t[5])
  ...
  t[17] === f?.length
    ...
    : ((K =
      ...
      (t[18] = K));
  let q;
  t[19] !== j || t[20] !== M || t[21] !== c || t[22] !== D || t[23] !== O || t[24] !== C
    ? ((q =
        C != null &&
        (0, I.jsxs)(ee, {
          children: [
            (0, I.jsx)(ne, {
              available: C.hasPasswords,
              checked: M,
              disabled: c,
              kind: `passwords`,
              onChange: O,
    ...
    : (q = t[25]);
  let J;
  t[26] !== r || t[27] !== c || t[28] !== T || t[29] !== _
    ? ((J = _ && (0, I.jsx)(H, { checked: r, disabled: c, onChange: T })),
      (t[26] = r),
      (t[27] = c),
      (t[28] = T),
      (t[29] = _),
  ...
  let Y;
  t[31] !== i || t[32] !== p
    ? ((Y = (0, I.jsx)(U, { importFailed: i, profileDiscoveryFailed: p })),
      (t[31] = i),
      (t[32] = p),
      (t[33] = Y))
    : (Y = t[33]);
  let X;
  t[34] !== Y || t[35] !== W || t[36] !== K || t[37] !== q || t[38] !== J
    ? ((X = (0, I.jsxs)(m, { className: `gap-3`, children: [W, K, q, J, Y] })),
      (t[34] = Y),
      (t[35] = W),
      (t[36] = K),
      (t[37] = q),
  ...
  let $;
  t[48] !== Z || t[49] !== Q
    ? (($ = (0, I.jsx)(m, { children: (0, I.jsxs)(y, { className: b, children: [Z, Q] }) })),
      (t[48] = Z),
      (t[49] = Q),
      (t[50] = $))
    : ($ = t[50]);
  ...
  return (
    t[51] !== F || t[52] !== X || t[53] !== $
      ? ((ae = (0, I.jsxs)(v, { as: `form`, onSubmit: F, children: [te, X, $] })),
        (t[51] = F),
        (t[52] = X),
        (t[53] = $),
        (t[54] = ae))
...
function B(e) {
  let t = (0, P.c)(27),
    ...
    f;
  t[0] === o ? (f = t[1]) : ((f = o ? Z(o) : null), (t[0] = o), (t[1] = f));
  let p = f,
    m;
  t[2] === o ? (m = t[3]) : ((m = o ? ie(o) : void 0), (t[2] = o), (t[3] = m));
  let h = m,
    g = a?.length === 1,
    _ = g || void 0,
    v = g && `pointer-events-none`,
    y;
  t[4] === v ? (y = t[5]) : ((y = c(`min-w-0 flex-1`, v)), (t[4] = v), (t[5] = y));
  let b = g ? `hidden` : void 0,
    x = g ? void 0 : n,
    S = g ? -1 : void 0,
    T;
  t[6] !== r || t[7] !== o
    ? ((T = (0, I.jsx)(V, { isLoading: r, selectedProfile: o })),
      (t[6] = r),
      (t[7] = o),
      (t[8] = T))
    : (T = t[8]);
                  ...
                  children: (0, I.jsx)(C.Section, {
                    ...
                    children: a?.map((e) => {
                      ...
                      return (0, I.jsx)(
                        ...
                        {
                          "aria-label": ie(e),
                          RightIcon: t === p ? d : void 0,
                          onSelect: () => u(e),
                          children: (0, I.jsx)(X, { profile: e }),
                        },
                        t,
                      );
                    }),
...
function V(e) {
  ...
  let i;
  return (
    t[2] === r ? (i = t[3]) : ((i = (0, I.jsx)(X, { profile: r })), (t[2] = r), (t[3] = i)), i
  );
}
function ne(e) {
  let t = (0, P.c)(16),
  ...
  if (a === `cookies`) {
    let e;
    (t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, I.jsx)(s, { ...z.cookies })), (t[0] = e))
      : (e = t[0]),
      (l = e));
    let n;
    (t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, I.jsx)(L, { className: `size-5 text-token-text-secondary` })), (t[1] = n))
      : (n = t[1]),
      (u = n));
  } else {
    let e;
    (t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, I.jsx)(s, { ...z.passwords })), (t[2] = e))
      : (e = t[2]),
      (l = e));
    let n;
    (t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, I.jsx)(R, { className: `size-5 text-token-text-secondary` })), (t[3] = n))
      : (n = t[3]),
      (u = n));
  }
  let d;
  t[4] !== l || t[5] !== c
    ? ((d = (0, I.jsx)(`span`, { id: c, children: l })), (t[4] = l), (t[5] = c), (t[6] = d))
    : (d = t[6]);
  let f = !n || i,
    p;
  t[7] !== r || t[8] !== c || t[9] !== o || t[10] !== f
    ? ((p = (0, I.jsx)(E, { "aria-labelledby": c, checked: r, disabled: f, onChange: o })),
      (t[7] = r),
      (t[8] = c),
      (t[9] = o),
      (t[10] = f),
  ...
  return (
    t[12] !== u || t[13] !== d || t[14] !== p
      ? ((m = (0, I.jsx)(N, { icon: u, label: d, control: p })),
        (t[12] = u),
        (t[13] = d),
        (t[14] = p),
        (t[15] = m))
...
function H(e) {
  ...
  let c;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((c = (0, I.jsx)(S, { checked: n, disabled: r, onCheckedChange: i })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = i),
      (t[5] = c))
...
function G(e) {
  let t = (0, P.c)(38),
    { cookieAccessFailureMessage: n, result: r, onDone: i } = e,
    a = r.cookies?.status === `failed_to_copy`,
    o;
  t[0] === r.cookies ? (o = t[1]) : ((o = Q(r.cookies)), (t[0] = r.cookies), (t[1] = o));
  let c = o,
    u = c && ((r.cookies?.imported ?? 0) > 0 || r.cookies?.status === `partial-success`),
    d = r.passwords?.profile,
    f = r.passwords?.account,
    p,
    _;
  t[2] !== r.passwords || t[3] !== d || t[4] !== f
    ? ((p = [r.passwords, d, f]),
      (_ = p.some(Q)),
      (t[2] = r.passwords),
      (t[3] = d),
  ...
  let S = _,
    ...
    w;
  t[7] !== S || t[8] !== p
    ? ((w = S && p.some(K)), (t[7] = S), (t[8] = p), (t[9] = w))
    : (w = t[9]);
  let T = w,
    E = c || S,
    D;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, I.jsx)(h, {
        ...
        children: (0, I.jsx)(`h2`, {
          className: `sr-only`,
          children: (0, I.jsx)(s, { ...$.complete }),
        }),
      })),
      (t[10] = D))
    : (D = t[10]);
  let O = E ? `sr-only` : void 0,
    k;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, I.jsx)(s, { ...$.complete })), (t[11] = k))
    : (k = t[11]);
  let A;
  t[12] === E
    ? (A = t[13])
  ...
  t[14] !== O || t[15] !== A
    ? ((j = (0, I.jsxs)(m, {
        children: [D, (0, I.jsx)(g, { subtitleClassName: O, title: k, subtitle: A })],
      })),
      (t[14] = O),
      (t[15] = A),
      (t[16] = j))
    : (j = t[16]);
  let M;
  t[17] !== C || t[18] !== S || t[19] !== T || t[20] !== r.passwords
    ? ((M =
        r.passwords != null &&
        (0, I.jsx)(re, {
          failureMessage: S ? (0, I.jsx)(Y, { accessFailed: C, partiallyFailed: T }) : void 0,
          kind: `passwords`,
        })),
      (t[17] = C),
      (t[18] = S),
    ...
    : (M = t[21]);
  let N;
  t[22] !== a || t[23] !== n || t[24] !== c || t[25] !== u || t[26] !== r.cookies
    ? ((N =
        r.cookies != null &&
        (0, I.jsx)(re, {
          failureMessage: c
            ? (0, I.jsx)(J, { accessFailed: a, message: n, partiallyFailed: u })
            : void 0,
          kind: `cookies`,
        })),
      (t[22] = a),
  ...
  let F;
  t[28] !== M || t[29] !== N
    ? ((F = (0, I.jsx)(m, { children: (0, I.jsxs)(ee, { children: [M, N] }) })),
      (t[28] = M),
      (t[29] = N),
      (t[30] = F))
    : (F = t[30]);
  ...
  t[32] === i
    ...
    : ((R = (0, I.jsx)(m, {
        children: (0, I.jsx)(y, {
          ...
          children: (0, I.jsx)(l, { color: `primary`, onClick: i, type: `button`, children: L }),
        }),
      })),
      (t[32] = i),
      (t[33] = R));
  let z;
  return (
    t[34] !== j || t[35] !== F || t[36] !== R
      ? ((z = (0, I.jsxs)(v, { children: [j, F, R] })),
        (t[34] = j),
        (t[35] = F),
        (t[36] = R),
        (t[37] = z))
...
function J(e) {
  let t = (0, P.c)(6),
    { accessFailed: n, message: r, partiallyFailed: i } = e;
  if (n) {
    let e;
    t[0] === r
      ? (e = t[1])
    ...
    return (
      t[2] === e
        ? (n = t[3])
        : ((n = (0, I.jsx)(I.Fragment, { children: e })), (t[2] = e), (t[3] = n)),
      n
    );
  }
  if (i) {
...
function X(e) {
  ...
  bb0: switch (n.source) {
    case `atlas`: {
      let e;
      (t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, I.jsx)(`img`, { alt: ``, className: `size-4 shrink-0 rounded-[22%]`, src: j })),
          (t[0] = e))
        : (e = t[0]),
        (r = e));
      break bb0;
    ...
    case `chrome`: {
      let e;
      (t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, I.jsx)(M, { className: `size-4 shrink-0` })), (t[1] = e))
        : (e = t[1]),
        (r = e));
    }
  }
...
function re(e) {
  ...
  if (r === `cookies`) {
    let e;
    (t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, I.jsx)(L, { className: `size-5 text-token-text-secondary` })), (t[0] = e))
      : (e = t[0]),
      (i = e));
    let n;
    (t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, I.jsx)(s, { ...z.cookies })), (t[1] = n))
      : (n = t[1]),
      (a = n));
  } else {
    let e;
    (t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, I.jsx)(R, { className: `size-5 text-token-text-secondary` })), (t[2] = e))
      : (e = t[2]),
      (i = e));
    let n;
    (t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, I.jsx)(s, { ...z.passwords })), (t[3] = n))
      : (n = t[3]),
      (a = n));
  }
  let o, c;
  t[4] === n
    ...
    : ((o =
        n == null
          ? (0, I.jsx)(p, { className: `size-5 text-token-text-primary` })
          : (0, I.jsx)(T, { className: `size-5 text-token-error-foreground` })),
      (c =
        n == null
          ? void 0
          : (0, I.jsx)(`span`, {
  ...
  return (
    t[7] !== i || t[8] !== a || t[9] !== o || t[10] !== c
      ? ((l = (0, I.jsx)(N, { control: o, description: c, icon: i, label: a })),
        (t[7] = i),
        (t[8] = a),
        (t[9] = o),
        (t[10] = c),
...
function ae(e) {
  let t = (0, P.c)(49),
    ...
    g;
  t[0] === r ? (g = t[1]) : ((g = A(r, !0)), (t[0] = r), (t[1] = g));
  let v = a(g),
    y;
  t[2] === r ? (y = t[3]) : ((y = { mutationFn: (e) => k(r, e) }), (t[2] = r), (t[3] = y));
  let b = i(y),
    x = v.data,
    S;
  t[4] !== x || t[5] !== s
    ? ((S = x?.find((e) => se(e) === s) ?? O(x ?? [])[0] ?? x?.[0] ?? null),
      (t[4] = x),
      (t[5] = s),
      (t[6] = S))
    : (S = t[6]);
  let C = S,
    w = C?.hasCookies === !0 && l,
    T = C?.hasPasswords === !0 && d,
    E =
      typeof document < `u` &&
      document.documentElement.dataset.codexOs === `win32` &&
      C?.source === `chrome`,
    D;
  t[7] === C ? (D = t[8]) : ((D = C ? se(C) : null), (t[7] = C), (t[8] = D));
  let j = D,
    M = j != null && m === j,
    N = b.data ?? null,
    ee,
  ...
  t[16] === z
    ...
    : ((B = (e) => {
      ...
      (t[16] = z),
      (t[17] = B));
  let V = !b.isPending && N == null,
    ne;
  t[18] === Symbol.for(`react.memo_cache_sentinel`) ? ((ne = void 0), (t[18] = ne)) : (ne = t[18]);
  let H;
  t[19] === j
    ? (H = t[20])
    : ((H = (e) => {
      ...
      (t[20] = H));
  let U;
  t[21] !== w || t[22] !== b || t[23] !== T || t[24] !== E || t[25] !== C
    ? ((U = () => {
        C != null && b.mutate(oe(C, w, T, E));
      }),
      (t[21] = w),
      (t[22] = b),
      (t[23] = T),
  ...
  t[43] !== W
    ? ((G = (0, I.jsx)(te, {
        cookieAccessFailureMessage: ne,
        elevatedChromeConsent: M,
        hasImportError: b.isError,
        importCookies: l,
        importPasswords: d,
        isImporting: b.isPending,
        isLoadingProfiles: v.isLoading,
        profiles: x,
        profilesHaveError: v.isError,
...
export { ae as BrowserProfileImportDialogModal };
