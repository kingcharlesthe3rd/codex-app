...
import { o as f } from "./chunk-13.js";
import "./platform.js";
...
import { t as h } from "./use-command-hotkey-Ya4-5lX2.js";
import { t as g } from "./pop-in-mac.js";
import { t as _ } from "./use-hotkey-window-detail-layout.js";
import { t as v } from "./use-hotkey-window-dismiss-on-escape-B.js";
var y = e(t(), 1),
  b = r(),
  x = n(),
  S = a({
...
function C(e) {
  ...
  t[3] !== E || t[4] !== n
    ...
    : (D = t[5]);
  let O;
  t[6] !== h || t[7] !== y || t[8] !== r || t[9] !== f
    ? ((O = f
        ? (0, x.jsx)(`div`, {
            className: `absolute flex items-center gap-0`,
            style: { left: y },
            children: (0, x.jsx)(l, {
              tooltipContent: (0, x.jsx)(s, { ...S.dismiss }),
              delayOpen: !0,
              children: (0, x.jsx)(c, {
                size: `toolbar`,
                color: `ghost`,
...
function w(e) {
  let t = (0, b.c)(18),
    { title: n, mainWindowPath: r, canCollapseToHome: a } = e,
    u = a === void 0 ? !0 : a,
    d = o(),
    f;
  t[0] !== u || t[1] !== d
    ? ((f = u
        ? (0, x.jsx)(l, {
            tooltipContent: (0, x.jsx)(s, { ...S.newThread }),
            delayOpen: !0,
            children: (0, x.jsx)(c, {
              size: `toolbar`,
              color: `ghost`,
              "aria-label": d.formatMessage(S.newThread),
              onClick: T,
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, x.jsx)(s, { ...S.openInMainWindow })), (t[3] = p))
    : (p = t[3]);
  let h;
  t[4] === d ? (h = t[5]) : ((h = d.formatMessage(S.openInMainWindow)), (t[4] = d), (t[5] = h));
  let _;
  t[6] === r
    ? (_ = t[7])
    : ((_ = () => {
        i.dispatchMessage(`open-in-main-window`, { path: r });
      }),
      (t[6] = r),
      (t[7] = _));
  let v;
...
function T() {
  d.hotkeyWindowHotkeys?.collapseToHome();
}
function E() {
  d.hotkeyWindowHotkeys?.dismiss();
}
function D() {
  let e = (0, b.c)(7);
  v();
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, x.jsx)(`div`, { className: `min-h-0 flex-1`, children: (0, x.jsx)(f, {}) })),
      (e[4] = o))
    : (o = e[4]);
  let s;
  return (
...
function O(e) {
  (e.preventDefault(), e.stopPropagation(), d.hotkeyWindowHotkeys?.collapseToHome());
}
