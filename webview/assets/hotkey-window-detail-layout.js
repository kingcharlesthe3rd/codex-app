...
import { o as d } from "./chunk-109.js";
...
import { t as v } from "./use-hotkey-window-dismiss-on-escape-D4h-fjJ0.js";
var y = e(t(), 1),
  b = r(),
  x = n(),
  S = s({
...
function w(e) {
  let t = (0, b.c)(18),
    { title: n, mainWindowPath: r, canCollapseToHome: s } = e,
    u = s === void 0 ? !0 : s,
    d = a(),
    f;
  t[0] !== u || t[1] !== d
...
function T() {
  u.hotkeyWindowHotkeys?.collapseToHome();
}
function E() {
  u.hotkeyWindowHotkeys?.dismiss();
}
function D() {
  let e = (0, b.c)(7);
  v();
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, x.jsx)(`div`, { className: `min-h-0 flex-1`, children: (0, x.jsx)(d, {}) })),
      (e[4] = o))
    : (o = e[4]);
  let s;
  return (
...
function O(e) {
  (e.preventDefault(), e.stopPropagation(), u.hotkeyWindowHotkeys?.collapseToHome());
}
