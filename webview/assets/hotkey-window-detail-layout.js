...
function N(e) {
  let t = (0, L.c)(20),
    {
      ...
      onDismiss: i,
      showDismissButton: s,
      reserveWindowControlsSafeArea: c,
      rightActions: l,
    } = e,
    u = s === void 0 ? !0 : s,
    d = c === void 0 ? !1 : c,
  ...
  t[3] !== C || t[4] !== n
    ...
    : (w = t[5]);
  let T;
  t[6] !== f || t[7] !== v || t[8] !== i || t[9] !== u
    ? ((T = u
        ? (0, R.jsx)(`div`, {
            className: `absolute flex items-center gap-0`,
            style: { left: v },
            children: (0, R.jsx)(_, {
              tooltipContent: (0, R.jsx)(a, { ...z.dismiss }),
              delayOpen: !0,
              children: (0, R.jsx)(p, {
                size: `toolbar`,
                color: `ghost`,
                ...
                onClick: i,
                children: (0, R.jsx)(r, { className: `icon-xs` }),
              }),
            }),
          })
        : null),
...
function P(e) {
  let t = (0, L.c)(18),
    { title: r, mainWindowPath: i, canCollapseToHome: s } = e,
    c = s === void 0 ? !0 : s,
    l = o(),
    u;
  t[0] !== c || t[1] !== l
    ? ((u = c
        ? (0, R.jsx)(_, {
            tooltipContent: (0, R.jsx)(a, { ...z.newThread }),
            delayOpen: !0,
            children: (0, R.jsx)(p, {
              size: `toolbar`,
              color: `ghost`,
              "aria-label": l.formatMessage(z.newThread),
              onClick: F,
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, R.jsx)(a, { ...z.openInMainWindow })), (t[3] = d))
    : (d = t[3]);
  let f;
  t[4] === l ? (f = t[5]) : ((f = l.formatMessage(z.openInMainWindow)), (t[4] = l), (t[5] = f));
  let m;
  t[6] === i
    ? (m = t[7])
    : ((m = () => {
  ...
  let v;
  t[12] !== u || t[13] !== g
    ? ((v = (0, R.jsxs)(R.Fragment, { children: [u, g] })), (t[12] = u), (t[13] = g), (t[14] = v))
    : (v = t[14]);
  let y;
  return (
    t[15] !== v || t[16] !== r
      ? ((y = (0, R.jsx)(N, { title: r, onDismiss: I, rightActions: v })),
        (t[15] = v),
        (t[16] = r),
        (t[17] = y))
      : (y = t[17]),
...
function V() {
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, G.jsx)(`div`, { className: `min-h-0 flex-1`, children: (0, G.jsx)(m, {}) })),
      (e[4] = o))
    : (o = e[4]);
  let s;
  return (
