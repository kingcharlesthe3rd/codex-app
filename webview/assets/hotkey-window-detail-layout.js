...
import { _d as s, vd as c } from "./app-initial~app-main~onboarding-page.js";
import {
  Ab as l,
  Qx as u,
  RC as d,
...
import { Mt as C, Nt as w } from "./app-initial~app-main~automations-page.js";
import {
  h as T,
  m as E,
...
function P(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (l = t[3]);
  let f;
  t[4] === s ? (f = t[5]) : ((f = s.formatMessage(z.openInMainWindow)), (t[4] = s), (t[5] = f));
  let p;
  t[6] === r
    ? (p = t[7])
    : ((p = () => {
...
function V() {
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, G.jsx)(`div`, { className: `min-h-0 flex-1`, children: (0, G.jsx)(g, {}) })),
      (e[4] = o))
    : (o = e[4]);
  let s;
  return (
