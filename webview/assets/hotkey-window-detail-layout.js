...
function N(e) {
  ...
  t[3] !== S || t[4] !== n
    ...
    : (C = t[5]);
  let w;
  t[6] !== f || t[7] !== g || t[8] !== r || t[9] !== c
    ? ((w = c
        ? (0, R.jsx)(`div`, {
            className: `absolute flex items-center gap-0`,
            style: { left: g },
            children: (0, R.jsx)(u, {
              tooltipContent: (0, R.jsx)(_, { ...z.dismiss }),
              delayOpen: !0,
              children: (0, R.jsx)(s, {
                size: `toolbar`,
                color: `ghost`,
...
function P(e) {
  ...
  t[0] !== o || t[1] !== c
    ? ((l = o
        ? (0, R.jsx)(u, {
            tooltipContent: (0, R.jsx)(_, { ...z.newThread }),
            delayOpen: !0,
            children: (0, R.jsx)(s, {
              size: `toolbar`,
              color: `ghost`,
              ...
              onClick: F,
              children: (0, R.jsx)(S, { className: `icon-sm` }),
            }),
          })
        : null),
      (t[0] = o),
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, R.jsx)(_, { ...z.openInMainWindow })), (t[3] = d))
    : (d = t[3]);
  let f;
  t[4] === c ? (f = t[5]) : ((f = c.formatMessage(z.openInMainWindow)), (t[4] = c), (t[5] = f));
  let p;
  t[6] === i
    ? (p = t[7])
    : ((p = () => {
  ...
  let g;
  t[12] !== l || t[13] !== h
    ? ((g = (0, R.jsxs)(R.Fragment, { children: [l, h] })), (t[12] = l), (t[13] = h), (t[14] = g))
    : (g = t[14]);
  let v;
  return (
    t[15] !== g || t[16] !== n
