...
function u(e) {
  let t = (0, l.c)(13),
    { Icon: n, className: r, containerClassName: u, animationDurationMs: f } = e,
    p = n === void 0 ? c : n,
    m = a(),
    [h] = (0, o.useState)(d),
    g = f == null ? void 0 : `${f}ms`,
    _ = !m && `animate-spin`,
    v;
  t[0] !== u || t[1] !== _
    ? ((v = i(
  ...
  let y;
  t[3] !== h || t[4] !== g
    ? ((y = { animationDelay: h, animationDuration: g }), (t[3] = h), (t[4] = g), (t[5] = y))
    : (y = t[5]);
  let b;
  t[6] !== p || t[7] !== r
    ? ((b = (0, s.jsx)(p, { className: r })), (t[6] = p), (t[7] = r), (t[8] = b))
    : (b = t[8]);
  let x;
  return (
    t[9] !== v || t[10] !== y || t[11] !== b
      ? ((x = (0, s.jsx)(`div`, { className: v, style: y, children: b })),
        (t[9] = v),
        (t[10] = y),
        (t[11] = b),
        (t[12] = x))
