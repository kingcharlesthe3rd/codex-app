...
function l(e) {
  let t = (0, c.c)(11),
    { className: n, containerClassName: r, animationDurationMs: l } = e,
    u = a(),
    d = `-${Date.now() % 1e3}ms`,
    f = l == null ? void 0 : `${l}ms`,
    p = !u && `animate-spin`,
    m;
  t[0] !== r || t[1] !== p
    ? ((m = i(
  ...
  t[3] === f
    ? (h = t[4])
    : ((h = { animationDelay: d, animationDuration: f }), (t[3] = f), (t[4] = h));
  let g;
  t[5] === n ? (g = t[6]) : ((g = (0, o.jsx)(s, { className: n })), (t[5] = n), (t[6] = g));
  let _;
  return (
    t[7] !== m || t[8] !== h || t[9] !== g
      ? ((_ = (0, o.jsx)(`div`, { className: m, style: h, children: g })),
        (t[7] = m),
        (t[8] = h),
        (t[9] = g),
        (t[10] = _))
