...
import { A as t, E as n, O as r, _ as i, a, d as o, f as s, v as c } from "./isEqual.js";
import { o as l } from "./markdown-to-search-text.js";
...
var f = e((e, t) => {
  ...
  x = e((e, r) => {
    ...
    function u(e, t, n) {
      if (!l(n)) return !1;
      var r = typeof t;
      return (r == `number` ? s(n) && c(t, n.length) : r == `string` && t in n) ? i(n[t], e) : !1;
    }
    r.exports = u;
  }),
  S = e((e, t) => {
