...
import { $t as t, Xt as n, Zt as r, cn as i, en as a, fn as o, qt as s, un as c } from "./src-C.js";
import { ao as l } from "./app-server-manager-signals.js";
...
var f = e((e, n) => {
  ...
  x = e((e, t) => {
    ...
    function u(e, t, n) {
      if (!l(n)) return !1;
      var i = typeof t;
      return (i == `number` ? a(n) && c(t, n.length) : i == `string` && t in n) ? r(n[t], e) : !1;
    }
    t.exports = u;
  }),
  S = e((e, t) => {
