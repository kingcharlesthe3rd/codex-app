...
import "./chunk-111.js";
import "./chunk-73.js";
import { t } from "./src-4.js";
import "./dist-9.js";
import { t as n } from "./cytoscape.esm-2.js";
import { t as r } from "./cytoscape-fcose.js";
...
import { t as v } from "./chunk-30.js";
import { r as y, s as b } from "./chunk-50.js";
import { a as x, i as S, n as C, r as w } from "./chunk-17.js";
import { t as T } from "./chunk-34.js";
import { t as E } from "./mermaid-parser.core-Cpt-mObg.js";
var ee = e(r(), 1),
    ...
    getDataStructures() {
      if (this.dataStructures === void 0) {
        let e = {},
          ...
          n = Object.keys(t)[0],
          r = { [n]: 1 },
          a = Object.keys(t).reduce((e, t) => (t === n ? e : { ...e, [t]: 1 }), {}),
          o = i((e) => {
            let n = { [e]: [0, 0] },
              i = [e];
            for (; i.length > 0; ) {
        ...
        this.dataStructures = { adjList: t, spatialMaps: s, groupAlignments: e };
      }
...
`,
    ...
    await Promise.all(
      t.edges().map(async (t) => {
        let {
          ...
          E = i + 4;
        if (
          (d && (j(l) ? (v += l === `L` ? -E : E) : (y += l === `T` ? -E : E + 18)),
          g && (j(p) ? (w += p === `L` ? -E : E) : (T += p === `T` ? -E : E + 18)),
          !d &&
          ...
          if (_) {
            let e = N(l, p) ? `XY` : j(l) ? `X` : `Y`,
              n = 0;
            n =
              e === `X` ? Math.abs(v - w) : e === `Y` ? Math.abs(y - T) / 1.5 : Math.abs(v - w) / 2;
            let r = t.append(`g`);
            if (
              (await C(
                r,
    ...
    await Promise.all(
      t.nodes().map(async (t) => {
        ...
        if (s.type === `group`) {
          ...
          if (s.icon) {
            let e = p.append(`g`);
            (e.html(`<g>${await w(s.icon, { height: i, width: i, fallbackPrefix: G.prefix })}</g>`),
              e.attr(`transform`, `translate(` + (h + o + 1) + `, ` + (g + o + 1) + `)`),
              (h += i),
              (g += a / 2 - 1 - 2));
          }
          if (s.label) {
            ...
            (await C(
              ...
              e.attr(`transform`, `translate(` + (h + o + 4) + `, ` + (g + o + 2) + `)`));
          }
  ...
  le = i(async function (e, t, n, r) {
    ...
    for (let a of n) {
      ...
      let s = n.append(`g`);
      if (a.icon)
        s.html(`<g>${await w(a.icon, { height: o, width: o, fallbackPrefix: G.prefix })}</g>`);
      else if (a.iconText) {
        s.html(`<g>${await w(`blank`, { height: o, width: o, fallbackPrefix: G.prefix })}</g>`);
        let e = s
            .append(`g`)
          ...
          if (l) {
            ...
            Object.entries(c).forEach(([e, a]) => {
              ...
              d &&
                !s[c] &&
                (o.push(c),
                n.push({ [D[e]]: d, [D[te(e)]]: l, gap: 1.5 * t.getConfigField(`iconSize`) }));
            });
          }
        }
      }
...
function $(e, r, o, s, c, { spatialMaps: l, groupAlignments: u }) {
  return new Promise((d) => {
    let f = t(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`),
      p = n({
        ...
        style: [
          ...
          { selector: `.node-group`, style: { padding: `${c.getConfigField(`padding`)}px` } },
        ],
      ...
      g = p.layout({
        ...
        idealEdgeLength(e) {
          let [t, n] = e.connectedNodes(),
            { parent: r } = V(t),
            { parent: i } = V(n);
          return r === i ? 1.5 * c.getConfigField(`iconSize`) : 0.5 * c.getConfigField(`iconSize`);
        },
        edgeElasticity(e) {
          let [t, n] = e.connectedNodes(),
            { parent: r } = V(t),
...
var de = {
  ...
  renderer: {
    draw: i(async (e, t, n, r) => {
      ...
      let m = d.append(`g`);
      (m.attr(`class`, `architecture-groups`), await le(i, p, a, t), ue(i, p, o, t));
      let h = await $(a, o, s, l, i, u);
      (await se(f, h, i, t),
        await ce(m, h, i, t),
        J(i, h),
        c(void 0, d, i.getConfigField(`padding`), i.getConfigField(`useMaxWidth`)));
    }, `draw`),
  },
  styles: oe,
};
