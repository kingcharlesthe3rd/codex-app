...
import { ia as t, is as n } from "./app-server-manager-signals.js";
import { L as r, h as i } from "./vscode-api.js";
...
var l = r(i, ({ get: r }) => {
    let i = n(r, `remote_ssh_connections`);
    if (i != null)
      return o({
        addedRemoteControlEnvIds: t(r, e.ADDED_REMOTE_CONTROL_ENV_IDS),
        remoteSshConnections: i,
        remoteControlConnections: n(r, `remote_control_connections`) ?? [],
      });
  }),
  u = r(
    i,
