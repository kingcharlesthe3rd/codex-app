...
import { s as n } from "./use-host-config-C.js";
import { Qi as r } from "./thread-context-inputs.js";
import { Br as i } from "./src-1.js";
...
function o({
  ...
  remoteWslConnections: r,
}) {
  return [...n, ...r, ...s({ addedRemoteControlEnvIds: e, remoteControlConnections: t })];
}
...
var l = e(t, ({ get: e }) => {
    let t = n(e, `remote_ssh_connections`),
      a = n(e, `remote_wsl_connections`);
    if (t != null)
      return o({
        addedRemoteControlEnvIds: r(e, i.ADDED_REMOTE_CONTROL_ENV_IDS),
        remoteSshConnections: t ?? [],
        remoteWslConnections: a ?? [],
        remoteControlConnections: n(e, `remote_control_connections`) ?? [],
      });
  }),
  u = e(
    t,
    ({ get: e }) =>
      n(e, `remote_ssh_connections`) == null || n(e, `remote_control_connections`) == null,
  );
export { s as i, l as n, c as r, u as t };
//# sourceMappingURL=selectable-remote-connections-signal.js.map
