...
import { a as g } from "./open-workspace-file.js";
import { V as _, Z as v } from "./app-shell-state.js";
import { n as y } from "./app-shell-tab-controller.js";
import { n as b } from "./thread-context.js";
...
function E({ cwd: e, path: t }) {
  if (e == null) return t;
  let n = s(t, e);
  return i(n) ? n : r({ root: e, relativePath: n, includeWorkspaceRootLabel: !0 });
}
...
async function I({ cacheKey: e, openFiles: t, queryClient: n }) {
  await Promise.all(
    t
      ...
      .map((e) => n.refetchQueries({ exact: !0, queryKey: e, type: `all` }, { throwOnError: !0 })),
  );
}
function L(e, t) {
...
function G(e) {
  ...
  return (
    t[1] === e
      ? (r = t[2])
      : ((r = (0, U.jsx)(H.Suspense, { fallback: n, children: (0, U.jsx)(W, { ...e }) })),
        (t[1] = e),
        (t[2] = r)),
    r
  );
...
function q(e, t, r) {
  ...
  return (
    ...
    y.openTab(e, G, {
      ...
      props: m,
      onClose: () => {
        (e.get(y.activeTab$)?.tabId === f && e.get(_) && (e.set(_, !1), v(e, `main`)),
          R(e, { excludeTabId: f }));
      },
      id: f,
      title: d,
