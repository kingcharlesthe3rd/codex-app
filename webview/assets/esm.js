      ...
      (E = (function () {
        ...
        return (
          ...
          (e.prototype.alias = function (e, t, n, r) {
            ...
            var i = { userId: e, type: `alias`, options: a({}, n), integrations: a({}, r) };
            return (
          ...
          (e.prototype.normalize = function (e) {
            ...
            var r = a(a({}, n), e.options?.integrations),
              ...
              c = e.options,
              l = t(e, [`options`]),
              u = a(a(a(a({ timestamp: new Date() }, l), { context: o, integrations: r }), s), {
          ...
          (e.prototype.flush = function () {
            if (this.logs.length > 1) {
              var e = this._logs.reduce(function (e, t) {
                var n,
                  r = a(a({}, t), { json: JSON.stringify(t.extras, null, ` `), extras: t.extras });
                delete r.time;
                var i = t.time?.toISOString() ?? ``;
                return (
                  e[i] && (i = `${i}-${Math.random()}`), a(a({}, e), ((n = {}), (n[i] = r), n))
                );
              }, {});
