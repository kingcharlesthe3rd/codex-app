      ...
      (E = (function () {
        ...
        return (
          ...
          (e.prototype.alias = function (e, t, n, i) {
            ...
            var a = { userId: e, type: `alias`, options: r({}, n), integrations: r({}, i) };
            return (
          ...
          (e.prototype.normalize = function (e) {
            ...
            var n = r(r({}, t), e.options?.integrations),
              ...
              c = e.options,
              l = a(e, [`options`]),
              u = r(r(r(r({ timestamp: new Date() }, l), { context: o, integrations: n }), s), {
          ...
          (e.prototype.flush = function () {
            if (this.logs.length > 1) {
              var e = this._logs.reduce(function (e, t) {
                var n,
                  i = r(r({}, t), { json: JSON.stringify(t.extras, null, ` `), extras: t.extras });
                delete i.time;
                var a = t.time?.toISOString() ?? ``;
                return (
                  e[a] && (a = `${a}-${Math.random()}`), r(r({}, e), ((n = {}), (n[a] = i), n))
                );
              }, {});
  ...
  Te = e(() => {
    (o(),
      ...
      (Q = (function (e) {
        ...
        return (
          (r.prototype.register = function (e, n, r) {
            return i(this, void 0, void 0, function () {
              var i,
                a,
                o = this;
          ...
          (r.prototype.deregister = function (e, n, r) {
            return i(this, void 0, void 0, function () {
              var i;
              return t(this, function (t) {
                switch (t.label) {
