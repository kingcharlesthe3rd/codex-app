...
var m = {
  encode(t, i = new o()) {
    ...
    for (let e of t.numberingDefinitions) U.encode(e, i.uint32(114).fork()).join();
    for (let e of t.paragraphNumberings) G.encode(e, i.uint32(122).fork()).join();
    for (let e of t.tableStyleDefinitions) l.encode(e, i.uint32(130).fork()).join();
  ...
  fromPartial(t) {
    ...
    return (
      ...
      (i.commentReferences = t.commentReferences?.map((e) => x.fromPartial(e)) || []),
      ...
      (i.numberingDefinitions = t.numberingDefinitions?.map((e) => U.fromPartial(e)) || []),
      (i.paragraphNumberings = t.paragraphNumberings?.map((e) => G.fromPartial(e)) || []),
      (i.tableStyleDefinitions = t.tableStyleDefinitions?.map((e) => l.fromPartial(e)) || []),
      (i.endnotes = t.endnotes?.map((e) => _.fromPartial(e)) || []),
      (i.settings =
        t.settings !== void 0 && t.settings !== null ? T.fromPartial(t.settings) : void 0),
      (i.theme = t.theme !== void 0 && t.theme !== null ? u.fromPartial(t.theme) : void 0),
...
var T = {
  encode(e, t = new o()) {
    return (
      ...
      e.backgroundFill !== void 0 && c.encode(e.backgroundFill, t.uint32(58).fork()).join(),
      t
    );
  },
  decode(e, n) {
...
var Z = {
    encode(e, t = new o()) {
      return (
        ...
        e.presentation !== void 0 && s.encode(e.presentation, t.uint32(26).fork()).join(),
