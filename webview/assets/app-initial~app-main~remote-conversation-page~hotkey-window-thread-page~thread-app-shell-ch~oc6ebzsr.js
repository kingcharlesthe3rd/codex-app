...
function p() {
  ...
  e[0] === n
    ...
    : ((r = (e) => {
        ...
        return (n((e) => ({ activeOperationId: null, operations: [...e.operations, t] })), t);
      }),
      (e[0] = n),
      (e[1] = r));
  let i = r,
  ...
  e[6] === n
    ? (d = e[7])
    : ((d = (e, r) => {
        n((n) => ({ ...n, operations: n.operations.map((n) => (n.id === e ? t(n, r) : n)) }));
      }),
      (e[6] = n),
      (e[7] = d));
  let f = d,
...
var g,
  _,
  v = e(() => {
    ((g = n()), r(), s(), i(), (_ = l({ activeOperationId: null, operations: [] })));
  });
