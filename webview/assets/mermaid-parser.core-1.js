import { m as e } from "./chunk-102.js";
var t = {},
  n = {
    info: e(async () => {
      let { createInfoServices: e } = await import(`./info-5.js`);
      t.info = e().Info.parser.LangiumParser;
    }, `info`),
    packet: e(async () => {
      let { createPacketServices: e } = await import(`./packet-2.js`);
    ...
    architecture: e(async () => {
      let { createArchitectureServices: e } = await import(`./architecture-5.js`);
    ...
    radar: e(async () => {
      let { createRadarServices: e } = await import(`./radar-3.js`);
