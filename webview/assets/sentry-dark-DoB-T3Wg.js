var e = `#2d2935`,
  ...
  i = `Sentry Dark`,
  a = [
    { scope: [`comment`, `punctuation.definition.comment`], settings: { foreground: `#8d849f` } },
    {
  ...
  o = `dark`,
  s = { bg: e, colors: t, chromeTheme: n, fg: r, name: i, settings: a, type: o };
export {
  e as bg,
  n as chromeTheme,
  t as colors,
...
//# sourceMappingURL=sentry-dark-DoB-T3Wg.js.map
