...
import { n as C } from "./vscode-api.js";
import { l as w } from "./persisted-signal.js";
import { i as le } from "./models-and-reasoning-efforts.js";
import "./permissions-mode-defaults.js";
import { n as ue } from "./projectless-thread.js";
import { t as de } from "./local-projects.js";
import { t as fe } from "./build-worktree-label-from-input.js";
import { t as T } from "./read-service-tier-for-request.js";
import { t as pe } from "./pending-worktree-store.js";
import { t as me } from "./workspace-dependencies-feature.js";
...
async function be({ pinned: e, threadId: t }) {
  return (
    await C(`set-thread-pinned`, { params: { threadId: t, pinned: e } }), { threadId: t, pinned: e }
  );
}
...
async function xe({ threadId: e, title: t }) {
  return (
    await v(`set-thread-title`, { conversationId: s(e), title: t }), { threadId: e, title: t }
  );
}
function Se(e, t) {
