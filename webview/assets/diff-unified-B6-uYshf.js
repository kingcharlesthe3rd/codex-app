...
import { Z as r, i, o as a, s as o, t as s, u as c } from "./app-scope-CWE-zIhQ.js";
import { jt as l, n as u, r as d } from "./use-host-config-C.js";
import { Zn as f, dr as p, er as m, fr as h } from "./thread-context-inputs.js";
...
import { t as x } from "./AnimatePresence.js";
import { t as S } from "./button.js";
import { t as te } from "./chevron-right.js";
import { t as C } from "./use-stable-callback.js";
import { t as w } from "./tooltip-B.js";
import { t as ne } from "./plus.js";
import { I as T, M as re, T as ie, k as ae, w as oe } from "./rpc-1.js";
import { a as se, n as ce } from "./shiki-highlight-provider-gate.js";
...
import { n as pe, r as D } from "./parse-diff.js";
import { t as me } from "./file-diff.js";
import { t as he } from "./error-boundary-DOI-M2iu.js";
import { t as ge } from "./copy-to-clipboard.js";
import { t as _e } from "./minus.js";
import { t as O } from "./hash-code.js";
import { r as ve } from "./diff-stats.js";
...
function I(e) {
  ...
  t[4] === n
    ? (o = t[5])
    : ((o = b(M.loadingResultsShimmer, `rounded-md`, n)), (t[4] = n), (t[5] = o));
  let s;
  return (
    t[6] !== a || t[7] !== r || t[8] !== o
...
function L(e) {
  ...
  t[5] === n
    ? (g = t[6])
    : ((g = b(`flex w-full flex-col items-start gap-2`, n)), (t[5] = n), (t[6] = g));
  let _;
...
function je(e) {
  let t = (0, N.c)(22),
    ...
    d;
  t[0] === n ? (d = t[1]) : ((d = (0, P.jsx)(Me, { ...n })), (t[0] = n), (t[1] = d));
  let f = d,
    m = s ? `binary` : l ? `rename-without-changes` : `empty`,
    g;
  t[2] === m ? (g = t[3]) : ((g = (0, P.jsx)(Pe, { kind: m })), (t[2] = m), (t[3] = g));
  let _ = g,
    v,
    y;
  t[4] !== r || t[5] !== c || t[6] !== u
    ? ((v = h(r)),
      (y = p({ filePath: r, imagePreviewMode: v, isDeletion: c, richPreviewEnabled: u })),
      (t[4] = r),
      (t[5] = c),
      (t[6] = u),
      (t[7] = v),
  ...
  if (b === `markdown`) {
    ...
    return (
      t[9] !== f || t[10] !== n.diffViewClassName || t[11] !== i
        ? ((e = (0, P.jsx)(we, { className: n.diffViewClassName, path: i, fallback: f })),
          (t[9] = f),
...
function Me(e) {
  ...
  let d = r && `[overflow-anchor:none]`,
    f;
  t[9] !== n || t[10] !== d
    ? ((f = b(`relative overflow-clip [contain:content]`, d, n)),
      (t[9] = n),
      (t[10] = d),
      (t[11] = f))
    : (f = t[11]);
  ...
  return (
    t[22] !== l || t[23] !== _
      ? ((v = (0, P.jsx)(he, { name: `FileDiff`, fallback: u, resetKey: l, children: _ })),
        (t[22] = l),
        (t[23] = _),
        (t[24] = v))
      : (v = t[24]),
...
var Ie = E(`load-full-files`, !0),
  Le = E(`skip-revert-confirmation`, !1),
  H = 250;
function Re(e) {
  let t = e.closest(ie.timelineScroll);
  if (t == null) return;
...
function U(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, P.jsx)(k, { className: `icon-2xs` })), (t[0] = p))
    : (p = t[0]);
  let m = p;
  if (n === `stage`) {
    let e;
    (t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, P.jsx)(ne, { className: `icon-2xs` })), (t[1] = e))
      : (e = t[1]),
      (m = e));
  } else if (n === `unstage`) {
    let e;
    (t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, P.jsx)(_e, { className: `icon-2xs` })), (t[2] = e))
      : (e = t[2]),
      (m = e));
  }
  let h;
  ...
  return (
    t[29] !== g || t[30] !== h
      ? ((_ = (0, P.jsx)(w, { tooltipContent: h, children: g })),
        (t[29] = g),
        (t[30] = h),
        (t[31] = _))
      : (_ = t[31]),
...
function Je({
  ...
  return `${e.metadata.cacheKey ?? `${e.metadata.name}:${e.metadata.prevObjectId ?? `none`}:${e.metadata.newObjectId ?? `none`}:${e.additions}:${e.deletions}`}:${a ?? ``}:${f(t)}:${i ? `next-disk-fallback` : `next-object-only`}:${n ? `ignore-whitespace` : `exact-whitespace`}:${r ? `full` : `partial`}`;
}
async function Ye({
  diff: e,
  hostConfig: t,
  ...
  let p = Ve(e.metadata, d.lines, f.lines, { ignoreWhitespace: n });
...
function ot(e) {
  let t = (0, N.c)(178),
    {
      ...
      showHunkActions: se,
      showFileActions: E,
      fileActionsDisabled: le,
      onHunkAction: de,
      onPostRender: fe,
      hunkActionsVariant: pe,
      cwd: D,
      richPreviewEnabled: me,
      roundedCorners: he,
      background: _e,
      diffSurface: O,
  ...
  let [K, ot] = (0, W.useState)(at),
    ...
    St;
  t[3] !== D || t[4] !== xt
    ? ((St = xt && xt !== `/dev/null` ? l(xt, D) : xt), (t[3] = D), (t[4] = xt), (t[5] = St))
    : (St = t[5]);
  let q = St,
    J = I ?? q ?? xt ?? ``,
    Ct;
  t[6] === J ? (Ct = t[7]) : ((Ct = J && !re(J) ? J : null), (t[6] = J), (t[7] = Ct));
  let wt = Ct,
    Y,
    Tt;
  t[8] !== D || t[9] !== c.metadata.prevName || t[10] !== c.metadata.type
    ? ((Y =
        ...
        c.metadata.prevName != null
          ? l(c.metadata.prevName, D)
          : null),
      (Tt = Y == null ? null : (T(Y).split(`/`).pop() ?? Y)),
      (t[8] = D),
  ...
  bb0: {
    ...
    let e = _t === `windows`,
      n;
    (t[16] !== D || t[17] !== e || t[18] !== q
      ? ((n = ae(D, q, e)), (t[16] = D), (t[17] = e), (t[18] = q), (t[19] = n))
      : (n = t[19]),
      (Z = n));
  }
  let Q = Z,
    Et;
  t[20] === J ? (Et = t[21]) : ((Et = T(J).split(`/`).pop() ?? J), (t[20] = J), (t[21] = Et));
  let Dt = Et,
    Ot = Y == null ? J : `${Y}${rt}${J}`,
  ...
  t[30] !== $ || t[31] !== Q || t[32] !== Pt
    ? ((Ft = { cwd: Pt, hostId: $, openPath: Q }),
      ...
      (t[33] = Ft))
    : (Ft = t[33]);
  let It = o(i(Ee, Ft).preferredTargetOverride$),
    Lt;
  t[34] !== D || t[35] !== $ || t[36] !== Q || t[37] !== gt
    ? ((Lt = async () => {
        try {
          return await be({ cwd: D ?? null, hostId: $, openPath: Q, queryClient: gt });
        } catch {
          return null;
        }
      }),
  ...
  let Ut = Ht,
    ...
    Gt;
  t[44] !== D || t[45] !== $ || t[46] !== Q || t[47] !== G
    ? ((Gt = (e) => {
        let { lineNumber: t, event: n } = e;
        Q && (n.metaKey || n.ctrlKey) && Oe(G, { path: Q, line: t, cwd: D ?? null, hostId: $ });
      }),
      (t[44] = D),
      (t[45] = $),
      (t[46] = Q),
  ...
  let Kt = C(Gt),
    qt;
  t[49] !== D || t[50] !== Wt || t[51] !== $ || t[52] !== Q || t[53] !== G
    ? ((qt = (e, t, n) => {
        if (!Q) return;
        let r = ft.current ?? Wt;
        ((ft.current = null),
  ...
  t[61] !== G
    ? ((Yt = () => {
        Q &&
          (async () => {
            let { primaryTarget: e } = Ce({ data: await Rt(), preferredTargetOverride: It });
            if (e != null) {
              xe(G, {
                cwd: D ?? null,
                hostId: $,
            ...
            Oe(G, { cwd: D ?? null, hostId: $, line: Wt, path: Q });
          })();
      }),
      (t[55] = D),
      (t[56] = Wt),
  ...
  let nn = C(tn),
    rn;
  t[71] !== D || t[72] !== Wt || t[73] !== $ || t[74] !== Q || t[75] !== G || t[76] !== nn
    ? ((rn = (e) => {
  ...
  t[82] !== n || t[83] !== dn || t[84] !== fn
    ? ((pn = b(`group/file-diff flex flex-col overflow-clip`, dn, fn, n)),
      (t[82] = n),
      (t[83] = dn),
      (t[84] = fn),
      (t[85] = pn))
  ...
  let mn;
  t[86] !== Ge || t[87] !== Ke
    ? ((mn = ce(Ge, Ke)), (t[86] = Ge), (t[87] = Ke), (t[88] = mn))
    : (mn = t[88]);
  ...
  t[92] === je
    ...
    : ((vn = (e) => {
      ...
      (t[93] = vn));
  let yn;
  t[94] !== c.metadata.name || t[95] !== de
    ? ((yn = (e) => {
        de?.({ path: c.metadata.name, action: e, scope: `file` });
      }),
  ...
  t[161] === Cn
    ? (wn = t[162])
    : ((wn = (0, P.jsx)(x, { children: Cn })), (t[161] = Cn), (t[162] = wn));
  let Tn;
...
function lt(e) {
  let t = (0, N.c)(107),
    {
      ...
      stickyHeader: x,
      toggleAriaLabel: C,
      workspaceRelativePath: ne,
    } = e,
    T = u === `full-review`,
    re;
  t[0] === _ ? (re = t[1]) : ((re = oe.reviewFileToggle(_)), (t[0] = _), (t[1] = re));
  let ie = T ? `ghostMuted` : `ghost`,
    ae;
  t[2] === g
    ? (ae = t[3])
    : ((ae = (e) => {
      ...
      (t[2] = g),
      (t[3] = ae));
  let se = _ ? `rotate-90` : `rotate-0`,
    ce;
  t[4] === se
    ? (ce = t[5])
    : ((ce = b(`icon-2xs transition-transform duration-200`, se)), (t[4] = se), (t[5] = ce));
  let E;
  t[6] === ce ? (E = t[7]) : ((E = (0, P.jsx)(te, { className: ce })), (t[6] = ce), (t[7] = E));
  let le;
  t[8] !== re || t[9] !== ie || t[10] !== ae || t[11] !== E || t[12] !== C
    ? ((le = (0, P.jsx)(S, {
        ...re,
    ...
    : (le = t[13]);
  let ue = le,
    de = x && `z-10 sticky top-0`,
    fe = T && x && `backdrop-blur-sm`,
    pe;
  t[14] !== de || t[15] !== fe
    ? ((pe = b(`cursor-interaction select-none focus-visible:outline-none`, de, fe)),
      (t[14] = de),
      (t[15] = fe),
      (t[16] = pe))
    : (pe = t[16]);
  let D =
    ...
    me;
  t[17] === D ? (me = t[18]) : ((me = { backgroundColor: D }), (t[17] = D), (t[18] = me));
  let he;
  t[19] === T
    ? (he = t[20])
    : ((he = T ? void 0 : { backgroundColor: `var(--codex-diffs-header-surface)` }),
      (t[19] = T),
      (t[20] = he));
  let ge;
  t[21] !== f || t[22] !== x || t[23] !== T
    ? ((ge = b(
      ...
      (t[24] = ge))
    : (ge = t[24]);
  let _e = T ? `gap-0.5` : `gap-2`,
    O;
  t[25] === _e
    ? (O = t[26])
    : ((O = b(`text-size-chat flex min-w-0 flex-1 items-center text-token-text-primary`, _e)),
      (t[25] = _e),
      (t[26] = O));
  let k = T && `gap-2 pl-1`,
    ye;
  t[27] === k
    ? (ye = t[28])
    : ((ye = b(`flex min-w-0 items-center`, k)), (t[27] = k), (t[28] = ye));
  let be;
  t[29] !== i || t[30] !== T
    ? ((be = T ? (0, P.jsx)(yt, { path: i }) : null), (t[29] = i), (t[30] = T), (t[31] = be))
    : (be = t[31]);
  let xe;
  t[32] === i
    ? (xe = t[33])
    : ((xe = (0, P.jsx)(`span`, { className: `font-mono`, children: i })),
      (t[32] = i),
      (t[33] = xe));
  let Se = !T && `pl-[6px]`,
    A;
  ...
  t[38] !== i || t[39] !== a || t[40] !== T
    ...
    : (Te = t[41]);
  let j;
  t[42] !== m || t[43] !== A || t[44] !== Ce || t[45] !== we || t[46] !== Te
    ? ((j = (0, P.jsxs)(`button`, {
        type: `button`,
        className: A,
        disabled: Ce,
  ...
  let Ee;
  t[48] !== xe || t[49] !== j
    ? ((Ee = (0, P.jsx)(w, { tooltipContent: xe, delayDuration: 200, children: j })),
      (t[48] = xe),
      (t[49] = j),
      (t[50] = Ee))
    : (Ee = t[50]);
  let De;
  t[51] !== ye || t[52] !== be || t[53] !== Ee
    ? ((De = (0, P.jsxs)(`div`, { className: ye, children: [be, Ee] })),
      (t[51] = ye),
      (t[52] = be),
      (t[53] = Ee),
      (t[54] = De))
  ...
  t[55] !== ue || t[56] !== T
    ...
    : (Oe = t[57]);
  let M;
  t[58] !== O || t[59] !== De || t[60] !== Oe
    ? ((M = (0, P.jsxs)(`div`, { className: O, children: [De, Oe] })),
      (t[58] = O),
      (t[59] = De),
      (t[60] = Oe),
      (t[61] = M))
    : (M = t[61]);
  let ke = T ? `gap-0` : `gap-1`,
    Ae;
  t[62] === ke
    ? (Ae = t[63])
    : ((Ae = b(`ms-auto flex items-center`, ke)), (t[62] = ke), (t[63] = Ae));
  let F;
  t[64] !== n ||
  t[65] !== i ||
  t[66] !== s ||
  ...
  t[70] !== T
        ...
        ? (0, P.jsx)(
            `span`,
            {
              className: b(
                ...
                s == null ? T && (ee || y) && `me-1` : T ? `me-3` : `me-2`,
              ),
              children: (0, P.jsx)(ve, { linesAdded: n.additions, linesRemoved: n.deletions }),
            },
            i,
          )
        : null),
    ...
    : (F = t[71]);
  let I;
  t[72] !== o || t[73] !== d || t[74] !== p || t[75] !== ee || t[76] !== T
    ? ((I = ee
        ? (0, P.jsx)(q, { disabled: o, onFileAction: p, useMutedButtonStyle: T, variant: d })
        : null),
      (t[72] = o),
      (t[73] = d),
      (t[74] = p),
    ...
    : (I = t[77]);
  let L;
  t[78] !== s || t[79] !== c || t[80] !== y || t[81] !== T
    ? ((L =
        s == null
          ? null
          : (0, P.jsx)(`span`, {
              className: b(T ? `flex items-center` : `contents`, T && y && `me-1`),
              onClick: c,
              children: s,
            })),
      (t[78] = s),
    ...
    : (L = t[82]);
  let R;
  t[83] !== l || t[84] !== h || t[85] !== y || t[86] !== T
    ? ((R = y
        ? (0, P.jsx)(dt, { headerOpenAction: l, onOpenInEditor: h, useMutedButtonStyle: T })
        : null),
      (t[83] = l),
      (t[84] = h),
      (t[85] = y),
  ...
  let je;
  t[99] !== he || t[100] !== V
    ? ((je = (0, P.jsx)(`div`, { style: he, children: V })),
      (t[99] = he),
      (t[100] = V),
      (t[101] = je))
    : (je = t[101]);
  let Me;
  return (
    t[102] !== g || t[103] !== pe || t[104] !== me || t[105] !== je
      ? ((Me = (0, P.jsx)(`div`, { onClick: g, className: pe, style: me, children: je })),
        (t[102] = g),
        (t[103] = pe),
        (t[104] = me),
        (t[105] = je),
...
function dt(e) {
  ...
  let l = c,
    ...
    d;
  t[6] === u ? (d = t[7]) : ((d = b(`shrink-0`, u)), (t[6] = u), (t[7] = d));
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, P.jsx)(le, { className: `icon-2xs` })), (t[11] = h))
    : (h = t[11]);
  let g;
  ...
  let _;
  t[17] !== l || t[18] !== g
    ? ((_ = (0, P.jsx)(w, { tooltipContent: l, children: g })),
      (t[17] = l),
      (t[18] = g),
      (t[19] = _))
    : (_ = t[19]);
...
function pt(e) {
  let t = (0, N.c)(137),
    {
      ...
      showHunkActions: k,
      showLoadError: ye,
      useReviewLineInfoSeparators: be,
      viewType: xe,
      wrapLines: Se,
    } = e,
    A = a(s),
  ...
  let ke = M,
    ...
    I = (0, W.useRef)(!1),
    L = y ?? Ae,
    R = p.additions + p.deletions,
    z;
  t[1] === p ? (z = t[2]) : ((z = pe(p)), (t[1] = p), (t[2] = z));
  let B = z,
    V = R > et,
    Me = V || !we ? `none` : `word-alt`,
    Ne = p.additions === 0 && p.deletions === 0,
    Pe = Ne && p.metadata.type === `rename-pure`,
    Fe = B,
    Le;
  t[3] !== f || t[4] !== p || t[5] !== w || t[6] !== C || t[7] !== j || t[8] !== L
    ? ((Le = Je({
        diff: p,
        hostConfig: L,
        ignoreWhitespace: w,
        loadFullFilesEnabled: j,
    ...
    : (Le = t[9]);
  let H = i(Ke, Le),
    Re = o(H.fullDiffMetadata$),
    U = o(H.fullContentLoadFailed$),
    ze = o(H.fullContentUnavailable$),
    Be = o(H.isLoadingFullContent$),
    Ve =
      te &&
      j &&
      f != null &&
      _e &&
      p.metadata.isPartial &&
      !p.isBinary &&
      !p.isGitlink &&
      !Ne &&
      !Fe &&
  ...
  t[28] !== Ve
    ...
    : ((Ye = t[29]), (Ze = t[30])),
    (0, W.useEffect)(Ye, Ze));
  let Qe = Re ?? p.metadata,
    $e;
  t[31] !== B || t[32] !== Re
    ? (($e = Re == null ? B : D(Re)), (t[31] = B), (t[32] = Re), (t[33] = $e))
    : ($e = t[33]);
  let tt = $e,
    nt;
  t[34] !== V || t[35] !== Qe
  ...
  let G = nt,
    rt = x === `staged` ? null : ge,
    it;
  t[37] !== f || t[38] !== p || t[39] !== x || t[40] !== rt || t[41] !== L.id
    ? ((it = Ct({ diff: p, openFilePath: rt, cwd: f, hostId: L.id, hunkActionsVariant: x })),
      (t[37] = f),
      (t[38] = p),
      (t[39] = x),
      (t[40] = rt),
    ...
    : (it = t[42]);
  let at = it,
    K = p.metadata.type === `new`,
    ot = p.metadata.type === `deleted`,
    st;
  t[43] !== g ||
  t[44] !== oe ||
  t[45] !== ae ||
  ...
  bb0: {
    ...
    let e;
    (t[58] !== p.metadata.hunks || t[59] !== p.metadata.name
      ? ((e = []),
        p.metadata.hunks.forEach((t, n) => {
          let r = Xe(t);
          r &&
            e.push({
              side: r.side,
              lineNumber: r.lineNumber,
              metadata: { kind: `hunk-actions`, path: p.metadata.name, hunkIndex: n },
            });
        }),
        (t[58] = p.metadata.hunks),
        (t[59] = p.metadata.name),
        (t[60] = e))
      : (e = t[60]),
      (ft = e));
  }
  ...
  let X = Y,
    Z;
  t[70] !== ut || t[71] !== g || t[72] !== lt || t[73] !== p || t[74] !== b || t[75] !== he
    ? ((Z = () => {
        if (!g) return;
        let e = b.current;
        if (!e) return;
        ...
        lt.has(t) ||
          (ut({
            ...
            localDiffHunk: Tt(p, e.side, e.lineNumber),
          }),
          he?.());
      }),
      (t[70] = ut),
  ...
  (t[77] !== Q || t[78] !== O
    ...
    (0, W.useEffect)(Et, Dt));
  let Ot;
  t[81] !== x || t[82] !== ue || t[83] !== dt
    ? ((Ot = (e) => {
        let t = e.metadata;
        return t
          ? t.kind === `hunk-actions`
            ? (0, P.jsx)(J, { path: t.path, hunkIndex: t.hunkIndex, onHunkAction: ue, variant: x })
            : dt(e)
          : null;
      }),
      (t[81] = x),
  ...
  t[126] !== Se
    ? (($ = ce
        ? (0, P.jsx)(_t, { diff: p, lines: vt(p) })
        : ye
          ? (0, P.jsx)(xt, { onRetry: le })
          : tt
            ? (0, P.jsx)(gt, { canOpenFile: n, onOpenInEditor: me })
            : (0, P.jsxs)(P.Fragment, {
                children: [
                  ...
                  (0, P.jsx)(je, {
                    diffViewProps: {
                      ...
                      onLineNumberClick: v,
                      onLineSelected: Oe,
                      onLineSelectionChange: Oe,
                      selectedLines: Ee,
                      lineAnnotations: bt,
                      renderAnnotation: k || h ? kt : void 0,
                      onGutterUtilityClick: g ? jt : void 0,
                      onPostRender: fe,
                      useReviewLineInfoSeparators: be,
                    },
                    filePath: p.metadata.name,
                    previewPath: rt,
                    imagePreview: at,
                    hasNoChanges: Ne,
...
function q(e) {
  let t = (0, N.c)(24),
    ...
    d;
  t[0] === u ? (d = t[1]) : ((d = b(`flex items-center`, u)), (t[0] = u), (t[1] = d));
  let f;
  t[2] === i
    ? (f = t[3])
    : ((f = (e) => {
...
//# sourceMappingURL=diff-unified-B6-uYshf.js.map
