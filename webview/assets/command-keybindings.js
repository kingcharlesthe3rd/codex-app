...
var l = [
  ...
  u = i(n, `codex-command-keymap-state`, { enabled: !0, staleTime: r.ONE_MINUTE }),
  d = e(n, (e, { get: t }) => (c(e), [...a({ commandId: e, keymapState: t(u).data })])),
  f = e(n, (e, { get: t }) => t(d, e)[0] ?? null),
  p = e(n, (e, { get: t }) => t(d, e).map((e) => s(e))),
  m = e(n, (e, { get: t }) => t(p, e)[0] ?? null),
  h = t(n, ({ get: e }) => l.map((t) => e(m, t))),
  g = e(n, (e, { get: t }) => t(u).data?.bindings.some((t) => t.command === e) === !0);
function _(e) {
