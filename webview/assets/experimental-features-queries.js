...
import { Xs as t } from "./app-server-manager-signals.js";
import { C as n, L as r, S as i, _ as a, nt as o, w as s, wt as c } from "./setting-storage.js";
...
var p = `chronicle`,
  ...
  _ = o(i, (e) => ({
    ...
    queryFn: async () => {
      let r = async (n) => {
        let i = await t(`list-experimental-features`, { hostId: e, cursor: n, limit: h });
        return i.nextCursor == null ? i.data : [...i.data, ...(await r(i.nextCursor))];
      };
      try {
        return await r(null);
      } catch (e) {
