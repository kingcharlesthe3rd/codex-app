...
import { d as b, f as x } from "./app-initial~app-main~automations-page.js";
import {
  dt as S,
  i as C,
  r as w,
...
function I() {
  let e = (0, L.c)(20),
    ...
    p;
  e[0] === f ? (p = e[1]) : ((p = s(f)), (e[0] = f), (e[1] = p));
  let h = p,
    v = r(S, l ?? null),
    x = r(d, l ?? null),
    C;
  e[2] === x ? (C = e[3]) : ((C = w(x ? i(x) : null)), (e[2] = x), (e[3] = C));
  let T = C;
  M(t);
  let E;
  if (
    (e[4] !== l || e[5] !== n || e[6] !== T || e[7] !== v
      ? ((E =
          l == null
            ? null
            : {
    ...
    return (
      e[9] === h
        ? (t = e[10])
        : ((t = (0, R.jsx)(m, { to: h, replace: !0 })), (e[9] = h), (e[10] = t)),
      t
    );
  }
  let O, k;
  e[11] === l
    ? ((O = e[12]), (k = e[13]))
    : ((O = (0, R.jsx)(j, { conversationId: l })),
      (k = (0, R.jsx)(A, { conversationId: l })),
      (e[11] = l),
      (e[12] = O),
      (e[13] = k));
  let N;
...
var L, R;
e(() => {
  ((L = t()), l(), n(), h(), p(), f(), O(), k(), P(), T(), v(), C(), N(), x(), E(), (R = u()));
})();
