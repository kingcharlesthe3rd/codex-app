...
import { Tb as d, wb as f } from "./app-initial~app-main~onboarding-page.js";
import {
  Ln as p,
  Rs as m,
  Us as h,
...
import { c as S, l as C } from "./app-initial~app-main~automations-page.js";
import {
  a as w,
  o as T,
...
function I() {
  ...
  if (
    ...
    return (
      e[9] === g
        ? (t = e[10])
        : ((t = (0, R.jsx)(h, { to: g, replace: !0 })), (e[9] = g), (e[10] = t)),
      t
    );
  }
  let O, k;
...
var L, R;
e(() => {
  ((L = n()), r(), t(), x(), m(), g(), O(), k(), P(), f(), _(), T(), N(), C(), E(), (R = u()));
})();
