...
import { hg as b, mg as x } from "./app-initial~app-main~onboarding-page.js";
import { d as S, u as C } from "./app-initial~app-main~automations-page.js";
import {
  Jn as w,
  qn as T,
...
function I() {
  let e = (0, L.c)(20),
    ...
    { conversationId: o } = d(),
    { data: s } = h(C),
    u = s == null || s.configuredHotkey != null,
    g;
  e[0] === u ? (g = e[1]) : ((g = v(u)), (e[0] = u), (e[1] = g));
  let _ = g,
    y = m(b, o ?? null),
    x = m(i, o ?? null),
    S;
  e[2] === x ? (S = e[3]) : ((S = T(x ? c(x) : null)), (e[2] = x), (e[3] = S));
  let w = S;
  M(r);
  let E;
  if (
    (e[4] !== o || e[5] !== a || e[6] !== w || e[7] !== y
      ? ((E =
          o == null
            ? null
            : {
    ...
    return (
      e[9] === _
        ? (t = e[10])
        : ((t = (0, R.jsx)(n, { to: _, replace: !0 })), (e[9] = _), (e[10] = t)),
      t
    );
  }
  let O, k;
  e[11] === o
    ? ((O = e[12]), (k = e[13]))
    : ((O = (0, R.jsx)(j, { conversationId: o })),
      (k = (0, R.jsx)(A, { conversationId: o })),
      (e[11] = o),
      (e[12] = O),
      (e[13] = k));
  let N;
...
var L, R;
e(() => {
  ((L = g()), a(), s(), u(), r(), _(), O(), k(), P(), x(), o(), w(), N(), S(), E(), (R = y()));
})();
