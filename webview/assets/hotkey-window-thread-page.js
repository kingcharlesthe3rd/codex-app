...
import { Z as t, a as n, o as r, s as i } from "./app-scope-CWE-zIhQ.js";
import "./use-host-config-C.js";
import { A as a } from "./thread-context-inputs.js";
import "./vscode-api.js";
import "./isEqual.js";
import { _n as o, _t as s, pt as c } from "./src-1.js";
import "./client.js";
import "./react-dom.js";
import { l } from "./lib-1.js";
import "./proxy.js";
...
import { a as u, g as d } from "./chunk-13.js";
import "./parse-directives.js";
import "./thread-side-panel-tabs-2.js";
import "./platform.js";
import { f } from "./persisted-signal.js";
...
import { t as p } from "./local-conversation-title-signals.js";
...
import { t as m } from "./get-project-name.js";
...
import { n as h } from "./hotkey-window-state.js";
...
import "./header.js";
import { n as g } from "./use-hotkey-window-detail-layout.js";
import "./thread-scroll-controller-context-value.js";
import "./thread-scroll-layout.js";
import { n as _, t as v } from "./local-conversation-stream-role-product-event.js";
import "./hooks-settings-copy.js";
import "./user-message-attachments.js";
import { m as y, r as b } from "./local-conversation-thread.js";
...
function C() {
  let e = (0, x.c)(20),
    ...
    D;
  e[0] === E ? (D = e[1]) : ((D = s(E)), (e[0] = E), (e[1] = D));
  let O = D,
    k = n(p, w ?? null),
    A = n(a, w ?? null),
    j;
  e[2] === A ? (j = e[3]) : ((j = m(A ? o(A) : null)), (e[2] = A), (e[3] = j));
  let M = j;
  y(t);
  let N;
  if (
    (e[4] !== w || e[5] !== C || e[6] !== M || e[7] !== k
      ? ((N =
          w == null
            ? null
            : {
    ...
    return (
      e[9] === O
        ? (t = e[10])
        : ((t = (0, S.jsx)(u, { to: O, replace: !0 })), (e[9] = O), (e[10] = t)),
      t
    );
  }
  let P, F;
  e[11] === w
    ? ((P = e[12]), (F = e[13]))
    : ((P = (0, S.jsx)(v, { conversationId: w })),
      (F = (0, S.jsx)(_, { conversationId: w })),
      (e[11] = w),
      (e[12] = P),
      (e[13] = F));
  let I;
  ...
  return (
    e[16] !== P || e[17] !== F || e[18] !== I
      ? ((L = (0, S.jsxs)(S.Fragment, { children: [P, F, I] })),
        (e[16] = P),
        (e[17] = F),
        (e[18] = I),
        (e[19] = L))
