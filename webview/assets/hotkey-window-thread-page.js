...
import { a as t, o as n, s as r, z as i } from "./app-scope.js";
import { _ as a } from "./app-server-manager-signals.js";
import "./vscode-api.js";
import "./isEqual.js";
import { ft as o, gt as s, pn as c } from "./src-2.js";
import "./client.js";
import "./react-dom.js";
...
import { b as u, r as d } from "./local-conversation-thread.js";
import "./core.esm.js";
import "./katex-3.js";
import "./pdf.js";
import { a as f, g as p } from "./chunk-9.js";
...
import { n as _ } from "./hotkey-window-state.js";
...
import { n as y, t as b } from "./local-conversation-stream-role-product-event.js";
...
function C() {
  ...
  let O = D,
    ...
    A = t(a, w ?? null),
    j;
  e[2] === A ? (j = e[3]) : ((j = g(A ? c(A) : null)), (e[2] = A), (e[3] = j));
  let M = j;
  u(i);
  let N;
  if (
    ...
    return (
      e[9] === O
        ? (t = e[10])
        : ((t = (0, S.jsx)(f, { to: O, replace: !0 })), (e[9] = O), (e[10] = t)),
      t
    );
  }
  let P, F;
  e[11] === w
    ? ((P = e[12]), (F = e[13]))
    : ((P = (0, S.jsx)(b, { conversationId: w })),
      (F = (0, S.jsx)(y, { conversationId: w })),
      (e[11] = w),
      (e[12] = P),
      (e[13] = F));
  let I;
