...
function l(e) {
  ...
  let m =
    ...
    h;
  t[2] === m ? (h = t[3]) : ((h = i(`flex shrink-0 items-center`, m)), (t[2] = m), (t[3] = h));
  let g;
  t[4] !== f || t[5] !== s
    ? ((g = f.formatNumber(s)), (t[4] = f), (t[5] = s), (t[6] = g))
    : (g = t[6]);
  let _;
  t[7] === g
    ? (_ = t[8])
  ...
  let y =
    ...
    b;
  t[12] === y ? (b = t[13]) : ((b = i(`flex shrink-0 items-center`, y)), (t[12] = y), (t[13] = b));
  let x;
  t[14] !== f || t[15] !== c
    ? ((x = f.formatNumber(c)), (t[14] = f), (t[15] = c), (t[16] = x))
    : (x = t[16]);
  let S;
  t[17] === x
    ? (S = t[18])
...
function u(e) {
  let t = (0, a.c)(20),
    { linesAdded: n, linesRemoved: s, variant: c, className: l } = e,
    u = c === void 0 ? `color` : c,
    f;
  t[0] === l
    ? (f = t[1])
  ...
  let p =
      u === `monochrome`
        ...
        : `text-token-git-decoration-added-resource-foreground`,
    m;
  t[2] === p ? (m = t[3]) : ((m = i(`flex shrink-0 items-center`, p)), (t[2] = p), (t[3] = m));
  let h;
  t[4] === n
    ? (h = t[5])
    : ((h = (0, o.jsx)(r, {
        ...
        defaultMessage: `+{linesAdded}`,
        description: `Number of lines added`,
        values: { linesAdded: (0, o.jsx)(d, { value: n }, `linesAdded`) },
      })),
      (t[4] = n),
      (t[5] = h));
  let g;
  t[6] !== m || t[7] !== h
    ? ((g = (0, o.jsx)(`span`, { className: m, children: h })), (t[6] = m), (t[7] = h), (t[8] = g))
    : (g = t[8]);
  let _ =
      u === `monochrome`
        ? `text-token-input-placeholder-foreground`
        : `text-token-git-decoration-deleted-resource-foreground`,
    v;
  t[9] === _ ? (v = t[10]) : ((v = i(`flex shrink-0 items-center`, _)), (t[9] = _), (t[10] = v));
  let y;
  t[11] === s
    ? (y = t[12])
    : ((y = (0, o.jsx)(r, {
...
function d(e) {
  let t = (0, a.c)(4),
    ...
    c = n(),
    l;
  if (t[0] !== c || t[1] !== r || t[2] !== s) {
    let e = c.formatNumber(r, { useGrouping: !1 }),
      n = Array.from(e),
      i = n.filter(m).length;
    ((l = (0, o.jsx)(`span`, {
      "aria-label": e,
...
function f(e) {
  let t = (0, a.c)(12),
    ...
    l = c[n],
    u;
  t[0] === l ? (u = t[1]) : ((u = i(`diff-stat-digit-stack`, l)), (t[0] = l), (t[1] = u));
  let d;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = s.map(p)), (t[2] = d)) : (d = t[2]);
  let f;
  t[3] === u
    ? (f = t[4])
    : ((f = (0, o.jsx)(`span`, { className: u, children: d })), (t[3] = u), (t[4] = f));
  let m = f,
    h = r === `inline` && `diff-stat-digit-column-inline`,
    g;
  t[5] === h ? (g = t[6]) : ((g = i(`diff-stat-digit-column`, h)), (t[5] = h), (t[6] = g));
  let _;
  t[7] === m
    ? (_ = t[8])
