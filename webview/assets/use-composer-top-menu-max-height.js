...
import { kr as i } from "./app-server-manager-signals.js";
import { nr as a, rr as o } from "./src-2.js";
import { t as s } from "./clsx-Cir5-jBH.js";
import { f as c } from "./chunk-9.js";
import { n as l } from "./composer-top-menu-chrome.js";
function u(e, t) {
  let n = i(e.path)?.pluginMarketplaceName ?? null;
  return t == null || n == null || !o(n) || n === a(t);
}
var d = `data-hotkey-window-home-composer-menu-open`;
function f(e) {
...
function b(e) {
  ...
  for (let e = 0; e < m; e += 1)
    for (let n = 0; n < h; n += 1) {
      if (!S(t, e * h + n)) continue;
      (r.push({ animationDelayMs: T(e), column: n, row: e }), i.add(C(n, e)));
      let a = m - 1 - n;
      a !== n && (r.push({ animationDelayMs: T(e), column: a, row: e }), i.add(C(a, e)));
    }
  if (r.length === 0) {
    let e = Math.floor(m / 2);
    (r.push({ animationDelayMs: T(e), column: e, row: e }), i.add(C(e, e)));
  }
  return { cells: r, color: E(n), scanCells: w(i) };
}
function x(e) {
  let t = _;
  for (let n = 0; n < e.length; n += 1) t = (t * v + e.charCodeAt(n)) % g;
  return t;
}
function S(e, t) {
...
function w(e) {
  ...
  for (let n = 0; n < m; n += 1)
    for (let r = 0; r < m; r += 1)
      t.push({ animationDelayMs: T(n), column: r, filled: e.has(C(r, n)), row: n });
  return t;
}
function T(e) {
  return e * p;
...
function E(e) {
  return D(Math.floor((e / g) * y.length));
}
function D(e) {
  return y[e % y.length] ?? `var(--color-token-charts-yellow)`;
}
var O = {
    ...
    ((c = r),
      ...
      (m = e.cells.map((t) =>
        (0, A.jsx)(
          `rect`,
          {
            className: o ? O.filledScanCell : void 0,
            x: t.column * j,
            y: t.row * j,
            width: j,
            height: j,
...
function I(e) {
  let t = (0, k.c)(13),
    ...
    u = c(),
    d = o === `embeddedExpandedTopTray`;
  if (o === `expandedTopTray` || d || f(u.pathname)) {
    let e;
    t[0] === r
      ? (e = t[1])
  ...
  return (
    t[9] !== n || t[10] !== a || t[11] !== p
      ? ((m = (0, A.jsx)(`div`, { ref: a, className: p, children: n })),
        (t[9] = n),
        (t[10] = a),
        (t[11] = p),
        (t[12] = m))
...
function L(e) {
  ...
  return (
    t[3] !== n || t[4] !== a || t[5] !== l
      ? ((u = (0, A.jsx)(`div`, { ref: a, className: l, children: n })),
        (t[3] = n),
        (t[4] = a),
        (t[5] = l),
        (t[6] = u))
...
function R(e) {
  let t = (0, k.c)(6),
    ...
    o = c(),
    l =
      a === `expandedTopTray` || a === `embeddedExpandedTopTray` || f(o.pathname)
  ...
  return (
    t[3] !== n || t[4] !== u
      ? ((d = (0, A.jsx)(`div`, { className: u, children: n })), (t[3] = n), (t[4] = u), (t[5] = d))
      : (d = t[5]),
    d
  );
}
