...
var t,
  ...
  s,
  c = e(() => {
    (a(), (o = Object.freeze({ width: null, height: null })), (s = Object.freeze({ ...o, ...n })));
  }),
  l,
  u,
  d = e(() => {
    ((l = (e, t, n, r = ``) => {
      ...
      (u = (e, t) => (e ? !!(((t && e.prefix === ``) || e.prefix) && e.name) : !1)));
  });
function f(e, t) {
  let n = {};
...
function k(e, t) {
  ...
  [n, i].forEach((e) => {
    ...
    n
      ? r
        ...
        : (t.push(
          ...
          (a.top = a.left = 0))
      : r &&
        (t.push(`translate(` + (0 - a.left).toString() + ` ` + (a.height + a.top).toString() + `)`),
        t.push(`scale(1 -1)`),
        (a.top = a.left = 0));
    let s;
    ...
    (i % 2 == 1 &&
      ...
      a.width !== a.height && ((s = a.width), (a.width = a.height), (a.height = s))),
  ...
  c === null
    ...
    : ((f = c === `auto` ? u : c), (p = l === null ? x(f, d / u) : l === `auto` ? d : l));
  let m = {},
    h = (e, t) => {
      A(t) || (m[e] = t.toString());
    };
...
var A,
  j = e(() => {
    (a(), c(), w(), O(), (A = (e) => e === `unset` || e === `undefined` || e === `none`));
  });
function M(e, t = P) {
  let n = [],
    r;
...
var N,
  ...
  I = e(() => {
    ((N = /\sid="(\S+)"/g),
      (P = `IconifyId` + Date.now().toString(16) + ((Math.random() * 16777216) | 0).toString(16)),
      (F = 0));
  });
function L(e, t) {
...
//# sourceMappingURL=esm-Bogb--qm.js.map
