...
import "./math.js";
import { b as r, t as i, v as a, y as o } from "./merge-1.js";
import { i as s } from "./_baseFor.js";
import { I as c, f as l, m as u, r as d, s as f } from "./chunk-94.js";
import { t as ee } from "./dist-Y1G-iXdi.js";
var te = class {
  constructor(e, t) {
...
var de = ee(),
  ...
  me = t(function (e, t) {
    ...
    let i = l(e, t),
      a = `config`;
    return (
      r[a] !== void 0 && (i === `flowchart-v2` && (i = `flowchart`), (r[i] = r[a]), delete r[a]), r
    );
  }, `detectInit`),
...
`,
      ...
      return a.length === 0 ? { type: t, args: null } : a.length === 1 ? a[0] : a;
    } catch (r) {
      return (
        e.error(
...
var W = t((e, t = 2) => {
    ...
    for (let t of e) {
      if (n) {
        ...
        if (e < r) r -= e;
          ...
          if (i > 0 && i < 1)
            return { x: W((1 - i) * n.x + i * t.x, 5), y: W((1 - i) * n.y + i * t.y, 5) };
        }
      }
      n = t;
    }
  ...
  ye = t((t, n, r) => {
    ...
    let i = G(n, 25),
      ...
      s = { x: 0, y: 0 };
    return (
      (s.x = Math.sin(o) * a + (n[0].x + i.x) / 2), (s.y = -Math.cos(o) * a + (n[0].y + i.y) / 2), s
    );
...
var be = 0,
  xe = t(() => (be++, `id-` + Math.random().toString(36).substr(2, 12) + `-` + be), `generateId`);
function Se(e) {
  let t = ``;
    ...
    (e, t) => {
      ...
      for (let e of s) {
        ...
        for (let r of c) {
          let i = we();
          i.text = r || `​`;
          let s = Te(d, i).style(`font-size`, o).style(`font-weight`, a).style(`font-family`, e),
