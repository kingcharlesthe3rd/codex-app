...
import { n as p, t as m } from "./app-initial~app-main~new-thread-panel-page.js";
import { n as h, t as g } from "./home-announcements-Dizo-1Ny.js";
function _() {
  let e = (0, v.c)(10),
    t = s();
  {
    ...
    return (
      e[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, y.jsx)(a, { to: `/`, replace: !0 })), (e[0] = t))
        : (t = e[0]),
      t
    );
  }
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = i(f, `z-10 -mt-[var(--thread-footer-overlap)] flex flex-col gap-2 pb-2`)), (e[6] = c))
    : (c = e[6]);
  let l;
  e[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, y.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, y.jsx)(u, { className: `electron:hidden` }),
        ],
      })),
      (e[7] = l))
    : (l = e[7]);
