...
import { vn as l, yn as u } from "./app-initial~app-main~automations-page.js";
import {
  n as d,
  t as f,
...
function _() {
    ...
    n = r();
  {
    ...
    return (
      e[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((n = (0, y.jsx)(t, { to: `/`, replace: !0 })), (e[0] = n))
        : (n = e[0]),
      n
    );
  }
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = s(m, `z-10 -mt-[var(--thread-footer-overlap)] flex flex-col gap-2 pb-2`)), (e[6] = c))
    : (c = e[6]);
  let u;
