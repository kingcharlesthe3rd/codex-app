...
import { n as h, t as g } from "./home-announcements-1.js";
function _() {
  let e = (0, v.c)(10),
    t = l();
  {
    ...
    return (
      e[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, y.jsx)(i, { to: `/`, replace: !0 })), (e[0] = t))
        : (t = e[0]),
      t
    );
  }
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = o(m, `z-10 -mt-[var(--thread-footer-overlap)] flex flex-col gap-2 pb-2`)), (e[6] = s))
    : (s = e[6]);
  let u;
