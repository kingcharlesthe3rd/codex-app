...
import { r as re } from "./chunk-8.js";
import { o as ie } from "./statsig.js";
import { t as d } from "./request.js";
import { _ as f, g as ae, h as oe, m as p, v as se, y as ce } from "./apps-queries.js";
...
import { n as _e } from "./app-connect-oauth.js";
...
function Se(e) {
  ...
  let { hostId: r, onConnectStarted: i } = n,
    ...
    o = r ?? `local`,
    s = ie(`2761268526`),
    { clearPendingAppConnect: c, isAppConnectPending: ee, markAppConnectOAuthPending: te } = _e(),
...
function v(e, t) {
  return (0, h.jsxs)(
    `div`,
    {
      ...
      children: [
        (0, h.jsx)(`div`, { className: `h-3 w-36 rounded bg-token-border-default` }),
        (0, h.jsx)(`div`, { className: `h-2.5 w-full rounded bg-token-border-default` }),
        (0, h.jsx)(`div`, { className: `h-2.5 w-4/5 rounded bg-token-border-default` }),
      ],
    },
    t,
  );
...
function Me(e) {
  ...
  let x = Le,
    S;
  t[2] === b ? (S = t[3]) : ((S = [`mcp-settings`, `app-connect`, b]), (t[2] = b), (t[3] = S));
  let Re = Ie && n != null,
    C;
  t[4] === n
    ? (C = t[5])
  ...
  let ze;
  t[6] !== S || t[7] !== Re || t[8] !== C
    ? ((ze = { queryKey: S, enabled: Re, staleTime: te.FIVE_MINUTES, queryFn: C }),
      (t[6] = S),
      (t[7] = Re),
      (t[8] = C),
      (t[9] = ze))
  ...
  t[10] === b
    ? (E = t[11])
    : ((E = [`mcp-settings`, `app-connect`, `tos`, b]), (t[10] = b), (t[11] = E));
  let Be = Ie && n != null,
    D;
  t[12] === n
    ? (D = t[13])
  ...
  t[14] !== Be || t[15] !== D || t[16] !== E
    ? ((Ve = { queryKey: E, enabled: Be, staleTime: te.FIVE_MINUTES, queryFn: D }),
      (t[14] = Be),
      (t[15] = D),
      (t[16] = E),
      (t[17] = Ve))
  ...
  t[20] === T
    ? (Ue = t[21])
    : ((Ue = T == null ? !1 : De(T.link_params_schema)), (t[20] = T), (t[21] = Ue));
  let We = Ue,
    j = l == null && !k && (w.isError || T == null || We || A === `UNSUPPORTED`),
    Ge;
    ...
    ? ((Je = (e) => {
        switch (e.kind) {
          ...
          case `browser-fallback`:
            ...
            return;
          case `failed`:
            (_ && v.get(ue).danger(n?.installUrl?.trim() ? p(y) : f(y)), we && x(!1));
            return;
        }
      }),
      (t[32] = n),
  ...
  let z;
  t[51] !== L || t[52] !== R
    ? ((z = { title: L, description: R }), (t[51] = L), (t[52] = R), (t[53] = z))
    : (z = t[53]);
  let B;
  t[54] === y
    ? (B = t[55])
  ...
  let H;
  t[58] !== B || t[59] !== V
    ? ((H = { title: B, description: V }), (t[58] = B), (t[59] = V), (t[60] = H))
    : (H = t[60]);
  let U;
  t[61] === y
    ? (U = t[62])
  ...
  let G;
  t[65] !== U || t[66] !== W
    ? ((G = { title: U, description: W }), (t[65] = U), (t[66] = W), (t[67] = G))
    : (G = t[67]);
  let Qe;
  ...
  let tt = et,
    ...
    rt =
      Pe?.connectorId === b ? Pe.enabled : O.data?.personalization_default === `PERSONALIZE_ALWAYS`,
  ...
  t[96] !== A ||
  t[97] !== j
    ? ((ut = l == null && !k && !g && !F && !j && A === `OAUTH` && !!n.installUrl?.trim()),
      (t[91] = n.installUrl),
      (t[92] = l),
      (t[93] = g),
      (t[94] = F),
  ...
  t[113] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((vt = (0, h.jsxs)(`span`, {
        ...
        children: [
          (0, h.jsx)(`span`, { className: `size-1.5 rounded-full bg-token-border-default` }),
          (0, h.jsx)(`span`, { className: `size-1.5 rounded-full bg-token-border-default` }),
          (0, h.jsx)(`span`, { className: `size-1.5 rounded-full bg-token-border-default` }),
        ],
      })),
  ...
  t[117] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xt = (0, h.jsx)(ve, { className: `icon-sm text-token-text-secondary` })), (t[117] = xt))
    : (xt = t[117]);
  let q;
  ...
  t[140] === ft
    ? (Tt = t[141])
    : ((Tt = ft ? (0, h.jsx)(ye, { className: `icon-xs` }) : null), (t[140] = ft), (t[141] = Tt));
  let Et;
  t[142] !== gt || t[143] !== Tt
    ? ((Et = (0, h.jsxs)(`span`, { className: `flex items-center gap-1`, children: [gt, Tt] })),
      (t[142] = gt),
      (t[143] = Tt),
      (t[144] = Et))
    : (Et = t[144]);
  ...
  let kt;
  t[154] !== Dt || t[155] !== Ot
    ? ((kt = (0, h.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [Dt, Ot] })),
      (t[154] = Dt),
      (t[155] = Ot),
      (t[156] = kt))
    : (kt = t[156]);
  ...
  t[157] !== k || t[158] !== j
    ...
    : (At = t[159]);
  let $;
  t[160] !== Z || t[161] !== Q || t[162] !== Ct || t[163] !== kt || t[164] !== At
    ? (($ = (0, h.jsxs)(he, { className: `gap-6 px-6 pt-8 pb-6`, children: [Z, Q, Ct, kt, At] })),
      (t[160] = Z),
      (t[161] = Q),
      (t[162] = Ct),
      (t[163] = kt),
  ...
  return (
    t[166] !== x || t[167] !== Ie || t[168] !== $
      ? ((jt = (0, h.jsx)(me, { open: Ie, onOpenChange: x, size: `wide`, children: $ })),
        (t[166] = x),
        (t[167] = Ie),
        (t[168] = $),
        (t[169] = jt))
