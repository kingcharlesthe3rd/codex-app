...
function xe() {
  ...
  e[0] === n
    ? (c = e[1])
    : ((c = () => {
        n != null && a.dispatchMessage(`global-dictation-close`, { sessionId: n });
      }),
      (e[0] = n),
      (e[1] = c));
  let ee = c,
  ...
  e[4] === ne
    ? (d = e[5])
    : ((d = S(`flex items-center justify-center`, ne)), (e[4] = ne), (e[5] = d));
  let f;
  e[6] === t
    ? (f = e[7])
    : ((f = (0, I.jsx)(_e, {
...
function M(e) {
  a.dispatchMessage(`global-dictation-pointer-interaction-changed`, { isInteractive: e });
}
function N() {
  let e = (0, P.c)(94),
    t = ce(),
  ...
  e[32] === Fe
    ? (z = e[33])
    : ((z = S(`group flex items-end justify-center`, Fe)), (e[32] = Fe), (e[33] = z));
  let B;
  e[34] !== t || e[35] !== h
    ? ((B =
        h === `initializing`
  ...
  let Ie = h === `error` ? `draggable` : `no-drag`,
    ...
    Ve = h !== `initializing` && h !== `idle` && `border-token-border-default/80`,
    He =
  ...
  e[48] === h
    ...
    : ((U =
      ...
      (e[49] = U));
  let W;
  e[50] !== y || e[51] !== _ || e[52] !== O || e[53] !== ye || e[54] !== t || e[55] !== h
    ? ((W =
        h === `error`
          ? (0, I.jsxs)(I.Fragment, {
              children: [
...
function we(e) {
  ...
  return (
    t[3] !== n || t[4] !== a
      ? ((o = (0, I.jsx)(oe, { items: a, children: n })), (t[3] = n), (t[4] = a), (t[5] = o))
      : (o = t[5]),
    o
  );
}
function Te(e) {
  ...
  if (n != null && r != null) {
    ...
    t[6] === a
      ? (o = t[7])
      : ((o = (0, I.jsx)(y, { keysLabel: a }, `toggle`)), (t[6] = a), (t[7] = o));
    let s;
    return (
      t[8] !== i || t[9] !== o
        ? ((s = (0, I.jsx)(x, {
...
//# sourceMappingURL=global-dictation-page-C.js.map
