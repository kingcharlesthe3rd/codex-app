...
import { Bt as f } from "./use-host-config.js";
import { A as p, Hi as m } from "./thread-context-inputs.js";
import { f as h, h as g } from "./vscode-api.js";
import { t as _ } from "./isEqual.js";
import {
  Aa as v,
  Gi as y,
  Gt as b,
...
import { t as ne } from "./react-dom.js";
import { i as z, l as re, s as B } from "./lib-1.js";
import { a as ie } from "./persisted-atom-store.js";
import { t as ae } from "./clsx.js";
import { ct as oe, i as se } from "./app-shell-state.js";
import { t as ce } from "./app-shell-0b-x_r3Z.js";
import { t as V } from "./button-oF-qgtAS.js";
import { t as H } from "./check-md.js";
import { t as le } from "./use-stable-callback.js";
import { t as ue } from "./tooltip-B.js";
import { o as de } from "./statsig.js";
import { t as fe } from "./chevron.js";
import { m as pe } from "./chunk-13.js";
import { d as me, f as U, h as he } from "./persisted-signal.js";
import "./config-queries.js";
import { d as W, f as ge, g as G, h as _e, l as ve, p as ye } from "./mcp-capability-signals.js";
import { j as be } from "./composer-view-state.js";
import { t as xe } from "./apps.js";
import { n as Se } from "./projectless-thread.js";
import { t as Ce } from "./connector-logo.js";
import { r as we } from "./app-shell-tab-controller.js";
import { d as Te, i as Ee, l as De, n as Oe, r as ke, u as Ae } from "./dialog-layout.js";
import { f as je } from "./sidebar-project-group-signals.js";
import { t as Me } from "./build-worktree-label-from-input.js";
import { t as Ne } from "./read-service-tier-for-request.js";
import { i as Pe } from "./pending-worktree-store.js";
import { t as Fe } from "./checkbox.js";
import { r as Ie, t as Le } from "./dropdown.js";
import { t as Re } from "./macbook.js";
import { t as ze } from "./worktree.js";
import { t as Be } from "./alert-1.js";
import { t as Ve } from "./queued-follow-ups-store.js";
import { n as He, t as Ue } from "./project-dropdown-options.js";
import { n as We, t as Ge } from "./mcp-capability-client-bEM-4Syx.js";
import { n as Ke, t as qe } from "./thread-right-panel-state.js";
import { t as Je } from "./back-forward-navigation-buttons-Cz-GufWg.js";
import {
  a as Ye,
  c as Xe,
  i as Ze,
...
function at(
  ...
  (we.openTab(e, it, {
    icon:
      n == null
        ? (0, J.createElement)(xe, { className: `icon-xs shrink-0 text-token-text-secondary` })
        : (0, J.createElement)(Ce, {
            alt: n.alt,
            className: `icon-xs shrink-0 object-contain`,
            logoUrl: n.logoUrl,
            logoDarkUrl: n.logoDarkUrl,
            fallback: (0, J.createElement)(xe, {
...
function ot(e, t) {
  let n = st(t);
  e.get(we.tabs$).some((e) => e.tabId === n) &&
    (we.closeTab(e, n), e.get(we.tabs$).length === 0 && qe(e));
}
function st(e) {
  return `${me.MCP_APP}:${e}`;
}
var ct = e(_(), 1),
  lt = { intrinsicHeight: null, isFullScreen: !1, isInlineExpanded: !1, sandboxError: null },
  ut = o(U, () => new Map()),
  dt = o(U, () => new Map()),
  ft = o(U, () => new Set()),
  pt = a(U, ({ get: e }) => {
  ...
  mt = s(U, (e, { get: t }) => t(ut).get(e) ?? null),
  ht = s(U, (e, { get: t }) => t(dt).get(e) ?? lt),
  gt = s(U, (e, { get: t }) => t(ft).has(e));
function _t(e) {
  return e;
}
function vt(e, t, n) {
...
function xt(e, t) {
  ...
  (e.set(ut, (r) => {
    let i = e.get(dt),
      ...
      c = r;
    (a == null || !(0, ct.default)(a, s)) && ((c = new Map(r)), c.set(t.mcpAppId, s));
    let l = Et({
      activeSidePanelTabId: e.get(we.activeTab$)?.tabId ?? null,
      frameStates: i,
      registration: t,
      registrations: c,
    });
...
function St(e, t, n) {
  ...
  for (let r of n.values())
    if (
      ...
      Ot(r.sidePanelFrameContent ?? r.inlineFrameContent, t)
    )
      return r.mcpAppId;
  return t.mcpAppId;
}
function Ct(e, t, n) {
  (n.isFullScreen === !0 && Tt(e, t),
    e.set(dt, (e) => {
      let r = e.get(t) ?? lt,
        i = { ...r, ...n };
      if (
...
function Et({ activeSidePanelTabId: e, frameStates: t, registration: n, registrations: r }) {
  for (let i of r.values())
    if (
      e === st(i.mcpAppId) &&
      t.get(i.mcpAppId)?.isFullScreen === !0 &&
      Ot(i.sidePanelFrameContent ?? i.inlineFrameContent, n)
    )
      return i;
  return null;
}
function Dt({ hostedInThreadScrollLayout: e, inlineFrameContainer: t, mcpAppId: n, ...r }) {
  return r;
}
function Ot(e, t) {
  return (
    ...
    e.server === t.server &&
    (0, ct.default)(e.mcpAppScope, t.mcpAppScope) &&
    kt(e.sandboxOriginScope, t.sandboxOriginScope)
  );
}
function kt(e, t) {
...
function jt({ server: e, tool: t }) {
  return Y(e) ? tt(t) : null;
}
function Mt({ mcpAppScope: e, server: t, tools: n }) {
  return Y(t) ? tt(n.find((t) => t.name === e.originTool) ?? null) : null;
}
function Nt({ connectorId: e, server: t, toolName: n, tools: r }) {
  let i = Lt({ server: t, toolName: n, tools: r });
  if ((Rt({ connectorId: e, server: t, tool: i, toolName: n }), zt(i)))
    throw Error(`MCP app cannot call tools that accept file parameters: ${i?.name ?? n}`);
  return { name: i?.name ?? n, tool: i };
}
function Pt({ connectorId: e, server: t, tools: n }) {
  let r = Y(t) ? n.filter((t) => tt(t) === e) : n;
  if (Y(t) && e == null) throw Error(`MCP app requests require a trusted connector scope`);
  return r.filter((e) => !zt(e));
}
...
function It({ connectorId: e, instanceFallbackId: t, server: n }) {
  return Y(n)
    ? { connectorId: e, instanceFallbackId: t, kind: `codex_app` }
    : { kind: `mcp_server`, server: n };
}
function Lt({ server: e, toolName: t, tools: n }) {
  let r = n.find((e) => e.name === t) ?? null;
  return r != null || !Y(e) ? r : (n.find((e) => e.title === t) ?? null);
}
function Rt({ connectorId: e, server: t, tool: n, toolName: r }) {
  if (!Y(t)) return;
  let i = tt(n);
...
var Bt = -32602,
  Vt = D({ prompt: v().trim().min(1) }).strip();
function Ht(e) {
  let t = Vt.safeParse(e);
  if (!t.success) throw Object.assign(Error(`Invalid follow-up message`), { code: Bt });
  return t.data;
}
function Ut(e) {
  let t = (0, K.c)(2),
  ...
  let r;
  return (t[0] === n ? (r = t[1]) : ((r = (0, q.jsx)(Wt, { ...n })), (t[0] = n), (t[1] = r)), r);
}
function Wt(e) {
  let t = (0, K.c)(35),
    { canConfirm: n, footerLeadingContent: r, onCancel: i, onConfirm: a, prompt: o } = e,
    s = n === void 0 ? !0 : n,
    c = re(),
    [l, u] = (0, J.useState)(o),
    d;
  ...
  t[4] !== s || t[5] !== a || t[6] !== f
    ? ((m = (e) => {
        (e.preventDefault(), !(!s || f.length === 0) && a(f));
      }),
      (t[4] = s),
      (t[5] = a),
      (t[6] = f),
  ...
  t[16] === r
    ? (b = t[17])
    : ((b = r ?? (0, q.jsx)(`div`, { className: `flex-1` })), (t[16] = r), (t[17] = b));
  let x;
  ...
  t[22] === C
    ? (T = t[23])
    : ((T = (0, q.jsx)(V, { disabled: C, type: `submit`, children: w })), (t[22] = C), (t[23] = T));
  let E;
  t[24] !== b || t[25] !== S || t[26] !== T
    ? ((E = (0, q.jsxs)(ke, { className: `justify-start gap-2`, children: [b, S, T] })),
      (t[24] = b),
      (t[25] = S),
      (t[26] = T),
      (t[27] = E))
    : (E = t[27]);
  let D;
  t[28] !== E || t[29] !== m || t[30] !== y
    ? ((D = (0, q.jsxs)(Oe, { className: `gap-4`, as: `form`, onSubmit: m, children: [g, y, E] })),
      (t[28] = E),
      (t[29] = m),
      (t[30] = y),
      (t[31] = D))
  ...
  return (
    t[32] !== D || t[33] !== p
      ? ((O = (0, q.jsx)(De, { open: !0, onOpenChange: p, size: `wide`, children: D })),
        (t[32] = D),
        (t[33] = p),
        (t[34] = O))
      : (O = t[34]),
...
function qt(e) {
  ...
  let r;
  return (
    t[0] === n ? (r = t[1]) : ((r = (0, q.jsx)(Jt, { confirmation: n })), (t[0] = n), (t[1] = r)), r
  );
}
function Jt(e) {
  let t = (0, K.c)(3),
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, q.jsx)(Yt, { confirmation: n, supportsWorktrees: !0, workspaceGroups: r })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function Yt(e) {
  let t = (0, K.c)(40),
    ...
    { onCancel: a, onConfirmCurrentThread: o, onConfirmNewThread: s, prompt: c } = n,
    l = re(),
    u = (0, J.useId)(),
    [d, f] = (0, J.useState)(!1),
    ...
    v,
    y;
  if (t[0] !== p || t[1] !== h || t[2] !== i) {
    let e = A(`~`);
    ((v = Ue({ workspaceGroups: i, roots: [], formatRootLabel: Qt })),
      (y = Ue({ workspaceGroups: i?.filter(Zt), roots: [], formatRootLabel: Xt })));
    let n = h === e ? e : (v.find((e) => e.value === h)?.value ?? e),
      r = y.find((e) => e.value === h)?.value ?? y[0]?.value ?? null;
    ((_ = null),
      p === `local` ? (_ = A(n)) : r != null && (_ = A(r)),
      (t[0] = p),
      (t[1] = h),
      (t[2] = i),
      (t[3] = _),
      (t[4] = v),
      (t[5] = y));
  } else ((_ = t[3]), (v = t[4]), (y = t[5]));
  let b = r && y.length > 0,
    x = !d || (_ != null && (p === `local` || b)),
    S;
  t[6] !== u || t[7] !== d
    ? ((S = (0, q.jsx)(Fe, { id: u, checked: d, onCheckedChange: f })),
      (t[6] = u),
      (t[7] = d),
      (t[8] = S))
    : (S = t[8]);
  ...
  t[22] !== y
    ? ((E = d
        ? (0, q.jsxs)(`div`, {
            ...
            children: [
              (0, q.jsx)($t, { canCreateWorktree: b, mode: p, supportsWorktrees: r, onChange: m }),
              (0, q.jsx)(`span`, {
              ...
              (0, q.jsx)(He, {
                ...
                selectedRoots: _ == null ? Kt : [_],
                options: p === `worktree` ? y : v,
                ...
                localOnlyTooltip: l.formatMessage({
  ...
  t[24] !== T || t[25] !== E
    ...
    : (D = t[26]);
  let O;
  t[27] !== x || t[28] !== d || t[29] !== p || t[30] !== o || t[31] !== s || t[32] !== _
    ? ((O = (e) => {
        if (!d) {
          o(e);
          return;
        }
        _ == null || !x || s({ executionMode: p, prompt: e, projectRoot: _, type: `new-thread` });
      }),
      (t[27] = x),
      (t[28] = d),
      (t[29] = p),
  ...
  let k;
  return (
    t[34] !== x || t[35] !== a || t[36] !== c || t[37] !== D || t[38] !== O
      ? ((k = (0, q.jsx)(Ut, {
          confirmation: {
            canConfirm: x,
            footerLeadingContent: D,
            onCancel: a,
            onConfirm: O,
            prompt: c,
          },
...
function $t(e) {
  ...
  t[3] === s
    ? (u = t[4])
    : ((u = (0, q.jsx)(s, { className: `icon-2xs shrink-0` })), (t[3] = s), (t[4] = u));
  let d;
  t[5] === r
    ? (d = t[6])
    : ((d = (0, q.jsx)(`span`, {
        ...
        children:
          r === `worktree`
            ? (0, q.jsx)(B, { ...en.newWorktree })
            : (0, q.jsx)(B, { ...en.workLocally }),
      })),
      (t[5] = r),
      (t[6] = d));
  let f;
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)(B, { ...en.workLocally })), (t[13] = g))
    : (g = t[13]);
  let _;
  t[14] !== m || t[15] !== h
    ? ((_ = (0, q.jsx)(Ie.Item, { LeftIcon: Re, RightIcon: m, onSelect: h, children: g })),
      (t[14] = m),
      (t[15] = h),
      (t[16] = _))
    : (_ = t[16]);
  let v = r === `worktree` ? H : void 0,
    y = !n,
    b = n ? void 0 : l,
    x;
  t[17] === a
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, q.jsx)(B, { ...en.newWorktree })), (t[19] = S))
    : (S = t[19]);
  let C;
  ...
  return (
    t[25] !== C || t[26] !== p || t[27] !== _
      ? ((w = (0, q.jsxs)(Le, { contentWidth: `menuNarrow`, triggerButton: p, children: [_, C] })),
        (t[25] = C),
        (t[26] = p),
        (t[27] = _),
        (t[28] = w))
...
var an = 240,
  ...
  sn = 720;
function cn(e, t, n) {
  let r = e == null ? (t ?? an) : Math.max(e, t ?? 0);
  return Math.min(Math.max(r, n ?? on), sn);
}
function ln(e, t) {
  return cn(null, e, t);
}
var un = `CALL`,
  dn = `GENERATOR_GENERATE`,
  fn = `REJECT`,
  pn = `RESOLVE`,
  mn = 1e4,
  hn = 3e4,
  gn = x,
  _n = D({ status: R(2), type: R(`environment_status`) }).passthrough(),
  vn = D({ href: w({ protocol: /^https$/ }) });
async function yn({
  hostApiHandlers: e,
  origin: t,
  sandboxId: n,
  ...
  let o = crypto.randomUUID(),
    { ports: s, replyPort: c } = await new Promise((e, s) => {
      ...
      let c,
        ...
        u = (r) => {
          ...
          if (
            ...
            return;
          let a = i.portNames;
          if (!I(a) || r.ports.length !== a.length + 1) return;
          let s = bn(a, r.ports);
          if (s == null) return;
      ...
      let f = O({ initId: o, sourceUrl: i });
      a.getAttribute(`src`) !== f && a.setAttribute(`src`, f);
    }),
    l = wn(e);
  return (c.postMessage(l, Object.values(l)), c.start(), Cn(s, r));
}
function bn(e, t) {
  let n = {};
  for (let r of gn) {
...
function Sn(e) {
  return xn(e) ? typeof e.postMessage == `function` && typeof e.start == `function` : !1;
}
function Cn(e, t) {
  return {
    ...
    runWidgetCode: kn(e.runWidgetCode, t),
...
function X(e) {
  ...
  return (
    (t.onmessage = async (t) => {
      ...
      if (!(n !== un || i == null))
        try {
          i.postMessage([pn, await e(...r)]);
        } catch (e) {
          i.postMessage([fn, Tn(e)]);
        } finally {
          i.close();
        }
    }),
...
function Tn(e) {
  return e instanceof Error
    ? { ...En(e), message: e.message || `MCP sandbox host call failed.`, name: e.name }
    : typeof e == `object` &&
        e &&
        `message` in e &&
        typeof e.message == `string` &&
        e.message.length > 0
      ? { ...En(e), message: e.message }
...
function Z(e, t = {}) {
  return (
    ...
    (n) =>
      new Promise((r, i) => {
        let a = t.signal,
          o = t.timeoutMs === void 0 ? hn : t.timeoutMs;
        if (a?.aborted) {
          i(Dn());
          return;
        }
  ...
  return (
    ...
    async function* (n) {
      let { port1: r, port2: i } = new MessageChannel(),
        ...
        p = Z(s),
        m = Z(l);
      e.postMessage([dn, { asyncDispose: i, next: o, return: c, throw: u }, n], [i, o, c, u]);
      try {
...
var An = e(ne(), 1),
  ...
  Mn = M(),
  Nn = T(v(), C()),
  Pn = D({ text: v(), type: R(`text`) }).strip(),
  Fn = D({ data: v(), mimeType: v(), type: R(`image`) }).strip(),
  In = D({ type: P([`audio`, `image`, `resource`, `resource_link`, `text`]) }).passthrough(),
  Ln = v(),
  Rn = D({ mode: P([`inline`, `fullscreen`]) }),
  zn = D({ canGoBack: N(), canGoForward: N() }).passthrough(),
  Bn = D({ method: v(), params: T(v(), C()).optional() }).strip(),
  Vn = D({ blob: te(Blob), name: v().trim().min(1) }).strip(),
  Hn = E({ [ge]: _e.optional(), progressToken: W.optional() }),
  Un = D({
    name: v().min(1),
    arguments: T(v(), Mn).optional(),
    _meta: Hn.optional(),
  }).passthrough(),
  Wn = D({ uri: v().min(1) }).passthrough(),
  Gn = D({ code: L().optional(), message: v().min(1) }).passthrough(),
  Kn = L().finite().positive(),
  qn = T(v(), Mn),
  Jn = D({
    composerAttachmentLayout: P(k).optional(),
    composerLabel: v().optional(),
    showInComposer: N().optional(),
  }).strip(),
  Yn = D({ content: F(C()).optional(), presentation: Jn.optional() }).passthrough(),
  Xn = D({
    content: F(In),
    presentation: Jn.optional(),
    structuredContent: Nn.optional(),
  }).strict(),
  Zn = { insets: { bottom: 0, left: 0, right: 0, top: 0 } },
  Qn = { insets: { ...Zn.insets, top: 48 } },
  $n = { canGoBack: !1, canGoForward: !1 },
  er = [];
function tr(e) {
  let t = (0, K.c)(5),
  ...
  let t = (0, K.c)(39),
    {
      ...
      mcpAppScope: p,
      mcpServerStatuses: m,
      overrideMcpRequest: h,
      prefersBorder: g,
      sandboxOriginScope: _,
      server: v,
      sidePanelIcon: y,
      sidePanelTitle: b,
      title: x,
    ...
    k = u(we.tabs$),
    A;
  t[0] === l ? (A = t[1]) : ((A = l == null ? 0 : new Blob([l]).size), (t[0] = l), (t[1] = A));
  let j = A,
    M,
    N;
  t[2] !== n ||
  ...
  return (
    ...
    t[36] !== w
      ? ((F = () => {
        ...
        (ee = [n, r, i, T, o, s, P, l, j, d, f, M, p, m, h, g, _, E, v, y, b, x, S, C, w]),
        (t[12] = n),
        (t[13] = r),
        (t[14] = i),
        (t[15] = T),
...
function rr(e) {
  let t = (0, K.c)(36),
    ...
    f = r === void 0 ? !1 : r,
    p = s === void 0 ? `standalone` : s,
    m = c(U),
    h = re(),
    g = i(mt, u),
    _ = i(ht, u),
    [v, y] = (0, J.useState)(null),
    b = o == null ? 0 : new Blob([o]).size,
    x = g != null,
    S;
  t[0] !== _.intrinsicHeight || t[1] !== a || t[2] !== d
    ? ((S = cn(_.intrinsicHeight, a, d)),
      (t[0] = _.intrinsicHeight),
      (t[1] = a),
      (t[2] = d),
      (t[3] = S))
    : (S = t[3]);
  ...
  if (l) {
    ...
    t[11] === h
      ...
      : ((e = h.formatMessage({
        ...
        (t[11] = h),
        (t[12] = e));
    let n = f ? `h-full border-t` : p === `standalone` && `rounded-lg border`,
      r;
    t[13] === n
      ? (r = t[14])
      : ((r = ae(`mcp-app-loading-pulse w-full overflow-hidden border-token-border-light`, n)),
        (t[13] = n),
        (t[14] = r));
    let i;
    t[15] !== f || t[16] !== a || t[17] !== d
      ? ((i = f ? `100%` : ln(a, d)), (t[15] = f), (t[16] = a), (t[17] = d), (t[18] = i))
      : (i = t[18]);
    let o;
  ...
  let D = f && `h-full`,
    O;
  t[28] === D ? (O = t[29]) : ((O = ae(`w-full overflow-hidden`, D)), (t[28] = D), (t[29] = O));
  let k = _.isFullScreen ? 0 : f ? `100%` : C,
    A;
  t[30] === k ? (A = t[31]) : ((A = { height: k }), (t[30] = k), (t[31] = A));
  let j;
  return (
    t[32] !== p || t[33] !== O || t[34] !== A
      ? ((j = (0, q.jsx)(`div`, {
          ref: y,
          "data-mcp-app-expanded": `true`,
          "data-mcp-app-inline-surface": p,
          className: O,
          style: A,
        })),
        (t[32] = p),
...
function ir(e) {
  ...
  return (
    t[7] === o
      ? (s = t[8])
      : ((s = (0, q.jsx)(q.Fragment, { children: o.map(ar) })), (t[7] = o), (t[8] = s)),
    s
  );
}
function ar(e) {
  return (0, q.jsx)(or, { mcpAppId: e }, e);
}
function or(e) {
  let t = (0, K.c)(5),
    { mcpAppId: n } = e,
    ...
    a = i(ht, n),
    o = i(gt, n);
  if (r == null || (!a.isInlineExpanded && !a.isFullScreen && !o)) return null;
  let s =
      a.isFullScreen || (!a.isInlineExpanded && r.inlineFrameContainer?.isConnected !== !0 && o)
        ? (r.sidePanelFrameContent ?? r.inlineFrameContent)
        : r.inlineFrameContent,
    c;
  return (
    t[0] !== s || t[1] !== a || t[2] !== r.inlineFrameContainer || t[3] !== r.mcpAppId
      ? ((c = (0, q.jsx)(cr, {
          ...s,
...
function sr(e) {
  let t = (0, K.c)(8),
    { conversationId: n, onCancel: r, onConfirm: i, prompt: a } = e,
    { enqueue: o } = Ve(n).actions,
    s;
  t[0] !== o || t[1] !== i
    ? ((s = (e) => {
        i({ enqueue: o, prompt: e, type: `current-thread` });
      }),
      (t[0] = o),
      (t[1] = i),
      (t[2] = s))
  ...
  let c;
  return (
    t[3] !== r || t[4] !== i || t[5] !== a || t[6] !== s
      ? ((c = (0, q.jsx)(qt, {
          confirmation: {
            onCancel: r,
            onConfirmCurrentThread: s,
...
function cr({
  ...
  let D = c(U),
    ...
    k = pe(),
    A = be(e),
    { createPendingWorktree: j } = Pe(),
    M = u(we.activeTab$),
    N = u(se),
    { rightPanelLayoutTick: P } = oe(),
    F = u(tn),
    { isFullScreen: I } = E,
    te = (0, J.useRef)(!1),
    L = (0, J.useRef)(null),
    [R, ne] = (0, J.useState)(null),
    [z, ie] = (0, J.useState)(null),
    [H, le] = (0, J.useState)(!1),
    [de, fe] = (0, J.useState)(null),
    [me, he] = (0, J.useState)(null),
    [W, ge] = (0, J.useState)(null),
    [G, _e] = (0, J.useState)($n),
    [ve, ye] = (0, J.useState)(null),
    [xe, Se] = (0, J.useState)(!1),
    [Ce, Te] = (0, J.useState)(null),
    [Ee, De] = (0, J.useState)(null),
    Oe = (0, J.useMemo)(() => _r(C), [C]),
    ke = (0, J.useMemo)(() => vr(w), [w]),
    Ae = (0, J.useMemo)(() => Xe({ toolResult: w }), [w]),
    ...
    Me = Ye({ locale: O.locale, originScope: m, widgetDomain: T }),
    Ne = (0, J.useMemo)(() => Ze({ originScope: m, sourceUrl: Me }), [Me, m]),
    Fe = (0, J.useEffectEvent)(() => {
      let e = S(Me);
      return e == null
        ? null
        : { csp: t, html: i, locale: O.locale, sandboxOrigin: e, sourceUrl: Me };
    }),
    Ie = de?.isConnected === !0 ? de : null,
    Le = a?.isConnected === !0 ? a : null,
    Re = !I && !n && a?.dataset.mcpAppInlineSurface === `card`,
    ze = R?.parentElement,
    Be =
      Le?.closest(`[data-mcp-app-portal-target='true']`) ??
      (ze instanceof HTMLElement && ze.dataset.mcpAppPortalTarget === `true`
        ? ze
    ...
    He = (0, J.useEffectEvent)(() => {
      Ct(D, o, { sandboxError: Error(`The MCP app sandbox failed to load.`) });
    }),
    Ue = (0, J.useEffectEvent)((e) => {
      let t = Kn.safeParse(e);
      t.success && Ct(D, o, { intrinsicHeight: t.data });
    }),
    We = (0, J.useEffectEvent)((e) => {
      Kn.safeParse(e);
    }),
    Ge = (0, J.useEffectEvent)((e) => {
      let t = zn.safeParse(e);
      t.success && _e({ canGoBack: t.data.canGoBack, canGoForward: t.data.canGoForward });
    }),
    Ke = (0, J.useEffectEvent)((e) => {
      let t = vn.safeParse(e);
      t.success &&
        h.dispatchMessage(`open-in-browser`, {
    ...
    qe = (0, J.useEffectEvent)((e) => {
      ...
      if (t.success) {
        let e = t.data.mode === `fullscreen`,
          n = t.data.mode;
        return (
          e && (R != null && (R.style.display = `none`), bt(D, o)),
          Ct(D, o, { isFullScreen: e }),
          W != null &&
            ve != null &&
            (Q(W.setWidgetView({ displayMode: n, isTombstone: !1, viewParams: ke, widgetId: ve })),
            R != null &&
              Q(
                W.notifyMcpAppsHostContext({
                  hostContext: kr({
                    containerDimensions: jr(R),
                    displayMode: n,
                    locale: O.locale,
                    safeAreaInsets: Ar({
                      displayMode: n,
      ...
      return { mode: I ? `fullscreen` : `inline` };
    }),
    Je = (0, J.useEffectEvent)(() => (I ? `fullscreen` : `inline`)),
    $e = (0, J.useEffectEvent)(() => Ce),
    et = (e) => {
      let t = hr(e.content),
        n = gr(e.content),
    ...
    tt = (0, J.useEffectEvent)((e, t) => {
      let n = qn.safeParse(t);
      Te(n.success ? n.data : null);
      let r = Xn.safeParse(t);
      r.success && et(r.data);
    }),
    nt = (0, J.useEffectEvent)((e) => {
      W != null && Q(W.navigate({ delta: e }));
    }),
    rt = (0, J.useEffectEvent)(async (t) => {
      let { prompt: n } = Ht(t);
      if (Ee != null) throw $(`A follow-up message is already awaiting confirmation`, jn);
      let i = await new Promise((e, t) => {
        De({ prompt: n, reject: t, resolve: e });
      });
      switch (i.type) {
        case `current-thread`: {
          let t = D.get(p, e);
        ...
        case `new-thread`:
          if (i.executionMode === `worktree`) {
            await k(
              `/worktree-init-v2/${await fr({ createPendingWorktree: j, hostId: r, prompt: i.prompt, projectRoot: i.projectRoot, scope: D })}`,
            );
            return;
          }
          await k(
            ee(await dr({ hostId: r, prompt: i.prompt, projectRoot: i.projectRoot, scope: D })),
          );
          return;
      }
    }),
    K = async (e, t) => (f == null ? t() : f(e)),
    it = (t) =>
      K({ method: `tools/call`, params: t }, () =>
        br({
          conversationId: e,
          hostId: r,
          mcpAppScope: s,
    ...
    lt = (0, J.useEffectEvent)(async (e, t) => {
      let n = Un.safeParse({ arguments: t, name: e });
      if (!n.success) throw $(`Invalid MCP tool call params`, -32602);
      return it(n.data);
    }),
    ut = (0, J.useEffectEvent)(async (t) => {
      let n = Bn.safeParse(t);
      ...
      switch (i) {
        ...
        case `tools/call`: {
          let e = Un.safeParse(a);
          if (!e.success) throw $(`Invalid MCP tool call params`, -32602);
          return it(e.data);
        }
        case `resources/read`: {
          let t = Wn.safeParse(a);
          if (!t.success) throw $(`Invalid MCP resource read params`, -32602);
          return K({ method: i, params: t.data }, async () => {
            Tr(() => {
              Ft({ mcpAppScope: s, server: _, uri: t.data.uri });
            });
            try {
              return await xr({ hostId: r, threadId: e, server: _, uri: t.data.uri });
            } catch (e) {
        ...
        case `tools/list`:
          return K(n.data, async () => {
            let e = wr(await yr({ hostId: r, mcpServerStatuses: Y(_) ? l : void 0, server: _ })),
              t = Mt({ mcpAppScope: s, server: _, tools: e });
            return { tools: Tr(() => Pt({ connectorId: t, server: _, tools: e })) };
          });
        case `resources/list`:
          return K(n.data, async () =>
            Y(_)
              ? { resources: [] }
              : { resources: (await yr({ hostId: r, server: _ })).resources },
          );
        case `resources/templates/list`:
          return K(n.data, async () =>
            Y(_)
              ? { resourceTemplates: [] }
              : { resourceTemplates: (await yr({ hostId: r, server: _ })).resourceTemplates },
          );
        case `prompts/list`:
          return K(n.data, async () => ({ prompts: [] }));
        default:
          return K(n.data, async () => {
  ...
  ((0, J.useLayoutEffect)(() => {
    ...
    return (
      t.setAttribute(`partition`, b(Ne)),
      ne(e),
      ie(t),
      () => {
        (e.remove(), ne((t) => (t === e ? null : t)), ie((e) => (e === t ? null : e)), le(!1));
      }
    );
  }, [o, Me, Ne]),
    (0, J.useLayoutEffect)(() => {
      R == null ||
        ...
        ((R.className = ae(
          ...
          !I && (n ? `border-t border-token-border-light` : !Re && `rounded-lg border shadow-sm`),
          !I && !n && !Re && (d ? `border-token-border` : `border-token-border-light`),
        )),
        (z.className = ae(
        ...
        (z.style.backgroundColor = me ?? ``),
        (z.title = x));
    }, [me, n, R, Re, I, d, z, x]),
    (0, J.useLayoutEffect)(() => {
      if (R == null || z == null) return;
      let e = I ? Ie : Le;
      if (e == null || Be == null) {
        R.style.display = `none`;
        return;
      }
      (z.parentElement !== R && R.appendChild(z),
        R.parentElement !== Be && Be.appendChild(R),
        H || le(!0));
      let t = null,
        ...
        r = () => {
          let e = I ? R.offsetParent : null;
          e !== t &&
            (n.disconnect(),
            (t = e),
            e != null && n.observe(e, { attributeFilter: [`class`, `style`], attributes: !0 }));
        },
        i = () => {
          if (I && N.get() !== 1) {
            R.style.display = `none`;
      ...
      (s.observe(e), s.observe(Be));
      let c = P.on(`change`, o);
      return () => {
        (s.disconnect(), n.disconnect(), c(), a != null && window.cancelAnimationFrame(a));
      };
    }, [R, Le, I, H, N, P, z, Ie, Be]),
    (0, J.useLayoutEffect)(
      () => (
        (te.current = !1),
        () => {
  ...
  let dt = (0, J.useEffectEvent)((e) => {
      at(D, {
        activate: !D.get(we.tabs$).some((e) => e.tabId === st(o)),
        icon: v,
        mcpAppId: o,
        onExitFullScreen: e,
        onPanelElementChange: fe,
        title: y,
      });
    }),
    ft = (0, J.useEffectEvent)(() => {
      te.current || (bt(D, o), Ct(D, o, { isFullScreen: !1 }));
    });
  ((0, J.useLayoutEffect)(() => {
    if (I) {
      dt(ft);
    ...
    ot(D, o);
  }, [I, o, D, v?.alt, v?.logoDarkUrl, v?.logoUrl, y]),
    (0, J.useLayoutEffect)(() => {
      if (z == null || R == null || !H) return;
      (Ct(D, o, { sandboxError: null }), Se(!1), _e($n), (L.current = null));
      let e = Fe();
      if (e == null) {
        (g.warning(`mcp_app_sandbox.init_config_missing`, { safe: {}, sensitive: { mcpAppId: o } }),
          Ct(D, o, { sandboxError: Error(`The MCP app sandbox failed to load.`) }));
        return;
      }
      let t = new AbortController(),
        ...
        r = crypto.randomUUID(),
        i = $e(),
        { toolInput: a, toolOutput: s, toolResponseMetadata: c } = je();
      return (
        yn({
          hostApiHandlers: {
            callMcp: ut,
            callTool: lt,
            notifyBackgroundColor: Ve,
            notifyEnvironmentError: He,
            notifyIntrinsicHeight: Ue,
            notifyIntrinsicWidth: We,
            notifyNavigation: (e) => {
              t.signal.aborted || Ge(e);
            },
            notifySecurityPolicyViolation: () => {},
            openExternal: Ke,
            requestDisplayMode: qe,
            sendFollowUpMessage: rt,
            sendInstrument: () => {},
            updateWidgetState: tt,
          },
          ...
          .then(async (o) => {
            ...
            let l = Je(),
              ...
              p = kr({
                ...
                displayMode: l,
                locale: e.locale,
                safeAreaInsets: Zn.insets,
                styleVariables: D.get(tn),
                theme: u,
                userAgent: f,
              }),
              m = o.runWidgetCode({
            ...
            for await (let e of m) {
              ...
              h ||
                !_n.safeParse(e).success ||
                ((h = !0),
                Se(!0),
                Q(o.setWidgetView({ displayMode: l, isTombstone: !1, viewParams: s, widgetId: r })),
                Q(o.setTheme({ theme: u })),
                Q(o.setSafeArea({ safeArea: Zn })),
                Q(
          ...
          .catch((e) => {
            t.signal.aborted ||
              (g.warning(`mcp_app_sandbox.init_failed`, {
                safe: {
    ...
    (0, J.useEffect)(() => {
      if (!xe || W == null || ve == null) return;
      let e = {
        toolInput: Oe,
        toolOutput: ke,
        toolResponseMetadata: Ae,
        toolResult: { content: w.content, structuredContent: w.structuredContent ?? void 0 },
      };
      if ((0, ct.default)(L.current, e)) return;
      L.current = e;
      let t = $e();
      (Q(
        W.setWidgetData({
        ...
        Oe != null && Q(W.notifyMcpAppsToolInput({ arguments: Oe })),
        Q(
          W.notifyMcpAppsToolResult({
            content: w.content,
            ...(w.structuredContent == null ? {} : { structuredContent: w.structuredContent }),
            ...(Ae == null ? {} : { _meta: Ae }),
          }),
        ));
    }, [xe, W, Oe, ke, Ae, w, ve]),
    (0, J.useEffect)(() => {
      if (R == null || W == null || ve == null || (I && Ie == null)) return;
      let e = null,
        t = I ? `fullscreen` : `inline`,
        n = () => {
          let e = jr(R),
            n = Ar({ displayMode: t, hasNavigationHistory: G.canGoBack || G.canGoForward });
          (Q(
            ...
            Q(W.setWidgetView({ displayMode: t, isTombstone: !1, viewParams: ke, widgetId: ve })),
            Q(
              W.notifyMcpAppsHostContext({
                hostContext: kr({
    ...
    }, [R, O.locale, F, I, G.canGoBack, G.canGoForward, P, W, Ie, ke, ve]));
  let pt = (e) => {
      let t = Ee;
      t != null && (De(null), t.resolve(e));
    },
    mt = () => {
      let e = Ee;
      e != null && (De(null), e.reject($(`Follow-up message was not confirmed`, jn)));
    },
    ht = z?.tagName === `WEBVIEW`,
    gt = R != null && W != null && ht && Qe(),
    _t = G.canGoBack || G.canGoForward,
    vt = W != null && _t,
    yt = vt && !I,
    xt = vt && I && M?.tabId === st(o);
  return (0, q.jsxs)(q.Fragment, {
    children: [
      Ee == null
        ? null
        : (0, q.jsx)(sr, { conversationId: e, onCancel: mt, onConfirm: pt, prompt: Ee.prompt }),
      xt
        ? (0, q.jsx)(ce.RightPanelTabListBefore, {
            children: (0, q.jsx)(lr, {
            ...
            (0, q.jsx)(ue, {
              ...
              children: (0, q.jsx)(`div`, {
                ...
                children: (0, q.jsx)(V, {
                  ...
                  onClick: (e) => {
                    (e.stopPropagation(),
                      h.dispatchMessage(`open-mcp-app-sandbox-devtools`, { sandboxId: Ne }));
                  },
...
function lr(e) {
  ...
  let d = u,
    f;
  t[4] === i ? (f = t[5]) : ((f = ae(`flex items-center gap-px`, i)), (t[4] = i), (t[5] = f));
  let p;
  t[6] === a
    ? (p = t[7])
    : ((p = (e) => {
...
async function dr({ hostId: e, prompt: t, projectRoot: n, scope: r }) {
  let i = n === `~`,
    a = i
      ? await Se([`~`], { prompt: t })
      : { cwd: n, projectlessOutputDirectory: null, workspaceRoots: [n] };
  if (a.cwd == null) throw $(`Missing project root`, jn);
  if (i && a.projectlessOutputDirectory == null)
    throw $(`Missing projectless thread output directory`, jn);
  let { config: o } = await f(`read-config-for-host`, { hostId: e, includeLayers: !1, cwd: a.cwd }),
    s = y(ie(`agent-mode-by-host-id`, {})[e] ?? `auto`, a.workspaceRoots, o);
...
async function fr({ createPendingWorktree: e, hostId: t, prompt: n, projectRoot: r, scope: i }) {
  if (r === `~`) throw $(`Missing project root`, jn);
  let { config: a } = await f(`read-config-for-host`, { hostId: t, includeLayers: !1, cwd: r }),
    ...
    s = {
      ...
      fileAttachments: er,
      addedFiles: er,
      agentMode: ie(`agent-mode-by-host-id`, {})[t] ?? `auto`,
      shouldSendPermissionOverrides: !0,
      model: null,
      serviceTier: await Ne(i, t, null),
...
function Q(e) {
  Promise.resolve(e).catch((e) => {
    g.debug(`MCP sandbox RPC failed`, { safe: {}, sensitive: { error: e } });
  });
}
function pr({
  frameElement: e,
...
function vr(e) {
  let t = Nn.safeParse(e.structuredContent);
...
async function yr({ hostId: e, mcpServerStatuses: t, server: n }) {
  let r = t?.data.find(({ name: e }) => e === n) ?? null;
  if (r != null) return r;
  let i =
    (await f(`list-mcp-server-status`, { hostId: e, cursor: null, limit: 100 })).data.find(
      ({ name: e }) => e === n,
    ) ?? null;
  if (i == null) throw $(`MCP server not found: ${n}`, jn);
  return i;
}
async function br({
  conversationId: e,
...
async function xr({ hostId: e, server: t, threadId: n, uri: r }) {
  try {
    return await f(`read-mcp-resource`, { hostId: e, threadId: n, server: t, uri: r });
  } catch (i) {
    if (await Sr(e, n)) throw i;
    return f(`read-mcp-resource`, { hostId: e, server: t, uri: r });
  }
}
async function Sr(e, t) {
  try {
    let { thread: n } = await f(`send-cli-request-for-host`, {
      hostId: e,
      method: `thread/read`,
...
async function Cr({ hostId: e, mcpAppScope: t, mcpServerStatuses: n, server: r, toolName: i }) {
  let a = n?.data.find(({ name: e }) => e === r) ?? (await yr({ hostId: e, server: r })),
    o = wr(a),
    s = Mt({ mcpAppScope: t, server: r, tools: o });
  return { ...Tr(() => Nt({ connectorId: s, server: r, toolName: i, tools: o })), serverStatus: a };
}
function wr(e) {
...
function Or(e, t) {
  let n = Gn.safeParse(e);
  return n.success
    ? $(n.data.message, n.data.code ?? jn, e)
...
function Ar({ displayMode: e, hasNavigationHistory: t }) {
  return e === `inline` && t ? Qn : Zn;
}
function jr(e) {
...
function Nr() {
  return {
    ...
    device: { os: Pr(), platform: `native`, type: `desktop` },
  };
}
function Pr() {
...
var Fr = M(),
  ...
  zr = l(
    ...
    ({ threadId: e, view: t }, { scope: n }) => ({
      queryKey: [`mcp-capability-view-resource`, t.hostId, t.resourceUri, t.server, e, t.tool.name],
      queryFn: () => We(n, t.hostId, t.server, t.resourceUri, e),
      staleTime: 0,
    }),
    { key: Vr },
  ),
  Br = l(
    d,
    ({ toolArguments: e, threadId: t, view: n }, { scope: r }) => ({
      queryKey: [`mcp-capability-view-tool-result`, n.hostId, n.server, t, n.tool.name, e],
      queryFn: async () => Ge(r, n.hostId, n.server, n.tool.name, e, t),
      staleTime: 0,
    }),
    { key: Hr },
  );
function Vr({ threadId: e, view: t }) {
  return JSON.stringify([t.hostId, t.resourceUri, t.server, e, t.tool.name]);
}
function Hr({ threadId: e, toolArguments: t, view: n }) {
  return JSON.stringify([n.hostId, n.resourceUri, n.server, e, n.tool.name, t]);
}
var Ur = {};
function Wr(e) {
  let t = (0, K.c)(82),
    { className: n, instanceId: r, readHostResource: a, toolArguments: o, view: s } = e,
    l = o === void 0 ? Ur : o,
    u = c(d),
    f = c(U),
    p = f.value.routeKind === `local-thread` || f.value.routeKind === `remote-thread`,
    m;
  t[0] !== p || t[1] !== f.value
    ? ((m = p ? he(f.value) : null), (t[0] = p), (t[1] = f.value), (t[2] = m))
    : (m = t[2]);
  let h = m,
    g = h ?? void 0,
    _;
  t[3] !== g || t[4] !== s
    ? ((_ = { threadId: g, view: s }), (t[3] = g), (t[4] = s), (t[5] = _))
    : (_ = t[5]);
  let { data: v, error: y, isLoading: b } = i(zr, _),
    x = h ?? void 0,
    S;
  t[6] !== x || t[7] !== l || t[8] !== s
    ? ((S = { threadId: x, toolArguments: l, view: s }),
      (t[6] = x),
      (t[7] = l),
      (t[8] = s),
      (t[9] = S))
    : (S = t[9]);
  let { data: C, error: w, isLoading: T } = i(Br, S),
    E = et(v);
  de(`2957382457`);
  let D = $e({
      isDilEnabled: !1,
    ...
    O = D.kind === `html` ? D.renderData : null,
    k;
  t[10] !== s.server || t[11] !== s.tool
    ? ((k = jt({ server: s.server, tool: s.tool })),
      (t[10] = s.server),
      (t[11] = s.tool),
      (t[12] = k))
    : (k = t[12]);
  ...
  t[20] !== s.serverTools
    ? ((M = async (e) => {
        ...
        switch (t.method) {
          case `tools/call`: {
            let e = Lr.parse(t.params),
              n = Nt({ connectorId: A, server: s.server, toolName: e.name, tools: s.serverTools });
            return Ge(u, s.hostId, s.server, n.name, Ir.parse(e.arguments ?? {}), h ?? void 0);
          }
          case `resources/read`: {
            let e = Rr.parse(t.params),
              n = await a?.(e);
            return n == null
              ? (Ft({
                  mcpAppScope: { originResourceUri: s.resourceUri },
                  server: s.server,
                  uri: e.uri,
                }),
                We(u, s.hostId, s.server, e.uri, h ?? void 0))
              : { contents: [{ ...n, uri: e.uri }] };
          }
          case `tools/list`:
            return { tools: Pt({ connectorId: A, server: s.server, tools: s.serverTools }) };
          case `resources/list`:
            return { resources: [] };
          case `resources/templates/list`:
  ...
  if (
    ...
    let e;
    t[31] === r ? (e = t[32]) : ((e = r == null ? [] : [r]), (t[31] = r), (t[32] = e));
    let n;
    (t[33] !== e || t[34] !== s.hostId || t[35] !== s.server || t[36] !== s.tool.name
      ? ((n = [`openai-mcp-capability`, s.hostId, s.server, s.tool.name, ...e]),
        (t[33] = e),
        (t[34] = s.hostId),
        (t[35] = s.server),
        (t[36] = s.tool.name),
      ...
      (F = _t(n.join(`:`))),
      (P = j(h ?? F)),
      (ee = It({ connectorId: A, instanceFallbackId: F, server: s.server })),
      (t[22] = r),
      (t[23] = A),
      (t[24] = h),
      (t[25] = s.hostId),
      ...
      (t[29] = F),
      (t[30] = ee));
  } else ((P = t[28]), (F = t[29]), (ee = t[30]));
  let I = ee,
    te;
  t[38] === n ? (te = t[39]) : ((te = ae(`h-full min-h-0`, n)), (t[38] = n), (t[39] = te));
  let L;
  t[40] === F
    ? (L = t[41])
    : ((L = (0, q.jsx)(tr, { isInlineExpanded: !0, mcpAppId: F })), (t[40] = F), (t[41] = L));
  let R = O?.csp ?? null,
    ne = y ?? w,
    z = O?.html ?? null,
    re = b || T,
    B;
  t[42] !== s.resourceUri || t[43] !== s.tool.name
    ? ((B = { originResourceUri: s.resourceUri, originTool: s.tool.name }),
      (t[42] = s.resourceUri),
      (t[43] = s.tool.name),
      (t[44] = B))
    : (B = t[44]);
  let ie = O?.prefersBorder ?? !1,
    oe = C ?? null,
    se = O?.widgetDomain ?? null,
    ce;
  t[45] !== P ||
  t[46] !== F ||
  t[47] !== N ||
  ...
  t[60] !== s.title
    ? ((ce = (0, q.jsx)(nr, {
        ...
        prefersBorder: ie,
        overrideMcpRequest: N,
        sandboxOriginScope: I,
        server: s.server,
        sidePanelIcon: null,
        sidePanelTitle: s.title,
        title: s.title,
        toolArguments: l,
        toolResult: oe,
        widgetDomain: se,
  ...
  t[71] !== y
    ? ((V = (0, q.jsx)(rr, {
        error: y ?? w,
        fullSurface: !0,
        heightHint: O?.heightHint ?? null,
        html: O?.html ?? null,
        isLoading: b || T,
        mcpAppId: F,
        minFrameHeight: O?.minFrameHeight ?? null,
      })),
      (t[62] = D.kind),
      (t[63] = D.source),
      (t[64] = O?.heightHint),
  ...
  let H;
  t[73] !== p || t[74] !== F
    ? ((H = p ? null : (0, q.jsx)(ir, { mcpAppId: F })), (t[73] = p), (t[74] = F), (t[75] = H))
    : (H = t[75]);
  let ue;
  return (
    t[76] !== te || t[77] !== L || t[78] !== ce || t[79] !== V || t[80] !== H
      ? ((ue = (0, q.jsxs)(`div`, {
