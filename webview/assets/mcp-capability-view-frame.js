...
import { Js as C, Xs as w, zs as T } from "./app-server-manager-signals.js";
import { n as E, t as D } from "./jsx-runtime.js";
import { t as O } from "./clsx.js";
import { t as k } from "./react-dom.js";
import {
  $ as A,
  C as j,
  G as M,
...
import { T as ie } from "./composer-view-state.js";
...
import { l as ue, n as de } from "./app-shell-tab-controller.js";
import { r as fe, t as pe } from "./thread-panel-state-fkSg-C_s.js";
import { d as G, i as me, l as K, n as he, r as ge, u as _e } from "./dialog-layout.js";
import { t as ve } from "./build-worktree-label-from-input.js";
import { r as ye } from "./pending-worktree-store.js";
...
import { f as Te, g as Ee, h as De, m as Oe, v as ke, y as Ae } from "./mcp-capability-signals.js";
...
function Ye(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, J.jsx)(Ce, { className: `icon-xs -scale-x-100 transform` })), (t[5] = f))
    : (f = t[5]);
  let p;
  t[6] !== a || t[7] !== s || t[8] !== d
    ? ((p = (0, J.jsx)(ae, {
  ...
  return (
    t[10] !== u || t[11] !== p
      ? ((m = (0, J.jsxs)(J.Fragment, { children: [u, p] })), (t[10] = u), (t[11] = p), (t[12] = m))
      : (m = t[12]),
    m
  );
}
...
function Ze(
  ...
  (de.openTab(e, Xe, {
    icon:
      n == null
        ? (0, Y.createElement)(ce, { className: `icon-xs shrink-0 text-token-text-secondary` })
...
var et = e(l(), 1),
  tt = { intrinsicHeight: null, isFullScreen: !1, isInlineExpanded: !1, sandboxError: null },
  nt = z(W, () => new Map()),
  rt = z(W, () => new Map()),
  it = z(W, () => new Set()),
  at = N(W, ({ get: e }) => {
...
function pt(e, t) {
  ...
  (e.set(nt, (r) => {
    let i = e.get(rt),
      ...
      c = r;
    (a == null || !(0, et.default)(a, s)) && ((c = new Map(r)), c.set(t.mcpAppId, s));
    let l = vt({
...
function vt({ activeSidePanelTabId: e, frameStates: t, registration: n, registrations: r }) {
...
function yt({ hostedInThreadScrollLayout: e, inlineFrameContainer: t, mcpAppId: n, ...r }) {
  return r;
}
function bt(e, t) {
  return (
...
function Ft(e) {
  return e instanceof Error
    ? { ...It(e), message: e.message || `MCP sandbox host call failed.`, name: e.name }
    : typeof e == `object` &&
        e &&
        `message` in e &&
  ...
  return (
    ...
    async function* (n) {
      let { port1: r, port2: i } = new MessageChannel(),
        ...
        p = Z(s),
        m = Z(l);
      e.postMessage([Ct, { asyncDispose: i, next: o, return: c, throw: u }, n], [i, o, c, u]);
      try {
...
var Bt = e(k(), 1),
  ...
  Kt = i({ type: n([`audio`, `image`, `resource`, `resource_link`, `text`]) }).passthrough(),
...
function Sn(e) {
  ...
  t[0] !== f.intrinsicHeight || t[1] !== i
    ? ((_ = sr(f.intrinsicHeight, i)), (t[0] = f.intrinsicHeight), (t[1] = i), (t[2] = _))
    : (_ = t[2]);
  let v = _,
    y = n ?? f.sandboxError,
    b,
  ...
  if (o) {
    ...
    t[12] === n
      ? (r = t[13])
      : ((r = O(`mcp-app-loading-pulse w-full overflow-hidden border-token-border-light`, n)),
        (t[12] = n),
        (t[13] = r));
    let i = c ? `100%` : pn,
      a;
  ...
  let S = c && `h-full`,
    C;
  t[23] === S ? (C = t[24]) : ((C = O(`w-full overflow-hidden`, S)), (t[23] = S), (t[24] = C));
...
function Cn(e) {
  ...
  return (
    t[7] === o
      ? (s = t[8])
      : ((s = (0, J.jsx)(J.Fragment, { children: o.map(wn) })), (t[7] = o), (t[8] = s)),
    s
  );
}
function wn(e) {
...
function En({
  ...
  let C = L(W),
    ...
    je = (0, Y.useEffectEvent)(() => {
      ...
      return e == null
        ? null
        : { csp: t, html: i, locale: T.locale, sandboxOrigin: e, sourceUrl: ke };
    }),
    ...
    Ge = (0, Y.useEffectEvent)((e) => {
      ...
      if (t.success) {
        ...
        return (
          ...
          G != null &&
            ge != null &&
            (Q(G.setWidgetView({ displayMode: n, isTombstone: !1, viewParams: Ee, widgetId: ge })),
            z != null &&
              Q(
    ...
    Xe = (0, Y.useEffectEvent)(async (t) => {
      ...
      if (Ce != null) throw $(`A follow-up message is already awaiting confirmation`, Vt);
      let { prompt: i } = n.data,
      ...
      switch (a.type) {
        case `current-thread`:
          await w(`send-follow-up-message`, { conversationId: e, prompt: a.prompt });
          return;
        case `new-thread`:
          ...
          await E(_(await Fn({ hostId: r, prompt: a.prompt, projectRoot: a.projectRoot })));
          return;
      }
    }),
      ...
      switch (i) {
        ...
        case `resources/templates/list`:
          return tt(n.data, async () =>
            f === `codex_apps`
              ? { resourceTemplates: [] }
              : { resourceTemplates: (await Un({ hostId: r, server: f })).resourceTemplates },
          );
        case `prompts/list`:
  ...
  ((0, Y.useLayoutEffect)(() => {
    ...
    return (
      ...
      te(t),
      () => {
        (e.remove(), B((t) => (t === e ? null : t)), te((e) => (e === t ? null : e)), ce(!1));
      }
    );
  }, [o, ke, Ae]),
    (0, Y.useLayoutEffect)(() => {
      z == null ||
        ...
        ((z.className = O(
          ...
          !P && (n ? `border-t border-token-border-light` : `rounded-lg border shadow-sm`),
    ...
    (0, Y.useLayoutEffect)(() => {
      ...
      (V.parentElement !== z && z.appendChild(V),
        ...
        ne || ce(!0));
      let t = () => {
        Ln({ frameElement: z, isFullScreen: P, targetFrameContainer: e, threadFrameContainer: Fe });
      };
  ...
  ((0, Y.useLayoutEffect)(() => {
    ...
    (0, Y.useLayoutEffect)(() => {
      ...
      let e = je();
      if (e == null) {
        (j.warning(`mcp_app_sandbox.init_config_missing`, { safe: {}, sensitive: { mcpAppId: o } }),
          ht(C, o, { sandboxError: Error(`The MCP app sandbox failed to load.`) }));
        return;
      }
    ...
    (0, Y.useEffect)(() => {
      ...
      let e = null,
        ...
        n = () => {
          let e = rr(z),
            n = nr({ displayMode: t, hasNavigationHistory: K.canGoBack || K.canGoForward });
          (Q(
            ...
            Q(G.setWidgetView({ displayMode: t, isTombstone: !1, viewParams: Ee, widgetId: ge })),
            Q(
              G.notifyMcpAppsHostContext({
                hostContext: tr({
  ...
  let st = (e) => {
    ...
    ct = () => {
      let e = Ce;
      e != null && (we(null), e.reject($(`Follow-up message was not confirmed`, Vt)));
    },
            ...
            (0, J.jsx)(re, {
              ...
              children: (0, J.jsx)(`div`, {
                ...
                children: (0, J.jsx)(ae, {
                  ...
                  onClick: (e) => {
                    (e.stopPropagation(),
                      H.dispatchMessage(`open-mcp-app-sandbox-devtools`, { sandboxId: Ae }));
                  },
...
function Dn(e) {
  ...
  let d = u,
    f;
  t[4] === i ? (f = t[5]) : ((f = O(`flex items-center gap-px`, i)), (t[4] = i), (t[5] = f));
  let p;
  t[6] === a
    ? (p = t[7])
    : ((p = (e) => {
...
function kn(e) {
  ...
  let s;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((s = n == null ? null : (0, J.jsx)(An, { confirmation: n, onCancel: r, onConfirm: i })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = i),
      (t[5] = s))
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== s
      ? ((c = (0, J.jsx)(K, { open: a, onOpenChange: o, size: `wide`, children: s })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s),
        (t[9] = c))
...
function An(e) {
  ...
  if (t[2] !== f || t[3] !== m || t[4] !== s) {
    ...
    ((y = ze({ workspaceGroups: s, roots: [], formatRootLabel: Nn })),
      (b = ze({ workspaceGroups: s?.filter(Mn), roots: [], formatRootLabel: jn })));
  ...
  let S = v,
    ...
    T;
  t[8] !== C || t[9] !== u || t[10] !== f || t[11] !== i || t[12] !== S || t[13] !== _
    ? ((T = (e) => {
        if ((e.preventDefault(), _.length !== 0)) {
          if (u) {
            if (S == null || (f === `worktree` && !C)) return;
            i({ executionMode: f, prompt: _, type: `new-thread`, projectRoot: S });
            return;
          }
  ...
  t[44] === r
    ? (B = t[45])
    : ((B = (0, J.jsx)(ae, { color: `secondary`, className: `ml-auto`, onClick: r, children: z })),
      (t[44] = r),
      (t[45] = B));
  let V = !w,
    H;
  ...
  t[49] !== R || t[50] !== B || t[51] !== U
    ? ((te = (0, J.jsxs)(ge, { className: `justify-start gap-2`, children: [R, B, U] })),
      (t[49] = R),
      (t[50] = B),
      (t[51] = U),
      (t[52] = te))
...
function Pn(e) {
  ...
  t[0] === a
    ? (s = t[1])
    : ((s = a.formatMessage(yn.newWorktreeRequiresGitProject)), (t[0] = a), (t[1] = s));
  let c = s,
    l;
  t[2] === o
    ? (l = t[3])
    : ((l = (0, J.jsx)(o, { className: `icon-2xs shrink-0` })), (t[2] = o), (t[3] = l));
  ...
  let _;
  t[13] !== m || t[14] !== h
    ? ((_ = (0, J.jsx)(je.Item, { LeftIcon: Pe, RightIcon: m, onSelect: h, children: g })),
      (t[13] = m),
      (t[14] = h),
      (t[15] = _))
    : (_ = t[15]);
  ...
  return (
    t[24] !== _ || t[25] !== C || t[26] !== p
      ? ((w = (0, J.jsxs)(Me, { contentWidth: `menuNarrow`, triggerButton: p, children: [_, C] })),
        (t[24] = _),
        (t[25] = C),
        (t[26] = p),
        (t[27] = w))
...
async function Fn({ hostId: e, prompt: n, projectRoot: r }) {
  ...
  let { config: o } = await w(`read-config-for-host`, { hostId: e, includeLayers: !1, cwd: a.cwd }),
...
async function In({ createPendingWorktree: e, hostId: t, prompt: n, projectRoot: r }) {
  if (r === `~`) throw $(`Missing project root`, Vt);
  let { config: i } = await w(`read-config-for-host`, { hostId: t, includeLayers: !1, cwd: r }),
...
async function Un({ hostId: e, mcpServerStatuses: t, server: n }) {
  ...
  if (r != null) return r;
  let i =
    (await w(`list-mcp-server-status`, { hostId: e, cursor: null, limit: 100 })).data.find(
      ({ name: e }) => e === n,
    ) ?? null;
...
async function Wn({
  ...
  let o = await Gn({ hostId: t, mcpServerStatuses: r, server: i, toolName: a.name });
  if (
    (qn({
      connectorId: Kn({ mcpAppScope: n, server: i, serverStatus: o.serverStatus }),
      server: i,
      tool: o.tool,
      toolName: o.name,
    }),
...
async function Gn({ hostId: e, mcpServerStatuses: t, server: n, toolName: r }) {
  let i = t?.data.find(({ name: e }) => e === n) ?? (await Un({ hostId: e, server: n }));
  if (n !== `codex_apps`) {
...
function tr({
  ...
  return {
    ...
    containerDimensions: e,
    deviceCapabilities: { hover: a.capabilities.hover, touch: a.capabilities.touch },
    displayMode: t,
    locale: n,
    platform: `desktop`,
    safeAreaInsets: r,
...
var ur = a(),
  ...
  hr = B(
    ...
    ({ toolArguments: e, view: t }, { scope: n }) => ({
      queryKey: [`mcp-capability-view-tool-result`, t.hostId, t.pluginId, t.server, t.tool.name, e],
      queryFn: async () => Le(n, t.hostId, t.pluginId, t.server, t.tool.name, e),
      staleTime: 0,
    }),
    { key: _r },
  );
function gr(e) {
  return JSON.stringify([e.hostId, e.pluginId, e.resourceUri, e.server, e.tool.name]);
}
function _r({ toolArguments: e, view: t }) {
  return JSON.stringify([t.hostId, t.pluginId, t.resourceUri, t.server, t.tool.name, e]);
}
var vr = {};
function yr(e) {
  let t = (0, q.c)(69),
    ...
    ? ((b = async (e) => {
        ...
        switch (t.method) {
          case `tools/call`: {
            ...
            return Le(c, o.hostId, o.pluginId, o.server, e.name, dr.parse(e.arguments ?? {}));
          }
          case `resources/read`: {
            ...
            return n == null
              ...
              : { contents: [{ extension: n.extension, text: n.text, uri: e.uri }] };
          }
          case `tools/list`:
  ...
  if (
    ...
    let e;
    t[18] === r ? (e = t[19]) : ((e = r == null ? [] : [r]), (t[18] = r), (t[19] = e));
    let n;
    (t[20] !== e || t[21] !== o.pluginId || t[22] !== o.server || t[23] !== o.tool.name
      ? ((n = [`openai-mcp-capability`, o.pluginId, o.server, o.tool.name, ...e]),
        (t[20] = e),
        (t[21] = o.pluginId),
        (t[22] = o.server),
        (t[23] = o.tool.name),
      ...
      : (n = t[24]),
      (C = lt(n.join(`:`))),
      (w = l.value.routeKind === `local-thread` ? l.value.conversationId : S(C)),
      (t[10] = r),
      (t[11] = l.value.conversationId),
      (t[12] = l.value.routeKind),
      (t[13] = o.pluginId),
  ...
  let T = w,
    E;
  t[25] === n ? (E = t[26]) : ((E = O(`h-full min-h-0`, n)), (t[25] = n), (t[26] = E));
  let D;
  t[27] === C
    ? (D = t[28])
    : ((D = (0, J.jsx)(bn, { isInlineExpanded: !0, mcpAppId: C })), (t[27] = C), (t[28] = D));
  let k = y?.csp ?? null,
    A = d ?? h,
    j = y?.html ?? null,
    M = f || g,
  ...
  t[32] === o.server
    ? (I = t[33])
    : ((I = { kind: `mcp_server`, server: o.server }), (t[32] = o.server), (t[33] = I));
  let ee = m ?? null,
  ...
  t[59] !== d
    ...
    : (V = t[60]);
  let H;
  t[61] === C ? (H = t[62]) : ((H = (0, J.jsx)(Cn, { mcpAppId: C })), (t[61] = C), (t[62] = H));
  let U;
  return (
