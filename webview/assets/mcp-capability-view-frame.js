...
import { _a as f, js as p } from "./app-server-manager-signals.js";
import { f as m, m as h } from "./vscode-api.js";
import { t as g } from "./isEqual.js";
import {
  Ar as _,
  Fi as v,
  Gt as y,
...
import { c as ee, o as z, r as B } from "./lib.js";
import { Br as V } from "./persisted-signal.js";
import { t as te } from "./clsx-Cir5-jBH.js";
import { ct as ne, i as H } from "./app-shell-state.js";
import { t as re } from "./app-shell.js";
import { t as ie } from "./button-DO-oxX3-.js";
import { t as ae } from "./check-md.js";
import { t as U } from "./use-stable-callback.js";
import { t as oe } from "./tooltip.js";
import { o as se } from "./statsig.js";
import "./config-queries.js";
import { c as ce, d as le, f as ue, h as de, m as fe, u as pe } from "./mcp-capability-signals.js";
import { t as W } from "./chevron.js";
import { m as me } from "./chunk-109.js";
import { t as he } from "./connector-logo.js";
import { t as ge } from "./route-scope.js";
import { k as _e } from "./composer-view-state.js";
import { t as G } from "./apps.js";
import { n as ve } from "./projectless-thread.js";
import { n as ye, u as be } from "./app-shell-tab-controller.js";
import { o as xe, r as Se } from "./thread-panel-state.js";
import { d as Ce, i as we, l as Te, n as Ee, r as De, u as Oe } from "./dialog-layout.js";
import { h as ke } from "./open-project-setup-dialog.js";
import { t as Ae } from "./build-worktree-label-from-input-CWcK-Fwd.js";
import { t as je } from "./read-service-tier-for-request.js";
import { r as Me } from "./pending-worktree-store.js";
import { t as Ne } from "./arrow-left.js";
import { t as Pe } from "./checkbox.js";
import { r as Fe, t as Ie } from "./dropdown.js";
import { t as Le } from "./macbook.js";
import { t as Re } from "./worktree.js";
import { n as ze, t as Be } from "./project-dropdown-options.js";
import { n as Ve, t as He } from "./mcp-capability-client.js";
import { t as Ue } from "./alert-1.js";
import {
  a as We,
  c as Ge,
  i as Ke,
...
function et(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, q.jsx)(Ne, { className: `icon-xs` })), (t[0] = l))
    : (l = t[0]);
  let u;
  t[1] !== n || t[2] !== o || t[3] !== c
    ? ((u = (0, q.jsx)(ie, {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, q.jsx)(Ne, { className: `icon-xs -scale-x-100 transform` })), (t[5] = f))
    : (f = t[5]);
  let p;
  t[6] !== a || t[7] !== s || t[8] !== d
    ? ((p = (0, q.jsx)(ie, {
...
function nt(
  ...
  (ye.openTab(e, tt, {
    icon:
      n == null
        ? (0, J.createElement)(G, { className: `icon-xs shrink-0 text-token-text-secondary` })
        : (0, J.createElement)(he, {
            alt: n.alt,
            className: `icon-xs shrink-0 object-contain`,
            logoUrl: n.logoUrl,
            logoDarkUrl: n.logoDarkUrl,
            fallback: (0, J.createElement)(G, {
...
function rt(e, t) {
  let n = it(t);
  e.get(ye.tabs$).some((e) => e.tabId === n) &&
    (ye.closeTab(e, n), e.get(ye.tabs$).length === 0 && $e(e));
}
function it(e) {
  return `${be.MCP_APP}:${e}`;
}
var at = e(g(), 1),
  ot = { intrinsicHeight: null, isFullScreen: !1, isInlineExpanded: !1, sandboxError: null },
  st = s(ge, () => new Map()),
  ct = s(ge, () => new Map()),
  lt = s(ge, () => new Set()),
  ut = a(ge, ({ get: e }) => {
  ...
  dt = c(ge, (e, { get: t }) => t(st).get(e) ?? null),
  ft = c(ge, (e, { get: t }) => t(ct).get(e) ?? ot),
  pt = c(ge, (e, { get: t }) => t(lt).has(e));
function mt(e) {
  return e;
}
function ht(e, t, n) {
...
function vt(e, t) {
  ...
  (e.set(st, (r) => {
    let i = e.get(ct),
      ...
      c = r;
    (a == null || !(0, at.default)(a, s)) && ((c = new Map(r)), c.set(t.mcpAppId, s));
    let l = Ct({
      activeSidePanelTabId: e.get(ye.activeTab$)?.tabId ?? null,
      frameStates: i,
      registration: t,
      registrations: c,
    });
...
function yt(e, t, n) {
  ...
  for (let r of n.values())
    if (
      ...
      Tt(r.sidePanelFrameContent ?? r.inlineFrameContent, t)
    )
      return r.mcpAppId;
  return t.mcpAppId;
}
function bt(e, t, n) {
  (n.isFullScreen === !0 && St(e, t),
    e.set(ct, (e) => {
      let r = e.get(t) ?? ot,
        i = { ...r, ...n };
      if (
...
function Ct({ activeSidePanelTabId: e, frameStates: t, registration: n, registrations: r }) {
  for (let i of r.values())
    if (
      e === it(i.mcpAppId) &&
      t.get(i.mcpAppId)?.isFullScreen === !0 &&
      Tt(i.sidePanelFrameContent ?? i.inlineFrameContent, n)
    )
      return i;
  return null;
}
function wt({ hostedInThreadScrollLayout: e, inlineFrameContainer: t, mcpAppId: n, ...r }) {
  return r;
}
function Tt(e, t) {
  return (
    ...
    e.server === t.server &&
    (0, at.default)(e.mcpAppScope, t.mcpAppScope) &&
    Et(e.sandboxOriginScope, t.sandboxOriginScope)
  );
}
function Et(e, t) {
...
function Ot({ server: e, tool: t }) {
  return Y(e) ? Ye(t) : null;
}
function kt({ mcpAppScope: e, server: t, tools: n }) {
  return Y(t) ? Ye(n.find((t) => t.name === e.originTool) ?? null) : null;
}
function At({ connectorId: e, server: t, toolName: n, tools: r }) {
  let i = Pt({ server: t, toolName: n, tools: r });
  if ((Ft({ connectorId: e, server: t, tool: i, toolName: n }), It(i)))
    throw Error(`MCP app cannot call tools that accept file parameters: ${i?.name ?? n}`);
  return { name: i?.name ?? n, tool: i };
}
function jt({ connectorId: e, server: t, tools: n }) {
  let r = Y(t) ? n.filter((t) => Ye(t) === e) : n;
  if (Y(t) && e == null) throw Error(`MCP app requests require a trusted connector scope`);
  return r.filter((e) => !It(e));
}
function Mt({ mcpAppScope: e, server: t, uri: n }) {
  if (Y(t) && (e.originResourceUri == null || n !== e.originResourceUri))
    throw Error(`MCP app cannot read resource outside its widget scope: ${n}`);
}
function Nt({ connectorId: e, instanceFallbackId: t, server: n }) {
  return Y(n)
    ? { connectorId: e, instanceFallbackId: t, kind: `codex_app` }
    : { kind: `mcp_server`, server: n };
}
function Pt({ server: e, toolName: t, tools: n }) {
  let r = n.find((e) => e.name === t) ?? null;
  return r != null || !Y(e) ? r : (n.find((e) => e.title === t) ?? null);
}
function Ft({ connectorId: e, server: t, tool: n, toolName: r }) {
  if (!Y(t)) return;
  let i = Ye(n);
...
async function Jt({
  ...
  let o = crypto.randomUUID(),
    { ports: s, replyPort: c } = await new Promise((e, s) => {
      ...
      let c,
        ...
        u = (r) => {
          ...
          if (
            ...
            return;
          let a = i.portNames;
          if (!w(a) || r.ports.length !== a.length + 1) return;
          let s = Yt(a, r.ports);
          if (s == null) return;
      ...
      let f = b({ initId: o, sourceUrl: i });
      a.getAttribute(`src`) !== f && a.setAttribute(`src`, f);
    }),
    l = $t(e);
  return (c.postMessage(l, Object.values(l)), c.start(), Qt(s, r));
}
function Yt(e, t) {
  let n = {};
  for (let r of qt) {
...
function Zt(e) {
  return Xt(e) ? typeof e.postMessage == `function` && typeof e.start == `function` : !1;
}
function Qt(e, t) {
  return {
    ...
    runWidgetCode: an(e.runWidgetCode, t),
...
function X(e) {
  ...
  return (
    (t.onmessage = async (t) => {
      ...
      if (!(n !== Vt || i == null))
        try {
          i.postMessage([Wt, await e(...r)]);
        } catch (e) {
          i.postMessage([Ut, en(e)]);
        } finally {
          i.close();
        }
    }),
...
function en(e) {
  return e instanceof Error
    ? { ...tn(e), message: e.message || `MCP sandbox host call failed.`, name: e.name }
    : typeof e == `object` &&
        e &&
        `message` in e &&
        typeof e.message == `string` &&
        e.message.length > 0
      ? { ...tn(e), message: e.message }
...
function Z(e, t = {}) {
  return (
    ...
    (n) =>
      new Promise((r, i) => {
        let a = t.signal,
          o = t.timeoutMs === void 0 ? Kt : t.timeoutMs;
        if (a?.aborted) {
          i(nn());
          return;
        }
  ...
  return (
    ...
    async function* (n) {
      let { port1: r, port2: i } = new MessageChannel(),
        ...
        p = Z(s),
        m = Z(l);
      e.postMessage([Ht, { asyncDispose: i, next: o, return: c, throw: u }, n], [i, o, c, u]);
      try {
...
var on = e(R(), 1),
  ...
  cn = C(),
  ln = A(P(), M()),
  un = k({ text: P(), type: F(`text`) }).strip(),
  dn = k({ data: P(), mimeType: P(), type: F(`image`) }).strip(),
  fn = k({ type: v([`audio`, `image`, `resource`, `resource_link`, `text`]) }).passthrough(),
  pn = k({ status: F(2), type: F(`environment_status`) }).passthrough(),
  mn = P(),
  hn = k({ mode: v([`inline`, `fullscreen`]) }),
  gn = k({ canGoBack: T(), canGoForward: T() }).passthrough(),
  _n = k({ prompt: P().trim().min(1) }).strip(),
  vn = k({ method: P(), params: A(P(), M()).optional() }).strip(),
  yn = k({ blob: x(Blob), name: P().trim().min(1) }).strip(),
  bn = S({ [le]: fe.optional(), progressToken: pe.optional() }),
  xn = k({
    name: P().min(1),
    arguments: A(P(), cn).optional(),
    _meta: bn.optional(),
  }).passthrough(),
  Sn = k({ uri: P().min(1) }).passthrough(),
  Cn = k({ code: O().optional(), message: P().min(1) }).passthrough(),
  wn = O().finite().positive(),
  Tn = k({ href: P().refine(Sr) }),
  En = A(P(), cn),
  Dn = k({ content: L(M()).optional() }).passthrough(),
  On = k({ content: L(fn), structuredContent: ln.optional() }).strict(),
  kn = { insets: { bottom: 0, left: 0, right: 0, top: 0 } },
  An = { insets: { ...kn.insets, top: 48 } },
  jn = 240,
  Mn = 200,
  Nn = 720,
  Pn = { canGoBack: !1, canGoForward: !1 },
  Fn = [],
  In = [],
  Ln = B({
    workLocally: {
...
function zn(e) {
  let t = (0, K.c)(39),
    ...
    k = u(ye.tabs$),
    A;
  t[0] === c ? (A = t[1]) : ((A = c == null ? 0 : new Blob([c]).size), (t[0] = c), (t[1] = A));
  let j = A,
    M,
    N;
  t[2] !== n ||
  ...
  return (
    ...
    t[36] !== w
      ? ((F = () => {
        ...
        (I = [n, r, i, T, o, s, P, c, j, d, f, M, p, m, h, g, _, E, v, y, b, x, S, C, w]),
        (t[12] = n),
        (t[13] = r),
        (t[14] = i),
        (t[15] = T),
        ...
        (t[38] = I))
      : ((F = t[37]), (I = t[38])),
    (0, J.useLayoutEffect)(F, I),
    null
  );
}
function Bn(e) {
  let t = (0, K.c)(30),
    { error: n, fullSurface: r, heightHint: a, html: o, isLoading: s, mcpAppId: c } = e,
    u = r === void 0 ? !1 : r,
    d = l(ge),
    f = ee(),
    p = i(dt, c),
    ...
    _ = o == null ? 0 : new Blob([o]).size,
    v = p != null,
    y;
  t[0] !== m.intrinsicHeight || t[1] !== a
    ? ((y = xr(m.intrinsicHeight, a)), (t[0] = m.intrinsicHeight), (t[1] = a), (t[2] = y))
    : (y = t[2]);
  let b = y,
    x = n ?? m.sandboxError,
    S,
  ...
  if (s) {
    ...
    t[10] === f
      ...
      : ((e = f.formatMessage({
        ...
        (t[10] = f),
        (t[11] = e));
    let n = u ? `h-full border-t` : `rounded-lg border`,
      r;
    t[12] === n
      ? (r = t[13])
      : ((r = te(`mcp-app-loading-pulse w-full overflow-hidden border-token-border-light`, n)),
        (t[12] = n),
        (t[13] = r));
    let i = u ? `100%` : jn,
      a;
  ...
  let w = u && `h-full`,
    T;
  t[23] === w ? (T = t[24]) : ((T = te(`w-full overflow-hidden`, w)), (t[23] = w), (t[24] = T));
  let E = m.isFullScreen ? 0 : u ? `100%` : b,
    D;
  t[25] === E ? (D = t[26]) : ((D = { height: E }), (t[25] = E), (t[26] = D));
  let O;
  return (
    t[27] !== T || t[28] !== D
      ? ((O = (0, q.jsx)(`div`, {
...
function Vn(e) {
  ...
  return (
    t[7] === o
      ? (s = t[8])
      : ((s = (0, q.jsx)(q.Fragment, { children: o.map(Hn) })), (t[7] = o), (t[8] = s)),
    s
  );
}
function Hn(e) {
  return (0, q.jsx)(Un, { mcpAppId: e }, e);
}
function Un(e) {
  let t = (0, K.c)(5),
    { mcpAppId: n } = e,
...
function Wn({
  ...
  let E = l(ge),
    ...
    k = me(),
    A = _e(e),
    { createPendingWorktree: M } = Me(),
    N = u(ye.activeTab$),
    P = u(H),
    { rightPanelLayoutTick: F } = ne(),
    I = u(Lt),
    { isFullScreen: L } = T,
    R = (0, J.useRef)(!1),
    B = (0, J.useRef)(null),
    [V, ae] = (0, J.useState)(null),
    [U, se] = (0, J.useState)(null),
    [ce, le] = (0, J.useState)(!1),
    [ue, de] = (0, J.useState)(null),
    [fe, pe] = (0, J.useState)(null),
    [W, he] = (0, J.useState)(null),
    [G, ve] = (0, J.useState)(Pn),
    [be, xe] = (0, J.useState)(null),
    [Se, Ce] = (0, J.useState)(!1),
    [we, Te] = (0, J.useState)(null),
    [Ee, De] = (0, J.useState)(null),
    Oe = (0, J.useMemo)(() => ar(S), [S]),
    ke = (0, J.useMemo)(() => or(C), [C]),
    Ae = (0, J.useMemo)(() => Ge({ toolResult: C }), [C]),
    Ne = (0, J.useEffectEvent)(() => ({
      toolInput: Oe,
      toolOutput: ke,
      toolResponseMetadata: Ae,
      toolResult: C,
    })),
    Pe = We({ locale: O.locale, originScope: g, widgetDomain: w }),
    Fe = (0, J.useMemo)(() => Ke({ originScope: g, sourceUrl: Pe }), [Pe, g]),
    Ie = (0, J.useEffectEvent)(() => {
      let e = y(Pe);
      return e == null
        ? null
        : { csp: t, html: i, locale: O.locale, sandboxOrigin: e, sourceUrl: Pe };
    }),
    Le = ue?.isConnected === !0 ? ue : null,
    Re = a?.isConnected === !0 ? a : null,
    ze = V?.parentElement,
    Be =
      Re?.closest(`[data-mcp-app-portal-target='true']`) ??
    ...
    He = (0, J.useEffectEvent)(() => {
      bt(E, o, { sandboxError: Error(`The MCP app sandbox failed to load.`) });
    }),
    Ue = (0, J.useEffectEvent)((e) => {
      let t = wn.safeParse(e);
      t.success && bt(E, o, { intrinsicHeight: t.data });
    }),
    ...
    Je = (0, J.useEffectEvent)((e) => {
      ...
      t.success && ve({ canGoBack: t.data.canGoBack, canGoForward: t.data.canGoForward });
    }),
    Ye = (0, J.useEffectEvent)((e) => {
      let t = Tn.safeParse(e);
      t.success && m.dispatchMessage(`open-in-browser`, { url: t.data.href });
    }),
    Xe = (0, J.useEffectEvent)((e) => {
      let t = hn.safeParse(e);
      if (t.success) {
        let e = t.data.mode === `fullscreen`,
          n = t.data.mode;
        return (
          e && (V != null && (V.style.display = `none`), _t(E, o)),
          bt(E, o, { isFullScreen: e }),
          W != null &&
            be != null &&
            (Q(W.setWidgetView({ displayMode: n, isTombstone: !1, viewParams: ke, widgetId: be })),
            V != null &&
              Q(
                W.notifyMcpAppsHostContext({
                  hostContext: hr({
                    containerDimensions: _r(V),
                    displayMode: n,
                    locale: O.locale,
                    safeAreaInsets: gr({
                      displayMode: n,
    ...
    Ze = (0, J.useEffectEvent)(() => (L ? `fullscreen` : `inline`)),
    Qe = (0, J.useEffectEvent)(() => we),
    $e = (e) => {
      let t = rr(e.content);
      A({ id: o, imageAttachments: ir(e.content), text: t, title: x });
    },
    K = (0, J.useEffectEvent)((e, t) => {
      let n = En.safeParse(t);
      Te(n.success ? n.data : null);
      let r = On.safeParse(t);
      r.success && $e(r.data);
    }),
    et = (0, J.useEffectEvent)((e) => {
      W != null && Q(W.navigate({ delta: e }));
    }),
    tt = (0, J.useEffectEvent)(async (t) => {
      let n = _n.safeParse(t);
      if (!n.success) throw $(`Invalid follow-up message`, -32602);
      if (Ee != null) throw $(`A follow-up message is already awaiting confirmation`, sn);
      let { prompt: i } = n.data,
        a = await new Promise((e, t) => {
          De({ prompt: i, reject: t, resolve: e });
        });
      switch (a.type) {
        case `current-thread`:
          await p(`send-follow-up-message`, {
            conversationId: e,
            prompt: a.prompt,
            serviceTier: await je(E, r, null),
          });
          return;
        case `new-thread`:
          if (a.executionMode === `worktree`) {
            await k(
              `/worktree-init-v2/${await er({ createPendingWorktree: M, hostId: r, prompt: a.prompt, projectRoot: a.projectRoot, scope: E })}`,
            );
            return;
          }
          await k(
            j(await $n({ hostId: r, prompt: a.prompt, projectRoot: a.projectRoot, scope: E })),
          );
          return;
      }
    }),
    ot = async (e, t) => (f == null ? t() : f(e)),
    st = (t) =>
      ot({ method: `tools/call`, params: t }, () =>
        cr({
          conversationId: e,
          hostId: r,
          mcpAppScope: s,
    ...
    ct = (0, J.useEffectEvent)(async (e, t) => {
      let n = xn.safeParse({ arguments: t, name: e });
      if (!n.success) throw $(`Invalid MCP tool call params`, -32602);
      return st(n.data);
    }),
    lt = (0, J.useEffectEvent)(async (t) => {
      let n = vn.safeParse(t);
      ...
      switch (i) {
        ...
        case `ui/update-model-context`: {
          let e = Dn.safeParse(a);
          if (!e.success) throw $(`Invalid MCP model context params`, -32602);
          return ($e(e.data), {});
        }
        case `tools/call`: {
          let e = xn.safeParse(a);
          if (!e.success) throw $(`Invalid MCP tool call params`, -32602);
          return st(e.data);
        }
        case `resources/read`: {
          let t = Sn.safeParse(a);
          if (!t.success) throw $(`Invalid MCP resource read params`, -32602);
          return ot({ method: i, params: t.data }, async () => {
            dr(() => {
              Mt({ mcpAppScope: s, server: _, uri: t.data.uri });
            });
            try {
              return await p(`read-mcp-resource`, {
                hostId: r,
                threadId: e,
                server: _,
                uri: t.data.uri,
              ...
              throw mr(e, `MCP resource read failed`);
            }
          });
        }
        case `tools/list`:
          return ot(n.data, async () => {
            let e = ur(await sr({ hostId: r, mcpServerStatuses: Y(_) ? c : void 0, server: _ })),
              t = kt({ mcpAppScope: s, server: _, tools: e });
            return { tools: dr(() => jt({ connectorId: t, server: _, tools: e })) };
          });
        case `resources/list`:
          return ot(n.data, async () =>
            Y(_)
              ? { resources: [] }
              : { resources: (await sr({ hostId: r, server: _ })).resources },
          );
        case `resources/templates/list`:
          return ot(n.data, async () =>
            Y(_)
              ? { resourceTemplates: [] }
              : { resourceTemplates: (await sr({ hostId: r, server: _ })).resourceTemplates },
          );
        case `prompts/list`:
          return ot(n.data, async () => ({ prompts: [] }));
        default:
          return ot(n.data, async () => {
  ...
  ((0, J.useLayoutEffect)(() => {
    ...
    return (
      t.setAttribute(`partition`, D(Fe)),
      ae(e),
      se(t),
      () => {
        (e.remove(), ae((t) => (t === e ? null : t)), se((e) => (e === t ? null : e)), le(!1));
      }
    );
  }, [o, Pe, Fe]),
    (0, J.useLayoutEffect)(() => {
      V == null ||
        ...
        ((V.className = te(
          ...
          !L && (n ? `border-t border-token-border-light` : `rounded-lg border shadow-sm`),
          !L && !n && (d ? `border-token-border` : `border-token-border-light`),
        )),
        (U.className = te(
    ...
    (0, J.useLayoutEffect)(() => {
      ...
      (U.parentElement !== V && V.appendChild(U),
        V.parentElement !== Be && Be.appendChild(V),
        ce || le(!0));
      let t = null,
  ...
  let ut = (0, J.useEffectEvent)((e) => {
      nt(E, {
        activate: !E.get(ye.tabs$).some((e) => e.tabId === it(o)),
        icon: v,
        mcpAppId: o,
        onExitFullScreen: e,
        onPanelElementChange: de,
        title: b,
      });
    }),
    dt = (0, J.useEffectEvent)(() => {
      R.current || (_t(E, o), bt(E, o, { isFullScreen: !1 }));
    });
  ((0, J.useLayoutEffect)(() => {
    if (L) {
      ut(dt);
    ...
    rt(E, o);
  }, [L, o, E, v?.alt, v?.logoDarkUrl, v?.logoUrl, b]),
    (0, J.useLayoutEffect)(() => {
      if (U == null || V == null || !ce) return;
      (bt(E, o, { sandboxError: null }), Ce(!1), ve(Pn), (B.current = null));
      let e = Ie();
      if (e == null) {
        (h.warning(`mcp_app_sandbox.init_config_missing`, { safe: {}, sensitive: { mcpAppId: o } }),
          bt(E, o, { sandboxError: Error(`The MCP app sandbox failed to load.`) }));
        return;
      }
      let t = new AbortController(),
        ...
        r = crypto.randomUUID(),
        i = Qe(),
        { toolInput: a, toolOutput: s, toolResponseMetadata: c } = Ne();
      return (
        Jt({
          hostApiHandlers: {
            callMcp: lt,
            ...
            notifyIntrinsicWidth: qe,
            notifyNavigation: (e) => {
              t.signal.aborted || Je(e);
            },
            notifySecurityPolicyViolation: () => {},
            openExternal: Ye,
            requestDisplayMode: Xe,
            sendFollowUpMessage: tt,
            sendInstrument: () => {},
            updateWidgetState: K,
          },
          ...
          .then(async (o) => {
            ...
            let l = Ze(),
              ...
              p = hr({
                ...
                displayMode: l,
                locale: e.locale,
                safeAreaInsets: kn.insets,
                styleVariables: E.get(Lt),
                theme: u,
                userAgent: f,
              }),
              m = o.runWidgetCode({
          ...
          .catch((e) => {
            t.signal.aborted ||
              (h.warning(`mcp_app_sandbox.init_failed`, {
                safe: {
    ...
    (0, J.useEffect)(() => {
      if (!Se || W == null || be == null) return;
      let e = {
        toolInput: Oe,
        toolOutput: ke,
        toolResponseMetadata: Ae,
        toolResult: { content: C.content, structuredContent: C.structuredContent ?? void 0 },
      };
      if ((0, at.default)(B.current, e)) return;
      B.current = e;
      let t = Qe();
      (Q(
        W.setWidgetData({
        ...
        Q(
          W.notifyMcpAppsToolResult({
            content: C.content,
            ...(C.structuredContent == null ? {} : { structuredContent: C.structuredContent }),
            ...(Ae == null ? {} : { _meta: Ae }),
          }),
        ));
    }, [Se, W, Oe, ke, Ae, C, be]),
    (0, J.useEffect)(() => {
      if (V == null || W == null || be == null || (L && Le == null)) return;
      let e = null,
        t = L ? `fullscreen` : `inline`,
        n = () => {
          let e = _r(V),
            n = gr({ displayMode: t, hasNavigationHistory: G.canGoBack || G.canGoForward });
          (Q(
            ...
            Q(W.setWidgetView({ displayMode: t, isTombstone: !1, viewParams: ke, widgetId: be })),
            Q(
              W.notifyMcpAppsHostContext({
                hostContext: hr({
    ...
    }, [V, O.locale, I, L, G.canGoBack, G.canGoForward, F, W, Le, ke, be]));
  let ft = (e) => {
      let t = Ee;
    ...
    pt = () => {
      let e = Ee;
      e != null && (De(null), e.reject($(`Follow-up message was not confirmed`, sn)));
    },
    mt = U?.tagName === `WEBVIEW`,
    ht = V != null && W != null && mt && Bt(),
    gt = G.canGoBack || G.canGoForward,
    vt = W != null && gt,
    yt = vt && !L,
    xt = vt && L && N?.tabId === it(o);
  return (0, q.jsxs)(q.Fragment, {
    children: [
      (0, q.jsx)(qn, { confirmation: Ee, onCancel: pt, onConfirm: ft }),
      xt
        ? (0, q.jsx)(re.RightPanelTabListBefore, {
            children: (0, q.jsx)(Gn, {
            ...
            (0, q.jsx)(oe, {
              ...
              children: (0, q.jsx)(`div`, {
                ...
                children: (0, q.jsx)(ie, {
                  ...
                  onClick: (e) => {
                    (e.stopPropagation(),
                      m.dispatchMessage(`open-mcp-app-sandbox-devtools`, { sandboxId: Fe }));
                  },
...
function Gn(e) {
  ...
  let d = u,
    f;
  t[4] === i ? (f = t[5]) : ((f = te(`flex items-center gap-px`, i)), (t[4] = i), (t[5] = f));
  let p;
  t[6] === a
    ? (p = t[7])
    : ((p = (e) => {
...
function qn(e) {
  ...
  let s;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((s = n == null ? null : (0, q.jsx)(Jn, { confirmation: n, onCancel: r, onConfirm: i })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = i),
      (t[5] = s))
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== s
      ? ((c = (0, q.jsx)(Te, { open: a, onOpenChange: o, size: `wide`, children: s })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = s),
        (t[9] = c))
...
function Jn(e) {
  ...
  let v = _,
    ...
    b,
    x;
  if (t[2] !== p || t[3] !== h || t[4] !== s) {
    let e = N(`~`);
    ((b = Be({ workspaceGroups: s, roots: [], formatRootLabel: Zn })),
      (x = Be({ workspaceGroups: s?.filter(Xn), roots: [], formatRootLabel: Yn })));
    let n = h === e ? e : (b.find((e) => e.value === h)?.value ?? e),
      r = x.find((e) => e.value === h)?.value ?? x[0]?.value ?? null;
    ((y = p === `local` ? N(n) : r == null ? null : N(r)),
      (t[2] = p),
      (t[3] = h),
      (t[4] = s),
      (t[5] = y),
  ...
  let j;
  t[23] !== o || t[24] !== d
    ? ((j = (0, q.jsx)(Pe, { id: o, checked: d, onCheckedChange: f })),
      (t[23] = o),
      (t[24] = d),
      (t[25] = j))
    : (j = t[25]);
  ...
  t[38] !== x
    ? ((I = d
        ? (0, q.jsxs)(`div`, {
            ...
            children: [
              (0, q.jsx)(Qn, { mode: p, canCreateWorktree: C, onChange: m }),
              (0, q.jsx)(`span`, {
  ...
  t[44] === r
    ? (B = t[45])
    : ((B = (0, q.jsx)(ie, { color: `secondary`, className: `ml-auto`, onClick: r, children: R })),
      (t[44] = r),
      (t[45] = B));
  let V = !w,
    te;
  ...
  t[47] === V
    ? (ne = t[48])
    : ((ne = (0, q.jsx)(ie, { type: `submit`, disabled: V, children: te })),
      (t[47] = V),
      (t[48] = ne));
  let H;
  t[49] !== L || t[50] !== B || t[51] !== ne
    ? ((H = (0, q.jsxs)(De, { className: `justify-start gap-2`, children: [L, B, ne] })),
      (t[49] = L),
      (t[50] = B),
      (t[51] = ne),
      (t[52] = H))
...
function Qn(e) {
  ...
  t[0] === a
    ? (s = t[1])
    : ((s = a.formatMessage(Ln.newWorktreeRequiresGitProject)), (t[0] = a), (t[1] = s));
  let c = s,
    l;
  t[2] === o
    ? (l = t[3])
    : ((l = (0, q.jsx)(o, { className: `icon-2xs shrink-0` })), (t[2] = o), (t[3] = l));
  let u = n === `worktree` ? Ln.newWorktree : Ln.workLocally,
    d;
  t[4] === u
    ? (d = t[5])
    : ((d = (0, q.jsx)(`span`, {
        className: `truncate text-left text-token-foreground`,
        children: (0, q.jsx)(z, { ...u }),
      })),
      (t[4] = u),
      (t[5] = d));
  let f;
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)(z, { ...Ln.workLocally })), (t[12] = g))
    : (g = t[12]);
  let _;
  t[13] !== m || t[14] !== h
    ? ((_ = (0, q.jsx)(Fe.Item, { LeftIcon: Le, RightIcon: m, onSelect: h, children: g })),
      (t[13] = m),
      (t[14] = h),
      (t[15] = _))
    : (_ = t[15]);
  let v = n === `worktree` ? ae : void 0,
    y = !r,
    b = r ? void 0 : c,
    x;
  t[16] === i
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, q.jsx)(z, { ...Ln.newWorktree })), (t[18] = S))
    : (S = t[18]);
  let C;
  ...
  return (
    t[24] !== _ || t[25] !== C || t[26] !== p
      ? ((w = (0, q.jsxs)(Ie, { contentWidth: `menuNarrow`, triggerButton: p, children: [_, C] })),
        (t[24] = _),
        (t[25] = C),
        (t[26] = p),
        (t[27] = w))
...
async function $n({ hostId: e, prompt: t, projectRoot: n, scope: r }) {
  let i = n === `~`,
    a = i
      ? await ve([`~`], { prompt: t })
      : { cwd: n, projectlessOutputDirectory: null, workspaceRoots: [n] };
  if (a.cwd == null) throw $(`Missing project root`, sn);
  if (i && a.projectlessOutputDirectory == null)
    throw $(`Missing projectless thread output directory`, sn);
  let { config: o } = await p(`read-config-for-host`, { hostId: e, includeLayers: !1, cwd: a.cwd }),
    s = I(V(`agent-mode-by-host-id`, {})[e] ?? `auto`, a.workspaceRoots, o);
...
async function er({ createPendingWorktree: e, hostId: t, prompt: n, projectRoot: r, scope: i }) {
  if (r === `~`) throw $(`Missing project root`, sn);
  let { config: a } = await p(`read-config-for-host`, { hostId: t, includeLayers: !1, cwd: r }),
...
function Q(e) {
  Promise.resolve(e).catch((e) => {
    h.debug(`MCP sandbox RPC failed`, { safe: {}, sensitive: { error: e } });
  });
}
function tr({
  frameElement: e,
...
function or(e) {
  let t = ln.safeParse(e.structuredContent);
...
async function sr({ hostId: e, mcpServerStatuses: t, server: n }) {
  let r = t?.data.find(({ name: e }) => e === n) ?? null;
  if (r != null) return r;
  let i =
    (await p(`list-mcp-server-status`, { hostId: e, cursor: null, limit: 100 })).data.find(
      ({ name: e }) => e === n,
    ) ?? null;
  if (i == null) throw $(`MCP server not found: ${n}`, sn);
  return i;
}
async function cr({
  conversationId: e,
  ...
  try {
    return await p(`call-mcp-tool`, c);
  } catch (e) {
    throw mr(e, `MCP tool call failed`);
  }
}
async function lr({ hostId: e, mcpAppScope: t, mcpServerStatuses: n, server: r, toolName: i }) {
  let a = n?.data.find(({ name: e }) => e === r) ?? (await sr({ hostId: e, server: r })),
    o = ur(a),
    s = kt({ mcpAppScope: t, server: r, tools: o });
  return { ...dr(() => At({ connectorId: s, server: r, toolName: i, tools: o })), serverStatus: a };
}
function ur(e) {
...
function mr(e, t) {
  ...
  return n.success
    ? $(n.data.message, n.data.code ?? sn, e)
...
function gr({ displayMode: e, hasNavigationHistory: t }) {
  return e === `inline` && t ? An : kn;
}
function _r(e) {
...
function yr() {
  return {
    ...
    device: { os: br(), platform: `native`, type: `desktop` },
  };
}
function br() {
...
function xr(e, t) {
  let n = e == null ? (t ?? jn) : Math.max(e, t ?? 0);
  return Math.min(Math.max(n, Mn), Nn);
}
function Sr(e) {
  try {
...
var Cr = C(),
  ...
  Dr = o(
    ...
    (e, { scope: t }) => ({
      ...
      queryFn: () => Ve(t, e.hostId, e.server, e.resourceUri),
      staleTime: 0,
    }),
    { key: kr },
  ),
  Or = o(
    ...
    ({ toolArguments: e, view: t }, { scope: n }) => ({
      ...
      queryFn: async () => He(n, t.hostId, t.server, t.tool.name, e),
      staleTime: 0,
    }),
    { key: Ar },
  );
...
function Ar({ toolArguments: e, view: t }) {
...
function Mr(e) {
  let t = (0, K.c)(73),
    ...
    u = l(d),
    f = l(ge),
    { data: p, error: m, isLoading: h } = i(Dr, s),
    g;
  t[0] !== c || t[1] !== s
    ? ((g = { toolArguments: c, view: s }), (t[0] = c), (t[1] = s), (t[2] = g))
    : (g = t[2]);
  let { data: v, error: y, isLoading: b } = i(Or, g),
    x = Je(p);
  se(`2957382457`);
  let S = qe({
      isDilEnabled: !1,
    ...
    C = S.kind === `html` ? S.renderData : null,
    w;
  t[3] !== s.server || t[4] !== s.tool
    ? ((w = Ot({ server: s.server, tool: s.tool })), (t[3] = s.server), (t[4] = s.tool), (t[5] = w))
    : (w = t[5]);
  let T = w,
    E;
  t[6] !== T ||
        ...
        switch (t.method) {
          case `tools/call`: {
            let e = Tr.parse(t.params),
              n = At({ connectorId: T, server: s.server, toolName: e.name, tools: s.serverTools });
            return He(u, s.hostId, s.server, n.name, wr.parse(e.arguments ?? {}));
          }
          case `resources/read`: {
            let e = Er.parse(t.params),
              n = await a?.(e);
            return n == null
              ? (Mt({
                ...
                Ve(u, s.hostId, s.server, e.uri))
              : { contents: [{ ...n, uri: e.uri }] };
          }
          case `tools/list`:
            return { tools: jt({ connectorId: T, server: s.server, tools: s.serverTools }) };
          case `resources/list`:
            return { resources: [] };
          case `resources/templates/list`:
  ...
  if (
    t[14] !== r ||
    t[15] !== T ||
    t[16] !== f.value.conversationId ||
    t[17] !== f.value.routeKind ||
    t[18] !== s.hostId ||
    t[19] !== s.server ||
    t[20] !== s.tool.name
  ) {
    ...
    let n;
    (t[26] !== e || t[27] !== s.hostId || t[28] !== s.server || t[29] !== s.tool.name
      ...
      : (n = t[30]),
      (k = mt(n.join(`:`))),
      (O = f.value.routeKind === `local-thread` ? f.value.conversationId : _(k)),
      (A = Nt({ connectorId: T, instanceFallbackId: k, server: s.server })),
      (t[14] = r),
      (t[15] = T),
      (t[16] = f.value.conversationId),
      (t[17] = f.value.routeKind),
      ...
      (t[22] = k),
      (t[23] = A));
  } else ((O = t[21]), (k = t[22]), (A = t[23]));
  let j = A,
    M;
  t[31] === n ? (M = t[32]) : ((M = te(`h-full min-h-0`, n)), (t[31] = n), (t[32] = M));
  let N;
  t[33] === k
    ? (N = t[34])
    : ((N = (0, q.jsx)(Rn, { isInlineExpanded: !0, mcpAppId: k })), (t[33] = k), (t[34] = N));
  let P = C?.csp ?? null,
    F = m ?? y,
    I = C?.html ?? null,
    L = h || b,
    R;
  t[35] !== s.resourceUri || t[36] !== s.tool.name
    ? ((R = { originResourceUri: s.resourceUri, originTool: s.tool.name }),
      (t[35] = s.resourceUri),
      (t[36] = s.tool.name),
      (t[37] = R))
    : (R = t[37]);
  let ee = C?.prefersBorder ?? !1,
    z = v ?? null,
    B = C?.widgetDomain ?? null,
    V;
  t[38] !== O ||
  t[39] !== k ||
  t[40] !== D ||
  ...
  t[53] !== s.title
    ? ((V = (0, q.jsx)(zn, {
        ...
        prefersBorder: ee,
        overrideMcpRequest: D,
        sandboxOriginScope: j,
        server: s.server,
        sidePanelIcon: null,
  ...
  t[63] !== m
    ...
    : (ne = t[64]);
  let H;
  t[65] === k ? (H = t[66]) : ((H = (0, q.jsx)(Vn, { mcpAppId: k })), (t[65] = k), (t[66] = H));
  let re;
  return (
    t[67] !== V || t[68] !== ne || t[69] !== H || t[70] !== M || t[71] !== N
      ? ((re = (0, q.jsxs)(`div`, {
