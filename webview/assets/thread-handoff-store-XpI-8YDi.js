...
import { ka as n } from "./thread-context-inputs.js";
import { n as r, r as i } from "./react.js";
import { t as a } from "./v4.js";
var o = e(),
  s = t({ activeOperationId: null, operations: [] });
function c(e) {
  return {
    ...e,
    status: `queued`,
...
function d() {
  ...
  e[6] === t
    ? (h = e[7])
    : ((h = (e, r) => {
        t((t) => ({ ...t, operations: t.operations.map((t) => (t.id === e ? n(t, r) : t)) }));
      }),
      (e[6] = t),
      (e[7] = h));
  let g = h,
...
//# sourceMappingURL=thread-handoff-store-XpI-8YDi.js.map
