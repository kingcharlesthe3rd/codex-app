...
function E() {
  ...
  return (
    e[0] === t
      ? (n = e[1])
      : ((n = A.some((e) => re({ path: e, end: !0 }, t.pathname) != null)), (e[0] = t), (e[1] = n)),
    n
  );
}
function D(e, t) {
    ...
    ((O = p()),
      ...
      (I = () => {
        ...
        e[0] !== i || e[1] !== n?.models
          ? ((o =
              n?.models.find(
                (e) => e.availabilityNux != null && !j.has(e.model) && !i.includes(e.model),
              ) ?? null),
            (e[0] = i),
            (e[1] = n?.models),
            (e[2] = o))
      ...
      (R = () => {
        ...
        let l = c,
          u;
        e[4] !== a || e[5] !== i?.models
          ? ((u = i?.models.find((e) => S(e, `priority`) && a.includes(e.model)) ?? null),
            (e[4] = a),
            (e[5] = i?.models),
            (e[6] = u))
          : (u = e[6]);
        ...
        return (
          e[7] === f
            ? (p = e[8])
            : ((p = f == null ? null : { model: f.model }), (e[7] = f), (e[8] = p)),
...
function pe(e, t, n) {
  ...
  let r =
    e.messages.find((e) => e.message_type === `announcement` && !t.has(e.message_id) && he(e, n)) ??
    null;
...
function ve() {
  ...
  e[0] !== n || e[1] !== f || e[2] !== t || e[3] !== u || e[4] !== l
    ? ((p = () => {
        f == null || n == null || (J(t, n, f), u(fe(l, n, f.message.created_at)));
      }),
      (e[0] = n),
      (e[1] = f),
      (e[2] = t),
