...
import { Zt as a } from "./use-host-config.js";
import {
  Ai as o,
  Mr as s,
  Ri as c,
...
import { o as Ce } from "./mcp-tool-item-content-utils-BXXv-vcm.js";
import { t as we } from "./thread-handoff-step-row.js";
import { n as Te, t as Ee } from "./patch-diff-stats-D.js";
var De = new WeakMap();
...
function V({ path: e, cwd: t }) {
  if (!e) return null;
  let n = u(e);
  return n.length === 0 ? null : t == null ? n : u(A(t, n));
}
function H(e) {
...
var tt = x({ tabId: w().int().nonnegative() }),
  nt = [{ getCompletedSummaryPartKey: it, namespace: c, render: rt, tool: o }];
function rt(e, t) {
