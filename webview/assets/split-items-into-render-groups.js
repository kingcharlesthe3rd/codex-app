...
import { _ as d, f } from "./vscode-api.js";
import { Ar as p, Xi as m, Zi as h, ft as g, ht as _, na as v, ra as y, ta as b } from "./src-1.js";
...
import { p as O } from "./format-skill-title.js";
import "./thread-detail-level.js";
import { t as k } from "./settings.cog.js";
import { t as A } from "./codex-Cx4-XOqq.js";
import {
  C as j,
  S as ee,
  a as M,
...
function B({ path: e, cwd: t }) {
  if (!e) return null;
  let n = a(e);
  return n.length === 0 ? null : t == null ? n : a(D(t, n));
}
function V(e) {
...
function Ae(
  ...
  if (o.type === `patch`) return { ...Ie(o, a), ...U(o.automaticApprovalReviews) };
  if (o.type === `exec`) {
    if (
      Me(o, i) ||
  ...
  if (o.type === `mcp-tool-call`)
    return r === !0 && H({ item: o, mcpServerStatuses: t })
      ? { type: `other` }
      : {
          type: `mcp-tool-call`,
  ...
  for (let u of e.items)
    if (u.type === `exec`) {
      ...
      if (u.parsedCmd.type === `read`) {
        let e = Le(u.parsedCmd.path ?? u.parsedCmd.name, u.cwd);
        if (R({ summary: u.parsedCmd, cwd: u.cwd })) {
...
function Be(e) {
  let t = (0, W.c)(31),
    ...
    a = !n.completed,
    o;
  t[0] === r ? (o = t[1]) : ((o = () => Ve(r)), (t[0] = r), (t[1] = o));
  let s;
  t[2] !== n.callId || t[3] !== r
  ...
  t[14] !== m || t[15] !== h || t[16] !== g
    ? ((_ = w(`text-size-chat min-w-0 items-center`, m, h, g)),
      (t[14] = m),
      (t[15] = h),
      (t[16] = g),
      (t[17] = _))
  ...
  let y = !n.completed,
    ...
    x;
  t[21] === b ? (x = t[22]) : ((x = w(b)), (t[21] = b), (t[22] = x));
  let C;
  t[23] !== p || t[24] !== y || t[25] !== x
    ? ((C = (0, G.jsx)(F, { active: y, className: x, children: p })),
      (t[23] = p),
      (t[24] = y),
      (t[25] = x),
      (t[26] = C))
  ...
  let T;
  return (
    t[27] !== C || t[28] !== _ || t[29] !== v
      ? ((T = (0, G.jsxs)(`span`, { className: _, children: [v, C] })),
        (t[27] = C),
        (t[28] = _),
        (t[29] = v),
        (t[30] = T))
...
var We = b({ tabId: m().int().nonnegative() }),
  Ge = [{ getCompletedSummaryPartKey: qe, namespace: s, render: Ke, tool: c }];
function Ke(e, t) {
  let n = We.safeParse(e.arguments);
  return n.success ? (0, G.jsx)(Be, { item: e, tabId: n.data.tabId, variant: t }) : null;
}
function qe(e) {
  return We.safeParse(e.arguments).success ? e.callId : null;
}
var Je = [
  { namespace: P, render: Ye, tool: j },
  { namespace: P, render: Xe, tool: se },
];
function Ye(e, t) {
  return Ze(e, e.completed ? `readCompleted` : `readActive`, t);
}
function Xe(e, t) {
  return Ze(e, e.completed ? `writeCompleted` : `writeActive`, t);
}
function Ze(e, t, n) {
  return (0, G.jsxs)(`span`, {
    ...
    children: [
      n === `summary-text`
        ? null
        : (0, G.jsx)(k, { className: `icon-xs shrink-0 text-token-text-secondary` }),
      (0, G.jsx)(F, {
        active: !e.completed,
        className: w(n !== `summary-text` && `min-w-0 truncate`),
        children: (0, G.jsx)(S, { ...Qe[t] }),
      }),
    ],
  });
}
var Qe = C({
  ...
  $e = e(t(), 1),
  et = h({ destinationHostDisplayName: v().min(1), threadTitle: v().min(1) });
function tt(e) {
  let t = (0, W.c)(56),
    { item: n, variant: r } = e,
    a = i(ee, n.callId),
  ...
  t[0] !== n.completed || t[1] !== n.contentItems || t[2] !== n.success
    ? ((o = n.completed && n.success === !0 ? rt(n.contentItems ?? null) : null),
      (t[0] = n.completed),
      (t[1] = n.contentItems),
      (t[2] = n.success),
      (t[3] = o))
  ...
  if (r !== `row`) {
    ...
    t[8] === r
      ...
      : ((a =
          r === `summary-text`
            ? null
            : (0, G.jsx)(A, { className: `icon-xs shrink-0 text-token-text-secondary` })),
        (t[8] = r),
        (t[9] = a));
    let o = !n.completed,
      s = r !== `summary-text` && `min-w-0 truncate`,
      u;
    t[10] === s ? (u = t[11]) : ((u = w(s)), (t[10] = s), (t[11] = u));
    let d;
    ...
    t[17] !== o || t[18] !== u || t[19] !== d
      ? ((f = (0, G.jsx)(F, { active: o, className: u, children: d })),
        (t[17] = o),
        (t[18] = u),
        (t[19] = d),
        (t[20] = f))
    ...
    return (
      t[21] !== f || t[22] !== i || t[23] !== a
        ? ((p = (0, G.jsxs)(`span`, { className: i, children: [a, f] })),
          (t[21] = f),
          (t[22] = i),
          (t[23] = a),
          (t[24] = p))
  ...
  t[25] === v
    ? (y = t[26])
    : ((y = w(`group flex min-w-0 items-center gap-2 text-left`, v)), (t[25] = v), (t[26] = y));
  let b = !h,
    x;
  t[27] === d ? (x = t[28]) : ((x = () => f(!d)), (t[27] = d), (t[28] = x));
  let S;
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, G.jsx)(A, { className: `icon-xs shrink-0 text-token-text-secondary` })),
      (t[29] = S))
    : (S = t[29]);
  let C = !n.completed,
    D;
  ...
  t[38] !== h || t[39] !== g
    ...
    : (k = t[40]);
  let j;
  t[41] !== O || t[42] !== k || t[43] !== _ || t[44] !== y || t[45] !== b || t[46] !== x
    ? ((j = (0, G.jsxs)(`button`, {
        type: `button`,
        "aria-expanded": _,
        className: y,
  ...
  return (
    t[53] !== j || t[54] !== M
      ? ((N = (0, G.jsxs)(`div`, { className: `my-1 min-w-0`, children: [j, M] })),
        (t[53] = j),
        (t[54] = M),
        (t[55] = N))
      : (N = t[55]),
...
function it(e) {
  let t = (0, W.c)(19),
    ...
    a;
  t[0] !== r || t[1] !== i
    ? ((a = r.formatMessage(i ? K.openWorktreeSetup : K.openCreatedThread)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a))
    : (a = t[2]);
  ...
  t[3] !== i || t[4] !== n.pendingWorktreeId || t[5] !== n.threadId
    ? ((s = () => {
        f.dispatchHostMessage({
          ...
          path: i ? _(n.pendingWorktreeId) : g(p(n.threadId)),
        });
      }),
      (t[3] = i),
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, G.jsx)(`span`, {
        ...
        children: (0, G.jsx)(ue, { className: `icon-sm`, "aria-hidden": !0 }),
      })),
      (t[7] = l))
    : (l = t[7]);
  let u = i ? K.worktreeThreadQueued : K.threadCreated,
    d;
  t[8] === u ? (d = t[9]) : ((d = (0, G.jsx)(S, { ...u })), (t[8] = u), (t[9] = d));
  let m = i ? K.openSetup : K.openThread,
    h;
  t[10] === m
    ? (h = t[11])
    : ((h = (0, G.jsx)(pe, { label: (0, G.jsx)(S, { ...m }) })), (t[10] = m), (t[11] = h));
  let v;
  t[12] !== d || t[13] !== h
    ? ((v = (0, G.jsx)(fe, { icon: l, title: d, trailing: h })),
      (t[12] = d),
      (t[13] = h),
      (t[14] = v))
    : (v = t[14]);
...
var K = C({
  ...
  at = h({ target: h({ type: v(), environment: h({ type: v() }).optional() }) }),
  ot = h({ environment: h({ type: v() }).optional() }),
  st = h({ destinationHostId: v().min(1).optional(), threadId: v().min(1) }),
  ct = y([h({ threadId: v().min(1) }), h({ pendingWorktreeId: v().min(1) })]),
  lt = [
    { getCompletedSummaryPartKey: J, namespace: P, render: q, tool: te },
    { getCompletedSummaryPartKey: J, namespace: P, render: q, tool: ie },
    { getCompletedSummaryPartKey: dt, namespace: P, render: ut, tool: ce },
    { continuesLiveActivityBetweenCalls: !0, namespace: P, render: q, tool: M },
    { continuesLiveActivityBetweenCalls: !0, namespace: P, render: q, tool: re },
    { namespace: P, render: q, tool: ae },
    { namespace: P, render: q, tool: ne },
    { namespace: P, render: q, tool: N },
    { namespace: P, render: q, tool: oe },
  ];
function ut(e, t) {
  return st.safeParse(e.arguments).success ? (0, G.jsx)(tt, { item: e, variant: t }) : null;
}
function dt(e) {
  let t = st.safeParse(e.arguments);
  ...
  return r == null
    ? (0, G.jsxs)(`span`, {
        ...
        children: [
          ...
          (0, G.jsx)(F, {
            active: !e.completed,
            className: w(t !== `summary-text` && `min-w-0 truncate`),
            children: (0, G.jsx)(S, { ...pt[n] }),
          }),
        ],
      })
    : (0, G.jsx)(it, { result: r });
...
function J(e) {
  switch (e.tool) {
    case te: {
      let t = ot.safeParse(e.arguments);
      return t.success
...
var pt = C({
  ...
  mt = [...Ge, ...lt, ...Je];
function Y(e) {
  return mt.find((t) => t.namespace === e.namespace && t.tool === e.tool);
}
function ht(e) {
  return Y(e)?.continuesLiveActivityBetweenCalls === !0;
}
function gt(e) {
  let t = Y(e)?.getCompletedSummaryPartKey?.(e);
  return `${e.namespace}:${e.tool}:${t ?? ``}`;
}
function _t({ items: e, isActive: t }) {
  if (!t) return !1;
  if (e.some((e) => !e.completed)) return !0;
  let n = e.at(-1);
  return n != null && ht(n);
}
function vt({ items: e, keepLatestLiveActivityInGroup: t }) {
  let n = e.at(-1);
  return e.length > 1 || (t && n != null && ht(n));
}
function yt({ units: e, isActivitySliceClosed: t }) {
  let n = [],
    r = bt(e, t);
  for (let { startIndex: t, endIndex: i } of r) {
    ...
    for (; r < i; ) {
      ...
      for (; r < i; ) {
        let t = e[r];
        if (t == null || !xt(t)) break;
        (Ct(o, t), (r += 1));
      }
      n.push({ startIndex: a, endIndex: r, summary: wt(o) });
    }
  }
  return n;
}
...
function Ct(e, t) {
  if (t.type === `exploration`) {
    X(e, t.automaticApprovalReviewFailures);
  ...
  if (t.type === `exec`) {
    if ((X(e, t.automaticApprovalReviewFailures), (e.commandCount += 1), t.isInProgress)) {
  ...
  if (t.type === `mcp-tool-call`) {
    if ((X(e, t.automaticApprovalReviewFailures), (e.mcpToolCallCount += 1), t.source != null)) {
...
function At({
  ...
  for (let t = 0; t < e.length; ) {
    ...
    for (; l < e.length; ) {
      let t = Vt(e[l]);
      if (t == null || Bt(t, n, r)) break;
      let a = zt({ item: t, resolvedApps: i });
      if (c != null && a !== c) break;
      ((c = a), s.push(t), (l += 1));
    }
...
function jt({ units: e, keepLatestLiveActivityInGroup: t = !1 }) {
  let n = [];
  for (let r = 0; r < e.length; ) {
    ...
    if (vt({ items: i, keepLatestLiveActivityInGroup: t && a === e.length })) {
...
function Lt({
  ...
  let c = e.map((e) =>
    ...
    l = [...yt({ units: c, isActivitySliceClosed: t })];
  if (!t) {
    let e = Ut(c),
      t = [];
    ...
    for (let n of yt({ units: t, isActivitySliceClosed: !0 }))
  ...
  for (let r = 0; r < e.length; ) {
    ...
    if (i && r === i.startIndex) {
      ...
      if (o != null) {
        let e = Rt({ groupedUnits: a, isCurrentToolActivity: s, summary: i.summary });
        u.push({ kind: `collapsed-tool-activity`, key: kt(o, i.startIndex), units: a, summary: e });
      }
      ((r = i.endIndex), (d += 1));
      continue;
    }
...
function Rt({ groupedUnits: e, isCurrentToolActivity: t, summary: n }) {
  return !t || e.at(-1)?.kind !== `web-search-group`
    ? n
    : { ...n, runningWebSearchCount: n.webSearchCount };
}
function zt({ item: e, resolvedApps: t }) {
  let n = u({ item: e });
...
var Wt = e(l(), 1);
function Gt({ agentItems: e, isTurnInProgress: t, isAnyNonAgentItemInProgress: n }) {
  let r = [],
    i = null,
    a = !1,
    o = !1,
...
function Jt(e, t) {
  ...
  let O = w[w.length - 1],
    k = t !== `in_progress` && !D && nn(O) ? O : null;
  k && w.pop();
  let A = E != null && E.completed && p.length > 0 ? { ...E, automationCitations: p } : E;
  return {
    userItems: i,
    agentItems: w,
...
var Yt = (e) => e.type === `patch` && e.approvalRequestId != null && e.success == null,
  Xt = (e) => e.type === `exec` && e.approvalRequestId != null && e.output?.exitCode === void 0,
  Zt = (e) => e?.type === `assistant-message`,
  Qt = (e) => {
    let t = [];
    for (;;) {
      let n = e[e.length - 1];
