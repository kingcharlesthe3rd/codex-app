...
import { Qr as t, ca as n, na as r, oa as i, sa as a, st as o, ta as s, ut as c } from "./src-2.js";
import {
  Qi as l,
  Rr as u,
  Zi as d,
...
import { P as b, f as x, lt as S, v as C } from "./vscode-api.js";
...
import { t as le } from "./animations-D-vdA-0W.js";
...
var U = `browser-use`;
function De({ units: e, isActivitySliceClosed: t }) {
  let n = [],
    r = Oe(e, t);
  for (let { startIndex: t, endIndex: i } of r) {
    ...
    for (; r < i; ) {
      ...
      for (; r < i; ) {
        let t = e[r];
        if (t == null || !ke(t)) break;
        (je(o, t), (r += 1));
      }
      n.push({ startIndex: a, endIndex: r, summary: Me(o) });
    }
  }
  return n;
}
...
var Ne = /(?:^|\s)(?:-X\s*|--request(?:=|\s+))(?:POST|PUT|PATCH|DELETE)\b/i,
  Pe = /(?:^|\s)(?:--data(?:-[^\s=]+)?|--json|--form|--upload-file)(?:=|\s|$)/,
  Fe = /(?:^|\s)-(?:d|F|T)(?:=|\s|$)/;
function Ie(
  e,
  {
  ...
  return o.type === `mcp-tool-call`
    ? r === !0 && H({ item: o, mcpServerStatuses: t })
      ? { type: `other` }
      : { type: `mcp-tool-call`, isInProgress: !o.completed, source: Le(o, n) }
...
function Le(e, t) {
  if (u(e)) return { logoUrl: null, logoUrlDark: null, name: U };
  let n = I({
    apps: t,
...
function ze(e) {
  if (!/^\s*curl(?:\s|$)/.test(e) || Ne.test(e) || Pe.test(e) || Fe.test(e)) return !1;
  let t = e.match(/\bhttps?:\/\/[^\s'"<>]+/gi);
  return t == null ? !1 : t.some(Be);
}
function Be(e) {
  try {
  ...
  for (let s of e.items)
    if (s.type === `exec`) {
      ...
      if (s.parsedCmd.type === `read`) {
        let e = Ue(s.parsedCmd.path ?? s.parsedCmd.name, s.cwd);
...
function He(e, t) {
  ...
  for (let [u, d] of Object.entries(e.changes)) {
    if (d.type === `add`) {
      (n.push(u),
        e.success == null && t ? i.push(u) : (e.success ?? (r.push(u), (a += We(d.content)))));
      continue;
    }
    if (d.type === `delete`) {
...
function Ge(e) {
  ...
  t[2] !== c || t[3] !== o || t[4] !== a || t[5] !== n
    ? ((d =
        c === n || (a && o !== n)
          ? (0, K.jsx)(de, { "aria-hidden": !0, className: `h-full w-full` })
          : null),
      (t[2] = c),
      (t[3] = o),
      (t[4] = a),
  ...
  return (
    t[11] !== u || t[12] !== d || t[13] !== f
      ? ((p = (0, K.jsxs)(`span`, { className: u, children: [d, f] })),
        (t[11] = u),
        (t[12] = d),
        (t[13] = f),
        (t[14] = p))
...
function Ke(e) {
  ...
  t[23] !== f || t[24] !== v || t[25] !== x
    ? ((S = (0, K.jsx)(F, { active: v, className: x, children: f })),
      (t[23] = f),
      (t[24] = v),
      (t[25] = x),
      (t[26] = S))
  ...
  let w;
  return (
    t[27] !== S || t[28] !== g || t[29] !== _
      ? ((w = (0, K.jsxs)(`span`, { className: g, children: [_, S] })),
        (t[27] = S),
        (t[28] = g),
        (t[29] = _),
        (t[30] = w))
...
async function qe(e) {
  ...
  try {
    ...
    return { faviconUrl: Ye(n, t), title: Ze(n) };
  } catch {
    return null;
  }
}
...
var Qe = i({ tabId: s().int().nonnegative() }),
  $e = [{ getCompletedSummaryPartKey: tt, namespace: l, render: et, tool: d }];
function et(e, t) {
  let n = Qe.safeParse(e.arguments);
  return n.success ? (0, K.jsx)(Ke, { item: e, tabId: n.data.tabId, variant: t }) : null;
}
function tt(e) {
  return Qe.safeParse(e.arguments).success ? e.callId : null;
}
var nt = [
  { namespace: P, render: rt, tool: A },
  { namespace: P, render: it, tool: se },
];
function rt(e, t) {
  return at(e, e.completed ? `readCompleted` : `readActive`, t);
}
function it(e, t) {
  return at(e, e.completed ? `writeCompleted` : `writeActive`, t);
}
function at(e, t, n) {
  return (0, K.jsxs)(`span`, {
    ...
    children: [
      n === `summary-text`
        ? null
        : (0, K.jsx)(O, { className: `icon-xs shrink-0 text-token-text-secondary` }),
      (0, K.jsx)(F, {
        active: !e.completed,
        className: y(n !== `summary-text` && `min-w-0 truncate`),
        children: (0, K.jsx)(T, { ...ot[t] }),
      }),
    ],
  });
}
var ot = E({
  ...
  st = r({ destinationHostDisplayName: a().min(1), threadTitle: a().min(1) });
function ct(e) {
  let t = (0, W.c)(56),
    { item: n, variant: r } = e,
    i = b(te, n.callId),
  ...
  t[0] !== n.completed || t[1] !== n.contentItems || t[2] !== n.success
    ? ((a = n.completed && n.success === !0 ? ut(n.contentItems ?? null) : null),
      (t[0] = n.completed),
      (t[1] = n.contentItems),
      (t[2] = n.success),
      (t[3] = a))
    : (a = t[3]);
  let o = a,
    s = i?.threadTitle ?? o?.threadTitle ?? null,
    c = i?.destinationHostDisplayName ?? o?.destinationHostDisplayName ?? null,
    l;
  t[4] === n.completed ? (l = t[5]) : ((l = () => !n.completed), (t[4] = n.completed), (t[5] = l));
  let [u, d] = (0, G.useState)(l),
    { elementHeightPx: f, elementRef: p } = _e(),
    m = i != null && i.steps.length > 0,
    h = m && u;
  if (r !== `row`) {
    ...
    t[8] === r
      ...
      : ((a =
          r === `summary-text`
            ? null
            : (0, K.jsx)(k, { className: `icon-xs shrink-0 text-token-text-secondary` })),
        (t[8] = r),
        (t[9] = a));
    let o = !n.completed,
      l = r !== `summary-text` && `min-w-0 truncate`,
      u;
    t[10] === l ? (u = t[11]) : ((u = y(l)), (t[10] = l), (t[11] = u));
    let d;
    t[12] !== c || t[13] !== n.completed || t[14] !== n.success || t[15] !== s
      ? ((d = (0, K.jsx)(lt, {
    ...
    t[17] !== o || t[18] !== u || t[19] !== d
      ? ((f = (0, K.jsx)(F, { active: o, className: u, children: d })),
        (t[17] = o),
        (t[18] = u),
        (t[19] = d),
        (t[20] = f))
    ...
    return (
      t[21] !== f || t[22] !== i || t[23] !== a
        ? ((p = (0, K.jsxs)(`span`, { className: i, children: [a, f] })),
          (t[21] = f),
          (t[22] = i),
          (t[23] = a),
          (t[24] = p))
  ...
  let g = m ? h : void 0,
    _ = m && `cursor-interaction`,
    v;
  t[25] === _
    ? (v = t[26])
    : ((v = y(`group flex min-w-0 items-center gap-2 text-left`, _)), (t[25] = _), (t[26] = v));
  let x = !m,
    S;
  t[27] === u ? (S = t[28]) : ((S = () => d(!u)), (t[27] = u), (t[28] = S));
  let C;
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (0, K.jsx)(k, { className: `icon-xs shrink-0 text-token-text-secondary` })),
      (t[29] = C))
    : (C = t[29]);
  let w = !n.completed,
    T;
  t[30] !== c || t[31] !== n.completed || t[32] !== n.success || t[33] !== s
    ? ((T = (0, K.jsx)(lt, {
        completed: n.completed,
        destinationHostDisplayName: c,
        success: n.success,
  ...
  t[38] !== m || t[39] !== h
    ...
    : (O = t[40]);
  let A;
  t[41] !== E || t[42] !== O || t[43] !== g || t[44] !== v || t[45] !== x || t[46] !== S
    ? ((A = (0, K.jsxs)(`button`, {
        type: `button`,
        "aria-expanded": g,
        className: v,
    ...
    : (A = t[47]);
  let j;
  t[48] !== f || t[49] !== p || t[50] !== h || t[51] !== i
    ? ((j =
        i == null
          ? null
          : (0, K.jsx)(D.div, {
              initial: !1,
              animate: { height: h ? f : 0, opacity: h ? 1 : 0 },
              "aria-hidden": !h,
              className: h ? `overflow-visible` : `overflow-hidden`,
              style: { pointerEvents: h ? `auto` : `none` },
              transition: le,
              children: (0, K.jsx)(`div`, {
                ref: p,
                className: `flex flex-col gap-2 pt-2 pb-1 pl-6`,
                children: i.steps.map((e) =>
                  (0, K.jsx)(
                    ge,
                    {
                      compact: !0,
                      direction: i.direction,
                      localBranch: i.localBranch,
  ...
  return (
    t[53] !== A || t[54] !== j
      ? ((M = (0, K.jsxs)(`div`, { className: `my-1 min-w-0`, children: [A, j] })),
        (t[53] = A),
        (t[54] = j),
        (t[55] = M))
      : (M = t[55]),
...
function dt(e) {
  let n = (0, W.c)(19),
    { result: r } = e,
    i = w(),
    a = `pendingWorktreeId` in r,
    s;
  n[0] !== i || n[1] !== a
    ? ((s = i.formatMessage(a ? q.openWorktreeSetup : q.openCreatedThread)),
      (n[0] = i),
      (n[1] = a),
      (n[2] = s))
    : (s = n[2]);
  let l = s,
    u;
  n[3] !== a || n[4] !== r.pendingWorktreeId || n[5] !== r.threadId
    ? ((u = () => {
        x.dispatchHostMessage({
          type: `navigate-to-route`,
          path: a ? c(r.pendingWorktreeId) : o(t(r.threadId)),
        });
      }),
      (n[3] = a),
      (n[4] = r.pendingWorktreeId),
      (n[5] = r.threadId),
      (n[6] = u))
    : (u = n[6]);
  let d = u,
  ...
  n[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, K.jsx)(`span`, {
        ...
        children: (0, K.jsx)(ue, { className: `icon-sm`, "aria-hidden": !0 }),
      })),
      (n[7] = f))
    : (f = n[7]);
  let p = a ? q.worktreeThreadQueued : q.threadCreated,
    m;
  n[8] === p ? (m = n[9]) : ((m = (0, K.jsx)(T, { ...p })), (n[8] = p), (n[9] = m));
  let h = a ? q.openSetup : q.openThread,
    g;
  n[10] === h
    ? (g = n[11])
    : ((g = (0, K.jsx)(pe, { label: (0, K.jsx)(T, { ...h }) })), (n[10] = h), (n[11] = g));
  let _;
  n[12] !== m || n[13] !== g
    ? ((_ = (0, K.jsx)(fe, { icon: f, title: m, trailing: g })),
      (n[12] = m),
      (n[13] = g),
      (n[14] = _))
    : (_ = n[14]);
...
var q = E({
  ...
  ft = r({ target: r({ type: a(), environment: r({ type: a() }).optional() }) }),
  pt = r({ environment: r({ type: a() }).optional() }),
  mt = r({ destinationHostId: a().min(1).optional(), threadId: a().min(1) }),
  ht = n([r({ threadId: a().min(1) }), r({ pendingWorktreeId: a().min(1) })]),
  gt = [
    { getCompletedSummaryPartKey: Y, namespace: P, render: J, tool: ne },
    { getCompletedSummaryPartKey: Y, namespace: P, render: J, tool: ie },
    { getCompletedSummaryPartKey: vt, namespace: P, render: _t, tool: ce },
    { continuesLiveActivityBetweenCalls: !0, namespace: P, render: J, tool: j },
    { continuesLiveActivityBetweenCalls: !0, namespace: P, render: J, tool: re },
    { namespace: P, render: J, tool: ae },
    { namespace: P, render: J, tool: N },
    { namespace: P, render: J, tool: M },
    { namespace: P, render: J, tool: oe },
  ];
function _t(e, t) {
  return mt.safeParse(e.arguments).success ? (0, K.jsx)(ct, { item: e, variant: t }) : null;
}
function vt(e) {
  let t = mt.safeParse(e.arguments);
...
function Y(e) {
  switch (e.tool) {
    case ne: {
      let t = pt.safeParse(e.arguments);
      return t.success
    ...
    case ie: {
      let t = ft.safeParse(e.arguments);
      return t.success
...
var bt = E({
  ...
  xt = [...$e, ...gt, ...nt];
function X(e) {
  return xt.find((t) => t.namespace === e.namespace && t.tool === e.tool);
}
function St(e) {
...
function wt({ items: e, isActive: t }) {
  if (!t) return !1;
  if (e.some((e) => !e.completed)) return !0;
  let n = e.at(-1);
  return n != null && St(n);
}
function Tt({ items: e, keepLatestLiveActivityInGroup: t }) {
  let n = e.at(-1);
  return e.length > 1 || (t && n != null && St(n));
}
function Et(e) {
  let t = [],
    n = [],
...
function Ot({
  ...
  for (let t = 0; t < e.length; ) {
    ...
    for (; c < e.length; ) {
      let t = Bt(e[c]);
      if (t == null || zt(t, n, r)) break;
      let a = Rt({ item: t, resolvedApps: i });
      if (s != null && a !== s) break;
      ((s = a), o.push(t), (c += 1));
    }
    if (o.length > 1) {
...
function kt({ units: e, keepLatestLiveActivityInGroup: t = !1 }) {
  let n = [];
  for (let r = 0; r < e.length; ) {
    ...
    if (Tt({ items: i, keepLatestLiveActivityInGroup: t && a === e.length })) {
...
function Ft({
  ...
  let c = e.map((e) =>
    ...
    l = [...De({ units: c, isActivitySliceClosed: t })];
  if (!t) {
    let e = Ht(c),
      t = [];
    ...
    for (let n of De({ units: t, isActivitySliceClosed: !0 }))
  ...
  for (let r = 0; r < e.length; ) {
    ...
    if (i && r === i.startIndex) {
      ...
      if (o != null) {
        let e = It({ groupedUnits: a, isCurrentToolActivity: s, summary: i.summary });
...
function It({ groupedUnits: e, isCurrentToolActivity: t, summary: n }) {
...
function Rt({ item: e, resolvedApps: t }) {
  if (e.source === `browser-use`) return U;
  if (t != null) {
    let n = I({
      apps: t,
      functionName: e.functionName,
...
var Ut = e(m(), 1);
function Wt({ agentItems: e, isTurnInProgress: t, isAnyNonAgentItemInProgress: n }) {
  let r = [],
    i = null,
    a = !1,
    o = !1,
...
function qt(e, t) {
  ...
  let D = C[C.length - 1],
    O = t !== `in_progress` && !E && $t(D) ? D : null;
  O && C.pop();
  let k = T != null && T.completed && p.length > 0 ? { ...T, automationCitations: p } : T;
  return {
    userItems: i,
    agentItems: C,
...
var Jt = (e) => e.type === `patch` && e.approvalRequestId != null && e.success == null,
  Yt = (e) => e.type === `exec` && e.approvalRequestId != null && e.output?.exitCode === void 0,
  Xt = (e) => e?.type === `assistant-message`,
  Zt = (e) => {
    let t = [];
    for (;;) {
      let n = e[e.length - 1];
