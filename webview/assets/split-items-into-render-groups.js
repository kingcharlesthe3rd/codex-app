...
import { a as r, z as i } from "./app-scope.js";
import {
  Ar as a,
  Mo as o,
  Sa as s,
...
import { i as w, l as T, s as E } from "./lib.js";
import { t as D } from "./clsx-Cir5-jBH.js";
import { t as O } from "./proxy.js";
import { t as k } from "./chevron-right.js";
import { m as A } from "./format-skill-title.js";
import { I as j } from "./rpc-Hf-fxjh7.js";
import { t as ee } from "./animations.js";
import { t as te } from "./codex-Dw-qSlib.js";
...
import { t as he } from "./chat.js";
import { t as ge } from "./web-search-favicon-icon.js";
import { t as _e } from "./comment-B.js";
import { i as ve, r as ye, t as be } from "./thread-resource-card.js";
import { o as xe } from "./mcp-tool-item-content-utils.js";
import { t as Se } from "./thread-handoff-step-row.js";
import { n as Ce, t as we } from "./patch-diff-stats.js";
var Te = new WeakMap();
...
function Ee(e) {
  ...
  let n = [
    ...
    r = n.filter((e, t) => (e.length === 0 ? !1 : n.findIndex((t) => De(t, e)) === t));
  return (Te.set(e, r), r);
}
function R(e) {
  return e
...
function ke({ summary: e, cwd: t, intl: n, threadDetailLevel: r, formatSearchQuery: i }) {
  ...
  switch (e.type) {
    case `read`:
      return a.isSkillDefinitionFile
        ? r === `STEPS_PROSE`
          ? Ae({ skillName: a.skillName, isFinished: e.isFinished, intl: n })
          : n.formatMessage(
              {
...
function Ae({ skillName: e, isFinished: t, intl: n }) {
  return t
    ? n.formatMessage(
        {
...
function B({ summary: e, cwd: t }) {
  let n = je({ summary: e, cwd: t });
  return n ? u(n) : null;
}
function je({ summary: e, cwd: t }) {
  switch (e.type) {
    case `read`:
...
function V({ path: e, cwd: t }) {
  if (!e) return null;
  let n = a(e);
  return n.length === 0 ? null : t == null ? n : a(j(t, n));
}
function H(e) {
  throw Error(`Unexpected value: ${String(e)}`);
}
function Me({ item: e, mcpServerStatuses: t }) {
...
function U({ item: e, mcpServerStatuses: t }) {
  return Me({ item: e, mcpServerStatuses: t }) !== `not-mcp-app`;
}
function Ne(e) {
  return e.some(
    (e) =>
...
function Pe({ entries: e, mcpServerStatuses: t }) {
  return e.some(
    (e) =>
      e.kind === `item` &&
      e.item.type === `mcp-tool-call` &&
      U({ item: e.item, mcpServerStatuses: t }),
  );
}
var Fe = /(?:^|\s)(?:-X\s*|--request(?:=|\s+))(?:POST|PUT|PATCH|DELETE)\b/i,
  Ie = /(?:^|\s)(?:--data(?:-[^\s=]+)?|--json|--form|--upload-file)(?:=|\s|$)/,
  Le = /(?:^|\s)-(?:d|F|T)(?:=|\s|$)/;
function Re(
  e,
  {
  ...
  if (e.entry.kind === `exploration`) return Ue(e.entry);
  let o = e.entry.item;
  if (o.type === `assistant-message`) return { type: `assistant-message` };
  if (o.type === `patch`) return { ...We(o, a), ...W(o.automaticApprovalReviews) };
  if (o.type === `exec`) {
    if (
      Be(o, i) ||
    ...
    let e = !o.parsedCmd.isFinished,
      ...
      r = t != null && !1,
      a = t != null && Ve(t),
      s = W(o.automaticApprovalReviews);
    return r
  ...
  if (o.type === `mcp-tool-call`)
    return r === !0 && U({ item: o, mcpServerStatuses: t })
      ? { type: `other` }
      : {
          type: `mcp-tool-call`,
          isInProgress: !o.completed,
          source: ze(o, n),
          ...W(o.automaticApprovalReviews),
        };
...
function Ve(e) {
  if (!/^\s*curl(?:\s|$)/.test(e) || Fe.test(e) || Ie.test(e) || Le.test(e)) return !1;
  let t = e.match(/\bhttps?:\/\/[^\s'"<>]+/gi);
  return t == null ? !1 : t.some(He);
}
function He(e) {
  try {
  ...
  for (let u of e.items)
    if (u.type === `exec`) {
      ...
      if (u.parsedCmd.type === `read`) {
        let e = Ge(u.parsedCmd.path ?? u.parsedCmd.name, u.cwd);
...
function We(e, t) {
  ...
  for (let [f, p] of Object.entries(e.changes)) {
    ...
    if (((o += (m?.added ?? 0) + (m?.deleted ?? 0)), p.type === `add`)) {
      (n.push(f),
        e.success == null && t ? i.push(f) : (e.success ?? (r.push(f), (a += Ke(p.content)))));
      continue;
    }
    if (p.type === `delete`) {
      (l.push(f), e.success ?? u.push(f));
      continue;
    }
    (s.push(f), e.success ?? c.push(f));
  }
  return {
    type: `patch`,
    createdPaths: n,
...
function Je(e) {
  let t = (0, G.c)(31),
    ...
    a = !n.completed,
    o;
  t[0] === r ? (o = t[1]) : ((o = () => Ye(r)), (t[0] = r), (t[1] = o));
  let s;
  t[2] !== n.callId || t[3] !== r
  ...
  t[14] !== p || t[15] !== h || t[16] !== g
    ? ((_ = D(`text-size-chat min-w-0 items-center`, p, h, g)),
      (t[14] = p),
      (t[15] = h),
      (t[16] = g),
      (t[17] = _))
  ...
  let y = !n.completed,
    ...
    x;
  t[21] === b ? (x = t[22]) : ((x = D(b)), (t[21] = b), (t[22] = x));
  let S;
  t[23] !== f || t[24] !== y || t[25] !== x
    ? ((S = (0, K.jsx)(I, { active: y, className: x, children: f })),
      (t[23] = f),
      (t[24] = y),
      (t[25] = x),
      (t[26] = S))
  ...
  return (
    t[27] !== S || t[28] !== _ || t[29] !== v
      ? ((C = (0, K.jsxs)(`span`, { className: _, children: [v, S] })),
        (t[27] = S),
        (t[28] = _),
        (t[29] = v),
        (t[30] = C))
...
async function Ye(e) {
  ...
  try {
    ...
    return { faviconUrl: qe(n, t.runtime), title: Ze(n) };
  } catch {
    return null;
  }
}
...
var Qe = S({ tabId: x().int().nonnegative() }),
  $e = [{ getCompletedSummaryPartKey: tt, namespace: c, render: et, tool: s }];
function et(e, t) {
  let n = Qe.safeParse(e.arguments);
  return n.success ? (0, K.jsx)(Je, { item: e, tabId: n.data.tabId, variant: t }) : null;
}
function tt(e) {
  return Qe.safeParse(e.arguments).success ? e.callId : null;
}
var nt = [{ namespace: F, render: rt, tool: N }];
function rt(e, t) {
  let n = e.completed && e.success === !1 ? q.failed : e.completed ? q.completed : q.active;
  return t === `row`
    ? (0, K.jsxs)(`span`, {
        ...
        children: [
          (0, K.jsx)(`span`, {
            ...
            children: (0, K.jsx)(_e, { className: `icon-xs` }),
          }),
          (0, K.jsxs)(`span`, {
            ...
            children: [
              (0, K.jsx)(I, {
                ...
                children: (0, K.jsx)(E, { ...n }),
              }),
              e.completed
                ? null
                : (0, K.jsx)(`span`, {
                    className: `text-size-chat-sm text-token-text-tertiary`,
                    children: (0, K.jsx)(E, { ...q.activeDetail }),
                  }),
            ],
          }),
        ],
    ...
    : (0, K.jsxs)(`span`, {
        ...
        children: [
          t === `summary-text`
            ? null
            : (0, K.jsx)(_e, { className: `icon-xs shrink-0 text-token-text-secondary` }),
          (0, K.jsx)(I, {
            active: !e.completed,
            className: D(t !== `summary-text` && `min-w-0 truncate`),
            children: (0, K.jsx)(E, { ...n }),
          }),
        ],
      });
...
var q = w({
  ...
  it = [
    { namespace: F, render: at, tool: P },
    { namespace: F, render: ot, tool: ce },
  ];
function at(e, t) {
  return st(e, e.completed ? `readCompleted` : `readActive`, t);
}
function ot(e, t) {
  return st(e, e.completed ? `writeCompleted` : `writeActive`, t);
}
function st(e, t, n) {
  return (0, K.jsxs)(`span`, {
    ...
    children: [
      n === `summary-text`
        ? null
        : (0, K.jsx)(M, { className: `icon-xs shrink-0 text-token-text-secondary` }),
      (0, K.jsx)(I, {
        active: !e.completed,
        className: D(n !== `summary-text` && `min-w-0 truncate`),
        children: (0, K.jsx)(E, { ...ct[t] }),
      }),
    ],
  });
}
var ct = w({
  ...
  lt = e(t(), 1),
  ut = C({
    destinationHostDisplayName: y().min(1),
    operationId: y().min(1),
    status: h([`queued`, `running`, `success`, `warning`, `error`]),
    threadTitle: y().min(1),
  });
function dt(e) {
  let t = (0, G.c)(52),
    { item: n, variant: i } = e,
    a = n.completed && n.success === !0 ? pt(n.contentItems ?? null) : null,
    o = r(re, a?.operationId ?? n.callId),
    s = o?.threadTitle ?? a?.threadTitle ?? null,
    c = o?.destinationHostDisplayName ?? a?.destinationHostDisplayName ?? null,
    l = o == null ? (a == null ? n.completed : ne(a.status)) : ne(o.status),
    u =
      o == null
        ? n.success
        : o.status === `error`
    ...
    [d, f] = (0, lt.useState)(!1),
    [p, m] = (0, lt.useState)(!1),
    { elementHeightPx: h, elementRef: g } = Ce(),
    _ = o != null && o.steps.length > 0,
    v = _ && (l ? p : !d);
  if (i !== `row`) {
    let e = i === `summary-text` ? `inline` : `flex gap-2`,
      n;
    t[0] === e
      ? (n = t[1])
      : ((n = D(
    ...
    t[2] === i
      ...
      : ((r =
          i === `summary-text`
            ? null
            : (0, K.jsx)(te, { className: `icon-xs shrink-0 text-token-text-secondary` })),
        (t[2] = i),
        (t[3] = r));
    let a = !l,
      o = i !== `summary-text` && `min-w-0 truncate`,
      d;
    t[4] === o ? (d = t[5]) : ((d = D(o)), (t[4] = o), (t[5] = d));
    let f;
    ...
    t[11] !== a || t[12] !== d || t[13] !== f
      ? ((p = (0, K.jsx)(I, { active: a, className: d, children: f })),
        (t[11] = a),
        (t[12] = d),
        (t[13] = f),
        (t[14] = p))
    ...
    let m;
    return (
      t[15] !== n || t[16] !== r || t[17] !== p
        ? ((m = (0, K.jsxs)(`span`, { className: n, children: [r, p] })),
          (t[15] = n),
          (t[16] = r),
          (t[17] = p),
          (t[18] = m))
  ...
  t[19] === b
    ? (x = t[20])
    : ((x = D(`group flex min-w-0 items-center gap-2 text-left`, b)), (t[19] = b), (t[20] = x));
  let S = !_,
    C;
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, K.jsx)(te, { className: `icon-xs shrink-0 text-token-text-secondary` })),
      (t[25] = w))
    : (w = t[25]);
  let T = !l,
    E;
  ...
  t[34] !== _ || t[35] !== v
    ...
    : (j = t[36]);
  let M;
  t[37] !== y || t[38] !== j || t[39] !== x || t[40] !== S || t[41] !== C || t[42] !== A
    ? ((M = (0, K.jsxs)(`button`, {
        type: `button`,
        "aria-expanded": y,
        className: x,
  ...
  return (
    t[49] !== M || t[50] !== N
      ? ((P = (0, K.jsxs)(`div`, { className: `my-1 min-w-0`, children: [M, N] })),
        (t[49] = M),
        (t[50] = N),
        (t[51] = P))
      : (P = t[51]),
...
function mt(e) {
  let t = (0, G.c)(19),
    ...
    a;
  t[0] !== r || t[1] !== i
    ? ((a = r.formatMessage(i ? J.openWorktreeSetup : J.openCreatedThread)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a))
    : (a = t[2]);
  ...
  t[3] !== i || t[4] !== n.pendingWorktreeId || t[5] !== n.threadId
    ? ((s = () => {
        p.dispatchHostMessage({
          ...
          path: i ? b(n.pendingWorktreeId) : _(g(n.threadId)),
        });
      }),
      (t[3] = i),
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, K.jsx)(`span`, {
        ...
        children: (0, K.jsx)(he, { className: `icon-sm`, "aria-hidden": !0 }),
      })),
      (t[7] = l))
    : (l = t[7]);
  let u = i ? J.worktreeThreadQueued : J.threadCreated,
    d;
  t[8] === u ? (d = t[9]) : ((d = (0, K.jsx)(E, { ...u })), (t[8] = u), (t[9] = d));
  let f = i ? J.openSetup : J.openThread,
    m;
  t[10] === f
    ? (m = t[11])
    : ((m = (0, K.jsx)(ye, { label: (0, K.jsx)(E, { ...f }) })), (t[10] = f), (t[11] = m));
  let h;
  t[12] !== d || t[13] !== m
    ? ((h = (0, K.jsx)(ve, { icon: l, title: d, trailing: m })),
      (t[12] = d),
      (t[13] = m),
      (t[14] = h))
    : (h = t[14]);
...
var J = w({
  ...
  ht = C({ target: C({ type: y(), environment: C({ type: y() }).optional() }) }),
  gt = C({ environment: C({ type: y() }).optional() }),
  _t = C({ destinationHostId: y().min(1).optional(), threadId: y().min(1) }),
  vt = C({ operationId: y().min(1) }),
  yt = v([C({ threadId: y().min(1) }), C({ pendingWorktreeId: y().min(1) })]),
  bt = [
    { getCompletedSummaryPartKey: X, namespace: F, render: Y, tool: se },
    { getCompletedSummaryPartKey: X, namespace: F, render: Y, tool: de },
    {
      getCompletedSummaryPartKey: St,
      namespace: F,
      render: xt,
    ...
    {
      getCompletedSummaryPartKey: Ct,
      namespace: F,
      render: Y,
      summaryOnlyInConversationGroup: !0,
      tool: me,
    },
    { continuesLiveActivityBetweenCalls: !0, namespace: F, render: Y, tool: ue },
    { continuesLiveActivityBetweenCalls: !0, namespace: F, render: Y, tool: fe },
    { namespace: F, render: Y, tool: ae },
    { namespace: F, render: Y, tool: pe },
    { namespace: F, render: Y, tool: le },
    { namespace: F, render: Y, tool: oe },
  ];
function xt(e, t) {
  return _t.safeParse(e.arguments).success ? (0, K.jsx)(dt, { item: e, variant: t }) : null;
}
function St(e) {
  let t = _t.safeParse(e.arguments);
...
function X(e) {
  switch (e.tool) {
    case se: {
      let t = gt.safeParse(e.arguments);
      return t.success
    ...
    case de: {
      let t = ht.safeParse(e.arguments);
      return t.success
    ...
    case me:
      return vt.safeParse(e.arguments).success
        ? e.completed
...
var Tt = w({
  ...
  Et = [...$e, ...bt, ...nt, ...it];
function Z(e) {
  return Et.find((t) => t.namespace === e.namespace && t.tool === e.tool);
}
function Dt(e) {
  return Z(e)?.continuesLiveActivityBetweenCalls === !0;
}
function Ot(e) {
  return Z(e)?.summaryOnlyInConversationGroup === !0;
}
function kt(e) {
  let t = Z(e)?.getCompletedSummaryPartKey?.(e);
  return `${e.namespace}:${e.tool}:${t ?? ``}`;
}
function At({ items: e, isActive: t }) {
  if (!t) return !1;
  if (e.some((e) => !e.completed)) return !0;
  let n = e.at(-1);
  return n != null && Dt(n);
}
function jt({ items: e, keepLatestLiveActivityInGroup: t }) {
  let n = e.at(-1);
  return e.length > 1 || (t && n != null && Dt(n));
}
function Mt({ units: e, isActivitySliceClosed: t }) {
  let n = [],
    r = Nt(e, t);
  for (let { startIndex: t, endIndex: i } of r) {
    ...
    for (; r < i; ) {
      ...
      for (; r < i; ) {
        let t = e[r];
        if (t == null || !Pt(t)) break;
        (It(o, t), (r += 1));
      }
      n.push({ startIndex: a, endIndex: r, summary: Lt(o) });
    }
  }
  return n;
}
...
function It(e, t) {
  if (t.type === `exploration`) {
    Q(e, t.automaticApprovalReviewFailures);
  ...
  if (t.type === `exec`) {
    if ((Q(e, t.automaticApprovalReviewFailures), (e.commandCount += 1), t.isInProgress)) {
  ...
  if (t.type === `mcp-tool-call`) {
    if ((Q(e, t.automaticApprovalReviewFailures), (e.mcpToolCallCount += 1), t.source != null)) {
...
function Wt({
  ...
  for (let t = 0; t < e.length; ) {
    ...
    for (; l < e.length; ) {
      let t = tn(e[l]);
      if (t == null || en(t, n, r)) break;
      let a = $t({ item: t, resolvedApps: i });
      if (c != null && a !== c) break;
      ((c = a), s.push(t), (l += 1));
    }
...
function Gt({ units: e, keepLatestLiveActivityInGroup: t = !1 }) {
  let n = [];
  for (let r = 0; r < e.length; ) {
    ...
    for (; o < e.length; ) {
      let t = nn(e[o]);
      if (t == null) break;
      if (Z(t)?.standaloneInConversation === !0) {
        if (i.length > 0) break;
    ...
    if (jt({ items: i, keepLatestLiveActivityInGroup: t && o === e.length })) {
...
function Zt({
  ...
  let c = e.map((e) =>
    ...
    l = [...Mt({ units: c, isActivitySliceClosed: t })];
  if (!t) {
    let e = rn(c),
      t = [];
    ...
    for (let n of Mt({ units: t, isActivitySliceClosed: !0 }))
  ...
  for (let r = 0; r < e.length; ) {
    ...
    if (i && r === i.startIndex) {
      ...
      if (o != null) {
        let e = Qt({ groupedUnits: a, isCurrentToolActivity: s, summary: i.summary });
        u.push({ kind: `collapsed-tool-activity`, key: Ut(o, i.startIndex), units: a, summary: e });
      }
      ((r = i.endIndex), (d += 1));
      continue;
    }
...
function Qt({ groupedUnits: e, isCurrentToolActivity: t, summary: n }) {
  return !t || e.at(-1)?.kind !== `web-search-group`
    ? n
    : { ...n, runningWebSearchCount: n.webSearchCount };
}
function $t({ item: e, resolvedApps: t }) {
  let n = l({ item: e });
...
var on = e(f(), 1);
function sn({ agentItems: e, isTurnInProgress: t, isAnyNonAgentItemInProgress: n }) {
  let r = [],
    i = null,
    a = !1,
    o = !1,
  ...
  if (i) {
    ...
    let e = (0, on.default)(r);
    e?.kind === `item` &&
      ((o = an(e.item)), e.item.type === `reasoning` && e.item.completed === !1 && (o = !1));
  }
...
function dn(e, t) {
  ...
  let O = w[w.length - 1],
    k = t !== `in_progress` && !D && yn(O) ? O : null;
  k && w.pop();
  let A =
    E != null && E.completed && p.length > 0
      ? {
          ...E,
          automationCitations: (0, un.default)(
            [...p].reverse(),
...
var fn = (e) => e.type === `patch` && e.approvalRequestId != null && e.success == null,
  pn = (e) => e.type === `exec` && e.approvalRequestId != null && e.output?.exitCode === void 0,
  mn = (e) => e?.type === `assistant-message`,
  hn = (e) => {
    let t = [];
    for (;;) {
      let n = e[e.length - 1];
