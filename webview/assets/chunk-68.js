...
import { n as m, t as h } from "./src-3.js";
import { n as g, t as ee } from "./rough.esm-2.js";
import { i as _, n as v, r as y } from "./chunk-50.js";
import { A as b, b as x, w as S, y as C } from "./chunk-85.js";
import { g as w, l as te, u as ne } from "./chunk-32.js";
import { i as T, n as E } from "./chunk-128.js";
import { a as D, i as O, n as re, r as k, t as A } from "./chunk-53.js";
import { n as j, r as M } from "./chunk-145.js";
import { a as N, n as P, r as ie } from "./chunk-132.js";
import { i as ae, r as F } from "./chunk-28.js";
function I(e, t) {
  S(x()) && e && ((e.style.width = t.length * 9 + `px`), (e.style.height = `12px`));
}
function L(e) {
  let t = [],
    n = [];
...
var V,
  ...
  me = e(() => {
    (k(),
      ...
      (oe = v((e) => (typeof e == `string` ? e : x()?.flowchart?.curve), `resolveEdgeCurveType`)),
      (G = new Map()),
      (K = new Map()),
      (q = v(() => {
        (G.clear(), K.clear());
      ...
      (Y = v(async (e, t) => {
        ...
        (o.attr(`transform`, A(u, r)), G.set(t.id, a), (t.width = l.width), (t.height = l.height));
        let d;
        if (t.startLabelLeft) {
      ...
      (X = v((e, t) => {
        ...
        if (e.startLabelLeft) {
          let t = K.get(e.id).startLeft,
            ...
            i = e.y;
          if (n) {
            let t = w.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, `start_left`, n);
            ((r = t.x), (i = t.y));
          }
        ...
        if (e.startLabelRight) {
          let t = K.get(e.id).startRight,
            ...
            i = e.y;
          if (n) {
            let t = w.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, `start_right`, n);
            ((r = t.x), (i = t.y));
          }
          t.attr(`transform`, `translate(${r}, ${i})`);
        }
        if (e.endLabelLeft) {
          let t = K.get(e.id).endLeft,
            ...
            i = e.y;
          if (n) {
            let t = w.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, `end_left`, n);
            ((r = t.x), (i = t.y));
          }
          t.attr(`transform`, `translate(${r}, ${i})`);
        }
        if (e.endLabelRight) {
          let t = K.get(e.id).endRight,
            ...
            i = e.y;
          if (n) {
            let t = w.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, `end_right`, n);
            ((r = t.x), (i = t.y));
          }
          t.attr(`transform`, `translate(${r}, ${i})`);
        }
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
        ...
        if (Math.abs(i - t.y) * o > Math.abs(r - t.x) * c) {
          ...
          return (
            _.debug(`sides calc abc89, Q ${l}, q ${e}, R ${u}, r ${s}`, { _x: i, _y: a }),
            s === 0 && ((i = t.x), (a = t.y)),
            u === 0 && (i = t.x),
            l === 0 && (a = t.y),
            { x: i, y: a }
        ...
        return (
          e.forEach((e) => {
            if ((_.info(`abc88 checking point`, e, t), !Z(t, e) && !i)) {
              let a = se(t, r, e);
              (_.debug(`abc88 inside`, e, r, a), _.debug(`abc88 intersection`, a, t));
              let o = !1;
              (n.forEach((e) => {
                o ||= e.x === a.x && e.y === a.y;
              }),
        ...
        for (let r = 0; r < e.length; r++)
          if (t.includes(r)) {
            ...
            (Math.abs(i.x - t.x) > 10 && Math.abs(i.y - t.y) >= 10
              ? (_.debug(`Corner point fixing`, Math.abs(i.x - t.x), Math.abs(i.y - t.y)),
                (d =
                  a.x === o.x
                    ? { x: c < 0 ? o.x - 5 + u : o.x + 5 - u, y: l < 0 ? o.y - u : o.y + u }
                    : { x: c < 0 ? o.x - u : o.x + u, y: l < 0 ? o.y - 5 + u : o.y + 5 - u }))
              : _.debug(`Corner point skipping fixing`, Math.abs(i.x - t.x), Math.abs(i.y - t.y)),
              n.push(d, s));
          } else n.push(e[r]);
        return n;
      }, `fixCorners`)),
      ...
      (ue = v(function (e, h, g, v, y, b, S, C = !1) {
        ...
        var k = b;
        let A = [];
        for (let e in h.cssCompiledStyles) ie(e) || A.push(h.cssCompiledStyles[e]);
        ...
        (h.toCluster &&
          ...
          (E = !0)),
          h.fromCluster &&
            (_.debug(`from cluster abc88`, g.get(h.fromCluster), JSON.stringify(T, null, 2)),
        ...
        if (h.look === `handDrawn`) {
          ...
          ((L += ` transition`),
            (z = m(n)
              .select(`path`)
              .attr(`id`, `${S}-${h.id}`)
              .attr(`class`, ` ` + L + (h.classes ? ` ` + h.classes : ``) + (G ? ` ` + G : ``))
