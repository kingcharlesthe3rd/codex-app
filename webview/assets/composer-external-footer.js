...
import { Bt as Ve, Ht as He, St as Ue, xt as We } from "./app-initial~app-main~automations-page.js";
import {
  Au as Ge,
  Dm as Ke,
  Em as qe,
...
function wt(e) {
  let t = (0, Tt.c)(35),
    ...
    [o, c] = (0, Y.useState)(!1),
    l = S(),
    { data: u, isLoading: d } = ke(l.cwd, l.hostConfig, `cloud_follow_up_local_remote_dropdown`),
    f = u?.root != null,
  ...
  t[9] === n
    ? (y = t[10])
    : ((y = n === `local` ? (0, X.jsx)(W, { ...Z.local }) : (0, X.jsx)(W, { ...Z.cloud })),
      (t[9] = n),
      (t[10] = y));
  let b = y,
    C;
  ...
  let A;
  t[21] !== D || t[22] !== O
    ? ((A = (0, X.jsx)(R.Item, { LeftIcon: x, RightIcon: D, onClick: O, children: k })),
      (t[21] = D),
      (t[22] = O),
      (t[23] = A))
    : (A = t[23]);
  ...
  let M;
  t[28] !== A || t[29] !== j
    ? ((M = (0, X.jsxs)(`div`, { className: `flex w-44 flex-col`, children: [E, A, j] })),
      (t[28] = A),
      (t[29] = j),
      (t[30] = M))
    : (M = t[30]);
  ...
  return (
    t[31] !== o || t[32] !== M || t[33] !== T
      ? ((N = (0, X.jsx)(F, { open: o, onOpenChange: c, triggerButton: T, children: M })),
        (t[31] = o),
        (t[32] = M),
        (t[33] = T),
        (t[34] = N))
...
function Dt(e) {
  ...
  t[14] !== g || t[15] !== h
    ? ((v = (0, Q.jsx)(B, {
        tooltipContent: m,
        children: (0, Q.jsx)(R.Item, { LeftIcon: Ot, RightIcon: h, onClick: g, children: _ }),
      })),
      (t[14] = g),
      (t[15] = h),
      (t[16] = v))
  ...
  let S;
  t[20] !== y || t[21] !== b
    ? ((S = (0, Q.jsx)(R.Item, { LeftIcon: se, RightIcon: y, onClick: b, children: x })),
      (t[20] = y),
      (t[21] = b),
      (t[22] = S))
    : (S = t[22]);
  ...
  return (
    t[26] !== i || t[27] !== C || t[28] !== p
      ? ((w = (0, Q.jsx)(F, { open: i, onOpenChange: a, triggerButton: p, children: C })),
        (t[26] = i),
        (t[27] = C),
        (t[28] = p),
        (t[29] = w))
...
function Rt(e) {
  let t = (0, Bt.c)(190),
    ...
    re = ce(),
    P;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((P = O()), (t[0] = P)) : (P = t[0]);
  let ie = P,
  ...
  let V = we,
    ...
    Ae = r(c({ cwd: De, assignment: I == null ? void 0 : ke?.[I] }), oe(L.hostId) ?? p),
    Me = Le(`2700454473`),
    Ne = n === `home` && Me,
    Ie = Le(`1115442235`),
    U = Ae,
    ...
    Ue;
  t[8] !== He || t[9] !== H
    ? ((Ue = He.find((e) => e.hostId === H) ?? null), (t[8] = He), (t[9] = H), (t[10] = Ue))
    : (Ue = t[10]);
  let Ge = Ue,
    Ke;
  ...
  t[19] === C
    ? (et = t[20])
    : ((et = C.getProjectPathForHostId(C.currentHostId)), (t[19] = C), (t[20] = et));
  let nt = et;
  ...
  t[25] !== C.currentHostId || t[26] !== nt || t[27] !== st
    ? ((ct = { hostId: C.currentHostId, connectionDisplayName: st, projectPath: nt }),
  ...
  let G = lt,
    K = L.hostConfig,
    q =
      o(pe, { hostConfig: K, operationSource: `composer_content` }).data?.available === !0 &&
      de &&
      !me
        ? L.cwd
        : null,
  ...
  t[39] !== q || t[40] !== K
    ...
    : (vt = t[41]);
  let { canCreateGitRepository: yt, createGitRepository: bt, isCreatingGitRepository: St } = tt(vt),
    Tt = q != null && J != null,
    Y = de && Tt && J?.root == null,
    X = !yt || St || !Tt || pt,
    Z = Y ? null : x,
    ...
    kt;
  t[42] !== Ot || t[43] !== d
    ? ((kt = { hostId: d, workspaceRoot: Ot }), (t[42] = Ot), (t[43] = d), (t[44] = kt))
    : (kt = t[44]);
  let {
      environments: At,
      isLoading: Q,
              ...
              onOpenSettings: () => {
                (Qe(E, d),
                  A(Ve({ workspaceRoot: f }), {
                    state: { hostId: d, returnTo: `${D.pathname}${D.search}${D.hash}` },
                  }));
              },
            })
          : null),
  ...
  if (
    ...
    bb0: {
      ...
      let a = r,
        o;
      t[105] !== Be || t[106] !== I || t[107] !== L.cwd || t[108] !== Ae || t[109] !== Ie
        ? ((o =
            Ie && xt({ isCompactWindow: ie }) && I != null && L.cwd != null
              ? { conversationTitle: Be, cwd: b(L.cwd), isWorktreeConversation: Ae }
              : null),
          (t[105] = Be),
          (t[106] = I),
          (t[107] = L.cwd),
      ...
      J?.root;
      let f;
      t[111] !== I || t[112] !== J?.root || t[113] !== K || t[114] !== Y || t[115] !== d
        ? ((f =
            d && !Y
              ? (0, $.jsx)(ht, {
                  gitRoot: J?.root ?? null,
      ...
      let x = v,
        S;
      t[128] !== w || t[129] !== i || t[130] !== N || t[131] !== g || t[132] !== n
        ? ((S =
            g && _t(i) && !N
              ? (0, $.jsx)(he, {
                  electron: !0,
      ...
      t[134] !== i || t[135] !== N || t[136] !== Z
        ? ((D = !!N || !1), (t[134] = i), (t[135] = N), (t[136] = Z), (t[137] = D))
        : (D = t[137]);
      let O = D,
        k;
      t[138] === O
      ...
      t[140] !== ne || t[141] !== i || t[142] !== N || t[143] !== E
        ...
        : (ee = t[144]);
      let j = ee,
        M = V ? G.draftNewThreadRemoteSelectionState : G.existingRemoteThreadState,
        P;
      t[145] !== bt || t[146] !== X || t[147] !== St || t[148] !== Y || t[149] !== d
        ? ((P =
            d && Y
              ? (0, $.jsxs)(le, {
                  className: `px-0`,
      ...
      t[171] !== n
        ? ((ye =
            N?.type === `cloud`
              ? (0, $.jsxs)($.Fragment, {
                  children: [n === `home` ? p : null, x, n === `default` ? p : null, j],
                })
      ...
      if (Ne) {
        ...
        (t[188] === Oe
          ...
          : ((n = (0, $.jsx)(`div`, {
            ...
            (t[189] = n)),
          (Rt = (0, $.jsxs)(Ye, {
            className: ge(e, Je.homeExternalFooter, `flex-nowrap gap-2 overflow-hidden`),
            responsive: !1,
            children: [n, je],
          })));
        break bb0;
      ...
      Lt = (0, $.jsxs)(Ye, {
        className: ge(e, `flex-wrap gap-2 overflow-visible`, n === `default` && `pl-2`),
        children: [
          (0, $.jsx)(`div`, {
...
function zt(e) {
  ...
  t[0] === o
    ...
    : ((s = (0, $.jsx)(`span`, { className: `max-w-40 min-w-0 truncate`, children: o })),
      ...
      (t[1] = s));
  let c;
  t[2] === n ? (c = t[3]) : ((c = (0, $.jsx)(st, { hostId: n })), (t[2] = n), (t[3] = c));
  let l;
  t[4] !== s || t[5] !== c
    ? ((l = (0, $.jsxs)(qe, {
        collapse: `sm`,
