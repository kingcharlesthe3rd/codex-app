...
import { E as te, t as ne } from "./composer-view-state.js";
...
import { n as ae, t as oe } from "./composer-footer.js";
...
import { r as F, t as fe } from "./dropdown.js";
import "./globe.js";
...
import { n as ge } from "./local-remote-selection.js";
...
import { Y as _e } from "./git-branch-picker-dropdown-content.js";
...
function Te(e) {
  ...
  t[10] === n
    ? (y = t[11])
    : ((y = n === `local` ? (0, B.jsx)(C, { ...V.local }) : (0, B.jsx)(C, { ...V.cloud })),
      (t[10] = n),
      (t[11] = y));
  let b = y,
    x;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, B.jsx)(pe, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[17] = T))
    : (T = t[17]);
  let D;
  t[18] !== S || t[19] !== w
  ...
  let M;
  t[26] !== k || t[27] !== A
    ? ((M = (0, B.jsx)(F.Item, { LeftIcon: L, RightIcon: k, onClick: A, children: j })),
      (t[26] = k),
      (t[27] = A),
      (t[28] = M))
    : (M = t[28]);
  ...
  let P;
  t[34] !== M || t[35] !== N
    ? ((P = (0, B.jsxs)(`div`, { className: `flex w-44 flex-col`, children: [O, M, N] })),
      (t[34] = M),
      (t[35] = N),
      (t[36] = P))
    : (P = t[36]);
...
function Ee(e) {
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, B.jsx)(pe, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[8] = p))
    : (p = t[8]);
  let m;
  t[9] !== d || t[10] !== f
  ...
  t[16] !== g || t[17] !== _
    ? ((y = (0, B.jsx)(ee, {
        tooltipContent: h,
        children: (0, B.jsx)(F.Item, { LeftIcon: De, RightIcon: g, onClick: _, children: v }),
      })),
      (t[16] = g),
      (t[17] = _),
      (t[18] = y))
  ...
  let w;
  t[22] !== b || t[23] !== x
    ? ((w = (0, B.jsx)(F.Item, { LeftIcon: j, RightIcon: b, onClick: x, children: S })),
      (t[22] = b),
      (t[23] = x),
      (t[24] = w))
    : (w = t[24]);
  let T;
  t[25] !== y || t[26] !== w
    ? ((T = (0, B.jsxs)(`div`, { className: `flex flex-col gap-1 pt-1`, children: [y, w] })),
      (t[25] = y),
      (t[26] = w),
      (t[27] = T))
    : (T = t[27]);
    ...
    e[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, B.jsx)(ee, {
          ...
          children: (0, B.jsx)(re, {
            ...
            uniform: !0,
            className: `-mx-2`,
            children: (0, B.jsx)(R, { className: `icon-xs text-token-editor-warning-foreground` }),
          }),
        })),
        (e[1] = r))
      : (r = e[1]),
...
function je(e) {
  let a = (0, we.c)(185),
    ...
    U = E(te),
    je;
  a[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((je = le()), (a[0] = je)) : (je = a[0]);
  let Ne = je,
  ...
  let st = ot,
    ct;
  a[13] !== st || a[14] !== q
    ? ((ct = st.find((e) => e.hostId === q) ?? null), (a[13] = st), (a[14] = q), (a[15] = ct))
    : (ct = a[15]);
  let lt = ct,
    ut;
  ...
  let wt = T(s, Ct),
    Tt;
  a[44] !== Y || a[45] !== X
    ? ((Tt = { cwd: Y, hostConfig: X, showErrorToast: !0 }), (a[44] = Y), (a[45] = X), (a[46] = Tt))
    : (Tt = a[46]);
  let { canCreateGitRepository: Et, createGitRepository: Dt, isCreatingGitRepository: Ot } = _e(Tt),
    ...
    Nt;
  a[47] !== Mt || a[48] !== he
    ? ((Nt = { hostId: he, workspaceRoot: Mt }), (a[47] = Mt), (a[48] = he), (a[49] = Nt))
    : (Nt = a[49]);
  let {
      environments: Pt,
      isLoading: Ft,
  ...
  if (
    ...
    let e = b(
      ...
      t;
    a[105] !== x || a[106] !== p || a[107] !== U || a[108] !== F || a[109] !== X || a[110] !== S
      ? ((t =
    ...
    a[121] !== Qe
      ? ((s =
          Qe && Se({ isCompactWindow: Ne }) && G != null && K.cwd != null
            ? { conversationTitle: tt, cwd: i(K.cwd), disabled: et, isWorktreeConversation: Ze }
            : null),
        (a[116] = G),
        (a[117] = tt),
        (a[118] = K.cwd),
    ...
    Z?.root;
    let d;
    (a[123] !== W || a[124] !== Z?.root || a[125] !== X || a[126] !== Q || a[127] !== u
      ? ((d =
          u && !Q
            ? (0, B.jsx)(xe, {
                gitRoot: Z?.root ?? null,
    ...
    a[139] !== o
      ...
      (Ut = f));
    let m;
    (a[141] !== L || a[142] !== p || a[143] !== U || a[144] !== V || a[145] !== R
      ? ((m =
          V && Oe(p) && !U
            ? (0, B.jsx)(ce, {
                electron: !0,
    ...
    (a[153] !== w || a[154] !== p || a[155] !== U || a[156] !== D
      ...
      : (T = a[157]),
      (Gt = T));
    let E = We ? J.draftNewThreadRemoteSelectionState : J.existingRemoteThreadState,
      O;
    (a[158] !== Dt || a[159] !== At || a[160] !== Ot || a[161] !== Q || a[162] !== u
      ? ((O =
          u && Q
            ? (0, B.jsxs)(re, {
                className: `px-0`,
    ...
    (a[164] !== E || a[165] !== k
      ...
      (Kt = A),
      (Vt = oe),
      (qt = b(e, `flex-wrap gap-2 overflow-visible`, R === `default` && `pl-2`)),
      (a[59] = L),
      (a[60] = x),
      (a[61] = G),
      (a[62] = Re?.role),
  ...
  let nn;
  return (
    a[179] !== Vt || a[180] !== qt || a[181] !== $t || a[182] !== en || a[183] !== tn
