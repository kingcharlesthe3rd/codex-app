...
import { Bn as Pe, Hn as Fe } from "./app-initial~app-main~automations-page.js";
import {
  Ds as U,
  Lc as Ie,
  Ms as Le,
...
import { n as K, t as dt } from "./worktree-environment-dropdown.js";
import {
  a as ft,
  i as q,
  n as pt,
...
function Tt(e) {
  let t = (0, Et.c)(35),
    ...
    [o, s] = (0, J.useState)(!1),
    c = te(),
    { data: l, isLoading: u } = De(c.cwd, c.hostConfig, `cloud_follow_up_local_remote_dropdown`),
    d = l?.root != null,
    f = a?.type === `cloud` && a.hasAppliedCodeLocally,
    p,
    m;
  (t[0] !== f || t[1] !== i
    ? ((p = () => {
  ...
  t[9] === n
    ? (_ = t[10])
    : ((_ = n === `local` ? (0, Y.jsx)(z, { ...X.local }) : (0, Y.jsx)(z, { ...X.cloud })),
      (t[9] = n),
      (t[10] = _));
  let b = _,
    x;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, Y.jsx)(z, { ...X.tooltip })), (t[11] = x))
    : (x = t[11]);
  let S;
  t[12] === n
    ? (S = t[13])
    : ((S =
        n === `cloud`
          ? (0, Y.jsx)(ie, { className: `icon-xs` })
          : (0, Y.jsx)(A, { className: `icon-xs` })),
      (t[12] = n),
      (t[13] = S));
  let C;
  t[14] !== b || t[15] !== S
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, Y.jsx)(z, { ...X.local })), (t[20] = ee))
    : (ee = t[20]);
  let D;
  t[21] !== T || t[22] !== E
    ? ((D = (0, Y.jsx)(I.Item, { LeftIcon: A, RightIcon: T, onClick: E, children: ee })),
      (t[21] = T),
      (t[22] = E),
      (t[23] = D))
    : (D = t[23]);
  ...
  let k;
  t[28] !== D || t[29] !== O
    ? ((k = (0, Y.jsxs)(`div`, { className: `flex w-44 flex-col`, children: [w, D, O] })),
      (t[28] = D),
      (t[29] = O),
      (t[30] = k))
    : (k = t[30]);
  let ne;
  return (
    t[31] !== o || t[32] !== k || t[33] !== C
      ? ((ne = (0, Y.jsx)(N, { open: o, onOpenChange: s, triggerButton: C, children: k })),
        (t[31] = o),
        (t[32] = k),
        (t[33] = C),
        (t[34] = ne))
...
function Ot(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Z.jsx)(Ve, { className: `icon-xs` })), (t[4] = d))
    : (d = t[4]);
  let f;
  t[5] === u
    ? (f = t[6])
  ...
  t[14] !== g || t[15] !== h
    ? ((v = (0, Z.jsx)(M, {
        tooltipContent: m,
        children: (0, Z.jsx)(I.Item, { LeftIcon: kt, RightIcon: h, onClick: g, children: _ }),
      })),
      (t[14] = g),
      (t[15] = h),
      (t[16] = v))
    : (v = t[16]);
  let y = n === `direct-follow-up` ? F : void 0,
    b;
  t[17] === r
    ? (b = t[18])
    : ((b = () => {
  ...
  let S;
  t[20] !== y || t[21] !== b
    ? ((S = (0, Z.jsx)(I.Item, { LeftIcon: Ve, RightIcon: y, onClick: b, children: x })),
      (t[20] = y),
      (t[21] = b),
      (t[22] = S))
    : (S = t[22]);
  ...
  return (
    t[26] !== i || t[27] !== C || t[28] !== p
      ? ((w = (0, Z.jsx)(N, { open: i, onOpenChange: a, triggerButton: p, children: C })),
        (t[26] = i),
        (t[27] = C),
        (t[28] = p),
        (t[29] = w))
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, Z.jsx)(ft, {
          ...
          children: (0, Z.jsx)(Ve, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
    ...
    e[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Q.jsx)(M, {
          ...
          children: (0, Q.jsx)(et, {
            ...
            uniform: !0,
            className: `-mx-2`,
            children: (0, Q.jsx)(tt, { className: `icon-xs text-token-editor-warning-foreground` }),
          }),
        })),
        (e[1] = r))
      : (r = e[1]),
...
var Ft,
  ...
  Lt = e(() => {
    ((Ft = u()),
      ...
      h(),
      (Q = x()),
      (It = C(l, `has-custom-cli-executable`, { staleTime: o.FIVE_SECONDS })));
  });
function Rt(e) {
  let t = (0, Bt.c)(190),
    {
      ...
      gitRootForStartingState: h,
      showFooterBranchWhen: b,
      freeUpsellButton: x,
      remoteConfig: C,
    ...
    ce = Ke(),
    j;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((j = ee()), (t[0] = j)) : (j = t[0]);
  let le = j,
    ue = r !== `cloud` && A?.type !== `cloud`,
    fe;
  t[1] === D ? (fe = t[2]) : ((fe = We(D)), (t[1] = D), (t[2] = fe));
  let M = fe,
    me = _(ye, M),
    he = M != null && !me,
    N = te(M),
    ...
    F = _(Vt, M),
    I = A != null || F,
    L = C.currentHostId ?? `local`,
    R = A?.type,
    xe;
  t[3] !== r || t[4] !== L || t[5] !== F || t[6] !== R
    ? ((xe = at({
        composerMode: r,
        draftRemoteHostId: L,
        followUpType: R,
        hasStartedBranchConversation: F,
      })),
      (t[3] = r),
      (t[4] = L),
      (t[5] = F),
  ...
  let we = xe,
    ...
    Ee = !we && B !== `local`,
    De = _(be, M),
    { data: ke } = S(s.THREAD_PROJECT_ASSIGNMENTS),
    V = w(c({ cwd: De, assignment: M == null ? void 0 : ke?.[M] }), Ze(N.hostId) ?? u),
    je = Ce(`2700454473`),
    H = n === `home` && je,
    Fe = Ce(`1115442235`),
    U = V,
    ...
    Be;
  t[8] !== ze || t[9] !== B
    ? ((Be = ze.find((e) => e.hostId === B) ?? null), (t[8] = ze), (t[9] = B), (t[10] = Be))
    : (Be = t[10]);
  let Ge = Be,
    Je;
  t[11] !== N.cwd || t[12] !== Ee || t[13] !== C || t[14] !== B
    ? ((Je = B === `local` ? null : Ee ? N.cwd : C.getProjectPathForHostId(B)),
      (t[11] = N.cwd),
      (t[12] = Ee),
      (t[13] = C),
      (t[14] = B),
  ...
  let Xe = Je,
    Qe;
  t[16] !== C.currentHostId || t[17] !== ze
    ? ((Qe = ze.find((e) => e.hostId === C.currentHostId) ?? null),
  ...
  t[19] === C
    ? (tt = t[20])
    : ((tt = C.getProjectPathForHostId(C.currentHostId)), (t[19] = C), (t[20] = tt));
  let nt = tt;
  (Ge?.displayName, $e?.displayName);
  let it = B === `local` ? null : (Ge?.displayName ?? null),
    ot;
  t[21] !== Xe || t[22] !== B || t[23] !== it
    ? ((ot = { hostId: B, connectionDisplayName: it, projectPath: Xe }),
      (t[21] = Xe),
      (t[22] = B),
      (t[23] = it),
      (t[24] = ot))
  ...
  t[25] !== C.currentHostId || t[26] !== nt || t[27] !== st
    ? ((W = { hostId: C.currentHostId, connectionDisplayName: st, projectPath: nt }),
    ...
    : (W = t[28]);
  let ct;
  t[29] !== I || t[30] !== ot || t[31] !== W
    ? ((ct = {
        isAttachedToStartedTask: I,
        existingRemoteThreadState: ot,
        draftNewThreadRemoteSelectionState: W,
      }),
      (t[29] = I),
      (t[30] = ot),
      (t[31] = W),
  ...
  let ut = ct,
    G = N.hostConfig,
    K =
      _(Ye, { hostConfig: G, operationSource: `composer_content` }).data?.available === !0 &&
      ue &&
      !he
        ? N.cwd
        : null,
  ...
  t[39] !== K || t[40] !== G
    ...
    : (yt = t[41]);
  let { canCreateGitRepository: bt, createGitRepository: xt, isCreatingGitRepository: Ct } = de(yt),
    Et = K != null && q != null,
    J = ue && Et && q?.root == null,
    Y = !bt || Ct || !Et || mt,
    X = J ? null : x,
    ...
    At;
  t[42] !== kt || t[43] !== o
    ? ((At = { hostId: o, workspaceRoot: kt }), (t[42] = kt), (t[43] = o), (t[44] = At))
    : (At = t[44]);
  let {
      environments: jt,
      isLoading: Z,
    ...
    ? ((Q =
        !A && Dt
          ? (0, $.jsx)(dt, {
              ...
              onOpenSettings: () => {
                (pe(D, o),
                  k(Pe({ workspaceRoot: l }), {
                    state: { hostId: o, returnTo: `${O.pathname}${O.search}${O.hash}` },
                  }));
              },
            })
          : null),
  ...
  if (
    ...
    bb0: {
            ...
            !A && (r === `cloud` || r === `worktree`)
              ? (0, $.jsx)(ge, {
                  ...
                  children: (0, $.jsx)(ht, {
                    startingState: ie,
                    setStartingState: (e) => {
                      Le(D, `asyncThreadStartingState`, e);
                    },
                    hostConfig: G,
                    gitRootOverride: h,
      ...
      let s = o,
        c;
      t[105] !== Re || t[106] !== M || t[107] !== N.cwd || t[108] !== V || t[109] !== Fe
        ? ((c =
            Fe && St({ isCompactWindow: le }) && M != null && N.cwd != null
              ? { conversationTitle: Re, cwd: g(N.cwd), isWorktreeConversation: V }
              : null),
          (t[105] = Re),
          (t[106] = M),
          (t[107] = N.cwd),
        ...
        : (c = t[110]);
      let l = c,
        u = M != null && B !== `local` && _e?.role === `follower`,
        f = (b === `always` || r === `local`) && !u && !he && !mt;
      q?.root;
      let _;
      t[111] !== M || t[112] !== q?.root || t[113] !== G || t[114] !== J || t[115] !== f
        ? ((_ =
            f && !J
              ? (0, $.jsx)(gt, {
                  gitRoot: q?.root ?? null,
      ...
      let x = y,
        S;
      t[128] !== T || t[129] !== r || t[130] !== A || t[131] !== m || t[132] !== n
        ? ((S =
            m && vt(r) && !A
              ? (0, $.jsx)(ge, {
                  electron: !0,
      ...
      let C = S,
        w;
      t[134] !== r || t[135] !== A || t[136] !== X
        ? ((w = !!A || !1), (t[134] = r), (t[135] = A), (t[136] = X), (t[137] = w))
        : (w = t[137]);
      let ee = w,
        te;
      t[138] === ee
        ? (te = t[139])
        : ((te = ee ? (0, $.jsx)(Pt, {}) : null), (t[138] = ee), (t[139] = te));
      let O = te,
        k;
      t[140] !== ae || t[141] !== r || t[142] !== A || t[143] !== D
        ? ((k =
            r === `cloud` && A?.type === `cloud` && A.hasAppliedCodeLocally
              ? (0, $.jsx)(Ot, {
                  startingState: ae,
                  setStartingState: (e) => {
                    Le(D, `followUpCloudStartingState`, e);
                  },
                })
              : null),
          (t[140] = ae),
        ...
        : (k = t[144]);
      let re = k,
        j = we ? ut.draftNewThreadRemoteSelectionState : ut.existingRemoteThreadState,
        ue;
      t[145] !== xt || t[146] !== Y || t[147] !== Ct || t[148] !== J || t[149] !== f
        ? ((ue =
            f && J
              ? (0, $.jsxs)(et, {
                  className: `px-0`,
        ...
        : (ue = t[150]);
      let de = ue,
        fe = r === `local` && j.hostId != null && j.hostId !== `local`,
        pe;
      t[151] !== j || t[152] !== fe
        ? ((pe = fe
            ? (0, $.jsx)(`div`, {
                ...
                children: (0, $.jsx)(zt, {
                  hostId: j.hostId,
                  connectionDisplayName: j.connectionDisplayName,
      ...
      let me = pe,
        P = d && !0,
        F;
      t[154] !== r || t[155] !== M || t[156] !== i || t[157] !== U
        ? ((F =
            r === `cloud`
              ? (0, $.jsx)(ge, {
                  electron: !0,
      ...
      t[164] !== It
        ? ((ve =
            A?.type === `cloud`
              ? (0, $.jsxs)($.Fragment, { children: [v, re] })
              : (0, $.jsxs)($.Fragment, { children: [v, I, It, s] })),
          (t[159] = s),
          (t[160] = I),
          (t[161] = re),
          (t[162] = A?.type),
      ...
      t[171] !== n
        ? ((R =
            A?.type === `cloud`
              ? (0, $.jsxs)($.Fragment, {
                  children: [n === `home` ? v : null, x, n === `default` ? v : null, re],
                })
              : (0, $.jsxs)($.Fragment, { children: [x, L] })),
          (t[166] = re),
          (t[167] = A?.type),
          (t[168] = v),
          (t[169] = L),
      ...
      let ye = R,
        ...
        Ce = n === `default` ? C : null,
        Te;
      t[173] !== xe || t[174] !== Se || t[175] !== Ce
        ? ((Te = (0, $.jsxs)($.Fragment, { children: [xe, Se, Ce] })),
          (t[173] = xe),
          (t[174] = Se),
          (t[175] = Ce),
          (t[176] = Te))
      ...
      let Ee = Te,
        ...
        ke = P ? L : null,
        Ae;
      t[177] !== De || t[178] !== ke || t[179] !== C
        ? ((Ae = (0, $.jsxs)($.Fragment, { children: [De, C, ke] })),
          (t[177] = De),
          (t[178] = ke),
          (t[179] = C),
          (t[180] = Ae))
      ...
      if (H) {
        ...
        (t[188] === je
          ...
          : ((n = (0, $.jsx)(`div`, {
            ...
            (t[189] = n)),
          (Rt = (0, $.jsxs)(se, {
            className: Oe(e, ne.homeExternalFooter, `flex-nowrap gap-2 overflow-hidden`),
            responsive: !1,
            children: [n, Ne],
          })));
        break bb0;
      ...
      Lt = (0, $.jsxs)(se, {
        className: Oe(e, `flex-wrap gap-2 overflow-visible`, n === `default` && `pl-2`),
        children: [
          (0, $.jsx)(`div`, {
...
function zt(e) {
  ...
  return (
    t[7] !== i || t[8] !== a || t[9] !== l
      ? ((u = (0, $.jsx)(M, { tooltipContent: i, disabled: a, children: l })),
        (t[7] = i),
        (t[8] = a),
        (t[9] = l),
        (t[10] = u))
