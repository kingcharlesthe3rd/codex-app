...
import { Hr as t, Kn as n, U as r, r as i } from "./src-2.js";
import {
  Ko as a,
  Qn as o,
  Wo as s,
...
import { o as D, r as O } from "./lib-2.js";
import { m as k } from "./chunk-12.js";
...
import { k as ne, t as re } from "./composer-view-state.js";
...
import { n as ae } from "./use-webview-execution-target.js";
import "./remote-projects.js";
import "./collaboration-mode-queries.js";
import { n as oe, t as se } from "./composer-footer.js";
...
import { t as fe } from "./local-active-workspace-root-dropdown-D.js";
...
import { n as _e } from "./local-remote-selection.js";
...
import { n as Ce, t as we } from "./local-remote-dropdown-C.js";
import "./dock.js";
...
function Ee(e) {
  ...
  t[10] === n
    ? (v = t[11])
    : ((v = n === `local` ? (0, z.jsx)(D, { ...B.local }) : (0, z.jsx)(D, { ...B.cloud })),
      (t[10] = n),
      (t[11] = v));
  let y = v,
    x;
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, z.jsx)(D, { ...B.tooltip })), (t[12] = x))
    : (x = t[12]);
  let S;
  t[13] === n
    ? (S = t[14])
  ...
  t[15] === y
    ? (C = t[16])
    : ((C = (0, z.jsx)(oe, { collapse: `xs`, className: `max-w-40 truncate`, children: y })),
      (t[15] = y),
      (t[16] = C));
  let w;
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, z.jsx)(F, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[17] = w))
    : (w = t[17]);
  let T;
  t[18] !== S || t[19] !== C
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, z.jsx)(D, { ...B.local })), (t[25] = A))
    : (A = t[25]);
  let j;
  t[26] !== O || t[27] !== k
    ? ((j = (0, z.jsx)(pe.Item, { LeftIcon: L, RightIcon: O, onClick: k, children: A })),
      (t[26] = O),
      (t[27] = k),
      (t[28] = j))
    : (j = t[28]);
  ...
  t[29] !== n || t[30] !== f || t[31] !== r || t[32] !== c
    ? ((M = f
        ? (0, z.jsx)(pe.Item, {
            LeftIcon: I,
            RightIcon: n === `cloud` ? P : void 0,
            onClick: () => {
              (c(`cloud`), r(`cloud`), s(!1));
            },
            children: (0, z.jsx)(D, { ...B.cloud }),
          })
        : null),
      (t[29] = n),
      (t[30] = f),
  ...
  let N;
  t[34] !== j || t[35] !== M
    ? ((N = (0, z.jsxs)(`div`, { className: `flex w-44 flex-col`, children: [E, j, M] })),
      (t[34] = j),
      (t[35] = M),
      (t[36] = N))
    : (N = t[36]);
  let se;
  return (
    t[37] !== a || t[38] !== T || t[39] !== N
      ? ((se = (0, z.jsx)(me, { open: a, onOpenChange: s, triggerButton: T, children: N })),
        (t[37] = a),
        (t[38] = T),
        (t[39] = N),
        (t[40] = se))
...
function De(e) {
  ...
  t[0] === n
    ...
    : ((o =
        n === `working-tree`
          ? (0, z.jsx)(D, { ...V.workingTree })
          : (0, z.jsx)(D, { ...V.directFollowUp })),
      (t[0] = n),
      (t[1] = o));
  let s = o,
    c;
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, z.jsx)(A, { className: `icon-xs` })), (t[3] = u))
    : (u = t[3]);
  let d;
  t[4] === l
    ? (d = t[5])
  ...
  t[9] !== d || t[10] !== f
    ? ((m = (0, z.jsx)(te, {
        tooltipContent: c,
        children: (0, z.jsxs)(ie, { size: `composerSm`, color: `ghost`, children: [d, f, p] }),
      })),
      (t[9] = d),
      (t[10] = f),
      (t[11] = m))
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, z.jsx)(D, { ...V.workingTree })), (t[15] = v))
    : (v = t[15]);
  let y;
  t[16] !== g || t[17] !== _
    ? ((y = (0, z.jsx)(te, {
        tooltipContent: h,
        children: (0, z.jsx)(pe.Item, { LeftIcon: Oe, RightIcon: g, onClick: _, children: v }),
      })),
      (t[16] = g),
      (t[17] = _),
      (t[18] = y))
    : (y = t[18]);
  let b = n === `direct-follow-up` ? P : void 0,
    x;
  t[19] === r
    ? (x = t[20])
    : ((x = () => {
  ...
  let S;
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, z.jsx)(D, { ...V.directFollowUp })), (t[21] = S))
    : (S = t[21]);
  let C;
  t[22] !== b || t[23] !== x
    ? ((C = (0, z.jsx)(pe.Item, { LeftIcon: A, RightIcon: b, onClick: x, children: S })),
      (t[22] = b),
      (t[23] = x),
      (t[24] = C))
    : (C = t[24]);
  ...
  return (
    t[28] !== i || t[29] !== w || t[30] !== m
      ? ((T = (0, z.jsx)(me, { open: i, onOpenChange: a, triggerButton: m, children: w })),
        (t[28] = i),
        (t[29] = w),
        (t[30] = m),
        (t[31] = T))
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, z.jsx)(xe, {
          ...
          children: (0, z.jsx)(A, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
var H = C(w, `has-custom-cli-executable`, { staleTime: E.FIVE_SECONDS });
function Ae() {
  let e = (0, Te.c)(2),
    { data: t } = b(H);
...
function Me(e) {
  let o = (0, Te.c)(178),
    {
      ...
      worktreeEnvironmentHostId: ee,
      worktreeEnvironmentWorkspaceRoot: O,
      codexHome: te,
      hideRunLocationDropdown: re,
      showWorkspaceDropdown: de,
      gitRootForStartingState: P,
      showFooterBranchWhen: pe,
      freeUpsellButton: me,
      remoteConfig: F,
    ...
    R = re === void 0 ? !1 : re,
    B = de === void 0 ? !0 : de,
    Oe = pe === void 0 ? `local` : pe,
    V = k(),
    H = b(ne),
    Me;
  o[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((Me = ue()), (o[0] = Me)) : (Me = o[0]);
  let Pe = Me,
    Fe = d !== `cloud` && H?.type !== `cloud`,
    ...
    Be = x(je, W),
    Ve = H != null || Be,
    He = F?.currentHostId ?? `local`,
    Ue = H?.type,
    We;
  o[1] !== d || o[2] !== He || o[3] !== Be || o[4] !== Ue
    ? ((We = _e({
        composerMode: d,
  ...
  let Ge = We,
    ...
    Ke = !Ge && K !== `local`,
    qe = x(u, U),
    { data: Je } = M(t.THREAD_PROJECT_ASSIGNMENTS),
    Ye = i({ cwd: qe, assignment: U == null ? void 0 : Je?.[U] }),
    Xe = N(G.hostId) ?? te,
    Ze = U ?? v,
    Qe = r(Ye, Xe),
    $e = j(`1115442235`),
    ...
    it;
  o[6] !== rt || o[7] !== K
    ? ((it = rt.find((e) => e.hostId === K) ?? null), (o[6] = rt), (o[7] = K), (o[8] = it))
    : (it = o[8]);
  let at = it,
    ot;
  o[9] !== G.cwd || o[10] !== Ke || o[11] !== F || o[12] !== K
    ? ((ot = K === `local` ? null : Ke ? G.cwd : (F?.getProjectPathForHostId(K) ?? null)),
      (o[9] = G.cwd),
      (o[10] = Ke),
      (o[11] = F),
      (o[12] = K),
  ...
  let st = ot,
    ct;
  o[14] !== F?.currentHostId || o[15] !== rt
    ? ((ct = rt.find((e) => e.hostId === F?.currentHostId) ?? null),
      (o[14] = F?.currentHostId),
      (o[15] = rt),
      (o[16] = ct))
    : (ct = o[16]);
  let lt = ct,
  ...
  o[17] === F
    ? (ut = o[18])
    : ((ut = F?.getProjectPathForHostId(F?.currentHostId ?? null) ?? null),
      (o[17] = F),
      (o[18] = ut));
  let dt = ut;
  (at?.displayName, F?.currentHostId, lt?.displayName);
  let ft = K === `local` ? null : (at?.displayName ?? null),
    pt;
  o[19] !== st || o[20] !== K || o[21] !== ft
    ? ((pt = { hostId: K, connectionDisplayName: ft, projectPath: st }),
      (o[19] = st),
      (o[20] = K),
      (o[21] = ft),
      (o[22] = pt))
    : (pt = o[22]);
  let mt = F?.currentHostId ?? null,
    ht = lt?.displayName ?? null,
    gt;
  o[23] !== dt || o[24] !== mt || o[25] !== ht
    ? ((gt = { hostId: mt, connectionDisplayName: ht, projectPath: dt }),
      (o[23] = dt),
      (o[24] = mt),
      (o[25] = ht),
      (o[26] = gt))
    : (gt = o[26]);
  let _t;
  o[27] !== Ve || o[28] !== pt || o[29] !== gt
    ? ((_t = {
        isAttachedToStartedTask: Ve,
        existingRemoteThreadState: pt,
        draftNewThreadRemoteSelectionState: gt,
      }),
      (o[27] = Ve),
      (o[28] = pt),
      (o[29] = gt),
  ...
  let bt = x(c, yt),
    xt;
  o[37] !== J || o[38] !== Y
    ? ((xt = { cwd: J, hostConfig: Y, showErrorToast: !0 }), (o[37] = J), (o[38] = Y), (o[39] = xt))
    : (xt = o[39]);
  let { canCreateGitRepository: St, createGitRepository: Ct, isCreatingGitRepository: wt } = ve(xt),
    Tt = J != null && X != null,
    Z = Fe && Tt && X?.root == null,
    Et = !St || wt || !Tt || bt,
    Q = Z ? null : me,
    ...
    kt;
  o[40] !== Ot || o[41] !== ge
    ? ((kt = { hostId: ge, workspaceRoot: Ot }), (o[40] = Ot), (o[41] = ge), (o[42] = kt))
    : (kt = o[42]);
  let {
      environments: At,
      isLoading: jt,
  ...
  if (
    ...
    let e = y(
      ...
      t;
    o[98] !== C || o[99] !== d || o[100] !== H || o[101] !== P || o[102] !== Y || o[103] !== w
      ? ((t =
          !H && (d === `cloud` || d === `worktree`)
            ? (0, z.jsx)(be, {
                startingState: C,
                setStartingState: w,
                hostConfig: Y,
    ...
    o[114] !== $e
      ? ((s =
          $e && Ce({ isCompactWindow: Pe }) && W != null && G.cwd != null
            ? { conversationTitle: nt, cwd: n(G.cwd), disabled: tt, isWorktreeConversation: Qe }
            : null),
        (o[109] = W),
        (o[110] = nt),
        (o[111] = G.cwd),
      ...
      : (s = o[115]);
    let c = s,
      l = W != null && K !== `local` && ze?.role === `follower`,
      u = (Oe === `always` || d === `local`) && !l && !Le && !bt;
    X?.root;
    let f;
    (o[116] !== U || o[117] !== X?.root || o[118] !== Y || o[119] !== Z || o[120] !== u
      ? ((f =
          u && !Z
            ? (0, z.jsx)(Se, {
                gitRoot: X?.root ?? null,
    ...
    o[132] !== a
      ? ((p =
          H?.type === `cloud`
            ? (0, z.jsx)(Ee, { composerMode: d, setComposerMode: _ })
            : (0, z.jsx)(we, {
                composerMode: d,
                setComposerMode: _,
                conversationId: Ze,
      ...
      (zt = p));
    let m;
    (o[134] !== I || o[135] !== d || o[136] !== H || o[137] !== B || o[138] !== L
      ? ((m =
          B && ke(d) && !H
            ? (0, z.jsx)(le, {
                electron: !0,
      ...
      (Wt = m));
    let h;
    o[140] !== d || o[141] !== H || o[142] !== Q
      ? ((h = !1), (o[140] = d), (o[141] = H), (o[142] = Q), (o[143] = h))
      : (h = o[143]);
    let g = !!H || h,
      v;
    (o[144] === g
      ? (v = o[145])
      : ((v = g ? (0, z.jsx)(Ae, {}) : null), (o[144] = g), (o[145] = v)),
      (Ut = v));
    let b;
    (o[146] !== T || o[147] !== d || o[148] !== H || o[149] !== E
      ? ((b =
          d === `cloud` && H?.type === `cloud` && H.hasAppliedCodeLocally
            ? (0, z.jsx)(De, { startingState: T, setStartingState: E })
            : null),
        (o[146] = T),
        (o[147] = d),
        (o[148] = H),
      ...
      : (b = o[150]),
      (Vt = b));
    let x = Ge ? q.draftNewThreadRemoteSelectionState : q.existingRemoteThreadState,
      ee;
    (o[151] !== Ct || o[152] !== Et || o[153] !== wt || o[154] !== Z || o[155] !== u
      ? ((ee =
          u && Z
            ? (0, z.jsxs)(ie, {
                className: `px-0`,
      ...
      : (ee = o[156]),
      (Rt = ee));
    let O = d === `local` && x.hostId != null && x.hostId !== `local`,
      k;
    (o[157] !== x || o[158] !== O
      ? ((k = O
          ? (0, z.jsx)(`div`, {
      ...
      ($ = k),
      (Lt = se),
      (Ht = y(e, `flex-wrap gap-2 overflow-visible`, L === `default` && `pl-2`)),
      (o[52] = I),
      (o[53] = C),
      (o[54] = W),
      (o[55] = ze?.role),
    ...
    ((Lt = o[89]),
      ...
      (Wt = o[97]));
  let Gt = L === `home` ? Wt : zt,
    Kt = H?.type === `cloud` ? Bt : null,
    qt = L === `home` ? zt : Wt,
    Jt;
  o[160] !== Gt || o[161] !== Kt || o[162] !== qt
    ? ((Jt = (0, z.jsxs)(`div`, {
  ...
  o[164] !== d || o[165] !== Vt
    ? ((Yt =
        d === `cloud`
          ? (0, z.jsx)(`div`, { className: `flex min-w-0 items-center gap-1`, children: Vt })
          : null),
      (o[164] = d),
      (o[165] = Vt),
      (o[166] = Yt))
    : (Yt = o[166]);
  let Xt;
  o[167] !== Rt || o[168] !== $ || o[169] !== Q || o[170] !== Ut
    ? ((Xt =
        $ || Rt || Q || Ut
          ? (0, z.jsxs)(`div`, {
  ...
  let Zt;
  return (
    o[172] !== Lt || o[173] !== Ht || o[174] !== Jt || o[175] !== Yt || o[176] !== Xt
      ? ((Zt = (0, z.jsxs)(Lt, { className: Ht, children: [Jt, Yt, Xt] })),
        (o[172] = Lt),
        (o[173] = Ht),
        (o[174] = Jt),
        (o[175] = Yt),
...
function Ne(e) {
  ...
  t[0] === o
    ...
    : ((s = (0, z.jsx)(`span`, { className: `max-w-40 min-w-0 truncate`, children: o })),
      ...
      (t[1] = s));
  let c;
  t[2] === n ? (c = t[3]) : ((c = (0, z.jsx)(ge, { hostId: n })), (t[2] = n), (t[3] = c));
  let l;
  t[4] !== s || t[5] !== c
    ? ((l = (0, z.jsxs)(oe, {
        collapse: `sm`,
  ...
  return (
    t[7] !== i || t[8] !== a || t[9] !== l
      ? ((u = (0, z.jsx)(te, { tooltipContent: i, disabled: a, children: l })),
        (t[7] = i),
        (t[8] = a),
        (t[9] = l),
        (t[10] = u))
