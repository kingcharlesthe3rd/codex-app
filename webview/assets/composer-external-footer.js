...
import { xn as we, yn as Te } from "./app-initial~app-main~automations-page.js";
import {
  f as Ee,
  p as De,
...
function Tt(e) {
  let t = (0, Et.c)(35),
    ...
    [c, l] = (0, J.useState)(!1),
    u = y(),
    { data: d, isLoading: f } = ce(u.cwd, u.hostConfig, `cloud_follow_up_local_remote_dropdown`),
    p = d?.root != null,
  ...
  t[9] === n
    ? (b = t[10])
    : ((b = n === `local` ? (0, Y.jsx)(z, { ...X.local }) : (0, Y.jsx)(z, { ...X.cloud })),
      (t[9] = n),
      (t[10] = b));
  let x = b,
    S;
  ...
  let D;
  t[21] !== te || t[22] !== T
    ? ((D = (0, Y.jsx)(H.Item, { LeftIcon: W, RightIcon: te, onClick: T, children: E })),
      (t[21] = te),
      (t[22] = T),
      (t[23] = D))
    : (D = t[23]);
  ...
  let k;
  t[28] !== D || t[29] !== O
    ? ((k = (0, Y.jsxs)(`div`, { className: `flex w-44 flex-col`, children: [ee, D, O] })),
      (t[28] = D),
      (t[29] = O),
      (t[30] = k))
    : (k = t[30]);
  ...
  return (
    t[31] !== c || t[32] !== k || t[33] !== w
      ? ((A = (0, Y.jsx)(U, { open: c, onOpenChange: l, triggerButton: w, children: k })),
        (t[31] = c),
        (t[32] = k),
        (t[33] = w),
        (t[34] = A))
...
function Ot(e) {
  ...
  t[14] !== g || t[15] !== h
    ? ((v = (0, Z.jsx)(N, {
        tooltipContent: m,
        children: (0, Z.jsx)(H.Item, { LeftIcon: kt, RightIcon: h, onClick: g, children: _ }),
      })),
      (t[14] = g),
      (t[15] = h),
      (t[16] = v))
  ...
  let S;
  t[20] !== y || t[21] !== b
    ? ((S = (0, Z.jsx)(H.Item, { LeftIcon: Be, RightIcon: y, onClick: b, children: x })),
      (t[20] = y),
      (t[21] = b),
      (t[22] = S))
    : (S = t[22]);
  ...
  return (
    t[26] !== i || t[27] !== C || t[28] !== p
      ? ((w = (0, Z.jsx)(U, { open: i, onOpenChange: a, triggerButton: p, children: C })),
        (t[26] = i),
        (t[27] = C),
        (t[28] = p),
        (t[29] = w))
    ...
    e[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Q.jsx)(N, {
          ...
          children: (0, Q.jsx)(se, {
            ...
            uniform: !0,
            className: `-mx-2`,
            children: (0, Q.jsx)(Ze, { className: `icon-xs text-token-editor-warning-foreground` }),
          }),
        })),
        (e[1] = r))
      : (r = e[1]),
...
function Rt(e) {
  let t = (0, Bt.c)(190),
    ...
    N = Ke(),
    P;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((P = Qe()), (t[0] = P)) : (P = t[0]);
  let ce = P,
  ...
  let De = we,
    ...
    Pe = h(l({ cwd: ke, assignment: L == null ? void 0 : Ae?.[L] }), Ie(R.hostId) ?? p),
    Re = oe(`2700454473`),
    H = n === `home` && Re,
    ze = oe(`1115442235`),
    U = Pe,
    ...
    Ge;
  t[8] !== Ue || t[9] !== V
    ? ((Ge = Ue.find((e) => e.hostId === V) ?? null), (t[8] = Ue), (t[9] = V), (t[10] = Ge))
    : (Ge = t[10]);
  let Je = Ge,
    Ye;
  ...
  t[19] === E
    ? (tt = t[20])
    : ((tt = E.getProjectPathForHostId(E.currentHostId)), (t[19] = E), (t[20] = tt));
  let nt = tt;
  ...
  t[25] !== E.currentHostId || t[26] !== nt || t[27] !== ot
    ? ((st = { hostId: E.currentHostId, connectionDisplayName: ot, projectPath: nt }),
  ...
  let W = lt,
    G = R.hostConfig,
    K =
      c(qe, { hostConfig: G, operationSource: `composer_content` }).data?.available === !0 &&
      F &&
      !ge
        ? R.cwd
        : null,
  ...
  t[39] !== K || t[40] !== G
    ...
    : (yt = t[41]);
  let { canCreateGitRepository: bt, createGitRepository: xt, isCreatingGitRepository: Ct } = C(yt),
    Et = K != null && q != null,
    J = F && Et && q?.root == null,
    Y = !bt || Ct || !Et || mt,
    X = J ? null : T,
    ...
    At;
  t[42] !== kt || t[43] !== d
    ? ((At = { hostId: d, workspaceRoot: kt }), (t[42] = kt), (t[43] = d), (t[44] = At))
    : (At = t[44]);
  let {
      environments: jt,
      isLoading: Z,
              ...
              onOpenSettings: () => {
                (k(A, d),
                  ne(Te({ workspaceRoot: f }), {
                    state: { hostId: d, returnTo: `${j.pathname}${j.search}${j.hash}` },
                  }));
              },
            })
          : null),
  ...
  if (
    ...
    bb0: {
      ...
      let s = o,
        c;
      t[105] !== Ve || t[106] !== L || t[107] !== R.cwd || t[108] !== Pe || t[109] !== ze
        ? ((c =
            ze && St({ isCompactWindow: ce }) && L != null && R.cwd != null
              ? { conversationTitle: Ve, cwd: u(R.cwd), isWorktreeConversation: Pe }
              : null),
          (t[105] = Ve),
          (t[106] = L),
          (t[107] = R.cwd),
      ...
      q?.root;
      let p;
      t[111] !== L || t[112] !== q?.root || t[113] !== G || t[114] !== J || t[115] !== f
        ? ((p =
            f && !J
              ? (0, $.jsx)(gt, {
                  gitRoot: q?.root ?? null,
      ...
      let y = v,
        C;
      t[128] !== D || t[129] !== r || t[130] !== M || t[131] !== _ || t[132] !== n
        ? ((C =
            _ && vt(r) && !M
              ? (0, $.jsx)(rt, {
                  electron: !0,
      ...
      t[134] !== r || t[135] !== M || t[136] !== X
        ? ((T = !!M || !1), (t[134] = r), (t[135] = M), (t[136] = X), (t[137] = T))
        : (T = t[137]);
      let E = T,
        k;
      t[138] === E
      ...
      t[140] !== ae || t[141] !== r || t[142] !== M || t[143] !== A
        ...
        : (ne = t[144]);
      let re = ne,
        oe = De ? W.draftNewThreadRemoteSelectionState : W.existingRemoteThreadState,
        P;
      ...
      let Ae = ke,
        je;
      t[181] !== le || t[182] !== j || t[183] !== B || t[184] !== fe || t[185] !== F || t[186] !== X
        ? ((je =
            F && B
              ? (0, $.jsxs)(`div`, {
      ...
      if (H) {
        ...
        (t[188] === Ae
          ...
          : ((n = (0, $.jsx)(`div`, {
            ...
            (t[189] = n)),
          (Rt = (0, $.jsxs)(te, {
            className: Ee(e, ee.homeExternalFooter, `flex-nowrap gap-2 overflow-hidden`),
            responsive: !1,
            children: [n, Me],
          })));
        break bb0;
...
function zt(e) {
  ...
  t[0] === o
    ...
    : ((s = (0, $.jsx)(`span`, { className: `max-w-40 min-w-0 truncate`, children: o })),
      ...
      (t[1] = s));
  let c;
  t[2] === n ? (c = t[3]) : ((c = (0, $.jsx)(nt, { hostId: n })), (t[2] = n), (t[3] = c));
  let l;
  t[4] !== s || t[5] !== c
    ? ((l = (0, $.jsxs)(S, {
        collapse: `sm`,
