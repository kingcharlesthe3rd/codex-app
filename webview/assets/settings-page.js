...
import { n as c, r as l } from "./use-host-config-C.js";
import "./thread-context-inputs.js";
import "./vscode-api.js";
import "./isEqual.js";
import "./src-1.js";
import "./react-dom.js";
import { i as u, l as d, r as f, s as p } from "./lib-1.js";
import { t as m } from "./clsx.js";
import "./proxy.js";
import { u as h } from "./app-shell-state.js";
import { c as g, m as ee, s as _, t as te } from "./app-shell.js";
import "./button.js";
...
import { t as v } from "./tooltip-B.js";
import "./context-menu.js";
import "./toast-signal.js";
import { t as y } from "./x.js";
import "./badge.js";
import "./rpc-1.js";
import { o as ne, u as b } from "./statsig.js";
import "./request.js";
import "./chevron.js";
import "./markdown-to-search-text.js";
import "./core.esm.js";
import "./marked.esm.js";
import { Pn as x, t as re } from "./product-logger.js";
import { a as S, f as C, m as ie, o as ae, p as w } from "./chunk-13.js";
...
import { n as oe } from "./remote-connection-visibility.js";
import "./sidebar-signals.js";
import { t as T } from "./use-auth.js";
import "./use-global-state.js";
import { t as E } from "./use-os-info.js";
...
import { n as O } from "./experimental-features-queries-D.js";
import { i as k, n as se, r as A, t as j } from "./use-is-plugins-enabled-B.js";
import "./browser-sidebar-availability.js";
import "./uniq.js";
import { t as M } from "./branch.js";
import "./info.js";
import { t as N } from "./arrow-left.js";
...
import { i as P, r as F, t as I } from "./locale-resolver.js";
import "./use-window-controls-safe-area.js";
import { t as L } from "./use-is-remote-host.js";
import "./folder.js";
import { t as R } from "./settings.cog.js";
import { t as z } from "./skills.js";
import { t as B } from "./mcp.js";
...
import { i as K, n as ce, r as le, t as q } from "./settings-back-route.js";
import "./links.js";
import { s as J } from "./dropdown.js";
import { t as Y } from "./globe.js";
import "./remote-host-globe-icon-B5-baJXK.js";
import { t as X } from "./cloud.js";
import { t as Z } from "./worktree.js";
import { t as Q } from "./archive.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as ue } from "./settings-host-context.js";
import "./laptop.js";
import { t as de } from "./avatar.js";
import { t as fe } from "./speedometer.js";
import { n as pe, r as me } from "./profile-queries.js";
import { n as he } from "./profile-visibility.js";
import { t as ge } from "./use-usage-settings-access.js";
import { t as _e } from "./appshot-availability.js";
import { t as ve } from "./arrow-top-right.js";
import { n as ye } from "./computer-use-app-approvals-query.js";
import { t as be } from "./shield-code.js";
import { a as xe, n as Se } from "./settings-shared.js";
import { t as Ce } from "./score-query-match.js";
import { t as we } from "./face-BkY0-VYb.js";
import { t as Te } from "./list-navigation.js";
import { t as Ee } from "./appshot-window.js";
import { n as De, t as Oe } from "./settings-content-layout.js";
import { t as ke } from "./sun.js";
import { t as Ae } from "./hooks.js";
import { t as je } from "./filter.js";
import { t as Me } from "./cursor-CY-4WWCc.js";
import { t as Ne } from "./dock.js";
import { t as Pe } from "./app-window.js";
import { t as Fe } from "./experimental-feature-visibility.js";
import { t as Ie } from "./settings-host-dropdown.js";
var Le = r(),
  Re = e(t()),
  $ = n(),
  ze = (e) =>
  ...
  He = new WeakMap();
function Ue({ intl: e, query: t, targets: n, visibleSectionSlugs: r }) {
...
function We(e, t, n) {
  let { messageTexts: r, panelLabel: i, sectionSlug: a } = e,
    o = Ce(i, t);
  if (o > 0) return { label: i, matchPriority: 0, panelLabel: i, score: o, sectionSlug: a };
  let s = Ge([i, ...r], n);
  if (s === 0) return null;
  let c = null;
  for (let e of r) {
    let r = Math.max(Ce(e, t), ...n.map((t) => Ce(e, t)));
...
function Ge(e, t) {
  let n = t.map((t) => Math.max(0, ...e.map((e) => Ce(e, t))));
  return n.length === 0 || n.some((e) => e === 0) ? 0 : n.reduce((e, t) => e + t, 0);
}
function Ke(e, t) {
  let n = He.get(e);
  n ?? ((n = new WeakMap()), He.set(e, n));
  let r = n.get(t);
  if (r != null) return r;
  let i = {
    messageTexts: [
    ...
    panelLabel: e.formatMessage(xe(t.sectionSlug)),
...
var qe = {
  ...
  Qe = `1785186884`,
  $e = {
    collapsed: { icon: _, message: Je.expandSidebar },
    expanded: { icon: g, message: Je.collapseSidebar },
  };
function et(e) {
  let t = (0, Le.c)(89),
    {
    ...
    ie;
  t[0] !== x || t[1] !== C
    ? ((ie = C && x.trim().length > 0), (t[0] = x), (t[1] = C), (t[2] = ie))
    : (ie = t[2]);
  let ae = ie,
    w,
    oe;
  t[3] !== _ || t[4] !== x || t[5] !== ee || t[6] !== n
    ? ((w = Ue({ intl: _, query: x, targets: ee, visibleSectionSlugs: n.flatMap(at) })),
      (oe = w.map(it).join(`\0`)),
      (t[3] = _),
      (t[4] = x),
      (t[5] = ee),
  ...
  let T = oe,
    E;
  t[9] === T ? (E = t[10]) : ((E = T.length === 0 ? [] : T.split(`\0`)), (t[9] = T), (t[10] = E));
  let D = E,
    O = C && x.length > 0,
    k;
  t[11] !== i || t[12] !== w
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (se = t[14]);
  let A;
  t[15] !== D || t[16] !== O || t[17] !== k
    ? ((A = { items: D, isActive: O, autoHighlightFirst: !1, onSelect: k, onEscape: se }),
      (t[15] = D),
      (t[16] = O),
      (t[17] = k),
      (t[18] = A))
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (F = t[20]);
  let I = F,
    L = S ? $e.collapsed : $e.expanded,
    R;
  t[21] !== L.message || t[22] !== _
    ? ((R = _.formatMessage(L.message)), (t[21] = L.message), (t[22] = _), (t[23] = R))
    : (R = t[23]);
  let z = R,
    B = L.icon,
    V,
  ...
  if (
    ...
    let e = [{ key: `settings`, heading: null, sections: lt(n, Ye) }];
    g && (e = ct(n, Xe));
    let s = e.flatMap(nt);
    (t[51] === a
      ? (J = t[52])
      : ((J = m(`flex min-h-0 flex-1 flex-col select-none px-row-x`, a)), (t[51] = a), (t[52] = J)),
      t[53] === _
        ? (Y = t[54])
        : ((Y = _.formatMessage({
      ...
      t[55] !== B || t[56] !== h || t[57] !== z || t[58] !== L.message
        ? ((W = h
            ? (0, $.jsx)(`div`, {
                className: `mb-2 shrink-0`,
                children: (0, $.jsx)(v, {
                  tooltipContent: (0, $.jsx)(p, { ...L.message }),
                  children: (0, $.jsx)(ce, {
                    "aria-label": z,
                    fullWidth: !1,
                    icon: B,
      ...
      t[63] !== S || t[64] !== f
        ? ((K =
            f != null && !S
              ? (0, $.jsx)(`div`, { className: `mb-4 shrink-0`, children: f })
              : null),
          (t[63] = S),
          (t[64] = f),
          (t[65] = K))
        : (K = t[65]),
      t[66] !== j || t[67] !== x || t[68] !== C
        ? ((q = C
            ? (0, $.jsx)(ot, {
                onKeyDown: j.getInputProps().onKeyDown,
                searchQuery: x,
                onQueryChange: (e) => {
                  (j.setHighlightedIndex(-1), re(e));
                },
              })
            : null),
          (t[66] = j),
          ...
          (t[69] = q))
        : (q = t[69]));
    let c = S ? `flex flex-col gap-2` : `flex flex-col gap-4`;
    (t[70] === c
      ? (V = t[71])
      : ((V = m(`min-h-0 flex-1 overflow-y-auto pb-2`, c)), (t[70] = c), (t[71] = V)),
      (H = ae
        ? (0, $.jsx)(st, {
            intl: _,
        ...
        : e.map((e) =>
            (0, $.jsx)(
              ...
              {
                className: `gap-0`,
                title: S || e.heading == null ? null : (0, $.jsx)(p, { ...e.heading }),
                children: e.sections.map((e) => {
                  let t = e.slug === r,
                    n = !!e.externalUrl,
                    a = !!e.disabled,
                    o = t && e.slug === `pets` ? Be : qe[e.slug],
                    c = _.formatMessage(xe(e.slug)),
                    l = () => {
                      if (!a) {
                        if (n && e.externalUrl) {
                  ...
                  return (0, $.jsx)(
                    v,
                    {
                      tooltipContent: S ? (0, $.jsx)(Se, { slug: e.slug }) : n ? I : P,
                      side: `right`,
                      sideOffset: 12,
                      disabled: !S && !a && !n,
                      children: (0, $.jsx)(ce, {
                        ...
                        isActive: t,
                        disabled: a,
                        "data-settings-panel-slug": g && !a && !n ? e.slug : void 0,
  ...
  t[72] === l
    ...
    : ((X =
      ...
      (t[73] = X));
  let Z;
  t[74] !== V || t[75] !== H || t[76] !== X
    ? ((Z = (0, $.jsxs)(`div`, { className: V, children: [H, X] })),
      (t[74] = V),
      (t[75] = H),
      (t[76] = X),
      (t[77] = Z))
    : (Z = t[77]);
  let Q;
  t[78] !== U || t[79] !== W || t[80] !== G || t[81] !== K || t[82] !== q || t[83] !== Z
    ? ((Q = (0, $.jsxs)(`div`, { className: U, children: [W, G, K, q, Z] })),
      (t[78] = U),
      (t[79] = W),
      (t[80] = G),
      (t[81] = K),
  ...
  let ue;
  return (
    t[85] !== J || t[86] !== Y || t[87] !== Q
      ? ((ue = (0, $.jsx)(`nav`, { className: J, "aria-label": Y, children: Q })),
        (t[85] = J),
        (t[86] = Y),
        (t[87] = Q),
        (t[88] = ue))
...
function ot(e) {
  ...
  t[6] === a
    ...
    : ((f = a.formatMessage({
      ...
      (t[7] = f));
  let p;
  t[8] !== n || t[9] !== r || t[10] !== l || t[11] !== u || t[12] !== f
    ? ((p = (0, $.jsx)(`input`, {
        ref: o,
        "aria-label": l,
    ...
    ? ((m =
        r.length > 0
          ? (0, $.jsx)(`button`, {
              ...
              type: `button`,
              children: (0, $.jsx)(y, { className: `icon-2xs` }),
            })
          : null),
      (t[14] = a),
      (t[15] = i),
...
function st(e) {
  let t = (0, Le.c)(13),
    { highlightedIndex: n, intl: r, listRef: i, onSelect: a, searchResults: o } = e;
  if (o.length === 0) {
    let e;
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
            ...
            `div`,
            {
              ...
              children: [
                (0, $.jsxs)(`div`, {
                  ...
                  children: [
                    (0, $.jsx)(i, { className: `icon-sm shrink-0` }),
                    (0, $.jsx)(`span`, { className: `truncate`, children: e.panelLabel }),
                  ],
                }),
                (0, $.jsx)(`button`, {
  ...
  return (
    t[10] !== i || t[11] !== s
      ? ((c = (0, $.jsx)(`div`, { ref: i, className: `flex flex-col gap-3 pt-1`, children: s })),
        (t[10] = i),
        (t[11] = s),
        (t[12] = c))
      : (c = t[12]),
...
function ct(e, t) {
  ...
  return (
    i.length > 0 && r[r.length - 1]?.sections.push(...i), r.filter((e) => e.sections.length > 0)
  );
}
function lt(e, t) {
  let n = new Map(e.map((e) => [e.slug, e]));
...
var ut = {
    agent: [
      { defaultMessage: `Open config.toml`, id: `codex.profileDropdown.openConfigToml` },
      {
      ...
      },
      {
        ...
        id: `settings-search.literal.1202400a7f40`,
      },
      {
        defaultMessage: `Ask only when a command fails`,
        id: `settings-search.literal.17dd34a3a88a`,
      },
      {
        defaultMessage: `Can read files, but cannot edit them`,
        id: `settings-search.literal.25da932b6b87`,
      },
      {
        defaultMessage: `Can edit files outside this workspace`,
        id: `settings-search.literal.2ee2057f9eb5`,
      },
      {
        defaultMessage: `Run without asking for approval`,
        id: `settings-search.literal.5d4f43e02727`,
      },
      {
        defaultMessage: `Ask when escalation is requested`,
        id: `settings-search.literal.6ddf6851576f`,
      },
      {
        defaultMessage: `Can edit files, but only in this workspace`,
        id: `settings-search.literal.d77aca488122`,
      },
      {
        defaultMessage: `Choose when Codex asks for approval`,
        id: `settings.agent.configuration.approval.definition`,
      },
      { defaultMessage: `Approval policy`, id: `settings.agent.configuration.approval.label` },
      { defaultMessage: `Never`, id: `settings.agent.configuration.approval.option.never` },
      {
      ...
      { defaultMessage: `Allow network access`, id: `settings.agent.configuration.network.label` },
      {
      ...
      { defaultMessage: `Open file`, id: `settings.agent.configuration.notice.openFile` },
      {
        defaultMessage: `Choose how much Codex can do when running commands`,
        id: `settings.agent.configuration.sandbox.definition`,
      },
      { defaultMessage: `Sandbox settings`, id: `settings.agent.configuration.sandbox.label` },
      {
        defaultMessage: `Full access`,
        id: `settings.agent.configuration.sandbox.option.fullAccess`,
      },
      { defaultMessage: `Read only`, id: `settings.agent.configuration.sandbox.option.readOnly` },
      {
      ...
      { defaultMessage: `Global config`, id: `settings.agent.configuration.scope.globalGroup` },
      { defaultMessage: `Loading…`, id: `settings.agent.configuration.scope.loading` },
      { defaultMessage: `Admin config`, id: `settings.agent.configuration.scope.managed` },
      {
        defaultMessage: `Managed by admin policy`,
        id: `settings.agent.configuration.scope.managedDescription`,
      },
      { defaultMessage: `Open config.toml`, id: `settings.agent.configuration.scope.open` },
      { defaultMessage: `{repoName}`, id: `settings.agent.configuration.scope.project` },
      { defaultMessage: `Project config`, id: `settings.agent.configuration.scope.projectGroup` },
      {
      ...
      { defaultMessage: `User config`, id: `settings.agent.configuration.scope.user` },
      {
      ...
      { defaultMessage: `Current version`, id: `settings.agent.dependencies.bundleVersion.label` },
      { defaultMessage: `Checking…`, id: `settings.agent.dependencies.bundleVersion.loading` },
      {
      ...
      { defaultMessage: `Cancel download`, id: `settings.agent.dependencies.cancel.button` },
      {
      ...
      { defaultMessage: `Diagnose`, id: `settings.agent.dependencies.diagnose.button` },
      {
      ...
      { defaultMessage: `Codex dependencies`, id: `settings.agent.dependencies.enabled.label` },
      { defaultMessage: `Reinstall`, id: `settings.agent.dependencies.reset.button` },
      {
      ...
      { defaultMessage: `Workspace Dependencies`, id: `settings.agent.dependencies.sectionTitle` },
      {
      ...
      { defaultMessage: `Plugins`, id: `settings.general.experimentalFeatures.plugins.label` },
      {
    ...
    appearance: [
      ...
      { defaultMessage: `Tokyo Night`, id: `settings-search.literal.08b251ee4fdd` },
      { defaultMessage: `Material`, id: `settings-search.literal.08bdf467eabb` },
      { defaultMessage: `Ayu`, id: `settings-search.literal.0b05a778be98` },
      { defaultMessage: `Gruvbox`, id: `settings-search.literal.0ed21094d832` },
      { defaultMessage: `Vercel Light`, id: `settings-search.literal.1c9237db2b00` },
      { defaultMessage: `Vercel Dark`, id: `settings-search.literal.22febe766668` },
      { defaultMessage: `Absolutely Dark`, id: `settings-search.literal.2310573c8530` },
      { defaultMessage: `Raycast Light`, id: `settings-search.literal.294a0797f708` },
      { defaultMessage: `Sentry`, id: `settings-search.literal.2d6f969ad5fe` },
      { defaultMessage: `One`, id: `settings-search.literal.2fb668d6ae45` },
      { defaultMessage: `Catppuccin`, id: `settings-search.literal.2fd149d97aaf` },
      { defaultMessage: `Codex Dark`, id: `settings-search.literal.3901fff43b84` },
      { defaultMessage: `Notion Dark`, id: `settings-search.literal.482c033768d3` },
      { defaultMessage: `Vercel`, id: `settings-search.literal.49ac21e803f5` },
      { defaultMessage: `Linear Light`, id: `settings-search.literal.52f1f3cb63e9` },
      { defaultMessage: `Raycast`, id: `settings-search.literal.5594d56e9d7b` },
      { defaultMessage: `Sentry Dark`, id: `settings-search.literal.58c8e8a07e0e` },
      { defaultMessage: `Everforest`, id: `settings-search.literal.59da037b81f7` },
      { defaultMessage: `Oscurange`, id: `settings-search.literal.5ccd6acaab61` },
      { defaultMessage: `VS Code Plus`, id: `settings-search.literal.60619a820f7a` },
      { defaultMessage: `Matrix`, id: `settings-search.literal.60eb93304060` },
      { defaultMessage: `Night Owl`, id: `settings-search.literal.62fcf0c8af0b` },
      { defaultMessage: `Proof`, id: `settings-search.literal.6f3d7459c9c6` },
      { defaultMessage: `Notion Light`, id: `settings-search.literal.71e8996903a2` },
      { defaultMessage: `Xcode`, id: `settings-search.literal.738bba08d727` },
      { defaultMessage: `Raycast Dark`, id: `settings-search.literal.75a1760e03d1` },
      { defaultMessage: `Dracula`, id: `settings-search.literal.7b3a05fd9766` },
      { defaultMessage: `Linear Dark`, id: `settings-search.literal.7be417f181e7` },
      { defaultMessage: `Temple`, id: `settings-search.literal.7c276aef66bf` },
      { defaultMessage: `Temple Dark`, id: `settings-search.literal.7ee2e4853e65` },
      ...
      { defaultMessage: `Proof Light`, id: `settings-search.literal.9add453b6ed3` },
      { defaultMessage: `Matrix Dark`, id: `settings-search.literal.9c2149b9b588` },
      { defaultMessage: `Solarized`, id: `settings-search.literal.a4481d449c08` },
      { defaultMessage: `Lobster`, id: `settings-search.literal.a5362281bcdf` },
      { defaultMessage: `Xcode Dark`, id: `settings-search.literal.a80e8166f521` },
      { defaultMessage: `Codex`, id: `settings-search.literal.b182fb2aea11` },
      { defaultMessage: `Rose Pine`, id: `settings-search.literal.b3917e56526f` },
      { defaultMessage: `Xcode Light`, id: `settings-search.literal.b48e27d81bea` },
      { defaultMessage: `Absolutely`, id: `settings-search.literal.b6a700bca967` },
      { defaultMessage: `Nord`, id: `settings-search.literal.bf3921faad10` },
      { defaultMessage: `Oscurange`, id: `settings-search.literal.c3c8cfb0053b` },
      { defaultMessage: `Absolutely Light`, id: `settings-search.literal.c5f3a2d4d334` },
      { defaultMessage: `Monokai`, id: `settings-search.literal.f228b0781d88` },
      { defaultMessage: `Lobster Dark`, id: `settings-search.literal.f71724c4ad3a` },
      { defaultMessage: `Codex Light`, id: `settings-search.literal.fba642b836d9` },
      {
        defaultMessage: `{variant} accent color`,
        id: `settings.general.appearance.chromeTheme.accent`,
      },
      { defaultMessage: `Accent`, id: `settings.general.appearance.chromeTheme.accent.short` },
      {
      ...
      { defaultMessage: `Contrast`, id: `settings.general.appearance.chromeTheme.contrast.short` },
      { defaultMessage: `Copy theme`, id: `settings.general.appearance.chromeTheme.export` },
      {
      ...
      { defaultMessage: `Import`, id: `settings.general.appearance.chromeTheme.import` },
      {
      ...
      { defaultMessage: `{variant} ink color`, id: `settings.general.appearance.chromeTheme.ink` },
      { defaultMessage: `Foreground`, id: `settings.general.appearance.chromeTheme.ink.short` },
      {
        defaultMessage: `{variant} background color`,
        id: `settings.general.appearance.chromeTheme.surface`,
      },
      { defaultMessage: `Background`, id: `settings.general.appearance.chromeTheme.surface.short` },
      {
      ...
      { defaultMessage: `Code font size`, id: `settings.general.appearance.codeFontSize` },
      { defaultMessage: `Code font size`, id: `settings.general.appearance.codeFontSize.row` },
      {
      ...
      { defaultMessage: `px`, id: `settings.general.appearance.codeFontSize.units` },
      { defaultMessage: `{variant} code theme`, id: `settings.general.appearance.codeTheme` },
      { defaultMessage: `Aa`, id: `settings.general.appearance.codeTheme.previewGlyph` },
      { defaultMessage: `Dark theme`, id: `settings.general.appearance.darkChromeTheme` },
      { defaultMessage: `Color`, id: `settings.general.appearance.diffMarkerStyle.color` },
      {
      ...
      { defaultMessage: `Diff markers`, id: `settings.general.appearance.diffMarkerStyle.label` },
      { defaultMessage: `+/-`, id: `settings.general.appearance.diffMarkerStyle.symbols` },
      {
        defaultMessage: `Plus / minus diff markers`,
        id: `settings.general.appearance.diffMarkerStyle.symbols.ariaLabel`,
      },
      { defaultMessage: `Codex Dark`, id: `settings.general.appearance.dockIcon.codexDark` },
      { defaultMessage: `Codex Light`, id: `settings.general.appearance.dockIcon.codexLight` },
      { defaultMessage: `Default`, id: `settings.general.appearance.dockIcon.default` },
      {
        defaultMessage: `Choose the icon {appName} uses in the dock`,
        id: `settings.general.appearance.dockIcon.description`,
      },
      { defaultMessage: `Dock icon`, id: `settings.general.appearance.dockIcon.label` },
      {
        defaultMessage: `Use native macOS font anti-aliasing`,
        id: `settings.general.appearance.fontSmoothing.description`,
      },
      { defaultMessage: `Font smoothing`, id: `settings.general.appearance.fontSmoothing.label` },
      { defaultMessage: `Light theme`, id: `settings.general.appearance.lightChromeTheme` },
      {
        defaultMessage: `Reduce animations or match your system`,
        id: `settings.general.appearance.reducedMotion.description`,
      },
      { defaultMessage: `Reduce motion`, id: `settings.general.appearance.reducedMotion.label` },
      { defaultMessage: `Off`, id: `settings.general.appearance.reducedMotion.off` },
      { defaultMessage: `On`, id: `settings.general.appearance.reducedMotion.on` },
      { defaultMessage: `System`, id: `settings.general.appearance.reducedMotion.system` },
      { defaultMessage: `Sans font size`, id: `settings.general.appearance.sansFontSize` },
      { defaultMessage: `UI font size`, id: `settings.general.appearance.sansFontSize.row` },
      {
        defaultMessage: `Adjust the base size used for the {appName} UI`,
        id: `settings.general.appearance.sansFontSize.row.description`,
      },
      { defaultMessage: `px`, id: `settings.general.appearance.sansFontSize.units` },
      ...
      { defaultMessage: `Light`, id: `settings.general.appearance.theme.light` },
      { defaultMessage: `System`, id: `settings.general.appearance.theme.system` },
      {
    ...
    appshots: [
      ...
      { defaultMessage: `Appshots walkthrough video`, id: `settings.appshots.demoVideo.label` },
      {
      ...
      { defaultMessage: `Play sound effect`, id: `settings.appshots.soundEffect.label` },
    ],
    "browser-use": [
      {
      ...
      { defaultMessage: `Allowed domain added`, id: `settings.browserUse.allowedDomains.added` },
      { defaultMessage: `No allowed domains`, id: `settings.browserUse.allowedDomains.emptyTitle` },
      {
        defaultMessage: `Domains that open without asking`,
        id: `settings.browserUse.allowedDomains.subtitle`,
      },
      { defaultMessage: `Allowed domains`, id: `settings.browserUse.allowedDomains.title` },
      {
      ...
      { defaultMessage: `Allowed domain removed`, id: `settings.browserUse.allowedWebsites.saved` },
      {
        defaultMessage: `Ask before opening websites`,
        id: `settings.browserUse.approval.alwaysAsk.description`,
      },
      { defaultMessage: `Always ask`, id: `settings.browserUse.approval.alwaysAsk.label` },
      {
      ...
      { defaultMessage: `Always allow`, id: `settings.browserUse.approval.neverAsk.label` },
      {
      ...
      { defaultMessage: `Blocked domain added`, id: `settings.browserUse.blockedDomains.added` },
      {
        defaultMessage: `Codex will never open these sites in your browser`,
        id: `settings.browserUse.blockedDomains.chromeSubtitle`,
      },
      { defaultMessage: `No blocked domains`, id: `settings.browserUse.blockedDomains.emptyTitle` },
      {
        defaultMessage: `Codex will never open these sites`,
        id: `settings.browserUse.blockedDomains.subtitle`,
      },
      { defaultMessage: `Blocked domains`, id: `settings.browserUse.blockedDomains.title` },
      {
      ...
      { defaultMessage: `Cached images and files`, id: `settings.browserUse.browser.cache.label` },
      { defaultMessage: `Browser cache cleared`, id: `settings.browserUse.browser.cacheCleared` },
      {
        defaultMessage: `Clear all browsing data`,
        id: `settings.browserUse.browser.clearBrowsingData`,
      },
      {
        defaultMessage: `Clear site data, cache, and download history from the in-app browser`,
      ...
      { defaultMessage: `Delete cookies`, id: `settings.browserUse.browser.clearCookies` },
      {
      ...
      { defaultMessage: `Delete site data`, id: `settings.browserUse.browser.clearSiteData` },
      {
        defaultMessage: `Unable to clear browser site data`,
        id: `settings.browserUse.browser.clearSiteDataError`,
      },
      { defaultMessage: `Cookies`, id: `settings.browserUse.browser.cookies.label` },
      {
        defaultMessage: `Browser cookies cleared`,
        id: `settings.browserUse.browser.cookiesCleared`,
      },
      { defaultMessage: `Download history`, id: `settings.browserUse.browser.downloads.label` },
      {
      ...
      { defaultMessage: `Site data`, id: `settings.browserUse.browser.siteData.label` },
      {
      ...
      { defaultMessage: `Browser`, id: `settings.browserUse.browserSettings.breadcrumb.browser` },
      { defaultMessage: `Settings`, id: `settings.browserUse.browserSettings.breadcrumb.settings` },
      {
      ...
      { defaultMessage: `Manage`, id: `settings.browserUse.browserSettings.manage` },
      { defaultMessage: `Back`, id: `settings.browserUse.browserSettings.navigation.back` },
      { defaultMessage: `Forward`, id: `settings.browserUse.browserSettings.navigation.forward` },
      { defaultMessage: `Contact info`, id: `settings.browserUse.contactInfo.breadcrumb` },
      {
      ...
      { defaultMessage: `Contact info`, id: `settings.browserUse.contactInfo.label` },
      {
      ...
      { defaultMessage: `Blocked domain removed`, id: `settings.browserUse.deniedWebsites.saved` },
      { defaultMessage: `Developer mode`, id: `settings.browserUse.developerMode.title` },
      { defaultMessage: `Add`, id: `settings.browserUse.domains.add` },
      { defaultMessage: `Domain`, id: `settings.browserUse.domains.addDialogAriaLabel` },
      { defaultMessage: `Cancel`, id: `settings.browserUse.domains.addDialogCancel` },
      { defaultMessage: `Add`, id: `settings.browserUse.domains.addDialogConfirm` },
      { defaultMessage: `example.com`, id: `settings.browserUse.domains.addDialogPlaceholder` },
      { defaultMessage: `Unable to add domain`, id: `settings.browserUse.domains.addError` },
      { defaultMessage: `Downloads`, id: `settings.browserUse.downloads.breadcrumb` },
      {
        defaultMessage: `View and manage files downloaded from Codex's browser`,
        id: `settings.browserUse.downloads.history.description`,
      },
      { defaultMessage: `Download history`, id: `settings.browserUse.downloads.history.label` },
      { defaultMessage: `Manage`, id: `settings.browserUse.downloads.history.manage` },
      { defaultMessage: `Change`, id: `settings.browserUse.downloads.location.change` },
      {
        defaultMessage: `Unable to change the downloads folder`,
        id: `settings.browserUse.downloads.location.changeError`,
      },
      { defaultMessage: `Location`, id: `settings.browserUse.downloads.location.label` },
      { defaultMessage: `Reset`, id: `settings.browserUse.downloads.location.reset` },
      {
      ...
      { defaultMessage: `Downloads`, id: `settings.browserUse.downloads.title` },
      { defaultMessage: `Downloads`, id: `settings.browserUse.downloads.webviewLabel` },
      { defaultMessage: `Extensions`, id: `settings.browserUse.extensions.breadcrumb` },
      {
        defaultMessage: `Install, remove, and configure browser extensions`,
        id: `settings.browserUse.extensions.description`,
      },
      { defaultMessage: `Extension manager`, id: `settings.browserUse.extensions.label` },
      { defaultMessage: `Extensions`, id: `settings.browserUse.extensions.title` },
      { defaultMessage: `Extensions settings`, id: `settings.browserUse.extensions.webviewLabel` },
      { defaultMessage: `Toggle full CDP access`, id: `settings.browserUse.fullCdp.ariaLabel` },
      {
      ...
      { defaultMessage: `Elevated risk`, id: `settings.browserUse.fullCdp.elevatedRisk.label` },
      { defaultMessage: `Enable full CDP access`, id: `settings.browserUse.fullCdp.label` },
      ...
      {
        defaultMessage: `Where localhost and loopback URLs open by default`,
      ...
      { defaultMessage: `Codex`, id: `settings.browserUse.localUrlOpenTarget.inAppBrowser.label` },
      {
        defaultMessage: `Default local URL open destination`,
        id: `settings.browserUse.localUrlOpenTarget.label`,
      },
      { defaultMessage: `Loading websites`, id: `settings.browserUse.origins.loading` },
      { defaultMessage: `Remove {origin}`, id: `settings.browserUse.origins.removeAriaLabel` },
      { defaultMessage: `Cancel`, id: `settings.browserUse.origins.removeDialogCancel` },
      { defaultMessage: `Remove`, id: `settings.browserUse.origins.removeDialogConfirm` },
      { defaultMessage: `Unable to save domains`, id: `settings.browserUse.origins.saveError` },
      { defaultMessage: `Password manager`, id: `settings.browserUse.passwordManager.breadcrumb` },
      {
        defaultMessage: `Add, delete, and edit saved passwords`,
        id: `settings.browserUse.passwordManager.description`,
      },
      { defaultMessage: `Password manager`, id: `settings.browserUse.passwordManager.label` },
      {
        defaultMessage: `Password manager settings`,
        id: `settings.browserUse.passwordManager.webviewLabel`,
      },
      { defaultMessage: `Permissions`, id: `settings.browserUse.permissions.title` },
      { defaultMessage: `Cookies`, id: `settings.browserUse.profileImport.cookies` },
      { defaultMessage: `Passwords`, id: `settings.browserUse.profileImport.passwords` },
      { defaultMessage: `Import from your browser`, id: `settings.browserUse.profileImport.title` },
      {
      ...
      { defaultMessage: `Site`, id: `settings.browserUse.sitePermissions.addDialog.siteAriaLabel` },
      { defaultMessage: `Site`, id: `settings.browserUse.sitePermissions.addDialog.siteLabel` },
      {
      ...
      { defaultMessage: `Debug (CDP)`, id: `settings.browserUse.sitePermissions.cdpAccess` },
      {
        defaultMessage: `Remove custom permissions for {origin}`,
        id: `settings.browserUse.sitePermissions.clearAriaLabel`,
      },
      { defaultMessage: `Cancel`, id: `settings.browserUse.sitePermissions.customDialog.cancel` },
      { defaultMessage: `Done`, id: `settings.browserUse.sitePermissions.customDialog.done` },
      {
      ...
      { defaultMessage: `Download`, id: `settings.browserUse.sitePermissions.downloads` },
      {
      ...
      { defaultMessage: `Loading websites`, id: `settings.browserUse.sitePermissions.loading` },
      {
      ...
      { defaultMessage: `Custom`, id: `settings.browserUse.sitePermissions.preset.custom` },
      {
      ...
      { defaultMessage: `Block browsing`, id: `settings.browserUse.sitePermissions.preset.denied` },
      {
        defaultMessage: `Block browsing for {origin}`,
        id: `settings.browserUse.sitePermissions.preset.deniedAriaLabel`,
      },
      { defaultMessage: `Cancel`, id: `settings.browserUse.sitePermissions.removeDialog.cancel` },
      { defaultMessage: `Remove`, id: `settings.browserUse.sitePermissions.removeDialog.confirm` },
      {
      ...
      { defaultMessage: `CDP`, id: `settings.browserUse.sitePermissions.summary.cdp` },
      { defaultMessage: ` status: `, id: `settings.browserUse.sitePermissions.summary.value` },
      { defaultMessage: `Site permissions`, id: `settings.browserUse.sitePermissions.title` },
      { defaultMessage: `Upload`, id: `settings.browserUse.sitePermissions.uploads` },
      { defaultMessage: `Allow`, id: `settings.browserUse.sitePermissions.value.allowed` },
      { defaultMessage: `Default`, id: `settings.browserUse.sitePermissions.value.default` },
      { defaultMessage: `Block`, id: `settings.browserUse.sitePermissions.value.denied` },
      { defaultMessage: `Browse`, id: `settings.browserUse.sitePermissions.websiteAccess` },
      { defaultMessage: `Site settings`, id: `settings.browserUse.siteSettings.breadcrumb` },
      {
      ...
      { defaultMessage: `Site settings`, id: `settings.browserUse.siteSettings.label` },
      { defaultMessage: `Site settings`, id: `settings.browserUse.siteSettings.webviewLabel` },
      {
    ...
    "cloud-environments": [
      ...
      { defaultMessage: `Create environment`, id: `settings.cloudEnvironments.create.action` },
      {
      ...
      { defaultMessage: `Create cloud environment`, id: `settings.cloudEnvironments.create.title` },
      {
      ...
      { defaultMessage: `Environment actions`, id: `settings.cloudEnvironments.details.actions` },
      { defaultMessage: `Configuration`, id: `settings.cloudEnvironments.details.configuration` },
      { defaultMessage: `Configured`, id: `settings.cloudEnvironments.details.configured` },
      { defaultMessage: `Created`, id: `settings.cloudEnvironments.details.created` },
      { defaultMessage: `Created by`, id: `settings.cloudEnvironments.details.creator` },
      { defaultMessage: `Delete environment`, id: `settings.cloudEnvironments.details.delete` },
      { defaultMessage: `Edit environment`, id: `settings.cloudEnvironments.details.edit` },
      { defaultMessage: `Edit`, id: `settings.cloudEnvironments.details.editAction` },
      {
      ...
      { defaultMessage: `Loading environment…`, id: `settings.cloudEnvironments.details.loading` },
      { defaultMessage: `Machine`, id: `settings.cloudEnvironments.details.machine` },
      {
        defaultMessage: `Maintenance script`,
        id: `settings.cloudEnvironments.details.maintenance`,
      },
      { defaultMessage: `Network access`, id: `settings.cloudEnvironments.details.network` },
      { defaultMessage: `Pin environment`, id: `settings.cloudEnvironments.details.pin` },
      { defaultMessage: `Repository`, id: `settings.cloudEnvironments.details.repository` },
      { defaultMessage: `Reset cache`, id: `settings.cloudEnvironments.details.resetCache` },
      { defaultMessage: `Secrets`, id: `settings.cloudEnvironments.details.secrets` },
      { defaultMessage: `Setup script`, id: `settings.cloudEnvironments.details.setup` },
      { defaultMessage: `Sharing`, id: `settings.cloudEnvironments.details.sharing` },
      { defaultMessage: `Cloud environment`, id: `settings.cloudEnvironments.details.title` },
      { defaultMessage: `Unpin environment`, id: `settings.cloudEnvironments.details.unpin` },
      { defaultMessage: `Loading environment…`, id: `settings.cloudEnvironments.edit.loading` },
      { defaultMessage: `Edit cloud environment`, id: `settings.cloudEnvironments.edit.title` },
      { defaultMessage: `Add secret`, id: `settings.cloudEnvironments.editor.addSecret` },
      { defaultMessage: `Add variable`, id: `settings.cloudEnvironments.editor.addVariable` },
      { defaultMessage: `Cancel`, id: `settings.cloudEnvironments.editor.cancel` },
      { defaultMessage: `Create environment`, id: `settings.cloudEnvironments.editor.create` },
      { defaultMessage: `Description`, id: `settings.cloudEnvironments.editor.description` },
      {
      ...
      { defaultMessage: `Machine`, id: `settings.cloudEnvironments.editor.machine` },
      {
      ...
      { defaultMessage: `Retry`, id: `settings.cloudEnvironments.editor.machine.retry` },
      {
        defaultMessage: `Select a machine`,
        id: `settings.cloudEnvironments.editor.machine.select`,
      },
      { defaultMessage: `Maintenance script`, id: `settings.cloudEnvironments.editor.maintenance` },
      {
        defaultMessage: `Maintenance script`,
      ...
      { defaultMessage: `Environment name`, id: `settings.cloudEnvironments.editor.name.aria` },
      { defaultMessage: `Name is required`, id: `settings.cloudEnvironments.editor.name.required` },
      { defaultMessage: `Network access`, id: `settings.cloudEnvironments.editor.network` },
      {
      ...
      { defaultMessage: `Network access`, id: `settings.cloudEnvironments.editor.network.aria` },
      {
      ...
      { defaultMessage: `Access`, id: `settings.cloudEnvironments.editor.network.mode` },
      {
      ...
      { defaultMessage: `Remove`, id: `settings.cloudEnvironments.editor.removeSecret` },
      { defaultMessage: `Remove`, id: `settings.cloudEnvironments.editor.removeVariable` },
      { defaultMessage: `Repository`, id: `settings.cloudEnvironments.editor.repository` },
      { defaultMessage: `Repository`, id: `settings.cloudEnvironments.editor.repository.aria` },
      {
        defaultMessage: `Repository is required`,
        id: `settings.cloudEnvironments.editor.repository.required`,
      },
      { defaultMessage: `Runtime`, id: `settings.cloudEnvironments.editor.runtime` },
      {
      ...
      { defaultMessage: `Post-setup cache`, id: `settings.cloudEnvironments.editor.runtime.cache` },
      {
      ...
      { defaultMessage: `Save changes`, id: `settings.cloudEnvironments.editor.save` },
      { defaultMessage: `Scripts`, id: `settings.cloudEnvironments.editor.scripts` },
      { defaultMessage: `Secret domain`, id: `settings.cloudEnvironments.editor.secret.domain` },
      {
      ...
      { defaultMessage: `Secret name`, id: `settings.cloudEnvironments.editor.secret.name` },
      { defaultMessage: `Secret value`, id: `settings.cloudEnvironments.editor.secret.value` },
      { defaultMessage: `Secrets`, id: `settings.cloudEnvironments.editor.secrets` },
      {
      ...
      { defaultMessage: `Setup script`, id: `settings.cloudEnvironments.editor.setup` },
      { defaultMessage: `Setup script`, id: `settings.cloudEnvironments.editor.setup.aria` },
      {
      ...
      { defaultMessage: `Sharing`, id: `settings.cloudEnvironments.editor.sharing` },
      { defaultMessage: `Add editor`, id: `settings.cloudEnvironments.editor.sharing.addEditor` },
      {
      ...
      { defaultMessage: `Remove`, id: `settings.cloudEnvironments.editor.sharing.removeEditor` },
      { defaultMessage: `Visibility`, id: `settings.cloudEnvironments.editor.sharing.visibility` },
      {
        defaultMessage: `Environment visibility`,
        id: `settings.cloudEnvironments.editor.sharing.visibility.aria`,
      },
      { defaultMessage: `Variable name`, id: `settings.cloudEnvironments.editor.variable.name` },
      { defaultMessage: `Variable value`, id: `settings.cloudEnvironments.editor.variable.value` },
      {
      ...
      { defaultMessage: `Environment actions`, id: `settings.cloudEnvironments.list.actions` },
      { defaultMessage: `Edit environment`, id: `settings.cloudEnvironments.list.edit` },
      { defaultMessage: `No cloud environments yet`, id: `settings.cloudEnvironments.list.empty` },
      {
      ...
      { defaultMessage: `Open {environmentName}`, id: `settings.cloudEnvironments.list.open` },
      { defaultMessage: `Pin environment`, id: `settings.cloudEnvironments.list.pin` },
      {
      ...
      { defaultMessage: `Unpin environment`, id: `settings.cloudEnvironments.list.unpin` },
      { defaultMessage: `Custom`, id: `settings.cloudEnvironments.network.custom` },
      ...
      { defaultMessage: `Retry`, id: `settings.cloudEnvironments.pagination.retryButton` },
      {
      ...
      { defaultMessage: `Private`, id: `settings.cloudEnvironments.sharing.private` },
      { defaultMessage: `Public`, id: `settings.cloudEnvironments.sharing.public` },
      { defaultMessage: `Workspace`, id: `settings.cloudEnvironments.sharing.workspace` },
      {
    ...
    "cloud-settings": [
      ...
      { defaultMessage: `Save`, id: `settings.general.cloudPreferences.branchFormat.save` },
      {
      ...
      { defaultMessage: `Diff view`, id: `settings.general.cloudPreferences.diffView.ariaLabel` },
      {
        defaultMessage: `Choose how changes are shown in cloud tasks`,
        id: `settings.general.cloudPreferences.diffView.description`,
      },
      { defaultMessage: `Diff view`, id: `settings.general.cloudPreferences.diffView.label` },
      {
        defaultMessage: `Saved diff view`,
        id: `settings.general.cloudPreferences.diffView.save.success`,
      },
      { defaultMessage: `Split`, id: `settings.general.cloudPreferences.diffView.split` },
      { defaultMessage: `Unified`, id: `settings.general.cloudPreferences.diffView.unified` },
      {
      ...
      { defaultMessage: `Retry`, id: `settings.general.cloudPreferences.retry` },
      {
    ...
    "code-review": [
      { defaultMessage: `Unable to load code review settings`, id: `settings.codeReview.error` },
      { defaultMessage: `Loading code review settings…`, id: `settings.codeReview.loading` },
      {
      ...
      { defaultMessage: `Automatic review`, id: `settings.codeReview.personal.autoReview.label` },
      {
      ...
      { defaultMessage: `Personal preferences`, id: `settings.codeReview.personal.title` },
      {
        defaultMessage: `Choose when Codex should review your pull requests`,
        id: `settings.codeReview.personal.trigger.description`,
      },
      { defaultMessage: `On every push`, id: `settings.codeReview.personal.trigger.everyPush` },
      { defaultMessage: `Review trigger`, id: `settings.codeReview.personal.trigger.label` },
      { defaultMessage: `On PR open`, id: `settings.codeReview.personal.trigger.prOpen` },
      { defaultMessage: `Smart trigger`, id: `settings.codeReview.personal.trigger.smart` },
    ...
    "computer-use": [
      ...
      { defaultMessage: `Downloads`, id: `settings.browserUse.downloadApproval.label` },
      {
      ...
      { defaultMessage: `History`, id: `settings.browserUse.historyApproval.label` },
      {
      ...
      { defaultMessage: `Uploads`, id: `settings.browserUse.uploadApproval.label` },
      {
      ...
      { defaultMessage: `None yet`, id: `settings.computerUse.allowedApps.emptyTitle` },
      {
        defaultMessage: `Unable to load allowed apps.`,
        id: `settings.computerUse.allowedApps.loadError`,
      },
      { defaultMessage: `Loading allowed apps`, id: `settings.computerUse.allowedApps.loading` },
      {
        defaultMessage: `Remove {displayName}`,
        id: `settings.computerUse.allowedApps.removeAriaLabel`,
      },
      { defaultMessage: `Cancel`, id: `settings.computerUse.allowedApps.removeDialogCancel` },
      { defaultMessage: `Remove`, id: `settings.computerUse.allowedApps.removeDialogConfirm` },
      {
      ...
      { defaultMessage: `Allowed app removed`, id: `settings.computerUse.allowedApps.saved` },
      {
        defaultMessage: `Unable to save allowed apps`,
        id: `settings.computerUse.allowedApps.saveError`,
      },
      { defaultMessage: `Always-allowed apps`, id: `settings.computerUse.allowedApps.title` },
      {
      ...
      { defaultMessage: `Enable Locked use`, id: `settings.computerUse.backgroundAuth.ariaLabel` },
      {
        defaultMessage: `Let Codex use your Mac when it's locked. <a>Learn more</a>`,
        id: `settings.computerUse.backgroundAuth.description`,
      },
      { defaultMessage: `Locked use disabled`, id: `settings.computerUse.backgroundAuth.disabled` },
      { defaultMessage: `Locked use enabled`, id: `settings.computerUse.backgroundAuth.enabled` },
      { defaultMessage: `Locked use`, id: `settings.computerUse.backgroundAuth.label` },
      {
        defaultMessage: `Unable to update Locked use`,
        id: `settings.computerUse.backgroundAuth.saveError`,
      },
      { defaultMessage: `Computer use`, id: `settings.computerUse.breadcrumb.computerUse` },
      ...
      { defaultMessage: `Connected`, id: `settings.computerUse.chrome.connected` },
      { defaultMessage: `Manage`, id: `settings.computerUse.chrome.manage` },
      { defaultMessage: `Not connected`, id: `settings.computerUse.chrome.notConnected` },
      {
        defaultMessage: `Unable to open Chrome extension settings`,
        id: `settings.computerUse.chrome.openExtensionSettingsError`,
      },
      { defaultMessage: `Permissions`, id: `settings.computerUse.chrome.permissions.title` },
      { defaultMessage: `Google Chrome`, id: `settings.computerUse.chrome.pluginTitle` },
      {
        defaultMessage: `Reinstall extension`,
        id: `settings.computerUse.chrome.reinstallExtension`,
      },
      { defaultMessage: `Remove extension`, id: `settings.computerUse.chrome.removeExtension` },
      { defaultMessage: `Google Chrome`, id: `settings.computerUse.chrome.title` },
      ...
      { defaultMessage: `Don’t play sounds`, id: `settings.computerUse.sounds.off` },
      {
    ...
    connections: [
      ...
      { defaultMessage: `You are currently logged out.`, id: `appServer.error.loginRequired` },
      {
      ...
      { defaultMessage: `Hex color`, id: `codex.remoteHostColorPicker.hexColor` },
      {
      ...
      { defaultMessage: `Reset to default`, id: `codex.remoteHostColorPicker.resetToDefault` },
      {
        defaultMessage: `This changes the color for {host} everywhere it appears`,
        id: `codex.remoteHostColorPicker.subtitle`,
      },
      { defaultMessage: `Change connection color`, id: `codex.remoteHostColorPicker.title` },
      {
      ...
      { defaultMessage: `Allow`, id: `codexMobile.setupDialog.allowHost.primary` },
      {
        defaultMessage: `Allow devices to control this computer?`,
      ...
      { defaultMessage: `Done`, id: `codexMobile.setupDialog.connected.finish` },
      { defaultMessage: `You’re connected`, id: `codexMobile.setupDialog.connected.heading` },
      {
      ...
      { defaultMessage: `You’re connected`, id: `codexMobile.setupDialog.connected.title` },
      {
      ...
      { defaultMessage: `Get started`, id: `codexMobile.setupDialog.initial.primary` },
      ...
      { defaultMessage: `Device type`, id: `codexMobile.setupDialog.waiting.deviceType` },
      { defaultMessage: `Computer`, id: `codexMobile.setupDialog.waiting.deviceType.computer` },
      { defaultMessage: `Phone`, id: `codexMobile.setupDialog.waiting.deviceType.phone` },
      {
      ...
      { defaultMessage: `Approve on your device`, id: `codexMobile.setupDialog.waiting.title` },
      {
      ...
      { defaultMessage: `Codex mobile`, id: `codexMobile.setupPage.ready.heading` },
      { defaultMessage: `Phone type`, id: `codexMobile.setupPage.ready.phoneDeepLink.deviceType` },
      { defaultMessage: `Remote`, id: `codexMobile.setupPage.ready.remoteHeading` },
      { defaultMessage: `Set up Remote`, id: `codexMobile.setupPage.remoteTitle` },
      { defaultMessage: `Set up Codex Mobile`, id: `codexMobile.setupPage.title` },
      {
        defaultMessage: `Add`,
      ...
      { defaultMessage: `Copy pairing code`, id: `codexMobile.setupPage.waiting.pairing.copy` },
      {
      ...
      { defaultMessage: `Continue`, id: `electron.onboarding.login.apikey.continue` },
      { defaultMessage: `OpenAI API key`, id: `electron.onboarding.login.apikey.label` },
      { defaultMessage: `Enter API key`, id: `electron.onboarding.login.apikey.open` },
      { defaultMessage: `sk-…`, id: `electron.onboarding.login.apikey.placeholder` },
      { defaultMessage: `Cancel sign-in`, id: `electron.onboarding.login.chatgpt.cancel` },
      { defaultMessage: `Continue with ChatGPT`, id: `electron.onboarding.login.chatgpt.continue` },
      {
      ...
      { defaultMessage: `Close`, id: `settings.remoteConnections.auth.closeIcon` },
      {
        defaultMessage: `Authenticate this remote Codex connection to continue.`,
        id: `settings.remoteConnections.auth.description`,
      },
      { defaultMessage: `Sign-in failed: {message}`, id: `settings.remoteConnections.auth.error` },
      { defaultMessage: `Login required`, id: `settings.remoteConnections.auth.title` },
      {
      ...
      { defaultMessage: `Delete`, id: `settings.remoteConnections.deleteConnection` },
      { defaultMessage: `Alias`, id: `settings.remoteConnections.details.alias` },
      {
      ...
      { defaultMessage: `Identity`, id: `settings.remoteConnections.details.identity` },
      ...
      { defaultMessage: `Version`, id: `settings.remoteConnections.details.version` },
      { defaultMessage: `Distro`, id: `settings.remoteConnections.details.wslDistro` },
      { defaultMessage: `Details`, id: `settings.remoteConnections.detailsMenu` },
      {
      ...
      { defaultMessage: `SSH`, id: `settings.remoteConnections.deviceConnections.sshSubtitle` },
      { defaultMessage: `WSL`, id: `settings.remoteConnections.deviceConnections.wslSubtitle` },
      { defaultMessage: `Add SSH connection`, id: `settings.remoteConnections.dialog.addTitle` },
      ...
      { defaultMessage: `Identity`, id: `settings.remoteConnections.dialog.authMode.identity` },
      { defaultMessage: `No Auth`, id: `settings.remoteConnections.dialog.authMode.none` },
      { defaultMessage: `Cancel`, id: `settings.remoteConnections.dialog.cancel` },
      { defaultMessage: `Close`, id: `settings.remoteConnections.dialog.close` },
      { defaultMessage: `Edit SSH connection`, id: `settings.remoteConnections.dialog.editTitle` },
      { defaultMessage: `Alias`, id: `settings.remoteConnections.dialog.field.alias` },
      { defaultMessage: `Display name`, id: `settings.remoteConnections.dialog.field.displayName` },
      {
      ...
      { defaultMessage: `(optional)`, id: `settings.remoteConnections.dialog.field.optional` },
      { defaultMessage: `Hostname`, id: `settings.remoteConnections.dialog.field.sshHost` },
      {
      ...
      { defaultMessage: `SSH port`, id: `settings.remoteConnections.dialog.field.sshPort` },
      {
      ...
      { defaultMessage: `Refresh`, id: `settings.remoteConnections.discoveryDialog.refresh` },
      { defaultMessage: `Add`, id: `settings.remoteConnections.discoveryDialog.save` },
      {
      ...
      { defaultMessage: `Edit connection`, id: `settings.remoteConnections.editConnection` },
      { defaultMessage: `SSH connection failed`, id: `settings.remoteConnections.genericSshError` },
      { defaultMessage: `Error details`, id: `settings.remoteConnections.genericSshError.details` },
      { defaultMessage: `WSL connection failed`, id: `settings.remoteConnections.genericWslError` },
      { defaultMessage: `Error details`, id: `settings.remoteConnections.genericWslError.details` },
      {
      ...
      { defaultMessage: `Add`, id: `settings.remoteConnections.remoteControlDiscoveryDialog.save` },
      {
      ...
      { defaultMessage: `Restart connection`, id: `settings.remoteConnections.restartConnection` },
      { defaultMessage: `Update details`, id: `settings.remoteConnections.restartNotice.details` },
      {
      ...
      { defaultMessage: `Saved remote connections`, id: `settings.remoteConnections.save.success` },
      { defaultMessage: `Settings`, id: `settings.remoteConnections.settingsMenu` },
      {
      ...
      { defaultMessage: `Loading SSH connections…`, id: `settings.remoteConnections.ssh.loading` },
      {
      ...
      { defaultMessage: `Connections view`, id: `settings.remoteConnections.tabs.ariaLabel` },
      { defaultMessage: `Control this Mac`, id: `settings.remoteConnections.tabs.controlThisMac` },
      {
      ...
      { defaultMessage: `busy`, id: `settings.remoteControlConnections.availability.busy` },
      {
        defaultMessage: `Connecting`,
      ...
      { defaultMessage: `offline`, id: `settings.remoteControlConnections.availability.offline` },
      { defaultMessage: `online`, id: `settings.remoteControlConnections.availability.online` },
      {
        defaultMessage: `Please update app-server version (current: {currentVersion}) to {requiredVersion} or newer`,
      ...
      { defaultMessage: `Cancel`, id: `settings.remoteControlConnections.deleteDialog.cancel` },
      { defaultMessage: `Delete`, id: `settings.remoteControlConnections.deleteDialog.confirm` },
      {
      ...
      { defaultMessage: `Host`, id: `settings.remoteControlConnections.details.host` },
      { defaultMessage: `Last seen`, id: `settings.remoteControlConnections.details.lastSeen` },
      { defaultMessage: `OS / arch`, id: `settings.remoteControlConnections.details.platform` },
      { defaultMessage: `Version`, id: `settings.remoteControlConnections.details.version` },
      { defaultMessage: `Rename`, id: `settings.remoteControlConnections.rename` },
      { defaultMessage: `Cancel`, id: `settings.remoteControlConnections.rename.cancel` },
      {
        defaultMessage: `Failed to rename remote control environment`,
        id: `settings.remoteControlConnections.rename.error`,
      },
      { defaultMessage: `Display name`, id: `settings.remoteControlConnections.rename.inputLabel` },
      { defaultMessage: `Save`, id: `settings.remoteControlConnections.rename.save` },
      {
      ...
      { defaultMessage: `Connected`, id: `threadPage.remoteConnectionStatusBadge.connected` },
      { defaultMessage: `Connecting`, id: `threadPage.remoteConnectionStatusBadge.connecting` },
      { defaultMessage: `Disconnected`, id: `threadPage.remoteConnectionStatusBadge.disconnected` },
      { defaultMessage: `Error`, id: `threadPage.remoteConnectionStatusBadge.error` },
      {
      ...
      { defaultMessage: `Log in to Codex`, id: `threadPage.remoteConnectionStatusBadge.login` },
      {
        defaultMessage: `Codex not installed`,
        id: `threadPage.remoteConnectionStatusBadge.remoteCodexNotFound`,
      },
      { defaultMessage: `Restarting`, id: `threadPage.remoteConnectionStatusBadge.restarting` },
      { defaultMessage: `Restart now`, id: `threadPage.remoteConnectionStatusBadge.restartNow` },
      {
      ...
      { defaultMessage: `Login required`, id: `threadPage.remoteConnectionStatusBadge.unauthed` },
      { defaultMessage: `Update Codex`, id: `threadPage.remoteConnectionStatusBadge.updateCodex` },
      {
        defaultMessage: `Update required`,
        id: `threadPage.remoteConnectionStatusBadge.updateRequired`,
      },
      { defaultMessage: `Updating…`, id: `threadPage.remoteConnectionStatusBadge.updatingCodex` },
    ],
    "data-controls": [
      { defaultMessage: `{date}, {time}`, id: `settings.dataControls.archivedChats.dateTime` },
      {
      ...
      { defaultMessage: `Delete`, id: `settings.dataControls.archivedChats.delete` },
      { defaultMessage: `Delete all`, id: `settings.dataControls.archivedChats.deleteAll` },
      {
      ...
      { defaultMessage: `Cancel`, id: `settings.dataControls.archivedChats.deleteConfirm.cancel` },
      {
        defaultMessage: `Delete archived chat?`,
      ...
      { defaultMessage: `No archived chats.`, id: `settings.dataControls.archivedChats.empty` },
      {
        defaultMessage: `Could not load archived chats.`,
        id: `settings.dataControls.archivedChats.error`,
      },
      { defaultMessage: `All chats`, id: `settings.dataControls.archivedChats.filter.all` },
      {
        defaultMessage: `Filter archived chats`,
        id: `settings.dataControls.archivedChats.filter.ariaLabel`,
      },
      { defaultMessage: `Cloud`, id: `settings.dataControls.archivedChats.filter.cloud` },
      { defaultMessage: `Local`, id: `settings.dataControls.archivedChats.filter.local` },
      { defaultMessage: `Sort by`, id: `settings.dataControls.archivedChats.filter.section.sort` },
      { defaultMessage: `Type`, id: `settings.dataControls.archivedChats.filter.section.type` },
      {
        defaultMessage: `Group archived chats`,
        id: `settings.dataControls.archivedChats.group.ariaLabel`,
      },
      { defaultMessage: `None`, id: `settings.dataControls.archivedChats.group.none` },
      { defaultMessage: `Project`, id: `settings.dataControls.archivedChats.group.project` },
      {
      ...
      { defaultMessage: `No project`, id: `settings.dataControls.archivedChats.noProject` },
      {
      ...
      { defaultMessage: `Chats`, id: `settings.dataControls.archivedChats.projectFilter.chats` },
      {
      ...
      { defaultMessage: `Created`, id: `settings.dataControls.archivedChats.sort.created` },
      { defaultMessage: `Updated`, id: `settings.dataControls.archivedChats.sort.updated` },
      { defaultMessage: `Unarchive`, id: `settings.dataControls.archivedChats.unarchive` },
      {
      ...
      { defaultMessage: `Untitled chat`, id: `settings.dataControls.archivedChats.untitled` },
      { defaultMessage: `View now`, id: `settings.dataControls.archivedChats.viewNow` },
    ],
    environments: [
      { defaultMessage: `Opens in your browser during Alpha`, id: `settings.section.external` },
    ],
    "general-settings": [
      { defaultMessage: `Open config.toml`, id: `codex.profileDropdown.openConfigToml` },
      {
      ...
      { defaultMessage: `Continue`, id: `electron.onboarding.welcomeV2.continue` },
      {
        defaultMessage: `Customize`,
      ...
      { defaultMessage: `Instructions`, id: `externalAgentConfig.itemType.agentsMd` },
      { defaultMessage: `Commands`, id: `externalAgentConfig.itemType.commands` },
      { defaultMessage: `Settings`, id: `externalAgentConfig.itemType.config` },
      { defaultMessage: `Hooks`, id: `externalAgentConfig.itemType.hooks` },
      { defaultMessage: `MCP servers`, id: `externalAgentConfig.itemType.mcpServerConfig` },
      { defaultMessage: `Plugins`, id: `externalAgentConfig.itemType.plugins` },
      { defaultMessage: `Sessions`, id: `externalAgentConfig.itemType.sessions` },
      { defaultMessage: `Skills`, id: `externalAgentConfig.itemType.skills` },
      { defaultMessage: `Agents`, id: `externalAgentConfig.itemType.subagents` },
      {
        defaultMessage: `Show alerts when notification permissions are required`,
        id: `notifications.permissions.description`,
      },
      { defaultMessage: `Enable permission notifications`, id: `notifications.permissions.label` },
      {
        defaultMessage: `Show alerts when input is needed to continue`,
        id: `notifications.questions.description`,
      },
      { defaultMessage: `Enable question notifications`, id: `notifications.questions.label` },
      ...
      { defaultMessage: `Turn completion notifications`, id: `notifications.turnMode.label` },
      { defaultMessage: `Never`, id: `notifications.turnMode.off` },
      { defaultMessage: `Only when unfocused`, id: `notifications.turnMode.unfocused` },
      { defaultMessage: `1.5x speed, increased usage`, id: `serviceTier.fast.description` },
      { defaultMessage: `Fast`, id: `serviceTier.fast.label` },
      { defaultMessage: `Default speed`, id: `serviceTier.standard.description` },
      ...
      { defaultMessage: `Suggested prompts`, id: `settings.agent.ambientSuggestions.groupTitle` },
      {
      ...
      { defaultMessage: `Import to Codex`, id: `settings.agent.importSettings.applySelected` },
      {
      ...
      { defaultMessage: `Checking for imports`, id: `settings.agent.importSettings.loadingLabel` },
      {
      ...
      { defaultMessage: `Import failed`, id: `settings.agent.importSettings.progress.errorTitle` },
      {
      ...
      { defaultMessage: `Agent setup imported`, id: `settings.agent.importSettings.toast.success` },
      {
      ...
      { defaultMessage: `Auto-review`, id: `settings.agent.permissionsMode.autoReview.title` },
      {
      ...
      { defaultMessage: `Default permissions`, id: `settings.agent.permissionsMode.default.title` },
      {
      ...
      { defaultMessage: `Full access`, id: `settings.agent.permissionsMode.fullAccess.title` },
      {
        defaultMessage: `Show Full access in the composer`,
        id: `settings.agent.permissionsMode.fullAccess.toggle`,
      },
      { defaultMessage: `Permissions`, id: `settings.agent.permissionsMode.groupTitle` },
      {
      ...
      { defaultMessage: `Agent environment`, id: `settings.agentEnvironment.label` },
      {
      ...
      { defaultMessage: `Windows native`, id: `settings.agentEnvironment.windowsNative` },
      {
        defaultMessage: `Run the agent directly in Windows`,
        id: `settings.agentEnvironment.windowsNative.description`,
      },
      { defaultMessage: `Windows Subsystem for Linux`, id: `settings.agentEnvironment.wsl` },
      {
      ...
      { defaultMessage: `Bottom panel`, id: `settings.general.bottomPanel.label` },
      { defaultMessage: `Composer`, id: `settings.general.composer.groupTitle` },
      {
      ...
      { defaultMessage: `Bottom`, id: `settings.general.defaultTerminalLocation.bottom` },
      {
      ...
      { defaultMessage: `Right`, id: `settings.general.defaultTerminalLocation.right` },
      { defaultMessage: `Dictation`, id: `settings.general.dictation` },
      { defaultMessage: `Add entry`, id: `settings.general.dictationDictionary.addEntry` },
      {
        defaultMessage: `Words or phrases dictation should recognize`,
        id: `settings.general.dictationDictionary.description`,
      },
      { defaultMessage: `Dictionary entry`, id: `settings.general.dictationDictionary.entryLabel` },
      { defaultMessage: `Dictation dictionary`, id: `settings.general.dictationDictionary.label` },
      { defaultMessage: `Remove entry`, id: `settings.general.dictationDictionary.removeEntry` },
      {
      ...
      { defaultMessage: `Off`, id: `settings.general.experimentalFeatures.hotkeyWindowHotkey.off` },
      { defaultMessage: `Set`, id: `settings.general.experimentalFeatures.hotkeyWindowHotkey.set` },
      {
      ...
      { defaultMessage: `Steer`, id: `settings.general.followUpQueueMode.interrupt` },
      { defaultMessage: `Follow-up behavior`, id: `settings.general.followUpQueueMode.label` },
      { defaultMessage: `Queue`, id: `settings.general.followUpQueueMode.queue` },
      { defaultMessage: `Copy dictation`, id: `settings.general.globalDictationHistory.copy` },
      {
      ...
      { defaultMessage: `Cancel`, id: `settings.general.globalDictationHotkey.cancel` },
      {
      ...
      { defaultMessage: `Change`, id: `settings.general.globalDictationHotkey.change` },
      { defaultMessage: `Clear`, id: `settings.general.globalDictationHotkey.clear` },
      {
      ...
      { defaultMessage: `Off`, id: `settings.general.globalDictationHotkey.off` },
      { defaultMessage: `Set`, id: `settings.general.globalDictationHotkey.set` },
      {
      ...
      { defaultMessage: `Change`, id: `settings.general.globalDictationToggleHotkey.change` },
      { defaultMessage: `Clear`, id: `settings.general.globalDictationToggleHotkey.clear` },
      {
      ...
      { defaultMessage: `Set`, id: `settings.general.globalDictationToggleHotkey.set` },
      { defaultMessage: `GPU Tearing Debug`, id: `settings.general.gpuTearingDebug` },
      {
      ...
      { defaultMessage: `Toggle {settingName}`, id: `settings.general.gpuTearingDebug.toggle` },
      { defaultMessage: `General`, id: `settings.general.groupTitle` },
      { defaultMessage: `Checking`, id: `settings.general.importExternalAgent.checking` },
      { defaultMessage: `Import`, id: `settings.general.importExternalAgent.import` },
      { defaultMessage: `Import again`, id: `settings.general.importExternalAgent.importAgain` },
      {
        defaultMessage: `Imported agent setup`,
        id: `settings.general.importExternalAgent.importedRowLabel`,
      },
      { defaultMessage: `Importing`, id: `settings.general.importExternalAgent.importing` },
      {
      ...
      { defaultMessage: `Show in menu bar`, id: `settings.general.macMenuBar.label` },
      { defaultMessage: `Used for dictation`, id: `settings.general.microphoneInput.description` },
      { defaultMessage: `No microphones found`, id: `settings.general.microphoneInput.empty` },
      {
        defaultMessage: `Microphone {index}`,
        id: `settings.general.microphoneInput.fallbackDeviceLabel`,
      },
      { defaultMessage: `Microphone`, id: `settings.general.microphoneInput.label` },
      {
        defaultMessage: `Unable to load microphones`,
        id: `settings.general.microphoneInput.loadError`,
      },
      { defaultMessage: `Loading microphones`, id: `settings.general.microphoneInput.loading` },
      { defaultMessage: `Selected microphone`, id: `settings.general.microphoneInput.selected` },
      { defaultMessage: `System default`, id: `settings.general.microphoneInput.systemDefault` },
      {
      ...
      {
        defaultMessage: `Where web links open by default`,
      ...
      {
        defaultMessage: `Default link open destination`,
      ...
      { defaultMessage: `Realtime voice`, id: `settings.general.realtimeVoice` },
      {
        defaultMessage: `Choose what appears in the avatar overlay while realtime voice is active`,
        id: `settings.general.realtimeVoiceAvatar.description`,
      },
      { defaultMessage: `Realtime voice avatar`, id: `settings.general.realtimeVoiceAvatar.label` },
      { defaultMessage: `Orb`, id: `settings.general.realtimeVoiceAvatar.orb` },
      { defaultMessage: `Pet`, id: `settings.general.realtimeVoiceAvatar.pet` },
      { defaultMessage: `Cancel`, id: `settings.general.realtimeVoiceHotkey.cancel` },
      {
        defaultMessage: `Realtime voice hotkey capture`,
        id: `settings.general.realtimeVoiceHotkey.captureAriaLabel`,
      },
      {
        defaultMessage: `Press shortcut`,
        id: `settings.general.realtimeVoiceHotkey.capturePrompt`,
      },
      { defaultMessage: `Change`, id: `settings.general.realtimeVoiceHotkey.change` },
      { defaultMessage: `Clear`, id: `settings.general.realtimeVoiceHotkey.clear` },
      {
        defaultMessage: `Start realtime voice from anywhere on desktop`,
        id: `settings.general.realtimeVoiceHotkey.description`,
      },
      {
        defaultMessage: `Failed to update realtime voice hotkey`,
        id: `settings.general.realtimeVoiceHotkey.errorGeneric`,
      },
      { defaultMessage: `Realtime voice hotkey`, id: `settings.general.realtimeVoiceHotkey.label` },
      { defaultMessage: `Off`, id: `settings.general.realtimeVoiceHotkey.off` },
      { defaultMessage: `Set`, id: `settings.general.realtimeVoiceHotkey.set` },
      {
        defaultMessage: `Use singleton voice thread`,
        id: `settings.general.realtimeVoiceSingletonOrchestratorThread.ariaLabel`,
      },
      {
        defaultMessage: `Attach new voice sessions to one durable orchestrator thread instead of new threads`,
        id: `settings.general.realtimeVoiceSingletonOrchestratorThread.description`,
      },
      {
        defaultMessage: `Singleton voice thread`,
        id: `settings.general.realtimeVoiceSingletonOrchestratorThread.label`,
      },
      {
        defaultMessage: `Enable realtime voice wake word`,
        id: `settings.general.realtimeVoiceWakeWord.ariaLabel`,
      },
      {
        defaultMessage: `Start realtime voice by saying Hey Chat`,
        id: `settings.general.realtimeVoiceWakeWord.description`,
      },
      { defaultMessage: `Wake word`, id: `settings.general.realtimeVoiceWakeWord.label` },
      {
      ...
      { defaultMessage: `Detached`, id: `settings.general.reviewDelivery.detached` },
      { defaultMessage: `Inline`, id: `settings.general.reviewDelivery.inline` },
      { defaultMessage: `Code review`, id: `settings.general.reviewDelivery.label` },
      {
      ...
      { defaultMessage: `No targets found`, id: `settings.ide.defaultOpenTarget.placeholder` },
      { defaultMessage: `Auto detect`, id: `settings.ide.language.auto` },
      { defaultMessage: `Auto detect`, id: `settings.ide.language.autoOption` },
      { defaultMessage: `Language for the app UI`, id: `settings.ide.language.description` },
      { defaultMessage: `Language`, id: `settings.ide.language.label` },
      { defaultMessage: `Search languages`, id: `settings.ide.language.search` },
      {
      ...
      { defaultMessage: `Open source licenses`, id: `settings.openSourceLicenses.rowLabel` },
      ...
      { defaultMessage: `For everyday work`, id: `settings.workMode.everyday.title` },
      {
    ...
    "git-settings": [
      { defaultMessage: `Branch prefix`, id: `settings.git.branchPrefix.ariaLabel` },
      {
        defaultMessage: `Prefix used when creating new branches in Codex`,
        id: `settings.git.branchPrefix.description`,
      },
      { defaultMessage: `Branch prefix`, id: `settings.git.branchPrefix.label` },
      ...
      { defaultMessage: `Saved branch prefix`, id: `settings.git.branchPrefix.save.success` },
      { defaultMessage: `Commit instructions`, id: `settings.git.commitInstructions.ariaLabel` },
      {
        defaultMessage: `Added to commit message generation prompts`,
        id: `settings.git.commitInstructions.description`,
      },
      { defaultMessage: `Commit instructions`, id: `settings.git.commitInstructions.label` },
      {
      ...
      { defaultMessage: `Always force push`, id: `settings.git.forcePush.ariaLabel` },
      {
        defaultMessage: `Use --force-with-lease when pushing from Codex`,
        id: `settings.git.forcePush.description`,
      },
      { defaultMessage: `Always force push`, id: `settings.git.forcePush.label` },
      { defaultMessage: `Always force push disabled`, id: `settings.git.forcePush.save.disabled` },
      { defaultMessage: `Always force push enabled`, id: `settings.git.forcePush.save.enabled` },
      {
        defaultMessage: `Failed to save force push setting`,
        id: `settings.git.forcePush.save.error`,
      },
      { defaultMessage: `Pull request instructions`, id: `settings.git.prInstructions.ariaLabel` },
      {
        defaultMessage: `Added to PR title/description generation prompts`,
        id: `settings.git.prInstructions.description`,
      },
      { defaultMessage: `Pull request instructions`, id: `settings.git.prInstructions.label` },
      {
      ...
      { defaultMessage: `Merge`, id: `settings.git.pullRequestMergeMethod.merge` },
      {
      ...
      { defaultMessage: `Squash`, id: `settings.git.pullRequestMergeMethod.squash` },
      {
      ...
      { defaultMessage: `Show PR icons in sidebar`, id: `settings.git.showSidebarPrIcons.label` },
      {
      ...
      { defaultMessage: `Auto-delete limit`, id: `settings.worktrees.keepCount.ariaLabel` },
      {
      ...
      { defaultMessage: `Auto-delete limit`, id: `settings.worktrees.keepCount.label` },
      {
    ...
    "hooks-settings": [
      ...
      { defaultMessage: `No hooks found`, id: `settings.hooks.emptyHooks.label` },
      ...
      { defaultMessage: `Hook {index}`, id: `settings.hooks.event.fallbackHookTitle` },
      { defaultMessage: `Handler`, id: `settings.hooks.event.handler` },
      { defaultMessage: `Managed hooks are always on`, id: `settings.hooks.event.managedTooltip` },
      { defaultMessage: `Matcher`, id: `settings.hooks.event.matcher` },
      { defaultMessage: `Open config file`, id: `settings.hooks.event.openConfigFile` },
      { defaultMessage: `PermissionRequest`, id: `settings.hooks.event.permissionRequest` },
      {
      ...
      { defaultMessage: `SessionStart`, id: `settings.hooks.event.sessionStart` },
      {
        defaultMessage: `When a new session starts`,
        id: `settings.hooks.event.sessionStart.description`,
      },
      { defaultMessage: `Status message`, id: `settings.hooks.event.statusMessage` },
      ...
      { defaultMessage: `SubagentStart`, id: `settings.hooks.event.subagentStart` },
      {
        defaultMessage: `When a subagent starts`,
        id: `settings.hooks.event.subagentStart.description`,
      },
      { defaultMessage: `SubagentStop`, id: `settings.hooks.event.subagentStop` },
      {
      ...
      { defaultMessage: `New hook`, id: `settings.hooks.event.untrustedReviewReason` },
      { defaultMessage: `UserPromptSubmit`, id: `settings.hooks.event.userPromptSubmit` },
      {
        defaultMessage: `When the user submits a prompt`,
        id: `settings.hooks.event.userPromptSubmit.description`,
      },
      { defaultMessage: `{path}: {message}`, id: `settings.hooks.issues.error` },
      {
      ...
      { defaultMessage: `Could not load hooks`, id: `settings.hooks.loadError.label` },
      { defaultMessage: `Loading hooks…`, id: `settings.hooks.loading.label` },
      { defaultMessage: `Reload hooks`, id: `settings.hooks.refresh` },
      { defaultMessage: `Refreshed hooks`, id: `settings.hooks.refresh.success` },
      {
      ...
      { defaultMessage: `Admin config`, id: `settings.hooks.source.adminConfig` },
      { defaultMessage: `From Config`, id: `settings.hooks.source.globalConfig` },
      {
        defaultMessage: `{count, plural, one {# hook} other {# hooks}}`,
        id: `settings.hooks.source.hookCount`,
      },
      { defaultMessage: `Other sources`, id: `settings.hooks.source.otherSources` },
      { defaultMessage: `Plugin`, id: `settings.hooks.source.plugin` },
      { defaultMessage: `From Plugins`, id: `settings.hooks.source.plugins` },
      { defaultMessage: `Project config`, id: `settings.hooks.source.projectConfig` },
      { defaultMessage: `From Projects`, id: `settings.hooks.source.projects` },
      { defaultMessage: `Session flags`, id: `settings.hooks.source.sessionFlags` },
      { defaultMessage: `All projects`, id: `settings.hooks.source.sharedProjects` },
      { defaultMessage: `Unknown source`, id: `settings.hooks.source.unknown` },
      { defaultMessage: `Unknown plugin`, id: `settings.hooks.source.unknownPlugin` },
    ...
    "keyboard-shortcuts": [
      { defaultMessage: `Approve request`, id: `codex.command.approval.approve` },
      { defaultMessage: `Decline request`, id: `codex.command.approval.decline` },
      ...
      { defaultMessage: `Open model picker`, id: `codex.command.composer.openModelPicker` },
      { defaultMessage: `Start dictation`, id: `codex.command.composer.startDictation` },
      { defaultMessage: `Toggle voice mode`, id: `codex.command.composer.startVoiceMode` },
      { defaultMessage: `Send message`, id: `codex.command.composer.submit` },
      { defaultMessage: `Toggle Fast mode`, id: `codex.command.composer.toggleFastMode` },
      { defaultMessage: `Toggle plan mode`, id: `codex.command.composer.togglePlanMode` },
      { defaultMessage: `Copy as Markdown`, id: `codex.command.copyConversationMarkdown` },
      { defaultMessage: `Environment action 1`, id: `codex.command.environmentAction1` },
      { defaultMessage: `Environment action 2`, id: `codex.command.environmentAction2` },
      { defaultMessage: `Environment action 3`, id: `codex.command.environmentAction3` },
      { defaultMessage: `Environment action 4`, id: `codex.command.environmentAction4` },
      { defaultMessage: `Environment action 5`, id: `codex.command.environmentAction5` },
      { defaultMessage: `Environment action 6`, id: `codex.command.environmentAction6` },
      { defaultMessage: `Environment action 7`, id: `codex.command.environmentAction7` },
      { defaultMessage: `Environment action 8`, id: `codex.command.environmentAction8` },
      { defaultMessage: `Environment action 9`, id: `codex.command.environmentAction9` },
      { defaultMessage: `Feedback`, id: `codex.command.feedback` },
      { defaultMessage: `Find`, id: `codex.command.findInThread` },
      { defaultMessage: `Focus browser address bar`, id: `codex.command.focusBrowserAddressBar` },
      { defaultMessage: `Force reload skills`, id: `codex.command.forceReloadSkills` },
      { defaultMessage: `Fork chat`, id: `codex.command.forkThread` },
      { defaultMessage: `Commit or push`, id: `codex.command.git.commit` },
      { defaultMessage: `Create PR`, id: `codex.command.git.createPullRequest` },
      { defaultMessage: `Hold-to-dictate hotkey`, id: `codex.command.globalDictationHold` },
      { defaultMessage: `Toggle dictation hotkey`, id: `codex.command.globalDictationToggle` },
      { defaultMessage: `Popout Window hotkey`, id: `codex.command.hotkeyWindow` },
      { defaultMessage: `Install Codex Workspace`, id: `codex.command.installPrimaryRuntime` },
      { defaultMessage: `Keyboard shortcuts`, id: `codex.command.keyboardShortcuts` },
      { defaultMessage: `Log out`, id: `codex.command.logOut` },
      { defaultMessage: `Manage automations`, id: `codex.command.manageTasks` },
      { defaultMessage: `MCP`, id: `codex.command.mcpSettings` },
      { defaultMessage: `Back`, id: `codex.command.navigateBack` },
      { defaultMessage: `Browser back`, id: `codex.command.navigateBrowserBack` },
      { defaultMessage: `Browser forward`, id: `codex.command.navigateBrowserForward` },
      { defaultMessage: `Forward`, id: `codex.command.navigateForward` },
      { defaultMessage: `New chat`, id: `codex.command.newThread` },
      { defaultMessage: `Next recently viewed chat`, id: `codex.command.nextRecentThread` },
      { defaultMessage: `Next tab`, id: `codex.command.nextTab` },
      { defaultMessage: `Next chat`, id: `codex.command.nextThread` },
      { defaultMessage: `Open browser tab`, id: `codex.command.openBrowserTab` },
      { defaultMessage: `Open control window`, id: `codex.command.openControlWindow` },
      { defaultMessage: `Open folder`, id: `codex.command.openFolder` },
      { defaultMessage: `Wake Pet`, id: `codex.command.openPetOverlay` },
      { defaultMessage: `Process Manager`, id: `codex.command.openProcessManager` },
      ...
      { defaultMessage: `Open in new window`, id: `codex.command.openThreadInNewWindow` },
      { defaultMessage: `Personality`, id: `codex.command.personalitySettings` },
      { defaultMessage: `Previous recently viewed chat`, id: `codex.command.previousRecentThread` },
      ...
      { defaultMessage: `Start realtime voice hotkey`, id: `codex.command.realtimeVoice` },
      { defaultMessage: `Settings`, id: `codex.command.settings` },
      { defaultMessage: `Show keyboard shortcuts`, id: `codex.command.showKeyboardShortcuts` },
      ...
      { defaultMessage: `Toggle bottom panel`, id: `codex.command.toggleBottomPanel` },
      { defaultMessage: `Toggle browser panel`, id: `codex.command.toggleBrowserPanel` },
      { defaultMessage: `Toggle maximize side panel`, id: `codex.command.toggleMaximizeSidePanel` },
      { defaultMessage: `Toggle sidebar`, id: `codex.command.toggleSidebar` },
      { defaultMessage: `Toggle side panel`, id: `codex.command.toggleSidePanel` },
      ...
      { defaultMessage: `Archive the current chat`, id: `codex.commandDescription.archiveThread` },
      { defaultMessage: `Close the active tab`, id: `codex.commandDescription.closeTab` },
      { defaultMessage: `Close the active window`, id: `codex.commandDescription.closeWindow` },
      {
      ...
      { defaultMessage: `Search the current chat`, id: `codex.commandDescription.findInThread` },
      {
      ...
      { defaultMessage: `Fork the current chat`, id: `codex.commandDescription.forkThread` },
      { defaultMessage: `Open commit or push options`, id: `codex.commandDescription.git.commit` },
      {
      ...
      { defaultMessage: `Sign out of {appName}`, id: `codex.commandDescription.logOut` },
      {
        defaultMessage: `Create or manage automations from the current page`,
        id: `codex.commandDescription.manageTasks`,
      },
      { defaultMessage: `Configure MCP servers`, id: `codex.commandDescription.mcpSettings` },
      {
      ...
      { defaultMessage: `Start a new chat`, id: `codex.commandDescription.newThread` },
      { defaultMessage: `Open a new window`, id: `codex.commandDescription.newWindow` },
      {
        defaultMessage: `Cycle to the next recently viewed chat`,
        id: `codex.commandDescription.nextRecentThread`,
      },
      { defaultMessage: `Switch to the next tab`, id: `codex.commandDescription.nextTab` },
      { defaultMessage: `Switch to the next chat`, id: `codex.commandDescription.nextThread` },
      { defaultMessage: `Open a new browser tab`, id: `codex.commandDescription.openBrowserTab` },
      { defaultMessage: `Open the command menu`, id: `codex.commandDescription.openCommandMenu` },
      {
      ...
      { defaultMessage: `Open the pet overlay`, id: `codex.commandDescription.openPetOverlay` },
      {
        defaultMessage: `View and manage chat-started processes`,
        id: `codex.commandDescription.openProcessManager`,
      },
      { defaultMessage: `Open the review tab`, id: `codex.commandDescription.openReviewTab` },
      {
      ...
      { defaultMessage: `Switch to the previous tab`, id: `codex.commandDescription.previousTab` },
      {
      ...
      { defaultMessage: `Rename the current chat`, id: `codex.commandDescription.renameThread` },
      { defaultMessage: `Search chats`, id: `codex.commandDescription.searchChats` },
      { defaultMessage: `Search files`, id: `codex.commandDescription.searchFiles` },
      { defaultMessage: `Open {appName} settings`, id: `codex.commandDescription.settings` },
      {
        defaultMessage: `Show the shortcuts available right now`,
        id: `codex.commandDescription.showKeyboardShortcuts`,
      },
      { defaultMessage: `Switch to mode 1`, id: `codex.commandDescription.switchToMode1` },
      { defaultMessage: `Switch to mode 2`, id: `codex.commandDescription.switchToMode2` },
      {
      ...
      { defaultMessage: `Show or hide the sidebar`, id: `codex.commandDescription.toggleSidebar` },
      {
        defaultMessage: `Show or hide the side panel`,
        id: `codex.commandDescription.toggleSidePanel`,
      },
      { defaultMessage: `Open the terminal panel`, id: `codex.commandDescription.toggleTerminal` },
      {
      ...
      { defaultMessage: `Archive chat`, id: `codex.commandMenuTitle.archiveThread` },
      { defaultMessage: `Close Tab`, id: `codex.commandMenuTitle.closeTab` },
      { defaultMessage: `Close`, id: `codex.commandMenuTitle.closeWindow` },
      { defaultMessage: `Dictation`, id: `codex.commandMenuTitle.composer.startDictation` },
      {
        defaultMessage: `Copy conversation path`,
        id: `codex.commandMenuTitle.copyConversationPath`,
      },
      { defaultMessage: `Copy deeplink`, id: `codex.commandMenuTitle.copyDeeplink` },
      { defaultMessage: `Copy session id`, id: `codex.commandMenuTitle.copySessionId` },
      {
      ...
      { defaultMessage: `Forward`, id: `codex.commandMenuTitle.navigateForward` },
      ...
      { defaultMessage: `Wake Pet`, id: `codex.commandMenuTitle.openAvatarOverlay` },
      { defaultMessage: `Open Browser Tab`, id: `codex.commandMenuTitle.openBrowserTab` },
      { defaultMessage: `Open command menu`, id: `codex.commandMenuTitle.openCommandMenu` },
      { defaultMessage: `Open Folder…`, id: `codex.commandMenuTitle.openFolder` },
      { defaultMessage: `Process Manager`, id: `codex.commandMenuTitle.openProcessManager` },
      { defaultMessage: `Open in New Window`, id: `codex.commandMenuTitle.openThreadInNewWindow` },
      { defaultMessage: `Previous Chat`, id: `codex.commandMenuTitle.previousThread` },
      { defaultMessage: `Quick Chat`, id: `codex.commandMenuTitle.quickChat` },
      { defaultMessage: `Reload Browser Page`, id: `codex.commandMenuTitle.reloadBrowserPage` },
      { defaultMessage: `Rename chat`, id: `codex.commandMenuTitle.renameThread` },
      { defaultMessage: `Search Chats…`, id: `codex.commandMenuTitle.searchChats` },
      { defaultMessage: `Search Files…`, id: `codex.commandMenuTitle.searchFiles` },
      { defaultMessage: `Settings…`, id: `codex.commandMenuTitle.settings` },
      { defaultMessage: `Keyboard Shortcuts`, id: `codex.commandMenuTitle.showKeyboardShortcuts` },
      ...
      { defaultMessage: `Toggle Bottom Panel`, id: `codex.commandMenuTitle.toggleBottomPanel` },
      { defaultMessage: `Toggle Browser Panel`, id: `codex.commandMenuTitle.toggleBrowserPanel` },
      { defaultMessage: `Toggle File Tree`, id: `codex.commandMenuTitle.toggleFileTreePanel` },
      { defaultMessage: `Toggle Sidebar`, id: `codex.commandMenuTitle.toggleSidebar` },
      { defaultMessage: `Toggle Side Panel`, id: `codex.commandMenuTitle.toggleSidePanel` },
      { defaultMessage: `Open Terminal`, id: `codex.commandMenuTitle.toggleTerminal` },
      { defaultMessage: `Pin/unpin chat`, id: `codex.commandMenuTitle.toggleThreadPin` },
      {
        defaultMessage: `Start Trace Recording`,
        id: `codex.commandMenuTitle.toggleTraceRecording`,
      },
      { defaultMessage: `No active shortcuts`, id: `keyboardShortcutsDialog.empty` },
      { defaultMessage: `Loading shortcuts…`, id: `keyboardShortcutsDialog.loading` },
      { defaultMessage: `No matching shortcuts`, id: `keyboardShortcutsDialog.noMatches` },
      { defaultMessage: `App`, id: `keyboardShortcutsDialog.section.app` },
      { defaultMessage: `Configure`, id: `keyboardShortcutsDialog.section.configure` },
      { defaultMessage: `General`, id: `keyboardShortcutsDialog.section.general` },
      { defaultMessage: `Navigation`, id: `keyboardShortcutsDialog.section.navigation` },
      { defaultMessage: `Panels`, id: `keyboardShortcutsDialog.section.panels` },
      { defaultMessage: `Skills`, id: `keyboardShortcutsDialog.section.skills` },
      { defaultMessage: `Chat`, id: `keyboardShortcutsDialog.section.thread` },
      { defaultMessage: `Project`, id: `keyboardShortcutsDialog.section.workspace` },
      { defaultMessage: `Keyboard shortcuts`, id: `keyboardShortcutsDialog.title` },
      {
        defaultMessage: `Shortcut capture for {commandTitle}`,
        id: `settings.keyboardShortcuts.captureAriaLabel`,
      },
      { defaultMessage: `Cancel`, id: `settings.keyboardShortcuts.captureCancel` },
      {
        defaultMessage: `Used by {commandTitle}`,
        id: `settings.keyboardShortcuts.captureConflict`,
      },
      { defaultMessage: `Press shortcut`, id: `settings.keyboardShortcuts.capturePrompt` },
      {
      ...
      { defaultMessage: `Loading shortcuts…`, id: `settings.keyboardShortcuts.loading` },
      { defaultMessage: `No matching shortcuts`, id: `settings.keyboardShortcuts.noMatches` },
      { defaultMessage: `Reset all to defaults`, id: `settings.keyboardShortcuts.resetAll` },
      { defaultMessage: `Cancel`, id: `settings.keyboardShortcuts.resetAllConfirm.cancel` },
      { defaultMessage: `Reset all`, id: `settings.keyboardShortcuts.resetAllConfirm.confirm` },
      {
      ...
      { defaultMessage: `Search shortcuts`, id: `settings.keyboardShortcuts.search.placeholder` },
      {
      ...
      { defaultMessage: `Actions`, id: `settings.keyboardShortcuts.table.actions` },
      { defaultMessage: `Command`, id: `settings.keyboardShortcuts.table.command` },
      { defaultMessage: `Keybinding`, id: `settings.keyboardShortcuts.table.keybinding` },
      { defaultMessage: `Unassigned`, id: `settings.keyboardShortcuts.unassigned` },
      { defaultMessage: `Failed to update shortcut`, id: `settings.keyboardShortcuts.updateError` },
    ],
    "local-environments": [
      ...
      { defaultMessage: `Cancel`, id: `projectSetup.createLocalProject.cancel` },
      { defaultMessage: `Project name`, id: `projectSetup.createLocalProject.nameAriaLabel` },
      { defaultMessage: `Name`, id: `projectSetup.createLocalProject.nameLabel` },
      {
        defaultMessage: `Optional project name`,
        id: `projectSetup.createLocalProject.namePlaceholder`,
      },
      { defaultMessage: `Remove {name}`, id: `projectSetup.createLocalProject.removeSource` },
      {
      ...
      { defaultMessage: `Add sources`, id: `projectSetup.createLocalProject.sourcesLabel` },
      { defaultMessage: `Create project`, id: `projectSetup.createLocalProject.submit` },
      {
        defaultMessage: `Add folders Codex can read and edit for this project`,
        id: `projectSetup.createLocalProject.subtitle`,
      },
      { defaultMessage: `Create local project`, id: `projectSetup.createLocalProject.title` },
      { defaultMessage: `Project name`, id: `projectSetup.createLocalProjectDialogAriaLabel` },
      { defaultMessage: `Project name`, id: `projectSetup.createLocalProjectDialogPlaceholder` },
      {
        defaultMessage: `Keep it short and recognizable`,
        id: `projectSetup.createLocalProjectDialogSubtitle`,
      },
      { defaultMessage: `Name project`, id: `projectSetup.createLocalProjectDialogTitle` },
      { defaultMessage: `Delete project`, id: `projectSetup.editLocalProject.deleteProject` },
      { defaultMessage: `Failed to save project`, id: `projectSetup.editLocalProject.saveError` },
      ...
      { defaultMessage: `Edit project`, id: `projectSetup.editLocalProject.title` },
      { defaultMessage: `Add action`, id: `settings.localEnvironments.actions.add` },
      {
        defaultMessage: `Add an action to run commands from the local toolbar`,
        id: `settings.localEnvironments.actions.empty`,
      },
      { defaultMessage: `Debug`, id: `settings.localEnvironments.actions.icon.debug` },
      { defaultMessage: `Run`, id: `settings.localEnvironments.actions.icon.run` },
      { defaultMessage: `Test`, id: `settings.localEnvironments.actions.icon.test` },
      { defaultMessage: `Tool`, id: `settings.localEnvironments.actions.icon.tool` },
      { defaultMessage: `Delete`, id: `settings.localEnvironments.actions.item.button.delete` },
      { defaultMessage: `Action script`, id: `settings.localEnvironments.actions.item.command` },
      { defaultMessage: `Name`, id: `settings.localEnvironments.actions.item.name` },
      { defaultMessage: `Platforms`, id: `settings.localEnvironments.actions.item.platforms` },
      {
        defaultMessage: `Only run on a specific OS.`,
        id: `settings.localEnvironments.actions.item.platforms.help`,
      },
      { defaultMessage: `Linux`, id: `settings.localEnvironments.actions.item.platforms.linux` },
      { defaultMessage: `macOS`, id: `settings.localEnvironments.actions.item.platforms.macos` },
      {
      ...
      { defaultMessage: `Delete`, id: `settings.localEnvironments.actions.item.tooltip.delete` },
      { defaultMessage: `Actions`, id: `settings.localEnvironments.actions.title` },
      { defaultMessage: `Back`, id: `settings.localEnvironments.breadcrumb.back` },
      { defaultMessage: `edit`, id: `settings.localEnvironments.breadcrumb.edit` },
      { defaultMessage: `Environments`, id: `settings.localEnvironments.breadcrumb.root` },
      {
        defaultMessage: `Runs at the project root on worktree creation`,
        id: `settings.localEnvironments.editor.setup.description`,
      },
      { defaultMessage: `Local environment`, id: `settings.localEnvironments.editor.title` },
      {
      ...
      { defaultMessage: `Actions`, id: `settings.localEnvironments.environment.actionsLabel` },
      {
      ...
      { defaultMessage: `local`, id: `settings.localEnvironments.environment.defaultName` },
      {
      ...
      { defaultMessage: `Name`, id: `settings.localEnvironments.environment.name` },
      { defaultMessage: `Default`, id: `settings.localEnvironments.environment.script.default` },
      { defaultMessage: `Setup script`, id: `settings.localEnvironments.environment.setup` },
      {
      ...
      { defaultMessage: `Environment details`, id: `settings.localEnvironments.environment.title` },
      {
      ...
      { defaultMessage: `(DEV only)`, id: `settings.localEnvironments.preview.devOnly` },
      { defaultMessage: `Save`, id: `settings.localEnvironments.preview.save` },
      {
        defaultMessage: `Failed to save the file. ({error})`,
        id: `settings.localEnvironments.preview.saveError`,
      },
      { defaultMessage: `Preview`, id: `settings.localEnvironments.preview.title` },
      {
        defaultMessage: `Could not load project information`,
        id: `settings.localEnvironments.projectInfo.error`,
      },
      { defaultMessage: `Retry`, id: `settings.localEnvironments.projectInfo.retry` },
      {
      ...
      { defaultMessage: `Saving…`, id: `settings.localEnvironments.save.disabled.saving` },
      {
        defaultMessage: `Saved the environment file, but could not select it`,
        id: `settings.localEnvironments.save.selectionError`,
      },
      { defaultMessage: `Saved local environment`, id: `settings.localEnvironments.save.success` },
      {
      ...
      { defaultMessage: `Add project`, id: `settings.localEnvironments.workspace.add` },
      { defaultMessage: `Project`, id: `settings.localEnvironments.workspace.title` },
      {
      ...
      { defaultMessage: `Learn more.`, id: `settings.localEnvironments.workspaceSelect.learnMore` },
      {
      ...
      { defaultMessage: `View`, id: `settings.localEnvironments.workspaceSelect.viewAction` },
      ...
      { defaultMessage: `Removing…`, id: `sidebarElectron.removeProject.removing` },
    ],
    "mcp-settings": [
      ...
      { defaultMessage: `Add environment variable`, id: `settings.mcp.detail.addEnvVar` },
      { defaultMessage: `Add variable`, id: `settings.mcp.detail.addEnvVarPassthrough` },
      { defaultMessage: `Arguments`, id: `settings.mcp.detail.args` },
      { defaultMessage: `Back`, id: `settings.mcp.detail.back` },
      { defaultMessage: `Command to launch`, id: `settings.mcp.detail.command` },
      { defaultMessage: `Working directory`, id: `settings.mcp.detail.cwd` },
      { defaultMessage: `Open MCP documentation`, id: `settings.mcp.detail.docs` },
      ...
      { defaultMessage: `Environment variables`, id: `settings.mcp.detail.envVars` },
      { defaultMessage: `Add variable`, id: `settings.mcp.detail.http.addEnvHeader` },
      { defaultMessage: `Add header`, id: `settings.mcp.detail.http.addHeader` },
      { defaultMessage: `Bearer token env var`, id: `settings.mcp.detail.http.bearerToken` },
      {
      ...
      { defaultMessage: `Could not save MCP server`, id: `settings.mcp.detail.saveError` },
      {
      ...
      { defaultMessage: `Update {name} MCP`, id: `settings.mcp.detail.titleExisting` },
      { defaultMessage: `Connect to a custom MCP`, id: `settings.mcp.detail.titleNew` },
      { defaultMessage: `Streamable HTTP`, id: `settings.mcp.detail.transport.http` },
      ...
      { defaultMessage: `Restart extension`, id: `settings.mcp.restartExtension` },
    ...
    personalization: [
      ...
      { defaultMessage: `Friendly`, id: `composer.personalitySlashCommand.label.friendly` },
      { defaultMessage: `Pragmatic`, id: `composer.personalitySlashCommand.label.pragmatic` },
      {
      ...
      { defaultMessage: `Cancel`, id: `settings.general.experimentalFeatures.chronicle.cancel` },
      {
      ...
      { defaultMessage: `Close`, id: `settings.general.experimentalFeatures.chronicle.setupClose` },
      {
      ...
      { defaultMessage: `Enable memories`, id: `settings.memory.enableMemoriesAriaLabel` },
      {
      ...
      { defaultMessage: `Enable memories`, id: `settings.memory.enableMemoriesLabel` },
      { defaultMessage: `Skip tool-assisted chats`, id: `settings.memory.noToolContextAriaLabel` },
      {
      ...
      { defaultMessage: `Skip tool-assisted chats`, id: `settings.memory.noToolContextLabel` },
      ...
      { defaultMessage: `Reset all memories?`, id: `settings.memory.resetDialogTitle` },
      { defaultMessage: `Unable to reset memories`, id: `settings.memory.resetError` },
      ...
      { defaultMessage: `Reset memories`, id: `settings.memory.resetMemoriesLabel` },
      ...
      { defaultMessage: `Loading agents.md…`, id: `settings.personalization.agents.loading` },
      {
      ...
      { defaultMessage: `Saved agents.md`, id: `settings.personalization.agents.save.success` },
      { defaultMessage: `Custom instructions`, id: `settings.personalization.agents.title` },
      {
      ...
      { defaultMessage: `Memory (experimental)`, id: `settings.personalization.memory.title` },
      {
        defaultMessage: `Choose a default tone for Codex responses`,
        id: `settings.personalization.personality.description`,
      },
      { defaultMessage: `Personality`, id: `settings.personalization.personality.label` },
    ],
    pets: [
      {
      ...
      { defaultMessage: `Null Signal`, id: `settings-search.literal.386bc4b830d3` },
      ...
      { defaultMessage: `Stacky`, id: `settings-search.literal.545f5490a6c5` },
      {
      ...
      { defaultMessage: `Quiet signal from the void.`, id: `settings-search.literal.813212bbccc1` },
      { defaultMessage: `A tiny blue-screen gremlin.`, id: `settings-search.literal.82015054f4ef` },
      {
      ...
      { defaultMessage: `Fireball`, id: `settings-search.literal.c6c39f74af09` },
      { defaultMessage: `Select`, id: `settings.personalization.avatars.select` },
      { defaultMessage: `Selected`, id: `settings.personalization.avatars.selected` },
      { defaultMessage: `Wake Pet`, id: `settings.personalization.pets.openPet` },
      { defaultMessage: `Tuck Away Pet`, id: `settings.personalization.pets.tuckAwayPet` },
      { defaultMessage: `Create your own pet`, id: `settings.pets.custom.create.title` },
      { defaultMessage: `Open folder`, id: `settings.pets.custom.openFolder` },
      { defaultMessage: `Unable to open pet folder`, id: `settings.pets.custom.openFolderError` },
      { defaultMessage: `Custom pets`, id: `settings.pets.custom.title` },
      { defaultMessage: `Unable to load custom pets`, id: `settings.pets.loadCustomError` },
      { defaultMessage: `Loading custom pets`, id: `settings.pets.loadingCustom` },
      { defaultMessage: `Refresh`, id: `settings.pets.refresh` },
    ],
    profile: [
      { defaultMessage: `High`, id: `composer.mode.local.reasoning.high.label` },
      { defaultMessage: `Low`, id: `composer.mode.local.reasoning.low.label` },
      { defaultMessage: `Max`, id: `composer.mode.local.reasoning.max.label` },
      { defaultMessage: `Medium`, id: `composer.mode.local.reasoning.medium.label` },
      { defaultMessage: `Minimal`, id: `composer.mode.local.reasoning.minimal.label` },
      { defaultMessage: `None`, id: `composer.mode.local.reasoning.none.label` },
      { defaultMessage: `Extra High`, id: `composer.mode.local.reasoning.xhigh.label` },
      ...
      { defaultMessage: `Most used reasoning`, id: `profile.activity.features.mostUsedReasoning` },
      ...
      { defaultMessage: `Skills explored`, id: `profile.activity.features.skillsExplored` },
      {
        defaultMessage: `The number of unique skills you've used`,
        id: `profile.activity.features.skillsExploredTooltip`,
      },
      { defaultMessage: `Total skills used`, id: `profile.activity.features.totalSkillsUsed` },
      {
        defaultMessage: `Total times Codex used a skill`,
        id: `profile.activity.features.totalSkillsUsedTooltip`,
      },
      { defaultMessage: `Total threads`, id: `profile.activity.features.totalThreads` },
      {
        defaultMessage: `Total unique conversations with Codex`,
        id: `profile.activity.features.totalThreadsTooltip`,
      },
      { defaultMessage: `Activity insights`, id: `profile.activity.insights.title` },
      { defaultMessage: `Browse`, id: `profile.activity.plugins.browse` },
      { defaultMessage: `No plugins used yet ·`, id: `profile.activity.plugins.empty` },
      {
        defaultMessage: `{runs, plural, one {# run} other {# runs}}`,
        id: `profile.activity.plugins.runs`,
      },
      { defaultMessage: `Most used plugins`, id: `profile.activity.plugins.title` },
      { defaultMessage: `Activity insights unavailable`, id: `profile.activity.unavailable` },
      { defaultMessage: `Unable to update display name`, id: `profile.displayNameUpdateError` },
      ...
      { defaultMessage: `[Employee only] Error: {details}`, id: `profile.fetchErrorDetail` },
      ...
      { defaultMessage: `Unable to process the profile picture`, id: `profile.photoCrop.error` },
      ...
      { defaultMessage: `Zoom profile picture`, id: `profile.photoCrop.zoomLabel` },
      { defaultMessage: `Zoom out`, id: `profile.photoCrop.zoomOut` },
      { defaultMessage: `Change profile picture`, id: `profile.photoInputLabel` },
      { defaultMessage: `Unable to update profile picture`, id: `profile.photoUpdateError` },
      { defaultMessage: `Private`, id: `profile.private` },
      { defaultMessage: `Your profile is only visible to you`, id: `profile.privateTooltip` },
      { defaultMessage: `Failed to copy image`, id: `profile.shareCard.copyError` },
      { defaultMessage: `Copied image`, id: `profile.shareCard.copySuccess` },
      { defaultMessage: `Could not create profile card`, id: `profile.shareCard.createError` },
      { defaultMessage: `Check out my Codex activity`, id: `profile.shareCard.draftText` },
      { defaultMessage: `Close share preview`, id: `profile.shareCard.preview.close` },
      { defaultMessage: `Copy image`, id: `profile.shareCard.preview.copyImage` },
      {
      ...
      { defaultMessage: `Share your activity`, id: `profile.shareCard.preview.heading` },
      { defaultMessage: `Hide pet`, id: `profile.shareCard.preview.hidePetLabel` },
      { defaultMessage: `Profile share card preview`, id: `profile.shareCard.preview.imageAlt` },
      { defaultMessage: `LinkedIn`, id: `profile.shareCard.preview.linkedin` },
      { defaultMessage: `Creating image…`, id: `profile.shareCard.preview.loading` },
      {
        defaultMessage: `Creating profile share card`,
        id: `profile.shareCard.preview.loadingLabel`,
      },
      { defaultMessage: `Next custom pet`, id: `profile.shareCard.preview.nextPet` },
      {
        defaultMessage: `Open {platformName} composer`,
        id: `profile.shareCard.preview.openSocialComposer`,
      },
      { defaultMessage: `Paste image into the post`, id: `profile.shareCard.preview.pasteImage` },
      { defaultMessage: `Hidden`, id: `profile.shareCard.preview.petHidden` },
      { defaultMessage: `{petPosition} / {petCount}`, id: `profile.shareCard.preview.petPosition` },
      { defaultMessage: `Custom pet`, id: `profile.shareCard.preview.petSwitcher` },
      { defaultMessage: `Previous custom pet`, id: `profile.shareCard.preview.previousPet` },
      { defaultMessage: `Reddit`, id: `profile.shareCard.preview.reddit` },
      { defaultMessage: `Save profile card`, id: `profile.shareCard.preview.save` },
      { defaultMessage: `Save`, id: `profile.shareCard.preview.saveLabel` },
      { defaultMessage: `Share to LinkedIn`, id: `profile.shareCard.preview.shareLinkedIn` },
      { defaultMessage: `Share to Reddit`, id: `profile.shareCard.preview.shareReddit` },
      { defaultMessage: `Share to X`, id: `profile.shareCard.preview.shareX` },
      { defaultMessage: `Show pet`, id: `profile.shareCard.preview.showPetLabel` },
      {
        defaultMessage: `Share to {platformName}`,
        id: `profile.shareCard.preview.socialInstructionsTitle`,
      },
      { defaultMessage: `Share profile card`, id: `profile.shareCard.preview.title` },
      ...
      { defaultMessage: `Share profile card`, id: `profile.shareCard.shareLabel` },
      { defaultMessage: `current streak`, id: `profile.shareCard.stats.currentStreak` },
      { defaultMessage: `lifetime tokens`, id: `profile.shareCard.stats.lifetimeTokens` },
      { defaultMessage: `longest streak`, id: `profile.shareCard.stats.longestStreak` },
      ...
      { defaultMessage: `{hours}h {minutes}m`, id: `profile.stats.durationHoursMinutes` },
      { defaultMessage: `{minutes}m`, id: `profile.stats.durationMinutes` },
      { defaultMessage: `{minutes}m {seconds}s`, id: `profile.stats.durationMinutesSeconds` },
      ...
      { defaultMessage: `Profile stats unavailable`, id: `profile.stats.unavailable` },
      { defaultMessage: `{tokens} tokens on {date}`, id: `profile.tokenUsage.cellTooltip` },
      { defaultMessage: `Token usage chart`, id: `profile.tokenUsage.chartLabel` },
      ...
      { defaultMessage: `Token usage unavailable`, id: `profile.tokenUsage.unavailable` },
      ...
      { defaultMessage: `Username requirements`, id: `profile.usernameRequirementsLabel` },
      { defaultMessage: `Unable to update username`, id: `profile.usernameUpdateError` },
      { defaultMessage: `Enter a username`, id: `profile.usernameValidation.empty` },
      {
    ...
    usage: [
      ...
      { defaultMessage: `Every {days}d`, id: `composer.mode.rateLimit.cadence.day` },
      { defaultMessage: `Every {hours}hr`, id: `composer.mode.rateLimit.cadence.hour` },
      { defaultMessage: `Every {minutes}m`, id: `composer.mode.rateLimit.cadence.minute` },
      {
      ...
      { defaultMessage: `Usage remaining`, id: `composer.mode.rateLimit.heading` },
      ...
      { defaultMessage: `Checking subscription…`, id: `settings.usage.access.loading` },
      ...
      { defaultMessage: `Auto-reload credits`, id: `settings.usage.autoTopUp.dialog.title` },
      ...
      { defaultMessage: `Disabled auto reload`, id: `settings.usage.autoTopUp.disable.success` },
      ...
      { defaultMessage: `Enabled auto reload`, id: `settings.usage.autoTopUp.enable.success` },
      {
      ...
      { defaultMessage: `Loading price`, id: `settings.usage.autoTopUp.target.equivalent.loading` },
      {
      ...
      { defaultMessage: `Target balance`, id: `settings.usage.autoTopUp.target.label` },
      {
      ...
      { defaultMessage: `Minimum balance`, id: `settings.usage.autoTopUp.threshold.label` },
      {
      ...
      { defaultMessage: `Buy credits`, id: `settings.usage.credit.balance.buyCredits` },
      { defaultMessage: `Current balance`, id: `settings.usage.credit.balance.current` },
      {
      ...
      { defaultMessage: `Set up auto-reload`, id: `settings.usage.credit.balance.setupAutoReload` },
      { defaultMessage: `Credits balance`, id: `settings.usage.credit.balance.title` },
      {
        defaultMessage: `Credit remaining unavailable`,
        id: `settings.usage.credit.remaining.unavailable`,
      },
      { defaultMessage: `Unlimited credit`, id: `settings.usage.credit.remaining.unlimited` },
      { defaultMessage: `No credit usage recorded yet`, id: `settings.usage.creditHistory.empty` },
      {
      ...
      { defaultMessage: `Previous`, id: `settings.usage.creditHistory.previous` },
      {
        defaultMessage: `{from}-{to} of {total} usage events`,
        id: `settings.usage.creditHistory.range`,
      },
      { defaultMessage: `Credit usage history`, id: `settings.usage.creditHistory.title` },
      {
      ...
      { defaultMessage: `Add credits`, id: `settings.usage.creditReload.addCredits.title` },
      {
        defaultMessage: `{creditQuantity, number} credits`,
        id: `settings.usage.creditReload.amount.credits`,
      },
      { defaultMessage: `Other`, id: `settings.usage.creditReload.amount.other` },
      {
      ...
      { defaultMessage: `Auto-reload`, id: `settings.usage.creditReload.autoReload.checkbox` },
      {
      ...
      { defaultMessage: `Enable auto-reload`, id: `settings.usage.creditReload.autoReload.enable` },
      {
        defaultMessage: `Failed to enable auto-reload`,
      ...
      { defaultMessage: `Save`, id: `settings.usage.creditReload.autoReload.save` },
      {
        defaultMessage: `Set up auto-reload`,
        id: `settings.usage.creditReload.autoReload.setup.title`,
      },
      { defaultMessage: `Turn off`, id: `settings.usage.creditReload.autoReload.turnOff` },
      {
        defaultMessage: `Failed to update auto-reload`,
      ...
      { defaultMessage: `Enter an amount`, id: `settings.usage.creditReload.error.missing` },
      {
      ...
      { defaultMessage: `Cancel`, id: `settings.usage.creditReload.load.cancel` },
      {
      ...
      { defaultMessage: `Minimum balance`, id: `settings.usage.creditReload.minimumBalance` },
      {
      ...
      { defaultMessage: `Maximum monthly spend`, id: `settings.usage.creditReload.spendLimit` },
      {
        defaultMessage: `Monthly reload spend limit`,
        id: `settings.usage.creditReload.spendLimit.ariaLabel`,
      },
      { defaultMessage: `(Optional)`, id: `settings.usage.creditReload.spendLimit.optional` },
      { defaultMessage: `No limit`, id: `settings.usage.creditReload.spendLimit.placeholder` },
      { defaultMessage: `View rate card`, id: `settings.usage.creditReload.viewRateCard` },
      {
        defaultMessage: `{value, number} {value, plural, one {credit} other {credits}}`,
        id: `settings.usage.credits.value`,
      },
      { defaultMessage: `No daily usage recorded yet`, id: `settings.usage.daily.empty` },
      { defaultMessage: `Could not load daily usage`, id: `settings.usage.daily.error` },
      {
      ...
      { defaultMessage: `Loading usage history…`, id: `settings.usage.history.loading` },
      { defaultMessage: `Retry`, id: `settings.usage.history.retry` },
      { defaultMessage: `Request Increase`, id: `settings.usage.limits.customRequestIncrease` },
      { defaultMessage: `Daily usage limit`, id: `settings.usage.limits.day.label` },
      { defaultMessage: `5 hour usage limit`, id: `settings.usage.limits.fiveHour.label` },
      { defaultMessage: `Usage limit`, id: `settings.usage.limits.genericWindow.label` },
      {
        defaultMessage: `{used} of {limit} credits used`,
        id: `settings.usage.limits.monthly.creditsUsed`,
      },
      { defaultMessage: `Monthly usage limit`, id: `settings.usage.limits.monthly.label` },
      {
      ...
      { defaultMessage: `Usage remaining`, id: `settings.usage.limits.progress.ariaLabel` },
      { defaultMessage: `{remaining}% left`, id: `settings.usage.limits.progress.remaining` },
      { defaultMessage: `Cancel`, id: `settings.usage.limits.requestCancel` },
      { defaultMessage: `Request limit increase`, id: `settings.usage.limits.requestIncrease` },
      { defaultMessage: `Justification`, id: `settings.usage.limits.requestJustificationLabel` },
      {
      ...
      { defaultMessage: `Submit request`, id: `settings.usage.limits.requestSave` },
      { defaultMessage: `Request submitted`, id: `settings.usage.limits.requestSaved` },
      {
        defaultMessage: `Could not save your request. Please try again.`,
        id: `settings.usage.limits.requestSaveError`,
      },
      { defaultMessage: `Update request`, id: `settings.usage.limits.requestUpdate` },
      { defaultMessage: `Request updated`, id: `settings.usage.limits.requestUpdated` },
      {
        defaultMessage: `GPT-5.3-Codex-Spark usage limits`,
        id: `settings.usage.limits.spark.title`,
      },
      { defaultMessage: `General usage limits`, id: `settings.usage.limits.title` },
      {
        defaultMessage: `Update pending request`,
        id: `settings.usage.limits.updatePendingRequest`,
      },
      { defaultMessage: `Weekly usage limit`, id: `settings.usage.limits.week.label` },
      { defaultMessage: `Resets {time}`, id: `settings.usage.limits.window.resetAt` },
      { defaultMessage: `Could not load usage settings.`, id: `settings.usage.load.error` },
      { defaultMessage: `Loading usage settings…`, id: `settings.usage.load.loading` },
      ...
      { defaultMessage: `Plan audience`, id: `settings.usage.pricingPlanPage.audienceSelector` },
      ...
      { defaultMessage: `Get started`, id: `settings.usage.pricingPlanPage.business.codexCta` },
      {
      ...
      { defaultMessage: `Business`, id: `settings.usage.pricingPlanPage.businessTab` },
      { defaultMessage: `Current plan`, id: `settings.usage.pricingPlanPage.current` },
      { defaultMessage: `Downgrade to {plan}`, id: `settings.usage.pricingPlanPage.downgradeTo` },
      { defaultMessage: `Loading…`, id: `settings.usage.pricingPlanPage.loadingPlanChange` },
      { defaultMessage: `Core model`, id: `settings.usage.pricingPlanPage.personal.free.core` },
      {
      ...
      { defaultMessage: `Free`, id: `settings.usage.pricingPlanPage.personal.free.title` },
      { defaultMessage: `Core model`, id: `settings.usage.pricingPlanPage.personal.go.core` },
      {
      ...
      { defaultMessage: `Longer memory`, id: `settings.usage.pricingPlanPage.personal.go.memory` },
      {
        defaultMessage: `More messages and uploads`,
        id: `settings.usage.pricingPlanPage.personal.go.messages`,
      },
      { defaultMessage: `Go`, id: `settings.usage.pricingPlanPage.personal.go.title` },
      {
        defaultMessage: `Expanded voice mode`,
        id: `settings.usage.pricingPlanPage.personal.go.voice`,
      },
      { defaultMessage: `/ month`, id: `settings.usage.pricingPlanPage.personal.monthlyCadence` },
      {
        defaultMessage: `Codex coding agent`,
      ...
      { defaultMessage: `Plus`, id: `settings.usage.pricingPlanPage.personal.plus.title` },
      {
      ...
      { defaultMessage: `From`, id: `settings.usage.pricingPlanPage.personal.pro.from` },
      {
      ...
      { defaultMessage: `Pro`, id: `settings.usage.pricingPlanPage.personal.pro.title` },
      {
        defaultMessage: `5x or 20x more usage than Plus`,
        id: `settings.usage.pricingPlanPage.personal.pro.usage`,
      },
      { defaultMessage: `Personal`, id: `settings.usage.pricingPlanPage.personalTab` },
      { defaultMessage: `POPULAR`, id: `settings.usage.pricingPlanPage.popular` },
      { defaultMessage: `Pro usage level`, id: `settings.usage.pricingPlanPage.proUsageSelector` },
      {
        defaultMessage: `Successfully upgraded plan`,
        id: `settings.usage.pricingPlanPage.subscriptionUpdate.upgradeSucceeded`,
      },
      { defaultMessage: `Upgrade your plan`, id: `settings.usage.pricingPlanPage.title` },
      { defaultMessage: `Upgrade to {plan}`, id: `settings.usage.pricingPlanPage.upgradeTo` },
      {
      ...
      { defaultMessage: `Access tokens`, id: `settings.usage.surface.agentIdentity` },
      { defaultMessage: `CLI`, id: `settings.usage.surface.cli` },
      { defaultMessage: `Desktop app`, id: `settings.usage.surface.desktopApp` },
      { defaultMessage: `Exec`, id: `settings.usage.surface.exec` },
      { defaultMessage: `GitHub`, id: `settings.usage.surface.github` },
      { defaultMessage: `GitHub code review`, id: `settings.usage.surface.githubCodeReview` },
      ...
      { defaultMessage: `GPT-5.5 Thinking`, id: `settings.usage.upgradePlan.business.codex.model` },
      { defaultMessage: `Usage pricing`, id: `settings.usage.upgradePlan.business.codex.price` },
      {
        defaultMessage: `Enhanced security and admin controls`,
        id: `settings.usage.upgradePlan.business.codex.security`,
      },
      { defaultMessage: `Codex`, id: `settings.usage.upgradePlan.business.codex.subtitle` },
      { defaultMessage: `Business`, id: `settings.usage.upgradePlan.business.codex.title` },
      {
      ...
      { defaultMessage: `GPT-5.5 Thinking`, id: `settings.usage.upgradePlan.business.team.model` },
      {
      ...
      { defaultMessage: `Business`, id: `settings.usage.upgradePlan.business.team.title` },
      {
      ...
      { defaultMessage: `Current plan`, id: `settings.usage.upgradePlan.current` },
      {
        defaultMessage: `Compare personal and business plans`,
        id: `settings.usage.upgradePlan.description`,
      },
      { defaultMessage: `Downgrade`, id: `settings.usage.upgradePlan.downgrade` },
      { defaultMessage: `Loading…`, id: `settings.usage.upgradePlan.loadingPlanChange` },
      ...
      { defaultMessage: `GPT-5.3`, id: `settings.usage.upgradePlan.personal.free.model` },
      { defaultMessage: `Free`, id: `settings.usage.upgradePlan.personal.free.title` },
      {
        defaultMessage: `Limited Codex usage`,
        id: `settings.usage.upgradePlan.personal.free.usage`,
      },
      { defaultMessage: `GPT-5.5 Thinking`, id: `settings.usage.upgradePlan.personal.plus.model` },
      { defaultMessage: `Plus`, id: `settings.usage.upgradePlan.personal.plus.title` },
      {
        defaultMessage: `Enhanced Codex usage`,
      ...
      { defaultMessage: `GPT-5.5 Pro`, id: `settings.usage.upgradePlan.personal.pro.model` },
      { defaultMessage: `20x`, id: `settings.usage.upgradePlan.personal.pro.tier` },
      { defaultMessage: `Pro`, id: `settings.usage.upgradePlan.personal.pro.title` },
      {
      ...
      { defaultMessage: `5x`, id: `settings.usage.upgradePlan.personal.proLite.tier` },
      {
      ...
      { defaultMessage: `5x`, id: `settings.usage.upgradePlan.personal.proTier.fiveX` },
      { defaultMessage: `20x`, id: `settings.usage.upgradePlan.personal.proTier.twentyX` },
      { defaultMessage: `Choose plan category`, id: `settings.usage.upgradePlan.tabs.ariaLabel` },
      { defaultMessage: `Business`, id: `settings.usage.upgradePlan.tabs.business` },
      { defaultMessage: `Personal`, id: `settings.usage.upgradePlan.tabs.personal` },
      { defaultMessage: `Upgrade plan`, id: `settings.usage.upgradePlan.title` },
      { defaultMessage: `Upgrade plan`, id: `settings.usage.upgradePlan.upgrade` },
    ],
    worktrees: [
      { defaultMessage: `Untitled conversation`, id: `settings.worktrees.conversation.untitled` },
      { defaultMessage: `Failed to delete worktree`, id: `settings.worktrees.delete.error` },
      {
        defaultMessage: `Worktrees created by Codex will appear here.`,
        id: `settings.worktrees.empty.body`,
      },
      { defaultMessage: `No worktrees yet`, id: `settings.worktrees.empty.title` },
      {
        defaultMessage: `Something went wrong while loading worktrees.`,
        id: `settings.worktrees.error.body`,
      },
      { defaultMessage: `Unable to load worktrees`, id: `settings.worktrees.error.title` },
      { defaultMessage: `Fetching worktree details.`, id: `settings.worktrees.loading.body` },
      { defaultMessage: `Loading worktrees`, id: `settings.worktrees.loading.title` },
      ...
      { defaultMessage: `Unknown repository`, id: `settings.worktrees.repository.unknown` },
      { defaultMessage: `Conversations`, id: `settings.worktrees.row.conversations` },
      {
  ...
  dt = H.map((e) => ({ messages: ut[e] ?? [], sectionSlug: e })),
  ft = [
  ...
  pt = [
    `settings.general.realtimeVoiceWakeWord.label`,
    `settings.general.realtimeVoiceWakeWord.description`,
    `settings.general.realtimeVoiceWakeWord.ariaLabel`,
  ];
function mt(e) {
  let t = (0, Le.c)(11),
    n = d(),
    ...
    o = r?.platform === `darwin`,
    { data: s } = i(O, e.selectedHostId),
    c;
  t[0] === s ? (c = t[1]) : ((c = s === void 0 ? [] : s), (t[0] = s), (t[1] = c));
  let l = c,
    u;
  t[2] === l ? (u = t[3]) : ((u = l.filter(Fe).flatMap(vt)), (t[2] = l), (t[3] = u));
  let f = u,
    p;
  t[4] === n.locale
    ? (p = t[5])
    : ((p = [{ locale: I, language: `en` }, ...F().map(_t)].flatMap((e) => {
        let { language: t, locale: r } = e;
        return [P(r, r), P(t, n.locale)];
      })),
      (t[4] = n.locale),
      (t[5] = p));
  let m = p,
    h;
  return (
    t[6] !== f || t[7] !== o || t[8] !== a || t[9] !== m
      ? ((h = dt.map((e) =>
          e.sectionSlug === `appearance` && !a
            ? { ...e, messages: e.messages.filter(gt) }
            : e.sectionSlug === `agent`
              ? { ...e, terms: f }
              : e.sectionSlug === `general-settings`
                ? { ...e, messages: o ? e.messages : e.messages.filter(ht), terms: m }
                : e,
        )),
        (t[6] = f),
        (t[7] = o),
...
function ht(e) {
  return !pt.includes(e.id);
}
function gt(e) {
  return !ft.includes(e.id);
}
function _t(e) {
  return { locale: e.locale, language: e.locale };
}
function vt(e) {
  return [e.displayName ?? e.name, ...(e.description == null ? [] : [e.description])];
}
var yt = [
    `profile`,
    `agent`,
...
function xt(e, t, n) {
  let r = (0, Le.c)(46),
    ...
    s = n === void 0 ? l : n,
    c;
  r[0] === s ? (c = r[1]) : ((c = { hostId: s }), (r[0] = s), (r[1] = c));
  let u = j(c),
    d = L(),
    f = oe(),
    p;
  r[2] === s ? (p = r[3]) : ((p = { hostId: s }), (r[2] = s), (r[3] = p));
  let m = se(p),
    h;
  r[4] === s ? (h = r[5]) : ((h = { hostId: s }), (r[4] = s), (r[5] = h));
  let g = A(h),
    ee = ne(`3207467860`),
    _ = o(_e),
    te = b(),
    { isProfileVisible: v, isProfileVisibilityLoading: y } = he(),
    { isUsageSettingsVisible: x, isUsageSettingsAccessLoading: re } = ge(),
    S;
  r[6] === s ? (S = r[7]) : ((S = { hostId: s }), (r[6] = s), (r[7] = S));
  let C = k(S),
    ie = a && !g.isLoading && !g.allowed,
    ae =
      a &&
      !m.isLoading &&
      (m.reason === `statsig-disabled` || m.reason === `config-requirement-disabled`),
    w = a && (C.available || g.available || ie),
    T = a && (m.available || g.available || ae),
    E,
    D;
  if (
    r[8] !== _ ||
    ...
    r[30] !== x
      ? ((e = (e) => {
          if (!a && !yt.includes(e.slug)) return !1;
          switch (e.slug) {
            case `appshots`:
              return _;
      ...
      (D = U.filter(e)));
    let t;
    (r[32] === i ? (t = r[33]) : ((t = (e) => e.slug === i), (r[32] = i), (r[33] = t)),
      (E = D.find(t)),
      (r[8] = _),
      (r[9] = T),
      (r[10] = ee),
  ...
  let O = E,
    ...
    I;
  if (
    (r[34] !== a || r[35] !== i || r[36] !== O
      ? ((P = St(i)),
        (N = P != null && O == null),
        (M = a ? W : bt),
        (F = !1),
        (I = N && !(!a && !yt.includes(P.slug))),
        (r[34] = a),
        (r[35] = i),
        (r[36] = O),
        (r[37] = M),
        ...
        (r[40] = F),
        (r[41] = I))
      : ((M = r[37]), (N = r[38]), (P = r[39]), (F = r[40]), (I = r[41])),
    I)
  )
    bb0: switch (P.slug) {
      case `appshots`:
      ...
      case `codex-micro`:
        ...
        break bb0;
      case `computer-use`:
        F = C.isLoading || g.isLoading;
        break bb0;
      case `browser-use`:
        F = m.isLoading || g.isLoading || te;
        break bb0;
      case `local-environments`:
      case `worktrees`:
      case `environments`:
  ...
  let R = O?.slug ?? M,
    ...
    B;
  return (
    r[42] !== z || r[43] !== R || r[44] !== D
      ? ((B = {
          activeSettingsSection: R,
          shouldRedirectToVisibleSettingsSection: z,
          visibleSettingsSections: D,
        }),
        (r[42] = z),
        (r[43] = R),
        (r[44] = D),
...
function St(e) {
  return e == null ? null : (U.find((t) => t.slug === e) ?? null);
}
function Ct() {
  let e = (0, Le.c)(78),
    t = a(s),
    n = d(),
    { accountId: r, userId: i } = T(),
    u = ie(),
    f = C(),
    p = w(`/settings/:section/*`)?.params.section ?? null,
    {
      connectedRemoteConnections: g,
      remoteConnectionHostIds: _,
      selectedHostId: v,
      setSelectedHostId: y,
    } = ue(),
    ne = c(v).kind === `local`,
    {
      activeSettingsSection: b,
      shouldRedirectToVisibleSettingsSection: oe,
    ...
    A;
  e[0] !== k || e[1] !== u
    ? ((A = () => Dt(u, k)), (e[0] = k), (e[1] = u), (e[2] = A))
    : (A = e[2]);
  let j = A,
    M;
  e[3] === v ? (M = e[4]) : ((M = { selectedHostId: v }), (e[3] = v), (e[4] = M));
  let N = mt(M),
    P;
  e[5] !== g || e[6] !== n || e[7] !== _ || e[8] !== v || e[9] !== y
    ? ((P =
        g != null && g.length > 0 && _ != null
          ? (0, $.jsx)(Ie, {
              align: `start`,
              connectedRemoteConnections: g,
  ...
  let L = I,
    R;
  e[14] !== f.state || e[15] !== u || e[16] !== t
    ? ((R = (e) => {
        (e === `profile` && re(t, x, { source: `settings_page` }),
          u(`/settings/${e}`, { replace: !0, state: f.state }));
      }),
      (e[14] = f.state),
      (e[15] = u),
      (e[16] = t),
  ...
  let B;
  e[18] !== O || e[19] !== E
    ? ((B = O && E.some(Tt)), (e[18] = O), (e[19] = E), (e[20] = B))
    : (B = e[20]);
  let V;
  (e[21] !== r || e[22] !== B || e[23] !== i
    ? ((V = { accountId: r, enabled: B, userId: i }),
      (e[21] = r),
      (e[22] = B),
      (e[23] = i),
      (e[24] = V))
  ...
  (e[25] === t
    ? ((H = e[26]), (U = e[27]))
    : ((H = () => {
        t.query.invalidate(ye, { exact: !0 }).catch(wt);
      }),
      (U = [t]),
      (e[25] = t),
      (e[26] = H),
  ...
  if (
    ...
    return (
      e[32] === t
        ? (n = e[33])
        : ((n = (0, $.jsx)(S, { to: t, replace: !0 })), (e[32] = t), (e[33] = n)),
      n
    );
  }
  if (D) {
    ...
    e[41] !== E
      ...
      : (t = e[42]);
    let n;
    e[43] === f.hash ? (n = e[44]) : ((n = f.hash.slice(1) || null), (e[43] = f.hash), (e[44] = n));
    let r;
    ...
    e[46] === v
      ? (i = e[47])
      : ((i = (0, $.jsx)(Re.Suspense, { fallback: r, children: (0, $.jsx)(ae, {}, v) })),
        (e[46] = v),
        (e[47] = i));
    let a;
    e[48] !== f.key || e[49] !== n || e[50] !== i
      ? ((a = (0, $.jsx)(`div`, {
          className: `h-full min-w-0 overflow-visible`,
          children: (0, $.jsx)(De, { navigationKey: f.key, targetId: n, children: i }),
        })),
        (e[48] = f.key),
        (e[49] = n),
        (e[50] = i),
    ...
    return (
      e[52] !== t || e[53] !== a
        ? ((o = (0, $.jsxs)(te.Root, { children: [t, a] })), (e[52] = t), (e[53] = a), (e[54] = o))
        : (o = e[54]),
      o
    );
  }
  ...
  e[56] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((le = m(
      ...
      (J = (0, $.jsx)(`div`, { className: `draggable h-toolbar w-full shrink-0` })),
      (e[56] = le),
      (e[57] = J))
    : ((le = e[56]), (J = e[57]));
  let Y = j,
  ...
  e[64] !== E
    ...
    : (X = e[65]);
  let Z;
  e[66] === f.hash ? (Z = e[67]) : ((Z = f.hash.slice(1) || null), (e[66] = f.hash), (e[67] = Z));
  let Q;
  ...
  e[69] === v
    ? (de = e[70])
    : ((de = (0, $.jsx)(Re.Suspense, { fallback: Q, children: (0, $.jsx)(ae, {}, v) })),
      (e[69] = v),
      (e[70] = de));
  let fe;
  e[71] !== f.key || e[72] !== Z || e[73] !== de
    ? ((fe = (0, $.jsx)(`div`, {
        className: `relative isolate min-w-0 flex-1 overflow-visible`,
        children: (0, $.jsx)(De, { navigationKey: f.key, targetId: Z, children: de }),
      })),
      (e[71] = f.key),
      (e[72] = Z),
      (e[73] = de),
