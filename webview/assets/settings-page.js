...
function wn(e, t, n) {
  ...
  let c = null;
  for (let e of r) {
    let r = Math.max(nt(e, t), ...n.map((t) => nt(e, t)));
...
function Tn(e, t) {
  let n = t.map((t) => Math.max(0, ...e.map((e) => nt(e, t))));
...
function En(e, t) {
  ...
  let i = {
    ...
    panelLabel: e.formatMessage(qt(t.sectionSlug)),
...
function kn(e) {
  let t = (0, Bn.c)(95),
    ...
    g = le(),
    ee = J(qn),
    [te, _] = (0, Vn.useState)(!1),
    [v, y] = (0, Vn.useState)(``),
    b = p && te,
    x = ee && m && !b,
    S;
  t[0] !== v || t[1] !== x
    ? ((S = x && v.trim().length > 0), (t[0] = v), (t[1] = x), (t[2] = S))
    : (S = t[2]);
  let C = S,
    w,
    T;
  t[3] !== g || t[4] !== v || t[5] !== h || t[6] !== n
    ? ((w = Cn({ intl: g, query: v, targets: h, visibleSectionSlugs: n.flatMap(Fn) })),
      (T = w.map(Pn).join(`\0`)),
      (t[3] = g),
      (t[4] = v),
      (t[5] = h),
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ie = t[14]);
  let k;
  t[15] !== ne || t[16] !== O || t[17] !== re
    ? ((k = { items: ne, isActive: O, autoHighlightFirst: !1, onSelect: re, onEscape: ie }),
      (t[15] = ne),
      (t[16] = O),
      (t[17] = re),
      (t[18] = k))
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (M = t[20]);
  let N = M,
    P = b ? Yn.collapsed : Yn.expanded,
    F;
  t[21] !== P.message || t[22] !== g
    ? ((F = g.formatMessage(P.message)), (t[21] = P.message), (t[22] = g), (t[23] = F))
    : (F = t[23]);
  let se = F,
    I = P.icon,
    L,
  ...
  if (
    ...
    (t[51] === a
      ? (W = t[52])
      : ((W = s(`flex min-h-0 flex-1 flex-col select-none px-row-x`, a)), (t[51] = a), (t[52] = W)),
      t[53] === g
        ? (G = t[54])
        : ((G = g.formatMessage({
      ...
      t[55] !== I || t[56] !== p || t[57] !== se || t[58] !== P.message
        ? ((B = p
            ? (0, Q.jsx)(`div`, {
                className: `mb-2 shrink-0`,
                children: (0, Q.jsx)(ue, {
                  tooltipContent: (0, Q.jsx)(Z, { ...P.message }),
                  children: (0, Q.jsx)(Qt, {
                    "aria-label": se,
                    fullWidth: !1,
                    icon: I,
      ...
      t[63] !== b || t[64] !== f
        ? ((H =
          ...
          (t[65] = H))
        : (H = t[65]),
      t[66] !== A || t[67] !== v || t[68] !== x
        ? ((U = x
            ? (0, Q.jsx)(In, {
                onKeyDown: A.getInputProps().onKeyDown,
                searchQuery: v,
                onQueryChange: (e) => {
                  (A.setHighlightedIndex(-1), y(e));
                },
              })
            : null),
          (t[66] = A),
          ...
          (t[69] = U))
        : (U = t[69]));
    let l = b ? `flex flex-col gap-2` : `flex flex-col gap-4`;
    (t[70] === l
      ? (L = t[71])
      : ((L = s(`min-h-0 flex-1 overflow-y-auto pb-2`, l)), (t[70] = l), (t[71] = L)),
      (R = C
        ? (0, Q.jsx)(Ln, {
            intl: g,
        ...
        : e.map((e) =>
            (0, Q.jsx)(
              ...
              {
                className: `gap-0`,
                title: b || e.heading == null ? null : (0, Q.jsx)(Z, { ...e.heading }),
                children: e.sections.map((e) => {
                  let t = e.slug === r,
                    n = !!e.externalUrl,
                    a = !!e.disabled,
                    o = t && e.slug === `pets` ? vn : Hn[e.slug],
                    s = g.formatMessage(qt(e.slug)),
                    l = (t) => {
                      if (!a) {
                        if (n && e.externalUrl) {
                          ve({
                  ...
                  return (0, Q.jsx)(
                    ue,
                    {
                      tooltipContent: b ? (0, Q.jsx)(Ht, { slug: e.slug }) : n ? N : ae,
                      side: `right`,
                      sideOffset: 12,
                      disabled: !b && !a && !n,
                      children: (0, Q.jsx)(Qt, {
                        ...
                        label: (0, Q.jsx)(Ht, { slug: e.slug }),
                        trailing:
                          !b && e.externalUrl != null
                            ? (0, Q.jsx)(ce, {
    ...
    ((L = t[42]),
      ...
      (G = t[50]));
  let K;
  t[72] !== p || t[73] !== b || t[74] !== g || t[75] !== C
    ? ((K = C
        ? null
        : (0, Q.jsx)(ue, {
            tooltipContent: b ? (0, Q.jsx)(Z, { ...Un.chatSettings }) : N,
            side: `right`,
            sideOffset: 12,
            children: (0, Q.jsx)(Qt, {
  ...
  t[77] === u
    ...
    : ((q =
      ...
      (t[78] = q));
  let Y;
  t[79] !== L || t[80] !== R || t[81] !== K || t[82] !== q
    ? ((Y = (0, Q.jsxs)(`div`, { className: L, children: [R, K, q] })),
      (t[79] = L),
      (t[80] = R),
      (t[81] = K),
      (t[82] = q),
    ...
    : (Y = t[83]);
  let X;
  t[84] !== z || t[85] !== B || t[86] !== V || t[87] !== H || t[88] !== U || t[89] !== Y
  ...
  return (
    t[91] !== W || t[92] !== G || t[93] !== X
      ? ((de = (0, Q.jsx)(`nav`, { className: W, "aria-label": G, children: X })),
        (t[91] = W),
        (t[92] = G),
        (t[93] = X),
        (t[94] = de))
...
function An(e) {
  ve({ event: e, href: Jn, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
}
function jn(e) {
  return !e;
}
...
function Ln(e) {
  ...
  return (
    t[10] !== i || t[11] !== c
      ? ((l = (0, Q.jsx)(`div`, { ref: i, className: `flex flex-col gap-3 pt-1`, children: c })),
        (t[10] = i),
        (t[11] = c),
        (t[12] = l))
      : (l = t[12]),
...
var Bn,
  ...
  Xn = e(() => {
    ((Bn = q()),
      ...
      (Yn = {
        collapsed: { icon: Ce, message: Un.expandSidebar },
        expanded: { icon: Ee, message: Un.collapseSidebar },
      }));
  }),
  Zn,
  Qn = e(() => {
...
function $n(e) {
  ...
  t[4] === n.locale
    ? (d = t[5])
    : ((d = [{ locale: Ct, language: `en` }, ...Mt().map(tr)].flatMap((e) => {
        let { language: t, locale: r } = e;
        return [kt(r, r), kt(t, n.locale)];
      })),
      (t[4] = n.locale),
      (t[5] = d));
  let f = d,
...
var rr,
  ...
  or = e(() => {
    ((rr = q()),
      ...
      h(),
      dn(),
      (ir = ze.map((e) => ({ messages: Zn[e] ?? [], sectionSlug: e }))),
      (ar = [
...
function sr(e = null, t = !0, n = ie) {
  ...
  let c = J(et),
    l = v(rn),
    u = N(),
    { isProfileVisible: d, isProfileVisibilityLoading: f } = Qe(),
    { isUsageSettingsVisible: p, isUsageSettingsAccessLoading: m } = qe(),
    h = a({ hostId: n }),
    g = t && !s.isLoading && !s.allowed,
    ee =
      t &&
      !o.isLoading &&
    ...
    te = t && (h.available || s.available || g),
    _ = t && (o.available || s.available || ee),
    y = Ge.filter((e) => {
  ...
  if (S && !(!t && !lr.includes(x.slug)))
    switch (x.slug) {
      ...
      case `codex-micro`:
        ...
        break;
      case `computer-use`:
        T = h.isLoading || s.isLoading;
        break;
      case `browser-use`:
        T = o.isLoading || s.isLoading || u;
        break;
      case `local-environments`:
      case `worktrees`:
      case `environments`:
  ...
  return {
    ...
    shouldRedirectToVisibleSettingsSection: S && !T,
    shouldRenderRouteContent: e !== `import` || !T,
    visibleSettingsSections: y,
  };
}
function cr(e) {
  return e == null ? null : (Ge.find((t) => t.slug === e) ?? null);
}
var lr,
  ur,
  dr = e(() => {
...
function fr() {
  let e = (0, gr.c)(78),
    ...
    r = T(),
    i = p(),
    a = f(`/settings/:section/*`)?.params.section ?? null,
    {
    ...
    d = te(l).kind === `local`,
    {
      activeSettingsSection: h,
      shouldRedirectToVisibleSettingsSection: g,
    ...
    S;
  e[0] !== b || e[1] !== r
    ? ((S = () => hr(r, b)), (e[0] = b), (e[1] = r), (e[2] = S))
    : (S = e[2]);
  let C = S,
    w;
  e[3] === l ? (w = e[4]) : ((w = { selectedHostId: l }), (e[3] = l), (e[4] = w));
  let E = $n(w),
    D;
  e[5] !== o || e[6] !== n || e[7] !== c || e[8] !== l || e[9] !== u
    ? ((D =
        o != null && o.length > 0 && c != null
          ? (0, $.jsx)(pn, {
              align: `start`,
              connectedRemoteConnections: o,
  ...
  e[15] !== l || e[16] !== ee
    ? ((oe = ee
        ? (0, $.jsx)(_r.Suspense, { fallback: (0, $.jsx)(He, {}), children: (0, $.jsx)(se, {}, l) })
        : (0, $.jsx)(He, {})),
      (e[15] = l),
      (e[16] = ee),
      (e[17] = oe))
  ...
  e[18] !== i.state || e[19] !== r || e[20] !== t
    ? ((P = (e) => {
        (e === `profile` && re(t, U, { source: `settings_page` }),
  ...
  e[27] === t.query
    ? (z = e[28])
    : ((z = () => {
        t.query.invalidate(de, { exact: !0 }).catch(pr);
      }),
      (e[27] = t.query),
      (e[28] = z));
  let B;
  (e[29] === t ? (B = e[30]) : ((B = [t]), (e[29] = t), (e[30] = B)), (0, _r.useEffect)(z, B));
  let V, H;
  if (
    (e[31] !== b || e[32] !== r
      ? ((V = () => {
    ...
    return (
      e[35] === t
        ? (n = e[36])
        : ((n = (0, $.jsx)(_e, { to: t, replace: !0 })), (e[35] = t), (e[36] = n)),
      n
    );
  }
  if (y) {
    ...
    e[44] !== _
      ...
      : (t = e[45]);
    let n;
    e[46] === i.hash ? (n = e[47]) : ((n = i.hash.slice(1) || null), (e[46] = i.hash), (e[47] = n));
    let r;
    e[48] !== i.key || e[49] !== N || e[50] !== n
      ? ((r = (0, $.jsx)(`div`, {
          className: `h-full min-w-0 overflow-visible`,
          children: (0, $.jsx)(Xe, { navigationKey: i.key, targetId: n, children: N }),
        })),
        (e[48] = i.key),
        (e[49] = N),
        (e[50] = n),
    ...
    return (
      e[52] !== t || e[53] !== r
        ? ((a = (0, $.jsxs)(xe.Root, { children: [t, r] })), (e[52] = t), (e[53] = r), (e[54] = a))
        : (a = e[54]),
      a
    );
  }
  ...
  e[56] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = s(
      ...
      (K = (0, $.jsx)(`div`, { className: `draggable h-toolbar w-full shrink-0` })),
      (e[56] = G),
      (e[57] = K))
    : ((G = e[56]), (K = e[57]));
  let ue = C,
  ...
  e[64] !== _
    ...
    : (q = e[65]);
  let J;
  e[66] === i.hash ? (J = e[67]) : ((J = i.hash.slice(1) || null), (e[66] = i.hash), (e[67] = J));
  let Y;
  e[68] !== i.key || e[69] !== N || e[70] !== J
    ? ((Y = (0, $.jsx)(Xe, { navigationKey: i.key, targetId: J, children: N })),
      (e[68] = i.key),
      (e[69] = N),
      (e[70] = J),
      (e[71] = Y))
  ...
  return (
    e[75] !== q || e[76] !== X
      ? ((Z = (0, $.jsxs)(`div`, { className: `flex h-full min-h-0`, style: W, children: [q, X] })),
        (e[75] = q),
        (e[76] = X),
        (e[77] = Z))
      : (Z = e[77]),
