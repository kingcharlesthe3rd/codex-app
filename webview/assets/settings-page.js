...
import { _t as Le, gt as Re, vt as ze } from "./app-initial~app-main~automations-page.js";
import {
  h as Be,
  l as Ve,
  m as He,
...
import {
  ...
  r as zt,
  t as Bt,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~setting~gyb0033j.js";
import {
  H as Vt,
  U as Ht,
...
import {
  n as qt,
  t as Jt,
} from "./app-initial~app-main~remote-conversation-page~settings-page~hotkey-window-thread-page~usage~hc2m5m0u.js";
import {
  i as Yt,
  r as Xt,
...
function En(e, t) {
  ...
  let i = {
    ...
    panelLabel: e.formatMessage($t(t.sectionSlug)),
...
function kn(e) {
  ...
  t[3] !== h || t[4] !== _ || t[5] !== m || t[6] !== n
    ? ((S = Cn({ intl: h, query: _, targets: m, visibleSectionSlugs: n.flatMap(Fn) })),
      (C = S.map(Pn).join(`\0`)),
      (t[3] = h),
      (t[4] = _),
      (t[5] = m),
  ...
  let w = C,
    T;
  t[9] === w ? (T = t[10]) : ((T = w.length === 0 ? [] : w.split(`\0`)), (t[9] = w), (t[10] = T));
  let E = T,
    D = y && _.length > 0,
    O;
  t[11] !== i || t[12] !== S
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (k = t[14]);
  let A;
  t[15] !== E || t[16] !== D || t[17] !== O
    ? ((A = { items: E, isActive: D, autoHighlightFirst: !1, onSelect: O, onEscape: k }),
      (t[15] = E),
      (t[16] = D),
      (t[17] = O),
      (t[18] = A))
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (P = t[20]);
  let F = P,
    I = v ? Yn.collapsed : Yn.expanded,
    L;
  t[21] !== I.message || t[22] !== h
    ? ((L = h.formatMessage(I.message)), (t[21] = I.message), (t[22] = h), (t[23] = L))
    : (L = t[23]);
  let R = L,
    z = I.icon,
    B,
  ...
  if (
    ...
    (t[51] === a
      ? (q = t[52])
      : ((q = oe(`flex min-h-0 flex-1 flex-col select-none px-row-x`, a)),
        (t[51] = a),
        (t[52] = q)),
      t[53] === h
        ? (J = t[54])
      ...
      t[55] !== z || t[56] !== f || t[57] !== R || t[58] !== I.message
        ? ((U = f
            ? (0, Q.jsx)(`div`, {
      ...
      t[63] !== v || t[64] !== d
        ? ((G =
          ...
          (t[65] = G))
        : (G = t[65]),
      t[66] !== j || t[67] !== _ || t[68] !== y
        ? ((K = y
            ? (0, Q.jsx)(In, {
                onKeyDown: j.getInputProps().onKeyDown,
                searchQuery: _,
                onQueryChange: (e) => {
                  (j.setHighlightedIndex(-1), ne(e));
                },
              })
            : null),
          (t[66] = j),
    ...
    (t[70] === c
      ? (B = t[71])
      : ((B = oe(`min-h-0 flex-1 overflow-y-auto pb-2`, c)), (t[70] = c), (t[71] = B)),
      (V = x
        ? (0, Q.jsx)(Ln, {
            intl: h,
        ...
        : e.map((e) =>
            (0, Q.jsx)(
              ...
              {
                className: `gap-0`,
                title: v || e.heading == null ? null : (0, Q.jsx)(Z, { ...e.heading }),
                children: e.sections.map((e) => {
                  let t = e.slug === r,
                    n = !!e.externalUrl,
                    a = !!e.disabled,
                    o = t && e.slug === `pets` ? vn : Hn[e.slug],
                    c = h.formatMessage($t(e.slug)),
                    l = (t) => {
                      if (!a) {
                        if (n && e.externalUrl) {
                          le({
                  ...
                  return (0, Q.jsx)(
                    ie,
                    {
                      tooltipContent: v ? (0, Q.jsx)(Qt, { slug: e.slug }) : n ? F : N,
                      side: `right`,
                      sideOffset: 12,
                      disabled: !v && !a && !n,
                      children: (0, Q.jsx)(ot, {
  ...
  t[72] !== f || t[73] !== v || t[74] !== h || t[75] !== x
    ? ((Y = x
        ? null
        : (0, Q.jsx)(ie, {
            tooltipContent: v ? (0, Q.jsx)(Z, { ...Un.chatSettings }) : F,
            side: `right`,
            sideOffset: 12,
            children: (0, Q.jsx)(ot, {
  ...
  t[79] !== B || t[80] !== V || t[81] !== Y || t[82] !== X
    ? ((se = (0, Q.jsxs)(`div`, { className: B, children: [V, Y, X] })),
      (t[79] = B),
      (t[80] = V),
      (t[81] = Y),
      (t[82] = X),
    ...
    : (se = t[83]);
  let ce;
  t[84] !== H || t[85] !== U || t[86] !== W || t[87] !== G || t[88] !== K || t[89] !== se
    ? ((ce = (0, Q.jsxs)(`div`, { className: H, children: [U, W, G, K, se] })),
      (t[84] = H),
      (t[85] = U),
      (t[86] = W),
      (t[87] = G),
  ...
  let ue;
  return (
    t[91] !== q || t[92] !== J || t[93] !== ce
      ? ((ue = (0, Q.jsx)(`nav`, { className: q, "aria-label": J, children: ce })),
        (t[91] = q),
        (t[92] = J),
        (t[93] = ce),
        (t[94] = ue))
...
function An(e) {
  le({ event: e, href: Jn, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
}
function jn(e) {
  return !e;
}
...
var Bn,
  ...
  Xn = e(() => {
    ((Bn = r()),
      ...
      (Yn = {
        collapsed: { icon: _, message: Un.expandSidebar },
        expanded: { icon: g, message: Un.collapseSidebar },
      }));
  }),
  Zn,
  Qn = e(() => {
...
function $n(e) {
  let t = (0, rr.c)(11),
    ...
    o = r?.platform === `darwin`,
    { data: s } = a(mt, e.selectedHostId),
    c;
  t[0] === s ? (c = t[1]) : ((c = s === void 0 ? [] : s), (t[0] = s), (t[1] = c));
  let l = c,
    u;
  t[2] === l ? (u = t[3]) : ((u = l.filter(un).flatMap(nr)), (t[2] = l), (t[3] = u));
  let d = u,
    f;
  t[4] === n.locale
    ? (f = t[5])
    : ((f = [{ locale: Ye, language: `en` }, ...Qe().map(tr)].flatMap((e) => {
        let { language: t, locale: r } = e;
        return [Ze(r, r), Ze(t, n.locale)];
      })),
      (t[4] = n.locale),
      (t[5] = f));
  let p = f,
...
var rr,
  ...
  or = e(() => {
    ((rr = r()),
      ...
      pt(),
      dn(),
      (ir = wt.map((e) => ({ messages: Zn[e] ?? [], sectionSlug: e }))),
      (ar = [
...
function sr(e = null, t = !0, n = Ie) {
  ...
  let s = xe(Pt),
    l = c(Yt),
    u = Ce(),
    { isProfileVisible: d, isProfileVisibilityLoading: f } = Et(),
    { isUsageSettingsVisible: p, isUsageSettingsAccessLoading: m } = qt(),
    h = M({ hostId: n }),
    ...
    te = t && (h.available || o.available || g),
    _ = t && (a.available || o.available || ee),
    ne = Ct.filter((e) => {
...
function cr(e) {
  return e == null ? null : (Ct.find((t) => t.slug === e) ?? null);
}
var lr,
  ur,
  dr = e(() => {
...
function fr() {
  let e = (0, gr.c)(78),
    ...
    i = Oe(),
    a = we(),
    o = ye(`/settings/:section/*`)?.params.section ?? null,
    {
      connectedRemoteConnections: l,
      remoteConnectionHostIds: u,
      selectedHostId: f,
      setSelectedHostId: m,
    } = at(),
    h = Fe(f).kind === `local`,
    ...
    S;
  e[0] !== b || e[1] !== i
    ? ((S = () => hr(i, b)), (e[0] = b), (e[1] = i), (e[2] = S))
    : (S = e[2]);
  let C = S,
    w;
  e[3] === f ? (w = e[4]) : ((w = { selectedHostId: f }), (e[3] = f), (e[4] = w));
  let T = $n(w),
    E;
  e[5] !== l || e[6] !== r || e[7] !== u || e[8] !== f || e[9] !== m
    ? ((E =
        l != null && l.length > 0 && u != null
          ? (0, $.jsx)(pn, {
              align: `start`,
              connectedRemoteConnections: l,
  ...
  e[15] !== f || e[16] !== te
    ? ((M = te
        ? (0, $.jsx)(_r.Suspense, { fallback: (0, $.jsx)(Re, {}), children: (0, $.jsx)(pe, {}, f) })
        : (0, $.jsx)(Re, {})),
      (e[15] = f),
      (e[16] = te),
      (e[17] = M))
  ...
  e[18] !== a.state || e[19] !== i || e[20] !== t
    ? ((P = (e) => {
        (e === `profile` && ve(t, he, { source: `settings_page` }),
  ...
  e[27] === t.query
    ? (V = e[28])
    : ((V = () => {
        t.query.invalidate($e, { exact: !0 }).catch(pr);
      }),
      (e[27] = t.query),
      (e[28] = V));
  let H;
  (e[29] === t ? (H = e[30]) : ((H = [t]), (e[29] = t), (e[30] = H)), (0, _r.useEffect)(V, H));
  let re, U;
  if (
    (e[31] !== b || e[32] !== i
      ? ((re = () => {
    ...
    return (
      e[35] === t
        ? (n = e[36])
        : ((n = (0, $.jsx)(ge, { to: t, replace: !0 })), (e[35] = t), (e[36] = n)),
      n
    );
  }
  if (ne) {
    ...
    let r;
    e[48] !== a.key || e[49] !== N || e[50] !== n
      ? ((r = (0, $.jsx)(`div`, {
          className: `h-full min-w-0 overflow-visible`,
          children: (0, $.jsx)(Le, { navigationKey: a.key, targetId: n, children: N }),
        })),
        (e[48] = a.key),
        (e[49] = N),
        (e[50] = n),
    ...
    return (
      e[52] !== t || e[53] !== r
        ? ((i = (0, $.jsxs)(d.Root, { children: [t, r] })), (e[52] = t), (e[53] = r), (e[54] = i))
        : (i = e[54]),
      i
    );
  }
  ...
  e[64] !== _
    ...
    : (K = e[65]);
  let q;
  e[66] === a.hash ? (q = e[67]) : ((q = a.hash.slice(1) || null), (e[66] = a.hash), (e[67] = q));
  let J;
  e[68] !== a.key || e[69] !== N || e[70] !== q
    ? ((J = (0, $.jsx)(Le, { navigationKey: a.key, targetId: q, children: N })),
      (e[68] = a.key),
      (e[69] = N),
      (e[70] = q),
      (e[71] = J))
