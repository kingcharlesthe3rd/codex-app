...
import { ds as c, us as l } from "./app-server-manager-signals.js";
import "./vscode-api.js";
import "./isEqual.js";
import "./src-1.js";
import "./react-dom.js";
import { c as ee, n as u, o as d, r as f } from "./lib.js";
import { Cn as p, o as m } from "./persisted-signal.js";
import { t as h } from "./clsx-Cir5-jBH.js";
import "./proxy.js";
import { u as g } from "./app-shell-state.js";
import { c as _, m as te, s as v, t as ne } from "./app-shell.js";
...
import "./rpc-1.js";
import { o as re, u as b } from "./statsig.js";
import "./request.js";
...
import { n as x } from "./remote-connection-visibility.js";
import "./sidebar-signals.js";
import "./use-is-copilot-api-available.js";
import "./use-global-state.js";
import { t as S } from "./use-auth.js";
import { t as C } from "./use-os-info.js";
import "./toast-signal.js";
import "./remote-projects.js";
import "./chevron.js";
import "./core.esm.js";
import { a as ie, f as ae, m as w, o as T, p as E } from "./chunk-109.js";
...
import { t as k } from "./apps.js";
import "./info.js";
import { t as A } from "./x.js";
import "./projectless-thread.js";
import "./use-platform.js";
import { i as oe, n as j, r as M, t as N } from "./use-is-plugins-enabled.js";
...
import { t as V } from "./codex-Cx4-XOqq.js";
...
import { i as G, n as ce, r as le, t as K } from "./settings-back-route.js";
import "./links.js";
import "./badge.js";
import { t as q } from "./search.js";
import "./dropdown.js";
import { t as J } from "./globe.js";
import { t as Y } from "./face.js";
import { t as X } from "./archive.js";
import "./remote-host-globe-icon.js";
import { t as Z } from "./worktree.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as ue } from "./settings-host-context.js";
import "./laptop.js";
import { t as Q } from "./avatar.js";
import { t as de } from "./speedometer.js";
import { n as fe, r as pe } from "./profile-queries.js";
import { n as me } from "./profile-visibility.js";
import { t as he } from "./appshot-availability-BoK-Z77O.js";
import { t as ge } from "./arrow-top-right.js";
import { n as _e } from "./computer-use-app-approvals-query.js";
import { t as ve } from "./appshot-window.js";
import { t as ye } from "./shield-code.js";
import { a as be, n as xe } from "./settings-shared.js";
import { t as Se } from "./score-query-match-CZO-nWKm.js";
import { t as Ce } from "./use-hotkey.js";
import { t as we } from "./list-navigation.js";
import { n as Te, t as Ee } from "./settings-content-layout.js";
import { t as De } from "./sun.js";
import { t as Oe } from "./hooks.js";
import { t as ke } from "./settings-host-dropdown.js";
import { t as Ae } from "./cursor.js";
import { t as je } from "./dock.js";
import { t as Me } from "./app-window.js";
import { t as Ne } from "./experimental-feature-visibility.js";
...
var Fe = r(),
  ...
  Re = new WeakMap();
function ze({ intl: e, query: t, targets: n, visibleSectionSlugs: r }) {
...
function Be(e, t, n) {
  ...
  let c = null;
  for (let e of r) {
    let r = Math.max(Se(e, t), ...n.map((t) => Se(e, t)));
...
function Ve(e, t) {
  let n = t.map((t) => Math.max(0, ...e.map((e) => Se(e, t))));
  return n.length === 0 || n.some((e) => e === 0) ? 0 : n.reduce((e, t) => e + t, 0);
}
function He(e, t) {
  let n = Re.get(e);
  n ?? ((n = new WeakMap()), Re.set(e, n));
  let r = n.get(t);
  if (r != null) return r;
  let i = {
    messageTexts: [
    ...
    panelLabel: e.formatMessage(be(t.sectionSlug)),
...
var Ue = {
  ...
  Je = `1785186884`,
  Ye = {
    collapsed: { icon: v, message: We.expandSidebar },
    expanded: { icon: _, message: We.collapseSidebar },
  };
function Xe(e) {
  let t = (0, Fe.c)(89),
    {
    ...
    _ = ee(),
    te = re(Je),
    [v, ne] = (0, Ie.useState)(!1),
    [b, x] = (0, Ie.useState)(``),
    S = p && v,
    C = te && m && !S,
    ie;
  t[0] !== b || t[1] !== C
    ? ((ie = C && b.trim().length > 0), (t[0] = b), (t[1] = C), (t[2] = ie))
    : (ie = t[2]);
  let ae = ie,
    w,
    T;
  t[3] !== _ || t[4] !== b || t[5] !== g || t[6] !== n
    ? ((w = ze({ intl: _, query: b, targets: g, visibleSectionSlugs: n.flatMap(tt) })),
      (T = w.map(et).join(`\0`)),
      (t[3] = _),
      (t[4] = b),
      (t[5] = g),
  ...
  let E = T,
    D;
  t[9] === E ? (D = t[10]) : ((D = E.length === 0 ? [] : E.split(`\0`)), (t[9] = E), (t[10] = D));
  let O = D,
    k = C && b.length > 0,
    A;
  t[11] !== i || t[12] !== w
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (oe = t[14]);
  let j;
  t[15] !== O || t[16] !== k || t[17] !== A
    ? ((j = { items: O, isActive: k, autoHighlightFirst: !1, onSelect: A, onEscape: oe }),
      (t[15] = O),
      (t[16] = k),
      (t[17] = A),
      (t[18] = j))
  ...
  if (
    ...
    let e = [{ key: `settings`, heading: null, sections: at(n, Ge) }];
    m && (e = it(n, Ke));
    let s = e.flatMap(Qe);
    (t[51] === a
      ? (J = t[52])
      : ((J = h(`flex min-h-0 flex-1 flex-col select-none px-row-x`, a)), (t[51] = a), (t[52] = J)),
      t[53] === _
        ? (Y = t[54])
        : ((Y = _.formatMessage({
      ...
      t[55] !== B || t[56] !== p || t[57] !== z || t[58] !== L.message
        ? ((W = p
            ? (0, $.jsx)(`div`, {
                className: `mb-2 shrink-0`,
                children: (0, $.jsx)(y, {
                  tooltipContent: (0, $.jsx)(d, { ...L.message }),
                  children: (0, $.jsx)(ce, {
                    "aria-label": z,
                    fullWidth: !1,
                    icon: B,
      ...
      t[63] !== S || t[64] !== f
        ? ((K =
          ...
          (t[65] = K))
        : (K = t[65]),
      t[66] !== M || t[67] !== b || t[68] !== C
        ? ((q = C
            ? (0, $.jsx)(nt, {
                onKeyDown: M.getInputProps().onKeyDown,
                searchQuery: b,
                onQueryChange: (e) => {
                  (M.setHighlightedIndex(-1), x(e));
                },
              })
            : null),
          (t[66] = M),
    ...
    (t[70] === c
      ? (V = t[71])
      : ((V = h(`min-h-0 flex-1 overflow-y-auto pb-2`, c)), (t[70] = c), (t[71] = V)),
      (H = ae
        ? (0, $.jsx)(rt, {
            intl: _,
        ...
        : e.map((e) =>
            (0, $.jsx)(
              ...
              {
                className: `gap-0`,
                title: S || e.heading == null ? null : (0, $.jsx)(d, { ...e.heading }),
                children: e.sections.map((e) => {
                  let t = e.slug === r,
                    n = !!e.externalUrl,
                    a = !!e.disabled,
                    o = Ue[e.slug],
                    c = _.formatMessage(be(e.slug)),
                    l = () => {
                      if (!a) {
                        if (n && e.externalUrl) {
                  ...
                  return (0, $.jsx)(
                    y,
                    {
                      tooltipContent: S ? (0, $.jsx)(xe, { slug: e.slug }) : n ? I : P,
                      side: `right`,
                      sideOffset: 12,
                      disabled: !S && !a && !n,
                      children: (0, $.jsx)(ce, {
                        ...
                        isActive: t,
                        disabled: a,
                        "data-settings-panel-slug": m && !a && !n ? e.slug : void 0,
                        hideLabel: p ? S : void 0,
                        onClick: l,
                        onKeyDown:
                          m && !a && !n
                            ? (t) => {
  ...
  t[78] !== U || t[79] !== W || t[80] !== G || t[81] !== K || t[82] !== q || t[83] !== Z
    ? ((ue = (0, $.jsxs)(`div`, { className: U, children: [W, G, K, q, Z] })),
      (t[78] = U),
      (t[79] = W),
      (t[80] = G),
      (t[81] = K),
  ...
  let Q;
  return (
    t[85] !== J || t[86] !== Y || t[87] !== ue
      ? ((Q = (0, $.jsx)(`nav`, { className: J, "aria-label": Y, children: ue })),
        (t[85] = J),
        (t[86] = Y),
        (t[87] = ue),
        (t[88] = Q))
    ...
    ? ((p =
        r.length > 0
          ? (0, $.jsx)(`button`, {
              ...
              type: `button`,
              children: (0, $.jsx)(A, { className: `icon-2xs` }),
            })
          : null),
      (t[14] = a),
      (t[15] = i),
...
var ot = {
    ...
    "browser-use": [
      ...
      { defaultMessage: `Data`, id: `settings.browserUse.browser.title` },
      {
      ...
      { defaultMessage: `Import browser data`, id: `settings.browserUse.profileImport.title` },
      {
    ...
    "general-settings": [
      ...
      { defaultMessage: `Default open destination`, id: `settings.ide.defaultOpenTarget.label` },
    ...
    "keyboard-shortcuts": [
      ...
      { defaultMessage: `Next recently viewed chat or tab`, id: `codex.command.nextRecentThread` },
      { defaultMessage: `Next chat or tab`, id: `codex.command.nextThread` },
      ...
      {
        defaultMessage: `Previous recently viewed chat or tab`,
        id: `codex.command.previousRecentThread`,
      },
      { defaultMessage: `Previous chat or tab`, id: `codex.command.previousThread` },
      ...
      {
        defaultMessage: `Cycle to the next recently viewed chat or tab`,
      ...
      { defaultMessage: `Open a browser tab`, id: `codex.commandDescription.openBrowserTab` },
      ...
      {
        defaultMessage: `Cycle to the previous recently viewed chat or tab`,
      ...
      { defaultMessage: `Close`, id: `codex.commandMenuTitle.closeTabOrWindow` },
      ...
      { defaultMessage: `Next Chat or Tab`, id: `codex.commandMenuTitle.nextThread` },
      ...
      { defaultMessage: `Previous Chat or Tab`, id: `codex.commandMenuTitle.previousThread` },
    ...
    usage: [
      ...
      { defaultMessage: `Cancel`, id: `settings.usage.creditReload.cancel` },
      {
  ...
  st = H.map((e) => ({ messages: ot[e] ?? [], sectionSlug: e })),
  ct = [
...
function lt(e) {
  let t = (0, Fe.c)(10),
    ...
    { data: o } = i(O, e.selectedHostId),
    s;
  t[0] === o ? (s = t[1]) : ((s = o === void 0 ? [] : o), (t[0] = o), (t[1] = s));
  let c = s,
    l;
  t[2] === c ? (l = t[3]) : ((l = c.filter(Ne).flatMap(ft)), (t[2] = c), (t[3] = l));
  let u = l,
    d;
  t[4] === n.locale
    ? (d = t[5])
    : ((d = [{ locale: I, language: `en` }, ...F().map(dt)].flatMap((e) => {
    ...
    t[6] !== u || t[7] !== a || t[8] !== f
      ? ((p = st.map((e) =>
          e.sectionSlug === `appearance` && !a
            ? { ...e, messages: e.messages.filter(ut) }
            : e.sectionSlug === `agent`
              ? { ...e, terms: u }
...
function ht(e, t, n) {
  let r = (0, Fe.c)(46),
    ...
    s = n === void 0 ? c : n,
    l;
  r[0] === s ? (l = r[1]) : ((l = { hostId: s }), (r[0] = s), (r[1] = l));
  let ee = N(l),
    u = L(),
    d = x(),
    f;
  r[2] === s ? (f = r[3]) : ((f = { hostId: s }), (r[2] = s), (r[3] = f));
  let p = j(f),
    m;
  r[4] === s ? (m = r[5]) : ((m = { hostId: s }), (r[4] = s), (r[5] = m));
  let h = M(m),
    g = re(`3207467860`),
    _ = o(he),
    te = b(),
    { isProfileVisible: v, isProfileVisibilityLoading: ne } = me(),
    { isUsageSettingsVisible: y, isUsageSettingsAccessLoading: S } = Pe(),
    C;
  r[6] === s ? (C = r[7]) : ((C = { hostId: s }), (r[6] = s), (r[7] = C));
  let ie = oe(C),
    ae = a && !h.isLoading && !h.allowed,
    w =
      a &&
      !p.isLoading &&
      (p.reason === `statsig-disabled` || p.reason === `config-requirement-disabled`),
    T = a && (ie.available || h.available || ae),
    E = a && (p.available || h.available || w),
    D,
    O;
  if (
    r[8] !== _ ||
    ...
    r[30] !== y
      ? ((e = (e) => {
          if (!a && !pt.includes(e.slug)) return !1;
          switch (e.slug) {
            case `appshots`:
              return _;
  ...
  let k = D,
    ...
    R;
  if (
    (r[34] !== a || r[35] !== i || r[36] !== k
      ? ((F = gt(i)),
        (P = F != null && k == null),
        (A = a ? W : mt),
        (I = !1),
        (R = P && !(!a && !pt.includes(F.slug))),
        (r[34] = a),
        (r[35] = i),
        (r[36] = k),
        (r[37] = A),
        ...
        (r[40] = I),
        (r[41] = R))
      : ((A = r[37]), (P = r[38]), (F = r[39]), (I = r[40]), (R = r[41])),
    R)
  )
    bb0: switch (F.slug) {
      case `appshots`:
      ...
      case `codex-micro`:
        ...
        break bb0;
      case `computer-use`:
        I = ie.isLoading || h.isLoading;
        break bb0;
      case `browser-use`:
        I = p.isLoading || h.isLoading || te;
        break bb0;
      case `local-environments`:
      case `worktrees`:
      case `environments`:
...
function _t() {
  let e = (0, Fe.c)(78),
    t = a(s),
    n = ee(),
    { accountId: r, userId: i } = S(),
    u = w(),
    d = ae(),
    f = E(`/settings/:section/*`)?.params.section ?? null,
    {
      connectedRemoteConnections: _,
      remoteConnectionHostIds: v,
      selectedHostId: y,
      setSelectedHostId: re,
    } = ue(),
    b = l(y).kind === `local`,
    {
      activeSettingsSection: x,
    ...
    j;
  e[0] !== A || e[1] !== u
    ? ((j = () => xt(u, A)), (e[0] = A), (e[1] = u), (e[2] = j))
    : (j = e[2]);
  let M = j,
    N;
  e[3] === y ? (N = e[4]) : ((N = { selectedHostId: y }), (e[3] = y), (e[4] = N));
  let P = lt(N),
    F;
  e[5] !== _ || e[6] !== n || e[7] !== v || e[8] !== y || e[9] !== re
    ? ((F =
        _ != null && _.length > 0 && v != null
          ? (0, $.jsx)(ke, {
              align: `start`,
              connectedRemoteConnections: _,
              contentWidth: `sidebar`,
              localLabel: n.formatMessage({
                id: `settings.hostDropdown.thisComputer`,
                defaultMessage: `This computer`,
                description: `Label for the local computer in the settings sidebar host dropdown`,
              }),
              onSelectHost: re,
              remoteConnectionHostIds: v,
              selectedHostId: y,
  ...
  let R = L,
    z;
  e[14] !== d.state || e[15] !== u || e[16] !== t
    ? ((z = (e) => {
        (e === `profile` && m(t, p, { source: `settings_page` }),
          u(`/settings/${e}`, { replace: !0, state: d.state }));
      }),
      (e[14] = d.state),
      (e[15] = u),
      (e[16] = t),
  ...
  let V;
  e[18] !== k || e[19] !== D
    ? ((V = k && D.some(yt)), (e[18] = k), (e[19] = D), (e[20] = V))
    : (V = e[20]);
  let H;
  (e[21] !== r || e[22] !== V || e[23] !== i
    ? ((H = { accountId: r, enabled: V, userId: i }),
      (e[21] = r),
      (e[22] = V),
      (e[23] = i),
      (e[24] = H))
  ...
  (e[25] === t
    ? ((U = e[26]), (W = e[27]))
    : ((U = () => {
        t.query.invalidate(_e, { exact: !0 }).catch(vt);
      }),
      (W = [t]),
      (e[25] = t),
      (e[26] = U),
  ...
  if (
    ...
    return (
      e[32] === t
        ? (n = e[33])
        : ((n = (0, $.jsx)(ie, { to: t, replace: !0 })), (e[32] = t), (e[33] = n)),
      n
    );
  }
  if (O) {
    ...
    e[41] !== D
      ...
      : (t = e[42]);
    let n;
    e[43] === d.hash ? (n = e[44]) : ((n = d.hash.slice(1) || null), (e[43] = d.hash), (e[44] = n));
    let r;
    ...
    e[46] === y
      ? (i = e[47])
      : ((i = (0, $.jsx)(Ie.Suspense, { fallback: r, children: (0, $.jsx)(T, {}, y) })),
        (e[46] = y),
        (e[47] = i));
    let a;
    e[48] !== d.key || e[49] !== n || e[50] !== i
      ? ((a = (0, $.jsx)(`div`, {
          className: `h-full min-w-0 overflow-visible`,
          children: (0, $.jsx)(Te, { navigationKey: d.key, targetId: n, children: i }),
        })),
        (e[48] = d.key),
        (e[49] = n),
        (e[50] = i),
    ...
    return (
      e[52] !== t || e[53] !== a
        ? ((o = (0, $.jsxs)(ne.Root, { children: [t, a] })), (e[52] = t), (e[53] = a), (e[54] = o))
        : (o = e[54]),
      o
    );
  }
  ...
  e[64] !== D
    ...
    : (X = e[65]);
  let Z;
  e[66] === d.hash ? (Z = e[67]) : ((Z = d.hash.slice(1) || null), (e[66] = d.hash), (e[67] = Z));
  let Q;
  ...
  e[69] === y
    ? (de = e[70])
    : ((de = (0, $.jsx)(Ie.Suspense, { fallback: Q, children: (0, $.jsx)(T, {}, y) })),
      (e[69] = y),
      (e[70] = de));
  let me;
  e[71] !== d.key || e[72] !== Z || e[73] !== de
    ? ((me = (0, $.jsx)(`div`, {
        className: `relative isolate min-w-0 flex-1 overflow-visible`,
        children: (0, $.jsx)(Te, { navigationKey: d.key, targetId: Z, children: de }),
      })),
      (e[71] = d.key),
      (e[72] = Z),
      (e[73] = de),
