...
import {
  i as ht,
  r as gt,
} from "./app-initial~app-main~remote-conversation-page~hotkey-window-thread-page~thread-app-shell-ch~ecjwgenq.js";
import {
  G as _t,
  K as vt,
...
import {
  ...
  t as Bt,
  v as Vt,
} from "./app-initial~app-main~worktree-init-v2-page~appgen-settings-page~page~appgen-page~remote-con~lblzrcac.js";
import {
  bn as Ht,
  ft as Ut,
  pt as Wt,
  xn as Gt,
  yn as Kt,
} from "./app-initial~app-main~remote-conversation-page~projects-index-page-CqG_-EML.js";
import {
  n as qt,
  t as Jt,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~setting~fboddtaw-R.js";
import {
  c as Yt,
  i as Xt,
  l as Zt,
  ...
  t as tn,
  u as nn,
} from "./app-initial~app-main~settings-page.js";
import {
  n as rn,
  t as an,
} from "./app-initial~app-main~settings-page~codex-mobile-page~debug-window-page~remote-connections-s~mf1b27wf.js";
import { n as on, t as sn } from "./filter.js";
import { n as cn, t as ln } from "./dock.js";
import { n as un, t as dn } from "./experimental-feature-visibility.js";
import { n as fn, t as pn } from "./settings-host-dropdown.js";
var mn,
  hn,
  gn = e(() => {
    (t(ve()),
...
function wn(e, t, n) {
  ...
  let c = null;
  for (let e of r) {
    let r = Math.max(ye(e, t), ...n.map((t) => ye(e, t)));
...
function Tn(e, t) {
  let n = t.map((t) => Math.max(0, ...e.map((e) => ye(e, t))));
...
function En(e, t) {
  ...
  let i = {
    ...
    panelLabel: e.formatMessage(kt(t.sectionSlug)),
...
function kn(e) {
  let t = (0, Bn.c)(95),
    ...
    g = T(),
    _ = j(qn),
    [ee, v] = (0, Vn.useState)(!1),
    [y, b] = (0, Vn.useState)(``),
    x = p && ee,
    S = _ && m && !x,
    te;
  t[0] !== y || t[1] !== S
    ? ((te = S && y.trim().length > 0), (t[0] = y), (t[1] = S), (t[2] = te))
    : (te = t[2]);
  let C = te,
    w,
    E;
  t[3] !== g || t[4] !== y || t[5] !== h || t[6] !== n
    ? ((w = Cn({ intl: g, query: y, targets: h, visibleSectionSlugs: n.flatMap(Fn) })),
      (E = w.map(Pn).join(`\0`)),
      (t[3] = g),
      (t[4] = y),
      (t[5] = h),
  ...
  t[9] === D
    ? (ne = t[10])
    : ((ne = D.length === 0 ? [] : D.split(`\0`)), (t[9] = D), (t[10] = ne));
  let O = ne,
    k = S && y.length > 0,
    A;
  t[11] !== i || t[12] !== w
  ...
  t[15] !== O || t[16] !== k || t[17] !== A
    ? ((ie = { items: O, isActive: k, autoHighlightFirst: !1, onSelect: A, onEscape: re }),
      (t[15] = O),
      (t[16] = k),
      (t[17] = A),
      (t[18] = ie))
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (F = t[20]);
  let ae = F,
    I = x ? Yn.collapsed : Yn.expanded,
    oe;
  t[21] !== I.message || t[22] !== g
    ? ((oe = g.formatMessage(I.message)), (t[21] = I.message), (t[22] = g), (t[23] = oe))
    : (oe = t[23]);
  let L = oe,
    R = I.icon,
    z,
  ...
  if (
    ...
    (t[51] === a
      ? (K = t[52])
      : ((K = Se(`flex min-h-0 flex-1 flex-col select-none px-row-x`, a)),
        (t[51] = a),
        (t[52] = K)),
      t[53] === g
        ? (q = t[54])
        : ((q = g.formatMessage({
          ...
          (t[53] = g),
          (t[54] = q)),
      (V = `flex min-h-0 flex-1 flex-col`),
      t[55] !== R || t[56] !== p || t[57] !== L || t[58] !== I.message
        ? ((H = p
            ? (0, Q.jsx)(`div`, {
                className: `mb-2 shrink-0`,
                children: (0, Q.jsx)(Ce, {
                  tooltipContent: (0, Q.jsx)(f, { ...I.message }),
                  children: (0, Q.jsx)(Kt, {
                    "aria-label": L,
                    fullWidth: !1,
                    icon: R,
      ...
      t[63] !== x || t[64] !== d
        ? ((W =
          ...
          (t[65] = W))
        : (W = t[65]),
      t[66] !== M || t[67] !== y || t[68] !== S
        ? ((G = S
            ? (0, Q.jsx)(In, {
                onKeyDown: M.getInputProps().onKeyDown,
                searchQuery: y,
                onQueryChange: (e) => {
                  (M.setHighlightedIndex(-1), b(e));
                },
              })
            : null),
          (t[66] = M),
          ...
          (t[69] = G))
        : (G = t[69]));
    let c = x ? `flex flex-col gap-2` : `flex flex-col gap-4`;
    (t[70] === c
      ? (z = t[71])
      : ((z = Se(`min-h-0 flex-1 overflow-y-auto pb-2`, c)), (t[70] = c), (t[71] = z)),
      (B = C
        ? (0, Q.jsx)(Ln, {
            intl: g,
        ...
        : e.map((e) =>
            (0, Q.jsx)(
              ...
              {
                className: `gap-0`,
                title: x || e.heading == null ? null : (0, Q.jsx)(f, { ...e.heading }),
                children: e.sections.map((e) => {
                  let t = e.slug === r,
                    n = !!e.externalUrl,
                    a = !!e.disabled,
                    o = t && e.slug === `pets` ? vn : Hn[e.slug],
                    c = g.formatMessage(kt(e.slug)),
                    l = (t) => {
                      if (!a) {
                        if (n && e.externalUrl) {
                          se({
                  ...
                  return (0, Q.jsx)(
                    Ce,
                    {
                      tooltipContent: x ? (0, Q.jsx)(Et, { slug: e.slug }) : n ? ae : P,
                      side: `right`,
                      sideOffset: 12,
                      disabled: !x && !a && !n,
                      children: (0, Q.jsx)(Kt, {
                        ...
                        label: (0, Q.jsx)(Et, { slug: e.slug }),
                        trailing:
                          !x && e.externalUrl != null
                            ? (0, Q.jsx)(xe, {
    ...
    ((z = t[42]),
      ...
      (q = t[50]));
  let J;
  t[72] !== p || t[73] !== x || t[74] !== g || t[75] !== C
    ? ((J = C
        ? null
        : (0, Q.jsx)(Ce, {
            tooltipContent: x ? (0, Q.jsx)(f, { ...Un.chatSettings }) : ae,
            side: `right`,
            sideOffset: 12,
            children: (0, Q.jsx)(Kt, {
              "aria-label": g.formatMessage(Un.chatSettings),
              icon: _t,
              iconClassName: `icon-sm inline-block align-middle`,
              hideLabel: p ? x : void 0,
              label: (0, Q.jsx)(f, { ...Un.chatSettings }),
              onClick: An,
              trailing: x
                ? void 0
                : (0, Q.jsx)(xe, {
  ...
  t[77] === l
    ...
    : ((le =
      ...
      (t[78] = le));
  let Y;
  t[79] !== z || t[80] !== B || t[81] !== J || t[82] !== le
    ? ((Y = (0, Q.jsxs)(`div`, { className: z, children: [B, J, le] })),
      (t[79] = z),
      (t[80] = B),
      (t[81] = J),
      (t[82] = le),
    ...
    : (Y = t[83]);
  let X;
  t[84] !== V || t[85] !== H || t[86] !== U || t[87] !== W || t[88] !== G || t[89] !== Y
    ? ((X = (0, Q.jsxs)(`div`, { className: V, children: [H, U, W, G, Y] })),
      (t[84] = V),
      (t[85] = H),
      (t[86] = U),
      (t[87] = W),
  ...
  let Z;
  return (
    t[91] !== K || t[92] !== q || t[93] !== X
      ? ((Z = (0, Q.jsx)(`nav`, { className: K, "aria-label": q, children: X })),
        (t[91] = K),
        (t[92] = q),
        (t[93] = X),
        (t[94] = Z))
...
function An(e) {
  se({ event: e, href: Jn, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
}
function jn(e) {
  return !e;
}
...
function In(e) {
  ...
  t[6] === a
    ...
    : ((f = a.formatMessage({
      ...
      (t[7] = f));
  let p;
  t[8] !== n || t[9] !== r || t[10] !== u || t[11] !== d || t[12] !== f
    ? ((p = (0, Q.jsx)(`input`, {
        ref: o,
        "aria-label": u,
    ...
    ? ((m =
        r.length > 0
          ? (0, Q.jsx)(`button`, {
              ...
              type: `button`,
              children: (0, Q.jsx)(s, { className: `icon-2xs` }),
            })
          : null),
      (t[14] = a),
      (t[15] = i),
...
function Ln(e) {
              ...
              children: [
                (0, Q.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, Q.jsx)(`span`, { className: `truncate`, children: e.panelLabel }),
                  ],
                }),
                (0, Q.jsx)(`button`, {
  ...
  return (
    t[10] !== i || t[11] !== s
      ? ((c = (0, Q.jsx)(`div`, { ref: i, className: `flex flex-col gap-3 pt-1`, children: s })),
        (t[10] = i),
        (t[11] = s),
        (t[12] = c))
      : (c = t[12]),
...
var Bn,
  ...
  Xn = e(() => {
    ((Bn = q()),
      ...
      (Yn = {
        collapsed: { icon: Lt, message: Un.expandSidebar },
        expanded: { icon: Ft, message: Un.collapseSidebar },
      }));
  }),
  Zn,
  Qn = e(() => {
    Zn = {
      agent: [
        ...
        { defaultMessage: `Model features`, id: `settings.agent.modelFeatures.title` },
        {
      ...
      "browser-use": [
        ...
        { defaultMessage: `Browsing history`, id: `settings.browserUse.browser.history.label` },
        {
        ...
        { defaultMessage: `History`, id: `settings.browserUse.history.breadcrumb` },
        {
          defaultMessage: `View and manage pages visited in Codex's browser`,
          id: `settings.browserUse.history.description`,
        },
        { defaultMessage: `Browsing history`, id: `settings.browserUse.history.label` },
        { defaultMessage: `History`, id: `settings.browserUse.history.webviewLabel` },
      ...
      "general-settings": [
        ...
        { defaultMessage: `Send shortcut`, id: `settings.general.enterBehavior.rowLabel` },
        {
          defaultMessage: `Cancel`,
      ...
      "keyboard-shortcuts": [
        ...
        { defaultMessage: `Manage scheduled tasks`, id: `codex.command.manageTasks` },
        ...
        { defaultMessage: `Toggle pinned summary`, id: `codex.command.togglePinnedSummary` },
      ...
      "local-environments": [
        ...
        { defaultMessage: `Add`, id: `projectSetup.createLocalProject.addSource` },
        ...
        { defaultMessage: `Project name`, id: `projectSetup.createLocalProject.namePlaceholder` },
        ...
        { defaultMessage: `Sources`, id: `projectSetup.createLocalProject.sourcesLabel` },
        { defaultMessage: `Create project`, id: `projectSetup.createLocalProject.submit` },
        { defaultMessage: `Create project`, id: `projectSetup.createLocalProject.title` },
      ...
      profile: [
        ...
        { defaultMessage: `Light`, id: `composer.mode.local.reasoning.low.label` },
        ...
        { defaultMessage: `Ultra`, id: `composer.mode.local.reasoning.ultra.label` },
...
function $n(e) {
  let t = (0, rr.c)(11),
    ...
    a = r?.platform === `darwin`,
    { data: o } = L(P, e.selectedHostId),
    s;
  t[0] === o ? (s = t[1]) : ((s = o === void 0 ? [] : o), (t[0] = o), (t[1] = s));
  let c = s,
    l;
  t[2] === c ? (l = t[3]) : ((l = c.filter(un).flatMap(nr)), (t[2] = c), (t[3] = l));
  let u = l,
    d;
  t[4] === n.locale
    ? (d = t[5])
    : ((d = [{ locale: He, language: `en` }, ...et().map(tr)].flatMap((e) => {
        let { language: t, locale: r } = e;
        return [Ve(r, r), Ve(t, n.locale)];
      })),
      (t[4] = n.locale),
      (t[5] = d));
  let f = d,
...
var rr,
  ...
  or = e(() => {
    ((rr = q()),
      ...
      ee(),
      dn(),
      (ir = ct.map((e) => ({ messages: Zn[e] ?? [], sectionSlug: e }))),
      (ar = [
...
function sr(e = null, t = !0, n = te) {
  ...
  let s = j(en),
    c = B(Ct),
    l = _(),
    { isProfileVisible: u, isProfileVisibilityLoading: d } = at(),
    { isUsageSettingsVisible: f, isUsageSettingsAccessLoading: m } = lt(),
    h = E({ hostId: n }),
    g = t && !o.isLoading && !o.allowed,
    ee =
      t &&
      !a.isLoading &&
    ...
    v = t && (h.available || o.available || g),
    y = t && (a.available || o.available || ee),
    b = it.filter((e) => {
  ...
  if (C && !(!t && !lr.includes(S.slug)))
    switch (S.slug) {
      ...
      case `codex-micro`:
        ...
        break;
      case `computer-use`:
        T = h.isLoading || o.isLoading;
        break;
      case `browser-use`:
        T = a.isLoading || o.isLoading || l;
        break;
      case `local-environments`:
      case `worktrees`:
      case `environments`:
  ...
  return {
    activeSettingsSection: x?.slug ?? w,
    shouldRedirectToVisibleSettingsSection: C && !T,
    shouldRenderRouteContent: e !== `import` || !T,
    visibleSettingsSections: b,
  };
}
function cr(e) {
  return e == null ? null : (it.find((t) => t.slug === e) ?? null);
}
var lr,
  ur,
  dr = e(() => {
...
function fr() {
  let e = (0, gr.c)(78),
    ...
    i = ze(),
    a = w(),
    o = ie(`/settings/:section/*`)?.params.section ?? null,
    {
      connectedRemoteConnections: s,
      remoteConnectionHostIds: c,
      selectedHostId: l,
      setSelectedHostId: u,
    } = Ze(),
    f = h(l).kind === `local`,
    ...
    b;
  e[0] !== v || e[1] !== i
    ? ((b = () => hr(i, v)), (e[0] = v), (e[1] = i), (e[2] = b))
    : (b = e[2]);
  let x = b,
    S;
  e[3] === l ? (S = e[4]) : ((S = { selectedHostId: l }), (e[3] = l), (e[4] = S));
  let C = $n(S),
    E;
  e[5] !== s || e[6] !== n || e[7] !== c || e[8] !== l || e[9] !== u
    ? ((E =
        s != null && s.length > 0 && c != null
          ? (0, $.jsx)(pn, {
              align: `start`,
              connectedRemoteConnections: s,
  ...
  e[15] !== l || e[16] !== g
    ? ((j = g
        ? (0, $.jsx)(_r.Suspense, { fallback: (0, $.jsx)(pt, {}), children: (0, $.jsx)(me, {}, l) })
        : (0, $.jsx)(pt, {})),
      (e[15] = l),
      (e[16] = g),
      (e[17] = j))
  ...
  let M = j,
    N;
  e[18] !== a.state || e[19] !== i || e[20] !== t
    ? ((N = (e) => {
        (e === `profile` && ne(t, W, { source: `settings_page` }),
  ...
  e[27] === t.query
    ...
    : ((R = () => {
      ...
      (e[28] = R));
  let z;
  (e[29] === t ? (z = e[30]) : ((z = [t]), (e[29] = t), (e[30] = z)), (0, _r.useEffect)(R, z));
  let H, se;
  if (
    (e[31] !== v || e[32] !== i
      ? ((H = () => {
    ...
    return (
      e[35] === t
        ? (n = e[36])
        : ((n = (0, $.jsx)(r, { to: t, replace: !0 })), (e[35] = t), (e[36] = n)),
      n
    );
  }
  if (ee) {
    ...
    e[44] !== _
      ...
      : (t = e[45]);
    let n;
    e[46] === a.hash ? (n = e[47]) : ((n = a.hash.slice(1) || null), (e[46] = a.hash), (e[47] = n));
    let r;
    e[48] !== a.key || e[49] !== M || e[50] !== n
      ? ((r = (0, $.jsx)(`div`, {
          className: `h-full min-w-0 overflow-visible`,
          children: (0, $.jsx)(ft, { navigationKey: a.key, targetId: n, children: M }),
        })),
        (e[48] = a.key),
        (e[49] = M),
        (e[50] = n),
    ...
    return (
      e[52] !== t || e[53] !== r
        ? ((i = (0, $.jsxs)(Bt.Root, { children: [t, r] })), (e[52] = t), (e[53] = r), (e[54] = i))
        : (i = e[54]),
      i
    );
  }
  ...
  e[56] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = Se(
      ...
      (G = (0, $.jsx)(`div`, { className: `draggable h-toolbar w-full shrink-0` })),
      (e[56] = U),
      (e[57] = G))
    : ((U = e[56]), (G = e[57]));
  let K = x,
  ...
  e[64] !== _
    ...
    : (q = e[65]);
  let J;
  e[66] === a.hash ? (J = e[67]) : ((J = a.hash.slice(1) || null), (e[66] = a.hash), (e[67] = J));
  let Y;
  e[68] !== a.key || e[69] !== M || e[70] !== J
    ? ((Y = (0, $.jsx)(ft, { navigationKey: a.key, targetId: J, children: M })),
      (e[68] = a.key),
      (e[69] = M),
      (e[70] = J),
      (e[71] = Y))
