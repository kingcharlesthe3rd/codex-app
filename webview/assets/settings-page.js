...
import { m as Pt, p as Ft } from "./app-initial~app-main~onboarding-page~select-workspace-page.js";
import {
  a as It,
  c as Lt,
  i as Rt,
  ...
  s as Bt,
  t as Vt,
} from "./app-initial~app-main~remote-conversation-page~settings-page~hotkey-window-thread-page~mcp-s~lv2pzabw.js";
import {
  n as Ht,
  t as Ut,
...
import {
  ...
  r as Zt,
  t as Qt,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~settings-page~appgen-li~hx3rzwx8.js";
import {
  i as $t,
  r as en,
...
function wn(e, t, n) {
  ...
  let c = null;
  for (let e of r) {
    let r = Math.max(St(e, t), ...n.map((t) => St(e, t)));
...
function Tn(e, t) {
  let n = t.map((t) => Math.max(0, ...e.map((e) => St(e, t))));
...
function En(e, t) {
  ...
  let i = {
    ...
    panelLabel: e.formatMessage(Ot(t.sectionSlug)),
...
function kn(e) {
  let t = (0, Bn.c)(95),
    ...
    h = Te(),
    g = X(qn),
    [ee, _] = (0, Vn.useState)(!1),
    [v, te] = (0, Vn.useState)(``),
    y = f && ee,
    b = g && p && !y,
    x;
  t[0] !== v || t[1] !== b
    ? ((x = b && v.trim().length > 0), (t[0] = v), (t[1] = b), (t[2] = x))
    : (x = t[2]);
  let S = x,
    C,
    w;
  t[3] !== h || t[4] !== v || t[5] !== m || t[6] !== n
    ? ((C = Cn({ intl: h, query: v, targets: m, visibleSectionSlugs: n.flatMap(Fn) })),
      (w = C.map(Pn).join(`\0`)),
      (t[3] = h),
      (t[4] = v),
      (t[5] = m),
  ...
  t[9] === ne
    ? (T = t[10])
    : ((T = ne.length === 0 ? [] : ne.split(`\0`)), (t[9] = ne), (t[10] = T));
  let re = T,
    E = b && v.length > 0,
    D;
  t[11] !== i || t[12] !== C
  ...
  t[15] !== re || t[16] !== E || t[17] !== D
    ? ((ae = { items: re, isActive: E, autoHighlightFirst: !1, onSelect: D, onEscape: ie }),
      (t[15] = re),
      (t[16] = E),
      (t[17] = D),
      (t[18] = ae))
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (se = t[20]);
  let ce = se,
    A = y ? Yn.collapsed : Yn.expanded,
    j;
  t[21] !== A.message || t[22] !== h
    ? ((j = h.formatMessage(A.message)), (t[21] = A.message), (t[22] = h), (t[23] = j))
    : (j = t[23]);
  let M = j,
    N = A.icon,
    P,
  ...
  if (
    ...
    (t[51] === a
      ? (V = t[52])
      : ((V = xe(`flex min-h-0 flex-1 flex-col select-none px-row-x`, a)),
        (t[51] = a),
        (t[52] = V)),
      t[53] === h
        ? (H = t[54])
        : ((H = h.formatMessage({
          ...
          (t[53] = h),
          (t[54] = H)),
      (I = `flex min-h-0 flex-1 flex-col`),
      t[55] !== N || t[56] !== f || t[57] !== M || t[58] !== A.message
        ? ((L = f
            ? (0, Q.jsx)(`div`, {
                className: `mb-2 shrink-0`,
                children: (0, Q.jsx)(ue, {
                  tooltipContent: (0, Q.jsx)(Z, { ...A.message }),
                  children: (0, Q.jsx)(Wt, {
                    "aria-label": M,
                    fullWidth: !1,
                    icon: N,
      ...
      t[63] !== y || t[64] !== d
        ? ((z =
          ...
          (t[65] = z))
        : (z = t[65]),
      t[66] !== O || t[67] !== v || t[68] !== b
        ? ((B = b
            ? (0, Q.jsx)(In, {
                onKeyDown: O.getInputProps().onKeyDown,
                searchQuery: v,
                onQueryChange: (e) => {
                  (O.setHighlightedIndex(-1), te(e));
                },
              })
            : null),
          (t[66] = O),
    ...
    (t[70] === c
      ? (P = t[71])
      : ((P = xe(`min-h-0 flex-1 overflow-y-auto pb-2`, c)), (t[70] = c), (t[71] = P)),
      (F = S
        ? (0, Q.jsx)(Ln, {
            intl: h,
        ...
        : e.map((e) =>
            (0, Q.jsx)(
              ...
              {
                className: `gap-0`,
                title: y || e.heading == null ? null : (0, Q.jsx)(Z, { ...e.heading }),
                children: e.sections.map((e) => {
                  let t = e.slug === r,
                    n = !!e.externalUrl,
                    a = !!e.disabled,
                    o = t && e.slug === `pets` ? vn : Hn[e.slug],
                    c = h.formatMessage(Ot(e.slug)),
                    l = (t) => {
                      if (!a) {
                        if (n && e.externalUrl) {
                          Mt({
                  ...
                  return (0, Q.jsx)(
                    ue,
                    {
                      tooltipContent: y ? (0, Q.jsx)(Dt, { slug: e.slug }) : n ? ce : oe,
                      side: `right`,
                      sideOffset: 12,
                      disabled: !y && !a && !n,
                      children: (0, Q.jsx)(Wt, {
                        ...
                        isActive: t,
                        disabled: a,
                        "data-settings-panel-slug": p && !a && !n ? e.slug : void 0,
                        hideLabel: f ? y : void 0,
                        onClick: l,
                        onKeyDown:
                          p && !a && !n
                            ? (t) => {
    ...
    ((P = t[42]),
      ...
      (H = t[50]));
  let U;
  t[72] !== f || t[73] !== y || t[74] !== h || t[75] !== S
    ? ((U = S
        ? null
        : (0, Q.jsx)(ue, {
            tooltipContent: y ? (0, Q.jsx)(Z, { ...Un.chatSettings }) : ce,
            side: `right`,
            sideOffset: 12,
            children: (0, Q.jsx)(Wt, {
  ...
  t[77] === l
    ...
    : ((W =
      ...
      (t[78] = W));
  let G;
  t[79] !== P || t[80] !== F || t[81] !== U || t[82] !== W
    ? ((G = (0, Q.jsxs)(`div`, { className: P, children: [F, U, W] })),
      (t[79] = P),
      (t[80] = F),
      (t[81] = U),
      (t[82] = W),
    ...
    : (G = t[83]);
  let K;
  t[84] !== I || t[85] !== L || t[86] !== R || t[87] !== z || t[88] !== B || t[89] !== G
    ? ((K = (0, Q.jsxs)(`div`, { className: I, children: [L, R, z, B, G] })),
      (t[84] = I),
      (t[85] = L),
      (t[86] = R),
      (t[87] = z),
  ...
  let q;
  return (
    t[91] !== V || t[92] !== H || t[93] !== K
      ? ((q = (0, Q.jsx)(`nav`, { className: V, "aria-label": H, children: K })),
        (t[91] = V),
        (t[92] = H),
        (t[93] = K),
        (t[94] = q))
...
function An(e) {
  Mt({ event: e, href: Jn, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
}
function jn(e) {
  return !e;
}
...
var Bn,
  ...
  Xn = e(() => {
    ((Bn = o()),
      ...
      (Yn = {
        collapsed: { icon: M, message: Un.expandSidebar },
        expanded: { icon: A, message: Un.collapseSidebar },
      }));
  }),
  Zn,
  Qn = e(() => {
...
function $n(e) {
  let t = (0, rr.c)(11),
    ...
    a = r?.platform === `darwin`,
    { data: o } = l(jt, e.selectedHostId),
    s;
  t[0] === o ? (s = t[1]) : ((s = o === void 0 ? [] : o), (t[0] = o), (t[1] = s));
  let c = s,
    u;
  t[2] === c ? (u = t[3]) : ((u = c.filter(un).flatMap(nr)), (t[2] = c), (t[3] = u));
  let d = u,
    f;
  t[4] === n.locale
    ? (f = t[5])
    : ((f = [{ locale: L, language: `en` }, ...z().map(tr)].flatMap((e) => {
        let { language: t, locale: r } = e;
        return [V(r, r), V(t, n.locale)];
      })),
      (t[4] = n.locale),
      (t[5] = f));
  let p = f,
...
var rr,
  ...
  or = e(() => {
    ((rr = o()),
      ...
      At(),
      dn(),
      (ir = Lt.map((e) => ({ messages: Zn[e] ?? [], sectionSlug: e }))),
      (ar = [
...
function sr(e = null, t = !0, n = i) {
  ...
  let c = X(De),
    l = u($t),
    d = J(),
    { isProfileVisible: f, isProfileVisibilityLoading: p } = zt(),
    { isUsageSettingsVisible: m, isUsageSettingsAccessLoading: h } = st(),
    g = Ue({ hostId: n }),
    ee = t && !s.isLoading && !s.allowed,
    _ =
      t &&
      !o.isLoading &&
      (o.reason === `statsig-disabled` ||
        o.reason === `config-requirement-disabled` ||
        o.reason === `wsl-disabled`),
    v = t && (g.available || s.available || ee),
    te = t && (o.available || s.available || _),
    y = It.filter((e) => {
  ...
  if (S && !(!t && !lr.includes(x.slug)))
    switch (x.slug) {
      ...
      case `codex-micro`:
        ...
        break;
      case `computer-use`:
        w = g.isLoading || s.isLoading;
        break;
      case `browser-use`:
        w = o.isLoading || s.isLoading || d;
        break;
      case `local-environments`:
      case `worktrees`:
      case `environments`:
  ...
  return {
    activeSettingsSection: b?.slug ?? C,
    shouldRedirectToVisibleSettingsSection: S && !w,
    shouldRenderRouteContent: e !== `import` || !w,
    visibleSettingsSections: y,
  };
}
function cr(e) {
...
function fr() {
  let e = (0, gr.c)(78),
    ...
    o = fe(),
    s = _e(),
    c = ve(`/settings/:section/*`)?.params.section ?? null,
    {
    ...
    x;
  e[0] !== y || e[1] !== o
    ? ((x = () => hr(o, y)), (e[0] = y), (e[1] = o), (e[2] = x))
    : (x = e[2]);
  let S = x,
    C;
  e[3] === p ? (C = e[4]) : ((C = { selectedHostId: p }), (e[3] = p), (e[4] = C));
  let w = $n(C),
    T;
  e[5] !== l || e[6] !== n || e[7] !== f || e[8] !== p || e[9] !== m
    ? ((T =
  ...
  e[15] !== p || e[16] !== _
    ? ((le = _
        ? (0, $.jsx)(_r.Suspense, { fallback: (0, $.jsx)(Ne, {}), children: (0, $.jsx)(ge, {}, p) })
        : (0, $.jsx)(Ne, {})),
      (e[15] = p),
      (e[16] = _),
      (e[17] = le))
  ...
  let j = le,
    M;
  e[18] !== s.state || e[19] !== o || e[20] !== t
    ? ((M = (e) => {
        (e === `profile` && Se(t, de, { source: `settings_page` }),
          o(`/settings/${e}`, { replace: !0, state: s.state }));
      }),
      (e[18] = s.state),
      (e[19] = o),
      (e[20] = t),
  ...
  e[27] === t.query
    ? (L = e[28])
    : ((L = () => {
        t.query.invalidate(nn, { exact: !0 }).catch(pr);
      }),
      (e[27] = t.query),
      (e[28] = L));
  let R;
  (e[29] === t ? (R = e[30]) : ((R = [t]), (e[29] = t), (e[30] = R)), (0, _r.useEffect)(L, R));
  let z, B;
  if (
    (e[31] !== y || e[32] !== o
      ? ((z = () => {
    ...
    return (
      e[35] === t
        ? (n = e[36])
        : ((n = (0, $.jsx)(he, { to: t, replace: !0 })), (e[35] = t), (e[36] = n)),
      n
    );
  }
  if (te) {
    ...
    e[44] !== v
      ...
      : (t = e[45]);
    let n;
    e[46] === s.hash ? (n = e[47]) : ((n = s.hash.slice(1) || null), (e[46] = s.hash), (e[47] = n));
    let r;
    e[48] !== s.key || e[49] !== j || e[50] !== n
      ? ((r = (0, $.jsx)(`div`, {
          className: `h-full min-w-0 overflow-visible`,
          children: (0, $.jsx)(Ae, { navigationKey: s.key, targetId: n, children: j }),
        })),
        (e[48] = s.key),
        (e[49] = j),
        (e[50] = n),
    ...
    return (
      e[52] !== t || e[53] !== r
        ? ((i = (0, $.jsxs)(ie.Root, { children: [t, r] })), (e[52] = t), (e[53] = r), (e[54] = i))
        : (i = e[54]),
      i
    );
  }
  ...
  e[56] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = xe(
      ...
      (W = (0, $.jsx)(`div`, { className: `draggable h-toolbar w-full shrink-0` })),
      (e[56] = U),
      (e[57] = W))
    : ((U = e[56]), (W = e[57]));
  let G = S,
  ...
  e[64] !== v
    ...
    : (K = e[65]);
  let q;
  e[66] === s.hash ? (q = e[67]) : ((q = s.hash.slice(1) || null), (e[66] = s.hash), (e[67] = q));
  let J;
  e[68] !== s.key || e[69] !== j || e[70] !== q
    ? ((J = (0, $.jsx)(Ae, { navigationKey: s.key, targetId: q, children: j })),
      (e[68] = s.key),
      (e[69] = j),
      (e[70] = q),
      (e[71] = J))
  ...
  return (
    e[75] !== K || e[76] !== Y
      ? ((X = (0, $.jsxs)(`div`, { className: `flex h-full min-h-0`, style: V, children: [K, Y] })),
        (e[75] = K),
        (e[76] = Y),
        (e[77] = X))
      : (X = e[77]),
