...
import { n as cn, t as ln } from "./dock-5J4-9xT8.js";
...
function wn(e, t, n) {
  ...
  let c = null;
  for (let e of r) {
    let r = Math.max(Te(e, t), ...n.map((t) => Te(e, t)));
...
function Tn(e, t) {
  let n = t.map((t) => Math.max(0, ...e.map((e) => Te(e, t))));
...
function En(e, t) {
  ...
  let i = {
    ...
    panelLabel: e.formatMessage(Mt(t.sectionSlug)),
...
function kn(e) {
  ...
  let S = x,
    w,
    T;
  t[3] !== h || t[4] !== v || t[5] !== ee || t[6] !== n
    ? ((w = Cn({ intl: h, query: v, targets: ee, visibleSectionSlugs: n.flatMap(Fn) })),
      (T = w.map(Pn).join(`\0`)),
      (t[3] = h),
      (t[4] = v),
      (t[5] = ee),
  ...
  let D = T,
    O;
  t[9] === D ? (O = t[10]) : ((O = D.length === 0 ? [] : D.split(`\0`)), (t[9] = D), (t[10] = O));
  let k = O,
    A = b && v.length > 0,
    j;
  t[11] !== i || t[12] !== w
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (M = t[14]);
  let re;
  t[15] !== k || t[16] !== A || t[17] !== j
    ? ((re = { items: k, isActive: A, autoHighlightFirst: !1, onSelect: j, onEscape: M }),
      (t[15] = k),
      (t[16] = A),
      (t[17] = j),
      (t[18] = re))
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (oe = t[20]);
  let se = oe,
    F = y ? Yn.collapsed : Yn.expanded,
    I;
  t[21] !== F.message || t[22] !== h
    ? ((I = h.formatMessage(F.message)), (t[21] = F.message), (t[22] = h), (t[23] = I))
    : (I = t[23]);
  let L = I,
    R = F.icon,
    z,
  ...
  if (
    ...
    (t[51] === a
      ? (q = t[52])
      : ((q = pe(`flex min-h-0 flex-1 flex-col select-none px-row-x`, a)),
        (t[51] = a),
        (t[52] = q)),
      t[53] === h
        ? (J = t[54])
        : ((J = h.formatMessage({
          ...
          (t[53] = h),
          (t[54] = J)),
      (ce = `flex min-h-0 flex-1 flex-col`),
      t[55] !== R || t[56] !== p || t[57] !== L || t[58] !== F.message
        ? ((V = p
            ? (0, Q.jsx)(`div`, {
                className: `mb-2 shrink-0`,
                children: (0, Q.jsx)(E, {
                  tooltipContent: (0, Q.jsx)(u, { ...F.message }),
                  children: (0, Q.jsx)(Ut, {
                    "aria-label": L,
                    fullWidth: !1,
                    icon: R,
      ...
      t[63] !== y || t[64] !== f
        ? ((U =
          ...
          (t[65] = U))
        : (U = t[65]),
      t[66] !== N || t[67] !== v || t[68] !== b
        ? ((W = b
            ? (0, Q.jsx)(In, {
                onKeyDown: N.getInputProps().onKeyDown,
                searchQuery: v,
                onQueryChange: (e) => {
                  (N.setHighlightedIndex(-1), ne(e));
                },
              })
            : null),
          (t[66] = N),
    ...
    (t[70] === c
      ? (z = t[71])
      : ((z = pe(`min-h-0 flex-1 overflow-y-auto pb-2`, c)), (t[70] = c), (t[71] = z)),
      (B = S
        ? (0, Q.jsx)(Ln, {
            intl: h,
        ...
        : e.map((e) =>
            (0, Q.jsx)(
              ...
              {
                className: `gap-0`,
                title: y || e.heading == null ? null : (0, Q.jsx)(u, { ...e.heading }),
                children: e.sections.map((e) => {
                  let t = e.slug === r,
                    n = !!e.externalUrl,
                    a = !!e.disabled,
                    o = t && e.slug === `pets` ? vn : Hn[e.slug],
                    c = h.formatMessage(Mt(e.slug)),
                    l = (t) => {
                      if (!a) {
                        if (n && e.externalUrl) {
                          K({ event: t, href: e.externalUrl, initiator: `open_in_browser_bridge` });
                          return;
                        }
                        i(e.slug);
                      }
                  ...
                  return (0, Q.jsx)(
                    E,
                    {
                      tooltipContent: y ? (0, Q.jsx)(Nt, { slug: e.slug }) : n ? se : ae,
                      side: `right`,
                      sideOffset: 12,
                      disabled: !y && !a && !n,
                      children: (0, Q.jsx)(Ut, {
    ...
    ((z = t[42]),
      ...
      (J = t[50]));
  let Y;
  t[72] !== p || t[73] !== y || t[74] !== h || t[75] !== S
    ? ((Y = S
        ? null
        : (0, Q.jsx)(E, {
            tooltipContent: y ? (0, Q.jsx)(u, { ...Un.chatSettings }) : se,
            side: `right`,
            sideOffset: 12,
            children: (0, Q.jsx)(Ut, {
              ...
              iconClassName: `icon-sm inline-block align-middle`,
              hideLabel: p ? y : void 0,
              label: (0, Q.jsx)(u, { ...Un.chatSettings }),
              onClick: An,
              trailing: y
                ? void 0
                : (0, Q.jsx)(G, {
  ...
  t[77] === l
    ...
    : ((X =
      ...
      (t[78] = X));
  let Z;
  t[79] !== z || t[80] !== B || t[81] !== Y || t[82] !== X
    ? ((Z = (0, Q.jsxs)(`div`, { className: z, children: [B, Y, X] })),
      (t[79] = z),
      (t[80] = B),
      (t[81] = Y),
      (t[82] = X),
    ...
    : (Z = t[83]);
  let de;
  t[84] !== ce || t[85] !== V || t[86] !== H || t[87] !== U || t[88] !== W || t[89] !== Z
    ? ((de = (0, Q.jsxs)(`div`, { className: ce, children: [V, H, U, W, Z] })),
      (t[84] = ce),
      (t[85] = V),
      (t[86] = H),
      (t[87] = U),
  ...
  let fe;
  return (
    t[91] !== q || t[92] !== J || t[93] !== de
      ? ((fe = (0, Q.jsx)(`nav`, { className: q, "aria-label": J, children: de })),
        (t[91] = q),
        (t[92] = J),
        (t[93] = de),
        (t[94] = fe))
...
function An(e) {
  K({ event: e, href: Jn, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
}
function jn(e) {
  return !e;
}
    ...
    ? ((p =
        r.length > 0
          ? (0, Q.jsx)(`button`, {
              ...
              type: `button`,
              children: (0, Q.jsx)(j, { className: `icon-2xs` }),
            })
          : null),
      (t[14] = a),
      (t[15] = i),
...
var Bn,
  ...
  Xn = e(() => {
    ((Bn = O()),
      ...
      (Yn = {
        collapsed: { icon: Me, message: Un.expandSidebar },
        expanded: { icon: Se, message: Un.collapseSidebar },
      }));
  }),
  Zn,
  Qn = e(() => {
...
function $n(e) {
  ...
  t[4] === n.locale
    ? (d = t[5])
    : ((d = [{ locale: Je, language: `en` }, ...rt().map(tr)].flatMap((e) => {
        let { language: t, locale: r } = e;
        return [Qe(r, r), Qe(t, n.locale)];
      })),
      (t[4] = n.locale),
      (t[5] = d));
  let f = d,
...
var rr,
  ...
  or = e(() => {
    ((rr = O()),
      ...
      q(),
      dn(),
      (ir = St.map((e) => ({ messages: Zn[e] ?? [], sectionSlug: e }))),
      (ar = [
...
function sr(e = null, t = !0, n = b) {
  ...
  let u = C(_t),
    d = c(Xt),
    f = A(),
    { isProfileVisible: p, isProfileVisibilityLoading: ee } = Et(),
    { isUsageSettingsVisible: te, isUsageSettingsAccessLoading: g } = kt(),
    _ = m({ hostId: n }),
    v = t && !l.isLoading && !l.allowed,
    ne =
      t &&
      !s.isLoading &&
    ...
    y = t && (_.available || l.available || v),
    x = t && (s.available || l.available || ne),
    S = wt.filter((e) => {
  ...
  if (D && !(!t && !lr.includes(E.slug)))
    switch (E.slug) {
      ...
      case `codex-micro`:
        ...
        break;
      case `computer-use`:
        k = _.isLoading || l.isLoading;
        break;
      case `browser-use`:
        k = s.isLoading || l.isLoading || f;
        break;
      case `local-environments`:
      case `worktrees`:
      case `environments`:
  ...
  return {
    activeSettingsSection: T?.slug ?? O,
    shouldRedirectToVisibleSettingsSection: D && !k,
    shouldRenderRouteContent: e !== `import` || !k,
    visibleSettingsSections: S,
  };
}
function cr(e) {
  return e == null ? null : (wt.find((t) => t.slug === e) ?? null);
}
var lr,
  ur,
  dr = e(() => {
...
function fr() {
  let e = (0, gr.c)(78),
    ...
    r = de(),
    i = B(),
    a = oe(`/settings/:section/*`)?.params.section ?? null,
    {
    ...
    d = ne(l).kind === `local`,
    {
      activeSettingsSection: f,
      shouldRedirectToVisibleSettingsSection: p,
      shouldRenderRouteContent: m,
      visibleSettingsSections: h,
    } = sr(a, d, l),
    te = Ie(),
    g = c(gt),
    _ = c(We),
    v;
  e[0] !== g || e[1] !== r
    ? ((v = () => hr(r, g)), (e[0] = g), (e[1] = r), (e[2] = v))
    : (v = e[2]);
  let y = v,
    x;
  e[3] === l ? (x = e[4]) : ((x = { selectedHostId: l }), (e[3] = l), (e[4] = x));
  let S = $n(x),
    C;
  e[5] !== o || e[6] !== n || e[7] !== s || e[8] !== l || e[9] !== u
    ? ((C =
  ...
  e[15] !== l || e[16] !== m
    ? ((A = m
        ? (0, $.jsx)(_r.Suspense, { fallback: (0, $.jsx)(nn, {}), children: (0, $.jsx)(Z, {}, l) })
        : (0, $.jsx)(nn, {})),
      (e[15] = l),
      (e[16] = m),
      (e[17] = A))
  ...
  e[18] !== i.state || e[19] !== r || e[20] !== t
    ? ((M = (e) => {
        (e === `profile` && ce(t, J, { source: `settings_page` }),
  ...
  e[27] === t.query
    ? (F = e[28])
    : ((F = () => {
        t.query.invalidate(Pt, { exact: !0 }).catch(pr);
      }),
      (e[27] = t.query),
      (e[28] = F));
  let I;
  (e[29] === t ? (I = e[30]) : ((I = [t]), (e[29] = t), (e[30] = I)), (0, _r.useEffect)(F, I));
  let L, R;
  if (
    (e[31] !== g || e[32] !== r
      ? ((L = () => {
    ...
    return (
      e[35] === t
        ? (n = e[36])
        : ((n = (0, $.jsx)(U, { to: t, replace: !0 })), (e[35] = t), (e[36] = n)),
      n
    );
  }
  if (te) {
    ...
    e[48] !== i.key || e[49] !== j || e[50] !== n
      ? ((r = (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(en, { navigationKey: i.key, targetId: n, children: j }),
        })),
        (e[48] = i.key),
        (e[49] = j),
        (e[50] = n),
    ...
    return (
      e[52] !== t || e[53] !== r
        ? ((a = (0, $.jsxs)(ut.Root, { children: [t, r] })), (e[52] = t), (e[53] = r), (e[54] = a))
        : (a = e[54]),
      a
    );
  }
  ...
  e[56] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((le = pe(
      ...
      (V = (0, $.jsx)(`div`, { className: `draggable h-toolbar w-full shrink-0` })),
      (e[56] = le),
      (e[57] = V))
    : ((le = e[56]), (V = e[57]));
  let H = y,
  ...
  e[64] !== h
    ...
    : (W = e[65]);
  let G;
  e[66] === i.hash ? (G = e[67]) : ((G = i.hash.slice(1) || null), (e[66] = i.hash), (e[67] = G));
  let K;
  e[68] !== i.key || e[69] !== j || e[70] !== G
    ? ((K = (0, $.jsx)(en, { navigationKey: i.key, targetId: G, children: j })),
      (e[68] = i.key),
      (e[69] = j),
      (e[70] = G),
      (e[71] = K))
  ...
  return (
    e[75] !== W || e[76] !== q
      ? ((Y = (0, $.jsxs)(`div`, { className: `flex h-full min-h-0`, style: z, children: [W, q] })),
        (e[75] = W),
        (e[76] = q),
        (e[77] = Y))
      : (Y = e[77]),
