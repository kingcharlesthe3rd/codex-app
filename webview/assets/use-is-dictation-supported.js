...
import { _r as y, m as b, mr as x, pr as S, yr as C } from "./src-4.js";
import { Ao as w, us as T } from "./app-server-manager-signals.js";
import { c as E, o as D } from "./lib-1.js";
import { T as O, o as k, t as A, w as j } from "./persisted-signal.js";
...
import { n as R } from "./rpc-2.js";
import { o as z, u as B } from "./statsig-DoZ-0xit.js";
...
import { v as re } from "./mention-item.js";
...
import { n as q } from "./json-1.js";
import { t as J } from "./folder.js";
import { t as ue } from "./image-square.js";
import { r as de } from "./modal-controller-state.js";
import { a as fe, d as Y, i as pe, l as me, n as he, r as ge, u as _e } from "./dialog-layout.js";
...
import { t as Me } from "./appshot-window-D.js";
import { t as Ne } from "./undo-C.js";
...
var Z = e(t()),
  ...
  Ge = c(s, `computer-use-frontmost-window`, {
    enabled: !1,
...
async function Ye(
  ...
  (p.info(`Appshot capture request created`, {
    ...
    o?.(u));
  let { transitionSnapshotScale: f, ...h } = Xe(t, c) ?? d;
  try {
    ...
    let t = await m(`computer-use-start-capture`, {
      params: { animationDestination: h, bundleIdentifier: c.bundleIdentifier, requestId: u },
    });
    if (
...
function $e(e) {
  ...
  if (t.update.type === `screenshot`) {
    (n.source === `hotkey` &&
      ...
      u.dispatchMessage(`open-current-main-window`, { stealFocus: !0 }),
      Ke.set(t.requestId, {
        ...n,
...
function it(e) {
  ...
  t[8] === n
    ? (u = t[9])
    : ((u = (0, Q.jsx)(N, { color: `ghost`, type: `button`, onClick: n, children: l })),
      (t[8] = n),
      (t[9] = u));
  let d;
...
var at = A(`has-accepted-appshot-intro`, !1);
function ot(e, t) {
  if (e.get(at)) {
    t();
    return;
...
function ut(e) {
  ...
  let A;
  t[15] !== T || t[16] !== n || t[17] !== o
    ? ((A = { hostId: n, directoryPath: T, directoriesOnly: o }),
      (t[15] = T),
      (t[16] = n),
      (t[17] = o),
      (t[18] = A))
  ...
  let j = T ?? ``,
    P;
  t[19] !== n || t[20] !== j ? ((P = [n, j]), (t[19] = n), (t[20] = j), (t[21] = P)) : (P = t[21]);
  let F;
  t[22] !== w || t[23] !== P
  ...
  t[25] !== A || t[26] !== F
    ...
    : (I = t[27]);
  let { data: L, error: R, isLoading: z } = h(`remote-workspace-directory-entries`, I),
    B = T || L?.directoryPath || ``,
    V = w && L?.directoryPath === B ? L.entries : lt,
    H = B;
  (o && (H = e.selectedPath || B), o && g && (H = b));
  let U;
  t[28] !== w ||
  t[29] !== L ||
  t[30] !== B ||
          ...
          Promise.all(
            e.map((e) =>
              a.prefetchQuery({
                ...
                queryFn: () =>
                  m(`remote-workspace-directory-entries`, {
...
function mt(e) {
  ...
  t[7] === r
    ? (p = t[8])
    : ((p = r ? (0, Q.jsx)(F, { className: `icon-xs shrink-0` }) : null), (t[7] = r), (t[8] = p));
  let m;
  return (
...
function wt() {
  ...
  return async ({
    ...
    (await m(`pick-files`, { params: { ...(t ? { imagesOnly: !0 } : {}), pickerTitle: n } }))
      .files ?? [];
}
var Tt = e(U(), 1),
...
function Dt(e) {
  ...
  let fe;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((fe = (0, Q.jsx)(X.Separator, {})), (t[54] = fe))
    : (fe = t[54]);
  let Y;
  t[55] !== r ||
  t[56] !== o ||
  ...
  t[73] !== W || t[74] !== b || t[75] !== T
    ...
    : (ve = t[76]);
  let ye;
  t[77] !== P || t[78] !== U || t[79] !== he || t[80] !== ge || t[81] !== _e || t[82] !== ve
    ? ((ye = (0, Q.jsxs)(`div`, {
        className: `flex w-full items-center justify-between gap-2`,
        children: [
          me,
  ...
  t[84] !== pe || t[85] !== ye
    ...
    : (be = t[86]);
  let xe;
  t[87] !== r || t[88] !== te || t[89] !== oe || t[90] !== s || t[91] !== d || t[92] !== T
    ? ((xe = d
        ? (0, Q.jsx)(X.Item, {
            LeftIcon: Se,
            leftIconClassName: `icon-xs`,
...
function jt(e) {
  return b(e.fsPath || e.path || e.label);
}
...
function Nt(e) {
  return { label: w(e), path: e, fsPath: e };
}
async function Pt(e) {
  try {
    let t = await m(`read-file-binary`, { params: { path: e.fsPath, hostId: T } });
...
function Lt(e) {
  ...
  if (
    ...
    t[22] !== T || t[23] !== g
      ? ((c = g
          ? (e) => {
              (e.key === `Enter` || e.key === ` `) && (e.preventDefault(), T(!0));
            }
          : void 0),
        (t[22] = T),
        (t[23] = g),
...
function Ht(e) {
  let t = (0, $.c)(29),
    ...
    u;
  t[0] === l ? (u = t[1]) : ((u = M(`flex items-center gap-2 px-2`, l)), (t[0] = l), (t[1] = u));
  let d;
  t[2] === o
    ? (d = t[3])
    : ((d =
  ...
  t[4] === r
    ...
    : ((f = (0, Q.jsx)(`div`, {
      ...
      (t[5] = f));
  let p;
  t[6] === n ? (p = t[7]) : ((p = ze(n)), (t[6] = n), (t[7] = p));
  let m;
  t[8] === p
    ? (m = t[9])
    : ((m = (0, Q.jsx)(`span`, {
  ...
  let h;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Q.jsx)(We, { className: `icon-2xs` })), (t[10] = h))
    : (h = t[10]);
  let g;
  t[11] !== i.ariaLabel || t[12] !== i.disabled || t[13] !== i.onClick
    ...
    : (g = t[14]);
  let _;
  t[15] !== i.tooltipContent || t[16] !== g || t[17] !== c
    ? ((_ = (0, Q.jsx)(L, {
  ...
  let y;
  return (
    t[22] !== _ || t[23] !== v || t[24] !== u || t[25] !== d || t[26] !== f || t[27] !== m
      ? ((y = (0, Q.jsxs)(ie, { className: u, children: [d, f, m, _, v] })),
        (t[22] = _),
        (t[23] = v),
        (t[24] = u),
        (t[25] = d),
...
function Zt(e) {
  ...
  bb0: switch (i) {
    case `starting`: {
      ...
      (t[4] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        : (i = t[4]),
        (_ = i),
        (v = `bg-token-foreground text-token-dropdown-background enabled:hover:bg-token-foreground/80`));
      break bb0;
    }
    case `active`: {
      let e;
      ...
      (t[9] === c
        ...
        : ((i = (0, Q.jsx)(`canvas`, {
          ...
          (t[10] = i)),
        (_ = i),
        (v = `bg-token-charts-blue text-white enabled:hover:bg-token-charts-blue/90 enabled:active:bg-token-charts-blue/80`));
      break bb0;
    }
    case `stopping`: {
      let e;
      ...
      (t[15] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((i = (0, Q.jsx)(P, { className: `icon-2xs` })), (t[15] = i))
        : (i = t[15]),
        (_ = i),
        (v = `bg-token-foreground text-token-dropdown-background`));
    }
  }
  let y = f ? `mb-0` : `mb-2`,
    b;
  t[16] === y
    ? (b = t[17])
    : ((b = M(`flex items-center gap-2 px-2`, y)), (t[16] = y), (t[17] = b));
  let x, S;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, Q.jsx)(Et, {
      ...
      (S = (0, Q.jsx)(`div`, { className: `min-w-0 flex-1` })),
      (t[18] = x),
      (t[19] = S))
    : ((x = t[18]), (S = t[19]));
  let C;
  ...
  t[35] === C
    ? (w = t[36])
    : ((w = (0, Q.jsx)(`div`, { className: `flex shrink-0 items-center gap-2`, children: C })),
      (t[35] = C),
      (t[36] = w));
  let O;
  return (
    t[37] !== b || t[38] !== w
      ? ((O = (0, Q.jsxs)(ie, { className: b, children: [x, S, w] })),
        (t[37] = b),
        (t[38] = w),
        (t[39] = O))
      : (O = t[39]),
  ...
  let N = () => {
    ...
    P = async (e) => {
      ...
      try {
        ...
        p.warning(`[Composer] streaming dictation failed`, { safe: {}, sensitive: { error: e } });
      }
      return Re(e);
    },
    F = async ({ action: e, audio: t, handlers: n }) => {
      w.current && m(!0);
      try {
        let r = await Be({
        ...
        let i = r.trim();
        i.length > 0 &&
          (l.getInstance().dispatchMessage(`global-dictation-record-history-item`, { text: i }),
          e === `send` ? n.onTranscriptSend(i) : n.onTranscriptInsert(i));
      } catch (r) {
        (p.error(`[Composer] dictation failed`, { safe: {}, sensitive: { error: r } }),
    ...
    L = async () => {
      ...
      await F({ action: e, audio: new Blob(i, { type: o }), handlers: t });
    },
    B = I(async () => {
      if (u || f) return;
      let e = C.current;
      ...
      startDictation: I(async () => {
        if (!(u || f)) {
          ...
          try {
                ...
                t.start(e).then(
                  ...
                  (e) => {
                    b.current === t &&
                      ((b.current = null),
                      t.close(),
                      p.warning(`[Composer] unable to start streaming dictation`, {
                        safe: {},
                        sensitive: { error: e },
                      }));
                  },
            ...
            (p.error(`[Composer] unable to start dictation`, { safe: {}, sensitive: { error: e } }),
...
function fn(e) {
  ...
  let y = v,
    b;
  t[2] !== n || t[3] !== d || t[4] !== i || t[5] !== s || t[6] !== c
    ? ((b = () => (!n || i || (d != null && pn(s, d)) ? !1 : c == null || c())),
      (t[2] = n),
      (t[3] = d),
      (t[4] = i),
      (t[5] = s),
  ...
  t[8] !== x || t[9] !== r || t[10] !== f || t[11] !== y
    ? ((S = (e) => {
        !f ||
          ...
          u.dispatchMessage(`global-dictation-in-app-started`, { sessionId: e.sessionId }),
          !(r || _.current) && y());
      }),
      (t[8] = x),
      (t[9] = r),
  ...
  (t[13] === Symbol.for(`react.memo_cache_sentinel`) ? ((C = []), (t[13] = C)) : (C = t[13]),
    g(`global-dictation-in-app-start`, S, C));
  let w;
  t[14] !== f || t[15] !== o
    ? ((w = (e) => {
  ...
  (t[17] === Symbol.for(`react.memo_cache_sentinel`) ? ((T = []), (t[17] = T)) : (T = t[17]),
    g(`global-dictation-in-app-stop`, w, T));
  let E = p ?? ``,
    D = n && p != null,
    O = d ?? void 0,
    k;
