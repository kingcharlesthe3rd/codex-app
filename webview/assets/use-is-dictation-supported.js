...
import { fr as b, m as x, or as S, sr as C, ur as w } from "./src-1.js";
import { c as T, o as E } from "./lib.js";
import { T as D, o as O, t as k, w as A } from "./persisted-signal.js";
...
import { A as L, n as R } from "./rpc-1.js";
import { o as z, u as B } from "./statsig.js";
import { t as V } from "./use-collaboration-mode.js";
import { n as H } from "./use-auth.js";
import { t as U } from "./mime-types.js";
import { r as ee } from "./toast-signal.js";
import { t as te } from "./arrow-up.js";
import { t as ne } from "./use-debounced-value.js";
import { y as re } from "./mention-item-B.js";
import { t as ie } from "./composer-footer.js";
import { t as W } from "./apps.js";
import { t as ae } from "./x.js";
import { t as oe } from "./use-is-plugins-enabled.js";
import { m as se } from "./use-plugins.js";
import { t as G } from "./app-intl-signal-D.js";
import { t as ce } from "./with-window.js";
import { a as le, i as K } from "./use-native-apps.electron.js";
import { n as q } from "./json.js";
...
import { i as ye } from "./command-keybindings.js";
import { t as be } from "./badge.js";
import { r as X, t as xe } from "./dropdown.js";
import { t as Se } from "./target.js";
import { t as Ce } from "./plus.js";
import { t as we } from "./image-preview-dialog.js";
import { a as Te } from "./plugins-page-selectors-D.js";
import { n as Ee } from "./appshot-availability-BoK-Z77O.js";
import { r as De, t as Oe } from "./attachment-remove-button.js";
import { t as ke } from "./appshot-logo.js";
import { t as Ae } from "./toggle.js";
import { t as je } from "./regenerate.js";
import { t as Me } from "./appshot-window.js";
import { t as Ne } from "./undo-C_qr-caq.js";
import { t as Pe } from "./plan.js";
import { t as Fe } from "./use-composer-controller.js";
import { a as Ie, i as Le, n as Re, r as ze, t as Be } from "./transcribe-audio.js";
import { n as Ve, t as He } from "./use-recording-waveform.js";
...
var Z = e(t()),
  ...
  Ge = l(s, `computer-use-frontmost-window`, {
    enabled: !1,
...
async function Ye(
  ...
  (m.info(`Appshot capture request created`, {
    ...
    o?.(u));
  let { transitionSnapshotScale: f, ...p } = Xe(t, c) ?? d;
  try {
    ...
    if (
      ...
      (i?.(u, null),
        tt(u, { status: `failed`, failureReason: `start_response_missing` })?.onAttachError());
      return;
    }
    let n = Ke.get(u),
      r = t.transitionSnapshotHeight == null ? null : t.transitionSnapshotHeight / f;
    (n != null && Ke.set(u, { ...n, transitionSnapshotHeight: r }),
    ...
    (m.warning(`Appshot capture start request failed`, {
      ...
      i?.(u, null),
      tt(u, { status: `failed`, failureReason: `start_request_failed` })?.onAttachError());
  }
}
function Xe(e, t) {
  let n = e(t);
  if (n == null || !Ze(n)) return;
  let {
    backgroundColor: r,
    cornerRadius: i,
    primaryTextColor: a,
...
function $e(e) {
  ...
  if (
    ...
    tt(t.requestId, { status: `discarded` });
    return;
  }
  if (t.update.type === `failed`) {
    (tt(t.requestId, { status: `failed`, failureReason: t.update.failureReason }),
      n.onAttachError());
    return;
  }
  if (t.update.type === `metadata`) {
    Ke.set(t.requestId, { ...n, bundleIdentifier: t.update.app.bundleIdentifier });
    return;
  }
  if (t.update.type === `axText`) {
    Ke.set(t.requestId, { ...n, text: t.update.text });
    return;
  }
  if (t.update.type === `screenshot`) {
    (n.source === `hotkey` &&
      ...
      d.dispatchMessage(`open-current-main-window`, { stealFocus: !0 }),
      Ke.set(t.requestId, {
        ...n,
  ...
  if (n.imageDataUrl == null) {
    (tt(t.requestId, { status: `failed`, failureReason: `completed_without_screenshot` }),
      n.onAttachError());
    return;
  }
  let r = n.target.appIconDataUrl ?? n.target.iconSmallDataURL;
  (De(n.scope, n.bundleIdentifier, n.filename, r),
    ...
    tt(t.requestId, { status: `success` }));
}
function et(e) {
  let t = e.text?.match(qe)?.[1]?.trim();
...
function nt(e, t) {
  let n = Ke.get(e);
  return n == null ? null : (Ke.delete(e), n.onCaptureSettled?.(e, t === `success`), n);
}
function rt(e) {
...
function it(e) {
  ...
  t[8] === n
    ? (u = t[9])
    : ((u = (0, Q.jsx)(M, { color: `ghost`, type: `button`, onClick: n, children: l })),
      (t[8] = n),
      (t[9] = u));
  let d;
  ...
  t[11] === u
    ? (f = t[12])
    : ((f = (0, Q.jsx)(fe, { children: (0, Q.jsxs)(ge, { children: [u, d] }) })),
      (t[11] = u),
      (t[12] = f));
  let p;
  t[13] !== i || t[14] !== f
    ? ((p = (0, Q.jsxs)(he, { as: `form`, onSubmit: i, children: [a, o, c, f] })),
      (t[13] = i),
      (t[14] = f),
      (t[15] = p))
    : (p = t[15]);
  ...
  return (
    t[16] !== n || t[17] !== p
      ? ((m = (0, Q.jsx)(me, { open: !0, onOpenChange: n, size: `compact`, children: p })),
        (t[16] = n),
        (t[17] = p),
        (t[18] = m))
      : (m = t[18]),
...
var at = k(`has-accepted-appshot-intro`, !1);
function ot(e, t) {
  if (e.get(at)) {
    t();
    return;
    ...
    : ((S = (0, Q.jsx)(X.ItemIcon, {
        ...
        children:
          y?.iconSmallDataURL == null
            ? (0, Q.jsx)(Me, { "aria-hidden": !0, className: `size-4` })
            : (0, Q.jsx)(`img`, {
...
function ut(e) {
  ...
  t[15] !== D || t[16] !== n || t[17] !== o
    ? ((A = { hostId: n, directoryPath: D, directoriesOnly: o }),
      (t[15] = D),
      (t[16] = n),
      (t[17] = o),
      (t[18] = A))
  ...
  let N = D ?? ``,
    P;
  t[19] !== n || t[20] !== N ? ((P = [n, N]), (t[19] = n), (t[20] = N), (t[21] = P)) : (P = t[21]);
  let F;
  t[22] !== w || t[23] !== P
    ? ((F = { cacheKey: P, enabled: w, staleTime: 0 }), (t[22] = w), (t[23] = P), (t[24] = F))
    : (F = t[24]);
  let I;
  t[25] !== A || t[26] !== F
    ? ((I = { params: A, queryConfig: F }), (t[25] = A), (t[26] = F), (t[27] = I))
    : (I = t[27]);
  let { data: L, error: R, isLoading: z } = g(`remote-workspace-directory-entries`, I),
    B = D || L?.directoryPath || ``,
    V = w && L?.directoryPath === B ? L.entries : lt,
    H = B;
  (o && (H = e.selectedPath || B), o && m && (H = b));
  let U;
  t[28] !== w ||
  t[29] !== L ||
  t[30] !== B ||
  ...
  t[35] !== e.selectedPath
    ? ((U = ft(H)),
      w &&
        ...
        (!m || H === B) &&
        (U =
          o && V.some((t) => t.type === `directory` && t.path === e.selectedPath)
            ? B
            : L.parentPath),
      (t[28] = w),
      (t[29] = L),
  ...
  t[51] !== U || t[52] !== e
    ? ((K = () => {
        U != null && (oe(U), e.mode !== `file` && e.setSelectedPath(U));
      }),
      (t[51] = U),
      (t[52] = e),
      (t[53] = K))
  ...
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = (0, Q.jsx)(Ne, { className: `icon-2xs` })), (t[54] = q))
    : (q = t[54]);
  let J;
  t[55] !== re || t[56] !== ee || t[57] !== K
    ? ((J = (0, Q.jsx)(M, {
        className: `shrink-0`,
        color: `ghost`,
        size: `composerSm`,
  ...
  t[63] === G
    ? (pe = t[64])
    : ((pe = (e) => {
        e.key === `Enter` && (e.preventDefault(), G(e.currentTarget.value));
      }),
      (t[63] = G),
      (t[64] = pe));
  let me;
...
function ft(e) {
  ...
  let t = C(e),
    n = t ? w(e) : e,
    r = ct.default.posix.dirname(n),
    i = C(n) && /^[A-Za-z]:$/.test(r) ? `${r}/` : r;
...
function mt(e) {
  ...
  let u = i ? void 0 : a,
    d;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(q, { className: `icon-xs shrink-0 text-token-description-foreground` })),
      (t[4] = d))
    : (d = t[4]);
  let f;
  t[5] === n.name
  ...
  t[7] === r
    ? (p = t[8])
    : ((p = r ? (0, Q.jsx)(P, { className: `icon-xs shrink-0` }) : null), (t[7] = r), (t[8] = p));
  let m;
  return (
...
function yt(e) {
  ...
  if (t[2] !== c || t[3] !== a || t[4] !== r || t[5] !== i || t[6] !== s) {
    ...
    bb0: {
      ...
      let n = new Map();
      for (let e of Te(c)) n.set(e.plugin.id, e);
      let o = [];
      for (let e of _t) {
        let t = n.get(e);
        t != null && o.push([e, t]);
          ...
          children: o.map((t) => {
            ...
            return (0, Q.jsx)(
              X.Item,
              {
                ...
                onSelect: () => {
                  (a.insertMentionAtSelection(o), r());
                },
                children: bt(n),
              },
              n,
    ...
    ((t[2] = c), (t[3] = a), (t[4] = r), (t[5] = i), (t[6] = s), (t[7] = l), (t[8] = u));
  } else ((l = t[7]), (u = t[8]));
  return u === Symbol.for(`react.early_return_sentinel`) ? l : u;
}
function bt(e) {
  switch (e) {
...
var Tt = e(U(), 1),
  Et = (0, Z.memo)(function (e) {
    ...
    let [ne, re] = (0, Z.useState)(te),
      {
        ...
        handleSelectAndClose: ce,
      } = Ct(),
      { isFetching: le, refetch: K } = o(Ge),
      q = N && _ !== `local`,
      J = R && d != null,
      ue;
    t[1] !== L || t[2] !== q || t[3] !== j
    ...
    let ye = ve,
      X,
      Se;
    if (t[9] !== P || t[10] !== le || t[11] !== K || t[12] !== W || t[13] !== J) {
      ((X = function (t) {
        (!t && B.current) || (W(t), t && e());
      }),
        (Se = function () {
      ...
      ((t[9] = P), (t[10] = le), (t[11] = K), (t[12] = W), (t[13] = J), (t[14] = X), (t[15] = Se));
    } else ((X = t[14]), (Se = t[15]));
    let we, Te;
    if (
      t[16] !== _e ||
        ...
        if (!P)
          try {
            let e = f(),
              t =
                k == null
                  ? await z({ imagesOnly: !j, pickerTitle: _e })
                  : await k({ imagesOnly: !j });
            if (t.length === 0) return;
            let { images: i, others: a } = At(t),
              o = [];
            if ((i.length > 0 && (o = await r(i)), f() !== e)) return;
            (o.length > 0 && n(o),
              j && a.length > 0 && (_ !== `local` && m != null ? m(a) : p((e) => [...e, ...a])));
          } catch {
            F.get(ee).danger(
              L.formatMessage({
      ...
      let e;
      (t[32] !== ne || t[33] !== p || t[34] !== q
        ? ((e = function () {
            !q || ne.length === 0 || (p((e) => [...e, ...ne.map(Nt)]), ye());
          }),
          (t[32] = ne),
          (t[33] = p),
          (t[34] = q),
        ...
        (Te = e));
      async function r(e) {
        return (await Promise.all(e.map(Pt))).filter(Ft);
      }
      ((t[16] = _e),
        (t[17] = P),
        (t[18] = _),
        ...
        (t[30] = we),
        (t[31] = Te));
    } else ((we = t[30]), (Te = t[31]));
    let De;
    t[36] === w
      ? (De = t[37])
      : ((De = (e) => {
          V.current && ((V.current = !1), e.preventDefault(), w());
        }),
        (t[36] = w),
        (t[37] = De));
    let Oe;
    ...
    t[46] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((Me = (0, Q.jsx)(Ce, { className: `icon-sm` })), (t[46] = Me))
      : (Me = t[46]);
    let Ne;
    t[47] !== de || t[48] !== P || t[49] !== se || t[50] !== G || t[51] !== Se || t[52] !== je
      ? ((Ne = (0, Q.jsx)(M, {
          size: `composer`,
          color: `ghost`,
          uniform: !0,
      ...
      : (Ne = t[53]);
    let Pe;
    t[54] !== Ae || t[55] !== Ne || t[56] !== ae || t[57] !== oe
      ? ((Pe = (0, Q.jsx)(I, {
          open: ae,
          triggerRef: oe,
          tooltipContent: Ae,
    ...
    t[80] !== j
      ? ((Ie = (0, Q.jsx)(Dt, {
          ...
          setIsAutoContextOn: y,
          setIsDropdownOpen: W,
          shouldShowAppshotCapture: J,
          shouldOpenGoalEditorOnCloseRef: V,
          shouldShowRemoteFileAttachments: q,
          supportsFileAttachments: j,
          togglingSwitchRef: B,
        })),
        (t[60] = h),
        (t[61] = P),
      ...
      : (Ie = t[81]);
    let Le;
    t[82] !== P || t[83] !== X || t[84] !== ie || t[85] !== Pe || t[86] !== Ie || t[87] !== De
      ? ((Le = (0, Q.jsx)(xe, {
          open: ie,
          disabled: P,
          onOpenChange: X,
      ...
      : (Le = t[88]);
    let Re;
    t[89] !== g || t[90] !== _ || t[91] !== Te || t[92] !== H || t[93] !== ne || t[94] !== q
      ? ((Re = q
          ? (0, Q.jsx)(me, {
              open: H,
              onOpenChange: (e) => {
...
function Dt(e) {
  let t = (0, $.c)(111),
    ...
    O = T(),
    { activeMode: k, modes: A, setSelectedMode: j, isLoading: M } = V(n),
    N = l === `connected`,
    P = k.mode === `plan`,
    F;
  t[0] === A ? (F = t[1]) : ((F = A.some(kt)), (t[0] = A), (t[1] = F));
  let I = F,
    L;
  t[2] === A ? (L = t[3]) : ((L = A.some(Ot)), (t[2] = A), (t[3] = L));
  let R = L,
    z;
  t[4] === O
    ? (z = t[5])
  ...
  let re = ne,
    ie;
  t[13] !== r || t[14] !== R || t[15] !== I || t[16] !== p || t[17] !== j
    ? ((ie = function (e) {
        if (!r && I) {
          if (e) {
            (p(), j(`plan`));
  ...
  t[26] !== S
    ? ((ae = function (e) {
        if (!r) {
          if (e) {
            (P && j(R ? `default` : null), (S.current = !0), o());
            return;
          }
          (p(), b(!0));
        }
  ...
  t[49] !== r || t[50] !== o || t[51] !== m || t[52] !== C
    ...
    : (J = t[53]);
  let de;
  t[54] !== r || t[55] !== o || t[56] !== c
    ? ((de = r ? null : (0, Q.jsx)(yt, { hostId: c, handleSelectAndClose: o })),
      (t[54] = r),
      (t[55] = o),
      (t[56] = c),
      (t[57] = de))
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((fe = (0, Q.jsx)(X.Separator, {})), (t[58] = fe))
    : (fe = t[58]);
  let Y;
  t[59] !== r ||
  t[60] !== o ||
  ...
  t[77] !== W || t[78] !== b || t[79] !== D
    ...
    : (ve = t[80]);
  let ye;
  t[81] !== P || t[82] !== U || t[83] !== he || t[84] !== ge || t[85] !== _e || t[86] !== ve
    ? ((ye = (0, Q.jsxs)(`div`, {
        className: `flex w-full items-center justify-between gap-2`,
        children: [
          me,
  ...
  t[88] !== pe || t[89] !== ye
    ...
    : (be = t[90]);
  let xe;
  t[91] !== r || t[92] !== te || t[93] !== oe || t[94] !== s || t[95] !== d || t[96] !== D
    ? ((xe = d
        ? (0, Q.jsx)(X.Item, {
            LeftIcon: Se,
            leftIconClassName: `icon-xs`,
    ...
    : (xe = t[97]);
  let Ce;
  t[98] !== r || t[99] !== o || t[100] !== c
    ? ((Ce = r ? null : (0, Q.jsx)(xt, { hostId: c, handleSelectAndClose: o })),
      (t[98] = r),
      (t[99] = o),
      (t[100] = c),
      (t[101] = Ce))
  ...
  return (
    ...
    t[108] !== xe ||
    t[109] !== Ce
      ? ((we = (0, Q.jsxs)(Q.Fragment, { children: [K, q, J, de, fe, Y, be, xe, Ce] })),
        (t[102] = K),
        (t[103] = q),
        (t[104] = J),
        (t[105] = de),
...
function At(e) {
  let t = [],
    n = [];
  for (let r of e) jt(r) ? t.push(r) : n.push(r);
  return { images: t, others: n };
}
function jt(e) {
  return x(e.fsPath || e.path || e.label);
}
function Mt({ contentsBase64: e, fsPath: t }) {
  let n = (0, Tt.lookup)(t);
  return typeof n == `string` ? `data:${n};base64,${e}` : null;
}
function Nt(e) {
  return { label: L(e), path: e, fsPath: e };
}
async function Pt(e) {
  try {
    let t = await h(`read-file-binary`, { params: { path: e.fsPath, hostId: c } });
    if (!t.contentsBase64) return null;
    let n = Mt({ contentsBase64: t.contentsBase64, fsPath: e.fsPath });
...
function Lt(e) {
  ...
  let E = w,
    D;
  t[3] !== m || t[4] !== n
    ? ((D = { alt: m, src: n }), (t[3] = m), (t[4] = n), (t[5] = D))
    : (D = t[5]);
  let O = D,
    k;
  ...
  if (
    ...
    let e =
      ...
      i = v ? `size-[54px]` : `size-20`,
      o = g ? `cursor-interaction` : `cursor-default`,
      s;
    t[19] !== i || t[20] !== o
      ? ((s = j(
    ...
    let l;
    t[25] !== m || t[26] !== n
      ? ((l = (0, Q.jsx)(`img`, { src: n, alt: m, className: `size-full object-cover` })),
        (t[25] = m),
        (t[26] = n),
        (t[27] = l))
      : (l = t[27]);
...
function Ht(e) {
  let t = (0, $.c)(29),
    ...
    d;
  t[0] === u ? (d = t[1]) : ((d = j(`flex items-center gap-2 px-2`, u)), (t[0] = u), (t[1] = d));
  let f;
  t[2] === o
    ? (f = t[3])
    : ((f =
  ...
  t[4] === r
    ...
    : ((p = (0, Q.jsx)(`div`, {
      ...
      (t[5] = p));
  let m;
  t[6] === n ? (m = t[7]) : ((m = Ve(n)), (t[6] = n), (t[7] = m));
  let h;
  t[8] === m
    ? (h = t[9])
    : ((h = (0, Q.jsx)(`span`, {
  ...
  let g;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, Q.jsx)(We, { className: `icon-2xs` })), (t[10] = g))
    : (g = t[10]);
  let _;
  ...
  return (
    t[22] !== v || t[23] !== y || t[24] !== d || t[25] !== f || t[26] !== p || t[27] !== h
      ? ((b = (0, Q.jsxs)(ie, { className: d, children: [f, p, h, v, y] })),
        (t[22] = v),
        (t[23] = y),
        (t[24] = d),
        (t[25] = f),
...
function Xt(e) {
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, Q.jsx)(te, { className: `icon-sm text-token-dropdown-background` })), (t[14] = v))
    : (v = t[14]);
  let y;
...
function Zt(e) {
  ...
  bb0: switch (i) {
    case `starting`: {
      ...
      let i;
      (t[4] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((i = (0, Q.jsx)(ae, { className: `icon-2xs` })), (t[4] = i))
        : (i = t[4]),
        (v = i),
    ...
    case `stopping`: {
      ...
      (t[15] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((i = (0, Q.jsx)(N, { className: `icon-2xs` })), (t[15] = i))
        : (i = t[15]),
        (v = i),
  ...
  t[16] === b
    ? (x = t[17])
    : ((x = j(`flex items-center gap-2 px-2`, b)), (t[16] = b), (t[17] = x));
  let S, C;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, Q.jsx)(Et, {
        onAddImageDataUrls: an,
        onAddAppshotContext: rn,
        getAttachmentGen: nn,
        setFileAttachments: tn,
        conversationId: null,
        executionTargetCwd: null,
        executionTargetHostId: c,
        isAutoContextOn: !1,
        setIsAutoContextOn: en,
        ideContextStatus: `no-connection`,
        hasGoal: !1,
        isGoalActionAvailable: !1,
        onClearGoal: $t,
  ...
  t[35] === w
    ? (D = t[36])
    : ((D = (0, Q.jsx)(`div`, { className: `flex shrink-0 items-center gap-2`, children: w })),
      (t[35] = w),
      (t[36] = D));
  let O;
  return (
    t[37] !== x || t[38] !== D
      ? ((O = (0, Q.jsxs)(ie, { className: x, children: [S, C, D] })),
        (t[37] = x),
        (t[38] = D),
        (t[39] = O))
      : (O = t[39]),
...
function cn({
  ...
  let s = z(`1025755912`),
    ...
    }),
    {
      ...
      waveformCanvasRef: k,
      startWaveformCapture: A,
      stopWaveformCapture: j,
      resetWaveformDisplay: M,
    } = He();
  ((D.current = {
    onTranscriptInsert: t,
    onTranscriptSend: n,
  ...
  let N = () => {
    ...
    P = async (e) => {
      ...
      let t = y.current;
      if (((y.current = null), t == null)) return Be(e);
      try {
    ...
    I = async ({ action: e, audio: t, handlers: n }) => {
      w.current && p(!0);
      try {
        let r = await Re({
          transcript: await P(t),
        ...
        let i = r.trim();
        i.length > 0 &&
          (u.getInstance().dispatchMessage(`global-dictation-record-history-item`, { text: i }),
          e === `send` ? n.onTranscriptSend(i) : n.onTranscriptInsert(i));
      } catch (r) {
        (m.error(`[Composer] dictation failed`, { safe: {}, sensitive: { error: r } }),
          w.current && ((C.current = { action: e, audio: t, handlers: n }), g(!0)),
    ...
    L = async () => {
      let e = S.current ?? `insert`,
        t = D.current;
      S.current = null;
      let n = Math.max(O, E.current == null ? 0 : performance.now() - E.current);
      E.current = null;
      let r = _.current,
        i = x.current;
      ((x.current = []),
      ...
      await I({ action: e, audio: new Blob(i, { type: o }), handlers: t });
    },
    B = F(async () => {
      if (l || f) return;
      let e = C.current;
        ...
        if (!(l || f)) {
          ...
          try {
            ((C.current = null),
              g(!1),
              j(),
              R.systemPermissions?.requestMicrophoneAccess().catch(() => {}));
            ...
            ((E.current = performance.now()), (v.current = e), A(e));
            ...
            if (
              ...
              ((b.current = t),
                t.start(e).then(
                  () => {
                    if (b.current === t) {
                      if (((b.current = null), !w.current || !T.current || v.current !== e)) {
                        t.close();
                        return;
                      }
                      y.current = t;
            ...
            (m.error(`[Composer] unable to start dictation`, { safe: {}, sensitive: { error: e } }),
              w.current && D.current.onStartError(e));
            let t = _.current;
...
var ln = `[data-codex-terminal]`;
function un() {
  return i(ye, `composer.startDictation`);
}
function dn() {
  let e = (0, $.c)(2),
    t = un();
  ...
  let n;
  return (e[0] === t ? (n = e[1]) : ((n = ve(t)), (e[0] = t), (e[1] = n)), n);
}
function fn(e) {
  let t = (0, $.c)(31),
    {
  ...
  t[2] !== n || t[3] !== u || t[4] !== i || t[5] !== s || t[6] !== c
    ? ((b = () => (!n || i || (u != null && pn(s, u)) ? !1 : c == null || c())),
      (t[2] = n),
      (t[3] = u),
      (t[4] = i),
      (t[5] = s),
  ...
  let x = b,
    S;
  t[8] !== x || t[9] !== r || t[10] !== f || t[11] !== y
    ? ((S = (e) => {
        !f ||
          !x() ||
          ((m.current = e.sessionId),
          d.dispatchMessage(`global-dictation-in-app-started`, { sessionId: e.sessionId }),
          !(r || g.current) && y());
      }),
      (t[8] = x),
      (t[9] = r),
    ...
    : (S = t[12]);
  let C;
  (t[13] === Symbol.for(`react.memo_cache_sentinel`) ? ((C = []), (t[13] = C)) : (C = t[13]),
    _(`global-dictation-in-app-start`, S, C));
  let w;
  t[14] !== f || t[15] !== o
    ? ((w = (e) => {
        !f || m.current !== e.sessionId || ((m.current = null), o(`insert`));
      }),
      (t[14] = f),
      (t[15] = o),
      (t[16] = w))
  ...
  (t[17] === Symbol.for(`react.memo_cache_sentinel`) ? ((T = []), (t[17] = T)) : (T = t[17]),
    _(`global-dictation-in-app-stop`, w, T));
  let E = p ?? ``,
    D = n && p != null,
    O = u ?? void 0,
    k;
  t[18] !== x || t[19] !== r || t[20] !== y
    ? ((k = (e) => {
        if ((e.preventDefault(), e.stopPropagation(), !x() || r || g.current)) {
          h.current = !1;
          return;
        }
        ((h.current = !0), y());
  ...
  t[22] === o
    ...
    : ((A = (e) => {
        (e.preventDefault(),
          e.stopPropagation(),
          !(!h.current || m.current != null) && ((h.current = !1), o(`insert`)));
      }),
      (t[22] = o),
      (t[23] = A));
  let j;
  (t[24] !== s || t[25] !== O || t[26] !== k || t[27] !== A || t[28] !== E || t[29] !== D
    ? ((j = {
        accelerator: E,
        enabled: D,
        ignoreWithin: O,
