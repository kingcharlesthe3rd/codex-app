    ...
    switch (n.code) {
      case `login-required`:
        ...
        if (o === `connection-status-badge`) {
          ...
          return { action: { kind: `settings`, label: t }, label: l, message: `${a} ${t}` };
        }
      ...
      case `update-required`:
        return r === `wsl`
          ...
          : o === `connections-row`
            ...
            : {
                action: { kind: `settings`, label: e.formatMessage(c.goToSettings) },
                label: l,
                message: a,
              };
      case `connection-failed`:
...
//# sourceMappingURL=app-initial~app-main~projects-index-page~remote-connections-settings~local-conversation-pag~goqedmh7.js.map
