...
import { _n as t } from "./app-server-manager-signals.js";
...
import { i as w, t as T } from "./skus.js";
...
import { t as k } from "./codex-api-error.js";
...
function V(e) {
  ...
  let s = n && !a && i != null,
    l;
  t[4] === i ? (l = t[5]) : ((l = async () => (i == null ? null : Y(i))), (t[4] = i), (t[5] = l));
  let u;
  return (
    t[6] !== o || t[7] !== s || t[8] !== l
      ? ((u = {
...
function fe(e) {
  ...
  t[2] === n
    ...
    : ((s = async () => {
        ...
        let e = await b.safeGet(`/checkout_pricing_config/configs/{country_code}`, {
...
function U() {
  ...
  e[1] !== n || e[2] !== t
    ? ((i = {
        ...
        mutationFn: G,
        onSuccess: (e) => {
          M(e.immediate_top_up_status) || X({ scope: t, queryClient: n, response: e });
        },
      }),
      (e[1] = n),
      (e[2] = t),
...
function q() {
  ...
  e[1] === r
    ...
    : ((i = [...L, r, `save`]),
      (a = async (e) => {
        ...
        return b.safePatch(`/accounts/{account_id}/workspace_admin_requests/{request_id}`, {
  ...
  e[4] !== r || e[5] !== t
    ? ((s = (e) => {
        (t.setQueryData([...L, r], (t) => he(t, e)), t.invalidateQueries({ queryKey: [...L, r] }));
      }),
      (e[4] = r),
      (e[5] = t),
      (e[6] = s))
...
function J(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = { queryConfig: { enabled: s, staleTime: d.ONE_MINUTE } }), (t[0] = s), (t[1] = c));
  ...
  return (
    t[5] !== u || t[6] !== p
      ? ((m = { accountId: p, isLoading: u }), (t[5] = u), (t[6] = p), (t[7] = m))
      : (m = t[7]),
    m
  );
}
...
function X({ scope: e, queryClient: n, response: r }) {
  (n.setQueryData(P, r), r.immediate_top_up_status === `succeeded` && e.query.invalidate(t));
}
function he(e, t) {
...
function ge() {
  return b.safeGet(`/accounts/check/{version}`, { parameters: { path: { version: R } } });
}
async function _e() {
...
async function xe(e) {
  return b.safePost(`/accounts/send_add_credits_nudge_email`, { requestBody: e });
}
function Se(e) {
  return {
...
function $e(e) {
  return e === T.FREE || e === T.GO || e === T.PLUS || e === T.PROLITE || e === T.PRO;
}
var et = e(n(), 1),
  Q = r();
function tt(e) {
...
function rt(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = () => (y(r, `337040058`, { disableExposureLog: !n }).get(nt, !1) ? A : re)),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function at(e) {
  ...
  let A;
  t[19] !== f || t[20] !== r
    ? ((A = ht({ intl: f, pricingInfo: r, plan: T.PLUS })), (t[19] = f), (t[20] = r), (t[21] = A))
    : (A = t[21]);
  let re, j;
  ...
  t[40] !== k || t[41] !== P || t[42] !== F || t[43] !== w || t[44] !== O
    ? ((I = (0, Q.jsxs)(`div`, { "aria-hidden": w, className: O, children: [k, P, F] })),
      (t[40] = k),
      (t[41] = P),
      (t[42] = F),
      (t[43] = w),
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, Q.jsx)(l, {
      ...
      (t[52] = R),
      (t[53] = ue))
    : ((oe = t[48]), (se = t[49]), (ce = t[50]), (le = t[51]), (R = t[52]), (ue = t[53]));
  let z;
  t[54] === u
    ? (z = t[55])
    : ((z = () => {
  ...
  let H;
  t[64] !== f || t[65] !== r
    ? ((H = gt({ intl: f, pricingInfo: r })), (t[64] = f), (t[65] = r), (t[66] = H))
    : (H = t[66]);
  let U, pe, W;
  ...
  t[79] !== ie || t[80] !== L || t[81] !== B || t[82] !== K
    ? ((q = (0, Q.jsxs)(`div`, { "aria-hidden": ie, className: L, children: [B, K] })),
      (t[79] = ie),
      (t[80] = L),
      (t[81] = B),
      (t[82] = K),
...
function ot(e) {
  ...
  let { data: l } = z(c),
    d;
  t[1] === l ? (d = t[2]) : ((d = { billingCurrency: l, enabled: !0 }), (t[1] = l), (t[2] = d));
  let { data: f } = H(d),
    p;
  ...
  (t[9] !== a || t[10] !== i
    ? ((y = () => {
        _(a, { eventName: `codex_upgrade_plan_modal_shown`, metadata: { source: i } });
      }),
      (b = [a, i]),
      (t[9] = a),
      (t[10] = i),
...
function ct(e) {
  let t = (0, N.c)(29),
    ...
    f;
  t[0] !== n || t[1] !== u
    ? ((f = Ze({ currentPlan: n, targetPlan: u })), (t[0] = n), (t[1] = u), (t[2] = f))
    : (f = t[2]);
  let p = f,
    m;
  t[3] !== n || t[4] !== u
    ? ((m = Qe({ currentPlan: n, targetPlan: u })), (t[3] = n), (t[4] = u), (t[5] = m))
    : (m = t[5]);
  let h = m,
    g;
  t[6] !== i || t[7] !== o || t[8] !== s
    ? ((g = s == null ? null : (0, Q.jsx)(mt, { detailsLabel: s, getPlansUrl: i, onOpenUrl: o })),
      (t[6] = i),
      (t[7] = o),
      (t[8] = s),
      (t[9] = g))
  ...
  return (
    t[1] === n
      ...
      : ((i = (0, Q.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, Q.jsx)(`span`, { className: `font-normal text-token-text-secondary`, children: n }),
          ],
        })),
        (t[1] = n),
        (t[2] = i)),
...
function pt(e) {
  let t = (0, N.c)(41),
    ...
    m;
  t[0] === p ? (m = t[1]) : ((m = i(`flex flex-col gap-1`, p)), (t[0] = p), (t[1] = m));
  let h;
  t[2] === d
    ? (h = t[3])
    : ((h = (0, Q.jsx)(`div`, {
  ...
  let v = f === `large` && `h-12 justify-center`,
    y;
  t[10] === v ? (y = t[11]) : ((y = i(`mt-3 flex flex-col`, v)), (t[10] = v), (t[11] = y));
  let b;
  t[12] !== c || t[13] !== f
    ? ((b =
        c == null
  ...
  let w = r == null ? `pt-8` : `gap-3`,
    T;
  t[28] === w ? (T = t[29]) : ((T = i(`mt-3 flex flex-col`, w)), (t[28] = w), (t[29] = T));
  let E;
  t[30] === r
    ? (E = t[31])
    : ((E =
        r == null ? null : (0, Q.jsx)(`div`, { className: `flex h-5 items-center`, children: r })),
      (t[30] = r),
      (t[31] = E));
  let D;
...
function mt(e) {
  ...
  t[4] === n
    ? (s = t[5])
    : ((s = (0, Q.jsx)(`span`, { className: `sr-only`, children: n })), (t[4] = n), (t[5] = s));
  let c;
  return (
    t[6] !== a || t[7] !== s
      ? ((c = (0, Q.jsxs)(`button`, {
...
function _t() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(j, { className: `icon-sm`, name: `bubble-on-bubble` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function vt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(ne, { className: `icon-sm text-token-charts-yellow` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
...
function bt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(j, { className: `icon-base`, name: `shield` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
  ...
  return (
    e[0] === t
      ...
      : ((n = (e) => {
          ...
          return r == null || !y(t, xt, { disableExposureLog: !1 }).get(`enabled`, !1)
            ? !1
            : (wt(n, r, i), !0);
        }),
        (e[0] = t),
...
function At(e) {
  ...
  let t = Tt(e),
    n = w(e?.plan_type) && e?.credits?.unlimited === !1 && e?.credits?.has_credits === !1;
...
function Nt({ rateLimitStatus: e, isWorkspaceAccount: t, isCreditsEnabled: n }) {
  let r = !t && Pt(e);
  return (
    n &&
...
function zt(e) {
  return e == null
    ...
    : {
        ...
        windowMinutes: e.limit_window_seconds == null ? null : e.limit_window_seconds / Rt,
...
function Yt(e, t) {
  ...
  return Array.isArray(r) ? r.some((e) => (It(e) ? $(e.limit_name) === n : !1)) : !1;
}
function Xt(e) {
