import { a as e, l as t, t as n, z as r } from "./app-scope.js";
import "./app-server-manager-signals.js";
import { r as i } from "./lib.js";
import { t as a } from "./use-auth.js";
import { r as o } from "./skus.js";
import { f as s, t as c } from "./apps-queries.js";
import { t as l } from "./known-app-icon.js";
var u = 3,
  d = i({
...
function P({ intl: e, mailProvider: t, plan: n = null, plugins: r = [], roles: i }) {
  let a = i[0] ?? `something_else`,
    s = t === `other` ? (o(n) ? `microsoft` : `google`) : t;
  return N[a].flatMap((t) => {
...
function I(e) {
  let t = new Map();
  for (let n of e) {
    let e = [n.id, V(n.id), V(n.name), ...(n.pluginDisplayNames ?? []).map(V)];
    n.id.startsWith(`connector_`) && e.push(V(n.id.slice(10)));
...
var L = t(n, (e, { get: t }) => {
  let n = t(c, e).data;
  return n == null ? void 0 : I(n);
});
function R(e, t) {
  let n = new Set();
  for (let r of t) {
    let t = e.get(r) ?? e.get(V(r));
    t != null && n.add(t);
  }
  return Array.from(n);
}
function z(t) {
  ...
  let g;
  return (
    n[5] !== h || n[6] !== r ? ((g = R(h, r)), (n[5] = h), (n[6] = r), (n[7] = g)) : (g = n[7]), g
  );
}
function B(e) {
  for (let t of e) return l(t) == null;
  return !1;
}
function V(e) {
  return e
...
export { z as a, h as c, B as i, I as n, P as o, R as r, d as s, V as t };
//# sourceMappingURL=ambient-suggestion-apps.js.map
