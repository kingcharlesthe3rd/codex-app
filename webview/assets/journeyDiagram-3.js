...
import { D as n } from "./runtime.worker-2.js";
import {
  B as r,
  C as i,
  V as a,
...
import "./dist-5.js";
import { t as f } from "./chunk-72.js";
import { a as p, n as m, o as h, s as g } from "./chunk-142.js";
var _ = (function () {
  var t = e(function (e, t, n, r) {
    ...
    l = {
      ...
      table: [
        ...
        { 1: [3] },
        t(n, [2, 2], { 5: 3 }),
        { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: r, 12: i, 14: a, 16: o, 17: s, 18: c },
        t(n, [2, 7], { 1: [2, 1] }),
        t(n, [2, 3]),
...
`,
  ...
  P = e(function (t, r) {
    ...
    return (e(c, `ambivalent`), r.score > 3 ? o(a) : r.score < 3 ? s(a) : c(a), i);
  }, `drawFace`),
  F = e(function (e, t) {
  ...
  B = e(function (e, t, n, r) {
    ...
    (t.people.forEach((e) => {
      ...
      (F(a, { cx: s, cy: t.y, r: 7, fill: n, stroke: `#000`, title: e, pos: t.actors[e].position }),
        (s += 10));
    }),
...
var J = l().journey,
  ...
  ee = e(function (e, n, r, i) {
    ...
    let v = 0;
    (_.forEach((e) => {
      ((G[e] = { color: J.actorColours[v % J.actorColours.length], position: v }), v++);
    }),
      q(m),
      (Y = J.leftMargin + K),
...
//# sourceMappingURL=journeyDiagram-3.js.map
