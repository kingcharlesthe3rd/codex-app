...
var z,
  ...
  Xe = e(() => {
    (c(),
      ...
      S(),
      L(),
      (z = n({ type: i(`app.appearance.get`) })),
      (B = I({
        schema: z,
        run: async () => {
          let [e, t, n, r, i] = await Promise.all([
            C(s.theme),
            C(s.lightCodeThemeId),
            C(s.darkCodeThemeId),
            C(s.lightChromeTheme),
            C(s.darkChromeTheme),
          ]);
          return {
            schemaVersion: 1,
  ...
  Ze = e(() => {
    (m(),
      j(),
      L(),
      (V = n({ type: i(`app.appearance.get_available_themes`) })),
      (H = I({
        schema: V,
        run: () => ({
          schemaVersion: 1,
...
async function U(e, t, n, r) {
  ...
  try {
    ...
    (await e.queryClient?.invalidateQueries({ queryKey: i }),
      l.dispatchMessage(`query-cache-invalidate`, { queryKey: [...i] }));
  }
}
var W = e(() => {
    (h(), S(), ee());
  ...
  Qe = e(() => {
    (c(),
      ...
      L(),
      W(),
      (G = n({ type: i(`app.appearance.set_mode`), mode: p([`light`, `dark`, `system`]) })),
      (K = I({
        schema: G,
        run: async ({ mode: e }, t) => (
          await U(t, s.theme, e, { optimistic: !1 }),
...
var q,
  ...
  st = e(() => {
    (c(),
      ...
      L(),
      W(),
      (q = r().regex(/^#[0-9a-fA-F]{6}$/)),
      (nt = n({ code: r().nullable().optional(), ui: r().nullable().optional() })),
      (rt = n({ diffAdded: q, diffRemoved: q, skill: q })),
      (it = n({
        accent: q.optional(),
      ...
      (at = n({
        ...
        theme: a(`kind`, [
          n({ kind: i(`preset`), themeId: r().refine(je, `Invalid code theme id`) }),
          n({ kind: i(`custom`), patch: it }),
        ]),
  ...
  switch (e.value.routeKind) {
    case `local-thread`:
      return {
        ...
        kind: `local`,
        hostId: e.get(he, e.value.conversationId) ?? `local`,
        title: e.get(Ne, e.value.conversationId),
      };
    case `remote-thread`:
...
function ut(e, t, n, r, i) {
  let a = t == null ? [] : qe(e, t),
    o = t == null ? null : Je(t, e.get(D), { bottom: n, right: r }),
    s = o == null ? null : (a.find((e) => e.browserTabId === o) ?? null),
    c = t == null || o == null ? null : R.getSnapshot(t, o);
  return {
...
function dt(e, t, n) {
  if (e == null) return [];
  let r = R.getBrowserUseBrowserTabIds(e),
    i = [...t, ...r],
    a = new Set(r),
    o = new Set();
  return i.flatMap((t) => {
    if (o.has(t)) return [];
    o.add(t);
    let r = R.getSnapshot(e, t);
    return [
      {
        active: t === n,
        browserTabId: t,
        isBrowserUseActive: R.isBrowserUseActive(e, t),
...
function pt(e, t) {
  let n = _t(e);
  return e.matches(b.sidebarSection)
    ? {
        type: `section`,
        index: t,
...
function ht(e) {
  let t = e?.querySelector(b.reviewFileToggle);
  return {
...
function gt() {
  let e = Array.from(document.querySelectorAll(b.reviewFile));
  return new Map(
    e.flatMap((e) => {
      ...
      (yt = I({
        ...
        run: (e, t) => {
          let n = J(t),
            ...
            i = n.get(de),
            a = n.get(_e),
            o = i && a ? n.get(Ve.activeTab$) : null,
            s = n.get(ce) ? n.get(Re.activeTab$) : null,
            c = o?.tabId ?? null,
            l = null;
          c === k.DIFF ? (l = `right`) : s?.tabId === k.DIFF && (l = `bottom`);
          let u = l != null,
            d = n.get(O),
            f = Ye(n.get(D), { bottom: n.get(Le), right: n.get(Ie) });
          return {
            schemaVersion: 1,
            window: {
              windowId: me,
              ...
              thread: ct(n),
              panels: {
                browser: ut(n, X(n.value) ? we(n) : null, s, o, d),
                sidebar: { open: r },
                review: {
                  open: u,
                  placement: l,
                  fullscreen: l === `right` && d,
                  fileTreeOpen: u && n.get(se),
                  view: n.get(F),
                },
                terminal: { open: f != null, placement: f },
                rightPanel: { fullscreen: d, kind: c },
              },
              ...(r ? { sidebar: { viewport: Z(b.sidebarScroll), rows: ft() } } : {}),
              ...(u ? { review: { viewport: Z(b.reviewScroll), files: mt(n) } } : {}),
              ...(X(n.value) ? { timeline: Z(b.timelineScroll) } : {}),
            },
          };
        },
      })));
...
function xt(e) {
  return I({ schema: Ct, run: ({ action: t }) => St(e(), t) });
}
function St(e, t, n = wt) {
  return {
    ...
    actions: e
      ...
      .map((e) => ({ type: e.type, jsonSchema: JSON.stringify(o(e.schema), null, 2) })),
  };
}
var Ct,
  wt,
  Tt = e(() => {
    (m(),
      L(),
      (Ct = n({ type: i(`app.help`), action: r().optional() })),
...
Prefer the smallest action that directly satisfies the user request.`));
  ...
  Ot = e(() => {
    (m(),
      ...
      L(),
      A(),
      (Et = n({ type: i(`windows.nav.back`), windowId: w })),
      (Dt = I({
        schema: Et,
        run: () => {
          l.dispatchHostMessage({ type: `navigate-back` });
        },
      })));
  }),
  kt,
  ...
  jt = e(() => {
    (m(),
      ...
      L(),
      A(),
      (kt = n({ type: i(`windows.nav.forward`), windowId: w })),
      (At = I({
        schema: kt,
        run: () => {
          l.dispatchHostMessage({ type: `navigate-forward` });
        },
      })));
  }),
  Mt,
  ...
  Pt = e(() => {
    (m(),
      L(),
      A(),
      (Mt = n({ type: i(`windows.review.collapse_all`), windowId: w })),
      (Nt = I({
        schema: Mt,
        run: () => {
  ...
  Lt = e(() => {
    (m(),
      L(),
      A(),
      (Ft = n({ type: i(`windows.review.expand_all`), windowId: w })),
      (It = I({
        schema: Ft,
        run: () => {
          window.dispatchEvent(
    ...
    (m(),
      ...
      (zt = I({
        ...
        run: ({ path: e, expanded: t }) => {
          let n = v(e).querySelector(b.reviewFileToggle);
  ...
  Ut = e(() => {
    (m(),
      L(),
      A(),
      (Vt = n({ type: i(`windows.review.scroll`), windowId: w, scroll: x })),
      (Ht = I({
        schema: Vt,
        run: ({ scroll: e }) => {
          _(T(b.reviewScroll), e);
        },
      })));
  });
function Wt(e) {
...
var Gt,
  ...
  Xt = e(() => {
    (m(),
      ...
      L(),
      A(),
      (Jt = n({ type: i(`windows.review.set_fullscreen`), windowId: w, fullscreen: t() })),
      (Yt = I({
        schema: Jt,
        run: ({ fullscreen: e }, t) => {
          J(t).set(O, e);
  ...
  nn = e(() => {
    (m(),
      ...
      L(),
      A(),
      (en = n({ type: i(`windows.review.toggle`), windowId: w })),
      (tn = I({
        schema: en,
        run: () => {
          l.dispatchHostMessage({ type: `toggle-diff-panel` });
        },
      })));
  }),
  rn,
  ...
  on = e(() => {
    (m(),
      ...
      L(),
      A(),
      (rn = n({ type: i(`windows.show_home`), windowId: w })),
      (an = I({
        schema: rn,
        run: () => {
          l.dispatchHostMessage({ type: `new-chat` });
        },
      })));
  });
function sn(e) {
  let t = oe(e);
  return t == null ? d(u(e)) : ae(t.key);
}
var cn,
  ln,
  un = e(() => {
    (c(),
      ...
      L(),
      A(),
      (cn = n({ type: i(`windows.show_thread`), windowId: w, threadId: r() })),
      (ln = I({
        schema: cn,
        run: ({ threadId: e }) => {
          l.dispatchHostMessage({ type: `navigate-to-route`, path: sn(e) });
        },
      })));
  }),
  dn,
    ...
    (m(),
      ...
      (hn = I({
        ...
        run: ({ project: e, showAll: t }) => {
          ...
          let a = i.querySelector(b.sidebarProjectShowAllToggle);
  ...
  yn = e(() => {
    (m(),
      L(),
      A(),
      (_n = n({ type: i(`windows.sidebar.scroll`), windowId: w, scroll: x })),
      (vn = I({
        schema: _n,
        run: ({ scroll: e }) => {
          _(T(b.sidebarScroll), e);
        },
      })));
  }),
  bn,
    ...
    (m(),
      ...
      (xn = I({
        ...
        run: ({ section: e, collapsed: t }) => {
          ...
          let r = n.querySelector(b.sidebarSectionToggle);
  ...
  Tn = e(() => {
    (m(),
      L(),
      A(),
      (Cn = n({ type: i(`windows.sidebar.select_project`), windowId: w, project: E })),
      (wn = I({
        schema: Cn,
        run: ({ project: e }) => {
          let t = y(e).querySelector(b.sidebarProjectSelect);
  ...
  On = e(() => {
    (m(),
      ...
      L(),
      A(),
      (En = n({ type: i(`windows.sidebar.toggle`), windowId: w })),
      (Dn = I({
        schema: En,
        run: () => {
          l.dispatchHostMessage({ type: `toggle-sidebar` });
        },
      })));
  }),
  kn,
  ...
  jn = e(() => {
    (m(),
      ...
      L(),
      A(),
      (kn = n({ type: i(`windows.terminal.toggle`), windowId: w })),
      (An = I({
        schema: kn,
        run: (e, t) => {
          Fe(J(t));
  ...
  Pn = e(() => {
    (m(),
      L(),
      A(),
      (Mn = n({ type: i(`windows.timeline.scroll`), windowId: w, scroll: x })),
      (Nn = I({
        schema: Mn,
        run: ({ scroll: e }) => {
          ve(T(b.timelineScroll), e);
        },
      })));
  }),
  Fn,
  ...
  Ln = e(() => {
    (m(),
      L(),
      A(),
      (Fn = n({ type: i(`windows.timeline.scroll_to_turn`), windowId: w, direction: ue })),
      (In = I({
        schema: Fn,
        run: ({ direction: e }) => {
          fe(T(b.timelineScroll), e);
        },
      })));
  });
function Rn() {
...
//# sourceMappingURL=register-app-actions-B.js.map
