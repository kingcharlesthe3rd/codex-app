var e = `<svg data-icon-sprite aria-hidden="true" width="0" height="0">
  ...
  t = `<symbol id="file-tree-builtin-astro" viewBox="0 0 16 16">
  ...
  n = `<symbol id="file-tree-builtin-babel" viewBox="0 0 16 16">
  ...
  r = `<symbol id="file-tree-builtin-bash" viewBox="0 0 16 16">
  ...
  i = `<symbol id="file-tree-builtin-biome" viewBox="0 0 16 16">
  ...
  a = `<symbol id="file-tree-builtin-bootstrap" viewBox="0 0 16 16">
  ...
  o = `<symbol id="file-tree-builtin-browserslist" viewBox="0 0 16 16">
  ...
  s = `<symbol id="file-tree-builtin-bun" viewBox="0 0 16 16">
  ...
  c = `<symbol id="file-tree-builtin-c" viewBox="0 0 16 16">
  ...
  u = `<symbol id="file-tree-builtin-cpp" viewBox="0 0 16 16">
  <path fill="currentColor" fill-rule="evenodd" d="M8 1q.084 0 .166.021.098.023.186.075c1.055.624 4.22 2.486 5.277 3.11.085.05.15.112.209.192h-.002l.028.037a.5.5 0 0 1 .103.21q.031.102.033.21v6.29a.71.71 0 0 1-.347.616l-5.307 3.144a.68.68 0 0 1-.693 0l-5.307-3.144A.72.72 0 0 1 2 11.145V4.832a.71.71 0 0 1 .346-.612l5.288-3.126A.7.7 0 0 1 7.992 1zm2.901 4.349a3.75 3.75 0 1 0 0 5.302l-1.06-1.06a2.25 2.25 0 1 1 0-3.182z" clip-rule="evenodd"/>
</symbol>`,
  ee = `<symbol id="file-tree-builtin-css" viewBox="0 0 16 16">
  ...
  te = `<symbol id="file-tree-builtin-database" viewBox="0 0 16 16">
  ...
  ne = `<symbol id="file-tree-builtin-default" viewBox="0 0 16 16">
  ...
  re = `<symbol id="file-tree-builtin-docker" viewBox="0 0 16 16">
  ...
  ie = `<symbol id="file-tree-builtin-eslint" viewBox="0 0 16 16">
  ...
  ae = `<symbol id="file-tree-builtin-font" viewBox="0 0 16 16">
  ...
  d = `<symbol id="file-tree-builtin-git" viewBox="0 0 16 16">
  ...
  oe = `<symbol id="file-tree-builtin-typescript" viewBox="0 0 16 16">
  <path fill="currentColor" d="M8 1C2.24 1 1 2.24 1 8s1.24 7 7 7 7-1.24 7-7-1.24-7-7-7" class="bg" opacity=".2"/>
  <path fill="currentColor" d="M8.1 9.64h.95c.04.62.28.76 1.28.76s1.2-.14 1.2-.85c0-.66-.2-.85-1.2-1.07-1.79-.38-2.18-.7-2.18-1.86C8.15 5.3 8.54 5 10.31 5c1.67 0 2.04.26 2.07 1.42h-.95c-.02-.43-.23-.53-1.1-.53-1 0-1.22.14-1.22.74 0 .52.22.7 1.24.92 1.76.38 2.15.73 2.15 2 0 1.44-.4 1.75-2.24 1.75-1.8 0-2.18-.3-2.15-1.66m-3 1.57V5.99H3.5v-.9h4.21v.9H6.1v5.22z"/>
</symbol>`,
  z = `<symbol id="file-tree-builtin-vite" viewBox="0 0 16 16">
  ...
  q = [t, n, i, a, o, s, l, re, ie, p, b, x, S, C, w, E, k, A, j, M, N, I, L, z, B, V, H, U, W, G];
function J(e, t) {
  return t.length === 0
    ? e
    : e.replace(
...
var Y = J(e, K),
  se = { minimal: e, standard: Y, complete: J(Y, q) },
  ce = {
    ".babelrc": `babel`,
    ".babelrc.json": `babel`,
    ".bash_profile": `bash`,
  ...
  ue = { jsx: `react`, sass: `sass`, scss: `sass`, tsx: `react` },
  X = new Set([
    `bash`,
    `c`,
    `cpp`,
  ...
  de = new Set([`complete`]);
function fe(e) {
  return se[e === `none` ? `minimal` : e];
}
function pe(e) {
  return `file-tree-builtin-${e}`;
}
function me(e) {
  return e !== `none` && de.has(e);
}
function he(e, t, n) {
...
function Q(e) {
  return e == null
    ...
    : typeof e == `string`
      ? { set: e, colored: !0 }
      : { ...e, set: e.set ?? (Z(e) ? `none` : `complete`), colored: e.colored ?? !0 };
}
  ...
  return {
    resolveIcon: (e, o) => {
      if (e === `file-tree-icon-file` && o != null) {
        ...
        let u = he(t.set, n, l);
        if (u != null && t.set !== `none`) return { name: pe(u), remappedFrom: e, token: u };
      }
      let s = n?.[e];
...
export { me as i, Q as n, fe as r, ye as t };
