...
import { Z as r, _ as i, g as a, t as o } from "./app-scope-CWE-zIhQ.js";
import {
  Bt as s,
  Ht as c,
  Yt as l,
...
import { u as S, v as C } from "./vscode-api.js";
import { t as w } from "./queryOptions.js";
import { Ar as T, Gi as E, Qi as D, Zi as O } from "./src-1.js";
import { l as k, s as A } from "./lib-1.js";
import { t as j } from "./clsx.js";
import { t as M } from "./tooltip-B.js";
import { t as N } from "./x.js";
import { t as P } from "./composer-utils.js";
import { n as F } from "./rpc-1.js";
import { o as I } from "./statsig.js";
import { t as L } from "./codex-api-error.js";
import { t as R } from "./v4.js";
import { y as z } from "./mention-item.js";
import { m as B } from "./use-plugins.js";
import { f as V } from "./apps-queries.js";
import { s as H, t as U } from "./use-native-apps.electron.js";
import { n as W } from "./get-file-icon.js";
import { n as G } from "./use-skills.js";
import { t as ee } from "./image-preview-dialog.js";
import { t as te } from "./attachment-remove-button.js";
import { i as K, t as q } from "./thread-resource-card.js";
import { n as J } from "./use-composer-controller.js";
var Y = 20,
  X = a(o, []),
  ne = i(o, (e) => null, void 0, { key: ie });
function re(e, t, n, r) {
  if (r == null || n == null) return;
  let i = { bundleIdentifier: t, imageName: n };
  if (e.get(ne, i) === r) return;
  e.set(ne, i, r);
  let a = ie(i),
    o = [...e.get(X).filter((e) => ie(e) !== a), i],
    s = o.slice(0, Math.max(0, o.length - Y));
  for (let t of s) e.set(ne, t, null);
  e.set(X, o.slice(s.length));
}
function ie(e) {
...
function oe(e) {
  let t = (0, Z.c)(92),
    {
      ...
      screenshotAlt: c,
      screenshotSrc: l,
      transitionSnapshotHeight: u,
      transitionSnapshotSrc: d,
      variant: f,
      windowTitle: p,
      onRemove: m,
    } = e,
  ...
  if (
    ...
    let e = de({ appName: r, windowTitle: p }),
      a = c ?? ``,
      o;
    t[31] !== i || t[32] !== l || t[33] !== a
      ? ((o = { alt: a, accessibilityText: i, src: l }),
        (t[31] = i),
        (t[32] = l),
        (t[33] = a),
        (t[34] = o))
    ...
    let f = o,
      y;
    t[35] !== f || t[36] !== s
      ? ((y = s ?? [f]), (t[35] = f), (t[36] = s), (t[37] = y))
      : (y = t[37]);
    let k = y;
    E = k[C] ?? f;
    let A;
    (t[38] === E.accessibilityText
      ? (A = t[39])
      : ((A = E.accessibilityText?.trim() ?? ``), (t[38] = E.accessibilityText), (t[39] = A)),
      (T = A),
      (O = T.length > 0),
      (M = x && O),
      (P = C > 0 ? C - 1 : null),
      (N = C + 1 < k.length ? C + 1 : null));
    let U = d != null && d.length > 0,
      W = u ?? 140,
      G;
    t[40] !== u || t[41] !== _
      ? ((G = _ === `composer` ? ae(u) : void 0), (t[40] = u), (t[41] = _), (t[42] = G))
      : (G = t[42]);
    let ee = G,
      K;
    (t[43] === g
    ...
    t[51] !== _
      ? ((q =
          _ === `thread`
            ? (0, $.jsx)(ue, { appIconSrc: n, screenshotAlt: c, screenshotSrc: l })
            : (0, $.jsx)(le, {
                hasTransitionSnapshot: U,
    ...
    let J = q,
      ...
      X = h ? `cursor-interaction` : `cursor-default`;
    (t[53] !== Y || t[54] !== X
      ? ((L = j(`composer-attachment-surface`, Y, X)), (t[53] = Y), (t[54] = X), (t[55] = L))
      : (L = t[55]),
      t[56] === ee
        ? (R = t[57])
        : ((R = ee == null ? void 0 : { height: ee }), (t[56] = ee), (t[57] = R)),
      (z = h ? `button` : void 0),
      (B = h ? e : void 0),
      (V = h ? 0 : void 0),
      t[58] !== D || t[59] !== h
  ...
  let G;
  t[70] !== T || t[71] !== M
    ? ((G = M ? (0, $.jsx)(ce, { accessibilityText: T }) : void 0),
      (t[70] = T),
      (t[71] = M),
      (t[72] = G))
    : (G = t[72]);
    ...
    : ((s =
        n != null && n.length > 0
          ? (0, $.jsx)(`img`, {
              ...
              alt: ``,
              "aria-hidden": !0,
              className: `absolute bottom-1 left-1 size-5 rounded object-contain shadow-sm`,
              draggable: !1,
            })
          : null),
      (t[3] = n),
...
function de({ appName: e, windowTitle: t }) {
  let n = t?.trim();
...
function fe(e) {
  ...
  let y = f
    ...
    b;
  t[18] === y ? (b = t[19]) : ((b = j(`flex-shrink-0`, y)), (t[18] = y), (t[19] = b));
  let x;
  t[20] !== n || t[21] !== a || t[22] !== f
    ? ((x = a ?? (n == null ? null : (0, $.jsx)(n, { className: j(f ? `size-6` : `icon-2xs`) }))),
      (t[20] = n),
      (t[21] = a),
      (t[22] = f),
      (t[23] = x))
  ...
  let S;
  t[24] !== b || t[25] !== x
    ? ((S = (0, $.jsx)(`div`, { className: b, children: x })),
      (t[24] = b),
      (t[25] = x),
      (t[26] = S))
    : (S = t[26]);
  let C = f
    ...
    w;
  t[27] === C ? (w = t[28]) : ((w = j(`relative min-w-0 flex-1`, C)), (t[27] = C), (t[28] = w));
  let T;
  t[29] !== r || t[30] !== w
    ? ((T = (0, $.jsx)(`div`, { className: w, children: r })),
      (t[29] = r),
      (t[30] = w),
      (t[31] = T))
    : (T = t[31]);
  ...
  t[32] !== m || t[33] !== f || t[34] !== s || t[35] !== c
    ? ((E =
        ...
        (0, $.jsx)(`div`, {
          ...
          "aria-label": c,
          children: (0, $.jsx)(N, {
            className: j(f ? `icon-xxs` : `icon-2xs text-token-foreground`),
          }),
        })),
      (t[32] = m),
      (t[33] = f),
...
function pe(e, t, n) {
  return w({
    ...
    queryFn: () => F.fileAttachments.countFolderFiles({ folderPath: e, hostId: t }),
    staleTime: S.THIRTY_SECONDS,
  });
}
function me(e) {
  let t = (0, Z.c)(62),
    ...
    h = k(),
    g;
  t[0] !== u || t[1] !== p ? ((g = u ?? W(p)), (t[0] = u), (t[1] = p), (t[2] = g)) : (g = t[2]);
  let _ = g,
    v;
      ...
      if (
        ...
        t[28] === _
          ...
          : ((s = (0, $.jsx)(`span`, {
              ...
              children: (0, $.jsx)(_, { className: `size-6` }),
            })),
            (t[28] = _),
            (t[29] = s));
        let u = o != null,
        ...
        t[30] === n
          ? (d = t[31])
          : ((d = (0, $.jsx)(`span`, { className: `block max-w-32 truncate`, children: n })),
            (t[30] = n),
            (t[31] = d));
        let p =
            f ??
        ...
        t[37] !== o || t[38] !== x
          ? ((g = o
              ? (0, $.jsx)(te, { className: `top-1 right-1 z-20`, ariaLabel: x, onRemove: o })
              : null),
            (t[37] = o),
            (t[38] = x),
            (t[39] = g))
        ...
        (t[44] !== y || t[45] !== a || t[46] !== i
          ? ((C = (0, $.jsx)(he, { folderPath: i, hostId: a, children: y })),
            (t[44] = y),
            (t[45] = a),
            (t[46] = i),
            (t[47] = C))
  ...
  t[48] === n
    ? (C = t[49])
    : ((C = (0, $.jsx)(`span`, { className: `truncate`, children: n })), (t[48] = n), (t[49] = C));
  let w;
  t[50] === l
    ? (w = t[51])
    : ((w = l
  ...
  let E;
  return (
    t[55] !== _ || t[56] !== m || t[57] !== c || t[58] !== o || t[59] !== x || t[60] !== T
      ? ((E = (0, $.jsx)(fe, {
          Icon: _,
          onClick: c,
          onRemove: o,
...
function he(e) {
  let t = (0, Z.c)(14),
    ...
    s;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((s = pe(r, i, a)), (t[0] = r), (t[1] = i), (t[2] = a), (t[3] = s))
    : (s = t[3]);
  let { data: c } = C(s),
    l,
    u,
  ...
  t[8] === c
    ? (p = t[9])
    : ((p = c == null ? null : (0, $.jsx)(ge, { count: c })), (t[8] = c), (t[9] = p));
  let m;
  return (
    t[10] !== n || t[11] !== a || t[12] !== p
      ? ((m = (0, $.jsx)(`span`, {
          ...
          onPointerEnter: d,
          onPointerLeave: f,
          children: (0, $.jsx)(M, { defaultOpen: a, tooltipContent: p, children: n }),
        })),
        (t[10] = n),
        (t[11] = a),
        (t[12] = p),
...
var Se = `SteerTurnInactiveError`;
function Ce(e) {
  let t = Error(`Cannot steer conversation ${e} because its active turn already ended`);
  return ((t.name = Se), t);
}
function we(e) {
  return (e instanceof Error && e.name === Se) || T(e).includes(Se);
}
function Te(e, t, { shouldRestrictRemoteHostImageSize: n = !1 } = {}) {
  return [
    ...e.imageAttachments.map((e) => u(e.src, { localPath: e.localPath, isRemoteHost: t })),
    ...(e.mcpAppModelContextAttachments ?? []).flatMap((e) =>
      e.imageAttachments.map((e) => u(e.src, { isRemoteHost: t })),
    ),
    ...(e.appshotContexts ?? []).flatMap((e) => {
      let n = e.imageDataUrl ?? e.imagePath;
      return n == null ? [] : [u(n, { localPath: e.imagePath ?? void 0, isRemoteHost: t })];
    }),
    ...p(e.commentAttachments, t),
  ];
}
async function Ee({
  context: e,
  ...
  collaborationMode: u,
  memoryPreferences: d,
  workspaceKind: p = `project`,
  projectlessOutputDirectory: m,
  projectAssignment: h,
}) {
  let { config: _ } = await s(`read-config-for-host`, { hostId: i, includeLayers: !1, cwd: r }),
    v = g(_);
  return (
    i === `local` && e.aeonStartTarget,
    {
      input: [
        ...
        ...Te(e, i !== f, { shouldRestrictRemoteHostImageSize: !1 }),
      ],
      commentAttachments: e.commentAttachments,
      workspaceRoots: n,
      cwd: r,
      fileAttachments: c(e.fileAttachments, e.pastedTextAttachments),
      ...
      workspaceKind: p,
      projectAssignment: h,
      ...(p === `projectless` ? { projectlessOutputDirectory: m } : {}),
    }
  );
}
var De = [];
...
function ke(e) {
  let { context: t, scope: n, targetConversationId: r } = e;
  return Ne(je(e), void 0);
}
function Ae(e) {
  let { restoreMessage: t, scope: n, targetConversationId: r } = e;
  return Ne(Me(e), void 0);
}
async function je({
  scope: e,
  manager: t,
  ...
  agentMode: o,
  serviceTier: u,
  shouldSendPermissionOverrides: p = !0,
  activeCollaborationMode: g,
  restoreMessage: v,
}) {
  let y = n !== f;
  if (Pe(e, i)) throw Error(P);
  if (
    (e.get(h, i) &&
      (await s(`maybe-resume-conversation`, {
        hostId: t.getHostId(),
        conversationId: i,
        model: null,
        serviceTier: u,
        ...
        collaborationMode: r.collaborationMode ?? g,
      })),
    e.get(_, i)?.at(-1)?.status === `inProgress`)
  )
    return Me({
      scope: e,
      manager: t,
      ...
      activeCollaborationMode: g,
      restoreMessage: v ?? Oe({ context: r, cwd: a }),
    });
  let x = d(r.imageAttachments),
    S = [
      { type: `text`, text: m(r), text_elements: [] },
      ...Te(r, y, { shouldRestrictRemoteHostImageSize: !1 }),
    ],
    C = l([...c(r.fileAttachments, r.pastedTextAttachments), ...r.addedFiles, ...x]),
    w = p ? await b(t.requestClient, a) : null,
    T = w == null ? null : E(o, r.workspaceRoots ?? De, w);
  return (
      ...
      params: {
        ...
        ...(T == null
          ...
          : {
              ...
              ...D(T),
              ...(T.activePermissionProfile == null ? {} : { runtimeWorkspaceRoots: O(T) }),
            }),
        ...(p ? {} : { useAppServerPermissionDefault: !0 }),
        attachments: C,
        collaborationMode: r.collaborationMode ?? g,
...
async function Me({
  ...
  e.get(h, r) &&
    (await s(`maybe-resume-conversation`, {
      ...
      serviceTier: a,
      reasoningEffort: null,
      workspaceRoots: v.workspaceRoots ?? [_],
      collaborationMode: v.collaborationMode ?? u,
    }));
  let y = d(v.imageAttachments),
    b = [
      { type: `text`, text: m(v), text_elements: [] },
      ...Te(v, g, { shouldRestrictRemoteHostImageSize: !1 }),
    ],
    x = l([...c(v.fileAttachments, v.pastedTextAttachments), ...v.addedFiles, ...y]);
  try {
    return (
      await s(`steer-turn-for-host`, {
        hostId: t.getHostId(),
        conversationId: r,
        input: b,
        restoreMessage: p,
...
var Fe = `thread_reference_limit_exceeded`,
  Ie = `thread_reference_read_failed`;
async function Le({ excludedThreadId: e, hostId: t, threadIds: n }) {
  let r = Array.from(new Set(n)).filter((t) => t !== e);
  if (r.length > 3) throw Error(Fe);
  try {
    return await Promise.all(
      r.map(async (e) => {
        let n = await s(`send-cli-request-for-host`, {
            hostId: t,
            method: `thread/read`,
...
var Re = `missing_github_connector_link`;
function ze(e, t) {
  let n = e instanceof Error ? L(e) : null;
  return n?.type === Re
    ? t.formatMessage({
    ...
    : t.formatMessage(
        ...
        { br: (0, $.jsx)(`br`, {}, `task-creation-error-break`), error: n?.message ?? T(e) },
      );
}
function Be(e, t) {
  let n = e instanceof Error ? L(e) : null;
  return n?.type === Re
    ...
    : t.formatMessage(
        ...
        { br: (0, $.jsx)(`br`, {}, `cloud-task-creation-error-break`), error: n?.message ?? T(e) },
      );
}
var Ve = `worktree_init_failed`;
function He(e, t) {
  return (
    We(e, t) ??
    (Ge(e)
      ...
      : t.formatMessage(
          ...
          { br: (0, $.jsx)(`br`, {}), error: T(e) },
        ))
  );
}
function Ue({ error: e, composerMode: t, intl: n }) {
  return (
    We(e, n) ??
    (t === `worktree` && Ge(e)
      ? n.formatMessage({
  ...
  return n === `thread_reference_limit_exceeded`
    ? t.formatMessage(
        {
          ...
          description: `Toast shown when a message contains more referenced chats than supported`,
        },
        { limit: 3 },
      )
    : n === `thread_reference_read_failed`
      ? t.formatMessage({
          ...
          description: `Toast shown when Codex cannot load context from a referenced chat`,
        })
      : null;
}
function Ge(e) {
  return !e || typeof e != `object` ? !1 : e.data?.code === Ve;
}
function Ke(e) {
  return T(e).includes(P);
}
function qe(e) {
  let t = (0, Z.c)(17),
...
function Ye(e) {
  ...
  t[0] !== a || t[1] !== u
    ? ((d =
        u && a ? { additionalMarketplaceKinds: [`shared-with-me`] } : { includeRemoteCatalog: a }),
      (t[0] = a),
      (t[1] = u),
      (t[2] = d))
    : (d = t[2]);
  let { availablePlugins: f } = B(i, o, d),
    p;
  t[3] === f ? (p = t[4]) : ((p = H(f)), (t[3] = f), (t[4] = p));
  let m = p != null,
    h;
