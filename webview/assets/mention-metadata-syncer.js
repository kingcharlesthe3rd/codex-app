...
function w(e) {
  ...
  if (
    ...
    (t[39] === I.accessibilityText
      ? (_ = t[40])
      : ((_ = I.accessibilityText?.trim() ?? ``), (t[39] = I.accessibilityText), (t[40] = _)),
      (F = _),
      (R = F.length > 0),
      (z = ne && R),
      (V = P > 0 ? P - 1 : null),
    ...
    let x = m != null && m.length > 0,
      ...
      T;
    t[41] !== p || t[42] !== A
      ? ((T = A === `composer` ? b(p) : void 0), (t[41] = p), (t[42] = A), (t[43] = T))
      : (T = t[43]);
    let E = T,
      M;
    (t[44] === O
    ...
    t[52] !== A
      ? ((Z =
          A === `thread`
            ? (0, C.jsx)(ee, { appIconSrc: n, screenshotAlt: d, screenshotSrc: f })
            : (0, C.jsx)(D, {
...
function A(e) {
  ...
  t[12] !== a || t[13] !== g || t[14] !== _ || t[15] !== v
    ? ((y = r(`text-token-foreground group relative transition-colors duration-200`, g, _, v, a)),
      (t[12] = a),
      (t[13] = g),
      (t[14] = _),
      (t[15] = v),
  ...
  let b = p
    ...
    S;
  t[17] === b ? (S = t[18]) : ((S = r(`flex-shrink-0`, b)), (t[17] = b), (t[18] = S));
  let w = p ? `size-6` : `icon-2xs`,
    T;
  t[19] === w ? (T = t[20]) : ((T = r(w)), (t[19] = w), (t[20] = T));
  let E;
  t[21] !== n || t[22] !== T
    ? ((E = (0, C.jsx)(n, { className: T })), (t[21] = n), (t[22] = T), (t[23] = E))
    : (E = t[23]);
  let D;
  t[24] !== E || t[25] !== S
  ...
  let ee = p
    ...
    O;
  t[27] === ee ? (O = t[28]) : ((O = r(`relative min-w-0 flex-1`, ee)), (t[27] = ee), (t[28] = O));
  let k;
  t[29] !== i || t[30] !== O
...
function N(e) {
  ...
  return (
    t[5] !== i || t[6] !== c
      ? ((l = (0, C.jsx)(`div`, { className: c, children: i })), (t[5] = i), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
function P(e) {
  ...
  let g;
  t[8] !== m || t[9] !== h
    ? ((g = (0, C.jsxs)(`span`, { className: `flex min-w-0 flex-1 flex-col`, children: [m, h] })),
      (t[8] = m),
      (t[9] = h),
      (t[10] = g))
    : (g = t[10]);
...
function re(e) {
  let t = (0, x.c)(13),
    { label: n, matchDropdownWidth: i, matchDropdownWidthLabel: a, size: o, showChevron: s } = e,
    c = i === void 0 ? !1 : i,
        ...
        ? (0, C.jsxs)(`span`, {
            ...
            children: [
              (0, C.jsxs)(`span`, {
                ...
                children: [a ?? n, (0, C.jsx)(f, { className: `icon-2xs shrink-0` })],
              }),
              (0, C.jsx)(`span`, {
  ...
  t[7] === u
    ...
    : ((h = u
        ? (0, C.jsx)(`span`, {
            ...
            children: (0, C.jsx)(f, { className: `icon-2xs self-center text-token-text-tertiary` }),
          })
        : null),
      (t[7] = u),
      (t[8] = h));
...
function F(e) {
  ...
  let c;
  t[2] === s ? (c = t[3]) : ((c = (0, C.jsx)(f, { className: s })), (t[2] = s), (t[3] = c));
  let l;
  return (
...
function I(e) {
  let t = (0, x.c)(52),
    ...
    p = i(),
    m;
  t[0] !== l || t[1] !== n ? ((m = l ?? h(n)), (t[0] = l), (t[1] = n), (t[2] = m)) : (m = t[2]);
  let g = m,
    _,
    y;
  if (
    ...
    bb0: {
      ...
      if (
        ...
        t[24] === n
          ? (l = t[25])
          : ((l = (0, C.jsx)(`span`, { className: `block max-w-32 truncate`, children: n })),
            (t[24] = n),
            (t[25] = l));
        let u = d ?? R(e, c, p),
          f;
        ...
        t[31] !== r || t[32] !== _
          ? ((m = r
              ? (0, C.jsx)(v, { className: `top-1 right-1 z-20`, ariaLabel: _, onRemove: r })
              : null),
            (t[31] = r),
            (t[32] = _),
            (t[33] = m))
  ...
  t[38] === n
    ? (b = t[39])
    : ((b = (0, C.jsx)(`span`, { className: `truncate`, children: n })), (t[38] = n), (t[39] = b));
  let S;
  t[40] === c
    ? (S = t[41])
    : ((S = c
  ...
  let T;
  return (
    t[45] !== g || t[46] !== f || t[47] !== s || t[48] !== r || t[49] !== _ || t[50] !== w
      ? ((T = (0, C.jsx)(A, {
          Icon: g,
          onClick: s,
          onRemove: r,
...
function H(e) {
  ...
  t[0] !== o || t[1] !== g
    ? ((_ =
        g && o ? { additionalMarketplaceKinds: [`shared-with-me`] } : { includeRemoteCatalog: o }),
      (t[0] = o),
      (t[1] = g),
      (t[2] = _))
    : (_ = t[2]);
...
export { F as a, A as c, N as i, w as l, z as n, re as o, I as r, P as s, B as t, b as u };
