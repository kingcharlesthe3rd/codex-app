...
import { Wn as w } from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~project~okyna5mq.js";
import {
  Qo as T,
  Zo as E,
  as as D,
...
var M,
  ...
  I = e(() => {
    (k(),
      ...
      (N = o()),
      (P = `px-toolbar`),
      (F = O(`mx-auto w-full max-w-(--thread-content-max-width)`, P)));
  });
function L({ children: e, onPointerDownOutside: t }) {
  ...
  if (
    ((0, z.useLayoutEffect)(
      () => () => {
        (d(n), n.get(g) !== 0 && n.set(g, 0), n.get(C) !== 0 && n.set(C, 0));
      },
      [n],
    ),
    (0, z.useLayoutEffect)(() => {
    ...
    (0, z.useLayoutEffect)(() => {
      if (!(!H || r == null))
        return (
          r.style.setProperty(_, `${k}px`),
          r.style.setProperty(x, `${D.current}px`),
          () => {
            (r.style.removeProperty(_), r.style.removeProperty(x));
          }
        );
    }, [r, k, H]),
    (0, z.useLayoutEffect)(() => {
      P === `entering` ? y(n, L, { direction: `enter`, shouldAnimate: !0 }) : W || y(n, L);
    }, [P, W, n, L]),
    (0, z.useLayoutEffect)(() => {
      !H || r == null || r.style.setProperty(x, `${G}px`);
    }, [r, H, G]),
    (0, z.useEffect)(() => {
      if (!M || !U) return;
      let e = (e) => {
        let t = e.target;
        t instanceof Node && (E.current?.contains(t) || K());
      };
      return (
  ...
  let J = (0, V.jsx)(`div`, {
    ...
    onAnimationEnd: (e) => {
      e.currentTarget === e.target && P === `entering` && v(n, `entering`);
    },
    onTransitionEnd: (e) => {
      e.currentTarget === e.target && P === `exiting` && v(n, `exiting`);
    },
    className: O(
    ...
    style: {
      ...
      transform: `translateY(calc(${I}px - var(${x}, 0px)))`,
    },
  ...
  return r == null ? J : (0, B.createPortal)(J, r);
}
function R(e, t) {
...
var z,
  ...
  V,
  H = e(() => {
    (k(), r(), (z = t(n(), 1)), (B = t(w(), 1)), b(), c(), l(), D(), f(), E(), I(), (V = o()));
  });
