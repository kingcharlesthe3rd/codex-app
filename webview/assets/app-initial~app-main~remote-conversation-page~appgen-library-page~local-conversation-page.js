...
function L({ children: e, onPointerDownOutside: t }) {
  ...
  let K = (0, z.useEffectEvent)(() => {
    ...
    q = (0, z.useCallback)(() => {
      ...
      j((e) => (e === t ? e : t));
      let n =
        i == null || e == null ? 0 : Math.max(0, i.offsetWidth - e.offsetLeft - e.offsetWidth);
      r.get(l) !== n && r.set(l, n);
    }, [i, r]);
  if (
    ((0, z.useLayoutEffect)(
    ...
    (0, z.useLayoutEffect)(() => {
      P === `entering` ? _(r, L, { direction: `enter`, shouldAnimate: !0 }) : W || _(r, L);
    }, [P, W, r, L]),
    (0, z.useLayoutEffect)(() => {
...
var z,
  ...
  V,
  H = e(() => {
    (T(), r(), (z = t(i(), 1)), (B = t(w(), 1)), v(), y(), u(), O(), x(), k(), I(), (V = a()));
  });
