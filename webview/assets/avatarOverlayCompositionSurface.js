...
import { Yr as v } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~new-thread-panel-page~o~hgx54pg3.js";
import {
  am as y,
  im as b,
  nm as x,
...
import { Dn as O, En as k } from "./app-initial~app-main~automations-page.js";
import { t as A } from "./app.js";
import { n as j, t as M } from "./avatar-overlay-native-frame-D.js";
var N = e(() => {});
function P(e) {
...
function oe() {
  ...
  return (
    e[9] !== t.contentState.locale || e[10] !== c
      ? ((l = (0, G.jsx)(E, { locale: t.contentState.locale, onError: de, children: c })),
    ...
    (s({}, () => {}),
      (0, W.createRoot)($).render(
        (0, G.jsx)(_, {
          client: K,
          children: (0, G.jsx)(k, {
            children: (0, G.jsx)(m, { scope: r, value: {}, children: (0, G.jsx)(oe, {}) }),
          }),
        }),
      ));
  });
