...
import { R as r, S as i, r as a, t as o } from "./app-scope.js";
import { O as s } from "./vscode-api.js";
import "./isEqual.js";
import { Er as c, wr as l } from "./src-4.js";
import "./app-server-manager-signals.js";
import { t as u } from "./client.js";
import "./react-dom.js";
import { a as d } from "./lib-1.js";
import { t as f } from "./app.js";
import { zr as p } from "./persisted-signal.js";
import "./proxy.js";
...
import "./warning.js";
import "./waveform.js";
import "./avatar-overlay-pill-dismiss-button.js";
...
function x(e) {
  ...
  let m = i.isNotificationStackExpanded,
    g = i.layout,
    v = r.nativeAttached,
  ...
  t[8] === i.activities
    ? (x = t[9])
    : ((x = i.activities.map(S)), (t[8] = i.activities), (t[9] = x));
  let w, T, E, D, O, k, A, j, M;
  t[10] === n
    ? ((w = t[11]),
      (T = t[12]),
      (E = t[13]),
    ...
    : ((w = (e) => {
      ...
      (M = (e) => (n({ type: `submit-quick-chat`, prompt: e }), Promise.resolve())),
      (t[10] = n),
      (t[11] = w),
      (t[12] = T),
      (t[13] = E),
      ...
      (t[19] = M));
  let N;
  t[20] === a ? (N = t[21]) : ((N = { type: `native-surface`, id: a }), (t[20] = a), (t[21] = N));
  let P;
  t[22] !== i.activityStackItems.length ||
  t[23] !== i.activityStackPresentation ||
  t[24] !== i.isNotificationStackExpanded ||
  t[25] !== i.isQuickChatVisible ||
  t[26] !== i.layout ||
  t[27] !== i.quickChatDraft ||
  t[28] !== i.quickChatResetRevision ||
  t[29] !== r.nativeAttached ||
  t[30] !== x ||
  t[31] !== w ||
  t[32] !== T ||
  t[33] !== E ||
  ...
  t[42] !== f
    ? ((P = (0, b.jsx)(
        h,
        {
          ...
          avatarMenuItems: p,
          isNotificationTrayOpen: m,
          layout: g,
          nativeMaterialAttached: v,
  ...
  return (
    t[44] !== P || t[45] !== c
      ? ((F = (0, b.jsx)(`div`, { className: `absolute`, style: c, children: P })),
        (t[44] = P),
        (t[45] = c),
        (t[46] = F))
      : (F = t[46]),
...
(p({}, () => {}),
  (0, g.createRoot)(j).render(
    (0, b.jsx)(s, {
      client: T,
      children: (0, b.jsx)(f, {
        children: (0, b.jsx)(a, { scope: o, value: {}, children: (0, b.jsx)(M, {}) }),
      }),
    }),
  ));
function M() {
...
function I() {
  document.querySelector(`[data-avatar-overlay-native-surface-id='composer'] input`)?.focus();
}
function L() {
  return window.close();
}
