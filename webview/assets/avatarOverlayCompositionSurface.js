...
import { Qg as g } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~new-thread-panel-page~o~kg2pu5rs.js";
import {
  fh as _,
  hh as v,
  mh as y,
...
import { Xt as O, Zt as k } from "./app-initial~app-main~automations-page.js";
import { t as A } from "./app.js";
import { n as j, t as M } from "./avatar-overlay-native-frame.js";
var N = e(() => {});
function P(e) {
...
function I(e) {
  ...
  if (a === `mascot-badge`) {
    let e;
    return (
      t[0] === r ? (e = t[1]) : ((e = (0, R.jsx)(ne, { preparation: r })), (t[0] = r), (t[1] = e)),
      e
    );
  }
  ...
  t[12] === n
    ...
    : ((x = (e) => {
      ...
      (t[23] = j));
  let N;
  t[24] === a ? (N = t[25]) : ((N = { type: `native-surface`, id: a }), (t[24] = a), (t[25] = N));
  let P;
  ...
  return (
    t[54] !== P || t[55] !== c
      ? ((F = (0, R.jsx)(`div`, { className: `absolute`, style: c, children: P })),
        (t[54] = P),
        (t[55] = c),
        (t[56] = F))
      : (F = t[56]),
...
function oe() {
  ...
  e[7] === t
    ? (c = e[8])
    : ((c = (0, G.jsx)(I, { preparation: t, dispatchAction: se })), (e[7] = t), (e[8] = c));
  let l;
  return (
    e[9] !== t.contentState.locale || e[10] !== c
      ? ((l = (0, G.jsx)(w, { locale: t.contentState.locale, onError: de, children: c })),
    ...
    (x({}, () => {}),
      (0, W.createRoot)($).render(
        (0, G.jsx)(m, {
          client: K,
          children: (0, G.jsx)(O, {
            children: (0, G.jsx)(l, { scope: o, value: {}, children: (0, G.jsx)(oe, {}) }),
          }),
        }),
      ));
  });
