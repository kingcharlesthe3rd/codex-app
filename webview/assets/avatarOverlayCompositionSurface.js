...
import { T_ as D } from "./app-initial~app-main~onboarding-page.js";
import { Gr as O, Wr as k } from "./app-initial~app-main~automations-page.js";
...
function te(e) {
  ...
  if (a === `mascot-badge`) {
    let e;
    return (
      t[0] === r ? (e = t[1]) : ((e = (0, R.jsx)(I, { preparation: r })), (t[0] = r), (t[1] = e)), e
    );
  }
  ...
  t[7] === i.activities
    ? (u = t[8])
    : ((u = i.activities.map(F)), (t[7] = i.activities), (t[8] = u));
  ...
  return (
    t[54] !== N || t[55] !== c
      ? ((P = (0, R.jsx)(`div`, { className: `absolute`, style: c, children: N })),
        (t[54] = N),
        (t[55] = c),
        (t[56] = P))
      : (P = t[56]),
...
function oe() {
  ...
  return (
    e[9] !== t.contentState.locale || e[10] !== c
      ? ((l = (0, G.jsx)(d, { locale: t.contentState.locale, onError: de, children: c })),
...
function de(e) {
  if (e.code !== E.MISSING_TRANSLATION) throw e;
}
function z() {
  return Y;
}
    ...
    (f({}, () => {}),
      (0, W.createRoot)($).render(
        (0, G.jsx)(r, {
          client: K,
          children: (0, G.jsx)(k, {
            children: (0, G.jsx)(S, { scope: o, value: {}, children: (0, G.jsx)(oe, {}) }),
          }),
        }),
      ));
  });
