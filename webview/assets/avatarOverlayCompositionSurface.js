...
import { t as n } from "./modulepreload-polyfill.js";
import {
  $P as r,
  AB as i,
  AV as a,
...
import { Xd as D } from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~projects-index-page~app~ovcriy74.js";
import { Qn as O, Zn as k } from "./app-initial~app-main~automations-page.js";
import { t as A } from "./app.js";
import { n as j, t as ee } from "./avatar-overlay-native-frame.js";
var M = e(() => {});
function N(e) {
...
function te(e) {
  ...
  if (a === `mascot-badge`) {
    let e;
    return (
      t[0] === r ? (e = t[1]) : ((e = (0, I.jsx)(ie, { preparation: r })), (t[0] = r), (t[1] = e)),
      e
    );
  }
  let o = 32 - r.backingRect.left,
    ...
    c;
  t[2] !== i.layout.viewport.height || t[3] !== i.layout.viewport.width || t[4] !== o || t[5] !== s
  ...
  t[7] === i.activities
    ? (u = t[8])
    : ((u = i.activities.map(re)), (t[7] = i.activities), (t[8] = u));
  ...
  t[10] === i.activities
    ? (b = t[11])
    : ((b = i.activities.map(ne)), (t[10] = i.activities), (t[11] = b));
  ...
  t[12] === n
    ...
    : ((x = (e) => {
      ...
      (j = (e) => (n({ type: `submit-quick-chat`, prompt: e }), Promise.resolve())),
      (t[12] = n),
      (t[13] = x),
      (t[14] = S),
      (t[15] = C),
      ...
      (t[23] = j));
  let M;
  t[24] === a ? (M = t[25]) : ((M = { type: `native-surface`, id: a }), (t[24] = a), (t[25] = M));
  let N;
  ...
  return (
    t[54] !== N || t[55] !== c
      ? ((P = (0, I.jsx)(`div`, { className: `absolute`, style: c, children: N })),
        (t[54] = N),
        (t[55] = c),
        (t[56] = P))
      : (P = t[56]),
...
function ie(e) {
  ...
  t[0] !== n.backingRect.height || t[1] !== n.backingRect.width
    ? ((r = { height: n.backingRect.height, left: 32, top: 32, width: n.backingRect.width }),
        ...
        n.contentState.activityStackItems.length > 0
          ? (0, I.jsx)(h, {
              className: o(
                ...
                n.contentState.layout.placement.startsWith(`bottom`) && `rotate-180`,
              ),
            })
...
function R() {
  ...
  (e[3] === t
    ...
    : ((a = () => {
        ...
        t.nativeAttached || V({ id: t.id, phase: `mounted`, revision: t.revision });
        let e = null,
  ...
  e[7] === t
    ? (c = e[8])
    : ((c = (0, G.jsx)(te, { preparation: t, dispatchAction: se })), (e[7] = t), (e[8] = c));
  let l;
  return (
    e[9] !== t.contentState.locale || e[10] !== c
      ? ((l = (0, G.jsx)(C, { locale: t.contentState.locale, onError: de, children: c })),
...
function de(e) {
  if (e.code !== b.MISSING_TRANSLATION) throw e;
}
function z() {
  return Y;
}
function B(e) {
  if (!(Y != null && e.revision <= Y.revision)) {
    ((Y = e),
      e.nativeAttached &&
        !Q &&
        ((Q = !0), V({ id: e.id, phase: `preparation-received`, revision: e.revision })));
    for (let e of J) e();
  }
}
async function V(e) {
...
function fe(e) {
  if ((J.add(e), J.size === 1)) {
    ...
    (window.addEventListener(x, e),
      (X = () => {
        window.removeEventListener(x, e);
      }),
      q
        .getPreparation()
        .then(B)
    ...
    (u({}, () => {}),
      (0, W.createRoot)($).render(
        (0, G.jsx)(g, {
          client: K,
          children: (0, G.jsx)(k, {
            children: (0, G.jsx)(f, { scope: p, value: {}, children: (0, G.jsx)(R, {}) }),
          }),
        }),
      ));
  });
