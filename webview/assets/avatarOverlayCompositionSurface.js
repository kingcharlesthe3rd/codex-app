...
import { RC as m } from "./app-initial~app-main~onboarding-page.js";
import {
  Tx as h,
  mw as g,
  pw as _,
...
import { Mn as w, Nn as T } from "./app-initial~app-main~automations-page.js";
...
function oe() {
  ...
  return (
    e[9] !== t.contentState.locale || e[10] !== c
      ? ((l = (0, G.jsx)(b, { locale: t.contentState.locale, onError: de, children: c })),
    ...
    (g({}, () => {}),
      (0, W.createRoot)($).render(
        (0, G.jsx)(d, {
          client: K,
          children: (0, G.jsx)(w, {
            children: (0, G.jsx)(l, { scope: C, value: {}, children: (0, G.jsx)(oe, {}) }),
          }),
        }),
      ));
  });
