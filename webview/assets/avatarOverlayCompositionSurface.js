...
import { gO as D } from "./app-initial~app-main~onboarding-page.js";
import { mr as O, pr as k } from "./app-initial~app-main~automations-page.js";
...
function R() {
  ...
  return (
    e[9] !== t.contentState.locale || e[10] !== c
      ? ((l = (0, G.jsx)(g, { locale: t.contentState.locale, onError: de, children: c })),
...
function de(e) {
  if (e.code !== _.MISSING_TRANSLATION) throw e;
}
function z() {
  return Y;
}
    ...
    (c({}, () => {}),
      (0, W.createRoot)($).render(
        (0, G.jsx)(S, {
          client: K,
          children: (0, G.jsx)(k, {
            children: (0, G.jsx)(f, { scope: a, value: {}, children: (0, G.jsx)(R, {}) }),
          }),
        }),
      ));
  });
