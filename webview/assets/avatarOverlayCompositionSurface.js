...
import { uT as g } from "./app-initial~app-main~onboarding-page.js";
import {
  Ab as _,
  Ex as v,
  jb as y,
...
import { dr as E, ur as D } from "./app-initial~app-main~automations-page.js";
import { t as O } from "./app.js";
import {
  Du as k,
  Eu as A,
...
function de(e) {
  if (e.code !== v.MISSING_TRANSLATION) throw e;
}
function z() {
  return Y;
}
    ...
    (C({}, () => {}),
      (0, W.createRoot)($).render(
        (0, G.jsx)(d, {
          client: K,
          children: (0, G.jsx)(D, {
            children: (0, G.jsx)(a, { scope: o, value: {}, children: (0, G.jsx)(oe, {}) }),
          }),
        }),
      ));
  });
