...
import { i as t, n, r, t as i } from "./chunk-70.js";
...
function We() {
  ...
  let y,
    ...
    S = Ue();
  t.isSupported =
    typeof d == `function` && typeof ve == `function` && je && je.createHTMLDocument !== void 0;
  let {
      MUSTACHE_EXPR: Re,
      ERB_EXPR: C,
      TMPLIT_EXPR: Ge,
    ...
    yt = function () {
      ...
      if (!(Y && Y === e)) {
        if (
          ((!e || typeof e != `object`) && (e = {}),
          (e = b(e)),
          (ht = gt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? `text/html` : e.PARSER_MEDIA_TYPE),
          (J = ht === `application/xhtml+xml` ? fe : de),
          (T = h(e, `ALLOWED_TAGS`) ? v({}, e.ALLOWED_TAGS, J) : Ze),
          (E = h(e, `ALLOWED_ATTR`) ? v({}, e.ALLOWED_ATTR, J) : D),
          (ut = h(e, `ALLOWED_NAMESPACES`) ? v({}, e.ALLOWED_NAMESPACES, fe) : dt),
          (W = h(e, `ADD_URI_SAFE_ATTR`) ? v(b(st), e.ADD_URI_SAFE_ATTR, J) : st),
          ...
          e.FORBID_CONTENTS && (B === V && (B = b(B)), v(B, e.FORBID_CONTENTS, J)),
          R && (T[`#text`] = !0),
          ...
          : e.namespaceURI === ct
            ? t.namespaceURI === G
              ...
              : t.namespaceURI === lt
                ...
                : !!xt[n]
            : e.namespaceURI === G
              ? (t.namespaceURI === lt && !pt[r]) || (t.namespaceURI === ct && !ft[r])
                ? !1
                : !xt[n] && (mt[n] || !bt[n])
  ...
  let Et = function (e) {
      ...
      if (
        ...
        return (Z(e), !0);
      if (!(j.tagCheck instanceof Function && j.tagCheck(r)) && (!T[r] || k[r])) {
        if (
          !k[r] &&
          Ot(r) &&
          ...
          if (
            !(
              (Ot(e) &&
                ...
                ((O.attributeNameCheck instanceof RegExp && g(O.attributeNameCheck, t)) ||
                  (O.attributeNameCheck instanceof Function && O.attributeNameCheck(t, e)))) ||
              (t === `is` &&
                O.allowCustomizedBuiltInElements &&
                ((O.tagNameCheck instanceof RegExp && g(O.tagNameCheck, r)) ||
                  (O.tagNameCheck instanceof Function && O.tagNameCheck(r))))
    ...
    kt = function (e) {
      ...
      for (; i--; ) {
        ...
        if (
          ...
          (u = r.attrValue),
          at && (c === `id` || c === `name`) && (Q(a, e), (u = `user-content-` + u)),
  ...
  return (
    (t.sanitize = function (e) {
      ...
      if ((rt || yt(n), (t.removed = []), typeof e == `string` && (ot = !1), ot)) {
        if (e.nodeName) {
          let t = J(e.nodeName);
          if (!T[t] || k[t]) throw _e(`root node is forbidden and cannot be sanitized in-place`);
        }
      } else if (e instanceof s)
        ((i = St(`<!---->`)),
          (o = i.ownerDocument.importNode(e, !0)),
          (o.nodeType === Be.element && o.nodeName === `BODY`) || o.nodeName === `HTML`
            ? (i = o)
            : i.appendChild(o));
      else {
        if (!F && !M && !N && e.indexOf(`<`) === -1) return y && L ? y.createHTML(e) : e;
      ...
      if (ot) return e;
      if (F) {
        if (I) for (l = Ne.call(i.ownerDocument); i.firstChild; ) l.appendChild(i.firstChild);
        else l = i;
        return ((E.shadowroot || E.shadowrootmode) && (l = Ie.call(r, l, !0)), l);
      }
...
` +
    ...
    (t.setConfig = function () {
      (yt(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}), (rt = !0));
    }),
...
`,
  ...
  O = `#ffffff`,
  k = `#f2f2f2`,
  A = n((e, t) => (t ? o(e, { s: -40, l: 10 }) : o(e, { s: -40, l: -10 })), `mkBorder`),
  j = class {
    static {
      n(this, `Theme`);
    }
    ...
    updateColors() {
      if (
        ...
        (this.secondaryColor = this.secondaryColor || o(this.primaryColor, { h: -120 })),
        (this.tertiaryColor = this.tertiaryColor || o(this.primaryColor, { h: 180, l: 5 })),
        (this.primaryBorderColor = this.primaryBorderColor || A(this.primaryColor, this.darkMode)),
        ...
        (this.noteBorderColor = this.noteBorderColor || A(this.noteBkgColor, this.darkMode)),
        ...
        (this.activeTaskBkgColor = this.activeTaskBkgColor || a(this.primaryColor, 23)),
        ...
        (this.cScale8 = this.cScale8 || o(this.primaryColor, { h: 210, l: 150 })),
      ...
      for (let t = 0; t < 5; t++)
        ((this[`surface` + t] =
          this[`surface` + t] || o(this.mainBkg, { h: 180, s: -15, l: e * (5 + t * 3) })),
          (this[`surfacePeer` + t] =
            this[`surfacePeer` + t] || o(this.mainBkg, { h: 180, s: -15, l: e * (8 + t * 3) })));
      ((this.classText = this.classText || this.textColor),
        ...
        (this.quadrant2Fill = this.quadrant2Fill || o(this.primaryColor, { r: 5, g: 5, b: 5 })),
        (this.quadrant3Fill = this.quadrant3Fill || o(this.primaryColor, { r: 10, g: 10, b: 10 })),
        (this.quadrant4Fill = this.quadrant4Fill || o(this.primaryColor, { r: 15, g: 15, b: 15 })),
        (this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor),
        (this.quadrant2TextFill =
          this.quadrant2TextFill || o(this.primaryTextColor, { r: -5, g: -5, b: -5 })),
        (this.quadrant3TextFill =
          this.quadrant3TextFill || o(this.primaryTextColor, { r: -10, g: -10, b: -10 })),
        (this.quadrant4TextFill =
          this.quadrant4TextFill || o(this.primaryTextColor, { r: -15, g: -15, b: -15 })),
        ...
        (this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || O),
  ...
  $e = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] =
          this[`surface` + e] || o(this.mainBkg, { h: 30, s: -30, l: -(-10 + e * 4) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || o(this.mainBkg, { h: 30, s: -30, l: -(-7 + e * 4) })));
  ...
  tt = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        this[`cScaleInv` + e] = this[`cScaleInv` + e] || o(this[`cScale` + e], { h: 180 });
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] = this[`surface` + e] || o(this.mainBkg, { h: 30, l: -(5 + e * 5) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || o(this.mainBkg, { h: 30, l: -(7 + e * 5) })));
      if (
        ((this.scaleLabelColor =
  ...
  nt = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] =
          this[`surface` + e] || o(this.mainBkg, { h: 30, s: -30, l: -(5 + e * 5) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || o(this.mainBkg, { h: 30, s: -30, l: -(8 + e * 5) })));
      ((this.nodeBkg = this.mainBkg),
        (this.nodeBorder = this.border1),
        (this.clusterBkg = this.secondBkg),
        (this.clusterBorder = this.border2),
  ...
  rt = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        this[`cScaleLabel` + e] = this[`cScaleLabel` + e] || this.scaleLabelColor;
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] = this[`surface` + e] || o(this.mainBkg, { l: -(5 + e * 5) })),
          (this[`surfacePeer` + e] =
    ...
    if ((r.debug(`sanitizeDirective called with`, e), !(typeof e != `object` || !e))) {
      ...
      for (let t of Object.keys(e)) {
        ...
        for (let n of [`themeCSS`, `fontFamily`, `altFontFamily`])
          t.includes(n) && (r.debug(`sanitizing css option`, t), (e[t] = ot(e[t])));
      }
      if (e.themeVariables)
  ...
  W = n((e, t) => {
    ...
    if (((n = D(n, r)), r.theme && r.theme in P)) {
      ...
      n.theme && n.theme in P && (n.themeVariables = P[n.theme].getThemeVariables(e));
    }
    return ((U = n), gt(U), U);
  }, `updateCurrentConfig`),
  st = n(
    (e) => (
      (B = D({}, z)),
      (B = D(B, e)),
      e.theme && P[e.theme] && (B.themeVariables = P[e.theme].getThemeVariables(e.themeVariables)),
      W(B, H),
      B
    ),
    `setSiteConfig`,
  ...
  ut = n((e) => {
    e &&
      ([`secure`, ...(B.secure ?? [])].forEach((t) => {
        Object.hasOwn(e, t) &&
          (r.debug(`Denied attempt to modify a secure key ${t}`, e[t]), delete e[t]);
      }),
  ...
  gt = n((e) => {
    e && (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) && ht(`LAZY_LOAD_DEPRECATED`);
  }, `checkConfig`),
  J = n(() => {
    let e = {};
    V && (e = D(e, V));
  ...
  It = n(async (t, n) => {
      ...
      return t.replace(Nt, `MathML is unsupported in this environment.`);
    {
      let { default: r } = await e(
        ...
        i = n.forceLegacyMathML || (!Mt() && n.legacyMathML) ? `htmlAndMathml` : `mathml`;
      return t
        .split(Y)
        .map((e) =>
          Pt(e)
