...
import { c as m, f as h, m as g } from "./vscode-api.js";
import { n as _ } from "./react.js";
import { Ar as v } from "./src-1.js";
import { c as y, o as b, r as x } from "./lib.js";
import { t as S } from "./clsx-Cir5-jBH.js";
import { t as C } from "./persisted-atom.js";
import { t as w } from "./button-DO-oxX3-.js";
...
import { f as F, m as I, p as L } from "./chunk-109.js";
import { D as R, O as z, m as B, w as V } from "./codex-api.js";
import { i as H } from "./use-environment.js";
import { t as U } from "./x.js";
import { n as W } from "./local-conversation-title-signals.js";
import { t as G } from "./with-window.js";
import { t as ee } from "./settings.cog.js";
import { r as K } from "./run-command.js";
import { n as te } from "./use-start-new-conversation-jDp-QANK.js";
import { i as q, r as ne } from "./pending-worktree-store.js";
import { a as J } from "./command-keybindings.js";
import { t as Y } from "./arrow-left.js";
import { t as re } from "./compose.js";
import { a as ie, r as X, t as ae } from "./dropdown.js";
...
function _e() {
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(re, { className: `icon-xs` })), (e[5] = l))
    : (l = e[5]);
  let u;
  e[6] !== o || e[7] !== c
    ? ((u = (0, Q.jsx)(w, {
    ...
    ? ((u =
        n.length > 0
          ? (0, Q.jsx)(`button`, {
              ...
              children: (0, Q.jsx)(U, { className: `icon-2xs` }),
            })
          : null),
      (t[5] = o),
      (t[6] = r),
...
function ke(e) {
  let t = (0, Z.c)(64),
    ...
    [c, l] = _(Te),
    u = H(),
    { data: d, isLoading: f, isError: p, refetch: m } = z(),
    h;
  t[0] === o ? (h = t[1]) : ((h = o.trim()), (t[0] = o), (t[1] = h));
  let g = h.length > 0,
    v;
  t[2] === g ? (v = t[3]) : ((v = { enabled: g }), (t[2] = g), (t[3] = v));
  let { data: x, isLoading: C, isError: E, refetch: D } = B(o, v),
    k;
  ...
  t[23] === L
    ? (R = t[24])
    : ((R = (0, Q.jsxs)(`span`, { className: `flex items-center gap-1.5`, children: [I, L] })),
      (t[23] = L),
      (t[24] = R));
  let V;
  t[25] !== R || t[26] !== P || t[27] !== F
    ? ((V = (0, Q.jsx)(oe, {
        asChild: !0,
        children: (0, Q.jsx)(O, {
          tooltipContent: N,
          children: (0, Q.jsx)(w, { color: `ghost`, size: P, className: F, children: R }),
        }),
      })),
      (t[25] = R),
      (t[26] = P),
  ...
  let ae;
  return (
    t[60] !== i || t[61] !== V || t[62] !== ie
      ? ((ae = (0, Q.jsxs)(ce, { open: i, onOpenChange: a, children: [V, ie] })),
        (t[60] = i),
        (t[61] = V),
        (t[62] = ie),
        (t[63] = ae))
...
function Me(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(P, { className: `icon-2xs` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === s
    ? (l = t[4])
...
function Re({
  ...
  let o = e ?? [],
    ...
    l = s.map((e) => {
      ...
      return { kind: `local`, key: f(e.id), at: n, conversation: e };
    }),
    d = n.map((e) => ({
...
function Ve(e) {
  let t = (0, Z.c)(31),
    ...
    [u, d] = _(Be),
    [f] = _(Te),
    p = L(`/local/:conversationId`)?.params?.conversationId ?? null,
    { data: m } = z(),
    h = me(),
    g;
  t[0] !== f || t[1] !== m
  ...
  t[3] === h
    ? (x = t[4])
    : ((x = (e) => Ie({ conversation: e, isBackgroundSubagentsEnabled: h })),
      (t[3] = h),
      (t[4] = x));
  let S = r.filter(x),
    C = Le(n.data, r, v),
    ...
    j = k
      ...
      : A,
    M = k ? S.filter((e) => we(o(e), O)) : S,
    P = k
      ? C.filter((e) =>
          e.kind === `remote`
            ? we(e.task.title, O)
            : e.kind === `local`
              ? we(o(e.conversation), O)
              : we(Ge(e.pendingWorktree, c), O),
        )
      : C,
    F;
  t[5] !== s || t[6] !== E
    ? ((F = (0, Q.jsx)(X.Section, {
        children: (0, Q.jsx)(Ee, { searchQuery: E, onQueryChange: D, autoFocus: s }),
      })),
      (t[5] = s),
      (t[6] = E),
      (t[7] = F))
...
function Ze(e) {
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(G, { chromeExtension: !0, children: (0, Q.jsx)(et, {}) })), (t[17] = E))
    : (E = t[17]);
  let D;
  t[18] === r
    ? (D = t[19])
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, Q.jsx)(G, { extension: !0, children: (0, Q.jsx)(fe, {}) })), (t[20] = O))
    : (O = t[20]);
  let k;
  ...
  t[38] === P
    ? (I = t[39])
    : ((I = (0, Q.jsx)(G, { extension: !0, children: P })), (t[38] = P), (t[39] = I));
  let L;
  return (
    t[40] !== N || t[41] !== I || t[42] !== _
      ? ((L = (0, Q.jsxs)(`div`, { className: _, children: [N, I] })),
        (t[40] = N),
        (t[41] = I),
        (t[42] = _),
        (t[43] = L))
...
function et() {
  ...
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Q.jsx)(ee, { className: `icon-xs` })), (e[3] = a))
    : (a = e[3]);
  let o;
  return (
    e[4] === i
...
function rt(e) {
  let t = (0, Z.c)(21),
    ...
    o = F().pathname === `/`,
    s = L(`/local/:conversationId`)?.params?.conversationId ?? null,
    c;
  t[0] === s ? (c = t[1]) : ((c = s == null ? null : v(s)), (t[0] = s), (t[1] = c));
  let l = c,
    u = L(`/remote/:taskId`)?.params?.taskId ?? null,
    { data: f } = V(u),
    p = i(d, l),
    m = i(W, l);
  if (u && f?.task?.title) {
...
function it(e) {
  ...
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(Y, { className: `size-3` })), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] !== n || t[5] !== a
...
export { Ze as t };
//# sourceMappingURL=header-67-PJdeh.js.map
