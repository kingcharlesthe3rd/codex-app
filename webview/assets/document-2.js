...
import { gn as ne, hn as h } from "./spreadsheet-1.js";
function g() {
  return {
    id: void 0,
    charts: [],
    ...
    (ee(),
      ...
      (N = {
        encode(e, t = new c()) {
          ...
          for (let n of e.commentReferences) L.encode(n, t.uint32(82).fork()).join();
          ...
          for (let n of e.numberingDefinitions) J.encode(n, t.uint32(114).fork()).join();
          for (let n of e.paragraphNumberings) Y.encode(n, t.uint32(122).fork()).join();
          for (let n of e.tableStyleDefinitions) i.encode(n, t.uint32(130).fork()).join();
          for (let n of e.endnotes) F.encode(n, t.uint32(138).fork()).join();
          (e.settings !== void 0 && z.encode(e.settings, t.uint32(146).fork()).join(),
            e.theme !== void 0 && u.encode(e.theme, t.uint32(154).fork()).join());
        ...
        fromPartial(e) {
          ...
          return (
            ...
            (t.commentReferences = e.commentReferences?.map((e) => L.fromPartial(e)) || []),
            ...
            (t.numberingDefinitions = e.numberingDefinitions?.map((e) => J.fromPartial(e)) || []),
            (t.paragraphNumberings = e.paragraphNumberings?.map((e) => Y.fromPartial(e)) || []),
            (t.tableStyleDefinitions = e.tableStyleDefinitions?.map((e) => i.fromPartial(e)) || []),
            (t.endnotes = e.endnotes?.map((e) => F.fromPartial(e)) || []),
            (t.settings =
              e.settings !== void 0 && e.settings !== null ? z.fromPartial(e.settings) : void 0),
            (t.theme = e.theme !== void 0 && e.theme !== null ? u.fromPartial(e.theme) : void 0),
      ...
      (z = {
        encode(e, t = new c()) {
          return (
            ...
            e.backgroundFill !== void 0 && l.encode(e.backgroundFill, t.uint32(58).fork()).join(),
            t
          );
        },
        decode(e, t) {
      ...
      (V = {
        encode(e, t = new c()) {
          ...
          for (let n of e.embeddedFonts) B.encode(n, t.uint32(34).fork()).join();
          return t;
        },
        decode(e, t) {
          let n = e instanceof p ? e : new p(e),
        ...
        fromPartial(e) {
          ...
          return (
            ...
            (t.embeddedFonts = e.embeddedFonts?.map((e) => B.fromPartial(e)) || []),
            t
          );
        },
      }),
      ...
      (U = {
        encode(e, t = new c()) {
          return (
            ...
            e.pageMargin !== void 0 && H.encode(e.pageMargin, t.uint32(26).fork()).join(),
            t
          );
        },
        decode(e, t) {
      ...
      (K = {
        ...
        fromPartial(e) {
          let t = se();
          return ((t.elements = e.elements?.map((e) => o.fromPartial(e)) || []), t);
        },
      }),
      (q = {
        encode(e, t = new c()) {
      ...
      (X = {
        encode(e, t = new c()) {
          (e.id !== `` && t.uint32(10).string(e.id),
            ...
            e.pageSetup !== void 0 && U.encode(e.pageSetup, t.uint32(26).fork()).join(),
            e.columns !== void 0 && W.encode(e.columns, t.uint32(34).fork()).join());
          for (let n of e.elements) o.encode(n, t.uint32(42).fork()).join();
          return (
            e.header !== void 0 && K.encode(e.header, t.uint32(50).fork()).join(),
            e.footer !== void 0 && K.encode(e.footer, t.uint32(58).fork()).join(),
            ...
            e.firstHeader !== void 0 && K.encode(e.firstHeader, t.uint32(98).fork()).join(),
            e.firstFooter !== void 0 && K.encode(e.firstFooter, t.uint32(106).fork()).join(),
            e.documentGrid !== void 0 && G.encode(e.documentGrid, t.uint32(114).fork()).join(),
            t
          );
        },
        decode(e, t) {
        ...
        fromPartial(e) {
          ...
          return (
            ...
            (t.pageSetup =
              e.pageSetup !== void 0 && e.pageSetup !== null ? U.fromPartial(e.pageSetup) : void 0),
            (t.columns =
              e.columns !== void 0 && e.columns !== null ? W.fromPartial(e.columns) : void 0),
            (t.elements = e.elements?.map((e) => o.fromPartial(e)) || []),
            (t.header =
              e.header !== void 0 && e.header !== null ? K.fromPartial(e.header) : void 0),
            (t.footer =
              e.footer !== void 0 && e.footer !== null ? K.fromPartial(e.footer) : void 0),
      ...
      (Q = {
        encode(e, n = new c()) {
          return (
            ...
            e.document !== void 0 && N.encode(e.document, n.uint32(18).fork()).join(),
            e.presentation !== void 0 && t.encode(e.presentation, n.uint32(26).fork()).join(),
            e.workbook !== void 0 && h.encode(e.workbook, n.uint32(34).fork()).join(),
            e.playground !== void 0 && Z.encode(e.playground, n.uint32(42).fork()).join(),
            n
          );
        },
        decode(e, n) {
        ...
        fromPartial(e) {
          ...
          return (
            ...
            (n.version = e.version ?? ``),
            (n.document =
              e.document !== void 0 && e.document !== null ? N.fromPartial(e.document) : void 0),
            (n.presentation =
              e.presentation !== void 0 && e.presentation !== null
                ? t.fromPartial(e.presentation)
                : void 0),
            (n.workbook =
              e.workbook !== void 0 && e.workbook !== null ? h.fromPartial(e.workbook) : void 0),
            (n.playground =
