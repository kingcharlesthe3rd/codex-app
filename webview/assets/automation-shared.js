import { Ai as e, Kn as t, Ni as n, Pi as r } from "./src-2.js";
import {
  A as i,
  I as a,
  a as o,
...
function x() {
  ...
  e[0] === t
    ? (r = e[1])
    : ((r = (e) => {
        (t.setQueryData(d(`inbox-items`, { limit: 200 }), (t) =>
          t == null
            ? t
            : {
                ...t,
  ...
  e[4] === n.data?.items
    ? (u = e[5])
    : ((u = n.data?.items ?? []), (e[4] = n.data?.items), (e[5] = u));
  let f = n.data?.unreadRunCounts,
    p;
  return (
    e[6] !== n.isLoading || e[7] !== o || e[8] !== l || e[9] !== u || e[10] !== f
      ? ((p = { items: u, isLoading: n.isLoading, markRead: o, markUnread: l, unreadRunCounts: f }),
        (e[6] = n.isLoading),
        (e[7] = o),
        (e[8] = l),
        (e[9] = u),
...
var D = s(null),
  O = s(null),
  k = s(!1);
function A({ directiveKey: e, automation: t }) {
  return {
    directiveKey: e,
    mode: `view`,
    id: t.id,
...
function j(t, i) {
  ...
  return {
    ...
    status: t.status,
    cwds: n(t) ? [] : t.cwds,
    executionEnvironment: n(t) ? null : r(t.executionEnvironment),
    localEnvironmentConfigPath: n(t) ? null : t.localEnvironmentConfigPath,
    targetThreadId: n(t) ? t.targetThreadId : null,
    model: n(t) ? null : a.model,
    reasoningEffort: n(t) ? null : a.reasoningEffort,
    rawRrule: t.rrule,
    scheduleConfig: n(t) ? h(t.rrule) : m(t.rrule),
    scheduleDirty: !1,
  };
}
function M({ seed: i, targetAutomation: a, models: o }) {
  let s = i.mode === `view` ? a : null,
    c = s?.rrule ?? i.rrule,
    l = a == null ? null : e({ automation: a, models: o ?? [] }),
    u =
      i.id != null && a == null
        ? null
        : a != null && !n(a)
    ...
    d = a?.kind ?? i.kind ?? (i.id != null && a == null ? S.kind : `cron`),
    f =
      d === `heartbeat`
        ? (i.targetThreadId ?? (a != null && n(a) ? a.targetThreadId : null))
        : null;
  return {
    id: i.id ?? a?.id ?? null,
    kind: d,
    name: s?.name ?? i.name,
    prompt: s?.prompt ?? i.prompt,
    status: s?.status ?? i.status ?? a?.status ?? `ACTIVE`,
    cwds: a != null && !n(a) ? a.cwds : i.cwds.map(t),
    executionEnvironment: d === `heartbeat` ? null : (i.executionEnvironment ?? u),
    localEnvironmentConfigPath:
      d === `heartbeat`
        ? null
        : (i.localEnvironmentConfigPath ??
          (a != null && !n(a) ? a.localEnvironmentConfigPath : S.localEnvironmentConfigPath)),
    targetThreadId: f,
    model: d === `heartbeat` ? null : (i.model ?? l?.model ?? S.model),
    reasoningEffort:
      d === `heartbeat` ? null : (i.reasoningEffort ?? l?.reasoningEffort ?? S.reasoningEffort),
    rawRrule: c,
    scheduleConfig: d === `heartbeat` ? h(c) : m(c),
    scheduleDirty: !1,
  };
}
function N(e) {
...
function I({ allowThreadDestination: e }) {
...
function R(e, t) {
  let n = t;
  t.includes(C) && (n = G(e.cwds) && t.length > 1 ? t.filter((e) => e !== C) : [C]);
...
function z({ draft: e, threadId: t, title: n }) {
  return { ...e, name: e.name.trim().length === 0 ? n : e.name, targetThreadId: t };
}
function B(e) {
  return e.kind === `cron` && G(e.cwds);
}
function V({ draft: e, modelSettings: t }) {
...
function H({ draft: e, name: t, prompt: n, status: r, rrule: i }) {
...
function U({ draft: e, name: t, prompt: n, rrule: r }) {
  if (e.kind === `heartbeat`) {
    if (e.targetThreadId == null) throw Error(`Heartbeat automation draft is incomplete`);
    return {
      kind: `heartbeat`,
...
function W({ directiveMode: e, canCreate: t, canUpdate: n, isViewMode: r, forceOpen: i = !1 }) {
  return i
    ? `open`
    : e === `view`
      ? r
