...
import { R as r, s as i, t as a, v as o } from "./app-scope.js";
import { a as s, f as c, k as l, r as u, u as d } from "./vscode-api.js";
import { hi as f, vi as p, wn as m, yi as h } from "./src-4.js";
import { i as g, m as _, p as v, r as y, t as b, u as x } from "./automation-schedule.js";
var ee = r(),
  S = s(a, `inbox-items`, {
    enabled: !0,
    params: { limit: 200 },
...
function C() {
  ...
  e[0] === t
    ? (r = e[1])
    : ((r = (e) => {
        (t.setQueryData(u(`inbox-items`, { limit: 200 }), (t) =>
          t == null
            ? t
            : {
                ...t,
          ...
          c.dispatchMessage(`inbox-item-set-read-state`, { id: e, isRead: !0 }));
      }),
      (e[0] = t),
      (e[1] = r));
  let a = r,
  ...
  e[2] === t
    ...
    : ((o = (e) => {
        (t.setQueryData(u(`inbox-items`, { limit: 200 }), (t) =>
          ...
          c.dispatchMessage(`inbox-item-set-read-state`, { id: e, isRead: !1 }));
      }),
      (e[2] = t),
      (e[3] = o));
  let s = o,
  ...
  e[4] === n.data?.items
    ? (d = e[5])
    : ((d = n.data?.items ?? []), (e[4] = n.data?.items), (e[5] = d));
  let f = n.data?.unreadRunCounts,
    p;
  return (
    e[6] !== n.isLoading || e[7] !== a || e[8] !== s || e[9] !== d || e[10] !== f
      ? ((p = { items: d, isLoading: n.isLoading, markRead: a, markUnread: s, unreadRunCounts: f }),
        (e[6] = n.isLoading),
        (e[7] = a),
        (e[8] = s),
        (e[9] = d),
...
var w = 7;
function T({ intl: e, nextRunAt: t, status: n }) {
  return n === `PAUSED`
    ? `-`
    : t == null
      ? e.formatMessage({
      ...
      : E({ intl: e, timestamp: t });
}
function E({ intl: e, timestamp: t }) {
  let n = new Date(t),
    r = D(n, new Date()),
...
function M(e) {
  ...
  return (
    ...
    x(e.scheduleConfig) || r.push(`schedule`),
    { trimmedName: t, trimmedPrompt: n, missingRequirements: r, canSave: r.length === 0 }
  );
}
function N(e) {
  return !e.scheduleDirty && e.rawRrule ? e.rawRrule : b(e.scheduleConfig);
}
function P(e, t) {
  return {
    ...e,
...
var F = o(null),
  I = o(null),
  L = o(!1);
function R({ directiveKey: e, automation: t }) {
  return {
    directiveKey: e,
    mode: `view`,
    id: t.id,
...
function z(e, t) {
  ...
  return {
    ...
    status: e.status,
    cwds: p(e) ? [] : e.cwds,
    executionEnvironment: p(e) ? null : h(e.executionEnvironment),
    localEnvironmentConfigPath: p(e) ? null : e.localEnvironmentConfigPath,
    targetThreadId: p(e) ? e.targetThreadId : null,
    model: p(e) ? null : n.model,
    reasoningEffort: p(e) ? null : n.reasoningEffort,
    rawRrule: e.rrule,
    scheduleConfig: p(e) ? v(e.rrule) : _(e.rrule),
    scheduleDirty: !1,
  };
}
function B({ seed: e, targetAutomation: t, models: n }) {
  let r = e.mode === `view` ? t : null,
    ...
    s = t?.kind ?? e.kind ?? (e.id != null && t == null ? A.kind : `cron`),
    c =
      s === `heartbeat`
        ? (e.targetThreadId ?? (t != null && p(t) ? t.targetThreadId : null))
        : null;
  return {
    id: e.id ?? t?.id ?? null,
    kind: s,
    ...
    cwds: t != null && !p(t) ? t.cwds : e.cwds.map(m),
    executionEnvironment: s === `heartbeat` ? null : (e.executionEnvironment ?? o),
    localEnvironmentConfigPath:
      s === `heartbeat`
        ? null
        : (e.localEnvironmentConfigPath ??
          (t != null && !p(t) ? t.localEnvironmentConfigPath : A.localEnvironmentConfigPath)),
    targetThreadId: c,
    model: s === `heartbeat` ? null : (e.model ?? a?.model ?? A.model),
    reasoningEffort:
      s === `heartbeat` ? null : (e.reasoningEffort ?? a?.reasoningEffort ?? A.reasoningEffort),
    rawRrule: i,
    scheduleConfig: s === `heartbeat` ? v(i) : _(i),
    scheduleDirty: !1,
  };
}
function V(e) {
...
function W({ allowThreadDestination: e }) {
...
function K(e, t) {
  let n = t;
  t.includes(j) && (n = $(e.cwds) && t.length > 1 ? t.filter((e) => e !== j) : [j]);
...
function q({ draft: e, threadId: t, title: n }) {
  return { ...e, name: e.name.trim().length === 0 ? n : e.name, targetThreadId: t };
}
function J(e) {
  return e.kind === `cron` && $(e.cwds);
}
function Y({ draft: e, modelSettings: t }) {
...
function X({ draft: e, name: t, prompt: n, status: r, rrule: i }) {
...
function Z({ draft: e, name: t, prompt: n, rrule: r }) {
  if (e.kind === `heartbeat`) {
    if (e.targetThreadId == null) throw Error(`Heartbeat automation draft is incomplete`);
    return {
      kind: `heartbeat`,
...
function Q({ directiveMode: e, canCreate: t, canUpdate: n, isViewMode: r, forceOpen: i = !1 }) {
  return i
    ? `open`
    : e === `view`
      ? r
