import { n as e } from "./chunk-63.js";
function t(e) {
  return e == null;
}
e(t, `isNothing`);
...
var Ge = new y(`tag:yaml.org,2002:omap`, { kind: `sequence`, resolve: Ue, construct: We }),
...
function qe(e) {
  ...
  for (a = Array(o.length), t = 0, n = o.length; t < n; t += 1) {
    if (((r = o[t]), Ke.call(r) !== `[object Object]` || ((i = Object.keys(r)), i.length !== 1)))
      return !1;
    a[t] = [i[0], r[i[0]]];
  }
  return !0;
...
var Ye = new y(`tag:yaml.org,2002:pairs`, { kind: `sequence`, resolve: qe, construct: Je }),
...
var $e = new y(`tag:yaml.org,2002:set`, { kind: `mapping`, resolve: Ze, construct: Qe }),
...
var yt = {
  ...
  TAG: e(function (e, t, n) {
    ...
    (n.length !== 2 && j(e, `TAG directive accepts exactly two arguments`),
      (r = n[0]),
      (i = n[1]),
      ct.test(r) || j(e, `ill-formed tag handle (first argument) of the TAG directive`),
      x.call(e.tagMap, r) &&
        j(e, `there is a previously declared suffix for "` + r + `" tag handle`),
      lt.test(i) || j(e, `ill-formed tag prefix (second argument) of the TAG directive`));
    try {
  ...
  if (t < n) {
    if (((s = e.input.slice(t, n)), r))
      for (i = 0, a = s.length; i < a; i += 1)
        ((o = s.charCodeAt(i)),
          o === 9 || (32 <= o && o <= 1114111) || j(e, `expected valid JSON character`));
...
function bt(e, t, n, r) {
  var i, a, o, c;
  for (
    s.isObject(n) || j(e, `cannot merge mappings; the provided source object is unacceptable`),
      i = Object.keys(n),
      o = 0,
      c = i.length;
    o < c;
...
function P(e, t, n, r, i, a, o, s, c) {
  ...
  if (Array.isArray(i))
    for (i = Array.prototype.slice.call(i), l = 0, u = i.length; l < u; l += 1)
      (Array.isArray(i[l]) && j(e, `nested arrays are not supported inside keys`),
        typeof i == `object` && ut(i[l]) === `[object Object]` && (i[l] = `[object Object]`));
  if (
    (typeof i == `object` && ut(i) === `[object Object]` && (i = `[object Object]`),
    (i = String(i)),
    t === null && (t = {}),
    r === `tag:yaml.org,2002:merge`)
  )
    if (Array.isArray(a)) for (l = 0, u = a.length; l < u; l += 1) bt(e, t, a[l], n);
    else bt(e, t, a, n);
  else
    (!e.json &&
      !x.call(n, i) &&
...
function I(e, t, n) {
  for (var r = 0, i = e.input.charCodeAt(e.position); i !== 0; ) {
    ...
    if (t && i === 35)
      ...
      while (i !== 10 && i !== 13 && i !== 0);
    if (T(i))
      for (F(e), i = e.input.charCodeAt(e.position), r++, e.lineIndent = 0; i === 32; )
...
function xt(e, t, n) {
  ...
  for (e.kind = `scalar`, e.result = ``, a = o = e.position, s = !1; p !== 0; ) {
    if (p === 58) {
      ...
      if (((c = e.line), (l = e.lineStart), (u = e.lineIndent), I(e, !1, -1), e.lineIndent >= t)) {
...
function St(e, t) {
  ...
  for (
    ...
    if (n === 39)
      if ((N(e, r, e.position, !0), (n = e.input.charCodeAt(++e.position)), n === 39))
  ...
  for (
    ...
    if (s === 34) return (N(e, n, e.position, !0), e.position++, !0);
      ...
      if ((N(e, n, e.position, !0), (s = e.input.charCodeAt(++e.position)), T(s))) I(e, !1, t);
        ...
        for (i = o, a = 0; i > 0; i--)
          ((s = e.input.charCodeAt(++e.position)),
            (o = dt(s)) >= 0 ? (a = (a << 4) + o) : j(e, `expected hexadecimal character`));
  ...
  for (
    ...
    (n
      ...
      (f || e.line === r) &&
        ...
        B(e, t, S, !1, !0),
        (_ = e.result)),
      p ? P(e, s, m, g, h, _, r, i, a) : d ? s.push(P(e, null, m, g, h, _, r, i, a)) : s.push(h),
      I(e, !0, t),
      (v = e.input.charCodeAt(e.position)),
...
function Tt(e, t) {
  ...
  for (e.kind = `scalar`, e.result = ``; f !== 0; )
    if (((f = e.input.charCodeAt(++e.position)), f === 43 || f === 45))
      w === i ? (i = f === 43 ? it : rt) : j(e, `repeat of a chomping mode identifier`);
    else if ((d = pt(f)) >= 0)
      d === 0
...
function Et(e, t, n) {
  ...
  for (
    ...
    if (
      ...
      (v === 63
        ? (g && (P(e, d, f, p, m, null, o, s, c), (p = m = h = null)), (_ = !0), (g = !0), (i = !0))
        : g
          ? ((g = !1), (i = !0))
          : j(
              e,
      ...
      (o === 33 &&
        (r
          ...
          : ((i = e.input.slice(t - 1, e.position + 1)),
            ct.test(i) || j(e, `named tag handle cannot contain such characters`),
            (r = !0),
            (t = e.position + 1))),
        (o = e.input.charCodeAt(++e.position)));
    ((a = e.input.slice(t, e.position)),
      st.test(a) && j(e, `tag suffix cannot contain flow indicator characters`));
  }
        ...
        ? (s && (z(e, g) || Et(e, g, h))) || wt(e, h)
          ...
          : ((o && Tt(e, h)) || St(e, h) || Ct(e, h)
              ...
              : kt(e)
                ...
                : xt(e, h, S === n) && ((u = !0), e.tag === null && (e.tag = `?`)),
...
function At(e) {
  ...
  for (
    ...
    (I(e, !0, -1), (o = e.input.charCodeAt(e.position)), !(e.lineIndent > 0 || o !== 37));
  ) {
    ...
    (o !== 0 && F(e),
      x.call(yt, r) ? yt[r](e, r, i) : M(e, `unknown document directive "` + r + `"`));
  }
  if (
    (I(e, !0, -1),
    e.lineIndent === 0 &&
...
function Cn(t, n, r, i, a) {
  t.dump = (function () {
    ...
    switch (
      (e(l, `testAmbiguity`), Sn(n, c, t.indent, s, l, t.quotingType, t.forceQuotes && !i, a))
    ) {
      case vn:
        return n;
      case yn:
...
function On(e) {
  for (var t = ``, n = 0, r, i = 0; i < e.length; n >= 65536 ? (i += 2) : i++)
    ((n = X(e, i)),
      (r = G[n]),
      !r && Y(n) ? ((t += e[i]), n >= 65536 && (t += e[i + 1])) : (t += r || cn(n)));
  return t;
}
e(On, `escapeString`);
function kn(e, t, n) {
  ...
  for (a = 0, o = i.length; a < o; a += 1)
    if (
      ...
      if (
        ...
        if (
          ((c = e.styleMap[s.tag] || s.defaultStyle), Pt.call(s.represent) === `[object Function]`)
        )
          r = s.represent(t, c);
...
function Q(e, t, n, r, i, a, o) {
  ...
  if (
    ...
    if ((d && p && !e.usedDuplicates[f] && (e.usedDuplicates[f] = !0), s === `[object Object]`))
      ...
      r && e.dump.length !== 0
        ? (e.noArrayIndent && !o && t > 0 ? An(e, t - 1, e.dump, i) : An(e, t, e.dump, i),
