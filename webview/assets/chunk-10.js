import { i as e } from "./chunk-20.js";
import { t } from "./src-3.js";
import { n, r } from "./chunk-70.js";
import { I as i, N as a, O as o, s, y as c } from "./chunk-3.js";
import { a as l, i as u, n as d, o as f, r as p, t as m } from "./esm.js";
import { n as h } from "./marked.esm.js";
var g = {
  ...
  y = n((e) => {
    for (let t of e) {
      ...
      if ((r.debug(`Registering icon pack:`, t.name), `loader` in t)) v.set(t.name, t.loader);
...
var z = n(
  async (
    ...
    if ((r.debug(`XYZ createText`, i, a, s, c, l, u, `addSvgBackground: `, f), l)) {
      let t = await R(e(T(i, p)), p),
        r = i.replace(/\\\\/g, `\\`);
      return await M(
        n,
        { isNode: u, label: o(i) ? r : t, labelStyle: a.replace(`fill:`, `color:`) },
        d,
        c,
        f,
        p,
      ...
      let e = I(d, n, w(i.replace(/<br\s*\/?>/g, `<br/>`).replace(`<br>`, `<br/>`), p), i ? f : !1);
      if (u) {
