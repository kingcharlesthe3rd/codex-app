...
import { u as n } from "./chunk-50.js";
import { s as r, y as i } from "./chunk-95.js";
import { a, i as o, s } from "./chunk-44.js";
import { a as c, i as l, n as u, r as d } from "./chunk-79.js";
var f = {
    common: r,
    getConfig: i,
    insertCluster: o,
...
t(() => {
  m([
    { name: `dagre`, loader: t(async () => await import(`./dagre-6.js`), `loader`) },
    ...[
      {
        name: `cose-bilkent`,
        loader: t(async () => await import(`./cose-bilkent-5.js`), `loader`),
      },
    ],
  ]);
