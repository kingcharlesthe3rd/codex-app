...
import { L as o, O as s, P as c, k as l, s as u, y as d } from "./chunk-48.js";
import { n as f, t as p } from "./src-3.js";
import { i as m, u as h } from "./chunk-123.js";
import { a as g, c as _, i as v, n as y, o as b, r as x, s as S, t as C } from "./esm-2.js";
    ...
    (h(),
      ...
      (U = i((e) => {
        for (let t of e) {
          ...
          if ((r.debug(`Registering icon pack:`, t.name), `loader` in t)) H.set(t.name, t.loader);
      ...
      (q = i(
        async (
          ...
          if ((r.debug(`XYZ createText`, t, n, i, a, o, c, `addSvgBackground: `, u), o)) {
            let r = await z(m(E(t, d)), d),
              i = t.replace(/\\\\/g, `\\`);
            return await N(
              e,
              { isNode: c, label: s(t) ? i : r, labelStyle: n.replace(`fill:`, `color:`) },
              l,
              a,
              u,
              d,
