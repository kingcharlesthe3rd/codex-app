...
import { c as re, o as g } from "./lib-2.js";
import { m as ie, p as ae } from "./chunk-12.js";
import { h as oe } from "./persisted-signal-CweW-bgN.js";
import { o as se, u as ce } from "./statsig.js";
import { t as le } from "./use-auth-CI-WraL2.js";
import { b as _, c as ue, p as de, t as v } from "./codex-api.js";
import { r as fe } from "./toast-signal.js";
import { t as pe } from "./tooltip.js";
import { t as me } from "./use-collaboration-mode.js";
import { t as he } from "./button.js";
import { t as ge } from "./link-external.js";
import { t as _e } from "./skus.js";
import { t as ve } from "./with-window.js";
import { t as ye } from "./settings.cog.js";
import { t as be } from "./codex.js";
import { t as xe } from "./openai-blossom.js";
import { t as Se } from "./copy-to-clipboard.js";
import { r as Ce } from "./modal-controller-state.js";
import { d as y, i as b, l as x, n as we, r as Te } from "./dialog-layout.js";
import { t as Ee } from "./settings-sections.js";
import { n as De, t as Oe } from "./upgrade-plan-dialog-launcher.js";
import { a as ke } from "./command-keybindings.js";
import { i as Ae } from "./links.js";
import { t as je } from "./use-codex-pricing-url.js";
import { c as Me, d as Ne, o as Pe, t as Fe } from "./use-rate-limit-CL-Jgab4.js";
import { c as Ie } from "./plan-management-state.js";
import { i as S, r as Le, t as Re } from "./dropdown.js";
import { t as ze } from "./building.js";
import { t as Be } from "./referral-invite-modal.js";
import { t as Ve } from "./use-active-conversation-id.js";
import { t as He } from "./avatar.js";
import { t as Ue } from "./keyboard.js";
import { t as We } from "./log-out.js";
import { t as Ge } from "./rate-limit-reset-modal-BG-T1c9v.js";
import { t as Ke } from "./rate-limit-summary-BqI-pZT5.js";
import { n as qe, r as Je } from "./profile-queries.js";
import { t as Ye } from "./profile-visibility.js";
var Xe = e(s()),
  C = c(),
  w = (e) =>
    (0, C.jsx)(`svg`, {
...
function E(e) {
  ...
  let _t = gt,
    vt;
  s[9] === O ? (vt = s[10]) : ((vt = Ie(O)?.pricePlan ?? null), (s[9] = O), (s[10] = vt));
  let yt = vt,
    bt = !ft && w != null,
    xt = !lt && Be,
    St = !ft && w == null && Te,
  ...
  if (s[18] !== j || s[19] !== A) {
    ...
    (s[25] === j?.plan_type
      ? (t = s[26])
      : ((t = Ie(j?.plan_type)?.pricePlan ?? null), (s[25] = j?.plan_type), (s[26] = t)),
      (P = t),
      (M = Fe(e, { activeLimitName: N, selectedModel: A })),
      (F = Ne(j, { activeLimitName: N, selectedModel: A })),
      (Lt = M.some(at)),
      (s[18] = j),
      (s[19] = A),
      (s[20] = M),
  ...
  s[42] === _
    ? (nn = s[43])
    : ((nn = () => {
        (_(!1), m.dispatchMessage(`open-in-browser`, { url: Ae }));
      }),
      (s[42] = _),
      (s[43] = nn));
  let rn = nn,
  ...
  s[44] !== I || s[45] !== p || s[46] !== _
    ? ((an = () => {
        (_(!1),
          Ce(p, Ge, { initialAvailableCount: I, isRateLimitReached: !1, onResetComplete: it }));
      }),
      (s[44] = I),
      (s[45] = p),
      (s[46] = _),
  ...
  s[48] !== v || s[49] !== p
    ? ((sn = async () => {
        (await a(p, `use-copilot-auth-if-available`, !1),
          await i(`logout`, { hostId: r }),
          v(`/login`));
      }),
      (s[48] = v),
      (s[49] = p),
  ...
  if (
    ...
    if (((B = []), D)) {
      if (y) {
        ...
        s[78] === y
          ? (t = s[79])
          : ((t = (0, C.jsx)(S, { LeftIcon: He, disabled: !0, children: y })),
            (s[78] = y),
            (s[79] = t));
        let n;
        (s[80] !== e || s[81] !== t
    ...
    if (bt) {
      ...
      s[98] !== w || s[99] !== p || s[100] !== T || s[101] !== _
        ? ((e = () => {
            (_(!1), a(p, `use-copilot-auth-if-available`, !1), T(w));
          }),
          (s[98] = w),
          (s[99] = p),
          (s[100] = T),
      ...
      (s[104] === e
        ? (n = s[105])
        : ((n = (0, C.jsx)(S, { onClick: e, LeftIcon: We, children: t }, `switch-to-openai`)),
          (s[104] = e),
          (s[105] = n)),
        B.push(n));
    } else if (xt) {
      ...
      s[106] !== p || s[107] !== T || s[108] !== _
        ? ((e = () => {
            (_(!1), a(p, `use-copilot-auth-if-available`, !0), T(`copilot`));
          }),
          (s[106] = p),
          (s[107] = T),
          (s[108] = _),
      ...
      (s[111] === e
        ? (n = s[112])
        : ((n = (0, C.jsx)(S, { onClick: e, LeftIcon: We, children: t }, `switch-to-copilot`)),
          (s[111] = e),
          (s[112] = n)),
        B.push(n));
    }
  ...
  s[121] === B.length
    ? (H = s[122])
    : ((H = B.length > 0 && (0, C.jsx)(Le.Separator, {})), (s[121] = B.length), (s[122] = H));
  let U;
  s[123] !== wt ||
  s[124] !== v ||
  s[125] !== p ||
          ...
          children: [
            wt &&
              (0, C.jsx)(S, {
                LeftIcon: He,
                onClick: () => {
                  (oe(p, o, { source: `profile_dropdown` }),
                    _(!1),
  ...
  s[145] === J
    ...
    : ((Y = (0, C.jsx)(ve, {
        extension: !0,
        children: (0, C.jsx)(S, { LeftIcon: Ue, onClick: J, children: fn }),
      })),
      (s[145] = J),
      (s[146] = Y));
  let X;
