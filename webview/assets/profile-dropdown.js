...
import { Li as n, Xs as r, _n as i, g as ee, po as a } from "./app-server-manager-signals.js";
...
import { m as re, p as ie } from "./chunk-8.js";
import { t as ae } from "./product-logger.js";
import { o as oe, u as se } from "./statsig.js";
import { t as ce } from "./use-auth.js";
import { b as _, c as le, p as ue, t as v } from "./codex-api-B.js";
import { r as de } from "./toast-signal.js";
...
import { d as y, i as b, l as x, n as ve, r as ye } from "./dialog-layout.js";
import { t as be } from "./settings-sections.js";
import { r as xe } from "./modal-controller-state.js";
import { a as Se } from "./command-keybindings.js";
import {
  C as Ce,
  O as we,
  b as Te,
...
import { i as S, r as Me, t as Ne } from "./dropdown.js";
import { t as Pe } from "./copy-to-clipboard.js";
import { t as Fe } from "./settings.cog.js";
...
import { n as Ue, t as We } from "./referral-invite-modal.js";
import { t as Ge } from "./rate-limit-summary.js";
import { n as Ke } from "./profile-queries.js";
...
function Ze({ currentAccount: e, accounts: t }) {
  return T(e) ? (t == null ? !0 : t.some((e) => !T(e))) : !1;
}
function Qe({ authMethod: e, plan: t, currentAccount: n, accounts: r }) {
  return e !== `chatgpt` || (t !== ge.FREE && t !== ge.GO) || n == null || r == null
    ? !1
    : !Ze({ currentAccount: n, accounts: r });
}
var $e = g(),
  et = `1038162578`,
  tt = `3648137593`;
function E(e) {
  ...
  let _ = se,
    v = re(),
    {
      ...
      planAtLogin: ve,
      requiresAuth: ye,
      isCopilotApiAvailable: We,
      openAIAuth: w,
      setAuthMethod: T,
    } = ce(),
    { data: Ze } = le(),
    { data: E, isError: ot } = ue(),
    D = x === `chatgpt`,
    st = x === `copilot`,
    ct = x === `apikey`,
    lt = x === `amazonBedrock`,
    ut = D || ct,
    dt;
  o[2] === D ? (dt = o[3]) : ((dt = { queryConfig: { enabled: D } }), (o[2] = D), (o[3] = dt));
  let { data: ft } = te(`account-info`, dt),
    O = E?.plan_type ?? ft?.plan ?? ve,
    pt = Ze?.accounts,
    mt;
  o[4] !== E || o[5] !== x || o[6] !== O || o[7] !== pt
    ? ((mt = Qe({ authMethod: x, plan: O, currentAccount: E, accounts: pt })),
      (o[4] = E),
      (o[5] = x),
      (o[6] = O),
      (o[7] = pt),
  ...
  let ht = mt,
    gt;
  o[9] === O ? (gt = o[10]) : ((gt = we(O)?.pricePlan ?? null), (o[9] = O), (o[10] = gt));
  let _t = gt,
    vt = !ut && w != null,
    yt = !st && We,
    bt = !ut && w == null && ye,
  ...
  let wt = Ce(Ct),
    ...
    Et;
  o[12] !== k || o[13] !== Tt
    ? ((Et = k ?? (Tt?.params.taskId == null ? null : t(Tt.params.taskId))),
      (o[12] = k),
      (o[13] = Tt),
      (o[14] = Et))
    : (Et = o[14]);
  let Dt = Et,
    ...
    kt;
  o[15] !== Ot || o[16] !== k
    ? ((kt = k == null ? void 0 : { workspaceRoot: Ot }), (o[15] = Ot), (o[16] = k), (o[17] = kt))
    : (kt = o[17]);
  let At = kt,
    { activeMode: jt } = pe(Dt),
    A = jt?.settings.model ?? null,
    Mt = xt,
    Nt = p(Se, `settings`),
    Pt = l(),
    { data: j } = m(i),
  ...
  if (o[18] !== j || o[19] !== A) {
    ...
    (o[25] === j?.plan_type
      ? (t = o[26])
      : ((t = we(j?.plan_type)?.pricePlan ?? null), (o[25] = j?.plan_type), (o[26] = t)),
      (P = t),
      (M = ke(e, { activeLimitName: N, selectedModel: A })),
      (F = De(j, { activeLimitName: N, selectedModel: A })),
      (Ft = M.some(rt)),
      (o[18] = j),
      (o[19] = A),
      (o[20] = M),
      ...
      (o[23] = F),
      (o[24] = Ft));
  } else ((M = o[20]), (N = o[21]), (P = o[22]), (F = o[23]), (Ft = o[24]));
  let It = Ft,
    I = j?.rate_limit_reset_credits?.available_count ?? 0,
    Lt = It || I > 0,
    Rt = Te(),
    zt = Ae(),
    Bt = ge ?? ft?.accountId ?? null,
    Vt = g && St,
    Ht = b ?? ft?.userId ?? null,
    Ut;
  (o[27] !== Bt || o[28] !== Vt || o[29] !== Ht
  ...
  let Jt = qt,
    ...
    [Yt, Xt] = (0, Je.useState)(null),
    Zt;
  o[38] !== Pt || o[39] !== h || o[40] !== b
    ? ((Zt = async () => {
        if (b != null)
          try {
            (await Pe(b),
  ...
  o[42] === _
    ? ($t = o[43])
    : (($t = () => {
        (_(!1), ne.dispatchMessage(`open-in-browser`, { url: je }));
      }),
      (o[42] = _),
      (o[43] = $t));
  let en = $t,
    tn;
  o[44] !== I || o[45] !== h || o[46] !== _
    ? ((tn = () => {
        (_(!1),
          xe(h, Ue, { initialAvailableCount: I, isRateLimitReached: !1, onResetComplete: nt }));
      }),
      (o[44] = I),
      (o[45] = h),
      (o[46] = _),
  ...
  o[48] !== v || o[49] !== h
    ? ((rn = async () => {
        (await n(h, `use-copilot-auth-if-available`, !1),
          await r(`logout`, { hostId: a }),
          v(`/login`));
      }),
      (o[48] = v),
      (o[49] = h),
    ...
    ? ((on = function (e) {
        return z && z !== Yt
          ? (0, C.jsx)(`img`, {
              src: z,
              alt: ``,
              className: c(`rounded-full`, e.className),
              onError: () => {
                Xt(z);
              },
            })
          : (0, C.jsx)(Fe, { className: e.className });
      }),
      (o[51] = z),
      (o[52] = Yt),
      (o[53] = on))
  ...
  if (
    ...
    if (((B = []), D)) {
      if (y) {
        ...
        o[78] === y
          ? (t = o[79])
          : ((t = (0, C.jsx)(S, { LeftIcon: ze, disabled: !0, children: y })),
            (o[78] = y),
            (o[79] = t));
        let n;
        (o[80] !== e || o[81] !== t
      ...
      if (!ot) {
        let e;
        (o[83] !== sn || o[84] !== Jt
          ? ((e = (0, C.jsx)(S, { LeftIcon: sn, disabled: !0, children: Jt }, `account`)),
            (o[83] = sn),
            (o[84] = Jt),
            (o[85] = e))
          : (e = o[85]),
      ...
      if (ht) {
        let e;
        o[86] !== _t || o[87] !== wt || o[88] !== Rt || o[89] !== h || o[90] !== _
          ? ((e = () => {
              (_(!1),
                Rt({
                  scope: h,
          ...
          : (e = o[91]);
        let t;
        o[92] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, C.jsx)(d, {
        ...
        (o[93] === e
          ...
          : ((n = (0, C.jsx)(
              S,
              { LeftIcon: Ye, RightIcon: he, onClick: e, children: t },
              `upgrade-account`,
            )),
            (o[93] = e),
            (o[94] = n)),
      ...
      let e;
      (o[95] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, C.jsx)(
            S,
            {
              LeftIcon: ze,
      ...
      let e;
      (o[96] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, C.jsx)(
            S,
            {
              LeftIcon: ze,
    ...
    if (st) {
      let e;
      (o[97] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, C.jsx)(
            S,
            {
              LeftIcon: ze,
    ...
    if (vt) {
      let e;
      o[98] !== w || o[99] !== h || o[100] !== T || o[101] !== _
        ? ((e = () => {
            (_(!1), n(h, `use-copilot-auth-if-available`, !1), T(w));
          }),
          (o[98] = w),
          (o[99] = h),
          (o[100] = T),
        ...
        : (e = o[102]);
      let t;
      o[103] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, C.jsx)(d, {
      ...
      (o[104] === e
        ? (r = o[105])
        : ((r = (0, C.jsx)(S, { onClick: e, LeftIcon: He, children: t }, `switch-to-openai`)),
          (o[104] = e),
          (o[105] = r)),
        B.push(r));
    } else if (yt) {
      let e;
      o[106] !== h || o[107] !== T || o[108] !== _
        ? ((e = () => {
            (_(!1), n(h, `use-copilot-auth-if-available`, !0), T(`copilot`));
          }),
          (o[106] = h),
          (o[107] = T),
          (o[108] = _),
        ...
        : (e = o[109]);
      let t;
      o[110] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, C.jsx)(d, {
      ...
      (o[111] === e
        ? (r = o[112])
        : ((r = (0, C.jsx)(S, { onClick: e, LeftIcon: He, children: t }, `switch-to-copilot`)),
          (o[111] = e),
          (o[112] = r)),
        B.push(r));
    }
    if (bt) {
      ...
      o[113] !== v || o[114] !== _
        ...
        : (e = o[115]);
      let t;
      o[116] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, C.jsx)(d, {
      ...
      (o[117] === e
        ? (n = o[118])
        : ((n = (0, C.jsx)(S, { onClick: e, LeftIcon: Le, children: t }, `sign-in-openai`)),
          (o[117] = e),
          (o[118] = n)),
        B.push(n));
    }
    ...
    : ((V =
        ...
        (0, C.jsx)(fe, {
          ...
          children: (0, C.jsx)(me, {
            color: `ghost`,
            size: `icon`,
            children: (0, C.jsx)(Fe, { className: `icon-xs` }),
          }),
        })),
      (o[119] = s),
      (o[120] = V));
  ...
  o[121] === B.length
    ? (H = o[122])
    : ((H = B.length > 0 && (0, C.jsx)(Me.Separator, {})), (o[121] = B.length), (o[122] = H));
  let U;
  o[123] !== St ||
  o[124] !== v ||
  o[125] !== h ||
        ...
        (0, C.jsxs)(C.Fragment, {
          children: [
              ...
              (0, C.jsx)(S, {
                ...
                onClick: () => {
                  (ae(h, {
                    ...
                    metadata: { source: `profile_dropdown` },
                  }),
                    _(!1),
                    v(`/settings/profile`, { state: At }));
                },
                children: (0, C.jsx)(d, {
            ...
            (0, C.jsx)(S, {
              ...
              keyboardShortcut: Nt,
              onClick: () => {
                (_(!1), v(`/settings/general-settings`, { state: At }));
              },
              children: (0, C.jsx)(d, {
  ...
  o[131] === U
    ? (W = o[132])
    : ((W = (0, C.jsx)(_e, { browser: !0, electron: !0, children: U })),
      (o[131] = U),
      (o[132] = W));
  let G;
  o[133] === _
    ? (G = o[134])
    : ((G = () => {
        (_(!1), ne.dispatchMessage(`show-settings`, { section: be }));
      }),
      (o[133] = _),
      (o[134] = G));
  let cn;
  o[135] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((cn = (0, C.jsx)(d, {
  ...
  o[136] === G
    ...
    : ((K = (0, C.jsx)(_e, {
        extension: !0,
        children: (0, C.jsx)(S, { LeftIcon: Ie, onClick: G, children: cn }),
      })),
      (o[136] = G),
      (o[137] = K));
  let q;
  o[138] !== D || o[139] !== Kt || o[140] !== en
    ? ((q =
        D && Kt()
          ? (0, C.jsx)(S, {
              LeftIcon: Be,
  ...
  o[142] === _
    ? (J = o[143])
    : ((J = () => {
        (_(!1), ne.dispatchMessage(`open-keyboard-shortcuts`, {}));
      }),
      (o[142] = _),
      (o[143] = J));
  let ln;
  o[144] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ln = (0, C.jsx)(d, {
  ...
  o[145] === J
    ...
    : ((Y = (0, C.jsx)(_e, {
        extension: !0,
        children: (0, C.jsx)(S, { LeftIcon: Ve, onClick: J, children: ln }),
      })),
      (o[145] = J),
      (o[146] = Y));
  let X;
  ...
  o[157] !== zt
    ...
    : (X = o[158]);
  let Z;
  o[159] !== L || o[160] !== D || o[161] !== g || o[162] !== R
    ? ((Z = g && D && R != null ? (0, C.jsx)(it, { isPersonalAccount: L(), layer: R }) : null),
      (o[159] = L),
      (o[160] = D),
      (o[161] = g),
      (o[162] = R),
  ...
  o[164] === Z
    ? (Q = o[165])
    : ((Q = (0, C.jsx)(_e, { electron: !0, children: Z })), (o[164] = Z), (o[165] = Q));
  let un;
  o[166] !== an || o[167] !== ye || o[168] !== h || o[169] !== _
    ? ((un =
        ye &&
        (0, C.jsx)(S, {
          onClick: () => {
            (_(!1), xe(h, at, { onConfirm: an }));
          },
          LeftIcon: He,
          children: (0, C.jsx)(d, {
...
function it(e) {
  ...
  return (
    t[10] !== l || t[11] !== p
      ? ((m = (0, C.jsx)(S, { LeftIcon: w, onClick: l, children: p })),
        (t[10] = l),
        (t[11] = p),
        (t[12] = m))
      : (m = t[12]),
...
function at(e) {
  ...
  t[8] === n
    ? (u = t[9])
    : ((u = (0, C.jsx)(me, { color: `ghost`, type: `button`, onClick: n, children: l })),
      (t[8] = n),
      (t[9] = u));
  let f;
  ...
  t[11] === u
    ? (p = t[12])
    : ((p = (0, C.jsxs)(ye, { className: `gap-2`, children: [u, f] })), (t[11] = u), (t[12] = p));
  let m;
  t[13] !== s || t[14] !== p
    ? ((m = (0, C.jsxs)(ve, {
        as: `form`,
  ...
  return (
    t[16] !== n || t[17] !== m
      ? ((h = (0, C.jsx)(x, { open: !0, onOpenChange: n, size: `narrow`, children: m })),
        (t[16] = n),
        (t[17] = m),
        (t[18] = h))
      : (h = t[18]),
