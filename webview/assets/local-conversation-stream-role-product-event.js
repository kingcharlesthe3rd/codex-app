...
function N(e) {
  ...
  t[6] !== i
    ? ((d = () => {
        let e = i.get(S, n),
          ...
          a = T(e, t),
          l = O(e, t, u);
        (o && a != null && i.set(A, (e) => k(e ?? {}, n, a)),
          r.dispatchMessage(`heartbeat-automation-thread-state-changed`, {
            threadId: o ? n : null,
            isEligible: o && s.isEligible,
            collaborationMode: o ? c : null,
            permissions: o ? l : null,
  ...
  return (
    ...
    t[14] !== c ||
    t[15] !== i
      ? ((m = [u, n, s.isEligible, s.reason, l, o, c, i]),
        (t[8] = u),
        (t[9] = n),
        (t[10] = s.isEligible),
        (t[11] = s.reason),
    ...
    t[0] !== n || t[1] !== r
      ? ((i = () => {
          ...
          return r.watch((t) => {
            let { get: i } = t,
              a = i(s, n);
            a == null || e || ((e = !0), d(r, C, { streamRole: a.role }));
          });
        }),
        (a = [n, r]),
        (t[0] = n),
