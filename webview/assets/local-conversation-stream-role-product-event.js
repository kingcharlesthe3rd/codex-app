...
import { G as s, V as c, pt as l, q as u } from "./app-server-manager-signals.js";
import { f as d } from "./vscode-api.js";
import { o as f, wr as p } from "./persisted-signal.js";
...
function w(e) {
  ...
  return (
    ...
    t[14] !== h ||
    t[15] !== l
      ? ((D = [T, n, p.isEligible, p.reason, w, f, h, l]),
        (t[8] = T),
        (t[9] = n),
        (t[10] = p.isEligible),
        (t[11] = p.reason),
    ...
    t[0] !== n || t[1] !== r
      ? ((a = () => {
          ...
          return r.watch((t) => {
            let { get: i } = t,
              a = i(l, n);
            a == null || e || ((e = !0), f(r, p, { streamRole: a.role }));
          });
        }),
        (o = [n, r]),
        (t[0] = n),
