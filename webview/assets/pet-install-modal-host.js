...
import { rn as C, tn as w } from "./app-initial~app-main~automations-page.js";
import { n as T, t as E } from "./avatar-mascot-button.js";
import { r as D, t as O } from "./custom-avatars-query.js";
import { i as k, n as A, r as j, t as M } from "./pet-install-state-2.js";
function N(e) {
  let n = (0, P.c)(37),
    { session: r, onClose: i, onInstall: a } = e,
    { setSelectedAvatarId: o } = C(),
    c = r.status !== `installing`,
    l = r.status === `ready` || r.status === `installError`,
    u;
  n[0] !== c || n[1] !== i
    ? ((u = (e) => {
        !e && c && i();
  ...
  n[6] !== r.name || n[7] !== r.status
    ...
    : (h = n[8]);
  let g;
  n[9] !== r.description || n[10] !== h
    ? ((g = (0, F.jsx)(x, { children: (0, F.jsx)(t, { title: h, subtitle: r.description }) })),
      (n[9] = r.description),
      (n[10] = h),
      (n[11] = g))
    : (g = n[11]);
  ...
  n[24] !== o
    ...
    : (w = n[25]);
  let T;
  n[26] !== m || n[27] !== g || n[28] !== y || n[29] !== b || n[30] !== w
    ? ((T = (0, F.jsxs)(S, { as: `form`, onSubmit: m, children: [g, y, b, w] })),
      (n[26] = m),
      (n[27] = g),
      (n[28] = y),
      (n[29] = b),
...
function L(e) {
  ...
  let l;
  t[3] !== s || t[4] !== i
    ? ((l = () => j(i, () => s(O))), (t[3] = s), (t[4] = i), (t[5] = l))
    : (l = t[5]);
  let u;
  return (
    t[6] !== a || t[7] !== c || t[8] !== l
      ? ((u = (0, z.jsx)(N, { session: a, onClose: c, onInstall: l })),
        (t[6] = a),
        (t[7] = c),
        (t[8] = l),
        (t[9] = u))
