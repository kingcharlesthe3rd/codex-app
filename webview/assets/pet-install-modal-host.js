...
import { n as x, t as S } from "./avatar-mascot-button.js";
import {
  bn as C,
  yn as w,
...
function N(e) {
  ...
  t[9] !== n.description || t[10] !== f
    ? ((y = (0, F.jsx)(h, { children: (0, F.jsx)(v, { title: f, subtitle: n.description }) })),
      (t[9] = n.description),
      (t[10] = f),
      (t[11] = y))
    : (y = t[11]);
  ...
  t[26] !== d || t[27] !== y || t[28] !== x || t[29] !== C || t[30] !== w
    ? ((E = (0, F.jsxs)(m, { as: `form`, onSubmit: d, children: [y, x, C, w] })),
      (t[26] = d),
      (t[27] = y),
      (t[28] = x),
      (t[29] = C),
