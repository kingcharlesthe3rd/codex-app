...
function N(e) {
  ...
  t[6] !== n.name || t[7] !== n.status
    ...
    : (h = t[8]);
  let g;
  t[9] !== n.description || t[10] !== h
    ? ((g = (0, F.jsx)(s, { children: (0, F.jsx)(c, { title: h, subtitle: n.description }) })),
      (t[9] = n.description),
      (t[10] = h),
      (t[11] = g))
    : (g = t[11]);
  ...
  t[24] !== a
    ...
    : (C = t[25]);
  let E;
  t[26] !== p || t[27] !== g || t[28] !== v || t[29] !== S || t[30] !== C
    ? ((E = (0, F.jsxs)(x, { as: `form`, onSubmit: p, children: [g, v, S, C] })),
      (t[26] = p),
      (t[27] = g),
      (t[28] = v),
      (t[29] = S),
