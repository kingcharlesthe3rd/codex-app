...
import { n as y, t as b } from "./avatar-mascot-button.js";
import {
  $ as x,
  Q as S,
  Z as C,
...
function N(e) {
  ...
  t[6] !== n.name || t[7] !== n.status
    ...
    : (p = t[8]);
  let h;
  t[9] !== n.description || t[10] !== p
    ? ((h = (0, F.jsx)(g, { children: (0, F.jsx)(m, { title: p, subtitle: n.description }) })),
      (t[9] = n.description),
      (t[10] = p),
      (t[11] = h))
    : (h = t[11]);
  ...
  t[24] !== a
    ...
    : (w = t[25]);
  let E;
  t[26] !== d || t[27] !== h || t[28] !== y || t[29] !== S || t[30] !== w
    ? ((E = (0, F.jsxs)(_, { as: `form`, onSubmit: d, children: [h, y, S, w] })),
      (t[26] = d),
      (t[27] = h),
      (t[28] = y),
      (t[29] = S),
...
function L(e) {
  ...
  let d;
  n[3] !== c || n[4] !== o
    ? ((d = () => j(o, () => c(O))), (n[3] = c), (n[4] = o), (n[5] = d))
    : (d = n[5]);
  let f;
  return (
    n[6] !== s || n[7] !== l || n[8] !== d
      ? ((f = (0, z.jsx)(N, { session: s, onClose: l, onInstall: d })),
        (n[6] = s),
        (n[7] = l),
        (n[8] = d),
        (n[9] = f))
