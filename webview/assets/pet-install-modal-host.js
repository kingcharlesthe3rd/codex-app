...
import { n as g, t as _ } from "./avatar-mascot-button.js";
import {
  A as v,
  D as y,
  S as b,
...
function N(e) {
  ...
  t[9] !== n.description || t[10] !== m
    ? ((h = (0, F.jsx)(b, { children: (0, F.jsx)(C, { title: m, subtitle: n.description }) })),
      (t[9] = n.description),
      (t[10] = m),
      (t[11] = h))
    : (h = t[11]);
  ...
  t[26] !== f || t[27] !== h || t[28] !== g || t[29] !== v || t[30] !== x
    ? ((E = (0, F.jsxs)(w, { as: `form`, onSubmit: f, children: [h, g, v, x] })),
      (t[26] = f),
      (t[27] = h),
      (t[28] = g),
      (t[29] = v),
