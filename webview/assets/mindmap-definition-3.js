...
import "./chunk-34.js";
import { $ as n, L as r, O as i, Q as a, b as o, d as s, tt as c, y as l } from "./chunk-87.js";
import "./dist-5.js";
import "./chunk-127.js";
import "./chunk-54.js";
import "./chunk-146.js";
import { t as u } from "./chunk-25.js";
import { t as d } from "./chunk-64.js";
import "./chunk-134.js";
import "./chunk-30.js";
import "./chunk-67.js";
import { r as f, t as p } from "./chunk-7.js";
const m = [];
...
var S = x,
  ...
  T = class {
    ...
    flattenNodes(e, n) {
      ...
      if ((n.push(c), e.children)) for (let t of e.children) this.flattenNodes(t, n);
    }
    generateEdges(e, t) {
    ...
    getData() {
      let t = this.getMindmap(),
        ...
        r = i().layout !== void 0,
        a = n;
      if ((r || (a.layout = `cose-bilkent`), !t)) return { nodes: [], edges: [], config: a };
      ...
      let l = new Map();
      for (let e of s)
        l.set(e.id, { shape: e.shape, width: e.width, height: e.height, padding: e.padding });
      return {
        nodes: s,
        edges: c,
        config: a,
