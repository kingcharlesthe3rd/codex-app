...
import { _n as h } from "./src-3.js";
import { s as g } from "./lib-1.js";
import { t as _ } from "./use-stable-callback.js";
import { F as v, I as y, L as ee, M as b } from "./rpc-1.js";
...
function _e(e) {
  let t = (0, E.c)(108),
    ...
    g;
  t[0] !== c || t[1] !== a || t[2] !== i
    ? ((g = { hostId: c, includeHidden: a, root: i }),
      (t[0] = c),
      (t[1] = a),
      (t[2] = i),
      (t[3] = g))
  ...
  let v = s(me, g),
    ...
    b;
  t[4] !== c || t[5] !== a || t[6] !== i
    ? ((b = { hostId: c, includeHidden: a, root: i }),
      (t[4] = c),
      (t[5] = a),
      (t[6] = i),
      (t[7] = b))
  ...
  let x = s(he, b),
    ...
    ae = p(`open-file`),
    S;
  t[8] === i ? (S = t[9]) : ((S = h(i)), (t[8] = i), (t[9] = S));
  let C = S,
    w,
    T;
  t[10] !== n || t[11] !== y || t[12] !== i
    ? ((w = n == null ? null : le({ filePath: n, root: i })),
      (T = ce(y, w)),
      (t[10] = n),
      (t[11] = y),
      (t[12] = i),
  ...
  let k = T,
    ...
    F = (0, D.useRef)(j),
    I;
  t[15] !== A || t[16] !== c || t[17] !== a || t[18] !== f || t[19] !== i
    ? ((I = { expandedItems: A, hostId: c, includeHidden: a, refreshKey: f, root: i }),
      (t[15] = A),
      (t[16] = c),
      (t[17] = a),
      (t[18] = f),
      ...
      (t[20] = I))
    : (I = t[20]);
  let { error: Ce, files: we, isEmpty: Te, isLoading: Ee } = o(ge, I),
    L;
  t[21] === i ? (L = t[22]) : ((L = [i]), (t[21] = i), (t[22] = L));
  let De = L,
    R;
  t[23] !== x || t[24] !== m
    ? ((R = (e) => {
  ...
  let Oe = _(R),
    z;
  t[26] !== Oe || t[27] !== c || t[28] !== y.searchQuery || t[29] !== De
    ? ((z = { hostId: c, onFiles: Oe, query: y.searchQuery, roots: De }),
      (t[26] = Oe),
      (t[27] = c),
      (t[28] = y.searchQuery),
      (t[29] = De),
  ...
  t[31] === y.searchQuery
    ? (B = t[32])
    : ((B = y.searchQuery.trim()), (t[31] = y.searchQuery), (t[32] = B));
  let je = B,
    V;
  t[33] !== ne || t[34] !== y.searchQuery || t[35] !== ke
    ? ((V = de(ke, ne, y.searchQuery)),
      (t[33] = ne),
      (t[34] = y.searchQuery),
      (t[35] = ke),
      (t[36] = V))
  ...
  let Ne = _(K),
    q;
  t[46] !== x || t[47] !== y.searchQuery || t[48] !== m || t[49] !== W || t[50] !== H
    ? ((q = (e) => {
        (H != null && m.set(x, { files: H, query: y.searchQuery }), W(e, { isPreview: !0 }));
      }),
      (t[46] = x),
      (t[47] = y.searchQuery),
      (t[48] = m),
  ...
  t[54] !== v || t[55] !== m
    ? ((Y = () => {
        let e = N.current;
        e != null && ((N.current = null), m.set(v, (t) => oe(t, e)));
      }),
      (t[54] = v),
      (t[55] = m),
      (t[56] = Y))
  ...
  t[62] === ze
    ? (Be = t[63])
    : ((Be = (e) => {
        (Se(M.current, e.expandedPaths) || ((M.current = e.expandedPaths), pe(e.expandedPaths)),
          F.current !== e.selectedPath && ((F.current = e.selectedPath), _e(e.selectedPath)),
          ze(e));
      }),
      (t[62] = ze),
      (t[63] = Be));
  ...
  (t[64] !== w || t[65] !== v || t[66] !== m
    ...
    (0, D.useEffect)(He, Ue));
  let We, Ge;
  (t[69] !== A || t[70] !== c || t[71] !== a || t[72] !== f || t[73] !== i || t[74] !== m
    ? ((We = () => {
        xe(m, { expandedItems: A, hostId: c, includeHidden: a, refreshKey: f, root: i });
      }),
      (Ge = [A, c, a, f, i, m]),
      (t[69] = A),
      (t[70] = c),
  ...
  (t[77] === X
    ? ((Ke = t[78]), (qe = t[79]))
    : ((Ke = () => () => {
        (P.current != null && (window.clearTimeout(P.current), (P.current = null)), X());
      }),
      (qe = [X]),
      (t[77] = X),
      (t[78] = Ke),
...
function ye(e) {
  let t = (0, E.c)(22),
    ...
    l;
  t[0] === n ? (l = t[1]) : ((l = n == null ? null : S(n)), (t[0] = n), (t[1] = l));
  let u = l,
    d;
  t[2] === u ? (d = t[3]) : ((d = u == null ? A : I(u.map(M))), (t[2] = u), (t[3] = d));
  let f = d;
...
async function xe(e, { expandedItems: t, hostId: n, includeHidden: r, refreshKey: i, root: a }) {
  await Promise.all(
    ae(t).map(async (t) => {
      await e.query
        .fetch(j, { directoryPath: t, hostId: n, includeHidden: r, refreshKey: i, root: a })
        .catch(() => void 0);
    }),
  );
}
...
export { _e as t };
//# sourceMappingURL=workspace-directory-tree-C.js.map
