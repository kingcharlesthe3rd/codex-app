...
import { $i as m, Ar as h, Xi as g, Zi as _, na as v } from "./src-1.js";
...
var C = m((e) => x(e), g().finite()).optional(),
  w = m((e) => S(e), g().int()).optional(),
  T = _({
    title: v().trim().min(1),
    body: v().trim().min(1),
    file: v().trim().min(1),
...
function A(e, t) {
  let n = [];
  for (let r of p(e, { lineStartNames: [o] })) {
...
var F = e(),
  ...
  L = i(r, (e) => {
    let t = new WeakMap(),
      i = I;
    return n(r, ({ get: n }) => {
      let r = N({ cache: t, storedModelComments: I, turns: n(s, e) });
      return (B(i, r) || (i = r), i);
    });
  });
function R(e, n) {
  let r = (0, F.c)(10),
    [i, a] = u(`diff_comments`),
    [o] = u(`diff_comments_from_model`),
    s = t(L, n),
    c = i?.[e] ?? I,
    l = o?.[e] ?? I,
    d;
  r[0] !== l || r[1] !== s
    ? ((d = z({ storedModelComments: l, turnModelComments: s })),
      (r[0] = l),
      (r[1] = s),
      (r[2] = d))
    : (d = r[2]);
  ...
  return (
    r[6] !== c || r[7] !== f || r[8] !== m
      ? ((h = { comments: c, modelComments: f, setComments: m }),
        (r[6] = c),
        (r[7] = f),
        (r[8] = m),
        (r[9] = h))
...
function B(e, t) {
  return e.length === t.length
    ? e.every((e, n) => {
        let r = t[n];
        return r != null && c(e) === c(r);
      })
    : !1;
}
function V(e) {
  let n = (0, F.c)(11),
    { conversationId: r, enablePullRequestComments: i, localConversationId: o } = e,
    s = i === void 0 ? !0 : i,
    { comments: c, modelComments: u, setComments: d } = R(r, o),
    p = String(r),
    m;
  n[0] === p ? (m = n[1]) : ((m = h(p)), (n[0] = p), (n[1] = m));
  let g = m,
    _ = t(f, g) ?? ``,
    v = t(l, g),
    b = t(a, g) ?? void 0,
  ...
  n[2] !== _ || n[3] !== v || n[4] !== b
    ...
    : (x = n[5]);
  let S = t(y, x),
    C = s && S.type === `success` ? S.data.commentAttachments : void 0,
    w;
  return (
    n[6] !== c || n[7] !== u || n[8] !== d || n[9] !== C
      ? ((w = {
          commentProps: {
            enableComments: !0,
            comments: c,
...
//# sourceMappingURL=use-diff-comment-sources-BiMg-OCE.js.map
