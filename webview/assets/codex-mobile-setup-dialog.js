...
import { Sn as Be, xn as Ve } from "./app-initial~app-main~automations-page.js";
import {
  $ as He,
  Ft as Ue,
  G as We,
...
import { n as rt, t as it } from "./segmented-toggle.js";
import { n as at, t as ot } from "./use-home-directory.js";
import { a as st, o as ct } from "./plugin-detail-page-utils.js";
var lt,
  ut = e(() => {
    (ce(), (lt = V(`electron:codex-mobile-setup-step-debug-override`, `auto`)));
  }),
  dt,
  ft = e(() => {
    dt = `` + new URL(`dialog-artwork-allow-host-B0bcIhDi.png`, import.meta.url).href;
  }),
  pt,
  mt = e(() => {
    pt = `` + new URL(`dialog-artwork-connected-NZKCls7p.png`, import.meta.url).href;
  }),
  ht,
  gt = e(() => {
    ht = `` + new URL(`dialog-artwork-initial-DMDAvEM7.png`, import.meta.url).href;
  }),
  _t,
  vt = e(() => {
    _t = `` + new URL(`dialog-artwork-mfa-e9Fx75-r.png`, import.meta.url).href;
  }),
  yt,
  bt = e(() => {
    yt = `` + new URL(`dialog-artwork-waiting-computer-BPIs9eKV.png`, import.meta.url).href;
  }),
  xt,
  St = e(() => {
    xt = `` + new URL(`dialog-artwork-waiting-phone-UTYmfLHs.png`, import.meta.url).href;
  }),
  Ct,
  wt = e(() => {
    Ct = `` + new URL(`page-artwork-allow-host-CPm7eJR2.png`, import.meta.url).href;
  }),
  Tt,
  Et = e(() => {
    Tt = `` + new URL(`page-artwork-mfa-e6UxOdqq.png`, import.meta.url).href;
  }),
  Dt,
  Ot = e(() => {
    Dt = `` + new URL(`page-artwork-waiting-pzj85BPm.png`, import.meta.url).href;
  }),
  kt,
  At = e(() => {
    kt = `` + new URL(`page-artwork-shared-Dv_GQL_j.png`, import.meta.url).href;
  }),
  jt,
  Mt,
  Nt = e(() => {
...
function Bt(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = W(`flex w-full flex-col gap-2 text-center`, s)), (t[0] = s), (t[1] = c));
  let l =
      o === `dialog`
    ...
    u;
  t[2] !== a || t[3] !== l
    ? ((u = (0, Ht.jsx)(`div`, { className: l, children: a })), (t[2] = a), (t[3] = l), (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] !== r || t[6] !== o
    ? ((d =
  ...
  let f;
  t[8] !== c || t[9] !== u || t[10] !== d
    ? ((f = (0, Ht.jsxs)(`div`, { className: c, children: [u, d] })),
      (t[8] = c),
      (t[9] = u),
      (t[10] = d),
      (t[11] = f))
  ...
  let p;
  t[12] !== i || t[13] !== f
    ? ((p = (0, Ht.jsxs)(Ht.Fragment, { children: [i, f] })), (t[12] = i), (t[13] = f), (t[14] = p))
    : (p = t[14]);
  let m = p;
  if (o === `dialog`) {
    let e;
...
var Vt,
  ...
  Wt,
  Gt = e(() => {
    Wt = `` + new URL(`page-artwork-background-DPNBzfAy.png`, import.meta.url).href;
  });
function Kt(e) {
  let t = (0, Yt.c)(13),
...
function Jt(e) {
  let t = (0, Yt.c)(6),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = W(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function Zt() {
  let e = (0, en.c)(55),
    ...
    c = b(`410065390`),
    l;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((l = { hostId: y }), (e[0] = l)) : (l = e[0]);
  let u = p(l).available,
    d = r(a.keepRemoteControlAwakeWhilePluggedIn),
    f = _e(Ge, y),
    h = o(qe),
    g;
  e[1] === t.query ? (g = e[2]) : ((g = t.query.snapshot(qe)), (e[1] = t.query), (e[2] = g));
  let _ = g,
    v;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((v = []), (e[3] = v)) : (v = e[3]);
  let x = ye(y, v),
    S;
  e[4] !== s || e[5] !== x.availablePlugins
    ? ((S = $t(x.availablePlugins, nn, s)), (e[4] = s), (e[5] = x.availablePlugins), (e[6] = S))
    : (S = e[6]);
  let C = S,
    w = C?.plugin.installed === !0 && C.plugin.enabled,
    T;
  e[7] !== s || e[8] !== x.availablePlugins
    ? ((T = Qt(x.availablePlugins, s)), (e[7] = s), (e[8] = x.availablePlugins), (e[9] = T))
    : (T = e[9]);
  let E = T,
    D;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = { hostId: y }), (e[10] = D))
    : (D = e[10]);
  let { pendingPluginId: O, setPluginEnabled: k } = pe(D),
    A;
  e[11] === x.forceReload
    ? (A = e[12])
    : ((A = { forceReloadPlugins: x.forceReload, hostId: y }),
      (e[11] = x.forceReload),
      (e[12] = A));
  let {
  ...
  e[13] === _
    ...
    : ((ie = {
      ...
      (e[14] = ie));
  let I = i(ie),
    L = n === `macOS` && w && f && h.data?.enabled != null,
    R;
  e[15] !== C || e[16] !== h.data?.enabled || e[17] !== F || e[18] !== k || e[19] !== I
    ? ((R = (e) => {
        if (C != null) {
          ...
          if (!e && h.data?.enabled) {
            I.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && k({ enabled: !1, pluginDisplayName: ge(C), pluginId: C.plugin.id });
              },
            });
            return;
          }
          k({ enabled: e, pluginDisplayName: ge(C), pluginId: C.plugin.id });
        }
      }),
      (e[15] = C),
      (e[16] = h.data?.enabled),
  ...
  e[21] !== E || e[22] !== F || e[23] !== k
    ? ((se = (e) => {
        if (E != null) {
          ...
          k({ enabled: e, pluginDisplayName: ge(E), pluginId: E.plugin.id });
        }
      }),
      (e[21] = E),
      (e[22] = F),
    ...
    : (se = e[24]);
  let ce = se,
    z = E?.plugin.installed === !0 && E.plugin.enabled,
    le = x.isLoading || E == null || P || O === E.plugin.id,
    B = x.isLoading || C == null || P || I.isPending || O === C.plugin.id,
    ue = d ?? !1,
    de = h.data?.enabled ?? !1,
    fe = !w || h.isLoading || I.isPending,
    V;
  e[25] === t
    ? (V = e[26])
    : ((V = (e) => {
        oe(t, a.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = V));
  let he;
  ...
  return (
    ...
    e[53] !== U
      ? ((W = {
          chromeExtensionEnabled: z,
          chromeExtensionToggleDisabled: le,
          computerUseEnabled: w,
          computerUseToggleDisabled: B,
          keepComputerAwake: ue,
          keepComputerAwakeToggleDisabled: !1,
          lockedComputerUseEnabled: de,
          lockedComputerUseToggleDisabled: fe,
          onChromeExtensionEnabledChange: ce,
          onComputerUseEnabledChange: ae,
          onKeepComputerAwakeChange: V,
          onLockedComputerUseEnabledChange: he,
          pluginInstallModal: U,
          showChromeExtensionSetup: c,
          showComputerUseSetup: u,
          showKeepComputerAwake: !0,
          showLockedComputerUse: L,
        }),
        (e[39] = w),
        (e[40] = ce),
        (e[41] = ae),
...
function Qt(e, t) {
  return c.isInternal(ae()) ? ($t(e, on, t) ?? $t(e, an, t) ?? $t(e, rn, t)) : $t(e, rn, t);
}
function $t(e, t, n) {
  ...
  return (
    ...
    r.find((e) => le(e.marketplaceName)) ??
    r.find((e) => e.marketplaceName === `openai-curated`) ??
    r.find((e) => ct(n, e.marketplacePath)) ??
    null
  );
}
var en,
...
function cn(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, q.jsx)(Te, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let u, d;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let f =
    ...
    p;
  t[4] === f ? (p = t[5]) : ((p = W(`flex w-full flex-col`, f)), (t[4] = f), (t[5] = p));
  let m;
    ...
    ? ((m = s.showKeepComputerAwake
        ? (0, q.jsx)(un, {
            icon: s.keepComputerAwake
              ? (0, q.jsx)(nt, { className: `icon-base` })
              : (0, q.jsx)(Rt, { className: `icon-base` }),
            variant: i,
            title:
              o === `windows`
                ? (0, q.jsx)(l, {
  ...
  t[24] !== i
    ? ((h =
        s.showComputerUseSetup && s.showLockedComputerUse
          ? (0, q.jsx)(un, {
              icon: (0, q.jsx)(Mt, { className: `icon-base` }),
              variant: i,
              title: (0, q.jsx)(l, {
          ...
          : s.showComputerUseSetup
            ? (0, q.jsx)(un, {
                icon: (0, q.jsx)(Ft, { className: `icon-base` }),
                variant: i,
                title: (0, q.jsx)(l, {
  ...
  t[31] !== i
    ? ((g = s.showChromeExtensionSetup
        ? (0, q.jsx)(un, {
            icon: (0, q.jsx)(Ae, { className: `icon-base` }),
            variant: i,
            title: (0, q.jsx)(l, {
  ...
  t[33] !== p || t[34] !== m || t[35] !== h || t[36] !== g
    ? ((_ = (0, q.jsxs)(`div`, { className: p, children: [m, h, g] })),
      (t[33] = p),
      (t[34] = m),
      (t[35] = h),
      (t[36] = g),
  ...
  let v = i === `page` && `w-[256px]`,
    y;
  t[38] === v ? (y = t[39]) : ((y = W(`justify-center`, v)), (t[38] = v), (t[39] = y));
  let b;
  ...
  t[41] !== n || t[42] !== y
    ? ((x = (0, q.jsx)(`div`, {
        ...
        children: (0, q.jsx)(N, { size: `large`, className: y, onClick: n, children: b }),
      })),
      (t[41] = n),
      (t[42] = y),
      (t[43] = x))
  ...
  t[44] !== r || t[45] !== i
    ? ((S =
        i === `page` && r != null
          ? (0, q.jsx)(Jt, { className: `w-[256px]`, onManageConnections: r })
          : null),
      (t[44] = r),
      (t[45] = i),
      (t[46] = S))
  ...
  let w;
  return (
    t[55] !== s.pluginInstallModal || t[56] !== ee
      ? ((w = (0, q.jsxs)(q.Fragment, { children: [ee, s.pluginInstallModal] })),
...
function un(e) {
  ...
  if (i != null) {
    ...
    t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== o
      ? ((l = (0, q.jsx)(dn, { description: n, icon: r, title: a, trailing: o })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o),
    ...
    return (
      t[7] !== i || t[8] !== c || t[9] !== l
        ? ((u = (0, q.jsx)(`button`, { type: `button`, className: c, onClick: i, children: l })),
          (t[7] = i),
          (t[8] = c),
          (t[9] = l),
          (t[10] = u))
  ...
  t[11] === c
    ? (l = t[12])
    : ((l = W(`flex items-center justify-between gap-4 px-[14px] py-2 text-left`, c)),
      (t[11] = c),
      (t[12] = l));
  let u;
  t[13] !== n || t[14] !== r || t[15] !== a || t[16] !== o
    ? ((u = (0, q.jsx)(dn, { description: n, icon: r, title: a, trailing: o })),
      (t[13] = n),
      (t[14] = r),
      (t[15] = a),
      (t[16] = o),
...
function Kn({ onArtworkReady: e, svgMarkup: t }) {
  let n = Se(),
    r = (0, J.useId)().replaceAll(`:`, ``),
    i = (0, J.useRef)(null),
    a = (0, J.useRef)(null),
    o = (0, J.useRef)(null),
    s = (0, J.useRef)({ current: null, lastSampledAt: 0, trail: [] }),
    c = (0, J.useRef)(null),
    l = (0, J.useRef)(null),
    u = (0, J.useRef)(null),
    d = (0, J.useCallback)(function e(t) {
      let n = o.current,
        r = a.current,
        i = c.current;
      ...
      if (n != null) {
        ...
        for (let [r, i] of n.trailSpots.entries()) {
          ...
          nr(i, n, (1 - (t - n.sampledAt) / cr) * (1 - r / lr) * ur);
        }
      }
      let d = u.current;
      if (n != null && d != null) {
  ...
  function h() {
    ((c.current = null), rr(s.current, o.current));
  }
...
function qn(e, t) {
  ...
  let i = Array.from(e.querySelectorAll(`:scope > path`)).map((e) => {
    ...
    a = ar(`defs`),
    o = Jn(e, `interactive-brush-${t}`),
    s = Array.from({ length: lr }, (n, r) => Jn(e, `interactive-brush-trail-${r}-${t}`)),
    c = $n(e, `interactive-brush-${t}-mask`);
  c.append(o.maskRect, ...s.map(({ maskRect: e }) => e));
  let { gradient: l, stops: u } = Xn(e, `interactive-ripple-${t}`),
    d = Qn(e, l);
  (a.append(n, o.gradient, ...s.map(({ gradient: e }) => e), c, l, d), e.prepend(a));
  let f = tr(r, `currentColor`, `1`),
    p = tr(r, `var(--color-token-charts-blue)`, `0`, c.id, sr),
    m = tr(r, `var(--color-token-charts-blue)`, `0`, d.id, pr);
  return (
    e.append(f, p, m),
    {
      baseOverlay: f,
...
function Yn(e) {
  let t = ar(`radialGradient`);
  return (
    (t.id = e),
    t.setAttribute(`gradientUnits`, `userSpaceOnUse`),
    t.setAttribute(`cx`, String(-or)),
    t.setAttribute(`cy`, String(-or)),
    t.setAttribute(`r`, String(or)),
    t.append(Zn(`0`, `1`), Zn(`0.58`, `0.61`), Zn(`0.99`, `0.23`), Zn(`1`, `0`)),
    t
  );
}
function Xn(e, t) {
  let n = ar(`radialGradient`),
    r = e.viewBox.baseVal,
    i = [Zn(`0`, `0`), Zn(`0`, `1`), Zn(`0`, `0`)];
  return (
    (n.id = t),
...
function _r(e) {
  ...
  t[0] !== n || t[1] !== i
    ...
    : (a = t[2]);
  let { clearPaint: o, paintDots: s, rootRef: c, triggerRipple: l } = Kn(a),
    u,
    d;
  (t[3] === l
    ? ((u = t[4]), (d = t[5]))
...
var vr,
  ...
  br,
  xr = e(() => {
    ((vr = S()), (yr = t(G(), 1)), gr(), (br = R()));
  }),
  Sr,
  Cr = e(() => {
    Sr = `` + new URL(`codex-home-hero-dark-still-43PvFxTG.png`, import.meta.url).href;
  }),
  wr,
  Tr = e(() => {
    wr = `` + new URL(`codex-home-hero-dark-_BGDEdk8.mp4`, import.meta.url).href;
  }),
  Er,
  Dr = e(() => {
    Er = `` + new URL(`codex-home-hero-light-still-CQ7cy4qg.png`, import.meta.url).href;
  }),
  Or,
  kr = e(() => {
    Or = `` + new URL(`codex-home-hero-light-Cyip34F2.mp4`, import.meta.url).href;
  }),
  Ar,
  jr = e(() => {
...
function Mr(e) {
  ...
  t[5] === r
    ? (_ = t[6])
    : ((_ = W(`size-full shrink-0 object-contain`, r)), (t[5] = r), (t[6] = _));
  let v = _;
  if (a || c === u) {
    let e;
    t[7] === r
      ? (e = t[8])
      : ((e = W(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== v || t[10] !== d
      ? ((a = (0, Ir.jsx)(`img`, { alt: ``, "aria-hidden": `true`, className: v, src: d })),
        (t[9] = v),
        (t[10] = d),
        (t[11] = a))
      : (a = t[11]);
  ...
  t[17] === r
    ? (y = t[18])
    : ((y = W(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = y));
  let b;
  t[19] === g
    ? (b = t[20])
    : ((b = (e) => {
...
var Pr,
  ...
  Br = e(() => {
    ((Pr = S()),
      ...
      he(),
      (Ir = R()),
      (Lr = { dark: { stillSrc: Sr, videoSrc: wr }, light: { stillSrc: Er, videoSrc: Or } }),
      (Rr = `url(${Ee(Ar)})`),
      (zr = {
        maskImage: Rr,
        maskMode: `alpha`,
...
function qr(e) {
  ...
  return (
    t[6] !== n || t[7] !== r || t[8] !== o || t[9] !== l
      ? ((u = (0, X.jsx)(Xr, { ariaLabel: n, centerLogoAriaLabel: r, platform: o, size: l })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = o),
        (t[9] = l),
...
function Jr(e) {
  ...
  if (i) {
    ...
    return (
      t[3] !== n || t[4] !== l
        ? ((e = (0, X.jsx)(Yr, { ariaLabel: n, ...l })), (t[3] = n), (t[4] = l), (t[5] = e))
        : (e = t[5]),
      e
    );
  }
  ...
  return (
    t[6] !== n || t[7] !== r || t[8] !== l || t[9] !== s
      ? ((u = (0, X.jsx)($r, { ariaLabel: n, centerLogoAriaLabel: r, size: s, ...l })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = l),
        (t[9] = s),
...
function Xr(e) {
  ...
  if (i === `android`) {
    ...
    return (
      t[0] !== n || t[1] !== o
        ? ((e = (0, X.jsx)(Zr, { ariaLabel: n, size: o })), (t[0] = n), (t[1] = o), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== o
      ? ((s = (0, X.jsx)(Qr, { ariaLabel: n, centerLogoAriaLabel: r, size: o })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s))
...
function Zr(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = W(`relative overflow-hidden bg-token-main-surface-primary`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, X.jsx)(`div`, {
        ...
        dangerouslySetInnerHTML: { __html: Hn },
      })),
      (t[2] = o))
    : (o = t[2]);
  let s;
...
function $r(e) {
  ...
  t[1] === u
    ? (d = t[2])
    : ((d = W(`relative overflow-hidden bg-token-main-surface-primary`, u)),
      (t[1] = u),
      (t[2] = d));
  let f;
  t[3] === i
  ...
  t[5] === a
    ? (p = t[6])
    : ((p = (0, X.jsx)(_r, { ref: s, onArtworkReady: l, svgMarkup: a })), (t[5] = a), (t[6] = p));
  let m = o === `compact` ? `w-10` : `w-14`,
    h;
  t[7] === m
    ? (h = t[8])
    : ((h = W(`pointer-events-auto aspect-square`, m)), (t[7] = m), (t[8] = h));
  let g;
  t[9] !== r || t[10] !== h
    ? ((g = (0, X.jsx)(`div`, {
        className: `pointer-events-none absolute inset-0 z-20 grid place-items-center`,
        children: (0, X.jsx)(Mr, { ariaLabel: r, className: h, onClick: l }),
      })),
      (t[9] = r),
      (t[10] = h),
      (t[11] = g))
...
function ti(e, t, n) {
  ...
  for (let i = 0; i < e.size; i += 1)
    for (let a = 0; a < e.size; a += 1)
      !ui(e, i, a) || di(e.size, i, a) || (n && li(e.size, t, i, a)) || r.push(ii(a, t, i));
  return oi(r.join(``));
}
function ni(e, t) {
...
function ri(e, t, n) {
  let r = ci(e, n),
    ...
    o = n,
    s = n * 2;
  return `<path fill-rule="evenodd" clip-rule="evenodd" d="${ai(r, i, a, n * 1.6)} ${ai(r + o, i + o, a - o * 2, n)}" fill="currentColor"/><rect x="${Y(r + s)}" y="${Y(i + s)}" width="${Y(a - s * 2)}" height="${Y(a - s * 2)}" rx="${Y(n)}" fill="currentColor"/>`;
}
function ii(e, t, n) {
  let r = t * yi,
    i = si(e, t),
    a = si(n, t);
  return `<path d="M ${Y(i)} ${Y(a - r)} A ${Y(r)} ${Y(r)} 0 1 1 ${Y(i)} ${Y(a + r)} A ${Y(r)} ${Y(r)} 0 1 1 ${Y(i)} ${Y(a - r)} Z" fill="currentColor"/>`;
}
function ai(e, t, n, r) {
  let i = e + n,
    a = t + n;
  return `M ${Y(e + r)} ${Y(t)} H ${Y(i - r)} A ${Y(r)} ${Y(r)} 0 0 1 ${Y(i)} ${Y(t + r)} V ${Y(a - r)} A ${Y(r)} ${Y(r)} 0 0 1 ${Y(i - r)} ${Y(a)} H ${Y(e + r)} A ${Y(r)} ${Y(r)} 0 0 1 ${Y(e)} ${Y(a - r)} V ${Y(t + r)} A ${Y(r)} ${Y(r)} 0 0 1 ${Y(e + r)} ${Y(t)} Z`;
}
function oi(e) {
...
function wi(e) {
  let t = (0, Ii.c)(82),
    ...
    f = b(C),
    p = b(Ce),
    [m, g] = (0, Li.useState)(`ios`),
    [_, v] = (0, Li.useState)(!1),
    [S, ee] = (0, Li.useState)(`phone`),
    w = c ? (n ?? S) : `phone`,
    [T] = (0, Li.useState)(Ti),
    E;
  t[0] !== s || t[1] !== T
    ? ((E = { hostId: s, openId: T }), (t[0] = s), (t[1] = T), (t[2] = E))
    : (E = t[2]);
  let D = _e(h, E),
    O = f && !p,
    k = O && D.error == null ? (D.data ?? null) : null,
    A = k?.manualPairingCode ?? null,
    te = O && k == null && (D.error == null || D.isFetching),
    j = !f || k?.pairingCode != null,
    M = w === `phone` && !f && !p,
    ne = O && w === `computer` && !te,
    P;
  t[3] !== n || t[4] !== i
  ...
  if (p) {
    ...
    t[17] === d
      ...
      : ((e = d.formatMessage({
        ...
        (t[18] = e));
    let n;
    (t[19] === e ? (n = t[20]) : ((n = (0, Z.jsx)(Di, { ariaLabel: e })), (t[19] = e), (t[20] = n)),
      (B = n));
  } else if (w === `phone` && j) {
    let e = k?.pairingCode,
      n;
    (t[21] !== ce || t[22] !== oe || t[23] !== m || t[24] !== u || t[25] !== e
      ? ((n = (0, Z.jsx)(qr, {
          ariaLabel: oe,
          centerLogoAriaLabel: ce,
          pairingCode: e,
          platform: m,
          size: u,
        })),
    ...
    (t[27] === D.error
      ? (e = t[28])
      : ((e = (0, Z.jsx)(Fi, { error: D.error })), (t[27] = D.error), (t[28] = e)),
      (B = e));
  } else if (f) {
    let e;
    (t[29] !== A || t[30] !== D.error || t[31] !== u
      ? ((e = (0, Z.jsx)(Oi, { error: D.error, manualPairingCode: A, size: u })),
        (t[29] = A),
        (t[30] = D.error),
        (t[31] = u),
        (t[32] = e))
  ...
  t[34] === fe
    ? (V = t[35])
    : ((V = W(`flex w-full flex-col items-center gap-4`, fe)), (t[34] = fe), (t[35] = V));
  let pe;
  t[36] !== d || t[37] !== p || t[38] !== F || t[39] !== w || t[40] !== c
    ? ((pe =
        c && !p
          ? (0, Z.jsx)(`div`, {
      ...
      (t[41] = pe))
    : (pe = t[41]);
  let me = u === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    he = M ? null : `justify-center`,
    ge =
      w === `computer`
        ? u === `compact`
  ...
  t[46] !== B || t[47] !== M
    ? ((U = M
        ? (0, Z.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: B })
        : B),
      (t[46] = B),
      (t[47] = M),
      (t[48] = U))
  ...
  t[60] !== R
              ...
              w === `phone` && j
                ? (0, Z.jsx)(x, {
                    ...
                    children: (0, Z.jsx)(N, {
                      ...
                      onClick: () => v(!0),
                      size: `icon`,
                      children: (0, Z.jsx)(Oe, { className: `icon-xs` }),
                    }),
                  })
                : null,
              (0, Z.jsx)(x, {
                ...
                children: (0, Z.jsx)(N, {
                  ...
                  size: `icon`,
                  children: (0, Z.jsx)(Le, {
                    className: W(`icon-xs`, D.isFetching ? `animate-spin` : null),
                  }),
                }),
              }),
            ],
    ...
    : (ye = t[61]);
  let be;
  t[62] !== H || t[63] !== U || t[64] !== ve || t[65] !== ye
    ? ((be = (0, Z.jsxs)(`div`, { className: H, children: [U, ve, ye] })),
      (t[62] = H),
      (t[63] = U),
      (t[64] = ve),
      (t[65] = ye),
    ...
    : (be = t[66]);
  let xe;
  t[67] === ne ? (xe = t[68]) : ((xe = ne ? (0, Z.jsx)(Pi, {}) : null), (t[67] = ne), (t[68] = xe));
  let Se;
  t[69] !== ce || t[70] !== d || t[71] !== _ || t[72] !== k || t[73] !== oe || t[74] !== m
    ? ((Se =
        k?.pairingCode == null
          ? null
          : (0, Z.jsxs)(ue, {
  ...
  let G;
  return (
    t[76] !== V || t[77] !== pe || t[78] !== be || t[79] !== xe || t[80] !== Se
      ? ((G = (0, Z.jsxs)(`div`, { className: V, children: [pe, be, xe, Se] })),
        (t[76] = V),
        (t[77] = pe),
        (t[78] = be),
        (t[79] = xe),
...
function Ei(e) {
  ...
  t[5] !== a || t[6] !== s || t[7] !== c
    ...
    : (d = t[8]);
  let f = i === `android`,
    p = i === `android` ? `text-token-text-primary` : `text-token-text-tertiary`,
    m;
  t[9] === p
    ? (m = t[10])
    : ((m = W(
      ...
      (t[10] = m));
  let h;
  t[11] === r ? (h = t[12]) : ((h = () => r(`android`)), (t[11] = r), (t[12] = h));
  let g;
...
function Di(e) {
  let t = (0, Ii.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(se, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function zi(e) {
  let t = (0, Ki.c)(34),
    ...
    { platform: s } = me(),
    c;
  t[0] !== s || t[1] !== o ? ((c = Wi(o, s)), (t[0] = s), (t[1] = o), (t[2] = c)) : (c = t[2]);
  let u = c,
    d;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (d = t[3]);
  let f;
  t[4] === o ? (f = t[5]) : ((f = (0, Q.jsx)(Ui, { variant: o })), (t[4] = o), (t[5] = f));
  let p = o === `page` && `w-full max-w-[400px]`,
    m;
  t[6] === p
    ? (m = t[7])
    : ((m = W(`flex flex-wrap items-center justify-center gap-3`, p)), (t[6] = p), (t[7] = m));
  let h;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((h =
        o === `dialog`
  ...
  let g = o === `page` && `w-full`,
    _;
  t[12] === g ? (_ = t[13]) : ((_ = W(`justify-center`, g)), (t[12] = g), (t[13] = _));
  let v;
  ...
  t[15] !== r || t[16] !== a || t[17] !== _
    ? ((y = (0, Q.jsx)(N, { onClick: r, size: `large`, className: _, loading: a, children: v })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = _),
      (t[18] = y))
  ...
  t[19] !== y || t[20] !== m || t[21] !== h
    ? ((b = (0, Q.jsxs)(`div`, { className: m, children: [h, y] })),
      (t[19] = y),
      (t[20] = m),
      (t[21] = h),
      (t[22] = b))
  ...
  let C;
  return (
    t[27] !== u || t[28] !== b || t[29] !== x || t[30] !== S || t[31] !== f || t[32] !== o
      ? ((C = (0, Q.jsxs)(Bt, { variant: o, heading: u, description: d, children: [f, b, x, S] })),
        (t[27] = u),
        (t[28] = b),
        (t[29] = x),
        (t[30] = S),
...
function Bi(e) {
  ...
  return (
    t[8] !== u || t[9] !== d || t[10] !== a
      ? ((f = (0, Q.jsxs)(Bt, { variant: a, heading: o, description: s, children: [u, d] })),
        (t[8] = u),
        (t[9] = d),
        (t[10] = a),
        (t[11] = f))
...
function Vi(e) {
  ...
  t[3] === n
    ? (s = t[4])
    : ((s = (0, Q.jsx)(N, { size: `large`, className: `justify-center`, onClick: n, children: o })),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
    t[5] !== s || t[6] !== r
      ? ((c = (0, Q.jsx)(Bt, { variant: r, heading: i, description: a, children: s })),
        (t[5] = s),
        (t[6] = r),
        (t[7] = c))
      : (c = t[7]),
...
function Hi(e) {
  ...
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(wi, { showDeviceTypeSelector: !1 })), (t[3] = o))
    : (o = t[3]);
  let s;
  t[4] === n
    ? (s = t[5])
    : ((s = (0, Q.jsxs)(`div`, {
        ...
        children: [o, (0, Q.jsx)(Jt, { onManageConnections: n })],
      })),
      (t[4] = n),
      (t[5] = s));
  let c;
  return (
    t[6] !== i || t[7] !== s
      ? ((c = (0, Q.jsx)(Bt, { variant: `page`, heading: i, description: a, children: s })),
        (t[6] = i),
        (t[7] = s),
        (t[8] = c))
      : (c = t[8]),
...
function Ui(e) {
  let t = (0, Ki.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = W(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Q.jsx)(Gi, {
        icon: (0, Q.jsx)(Ve, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Q.jsx)(l, {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(Gi, {
        icon: (0, Q.jsx)(Fe, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Q.jsx)(l, {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(Gi, {
        icon: (0, Q.jsx)(Me, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Q.jsx)(l, {
...
var Ki,
  Q,
  qi = e(() => {
    ((Ki = S()), w(), d(), z(), j(), Ie(), Re(), Be(), _(), Ut(), Xt(), Ri(), (Q = R()));
  });
function Ji(e) {
  let t = (0, Yi.c)(16),
  ...
  if (o === `page`) {
    ...
    t[4] === s
      ...
      : ((n = (0, Xi.jsx)(`div`, {
          className: `flex w-full max-w-[460px] flex-col items-center gap-6`,
          children: (0, Xi.jsx)(wi, { hostId: s, showDeviceTypeSelector: !1 }),
        })),
        (t[4] = s),
        (t[5] = n));
    let r;
    return (
      t[6] !== d || t[7] !== n
        ? ((r = (0, Xi.jsx)(Bt, { variant: `page`, heading: d, description: e, children: n })),
          (t[6] = d),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  return (
    t[13] !== d || t[14] !== f
      ? ((p = (0, Xi.jsx)(Bt, { variant: `dialog`, heading: d, children: f })),
        (t[13] = d),
        (t[14] = f),
        (t[15] = p))
      : (p = t[15]),
...
function Qi(e) {
  ...
  if (p === `dialog`) {
    ...
    t[15] !== g || t[16] !== f
      ...
      : (e = t[17]);
    let n;
    t[18] === e ? (n = t[19]) : ((n = (0, $.jsx)(qt, { artworkSrc: e })), (t[18] = e), (t[19] = n));
    let r;
    return (
      t[20] !== y || t[21] !== n
        ? ((r = (0, $.jsxs)(`div`, {
  ...
  return (
    t[27] !== y || t[28] !== b || t[29] !== x
      ? ((S = (0, $.jsx)(Kt, { artworkAlignment: b, artworkSrc: x, children: y })),
        (t[27] = y),
        (t[28] = b),
        (t[29] = x),
        (t[30] = S))
...
function $i(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, $.jsx)(Kt, { children: (0, $.jsx)(Hi, { onManageConnections: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function ea(e) {
  ...
  switch (m) {
    ...
    case `connected`: {
      ...
      return (
        t[5] !== s || t[6] !== c || t[7] !== h
          ? ((e = (0, $.jsx)(cn, { onFinishSetup: s, onManageConnections: c, variant: h })),
            (t[5] = s),
            (t[6] = c),
            (t[7] = h),
            (t[8] = e))
...
function sa(e) {
  ...
  let y;
  t[1] !== g || t[2] !== _ || t[3] !== d
    ? ((y = ca(g, _, d)), (t[1] = g), (t[2] = _), (t[3] = d), (t[4] = y))
    : (y = t[4]);
  let b;
  t[5] === y
    ? (b = t[6])
    : ((b = (0, ua.jsx)(ie, { className: `sr-only`, children: y })), (t[5] = y), (t[6] = b));
  let x;
  t[7] !== h || t[8] !== d
    ? ((x = (e) => {
        (re(h, ve, { action: `continue_on_chatgpt`, step: d, surface: `dialog` }),
          fe({
            event: e,
    ...
    : (x = t[9]);
  let S;
  t[10] !== i || t[11] !== h || t[12] !== d
    ? ((S = () => {
        (re(h, ve, { action: `finish_setup`, step: d, surface: `dialog` }), i(!1));
      }),
      (t[10] = i),
      (t[11] = h),
      (t[12] = d),
