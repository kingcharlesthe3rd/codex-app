...
import { C as t, jr as n, kr as r, mr as i, pr as a } from "./src-C.js";
import { Li as o, Ps as s, po as c } from "./app-server-manager-signals.js";
...
import { t as T } from "./use-is-dark.js";
import { t as E } from "./button.js";
import { r as D } from "./spinner.js";
import { t as O } from "./chats.js";
import { t as ee } from "./use-platform.js";
import { i as k } from "./use-is-plugins-enabled.js";
import { m as A, v as j } from "./use-plugins.js";
import { n as M, s as N, t as P } from "./use-plugin-install-flow.js";
import { d as F, l as I } from "./dialog-layout.js";
import { o as te, r as ne } from "./plugins-availability.js";
import { t as L } from "./data-url-from-svg.js";
import { m as re } from "./links.js";
import { t as ie } from "./check-circle.js";
import { t as ae } from "./phone.js";
import { t as R } from "./chrome-ZI-wJE1V.js";
import { o as z } from "./check-plugin-availability.js";
import { t as B } from "./toggle.js";
import { o as oe, r as se } from "./computer-use-app-approvals-query.js";
import { t as ce } from "./sun.js";
import { t as le } from "./use-home-directory.js";
import { t as V } from "./cursor.js";
import { t as H } from "./segmented-toggle.js";
var U = s(`electron:codex-mobile-setup-step-debug-override`, `auto`),
  ...
  fe = `` + new URL(`dialog-artwork-mfa-e9Fx75-r.png`, import.meta.url).href,
  pe = `` + new URL(`dialog-artwork-waiting-computer-BPIs9eKV.png`, import.meta.url).href,
  me = `` + new URL(`dialog-artwork-waiting-phone-UTYmfLHs.png`, import.meta.url).href,
  he = `` + new URL(`page-artwork-allow-host-C3m2nRMv.png`, import.meta.url).href,
  ge = `` + new URL(`page-artwork-connected-BUPhttJ1.png`, import.meta.url).href,
  _e = `` + new URL(`page-artwork-mfa-e6UxOdqq.png`, import.meta.url).href,
  G = `` + new URL(`page-artwork-ready-bfkkMY-P.png`, import.meta.url).href,
  K = `` + new URL(`page-artwork-waiting-pzj85BPm.png`, import.meta.url).href,
  q = e(l()),
  J = u(),
  Y = (e) =>
    (0, J.jsxs)(`svg`, {
...
function Q(e) {
  ...
  let l =
    ...
    u;
  t[2] !== a || t[3] !== l
    ? ((u = (0, J.jsx)(`div`, { className: l, children: a })), (t[2] = a), (t[3] = l), (t[4] = u))
    : (u = t[4]);
  let f;
  t[5] !== r || t[6] !== o
    ? ((f =
  ...
  let m;
  t[12] !== i || t[13] !== p
    ? ((m = (0, J.jsxs)(J.Fragment, { children: [i, p] })), (t[12] = i), (t[13] = p), (t[14] = m))
    : (m = t[14]);
  let h = m;
  if (o === `dialog`) {
    let e;
...
function De() {
  let e = (0, Z.c)(53),
    ...
    a = w(`410065390`),
    o;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = { hostId: c }), (e[0] = o)) : (o = e[0]);
  let s = k(o).available,
    l = v(t.keepRemoteControlAwakeWhilePluggedIn),
    u = g(N, c),
    d = _(se),
    f;
  e[1] === n.query ? (f = e[2]) : ((f = n.query.snapshot(se)), (e[1] = n.query), (e[2] = f));
  let m = f,
    x;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((x = []), (e[3] = x)) : (x = e[3]);
  let S = A(c, x),
    C;
  e[4] !== i || e[5] !== S.availablePlugins
    ? ((C = $(S.availablePlugins, Ce, i)), (e[4] = i), (e[5] = S.availablePlugins), (e[6] = C))
    : (C = e[6]);
  let T = C,
    E = T?.plugin.installed === !0 && T.plugin.enabled,
    D;
  e[7] !== i || e[8] !== S.availablePlugins
    ? ((D = Oe(S.availablePlugins, i)), (e[7] = i), (e[8] = S.availablePlugins), (e[9] = D))
    : (D = e[9]);
  let O = D,
    j;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = { hostId: c }), (e[10] = j))
    : (j = e[10]);
  let { pendingPluginId: F, setPluginEnabled: I } = ne(j),
    L;
  e[11] === S.forceReload
    ? (L = e[12])
    : ((L = { forceReloadPlugins: S.forceReload, hostId: c }),
      (e[11] = S.forceReload),
      (e[12] = L));
  let {
  ...
  e[13] === m
    ...
    : ((ce = {
      ...
      (e[14] = ce));
  let V = b(ce),
    H = r === `macOS` && E && u && d.data?.enabled != null,
    U;
  e[15] !== T || e[16] !== d.data?.enabled || e[17] !== z || e[18] !== I || e[19] !== V
    ? ((U = (e) => {
        if (T != null) {
          ...
          if (!e && d.data?.enabled) {
            V.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && I({ enabled: !1, pluginDisplayName: te(T), pluginId: T.plugin.id });
              },
            });
            return;
          }
          I({ enabled: e, pluginDisplayName: te(T), pluginId: T.plugin.id });
        }
      }),
      (e[15] = T),
      (e[16] = d.data?.enabled),
  ...
  e[21] !== O || e[22] !== z || e[23] !== I
    ...
    : (W = e[24]);
  let de = W,
    fe = O?.plugin.installed === !0 && O.plugin.enabled,
    pe = S.isLoading || O == null || R || F === O.plugin.id,
    me = S.isLoading || T == null || R || V.isPending || F === T.plugin.id,
    he = l ?? !1,
    ge = d.data?.enabled ?? !1,
    _e = !E || d.isLoading || V.isPending,
    G;
  e[25] === n
    ? (G = e[26])
    : ((G = (e) => {
        y(n, t.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = n),
      (e[26] = G));
  let K;
  ...
  e[29] === re
    ...
    : ((q = (e) => {
      ...
      (e[30] = q));
  let Y;
  e[31] !== ie || e[32] !== ae || e[33] !== R || e[34] !== B || e[35] !== q
    ? ((Y = (0, J.jsx)(M, {
        hostId: c,
        isInstalling: R,
  ...
  return (
    ...
    e[51] !== Y
      ? ((X = {
          ...
          computerUseEnabled: E,
          computerUseToggleDisabled: me,
          keepComputerAwake: he,
...
function ke(e) {
  ...
  t[3] === a
    ? (v = t[4])
    : ((v = a === `page` ? (0, J.jsx)(ie, { className: `size-11 text-token-foreground` }) : void 0),
      (t[3] = a),
      (t[4] = v));
  let y, b;
  ...
  let x =
    ...
    S;
  t[7] === x ? (S = t[8]) : ((S = d(`flex w-full flex-col`, x)), (t[7] = x), (t[8] = S));
  let C;
    ...
    ? ((C = u.showKeepComputerAwake
        ? (0, J.jsx)(je, {
            icon: u.keepComputerAwake
              ? (0, J.jsx)(ce, { className: `icon-base` })
              : (0, J.jsx)(ve, { className: `icon-base` }),
            variant: a,
            title:
              l === `windows`
                ? (0, J.jsx)(m, {
  ...
  t[33] !== c ||
  t[34] !== a
    ? ((T = u.showChromeExtensionSetup
        ? (0, J.jsx)(je, {
            icon: (0, J.jsx)(R, { className: `icon-base` }),
            variant: a,
            title: (0, J.jsx)(m, {
    ...
    : (T = t[35]);
  let D;
  t[36] !== S || t[37] !== C || t[38] !== w || t[39] !== T
    ? ((D = (0, J.jsxs)(`div`, { className: S, children: [C, w, T] })),
      (t[36] = S),
      (t[37] = C),
      (t[38] = w),
      (t[39] = T),
      (t[40] = D))
    : (D = t[40]);
  let O = a === `page` && `w-[256px]`,
    k;
  t[41] === O ? (k = t[42]) : ((k = d(`justify-center`, O)), (t[41] = O), (t[42] = k));
  let A;
  ...
  t[44] !== _ || t[45] !== k
    ? ((j = (0, J.jsx)(`div`, {
        ...
        children: (0, J.jsx)(E, { size: `large`, className: k, onClick: _, children: A }),
      })),
      (t[44] = _),
      (t[45] = k),
      (t[46] = j))
  ...
  t[47] !== i || t[48] !== a
    ? ((M =
        a === `page` && i != null
          ? (0, J.jsx)(Se, { className: `w-[256px]`, onManageConnections: i })
          : null),
      (t[47] = i),
      (t[48] = a),
      (t[49] = M))
  ...
  let F;
  return (
    t[58] !== u.pluginInstallModal || t[59] !== P
      ? ((F = (0, J.jsxs)(J.Fragment, { children: [P, u.pluginInstallModal] })),
...
function je(e) {
  ...
  if (i != null) {
    ...
    t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== o
      ? ((l = (0, J.jsx)(Me, { description: n, icon: r, title: a, trailing: o })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o),
    ...
    return (
      t[7] !== i || t[8] !== c || t[9] !== l
        ? ((u = (0, J.jsx)(`button`, { type: `button`, className: c, onClick: i, children: l })),
          (t[7] = i),
          (t[8] = c),
          (t[9] = l),
          (t[10] = u))
...
function Me(e) {
  ...
  t[2] === i
    ? (s = t[3])
    : ((s = (0, J.jsx)(`div`, { className: `text-sm text-token-text-primary`, children: i })),
      (t[2] = i),
      (t[3] = s));
  let c;
  t[4] === n
  ...
  let l;
  t[6] !== s || t[7] !== c
    ? ((l = (0, J.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [s, c] })),
      (t[6] = s),
      (t[7] = c),
      (t[8] = l))
    : (l = t[8]);
  ...
  return (
    t[14] !== u || t[15] !== d
      ? ((f = (0, J.jsxs)(J.Fragment, { children: [u, d] })), (t[14] = u), (t[15] = d), (t[16] = f))
      : (f = t[16]),
    f
  );
}
...
function at(e) {
  ...
  if (a === `android`) {
    ...
    t[0] === r
      ? (e = t[1])
      : ((e = d(`cursor-interaction overflow-hidden text-token-text-primary`, r)),
        (t[0] = r),
        (t[1] = e));
    let a;
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  t[12] === r
    ? (y = t[13])
    : ((y = d(`size-full shrink-0 object-contain`, r)), (t[12] = r), (t[13] = y));
  let b = y;
  if (o || l === f) {
    let e;
    t[14] === r
      ? (e = t[15])
      : ((e = d(`cursor-interaction overflow-hidden`, r)), (t[14] = r), (t[15] = e));
    let a;
    t[16] !== b || t[17] !== p
      ? ((a = (0, J.jsx)(`img`, { alt: ``, "aria-hidden": `true`, className: b, src: p })),
        (t[16] = b),
        (t[17] = p),
        (t[18] = a))
      : (a = t[18]);
  ...
  t[24] === r
    ? (x = t[25])
    : ((x = d(`cursor-interaction overflow-hidden`, r)), (t[24] = r), (t[25] = x));
  let S;
  t[26] === v
    ? (S = t[27])
    : ((S = (e) => {
  ...
  t[28] === f
    ...
    : ((C = () => {
      ...
      (t[29] = C));
  let w;
  t[30] !== b || t[31] !== p || t[32] !== S || t[33] !== C || t[34] !== f || t[35] !== m
    ? ((w = (0, J.jsx)(
        `video`,
        {
          ref: s,
...
function st(e) {
  ...
  return (
    t[9] !== n || t[10] !== m || t[11] !== h
      ? ((g = (0, J.jsx)(`div`, { "aria-label": n, className: m, role: `img`, children: h })),
        (t[9] = n),
        (t[10] = m),
        (t[11] = h),
        (t[12] = g))
...
function ct(e) {
  ...
  t[13] !== a || t[14] !== r || t[15] !== g || t[16] !== _
    ? ((v = (0, J.jsx)(st, { ariaLabel: g, centerLogoAriaLabel: _, platform: a, size: r })),
      (t[13] = a),
      (t[14] = r),
      (t[15] = g),
      (t[16] = _),
...
function lt(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[3]);
  let f;
  t[4] === o ? (f = t[5]) : ((f = (0, J.jsx)(pt, { variant: o })), (t[4] = o), (t[5] = f));
  ...
  t[15] !== r || t[16] !== a || t[17] !== v
    ? ((b = (0, J.jsx)(E, { onClick: r, size: `large`, className: v, loading: a, children: y })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = v),
      (t[18] = b))
  ...
  t[19] !== b || t[20] !== h || t[21] !== g
    ? ((x = (0, J.jsxs)(`div`, { className: h, children: [g, b] })),
      (t[19] = b),
      (t[20] = h),
      (t[21] = g),
      (t[22] = x))
  ...
  return (
    t[27] !== l || t[28] !== x || t[29] !== S || t[30] !== C || t[31] !== f || t[32] !== o
      ? ((w = (0, J.jsxs)(Q, { variant: o, heading: l, description: u, children: [f, x, S, C] })),
        (t[27] = l),
        (t[28] = x),
        (t[29] = S),
        (t[30] = C),
...
function ut(e) {
  ...
  return (
    t[6] !== c || t[7] !== i
      ? ((l = (0, J.jsx)(Q, { variant: i, heading: a, description: o, children: c })),
        (t[6] = c),
        (t[7] = i),
        (t[8] = l))
      : (l = t[8]),
...
function dt(e) {
  ...
  t[3] === n
    ? (s = t[4])
    : ((s = (0, J.jsx)(E, { size: `large`, className: `justify-center`, onClick: n, children: o })),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
    t[5] !== s || t[6] !== r
      ? ((c = (0, J.jsx)(Q, { variant: r, heading: i, description: a, children: s })),
        (t[5] = s),
        (t[6] = r),
        (t[7] = c))
      : (c = t[7]),
    ...
    t[3] === n
      ...
      : ((o = (0, J.jsx)(Q, {
          ...
          children: (0, J.jsxs)(`div`, {
            ...
            children: [a, (0, J.jsx)(Se, { onManageConnections: n })],
          }),
        })),
        (t[3] = n),
        (t[4] = o)),
...
function pt(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, J.jsx)(ht, {
        icon: (0, J.jsx)(ae, { "aria-hidden": !0, className: `size-5` }),
        title: (0, J.jsx)(m, {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, J.jsx)(ht, {
        icon: (0, J.jsx)(O, { "aria-hidden": !0, className: `size-5` }),
        title: (0, J.jsx)(m, {
  ...
  return (
    t[5] === i
      ? (c = t[6])
      : ((c = (0, J.jsxs)(`div`, { className: i, children: [a, o, s] })), (t[5] = i), (t[6] = c)),
    c
  );
}
function mt(e, t) {
...
function _t(e) {
  return (0, J.jsx)(`span`, { className: `font-semibold text-token-text-primary`, children: e });
}
function vt(e) {
  return (0, J.jsx)(`span`, { className: `font-semibold text-token-text-primary`, children: e });
}
...
function xt(e) {
  ...
  if (d === `dialog`) {
    ...
    t[12] !== f || t[13] !== u
      ...
      : (e = t[14]);
    let n;
    t[15] === e ? (n = t[16]) : ((n = (0, J.jsx)(xe, { artworkSrc: e })), (t[15] = e), (t[16] = n));
    let r;
    return (
      t[17] !== h || t[18] !== n
        ? ((r = (0, J.jsxs)(`div`, {
  ...
  return (
    t[24] !== h || t[25] !== g || t[26] !== _
      ? ((v = (0, J.jsx)(be, { artworkAlignment: g, artworkSrc: _, children: h })),
        (t[24] = h),
        (t[25] = g),
        (t[26] = _),
        (t[27] = v))
...
function St(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, J.jsx)(be, { children: (0, J.jsx)(ft, { onManageConnections: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function Ct(e) {
  ...
  switch (f) {
    case `allow-host`: {
      ...
      return (
        t[0] !== r || t[1] !== u || t[2] !== p
          ? ((e = (0, J.jsx)(ut, { onAllowHost: r, setupInProgress: u, variant: p })),
            (t[0] = r),
            (t[1] = u),
            (t[2] = p),
            (t[3] = e))
    ...
    case `connected`: {
      ...
      return (
        t[4] !== o || t[5] !== s || t[6] !== p
          ? ((e = (0, J.jsx)(ke, { onFinishSetup: o, onManageConnections: s, variant: p })),
            (t[4] = o),
            (t[5] = s),
            (t[6] = p),
            (t[7] = e))
...
function Dt(e) {
  let t = (0, Z.c)(28),
    ...
    g;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = { "aria-describedby": void 0 }), (t[0] = g))
    : (g = t[0]);
  let _;
  t[1] !== d || t[2] !== m || t[3] !== l
    ? ((_ =
  ...
  t[5] === _
    ? (v = t[6])
    : ((v = (0, J.jsx)(F, { className: `sr-only`, children: _ })), (t[5] = _), (t[6] = v));
  let y;
  t[7] !== u || t[8] !== l
    ? ((y = () => {
        (C(u, {
          ...
          S.dispatchMessage(`open-in-browser`, { url: `https://chatgpt.com/#settings/Security` }));
      }),
      (t[7] = u),
      (t[8] = l),
      (t[9] = y))
...
export { X as a, pt as i, St as n, U as o, xt as r, Dt as t };
