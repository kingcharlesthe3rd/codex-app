...
import { c as d, f, g as p, n as m, u as h } from "./vscode-api.js";
import { t as g } from "./queryOptions.js";
import { C as _, Cr as v, Vi as y, ar as b, ji as x, or as S } from "./src-4.js";
import { An as C, As as w, kn as T, us as E } from "./app-server-manager-signals.js";
import { c as ee, o as D } from "./lib-1.js";
import { o as O, qn as k } from "./persisted-signal.js";
...
import { f as I, o as re } from "./statsig-DoZ-0xit.js";
import { t as L } from "./request.js";
import { t as R } from "./use-is-dark.js";
import { t as z } from "./chats.js";
import { t as B } from "./use-platform.js";
import { i as ie } from "./use-is-plugins-enabled.js";
import { m as ae, y as V } from "./use-plugins.js";
import { n as oe, p as H, t as U } from "./use-plugin-install-flow.js";
import { t as W } from "./chrome.js";
import { d as G, l as se } from "./dialog-layout.js";
import { l as ce } from "./bundled-plugin-auto-install-preference.js";
import { t as le } from "./data-url-from-svg.js";
import { m as ue } from "./links.js";
import { t as de } from "./check-circle.js";
import { n as fe, r as pe, t as me } from "./local-remote-control-enabled-sync.js";
import { s as K } from "./check-plugin-availability.js";
import { t as q } from "./toggle.js";
import { t as J } from "./regenerate.js";
import { o as he, r as ge } from "./computer-use-app-approvals-query.js";
import { r as _e } from "./plugins-availability.js";
import { t as Y } from "./sun.js";
import { t as ve } from "./chatgpt-token-auth.browser.js";
import { t as ye } from "./use-home-directory.js";
import { t as be } from "./cursor.js";
import { t as xe } from "./segmented-toggle.js";
var Se = j(`electron:codex-mobile-setup-step-debug-override`, `auto`),
  Ce = 100,
  we = y({ mfa_enabled_v2: x() }),
  Te = class extends Error {},
  Ee = class extends Error {},
  De = class extends Error {};
async function Oe({ clientId: e }) {
  await Fe(() =>
    L.safeDelete(`/wham/remote/control/clients/{client_id}`, {
      parameters: { path: { client_id: e } },
    }),
  );
}
async function ke() {
  return (await Fe(() => L.safeGet(`/wham/remote/control/mfa_requirement`))).requirement;
}
async function Ae() {
  return we.parse(await L.safeGet(`/accounts/mfa_info`)).mfa_enabled_v2;
}
async function je(e = null) {
  let t = await Fe(() =>
    L.safeGet(`/wham/remote/control/clients`, { parameters: { query: { cursor: e, limit: Ce } } }),
  );
  return t.items.some(Pe) ? !0 : t.cursor == null ? !1 : je(t.cursor);
}
async function Me() {
  return Ne(null);
}
async function Ne(e) {
  let t = await Fe(() =>
      L.safeGet(`/wham/remote/control/clients`, {
        parameters: { query: { cursor: e, limit: Ce } },
      }),
    ),
    n = t.items.filter(Pe);
  return t.cursor == null ? n : n.concat(await Ne(t.cursor));
}
function Pe(e) {
    ...
    throw e instanceof d
      ? e.status === 404
        ...
        : e.status === 403
          ? new De(e.message)
          : e.status === 401
            ? (ve(), new Te(`ChatGPT auth is required to load remote control environments.`))
            : Error(`Remote control request failed (${e.status}): ${e.message}`)
      : e;
  }
}
var Ie = `` + new URL(`dialog-artwork-connected-NZKCls7p.png`, import.meta.url).href,
  Le = `` + new URL(`dialog-artwork-initial-DMDAvEM7.png`, import.meta.url).href,
  Re = `` + new URL(`dialog-artwork-mfa-e9Fx75-r.png`, import.meta.url).href,
  ze = `` + new URL(`dialog-artwork-waiting-computer-BPIs9eKV.png`, import.meta.url).href,
  Be = `` + new URL(`dialog-artwork-waiting-phone-UTYmfLHs.png`, import.meta.url).href,
  Ve = `` + new URL(`page-artwork-connected-BUPhttJ1.png`, import.meta.url).href,
  He = `` + new URL(`page-artwork-mfa-e6UxOdqq.png`, import.meta.url).href,
  Ue = `` + new URL(`page-artwork-ready-bfkkMY-P.png`, import.meta.url).href,
  We = `` + new URL(`page-artwork-waiting-pzj85BPm.png`, import.meta.url).href,
  X = e(n()),
  Z = r(),
  Ge = (e) =>
    (0, Z.jsxs)(`svg`, {
...
function rt() {
  let e = (0, Q.c)(55),
    ...
    i = re(`410065390`),
    o;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = { hostId: E }), (e[0] = o)) : (o = e[0]);
  let c = ie(o).available,
    d = te(_.keepRemoteControlAwakeWhilePluggedIn),
    f = a(H, E),
    m = l(ge),
    h;
  e[1] === t.query ? (h = e[2]) : ((h = t.query.snapshot(ge)), (e[1] = t.query), (e[2] = h));
  let g = h,
    v;
  ...
  e[4] !== r || e[5] !== y.availablePlugins
    ? ((b = at(y.availablePlugins, $e, r)), (e[4] = r), (e[5] = y.availablePlugins), (e[6] = b))
    : (b = e[6]);
  let x = b,
    S = x?.plugin.installed === !0 && x.plugin.enabled,
    C;
  e[7] !== r || e[8] !== y.availablePlugins
    ? ((C = it(y.availablePlugins, r)), (e[7] = r), (e[8] = y.availablePlugins), (e[9] = C))
    : (C = e[9]);
  let w = C,
    T;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = { hostId: E }), (e[10] = T))
    : (T = e[10]);
  let { pendingPluginId: ee, setPluginEnabled: D } = _e(T),
    O;
  e[11] === y.forceReload
    ? (O = e[12])
    : ((O = { forceReloadPlugins: y.forceReload, hostId: E }),
      (e[11] = y.forceReload),
      (e[12] = O));
  let {
  ...
  e[13] === g
    ...
    : ((L = {
      ...
      (e[14] = L));
  let R = p(L),
    z = n === `macOS` && S && f && m.data?.enabled != null,
    V;
  e[15] !== x || e[16] !== m.data?.enabled || e[17] !== F || e[18] !== D || e[19] !== R
    ? ((V = (e) => {
        if (x != null) {
          ...
          if (!e && m.data?.enabled) {
            R.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && D({ enabled: !1, pluginDisplayName: ce(x), pluginId: x.plugin.id });
              },
            });
            return;
          }
          D({ enabled: e, pluginDisplayName: ce(x), pluginId: x.plugin.id });
        }
      }),
      (e[15] = x),
      (e[16] = m.data?.enabled),
  ...
  e[21] !== w || e[22] !== F || e[23] !== D
    ? ((G = (e) => {
        if (w != null) {
          ...
          D({ enabled: e, pluginDisplayName: ce(w), pluginId: w.plugin.id });
        }
      }),
      (e[21] = w),
      (e[22] = F),
    ...
    : (G = e[24]);
  let se = G,
    le = w?.plugin.installed === !0 && w.plugin.enabled,
    ue = y.isLoading || w == null || P || ee === w.plugin.id,
    de = y.isLoading || x == null || P || R.isPending || ee === x.plugin.id,
    fe = d ?? !1,
    pe = m.data?.enabled ?? !1,
    me = !S || m.isLoading || R.isPending,
    K;
  e[25] === t
    ? (K = e[26])
    : ((K = (e) => {
        ne(t, _.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = K));
  let q;
  ...
  return (
    ...
    e[53] !== Y
      ? ((ve = {
          chromeExtensionEnabled: le,
          chromeExtensionToggleDisabled: ue,
          computerUseEnabled: S,
          computerUseToggleDisabled: de,
          keepComputerAwake: fe,
          keepComputerAwakeToggleDisabled: !1,
          lockedComputerUseEnabled: pe,
          lockedComputerUseToggleDisabled: me,
          onChromeExtensionEnabledChange: se,
          onComputerUseEnabledChange: W,
...
function it(e, t) {
  return v.isInternal(V()) ? (at(e, nt, t) ?? at(e, tt, t) ?? at(e, et, t)) : at(e, et, t);
}
function at(e, t, n) {
  ...
  return (
    ...
    r.find((e) => K(n, e.marketplacePath)) ??
    null
  );
}
function ot(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, Z.jsx)(de, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    ? ((p = s.showKeepComputerAwake
        ? (0, Z.jsx)(ct, {
            icon: s.keepComputerAwake
              ? (0, Z.jsx)(Y, { className: `icon-base` })
              : (0, Z.jsx)(qe, { className: `icon-base` }),
            variant: i,
            title:
              o === `windows`
                ? (0, Z.jsx)(D, {
  ...
  t[24] !== i
    ? ((m =
        s.showComputerUseSetup && s.showLockedComputerUse
          ? (0, Z.jsx)(ct, {
              icon: (0, Z.jsx)(Ge, { className: `icon-base` }),
              variant: i,
              title: (0, Z.jsx)(D, {
          ...
          : s.showComputerUseSetup
            ? (0, Z.jsx)(ct, {
                icon: (0, Z.jsx)(Ke, { className: `icon-base` }),
                variant: i,
                title: (0, Z.jsx)(D, {
  ...
  t[31] !== i
    ? ((h = s.showChromeExtensionSetup
        ? (0, Z.jsx)(ct, {
            icon: (0, Z.jsx)(W, { className: `icon-base` }),
            variant: i,
            title: (0, Z.jsx)(D, {
  ...
  t[44] !== r || t[45] !== i
    ? ((x =
        i === `page` && r != null
          ? (0, Z.jsx)(Qe, { className: `w-[256px]`, onManageConnections: r })
          : null),
      (t[44] = r),
      (t[45] = i),
      (t[46] = x))
...
function ct(e) {
  ...
  if (i != null) {
    ...
    t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== o
      ? ((l = (0, Z.jsx)(lt, { description: n, icon: r, title: a, trailing: o })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o),
  ...
  t[13] !== n || t[14] !== r || t[15] !== a || t[16] !== o
    ? ((u = (0, Z.jsx)(lt, { description: n, icon: r, title: a, trailing: o })),
      (t[13] = n),
      (t[14] = r),
      (t[15] = a),
      (t[16] = o),
...
var dt = 3e4,
  ft = 5e3,
  pt = 6e4,
  mt = [`codex-mobile-mfa-setup-required`],
  ht = `2055603567`,
  gt = [`remote-control-server-pairing`],
  _t = [`remote-control-pairing-enablement`],
  vt = c(u, () => ({
...
var xt = c(u, ({ get: e }) => ({
  ...
  St = o(u, (e, { get: t, scope: n }) => ({
    enabled: t(C, e)?.status === `disabled`,
    queryKey: [..._t, e],
    queryFn: () => ut(n, e, !0),
    gcTime: 0,
    retry: !1,
  ...
  Ct = o(
    ...
    ({ hostId: e, openId: t }, { get: n, scope: r }) => ({
      enabled: n(I, `2055603567`) && n(T, e),
      queryKey: [...gt, e, t],
      queryFn: async () => (
        await Tt(r, e),
        w(`start-remote-control-pairing-for-host`, { hostId: e, manualCode: !0 })
      ),
      retry: !1,
      gcTime: 0,
      staleTime: (e) => {
        let t = e.state.data?.expiresAt;
        return t == null ? 0 : Math.max(0, wt(t) - e.state.dataUpdatedAt);
      },
      refetchInterval: (e) => {
        let t = e.state.data?.expiresAt;
        return t == null || e.state.fetchStatus === `fetching` || e.state.error != null
          ? !1
          : Math.max(1, wt(t) - Date.now() - pt);
      },
    }),
  ...
  return Et(e.get(C, t))
    ...
    : new Promise((n, r) => {
        let i = !1,
          ...
          o = null,
          s = (e) => {
            i || ((i = !0), o != null && clearTimeout(o), a?.(), e());
          };
        ((o = setTimeout(() => {
          s(() => {
            r(Error(`Timed out waiting for remote control to connect`));
          });
        }, ft)),
          (a = e.watch((e) => {
            Et(e.get(C, t)) && s(n);
...
var ln = 760,
  ...
  fn = `180ms`;
function pn(e, t, n) {
  ((e.style.transitionDuration = n ? `0ms` : fn),
    (e.style.fill = cn(t)),
...
function hn({ onArtworkReady: e, svgMarkup: t }) {
  let n = N(),
    r = (0, X.useRef)(null),
    i = (0, X.useRef)(null),
    a = (0, X.useRef)([]),
    ...
    u = (0, X.useCallback)((e) => {
      ...
      for (let r of a.current) {
        let i = (o.current.get(r.node) ?? 0) * dn;
        ...
        pn(r.node, Math.max(o.current.get(r.node) ?? 0, a), a > 0);
      }
    ...
    paintDots: (0, X.useCallback)(
      (e) => {
        ...
        let s = r.matrixTransform(t.getScreenCTM()?.inverse()),
          c = !1;
        for (let e of a.current) {
          let t = sn(Math.hypot(e.x - s.x, e.y - s.y)),
            n = o.current.get(e.node) ?? 0,
            r = Math.max(n, t);
          r > n && (o.current.set(e.node, r), mn(e.node, r), (c = !0));
        }
        c && d();
      },
      [d, n],
...
function gn(e) {
  ...
  t[0] !== i || t[1] !== n
    ...
    : (a = t[2]);
  let { paintDots: o, rootRef: s, svgMarkup: c, triggerRipple: l } = hn(a),
    u,
    d;
  (t[3] === l
    ? ((u = t[4]), (d = t[5]))
...
var _n = `` + new URL(`codex-home-hero-dark-still-43PvFxTG.png`, import.meta.url).href,
  vn = `` + new URL(`codex-home-hero-dark-_BGDEdk8.mp4`, import.meta.url).href,
  yn = `` + new URL(`codex-home-hero-light-still-CQ7cy4qg.png`, import.meta.url).href,
  bn = `` + new URL(`codex-home-hero-light-Cyip34F2.mp4`, import.meta.url).href,
  xn = `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
  Sn = { dark: { stillSrc: _n, videoSrc: vn }, light: { stillSrc: yn, videoSrc: bn } },
  Cn = `url(${le(xn)})`,
  wn = {
    maskImage: Cn,
    maskMode: `alpha`,
...
function Tn(e) {
  ...
  t[1] !== a || t[2] !== u || t[3] !== c
    ? ((h = () => {
        if (a || c === u) return;
        let e = o.current;
        e != null && e.paused && ((e.currentTime = 0), e.play()?.catch(En));
      }),
      (t[1] = a),
      (t[2] = u),
      (t[3] = c),
...
function Ln(e) {
  ...
  if (i != null) {
    ...
    return (
      t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== s
        ? ((e = (0, Z.jsx)(Rn, { ariaLabel: n, centerLogoAriaLabel: r, pairingCode: i, size: s })),
          (t[0] = n),
          (t[1] = r),
          (t[2] = i),
          (t[3] = s),
  ...
  return (
    t[5] !== n || t[6] !== r || t[7] !== a || t[8] !== s
      ? ((c = (0, Z.jsx)(zn, { ariaLabel: n, centerLogoAriaLabel: r, platform: a, size: s })),
        (t[5] = n),
        (t[6] = r),
        (t[7] = a),
        (t[8] = s),
...
function zn(e) {
  ...
  if (i === `android`) {
    ...
    return (
      t[0] !== n || t[1] !== o
        ? ((e = (0, Z.jsx)(Bn, { ariaLabel: n, size: o })), (t[0] = n), (t[1] = o), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== o
      ? ((s = (0, Z.jsx)(Vn, { ariaLabel: n, centerLogoAriaLabel: r, size: o })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s))
...
function Bn(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(`div`, {
        ...
        dangerouslySetInnerHTML: { __html: nn },
      })),
      (t[2] = o))
    : (o = t[2]);
  let s;
...
function Hn(e) {
  ...
  t[5] === a
    ? (p = t[6])
    : ((p = (0, Z.jsx)(gn, { ref: s, onArtworkReady: l, svgMarkup: a })), (t[5] = a), (t[6] = p));
  ...
  t[9] !== r || t[10] !== h
    ? ((g = (0, Z.jsx)(`div`, {
        ...
        children: (0, Z.jsx)(Tn, { ariaLabel: r, className: h, onClick: l }),
      })),
      (t[9] = r),
      (t[10] = h),
      (t[11] = g))
...
function Un(e) {
  let t = (0, An.create)(e, { errorCorrectionLevel: `H` }).modules,
    n = jn / (t.size + Fn * 2);
  return { cornersMarkup: Gn(t.size, n), dotsMarkup: Wn(t, n) };
}
function Wn(e, t) {
  let n = [];
  for (let r = 0; r < e.size; r += 1)
    for (let i = 0; i < e.size; i += 1)
      !$n(e, r, i) || er(e.size, r, i) || Qn(e.size, t, r, i) || n.push(qn(i, t, r));
  return Yn(n.join(``));
}
function Gn(e, t) {
  return Yn([Kn(0, 0, t), Kn(e - Pn, 0, t), Kn(0, e - Pn, t)].join(``));
}
function Kn(e, t, n) {
  let r = Zn(e, n),
    i = Zn(t, n),
    ...
    o = n,
    s = n * 2;
  return `<path fill-rule="evenodd" clip-rule="evenodd" d="${Jn(r, i, a, n * 1.6)} ${Jn(r + o, i + o, a - o * 2, n)}" fill="currentColor"/><rect x="${$(r + s)}" y="${$(i + s)}" width="${$(a - s * 2)}" height="${$(a - s * 2)}" rx="${$(n)}" fill="currentColor"/>`;
}
function qn(e, t, n) {
  let r = t * Nn,
    i = Xn(e, t),
...
function Yn(e) {
  return `<svg width="${jn}" height="${jn}" viewBox="0 0 ${jn} ${jn}" fill="none" xmlns="${In}">${e}</svg>`;
}
function Xn(e, t) {
  return Zn(e, t) + t / 2;
}
...
function er(e, t, n) {
  return tr(t, n, 0, 0) || tr(t, n, 0, e - Pn) || tr(t, n, e - Pn, 0);
}
function tr(e, t, n, r) {
  return e >= n && e < n + Pn && t >= r && t < r + Pn;
}
function nr(e) {
  return e % 2 == 0 ? e + 1 : e;
}
...
function rr(e) {
  let t = (0, Q.c)(64),
    ...
    [h, g] = (0, X.useState)(`phone`),
    _ = l ? (n ?? h) : `phone`,
    [v] = (0, X.useState)(ir),
    y = a(St, c),
    b;
  t[0] !== c || t[1] !== v
    ? ((b = { hostId: c, openId: v }), (t[0] = c), (t[1] = v), (t[2] = b))
    : (b = t[2]);
  let x = a(Ct, b),
    S = y.error ?? x.error,
    C = f && S == null ? (x.data ?? null) : null,
    w = f && C == null && (S == null || y.isFetching || x.isFetching),
    T = !f || C?.pairingCode != null,
    O = _ === `phone` && !f,
    k = f && _ === `computer` && !w,
    j;
  t[3] !== n || t[4] !== i
  ...
  if (w) {
    ...
    t[8] === d
      ...
      : ((e = d.formatMessage({
        ...
        (t[9] = e));
    let n;
    (t[10] === e ? (n = t[11]) : ((n = (0, Z.jsx)(or, { ariaLabel: e })), (t[10] = e), (t[11] = n)),
      (P = n));
  } else if (_ === `phone` && T) {
    let e;
    t[12] === d
    ...
    let r = C?.pairingCode,
      i;
    (t[16] !== p || t[17] !== u || t[18] !== e || t[19] !== n || t[20] !== r
      ? ((i = (0, Z.jsx)(Ln, {
          ariaLabel: e,
    ...
    let e;
    (t[22] === S ? (e = t[23]) : ((e = (0, Z.jsx)(mr, { error: S })), (t[22] = S), (t[23] = e)),
      (P = e));
  } else if (f) {
    let e = C?.manualPairingCode ?? null,
      n;
    (t[24] !== S || t[25] !== u || t[26] !== e
      ? ((n = (0, Z.jsx)(sr, { error: S, manualPairingCode: e, size: u })),
        (t[24] = S),
        (t[25] = u),
        (t[26] = e),
        (t[27] = n))
  ...
  let I = u === `compact` ? null : `mt-3`,
    L;
  t[29] === I
    ? (L = t[30])
    : ((L = A(`flex w-full flex-col items-center gap-4`, I)), (t[29] = I), (t[30] = L));
  let R;
  t[31] !== d || t[32] !== te || t[33] !== _ || t[34] !== l
    ? ((R = l
        ? (0, Z.jsx)(`div`, {
      ...
      (t[35] = R))
    : (R = t[35]);
  let z = u === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    B = O ? null : `justify-center`,
    ie =
      _ === `computer`
        ? u === `compact`
  ...
  t[47] !== y || t[48] !== f || t[49] !== x || t[50] !== N
    ? ((H = f
        ? (0, Z.jsx)(F, {
            ...
            children: (0, Z.jsx)(M, {
              ...
              color: `ghost`,
              disabled: y.isFetching || x.isFetching,
              onClick: () => {
                y.isError ? y.refetch() : x.refetch();
              },
              size: `icon`,
              children: (0, Z.jsx)(J, {
                className: A(`icon-xs`, y.isFetching || x.isFetching ? `animate-spin` : null),
              }),
            }),
          })
        : null),
    ...
    : (H = t[51]);
  let U;
  t[52] !== ae || t[53] !== V || t[54] !== oe || t[55] !== H
    ? ((U = (0, Z.jsxs)(`div`, { className: ae, children: [V, oe, H] })),
      (t[52] = ae),
      (t[53] = V),
      (t[54] = oe),
      (t[55] = H),
    ...
    : (U = t[56]);
  let W;
  t[57] === k ? (W = t[58]) : ((W = k ? (0, Z.jsx)(pr, {}) : null), (t[57] = k), (t[58] = W));
  let G;
  return (
    t[59] !== U || t[60] !== W || t[61] !== L || t[62] !== R
      ? ((G = (0, Z.jsxs)(`div`, { className: L, children: [R, U, W] })),
        (t[59] = U),
        (t[60] = W),
        (t[61] = L),
        (t[62] = R),
...
function or(e) {
  let t = (0, Q.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(P, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function hr(e) {
  let t = (0, Q.c)(34),
    ...
    { platform: s } = B(),
    c;
  t[0] !== s || t[1] !== o ? ((c = yr(o, s)), (t[0] = s), (t[1] = o), (t[2] = c)) : (c = t[2]);
  let l = c,
    u;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[3]);
  let d;
  t[4] === o ? (d = t[5]) : ((d = (0, Z.jsx)(vr, { variant: o })), (t[4] = o), (t[5] = d));
  ...
  return (
    t[27] !== l || t[28] !== y || t[29] !== b || t[30] !== x || t[31] !== d || t[32] !== o
      ? ((S = (0, Z.jsxs)(Je, { variant: o, heading: l, description: u, children: [d, y, b, x] })),
        (t[27] = l),
        (t[28] = y),
        (t[29] = b),
        (t[30] = x),
...
function gr(e) {
  ...
  return (
    t[5] !== s || t[6] !== r
      ? ((c = (0, Z.jsx)(Je, { variant: r, heading: i, description: a, children: s })),
        (t[5] = s),
        (t[6] = r),
        (t[7] = c))
      : (c = t[7]),
...
function _r(e) {
  ...
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(rr, { showDeviceTypeSelector: !1 })), (t[2] = a))
    : (a = t[2]);
  let o;
  return (
    t[3] === n
      ...
      : ((o = (0, Z.jsx)(Je, {
          ...
          children: (0, Z.jsxs)(`div`, {
            ...
            children: [a, (0, Z.jsx)(Qe, { onManageConnections: n })],
          }),
        })),
        (t[3] = n),
        (t[4] = o)),
...
function vr(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(br, {
        icon: (0, Z.jsx)(pe, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(D, {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(br, {
        icon: (0, Z.jsx)(z, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(D, {
...
function xr(e) {
  ...
  if (o === `page`) {
    ...
    t[4] === s
      ...
      : ((n = (0, Z.jsx)(`div`, {
          className: `flex w-full max-w-[460px] flex-col items-center gap-6`,
          children: (0, Z.jsx)(rr, { hostId: s, showDeviceTypeSelector: !1 }),
        })),
        (t[4] = s),
        (t[5] = n));
    let r;
    return (
      t[6] !== u || t[7] !== n
        ? ((r = (0, Z.jsx)(Je, { variant: `page`, heading: u, description: e, children: n })),
          (t[6] = u),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  return (
    t[13] !== u || t[14] !== d
      ? ((f = (0, Z.jsx)(Je, { variant: `dialog`, heading: u, children: d })),
        (t[13] = u),
        (t[14] = d),
        (t[15] = f))
      : (f = t[15]),
...
function Sr(e) {
  ...
  t[11] !== f
    ? ((h = (0, Z.jsx)(wr, {
        approvalDeviceMode: p,
        hostId: n,
        onApprovalDeviceModeChange: m,
        onContinueOnChatGPT: r,
        onFinishSetup: i,
        onManageConnections: a,
        onSkip: o,
  ...
  if (d === `dialog`) {
    let e;
    t[13] !== p || t[14] !== u
      ? ((e = Tr(u, p)), (t[13] = p), (t[14] = u), (t[15] = e))
      : (e = t[15]);
    let n;
    t[16] === e ? (n = t[17]) : ((n = (0, Z.jsx)(Ze, { artworkSrc: e })), (t[16] = e), (t[17] = n));
    let r;
    return (
      t[18] !== g || t[19] !== n
        ? ((r = (0, Z.jsxs)(`div`, {
  ...
  let _;
  t[21] === u ? (_ = t[22]) : ((_ = Dr(u)), (t[21] = u), (t[22] = _));
  let v;
  t[23] === u ? (v = t[24]) : ((v = Er(u)), (t[23] = u), (t[24] = v));
  let y;
  return (
    t[25] !== g || t[26] !== _ || t[27] !== v
      ? ((y = (0, Z.jsx)(Xe, { artworkAlignment: _, artworkSrc: v, children: g })),
        (t[25] = g),
        (t[26] = _),
        (t[27] = v),
        (t[28] = y))
...
function Cr(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Z.jsx)(Xe, { children: (0, Z.jsx)(_r, { onManageConnections: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function wr(e) {
  ...
  switch (f) {
    case `connected`: {
      ...
      return (
        t[0] !== o || t[1] !== s || t[2] !== p
          ? ((e = (0, Z.jsx)(ot, { onFinishSetup: o, onManageConnections: s, variant: p })),
            (t[0] = o),
            (t[1] = s),
            (t[2] = p),
            (t[3] = e))
    ...
    case `mfa-required`: {
      ...
      return (
        t[10] !== a || t[11] !== p
          ? ((e = (0, Z.jsx)(gr, { onContinueOnChatGPT: a, variant: p })),
            (t[10] = a),
            (t[11] = p),
            (t[12] = e))
          : (e = t[12]),
    ...
    case `waiting`: {
      let e;
      return (
        t[13] !== n || t[14] !== r || t[15] !== i || t[16] !== p || t[17] !== m
          ? ((e = (0, Z.jsx)(xr, {
              approvalDeviceMode: n,
              heading: m,
              hostId: r,
...
function Or(e) {
  ...
  t[5] === v
    ? (y = t[6])
    : ((y = (0, Z.jsx)(G, { className: `sr-only`, children: v })), (t[5] = v), (t[6] = y));
  let b;
  t[7] !== m || t[8] !== d
    ? ((b = () => {
        (O(m, k, { action: `continue_on_chatgpt`, step: d, surface: `dialog` }),
    ...
    : (b = t[9]);
  let x;
  t[10] !== r || t[11] !== m || t[12] !== d
    ? ((x = () => {
        (O(m, k, { action: `finish_setup`, step: d, surface: `dialog` }), r(!1));
      }),
      (t[10] = r),
      (t[11] = m),
      (t[12] = d),
