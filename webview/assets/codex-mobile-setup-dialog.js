...
import { Z as i, a, o, s, t as c } from "./app-scope-CWE-zIhQ.js";
import { r as l } from "./use-host-config-C.js";
import { _ as u, f as d } from "./vscode-api.js";
import { Hr as f, vr as p, w as m, yr as h } from "./src-1.js";
import { l as g, s as _ } from "./lib-1.js";
import { t as v } from "./clsx.js";
import { t as y } from "./persisted-atom.js";
import { t as b } from "./button.js";
import { a as x, i as S } from "./setting-storage.js";
import { t as C } from "./use-reduced-motion-1.js";
import { t as w } from "./spinner.js";
import { t as T } from "./tooltip-B.js";
import { t as E } from "./regenerate.js";
import { o as D } from "./statsig.js";
import { ir as O, t as k } from "./product-logger.js";
import { t as A } from "./use-platform.js";
import { i as j } from "./use-is-plugins-enabled-B.js";
import { m as ee, y as M } from "./use-plugins.js";
import { t as N } from "./use-is-dark.js";
import { t as te } from "./chats.js";
import { t as ne } from "./chrome.js";
import { t as re } from "./copy-to-clipboard.js";
import { d as ie, l as ae } from "./dialog-layout.js";
import { l as P, r as oe } from "./plugins-availability.js";
import { s as se } from "./check-plugin-availability-C.js";
import { t as F } from "./data-url-from-svg.js";
import { t as ce } from "./expand.js";
import { h as I } from "./links.js";
import { t as L } from "./check-circle.js";
import { c as R, n as le, p as z, t as ue } from "./codex-mobile-setup-queries.js";
import { h as de, n as fe, t as pe } from "./use-plugin-install-flow.js";
import { t as me } from "./copy-button.js";
import { t as B } from "./toggle.js";
import { o as he, r as ge } from "./computer-use-app-approvals-query.js";
import { t as _e } from "./sun.js";
import { t as ve } from "./segmented-toggle-BJ-T19lF.js";
import { t as V } from "./use-home-directory.js";
import { t as ye } from "./cursor-CY-4WWCc.js";
var H = y(`electron:codex-mobile-setup-step-debug-override`, `auto`),
  U = `` + new URL(`dialog-artwork-allow-host-B0bcIhDi.png`, import.meta.url).href,
  be = `` + new URL(`dialog-artwork-connected-NZKCls7p.png`, import.meta.url).href,
  W = `` + new URL(`dialog-artwork-initial-DMDAvEM7.png`, import.meta.url).href,
  G = `` + new URL(`dialog-artwork-mfa-e9Fx75-r.png`, import.meta.url).href,
  K = `` + new URL(`dialog-artwork-waiting-computer-BPIs9eKV.png`, import.meta.url).href,
  q = `` + new URL(`dialog-artwork-waiting-phone-UTYmfLHs.png`, import.meta.url).href,
  J = `` + new URL(`page-artwork-allow-host-CPm7eJR2.png`, import.meta.url).href,
  xe = `` + new URL(`page-artwork-mfa-e6UxOdqq.png`, import.meta.url).href,
  Se = `` + new URL(`page-artwork-waiting-pzj85BPm.png`, import.meta.url).href,
  Ce = `` + new URL(`page-artwork-shared-Dv_GQL_j.png`, import.meta.url).href,
  Y = e(n()),
  X = r(),
  we = (e) =>
    (0, X.jsxs)(`svg`, {
...
function De(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = v(`flex w-full flex-col gap-2 text-center`, s)), (t[0] = s), (t[1] = c));
  let l =
      o === `dialog`
    ...
    u;
  t[2] !== a || t[3] !== l
    ? ((u = (0, X.jsx)(`div`, { className: l, children: a })), (t[2] = a), (t[3] = l), (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] !== r || t[6] !== o
    ? ((d =
  ...
  let f;
  t[8] !== c || t[9] !== u || t[10] !== d
    ? ((f = (0, X.jsxs)(`div`, { className: c, children: [u, d] })),
      (t[8] = c),
      (t[9] = u),
      (t[10] = d),
      (t[11] = f))
  ...
  let p;
  t[12] !== i || t[13] !== f
    ? ((p = (0, X.jsxs)(X.Fragment, { children: [i, f] })), (t[12] = i), (t[13] = f), (t[14] = p))
    : (p = t[14]);
  let m = p;
  if (o === `dialog`) {
    let e;
...
var Oe = `` + new URL(`page-artwork-background-DPNBzfAy.png`, import.meta.url).href;
function ke(e) {
  let t = (0, Z.c)(13),
...
function je(e) {
  let t = (0, Z.c)(6),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = v(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function Ie() {
  let e = (0, Z.c)(55),
    ...
    i = D(`410065390`),
    d;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((d = { hostId: l }), (e[0] = d)) : (d = e[0]);
  let f = j(d).available,
    p = x(m.keepRemoteControlAwakeWhilePluggedIn),
    h = a(de, l),
    g = s(ge),
    _;
  e[1] === t.query ? (_ = e[2]) : ((_ = t.query.snapshot(ge)), (e[1] = t.query), (e[2] = _));
  let v = _,
    y;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((y = []), (e[3] = y)) : (y = e[3]);
  let b = ee(l, y),
    C;
  e[4] !== r || e[5] !== b.availablePlugins
    ? ((C = Re(b.availablePlugins, Me, r)), (e[4] = r), (e[5] = b.availablePlugins), (e[6] = C))
    : (C = e[6]);
  let w = C,
    T = w?.plugin.installed === !0 && w.plugin.enabled,
    E;
  e[7] !== r || e[8] !== b.availablePlugins
    ? ((E = Le(b.availablePlugins, r)), (e[7] = r), (e[8] = b.availablePlugins), (e[9] = E))
    : (E = e[9]);
  let O = E,
    k;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = { hostId: l }), (e[10] = k))
    : (k = e[10]);
  let { pendingPluginId: M, setPluginEnabled: N } = oe(k),
    te;
  e[11] === b.forceReload
    ? (te = e[12])
    : ((te = { forceReloadPlugins: b.forceReload, hostId: l }),
      (e[11] = b.forceReload),
      (e[12] = te));
  let {
      closePluginInstall: ne,
      connectRequiredApp: re,
      handleRequiredAppConnected: ie,
      handleRequiredAppOAuthStarted: ae,
      installPlugin: se,
      isInstalling: F,
  ...
  e[13] === v
    ...
    : ((L = {
      ...
      (e[14] = L));
  let R = u(L),
    le = n === `macOS` && T && h && g.data?.enabled != null,
    z;
  e[15] !== w || e[16] !== g.data?.enabled || e[17] !== ce || e[18] !== N || e[19] !== R
    ? ((z = (e) => {
        if (w != null) {
          ...
          if (!e && g.data?.enabled) {
            R.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && N({ enabled: !1, pluginDisplayName: P(w), pluginId: w.plugin.id });
              },
            });
            return;
          }
          N({ enabled: e, pluginDisplayName: P(w), pluginId: w.plugin.id });
        }
      }),
      (e[15] = w),
      (e[16] = g.data?.enabled),
  ...
  e[21] !== O || e[22] !== ce || e[23] !== N
    ? ((me = (e) => {
        if (O != null) {
          ...
          N({ enabled: e, pluginDisplayName: P(O), pluginId: O.plugin.id });
        }
      }),
      (e[21] = O),
      (e[22] = ce),
    ...
    : (me = e[24]);
  let B = me,
    _e = O?.plugin.installed === !0 && O.plugin.enabled,
    ve = b.isLoading || O == null || F || M === O.plugin.id,
    ye = b.isLoading || w == null || F || R.isPending || M === w.plugin.id,
    H = p ?? !1,
    U = g.data?.enabled ?? !1,
    be = !T || g.isLoading || R.isPending,
    W;
  e[25] === t
    ? (W = e[26])
    : ((W = (e) => {
        S(t, m.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = W));
  let G;
  ...
  e[37] !== K
    ? ((q = (0, X.jsx)(fe, {
        hostId: l,
        isInstalling: F,
        onConnectRequiredApp: re,
        onInstall: se,
        onRequiredAppConnected: ie,
        onRequiredAppOAuthStarted: ae,
        onOpenChange: K,
        session: I,
      })),
      (e[31] = re),
  ...
  return (
    ...
    e[53] !== q
      ? ((J = {
          chromeExtensionEnabled: _e,
          chromeExtensionToggleDisabled: ve,
          computerUseEnabled: T,
          computerUseToggleDisabled: ye,
          keepComputerAwake: H,
          keepComputerAwakeToggleDisabled: !1,
          lockedComputerUseEnabled: U,
          lockedComputerUseToggleDisabled: be,
          onChromeExtensionEnabledChange: B,
          onComputerUseEnabledChange: ue,
          onKeepComputerAwakeChange: W,
          onLockedComputerUseEnabledChange: G,
          pluginInstallModal: q,
          showChromeExtensionSetup: i,
          showComputerUseSetup: f,
          showKeepComputerAwake: !0,
          showLockedComputerUse: le,
        }),
        (e[39] = T),
        (e[40] = B),
        (e[41] = ue),
...
function Le(e, t) {
  return f.isInternal(M()) ? (Re(e, Fe, t) ?? Re(e, Pe, t) ?? Re(e, Ne, t)) : Re(e, Ne, t);
}
function Re(e, t, n) {
  ...
  return (
    ...
    r.find((e) => h(e.marketplaceName)) ??
    r.find((e) => e.marketplaceName === `openai-curated`) ??
    r.find((e) => se(n, e.marketplacePath)) ??
    null
  );
}
function ze(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, X.jsx)(L, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let d =
    ...
    f;
  t[4] === d ? (f = t[5]) : ((f = v(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = f));
  let p;
    ...
    ? ((p = s.showKeepComputerAwake
        ? (0, X.jsx)(Ve, {
            icon: s.keepComputerAwake
              ? (0, X.jsx)(_e, { className: `icon-base` })
              : (0, X.jsx)(Ee, { className: `icon-base` }),
            variant: i,
            title:
              o === `windows`
                ? (0, X.jsx)(_, {
  ...
  t[24] !== i
    ? ((m =
        s.showComputerUseSetup && s.showLockedComputerUse
          ? (0, X.jsx)(Ve, {
              icon: (0, X.jsx)(we, { className: `icon-base` }),
              variant: i,
              title: (0, X.jsx)(_, {
          ...
          : s.showComputerUseSetup
            ? (0, X.jsx)(Ve, {
                icon: (0, X.jsx)(Te, { className: `icon-base` }),
                variant: i,
                title: (0, X.jsx)(_, {
  ...
  t[31] !== i
    ? ((h = s.showChromeExtensionSetup
        ? (0, X.jsx)(Ve, {
            icon: (0, X.jsx)(ne, { className: `icon-base` }),
            variant: i,
            title: (0, X.jsx)(_, {
  ...
  t[33] !== f || t[34] !== p || t[35] !== m || t[36] !== h
    ? ((y = (0, X.jsxs)(`div`, { className: f, children: [p, m, h] })),
      (t[33] = f),
      (t[34] = p),
      (t[35] = m),
      (t[36] = h),
      (t[37] = y))
    : (y = t[37]);
  let x = i === `page` && `w-[256px]`,
    S;
  t[38] === x ? (S = t[39]) : ((S = v(`justify-center`, x)), (t[38] = x), (t[39] = S));
  let C;
  ...
  t[41] !== n || t[42] !== S
    ? ((w = (0, X.jsx)(`div`, {
        ...
        children: (0, X.jsx)(b, { size: `large`, className: S, onClick: n, children: C }),
      })),
      (t[41] = n),
      (t[42] = S),
      (t[43] = w))
  ...
  t[44] !== r || t[45] !== i
    ? ((T =
        i === `page` && r != null
          ? (0, X.jsx)(je, { className: `w-[256px]`, onManageConnections: r })
          : null),
      (t[44] = r),
      (t[45] = i),
      (t[46] = T))
  ...
  let O;
  return (
    t[55] !== s.pluginInstallModal || t[56] !== D
      ? ((O = (0, X.jsxs)(X.Fragment, { children: [D, s.pluginInstallModal] })),
...
function Ve(e) {
  ...
  if (i != null) {
    ...
    t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== o
      ? ((l = (0, X.jsx)(He, { description: n, icon: r, title: a, trailing: o })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o),
    ...
    return (
      t[7] !== i || t[8] !== c || t[9] !== l
        ? ((u = (0, X.jsx)(`button`, { type: `button`, className: c, onClick: i, children: l })),
          (t[7] = i),
          (t[8] = c),
          (t[9] = l),
          (t[10] = u))
  ...
  t[11] === c
    ? (l = t[12])
    : ((l = v(`flex items-center justify-between gap-4 px-[14px] py-2 text-left`, c)),
      (t[11] = c),
      (t[12] = l));
  let u;
  t[13] !== n || t[14] !== r || t[15] !== a || t[16] !== o
    ? ((u = (0, X.jsx)(He, { description: n, icon: r, title: a, trailing: o })),
      (t[13] = n),
      (t[14] = r),
      (t[15] = a),
      (t[16] = o),
  ...
  return (
    t[18] !== l || t[19] !== u
      ? ((d = (0, X.jsx)(`div`, { className: l, children: u })),
        (t[18] = l),
        (t[19] = u),
        (t[20] = d))
      : (d = t[20]),
...
function He(e) {
  ...
  t[2] === i
    ? (s = t[3])
    : ((s = (0, X.jsx)(`div`, { className: `text-sm text-token-text-primary`, children: i })),
      (t[2] = i),
      (t[3] = s));
  let c;
  t[4] === n
  ...
  let l;
  t[6] !== s || t[7] !== c
    ? ((l = (0, X.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [s, c] })),
      (t[6] = s),
      (t[7] = c),
      (t[8] = l))
    : (l = t[8]);
  ...
  return (
    t[14] !== u || t[15] !== d
      ? ((f = (0, X.jsxs)(X.Fragment, { children: [u, d] })), (t[14] = u), (t[15] = d), (t[16] = f))
      : (f = t[16]),
    f
  );
}
...
function kt({ onArtworkReady: e, svgMarkup: t }) {
  let n = C(),
    r = (0, Y.useId)().replaceAll(`:`, ``),
    i = (0, Y.useRef)(null),
    a = (0, Y.useRef)(null),
    o = (0, Y.useRef)(null),
    s = (0, Y.useRef)({ current: null, lastSampledAt: 0, trail: [] }),
    c = (0, Y.useRef)(null),
    l = (0, Y.useRef)(null),
    u = (0, Y.useRef)(null),
    d = (0, Y.useCallback)(function e(t) {
      let n = o.current,
        r = a.current,
        i = c.current;
      if (((c.current = null), n != null && r != null && i != null)) {
        ...
        if (a != null) {
          let r = e.matrixTransform(a.inverse()),
            i = s.current;
          (i.current != null && t - i.lastSampledAt >= wt
            ? (i.trail.unshift({ sampledAt: t, x: i.current.x, y: i.current.y }),
              i.trail.length > St && i.trail.pop(),
              (i.lastSampledAt = t))
      ...
      if (n != null) {
        ...
        for (; e.length > 0 && t - e[e.length - 1].sampledAt >= xt; ) e.pop();
        for (let [r, i] of n.trailSpots.entries()) {
          ...
          zt(i, n, (1 - (t - n.sampledAt) / xt) * (1 - r / St) * Ct);
        }
      }
      let d = u.current;
      if (n != null && d != null) {
        let e = Math.min(1, (t - d.startedAt) / Tt),
          r = d.maxRadius * e,
          i = Math.max(0, r - Dt),
          a = Math.min(d.maxRadius, r + Dt),
          [o, s, c] = n.rippleStops;
      ...
      l.current =
        u.current != null || c.current != null || (n != null && s.current.trail.length > 0)
  ...
  function h() {
    ((c.current = null), Bt(s.current, o.current));
  }
...
function At(e, t) {
  ...
  let i = Array.from(e.querySelectorAll(`:scope > path`)).map((e) => {
      ...
      return (e.removeAttribute(`fill`), n.appendChild(e), { fill: t, path: e });
    }),
    a = Q(`defs`),
    o = jt(e, `interactive-brush-${t}`),
    s = Array.from({ length: St }, (n, r) => jt(e, `interactive-brush-trail-${r}-${t}`)),
    c = It(e, `interactive-brush-${t}-mask`);
  c.append(o.maskRect, ...s.map(({ maskRect: e }) => e));
  let { gradient: l, stops: u } = Nt(e, `interactive-ripple-${t}`),
    d = Ft(e, l);
  (a.append(n, o.gradient, ...s.map(({ gradient: e }) => e), c, l, d), e.prepend(a));
  let f = Rt(r, `currentColor`, `1`),
    p = Rt(r, `var(--color-token-charts-blue)`, `0`, c.id, bt),
    m = Rt(r, `var(--color-token-charts-blue)`, `0`, d.id, Et);
  return (
    e.append(f, p, m),
    {
      baseOverlay: f,
...
function Mt(e) {
  let t = Q(`radialGradient`);
  return (
    (t.id = e),
    t.setAttribute(`gradientUnits`, `userSpaceOnUse`),
    t.setAttribute(`cx`, String(-yt)),
    t.setAttribute(`cy`, String(-yt)),
    t.setAttribute(`r`, String(yt)),
    t.append(Pt(`0`, `1`), Pt(`0.58`, `0.61`), Pt(`0.99`, `0.23`), Pt(`1`, `0`)),
    t
  );
}
function Nt(e, t) {
  let n = Q(`radialGradient`),
    r = e.viewBox.baseVal,
    i = [Pt(`0`, `0`), Pt(`0`, `1`), Pt(`0`, `0`)];
  return (
    (n.id = t),
...
function Rt(e, t, n, r, i) {
  ...
  return (
    ...
    i != null && (a.setAttribute(`stroke`, t), a.setAttribute(`stroke-width`, String(i))),
    a
  );
}
function zt(e, t, n) {
...
function Vt(e, t) {
  if (t.defs.parentNode === e) {
    ...
    (t.baseOverlay.remove(), t.brushOverlay.remove(), t.rippleOverlay.remove(), t.defs.remove());
  }
}
function Q(e) {
  return document.createElementNS(Ot, e);
}
function Ht(e) {
  let t = (0, Z.c)(13),
    ...
    a;
  t[0] !== n || t[1] !== i
    ? ((a = { onArtworkReady: n, svgMarkup: i }), (t[0] = n), (t[1] = i), (t[2] = a))
    : (a = t[2]);
  let { clearPaint: o, paintDots: s, rootRef: c, triggerRipple: l } = kt(a),
    u,
    d;
  (t[3] === l
    ? ((u = t[4]), (d = t[5]))
    : ((u = () => ({ triggerRipple: l })), (d = [l]), (t[3] = l), (t[4] = u), (t[5] = d)),
    (0, Y.useImperativeHandle)(r, u, d));
  let f;
...
var Ut = `` + new URL(`codex-home-hero-dark-still-43PvFxTG.png`, import.meta.url).href,
  Wt = `` + new URL(`codex-home-hero-dark-_BGDEdk8.mp4`, import.meta.url).href,
  Gt = `` + new URL(`codex-home-hero-light-still-CQ7cy4qg.png`, import.meta.url).href,
  Kt = `` + new URL(`codex-home-hero-light-Cyip34F2.mp4`, import.meta.url).href,
  qt = `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
  Jt = { dark: { stillSrc: Ut, videoSrc: Wt }, light: { stillSrc: Gt, videoSrc: Kt } },
  Yt = `url(${F(qt)})`,
  Xt = {
    maskImage: Yt,
    maskMode: `alpha`,
...
function Zt(e) {
  ...
  t[1] !== a || t[2] !== u || t[3] !== c
    ? ((h = () => {
        if (a || c === u) return;
        let e = o.current;
        e != null && e.paused && ((e.currentTime = 0), e.play()?.catch(Qt));
      }),
      (t[1] = a),
      (t[2] = u),
      (t[3] = c),
  ...
  if (a || c === u) {
    ...
    t[7] === r
      ? (e = t[8])
      : ((e = v(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== y || t[10] !== d
      ? ((a = (0, X.jsx)(`img`, { alt: ``, "aria-hidden": `true`, className: y, src: d })),
        (t[9] = y),
        (t[10] = d),
        (t[11] = a))
      : (a = t[11]);
  ...
  t[17] === r
    ? (b = t[18])
    : ((b = v(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = b));
  let x;
  t[19] === g
    ? (x = t[20])
    : ((x = (e) => {
...
function un(e) {
  ...
  return (
    t[6] !== n || t[7] !== r || t[8] !== o || t[9] !== l
      ? ((u = (0, X.jsx)(pn, { ariaLabel: n, centerLogoAriaLabel: r, platform: o, size: l })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = o),
        (t[9] = l),
...
function dn(e) {
  ...
  if (i) {
    ...
    return (
      t[3] !== n || t[4] !== l
        ? ((e = (0, X.jsx)(fn, { ariaLabel: n, ...l })), (t[3] = n), (t[4] = l), (t[5] = e))
        : (e = t[5]),
      e
    );
  }
  ...
  return (
    t[6] !== n || t[7] !== r || t[8] !== l || t[9] !== s
      ? ((u = (0, X.jsx)(gn, { ariaLabel: n, centerLogoAriaLabel: r, size: s, ...l })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = l),
        (t[9] = s),
...
function pn(e) {
  ...
  if (i === `android`) {
    ...
    return (
      t[0] !== n || t[1] !== o
        ? ((e = (0, X.jsx)(mn, { ariaLabel: n, size: o })), (t[0] = n), (t[1] = o), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== o
      ? ((s = (0, X.jsx)(hn, { ariaLabel: n, centerLogoAriaLabel: r, size: o })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s))
...
function mn(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, X.jsx)(`div`, {
        ...
        dangerouslySetInnerHTML: { __html: _t },
      })),
      (t[2] = o))
    : (o = t[2]);
  let s;
  return (
    t[3] !== n || t[4] !== a
      ? ((s = (0, X.jsx)(`div`, { "aria-label": n, className: a, role: `img`, children: o })),
        (t[3] = n),
        (t[4] = a),
        (t[5] = s))
      : (s = t[5]),
...
function gn(e) {
  ...
  t[5] === a
    ? (p = t[6])
    : ((p = (0, X.jsx)(Ht, { ref: s, onArtworkReady: l, svgMarkup: a })), (t[5] = a), (t[6] = p));
  ...
  t[9] !== r || t[10] !== h
    ? ((g = (0, X.jsx)(`div`, {
        ...
        children: (0, X.jsx)(Zt, { ariaLabel: r, className: h, onClick: l }),
      })),
      (t[9] = r),
      (t[10] = h),
      (t[11] = g))
...
function _n(e, t, n) {
  let r = (0, nn.create)(e, { errorCorrectionLevel: t }).modules,
    i = rn / (r.size + cn * 2);
  return { cornersMarkup: yn(r.size, i), dotsMarkup: vn(r, i, n) };
}
function vn(e, t, n) {
  let r = [];
  for (let i = 0; i < e.size; i += 1)
    for (let a = 0; a < e.size; a += 1)
      !Dn(e, i, a) || On(e.size, i, a) || (n && En(e.size, t, i, a)) || r.push(xn(a, t, i));
  return Cn(r.join(``));
}
function yn(e, t) {
  return Cn([bn(0, 0, t), bn(e - sn, 0, t), bn(0, e - sn, t)].join(``));
}
function bn(e, t, n) {
  let r = Tn(e, n),
    i = Tn(t, n),
    ...
    o = n,
    s = n * 2;
  return `<path fill-rule="evenodd" clip-rule="evenodd" d="${Sn(r, i, a, n * 1.6)} ${Sn(r + o, i + o, a - o * 2, n)}" fill="currentColor"/><rect x="${$(r + s)}" y="${$(i + s)}" width="${$(a - s * 2)}" height="${$(a - s * 2)}" rx="${$(n)}" fill="currentColor"/>`;
}
function xn(e, t, n) {
  let r = t * on,
    i = wn(e, t),
...
function Cn(e) {
  return `<svg width="${rn}" height="${rn}" viewBox="0 0 ${rn} ${rn}" fill="none" xmlns="${ln}">${e}</svg>`;
}
function wn(e, t) {
  return Tn(e, t) + t / 2;
}
...
function On(e, t, n) {
  return kn(t, n, 0, 0) || kn(t, n, 0, e - sn) || kn(t, n, e - sn, 0);
}
function kn(e, t, n, r) {
  return e >= n && e < n + sn && t >= r && t < r + sn;
}
function An(e) {
  return e % 2 == 0 ? e + 1 : e;
}
...
function jn(e) {
  let t = (0, Z.c)(82),
    ...
    p = D(ue),
    m = D(le),
    [h, y] = (0, Y.useState)(`ios`),
    [x, S] = (0, Y.useState)(!1),
    [C, w] = (0, Y.useState)(`phone`),
    O = u ? (n ?? C) : `phone`,
    [k] = (0, Y.useState)(Mn),
    A;
  t[0] !== c || t[1] !== k
    ? ((A = { hostId: c, openId: k }), (t[0] = c), (t[1] = k), (t[2] = A))
    : (A = t[2]);
  let j = a(R, A),
    ee = p && !m,
    M = ee && j.error == null ? (j.data ?? null) : null,
    N = M?.manualPairingCode ?? null,
    te = ee && M == null && (j.error == null || j.isFetching),
    ne = !p || M?.pairingCode != null,
    P = O === `phone` && !p && !m,
    oe = ee && O === `computer` && !te,
    se;
  t[3] !== n || t[4] !== i
  ...
  if (m) {
    ...
    t[17] === f
      ...
      : ((e = f.formatMessage({
        ...
        (t[18] = e));
    let n;
    (t[19] === e ? (n = t[20]) : ((n = (0, X.jsx)(Pn, { ariaLabel: e })), (t[19] = e), (t[20] = n)),
      (V = n));
  } else if (O === `phone` && ne) {
    let e = M?.pairingCode,
      n;
    (t[21] !== he || t[22] !== pe || t[23] !== h || t[24] !== d || t[25] !== e
      ? ((n = (0, X.jsx)(un, {
          ariaLabel: pe,
          centerLogoAriaLabel: he,
          pairingCode: e,
          platform: h,
          size: d,
        })),
    ...
    (t[27] === j.error
      ? (e = t[28])
      : ((e = (0, X.jsx)(Hn, { error: j.error })), (t[27] = j.error), (t[28] = e)),
      (V = e));
  } else if (p) {
    let e;
    (t[29] !== N || t[30] !== j.error || t[31] !== d
      ? ((e = (0, X.jsx)(Fn, { error: j.error, manualPairingCode: N, size: d })),
        (t[29] = N),
        (t[30] = j.error),
        (t[31] = d),
        (t[32] = e))
  ...
  let ye = d === `compact` ? null : `mt-3`,
    H;
  t[34] === ye
    ? (H = t[35])
    : ((H = v(`flex w-full flex-col items-center gap-4`, ye)), (t[34] = ye), (t[35] = H));
  let U;
  t[36] !== f || t[37] !== m || t[38] !== F || t[39] !== O || t[40] !== u
    ? ((U =
        u && !m
          ? (0, X.jsx)(`div`, {
      ...
      (t[41] = U))
    : (U = t[41]);
  let be = d === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    W = P ? null : `justify-center`,
    G =
      O === `computer`
        ? d === `compact`
  ...
  t[46] !== V || t[47] !== P
    ? ((q = P
        ? (0, X.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: V })
        : V),
      (t[46] = V),
      (t[47] = P),
      (t[48] = q))
  ...
  t[60] !== de
              ...
              O === `phone` && ne
                ? (0, X.jsx)(T, {
                    ...
                    children: (0, X.jsx)(b, {
                      ...
                      onClick: () => S(!0),
                      size: `icon`,
                      children: (0, X.jsx)(ce, { className: `icon-xs` }),
                    }),
                  })
                : null,
              (0, X.jsx)(T, {
                ...
                children: (0, X.jsx)(b, {
                  "aria-label": L,
                  color: `ghost`,
                  disabled: j.isFetching,
                  onClick: () => {
                    j.refetch();
                  },
                  size: `icon`,
                  children: (0, X.jsx)(E, {
                    className: v(`icon-xs`, j.isFetching ? `animate-spin` : null),
                  }),
                }),
              }),
            ],
    ...
    : (xe = t[61]);
  let Se;
  t[62] !== K || t[63] !== q || t[64] !== J || t[65] !== xe
    ? ((Se = (0, X.jsxs)(`div`, { className: K, children: [q, J, xe] })),
      (t[62] = K),
      (t[63] = q),
      (t[64] = J),
      (t[65] = xe),
    ...
    : (Se = t[66]);
  let Ce;
  t[67] === oe ? (Ce = t[68]) : ((Ce = oe ? (0, X.jsx)(Vn, {}) : null), (t[67] = oe), (t[68] = Ce));
  let we;
  t[69] !== he || t[70] !== f || t[71] !== x || t[72] !== M || t[73] !== pe || t[74] !== h
    ? ((we =
        M?.pairingCode == null
          ? null
          : (0, X.jsxs)(ae, {
  ...
  let Te;
  return (
    t[76] !== H || t[77] !== U || t[78] !== Se || t[79] !== Ce || t[80] !== we
      ? ((Te = (0, X.jsxs)(`div`, { className: H, children: [U, Se, Ce, we] })),
        (t[76] = H),
        (t[77] = U),
        (t[78] = Se),
        (t[79] = Ce),
...
function Pn(e) {
  let t = (0, Z.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, X.jsx)(w, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function Ln(e) {
  return (0, X.jsx)(`span`, { className: `font-semibold text-token-text-primary`, children: e });
}
function Rn(e) {
  return (0, X.jsx)(`span`, { className: `font-semibold text-token-text-primary`, children: e });
}
...
function Un(e) {
  let t = (0, Z.c)(34),
    ...
    { platform: s } = A(),
    c;
  t[0] !== s || t[1] !== o ? ((c = Jn(o, s)), (t[0] = s), (t[1] = o), (t[2] = c)) : (c = t[2]);
  let l = c,
    u;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[3]);
  let d;
  t[4] === o ? (d = t[5]) : ((d = (0, X.jsx)(qn, { variant: o })), (t[4] = o), (t[5] = d));
  let f = o === `page` && `w-full max-w-[400px]`,
    p;
  t[6] === f
    ? (p = t[7])
    : ((p = v(`flex flex-wrap items-center justify-center gap-3`, f)), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((m =
        o === `dialog`
  ...
  let h = o === `page` && `w-full`,
    g;
  t[12] === h ? (g = t[13]) : ((g = v(`justify-center`, h)), (t[12] = h), (t[13] = g));
  let y;
  ...
  t[15] !== r || t[16] !== a || t[17] !== g
    ? ((x = (0, X.jsx)(b, { onClick: r, size: `large`, className: g, loading: a, children: y })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = g),
      (t[18] = x))
    : (x = t[18]);
  let S;
  t[19] !== x || t[20] !== p || t[21] !== m
    ? ((S = (0, X.jsxs)(`div`, { className: p, children: [m, x] })),
      (t[19] = x),
      (t[20] = p),
      (t[21] = m),
      (t[22] = S))
  ...
  let T;
  return (
    t[27] !== l || t[28] !== S || t[29] !== C || t[30] !== w || t[31] !== d || t[32] !== o
      ? ((T = (0, X.jsxs)(De, { variant: o, heading: l, description: u, children: [d, S, C, w] })),
        (t[27] = l),
        (t[28] = S),
        (t[29] = C),
        (t[30] = w),
...
function Wn(e) {
  ...
  return (
    t[8] !== l || t[9] !== u || t[10] !== a
      ? ((d = (0, X.jsxs)(De, { variant: a, heading: o, description: s, children: [l, u] })),
        (t[8] = l),
        (t[9] = u),
        (t[10] = a),
        (t[11] = d))
...
function Gn(e) {
  ...
  t[3] === n
    ? (s = t[4])
    : ((s = (0, X.jsx)(b, { size: `large`, className: `justify-center`, onClick: n, children: o })),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
    t[5] !== s || t[6] !== r
      ? ((c = (0, X.jsx)(De, { variant: r, heading: i, description: a, children: s })),
        (t[5] = s),
        (t[6] = r),
        (t[7] = c))
      : (c = t[7]),
...
function Kn(e) {
  ...
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, X.jsx)(jn, { showDeviceTypeSelector: !1 })), (t[3] = o))
    : (o = t[3]);
  let s;
  t[4] === n
    ? (s = t[5])
    : ((s = (0, X.jsxs)(`div`, {
        ...
        children: [o, (0, X.jsx)(je, { onManageConnections: n })],
      })),
      (t[4] = n),
      (t[5] = s));
  let c;
  return (
    t[6] !== i || t[7] !== s
      ? ((c = (0, X.jsx)(De, { variant: `page`, heading: i, description: a, children: s })),
        (t[6] = i),
        (t[7] = s),
        (t[8] = c))
      : (c = t[8]),
...
function qn(e) {
  let t = (0, Z.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = v(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, X.jsx)(Yn, {
        icon: (0, X.jsx)(z, { "aria-hidden": !0, className: `size-5` }),
        title: (0, X.jsx)(_, {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, X.jsx)(Yn, {
        icon: (0, X.jsx)(te, { "aria-hidden": !0, className: `size-5` }),
        title: (0, X.jsx)(_, {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, X.jsx)(Yn, {
        icon: (0, X.jsx)(ye, { "aria-hidden": !0, className: `size-5` }),
        title: (0, X.jsx)(_, {
  ...
  return (
    t[5] === i
      ? (c = t[6])
      : ((c = (0, X.jsxs)(`div`, { className: i, children: [a, o, s] })), (t[5] = i), (t[6] = c)),
    c
  );
}
function Jn(e, t) {
...
function Xn(e) {
  ...
  if (o === `page`) {
    ...
    t[4] === s
      ...
      : ((n = (0, X.jsx)(`div`, {
          className: `flex w-full max-w-[460px] flex-col items-center gap-6`,
          children: (0, X.jsx)(jn, { hostId: s, showDeviceTypeSelector: !1 }),
        })),
        (t[4] = s),
        (t[5] = n));
    let r;
    return (
      t[6] !== d || t[7] !== n
        ? ((r = (0, X.jsx)(De, { variant: `page`, heading: d, description: e, children: n })),
          (t[6] = d),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  return (
    t[13] !== d || t[14] !== f
      ? ((p = (0, X.jsx)(De, { variant: `dialog`, heading: d, children: f })),
        (t[13] = d),
        (t[14] = f),
        (t[15] = p))
      : (p = t[15]),
...
function Zn(e) {
  ...
  if (p === `dialog`) {
    let e;
    t[15] !== g || t[16] !== f
      ? ((e = er(f, g)), (t[15] = g), (t[16] = f), (t[17] = e))
      : (e = t[17]);
    let n;
    t[18] === e ? (n = t[19]) : ((n = (0, X.jsx)(Ae, { artworkSrc: e })), (t[18] = e), (t[19] = n));
    let r;
    return (
      t[20] !== y || t[21] !== n
        ? ((r = (0, X.jsxs)(`div`, {
  ...
  let b;
  t[23] === f ? (b = t[24]) : ((b = nr(f)), (t[23] = f), (t[24] = b));
  let x;
  t[25] === f ? (x = t[26]) : ((x = tr(f)), (t[25] = f), (t[26] = x));
  let S;
  return (
    t[27] !== y || t[28] !== b || t[29] !== x
      ? ((S = (0, X.jsx)(ke, { artworkAlignment: b, artworkSrc: x, children: y })),
        (t[27] = y),
        (t[28] = b),
        (t[29] = x),
        (t[30] = S))
...
function Qn(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, X.jsx)(ke, { children: (0, X.jsx)(Kn, { onManageConnections: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function $n(e) {
  ...
  switch (m) {
    ...
    case `connected`: {
      ...
      return (
        t[5] !== s || t[6] !== c || t[7] !== h
          ? ((e = (0, X.jsx)(ze, { onFinishSetup: s, onManageConnections: c, variant: h })),
            (t[5] = s),
            (t[6] = c),
            (t[7] = h),
            (t[8] = e))
    ...
    case `mfa-required`: {
      ...
      return (
        t[15] !== o || t[16] !== h
          ? ((e = (0, X.jsx)(Gn, { onContinueOnChatGPT: o, variant: h })),
            (t[15] = o),
            (t[16] = h),
            (t[17] = e))
          : (e = t[17]),
...
function rr(e) {
  let t = (0, Z.c)(31),
    ...
    x;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = { "aria-describedby": void 0 }), (t[0] = x))
    : (x = t[0]);
  let S;
  t[1] !== y || t[2] !== b || t[3] !== m
    ? ((S = ir(y, b, m)), (t[1] = y), (t[2] = b), (t[3] = m), (t[4] = S))
    : (S = t[4]);
  let C;
  t[5] === S
    ? (C = t[6])
    : ((C = (0, X.jsx)(ie, { className: `sr-only`, children: S })), (t[5] = S), (t[6] = C));
  let w;
  t[7] !== v || t[8] !== m
    ? ((w = () => {
        (k(v, O, { action: `continue_on_chatgpt`, step: m, surface: `dialog` }),
          d.dispatchMessage(`open-in-browser`, { url: `https://chatgpt.com/#settings/Security` }));
      }),
      (t[7] = v),
      (t[8] = m),
      (t[9] = w))
    : (w = t[9]);
  let T;
  t[10] !== i || t[11] !== v || t[12] !== m
    ? ((T = () => {
        (k(v, O, { action: `finish_setup`, step: m, surface: `dialog` }), i(!1));
      }),
      (t[10] = i),
      (t[11] = v),
      (t[12] = m),
  ...
  t[24] !== h
    ? ((E = (0, X.jsx)(Zn, {
        hostId: n,
        onAllowHost: r,
        onContinueOnChatGPT: w,
        onFinishSetup: T,
        onSkip: a,
        onStartSetup: s,
        setupInProgress: p,
        showAllowHostError: _,
        showStartSetupError: f,
        step: m,
        variant: `dialog`,
        waitingHeading: h,
...
export { Te as a, qn as i, Qn as n, H as o, Zn as r, rr as t };
