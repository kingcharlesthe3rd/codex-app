...
import { A as Be, j as Ve } from "./app-initial~app-main~automations-page.js";
import {
  Br as He,
  Ur as Ue,
  aa as We,
...
import { n as it, t as at } from "./segmented-toggle.js";
import { n as ot, t as st } from "./use-home-directory.js";
import { a as ct, o as lt } from "./plugin-detail-page-utils.js";
var ut,
  dt = e(() => {
    (Fe(), (ut = me(`electron:codex-mobile-setup-step-debug-override`, `auto`)));
  }),
  ft,
  pt = e(() => {
    ft = `` + new URL(`dialog-artwork-allow-host-B0bcIhDi.png`, import.meta.url).href;
  }),
  mt,
  ht = e(() => {
    mt = `` + new URL(`dialog-artwork-connected-NZKCls7p.png`, import.meta.url).href;
  }),
  gt,
  _t = e(() => {
    gt = `` + new URL(`dialog-artwork-initial-DMDAvEM7.png`, import.meta.url).href;
  }),
  vt,
  yt = e(() => {
  ...
  bt,
  xt = e(() => {
    bt = `` + new URL(`dialog-artwork-waiting-computer-BPIs9eKV.png`, import.meta.url).href;
  }),
  St,
  Ct = e(() => {
    St = `` + new URL(`dialog-artwork-waiting-phone-UTYmfLHs.png`, import.meta.url).href;
  }),
  wt,
  Tt = e(() => {
    wt = `` + new URL(`page-artwork-allow-host-CPm7eJR2.png`, import.meta.url).href;
  }),
  Et,
  Dt = e(() => {
  ...
  Ot,
  kt = e(() => {
    Ot = `` + new URL(`page-artwork-waiting-pzj85BPm.png`, import.meta.url).href;
  }),
  At,
  jt = e(() => {
...
function Vt(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = d(`flex w-full flex-col gap-2 text-center`, s)), (t[0] = s), (t[1] = c));
  let l =
      o === `dialog`
    ...
    u;
  t[2] !== a || t[3] !== l
    ? ((u = (0, Ut.jsx)(`div`, { className: l, children: a })), (t[2] = a), (t[3] = l), (t[4] = u))
    : (u = t[4]);
  let f;
  t[5] !== r || t[6] !== o
    ? ((f =
  ...
  let p;
  t[8] !== c || t[9] !== u || t[10] !== f
    ? ((p = (0, Ut.jsxs)(`div`, { className: c, children: [u, f] })),
      (t[8] = c),
      (t[9] = u),
      (t[10] = f),
      (t[11] = p))
  ...
  let m;
  t[12] !== i || t[13] !== p
    ? ((m = (0, Ut.jsxs)(Ut.Fragment, { children: [i, p] })), (t[12] = i), (t[13] = p), (t[14] = m))
    : (m = t[14]);
  let h = m;
  if (o === `dialog`) {
    let e;
...
var Ht,
  ...
  Gt,
  Kt = e(() => {
    Gt = `` + new URL(`page-artwork-background-DPNBzfAy.png`, import.meta.url).href;
  });
function qt(e) {
  let t = (0, Xt.c)(13),
...
function Yt(e) {
  let t = (0, Xt.c)(6),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = d(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function Qt() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (a = e[0]);
  let o = u(a).available,
    s = y(se.keepRemoteControlAwakeWhilePluggedIn),
    c = re(v, oe),
    l = S(ge),
    d;
  e[1] === t.query ? (d = e[2]) : ((d = t.query.snapshot(ge)), (e[1] = t.query), (e[2] = d));
  let f = d,
    p;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((p = []), (e[3] = p)) : (p = e[3]);
  let m = ve(oe, p),
    g;
  e[4] !== r || e[5] !== m.availablePlugins
    ? ((g = en(m.availablePlugins, rn, r)), (e[4] = r), (e[5] = m.availablePlugins), (e[6] = g))
    : (g = e[6]);
  let _ = g,
    b = _?.plugin.installed === !0 && _.plugin.enabled,
    x;
  e[7] !== r || e[8] !== m.availablePlugins
    ? ((x = $t(m.availablePlugins, r)), (e[7] = r), (e[8] = m.availablePlugins), (e[9] = x))
    : (x = e[9]);
  let C = x,
    w;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = { hostId: oe }), (e[10] = w))
    : (w = e[10]);
  let { pendingPluginId: T, setPluginEnabled: E } = Ue(w),
    D;
  e[11] === m.forceReload
    ? (D = e[12])
    : ((D = { forceReloadPlugins: m.forceReload, hostId: oe }),
      (e[11] = m.forceReload),
      (e[12] = D));
  let {
      closePluginInstall: te,
      connectRequiredApp: ne,
      handleRequiredAppConnected: O,
  ...
  e[13] === f
    ...
    : ((M = {
      ...
      (e[14] = M));
  let N = ee(M),
    de = n === `macOS` && b && c && l.data?.enabled != null,
    fe;
  e[15] !== _ || e[16] !== l.data?.enabled || e[17] !== j || e[18] !== E || e[19] !== N
    ? ((fe = (e) => {
        if (_ != null) {
          ...
          if (!e && l.data?.enabled) {
            N.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && E({ enabled: !1, pluginDisplayName: be(_), pluginId: _.plugin.id });
              },
            });
            return;
          }
          E({ enabled: e, pluginDisplayName: be(_), pluginId: _.plugin.id });
        }
      }),
      (e[15] = _),
      (e[16] = l.data?.enabled),
  ...
  e[21] !== C || e[22] !== j || e[23] !== E
    ? ((P = (e) => {
        if (C != null) {
          ...
          E({ enabled: e, pluginDisplayName: be(C), pluginId: C.plugin.id });
        }
      }),
      (e[21] = C),
      (e[22] = j),
    ...
    : (P = e[24]);
  let me = P,
    he = C?.plugin.installed === !0 && C.plugin.enabled,
    F = m.isLoading || C == null || A || T === C.plugin.id,
    I = m.isLoading || _ == null || A || N.isPending || T === _.plugin.id,
    L = s ?? !1,
    R = l.data?.enabled ?? !1,
    z = !b || l.isLoading || N.isPending,
    B;
  e[25] === t
    ? (B = e[26])
    : ((B = (e) => {
        ue(t, se.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = B));
  let V;
...
function $t(e, t) {
  return N.isInternal(Ie()) ? (en(e, sn, t) ?? en(e, on, t) ?? en(e, an, t)) : en(e, an, t);
}
function en(e, t, n) {
...
function ln(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, K.jsx)(Qe, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let f =
    ...
    p;
  t[4] === f ? (p = t[5]) : ((p = d(`flex w-full flex-col`, f)), (t[4] = f), (t[5] = p));
  let h;
  ...
  t[11] !== o ||
  t[12] !== i
    ? ((h = s.showKeepComputerAwake
        ? (0, K.jsx)(dn, {
            icon: s.keepComputerAwake
              ? (0, K.jsx)(Be, { className: `icon-base` })
  ...
  t[30] !== a ||
  t[31] !== i
    ? ((_ = s.showChromeExtensionSetup
        ? (0, K.jsx)(dn, {
            icon: (0, K.jsx)(Ye, { className: `icon-base` }),
            variant: i,
            title: (0, K.jsx)(W, {
    ...
    : (_ = t[32]);
  let v;
  t[33] !== p || t[34] !== h || t[35] !== g || t[36] !== _
    ? ((v = (0, K.jsxs)(`div`, { className: p, children: [h, g, _] })),
      (t[33] = p),
      (t[34] = h),
      (t[35] = g),
      (t[36] = _),
      (t[37] = v))
    : (v = t[37]);
  let y = i === `page` && `w-[256px]`,
    b;
  t[38] === y ? (b = t[39]) : ((b = d(`justify-center`, y)), (t[38] = y), (t[39] = b));
  let x;
  ...
  t[41] !== n || t[42] !== b
    ? ((S = (0, K.jsx)(`div`, {
        ...
        children: (0, K.jsx)(m, { size: `large`, className: b, onClick: n, children: x }),
      })),
      (t[41] = n),
      (t[42] = b),
      (t[43] = S))
...
function dn(e) {
  ...
  if (i != null) {
    ...
    t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== o
      ? ((l = (0, K.jsx)(fn, { description: n, icon: r, title: a, trailing: o })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o),
    ...
    return (
      t[7] !== i || t[8] !== c || t[9] !== l
        ? ((u = (0, K.jsx)(`button`, { type: `button`, className: c, onClick: i, children: l })),
          (t[7] = i),
          (t[8] = c),
          (t[9] = l),
          (t[10] = u))
  ...
  t[11] === c
    ? (l = t[12])
    : ((l = d(`flex items-center justify-between gap-4 px-[14px] py-2 text-left`, c)),
      (t[11] = c),
      (t[12] = l));
  let u;
  ...
  return (
    t[18] !== l || t[19] !== u
      ? ((f = (0, K.jsx)(`div`, { className: l, children: u })),
        (t[18] = l),
        (t[19] = u),
        (t[20] = f))
      : (f = t[20]),
...
function fn(e) {
  ...
  t[2] === i
    ? (s = t[3])
    : ((s = (0, K.jsx)(`div`, { className: `text-sm text-token-text-primary`, children: i })),
      (t[2] = i),
      (t[3] = s));
  let c;
  t[4] === n
  ...
  let l;
  t[6] !== s || t[7] !== c
    ? ((l = (0, K.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [s, c] })),
      (t[6] = s),
      (t[7] = c),
      (t[8] = l))
    : (l = t[8]);
  ...
  return (
    t[14] !== u || t[15] !== d
      ? ((f = (0, K.jsxs)(K.Fragment, { children: [u, d] })), (t[14] = u), (t[15] = d), (t[16] = f))
      : (f = t[16]),
    f
  );
}
...
function Jn(e, t) {
  ...
  let i = Array.from(e.querySelectorAll(`:scope > path`)).map((e) => {
    ...
    s = Array.from({ length: ur }, (n, r) => Yn(e, `interactive-brush-trail-${r}-${t}`)),
...
function Xn(e) {
  ...
  return (
    ...
    t.append(Qn(`0`, `1`), Qn(`0.58`, `0.61`), Qn(`0.99`, `0.23`), Qn(`1`, `0`)),
    t
  );
}
function Zn(e, t) {
...
var yr,
  ...
  xr,
  Sr = e(() => {
    ((yr = U()), (br = t(C(), 1)), _r(), (xr = f()));
  }),
  Cr,
  wr = e(() => {
    Cr = `` + new URL(`codex-home-hero-dark-still-43PvFxTG.png`, import.meta.url).href;
  }),
  Tr,
  Er = e(() => {
    Tr = `` + new URL(`codex-home-hero-dark-_BGDEdk8.mp4`, import.meta.url).href;
  }),
  Dr,
  Or = e(() => {
    Dr = `` + new URL(`codex-home-hero-light-still-CQ7cy4qg.png`, import.meta.url).href;
  }),
  kr,
  Ar = e(() => {
    kr = `` + new URL(`codex-home-hero-light-Cyip34F2.mp4`, import.meta.url).href;
  }),
  jr,
  Mr = e(() => {
...
function Nr(e) {
  ...
  t[5] === r
    ? (v = t[6])
    : ((v = d(`size-full shrink-0 object-contain`, r)), (t[5] = r), (t[6] = v));
  let y = v;
  if (a || c === u) {
    let e;
    t[7] === r
      ? (e = t[8])
      : ((e = d(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== y || t[10] !== f
      ? ((a = (0, Lr.jsx)(`img`, { alt: ``, "aria-hidden": `true`, className: y, src: f })),
        (t[9] = y),
        (t[10] = f),
        (t[11] = a))
      : (a = t[11]);
  ...
  t[17] === r
    ? (b = t[18])
    : ((b = d(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = b));
  let x;
  t[19] === _
    ? (x = t[20])
    : ((x = (e) => {
  ...
  t[21] === u
    ...
    : ((S = () => {
      ...
      (t[22] = S));
  let C;
  t[23] !== y || t[24] !== f || t[25] !== x || t[26] !== S || t[27] !== u || t[28] !== p
    ? ((C = (0, Lr.jsx)(
        `video`,
        {
          ref: o,
...
var Fr,
  ...
  Vr = e(() => {
    ((Fr = U()),
      ...
      Ce(),
      (Lr = f()),
      (Rr = { dark: { stillSrc: Cr, videoSrc: Tr }, light: { stillSrc: Dr, videoSrc: kr } }),
      (zr = `url(${qe(jr)})`),
      (Br = {
        maskImage: zr,
        maskMode: `alpha`,
...
function Jr(e) {
  ...
  return (
    t[6] !== n || t[7] !== r || t[8] !== o || t[9] !== l
      ? ((u = (0, Y.jsx)(Zr, { ariaLabel: n, centerLogoAriaLabel: r, platform: o, size: l })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = o),
        (t[9] = l),
...
function Yr(e) {
  ...
  if (i) {
    ...
    return (
      t[3] !== n || t[4] !== l
        ? ((e = (0, Y.jsx)(Xr, { ariaLabel: n, ...l })), (t[3] = n), (t[4] = l), (t[5] = e))
        : (e = t[5]),
      e
    );
  }
  ...
  return (
    t[6] !== n || t[7] !== r || t[8] !== l || t[9] !== s
      ? ((u = (0, Y.jsx)(ei, { ariaLabel: n, centerLogoAriaLabel: r, size: s, ...l })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = l),
        (t[9] = s),
...
function Zr(e) {
  ...
  if (i === `android`) {
    ...
    return (
      t[0] !== n || t[1] !== o
        ? ((e = (0, Y.jsx)(Qr, { ariaLabel: n, size: o })), (t[0] = n), (t[1] = o), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== o
      ? ((s = (0, Y.jsx)($r, { ariaLabel: n, centerLogoAriaLabel: r, size: o })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s))
...
function Qr(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = d(`relative overflow-hidden bg-token-main-surface-primary`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  return (
    t[3] !== n || t[4] !== a
      ? ((s = (0, Y.jsx)(`div`, { "aria-label": n, className: a, role: `img`, children: o })),
        (t[3] = n),
        (t[4] = a),
        (t[5] = s))
      : (s = t[5]),
...
function ei(e) {
  ...
  t[1] === u
    ? (f = t[2])
    : ((f = d(`relative overflow-hidden bg-token-main-surface-primary`, u)),
      (t[1] = u),
      (t[2] = f));
  let p;
  t[3] === i
  ...
  t[5] === a
    ? (m = t[6])
    : ((m = (0, Y.jsx)(vr, { ref: s, onArtworkReady: l, svgMarkup: a })), (t[5] = a), (t[6] = m));
  let h = o === `compact` ? `w-10` : `w-14`,
    g;
  t[7] === h
    ? (g = t[8])
    : ((g = d(`pointer-events-auto aspect-square`, h)), (t[7] = h), (t[8] = g));
  let _;
  t[9] !== r || t[10] !== g
    ? ((_ = (0, Y.jsx)(`div`, {
        className: `pointer-events-none absolute inset-0 z-20 grid place-items-center`,
        children: (0, Y.jsx)(Nr, { ariaLabel: r, className: g, onClick: l }),
      })),
      (t[9] = r),
      (t[10] = g),
      (t[11] = _))
...
function ni(e, t, n) {
  ...
  for (let i = 0; i < e.size; i += 1)
    for (let a = 0; a < e.size; a += 1)
      !di(e, i, a) || fi(e.size, i, a) || (n && ui(e.size, t, i, a)) || r.push(ai(a, t, i));
  return si(r.join(``));
}
function ri(e, t) {
...
function Ti(e) {
  let t = (0, Li.c)(82),
    ...
    C;
  t[0] !== s || t[1] !== S
    ? ((C = { hostId: s, openId: S }), (t[0] = s), (t[1] = S), (t[2] = C))
    : (C = t[2]);
  let T = re(Ae, C),
    E = f && !p,
    ee = E && T.error == null ? (T.data ?? null) : null,
    D = ee?.manualPairingCode ?? null,
    te = E && ee == null && (T.error == null || T.isFetching),
    ne = !f || ee?.pairingCode != null,
    O = x === `phone` && !f && !p,
    ie = E && x === `computer` && !te,
    ae;
  t[3] !== n || t[4] !== i
  ...
  if (p) {
    ...
    t[17] === u
      ...
      : ((e = u.formatMessage({
        ...
        (t[18] = e));
    let n;
    (t[19] === e ? (n = t[20]) : ((n = (0, X.jsx)(Oi, { ariaLabel: e })), (t[19] = e), (t[20] = n)),
      (P = n));
  } else if (x === `phone` && ne) {
    let e = ee?.pairingCode,
      n;
    (t[21] !== N || t[22] !== M || t[23] !== h || t[24] !== l || t[25] !== e
      ? ((n = (0, X.jsx)(Jr, {
          ariaLabel: M,
    ...
    (t[27] === T.error
      ? (e = t[28])
      : ((e = (0, X.jsx)(Ii, { error: T.error })), (t[27] = T.error), (t[28] = e)),
      (P = e));
  } else if (f) {
    let e;
    (t[29] !== D || t[30] !== T.error || t[31] !== l
      ? ((e = (0, X.jsx)(ki, { error: T.error, manualPairingCode: D, size: l })),
        (t[29] = D),
        (t[30] = T.error),
        (t[31] = l),
        (t[32] = e))
  ...
  let me = l === `compact` ? null : `mt-3`,
    F;
  t[34] === me
    ? (F = t[35])
    : ((F = d(`flex w-full flex-col items-center gap-4`, me)), (t[34] = me), (t[35] = F));
  let ge;
  t[36] !== u || t[37] !== p || t[38] !== k || t[39] !== x || t[40] !== c
    ? ((ge =
        c && !p
          ? (0, X.jsx)(`div`, {
      ...
      (t[41] = ge))
    : (ge = t[41]);
  let _e = l === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    ve = O ? null : `justify-center`,
    ye =
      x === `computer`
        ? l === `compact`
  ...
  t[46] !== P || t[47] !== O
    ? ((L = O
        ? (0, X.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: P })
        : P),
      (t[46] = P),
      (t[47] = O),
      (t[48] = L))
  ...
  t[60] !== j
              ...
              x === `phone` && ne
                ? (0, X.jsx)(Te, {
                    ...
                    children: (0, X.jsx)(m, {
                      ...
                      onClick: () => v(!0),
                      size: `icon`,
                      children: (0, X.jsx)(ze, { className: `icon-xs` }),
                    }),
                  })
                : null,
              (0, X.jsx)(Te, {
                ...
                children: (0, X.jsx)(m, {
                  ...
                  size: `icon`,
                  children: (0, X.jsx)(pe, {
                    className: d(`icon-xs`, T.isFetching ? `animate-spin` : null),
                  }),
                }),
              }),
            ],
    ...
    : (R = t[61]);
  let z;
  t[62] !== I || t[63] !== L || t[64] !== be || t[65] !== R
    ? ((z = (0, X.jsxs)(`div`, { className: I, children: [L, be, R] })),
      (t[62] = I),
      (t[63] = L),
      (t[64] = be),
      (t[65] = R),
    ...
    : (z = t[66]);
  let B;
  t[67] === ie ? (B = t[68]) : ((B = ie ? (0, X.jsx)(Fi, {}) : null), (t[67] = ie), (t[68] = B));
  let V;
  t[69] !== N || t[70] !== u || t[71] !== _ || t[72] !== ee || t[73] !== M || t[74] !== h
    ? ((V =
        ee?.pairingCode == null
          ? null
          : (0, X.jsxs)(Ne, {
  ...
  let H;
  return (
    t[76] !== F || t[77] !== ge || t[78] !== z || t[79] !== B || t[80] !== V
      ? ((H = (0, X.jsxs)(`div`, { className: F, children: [ge, z, B, V] })),
        (t[76] = F),
        (t[77] = ge),
        (t[78] = z),
        (t[79] = B),
...
function Oi(e) {
  let t = (0, Li.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, X.jsx)(V, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function Bi(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[3]);
  let f;
  t[4] === o ? (f = t[5]) : ((f = (0, Z.jsx)(Wi, { variant: o })), (t[4] = o), (t[5] = f));
  let p = o === `page` && `w-full max-w-[400px]`,
    h;
  t[6] === p
    ? (h = t[7])
    : ((h = d(`flex flex-wrap items-center justify-center gap-3`, p)), (t[6] = p), (t[7] = h));
  let g;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((g =
        o === `dialog`
  ...
  let _ = o === `page` && `w-full`,
    v;
  t[12] === _ ? (v = t[13]) : ((v = d(`justify-center`, _)), (t[12] = _), (t[13] = v));
  let y;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (y = t[14]);
  let b;
  t[15] !== r || t[16] !== a || t[17] !== v
    ? ((b = (0, Z.jsx)(m, { onClick: r, size: `large`, className: v, loading: a, children: y })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = v),
      (t[18] = b))
    : (b = t[18]);
  let x;
  t[19] !== b || t[20] !== h || t[21] !== g
    ? ((x = (0, Z.jsxs)(`div`, { className: h, children: [g, b] })),
      (t[19] = b),
      (t[20] = h),
      (t[21] = g),
      (t[22] = x))
  ...
  return (
    t[27] !== l || t[28] !== x || t[29] !== S || t[30] !== C || t[31] !== f || t[32] !== o
      ? ((w = (0, Z.jsxs)(Vt, { variant: o, heading: l, description: u, children: [f, x, S, C] })),
        (t[27] = l),
        (t[28] = x),
        (t[29] = S),
        (t[30] = C),
...
function Vi(e) {
  ...
  return (
    t[8] !== l || t[9] !== u || t[10] !== a
      ? ((d = (0, Z.jsxs)(Vt, { variant: a, heading: o, description: s, children: [l, u] })),
        (t[8] = l),
        (t[9] = u),
        (t[10] = a),
        (t[11] = d))
...
function Hi(e) {
  ...
  return (
    t[5] !== s || t[6] !== r
      ? ((c = (0, Z.jsx)(Vt, { variant: r, heading: i, description: a, children: s })),
        (t[5] = s),
        (t[6] = r),
        (t[7] = c))
      : (c = t[7]),
...
function Ui(e) {
  ...
  return (
    t[6] !== i || t[7] !== s
      ? ((c = (0, Z.jsx)(Vt, { variant: `page`, heading: i, description: a, children: s })),
        (t[6] = i),
        (t[7] = s),
        (t[8] = c))
      : (c = t[8]),
...
function Wi(e) {
  let t = (0, qi.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = d(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(nt, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(W, {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(ae, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(W, {
...
var qi,
  Z,
  Ji = e(() => {
    ((qi = U()), M(), R(), te(), x(), i(), Ze(), rt(), b(), Wt(), Zt(), zi(), (Z = f()));
  });
function Yi(e) {
  let t = (0, Xi.c)(16),
  ...
  if (o === `page`) {
    ...
    return (
      t[6] !== u || t[7] !== n
        ? ((r = (0, Q.jsx)(Vt, { variant: `page`, heading: u, description: e, children: n })),
          (t[6] = u),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
...
function Qi(e) {
  ...
  if (p === `dialog`) {
    ...
    t[15] !== g || t[16] !== f
      ...
      : (e = t[17]);
    let n;
    t[18] === e ? (n = t[19]) : ((n = (0, $.jsx)(Jt, { artworkSrc: e })), (t[18] = e), (t[19] = n));
    let r;
    return (
      t[20] !== y || t[21] !== n
        ? ((r = (0, $.jsxs)(`div`, {
  ...
  return (
    t[27] !== y || t[28] !== b || t[29] !== x
      ? ((S = (0, $.jsx)(qt, { artworkAlignment: b, artworkSrc: x, children: y })),
        (t[27] = y),
        (t[28] = b),
        (t[29] = x),
        (t[30] = S))
...
function $i(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, $.jsx)(qt, { children: (0, $.jsx)(Ui, { onManageConnections: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function ea(e) {
  ...
  switch (m) {
    ...
    case `connected`: {
      ...
      return (
        t[5] !== s || t[6] !== c || t[7] !== h
          ? ((e = (0, $.jsx)(ln, { onFinishSetup: s, onManageConnections: c, variant: h })),
            (t[5] = s),
            (t[6] = c),
            (t[7] = h),
            (t[8] = e))
...
function sa(e) {
  ...
  let b;
  t[1] !== _ || t[2] !== v || t[3] !== d
    ? ((b = ca(_, v, d)), (t[1] = _), (t[2] = v), (t[3] = d), (t[4] = b))
    : (b = t[4]);
  let x;
  t[5] === b
    ? (x = t[6])
    : ((x = (0, ua.jsx)(he, { className: `sr-only`, children: b })), (t[5] = b), (t[6] = x));
  let S;
  t[7] !== m || t[8] !== d
    ? ((S = (e) => {
        (A(m, g, { action: `continue_on_chatgpt`, step: d, surface: `dialog` }),
          Le({
            event: e,
  ...
  t[10] !== i || t[11] !== m || t[12] !== d
    ? ((C = () => {
        (A(m, g, { action: `finish_setup`, step: d, surface: `dialog` }), i(!1));
      }),
      (t[10] = i),
      (t[11] = m),
      (t[12] = d),
