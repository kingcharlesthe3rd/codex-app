...
import { At as De, at as Oe, kt as ke, ot as Ae } from "./app-initial~app-main~automations-page.js";
import {
  Ct as je,
  f as Me,
  gt as Ne,
...
function Vt(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = L(`flex w-full flex-col gap-2 text-center`, s)), (t[0] = s), (t[1] = c));
  let l =
      o === `dialog`
...
function Yt(e) {
  let t = (0, Xt.c)(6),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = L(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function Qt() {
  ...
  let l = pe(c).available,
    ...
    f = _(Ye),
    p;
  e[1] === t.query ? (p = e[2]) : ((p = t.query.snapshot(Ye)), (e[1] = t.query), (e[2] = p));
  let m = p,
    g;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((g = []), (e[3] = g)) : (g = e[3]);
  let y = _e(we, g),
    b;
  ...
  let N = v(ae),
    ...
    P;
  e[15] !== x || e[16] !== f.data?.enabled || e[17] !== re || e[18] !== D || e[19] !== N
    ? ((P = (e) => {
        if (x != null) {
...
function $t(e, t) {
  return c.isInternal(M()) ? (en(e, sn, t) ?? en(e, on, t) ?? en(e, an, t)) : en(e, an, t);
}
function en(e, t, n) {
...
function ln(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, K.jsx)(Re, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let d =
    ...
    f;
  t[4] === d ? (f = t[5]) : ((f = L(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = f));
  let p;
  ...
  let _ = i === `page` && `w-[256px]`,
    v;
  t[38] === _ ? (v = t[39]) : ((v = L(`justify-center`, _)), (t[38] = _), (t[39] = v));
  let y;
  ...
  t[41] !== n || t[42] !== v
    ? ((b = (0, K.jsx)(`div`, {
        ...
        children: (0, K.jsx)(P, { size: `large`, className: v, onClick: n, children: y }),
      })),
      (t[41] = n),
      (t[42] = v),
      (t[43] = b))
...
function dn(e) {
  ...
  t[11] === c
    ? (l = t[12])
    : ((l = L(`flex items-center justify-between gap-4 px-[14px] py-2 text-left`, c)),
      (t[11] = c),
      (t[12] = l));
  let u;
...
function Nr(e) {
  ...
  if (a || c === u) {
    ...
    t[7] === r
      ? (e = t[8])
      : ((e = L(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== v || t[10] !== d
  ...
  t[17] === r
    ? (y = t[18])
    : ((y = L(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = y));
  let b;
  t[19] === g
    ? (b = t[20])
    : ((b = (e) => {
...
function Ti(e) {
  ...
  if (p) {
    ...
    (t[27] === E.error
      ? (e = t[28])
      : ((e = (0, X.jsx)(Ii, { error: E.error })), (t[27] = E.error), (t[28] = e)),
      (I = e));
  } else if (f) {
    let e;
    (t[29] !== k || t[30] !== E.error || t[31] !== u
      ? ((e = (0, X.jsx)(ki, { error: E.error, manualPairingCode: k, size: u })),
        (t[29] = k),
        (t[30] = E.error),
        (t[31] = u),
        (t[32] = e))
  ...
  t[34] === fe
    ? (R = t[35])
    : ((R = L(`flex w-full flex-col items-center gap-4`, fe)), (t[34] = fe), (t[35] = R));
  let z;
  ...
  t[46] !== I || t[47] !== j
    ? ((_e = j
        ? (0, X.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: I })
        : I),
      (t[46] = I),
      (t[47] = j),
      (t[48] = _e))
            ...
            children: [
              ...
              (0, X.jsx)(ge, {
                ...
                children: (0, X.jsx)(P, {
                  ...
                  size: `icon`,
                  children: (0, X.jsx)(He, {
                    className: L(`icon-xs`, E.isFetching ? `animate-spin` : null),
                  }),
                }),
              }),
            ],
  ...
  t[62] !== V || t[63] !== _e || t[64] !== H || t[65] !== ve
    ...
    : (U = t[66]);
  let ye;
  t[67] === ne ? (ye = t[68]) : ((ye = ne ? (0, X.jsx)(Fi, {}) : null), (t[67] = ne), (t[68] = ye));
  let be;
  t[69] !== F || t[70] !== d || t[71] !== g || t[72] !== O || t[73] !== ce || t[74] !== m
    ? ((be =
        O?.pairingCode == null
          ? null
          : (0, X.jsxs)(me, {
...
function Oi(e) {
  let t = (0, Li.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, X.jsx)(k, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function Bi(e) {
  ...
  t[6] === f
    ? (p = t[7])
    : ((p = L(`flex flex-wrap items-center justify-center gap-3`, f)), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((m =
        o === `dialog`
  ...
  let h = o === `page` && `w-full`,
    g;
  t[12] === h ? (g = t[13]) : ((g = L(`justify-center`, h)), (t[12] = h), (t[13] = g));
  let _;
  ...
  t[15] !== r || t[16] !== a || t[17] !== g
    ? ((v = (0, Z.jsx)(P, { onClick: r, size: `large`, className: g, loading: a, children: _ })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = g),
      (t[18] = v))
...
function Hi(e) {
  ...
  t[3] === n
    ? (s = t[4])
    : ((s = (0, Z.jsx)(P, { size: `large`, className: `justify-center`, onClick: n, children: o })),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
...
function Wi(e) {
  let t = (0, qi.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = L(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(Ki, {
...
var qi,
  Z,
  Ji = e(() => {
    ((qi = f()), F(), U(), A(), Me(), T(), Be(), De(), Ee(), Wt(), Zt(), zi(), (Z = p()));
  });
function Yi(e) {
  let t = (0, Xi.c)(16),
...
function sa(e) {
  ...
  t[5] === b
    ? (x = t[6])
    : ((x = (0, ua.jsx)(te, { className: `sr-only`, children: b })), (t[5] = b), (t[6] = x));
  let S;
  t[7] !== g || t[8] !== p
    ? ((S = (e) => {
        (ve(g, Ce, { action: `continue_on_chatgpt`, step: p, surface: `dialog` }),
          ue({
            event: e,
  ...
  t[10] !== i || t[11] !== g || t[12] !== p
    ? ((C = () => {
        (ve(g, Ce, { action: `finish_setup`, step: p, surface: `dialog` }), i(!1));
      }),
      (t[10] = i),
      (t[11] = g),
      (t[12] = p),
