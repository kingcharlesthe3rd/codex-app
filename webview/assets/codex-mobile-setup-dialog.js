...
import { c as E, o as D } from "./lib.js";
import { Kn as O, o as k } from "./persisted-signal.js";
import { t as A } from "./clsx-Cir5-jBH.js";
import { t as j } from "./persisted-atom.js";
import { t as M } from "./button-DO-oxX3-.js";
import { a as ee, i as te } from "./setting-storage.js";
import { t as N } from "./use-reduced-motion-1.js";
...
import { i as z } from "./use-is-plugins-enabled.js";
import { m as B, y as V } from "./use-plugins.js";
import { t as H } from "./chrome.js";
import { d as U, l as W } from "./dialog-layout.js";
import { o as G } from "./bundled-plugin-auto-install-preference.js";
import { t as ae } from "./data-url-from-svg.js";
import { m as oe } from "./links.js";
...
var ye = j(`electron:codex-mobile-setup-step-debug-override`, `auto`),
  be = 100,
...
function Ke(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = A(`flex w-full flex-col gap-2 text-center`, s)), (t[0] = s), (t[1] = c));
  let l =
      o === `dialog`
...
function Xe(e) {
  let t = (0, Q.c)(6),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = A(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function tt() {
  ...
  let c = z(o).available,
    d = ee(S.keepRemoteControlAwakeWhilePluggedIn),
    f = a(ue, p),
    m = l(he),
    h;
  ...
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = { hostId: p }), (e[10] = E))
    : (E = e[10]);
  let { pendingPluginId: D, setPluginEnabled: O } = ge(E),
    k;
  e[11] === y.forceReload
    ? (k = e[12])
    : ((k = { forceReloadPlugins: y.forceReload, hostId: p }),
      (e[11] = y.forceReload),
      (e[12] = k));
  let {
      closePluginInstall: A,
      connectRequiredApp: j,
      handleRequiredAppConnected: M,
      handleRequiredAppOAuthStarted: N,
      installPlugin: ne,
      isInstalling: re,
      openPluginInstall: P,
      session: F,
  ...
  e[13] === g
    ...
    : ((I = {
      ...
      (e[14] = I));
  let L = _(I),
    V = n === `macOS` && C && f && m.data?.enabled != null,
    H;
  e[15] !== x || e[16] !== m.data?.enabled || e[17] !== P || e[18] !== O || e[19] !== L
    ? ((H = (e) => {
        if (x != null) {
          ...
          if (!e && m.data?.enabled) {
            L.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && O({ enabled: !1, pluginDisplayName: G(x), pluginId: x.plugin.id });
              },
            });
            return;
          }
          O({ enabled: e, pluginDisplayName: G(x), pluginId: x.plugin.id });
        }
      }),
      (e[15] = x),
      (e[16] = m.data?.enabled),
  ...
  e[21] !== T || e[22] !== P || e[23] !== O
    ? ((W = (e) => {
        if (T != null) {
          ...
          O({ enabled: e, pluginDisplayName: G(T), pluginId: T.plugin.id });
        }
      }),
      (e[21] = T),
      (e[22] = P),
    ...
    : (W = e[24]);
  let ae = W,
    oe = T?.plugin.installed === !0 && T.plugin.enabled,
    se = y.isLoading || T == null || re || D === T.plugin.id,
    ce = y.isLoading || x == null || re || L.isPending || D === x.plugin.id,
    fe = d ?? !1,
    K = m.data?.enabled ?? !1,
  ...
  e[25] === t
    ? (q = e[26])
    : ((q = (e) => {
        te(t, S.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = q));
  let J;
  ...
  e[37] !== Y
    ? ((ve = (0, Z.jsx)(le, {
        hostId: p,
        isInstalling: re,
        onConnectRequiredApp: j,
        onInstall: ne,
        onRequiredAppConnected: M,
        onRequiredAppOAuthStarted: N,
        onOpenChange: Y,
        session: F,
      })),
      (e[31] = j),
  ...
  return (
    ...
    e[53] !== ve
      ? ((ye = {
          ...
          onChromeExtensionEnabledChange: ae,
          onComputerUseEnabledChange: U,
...
function nt(e, t) {
  return T.isInternal(V()) ? (rt(e, et, t) ?? rt(e, $e, t) ?? rt(e, Qe, t)) : rt(e, Qe, t);
}
function rt(e, t, n) {
...
function it(e) {
  ...
  let d =
    ...
    f;
  t[4] === d ? (f = t[5]) : ((f = A(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = f));
  let p;
  ...
  let _ = i === `page` && `w-[256px]`,
    v;
  t[38] === _ ? (v = t[39]) : ((v = A(`justify-center`, _)), (t[38] = _), (t[39] = v));
  let y;
  ...
  t[41] !== n || t[42] !== v
    ? ((b = (0, Z.jsx)(`div`, {
        ...
        children: (0, Z.jsx)(M, { size: `large`, className: v, onClick: n, children: y }),
      })),
      (t[41] = n),
      (t[42] = v),
      (t[43] = b))
...
function ot(e) {
  ...
  t[11] === c
    ? (l = t[12])
    : ((l = A(`flex items-center justify-between gap-4 px-[14px] py-2 text-left`, c)),
      (t[11] = c),
      (t[12] = l));
  let u;
...
var ct = 3e4,
  ...
  dt = `2055603567`,
  ft = [`remote-control-server-pairing`],
  pt = c(u, () => ({
  ...
  vt = o(
    ...
    ({ hostId: e, openId: t }, { get: n, scope: r }) => ({
      ...
      staleTime: (e) => {
        ...
        return t == null ? 0 : Math.max(0, yt(t) - e.state.dataUpdatedAt);
      },
      refetchInterval: (e) => {
        let t = e.state.data?.expiresAt;
        return t == null || e.state.fetchStatus === `fetching` || e.state.error != null
          ? !1
          : Math.max(1, yt(t) - Date.now() - lt);
      },
    }),
...
var en = 760,
  ...
  rn = `180ms`;
function an(e, t, n) {
  ((e.style.transitionDuration = n ? `0ms` : rn),
    (e.style.fill = $t(t)),
...
function sn({ onArtworkReady: e, svgMarkup: t }) {
  let n = N(),
    r = (0, X.useRef)(null),
    i = (0, X.useRef)(null),
    a = (0, X.useRef)([]),
    ...
    u = (0, X.useCallback)((e) => {
      ...
      for (let r of a.current) {
        let i = (o.current.get(r.node) ?? 0) * nn;
        ...
        an(r.node, Math.max(o.current.get(r.node) ?? 0, a), a > 0);
      }
      ...
      (e) => {
        ...
        for (let e of a.current) {
          let t = Qt(Math.hypot(e.x - s.x, e.y - s.y)),
            ...
            r = Math.max(n, t);
          r > n && (o.current.set(e.node, r), on(e.node, r), (c = !0));
        }
        c && d();
      },
      [d, n],
...
function cn(e) {
  ...
  t[0] !== i || t[1] !== n
    ...
    : (a = t[2]);
  let { paintDots: o, rootRef: s, svgMarkup: c, triggerRipple: l } = sn(a),
    u,
    d;
  (t[3] === l
    ? ((u = t[4]), (d = t[5]))
...
var ln = `` + new URL(`codex-home-hero-dark-still-43PvFxTG.png`, import.meta.url).href,
  un = `` + new URL(`codex-home-hero-dark-_BGDEdk8.mp4`, import.meta.url).href,
  dn = `` + new URL(`codex-home-hero-light-still-CQ7cy4qg.png`, import.meta.url).href,
  fn = `` + new URL(`codex-home-hero-light-Cyip34F2.mp4`, import.meta.url).href,
  pn = `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
  mn = { dark: { stillSrc: ln, videoSrc: un }, light: { stillSrc: dn, videoSrc: fn } },
  hn = `url(${ae(pn)})`,
  gn = {
    maskImage: hn,
    maskMode: `alpha`,
...
function _n(e) {
  ...
  t[1] !== a || t[2] !== u || t[3] !== c
    ? ((h = () => {
        if (a || c === u) return;
        let e = o.current;
        e != null && e.paused && ((e.currentTime = 0), e.play()?.catch(vn));
      }),
      (t[1] = a),
      (t[2] = u),
      (t[3] = c),
  ...
  t[5] === r
    ? (_ = t[6])
    : ((_ = A(`size-full shrink-0 object-contain`, r)), (t[5] = r), (t[6] = _));
  let v = _;
  if (a || c === u) {
    let e;
    t[7] === r
      ? (e = t[8])
      : ((e = A(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== v || t[10] !== d
  ...
  t[17] === r
    ? (y = t[18])
    : ((y = A(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = y));
  let b;
  t[19] === g
    ? (b = t[20])
    : ((b = (e) => {
...
function kn(e) {
  ...
  if (i != null) {
    ...
    return (
      t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== s
        ? ((e = (0, Z.jsx)(An, { ariaLabel: n, centerLogoAriaLabel: r, pairingCode: i, size: s })),
          (t[0] = n),
          (t[1] = r),
          (t[2] = i),
          (t[3] = s),
  ...
  return (
    t[5] !== n || t[6] !== r || t[7] !== a || t[8] !== s
      ? ((c = (0, Z.jsx)(jn, { ariaLabel: n, centerLogoAriaLabel: r, platform: a, size: s })),
        (t[5] = n),
        (t[6] = r),
        (t[7] = a),
        (t[8] = s),
...
function jn(e) {
  ...
  if (i === `android`) {
    ...
    return (
      t[0] !== n || t[1] !== o
        ? ((e = (0, Z.jsx)(Mn, { ariaLabel: n, size: o })), (t[0] = n), (t[1] = o), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== o
      ? ((s = (0, Z.jsx)(Nn, { ariaLabel: n, centerLogoAriaLabel: r, size: o })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s))
...
function Mn(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = A(`relative overflow-hidden bg-token-main-surface-primary`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(`div`, {
        ...
        dangerouslySetInnerHTML: { __html: Jt },
      })),
      (t[2] = o))
    : (o = t[2]);
  let s;
...
function Pn(e) {
  ...
  t[1] === u
    ? (d = t[2])
    : ((d = A(`relative overflow-hidden bg-token-main-surface-primary`, u)),
      (t[1] = u),
      (t[2] = d));
  let f;
  t[3] === i
  ...
  t[5] === a
    ? (p = t[6])
    : ((p = (0, Z.jsx)(cn, { ref: s, onArtworkReady: l, svgMarkup: a })), (t[5] = a), (t[6] = p));
  let m = o === `compact` ? `w-10` : `w-14`,
    h;
  t[7] === m
    ? (h = t[8])
    : ((h = A(`pointer-events-auto aspect-square`, m)), (t[7] = m), (t[8] = h));
  let g;
  t[9] !== r || t[10] !== h
    ? ((g = (0, Z.jsx)(`div`, {
        className: `pointer-events-none absolute inset-0 z-20 grid place-items-center`,
        children: (0, Z.jsx)(_n, { ariaLabel: r, className: h, onClick: l }),
      })),
      (t[9] = r),
      (t[10] = h),
      (t[11] = g))
...
function Fn(e) {
  let t = (0, Sn.create)(e, { errorCorrectionLevel: `H` }).modules,
    n = Cn / (t.size + Dn * 2);
  return { cornersMarkup: Ln(t.size, n), dotsMarkup: In(t, n) };
}
function In(e, t) {
  let n = [];
  for (let r = 0; r < e.size; r += 1)
    for (let i = 0; i < e.size; i += 1)
      !Gn(e, r, i) || Kn(e.size, r, i) || Wn(e.size, t, r, i) || n.push(zn(i, t, r));
  return Vn(n.join(``));
}
function Ln(e, t) {
  return Vn([Rn(0, 0, t), Rn(e - En, 0, t), Rn(0, e - En, t)].join(``));
}
function Rn(e, t, n) {
  let r = Un(e, n),
    i = Un(t, n),
    ...
    o = n,
    s = n * 2;
  return `<path fill-rule="evenodd" clip-rule="evenodd" d="${Bn(r, i, a, n * 1.6)} ${Bn(r + o, i + o, a - o * 2, n)}" fill="currentColor"/><rect x="${$(r + s)}" y="${$(i + s)}" width="${$(a - s * 2)}" height="${$(a - s * 2)}" rx="${$(n)}" fill="currentColor"/>`;
}
function zn(e, t, n) {
  let r = t * Tn,
    i = Hn(e, t),
...
function Vn(e) {
  return `<svg width="${Cn}" height="${Cn}" viewBox="0 0 ${Cn} ${Cn}" fill="none" xmlns="${On}">${e}</svg>`;
}
function Hn(e, t) {
  return Un(e, t) + t / 2;
}
...
function Kn(e, t, n) {
  return qn(t, n, 0, 0) || qn(t, n, 0, e - En) || qn(t, n, e - En, 0);
}
function qn(e, t, n, r) {
  return e >= n && e < n + En && t >= r && t < r + En;
}
function Jn(e) {
  return e % 2 == 0 ? e + 1 : e;
}
...
function Yn(e) {
  let t = (0, Q.c)(63),
    ...
    d = E(),
    f = ie(dt),
    [m, h] = (0, X.useState)(`ios`),
    [g, _] = (0, X.useState)(`phone`),
    v = l ? (n ?? g) : `phone`,
    [y] = (0, X.useState)(Xn),
    b;
  t[0] !== c || t[1] !== y
    ? ((b = { hostId: c, openId: y }), (t[0] = c), (t[1] = y), (t[2] = b))
    : (b = t[2]);
  let x = a(vt, b),
    S = f && x.error == null ? (x.data ?? null) : null,
    C = f && S == null && (x.error == null || x.isFetching),
    w = !f || S?.pairingCode != null,
    T = v === `phone` && !f,
    O = f && v === `computer` && !C,
    k;
  t[3] !== n || t[4] !== i
  ...
  if (C) {
    ...
    let r = S?.pairingCode,
      i;
    (t[16] !== m || t[17] !== u || t[18] !== e || t[19] !== n || t[20] !== r
      ? ((i = (0, Z.jsx)(kn, {
          ariaLabel: e,
    ...
    (t[22] === x.error
      ? (e = t[23])
      : ((e = (0, Z.jsx)(or, { error: x.error })), (t[22] = x.error), (t[23] = e)),
      (N = e));
  } else if (f) {
    let e = S?.manualPairingCode ?? null,
      n;
    (t[24] !== x.error || t[25] !== u || t[26] !== e
      ? ((n = (0, Z.jsx)($n, { error: x.error, manualPairingCode: e, size: u })),
        (t[24] = x.error),
        (t[25] = u),
        (t[26] = e),
        (t[27] = n))
  ...
  let ne = u === `compact` ? null : `mt-3`,
    P;
  t[29] === ne
    ? (P = t[30])
    : ((P = A(`flex w-full flex-col items-center gap-4`, ne)), (t[29] = ne), (t[30] = P));
  let F;
  t[31] !== d || t[32] !== j || t[33] !== v || t[34] !== l
    ? ((F = l
        ? (0, Z.jsx)(`div`, {
      ...
      (t[35] = F))
    : (F = t[35]);
  let I = u === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    L = T ? null : `justify-center`,
    R =
      v === `computer`
        ? u === `compact`
  ...
  t[40] !== N || t[41] !== T
    ? ((B = T
        ? (0, Z.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: N })
        : N),
      (t[40] = N),
      (t[41] = T),
      (t[42] = B))
    ...
    ? ((H = f
        ? (0, Z.jsx)(re, {
            ...
            children: (0, Z.jsx)(M, {
              ...
              size: `icon`,
              children: (0, Z.jsx)(pe, {
                className: A(`icon-xs`, x.isFetching ? `animate-spin` : null),
              }),
            }),
          })
        : null),
  ...
  t[51] !== z || t[52] !== B || t[53] !== V || t[54] !== H
    ...
    : (U = t[55]);
  let W;
  t[56] === O ? (W = t[57]) : ((W = O ? (0, Z.jsx)(ar, {}) : null), (t[56] = O), (t[57] = W));
  let G;
  return (
    t[58] !== U || t[59] !== W || t[60] !== P || t[61] !== F
      ? ((G = (0, Z.jsxs)(`div`, { className: P, children: [F, U, W] })),
        (t[58] = U),
        (t[59] = W),
        (t[60] = P),
        (t[61] = F),
...
function Qn(e) {
  let t = (0, Q.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(ne, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function sr(e) {
  let t = (0, Q.c)(34),
    ...
    { platform: s } = R(),
    c;
  t[0] !== s || t[1] !== o ? ((c = fr(o, s)), (t[0] = s), (t[1] = o), (t[2] = c)) : (c = t[2]);
  let l = c,
    u;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[3]);
  let d;
  t[4] === o ? (d = t[5]) : ((d = (0, Z.jsx)(dr, { variant: o })), (t[4] = o), (t[5] = d));
  let f = o === `page` && `w-full max-w-[400px]`,
    p;
  t[6] === f
    ? (p = t[7])
    : ((p = A(`flex flex-wrap items-center justify-center gap-3`, f)), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((m =
        o === `dialog`
  ...
  let h = o === `page` && `w-full`,
    g;
  t[12] === h ? (g = t[13]) : ((g = A(`justify-center`, h)), (t[12] = h), (t[13] = g));
  let _;
  ...
  t[15] !== r || t[16] !== a || t[17] !== g
    ? ((v = (0, Z.jsx)(M, { onClick: r, size: `large`, className: g, loading: a, children: _ })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = g),
      (t[18] = v))
...
function lr(e) {
  ...
  t[3] === n
    ? (s = t[4])
    : ((s = (0, Z.jsx)(M, { size: `large`, className: `justify-center`, onClick: n, children: o })),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
...
function ur(e) {
  ...
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(Yn, { showDeviceTypeSelector: !1 })), (t[2] = a))
    : (a = t[2]);
  let o;
  return (
    t[3] === n
...
function dr(e) {
  let t = (0, Q.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = A(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(pr, {
...
function mr(e) {
  ...
  if (o === `page`) {
    ...
    t[4] === s
      ...
      : ((n = (0, Z.jsx)(`div`, {
          className: `flex w-full max-w-[460px] flex-col items-center gap-6`,
          children: (0, Z.jsx)(Yn, { hostId: s, showDeviceTypeSelector: !1 }),
        })),
        (t[4] = s),
        (t[5] = n));
    let r;
...
function hr(e) {
  ...
  let b;
  t[23] === f ? (b = t[24]) : ((b = br(f)), (t[23] = f), (t[24] = b));
  let x;
  t[25] === f ? (x = t[26]) : ((x = yr(f)), (t[25] = f), (t[26] = x));
  let S;
  return (
...
function gr(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Z.jsx)(Je, { children: (0, Z.jsx)(ur, { onManageConnections: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function _r(e) {
  ...
  switch (m) {
    ...
    case `mfa-required`: {
      ...
      return (
        t[15] !== o || t[16] !== h
          ? ((e = (0, Z.jsx)(lr, { onContinueOnChatGPT: o, variant: h })),
            (t[15] = o),
            (t[16] = h),
            (t[17] = e))
          : (e = t[17]),
...
function xr(e) {
  ...
  let x;
  t[1] !== v || t[2] !== y || t[3] !== p
    ? ((x = Sr(v, y, p)), (t[1] = v), (t[2] = y), (t[3] = p), (t[4] = x))
    : (x = t[4]);
  let S;
  t[5] === x
    ? (S = t[6])
    : ((S = (0, Z.jsx)(U, { className: `sr-only`, children: x })), (t[5] = x), (t[6] = S));
  let C;
  t[7] !== _ || t[8] !== p
    ? ((C = () => {
        (k(_, O, { action: `continue_on_chatgpt`, step: p, surface: `dialog` }),
  ...
  t[10] !== i || t[11] !== _ || t[12] !== p
    ? ((w = () => {
        (k(_, O, { action: `finish_setup`, step: p, surface: `dialog` }), i(!1));
      }),
      (t[10] = i),
      (t[11] = _),
      (t[12] = p),
