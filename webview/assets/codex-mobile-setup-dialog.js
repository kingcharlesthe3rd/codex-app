...
import { R as i, a, f as o, o as s, p as c, s as l, t as u } from "./app-scope.js";
import { An as d, Pn as f, ds as p, js as m } from "./app-server-manager-signals.js";
import { c as h, f as g, g as _, u as v } from "./vscode-api.js";
import { t as y } from "./queryOptions.js";
import { $n as b, Qn as x, T as S, Vi as C, Zi as w, gr as T } from "./src-1.js";
import { c as ee, o as E } from "./lib.js";
import { Kn as D, o as O } from "./persisted-signal.js";
import { t as k } from "./clsx-Cir5-jBH.js";
import { t as A } from "./persisted-atom.js";
import { t as j } from "./button-DO-oxX3-.js";
import { a as te, i as ne } from "./setting-storage.js";
import { t as M } from "./use-reduced-motion-1.js";
import { t as N } from "./spinner.js";
import { t as re } from "./tooltip.js";
import { f as P, o as ie } from "./statsig.js";
...
import { i as ae } from "./use-is-plugins-enabled.js";
import { m as oe, y as z } from "./use-plugins.js";
import { t as B } from "./chrome.js";
import { d as V, l as H } from "./dialog-layout.js";
import { o as U } from "./bundled-plugin-auto-install-preference.js";
import { t as W } from "./data-url-from-svg.js";
import { m as G } from "./links.js";
import { t as se } from "./check-circle.js";
import { t as ce } from "./phone.js";
import { n as le, p as ue, t as de } from "./use-plugin-install-flow.js";
import { s as fe } from "./check-plugin-availability.js";
import { t as K } from "./toggle.js";
import { t as pe } from "./regenerate.js";
import { o as me, r as he } from "./computer-use-app-approvals-query.js";
import { r as ge } from "./plugins-availability.js";
import { t as q } from "./sun.js";
import { t as J } from "./chatgpt-token-auth.browser.js";
import { t as _e } from "./use-home-directory.js";
import { t as Y } from "./cursor.js";
import { t as ve } from "./segmented-toggle.js";
var ye = A(`electron:codex-mobile-setup-step-debug-override`, `auto`),
  be = 100,
  xe = w({ mfa_enabled_v2: C() }),
  Se = class extends Error {},
  Ce = class extends Error {},
  we = class extends Error {};
async function Te({ clientId: e }) {
  await Me(() =>
    F.safeDelete(`/wham/remote/control/clients/{client_id}`, {
      parameters: { path: { client_id: e } },
    }),
  );
}
async function Ee() {
  return (await Me(() => F.safeGet(`/wham/remote/control/mfa_requirement`))).requirement;
}
async function De() {
  return xe.parse(await F.safeGet(`/accounts/mfa_info`)).mfa_enabled_v2;
}
async function Oe(e = null) {
  let t = await Me(() =>
    F.safeGet(`/wham/remote/control/clients`, { parameters: { query: { cursor: e, limit: be } } }),
  );
  return t.items.some(je) ? !0 : t.cursor == null ? !1 : Oe(t.cursor);
}
async function ke() {
  return Ae(null);
}
async function Ae(e) {
  let t = await Me(() =>
      F.safeGet(`/wham/remote/control/clients`, {
        parameters: { query: { cursor: e, limit: be } },
      }),
    ),
    n = t.items.filter(je);
  return t.cursor == null ? n : n.concat(await Ae(t.cursor));
}
function je(e) {
...
async function Me(e) {
  try {
    ...
    throw e instanceof h
      ? e.status === 404
        ? new Ce()
        : e.status === 403
          ? new we(e.message)
          : e.status === 401
            ? (J(), new Se(`ChatGPT auth is required to load remote control environments.`))
            : Error(`Remote control request failed (${e.status}): ${e.message}`)
      : e;
  }
}
var Ne = `` + new URL(`dialog-artwork-allow-host-B0bcIhDi.png`, import.meta.url).href,
  Pe = `` + new URL(`dialog-artwork-connected-NZKCls7p.png`, import.meta.url).href,
  Fe = `` + new URL(`dialog-artwork-initial-DMDAvEM7.png`, import.meta.url).href,
  Ie = `` + new URL(`dialog-artwork-mfa-e9Fx75-r.png`, import.meta.url).href,
  Le = `` + new URL(`dialog-artwork-waiting-computer-BPIs9eKV.png`, import.meta.url).href,
  Re = `` + new URL(`dialog-artwork-waiting-phone-UTYmfLHs.png`, import.meta.url).href,
  ze = `` + new URL(`page-artwork-allow-host-CPm7eJR2.png`, import.meta.url).href,
  Be = `` + new URL(`page-artwork-mfa-e6UxOdqq.png`, import.meta.url).href,
  Ve = `` + new URL(`page-artwork-waiting-pzj85BPm.png`, import.meta.url).href,
  He = `` + new URL(`page-artwork-shared-Dv_GQL_j.png`, import.meta.url).href,
  X = e(n()),
  Z = r(),
  Ue = (e) =>
    (0, Z.jsxs)(`svg`, {
...
function Ke(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = k(`flex w-full flex-col gap-2 text-center`, s)), (t[0] = s), (t[1] = c));
  let l =
      o === `dialog`
...
var qe = `` + new URL(`page-artwork-background-DPNBzfAy.png`, import.meta.url).href;
function Je(e) {
  let t = (0, Q.c)(13),
...
function Xe(e) {
  let t = (0, Q.c)(6),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = k(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function tt() {
  let e = (0, Q.c)(55),
    ...
    i = ie(`410065390`),
    o;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = { hostId: p }), (e[0] = o)) : (o = e[0]);
  let c = ae(o).available,
    d = te(S.keepRemoteControlAwakeWhilePluggedIn),
    f = a(ue, p),
    m = l(he),
    h;
  e[1] === t.query ? (h = e[2]) : ((h = t.query.snapshot(he)), (e[1] = t.query), (e[2] = h));
  let g = h,
    v;
  ...
  e[4] !== r || e[5] !== y.availablePlugins
    ? ((b = rt(y.availablePlugins, Ze, r)), (e[4] = r), (e[5] = y.availablePlugins), (e[6] = b))
    : (b = e[6]);
  let x = b,
    C = x?.plugin.installed === !0 && x.plugin.enabled,
    w;
  e[7] !== r || e[8] !== y.availablePlugins
    ? ((w = nt(y.availablePlugins, r)), (e[7] = r), (e[8] = y.availablePlugins), (e[9] = w))
    : (w = e[9]);
  let T = w,
    ee;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = { hostId: p }), (e[10] = ee))
    : (ee = e[10]);
  let { pendingPluginId: E, setPluginEnabled: D } = ge(ee),
    O;
  e[11] === y.forceReload
    ? (O = e[12])
    : ((O = { forceReloadPlugins: y.forceReload, hostId: p }),
      (e[11] = y.forceReload),
      (e[12] = O));
  let {
  ...
  e[13] === g
    ...
    : ((I = {
      ...
      (e[14] = I));
  let L = _(I),
    z = n === `macOS` && C && f && m.data?.enabled != null,
    B;
  e[15] !== x || e[16] !== m.data?.enabled || e[17] !== P || e[18] !== D || e[19] !== L
    ? ((B = (e) => {
        if (x != null) {
          ...
          if (!e && m.data?.enabled) {
            L.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && D({ enabled: !1, pluginDisplayName: U(x), pluginId: x.plugin.id });
              },
            });
            return;
          }
          D({ enabled: e, pluginDisplayName: U(x), pluginId: x.plugin.id });
        }
      }),
      (e[15] = x),
      (e[16] = m.data?.enabled),
  ...
  e[21] !== T || e[22] !== P || e[23] !== D
    ? ((H = (e) => {
        if (T != null) {
          ...
          D({ enabled: e, pluginDisplayName: U(T), pluginId: T.plugin.id });
        }
      }),
      (e[21] = T),
      (e[22] = P),
    ...
    : (H = e[24]);
  let W = H,
    G = T?.plugin.installed === !0 && T.plugin.enabled,
    se = y.isLoading || T == null || re || E === T.plugin.id,
    ce = y.isLoading || x == null || re || L.isPending || E === x.plugin.id,
    fe = d ?? !1,
    K = m.data?.enabled ?? !1,
    pe = !C || m.isLoading || L.isPending,
    q;
  e[25] === t
    ? (q = e[26])
    : ((q = (e) => {
        ne(t, S.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = q));
  let J;
  ...
  return (
    ...
    e[53] !== ve
      ? ((ye = {
          chromeExtensionEnabled: G,
          chromeExtensionToggleDisabled: se,
          computerUseEnabled: C,
          computerUseToggleDisabled: ce,
          keepComputerAwake: fe,
          keepComputerAwakeToggleDisabled: !1,
          lockedComputerUseEnabled: K,
          lockedComputerUseToggleDisabled: pe,
          onChromeExtensionEnabledChange: W,
          onComputerUseEnabledChange: V,
          onKeepComputerAwakeChange: q,
          onLockedComputerUseEnabledChange: J,
          pluginInstallModal: ve,
          showChromeExtensionSetup: i,
          showComputerUseSetup: c,
          showKeepComputerAwake: !0,
          showLockedComputerUse: z,
        }),
        (e[39] = C),
        (e[40] = W),
        (e[41] = V),
...
function nt(e, t) {
  return T.isInternal(z()) ? (rt(e, et, t) ?? rt(e, $e, t) ?? rt(e, Qe, t)) : rt(e, Qe, t);
}
function rt(e, t, n) {
  ...
  return (
    ...
    r.find((e) => b(e.marketplaceName)) ??
    r.find((e) => e.marketplaceName === `openai-curated`) ??
    r.find((e) => fe(n, e.marketplacePath)) ??
    null
  );
}
function it(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, Z.jsx)(se, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let d =
    ...
    f;
  t[4] === d ? (f = t[5]) : ((f = k(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = f));
  let p;
    ...
    ? ((m =
        s.showComputerUseSetup && s.showLockedComputerUse
          ...
          : s.showComputerUseSetup
            ? (0, Z.jsx)(ot, {
                icon: (0, Z.jsx)(We, { className: `icon-base` }),
                variant: i,
                title: (0, Z.jsx)(E, {
  ...
  t[31] !== i
    ? ((h = s.showChromeExtensionSetup
        ? (0, Z.jsx)(ot, {
            icon: (0, Z.jsx)(B, { className: `icon-base` }),
            variant: i,
            title: (0, Z.jsx)(E, {
  ...
  t[33] !== f || t[34] !== p || t[35] !== m || t[36] !== h
    ? ((g = (0, Z.jsxs)(`div`, { className: f, children: [p, m, h] })),
      (t[33] = f),
      (t[34] = p),
      (t[35] = m),
      (t[36] = h),
  ...
  let _ = i === `page` && `w-[256px]`,
    v;
  t[38] === _ ? (v = t[39]) : ((v = k(`justify-center`, _)), (t[38] = _), (t[39] = v));
  let y;
  ...
  t[41] !== n || t[42] !== v
    ? ((b = (0, Z.jsx)(`div`, {
        ...
        children: (0, Z.jsx)(j, { size: `large`, className: v, onClick: n, children: y }),
      })),
      (t[41] = n),
      (t[42] = v),
      (t[43] = b))
  ...
  t[44] !== r || t[45] !== i
    ? ((x =
        i === `page` && r != null
          ? (0, Z.jsx)(Xe, { className: `w-[256px]`, onManageConnections: r })
          : null),
      (t[44] = r),
      (t[45] = i),
      (t[46] = x))
  ...
  return (
    t[55] !== s.pluginInstallModal || t[56] !== C
      ? ((w = (0, Z.jsxs)(Z.Fragment, { children: [C, s.pluginInstallModal] })),
...
function ot(e) {
  ...
  if (i != null) {
    ...
    t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== o
      ? ((l = (0, Z.jsx)(st, { description: n, icon: r, title: a, trailing: o })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o),
  ...
  t[11] === c
    ? (l = t[12])
    : ((l = k(`flex items-center justify-between gap-4 px-[14px] py-2 text-left`, c)),
      (t[11] = c),
      (t[12] = l));
  let u;
  t[13] !== n || t[14] !== r || t[15] !== a || t[16] !== o
    ? ((u = (0, Z.jsx)(st, { description: n, icon: r, title: a, trailing: o })),
      (t[13] = n),
      (t[14] = r),
      (t[15] = a),
      (t[16] = o),
...
var ct = 3e4,
  lt = 6e4,
  ut = [`codex-mobile-mfa-setup-required`],
  dt = `2055603567`,
  ft = `3936985709`,
  pt = [`remote-control-server-pairing`],
  mt = c(u, () => ({
...
async function _t(e) {
  let t = e.query.snapshot(mt);
  if ((await t.invalidate({ exact: !0, refetchType: `none` }), (await t.fetch()) !== `required`))
    return !1;
  let n = e.query.snapshot(ht);
  return (await n.invalidate({ exact: !0, refetchType: `none` }), !(await n.fetch()));
}
var vt = c(u, ({ get: e }) => ({
    enabled: e(d, p),
  ...
  yt = o(
    ...
    ({ hostId: e, openId: t }, { get: n, scope: r }) => ({
      enabled: n(P, `2055603567`) && !n(P, `3936985709`) && n(d, e),
      queryKey: [...pt, e, t],
      queryFn: async () => (
        await f(r, e),
        m(`start-remote-control-pairing-for-host`, { hostId: e, manualCode: !0 })
      ),
      retry: !1,
      gcTime: 0,
      staleTime: (e) => {
        let t = e.state.data?.expiresAt;
        return t == null ? 0 : Math.max(0, bt(t) - e.state.dataUpdatedAt);
      },
      refetchInterval: (e) => {
        let t = e.state.data?.expiresAt;
        return t == null || e.state.fetchStatus === `fetching` || e.state.error != null
          ? !1
          : Math.max(1, bt(t) - Date.now() - lt);
      },
    }),
...
var tn = 760,
  ...
  an = `180ms`;
function on(e, t, n) {
  ((e.style.transitionDuration = n ? `0ms` : an),
    (e.style.fill = en(t)),
...
function cn({ onArtworkReady: e, svgMarkup: t }) {
  let n = M(),
    r = (0, X.useRef)(null),
    i = (0, X.useRef)(null),
    a = (0, X.useRef)([]),
    ...
    u = (0, X.useCallback)((e) => {
      ...
      for (let r of a.current) {
        let i = (o.current.get(r.node) ?? 0) * rn;
        ...
        on(r.node, Math.max(o.current.get(r.node) ?? 0, a), a > 0);
      }
    ...
    paintDots: (0, X.useCallback)(
      (e) => {
        ...
        let s = r.matrixTransform(t.getScreenCTM()?.inverse()),
          c = !1;
        for (let e of a.current) {
          let t = $t(Math.hypot(e.x - s.x, e.y - s.y)),
            n = o.current.get(e.node) ?? 0,
            r = Math.max(n, t);
          r > n && (o.current.set(e.node, r), sn(e.node, r), (c = !0));
        }
        c && d();
      },
      [d, n],
...
function ln(e) {
  ...
  t[0] !== i || t[1] !== n
    ...
    : (a = t[2]);
  let { paintDots: o, rootRef: s, svgMarkup: c, triggerRipple: l } = cn(a),
    u,
    d;
  (t[3] === l
    ? ((u = t[4]), (d = t[5]))
...
var un = `` + new URL(`codex-home-hero-dark-still-43PvFxTG.png`, import.meta.url).href,
  dn = `` + new URL(`codex-home-hero-dark-_BGDEdk8.mp4`, import.meta.url).href,
  fn = `` + new URL(`codex-home-hero-light-still-CQ7cy4qg.png`, import.meta.url).href,
  pn = `` + new URL(`codex-home-hero-light-Cyip34F2.mp4`, import.meta.url).href,
  mn = `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
  hn = { dark: { stillSrc: un, videoSrc: dn }, light: { stillSrc: fn, videoSrc: pn } },
  gn = `url(${W(mn)})`,
  _n = {
    maskImage: gn,
    maskMode: `alpha`,
...
function vn(e) {
  ...
  t[1] !== a || t[2] !== u || t[3] !== c
    ? ((h = () => {
        if (a || c === u) return;
        let e = o.current;
        e != null && e.paused && ((e.currentTime = 0), e.play()?.catch(yn));
      }),
      (t[1] = a),
      (t[2] = u),
      (t[3] = c),
  ...
  t[5] === r
    ? (_ = t[6])
    : ((_ = k(`size-full shrink-0 object-contain`, r)), (t[5] = r), (t[6] = _));
  let v = _;
  if (a || c === u) {
    let e;
    t[7] === r
      ? (e = t[8])
      : ((e = k(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== v || t[10] !== d
      ? ((a = (0, Z.jsx)(`img`, { alt: ``, "aria-hidden": `true`, className: v, src: d })),
        (t[9] = v),
        (t[10] = d),
        (t[11] = a))
      : (a = t[11]);
  ...
  t[17] === r
    ? (y = t[18])
    : ((y = k(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = y));
  let b;
  t[19] === g
    ? (b = t[20])
    : ((b = (e) => {
  ...
  t[21] === u
    ...
    : ((x = () => {
      ...
      (t[22] = x));
  let S;
  t[23] !== v || t[24] !== d || t[25] !== b || t[26] !== x || t[27] !== u || t[28] !== f
    ? ((S = (0, Z.jsx)(
        `video`,
        {
          ref: o,
...
function An(e) {
  ...
  if (i != null) {
    ...
    return (
      t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== s
        ? ((e = (0, Z.jsx)(jn, { ariaLabel: n, centerLogoAriaLabel: r, pairingCode: i, size: s })),
          (t[0] = n),
          (t[1] = r),
          (t[2] = i),
          (t[3] = s),
  ...
  return (
    t[5] !== n || t[6] !== r || t[7] !== a || t[8] !== s
      ? ((c = (0, Z.jsx)(Mn, { ariaLabel: n, centerLogoAriaLabel: r, platform: a, size: s })),
        (t[5] = n),
        (t[6] = r),
        (t[7] = a),
        (t[8] = s),
...
function Mn(e) {
  ...
  if (i === `android`) {
    ...
    return (
      t[0] !== n || t[1] !== o
        ? ((e = (0, Z.jsx)(Nn, { ariaLabel: n, size: o })), (t[0] = n), (t[1] = o), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== o
      ? ((s = (0, Z.jsx)(Pn, { ariaLabel: n, centerLogoAriaLabel: r, size: o })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s))
...
function Nn(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = k(`relative overflow-hidden bg-token-main-surface-primary`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
...
function Fn(e) {
  ...
  t[1] === u
    ? (d = t[2])
    : ((d = k(`relative overflow-hidden bg-token-main-surface-primary`, u)),
      (t[1] = u),
      (t[2] = d));
  let f;
  t[3] === i
  ...
  t[5] === a
    ? (p = t[6])
    : ((p = (0, Z.jsx)(ln, { ref: s, onArtworkReady: l, svgMarkup: a })), (t[5] = a), (t[6] = p));
  let m = o === `compact` ? `w-10` : `w-14`,
    h;
  t[7] === m
    ? (h = t[8])
    : ((h = k(`pointer-events-auto aspect-square`, m)), (t[7] = m), (t[8] = h));
  let g;
  t[9] !== r || t[10] !== h
    ? ((g = (0, Z.jsx)(`div`, {
        className: `pointer-events-none absolute inset-0 z-20 grid place-items-center`,
        children: (0, Z.jsx)(vn, { ariaLabel: r, className: h, onClick: l }),
      })),
      (t[9] = r),
      (t[10] = h),
      (t[11] = g))
...
function In(e) {
  let t = (0, Cn.create)(e, { errorCorrectionLevel: `H` }).modules,
    n = wn / (t.size + On * 2);
  return { cornersMarkup: Rn(t.size, n), dotsMarkup: Ln(t, n) };
}
function Ln(e, t) {
  let n = [];
  for (let r = 0; r < e.size; r += 1)
    for (let i = 0; i < e.size; i += 1)
      !Kn(e, r, i) || qn(e.size, r, i) || Gn(e.size, t, r, i) || n.push(Bn(i, t, r));
  return Hn(n.join(``));
}
function Rn(e, t) {
  return Hn([zn(0, 0, t), zn(e - Dn, 0, t), zn(0, e - Dn, t)].join(``));
}
function zn(e, t, n) {
  let r = Wn(e, n),
    i = Wn(t, n),
    ...
    o = n,
    s = n * 2;
  return `<path fill-rule="evenodd" clip-rule="evenodd" d="${Vn(r, i, a, n * 1.6)} ${Vn(r + o, i + o, a - o * 2, n)}" fill="currentColor"/><rect x="${$(r + s)}" y="${$(i + s)}" width="${$(a - s * 2)}" height="${$(a - s * 2)}" rx="${$(n)}" fill="currentColor"/>`;
}
function Bn(e, t, n) {
  let r = t * En,
    i = Un(e, t),
...
function Hn(e) {
  return `<svg width="${wn}" height="${wn}" viewBox="0 0 ${wn} ${wn}" fill="none" xmlns="${kn}">${e}</svg>`;
}
function Un(e, t) {
  return Wn(e, t) + t / 2;
}
...
function qn(e, t, n) {
  return Jn(t, n, 0, 0) || Jn(t, n, 0, e - Dn) || Jn(t, n, e - Dn, 0);
}
function Jn(e, t, n, r) {
  return e >= n && e < n + Dn && t >= r && t < r + Dn;
}
function Yn(e) {
  return e % 2 == 0 ? e + 1 : e;
}
...
function Xn(e) {
  let t = (0, Q.c)(65),
    { deviceType: n, hostId: r, onDeviceTypeChange: i, showDeviceTypeSelector: o, size: s } = e,
    c = r === void 0 ? p : r,
    l = o === void 0 ? !0 : o,
    ...
    f = ie(dt),
    m = ie(ft),
    [h, g] = (0, X.useState)(`ios`),
    [_, v] = (0, X.useState)(`phone`),
    y = l ? (n ?? _) : `phone`,
    [b] = (0, X.useState)(Zn),
    x;
  t[0] !== c || t[1] !== b
    ? ((x = { hostId: c, openId: b }), (t[0] = c), (t[1] = b), (t[2] = x))
    : (x = t[2]);
  let S = a(yt, x),
    C = f && !m,
    w = C && S.error == null ? (S.data ?? null) : null,
    T = C && w == null && (S.error == null || S.isFetching),
    D = !f || w?.pairingCode != null,
    O = y === `phone` && !f && !m,
    A = C && y === `computer` && !T,
    te;
  t[3] !== n || t[4] !== i
  ...
  if (m) {
    ...
    t[9] === d
      ...
      : ((e = d.formatMessage({
        ...
        (t[10] = e));
    let n;
    (t[11] === e ? (n = t[12]) : ((n = (0, Z.jsx)($n, { ariaLabel: e })), (t[11] = e), (t[12] = n)),
      (P = n));
  } else if (y === `phone` && D) {
    let e;
    t[13] === d
    ...
    let r = w?.pairingCode,
      i;
    (t[17] !== h || t[18] !== u || t[19] !== e || t[20] !== n || t[21] !== r
      ? ((i = (0, Z.jsx)(An, {
          ariaLabel: e,
    ...
    (t[23] === S.error
      ? (e = t[24])
      : ((e = (0, Z.jsx)(sr, { error: S.error })), (t[23] = S.error), (t[24] = e)),
      (P = e));
  } else if (f) {
    let e = w?.manualPairingCode ?? null,
      n;
    (t[25] !== S.error || t[26] !== u || t[27] !== e
      ? ((n = (0, Z.jsx)(er, { error: S.error, manualPairingCode: e, size: u })),
        (t[25] = S.error),
        (t[26] = u),
        (t[27] = e),
        (t[28] = n))
  ...
  let F = u === `compact` ? null : `mt-3`,
    I;
  t[30] === F
    ? (I = t[31])
    : ((I = k(`flex w-full flex-col items-center gap-4`, F)), (t[30] = F), (t[31] = I));
  let L;
  t[32] !== d || t[33] !== m || t[34] !== ne || t[35] !== y || t[36] !== l
    ? ((L =
        l && !m
          ? (0, Z.jsx)(`div`, {
      ...
      (t[37] = L))
    : (L = t[37]);
  let R = u === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    ae = O ? null : `justify-center`,
    oe =
      y === `computer`
        ? u === `compact`
  ...
  t[49] !== S || t[50] !== N || t[51] !== C
    ? ((H = C
        ? (0, Z.jsx)(re, {
            ...
            children: (0, Z.jsx)(j, {
              ...
              size: `icon`,
              children: (0, Z.jsx)(pe, {
                className: k(`icon-xs`, S.isFetching ? `animate-spin` : null),
              }),
            }),
          })
        : null),
    ...
    : (H = t[52]);
  let U;
  t[53] !== z || t[54] !== B || t[55] !== V || t[56] !== H
    ? ((U = (0, Z.jsxs)(`div`, { className: z, children: [B, V, H] })),
      (t[53] = z),
      (t[54] = B),
      (t[55] = V),
      (t[56] = H),
    ...
    : (U = t[57]);
  let W;
  t[58] === A ? (W = t[59]) : ((W = A ? (0, Z.jsx)(or, {}) : null), (t[58] = A), (t[59] = W));
  let G;
  return (
    t[60] !== U || t[61] !== W || t[62] !== I || t[63] !== L
      ? ((G = (0, Z.jsxs)(`div`, { className: I, children: [L, U, W] })),
        (t[60] = U),
        (t[61] = W),
        (t[62] = I),
        (t[63] = L),
...
function $n(e) {
  let t = (0, Q.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(N, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function cr(e) {
  let t = (0, Q.c)(34),
    ...
    { platform: s } = R(),
    c;
  t[0] !== s || t[1] !== o ? ((c = pr(o, s)), (t[0] = s), (t[1] = o), (t[2] = c)) : (c = t[2]);
  let l = c,
    u;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[3]);
  let d;
  t[4] === o ? (d = t[5]) : ((d = (0, Z.jsx)(fr, { variant: o })), (t[4] = o), (t[5] = d));
  let f = o === `page` && `w-full max-w-[400px]`,
    p;
  t[6] === f
    ? (p = t[7])
    : ((p = k(`flex flex-wrap items-center justify-center gap-3`, f)), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((m =
        o === `dialog`
  ...
  let h = o === `page` && `w-full`,
    g;
  t[12] === h ? (g = t[13]) : ((g = k(`justify-center`, h)), (t[12] = h), (t[13] = g));
  let _;
  ...
  t[15] !== r || t[16] !== a || t[17] !== g
    ? ((v = (0, Z.jsx)(j, { onClick: r, size: `large`, className: g, loading: a, children: _ })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = g),
      (t[18] = v))
  ...
  let S;
  return (
    t[27] !== l || t[28] !== y || t[29] !== b || t[30] !== x || t[31] !== d || t[32] !== o
      ? ((S = (0, Z.jsxs)(Ke, { variant: o, heading: l, description: u, children: [d, y, b, x] })),
        (t[27] = l),
        (t[28] = y),
        (t[29] = b),
        (t[30] = x),
...
function lr(e) {
  let t = (0, Q.c)(12),
    { onAllowHost: n, setupInProgress: r, showAllowHostError: i, variant: a } = e,
    o,
    s;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(E, {
  ...
  return (
    t[8] !== l || t[9] !== u || t[10] !== a
      ? ((d = (0, Z.jsxs)(Ke, { variant: a, heading: o, description: s, children: [l, u] })),
        (t[8] = l),
        (t[9] = u),
        (t[10] = a),
        (t[11] = d))
...
function ur(e) {
  ...
  t[3] === n
    ? (s = t[4])
    : ((s = (0, Z.jsx)(j, { size: `large`, className: `justify-center`, onClick: n, children: o })),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
    t[5] !== s || t[6] !== r
      ? ((c = (0, Z.jsx)(Ke, { variant: r, heading: i, description: a, children: s })),
        (t[5] = s),
        (t[6] = r),
        (t[7] = c))
      : (c = t[7]),
...
function dr(e) {
  ...
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(Xn, { showDeviceTypeSelector: !1 })), (t[2] = a))
    : (a = t[2]);
  let o;
  return (
    t[3] === n
      ...
      : ((o = (0, Z.jsx)(Ke, {
          ...
          children: (0, Z.jsxs)(`div`, {
            ...
            children: [a, (0, Z.jsx)(Xe, { onManageConnections: n })],
          }),
        })),
        (t[3] = n),
        (t[4] = o)),
...
function fr(e) {
  let t = (0, Q.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = k(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(mr, {
        icon: (0, Z.jsx)(ce, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(E, {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Z.jsx)(mr, {
        icon: (0, Z.jsx)(Y, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(E, {
...
function hr(e) {
  ...
  if (o === `page`) {
    ...
    t[4] === s
      ...
      : ((n = (0, Z.jsx)(`div`, {
          className: `flex w-full max-w-[460px] flex-col items-center gap-6`,
          children: (0, Z.jsx)(Xn, { hostId: s, showDeviceTypeSelector: !1 }),
        })),
        (t[4] = s),
        (t[5] = n));
    let r;
    return (
      t[6] !== u || t[7] !== n
        ? ((r = (0, Z.jsx)(Ke, { variant: `page`, heading: u, description: e, children: n })),
          (t[6] = u),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  return (
    t[13] !== u || t[14] !== d
      ? ((f = (0, Z.jsx)(Ke, { variant: `dialog`, heading: u, children: d })),
        (t[13] = u),
        (t[14] = d),
        (t[15] = f))
      : (f = t[15]),
...
function gr(e) {
  ...
  if (p === `dialog`) {
    let e;
    t[15] !== g || t[16] !== f
      ? ((e = yr(f, g)), (t[15] = g), (t[16] = f), (t[17] = e))
      : (e = t[17]);
    let n;
    t[18] === e ? (n = t[19]) : ((n = (0, Z.jsx)(Ye, { artworkSrc: e })), (t[18] = e), (t[19] = n));
    let r;
    return (
      t[20] !== y || t[21] !== n
        ? ((r = (0, Z.jsxs)(`div`, {
  ...
  let b;
  t[23] === f ? (b = t[24]) : ((b = xr(f)), (t[23] = f), (t[24] = b));
  let x;
  t[25] === f ? (x = t[26]) : ((x = br(f)), (t[25] = f), (t[26] = x));
  let S;
  return (
    t[27] !== y || t[28] !== b || t[29] !== x
      ? ((S = (0, Z.jsx)(Je, { artworkAlignment: b, artworkSrc: x, children: y })),
        (t[27] = y),
        (t[28] = b),
        (t[29] = x),
        (t[30] = S))
...
function _r(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Z.jsx)(Je, { children: (0, Z.jsx)(dr, { onManageConnections: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function vr(e) {
  ...
  switch (m) {
    ...
    case `connected`: {
      ...
      return (
        t[5] !== s || t[6] !== c || t[7] !== h
          ? ((e = (0, Z.jsx)(it, { onFinishSetup: s, onManageConnections: c, variant: h })),
            (t[5] = s),
            (t[6] = c),
            (t[7] = h),
            (t[8] = e))
    ...
    case `mfa-required`: {
      ...
      return (
        t[15] !== o || t[16] !== h
          ? ((e = (0, Z.jsx)(ur, { onContinueOnChatGPT: o, variant: h })),
            (t[15] = o),
            (t[16] = h),
            (t[17] = e))
          : (e = t[17]),
...
function Sr(e) {
  let t = (0, Q.c)(31),
    ...
    b;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = { "aria-describedby": void 0 }), (t[0] = b))
    : (b = t[0]);
  let x;
  t[1] !== v || t[2] !== y || t[3] !== p
    ? ((x = Cr(v, y, p)), (t[1] = v), (t[2] = y), (t[3] = p), (t[4] = x))
    : (x = t[4]);
  let S;
  t[5] === x
    ? (S = t[6])
    : ((S = (0, Z.jsx)(V, { className: `sr-only`, children: x })), (t[5] = x), (t[6] = S));
  let C;
  t[7] !== _ || t[8] !== p
    ? ((C = () => {
        (O(_, D, { action: `continue_on_chatgpt`, step: p, surface: `dialog` }),
          g.dispatchMessage(`open-in-browser`, { url: `https://chatgpt.com/#settings/Security` }));
      }),
      (t[7] = _),
      (t[8] = p),
      (t[9] = C))
    : (C = t[9]);
  let w;
  t[10] !== i || t[11] !== _ || t[12] !== p
    ? ((w = () => {
        (O(_, D, { action: `finish_setup`, step: p, surface: `dialog` }), i(!1));
      }),
      (t[10] = i),
      (t[11] = _),
      (t[12] = p),
