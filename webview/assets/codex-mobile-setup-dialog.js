...
import { H as ge, Jt as _e, V as ve, Yt as ye } from "./app-initial~app-main~automations-page.js";
import {
  f as U,
  p as W,
...
function Qt() {
  let e = (0, tn.c)(55),
    ...
    i = re(`410065390`),
    a;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: H }), (e[0] = a)) : (a = e[0]);
  let o = je(a).available,
    s = fe(l.keepRemoteControlAwakeWhilePluggedIn),
    u = f(Je, H),
    m = d(qe),
    h;
  e[1] === t.query ? (h = e[2]) : ((h = t.query.snapshot(qe)), (e[1] = t.query), (e[2] = h));
  let g = h,
    _;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((_ = []), (e[3] = _)) : (_ = e[3]);
  let v = ke(H, _),
    y;
  e[4] !== r || e[5] !== v.availablePlugins
    ? ((y = en(v.availablePlugins, rn, r)), (e[4] = r), (e[5] = v.availablePlugins), (e[6] = y))
    : (y = e[6]);
  let b = y,
    x = b?.plugin.installed === !0 && b.plugin.enabled,
    S;
  e[7] !== r || e[8] !== v.availablePlugins
    ? ((S = $t(v.availablePlugins, r)), (e[7] = r), (e[8] = v.availablePlugins), (e[9] = S))
    : (S = e[9]);
  let C = S,
    w;
  ...
  let N = p(ae),
    ...
    P;
  e[15] !== b || e[16] !== m.data?.enabled || e[17] !== M || e[18] !== E || e[19] !== N
    ? ((P = (e) => {
        if (b != null) {
          ...
          if (!e && m.data?.enabled) {
            N.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && E({ enabled: !1, pluginDisplayName: Le(b), pluginId: b.plugin.id });
              },
            });
            return;
          }
...
function $t(e, t) {
  return s.isInternal(Ee()) ? (en(e, sn, t) ?? en(e, on, t) ?? en(e, an, t)) : en(e, an, t);
}
function en(e, t, n) {
...
function ln(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, K.jsx)(S, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let d =
    ...
    f;
  t[4] === d ? (f = t[5]) : ((f = U(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = f));
  let p;
  ...
  let _ = i === `page` && `w-[256px]`,
    v;
  t[38] === _ ? (v = t[39]) : ((v = U(`justify-center`, _)), (t[38] = _), (t[39] = v));
  let y;
  ...
  t[41] !== n || t[42] !== v
    ? ((b = (0, K.jsx)(`div`, {
        ...
        children: (0, K.jsx)(N, { size: `large`, className: v, onClick: n, children: y }),
      })),
      (t[41] = n),
      (t[42] = v),
      (t[43] = b))
...
function Nr(e) {
  ...
  if (a || c === u) {
    ...
    t[7] === r
      ? (e = t[8])
      : ((e = U(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== v || t[10] !== d
  ...
  t[17] === r
    ? (y = t[18])
    : ((y = U(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = y));
  let b;
  t[19] === g
    ? (b = t[20])
    : ((b = (e) => {
...
function Ti(e) {
  ...
  if (p) {
    ...
    (t[29] !== O || t[30] !== T.error || t[31] !== l
      ? ((e = (0, X.jsx)(ki, { error: T.error, manualPairingCode: O, size: l })),
        (t[29] = O),
        (t[30] = T.error),
        (t[31] = l),
        (t[32] = e))
  ...
  t[34] === B
    ? (he = t[35])
    : ((he = U(`flex w-full flex-col items-center gap-4`, B)), (t[34] = B), (t[35] = he));
  let V;
  ...
  t[46] !== L || t[47] !== A
    ? ((W = A
        ? (0, X.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: L })
        : L),
      (t[46] = L),
      (t[47] = A),
      (t[48] = W))
            ...
            children: [
              ...
              (0, X.jsx)(ae, {
                ...
                children: (0, X.jsx)(N, {
                  ...
                  size: `icon`,
                  children: (0, X.jsx)(b, {
                    className: U(`icon-xs`, T.isFetching ? `animate-spin` : null),
                  }),
                }),
              }),
            ],
  ...
  t[62] !== ye || t[63] !== W || t[64] !== be || t[65] !== xe
    ...
    : (Se = t[66]);
  let Ce;
  t[67] === te ? (Ce = t[68]) : ((Ce = te ? (0, X.jsx)(Fi, {}) : null), (t[67] = te), (t[68] = Ce));
  let we;
  t[69] !== pe || t[70] !== u || t[71] !== g || t[72] !== D || t[73] !== F || t[74] !== m
    ? ((we =
        D?.pairingCode == null
          ? null
          : (0, X.jsxs)(nt, {
  ...
  return (
    t[76] !== he || t[77] !== V || t[78] !== Se || t[79] !== Ce || t[80] !== we
      ? ((Te = (0, X.jsxs)(`div`, { className: he, children: [V, Se, Ce, we] })),
        (t[76] = he),
        (t[77] = V),
        (t[78] = Se),
        (t[79] = Ce),
...
function Oi(e) {
  let t = (0, Li.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, X.jsx)(O, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function Bi(e) {
  ...
  t[6] === f
    ? (p = t[7])
    : ((p = U(`flex flex-wrap items-center justify-center gap-3`, f)), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((m =
        o === `dialog`
  ...
  let h = o === `page` && `w-full`,
    g;
  t[12] === h ? (g = t[13]) : ((g = U(`justify-center`, h)), (t[12] = h), (t[13] = g));
  let _;
  ...
  t[15] !== r || t[16] !== a || t[17] !== g
    ? ((v = (0, Z.jsx)(N, { onClick: r, size: `large`, className: g, loading: a, children: _ })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = g),
      (t[18] = v))
...
var qi,
  Z,
  Ji = e(() => {
    ((qi = i()), W(), L(), I(), k(), ze(), E(), ye(), D(), Wt(), Zt(), zi(), (Z = r()));
  });
function Yi(e) {
  let t = (0, Xi.c)(16),
...
function sa(e) {
  ...
  t[5] === y
    ? (b = t[6])
    : ((b = (0, ua.jsx)(rt, { className: `sr-only`, children: y })), (t[5] = y), (t[6] = b));
  let x;
  t[7] !== h || t[8] !== f
    ? ((x = (e) => {
        (F(h, me, { action: `continue_on_chatgpt`, step: f, surface: `dialog` }),
          Ne({
            event: e,
  ...
  t[10] !== i || t[11] !== h || t[12] !== f
    ? ((S = () => {
        (F(h, me, { action: `finish_setup`, step: f, surface: `dialog` }), i(!1));
      }),
      (t[10] = i),
      (t[11] = h),
      (t[12] = f),
