...
import { C as n, Dr as r, Er as i, Hr as a, Ki as o, Wr as s, na as c } from "./src-2.js";
import { Ut as l, Wo as u, fs as d, sa as f } from "./app-server-manager-signals.js";
...
import { c as ee, o as E } from "./lib-2.js";
import { g as D } from "./persisted-signal-CweW-bgN.js";
import { o as te, p as O } from "./statsig.js";
import { t as k } from "./request.js";
import { t as A } from "./use-is-dark.js";
import { t as j } from "./tooltip.js";
import { t as M } from "./persisted-atom.js";
import { t as N } from "./button.js";
import { a as ne, i as P } from "./setting-storage.js";
import { r as F, t as I } from "./spinner.js";
import { t as L } from "./chats-K.js";
import { t as R } from "./use-platform.js";
import { i as re } from "./use-is-plugins-enabled.js";
import { m as ie, y as z } from "./use-plugins.js";
import { n as B, p as V, t as ae } from "./use-plugin-install-flow.js";
import { t as H } from "./chrome.js";
import { d as U, l as W } from "./dialog-layout.js";
import { o as oe } from "./bundled-plugin-auto-install-preference.js";
import { t as se } from "./data-url-from-svg-CpQT-mD6.js";
import { m as ce } from "./links.js";
import { t as le } from "./check-circle.js";
import { t as ue } from "./phone.js";
import { o as de } from "./check-plugin-availability.js";
import { t as G } from "./toggle.js";
import { t as fe } from "./regenerate.js";
import { o as pe, r as me } from "./computer-use-app-approvals-query.js";
import { r as he } from "./plugins-availability.js";
import { t as ge } from "./sun.js";
import { t as _e } from "./chatgpt-token-auth.browser.js";
import { t as ve } from "./use-home-directory-vhC-RDJp.js";
import { t as K } from "./cursor.js";
import { t as q } from "./segmented-toggle-BGk-vwSF.js";
var J = M(`electron:codex-mobile-setup-step-debug-override`, `auto`),
  Y = 100,
  ye = c({ mfa_enabled_v2: o() }),
  be = class extends Error {},
  xe = class extends Error {},
  Se = class extends Error {};
async function Ce({ clientId: e }) {
  await Ae(() =>
    k.safeDelete(`/wham/remote/control/clients/{client_id}`, {
      parameters: { path: { client_id: e } },
    }),
  );
}
async function we() {
  return (await Ae(() => k.safeGet(`/wham/remote/control/mfa_requirement`))).requirement;
}
async function Te() {
  return ye.parse(await k.safeGet(`/accounts/mfa_info`)).mfa_enabled_v2;
}
async function Ee(e = null) {
  let t = await Ae(() =>
    k.safeGet(`/wham/remote/control/clients`, { parameters: { query: { cursor: e, limit: Y } } }),
  );
  return t.items.some(ke) ? !0 : t.cursor == null ? !1 : Ee(t.cursor);
}
async function De() {
  return Oe(null);
}
async function Oe(e) {
  let t = await Ae(() =>
    ...
    n = t.items.filter(ke);
  return t.cursor == null ? n : n.concat(await Oe(t.cursor));
}
function ke(e) {
    ...
    throw e instanceof S
      ? e.status === 404
        ...
        : e.status === 403
          ? new Se(e.message)
          : e.status === 401
            ? (_e(), new be(`ChatGPT auth is required to load remote control environments.`))
            : Error(`Remote control request failed (${e.status}): ${e.message}`)
      : e;
  }
}
var je = `` + new URL(`dialog-artwork-allow-host-C5BkBIxB.png`, import.meta.url).href,
  Me = `` + new URL(`dialog-artwork-connected-NZKCls7p.png`, import.meta.url).href,
  Ne = `` + new URL(`dialog-artwork-initial-DMDAvEM7.png`, import.meta.url).href,
  Pe = `` + new URL(`dialog-artwork-mfa-e9Fx75-r.png`, import.meta.url).href,
  Fe = `` + new URL(`dialog-artwork-waiting-computer-BPIs9eKV.png`, import.meta.url).href,
  Ie = `` + new URL(`dialog-artwork-waiting-phone-UTYmfLHs.png`, import.meta.url).href,
  Le = `` + new URL(`page-artwork-allow-host-C3m2nRMv.png`, import.meta.url).href,
  Re = `` + new URL(`page-artwork-connected-BUPhttJ1.png`, import.meta.url).href,
  ze = `` + new URL(`page-artwork-mfa-e6UxOdqq.png`, import.meta.url).href,
  Be = `` + new URL(`page-artwork-ready-bfkkMY-P.png`, import.meta.url).href,
...
function Ge(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = h(`flex w-full flex-col gap-2 text-center`, s)), (t[0] = s), (t[1] = c));
  let l =
      o === `dialog`
    ...
    u;
  t[2] !== a || t[3] !== l
    ? ((u = (0, Z.jsx)(`div`, { className: l, children: a })), (t[2] = a), (t[3] = l), (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] !== r || t[6] !== o
    ? ((d =
  ...
  let f;
  t[8] !== c || t[9] !== u || t[10] !== d
    ? ((f = (0, Z.jsxs)(`div`, { className: c, children: [u, d] })),
      (t[8] = c),
      (t[9] = u),
      (t[10] = d),
      (t[11] = f))
  ...
  let p;
  t[12] !== i || t[13] !== f
    ? ((p = (0, Z.jsxs)(Z.Fragment, { children: [i, f] })), (t[12] = i), (t[13] = f), (t[14] = p))
    : (p = t[14]);
  let m = p;
  if (o === `dialog`) {
    let e;
...
var Ke = `` + new URL(`page-artwork-background-DPNBzfAy.png`, import.meta.url).href;
function qe(e) {
  let t = (0, Q.c)(13),
...
function Ye(e) {
  let t = (0, Q.c)(6),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = h(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function et() {
  let e = (0, Q.c)(55),
    ...
    a = te(`410065390`),
    o;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = { hostId: u }), (e[0] = o)) : (o = e[0]);
  let s = re(o).available,
    c = ne(n.keepRemoteControlAwakeWhilePluggedIn),
    l = y(V, u),
    d = v(me),
    f;
  e[1] === t.query ? (f = e[2]) : ((f = t.query.snapshot(me)), (e[1] = t.query), (e[2] = f));
  let p = f,
    m;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((m = []), (e[3] = m)) : (m = e[3]);
  let h = ie(u, m),
    _;
  e[4] !== i || e[5] !== h.availablePlugins
    ? ((_ = nt(h.availablePlugins, Xe, i)), (e[4] = i), (e[5] = h.availablePlugins), (e[6] = _))
    : (_ = e[6]);
  let b = _,
    S = b?.plugin.installed === !0 && b.plugin.enabled,
    C;
  e[7] !== i || e[8] !== h.availablePlugins
    ? ((C = tt(h.availablePlugins, i)), (e[7] = i), (e[8] = h.availablePlugins), (e[9] = C))
    : (C = e[9]);
  let T = C,
    ee;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = { hostId: u }), (e[10] = ee))
    : (ee = e[10]);
  let { pendingPluginId: E, setPluginEnabled: D } = he(ee),
    O;
  e[11] === h.forceReload
    ? (O = e[12])
    : ((O = { forceReloadPlugins: h.forceReload, hostId: u }),
      (e[11] = h.forceReload),
      (e[12] = O));
  let {
  ...
  e[13] === p
    ...
    : ((z = {
      ...
      (e[14] = z));
  let H = x(z),
    U = r === `macOS` && S && l && d.data?.enabled != null,
    W;
  e[15] !== b || e[16] !== d.data?.enabled || e[17] !== I || e[18] !== D || e[19] !== H
    ? ((W = (e) => {
        if (b != null) {
          ...
          if (!e && d.data?.enabled) {
            H.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && D({ enabled: !1, pluginDisplayName: oe(b), pluginId: b.plugin.id });
              },
            });
            return;
          }
          D({ enabled: e, pluginDisplayName: oe(b), pluginId: b.plugin.id });
        }
      }),
      (e[15] = b),
      (e[16] = d.data?.enabled),
  ...
  e[21] !== T || e[22] !== I || e[23] !== D
    ? ((ce = (e) => {
        if (T != null) {
          ...
          D({ enabled: e, pluginDisplayName: oe(T), pluginId: T.plugin.id });
        }
      }),
      (e[21] = T),
      (e[22] = I),
    ...
    : (ce = e[24]);
  let le = ce,
    ue = T?.plugin.installed === !0 && T.plugin.enabled,
    de = h.isLoading || T == null || F || E === T.plugin.id,
    G = h.isLoading || b == null || F || H.isPending || E === b.plugin.id,
    fe = c ?? !1,
    ge = d.data?.enabled ?? !1,
    _e = !S || d.isLoading || H.isPending,
    K;
  e[25] === t
    ? (K = e[26])
    : ((K = (e) => {
        P(t, n.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = K));
  let q;
...
function tt(e, t) {
  return s.isInternal(z()) ? (nt(e, $e, t) ?? nt(e, Qe, t) ?? nt(e, Ze, t)) : nt(e, Ze, t);
}
function nt(e, t, n) {
  ...
  return (
    ...
    a.find((e) => r(e.marketplaceName)) ??
    a.find((e) => e.marketplaceName === `openai-curated`) ??
    a.find((e) => de(n, e.marketplacePath)) ??
    null
  );
}
function rt(e) {
  ...
  t[0] !== n || t[1] !== o
    ? ((u = () => {
        (f(o, a.CODEX_MOBILE_SETUP_COMPLETED, !0), n());
      }),
      (t[0] = n),
      (t[1] = o),
      (t[2] = u))
  ...
  t[3] === i
    ? (p = t[4])
    : ((p = i === `page` ? (0, Z.jsx)(le, { className: `size-11 text-token-foreground` }) : void 0),
      (t[3] = i),
      (t[4] = p));
  let m, _;
  ...
  let v =
    ...
    y;
  t[7] === v ? (y = t[8]) : ((y = h(`flex w-full flex-col`, v)), (t[7] = v), (t[8] = y));
  let b;
  t[9] !== l.keepComputerAwake ||
  t[10] !== l.keepComputerAwakeToggleDisabled ||
  t[11] !== l.onKeepComputerAwakeChange ||
  t[12] !== l.showKeepComputerAwake ||
  t[13] !== s ||
  t[14] !== c ||
  t[15] !== i
    ? ((b = l.showKeepComputerAwake
        ? (0, Z.jsx)(at, {
            icon: l.keepComputerAwake
              ? (0, Z.jsx)(ge, { className: `icon-base` })
              : (0, Z.jsx)(We, { className: `icon-base` }),
            variant: i,
            title:
              c === `windows`
                ? (0, Z.jsx)(E, {
            ...
            trailing: (0, Z.jsx)(G, {
              checked: l.keepComputerAwake,
              disabled: l.keepComputerAwakeToggleDisabled,
              ariaLabel:
                c === `windows`
                  ? s.formatMessage({
              ...
              onChange: l.onKeepComputerAwakeChange,
            }),
          })
        : null),
      (t[9] = l.keepComputerAwake),
    ...
    : (b = t[16]);
  let x;
  t[17] !== l.computerUseEnabled ||
  t[18] !== l.computerUseToggleDisabled ||
  t[19] !== l.lockedComputerUseEnabled ||
  t[20] !== l.lockedComputerUseToggleDisabled ||
  t[21] !== l.onComputerUseEnabledChange ||
  t[22] !== l.onLockedComputerUseEnabledChange ||
  t[23] !== l.showComputerUseSetup ||
  t[24] !== l.showLockedComputerUse ||
  t[25] !== s ||
  t[26] !== c ||
  t[27] !== i
    ? ((x =
        l.showComputerUseSetup && l.showLockedComputerUse
          ? (0, Z.jsx)(at, {
              icon: (0, Z.jsx)(He, { className: `icon-base` }),
              variant: i,
              title: (0, Z.jsx)(E, {
              ...
              trailing: (0, Z.jsx)(G, {
                checked: l.lockedComputerUseEnabled,
                disabled: l.lockedComputerUseToggleDisabled,
                ...
                onChange: l.onLockedComputerUseEnabledChange,
              }),
            })
          : l.showComputerUseSetup
            ? (0, Z.jsx)(at, {
                icon: (0, Z.jsx)(Ue, { className: `icon-base` }),
                variant: i,
                title: (0, Z.jsx)(E, {
    ...
    : (x = t[28]);
  let S;
  t[29] !== l.chromeExtensionEnabled ||
  t[30] !== l.chromeExtensionToggleDisabled ||
  t[31] !== l.onChromeExtensionEnabledChange ||
  t[32] !== l.showChromeExtensionSetup ||
  t[33] !== s ||
  t[34] !== i
    ? ((S = l.showChromeExtensionSetup
        ? (0, Z.jsx)(at, {
            icon: (0, Z.jsx)(H, { className: `icon-base` }),
            variant: i,
            title: (0, Z.jsx)(E, {
            ...
            trailing: (0, Z.jsx)(G, {
              checked: l.chromeExtensionEnabled,
              disabled: l.chromeExtensionToggleDisabled,
              ariaLabel: s.formatMessage({
              ...
              onChange: l.onChromeExtensionEnabledChange,
            }),
          })
        : null),
      (t[29] = l.chromeExtensionEnabled),
    ...
    : (S = t[35]);
  let C;
  t[36] !== y || t[37] !== b || t[38] !== x || t[39] !== S
    ? ((C = (0, Z.jsxs)(`div`, { className: y, children: [b, x, S] })),
      (t[36] = y),
      (t[37] = b),
      (t[38] = x),
      (t[39] = S),
      (t[40] = C))
    : (C = t[40]);
  let T = i === `page` && `w-[256px]`,
    D;
  t[41] === T ? (D = t[42]) : ((D = h(`justify-center`, T)), (t[41] = T), (t[42] = D));
  let te;
  ...
  t[44] !== d || t[45] !== D
    ? ((O = (0, Z.jsx)(`div`, {
        ...
        children: (0, Z.jsx)(N, { size: `large`, className: D, onClick: d, children: te }),
      })),
      (t[44] = d),
      (t[45] = D),
      (t[46] = O))
  ...
  t[47] !== r || t[48] !== i
    ? ((k =
        i === `page` && r != null
          ? (0, Z.jsx)(Ye, { className: `w-[256px]`, onManageConnections: r })
          : null),
      (t[47] = r),
      (t[48] = i),
      (t[49] = k))
  ...
  let M;
  return (
    t[58] !== l.pluginInstallModal || t[59] !== j
      ? ((M = (0, Z.jsxs)(Z.Fragment, { children: [j, l.pluginInstallModal] })),
        (t[58] = l.pluginInstallModal),
        (t[59] = j),
        (t[60] = M))
      : (M = t[60]),
    M
...
function at(e) {
  ...
  if (i != null) {
    ...
    t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== o
      ? ((l = (0, Z.jsx)(ot, { description: n, icon: r, title: a, trailing: o })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o),
    ...
    return (
      t[7] !== i || t[8] !== c || t[9] !== l
        ? ((u = (0, Z.jsx)(`button`, { type: `button`, className: c, onClick: i, children: l })),
          (t[7] = i),
          (t[8] = c),
          (t[9] = l),
          (t[10] = u))
  ...
  t[11] === c
    ? (l = t[12])
    : ((l = h(`flex items-center justify-between gap-4 px-[14px] py-2 text-left`, c)),
      (t[11] = c),
      (t[12] = l));
  let u;
  t[13] !== n || t[14] !== r || t[15] !== a || t[16] !== o
    ? ((u = (0, Z.jsx)(ot, { description: n, icon: r, title: a, trailing: o })),
      (t[13] = n),
      (t[14] = r),
      (t[15] = a),
      (t[16] = o),
...
function ot(e) {
  ...
  t[2] === i
    ? (s = t[3])
    : ((s = (0, Z.jsx)(`div`, { className: `text-sm text-token-text-primary`, children: i })),
      (t[2] = i),
      (t[3] = s));
  let c;
  t[4] === n
  ...
  let l;
  t[6] !== s || t[7] !== c
    ? ((l = (0, Z.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [s, c] })),
      (t[6] = s),
      (t[7] = c),
      (t[8] = l))
    : (l = t[8]);
  ...
  return (
    t[14] !== u || t[15] !== d
      ? ((f = (0, Z.jsxs)(Z.Fragment, { children: [u, d] })), (t[14] = u), (t[15] = d), (t[16] = f))
      : (f = t[16]),
    f
  );
}
var st = 3e4,
  ct = 6e4,
  lt = `2055603567`,
  ut = [`remote-control-server-pairing`],
  dt = _(w, () => ({
  ...
  mt = b(
    w,
    ({ hostId: e, openId: t }, { get: n }) => ({
      enabled: n(O, lt),
      queryKey: [...ut, e, t],
      queryFn: () => d(`start-remote-control-pairing-for-host`, { hostId: e, manual_code: !0 }),
      retry: !1,
      gcTime: 0,
      staleTime: (e) => {
        let t = e.state.data?.expires_at;
        return t == null ? 0 : Math.max(0, t - e.state.dataUpdatedAt);
      },
      refetchInterval: (e) => {
        let t = e.state.data?.expires_at;
        return t == null || e.state.fetchStatus === `fetching` || e.state.error != null
          ? !1
          : Math.max(1, t - Date.now() - ct);
      },
    }),
...
var Yt = 760,
  ...
  Qt = `180ms`;
function $t(e, t, n) {
  ((e.style.transitionDuration = n ? `0ms` : Qt),
    (e.style.fill = Jt(t)),
...
function tn({ onArtworkReady: e, svgMarkup: t }) {
  let n = F(),
    r = (0, X.useRef)(null),
    i = (0, X.useRef)(null),
    a = (0, X.useRef)([]),
    o = (0, X.useRef)(new Map()),
    s = (0, X.useRef)(null),
    c = (0, X.useRef)(() => {}),
    l = (0, X.useRef)(null),
    u = (0, X.useCallback)((e) => {
      ...
      for (let r of a.current) {
        let i = (o.current.get(r.node) ?? 0) * Zt;
        i < 0.01 ? o.current.set(r.node, 0) : (o.current.set(r.node, i), (n = !0));
        let a = 0;
        if (t != null) {
          let i = e - t.startedAt,
            s = Math.min(1, i / Yt),
            c = t.maxRadius * s,
            u = Math.hypot(r.x - t.origin.x, r.y - t.origin.y),
            d = Math.abs(u - c);
          (d <= Xt &&
            ((a = (1 - d / Xt) * (1 - s * 0.18)),
            o.current.set(r.node, Math.max(o.current.get(r.node) ?? 0, a)),
            (n = !0)),
            s >= 1 && (l.current = null));
        }
        $t(r.node, Math.max(o.current.get(r.node) ?? 0, a), a > 0);
      }
      s.current = n ? requestAnimationFrame(c.current) : null;
    }, []);
  ((0, X.useEffect)(() => {
    c.current = u;
  }, [u]),
    (0, X.useEffect)(() => {
      if (n) {
        ...
        for (let e of a.current)
          (o.current.set(e.node, 0),
            (e.node.style.transitionDuration = `0ms`),
            (e.node.style.fill = Jt(0)),
  ...
  (0, X.useEffect)(() => {
    let t = r.current?.querySelector(`svg`);
    if (t != null)
      return (
        (i.current = t),
        o.current.clear(),
        (a.current = Array.from(t.querySelectorAll(`path`)).map((e) => {
          let t = e.getBBox();
          return (
            (e.style.fill = Jt(0)),
  ...
  return {
    paintDots: (0, X.useCallback)(
      (e) => {
        ...
        let s = r.matrixTransform(t.getScreenCTM()?.inverse()),
          c = !1;
        for (let e of a.current) {
          let t = qt(Math.hypot(e.x - s.x, e.y - s.y)),
            n = o.current.get(e.node) ?? 0,
            r = Math.max(n, t);
          r > n && (o.current.set(e.node, r), en(e.node, r), (c = !0));
        }
        c && d();
      },
      [d, n],
...
function nn(e) {
  let t = (0, Q.c)(12),
    ...
    a;
  t[0] !== i || t[1] !== n
    ? ((a = { onArtworkReady: n, svgMarkup: i }), (t[0] = i), (t[1] = n), (t[2] = a))
    : (a = t[2]);
  let { paintDots: o, rootRef: s, svgMarkup: c, triggerRipple: l } = tn(a),
    u,
    d;
  (t[3] === l
    ? ((u = t[4]), (d = t[5]))
    : ((u = () => ({ triggerRipple: l })), (d = [l]), (t[3] = l), (t[4] = u), (t[5] = d)),
    (0, X.useImperativeHandle)(r, u, d));
  let f;
...
var rn = `` + new URL(`codex-home-hero-dark-still-43PvFxTG.png`, import.meta.url).href,
  an = `` + new URL(`codex-home-hero-dark-_BGDEdk8.mp4`, import.meta.url).href,
  on = `` + new URL(`codex-home-hero-light-still-CQ7cy4qg.png`, import.meta.url).href,
  sn = `` + new URL(`codex-home-hero-light-Cyip34F2.mp4`, import.meta.url).href,
  cn = `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
  ln = { dark: { stillSrc: rn, videoSrc: an }, light: { stillSrc: on, videoSrc: sn } },
  un = `url(${se(cn)})`,
  dn = {
    maskImage: un,
    maskMode: `alpha`,
...
function fn(e) {
  ...
  t[1] !== a || t[2] !== u || t[3] !== c
    ? ((g = () => {
        if (a || c === u) return;
        let e = o.current;
        e != null && e.paused && ((e.currentTime = 0), e.play()?.catch(pn));
      }),
      (t[1] = a),
      (t[2] = u),
      (t[3] = c),
  ...
  t[5] === r
    ? (v = t[6])
    : ((v = h(`size-full shrink-0 object-contain`, r)), (t[5] = r), (t[6] = v));
  let y = v;
  if (a || c === u) {
    let e;
    t[7] === r
      ? (e = t[8])
      : ((e = h(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== y || t[10] !== d
      ? ((a = (0, Z.jsx)(`img`, { alt: ``, "aria-hidden": `true`, className: y, src: d })),
        (t[9] = y),
        (t[10] = d),
        (t[11] = a))
      : (a = t[11]);
  ...
  t[17] === r
    ? (b = t[18])
    : ((b = h(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = b));
  let x;
  t[19] === _
    ? (x = t[20])
    : ((x = (e) => {
        e.pointerType === `mouse` && _();
      }),
      (t[19] = _),
      (t[20] = x));
  let S;
  t[21] === u
    ...
    : ((S = () => {
      ...
      (t[22] = S));
  let C;
  t[23] !== y || t[24] !== d || t[25] !== x || t[26] !== S || t[27] !== u || t[28] !== f
    ? ((C = (0, Z.jsx)(
        `video`,
        {
          ref: o,
...
function wn(e) {
  let t = (0, Q.c)(10),
    { ariaLabel: n, centerLogoAriaLabel: r, pairingCode: i, platform: a, size: o } = e,
    s = o === void 0 ? `default` : o;
  if (i != null) {
    let e;
    return (
      t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== s
        ? ((e = (0, Z.jsx)(Tn, { ariaLabel: n, centerLogoAriaLabel: r, pairingCode: i, size: s })),
          (t[0] = n),
          (t[1] = r),
          (t[2] = i),
          (t[3] = s),
  ...
  let c;
  return (
    t[5] !== n || t[6] !== r || t[7] !== a || t[8] !== s
      ? ((c = (0, Z.jsx)(En, { ariaLabel: n, centerLogoAriaLabel: r, platform: a, size: s })),
        (t[5] = n),
        (t[6] = r),
        (t[7] = a),
        (t[8] = s),
...
function Tn(e) {
  let t = (0, Q.c)(15),
    { ariaLabel: n, centerLogoAriaLabel: r, pairingCode: i, size: a } = e,
    ...
    u,
    d;
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== o) {
    let e = new URL(`https://chatgpt.com/codex/pair`);
    (e.searchParams.set(`pairing_code`, i),
      (s = kn),
      (c = n),
      (l = r),
      (u = o),
      ...
      (t[7] = u),
      (t[8] = d));
  } else ((s = t[4]), (c = t[5]), (l = t[6]), (u = t[7]), (d = t[8]));
  let f;
  return (
    t[9] !== s || t[10] !== c || t[11] !== l || t[12] !== u || t[13] !== d
      ? ((f = (0, Z.jsx)(s, { ariaLabel: c, centerLogoAriaLabel: l, size: u, ...d })),
        (t[9] = s),
        (t[10] = c),
        (t[11] = l),
        (t[12] = u),
...
function En(e) {
  ...
  if (i === `android`) {
    ...
    return (
      t[0] !== n || t[1] !== o
        ? ((e = (0, Z.jsx)(Dn, { ariaLabel: n, size: o })), (t[0] = n), (t[1] = o), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== o
      ? ((s = (0, Z.jsx)(On, { ariaLabel: n, centerLogoAriaLabel: r, size: o })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s))
...
function Dn(e) {
  let t = (0, Q.c)(6),
    ...
    i = r === `compact` ? `size-[180px] rounded-[24px]` : `size-[270px] rounded-[32px]`,
    a;
  t[0] === i
    ? (a = t[1])
    : ((a = h(`relative overflow-hidden bg-token-main-surface-primary`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  return (
    t[3] !== n || t[4] !== a
      ? ((s = (0, Z.jsx)(`div`, { "aria-label": n, className: a, role: `img`, children: o })),
        (t[3] = n),
        (t[4] = a),
        (t[5] = s))
      : (s = t[5]),
...
function kn(e) {
  let t = (0, Q.c)(18),
    { ariaLabel: n, centerLogoAriaLabel: r, cornersMarkup: i, dotsMarkup: a, size: o } = e,
    s = (0, X.useRef)(null),
    c;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = () => {
    ...
    : (c = t[0]);
  let l = c,
    u = o === `compact` ? `size-[180px] rounded-[24px]` : `size-[270px] rounded-[32px]`,
    d;
  t[1] === u
    ? (d = t[2])
    : ((d = h(`relative overflow-hidden bg-token-main-surface-primary`, u)),
      (t[1] = u),
      (t[2] = d));
  let f;
  t[3] === i
  ...
  t[5] === a
    ? (p = t[6])
    : ((p = (0, Z.jsx)(nn, { ref: s, onArtworkReady: l, svgMarkup: a })), (t[5] = a), (t[6] = p));
  let m = o === `compact` ? `w-10` : `w-14`,
    g;
  t[7] === m
    ? (g = t[8])
    : ((g = h(`pointer-events-auto aspect-square`, m)), (t[7] = m), (t[8] = g));
  let _;
  t[9] !== r || t[10] !== g
    ? ((_ = (0, Z.jsx)(`div`, {
        className: `pointer-events-none absolute inset-0 z-20 grid place-items-center`,
        children: (0, Z.jsx)(fn, { ariaLabel: r, className: g, onClick: l }),
      })),
      (t[9] = r),
      (t[10] = g),
      (t[11] = _))
  ...
  let v;
  return (
    t[12] !== n || t[13] !== d || t[14] !== f || t[15] !== p || t[16] !== _
      ? ((v = (0, Z.jsxs)(`div`, {
          "aria-label": n,
          className: d,
          role: `img`,
...
function An(e) {
  let t = (0, _n.create)(e, { errorCorrectionLevel: `H` }).modules,
    n = vn / (t.size + Sn * 2);
  return { cornersMarkup: Mn(t.size, n), dotsMarkup: jn(t, n) };
}
function jn(e, t) {
  let n = [];
  for (let r = 0; r < e.size; r += 1)
    for (let i = 0; i < e.size; i += 1)
      !Bn(e, r, i) || Vn(e.size, r, i) || zn(e.size, t, r, i) || n.push(Pn(i, t, r));
  return In(n.join(``));
}
function Mn(e, t) {
  return In([Nn(0, 0, t), Nn(e - xn, 0, t), Nn(0, e - xn, t)].join(``));
}
function Nn(e, t, n) {
  let r = Rn(e, n),
    i = Rn(t, n),
    ...
    o = n,
    s = n * 2;
  return `<path fill-rule="evenodd" clip-rule="evenodd" d="${Fn(r, i, a, n * 1.6)} ${Fn(r + o, i + o, a - o * 2, n)}" fill="currentColor"/><rect x="${$(r + s)}" y="${$(i + s)}" width="${$(a - s * 2)}" height="${$(a - s * 2)}" rx="${$(n)}" fill="currentColor"/>`;
}
function Pn(e, t, n) {
  let r = t * bn,
    i = Ln(e, t),
    a = Ln(n, t);
  return `<path d="M ${$(i)} ${$(a - r)} A ${$(r)} ${$(r)} 0 1 1 ${$(i)} ${$(a + r)} A ${$(r)} ${$(r)} 0 1 1 ${$(i)} ${$(a - r)} Z" fill="currentColor"/>`;
}
function Fn(e, t, n, r) {
  let i = e + n,
    a = t + n;
  return `M ${$(e + r)} ${$(t)} H ${$(i - r)} A ${$(r)} ${$(r)} 0 0 1 ${$(i)} ${$(t + r)} V ${$(a - r)} A ${$(r)} ${$(r)} 0 0 1 ${$(i - r)} ${$(a)} H ${$(e + r)} A ${$(r)} ${$(r)} 0 0 1 ${$(e)} ${$(a - r)} V ${$(t + r)} A ${$(r)} ${$(r)} 0 0 1 ${$(e + r)} ${$(t)} Z`;
}
function In(e) {
  return `<svg width="${vn}" height="${vn}" viewBox="0 0 ${vn} ${vn}" fill="none" xmlns="${Cn}">${e}</svg>`;
}
function Ln(e, t) {
  return Rn(e, t) + t / 2;
}
...
function Vn(e, t, n) {
  return Hn(t, n, 0, 0) || Hn(t, n, 0, e - xn) || Hn(t, n, e - xn, 0);
}
function Hn(e, t, n, r) {
  return e >= n && e < n + xn && t >= r && t < r + xn;
}
function Un(e) {
  return e % 2 == 0 ? e + 1 : e;
}
...
function Wn(e) {
  let t = (0, Q.c)(61),
    { deviceType: n, hostId: r, onDeviceTypeChange: i, showDeviceTypeSelector: a, size: o } = e,
    s = r === void 0 ? u : r,
    c = a === void 0 ? !0 : a,
    l = o === void 0 ? `default` : o,
    d = ee(),
    f = te(lt),
    [p, m] = (0, X.useState)(`ios`),
    [g, _] = (0, X.useState)(`phone`),
    v = c ? (n ?? g) : `phone`,
    [b] = (0, X.useState)(Gn),
    x;
  t[0] !== s || t[1] !== b
    ? ((x = { hostId: s, openId: b }), (t[0] = s), (t[1] = b), (t[2] = x))
    : (x = t[2]);
  let S = y(mt, x),
    C = f && !S.isError ? (S.data ?? null) : null,
    w = f && !S.isError && C == null,
    T = !f || C?.pairing_code != null,
    D = v === `phone` && !f,
    O = f && v === `computer` && !w,
    k;
  t[3] !== n || t[4] !== i
  ...
  if (w) {
    ...
    t[8] === d
      ...
      : ((e = d.formatMessage({
        ...
        (t[9] = e));
    let n;
    (t[10] === e ? (n = t[11]) : ((n = (0, Z.jsx)(qn, { ariaLabel: e })), (t[10] = e), (t[11] = n)),
      (P = n));
  } else if (v === `phone` && T) {
    let e;
    t[12] === d
    ...
    t[14] === d
      ...
      : ((n = d.formatMessage({
        ...
        (t[14] = d),
        (t[15] = n));
    let r = C?.pairing_code,
      i;
    (t[16] !== p || t[17] !== l || t[18] !== e || t[19] !== n || t[20] !== r
      ? ((i = (0, Z.jsx)(wn, {
          ariaLabel: e,
          centerLogoAriaLabel: n,
          pairingCode: r,
          platform: p,
          size: l,
        })),
    ...
    let e = C?.manual_pairing_code ?? null,
      n;
    (t[23] !== l || t[24] !== e
      ? ((n = (0, Z.jsx)(Jn, { manualPairingCode: e, size: l })),
        (t[23] = l),
        (t[24] = e),
        (t[25] = n))
      : (n = t[25]),
  ...
  let F = l === `compact` ? null : `mt-3`,
    I;
  t[27] === F
    ? (I = t[28])
    : ((I = h(`flex w-full flex-col items-center gap-4`, F)), (t[27] = F), (t[28] = I));
  let L;
  t[29] !== d || t[30] !== A || t[31] !== v || t[32] !== c
    ? ((L = c
        ? (0, Z.jsx)(`div`, {
      ...
      (t[33] = L))
    : (L = t[33]);
  let R = l === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    re = D ? null : `justify-center`,
    ie =
      v === `computer`
        ? l === `compact`
  ...
  t[38] !== P || t[39] !== D
    ? ((B = D
        ? (0, Z.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: P })
        : P),
      (t[38] = P),
      (t[39] = D),
      (t[40] = B))
  ...
  t[45] !== f || t[46] !== S || t[47] !== ne
    ? ((ae = f
        ? (0, Z.jsx)(j, {
            ...
            children: (0, Z.jsx)(N, {
              ...
              size: `icon`,
              children: (0, Z.jsx)(fe, {
                className: h(`icon-xs`, S.isFetching ? `animate-spin` : null),
              }),
            }),
          })
        : null),
    ...
    : (ae = t[48]);
  let H;
  t[49] !== z || t[50] !== B || t[51] !== V || t[52] !== ae
    ? ((H = (0, Z.jsxs)(`div`, { className: z, children: [B, V, ae] })),
      (t[49] = z),
      (t[50] = B),
      (t[51] = V),
      (t[52] = ae),
    ...
    : (H = t[53]);
  let U;
  t[54] === O ? (U = t[55]) : ((U = O ? (0, Z.jsx)(er, {}) : null), (t[54] = O), (t[55] = U));
  let W;
  return (
    t[56] !== H || t[57] !== U || t[58] !== I || t[59] !== L
      ? ((W = (0, Z.jsxs)(`div`, { className: I, children: [L, H, U] })),
        (t[56] = H),
        (t[57] = U),
        (t[58] = I),
        (t[59] = L),
...
function Kn(e) {
  ...
  t[5] !== a || t[6] !== s || t[7] !== c
    ...
    : (u = t[8]);
  let d = i === `android`,
    f = i === `android` ? `text-token-text-primary` : `text-token-text-tertiary`,
    p;
  t[9] === f
    ? (p = t[10])
    : ((p = h(
      ...
      (t[10] = p));
  let m;
  t[11] === r ? (m = t[12]) : ((m = () => r(`android`)), (t[11] = r), (t[12] = m));
  let g;
...
function qn(e) {
  let t = (0, Q.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(I, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function Jn(e) {
  let t = (0, Q.c)(3),
    { manualPairingCode: n, size: r } = e,
    i;
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, Z.jsx)(Z.Fragment, {
          children:
            n == null
              ? (0, Z.jsx)(tr, {})
              : (0, Z.jsx)(`div`, {
...
function Xn(e) {
  return (0, Z.jsx)(`span`, { className: `font-semibold text-token-text-primary`, children: e });
}
function Zn(e) {
  return (0, Z.jsx)(`span`, { className: `font-semibold text-token-text-primary`, children: e });
}
...
function nr(e) {
  let t = (0, Q.c)(34),
    ...
    { platform: s } = R(),
    c;
  t[0] !== s || t[1] !== o ? ((c = sr(o, s)), (t[0] = s), (t[1] = o), (t[2] = c)) : (c = t[2]);
  let l = c,
    u;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[3]);
  let d;
  t[4] === o ? (d = t[5]) : ((d = (0, Z.jsx)(or, { variant: o })), (t[4] = o), (t[5] = d));
  let f = o === `page` && `w-full max-w-[400px]`,
    p;
  t[6] === f
    ? (p = t[7])
    : ((p = h(`flex flex-wrap items-center justify-center gap-3`, f)), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((m =
        o === `dialog`
  ...
  let g = o === `page` && `w-full`,
    _;
  t[12] === g ? (_ = t[13]) : ((_ = h(`justify-center`, g)), (t[12] = g), (t[13] = _));
  let v;
  ...
  t[15] !== r || t[16] !== a || t[17] !== _
    ? ((y = (0, Z.jsx)(N, { onClick: r, size: `large`, className: _, loading: a, children: v })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = _),
      (t[18] = y))
    : (y = t[18]);
  let b;
  t[19] !== y || t[20] !== p || t[21] !== m
    ? ((b = (0, Z.jsxs)(`div`, { className: p, children: [m, y] })),
      (t[19] = y),
      (t[20] = p),
      (t[21] = m),
      (t[22] = b))
  ...
  let C;
  return (
    t[27] !== l || t[28] !== b || t[29] !== x || t[30] !== S || t[31] !== d || t[32] !== o
      ? ((C = (0, Z.jsxs)(Ge, { variant: o, heading: l, description: u, children: [d, b, x, S] })),
        (t[27] = l),
        (t[28] = b),
        (t[29] = x),
        (t[30] = S),
...
function rr(e) {
  ...
  return (
    t[6] !== c || t[7] !== i
      ? ((l = (0, Z.jsx)(Ge, { variant: i, heading: a, description: o, children: c })),
        (t[6] = c),
        (t[7] = i),
        (t[8] = l))
      : (l = t[8]),
...
function ir(e) {
  ...
  t[3] === n
    ? (s = t[4])
    : ((s = (0, Z.jsx)(N, { size: `large`, className: `justify-center`, onClick: n, children: o })),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
    t[5] !== s || t[6] !== r
      ? ((c = (0, Z.jsx)(Ge, { variant: r, heading: i, description: a, children: s })),
        (t[5] = s),
        (t[6] = r),
        (t[7] = c))
      : (c = t[7]),
...
function ar(e) {
  ...
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(Wn, { showDeviceTypeSelector: !1 })), (t[2] = a))
    : (a = t[2]);
  let o;
  return (
    t[3] === n
      ...
      : ((o = (0, Z.jsx)(Ge, {
          ...
          children: (0, Z.jsxs)(`div`, {
            ...
            children: [a, (0, Z.jsx)(Ye, { onManageConnections: n })],
          }),
        })),
        (t[3] = n),
        (t[4] = o)),
...
function or(e) {
  let t = (0, Q.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = h(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(cr, {
        icon: (0, Z.jsx)(ue, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(E, {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(cr, {
        icon: (0, Z.jsx)(L, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(E, {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Z.jsx)(cr, {
        icon: (0, Z.jsx)(K, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(E, {
  ...
  return (
    t[5] === i
      ? (c = t[6])
      : ((c = (0, Z.jsxs)(`div`, { className: i, children: [a, o, s] })), (t[5] = i), (t[6] = c)),
    c
  );
}
function sr(e, t) {
...
function lr(e) {
  let t = (0, Q.c)(16),
    { approvalDeviceMode: n, heading: r, hostId: i, onApprovalDeviceModeChange: a, variant: o } = e,
    s = i === void 0 ? u : i,
    { platform: c } = R(),
    l;
  t[0] !== r || t[1] !== c
  ...
  if (o === `page`) {
    ...
    t[4] === s
      ...
      : ((n = (0, Z.jsx)(`div`, {
          className: `flex w-full max-w-[460px] flex-col items-center gap-6`,
          children: (0, Z.jsx)(Wn, { hostId: s, showDeviceTypeSelector: !1 }),
        })),
        (t[4] = s),
        (t[5] = n));
    let r;
    return (
      t[6] !== d || t[7] !== n
        ? ((r = (0, Z.jsx)(Ge, { variant: `page`, heading: d, description: e, children: n })),
          (t[6] = d),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  return (
    t[13] !== d || t[14] !== f
      ? ((p = (0, Z.jsx)(Ge, { variant: `dialog`, heading: d, children: f })),
        (t[13] = d),
        (t[14] = f),
        (t[15] = p))
      : (p = t[15]),
...
function ur(e) {
  ...
  t[12] !== p
    ? ((g = (0, Z.jsx)(fr, {
        approvalDeviceMode: m,
        hostId: n,
        onAllowHost: r,
        onApprovalDeviceModeChange: h,
        onContinueOnChatGPT: i,
        onFinishSetup: a,
        onManageConnections: o,
        onSkip: s,
  ...
  if (f === `dialog`) {
    let e;
    t[14] !== m || t[15] !== d
      ? ((e = pr(d, m)), (t[14] = m), (t[15] = d), (t[16] = e))
      : (e = t[16]);
    let n;
    t[17] === e ? (n = t[18]) : ((n = (0, Z.jsx)(Je, { artworkSrc: e })), (t[17] = e), (t[18] = n));
    let r;
    return (
      t[19] !== _ || t[20] !== n
        ? ((r = (0, Z.jsxs)(`div`, {
  ...
  let v;
  t[22] === d ? (v = t[23]) : ((v = hr(d)), (t[22] = d), (t[23] = v));
  let y;
  t[24] === d ? (y = t[25]) : ((y = mr(d)), (t[24] = d), (t[25] = y));
  let b;
  return (
    t[26] !== _ || t[27] !== v || t[28] !== y
      ? ((b = (0, Z.jsx)(qe, { artworkAlignment: v, artworkSrc: y, children: _ })),
        (t[26] = _),
        (t[27] = v),
        (t[28] = y),
        (t[29] = b))
...
function dr(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Z.jsx)(qe, { children: (0, Z.jsx)(ar, { onManageConnections: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function fr(e) {
  ...
  switch (p) {
    case `allow-host`: {
      ...
      return (
        t[0] !== i || t[1] !== d || t[2] !== m
          ? ((e = (0, Z.jsx)(rr, { onAllowHost: i, setupInProgress: d, variant: m })),
            (t[0] = i),
            (t[1] = d),
            (t[2] = m),
            (t[3] = e))
    ...
    case `connected`: {
      ...
      return (
        t[4] !== s || t[5] !== c || t[6] !== m
          ? ((e = (0, Z.jsx)(rt, { onFinishSetup: s, onManageConnections: c, variant: m })),
            (t[4] = s),
            (t[5] = c),
            (t[6] = m),
            (t[7] = e))
    ...
    case `initial`: {
      let e;
      return (
        t[8] !== l || t[9] !== u || t[10] !== d || t[11] !== f || t[12] !== m
          ? ((e = (0, Z.jsx)(nr, {
              onSkip: l,
              onStartSetup: u,
              showStartSetupError: f,
    ...
    case `mfa-required`: {
      ...
      return (
        t[14] !== o || t[15] !== m
          ? ((e = (0, Z.jsx)(ir, { onContinueOnChatGPT: o, variant: m })),
            (t[14] = o),
            (t[15] = m),
            (t[16] = e))
          : (e = t[16]),
    ...
    case `waiting`: {
      let e;
      return (
        t[17] !== n || t[18] !== r || t[19] !== a || t[20] !== m || t[21] !== h
          ? ((e = (0, Z.jsx)(lr, {
              approvalDeviceMode: n,
              heading: h,
              hostId: r,
...
function gr(e) {
  ...
  t[5] === _
    ? (v = t[6])
    : ((v = (0, Z.jsx)(U, { className: `sr-only`, children: _ })), (t[5] = _), (t[6] = v));
  let y;
  t[7] !== f || t[8] !== u
    ? ((y = () => {
        (D(f, {
          eventName: `codex_remote_control_onboarding_action_clicked`,
          metadata: { action: `continue_on_chatgpt`, step: u, surface: `dialog` },
        }),
          C.dispatchMessage(`open-in-browser`, { url: `https://chatgpt.com/#settings/Security` }));
      }),
      (t[7] = f),
      (t[8] = u),
      (t[9] = y))
    : (y = t[9]);
  let b;
  t[10] !== r || t[11] !== f || t[12] !== u
    ? ((b = () => {
        (D(f, {
          eventName: `codex_remote_control_onboarding_action_clicked`,
          metadata: { action: `finish_setup`, step: u, surface: `dialog` },
        }),
          r(!1));
      }),
      (t[10] = r),
...
//# sourceMappingURL=codex-mobile-setup-dialog.js.map
