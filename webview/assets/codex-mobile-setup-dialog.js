...
import { n as at, t as ot } from "./segmented-toggle.js";
import { n as st, t as ct } from "./use-home-directory.js";
import { a as lt, o as ut } from "./plugin-detail-page-utils.js";
var dt,
  ft = e(() => {
    (ye(), (dt = R(`electron:codex-mobile-setup-step-debug-override`, `auto`)));
  }),
  pt,
  mt = e(() => {
    pt = `` + new URL(`dialog-artwork-allow-host-B0bcIhDi.png`, import.meta.url).href;
  }),
  ht,
  gt = e(() => {
    ht = `` + new URL(`dialog-artwork-connected-NZKCls7p.png`, import.meta.url).href;
  }),
  _t,
  vt = e(() => {
  ...
  xt,
  St = e(() => {
    xt = `` + new URL(`dialog-artwork-waiting-computer-BPIs9eKV.png`, import.meta.url).href;
  }),
  Ct,
  wt = e(() => {
    Ct = `` + new URL(`dialog-artwork-waiting-phone-UTYmfLHs.png`, import.meta.url).href;
  }),
  Tt,
  Et = e(() => {
    Tt = `` + new URL(`page-artwork-allow-host-CPm7eJR2.png`, import.meta.url).href;
  }),
  Dt,
  Ot = e(() => {
  ...
  kt,
  At = e(() => {
    kt = `` + new URL(`page-artwork-waiting-pzj85BPm.png`, import.meta.url).href;
  }),
  jt,
  Mt = e(() => {
...
function Ht(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = P(`flex w-full flex-col gap-2 text-center`, s)), (t[0] = s), (t[1] = c));
  let l =
      o === `dialog`
    ...
    u;
  t[2] !== a || t[3] !== l
    ? ((u = (0, Wt.jsx)(`div`, { className: l, children: a })), (t[2] = a), (t[3] = l), (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] !== r || t[6] !== o
    ? ((d =
  ...
  let p;
  t[12] !== i || t[13] !== f
    ? ((p = (0, Wt.jsxs)(Wt.Fragment, { children: [i, f] })), (t[12] = i), (t[13] = f), (t[14] = p))
    : (p = t[14]);
  let m = p;
  if (o === `dialog`) {
    let e;
...
var Ut,
  ...
  Kt,
  qt = e(() => {
    Kt = `` + new URL(`page-artwork-background-DPNBzfAy.png`, import.meta.url).href;
  });
function Jt(e) {
  let t = (0, Zt.c)(13),
...
function Xt(e) {
  let t = (0, Zt.c)(6),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = P(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function $t() {
  let e = (0, nn.c)(55),
    ...
    i = se(`410065390`),
    a;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: o }), (e[0] = a)) : (a = e[0]);
  let s = _e(a).available,
    l = je(m.keepRemoteControlAwakeWhilePluggedIn),
    u = p(We, o),
    d = h(tt),
    f;
  e[1] === t.query ? (f = e[2]) : ((f = t.query.snapshot(tt)), (e[1] = t.query), (e[2] = f));
  let v = f,
    y;
  ...
  e[4] !== r || e[5] !== b.availablePlugins
    ? ((x = tn(b.availablePlugins, an, r)), (e[4] = r), (e[5] = b.availablePlugins), (e[6] = x))
    : (x = e[6]);
  let S = x,
    C = S?.plugin.installed === !0 && S.plugin.enabled,
    w;
  e[7] !== r || e[8] !== b.availablePlugins
    ? ((w = en(b.availablePlugins, r)), (e[7] = r), (e[8] = b.availablePlugins), (e[9] = w))
    : (w = e[9]);
  let T = w,
    ee;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = { hostId: o }), (e[10] = ee))
    : (ee = e[10]);
  let { pendingPluginId: E, setPluginEnabled: D } = we(ee),
    te;
  e[11] === b.forceReload
    ? (te = e[12])
    : ((te = { forceReloadPlugins: b.forceReload, hostId: o }),
      (e[11] = b.forceReload),
      (e[12] = te));
  let {
      ...
      handleRequiredAppOAuthStarted: O,
      installPlugin: ae,
      isInstalling: k,
      openPluginInstall: A,
      session: oe,
  ...
  e[13] === v
    ...
    : ((ce = {
      ...
      (e[14] = ce));
  let j = _(ce),
    le = n === `macOS` && C && u && d.data?.enabled != null,
    M;
  e[15] !== S || e[16] !== d.data?.enabled || e[17] !== A || e[18] !== D || e[19] !== j
    ? ((M = (e) => {
        if (S != null) {
          ...
          if (!e && d.data?.enabled) {
            j.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && D({ enabled: !1, pluginDisplayName: z(S), pluginId: S.plugin.id });
              },
            });
            return;
          }
          D({ enabled: e, pluginDisplayName: z(S), pluginId: S.plugin.id });
        }
      }),
      (e[15] = S),
      (e[16] = d.data?.enabled),
  ...
  e[21] !== T || e[22] !== A || e[23] !== D
    ? ((ue = (e) => {
        if (T != null) {
          ...
          D({ enabled: e, pluginDisplayName: z(T), pluginId: T.plugin.id });
        }
      }),
      (e[21] = T),
      (e[22] = A),
    ...
    : (ue = e[24]);
  let P = ue,
    de = T?.plugin.installed === !0 && T.plugin.enabled,
    F = b.isLoading || T == null || k || E === T.plugin.id,
    fe = b.isLoading || S == null || k || j.isPending || E === S.plugin.id,
    I = l ?? !1,
    pe = d.data?.enabled ?? !1,
    L = !C || d.isLoading || j.isPending,
    R;
  e[25] === t
    ? (R = e[26])
    : ((R = (e) => {
        Pe(t, m.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = R));
  let me;
  ...
  return (
    ...
    e[53] !== B
      ? ((V = {
          ...
          onChromeExtensionEnabledChange: P,
          onComputerUseEnabledChange: N,
          onKeepComputerAwakeChange: R,
          onLockedComputerUseEnabledChange: me,
          pluginInstallModal: B,
...
function en(e, t) {
  return s.isInternal(be()) ? (tn(e, cn, t) ?? tn(e, sn, t) ?? tn(e, on, t)) : tn(e, on, t);
}
function tn(e, t, n) {
  let r = e.filter((e) => e.plugin.name === t || e.plugin.id.split(`@`)[0] === t),
    a = i(be());
  return (
    (a == null ? void 0 : r.find((e) => e.marketplaceName === a)) ??
    r.find((e) => y(e.marketplaceName)) ??
    r.find((e) => e.marketplaceName === `openai-curated`) ??
    r.find((e) => ut(n, e.marketplacePath)) ??
    null
  );
}
var nn,
...
function un(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, G.jsx)(C, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let d =
    ...
    f;
  t[4] === d ? (f = t[5]) : ((f = P(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = f));
  let p;
    ...
    ? ((p = s.showKeepComputerAwake
        ? (0, G.jsx)(fn, {
            icon: s.keepComputerAwake
              ? (0, G.jsx)(it, { className: `icon-base` })
  ...
  t[31] !== i
    ? ((h = s.showChromeExtensionSetup
        ? (0, G.jsx)(fn, {
            icon: (0, G.jsx)(Re, { className: `icon-base` }),
            variant: i,
            title: (0, G.jsx)(j, {
  ...
  t[33] !== f || t[34] !== p || t[35] !== m || t[36] !== h
    ? ((g = (0, G.jsxs)(`div`, { className: f, children: [p, m, h] })),
      (t[33] = f),
      (t[34] = p),
      (t[35] = m),
      (t[36] = h),
  ...
  let _ = i === `page` && `w-[256px]`,
    v;
  t[38] === _ ? (v = t[39]) : ((v = P(`justify-center`, _)), (t[38] = _), (t[39] = v));
  let y;
  ...
  t[41] !== n || t[42] !== v
    ? ((b = (0, G.jsx)(`div`, {
        ...
        children: (0, G.jsx)(Oe, { size: `large`, className: v, onClick: n, children: y }),
      })),
      (t[41] = n),
      (t[42] = v),
      (t[43] = b))
  ...
  return (
    t[55] !== s.pluginInstallModal || t[56] !== w
      ? ((T = (0, G.jsxs)(G.Fragment, { children: [w, s.pluginInstallModal] })),
...
function fn(e) {
  ...
  if (i != null) {
    ...
    t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== o
      ? ((l = (0, G.jsx)(pn, { description: n, icon: r, title: a, trailing: o })),
        (t[2] = n),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o),
    ...
    return (
      t[7] !== i || t[8] !== c || t[9] !== l
        ? ((u = (0, G.jsx)(`button`, { type: `button`, className: c, onClick: i, children: l })),
          (t[7] = i),
          (t[8] = c),
          (t[9] = l),
          (t[10] = u))
  ...
  t[11] === c
    ? (l = t[12])
    : ((l = P(`flex items-center justify-between gap-4 px-[14px] py-2 text-left`, c)),
      (t[11] = c),
      (t[12] = l));
  let u;
  t[13] !== n || t[14] !== r || t[15] !== a || t[16] !== o
    ? ((u = (0, G.jsx)(pn, { description: n, icon: r, title: a, trailing: o })),
      (t[13] = n),
      (t[14] = r),
      (t[15] = a),
      (t[16] = o),
  ...
  return (
    t[18] !== l || t[19] !== u
      ? ((d = (0, G.jsx)(`div`, { className: l, children: u })),
        (t[18] = l),
        (t[19] = u),
        (t[20] = d))
      : (d = t[20]),
...
function pn(e) {
  ...
  t[2] === i
    ? (s = t[3])
    : ((s = (0, G.jsx)(`div`, { className: `text-sm text-token-text-primary`, children: i })),
      (t[2] = i),
      (t[3] = s));
  let c;
  t[4] === n
  ...
  let l;
  t[6] !== s || t[7] !== c
    ? ((l = (0, G.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [s, c] })),
      (t[6] = s),
      (t[7] = c),
      (t[8] = l))
    : (l = t[8]);
  ...
  return (
    t[14] !== u || t[15] !== d
      ? ((f = (0, G.jsxs)(G.Fragment, { children: [u, d] })), (t[14] = u), (t[15] = d), (t[16] = f))
      : (f = t[16]),
    f
  );
}
...
function Yn(e, t) {
  ...
  let i = Array.from(e.querySelectorAll(`:scope > path`)).map((e) => {
    ...
    s = Array.from({ length: dr }, (n, r) => Xn(e, `interactive-brush-trail-${r}-${t}`)),
...
function Zn(e) {
  ...
  return (
    ...
    t.setAttribute(`cx`, String(-cr)),
    t.setAttribute(`cy`, String(-cr)),
    t.setAttribute(`r`, String(cr)),
    t.append($n(`0`, `1`), $n(`0.58`, `0.61`), $n(`0.99`, `0.23`), $n(`1`, `0`)),
    t
  );
}
function Qn(e, t) {
...
var br,
  ...
  Sr,
  Cr = e(() => {
    ((br = l()), (xr = t(a(), 1)), vr(), (Sr = v()));
  }),
  wr,
  Tr = e(() => {
    wr = `` + new URL(`codex-home-hero-dark-still-43PvFxTG.png`, import.meta.url).href;
  }),
  Er,
  Dr = e(() => {
    Er = `` + new URL(`codex-home-hero-dark-_BGDEdk8.mp4`, import.meta.url).href;
  }),
  Or,
  kr = e(() => {
    Or = `` + new URL(`codex-home-hero-light-still-CQ7cy4qg.png`, import.meta.url).href;
  }),
  Ar,
  jr = e(() => {
    Ar = `` + new URL(`codex-home-hero-light-Cyip34F2.mp4`, import.meta.url).href;
  }),
  Mr,
  Nr = e(() => {
...
function Pr(e) {
  let t = (0, Ir.c)(35),
    ...
    o = (0, Lr.useRef)(null),
    s = L() === !0,
    [c, l] = (0, Lr.useState)(null),
    u = s ? `dark` : `light`,
    { stillSrc: d, videoSrc: f } = zr[u],
    p;
  ...
  t[5] === r
    ? (_ = t[6])
    : ((_ = P(`size-full shrink-0 object-contain`, r)), (t[5] = r), (t[6] = _));
  let v = _;
  if (a || c === u) {
    let e;
    t[7] === r
      ? (e = t[8])
      : ((e = P(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== v || t[10] !== d
      ? ((a = (0, Rr.jsx)(`img`, { alt: ``, "aria-hidden": `true`, className: v, src: d })),
        (t[9] = v),
        (t[10] = d),
        (t[11] = a))
      : (a = t[11]);
  ...
  t[17] === r
    ? (y = t[18])
    : ((y = P(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = y));
  let b;
  t[19] === g
    ? (b = t[20])
    : ((b = (e) => {
...
var Ir,
  ...
  Hr = e(() => {
    ((Ir = l()),
      ...
      ve(),
      (Rr = v()),
      (zr = { dark: { stillSrc: wr, videoSrc: Er }, light: { stillSrc: Or, videoSrc: Ar } }),
      (Br = `url(${M(Mr)})`),
      (Vr = {
        maskImage: Br,
        maskMode: `alpha`,
...
function Yr(e) {
  ...
  return (
    t[6] !== n || t[7] !== r || t[8] !== o || t[9] !== l
      ? ((u = (0, J.jsx)(Qr, { ariaLabel: n, centerLogoAriaLabel: r, platform: o, size: l })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = o),
        (t[9] = l),
...
function Xr(e) {
  ...
  if (i) {
    ...
    return (
      t[3] !== n || t[4] !== l
        ? ((e = (0, J.jsx)(Zr, { ariaLabel: n, ...l })), (t[3] = n), (t[4] = l), (t[5] = e))
        : (e = t[5]),
      e
    );
  }
  ...
  return (
    t[6] !== n || t[7] !== r || t[8] !== l || t[9] !== s
      ? ((u = (0, J.jsx)(ti, { ariaLabel: n, centerLogoAriaLabel: r, size: s, ...l })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = l),
        (t[9] = s),
...
function Qr(e) {
  ...
  if (i === `android`) {
    ...
    return (
      t[0] !== n || t[1] !== o
        ? ((e = (0, J.jsx)($r, { ariaLabel: n, size: o })), (t[0] = n), (t[1] = o), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== o
      ? ((s = (0, J.jsx)(ei, { ariaLabel: n, centerLogoAriaLabel: r, size: o })),
        (t[3] = n),
        (t[4] = r),
        (t[5] = o),
        (t[6] = s))
...
function $r(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = P(`relative overflow-hidden bg-token-main-surface-primary`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  return (
    t[3] !== n || t[4] !== a
      ? ((s = (0, J.jsx)(`div`, { "aria-label": n, className: a, role: `img`, children: o })),
        (t[3] = n),
        (t[4] = a),
        (t[5] = s))
      : (s = t[5]),
...
function ti(e) {
  ...
  t[1] === u
    ? (d = t[2])
    : ((d = P(`relative overflow-hidden bg-token-main-surface-primary`, u)),
      (t[1] = u),
      (t[2] = d));
  let f;
  t[3] === i
  ...
  t[5] === a
    ? (p = t[6])
    : ((p = (0, J.jsx)(yr, { ref: s, onArtworkReady: l, svgMarkup: a })), (t[5] = a), (t[6] = p));
  let m = o === `compact` ? `w-10` : `w-14`,
    h;
  t[7] === m
    ? (h = t[8])
    : ((h = P(`pointer-events-auto aspect-square`, m)), (t[7] = m), (t[8] = h));
  let g;
  t[9] !== r || t[10] !== h
    ? ((g = (0, J.jsx)(`div`, {
        className: `pointer-events-none absolute inset-0 z-20 grid place-items-center`,
        children: (0, J.jsx)(Pr, { ariaLabel: r, className: h, onClick: l }),
      })),
      (t[9] = r),
      (t[10] = h),
      (t[11] = g))
...
function ri(e, t, n) {
  ...
  for (let i = 0; i < e.size; i += 1)
    for (let a = 0; a < e.size; a += 1)
      !fi(e, i, a) || pi(e.size, i, a) || (n && di(e.size, t, i, a)) || r.push(oi(a, t, i));
  return ci(r.join(``));
}
function ii(e, t) {
...
function Ei(e) {
  let t = (0, Y.c)(82),
    { deviceType: n, hostId: r, onDeviceTypeChange: i, showDeviceTypeSelector: a, size: s } = e,
    c = r === void 0 ? o : r,
    l = a === void 0 ? !0 : a,
    ...
    C;
  t[0] !== c || t[1] !== S
    ? ((C = { hostId: c, openId: S }), (t[0] = c), (t[1] = S), (t[2] = C))
    : (C = t[2]);
  let w = p(ce, C),
    T = f && !m,
    E = T && w.error == null ? (w.data ?? null) : null,
    D = E?.manualPairingCode ?? null,
    te = T && E == null && (w.error == null || w.isFetching),
    ie = !f || E?.pairingCode != null,
    O = x === `phone` && !f && !m,
    k = T && x === `computer` && !te,
    A;
  t[3] !== n || t[4] !== i
  ...
  if (m) {
    ...
    t[17] === d
      ...
      : ((e = d.formatMessage({
        ...
        (t[18] = e));
    let n;
    (t[19] === e ? (n = t[20]) : ((n = (0, X.jsx)(ki, { ariaLabel: e })), (t[19] = e), (t[20] = n)),
      (z = n));
  } else if (x === `phone` && ie) {
    let e = E?.pairingCode,
      n;
    ...
    (t[27] === w.error
      ? (e = t[28])
      : ((e = (0, X.jsx)(Li, { error: w.error })), (t[27] = w.error), (t[28] = e)),
      (z = e));
  } else if (f) {
    let e;
    (t[29] !== D || t[30] !== w.error || t[31] !== u
      ? ((e = (0, X.jsx)(Ai, { error: w.error, manualPairingCode: D, size: u })),
        (t[29] = D),
        (t[30] = w.error),
        (t[31] = u),
        (t[32] = e))
  ...
  let B = u === `compact` ? null : `mt-3`,
    _e;
  t[34] === B
    ? (_e = t[35])
    : ((_e = P(`flex w-full flex-col items-center gap-4`, B)), (t[34] = B), (t[35] = _e));
  let V;
  t[36] !== d || t[37] !== m || t[38] !== oe || t[39] !== x || t[40] !== l
    ? ((V =
        l && !m
          ? (0, X.jsx)(`div`, {
      ...
      (t[41] = V))
    : (V = t[41]);
  let ve = u === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    ye = O ? null : `justify-center`,
    be =
      x === `computer`
        ? u === `compact`
  ...
  t[46] !== z || t[47] !== O
    ? ((Se = O
        ? (0, X.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: z })
        : z),
      (t[46] = z),
      (t[47] = O),
      (t[48] = Se))
  ...
  t[60] !== de
              ...
              x === `phone` && ie
                ? (0, X.jsx)(re, {
                    ...
                    children: (0, X.jsx)(Oe, {
                      ...
                      onClick: () => v(!0),
                      size: `icon`,
                      children: (0, X.jsx)(ne, { className: `icon-xs` }),
                    }),
                  })
                : null,
              (0, X.jsx)(re, {
                ...
                children: (0, X.jsx)(Oe, {
                  ...
                  size: `icon`,
                  children: (0, X.jsx)(ee, {
                    className: P(`icon-xs`, w.isFetching ? `animate-spin` : null),
                  }),
                }),
              }),
            ],
    ...
    : (we = t[61]);
  let Te;
  t[62] !== xe || t[63] !== Se || t[64] !== Ce || t[65] !== we
    ? ((Te = (0, X.jsxs)(`div`, { className: xe, children: [Se, Ce, we] })),
      (t[62] = xe),
      (t[63] = Se),
      (t[64] = Ce),
      (t[65] = we),
    ...
    : (Te = t[66]);
  let H;
  t[67] === k ? (H = t[68]) : ((H = k ? (0, X.jsx)(Ii, {}) : null), (t[67] = k), (t[68] = H));
  let Ee;
  t[69] !== L || t[70] !== d || t[71] !== _ || t[72] !== E || t[73] !== I || t[74] !== h
    ? ((Ee =
        E?.pairingCode == null
          ? null
          : (0, X.jsxs)(me, {
  ...
  let U;
  return (
    t[76] !== _e || t[77] !== V || t[78] !== Te || t[79] !== H || t[80] !== Ee
      ? ((U = (0, X.jsxs)(`div`, { className: _e, children: [V, Te, H, Ee] })),
        (t[76] = _e),
        (t[77] = V),
        (t[78] = Te),
        (t[79] = H),
...
function ki(e) {
  let t = (0, Y.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, X.jsx)(Ee, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function Bi(e) {
  let t = (0, qi.c)(34),
    ...
    { platform: s } = Ne(),
    c;
  t[0] !== s || t[1] !== o ? ((c = Gi(o, s)), (t[0] = s), (t[1] = o), (t[2] = c)) : (c = t[2]);
  let l = c,
    u;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[3]);
  let d;
  t[4] === o ? (d = t[5]) : ((d = (0, Z.jsx)(Wi, { variant: o })), (t[4] = o), (t[5] = d));
  let f = o === `page` && `w-full max-w-[400px]`,
    p;
  t[6] === f
    ? (p = t[7])
    : ((p = P(`flex flex-wrap items-center justify-center gap-3`, f)), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((m =
        o === `dialog`
  ...
  let h = o === `page` && `w-full`,
    g;
  t[12] === h ? (g = t[13]) : ((g = P(`justify-center`, h)), (t[12] = h), (t[13] = g));
  let _;
  ...
  t[15] !== r || t[16] !== a || t[17] !== g
    ? ((v = (0, Z.jsx)(Oe, { onClick: r, size: `large`, className: g, loading: a, children: _ })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = g),
      (t[18] = v))
  ...
  return (
    t[27] !== l || t[28] !== y || t[29] !== b || t[30] !== x || t[31] !== d || t[32] !== o
      ? ((S = (0, Z.jsxs)(Ht, { variant: o, heading: l, description: u, children: [d, y, b, x] })),
        (t[27] = l),
        (t[28] = y),
        (t[29] = b),
        (t[30] = x),
...
function Vi(e) {
  ...
  return (
    t[8] !== l || t[9] !== u || t[10] !== a
      ? ((d = (0, Z.jsxs)(Ht, { variant: a, heading: o, description: s, children: [l, u] })),
        (t[8] = l),
        (t[9] = u),
        (t[10] = a),
        (t[11] = d))
...
function Hi(e) {
  ...
  return (
    t[5] !== s || t[6] !== r
      ? ((c = (0, Z.jsx)(Ht, { variant: r, heading: i, description: a, children: s })),
        (t[5] = s),
        (t[6] = r),
        (t[7] = c))
      : (c = t[7]),
...
function Ui(e) {
  ...
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(Ei, { showDeviceTypeSelector: !1 })), (t[3] = o))
    : (o = t[3]);
  let s;
  t[4] === n
    ? (s = t[5])
    : ((s = (0, Z.jsxs)(`div`, {
        ...
        children: [o, (0, Z.jsx)(Xt, { onManageConnections: n })],
      })),
      (t[4] = n),
      (t[5] = s));
  let c;
  return (
    t[6] !== i || t[7] !== s
      ? ((c = (0, Z.jsx)(Ht, { variant: `page`, heading: i, description: a, children: s })),
        (t[6] = i),
        (t[7] = s),
        (t[8] = c))
      : (c = t[8]),
...
function Wi(e) {
  let t = (0, qi.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = P(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(Qe, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(j, {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(E, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(j, {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(D, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(j, {
...
var qi,
  Z,
  Ji = e(() => {
    ((qi = l()), F(), I(), De(), U(), te(), x(), $e(), A(), Gt(), Qt(), zi(), (Z = v()));
  });
function Yi(e) {
  let t = (0, Xi.c)(16),
    { approvalDeviceMode: n, heading: r, hostId: i, onApprovalDeviceModeChange: a, variant: s } = e,
    c = i === void 0 ? o : i,
    { platform: l } = Ne(),
    u;
  t[0] !== r || t[1] !== l
  ...
  if (s === `page`) {
    ...
    t[4] === c
      ...
      : ((n = (0, Q.jsx)(`div`, {
          className: `flex w-full max-w-[460px] flex-col items-center gap-6`,
          children: (0, Q.jsx)(Ei, { hostId: c, showDeviceTypeSelector: !1 }),
        })),
        (t[4] = c),
        (t[5] = n));
    let r;
    return (
      t[6] !== d || t[7] !== n
        ? ((r = (0, Q.jsx)(Ht, { variant: `page`, heading: d, description: e, children: n })),
          (t[6] = d),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  return (
    t[13] !== d || t[14] !== f
      ? ((p = (0, Q.jsx)(Ht, { variant: `dialog`, heading: d, children: f })),
        (t[13] = d),
        (t[14] = f),
        (t[15] = p))
      : (p = t[15]),
...
function Qi(e) {
  ...
  if (p === `dialog`) {
    ...
    t[15] !== g || t[16] !== f
      ...
      : (e = t[17]);
    let n;
    t[18] === e ? (n = t[19]) : ((n = (0, $.jsx)(Yt, { artworkSrc: e })), (t[18] = e), (t[19] = n));
    let r;
    return (
      t[20] !== y || t[21] !== n
        ? ((r = (0, $.jsxs)(`div`, {
  ...
  return (
    t[27] !== y || t[28] !== b || t[29] !== x
      ? ((S = (0, $.jsx)(Jt, { artworkAlignment: b, artworkSrc: x, children: y })),
        (t[27] = y),
        (t[28] = b),
        (t[29] = x),
        (t[30] = S))
...
function $i(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, $.jsx)(Jt, { children: (0, $.jsx)(Ui, { onManageConnections: n }) })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function ea(e) {
  ...
  switch (m) {
    ...
    case `connected`: {
      ...
      return (
        t[5] !== s || t[6] !== c || t[7] !== h
          ? ((e = (0, $.jsx)(un, { onFinishSetup: s, onManageConnections: c, variant: h })),
            (t[5] = s),
            (t[6] = c),
            (t[7] = h),
            (t[8] = e))
...
function sa(e) {
  ...
  t[5] === b
    ? (x = t[6])
    : ((x = (0, ua.jsx)(ge, { className: `sr-only`, children: b })), (t[5] = b), (t[6] = x));
  let S;
  t[7] !== h || t[8] !== f
    ? ((S = (e) => {
        (de(h, N, { action: `continue_on_chatgpt`, step: f, surface: `dialog` }),
          He({
            event: e,
  ...
  t[10] !== i || t[11] !== h || t[12] !== f
    ? ((C = () => {
        (de(h, N, { action: `finish_setup`, step: f, surface: `dialog` }), i(!1));
      }),
      (t[10] = i),
      (t[11] = h),
      (t[12] = f),
