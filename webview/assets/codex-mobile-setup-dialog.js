...
import { vn as Je, yn as Ye } from "./app-initial~app-main~onboarding-page.js";
import {
  h as Xe,
  m as Ze,
...
var ut,
  dt = e(() => {
    (s(), (ut = h(`electron:codex-mobile-setup-step-debug-override`, `auto`)));
  }),
  ft,
  pt = e(() => {
...
function Vt(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = N(`flex w-full flex-col gap-2 text-center`, s)), (t[0] = s), (t[1] = c));
  let l =
      o === `dialog`
  ...
  let p;
  t[12] !== i || t[13] !== f
    ? ((p = (0, Ut.jsxs)(Ut.Fragment, { children: [i, f] })), (t[12] = i), (t[13] = f), (t[14] = p))
    : (p = t[14]);
  let m = p;
  if (o === `dialog`) {
    let e;
...
function Yt(e) {
  let t = (0, Xt.c)(6),
    ...
    i;
  t[0] === n ? (i = t[1]) : ((i = N(`justify-center`, n)), (t[0] = n), (t[1] = i));
  let a;
...
function Qt() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = { hostId: Ae }), (e[0] = o))
    : (o = e[0]);
  let s = ee(o).available,
    c = _e(d.keepRemoteControlAwakeWhilePluggedIn),
    l = f(Ge, Ae),
    u = v(He),
    p;
  e[1] === t.query ? (p = e[2]) : ((p = t.query.snapshot(He)), (e[1] = t.query), (e[2] = p));
  let m = p,
    h;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((h = []), (e[3] = h)) : (h = e[3]);
  let y = le(Ae, h),
    b;
  e[4] !== r || e[5] !== y.availablePlugins
    ? ((b = en(y.availablePlugins, rn, r)), (e[4] = r), (e[5] = y.availablePlugins), (e[6] = b))
    : (b = e[6]);
  let x = b,
    S = x?.plugin.installed === !0 && x.plugin.enabled,
    C;
  e[7] !== r || e[8] !== y.availablePlugins
    ? ((C = $t(y.availablePlugins, r)), (e[7] = r), (e[8] = y.availablePlugins), (e[9] = C))
    : (C = e[9]);
  let w = C,
    T;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = { hostId: Ae }), (e[10] = T))
    : (T = e[10]);
  let { pendingPluginId: E, setPluginEnabled: D } = ne(T),
    te;
  e[11] === y.forceReload
    ? (te = e[12])
    : ((te = { forceReloadPlugins: y.forceReload, hostId: Ae }),
      (e[11] = y.forceReload),
      (e[12] = te));
  let {
      ...
      handleRequiredAppOAuthStarted: k,
      installPlugin: ae,
      isInstalling: oe,
      openPluginInstall: A,
      session: se,
  ...
  e[13] === m
    ...
    : ((ce = {
      ...
      (e[14] = ce));
  let j = _(ce),
    ue = n === `macOS` && S && l && u.data?.enabled != null,
    M;
  e[15] !== x || e[16] !== u.data?.enabled || e[17] !== A || e[18] !== D || e[19] !== j
    ? ((M = (e) => {
        if (x != null) {
          ...
          if (!e && u.data?.enabled) {
            j.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && D({ enabled: !1, pluginDisplayName: he(x), pluginId: x.plugin.id });
              },
            });
            return;
          }
  ...
  e[21] !== w || e[22] !== A || e[23] !== D
    ...
    : (de = e[24]);
  let P = de,
    fe = w?.plugin.installed === !0 && w.plugin.enabled,
    pe = y.isLoading || w == null || oe || E === w.plugin.id,
    me = y.isLoading || x == null || oe || j.isPending || E === x.plugin.id,
    F = c ?? !1,
    I = u.data?.enabled ?? !1,
    L = !S || u.isLoading || j.isPending,
    R;
  e[25] === t
    ? (R = e[26])
    : ((R = (e) => {
        ge(t, d.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = R));
  let z;
  ...
  return (
    ...
    e[53] !== V
      ? ((H = {
          ...
          computerUseToggleDisabled: me,
          keepComputerAwake: F,
          keepComputerAwakeToggleDisabled: !1,
          lockedComputerUseEnabled: I,
...
function $t(e, t) {
  return u.isInternal(R()) ? (en(e, sn, t) ?? en(e, on, t) ?? en(e, an, t)) : en(e, an, t);
}
function en(e, t, n) {
  let i = e.filter((e) => e.plugin.name === t || e.plugin.id.split(`@`)[0] === t),
    o = r(R());
  return (
    (o == null ? void 0 : i.find((e) => e.marketplaceName === o)) ??
    i.find((e) => a(e.marketplaceName)) ??
    i.find((e) => e.marketplaceName === `openai-curated`) ??
    i.find((e) => lt(n, e.marketplacePath)) ??
    null
  );
}
var tn,
...
function ln(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, K.jsx)(Ve, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let d =
    ...
    f;
  t[4] === d ? (f = t[5]) : ((f = N(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = f));
  let p;
    ...
    ? ((p = s.showKeepComputerAwake
        ? (0, K.jsx)(dn, {
            icon: s.keepComputerAwake
              ? (0, K.jsx)(rt, { className: `icon-base` })
  ...
  t[31] !== i
    ? ((h = s.showChromeExtensionSetup
        ? (0, K.jsx)(dn, {
            icon: (0, K.jsx)(B, { className: `icon-base` }),
            variant: i,
            title: (0, K.jsx)(W, {
  ...
  let _ = i === `page` && `w-[256px]`,
    v;
  t[38] === _ ? (v = t[39]) : ((v = N(`justify-center`, _)), (t[38] = _), (t[39] = v));
  let y;
  ...
  t[41] !== n || t[42] !== v
    ? ((b = (0, K.jsx)(`div`, {
        ...
        children: (0, K.jsx)(D, { size: `large`, className: v, onClick: n, children: y }),
      })),
      (t[41] = n),
      (t[42] = v),
      (t[43] = b))
...
function dn(e) {
  ...
  t[11] === c
    ? (l = t[12])
    : ((l = N(`flex items-center justify-between gap-4 px-[14px] py-2 text-left`, c)),
      (t[11] = c),
      (t[12] = l));
  let u;
...
function Nr(e) {
  ...
  t[5] === r
    ? (_ = t[6])
    : ((_ = N(`size-full shrink-0 object-contain`, r)), (t[5] = r), (t[6] = _));
  let v = _;
  if (a || c === u) {
    let e;
    t[7] === r
      ? (e = t[8])
      : ((e = N(`cursor-interaction overflow-hidden`, r)), (t[7] = r), (t[8] = e));
    let a;
    t[9] !== v || t[10] !== d
      ? ((a = (0, Lr.jsx)(`img`, { alt: ``, "aria-hidden": `true`, className: v, src: d })),
        (t[9] = v),
        (t[10] = d),
        (t[11] = a))
      : (a = t[11]);
  ...
  t[17] === r
    ? (y = t[18])
    : ((y = N(`cursor-interaction overflow-hidden`, r)), (t[17] = r), (t[18] = y));
  let b;
  t[19] === g
    ? (b = t[20])
    : ((b = (e) => {
...
function Qr(e) {
  ...
  t[0] === i
    ? (a = t[1])
    : ((a = N(`relative overflow-hidden bg-token-main-surface-primary`, i)),
      (t[0] = i),
      (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
...
function ei(e) {
  ...
  t[1] === u
    ? (d = t[2])
    : ((d = N(`relative overflow-hidden bg-token-main-surface-primary`, u)),
      (t[1] = u),
      (t[2] = d));
  let f;
  t[3] === i
  ...
  t[5] === a
    ? (p = t[6])
    : ((p = (0, Y.jsx)(vr, { ref: s, onArtworkReady: l, svgMarkup: a })), (t[5] = a), (t[6] = p));
  let m = o === `compact` ? `w-10` : `w-14`,
    h;
  t[7] === m
    ? (h = t[8])
    : ((h = N(`pointer-events-auto aspect-square`, m)), (t[7] = m), (t[8] = h));
  let g;
  t[9] !== r || t[10] !== h
    ? ((g = (0, Y.jsx)(`div`, {
...
function Ti(e) {
  let t = (0, Li.c)(82),
    ...
    [g, _] = (0, Ri.useState)(!1),
    [v, y] = (0, Ri.useState)(`phone`),
    b = c ? (n ?? v) : `phone`,
    [x] = (0, Ri.useState)(Ei),
    S;
  t[0] !== s || t[1] !== x
    ? ((S = { hostId: s, openId: x }), (t[0] = s), (t[1] = x), (t[2] = S))
    : (S = t[2]);
  let C = f(xe, S),
    T = d && !p,
    E = T && C.error == null ? (C.data ?? null) : null,
    ee = E?.manualPairingCode ?? null,
    te = T && E == null && (C.error == null || C.isFetching),
    ne = !d || E?.pairingCode != null,
    O = b === `phone` && !d && !p,
    ie = T && b === `computer` && !te,
    k;
  t[3] !== n || t[4] !== i
  ...
  if (p) {
    ...
    let e = E?.pairingCode,
      n;
    (t[21] !== P || t[22] !== M || t[23] !== m || t[24] !== l || t[25] !== e
      ? ((n = (0, X.jsx)(Jr, {
          ariaLabel: M,
          centerLogoAriaLabel: P,
          pairingCode: e,
          platform: m,
          size: l,
        })),
    ...
    (t[27] === C.error
      ? (e = t[28])
      : ((e = (0, X.jsx)(Ii, { error: C.error })), (t[27] = C.error), (t[28] = e)),
      (F = e));
  } else if (d) {
    let e;
    (t[29] !== ee || t[30] !== C.error || t[31] !== l
      ? ((e = (0, X.jsx)(ki, { error: C.error, manualPairingCode: ee, size: l })),
        (t[29] = ee),
        (t[30] = C.error),
        (t[31] = l),
        (t[32] = e))
  ...
  let I = l === `compact` ? null : `mt-3`,
    L;
  t[34] === I
    ? (L = t[35])
    : ((L = N(`flex w-full flex-col items-center gap-4`, I)), (t[34] = I), (t[35] = L));
  let R;
  t[36] !== u || t[37] !== p || t[38] !== ae || t[39] !== b || t[40] !== c
    ? ((R =
        c && !p
          ? (0, X.jsx)(`div`, {
      ...
      (t[41] = R))
    : (R = t[41]);
  let z = l === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
  ...
  t[46] !== F || t[47] !== O
    ? ((ge = O
        ? (0, X.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: F })
        : F),
      (t[46] = F),
      (t[47] = O),
      (t[48] = ge))
  ...
  t[60] !== j
            ...
            children: [
              ...
              (0, X.jsx)(ue, {
                ...
                children: (0, X.jsx)(D, {
                  ...
                  size: `icon`,
                  children: (0, X.jsx)(Fe, {
                    className: N(`icon-xs`, C.isFetching ? `animate-spin` : null),
                  }),
                }),
              }),
            ],
    ...
    : (H = t[61]);
  let ve;
  t[62] !== he || t[63] !== ge || t[64] !== _e || t[65] !== H
    ? ((ve = (0, X.jsxs)(`div`, { className: he, children: [ge, _e, H] })),
      (t[62] = he),
      (t[63] = ge),
      (t[64] = _e),
      (t[65] = H),
    ...
    : (ve = t[66]);
  let ye;
  t[67] === ie ? (ye = t[68]) : ((ye = ie ? (0, X.jsx)(Fi, {}) : null), (t[67] = ie), (t[68] = ye));
  let U;
  t[69] !== P || t[70] !== u || t[71] !== g || t[72] !== E || t[73] !== M || t[74] !== m
    ? ((U =
        E?.pairingCode == null
          ? null
          : (0, X.jsxs)(w, {
  ...
  let Se;
  return (
    t[76] !== L || t[77] !== R || t[78] !== ve || t[79] !== ye || t[80] !== U
      ? ((Se = (0, X.jsxs)(`div`, { className: L, children: [R, ve, ye, U] })),
        (t[76] = L),
        (t[77] = R),
        (t[78] = ve),
        (t[79] = ye),
...
function Oi(e) {
  let t = (0, Li.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, X.jsx)(ie, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function Bi(e) {
  ...
  t[6] === f
    ? (p = t[7])
    : ((p = N(`flex flex-wrap items-center justify-center gap-3`, f)), (t[6] = f), (t[7] = p));
  let m;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((m =
        o === `dialog`
  ...
  let h = o === `page` && `w-full`,
    g;
  t[12] === h ? (g = t[13]) : ((g = N(`justify-center`, h)), (t[12] = h), (t[13] = g));
  let _;
  ...
  t[15] !== r || t[16] !== a || t[17] !== g
    ? ((v = (0, Z.jsx)(D, { onClick: r, size: `large`, className: g, loading: a, children: _ })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = g),
      (t[18] = v))
  ...
  return (
    t[27] !== l || t[28] !== y || t[29] !== b || t[30] !== x || t[31] !== d || t[32] !== o
      ? ((S = (0, Z.jsxs)(Vt, { variant: o, heading: l, description: u, children: [d, y, b, x] })),
        (t[27] = l),
        (t[28] = y),
        (t[29] = b),
        (t[30] = x),
...
function Hi(e) {
  ...
  t[3] === n
    ? (s = t[4])
    : ((s = (0, Z.jsx)(D, { size: `large`, className: `justify-center`, onClick: n, children: o })),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
...
function Wi(e) {
  let t = (0, qi.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = N(`flex flex-col`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(et, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(W, {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Z.jsx)(Ki, {
        icon: (0, Z.jsx)(Je, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Z.jsx)(W, {
...
var qi,
  Z,
  Ji = e(() => {
    ((qi = o()), A(), U(), k(), je(), Ne(), Ye(), tt(), Ee(), Wt(), Zt(), zi(), (Z = b()));
  });
function Yi(e) {
  let t = (0, Xi.c)(16),
...
function sa(e) {
  ...
  t[5] === b
    ? (x = t[6])
    : ((x = (0, ua.jsx)(re, { className: `sr-only`, children: b })), (t[5] = b), (t[6] = x));
  let S;
  t[7] !== h || t[8] !== f
    ? ((S = (e) => {
        (ye(h, we, { action: `continue_on_chatgpt`, step: f, surface: `dialog` }),
          L({
            event: e,
  ...
  t[10] !== a || t[11] !== h || t[12] !== f
    ? ((C = () => {
        (ye(h, we, { action: `finish_setup`, step: f, surface: `dialog` }), a(!1));
      }),
      (t[10] = a),
      (t[11] = h),
      (t[12] = f),
...
var la,
  ua,
  da = e(() => {
    ((la = o()), Se(), y(), U(), C(), V(), je(), De(), c(), oa(), (ua = b()));
  });
export {
  oa as a,
  It as c,
