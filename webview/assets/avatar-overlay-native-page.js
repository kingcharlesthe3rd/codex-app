...
import { at as Ne, ot as Pe } from "./app-initial~app-main~automations-page.js";
import {
  Di as Fe,
  Oi as Ie,
  Qc as Le,
        ...
        case `stop`:
          ...
          switch (r.type) {
            case `app-server-conversation`:
              ...
              return;
            case `cloud-task`:
              (await oe.mutateAsync(r.taskId), Promise.resolve(h()).catch(() => {}));
              return;
          }
          ...
          switch (r.type) {
            case `app-server-conversation`:
              (await g(`send-follow-up-message`, {
                conversationId: r.conversationId,
                prompt: e,
                serviceTier: await p(n, n.get(he, r.conversationId) ?? `local`, null),
              }),
                Promise.resolve(f()).catch(() => {}));
              return;
            case `cloud-task`:
...
function H({
  ...
  ((0, G.useEffect)(() => {
    ...
    (0, G.useEffect)(() => {
      Ut.current ||
        (f !== de &&
          ((Ut.current = !0),
          q(x.CODEX_AVATAR_OVERLAY_ACTION_OPENED, C.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
    }, [f, q]),
    $e({
  ...
  let Wt = (0, G.useCallback)(() => {
      ...
      let u = {
        ...
        ee = {
          contentState: {
            activities: F,
            activityStackBackingLayoutHeight: u.activityStackBackingLayoutHeight,
            ...
            activityStackVisibleLayoutHeight: u.activityStackVisibleLayoutHeight,
      ...
      (0, kt.default)(ee, Ht.current) ||
        ((Ht.current = ee), a.dispatchMessage(`avatar-overlay-composition-changed`, { state: ee }));
    ...
    Q = (0, G.useCallback)(
      (e, t) => {
        ...
        (t &&
          !i &&
          (q(x.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, C.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          se()),
          i &&
            !n.hasMoved &&
            o != null &&
  ...
  return (
    ...
    (0, At.jsx)(Ke, {
      ...
      mascotLayout:
        et && k != null ? { ...y.mascot, height: Math.ceil(k / Xe), width: k } : y.mascot,
