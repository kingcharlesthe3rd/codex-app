...
import { nt as Ne, rt as Pe } from "./app-initial~app-main~automations-page.js";
import {
  h as Fe,
  p as Ie,
...
import { i as Ve, n as He, r as Ue, t as We } from "./avatar-overlay-native-frame-D.js";
import {
  a as Ge,
  f as Ke,
  i as T,
...
import { n as et, t as tt } from "./use-floating-window-pointer-interactivity.js";
import { n as nt, t as rt } from "./avatar-overlay-debug-state.js";
import {
  a as it,
  c as at,
  d as D,
...
function pt({
  ...
  return n.flatMap((n) => {
    ...
    let o = k(n.rect, a.visibleRect, a.presentationRect);
    return [
      {
        ...n,
        ...i,
        chromiumPresentationRect: t ? n.rect : k(n.rect, a.contentRect, a.presentationRect),
        edgeZone: a.edgeZone,
...
function ht(e, { includeInertSurfaces: t = !1 } = {}) {
  ...
  let n = vt(e.querySelector(j)),
    r = bt(e.querySelector(St), t);
  return n == null ? null : { mascot: n, tray: r };
}
function gt(e, t, { includeInert: n = !1 } = {}) {
  return e == null
    ? []
    : Array.from(e.querySelectorAll(F))
        .flatMap((e) => {
          if ((!n && e.closest(`[inert]`) != null) || A(e)) return [];
          ...
          return [
            {
              ...(l != null && u != null && !A(l) && u.width > 0 && u.height > 0
                ? {
...
function yt(e) {
  return {
    backing: vt(e?.querySelector(P) ?? null)?.height ?? 0,
    visible: vt(e?.querySelector(wt) ?? null)?.height ?? 0,
  };
}
function bt(e, t) {
  if (e == null || A(e)) return null;
  ...
  let r = Array.from(e.querySelectorAll(F))
      .filter((e) => (t || e.closest(`[inert]`) == null) && !A(e))
    ...
    a = e.querySelector(Ct),
    o = e.querySelector(M);
  if (a == null || o == null) return { height: Math.ceil(n.height), width: i };
  let s = o.getBoundingClientRect(),
    c = Math.max(
      0,
      ...Array.from(o.querySelectorAll(L)).map((e) => e.getBoundingClientRect().bottom - s.bottom),
    );
...
var j,
  ...
  Tt = e(() => {
    ((j = `.codex-avatar-root`),
      (St = `[data-avatar-overlay-size='notification-tray']`),
      (Ct = `[data-avatar-overlay-size='notification-tray-header']`),
      (M = `[data-avatar-overlay-size='notification-tray-list']`),
      (N = `[data-avatar-overlay-measure='notification-tray-row']`),
      (P = `[data-avatar-overlay-size='notification-stack-backing-layout']`),
      (wt = `[data-avatar-overlay-size='notification-stack-visible-layout']`),
      (F = `[data-avatar-overlay-native-surface-id]`),
      (I = `[data-avatar-overlay-chromium-overflow='true']`),
      (L = `[data-avatar-overlay-backing-canvas='true']`),
      (R = [j, St, Ct, M, N, P, wt, F, I]));
  });
function z() {
  let e = (0, U.c)(13),
  ...
  if (
    ...
    return null;
  let c;
  e[6] !== t || e[7] !== n ? ((c = Ot(t, n)), (e[6] = t), (e[7] = n), (e[8] = c)) : (c = e[8]);
  let l;
  return (
    e[9] !== t || e[10] !== n || e[11] !== c
      ? ((l = (0, jt.jsx)(B, { selectedAvatar: t, selectedAvatarId: n }, c)),
        (e[9] = t),
        (e[10] = n),
        (e[11] = c),
        (e[12] = l))
...
function B({ selectedAvatar: e, selectedAvatarId: t }) {
  let n = ne(i),
    r = je(),
    a = de() === !0,
    o = x(`451951815`),
    ...
    u = Re(Me),
    ee = ie(Ae),
    { mascotWidthPx: te, setMascotWidthPx: f } = Ye(),
    { data: re = [], refetch: p } = Ce(),
    { data: ae = [], refetch: m } = pe({ taskFilter: `current`, limit: 20 }),
    oe = C(),
    h = b(),
    ce = E({
  ...
  return (0, jt.jsx)(V, {
    ...
    dictationSupportState: u,
    latestTurnItems: (e) => (e == null ? void 0 : n.get(Oe, e)?.items),
    mascotWidthPx: te,
    productLogger: ee,
        ...
        case `stop`:
          ...
          switch (r.type) {
            case `app-server-conversation`:
              ...
              return;
            case `cloud-task`:
              (await oe.mutateAsync(r.taskId), Promise.resolve(m()).catch(() => {}));
              return;
          }
          ...
          switch (r.type) {
            case `app-server-conversation`:
              (await _(`send-follow-up-message`, {
                conversationId: r.conversationId,
                prompt: e,
                serviceTier: await se(n, n.get(ve, r.conversationId) ?? `local`, null),
              }),
                Promise.resolve(p()).catch(() => {}));
              return;
            case `cloud-task`:
...
function V({
  ...
  firstAwakeNotificationEnabled: s = !0,
  ...
  onClosePet: ue,
  onMascotClick: de,
  onMascotWidthChange: fe,
  onRefreshLocalSessions: pe,
  onRefreshRemoteSessions: me,
  onRunNotificationControl: ge,
  onRunNotificationAction: _e,
  onSubmitQuestionOption: ve,
  onSubmitQuickChat: _,
}) {
  let ye = ne(i),
    be = ie(rt),
    y = It.phase !== `inactive` && !0;
  u(Oe, void 0);
  let { data: xe } = le({ enabled: y, hostId: void 0 }),
    b = je(),
    [x, Se] = (0, W.useState)(zt),
    [S, Ce] = (0, W.useState)(!1),
    [we, Te] = (0, W.useState)(!0),
    [C, w] = (0, W.useState)(!1),
    [De, Ae] = (0, W.useState)(!1),
    [Me, Ne] = (0, W.useState)(!1),
    [Pe, Ie] = (0, W.useState)(!1),
    [Le, Re] = (0, W.useState)(null),
    [ze, Be] = (0, W.useState)(``),
    [Ve, He] = (0, W.useState)(0),
    [Ke, T] = (0, W.useState)(null),
    [qe, Ye] = (0, W.useState)([]),
    [E, Xe] = (0, W.useState)({}),
    [Ze, Qe] = (0, W.useState)(0),
    [tt, nt] = (0, W.useState)(!1),
    [it, D] = (0, W.useState)(null),
    [ct, dt] = (0, W.useState)(!1),
    [O, k] = (0, W.useState)(null),
    [mt, bt] = (0, W.useState)(() => new Map()),
    [A, xt] = (0, W.useState)(() => Date.now()),
    [j] = (0, W.useState)(() => (s ? Dt(h, se) : null)),
    St = j == null ? null : ut({ intl: b, petName: j.petName, startedAtMs: j.startedAtMs }),
    Ct = [],
    { nextNotificationExpiresAtMs: M, notifications: N } = ot({
      dismissedNotificationTurnKeys: mt,
      extraNotifications: y ? [...[], ...Ct] : St == null ? [] : [St],
    ...
    wt = lt(N, b),
    F = we ? N.map(({ id: e }) => ({ height: E[e] ?? 54, id: e })) : Pt,
    I = re({
      expanded: S || C,
      items: F,
      scrollOffset: Ze,
      viewportRect: { height: Nt, left: 0, top: 0, width: 345 },
    }),
    L = ce.some((e) => e.source !== `cloud` && e.status === `running`),
    R = ce.some((e) => e.source === `cloud` && e.status === `running`),
    Tt = m && (De || Me || Pe),
    z = (0, W.useRef)(null),
    B = (0, W.useRef)(null),
    V = (0, W.useRef)(null),
  ...
  ((0, W.useEffect)(() => {
    if (j == null) return;
    let e = a(Ft, []);
    e.includes(j.avatarId) || r(Ft, [...e, j.avatarId]);
  }, [j]),
    (0, W.useEffect)(() => {
      Ut.current ||
        (p !== Ee &&
          ((Ut.current = !0),
          q(v.CODEX_AVATAR_OVERLAY_ACTION_OPENED, g.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
    }, [p, q]),
    et({
      interactiveRegionRef: G,
      isPaused: () => z.current != null || B.current != null,
      onInteractiveChange: (e) => {
        d.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: e });
      },
      regionElementSelectors: Lt,
    }));
  let Wt = (0, W.useCallback)(() => {
      let r = ht(G.current, { includeInertSurfaces: !0 });
      if (r == null) return;
      let i = yt(G.current),
        a = pt({
          activityStackPresentation: I,
          isNotificationStackExpanded: S || C,
          measuredSurfaces: gt(G.current, n, { includeInert: !0 }),
          policies: ae({
            activityStackPresentation: I,
            isNotificationStackExpanded: S || C,
            isQuickChatVisible: Tt,
      ...
      let c = {
        ...
        u = {
          contentState: {
            activities: P,
            activityStackBackingLayoutHeight: c.activityStackBackingLayoutHeight,
            activityStackItems: c.activityStackItems,
            activityStackPresentation: c.activityStackPresentation,
            activityStackScrollOffset: c.activityStackScrollOffset,
            activityStackVisibleLayoutHeight: c.activityStackVisibleLayoutHeight,
            expandedNotificationIds: qe,
            isDarkAppearance: l,
            isNotificationStackExpanded: C,
            isQuickChatVisible: Tt,
            layout: x,
            locale: b.locale,
            notificationFollowUp: Ke,
            pointerSurfaceId: Le,
            quickChatDictation: { cleanupEnabled: e, streamingEnabled: t, supportState: o },
            quickChatDraft: ze,
            quickChatResetRevision: Ve,
          },
          measurements: c,
        };
      (0, At.default)(u, Ht.current) ||
        ((Ht.current = u), d.dispatchMessage(`avatar-overlay-composition-changed`, { state: u }));
    }, [P, E, F, I, Ze, qe, b.locale, l, C, Tt, x, S, Ke, Le, e, t, o, ze, Ve]),
    J = (0, W.useCallback)(() => {
      if (B.current != null || H.current != null) return;
      let e = ht(G.current);
      if (e == null) return;
      if (kt(Bt.current, e)) {
        if (S && K.current != null) return;
        (S || (K.current = null), Wt());
        return;
      }
      let t = Bt.current == null;
      Bt.current = e;
      let n = S && !t ? Vt.current + 1 : null;
      (n != null && (Vt.current = n),
        (K.current = n),
      ...
      (e) => {
        ((H.current = e),
          ...
          (U.current = window.setTimeout(() => {
            ((U.current = null), (H.current = null), k(null), J());
          }, 100)));
      },
      [Y, J],
    ),
    Jt = (0, W.useCallback)(
      () => vt(G.current?.querySelector(`.codex-avatar-root`) ?? null)?.width ?? f ?? 112,
      [f],
    ),
    X = (0, W.useCallback)((e, t) => {
      let n = B.current;
      n == null ||
        n.pointerId !== e ||
        ((B.current = null), nt(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
    }, []),
    Z = (0, W.useCallback)(
      (e, t) => {
        let n = B.current;
    ...
    Q = (0, W.useCallback)(
      (e, t) => {
        ...
        let {
          ...
          releaseSample: a,
          velocity: o,
        } = at(n, t ? st(e) : void 0, !t && n.usesOrbPhysics);
        (t &&
          !i &&
          (q(v.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, g.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          de()),
          i &&
            !n.hasMoved &&
            a != null &&
    ...
    Xt = (e) => {
      ...
      (Math.abs(r) < 4 && Math.abs(i) < 4) ||
        ...
        (t.screenX = n.screenX),
        (t.screenY = n.screenY),
        t.usesOrbPhysics || (r >= 4 ? D(`running-right`) : r <= -4 && D(`running-left`)),
        d.dispatchMessage(`avatar-overlay-drag-move`, {
    ...
    ln = async (e) => {
      if (!m) return;
      let t = e.trim();
      t.length !== 0 && (await _(t), Be(``), He((e) => e + 1));
    },
    $ = (0, W.useCallback)((e) => {
      ...
      switch (t.type) {
        ...
        case `submit-follow-up`: {
          ...
          (T((t) =>
            ...
            Promise.resolve(ge(e, { type: `submit-follow-up`, prompt: i }))
              .then(() => {
  ...
  return (
          ...
          case `scroll-activity-stack`:
            Qe((t) =>
              te({
                ...
                deltaY: e.deltaY,
                scrollOffset: t,
                viewportHeight: I.viewportRect.height,
              }),
            );
            return;
    ...
    oe(
      ...
      ({ elementSizeRevision: e, layout: t, nativeMaterialAttached: n }) => {
        (e === K.current && (K.current = null),
          Se(t),
          Ce(n),
          H.current === t.mascot.width && ((H.current = null), Y(), k(null)));
      },
      [Y],
    ),
    (0, W.useLayoutEffect)(() => {
      let e = (!be && ct) || tt;
      return (
        document.documentElement.classList.toggle(Rt, e),
        document.body.classList.toggle(Rt, e),
        () => {
          (document.documentElement.classList.remove(Rt), document.body.classList.remove(Rt));
        }
      );
    }, [be, ct, tt]),
    (0, W.useEffect)(
    ...
    (0, W.useEffect)(() => {
      ...
      let e = window.setTimeout(() => {
        (xt((e) => Math.max(Date.now(), e + 1)), L && pe(), R && me());
      }, Mt);
      return () => {
    ...
    (0, jt.jsx)(We, {
      ...
      mascotLayout:
        tt && O != null ? { ...x.mascot, height: Math.ceil(O / Je), width: O } : x.mascot,
      ...
      onQuickChatDraftChange: m ? Be : void 0,
      onQuickChatVisibilityChange: m ? Ae : void 0,
...
function Et(e, t) {
  return T(e.startWidthPx + t - e.startScreenX);
}
function Dt(e, t) {
  return Pe(e, t) || a(Ft, []).includes(e.id)
    ? null
...
var U, At, W, jt, Mt, Nt, Pt, Ft, It, Lt, Rt, zt;
e(() => {
  ((U = s()),
    S(),
    (At = t(ee(), 1)),
    ...
    (Nt = 208),
    (Pt = []),
    (Ft = `first-awake-pet-notification-avatar-ids`),
    (It = {
      audioStream: null,
      canStart: !1,
      caption: null,
    ...
    (Lt = [`[data-avatar-overlay-hit-region]`, `[data-avatar-mascot='true']`]),
    (Rt = `codex-avatar-overlay-force-resize-cursor`),
    (zt = {
...
export { z as AvatarOverlayNativePage };
