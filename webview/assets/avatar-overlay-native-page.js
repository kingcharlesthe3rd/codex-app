...
import { gt as je, ht as Me } from "./app-initial~app-main~automations-page.js";
import {
  D as Ne,
  y as Pe,
...
import { i as Ve, n as He, r as Ue, t as We } from "./avatar-overlay-native-frame.js";
import {
  a as Ge,
  f as D,
  i as Ke,
        ...
        case `stop`:
          ...
          switch (r.type) {
            case `app-server-conversation`:
              ...
              return;
            case `cloud-task`:
              (await oe.mutateAsync(r.taskId), Promise.resolve(g()).catch(() => {}));
              return;
          }
          ...
          switch (r.type) {
            case `app-server-conversation`:
              (await E(`send-follow-up-message`, {
                conversationId: r.conversationId,
                prompt: e,
                serviceTier: await ie(n, n.get(xe, r.conversationId) ?? `local`, null),
              }),
                Promise.resolve(h()).catch(() => {}));
              return;
            case `cloud-task`:
          ...
          case `plan-start`:
            if (r?.kind === `plan` && t.planStartCollaborationMode != null) {
              E(`update-thread-settings-for-next-turn`, {
                ...
                .then(() =>
                  E(`remove-plan-implementation-request`, { conversationId: i, turnId: r.turnId }),
                )
                .then(async () =>
...
function H({
  ...
  let { data: xe } = me({ enabled: _, hostId: void 0 }),
    ...
    xt = M == null ? null : lt({ intl: v, petName: M.petName, startedAtMs: M.startedAtMs }),
    St = [],
  ...
  ((0, G.useEffect)(() => {
    ...
    (0, G.useEffect)(() => {
      Ut.current ||
        (f !== Ee &&
          ((Ut.current = !0),
          q(x.CODEX_AVATAR_OVERLAY_ACTION_OPENED, S.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
    }, [f, q]),
    $e({
  ...
  let Wt = (0, G.useCallback)(() => {
      ...
      (0, kt.default)(c, Ht.current) ||
        ((Ht.current = c), m.dispatchMessage(`avatar-overlay-composition-changed`, { state: c }));
    }, [F, Ye, I, L, Ze, Ke, v.locale, u, w, wt, y, b, He, Ie, e, t, n, Re, Be]),
    J = (0, G.useCallback)(() => {
    ...
    Jt = (0, G.useCallback)(
      () => _t(K.current?.querySelector(`.codex-avatar-root`) ?? null)?.width ?? d ?? 112,
      [d],
    ),
    ...
    Q = (0, G.useCallback)(
      (e, t) => {
        ...
        (t &&
          !i &&
          (q(x.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, S.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          se()),
          i &&
            !n.hasMoved &&
            a != null &&
    ...
    un = (e, t, n = !0) => {
      ...
      switch (t.type) {
        ...
        case `open-follow-up`:
          ...
          (D({ notificationId: e.id, submissionStatus: `idle`, turnKey: e.turnKey }), n && $(!0));
          return;
        case `stop`:
          if (r == null) return;
          (D(null),
  ...
  return (
    ...
    (0, At.jsx)(We, {
      ...
      mascotLayout:
        et && k != null ? { ...y.mascot, height: Math.ceil(k / Je), width: k } : y.mascot,
