...
import { nn as Be, tn as Ve } from "./app-initial~app-main~automations-page.js";
import { i as He, n as E, r as Ue, t as We } from "./avatar-overlay-native-frame.js";
import {
  a as Ge,
  f as Ke,
  i as qe,
...
import { n as nt, t as rt } from "./avatar-overlay-debug-state-Dz-uULi-.js";
import {
  a as it,
  c as at,
  d as D,
...
function yt(e) {
  return {
    backing: vt(e?.querySelector(F) ?? null)?.height ?? 0,
    visible: vt(e?.querySelector(Ct) ?? null)?.height ?? 0,
  };
}
function bt(e, t) {
  if (e == null || A(e)) return null;
...
var j,
  ...
  wt = e(() => {
    ((j = `.codex-avatar-root`),
      (M = `[data-avatar-overlay-size='notification-tray']`),
...
function B() {
  ...
  (e[0] === r
    ? ((i = e[1]), (o = e[2]))
    : ((i = () => {
        r && a.dispatchMessage(`avatar-overlay-pointer-interaction-changed`, { isInteractive: !1 });
      }),
      (o = [r]),
      (e[0] = r),
      (e[1] = i),
  ...
  if (
    (e[3] === r
      ? ((s = e[4]), (c = e[5]))
      : ((s = () => {
          r && a.dispatchMessage(`avatar-overlay-composition-changed`, { state: null });
        }),
        (c = [r]),
        (e[3] = r),
        (e[4] = s),
...
function V({ selectedAvatar: e, selectedAvatarId: t }) {
  let n = de(c),
    ...
    f = Ne(ee),
    p = pe(ae),
    { mascotWidthPx: m, setMascotWidthPx: ne } = Xe(),
    { data: ie = [], refetch: h } = l(),
    { data: oe = [], refetch: se } = re({ taskFilter: `current`, limit: 20 }),
    ce = be(),
    le = ke(),
    ue = Ze({
  ...
  return (0, At.jsx)(H, {
        ...
        case `stop`:
          ...
          switch (r.type) {
            case `app-server-conversation`:
              ...
              return;
            case `cloud-task`:
              (await ce.mutateAsync(r.taskId), Promise.resolve(se()).catch(() => {}));
              return;
          }
          ...
          switch (r.type) {
            case `app-server-conversation`:
              (await _(`send-follow-up-message`, {
                conversationId: r.conversationId,
                prompt: e,
                serviceTier: await Fe(n, n.get(we, r.conversationId) ?? `local`, null),
              }),
                Promise.resolve(h()).catch(() => {}));
              return;
            case `cloud-task`:
    ...
    onRunNotificationAction: (e, t) => {
          ...
          case `mcp-elicitation`:
            if (t.mcpElicitationAction != null && r?.kind === `tool`) {
              _(`reply-with-mcp-server-elicitation-response`, {
                conversationId: i,
                requestId: r.requestId,
                response: he(t.mcpElicitationAction),
              }).then(() => {
                h();
              });
              return;
      ...
      (t != null && t.intent !== `open`) ||
        (e.action != null && a.dispatchMessage(`open-in-main-window`, { path: e.action.path }));
    },
...
function H({
  ...
  let _e = de(c),
    ve = pe(rt),
    y = Ft.phase !== `inactive` && !0;
  fe(De, void 0);
  let { data: ye } = ue({ enabled: y, hostId: void 0 }),
    b = te(),
    [x, be] = (0, G.useState)(Rt),
    [S, xe] = (0, G.useState)(!1),
    [Ce, we] = (0, G.useState)(!0),
    [C, T] = (0, G.useState)(!1),
    [ke, je] = (0, G.useState)(!1),
    [Me, Ne] = (0, G.useState)(!1),
    [Pe, Fe] = (0, G.useState)(!1),
    [Ie, Le] = (0, G.useState)(null),
    [Re, ze] = (0, G.useState)(``),
    [Be, Ve] = (0, G.useState)(0),
    [He, E] = (0, G.useState)(null),
    [Ke, qe] = (0, G.useState)([]),
    [Je, Xe] = (0, G.useState)({}),
    [Ze, Qe] = (0, G.useState)(0),
    [tt, nt] = (0, G.useState)(!1),
    [it, D] = (0, G.useState)(null),
    [ct, dt] = (0, G.useState)(!1),
    [O, k] = (0, G.useState)(null),
    [mt, bt] = (0, G.useState)(() => new Map()),
    [A, xt] = (0, G.useState)(() => Date.now()),
    [j] = (0, G.useState)(() => (r ? Et(p, ee) : null)),
    M = j == null ? null : ut({ intl: b, petName: j.petName, startedAtMs: j.startedAtMs }),
    St = [],
    { nextNotificationExpiresAtMs: N, notifications: P } = ot({
      dismissedNotificationTurnKeys: mt,
      extraNotifications: y ? [...[], ...St] : M == null ? [] : [M],
    ...
    F = P.map((e) => ({
      copy: Ue({
        intl: b,
        latestTurnItems:
          e.source === `local` && !e.id.startsWith(`realtime-`) ? l(e.localConversationId) : void 0,
        notification: e,
    ...
    Ct = lt(P, b),
    I = Ce ? P.map(({ id: e }) => ({ height: Je[e] ?? 54, id: e })) : Nt,
    L = Oe({
      expanded: S || C,
      items: I,
      scrollOffset: Ze,
    ...
    R = m.some((e) => e.source !== `cloud` && e.status === `running`),
    z = m.some((e) => e.source === `cloud` && e.status === `running`),
    wt = f && (ke || Me || Pe),
    B = (0, G.useRef)(null),
    V = (0, G.useRef)(null),
    H = (0, G.useRef)(null),
  ...
  ((0, G.useEffect)(() => {
    if (j == null) return;
    let e = ge(Pt, []);
    e.includes(j.avatarId) || Ee(Pt, [...e, j.avatarId]);
  }, [j]),
    (0, G.useEffect)(() => {
      Ut.current ||
        (d !== ie &&
          ((Ut.current = !0),
          q(v.CODEX_AVATAR_OVERLAY_ACTION_OPENED, w.CODEX_AVATAR_OVERLAY_SOURCE_UNSPECIFIED)));
    }, [d, q]),
    et({
  ...
  let Wt = (0, G.useCallback)(() => {
      let r = ht(K.current, { includeInertSurfaces: !0 });
      if (r == null) return;
      let i = yt(K.current),
        o = pt({
          activityStackPresentation: L,
          isNotificationStackExpanded: S || C,
          measuredSurfaces: gt(K.current, me, { includeInert: !0 }),
          policies: Ae({
            activityStackPresentation: L,
            isNotificationStackExpanded: S || C,
      ...
      if (!(0, kt.default)(Je, c) && (Xe(c), S)) return;
      let l = {
      ...
      (0, kt.default)(u, Ht.current) ||
        ((Ht.current = u), a.dispatchMessage(`avatar-overlay-composition-changed`, { state: u }));
    }, [F, Je, I, L, Ze, Ke, b.locale, s, C, wt, x, S, He, Ie, e, t, n, Re, Be]),
    J = (0, G.useCallback)(() => {
      ...
      (e) => {
        ((U.current = e),
          ...
          (W.current = window.setTimeout(() => {
            ((W.current = null), (U.current = null), k(null), J());
          }, 100)));
      },
      [Y, J],
    ),
    Jt = (0, G.useCallback)(
      () => vt(K.current?.querySelector(`.codex-avatar-root`) ?? null)?.width ?? u ?? 112,
      [u],
    ),
    X = (0, G.useCallback)((e, t) => {
      ...
      n == null ||
        n.pointerId !== e ||
        ((V.current = null), nt(!1), t?.hasPointerCapture?.(e) && t.releasePointerCapture?.(e));
    }, []),
    Z = (0, G.useCallback)(
      (e, t) => {
        let n = V.current;
    ...
    Q = (0, G.useCallback)(
      (e, t) => {
        ...
        (t &&
          !i &&
          (q(v.CODEX_AVATAR_OVERLAY_ACTION_MASCOT_CLICKED, w.CODEX_AVATAR_OVERLAY_SOURCE_MASCOT),
          re()),
          i &&
            !n.hasMoved &&
            o != null &&
    ...
    ln = async (e) => {
      if (!f) return;
      let t = e.trim();
      t.length !== 0 && (await he(t), ze(``), Ve((e) => e + 1));
    },
    $ = (0, G.useCallback)((e) => {
  ...
  return (
    ...
    se(
      ...
      ({ elementSizeRevision: e, layout: t, nativeMaterialAttached: n }) => {
        (e === Vt.current && (Vt.current = null),
          be(t),
          xe(n),
          U.current === t.mascot.width && ((U.current = null), Y(), k(null)));
      },
      [Y],
    ),
    (0, G.useLayoutEffect)(() => {
    ...
    (0, G.useEffect)(() => {
      ...
      let e = window.setTimeout(() => {
        (xt((e) => Math.max(Date.now(), e + 1)), R && h(), z && g());
      }, jt);
      return () => {
    ...
    (0, At.jsx)(We, {
      ...
      mascotLayout:
        tt && O != null ? { ...x.mascot, height: Math.ceil(O / Ye), width: O } : x.mascot,
      mascotResizeHandle: ve
        ? void 0
        : {
      ...
      onQuickChatDraftChange: f ? ze : void 0,
      onQuickChatVisibilityChange: f ? je : void 0,
...
function Et(e, t) {
  return Be(e, t) || ge(Pt, []).includes(e.id)
    ? null
