...
import { Tn as _ } from "./use-host-config-C.js";
import { A as v, j as y } from "./vscode-api.js";
var b = class extends f {
  ...
  resumePausedMutations() {
    ...
    return h.batch(() => Promise.all(e.map((e) => e.continue().catch(l))));
  }
};
function x(e) {
...
var S = class extends f {
    ...
    find(e) {
      let t = { exact: !0, ...e };
      return this.getAll().find((e) => r(t, e));
    }
    findAll(e = {}) {
      let t = this.getAll();
      return Object.keys(e).length > 0 ? t.filter((t) => r(e, t)) : t;
    }
    notify(e) {
      h.batch(() => {
        this.listeners.forEach((t) => {
  ...
  C = class {
    ...
    #s;
    constructor(e = {}) {
      ((this.#e = e.queryCache || new S()),
        (this.#t = e.mutationCache || new b()),
    ...
    mount() {
      (this.#a++,
        this.#a === 1 &&
          ((this.#o = s.subscribe(async (e) => {
            e && (await this.resumePausedMutations(), this.#e.onFocus());
          })),
          (this.#s = t.subscribe(async (e) => {
    ...
    ensureQueryData(e) {
      ...
      return r === void 0
        ? this.fetchQuery(e)
        : (e.revalidateIfStale && n.isStaleByTime(a(t.staleTime, n)) && this.prefetchQuery(t),
          Promise.resolve(r));
    }
    getQueriesData(e) {
    ...
    setQueryData(e, t, n) {
      let r = this.defaultQueryOptions({ queryKey: e }),
        ...
        o = i(t, a);
      if (o !== void 0) return this.#e.build(this, r).setData(o, { ...n, manual: !0 });
    }
    ...
    resumePausedMutations() {
      return t.isOnline() ? this.#t.resumePausedMutations() : Promise.resolve();
    }
    getQueryCache() {
      return this.#e;
    }
    ...
    setQueryDefaults(e, t) {
      this.#r.set(o(e), { queryKey: e, defaultOptions: t });
    }
    getQueryDefaults(e) {
      let t = [...this.#r.values()],
        n = {};
      return (
        t.forEach((t) => {
          d(e, t.queryKey) && Object.assign(n, t.defaultOptions);
        }),
        n
      );
    }
    setMutationDefaults(e, t) {
      this.#i.set(o(e), { mutationKey: e, defaultOptions: t });
    }
    getMutationDefaults(e) {
      ...
      return (
        t.forEach((t) => {
          d(e, t.mutationKey) && Object.assign(n, t.defaultOptions);
        }),
        n
      );
    }
...
function E(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, T.jsx)(g, { queryClient: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
