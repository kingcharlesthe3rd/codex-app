...
import { a as r, l as i, n as a, o, r as s, s as c, t as l } from "./dist-3.js";
import { a as u, i as d, n as f, r as ee, t as te } from "./chunk-50.js";
function p(e) {
  return function (t) {
      ...
      (tn = f(async (e, t) => {
          ...
          return e.replace(Qt, `MathML is unsupported in this environment.`);
        {
          let { default: r } = await n(
            ...
            i = t.forceLegacyMathML || (!Zt() && t.legacyMathML) ? `htmlAndMathml` : `mathml`;
          return e
            .split(Pt)
            .map((e) =>
              $t(e)
