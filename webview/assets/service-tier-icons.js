...
import { Ts as s, y as c } from "./app-server-manager-signals.js";
import { A as l, _ as u, h as d, u as f, v as p } from "./vscode-api.js";
import {
  Ii as m,
  Ji as h,
  Li as g,
...
import { a as w, i as T } from "./setting-storage.js";
import { t as E } from "./invalidate-queries-and-broadcast.js";
import { u as D } from "./config-queries.js";
var O = o(),
  k = x({ sandbox: h([`elevated`, `unelevated`]).optional() }).passthrough(),
...
async function M(e) {
  try {
    return (await s(`get-windows-sandbox-readiness-for-host`, { hostId: e })).status;
  } catch (e) {
    throw (
      d.error(`Failed to load Windows sandbox readiness`, { safe: {}, sensitive: { error: e } }), e
    );
  }
}
function N(e) {
  ...
  t[2] !== s || t[3] !== r
    ? ((u = async () => {
        try {
          return I((await D(s, r, null, !1)).config.windows);
        } catch (e) {
          let t = e;
          return (
            d.error(`Failed to load Windows sandbox mode`, {
              safe: { error: String(t) },
              sensitive: {},
            }),
            null
  ...
  return (
    t[5] !== o || t[6] !== u
      ? ((m = { queryKey: o, queryFn: u, staleTime: f.ONE_MINUTE }),
        (t[5] = o),
        (t[6] = u),
        (t[7] = m))
      : (m = t[7]),
...
function P(e) {
  let t = (0, O.c)(8),
    ...
    r = e?.hostId ?? n,
    a;
  t[0] === r ? (a = t[1]) : ((a = j(r)), (t[0] = r), (t[1] = a));
  let o;
  t[2] === r ? (o = t[3]) : ((o = () => M(r)), (t[2] = r), (t[3] = o));
  let s = e?.enabled ?? !0,
    l;
  return (
    t[4] !== a || t[5] !== o || t[6] !== s
      ? ((l = { queryKey: a, queryFn: o, staleTime: f.INFINITE, enabled: s }),
        (t[4] = a),
        (t[5] = o),
        (t[6] = s),
        (t[7] = l))
...
function F(e) {
  let t = (0, O.c)(19),
    ...
    o = E(),
    f;
  t[0] === r ? (f = t[1]) : ((f = A(r)), (t[0] = r), (t[1] = f));
  let p = f,
    m;
  t[2] === r ? (m = t[3]) : ((m = j(r)), (t[2] = r), (t[3] = m));
  let h = m,
    g;
  t[4] === r
    ? (g = t[5])
    : ((g = (e) =>
        s(`batch-write-config-value-for-host`, {
          hostId: r,
          edits: [
            {
  ...
  t[6] !== a || t[7] !== p
    ? ((_ = (e) => {
      ...
      (v = (e, t, n) => {
        (d.error(`Failed to update Windows sandbox mode`, {
          safe: { error: String(e) },
          sensitive: {},
        }),
    ...
    : ((_ = t[8]), (v = t[9]));
  let y;
  t[10] !== o || t[11] !== p || t[12] !== h
    ? ((y = async () => {
        await Promise.all([o(p), o(h)]);
      }),
      (t[10] = o),
      (t[11] = p),
      (t[12] = h),
...
function R() {
  let e = (0, O.c)(7),
    t = r(a),
    n = w(_.followUpQueueMode),
    i = n === `interrupt` ? `steer` : (n ?? `queue`),
    o,
    s;
  (e[0] !== n || e[1] !== t
    ? ((o = () => {
        n === `interrupt` && T(t, _.followUpQueueMode, `steer`);
      }),
      (s = [n, t]),
      (e[0] = n),
      (e[1] = t),
...
function H({ hasPlanMode: e, hasDefaultMode: t, isPlanMode: n, setSelectedMode: r }) {
  ...
  return t
    ? e.key === `Escape` && !e.metaKey && !e.ctrlKey && !e.altKey && !e.shiftKey
      ...
      : e.key === `Tab` &&
          ...
          !e.ctrlKey &&
          !e.altKey &&
          H({ hasPlanMode: r, hasDefaultMode: i, isPlanMode: a, setSelectedMode: o })
...
var W = n();
function G(e) {
  return typeof e == `string` ? (0, W.jsx)(W.Fragment, { children: e }) : (0, W.jsx)(C, { ...e });
}
function K(e, t) {
...
function Z({
  ...
  let a = e ? [`read-only`, `auto`, `granular`, `full-access`, `custom`] : v(t, n),
    o = y(n ?? void 0) ?? !0,
    s = r,
    ...
    p = g(n ?? void 0, i),
    h = p === `full-access` ? null : p,
    _ = d && p === `auto` && S(m(n ?? void 0)),
    b = Y(f);
  return (
    _ ? (b = `guardian-approvals`) : h != null && f.includes(h) && (b = h),
    {
      availableAgentModes: u,
      canShowCustom: u.includes(`custom`),
      canUnlock: u.includes(`full-access`),
      customEquivalentMode: _ ? `guardian-approvals` : p,
