...
import { js as s, v as c } from "./app-server-manager-signals.js";
import { _ as l, g as u, k as d, m as f, u as p } from "./vscode-api.js";
import {
  Ai as m,
  Ci as h,
  Ei as g,
...
var O = r(),
  k = b({ sandbox: _([`elevated`, `unelevated`]).optional() }).passthrough(),
...
async function M(e) {
  try {
    ...
    throw (
      f.error(`Failed to load Windows sandbox readiness`, { safe: {}, sensitive: { error: e } }), e
    );
  }
}
function N(e) {
  ...
  t[2] !== s || t[3] !== r
    ? ((u = async () => {
        try {
          ...
          let t = e;
          return (
            f.error(`Failed to load Windows sandbox mode`, {
              safe: { error: String(t) },
              sensitive: {},
            }),
            null
  ...
  return (
    t[5] !== o || t[6] !== u
      ? ((m = { queryKey: o, queryFn: u, staleTime: p.ONE_MINUTE }),
        (t[5] = o),
        (t[6] = u),
        (t[7] = m))
      : (m = t[7]),
...
function P(e) {
  ...
  return (
    t[4] !== i || t[5] !== o || t[6] !== s
      ? ((u = { queryKey: i, queryFn: o, staleTime: p.INFINITE, enabled: s }),
        (t[4] = i),
        (t[5] = o),
        (t[6] = s),
        (t[7] = u))
...
function F(e) {
  ...
  t[6] !== i || t[7] !== p
    ? ((_ = (e) => {
        let t = i.getQueryData(p);
        return (i.setQueryData(p, e), { previousMode: t });
      }),
      (v = (e, t, n) => {
        (f.error(`Failed to update Windows sandbox mode`, {
          safe: { error: String(e) },
          sensitive: {},
        }),
          n?.previousMode !== void 0 && i.setQueryData(p, n.previousMode));
      }),
      (t[6] = i),
      (t[7] = p),
      (t[8] = _),
...
function R() {
  let e = (0, O.c)(7),
    t = i(o),
    n = w(y.followUpQueueMode),
    r = n === `interrupt` ? `steer` : (n ?? `queue`),
    a,
    s;
  (e[0] !== n || e[1] !== t
    ? ((a = () => {
        n === `interrupt` && T(t, y.followUpQueueMode, `steer`);
      }),
      (s = [n, t]),
      (e[0] = n),
      (e[1] = t),
  ...
  return (
    e[4] !== r || e[5] !== c
      ? ((l = { mode: r, isQueueingEnabled: c }), (e[4] = r), (e[5] = c), (e[6] = l))
      : (l = e[6]),
    l
  );
}
...
function Z({
  ...
  let a = e ? [`read-only`, `auto`, `granular`, `full-access`, `custom`] : m(t, n),
    o = v(n ?? void 0) ?? !0,
    s = r,
    ...
    p = S(n ?? void 0, i),
    _ = p === `full-access` ? null : p,
    y = d && p === `auto` && g(h(n ?? void 0)),
    b = Y(f);
  return (
    y ? (b = `guardian-approvals`) : _ != null && f.includes(_) && (b = _),
    {
      availableAgentModes: u,
      canShowCustom: u.includes(`custom`),
      canUnlock: u.includes(`full-access`),
      customEquivalentMode: y ? `guardian-approvals` : p,
