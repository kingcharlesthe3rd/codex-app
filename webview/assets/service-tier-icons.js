...
import { _ as s, g as c, k as l, m as u, u as d } from "./vscode-api.js";
import {
  Bt as f,
  C as p,
  Gt as m,
...
import { As as x, v as S } from "./app-server-manager-signals.js";
...
import { u as D } from "./config-queries-BHYT-TjG.js";
var O = r(),
  ee = v({ sandbox: g([`elevated`, `unelevated`]).optional() }).passthrough(),
...
async function j(e) {
  try {
    return (await x(`get-windows-sandbox-readiness-for-host`, { hostId: e })).status;
  } catch (e) {
    throw (
...
function M(e) {
  ...
  t[2] !== c || t[3] !== r
    ? ((f = async () => {
        try {
          return F((await D(c, r, null, !1)).config.windows);
        } catch (e) {
          let t = e;
          return (
  ...
  return (
    t[5] !== o || t[6] !== f
      ? ((p = { queryKey: o, queryFn: f, staleTime: d.ONE_MINUTE }),
        (t[5] = o),
        (t[6] = f),
        (t[7] = p))
      : (p = t[7]),
...
function N(e) {
  ...
  let o;
  t[2] === r ? (o = t[3]) : ((o = () => j(r)), (t[2] = r), (t[3] = o));
  let c = e?.enabled ?? !0,
    l;
  return (
    t[4] !== i || t[5] !== o || t[6] !== c
      ? ((l = { queryKey: i, queryFn: o, staleTime: d.INFINITE, enabled: c }),
        (t[4] = i),
        (t[5] = o),
        (t[6] = c),
        (t[7] = l))
...
function P(e) {
  let t = (0, O.c)(19),
    ...
    o = E(),
    s;
  t[0] === r ? (s = t[1]) : ((s = k(r)), (t[0] = r), (t[1] = s));
  let d = s,
    f;
  t[2] === r ? (f = t[3]) : ((f = A(r)), (t[2] = r), (t[3] = f));
  let p = f,
    m;
  t[4] === r
    ? (m = t[5])
    : ((m = (e) =>
        x(`batch-write-config-value-for-host`, {
          hostId: r,
          edits: [
            {
  ...
  t[6] !== i || t[7] !== d
    ? ((h = (e) => {
        let t = i.getQueryData(d);
        return (i.setQueryData(d, e), { previousMode: t });
      }),
      (g = (e, t, n) => {
        (u.error(`Failed to update Windows sandbox mode`, {
          ...
          n?.previousMode !== void 0 && i.setQueryData(d, n.previousMode));
      }),
      (t[6] = i),
      (t[7] = d),
      (t[8] = h),
    ...
    : ((h = t[8]), (g = t[9]));
  let _;
  t[10] !== o || t[11] !== d || t[12] !== p
    ? ((_ = async () => {
        await Promise.all([o(d), o(p)]);
      }),
      (t[10] = o),
      (t[11] = d),
      (t[12] = p),
  ...
  return (
    t[14] !== m || t[15] !== h || t[16] !== g || t[17] !== _
      ? ((v = { mutationFn: m, onMutate: h, onError: g, onSettled: _ }),
        (t[14] = m),
        (t[15] = h),
        (t[16] = g),
        (t[17] = _),
...
function L() {
  let e = (0, O.c)(7),
    t = i(o),
    n = w(p.followUpQueueMode),
    r = n === `interrupt` ? `steer` : (n ?? `queue`),
    a,
    s;
  (e[0] !== n || e[1] !== t
    ? ((a = () => {
        n === `interrupt` && T(t, p.followUpQueueMode, `steer`);
      }),
      (s = [n, t]),
      (e[0] = n),
      (e[1] = t),
...
function X({
  ...
  let a = e ? [`read-only`, `auto`, `granular`, `full-access`, `custom`] : b(t, n),
    o = m(n ?? void 0) ?? !0,
    s = r,
    ...
    p = u.filter((e) => e !== `custom`),
    h = y(n ?? void 0, i),
    g = h === `full-access` ? null : h,
    v = d && h === `auto` && _(f(n ?? void 0)),
    x = J(p);
  return (
    v ? (x = `guardian-approvals`) : g != null && p.includes(g) && (x = g),
    {
      availableAgentModes: u,
      canShowCustom: u.includes(`custom`),
      canUnlock: u.includes(`full-access`),
      customEquivalentMode: v ? `guardian-approvals` : h,
