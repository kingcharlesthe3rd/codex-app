...
import { fs as u, v as d } from "./app-server-manager-signals.js";
...
import { t as ee } from "./invalidate-queries-and-broadcast.js";
import { u as w } from "./config-queries.js";
import { a as T, i as E } from "./setting-storage.js";
var D = b(),
  O = c({ sandbox: t([`elevated`, `unelevated`]).optional() }).passthrough(),
...
async function j(e) {
  try {
    ...
    throw (
      v.error(`Failed to load Windows sandbox readiness`, { safe: {}, sensitive: { error: e } }), e
    );
  }
}
function M(e) {
...
function X({
  ...
  defaultWorkspaceWriteMode: c = `auto`,
}) {
