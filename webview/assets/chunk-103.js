...
var Bs = class extends Co {
  ...
  buildLookaheadForAlternation(e) {
    let { prodOccurrence: t, rule: i, hasPredicates: a, dynamicTokensEnabled: o } = e,
      ...
      f = l(ba({ maxLookahead: 1, occurrence: t, prodType: `Alternation`, rule: i }), (e) =>
        l(e, (e) => e[0]),
      );
    if (Vs(f, !1) && !o) {
      let e = r(
  ...
  buildLookaheadForOptional(e) {
    let { prodOccurrence: t, rule: i, prodType: a, dynamicTokensEnabled: s } = e,
      ...
      m = l(ba({ maxLookahead: 1, occurrence: t, prodType: a, rule: i }), (e) => l(e, (e) => e[0]));
    if (Vs(m) && m[0][0] && !s) {
      let e = m[0],
        t = c(e);
