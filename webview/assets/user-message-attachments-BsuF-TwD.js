...
import { R as i, a, g as o, o as s, s as c } from "./app-scope.js";
import { D as l, Ha as u, li as d } from "./app-server-manager-signals.js";
import { _ as f, k as p, l as m, m as h, o as g, s as _, u as v } from "./vscode-api.js";
import { Zi as y, na as b } from "./src-1.js";
import { c as ee, o as x, t as S } from "./lib.js";
import { c as C } from "./persisted-signal.js";
...
import { t as k } from "./context-menu-Cx-ZCB4Y.js";
import { t as A } from "./request.js";
import { t as j } from "./open-workspace-file.js";
import { t as M } from "./chevron.js";
import { t as N } from "./warning.js";
import { t as P } from "./route-scope.js";
import { n as F, t as I } from "./prompt-text.js";
import { t as L } from "./thread-detail-level.js";
import { _ as te, g as R } from "./use-plugins.js";
import { t as z } from "./pencil.js";
import { m as B } from "./inline-mentions.js";
import { t as V } from "./workspace-file-context-menu.js";
import { t as ne } from "./copy.js";
import { t as re } from "./image-preview-dialog.js";
import { t as ie } from "./pull-request-open.js";
import { i as ae, n as H, r as oe, s as se, t as U } from "./composer-controller.js";
import { n as W } from "./attachment-remove-button.js";
import { a as G, i as K, n as ce, r as q, t as le } from "./mention-metadata-syncer-Bc-bkkFL.js";
import { t as ue } from "./use-enter-behavior.js";
import { d as de } from "./hooks-settings-model.js";
import { r as fe } from "./use-composer-controller.js";
import { t as pe } from "./at-mention-list-2.js";
...
function ye(e) {
  ...
  t[6] === s
    ? (u = t[7])
    : ((u = (0, Q.jsx)(T, { "aria-label": s, color: `ghost`, size: `icon`, children: l })),
      (t[6] = s),
      (t[7] = u));
  let d;
  return (
        ...
        l === `uncollapsible`
          ...
          : (0, Q.jsxs)(`button`, {
              ...
              children: [
                ...
                (0, Q.jsx)(M, { className: l === `expanded` ? `icon-2xs rotate-180` : `icon-2xs` }),
              ],
            })),
      (t[12] = l),
      (t[13] = u),
...
function Fe(e) {
  let t = (0, X.c)(93),
    ...
    ie = u(n),
    ae = ie.trim(),
    H = E != null && A != null && !ie.startsWith(`PLEASE IMPLEMENT THIS PLAN:`),
    ...
    de = le || f != null || !F,
    fe;
  t[0] !== K || t[1] !== se || t[2] !== k || t[3] !== ae || t[4] !== A
    ? ((fe = () => {
        (k != null &&
          A != null &&
          ...
          navigator.clipboard.writeText(d(ae)).then(() => {
  ...
  let ge = he,
    _e;
  t[12] !== U || t[13] !== K || t[14] !== J || t[15] !== k || t[16] !== ae || t[17] !== A
    ? ((_e = () => {
        (k != null &&
          A != null &&
          K.submitCodexAnalyticsEvent?.({
  ...
  let be = ve,
    xe;
  t[21] !== i || t[22] !== j || t[23] !== ce || t[24] !== q || t[25] !== M
    ? ((xe = q
        ? (0, Q.jsx)(Oe, { text: ce, cwd: j ?? null, hostId: M, collapsedLineCount: i })
        : (0, Q.jsx)(`div`, {
      ...
      (Ce = W
        ...
        : ue
          ? H
            ...
            : (0, Q.jsx)(`div`, { "data-user-message-bubble": !0, className: e, children: Se })
          : null),
      (t[27] = H),
      (t[28] = j),
      (t[29] = U),
  ...
  let we = Ce,
    Te;
  t[48] !== F || t[49] !== $ || t[50] !== q || t[51] !== W || t[52] !== we
    ? ((Te =
        F && q && !W
          ? (0, Q.jsxs)(`div`, {
    ...
    ? ((ke =
        f == null
          ...
          : (0, Q.jsxs)(`div`, {
              ...
              children: [p, (0, Q.jsx)(Ie, { children: f })],
            })),
      (t[56] = f),
      (t[57] = p),
      (t[58] = ke))
        ...
        q && !W && !F
          ? (0, Q.jsxs)(`div`, {
              className: w(
                ...
                N ? void 0 : `opacity-0 group-focus-within:opacity-100 group-hover:opacity-100`,
              ),
              children: [
                r == null
                  ? null
                ...
                (0, Q.jsxs)(`div`, {
                  ...
                  children: [
                    m == null ? null : (0, Q.jsx)(ye, { stats: m, threadDetailLevel: h }),
                    $,
                    H
                      ? (0, Q.jsx)(O, {
                          tooltipContent: (0, Q.jsx)(x, {
                          ...
                          children: (0, Q.jsx)(T, {
                            ...
                            onClick: Y,
                            children: (0, Q.jsx)(z, { className: `icon-xs` }),
                          }),
                        })
                      : null,
                  ],
...
function Ge(e) {
  ...
  let m = p,
    h;
  t[8] !== m || t[9] !== f
    ? ((h = () => V(f, m)), (t[8] = m), (t[9] = f), (t[10] = h))
    : (h = t[10]);
  let g;
  return (
    t[11] !== n || t[12] !== h
      ? ((g = (0, Q.jsx)(k, { getItems: h, children: n })), (t[11] = n), (t[12] = h), (t[13] = g))
      : (g = t[13]),
    g
  );
}
var Ke = y({ base64: b(), contentType: b().optional() }),
  qe = [`file`, `image-src`],
  Je = new WeakSet();
function Ye(e) {
...
function Qe(e, t) {
  ...
  n[5] !== e || n[6] !== t
    ? ((o = async () => {
        ...
        try {
          ...
          let a = t == null ? await ot(n) : await t.getDownloadRequest(n);
          h.debug(`Image asset download diagnostic: URL resolved`, {
            safe: { pointerScheme: i, resolverKind: r },
            sensitive: { downloadUrl: a.downloadUrl, fileId: n },
          });
          let { body: o } = await m.getInstance().get(a.downloadUrl, a.requestHeaders),
            s = Ke.parse(o);
          return (
  ...
  let s;
  n[8] !== r || n[9] !== a || n[10] !== o
    ? ((s = { enabled: r, queryKey: a, queryFn: o, staleTime: v.FIVE_MINUTES }),
      (n[8] = r),
      (n[9] = a),
      (n[10] = o),
      (n[11] = s))
    : (s = n[11]);
  let { data: c, isLoading: l, isError: u, refetch: d } = f(s),
    g = c ?? null,
    _;
  n[12] === d
    ? (_ = n[13])
  ...
  let y;
  return (
    n[14] !== u || n[15] !== l || n[16] !== g || n[17] !== _
      ? ((y = { src: g, isLoading: l, isError: u, refetch: _ }),
        (n[14] = u),
        (n[15] = l),
        (n[16] = g),
        (n[17] = _),
...
function $e(e) {
  ...
  (t[0] === e
    ...
    : ((n = () => {
        ...
        Je.add(e);
        let t = new Map();
        for (let n of e.getQueryCache().getAll())
          et(n.queryKey) && tt(t, n.queryHash, n.state.data);
        e.getQueryCache().subscribe((e) => {
          if (et(e.query.queryKey)) {
            if (e.type === `removed`) {
              (it(t.get(e.query.queryHash) ?? e.query.state.data), t.delete(e.query.queryHash));
              return;
            }
            if (e.type === `added`) {
              tt(t, e.query.queryHash, e.query.state.data);
              return;
            }
            e.type === `updated` &&
              e.action.type === `success` &&
              nt(t, e.query.queryHash, e.action.data);
          }
        });
      }),
      (r = [e]),
...
function et(e) {
  return Array.isArray(e) ? e[0] === qe[0] && e[1] === qe[1] : !1;
}
function tt(e, t, n) {
  let r = rt(n);
  r != null && e.set(t, r);
...
function rt(e) {
  return typeof e != `string` || !e.startsWith(`blob:`) ? null : e;
}
function it(e) {
  let t = rt(e);
  if (t != null)
...
function lt(e) {
  let t = (0, X.c)(42),
    ...
    h = a(l, r) ?? `local`,
    g = Ye(n) ? n : ``,
    { isError: _, src: v } = Qe(g, i),
    [y, b] = (0, Z.useState)(!1),
    S = o ?? y,
    C = s ?? b,
    w;
  t[0] !== g.length || t[1] !== n
    ? ((w = () => (g.length > 0 || R(n) != null ? null : n)),
      (t[0] = g.length),
      (t[1] = n),
      (t[2] = w))
    : (w = t[2]);
  let [T, D] = (0, Z.useState)(w),
    O = g.length > 0 ? v : T,
    k;
  t[3] === f
    ? (k = t[4])
  ...
  let P = N,
    F;
  t[9] !== h || t[10] !== g.length || t[11] !== m || t[12] !== n
    ? ((F = () => {
  ...
  let I;
  if (
    (t[14] !== h || t[15] !== g || t[16] !== m || t[17] !== n
      ? ((I = [h, g, m, n]), (t[14] = h), (t[15] = g), (t[16] = m), (t[17] = n), (t[18] = I))
      : (I = t[18]),
    (0, Z.useEffect)(F, I),
    g.length > 0 && _)
  ) {
  ...
  t[23] === C
    ? (L = t[24])
    : ((L = (e) => {
        (e.key === `Enter` || e.key === ` `) && (e.preventDefault(), C(!0));
      }),
      (t[23] = C),
      (t[24] = L));
  let z;
...
function dt(e) {
  ...
  let u = a(W, c),
    ...
    m;
  t[3] === d ? (m = t[4]) : ((m = R(d)), (t[3] = d), (t[4] = m));
  let h = m,
    _;
  t[5] !== h || t[6] !== s
    ? ((_ = [`local-user-appshot-screenshot-data-url`, s, h]), (t[5] = h), (t[6] = s), (t[7] = _))
    : (_ = t[7]);
  let y;
  t[8] !== h || t[9] !== s || t[10] !== o
    ? ((y = () => te(h, s, o)), (t[8] = h), (t[9] = s), (t[10] = o), (t[11] = y))
    : (y = t[11]);
  let b = h != null,
    x;
  t[12] !== _ || t[13] !== y || t[14] !== b
    ? ((x = { queryKey: _, queryFn: y, enabled: b, gcTime: 1 / 0, staleTime: v.INFINITE }),
      (t[12] = _),
      (t[13] = y),
      (t[14] = b),
      (t[15] = x))
  ...
  t[18] === T
    ? (D = t[19])
    : ((D = { enabled: T, staleTime: v.INFINITE, refetchOnWindowFocus: !1 }),
      (t[18] = T),
      (t[19] = D));
  let O;
  t[20] !== w || t[21] !== D
    ? ((O = { params: w, queryConfig: D, select: ft }), (t[20] = w), (t[21] = D), (t[22] = O))
    : (O = t[22]);
  let k = g(`native-desktop-app-by-bundle-id`, O).data?.appPath ?? null,
    A;
  t[23] === k ? (A = t[24]) : ((A = { appPath: k }), (t[23] = k), (t[24] = A));
  let { iconSmall: j } = B(A),
...
function ht(e) {
  ...
  return (
    t[3] === i
      ? (a = t[4])
      : ((a = (0, Q.jsx)(K, { Icon: N, children: i })), (t[3] = i), (t[4] = a)),
    a
  );
}
function gt(e) {
...
//# sourceMappingURL=user-message-attachments-BsuF-TwD.js.map
