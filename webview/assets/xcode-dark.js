var e = `Xcode Dark`,
  ...
  i = [
    { scope: [`comment`, `punctuation.definition.comment`], settings: { foreground: `#6c7986` } },
    { scope: [`string`, `constant.other.symbol`], settings: { foreground: `#fc6a5d` } },
    {
...
export { r as chromeTheme, n as colors, a as default, e as name, i as tokenColors, t as type };
