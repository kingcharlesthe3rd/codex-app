...
import { t as o } from "./button-DO-oxX3-.js";
...
function Re(e) {
  ...
  if (t[0] !== n || t[1] !== r) {
    let e = Q(),
      p = D.Children.toArray(n),
      m = p.reduce(ze, 0),
      h = (e) =>
        p.map((t) => {
          if (!D.isValidElement(t) || t.type !== o) return t;
          let n = m === 1 ? `w-full justify-center` : void 0;
          return D.cloneElement(t, { size: t.props.size ?? e, className: a(t.props.className, n) });
        });
    ((l = a(`flex w-full items-center justify-end gap-3`, e && Z, r)),
      t[9] === e
        ? (u = t[10])
        : ((u = e ? (0, O.jsx)($, { name: `DialogFooter` }) : null), (t[9] = e), (t[10] = u)),
      (d = (0, O.jsx)(T, { browser: !0, children: h(`medium`) })),
      (f = (0, O.jsx)(T, { electron: !0, children: h(`medium`) })),
      (i = T),
      (s = !0),
      (c = h(`toolbar`)),
      (t[0] = n),
      ...
      (t[7] = d),
      (t[8] = f));
  } else ((i = t[2]), (s = t[3]), (c = t[4]), (l = t[5]), (u = t[6]), (d = t[7]), (f = t[8]));
  let p;
  t[11] !== i || t[12] !== s || t[13] !== c
    ? ((p = (0, O.jsx)(i, { extension: s, children: c })),
      (t[11] = i),
      (t[12] = s),
      (t[13] = c),
      (t[14] = p))
  ...
  return (
    t[15] !== l || t[16] !== u || t[17] !== d || t[18] !== f || t[19] !== p
      ? ((m = (0, O.jsxs)(`div`, { className: l, children: [u, d, f, p] })),
        (t[15] = l),
        (t[16] = u),
        (t[17] = d),
        (t[18] = f),
