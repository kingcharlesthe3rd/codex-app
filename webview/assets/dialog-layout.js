...
import { c as s, d as c, i as l, l as u, n as d, o as f, t as p, u as m } from "./dist-13.js";
...
var B = `DialogOverlay`,
  V = D.forwardRef((e, t) => {
    ...
    return a.modal
      ? (0, O.jsx)(d, { present: r || a.open, children: (0, O.jsx)(U, { ...i, ref: t }) })
      : null;
  });
V.displayName = B;
var H = f(`DialogOverlay.RemoveScroll`),
  U = D.forwardRef((e, t) => {
    let { __scopeDialog: n, ...r } = e,
      i = M(B, n);
    return (0, O.jsx)(x, {
...
function Ee(e) {
  ...
  let E;
  return (
    t[32] !== S || t[33] !== c || t[34] !== w || t[35] !== T
      ? ((E = (0, O.jsxs)(pe, { ...c, onOpenChange: S, children: [w, T] })),
        (t[32] = S),
        (t[33] = c),
        (t[34] = w),
        (t[35] = T),
...
function Ae(e) {
  ...
  let P = E,
    F = s ?? void 0,
    I;
  t[3] === o ? (I = t[4]) : ((I = a(we, o)), (t[3] = o), (t[4] = I));
  let L;
