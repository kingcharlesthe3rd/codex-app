...
import { c as s, d as c, i as l, l as u, n as d, o as f, t as p, u as m } from "./dist-12.js";
import { a as h, i as g, n as _, o as v, r as y, s as b, t as x } from "./Combination.js";
import { n as S } from "./window-zoom-context.js";
import { n as C } from "./tooltip-dismiss.js";
...
var E = e({
  ...
  M = (e) => {
    let {
      ...
      s = D.useRef(null),
      c = D.useRef(null),
      [l, u] = p({ prop: r, defaultProp: i ?? !1, onChange: a, caller: k });
    return (0, O.jsx)(te, {
      scope: t,
      triggerRef: s,
      contentRef: c,
  ...
  R = (e) => {
    ...
    return (0, O.jsx)(I, {
      ...
      children: D.Children.map(r, (e) =>
        (0, O.jsx)(d, {
          present: n || a.open,
          children: (0, O.jsx)(y, { asChild: !0, container: i, children: e }),
        }),
      ),
    });
  };
...
var z = `DialogOverlay`,
  B = D.forwardRef((e, t) => {
    let n = L(z, e.__scopeDialog),
      ...
      a = j(z, e.__scopeDialog);
    return a.modal
      ? (0, O.jsx)(d, { present: r || a.open, children: (0, O.jsx)(V, { ...i, ref: t }) })
      : null;
  });
B.displayName = z;
var ne = f(`DialogOverlay.RemoveScroll`),
  V = D.forwardRef((e, t) => {
    let { __scopeDialog: n, ...r } = e,
      i = j(z, n);
    return (0, O.jsx)(x, {
  ...
  H = `DialogContent`,
  U = D.forwardRef((e, t) => {
    let n = L(H, e.__scopeDialog),
      { forceMount: r = n.forceMount, ...i } = e,
      a = j(H, e.__scopeDialog);
    return (0, O.jsx)(d, {
      present: r || a.open,
      children: a.modal ? (0, O.jsx)(W, { ...i, ref: t }) : (0, O.jsx)(G, { ...i, ref: t }),
    });
  });
U.displayName = H;
var W = D.forwardRef((e, t) => {
    let n = j(H, e.__scopeDialog),
      r = D.useRef(null),
    ...
    return (
      ...
      (0, O.jsxs)(O.Fragment, {
        children: [
          ...
          (0, O.jsxs)(O.Fragment, {
            children: [
              (0, O.jsx)(ue, { titleId: c.titleId }),
              (0, O.jsx)(fe, { contentRef: l, descriptionId: c.descriptionId }),
            ],
          }),
        ],
      })
  ...
  J = D.forwardRef((e, t) => {
    let { __scopeDialog: n, ...r } = e,
      i = j(q, n);
    return (0, O.jsx)(l.h2, { id: i.titleId, ...r, ref: t });
  });
J.displayName = q;
var Y = `DialogDescription`,
  re = D.forwardRef((e, t) => {
    let { __scopeDialog: n, ...r } = e,
      i = j(Y, n);
    return (0, O.jsx)(l.p, { id: i.descriptionId, ...r, ref: t });
  });
re.displayName = Y;
var ie = `DialogClose`,
  ae = D.forwardRef((e, t) => {
...
var se = `DialogTitleWarning`,
  [ce, le] = u(se, { contentName: H, titleName: q, docsSlug: `dialog` }),
  ue = ({ titleId: e }) => {
    let t = le(se),
...
function Ee(e) {
  ...
  let v = u === void 0 ? !0 : u,
    ...
    x = p === void 0 ? !1 : p,
    S = m === void 0 ? !1 : m,
    w = h === void 0 ? `default` : h,
    T;
  t[17] === e
    ? (T = t[18])
    : ((T = (t) => {
        (t && C(), e.onOpenChange?.(t));
      }),
      (t[17] = e),
      (t[18] = T));
  let E = T,
    D;
  t[19] !== v || t[20] !== g || t[21] !== _
    ? ((D = g && (0, O.jsx)(ke, { asChild: v, triggerRef: _, children: g })),
      (t[19] = v),
      (t[20] = g),
      (t[21] = _),
      (t[22] = D))
  ...
  let A;
  return (
    t[36] !== E || t[37] !== l || t[38] !== D || t[39] !== k
      ? ((A = (0, O.jsxs)(pe, { ...l, onOpenChange: E, children: [D, k] })),
        (t[36] = E),
        (t[37] = l),
        (t[38] = D),
        (t[39] = k),
...
function Ae(e) {
  let t = (0, X.c)(41),
    ...
    _ = d === void 0 ? !1 : d,
    v = f === void 0 ? !1 : f,
    { className: y, onPointerDown: b, onPointerDownOutside: x, style: C, ...T } = m,
    k = S(),
    A = a(
      `codex-dialog left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 outline-none`,
      Ce.content,
      c == null ? `fixed` : `absolute`,
    ),
    ee = Te(p),
    te = (0, D.useRef)(null),
    j = (0, D.useRef)(null),
  ...
  (t[0] === N
    ...
    : ((P = () => {
      ...
      (t[1] = P),
      (t[2] = F)),
    (0, D.useLayoutEffect)(P, F));
  let I = E,
    L = c ?? void 0,
    R;
  t[3] === s ? (R = t[4]) : ((R = a(we, s)), (t[3] = s), (t[4] = R));
  let z;
  t[5] === R ? (z = t[6]) : ((z = (0, O.jsx)(ge, { className: R })), (t[5] = R), (t[6] = z));
  let B = E,
    ne = a(
      A,
      !_ &&
    ...
    V = c == null && k !== 1 ? k : void 0,
    H;
  t[7] !== c || t[8] !== v || t[9] !== k
    ? ((H = v && c == null ? { height: `calc(100dvh / ${k})`, width: `calc(100vw / ${k})` } : null),
      (t[7] = c),
      (t[8] = v),
      (t[9] = k),
      (t[10] = H))
    : (H = t[10]);
  let U;
  t[11] !== C || t[12] !== V || t[13] !== H
    ? ((U = { zoom: V, ...H, ...C }), (t[11] = C), (t[12] = V), (t[13] = H), (t[14] = U))
    : (U = t[14]);
  let W;
  t[15] !== x || t[16] !== g
    ? ((W = (e) => {
        (g && e.preventDefault(), x?.(e));
      }),
      (t[15] = x),
      (t[16] = g),
      (t[17] = W))
  ...
  let K;
  t[20] !== n || t[21] !== N
    ? ((K = N ? (0, O.jsx)(`div`, { ref: j, children: n }) : n),
      (t[20] = n),
      (t[21] = N),
      (t[22] = K))
    : (K = t[22]);
  let q;
  t[23] !== i || t[24] !== o || t[25] !== h
    ? ((q =
        h &&
        (0, O.jsxs)(be, {
          className: a(
          ...
          onClick: je,
          children: [
            (0, O.jsx)(w, { "aria-hidden": !0, className: `icon-xs` }),
            o ? (0, O.jsx)(`span`, { className: `sr-only`, children: o }) : null,
          ],
        })),
      (t[23] = i),
      (t[24] = o),
  ...
  let Y;
  return (
    t[36] !== z || t[37] !== J || t[38] !== I.Portal || t[39] !== L
      ? ((Y = (0, O.jsxs)(I.Portal, { container: L, children: [z, J] })),
        (t[36] = z),
        (t[37] = J),
        (t[38] = I.Portal),
        (t[39] = L),
...
function Ie(e) {
  ...
  t[0] !== o || t[1] !== m || t[2] !== p
    ? ((h = Q()),
      ...
      (_ = a(`flex flex-col items-start gap-3`, h && Z, o)),
      (t[0] = o),
      (t[1] = m),
      (t[2] = p),
      (t[3] = h),
  ...
  t[13] !== r || t[14] !== u || t[15] !== v
    ? ((x = r
        ? (0, O.jsx)(`div`, { className: a(v, `min-w-0 font-semibold`, u), children: r })
        : null),
      (t[13] = r),
      (t[14] = u),
      (t[15] = v),
    ...
    : (x = t[16]);
  let S;
  t[17] !== i || t[18] !== f || t[19] !== g
    ? ((S = i
        ? (0, O.jsx)(`div`, {
            className: a(`text-token-description-foreground`, g, f),
            children: i,
          })
        : null),
      (t[17] = i),
...
function Re(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== s) {
    let e = Q(),
      i = D.Children.toArray(n),
      h = i.reduce(ze, 0),
      g = (e) =>
        i.map((t) => {
          if (!D.isValidElement(t) || t.type !== o) return t;
          let n = s && h === 1 ? `w-full justify-center` : void 0;
          return D.cloneElement(t, { size: t.props.size ?? e, className: a(t.props.className, n) });
        });
    ((d = a(`flex w-full items-center justify-end gap-3`, e && Z, r)),
      t[10] === e
        ? (f = t[11])
        : ((f = e ? (0, O.jsx)($, { name: `DialogFooter` }) : null), (t[10] = e), (t[11] = f)),
      (p = (0, O.jsx)(T, { browser: !0, children: g(`medium`) })),
      (m = (0, O.jsx)(T, { electron: !0, children: g(`medium`) })),
      (c = T),
      (l = !0),
      (u = g(`toolbar`)),
      (t[0] = n),
      ...
      (t[8] = p),
      (t[9] = m));
  } else ((c = t[3]), (l = t[4]), (u = t[5]), (d = t[6]), (f = t[7]), (p = t[8]), (m = t[9]));
  let h;
  t[12] !== c || t[13] !== l || t[14] !== u
    ? ((h = (0, O.jsx)(c, { extension: l, children: u })),
      (t[12] = c),
      (t[13] = l),
      (t[14] = u),
      (t[15] = h))
  ...
  return (
    t[16] !== d || t[17] !== f || t[18] !== p || t[19] !== m || t[20] !== h
      ? ((g = (0, O.jsxs)(`div`, { className: d, children: [f, p, m, h] })),
        (t[16] = d),
        (t[17] = f),
        (t[18] = p),
        (t[19] = m),
...
function ze(e, t) {
  return !D.isValidElement(t) || t.type !== o ? e : e + 1;
}
function Be(e) {
  let t = (0, X.c)(9),
  ...
  t[0] === r
    ? ((i = t[1]), (o = t[2]))
    : ((i = Q()),
      (o = a(`flex w-full flex-col pt-3 first:pt-0`, i && Z, r)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = o));
  let s;
  t[3] === i
    ? (s = t[4])
    : ((s = i ? (0, O.jsx)($, { name: `DialogSection` }) : null), (t[3] = i), (t[4] = s));
  let c;
  return (
    t[5] !== n || t[6] !== o || t[7] !== s
...
function Ve(e) {
  ...
  t[0] === r
    ? ((i = t[1]), (o = t[2]))
    : ((i = Q()),
      (o = a(`relative flex items-center gap-2`, i && Z, r)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = o));
  let s;
  t[3] === i
    ? (s = t[4])
    : ((s = i ? (0, O.jsx)($, { name: `FormRow` }) : null), (t[3] = i), (t[4] = s));
  let c;
  return (
    t[5] !== n || t[6] !== o || t[7] !== s
      ? ((c = (0, O.jsxs)(`div`, { className: o, children: [s, n] })),
...
function He(e) {
  ...
  t[0] === r
    ? ((i = t[1]), (o = t[2]))
    : ((i = Q()), (o = a(`flex flex-col gap-2`, i && Z, r)), (t[0] = r), (t[1] = i), (t[2] = o));
  let s;
  t[3] === i
    ? (s = t[4])
    : ((s = i ? (0, O.jsx)($, { name: `FieldStack` }) : null), (t[3] = i), (t[4] = s));
  let c;
  return (
    t[5] !== n || t[6] !== o || t[7] !== s
      ? ((c = (0, O.jsxs)(`div`, { className: o, children: [s, n] })),
