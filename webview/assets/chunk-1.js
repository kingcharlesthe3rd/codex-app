...
import { a as ue, o as d } from "./_baseFor-1.js";
import { n as de, t as fe } from "./merge.js";
import { n as pe, t as me } from "./src-1.js";
import { t as he } from "./dist-3.js";
import { i as f, n as p, r as ge } from "./chunk-66.js";
import { A as _e, L as ve, f as ye, m, r as h, s as g } from "./chunk-96.js";
function _(e, t) {
...
function S(e, t, n) {
  ...
  (f.info(`our points`, r), t !== `start_left` && t !== `start_right` && r.reverse());
  let i = z(r, 25 + e),
    a = 10 + e * 0.5,
...
`,
      ...
      (B = p((e, t, n) => {
        (f.info(`our points ${JSON.stringify(t)}`), t[0] !== n && (t = t.reverse()));
        let r = z(t, 25),
          i = e ? 10 : 5,
