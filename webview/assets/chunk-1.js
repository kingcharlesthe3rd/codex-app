...
import { a as r, i, n as a, r as o, t as s } from "./chunk-2.js";
import { a as c, l, n as u, o as d, r as f, s as p, t as ee } from "./dist-1.js";
function m(e) {
  return function (t) {
...
function ie() {
  ...
  let _,
    ...
    S = Je();
  t.isSupported =
    typeof ae == `function` && typeof se == `function` && y && y.createHTMLDocument !== void 0;
  let {
      MUSTACHE_EXPR: Le,
      ERB_EXPR: Re,
      TMPLIT_EXPR: Be,
    ...
    bt = function () {
      ...
      if (!(J && J === e)) {
        if (
          ((!e || typeof e != `object`) && (e = {}),
          (e = g(e)),
          (K = _t.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? `text/html` : e.PARSER_MEDIA_TYPE),
          (q = K === `application/xhtml+xml` ? ve : _e),
          (w = b(e, `ALLOWED_TAGS`) ? h({}, e.ALLOWED_TAGS, q) : Qe),
          (T = b(e, `ALLOWED_ATTR`) ? h({}, e.ALLOWED_ATTR, q) : E),
          (ft = b(e, `ALLOWED_NAMESPACES`) ? h({}, e.ALLOWED_NAMESPACES, ve) : pt),
          (dt = b(e, `ADD_URI_SAFE_ATTR`) ? h(g(B), e.ADD_URI_SAFE_ATTR, q) : B),
          (lt = b(e, `ADD_DATA_URI_TAGS`) ? h(g(ut), e.ADD_DATA_URI_TAGS, q) : ut),
          ...
          e.FORBID_CONTENTS && (z === ct && (z = g(z)), h(z, e.FORBID_CONTENTS, q)),
          I && (w[`#text`] = !0),
          ...
          : e.namespaceURI === V
            ? t.namespaceURI === U
              ...
              : t.namespaceURI === H
                ...
                : !!St[n]
            : e.namespaceURI === U
              ? (t.namespaceURI === H && !ht[r]) || (t.namespaceURI === V && !mt[r])
                ? !1
                : !St[n] && (gt[n] || !xt[n])
  ...
  let Et = function (e) {
      ...
      if (
        ...
        return (X(e), !0);
      if (!(k.tagCheck instanceof Function && k.tagCheck(r)) && (!w[r] || O[r])) {
        if (
          !O[r] &&
          Ot(r) &&
          ...
          if (
            !(
              (Ot(e) &&
                ...
                ((D.attributeNameCheck instanceof RegExp && x(D.attributeNameCheck, t)) ||
    ...
    kt = function (e) {
      ...
      for (; i--; ) {
        ...
        if (
          ...
          (u = r.attrValue),
          st && (c === `id` || c === `name`) && (Z(a, e), (u = `user-content-` + u)),
        ...
        if (_ && typeof p == `object` && typeof p.getAttributeType == `function` && !o)
        ...
        if (u !== l)
          try {
            (o ? e.setAttributeNS(o, a, u) : e.setAttribute(a, u), Q(e) ? X(e) : me(t.removed));
          } catch {
            Z(a, e);
          }
      }
  ...
  return (
    (t.sanitize = function (e) {
      ...
      if ((nt || bt(n), (t.removed = []), typeof e == `string` && (L = !1), L)) {
        if (e.nodeName) {
          let t = q(e.nodeName);
          if (!w[t] || O[t]) throw Ce(`root node is forbidden and cannot be sanitized in-place`);
        }
      } else if (e instanceof s)
        ((i = Ct(`<!---->`)),
          (o = i.ownerDocument.importNode(e, !0)),
          (o.nodeType === Ge.element && o.nodeName === `BODY`) || o.nodeName === `HTML`
            ? (i = o)
            : i.appendChild(o));
      else {
        if (!F && !N && !P && e.indexOf(`<`) === -1) return _ && at ? _.createHTML(e) : e;
      ...
      if (L) return e;
      if (F) {
        if (it) for (l = de.call(i.ownerDocument); i.firstChild; ) l.appendChild(i.firstChild);
        else l = i;
        return ((T.shadowroot || T.shadowrootmode) && (l = Ie.call(r, l, !0)), l);
      }
...
` +
    ...
    (t.setConfig = function () {
      (bt(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}), (nt = !0));
    }),
...
var ae,
  ...
  Ye = e(() => {
    (({
      ...
      (Pe = v([`xlink:href`, `xml:id`, `xlink:title`, `xml:space`, `xmlns:xlink`])),
      (Fe = y(/\{\{[\w\W]*|[\w\W]*\}\}/gm)),
      (Ie = y(/<%[\w\W]*|[\w\W]*%>/gm)),
      (S = y(/\$\{[\w\W]*/gm)),
      (Le = y(/^data-[\-\w.\u00B7-\uFFFF]+$/)),
...
`,
        ...
        for (let [n, { detector: r }] of Object.entries(E)) if (r(e, t)) return n;
            ...
            : e === void 0 || n <= 0
              ...
              : (t !== void 0 &&
                  ...
                  Object.keys(t).forEach((i) => {
                    typeof t[i] == `object` && (e[i] === void 0 || typeof e[i] == `object`)
                      ? (e[i] === void 0 && (e[i] = Array.isArray(t[i]) ? [] : {}),
                        (e[i] = et(e[i], t[i], { depth: n - 1, clobber: r })))
                      : (r || (typeof e[i] != `object` && typeof t[i] != `object`)) &&
                        (e[i] = t[i]);
                  }),
                e);
      }, `assignWithDepth`)),
      ...
      (j = `#ffffff`),
      (M = `#f2f2f2`),
      (N = a((e, t) => (t ? f(e, { s: -40, l: 10 }) : f(e, { s: -40, l: -10 })), `mkBorder`)),
      (tt = class {
        static {
          a(this, `Theme`);
        }
        ...
        updateColors() {
          if (
            ...
            (this.secondaryColor = this.secondaryColor || f(this.primaryColor, { h: -120 })),
            (this.tertiaryColor = this.tertiaryColor || f(this.primaryColor, { h: 180, l: 5 })),
            ...
            (this.noteBorderColor = this.noteBorderColor || N(this.noteBkgColor, this.darkMode)),
            (this.noteBkgColor = this.noteBkgColor || `#fff5ad`),
            (this.noteTextColor = this.noteTextColor || `#333`),
            (this.secondaryTextColor = this.secondaryTextColor || u(this.secondaryColor)),
            (this.tertiaryTextColor = this.tertiaryTextColor || u(this.tertiaryColor)),
            ...
            (this.activationBorderColor = this.activationBorderColor || c(this.secondaryColor, 10)),
            (this.activationBkgColor = this.activationBkgColor || this.secondaryColor),
            (this.sequenceNumberColor = this.sequenceNumberColor || u(this.lineColor)),
            ...
            (this.activeTaskBkgColor = this.activeTaskBkgColor || d(this.primaryColor, 23)),
            ...
            (this.cScale8 = this.cScale8 || f(this.primaryColor, { h: 210, l: 150 })),
          ...
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this.darkMode
              ? (this[`cScalePeer` + e] = this[`cScalePeer` + e] || d(this[`cScale` + e], 10))
              : (this[`cScalePeer` + e] = this[`cScalePeer` + e] || c(this[`cScale` + e], 10));
          ...
          for (let t = 0; t < 5; t++)
            ((this[`surface` + t] =
              this[`surface` + t] || f(this.mainBkg, { h: 180, s: -15, l: e * (5 + t * 3) })),
              (this[`surfacePeer` + t] =
                this[`surfacePeer` + t] ||
          ...
          ((this.classText = this.classText || this.textColor),
            ...
            (this.fillType2 = this.fillType2 || f(this.primaryColor, { h: 64 })),
            (this.fillType3 = this.fillType3 || f(this.secondaryColor, { h: 64 })),
            (this.fillType4 = this.fillType4 || f(this.primaryColor, { h: -64 })),
            (this.fillType5 = this.fillType5 || f(this.secondaryColor, { h: -64 })),
            (this.fillType6 = this.fillType6 || f(this.primaryColor, { h: 128 })),
            (this.fillType7 = this.fillType7 || f(this.secondaryColor, { h: 128 })),
            ...
            (this.pie10 = this.pie10 || f(this.primaryColor, { h: 60, l: -20 })),
            (this.pie11 = this.pie11 || f(this.primaryColor, { h: -60, l: -20 })),
            (this.pie12 = this.pie12 || f(this.primaryColor, { h: 120, l: -10 })),
            ...
            (this.quadrant2Fill = this.quadrant2Fill || f(this.primaryColor, { r: 5, g: 5, b: 5 })),
            (this.quadrant3Fill =
              this.quadrant3Fill || f(this.primaryColor, { r: 10, g: 10, b: 10 })),
            (this.quadrant4Fill =
              this.quadrant4Fill || f(this.primaryColor, { r: 15, g: 15, b: 15 })),
            (this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor),
            (this.quadrant2TextFill =
              this.quadrant2TextFill || f(this.primaryTextColor, { r: -5, g: -5, b: -5 })),
            (this.quadrant3TextFill =
              this.quadrant3TextFill || f(this.primaryTextColor, { r: -10, g: -10, b: -10 })),
            (this.quadrant4TextFill =
              this.quadrant4TextFill || f(this.primaryTextColor, { r: -15, g: -15, b: -15 })),
            ...
            (this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || j),
            (this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || M));
        }
        calculate(e) {
          if (typeof e != `object`) {
            this.updateColors();
      ...
      (nt = class {
        ...
        updateColors() {
          ...
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] =
              this[`surface` + e] || f(this.mainBkg, { h: 30, s: -30, l: -(-10 + e * 4) })),
              (this[`surfacePeer` + e] =
                this[`surfacePeer` + e] || f(this.mainBkg, { h: 30, s: -30, l: -(-7 + e * 4) })));
        ...
        updateColors() {
          ...
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            ((this[`cScale` + e] = c(this[`cScale` + e], 10)),
              (this[`cScalePeer` + e] = this[`cScalePeer` + e] || c(this[`cScale` + e], 25)));
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleInv` + e] = this[`cScaleInv` + e] || f(this[`cScale` + e], { h: 180 });
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] =
              this[`surface` + e] || f(this.mainBkg, { h: 30, l: -(5 + e * 5) })),
              (this[`surfacePeer` + e] =
                this[`surfacePeer` + e] || f(this.mainBkg, { h: 30, l: -(7 + e * 5) })));
          if (
            ((this.scaleLabelColor =
          ...
          ((this.nodeBkg = this.mainBkg),
            ...
            (this.archEdgeColor = this.lineColor),
            (this.archEdgeArrowColor = this.lineColor),
            (this.rowOdd = this.rowOdd || d(this.primaryColor, 75) || `#ffffff`),
            ...
            (this.pie10 = this.pie10 || f(this.primaryColor, { h: 60, l: -40 })),
            (this.pie11 = this.pie11 || f(this.primaryColor, { h: -90, l: -40 })),
            (this.pie12 = this.pie12 || f(this.primaryColor, { h: 120, l: -30 })),
            (this.pieTitleTextSize = this.pieTitleTextSize || `25px`),
            (this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor),
            (this.pieSectionTextSize = this.pieSectionTextSize || `17px`),
            (this.pieSectionTextColor = this.pieSectionTextColor || this.textColor),
      ...
      (at = class {
        ...
        updateColors() {
          ...
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] =
              this[`surface` + e] || f(this.mainBkg, { h: 30, s: -30, l: -(5 + e * 5) })),
              (this[`surfacePeer` + e] =
                this[`surfacePeer` + e] || f(this.mainBkg, { h: 30, s: -30, l: -(8 + e * 5) })));
          ((this.nodeBkg = this.mainBkg),
            (this.nodeBorder = this.border1),
            (this.clusterBkg = this.secondBkg),
            (this.clusterBorder = this.border2),
            ...
            (this.pie8 = this.pie8 || f(this.primaryColor, { h: -60, l: -10 })),
            (this.pie9 = this.pie9 || f(this.primaryColor, { h: 120, l: 0 })),
            (this.pie10 = this.pie10 || f(this.primaryColor, { h: 60, l: -50 })),
            (this.pie11 = this.pie11 || f(this.primaryColor, { h: -60, l: -50 })),
            (this.pie12 = this.pie12 || f(this.primaryColor, { h: 120, l: -50 })),
            (this.pieTitleTextSize = this.pieTitleTextSize || `25px`),
            (this.pieTitleTextColor = this.pieTitleTextColor || this.taskTextDarkColor),
            (this.pieSectionTextSize = this.pieSectionTextSize || `17px`),
            (this.pieSectionTextColor = this.pieSectionTextColor || this.textColor),
      ...
      (st = class {
        ...
        updateColors() {
          ...
          for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
            this[`cScaleLabel` + e] = this[`cScaleLabel` + e] || this.scaleLabelColor;
          for (let e = 0; e < 5; e++)
            ((this[`surface` + e] = this[`surface` + e] || f(this.mainBkg, { l: -(5 + e * 5) })),
              (this[`surfacePeer` + e] =
                this[`surfacePeer` + e] || f(this.mainBkg, { l: -(8 + e * 5) })));
          ((this.nodeBkg = this.mainBkg),
            (this.nodeBorder = this.border1),
            (this.clusterBkg = this.secondBkg),
            (this.clusterBorder = this.border2),
        ...
        if ((i.debug(`sanitizeDirective called with`, e), !(typeof e != `object` || !e))) {
          ...
          for (let t of Object.keys(e)) {
            ...
            for (let n of [`themeCSS`, `fontFamily`, `altFontFamily`])
              t.includes(n) && (i.debug(`sanitizing css option`, t), (e[t] = dt(e[t])));
          }
          if (e.themeVariables)
      ...
      (G = a((e, t) => {
        ...
        if (((n = A(n, r)), r.theme && r.theme in I)) {
          ...
          n.theme && n.theme in I && (n.themeVariables = I[n.theme].getThemeVariables(e));
        }
        return ((W = n), xt(W), W);
      }, `updateCurrentConfig`)),
      (ft = a(
      ...
      (_t = a((e) => {
        e &&
          ([`secure`, ...(V.secure ?? [])].forEach((t) => {
            Object.hasOwn(e, t) &&
              (i.debug(`Denied attempt to modify a secure key ${t}`, e[t]), delete e[t]);
          }),
      ...
      (Tt = a(
        (e, t) => (typeof e == `string` ? Q(e, t) : e.flat().map((e) => Q(e, t))),
        `sanitizeTextOrArray`,
      )),
      ...
      (Vt = a(async (e, n) => {
          ...
          return e.replace(Rt, `MathML is unsupported in this environment.`);
        {
          let { default: r } = await t(
              async () => {
                let { default: e } = await import(`./katex-2.js`);
                return { default: e };
              },
              __vite__mapDeps([
            ...
            i = n.forceLegacyMathML || (!Lt() && n.legacyMathML) ? `htmlAndMathml` : `mathml`;
          return e
            .split(Y)
            .map((e) =>
              zt(e)
...
`,
      ...
      (yn = {}),
      (bn = a((e, t, n) => {
        (yn[e] && dn.warn(`Diagram with id ${e} already registered. Overwriting.`),
          (yn[e] = t),
          n && $e(e, n),
          Xt(e, t.styles),
