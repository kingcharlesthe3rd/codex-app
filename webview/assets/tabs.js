...
function s(e) {
  let n = (0, l.c)(33),
    ...
    b;
  n[0] !== s || n[1] !== v.listClassName || n[2] !== y
    ? ((b = i(v.listClassName, y, s)), (n[0] = s), (n[1] = v.listClassName), (n[2] = y), (n[3] = b))
    : (b = n[3]);
  let x = _ ? c : void 0,
    S;
  if (
    n[4] !== o ||
    n[5] !== v.closeButtonClassName ||
    n[6] !== v.itemClassName ||
    n[7] !== v.segmentedEdges ||
    n[8] !== v.selectedClassName ||
    n[9] !== v.selectionIndicator ||
    n[10] !== v.tabButtonClassName ||
    n[11] !== v.unselectedClassName ||
    n[12] !== a ||
    n[13] !== r
  ) {
    let e;
    (n[15] !== o ||
    n[16] !== v.closeButtonClassName ||
    n[17] !== v.itemClassName ||
    n[18] !== v.segmentedEdges ||
    n[19] !== v.selectedClassName ||
    n[20] !== v.selectionIndicator ||
    n[21] !== v.tabButtonClassName ||
    n[22] !== v.unselectedClassName ||
    n[23] !== a ||
    n[24] !== r.length
      ? ((e = (e, n) => {
          let s = e.key === a,
              ...
              children: [
                ...
                e.onClose == null
                  ...
                  : (0, u.jsx)(`button`, {
                      ...
                      onClick: e.onClose,
                      children: (0, u.jsx)(t, { className: `icon-2xs` }),
                    }),
                v.segmentedEdges && !l
                  ? (0, u.jsx)(`div`, { className: `h-full w-px self-stretch bg-token-border` })
                  : null,
              ],
            },
            e.key,
  ...
  let C;
  return (
    n[26] !== h || n[27] !== g || n[28] !== b || n[29] !== x || n[30] !== S || n[31] !== p
      ? ((C = (0, u.jsx)(`div`, {
          ref: p,
          role: `tablist`,
          "aria-label": h,
