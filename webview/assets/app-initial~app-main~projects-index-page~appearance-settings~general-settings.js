...
import { R as n } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~plugin-detail-page~new-~sfopfmmp.js";
function r() {
  return (r =
    Object.assign ||
    function (e) {
...
var s,
  ...
  R = e(() => {
    ((s = t(n(), 1)),
        ...
        return s.createElement(
          ...
          s.createElement(
            p,
            {
              ...
              onKey: function (e) {
                n({ s: c(t.s + 100 * e.left, 0, 100), v: c(t.v - 100 * e.top, 0, 100) });
              },
              "aria-label": `Color`,
      ...
      (M = function () {
        return A || (typeof __webpack_nonce__ < `u` ? __webpack_nonce__ : void 0);
      }),
      (N = new Map()),
      (P = function (e) {
        j(function () {
      ...
      (F = function (e) {
        ...
        return s.createElement(
          ...
          s.createElement(E, { hue: p.h, onChange: h, className: `react-colorful__last-control` }),
        );
      }),
      (I = {
        defaultColor: `000`,
...
//# sourceMappingURL=app-initial~app-main~projects-index-page~appearance-settings~general-settings.js.map
