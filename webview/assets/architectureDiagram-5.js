...
import "./chunk-93.js";
import { r as t, s as n } from "./chunk-129.js";
import "./main.js";
import "./chunk-11.js";
import "./chunk-14.js";
import "./chunk-7.js";
...
import "./dist-5.js";
import { i as y, n as b, o as x, r as S } from "./chunk-100.js";
import { t as C } from "./chunk-31.js";
import { t as w } from "./mermaid-parser.core-D.js";
import { t as T } from "./cytoscape.esm-2.js";
import { t as E } from "./cytoscape-fcose.js";
var ee = e(E(), 1),
...
`,
    ...
    await Promise.all(
      t.edges().map(async (t) => {
        let {
          ...
          T = i + 4;
        if (
          (d && (j(l) ? (v += l === `L` ? -T : T) : (y += l === `T` ? -T : T + 18)),
          g && (j(m) ? (C += m === `L` ? -T : T) : (w += m === `T` ? -T : T + 18)),
          !d &&
          ...
          if (_) {
            let e = N(l, m) ? `XY` : j(l) ? `X` : `Y`,
              n = 0;
            n =
              e === `X` ? Math.abs(v - C) : e === `Y` ? Math.abs(y - w) / 1.5 : Math.abs(v - C) / 2;
            let r = t.append(`g`);
            if (
              (await b(
                r,
    ...
    await Promise.all(
      t.nodes().map(async (t) => {
        ...
        if (o.type === `group`) {
          ...
          if (o.icon) {
            let e = f.append(`g`);
            (e.html(`<g>${await S(o.icon, { height: r, width: r, fallbackPrefix: G.prefix })}</g>`),
  ...
  le = i(async function (e, t, n) {
    ...
    for (let i of n) {
      ...
      let o = n.append(`g`);
      if (i.icon)
        o.html(`<g>${await S(i.icon, { height: a, width: a, fallbackPrefix: G.prefix })}</g>`);
      else if (i.iconText) {
        o.html(`<g>${await S(`blank`, { height: a, width: a, fallbackPrefix: G.prefix })}</g>`);
        let e = o
            .append(`g`)
...
function $(e, t, n, o, s, { spatialMaps: c, groupAlignments: l }) {
  return new Promise((u) => {
    let d = r(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`),
      f = T({
