...
import { n as b, t as x } from "./chunk-71.js";
import { r as S, s as ee, u as C } from "./chunk-123.js";
import { a as te, i as ne, n as w, r as T, s as re } from "./chunk-88.js";
import { n as ie, t as ae } from "./chunk-16.js";
import { n as oe, t as se } from "./mermaid-parser.core-4.js";
import { n as ce, t as E } from "./cytoscape.esm-2.js";
import { t as le } from "./cytoscape-fcose.js";
function ue(e, t, n) {
  e.forEach((e) => {
    t.add({
      group: `nodes`,
          ...
          if (l) {
            ...
            Object.entries(c).forEach(([e, a]) => {
              ...
              d &&
                !s[c] &&
                (o.push(c),
                n.push({ [M[e]]: d, [M[F(e)]]: l, gap: 1.5 * t.getConfigField(`iconSize`) }));
            });
          }
        }
      }
...
function A(e, t, i, a, o, { spatialMaps: s, groupAlignments: c }) {
  return new Promise((l) => {
    let u = v(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`),
      d = E({
...
`,
      ...
      await Promise.all(
        t.edges().map(async (t) => {
          let {
            ...
            C = r + 4;
          if (
            (u && (L(c) ? (_ += c === `L` ? -C : C) : (v += c === `T` ? -C : C + 18)),
            h && (L(f) ? (x += f === `L` ? -C : C) : (S += f === `T` ? -C : C + 18)),
            !u &&
            ...
            if (g) {
              ...
              if (
                ...
                r.attr(`transform`, `translate(` + y + `, ` + b + `) rotate(-90)`);
              else if (e === `XY`) {
                let e = H(c, f);
                if (e && B(e)) {
          ...
          if (o.type === `group`) {
            ...
            if (o.icon) {
              ...
              (e.html(
                ...
                e.attr(`transform`, `translate(` + (m + a + 1) + `, ` + (h + a + 1) + `)`),
                (m += r),
                (h += i / 2 - 1 - 2));
            }
            if (o.label) {
              ...
              (await w(
                ...
                e.attr(`transform`, `translate(` + (m + a + 4) + `, ` + (h + a + 2) + `)`));
            }
    ...
    (ye = r(async function (e, t, n) {
      ...
      for (let i of n) {
        ...
        let o = n.append(`g`);
        if (i.icon)
          o.html(`<g>${await T(i.icon, { height: a, width: a, fallbackPrefix: $.prefix })}</g>`);
        else if (i.iconText) {
          o.html(`<g>${await T(`blank`, { height: a, width: a, fallbackPrefix: $.prefix })}</g>`);
          let e = o
              .append(`g`)
    ...
    (xe = {
      ...
      renderer: {
        draw: r(async (e, t, n, r) => {
          ...
          let m = d.append(`g`);
          (m.attr(`class`, `architecture-groups`), await ye(i, p, a), be(i, p, o));
          let h = await A(a, o, c, l, i, u);
          (await _e(f, h, i),
            await ve(m, h, i),
            fe(i, h),
            s(void 0, d, i.getConfigField(`padding`), i.getConfigField(`useMaxWidth`)));
        }, `draw`),
      },
      styles: Z,
    }));
...
//# sourceMappingURL=architectureDiagram-5.js.map
