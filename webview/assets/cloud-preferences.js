...
import { By as c, Hy as l } from "./app-initial~app-main~new-thread-panel-page.js";
function u() {
  let e = (0, y.c)(1),
    t;
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = { queryKey: b, queryFn: d, retry: !1, staleTime: n.FIVE_MINUTES }), (e[0] = t))
      : (t = e[0]),
    o(t)
  );
}
...
function f() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = { queryKey: x, queryFn: p, retry: !1, staleTime: n.FIVE_MINUTES }), (e[0] = t))
      : (t = e[0]),
    o(t)
  );
}
