...
import { i as t, n, r, t as i } from "./chunk-49.js";
...
import { n as _, t as v } from "./src-3.js";
import { g as y, s as b, u as x } from "./chunk-123.js";
import { i as S } from "./chunk-88.js";
import { n as C } from "./chunk-83.js";
import { n as w } from "./chunk-61.js";
import { n as T, t as E } from "./chunk-22.js";
import { n as D, t as O } from "./chunk-116.js";
import { n as k } from "./chunk-51.js";
import { i as A } from "./chunk-89.js";
import { n as j } from "./chunk-117.js";
import { i as M, n as N, t as P } from "./chunk-106.js";
var F, I, L, R, z, B, V;
e(() => {
  (T(),
    O(),
    ...
    (F = (function () {
      var e = n(function (e, t, n, r) {
        ...
        b = [1, 37],
        x = [
          6, 8, 10, 13, 15, 17, 20, 21, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 43, 44, 50, 63, 64,
          65, 66, 67,
        ],
        S = [1, 42],
        C = [1, 43],
        ...
        A = [1, 64],
        j = [
          6, 8, 10, 13, 17, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 41, 42, 43, 44, 48, 49, 50, 63,
          64, 65, 66, 67,
        ],
        M = [63, 64, 65, 66, 67],
        N = [1, 81],
...
` +
    ...
    (L = class {
        ...
        return (
          this.entities.has(e)
            ? !this.entities.get(e)?.alias &&
              n &&
              ((this.entities.get(e).alias = n), t.info(`Add alias '${n}' to entity '${e}'`))
            : (this.entities.set(e, {
      ...
      clear() {
        ((this.entities = new Map()), (this.classes = new Map()), (this.relationships = []), p());
      }
      getData() {
        let e = [],
          t = [],
    ...
    (z = n(async function (e, n, r, i) {
      ...
      ((c.type = i.type),
        ...
        (c.markers = [`only_one`, `zero_or_one`, `one_or_more`, `zero_or_more`]),
        (c.diagramId = n),
        await M(c, l),
      ...
      (Array.from(u).length > 0 &&
        ...
        y.insertTitle(l, `erDiagramTitleText`, o?.titleTopMargin ?? 25, i.db.getDiagramTitle()),
