...
import { $s as y, ec as b } from "./app-initial~app-main~onboarding-page.js";
import {
  Ax as x,
  BC as S,
  Cm as C,
  ...
  let w = async () => {
    ...
    N =
      !c || !D
        ? (0, K.jsxs)(K.Fragment, {
            children: [
              (0, K.jsx)(et, { isPrimary: !0, handleChatGptSignIn: w, isChatGptSignInPending: s }),
              !s &&
                c &&
                (0, K.jsx)(`div`, {
                  className: `pt-2`,
                  children: (0, K.jsx)(tt, { isPrimary: !1, handleCopilotSignIn: O }),
                }),
            ],
          })
        : (0, K.jsxs)(K.Fragment, {
                      ...
                      children: [
                        ...
                        !s &&
                          ...
                          (0, K.jsx)(rt, {
                            ...
                            children: (0, K.jsx)(nt, { handleChatGptDeviceCodeSignIn: T }),
                          }),
                      ],
                    }),
                  }),
...
function lt(e) {
  ...
  t[26] === o
    ? (w = t[27])
    : ((w = (0, K.jsx)(F, { color: `ghost`, onClick: o, children: C })), (t[26] = o), (t[27] = w));
  let T = n.length === 0,
    E;
...
function jt(e) {
  ...
  if (o && !i) {
    ...
    let i;
    t[2] !== n || t[3] !== r
      ? ((i = (0, Z.jsx)(Be, { appBrand: n, className: r })), (t[2] = n), (t[3] = r), (t[4] = i))
      : (i = t[4]);
    let a;
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((a = (0, Z.jsx)(`p`, {
  ...
  t[14] === b
    ? (x = t[15])
    : ((x = me(`flex w-full flex-col items-center`, b)), (t[14] = b), (t[15] = x));
  let S;
  t[16] === g
    ? (S = t[17])
    : ((S = g.formatMessage({
  ...
  let C = !_ && `size-[52px]`,
    w;
  t[18] === C ? (w = t[19]) : ((w = me(`shrink-0`, C)), (t[18] = C), (t[19] = w));
  let T;
  t[20] !== n || t[21] !== w
    ? ((T = (0, Z.jsx)(Be, { appBrand: n, className: w })), (t[20] = n), (t[21] = w), (t[22] = T))
    : (T = t[22]);
  let E;
        ...
        : (0, Z.jsxs)(`div`, {
            ...
            children: [
              (0, Z.jsxs)(`button`, {
                ...
                onClick: () => u(),
                children: [
                  (0, Z.jsx)(Se, { className: `size-6 shrink-0 text-token-dropdown-background` }),
                  _
                    ? (0, Z.jsx)(H, {
                ...
                ? (0, Z.jsxs)(Z.Fragment, {
                    children: [
                      ...
                      (0, Z.jsxs)(`button`, {
                        ...
                        onClick: () => u(`microsoft`),
                        children: [
                          (0, Z.jsx)(y, { className: `size-5 shrink-0`, "aria-hidden": `true` }),
                          (0, Z.jsx)(H, {
              ...
              onApiKeySubmit: async () => {
                ...
                if (!(!r || N || p == null)) {
                  ...
                  try {
                    ...
                    (z(e, L, { method: `apikey`, errorKind: Ft(t), ...p }), v(g(t)));
                  } finally {
                    F(!1);
                  }
                }
