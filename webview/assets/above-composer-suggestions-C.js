...
import { y as r, z as i } from "./app-scope.js";
...
import { n as p, t as m } from "./use-composer-controller.js";
import { n as h, t as g } from "./use-collaboration-mode.js";
...
function x(e) {
  ...
  t[0] === u
    ...
    : ((d = l(
      ...
      (t[0] = u),
      (t[1] = d));
  let f = c ? `items-start` : `items-center`,
    p;
  t[2] === f ? (p = t[3]) : ((p = l(`flex min-w-0 flex-1 gap-2`, f)), (t[2] = f), (t[3] = p));
  let m;
  t[4] === r
    ? (m = t[5])
    : ((m =
      ...
      (t[4] = r),
      (t[5] = m));
  let h = c ? `flex flex-col gap-1 text-sm` : `flex items-center gap-2`,
    g;
  t[6] === h ? (g = t[7]) : ((g = l(`min-w-0 flex-1`, h)), (t[6] = h), (t[7] = g));
  let _ = c ? `min-w-0 leading-5 break-words` : `truncate leading-[18px]`,
    v;
  t[8] === _
    ? (v = t[9])
    : ((v = l(`text-sm font-medium text-token-foreground`, _)), (t[8] = _), (t[9] = v));
  let x;
  t[10] !== v || t[11] !== s
    ? ((x = (0, b.jsx)(`span`, { className: v, children: s })),
      (t[10] = v),
      (t[11] = s),
      (t[12] = x))
    : (x = t[12]);
  ...
  t[24] === n
    ? (T = t[25])
    : ((T = (0, b.jsx)(`div`, { className: `flex shrink-0 items-center gap-1`, children: n })),
      (t[24] = n),
      (t[25] = T));
  let E;
  return (
    t[26] !== o || t[27] !== w || t[28] !== T || t[29] !== d
      ? ((E = (0, b.jsx)(`div`, {
...
function O(e) {
  ...
  return (
    t[0] !== r || t[1] !== n || t[2] !== i
      ? ((a = (0, b.jsx)(k, { portalTarget: n, conversationId: r, showPlanKeywordSuggestion: i })),
        (t[0] = r),
        (t[1] = n),
        (t[2] = i),
        (t[3] = a))
...
function k(e) {
  let t = (0, y.c)(21),
    { portalTarget: n, conversationId: i, showPlanKeywordSuggestion: o } = e,
    c = s(),
    l = m(),
    { activeMode: u, modes: d, setSelectedMode: f } = g(i),
    v;
  t[0] === d ? (v = t[1]) : ((v = d.some(A)), (t[0] = d), (t[1] = v));
  let x = v,
    S = u.mode === `plan`,
    T = j(i),
    D;
  ...
  let [O, k] = a(D),
    N;
  t[4] === O ? (N = t[5]) : ((N = new Set(O)), (t[4] = O), (t[5] = N));
  let P = N,
    F;
  t[6] !== P || t[7] !== x || t[8] !== S || t[9] !== o
    ? ((F = (e) =>
        w({
  ...
  let R = L,
    z;
  t[16] !== n || t[17] !== R
    ? ((z = R ? (0, _.createPortal)((0, b.jsx)(M, { suggestion: R }, R.id), n) : null),
      (t[16] = n),
      (t[17] = R),
      (t[18] = z))
    : (z = t[18]);
  ...
  return (
    t[19] === z
      ? (B = t[20])
      : ((B = (0, b.jsx)(b.Fragment, { children: z })), (t[19] = z), (t[20] = B)),
    B
  );
}
function A(e) {
...
function M(e) {
  ...
  t[0] === o
    ? (f = t[1])
    : ((f = o ? (0, b.jsx)(o, { className: `icon-xs shrink-0` }) : null), (t[0] = o), (t[1] = f));
  let p = f,
    m;
  t[2] !== c || t[3] !== l || t[4] !== n
    ? ((m = (e) => {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, b.jsx)(d, { className: `icon-xs` })), (t[15] = w))
    : (w = t[15]);
  let T;
  t[16] !== _ || t[17] !== C
    ? ((T = (0, b.jsx)(`button`, {
  ...
  let E;
  t[19] !== S || t[20] !== T
    ? ((E = (0, b.jsxs)(b.Fragment, { children: [S, T] })), (t[19] = S), (t[20] = T), (t[21] = E))
    : (E = t[21]);
  let D;
  return (
    t[22] !== p || t[23] !== n.id || t[24] !== n.meta || t[25] !== n.title || t[26] !== E
      ? ((D = (0, b.jsx)(x, {
          actions: E,
          icon: p,
          meta: n.meta,
...
//# sourceMappingURL=above-composer-suggestions-C.js.map
