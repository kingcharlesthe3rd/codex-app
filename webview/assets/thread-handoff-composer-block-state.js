...
import { t as b } from "./persisted-atom-C.js";
import { r as x } from "./skus.js";
import { r as S } from "./local-projects.js";
...
function P(e, t) {
  let n = `~`;
  return (
    t != null && (n = t.projectKind === `remote` ? t.path : S.getThreadStartCwd(t)), e.set(N, n), n
  );
}
var F = e(C(), 1),
  I = o([]),
...
//# sourceMappingURL=thread-handoff-composer-block-state.js.map
