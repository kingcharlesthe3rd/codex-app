import { f as e, l as t, t as n } from "./app-scope.js";
import {
  Jn as r,
  cr as i,
  lr as a,
...
function l({ getOptions: l, getParams: u, method: d }) {
  let f = e(
      n,
      (e) =>
        r(d, { commonDir: e.commonDir, root: e.root }, u(e), s(e.hostConfig), e.hostConfig, {
          enabled: e.enabled,
          ...l?.(e),
        }),
  ...
  return {
    fromCwd$: t(
      ...
      (e, { get: t }) => {
        ...
        let { cwd: i, ...s } = e;
        return t(p, { ...s, commonDir: r.commonDir, root: r.root });
      },
      { excludeFieldsFromKey: [`operationSource`] },
    ),
    fromMetadata$: p,
