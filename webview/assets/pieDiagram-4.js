...
import { n as y, t as b } from "./chunk-11.js";
import { p as x, r as S, u as C } from "./chunk-32.js";
import { n as w, t as T } from "./chunk-17.js";
import { n as E, t as D } from "./mermaid-parser.core-2.js";
  ...
  (b(),
    ...
    (N = {
      ...
      addSection: o(({ label: e, value: t }) => {
        ...
        A.has(e) || (A.set(e, t), a.debug(`added new section: ${e}, with value: ${t}`));
      }, `addSection`),
...
` + e,
          ...
          (A.append(`rect`)
            ...
            A.append(`text`)
              .attr(`x`, 22)
              .attr(`y`, 14)
              .text((e) => (s.getShowData() ? `${e.label} [${e.value}]` : e.label)));
          let j =
              512 +
              Math.max(
                ...A.selectAll(`text`)
...
export { R as diagram };
//# sourceMappingURL=pieDiagram-4.js.map
