...
function qe(e) {
  return e == null
    ...
    : typeof e == `string`
      ? { set: e, colored: !0 }
      : { ...e, set: e.set ?? (Ke(e) ? `none` : `complete`), colored: e.colored ?? !0 };
}
var Je = e(() => {});
function Ye(e, t) {
...
function Xe(e) {
  let t = qe(e),
    n = t.remap,
    i = new Map();
  for (let [e, n] of Object.entries(t.byFileName ?? {})) i.set(e.toLowerCase(), n);
  let o = new Map();
  for (let [e, n] of Object.entries(t.byFileExtension ?? {})) o.set(Ze(e), n);
  let s = Object.entries(t.byFileNameContains ?? {}).map(([e, t]) => [e.toLowerCase(), t]);
  return {
    resolveIcon: (e, c) => {
      if (e === `file-tree-icon-file` && c != null) {
        ...
        let f = a(t.set, n, d);
        if (f != null && t.set !== `none`) return { name: r(f), remappedFrom: e, token: f };
      }
      let l = n?.[e];
...
function bt(e, t) {
  return (
    t == null ||
      Object.defineProperty(e, Ct, { configurable: !0, enumerable: !1, value: t, writable: !1 }),
    e
  );
}
function xt(e) {
...
function Et(e) {
  ...
  for (; r < e.length; ) {
    ...
    let i = 0;
    for (; r < e.length && Tt(e.charCodeAt(r)); ) ((i = i * 10 + (e.charCodeAt(r) - 48)), (r += 1));
    (t.push(i), (n = r));
  }
...
function Wt() {
  let e = new Map();
  return (e.set(qt, 0), { idByValue: e, valueById: [qt], sortKeyById: [Dt(qt)] });
}
function Gt(e, t) {
...
function on(e) {
  ...
  return Yt({ paths: e, presortedPaths: e, presortedPathsContainDirectories: n }, `presorted`);
}
function sn(e) {
  let t = e,
    n = t.preparedPaths;
  if (t[dn] === `prepared` && n != null) return n;
  if (!tn(n)) throw Error(`preparedInput must come from PathStore.prepareInput()`);
  return n;
}
function cn(e) {
  let t = e;
  return (t[dn] === `presorted` && t.presortedPaths != null) || nn(t.presortedPaths)
    ? t.presortedPaths
    : null;
}
function ln(e) {
...
function un(e, t = {}) {
  ...
  return (U(r, `store.preparePathEntries.sort`, () => i.sort((e, t) => Zt(e, t, n.sort))), i);
}
var dn,
  fn,
  pn = e(() => {
    (F(),
      ...
      (fn = class {
        ...
        appendPaths(e) {
          return U(this.instrumentation, `store.builder.appendPaths.parse`, () =>
        ...
        appendPresortedPaths(e, t = null) {
          return (
            U(this.instrumentation, `store.builder.appendPresortedPaths`, () => {
              if (t === !1) {
        ...
        finish(e = {}) {
          ...
          return (
            this.hasDeferredDirectoryIndexes
              ? (U(this.instrumentation, `store.builder.buildDirectoryIndexes`, () =>
                  this.buildPresortedFinish(t),
                ),
                (this.hasDeferredDirectoryIndexes = !1))
              : t ||
                U(this.instrumentation, `store.builder.computeSubtreeCounts`, () =>
        ...
        buildDirectoryIndexes() {
          ...
          for (let t = 1; t < e.length; t++) {
            ...
            r != null &&
              (r.childIdByNameId != null && r.childIdByNameId.set(n.nameId, t), it(r, t));
          }
        }
        computeSubtreeCounts(e) {
          let t = this.nodes[e];
          if (t === void 0) throw Error(`Unknown node ID: ${String(e)}`);
          if (!R(t)) return ((t.subtreeNodeCount = 1), (t.visibleSubtreeCount = 1), 1);
          let n = this.getDirectoryIndex(e),
            r = 1;
          for (let e of n.childIds) r += this.computeSubtreeCounts(e);
          return (ot(this.nodes, n), (t.subtreeNodeCount = r), (t.visibleSubtreeCount = r), r);
        }
      }));
  });
...
function ir(e, t) {
  ...
  if (n.isDirectory) {
    ...
    (gt(n, 1), e.pathCacheByNodeId.set(o, { path: t, version: e.pathCacheVersion }), s.add(o));
...
function mr(e, t) {
  ...
  if (!R(n)) return [G(e, t)];
  if (K(e, t).childIds.length === 0) return z(n, 1) && !z(n, 2) ? [G(e, t)] : [];
  let r = [],
...
function _r(e, t, n) {
  let r = Gt(e.snapshot.segmentTable, n),
    i = K(e, t);
  if (nt(e.snapshot.nodes, i).has(r)) throw Error(`Path already exists: "${Rr(e, t, n)}"`);
  let a = q(e, t),
...
function yr(e, t, n) {
  let r = K(e, t),
    i = q(e, n);
  (nt(e.snapshot.nodes, r).set(i.nameId, n), st(r, n, i.subtreeNodeCount, i.visibleSubtreeCount));
  let a = vr(e, r, n);
...
function Sr(e, t, n) {
  ...
  let o = kt(It(e.snapshot.segmentTable, r.nameId), It(e.snapshot.segmentTable, i.nameId));
  if (o !== 0) return o;
...
function wr(e, t, n) {
  ...
  if (i != null) {
    let t = q(e, i);
    if (R(t))
      return { basename: Kt(e.snapshot.segmentTable, r.nameId), existingNodeId: null, parentId: i };
    let a = Ht(n).segments;
...
function Tr(e, t, n, r) {
  ...
  let i = q(e, t);
  if (mt(i) !== r) throw Error(`replace collision requires the same source and destination kinds`);
...
function Nr(e, t) {
  let n = q(e, t);
  if ((_t(n, (t === e.snapshot.rootId ? -1 : L(q(e, n.parentId))) + 1), !R(n))) return;
  let r = K(e, t);
...
function Lr(e, t, n, r) {
  ...
  if (r) {
    ...
    t == null
      ...
      : U(t, `store.recomputeNodeCounts.rebuildChildAggregates`, () => ot(e.snapshot.nodes, i));
  }
...
function ei(e) {
  ...
  (U(e.instrumentation, `store.cleanup.stable.clearPathCaches`, () => Xr(e)),
    U(e.instrumentation, `store.cleanup.stable.rebuildSegmentTable`, () => Zr(e)),
    U(e.instrumentation, `store.cleanup.stable.rebuildDirectoryIndexes`, () => Qr(e)),
    U(e.instrumentation, `store.cleanup.stable.trimTrailingRemovedNodeSlots`, () => $r(e)),
    U(e.instrumentation, `store.cleanup.stable.restoreExpansionOverrides`, () => Jr(e, t)),
    U(e.instrumentation, `store.cleanup.stable.restoreDirectoryLoadInfos`, () => Yr(e, n)),
    U(e.instrumentation, `store.cleanup.stable.recomputeCounts`, () => ur(e, e.snapshot.rootId)));
}
function ti(e) {
  let t = Kr(e),
    n = qr(e),
  ...
  ((e.snapshot = a),
    ...
    U(e.instrumentation, `store.cleanup.aggressive.restoreExpansionOverrides`, () => Jr(e, t)),
    U(e.instrumentation, `store.cleanup.aggressive.restoreDirectoryLoadInfos`, () => Yr(e, n)),
...
function ci(e, t, n, r, i, a) {
  let o = K(e, t),
    { childIndex: s, childVisibleIndex: c, localVisibleIndex: l } = ct(e.snapshot.nodes, o, n),
    u = o.childIds[s];
...
function fi(e, t = J(e)) {
  let n = e.instrumentation;
  return n == null ? wi(e, t) : U(n, `store.getVisibleTreeProjection`, () => wi(e, t));
}
function pi(e) {
  return Ci(fi(e));
}
function mi(e, t) {
  let n = fr(e, t);
  if (n == null || n === e.snapshot.rootId || (R(q(e, n)) && er(e, n) !== n)) return null;
  let r = 0,
    i = n,
...
function hi(e, t) {
  ...
  return W(e, n, r)
    ...
    : (vn(e, n, !0, r),
      lr(e, n),
      Mn({ affectedAncestorIds: dr(e, n), affectedNodeIds: [n], path: t, projectionChanged: !0 }));
}
function gi(e, t) {
  let n = fr(e, t);
  if (n == null) throw Error(`Path does not exist: "${t}"`);
  ...
  return W(e, n, r)
    ? (vn(e, n, !1, r),
      lr(e, n),
      Nn({ affectedAncestorIds: dr(e, n), affectedNodeIds: [n], path: t, projectionChanged: !0 }))
    : null;
}
function _i(e, t) {
  ...
  let i = K(e, t),
    ...
    { childIndex: o, localVisibleIndex: s } =
      a == null
        ...
        : U(a, `store.getVisibleSlice.selectChildIndex`, () => ct(e.snapshot.nodes, i, n)),
    c = i.childIds[o];
...
function wi(e, t) {
  ...
  for (; d.length > 0 && s < t; ) {
    ...
    let x,
      S = _;
    if (R(v)) ((S = f ? er(e, _) : _), (x = S === _ ? `${b}${h[v.nameId]}/` : G(e, S)));
    else {
      let e = p.get(_);
      ...
      (Ni = class e {
        ...
        constructor(e = {}) {
          ...
          if (e.preparedInput != null) {
            ...
            e.presorted === !0
              ? n.appendPaths(r)
              : n.appendPreparedPaths(U(t, `store.preparePathEntries`, () => un(r, e)));
          }
          let r = U(t, `store.builder.finish`, () => n.finish({ skipSubtreeCountPass: !0 })),
            i = U(
              t,
          ...
          ((e.initialExpandedPaths?.length ?? 0) > 0 &&
            U(t, `store.state.checkAllDirectoriesExpanded`, () => this.hasAllDirectoriesExpanded()))
            ? U(t, `store.state.initializeOpenVisibleCounts`, () => Ai(this.#e))
            : U(t, `store.state.recomputeCounts`, () => ur(this.#e, this.#e.snapshot.rootId));
        }
        ...
        getVisibleCount() {
          return U(this.#e.instrumentation, `store.getVisibleCount`, () => J(this.#e));
        }
        getVisibleSlice(e, t) {
          return U(this.#e.instrumentation, `store.getVisibleSlice`, () => di(this.#e, e, t));
        }
        getVisibleRowContext(e) {
          return U(this.#e.instrumentation, `store.getVisibleRowContext`, () => ui(this.#e, e));
        }
        ...
        getVisibleIndex(e) {
          return U(this.#e.instrumentation, `store.getVisibleIndex`, () => mi(this.#e, e));
        }
        getPathInfo(e) {
          return U(this.#e.instrumentation, `store.getPathInfo`, () => {
            ...
            let n = q(this.#e, t);
            return { depth: L(n), kind: R(n) ? `directory` : `file`, path: G(this.#e, t) };
          });
        }
        isExpanded(e) {
        ...
        applyChildPatch(e, t) {
          return U(this.#e.instrumentation, `store.applyChildPatch`, () => {
            ...
            if (n == null || bn(this.#e, n) !== `loading` || !wn(this.#e, n, e.attemptId))
              return !1;
            let r = G(this.#e, n);
            ...
            for (let e of t.operations) {
              ...
              switch (e.type) {
                case `add`:
                  ...
                  break;
                case `remove`:
                  a.push(Bn(this.#e, t, ar(this.#e, e.path, { recursive: e.recursive })));
                  break;
                case `move`: {
        ...
        cleanup(e = {}) {
          return U(this.#e.instrumentation, `store.cleanup`, () => {
            ...
            if (ni(this.#e)) throw Error(`Cleanup cannot run while directory loads are active.`);
            let t = J(this.#e),
        ...
        resolveActiveDirectoryNodeId(e) {
          try {
            if (!R(q(this.#e, e))) throw Error(`Node is not a directory: ${String(e)}`);
            return e;
          } catch {
            return null;
          }
...
function Fi(e, t) {
  if (typeof e == `number`) return { itemHeight: t ?? Ii.default.itemHeight, factor: e };
  let n = Ii[e ?? `default`];
    ...
    if (
      ...
      if ((customElements.define(Ie, e), typeof document < `u`))
        for (let e of Array.from(document.querySelectorAll(Ie)))
          e instanceof HTMLElement && Zi(e, e.shadowRoot ?? e.attachShadow({ mode: `open` }));
    }
  }),
  ta,
  na = e(() => {
...
function pa(e, t) {
  ...
  for (let n of e) if (sa(n) && (t.directoryPath === n || t.directoryPath.startsWith(n))) return !0;
  return !1;
}
function ma(e, t) {
      ...
      (Ja = class {
        ...
        scrollToPath(e, t) {
          ...
          r < 0 ||
            (this.#Me(r) != null &&
              ...
              (this.#L = { id: (this.#R += 1), offset: Ha(t?.offset), visibleIndex: r }),
              this.#De()));
        }
        ...
        setDragTarget(e) {
          ...
          if (n != null) {
            ...
            (pa(t.draggedPaths, n) || this.#r?.canDrop?.(e) === !1) && (n = null);
          }
        ...
        completeDrag() {
          ...
          if (pa(e.draggedPaths, t) || this.#r?.canDrop?.(n) === !1) return (this.#De(), !1);
        ...
        #J() {
          ...
          let t = Na(e),
            n = aa({ files: this.#H.list(), isFolder: t, nextBasename: this.#E, path: La(e) });
        ...
        resetPaths(e, t = {}) {
          let n = this.#H.list().length,
            r = this.#G,
            i = va({ paths: e, preparedInput: t.preparedInput }, `resetPaths`, this.#e.sort),
        ...
        #Le(e) {
          ...
          let n = Ca(this.#c, e, !0),
            ...
            o = [...new Set(r)];
          return (ka(this.#B, o) || ((this.#B = new Set(o)), (this.#V += 1)), (this.#z = a), n);
        }
        #Re() {
          return this.#H.on(`*`, (e) => {
            if (this.#W) return;
...
function ao(e, t, n) {
  ...
  return (
    arguments.length > 2 && (o.children = arguments.length > 3 ? Uo.call(arguments, 2) : n),
    oo(e, o, r, i, null)
  );
}
...
function fo(e) {
  ((8 & e.__g || !(e.__g |= 8) || !Mo.push(e) || Po++) && No == Y.debounceRendering) ||
...
function mo(e, t, n, r, i, a, o, s, c, l, u, d) {
  ...
  for (c = ho(n, t, y, c, b), f = 0; f < b; f++)
    (m = n.__k[f]) != null &&
      ...
      (h = m.__e),
      m.ref && p.ref != m.ref && (p.ref && Eo(p.ref, null, m), u.push(m.ref, m.__c || h, m)),
      g == null && h != null && (g = h),
...
function ho(e, t, n, r, i) {
  ...
  if (d)
    for (a = 0; a < u; a++)
      (s = n[a]) != null && !(2 & s.__u) && (s.__e == r && (r = lo(s)), Do(s, s));
  return r;
}
function go(e, t, n, r) {
  var i, a;
  if (typeof e.type == `function`) {
    for (i = e.__k, a = 0; i && a < i.length; a++) i[a] && ((i[a].__ = e), (t = go(i[a], t, n, r)));
    return t;
  }
  e.__e != t &&
    (r && (t && e.type && !t.parentNode && (t = lo(e)), n.insertBefore(e.__e, t || null)),
    (t = e.__e));
  do t &&= t.nextSibling;
    ...
    try {
      if (
        ...
        n.__c
          ...
          : (y
              ? (t.__c = f = new O(v, x))
              : ((t.__c = f = new co(v, x)), (f.constructor = O), (f.render = Oo)),
            b && b.sub(f),
            (f.props = v),
            (f.state ||= {}),
            (f.context = x),
      ...
      ((f.state = f.__s),
        ...
        (w = d),
        d != null && d.type === so && d.key == null && (w = wo(d.props.children)),
...
function wo(e) {
  return typeof e != `object` || !e || (e.__b && e.__b > 0) ? e : Ho(e) ? e.map(wo) : Wo({}, e);
}
  ...
  if (b == null) v === y || (s && e.data == y) || (e.data = y);
        ...
        u == `children`
          ...
          : u == `dangerouslySetInnerHTML`
            ...
            : u == `value`
              ...
              : u == `checked`
                ? (g = m)
                : (s && typeof m != `function`) || (v[u] === m && !_) || yo(e, u, m, v[u], i));
    if (d)
    ...
    s ||
      ...
      b == `progress` && h == null
        ...
        : h == null || (h === e[u] && (b !== `progress` || h)) || yo(e, u, h, v[u], i),
      (u = `checked`),
...
function Do(e, t, n) {
  ...
  if ((r = e.__k))
    for (i = 0; i < r.length; i++) r[i] && Do(r[i], t, n || typeof e.type != `function`);
  (n || io(e.__e), e.__e && e.__e.__l && (e.__e.__l = null), (e.__e = e.__c = e.__ = null));
}
function Oo(e, t, n) {
  ...
  Go = e(() => {
    ((Bo = {}),
      ...
      (co.prototype.setState = function (e, t) {
        var n =
          this.__s != null && this.__s != this.state ? this.__s : (this.__s = Wo({}, this.state));
...
function is({
  ...
  if (Array.isArray(t)) {
    ...
    let t = null,
      ...
      d = null;
    if (typeof r == `string`)
      r === `center` ? (t = as) : r === `extension` ? (t = os) : r === `leaf-path` && (t = ss);
...
function Ss(e, t) {
  let n = t.totalRowCount ?? e.length,
    ...
    y = g + 1,
    b = ms(v) ? Cs : ps(Math.max(y, v.startIndex - a), Math.min(n - 1, v.endIndex + a)),
    x = hs(b, t.itemHeight);
  return {
...
var Ws = e(() => {});
function Gs({ ariaLabel: e, isFlattened: t = !1, ref: n, value: r, onBlur: i, onInput: a }) {
  return X(`input`, {
    ref: n,
...
function Fc(e, t) {
  ...
  return t ? { icon: { name: `file-tree-icon-dot`, width: 6, height: 6 }, title: Ds } : null;
}
function Ic(e, t, n) {
...
function il(
  ...
  return X(so, {
    children: [
      ...
      i
        ? X(`div`, { "data-item-section": `decoration`, children: r == null ? null : nl(r, t) })
        : null,
          ...
          ? (e) => {
              ...
              S &&
                ...
                w &&
                  ...
                  re(t, A, { anchorRect: Gc(e.clientX, e.clientY), source: `right-click` })));
            }
          : void 0,
      onFocus: oe
        ? void 0
...
function sl({
  ...
  let je = Z(null),
    ...
    ze = (e, t) => {
      ((Me.current = null), (Ne.current = { path: e, viewportOffset: t }), (Pe.current = null));
    },
  ...
  let rt = rc((e, t) => {
    ...
    Et = rc((e) => (Ns(e == null ? null : (te.current.get(e) ?? null)) ? !0 : Ns(S.current)), []),
    Dt = rc(
      (e) => {
  ...
  let Mt = rc((e) => {
    ...
    Nt = rc(
      (e, n, r) => {
        ...
        if (a?.dataset.fileTreeStickyRow === `true`) {
          let e = C.current;
          (Re(n, e?.scrollTop ?? null), (O.current = !0), be((e) => (e === n ? e : n)));
        }
        (i.focus(),
          Mt(a),
          (kt.current = !0),
        ...
        if (l) {
          if (t.isSearchOpen()) {
            ...
            ((ie.current =
              F < 0 || e == null
                ? null
                : Math.max(0, Math.min(F * s - e.scrollTop, Math.max(0, t - s)))),
              (j.current = !0));
          }
    ...
    Ft = rc(
      (e, { restoreTreeFocus: n = !0, targetOffset: r = `live-overlay` } = {}) => {
        ...
        return (
          (O.current = !0), Bs(i, a, s, l, u, d), T.current(), (je.current = n ? e : null), !0
        );
      },
      [t, s, c, V, h],
    ),
    ...
    Zt = (e) => {
      ...
      if (lt.isActive()) {
        ...
        (Ee(`focus`), ve((e) => e + 1), e.preventDefault(), e.stopPropagation());
        return;
      }
      if (l && e.key === `F2`) {
      ...
      if ((h || T) && b != null && ((ee && x) || T))
        (Re(b, v?.scrollTop ?? null), (O.current = !0), be((e) => (e === b ? e : b)));
      else {
  ...
  (tc(() => {
    ...
    tc(() => {
      let e = x.current;
      switch (
        Us({ hasRenderedInput: e != null, previousRenamingPath: A.current, renamingPath: ut })
      ) {
        case `reset`:
          A.current = null;
          return;
        case `reveal-canonical`:
          ut != null && Ft(ut, { restoreTreeFocus: !1, targetOffset: `live-overlay` });
          return;
        case `ignore`:
          return;
        case `focus-input`:
          e != null && ((je.current = null), (A.current = ut), Ns(e), e.select());
          return;
      }
  ...
  (tc(() => {
    ...
    tc(() => {
      ...
      let e = S.current?.getRootNode(),
        ...
        n = (e) => {
          let n = e.target;
          n instanceof Node &&
            (Uc(e) || (_.current?.contains(n) !== !0 && t?.contains(n) !== !0 && jt()));
        },
        r = (e) => {
    ...
    tc(() => {
      ...
      if (I != null && I.id !== ne.current) {
        ...
        if (r != null) {
          let t = h ? Math.max(0, Math.min(r.ancestorPaths.length * s, Math.max(0, V - s))) : St;
      ...
      let D = !w && l && Bs(e, F, s, V, U, u),
        ...
        A = !w && m != null && m.path === P && Bs(e, F, s, V, U, m.viewportOffset),
        ae = !w && g != null && g.path === P && e.scrollTop !== g.scrollTop;
      if (
        (ae && (e.scrollTop = g.scrollTop),
        (ae || E || re || A || D || (v && y && d !== P && !b && Rs(e, F, s, V, St))) && T.current(),
        w)
      ) {
        k.current = P;
        return;
      ...
      ((y || l || d === P || p === P || m?.path === P || g?.path === P || a == null || a !== P) &&
        (Ns(r),
        d === P && (je.current = null),
        p === P && (Me.current = null),
        ...
        i =
          n instanceof HTMLElement
            ...
            : r instanceof HTMLElement
              ...
              : null;
      (i != null && Ee((e) => (e === `pointer` ? e : `pointer`)), Se((e) => (e === i ? e : i)));
    }, []),
    cn = rc(() => {
      Se(null);
    }, []);
  ...
  let ln = (e) => {
    ...
    un = (e) => {
      ...
      (n instanceof Node && S.current?.contains(n) === !0) || (zt(), Vt(), t.setDragTarget(null));
    },
    dn = (e) => {
      !L ||
    ...
    gn = ye === P || j.current,
    _n = P != null && gn && !wt && F >= 0 ? (yt[F] ?? t.getVisibleRows(F, F)[0] ?? null) : null,
    W = _n == null ? null : Vs(F, s, H, fn),
    vn = ue.current,
    yn = z != null && vn != null && vn.path === z && vn.index >= H.start && vn.index <= H.end,
    bn = z != null && vn != null && vn.path === z && !yn && vn.path !== _n?.path ? vn : null,
    xn = bn == null ? null : Vs(bn.index, s, H, fn),
    Sn = Bc(
      (F >= 0 ? (yt[F] ?? t.getVisibleRows(F, F)[0] ?? null) : null)?.ancestorPaths.at(-1) ?? null,
    ),
    ...
    On = N && (Dn || M != null),
    kn = M?.anchorRect,
    An = kn == null && En != null && Ce != null && (M != null || Dn) ? Ce : null,
    jn =
      kn == null
        ? An == null
          ? void 0
  ...
  return X(`div`, {
    ...
    children: [
      X(`style`, { "data-file-tree-guide-style": `true`, dangerouslySetInnerHTML: { __html: Sn } }),
...
function Tl(e) {
  ...
  for (var n in e) {
    var r = e[n];
    if (r != null && r !== ``) {
      var i = n[0] == `-` ? n : Hl[n] || (Hl[n] = n.replace(Wl, `-$&`).toLowerCase()),
        a = `;`;
...
function Dl(e, t) {
  return { __v: e, context: t, props: e.props, setState: El, forceUpdate: El, __d: !0, __h: [] };
}
function Ol(e, t, n) {
  if (!e.s) {
    if (n instanceof Gl) {
    ...
    if (n && n.then) return void n.then(Ol.bind(null, e, t), Ol.bind(null, e, 2));
    ((e.s = t), (e.v = n));
    let r = e.o;
    r && r(e);
  }
...
function kl(e, t) {
  ...
  return (
    ...
    r.getDerivedStateFromProps
      ? (n.state = Ql({}, n.state, r.getDerivedStateFromProps(n.props, n.state)))
      : i && n.componentWillMount
        ? (n.componentWillMount(), (n.state = n[Fl] === n.state ? n.state : n[Fl]))
...
function Al(e, t, n, r, i, a, o) {
  ...
  var s = typeof e;
  if (s != `object`) return s == `function` ? $l : s == `string` ? wl(e) : e + $l;
  if (Zl(e)) {
    var c,
      l = $l;
    i[Nl] = e;
  ...
  if (typeof h == `function`) {
    ...
    if (h === so) {
      ...
      if (`UNSTABLE_comment` in g) return `<!--` + wl(g.UNSTABLE_comment) + `-->`;
      v = g.children;
    } else {
      ...
      if (
        ...
        v =
          v != null && v.type === so && v.key == null && v.props.tpl == null ? v.props.children : v;
        try {
          return Al(v, t, n, r, e, a, !1);
        } catch (i) {
          return (
            h.getDerivedStateFromError && (y[Fl] = h.getDerivedStateFromError(i)),
            y.componentDidCatch && y.componentDidCatch(i, Xl),
            Cl(y)
              ? ((v = kl(e, t)),
                (y = e[Ml]).getChildContext != null && (t = Ql({}, t, y.getChildContext())),
                Al(
                  (v =
    ...
    v = v != null && v.type === so && v.key == null && v.props.tpl == null ? v.props.children : v;
    try {
  ...
  for (var k in g) {
    var A = g[k];
    if (typeof (A = jl(A) ? A.value : A) != `function` || k === `class` || k === `className`) {
      switch (k) {
        case `children`:
          D = A;
          continue;
      ...
      A != null &&
        ...
        (re =
          !0 === A || A === $l
            ? re + ` ` + k
            : re + ` ` + k + `="` + (typeof A == `string` ? wl(A) : A + $l) + `"`);
    }
  }
  if (Il.test(h)) throw Error(h + ` is not a valid HTML tag name in ` + re + `>`);
  if (
    (O ||
      (typeof D == `string`
        ? (O = wl(D))
        : D != null &&
          !1 !== D &&
          !0 !== D &&
          (O = Al(D, t, h === `svg` || (h !== `foreignObject` && n), r, e, a, o))),
    ql && ql(e),
    Yl && Yl(e),
    !O && nu.has(h))
  )
  ...
  var j = `</` + h + `>`,
    ie = re + `>`;
  return Zl(O) ? [ie].concat(O, [j]) : typeof O == `string` ? ie + O + j : [ie, O, j];
}
function jl(e) {
          ...
          (e.prototype.then = function (t, n) {
            ...
            return (
              (this.o = function (e) {
                try {
                  var i = e.v;
                  1 & e.s ? Ol(r, 1, t ? t(i) : i) : n ? Ol(r, 1, n(i)) : Ol(r, 2, i);
                } catch (e) {
                  Ol(r, 2, e);
                }
              }),
  ...
  du = e(() => {
    (Fe(),
      ...
      (uu = class {
        ...
        unmount() {
          (this.#b != null &&
            (gl(this.#b), delete this.#b.dataset.fileTreeVirtualizedWrapper, (this.#b = void 0)),
            this.#l.clearAll(),
            this.#l.setHost(null),
            this.#f != null &&
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~remote-conversation-page~pull-requests-page~new-~0350jj6u.js.map
