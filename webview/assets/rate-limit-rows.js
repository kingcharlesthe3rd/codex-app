...
import { On as u, fi as d, ui as f } from "./app-server-manager-signals.js";
...
import { c as x, i as S } from "./statsig-DoZ-0xit.js";
...
function Ne(e) {
  ...
  let [L, ne] = (0, K.useState)(I),
    ...
    Ee = u.isPending || d.isPending,
    De = f.isPending,
    J = Ee || De,
    Y = r === `add-credits` && !R,
    Ae;
  t[6] !== H || t[7] !== Y || t[8] !== F || t[9] !== l || t[10] !== k
    ? ((Ae = H
        ? `invalid-currency-amount`
        : Y
          ? de({ value: k, pricingInfo: l })
  ...
  t[47] !== d
    ? (($e = async () => {
        ...
        if ((fe(!0), V(!0), !(Q == null || J)))
          try {
            if ((Ye(), Z == null)) return;
            let e = Q === `enable` ? await u.mutateAsync(Z) : await d.mutateAsync(Z);
  ...
  bb0: switch (r) {
    ...
    case `setup-auto-reload`: {
      ...
      (t[58] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        (rt = e));
      let n;
      (t[59] !== C || t[60] !== F || t[61] !== L || t[62] !== l || t[63] !== k
        ? ((n = (0, q.jsx)(ze, {
            intl: C,
            targetBalance: k,
            minimumBalance: F,
        ...
        (it = n));
      let r;
      (t[65] !== C || t[66] !== F || t[67] !== L || t[68] !== l || t[69] !== k
        ? ((r = (0, q.jsx)(ze, {
            intl: C,
            targetBalance: k,
            minimumBalance: F,
    ...
    case `manage-auto-reload`: {
      ...
      (t[71] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        (rt = e));
      let n;
      (t[72] !== C || t[73] !== F || t[74] !== L || t[75] !== l || t[76] !== k
        ? ((n = (0, q.jsx)(ze, {
            intl: C,
            targetBalance: k,
            minimumBalance: F,
        ...
        (it = n));
      let r;
      (t[78] !== C || t[79] !== F || t[80] !== L || t[81] !== l || t[82] !== k
        ? ((r = (0, q.jsx)(ze, {
            intl: C,
            targetBalance: k,
            minimumBalance: F,
  ...
  t[96] !== r
    ...
    : (ct = t[97]);
  let lt;
  t[98] !== s || t[99] !== C || t[100] !== l || t[101] !== ct
    ? ((lt = (0, q.jsx)(He, { intl: C, creditDetails: s, pricingInfo: l, actions: ct })),
      (t[98] = s),
      (t[99] = C),
      (t[100] = l),
      (t[101] = ct),
  ...
  let dt = re ? X : null,
    ft;
  t[105] !== Y || t[106] !== l
    ? ((ft = Y ? ue(l) : 125), (t[105] = Y), (t[106] = l), (t[107] = ft))
    : (ft = t[107]);
  let pt = Y ? 250 : null,
    mt,
    ht;
...
function Ve() {
  s.dispatchMessage(`open-in-browser`, { url: Ae });
}
function He(e) {
  let t = (0, G.c)(12),
...
function Ue({ scope: e, source: t, email: n, quantity: r, onOpenChange: i, statsigClient: a }) {
  let o = V(r);
  (v(e, g, { creditQuantity: f(o), source: t }),
    v(e, d, { checkoutKind: `standalone_credit`, entryPoint: `codex_purchase_credits_route` }),
    s.dispatchMessage(`open-in-browser`, {
      url: I({
        loginHint: n,
        statsigClient: a,
        url: `${l}/purchase/credits?quantity=${encodeURIComponent(o)}`,
      }),
    }),
    i(!1));
}
...
function Ye(e) {
  ...
  let { data: l, isError: d, refetch: f } = F(c),
    ...
    e[0] !== t || e[1] !== n
      ? ((r = (e) => {
          ...
          if (e.intent === `purchase`) {
            s.dispatchMessage(`open-in-browser`, { url: e.legacyUrl });
            return;
          }
