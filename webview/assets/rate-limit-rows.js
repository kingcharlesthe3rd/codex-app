...
import { _r as s, cn as c, hr as l } from "./thread-context-inputs.js";
...
function Ge({ scope: e, source: t, email: n, quantity: r, onOpenChange: i, statsigClient: a }) {
  let o = H(r);
  (w(e, C, { creditQuantity: l(o), source: t }),
    w(e, s, { checkoutKind: `standalone_credit`, entryPoint: `codex_purchase_credits_route` }),
