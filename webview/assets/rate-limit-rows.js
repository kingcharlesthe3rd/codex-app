...
import { F as d, I as f, _ as p, f as m, h, lt as g } from "./vscode-api.js";
import { c as _, o as v } from "./lib-2.js";
import { h as y } from "./persisted-signal-CweW-bgN.js";
import { c as b, i as x } from "./statsig.js";
import { t as S } from "./request.js";
import { t as C } from "./use-auth-CI-WraL2.js";
...
import { A as L, x as ne, y as R } from "./use-rate-limit-CL-Jgab4.js";
...
function Ne(e) {
  ...
  t[47] !== l
    ? (($e = async () => {
        if ((z(!0), Y)) {
          X ??
            Ue({ scope: g, source: r, email: x, quantity: k, onOpenChange: f, statsigClient: S });
          return;
        }
        if ((fe(!0), V(!0), !(Q == null || J)))
          try {
            ...
            if ((y(g, n, { action: Q, source: r }), N(e.immediate_top_up_status))) {
              (Ce(!0),
                Te(
                  be({
                    intl: T,
  ...
  let et = $e,
    tt;
  t[49] !== u || t[50] !== T || t[51] !== f || t[52] !== g || t[53] !== r
    ? ((tt = async () => {
        try {
          (await u.mutateAsync(),
            y(g, n, { action: `disable`, source: r }),
  ...
  t[96] !== i
    ...
    : (ct = t[97]);
  let lt;
  t[98] !== o || t[99] !== T || t[100] !== s || t[101] !== ct
    ? ((lt = (0, q.jsx)(He, { intl: T, creditDetails: o, pricingInfo: s, actions: ct })),
      (t[98] = o),
      (t[99] = T),
      (t[100] = s),
      (t[101] = ct),
...
function Ue({ scope: e, source: n, email: r, quantity: a, onOpenChange: c, statsigClient: l }) {
  let u = V(a);
  (y(e, i, { creditQuantity: o(u), source: n }),
    y(e, s, { checkoutKind: `standalone_credit`, entryPoint: `codex_purchase_credits_route` }),
...
function Ye(e) {
  ...
  if (l == null) {
    let e;
    return (
      t[25] !== A || t[26] !== u || t[27] !== d || t[28] !== r || t[29] !== i
        ? ((e = u
            ? (0, q.jsx)($, {
                open: !0,
                source: r,
...
function $e() {
  ...
  return (
    e[0] !== t || e[1] !== n
      ? ((i = (e) => {
          let i = x(n, Xe, { disableExposureLog: !1 }).get(`enabled`, !1);
          if (Ze({ intent: e.intent, isCombinedModalEnabled: i }) === `combined-modal`) {
            (y(t, r, { isAutoReloadEnabledAtOpen: e.isAutoReloadEnabled, source: e.source }),
              E(t, Ye, {
                source: e.source,
