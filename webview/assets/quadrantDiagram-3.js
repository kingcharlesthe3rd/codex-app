...
import { N as r } from "./runtime.worker-CnG-97Cx.js";
import {
  B as i,
  C as a,
  E as o,
...
var g = (function () {
  var e = t(function (e, t, n, r) {
    ...
    L = [1, 62],
    R = [1, 61],
    z = [4, 5, 8, 10, 12, 13, 14, 18, 44, 47, 49, 55, 56, 57, 63, 64, 65, 66, 67],
    B = [1, 65],
    ee = [1, 66],
    te = [1, 67],
    ne = [1, 68],
    ...
    pe = {
      ...
      table: [
        ...
        { 4: H, 5: U, 6: W, 8: G, 11: K, 13: q, 16: 89, 17: J, 18: Y, 19: X, 20: Z, 22: 105 },
        e(Q, [2, 26]),
        e(l, [2, 50], { 10: de }),
        e(fe, [2, 28], {
          16: 103,
  ...
  y = class {
    ...
    getDefaultConfig() {
      return {
        ...
        quadrantInternalBorderStrokeWidth: m.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
        quadrantExternalBorderStrokeWidth: m.quadrantChart?.quadrantExternalBorderStrokeWidth || 2,
      };
    }
    ...
    setConfig(t) {
      (e.trace(`setConfig called with: `, t), (this.config = { ...this.config, ...t }));
    }
    setThemeConfig(t) {
    ...
    calculateSpace(e, t, n, r) {
      let i = this.config.xAxisLabelPadding * 2 + this.config.xAxisLabelFontSize,
        a = { top: e === `top` && t ? i : 0, bottom: e === `bottom` && t ? i : 0 },
        ...
        f = this.config.chartWidth - this.config.quadrantPadding * 2 - s.left - s.right,
        p = this.config.chartHeight - this.config.quadrantPadding * 2 - a.top - a.bottom - l.top;
      return {
        xAxisSpace: a,
        yAxisSpace: s,
        titleSpace: l,
          ...
          m.push({
            ...
            y:
              e === `top`
                ...
                : this.config.xAxisLabelPadding + u + s + this.config.quadrantPadding,
          ...
          m.push({
            ...
            x:
              this.config.yAxisPosition === `left`
                ...
                : this.config.yAxisLabelPadding + c + d + this.config.quadrantPadding,
            y: u + s - (p ? o / 2 : 0),
    ...
    getQuadrants(e) {
      let { quadrantSpace: t } = e,
        { quadrantHalfHeight: n, quadrantLeft: r, quadrantHalfWidth: i, quadrantTop: a } = t,
        o = [
          {
            text: {
      ...
      for (let e of o)
        ((e.text.x = e.x + e.width / 2),
          this.data.points.length === 0
            ? ((e.text.y = e.y + e.height / 2), (e.text.horizontalPos = `middle`))
    ...
    getQuadrantPoints(e) {
      let { quadrantSpace: t } = e,
        { quadrantHeight: n, quadrantLeft: i, quadrantTop: a, quadrantWidth: o } = t,
        s = r()
          .domain([0, 1])
          .range([i, o + i]),
        c = r()
    ...
    build() {
      let e = this.config.showXAxis && !!(this.data.xAxisLeftText || this.data.xAxisRightText),
        t = this.config.showYAxis && !!(this.data.yAxisTopText || this.data.yAxisBottomText),
...
` + r,
      ...
      let d = u.securityLevel,
        m;
      d === `sandbox` && (m = n(`#i` + i));
      let h = n(d === `sandbox` ? m.nodes()[0].contentDocument.body : `body`).select(`[id="${i}"]`),
...
//# sourceMappingURL=quadrantDiagram-3.js.map
