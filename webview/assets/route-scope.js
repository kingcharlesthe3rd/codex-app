import { m as e, t } from "./app-scope.js";
import { $ as n, Lr as r, Q as i, Z as a, at as o, et as s } from "./src-4.js";
import { u as c } from "./chunk-8.js";
var l = e(`RouteScope`, {
...
function f({ pathname: e, routeTemplate: t, search: l = `` }) {
  let u = c(s, e)?.params.conversationId ?? c(n, e)?.params.conversationId;
  if (u != null) {
  ...
  let d = c(o, e)?.params.taskId ?? c(i, e)?.params.taskId;
  return d == null
    ? e === `/` || e === `/hotkey-window`
      ? { pathname: e, routeKind: `home`, routeTemplate: t, search: l }
      : e === `/extension/panel/new` || e === a
