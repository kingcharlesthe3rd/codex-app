...
function G(e) {
  ...
  t[34] === a
    ? (M = t[35])
    : ((M = de(`text-token-text-secondary mt-0.5 text-base leading-relaxed text-pretty`, a)),
      (t[34] = a),
      (t[35] = M));
  let N;
  t[36] !== s || t[37] !== M
  ...
  t[39] !== y || t[40] !== x || t[41] !== j || t[42] !== N
    ? ((P = (0, K.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [j, N, y, x] })),
      (t[39] = y),
      (t[40] = x),
      (t[41] = j),
      (t[42] = N),
...
function Qt() {
  let e = (0, en.c)(13),
    t = l(i),
    { authMethod: r, email: a, isLoading: o, planAtLogin: s } = I(),
    c = r === `chatgpt`,
    u;
  e[0] === c ? (u = e[1]) : ((u = { queryConfig: { enabled: c } }), (e[0] = c), (e[1] = u));
  let { data: d, isLoading: f } = _(`account-info`, u),
    ...
    v = Ge(),
    b = te(h.enabled),
    x = n({ authMethod: r, email: d?.email ?? a, plan: d?.plan ?? s }),
    S = g && x && b === !0 && p === !1,
    { data: C, isLoading: w } = me({ enabled: S, hostId: Fe }),
    T;
  e[2] === C ? (T = e[3]) : ((T = C === void 0 ? [] : C), (e[2] = C), (e[3] = T));
  let E = T,
    D;
  e[4] === E ? (D = e[5]) : ((D = Et(E)), (e[4] = E), (e[5] = D));
  let O = $t({
      hasConnectedApps: D.length > 0,
      isLoadingApps: w,
      isLoadingEligibilityInputs: o || !m || v || f,
      shouldLoadApps: S,
    }),
    k,
    A;
...
async function dn(e, t, n) {
  try {
    await we.safePost(`/beacons/event`, {
      requestBody:
        n == null
...
function hn() {
  let e = (0, gn.c)(30),
    t = l(i),
    { accountId: n, authMethod: r, isLoading: a, userId: o } = I(),
    { data: s } = ie(),
    c = Pe(),
    u = y(xn),
    d = y(Cn),
    ...
    m,
    h;
  if (e[0] !== n || e[1] !== r || e[2] !== s?.id || e[3] !== a || e[4] !== c || e[5] !== o) {
    let t = c.getContext().user?.customIDs?.account_id;
    ((m = n ?? s?.id ?? t ?? o ?? null),
      (h = ln({ accountId: m, authMethod: r, isAuthLoading: a })),
      (e[0] = n),
      (e[1] = r),
      (e[2] = s?.id),
      (e[3] = a),
  ...
  let g = h,
    _;
  e[8] === a ? (_ = e[9]) : ((_ = un({ isAuthLoading: a })), (e[8] = a), (e[9] = _));
  let v = _,
    b,
    x;
  ...
  let w =
      d.data?.accountId === m
        ...
        : null,
    T;
  if (e[19] !== u || e[20] !== w || e[21] !== m || e[22] !== g) {
    let t = w != null && m != null ? fn(m, w.beacon_id) : null;
    ((T = g && w != null && t != null && !u.has(t) ? w : null),
      (e[19] = u),
      (e[20] = w),
      (e[21] = m),
      (e[22] = g),
  ...
  let E = T,
    ...
    A;
  return (
    e[24] !== E || e[25] !== m || e[26] !== D || e[27] !== O || e[28] !== k
      ? ((A = {
          accountId: m,
          beacon: E,
          isEligible: O,
  ...
  wn = e(() => {
    ((gn = g()),
      ...
      (Cn = s(i, ({ get: e }) => {
        let t = e(vn);
        return {
          queryKey: [`codex-app-home-beacon`, t, e(E).locale],
          enabled: e(yn),
          refetchOnMount: !1,
          ...
          queryFn: async () => ({
            accountId: t,
            response: await we.safeGet(`/beacons/home`, {
...
function Tn(e) {
  let t = (0, kn.c)(13),
    { accountId: n, beacon: r, localActionHandlers: a } = e,
    o = l(i),
    s,
    c;
  (t[0] !== n || t[1] !== r || t[2] !== o
  ...
  return (
    t[9] !== r || t[10] !== a || t[11] !== u
      ? ((d = (0, jn.jsx)(En, { beacon: r, localActionHandlers: a, onDismiss: u })),
        (t[9] = r),
        (t[10] = a),
        (t[11] = u),
        (t[12] = d))
          ...
          return {
            ...
            onClick: (r) => {
              if ((dn(n, `click`, e.id), t?.({ action: e, beacon: n }) !== !0 && i != null)) {
                if (!i.startsWith(`/`)) {
                  ce({ event: r, href: i, initiator: `open_in_browser_bridge` });
                  return;
                }
                o(i);
              }
...
var kn,
  ...
  jn,
  Mn = e(() => {
    ((kn = g()), f(), (An = t(p(), 1)), H(), Je(), Dt(), wn(), fe(), q(), B(), r(), (jn = v()));
  });
function Nn(e) {
  let t = (0, Pn.c)(16),
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Fn.jsx)(`img`, { alt: ``, src: zt, className: `h-8 w-8 shrink-0` })), (t[1] = o))
    : (o = t[1]);
  let s;
...
var Pn,
  Fn,
  In = e(() => {
    ((Pn = g()), H(), Lt(), fe(), q(), B(), (Fn = v()));
  });
function Ln(e) {
  let t = (0, zn.c)(6),
    { platform: n, isLoading: r } = rt(),
    { authMethod: i, planAtLogin: a, isLoading: o } = I(),
    s = i === `chatgpt`,
    c = i === `apikey`,
    l = s || c,
    u;
...
var zn,
  ...
  Hn = e(() => {
    ((zn = g()),
      ...
      m(),
      (Bn = v()),
      (Vn = pe(`has-seen-app-upsell-banner`, !1)));
  });
function Un(e) {
  let t = (0, Wn.c)(25),
    {
  ...
  let p, m;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, Gn.jsx)(Ze, { className: `icon-sm text-[#FFC93C]` })),
      (m = (0, Gn.jsx)(W, {
    ...
    : ((p = t[1]), (m = t[2]));
  let h;
  t[3] !== r || t[4] !== d || t[5] !== s || t[6] !== c || t[7] !== u
    ? ((h = () => {
        r != null &&
          (c(!0),
          V(d, He, {}),
          u(ye(r)?.id ?? `priority`, `home_banner`).finally(() => {
            (s(!0), c(!1));
          }));
      }),
      (t[3] = r),
...
var Wn,
  Gn,
  Kn = e(() => {
    ((Wn = g()), Te(), f(), H(), q(), Qe(), B(), Oe(), r(), Ce(), (Gn = v()));
  });
function qn() {
  let e = (0, Jn.c)(18),
    t = l(i),
    n = U(),
    { isServiceTierAllowed: r } = ot(),
    { data: a } = lt(),
    [o, s] = b(Zn),
    { modelSettings: c } = pt(),
    { serviceTierSettings: u, setServiceTier: d } = dt(),
    [f, p] = (0, Yn.useState)(!1),
    m = (0, Yn.useRef)(!1),
    h = a?.models,
    g;
  e[0] !== c.model || e[1] !== h
    ? ((g = je(h, c.model, ke)), (e[0] = c.model), (e[1] = h), (e[2] = g))
    : (g = e[2]);
  let _ = g,
    v = r && _ != null && !o && u.selectedServiceTier == null && !u.isLoading,
    { estimate: y, estimateStatus: x } = $e(v),
    S = !o && v && x !== `ready` && x !== `failed`,
    C = v && x === `ready` && y != null,
    w,
    T;
  (e[3] !== C || e[4] !== t
    ? ((w = () => {
        !C || m.current || ((m.current = !0), V(t, Me, {}));
      }),
      (T = [t, C]),
      (e[3] = C),
      (e[4] = t),
...
var Jn,
  ...
  Qn = e(() => {
    ((Jn = g()),
      ...
      Xe(),
      (Xn = v()),
      (Zn = pe(`has-seen-fast-mode-home-banner`, !1)));
  });
function $n() {
  let e = (0, tr.c)(5),
    { hostId: t } = S(ht()),
    n = C(),
    [r] = b(rr),
    { data: i, isLoading: o } = a(he, t),
    s;
  e[0] === i ? (s = e[1]) : ((s = i?.some(er) ?? !1), (e[0] = i), (e[1] = s));
  let c = s,
    l = n && !r && o,
    u = n && !r && !c,
    d;
...
var tr,
  ...
  ir = e(() => {
    ((tr = g()),
      ...
      P(),
      (nr = `multi_agent`),
      (rr = pe(`has-seen-multi-agent-composer-banner`, !1)));
  });
function ar(e) {
  let t = (0, or.c)(31),
    { onTryNow: n } = e,
  ...
  if (
    (t[1] !== h || t[2] !== r
      ? ((g = () => {
          !h || m.current || ((m.current = !0), V(r, xe, {}));
        }),
        (_ = [r, h]),
        (t[1] = h),
        (t[2] = r),
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, Y.jsx)(W, {
      ...
      (x = (0, Y.jsx)(Kt, { className: `icon-sm` })),
      (S = (0, Y.jsx)(W, {
      ...
      (t[7] = x),
      (t[8] = S))
    : ((v = t[5]), (y = t[6]), (x = t[7]), (S = t[8]));
  let C;
  t[9] !== a || t[10] !== n || t[11] !== r || t[12] !== c || t[13] !== s || t[14] !== d
    ? ((C = () => {
        p(!0);
...
function ur(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, X.jsx)(`span`, {
      ...
      (s = (0, X.jsx)(Nt, { className: `icon-sm` })),
      (c = (0, X.jsx)(W, {
...
function br(e) {
  ...
  t[0] !== n || t[1] !== a
    ? ((o = () => {
        k(a, Bt, { initialAvailableCount: n, isRateLimitReached: !1, onResetComplete: xr });
      }),
      (t[0] = n),
      (t[1] = a),
      (t[2] = o))
  ...
  return (
    t[3] !== r || t[4] !== o
      ? ((s = (0, Z.jsx)(Sr, { onDismiss: r, onSeeResets: o })), (t[3] = r), (t[4] = o), (t[5] = s))
      : (s = t[5]),
    s
  );
}
...
var Cr,
  Z,
  wr = e(() => {
    ((Cr = g()), f(), H(), R(), q(), Vt(), B(), Rt(), r(), (Z = v()));
  });
function Tr() {
  let e = (0, Er.c)(9),
    t = l(i),
    { accountId: n, isLoading: r } = I(),
    a = y(Or),
    { data: o, isLoading: s } = y(qe),
    c = o?.rate_limit_reset_credits?.available_count ?? 0,
    u = n == null ? null : a?.[n],
    d = Date.now(),
    f;
  e[0] !== n || e[1] !== c || e[2] !== t
...
var Er,
  ...
  kr = e(() => {
    ((Er = g()),
      ...
      Le(),
      (Dr = 1440 * 60 * 1e3),
      (Or = Ie(`rate-limit-reset-home-announcement-dismissal-by-account-id`, {})));
  });
function Ar(e) {
  let t = (0, jr.c)(17),
    { navigate: n } = e,
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(W, {
      ...
      (c = (0, Q.jsx)(re, { className: `icon-sm` })),
      (u = (0, Q.jsx)(W, {
      ...
      (t[2] = c),
      (t[3] = u))
    : ((o = t[0]), (s = t[1]), (c = t[2]), (u = t[3]));
  let d;
  t[4] !== n || t[5] !== r
    ? ((d = {
        label: u,
        onClick: () => {
          (r.set(gt, !0), n(`/settings/connections`));
        },
        className: `px-3 max-[400px]:flex-1 max-[400px]:justify-center`,
      }),
      (t[4] = n),
...
function Lr() {
  ...
  e[0] !== r || e[1] !== t.pathname
    ? ((i = vt({ hideFirstNewThreadOnboardingPromos: r, pathname: t.pathname })),
      (e[0] = r),
      (e[1] = t.pathname),
      (e[2] = i))
    : (i = e[2]);
...
//# sourceMappingURL=home-announcements-Dizo-1Ny.js.map
