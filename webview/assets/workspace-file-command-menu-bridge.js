...
import { r as g } from "./tooltip.js";
import { t as _ } from "./route-scope.js";
import { t as v } from "./open-workspace-file.js";
import { At as y } from "./review-navigation-model.js";
...
import { r as C } from "./use-register-command-D7-mciT3.js";
import { a as w } from "./command-keybindings.js";
import { t as T } from "./search.js";
import { d as E } from "./inline-mentions-C8jF-sc9.js";
import { n as D, t as O } from "./dist.js";
import { t as k } from "./slash-command-item.js";
import { n as A } from "./at-mention-list.js";
...
function L(e) {
  let t = (0, P.c)(31),
    { clearSearch: n, close: r, hostId: u, onSelectFile: d, workspaceRoot: f } = e,
    p = s(a),
    m = i(),
    h = c(w, `searchFiles`),
    _ = O(z),
  ...
  let S;
  t[2] !== u || t[3] !== b || t[4] !== x
    ? ((S = { hostId: u, query: b, roots: x }), (t[2] = u), (t[3] = b), (t[4] = x), (t[5] = S))
    : (S = t[5]);
  let { sections: E } = A(S),
    M = E[0],
    L,
  ...
  if (
    ...
    let r = h ?? ``,
      i;
    t[12] === r ? (i = t[13]) : ((i = (0, I.jsx)(g, { keysLabel: r })), (t[12] = r), (t[13] = i));
    let a;
    t[14] !== n || t[15] !== p
      ? ((a = () => {
          (n(), p.set(N, `files`));
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (H = t[22]);
  let U;
  t[23] !== r || t[24] !== M.emptyState || t[25] !== M.items || t[26] !== m || t[27] !== d
    ? ((U =
        M.items.length > 0
          ? M.items.map((e, t) =>
              (0, I.jsx)(
...
function B() {
  let e = (0, P.c)(25),
    ...
    w = c.kind === `git` ? c.git.root : c.kind === `plain` ? (g ?? c.cwd) : null,
    T = w != null,
    D;
  e[0] !== T || e[1] !== o || e[2] !== i || e[3] !== a || e[4] !== n || e[5] !== w
    ? ((D = (e) => {
        !T ||
          w == null ||
          v({
