...
import { f, i as p, m, n as h, p as g, s as _, u as v } from "./vscode-api.js";
import {
  G as y,
  Ki as b,
  S as x,
...
import { c as Te, o as Ee, r as De } from "./lib-1.js";
...
import { f as Ne } from "./statsig-DoZ-0xit.js";
import { t as Pe } from "./thread-context-inputs.js";
import { E as Fe, s as Ie, u as Le } from "./sidebar-signals.js";
import { t as Re } from "./open-workspace-file.js";
import { t as ze } from "./clock.js";
import { t as Be } from "./route-scope.js";
import { r as Ve } from "./thread-context.js";
import { t as He } from "./project-context-signal.js";
import { t as Ue } from "./app-intl-signal.js";
import { b as We } from "./process-manager-target.js";
import { r as Ge } from "./use-register-command.js";
...
import { T as Ze, m as Qe, p as I, y as $e } from "./review-header-toolbar-p.js";
import { o as et } from "./review-runtime-bridge.js";
import { a as tt } from "./gh-pull-request-status-query.js";
import { n as nt, t as rt } from "./dist-14.js";
import { t as it } from "./slash-command-item-D6wU-Usp.js";
import { n as at } from "./at-mention-list-1.js";
var ot = `custom:`;
function st(e) {
  return `${ot}${e}`;
}
function L(e) {
  return e.startsWith(ot) ? e.slice(7) : null;
}
function R({ sectionOrder: e, customSectionIds: t, includeCloudSection: n, showChatsFirst: r }) {
  let i = lt(t),
...
function ct({ sectionOrder: e, visibleSectionKeys: t, nextVisibleSectionKeys: n }) {
  return dt(t, n) ? ut({ sectionOrder: e, visibleSectionKeys: t, nextVisibleSectionKeys: n }) : e;
}
function lt(e) {
  let t = new Set();
  return e.flatMap((e) => (t.has(e) ? [] : (t.add(e), [st(e)])));
}
function ut({ sectionOrder: e, visibleSectionKeys: t, nextVisibleSectionKeys: n }) {
  let r = new Set(t),
    i = 0;
  return e.map((e) => {
    if (!r.has(e)) return e;
...
var z = o(u, null),
  pt = o(u, null),
  mt = a(u, ({ get: e }) => e(Ne, `2413345355`)),
  ht = a(u, ({ get: e }) => e(_e, k.SIDEBAR_CUSTOM_SECTIONS)),
  gt = a(u, ({ get: e }) => (e(mt) ? pe(e, k.SIDEBAR_CUSTOM_SECTIONS) : [])),
  _t = a(u, ({ get: e }) => e(ht).isFetched),
  B = a(u, ({ get: e }) => ft({ sections: e(gt), drop: e(pt) })),
  vt = a(u, ({ get: e }) => {
    let t = e(B),
      n = R({
        sectionOrder: e(Fe),
  ...
  yt = d(u, ({ sectionId: e, currentThreadKey: t }) => {
    let n = [];
    return a(u, ({ get: r }) => {
      let i = r(B).find((t) => t.id === e);
      if (i == null) return ((n = []), n);
      let { allSidebarThreadKeys: a } = r(r(qe, { currentConversationId: se(t) })),
        o = ye({ items: r(r(Je, a)), threadIds: i.threadIds, sortKey: i.sortKey });
      return ((n = bt(n, o)), n);
    });
  });
function bt(e, t) {
...
function St({ tasks: e, order: t }) {
  return t == null ? e : Ct(e, t.sortKey == null ? t : V(e, t.sortKey));
}
function Ct(e, t) {
  let n = new Map();
  for (let t of e) {
...
function wt({ order: e, tasks: t, visibleThreadIds: n, nextVisibleThreadIds: r }) {
  return {
    threadIds: ue({
      threadIds: (e == null
        ? xt(t)
...
function Tt({ order: e, tasks: t, threadId: n, beforeThreadId: r }) {
  let i = e == null ? H(t) : Et({ order: e, tasks: t }).threadIds,
    a = i.filter((e) => e !== n),
    o = r == null ? 0 : a.indexOf(r),
    s = o === -1 ? a.length : o,
    c = [...a.slice(0, s), n, ...a.slice(s)];
  return j(i, c) ? { threadIds: i } : { threadIds: c };
}
function Et({ order: e, tasks: t }) {
  let n = Ot(e.threadIds, H(t));
...
function V(e, t) {
  return {
    threadIds: H(
      e
        .flatMap((e, n) => (U(e) == null ? [] : [{ task: e, timestamp: Dt(e, t), index: n }]))
...
function At({ currentCwd: e, targetGroup: t, worktreeWorkspaceRoot: n }) {
  let r = n ?? t.path;
  return {
    projectKind: `local`,
    projectId: t.projectId,
    ...(r == null ? {} : { path: r }),
    pendingCoreUpdate: r != null && T(e ?? ``) !== T(r),
  };
}
async function jt(e, t, n) {
  ...
  try {
    return (
      await he(`git`).request({
        method: `resolve-worktree-for-thread`,
        params: {
          cwd: r,
          conversationId: t,
          hostConfig: we(e.get, `host_config`) ?? de(`local`, null),
    ...
    return (
      m.warning(`Failed to resolve an existing worktree for moved thread.`, {
        safe: {},
        sensitive: { error: C(e) },
      }),
      null
...
function It(e, t) {
  return G(e, (e) => {
    ...
    let r = n[t.projectId] ?? null,
      i = Tt({ order: r, tasks: t.tasks, threadId: t.threadId, beforeThreadId: t.beforeThreadId });
    return r != null && j(r.threadIds, i.threadIds) ? n : { ...n, [t.projectId]: i };
  });
}
function Lt(e, t) {
  return Promise.all([
    W(e, (e) =>
      Tt({ order: e, tasks: t.tasks, threadId: t.threadId, beforeThreadId: t.beforeThreadId }),
    ),
    G(e, (e) => {
      let n = e;
      for (let [r, i] of Object.entries(e)) {
...
function Ht(e, t) {
  return e != null && j(e.threadIds, t.threadIds) ? e : t;
}
function Ut(e, t) {
...
function W(e, t) {
  let n = async () => {
      let { value: n } = await h(`get-global-state`, {
          params: { key: k.SIDEBAR_CHAT_THREAD_ORDER },
        }),
        r = n ?? null,
        i = t(r);
      i == null || i === r || (await M(e, k.SIDEBAR_CHAT_THREAD_ORDER, i));
    },
    r = Mt.then(n, n);
  return ((Mt = r.catch(() => {})), r);
}
function G(e, t) {
  let n = async () => {
      let { value: n } = await h(`get-global-state`, {
          params: { key: k.SIDEBAR_PROJECT_THREAD_ORDERS },
        }),
        r = n ?? S(k.SIDEBAR_PROJECT_THREAD_ORDERS),
        i = t(r);
      i !== r && (await M(e, k.SIDEBAR_PROJECT_THREAD_ORDERS, i));
    },
    r = Nt.then(n, n);
  return ((Nt = r.catch(() => {})), r);
}
...
function K(e, t) {
  let n = async () => {
      let { value: n } = await h(`get-global-state`, {
          params: { key: k.THREAD_PROJECT_ASSIGNMENTS },
        }),
        r = te(n);
      D(r[t.threadId], t.assignment) ||
        (await M(
          e,
          k.THREAD_PROJECT_ASSIGNMENTS,
          w({ assignments: r, conversationId: t.threadId, assignment: t.assignment }),
        ));
    },
    r = Kt.then(n, n);
  return ((Kt = r.catch(() => {})), r);
...
function Jt(e, t) {
  let n = async () => {
      let { value: n } = await h(`get-global-state`, { params: { key: k.PROJECTLESS_THREAD_IDS } }),
        r = Gt.safeParse(n).data ?? [];
      r.includes(t.threadId) !== t.projectless &&
        (await M(
          e,
          k.PROJECTLESS_THREAD_IDS,
...
function Yt({
  ...
  let s = t.find((e) => e.threadKeys.includes(o.key)),
    c = ee({ cwd: o.conversation.cwd ?? null, assignment: a?.[o.conversation.id] });
  if (s == null || !y(c ?? ``, r ?? void 0)) return null;
  if (e.targetContainerId === `chats`) return { sourceProjectLabel: s.label };
  let l = e.targetContainerId.slice(8),
    u = t.find((e) => e.projectId === l);
  return u == null || u.projectId === s.projectId || i != null || !Xt(o, u)
    ? null
    : { sourceProjectLabel: s.label };
}
function Xt(e, t) {
  let n = t.projectKind === `remote` ? t.hostId : Ce,
    r = e.conversation.hostId ?? `local`;
  return n != null && n === r;
}
function Zt(e, { sectionId: t, threadId: n, included: r, isPinned: i }) {
  let a = fe(e, { sectionId: t, threadId: n, included: r });
  return J(r && i ? P(e, n, a) : a);
}
function Qt(e, { emoji: t, name: n, threadId: r, wasPinned: i }) {
  let a = ae(e, { sectionId: be(), emoji: t, name: n, threadId: r });
  return J(r != null && i ? P(e, r, a) : a);
}
function $t(e, { sectionId: t, emoji: n, name: r }) {
  return J(ve(e, { sectionId: t, emoji: n, name: r }));
}
function en(e, t) {
  return J(le(e, t));
}
...
function nn(e, { emoji: t, name: n }) {
  let r = e.get(z);
  r != null &&
    (r.kind === `create`
      ? Qt(e, { emoji: t, name: n, threadId: r.threadId, wasPinned: r.wasPinned })
      : $t(e, { sectionId: r.sectionId, emoji: t, name: n }),
    tn(e));
}
function rn(e, t) {
  (Le(e, t, !1), en(e, t));
...
async function sn(
  ...
  let u = r.find((e) => re(e.task.key) === o)?.task;
  if (u == null || u.kind === `pending-worktree`) return Promise.resolve();
  if (c === `chats`)
    return Y(
      Promise.all([
        K(e, { threadId: o, assignment: null }),
        Jt(e, { threadId: o, projectless: !0 }),
        Lt(e, { tasks: [...i.map((e) => e.task), u], threadId: o, beforeThreadId: l }),
        A(e, o),
  ...
  if (c.startsWith(`project:`)) {
    ...
    if (i.projectKind === `remote`) {
      ...
      d = At({
        ...
        targetGroup: i,
        worktreeWorkspaceRoot: a === void 0 ? await jt(e, u.conversation.id, i) : a,
      });
    return Y(
      Promise.all([
        K(e, { threadId: o, assignment: d }),
        Jt(e, { threadId: o, projectless: !1 }),
        It(e, {
          projectId: i.projectId,
          tasks: [...Ke(i.threadKeys, new Map(r.map((e) => [e.task.key, e]))), u],
          threadId: o,
  ...
  let d = ce(e, { sectionId: c.slice(7), threadId: o, beforeThreadId: l });
  return J(s === `pinned` ? P(e, o, d) : d);
}
function J(e) {
  return e.catch((e) => {
    m.error(`Failed to save sidebar custom sections`, { safe: {}, sensitive: { error: C(e) } });
  });
}
function Y(e) {
  return e.catch((e) => {
    m.error(`Failed to save thread project assignment`, { safe: {}, sensitive: { error: C(e) } });
  });
}
var X = De({
  moveTo: {
...
function ln({ onCreateSection: e }) {
  return [{ id: `new-custom-section`, message: X.newSection, onSelect: e }];
}
function un(e, { threadId: t, isPinned: n, sections: r }) {
  return cn({
    threadId: t,
    isPinned: n,
    sections: r,
    ...
    onSectionMembershipChange: (r, i) => {
      Zt(e, { sectionId: r, threadId: t, included: i, isPinned: n });
    },
    onCreateSection: () => {
...
var Z = n(),
  fn = p(u, `gh-pr-summary`, ({ cwd: e, enabled: t, headBranch: n, hostId: r }) => ({
    enabled: t,
    source: `sidebar_task_pr_chip`,
    params: { cwd: O(e ?? `/`), headBranch: n ?? ``, hostId: r },
    staleTime: v.ONE_MINUTE,
  })),
  pn = a(u, ({ get: e }) => {
    let t = e(Ne, `2553306736`);
    return Oe(e, x.showSidebarPrIcons) ?? t;
  }),
  mn = s(u, (e, { get: t }) => (!t(pn) || e == null ? null : _n(e, t(Ue)))),
  hn = s(u, (e, { get: t }) => {
    if (!t(pn)) return null;
    let n =
        e != null &&
        t(me, e) != null &&
        t(N, e) != null &&
        t(tt, t(ie, e) ?? void 0) === `available`,
      r = t(fn, {
        cwd: t(me, e) ?? null,
        enabled: n,
        headBranch: t(N, e) ?? null,
        hostId: t(ie, e) ?? void 0,
      });
    if (!n || r.isLoading || r.isError) return null;
    let i = r.data?.status === `success` ? r.data : null;
    if (i == null) return null;
    let a = je({ hasOpenPr: i.hasOpenPr, isDraft: i.isDraft, url: i.url });
    return a == null
      ? null
      : vn(
          a,
          Me({ canMerge: i.canMerge, ciStatus: i.ciStatus, status: a }),
          i.checks,
          i.ciStatus,
          t(Ue),
        );
...
function vn(e, t, n, r, i) {
  return {
    hoverCardSection: {
      id: `pr`,
      rows: [
        { id: `pr-status`, icon: (0, Z.jsx)(I, { status: e }), label: yn(e, i) },
        {
          id: `checks-summary`,
          icon: r === `none` ? (0, Z.jsx)(ze, {}) : (0, Z.jsx)(Ze, { checks: n }),
          label: $e(r),
        },
      ],
    },
    iconBadge: { id: `pr-status`, icon: (0, Z.jsx)(Qe, { state: t }), tooltipContent: null },
  };
}
function yn(e, t) {
  switch (e) {
...
var Q = `command-menu-first-file-item`,
  bn = `command-menu-first-chat-item`,
  $ = o(u, `root`),
  xn = r(),
  Sn = e(t(), 1);
function Cn(e) {
  let t = (0, xn.c)(31),
    { clearSearch: n, close: r, hostId: a, onSelectFile: o, workspaceRoot: s } = e,
    d = c(u),
    f = Te(),
    p = i(Ye, `searchFiles`),
    m = rt(Tn),
  ...
  t[22] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (T = t[22]);
  let E;
  t[23] !== r || t[24] !== x.emptyState || t[25] !== x.items || t[26] !== f || t[27] !== o
    ? ((E =
        x.items.length > 0
          ? x.items.map((e, t) =>
              (0, Z.jsx)(
            ...
            : (0, Z.jsx)(nt.Item, {
                ...
                children: (0, Z.jsx)(`div`, {
                  ...
                  children: (0, Z.jsx)(`div`, {
                    ...
                    children: f.formatMessage(x.emptyState),
                  }),
                }),
              })),
      (t[23] = r),
  ...
  return (
    t[29] === E
      ...
      : ((D = (0, Z.jsx)(
          nt.Group,
          { forceMount: !0, heading: w, className: `flex flex-col`, style: T, children: E },
          `group-files`,
        )),
        (t[29] = E),
        (t[30] = D)),
...
function En() {
  let e = (0, xn.c)(23),
    ...
    { data: o } = l(Pe),
    s = o?.roots?.[0] ?? null,
    u = i.kind === `local` ? s : null,
    d = a.kind === `git` ? a.git.root : a.kind === `plain` ? (u ?? a.cwd) : null,
    p = d != null,
    m;
  e[0] !== p || e[1] !== i || e[2] !== r || e[3] !== t || e[4] !== d
    ? ((m = (e) => {
        !p ||
          d == null ||
          Re({
  ...
  (e[6] !== p || e[7] !== t
    ? ((v = () => {
        p &&
          (f.dispatchHostMessage({ type: `command-menu`, query: `` }),
          t.set($, `files`),
          t.set(Ge, !0));
      }),
      (e[6] = p),
      ...
      (e[8] = v))
    : (v = e[8]),
    g(`file-search-command-menu`, ke(v)));
  let y;
  e[9] !== p || e[10] !== n || e[11] !== i.id || e[12] !== d
    ? ((y = [p, n, i.id, d]), (e[9] = p), (e[10] = n), (e[11] = i.id), (e[12] = d), (e[13] = y))
    : (y = e[13]);
  let b = n === `files`,
    x;
  e[14] !== i.id || e[15] !== h || e[16] !== d
    ? ((x = (e, t) =>
        d == null
          ? null
          : (0, Z.jsx)(Cn, {
