...
import { R as o, Ts as s, jn as c } from "./app-server-manager-signals.js";
import { A as l, f as u, h as d, p as f } from "./vscode-api.js";
import { t as p } from "./isEqual.js";
import "./src-2.js";
...
import { h as M } from "./links-p.js";
import { t as N } from "./trash.js";
...
function G(e) {
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, W.jsx)(v, {
                    ...
                    disabled:
                      e.disabled ||
                      (b.length <= 1 && t.key.trim().length === 0 && t.value.trim().length === 0),
                    "aria-label": d,
                    onClick: () => {
                      let t = e.value.filter((e, t) => t !== n);
                      e.onEdit(t);
  ...
  t[39] === S
    ? (C = t[40])
    : ((C = (0, W.jsx)(`div`, { className: `flex flex-col gap-2`, children: S })),
      (t[39] = S),
      (t[40] = C));
  let w;
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, W.jsx)(E, { className: `icon-2xs` })), (t[46] = D))
    : (D = t[46]);
  let O = e.addLabel ? e.addLabel : null,
    A;
  t[47] !== e.disabled || t[48] !== O || t[49] !== T
    ? ((A = (0, W.jsxs)(v, {
        color: `secondary`,
        size: `toolbar`,
        className: w,
...
function Z() {
  let { selectedHostId: e } = ee(),
    { data: t } = S(null, { hostId: e }),
    { data: n, isFetching: a } = r(C, e),
    c = b({ hostId: e }),
    p = x({ hostId: e }),
    m = l(),
    _ = h(),
  ...
  let Q = () => {
    ...
    ge = async (e, t) => {
      let n = M ?? de(t, G, null);
      try {
        (await c.mutateAsync({ filePath: me(), key: n, value: e }), Q(), $());
      } catch (e) {
        throw (
          d.error(`Failed to save MCP server`, { safe: { targetKey: n }, sensitive: { error: e } }),
          e
        );
      }
    },
    _e = async (t) => {
      let n = M ?? de(t, G, null);
      try {
        (await c.mutateAsync({ filePath: me(), key: n, value: null }),
          j((r) => ({ ...r, [e]: (0, ie.default)([...(r[e] ?? []), n, t, z[n]?.name ?? n]) })),
          Q(),
          $());
      } catch (e) {
        throw (
          d.error(`Failed to uninstall MCP server`, {
            safe: { targetKey: n },
            sensitive: { error: e },
          }),
          e
    ...
    ve = async (t) => {
      ...
      try {
        ...
        n && (D((e) => ({ ...e, [t]: n })), u.dispatchMessage(`open-in-browser`, { url: n }));
      } catch (e) {
        (d.error(`Failed to start login for MCP server`, {
          safe: { serverName: t },
          sensitive: { error: e },
        }),
          D((e) => {
    ...
    ye = (0, H.useEffectEvent)((e, t) => {
      (D((n) => {
        ...
        t && (Q(), m.invalidateQueries({ queryKey: w })));
    }),
    be = (0, H.useRef)(!0);
  if (
    ((0, H.useEffect)(() => {
    ...
    f(
      ...
      (e) => {
        (k((t) => t.filter((t) => t !== e.hostId)),
          ...
          m.invalidateQueries({ queryKey: [...w, e.hostId] }));
      },
      [m],
    ),
    P)
  ...
  let xe = (0, W.jsx)(te, { slug: le }),
    ...
    Ce = q
      ? (0, W.jsxs)(v, {
          ...
          size: `toolbar`,
          onClick: () => {
            u.dispatchMessage(`codex-app-server-restart`, { hostId: e });
          },
          children: [
            (0, W.jsx)(y, { className: `icon-xs` }),
            (0, W.jsx)(g, {
...
function fe(e) {
  ...
  return (
    t[12] !== p || t[13] !== m
      ? ((_ = (0, W.jsx)(re, { label: p, description: null, control: m })),
        (t[12] = p),
        (t[13] = m),
        (t[14] = _))
      : (_ = t[14]),
