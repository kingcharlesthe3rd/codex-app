...
import { P as n, Xs as r, gn as i } from "./app-server-manager-signals.js";
...
import "./x.js";
import { r as w } from "./settings-sections.js";
...
import { t as I } from "./control-group.js";
var L = e(j(), 1),
  oe = e(i(), 1),
  R = e(a(), 1),
  z = e(t(), 1),
...
function ce({ config: e, initialKey: t, onSave: n, onCancel: r, onUninstall: i }) {
...
function G(e, t) {
  ...
  return {
    ...
    http: {
      ...
      envHttpHeaders: `url` in e && e.env_http_headers ? q(e.env_http_headers) : [],
    },
  };
}
function K(e) {
...
function Y() {
  let { selectedHostId: e } = re(),
    ...
    K = G ? (k[e] ?? []) : [],
    q = (0, L.default)(
      (t == null ? [] : (i?.data ?? [])).filter((e) => !W.has(e.name) && !K.includes(e.name)),
      (e) => e.name,
    ),
    J = U.length > 0,
    Y = q.length > 0,
  ...
  let Q = () => {
    ...
    ge = async (t) => {
      ...
      try {
        (await o.mutateAsync({ filePath: pe(), key: n, value: null }),
          A((r) => ({ ...r, [e]: (0, oe.default)([...(r[e] ?? []), n, t, z[n]?.name ?? n]) })),
          Q(),
          $());
      } catch (e) {
        throw (
    ...
    _e = async (t) => {
      ...
      try {
        ...
        n && (E((e) => ({ ...e, [t]: n })), g.dispatchMessage(`open-in-browser`, { url: n }));
      } catch (e) {
