...
import { L as o, On as s, js as c } from "./app-server-manager-signals.js";
import { f as l, k as u, m as d, p as f } from "./vscode-api.js";
import { t as p } from "./isEqual.js";
import "./src-1.js";
import { c as m, o as h, r as g } from "./lib.js";
...
import { C as y, S as b, b as x, m as S, o as C } from "./config-queries.js";
...
import "./x.js";
import { t as T } from "./settings.cog.js";
...
import { i as ne, r as re } from "./settings-shared.js";
import { t as P } from "./settings-content-layout.js";
import { n as F } from "./settings-row.js";
import { n as I, t as L } from "./settings-group.js";
...
function G(e) {
  ...
  if (t[6] !== s || t[7] !== e.inputType || t[8] !== e.placeHolderValue || t[9] !== l) {
    if (((f = s), (p = l), e.inputType === E.Record)) {
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, W.jsx)(v, {
                    color: `ghost`,
                    size: `icon`,
                    disabled: g.length <= 1 && t.trim().length === 0,
                    "aria-label": d,
                    onClick: () => {
                      let t = e.value.filter((e, t) => t !== n);
                      e.onEdit(t);
                    },
                    children: (0, W.jsx)(A, { className: `icon-2xs` }),
                  }),
                ],
              },
              `list-${n}`,
  ...
  t[44] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, W.jsx)(j, { className: `icon-2xs` })), (t[44] = D))
    : (D = t[44]);
...
function Z() {
  ...
  let Q = () => {
    ...
    ge = async (e, t) => {
      let n = j ?? de(t, G, null);
      try {
        (await s.mutateAsync({ filePath: me(), key: n, value: e }), Q(), $());
      } catch (e) {
        throw (
    ...
    _e = async (t) => {
      let n = j ?? de(t, G, null);
      try {
        (await s.mutateAsync({ filePath: me(), key: n, value: null }),
          A((r) => ({ ...r, [e]: (0, ie.default)([...(r[e] ?? []), n, t, z[n]?.name ?? n]) })),
          Q(),
          $());
      } catch (e) {
        throw (
    ...
    ve = async (t) => {
      ...
      E((e) => ({ ...e, [t]: null }));
      try {
        let { authorizationUrl: n } = await c(`login-mcp-server`, { hostId: e, name: t });
        n && (E((e) => ({ ...e, [t]: n })), l.dispatchMessage(`open-in-browser`, { url: n }));
      } catch (e) {
    ...
    ye = (0, H.useEffectEvent)((e, t) => {
      (E((n) => {
        ...
        t && (Q(), g.invalidateQueries({ queryKey: C })));
    }),
    be = (0, H.useRef)(!0);
  if (
    ((0, H.useEffect)(() => {
      ...
      w?.hostId === e && ye(w.name, w.success);
    }, [w, e]),
    f(
      ...
      (e) => {
        (O((t) => t.filter((t) => t !== e.hostId)),
          ...
          g.invalidateQueries({ queryKey: [...C, e.hostId] }));
      },
      [g],
    ),
    N)
    ...
    return (0, W.jsx)(oe, {
      ...
      onCancel: $,
      onSave: ge,
      onUninstall: j ? _e : void 0,
    });
  let xe = (0, W.jsx)(ne, { slug: le }),
    Se = (0, W.jsx)(re, { slug: le }),
    Ce = q
      ? (0, W.jsxs)(v, {
          color: `ghost`,
          size: `toolbar`,
...
function fe(e) {
            ...
            children: [
              ...
              c
                ? (0, W.jsx)(v, {
                    ...
                    children: (0, W.jsx)(T, { className: `icon-xs` }),
                  })
                : null,
              o
                ? (0, W.jsx)(N, {
  ...
  return (
    t[12] !== p || t[13] !== g
      ? ((_ = (0, W.jsx)(F, { label: p, description: null, control: g })),
        (t[12] = p),
        (t[13] = g),
        (t[14] = _))
      : (_ = t[14]),
