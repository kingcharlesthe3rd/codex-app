...
import { qt as t } from "./src-2.js";
import { P as n, fs as r, wn as i } from "./app-server-manager-signals.js";
import { n as a, t as o } from "./jsx-runtime.js";
import { t as s } from "./clsx.js";
import "./marked.esm-BR-H6018.js";
import { A as c, I as l, P as u, f as d, g as f, lt as p, p as m } from "./vscode-api.js";
...
import { C as _, S as v, b as y, m as b, o as x } from "./config-queries.js";
...
import { r as T } from "./settings-sections.js";
import "./_defineProperty.js";
import "./homepage-logo.js";
import { t as E } from "./loading-page.js";
import { t as D } from "./arrow-left.js";
import { h as O } from "./links.js";
import { t as k } from "./trash.js";
import "./chevron.js";
import { t as A } from "./plus-d3DP-DMx.js";
...
import { t as I } from "./control-group-C.js";
import { n as oe, r as se } from "./mcp-settings.search.js";
var L = e(j(), 1),
  ce = e(i(), 1),
  R = e(a(), 1),
  z = e(t(), 1),
...
function X() {
  let { selectedHostId: e } = re(),
    { data: t } = y(null, { hostId: e }),
    { data: i, isFetching: a } = u(b, e),
    o = _({ hostId: e }),
    s = v({ hostId: e }),
    p = c(),
    C = h(),
  ...
  let Q = () => {
    ...
    be = (0, R.useEffectEvent)((e, t) => {
      (E((n) => {
        ...
        t && (Q(), p.invalidateQueries({ queryKey: x })));
    }),
    xe = (0, R.useRef)(!0);
  if (
    ((0, R.useEffect)(() => {
    ...
    m(
      ...
      (e) => {
        (O((t) => t.filter((t) => t !== e.hostId)),
          ...
          p.invalidateQueries({ queryKey: [...x, e.hostId] }));
      },
      [p],
    ),
    F)
...
function pe(e) {
  ...
  return (
    t[12] !== p || t[13] !== m
      ? ((_ = (0, V.jsx)(ae, { label: p, description: null, control: m })),
        (t[12] = p),
        (t[13] = m),
        (t[14] = _))
      : (_ = t[14]),
