...
import { f as o, k as s, m as c, p as l } from "./vscode-api.js";
import { t as u } from "./isEqual.js";
import "./src-4.js";
import { As as d, Dn as f, I as p } from "./app-server-manager-signals.js";
...
import { C as y, S as b, b as x, m as S, o as C } from "./config-queries-BHYT-TjG.js";
...
function Z() {
  ...
  let Q = () => {
    ...
    he = async (e, t) => {
      try {
        (await f.mutateAsync({ key: e, enabled: t }), Q());
      } catch {}
    },
    ge = async (e, t) => {
      let n = j ?? de(t, G, null);
      try {
        (await u.mutateAsync({ filePath: me(), key: n, value: e }), Q(), $());
      } catch (e) {
        throw (
          c.error(`Failed to save MCP server`, { safe: { targetKey: n }, sensitive: { error: e } }),
          e
        );
      }
    },
    _e = async (t) => {
      let n = j ?? de(t, G, null);
      try {
        (await u.mutateAsync({ filePath: me(), key: n, value: null }),
    ...
    ve = async (t) => {
      ...
      E((e) => ({ ...e, [t]: null }));
      try {
        let { authorizationUrl: n } = await d(`login-mcp-server`, { hostId: e, name: t });
        n && (E((e) => ({ ...e, [t]: n })), o.dispatchMessage(`open-in-browser`, { url: n }));
      } catch (e) {
  ...
  let xe = (0, W.jsx)(ne, { slug: le }),
    ...
    Ce = q
      ? (0, W.jsxs)(v, {
          ...
          size: `toolbar`,
          onClick: () => {
            o.dispatchMessage(`codex-app-server-restart`, { hostId: e });
          },
          children: [
