...
import { Z as s } from "./thread-context-inputs.js";
import { A as c, f as l, h as u, p as d } from "./vscode-api.js";
import { t as f } from "./isEqual.js";
import "./src-1.js";
import { i as p, l as m, s as h } from "./lib-1.js";
...
import "./spinner.js";
import { t as v } from "./regenerate.js";
import "./x.js";
...
import { S as b, o as x, p as S, x as C, y as w } from "./config-queries.js";
import "./selectable-remote-connections-signal.js";
import { t as T } from "./link-external.js";
import "./_baseEach.js";
import "./_baseOrderBy.js";
import { t as E } from "./uniq.js";
import { t as D } from "./arrow-left.js";
import { t as O } from "./settings.cog.js";
import "./_defineProperty.js";
import { r as k } from "./settings-sections.js";
import "./homepage-logo.js";
import { t as A } from "./loading-page.js";
import { g as j } from "./links.js";
import { t as M } from "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as ee } from "./settings-host-context.js";
import { t as N } from "./trash-DL-ar7Ww.js";
...
import { t as R } from "./tabs.js";
import { t as z } from "./control-group.js";
var B = e(M(), 1),
  ie = e(E(), 1),
  V = e(f(), 1),
  H = e(t(), 1),
...
function G(e) {
  let t = (0, U.c)(55),
    n = e.inputType === k.String,
    r = e.inputType === k.Array,
    i = e.inputType === k.Record,
    a = m(),
    o;
  t[0] === a
    ? (o = t[1])
  ...
  let d = u,
    f,
    p;
  if (t[6] !== s || t[7] !== e.inputType || t[8] !== e.placeHolderValue || t[9] !== l) {
    if (((f = s), (p = l), e.inputType === k.Record)) {
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, W.jsx)(_, {
                    color: `ghost`,
                    size: `icon`,
                    disabled: e.disabled || (v.length <= 1 && t.trim().length === 0),
                    "aria-label": d,
                    onClick: () => {
                      let t = e.value.filter((e, t) => t !== n);
                      e.onEdit(t);
                    },
                    children: (0, W.jsx)(N, { className: `icon-2xs` }),
                  }),
                ],
              },
              `list-${n}`,
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, W.jsx)(_, {
                    ...
                    disabled:
                      e.disabled ||
                      (x.length <= 1 && t.key.trim().length === 0 && t.value.trim().length === 0),
                    "aria-label": d,
                    onClick: () => {
                      let t = e.value.filter((e, t) => t !== n);
                      e.onEdit(t);
  ...
  t[39] === C
    ? (w = t[40])
    : ((w = (0, W.jsx)(`div`, { className: `flex flex-col gap-2`, children: C })),
      (t[39] = C),
      (t[40] = w));
  let T;
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, W.jsx)(y, { className: `icon-2xs` })), (t[46] = D))
    : (D = t[46]);
  let O = e.addLabel ? e.addLabel : null,
    A;
  t[47] !== e.disabled || t[48] !== O || t[49] !== E
    ? ((A = (0, W.jsxs)(_, {
        color: `secondary`,
        size: `toolbar`,
        className: T,
...
function K(e) {
  ...
  return (
    t[5] !== r || t[6] !== i
      ? ((a = (0, W.jsx)(`input`, { className: i, ...r })), (t[5] = r), (t[6] = i), (t[7] = a))
      : (a = t[7]),
    a
  );
}
...
function oe({ config: e, initialKey: t, onSave: n, onCancel: r, onUninstall: i }) {
  let a = (0, H.useMemo)(() => se(e, t), [e, t]),
    [o, s] = (0, H.useState)(a),
    [c, l] = (0, H.useState)(!1),
  ...
  return (0, W.jsx)(F, {
    ...
    children: (0, W.jsxs)(`div`, {
      className: `relative`,
      children: [
        c ? (0, W.jsx)(A, { overlay: !0 }) : null,
        (0, W.jsx)(L, {
          children: (0, W.jsxs)(L.Content, {
            children: [
              b
                ? (0, W.jsx)(`p`, {
...
function se(e, t) {
  ...
  return {
    ...
    stdio: {
      ...
      env: `command` in e && e.env ? Y(e.env) : [],
    ...
    http: {
      ...
      httpHeaders: `url` in e && e.http_headers ? Y(e.http_headers) : [],
      envHttpHeaders: `url` in e && e.env_http_headers ? Y(e.env_http_headers) : [],
    },
  };
}
function J(e) {
  ...
  if (e.transportType === `streamable_http`) {
    let n = X(e.http.httpHeaders),
      r = X(e.http.envHttpHeaders);
    return {
      ...t,
      url: e.http.url,
...
function Z() {
  let { selectedHostId: e } = ee(),
    { data: t } = w(null, { hostId: e }),
    { data: n, isFetching: r } = i(S, e),
    f = b({ hostId: e }),
    p = C({ hostId: e }),
    g = c(),
    y = m(),
    ...
    [P, R] = (0, H.useState)(null),
    z = t?.servers ?? {},
    V = t?.serverOrigins ?? {},
    U = t?.configWriteTarget ?? null,
    G = Object.keys(z),
    K = (0, B.default)(
      G,
      (e) => z[e]?.name?.trim() || e,
    ...
    ae = new Set(Object.entries(z).flatMap(([e, t]) => [e, t.name ?? e])),
    q = O.includes(e),
    se = q ? (A[e] ?? []) : [],
    J = (0, B.default)(
      (t == null ? [] : (n?.data ?? [])).filter((e) => !ae.has(e.name) && !se.includes(e.name)),
      (e) => e.name,
    ),
    Y = G.length > 0,
    X = J.length > 0,
  ...
  let Q = () => {
      k((t) => (t.includes(e) ? t : [...t, e]));
    },
    $ = () => {
      (R(null), N(null));
    },
    me = () => {
      if (U != null) return U.filePath;
      throw Error(
        y.formatMessage({
    ...
    he = async (e, t) => {
      try {
        (await p.mutateAsync({ key: e, enabled: t }), Q());
      } catch {}
    },
    ge = async (e, t) => {
      let n = M ?? de(t, G, null);
      try {
        (await f.mutateAsync({ filePath: me(), key: n, value: e }), Q(), $());
      } catch (e) {
        throw (
          u.error(`Failed to save MCP server`, { safe: { targetKey: n }, sensitive: { error: e } }),
          e
        );
      }
    },
    _e = async (t) => {
      let n = M ?? de(t, G, null);
      try {
        (await f.mutateAsync({ filePath: me(), key: n, value: null }),
          j((r) => ({ ...r, [e]: (0, ie.default)([...(r[e] ?? []), n, t, z[n]?.name ?? n]) })),
          Q(),
          $());
      } catch (e) {
        throw (
          u.error(`Failed to uninstall MCP server`, {
            safe: { targetKey: n },
            sensitive: { error: e },
          }),
          e
    ...
    ve = async (t) => {
      ...
      D((e) => ({ ...e, [t]: null }));
      try {
        let { authorizationUrl: n } = await o(`login-mcp-server`, { hostId: e, name: t });
        n && (D((e) => ({ ...e, [t]: n })), l.dispatchMessage(`open-in-browser`, { url: n }));
      } catch (e) {
        (u.error(`Failed to start login for MCP server`, {
          safe: { serverName: t },
          sensitive: { error: e },
        }),
          D((e) => {
    ...
    ye = (0, H.useEffectEvent)((e, t) => {
      (D((n) => {
        ...
        t && (Q(), g.invalidateQueries({ queryKey: x })));
    }),
    be = (0, H.useRef)(!0);
  if (
    ((0, H.useEffect)(() => {
      ...
      T?.hostId === e && ye(T.name, T.success);
    }, [T, e]),
    d(
      `codex-app-server-initialized`,
      (e) => {
        (k((t) => t.filter((t) => t !== e.hostId)),
          j((t) => {
            let { [e.hostId]: n, ...r } = t;
            return r;
          }),
          g.invalidateQueries({ queryKey: [...x, e.hostId] }));
      },
      [g],
    ),
    P)
    ...
    return (0, W.jsx)(oe, {
      ...
      onCancel: $,
      onSave: ge,
      onUninstall: M ? _e : void 0,
    });
  let xe = (0, W.jsx)(te, { slug: le }),
    Se = (0, W.jsx)(ne, { slug: le }),
    Ce = q
      ? (0, W.jsxs)(_, {
          color: `ghost`,
          size: `toolbar`,
          onClick: () => {
            l.dispatchMessage(`codex-app-server-restart`, { hostId: e });
          },
          children: [
            (0, W.jsx)(v, { className: `icon-xs` }),
            (0, W.jsx)(h, {
  ...
  return (0, W.jsxs)(F, {
    ...
    children: [
      (0, W.jsxs)(L, {
        children: [
          (0, W.jsx)(L.Header, {
            title: (0, W.jsx)(h, { ...ce.servers }),
            actions: (Y || X) && (0, W.jsx)(pe, { onClick: we }),
          }),
          Y || !X
            ? (0, W.jsx)(L.Content, {
                children: (0, W.jsx)(I, {
                    ...
                    ? K.map((e) =>
                        (0, W.jsx)(
                          fe,
                          {
                            ...
                            authStatus: Z[e],
                            onAuthenticateClicked: () => ve(e),
                            onEnableClicked: z[e] ? (t) => he(e, t) : void 0,
                  ...
                  children: J.map((e) =>
                    (0, W.jsx)(
                      fe,
                      {
                        ...
                        onAuthenticateClicked: () => ve(e.name),
                      },
                      `status-${e.name}`,
                    ),
                  ),
...
function fe(e) {
  ...
  return (
    t[12] !== p || t[13] !== g
      ? ((v = (0, W.jsx)(re, { label: p, description: null, control: g })),
        (t[12] = p),
        (t[13] = g),
        (t[14] = v))
      : (v = t[14]),
