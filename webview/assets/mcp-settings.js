...
import { Mr as H, _n as U, hn as ye, jr as W } from "./app-initial~app-main~automations-page.js";
import {
  G as be,
  K as xe,
  W as Se,
...
import { n as Te, t as Ee } from "./tabs.js";
import { n as De, t as Oe } from "./control-group.js";
function q(e) {
  let t = (0, ke.c)(55),
    n = e.inputType === W.String,
    i = e.inputType === W.Array,
    a = e.inputType === W.Record,
    o = d(),
    s;
  t[0] === o
    ? (s = t[1])
  ...
  if (t[6] !== c || t[7] !== e.inputType || t[8] !== e.placeHolderValue || t[9] !== u) {
    if (((h = c), (g = u), e.inputType === W.Record)) {
      let [t] = e.placeHolderValue;
      ((h = t?.key ?? c), (g = t?.value ?? u));
    }
    ((t[6] = c),
      (t[7] = e.inputType),
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, Y.jsx)(j, {
                    ...
                    children: (0, Y.jsx)(p, { className: `icon-2xs` }),
                  }),
                ],
              },
              `list-${n}`,
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Y.jsx)(r, { className: `icon-2xs` })), (t[46] = E))
    : (E = t[46]);
  let D = e.addLabel ? e.addLabel : null,
    O;
  t[47] !== e.disabled || t[48] !== D || t[49] !== T
    ? ((O = (0, Y.jsxs)(j, {
        color: `secondary`,
        size: `toolbar`,
        className: w,
...
function Me({ config: e, initialKey: t, onSave: n, onCancel: r, onUninstall: i }) {
  let o = (0, X.useMemo)(() => Pe(e, t), [e, t]),
    [s, c] = (0, X.useState)(o),
    [l, u] = (0, X.useState)(!1),
    [f, m] = (0, X.useState)(null),
    h = d(),
    g = s.label.trim(),
    _ = !(0, Re.default)(s, o),
    v =
  ...
  return (0, Z.jsx)(ye, {
    ...
    subtitle: b
      ...
      : (0, Z.jsxs)(`a`, {
          ...
          rel: `noreferrer`,
          onClick: (e) => {
            w({ event: e, href: z, initiator: `open_in_browser_bridge` });
          },
          ...
          children: [
            ...
            (0, Z.jsx)(oe, { href: z, className: `icon-xxs` }),
          ],
        }),
    action:
                    ...
                    : (0, Z.jsxs)(Z.Fragment, {
                        children: [
                          ...
                          (0, Z.jsx)(q, {
                            ...
                            inputType: W.String,
                            onEdit: (e) => {
                              c((t) => ({ ...t, http: { ...t.http, bearerTokenEnvVar: e } }));
                            },
                          }),
                          (0, Z.jsx)(q, {
                            title: (0, Z.jsx)(a, {
                            ...
                            onEdit: (e) => {
                              c((t) => ({ ...t, http: { ...t.http, httpHeaders: e } }));
                            },
                          }),
                          (0, Z.jsx)(q, {
                            title: (0, Z.jsx)(a, {
                            ...
                            onEdit: (e) => {
                              c((t) => ({ ...t, http: { ...t.http, envHttpHeaders: e } }));
                            },
                          }),
                        ],
                      }),
...
function He() {
  let { selectedHostId: e } = me(),
    ...
    re = new Set(Object.entries(D).flatMap(([e, t]) => [e, t.name ?? e])),
    M = h.includes(e),
    ae = M ? (v[e] ?? []) : [],
    oe = (0, qe.default)(
      (t == null ? [] : (n?.data ?? [])).filter((e) => !re.has(e.name) && !ae.includes(e.name)),
      (e) => e.name,
    ),
    N = A.length > 0,
    P = oe.length > 0,
  ...
  n != null &&
    (n.data.forEach((e) => {
      F[e.name] = e.authStatus;
    }),
    Object.entries(D).forEach(([e, t]) => {
      let n = F[e] ?? (t.name == null ? void 0 : F[t.name]);
      n != null && (F[e] = n);
    }));
  let I = () => {
    ...
    z = async (e, t) => {
      try {
        (await c.mutateAsync({ key: e, enabled: t }), I());
      } catch {}
    },
    fe = async (e, t) => {
      let n = S ?? Ue(t, A, null);
      try {
        (await s.mutateAsync({ filePath: R(), key: n, value: e }), I(), L());
      } catch (e) {
        throw (
          o.error(`Failed to save MCP server`, { safe: { targetKey: n }, sensitive: { error: e } }),
          e
        );
      }
    },
    pe = async (t) => {
      let n = S ?? Ue(t, A, null);
      try {
        (await s.mutateAsync({ filePath: R(), key: n, value: null }),
          y((r) => ({ ...r, [e]: (0, Je.default)([...(r[e] ?? []), n, t, D[n]?.name ?? n]) })),
          I(),
          L());
      } catch (e) {
        throw (
    ...
    B = async (t) => {
      ...
      let n = p[t];
      if (n) {
        de({ href: n, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
        return;
      }
      m((e) => ({ ...e, [t]: null }));
      try {
        let { authorizationUrl: n } = await b(`login-mcp-server`, { hostId: e, name: t });
        n &&
          (m((e) => ({ ...e, [t]: n })),
          de({ href: n, initiator: `open_in_browser_bridge`, openTarget: `external-browser` }));
      } catch (e) {
    ...
    ge = (0, Q.useEffectEvent)((e, t) => {
      (m((n) => {
        ...
        t && (I(), l.invalidateQueries({ queryKey: le })));
    }),
    V = (0, Q.useRef)(!0);
  if (
    ((0, Q.useEffect)(() => {
      ...
      f?.hostId === e && ge(f.name, f.success);
    }, [f, e]),
    _(
      `codex-app-server-initialized`,
      (e) => {
        (g((t) => t.filter((t) => t !== e.hostId)),
          y((t) => {
            let { [e.hostId]: n, ...r } = t;
            return r;
          }),
          l.invalidateQueries({ queryKey: [...le, e.hostId] }));
      },
      [l],
    ),
    T)
    ...
    return (0, $.jsx)(Me, {
      ...
      onCancel: L,
      onSave: fe,
      onUninstall: S ? pe : void 0,
    });
  let _e = (0, $.jsx)(be, { slug: Ye }),
    H = (0, $.jsx)(Se, { slug: Ye }),
    U = M
      ? (0, $.jsxs)(j, {
          color: `ghost`,
          size: `toolbar`,
          onClick: () => {
            i.dispatchMessage(`codex-app-server-restart`, { hostId: e });
          },
          children: [
  ...
  return (0, $.jsxs)(ye, {
    ...
    children: [
      (0, $.jsxs)(K, {
        children: [
          (0, $.jsx)(K.Header, {
            title: (0, $.jsx)(a, { ...Be.servers }),
            actions: (N || P) && (0, $.jsx)(Ge, { onClick: W }),
          }),
          N || !P
            ? (0, $.jsx)(K.Content, {
                children: (0, $.jsx)(G, {
                    ...
                    ? ne.map((e) =>
                        (0, $.jsx)(
                          We,
                          {
                            ...
                            onEnableClicked: D[e] ? (t) => z(e, t) : void 0,
...
function We(e) {
  let t = (0, Ke.c)(15),
    ...
    p = d(),
    m = !r && i !== void 0 && o === `notLoggedIn`,
    h = s !== void 0 || l !== void 0 || m,
    g;
  t[0] === n
    ? (g = t[1])
    : ((g = (0, $.jsx)(`span`, {
            ...
            children: [
              ...
              l
                ? (0, $.jsx)(j, {
                    ...
                    children: (0, $.jsx)(u, { className: `icon-xs` }),
                  })
                : null,
              s
                ? (0, $.jsx)(E, {
  ...
  return (
    t[12] !== g || t[13] !== _
      ? ((v = (0, $.jsx)(he, { label: g, description: null, control: _ })),
        (t[12] = g),
        (t[13] = _),
        (t[14] = v))
      : (v = t[14]),
