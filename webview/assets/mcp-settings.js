...
import { Dt as le, Tt as ue } from "./app-initial~app-main~automations-page.js";
import {
  _a as de,
  at as fe,
  bu as N,
...
import { a as be } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~new-thread-panel-page~o~bj5tp28r.js";
import {
  S as xe,
  g as Se,
...
function q(e) {
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, Y.jsx)(V, {
                    color: `ghost`,
                    size: `icon`,
                    disabled: e.disabled || (h.length <= 1 && t.trim().length === 0),
                    "aria-label": d,
                    onClick: () => {
                      let t = e.value.filter((e, t) => t !== n);
                      e.onEdit(t);
                    },
                    children: (0, Y.jsx)(S, { className: `icon-2xs` }),
                  }),
                ],
              },
              `list-${n}`,
              ...
              `div`,
              {
                ...
                children: [
                  ...
                  (0, Y.jsx)(V, {
                    ...
                    disabled:
                      e.disabled ||
                      (_.length <= 1 && t.key.trim().length === 0 && t.value.trim().length === 0),
                    "aria-label": d,
                    onClick: () => {
                      let t = e.value.filter((e, t) => t !== n);
                      e.onEdit(t);
  ...
  t[39] === y
    ? (b = t[40])
    : ((b = (0, Y.jsx)(`div`, { className: `flex flex-col gap-2`, children: y })),
      (t[39] = y),
      (t[40] = b));
  let x;
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, Y.jsx)(N, { className: `icon-2xs` })), (t[46] = w))
    : (w = t[46]);
  ...
  return (0, Z.jsx)(ue, {
    ...
    subtitle: _
      ...
      : (0, Z.jsxs)(`a`, {
          ...
          rel: `noreferrer`,
          onClick: (e) => {
            _e({ event: e, href: Se, initiator: `open_in_browser_bridge` });
          },
          ...
          children: [
            ...
            (0, Z.jsx)(fe, { href: Se, className: `icon-xxs` }),
          ],
        }),
    action:
...
function He() {
  let { selectedHostId: e } = g(),
    { data: t } = ie(null, { hostId: e }),
    { data: r, isFetching: a } = u(ce, e),
    o = te({ hostId: e }),
    s = ne({ hostId: e }),
    l = c(),
    f = j(),
    ...
    le = new Set(Object.entries(k).flatMap(([e, t]) => [e, t.name ?? e])),
    de = v.includes(e),
    fe = de ? (S[e] ?? []) : [],
    N = (0, qe.default)(
      (t == null ? [] : (r?.data ?? [])).filter((e) => !le.has(e.name) && !fe.includes(e.name)),
      (e) => e.name,
    ),
    P = A.length > 0,
    F = N.length > 0,
  ...
  let L = () => {
      x((t) => (t.includes(e) ? t : [...t, e]));
    },
    R = () => {
      (O(null), D(null));
    },
    z = () => {
      if (se != null) return se.filePath;
      throw Error(
        f.formatMessage({
    ...
    pe = async (e, t) => {
      let n = E ?? Ue(t, A, null);
      try {
        (await o.mutateAsync({ filePath: z(), key: n, value: e }), L(), R());
      } catch (e) {
        throw (
          i.error(`Failed to save MCP server`, { safe: { targetKey: n }, sensitive: { error: e } }),
          e
        );
      }
    },
    _e = async (t) => {
      let n = E ?? Ue(t, A, null);
      try {
        (await o.mutateAsync({ filePath: z(), key: n, value: null }),
          C((r) => ({ ...r, [e]: (0, Je.default)([...(r[e] ?? []), n, t, k[n]?.name ?? n]) })),
          L(),
          R());
      } catch (e) {
        throw (
    ...
    H = async (t) => {
      ...
      let n = h[t];
      if (n) {
        ge({ href: n, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
        return;
      }
      _((e) => ({ ...e, [t]: null }));
      try {
        let { authorizationUrl: n } = await ae(`login-mcp-server`, { hostId: e, name: t });
        n &&
          (_((e) => ({ ...e, [t]: n })),
          ge({ href: n, initiator: `open_in_browser_bridge`, openTarget: `external-browser` }));
      } catch (e) {
    ...
    U = (0, Q.useEffectEvent)((e, t) => {
      (_((n) => {
        ...
        t && (L(), l.invalidateQueries({ queryKey: w })));
    }),
    W = (0, Q.useRef)(!0);
  if (
    ((0, Q.useEffect)(() => {
      ...
      m?.hostId === e && U(m.name, m.success);
    }, [m, e]),
    d(
      `codex-app-server-initialized`,
      (e) => {
        (x((t) => t.filter((t) => t !== e.hostId)),
          C((t) => {
            let { [e.hostId]: n, ...r } = t;
            return r;
          }),
          l.invalidateQueries({ queryKey: [...w, e.hostId] }));
      },
      [l],
    ),
    ee)
    ...
    return (0, $.jsx)(Me, {
      ...
      onCancel: R,
      onSave: pe,
      onUninstall: E ? _e : void 0,
    });
  let ve = (0, $.jsx)(he, { slug: Ye }),
    ye = (0, $.jsx)(me, { slug: Ye }),
    be = de
      ? (0, $.jsxs)(V, {
          color: `ghost`,
          size: `toolbar`,
          onClick: () => {
            n.dispatchMessage(`codex-app-server-restart`, { hostId: e });
          },
          children: [
  ...
  return (0, $.jsxs)(ue, {
    ...
    children: [
      (0, $.jsxs)(G, {
        children: [
          (0, $.jsx)(G.Header, {
            title: (0, $.jsx)(T, { ...Be.servers }),
            actions: (P || F) && (0, $.jsx)(Ge, { onClick: xe }),
          }),
          P || !F
            ? (0, $.jsx)(G.Content, {
                children: (0, $.jsx)(K, {
                    ...
                    ? M.map((e) =>
                        (0, $.jsx)(
                          We,
                          {
                            name: k[e]?.name ?? e,
                            statusLoading: a,
                            enabled: k[e]?.enabled !== !1,
                            authStatus: I[e],
                            onAuthenticateClicked: () => H(e),
                            onEnableClicked: k[e] ? (t) => B(e, t) : void 0,
                            onSettingsClicked: k[e]
                              ? async () => {
                                  (D(e), O(k[e]));
                                }
                              : void 0,
                            isReadOnly: oe[e]?.name.type === `project`,
                          },
                          e,
                        ),
                      )
                  ...
                  children: N.map((e) =>
                    (0, $.jsx)(
                      We,
                      {
                        ...
                        onAuthenticateClicked: () => H(e.name),
                      },
                      `status-${e.name}`,
                    ),
                  ),
...
function We(e) {
  ...
  return (
    t[12] !== p || t[13] !== m
      ? ((h = (0, $.jsx)(y, { label: p, description: null, control: m })),
        (t[12] = p),
        (t[13] = m),
        (t[14] = h))
      : (h = t[14]),
