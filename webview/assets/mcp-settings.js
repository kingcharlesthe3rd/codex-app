...
import { gt as le, vt as F } from "./app-initial~app-main~automations-page.js";
import { r as I } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~pull-requests-page~new-~ozr5a6hk.js";
import {
  Dn as ue,
  Dt as L,
  Et as R,
...
import { Mt as V, jt as fe } from "./app-initial~app-main~onboarding-page.js";
import {
  S as pe,
  n as me,
  t as he,
...
import { i as _e, r as ve } from "./app-initial~app-main~new-thread-panel-page~onboarding-page.js";
import {
  O as W,
  P as ye,
...
function q(e) {
  let t = (0, ke.c)(55),
    n = e.inputType === H.String,
    r = e.inputType === H.Array,
    i = e.inputType === H.Record,
    a = P(),
    o;
  t[0] === a
    ? (o = t[1])
  ...
  if (t[6] !== s || t[7] !== e.inputType || t[8] !== e.placeHolderValue || t[9] !== l) {
    if (((f = s), (p = l), e.inputType === H.Record)) {
  ...
  t[39] === b
    ? (S = t[40])
    : ((S = (0, Y.jsx)(`div`, { className: `flex flex-col gap-2`, children: b })),
      (t[39] = b),
      (t[40] = S));
  let w;
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Y.jsx)(C, { className: `icon-2xs` })), (t[46] = E))
    : (E = t[46]);
  ...
  return (0, Z.jsx)(le, {
    ...
    subtitle: v
      ...
      : (0, Z.jsxs)(`a`, {
          ...
          rel: `noreferrer`,
          onClick: (e) => {
            D({ event: e, href: W, initiator: `open_in_browser_bridge` });
          },
          ...
          children: [
            ...
            (0, Z.jsx)(he, { href: W, className: `icon-xxs` }),
          ],
        }),
    action:
...
function He() {
  let { selectedHostId: e } = de(),
    { data: t } = ie(null, { hostId: e }),
    { data: n, isFetching: s } = i(oe, e),
    c = ee({ hostId: e }),
    l = ce({ hostId: e }),
    d = a(),
    f = P(),
    ...
    j = new Set(Object.entries(D).flatMap(([e, t]) => [e, t.name ?? e])),
    N = y.includes(e),
    se = N ? (x[e] ?? []) : [],
    F = (0, qe.default)(
      (t == null ? [] : (n?.data ?? [])).filter((e) => !j.has(e.name) && !se.includes(e.name)),
      (e) => e.name,
    ),
    I = A.length > 0,
    L = F.length > 0,
  ...
  let z = () => {
    ...
    pe = async (e, t) => {
      try {
        (await l.mutateAsync({ key: e, enabled: t }), z());
      } catch {}
    },
    me = async (e, t) => {
      let n = C ?? Ue(t, A, null);
      try {
        (await c.mutateAsync({ filePath: V(), key: n, value: e }), z(), B());
      } catch (e) {
        throw (
          r.error(`Failed to save MCP server`, { safe: { targetKey: n }, sensitive: { error: e } }),
          e
        );
      }
    },
    he = async (t) => {
      let n = C ?? Ue(t, A, null);
      try {
        (await c.mutateAsync({ filePath: V(), key: n, value: null }),
          S((r) => ({ ...r, [e]: (0, Je.default)([...(r[e] ?? []), n, t, D[n]?.name ?? n]) })),
          z(),
          B());
      } catch (e) {
        throw (
    ...
    ge = async (t) => {
      ...
      let n = h[t];
      if (n) {
        _({ href: n, initiator: `open_in_browser_bridge`, openTarget: `external-browser` });
        return;
      }
      v((e) => ({ ...e, [t]: null }));
      try {
    ...
    H = (0, Q.useEffectEvent)((e, t) => {
      (v((n) => {
        ...
        t && (z(), d.invalidateQueries({ queryKey: te })));
    }),
    U = (0, Q.useRef)(!0);
  if (
    ((0, Q.useEffect)(() => {
    ...
    m(
      ...
      (e) => {
        (b((t) => t.filter((t) => t !== e.hostId)),
          ...
          d.invalidateQueries({ queryKey: [...te, e.hostId] }));
      },
      [d],
    ),
    T)
    ...
    return (0, $.jsx)(Me, {
      ...
      onCancel: B,
      onSave: me,
      onUninstall: C ? he : void 0,
    });
  let _e = (0, $.jsx)(xe, { slug: Ye }),
    ve = (0, $.jsx)(Se, { slug: Ye }),
    W = N
      ? (0, $.jsxs)(g, {
          color: `ghost`,
  ...
  return (0, $.jsxs)(le, {
    ...
    children: [
      (0, $.jsxs)(K, {
        children: [
          (0, $.jsx)(K.Header, {
            title: (0, $.jsx)(M, { ...Be.servers }),
            actions: (I || L) && (0, $.jsx)(Ge, { onClick: ye }),
          }),
          I || !L
            ? (0, $.jsx)(K.Content, {
                children: (0, $.jsx)(G, {
                  ...
                  children: F.map((e) =>
                    (0, $.jsx)(
                      We,
                      {
                        ...
                        onAuthenticateClicked: () => ge(e.name),
                      },
                      `status-${e.name}`,
                    ),
                  ),
            ...
            children: [
              ...
              c
                ? (0, $.jsx)(g, {
                    ...
                    children: (0, $.jsx)(w, { className: `icon-xs` }),
                  })
                : null,
              o
                ? (0, $.jsx)(E, {
