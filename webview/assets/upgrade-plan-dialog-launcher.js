          ...
          switch (d(n, b, { disableExposureLog: !1 }).get(`surface`, `web`)) {
            case `dialog`:
              return (
                s == null
                  ? E(a, n, t).then((e) => {
                      p(a, v, { currentPlan: o, defaultTab: e, source: c });
                    })
                  : p(a, v, { currentPlan: o, defaultTab: s, source: c }),
                !0
              );
            case `page`: {
              let e = (e) => {
