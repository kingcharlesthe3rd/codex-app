...
import { A as t, D as n, S as r, l as i, n as a, r as o } from "./reduce.js";
import { M as s } from "./_baseFor-1.js";
import {
  _ as c,
  a as l,
  b as u,
...
import { j as C, n as w } from "./merge.js";
import { n as T, r as ae, t as E } from "./graphlib-DW-d3iNK.js";
function D(e) {
...
function Te(e) {
  function t(n) {
    var r = e.children(n),
      i = e.node(n);
    if ((r.length && o(r, t), Object.prototype.hasOwnProperty.call(i, `minRank`))) {
      ((i.borderLeft = []), (i.borderRight = []));
      for (var a = i.minRank, s = i.maxRank + 1; a < s; ++a)
        (Ee(e, `borderLeft`, `_bl`, n, i, a), Ee(e, `borderRight`, `_br`, n, i, a));
    }
  }
  o(e.children(), t);
}
...
function ke(e) {
  var t = e.graph().rankdir.toLowerCase();
  ((t === `bt` || t === `rl`) && Me(e), (t === `lr` || t === `rl`) && (Ne(e), Ae(e)));
}
function Ae(e) {
  (o(e.nodes(), function (t) {
    je(e.node(t));
...
function Ue(e) {
  ...
  function i(a) {
    ...
    Object.prototype.hasOwnProperty.call(t, a) ||
      ((n[a] = !0), (t[a] = !0), o(e.predecessors(a), i), delete n[a], r.push(a));
  }
...
function xt(e, t, n) {
  var r = St(e),
    i = new T({ compound: !0 }).setGraph({ root: r }).setDefaultNodeLabel(function (t) {
      return e.node(t);
    });
  return (
    o(e.nodes(), function (a) {
      ...
      (s.rank === t || (s.minRank <= t && t <= s.maxRank)) &&
        ...
        Object.prototype.hasOwnProperty.call(s, `minRank`) &&
          i.setNode(a, { borderLeft: s.borderLeft[t], borderRight: s.borderRight[t] }));
    }),
    i
  );
}
  ...
  return (
    o(
      s.forEach(function (e) {
        var t = e.pos + c;
        d[t] += e.weight;
        for (var n = 0; t > 0; ) (t % 2 && (n += d[t + 1]), (t = (t - 1) >> 1), (d[t] += e.weight));
        f += e.weight * n;
      }),
    ),
    f
...
function Mt(e) {
  ...
  function i(e) {
    return function (t) {
      t.merged ||
        ((p(t.barycenter) || p(e.barycenter) || t.barycenter >= e.barycenter) && Nt(e, t));
    };
  }
  function a(t) {
    return function (n) {
...
function zt(e, t, r, a) {
  ...
  o(f, function (t) {
    if (e.children(t.v).length) {
      var n = zt(e, t.v, r, a);
      ((d[t.v] = n), Object.prototype.hasOwnProperty.call(n, `barycenter`) && Vt(t, n));
    }
  });
  var p = jt(f, r);
  Bt(p, d);
    ...
    return (
      o(n, function (o, c) {
        if (e.node(o).dummy === `border`) {
          ...
          l.length && ((a = e.node(l[0]).order), r(n, s, c, i, a), (s = c), (i = a));
        }
    ...
    o(t, function (e) {
      ...
      o(e, function (e) {
        ...
        if (o.length) {
          ...
          for (var c = (o.length - 1) / 2, u = Math.floor(c), d = Math.ceil(c); u <= d; ++u) {
            var f = o[u];
            a[e] === e &&
              t < s[f] &&
              !nn(n, e, f) &&
...
function Sn(e) {
  o(e.edges(), function (t) {
    ...
    if (n.width && n.height) {
      var r = e.node(t.v);
      j(e, `edge-proxy`, { rank: (e.node(t.w).rank - r.rank) / 2 + r.rank, e: t }, `_ep`);
    }
  });
}
function Cn(e) {
...
var Nn,
  ...
  Vn = e(() => {
    (b(),
      ...
      (zn = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: `r` }),
      (Bn = [`labelpos`]));
  }),
  Hn = e(() => {
    (A(), Vn(), R(), ft());
...
//# sourceMappingURL=dagre-BZ-7uXhr.js.map
