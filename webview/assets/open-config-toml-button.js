...
async function g(e) {
  try {
    return (await s(`open-in-targets`, { params: { cwd: null, hostId: e } })).preferredTarget;
  } catch {
    return;
  }
}
...
function S(e) {
  ...
  n[0] === s
    ? (l = n[1])
    : ((l = s == null ? null : v.default.join(s, `config.toml`)), (n[0] = s), (n[1] = l));
  let f = l,
    p;
  n[2] === c
    ? (p = n[3])
    : ((p = c ? (0, y.jsx)(i, { ...m.openConfigTomlWsl }) : (0, y.jsx)(i, { ...m.openConfigToml })),
      (n[2] = c),
      (n[3] = p));
  let h = p,
    g;
