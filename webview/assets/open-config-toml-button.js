...
import { n as r } from "./vscode-api.js";
import { Rr as i, w as a } from "./src.js";
...
async function g(e) {
  try {
    return (await r(`open-in-targets`, { params: { cwd: null, hostId: e } })).preferredTarget;
  } catch {
    return;
  }
}
...
function S(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i == null ? null : v.default.join(i, `config.toml`)), (t[0] = i), (t[1] = c));
  let f = c,
    p;
  t[2] === o
    ? (p = t[3])
    : ((p = o ? (0, y.jsx)(s, { ...m.openConfigTomlWsl }) : (0, y.jsx)(s, { ...m.openConfigToml })),
      (t[2] = o),
      (t[3] = p));
  let h = p,
    g;
