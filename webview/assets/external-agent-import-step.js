...
import { A as l, _ as u, h as d, n as f, r as p, v as m } from "./vscode-api.js";
import { li as h } from "./src-3.js";
import { l as g, r as _, s as v } from "./lib-1.js";
import { t as y } from "./clsx.js";
import { t as b } from "./button.js";
import { t as x } from "./spinner.js";
import { t as S } from "./tooltip-B.js";
import { A as C, I as w } from "./rpc-1.js";
import { a as T, o as E, r as D } from "./config-queries.js";
import { O, a as k, m as A, r as j } from "./sidebar-signals.js";
import { t as M } from "./apps.js";
import { t as N } from "./use-plugins.js";
import { t as P } from "./info.js";
import { t as F } from "./check-circle-filled.js";
import { t as I } from "./file.js";
import { t as L } from "./terminal.js";
import { t as R } from "./json-2.js";
import { t as ee } from "./settings.cog.js";
import { t as z } from "./skills.js";
import { a as te, d as ne, i as re, l as ie, n as ae, r as oe, u as se } from "./dialog-layout.js";
...
import { t as ue } from "./toggle.js";
import { s as H } from "./permissions-mode-visibility.js";
import { t as de } from "./codex-app-ga-logo.js";
import { n as fe, r as U } from "./onboarding-shell.js";
import { t as pe } from "./hooks.js";
var me = e(V(), 1);
function he(e, t) {
  switch (t.itemType) {
    case `AGENTS_MD`:
...
function xe(e) {
  let t = (0, J.c)(14),
    ...
    a;
  t[0] === n ? (a = t[1]) : ((a = (0, q.jsx)(Se, { variant: n })), (t[0] = n), (t[1] = a));
  let o, s;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, q.jsx)(ye, { className: `h-12 w-10 text-token-foreground` })),
      (s = (0, q.jsx)(`img`, { alt: ``, className: `size-12`, src: de })),
      (t[2] = o),
      (t[3] = s))
    : ((o = t[2]), (s = t[3]));
  let c;
...
function Se(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = y(`flex size-12 shrink-0 items-center justify-center rounded-xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
...
function Te(e) {
  ...
  t[14] !== d || t[15] !== p
    ? ((D = d
        ? (0, q.jsx)(te, {
            children: (0, q.jsx)(re, {
              title: (0, q.jsx)(ne, { className: `contents`, children: p }),
              subtitle: (0, q.jsx)(se, { className: `sr-only`, children: h }),
            }),
          })
        : (0, q.jsx)(xe, { sourceIconVariant: `neutral`, title: p, subtitle: h })),
      (t[14] = d),
      (t[15] = p),
      (t[16] = D))
    : (D = t[16]);
  let O = d ? `mt-4 flex w-full flex-col` : `mt-8 flex w-full max-w-xs flex-col`,
    k;
  ...
  if (t[20] !== n || t[21] !== l) {
    ...
    (t[25] === l
      ? (r = t[26])
      : ((r = (e) =>
          (0, q.jsx)(Ee, { providerId: e, selected: l.includes(e), onToggle: () => w(e) }, e)),
        (t[25] = l),
        (t[26] = r)),
      (j = Ce.filter(e).map(r)),
      (t[20] = n),
  ...
  let P;
  t[31] !== M || t[32] !== O
    ? ((P = (0, q.jsxs)(`div`, { className: O, children: [k, M, N] })),
      (t[31] = M),
      (t[32] = O),
      (t[33] = P))
    : (P = t[33]);
  let F;
  t[34] !== y || t[35] !== S || t[36] !== d || t[37] !== i || t[38] !== o
    ? ((F = d
        ? (0, q.jsx)(`div`, {
            className: `mt-4`,
    ...
    : (F = t[39]);
  let I;
  t[40] !== P || t[41] !== F || t[42] !== D
    ? ((I = (0, q.jsxs)(q.Fragment, { children: [D, P, F] })),
      (t[40] = P),
      (t[41] = F),
      (t[42] = D),
      (t[43] = I))
  ...
  let L = I,
    R;
  return (
    t[44] !== L || t[45] !== E || t[46] !== d
      ? ((R = d
          ? (0, q.jsx)(ae, { as: `form`, className: `gap-0`, onSubmit: E, children: L })
          : (0, q.jsx)(`div`, {
...
function Ee(e) {
  ...
  t[10] !== i || t[11] !== r || t[12] !== f
    ? ((p = (0, q.jsx)(ue, { checked: r, ariaLabel: f, onChange: i })),
      (t[10] = i),
      (t[11] = r),
      (t[12] = f),
      (t[13] = p))
...
function ke(e) {
                ...
                e.tooltip == null
                  ...
                  : (0, q.jsx)(S, {
                      ...
                      children: (0, q.jsx)(`button`, {
                        ...
                        children: (0, q.jsx)(P, { className: `size-4`, "aria-hidden": `true` }),
                      }),
                    }),
                (0, q.jsx)(`div`, {
  ...
  return (
    t[20] !== p || t[21] !== y
      ? ((x = (0, q.jsxs)(`div`, { className: `flex flex-col gap-4 p-4`, children: [u, d, p, y] })),
        (t[20] = p),
        (t[21] = y),
        (t[22] = x))
      : (x = t[22]),
...
function Ae(e) {
  ...
  switch (n) {
    case `instructions`: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(I, { className: `icon-base` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
    case `settings`: {
      ...
      return (
        t[1] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(R, { className: `icon-base` })), (t[1] = e))
          : (e = t[1]),
        e
      );
    }
    case `skills`: {
      ...
      return (
        t[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(z, { className: `icon-base` })), (t[2] = e))
          : (e = t[2]),
        e
      );
    }
    ...
    case `projects`: {
      ...
      return (
        t[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(le, { className: `icon-base` })), (t[4] = e))
          : (e = t[4]),
        e
      );
    }
    ...
    case `hooks`: {
      ...
      return (
        t[6] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(pe, { className: `icon-base` })), (t[6] = e))
          : (e = t[6]),
        e
      );
    }
    case `commands`: {
      ...
      return (
        t[7] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(L, { className: `icon-base` })), (t[7] = e))
          : (e = t[7]),
        e
      );
    }
...
async function Me({
  ...
  try {
    ...
    return (
      d.warning(`Failed to add imported project roots after import`, {
        safe: { hostId: e },
        sensitive: { error: t },
      }),
      []
...
async function Ne({ hostId: e, projectRoots: t }) {
  ...
  let n = await f(`paths-exist`, { params: { hostId: e, paths: t } }),
...
async function Pe(e) {
  let t = (
    await Promise.allSettled(
      [...e]
        ...
        .map(
          async (e) => (
            await f(`add-workspace-root-option`, { params: { root: e, setActive: !1 } }),
            e
          ),
        ),
    )
  ...
  t.length > 0 &&
    d.warning(`Failed to add some imported project roots after import`, {
      safe: { failedRootCount: t.length, totalRootCount: e.length },
      sensitive: { errors: t.map((e) => e.reason) },
    });
}
function Fe(e = c) {
  return s(`refresh-recent-conversations-for-host`, { hostId: e });
}
async function Ie(e) {
  try {
    await e();
  } catch (e) {
    d.warning(`Failed to refresh recent conversations after import`, {
      safe: {},
      sensitive: { error: e },
    });
  }
...
function Re(e) {
  ...
  return [
    ...
    ...(e.sessionItems.length > 0
      ? [{ key: `chats`, kind: `chats`, count: He(e.sessionItems), items: e.sessionItems }]
      : []),
  ];
}
function ze({ model: e, selection: t }) {
  let n = e.projectItems.some((e, n) => Object.prototype.hasOwnProperty.call(t, Be(e, n))),
    r = Re(e).filter((e) => t[e.key] ?? !1);
  return [
    ...r
      .filter((e) => e.kind !== `chats`)
      .flatMap((e) =>
        e.kind !== `projects` || !n ? e.items : e.items.filter((e, n) => t[Be(e, n)] ?? !1),
      ),
...
var Ue = [`claude-code`, `claude-cowork`];
function We({ hostId: e, workspaceRoots: t }) {
  return [`external-agent-config`, `import-model`, `detected`, e, t];
}
async function Ge({ hostId: e, includeHome: t, workspaceRoots: n }) {
  let r = n == null || n.length === 0 ? void 0 : n;
  return f(`external-agent-import-detect`, {
    params: {
      hostId: e,
      includeHome: t,
      providers: Ue,
      ...(r == null ? {} : { workspaceRoots: r }),
    },
  });
}
async function Ke({ hostId: e, items: t }) {
  return t.length === 0
    ? { projectRoots: [] }
    : f(`external-agent-import-import`, { params: { hostId: e, items: t } });
}
async function qe(e) {
  await Promise.all([
    ...
    e.invalidateQueries({ queryKey: D }),
    e.invalidateQueries({ queryKey: E }),
    e.invalidateQueries({ queryKey: p(`local-custom-agents`) }),
    e.invalidateQueries({ queryKey: p(`external-agent-import-status`) }),
    e.invalidateQueries({ queryKey: p(`external-agent-imported-connectors`) }),
  ]);
}
function Je({ items: e, surface: t }) {
  d.info(`external_agent_import_user_flow_started`, { safe: { surface: t, ...Ze(e) } });
}
function Ye({
  durationMs: e,
  error: t,
  ...
  if (a === `success`) {
    d.info(`external_agent_import_user_flow_finished`, { safe: s });
    return;
  }
  d.warning(`external_agent_import_user_flow_finished`, { safe: s, sensitive: { error: t } });
}
function Xe(e) {
  switch (e) {
    case `import`:
...
function et(e) {
  let t = (0, J.c)(40),
    ...
    o;
  t[0] !== a || t[1] !== i
    ? ((o = We({ hostId: a, workspaceRoots: i })), (t[0] = a), (t[1] = i), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== a || t[4] !== i
    ? ((s = () => Ge({ hostId: a, includeHome: !0, workspaceRoots: i })),
      (t[3] = a),
      (t[4] = i),
      (t[5] = s))
    : (s = t[5]);
  let l;
  t[6] !== n || t[7] !== o || t[8] !== s
    ? ((l = { queryKey: o, staleTime: 0, enabled: n, queryFn: s }),
      (t[6] = n),
      (t[7] = o),
      (t[8] = s),
      (t[9] = l))
  ...
  let d = m(l),
    ...
    h;
  t[10] === f ? (h = t[11]) : ((h = f.filter(nt)), (t[10] = f), (t[11] = h));
  let g = h,
    _;
  t[12] === f ? (_ = t[13]) : ((_ = f.filter(tt)), (t[12] = f), (t[13] = _));
  let v = _,
    y;
  t[14] !== g || t[15] !== v
    ? ((y = Le({ homeItems: g, projectItems: v })), (t[14] = g), (t[15] = v), (t[16] = y))
    : (y = t[16]);
  let b = y,
    x;
  t[17] === b ? (x = t[18]) : ((x = b == null ? [] : Re(b)), (t[17] = b), (t[18] = x));
  let S = x,
    C = n && d.isLoading,
    w;
  t[19] === b
    ? (w = t[20])
    : ((w = (e) => (b == null ? [] : ze({ model: b, selection: e }))), (t[19] = b), (t[20] = w));
  let T = w,
    E;
  t[21] === a
    ? (E = t[22])
    : ((E = { mutationFn: (e) => Ke({ hostId: a, items: e }) }), (t[21] = a), (t[22] = E));
  let D = u(E),
    O = b != null || p.length > 0,
    k = b != null,
    A;
  ...
  t[26] === d
    ? (j = t[27])
    : ((j = async () => (await d.refetch()).data?.items ?? Qe), (t[26] = d), (t[27] = j));
  let M;
  return (
    t[28] !== S ||
    t[29] !== f ||
...
function at(e) {
  ...
  let {
    ...
    S;
  t[2] === m ? (S = t[3]) : ((S = ct(m)), (t[2] = m), (t[3] = S));
  let C = S,
    w;
  bb0: {
    if (!n) {
    ...
    let e;
    (t[4] !== m || t[5] !== s || t[6] !== C
      ? ((e = Y({ detectedItems: m, intl: s, providerIds: C })),
        (t[4] = m),
        (t[5] = s),
        (t[6] = C),
        (t[7] = e))
  ...
  let T = w,
    ...
    M;
  t[8] !== m || t[9] !== s
    ? ((M = (e) => Y({ detectedItems: m, intl: s, providerIds: e })),
      (t[8] = m),
      (t[9] = s),
      (t[10] = M))
    : (M = t[10]);
  ...
  t[21] !== T
    ? ((N = async (e, t) => {
        if (!n || (t == null && !_)) return;
        let i = t == null ? T : Y({ detectedItems: m, intl: s, providerIds: t }),
          a = t == null ? h(e) : lt({ detectedItems: m, providerIds: t, selection: e }),
          o = Date.now(),
          l = `import`,
          f = 0;
        Je({ items: a, surface: `first_time_onboarding` });
        let g = i?.chatChoiceKey != null && e[i.chatChoiceKey];
        try {
          l = `import`;
          let { projectRoots: n } = t == null ? await y(e) : await v(a);
          ((f = n.length),
            ...
            await je({
              ...
              onImportedProjectRootsReady: (e) => {
                A(r, k({ collapsedGroups: d, importedProjectRoots: e }));
              },
              projectRoots: n,
              invalidateWorkspaceRootQueries: async () => {
                await Promise.all([
                  u.invalidateQueries({ queryKey: p(`workspace-root-options`) }),
                  u.invalidateQueries({ queryKey: p(`active-workspace-roots`) }),
                ]);
              },
            ...
            (l = `invalidate_queries`),
            await Promise.all([
              u.invalidateQueries({ queryKey: p(`codex-agents-md`) }),
              u.invalidateQueries({ queryKey: B }),
            ]),
            Ye({
  ...
  return (
    ...
    t[29] !== N
      ? ((P = {
          ...
          isImporting: D,
          providerIds: C,
          shouldShowImportStep: O,
          summary: T,
          getSummaryForProviders: M,
          importSelection: N,
        }),
        (t[23] = C),
        (t[24] = T),
...
function ot() {
  return s(`refresh-recent-conversations-for-host`, { hostId: c, sortKey: O });
}
async function st({ queryClient: e }) {
  try {
    return (
      ct(
        (
          await e.fetchQuery({
            queryKey: We({ hostId: c }),
            queryFn: () => Ge({ hostId: c, includeHome: !0 }),
            staleTime: 0,
          })
        ).items,
      ).length > 0
...
function ct(e) {
  return rt.filter((t) => ut(e, [t]) != null);
}
...
function Dt(e, t) {
  switch (t.itemType) {
    case `AGENTS_MD`:
      return `CLAUDE.md`;
    case `CONFIG`:
      return t.providerId === `claude-cowork` ? Mt(t.description) : `settings.json`;
    case `SKILLS`:
      return e.formatMessage({
...
function Rt({
  ...
  let _ = g(),
    [x, S] = (0, K.useState)(() => ft(d)),
    [C, w] = (0, K.useState)(!1),
    [T, E] = (0, K.useState)(() => new Set(d.customizeItems.map((e) => e.id))),
    D = c === `dialog`,
    O = i || r,
    k = i || r,
    A = Gt({ summary: d, selection: x }),
    j = Wt({ items: d.customizeItems, selection: x, group: `toolsAndSetup` }),
    M = Wt({ items: d.customizeItems, selection: x, group: `projects` }),
    N = d.chatChoiceKey != null && (x[d.chatChoiceKey] ?? !1),
  ...
  (0, K.useEffect)(() => {
    a && L({ action: `shown`, ...X(d, x, u) });
  }, []);
  let R = () => {
      (f?.(), w(!0));
    },
    z = () => {
      i || !A || (r || L({ action: `continue`, ...X(d, x, u) }), p(x));
    },
    ie = () => {
      O || (L({ action: `skipped`, ...X(d, x, u) }), h());
    },
    B = i
      ? (0, q.jsx)(v, {
    ...
    H = (0, q.jsxs)(q.Fragment, {
      children: [
        D
          ? (0, q.jsx)(te, {
              children: (0, q.jsx)(re, {
                title: (0, q.jsx)(ne, { className: `contents`, children: ce }),
                subtitle: V == null ? null : (0, q.jsx)(se, { children: V }),
              }),
            })
          : (0, q.jsx)(xe, { sourceIconVariant: `orange`, title: ce, subtitle: V }),
        (0, q.jsxs)(`div`, {
          className: y(`flex w-full flex-col`, D ? `mt-4` : `mt-8 max-w-sm`),
          children: [
            Ut(d)
              ? (0, q.jsxs)(fe, {
                  ...
                  children: [
                    d.toolsAndSetupCount > 0
                      ? (0, q.jsx)(U, {
                          checkboxId: `external-agent-import-tools-and-setup`,
                          checked: j,
                          control: k ? (0, q.jsx)(Q, { status: P }) : void 0,
                          disabled: O,
                          leadingContent: (0, q.jsx)(ee, { className: `icon-base` }),
                          label: (0, q.jsx)(v, {
                          ...
                          trailingControl:
                            d.toolsAndSetupTooltip == null
                              ...
                              : (0, q.jsx)($, {
                                  ...
                                  tooltip: d.toolsAndSetupTooltip.text,
                                }),
                          className: Lt,
                    ...
                    d.projectCount > 0
                      ? (0, q.jsx)(U, {
                          ...
                          checked: M,
                          control: k ? (0, q.jsx)(Q, { status: F }) : void 0,
                          disabled: O,
                          leadingContent: (0, q.jsx)(le, { className: `icon-base` }),
                          label: (0, q.jsx)(v, {
                            id: `electron.onboarding.welcomeV2.externalAgentImport.projects.title`,
                            defaultMessage: `Projects ({count})`,
                            description: `Projects import row title`,
                            values: { count: d.projectCount },
                          }),
                          description: (0, q.jsx)(v, {
                    ...
                    d.recentChatCount > 0
                      ? (0, q.jsx)(U, {
                          ...
                          checked: N,
                          control: k ? (0, q.jsx)(Q, { status: I }) : void 0,
                          disabled: O || d.chatChoiceKey == null,
                          leadingContent: (0, q.jsx)(De, { className: `icon-base` }),
                          label: (0, q.jsx)(v, {
                            id: `electron.onboarding.welcomeV2.externalAgentImport.recentChats.title`,
                            defaultMessage: `Chat sessions ({count})`,
                            description: `Recent chats toggle title`,
                            values: { count: d.recentChatCount },
                          }),
                          description: (0, q.jsx)(v, {
                          ...
                          trailingControl:
                            d.recentChatTooltip == null
                              ...
                              : (0, q.jsx)($, {
                                  ...
                                  tooltip: d.recentChatTooltip.text,
                                }),
                          className: Lt,
                          checkboxClassName: It,
                          controlPlacement: `right`,
                          onCheckedChange: (e) => {
                            let t = d.chatChoiceKey;
                            t != null &&
                              (S((n) => ({ ...n, [t]: e })),
                              E((n) => {
                                let r = new Set(n);
        ...
        (0, q.jsx)(Oe, {
          ...
          onOpenChange: w,
          onConfirm: (e) => {
            let t = d.customizeItems.filter((t) => T.has(t.id) !== e.has(t.id)).length;
            E(e);
            let n = Kt({ current: x, items: d.customizeItems, selectedItemIds: e });
            (S(n), L({ action: `customized`, changedItemsCount: t, ...X(d, n, u) }));
          },
        }),
        (0, q.jsxs)(`div`, {
          className: y(
  ...
  return D
    ? (0, q.jsx)(ae, { as: `form`, className: `gap-0`, onSubmit: ue, children: H })
    : (0, q.jsx)(`div`, {
        className: `flex w-full max-w-lg flex-col items-center overflow-hidden rounded-2xl p-10`,
        children: H,
      });
...
function Q(e) {
  ...
  if (n === `idle`) {
    ...
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, q.jsx)(`span`, { "aria-hidden": !0, className: `block h-5 w-5 shrink-0` })),
          (t[0] = e))
        : (e = t[0]),
      e
    );
  ...
  if (n === `complete`) {
    ...
    let n;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, q.jsx)(F, { className: `h-5 w-5 text-token-charts-green` })), (t[3] = n))
      : (n = t[3]);
    let i;
    return (
      t[4] === e
  ...
  let a;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, q.jsx)(x, { className: `h-5 w-5` })), (t[8] = a))
    : (a = t[8]);
  let o;
  return (
    t[9] === i
...
function $(e) {
  let t = (0, J.c)(6),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, q.jsx)(P, { className: `size-4`, "aria-hidden": `true` })), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === n
    ? (a = t[2])
