...
import { Ia as n, Va as r, Xs as i, po as a } from "./app-server-manager-signals.js";
...
import { a as ee, d as te, i as ne, l as L, n as re, r as ie, u as R } from "./dialog-layout.js";
import { t as z } from "./checkbox.js";
import { t as ae } from "./skills.js";
import { n as oe, t as se } from "./json.js";
...
function Te(e) {
  ...
  t[14] !== f || t[15] !== m
    ? ((E = f
        ...
        : (0, q.jsx)(xe, { sourceIconVariant: `neutral`, title: m, subtitle: _ })),
      (t[14] = f),
      (t[15] = m),
      (t[16] = E))
    : (E = t[16]);
  let D = f ? `mt-4 flex w-full flex-col` : `mt-8 flex w-full max-w-xs flex-col`,
    O;
  ...
  if (t[20] !== n || t[21] !== l) {
    ...
    (t[25] === l
      ? (r = t[26])
      : ((r = (e) =>
          (0, q.jsx)(Ee, { providerId: e, selected: l.includes(e), onToggle: () => C(e) }, e)),
        (t[25] = l),
        (t[26] = r)),
      (j = Ce.filter(e).map(r)),
      (t[20] = n),
  ...
  return (
    t[44] !== L || t[45] !== T || t[46] !== f
      ? ((z = f
          ? (0, q.jsx)(re, { as: `form`, className: `gap-0`, onSubmit: T, children: L })
          : (0, q.jsx)(`div`, {
...
function ke(e) {
  ...
  t[11] === p
    ? (m = t[12])
    : ((m = (0, q.jsx)(`div`, { className: `flex flex-col gap-2`, children: p })),
      (t[11] = p),
      (t[12] = m));
  let g = l === 0,
    _;
  ...
  return (
    t[20] !== m || t[21] !== y
      ? ((b = (0, q.jsxs)(`div`, { className: `flex flex-col gap-4 p-4`, children: [u, f, m, y] })),
        (t[20] = m),
        (t[21] = y),
        (t[22] = b))
      : (b = t[22]),
  ...
  let t = (
    await Promise.allSettled(
      [...e]
        ...
        .map(
          async (e) => (
            await v(`add-workspace-root-option`, { params: { root: e, setActive: !1 } }),
            e
          ),
        ),
    )
...
function Ye({
  ...
  u.warning(`external_agent_import_user_flow_finished`, { safe: c, sensitive: { error: t } });
}
function Xe(e) {
  switch (e) {
    case `import`:
...
function et(e) {
  let t = (0, J.c)(42),
    { enabled: n, hostId: r, isCoworkMigrationEnabled: i, workspaceRoots: o } = e,
    s = r === void 0 ? a : r,
    c;
  t[0] !== s || t[1] !== i || t[2] !== o
  ...
  t[4] !== s || t[5] !== i || t[6] !== o
    ? ((l = () =>
        We({ hostId: s, includeHome: !0, isCoworkMigrationEnabled: i, workspaceRoots: o })),
      (t[4] = s),
      (t[5] = i),
      (t[6] = o),
      (t[7] = l))
  ...
  let v = _,
    y;
  t[16] !== g || t[17] !== v
    ? ((y = Le({ homeItems: g, projectItems: v })), (t[16] = g), (t[17] = v), (t[18] = y))
    : (y = t[18]);
  let x = y,
    S;
  t[19] === x ? (S = t[20]) : ((S = x == null ? [] : Re(x)), (t[19] = x), (t[20] = S));
  let C = S,
    w = n && d.isLoading,
    T;
  t[21] === x
    ? (T = t[22])
    : ((T = (e) => (x == null ? [] : ze({ model: x, selection: e }))), (t[21] = x), (t[22] = T));
  let E = T,
    D;
  t[23] === s
    ? (D = t[24])
    : ((D = { mutationFn: (e) => Ge({ hostId: s, items: e }) }), (t[23] = s), (t[24] = D));
  let O = b(D),
    k = x != null || p.length > 0,
    A = x != null,
    j;
  ...
  t[28] === d
    ? (M = t[29])
    : ((M = async () => (await d.refetch()).data?.items ?? Qe), (t[28] = d), (t[29] = M));
  let N;
  return (
    t[30] !== C ||
    t[31] !== f ||
...
function at(e) {
  let t = (0, J.c)(33),
    ...
    l;
  t[0] !== n || t[1] !== r
    ? ((l = { enabled: n, isCoworkMigrationEnabled: r }), (t[0] = n), (t[1] = r), (t[2] = l))
    : (l = t[2]);
  let {
      detectedItems: u,
      getSelectedItems: m,
  ...
  t[23] !== k
    ? ((P = async (e, t) => {
        ...
        let r = t == null ? k : Y({ detectedItems: u, intl: o, providerIds: t }),
          l = t == null ? m(e) : lt({ detectedItems: u, providerIds: t, selection: e }),
          d = Date.now(),
          f = `import`,
          p = 0;
          ...
          ((p = n.length),
            ...
            await je({
              ...
              invalidateWorkspaceRootQueries: async () => {
                await Promise.all([
                  s.invalidateQueries({ queryKey: y(`workspace-root-options`) }),
                  s.invalidateQueries({ queryKey: y(`active-workspace-roots`) }),
                ]);
              },
      ...
      ct({
        detectedItems: (
          await t.fetchQuery({
            ...
            queryFn: () => We({ hostId: a, includeHome: !0, isCoworkMigrationEnabled: e }),
            staleTime: 0,
          })
        ).items,
...
function ct({ detectedItems: e, isCoworkMigrationEnabled: t }) {
  return rt.filter((n) => (n === `claude-cowork` && !t ? !1 : ut(e, [n]) != null));
}
...
function Rt({
    ...
    H = (0, q.jsxs)(q.Fragment, {
      children: [
        E
          ...
          : (0, q.jsx)(xe, { sourceIconVariant: `orange`, title: B, subtitle: V }),
        (0, q.jsxs)(`div`, {
                  ...
                  children: [
                    p.toolsAndSetupCount > 0
                      ? (0, q.jsx)(U, {
                          ...
                          disabled: D,
                          leadingContent: (0, q.jsx)(ce, { className: `icon-base` }),
                          label: (0, q.jsx)(h, {
                    ...
                    p.projectCount > 0
                      ? (0, q.jsx)(U, {
                          ...
                          disabled: D,
                          leadingContent: (0, q.jsx)(ue, { className: `icon-base` }),
                          label: (0, q.jsx)(h, {
        ...
        (0, q.jsx)(Oe, {
          ...
          onOpenChange: C,
          onConfirm: (e) => {
            let t = p.customizeItems.filter((t) => w.has(t.id) !== e.has(t.id)).length;
            T(e);
            let n = Kt({ current: b, items: p.customizeItems, selectedItemIds: e });
            (x(n), L({ action: `customized`, changed_items_count: t, ...X(p, n, f) }));
          },
        }),
        (0, q.jsxs)(`div`, {
          className: c(
  ...
  return E
    ? (0, q.jsx)(re, { as: `form`, className: `gap-0`, onSubmit: le, children: H })
    : (0, q.jsx)(`div`, {
        className: `flex w-full max-w-lg flex-col items-center overflow-hidden rounded-2xl p-10`,
        children: H,
      });
...
function Q(e) {
  ...
  if (n === `complete`) {
    ...
    let n;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, q.jsx)(P, { className: `h-5 w-5 text-token-charts-green` })), (t[3] = n))
      : (n = t[3]);
    let i;
    return (
      t[4] === e
