...
import { _ as s, g as c, k as l, m as u, n as d, r as f } from "./vscode-api.js";
import { Vr as p } from "./src-4.js";
import { Ao as m, As as h, Fo as g, us as _ } from "./app-server-manager-signals.js";
import { c as v, n as y, o as b } from "./lib-1.js";
import { t as x } from "./clsx.js";
import { t as S } from "./button.js";
import { t as C } from "./spinner.js";
import { t as w } from "./tooltip.js";
import { a as T, o as E, r as D } from "./config-queries-BHYT-TjG.js";
...
import { n as L, t as R } from "./json-1.js";
...
function Se(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = x(`flex size-12 shrink-0 items-center justify-center rounded-xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
...
function Te(e) {
  ...
  t[31] !== M || t[32] !== O
    ...
    : (P = t[33]);
  let F;
  t[34] !== _ || t[35] !== x || t[36] !== d || t[37] !== i || t[38] !== o
    ? ((F = d
        ? (0, q.jsx)(`div`, {
            className: `mt-4`,
...
function ke(e) {
                ...
                e.tooltip == null
                  ...
                  : (0, q.jsx)(w, {
                      ...
                      children: (0, q.jsx)(`button`, {
                        ...
                        children: (0, q.jsx)(I, { className: `size-4`, "aria-hidden": `true` }),
                      }),
                    }),
                (0, q.jsx)(`div`, {
  ...
  return (
    t[20] !== p || t[21] !== _
      ? ((y = (0, q.jsxs)(`div`, { className: `flex flex-col gap-4 p-4`, children: [u, d, p, _] })),
        (t[20] = p),
        (t[21] = _),
        (t[22] = y))
      : (y = t[22]),
...
async function Ne({ hostId: e, projectRoots: t }) {
  ...
  let n = await d(`paths-exist`, { params: { hostId: e, paths: t } }),
  ...
  let t = (
    await Promise.allSettled(
      [...e]
        ...
        .map(
          async (e) => (
            await d(`add-workspace-root-option`, { params: { root: e, setActive: !1 } }),
            e
          ),
        ),
    )
...
function Fe(e = _) {
  return h(`refresh-recent-conversations-for-host`, { hostId: e });
}
async function Ie(e) {
  try {
    await e();
...
async function Ge({ hostId: e, includeHome: t, workspaceRoots: n }) {
  ...
  return d(`external-agent-import-detect`, {
    params: {
      hostId: e,
      includeHome: t,
      providers: Ue,
...
async function Ke({ hostId: e, items: t }) {
  return t.length === 0
    ? { projectRoots: [] }
    : d(`external-agent-import-import`, { params: { hostId: e, items: t } });
}
async function qe(e) {
  await Promise.all([
    ...
    e.invalidateQueries({ queryKey: f(`local-custom-agents`) }),
    e.invalidateQueries({ queryKey: f(`external-agent-import-status`) }),
    e.invalidateQueries({ queryKey: f(`external-agent-imported-connectors`) }),
  ]);
}
function Je({ items: e, surface: t }) {
  u.info(`external_agent_import_user_flow_started`, { safe: { surface: t, ...Ze(e) } });
}
function Ye({
  durationMs: e,
  error: t,
  ...
  if (a === `success`) {
    u.info(`external_agent_import_user_flow_finished`, { safe: s });
    return;
  }
  u.warning(`external_agent_import_user_flow_finished`, { safe: s, sensitive: { error: t } });
}
function Xe(e) {
  switch (e) {
    case `import`:
...
function et(e) {
  ...
  let l;
  t[3] !== a || t[4] !== i
    ? ((l = () => Ge({ hostId: a, includeHome: !0, workspaceRoots: i })),
      (t[3] = a),
      (t[4] = i),
      (t[5] = l))
    : (l = t[5]);
  let u;
  t[6] !== n || t[7] !== o || t[8] !== l
    ? ((u = { queryKey: o, staleTime: 0, enabled: n, queryFn: l }),
      (t[6] = n),
      (t[7] = o),
      (t[8] = l),
      (t[9] = u))
  ...
  let d = s(u),
    ...
    m;
  t[10] === f ? (m = t[11]) : ((m = f.filter(nt)), (t[10] = f), (t[11] = m));
  let h = m,
    g;
  t[12] === f ? (g = t[13]) : ((g = f.filter(tt)), (t[12] = f), (t[13] = g));
  let v = g,
    y;
  t[14] !== h || t[15] !== v
    ? ((y = Le({ homeItems: h, projectItems: v })), (t[14] = h), (t[15] = v), (t[16] = y))
    : (y = t[16]);
  let b = y,
    x;
...
function at(e) {
  let t = (0, J.c)(31),
    ...
    u = a(j),
    d;
  t[0] === n ? (d = t[1]) : ((d = { enabled: n }), (t[0] = n), (t[1] = d));
  let {
      detectedItems: p,
      getSelectedItems: m,
  ...
  bb0: {
    ...
    let e;
    (t[4] !== p || t[5] !== s || t[6] !== C
      ? ((e = Y({ detectedItems: p, intl: s, providerIds: C })),
        (t[4] = p),
        (t[5] = s),
        (t[6] = C),
        (t[7] = e))
  ...
  let T = w,
    ...
    M;
  t[8] !== p || t[9] !== s
    ? ((M = (e) => Y({ detectedItems: p, intl: s, providerIds: e })),
      (t[8] = p),
      (t[9] = s),
      (t[10] = M))
    : (M = t[10]);
  ...
  t[21] !== T
    ? ((N = async (e, t) => {
        ...
        let i = t == null ? T : Y({ detectedItems: p, intl: s, providerIds: t }),
          a = t == null ? m(e) : lt({ detectedItems: p, providerIds: t, selection: e }),
          o = Date.now(),
          l = `import`,
          d = 0;
        Je({ items: a, surface: `first_time_onboarding` });
        let v = i?.chatChoiceKey != null && e[i.chatChoiceKey];
        try {
          l = `import`;
          let { projectRoots: n } = t == null ? await y(e) : await g(a);
          ((d = n.length),
            ...
            await je({
              ...
              invalidateWorkspaceRootQueries: async () => {
                await Promise.all([
                  c.invalidateQueries({ queryKey: f(`workspace-root-options`) }),
                  c.invalidateQueries({ queryKey: f(`active-workspace-roots`) }),
                ]);
              },
              refreshRecentConversations: v ? ot : void 0,
            }),
            (l = `invalidate_queries`),
            await Promise.all([
              c.invalidateQueries({ queryKey: f(`codex-agents-md`) }),
              c.invalidateQueries({ queryKey: B }),
            ]),
            Ye({
              durationMs: Date.now() - o,
              items: a,
              projectRootsReturnedCount: d,
              status: `success`,
...
function ot() {
  return h(`refresh-recent-conversations-for-host`, { hostId: _, sortKey: O });
}
  ...
  try {
    return (
      ct(
        (
          await e.fetchQuery({
            queryKey: We({ hostId: _ }),
            queryFn: () => Ge({ hostId: _, includeHome: !0 }),
            staleTime: 0,
          })
        ).items,
      ).length > 0
...
function Rt({
  ...
  let g = v(),
    [_, y] = (0, K.useState)(() => ft(d)),
    [C, w] = (0, K.useState)(!1),
    [T, E] = (0, K.useState)(() => new Set(d.customizeItems.map((e) => e.id))),
    D = c === `dialog`,
    O = i || r,
    k = i || r,
    A = Gt({ summary: d, selection: _ }),
    j = Wt({ items: d.customizeItems, selection: _, group: `toolsAndSetup` }),
    M = Wt({ items: d.customizeItems, selection: _, group: `projects` }),
    N = d.chatChoiceKey != null && (_[d.chatChoiceKey] ?? !1),
  ...
  (0, K.useEffect)(() => {
    a && L({ action: `shown`, ...X(d, _, u) });
  }, []);
  let R = () => {
      (f?.(), w(!0));
    },
    z = () => {
      i || !A || (r || L({ action: `continue`, ...X(d, _, u) }), p(_));
    },
    ie = () => {
      O || (L({ action: `skipped`, ...X(d, _, u) }), h());
    },
    B = i
      ? (0, q.jsx)(b, {
    ...
    H = (0, q.jsxs)(q.Fragment, {
      children: [
        ...
        (0, q.jsxs)(`div`, {
          className: x(`flex w-full flex-col`, D ? `mt-4` : `mt-8 max-w-sm`),
          children: [
            Ut(d)
              ? (0, q.jsxs)(fe, {
        ...
        (0, q.jsx)(Oe, {
          ...
          onConfirm: (e) => {
            ...
            E(e);
            let n = Kt({ current: _, items: d.customizeItems, selectedItemIds: e });
            (y(n), L({ action: `customized`, changedItemsCount: t, ...X(d, n, u) }));
          },
        }),
        (0, q.jsxs)(`div`, {
          className: x(
...
function Q(e) {
  ...
  let a;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, q.jsx)(C, { className: `h-5 w-5` })), (t[8] = a))
    : (a = t[8]);
  let o;
  return (
    t[9] === i
...
function $(e) {
  let t = (0, J.c)(6),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, q.jsx)(I, { className: `size-4`, "aria-hidden": `true` })), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === n
    ? (a = t[2])
