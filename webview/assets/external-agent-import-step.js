...
import { ds as s, js as c } from "./app-server-manager-signals.js";
import { _ as l, g as u, k as d, m as f, n as p, r as m } from "./vscode-api.js";
import { Pr as h } from "./src-1.js";
import { c as g, n as _, o as v } from "./lib.js";
...
import { A as C, F as w } from "./rpc-1.js";
import { a as T, o as E, r as D } from "./config-queries.js";
import { M as O, a as k, h as A, r as j } from "./sidebar-signals.js";
import { t as M } from "./check-circle-filled.js";
import { t as N } from "./apps.js";
import { t as P } from "./info.js";
import { t as F } from "./use-plugins.js";
import { t as I } from "./terminal-C.js";
import { n as L, t as R } from "./json.js";
...
import { t as B } from "./use-skills-J.js";
...
function Ae(e) {
  ...
  switch (n) {
    case `instructions`: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(L, { className: `icon-base` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
    ...
    case `plugins`: {
      ...
      return (
        t[3] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(N, { className: `icon-base` })), (t[3] = e))
          : (e = t[3]),
        e
      );
    }
    ...
    case `commands`: {
      ...
      return (
        t[7] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(I, { className: `icon-base` })), (t[7] = e))
          : (e = t[7]),
        e
      );
    }
...
async function Me({
  ...
  try {
    ...
    return (
      f.warning(`Failed to add imported project roots after import`, {
        safe: { hostId: e },
        sensitive: { error: t },
      }),
      []
...
async function Ne({ hostId: e, projectRoots: t }) {
  ...
  let n = await p(`paths-exist`, { params: { hostId: e, paths: t } }),
...
async function Pe(e) {
  let t = (
    await Promise.allSettled(
      [...e]
        ...
        .map(
          async (e) => (
            await p(`add-workspace-root-option`, { params: { root: e, setActive: !1 } }),
            e
          ),
        ),
    )
  ...
  t.length > 0 &&
    f.warning(`Failed to add some imported project roots after import`, {
      safe: { failedRootCount: t.length, totalRootCount: e.length },
      sensitive: { errors: t.map((e) => e.reason) },
    });
}
function Fe(e = s) {
  return c(`refresh-recent-conversations-for-host`, { hostId: e });
}
async function Ie(e) {
  try {
    await e();
  } catch (e) {
    f.warning(`Failed to refresh recent conversations after import`, {
      safe: {},
      sensitive: { error: e },
    });
  }
...
async function Ge({ hostId: e, includeHome: t, workspaceRoots: n }) {
  ...
  return p(`external-agent-import-detect`, {
    params: {
      hostId: e,
      includeHome: t,
      providers: Ue,
...
async function Ke({ hostId: e, items: t }) {
  return t.length === 0
    ? { projectRoots: [] }
    : p(`external-agent-import-import`, { params: { hostId: e, items: t } });
}
async function qe(e) {
  await Promise.all([
...
function Je({ items: e, surface: t }) {
  f.info(`external_agent_import_user_flow_started`, { safe: { surface: t, ...Ze(e) } });
}
function Ye({
  durationMs: e,
  error: t,
  ...
  if (a === `success`) {
    f.info(`external_agent_import_user_flow_finished`, { safe: s });
    return;
  }
  f.warning(`external_agent_import_user_flow_finished`, { safe: s, sensitive: { error: t } });
}
function Xe(e) {
  switch (e) {
    case `import`:
...
function et(e) {
  ...
  let c;
  t[3] !== a || t[4] !== i
    ? ((c = () => Ge({ hostId: a, includeHome: !0, workspaceRoots: i })),
      (t[3] = a),
      (t[4] = i),
      (t[5] = c))
    : (c = t[5]);
  let d;
  t[6] !== n || t[7] !== o || t[8] !== c
    ? ((d = { queryKey: o, staleTime: 0, enabled: n, queryFn: c }),
      (t[6] = n),
      (t[7] = o),
      (t[8] = c),
      (t[9] = d))
  ...
  let f = l(d),
    p = f.data?.items ?? Qe,
    m = f.data?.unsupportedProjects ?? $e,
    h;
  t[10] === p ? (h = t[11]) : ((h = p.filter(nt)), (t[10] = p), (t[11] = h));
  let g = h,
    _;
  t[12] === p ? (_ = t[13]) : ((_ = p.filter(tt)), (t[12] = p), (t[13] = _));
  let v = _,
    y;
  t[14] !== g || t[15] !== v
  ...
  t[26] === f
    ? (j = t[27])
    : ((j = async () => (await f.refetch()).data?.items ?? Qe), (t[26] = f), (t[27] = j));
  let M;
  return (
    t[28] !== S ||
    t[29] !== p ||
...
function at(e) {
  ...
  let {
    ...
    S;
  t[2] === p ? (S = t[3]) : ((S = ct(p)), (t[2] = p), (t[3] = S));
  let C = S,
    w;
  bb0: {
    if (!n) {
    ...
    let e;
    (t[4] !== p || t[5] !== c || t[6] !== C
      ? ((e = Y({ detectedItems: p, intl: c, providerIds: C })),
        (t[4] = p),
        (t[5] = c),
        (t[6] = C),
        (t[7] = e))
  ...
  let T = w,
    ...
    M;
  t[8] !== p || t[9] !== c
    ? ((M = (e) => Y({ detectedItems: p, intl: c, providerIds: e })),
      (t[8] = p),
      (t[9] = c),
      (t[10] = M))
    : (M = t[10]);
  ...
  t[21] !== T
    ? ((N = async (e, t) => {
        ...
        let i = t == null ? T : Y({ detectedItems: p, intl: c, providerIds: t }),
          a = t == null ? h(e) : lt({ detectedItems: p, providerIds: t, selection: e }),
          o = Date.now(),
          d = `import`,
          f = 0;
          ...
          ((f = n.length),
            ...
            await je({
              ...
              onImportedProjectRootsReady: (e) => {
                A(r, k({ collapsedGroups: u, importedProjectRoots: e }));
              },
              projectRoots: n,
              invalidateWorkspaceRootQueries: async () => {
                await Promise.all([
                  l.invalidateQueries({ queryKey: m(`workspace-root-options`) }),
                  l.invalidateQueries({ queryKey: m(`active-workspace-roots`) }),
                ]);
              },
            ...
            (d = `invalidate_queries`),
            await Promise.all([
              l.invalidateQueries({ queryKey: m(`codex-agents-md`) }),
...
function ot() {
  return c(`refresh-recent-conversations-for-host`, { hostId: s, sortKey: O });
}
  ...
  try {
    return (
      ct(
        (
          await e.fetchQuery({
            queryKey: We({ hostId: s }),
            queryFn: () => Ge({ hostId: s, includeHome: !0 }),
            staleTime: 0,
          })
        ).items,
      ).length > 0
...
function Q(e) {
  ...
  if (n === `complete`) {
    ...
    let n;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, q.jsx)(M, { className: `h-5 w-5 text-token-charts-green` })), (t[3] = n))
      : (n = t[3]);
    let i;
    return (
      t[4] === e
