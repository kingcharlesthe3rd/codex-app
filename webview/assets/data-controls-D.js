...
import { Ps as o, T as s, Ui as c, ds as l, js as u } from "./app-server-manager-signals.js";
import { _ as d, c as f, g as p, k as m, u as h } from "./vscode-api.js";
import "./isEqual.js";
import { Ar as g } from "./src-1.js";
import "./react-dom.js";
import { c as _, o as v, r as y } from "./lib.js";
...
import { t as x } from "./check-md.js";
...
import "./chevron.js";
import { m as T } from "./chunk-109.js";
import { t as E } from "./fuse.js";
import "./_baseEach-BPh-9Ri0.js";
import "./_baseOrderBy.js";
import "./x.js";
import "./with-window.js";
import { t as D } from "./folder.js";
import { a as O, i as k, l as A, n as j, r as M } from "./dialog-layout.js";
import "./_defineProperty.js";
import "./initial-route-atom.js";
import { t as N } from "./use-navigate-to-local-conversation.js";
import "./links.js";
import { t as P } from "./folders.js";
import { t as F } from "./search.js";
import { r as I, t as L } from "./dropdown.js";
import "./three-dots.js";
import { t as R } from "./trash.js";
import { t as z } from "./cloud.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as B } from "./settings-host-context.js";
import { t as V } from "./get-project-name.js";
import { i as H, t as U } from "./settings-shared.js";
import { t as ee } from "./settings-content-layout.js";
import { t as W } from "./more-menu-trigger.js";
import { n as te } from "./settings-row.js";
import { n as ne, t as re } from "./settings-group.js";
import { t as ie } from "./infinite-scroll-pagination-spinner.js";
import { t as ae } from "./filter.js";
import { t as oe } from "./control-group.js";
var G = r(),
  se = e(t(), 1),
  K = y({
    delete: {
...
function ce({ cloudTasks: e, localThreads: t }) {
  return [
    ...(e ?? []).map((e) => {
      ...
      return {
        kind: `cloud`,
        createdAt: q(e.created_at, e.updated_at),
        projectId: r == null ? null : n,
        projectLabel: r,
        searchValues: [t, r ?? ``, n],
        task: e,
        title: t,
        updatedAt: q(e.updated_at, e.created_at),
      };
    }),
    ...(t ?? []).map((e) => {
      let t = c(e.name?.trim() || e.preview).trim(),
        n = V(e.cwd),
        r = V(e.path),
        i = n ?? r;
      return {
        kind: `local`,
        createdAt: q(e.createdAt, e.updatedAt),
        projectId: n == null ? (r == null ? null : e.path) : e.cwd,
        projectLabel: i,
        searchValues: [t, i ?? ``],
        thread: e,
        title: t,
        updatedAt: q(e.updatedAt, e.createdAt),
      };
    }),
  ].sort((e, t) => t.updatedAt - e.updatedAt);
}
function le(e) {
  let t = new E(e, { ignoreLocation: !0, keys: [`searchValues`], threshold: 0.4 });
  return (n) => {
    let r = n.trim();
    return r.length === 0 ? e : t.search(r).map(({ item: e }) => e);
  };
}
function ue({ entries: e, groupKey: t, kindFilter: n, searchQuery: r, sortKey: i }) {
  let a = le(e.filter((e) => n === `all` || e.kind === n))(r);
  if (t === `none`)
    return a.length === 0
      ? []
      : [{ id: `all`, projectLabel: null, entries: [...a].sort((e, t) => Y(e, t, i)) }];
  let o = new Map();
  for (let e of a) {
    let t = e.projectId ?? ``,
      n = o.get(t);
    ...
    o.set(t, { id: t, projectLabel: e.projectLabel, entries: [e] });
  }
  let s = [...o.values()];
  for (let e of s) e.entries.sort((e, t) => Y(e, t, i));
  return s.sort((e, t) => {
    if (i === `alphabetical`) {
...
function fe(e, t) {
  let n = 0;
  for (let r of e.entries) n = Math.max(n, J(r, t));
  return n;
}
var X = n();
function Z(e) {
  ...
  t[0] === n.id
    ...
    : ((d = [`recover-cloud-task`, n.id]),
      (f = () =>
        C.safePost(`/wham/tasks/{task_id}/recover`, { parameters: { path: { task_id: n.id } } })),
      (t[0] = n.id),
      (t[1] = d),
      (t[2] = f));
  let h;
  t[3] !== l || t[4] !== o
    ? ((h = () => {
        o.get(w).danger(l.formatMessage(K.unarchiveError));
      }),
      (t[3] = l),
      (t[4] = o),
      (t[5] = h))
    ...
    ? ((g = () => {
        (s.setQueryData([`tasks`, `archived`], (e) =>
          ...
          o.get(w).info(
            (0, X.jsxs)(`span`, {
              children: [
                (0, X.jsx)(v, { ...K.unarchiveSuccessPlain }),
                (0, X.jsx)(`button`, {
  ...
  t[11] === s
    ...
    : ((y = () => {
      ...
      (t[12] = y));
  let x;
  t[13] !== d || t[14] !== f || t[15] !== h || t[16] !== g || t[17] !== y
    ? ((x = { mutationKey: d, mutationFn: f, onError: h, onSuccess: g, onSettled: y }),
      (t[13] = d),
      (t[14] = f),
      (t[15] = h),
      (t[16] = g),
  ...
  let S = p(x),
    E;
  t[19] === n.title ? (E = t[20]) : ((E = c(n.title ?? ``).trim()), (t[19] = n.title), (t[20] = E));
  let D = E,
    O,
    k,
    A,
  ...
  if (t[21] !== n || t[22] !== l || t[23] !== r) {
    ...
    (t[28] !== n.task_status_display?.environment_label || t[29] !== r
      ...
      (k = i),
      (A = e != null),
      (O = A ? l.formatDate(e, { year: `numeric`, month: `short`, day: `numeric` }) : ``),
      (j = A ? l.formatTime(e, { hour: `numeric`, minute: `2-digit` }) : ``),
      (t[21] = n),
      (t[22] = l),
      (t[23] = r),
      (t[24] = O),
      ...
      (t[26] = A),
      (t[27] = j));
  } else ((O = t[24]), (k = t[25]), (A = t[26]), (j = t[27]));
  let M = j,
    N;
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, X.jsx)(z, { className: `icon-sm shrink-0` })), (t[31] = N))
    : (N = t[31]);
  let P;
  t[32] === D
    ? (P = t[33])
  ...
  t[34] === P
    ...
    : ((F = (0, X.jsxs)(`div`, {
        ...
        children: [N, (0, X.jsx)(`span`, { className: `truncate`, children: P })],
      })),
      (t[34] = P),
      (t[35] = F));
  let I;
  t[36] !== O || t[37] !== k || t[38] !== A || t[39] !== M
    ? ((I = A
        ? k
          ? (0, X.jsx)(v, {
  ...
  t[46] === S
    ? (B = t[47])
    : ((B = () => {
        S.isPending || S.mutate();
      }),
      (t[46] = S),
      (t[47] = B));
  let V;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, X.jsx)(v, { ...K.unarchive })), (t[48] = V))
    : (V = t[48]);
  let H;
  t[49] !== B || t[50] !== S.isPending
    ? ((H = (0, X.jsx)(b, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
async function ye(e) {
  try {
    return await C.safeGet(`/wham/tasks/list`, {
      parameters: { query: { limit: 20, cursor: e, task_filter: `archived` } },
    });
  } catch (e) {
    if (e instanceof f && (e.status === 401 || e.status === 403 || e.status === 404))
...
function $() {
  ...
  e[0] === t
    ...
    : ((n = {
        ...
        queryFn: () => u(`list-archived-threads`, { hostId: t }),
        enabled: !0,
        staleTime: h.FIVE_SECONDS,
      }),
      (e[0] = t),
      (e[1] = n));
  let { data: r, isLoading: i, isError: a } = d(n),
    {
      data: o,
      fetchNextPage: s,
      hasNextPage: c,
    ...
    g;
  e[2] !== o || e[3] !== r || e[4] !== t
    ? ((g = ce({ cloudTasks: o, localThreads: t === `local` ? r : [] })),
      (e[2] = o),
      (e[3] = r),
      (e[4] = t),
      (e[5] = g))
...
function be(e) {
  let t = (0, G.c)(118),
    ...
    S = T(),
    C = N(),
    [E, D] = (0, se.useState)(null),
    [O, k] = (0, se.useState)(``),
    [A, j] = (0, se.useState)(`project`),
    [M, P] = (0, se.useState)(`all`),
    [F, I] = (0, se.useState)(`updated`),
    L;
  t[0] !== n || t[1] !== A || t[2] !== M || t[3] !== O || t[4] !== F
    ? ((L = ue({ entries: n, groupKey: A, kindFilter: M, searchQuery: O, sortKey: F })),
      (t[0] = n),
      (t[1] = A),
      (t[2] = M),
      (t[3] = O),
  ...
  let z = L,
    ...
    V;
  t[6] !== n || t[7] !== r
    ? ((V = r === `local` && n.some(we)), (t[6] = n), (t[7] = r), (t[8] = V))
    : (V = t[8]);
  let U = V,
    W;
  t[9] !== r || t[10] !== S || t[11] !== C || t[12] !== h
    ? ((W = (e) => {
        (g(e.id), r === `local` && C(e.id));
      }),
      (t[9] = r),
      (t[10] = S),
      (t[11] = C),
  ...
  t[14] === r
    ? ((oe = t[15]), (ce = t[16]))
    : ((oe = [`unarchive-thread`, r]),
      (ce = async (e) => (
        await u(`unarchive-conversation`, { hostId: r, conversationId: g(e.id) }),
        e
      )),
      (t[14] = r),
      (t[15] = oe),
  ...
  t[17] !== r || t[18] !== y || t[19] !== h
    ? ((le = async (e) => {
        (h
          ...
          await y.cancelQueries({ queryKey: [`archived-threads`, r] }));
        let t = y.getQueryData([`archived-threads`, r]) ?? [];
        return (
          y.setQueryData(
            [`archived-threads`, r],
    ...
    : (le = t[20]);
  let q;
  t[21] !== r || t[22] !== x || t[23] !== y || t[24] !== h
    ? ((q = (e, t, n) => {
        (n?.previousThreads && y.setQueryData([`archived-threads`, r], n.previousThreads),
          h.get(w).danger(x.formatMessage(K.unarchiveError), { id: `unarchive-thread-${t.id}` }));
      }),
      (t[21] = r),
      (t[22] = x),
      (t[23] = y),
    ...
    : (q = t[25]);
  let J;
  t[26] !== r || t[27] !== ae || t[28] !== h
    ? ((J = async (e) => {
        let t = g(e.id),
          n = await u(`hydrate-pinned-threads`, { hostId: r, threadIds: [e.id] }).then(
            () => h.get(s, t),
            Ce,
          );
        h.get(w).info(
  ...
  t[30] !== r || t[31] !== y
    ? ((Y = () => {
        y.invalidateQueries({ queryKey: [`archived-threads`, r] });
      }),
      (t[30] = r),
      (t[31] = y),
      (t[32] = Y))
    : (Y = t[32]);
  let fe;
  t[33] !== oe || t[34] !== ce || t[35] !== le || t[36] !== q || t[37] !== J || t[38] !== Y
    ? ((fe = {
        mutationKey: oe,
        mutationFn: ce,
        onMutate: le,
  ...
  t[40] === r
    ? ((pe = t[41]), (me = t[42]))
    : ((pe = [`delete-archived-conversations`, r]),
      (me = async (e) =>
        e.kind === `all`
          ? u(`delete-all-archived-conversations`, { hostId: r })
          : e.kind === `project`
            ? (
                await Promise.all(
                  e.threadIds.map((e) =>
                    u(`delete-archived-conversation`, { hostId: r, conversationId: g(e) }),
                  ),
                )
              ).flat()
            : u(`delete-archived-conversation`, { hostId: r, conversationId: g(e.thread.id) })),
      (t[40] = r),
      (t[41] = pe),
      (t[42] = me));
  let he;
  t[43] !== r || t[44] !== y || t[45] !== h
    ? ((he = async (e) => {
        ...
        (h
          ...
          .info(
            e.kind === `single`
              ? (0, X.jsx)(v, { ...K.deleting })
              : (0, X.jsx)(v, { ...K.deletingAll }),
            { id: Pe(e), duration: 0, hasCloseButton: !1 },
          ),
          await y.cancelQueries({ queryKey: [`archived-threads`, r] }));
        let n = y.getQueryData([`archived-threads`, r]) ?? [];
        return (
          y.setQueryData(
            [`archived-threads`, r],
    ...
    : (he = t[46]);
  let ge;
  t[47] !== r || t[48] !== x || t[49] !== y || t[50] !== h
    ? ((ge = (e, t, n) => {
        (n?.previousThreads && y.setQueryData([`archived-threads`, r], n.previousThreads),
          h
            .get(w)
            .danger(x.formatMessage(t.kind === `single` ? K.deleteError : K.deleteAllError), {
              id: Pe(t),
            }));
      }),
      (t[47] = r),
  ...
  t[52] !== x || t[53] !== h
    ? ((_e = (e, t) => {
        ...
        h.get(w).success(x.formatMessage(K.deleteSuccessPlain), { id: Pe(t) });
      }),
      (t[52] = x),
      (t[53] = h),
      (t[54] = _e))
  ...
  t[55] !== r || t[56] !== y
    ...
    : (ve = t[57]);
  let ye;
  t[58] !== pe || t[59] !== me || t[60] !== he || t[61] !== ge || t[62] !== _e || t[63] !== ve
    ? ((ye = {
        mutationKey: pe,
        mutationFn: me,
        onMutate: he,
  ...
  if (c) {
    ...
    let e;
    t[68] !== A || t[69] !== M || t[70] !== F
      ? ((e = (0, X.jsx)(`div`, {
          className: `rounded-t-[7px] bg-token-main-surface-primary/95 p-3 backdrop-blur-md`,
          children: (0, X.jsx)(Te, {
            groupKey: A,
            kindFilter: M,
            sortKey: F,
            onGroupKeyChange: j,
            onKindFilterChange: P,
    ...
    t[72] !== B || t[73] !== l || t[74] !== z.length
      ...
      : (n = t[75]);
    let i;
    if (t[76] !== $ || t[77] !== A || t[78] !== r || t[79] !== Z || t[80] !== z) {
      let e;
      (t[82] !== $ || t[83] !== A || t[84] !== r || t[85] !== Z
        ? ((e = (e) =>
            (0, X.jsx)(
              Oe,
              {
                ...
                hostId: r,
                isDeleteDisabled: $,
                projectArchivedThreads: de(e.entries, e.id),
                unarchivingThreadId: Z.variables?.id ?? null,
                isUnarchiving: Z.isPending,
                showHeader: A === `project`,
                onDelete: (e) => {
    ...
    let a;
    t[87] !== B || t[88] !== l || t[89] !== f
      ? ((a = (0, X.jsx)(ie, { hasNextPage: B, isFetchingNextPage: l, onLoadNextPage: f })),
        (t[87] = B),
        (t[88] = l),
        (t[89] = f),
        (t[90] = a))
      : (a = t[90]);
    let o;
    t[91] !== n || t[92] !== i || t[93] !== a
      ? ((o = (0, X.jsx)(`div`, {
          className: `min-h-0 flex-1 overflow-y-auto`,
          children: (0, X.jsxs)(`div`, { className: `flex flex-col`, children: [n, i, a] }),
        })),
        (t[91] = n),
        (t[92] = i),
        (t[93] = a),
    ...
    let s;
    (t[95] !== e || t[96] !== o
      ? ((s = (0, X.jsxs)(ne, { className: `isolate max-h-[min(80vh)]`, children: [e, o] })),
        (t[95] = e),
        (t[96] = o),
        (t[97] = s))
      : (s = t[97]),
  ...
  t[98] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ee = (0, X.jsx)(H, { slug: `data-controls` })), (t[98] = Ee))
    : (Ee = t[98]);
  let De;
  t[99] !== $ || t[100] !== U || t[101] !== d || t[102] !== c
    ? ((De =
        U && !c && !d
          ? (0, X.jsxs)(b, {
              color: `danger`,
              ...
              children: [
                (0, X.jsx)(R, { className: `icon-xs shrink-0` }),
                (0, X.jsx)(v, { ...K.deleteAll }),
              ],
            })
          : null),
      (t[99] = $),
  ...
  t[104] === be
    ...
    : ((ke = (0, X.jsx)(re, {
        className: `gap-2`,
        children: (0, X.jsx)(re.Content, { children: be }),
      })),
      (t[104] = be),
      (t[105] = ke));
  let je;
  t[106] !== n || t[107] !== Q || t[108] !== E
    ? ((je = () => {
        if (E != null) {
          if ((D(null), E.kind === `all`)) {
            Q.mutate({ kind: `all`, threadIds: n.flatMap(Se) });
            return;
          }
          if (E.kind === `project`) {
            Q.mutate({
              ...
              threadIds: E.threads.map(xe),
            });
            return;
          }
          Q.mutate({ kind: `single`, thread: E.thread });
        }
      }),
      (t[106] = n),
      (t[107] = Q),
  ...
  let Ne;
  t[111] !== E || t[112] !== je
    ? ((Ne = (0, X.jsx)(Ae, { state: E, onConfirm: je, onOpenChange: Me })),
      (t[111] = E),
      (t[112] = je),
      (t[113] = Ne))
    : (Ne = t[113]);
...
function Te(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (f = t[0]);
  let p;
  t[1] === l ? (p = t[2]) : ((p = l.formatMessage(Q.searchArchivedChats)), (t[1] = l), (t[2] = p));
  let m;
  t[3] === l ? (m = t[4]) : ((m = l.formatMessage(Q.searchArchivedChats)), (t[3] = l), (t[4] = m));
  let h;
  t[5] === s
    ? (h = t[6])
    : ((h = (e) => {
  ...
  let y;
  t[17] !== n || t[18] !== a
    ? ((y = (0, X.jsx)(De, { groupKey: n, onGroupKeyChange: a })),
      (t[17] = n),
      (t[18] = a),
      (t[19] = y))
    : (y = t[19]);
  let b;
  t[20] !== v || t[21] !== y
    ? ((b = (0, X.jsxs)(oe, { className: `shrink-0`, children: [v, y] })),
      (t[20] = v),
      (t[21] = y),
      (t[22] = b))
    : (b = t[22]);
...
function Ee(e) {
  let t = (0, G.c)(57),
    ...
    o = _(),
    s;
  t[0] === o ? (s = t[1]) : ((s = o.formatMessage(Q.filterArchivedChats)), (t[0] = o), (t[1] = s));
  let c;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, X.jsx)(ae, { className: `icon-xs shrink-0` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === n ? (l = t[4]) : ((l = je(n)), (t[3] = n), (t[4] = l));
  let u;
  t[5] === l
    ? (u = t[6])
    : ((u = (0, X.jsx)(`span`, { className: `truncate`, children: (0, X.jsx)(v, { ...l }) })),
      (t[5] = l),
      (t[6] = u));
  let d;
  t[7] !== s || t[8] !== u
    ? ((d = (0, X.jsxs)(U, { className: `w-[150px] md:w-36`, "aria-label": s, children: [c, u] })),
      (t[7] = s),
      (t[8] = u),
      (t[9] = d))
    : (d = t[9]);
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, X.jsx)(I.SectionLabel, { children: (0, X.jsx)(v, { ...Q.type }) })), (t[10] = f))
    : (f = t[10]);
  let p = n === `all` ? x : void 0,
    m;
  t[11] === i
    ? (m = t[12])
    : ((m = () => {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, X.jsx)(v, { ...Q.allChats })), (t[13] = h))
    : (h = t[13]);
  let g;
  t[14] !== p || t[15] !== m
    ? ((g = (0, X.jsx)(I.Item, { RightIcon: p, onSelect: m, children: h })),
      (t[14] = p),
      (t[15] = m),
      (t[16] = g))
    : (g = t[16]);
  let y = n === `local` ? x : void 0,
    b;
  t[17] === i
    ? (b = t[18])
    : ((b = () => {
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, X.jsx)(v, { ...Q.local })), (t[19] = S))
    : (S = t[19]);
  let C;
  t[20] !== y || t[21] !== b
    ? ((C = (0, X.jsx)(I.Item, { RightIcon: y, onSelect: b, children: S })),
      (t[20] = y),
      (t[21] = b),
      (t[22] = C))
    : (C = t[22]);
  let w = n === `cloud` ? x : void 0,
    T;
  t[23] === i
    ? (T = t[24])
    : ((T = () => {
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, X.jsx)(v, { ...Q.cloud })), (t[25] = E))
    : (E = t[25]);
  let D;
  t[26] !== w || t[27] !== T
    ? ((D = (0, X.jsx)(I.Item, { RightIcon: w, onSelect: T, children: E })),
      (t[26] = w),
      (t[27] = T),
      (t[28] = D))
    : (D = t[28]);
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, X.jsx)(I.Separator, {})), (t[29] = O))
    : (O = t[29]);
  let k;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, X.jsx)(I.SectionLabel, { children: (0, X.jsx)(v, { ...Q.sortBy }) })), (t[30] = k))
    : (k = t[30]);
  let A = r === `updated` ? x : void 0,
    j;
  t[31] === a
    ? (j = t[32])
    : ((j = () => {
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, X.jsx)(v, { ...Q.updated })), (t[33] = M))
    : (M = t[33]);
  let N;
  t[34] !== A || t[35] !== j
    ? ((N = (0, X.jsx)(I.Item, { RightIcon: A, onSelect: j, children: M })),
      (t[34] = A),
      (t[35] = j),
      (t[36] = N))
    : (N = t[36]);
  let P = r === `created` ? x : void 0,
    F;
  t[37] === a
    ? (F = t[38])
    : ((F = () => {
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, X.jsx)(v, { ...Q.created })), (t[39] = R))
    : (R = t[39]);
  let z;
  t[40] !== P || t[41] !== F
    ? ((z = (0, X.jsx)(I.Item, { RightIcon: P, onSelect: F, children: R })),
      (t[40] = P),
      (t[41] = F),
      (t[42] = z))
    : (z = t[42]);
  let B = r === `alphabetical` ? x : void 0,
    V;
  t[43] === a
    ? (V = t[44])
    : ((V = () => {
  ...
  t[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, X.jsx)(v, { ...Q.alphabetical })), (t[45] = H))
    : (H = t[45]);
  let ee;
  t[46] !== B || t[47] !== V
    ? ((ee = (0, X.jsx)(I.Item, { RightIcon: B, onSelect: V, children: H })),
      (t[46] = B),
      (t[47] = V),
      (t[48] = ee))
    : (ee = t[48]);
...
function De(e) {
  let t = (0, G.c)(26),
    { groupKey: n, onGroupKeyChange: r } = e,
    i = _(),
    a;
  t[0] === i ? (a = t[1]) : ((a = i.formatMessage(Q.groupArchivedChats)), (t[0] = i), (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, X.jsx)(P, { className: `icon-xs shrink-0` })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === n ? (s = t[4]) : ((s = Me(n)), (t[3] = n), (t[4] = s));
  let c;
  t[5] === s
    ? (c = t[6])
    : ((c = (0, X.jsx)(`span`, { className: `truncate`, children: (0, X.jsx)(v, { ...s }) })),
      (t[5] = s),
      (t[6] = c));
  let l;
  t[7] !== a || t[8] !== c
    ? ((l = (0, X.jsxs)(U, { className: `w-[150px] md:w-36`, "aria-label": a, children: [o, c] })),
      (t[7] = a),
      (t[8] = c),
      (t[9] = l))
    : (l = t[9]);
  let u = n === `project` ? x : void 0,
    d;
  t[10] === r
    ? (d = t[11])
    : ((d = () => {
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, X.jsx)(v, { ...Q.project })), (t[12] = f))
    : (f = t[12]);
  let p;
  t[13] !== u || t[14] !== d
    ? ((p = (0, X.jsx)(I.Item, { RightIcon: u, onSelect: d, children: f })),
      (t[13] = u),
      (t[14] = d),
      (t[15] = p))
    : (p = t[15]);
  let m = n === `none` ? x : void 0,
    h;
  t[16] === r
    ? (h = t[17])
    : ((h = () => {
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, X.jsx)(v, { ...Q.none })), (t[18] = g))
    : (g = t[18]);
  let y;
  t[19] !== m || t[20] !== h
    ? ((y = (0, X.jsx)(I.Item, { RightIcon: m, onSelect: h, children: g })),
      (t[19] = m),
      (t[20] = h),
      (t[21] = y))
    : (y = t[21]);
...
function Oe(e) {
  ...
  t[7] !== c
    ? ((h = c
        ? (0, X.jsxs)(`div`, {
            className: `sticky top-0 z-10 flex items-center justify-between gap-3 bg-token-main-surface-primary/80 px-4 py-1.5 shadow-sm backdrop-blur-md`,
            children: [
              (0, X.jsxs)(`span`, {
                className: `flex min-w-0 items-center gap-2 text-base text-token-description-foreground`,
                children: [
                  (0, X.jsx)(D, { className: `icon-xs shrink-0` }),
                  (0, X.jsx)(`span`, {
                    className: `truncate`,
                    children:
                      n.projectLabel == null
                  ...
                  m
                    ? (0, X.jsx)(L, {
                        ...
                        children: (0, X.jsx)(I.Item, {
                          ...
                          children: (0, X.jsx)(v, { ...Q.deleteProjectChats }),
                        }),
                      })
                    : null,
                ],
  ...
  if (
    ...
    t[24] !== o
      ? ((e = (e) => {
          switch (e.kind) {
            case `cloud`:
              return (0, X.jsx)(Z, { archivedTask: e.task, showProjectName: !c }, e.task.id);
            case `local`:
              return (0, X.jsx)(
                ke,
                {
  ...
  return (
    t[26] !== h || t[27] !== g
      ? ((y = (0, X.jsxs)(`div`, { className: `flex flex-col`, children: [h, g] })),
        (t[26] = h),
        (t[27] = g),
        (t[28] = y))
      : (y = t[28]),
...
function ke(e) {
  ...
  t[21] === w
    ? (T = t[22])
    : ((T = (0, X.jsx)(`div`, { className: `truncate text-base font-medium`, children: w })),
      (t[21] = w),
      (t[22] = T));
  let E;
  t[23] !== p || t[24] !== m || t[25] !== h || t[26] !== y
    ? ((E = m
        ? h
          ? (0, X.jsx)(v, {
              ...
              values: { date: p, time: y, repo: h },
            })
          : (0, X.jsx)(v, {
              id: `settings.dataControls.archivedChats.dateTime`,
              defaultMessage: `{date}, {time}`,
              description: `Date and time for an archived chat`,
              values: { date: p, time: y },
            })
        : null),
      (t[23] = p),
      (t[24] = m),
    ...
    ? ((k = a
        ? (0, X.jsx)(S, {
            ...
            children: (0, X.jsx)(b, {
              ...
              disabled: r,
              onClick: s,
              children: (0, X.jsx)(R, { className: `icon-xs` }),
            }),
          })
        : null),
      (t[33] = C),
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, X.jsx)(v, { ...K.unarchive })), (t[41] = j))
    : (j = t[41]);
  let M;
...
function Ae(e) {
  ...
  t[8] === s
    ? (l = t[9])
    : ((l = (0, X.jsx)(b, { color: `ghost`, onClick: s, children: c })), (t[8] = s), (t[9] = l));
  let u;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, X.jsx)(v, { ...K.delete })), (t[10] = u))
    : (u = t[10]);
  let d;
  t[11] === r
    ? (d = t[12])
    : ((d = (0, X.jsx)(b, { color: `danger`, onClick: r, children: u })), (t[11] = r), (t[12] = d));
  let f;
  t[13] !== l || t[14] !== d
    ? ((f = (0, X.jsx)(O, { children: (0, X.jsxs)(M, { children: [l, d] }) })),
      (t[13] = l),
      (t[14] = d),
      (t[15] = f))
    : (f = t[15]);
  ...
  return (
    t[20] !== i || t[21] !== p
      ? ((m = (0, X.jsx)(A, { open: !0, showDialogClose: !1, onOpenChange: i, children: p })),
        (t[20] = i),
        (t[21] = p),
        (t[22] = m))
      : (m = t[22]),
...
export { $ as DataControlsSettings };
//# sourceMappingURL=data-controls-D.js.map
