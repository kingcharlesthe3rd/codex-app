...
import { _ as n, u as r } from "./vscode-api.js";
import { o as i } from "./lib-1.js";
...
import { t as u } from "./use-auth.js";
import { t as d } from "./use-debounced-value.js";
...
function y(e) {
  ...
  t[7] === l
    ...
    : ((u = (0, v.jsx)(`span`, {
      ...
      (t[8] = u));
  let d;
  t[9] !== r || t[10] !== i ? ((d = r(i)), (t[9] = r), (t[10] = i), (t[11] = d)) : (d = t[11]);
  let f;
  t[12] === d
    ? (f = t[13])
    : ((f = (0, v.jsx)(`span`, { className: `truncate`, children: d })), (t[12] = d), (t[13] = f));
  let g;
...
function b(e) {
  ...
  let b = d ? f : void 0,
    ...
    E;
  t[8] !== g || t[9] !== d || t[10] !== m
    ? ((E = d ? (0, v.jsx)(s, { className: m }) : (0, v.jsx)(x, { action: g })),
      (t[8] = g),
      (t[9] = d),
      (t[10] = m),
      (t[11] = E))
...
function E(e) {
  let t = (0, _.c)(50),
    ...
    b;
  t[0] === u ? (b = t[1]) : ((b = u.trim()), (t[0] = u), (t[1] = b));
  let x = b.length > 0,
    S;
  t[2] !== c || t[3] !== o
            ...
            `span`,
            {
              ...
              children: [
                ...
                (0, v.jsx)(`button`, {
                  ...
                  children: (0, v.jsx)(f, { "aria-hidden": !0, className: `icon-2xs` }),
                }),
              ],
            },
            e.id,
  ...
  t[27] === m
    ...
    : ((R = (e) => {
      ...
      (t[28] = R));
  let z;
  t[29] !== n || t[30] !== u || t[31] !== R || t[32] !== I || t[33] !== L
    ? ((z = (0, v.jsx)(`input`, {
        ...I,
        "aria-label": n,
...
function j(e) {
  let t = (0, _.c)(23),
    ...
    u =
      a === void 0
        ...
        : a,
    d;
  t[0] !== r || t[1] !== o ? ((d = r(o)), (t[0] = r), (t[1] = o), (t[2] = d)) : (d = t[2]);
  let f;
  ...
  let g;
  t[4] !== d || t[5] !== u
    ? ((g = (0, v.jsxs)(`button`, { type: `button`, className: u, children: [d, f] })),
      (t[4] = d),
      (t[5] = u),
      (t[6] = g))
    : (g = t[6]);
...
function P(e) {
  ...
  t[2] !== i || t[3] !== s
    ...
    : (c = t[4]);
  let f = a === `chatgpt` && i != null && s.length > 0,
    p;
  t[5] !== i || t[6] !== s
    ? ((p = async () => {
        if (i == null) throw Error(`account id is required`);
        return (
          await l.safeGet(`/accounts/{account_id}/users`, {
  ...
  return (
    t[8] !== c || t[9] !== f || t[10] !== p
      ? ((m = { queryKey: c, enabled: f, queryFn: p, staleTime: r.ONE_MINUTE }),
        (t[8] = c),
        (t[9] = f),
        (t[10] = p),
        (t[11] = m))
...
function F(e) {
  ...
  t[5] !== i || t[6] !== s
    ? ((p = async () => {
        if (i == null) throw Error(`account id is required`);
        return (
          await l.safeGet(`/accounts/{account_id}/groups`, {
            parameters: { path: { account_id: i }, query: { limit: 10, offset: 0, query: s } },
          })
        ).items;
      }),
...
//# sourceMappingURL=use-workspace-users-mkxg-j0x.js.map
