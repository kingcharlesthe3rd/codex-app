...
import { n as S, t as C } from "./chunk-11.js";
import { r as w, u as T } from "./chunk-32.js";
import { n as E, t as D } from "./chunk-17.js";
import { n as O, t as k } from "./mermaid-parser.core-2.js";
import { n as A, t as j } from "./chunk-65.js";
import { a as M, n as N, r as P } from "./chunk-132.js";
function F(e) {
  if (!e.length) return [];
  let t = [],
    n = [];
  ...
  (C(),
    ...
    (I = class {
      ...
      addClass(e, t) {
        ...
        (r &&
          r.forEach((e) => {
            (P(e) && (n?.textStyles ? n.textStyles.push(e) : (n.textStyles = [e])),
    ...
    (U = {
      draw: c((e, o, l, u) => {
        ...
        let j = y
          ...
          P = i()
            .size([b, C])
            .paddingTop((e) => (e.children && e.children.length > 0 ? H + V : 0))
            .paddingInner(p)
            ...
            .attr(`style`, (e) =>
              e.depth === 0
                ...
                : `dominant-baseline: middle; font-size: 12px; fill:` +
                  ...
                  M({ cssCompiledStyles: e.data.cssCompiledStyles }).labelStyles.replace(
                    `color:`,
                    `fill:`,
                  ),
            )
        ...
        (R.append(`rect`)
          ...
          .attr(`style`, (e) => M({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles)
          ...
          R.append(`text`)
            ...
            .each(function (e) {
              ...
              let c = parseInt(t.style(`font-size`), 10),
                l = 0.6;
              for (; i.getComputedTextLength() > o && c > 8;) (c--, t.style(`font-size`, `${c}px`));
              ...
              for (
                ...
                d > s &&
                c > 8 &&
                (c--, (u = Math.max(6, Math.min(28, Math.round(c * l)))), !(u < 6 && c === 8));
              )
                (t.style(`font-size`, `${c}px`), (d = c + 2 + u));
              (t.style(`font-size`, `${c}px`),
                (i.getComputedTextLength() > o || c < 8 || s < c) && t.style(`display`, `none`));
            }),
          f.showValues !== !1 &&
            R.append(`text`)
...
export { G as diagram };
//# sourceMappingURL=diagram-8.js.map
