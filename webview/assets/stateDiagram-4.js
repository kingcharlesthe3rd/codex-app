...
import { n as r, t as i } from "./src-1.js";
import { i as a, n as o, r as s } from "./chunk-49.js";
import { A as c, D as l, b as u, c as d, s as f } from "./chunk-87.js";
import { g as p, u as m } from "./chunk-33.js";
import { i as h } from "./chunk-127.js";
import { r as g } from "./chunk-56.js";
import { r as _ } from "./chunk-145.js";
import { n as v, t as y } from "./graphlib-4.js";
import { n as b } from "./chunk-24.js";
import { t as x } from "./chunk-63.js";
import { n as S } from "./chunk-133.js";
import { i as C } from "./chunk-28.js";
import { n as w } from "./chunk-68.js";
import { n as T } from "./chunk-8.js";
import { n as E, t as D } from "./dagre-Bmci-A-I.js";
import { a as O, n as k, r as A, t as j } from "./chunk-113.js";
  ...
  (k(),
    ...
    (F = o((e, t) => {
      let n = o(function (e, t, n) {
        ...
        a = e
          .append(`text`)
          .attr(`x`, u().state.padding)
          .attr(`y`, i + u().state.padding * 0.4 + u().state.dividerMargin + u().state.textHeight)
    ...
    (I = o((e, t, n) => {
      ...
      return (
        e
          ...
          .attr(`width`, d)
          .attr(`height`, p.height + u().state.textHeight + u().state.titleShift + 1)
          .attr(`rx`, `0`),
        c.attr(`x`, f + r),
        ...
        e
          .insert(`rect`, `:first-child`)
          .attr(`x`, f)
          .attr(`y`, u().state.titleShift - u().state.textHeight - u().state.padding)
          .attr(`width`, d)
    ...
    (U = o(function (e, r, i) {
      ...
      if (
        ...
        m.attr(`marker-end`, `url(` + h + `#` + s(j.relationType.DEPENDENCY) + `End)`),
        i.title !== void 0)
      ) {
        ...
        for (let e = 0; e <= s.length; e++) {
          ...
          ((d = Math.max(d, i.width)),
            (m = Math.min(m, i.x)),
            a.info(i.x, n, o + c),
            c === 0 && ((c = r.node().getBBox().height), a.info(`Title height`, c, o)),
            l.push(r));
        }
        let h = c * s.length;
        if (s.length > 1) {
    ...
    (J = o(function (e, t, n, i) {
      ...
      let f = c.select(`[id='${t}']`);
      (q(f), X(i.db.getRootDoc(), f.append(`g`).attr(`id`, t + `-root`), void 0, !1, c, l, i));
      let p = W.padding,
        m = f.node().getBBox(),
        h = m.width + p * 2,
        g = m.height + p * 2;
      (d(f, g, h * 1.75, W.useMaxWidth),
        f.attr(`viewBox`, `${m.x - W.padding}  ${m.y - W.padding} ` + h + ` ` + g));
    }, `draw`)),
    ...
    (X = o((e, t, n, r, i, o, s) => {
      ...
      for (let e of m) {
        ...
        if (a.note) {
          let e = V(t, { descriptions: [], id: a.id + `-note`, note: a.note, type: `note` }, c);
      ...
      c.nodes().forEach(function (e) {
        e !== void 0 && c.node(e) !== void 0
          ? (a.warn(`Node ` + e + `: ` + JSON.stringify(c.node(e))),
            ...
            i.select(`#` + g.id + ` #` + e).attr(`data-x-shift`, c.node(e).x - c.node(e).width / 2),
            o.querySelectorAll(`#` + g.id + ` #` + e + ` .divider`).forEach((e) => {
      ...
      (c.edges().forEach(function (e) {
        e !== void 0 &&
          c.edge(e) !== void 0 &&
          (a.debug(`Edge ` + e.v + ` -> ` + e.w + `: ` + JSON.stringify(c.edge(e))),
...
export { Z as diagram };
//# sourceMappingURL=stateDiagram-4.js.map
