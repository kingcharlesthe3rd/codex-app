...
function $e() {
  ...
  let D = async () => {
    ...
    O = async () => {
      ...
      let e = new AbortController();
      (m(!0), o({ abortController: e, kind: `deviceCode` }));
      try {
        let { verificationUrl: r, userCode: i, completion: a } = await Ge({ signal: e.signal });
        if (e.signal.aborted) return;
        (o((t) => (t?.abortController === e ? { ...t, verificationUrl: r, userCode: i } : t)),
          E({ href: r, initiator: `open_in_browser_bridge`, openTarget: `external-browser` }));
        let s = await a;
        s.success
          ? (t.setAuthMethod(`chatgpt`), n(`/first-run`))
          : T(b(s.error ?? `Unknown error`));
      } catch (e) {
        if (e instanceof Error && e.name === `AbortError`) return;
        T(b(e));
      } finally {
    ...
    { data: A } = L(`show-copilot-login-first`),
    j = async () => {
      (await xe(e, `use-copilot-auth-if-available`, !0),
    ...
    M = async () => {
      ...
      if (!(!e || y)) {
        S(!0);
        try {
          (await ue(`login-with-api-key`, { hostId: Me, apiKey: e }),
    ...
    N =
      !c || !A
        ? (0, K.jsxs)(K.Fragment, {
            children: [
              (0, K.jsx)(et, { isPrimary: !0, handleChatGptSignIn: D, isChatGptSignInPending: s }),
              !s &&
                c &&
                (0, K.jsx)(`div`, {
                  className: `pt-2`,
                  children: (0, K.jsx)(tt, { isPrimary: !1, handleCopilotSignIn: j }),
                }),
            ],
          })
        : (0, K.jsxs)(K.Fragment, {
            children: [
              !s && (0, K.jsx)(tt, { isPrimary: !0, handleCopilotSignIn: j }),
              (0, K.jsx)(`div`, {
                className: `pt-2`,
                children: (0, K.jsx)(et, {
                  isPrimary: !1,
                      ...
                      children: [
                        ...
                        !s &&
                          ...
                          (0, K.jsx)(rt, {
                            ...
                            children: (0, K.jsx)(nt, { handleChatGptDeviceCodeSignIn: O }),
                          }),
                      ],
                    }),
                  }),
...
function it(e) {
  ...
  return (
    t[0] !== i || t[1] !== r || t[2] !== a || t[3] !== o
      ? ((s = (0, K.jsx)(C, { color: a, className: o, onClick: r, children: i })),
        (t[0] = i),
        (t[1] = r),
        (t[2] = a),
        (t[3] = o),
...
function ot(e) {
  ...
  t[16] === g
    ? (v = t[17])
    : ((v = (0, K.jsx)(C, { color: `ghost`, onClick: g, children: _ })), (t[16] = g), (t[17] = v));
  let y;
  t[18] !== n || t[19] !== a
  ...
  t[22] !== c || t[23] !== a || t[24] !== y
    ? ((x = (0, K.jsx)(C, { className: `px-4`, onClick: c, disabled: y, loading: a, children: b })),
      (t[22] = c),
      (t[23] = a),
      (t[24] = y),
      (t[25] = x))
...
function st(e) {
  ne({ event: e, href: ut, initiator: `open_in_browser_bridge` });
}
function ct(e) {
...
function lt(e) {
  ...
  t[11] === l
    ? (v = t[12])
    : ((v = l
        ? (0, K.jsx)(te, { className: `icon-sm text-token-foreground` })
        : (0, K.jsx)(ee, { className: `icon-sm` })),
      (t[11] = l),
      (t[12] = v));
  let y;
  ...
  t[26] === o
    ? (T = t[27])
    : ((T = (0, K.jsx)(C, { color: `ghost`, onClick: o, children: w })), (t[26] = o), (t[27] = T));
  let E = n.length === 0,
    D;
  ...
  let O;
  t[29] !== i || t[30] !== E
    ? ((O = (0, K.jsx)(C, { onClick: i, disabled: E, children: D })),
      (t[29] = i),
      (t[30] = E),
      (t[31] = O))
    : (O = t[31]);
  ...
  return (
    t[35] !== S || t[36] !== k
      ? ((A = (0, K.jsx)(`div`, {
          className: `w-full rounded-2xl border border-token-border bg-token-dropdown-background/80 px-4 py-4 backdrop-blur-lg`,
          children: (0, K.jsxs)(`div`, { className: `space-y-3`, children: [h, S, k] }),
        })),
        (t[35] = S),
        (t[36] = k),
        (t[37] = A))
...
function jt(e) {
  ...
  if (c && !o) {
    let e = v ? `size-10` : `size-[52px]`,
      n;
    t[0] === e ? (n = t[1]) : ((n = N(`shrink-0`, e)), (t[0] = e), (t[1] = n));
    let i;
    t[2] !== r || t[3] !== n
      ? ((i = (0, Z.jsx)(Re, { appBrand: r, className: n })), (t[2] = r), (t[3] = n), (t[4] = i))
      : (i = t[4]);
    let a;
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((a = (0, Z.jsx)(`p`, {
  ...
  t[14] === y
    ? (b = t[15])
    : ((b = N(`flex w-full flex-col items-center`, y)), (t[14] = y), (t[15] = b));
  let x;
  t[16] === _
    ? (x = t[17])
    : ((x = _.formatMessage({
  ...
  let S = !v && `size-[52px]`,
    C;
  t[18] === S ? (C = t[19]) : ((C = N(`shrink-0`, S)), (t[18] = S), (t[19] = C));
  let w;
  t[20] !== r || t[21] !== C
    ? ((w = (0, Z.jsx)(Re, { appBrand: r, className: C })), (t[20] = r), (t[21] = C), (t[22] = w))
    : (w = t[22]);
  let T;
        ...
        : (0, Z.jsxs)(`div`, {
            ...
            children: [
              (0, Z.jsxs)(`button`, {
                ...
                onClick: () => f(),
                children: [
                  (0, Z.jsx)(j, { className: `size-6 shrink-0 text-token-dropdown-background` }),
                  v
                    ? (0, Z.jsx)(V, {
                ...
                ? (0, Z.jsxs)(Z.Fragment, {
                    children: [
                      ...
                      (0, Z.jsxs)(`button`, {
                        ...
                        onClick: () => f(`microsoft`),
                        children: [
                          (0, Z.jsx)(Pe, { className: `size-5 shrink-0`, "aria-hidden": `true` }),
                          (0, Z.jsx)(V, {
...
function Pt() {
  let e = d(r),
    ...
    ee = () => {
      f != null && (z(e, ce, { method: `apikey`, ...f }), w(!0));
    },
    te = () => {
      D(!1);
    },
    ...
    L = async (r = `signin`) => {
      ...
      x(o);
      try {
        let { useDesktopAuth: c, useStreamlinedLoginUx: l } = ht(me(p, _t)),
          u = De(p, `2936610421`),
          d = De(p, `3963726525`),
          { authUrl: m, completion: h } = await qe({
            signal: o.signal,
            ...(u ? { appBrand: re } : {}),
        ...
        _.success
          ? (z(e, ve, { method: i, ...f }),
            a.removeQueries({ queryKey: g(`account-info`), exact: !0 }),
            P(),
            s(!0),
            t.setAuthMethod(`chatgpt`),
            n(`/welcome`, { replace: !0 }))
          : (z(e, R, { method: i, errorKind: Ft(_.error), ...f }),
            v(b(_.error ?? `Unknown error`)));
      } catch (t) {
        if (t instanceof Error && t.name === `AbortError`) {
          z(e, R, { method: i, errorKind: `abort`, ...f });
          return;
        }
        (z(e, R, { method: i, errorKind: Ft(t), ...f }), v(b(t)));
      } finally {
        x(null);
      }
    };
  return f == null
    ? (0, $.jsx)(Be, {
        children: (0, $.jsxs)(`div`, {
          ...
          children: [
            (0, $.jsx)(O, { className: `h-4 w-4 text-token-foreground` }),
            (0, $.jsx)(V, {
          ...
          : (0, $.jsx)(jt, {
              ...
              onApiKeySubmit: async () => {
                ...
                if (!(!r || j || f == null)) {
                  M(!0);
                  try {
                    (await ue(`login-with-api-key`, { hostId: Me, apiKey: r }),
                      z(e, ve, { method: `apikey`, ...f }),
                      P(),
                      s(!0),
                      t.setAuthMethod(`apikey`),
                      n(`/welcome`, { replace: !0 }));
                  } catch (t) {
                    (z(e, R, { method: `apikey`, errorKind: Ft(t), ...f }), v(b(t)));
                  } finally {
                    M(!1);
                  }
                }
              },
              onApiKeyValueChange: A,
              onChatGptSignIn: L,
