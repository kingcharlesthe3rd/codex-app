...
import { f as s, k as c, n as l, r as u } from "./vscode-api.js";
import { i as d } from "./react.js";
import "./isEqual.js";
import { Xt as f } from "./src-4.js";
import { As as p, ha as m, us as h } from "./app-server-manager-signals.js";
import "./react-dom.js";
import { c as g, o as _ } from "./lib-1.js";
import { At as v, Mt as y, kt as b, o as x } from "./persisted-signal.js";
...
import "./rpc-2.js";
import { _ as T, c as E, i as D, l as O, n as k, o as A } from "./statsig-DoZ-0xit.js";
import "./request.js";
import "./platform.js";
...
function q() {
  ...
  let I = async () => {
      if (u) {
        (a?.abortController.abort(), c(null));
        return;
      }
      let e = new AbortController();
      c({ abortController: e, kind: `browserRedirect` });
      try {
        let { authUrl: r, completion: i } = await ie({ signal: e.signal });
        r && s.dispatchMessage(`open-in-browser`, { url: r });
        let a = await i;
        a.success
          ? (t.setAuthMethod(`chatgpt`), n(`/first-run`))
          : P(f(a.error ?? `Unknown error`));
      } catch (e) {
    ...
    te = async () => {
      ...
      let e = new AbortController();
      (x(!0), c({ abortController: e, kind: `deviceCode` }));
      try {
        let { verificationUrl: r, userCode: i, completion: a } = await H({ signal: e.signal });
        if (e.signal.aborted) return;
        (c((t) => (t?.abortController === e ? { ...t, verificationUrl: r, userCode: i } : t)),
          s.dispatchMessage(`open-in-browser`, { url: r }));
        let o = await a;
        o.success
          ? (t.setAuthMethod(`chatgpt`), n(`/first-run`))
          : P(f(o.error ?? `Unknown error`));
      } catch (e) {
        if (e instanceof Error && e.name === `AbortError`) return;
        P(f(e));
      } finally {
    ...
    z = async () => {
      ...
      if (!(!e || E)) {
        D(!0);
        try {
          (await p(`login-with-api-key`, { hostId: h, apiKey: e }),
    ...
    B =
      !d || !re
        ? (0, K.jsxs)(K.Fragment, {
            children: [
              (0, K.jsx)(Y, { isPrimary: !0, handleChatGptSignIn: I, isChatGptSignInPending: u }),
              !u &&
                d &&
                (0, K.jsx)(`div`, {
                  className: `pt-2`,
        ...
        : (0, K.jsxs)(K.Fragment, {
            children: [
              !u && (0, K.jsx)(X, { isPrimary: !0, handleCopilotSignIn: L }),
              (0, K.jsx)(`div`, {
                className: `pt-2`,
                children: (0, K.jsx)(Y, {
                  isPrimary: !1,
                ...
                V != null &&
                  (0, K.jsx)(he, {
                    ...
                    onOpenBrowser: () => {
                      ...
                      e && s.dispatchMessage(`open-in-browser`, { url: e });
                    },
                    onCopyCode: ne,
                    onCancel: () => {
                      (V.abortController.abort(), c(null));
                    },
                  }),
                !u &&
                  v &&
...
function pe() {
  s.dispatchMessage(`open-in-browser`, { url: `https://platform.openai.com/api-keys` });
}
function me(e) {
...
function Pe() {
  let e = i(o),
    ...
    w = d(I),
    T = d(te),
    A = m == null ? null : { hasPreviouslyCompletedOnboarding: m },
    j = E(),
    ...
    de = async (r = `signin`) => {
      ...
      try {
        let { useDesktopAuth: o, useStreamlinedLoginUx: c } = we(D(j, Se)),
          d = k(j, `3963726525`),
          { authUrl: p, completion: m } = await ie({ signal: a.signal, useStreamlinedLogin: c });
        if (p) {
          let e = xe({
            authUrl: Ae(p, r),
        ...
        h.success
          ? (x(e, y, { method: i, ...A }),
            l.removeQueries({ queryKey: u(`account-info`), exact: !0 }),
            X(),
            S(!0),
            t.setAuthMethod(`chatgpt`),
            n(`/welcome`, { replace: !0 }))
          : (x(e, b, { method: i, errorKind: Fe(h.error), ...A }),
            P(f(h.error ?? `Unknown error`)));
      } catch (t) {
        if (t instanceof Error && t.name === `AbortError`) {
          x(e, b, { method: i, errorKind: `abort`, ...A });
          return;
        }
        (x(e, b, { method: i, errorKind: Fe(t), ...A }), P(f(t)));
      } finally {
        R(null);
      }
    };
          ...
          : (0, K.jsx)(Ne, {
              ...
              onApiKeySubmit: async () => {
                ...
                if (!(!r || q || A == null)) {
                  J(!0);
                  try {
                    (await p(`login-with-api-key`, { hostId: h, apiKey: r }),
                    ...
                    (x(e, b, { method: `apikey`, errorKind: Fe(t), ...A }), P(f(t)));
                  } finally {
                    J(!1);
                  }
                }
