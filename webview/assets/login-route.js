...
import { At as De } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~pull-requests-page~new-~ozr5a6hk.js";
import { vs as Oe, ys as ke } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
import {
  C as Ae,
  S as je,
  j as Me,
...
import { i as Ye, n as Xe, r as Ze, t as Qe } from "./use-ascii-engine-BJ-AIEdX.js";
function $e() {
  let e = o(i),
    t = A(),
    n = ce(),
  ...
  let E = async () => {
    ...
    D = async () => {
      ...
      try {
        ...
        (s((t) => (t?.abortController === e ? { ...t, verificationUrl: r, userCode: i } : t)),
          I({ href: r, initiator: `open_in_browser_bridge`, openTarget: `external-browser` }));
        let o = await a;
        o.success
          ? (t.setAuthMethod(`chatgpt`), n(`/first-run`))
    ...
    N =
      !u || !k
        ? (0, K.jsxs)(K.Fragment, {
            children: [
              (0, K.jsx)(et, { isPrimary: !0, handleChatGptSignIn: E, isChatGptSignInPending: c }),
              !c &&
                u &&
                (0, K.jsx)(`div`, {
                  className: `pt-2`,
...
function it(e) {
  ...
  return (
    t[0] !== i || t[1] !== r || t[2] !== a || t[3] !== o
      ? ((s = (0, K.jsx)(F, { color: a, className: o, onClick: r, children: i })),
        (t[0] = i),
        (t[1] = r),
        (t[2] = a),
        (t[3] = o),
...
function ot(e) {
  ...
  t[16] === g
    ? (v = t[17])
    : ((v = (0, K.jsx)(F, { color: `ghost`, onClick: g, children: _ })), (t[16] = g), (t[17] = v));
  let y;
  t[18] !== n || t[19] !== a
  ...
  t[22] !== c || t[23] !== a || t[24] !== y
    ? ((x = (0, K.jsx)(F, { className: `px-4`, onClick: c, disabled: y, loading: a, children: b })),
      (t[22] = c),
      (t[23] = a),
      (t[24] = y),
      (t[25] = x))
...
function lt(e) {
  ...
  t[26] === o
    ? (T = t[27])
    : ((T = (0, K.jsx)(F, { color: `ghost`, onClick: o, children: w })), (t[26] = o), (t[27] = T));
  let E = n.length === 0,
    D;
  ...
  return (
    t[35] !== C || t[36] !== k
      ? ((A = (0, K.jsx)(`div`, {
          className: `w-full rounded-2xl border border-token-border bg-token-dropdown-background/80 px-4 py-4 backdrop-blur-lg`,
          children: (0, K.jsxs)(`div`, { className: `space-y-3`, children: [h, C, k] }),
        })),
        (t[35] = C),
        (t[36] = k),
        (t[37] = A))
...
function jt(e) {
  ...
  if (o && !i) {
    ...
    let i;
    t[2] !== n || t[3] !== r
      ? ((i = (0, Z.jsx)(Re, { appBrand: n, className: r })), (t[2] = n), (t[3] = r), (t[4] = i))
      : (i = t[4]);
    let a;
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((a = (0, Z.jsx)(`p`, {
  ...
  t[14] === y
    ? (b = t[15])
    : ((b = z(`flex w-full flex-col items-center`, y)), (t[14] = y), (t[15] = b));
  let x;
  t[16] === g
    ? (x = t[17])
    : ((x = g.formatMessage({
  ...
  let S = !_ && `size-[52px]`,
    C;
  t[18] === S ? (C = t[19]) : ((C = z(`shrink-0`, S)), (t[18] = S), (t[19] = C));
  let w;
  t[20] !== n || t[21] !== C
    ? ((w = (0, Z.jsx)(Re, { appBrand: n, className: C })), (t[20] = n), (t[21] = C), (t[22] = w))
    : (w = t[22]);
  let T;
        ...
        : (0, Z.jsxs)(`div`, {
            ...
            children: [
              (0, Z.jsxs)(`button`, {
                ...
                onClick: () => d(),
                children: [
                  (0, Z.jsx)(te, { className: `size-6 shrink-0 text-token-dropdown-background` }),
                  _
                    ? (0, Z.jsx)(U, {
                ...
                ? (0, Z.jsxs)(Z.Fragment, {
                    children: [
                      ...
                      (0, Z.jsxs)(`button`, {
                        ...
                        onClick: () => d(`microsoft`),
                        children: [
                          (0, Z.jsx)(Oe, { className: `size-5 shrink-0`, "aria-hidden": `true` }),
                          (0, Z.jsx)(U, {
              ...
              onApiKeySubmit: async () => {
                ...
                if (!(!r || j || m == null)) {
                  ...
                  try {
                    ...
                    (B(e, V, { method: `apikey`, errorKind: Ft(t), ...m }), v(l(t)));
                  } finally {
                    M(!1);
                  }
                }
