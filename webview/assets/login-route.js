...
import { Fo as Oe, Po as ke } from "./app-initial~app-main~onboarding-page.js";
import { At as Ae, jt as je } from "./app-initial~app-main~automations-page.js";
import {
  Ft as Me,
  It as Ne,
  Lt as Pe,
...
function $e() {
  ...
  ((0, G.useEffect)(() => {
    c && (C.current?.focus(), C.current?.select());
  }, [c]),
    (0, G.useEffect)(() => {
      let e = !1;
      return (
        (async () => {
          try {
            let t = await d(`openai-api-key`);
            if (e) return;
            let n = t?.value ?? null;
            (g(n), v((e) => (e.length > 0 ? e : (n ?? ``))));
          } catch {
            e || g(null);
          }
        })(),
  ...
  let E = async () => {
    ...
    D = async () => {
      ...
      let e = new AbortController();
      (p(!0), a({ abortController: e, kind: `deviceCode` }));
      try {
        let { verificationUrl: r, userCode: i, completion: o } = await Ge({ signal: e.signal });
        if (e.signal.aborted) return;
        (a((t) => (t?.abortController === e ? { ...t, verificationUrl: r, userCode: i } : t)),
          we({ href: r, initiator: `open_in_browser_bridge`, openTarget: `external-browser` }));
        let s = await o;
        s.success
          ? (t.setAuthMethod(`chatgpt`), n(`/first-run`))
          : T(L(s.error ?? `Unknown error`));
      } catch (e) {
        if (e instanceof Error && e.name === `AbortError`) return;
        T(L(e));
      } finally {
    ...
    { data: M } = N(`show-copilot-login-first`),
    P = async () => {
      (await k(e, `use-copilot-auth-if-available`, !0),
    ...
    ee = async () => {
      ...
      if (!(!e || y)) {
        x(!0);
        try {
          (await re(`login-with-api-key`, { hostId: b, apiKey: e }),
    ...
    te =
      !s || !M
        ? (0, K.jsxs)(K.Fragment, {
            children: [
              (0, K.jsx)(et, { isPrimary: !0, handleChatGptSignIn: E, isChatGptSignInPending: o }),
              !o &&
                s &&
                (0, K.jsx)(`div`, {
                  className: `pt-2`,
                  children: (0, K.jsx)(tt, { isPrimary: !1, handleCopilotSignIn: P }),
                }),
            ],
          })
        : (0, K.jsxs)(K.Fragment, {
            children: [
              !o && (0, K.jsx)(tt, { isPrimary: !0, handleCopilotSignIn: P }),
              (0, K.jsx)(`div`, {
                className: `pt-2`,
                children: (0, K.jsx)(et, {
                  isPrimary: !1,
                      ...
                      children: [
                        ...
                        !o &&
                          ...
                          (0, K.jsx)(rt, {
                            ...
                            children: (0, K.jsx)(nt, { handleChatGptDeviceCodeSignIn: D }),
                          }),
                      ],
                    }),
                  }),
...
function it(e) {
  ...
  return (
    t[0] !== i || t[1] !== r || t[2] !== a || t[3] !== o
      ? ((s = (0, K.jsx)(B, { color: a, className: o, onClick: r, children: i })),
        (t[0] = i),
        (t[1] = r),
        (t[2] = a),
        (t[3] = o),
...
function ot(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, K.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, K.jsx)(he, { href: ut, className: `icon-2xs` }),
        ],
      })),
      (t[11] = g))
    : (g = t[11]);
  ...
  t[16] === _
    ? (y = t[17])
    : ((y = (0, K.jsx)(B, { color: `ghost`, onClick: _, children: v })), (t[16] = _), (t[17] = y));
  let b;
  t[18] !== n || t[19] !== a
  ...
  t[22] !== c || t[23] !== a || t[24] !== b
    ? ((C = (0, K.jsx)(B, { className: `px-4`, onClick: c, disabled: b, loading: a, children: x })),
      (t[22] = c),
      (t[23] = a),
      (t[24] = b),
      (t[25] = C))
  ...
  t[26] !== C || t[27] !== y
    ? ((w = (0, K.jsxs)(`div`, {
        ...
        children: [
          g,
          (0, K.jsxs)(`div`, { className: `flex justify-end gap-2`, children: [y, C] }),
        ],
      })),
      (t[26] = C),
      (t[27] = y),
...
function st(e) {
  oe({ event: e, href: ut, initiator: `open_in_browser_bridge` });
}
function ct(e) {
...
function lt(e) {
  ...
  t[11] === l
    ? (y = t[12])
    : ((y = l
        ? (0, K.jsx)(ae, { className: `icon-sm text-token-foreground` })
        : (0, K.jsx)(ce, { className: `icon-sm` })),
      (t[11] = l),
      (t[12] = y));
  let b;
  ...
  t[26] === o
    ? (E = t[27])
    : ((E = (0, K.jsx)(B, { color: `ghost`, onClick: o, children: T })), (t[26] = o), (t[27] = E));
  let D = n.length === 0,
    O;
  ...
  let k;
  t[29] !== i || t[30] !== D
    ? ((k = (0, K.jsx)(B, { onClick: i, disabled: D, children: O })),
      (t[29] = i),
      (t[30] = D),
      (t[31] = k))
    : (k = t[31]);
  ...
  return (
    t[35] !== w || t[36] !== A
      ? ((j = (0, K.jsx)(`div`, {
          className: `w-full rounded-2xl border border-token-border bg-token-dropdown-background/80 px-4 py-4 backdrop-blur-lg`,
          children: (0, K.jsxs)(`div`, { className: `space-y-3`, children: [g, w, A] }),
        })),
        (t[35] = w),
        (t[36] = A),
        (t[37] = j))
...
function jt(e) {
  ...
  if (o && !i) {
    let e = _ ? `size-10` : `size-[52px]`,
      r;
    t[0] === e ? (r = t[1]) : ((r = ge(`shrink-0`, e)), (t[0] = e), (t[1] = r));
    let i;
    t[2] !== n || t[3] !== r
      ? ((i = (0, Z.jsx)(Ve, { appBrand: n, className: r })), (t[2] = n), (t[3] = r), (t[4] = i))
      : (i = t[4]);
    let a;
    t[5] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((a = (0, Z.jsx)(`p`, {
  ...
  t[14] === v
    ? (y = t[15])
    : ((y = ge(`flex w-full flex-col items-center`, v)), (t[14] = v), (t[15] = y));
  let b;
  t[16] === g
    ? (b = t[17])
    : ((b = g.formatMessage({
  ...
  let x = !_ && `size-[52px]`,
    C;
  t[18] === x ? (C = t[19]) : ((C = ge(`shrink-0`, x)), (t[18] = x), (t[19] = C));
  let w;
  t[20] !== n || t[21] !== C
    ? ((w = (0, Z.jsx)(Ve, { appBrand: n, className: C })), (t[20] = n), (t[21] = C), (t[22] = w))
    : (w = t[22]);
  let T;
  t[23] !== f || t[24] !== b || t[25] !== w
    ? ((T = (0, Z.jsx)(`button`, {
  ...
  t[27] !== n || t[28] !== _
    ...
    : (E = t[29]);
  let D;
  t[30] !== y || t[31] !== T || t[32] !== E
    ? ((D = (0, Z.jsxs)(`div`, { className: y, children: [T, E] })),
      (t[30] = y),
      (t[31] = T),
      (t[32] = E),
      (t[33] = D))
        ...
        : (0, Z.jsxs)(`div`, {
            ...
            children: [
              (0, Z.jsxs)(`button`, {
                ...
                onClick: () => u(),
                children: [
                  (0, Z.jsx)(le, { className: `size-6 shrink-0 text-token-dropdown-background` }),
                  _
                    ? (0, Z.jsx)(m, {
                ...
                ? (0, Z.jsxs)(Z.Fragment, {
                    children: [
                      ...
                      (0, Z.jsxs)(`button`, {
                        ...
                        onClick: () => u(`microsoft`),
                        children: [
                          (0, Z.jsx)(ke, { className: `size-5 shrink-0`, "aria-hidden": `true` }),
                          (0, Z.jsx)(m, {
...
var Mt,
  Z,
  Nt = e(() => {
    ((Mt = R()), pe(), y(), E(), At(), Oe(), de(), Be(), We(), (Z = U()));
  });
function Pt() {
  let e = ne(f),
    t = fe(),
    ...
    u = te(ze),
    d = te(Ie),
    h = s == null ? null : { hasPreviouslyCompletedOnboarding: s },
    g = a(),
    _ = gt(ee(vt).get(`enabled`, !1)),
    v = (t) => {
      e.get(H).warning(
        r.formatMessage(
          {
    ...
    se = () => {
      h != null && (T(e, o, { method: `apikey`, ...h }), E(!0));
    },
    ce = () => {
      k(!1);
    },
    ...
    z = async (r = `signin`) => {
      ...
      x(s);
      try {
        let { useDesktopAuth: o, useStreamlinedLoginUx: u } = ht(p(g, _t)),
          d = O(g, `2936610421`),
          f = O(g, `3963726525`),
          { authUrl: m, completion: _ } = await qe({
            signal: s.signal,
            ...(d ? { appBrand: Me } : {}),
        ...
        y.success
          ? (T(e, P, { method: a, ...h }),
            i.removeQueries({ queryKey: c(`account-info`), exact: !0 }),
            ae(),
            l(!0),
            t.setAuthMethod(`chatgpt`),
            n(`/welcome`, { replace: !0 }))
          : (T(e, M, { method: a, errorKind: Ft(y.error), ...h }),
            v(L(y.error ?? `Unknown error`)));
      } catch (t) {
        if (t instanceof Error && t.name === `AbortError`) {
          T(e, M, { method: a, errorKind: `abort`, ...h });
          return;
        }
        (T(e, M, { method: a, errorKind: Ft(t), ...h }), v(L(t)));
      } finally {
        x(null);
      }
    };
    ...
    : (0, $.jsx)(Ae, {
        ...
        children: D
          ? (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(bt, { onExit: ce, audioContextRef: I }),
            })
          : (0, $.jsx)(jt, {
              appBrand: Me,
              apiKeyValue: A,
              ...
              onApiKeySubmit: async () => {
                ...
                if (!(!r || N || h == null)) {
                  F(!0);
                  try {
                    (await re(`login-with-api-key`, { hostId: b, apiKey: r }),
                      T(e, P, { method: `apikey`, ...h }),
                      ae(),
                      l(!0),
                      t.setAuthMethod(`apikey`),
                      n(`/welcome`, { replace: !0 }));
                  } catch (t) {
                    (T(e, M, { method: `apikey`, errorKind: Ft(t), ...h }), v(L(t)));
                  } finally {
                    F(!1);
                  }
                }
              ...
              onChatGptSignIn: z,
              onChatGptSignUp: () => z(`signup`),
              onPlaySnake: le,
              onResetApiKeyEntry: oe,
              onShowApiKeyEntry: se,
            }),
      });
}
function Ft(e) {
