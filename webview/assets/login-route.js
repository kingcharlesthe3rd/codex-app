...
import { h as S } from "./persisted-signal.js";
import "./rpc-2.js";
import { c as C, i as w, n as T, o as E, u as D, v as O } from "./statsig.js";
import "./request.js";
import "./app-server-manager-hooks.js";
import { t as k } from "./use-global-state.js";
import "./invalidate-queries-and-broadcast.js";
import "./thread-context-inputs.js";
import "./config-queries.js";
import "./remote-connection-visibility.js";
import "./sidebar-signals.js";
import { n as A } from "./use-is-copilot-api-available.js";
import { t as j } from "./use-auth.js";
...
import { t as B } from "./codex-app-ga-logo-Ce-JNlBO.js";
...
function oe() {
  ...
  let ee = async () => {
    ...
    { data: L } = k(`show-copilot-login-first`),
    R = async () => {
    ...
    z = async () => {
      ...
      if (!(!e || O)) {
        N(!0);
        try {
          (await a(`login-with-api-key`, { hostId: i, apiKey: e }),
...
function Pe() {
  let e = d(m),
    ...
    ce = () => {
      A != null && (S(e, s, { method: `apikey`, ...A }), ie(!0));
    },
    le = () => {
      U(!1);
    },
    ...
    de = async (i = `signin`) => {
      ...
      if (A == null) return;
      let a = i === `google` || i === `microsoft` ? i : `chatgpt`;
      S(e, s, { method: a, ...A });
      let l = new AbortController();
      R(l);
      try {
        let { useDesktopAuth: s, useStreamlinedLoginUx: u } = Oe(w(N, Ee)),
          d = T(N, `3963726525`),
        ...
        g.success
          ? (S(e, r, { method: a, ...A }),
            ...
            X(),
            E(!0),
            o.setAuthMethod(`chatgpt`),
            c(`/welcome`, { replace: !0 }))
          : (S(e, n, { method: a, errorKind: Fe(g.error), ...A }),
            L(t(g.error ?? `Unknown error`)));
      } catch (r) {
        if (r instanceof Error && r.name === `AbortError`) {
          S(e, n, { method: a, errorKind: `abort`, ...A });
          return;
        }
        (S(e, n, { method: a, errorKind: Fe(r), ...A }), L(t(r)));
      } finally {
        R(null);
      }
    };
          ...
          : (0, q.jsx)(Ne, {
              ...
              onApiKeySubmit: async () => {
                ...
                if (!(!s || oe || A == null)) {
                  J(!0);
                  try {
                    (await a(`login-with-api-key`, { hostId: i, apiKey: s }),
                      S(e, r, { method: `apikey`, ...A }),
                      X(),
                      E(!0),
                      o.setAuthMethod(`apikey`),
                      c(`/welcome`, { replace: !0 }));
                  } catch (r) {
                    (S(e, n, { method: `apikey`, errorKind: Fe(r), ...A }), L(t(r)));
                  } finally {
                    J(!1);
                  }
                }
