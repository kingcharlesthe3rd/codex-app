...
import { Ia as s, Ts as c, zs as l } from "./app-server-manager-signals.js";
import { A as u, f as d, n as f, r as p } from "./vscode-api.js";
import { i as m } from "./react.js";
import "./isEqual.js";
import { mr as h } from "./src-2.js";
import "./react-dom.js";
...
import { Ft as S, Lt as C, Pt as w, t as T } from "./product-logger.js";
import "./format-skill-title.js";
import "./rpc-2.js";
import { _ as E, c as D, i as O, l as k, n as A, o as j } from "./statsig.js";
import "./request.js";
import "./platform.js";
...
import { n as M } from "./use-is-copilot-api-available.js";
import { t as N } from "./use-global-state.js";
import { t as P } from "./use-auth.js";
import "./use-os-info.js";
import "./use-platform.js";
import { t as F } from "./openai-blossom.js";
import { t as I } from "./link-external.js";
import { m as ee } from "./chunk-9.js";
import "./route-scope.js";
import { c as te, l as ne, m as re, s as ie } from "./onboarding-state.js";
import { t as L } from "./copy-to-clipboard.js";
import "./checkbox.js";
import "./minus.js";
import { t as R } from "./copy.js";
import { t as z } from "./codex-app-ga-logo.js";
import { a as B } from "./onboarding-shell-DTxS-cwL.js";
import "./chatgpt-token-auth.browser.js";
import { n as V, r as ae, t as H } from "./onboarding-login-content.js";
import { n as U, t as oe } from "./use-ascii-engine.js";
var W = o(),
  G = e(t(), 1),
  K = n();
function se() {
  ...
  ((0, G.useEffect)(() => {
    v && (k.current?.focus(), k.current?.select());
  }, [v]),
    (0, G.useEffect)(() => {
      let e = !1;
      return (
  ...
  let I = async () => {
      if (p) {
        (o?.abortController.abort(), u(null));
        return;
      }
      let e = new AbortController();
      u({ abortController: e, kind: `browserRedirect` });
      try {
        let { authUrl: r, completion: i } = await ae({ signal: e.signal });
        r && d.dispatchMessage(`open-in-browser`, { url: r });
        let a = await i;
        a.success
          ? (t.setAuthMethod(`chatgpt`), n(`/first-run`))
          : F(h(a.error ?? `Unknown error`));
      } catch (e) {
    ...
    te = async () => {
      ...
      try {
        let { verificationUrl: r, userCode: i, completion: a } = await V({ signal: e.signal });
    ...
    { data: re } = N(`show-copilot-login-first`),
    ie = async () => {
    ...
    R = async () => {
      ...
      if (!(!e || D)) {
        O(!0);
        try {
          (await c(`login-with-api-key`, { hostId: l, apiKey: e }),
    ...
    z =
      !m || !re
        ? (0, K.jsxs)(K.Fragment, {
            children: [
              (0, K.jsx)(J, { isPrimary: !0, handleChatGptSignIn: I, isChatGptSignInPending: p }),
              !p &&
                m &&
                (0, K.jsx)(`div`, {
                  className: `pt-2`,
                  children: (0, K.jsx)(Y, { isPrimary: !1, handleCopilotSignIn: ie }),
                }),
            ],
          })
        : (0, K.jsxs)(K.Fragment, {
            children: [
              !p && (0, K.jsx)(Y, { isPrimary: !0, handleCopilotSignIn: ie }),
              (0, K.jsx)(`div`, {
                className: `pt-2`,
                children: (0, K.jsx)(J, {
                  isPrimary: !1,
                      ...
                      children: [
                        ...
                        !p &&
                          ...
                          (0, K.jsx)(le, {
                            ...
                            children: (0, K.jsx)(ce, { handleChatGptDeviceCodeSignIn: te }),
                          }),
                      ],
                    }),
                  }),
...
var q = G.memo(function () {
  ...
  return (
    e[1] !== n || e[2] !== i || e[3] !== r
      ? ((a = (0, K.jsx)(U, { lines: i, columns: n, rows: r, autoCover: !0 })),
        (e[1] = n),
        (e[2] = i),
        (e[3] = r),
        (e[4] = a))
...
function J(e) {
  ...
  return (
    t[2] !== r || t[3] !== n || t[4] !== a
      ? ((o = (0, K.jsx)(X, { isPrimary: n, onClick: r, children: a })),
        (t[2] = r),
        (t[3] = n),
        (t[4] = a),
        (t[5] = o))
...
function Y(e) {
  ...
  return (
    t[1] !== r || t[2] !== n
      ? ((a = (0, K.jsx)(X, { isPrimary: n, onClick: r, children: i })),
        (t[1] = r),
        (t[2] = n),
        (t[3] = a))
      : (a = t[3]),
...
function ce(e) {
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, K.jsx)(X, { isPrimary: !1, onClick: n, children: r })), (t[1] = n), (t[2] = i)),
    i
  );
}
function le(e) {
...
var ue = `w-full cursor-interaction justify-center !rounded-full border px-4 py-2 font-medium`,
...
function pe(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, K.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, K.jsx)(I, { "aria-hidden": `true`, className: `icon-2xs` }),
        ],
      })),
      (t[11] = h))
    : (h = t[11]);
  ...
  t[16] === y
    ? (x = t[17])
    : ((x = (0, K.jsx)(v, { color: `ghost`, onClick: y, children: b })), (t[16] = y), (t[17] = x));
  let S;
  t[18] !== n || t[19] !== a
  ...
  t[22] !== c || t[23] !== a || t[24] !== S
    ? ((w = (0, K.jsx)(v, { className: `px-4`, onClick: c, disabled: S, loading: a, children: C })),
      (t[22] = c),
      (t[23] = a),
      (t[24] = S),
      (t[25] = w))
  ...
  t[26] !== w || t[27] !== x
    ? ((T = (0, K.jsxs)(`div`, {
        ...
        children: [
          h,
          (0, K.jsxs)(`div`, { className: `flex justify-end gap-2`, children: [x, w] }),
        ],
      })),
      (t[26] = w),
      (t[27] = x),
...
function ge(e) {
  ...
  t[11] === l
    ? (S = t[12])
    : ((S = l
        ? (0, K.jsx)(b, { className: `icon-sm text-token-foreground` })
        : (0, K.jsx)(R, { className: `icon-sm` })),
      (t[11] = l),
      (t[12] = S));
  let C;
  t[13] !== f || t[14] !== x || t[15] !== S
    ? ((C = (0, K.jsx)(`div`, {
  ...
  t[26] === o
    ? (O = t[27])
    : ((O = (0, K.jsx)(v, { color: `ghost`, onClick: o, children: D })), (t[26] = o), (t[27] = O));
  let k = n.length === 0,
    A;
  ...
  let j;
  t[29] !== i || t[30] !== k
    ? ((j = (0, K.jsx)(v, { onClick: i, disabled: k, children: A })),
      (t[29] = i),
      (t[30] = k),
      (t[31] = j))
    : (j = t[31]);
...
function Se({
  ...
  try {
    let a = new URL(e);
    if ((n && t && a.searchParams.set(xe, t), a.pathname === `/codex/desktop-auth`))
...
var Z = 12,
  Q = 18,
  De = 120,
  Oe = { up: { x: 0, y: -1 }, down: { x: 0, y: 1 }, left: { x: -1, y: 0 }, right: { x: 1, y: 0 } },
  ke = { up: `down`, down: `up`, left: `right`, right: `left` };
function Ae(e) {
  let t = (0, W.c)(21),
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = { columns: Z, rows: Z, cellSize: Q, width: Z * Q, height: Z * Q }), (t[2] = p))
    : (p = t[2]);
  let m = (0, G.useRef)(p),
    h = (0, G.useRef)(null),
  ...
  t[12] === A
    ...
    : ((j = () => {
        ...
        let e = a.current.getBoundingClientRect(),
          ...
          r = Math.max(Z, Math.floor(t / Q)),
          i = t / r;
        ((m.current = {
          columns: r,
          rows: Math.max(Z, Math.floor(n / i)),
          cellSize: i,
          width: t,
          height: n,
        }),
    ...
    ? ((N = () => {
        ...
        let e = (e) => {
          ...
          (e.key === `ArrowUp` || e.key === `w` || e.key === `W`
            ...
            t != null && (e.preventDefault(), ke[d.current] !== t && (f.current = t)));
        };
        return (
    ...
    : ((w = (0, K.jsx)(`h1`, {
      ...
      (T = y
        ? (0, K.jsxs)(`div`, {
            ...
            children: [
              (0, K.jsx)(b, { className: `size-3.5 shrink-0`, "aria-hidden": `true` }),
              (0, K.jsx)(_, {
        ...
        : (0, K.jsxs)(`div`, {
            ...
            children: [
              (0, K.jsxs)(`button`, {
                ...
                onClick: () => l(),
                children: [
                  (0, K.jsx)(F, { className: `size-6 shrink-0 text-token-dropdown-background` }),
                  y
                    ? (0, K.jsx)(_, {
                ...
                ? (0, K.jsxs)(K.Fragment, {
                    children: [
                      ...
                      (0, K.jsxs)(`button`, {
                        ...
                        onClick: () => l(`microsoft`),
                        children: [
                          (0, K.jsx)(Ne, { className: `size-5 shrink-0`, "aria-hidden": `true` }),
                          (0, K.jsx)(_, {
...
function Fe() {
  let e = r(a),
    ...
    b = m(te),
    E = m(ne),
    j = f == null ? null : { hasPreviouslyCompletedOnboarding: f },
    M = D(),
    N = Ee(k(we).get(`enabled`, !1)),
    F = (t) => {
      e.get(x).warning(
        o.formatMessage(
          {
    ...
    le = () => {
      j != null && (T(e, S, { method: `apikey`, ...j }), V(!0));
    },
    ue = () => {
      U(!1);
    },
    ...
    fe = async (r = `signin`) => {
      ...
      L(a);
      try {
        let { useDesktopAuth: o, useStreamlinedLoginUx: c } = Te(O(M, Ce)),
          l = A(M, `3963726525`),
          { authUrl: u, completion: f } = await ae({ signal: a.signal, useStreamlinedLogin: c });
        if (u) {
          let e = Se({
            authUrl: je(u, r),
        ...
        m.success
          ? (T(e, C, { method: i, ...j }),
            ...
            n(`/welcome`, { replace: !0 }))
          : (T(e, w, { method: i, errorKind: $(m.error), ...j }), F(h(m.error ?? `Unknown error`)));
      } catch (t) {
        if (t instanceof Error && t.name === `AbortError`) {
          T(e, w, { method: i, errorKind: `abort`, ...j });
          return;
        }
        (T(e, w, { method: i, errorKind: $(t), ...j }), F(h(t)));
      } finally {
        L(null);
      }
    };
  return j == null
    ? (0, K.jsx)(B, {
        children: (0, K.jsxs)(`div`, {
          ...
          children: [
            (0, K.jsx)(y, { className: `h-4 w-4 text-token-foreground` }),
            (0, K.jsx)(_, {
    ...
    : (0, K.jsx)(B, {
        ...
        children: H
          ? (0, K.jsx)(`div`, {
              ...
              children: (0, K.jsx)(Ae, { onExit: ue, audioContextRef: J }),
            })
          : (0, K.jsx)(Pe, {
              apiKeyValue: oe,
              isApiKeyEntryVisible: z,
              isApiKeySignInPending: se,
              isChatGptSignInPending: R,
              showChatGptProviderSignIn: N,
              onApiKeySubmit: async () => {
                let r = oe.trim();
                if (!(!r || se || j == null)) {
                  q(!0);
                  try {
                    (await c(`login-with-api-key`, { hostId: l, apiKey: r }),
                      T(e, C, { method: `apikey`, ...j }),
                      Y(),
                      v(!0),
                      t.setAuthMethod(`apikey`),
                      n(`/welcome`, { replace: !0 }));
                  } catch (t) {
                    (T(e, w, { method: `apikey`, errorKind: $(t), ...j }), F(h(t)));
                  } finally {
                    q(!1);
                  }
                }
              ...
              onChatGptSignIn: fe,
              onChatGptSignUp: () => fe(`signup`),
              onPlaySnake: X,
              onResetApiKeyEntry: ce,
              onShowApiKeyEntry: le,
            }),
      });
}
function $(e) {
