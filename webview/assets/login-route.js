...
import { Li as n, Xs as r, po as i, tc as a } from "./app-server-manager-signals.js";
...
import { t as y } from "./product-logger.js";
import "./rpc.js";
import { c as b, i as x, n as S, o as C, u as w, v as T } from "./statsig.js";
import "./request.js";
...
import { n as te, r as ne, t as H } from "./onboarding-login-content.js";
...
function re() {
  ...
  let L = async () => {
    ...
    R = async () => {
      ...
      try {
        let { verificationUrl: n, userCode: r, completion: i } = await te({ signal: e.signal });
        if (e.signal.aborted) return;
        (p((t) => (t?.abortController === e ? { ...t, verificationUrl: n, userCode: r } : t)),
    ...
    U =
      !g || !B
        ? (0, q.jsxs)(q.Fragment, {
            children: [
              (0, q.jsx)(Y, { isPrimary: !0, handleChatGptSignIn: L, isChatGptSignInPending: h }),
              !h &&
                g &&
                (0, q.jsx)(`div`, {
                  className: `pt-2`,
                  children: (0, q.jsx)(X, { isPrimary: !1, handleCopilotSignIn: V }),
                }),
            ],
          })
        : (0, q.jsxs)(q.Fragment, {
                      ...
                      children: [
                        ...
                        !h &&
                          ...
                          (0, q.jsx)(ae, {
                            ...
                            children: (0, q.jsx)(ie, { handleChatGptDeviceCodeSignIn: R }),
                          }),
                      ],
                    }),
                  }),
...
function Z(e) {
  ...
  return (
    t[0] !== i || t[1] !== r || t[2] !== a || t[3] !== o
      ? ((s = (0, q.jsx)(A, { color: a, className: o, onClick: r, children: i })),
        (t[0] = i),
        (t[1] = r),
        (t[2] = a),
        (t[3] = o),
...
function le(e) {
  ...
  t[16] === v
    ? (b = t[17])
    : ((b = (0, q.jsx)(A, { color: `ghost`, onClick: v, children: y })), (t[16] = v), (t[17] = b));
  let x;
  t[18] !== n || t[19] !== a
  ...
  t[22] !== l || t[23] !== a || t[24] !== x
    ? ((C = (0, q.jsx)(A, { className: `px-4`, onClick: l, disabled: x, loading: a, children: S })),
      (t[22] = l),
      (t[23] = a),
      (t[24] = x),
      (t[25] = C))
  ...
  t[26] !== C || t[27] !== b
    ? ((w = (0, q.jsxs)(`div`, {
        ...
        children: [
          _,
          (0, q.jsxs)(`div`, { className: `flex justify-end gap-2`, children: [b, C] }),
        ],
      })),
      (t[26] = C),
      (t[27] = b),
...
function ue() {
  _.dispatchMessage(`open-in-browser`, { url: `https://platform.openai.com/api-keys` });
}
function de(e) {
...
function fe(e) {
  ...
  t[26] === o
    ? (E = t[27])
    : ((E = (0, q.jsx)(A, { color: `ghost`, onClick: o, children: T })), (t[26] = o), (t[27] = E));
  let D = n.length === 0,
    O;
  ...
  return (
    t[35] !== w || t[36] !== j
      ? ((M = (0, q.jsx)(`div`, {
          className: `w-full rounded-2xl border border-token-border bg-token-dropdown-background/80 px-4 py-4 backdrop-blur-lg`,
          children: (0, q.jsxs)(`div`, { className: `space-y-3`, children: [_, w, j] }),
        })),
        (t[35] = w),
        (t[36] = j),
        (t[37] = M))
...
var Q = 12,
  $ = 18,
  pe = 120,
  me = { up: { x: 0, y: -1 }, down: { x: 0, y: 1 }, left: { x: -1, y: 0 }, right: { x: 1, y: 0 } },
    ...
    ? ((N = () => {
        ...
        let e = (e) => {
          ...
          (e.key === `ArrowUp` || e.key === `w` || e.key === `W`
            ...
            t != null && (e.preventDefault(), he[d.current] !== t && (f.current = t)));
        };
        return (
...
function Ae(e) {
  let t = (0, G.c)(40),
    ...
    _ = w(`2523619087`),
    v;
  t[0] === _ ? (v = t[1]) : ((v = _.get(`enabled`, !1)), (t[0] = _), (t[1] = v));
  let y = v;
  if (a && !r) {
    let e;
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((C = (0, q.jsx)(`h1`, {
      ...
      (T = y
        ? (0, q.jsxs)(`div`, {
            ...
            children: [
              (0, q.jsx)(L, { className: `size-3.5 shrink-0`, "aria-hidden": `true` }),
              (0, q.jsx)(d, {
        ...
        : (0, q.jsxs)(`div`, {
            ...
            children: [
              (0, q.jsxs)(`button`, {
                ...
                onClick: () => u(),
                children: [
                  (0, q.jsx)(R, { className: `size-6 shrink-0 text-token-dropdown-background` }),
                  y
                    ? (0, q.jsx)(d, {
                ...
                ? (0, q.jsxs)(q.Fragment, {
                    children: [
                      (0, q.jsxs)(`button`, {
                        ...
                        onClick: () => u(`google`),
                        children: [
                          (0, q.jsx)(Oe, { className: `size-5 shrink-0`, "aria-hidden": `true` }),
                          (0, q.jsx)(d, {
                      ...
                      (0, q.jsxs)(`button`, {
                        ...
                        onClick: () => u(`microsoft`),
                        children: [
                          (0, q.jsx)(ke, { className: `size-5 shrink-0`, "aria-hidden": `true` }),
                          (0, q.jsx)(d, {
...
function je() {
  let e = f(u),
    ...
    ae = () => {
      D != null &&
        (y(e, { eventName: `codex_login_method_selected`, metadata: { method: `apikey`, ...D } }),
        te(!0));
    },
    oe = () => {
      U(!1);
    ...
    ce = async (r = `signin`) => {
      ...
      y(e, { eventName: `codex_login_method_selected`, metadata: { method: i, ...D } });
      let a = new AbortController();
      R(a);
      try {
        let { useDesktopAuth: s, useStreamlinedLoginUx: c } = Te(x(A, Ce)),
          l = S(A, `3963726525`),
          { authUrl: u, completion: d } = await ne({ signal: a.signal, useStreamlinedLogin: c });
        if (u) {
          let e = Se({
            authUrl: De(u, r),
        ...
        let f = await d;
        f.success
          ? (y(e, { eventName: `codex_login_success`, metadata: { method: i, ...D } }),
