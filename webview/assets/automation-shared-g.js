import { x as e } from "./app-scope-CWE-zIhQ.js";
import { Bi as t, Ri as n, Vi as r, _n as i } from "./src.js";
import { i as a, m as o, p as s, r as c, t as l, u } from "./automation-schedule.js";
var d = 7;
function f({ intl: e, nextRunAt: t, status: n }) {
  return n === `PAUSED`
    ? `-`
    : t == null
      ? e.formatMessage({
      ...
      : p({ intl: e, timestamp: t });
}
function p({ intl: e, timestamp: t }) {
  let n = new Date(t),
    r = m(n, new Date()),
...
var b = e(null),
  x = e(null),
  S = e(!1);
function C({ directiveKey: e, automation: t }) {
  return {
    directiveKey: e,
    mode: `view`,
    id: t.id,
...
function w(e, i) {
  ...
  return {
    ...
    status: e.status,
    cwds: t(e) ? [] : e.cwds,
    executionEnvironment: t(e) ? null : r(e.executionEnvironment),
    localEnvironmentConfigPath: t(e) ? null : e.localEnvironmentConfigPath,
    targetThreadId: t(e) ? e.targetThreadId : null,
    model: t(e) ? null : a.model,
    reasoningEffort: t(e) ? null : a.reasoningEffort,
    rawRrule: e.rrule,
    scheduleConfig: t(e) ? s(e.rrule) : o(e.rrule),
    scheduleDirty: !1,
  };
}
function T({ seed: e, targetAutomation: a, models: c }) {
  let l = e.mode === `view` ? a : null,
    u = l?.rrule ?? e.rrule,
    d = a == null ? null : n({ automation: a, models: c ?? [] }),
    f =
      e.id != null && a == null
        ? null
        : a != null && !t(a)
          ? r(a.executionEnvironment)
          : h.executionEnvironment,
    p = a?.kind ?? e.kind ?? (e.id != null && a == null ? h.kind : `cron`),
    m =
      p === `heartbeat`
        ? (e.targetThreadId ?? (a != null && t(a) ? a.targetThreadId : null))
        : null;
  return {
    id: e.id ?? a?.id ?? null,
    kind: p,
    name: l?.name ?? e.name,
    prompt: l?.prompt ?? e.prompt,
    status: l?.status ?? e.status ?? a?.status ?? `ACTIVE`,
    cwds: a != null && !t(a) ? a.cwds : e.cwds.map(i),
    executionEnvironment: p === `heartbeat` ? null : (e.executionEnvironment ?? f),
    localEnvironmentConfigPath:
      p === `heartbeat`
        ? null
        : (e.localEnvironmentConfigPath ??
          (a != null && !t(a) ? a.localEnvironmentConfigPath : h.localEnvironmentConfigPath)),
    targetThreadId: m,
    model: p === `heartbeat` ? null : (e.model ?? d?.model ?? h.model),
    reasoningEffort:
      p === `heartbeat` ? null : (e.reasoningEffort ?? d?.reasoningEffort ?? h.reasoningEffort),
    rawRrule: u,
    scheduleConfig: p === `heartbeat` ? s(u) : o(u),
    scheduleDirty: !1,
  };
}
function E(e) {
...
function k({ allowThreadDestination: e }) {
...
function j(e, t) {
  let n = t;
  t.includes(g) && (n = R(e.cwds) && t.length > 1 ? t.filter((e) => e !== g) : [g]);
...
function M({ draft: e, threadId: t, title: n }) {
  return { ...e, name: e.name.trim().length === 0 ? n : e.name, targetThreadId: t };
}
function N(e) {
  return e.kind === `cron` && R(e.cwds);
}
function P({ draft: e, modelSettings: t }) {
...
function F({ draft: e, name: t, prompt: n, status: r, rrule: i }) {
...
function I({ draft: e, name: t, prompt: n, rrule: r }) {
  if (e.kind === `heartbeat`) {
    if (e.targetThreadId == null) throw Error(`Heartbeat automation draft is incomplete`);
    return {
      kind: `heartbeat`,
...
function L({ directiveMode: e, canCreate: t, canUpdate: n, isViewMode: r, forceOpen: i = !1 }) {
  return i
    ? `open`
    : e === `view`
      ? r
...
//# sourceMappingURL=automation-shared-g.js.map
