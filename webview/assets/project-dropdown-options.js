...
import { t as d } from "./remote-connection-visibility.js";
import { t as f } from "./chevron.js";
import { t as p } from "./chats.js";
import { t as m } from "./info-1.js";
  ...
  let t = (0, g.c)(40),
    ...
    L =
      P.length > 1
        ...
        : (I?.label ?? v[0] ?? ne),
    R = D && F.has(A),
    z = R ? p : I?.isCodexWorktree === !0 ? te : ee,
    B;
  t[0] === k
    ? (B = t[1])
    : ((B = k.formatMessage({
    ...
    ? ((q = j
        ? (0, _.jsx)(c, {
            ...
            children: (0, _.jsx)(`button`, {
              ...
              children: (0, _.jsx)(m, { className: `icon-2xs` }),
            }),
          })
        : null),
      (t[16] = j),
        ...
        ? (0, _.jsxs)(_.Fragment, {
            children: [
              ...
              (0, _.jsx)(l.Section, {
                ...
                children: (0, _.jsx)(l.Item, {
                  LeftIcon: p,
                  RightIcon: R ? s : void 0,
                  onSelect: () => {
                    w(O === `single` || !R ? [A] : []);
                  },
                  children: M,
...
function b(e) {
  let t = (0, g.c)(22),
    { option: r, selectedRoots: i, selectedRootSet: a, selectionMode: o, onChange: c } = e,
    u = r.isCodexWorktree === !0 ? te : ee,
    d,
    f;
  t[0] !== r.value || t[1] !== a
    ? ((d = n(r.value)), (f = a.has(d)), (t[0] = r.value), (t[1] = a), (t[2] = d), (t[3] = f))
    : ((d = t[2]), (f = t[3]));
  let p = f,
    m = p ? s : void 0,
    h;
  t[4] !== p || t[5] !== d || t[6] !== c || t[7] !== i || t[8] !== o
    ? ((h = () => {
        if (o === `single`) {
          c([d]);
          return;
        }
        c(p ? i.filter((e) => e !== d) : [...i, d]);
      }),
      (t[4] = p),
      (t[5] = d),
      (t[6] = c),
  ...
  let x;
  return (
    t[17] !== u || t[18] !== m || t[19] !== h || t[20] !== b
      ? ((x = (0, _.jsx)(l.Item, { LeftIcon: u, RightIcon: m, onSelect: h, children: b })),
        (t[17] = u),
        (t[18] = m),
        (t[19] = h),
        (t[20] = b),
