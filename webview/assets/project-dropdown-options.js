...
function _(t) {
  ...
  a[24] !== Y || a[25] !== X
    ...
    : (Z = a[26]);
  let Q;
  a[27] !== j || a[28] !== N || a[29] !== O || a[30] !== R || a[31] !== T || a[32] !== k
    ? ((Q = O
        ? (0, g.jsxs)(g.Fragment, {
            children: [
              (0, g.jsx)(f.Separator, {}),
...
function y(t) {
  ...
  n[10] === r.label
    ? (_ = n[11])
    : ((_ = (0, g.jsx)(`span`, { children: r.label })), (n[10] = r.label), (n[11] = _));
  let v;
  n[12] === r.description
    ? (v = n[13])
    : ((v = r.description
  ...
  let y;
  n[14] !== _ || n[15] !== v
    ? ((y = (0, g.jsxs)(`div`, { className: `flex items-center gap-1`, children: [_, v] })),
      (n[14] = _),
      (n[15] = v),
      (n[16] = y))
    : (y = n[16]);
  ...
  return (
    n[17] !== c || n[18] !== m || n[19] !== h || n[20] !== y
      ? ((b = (0, g.jsx)(f.Item, { LeftIcon: c, RightIcon: m, onSelect: h, children: y })),
        (n[17] = c),
        (n[18] = m),
        (n[19] = h),
        (n[20] = y),
