...
import { t as u } from "./chats.js";
import { t as d } from "./info.js";
...
function v(e) {
  let t = (0, te.c)(40),
    ...
    L =
      F.length > 1
        ...
        : (ce?.label ?? v[0] ?? ne),
    R = O && I.has(j),
    z = R ? u : ce?.isCodexWorktree === !0 ? h : f,
    B;
  t[0] === A
    ? (B = t[1])
    : ((B = A.formatMessage({
    ...
    ? ((q = M
        ? (0, _.jsx)(s, {
            ...
            children: (0, _.jsx)(`button`, {
              ...
              children: (0, _.jsx)(d, { className: `icon-2xs` }),
            }),
          })
        : null),
      (t[16] = M),
  ...
  t[24] !== Y || t[25] !== X
    ...
    : (Z = t[26]);
  let Q;
  t[27] !== j || t[28] !== N || t[29] !== O || t[30] !== R || t[31] !== T || t[32] !== k
    ? ((Q = O
        ? (0, _.jsxs)(_.Fragment, {
            children: [
              (0, _.jsx)(p.Separator, {}),
  ...
  let $;
  return (
    t[34] !== E || t[35] !== G || t[36] !== J || t[37] !== Z || t[38] !== Q
      ? (($ = (0, _.jsxs)(m, {
          align: E,
...
function b(e) {
  ...
  let d = u,
    m = d ? ee : void 0,
    g;
  t[4] !== d || t[5] !== l || t[6] !== s || t[7] !== i || t[8] !== o
    ? ((g = () => {
        if (o === `single`) {
          s([l]);
          return;
        }
        s(d ? i.filter((e) => e !== l) : [...i, l]);
      }),
      (t[4] = d),
      (t[5] = l),
      (t[6] = s),
  ...
  let x;
  return (
    t[17] !== c || t[18] !== m || t[19] !== g || t[20] !== b
      ? ((x = (0, _.jsx)(p.Item, { LeftIcon: c, RightIcon: m, onSelect: g, children: b })),
        (t[17] = c),
        (t[18] = m),
        (t[19] = g),
        (t[20] = b),
