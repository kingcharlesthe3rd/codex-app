...
import { Z as n, s as r } from "./app-scope-CWE-zIhQ.js";
...
import { n as l } from "./app-identity.js";
import { a as u, d, i as f, l as p, n as m, r as h, t as g } from "./dialog-layout.js";
import { t as _ } from "./extension-info.js";
var v = e({
    CodexMemoryResetClicked: () => b,
    CodexMemorySettingToggled: () => y,
    CodexMemoryStateSnapshot: () => x,
  }),
  y = { $type: `protobuf_analytics_events.v1.CodexMemorySettingToggled` },
  b = { $type: `protobuf_analytics_events.v1.CodexMemoryResetClicked` },
  x = { $type: `protobuf_analytics_events.v1.CodexMemoryStateSnapshot` };
...
function D(e) {
  let t = (0, w.c)(46),
    { open: n, setupState: s, onAskCodex: c, onOpenChange: l } = e,
    v = i(),
    y = s.kind === `ready`,
    b = s.kind === `failed`,
    x = s.kind === `screen-recording-permission-needed`,
    S = s.kind === `accessibility-permission-needed`,
    C = x || S,
    E = s.kind === `preparing` || s.kind === `starting`,
    D = y || b || C || E,
    k = E || y || b,
    j;
  t[0] !== v || t[1] !== S || t[2] !== x || t[3] !== s.status
    ? ((j = x
        ? s.status === `denied`
          ? v.formatMessage({
  ...
  t[11] === s
    ...
    : ((G = (0, T.jsxs)(u, {
        children: [
          W,
          (0, T.jsx)(f, {
            title: (0, T.jsx)(F, { setupState: s }),
            subtitle: (0, T.jsx)(I, { setupState: s }),
          }),
        ],
      })),
      (t[11] = s),
  ...
  t[13] !== z || t[14] !== s
    ? ((K = (0, T.jsx)(`p`, {
        ...
        children: (0, T.jsx)(L, { bundleName: z, setupState: s }),
      })),
      (t[13] = z),
      (t[14] = s),
      (t[15] = K))
    : (K = t[15]);
  let q;
  t[16] !== b || t[17] !== s.message
    ? ((q = b
        ? (0, T.jsx)(`p`, { className: `text-token-error-foreground`, children: s.message })
        : null),
      (t[16] = b),
      (t[17] = s.message),
      (t[18] = q))
  ...
  let J;
  t[19] !== K || t[20] !== q
    ? ((J = (0, T.jsxs)(u, { className: `space-y-3`, children: [K, q] })),
      (t[19] = K),
      (t[20] = q),
      (t[21] = J))
    : (J = t[21]);
  let Y;
  t[22] !== z || t[23] !== N || t[24] !== R?.appIconMedium
    ? ((Y =
        N == null
          ? null
          : (0, T.jsx)(u, {
              children: (0, T.jsx)(P, {
                appIconMedium: R?.appIconMedium ?? null,
                bundleName: z,
                permissionSettingsName: N,
                onDragStart: H,
              }),
            })),
      (t[22] = z),
      (t[23] = N),
      (t[24] = R?.appIconMedium),
      (t[25] = Y))
    : (Y = t[25]);
  let X;
  t[26] !== b ||
  ...
  t[33] !== l
    ...
    : (X = t[34]);
  let Z;
  t[35] !== X || t[36] !== G || t[37] !== J || t[38] !== Y
    ? ((Z = (0, T.jsxs)(m, { children: [G, J, Y, X] })),
      (t[35] = X),
      (t[36] = G),
      (t[37] = J),
      (t[38] = Y),
  ...
  let Q;
  return (
    t[40] !== D || t[41] !== V || t[42] !== n || t[43] !== Z || t[44] !== U
      ? ((Q = (0, T.jsx)(p, {
          open: n,
          onOpenChange: V,
          contentProps: U,
...
function O() {
  s.systemPermissions?.openAccessibilitySettings().catch(k);
}
function k() {}
function A() {
  s.systemPermissions?.openScreenRecordingSettings().catch(j);
}
function j() {}
function M(e) {
  (e.preventDefault(), s.systemPermissions?.startPermissionSettingsAppDrag().catch(N));
}
function N() {}
function P(e) {
  let t = (0, w.c)(15),
    { appIconMedium: n, bundleName: r, permissionSettingsName: o, onDragStart: s } = e,
    c = i(),
    u;
  t[0] !== c || t[1] !== o
    ? ((u = c.formatMessage(
        ...
        { appName: l, permissionSettingsName: o },
      )),
      (t[0] = c),
      (t[1] = o),
      (t[2] = u))
  ...
  t[8] !== r || t[9] !== o
    ? ((p = (0, T.jsx)(`p`, {
        ...
        children: (0, T.jsx)(a, {
          ...
          values: { bundleName: r, permissionSettingsName: o },
...
export { C as a, y as c, D as i, x as l, z as n, S as o, E as r, b as s, R as t, v as u };
