...
import { G as t, S as n, U as r, Z as i, _ as a, f as o, wt as s } from "./setting-storage.js";
...
function C(e) {
  ...
  n[15] !== S || n[16] !== o.message
    ? ((K = S
        ? (0, x.jsx)(`p`, { className: `text-token-error-foreground`, children: o.message })
        : null),
      (n[15] = S),
      (n[16] = o.message),
      (n[17] = K))
...
function k(e) {
  (e.preventDefault(), c.systemPermissions?.startPermissionSettingsAppDrag().catch(A));
}
function A() {}
function j(e) {
  let n = (0, b.c)(15),
    { appIconMedium: i, bundleName: a, permissionSettingsName: o, onDragStart: s } = e,
    c = t(),
    l;
  n[0] !== c || n[1] !== o
    ? ((l = c.formatMessage(
