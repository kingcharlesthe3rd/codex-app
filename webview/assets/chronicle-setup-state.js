...
import { R as t, s as n, t as r } from "./app-scope.js";
import { a as i, u as a } from "./vscode-api.js";
import { c as o, o as s } from "./lib-1.js";
import { t as c } from "./button.js";
import { n as l } from "./rpc-2.js";
import { o as u } from "./statsig-DoZ-0xit.js";
import { a as d, d as f, i as p, l as m, n as h, r as g, t as _ } from "./dialog-layout.js";
var v = { $type: `protobuf_analytics_events.v1.CodexMemorySettingToggled` },
  ...
  x = i(r, `extension-info`, { staleTime: a.INFINITE });
...
function D(e) {
  let t = (0, w.c)(43),
    { open: r, setupState: i, onAskCodex: a, onOpenChange: l } = e,
    u = o(),
    v = i.kind === `ready`,
    y = i.kind === `failed`,
    ...
    E = v || y || C,
    D;
  t[0] !== u || t[1] !== S || t[2] !== b || t[3] !== i.status
    ? ((D = b
        ? i.status === `denied`
          ? u.formatMessage({
  ...
  t[18] !== G || t[19] !== K
    ...
    : (q = t[20]);
  let J;
  t[21] !== P || t[22] !== k || t[23] !== j?.appIconMedium
    ? ((J =
        k == null
          ? null
          : (0, T.jsx)(d, {
...
function O() {
  l.systemPermissions?.openAccessibilitySettings().catch(k);
}
function k() {}
function A() {
  l.systemPermissions?.openScreenRecordingSettings().catch(j);
}
function j() {}
function M(e) {
  e.preventDefault();
...
function N(e) {
  (e.preventDefault(), l.systemPermissions?.startPermissionSettingsAppDrag().catch(P));
}
function P() {}
function F(e) {
  let t = (0, w.c)(15),
