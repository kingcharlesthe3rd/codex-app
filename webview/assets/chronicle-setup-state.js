...
import { s as n, z as r } from "./app-scope.js";
import { l as i, s as a } from "./lib.js";
import { t as o } from "./button.js";
import { n as s } from "./rpc-Hf-fxjh7.js";
import { o as c } from "./statsig.js";
import { a as l, d as u, i as d, l as f, n as p, r as m, t as h } from "./dialog-layout-B.js";
import { t as g } from "./extension-info.js";
var _ = e({
    CodexMemoryResetClicked: () => y,
    CodexMemorySettingToggled: () => v,
    CodexMemoryStateSnapshot: () => b,
  }),
  v = { $type: `protobuf_analytics_events.v1.CodexMemorySettingToggled` },
  y = { $type: `protobuf_analytics_events.v1.CodexMemoryResetClicked` },
  b = { $type: `protobuf_analytics_events.v1.CodexMemoryStateSnapshot` };
function x({ isMemoryFeatureEnabled: e, memoryConfig: t }) {
  return {
...
var C = r(),
  w = t(),
  T = `Describe what I'm working on right now and suggest how I can use Codex to help.`;
function E(e) {
  let t = (0, C.c)(43),
    { open: r, setupState: s, onAskCodex: c, onOpenChange: _ } = e,
    v = i(),
    y = s.kind === `ready`,
    b = s.kind === `failed`,
  ...
  t[10] === s
    ...
    : ((W = (0, w.jsxs)(l, {
        children: [
          U,
          (0, w.jsx)(d, {
            title: (0, w.jsx)(F, { setupState: s }),
            subtitle: (0, w.jsx)(I, { setupState: s }),
          }),
        ],
      })),
      (t[10] = s),
  ...
  t[12] !== R || t[13] !== s
    ? ((G = (0, w.jsx)(`p`, {
        ...
        children: (0, w.jsx)(L, { bundleName: R, setupState: s }),
      })),
      (t[12] = R),
      (t[13] = s),
      (t[14] = G))
    : (G = t[14]);
  let K;
  t[15] !== b || t[16] !== s.message
    ? ((K = b
        ? (0, w.jsx)(`p`, { className: `text-token-error-foreground`, children: s.message })
        : null),
      (t[15] = b),
      (t[16] = s.message),
      (t[17] = K))
  ...
  let q;
  t[18] !== G || t[19] !== K
    ? ((q = (0, w.jsxs)(l, { className: `space-y-3`, children: [G, K] })),
      (t[18] = G),
      (t[19] = K),
      (t[20] = q))
    : (q = t[20]);
  let J;
  t[21] !== R || t[22] !== A || t[23] !== N?.appIconMedium
    ? ((J =
        A == null
          ? null
          : (0, w.jsx)(l, {
              children: (0, w.jsx)(P, {
                appIconMedium: N?.appIconMedium ?? null,
                bundleName: R,
                permissionSettingsName: A,
                onDragStart: V,
              }),
            })),
      (t[21] = R),
      (t[22] = A),
      (t[23] = N?.appIconMedium),
      (t[24] = J))
    : (J = t[24]);
  let Y;
  t[25] !== b ||
  ...
  t[31] !== _
    ...
    : (Y = t[32]);
  let X;
  t[33] !== Y || t[34] !== W || t[35] !== q || t[36] !== J
    ? ((X = (0, w.jsxs)(p, { children: [W, q, J, Y] })),
      (t[33] = Y),
      (t[34] = W),
      (t[35] = q),
      (t[36] = J),
...
function D() {
  s.systemPermissions?.openAccessibilitySettings().catch(O);
}
function O() {}
function k() {
  s.systemPermissions?.openScreenRecordingSettings().catch(A);
}
function A() {}
function j(e) {
  e.preventDefault();
...
export { S as a, v as c, E as i, b as l, z as n, x as o, T as r, y as s, R as t, _ as u };
