...
function W(e, t, n, r, i, a, o, s, c) {
  for (
    ...
    switch (((E = I), (I = C()))) {
      case 40:
        if (E != 108 && f(V, y - 1) == 58) {
          d((V += u(A(I), `&`, `&\f`)), `&\f`, _(l ? s[l - 1] : 0)) != -1 && (N = -1);
          break;
        }
      case 34:
      case 39:
        ...
        switch (I) {
          ...
          case 59 + h:
            (N == -1 && (V = u(V, /\f/g, ``)),
              x > 0 &&
                (m(V) - y || (O === 0 && E === 47)) &&
                g(x > 32 ? q(V + `;`, r, n, y - 1, c) : q(u(V, ` `, ``) + `;`, r, n, y - 2, c), c));
            break;
          case 59:
            V += `;`;
          default:
            if ((g((B = G(V, t, n, l, h, i, s, L, (R = []), (z = []), y, a)), a), I === 123))
      ...
      default:
        ...
        switch (((V += v(I)), I * O)) {
          ...
          case 44:
            ...
            break;
          case 64:
            (w() === 45 && (V += A(C())), (b = w()), (h = y = m((L = V += F(T())))), I++);
            break;
          case 45:
            E === 45 && m(V) == 2 && (O = 0);
        }
...
function G(e, t, r, i, a, o, s, c, d, f, m, g) {
  for (var v = a - 1, y = a === 0 ? o : [``], x = h(y), S = 0, C = 0, w = 0; S < i; ++S)
