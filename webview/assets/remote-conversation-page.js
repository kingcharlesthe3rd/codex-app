...
import { a as te, g as ne } from "./chunk-8.js";
import "./known-app-icon.js";
import { t as re } from "./branch.js";
import { t as ie } from "./github-mark.js";
import "./google-drive.js";
import "./notion.js";
import "./product-logger.js";
import "./rpc.js";
import "./statsig.js";
import { n as B } from "./request.js";
...
import "./use-auth.js";
import { D as ae, T as oe, f as se, v as ce, w as le } from "./codex-api-B.js";
import "./_baseEach.js";
import "./_baseOrderBy.js";
import "./use-debounced-value.js";
import { s as V } from "./apps-queries.js";
...
import { t as de } from "./route-scope.js";
import "./prompt-text.js";
import { r as U } from "./use-environment.js";
import {
  A as fe,
  D as W,
  F as G,
...
import { i as ye, n as be } from "./thread-detail-level.js";
import "./permissions-mode-defaults.js";
import "./use-permissions-mode.js";
import "./composer-footer.js";
import "./proxy.js";
import { V as xe, a as Se } from "./app-shell-state.js";
...
import { k as Te, y as Ee } from "./review-navigation-model.js";
import { i as De } from "./focus-composer.js";
import { f as Oe, o as ke } from "./review-file-source-tab.js";
import "./file-diff.js";
import "./sumBy.js";
...
import { t as Le, u as Re } from "./composer.js";
import { _ as ze, v as Be } from "./process-manager-target.js";
import { l as Ve } from "./thread-side-panel-tabs-1.js";
import "./modal-controller-state.js";
import "./open-project-setup-dialog.js";
import "./folder.js";
import { h as He, m as Ue } from "./local-conversation-background-terminals-model.js";
import "./initial-route-atom.js";
import { t as We } from "./use-stable-callback.js";
...
import "./checkbox.js";
import "./minus.js";
import "./rate-limit-rows-CYWI-x0e.js";
import "./links.js";
...
import "./warning.js";
import { r as it } from "./format-automation-next-run-label.js";
import { n as at, t as ot } from "./pull-request-status-Ceb-oAPn.js";
import "./markdown.js";
...
import { n as ut, t as dt } from "./pull-request-status-utils.js";
...
import { t as ft } from "./use-git-current-branch-CZf-kxlj.js";
import "./stop.js";
import "./realtime-controller-C.js";
...
import { n as ht } from "./diff-stats.js";
...
import { a as gt, s as _t } from "./mcp-capability-view-frame.js";
...
import { i as yt, n as bt, r as xt, t as St } from "./review-runtime-bridge.js";
...
import { o as Ot, s as kt } from "./user-message-attachments.js";
import "./app-window.js";
import "./local-environments-utils.js";
import "./pull-request-board-model.js";
import "./split-items-into-render-groups-CtEE-Zkg.js";
...
function Mt(e) {
        ...
        m?.targets?.map((e) =>
          (0, $.jsx)(
            X.Item,
            {
              ...
              RightIcon: e.gitRoot === y?.gitRoot ? Ke : void 0,
              children: (0, $.jsxs)(`div`, {
  ...
  t[19] === T
    ? (D = t[20])
    : ((D = (0, $.jsx)(X.Section, { className: `mt-1 flex flex-col gap-1`, children: T })),
      (t[19] = T),
      (t[20] = D));
  let O;
  t[21] === u
    ? (O = t[22])
    : ((O = u ? (0, $.jsx)(X.Section, { className: `mt-2`, children: u }) : null),
      (t[21] = u),
      (t[22] = O));
  let k;
  return (
...
function Pt(e) {
  ...
  t[1] === n
    ? (a = t[2])
    : ((a = (0, $.jsx)(Ft, { paths: n, className: `text-token-description-foreground`, Icon: Ke })),
      (t[1] = n),
      (t[2] = a));
  let o;
  t[3] === r.length
...
function Ft(e) {
  ...
  let o;
  t[0] === i ? (o = t[1]) : ((o = E(`flex flex-col gap-1.5 text-sm`, i)), (t[0] = i), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
    : ((s = n
...
function zt(e) {
  let t = (0, Z.c)(31),
    ...
    l = m(h),
    { data: u } = ft(c, l, `remote_conversation_apply_diff`),
    { data: d } = ae(),
    p = O(),
    g;
  bb0: {
    ...
    ? ((x = {
        ...
        onSuccess(e, t) {
          let { revert: r } = t,
            i = r === void 0 ? !1 : r;
          (Bt(i, e, p, a.get(ue)),
            i && e.status === `success` ? W(a, n) : !i && e.status === `success` && _e(a, n),
            e.status !== `success` && b({ open: !0, result: e }));
        },
        onError(e, t) {
          let { revert: n } = t;
          Bt(n === void 0 ? !1 : n, { status: `error` }, p, a.get(ue));
        },
        onSettled(e, t, n) {
          f({
            cwd: n.cwd,
...
function Ut(e) {
  ...
  t[20] === h
    ...
    : ((_ = (0, $.jsx)(Me, {
        children: (0, $.jsx)(Ie, {
          children: (0, $.jsx)(Y, { color: `outline`, onClick: h, children: g }),
        }),
      })),
      (t[20] = h),
      (t[21] = _));
...
function qt(e) {
  ...
  t[50] !== d.open || t[51] !== d.result || t[52] !== f
    ? ((L = (0, $.jsx)(Ut, { open: d.open, result: d.result, onOpenChange: f })),
      (t[50] = d.open),
      (t[51] = d.result),
      (t[52] = f),
      (t[53] = L))
  ...
  return (
    t[54] !== I || t[55] !== L
      ? ((R = (0, $.jsxs)($.Fragment, { children: [I, L] })), (t[54] = I), (t[55] = L), (t[56] = R))
      : (R = t[56]),
    R
  );
}
...
function Yt(e) {
  let t = (0, Z.c)(56),
    ...
    u = M(A),
    d = O(),
    f = F(a.createPullRequestAsDraft),
    p = se(),
    m = (0, Q.useRef)(!1),
    h = (0, Q.useRef)(null),
  ...
  let x = b,
    ...
    N;
  t[8] !== k || t[9] !== D
    ? ((N = { enabled: D, refetchInterval: k }), (t[8] = k), (t[9] = D), (t[10] = N))
    : (N = t[10]);
  let { data: P } = le(n, w, N),
    I = P?.turn ?? S,
    L = I?.pull_request_status ?? null,
    R = I?.pull_request_data?.url ?? null,
    z = tn(s, I?.id ?? null, R) ?? tn(s, w, R),
    te = I?.turn_status === `completed`,
    ne;
  t[11] !== L || t[12] !== R
    ? ((ne = en(L, R)), (t[11] = L), (t[12] = R), (t[13] = ne))
    : (ne = t[13]);
  let re = ne,
    B = p.isPending || L === `creating` || (E && !re),
    ae,
    oe;
  (t[14] === R
    ? ((ae = t[15]), (oe = t[16]))
    : ((ae = () => {
        m.current && R && (ee.dispatchMessage(`open-in-browser`, { url: R }), (m.current = !1));
      }),
      (oe = [R]),
      (t[14] = R),
      (t[15] = ae),
  ...
  t[23] === R
    ? (H = t[24])
    : ((H = function () {
        R && ee.dispatchMessage(`open-in-browser`, { url: R });
      }),
      (t[23] = R),
      (t[24] = H));
  let de = H,
  ...
  let J;
  return (
    t[50] !== l || t[51] !== W || t[52] !== G || t[53] !== K || t[54] !== q
      ? ((J = (0, $.jsxs)(Y, {
          className: `shrink-0`,
          color: `outline`,
          disabled: W,
...
function rn(e) {
  let t = (0, Z.c)(33),
    ...
    o = N(qe, `toggleThreadPin`),
    s = N(qe, `copySessionId`),
    c = i ? He : Ue,
    l = i ? T : it,
    u;
  ...
  let d = u,
    f;
  (t[2] === a ? (f = t[3]) : ((f = [a]), (t[2] = a), (t[3] = f)), I(`toggle-thread-pin`, a, f));
  let p, m;
  (t[4] === n
    ? ((p = t[5]), (m = t[6]))
    : ((p = () => {
  ...
  t[11] === d
    ...
    : ((v = (0, $.jsx)(Y, {
      ...
      (t[12] = v));
  let y;
  t[13] === c ? (y = t[14]) : ((y = (0, $.jsx)(j, { ...c })), (t[13] = c), (t[14] = y));
  let b;
  t[15] !== l || t[16] !== y || t[17] !== a || t[18] !== o
    ? ((b = (0, $.jsx)(X.Item, { onSelect: a, LeftIcon: l, keyboardShortcut: o, children: y })),
      (t[15] = l),
      (t[16] = y),
      (t[17] = a),
      (t[18] = o),
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(X.Item, {
        disabled: !0,
        LeftIcon: Ye,
        children: (0, $.jsx)(j, { ...$e.renameThread }),
      })),
      (t[20] = x))
    : (x = t[20]);
  let S, C;
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(X.Item, {
        disabled: !0,
        LeftIcon: tt,
        children: (0, $.jsx)(j, { ...$e.archiveThread }),
      })),
      (C = (0, $.jsx)(X.Separator, {})),
      (t[21] = S),
      (t[22] = C))
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, $.jsx)(j, { ...$e.copySessionId })), (t[25] = E))
    : (E = t[25]);
  let D;
  t[26] !== s || t[27] !== w
    ? ((D = (0, $.jsx)(X.Item, { onSelect: w, LeftIcon: ct, keyboardShortcut: s, children: E })),
      (t[26] = s),
      (t[27] = w),
      (t[28] = D))
    : (D = t[28]);
  ...
  e[12] === a
    ...
    : ((v = (0, $.jsx)(H, {
        ...
        children: (0, $.jsxs)(Y, {
          ...
          size: `toolbar`,
          onClick: () => {
            a && ee.dispatchMessage(`open-in-browser`, { url: `${o}/tasks/${a}` });
          },
          children: [
    ...
    getTurns: () =>
      e().flatMap(({ node: e, activeId: t }) => {
        let n = kn(e.userTurn.input_items.filter((e) => e.type === `message`)),
          ...
          i = r == null ? `` : p(kn(r.output_items.filter((e) => e.type === `message`))),
          a = [];
        return (
          n.trim().length > 0 &&
...
var An = n({
  id: c(),
  item_type: i(`log`),
  key: n({ type: i(`UserSetupScript`), created_at: c() }),
  line: c(),
});
function jn(e) {
...
function Bn(e) {
  let t = (0, Z.c)(72),
    ...
    { isFetching: f, isLoading: p } = P(he),
    m = P(fe),
    h = P(ge),
    g = P(_t),
    _ = ze(`chatgpt.supportsNewChatKeyShortcut`),
  ...
  t[4] === b
    ? (L = t[5])
    : ((L = () => {
        b && ee.dispatchMessage(`open-in-browser`, { url: `${o}/tasks/${b}` });
      }),
      (t[4] = b),
      (t[5] = L));
  let R = L,
    z = (0, Q.useEffectEvent)(Vn),
    te;
  t[6] !== k || t[7] !== z || t[8] !== l?.task.id || t[9] !== A
    ? ((te = () => {
        k || (l?.task.id && A && z(l?.task.id ?? null, A));
      }),
      (t[6] = k),
      (t[7] = z),
      (t[8] = l?.task.id),
  ...
  let re = l?.task.id,
    ie;
  (t[11] !== k || t[12] !== re || t[13] !== A
    ? ((ie = [k, re, A]), (t[11] = k), (t[12] = re), (t[13] = A), (t[14] = ie))
    : (ie = t[14]),
    (0, Q.useEffect)(te, ie));
  let B;
  t[15] === _
  ...
  t[17] === oe
    ? (se = t[18])
    : ((se = (0, $.jsx)(je, { extension: !0, children: (0, $.jsx)(Tt, { title: oe }) })),
      (t[17] = oe),
      (t[18] = se));
  let le;
  t[19] === l
    ? (le = t[20])
    : ((le = (0, $.jsx)(je, { extension: !0, children: (0, $.jsx)(Hn, { taskDetails: l }) })),
      (t[19] = l),
      (t[20] = le));
  let V;
  t[21] !== k || t[22] !== h || t[23] !== C || t[24] !== b || t[25] !== A
    ? ((V = A && b && h?.id && !k && (0, $.jsx)(Vt, { turnId: h.id, diff: A, taskEnvironment: C })),
      (t[21] = k),
      (t[22] = h),
      (t[23] = C),
      (t[24] = b),
  ...
  t[30] !== T || t[31] !== w || t[32] !== s || t[33] !== a
    ? ((H =
        ...
        (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(Le, { isResponseInProgress: T, showFooterBranchWhen: `always` }),
        })),
      (t[30] = T),
      (t[31] = w),
      (t[32] = s),
    ...
    : (H = t[34]);
  let U;
  t[35] !== V || t[36] !== ue || t[37] !== H
    ? ((U = (0, $.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [V, ue, H] })),
      (t[35] = V),
      (t[36] = ue),
      (t[37] = H),
      (t[38] = U))
  ...
  let K;
  t[54] !== W || t[55] !== G
    ? ((K = (0, $.jsxs)(`div`, { className: `flex flex-col gap-1.5 pt-2`, children: [W, G] })),
      (t[54] = W),
      (t[55] = G),
      (t[56] = K))
    : (K = t[56]);
  let q;
  t[57] === b ? (q = t[58]) : ((q = (0, $.jsx)(gt, {}, b)), (t[57] = b), (t[58] = q));
  let J;
  t[59] !== g || t[60] !== U || t[61] !== K || t[62] !== q
    ? ((J = (0, $.jsxs)(Dt, { hasLiveMcpAppFrame: g, footer: U, children: [K, q] })),
      (t[59] = g),
      (t[60] = U),
      (t[61] = K),
      (t[62] = q),
    ...
    : (J = t[63]);
  let me;
  t[64] !== ae || t[65] !== se || t[66] !== le || t[67] !== J
    ? ((me = (0, $.jsx)(Ct, {
        containerRef: ae,
  ...
  return (
    t[69] !== v || t[70] !== me
      ? ((_e = (0, $.jsx)(Re, { value: v, children: me })), (t[69] = v), (t[70] = me), (t[71] = _e))
      : (_e = t[71]),
    _e
  );
}
      ...
      () => ({
        scrollToTurn: async (e, t) => {
          t?.signal?.aborted ||
            (await ke(),
            !t?.signal?.aborted &&
              (Kn(u, e)?.scrollIntoView({ block: `center`, behavior: `smooth` }), await ke()));
        },
...
function qn(e) {
  ...
  t[2] !== a.id || t[3] !== a.turn_status || t[4] !== r
    ? ((f = {
        ...
        keepStreamOpenAfterCompletion: d,
      }),
      (t[2] = a.id),
      (t[3] = a.turn_status),
      (t[4] = r),
      (t[5] = f))
    : (f = t[5]);
  let { setupLogs: p, threadEvents: m } = Fn(f),
    h;
  t[6] === a ? (h = t[7]) : ((h = un(a)), (t[6] = a), (t[7] = h));
  let g = h,
    _;
  t[8] !== a.turn_status || t[9] !== m || t[10] !== g
    ? ((_ = fn({
        turnStatus: a.turn_status,
        storedEvents: g,
        liveEvents: m,
        preserveLiveImageGenerationEvents: d,
      }).map(Yn)),
      (t[8] = a.turn_status),
      (t[9] = m),
      (t[10] = g),
  ...
  let { data: x } = oe(r, a.id, b),
    S;
  t[14] !== p || t[15] !== x
    ? ((S = x == null ? p : x.logs.flatMap(Jn)), (t[14] = p), (t[15] = x), (t[16] = S))
    : (S = t[16]);
  let C = S,
  ...
  let A = k,
    M = r ?? a.id,
    N;
  t[21] !== a || t[22] !== s || t[23] !== M || t[24] !== v || t[25] !== i
    ? ((N = mn({
        taskId: M,
        userTurn: i,
        assistantTurn: a,
  ...
  let P = N,
    F;
  t[27] === P ? (F = t[28]) : ((F = u(P, [])), (t[27] = P), (t[28] = F));
  let I = F,
    L;
  t[29] !== a.id ||
  t[30] !== o ||
  ...
  let ee;
  return (
    t[46] !== L || t[47] !== R || t[48] !== z
      ? ((ee = (0, $.jsxs)($.Fragment, { children: [L, R, z] })),
        (t[46] = L),
        (t[47] = R),
        (t[48] = z),
        (t[49] = ee))
...
function ar(e) {
  ...
  t[2] === r
    ...
    : ((c = r.formatMessage({
      ...
      (t[3] = c));
  let l = c,
    { src: u, isLoading: d, isError: f, refetch: p } = x(n.asset_pointer);
  if (f) return null;
  if (d || !u) {
    let e;
    t[4] === r
...
function or(e) {
  let t = (0, Z.c)(24),
    ...
    S;
  (t[0] === r ? (S = t[1]) : ((S = () => Ve(r)), (t[0] = r), (t[1] = S)), xt(S));
  let C;
  t[2] === c
    ? (C = t[3])
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(Ce.MainContentLayout, { layout: `thread-edge-scroll` })), (t[4] = w))
    : (w = t[4]);
  let T;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(Ce.Header, { children: (0, $.jsx)(an, {}) })), (t[5] = T))
    : (T = t[5]);
  let E;
  t[6] !== i || t[7] !== b
    ? ((E = (0, $.jsx)(`div`, {
  ...
  t[9] !== h || t[10] !== D || t[11] !== O || t[12] !== n
    ...
    : (k = t[13]);
  let A;
  t[14] === x ? (A = t[15]) : ((A = x ? (0, $.jsx)(sr, {}) : null), (t[14] = x), (t[15] = A));
  let j;
  t[16] !== C || t[17] !== E || t[18] !== k || t[19] !== A
    ? ((j = (0, $.jsxs)(`div`, {
        ref: v,
        className: `relative h-full min-h-0`,
        children: [C, w, T, E, k, A],
      })),
      (t[16] = C),
      (t[17] = E),
      (t[18] = k),
  ...
  return (
    t[21] !== g || t[22] !== j
      ? ((N = (0, $.jsx)(Re, { value: g, children: j })), (t[21] = g), (t[22] = j), (t[23] = N))
      : (N = t[23]),
    N
  );
}
function sr() {
  let e = (0, Z.c)(2),
    t = P(pe).data?.current_assistant_turn?.turn_status,
