...
import { f as c, k as l, l as u, p as d, s as f } from "./vscode-api.js";
import "./isEqual.js";
import {
  Ki as p,
  Li as m,
...
import "./client.js";
import "./react-dom.js";
import { c as A, o as j } from "./lib-1.js";
import "./persisted-signal.js";
import { t as M } from "./clsx.js";
import "./proxy.js";
import { W as N, a as P } from "./app-shell-state.js";
...
import "./katex-2.js";
import "./pdf-1.js";
import { a as W, g as se } from "./chunk-8.js";
...
import { A as Ee, B as De, b as Oe } from "./review-navigation-model.js";
import "./file-tree-search-input.js";
import { t as ke } from "./parse-diff.js";
import { o as Ae } from "./review-file-source-tab.js";
import "./file-diff.js";
import "./sumBy.js";
...
import { F as Ne, I as Pe, M as Fe, _ as Ie, v as Le } from "./process-manager-target.js";
...
import { a as ze, i as Be, l as Ve, n as He, r as Ue } from "./dialog-layout.js";
...
import { p as We, t as Ge } from "./composer.js";
...
import { f as ot, p as st } from "./review-header-toolbar-p.js";
import "./comment.js";
import "./markdown.js";
import "./external-link-favicon.js";
import "./code-snippet-Bu-o-Ykd.js";
import { t as ct } from "./copy-D.js";
...
import { i as yt } from "./slash-command-item-D6wU-Usp.js";
...
function Bt(e) {
  let t = (0, Z.c)(31),
    ...
    d = D(O),
    { data: p } = gt(u, d, `remote_conversation_apply_diff`),
    { data: m } = q(),
    h = A(),
    g;
  bb0: {
  ...
  t[6] !== d || t[7] !== h || t[8] !== s || t[9] !== n
    ? ((x = {
        ...
        onError(e, t) {
          let { revert: n } = t;
          Vt(n === void 0 ? !1 : n, { status: `error` }, h, s.get(ie));
        },
        onSettled(e, t, n) {
          E({
            cwd: n.cwd,
      ...
      (t[10] = x))
    : (x = t[10]);
  let S = f(`apply-patch`, x),
    C;
  t[11] !== r || t[12] !== u || t[13] !== d || t[14] !== S
    ? ((C = (e) => {
        S.isPending || (u && S.mutate({ diff: r, cwd: u, hostConfig: d, revert: e }));
      }),
      (t[11] = r),
      (t[12] = u),
      (t[13] = d),
...
function Xt(e) {
  let t = (0, Z.c)(56),
    { taskId: n, turns: r, selectedTurn: i, diffTaskTurn: o, pullRequests: l, size: u } = e,
    d = u === void 0 ? `toolbar` : u,
    f = a(s),
    p = A(),
    m = L(_.createPullRequestAsDraft),
    h = ue(),
    g = (0, Q.useRef)(!1),
    v = (0, Q.useRef)(null),
  ...
  if (t[0] !== o || t[1] !== i || t[2] !== r) {
    x = new Map();
    for (let e of r) x.set(e.id, e);
    (i && x.set(i.id, i), o && x.set(o.id, o), (t[0] = o), (t[1] = i), (t[2] = r), (t[3] = x));
  } else x = t[3];
  let S = x,
    C;
  t[4] !== o || t[5] !== i || t[6] !== S
    ? ((C = $t({ turnById: S, selectedTurn: i, diffTaskTurn: o })),
      (t[4] = o),
      (t[5] = i),
      (t[6] = S),
      (t[7] = C))
  ...
  let w = C,
    T = w?.actionTurn ?? null,
    E = (w?.prItem ?? null)?.output_diff?.diff ?? null,
    D = T?.id ?? null,
    O = T?.pull_request_status ?? null,
    k = !!y && y === D,
    M = !!n && !!D && (h.isPending || O === `creating` || k),
    N = M ? Zt : !1,
    P;
  t[8] !== N || t[9] !== M
  ...
  t[11] !== ee || t[12] !== B
    ...
    : (re = t[13]);
  let ae = re,
    V = h.isPending || ee === `creating` || (k && !ae),
    oe,
    H;
  (t[14] === B
    ? ((oe = t[15]), (H = t[16]))
    : ((oe = () => {
        g.current && B && (c.dispatchMessage(`open-in-browser`, { url: B }), (g.current = !1));
      }),
      (H = [B]),
      (t[14] = B),
      (t[15] = oe),
  ...
  t[23] === B
    ? (se = t[24])
    : ((se = function () {
        B && c.dispatchMessage(`open-in-browser`, { url: B });
      }),
      (t[23] = B),
      (t[24] = se));
  let G = se,
  ...
  t[32] !== n
    ? ((K = async function () {
        if (!(!n || !D || !ne || V)) {
          ((g.current = !1), (v.current = null), b(D));
          try {
            (await h.mutateAsync({ taskId: n, turnId: D, ...(m ? { mode: `draft` } : {}) }),
              (g.current = !0));
          } catch {
            ((g.current = !1),
              b(null),
  ...
  let X;
  return (
    t[50] !== d || t[51] !== de || t[52] !== J || t[53] !== fe || t[54] !== Y
      ? ((X = (0, $.jsxs)(I, {
          className: `shrink-0`,
          color: `outline`,
          disabled: de,
...
function an(e) {
  let t = (0, Z.c)(33),
    ...
    u = a ? Fe : Ye,
    f;
  t[0] === r ? (f = t[1]) : ((f = r.formatMessage(tt.moreActions)), (t[0] = r), (t[1] = f));
  let p = f,
    m;
  (t[2] === o ? (m = t[3]) : ((m = [o]), (t[2] = o), (t[3] = m)), d(`toggle-thread-pin`, o, m));
  let h, g;
  (t[4] === n
    ? ((h = t[5]), (g = t[6]))
    : ((h = () => {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, $.jsx)(it, { className: `icon-sm` })), (t[10] = y))
    : (y = t[10]);
  let b;
  t[11] === p
    ? (b = t[12])
...
function on() {
  ...
  let f = d?.output_diff?.diff ?? null,
    p = r?.id ?? s?.id ?? null,
    m = i?.current_assistant_turn?.environment,
    h = i?.task.title ?? null,
    g = a ?? null,
    _;
  e[6] === g ? (_ = e[7]) : ((_ = (0, $.jsx)(an, { conversationId: g })), (e[6] = g), (e[7] = _));
  let v;
  e[8] !== p || e[9] !== m || e[10] !== f
    ? ((v = f && p ? (0, $.jsx)(Jt, { turnId: p, diff: f, taskEnvironment: m }) : null),
      (e[8] = p),
      (e[9] = m),
      (e[10] = f),
      (e[11] = v))
  ...
  e[12] === a
    ...
    : ((y = (0, $.jsx)(B, {
        ...
        children: (0, $.jsxs)(I, {
          ...
          size: `toolbar`,
          onClick: () => {
            a && c.dispatchMessage(`open-in-browser`, { url: `${b}/tasks/${a}` });
          },
          children: [
  ...
  e[14] !== s || e[15] !== u || e[16] !== r || e[17] !== a || e[18] !== n
    ...
    : (x = e[19]);
  let S;
  e[20] !== v || e[21] !== y || e[22] !== x
    ? ((S = (0, $.jsxs)(`div`, { className: `flex items-center gap-2`, children: [v, y, x] })),
      (e[20] = v),
      (e[21] = y),
      (e[22] = x),
      (e[23] = S))
  ...
  let C;
  return (
    e[24] !== h || e[25] !== _ || e[26] !== S
      ? ((C = (0, $.jsx)(St, { start: h, startActions: _, trailing: S })),
        (e[24] = h),
        (e[25] = _),
        (e[26] = S),
        (e[27] = C))
...
function hn({
  ...
  let d = En(n.output_items?.filter((e) => e.type === `message`) ?? []);
    ...
    getTurns: () =>
      e().flatMap(({ node: e, activeId: t }) => {
        let n = An(e.userTurn.input_items.filter((e) => e.type === `message`)),
          ...
          i = r == null ? `` : w(An(r.output_items.filter((e) => e.type === `message`))),
          a = [];
        return (
          n.trim().length > 0 &&
...
var jn = v({
  id: p(),
  item_type: m(`log`),
  key: v({ type: m(`UserSetupScript`), created_at: p() }),
  line: p(),
});
function Mn(e) {
            ...
            i = u.getInstance().stream(`GET`, t, {
              ...
              onComplete: () => {
                (f.invalidateQueries({ queryKey: [`tasks`] }),
                  f.invalidateQueries({ queryKey: [`task`, n] }),
                  f.invalidateQueries({ queryKey: [`task`, n, `turns`] }));
              },
            });
          return () => {
            u.getInstance().cancelStream(i);
          };
        }),
        (v = [f, g, n, r]),
        (t[10] = f),
...
function Vn(e) {
  let t = (0, Z.c)(72),
    ...
    l = a(fe),
    u = o(he),
    { data: d, error: f, isLoading: p } = u,
    { isFetching: m, isLoading: h } = o(ye),
    g = o(ve),
    _ = o(pe),
    v = o(wt),
    y = Ie(`chatgpt.supportsNewChatKeyShortcut`),
    [x, S] = (0, Q.useState)(null),
    { taskId: C } = se(),
    { mutate: w } = de(C ?? ``),
    T = d?.current_assistant_turn,
    E = d?.current_assistant_turn?.environment,
    D = T?.turn_status ?? null,
    O = D === `pending` || D === `in_progress`,
    k = D === `failed`,
    A = Ce(),
    M = i ?? A,
    N = M === we,
    P = Ln(u, _),
    F = d?.task.has_unread_turn ?? !1,
    I,
    L;
  (t[0] !== F || t[1] !== w
    ? ((I = () => {
  ...
  t[4] === C
    ? (z = t[5])
    : ((z = () => {
        C && c.dispatchMessage(`open-in-browser`, { url: `${b}/tasks/${C}` });
      }),
      (t[4] = C),
      (t[5] = z));
  let B = z,
    ...
    ne;
  t[6] !== N || t[7] !== te || t[8] !== d?.task.id || t[9] !== P
    ? ((ne = () => {
        N || (d?.task.id && P && te(d?.task.id ?? null, P));
      }),
      (t[6] = N),
      (t[7] = te),
      (t[8] = d?.task.id),
  ...
  t[19] === d
    ? (U = t[20])
    : ((U = (0, $.jsx)(Me, { extension: !0, children: (0, $.jsx)(Un, { taskDetails: d }) })),
      (t[19] = d),
      (t[20] = U));
  let W;
  t[21] !== N || t[22] !== _ || t[23] !== E || t[24] !== C || t[25] !== P
    ? ((W = P && C && _?.id && !N && (0, $.jsx)(Ht, { turnId: _.id, diff: P, taskEnvironment: E })),
      (t[21] = N),
      (t[22] = _),
      (t[23] = E),
      (t[24] = C),
  ...
  t[30] !== O || t[31] !== D || t[32] !== l || t[33] !== s
    ? ((ce =
        ...
        (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(Ge, { isResponseInProgress: O, showFooterBranchWhen: `always` }),
        })),
      (t[30] = O),
      (t[31] = D),
      (t[32] = l),
  ...
  t[52] !== P
    ? ((le = d
        ? (0, $.jsx)(Kn, {
            ...
            taskId: C ?? null,
            turnsLoading: h || m,
            focusedAssistantId: _?.id ?? T?.id ?? null,
  ...
  t[54] !== q || t[55] !== le
    ...
    : (ue = t[56]);
  let J;
  t[57] === C ? (J = t[58]) : ((J = (0, $.jsx)(Ct, {}, C)), (t[57] = C), (t[58] = J));
  let Y;
  ...
  return (
    t[69] !== x || t[70] !== X
      ? ((me = (0, $.jsx)(We, { value: x, children: X })), (t[69] = x), (t[70] = X), (t[71] = me))
      : (me = t[71]),
    me
  );
}
        ...
        (0, $.jsxs)(`a`, {
          ...
          children: [
            ...
            (0, $.jsx)(B, {
              ...
              children: (0, $.jsx)(je, { className: `icon-2xs` }),
            }),
          ],
        })),
      (t[0] = n),
...
function Kn({
      ...
      () => ({
        scrollToTurn: async (e, t) => {
          t?.signal?.aborted ||
            (await Ae(),
            !t?.signal?.aborted &&
              (qn(f, e)?.scrollIntoView({ block: `center`, behavior: `smooth` }), await Ae()));
        },
  ...
  return (
    ...
    d.length === 0
      ...
      : (0, $.jsxs)($.Fragment, {
          children: [
            (0, $.jsx)(Le, { conversationSource: g, diffSource: h }),
            (0, $.jsxs)(`div`, {
              ref: f,
...
function Jn(e) {
  ...
  t[2] !== a.id || t[3] !== a.turn_status || t[4] !== r
    ? ((u = {
      ...
      (t[5] = u))
    : (u = t[5]);
  let { setupLogs: d, threadEvents: f } = In(u),
    p;
  t[6] === a ? (p = t[7]) : ((p = dn(a)), (t[6] = a), (t[7] = p));
  let m = p,
    g;
  ...
  let { data: b } = K(r, a.id, y),
    x;
  t[14] !== d || t[15] !== b
    ? ((x = b == null ? d : b.logs.flatMap(Yn)), (t[14] = d), (t[15] = b), (t[16] = x))
    : (x = t[16]);
  let C = x,
  ...
  let N = M,
    P;
  t[27] === N ? (P = t[28]) : ((P = S(N, [])), (t[27] = N), (t[28] = P));
  let F = P,
    I;
  t[29] !== k ||
  t[30] !== a.id ||
...
function cr(e) {
  let t = (0, Z.c)(24),
    ...
    b = h && g,
    x = !b,
    S = b && s.data != null && d != null,
    C;
  (t[0] === r ? (C = t[1]) : ((C = () => ne(r)), (t[0] = r), (t[1] = C)), mt(C));
  let w;
  t[2] === u
    ? (w = t[3])
    : ((w = (0, $.jsx)(ht, { lastTurnCwd: null, lastTurnDiff: u })), (t[2] = u), (t[3] = w));
  let T;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(F.MainContentLayout, { layout: `thread-edge-scroll` })), (t[4] = T))
    : (T = t[4]);
  let E;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, $.jsx)(F.Header, { children: (0, $.jsx)(on, {}) })), (t[5] = E))
    : (E = t[5]);
  let D;
  t[6] !== i || t[7] !== x
    ? ((D = (0, $.jsx)(`div`, {
        className: `h-full min-h-0`,
        children: (0, $.jsx)(Vn, { hostId: i, showComposer: x }),
      })),
      (t[6] = i),
      (t[7] = x),
      (t[8] = D))
    : (D = t[8]);
  let O = f?.lines_added ?? 0,
    A = f?.lines_removed ?? 0,
    j;
  t[9] !== _ || t[10] !== O || t[11] !== A || t[12] !== n
    ? ((j = (0, $.jsx)(jt, {
        taskId: n,
        linesAdded: O,
        linesRemoved: A,
    ...
    : (j = t[13]);
  let M;
  t[14] === S ? (M = t[15]) : ((M = S ? (0, $.jsx)(lr, {}) : null), (t[14] = S), (t[15] = M));
  let I;
  t[16] !== w || t[17] !== D || t[18] !== j || t[19] !== M
    ? ((I = (0, $.jsxs)(`div`, {
        ref: y,
        className: `relative h-full min-h-0`,
        children: [w, T, E, D, j, M],
      })),
      (t[16] = w),
      (t[17] = D),
      (t[18] = j),
  ...
  return (
    t[21] !== v || t[22] !== I
      ? ((L = (0, $.jsx)(We, { value: v, children: I })), (t[21] = v), (t[22] = I), (t[23] = L))
      : (L = t[23]),
    L
  );
}
