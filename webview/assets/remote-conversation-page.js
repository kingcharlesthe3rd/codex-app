...
import { Ea as u, Ln as d, j as f, jr as p, la as m } from "./thread-context-inputs.js";
...
import { p as q } from "./thread-side-panel-tabs-1.js";
import "./platform.js";
...
import { E as ie, O as ae, T as oe, f as se, v as ce } from "./codex-api-C.js";
...
import { i as Ze, n as Qe, r as $e, t as et } from "./thread-actions-B.js";
import "./popover.js";
...
import { t as ft } from "./image-preview-dialog-Bb-vTCJ6.js";
...
import "./robot.js";
import { t as Nt } from "./thread-app-shell-chrome-BTm-EsaJ.js";
...
function Ht(e) {
  let t = (0, Z.c)(31),
    ...
    u = i(Y, n),
    f = le(o),
    p = ht(f == null ? void 0 : o?.repo_map?.[f]?.clone_url),
    m = c(l),
...
function mn({
  ...
  let o = D([]),
    ...
    c = r.reduce(hn, s),
    l = gn(n, c.status),
    d = l === c.status ? c : { ...c, status: l };
  if (d.items.some((e) => e.type === `agentMessage`)) return d;
  let f = Tn(n.output_items?.filter((e) => e.type === `message`) ?? []);
...
function Un(e) {
  ...
  t[2] !== a.id || t[3] !== a.turn_status || t[4] !== r
    ? ((u = {
      ...
      (t[5] = u))
    : (u = t[5]);
  let { setupLogs: d, threadEvents: f } = Fn(u),
    m;
  t[6] === a ? (m = t[7]) : ((m = un(a)), (t[6] = a), (t[7] = m));
  let h = m,
    g;
  t[8] !== a.turn_status || t[9] !== f || t[10] !== h
    ? ((g = fn({
        turnStatus: a.turn_status,
        storedEvents: h,
        liveEvents: f,
  ...
  let { data: b } = ie(r, a.id, y),
    x;
  t[14] !== d || t[15] !== b
    ? ((x = b == null ? d : b.logs.flatMap(Wn)), (t[14] = d), (t[15] = b), (t[16] = x))
    : (x = t[16]);
  let S = x,
  ...
  let N = M,
    P;
  t[27] === N ? (P = t[28]) : ((P = p(N, [])), (t[27] = N), (t[28] = P));
  let F = P,
    I;
  t[29] !== k ||
  t[30] !== a.id ||
...
function ir() {
  ...
  let u = l,
    ...
    y = m && h,
    b = !y,
    x = y && r.data != null && d != null,
    S;
  (e[4] === t ? (S = e[5]) : ((S = () => q(t)), (e[4] = t), (e[5] = S)), gt(S));
  let C;
  e[6] === u
    ? (C = e[7])
    : ((C = (0, $.jsx)(vt, { lastTurnCwd: null, lastTurnDiff: u })), (e[6] = u), (e[7] = C));
  let w;
...
function or(e) {
  ...
  let u;
  t[6] !== a || t[7] !== i || t[8] !== r
    ? ((u = r === `hotkey` ? (0, $.jsx)(In, { hostId: a }, i) : (0, $.jsx)(ir, {}, i)),
      (t[6] = a),
      (t[7] = i),
      (t[8] = r),
      (t[9] = u))
  ...
  return (
    t[11] === d
      ? (m = t[12])
      : ((m = (0, $.jsxs)($.Fragment, { children: [p, d] })), (t[11] = d), (t[12] = m)),
    m
  );
}
