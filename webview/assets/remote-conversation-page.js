...
import { T as b, c as x, m as S, u as C } from "./local-conversation-thread.js";
...
import { c as I, o as L } from "./lib-2.js";
import { a as R, g as z } from "./chunk-12.js";
import "./known-app-icon.js";
import { t as B } from "./branch.js";
import { t as ee } from "./github-mark.js";
import "./google-drive-CC-Egn92.js";
import "./notion.js";
import "./persisted-signal-CweW-bgN.js";
import "./rpc-1.js";
import { d as te } from "./thread-side-panel-tabs.js";
import "./statsig.js";
import { n as ne } from "./request.js";
...
import { D as V, T as re, f as ie, v as ae, w as oe } from "./codex-api.js";
import "./use-debounced-value.js";
import { c as H } from "./apps-queries.js";
...
import { a as he } from "./setting-storage.js";
import "./reduced-motion-preference.js";
import { t as ge } from "./spinner.js";
...
import { i as _e, n as ve } from "./thread-detail-level.js";
import "./permissions-mode-defaults.js";
import "./use-permissions-mode.js";
import "./composer-footer.js";
import "./proxy.js";
import { W as ye, a as be } from "./app-shell-state.js";
import { t as xe } from "./app-shell.js";
...
import { A as Ce, B as we, b as Te } from "./review-navigation-model.js";
import { t as Ee } from "./parse-diff.js";
import { o as De } from "./review-file-source-tab.js";
import "./file-diff.js";
...
import { _ as Ae, v as je } from "./process-manager-target-CiTD-21N.js";
...
import { t as Be, u as Ve } from "./composer.js";
import "./upgrade-plan-dialog-launcher.js";
import { f as He, g as Ue, h as We } from "./local-conversation-background-terminals-model.js";
...
import { a as Ke } from "./command-keybindings.js";
import "./expand.js";
...
import "./x-circle.js";
import { n as qe } from "./thinking-shimmer.js";
import "./automation-shared.js";
import "./badge-Bpp-zYoJ.js";
import "./chat.js";
import "./clock.js";
import "./search-C0nm-Ej1.js";
import { t as Je } from "./edit.js";
import { r as Ye, t as Xe } from "./dropdown.js";
import "./globe.js";
import "./set-pinned-thread.js";
import { i as Ze, n as Qe, r as $e, t as et } from "./thread-actions.js";
import "./popover.js";
import "./face.js";
import { t as tt } from "./archive.js";
import { t as nt } from "./three-dots.js";
import "./trash.js";
import "./chevron.js";
...
import { t as rt } from "./cloud.js";
import "./macbook.js";
import "./worktree.js";
import "./thread-env-icon.js";
import "./workspace-root-icon-B5yk-HQ7.js";
import "./warning.js";
import { n as it } from "./format-automation-next-run-label.js";
import "./unselected-circle-BN-IdXY-.js";
import { n as at, t as ot } from "./pull-request-status.js";
...
import { t as ct } from "./image-preview-dialog.js";
import "./pull-request-readonly-comment.js";
import "./pull-request-open.js";
import { n as lt, t as ut } from "./pull-request-status-utils.js";
...
import { i as mt } from "./slash-command-item.js";
...
import { r as ht } from "./diff-stats.js";
...
import { c as Dt, d as Ot, u as kt } from "./user-message-attachments.js";
...
import { t as At } from "./thread-app-shell-chrome-2.js";
var Z = N(),
  jt = e(t(), 1),
  Q = e(v(), 1),
  $ = y();
function Mt(e) {
  ...
  let T;
  t[13] !== S || t[14] !== C
    ? ((T = (0, $.jsxs)(`div`, { className: `flex flex-col gap-px`, children: [S, C] })),
      (t[13] = S),
      (t[14] = C),
      (t[15] = T))
    : (T = t[15]);
  ...
  t[19] === E
    ? (D = t[20])
    : ((D = (0, $.jsx)(Ye.Section, { className: `mt-1 flex flex-col gap-1`, children: E })),
      (t[19] = E),
      (t[20] = D));
  let O;
  t[21] === u
    ? (O = t[22])
    : ((O = u ? (0, $.jsx)(Ye.Section, { className: `mt-2`, children: u }) : null),
      (t[21] = u),
      (t[22] = O));
  let k;
  return (
...
function Ft(e) {
  ...
  let o;
  t[0] === i ? (o = t[1]) : ((o = w(`flex flex-col gap-1.5 text-sm`, i)), (t[0] = i), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
    : ((s = n
...
function zt(e) {
  let t = (0, Z.c)(31),
    ...
    o = k(pe, n),
    s = G(i),
    c = mt(s == null ? void 0 : i?.repo_map?.[s]?.clone_url),
    l = p(m),
    { data: u } = dt(c, l, `remote_conversation_apply_diff`),
    { data: f } = V(),
    h = I(),
    g;
  bb0: {
...
function qt(e) {
        ...
        ? (0, $.jsxs)(`div`, {
            ...
            children: [
              ...
              x
                ...
                : null,
              (0, $.jsx)(Ye.Separator, { paddingClassName: `py-2` }),
              (0, $.jsx)(`div`, {
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (k = t[26]);
  let A;
  t[27] === y ? (A = t[28]) : ((A = (0, $.jsx)(L, { ...y })), (t[27] = y), (t[28] = A));
  let j;
  ...
  return (
    t[54] !== F || t[55] !== I
      ? ((R = (0, $.jsxs)($.Fragment, { children: [F, I] })), (t[54] = F), (t[55] = I), (t[56] = R))
      : (R = t[56]),
    R
  );
}
...
function Yt(e) {
  let t = (0, Z.c)(56),
    { taskId: n, turns: r, selectedTurn: i, diffTaskTurn: o, pullRequests: s, size: c } = e,
    l = c === void 0 ? `toolbar` : c,
    u = D(j),
    d = I(),
    f = he(a.createPullRequestAsDraft),
    p = ie(),
    m = (0, Q.useRef)(!1),
    h = (0, Q.useRef)(null),
  ...
  if (t[0] !== o || t[1] !== i || t[2] !== r) {
    ...
    (i && v.set(i.id, i), o && v.set(o.id, o), (t[0] = o), (t[1] = i), (t[2] = r), (t[3] = v));
  } else v = t[3];
  let y = v,
    b;
  t[4] !== o || t[5] !== i || t[6] !== y
    ? ((b = Qt({ turnById: y, selectedTurn: i, diffTaskTurn: o })),
      (t[4] = o),
      (t[5] = i),
      (t[6] = y),
      (t[7] = b))
  ...
  let x = b,
    ...
    E = !!g && g === w,
    O = !!n && !!w && (p.isPending || T === `creating` || E),
    k = O ? Xt : !1,
    M;
  t[8] !== k || t[9] !== O
    ? ((M = { enabled: O, refetchInterval: k }), (t[8] = k), (t[9] = O), (t[10] = M))
    : (M = t[10]);
  let { data: N } = oe(n, w, M),
    P = N?.turn ?? S,
    F = P?.pull_request_status ?? null,
    R = P?.pull_request_data?.url ?? null,
    z = tn(s, P?.id ?? null, R) ?? tn(s, w, R),
    B = P?.turn_status === `completed`,
    te;
  t[11] !== F || t[12] !== R
    ? ((te = en(F, R)), (t[11] = F), (t[12] = R), (t[13] = te))
    : (te = t[13]);
  let ne = te,
  ...
  (t[14] === R
    ? ((re = t[15]), (ae = t[16]))
    : ((re = () => {
        m.current && R && (A.dispatchMessage(`open-in-browser`, { url: R }), (m.current = !1));
      }),
      (ae = [R]),
      (t[14] = R),
      (t[15] = re),
  ...
  t[23] === R
    ? (se = t[24])
    : ((se = function () {
        R && A.dispatchMessage(`open-in-browser`, { url: R });
      }),
      (t[23] = R),
      (t[24] = se));
  let G = se,
  ...
  if (R) {
    ...
    t[34] === n
      ? (r = t[35])
      : ((r = (0, $.jsx)(at, { className: `icon-xs shrink-0`, status: n })),
        (t[34] = n),
        (t[35] = r));
    let i;
  ...
  let ue;
  return (
    t[50] !== l || t[51] !== ce || t[52] !== J || t[53] !== le || t[54] !== Y
      ? ((ue = (0, $.jsxs)(X, {
          className: `shrink-0`,
          color: `outline`,
          disabled: ce,
...
function Qt({ turnById: e, selectedTurn: t, diffTaskTurn: n }) {
  let r = Array.from(e.values()).filter((e) => !q(e)),
    i = null,
    a = null,
    o = t ? $t(r, e, t) : null;
...
function rn(e) {
  let t = (0, Z.c)(33),
    { conversationId: n } = e,
    r = I(),
    { isPinned: i, togglePin: a } = Ze(n),
    o = k(Ke, `toggleThreadPin`),
    s = k(Ke, `copySessionId`),
    c = i ? Ue : We,
    l = i ? He : it,
    u;
  t[0] === r ? (u = t[1]) : ((u = r.formatMessage($e.moreActions)), (t[0] = r), (t[1] = u));
  let d = u,
    f;
  (t[2] === a ? (f = t[3]) : ((f = [a]), (t[2] = a), (t[3] = f)), P(`toggle-thread-pin`, a, f));
  let p, m;
  (t[4] === n
    ? ((p = t[5]), (m = t[6]))
    : ((p = () => {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, $.jsx)(nt, { className: `icon-sm` })), (t[10] = _))
    : (_ = t[10]);
  let v;
  t[11] === d
    ? (v = t[12])
    : ((v = (0, $.jsx)(X, {
      ...
      (t[12] = v));
  let y;
  t[13] === c ? (y = t[14]) : ((y = (0, $.jsx)(L, { ...c })), (t[13] = c), (t[14] = y));
  let b;
  t[15] !== l || t[16] !== y || t[17] !== a || t[18] !== o
    ? ((b = (0, $.jsx)(Ye.Item, { onSelect: a, LeftIcon: l, keyboardShortcut: o, children: y })),
      (t[15] = l),
      (t[16] = y),
      (t[17] = a),
      (t[18] = o),
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(Ye.Item, {
        disabled: !0,
        LeftIcon: Je,
        children: (0, $.jsx)(L, { ...$e.renameThread }),
      })),
      (t[20] = x))
    : (x = t[20]);
  let S, C;
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(Ye.Item, {
        disabled: !0,
        LeftIcon: tt,
        children: (0, $.jsx)(L, { ...$e.archiveThread }),
      })),
      (C = (0, $.jsx)(Ye.Separator, {})),
      (t[21] = S),
      (t[22] = C))
    : ((S = t[21]), (C = t[22]));
  let w;
  t[23] === n ? (w = t[24]) : ((w = () => Qe(n)), (t[23] = n), (t[24] = w));
  let T;
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(L, { ...$e.copySessionId })), (t[25] = T))
    : (T = t[25]);
  let E;
  t[26] !== s || t[27] !== w
    ? ((E = (0, $.jsx)(Ye.Item, { onSelect: w, LeftIcon: st, keyboardShortcut: s, children: T })),
      (t[26] = s),
      (t[27] = w),
      (t[28] = E))
    : (E = t[28]);
...
function an() {
  ...
  bb0: {
    ...
    if (s) {
      ...
      e[4] === s.output_items
        ? (t = e[5])
        : ((t = s.output_items?.find(on)), (e[4] = s.output_items), (e[5] = t));
      let n = t;
      if (n) {
        u = n;
        break bb0;
  ...
  e[12] === a
    ...
    : ((v = (0, $.jsx)(W, {
        ...
        children: (0, $.jsxs)(X, {
          ...
          size: `toolbar`,
          onClick: () => {
            a && A.dispatchMessage(`open-in-browser`, { url: `${o}/tasks/${a}` });
          },
          children: [
    ...
    getTurns: () =>
      e().flatMap(({ node: e, activeId: t }) => {
        let n = kn(e.userTurn.input_items.filter((e) => e.type === `message`)),
          ...
          i = r == null ? `` : h(kn(r.output_items.filter((e) => e.type === `message`))),
          a = [];
        return (
          n.trim().length > 0 &&
...
var An = c({
  id: l(),
  item_type: r(`log`),
  key: c({ type: r(`UserSetupScript`), created_at: l() }),
  line: l(),
});
function jn(e) {
...
function Bn(e) {
  let t = (0, Z.c)(72),
    ...
    { isFetching: f, isLoading: p } = O(le),
    m = O(ue),
    h = O(de),
    g = O(Ct),
    _ = Ae(`chatgpt.supportsNewChatKeyShortcut`),
    [v, y] = (0, Q.useState)(null),
    { taskId: b } = z(),
    { mutate: x } = ae(b ?? ``),
    S = l?.current_assistant_turn,
    C = l?.current_assistant_turn?.environment,
  ...
  t[4] === b
    ? (R = t[5])
    : ((R = () => {
        b && A.dispatchMessage(`open-in-browser`, { url: `${o}/tasks/${b}` });
      }),
      (t[4] = b),
      (t[5] = R));
  let B = R,
    ...
    te;
  t[6] !== M || t[7] !== ee || t[8] !== l?.task.id || t[9] !== N
    ? ((te = () => {
        M || (l?.task.id && N && ee(l?.task.id ?? null, N));
      }),
      (t[6] = M),
      (t[7] = ee),
      (t[8] = l?.task.id),
  ...
  t[15] === _
    ...
    : ((re = (e) => {
      ...
      (t[16] = re));
  let ie = Ne(re),
    oe = l?.task.title ?? void 0,
    H;
  t[17] === oe
    ? (H = t[18])
    : ((H = (0, $.jsx)(ke, { extension: !0, children: (0, $.jsx)(wt, { title: oe }) })),
      (t[17] = oe),
      (t[18] = H));
  let U;
  t[19] === l
    ? (U = t[20])
    : ((U = (0, $.jsx)(ke, { extension: !0, children: (0, $.jsx)(Hn, { taskDetails: l }) })),
      (t[19] = l),
      (t[20] = U));
  let W;
  t[21] !== M || t[22] !== h || t[23] !== C || t[24] !== b || t[25] !== N
    ? ((W = N && b && h?.id && !M && (0, $.jsx)(Vt, { turnId: h.id, diff: N, taskEnvironment: C })),
      (t[21] = M),
      (t[22] = h),
      (t[23] = C),
      (t[24] = b),
  ...
  t[30] !== T || t[31] !== w || t[32] !== s || t[33] !== a
    ? ((K =
        ...
        (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsx)(Be, { isResponseInProgress: T, showFooterBranchWhen: `always` }),
        })),
      (t[30] = T),
      (t[31] = w),
      (t[32] = s),
    ...
    : (K = t[34]);
  let q;
  t[35] !== W || t[36] !== G || t[37] !== K
    ? ((q = (0, $.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [W, G, K] })),
      (t[35] = W),
      (t[36] = G),
      (t[37] = K),
      (t[38] = q))
  ...
  let fe;
  t[54] !== ce || t[55] !== Y
    ? ((fe = (0, $.jsxs)(`div`, { className: `flex flex-col gap-1.5 pt-2`, children: [ce, Y] })),
      (t[54] = ce),
      (t[55] = Y),
      (t[56] = fe))
    : (fe = t[56]);
  let pe;
  t[57] === b ? (pe = t[58]) : ((pe = (0, $.jsx)(St, {}, b)), (t[57] = b), (t[58] = pe));
  let me;
  t[59] !== g || t[60] !== q || t[61] !== fe || t[62] !== pe
    ? ((me = (0, $.jsxs)(Et, { hasLiveMcpAppFrame: g, footer: q, children: [fe, pe] })),
      (t[59] = g),
      (t[60] = q),
      (t[61] = fe),
      (t[62] = pe),
  ...
  return (
    t[69] !== v || t[70] !== X
      ? ((he = (0, $.jsx)(Ve, { value: v, children: X })), (t[69] = v), (t[70] = X), (t[71] = he))
      : (he = t[71]),
    he
  );
}
...
function Gn({
      ...
      () => ({
        scrollToTurn: async (e, t) => {
          t?.signal?.aborted ||
            (await De(),
            !t?.signal?.aborted &&
              (Kn(u, e)?.scrollIntoView({ block: `center`, behavior: `smooth` }), await De()));
        },
  ...
  return (
    b({ containerRef: u, contextId: m.contextId }),
    l.length === 0
      ? (0, $.jsx)(Ge, { fillParent: !0, debugName: `RemoteConversationThread.groupings` })
      : (0, $.jsxs)($.Fragment, {
          children: [
            (0, $.jsx)(je, { conversationSource: m, diffSource: p }),
            (0, $.jsx)(`div`, {
              ref: u,
...
function qn(e) {
  ...
  t[2] !== o.id || t[3] !== o.turn_status || t[4] !== r
    ? ((d = {
      ...
      (t[5] = d))
    : (d = t[5]);
  let { setupLogs: p, threadEvents: m } = Fn(d),
    h;
  t[6] === o ? (h = t[7]) : ((h = un(o)), (t[6] = o), (t[7] = h));
  let g = h,
    _;
  t[8] !== o.turn_status || t[9] !== m || t[10] !== g
    ? ((_ = fn({
        turnStatus: o.turn_status,
        storedEvents: g,
        liveEvents: m,
    ...
    : (_ = t[11]);
  let v = _,
    y = o.error?.code === `startup_script_failed`,
    b;
  t[12] === y ? (b = t[13]) : ((b = { enabled: y }), (t[12] = y), (t[13] = b));
  let { data: S } = re(r, o.id, b),
    C;
  t[14] !== p || t[15] !== S
    ? ((C = S == null ? p : S.logs.flatMap(Jn)), (t[14] = p), (t[15] = S), (t[16] = C))
    : (C = t[16]);
  let w = C,
    T = o.turn_status === `failed` && y,
    E = v.length === 0 && (o.turn_status === `pending` || o.turn_status === `in_progress`),
    D;
  ...
  let A = k,
    j = r ?? o.id,
    M;
  t[21] !== o || t[22] !== c || t[23] !== j || t[24] !== v || t[25] !== a
    ? ((M = mn({
        taskId: j,
        userTurn: a,
        assistantTurn: o,
  ...
  let N = M,
    P;
  t[27] === N ? (P = t[28]) : ((P = f(N, [])), (t[27] = N), (t[28] = P));
  let F = P,
    I;
  t[29] !== A ||
  t[30] !== o.id ||
  ...
  t[40] === o.turn_status
    ...
    : ((R =
      ...
      (t[41] = R));
  let z;
  t[42] !== o.error?.message || t[43] !== o.turn_status || t[44] !== y
    ? ((z =
        o.turn_status === `failed` && !y
          ? (0, $.jsx)(Xn, { message: o.error?.message ?? null })
          : null),
  ...
  let B;
  return (
    t[46] !== I || t[47] !== R || t[48] !== z
      ? ((B = (0, $.jsxs)($.Fragment, { children: [I, R, z] })),
        (t[46] = I),
        (t[47] = R),
        (t[48] = z),
        (t[49] = B))
...
function Xn(e) {
  ...
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, $.jsx)(ft, { type: `error`, content: r })), (t[2] = r), (t[3] = i)),
    i
  );
}
function Zn(e) {
...
function tr(e) {
  ...
  t[0] === r
    ...
    : ((i =
        r.length > 0
          ? (0, $.jsx)(kt, { className: `text-sm`, children: r })
          : (0, $.jsx)(`span`, {
...
function or(e) {
  let t = (0, Z.c)(24),
    ...
    S;
  (t[0] === r ? (S = t[1]) : ((S = () => te(r)), (t[0] = r), (t[1] = S)), vt(S));
  let C;
  t[2] === c
    ? (C = t[3])
    : ((C = (0, $.jsx)(yt, { lastTurnCwd: null, lastTurnDiff: c })), (t[2] = c), (t[3] = C));
  let w;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(xe.MainContentLayout, { layout: `thread-edge-scroll` })), (t[4] = w))
    : (w = t[4]);
  let T;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(xe.Header, { children: (0, $.jsx)(an, {}) })), (t[5] = T))
    : (T = t[5]);
  let E;
  t[6] !== i || t[7] !== b
    ? ((E = (0, $.jsx)(`div`, {
      ...
      (t[8] = E))
    : (E = t[8]);
  let k = u?.lines_added ?? 0,
    A = u?.lines_removed ?? 0,
    j;
  t[9] !== h || t[10] !== k || t[11] !== A || t[12] !== n
    ? ((j = (0, $.jsx)(At, {
        taskId: n,
        linesAdded: k,
        linesRemoved: A,
  ...
  return (
    t[21] !== g || t[22] !== N
      ? ((P = (0, $.jsx)(Ve, { value: g, children: N })), (t[21] = g), (t[22] = N), (t[23] = P))
      : (P = t[23]),
    P
  );
}
function sr() {
  let e = (0, Z.c)(2),
    t = O(J).data?.current_assistant_turn?.turn_status,
...
function cr(e) {
  let t = (0, Z.c)(13),
    ...
    a = O(_),
    o = O(J).data,
    c = o?.task.task_status_display?.environment_label,
    l;
  if (
    (t[0] !== c || t[1] !== o?.task || t[2] !== i || t[3] !== r
      ? ((l =
          r !== `hotkey` || i == null
            ? null
            : {
