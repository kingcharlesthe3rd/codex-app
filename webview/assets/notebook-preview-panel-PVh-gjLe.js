...
import { aT as d, iT as f } from "./app-initial~app-main~onboarding-page.js";
import {
  Sx as p,
  nx as m,
  rx as h,
...
var N,
  ...
  V = e(() => {
    (l(),
      ...
      (B = r({ cells: n(z), metadata: I.optional() }).passthrough()));
  });
function H(e) {
...
function fe(e) {
  ...
  let y;
  t[13] !== i || t[14] !== a
    ? ((y = (0, $.jsx)(x, { hostId: i, path: a })), (t[13] = i), (t[14] = a), (t[15] = y))
    : (y = t[15]);
  let b;
  ...
  t[20] !== d || t[21] !== _ || t[22] !== b
    ? ((S = (0, $.jsx)(ee, { artifactType: _, centerContent: null, rightContent: b, title: d })),
      (t[20] = d),
      (t[21] = _),
      (t[22] = b),
      (t[23] = S))
...
function ge(e) {
  ...
  return (
    t[22] !== d || t[23] !== h
      ? ((_ = (0, $.jsxs)($.Fragment, { children: [d, h] })), (t[22] = d), (t[23] = h), (t[24] = _))
      : (_ = t[24]),
    _
  );
}
...
var Q, $;
e(() => {
  ((Q = s()), h(), _(), b(), ie(), te(), w(), v(), C(), ne(), d(), V(), de(), ($ = u()));
})();
export { fe as NotebookPreviewPanel };
//# sourceMappingURL=notebook-preview-panel-PVh-gjLe.js.map
