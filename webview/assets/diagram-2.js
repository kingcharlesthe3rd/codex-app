...
import { r as _, u as v } from "./chunk-32.js";
import { n as y, t as b } from "./chunk-17.js";
import { n as x, t as S } from "./mermaid-parser.core-2.js";
import { n as C, t as w } from "./chunk-122.js";
...
e(() => {
  (g(),
    ...
    r(),
    S(),
    (T = new w(() => ({ cnt: 1, stack: [{ id: 0, level: -1, name: `/`, children: [] }] }))),
    (E = n(() => {
      (T.reset(), u());
    }, `clear`)),
    ...
    (A = {
      clear: E,
      addNode: n((e, t) => {
        for (; e <= T.records.stack[T.records.stack.length - 1].level;) T.records.stack.pop();
        let n = { id: T.records.cnt++, level: e, name: t, children: [] };
        (T.records.stack[T.records.stack.length - 1].children.push(n), T.records.stack.push(n));
      }, `addNode`),
      getRoot: D,
      getCount: O,
    ...
    (j = n((e) => {
      (y(e, A), e.nodes.map((e) => A.addNode(e.indent ? parseInt(e.indent) : 0, e.name)));
    }, `populate`)),
    (M = {
      parse: n(async (e) => {
...
` + e,
        ...
        (c.attr(`viewBox`, `-${s.lineThickness / 2} 0 ${f} ${u}`), d(c, u, f, s.useMaxWidth));
      }, `draw`),
    }),
...
export { R as diagram };
//# sourceMappingURL=diagram-2.js.map
