...
import { F as i } from "./rpc-Hf-fxjh7.js";
import { n as a } from "./local-environments.js";
var o = e(),
  s = r(`local-env-selections-by-workspace`, {});
function c(e) {
  let t = a(e),
    n = t?.configPath ?? null,
    r = n ? i(n) : null;
...
function u({
  ...
  let o = l(a, n),
    ...
    f = s?.configPath ?? null,
    p = o != null && Object.prototype.hasOwnProperty.call(r, o),
    m = null;
  o && p && (m = r[o] ?? null);
  let h = m ? i(m) : null,
    g = e && h != null && t.some((e) => i(e.configPath) === h),
    _ = p ? m : null;
  e && p && m != null && !g && (_ = f);
  let v = _ ? i(_) : null;
  return {
