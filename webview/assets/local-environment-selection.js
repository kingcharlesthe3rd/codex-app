import { $s as e, Ps as t, Va as n } from "./app-server-manager-signals.js";
...
function f(t) {
  let n = (0, o.c)(37),
    ...
    [c, f] = e(s),
    m;
  n[0] !== i || n[1] !== a ? ((m = l(a, i)), (n[0] = i), (n[1] = a), (n[2] = m)) : (m = n[2]);
  let h = m,
    g = a ?? ``,
    _;
  n[3] !== i || n[4] !== g
    ? ((_ = { hostId: i, workspaceRoot: g }), (n[3] = i), (n[4] = g), (n[5] = _))
    : (_ = n[5]);
  let v = h != null,
    y;
  ...
  let b;
  n[8] !== _ || n[9] !== y
    ? ((b = { params: _, queryConfig: y, select: p }), (n[8] = _), (n[9] = y), (n[10] = b))
    : (b = n[10]);
  let { data: x, isLoading: S, isFetching: C, error: w } = r(`local-environments`, b),
    T,
    E;
  n[11] !== w ||
  n[12] !== i ||
