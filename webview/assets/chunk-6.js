import { h as e, o as t } from "./chunk-16.js";
  ...
  pe = {
    ...
    draw: n(async function (t, n, i, a) {
      ...
      ((u.type = a.type),
        ...
        await h(u, d));
      try {
        (typeof a.db.getLinks == `function` ? a.db.getLinks() : new Map()).forEach((e, t) => {
      ...
      (e.insertTitle(d, `statediagramTitleText`, s?.titleTopMargin ?? 25, a.db.getDiagramTitle()),
...
var X = n((e, t, n, i, a, o, s, c) => {
    ...
    if ((r.info(`dataFetcher parsedItem`, t, f, m), d !== `root`)) {
      ...
      if (
        ...
        e &&
          e.id !== `root` &&
          (r.trace(`Setting node `, d, ` to be child of its parent `, e.id), (f.parentId = e.id)),
        (f.centerLabel = !0),
        t.note)
      ) {
        let e = {
  ...
  ve = class {
    ...
    addState(e, t = D, n = void 0, i = void 0, a = void 0, o = void 0, s = void 0, c = void 0) {
      ...
      (o &&
        ...
        c &&
          (r.info(`Setting state styles`, d, s),
          (Array.isArray(c) ? c : [c]).forEach((e) => this.setTextStyle(d, e.trim()))));
    }
    clear(e) {
      ((this.nodes = []),
        (this.edges = []),
    ...
    addLink(e, t, n) {
      (this.links.set(e, { url: t, tooltip: n }), r.warn(`Adding link`, e, t, n));
    }
    getLinks() {
      return this.links;
    }
