...
function h(e) {
  ...
  return (
    t[5] !== r || t[6] !== c
      ? ((l = (0, b.jsx)(`div`, { className: c, children: r })), (t[5] = r), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
function g(e) {
  ...
  let g;
  t[8] !== m || t[9] !== h
    ? ((g = (0, b.jsxs)(`span`, { className: `flex min-w-0 flex-1 flex-col`, children: [m, h] })),
      (t[8] = m),
      (t[9] = h),
      (t[10] = g))
    : (g = t[10]);
...
function _(e) {
  let t = (0, y.c)(13),
    { label: n, matchDropdownWidth: r, matchDropdownWidthLabel: i, size: a, showChevron: s } = e,
    c = r === void 0 ? !1 : r,
  ...
  t[2] !== n || t[3] !== c || t[4] !== i || t[5] !== u
    ? ((m = c
        ? (0, b.jsxs)(`span`, {
            ...
            children: [
              (0, b.jsxs)(`span`, {
                ...
                children: [i ?? n, (0, b.jsx)(l, { className: `icon-2xs shrink-0` })],
              }),
              (0, b.jsx)(`span`, {
        ...
        : (0, b.jsx)(`span`, { className: o(`flex items-center font-medium`, w[u]), children: n })),
      (t[2] = n),
      (t[3] = c),
      (t[4] = i),
      (t[5] = u),
  ...
  t[7] === d
    ...
    : ((h = d
        ? (0, b.jsx)(`span`, {
            ...
            children: (0, b.jsx)(l, { className: `icon-2xs self-center text-token-text-tertiary` }),
          })
        : null),
      (t[7] = d),
      (t[8] = h));
...
function v(e) {
  ...
  let c;
  t[2] === s ? (c = t[3]) : ((c = (0, b.jsx)(l, { className: s })), (t[2] = s), (t[3] = c));
  let u;
  return (
...
var y,
  ...
  T = e(() => {
    ((y = r()),
      ...
      u(),
      (b = n()),
      (x = { default: `px-[var(--thread-resource-card-row-padding-x)] py-3`, compact: `p-1.5` }),
      (S = {
      ...
      (w = { default: `px-2 py-1`, medium: `px-4 py-1.5`, toolbar: `px-2 py-0` }));
  });
export {
  T as a,
  p as c,
