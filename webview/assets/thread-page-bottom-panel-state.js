...
import { C as n, D as r } from "./src-2.js";
import { oo as i, uo as a } from "./app-server-manager-signals.js";
import { n as o, t as s } from "./jsx-runtime.js";
import { F as c, L as l, f as u, h as d, lt as f } from "./vscode-api.js";
import { o as p } from "./lib-2.js";
import { t as m } from "./route-scope.js";
import { t as h } from "./button.js";
import { a as g, t as _ } from "./setting-storage.js";
import { n as v, o as y, r as b } from "./app-shell-state.js";
...
import { t as A } from "./terminal.js";
import { t as j } from "./app-intl-signal-B.js";
import {
  a as te,
  c as M,
  n as ne,
...
import { t as F } from "./error-boundary.js";
import { n as I } from "./check-git-index-for-changes.js";
import { t as ae } from "./font-settings.js";
import { n as oe, r as se } from "./use-resolved-theme-variant.js";
import { i as ce, n as L, r as R } from "./thread-panel-state.js";
              ...
              (typeof self < `u` ? self : typeof window < `u` ? window : n.g !== void 0 && n.g,
                (e.exports = (function () {
                  var e,
                    ...
                    M = function () {
                      var e = function (e, t) {
                        return Object.defineProperty(String.prototype, e, te(t));
                      };
                    ...
                    ne = function () {
                      var e = function (e, t) {
                        return Object.defineProperty(Uint8Array.prototype, e, te(t));
                      };
                      (e(`toBase64`, function (e) {
                        return g(this, e);
                      }),
      ...
      : ((o = (0, H.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, H.jsx)(`div`, {
              ...
              children: (0, H.jsx)(h, { color: `secondary`, onClick: n, children: a }),
            }),
          ],
        })),
        (t[3] = n),
...
function ue({
  ...
  if (n != null && X(t, [`t`])) return (q(t), n(), !1);
  if (e != null) {
    if (J(t, a.hasSelection())) {
      q(t);
  ...
  let o = de(t);
  return o == null ? !0 : (q(t), i(o), !1);
}
function q(e) {
  (e.preventDefault(), e.stopPropagation());
}
function J(e, t) {
  return (t && pe(e, `c`)) || fe(e, `c`) || me(e, { ctrlKey: !0, shiftKey: !1 });
}
function Y(e, t) {
  return (t && pe(e, `v`)) || fe(e, `v`) || me(e, { ctrlKey: !1, shiftKey: !0 });
}
function de(e) {
...
function be(e) {
  let t = (0, V.c)(5),
    ...
    i = r ?? n,
    a;
  t[0] === e ? (a = t[1]) : ((a = (0, H.jsx)(Se, { ...e })), (t[0] = e), (t[1] = a));
  let o;
  return (
    t[2] !== i || t[3] !== a
      ? ((o = (0, H.jsx)(F, { name: `TerminalPanel`, fallback: xe, children: a }, i)),
        (t[2] = i),
        (t[3] = a),
        (t[4] = o))
      : (o = t[4]),
...
function Se(e) {
  let t = (0, V.c)(50),
    ...
    d = se(oe()),
    f = u !== `macOS`,
    p = g(r.lightChromeTheme),
    m = g(r.darkChromeTheme),
    h = g(r.codeFontSize),
    _,
    v,
    y,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (z = t[20]);
  let B;
  (t[21] !== _ || t[22] !== d ? ((B = [_, d]), (t[21] = _), (t[22] = d), (t[23] = B)) : (B = t[23]),
    (0, Z.useEffect)(z, B));
  let U, W;
  (t[24] !== v || t[25] !== y || t[26] !== C
    ? ((U = () => {
        let e = E.current;
        if (!e) return;
        let t = !1;
  ...
  t[36] !== f
    ? ((G = () => {
        ...
        E.current = p;
        let g = new he.ClipboardAddon(),
          _ = new ge.FitAddon();
        D.current = _;
        let v = new _e.WebLinksAddon(we);
        (p.loadAddon(g),
          p.loadAddon(_),
          p.loadAddon(v),
        ...
        let y = () => {
          d ||
            (e.isConnected &&
              requestAnimationFrame(() => {
                d || (e.isConnected && (k.current ? ye(p, _, a) : _.fit()));
              }));
        };
        y();
        let b = i.register(a, {
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((J = (0, H.jsx)(`div`, {
        ...
        children: (0, H.jsx)(`div`, { className: `h-full w-full overflow-hidden`, ref: T }),
      })),
      (t[47] = J))
    : (J = t[47]);
  let Y;
...
function we(e, t) {
  t && (e.preventDefault?.(), u.dispatchMessage(`open-in-browser`, { url: t }));
}
function Te(e) {
  let t = (0, V.c)(3),
    { conversationId: n } = e,
  ...
  return (
    t[0] === n
      ? ((r = t[1]), (a = t[2]))
      : ((r = (e) => (n == null ? De : i.subscribeToConversation(n, e))),
        (a = () => (n == null ? null : i.getConversationSnapshot(n))),
        (t[0] = n),
        (t[1] = r),
        (t[2] = a)),
    (0, Z.useSyncExternalStore)(r, a, Ee)
  );
}
function Ee() {
  return null;
...
function Oe(e) {
  ...
  let f;
  return (
    t[5] !== n || t[6] !== r || t[7] !== i || t[8] !== a || t[9] !== s || t[10] !== d
      ? ((f = (0, H.jsx)(be, {
          conversationId: n,
          conversationTitle: r,
          cwd: i,
...
var ke = `terminal:`,
  ...
  Ae = l(m, ({ get: e }) => {
    let t = e(w.activeTab$);
    return e(b) && t != null && et(t.tabId);
  }),
  je = l(m, ({ get: e }) => {
    let t = e(C.activeTab$);
    return e(y) && t != null && et(t.tabId);
  }),
  Me = l(d, ({ get: e }) => _(e, n.defaultTerminalLocation)),
  Ne = l(m, ({ get: e }) => (e(v) === !1 ? `right` : e(Me)));
function Pe(e) {
  (L(e, `right`), requestAnimationFrame(k));
}
function Fe(e) {
  Le(e, `bottom`);
}
function Ie(e, t, n = We(e)) {
  (Le(e, t == null ? n : Ge(e, t, n), t), t != null && requestAnimationFrame(() => O()));
}
function Le(e, t, n) {
  let r = Qe(e);
  if (r == null) return;
  let a = i.getConversationSnapshot(r.conversationId);
  n != null && !a?.sessionIds.includes(n) && i.addSessionForConversation(r.conversationId, n);
  let o = n ?? Xe(e, t, a?.sessionIds ?? []) ?? i.addSessionForConversation(r.conversationId);
  (i.setActiveSessionForConversation(r.conversationId, o), Je(e, r, t), Ke(e, r, o, !0, t, o));
}
function Re(e) {
  return Qe(e) != null;
}
...
function Ke(e, t, n, r, a, o) {
  ...
  for (let [n, r] of d.entries()) {
    let o = $(r),
      c = z(s?.tabTitlesBySessionId[r], s?.cwdBySessionId[r] || t.cwd, n, d.length, l),
      p = f.get(o);
    if (p != null) {
    ...
    u.openTab(e, Oe, {
      ...
      id: o,
      title: c,
      props: { ...t, onNewTerminalTab: a === `bottom` ? ze : Be, sessionId: r },
    });
  }
  r && (u.activateTab(e, $(n)), ce(e, a));
}
function qe(e, t, n, r) {
  let a = R(r);
...
function Je(e, t, n) {
  ...
  let o = i.subscribeToConversation(t.conversationId, () => {
    ...
    let a = Q.get(r);
    if (a != null) for (let t of a.panels) Ke(e, a.target, n.activeSessionId, !1, t);
  });
  Q.set(r, { panels: new Set([n]), target: t, unsubscribe: o });
}
function Ye(e, t, n) {
  let r = R(n),
    i = new Set(t.map($));
...
function $e(e) {
  return e?.startsWith(ke) ? e.slice(9) : null;
}
function et(e) {
  return e.startsWith(ke);
}
export { Ae as a, Ve as i, Ie as n, Ne as o, ze as r, Ue as s, Re as t };
