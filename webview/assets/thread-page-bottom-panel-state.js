...
import { Ro as c } from "./app-server-manager-signals.js";
import { f as l } from "./vscode-api.js";
import { A as u, T as d } from "./src-1.js";
import { o as f } from "./lib.js";
...
import { A as y } from "./rpc-1.js";
import { t as b } from "./route-scope.js";
import { t as x } from "./use-platform.js";
import { g as S, h as C } from "./diff-view-mode.js";
import { n as w, t as T } from "./app-shell-tab-controller.js";
import { t as E } from "./local-conversation-title-signals.js";
import { i as D, n as O } from "./thread-context.js";
import { n as k, t as A } from "./focus-composer.js";
import { i as j, o as M, r as N } from "./thread-panel-state.js";
import { t as P } from "./terminal-C.js";
import { t as F } from "./app-intl-signal-D.js";
import { t as I } from "./error-boundary.js";
import { n as L } from "./check-git-index-for-changes.js";
                ...
                m = (t.DomRendererRowFactory = class {
                  ...
                  createRow(e, t, n, r, i, s, c, u, f, m, g) {
                    ...
                    for (let N = 0; N < x; N++) {
                      ...
                      let R = I.getChars() || o.WHITESPACE_CELL_CHAR;
                      if (
                        (R === ` ` && (I.isUnderline() || I.isOverline()) && (R = `\xA0`),
                        (A = x * u - f.get(R, I.isBold(), I.isItalic())),
                        b)
                      ) {
                        if (
                          S &&
                          ...
                          (I.isInvisible() ? (C += o.WHITESPACE_CELL_CHAR) : (C += R), S++);
                          continue;
                        }
                        (S && (b.textContent = C),
      ...
      : ((o = (0, W.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, W.jsx)(`div`, {
              ...
              children: (0, W.jsx)(g, { color: `secondary`, onClick: n, children: a }),
            }),
          ],
        })),
        (t[3] = n),
...
function ie({
  ...
  if (n != null && Q(t, [`t`])) return (Y(t), n(), !1);
  if (e != null) {
    if (X(t, a.hasSelection())) {
      Y(t);
  ...
  let o = ae(t);
  return o == null ? !0 : (Y(t), i(o), !1);
}
function Y(e) {
  (e.preventDefault(), e.stopPropagation());
}
function X(e, t) {
  return (t && se(e, `c`)) || oe(e, `c`) || ce(e, { ctrlKey: !0, shiftKey: !1 });
}
function Z(e, t) {
  return (t && se(e, `v`)) || oe(e, `v`) || ce(e, { ctrlKey: !1, shiftKey: !0 });
}
function ae(e) {
  return Q(e, [`ArrowLeft`, `ArrowUp`])
    ? K
    : Q(e, [`ArrowRight`, `ArrowDown`])
      ? q
      : Q(e, [`Backspace`])
        ? re
        : Q(e, [`Delete`])
...
function ye(e) {
  let t = (0, U.c)(5),
    ...
    i = r ?? n,
    a;
  t[0] === e ? (a = t[1]) : ((a = (0, W.jsx)(xe, { ...e })), (t[0] = e), (t[1] = a));
  let o;
  return (
    t[2] !== i || t[3] !== a
      ? ((o = (0, W.jsx)(I, { name: `TerminalPanel`, fallback: be, children: a }, i)),
        (t[2] = i),
        (t[3] = a),
        (t[4] = o))
      : (o = t[4]),
...
function xe(e) {
  let t = (0, U.c)(50),
    ...
    d = ne(te()),
    f = l !== `macOS`,
    p = _(u.lightChromeTheme),
    m = _(u.darkChromeTheme),
    h = _(u.codeFontSize),
    g,
    v,
    y,
  ...
  (t[16] !== g || t[17] !== d
    ? ((z = () => {
      ...
      (t[19] = B))
    : ((z = t[18]), (B = t[19])),
    (0, $.useLayoutEffect)(z, B));
  let V;
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = () => {
        let e = D.current,
          t = T.current;
        !e || !t || ((e.options.theme = pe(t)), e.rows > 0 && e.refresh(0, e.rows - 1));
      }),
      (t[20] = V))
    : (V = t[20]);
  let H;
  (t[21] !== g || t[22] !== d ? ((H = [g, d]), (t[21] = g), (t[22] = d), (t[23] = H)) : (H = t[23]),
    (0, $.useEffect)(V, H));
  let G, K;
  (t[24] !== v || t[25] !== y || t[26] !== w
    ? ((G = () => {
        let e = D.current;
        if (!e) return;
        let t = !1;
    ...
    ? ((q = () => {
        ...
        let y = () => {
          d ||
            (e.isConnected &&
              requestAnimationFrame(() => {
                d || (e.isConnected && (A.current ? ve(p, _, u) : _.fit()));
              }));
        };
        y();
        let b = c.register(u, {
  ...
  t[44] !== f
    ...
    : (J = t[45]),
    (0, $.useEffect)(q, J));
  let re = o == null ? void 0 : `terminal-panel-${o}`,
    Y;
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((X = (0, W.jsx)(`div`, {
        ...
        children: (0, W.jsx)(`div`, { className: `h-full w-full overflow-hidden`, ref: E }),
      })),
      (t[47] = X))
    : (X = t[47]);
  let Z;
...
function we(e) {
  ...
  return (
    t[0] === n
      ? ((r = t[1]), (i = t[2]))
      : ((r = (e) => (n == null ? Ee : c.subscribeToConversation(n, e))),
        (i = () => (n == null ? null : c.getConversationSnapshot(n))),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i)),
    (0, $.useSyncExternalStore)(r, i, Te)
  );
}
function Te() {
  return null;
...
var Oe = `terminal:`,
  ...
  Ae = a(b, ({ get: e }) => {
    let t = e(T.activeTab$);
    return e(h) && t != null && tt(t.tabId);
  }),
  je = a(b, ({ get: e }) => {
    let t = e(w.activeTab$);
    return e(m) && t != null && tt(t.tabId);
  }),
  Me = a(s, ({ get: e }) => v(e, d.defaultTerminalLocation)),
  Ne = a(b, ({ get: e }) => (e(p) === !1 ? `right` : e(Me)));
function Pe(e) {
  (N(e, `right`), requestAnimationFrame(A));
}
function Fe(e) {
  Le(e, `bottom`);
}
function Ie(e, t, n = We(e)) {
  return Le(e, t == null ? n : Ge(e, t, n), t);
}
function Le(e, t, n) {
  let r = Qe(e);
  ...
  let a = n ?? Xe(e, t, i?.sessionIds ?? []) ?? c.addSessionForConversation(r.conversationId);
  return (
    c.setActiveSessionForConversation(r.conversationId, a), Je(e, r, t), Ke(e, r, a, !0, t, a), a
  );
}
function Re(e) {
  return Qe(e) != null;
...
function Ge(e, t, n) {
  let r = $e(t);
  return e.get(T.tabs$).some((e) => e.tabId === r)
    ? `bottom`
    : e.get(w.tabs$).some((e) => e.tabId === r)
      ? `right`
      : n;
}
function Ke(e, t, n, r, i, a) {
  ...
  for (let [n, r] of d.entries()) {
    let a = $e(r),
      s = R(o?.tabTitlesBySessionId[r], o?.cwdBySessionId[r] || t.cwd, n, d.length, l),
      p = f.get(a);
    if (p != null) {
      ...
      onMove: (e, n) => {
        ...
        return (
          Je(e, t, i),
          {
            ...
            props: { ...t, onNewTerminalTab: i === `bottom` ? ze : Be, sessionId: r },
          }
        );
      },
      id: a,
...
function Je(e, t, n) {
  ...
  let a = c.subscribeToConversation(t.conversationId, () => {
    ...
    let i = ke.get(r);
    if (i != null) for (let t of i.panels) Ke(e, i.target, n.activeSessionId, !1, t);
  });
  ke.set(r, { panels: new Set([n]), target: t, unsubscribe: a });
}
function Ye(e, t, n) {
  let r = j(n),
    i = new Set(t.map($e));
  for (let t of e.get(r.tabs$)) tt(t.tabId) && !i.has(t.tabId) && r.closeTab(e, t.tabId);
  e.get(r.tabs$).length === 0 && N(e, n);
}
function Xe(e, t, n) {
  let r = new Set(n),
    i = j(t),
    a = et(e.get(i.activeTab$)?.tabId ?? null);
  ...
  switch (e.value.routeKind) {
    ...
    case `local-thread`:
      return {
        ...
        conversationTitle: e.get(E, e.value.conversationId),
        cwd: e.get(O),
        hostId: e.get(D),
      };
