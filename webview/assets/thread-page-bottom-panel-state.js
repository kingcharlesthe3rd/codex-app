...
import { Z as i, c as a, o, t as s } from "./app-scope-CWE-zIhQ.js";
import { sa as c } from "./thread-context-inputs.js";
import { f as l } from "./vscode-api.js";
import { k as u, w as d } from "./src.js";
import { s as f } from "./lib-1.js";
...
import { A as b } from "./rpc.js";
import { f as x } from "./persisted-signal.js";
import { t as S } from "./use-platform.js";
import { g as C, h as w } from "./diff-view-mode.js";
import { r as T, t as E } from "./app-shell-tab-controller.js";
import { t as D } from "./local-conversation-title-signals.js";
import { i as O, n as k } from "./thread-context.js";
import { n as A, t as j } from "./focus-composer.js";
import { i as M, o as N, r as P } from "./thread-panel-state.js";
...
import { n as te, r as ne } from "./use-resolved-theme-variant-D.js";
...
var je = `terminal:`,
  ...
  Fe = a(s, ({ get: e }) => v(e, d.defaultTerminalLocation)),
  Ie = a(x, ({ get: e }) => (e(p) === !1 ? `right` : e(Fe)));
function Le(e) {
  (P(e, `right`), requestAnimationFrame(j));
}
function Re(e) {
  Be(e, `bottom`);
}
...
function Je(e, t, n) {
  let r = nt(t);
  return e.get(E.tabs$).some((e) => e.tabId === r)
    ? `bottom`
    : e.get(T.tabs$).some((e) => e.tabId === r)
      ? `right`
      : n;
}
  ...
  switch (e.value.routeKind) {
    ...
    case `local-thread`:
      return {
        ...
        conversationTitle: e.get(D, e.value.conversationId),
        cwd: e.get(k),
        hostId: e.get(O),
      };
