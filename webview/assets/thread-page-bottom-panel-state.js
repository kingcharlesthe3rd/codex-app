...
import { Ia as r, Ma as i } from "./app-server-manager-signals.js";
import { n as a, t as o } from "./jsx-runtime.js";
import { Q as s, U as c, X as l, a as u, wt as d, y as f } from "./setting-storage.js";
...
import { i as T, n as E } from "./thread-context.js";
...
import { n as P } from "./check-git-index-for-changes.js";
import { t as ie } from "./font-settings.js";
import { n as ae, r as oe } from "./use-resolved-theme-variant.js";
import { n as F, r as I, t as L } from "./thread-panel-state-fkSg-C_s.js";
      ...
      : ((o = (0, B.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, B.jsx)(`div`, {
              ...
              children: (0, B.jsx)(m, { color: `secondary`, onClick: n, children: a }),
            }),
          ],
        })),
        (t[3] = n),
...
function ge(e) {
  let t = (0, z.c)(5),
    ...
    i = r ?? n,
    a;
  t[0] === e ? (a = t[1]) : ((a = (0, B.jsx)(ve, { ...e })), (t[0] = e), (t[1] = a));
  let o;
  return (
    t[2] !== i || t[3] !== a
      ? ((o = (0, B.jsx)(N, { name: `TerminalPanel`, fallback: _e, children: a }, i)),
        (t[2] = i),
        (t[3] = a),
        (t[4] = o))
      : (o = t[4]),
...
function ve(e) {
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (H = t[20]);
  let U;
  (t[21] !== _ || t[22] !== f ? ((U = [_, f]), (t[21] = _), (t[22] = f), (t[23] = U)) : (U = t[23]),
    (0, Q.useEffect)(H, U));
  let W, G;
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Y = (0, B.jsx)(`div`, {
        ...
        children: (0, B.jsx)(`div`, { className: `h-full w-full overflow-hidden`, ref: T }),
      })),
      (t[47] = Y))
    : (Y = t[47]);
  let X;
...
function je(e, t) {
  (Me(e, t == null ? ze(e) : Be(e, t), t), t != null && requestAnimationFrame(C));
}
function Me(e, t, n) {
  let r = qe(e);
  if (r == null) return;
  ...
  let o = n ?? Ge(e, t, a?.sessionIds ?? []) ?? i.addSessionForConversation(r.conversationId);
  (i.setActiveSessionForConversation(r.conversationId, o), Ue(e, r, t), Ve(e, r, o, !0, t, o));
}
function Ne(e) {
  return qe(e) != null;
}
...
function Ve(e, t, n, r, a, o) {
  ...
  for (let [n, r] of d.entries()) {
    let o = Je(r),
      c = se(s?.tabTitlesBySessionId[r], s?.cwdBySessionId[r] || t.cwd, n, d.length, l),
      p = f.get(o);
    if (p != null) {
...
function We(e, t, n) {
  let r = F(n),
    i = new Set(t.map(Je));
  for (let t of e.get(r.tabs$)) Xe(t.tabId) && !i.has(t.tabId) && r.closeTab(e, t.tabId);
