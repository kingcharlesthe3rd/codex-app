...
import { i as fe, n as pe } from "./isEmpty-2.js";
import { _ as O } from "./chunk-128.js";
import { t as k } from "./graphlib-4.js";
function me(e) {
...
var z = n(function (t, n) {
    ...
    var r = n.length;
    return (
      r > 1 && e(t, n[0], n[1]) ? (n = []) : r > 2 && e(n[0], n[1], n[2]) && (n = [n[0]]),
      Oe(t, te(n, 1), [])
    );
  }),
  tt = 0;
...
function yt(e, t, n, r) {
  ...
  return (arguments.length >= 4 && ((i.rank = n), (i.order = r)), U(e, `border`, i, t));
}
function bt(e) {
  return M(
    w(e.nodes(), function (t) {
...
function wt(e) {
  function t(n) {
    var r = e.children(n),
      i = e.node(n);
    if ((r.length && S(r, t), Object.prototype.hasOwnProperty.call(i, `minRank`))) {
      ((i.borderLeft = []), (i.borderRight = []));
      for (var a = i.minRank, o = i.maxRank + 1; a < o; ++a)
        (Tt(e, `borderLeft`, `_bl`, n, i, a), Tt(e, `borderRight`, `_br`, n, i, a));
    }
  }
  S(e.children(), t);
}
...
function Dt(e) {
  var t = e.graph().rankdir.toLowerCase();
  ((t === `bt` || t === `rl`) && At(e), (t === `lr` || t === `rl`) && (jt(e), Ot(e)));
}
function Ot(e) {
...
function It(e, t) {
  function n(r) {
    S(t.nodeEdges(r), function (i) {
      var a = i.v,
        o = r === a ? i.w : a;
      !e.hasNode(o) && !J(t, i) && (e.setNode(o, {}), e.setEdge(r, o, {}), n(o));
    });
  }
...
function zt(e) {
  ...
  function i(a) {
    ...
    Object.prototype.hasOwnProperty.call(t, a) ||
      ((n[a] = !0), (t[a] = !0), S(e.predecessors(a), i), delete n[a], r.push(a));
  }
...
function un(e, t, n) {
  var r = dn(e),
    i = new k({ compound: !0 }).setGraph({ root: r }).setDefaultNodeLabel(function (t) {
      return e.node(t);
    });
  return (
...
function _n(e) {
  ...
  function n(e) {
    return function (t) {
      t.merged ||
        ((x(t.barycenter) || x(e.barycenter) || t.barycenter >= e.barycenter) && vn(e, t));
    };
  }
  function r(t) {
    return function (n) {
...
function Sn(e, t, n, r) {
  ...
  S(l, function (t) {
    if (e.children(t.v).length) {
      var i = Sn(e, t.v, n, r);
      ((c[t.v] = i), Object.prototype.hasOwnProperty.call(i, `barycenter`) && wn(t, i));
    }
  });
  var u = gn(l, n);
  Cn(u, c);
  ...
  if (o && ((d.vs = T([o, d.vs, s])), e.predecessors(o).length)) {
    ...
    (Object.prototype.hasOwnProperty.call(d, `barycenter`) || ((d.barycenter = 0), (d.weight = 0)),
      (d.barycenter = (d.barycenter * d.weight + f.order + p.order) / (d.weight + 2)),
      (d.weight += 2));
  }
  return d;
}
...
var Zn = [`nodesep`, `edgesep`, `ranksep`, `marginx`, `marginy`],
  ...
  rr = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: `r` },
  ir = [`labelpos`];
function ar(e) {
...
function sr(e) {
  S(e.edges(), function (t) {
    ...
    if (n.width && n.height) {
      var r = e.node(t.v);
      U(e, `edge-proxy`, { rank: (e.node(t.w).rank - r.rank) / 2 + r.rank, e: t }, `_ep`);
    }
  });
}
function cr(e) {
