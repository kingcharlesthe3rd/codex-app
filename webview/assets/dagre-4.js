...
import { At as t, ht as n, n as r } from "./merge-1.js";
import {
  B as i,
  D as a,
  E as o,
...
import { n as O, r as ne, t as k } from "./graphlib-DwAx-mHa.js";
function re(e) {
...
function ve(e, t, n, r) {
  ...
  return (arguments.length >= 4 && ((i.rank = n), (i.order = r)), N(e, `border`, i, t));
}
function ye(e) {
  return _(
    b(e.nodes(), function (t) {
...
function Ce(e) {
  function t(n) {
    var r = e.children(n),
      i = e.node(n);
    if ((r.length && d(r, t), Object.prototype.hasOwnProperty.call(i, `minRank`))) {
      ((i.borderLeft = []), (i.borderRight = []));
      for (var a = i.minRank, o = i.maxRank + 1; a < o; ++a)
        (we(e, `borderLeft`, `_bl`, n, i, a), we(e, `borderRight`, `_br`, n, i, a));
    }
  }
  d(e.children(), t);
}
...
function De(e) {
  var t = e.graph().rankdir.toLowerCase();
  ((t === `bt` || t === `rl`) && Ae(e), (t === `lr` || t === `rl`) && (je(e), Oe(e)));
}
function Oe(e) {
...
function Ie(e, t) {
  function n(r) {
    d(t.nodeEdges(r), function (i) {
      var a = i.v,
        o = r === a ? i.w : a;
      !e.hasNode(o) && !H(t, i) && (e.setNode(o, {}), e.setEdge(r, o, {}), n(o));
    });
  }
...
function Ve(e) {
  ...
  function i(a) {
    ...
    Object.prototype.hasOwnProperty.call(t, a) ||
      ((n[a] = !0), (t[a] = !0), d(e.predecessors(a), i), delete n[a], r.push(a));
  }
...
function St(e, t, n) {
  var r = Ct(e),
    i = new O({ compound: !0 }).setGraph({ root: r }).setDefaultNodeLabel(function (t) {
      return e.node(t);
    });
  return (
    d(e.nodes(), function (a) {
      ...
      (o.rank === t || (o.minRank <= t && t <= o.maxRank)) &&
        ...
        Object.prototype.hasOwnProperty.call(o, `minRank`) &&
          i.setNode(a, { borderLeft: o.borderLeft[t], borderRight: o.borderRight[t] }));
    }),
    i
  );
}
...
function Nt(e) {
  ...
  function n(e) {
    return function (t) {
      t.merged ||
        ((E(t.barycenter) || E(e.barycenter) || t.barycenter >= e.barycenter) && Pt(e, t));
    };
  }
  function r(t) {
    return function (n) {
...
function Bt(e, t, n, r) {
  ...
  d(f, function (t) {
    if (e.children(t.v).length) {
      var i = Bt(e, t.v, n, r);
      ((l[t.v] = i), Object.prototype.hasOwnProperty.call(i, `barycenter`) && Ht(t, i));
    }
  });
  var p = Mt(f, n);
  Vt(p, l);
...
function Cn(e) {
  d(e.edges(), function (t) {
    ...
    if (n.width && n.height) {
      var r = e.node(t.v);
      N(e, `edge-proxy`, { rank: (e.node(t.w).rank - r.rank) / 2 + r.rank, e: t }, `_ep`);
    }
  });
}
function wn(e) {
