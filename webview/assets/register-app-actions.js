...
var W = e(() => {
  ...
  Qe = e(() => {
    (r(),
      ...
      R(),
      W(),
      (G = t({ type: a(`app.appearance.set_mode`), mode: m([`light`, `dark`, `system`]) })),
      (K = L({
        schema: G,
        run: async ({ mode: e }, t) => (
...
function tt(e) {
  return e === `light`
    ? { chromeThemeSetting: p.lightChromeTheme, codeThemeSetting: p.lightCodeThemeId }
    : { chromeThemeSetting: p.darkChromeTheme, codeThemeSetting: p.darkCodeThemeId };
}
var q,
  nt,
  rt,
  ...
  st = e(() => {
    (r(),
      ...
      (nt = t({ code: d().nullable().optional(), ui: d().nullable().optional() })),
      ...
      (at = t({
        ...
        theme: te(`kind`, [
          t({ kind: a(`preset`), themeId: d().refine(ae, `Invalid code theme id`) }),
        ...
        run: (e, t) => {
          ...
          return {
            ...
            window: {
              ...
              ...(r ? { sidebar: { viewport: Z(D.sidebarScroll), rows: ft() } } : {}),
              ...(u ? { review: { viewport: Z(D.reviewScroll), files: mt(n) } } : {}),
...
var Gt,
  ...
  Xt = e(() => {
    (f(),
      ...
      R(),
      I(),
      (Jt = t({ type: a(`windows.review.set_fullscreen`), windowId: P, fullscreen: u() })),
      (Yt = L({
        schema: Jt,
        run: ({ fullscreen: e }, t) => {
          J(t).set(x, e);
...
var cn,
  ...
  Tn = e(() => {
    (f(),
      R(),
      I(),
      (Cn = t({ type: a(`windows.sidebar.select_project`), windowId: P, project: j })),
      (wn = L({
        schema: Cn,
        run: ({ project: e }) => {
  ...
  Ln = e(() => {
    (f(),
      R(),
      I(),
      (Fn = t({ type: a(`windows.timeline.scroll_to_turn`), windowId: P, direction: Pe })),
      (In = L({
        schema: Fn,
        run: ({ direction: e }) => {
