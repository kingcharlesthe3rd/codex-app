...
import {
  ...
  r as Ue,
  t as We,
} from "./app-initial~app-main~register-app-actions-CgjL-zeV.js";
var W,
  G,
  Ge = e(() => {
    (g(),
      ...
      m(),
      U(),
      (W = h({ type: S(`app.appearance.get`) })),
      (G = H({
        schema: W,
        run: async () => {
          let [e, t, n, r, i] = await Promise.all([
            o(s.theme),
            o(s.lightCodeThemeId),
            o(s.darkCodeThemeId),
            o(s.lightChromeTheme),
            o(s.darkChromeTheme),
          ]);
          return {
            schemaVersion: 1,
  ...
  qe = e(() => {
    (O(),
      F(),
      U(),
      (K = h({ type: S(`app.appearance.get_available_themes`) })),
      (Ke = H({
        schema: K,
        run: () => ({
          schemaVersion: 1,
...
async function q(e, t, n, r) {
  let i = te(`get-settings`),
    ...
    o = r?.optimistic ?? !0;
  o && e.queryClient?.setQueryData(i, { ...a, values: { ...a?.values, [t.key]: n } });
  try {
    (await fe(t, n),
      o || e.queryClient?.setQueryData(i, { ...a, values: { ...a?.values, [t.key]: n } }));
  } catch (t) {
    ...
    (await e.queryClient?.invalidateQueries({ queryKey: i }),
      T.dispatchMessage(`query-cache-invalidate`, { queryKey: [...i] }));
  }
}
var Je = e(() => {
    (v(), m(), t());
  ...
  Ze = e(() => {
    (g(),
      ...
      U(),
      Je(),
      (Ye = h({ type: S(`app.appearance.set_mode`), mode: _([`light`, `dark`, `system`]) })),
      (Xe = H({
        schema: Ye,
        run: async ({ mode: e }, t) => (
          await q(t, s.theme, e, { optimistic: !1 }),
          { schemaVersion: 1, mode: e }
        ),
      })));
  });
async function Qe(e, t, n) {
  let { chromeThemeSetting: r, codeThemeSetting: i } = et(t),
    a = Se(await o(r), t);
  if (n.kind === `custom`) {
    let t = $e(a, n.patch);
    return (await q(e, r, t), t);
  }
  let s = await _e(n.themeId, t),
    c = {
      ...a,
      ...s,
      fonts: { ...a.fonts, ...s.fonts },
      semanticColors: { ...a.semanticColors, ...s.semanticColors },
    };
  return (await Promise.all([q(e, i, n.themeId), q(e, r, c)]), c);
}
function $e(e, t) {
  return {
    ...e,
...
var J,
  ...
  ot = e(() => {
    (g(),
      ...
      U(),
      Je(),
      (J = M().regex(/^#[0-9a-fA-F]{6}$/)),
      (tt = h({ code: M().nullable().optional(), ui: M().nullable().optional() })),
      (nt = h({ diffAdded: J, diffRemoved: J, skill: J })),
      (rt = h({
        accent: J.optional(),
        contrast: me().int().min(0).max(100).optional(),
        fonts: tt.optional(),
        ink: J.optional(),
      ...
      (it = h({
        type: S(`app.appearance.set_theme`),
        theme: ce(`kind`, [
          h({ kind: S(`preset`), themeId: M().refine(Ce, `Invalid code theme id`) }),
          h({ kind: S(`custom`), patch: rt }),
        ]),
        variant: _([`light`, `dark`, `both`]).default(`both`),
      })),
      (at = H({
        schema: it,
  ...
  switch (e.value.routeKind) {
    case `local-thread`:
      return {
        ...
        kind: `local`,
        hostId: e.get(i, e.value.conversationId) ?? `local`,
        title: e.get(ye, e.value.conversationId),
      };
    case `remote-thread`:
...
function lt(e, t, n, r, i) {
  let a = t == null ? [] : Le(e, t),
    o = t == null ? null : Ae(t, e.get(R), { bottom: n, right: r }),
    s = o == null ? null : (a.find((e) => e.browserTabId === o) ?? null),
    c = t == null || o == null ? null : z.getSnapshot(t, o);
  return {
...
function ut(e, t, n) {
  if (e == null) return [];
  let r = z.getBrowserUseBrowserTabIds(e),
    i = [...t, ...r],
    a = new Set(r),
    o = new Set();
  return i.flatMap((t) => {
    if (o.has(t)) return [];
    o.add(t);
    let r = z.getSnapshot(e, t);
    return [
      {
        active: t === n,
        browserTabId: t,
        isBrowserUseActive: z.isBrowserUseActive(e, t),
...
function dt() {
  return Array.from(document.querySelectorAll(ne)).map((e, t) => ft(e, t));
}
function ft(e, t) {
  let n = gt(e);
  return e.matches(C.sidebarSection)
    ? {
        type: `section`,
        index: t,
...
function pt(e) {
  let t = ht(),
    n = new Set(e.get(N).map((e) => e.path));
  return [
    ...e
      .get(N)
      .map((e) => ({
...
function mt(e) {
  let t = e?.querySelector(C.reviewFileToggle);
  return {
...
function ht() {
  let e = Array.from(document.querySelectorAll(C.reviewFile));
  return new Map(
    e.flatMap((e) => {
      ...
      (vt = H({
        ...
        run: (e, t) => {
          let n = Y(t),
            ...
            a = n.get(Fe),
            o = n.get(ze),
            s = a && o ? n.get(De.activeTab$) : null,
            c = n.get(je) ? n.get(Re.activeTab$) : null,
            l = s?.tabId ?? null,
            u = null;
          l === r.DIFF ? (u = `right`) : c?.tabId === r.DIFF && (u = `bottom`);
          let d = u != null,
            f = n.get(V),
            p = Pe(n.get(R), { bottom: n.get(ge), right: n.get(we) });
          return {
            schemaVersion: 1,
            window: {
              windowId: ie,
              ...
              thread: st(n),
              panels: {
                browser: lt(n, Z(n.value) ? ee(n) : null, c, s, f),
                sidebar: { open: i },
                review: {
                  open: d,
                  placement: u,
                  fullscreen: u === `right` && f,
                  fileTreeOpen: d && n.get(ke),
                  view: n.get(I),
                },
                terminal: { open: p != null, placement: p },
                rightPanel: { fullscreen: f, kind: l },
              },
              ...(i ? { sidebar: { viewport: Q(C.sidebarScroll), rows: dt() } } : {}),
              ...(d ? { review: { viewport: Q(C.reviewScroll), files: pt(n) } } : {}),
              ...(Z(n.value) ? { timeline: Q(C.timelineScroll) } : {}),
            },
          };
        },
      })));
...
function bt(e) {
  return H({ schema: St, run: ({ action: t }) => xt(e(), t) });
}
function xt(e, t, n = Ct) {
  return {
    ...
    actions: e
      ...
      .map((e) => ({ type: e.type, jsonSchema: JSON.stringify(l(e.schema), null, 2) })),
  };
}
var St,
  Ct,
  wt = e(() => {
    (O(),
      U(),
      (St = h({ type: S(`app.help`), action: M().optional() })),
...
Prefer the smallest action that directly satisfies the user request.`));
  ...
  Dt = e(() => {
    (O(),
      ...
      U(),
      A(),
      (Tt = h({ type: S(`windows.nav.back`), windowId: j })),
      (Et = H({
        schema: Tt,
        run: () => {
  ...
  At = e(() => {
    (O(),
      ...
      U(),
      A(),
      (Ot = h({ type: S(`windows.nav.forward`), windowId: j })),
      (kt = H({
        schema: Ot,
        run: () => {
  ...
  Nt = e(() => {
    (O(),
      U(),
      A(),
      (jt = h({ type: S(`windows.review.collapse_all`), windowId: j })),
      (Mt = H({
        schema: jt,
        run: () => {
  ...
  It = e(() => {
    (O(),
      U(),
      A(),
      (Pt = h({ type: S(`windows.review.expand_all`), windowId: j })),
      (Ft = H({
        schema: Pt,
        run: () => {
          window.dispatchEvent(
  ...
  zt = e(() => {
    (O(),
      ...
      A(),
      (Lt = h({
        type: S(`windows.review.file_set_expanded`),
        windowId: j,
        path: M(),
        expanded: x(),
      })),
      (Rt = H({
        ...
        run: ({ path: e, expanded: t }) => {
          let n = k(e).querySelector(C.reviewFileToggle);
  ...
  Ht = e(() => {
    (O(),
      U(),
      A(),
      (Bt = h({ type: S(`windows.review.scroll`), windowId: j, scroll: E })),
      (Vt = H({
        schema: Bt,
        run: ({ scroll: e }) => {
          y(D(C.reviewScroll), e);
        },
      })));
  });
function Ut(e) {
...
var Wt,
  ...
  Kt = e(() => {
    (O(),
      ...
      A(),
      (Wt = h({
        type: S(`windows.review.scroll_to_file`),
        windowId: j,
        path: M(),
        align: _([`top`, `center`, `bottom`]).optional(),
      })),
      (Gt = H({
        schema: Wt,
        run: ({ path: e, align: t }, n) => {
          let r = k(e);
          (he(Y(n), r.dataset.reviewPath ?? e),
  ...
  Yt = e(() => {
    (O(),
      ...
      U(),
      A(),
      (qt = h({ type: S(`windows.review.set_fullscreen`), windowId: j, fullscreen: x() })),
      (Jt = H({
        schema: qt,
        run: ({ fullscreen: e }, t) => {
          Y(t).set(V, e);
  ...
  Qt = e(() => {
    (O(),
      ...
      A(),
      (Xt = h({
        type: S(`windows.review.set_view`),
        windowId: j,
        view: _([`turn`, `branch`, `unstaged`, `staged`]),
      })),
      (Zt = H({
        schema: Xt,
        run: ({ view: e }, t) => {
          Y(t).set(I, e === `turn` ? `last-turn` : e);
        },
      })));
  }),
  $t,
  ...
  tn = e(() => {
    (O(),
      ...
      U(),
      A(),
      ($t = h({ type: S(`windows.review.toggle`), windowId: j })),
      (en = H({
        schema: $t,
        run: () => {
  ...
  an = e(() => {
    (O(),
      ...
      U(),
      A(),
      (nn = h({ type: S(`windows.show_home`), windowId: j })),
      (rn = H({
        schema: nn,
        run: () => {
...
var sn,
  ...
  ln = e(() => {
    (g(),
      ...
      U(),
      A(),
      (sn = h({ type: S(`windows.show_thread`), windowId: j, threadId: M() })),
      (cn = H({
        schema: sn,
        run: ({ threadId: e }) => {
          T.dispatchHostMessage({ type: `navigate-to-route`, path: on(e) });
        },
      })));
  }),
  un,
  ...
  fn = e(() => {
    (O(),
      ...
      A(),
      (un = h({
        type: S(`windows.sidebar.project_set_collapsed`),
        windowId: j,
        project: b,
        collapsed: x(),
      })),
  ...
  hn = e(() => {
    (O(),
      ...
      A(),
      (pn = h({
        type: S(`windows.sidebar.project_set_show_all`),
        windowId: j,
        project: b,
        showAll: x(),
      })),
      (mn = H({
        ...
        run: ({ project: e, showAll: t }) => {
          ...
          let a = i.querySelector(C.sidebarProjectShowAllToggle);
  ...
  vn = e(() => {
    (O(),
      U(),
      A(),
      (gn = h({ type: S(`windows.sidebar.scroll`), windowId: j, scroll: E })),
      (_n = H({
        schema: gn,
        run: ({ scroll: e }) => {
          y(D(C.sidebarScroll), e);
        },
      })));
  }),
  yn,
  ...
  xn = e(() => {
    (O(),
      ...
      A(),
      (yn = h({
        type: S(`windows.sidebar.section_set_collapsed`),
        windowId: j,
        section: ae,
        collapsed: x(),
      })),
      (bn = H({
        ...
        run: ({ section: e, collapsed: t }) => {
          ...
          let r = n.querySelector(C.sidebarSectionToggle);
  ...
  wn = e(() => {
    (O(),
      U(),
      A(),
      (Sn = h({ type: S(`windows.sidebar.select_project`), windowId: j, project: b })),
      (Cn = H({
        schema: Sn,
        run: ({ project: e }) => {
          let t = w(e).querySelector(C.sidebarProjectSelect);
  ...
  Dn = e(() => {
    (O(),
      ...
      U(),
      A(),
      (Tn = h({ type: S(`windows.sidebar.toggle`), windowId: j })),
      (En = H({
        schema: Tn,
        run: () => {
  ...
  An = e(() => {
    (O(),
      ...
      U(),
      A(),
      (On = h({ type: S(`windows.terminal.toggle`), windowId: j })),
      (kn = H({
        schema: On,
        run: (e, t) => {
          Te(Y(t));
  ...
  Nn = e(() => {
    (O(),
      U(),
      A(),
      (jn = h({ type: S(`windows.timeline.scroll`), windowId: j, scroll: E })),
      (Mn = H({
        schema: jn,
        run: ({ scroll: e }) => {
          se(D(C.timelineScroll), e);
        },
      })));
  }),
  Pn,
  ...
  In = e(() => {
    (O(),
      U(),
      A(),
      (Pn = h({ type: S(`windows.timeline.scroll_to_turn`), windowId: j, direction: ue })),
      (Fn = H({
        schema: Pn,
        run: ({ direction: e }) => {
          pe(D(C.timelineScroll), e);
        },
      })));
  });
function Ln() {
