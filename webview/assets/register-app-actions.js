...
import { E as v, j as y, k as b, w as x } from "./diff-view-mode.js";
...
import { L as E, jt as D, r as oe } from "./review-navigation-model.js";
...
import { a as se, o as ce } from "./thread-page-bottom-panel-state.js";
...
var ue = U({
    schema: e({ type: o(`app.appearance.get`) }),
    run: async () => {
  ...
  de = U({
    schema: e({ type: o(`app.appearance.get_available_themes`) }),
    run: () => ({
      schemaVersion: 1,
      themes: v().map((e) => ({
        id: e.id,
...
var fe = U({
    schema: e({ type: o(`app.appearance.set_mode`), mode: r([`light`, `dark`, `system`]) }),
    run: async ({ mode: e }, n) => (
  ...
  pe = e({ code: c().nullable().optional(), ui: c().nullable().optional() }),
  me = e({ diffAdded: K, diffRemoved: K, skill: K }),
  he = e({
    accent: K.optional(),
    contrast: i().int().min(0).max(100).optional(),
    fonts: pe.optional(),
    ink: K.optional(),
  ...
  ge = U({
    schema: e({
      type: o(`app.appearance.set_theme`),
      theme: n(`kind`, [
        e({ kind: o(`preset`), themeId: c().refine(b, `Invalid code theme id`) }),
        e({ kind: o(`custom`), patch: he }),
      ]),
...
var ye = U({
  schema: e({ type: o(`app.get_summary`) }),
  run: (e, t) => {
    let n = J(t),
      r = n.get(_),
      i = n.get(re),
...
var Ae = e({ type: o(`app.help`), action: c().optional() });
function je(e) {
...
function Me(e, t, n = Ne) {
  return {
    ...
    actions: e
      ...
      .map((e) => ({ type: e.type, jsonSchema: JSON.stringify(u(e.schema), null, 2) })),
  };
}
...
Prefer the smallest action that directly satisfies the user request.`,
  Pe = U({
    schema: e({ type: o(`windows.nav.back`), windowId: I }),
    run: () => {
      f.dispatchHostMessage({ type: `navigate-back` });
    },
  }),
  Fe = U({
    schema: e({ type: o(`windows.nav.forward`), windowId: I }),
    run: () => {
      f.dispatchHostMessage({ type: `navigate-forward` });
    },
  }),
  Ie = U({
    schema: e({ type: o(`windows.review.collapse_all`), windowId: I }),
    run: () => {
  ...
  Le = U({
    schema: e({ type: o(`windows.review.expand_all`), windowId: I }),
    run: () => {
      window.dispatchEvent(
  ...
  Re = U({
    schema: e({
      type: o(`windows.review.file_set_expanded`),
      windowId: I,
      path: c(),
      expanded: a(),
    }),
  ...
  ze = U({
    schema: e({ type: o(`windows.review.scroll`), windowId: I, scroll: F }),
    run: ({ scroll: e }) => {
  ...
  Be = U({
    schema: e({
      type: o(`windows.review.scroll_to_file`),
      windowId: I,
      path: c(),
...
var He = U({
    schema: e({ type: o(`windows.review.set_fullscreen`), windowId: I, fullscreen: a() }),
    run: ({ fullscreen: e }, t) => {
      J(t).set(h, e);
    },
  }),
  Q = U({
    schema: e({
      type: o(`windows.review.set_view`),
      windowId: I,
  ...
  Ue = U({
    schema: e({ type: o(`windows.review.toggle`), windowId: I }),
    run: () => {
      f.dispatchHostMessage({ type: `toggle-diff-panel` });
    },
  }),
  We = U({
    schema: e({ type: o(`windows.show_home`), windowId: I }),
    run: () => {
      f.dispatchHostMessage({ type: `new-chat` });
    },
  }),
  Ge = U({
    schema: e({ type: o(`windows.show_thread`), windowId: I, threadId: c() }),
    run: ({ threadId: e }) => {
...
var qe = [
    ...
    U({
      schema: e({
        type: o(`windows.sidebar.project_set_collapsed`),
        windowId: I,
        project: A,
        collapsed: a(),
      }),
    ...
    U({
      schema: e({
        type: o(`windows.sidebar.project_set_show_all`),
        windowId: I,
        project: A,
        showAll: a(),
      }),
    ...
    U({
      schema: e({ type: o(`windows.sidebar.scroll`), windowId: I, scroll: F }),
      run: ({ scroll: e }) => {
    ...
    U({
      schema: e({
        type: o(`windows.sidebar.section_set_collapsed`),
        windowId: I,
        section: j,
        collapsed: a(),
      }),
    ...
    U({
      schema: e({ type: o(`windows.sidebar.select_project`), windowId: I, project: A }),
      run: ({ project: e }) => {
    ...
    U({
      schema: e({ type: o(`windows.sidebar.toggle`), windowId: I }),
      run: () => {
        f.dispatchHostMessage({ type: `toggle-sidebar` });
      },
    }),
    U({
      schema: e({ type: o(`windows.terminal.toggle`), windowId: I }),
      run: (e, t) => {
        ce(J(t));
      },
    }),
    U({
      schema: e({ type: o(`windows.timeline.scroll`), windowId: I, scroll: F }),
      run: ({ scroll: e }) => {
        P(z(M.timelineScroll), e);
      },
    }),
    U({
      schema: e({ type: o(`windows.timeline.scroll_to_turn`), windowId: I, direction: R }),
      run: ({ direction: e }) => {
