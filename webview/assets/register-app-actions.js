...
var R,
  ...
  Ze = e(() => {
    (r(),
      ...
      P(),
      L(),
      (R = a({ type: f(`app.appearance.get`) })),
      (z = I({
        schema: R,
        run: async () => {
          let [e, t, n, r, i] = await Promise.all([
            F(m.theme),
            F(m.lightCodeThemeId),
            F(m.darkCodeThemeId),
            F(m.lightChromeTheme),
            F(m.darkChromeTheme),
          ]);
          return {
            schemaVersion: 1,
  ...
  Qe = e(() => {
    (d(),
      S(),
      L(),
      (B = a({ type: f(`app.appearance.get_available_themes`) })),
      (V = I({
        schema: B,
        run: () => ({
          schemaVersion: 1,
...
async function H(e, n, r, i) {
  let a = l(`get-settings`),
    o = e.queryClient?.getQueryData(a),
    s = i?.optimistic ?? !0;
  s && e.queryClient?.setQueryData(a, { ...o, values: { ...o?.values, [n.key]: r } });
  try {
    (await qe(n, r),
      s || e.queryClient?.setQueryData(a, { ...o, values: { ...o?.values, [n.key]: r } }));
  } catch (t) {
    ...
    (await e.queryClient?.invalidateQueries({ queryKey: a }),
      t.dispatchMessage(`query-cache-invalidate`, { queryKey: [...a] }));
  }
}
var U = e(() => {
    (p(), P(), u());
  ...
  $e = e(() => {
    (r(),
      ...
      L(),
      U(),
      (W = a({ type: f(`app.appearance.set_mode`), mode: h([`light`, `dark`, `system`]) })),
      (G = I({
        schema: W,
        run: async ({ mode: e }, t) => (
          await H(t, m.theme, e, { optimistic: !1 }),
...
async function K(e, t, n) {
  ...
  if (n.kind === `custom`) {
    let t = et(a, n.patch);
    return (await H(e, r, t), t);
  }
  let o = await pe(n.themeId, t),
    s = {
      ...a,
      ...o,
  ...
  return (await Promise.all([H(e, i, n.themeId), H(e, r, s)]), s);
}
function et(e, t) {
  return {
    ...e,
...
var q,
  ...
  ot = e(() => {
    (r(),
      ...
      L(),
      U(),
      (q = n().regex(/^#[0-9a-fA-F]{6}$/)),
      (J = a({ code: n().nullable().optional(), ui: n().nullable().optional() })),
      (nt = a({ diffAdded: q, diffRemoved: q, skill: q })),
      (rt = a({
        accent: q.optional(),
      ...
      (it = a({
        ...
        theme: i(`kind`, [
          a({ kind: f(`preset`), themeId: n().refine(Ee, `Invalid code theme id`) }),
          a({ kind: f(`custom`), patch: rt }),
        ]),
        variant: h([`light`, `dark`, `both`]).default(`both`),
      })),
      (at = I({
        schema: it,
  ...
  switch (e.value.routeKind) {
    case `local-thread`:
      return {
        ...
        kind: `local`,
        hostId: e.get(je, e.value.conversationId) ?? `local`,
...
function lt(e, t, n, r, i) {
  let a = t == null ? [] : De(e, t),
    o = t == null ? null : ve(t, e.get(v), { bottom: n, right: r }),
...
function pt(e) {
  let t = ht(),
    n = new Set(e.get(g).map((e) => e.path));
  return [
    ...e
      .get(g)
      .map((e) => ({
      ...
      (vt = I({
        ...
        run: (e, t) => {
          let n = Y(t),
            ...
            i = n.get(ie),
            a = n.get(ke),
            o = i && a ? n.get(xe.activeTab$) : null,
            s = n.get(Ae) ? n.get(ae.activeTab$) : null,
            c = o?.tabId ?? null,
            l = null;
          c === w.DIFF ? (l = `right`) : s?.tabId === w.DIFF && (l = `bottom`);
          let u = l != null,
            d = n.get(me),
            f = Te(n.get(v), { bottom: n.get(ue), right: n.get(re) });
          return {
            schemaVersion: 1,
            window: {
              windowId: Re,
              ...
              thread: st(n),
              panels: {
                browser: lt(n, Z(n.value) ? Me(n) : null, s, o, d),
                sidebar: { open: r },
                review: {
                  open: u,
                  placement: l,
              ...
              ...(r ? { sidebar: { viewport: Q(M.sidebarScroll), rows: dt() } } : {}),
              ...(u ? { review: { viewport: Q(M.reviewScroll), files: pt(n) } } : {}),
              ...(Z(n.value) ? { timeline: Q(M.timelineScroll) } : {}),
            },
          };
        },
      })));
...
function bt(e) {
  return I({ schema: St, run: ({ action: t }) => xt(e(), t) });
}
function xt(e, t, n = Ct) {
  return {
    ...
    actions: e
      ...
      .map((e) => ({ type: e.type, jsonSchema: JSON.stringify(te(e.schema), null, 2) })),
  };
}
var St,
  Ct,
  wt = e(() => {
    (d(),
      L(),
      (St = a({ type: f(`app.help`), action: n().optional() })),
...
Prefer the smallest action that directly satisfies the user request.`));
  ...
  Dt = e(() => {
    (d(),
      ...
      L(),
      k(),
      (Tt = a({ type: f(`windows.nav.back`), windowId: A })),
      (Et = I({
        schema: Tt,
        run: () => {
  ...
  At = e(() => {
    (d(),
      ...
      L(),
      k(),
      (Ot = a({ type: f(`windows.nav.forward`), windowId: A })),
      (kt = I({
        schema: Ot,
        run: () => {
  ...
  Nt = e(() => {
    (d(),
      L(),
      k(),
      (jt = a({ type: f(`windows.review.collapse_all`), windowId: A })),
      (Mt = I({
        schema: jt,
        run: () => {
  ...
  It = e(() => {
    (d(),
      L(),
      k(),
      (Pt = a({ type: f(`windows.review.expand_all`), windowId: A })),
      (Ft = I({
        schema: Pt,
        run: () => {
          window.dispatchEvent(
    ...
    (d(),
      ...
      (Rt = I({
        ...
        run: ({ path: e, expanded: t }) => {
          let n = E(e).querySelector(M.reviewFileToggle);
  ...
  Ht = e(() => {
    (d(),
      L(),
      k(),
      (Bt = a({ type: f(`windows.review.scroll`), windowId: A, scroll: T })),
      (Vt = I({
        schema: Bt,
        run: ({ scroll: e }) => {
          O(j(M.reviewScroll), e);
        },
      })));
  });
function Ut(e) {
...
var Wt,
  ...
  Kt = e(() => {
    (d(),
      ...
      (Wt = a({
        ...
        windowId: A,
        path: n(),
        align: h([`top`, `center`, `bottom`]).optional(),
      })),
      (Gt = I({
        schema: Wt,
        run: ({ path: e, align: t }, n) => {
          let r = E(e);
          (se(Y(n), r.dataset.reviewPath ?? e),
  ...
  Yt = e(() => {
    (d(),
      ...
      L(),
      k(),
      (qt = a({ type: f(`windows.review.set_fullscreen`), windowId: A, fullscreen: s() })),
      (Jt = I({
        schema: qt,
        run: ({ fullscreen: e }, t) => {
          Y(t).set(me, e);
  ...
  Qt = e(() => {
    (d(),
      ...
      (Xt = a({
        ...
        windowId: A,
        view: h([`turn`, `branch`, `unstaged`, `staged`]),
      })),
      (Zt = I({
        schema: Xt,
        run: ({ view: e }, t) => {
          Y(t).set(_, e === `turn` ? `last-turn` : e);
        },
      })));
  }),
  $t,
  ...
  tn = e(() => {
    (d(),
      ...
      L(),
      k(),
      ($t = a({ type: f(`windows.review.toggle`), windowId: A })),
      (en = I({
        schema: $t,
        run: () => {
  ...
  an = e(() => {
    (d(),
      ...
      L(),
      k(),
      (nn = a({ type: f(`windows.show_home`), windowId: A })),
      (rn = I({
        schema: nn,
        run: () => {
...
function on(e) {
  let t = We(e);
  return t == null ? ee(ne(e)) : Ge(t.key);
}
var sn,
  cn,
  ln = e(() => {
    (r(),
      ...
      L(),
      k(),
      (sn = a({ type: f(`windows.show_thread`), windowId: A, threadId: n() })),
      (cn = I({
        schema: sn,
        run: ({ threadId: e }) => {
  ...
  vn = e(() => {
    (d(),
      L(),
      k(),
      (gn = a({ type: f(`windows.sidebar.scroll`), windowId: A, scroll: T })),
      (_n = I({
        schema: gn,
        run: ({ scroll: e }) => {
          O(j(M.sidebarScroll), e);
        },
      })));
  }),
  yn,
  ...
  wn = e(() => {
    (d(),
      L(),
      k(),
      (Sn = a({ type: f(`windows.sidebar.select_project`), windowId: A, project: N })),
      (Cn = I({
        schema: Sn,
        run: ({ project: e }) => {
          let t = D(e).querySelector(M.sidebarProjectSelect);
  ...
  Dn = e(() => {
    (d(),
      ...
      L(),
      k(),
      (Tn = a({ type: f(`windows.sidebar.toggle`), windowId: A })),
      (En = I({
        schema: Tn,
        run: () => {
  ...
  An = e(() => {
    (d(),
      ...
      L(),
      k(),
      (On = a({ type: f(`windows.terminal.toggle`), windowId: A })),
      (kn = I({
        schema: On,
        run: (e, t) => {
          be(Y(t));
  ...
  Nn = e(() => {
    (d(),
      L(),
      k(),
      (jn = a({ type: f(`windows.timeline.scroll`), windowId: A, scroll: T })),
      (Mn = I({
        schema: jn,
        run: ({ scroll: e }) => {
          Ie(j(M.timelineScroll), e);
        },
      })));
  }),
  Pn,
  ...
  In = e(() => {
    (d(),
      L(),
      k(),
      (Pn = a({ type: f(`windows.timeline.scroll_to_turn`), windowId: A, direction: Ue })),
      (Fn = I({
        schema: Pn,
        run: ({ direction: e }) => {
          He(j(M.timelineScroll), e);
        },
      })));
  });
function Ln() {
