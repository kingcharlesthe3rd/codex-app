...
var P,
  ...
  tt = e(() => {
    (p(),
      ...
      E(),
      N(),
      (P = u({ type: h(`app.appearance.get`) })),
      (F = M({
        schema: P,
        run: async () => {
          let [e, t, n, r, i] = await Promise.all([
            O(T.theme),
            O(T.lightCodeThemeId),
            O(T.darkCodeThemeId),
            O(T.lightChromeTheme),
            O(T.darkChromeTheme),
          ]);
          return {
            schemaVersion: 1,
  ...
  nt = e(() => {
    (v(),
      qe(),
      N(),
      (I = u({ type: h(`app.appearance.get_available_themes`) })),
      (L = M({
        schema: I,
        run: () => ({
          schemaVersion: 1,
...
async function R(e, t, n, r) {
  ...
  try {
    ...
    (await e.queryClient?.invalidateQueries({ queryKey: i }),
      c.dispatchMessage(`query-cache-invalidate`, { queryKey: [...i] }));
  }
}
var z = e(() => {
    (k(), E(), a());
  ...
  rt = e(() => {
    (p(),
      ...
      N(),
      z(),
      (B = u({ type: h(`app.appearance.set_mode`), mode: D([`light`, `dark`, `system`]) })),
      (V = M({
        schema: B,
        run: async ({ mode: e }, t) => (
          await R(t, T.theme, e, { optimistic: !1 }),
...
async function H(e, t, n) {
  ...
  if (n.kind === `custom`) {
    let t = it(a, n.patch);
    return (await R(e, r, t), t);
  }
  let o = await Ie(n.themeId, t),
    s = {
      ...a,
      ...o,
  ...
  return (await Promise.all([R(e, i, n.themeId), R(e, r, s)]), s);
}
function it(e, t) {
  return {
    ...e,
...
var U,
  ...
  ot = e(() => {
    (p(),
      ...
      N(),
      z(),
      (U = A().regex(/^#[0-9a-fA-F]{6}$/)),
      (W = u({ code: A().nullable().optional(), ui: A().nullable().optional() })),
      (G = u({ diffAdded: U, diffRemoved: U, skill: U })),
      (K = u({
        accent: U.optional(),
        contrast: ie().int().min(0).max(100).optional(),
        fonts: W.optional(),
        ink: U.optional(),
        opaqueWindows: g().optional(),
        semanticColors: G.partial().optional(),
        surface: U.optional(),
      })),
      (q = u({
        type: h(`app.appearance.set_theme`),
        theme: o(`kind`, [
          u({ kind: h(`preset`), themeId: A().refine(Ne, `Invalid code theme id`) }),
          u({ kind: h(`custom`), patch: K }),
        ]),
        variant: D([`light`, `dark`, `both`]).default(`both`),
      })),
      (J = M({
        schema: q,
        run: async ({ theme: e, variant: t }, n) => {
          ...
          if (t === `light` || t === `both`) {
            let t = await H(n, `light`, e);
            (r.push(`light`), (i.appearanceLightChromeTheme = t));
          }
          if (t === `dark` || t === `both`) {
            let t = await H(n, `dark`, e);
  ...
  switch (e.value.routeKind) {
    case `local-thread`:
      return {
        ...
        kind: `local`,
        hostId: e.get(De, e.value.conversationId) ?? `local`,
        title: e.get(He, e.value.conversationId),
      };
    case `remote-thread`:
...
function ut(e, t, n, r, i) {
  let a = t == null ? [] : ze(e, t),
    o = t == null ? null : Ve(t, e.get(ae), { bottom: n, right: r }),
    s = o == null ? null : (a.find((e) => e.browserTabId === o) ?? null),
    c = t == null || o == null ? null : j.getSnapshot(t, o);
  return {
...
function dt(e, t, n) {
  if (e == null) return [];
  let r = j.getBrowserUseBrowserTabIds(e),
    i = [...t, ...r],
    a = new Set(r),
    o = new Set();
  return i.flatMap((t) => {
    if (o.has(t)) return [];
    o.add(t);
    let r = j.getSnapshot(e, t);
    return [
      {
        active: t === n,
        browserTabId: t,
        isBrowserUseActive: j.isBrowserUseActive(e, t),
...
function ft() {
  return Array.from(document.querySelectorAll(Ee)).map((e, t) => pt(e, t));
}
function pt(e, t) {
  let n = _t(e);
...
function mt(e) {
  let t = gt(),
    n = new Set(e.get(Re).map((e) => e.path));
  return [
    ...e
      .get(Re)
      .map((e) => ({
      ...
      (yt = M({
        ...
        run: (e, t) => {
          let n = Y(t),
            ...
            i = n.get(me),
            a = n.get(_e),
            o = i && a ? n.get(ne.activeTab$) : null,
            s = n.get(ye) ? n.get(ee.activeTab$) : null,
            c = o?.tabId ?? null,
            l = null;
          c === te.DIFF ? (l = `right`) : s?.tabId === te.DIFF && (l = `bottom`);
          let u = l != null,
            d = n.get(b),
            f = We(n.get(ae), { bottom: n.get(Ae), right: n.get(Me) });
          return {
            schemaVersion: 1,
            window: {
              windowId: ue,
              ...
              thread: ct(n),
              panels: {
                browser: ut(n, st(n.value) ? re(n) : null, s, o, d),
                sidebar: { open: r },
                review: {
                  open: u,
                  placement: l,
                  fullscreen: l === `right` && d,
                  fileTreeOpen: u && n.get(oe),
                  view: n.get(Ge),
                },
                terminal: { open: f != null, placement: f },
                rightPanel: { fullscreen: d, kind: c },
              },
              ...(r ? { sidebar: { viewport: Z(S.sidebarScroll), rows: ft() } } : {}),
              ...(u ? { review: { viewport: Z(S.reviewScroll), files: mt(n) } } : {}),
              ...(st(n.value) ? { timeline: Z(S.timelineScroll) } : {}),
            },
          };
        },
      })));
...
function xt(e) {
  return M({ schema: Ct, run: ({ action: t }) => St(e(), t) });
}
function St(e, t, n = wt) {
  return {
    ...
    actions: e
      ...
      .map((e) => ({ type: e.type, jsonSchema: JSON.stringify(le(e.schema), null, 2) })),
  };
}
var Ct,
  wt,
  Tt = e(() => {
    (v(),
      N(),
      (Ct = u({ type: h(`app.help`), action: A().optional() })),
...
Prefer the smallest action that directly satisfies the user request.`));
  ...
  Ot = e(() => {
    (v(),
      ...
      N(),
      y(),
      (Et = u({ type: h(`windows.nav.back`), windowId: d })),
      (Dt = M({
        schema: Et,
        run: () => {
  ...
  jt = e(() => {
    (v(),
      ...
      N(),
      y(),
      (kt = u({ type: h(`windows.nav.forward`), windowId: d })),
      (At = M({
        schema: kt,
        run: () => {
  ...
  Pt = e(() => {
    (v(),
      N(),
      y(),
      (Mt = u({ type: h(`windows.review.collapse_all`), windowId: d })),
      (Nt = M({
        schema: Mt,
        run: () => {
  ...
  Lt = e(() => {
    (v(),
      N(),
      y(),
      (Ft = u({ type: h(`windows.review.expand_all`), windowId: d })),
      (It = M({
        schema: Ft,
        run: () => {
          window.dispatchEvent(
    ...
    (v(),
      ...
      (zt = M({
        ...
        run: ({ path: e, expanded: t }) => {
          let n = C(e).querySelector(S.reviewFileToggle);
  ...
  Ut = e(() => {
    (v(),
      N(),
      y(),
      (Vt = u({ type: h(`windows.review.scroll`), windowId: d, scroll: x })),
      (Ht = M({
        schema: Vt,
        run: ({ scroll: e }) => {
          _(m(S.reviewScroll), e);
        },
      })));
  });
function Wt(e) {
...
var Gt,
  ...
  qt = e(() => {
    (v(),
      ...
      (Gt = u({
        ...
        windowId: d,
        path: A(),
        align: D([`top`, `center`, `bottom`]).optional(),
      })),
      (Kt = M({
        schema: Gt,
  ...
  Xt = e(() => {
    (v(),
      ...
      N(),
      y(),
      (Jt = u({ type: h(`windows.review.set_fullscreen`), windowId: d, fullscreen: g() })),
      (Yt = M({
        schema: Jt,
        run: ({ fullscreen: e }, t) => {
          Y(t).set(b, e);
  ...
  $t = e(() => {
    (v(),
      ...
      (Zt = u({
        ...
        windowId: d,
        view: D([`turn`, `branch`, `unstaged`, `staged`]),
      })),
      (Qt = M({
        schema: Zt,
        run: ({ view: e }, t) => {
          Y(t).set(Ge, e === `turn` ? `last-turn` : e);
        },
      })));
  }),
  en,
  ...
  nn = e(() => {
    (v(),
      ...
      N(),
      y(),
      (en = u({ type: h(`windows.review.toggle`), windowId: d })),
      (tn = M({
        schema: en,
        run: () => {
  ...
  on = e(() => {
    (v(),
      ...
      N(),
      y(),
      (rn = u({ type: h(`windows.show_home`), windowId: d })),
      (an = M({
        schema: rn,
        run: () => {
...
var cn,
  ...
  un = e(() => {
    (p(),
      ...
      N(),
      y(),
      (cn = u({ type: h(`windows.show_thread`), windowId: d, threadId: A() })),
      (ln = M({
        schema: cn,
        run: ({ threadId: e }) => {
          c.dispatchHostMessage({ type: `navigate-to-route`, path: sn(e) });
        },
      })));
  }),
  dn,
  ...
  yn = e(() => {
    (v(),
      N(),
      y(),
      (_n = u({ type: h(`windows.sidebar.scroll`), windowId: d, scroll: x })),
      (vn = M({
        schema: _n,
        run: ({ scroll: e }) => {
          _(m(S.sidebarScroll), e);
        },
      })));
  }),
  Q,
  ...
  wn = e(() => {
    (v(),
      N(),
      y(),
      (Sn = u({ type: h(`windows.sidebar.select_project`), windowId: d, project: w })),
      (Cn = M({
        schema: Sn,
        run: ({ project: e }) => {
          let t = f(e).querySelector(S.sidebarProjectSelect);
  ...
  Dn = e(() => {
    (v(),
      ...
      N(),
      y(),
      (Tn = u({ type: h(`windows.sidebar.toggle`), windowId: d })),
      (En = M({
        schema: Tn,
        run: () => {
  ...
  An = e(() => {
    (v(),
      ...
      N(),
      y(),
      (On = u({ type: h(`windows.terminal.toggle`), windowId: d })),
      (kn = M({
        schema: On,
        run: (e, t) => {
          Xe(Y(t));
  ...
  Nn = e(() => {
    (v(),
      N(),
      y(),
      (jn = u({ type: h(`windows.timeline.scroll`), windowId: d, scroll: x })),
      (Mn = M({
        schema: jn,
        run: ({ scroll: e }) => {
          t(m(S.timelineScroll), e);
        },
      })));
  }),
  Pn,
  ...
  In = e(() => {
    (v(),
      N(),
      y(),
      (Pn = u({ type: h(`windows.timeline.scroll_to_turn`), windowId: d, direction: Te })),
      (Fn = M({
        schema: Pn,
        run: ({ direction: e }) => {
          he(m(S.timelineScroll), e);
        },
      })));
  });
function Ln() {
