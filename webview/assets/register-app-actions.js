...
import { i as He } from "./app-initial~app-main~remote-conversation-page~onboarding-page~projects-index-page~hotkey-wi~nek76pmq.js";
import {
  ci as Ue,
  oi as We,
  si as Ge,
...
async function z(e, t, r, i) {
  let a = ne(`get-settings`),
    ...
    s = i?.optimistic ?? !0;
  s && e.queryClient?.setQueryData(a, { ...o, values: { ...o?.values, [t.key]: r } });
  try {
    (await Le(t, r),
      s || e.queryClient?.setQueryData(a, { ...o, values: { ...o?.values, [t.key]: r } }));
  } catch (t) {
...
var B = e(() => {
  ...
  nt = e(() => {
    (l(),
      ...
      P(),
      B(),
      (V = p({ type: f(`app.appearance.set_mode`), mode: r([`light`, `dark`, `system`]) })),
      (H = N({
        schema: V,
        run: async ({ mode: e }, t) => (
...
var W,
  ...
  st = e(() => {
    (l(),
      ...
      (G = p({ code: d().nullable().optional(), ui: d().nullable().optional() })),
      ...
      (at = p({
        ...
        theme: re(`kind`, [
          p({ kind: f(`preset`), themeId: d().refine(Xe, `Invalid code theme id`) }),
        ...
        run: (e, t) => {
          ...
          return {
            ...
            window: {
              ...
              ...(r ? { sidebar: { viewport: Z(O.sidebarScroll), rows: ft() } } : {}),
              ...(u ? { review: { viewport: Z(O.reviewScroll), files: mt(n) } } : {}),
...
var Gt,
  ...
  Xt = e(() => {
    (c(),
      ...
      P(),
      E(),
      (Jt = p({ type: f(`windows.review.set_fullscreen`), windowId: T, fullscreen: u() })),
      (Yt = N({
        schema: Jt,
        run: ({ fullscreen: e }, t) => {
          J(t).set(g, e);
...
var cn,
  ...
  Tn = e(() => {
    (c(),
      P(),
      E(),
      (Cn = p({ type: f(`windows.sidebar.select_project`), windowId: T, project: k })),
      (wn = N({
        schema: Cn,
        run: ({ project: e }) => {
  ...
  Ln = e(() => {
    (c(),
      P(),
      E(),
      (Fn = p({ type: f(`windows.timeline.scroll_to_turn`), windowId: T, direction: ze })),
      (In = N({
        schema: Fn,
        run: ({ direction: e }) => {
