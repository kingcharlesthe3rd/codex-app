...
var zr,
  Br = e(() => {
    (br(), Nr(), Sn(), (zr = RegExp(`^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$`)));
  });
function Vr(e) {
...
function ga(e) {
  ...
  return (e.scope ? (t) => Un(e.scope, t) : i === void 0 ? (e) => e() : (e) => _a(i, e))(() => {
    let t = M(),
      a = Ca(t, i);
...
function xa(e, t, n) {
  ...
  let s = o.parentSampled ?? n,
    ...
    p = new ca({
      ...e,
      attributes: { [Gn]: `custom`, [Kn]: d !== void 0 && f ? d : void 0, ...c },
      sampled: u,
    });
  return (
    !u &&
...
function wo(e) {
  let t = N(),
    ...
    a = t.getSession();
  return (a?.status === `ok` && mn(a, { status: `exited` }), To(), t.setSession(i), i);
}
function To() {
  let e = N(),
...
function Ms(e) {
  ...
  return (
    Object.values(e).forEach((e) => {
      Array.isArray(e) ? (t += e.length * Ns(e[0])) : bt(e) ? (t += Ns(e)) : (t += 100);
    }),
    t
  );
}
  ...
  Bs = e(() => {
    (Po(),
      ...
      (zs = class {
        ...
        captureEvent(e, t, n) {
          let r = k();
          if (t?.originalException && tn(t.originalException)) return (v && S.log(Ps), r);
          let i = { event_id: r, ...t },
        ...
        _captureEvent(e, t = {}, n = M(), r = N()) {
          return (
            v && Os(e) && S.log(`Captured error event \`${hs(e)[0] || `<unknown>`}\``),
            this._processEvent(e, t, n, r).then(
              (e) => e.event_id,
              (e) => {
                v && (Cs(e) ? S.log(e.message) : Ss(e) ? S.warn(e.message) : S.warn(e));
              },
            )
          );
        }
...
function tc(e = {}) {
  ...
  let r = e.scope || M(),
    ...
    a = i ? Ur(i) : nc(r),
    o = mr(i ? yi(i) : vi(t, r));
  if (!zr.test(a)) return (S.warn(`Invalid sentry-trace data. Cannot generate trace data`), {});
...
function iu(e, t, n, r) {
  ...
  return (en(i), (i.level = `error`), n?.event_id && (i.event_id = n.event_id), Fa(i));
}
        ...
        return {
          ...
          setupOnce() {
            (t.setTimeout && D(W, `setTimeout`, cm),
              ...
              t.XMLHttpRequest && `XMLHttpRequest` in W && D(XMLHttpRequest.prototype, `send`, um));
            let e = t.eventTarget;
        ...
        return {
          ...
          setup(e) {
            ...
            function t() {
              ...
              t &&
                !L(t).timestamp &&
                (Q && S.log(`[Tracing] Finishing current active span with op: ${L(t).op}`),
            ...
            (e.on(`startNavigationSpan`, (n, r) => {
              ...
              (i.setPropagationContext({
                ...
                he(e, { op: `navigation`, ...n, parentSpan: null, forceTransaction: !0 }));
            }),
                ...
                np(({ to: t, from: r }) => {
                  ...
                  yh(
                    e,
                    {
                      ...
                      attributes: { [Gn]: `url`, [I]: `auto.navigation.browser` },
                    },
                    { url: t, isRedirect: o },
                  );
                });
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      return (
        t[4] === e
          ? (a = t[5])
          : ((a = (0, $.jsxs)(ie, { onClick: e, children: [n, i] })), (t[4] = e), (t[5] = a)),
        a
      );
    }
    case `ready`: {
...
var gg,
  $,
  _g = e(() => {
    ((gg = r()), c(), me(), ig(), pg(), pe(), ae(), ne(), ve(), le(), ($ = n()));
  });
function vg(e) {
...
function Sg(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Tg.jsx)(Se, { className: `icon-lg text-token-error-foreground` })),
      (a = (0, Tg.jsx)(_, {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Tg.jsx)(ye, { electron: !0, children: (0, Tg.jsx)(mg, {}) })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
    ? ((s = () => {
