...
var Be,
  ...
  S = e(() => {
    (Ae(),
      ...
      (Ve = `Sentry Logger `),
      (He = {}),
      (x = { enable: Me, disable: Ne, isEnabled: Pe, log: Fe, warn: Ie, error: Le }));
  });
function Ue(...e) {
...
`);
    for (let e = n; e < a.length; e++) {
      ...
      let o = Ze.test(n) ? n.replace(Ze, `$1`) : n;
      if (!o.match(/\S*Error: /)) {
        for (let e of t) {
          let t = e(o);
          if (t) {
...
function Ge(e) {
  ...
  let t = Array.from(e);
  return (
    /sentryWrapped/.test(Ke(t).function || ``) && t.pop(),
    t.reverse(),
    Qe.test(Ke(t).function || ``) && (t.pop(), Qe.test(Ke(t).function || ``) && t.pop()),
    t
      .slice(0, Xe)
      .map((e) => ({ ...e, filename: e.filename || Ke(t).filename, function: e.function || `?` }))
  );
}
function Ke(e) {
  return e[e.length - 1] || {};
...
function qe(e) {
  try {
    return !e || typeof e != `function` ? $e : e.name || $e;
  } catch {
    return $e;
  }
}
...
function nt(e, t) {
  if (!it[e]) {
    ...
    try {
      ...
      _ && x.error(`Error while instrumenting ${e}`, t);
    }
  }
}
function C(e, t) {
...
function dt() {
  ((ft = y.onunhandledrejection),
    (y.onunhandledrejection = function (e) {
      return (C(`unhandledrejection`, e), ft ? ft.apply(this, arguments) : !0);
    }),
...
function xt(e) {
  return e === null || bt(e) || (typeof e != `object` && typeof e != `function`);
}
function St(e) {
  return ht(e, `Object`);
}
...
function Dt(e) {
  return St(e) && `nativeEvent` in e && `preventDefault` in e && `stopPropagation` in e;
}
function Ot(e, t) {
  try {
...
function At(e) {
  return typeof Request < `u` && Ot(e, Request);
}
var jt,
  w = e(() => {
...
function T(e, t = {}) {
  ...
  try {
    ...
    for (
      ...
      n &&
      i++ < 5 &&
      ((o = Mt(n, s)), !(o === `html` || (i > 1 && a + r.length * 3 + o.length >= c)));
    )
...
function Mt(e, t) {
  let n = e,
    r = [];
  if (!n?.tagName) return ``;
  if (Ft.HTMLElement && n instanceof HTMLElement && n.dataset) {
...
function Nt() {
  try {
    return Ft.document.location.href;
  } catch {
    return ``;
  }
}
function Pt(e) {
  if (!Ft.HTMLElement) return null;
  let t = e;
  for (let e = 0; e < 5; e++) {
    if (!t) return null;
...
function E(e, t, n) {
  ...
  let i = n(r);
  typeof i == `function` && Rt(i, r);
  try {
    e[t] = i;
  } catch {
    _ && x.log(`Failed to replace method "${t}" in object`, e);
  }
}
function D(e, t, n) {
  try {
    ...
    _ && x.log(`Failed to add non-enumerable property "${t}" to object`, e);
  }
}
function Rt(e, t) {
  try {
...
function Bt(e) {
  if (mt(e)) return { message: e.message, name: e.name, stack: e.stack, ...Ht(e) };
  if (Ct(e)) {
    let t = { type: e.type, target: Vt(e.target), currentTarget: Vt(e.currentTarget), ...Ht(e) };
    return (typeof CustomEvent < `u` && Ot(e, CustomEvent) && (t.detail = e.detail), t);
  } else return e;
}
function Vt(e) {
  try {
    return wt(e) ? T(e) : Object.prototype.toString.call(e);
  } catch {
    return `<unknown>`;
  }
}
...
function Kt(e, t) {
  ...
  for (let t = 0; t < e.length; t++) {
    let r = e[t];
    try {
      kt(r) ? n.push(Ye(r)) : n.push(String(r));
    } catch {
...
function qt(e, t, n = !1) {
  return yt(e) ? (Tt(t) ? t.test(e) : yt(t) ? (n ? e === t : e.includes(t)) : !1) : !1;
}
function Jt(e, t = [], n = !1) {
  return t.some((t) => qt(e, t, n));
}
var Yt = e(() => {
  (w(), et());
});
...
function O(e = Xt()) {
  ...
  return (
    (an ||= `10000000100040008000100000000000`),
    an.replace(/[018]/g, (e) => (e ^ ((Zt() & 15) >> (e / 4))).toString(16))
  );
}
function Qt(e) {
...
function cn() {
  let { performance: e } = y;
  if (!e?.now || !e.timeOrigin) return sn;
  let t = e.timeOrigin;
  return () => (t + e.now()) / un;
}
function k() {
...
function gn(e, t) {
  let n = {};
  (t ? (n = { status: t }) : e.status === `ok` && (n = { status: `exited` }), hn(e, n));
}
function _n(e) {
  return {
    sid: `${e.sid}`,
...
function yn(e, t, n = 2) {
  ...
  let r = { ...e };
  for (let e in t) Object.prototype.hasOwnProperty.call(t, e) && (r[e] = yn(r[e], t[e], n - 1));
  return r;
}
var bn = e(() => {});
function xn() {
      ...
      (kn = class e {
        constructor() {
          ((this._notifyingListeners = !1),
            ...
            (this._propagationContext = { traceId: xn(), sampleRand: Math.random() }));
        }
        clone() {
          let t = new e();
          return (
        ...
        setUser(e) {
          return (
            ...
            this._session && hn(this._session, { user: e }),
        ...
        update(t) {
          ...
          let n = typeof t == `function` ? t(this) : t,
            ...
            } = (n instanceof e ? n.getScopeData() : St(n) ? t : void 0) || {};
          return (
        ...
        addBreadcrumb(e, t) {
          let n = typeof t == `number` ? t : On;
          if (n <= 0) return this;
          let r = { timestamp: sn(), ...e, message: e.message ? Gt(e.message, 2048) : e.message };
          return (
        ...
        setSDKProcessingMetadata(e) {
          return ((this._sdkProcessingMetadata = yn(this._sdkProcessingMetadata, e, 2)), this);
        }
        ...
        captureException(e, t) {
          let n = t?.event_id || O();
          if (!this._client)
            return (_ && x.warn(`No client configured on scope - will not capture exception!`), n);
        ...
        captureMessage(e, t, n) {
          let r = n?.event_id || O();
          if (!this._client)
            return (_ && x.warn(`No client configured on scope - will not capture message!`), r);
        ...
        captureEvent(e, t) {
          ...
          return this._client
            ...
            : (_ && x.warn(`No client configured on scope - will not capture event!`), n);
        }
...
function jn() {
  return ke(`defaultCurrentScope`, () => new kn());
}
function Mn() {
  return ke(`defaultIsolationScope`, () => new kn());
}
var Nn = e(() => {
  (Ae(), An());
});
function Pn() {
  let e = Oe(De());
  return (e.stack = e.stack || new zn(jn(), Mn()));
}
function Fn(e) {
...
function Rn() {
  return {
    withIsolationScope: Ln,
    withScope: Fn,
    withSetScope: In,
    withSetIsolationScope: (e, t) => Ln(t),
    ...
    (Nn(),
      ...
      (zn = class {
        constructor(e, t) {
          ...
          n = e || new kn();
          let r;
          ((r = t || new kn()), (this._stack = [{ scope: n }]), (this._isolationScope = r));
        }
        withScope(e) {
...
function Vn(e) {
  let t = Oe(e);
  return t.acs ? t.acs : Rn();
}
var Hn = e(() => {
  (Ae(), Bn());
});
function j() {
  return Vn(De()).getCurrentScope();
}
function M() {
  return Vn(De()).getIsolationScope();
}
function Un() {
  return ke(`globalScope`, () => new kn());
}
function Wn(...e) {
  let t = Vn(De());
  if (e.length === 2) {
...
var ur,
  dr,
  fr = e(() => {
    (Wt(), b(), (ur = `_sentryScope`), (dr = `_sentryIsolationScope`));
  });
function pr(e) {
  let t = hr(e);
  if (!t) return;
...
function mr(e) {
  if (e) return _r(Object.entries(e).reduce((e, [t, n]) => (n && (e[`${vr}${t}`] = n), e), {}));
}
function hr(e) {
  if (!(!e || (!yt(e) && !Array.isArray(e))))
...
function Cr(e) {
  ...
  return wr({ host: a, pass: i, path: c, projectId: l, port: o, protocol: n, publicKey: r });
}
function wr(e) {
  return {
    protocol: e.protocol,
...
function Fr(e, t) {
  let n = Pr(e),
    r = pr(t);
  if (!n?.traceId) return { traceId: xn(), sampleRand: Math.random() };
  let i = Rr(n, r);
...
function Ir(e = xn(), t = Sn(), n) {
  let r = ``;
  return (n !== void 0 && (r = n ? `-1` : `-0`), `${e}-${t}${r}`);
}
function Lr(e = xn(), t = Sn(), n) {
...
var zr,
  Br = e(() => {
    (br(), Nr(), Cn(), (zr = RegExp(`^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$`)));
  });
function Vr(e) {
  let { spanId: t, traceId: n } = e.spanContext(),
    { data: r, op: i, parent_span_id: a, status: o, origin: s, links: c } = L(e);
  return {
    parent_span_id: a,
    span_id: t,
    trace_id: n,
...
function Hr(e) {
  ...
  return {
    parent_span_id: i,
    span_id: r ? a?.getPropagationContext().propagationSpanId || Sn() : t,
    trace_id: n,
  };
}
function Ur(e) {
...
function Qr(e, t) {
  (D(t, ii, e[ii] || e), e[ri] ? e[ri].add(t) : D(e, ri, new Set([t])));
}
function $r(e, t) {
  e[ri] && e[ri].delete(t);
}
...
function z() {
  let e = Vn(De());
  return e.getActiveSpan ? e.getActiveSpan() : Tn(j());
}
function ti() {
  ni ||=
    (je(() => {
...
function ai() {
  ...
  function e() {
    ...
    if (t) {
      ...
      (_ && x.log(`[Tracing] Root span: ${e} -> Global error occurred`),
        t.setStatus({ code: 2, message: e }));
    }
  }
  ((e.tag = `sentry_tracingErrorCallback`), (oi = !0), ot(e), ut(e));
}
var oi,
  si = e(() => {
    (v(), lt(), pt(), S(), B(), ar(), (oi = !1));
...
function ui(e, t) {
  ...
  for (let n of t) {
    if (fi(n)) {
      if (qt(e.description, n)) return (_ && li(e), !0);
      continue;
    }
    if (!n.name && !n.op) continue;
    let t = n.name ? qt(e.description, n.name) : !0,
      r = n.op ? e.op && qt(e.op, n.op) : !0;
    if (t && r) return (_ && li(e), !0);
  }
  return !1;
}
function di(e, t) {
...
var bi,
  xi = e(() => {
    (hi(), P(), nr(), br(), jr(), ci(), Wt(), B(), fr(), (bi = `_frozenDsc`));
  }),
  Si,
  Ci = e(() => {
    (Cn(),
      ...
      (Si = class {
        constructor(e = {}) {
          ((this._traceId = e.traceId || xn()), (this._spanId = e.spanId || Sn()));
        }
        spanContext() {
...
function Di(e, t) {
  try {
    ...
    if (kt(t)) return Ye(t);
    if (Dt(t)) return `[SyntheticEvent]`;
    if (typeof t == `number` && !Number.isFinite(t)) return `[${t}]`;
    if (typeof t == `function`) return `[Function: ${qe(t)}]`;
...
function qi(e, t, n, r) {
  let i = Hi(n);
  return Ni(
    { sent_at: new Date().toISOString(), ...(i && { sdk: i }), ...(!!r && t && { dsn: Sr(t) }) },
...
function Zi(e) {
  if (!_) return;
  let { description: t = `< unknown name >`, op: n = `< unknown op >`, parent_span_id: r } = L(e),
...
function ea(e, t, n, r = z()) {
  let i = r && R(r);
  i &&
    (_ && x.log(`[Measurement] Setting measurement on root span: ${e} = ${t} ${n}`),
...
var sa,
  ...
  la = e(() => {
    (P(),
      ...
      (ca = class {
        constructor(e = {}) {
          ((this._traceId = e.traceId || xn()),
            (this._spanId = e.spanId || Sn()),
        ...
        updateName(e) {
          return ((this._name = e), this.setAttribute(F, `custom`), this);
        }
        end(e) {
          this._endTime || ((this._endTime = Kr(e)), Qi(this), this._onSpanEnded());
        }
        getSpanJSON() {
          return {
        ...
        addEvent(e, t, n) {
          _ && x.log(`[Tracing] Adding an event to span:`, e);
          let r = ra(t) ? t : n || k(),
            i = ra(t) ? {} : t || {},
        ...
        _onSpanEnded() {
          ...
          t && (lr(this).scope || j()).captureEvent(t);
        }
        _convertSpanToTransaction() {
          if (!ia(L(this))) return;
          this._name ||=
            (_ && x.warn("Transaction has no name, falling back to `<unlabeled transaction>`."),
          ...
          let a = {
              ...
              spans:
                r.length > sa
                  ? r.sort((e, t) => e.start_timestamp - t.start_timestamp).slice(0, sa)
                  : r,
              start_timestamp: this._startTime,
              timestamp: this._endTime,
    ...
    wa(a)(() => {
      let n = j(),
        ...
        s =
          e.onlyIfParent && !o
            ? new Si()
            : va({ parentSpan: o, spanArguments: r, forceTransaction: i, scope: n });
      return (
        wn(n, s),
        ua(
          () => t(s),
...
function ga(e) {
  ...
  return (e.scope ? (t) => Wn(e.scope, t) : i === void 0 ? (e) => e() : (e) => _a(i, e))(() => {
    let t = j(),
      a = Ca(t, i);
...
function _a(e, t) {
  let n = ba();
  return n.withActiveSpan ? n.withActiveSpan(e, t) : Wn((n) => (wn(n, e || void 0), t(n)));
}
function va({ parentSpan: e, spanArguments: t, forceTransaction: n, scope: r }) {
  if (!V()) {
    let r = new Si();
    return (
      (n || !e) && gi(r, { sampled: `false`, sample_rate: `0`, transaction: t.name, ...yi(r) }), r
    );
  }
  let i = M(),
    a;
...
function xa(e, t, n) {
  ...
  let s = o.parentSampled ?? n,
    ...
    [u, d, f] = t.getScopeData().sdkProcessingMetadata[Ta]
      ...
      : pa(
          i,
          { name: a, parentSampled: s, attributes: c, parentSampleRate: Mr(l.dsc?.sample_rate) },
          l.sampleRand,
        ),
    p = new ca({
      ...e,
      attributes: { [F]: `custom`, [Kn]: d !== void 0 && f ? d : void 0, ...c },
      sampled: u,
    });
  return (
    !u &&
      r &&
      (_ && x.log(`[Tracing] Discarding root span because its trace was not chosen to be sampled.`),
...
function Sa(e, t, n) {
  let { spanId: r, traceId: i } = e.spanContext(),
    ...
    o = a ? new ca({ ...n, parentSpanId: r, traceId: i, sampled: a }) : new Si({ traceId: i });
  Qr(e, o);
  let s = N();
...
function Da(e, t = {}) {
    ...
    apply(e, t, n) {
      ...
      let c = p.getOptions().ignoreSpans,
        u = o?.reduce(
          (e, t) => {
            let n = L(t);
            return !n.timestamp || (c && ui(n, c)) ? e : e ? Math.max(e, n.timestamp) : n.timestamp;
          },
          void 0,
        ),
        m = s.start_timestamp,
  ...
  function re(e) {
    (ee(), n.set(e, !0), ne(k() + u / 1e3));
  }
  function ie(e) {
    (n.has(e) && n.delete(e), n.size === 0 && te(k() + c / 1e3));
  }
  function ae(e) {
    ((r = !0), n.clear(), s.forEach((e) => e()), wn(m, h));
    let t = L(g),
      { start_timestamp: i } = t;
    if (!i) return;
  ...
  return (
    ...
    setTimeout(() => {
      r || (g.setStatus({ code: 2, message: `deadline_exceeded` }), (a = Ma), g.end());
    }, l),
    g
  );
}
function Oa(e) {
  let t = ga(e);
  return (wn(j(), t), _ && x.log(`[Tracing] Started span is an idle span`), t);
}
var ka,
  Aa,
  ja,
...
function Ua(e, t, n, r) {
  ...
  let a = i({ ...e }, t);
  return (
    _ && a === null && x.log(`Event processor "${i.id || `?`}" dropped event`),
    Et(a) ? a.then((e) => Ua(e, t, n, r + 1)) : Ua(a, t, n, r + 1)
  );
}
var Wa = e(() => {
  (v(), S(), w(), Va());
...
function Ka(e, t) {
  ...
  (qa(e, `extra`, n),
    ...
    qa(e, `user`, i),
    qa(e, `contexts`, a),
    (e.sdkProcessingMetadata = yn(e.sdkProcessingMetadata, s, 2)),
    o && (e.level = o),
...
function Za(e, t) {
  ((e.contexts = { trace: Hr(t), ...e.contexts }),
    (e.sdkProcessingMetadata = { dynamicSamplingContext: yi(t), ...e.sdkProcessingMetadata }));
...
function oo(e, t, n, r, i, a) {
  let { normalizeDepth: o = 3, normalizeMaxBreadth: s = 1e3 } = e,
    c = { ...t, event_id: t.event_id || n.event_id || O(), timestamp: t.timestamp || sn() },
...
function fo(e, t, n) {
  ...
  let r = {
    ...e,
    ...(e.breadcrumbs && {
      breadcrumbs: e.breadcrumbs.map((e) => ({ ...e, ...(e.data && { data: wi(e.data, t, n) }) })),
    }),
  ...
  return (
    e.contexts?.trace &&
      ...
      e.contexts.trace.data && (r.contexts.trace.data = wi(e.contexts.trace.data, t, n))),
    e.spans &&
      (r.spans = e.spans.map((e) => ({ ...e, ...(e.data && { data: wi(e.data, t, n) }) }))),
    e.contexts?.flags && r.contexts && (r.contexts.flags = wi(e.contexts.flags, 3, n)),
    r
  );
}
function po(e, t) {
  if (!t) return e;
  let n = e ? e.clone() : new kn();
  return (n.update(t), n);
}
function mo(e) {
...
function ho(e) {
  return e instanceof kn || typeof e == `function`;
}
function go(e) {
...
var _o,
  vo = e(() => {
    (hi(),
      ...
      Yt(),
      pn(),
      (_o = [`user`, `level`, `extra`, `contexts`, `tags`, `fingerprint`, `propagationContext`]));
  });
function yo(e, t) {
  return j().captureException(e, mo(t));
}
function bo(e, t) {
...
function wo(e) {
  let t = M(),
    ...
    i = mn({ user: n.getUser() || t.getUser(), ...(r && { userAgent: r }), ...e }),
    a = t.getSession();
  return (a?.status === `ok` && hn(a, { status: `exited` }), To(), t.setSession(i), i);
}
function To() {
  let e = M(),
    t = j().getSession() || e.getSession();
  (t && gn(t), Eo(), e.setSession());
}
function Eo() {
  let e = M(),
    t = N(),
...
function zo(e, t, n) {
  if (n[t.name]) {
    _ && x.log(`Integration skipped because it was already installed: ${t.name}`);
    return;
  }
  if (
    ((n[t.name] = t),
    !Bo.includes(t.name) && typeof t.setupOnce == `function` && (t.setupOnce(), Bo.push(t.name)),
  ...
  _ && x.log(`Integration installed: ${t.name}`);
}
function H(e) {
  return e;
}
    ...
    return n
      .add(() =>
        t({ body: Li(o) }).then(
          ...
          (e) => {
            throw (
              s(`network_error`), _ && x.error(`Encountered error running transport request:`, e), e
            );
          },
        ),
      )
      .then(
        ...
        (e) => {
          if (e === rs)
            return (
              _ && x.error(`Skipped sending event because buffer is full.`),
              s(`queue_overflow`),
              Promise.resolve({})
            );
          throw e;
...
function ps(e, t, n) {
  let r = [{ type: `client_report` }, { timestamp: n || sn(), discarded_events: e }];
  return Ni(t ? { dsn: t } : {}, [r]);
}
var ms = e(() => {
  (Gi(), pn());
...
function Ms(e) {
  ...
  return (
    Object.values(e).forEach((e) => {
      Array.isArray(e) ? (t += e.length * Ns(e[0])) : xt(e) ? (t += Ns(e)) : (t += 100);
    }),
    t
  );
}
      ...
      (zs = class {
        constructor(e) {
          if (
            ...
            e.dsn
              ? (this._dsn = Or(e.dsn))
              : _ && x.warn(`No DSN provided, client will not send events.`),
            this._dsn)
          ) {
            let t = Mo(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
        ...
        captureEvent(e, t, n) {
          let r = O();
          if (t?.originalException && nn(t.originalException)) return (_ && x.log(Ps), r);
          let i = { event_id: r, ...t },
        ...
        captureSession(e) {
          (this.sendSession(e), hn(e, { init: !1 }));
        }
        getDsn() {
          return this._dsn;
        }
        ...
        sendEvent(e, t = {}) {
          ...
          let n = Ji(e, this._dsn, this._options._metadata, this._options.tunnel);
        ...
        sendSession(e) {
          ...
          let r = qi(e, this._dsn, this._options._metadata, this._options.tunnel);
          this.sendEnvelope(r);
        }
        recordDroppedEvent(e, t, n = 1) {
          if (this._options.sendClientReports) {
            let r = `${e}:${t}`;
            (_ && x.log(`Recording outcome: "${r}"${n > 1 ? ` (${n} times)` : ``}`),
        ...
        async sendEnvelope(e) {
          if ((this.emit(`beforeEnvelope`, e), this._isEnabled() && this._transport))
            try {
              ...
              return (_ && x.error(`Error while sending envelope:`, e), {});
            }
          return (_ && x.error(`Transport disabled`), {});
        }
        _setupIntegrations() {
        ...
        _updateSessionFromEvent(e, t) {
          ...
          let a = e.status === `ok`;
          ((a && e.errors === 0) || (a && n)) &&
            (hn(e, { ...(n && { status: `crashed` }), errors: e.errors || Number(r || n) }),
            ...
            oo(i, e, t, n, this, r).then((e) =>
              e === null
                ...
                : (this.emit(`postprocessEvent`, e, t),
                  (e.contexts = { trace: Gn(n), ...e.contexts }),
        ...
        _captureEvent(e, t = {}, n = j(), r = M()) {
          return (
            _ && Os(e) && x.log(`Captured error event \`${hs(e)[0] || `<unknown>`}\``),
            this._processEvent(e, t, n, r).then(
              (e) => e.event_id,
              (e) => {
                _ && (Cs(e) ? x.log(e.message) : Ss(e) ? x.warn(e.message) : x.warn(e));
              },
            )
          );
        }
        _processEvent(e, t, n, r) {
          ...
          return this._prepareEvent(e, t, n, r)
            .then((e) => {
              ...
              return t.data && t.data.__sentry__ === !0 ? e : Es(Ds(this, i, e, t), c);
            })
            .then((i) => {
              if (i === null) {
        ...
        _flushOutcomes() {
          _ && x.log(`Flushing outcomes...`);
          let e = this._clearOutcomes();
          if (e.length === 0) {
            _ && x.log(`No outcomes to send`);
            return;
          }
          if (!this._dsn) {
            _ && x.log(`No dsn provided, will not send outcomes`);
            return;
          }
          _ && x.log(`Sending outcomes:`, e);
...
function tc(e = {}) {
  ...
  let r = e.scope || j(),
    ...
    a = i ? Ur(i) : nc(r),
    o = mr(i ? yi(i) : vi(t, r));
  if (!zr.test(a)) return (x.warn(`Invalid sentry-trace data. Cannot generate trace data`), {});
...
function gc(e, t) {
  return t?.length ? hs(e).some((e) => Jt(e, t)) : !1;
}
function _c(e, t) {
...
function xc(e) {
  try {
    ...
    return (_ && x.error(`Cannot extract url for event ${$t(e)}`), null);
  }
}
function Sc(e) {
...
function Oc(e, t, n, r, i, a) {
  if (!i.exception?.values || !a || !Ot(a.originalException, Error)) return;
  let o =
    i.exception.values.length > 0 ? i.exception.values[i.exception.values.length - 1] : void 0;
  o && (i.exception.values = kc(e, t, r, a.originalException, n, i.exception.values, o, 0));
}
    ...
    Array.isArray(r.errors) &&
      r.errors.forEach((r, a) => {
        if (Ot(r, Error)) {
          ...
          let l = e(t, r),
            u = c.length;
          (jc(l, `errors[${a}]`, u, s), (c = kc(e, t, n, r, i, [l, ...c], l, u)));
        }
      }),
    c
  );
...
function Pc() {
  `console` in y &&
    Be.forEach(function (e) {
      e in y.console &&
        E(y.console, e, function (t) {
          return (
            (He[e] = t),
            function (...t) {
              (C(`console`, { args: t, level: e }), He[e]?.apply(y.console, t));
            }
          );
        });
    });
...
function zc(e, t) {
  let n = e.message,
    r = t.message;
  return !((!n && !r) || (n && !r) || (!n && r) || n !== r || !Hc(e, t) || !Vc(e, t));
}
function Bc(e, t) {
  let n = Uc(t),
    r = Uc(e);
  return !(!n || !r || n.type !== r.type || n.value !== r.value || !Hc(e, t) || !Vc(e, t));
}
function Vc(e, t) {
  let n = Je(e),
    r = Je(t);
...
function Xc(e, t, n, r) {
  let i = tc({ span: n, propagateTraceparent: r }),
    ...
    s = i.traceparent;
  if (!a) return;
  let c = t.headers || (At(e) ? e.headers : void 0);
  if (!c) return { ...i };
  if ($c(c)) {
    let e = new Headers(c);
    if (
...
function $c(e) {
  return typeof Headers < `u` && Ot(e, Headers);
}
function el(e, t, n) {
  let r = Gs(e);
...
function tl(e, t, n, r) {
  let i = { url: e, type: `fetch`, "http.method": n, [I]: r, [Jn]: `http.client` };
  return (
    t &&
    ...
    E(y, `fetch`, function (t) {
      return function (...n) {
        ...
        return (
          e || C(`fetch`, { ...o }),
          t.apply(y, n).then(
            async (t) => (e ? e(t) : C(`fetch`, { ...o, endTimestamp: k() * 1e3, response: t }), t),
            (e) => {
              if (
                (C(`fetch`, { ...o, endTimestamp: k() * 1e3, error: e }),
                mt(e) && e.stack === void 0 && ((e.stack = r.stack), D(e, `framesToPop`, 1)),
...
function vl(e) {
  ...
  if (e.length === 2) {
    let [t, n] = e;
    return { url: _l(t), method: gl(n, `method`) ? String(n.method).toUpperCase() : `GET` };
  }
  let t = e[0];
  return { url: _l(t), method: gl(t, `method`) ? String(t.method).toUpperCase() : `GET` };
}
function yl(e) {
  let [t, n] = e;
  try {
    if (typeof n == `object` && n && `headers` in n && n.headers) return new Headers(n.headers);
    if (At(t)) return new Headers(t.headers);
  } catch {}
}
var bl = e(() => {
  (w(), Wt(), ul(), pn(), b(), at());
...
function Rl(e) {
  ...
  if (window.__SENTRY_IPC__?.[t.namespace]) return window.__SENTRY_IPC__[t.namespace];
  {
    ...
    let e = (window.__SENTRY_RENDERER_ID__ = O()),
      n = { [Il]: e };
    return {
      sendRendererStart: () => {
...
function Kl(e, t = {}) {
    ...
    try {
      ...
      throw (
        ...
        Wn((r) => {
          (r.addEventProcessor(
            (e) => (
              t.mechanism && (en(e, void 0, void 0), tn(e, t.mechanism)),
  ...
  (Rt(r, e), D(e, `__sentry_wrapped__`, r));
  try {
...
function Xl(e, t, n, r) {
  let i = N()?.getOptions().normalizeDepth,
    a = uu(t),
  ...
  let s = {
    exception: {
      values: [
        {
          type: Ct(t) ? t.constructor.name : r ? `UnhandledRejection` : `Error`,
...
function iu(e, t, n, r) {
  ...
  return (tn(i), (i.level = `error`), n?.event_id && (i.event_id = n.event_id), Fa(i));
}
...
function ou(e, t, n, r, i) {
  let a;
  if (gt(t) && t.error) return Zl(e, t.error);
  if (_t(t) || vt(t)) {
    let i = t;
    if (`stack` in t) a = Zl(e, t);
    else {
      let t = i.name || (_t(i) ? `DOMError` : `DOMException`),
  ...
  return mt(t)
    ? Zl(e, t)
    : St(t) || Ct(t)
      ? ((a = Xl(e, t, n, i)), tn(a, { synthetic: !0 }), a)
      : ((a = su(e, t, n, r)), en(a, `${t}`, void 0), tn(a, { synthetic: !0 }), a);
}
function su(e, t, n, r) {
  let i = {};
  if (r && n) {
...
var mu,
    ...
    (U(),
      ...
      (mu = class extends zs {
        ...
        eventFromException(e, t) {
          return iu(this._options.stackParser, e, t, this._options.attachStacktrace);
        }
        eventFromMessage(e, t = `info`, n) {
          return au(this._options.stackParser, e, t, n, this._options.attachStacktrace);
        }
        _prepareEvent(e, t, n, r) {
  ...
  yu,
  bu = e(() => {
    ((vu = (e, t) => (e > t[1] ? `poor` : e > t[0] ? `needs-improvement` : `good`)),
      (yu = (e, t, n, r) => {
        let i, a;
        return (o) => {
          t.value >= 0 &&
            ...
            ((a = t.value - (i ?? 0)),
            (a || i === void 0) &&
              ((i = t.value), (t.delta = a), (t.rating = vu(t.value, n)), e(t)));
        };
      }));
  }),
  xu,
...
var ku,
  ...
  Pu = e(() => {
    (q(),
      ...
      (Au = new Set()),
      (ju = () =>
        K.document?.visibilityState === `hidden` && !K.document?.prerendering ? 0 : 1 / 0),
      (Mu = (e) => {
        if (Ou(e) && ku > -1) {
          if (e.type === `visibilitychange` || e.type === `pagehide`) for (let e of Au) e();
          isFinite(ku) ||
          ...
          ((ku =
            (K.document.prerendering
              ...
              : globalThis.performance
                  ...
                  .filter((t) => t.name === `hidden` && t.startTime > e)[0]?.startTime) ?? ju()),
  ...
  Fu,
  Iu = e(() => {
    Fu = () => `v5-${Date.now()}-${Math.floor(Math.random() * 8999999999999) + 0xe8d4a51000}`;
  }),
  Lu,
  Ru = e(() => {
    (q(),
      ...
      (Lu = (e, t = -1) => {
        ...
        return (
          ...
          { name: e, value: t, rating: `good`, delta: 0, entries: [], id: Fu(), navigationType: r }
        );
      }));
  });
function zu(e, t) {
              ...
              for (let t of e)
                t.name === `first-contentful-paint` &&
                  ...
                  t.startTime < n.firstHiddenTime &&
                    ((r.value = Math.max(t.startTime - Cu(), 0)), r.entries.push(t), i(!0)));
            });
    ...
    (Gu(),
      ...
      (cd = () => {
        `interactionCount` in performance ||
          od ||
          (od = Wu(`event`, ad, { type: `event`, buffered: !0, durationThreshold: 0 }));
      }));
  }),
  ud,
  dd,
    ...
    (ld(),
      ...
      (pd = class e {
        ...
        _estimateP98LongestInteraction() {
          let e = Math.min(this._longestInteractionList.length - 1, Math.floor(fd() / 50));
        ...
        _processEntry(e) {
          ...
          if (n || this._longestInteractionList.length < ud || e.duration > t._latency) {
            if (
              (n
      ...
      (xd = (e, t = {}) => {
        ...
        Ju(() => {
          ...
          let r = Lu(`INP`),
            ...
            s = Wu(`event`, o, { durationThreshold: t.durationThreshold ?? bd });
      ...
      (Ed = (e, t = {}) => {
        Ju(() => {
          let n = Nu(),
            ...
            o = (e) => {
              ...
              for (let t of e)
                (a._processEntry(t),
                  t.startTime < n.firstHiddenTime &&
                    ((r.value = Math.max(t.startTime - Cu(), 0)), (r.entries = [t]), i()));
            },
          ...
          if (s) {
            ...
            for (let e of [`keydown`, `click`, `visibilitychange`]) Tu(e, a, { capture: !0 });
          }
        });
      }));
  }),
  ...
  jd = e(() => {
    (q(),
      ...
      (Ad = (e, t = {}) => {
        ...
        kd(() => {
          let e = xu();
          e && ((n.value = Math.max(e.responseStart - Cu(), 0)), (n.entries = [e]), r(!0));
        });
      }));
  });
function Md(e, t = !1) {
...
function Hd(e, t, n, r, i = !1) {
  Wd(e, t);
  let a;
  return (Jd[e] || ((a = n()), (Jd[e] = !0)), r && t({ metric: r }), Gd(e, t, i ? a : void 0));
}
function Ud(e) {
  let t = {};
...
function uf(e, t, n, r) {
  gu && x.log(`Sending CLS span (${e})`);
  let i = t ? J((A() || 0) + t.startTime) : k(),
    a = j().getScopeData().transactionName,
    o = t ? T(t.sources[0]?.node) : `Layout shift`,
    s = {
...
function pf(e, t, n, r) {
  gu && x.log(`Sending LCP span (${e})`);
  let i = J((A() || 0) + (t?.startTime || 0)),
    a = j().getScopeData().transactionName,
    o = t ? T(t.element) : `Largest contentful paint`,
    s = {
  ...
  t &&
    (t.element && (s[`lcp.element`] = T(t.element)),
    t.id && (s[`lcp.id`] = t.id),
...
function vf({ recordClsStandaloneSpans: e, recordLcpStandaloneSpans: t, client: n }) {
  let r = rf();
  if (r && A()) {
...
function Df(e, t, n, r, i, a) {
  if (Ef(t) || ([`mark`, `measure`].includes(t.entryType) && Jt(t.name, a))) return;
  let o = xu(!1),
  ...
  try {
    ...
    if (typeof n == `object`) {
      for (let [t, r] of Object.entries(n))
        if (r && xt(r)) e[`sentry.browser.measure.detail.${t}`] = r;
        else if (r !== void 0)
          try {
...
function Nf(e, t, n, r, i, a, o) {
  ...
  let u = { ...c, ...hf(t) },
    d = a + r;
  tf(e, d, d + i, { name: n.replace(K.location.origin, ``), op: s, attributes: u });
}
function Pf(e) {
  let t = K.navigator;
  if (!t) return;
  ...
  (n &&
    ...
    ef(t.deviceMemory) && e.setAttribute(`deviceMemory`, `${t.deviceMemory} GB`),
...
function Ff(e, t) {
  (Z &&
    ...
    (Z.element && e.setAttribute(`lcp.element`, T(Z.element)),
    ...
    Bf?.sources &&
      ...
      Bf.sources.forEach((t, n) => e.setAttribute(`cls.source.${n + 1}`, T(t.node))));
}
function If(e, t, n) {
  n.forEach(([n, r]) => {
    let i = e[n];
    i != null && ((typeof i == `number` && i < Rf) || typeof i == `string`) && (t[r] = i);
  });
}
function Lf(e) {
  let t = xu(!1);
...
function Hf() {
  return rf() && A() ? Id(`element`, Uf) : () => void 0;
}
var Uf,
  Wf = e(() => {
    (U(),
      ...
      (Uf = ({ entries: e }) => {
        let t = z(),
          n = t ? R(t) : void 0,
          r = n ? L(n).description : j().getScopeData().transactionName;
        e.forEach((e) => {
          let t = e;
          ...
          let n = t.name,
            i = t.renderTime,
            a = t.loadTime,
            [o, s] = a ? [J(a), `load-time`] : i ? [J(i), `render-time`] : [k(), `entry-emission`],
  ...
  (K.document.addEventListener(`click`, t, !1),
    ...
    [`EventTarget`, `Node`].forEach((t) => {
      ...
      n?.hasOwnProperty?.(`addEventListener`) &&
        (E(n, `addEventListener`, function (t) {
...
function Yf(e, t = !1) {
  return (n) => {
    ...
    (D(n, `_sentryCaptured`, !0), r && !r._sentryId && D(r, `_sentryId`, O()));
    let i = n.type === `keypress` ? `input` : n.type;
    (qf(n) || (e({ event: n, name: i, global: t }), ($f = n.type), (ep = r ? r._sentryId : void 0)),
      clearTimeout(Qf),
      (Qf = K.setTimeout(() => {
        ((ep = void 0), ($f = void 0));
      }, Zf)));
...
function rp() {
  if (
    (K.addEventListener(`popstate`, () => {
      let e = K.location.href,
        t = ap;
      ((ap = e), t !== e && C(`history`, { from: t, to: e }));
    }),
    !al())
  )
    return;
  ...
  (E(K.history, `pushState`, e), E(K.history, `replaceState`, e));
}
function ip(e) {
  try {
...
function sp(e) {
  ...
  if (r && typeof r.createElement == `function`)
    try {
      ...
      gu && x.warn(`Could not create sandbox iframe for ${e} check, bailing to window.${e}: `, t);
    }
...
function fp() {
  ...
  ((e.open = new Proxy(e.open, {
    apply(e, t, n) {
      let r = Error(),
        i = k() * 1e3,
        a = yt(n[0]) ? n[0].toUpperCase() : void 0,
        o = pp(n[1]);
      ...
      let s = () => {
        ...
        if (e && t.readyState === 4) {
          ...
          C(`xhr`, { endTimestamp: k() * 1e3, startTimestamp: i, xhr: t, virtualError: r });
        }
      };
      return (
        ...
        (t.setRequestHeader = new Proxy(t.setRequestHeader, {
          apply(e, t, n) {
            let [r, i] = n,
              a = t[mp];
            return (a && yt(r) && yt(i) && (a.request_headers[r.toLowerCase()] = i), e.apply(t, n));
          },
        })),
        e.apply(t, n)
      );
...
function gp(e) {
  ...
  try {
    ...
    return (gu && x.error(t, `Failed to get xhr response headers`, e), {});
  }
  return t
    ? t
        .split(`\r
    ...
    (U(),
      ...
      (Ep = ({ metric: e }) => {
        ...
        let { interactionId: r } = n,
          ...
          l = c?.span || s,
          u = l ? L(l).description : j().getScopeData().transactionName,
          d = nf({
        ...
        d && (d.addEvent(`inp`, { [Xn]: `millisecond`, [Zn]: e.value }), d.end(a + t));
      }));
  }),
  Op = e(() => {
    ...
    (U(),
      ...
      (Wp = (e) => {
        ...
        if (t) {
          ...
          let e = t[3],
            n = t[1] || `?`;
          return (([n, e] = Jp(n, e)), Np(e, n, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0));
        }
      }),
      (Gp = [Fp, Wp]),
      (Kp = [Vp, Gp]),
...
function Zp(e, t) {
  return function (n) {
    ...
    try {
      let e = n.event,
        t = nm(e) ? e.target : e;
      ((r = T(t, { keyAttrs: a, maxStringLength: o })), (i = Pt(t)));
    } catch {
      r = `<unknown>`;
    }
...
function Qp(e) {
  return function (t) {
    ...
    if (t.level === `assert`)
      if (t.args[0] === !1)
        ((n.message = `Assertion failed: ${Kt(t.args.slice(1), ` `) || `console.assert`}`),
    ...
    if (r && !(t.fetchData.url.match(/sentry_key/) && t.fetchData.method === `POST`))
      if ((t.fetchData.method, t.fetchData.url, t.error)) {
        ...
        let o = { input: t.args, response: i, startTimestamp: n, endTimestamp: r },
          s = { category: `fetch`, data: a, type: `http`, level: rl(a.status_code) };
...
function cm(e) {
  return function (...t) {
    ...
    return (
      (t[0] = Kl(n, {
        mechanism: { handled: !1, type: `auto.browser.browserapierrors.${qe(e)}` },
      })),
      e.apply(this, t)
    );
  };
        ...
        e in n &&
          ...
          E(n, e, function (t) {
            let n = {
              ...
              r = zt(t);
            return (r && (n.mechanism.data.handler = qe(r)), Kl(t, n));
          });
      }),
      e.apply(this, t)
    );
...
function dm(e, t) {
  let n = W[e]?.prototype;
  n?.hasOwnProperty?.(`addEventListener`) &&
    (E(n, `addEventListener`, function (n) {
      return function (r, i, a) {
        try {
          fm(i) &&
            (i.handleEvent = Kl(i.handleEvent, {
              mechanism: {
                data: { handler: qe(i), target: e },
                handled: !1,
    ...
    (U(),
      ...
      (gm = (e = {}) => {
        ...
        return {
          name: hm,
          setupOnce() {
            (t.setTimeout && E(W, `setTimeout`, cm),
              t.setInterval && E(W, `setInterval`, cm),
              t.requestAnimationFrame && E(W, `requestAnimationFrame`, lm),
              t.XMLHttpRequest && `XMLHttpRequest` in W && E(XMLHttpRequest.prototype, `send`, um));
            let e = t.eventTarget;
...
function Dm() {
  return N()?.getOptions() || { stackParser: () => [], attachStacktrace: !1 };
}
function Om(e) {
  if (!(!yt(e) || e.length === 0)) {
...
function Gm(e = {}) {
  ...
  return Vs(mu, {
    ...
    stackParser: We(e.stackParser || qp),
...
function Qm(e, t) {
  ...
  (n &&
    ...
    dl((e) => {
      ...
      if ((e.response && e.fetchData.__span && ih.set(e.response, e.fetchData.__span), t)) {
    ...
    r &&
      dp((e) => {
        ...
        t && (o && $m(t), c?.(t, { headers: Xm(e.xhr.__sentry_xhr_v3__?.request_headers) }));
      }));
}
function $m(e) {
  let { url: t } = L(e).data;
...
function eh(e, t) {
  ...
  if (n) {
    ...
    let a = r.origin === i;
    return t ? Jt(r.toString(), t) || (a && Jt(r.pathname, t)) : a;
  } else {
    let n = !!e.match(/^\/(?!\/)/);
    return t ? Jt(e, t) : n;
  }
...
function th(e, t, n, r, i, a) {
  ...
  if (e.endTimestamp && u) {
    ...
    n &&
      ...
      (ir(n, s.status_code), n.end(), a?.(n, { headers: Xm(gp(o)), error: e.error }), delete r[t]);
    return;
  }
  let d = Jm(c),
    f = qs(d || c),
...
function nh(e, t, n) {
  let { "sentry-trace": r, baggage: i, traceparent: a } = tc({ span: t, propagateTraceparent: n });
  r && rh(e, r, i, a);
}
function rh(e, t, n, r) {
  ...
  n &&
    e.on(`beforeSampling`, (e) => {
      ...
      (t.setPropagationContext({
        ...n,
        dsc: { ...n.dsc, sample_rate: String(i.sampleRate), sampled: String(mh(i.spanContext)) },
...
var hh,
  gh,
  _h = e(() => {
    (U(), Mp(), G(), (hh = `sentry_previous_trace`), (gh = `sentry.previous_trace`));
  });
function vh(e, t, n) {
...
function yh(e, t, n) {
  ...
  return (
    ...
    r && !i && a.setSDKProcessingMetadata({ normalizedRequest: { ...ql(), url: r } }),
    Sh(e)
  );
}
function bh(e) {
  ...
  a &&
    addEventListener(
      ...
      () => {
        ...
        if (((o &&= (o.setAttribute(Yn, `interactionInterrupted`), o.end(), void 0)), !i.name)) {
          Q &&
            x.warn(
        ...
        o = Da(
          { name: i.name, op: a, attributes: { [F]: i.source || `url` } },
      ...
      (Dh = (e = {}) => {
        ...
        function ge(e, r, i = !0) {
          let a = r.op === `pageload`,
            ...
            s = u ? u(r) : r,
            m = s.attributes || {};
          if ((o !== s.name && ((m[F] = `custom`), (s.attributes = m)), !i)) {
            let e = sn();
            ga({ ...s, startTime: e }).end(e);
            return;
          }
          ((t.name = s.name), (t.source = m[F]));
          let h = Da(s, {
            idleTimeout: d,
            finalTimeout: f,
            childSpanTimeout: p,
        ...
        return {
          ...
          setup(e) {
            ...
            function t() {
              ...
              t &&
                !L(t).timestamp &&
                (Q && x.log(`[Tracing] Finishing current active span with op: ${L(t).op}`),
            ...
            (e.on(`startNavigationSpan`, (n, r) => {
              ...
              (i.setPropagationContext({
                ...
                ge(e, { op: `navigation`, ...n, parentSpan: null, forceTransaction: !0 }));
            }),
              e.on(`startPageLoadSpan`, (n, r = {}) => {
                if (N() !== e) return;
                t();
                let i = Fr(r.sentryTrace || bh(`sentry-trace`), r.baggage || bh(`baggage`)),
                  a = j();
                (a.setPropagationContext(i),
                  V() || (a.getPropagationContext().propagationSpanId = Sn()),
                  a.setSDKProcessingMetadata({ normalizedRequest: ql() }),
                  ge(e, { op: `pageload`, ...n }));
              }),
              e.on(`endPageloadSpan`, () => {
                ue && he && (he.setAttribute(Yn, `reportPageLoaded`), he.end());
              }));
          },
          afterAllSetup(e) {
            let n = Nt();
            if (
              (ce !== `off` && uh(e, { linkPreviousTrace: ce, consistentTraceSampling: le }),
              W.location)
            ) {
              if (ae) {
                let t = A();
                vh(e, {
                  ...
                  attributes: { [F]: `url`, [I]: `auto.pageload.browser` },
                });
              }
              oe &&
                np(({ to: t, from: r }) => {
                  ...
                  yh(
                    e,
                    {
                      ...
                      attributes: { [F]: `url`, [I]: `auto.navigation.browser` },
                    },
                    { url: t, isRedirect: o },
                  );
                });
...
function Nh(e) {
  (M().addScopeListener((t) => {
    ...
    j().addScopeListener((t) => {
      e(Mh(), t);
    }),
    Un().addScopeListener((t) => {
      e(Mh(), t);
    }));
}
var Ph = e(() => {
...
function Rh(e) {
  let t;
  return ds(e, async (e) => ((t ||= zl()), t.sendEnvelope(e.body), { statusCode: 200 }));
}
var zh = e(() => {
    (U(), Vl());
  }),
...
var og,
  ...
  pg = e(() => {
    (re(),
      ...
      (sg = fe(u, og)),
      (cg = _e(u, ({ get: e }) => e(sg).isUpdateReady)),
      (lg = _e(u, ({ get: e }) => e(sg).lifecycleState)),
      (ug = _e(u, ({ get: e }) => e(sg).downloadProgressPercent)),
      (dg = _e(u, ({ get: e }) => e(sg).installProgressPercent)),
      (fg = _e(u, ({ get: e }) => e(sg).relaunchNotice)));
  });
function mg(e) {
  let t = (0, gg.c)(11),
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      t[0] === r
        ...
        : ((e = () => {
            if (r === `macOS`) {
              p.appUpdates?.installUpdate();
              return;
            }
            p.appUpdates?.checkForUpdates();
          }),
          (t[0] = r),
          (t[1] = e));
      let n;
      t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((n = (0, $.jsx)(ie, { className: `icon-xs` })), (t[2] = n))
        : (n = t[2]);
      let i;
      ...
      return (
        t[4] === e
          ? (a = t[5])
          : ((a = (0, $.jsxs)(oe, { onClick: e, children: [n, i] })), (t[4] = e), (t[5] = a)),
        a
      );
    }
    case `ready`: {
      ...
      t[6] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(ie, { className: `icon-xs` })), (t[6] = e))
        : (e = t[6]);
      let n;
      return (
...
var gg,
  $,
  _g = e(() => {
    ((gg = ee()), re(), c(), ig(), pg(), he(), se(), ae(), ve(), m(), ($ = de()));
  });
function vg(e) {
...
function Sg(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Tg.jsx)(Ce, { className: `icon-lg text-token-error-foreground` })),
      (a = (0, Tg.jsx)(s, {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Tg.jsx)(g, { electron: !0, children: (0, Tg.jsx)(mg, {}) })), (t[2] = o))
    : (o = t[2]);
  let c;
  t[3] !== r || t[4] !== n
    ? ((c = () => {
      ...
      : ((u = (0, Tg.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, Tg.jsxs)(`div`, {
              ...
              children: [o, (0, Tg.jsx)(oe, { onClick: c, children: l })],
            }),
          ],
        })),
        (t[7] = c),
      ...
      (Dg = class extends wg.Component {
        ...
        componentDidCatch(e, { componentStack: t }) {
          ...
          if (bg(e)) {
            ...
            ((t.name = `React ErrorBoundary ${t.name}`), (t.stack = r), xg(e, t));
          }
          let a = Zh(i, { boundaryName: this.props.name, componentStack: r });
          this.props.onError && this.props.onError(i, r, a);
          try {
            n.error(`error boundary`, {
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~appgen-settings-page~page~appgen-page~remote-con~di269h6j.js.map
