...
var ze,
  ...
  C = e(() => {
    (x(),
      ...
      (Be = `Sentry Logger `),
      (Ve = {}),
      (S = { enable: je, disable: Me, isEnabled: Ne, log: Pe, warn: Fe, error: Ie }));
  });
function He(...e) {
...
function We(e) {
  ...
  return (
    ...
    t.reverse(),
    Ze.test(Ge(t).function || ``) && (t.pop(), Ze.test(Ge(t).function || ``) && t.pop()),
    t
      .slice(0, Ye)
      .map((e) => ({ ...e, filename: e.filename || Ge(t).filename, function: e.function || `?` }))
  );
}
function Ge(e) {
  return e[e.length - 1] || {};
...
function bt(e) {
  return e === null || yt(e) || (typeof e != `object` && typeof e != `function`);
}
function xt(e) {
  return mt(e, `Object`);
}
...
function E(e, t = {}) {
  ...
  try {
    ...
    for (
      ...
      n &&
      i++ < 5 &&
      ((o = jt(n, s)), !(o === `html` || (i > 1 && a + r.length * 3 + o.length >= c)));
    )
...
function zt(e) {
  if (pt(e)) return { message: e.message, name: e.name, stack: e.stack, ...Vt(e) };
  if (St(e)) {
    let t = { type: e.type, target: Bt(e.target), currentTarget: Bt(e.currentTarget), ...Vt(e) };
    return (typeof CustomEvent < `u` && Dt(e, CustomEvent) && (t.detail = e.detail), t);
  } else return e;
}
function Bt(e) {
  try {
...
function Kt(e, t, n = !1) {
  return vt(e) ? (wt(t) ? t.test(e) : vt(t) ? (n ? e === t : e.includes(t)) : !1) : !1;
}
function qt(e, t = [], n = !1) {
...
function hn(e, t) {
  let n = {};
  (t ? (n = { status: t }) : e.status === `ok` && (n = { status: `exited` }), mn(e, n));
}
function gn(e) {
  return {
    sid: `${e.sid}`,
...
function vn(e, t, n = 2) {
  ...
  let r = { ...e };
  for (let e in t) Object.prototype.hasOwnProperty.call(t, e) && (r[e] = vn(r[e], t[e], n - 1));
  return r;
}
var yn = e(() => {});
function bn() {
      ...
      (On = class e {
        constructor() {
          ((this._notifyingListeners = !1),
            ...
            (this._propagationContext = { traceId: bn(), sampleRand: Math.random() }));
        }
        clone() {
          let t = new e();
          return (
        ...
        addBreadcrumb(e, t) {
          ...
          if (n <= 0) return this;
          let r = { timestamp: on(), ...e, message: e.message ? Wt(e.message, 2048) : e.message };
          return (
        ...
        setSDKProcessingMetadata(e) {
          return ((this._sdkProcessingMetadata = vn(this._sdkProcessingMetadata, e, 2)), this);
        }
        ...
        captureException(e, t) {
          let n = t?.event_id || k();
          if (!this._client)
            return (_ && S.warn(`No client configured on scope - will not capture exception!`), n);
        ...
        captureMessage(e, t, n) {
          let r = n?.event_id || k();
          if (!this._client)
            return (_ && S.warn(`No client configured on scope - will not capture message!`), r);
        ...
        captureEvent(e, t) {
          ...
          return this._client
            ...
            : (_ && S.warn(`No client configured on scope - will not capture event!`), n);
        }
    ...
    (Mn(),
      ...
      (Rn = class {
        constructor(e, t) {
          ...
          n = e || new On();
          let r;
          ((r = t || new On()), (this._stack = [{ scope: n }]), (this._isolationScope = r));
        }
        withScope(e) {
...
function pr(e) {
  if (e) return gr(Object.entries(e).reduce((e, [t, n]) => (n && (e[`${_r}${t}`] = n), e), {}));
}
function mr(e) {
...
function Sr(e) {
  ...
  return Cr({ host: a, pass: i, path: c, projectId: l, port: o, protocol: n, publicKey: r });
}
function Cr(e) {
  return {
    protocol: e.protocol,
...
var Rr,
  zr = e(() => {
    (yr(), Mr(), Sn(), (Rr = RegExp(`^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$`)));
  });
function Br(e) {
  let { spanId: t, traceId: n } = e.spanContext(),
    { data: r, op: i, parent_span_id: a, status: o, origin: s, links: c } = R(e);
  return {
    parent_span_id: a,
    span_id: t,
    trace_id: n,
...
var yi,
  ...
  Si = e(() => {
    (Sn(),
      ...
      (xi = class {
        constructor(e = {}) {
          ((this._traceId = e.traceId || bn()), (this._spanId = e.spanId || xn()));
        }
        spanContext() {
...
function Ki(e, t, n, r) {
  let i = Vi(n);
  return Mi(
    { sent_at: new Date().toISOString(), ...(i && { sdk: i }), ...(!!r && t && { dsn: xr(t) }) },
...
function Xi(e) {
  if (!_) return;
  let { description: t = `< unknown name >`, op: n = `< unknown op >`, parent_span_id: r } = R(e),
...
function $i(e, t, n, r = B()) {
  let i = r && z(r);
  i &&
    (_ && S.log(`[Measurement] Setting measurement on root span: ${e} = ${t} ${n}`),
    ...
    (F(),
      ...
      (sa = class {
        ...
        updateName(e) {
          ...
          this._endTime || ((this._endTime = Gr(e)), Zi(this), this._onSpanEnded());
        }
        getSpanJSON() {
          return {
        ...
        _onSpanEnded() {
          let e = P();
          if ((e && e.emit(`spanEnd`, this), !(this._isStandaloneSpan || this === z(this)))) return;
        ...
        _convertSpanToTransaction() {
          if (!ra(R(this))) return;
          this._name ||=
            (_ && S.warn("Transaction has no name, falling back to `<unlabeled transaction>`."),
          ...
          let a = {
              ...
              spans:
                r.length > oa
                  ? r.sort((e, t) => e.start_timestamp - t.start_timestamp).slice(0, oa)
                  : r,
              start_timestamp: this._startTime,
              timestamp: this._endTime,
    ...
    Ca(a)(() => {
      let n = M(),
        ...
        s =
          e.onlyIfParent && !o
            ? new xi()
            : _a({ parentSpan: o, spanArguments: r, forceTransaction: i, scope: n });
      return (
        Cn(n, s),
        la(
          () => t(s),
...
function ha(e) {
  ...
  return (e.scope ? (t) => Un(e.scope, t) : i === void 0 ? (e) => e() : (e) => ga(i, e))(() => {
    let t = M(),
      a = Sa(t, i);
...
function ga(e, t) {
  let n = ya();
  return n.withActiveSpan ? n.withActiveSpan(e, t) : Un((n) => (Cn(n, e || void 0), t(n)));
}
function _a({ parentSpan: e, spanArguments: t, forceTransaction: n, scope: r }) {
  if (!H()) {
    let r = new xi();
    return (
      (n || !e) && hi(r, { sampled: `false`, sample_rate: `0`, transaction: t.name, ...vi(r) }), r
    );
  }
  let i = N(),
    a;
...
function ba(e, t, n) {
  ...
  let s = o.parentSampled ?? n,
    ...
    [u, d, f] = t.getScopeData().sdkProcessingMetadata[wa]
      ...
      : fa(
          i,
          { name: a, parentSampled: s, attributes: c, parentSampleRate: jr(l.dsc?.sample_rate) },
          l.sampleRand,
        ),
    p = new sa({
      ...e,
  ...
  return (
    !u &&
      r &&
      (_ && S.log(`[Tracing] Discarding root span because its trace was not chosen to be sampled.`),
...
function xa(e, t, n) {
  let { spanId: r, traceId: i } = e.spanContext(),
    ...
    o = a ? new sa({ ...n, parentSpanId: r, traceId: i, sampled: a }) : new xi({ traceId: i });
  Zr(e, o);
  let s = P();
...
function Ea(e, t = {}) {
    ...
    apply(e, t, n) {
      ...
      let c = p.getOptions().ignoreSpans,
        u = o?.reduce(
          (e, t) => {
            let n = R(t);
            return !n.timestamp || (c && li(n, c)) ? e : e ? Math.max(e, n.timestamp) : n.timestamp;
          },
          void 0,
        ),
        m = s.start_timestamp,
  ...
  return (
    ...
    setTimeout(() => {
      r || (g.setStatus({ code: 2, message: `deadline_exceeded` }), (a = ja), g.end());
    }, l),
    g
  );
}
...
function Xa(e, t) {
  ((e.contexts = { trace: Vr(t), ...e.contexts }),
    (e.sdkProcessingMetadata = { dynamicSamplingContext: vi(t), ...e.sdkProcessingMetadata }));
...
function ao(e, t, n, r, i, a) {
  let { normalizeDepth: o = 3, normalizeMaxBreadth: s = 1e3 } = e,
    c = { ...t, event_id: t.event_id || n.event_id || k(), timestamp: t.timestamp || on() },
...
function uo(e, t, n) {
  ...
  let r = {
    ...e,
    ...(e.breadcrumbs && {
      breadcrumbs: e.breadcrumbs.map((e) => ({ ...e, ...(e.data && { data: Ci(e.data, t, n) }) })),
    }),
  ...
  return (
    e.contexts?.trace &&
      ...
      e.contexts.trace.data && (r.contexts.trace.data = Ci(e.contexts.trace.data, t, n))),
    e.spans &&
      (r.spans = e.spans.map((e) => ({ ...e, ...(e.data && { data: Ci(e.data, t, n) }) }))),
    e.contexts?.flags && r.contexts && (r.contexts.flags = Ci(e.contexts.flags, 3, n)),
    r
  );
}
function fo(e, t) {
...
var go,
  _o = e(() => {
    (mi(),
      ...
      Jt(),
      fn(),
      (go = [`user`, `level`, `extra`, `contexts`, `tags`, `fingerprint`, `propagationContext`]));
  });
function vo(e, t) {
...
function Co(e) {
  let t = N(),
    ...
    i = pn({ user: n.getUser() || t.getUser(), ...(r && { userAgent: r }), ...e }),
    a = t.getSession();
  return (a?.status === `ok` && mn(a, { status: `exited` }), wo(), t.setSession(i), i);
}
function wo() {
  let e = N(),
...
function Ro(e, t, n) {
  if (n[t.name]) {
    _ && S.log(`Integration skipped because it was already installed: ${t.name}`);
    return;
  }
  if (
    ((n[t.name] = t),
    !zo.includes(t.name) && typeof t.setupOnce == `function` && (t.setupOnce(), zo.push(t.name)),
    ...
    return n
      .add(() =>
        t({ body: Ii(o) }).then(
          ...
          (e) => {
            throw (
              s(`network_error`), _ && S.error(`Encountered error running transport request:`, e), e
            );
          },
        ),
      )
...
function fs(e, t, n) {
  let r = [{ type: `client_report` }, { timestamp: n || on(), discarded_events: e }];
  return Mi(t ? { dsn: t } : {}, [r]);
}
var ps = e(() => {
  (Wi(), fn());
...
function js(e) {
  ...
  return (
    Object.values(e).forEach((e) => {
      Array.isArray(e) ? (t += e.length * Ms(e[0])) : bt(e) ? (t += Ms(e)) : (t += 100);
    }),
    t
  );
}
      ...
      (Rs = class {
        constructor(e) {
          if (
            ...
            let t = jo(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
          ...
          ((this._options.enableLogs =
            ...
            this._options.enableLogs && Cs(this, `afterCaptureLog`, `flushLogs`, As, Wo),
        ...
        captureEvent(e, t, n) {
          let r = k();
          if (t?.originalException && tn(t.originalException)) return (_ && S.log(Ns), r);
          let i = { event_id: r, ...t },
        ...
        sendEvent(e, t = {}) {
          ...
          let n = qi(e, this._dsn, this._options._metadata, this._options.tunnel);
        ...
        sendSession(e) {
          ...
          let r = Ki(e, this._dsn, this._options._metadata, this._options.tunnel);
          this.sendEnvelope(r);
        }
        ...
        _updateSessionFromEvent(e, t) {
          ...
          let a = e.status === `ok`;
          ((a && e.errors === 0) || (a && n)) &&
            (mn(e, { ...(n && { status: `crashed` }), errors: e.errors || Number(r || n) }),
        ...
        _captureEvent(e, t = {}, n = M(), r = N()) {
          return (
            _ && Ds(e) && S.log(`Captured error event \`${ms(e)[0] || `<unknown>`}\``),
            this._processEvent(e, t, n, r).then(
              (e) => e.event_id,
              (e) => {
                _ && (Ss(e) ? S.log(e.message) : xs(e) ? S.warn(e.message) : S.warn(e));
              },
            )
          );
        }
        _processEvent(e, t, n, r) {
          ...
          return this._prepareEvent(e, t, n, r)
            .then((e) => {
              ...
              return t.data && t.data.__sentry__ === !0 ? e : Ts(Es(this, i, e, t), c);
            })
            .then((i) => {
              if (i === null) {
...
function ec(e = {}) {
  ...
  let r = e.scope || M(),
    ...
    a = i ? Hr(i) : tc(r),
    o = pr(i ? vi(i) : _i(t, r));
  if (!Rr.test(a)) return (S.warn(`Invalid sentry-trace data. Cannot generate trace data`), {});
...
function Dc(e, t, n, r, i, a) {
  ...
  o && (i.exception.values = Oc(e, t, r, a.originalException, n, i.exception.values, o, 0));
}
    ...
    Array.isArray(r.errors) &&
      r.errors.forEach((r, a) => {
        if (Dt(r, Error)) {
          ...
          let l = e(t, r),
            u = c.length;
          (Ac(l, `errors[${a}]`, u, s), (c = Oc(e, t, n, r, i, [l, ...c], l, u)));
        }
      }),
    c
  );
...
function Rc(e, t) {
  let n = e.message,
    r = t.message;
  return !((!n && !r) || (n && !r) || (!n && r) || n !== r || !Vc(e, t) || !Bc(e, t));
}
function zc(e, t) {
  let n = Hc(t),
    r = Hc(e);
  return !(!n || !r || n.type !== r.type || n.value !== r.value || !Vc(e, t) || !Bc(e, t));
}
function Bc(e, t) {
  let n = qe(e),
    r = qe(t);
          ...
          processEvent(t) {
            ...
            try {
              if (Lc(t, e))
                return (
                  _ &&
                    S.warn(`Event dropped due to being a duplicate of previously captured event.`),
                  null
                );
            } catch {}
            return (e = t);
...
function el(e, t, n, r) {
  let i = { url: e, type: `fetch`, "http.method": n, [L]: r, [qn]: `http.client` };
  return (
    t &&
    ...
    D(y, `fetch`, function (t) {
      return function (...n) {
        ...
        return (
          e || w(`fetch`, { ...o }),
          t.apply(y, n).then(
            async (t) => (e ? e(t) : w(`fetch`, { ...o, endTimestamp: A() * 1e3, response: t }), t),
            (e) => {
              if (
                (w(`fetch`, { ...o, endTimestamp: A() * 1e3, error: e }),
                pt(e) && e.stack === void 0 && ((e.stack = r.stack), O(e, `framesToPop`, 1)),
...
function _l(e) {
  ...
  if (e.length === 2) {
    let [t, n] = e;
    return { url: gl(t), method: hl(n, `method`) ? String(n.method).toUpperCase() : `GET` };
  }
  let t = e[0];
  return { url: gl(t), method: hl(t, `method`) ? String(t.method).toUpperCase() : `GET` };
}
function vl(e) {
  let [t, n] = e;
  try {
...
function iu(e, t, n, r) {
  ...
  return (en(i), (i.level = `error`), n?.event_id && (i.event_id = n.event_id), Pa(i));
}
...
function ou(e, t, n, r, i) {
  ...
  return pt(t)
    ...
    : xt(t) || St(t)
      ...
      : ((a = su(e, t, n, r)), $t(a, `${t}`, void 0), en(a, { synthetic: !0 }), a);
}
function su(e, t, n, r) {
  let i = {};
  if (r && n) {
...
function Df(e, t, n, r, i, a) {
  if (Ef(t) || ([`mark`, `measure`].includes(t.entryType) && qt(t.name, a))) return;
  let o = xu(!1),
...
function Ff(e, t) {
  (Z &&
    ...
    Bf?.sources &&
      ...
      Bf.sources.forEach((t, n) => e.setAttribute(`cls.source.${n + 1}`, E(t.node))));
}
function If(e, t, n) {
  n.forEach(([n, r]) => {
    let i = e[n];
...
function sp(e) {
  ...
  if (r && typeof r.createElement == `function`)
    try {
      ...
      gu && S.warn(`Could not create sandbox iframe for ${e} check, bailing to window.${e}: `, t);
    }
    ...
    apply(e, t, n) {
      ...
      let s = () => {
        ...
        if (e && t.readyState === 4) {
          ...
          w(`xhr`, { endTimestamp: A() * 1e3, startTimestamp: i, xhr: t, virtualError: r });
        }
      };
      return (
        ...
        (t.setRequestHeader = new Proxy(t.setRequestHeader, {
          apply(e, t, n) {
            let [r, i] = n,
              a = t[mp];
            return (a && vt(r) && vt(i) && (a.request_headers[r.toLowerCase()] = i), e.apply(t, n));
          },
        })),
        e.apply(t, n)
      );
  ...
  Dp = e(() => {
    (W(),
      ...
      (Ep = ({ metric: e }) => {
        ...
        d && (d.addEvent(`inp`, { [Yn]: `millisecond`, [Xn]: e.value }), d.end(a + t));
      }));
  }),
  Op = e(() => {
    ...
    if (r && !(t.fetchData.url.match(/sentry_key/) && t.fetchData.method === `POST`))
      if ((t.fetchData.method, t.fetchData.url, t.error)) {
        ...
        let o = { input: t.args, response: i, startTimestamp: n, endTimestamp: r },
          s = { category: `fetch`, data: a, type: `http`, level: nl(a.status_code) };
...
function cm(e) {
  return function (...t) {
    ...
    return (
      (t[0] = Gl(n, {
        mechanism: { handled: !1, type: `auto.browser.browserapierrors.${Ke(e)}` },
      })),
      e.apply(this, t)
    );
  };
        ...
        return {
          ...
          setupOnce() {
            (t.setTimeout && D(G, `setTimeout`, cm),
              ...
              t.XMLHttpRequest && `XMLHttpRequest` in G && D(XMLHttpRequest.prototype, `send`, um));
            let e = t.eventTarget;
...
function th(e, t, n, r, i, a) {
  ...
  if (e.endTimestamp && u) {
    ...
    n &&
      ...
      (rr(n, s.status_code), n.end(), a?.(n, { headers: Xm(gp(o)), error: e.error }), delete r[t]);
    return;
  }
  let d = Jm(c),
    f = Ks(d || c),
...
function nh(e, t, n) {
  let { "sentry-trace": r, baggage: i, traceparent: a } = ec({ span: t, propagateTraceparent: n });
  r && rh(e, r, i, a);
}
function rh(e, t, n, r) {
...
var hh,
  gh,
  _h = e(() => {
    (W(), Mp(), Jl(), (hh = `sentry_previous_trace`), (gh = `sentry.previous_trace`));
  });
function vh(e, t, n) {
...
function yh(e, t, n) {
  ...
  return (
    ...
    r && !i && a.setSDKProcessingMetadata({ normalizedRequest: { ...Kl(), url: r } }),
    Sh(e)
  );
}
function bh(e) {
  ...
  a &&
    addEventListener(
      ...
      () => {
        ...
        if (((o &&= (o.setAttribute(Jn, `interactionInterrupted`), o.end(), void 0)), !i.name)) {
          Q &&
            S.warn(
        ...
        return {
          ...
          setup(e) {
            ...
            function t() {
              ...
              t &&
                !R(t).timestamp &&
                (Q && S.log(`[Tracing] Finishing current active span with op: ${R(t).op}`),
            ...
            (e.on(`startNavigationSpan`, (n, r) => {
              ...
              e.on(`startPageLoadSpan`, (n, r = {}) => {
                if (P() !== e) return;
                t();
                let i = Pr(r.sentryTrace || bh(`sentry-trace`), r.baggage || bh(`baggage`)),
                  a = M();
                ...
                np(({ to: t, from: r }) => {
                  ...
                  yh(
                    e,
                    {
                      ...
                      attributes: { [I]: `url`, [L]: `auto.navigation.browser` },
                    },
                    { url: t, isRedirect: o },
                  );
                });
...
function Rh(e) {
  let t;
  return us(e, async (e) => ((t ||= Rl()), t.sendEnvelope(e.body), { statusCode: 200 }));
}
var zh = e(() => {
    (W(), Bl());
  }),
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      return (
        t[4] === e
          ? (a = t[5])
          : ((a = (0, $.jsxs)(ae, { onClick: e, children: [n, i] })), (t[4] = e), (t[5] = a)),
        a
      );
    }
    case `ready`: {
...
var gg,
  $,
  _g = e(() => {
    ((gg = m()), u(), pe(), ig(), pg(), re(), ie(), be(), se(), ge(), ($ = h()));
  });
function vg(e) {
...
function Sg(e) {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Tg.jsx)(ce, { electron: !0, children: (0, Tg.jsx)(mg, {}) })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
    ? ((s = () => {
      ...
      (Dg = class extends wg.Component {
        ...
        componentDidCatch(e, { componentStack: t }) {
          ...
          if (bg(e)) {
            ...
            ((t.name = `React ErrorBoundary ${t.name}`), (t.stack = n), xg(e, t));
          }
