...
function qn(e) {
  return e ? (Gn(e) ? e : Kn(e) ? (e.ownerDocument?.defaultView ?? window) : window) : window;
}
function Jn(e) {
  let { Document: t } = qn(e);
...
function Yn(e) {
  return Gn(e) ? !1 : e instanceof qn(e).HTMLElement;
}
function Xn(e) {
  return e instanceof qn(e).SVGElement;
}
function Zn(e) {
  return e
    ? Gn(e)
...
function $n() {
  let e = (0, dr.useRef)(null);
  return [
    (0, dr.useCallback)((t, n) => {
...
function sr(e) {
  if (!e) return !1;
  let { KeyboardEvent: t } = qn(e.target);
  return t && e instanceof t;
}
function cr(e) {
  if (!e) return !1;
  let { TouchEvent: t } = qn(e.target);
  return t && e instanceof t;
}
function lr(e) {
  if (cr(e)) {
  ...
  return or(e) ? { x: e.clientX, y: e.clientY } : null;
}
function ur(e) {
...
var dr,
  ...
  yr = e(() => {
    ((dr = t(zt())),
      ...
      (pr = fr ? dr.useLayoutEffect : dr.useEffect),
      (mr = {}),
      (hr = ar(1)),
      (gr = ar(-1)),
      (_r = Object.freeze({
        ...
        Transform: {
          toString(e) {
            if (e) return [_r.Translate.toString(e), _r.Scale.toString(e)].join(` `);
          },
        },
        Transition: {
          toString(e) {
...
function br(e) {
  let { id: t, value: n } = e;
  return Cr.createElement(`div`, { id: t, style: wr }, n);
}
function xr(e) {
...
function Sr() {
  let [e, t] = (0, Cr.useState)(``);
  return {
    announce: (0, Cr.useCallback)((e) => {
      e != null && t(e);
    }, []),
    announcement: e,
  };
...
var Cr,
  wr,
  Tr = e(() => {
    ((Cr = t(zt())), (wr = { display: `none` }));
  });
function Er(e) {
  let t = (0, W.useContext)($i);
  (0, W.useEffect)(() => {
...
function Dr() {
  let [e] = (0, W.useState)(() => new Set()),
    t = (0, W.useCallback)((t) => (e.add(t), () => e.delete(t)), [e]);
  return [
    (0, W.useCallback)(
      (t) => {
...
function Or(e) {
  let {
      ...
      screenReaderInstructions: i = ea,
    } = e,
    { announce: a, announcement: o } = Sr(),
    s = ir(`DndLiveRegion`),
    [c, l] = (0, W.useState)(!1);
  if (
    ((0, W.useEffect)(() => {
    ...
    return null;
  let u = W.createElement(
    W.Fragment,
    null,
    W.createElement(br, { id: r, value: i.draggable }),
    W.createElement(xr, { id: s, announcement: o }),
  );
  return n ? (0, Qi.createPortal)(u, n) : u;
}
function kr() {}
function Ar(e, t) {
  return (0, W.useMemo)(() => ({ sensor: e, options: t ?? {} }), [e, t]);
}
function jr() {
  var e = [...arguments];
  return (0, W.useMemo)(() => [...e].filter((e) => e != null), [...e]);
}
function Mr(e, t) {
...
function Hr(e, t) {
  return e && t ? { x: e.left - t.left, y: e.top - t.top } : ra;
}
function Ur(e) {
  return function (t) {
    return [...arguments]
...
function Kr(e, t) {
  ...
  if (t.ignoreTransform) {
    let { transform: t, transformOrigin: r } = qn(e).getComputedStyle(e);
    t && (n = Gr(n, t, r));
  }
...
function Yr(e, t) {
  return (t === void 0 && (t = qn(e).getComputedStyle(e)), t.position === `fixed`);
}
function Xr(e, t) {
  t === void 0 && (t = qn(e).getComputedStyle(e));
...
function Zr(e, t) {
  ...
  function r(i) {
    ...
    if (Jn(i) && i.scrollingElement != null && !n.includes(i.scrollingElement))
      return (n.push(i.scrollingElement), n);
    if (!Yn(i) || Xn(i) || n.includes(i)) return n;
    let a = qn(e).getComputedStyle(i);
    return (i !== e && Xr(i, a) && n.push(i), Yr(i, a) ? n : r(i.parentNode));
  }
  return e ? r(e) : n;
}
function Qr(e) {
...
function ai(e, t, n, r, i) {
  ...
  (r === void 0 && (r = 10), i === void 0 && (i = ua));
  let { isTop: l, isBottom: u, isLeft: d, isRight: f } = ii(e),
    p = { x: 0, y: 0 },
    m = { x: 0, y: 0 },
    h = { height: t.height * i.y, width: t.width * i.x };
  return (
    !l && a <= t.top + h.height
      ? ((p.y = la.Backward), (m.y = r * Math.abs((t.top + h.height - a) / h.height)))
      : !u &&
        c >= t.bottom - h.height &&
        ((p.y = la.Forward), (m.y = r * Math.abs((t.bottom - h.height - c) / h.height))),
    !f && s >= t.right - h.width
      ? ((p.x = la.Forward), (m.x = r * Math.abs((t.right - h.width - s) / h.width)))
      : !d &&
        o <= t.left + h.width &&
        ((p.x = la.Backward), (m.x = r * Math.abs((t.left + h.width - o) / h.width))),
    { direction: p, speed: m }
  );
}
function oi(e) {
...
function si(e) {
  return e.reduce((e, t) => hr(e, ni(t)), ra);
}
function ci(e) {
  return e.reduce((e, t) => e + ei(t), 0);
}
function li(e) {
  return e.reduce((e, t) => e + ti(t), 0);
}
function ui(e, t) {
  if ((t === void 0 && (t = Kr), !e)) return;
...
function di(e) {
  let { EventTarget: t } = qn(e);
  return e instanceof t ? e : Zn(e);
}
function fi(e, t) {
  let n = Math.abs(e.x),
    r = Math.abs(e.y);
...
function _i(e) {
  let {
      acceleration: t,
      activator: n = Ea.Pointer,
      canScroll: r,
      draggingRect: i,
      enabled: a,
      interval: o = 5,
      order: s = Da.TreeOrder,
    ...
    p = vi({ delta: d, disabled: !a }),
    [m, h] = $n(),
    g = (0, W.useRef)({ x: 0, y: 0 }),
    _ = (0, W.useRef)({ x: 0, y: 0 }),
    v = (0, W.useMemo)(() => {
      switch (n) {
        case Ea.Pointer:
          return c ? { top: c.y, bottom: c.y, left: c.x, right: c.x } : null;
        case Ea.DraggableRect:
          return i;
      }
    }, [n, i, c]),
    y = (0, W.useRef)(null),
    ...
    x = (0, W.useMemo)(() => (s === Da.TreeOrder ? [...l].reverse() : l), [s, l]);
  (0, W.useEffect)(() => {
    if (!a || !l.length || !v) {
      h();
      return;
    ...
    for (let e of x) {
      ...
      let n = u[l.indexOf(e)];
      if (!n) continue;
      let { direction: i, speed: a } = ai(e, n, v, t, f);
...
function vi(e) {
  ...
  return tr(
    (e) => {
      ...
      return {
        x: {
          [la.Backward]: e.x[la.Backward] || i.x === -1,
          [la.Forward]: e.x[la.Forward] || i.x === 1,
        },
        y: {
          [la.Backward]: e.y[la.Backward] || i.y === -1,
          [la.Forward]: e.y[la.Forward] || i.y === 1,
        },
      };
    },
    [n, t, r],
...
function yi(e, t) {
  ...
  return tr((e) => (t == null ? null : (r ?? e ?? null)), [r, t]);
}
function bi(e, t) {
  return (0, W.useMemo)(
    () =>
...
function xi(e, t) {
  ...
  return (
    ...
    { droppableRects: h, measureDroppableContainers: p, measuringScheduled: a != null }
  );
  function g() {
    switch (l) {
      case ka.Always:
        return !1;
      case ka.BeforeDragging:
        return n;
      default:
        return !n;
    }
...
function Si(e, t) {
  return tr((n) => (e ? n || (typeof t == `function` ? t(e) : e) : null), [t, e]);
}
function Ci(e, t) {
  return Si(e, t);
}
function wi(e) {
  ...
  return ((0, W.useEffect)(() => () => i?.disconnect(), [i]), i);
}
function Ti(e) {
  let { callback: t, disabled: n } = e,
    r = Qn(t),
...
function Ei(e) {
  return new fa(Kr(e), e);
}
function Di(e, t, n) {
  t === void 0 && (t = Ei);
  let [r, i] = (0, W.useState)(null);
  function a() {
    i((r) => {
      if (!e) return null;
  ...
  return (
    pr(() => {
      (a(),
        e
          ? (s?.observe(e), o?.observe(document.body, { childList: !0, subtree: !0 }))
...
function ki(e) {
  let t = (0, W.useRef)(e),
    n = tr(
      (n) =>
        e
          ? n && n !== Ma && e && t.current && e.parentNode === t.current.parentNode
            ? n
            : Zr(e)
          : Ma,
      [e],
...
function Ai(e) {
  let [t, n] = (0, W.useState)(null),
    ...
    i = (0, W.useCallback)((e) => {
      let t = $r(e.target);
      t && n((e) => (e ? (e.set(t, ni(t)), new Map(e)) : null));
    }, []);
  return (
    (0, W.useEffect)(() => {
      let t = r.current;
      if (e !== t) {
        ...
        let o = e
          .map((e) => {
            let t = $r(e);
            return t ? (t.addEventListener(`scroll`, i, { passive: !0 }), [t, ni(t)]) : null;
          })
          .filter((e) => e != null);
      ...
      function a(e) {
        e.forEach((e) => {
          $r(e)?.removeEventListener(`scroll`, i);
        });
      }
    }, [i, e]),
    (0, W.useMemo)(
      () => (e.length ? (t ? Array.from(t.values()).reduce((e, t) => hr(e, t), ra) : si(e)) : ra),
      [e, t],
    )
  );
}
...
function Pi(e) {
  return (0, W.useMemo)(() => (e ? Jr(e) : null), [e]);
}
function Fi(e, t) {
  t === void 0 && (t = Kr);
  let [n] = e,
    ...
    [i, a] = (0, W.useState)(Na);
  function o() {
    a(() => (e.length ? e.map((e) => (ri(e) ? r : new fa(t(e), e))) : Na));
  }
  let s = Ti({ callback: o });
  return (
    pr(() => {
...
function Li(e) {
  ...
  return (0, W.useMemo)(() => ({ nodeRef: a, rect: n, setRef: o }), [n, a, o]);
}
function Ri() {
  return {
    draggable: {
...
function zi(e, t) {
  switch (t.type) {
    ...
    case na.RegisterDroppable: {
      let { element: n } = t,
        { id: r } = n,
        i = new La(e.droppable.containers);
      return (i.set(r, n), { ...e, droppable: { ...e.droppable, containers: i } });
    }
    case na.SetDroppableDisabled: {
      let { id: n, key: r, disabled: i } = t,
        a = e.droppable.containers.get(n);
      if (!a || r !== a.key) return e;
      let o = new La(e.droppable.containers);
      return (
        o.set(n, { ...a, disabled: i }), { ...e, droppable: { ...e.droppable, containers: o } }
      );
    }
    case na.UnregisterDroppable: {
      let { id: n, key: r } = t,
        i = e.droppable.containers.get(n);
      if (!i || r !== i.key) return e;
      let a = new La(e.droppable.containers);
...
function Bi(e) {
  let { disabled: t } = e,
    { active: n, activatorEvent: r, draggableNodes: i } = (0, W.useContext)(Ba),
    a = rr(r),
    o = rr(n?.id);
  return (
    (0, W.useEffect)(() => {
      if (!t && !r && a && o != null) {
        if (!sr(a) || document.activeElement === a.target) return;
        let e = i.get(o);
        if (!e) return;
...
function Hi(e) {
  return (0, W.useMemo)(
    () => ({
      draggable: { ...Ia.draggable, ...e?.draggable },
      droppable: { ...Ia.droppable, ...e?.droppable },
      dragOverlay: { ...Ia.dragOverlay, ...e?.dragOverlay },
    }),
...
function Ui(e) {
  ...
  pr(() => {
    ...
    let i = Hr(n(e), r);
    if (
      (o || (i.x = 0), s || (i.y = 0), (a.current = !0), Math.abs(i.x) > 0 || Math.abs(i.y) > 0)
    ) {
      let t = Qr(e);
...
function Wi(e) {
  let { id: t, data: n, disabled: r = !1, attributes: i } = e,
    ...
    { role: p = Ka, roleDescription: m = `draggable`, tabIndex: h = 0 } = i ?? {},
    g = c?.id === t,
    _ = (0, W.useContext)(g ? Ha : Ga),
    [v, y] = nr(),
    [b, x] = nr(),
    S = Ni(o, t),
    C = er(n);
  return (
    ...
    ),
    {
      ...
      activatorEvent: s,
      activeNodeRect: l,
      attributes: (0, W.useMemo)(
        () => ({
          role: p,
          tabIndex: h,
          "aria-disabled": r,
          "aria-pressed": g && p === Ka ? !0 : void 0,
...
function Gi() {
  return (0, W.useContext)(Va);
}
function Ki(e) {
  let { data: t, disabled: n = !1, id: r, resizeObserverConfig: i } = e,
    a = ir(Ja),
    { active: o, dispatch: s, over: c, measureDroppableContainers: l } = (0, W.useContext)(Ba),
    u = (0, W.useRef)({ disabled: n }),
    d = (0, W.useRef)(!1),
    f = (0, W.useRef)(null),
    p = (0, W.useRef)(null),
    { disabled: m, updateMeasurementsFor: h, timeout: g } = { ...Ya, ...i },
    _ = er(h ?? r),
    v = Ti({
      callback: (0, W.useCallback)(() => {
        if (!d.current) {
  ...
  return (
    ...
    (0, W.useEffect)(
      () => (
        s({
          type: na.RegisterDroppable,
          element: { id: r, key: a, disabled: n, node: y, rect: f, data: x },
        }),
        () => s({ type: na.UnregisterDroppable, key: a, id: r })
      ),
      [r],
    ),
    (0, W.useEffect)(() => {
      n !== u.current.disabled &&
        (s({ type: na.SetDroppableDisabled, id: r, key: a, disabled: n }),
...
function qi(e) {
  ...
  return (
    ...
    W.createElement(W.Fragment, null, n, r ? (0, W.cloneElement)(r, { ref: o }) : null)
  );
}
function Ji(e) {
  let { children: t } = e;
  return W.createElement(
    Ba.Provider,
    { value: za },
    W.createElement(Ha.Provider, { value: Xa }, t),
  );
}
function Yi(e) {
  ...
  return Qn((e, a) => {
    ...
    let c = Ii(a);
    if (!c) return;
    let { transform: l } = qn(a).getComputedStyle(a),
      u = Wr(l);
    if (!u) return;
    let d = typeof t == `function` ? t : Xi(t);
    return (
      ui(s, i.draggable.measure),
      d({
...
function Xi(e) {
  let { duration: t, easing: n, sideEffects: r, keyframes: i } = { ...no, ...e };
  return (e) => {
...
var W,
  ...
  `,
      ...
      (oa = (e) => {
        ...
        for (let e of t) {
          let { id: t } = e,
            a = n.get(t);
          if (a && Br(r, a)) {
            let n = Ir(a).reduce((e, t) => e + Mr(r, t), 0),
      ...
      (ha = { start: [G.Space, G.Enter], cancel: [G.Esc], end: [G.Space, G.Enter, G.Tab] }),
      (ga = (e, t) => {
      ...
      (_a = class {
        constructor(e) {
          ...
          ((this.props = e),
            (this.listeners = new pa(Zn(t))),
            (this.windowListeners = new pa(qn(t))),
        ...
        attach() {
          (this.handleStart(),
            this.windowListeners.add(ma.Resize, this.handleCancel),
            this.windowListeners.add(ma.VisibilityChange, this.handleCancel),
            setTimeout(() => this.listeners.add(ma.Keydown, this.handleKeyDown)));
        }
        handleStart() {
        ...
        handleKeyDown(e) {
          if (sr(e)) {
            let { active: t, context: n, options: r } = this.props,
              { keyboardCodes: i = ha, coordinateGetter: a = ga, scrollBehavior: o = `smooth` } = r,
              { code: s } = e;
            if (i.end.includes(s)) {
              this.handleEnd(e);
              return;
            ...
            if (u) {
              ...
              for (let n of i) {
                let i = e.code,
                  ...
                  m = {
                    x: Math.min(
                      i === G.Right ? p.right - p.width / 2 : p.right,
                      Math.max(i === G.Right ? p.left : p.left + p.width / 2, u.x),
                    ),
                    y: Math.min(
                      i === G.Down ? p.bottom - p.height / 2 : p.bottom,
                      Math.max(i === G.Down ? p.top : p.top + p.height / 2, u.y),
                    ),
                  },
                  h = (i === G.Right && !s) || (i === G.Left && !c),
                  g = (i === G.Down && !l) || (i === G.Up && !a);
                if (h && m.x !== u.x) {
                  let e = n.scrollLeft + t.x,
                    a = (i === G.Right && e <= d.x) || (i === G.Left && e >= f.x);
                  if (a && !t.y) {
                  ...
                  (a
                    ? (r.x = n.scrollLeft - e)
                    : (r.x = i === G.Right ? n.scrollLeft - d.x : n.scrollLeft - f.x),
                    r.x && n.scrollBy({ left: -r.x, behavior: o }));
                  break;
                } else if (g && m.y !== u.y) {
                  let e = n.scrollTop + t.y,
                    a = (i === G.Down && e <= d.y) || (i === G.Up && e >= f.y);
                  if (a && !t.x) {
                  ...
                  (a
                    ? (r.y = n.scrollTop - e)
                    : (r.y = i === G.Down ? n.scrollTop - d.y : n.scrollTop - f.y),
                    r.y && n.scrollBy({ top: -r.y, behavior: o }));
                  break;
                }
              }
              this.handleMove(e, hr(gr(u, this.referenceCoordinates), r));
            }
          }
        }
        handleMove(e, t) {
      ...
      (_a.activators = [
        {
          eventName: `onKeyDown`,
          handler: (e, t, n) => {
            let { keyboardCodes: r = ha, onActivation: i } = t,
              { active: a } = n,
      ...
      (va = class {
        constructor(e, t, n) {
          ...
          ((this.props = e),
            (this.events = t),
            (this.document = Zn(i)),
            (this.documentListeners = new pa(this.document)),
            (this.listeners = new pa(n)),
            (this.windowListeners = new pa(qn(i))),
            (this.initialCoordinates = lr(r) ?? ra),
        ...
        attach() {
          ...
          if (
            ...
            this.windowListeners.add(ma.Resize, this.handleCancel),
            this.windowListeners.add(ma.DragStart, pi),
            this.windowListeners.add(ma.VisibilityChange, this.handleCancel),
            this.windowListeners.add(ma.ContextMenu, pi),
            this.documentListeners.add(ma.Keydown, this.handleKeydown),
            t)
          ) {
            if (
              n != null &&
        ...
        handleStart() {
          ...
          e &&
            ((this.activated = !0),
            this.documentListeners.add(ma.Click, mi, { capture: !0 }),
            this.removeTextSelection(),
            this.documentListeners.add(ma.SelectionChange, this.removeTextSelection),
            t(e));
        }
        handleMove(e) {
          ...
          if (!t && a) {
            if (hi(a)) {
              if (a.tolerance != null && fi(s, a.tolerance)) return this.handleCancel();
              if (fi(s, a.distance)) return this.handleStart();
            }
            if (gi(a) && fi(s, a.tolerance)) return this.handleCancel();
      ...
      (xa = { move: { name: `mousemove` }, end: { name: `mouseup` } }),
      (function (e) {
        e[(e.RightClick = 2)] = `RightClick`;
      })((Sa ||= {})),
      (Ca = class extends va {
        constructor(e) {
          super(e, xa, Zn(e.event.target));
        }
      }),
      (Ca.activators = [
        {
          ...
          handler: (e, t) => {
            let { nativeEvent: n } = e,
              { onActivation: r } = t;
            return n.button === Sa.RightClick ? !1 : (r?.({ event: n }), !0);
          },
        },
      ]),
      (wa = {
      ...
      (Ta = class extends va {
        ...
        static setup() {
          return (
            window.addEventListener(wa.move.name, e, { capture: !1, passive: !1 }),
            function () {
              window.removeEventListener(wa.move.name, e);
            }
          );
          function e() {}
        }
      ...
      (Oa = {
        x: { [la.Backward]: !1, [la.Forward]: !1 },
        y: { [la.Backward]: !1, [la.Forward]: !1 },
      }),
      (function (e) {
        ((e[(e.Always = 0)] = `Always`),
      ...
      (Fa = { current: {} }),
      (Ia = {
        draggable: { measure: qr },
        droppable: { measure: qr, strategy: ka.WhileDragging, frequency: Aa.Optimized },
        dragOverlay: { measure: Kr },
      }),
      (La = class extends Map {
        get(e) {
      ...
      (Ra = {
        ...
        over: null,
        dragOverlay: { nodeRef: { current: null }, rect: null, setRef: kr },
        scrollableAncestors: [],
        scrollableAncestorRects: [],
        measuringConfiguration: Ia,
      ...
      (Ba = (0, W.createContext)(za)),
      (Va = (0, W.createContext)(Ra)),
      (Ha = (0, W.createContext)({ ...ra, scaleX: 1, scaleY: 1 })),
      (function (e) {
        ((e[(e.Uninitialized = 0)] = `Uninitialized`),
          (e[(e.Initializing = 1)] = `Initializing`),
          (e[(e.Initialized = 2)] = `Initialized`));
      })((Ua ||= {})),
      (Wa = (0, W.memo)(function (e) {
        let {
            id: t,
            accessibility: n,
            autoScroll: r = !0,
            children: i,
            sensors: a = Pa,
            collisionDetection: o = aa,
            measuring: s,
            modifiers: c,
            ...l
          } = e,
          [u, d] = (0, W.useReducer)(zi, void 0, Ri),
          [f, p] = Dr(),
          [m, h] = (0, W.useState)(Ua.Uninitialized),
          g = m === Ua.Initialized,
          {
          ...
          S = (0, W.useRef)({ initial: null, translated: null }),
          C = (0, W.useMemo)(
            () => (_ == null ? null : { id: _, data: x?.data ?? Fa, rect: S }),
            [_, x],
          ),
          w = (0, W.useRef)(null),
          [T, E] = (0, W.useState)(null),
          [D, O] = (0, W.useState)(null),
          k = er(l, Object.values(l)),
          A = ir(`DndDescribedBy`, t),
          j = (0, W.useMemo)(() => b.getEnabled(), [b]),
          M = Hi(s),
          {
            droppableRects: N,
            measureDroppableContainers: P,
            measuringScheduled: ee,
          } = xi(j, { dragging: g, dependencies: [y.x, y.y], config: M.droppable }),
          F = yi(v, _),
          te = (0, W.useMemo)(() => (D ? lr(D) : null), [D]),
          I = De(),
          L = Ci(F, M.draggable.measure);
        Ui({
          activeNode: _ == null ? null : v.get(_),
          config: I.layoutShiftCompensation,
          initialRect: L,
          measure: M.draggable.measure,
        });
        let R = Di(F, M.draggable.measure, L),
          z = Di(F ? F.parentElement : null),
          B = (0, W.useRef)({
            activatorEvent: null,
            active: null,
            activeNode: F,
          ...
          ne = b.getNodeFor(B.current.over?.id),
          V = Li({ measure: M.dragOverlay.measure }),
          re = V.nodeRef.current ?? F,
          ie = g ? (V.rect ?? R) : null,
          ae = !!(V.nodeRef.current && V.rect),
          oe = Oi(ae ? null : R),
          se = Pi(re ? qn(re) : null),
          ce = ki(g ? (ne ?? F) : null),
          le = Fi(ce),
          ...
          _e =
            C && ge
              ...
              : null,
          ve = Lr(_e, `id`),
          [ye, be] = (0, W.useState)(null),
          xe = Vr(ae ? ue : hr(ue, me), ye?.rect ?? null, R),
          Se = (0, W.useRef)(null),
          Ce = (0, W.useCallback)(
            (e, t) => {
              ...
              Se.current = new n({
                ...
                onStart(e) {
                  ...
                  let { onDragStart: r } = k.current,
                    i = { activatorEvent: a, active: { id: t, data: n.data, rect: S } };
                  (0, Qi.unstable_batchedUpdates)(() => {
                    (r?.(i),
                      h(Ua.Initializing),
                      d({ type: na.DragStart, initialCoordinates: e, active: t }),
                ...
                onMove(e) {
                  d({ type: na.DragMove, coordinates: e });
                },
                onEnd: o(na.DragEnd),
                onCancel: o(na.DragCancel),
              });
              function o(e) {
                  ...
                  ((w.current = null),
                    (0, Qi.unstable_batchedUpdates)(() => {
                      (d({ type: e }),
                        ...
                        O(null),
                        (Se.current = null));
                      let t = e === na.DragEnd ? `onDragEnd` : `onDragCancel`;
                      if (o) {
                        let e = k.current[t];
          ...
          we = bi(
            ...
            (0, W.useCallback)(
              (e, t) => (n, r) => {
                ...
                let o = { active: a };
                e(n, t.options, o) === !0 &&
                  ((i.dndKit = { capturedBy: t.sensor }), (w.current = r), Ce(n, t));
              },
              [v, Ce],
            ),
          );
        (Mi(a),
          pr(() => {
            R && m === Ua.Initializing && h(Ua.Initialized);
          }, [R, m]),
          (0, W.useEffect)(() => {
          ...
          (0, W.useEffect)(() => {
            ...
            (0, Qi.unstable_batchedUpdates)(() => {
              (be(s), a?.(c), f({ type: `onDragOver`, event: c }));
            });
          }, [ve]),
          pr(() => {
            ((B.current = {
              ...
              (S.current = { initial: ie, translated: ge }));
          }, [C, F, _e, ge, v, re, ie, N, b, ye, ce, he]),
          _i({
            ...I,
            delta: y,
            draggingRect: ge,
        ...
        let Te = (0, W.useMemo)(
            ...
            [C, F, R, D, _e, z, V, v, b, N, ye, P, ce, le, M, ee, se],
          ),
          Ee = (0, W.useMemo)(
            () => ({
              activatorEvent: D,
        ...
        return W.createElement(
          ...
          W.createElement(
            ...
            W.createElement(
              Va.Provider,
              { value: Te },
              W.createElement(Ha.Provider, { value: xe }, i),
            ),
            W.createElement(Bi, { disabled: n?.restoreFocus === !1 }),
          ),
          W.createElement(Or, { ...n, hiddenTextDescribedById: A }),
        );
        function De() {
      ...
      (Ga = (0, W.createContext)(null)),
      (Ka = `button`),
      (qa = `Draggable`),
      (Ja = `Droppable`),
      (Ya = { timeout: 25 }),
      (Xa = { x: 0, y: 0, scaleX: 1, scaleY: 1 }),
      (Za = { position: `fixed`, touchAction: `none` }),
      (Qa = (e) => (sr(e) ? `transform 250ms ease` : void 0)),
      ($a = (0, W.forwardRef)((e, t) => {
        let {
          as: n,
          activatorEvent: r,
          adjustScale: i,
        ...
        let d = i ? l : { ...l, scaleX: 1, scaleY: 1 },
          f = {
            ...
            top: s.top,
            left: s.left,
            transform: _r.Transform.toString(d),
            transformOrigin: i && r ? Nr(r, s) : void 0,
            transition: typeof u == `function` ? u(r) : u,
            ...c,
          };
        return W.createElement(n, { className: o, style: f, ref: t }, a);
      })),
      (eo = (e) => (t) => {
      ...
      (to = (e) => {
        ...
        return [{ transform: _r.Transform.toString(t) }, { transform: _r.Transform.toString(n) }];
      }),
      (no = {
        duration: 250,
        easing: `ease`,
...
function lo(e, t) {
  ...
  let n = mo(e),
    ...
    s = { x: Math.round(n.x + Math.max(Ao, (n.width - a) / 2)), y: n.y, width: a, height: o };
  return {
    fitHeight: r.height,
    fitWidth: r.width,
    scale: i,
...
function go(e) {
  return { width: Math.max(0, e.width - Ao * 2), height: Math.max(0, e.height - Ao) };
}
function _o({ drag: e, fitHeight: t, fitWidth: n, pointerX: r, pointerY: i, scale: a }) {
  ...
  return {
    width: s
      ? So(
          bo({ fitSize: n, rawSize: e.startWidth + ((r - e.startPointerX) * c * 2) / a, scale: a }),
        )
      : e.startWidth,
    height: o
      ? Co(bo({ fitSize: t, rawSize: e.startHeight + (i - e.startPointerY) / a, scale: a }))
      : e.startHeight,
  };
}
...
var To,
  ...
  No = e(() => {
    ((To = `responsive`),
      ...
      (Mo = { isEnabled: !1, presetId: ko.id, width: ko.width, height: ko.height }));
  });
function Po(e, t) {
  return (
    e.host !== t.host &&
      ...
      (Bo = class {
        ...
        acknowledgeAttachment(e, t, n, r) {
          for (let i of zo) {
            ...
            if (
              ...
              (O.info(`IAB_TAB_SWITCH renderer acknowledged Owl webview handoff`, {
                safe: {
                  ...Fo(a),
            ...
            a != null &&
              O.info(`IAB_TAB_SWITCH renderer ignored stale Owl webview handoff acknowledgement`, {
                safe: {
                  ...Fo(a),
                  acknowledgedMountGeneration: n,
                  currentMountGeneration: r,
        ...
        stage(e, t, n, r) {
          ...
          ((this.pendingHandoffs[e] = i),
            (i.removeIncomingDidAttachListener = n.host.listenForDidAttach(() => {
              this.pendingHandoffs[e] === i &&
                (O.info(`IAB_TAB_SWITCH renderer observed Owl webview did-attach during handoff`, {
            ...
            (i.timeoutId = window.setTimeout(() => {
              this.pendingHandoffs[e] === i &&
                ...
                O.info(`IAB_TAB_SWITCH renderer timed out Owl webview handoff`, {
                  safe: { ...Fo(i), hostKind: e },
                  sensitive: {},
                }),
                this.commit(e, i));
            }, Lo)),
            O.info(`IAB_TAB_SWITCH renderer staged Owl webview handoff`, {
              safe: { ...Fo(i), hostKind: e },
              sensitive: {},
            }),
        ...
        scheduleCommitAfterPrewarm(e, t, n = Ro) {
          if (
            ...
            if (n === 0) {
              (O.info(`IAB_TAB_SWITCH renderer prewarmed Owl webview handoff before reveal`, {
            ...
            (O.info(`IAB_TAB_SWITCH renderer prewarming Owl webview handoff before reveal`, {
        ...
        commit(e, t) {
          this.pendingHandoffs[e] !== t ||
            ...
            O.info(`IAB_TAB_SWITCH renderer committed Owl webview handoff`, {
              safe: { ...Fo(t), hostKind: e },
              sensitive: {},
            }),
        ...
        releaseOutgoing(e, t, n) {
          this.pendingHandoffs[e] === t &&
            ...
            O.info(`IAB_TAB_SWITCH renderer released outgoing Owl webview handoff`, {
              safe: { ...Fo(t), hostKind: e, timing: n },
              sensitive: {},
            }));
        }
        cancel(e, t, n) {
          ...
          r != null &&
            ...
            n
              ...
              : r.outgoing.host.isConnected()
                ...
                : (this.paintedWebviews[e] = null),
            O.info(`IAB_TAB_SWITCH renderer cancelled Owl webview handoff`, {
...
function qo(e, t) {
  ...
  return e.getAttribute(`data-browser-sidebar-page-restore`) === n &&
    ...
    ? !1
    : (t == null
        ? (e.removeAttribute(Zt), e.removeAttribute(dn))
        : (e.setAttribute(Zt, t.restore), e.setAttribute(dn, t.browserStorageId)),
      !0);
}
...
function Qo(e, t, n, r, i, a) {
  (Xo(e, t, n, r, i, a), Object.assign(e.style, { pointerEvents: `none`, visibility: `hidden` }));
}
function $o(e, t, n, r, i, a) {
  (Xo(e, t, n, r, i, a), Object.assign(e.style, { opacity: gs, pointerEvents: `none` }));
}
function es(e) {
      ...
      (ys = class {
        ...
        detach(e, t) {
          ...
          ((this.webviewRef = e),
            ...
            O.info(`IAB_LIFECYCLE renderer backgrounded browser sidebar webview`, {
              safe: {
        ...
        releaseRef(e, t) {
          let n = this.webview;
          n == null || (t != null && t !== this.state.mountGeneration) || is(e, null, n);
        }
        sync(e, t) {
          let n = this.webview;
          if (this.isDisposed || n == null) {
        ...
        bringToFront() {
          let e = this.container;
          e?.isConnected === !0 && e.nextElementSibling != null && rs().append(e);
        }
        ...
        dispose() {
          ...
          ((this.isDisposed = !0),
            O.info(`IAB_LIFECYCLE renderer disposed browser sidebar webview`, {
          ...
          if (i != null && this.browserUseCaptureSurfaceSize == null) {
            ...
            return a == null
              ? r || this.state.shouldPaint === !1
                ? (Qo(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `bootstrap`)
                : this.isStaged
                  ? ($o(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `staged`)
                  : (Xo(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `visible`)
              : (Zo(e, n, t, a), `hidden`);
          }
          let a = Yo({
        ...
        parkInDom() {
          ...
          (this.attachToDom(), Qo(e, n, t, r, this.state.scale, this.state.windowZoom ?? 1));
        }
        detachFromDom() {
      ...
      (Ac = class {
        ...
        constructor({
          ...
          ((this.browserTabId = e),
            ...
            this.webview.setAttribute(`src`, o.length === 0 ? xc : o),
        ...
        detach(e) {
          ...
          ((this.isAttached = !1),
            ...
            bc(e, null, this.webview),
            this.syncContainerStyle(),
            O.info(`IAB_LIFECYCLE renderer detached retained browser sidebar webview`, {
              safe: { browserTabId: this.browserTabId, conversationId: this.conversationId },
            }));
        }
        sync(e, t) {
        ...
        dispose() {
          (O.info(`IAB_LIFECYCLE renderer disposed retained browser sidebar webview`, {
            safe: { browserTabId: this.browserTabId, conversationId: this.conversationId },
          }),
            this.container.remove());
        }
...
function Mc(e) {
  let t = e.indexOf(`\0`);
  return { browserTabId: ie(e.slice(t + 1)), conversationId: e.slice(0, t) };
}
function Nc(e, t) {
  return [e, t?.tabType ?? ``, t?.title ?? ``, t?.url ?? ``, t?.faviconUrl ?? ``].join(`	`);
}
function Pc(e, t) {
  return t === Fc(e, void 0) ? e : K(e, t);
}
function Fc(e, t) {
  return t ?? ee(e);
}
...
var Lc,
  ...
  Vc = e(() => {
    (z(),
      ...
      fc(),
      jc(),
      (Lc = { responsiveViewportSize: null, toolbarState: Mo }),
      (Rc = `default`),
      (zc = class {
        listeners = new Set();
        ...
        constructor() {
          (l.subscribe(`browser-sidebar-state`, (e) => {
            this.setSnapshot(e.conversationId, Fc(e.conversationId, e.browserTabId), e.snapshot);
          }),
            l.subscribe(`browser-sidebar-browser-use-state`, (e) => {
              this.setBrowserUseActive(
                e.conversationId,
                Fc(e.conversationId, e.browserTabId),
                e.isActive,
              );
            }),
            l.subscribe(`browser-sidebar-browser-use-page-released`, (e) => {
              this.releaseBrowserUseTab(e.conversationId, Fc(e.conversationId, e.browserTabId));
            }),
        ...
        getSnapshot(e, t = Fc(e, void 0)) {
          return this.snapshots.get(K(e, t)) ?? null;
        }
        getBrowserStorageId(e, t = Fc(e, void 0)) {
          let n = K(e, t),
            r = this.tabPersistenceStates.get(n);
          if (r != null) return r.browserStorageId;
          let i = it(`browser:${crypto.randomUUID()}`);
          return (this.tabPersistenceStates.set(n, { browserStorageId: i, mode: `ephemeral` }), i);
        }
        getExistingBrowserStorageId(e, t) {
          return this.tabPersistenceStates.get(K(e, t))?.browserStorageId ?? null;
        }
        ...
        getPagePersistence(e, t, n) {
          ...
          let r = K(e, t),
            i = this.tabPersistenceStates.get(r);
          if (i == null) {
            let e = it(`browser:${crypto.randomUUID()}`);
            return (
        ...
        hasRetainedWebview(e, t = Fc(e, void 0)) {
          return this.webviews.get(K(e, t)) instanceof Ac;
        }
        getBrowserUseCursorState(e, t = Fc(e, void 0)) {
          return this.browserUseCursorStates.get(K(e, t)) ?? null;
        }
        isBrowserUseActive(e, t = Fc(e, void 0)) {
          return this.browserUseActiveTabKeys.has(K(e, t));
        }
        isBrowserUseTab(e, t = Fc(e, void 0)) {
          return this.browserUseTabKeys.has(K(e, t));
        }
        getBrowserUseTabs() {
        ...
        getDeviceToolbarTabState(e, t = Fc(e, void 0)) {
          return this.deviceToolbarTabStates.get(K(e, t)) ?? Lc;
        }
        getMountGeneration(e, t = Fc(e, void 0)) {
          return this.mountStates.get(K(e, t))?.generation ?? 0;
        }
        claimMountGeneration(e, t = Fc(e, void 0), n = Rc) {
          let r = K(e, t),
        ...
        hasOtherMountGenerationClaim(e, t = Fc(e, void 0), n = Rc, r) {
          let i = this.mountStates.get(K(e, t));
          if (i == null || (r != null && i.generation !== r)) return !1;
          for (let e of i.claimKeys) if (e !== n) return !0;
          return !1;
        }
        releaseMountGeneration(e, t = Fc(e, void 0), n = Rc, r) {
          let i = K(e, t),
        ...
        setDeviceToolbarTabState(e, t, n) {
          let r = typeof t == `function` ? Fc(e, void 0) : t,
        ...
        setSnapshot(e, t, n) {
          let r = typeof t == `string` ? t : Fc(e, void 0),
        ...
        getWebview(e, ...t) {
          ...
          if (Ic(t)) {
            let [e, a, o] = t;
            ((n = e), (r = a), (i = o));
          } else ((n = Fc(e, void 0)), (r = t[0]), (i = t[1]));
          let a = K(e, n),
          ...
          if (l instanceof ys && l.getPartition() === c)
            return (
              l.setHostKind(u),
              l.setPagePersistence(s) &&
                (this.notifyWebviewHostCreated(e, n, u, s), this.emitChange()),
              i != null &&
                ...
                i.adoptionLease != null &&
                  i.adoptedWebContentsId != null &&
                  O.info(`IAB_ADOPTION renderer updated adopted webview`, {
                    safe: {
          ...
          this.browserUseActiveTabKeys.has(a) && d.setBrowserUseActive(!0);
          let f = this.browserUseViewportSizes.get(a) ?? null;
          f != null && d.setBrowserUseViewportSize(f);
          let p = this.browserUseCaptureSurfaceSizes.get(a) ?? null;
          return (
            p != null && d.setBrowserUseCaptureSurfaceSize(p),
            d.setTabCaptureActive(this.tabCaptureActiveKeys.has(a)),
            this.webviews.set(a, d),
            this.notifyWebviewHostCreated(e, n, u, s),
            O.info(`IAB_LIFECYCLE renderer created browser sidebar webview`, {
              safe: { browserTabId: n, conversationId: e, hostKind: u },
              sensitive: { initialUrl: r },
            }),
            i?.adoptionLease != null &&
              i.adoptedWebContentsId != null &&
              O.info(`IAB_ADOPTION renderer created adopted webview`, {
                safe: {
                  adoptedWebContentsId: i.adoptedWebContentsId,
                  browserTabId: n,
                  conversationId: e,
        ...
        getRetainedWebview(e, t, n, r) {
          ...
          return (
            u.setTabCaptureActive(this.tabCaptureActiveKeys.has(i)),
            this.webviews.set(i, u),
            this.notifyWebviewHostCreated(e, t, l, o),
            O.info(`IAB_LIFECYCLE renderer created retained browser sidebar webview`, {
        ...
        notifyWebviewHostCreated(e, t, n, r) {
          l.dispatchMessage(`browser-sidebar-webview-host-created`, {
            browserTabId: t,
            conversationId: e,
            hostKind: n,
            pagePersistence: r,
        ...
        getCursorOverlayHost(e, t = Fc(e, void 0)) {
          return this.webviews.get(K(e, t))?.getCursorOverlayHost() ?? null;
        }
        setBrowserUseActive(e, ...t) {
          let n = typeof t[0] == `boolean` ? Fc(e, void 0) : t[0],
          ...
          (this.webviews.get(i)?.setBrowserUseActive?.(r),
            O.info(`IAB_LIFECYCLE renderer synced browser use webview state`, {
        ...
        setBrowserUseViewportSize(e, ...t) {
          let n = t.length === 1 ? Fc(e, void 0) : t[0],
            ...
            this.setDeviceToolbarTabState(e, n, (e) =>
              a == null
                ...
                : {
                    ...
                    toolbarState: { ...e.toolbarState, ...a, isEnabled: !0, presetId: To },
                  },
            ));
        }
        ...
        reassociateTabState(e, ...t) {
          let n = t.length === 1 ? Fc(e, void 0) : t[0],
            r = t.length === 1 ? t[0] : t[1],
            i = t.length === 1 ? Fc(r, void 0) : t[2],
            a = t.length === 4 ? t[3] : void 0,
            o = N(K(e, n), K(r, i)),
            s = K(e, n),
            c = K(r, i);
          if (s === c || this.transferredWebviewKeys.has(o)) return;
          let u = this.webviews.get(s) ?? null,
            d = this.webviews.get(c) ?? null,
            f = this.tabPersistenceStates.get(s) ?? null,
            p = this.tabPersistenceStates.get(c) ?? null,
            m = this.snapshots.get(s) ?? null;
          if (
            d != null ||
            ...
            (this.transferredWebviewKeys.add(o),
              u != null && this.disposeWebviewHost(e, n, s, `closed`),
              this.removeTab(e, n),
                ...
                ...(f == null || f.mode === `ephemeral`
                  ...
                  : {
                      pagePersistence: {
                        ...
                        restore: f.mode === `restore-expected` ? `required` : `none`,
                      },
                    }),
                browserTabId: n,
                conversationId: e,
          ...
          (u instanceof ys && this.electronPageHandoff.transferRoute(u),
            ...
            u != null &&
              ...
              this.webviews.set(c, u)));
          let h = this.browserUseViewportSizes.get(s) ?? null,
            g = this.browserUseTabKeys.has(s),
            _ = this.tabCaptureActiveKeys.delete(s),
            v = this.mountStates.get(s) ?? null,
            y = this.browserUseActiveTabKeys.delete(s);
          (this.browserUseCaptureSurfaceSizes.delete(s),
            ...
            f != null && this.tabPersistenceStates.set(c, f),
          ...
          let b = !1;
          (g && (this.browserUseTabKeys.add(c), this.syncBrowserUseTabKeys(e), (b = !0)),
            y && this.browserUseActiveTabKeys.add(c),
            h != null && this.browserUseViewportSizes.set(c, h),
            _ && u != null && this.tabCaptureActiveKeys.add(c),
            v != null &&
              this.mountStates.set(c, { claimKeys: new Set(), generation: v.generation }),
            u?.setBrowserUseCaptureSurfaceSize(null),
            O.info(`IAB_LIFECYCLE renderer reassociated browser sidebar tab`, {
              safe: {
                sourceBrowserTabId: n,
                sourceConversationId: e,
                targetBrowserTabId: i,
          ...
          let x = this.deviceToolbarTabStates.get(s);
          (m != null && (this.snapshots.delete(s), this.snapshots.set(c, m)),
            b && this.syncBrowserUseTabKeys(r),
            x != null &&
              (this.deviceToolbarTabStates.delete(s), this.deviceToolbarTabStates.set(c, x)),
            a?.removeSourceBrowserStateWhenEmpty && this.removeConversationBrowserStateIfEmpty(e),
            this.emitChange());
        }
        consumePendingElectronTransfer(e, t = Fc(e, void 0)) {
          let n = K(e, t),
            r = this.pendingElectronTransfers.get(n) ?? null;
          return r == null ? null : (this.pendingElectronTransfers.delete(n), r);
        }
        peekPendingElectronTransfer(e, t = Fc(e, void 0)) {
          return this.pendingElectronTransfers.get(K(e, t)) ?? null;
        }
        disposeAll() {
        ...
        disposeWebviewHost(e, t, n, r) {
          ...
          (this.webviews.delete(n),
            i != null &&
              ...
              i.dispose(),
              O.info(`IAB_LIFECYCLE renderer removed browser sidebar webview`, {
        ...
        getFirstConversationBrowserTabId(e, t) {
          let n = `${e}\0`;
          for (let e of t) if (e.startsWith(n)) return ie(e.slice(n.length));
          return null;
        }
        getConversationBrowserTabIdsFromKeys(e, t) {
          let n = `${e}\0`,
            r = [];
          for (let e of t) e.startsWith(n) && r.push(ie(e.slice(n.length)));
          return r;
        }
...
function qc(e) {
  ...
  return ((t.version = t.version || `10.29.0`), (t[Wc] = t[`10.29.0`] || {}));
}
function Jc(e, t, n = J) {
...
function il() {
  return q ? Jc(`loggerSettings`, () => ({ enabled: !1 })) : { enabled: !1 };
}
var al,
  ol,
  sl,
  ...
  cl = e(() => {
    (Yc(),
      Hc(),
      Uc(),
      (al = [`debug`, `info`, `warn`, `error`, `log`, `assert`, `trace`]),
      (ol = `Sentry Logger `),
      (sl = {}),
      (Y = { enable: Zc, disable: Qc, isEnabled: $c, log: el, warn: tl, error: nl }));
  });
function ll(...e) {
...
`);
    for (let e = n; e < a.length; e++) {
      ...
      let o = _l.test(n) ? n.replace(_l, `$1`) : n;
      if (!o.match(/\S*Error: /)) {
        for (let e of t) {
          let t = e(o);
          if (t) {
...
function ul(e) {
  return Array.isArray(e) ? ll(...e) : e;
}
function dl(e) {
  if (!e.length) return [];
  let t = Array.from(e);
  return (
    /sentryWrapped/.test(fl(t).function || ``) && t.pop(),
    t.reverse(),
    vl.test(fl(t).function || ``) && (t.pop(), vl.test(fl(t).function || ``) && t.pop()),
    t
      .slice(0, gl)
      .map((e) => ({ ...e, filename: e.filename || fl(t).filename, function: e.function || `?` }))
  );
}
function fl(e) {
  return e[e.length - 1] || {};
...
function pl(e) {
  try {
    return !e || typeof e != `function` ? yl : e.name || yl;
  } catch {
    return yl;
  }
}
...
var gl,
  ...
  bl = e(() => {
    ((gl = 50),
      (_l = /\(error: (.*)\)/),
      (vl = /captureMessage|captureException/),
      (yl = `<anonymous>`));
  });
function xl(e, t) {
  ((wl[e] = wl[e] || []), wl[e].push(t));
}
function Sl(e, t) {
  if (!Tl[e]) {
    Tl[e] = !0;
    try {
      ...
      q && Y.error(`Error while instrumenting ${e}`, t);
    }
  }
}
function Cl(e, t) {
...
function Ol() {
  ((kl = J.onerror),
    (J.onerror = function (e, t, n, r, i) {
      return (
        Cl(`error`, { column: r, error: i, line: n, msg: e, url: t }),
        kl ? kl.apply(this, arguments) : !1
      );
    }),
...
function Ml() {
  ((Nl = J.onunhandledrejection),
    (J.onunhandledrejection = function (e) {
      return (Cl(`unhandledrejection`, e), Nl ? Nl.apply(this, arguments) : !0);
    }),
...
function Il(e, t) {
  return Ql.call(e) === `[object ${t}]`;
}
function Ll(e) {
  return Il(e, `ErrorEvent`);
}
function Rl(e) {
  return Il(e, `DOMError`);
}
function zl(e) {
  return Il(e, `DOMException`);
}
function Bl(e) {
  return Il(e, `String`);
}
...
function Hl(e) {
  return e === null || Vl(e) || (typeof e != `object` && typeof e != `function`);
}
function Ul(e) {
  return Il(e, `Object`);
}
function Wl(e) {
  return typeof Event < `u` && Yl(e, Event);
}
function Gl(e) {
  return typeof Element < `u` && Yl(e, Element);
}
function Kl(e) {
  return Il(e, `RegExp`);
}
...
function Jl(e) {
  return Ul(e) && `nativeEvent` in e && `preventDefault` in e && `stopPropagation` in e;
}
function Yl(e, t) {
  try {
    return e instanceof t;
...
function Zl(e) {
  return typeof Request < `u` && Yl(e, Request);
}
var Ql,
  $l = e(() => {
...
function eu(e, t = {}) {
  ...
  try {
    let n = e,
      ...
      c = (!Array.isArray(t) && t.maxStringLength) || au;
    for (
      ;
      n &&
      i++ < 5 &&
      ((o = tu(n, s)), !(o === `html` || (i > 1 && a + r.length * 3 + o.length >= c)));
    )
...
function tu(e, t) {
  let n = e,
    r = [];
  if (!n?.tagName) return ``;
  if (iu.HTMLElement && n instanceof HTMLElement && n.dataset) {
...
function nu() {
  try {
    return iu.document.location.href;
  } catch {
    return ``;
  }
}
function ru(e) {
  if (!iu.HTMLElement) return null;
  let t = e;
  for (let e = 0; e < 5; e++) {
    if (!t) return null;
...
function su(e, t, n) {
  ...
  let i = n(r);
  typeof i == `function` && lu(i, r);
  try {
    e[t] = i;
  } catch {
    q && Y.log(`Failed to replace method "${t}" in object`, e);
  }
}
function cu(e, t, n) {
  try {
    ...
    q && Y.log(`Failed to add non-enumerable property "${t}" to object`, e);
  }
}
function lu(e, t) {
  try {
    ((e.prototype = t.prototype = t.prototype || {}), cu(e, `__sentry_original__`, t));
  } catch {}
}
function uu(e) {
...
function du(e) {
  if (Fl(e)) return { message: e.message, name: e.name, stack: e.stack, ...pu(e) };
  if (Wl(e)) {
    let t = { type: e.type, target: fu(e.target), currentTarget: fu(e.currentTarget), ...pu(e) };
    return (typeof CustomEvent < `u` && Yl(e, CustomEvent) && (t.detail = e.detail), t);
  } else return e;
}
function fu(e) {
  try {
    return Gl(e) ? eu(e) : Object.prototype.toString.call(e);
  } catch {
    return `<unknown>`;
  }
}
...
function _u(e, t) {
  ...
  for (let t = 0; t < e.length; t++) {
    let r = e[t];
    try {
      Xl(r) ? n.push(hl(r)) : n.push(String(r));
    } catch {
...
function vu(e, t, n = !1) {
  return Bl(e) ? (Kl(t) ? t.test(e) : Bl(t) ? (n ? e === t : e.includes(t)) : !1) : !1;
}
function yu(e, t = [], n = !1) {
  return t.some((t) => vu(e, t, n));
}
var bu = e(() => {
  ($l(), bl());
});
...
function Cu(e = xu()) {
  ...
  return (
    (Au ||= `10000000100040008000100000000000`),
    Au.replace(/[018]/g, (e) => (e ^ ((Su() & 15) >> (e / 4))).toString(16))
  );
}
function wu(e) {
...
function Nu() {
  let { performance: e } = J;
  if (!e?.now || !e.timeOrigin) return Mu;
  let t = e.timeOrigin;
  return () => (t + e.now()) / Lu;
}
function Pu() {
...
function Hu(e, t = {}) {
  if (
    ...
    (e.timestamp = t.timestamp || Pu()),
    t.abnormal_mechanism && (e.abnormal_mechanism = t.abnormal_mechanism),
    t.ignoreDuration && (e.ignoreDuration = t.ignoreDuration),
    t.sid && (e.sid = t.sid.length === 32 ? t.sid : Cu()),
...
function Uu(e, t) {
  let n = {};
  (t ? (n = { status: t }) : e.status === `ok` && (n = { status: `exited` }), Hu(e, n));
}
function Wu(e) {
  return {
    sid: `${e.sid}`,
...
function Ku(e, t, n = 2) {
  ...
  let r = { ...e };
  for (let e in t) Object.prototype.hasOwnProperty.call(t, e) && (r[e] = Ku(r[e], t[e], n - 1));
  return r;
}
var qu = e(() => {});
function Ju() {
...
function Yu() {
  return Cu().substring(16);
}
var Xu = e(() => {
  ju();
});
function Zu(e, t) {
  t ? cu(e, $u, t) : delete e[$u];
}
function Qu(e) {
  return e[$u];
}
      ...
      (nd = class e {
        constructor() {
          ((this._notifyingListeners = !1),
            ...
            (this._propagationContext = { traceId: Ju(), sampleRand: Math.random() }));
        }
        clone() {
          let t = new e();
          return (
        ...
        setUser(e) {
          return (
            ...
            this._session && Hu(this._session, { user: e }),
        ...
        setAttributes(e) {
          return (
            (this._attributes = { ...this._attributes, ...e }), this._notifyScopeListeners(), this
          );
        }
        setAttribute(e, t) {
        ...
        update(t) {
          ...
          let n = typeof t == `function` ? t(this) : t,
            ...
            } = (n instanceof e ? n.getScopeData() : Ul(n) ? t : void 0) || {};
          return (
        ...
        clear() {
          return (
            ...
            Zu(this, void 0),
            (this._attachments = []),
            this.setPropagationContext({ traceId: Ju(), sampleRand: Math.random() }),
            this._notifyScopeListeners(),
            this
          );
        }
        addBreadcrumb(e, t) {
          let n = typeof t == `number` ? t : td;
          if (n <= 0) return this;
          let r = { timestamp: Mu(), ...e, message: e.message ? gu(e.message, 2048) : e.message };
          return (
        ...
        setSDKProcessingMetadata(e) {
          return ((this._sdkProcessingMetadata = Ku(this._sdkProcessingMetadata, e, 2)), this);
        }
        ...
        captureException(e, t) {
          let n = t?.event_id || Cu();
          if (!this._client)
            return (q && Y.warn(`No client configured on scope - will not capture exception!`), n);
        ...
        captureMessage(e, t, n) {
          let r = n?.event_id || Cu();
          if (!this._client)
            return (q && Y.warn(`No client configured on scope - will not capture message!`), r);
        ...
        captureEvent(e, t) {
          ...
          return this._client
            ...
            : (q && Y.warn(`No client configured on scope - will not capture event!`), n);
        }
...
function id() {
  return Jc(`defaultCurrentScope`, () => new nd());
}
function ad() {
  return Jc(`defaultIsolationScope`, () => new nd());
}
var od = e(() => {
  (Yc(), rd());
});
function sd() {
  let e = qc(Kc());
  return (e.stack = e.stack || new fd(id(), ad()));
}
function cd(e) {
  return sd().withScope(e);
}
function ld(e, t) {
  let n = sd();
...
function ud(e) {
  return sd().withScope(() => e(sd().getIsolationScope()));
}
function dd() {
  return {
    ...
    withScope: cd,
    withSetScope: ld,
    withSetIsolationScope: (e, t) => ud(t),
    getCurrentScope: () => sd().getScope(),
    getIsolationScope: () => sd().getIsolationScope(),
  };
}
var fd,
  pd = e(() => {
    (od(),
      ...
      (fd = class {
        constructor(e, t) {
          ...
          n = e || new nd();
          let r;
          ((r = t || new nd()), (this._stack = [{ scope: n }]), (this._isolationScope = r));
        }
        withScope(e) {
...
function gd() {
  return md(Kc()).getCurrentScope();
}
function _d() {
  return md(Kc()).getIsolationScope();
}
function vd() {
  return Jc(`globalScope`, () => new nd());
}
function yd(...e) {
  let t = md(Kc());
  if (e.length === 2) {
...
var Sd = e(() => {
  ...
  Fd = e(() => {
    ((Cd = `sentry.source`),
      (wd = `sentry.sample_rate`),
      (Td = `sentry.previous_trace_sample_rate`),
      (Ed = `sentry.op`),
      (Dd = `sentry.origin`),
      (Od = `sentry.idle_span_finish_reason`),
      (kd = `sentry.measurement_unit`),
      (Ad = `sentry.measurement_value`),
      (jd = `sentry.custom_span_name`),
      (Md = `sentry.profile_id`),
      (Nd = `sentry.exclusive_time`),
      (Pd = `sentry.link.type`));
  });
function Id(e) {
...
function Vd(e, t, n) {
  e && (cu(e, Wd, zd(n)), cu(e, Ud, t));
}
function Hd(e) {
  let t = e;
  return { scope: t[Ud], isolationScope: Bd(t[Wd]) };
}
var Ud,
  Wd,
  Gd = e(() => {
    (hu(), Uc(), (Ud = `_sentryScope`), (Wd = `_sentryIsolationScope`));
  });
function Kd(e) {
  let t = Jd(e);
  if (!t) return;
...
function qd(e) {
  if (e) return Xd(Object.entries(e).reduce((e, [t, n]) => (n && (e[`${Zd}${t}`] = n), e), {}));
}
function Jd(e) {
  if (!(!e || (!Bl(e) && !Array.isArray(e))))
...
function nf(e) {
  ...
  return rf({ host: a, pass: i, path: c, projectId: l, port: o, protocol: n, publicKey: r });
}
function rf(e) {
  return {
    protocol: e.protocol,
...
function af(e) {
  ...
  return [`protocol`, `publicKey`, `host`, `projectId`].find((t) =>
    e[t] ? !1 : (Y.error(`Invalid Sentry Dsn: ${t} missing`), !0),
  )
    ? !1
    : n.match(/^\d+$/)
      ? ef(r)
...
function sf(e) {
  let t = e.getOptions(),
    { host: n } = e.getDsn() || {},
    r;
  return (t.orgId ? (r = String(t.orgId)) : n && (r = of(n)), r);
}
function cf(e) {
  let t = typeof e == `string` ? nf(e) : rf(e);
  if (!(!t || !af(t))) return t;
}
var lf,
  uf,
...
function hf(e, t) {
  let n = mf(e),
    r = Kd(t);
  if (!n?.traceId) return { traceId: Ju(), sampleRand: Math.random() };
  let i = vf(n, r);
...
function gf(e = Ju(), t = Yu(), n) {
  let r = ``;
  return (n !== void 0 && (r = n ? `-1` : `-0`), `${e}-${t}${r}`);
}
function _f(e = Ju(), t = Yu(), n) {
  return `00-${e}-${t}-${n ? `01` : `00`}`;
}
function vf(e, t) {
  let n = ff(t?.sample_rand);
  if (n !== void 0) return n;
  let r = ff(t?.sample_rate);
...
var yf,
  bf = e(() => {
    ($d(), pf(), Xu(), (yf = RegExp(`^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$`)));
  });
function xf(e) {
  let { spanId: t, traceId: n } = e.spanContext(),
    { data: r, op: i, parent_span_id: a, status: o, origin: s, links: c } = Of(e);
  return {
    parent_span_id: a,
    span_id: t,
    trace_id: n,
...
function Sf(e) {
  let { spanId: t, traceId: n, isRemote: r } = e.spanContext(),
    i = r ? t : Of(e).parent_span_id,
    a = Hd(e).scope;
  return {
    parent_span_id: i,
    span_id: r ? a?.getPropagationContext().propagationSpanId || Yu() : t,
    trace_id: n,
  };
}
function Cf(e) {
      ...
      parent_span_id:
        `parentSpanId` in e
          ...
          : `parentSpanContext` in e
            ...
            : void 0,
      start_timestamp: Ef(i),
      timestamp: Ef(o) || void 0,
      status: Mf(s),
      op: r[Ed],
      origin: r[Dd],
      links: Tf(c),
...
function Nf(e, t) {
  (cu(t, Vf, e[Vf] || e), e[Bf] ? e[Bf].add(t) : cu(e, Bf, new Set([t])));
}
function Pf(e, t) {
  e[Bf] && e[Bf].delete(t);
}
...
function Lf() {
  let e = md(Kc());
  return e.getActiveSpan ? e.getActiveSpan() : Qu(gd());
}
function Rf() {
  zf ||=
    (Xc(() => {
...
function Uf() {
  ...
  function e() {
    ...
    if (t) {
      ...
      (q && Y.log(`[Tracing] Root span: ${e} -> Global error occurred`),
        t.setStatus({ code: 2, message: e }));
    }
  }
  ((e.tag = `sentry_tracingErrorCallback`), (Wf = !0), Dl(e), jl(e));
}
var Wf,
  Gf = e(() => {
    (Hc(), Al(), Pl(), cl(), Hf(), Rd(), (Wf = !1));
  });
function Kf(e) {
  if (typeof __SENTRY_TRACING__ == `boolean` && !__SENTRY_TRACING__) return !1;
  let t = e || bd()?.getOptions();
...
function Yf(e, t) {
  ...
  for (let n of t) {
    if (Zf(n)) {
      if (vu(e.description, n)) return (q && Jf(e), !0);
      continue;
    }
    if (!n.name && !n.op) continue;
    let t = n.name ? vu(e.description, n.name) : !0,
      r = n.op ? e.op && vu(e.op, n.op) : !0;
    if (t && r) return (q && Jf(e), !0);
  }
  return !1;
}
function Xf(e, t) {
...
function ip(e) {
  ...
  let l = a?.get(`sentry.dsc`),
    u = l && Kd(l);
  if (u) return s(u);
  let d = np(e.spanContext().traceId, t),
    f = i[Cd],
    p = r.description;
  return (
    f !== `url` && p && (d.transaction = p),
    Kf() &&
      ((d.sampled = String(jf(n))),
      (d.sample_rand =
        a?.get(`sentry.sample_rand`) ??
        Hd(n).scope?.getPropagationContext().sampleRand.toString())),
    s(d),
...
var ap,
  op = e(() => {
    (ep(), Sd(), Fd(), $d(), df(), qf(), hu(), Hf(), Gd(), (ap = `_frozenDsc`));
  }),
  sp,
  cp = e(() => {
    (Xu(),
      ...
      (sp = class {
        constructor(e = {}) {
          ((this._traceId = e.traceId || Ju()), (this._spanId = e.spanId || Yu()));
        }
        spanContext() {
...
function up(e, t = 3, n = 100 * 1024) {
  let r = lp(e, t);
  return hp(r) > n ? up(e, t - 1, n) : r;
}
function dp(e, t, n = 1 / 0, r = 1 / 0, i = gp()) {
  let [a, o] = i;
  if (
    t == null ||
...
function fp(e, t) {
  try {
    ...
    if (Xl(t)) return hl(t);
    if (Jl(t)) return `[SyntheticEvent]`;
    if (typeof t == `number` && !Number.isFinite(t)) return `[${t}]`;
    if (typeof t == `function`) return `[Function: ${pl(t)}]`;
...
function Sp(e) {
  ...
  function i(e) {
    typeof r == `string`
      ? (r = typeof e == `string` ? r + e : [xp(r), e])
      : r.push(typeof e == `string` ? xp(e) : e);
  }
  for (let e of n) {
    let [t, n] = e;
    if ((i(`\n${JSON.stringify(t)}\n`), typeof n == `string` || n instanceof Uint8Array)) i(n);
      ...
      try {
        ...
        e = JSON.stringify(lp(n));
      }
      i(e);
    }
  }
  return typeof r == `string` ? r : Cp(r);
}
function Cp(e) {
...
function Tp(e) {
  let t = typeof e.data == `string` ? xp(e.data) : e.data;
  return [
    {
      type: `attachment`,
      length: t.length,
...
function Mp(e, t, n, r) {
  let i = Dp(n);
  return vp(
    { sent_at: new Date().toISOString(), ...(i && { sdk: i }), ...(!!r && t && { dsn: tf(t) }) },
...
function Np(e, t, n, r) {
  ...
  jp(e, n?.sdk);
  let o = Op(e, i, r, t);
  return (delete e.sdkProcessingMetadata, vp(o, [[{ type: a }, e]]));
}
function Pp(e, t) {
  function n(e) {
  ...
  let r = ip(e[0]),
    ...
    l = c?.length ? e.filter((e) => !Yf(Of(e), c)) : e,
    u = e.length - l.length;
...
function Ip(e) {
  if (!q) return;
  let { description: t = `< unknown name >`, op: n = `< unknown op >`, parent_span_id: r } = Of(e),
...
function Lp(e) {
  if (!q) return;
  let { description: t = `< unknown name >`, op: n = `< unknown op >` } = Of(e),
    { spanId: r } = e.spanContext(),
    i = `[Tracing] Finishing "${n}" ${If(e) === e ? `root ` : ``}span "${t}" with ID ${r}`;
  Y.log(i);
}
var Rp = e(() => {
  (Hc(), cl(), Hf());
});
function zp(e, t, n, r = Lf()) {
  let i = r && If(r);
  i &&
    (q && Y.log(`[Measurement] Setting measurement on root span: ${e} = ${t} ${n}`),
    i.addEvent(e, { [Ad]: t, [kd]: n }));
}
function Bp(e) {
...
function Wp(e) {
  return e instanceof qp && e.isStandaloneSpan();
}
function Gp(e) {
  let t = bd();
  if (!t) return;
...
var Kp,
  ...
  Jp = e(() => {
    (Sd(),
      ...
      (qp = class {
        constructor(e = {}) {
          ((this._traceId = e.traceId || Ju()),
            (this._spanId = e.spanId || Yu()),
            (this._startTime = e.startTimestamp || Pu()),
            (this._links = e.links),
            (this._attributes = {}),
            this.setAttributes({ [Dd]: `manual`, [Ed]: e.op, ...e.attributes }),
            (this._name = e.name),
        ...
        updateStartTime(e) {
          this._startTime = Ef(e);
        }
        setStatus(e) {
          return ((this._status = e), this);
        }
        updateName(e) {
          return ((this._name = e), this.setAttribute(Cd, `custom`), this);
        }
        end(e) {
          this._endTime || ((this._endTime = Ef(e)), Lp(this), this._onSpanEnded());
        }
        getSpanJSON() {
          return {
            data: this._attributes,
            description: this._name,
            op: this._attributes[Ed],
            parent_span_id: this._parentSpanId,
            span_id: this._spanId,
            start_timestamp: this._startTime,
            status: Mf(this._status),
            timestamp: this._endTime,
            trace_id: this._traceId,
            origin: this._attributes[Dd],
            profile_id: this._attributes[Md],
            exclusive_time: this._attributes[Nd],
            measurements: Bp(this._events),
            is_segment: (this._isStandaloneSpan && If(this) === this) || void 0,
            segment_id: this._isStandaloneSpan ? If(this).spanContext().spanId : void 0,
            links: Tf(this._links),
          };
        }
        isRecording() {
        ...
        addEvent(e, t, n) {
          q && Y.log(`[Tracing] Adding an event to span:`, e);
          let r = Hp(t) ? t : n || Pu(),
            i = Hp(t) ? {} : t || {},
            a = { name: e, time: Ef(r), attributes: i };
        ...
        _onSpanEnded() {
          let e = bd();
          if ((e && e.emit(`spanEnd`, this), !(this._isStandaloneSpan || this === If(this))))
            return;
          ...
          t && (Hd(this).scope || gd()).captureEvent(t);
        }
        _convertSpanToTransaction() {
          if (!Up(Of(this))) return;
          this._name ||=
            (q && Y.warn("Transaction has no name, falling back to `<unlabeled transaction>`."),
            `<unlabeled transaction>`);
          let { scope: e, isolationScope: t } = Hd(this),
            n = e?.getScopeData().sdkProcessingMetadata?.normalizedRequest;
          if (this._sampled !== !0) return;
          let r = Ff(this)
              .filter((e) => e !== this && !Wp(e))
              .map((e) => Of(e))
              .filter(Up),
            i = this._attributes[Cd];
          (delete this._attributes[jd],
            r.forEach((e) => {
              delete e.data[jd];
            }));
          let a = {
              ...
              spans:
                r.length > Kp
                  ? r.sort((e, t) => e.start_timestamp - t.start_timestamp).slice(0, Kp)
                  : r,
              start_timestamp: this._startTime,
              timestamp: this._endTime,
              ...
              sdkProcessingMetadata: {
                ...
                dynamicSamplingContext: ip(this),
              },
              request: n,
    ...
    lm(a)(() => {
      let n = gd(),
        ...
        s =
          e.onlyIfParent && !o
            ? new sp()
            : rm({ parentSpan: o, spanArguments: r, forceTransaction: i, scope: n });
      return (
        Zu(n, s),
        Yp(
          () => t(s),
...
function tm(e) {
  ...
  return (e.scope ? (t) => yd(e.scope, t) : i === void 0 ? (e) => e() : (e) => nm(i, e))(() => {
    let t = gd(),
      a = cm(t, i);
    return e.onlyIfParent && !a
      ? new sp()
      : rm({ parentSpan: a, spanArguments: n, forceTransaction: r, scope: t });
  });
}
function nm(e, t) {
  let n = am();
  return n.withActiveSpan ? n.withActiveSpan(e, t) : yd((n) => (Zu(n, e || void 0), t(n)));
}
function rm({ parentSpan: e, spanArguments: t, forceTransaction: n, scope: r }) {
  if (!Kf()) {
    let r = new sp();
    return (
      (n || !e) && tp(r, { sampled: `false`, sample_rate: `0`, transaction: t.name, ...ip(r) }), r
    );
  }
  let i = _d(),
    a;
  if (e && !n) ((a = sm(e, r, t)), Nf(e, a));
  else if (e) {
    let n = ip(e),
      { traceId: i, spanId: o } = e.spanContext(),
      s = jf(e);
    ((a = om({ traceId: i, parentSpanId: o, ...t }, r, s)), tp(a, n));
  } else {
    let {
      traceId: e,
      dsc: n,
    ...
    ((a = om({ traceId: e, parentSpanId: o, ...t }, r, s)), n && tp(a, n));
  }
  return (Ip(a), Vd(a, r, i), a);
}
function im(e) {
  let t = { isStandalone: (e.experimental || {}).standalone, ...e };
  if (e.startTime) {
    let n = { ...t };
    return ((n.startTimestamp = Ef(e.startTime)), delete n.startTime, n);
  }
  return t;
}
function am() {
...
function om(e, t, n) {
  ...
  let s = o.parentSampled ?? n,
    ...
    [u, d, f] = t.getScopeData().sdkProcessingMetadata[um]
      ? [!1]
      : Qp(
          i,
          { name: a, parentSampled: s, attributes: c, parentSampleRate: ff(l.dsc?.sample_rate) },
          l.sampleRand,
        ),
    p = new qp({
      ...e,
      attributes: { [Cd]: `custom`, [wd]: d !== void 0 && f ? d : void 0, ...c },
      sampled: u,
    });
  return (
    !u &&
      r &&
      (q && Y.log(`[Tracing] Discarding root span because its trace was not chosen to be sampled.`),
...
function sm(e, t, n) {
  let { spanId: r, traceId: i } = e.spanContext(),
    a = t.getScopeData().sdkProcessingMetadata[um] ? !1 : jf(e),
    o = a ? new qp({ ...n, parentSpanId: r, traceId: i, sampled: a }) : new sp({ traceId: i });
  Nf(e, o);
  let s = bd();
...
function cm(e, t) {
  ...
  if (!n) return;
  let r = bd();
  return (r ? r.getOptions() : {}).parentSpanIsAlwaysRootSpan ? If(n) : n;
}
function lm(e) {
  return e === void 0 ? (e) => e() : (t) => nm(e, t);
}
var um,
  dm = e(() => {
    (hd(),
      ...
      Rd(),
      Gd(),
      (um = `__SENTRY_SUPPRESS_TRACING__`));
  });
function fm(e, t = {}) {
  let n = new Map(),
    r = !1,
    ...
    s = [],
    {
      idleTimeout: c = mm.idleTimeout,
      finalTimeout: l = mm.finalTimeout,
      childSpanTimeout: u = mm.childSpanTimeout,
      beforeSpanEnd: d,
  ...
  if (!p || !Kf()) {
    let e = new sp();
    return (tp(e, { sample_rate: `0`, sampled: `false`, ...ip(e) }), e);
  }
  let m = gd(),
    h = Lf(),
    g = pm(e);
  g.end = new Proxy(g.end, {
    apply(e, t, n) {
      if ((d && d(g), t instanceof sp)) return;
      let [r, ...i] = n,
        a = Ef(r || Pu()),
        o = Ff(g).filter((e) => e !== g),
        s = Of(g);
      if (!o.length || !f) return (S(a), Reflect.apply(e, t, [a, ...i]));
      let c = p.getOptions().ignoreSpans,
        u = o?.reduce(
          (e, t) => {
            let n = Of(t);
            return !n.timestamp || (c && Yf(n, c)) ? e : e ? Math.max(e, n.timestamp) : n.timestamp;
          },
          void 0,
        ),
        m = s.start_timestamp,
  ...
  function b(e) {
    (_(), n.set(e, !0), y(Pu() + u / 1e3));
  }
  function x(e) {
    (n.has(e) && n.delete(e), n.size === 0 && v(Pu() + c / 1e3));
  }
  function S(e) {
    ((r = !0), n.clear(), s.forEach((e) => e()), Zu(m, h));
    let t = Of(g),
      { start_timestamp: i } = t;
    if (!i) return;
    t.data[`sentry.idle_span_finish_reason`] || g.setAttribute(Od, a);
    let o = t.status;
    ((!o || o === `unknown`) && g.setStatus({ code: 1 }),
      Y.log(`[Tracing] Idle span "${t.op}" finished`));
    let u = Ff(g).filter((e) => e !== g),
      d = 0;
    (u.forEach((t) => {
      t.isRecording() &&
        ...
        t.end(e),
        q &&
          Y.log(`[Tracing] Cancelling span since span ended early`, JSON.stringify(t, void 0, 2)));
      let { timestamp: n = 0, start_timestamp: r = 0 } = Of(t),
        i = r <= e,
        a = (l + c) / 1e3,
        o = n - r <= a;
      if (q) {
        ...
        i
          ? o ||
            Y.log(`[Tracing] Discarding span since it finished after idle span final timeout`, e)
          : Y.log(`[Tracing] Discarding span since it happened after idle span was finished`, e);
      }
      (!o || !i) && (Pf(g, t), d++);
    }),
  ...
  return (
    s.push(
      p.on(`spanStart`, (e) => {
        r ||
          e === g ||
          Of(e).timestamp ||
          (e instanceof qp && e.isStandaloneSpan()) ||
          (Ff(g).includes(e) && b(e.spanContext().spanId));
      }),
    ),
    s.push(
      p.on(`spanEnd`, (e) => {
        r || x(e.spanContext().spanId);
      }),
    ),
    s.push(
    ...
    setTimeout(() => {
      r || (g.setStatus({ code: 2, message: `deadline_exceeded` }), (a = _m), g.end());
    }, l),
    g
  );
}
function pm(e) {
  let t = tm(e);
  return (Zu(gd(), t), q && Y.log(`[Tracing] Started span is an idle span`), t);
}
var mm,
  hm,
  gm,
  ...
  ym = e(() => {
    (Sd(),
      ...
      Rd(),
      dm(),
      (mm = { idleTimeout: 1e3, finalTimeout: 3e4, childSpanTimeout: 15e3 }),
      (hm = `heartbeatFailed`),
      (gm = `idleTimeout`),
      (_m = `finalTimeout`),
      (vm = `externalFinish`));
...
var Sm,
  ...
  Em = e(() => {
    ($l(),
      ...
      (Tm = class e {
        constructor(e) {
          ((this._state = Sm), (this._handlers = []), this._runExecutor(e));
        }
        then(t, n) {
          return new e((e, r) => {
            (this._handlers.push([
        ...
        _executeHandlers() {
          if (this._state === Sm) return;
          let e = this._handlers.slice();
          ((this._handlers = []),
            e.forEach((e) => {
              e[0] ||=
                (this._state === Cm && e[1](this._value),
                this._state === wm && e[2](this._value),
                !0);
            }));
        }
        _runExecutor(e) {
...
function Om(e, t, n, r) {
  ...
  let a = i({ ...e }, t);
  return (
    q && a === null && Y.log(`Event processor "${i.id || `?`}" dropped event`),
    ql(a) ? a.then((e) => Om(e, t, n, r + 1)) : Om(a, t, n, r + 1)
  );
}
var km = e(() => {
  (Hc(), cl(), $l(), Em());
...
function Am(e, t) {
  ...
  (Nm(e, t), r && Im(e, r), Lm(e, n), Pm(e, i), Fm(e, a));
}
function jm(e, t) {
  let {
    extra: n,
  ...
  (Mm(e, `extra`, n),
    ...
    Mm(e, `user`, i),
    Mm(e, `contexts`, a),
    (e.sdkProcessingMetadata = Ku(e.sdkProcessingMetadata, s, 2)),
    o && (e.level = o),
...
function Im(e, t) {
  ((e.contexts = { trace: Sf(t), ...e.contexts }),
    (e.sdkProcessingMetadata = { dynamicSamplingContext: ip(t), ...e.sdkProcessingMetadata }));
  let n = Of(If(t)).description;
...
function zm(e) {
  let t = J._sentryDebugIds,
    n = J._debugIds;
  if (!t && !n) return {};
  let r = t ? Object.keys(t) : [],
    i = n ? Object.keys(n) : [];
  if (Um && r.length === Vm && i.length === Hm) return Um;
  ((Vm = r.length), (Hm = i.length), (Um = {}), (Bm ||= {}));
  let a = (t, n) => {
    for (let r of t) {
      let t = n[r],
        i = Bm?.[r];
      if (i && Um && t) ((Um[i[0]] = t), Bm && (Bm[r] = [i[0], t]));
      else if (t) {
        let n = e(r);
...
function Gm(e, t, n, r, i, a) {
  let { normalizeDepth: o = 3, normalizeMaxBreadth: s = 1e3 } = e,
    c = { ...t, event_id: t.event_id || n.event_id || Cu(), timestamp: t.timestamp || Mu() },
    l = n.integrations || e.integrations.map((e) => e.name);
  (Km(c, e),
    Ym(c, l),
    i && i.emit(`applyFrameMetadata`, t),
    t.type === void 0 && qm(c, e.stackParser));
  let u = Zm(r, n.captureContext);
  n.mechanism && Du(c, n.mechanism);
  let d = i ? i.getEventProcessors() : [],
    f = vd().getScopeData();
  (a && jm(f, a.getScopeData()), u && jm(f, u.getScopeData()));
  let p = [...(n.attachments || []), ...f.attachments];
  return (
    p.length && (n.attachments = p),
    Am(c, f),
    Dm([...d, ...f.eventProcessors], c, n).then(
      (e) => (e && Jm(e), typeof o == `number` && o > 0 ? Xm(e, o, s) : e),
    )
  );
}
function Km(e, t) {
  ...
  ((e.environment = e.environment || n || `production`),
    ...
    !e.dist && i && (e.dist = i));
  let o = e.request;
  (o?.url && a && (o.url = gu(o.url, a)),
    a &&
      e.exception?.values?.forEach((e) => {
        e.value &&= gu(e.value, a);
      }));
}
function qm(e, t) {
  let n = zm(t);
...
function Xm(e, t, n) {
  ...
  let r = {
    ...e,
    ...(e.breadcrumbs && {
      breadcrumbs: e.breadcrumbs.map((e) => ({ ...e, ...(e.data && { data: lp(e.data, t, n) }) })),
    }),
    ...(e.user && { user: lp(e.user, t, n) }),
    ...(e.contexts && { contexts: lp(e.contexts, t, n) }),
    ...(e.extra && { extra: lp(e.extra, t, n) }),
  };
  return (
    e.contexts?.trace &&
      r.contexts &&
      ((r.contexts.trace = e.contexts.trace),
      e.contexts.trace.data && (r.contexts.trace.data = lp(e.contexts.trace.data, t, n))),
    e.spans &&
      (r.spans = e.spans.map((e) => ({ ...e, ...(e.data && { data: lp(e.data, t, n) }) }))),
    e.contexts?.flags && r.contexts && (r.contexts.flags = lp(e.contexts.flags, 3, n)),
    r
  );
}
function Zm(e, t) {
  if (!t) return e;
  let n = e ? e.clone() : new nd();
  return (n.update(t), n);
}
function Qm(e) {
  if (e) return $m(e) || eh(e) ? { captureContext: e } : e;
}
function $m(e) {
  return e instanceof nd || typeof e == `function`;
}
function eh(e) {
  return Object.keys(e).some((e) => th.includes(e));
}
var th,
  nh = e(() => {
    (ep(),
      ...
      bu(),
      Bu(),
      (th = [`user`, `level`, `extra`, `contexts`, `tags`, `fingerprint`, `propagationContext`]));
  });
function rh(e, t) {
  return gd().captureException(e, Qm(t));
}
function ih(e, t) {
  return gd().captureEvent(e, t);
}
function ah(e, t) {
  _d().setTag(e, t);
}
...
function ch(e) {
  let t = _d(),
    ...
    i = Vu({ user: n.getUser() || t.getUser(), ...(r && { userAgent: r }), ...e }),
    a = t.getSession();
  return (a?.status === `ok` && Hu(a, { status: `exited` }), lh(), t.setSession(i), i);
}
function lh() {
  let e = _d(),
    t = gd().getSession() || e.getSession();
  (t && Uu(t), uh(), e.setSession());
}
function uh() {
  let e = _d(),
    t = bd(),
...
function mh(e) {
  return `${ph(e)}${e.projectId}/envelope/`;
}
function hh(e, t) {
  let n = { sentry_version: _h };
  return (
...
function Ch(e, t, n) {
  if (n[t.name]) {
    q && Y.log(`Integration skipped because it was already installed: ${t.name}`);
    return;
  }
  if (
    ((n[t.name] = t),
    !Th.includes(t.name) && typeof t.setupOnce == `function` && (t.setupOnce(), Th.push(t.name)),
  ...
  q && Y.log(`Integration installed: ${t.name}`);
}
function wh(e) {
  return e;
}
...
function Ah(e, t) {
  ...
  let r = e.getOptions(),
    i = Oh(n, r._metadata, r.tunnel, e.getDsn());
  (Mh().set(e, []), e.emit(`flushLogs`), e.sendEnvelope(i));
}
function jh(e) {
  return Mh().get(e);
}
function Mh() {
  return Jc(`clientToLogBufferMap`, () => new WeakMap());
}
var Nh = e(() => {
  (Yc(), kh());
});
...
function Lh(e, t) {
  ...
  if (n.length === 0) return;
  let r = e.getOptions(),
    i = Fh(n, r._metadata, r.tunnel, e.getDsn());
  (zh().set(e, []), e.emit(`flushMetrics`), e.sendEnvelope(i));
}
function Rh(e) {
  return zh().get(e);
}
function zh() {
  return Jc(`clientToMetricBufferMap`, () => new WeakMap());
}
var Bh = e(() => {
  (Yc(), Ih());
});
...
var Hh,
  Uh = e(() => {
    (Em(), (Hh = Symbol.for(`SentryBufferFullError`)));
  });
function Wh(e, t = Date.now()) {
  let n = parseInt(`${e}`, 10);
  if (!isNaN(n)) return n * 1e3;
  let r = Date.parse(`${e}`);
  return isNaN(r) ? Jh : r - t;
}
function Gh(e, t) {
  return e[t] || e.all || 0;
}
function Kh(e, t, n = Date.now()) {
  return Gh(e, t) > n;
}
function qh(e, { statusCode: t, headers: n }, r = Date.now()) {
  let i = { ...e },
  ...
  else o ? (i.all = r + Wh(o, r)) : t === 429 && (i.all = r + 60 * 1e3);
  return i;
}
var Jh,
  Yh = e(() => {
...
function Xh(e, t, n = Vh(e.bufferSize || 64)) {
  let r = {},
    i = (e) => n.drain(e);
  function a(i) {
    let a = [];
    if (
      (bp(i, (t, n) => {
        let i = Ep(n);
        Kh(r, i) ? e.recordDroppedEvent(`ratelimit_backoff`, i) : a.push(t);
      }),
      a.length === 0)
    )
    ...
    return n
        ...
        t({ body: Sp(o) }).then(
          (e) => (
            e.statusCode !== void 0 &&
              ...
              q &&
              Y.warn(`Sentry responded with status code ${e.statusCode} to sent event.`),
            (r = qh(r, e)),
            e
          ),
          (e) => {
            throw (
              s(`network_error`), q && Y.error(`Encountered error running transport request:`, e), e
            );
          },
        ),
      )
      .then(
        ...
        (e) => {
          if (e === Hh)
            return (
              q && Y.error(`Skipped sending event because buffer is full.`),
              s(`queue_overflow`),
              Promise.resolve({})
            );
          throw e;
...
function Qh(e, t, n) {
  let r = [{ type: `client_report` }, { timestamp: n || Mu(), discarded_events: e }];
  return vp(t ? { dsn: t } : {}, [r]);
}
var $h = e(() => {
  (Ap(), Bu());
...
function ag(e) {
  return { message: e, [xg]: !0 };
}
function og(e) {
  return { message: e, [Sg]: !0 };
}
function sg(e) {
  return !!e && typeof e == `object` && xg in e;
}
function cg(e) {
  return !!e && typeof e == `object` && Sg in e;
}
...
function dg(e, t) {
  ...
  if (ql(e))
    return e.then(
      (e) => {
        if (!Ul(e) && e !== null) throw ag(n);
        return e;
      },
      (e) => {
        throw ag(`${t} rejected with ${e}`);
      },
    );
  if (!Ul(e) && e !== null) throw ag(n);
  return e;
...
function fg(e, t, n, r) {
  let { beforeSend: i, beforeSendTransaction: a, beforeSendSpan: o, ignoreSpans: s } = t,
    c = n;
  if (pg(c) && i) return i(c, r);
  if (mg(c)) {
    if (o || s) {
      let t = ng(c);
      if (s?.length && Yf(t, s)) return null;
      if (o) {
        let e = o(t);
        e ? (c = Ku(n, rg(e))) : Rf();
      }
...
function hg(e) {
  let t = 0;
  return (e.name && (t += e.name.length * 2), (t += 8), t + _g(e.attributes));
}
function gg(e) {
  let t = 0;
  return (e.message && (t += e.message.length * 2), t + _g(e.attributes));
}
function _g(e) {
  if (!e) return 0;
  let t = 0;
  return (
    Object.values(e).forEach((e) => {
      Array.isArray(e) ? (t += e.length * vg(e[0])) : Hl(e) ? (t += vg(e)) : (t += 100);
    }),
    t
  );
}
...
var yg,
  ...
  Tg = e(() => {
    (vh(),
      ...
      Em(),
      ig(),
      (yg = `Not capturing exception because it's already been captured.`),
      (bg = `Discarded session because of missing or non-string release`),
      (xg = Symbol.for(`SentryInternalError`)),
      (Sg = Symbol.for(`SentryDoNotSendEventError`)),
      (Cg = 5e3),
      (wg = class {
        constructor(e) {
          if (
            ...
            (this._hooks = {}),
            (this._eventProcessors = []),
            (this._promiseBuffer = Vh(e.transportOptions?.bufferSize ?? 64)),
            e.dsn
              ? (this._dsn = cf(e.dsn))
              : q && Y.warn(`No DSN provided, client will not send events.`),
            this._dsn)
          ) {
            let t = gh(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
          ...
          ((this._options.enableLogs =
            ...
            this._options.enableLogs && lg(this, `afterCaptureLog`, `flushLogs`, gg, Ah),
            (this._options.enableMetrics ?? this._options._experiments?.enableMetrics ?? !0) &&
              lg(this, `afterCaptureMetric`, `flushMetrics`, hg, Lh));
        }
        captureException(e, t, n) {
          let r = Cu();
          if (Ou(e)) return (q && Y.log(yg), r);
          let i = { event_id: r, ...t };
          return (
            this._process(
              () =>
        ...
        captureEvent(e, t, n) {
          let r = Cu();
          if (t?.originalException && Ou(t.originalException)) return (q && Y.log(yg), r);
          let i = { event_id: r, ...t },
        ...
        captureSession(e) {
          (this.sendSession(e), Hu(e, { init: !1 }));
        }
        getDsn() {
          return this._dsn;
        }
        ...
        addIntegration(e) {
          ...
          (Ch(this, e, this._integrations), t || Sh(this, [e]));
        }
        sendEvent(e, t = {}) {
          this.emit(`beforeSendEvent`, e, t);
          let n = Np(e, this._dsn, this._options._metadata, this._options.tunnel);
          for (let e of t.attachments || []) n = yp(n, Tp(e));
          this.sendEnvelope(n).then((t) => this.emit(`afterSendEvent`, e, t));
        }
        sendSession(e) {
          let { release: t, environment: n = $f } = this._options;
          if (`aggregates` in e) {
            let r = e.attrs || {};
            if (!r.release && !t) {
              q && Y.warn(bg);
          ...
          let r = Mp(e, this._dsn, this._options._metadata, this._options.tunnel);
          this.sendEnvelope(r);
        }
        recordDroppedEvent(e, t, n = 1) {
          if (this._options.sendClientReports) {
            let r = `${e}:${t}`;
            (q && Y.log(`Recording outcome: "${r}"${n > 1 ? ` (${n} times)` : ``}`),
        ...
        async sendEnvelope(e) {
          if ((this.emit(`beforeEnvelope`, e), this._isEnabled() && this._transport))
            try {
              ...
              return (q && Y.error(`Error while sending envelope:`, e), {});
            }
          return (q && Y.error(`Transport disabled`), {});
        }
        _setupIntegrations() {
          let { integrations: e } = this._options;
          ((this._integrations = xh(this, e)), Sh(this, e));
        }
        _updateSessionFromEvent(e, t) {
          ...
          let a = e.status === `ok`;
          ((a && e.errors === 0) || (a && n)) &&
            (Hu(e, { ...(n && { status: `crashed` }), errors: e.errors || Number(r || n) }),
        ...
        _prepareEvent(e, t, n, r) {
          ...
          return (
            ...
            Gm(i, e, t, n, this, r).then((e) =>
              e === null
                ? e
                : (this.emit(`postprocessEvent`, e, t),
                  (e.contexts = { trace: xd(n), ...e.contexts }),
                  (e.sdkProcessingMetadata = {
                    dynamicSamplingContext: rp(this, n),
                    ...e.sdkProcessingMetadata,
                  }),
                  e),
            )
        ...
        _captureEvent(e, t = {}, n = gd(), r = _d()) {
          return (
            q && pg(e) && Y.log(`Captured error event \`${eg(e)[0] || `<unknown>`}\``),
            this._processEvent(e, t, n, r).then(
              (e) => e.event_id,
              (e) => {
                q && (cg(e) ? Y.log(e.message) : sg(e) ? Y.warn(e.message) : Y.warn(e));
              },
            )
          );
        }
            ...
            .then((e) => {
              if (e === null)
                throw (
                  ...
                  og("An event processor returned `null`, will not send event.")
                );
              return t.data && t.data.__sentry__ === !0 ? e : dg(fg(this, i, e, t), c);
            })
            .then((i) => {
              if (i === null) {
                ...
                throw og(`${c} returned \`null\`, will not send event.`);
              }
        ...
        _process(e, t) {
          (this._numProcessing++,
            this._promiseBuffer.add(e).then(
              ...
              (e) => (
                this._numProcessing--,
                e === Hh && this.recordDroppedEvent(`queue_overflow`, t),
                e
              ),
            ));
        }
        ...
        _flushOutcomes() {
          q && Y.log(`Flushing outcomes...`);
          let e = this._clearOutcomes();
          if (e.length === 0) {
            q && Y.log(`No outcomes to send`);
            return;
          }
          if (!this._dsn) {
            q && Y.log(`No dsn provided, will not send outcomes`);
            return;
          }
          q && Y.log(`Sending outcomes:`, e);
          let t = Qh(e, this._options.tunnel && tf(this._dsn));
          this.sendEnvelope(t);
        }
      }));
  });
function Eg(e, t) {
  (t.debug === !0 &&
    ...
    gd().update(t.initialScope));
  let n = new e(t);
  return (Dg(n), n.init(), n);
}
function Dg(e) {
  gd().setClient(e);
}
...
var Lg = e(() => {});
function Rg(e, t, n = [t], r = `npm`) {
  let i = e._metadata || {};
  ((i.sdk ||= {
    name: `sentry.javascript.${t}`,
    packages: n.map((e) => ({ name: `${r}:@sentry/${e}`, version: Wc })),
    version: Wc,
  }),
    (e._metadata = i));
}
...
function Bg(e = {}) {
  ...
  let r = e.scope || gd(),
    ...
    a = i ? Cf(i) : Vg(r),
    o = qd(i ? ip(i) : rp(t, r));
  if (!yf.test(a)) return (Y.warn(`Invalid sentry-trace data. Cannot generate trace data`), {});
...
var Ug = e(() => {
  (hd(), Yc(), Sd(), fh(), cl(), Hf(), op(), $d(), bf());
});
function Wg(e, t) {
  let n = bd(),
    r = _d();
  if (!n) return;
  let { beforeBreadcrumb: i = null, maxBreadcrumbs: a = Gg } = n.getOptions();
  if (a <= 0) return;
  let o = { timestamp: Mu(), ...e },
    s = i ? Xc(() => i(o, t)) : o;
  ...
  Qg = e(() => {
    (Sd(),
      ...
      (Xg = () => ({
        name: Jg,
        setupOnce() {
          qg = Function.prototype.toString;
          try {
            Function.prototype.toString = function (...e) {
              let t = uu(this),
                n = Yg.has(bd()) && t !== void 0 ? t : this;
              return qg.apply(n, e);
            };
          } catch {}
        },
...
function e_(e, t) {
  ...
  } else if (e.type === `transaction` && n_(e, t.ignoreTransactions))
    return (
      q &&
        Y.warn(
...
function t_(e, t) {
  return t?.length ? eg(e).some((e) => yu(e, t)) : !1;
}
function n_(e, t) {
...
function o_(e) {
  try {
    ...
    return (q && Y.error(`Cannot extract url for event ${Tu(e)}`), null);
  }
}
function s_(e) {
    ...
    (Hc(),
      ...
      (u_ = wh((e = {}) => {
        ...
        return {
          ...
          processEvent(n, r, i) {
            return ((t ||= $g(e, i.getOptions())), e_(n, t) ? null : n);
          },
        };
      })),
      (d_ = wh((e = {}) => ({ ...u_(e), name: `InboundFilters` }))));
  });
function p_(e, t, n, r, i, a) {
  if (!i.exception?.values || !a || !Yl(a.originalException, Error)) return;
  let o =
    i.exception.values.length > 0 ? i.exception.values[i.exception.values.length - 1] : void 0;
  o && (i.exception.values = m_(e, t, r, a.originalException, n, i.exception.values, o, 0));
}
function m_(e, t, n, r, i, a, o, s) {
  ...
  if (Yl(r[i], Error)) {
    ...
    let a = e(t, r[i]),
      l = c.length;
    (g_(a, i, l, s), (c = m_(e, t, n, r[i], i, [a, ...c], a, l)));
  }
  return (
    Array.isArray(r.errors) &&
      r.errors.forEach((r, a) => {
        if (Yl(r, Error)) {
          ...
          let l = e(t, r),
            u = c.length;
          (g_(l, `errors[${a}]`, u, s), (c = m_(e, t, n, r, i, [l, ...c], l, u)));
        }
      }),
    c
  );
...
function y_() {
  `console` in J &&
    al.forEach(function (e) {
      e in J.console &&
        su(J.console, e, function (t) {
          return (
            (sl[e] = t),
            function (...t) {
              (Cl(`console`, { args: t, level: e }), sl[e]?.apply(J.console, t));
            }
          );
        });
    });
...
var S_ = e(() => {});
function C_(e, t) {
  return t ? !!(w_(e, t) || T_(e, t)) : !1;
}
function w_(e, t) {
  let n = e.message,
    r = t.message;
  return !((!n && !r) || (n && !r) || (!n && r) || n !== r || !D_(e, t) || !E_(e, t));
}
function T_(e, t) {
  let n = O_(t),
    r = O_(e);
  return !(!n || !r || n.type !== r.type || n.value !== r.value || !D_(e, t) || !E_(e, t));
}
function E_(e, t) {
  let n = ml(e),
    r = ml(t);
...
function F_(e, t, n, r) {
  let i = Bg({ span: n, propagateTraceparent: r }),
    a = i[`sentry-trace`],
    o = i.baggage,
    s = i.traceparent;
  if (!a) return;
  let c = t.headers || (Zl(e) ? e.headers : void 0);
  if (!c) return { ...i };
  if (R_(c)) {
    let e = new Headers(c);
    if (
      ...
      let t = e.get(`baggage`);
      t ? L_(t) || e.set(`baggage`, `${t},${o}`) : e.set(`baggage`, o);
    }
    return e;
    ...
    let t = c.find((e) => e[0] === `baggage` && L_(e[1]));
    ...
    let e = `sentry-trace` in c ? c[`sentry-trace`] : void 0,
      ...
      l = n && (Array.isArray(n) ? n.find((e) => L_(e)) : L_(n));
    o && !l && i.push(o);
...
function L_(e) {
  return e.split(`,`).some((e) => e.trim().startsWith(Zd));
}
function R_(e) {
  return typeof Headers < `u` && Yl(e, Headers);
}
function z_(e, t, n) {
  let r = Ag(e);
  return { name: r ? `${t} ${jg(r)}` : t, attributes: B_(e, r, t, n) };
}
function B_(e, t, n, r) {
  let i = { url: e, type: `fetch`, "http.method": n, [Dd]: r, [Ed]: `http.client` };
  return (
    t &&
      (kg(t) || ((i[`http.url`] = t.href), (i[`server.address`] = t.host)),
...
var V_ = e(() => {
  (Sd(), Fd(), Hf(), Rd(), $l(), qf(), $d(), cp(), dm(), Ug(), Fg());
});
function H_(e) {
  if (e !== void 0) {
  ...
  if (t && typeof t.createElement == `function`)
    try {
      ...
      ((n.hidden = !0),
        ...
        n.contentWindow?.fetch && (e = K_(n.contentWindow.fetch)),
    ...
    su(J, `fetch`, function (t) {
      return function (...n) {
        ...
        return (
          ...
          t.apply(J, n).then(
            async (t) => (
              e ? e(t) : Cl(`fetch`, { ...o, endTimestamp: Pu() * 1e3, response: t }),
              t
            ),
            (e) => {
              if (
                (Cl(`fetch`, { ...o, endTimestamp: Pu() * 1e3, error: e }),
                Fl(e) && e.stack === void 0 && ((e.stack = r.stack), cu(e, `framesToPop`, 1)),
...
function ev(e) {
  ...
  $_(t, () => {
    Cl(`fetch-body-resolved`, { endTimestamp: Pu() * 1e3, response: e });
  });
}
function tv(e, t) {
...
function rv(e) {
  ...
  if (e.length === 2) {
    let [t, n] = e;
    return { url: nv(t), method: tv(n, `method`) ? String(n.method).toUpperCase() : `GET` };
  }
  let t = e[0];
  return { url: nv(t), method: tv(t, `method`) ? String(t.method).toUpperCase() : `GET` };
}
function iv(e) {
  let [t, n] = e;
  try {
    if (typeof n == `object` && n && `headers` in n && n.headers) return new Headers(n.headers);
    if (Zl(t)) return new Headers(t.headers);
  } catch {}
}
var av = e(() => {
  ($l(), hu(), Y_(), Bu(), Uc(), El());
...
function dv() {
  return typeof window < `u` && (!lv() || fv());
}
function fv() {
  return J.process?.type === `renderer`;
}
var pv = e(() => {
  (uv(), Uc());
});
...
var bv,
  ...
  Sv = e(() => {
    ((function (e) {
      ...
      (xv = `sentry-electron-renderer-id`));
  });
function Cv(e) {
  let t = yv(e);
  if (window.__SENTRY_IPC__?.[t.namespace]) return window.__SENTRY_IPC__[t.namespace];
  {
    ...
    let e = (window.__SENTRY_RENDERER_ID__ = Cu()),
      n = { [xv]: e };
    return {
      sendRendererStart: () => {
...
function wv(e = bd()) {
  ...
  let n = e.getOptions().ipcNamespace,
    r = Cv(n);
  return (Tv.set(e, r), r.sendRendererStart(), r);
}
var Tv,
  Ev = e(() => {
    (X(), Sv());
...
function jv(e, t = {}) {
    ...
    try {
      ...
      throw (
        ...
        yd((r) => {
          (r.addEventProcessor(
            (e) => (
              t.mechanism && (Eu(e, void 0, void 0), Du(e, t.mechanism)),
  ...
  (lu(r, e), cu(e, `__sentry_wrapped__`, r));
  try {
...
function Iv(e, t, n, r) {
  let i = bd()?.getOptions().normalizeDepth,
    a = Xv(t),
    o = { __serialized__: up(t, i) };
  if (a) return { exception: { values: [Fv(e, a)] }, extra: o };
  let s = {
    exception: {
      values: [
        {
          type: Wl(t) ? t.constructor.name : r ? `UnhandledRejection` : `Error`,
...
function Lv(e, t) {
  return { exception: { values: [Fv(e, t)] } };
}
function Rv(e, t) {
...
function zv(e) {
  return e && Zv.test(e.message) ? 1 : 0;
}
function Bv(e) {
...
function Wv(e, t, n, r) {
  let i = Kv(e, t, n?.syntheticException || void 0, r);
  return (Du(i), (i.level = `error`), n?.event_id && (i.event_id = n.event_id), bm(i));
}
function Gv(e, t, n = `info`, r, i) {
  let a = qv(e, t, r?.syntheticException || void 0, i);
  return ((a.level = n), r?.event_id && (a.event_id = r.event_id), bm(a));
}
function Kv(e, t, n, r, i) {
  let a;
  if (Ll(t) && t.error) return Lv(e, t.error);
  if (Rl(t) || zl(t)) {
    let i = t;
    if (`stack` in t) a = Lv(e, t);
    else {
      let t = i.name || (Rl(i) ? `DOMError` : `DOMException`),
  ...
  return Fl(t)
    ? Lv(e, t)
    : Ul(t) || Wl(t)
      ? ((a = Iv(e, t, n, i)), Du(a, { synthetic: !0 }), a)
      : ((a = qv(e, t, n, r)), Eu(a, `${t}`, void 0), Du(a, { synthetic: !0 }), a);
}
function qv(e, t, n, r) {
  let i = {};
  if (r && n) {
...
function Jv(e, { isUnhandledRejection: t }) {
  ...
  return Ll(e)
    ...
    : Wl(e)
      ? `Event \`${Yv(e)}\` (type=${e.type}) captured as ${r}`
...
var ey,
  ty = e(() => {
    (X(),
      ...
      (ey = class extends wg {
        constructor(e) {
          let t = $v(e);
          (Rg(t, `browser`, [`browser`], Z.SENTRY_SDK_SOURCE || sv()),
            t._metadata?.sdk &&
          ...
          (Z.document &&
            ...
            Z.document.addEventListener(`visibilitychange`, () => {
              Z.document.visibilityState === `hidden` &&
                (r && this._flushOutcomes(), i && Ah(this), s && Lh(this));
            }),
            n && this.on(`beforeSendSession`, Ig));
        }
        eventFromException(e, t) {
          return Wv(this._options.stackParser, e, t, this._options.attachStacktrace);
        }
        eventFromMessage(e, t = `info`, n) {
          return Gv(this._options.stackParser, e, t, n, this._options.attachStacktrace);
        }
        _prepareEvent(e, t, n, r) {
  ...
  ny,
  ry = e(() => {
    ny = typeof __SENTRY_DEBUG__ > `u` || __SENTRY_DEBUG__;
  }),
  Q,
  iy = e(() => {
    (X(), (Q = J));
  ...
  oy,
  sy = e(() => {
    ((ay = (e, t) => (e > t[1] ? `poor` : e > t[0] ? `needs-improvement` : `good`)),
      (oy = (e, t, n, r) => {
        let i, a;
        return (o) => {
          t.value >= 0 &&
            ...
            ((a = t.value - (i ?? 0)),
            (a || i === void 0) &&
              ((i = t.value), (t.delta = a), (t.rating = ay(t.value, n)), e(t)));
        };
      }));
  }),
  cy,
...
var gy,
  ...
  xy = e(() => {
    (iy(),
      ...
      (_y = new Set()),
      (vy = () =>
        Q.document?.visibilityState === `hidden` && !Q.document?.prerendering ? 0 : 1 / 0),
      (yy = (e) => {
        if (hy(e) && gy > -1) {
          if (e.type === `visibilitychange` || e.type === `pagehide`) for (let e of _y) e();
          isFinite(gy) ||
            ((gy = e.type === `visibilitychange` ? e.timeStamp : 0),
            py(`prerenderingchange`, yy, !0));
        }
      }),
      (by = () => {
        if (Q.document && gy < 0) {
          ...
          ((gy =
            (Q.document.prerendering
              ...
              : globalThis.performance
                  ...
                  .filter((t) => t.name === `hidden` && t.startTime > e)[0]?.startTime) ?? vy()),
            fy(`visibilitychange`, yy, !0),
            fy(`pagehide`, yy, !0),
            fy(`prerenderingchange`, yy, !0));
        }
        return {
          get firstHiddenTime() {
            return gy;
  ...
  Sy,
  Cy = e(() => {
    Sy = () => `v5-${Date.now()}-${Math.floor(Math.random() * 8999999999999) + 0xe8d4a51000}`;
  }),
  wy,
  Ty = e(() => {
    (iy(),
      ...
      (wy = (e, t = -1) => {
        ...
        return (
          n &&
            (Q.document?.prerendering || uy() > 0
              ? (r = `prerender`)
              : Q.document?.wasDiscarded
                ? (r = `restore`)
                : n.type && (r = n.type.replace(/_/g, `-`))),
          { name: e, value: t, rating: `good`, delta: 0, entries: [], id: Sy(), navigationType: r }
        );
      }));
  });
function Ey(e, t) {
  return (Dy.get(e) || Dy.set(e, new t()), Dy.get(e));
}
var Dy,
  Oy = e(() => {
    Dy = new WeakMap();
              ...
              for (let t of e)
                t.name === `first-contentful-paint` &&
                  ...
                  t.startTime < n.firstHiddenTime &&
                    ((r.value = Math.max(t.startTime - uy(), 0)), r.entries.push(t), i(!0)));
            });
          a && (i = oy(e, r, Ly, t.reportAllChanges));
        });
      }));
  }),
  By,
        ...
        Ry(
          Ny(() => {
            let n = wy(`CLS`, 0),
              ...
              s = jy(`layout-shift`, o);
            s &&
              ((r = oy(e, n, By, t.reportAllChanges)),
              i.onHidden(() => {
                (o(s.takeRecords()), r(!0));
              }),
              Q?.setTimeout?.(r));
  ...
  Xy = e(() => {
    (My(),
      ...
      (Ky = (e) => {
        e.forEach((e) => {
          e.interactionId &&
            ((Wy = Math.min(Wy, e.interactionId)),
            (Gy = Math.max(Gy, e.interactionId)),
            (Uy = Gy ? (Gy - Wy) / 7 + 1 : 0));
        });
      }),
      (Jy = () => (qy ? Uy : performance.interactionCount || 0)),
      (Yy = () => {
        `interactionCount` in performance ||
          qy ||
          (qy = jy(`event`, Ky, { type: `event`, buffered: !0, durationThreshold: 0 }));
      }));
  }),
  Zy,
  Qy,
    ...
    (Xy(),
      ...
      (eb = class e {
        ...
        _estimateP98LongestInteraction() {
          let e = Math.min(this._longestInteractionList.length - 1, Math.floor($y() / 50));
        ...
        _processEntry(e) {
          ...
          if (n || this._longestInteractionList.length < Zy || e.duration > t._latency) {
            if (
              (n
              ...
              this._longestInteractionList.length > Zy)
            ) {
              let e = this._longestInteractionList.splice(Zy);
  ...
  rb = e(() => {
    (iy(),
      ...
      (nb = (e) => {
        ...
        (fy(`visibilitychange`, t, !0), fy(`pagehide`, t, !0));
      }));
  }),
  ib,
  ab = e(() => {
    (iy(),
      ...
      (ib = (e) => {
        ...
        Q.document?.visibilityState === `hidden`
          ? e()
          : ((e = Ny(e)),
            fy(`visibilitychange`, e, { once: !0, capture: !0 }),
            t(() => {
              (e(), py(`visibilitychange`, e, { capture: !0 }));
            }),
            nb(e));
      }));
  }),
      ...
      (cb = (e, t = {}) => {
        ...
        Fy(() => {
          ...
          let r = wy(`INP`),
            ...
            s = jy(`event`, o, { durationThreshold: t.durationThreshold ?? sb });
          ((i = oy(e, r, ob, t.reportAllChanges)),
            s &&
          ...
          let n = by(),
            ...
            o = (e) => {
              ...
              for (let t of e)
                (a._processEntry(t),
                  t.startTime < n.firstHiddenTime &&
                    ((r.value = Math.max(t.startTime - uy(), 0)), (r.entries = [t]), i()));
            },
            s = jy(`largest-contentful-paint`, o);
          if (s) {
            i = oy(e, r, fb, t.reportAllChanges);
            let n = Ny(() => {
                (o(s.takeRecords()), s.disconnect(), i(!0));
              }),
              a = (e) => {
                e.isTrusted && (ib(n), py(e.type, a, { capture: !0 }));
              };
            for (let e of [`keydown`, `click`, `visibilitychange`]) fy(e, a, { capture: !0 });
          }
        });
      }));
  }),
      ...
      (gb = (e) => {
        Q.document?.prerendering
          ...
          : Q.document?.readyState === `complete`
            ? setTimeout(e)
            : addEventListener(`load`, () => gb(e), !0);
      }),
      (_b = (e, t = {}) => {
        let n = wy(`TTFB`),
          r = oy(e, n, hb, t.reportAllChanges);
        gb(() => {
          let e = cy();
          e && ((n.value = Math.max(e.responseStart - uy(), 0)), (n.entries = [e]), r(!0));
        });
      }));
  });
function yb(e, t = !1) {
  return kb(`cls`, e, Tb, Ib, t);
}
function bb(e, t = !1) {
  return kb(`lcp`, e, Eb, Lb, t);
}
function xb(e) {
  return kb(`ttfb`, e, Db, Rb);
}
function Sb(e) {
  return kb(`inp`, e, Ob, zb);
}
function Cb(e, t) {
  return (jb(e, t), Fb[e] || (Ab(e), (Fb[e] = !0)), Mb(e, t));
}
function wb(e, t) {
  let n = Pb[e];
  if (n?.length)
...
function Db() {
  return _b((e) => {
    (wb(`ttfb`, { metric: e }), (Rb = e));
  });
}
function Ob() {
  return cb((e) => {
    (wb(`inp`, { metric: e }), (zb = e));
  });
}
function kb(e, t, n, r, i = !1) {
  jb(e, t);
  let a;
  return (Fb[e] || ((a = n()), (Fb[e] = !0)), r && t({ metric: r }), Mb(e, t, i ? a : void 0));
}
function Ab(e) {
  let t = {};
...
var Pb,
  ...
  zb,
  Bb = e(() => {
    (X(), ry(), Hy(), lb(), mb(), My(), vb(), (Pb = {}), (Fb = {}));
  });
function Vb(e) {
  return typeof e == `number` && isFinite(e);
}
function Hb(e, t, n, { ...r }) {
  let i = Of(e).start_timestamp;
  return (
    i && i > t && typeof e.updateStartTime == `function` && e.updateStartTime(t),
    nm(e, () => {
      let e = tm({ startTime: t, ...r });
      return (e && e.end(n), e);
    })
  );
}
...
function Zb(e, t, n, r) {
  ny && Y.log(`Sending CLS span (${e})`);
  let i = t ? Gb((Iu() || 0) + t.startTime) : Pu(),
    a = gd().getScopeData().transactionName,
    o = t ? eu(t.sources[0]?.node) : `Layout shift`,
    s = {
      [Dd]: `auto.http.browser.cls`,
      [Ed]: `ui.webvital.cls`,
      [Nd]: 0,
  ...
  t?.sources &&
    t.sources.forEach((e, t) => {
      s[`cls.source.${t + 1}`] = eu(e.node);
    });
  let c = Ub({ name: o, transaction: a, attributes: s, startTime: i });
  c && (c.addEvent(`cls`, { [kd]: ``, [Ad]: e }), c.end(i));
}
var Qb = e(() => {
  (X(), ry(), Bb(), Yb());
});
function $b(e) {
  let t = 0,
    n;
  if (!qb(`largest-contentful-paint`)) return;
  let r = bb(({ metric: e }) => {
    let r = e.entries[e.entries.length - 1];
    r && ((t = e.value), (n = r));
  }, !0);
...
function ex(e, t, n, r) {
  ny && Y.log(`Sending LCP span (${e})`);
  let i = Gb((Iu() || 0) + (t?.startTime || 0)),
    a = gd().getScopeData().transactionName,
    o = t ? eu(t.element) : `Largest contentful paint`,
    s = {
      [Dd]: `auto.http.browser.lcp`,
      [Ed]: `ui.webvital.lcp`,
      [Nd]: 0,
      "sentry.pageload.span_id": n,
      "sentry.report_event": r,
  ...
  t &&
    (t.element && (s[`lcp.element`] = eu(t.element)),
    t.id && (s[`lcp.id`] = t.id),
  ...
  let c = Ub({ name: o, transaction: a, attributes: s, startTime: i });
  c && (c.addEvent(`lcp`, { [kd]: `millisecond`, [Ad]: e }), c.end(i));
}
var tx = e(() => {
  (X(), ry(), Bb(), Yb());
});
function nx(e) {
  return e && ((Iu() || performance.timeOrigin) + e) / 1e3;
}
function rx(e) {
  let t = {};
  if (e.nextHopProtocol != null) {
    let { name: n, version: r } = Kb(e.nextHopProtocol);
    ((t[`network.protocol.version`] = r), (t[`network.protocol.name`] = n));
  }
  return Iu() || Wb()?.timeOrigin
    ? ix({
        ...t,
        "http.request.redirect_start": nx(e.redirectStart),
        "http.request.redirect_end": nx(e.redirectEnd),
        "http.request.worker_start": nx(e.workerStart),
        "http.request.fetch_start": nx(e.fetchStart),
        "http.request.domain_lookup_start": nx(e.domainLookupStart),
        "http.request.domain_lookup_end": nx(e.domainLookupEnd),
        "http.request.connect_start": nx(e.connectStart),
        "http.request.secure_connection_start": nx(e.secureConnectionStart),
        "http.request.connection_end": nx(e.connectEnd),
        "http.request.request_start": nx(e.requestStart),
        "http.request.response_start": nx(e.responseStart),
        "http.request.response_end": nx(e.responseEnd),
...
function ox({ recordClsStandaloneSpans: e, recordLcpStandaloneSpans: t, client: n }) {
  let r = Wb();
  if (r && Iu()) {
...
function sx() {
  Cb(`longtask`, ({ entries: e }) => {
    let t = Lf();
    if (!t) return;
    let { op: n, start_timestamp: r } = Of(t);
    for (let i of e) {
      let e = Gb(Iu() + i.startTime),
        a = Gb(i.duration);
      (n === `navigation` && r && e < r) ||
        Hb(t, e, e + a, {
          name: `Main UI thread blocked`,
          op: `ui.long-task`,
          attributes: { [Dd]: `auto.ui.browser.metrics` },
        });
    }
  });
}
  ...
  new PerformanceObserver((e) => {
    ...
    if (t)
      for (let n of e.getEntries()) {
        ...
        let e = Gb(Iu() + n.startTime),
          { start_timestamp: r, op: i } = Of(t);
        if (i === `navigation` && r && e < r) continue;
        let a = Gb(n.duration),
          o = { [Dd]: `auto.ui.browser.metrics` },
          {
            invoker: s,
            invokerType: c,
            sourceURL: l,
      ...
      for (let n of e)
        if (n.name === `click`) {
          let e = Gb(Iu() + n.startTime),
            ...
            a = ru(n.target);
          (a && (i.attributes[`ui.component_name`] = a), Hb(t, e, e + r, i));
        }
    }
  });
}
function ux() {
  return yb(({ metric: e }) => {
    ...
    t && ((Ox.cls = { value: e.value, unit: `` }), (Ax = t));
  }, !0);
}
function dx() {
  return bb(({ metric: e }) => {
    let t = e.entries[e.entries.length - 1];
    t && ((Ox.lcp = { value: e.value, unit: `millisecond` }), (kx = t));
  }, !0);
}
function fx() {
  return xb(({ metric: e }) => {
    e.entries[e.entries.length - 1] && (Ox.ttfb = { value: e.value, unit: `millisecond` });
  });
}
function px(e, t) {
  let n = Wb(),
  ...
  let i = Gb(r),
    a = n.getEntries(),
    { op: o, start_timestamp: s } = Of(e);
  (a.slice(Dx).forEach((n) => {
    let r = Gb(n.startTime),
      a = Gb(Math.max(0, n.duration));
    if (!(o === `navigation` && s && i + r < s))
      switch (n.entryType) {
        ...
        case `paint`:
        case `measure`: {
          hx(e, n, r, a, i, t.ignorePerformanceApiSpans);
          let o = by(),
            s = n.startTime < o.firstHiddenTime;
          (n.name === `first-paint` && s && (Ox.fp = { value: n.startTime, unit: `millisecond` }),
            n.name === `first-contentful-paint` &&
              s &&
              (Ox.fcp = { value: n.startTime, unit: `millisecond` }));
          break;
        }
        case `resource`:
          xx(e, n, n.name, r, a, i, t.ignoreResourceSpans);
          break;
      }
  }),
    (Dx = Math.max(a.length - 1, 0)),
    Sx(e),
    o === `pageload` &&
      (Tx(Ox),
      t.recordClsOnPageloadSpan || delete Ox.cls,
      t.recordLcpOnPageloadSpan || delete Ox.lcp,
      Object.entries(Ox).forEach(([e, t]) => {
        zp(e, t.value, t.unit);
      }),
      e.setAttribute(`performance.timeOrigin`, i),
      e.setAttribute(`performance.activationStart`, uy()),
      Cx(e, t)),
    (kx = void 0),
    (Ax = void 0),
    (Ox = {}));
...
function hx(e, t, n, r, i, a) {
  if (mx(t) || ([`mark`, `measure`].includes(t.entryType) && yu(t.name, a))) return;
  let o = cy(!1),
    s = Gb(o ? o.requestStart : 0),
    c = i + Math.max(n, s),
    l = i + n,
    u = l + r,
    d = { [Dd]: `auto.resource.browser.metrics` };
  (c !== l &&
    ((d[`sentry.browser.measure_happened_before_request`] = !0),
    (d[`sentry.browser.measure_start_time`] = c)),
    gx(d, t),
    c <= u && Hb(e, c, u, { name: t.name, op: t.entryType, attributes: d }));
}
function gx(e, t) {
  try {
    let n = t.detail;
    ...
    if (typeof n == `object`) {
      for (let [t, r] of Object.entries(n))
        if (r && Hl(r)) e[`sentry.browser.measure.detail.${t}`] = r;
        else if (r !== void 0)
          try {
...
function _x(e, t, n) {
  ([`unloadEvent`, `redirect`, `domContentLoadedEvent`, `loadEvent`, `connect`].forEach((r) => {
    ...
    vx(e, t, `secureConnection`, n, `TLS/SSL`),
    vx(e, t, `fetch`, n, `cache`),
    vx(e, t, `domainLookup`, n, `DNS`),
    bx(e, t, n));
}
function vx(e, t, n, r, i = n) {
  let a = t[yx(n)],
    o = t[`${n}Start`];
  !o ||
    !a ||
...
function bx(e, t, n) {
  let r = n + Gb(t.requestStart),
    i = n + Gb(t.responseEnd),
    a = n + Gb(t.responseStart);
  t.responseEnd &&
    (Hb(e, r, i, {
      op: `browser.request`,
      name: t.name,
...
function xx(e, t, n, r, i, a, o) {
  ...
  let c = { [Dd]: `auto.resource.browser.metrics` },
    l = Mg(n);
  ...
  let u = { ...c, ...rx(t) },
    d = a + r;
  Hb(e, d, d + i, { name: n.replace(Q.location.origin, ``), op: s, attributes: u });
}
function Sx(e) {
  let t = Q.navigator;
  if (!t) return;
  ...
  (n &&
    ...
    Vb(n.rtt) && (Ox[`connection.rtt`] = { value: n.rtt, unit: `millisecond` })),
    Vb(t.deviceMemory) && e.setAttribute(`deviceMemory`, `${t.deviceMemory} GB`),
    Vb(t.hardwareConcurrency) &&
      e.setAttribute(`hardwareConcurrency`, String(t.hardwareConcurrency)));
}
function Cx(e, t) {
  (kx &&
    t.recordLcpOnPageloadSpan &&
    (kx.element && e.setAttribute(`lcp.element`, eu(kx.element)),
    kx.id && e.setAttribute(`lcp.id`, kx.id),
    kx.url && e.setAttribute(`lcp.url`, kx.url.trim().slice(0, 200)),
    kx.loadTime != null && e.setAttribute(`lcp.loadTime`, kx.loadTime),
    kx.renderTime != null && e.setAttribute(`lcp.renderTime`, kx.renderTime),
    e.setAttribute(`lcp.size`, kx.size)),
    Ax?.sources &&
      t.recordClsOnPageloadSpan &&
      Ax.sources.forEach((t, n) => e.setAttribute(`cls.source.${n + 1}`, eu(t.node))));
}
function wx(e, t, n) {
  n.forEach(([n, r]) => {
    let i = e[n];
    i != null && ((typeof i == `number` && i < Ex) || typeof i == `string`) && (t[r] = i);
  });
}
function Tx(e) {
  let t = cy(!1);
...
function Mx() {
  return Wb() && Iu() ? Cb(`element`, Nx) : () => void 0;
}
var Nx,
  Px = e(() => {
    (X(),
      ...
      (Nx = ({ entries: e }) => {
        let t = Lf(),
          n = t ? If(t) : void 0,
          r = n ? Of(n).description : gd().getScopeData().transactionName;
        e.forEach((e) => {
          let t = e;
          ...
          let n = t.name,
            ...
            [o, s] = a
              ...
              : i
                ? [Gb(i), `render-time`]
                : [Pu(), `entry-emission`],
            c = n === `image-paint` ? Gb(Math.max(0, (i ?? 0) - (a ?? 0))) : 0,
            l = {
              [Dd]: `auto.ui.browser.elementtiming`,
              [Ed]: `ui.elementtiming`,
              [Cd]: `component`,
  ...
  (Q.document.addEventListener(`click`, t, !1),
    ...
    [`EventTarget`, `Node`].forEach((t) => {
      ...
      n?.hasOwnProperty?.(`addEventListener`) &&
        (su(n, `addEventListener`, function (t) {
        ...
        su(n, `removeEventListener`, function (e) {
...
function Lx(e) {
  if (e.type !== Ux) return !1;
  try {
    if (!e.target || e.target._sentryId !== Wx) return !1;
  } catch {}
  return !0;
}
function Rx(e, t) {
...
function zx(e, t = !1) {
  return (n) => {
    ...
    let r = Bx(n);
    if (Rx(n.type, r)) return;
    (cu(n, `_sentryCaptured`, !0), r && !r._sentryId && cu(r, `_sentryId`, Cu()));
    let i = n.type === `keypress` ? `input` : n.type;
    (Lx(n) || (e({ event: n, name: i, global: t }), (Ux = n.type), (Wx = r ? r._sentryId : void 0)),
      clearTimeout(Hx),
      (Hx = Q.setTimeout(() => {
        ((Wx = void 0), (Ux = void 0));
      }, Vx)));
  ...
  if (
    (Q.addEventListener(`popstate`, () => {
      let e = Q.location.href,
        t = Yx;
      ((Yx = e), t !== e && Cl(`history`, { from: t, to: e }));
    }),
    !W_())
  )
    return;
  function e(e) {
    return function (...t) {
      ...
      if (n) {
        let r = Yx,
          i = Jx(String(n));
        if (((Yx = i), r === i)) return e.apply(this, t);
        Cl(`history`, { from: r, to: i });
      }
      return e.apply(this, t);
    };
  }
  (su(Q.history, `pushState`, e), su(Q.history, `replaceState`, e));
}
function Jx(e) {
  try {
...
function Zx(e) {
  ...
  if (r && typeof r.createElement == `function`)
    try {
      ...
      ny && Y.warn(`Could not create sandbox iframe for ${e} check, bailing to window.${e}: `, t);
    }
  return n && ($x[e] = n.bind(Q));
}
function Qx(e) {
  $x[e] = void 0;
}
...
function nS() {
  ...
  ((e.open = new Proxy(e.open, {
    apply(e, t, n) {
      let r = Error(),
        i = Pu() * 1e3,
        a = Bl(n[0]) ? n[0].toUpperCase() : void 0,
        o = rS(n[1]);
      if (!a || !o) return e.apply(t, n);
      ((t[iS] = { method: a, url: o, request_headers: {} }),
      ...
      let s = () => {
        ...
        if (e && t.readyState === 4) {
          ...
          Cl(`xhr`, { endTimestamp: Pu() * 1e3, startTimestamp: i, xhr: t, virtualError: r });
        }
      };
      return (
        ...
        (t.setRequestHeader = new Proxy(t.setRequestHeader, {
          apply(e, t, n) {
            let [r, i] = n,
              a = t[iS];
            return (a && Bl(r) && Bl(i) && (a.request_headers[r.toLowerCase()] = i), e.apply(t, n));
          },
        })),
        e.apply(t, n)
      );
      ...
      apply(e, t, n) {
        ...
        return r
          ? (n[0] !== void 0 && (r.body = n[0]),
            Cl(`xhr`, { startTimestamp: Pu() * 1e3, xhr: t }),
            e.apply(t, n))
          : e.apply(t, n);
      },
    })));
...
function oS(e) {
  ...
  try {
    ...
    return (ny && Y.error(t, `Failed to get xhr response headers`, e), {});
  }
  return t
    ? t
        .split(`\r
...
function uS() {
  ...
  function t(e) {
    ...
    if ((pS.set(r, n), pS.size > 50)) {
      let e = pS.keys().next().value;
      e !== void 0 && pS.delete(e);
    }
  }
  function n(e) {
  ...
  let r = ({ entries: e }) => {
    ...
    e.forEach((e) => {
      ...
      if (t == null || fS.has(t)) return;
      let i = e.target ? eu(e.target) : n(e);
      if (dS.length > 10) {
        let e = dS.shift();
        fS.delete(e);
      }
      (dS.push(t), fS.set(t, { span: r, elementName: i }));
    });
  };
  (Cb(`event`, r), Cb(`first-input`, r));
}
var dS,
  fS,
  pS,
  ...
  _S = e(() => {
    (X(),
      ...
      (gS = ({ metric: e }) => {
        ...
        let t = Gb(e.value);
        if (t > mS) return;
        let n = e.entries.find((t) => t.duration === e.value && hS[t.name]);
        if (!n) return;
        let { interactionId: r } = n,
          ...
          o = Lf(),
          s = o ? If(o) : void 0,
          c = r == null ? void 0 : fS.get(r),
          l = c?.span || s,
          u = l ? Of(l).description : gd().getScopeData().transactionName,
          d = Ub({
            name: c?.elementName || eu(n.target),
            transaction: u,
            attributes: {
              [Dd]: `auto.http.browser.inp`,
              [Ed]: `ui.interaction.${i}`,
              [Nd]: n.duration,
            },
            startTime: a,
          });
        d && (d.addEvent(`inp`, { [kd]: `millisecond`, [Ad]: e.value }), d.end(a + t));
      }));
  }),
  vS = e(() => {
    (Bb(), jx(), Px(), Gx(), Xx(), eS(), aS(), sS(), ax(), _S());
  });
function yS(e, t = Zx(`fetch`)) {
  let n = 0,
    r = 0;
  async function i(i) {
    let a = i.body.length;
  ...
  return Xh(e, i, Vh(e.bufferSize || bS));
}
var bS,
  xS = e(() => {
    (X(), vS(), (bS = 40));
  ...
  SS,
  CS = e(() => {
    SS = typeof __SENTRY_DEBUG__ > `u` || __SENTRY_DEBUG__;
  });
function wS(e, t, n, r) {
    ...
    (X(),
      ...
      (jS = (e) => {
        ...
        if (r) {
          ...
          let [e, t] = zS(r[1] || `?`, r[2]);
          return wS(t, e, r[3] ? +r[3] : void 0, r[4] ? +r[4] : void 0);
        }
      }),
      (MS = [TS, jS]),
      (NS =
        /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i),
      (PS = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i),
      (FS = (e) => {
        let t = NS.exec(e);
        if (t) {
          ...
          let e = t[3],
            n = t[1] || `?`;
          return (([n, e] = zS(n, e)), wS(e, n, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0));
        }
      }),
      (IS = [ES, FS]),
      (LS = [MS, IS]),
...
function HS(e, t) {
  return function (n) {
    ...
    try {
      let e = n.event,
        t = qS(e) ? e.target : e;
      ((r = eu(t, { keyAttrs: a, maxStringLength: o })), (i = ru(t)));
    } catch {
      r = `<unknown>`;
    }
    ...
    (i && (s.data = { "ui.component_name": i }),
      Wg(s, { event: n.event, name: n.name, global: n.global }));
  };
}
function US(e) {
  return function (t) {
    ...
    if (t.level === `assert`)
      if (t.args[0] === !1)
        ((n.message = `Assertion failed: ${_u(t.args.slice(1), ` `) || `console.assert`}`),
          (n.data.arguments = t.args.slice(1)));
      else return;
    Wg(n, { input: t.args, level: t.level });
  };
}
function WS(e) {
  return function (t) {
    ...
    let { method: a, url: o, status_code: s, body: c } = i,
      ...
      d = { category: `xhr`, data: l, type: `http`, level: H_(s) };
    (e.emit(`beforeOutgoingRequestBreadcrumb`, d, u), Wg(d, u));
  };
}
function GS(e) {
  return function (t) {
    ...
    if (r && !(t.fetchData.url.match(/sentry_key/) && t.fetchData.method === `POST`))
      if ((t.fetchData.method, t.fetchData.url, t.error)) {
        ...
        (e.emit(`beforeOutgoingRequestBreadcrumb`, o, a), Wg(o, a));
      } else {
        let i = t.response,
        ...
        let o = { input: t.args, response: i, startTimestamp: n, endTimestamp: r },
          s = { category: `fetch`, data: a, type: `http`, level: H_(a.status_code) };
        (e.emit(`beforeOutgoingRequestBreadcrumb`, s, o), Wg(s, o));
      }
  };
}
function KS(e) {
...
function $S(e) {
  return function (...t) {
    ...
    return (
      (t[0] = jv(n, {
        mechanism: { handled: !1, type: `auto.browser.browserapierrors.${pl(e)}` },
      })),
      e.apply(this, t)
    );
  };
        ...
        e in n &&
          ...
          su(n, e, function (t) {
            let n = {
              ...
              r = uu(t);
            return (r && (n.mechanism.data.handler = pl(r)), jv(t, n));
          });
      }),
      e.apply(this, t)
    );
...
function nC(e, t) {
  let n = Z[e]?.prototype;
  n?.hasOwnProperty?.(`addEventListener`) &&
    (su(n, `addEventListener`, function (n) {
      return function (r, i, a) {
        try {
          rC(i) &&
            (i.handleEvent = jv(i.handleEvent, {
              mechanism: {
                data: { handler: pl(i), target: e },
                handled: !1,
        ...
        return (
          t.unregisterOriginalCallbacks && iC(this, r, i),
          n.apply(this, [
            r,
            jv(i, {
              mechanism: {
    ...
    (X(),
      ...
      (sC = (e = {}) => {
        ...
        return {
          name: oC,
          setupOnce() {
            (t.setTimeout && su(Z, `setTimeout`, $S),
              t.setInterval && su(Z, `setInterval`, $S),
              t.requestAnimationFrame && su(Z, `requestAnimationFrame`, eC),
              t.XMLHttpRequest &&
                `XMLHttpRequest` in Z &&
                su(XMLHttpRequest.prototype, `send`, tC));
            let e = t.eventTarget;
            e && (Array.isArray(e) ? e : aC).forEach((e) => nC(e, t));
          },
        };
      }),
      (cC = wh(sC)));
      ...
      (uC = wh(() => ({
        ...
        setupOnce() {
          ...
          (ch({ ignoreDuration: !0 }),
            dh(),
            Kx(({ from: e, to: t }) => {
              e !== void 0 && e !== t && (ch({ ignoreDuration: !0 }), dh());
            }));
        },
      }))));
  });
function fC(e) {
  Dl((t) => {
    let { stackParser: n, attachStacktrace: r } = vC();
    if (bd() !== e || kv()) return;
    let { msg: i, url: a, line: o, column: s, error: c } = t,
      l = gC(Kv(n, c || i, void 0, r, !1), a, o, s);
    ((l.level = `error`),
      ih(l, {
        originalException: c,
...
function gC(e, t, n, r) {
  let i = (e.exception = e.exception || {}),
    ...
    d = yC(t) ?? nu();
  return (
    c.length === 0 && c.push({ colno: l, filename: d, function: `?`, in_app: !0, lineno: u }), e
  );
}
function _C(e) {
  SS && Y.log(`Global Handler attached: ${e}`);
}
function vC() {
  return bd()?.getOptions() || { stackParser: () => [], attachStacktrace: !1 };
}
function yC(e) {
  if (!(!Bl(e) || e.length === 0)) {
    ...
    (X(),
      ...
      (xC = (e = {}) => {
        ...
        return {
          ...
          setup(e) {
            (t.onerror && (fC(e), _C(`onerror`)),
              t.onunhandledrejection && (pC(e), _C(`onunhandledrejection`)));
          },
        };
      }),
      (SC = wh(xC)));
      ...
      (kC = (e = {}) => {
        ...
        return {
          ...
          preprocessEvent(e, r, i) {
            p_(Fv, i.getOptions().stackParser, n, t, e, r);
          },
        };
      }),
      (AC = wh(kC)));
...
function FC(e) {
  return [d_(), Zg(), cC(), ZS(), SC(), AC(), j_(), wC(), uC()];
}
function IC(e = {}) {
  let t = !e.skipBrowserExtensionCheck && MC(),
    n = e.defaultIntegrations == null ? FC() : e.defaultIntegrations;
  return Eg(ey, {
    ...e,
    enabled: t ? !1 : e.enabled,
    stackParser: ul(e.stackParser || RS),
    integrations: bh({ integrations: e.integrations, defaultIntegrations: n }),
    transport: e.transport || yS,
  });
}
var LC = e(() => {
  (X(), ty(), QS(), lC(), dC(), CC(), TC(), jC(), BS(), xS(), PC());
});
function RC(e) {
...
function UC(e, t) {
  ...
  (n &&
    (e.addEventProcessor(
      (e) => (
        e.type === `transaction` &&
          ...
          e.spans.forEach((e) => {
            if (e.op === `http.client`) {
              let t = XC.get(e.span_id);
              t && ((e.timestamp = t / 1e3), XC.delete(e.span_id));
            }
          }),
        e
      ),
    ...
    i &&
      Z_((e) => {
        if (e.response) {
          let t = YC.get(e.response);
          t && e.endTimestamp && XC.set(t, e.endTimestamp);
        }
      }),
    X_((e) => {
      let t = N_(e, u, d, f, { propagateTraceparent: p, onRequestSpanEnd: l });
      if ((e.response && e.fetchData.__span && YC.set(e.response, e.fetchData.__span), t)) {
        let n = zC(e.fetchData.url),
          r = n ? Mg(n).host : void 0;
    ...
    r &&
      tS((e) => {
        let t = KC(e, u, d, f, p, l);
        t && (o && WC(t), c?.(t, { headers: VC(e.xhr.__sentry_xhr_v3__?.request_headers) }));
      }));
}
function WC(e) {
  let { url: t } = Of(e).data;
  if (!t || typeof t != `string`) return;
  let n = Cb(`resource`, ({ entries: r }) => {
    r.forEach((r) => {
      BC(r) && r.name.endsWith(t) && (e.setAttributes(rx(r)), setTimeout(n));
    });
  });
}
function GC(e, t) {
  ...
  if (n) {
    ...
    let a = r.origin === i;
    return t ? yu(r.toString(), t) || (a && yu(r.pathname, t)) : a;
  } else {
    let n = !!e.match(/^\/(?!\/)/);
    return t ? yu(e, t) : n;
  }
...
function KC(e, t, n, r, i, a) {
  ...
  if (e.endTimestamp && u) {
    ...
    n &&
      ...
      (Ld(n, s.status_code), n.end(), a?.(n, { headers: VC(oS(o)), error: e.error }), delete r[t]);
    return;
  }
  let d = zC(c),
    f = Mg(d || c),
  ...
  ((o.__sentry_xhr_span_id__ = h.spanContext().spanId),
    ...
    n(c) && qC(o, Kf() && m ? h : void 0, i));
  let g = bd();
  return (g && g.emit(`beforeOutgoingRequestSpan`, h, e), h);
}
function qC(e, t, n) {
  let { "sentry-trace": r, baggage: i, traceparent: a } = Bg({ span: t, propagateTraceparent: n });
  r && JC(e, r, i, a);
}
function JC(e, t, n, r) {
  ...
  if (!(i?.[`sentry-trace`] || !e.setRequestHeader))
    try {
      if (
        ...
        let t = i?.baggage;
        (!t || !RC(t)) && e.setRequestHeader(`baggage`, n);
      }
    } catch {}
}
var YC,
    ...
    ? Z.document.addEventListener(`visibilitychange`, () => {
        ...
        if (Z.document.hidden && t) {
          let e = `cancelled`,
            { op: n, status: r } = Of(t);
          (SS &&
            Y.log(`[Tracing] Transaction: ${e} -> since tab moved to the background, op: ${n}`),
...
function tw(e, { linkPreviousTrace: t, consistentTraceSampling: n }) {
  let r = t === `session-storage`,
    i = r ? iw() : void 0;
  e.on(`spanStart`, (e) => {
    if (If(e) !== e) return;
    let t = gd().getPropagationContext();
    ((i = nw(i, e, t)), r && rw(i));
  });
  let a = !0;
  n &&
    e.on(`beforeSampling`, (e) => {
      ...
      (t.setPropagationContext({
        ...n,
        dsc: { ...n.dsc, sample_rate: String(i.sampleRate), sampled: String(aw(i.spanContext)) },
        sampleRand: i.sampleRand,
      }),
        (e.parentSampled = aw(i.spanContext)),
        (e.parentSampleRate = i.sampleRate),
        (e.spanAttributes = { ...e.spanAttributes, [Td]: i.sampleRate }));
    });
}
function nw(e, t, n) {
  let r = Of(t);
  ...
  return o.traceId === r.trace_id
    ...
    : (Date.now() / 1e3 - e.startTimestamp <= 3600 &&
        (SS && Y.log(`Adding previous_trace ${o} link to span ${{ op: r.op, ...t.spanContext() }}`),
        t.addLink({ context: o, attributes: { [Pd]: `previous_trace` } }),
        t.setAttribute(sw, `${o.traceId}-${o.spanId}-${aw(o) ? 1 : 0}`)),
      a);
}
function rw(e) {
  try {
    Z.sessionStorage.setItem(ow, JSON.stringify(e));
  } catch (e) {
    SS && Y.warn(`Could not store previous trace in sessionStorage`, e);
  }
}
function iw() {
  try {
    let e = Z.sessionStorage?.getItem(ow);
    return JSON.parse(e);
  } catch {
    return;
  }
...
var ow,
  sw,
  cw = e(() => {
    (X(), CS(), Pv(), (ow = `sentry_previous_trace`), (sw = `sentry.previous_trace`));
  });
function lw(e, t, n) {
  (e.emit(`startPageLoadSpan`, t, n), gd().setTransactionName(t.name));
  let r = pw(e);
...
function uw(e, t, n) {
  ...
  return (
    ...
    r && !i && a.setSDKProcessingMetadata({ normalizedRequest: { ...Mv(), url: r } }),
    pw(e)
  );
}
function dw(e) {
  return Z.document?.querySelector(`meta[name=${e}]`)?.getAttribute(`content`) || void 0;
}
  ...
  a &&
    addEventListener(
      ...
      () => {
        ...
        if (((o &&= (o.setAttribute(Od, `interactionInterrupted`), o.end(), void 0)), !i.name)) {
          SS &&
            Y.warn(
        ...
        o = fm(
          { name: i.name, op: a, attributes: { [Cd]: i.source || `url` } },
...
function hw(e, t) {
  let n = Of(e),
    r = Mu();
  return !(r - n.start_timestamp > bw || (t && r - t <= bw));
}
var gw,
  _w,
  vw,
      ...
      (vw = (e = {}) => {
        ...
        function N(e, r, i = !0) {
          let a = r.op === `pageload`,
            ...
            s = u ? u(r) : r,
            m = s.attributes || {};
          if ((o !== s.name && ((m[Cd] = `custom`), (s.attributes = m)), !i)) {
            let e = Mu();
            tm({ ...s, startTime: e }).end(e);
            return;
          }
          ((t.name = s.name), (t.source = m[Cd]));
          let h = fm(s, {
            idleTimeout: d,
            finalTimeout: f,
            childSpanTimeout: p,
        ...
        return {
          ...
          setup(e) {
            ...
            function t() {
              ...
              t &&
                !Of(t).timestamp &&
                (SS && Y.log(`[Tracing] Finishing current active span with op: ${Of(t).op}`),
                t.setAttribute(Od, `cancelled`),
                t.end());
            }
            (e.on(`startNavigationSpan`, (n, r) => {
              ...
              if (r?.isRedirect) {
                (SS &&
                  ...
                  N(e, { op: `navigation.redirect`, ...n }, !1));
                return;
              }
              ((j = void 0),
                t(),
                _d().setPropagationContext({
                  traceId: Ju(),
                  sampleRand: Math.random(),
                  propagationSpanId: Kf() ? void 0 : Yu(),
                }));
              let i = gd();
              (i.setPropagationContext({
                ...
                N(e, { op: `navigation`, ...n, parentSpan: null, forceTransaction: !0 }));
            }),
              e.on(`startPageLoadSpan`, (n, r = {}) => {
                if (bd() !== e) return;
                t();
                let i = hf(r.sentryTrace || dw(`sentry-trace`), r.baggage || dw(`baggage`)),
                  a = gd();
                (a.setPropagationContext(i),
                  Kf() || (a.getPropagationContext().propagationSpanId = Yu()),
                  a.setSDKProcessingMetadata({ normalizedRequest: Mv() }),
                  N(e, { op: `pageload`, ...n }));
              }),
              e.on(`endPageloadSpan`, () => {
                D && M && (M.setAttribute(Od, `reportPageLoaded`), M.end());
              }));
          },
          afterAllSetup(e) {
            let n = nu();
            if (
              (T !== `off` && tw(e, { linkPreviousTrace: T, consistentTraceSampling: E }),
              Z.location)
            ) {
              if (S) {
                let t = Iu();
                lw(e, {
                  ...
                  attributes: { [Cd]: `url`, [Dd]: `auto.pageload.browser` },
                });
              }
              C &&
                Kx(({ to: t, from: r }) => {
                  ...
                  uw(
                    e,
                    {
                      name: i?.pathname || Z.location.pathname,
                      attributes: { [Cd]: `url`, [Dd]: `auto.navigation.browser` },
                    },
                    { url: t, isRedirect: o },
                  );
                });
...
function Cw() {
  let e = vd().getScopeData(),
    t = _d().getScopeData(),
    n = gd().getScopeData();
  return (jm(e, t), jm(e, n), (e.eventProcessors = []), e);
}
function ww(e) {
  (_d().addScopeListener((t) => {
    e(Cw(), t);
  }),
    gd().addScopeListener((t) => {
      e(Cw(), t);
    }),
    vd().addScopeListener((t) => {
      e(Cw(), t);
    }));
}
var Tw = e(() => {
    ...
    (X(),
      ...
      (Ew = wh(() => ({
        ...
        setup(e) {
          let t = wv(e);
          ww((e, n) => {
            (t.sendScope(JSON.stringify(lp(e, 20, 2e3))),
              n.clearBreadcrumbs(),
              n.clearAttachments());
          });
        },
...
function kw(e) {
  let t;
  return Xh(e, async (e) => ((t ||= wv()), t.sendEnvelope(e.body), { statusCode: 200 }));
}
var Aw = e(() => {
    (X(), Ev());
  }),
...
function Iw(e) {
  return [...FC(e).filter((e) => e.name !== `BrowserSession`), Ew()];
}
function Lw(e = {}, t = IC) {
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
  ...
  ((window.__SENTRY__RENDERER_INIT__ = !0),
    ...
    e.defaultIntegrations === void 0 && (e.defaultIntegrations = Iw(e)),
    e.stackParser === void 0 && (e.stackParser = Pw),
    e.ipcNamespace === void 0 && (e.ipcNamespace = `sentry-ipc`),
    e.dsn === void 0 && (e.dsn = `https://12345@dummy.dsn/12345`),
    e.transport === void 0 && (e.transport = kw),
...
function Bw() {
  ...
  (Lw({
    ...
    tracesSampleRate: 0,
    integrations: (e) => (t ? [...e, vw()] : e),
  }),
    ah(`sessionId`, e.codexAppSessionId),
    ah(`buildFlavor`, e.buildFlavor),
    ah(`preRelease`, r),
    ah(`bundle`, `webview`),
    ah(`host`, `app`),
    Se(Uw));
...
var Zw,
  ...
  iT = e(() => {
    (k(),
      ...
      (Qw = he(C, Zw)),
      ($w = w(C, ({ get: e }) => e(Qw).isUpdateReady)),
      (eT = w(C, ({ get: e }) => e(Qw).lifecycleState)),
      (tT = w(C, ({ get: e }) => e(Qw).downloadProgressPercent)),
      (nT = w(C, ({ get: e }) => e(Qw).installProgressPercent)),
      (rT = w(C, ({ get: e }) => e(Qw).relaunchNotice)));
  });
function aT(e) {
  let t = (0, sT.c)(11),
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      t[0] === r
        ...
        : ((e = () => {
            if (r === `macOS`) {
              de.appUpdates?.installUpdate();
              return;
            }
            de.appUpdates?.checkForUpdates();
          }),
          (t[0] = r),
          (t[1] = e));
      let n;
      t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((n = (0, cT.jsx)(Nn, { className: `icon-xs` })), (t[2] = n))
        : (n = t[2]);
      let i;
      ...
      return (
        t[4] === e
          ? (a = t[5])
          : ((a = (0, cT.jsxs)(At, { onClick: e, children: [n, i] })), (t[4] = e), (t[5] = a)),
        a
      );
    }
    case `ready`: {
      ...
      t[6] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, cT.jsx)(Nn, { className: `icon-xs` })), (t[6] = e))
        : (e = t[6]);
      let n;
      return (
...
var sT,
  cT,
  lT = e(() => {
    ((sT = pt()), k(), le(), Yw(), iT(), et(), fn(), We(), we(), me(), (cT = _n()));
  });
function uT(e) {
...
function mT(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, _T.jsx)(so, { className: `icon-lg text-token-error-foreground` })),
      (a = (0, _T.jsx)(E, {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, _T.jsx)(In, { electron: !0, children: (0, _T.jsx)(aT, {}) })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
    ? ((s = () => {
      ...
      : ((l = (0, _T.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, _T.jsxs)(`div`, {
              ...
              children: [o, (0, _T.jsx)(At, { onClick: s, children: c })],
            }),
          ],
        })),
        (t[7] = s),
...
var hT,
  ...
  bT = e(() => {
    ((hT = pt()),
      ...
      ct(),
      (_T = _n()),
      (vT = { componentStack: null, error: null, eventId: `` }),
      (yT = class extends gT.Component {
        state = vT;
        ...
        componentDidCatch(e, { componentStack: t }) {
          let n = t ?? ``,
            r = fT(e) ? e : Error(String(e));
          if (fT(e)) {
            let t = Error(e.message);
            ((t.name = `React ErrorBoundary ${t.name}`), (t.stack = n), pT(e, t));
          }
          let i = Hw(r, { boundaryName: this.props.name, componentStack: n });
          this.props.onError && this.props.onError(r, n, i);
          try {
            O.error(`error boundary`, {
...
var jT,
  MT = e(() => {
    (TT(),
      DT(),
      kT(),
      (jT = [...AT(OT, `webview`), ...AT(ET, `vscode-only`), ...AT(wT, `electron-only`)]));
  });
function NT(e) {
...
function HT(e, t) {
  return e === t ? !0 : YT.some((n) => n.includes(e) && n.includes(t));
}
function UT({ commandId: e, isMacOS: t }) {
  return WT({ commandId: e, isMacOS: t })[0] ?? null;
}
function WT({ commandId: e, isMacOS: t }) {
  let n = NT(e);
...
function GT({ commandId: e, keymapState: t, isMacOS: n }) {
  let r = NT(e);
  if (r == null || !LT(r)) return [];
  ...
  return WT({ commandId: e, isMacOS: n });
}
function KT(e) {
...
var JT,
  ...
  $T = e(() => {
    (MT(),
      (JT = [`thread`, `navigation`, `panels`, `workspace`, `skills`, `configure`, `app`]),
      (YT = [
      ...
      (XT = new Map()));
    for (let e of jT) {
      if (XT.has(e.id)) throw Error(`Duplicate Codex command id: ${e.id}`);
      XT.set(e.id, e);
    }
    ((ZT = jT.filter((e) => e.kind === `webview` && /^thread[1-9]$/.test(e.id)).map((e) => e.id)),
      (QT = jT
...
function lE(e, t = iE()) {
  let n = UT({ commandId: e, isMacOS: t });
  return n == null ? null : oE(n, t);
}
var uE,
  dE = e(() => {
    (eE(),
...
function fE(e, t) {
  return WT({ commandId: e, isMacOS: t === `macOS` }).length > 0;
}
function pE(e, t, n) {
  return GT({ commandId: e, keymapState: t, isMacOS: n === `macOS` }).map((e) => ({
    accelerator: e,
    label: oE(e, n === `macOS`, n === `linux`),
  }));
}
var mE,
  hE,
  ...
  SE = e(() => {
    (eE(),
      ...
      (hE = It(C, `codex-command-keymap-state`, { enabled: !0, staleTime: F.ONE_MINUTE })),
      (gE = y(C, (e, { get: t }) => {
        NT(e);
        let n = t(zn);
        return [...GT({ commandId: e, keymapState: t(hE).data, isMacOS: n === `macOS` })];
      })),
      (_E = y(C, (e, { get: t }) => t(gE, e)[0] ?? null)),
      (vE = y(C, (e, { get: t }) => {
        let n = t(zn);
        return t(gE, e).map((e) => oE(e, n === `macOS`, n === `linux`));
      })),
      (yE = y(C, (e, { get: t }) => t(vE, e)[0] ?? null)),
      (bE = w(C, ({ get: e }) => mE.map((t) => e(yE, t)))),
      (xE = y(C, (e, { get: t }) => t(hE).data?.bindings.some((t) => t.command === e) === !0)));
  });
function CE(e, t) {
  return e.find((e) => e.clientThreadId === t) ?? null;
}
function wE(e, t) {
  return t == null ? qt(e) : n(t);
}
var TE,
  EE,
  DE = e(() => {
    (k(),
      ...
      _t(),
      (TE = y(C, (e, { get: t }) => {
        let n = r(t, `pending_worktrees`);
        return n === void 0 ? void 0 : CE(n, e);
      })),
      (EE = w(Me, ({ get: e, scope: t }) => {
  ...
  kE,
  AE = e(() => {
    ((OE = t(zt(), 1)), (kE = (0, OE.createContext)(null)));
  });
function jE(e, t, n) {
  let r = e.slice();
...
function RE(e) {
  let { children: t, id: n, items: r, strategy: i = GE, disabled: a = !1 } = e,
    { active: o, dragOverlay: s, droppableRects: c, over: l, measureDroppableContainers: u } = Gi(),
    d = ir(JE, n),
    f = s.rect !== null,
    p = (0, HE.useMemo)(() => r.map((e) => (typeof e == `object` && `id` in e ? e.id : e)), [r]),
    m = o != null,
  ...
  return HE.createElement(YE.Provider, { value: x }, t);
}
function zE(e) {
  ...
  return (
    pr(() => {
      if (!t && n !== s.current && r.current) {
        let e = i.current;
        if (e) {
          let t = Kr(r.current, { ignoreTransform: !0 }),
            n = {
              x: e.left - t.left,
              y: e.top - t.top,
...
function BE(e) {
  let {
    ...
    S = (0, HE.useMemo)(() => u.slice(u.indexOf(o)), [u, o]),
    {
      rect: C,
      node: w,
      isOver: T,
    ...
    }),
    {
      ...
      transform: F,
    } = Wi({ id: o, data: x, attributes: { ...tD, ...n }, disabled: y.draggable }),
    te = Wn(E, j),
    I = !!D,
    L = I && !m && NE(f) && NE(g),
    R = !_ && N,
    z = L
      ? ((R && L ? F : null) ??
        (s ?? v)({ rects: h, activeNodeRect: k, activeIndex: f, overIndex: g, index: b }))
      : null,
    B = NE(f) && NE(g) ? a({ id: o, items: u, activeIndex: f, overIndex: g }) : b,
    ne = D?.id,
    V = (0, HE.useRef)({ activeId: ne, items: u, newIndex: B, containerId: d }),
    re = u !== V.current.items,
    ie = t({
      active: D,
      containerId: d,
      isDragging: N,
    ...
    ae = zE({ disabled: !ie, index: b, node: w, rect: C });
  return (
    (0, HE.useEffect)(() => {
      (I && V.current.newIndex !== B && (V.current.newIndex = B),
        d !== V.current.containerId && (V.current.containerId = d),
        u !== V.current.items && (V.current.items = u));
    }, [I, B, d, u]),
    (0, HE.useEffect)(() => {
      if (ne === V.current.activeId) return;
      if (ne && !V.current.activeId) {
        V.current.activeId = ne;
        return;
      }
      let e = setTimeout(() => {
        V.current.activeId = ne;
  ...
  function oe() {
    if (ae || (re && V.current.newIndex === b)) return eD;
    if (!((R && !sr(O)) || !l) && (I || ie)) return _r.Transition.toString({ ...l, property: $E });
  }
}
function VE(e, t) {
    ...
    ((HE = t(zt())),
      ...
      (WE = (e) => {
        ...
        if (a === r) {
          let e = t[i];
          return e
            ? { x: r < i ? e.left + e.width - (o.left + o.width) : e.left - o.left, y: 0, ...UE }
            : null;
        }
        return a > r && a <= i
          ? { x: -o.width - s, y: 0, ...UE }
      ...
      (qE = (e) => {
        ...
        if (r === t) {
          let e = i[a];
          return e
            ? { x: 0, y: t < a ? e.top + e.height - (o.top + o.height) : e.top - o.top, ...KE }
            : null;
        }
        let s = LE(i, r, t);
        return r > t && r <= a
      ...
      (QE = { duration: 200, easing: `ease` }),
      ($E = `transform`),
      (eD = _r.Transition.toString({ property: $E, duration: 0, easing: `linear` })),
      (tD = { roleDescription: `sortable` }),
      G.Down,
      G.Right,
      G.Up,
      G.Left);
...
function rD(e, t) {
  let n = e.get(t.sourceController.tabIds$),
    r = n.indexOf(t.tabId);
  r !== -1 &&
    (r !== t.sourceIndex && e.set(t.sourceController.tabIds$, jE(n, r, t.sourceIndex)),
...
function iD(e, t, n, r) {
  let i = e.get(t.tabIds$),
    a = i.indexOf(n),
    o = i.indexOf(r);
  a === -1 || o === -1 || a === o || e.set(t.tabIds$, jE(i, a, o));
}
function aD(e, t, n, r) {
...
function fD(e) {
  ...
  t[21] === L
    ? (R = t[22])
    : ((R = U(`block w-full min-w-0 whitespace-nowrap`, L)), (t[21] = L), (t[22] = R));
  let z;
  t[23] !== R || t[24] !== I || t[25] !== v
    ? ((z = (0, yD.jsx)(`span`, { ref: I, className: R, children: v })),
      (t[23] = R),
      (t[24] = I),
      (t[25] = v),
      (t[26] = z))
  ...
  t[27] === u
    ? (ne = t[28])
    : ((ne = { ...u, "--app-shell-tab-background": bD }), (t[27] = u), (t[28] = ne));
  let V = ne,
    re;
  t[29] === l
    ? (re = t[30])
    : ((re = (e) => {
      ...
      (t[29] = l),
      (t[30] = re));
  let ie = P && `group-hover/tab:bg-[var(--app-shell-tab-background)]`,
    ae = P && (C || S) && `bg-[var(--app-shell-tab-background)]`,
    se;
  t[31] !== ie || t[32] !== ae
    ? ((se = U(`pointer-events-none absolute inset-0 z-0 rounded-md`, ie, ae)),
      (t[31] = ie),
      (t[32] = ae),
      (t[33] = se))
    : (se = t[33]);
  ...
  t[34] === se
    ? (ce = t[35])
    : ((ce = (0, yD.jsx)(`div`, { className: se })), (t[34] = se), (t[35] = ce));
  let le = w && b == null && `pe-2`,
    ue = C && `text-token-text-primary`,
    de = !C && `text-token-text-secondary`,
    fe;
  t[36] !== le || t[37] !== ue || t[38] !== de
    ? ((fe = U(`no-drag relative flex flex-1 items-center gap-2 z-10 text-sm min-w-0`, le, ue, de)),
      (t[36] = le),
      (t[37] = ue),
      (t[38] = de),
      (t[39] = fe))
    ...
    ? ((me =
        ...
        (0, yD.jsxs)(`span`, {
          ...
          children: [
            a != null &&
              (0, yD.jsx)(`span`, {
                className: U(`flex size-full items-center justify-center`, ee && `opacity-30`),
                children: a,
              }),
            ee &&
              (0, yD.jsx)(`span`, {
  ...
  t[48] !== S || t[49] !== B || t[50] !== y
    ...
    : (he = t[51]);
  let ge;
  t[52] !== F || t[53] !== C || t[54] !== k || t[55] !== P
    ? ((ge =
        k &&
        (0, yD.jsx)(`span`, {
          className: U(
            `pointer-events-none absolute inset-y-0 end-0 z-20 w-2 bg-linear-to-r from-transparent to-100%`,
            F ? `to-[var(--app-shell-tab-background)]` : `to-token-main-surface-primary`,
            P && !C && `group-hover/tab:to-[var(--app-shell-tab-background)]`,
          ),
        })),
      (t[52] = F),
      (t[53] = C),
  ...
  t[60] !== N || t[61] !== b
    ? ((ye =
        b != null &&
        (0, yD.jsx)(`span`, {
          className: U(`-ms-1.5 flex shrink-0 items-center`, N && `group-hover/tab:opacity-0`),
          children: b,
        })),
      (t[60] = N),
      (t[61] = b),
  ...
  t[78] !== b
    ? ((xe =
        ...
        (0, yD.jsx)(`button`, {
          ...
          onMouseDown: mD,
          onPointerDown: pD,
          children: (0, yD.jsx)(uD, { className: `icon-xs relative` }),
        })),
      (t[72] = O),
      (t[73] = C),
      (t[74] = w),
...
function hD(e) {
  let t = (0, _D.c)(72),
    ...
    x;
  t[0] !== n || t[1] !== u
    ? ((x = { controller: n, kind: `app-shell-tab`, tabId: u }), (t[0] = n), (t[1] = u), (t[2] = x))
    : (x = t[2]);
  let S = r || m,
    C;
  t[3] !== x || t[4] !== S || t[5] !== c.dndId
    ? ((C = { data: x, disabled: S, id: c.dndId, strategy: WE }),
      (t[3] = x),
      (t[4] = S),
      (t[5] = c.dndId),
      (t[6] = C))
  ...
  t[7] !== n || t[8] !== p || t[9] !== l || t[10] !== u
    ? ((j = (e) => {
        if (p) {
          let t = l.get(vt),
            r = l.get(n.tabs$),
            i = r.findIndex((e) => e.tabId === u),
            a = r.some((e) => e.tabId !== u && e.isClosable),
            s = i !== -1 && r.slice(i + 1).some(gD);
          if (
  ...
  let M = j,
    N;
  t[12] !== M || t[13] !== h || t[14] !== l
    ? ((N = () => {
        let e = typeof h == `function` ? h(l) : (h ?? []);
        return Array.isArray(e) ? M([...e]) : e.then((e) => M([...e]));
      }),
      (t[12] = M),
      (t[13] = h),
      (t[14] = l),
  ...
  let P = N,
    ee = n.panelId,
    F = r && `opacity-50`,
    te = T && `z-10 cursor-grab opacity-0`,
    I;
  t[16] !== F || t[17] !== te
    ? ((I = U(
    ...
    : (I = t[18]);
  let L;
  t[19] === k ? (L = t[20]) : ((L = _r.Translate.toString(k)), (t[19] = k), (t[20] = L));
  let R;
  t[21] !== L || t[22] !== A
    ? ((R = { transform: L, transition: A }), (t[21] = L), (t[22] = A), (t[23] = R))
    : (R = t[23]);
  let z, B;
  t[24] !== n || t[25] !== l || t[26] !== u
    ? ((z = () => n.activateTab(l, u)),
      (B = () => n.closeTab(l, u)),
      (t[24] = n),
      (t[25] = l),
  ...
  let re;
  t[54] !== P || t[55] !== V
    ? ((re = (0, yD.jsx)(kt, { getItems: P, children: V })), (t[54] = P), (t[55] = V), (t[56] = re))
    : (re = t[56]);
  let ie = s ? `opacity-100` : `opacity-0`,
    ae;
  t[57] === ie
    ? (ae = t[58])
    : ((ae = U(
...
var _D,
  ...
  CD = e(() => {
    ((_D = pt()),
      ...
      $e(),
      (yD = _n()),
      (bD = `color-mix(in srgb, var(--color-token-foreground) 5%, var(--color-token-main-surface-primary))`),
      (xD = `min(32rem, var(--radix-tooltip-content-available-width), calc(100vw - 16px))`),
      (SD = 100));
  });
function wD(e) {
  let t = (0, kD.c)(95),
    ...
    [f, p] = (0, AD.useState)(!1),
    [m, h] = ve(),
    [g, _] = (0, AD.useState)(null),
    v = `app-shell-tab-strip:${o.panelId}`,
    y;
  t[0] === o
    ? (y = t[1])
    : ((y = { controller: o, kind: `app-shell-tab-strip` }), (t[0] = o), (t[1] = y));
  let b;
  t[2] !== v || t[3] !== y
    ? ((b = { id: v, data: y }), (t[2] = v), (t[3] = y), (t[4] = b))
    : (b = t[4]);
  let { setNodeRef: x } = Ki(b),
    S = (0, AD.useContext)(kE),
    C,
    w,
    T,
    E,
  ...
  if (
    ...
    let e = c.map(ED),
      r;
    t[33] === c ? (r = t[34]) : ((r = c.map(TD)), (t[33] = c), (t[34] = r));
    let i = r;
    ((w = h == null || h === 0 ? `0px` : `0px -${h}px 0px 0px`), (T = S?.dragState != null));
    ...
    let v = `${h ?? 0}px`;
    t[42] === v ? (k = t[43]) : ((k = { scrollPaddingInlineEnd: v }), (t[42] = v), (t[43] = k));
    ...
    (t[44] === y
      ...
      t[46] === b
        ? (A = t[47])
        : ((A = (0, jD.jsx)(`div`, { "aria-hidden": !0, className: b })), (t[46] = b), (t[47] = A)),
      t[48] === g
        ? (j = t[49])
        : ((j = (0, jD.jsx)(DD, { onVisibleChange: d, root: g })), (t[48] = g), (t[49] = j)),
      (C = RE),
      (I = i),
      (L = WE),
      (P = `tablist`));
    let R = T ? `z-20` : `z-0`;
    (t[50] === R ? (ee = t[51]) : ((ee = U(`relative flex`, R)), (t[50] = R), (t[51] = ee)),
      ...
      (te = c.map((t) => {
        let r = n === t.tabId,
          i = e.indexOf(t.tabId),
          a = i < e.length - 1 && !r && !OD(i, f);
        return (0, jD.jsx)(
          hD,
          {
            controller: o,
            disabled: !l && t.requiresWorkspaceReady !== !1,
            isActive: r,
            separatorIndex: i,
    ...
    ((C = t[16]),
      ...
      (L = t[32]));
  let R;
  t[53] !== P || t[54] !== ee || t[55] !== F || t[56] !== te
    ? ((R = (0, jD.jsx)(`div`, { role: P, className: ee, style: F, children: te })),
      (t[53] = P),
      (t[54] = ee),
      (t[55] = F),
      (t[56] = te),
    ...
    : (R = t[57]);
  let z;
  t[58] !== C || t[59] !== R || t[60] !== I || t[61] !== L
    ? ((z = (0, jD.jsx)(C, { items: I, strategy: L, children: R })),
      (t[58] = C),
      (t[59] = R),
      (t[60] = I),
      (t[61] = L),
  ...
  let B;
  t[63] !== w || t[64] !== g
    ? ((B = (0, jD.jsx)(DD, { onVisibleChange: p, root: g, rootMargin: w })),
      (t[63] = w),
      (t[64] = g),
      (t[65] = B))
    : (B = t[65]);
  let ne = h ?? 0,
    V;
  t[66] === ne ? (V = t[67]) : ((V = { right: ne }), (t[66] = ne), (t[67] = V));
  let re = f ? `opacity-0` : `opacity-100`,
    ie;
  t[68] === re
    ? (ie = t[69])
    : ((ie = U(
  ...
  let ae;
  t[70] !== V || t[71] !== ie
    ? ((ae = (0, jD.jsx)(`div`, { "aria-hidden": !0, style: V, className: ie })),
      (t[70] = V),
      (t[71] = ie),
      (t[72] = ae))
    : (ae = t[72]);
  let oe;
  t[73] !== i || t[74] !== m || t[75] !== T
    ? ((oe =
        i != null &&
        (0, jD.jsx)(`div`, {
          ref: m,
  ...
  let le;
  return (
    t[90] !== M || t[91] !== N || t[92] !== se || t[93] !== ce
      ? ((le = (0, jD.jsxs)(`div`, { className: M, children: [N, se, ce] })),
        (t[90] = M),
        (t[91] = N),
        (t[92] = se),
        (t[93] = ce),
...
function DD(e) {
  ...
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, jD.jsx)(`span`, { "aria-hidden": !0, ref: a }, i)),
        (t[4] = i),
        (t[5] = a),
        (t[6] = o))
      : (o = t[6]),
...
var kD,
  ...
  jD,
  MD = e(() => {
    ((kD = pt()), ao(), nD(), Et(), (AD = t(zt(), 1)), Ge(), CD(), AE(), (jD = _n()));
  });
function ND(e) {
  let t = (0, ID.c)(23),
    {
    ...
    c = H(s.tabs$),
    l = H(s.activeTab$),
    u = H(s.activeTabReactKey$),
    d = H(EE),
    f = (0, LD.useContext)(kE)?.dragState ?? null,
    p;
  t[0] !== s || t[1] !== f || t[2] !== c
    ? ((p = sD(c, s, f)), (t[0] = s), (t[1] = f), (t[2] = c), (t[3] = p))
    : (p = t[3]);
  let m = p,
    h = d === `ready`,
  ...
  t[11] !== h
    ...
    : (v = t[12]);
  let y;
  t[13] !== l || t[14] !== g || t[15] !== u || t[16] !== s || t[17] !== a || t[18] !== h
    ? ((y = g
        ? (0, RD.jsx)(BD, { controller: s, tab: l }, u)
        : h
          ? (0, RD.jsx)(`div`, { className: `relative min-h-0 flex-1`, children: a })
          : (0, RD.jsx)(`div`, {
  ...
  return (
    t[2] === n
      ...
      : ((a = (0, RD.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, RD.jsx)(At, { color: `secondary`, size: `default`, onClick: n, children: i }),
          ],
        })),
        (t[2] = n),
        (t[3] = a)),
...
function FD(e) {
  return e.composedPath().some((e) => e instanceof Element && e.hasAttribute(zD));
}
var ID,
  LD,
  RD,
  ...
  VD = e(() => {
    ((ID = pt()),
      ...
      MD(),
      (RD = _n()),
      (zD = `data-tab-preview-pin-exempt`),
      (BD = (0, LD.memo)(function ({ controller: e, tab: t }) {
        "use no memo";
        let n = Le(Me);
        Ve(e.tabStateById$, t.tabId);
        let r = (r) => {
          FD(r.nativeEvent) || (t.isPreview && e.pinTab(n, t.tabId));
        };
        return (0, RD.jsx)(`div`, {
          role: `tabpanel`,
          "aria-label": t.title,
...
function YD() {
  let e = (0, ZD.c)(17),
    ...
    n = oe(),
    r = H(yt),
    i = Ve(yE, `toggleMaximizeSidePanel`),
    a;
  e[0] !== n || e[1] !== r
    ? ((a = r
        ? n.formatMessage({
  ...
  (e[3] !== r || e[4] !== t
    ? ((s = () => {
      ...
      (e[5] = s))
    : (s = e[5]),
    se(`toggleMaximizeSidePanel`, s));
  let c = r ? `secondary` : `ghost`,
    l;
  e[6] === r
    ? (l = e[7])
    : ((l = r
        ? (0, QD.jsx)(qD, { className: `icon-xs` })
        : (0, QD.jsx)(ke, { className: `icon-xs` })),
      (e[6] = r),
      (e[7] = l));
  let u;
  ...
  return (
    e[13] !== o || e[14] !== i || e[15] !== u
      ? ((d = (0, QD.jsx)(Qt, { tooltipContent: o, shortcut: i, delayOpen: !0, children: u })),
        (e[13] = o),
        (e[14] = i),
        (e[15] = u),
        (e[16] = d))
...
function XD() {
  return u(`toggleMaximizeSidePanel`, `side_panel_full_width_button`);
}
var ZD,
  QD,
  $D = e(() => {
    ((ZD = pt()), k(), le(), SE(), Un(), te(), et(), dt(), Ie(), JD(), L(), i(), (QD = _n()));
  });
function eO() {
  let e = H(Mt),
    t = H(nt),
    ...
    i = H(yt),
    a = H(wt),
    { headerLeftWidth: o, headerRightWidth: s } = Sn(),
    c = Jt`max(0px, calc(${s}px)`;
  return (0, tO.jsx)(ND, {
    headerHeight: `toolbar`,
    beforeList: (0, tO.jsxs)(tO.Fragment, {
      children: [
        i &&
          !a &&
          (0, tO.jsx)(tt.div, {
    ...
    afterListSticky: t,
    emptyState: r,
    afterList: (0, tO.jsxs)(tO.Fragment, {
      children: [
        e,
        (0, tO.jsx)(YD, {}),
        (0, tO.jsx)(tt.div, {
...
var iO,
  ...
  oO,
  sO = e(() => {
    (k(), v(), (iO = he(C, !1)), (aO = he(C, !1)), (oO = he(C, null)));
  });
function cO() {
  return ST() && window.electronBridge?.showApplicationMenu != null;
}
var lO = e(() => {
  CT();
});
function uO() {
  ...
  return (0, fO.jsx)(`div`, {
    ...
    children: mO.map(({ id: n, message: r }) =>
      (0, fO.jsx)(
        `button`,
        {
          type: `button`,
...
var dO,
  ...
  hO = e(() => {
    (Et(),
      ...
      (mO = [
        { id: bt.file, message: pO.file },
        { id: bt.edit, message: pO.edit },
        { id: bt.view, message: pO.view },
        { id: bt.help, message: pO.help },
      ]));
  });
function gO(e, t, n, r) {
...
var _O,
  ...
  SO = e(() => {
    (k(),
      ...
      vO(),
      (yO = he(C, _O)),
      (bO = he(C, { width: window.innerWidth, height: window.innerHeight })),
      (xO = {
        px$: w(C, ({ get: e }) => e(yO).x),
        py$: w(C, ({ get: e }) => e(yO).y),
        hasKnownVelocity$: w(C, ({ get: e }) => e(yO).hasKnownVelocity),
        vx$: w(C, ({ get: e }) => e(yO).velocityX),
        vy$: w(C, ({ get: e }) => e(yO).velocityY),
        speed$: w(C, ({ get: e }) => e(yO).speed),
        bottomInset$: w(C, ({ get: e }) => {
          let { height: t } = e(bO),
            n = e(yO).y;
          return n == null ? null : t - n;
        }),
        rightInset$: w(C, ({ get: e }) => {
          let { width: t } = e(bO),
            n = e(yO).x;
          return n == null ? null : t - n;
        }),
    ...
    ? ((w = () => {
        ...
        let e = (e) => ({ x: e.clientX / d, y: e.clientY / d }),
          t = (t) => {
            ...
            if (n == null) return;
            let r = e(t);
            ((h ? r.x : r.y) !== n.startPosition && (n.didMove = !0), c(wO(u, r, n)));
          },
          n = (t) => {
            t.preventDefault();
            let n = m.current;
...
function TO(e) {
  ...
  t[0] !== l || t[1] !== u || t[2] !== d || t[3] !== f || t[4] !== p || t[5] !== m || t[6] !== h
    ? ((g = U(`group absolute flex touch-none select-none`, l, u, d, f, p, m, h)),
      (t[0] = l),
      (t[1] = u),
      (t[2] = d),
      (t[3] = f),
  ...
  let _ =
    ...
    y;
  t[8] !== _ || t[9] !== v
    ? ((y = U(`sidebar-resize-handle-line pointer-events-none m-auto opacity-0`, _, v)),
      (t[8] = _),
      (t[9] = v),
      (t[10] = y))
    : (y = t[10]);
  ...
  t[11] === y
    ? (b = t[12])
    : ((b = (0, OO.jsx)(`div`, { className: y })), (t[11] = y), (t[12] = b));
  let x;
  return (
...
var EO,
  ...
  BO = e(() => {
    (k(),
      ...
      nn(),
      (zO = w(C, ({ get: e }) => {
        let { automationThreadIds: t, unreadRunCount: n } = e(M);
        return (
          n +
          e(d).filter((e) => {
            let n = Bt(e);
...
function VO(e) {
  ...
  let { hideUnreadBadge: r, onToggleSidebar: i } = n,
    ...
    p = H(iO),
    m = H(aO),
    h = Ve(yE, `toggleSidebar`),
    g = Ve(yE, `navigateBack`),
    _ = Ve(yE, `navigateForward`),
    v;
  t[2] !== s || t[3] !== c
    ? ((v = c
        ? s.formatMessage({
  ...
  (t[5] === o
    ? ((x = t[6]), (S = t[7]))
    : ((x = () => () => {
        (o.set(Cn, !1), o.set(Ot, !1), o.set(Qe, !1));
      }),
      (S = [o]),
      (t[5] = o),
      (t[6] = x),
  ...
  t[9] !== i || t[10] !== o
    ? ((D = () => {
        if ((o.set(Qe, !0), i != null)) {
          i();
          return;
        }
        u(`toggleSidebar`, `sidebar_trigger`);
      }),
      (t[9] = i),
      (t[10] = o),
      (t[11] = D))
  ...
  t[15] === b
    ? (A = t[16])
    : ((A = (0, qO.jsx)(b, { className: `icon-xs` })), (t[15] = b), (t[16] = A));
  let j;
  t[17] !== y ||
  t[18] !== O ||
  t[19] !== A ||
  ...
  t[23] !== h
    ...
    : (j = t[24]);
  let M;
  t[25] === s ? (M = t[26]) : ((M = s.formatMessage(JO.navigateBack)), (t[25] = s), (t[26] = M));
  let N = !p,
    P;
  t[27] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (0, qO.jsx)(E, { ...JO.navigateBack })), (t[27] = P))
    : (P = t[27]);
  let ee;
  t[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, qO.jsx)(Nt, { className: `icon-xs` })), (t[28] = ee))
    : (ee = t[28]);
  let F;
  t[29] !== g || t[30] !== M || t[31] !== N
    ? ((F = (0, qO.jsx)(WO, {
        ariaLabel: M,
        disabled: N,
        shortcut: g,
  ...
  t[33] === s
    ? (te = t[34])
    : ((te = s.formatMessage(JO.navigateForward)), (t[33] = s), (t[34] = te));
  let I = !m,
    L;
  t[35] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = (0, qO.jsx)(E, { ...JO.navigateForward })), (t[35] = L))
    : (L = t[35]);
  let R;
  t[36] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, qO.jsx)(Nt, { className: `icon-xs -scale-x-100` })), (t[36] = R))
    : (R = t[36]);
  let z;
  t[37] !== _ || t[38] !== te || t[39] !== I
    ? ((z = (0, qO.jsx)(WO, {
        ariaLabel: te,
        disabled: I,
        shortcut: _,
  ...
  t[41] !== F || t[42] !== z
    ? ((B = (0, qO.jsx)(In, {
        electron: !0,
        extension: !0,
        children: (0, qO.jsxs)(qO.Fragment, { children: [F, z] }),
      })),
      (t[41] = F),
      (t[42] = z),
      (t[43] = B))
  ...
  return (
    t[44] !== j || t[45] !== B
      ? ((ne = (0, qO.jsxs)(`div`, { className: `flex items-center gap-1`, children: [j, B] })),
        (t[44] = j),
        (t[45] = B),
        (t[46] = ne))
      : (ne = t[46]),
...
function HO() {
  return u(`navigateForward`, `sidebar_forward`);
}
function UO() {
  return u(`navigateBack`, `sidebar_back`);
}
function WO(e) {
  let t = (0, GO.c)(17),
    {
...
function QO(e, t) {
  if (e) return ik.default;
  if (ST()) return t ?? ik.applicationMenu;
  if (typeof navigator > `u`) return ik.default;
  let n = navigator,
  ...
  return i.includes(`darwin`) ||
    ...
    : i.includes(`win`) || r.includes(`windows`) || i.includes(`linux`)
      ? (t ?? ik.applicationMenu)
      : ik.default;
}
function $O() {
  let e = (0, tk.c)(9),
    [t, n] = (0, nk.useState)(!1),
    [r, i] = (0, nk.useState)(ek),
    a,
    o;
  (e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (e) => {
      ...
      (e[1] = o))
    : ((a = e[0]), (o = e[1])),
    Ae(`window-fullscreen-changed`, a, o));
  let s, c;
  ...
  let d;
  return (
    e[6] !== t || e[7] !== r ? ((d = QO(t, r)), (e[6] = t), (e[7] = r), (e[8] = d)) : (d = e[8]), d
  );
}
function ek() {
  return ZO();
  ...
  ok = e(() => {
    ((tk = pt()),
      ...
      (ik = Object.freeze({
        ...
        mac: Object.freeze({
          legacy: Object.freeze({ left: 66 + rk, right: 0 }),
          modern: Object.freeze({ left: 76 + rk, right: 0 }),
        }),
...
function sk(e, t) {
  return Number.isFinite(e) ? Math.max(160, Math.min(e, t * 0.5)) : uk;
}
function ck(e) {
  return sk(st(dk, 280), e);
}
function lk(e, t) {
  Tn(dk, sk(e, t));
}
var uk,
  dk,
  fk = e(() => {
    (jn(), (uk = 280), (dk = `app-shell:bottom-panel-height`));
  });
function pk(e) {
  let t = (0, gk.c)(10),
...
function yk({
  ...
  let a = Le(Me),
    { isMounted: o, opacity: s, animatedSize: c } = pk({ animation: H(hn), size: n, isVisible: i }),
    l = Jt`${n}px`;
  return !o && !i
    ? null
    : (0, bk.jsxs)(tt.div, {
...
var bk,
  xk = e(() => {
    (Ke(), k(), L(), De(), kO(), fk(), Ze(), vk(), (bk = _n()));
  }),
  Sk,
  Ck,
  wk = e(() => {
    ((Sk = t(zt(), 1)), (Ck = (0, Sk.createContext)(null)));
  });
function Tk() {
  let e = (0, Ak.c)(33),
    t = Le(Me),
    ...
    a = H(je),
    o = H(B.activeTab$),
    s = (0, jk.useSyncExternalStore)(En, Mn, Mn),
    c = H(St),
    u,
    d,
    f;
  if (e[0] !== n || e[1] !== o || e[2] !== t) {
    ...
    ((d = r != null),
      ...
      (e[4] = d),
      (e[5] = f));
  } else ((u = e[3]), (d = e[4]), (f = e[5]));
  let p = f,
    m = c && ((o?.isClosable ?? !1) || p != null),
    h = r && ((n?.isClosable ?? !1) || u != null),
    g;
  e[6] === u
    ? (g = e[7])
    : ((g = () => (u == null ? null : Bc.getSnapshot(u.conversationId, u.browserTabId))),
      (e[6] = u),
      (e[7] = g));
  let v = g,
    y;
  e[8] === p
    ? (y = e[9])
    : ((y = () => (p == null ? null : Bc.getSnapshot(p.conversationId, p.browserTabId))),
      (e[8] = p),
      (e[9] = y));
  let b = y,
    x = (0, jk.useSyncExternalStore)(Bc.subscribe, v, v),
    S = (0, jk.useSyncExternalStore)(Bc.subscribe, b, b),
    C = x?.tabType === _.WEB,
    w = S?.tabType === _.WEB,
    T = u?.conversationId ?? null,
    E = u?.browserTabId ?? null,
    D = p?.conversationId ?? null,
    O = p?.browserTabId ?? null,
    k,
    j;
  (e[10] !== C ||
  e[11] !== T ||
  ...
  e[21] !== a
    ? ((k = () => {
        l.dispatchMessage(`app-shell-shortcut-state-changed`, {
          bottomPanelBrowserCanZoom: C,
          bottomPanelBrowserConversationId: T,
          bottomPanelBrowserTabId: E,
          canAcceptAppshotShortcut: d,
          bottomPanelCanCloseActiveTab: h,
          focusArea: i,
          imagePreviewOpen: s,
          terminalFocused: a,
          rightPanelBrowserCanZoom: w,
          rightPanelBrowserConversationId: D,
          rightPanelBrowserTabId: O,
          rightPanelCanCloseActiveTab: m,
        });
      }),
      (j = [C, T, E, d, h, i, s, w, D, O, a, m]),
      (e[10] = C),
      (e[11] = T),
      (e[12] = E),
      (e[13] = h),
      ...
      (e[23] = j))
    : ((k = e[22]), (j = e[23])),
    (0, jk.useLayoutEffect)(k, j));
  let M;
  (e[24] === Symbol.for(`react.memo_cache_sentinel`) ? ((M = []), (e[24] = M)) : (M = e[24]),
    (0, jk.useEffect)(Dk, M));
  let N;
  (e[25] === Symbol.for(`react.memo_cache_sentinel`) ? ((N = []), (e[25] = N)) : (N = e[25]),
    Ae(`image-preview-zoom-command`, Ek, N));
  let P, ee;
  return (
    e[26] !== n || e[27] !== u || e[28] !== o || e[29] !== p || e[30] !== t
      ? ((P = (e) => {
          let { panelId: r } = e;
          bb95: switch (r) {
            case `bottom`:
              if (A.closeActiveTab(t)) break bb95;
              u != null && n != null && A.closeTab(t, n.tabId);
              break bb95;
            case `right`:
              if (B.closeActiveTab(t)) break bb95;
              p != null && o != null && B.closeTab(t, o.tabId);
          }
        }),
        (ee = [n, u, o, p, t]),
        (e[26] = n),
        ...
        (e[32] = ee))
      : ((P = e[31]), (ee = e[32])),
    Ae(`close-active-app-shell-tab`, P, ee),
    null
  );
}
function Ek(e) {
...
var Ak,
  jk,
  Mk = e(() => {
    ((Ak = pt()), k(), z(), (jk = t(zt(), 1)), Vc(), De(), Ce(), Hn(), L(), c(), i(), sn());
  });
function Nk({ isHeaderEdgeScroll: e, isApplicationMenuBarEnabled: t }) {
  ...
  return (0, Uk.jsx)(kt, {
    ...
    children: (0, Uk.jsxs)(tt.header, {
      ...
      style: t ? { left: s } : {},
      children: [
        (0, Uk.jsx)(Pk, { entries: f, fitWidth: n, slotWidth: t ? o : i, side: `start` }),
        (0, Uk.jsxs)(`div`, {
          "aria-hidden": m,
          ...
          children: [
            l != null &&
              (0, Uk.jsx)(`div`, {
                className: U(`pointer-events-none w-full min-w-0 flex-1`, Wk),
                children: l,
              }),
            v &&
              (0, Uk.jsx)(`div`, {
        ...
        y
          ...
          : null,
        (0, Uk.jsx)(Pk, { entries: p, fitWidth: r, slotWidth: c, side: `end` }),
      ],
    }),
  });
}
function Pk({ entries: e, fitWidth: t, side: n, slotWidth: r }) {
  ...
  return (0, Uk.jsxs)(Uk.Fragment, {
    children: [
      (0, Uk.jsx)(`div`, {
        ...
        ref: o,
        children: (0, Uk.jsx)(Fk, { entries: e }),
      }),
      (0, Uk.jsx)(tt.div, {
        ...
        children: (0, Uk.jsx)(Fk, { entries: e, fillSlot: !0 }),
      }),
    ],
  });
}
function Fk(e) {
  ...
  if (t[0] !== n || t[1] !== i) {
    let e = n.filter(Vk),
      r = n.filter(Bk),
      l = n.filter(zk),
      u = i ? `pointer-events-none w-full` : `no-drag pointer-events-auto w-auto`;
    (t[6] === u
      ? (a = t[7])
      : ((a = U(`inline-flex h-full items-center gap-1.5`, u)), (t[6] = u), (t[7] = a)),
      (o = e.map(Rk)),
      (s =
        r.length > 0
          ? (0, Uk.jsx)(`div`, {
  ...
  return (
    t[8] !== a || t[9] !== o || t[10] !== s || t[11] !== c
      ? ((l = (0, Uk.jsxs)(`div`, { className: a, children: [o, s, c] })),
        (t[8] = a),
        (t[9] = o),
        (t[10] = s),
        (t[11] = c),
...
function Ik(e, t) {
  ...
  return (0, Uk.jsx)(
    `div`,
    {
      className: U(`no-drag pointer-events-auto flex shrink-0 items-center`, t === 0 && `ms-auto`),
      children: r,
    },
    n,
  );
...
var Hk,
  ...
  Gk = e(() => {
    ((Hk = pt()),
      ...
      i(),
      (Uk = _n()),
      (Wk = `[&_a]:pointer-events-auto [&_button]:pointer-events-auto [&_input]:pointer-events-auto [&_select]:pointer-events-auto [&_textarea]:pointer-events-auto`));
  });
function Kk({ children: e, isResizing: t, onResizingChange: n, paddingTop: r }) {
  let i = Le(C),
    { leftPanelAnimatedWidth: a, leftPanelWidth: o } = Sn(),
    c = H(an),
    l = Jt`${o}px`;
  return (0, qk.jsxs)(tt.aside, {
    className: U(
    ...
    children: [
      (0, qk.jsx)(tt.div, {
        ...
        style: { minWidth: l, width: l, opacity: H(Kt) },
        children: e,
      }),
      (0, qk.jsx)(CO, {
        disabled: c && !t,
...
var qk,
  ...
  Qk = e(() => {
    ((Yk = t(zt(), 1)),
      (Xk = (0, Yk.createContext)({ current: null })),
      (Zk = (0, Yk.createContext)(null)));
  });
function $k({
  children: e,
  isRightPanelOpen: t,
  ...
  let o = Le(Me),
    ...
    _ = Jt`${r}px`,
    {
      ...
      animatedSize: b,
      progress: x,
    } = pk({ animation: d, size: r, isVisible: t });
  return (
    jt(x, `change`, () => {
      f.set(f.get() + 1);
    }),
          ...
          children: [
            ...
            !g &&
              (0, tA.jsx)(CO, {
                ...
                onResizingChange: (e) => {
                  (m(e), e && (h.current = o.get(St)));
                },
                setSize: (e) => {
                  let t = e >= Ct(320);
                  (o.get(gt) !== t && (t && h.current ? Lt(o, !0) : pe(o, t)),
                    t && i.set(Te(e, n.get(), a)));
                },
                onResizeEnd: (e) => {
                  e < Ct(320) ||
                    Dn({
            ...
            (0, tA.jsx)(`div`, {
              ...
              children: (0, tA.jsx)(tt.div, {
                className: U(
                  `absolute top-0 bottom-0 left-0 min-w-0 bg-token-main-surface-primary`,
                  !g && `border-l border-token-border-default`,
                ),
                style: { minWidth: _, width: _ },
                children: (0, tA.jsxs)(`div`, {
                  ...
                  children: [e, s == null ? c : (0, tA.jsx)(eO, {})],
                }),
              }),
            }),
          ],
...
function iA(e, t) {
  ...
  let r = ft(lt({ ...e, mainContentWidth: t.get() }));
  return ((n.current = { ...e, widthRatio: r }), r);
}
var aA,
  oA,
  sA = e(() => {
    ((aA = pt()), Ke(), k(), (oA = t(zt(), 1)), De(), g(), i());
  });
function cA(e) {
  let t = (0, hA.c)(41),
    { children: n } = e,
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (i = t[0]);
  let a = jr(Ar(ba, i)),
    [o, s] = (0, gA.useState)(null),
    c = (0, gA.useRef)(null),
    l = o != null,
    u;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (e, t, n) => {
        s((r) => (r == null ? r : aD(r, e, t, n)));
      }),
      (t[1] = u))
    : (u = t[1]);
  let d = u,
  ...
  t[5] === r
    ? (m = t[6])
    : ((m = (e) => {
        let t = dA(e.active.data.current);
  ...
  t[7] !== o || t[8] !== r
    ? ((g = (e) => {
        ...
        let n = dA(e.over?.data.current);
        if (n != null)
          if (n.kind === `app-shell-tab`) {
            if (n.tabId === t.tabId) return;
            if (n.controller === t.sourceController) {
              (iD(r, t.sourceController, t.tabId, n.tabId), d(t.sourceController, null, `before`));
              return;
            }
            d(n.controller, n.tabId, mA(e));
  ...
  t[12] !== o || t[13] !== r
    ? ((b = (e) => {
        let t = c.current;
        (o != null && t != null && rD(r, t), s(null), (c.current = null));
      }),
      (t[12] = o),
      (t[13] = r),
      (t[14] = b))
  ...
  let C = S,
    w;
  t[18] === o ? (w = t[19]) : ((w = { dragState: o }), (t[18] = o), (t[19] = w));
  let T;
  t[20] === o
    ? (T = t[21])
    : ((T =
  ...
  t[22] === o
    ? (E = t[23])
    : ((E = o == null ? null : (0, vA.jsx)(uA, { dragState: o })), (t[22] = o), (t[23] = E));
  let D;
  t[24] === E
    ? (D = t[25])
    : ((D = (0, vA.jsx)(io, { adjustScale: !1, zIndex: Ee, children: E })),
      (t[24] = E),
      (t[25] = D));
  let O;
  t[26] !== T || t[27] !== D
    ? ((O = (0, _A.createPortal)((0, vA.jsxs)(vA.Fragment, { children: [T, D] }), document.body)),
      (t[26] = T),
      (t[27] = D),
      (t[28] = O))
    : (O = t[28]);
  ...
  return (
    t[38] !== w || t[39] !== k
      ? ((A = (0, vA.jsx)(kE.Provider, { value: w, children: k })),
        (t[38] = w),
        (t[39] = k),
        (t[40] = A))
      : (A = t[40]),
...
function lA() {
  document.dispatchEvent(
    new KeyboardEvent(`keydown`, { bubbles: !0, cancelable: !0, code: G.Esc, key: G.Esc }),
  );
}
function uA(e) {
  let t = (0, hA.c)(19),
  ...
  return (
    t[16] !== _ || t[17] !== v
      ? ((y = (0, vA.jsx)(`div`, { style: _, children: v })), (t[16] = _), (t[17] = v), (t[18] = y))
      : (y = t[18]),
    y
  );
}
...
function fA(e) {
  let t = oa(e),
    n = t.filter((e) => dA(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab`);
  if (n.length > 0) return pA(n, e);
  let r =
      t.find((e) => dA(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab-strip`) ??
      null,
    i = r == null ? null : dA(r.data?.droppableContainer.data.current);
  if (r != null && i?.kind === `app-shell-tab-strip`) {
    let t = e.droppableContainers.filter((e) => {
      let t = dA(e.data.current);
      return t?.kind === `app-shell-tab` && t.controller === i.controller;
    });
    return t.length > 0 ? pA(ia({ ...e, droppableContainers: t }), e) : [r];
  }
  return pA(ia(e), e);
}
function pA(e, t) {
  return e.map((e) => {
    let n = dA(e.data?.droppableContainer.data.current),
    ...
    return n?.kind !== `app-shell-tab` || r == null
      ...
      : {
          ...
          data: {
            ...e.data,
            appShellTabInsertionPlacement: oD(t.pointerCoordinates?.x ?? null, r.left, r.width),
          },
        };
  });
}
...
var hA,
  ...
  bA = e(() => {});
function xA({ bottomPanelSlot: e, children: t, leftPanelSlot: n, rightPanelSlot: r }) {
  let i = Le(Me),
    a = Le(Rt),
    o = (0, AA.useRef)(null),
    [c, l] = (0, AA.useState)(null),
    [u, d] = (0, AA.useState)(!1),
    f = (0, AA.useRef)(n);
  n != null && (f.current = n);
  let p = (n ?? (u ? f.current : void 0))?.children,
    m = p != null,
    h = e != null,
    g = r != null,
    _ = (0, AA.useRef)(!1),
    ...
    D = H(Tt),
    O = H(BA),
    k = b === `thread-edge-scroll`,
    A = m && E,
    j = k && w && !y,
    M = b === `full-bleed`,
    N = `visible`;
  M ? (N = `hidden`) : k ? (N = `full-bleed`) : g && (N = `hidden`);
  let P = ln(fe()),
    ee = gn(P, (e) => `${Math.max(0, e - IA * 2)}px`),
    { isMounted: F, animatedSize: te } = pk({ animation: H(Kt), size: P, isVisible: A }),
    I = ln(window.innerWidth),
    L = ln(window.innerHeight - 46),
    R = ln(ck(L.get())),
    z = H(hn),
    B = gn([R, L], ([e, t]) => sk(e, t)),
    ne = gn([z, B], ([e, t]) => e * t),
    ...
    ie = ln(0),
    ae = ln(0),
    oe = gn([I, te], ([e, t]) => Math.max(0, e - t)),
    {
      rightPanelAnimatedWidth: se,
      rightPanelWidth: ce,
      rightPanelWidthRatio: le,
      widthMode: ue,
    } = rA({ isFullWidth: y, mainContentWidth: oe }),
    de = gn([I, le], ([e, t]) =>
      Dt({
        isRightPanelOpen: g,
        mainContentWidth: e,
    ...
    he = A ? me : de,
    ge = (0, AA.useRef)(ne.get()),
    _e = (0, AA.useRef)(new Set()),
    ve = {
      "--spacing-token-safe-header-left": `${S.left / x}px`,
      "--spacing-token-safe-header-right": `${S.right / x}px`,
      width: `calc(100vw / var(--codex-window-zoom))`,
      height: `calc(100vh / var(--codex-window-zoom))`,
      zoom: `var(--codex-window-zoom)`,
      "--app-shell-bottom-panel-height": V,
    },
    be = (0, AA.useMemo)(
      () => ({
        headerLeftWidth: ie,
        ...
        mainContentTargetWidth: he,
        mainContentWidth: oe,
        shellWidth: I,
        rightPanelAnimatedWidth: se,
        rightPanelLayoutTick: re,
      }),
      [ie, ae, te, P, he, oe, se, re, I],
    ),
    Se = m,
    Ce = (0, AA.useCallback)(
      (e) => (
    ...
    we = Ut(({ width: e }) => {
      ...
      (!r && !a) ||
        ...
        (v.current = n),
        ((r && A && g && t) || (a && n)) &&
          (i.get(ye) === `right-panel` && yn(i, `main`),
          i.get(yt) && i.set(yt, !1),
          i.get(gt) && pe(i, !1)),
        a && n && i.get(wt) && s(i, !1));
    }),
    ...
    De = Je((e, t) => {
      let { height: n } = Ye(e);
      (L.set(n), i.set(oO, rO(t)));
    }),
    Oe = (0, AA.useCallback)(
      (e) => {
        (l(e), De(e), e ?? i.set(oO, null));
      },
      [De, i],
    );
  return (
    jt(ne, `change`, (e) => {
      let t = e - ge.current;
      if (((ge.current = e), t !== 0)) for (let e of _e.current) e(t);
    }),
    (0, $.jsx)(Xk.Provider, {
      value: o,
      children: (0, $.jsx)(Zk.Provider, {
        value: c,
        children: (0, $.jsx)(Ck.Provider, {
          value: Ce,
          children: (0, $.jsxs)(Gt.Provider, {
            value: be,
            children: [
              (0, $.jsx)(Tk, {}),
              (0, $.jsxs)(tt.div, {
                ...
                onBlurCapture: (e) => {
                  (e.relatedTarget instanceof Node && e.currentTarget.contains(e.relatedTarget)) ||
                    (e.relatedTarget != null && yn(i, TA(e.relatedTarget)), xt(i, !1));
                },
                onFocusCapture: (e) => {
                  (yn(i, TA(e.target)), xt(i, EA(e.target)));
                },
                        ...
                        children:
                          ...
                          (0, $.jsx)(
                            Kk,
                            {
                              isResizing: u,
                              onResizingChange: d,
                              paddingTop: C ? `0px` : `var(--height-toolbar)`,
                              children: p,
                            },
                        ...
                        children: (0, $.jsxs)(cA, {
                          children: [
                            ...
                            (0, $.jsxs)(`div`, {
                              ...
                              children: [
                                (0, $.jsx)(`div`, {
                                  "data-app-shell-main-content-layout": b,
                                  ref: Ee,
                                  className: U(
                                    `app-shell-main-content-viewport relative flex min-h-0 min-w-0 flex-col`,
                                    y ? `w-0 flex-none overflow-hidden` : `flex-1`,
                                  ),
                                  children: (0, $.jsx)(`div`, {
                                    className: U(
                                    ...
                                    children: (0, $.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, $.jsx)(`div`, {
                                          "aria-hidden": !0,
                                          "data-app-shell-main-content-top-fade": N,
...
function SA(e) {
  let t = (0, kA.c)(15),
    ...
    f = i || u,
    p;
  t[0] === s ? (p = t[1]) : ((p = s ? { duration: 0 } : rn), (t[0] = s), (t[1] = p));
  let m = p,
    h;
  t[2] !== n ||
  t[3] !== r ||
              ...
              (0, $.jsxs)(`aside`, {
                ...
                children: [
                  (0, $.jsx)(tt.div, {
                    ...
                    children: (0, $.jsx)(VO, { hideUnreadBadge: !0, onToggleSidebar: c }),
                  }),
                  (0, $.jsx)(`div`, { className: `min-h-0 flex-1 overflow-hidden`, children: a }),
                ],
              }),
              (0, $.jsx)(CO, {
                defaultSize: 300,
  ...
  return (
    t[13] === h
      ? (g = t[14])
      : ((g = (0, $.jsx)(pn, { initial: !1, children: h })), (t[13] = h), (t[14] = g)),
    g
  );
}
function CA(e) {
...
function wA() {
  ...
  return (
    e[3] === n
      ? (a = e[4])
      : ((a = n == null ? null : (0, $.jsx)($.Fragment, { children: n })), (e[3] = n), (e[4] = a)),
    a
  );
}
function TA(e) {
  if (!(e instanceof HTMLElement)) return `main`;
  let t = e.closest(`[${ce}]`)?.getAttribute(ce);
...
function DA() {
  ...
  return Number.isFinite(e) ? jA * e : jA * MA;
}
function OA() {
  let e = (0, kA.c)(1),
    t;
...
var kA,
  ...
  VA = e(() => {
    ((kA = pt()),
      ...
      (LA = w(C, ({ get: e }) => {
        let t = e(xO.px$);
        return t == null ? null : kn(t, e(p) ?? 1);
      })),
      (RA = w(C, ({ get: e }) => {
        let t = e(LA);
        return t != null && t >= 0 && t <= FA;
      })),
      (zA = w(C, ({ get: e }) => {
        let t = e(LA),
          n = e(Rn) - IA;
            ...
            if (u) {
              ...
              (r === void 0 && ((r = o), (i = s)),
                (a || (n && !d)) &&
                  !c &&
                  !d &&
                  ((n = !1), (r = void 0), (i = void 0), t.set(Ot, !1)),
                e(!1));
              return;
            }
...
function GA(e) {
  ...
  (t[0] !== e || t[1] !== n
    ? ((r = () => {
      ...
      (t[3] = i))
    : ((r = t[2]), (i = t[3])),
    (0, mj.useLayoutEffect)(r, i));
  let a, o;
  return (
    t[4] !== e.id || t[5] !== n
      ? ((a = () => (
          n.set(Ue.ids$, (t) => (t.includes(e.id) ? t : [...t, e.id])),
          () => {
            (n.set(Ue.ids$, (t) => t.filter((t) => t !== e.id)), n.set(Ue.byId, e.id, null));
          }
        )),
        (o = [e.id, n]),
        (t[4] = e.id),
...
function YA(e) {
  let t = (0, pj.c)(9),
    ...
    s;
  t[0] !== o || t[1] !== i
    ? ((s = i ?? Ln(o.value.routeTemplate)), (t[0] = o), (t[1] = i), (t[2] = s))
    : (s = t[2]);
  let c = s;
  aj(o, Xt, n);
  let l, u;
  return (
    t[3] !== a || t[4] !== c || t[5] !== o || t[6] !== i
      ? ((l = () => {
          if (!(a === 600 && i == null))
            return (
              o.set(Vt, { defaultWidth: a, storageKey: c }),
              () => {
                o.set(Vt, null);
              }
            );
        ...
        (t[8] = u))
      : ((l = t[7]), (u = t[8])),
    (0, mj.useLayoutEffect)(l, u),
    null
  );
}
function XA(e) {
  let { children: t } = e;
  return (aj(Le(Me), Mt, t), null);
}
function ZA(e) {
  let { children: t } = e;
  return (aj(Le(Me), en, t), null);
}
function QA(e) {
  let { children: t } = e;
  return (aj(Le(Me), nt, t), null);
}
function $A() {
  return null;
}
...
function tj(e) {
  let { children: t } = e;
  return (aj(Le(Me), j, t), null);
}
function nj(e) {
  let { children: t } = e;
  return (aj(Le(Me), Oe, t), null);
}
function rj(e) {
  let { children: t } = e;
  return (aj(Le(Me), Pe, t), null);
}
function ij(e) {
  let { children: t } = e;
  return (aj(Le(Me), P, t), null);
}
function aj(e, t, n) {
  let r = (0, pj.c)(9),
    i,
...
function oj(e) {
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, hj.jsx)(mj.Suspense, { fallback: r, children: n })), (t[1] = n), (t[2] = i)),
    i
  );
}
function sj(e) {
...
function cj(e) {
  let t = (0, pj.c)(7),
    { children: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = lj(n)), (t[0] = n), (t[1] = r));
...
function lj(e) {
  ...
  return (
    mj.Children.forEach(e, (e, a) => {
      ...
      (0, mj.isValidElement)(e) ? t.push({ ...e, key: e.key ?? `${a}` }) : t.push(e);
    }),
    { bottomPanelSlot: n, contentChildren: t, leftPanelSlot: r, rightPanelSlot: i }
  );
}
function uj(e) {
  return (0, mj.isValidElement)(e) && e.type === HA;
}
function dj(e) {
  return (0, mj.isValidElement)(e) && e.type === KA;
}
function fj(e) {
  return (0, mj.isValidElement)(e) && e.type === $A;
}
var pj,
  mj,
  hj,
  gj = e(() => {
    ((pj = pt()), k(), (mj = t(zt(), 1)), fn(), L(), GD(), nO(), g(), VA(), i(), (hj = _n()));
  }),
  _j,
  vj,
  yj = e(() => {
    ((_j = t(zt(), 1)),
      ...
      (vj = {
        Root: (0, _j.memo)(cj),
        LeftPanel: HA,
        Content: (0, _j.memo)(oj),
        Header: (0, _j.memo)(UA),
        HeaderAction: (0, _j.memo)(WA),
        HeaderContextMenuItem: (0, _j.memo)(GA),
        MainContentLayout: (0, _j.memo)(sj),
        BottomPanel: $A,
        BottomPanelTabs: (0, _j.memo)(ej),
        BottomPanelTabsEmptyState: (0, _j.memo)(tj),
        BottomPanelTabListAfter: (0, _j.memo)(nj),
        BottomPanelTabListAfterSticky: (0, _j.memo)(rj),
        BottomPanelOutlet: (0, _j.memo)(ij),
        RightPanel: KA,
        RightPanelTabs: (0, _j.memo)(qA),
        RightPanelTabsEmptyState: (0, _j.memo)(JA),
        RightPanelTabListAfter: (0, _j.memo)(XA),
        RightPanelTabListAfterSticky: (0, _j.memo)(QA),
        RightPanelTabListBefore: (0, _j.memo)(ZA),
        RightPanelOutlet: (0, _j.memo)(YA),
      }));
  });
export {
  iE as $,
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~appgen-settings-page~page~appgen-page~remote-con~lblzrcac.js.map
