...
import { t as Ye, v as Xe } from "./lib.js";
...
import { r as St } from "./product-logger.js";
import { t as Ct } from "./rpc.js";
import { _ as wt, i as Tt, m as Et, n as Dt, r as Ot } from "./statsig.js";
import { o as kt, s as At, t as jt } from "./request.js";
function Mt(e) {
  return e;
}
var Nt = e(Je(), 1),
        ...
        ((i = new Promise((a, o) => {
          let s = t,
            ...
            u = () => {
              try {
                let t = n();
                Lt(t) ? (Bt.set(t, i), (s = t), t.then(c(t), l(t)), r(e, t, u)) : a(t);
              } catch (e) {
                o(e);
              }
            };
...
async function Jt(e, t) {
  return Yt((await e.sendRequest(`config/read`, { includeLayers: !1, cwd: t ?? null })).config);
}
function Yt(e) {
  let t = Xt(e.profiles),
...
function tn(e) {
  return e ? rn(e) || Array.isArray(e) || !!e[Qt] || !!e.constructor?.[Qt] || dn(e) || fn(e) : !1;
}
  ...
  return (
    e !== void 0 && e !== n
      ? (n[U].modified_ && (Tn(t), W(4)),
        ...
        t.patches_ &&
          yn(`Patches`).generateReplacementPatches_(n[U].base_, e, t.patches_, t.inversePatches_))
      : (e = An(t, n, [])),
    Tn(t),
...
function An(e, t, n) {
  ...
  if (!r.finalized_) {
    ...
    (r.type_ === 3 && ((i = new Set(t)), t.clear(), (a = !0)),
      ...
      Mn(e, t, !1),
      n && e.patches_ && yn(`Patches`).generatePatches_(r, n, e.patches_, e.inversePatches_));
  }
  return r.copy_;
}
function jn(e, t, n, r, i, a, o) {
  if (en(i)) {
    let o = An(e, i, a && t && t.type_ !== 3 && !sn(t.assigned_, r) ? a.concat(r) : void 0);
  ...
  constructor(e) {
    ((this.autoFreeze_ = !0),
      ...
      (this.produce = (e, t, n) => {
        ...
        (typeof t != `function` && W(6), n !== void 0 && typeof n != `function` && W(7));
        let r;
        if (tn(e)) {
          let i = Dn(this),
            a = Hn(e, void 0),
...
function Hn(e, t) {
  let n = dn(e) ? yn(`MapSet`).proxyMap_(e, t) : fn(e) ? yn(`MapSet`).proxySet_(e, t) : Nn(e, t);
...
function Gn() {
      ...
      r.forEach((r) => {
        ...
        for (let e = 0; e < i.length - 1; e++) {
          ...
          (typeof n != `string` && typeof n != `number` && (n = `` + n),
            (t === 0 || t === 1) && (n === `__proto__` || n === `constructor`) && W(19),
  ...
  function c(e) {
    ...
    if (dn(e)) return new Map(Array.from(e.entries()).map(([e, t]) => [e, c(t)]));
  ...
  bn(`Patches`, { applyPatches_: s, generatePatches_: n, generateReplacementPatches_: o });
}
var Kn = new Vn(),
  qn = Kn.produce,
...
function kr() {
  ...
  let r;
  return (e[2] === n ? (r = e[3]) : ((r = { serviceTier: n }), (e[2] = n), (e[3] = r)), r);
}
function Ar() {
  let e = (0, Er.c)(2),
    t = rt(B),
  ...
  return (
    e[0] === t
      ? (n = e[1])
      : ((n = (e) => pt(t, _e.defaultServiceTier, i(e))), (e[0] = t), (e[1] = n)),
    n
  );
}
function jr() {
...
var Nr = class {
  ...
  refreshRecentConversations({ sortKey: e } = {}) {
    return Kt(`refresh-recent-conversations-for-host`, { hostId: this.hostId, sortKey: e });
  }
  ...
  startWindowsSandboxSetup(e, t) {
    return Kt(`start-windows-sandbox-setup-for-host`, { hostId: this.hostId, mode: e, cwd: t });
  }
  async getAccount() {
    return this.sendRequest(`account/read`, { refreshToken: !1 });
  }
  unsubscribeInactiveConversation(e) {
    return Kt(`unsubscribe-thread-for-host`, { hostId: this.hostId, threadId: e });
  }
...
var Fr = (function (e) {
  ...
  _i = { $type: `protobuf_analytics_events.v1.CodexRemoteControlConnectionsRefreshed` },
  ...
  Ti = { $type: `protobuf_analytics_events.v1.CodexSidebarUsageAlertDismissed` },
  Ei = { $type: `protobuf_analytics_events.v1.CodexSidebarUsageAlertCtaClicked` },
  Di = { $type: `protobuf_analytics_events.v1.CodexOnboardingStepViewed` },
  Oi = { $type: `protobuf_analytics_events.v1.CodexOnboardingLoginMethodSelected` },
  ...
  ji = { $type: `protobuf_analytics_events.v1.CodexProfilePageEntrypointClicked` },
  Mi = { $type: `protobuf_analytics_events.v1.CodexProfilePageViewed` },
  Ni = { $type: `protobuf_analytics_events.v1.CodexProfileEditEvent` },
  Pi = { $type: `protobuf_analytics_events.v1.CodexProfileInlinePhotoChangeEvent` },
  ...
  Vi = { $type: `protobuf_analytics_events.v1.CodexUpgradePlanModalCtaClicked` },
...
function ia(e, { connection: t, connectionState: n, connectionError: r, errorCategory: i, ...a }) {
  if (e == null) return;
...
function aa(e, { error: t, hostId: n, previousError: r, previousState: i, state: a }) {
  if (
    !ra.has(a) ||
...
function Zo(e) {
  return e.length <= Jo ? e : `${e.slice(0, Jo)}\n… truncated ${e.length - Jo} chars`;
}
var Qo = 100,
  $o = new (class {
...
function ss(e) {
  ...
  return (
    t[0] !== e || t[1] !== r || t[2] !== n
      ? ((a = ls(e, [...(n ?? []), ...(r ?? [])])), (t[0] = e), (t[1] = r), (t[2] = n), (t[3] = a))
      : (a = t[3]),
    a
  );
}
...
function us(e, t) {
  t.addTurnCompletedListener((t) => {
    let n = Zi(e.get, `remote_connections`)?.find((e) => e.hostId === t.hostId) ?? null,
...
function Xs(e) {
  return e == null ? null : (Zs(e.agentNickname) ?? Zs(q(e.source)?.agentNickname));
}
function Zs(e) {
...
function ec(e) {
  let t = e.trim();
  return t.length === 0 ? null : Ke(t) ? Ge(M(t)) : Qs.test(t) ? t : `data:image/png;base64,${t}`;
}
var tc = new Map();
function nc(e, t) {
  let n = t.trim();
...
function oc(e) {
  return e.item.type === `imageGeneration`
    ...
    : e.item.type === `collabAgentToolCall`
      ? (e.onCollabAgentToolCall?.(e.item), ac({ item: e.item, threadsById: e.threadsById }))
      : e.item;
}
function sc(e) {
  let t = Xs(e);
          ...
          for (let n of t.turns)
            for (let t of n.items) {
              if (t.type !== `collabAgentToolCall` || !t.receiverThreadIds.includes(e.threadId))
                continue;
              let n = ic({ receiverThreadIds: t.receiverThreadIds, threadsById: e.threadsById });
              (0, qi.default)(t.receiverThreads, n) || (t.receiverThreads = G(n));
            }
        },
        !1,
      );
...
function Dc(e) {
  return J(e).replace(/\/+$/, ``).split(`/`).filter(Boolean).slice(-2).join(`/`);
}
...
var Fc = 16e3,
  ...
  Rc = class {
    ...
    runHeadlessAction(e, t) {
      (this.updateSnapshotMetadata(e, { cwd: t.cwd, title: zc(t.command), rawShellTitle: null }),
        this.sendOrQueueSessionAction(e, {
          type: `terminal-run-action`,
          cwd: t.cwd,
          command: t.command,
    ...
    appendSnapshotBuffer(e, t) {
      let n = this.getOrCreateSnapshot(e),
        r = `${n.buffer}${t}`;
      (this.sessionSnapshots.set(e, { ...n, buffer: r.slice(-Fc), truncated: r.length > Fc }),
        this.notifySessionSnapshotListeners(e));
    }
    replaceSnapshotBuffer(e, t) {
      let n = this.getOrCreateSnapshot(e);
      (this.sessionSnapshots.set(e, { ...n, buffer: t.slice(-Fc), truncated: t.length > Fc }),
        this.notifySessionSnapshotListeners(e));
    }
...
async function Kc(e, t) {
  ...
  try {
    return Gc((await mt(`thread-terminal-snapshot`, { params: { threadId: t } })).session);
  } catch (e) {
    return (
...
var el = l([`session`, `always`]),
  ...
  ol = f(`codex_approval_kind`, [
    f(`tool_type`, [
      ...
      g({ ...al, tool_type: A(`plugin`), install_url: P().optional() }).passthrough(),
    ]),
    g({
...
function yl(e) {
  let t = [`app="${Cl(e.appName)}"`, `bundle-identifier="${Cl(e.bundleIdentifier)}"`],
...
function Dl(e) {
  ...
  return n == null || r == null
    ? null
    : { automationId: kl(t, `automation_id`), currentTimeIso: n, instructions: r };
}
function Ol(e) {
  return Dl(
...
function su(e) {
  return au(
    e.flatMap((e) => {
      ...
      let t = J(e.localPath);
      return [{ label: e.filename ?? Ec(t) ?? e.localPath, path: t, fsPath: t }];
    }),
  );
}
function cu({ attachments: e, input: t }) {
  let n = new Set(t.filter((e) => e.type === `localImage`).map((e) => wc(e.path)));
...
function gd(e, { hasBrowserContext: t }) {
  ...
  return [
    ...
    ...(t
      ? []
      : [`Target: ${jl(n.targetLabel)}`, `Selector: ${n.selector ?? `(no stable selector)`}`]),
    ...(r == null ? [] : [r]),
    ...(i == null ? [] : [i]),
    td,
    ...a,
  ...
  switch (t.type) {
    case `presentation-element-selection`: {
      ...
      if (t.primaryElementId != null) {
        let n = t.primaryElementName == null ? `` : ` ${jl(t.primaryElementName)}`;
    ...
    case `workbook-range`: {
      ...
      return (t.anchorPoint != null && e.push(`anchor point: ${xd(t.anchorPoint)}`), e.join(`; `));
    }
    case `workbook-floating-element`: {
      ...
      return (
        t.anchorPoint != null && e.push(`anchor point: ${xd(t.anchorPoint)}`),
        t.elementOffset != null && e.push(`element offset: ${xd(t.elementOffset)}`),
        e.join(`; `)
      );
    }
...
function Od({ comment: e, promptNumber: t }) {
  ...
  (e.localBrowserDesignChange != null &&
    ...
    e.localBrowserScreenshot != null &&
      (c += e.localBrowserCommentMetadata?.kind === `element` ? `${cd(t)}\n` : `${ld(t)}\n`),
...
`;
  return (
    ...
    t.documentTitle != null && (n += `Document title: ${jl(t.documentTitle)}\n`),
...
function Pd(e) {
  ...
  let n = Vd(t, `input`);
  return n == null ? null : { input: n, transcriptDelta: Vd(t, `transcript_delta`) };
}
function Fd(e) {
  return Pd(
    e.flatMap((e) => (e.type === `text` ? [e.text] : [])).join(`
...
function lf(e) {
  if (e.attachedPdfAnnotation === !0) return { type: `selected-pdf-annotation` };
...
function vf(e) {
  let t = If(e),
    ...
    c = s?.type === `workbook-range` ? `${s.sheetName}!${s.rangeAddress}` : null,
    l = xf(e);
  return {
    origin: t,
...
function yf(e) {
  return Au(e) ? (bf(...Il(e), Ll(e)) ?? df(e.localBrowserContext?.targetRole)) : null;
}
function bf(...e) {
  for (let t of e) {
    let e = df(t);
...
`),
  ...
  for (let e = 0; e < s.length; e += 1)
    s[e].startsWith(`## Selection `) && (l != null && c.push(Tf(s.slice(l, e))), (l = e));
...
function If(e) {
  return k(e) ? `artifact_annotation` : Au(e) ? `browser` : te(e) ? `pdf` : `diff`;
}
function Lf({
  input: e,
  attachments: t = [],
...
`),
  ...
  let d = l.trim(),
    ...
    A = k;
  return (
    f ? (A = f.instructions) : p ? (A = p.input) : m ? (A = m.input) : ee != null && (A = ee),
    h.length > 0 && (A = xl(A)),
    {
...
function Xf(e) {
  ...
  for (let [n, r] of e.conversations) q(r.source)?.parentThreadId === e.conversationId && t.add(n);
  for (let [n, r] of e.threadsById) q(r.source)?.parentThreadId === e.conversationId && t.add(I(n));
  return Array.from(t);
}
function Zf(e) {
  let t = [],
...
async function cp(e, t) {
  let n = Zf({ conversationId: t, conversations: e.conversations, threadsById: e.threadsById });
  await Promise.all(
    n.map(async (n) => {
      try {
...
var mp = lt(B, `get-global-state`, (e) => ({ params: { key: e }, staleTime: at.FIVE_SECONDS })),
  hp = R(B, (e, { get: t }) => {
    let n = t(mp, e);
    return { ...n, data: yp(e, n.data?.value) };
  });
async function gp(e, t, n) {
  let r = e.query.snapshot(mp, t);
  await r.cancel();
  let i = r.getData();
  r.setData({ value: n });
  try {
...
function Op(e) {
  switch (Ep(e?.id ?? null, e?.name)) {
    case `fast`:
      return Tp.fastLabel;
    case `ultrafast`:
      return Tp.ultrafastLabel;
    case null:
      return e?.name ?? Tp.standardLabel;
  }
}
function kp(e) {
  switch (Ep(e?.id ?? null, e?.name)) {
    case `fast`:
      return e?.description ?? Tp.fastDescription;
    case `ultrafast`:
      return e?.description ?? Tp.ultrafastDescription;
    case null:
      return e?.description ?? Tp.standardDescription;
  }
}
function Ap(e, t) {
  return t == null
...
function jp(e) {
  return [
    {
      description: Tp.standardDescription,
      iconKind: null,
      label: Tp.standardLabel,
      tier: null,
      value: null,
    },
    ...(e?.serviceTiers ?? []).map((e) => ({
      description: kp(e),
      iconKind: Ep(e.id, e.name),
      label: Op(e),
      tier: e,
      value: e.id,
    })),
...
function Mp(e) {
  return (
    e?.serviceTiers?.find(
      (e) => Ep(e.id, e.name) === `fast` || e.name.trim().toLowerCase() === `priority`,
    ) ?? null
  );
}
function Np(e, t) {
...
function Rp(e, t, n, r, i) {
  ...
  if (!a) return;
  if (a.method !== r) {
    z.error(`Unexpected approval request method`, { safe: { method: a.method }, sensitive: {} });
    return;
  }
  let o;
  switch (r) {
  ...
  (z.info(`Sending server response`, {
    ...
    e.dispatchMessageFromView(`mcp-response`, { hostId: e.hostId, response: o }),
    e.dispatchMessageFromView(`desktop-notification-hide`, { notificationId: `approval-${n}` }),
...
function Vp(e, t, n, r) {
  let i = Ip(e, t);
  if (i) {
    Lp(e, i, `thread-follower-permissions-request-approval-response`, {
      conversationId: t,
      requestId: n,
      response: r,
    }).catch((e) => {
...
async function jm(
  ...
  let d = Om(l?.turns)?.params,
    f = await Gm(e, t),
    p = l?.workspaceKind === `projectless` ? fm(d?.sandboxPolicy) : null,
    m = Um(l, a[0]),
    h = dm({
      cwd: l?.cwd,
      fallbackCwd: p ?? m,
  ...
  try {
    ...
    if (m != null) {
      ((h = dm({
        cwd:
          Sm({ requestedCwd: h, responseCwd: null, threadCwd: m.thread.cwd, fallbackCwd: g[0] }) ??
          h,
        fallbackCwd: p ?? Um(l, g[0]),
        workspaceBrowserRoot: l?.workspaceBrowserRoot,
        workspaceKind: l?.workspaceKind,
      })),
        (g = Hm(h, a, l?.workspaceKind)));
        ...
        e.useTailHydration() &&
          ...
          (x = async () => {
            let r = await e
                ...
                .catch(
                  (e) => (
                    z.warning(`Failed to read paged thread history before resume`, {
                      safe: { conversationId: t },
                      sensitive: { error: e },
                    }),
                    null
              ...
              a =
                r == null
                  ? await e
                      ...
                      .catch(
                        (e) => (
                          z.warning(`Failed to read legacy thread history before resume`, {
                            safe: { conversationId: t },
                            sensitive: { error: e },
                          }),
                          null
              ...
              o =
                r == null
                  ...
                  : im({
                      ...
                      reasoningEffort: i ?? l?.latestReasoningEffort ?? null,
                      cwd: h ?? `/`,
                      permissions: l?.currentPermissions ?? D(g),
                    }),
              c = Pm(e.getConversation(t)?.turns ?? u, o);
            return (
              e.updateConversationState(t, (e) => {
                ((e.turns = c.map(G)),
                  (e.turnsPagination =
    ...
    let S = Wm({
      ...
      T = o ?? {
        approvalPolicy:
          d?.approvalPolicy ?? l?.currentPermissions?.approvalPolicy ?? C.approvalPolicy,
        approvalsReviewer: w,
        sandboxPolicy: d?.sandboxPolicy ?? l?.currentPermissions?.sandboxPolicy ?? C.sandboxPolicy,
      },
      E = ym(T.sandboxPolicy, f),
      O = { ...T, sandboxPolicy: pm({ sandboxPolicy: E, workspaceKind: l?.workspaceKind }) },
      k = o != null || l?.workspaceKind === `projectless` || bm(T.sandboxPolicy, f),
      ee = k && (o?.approvalsReviewer != null || d?.approvalsReviewer != null),
      A = n ?? l?.latestCollaborationMode.settings.model ?? s?.settings.model ?? null,
      j = await e.buildNewConversationParams(
        A,
        r === void 0 ? e.getEffectiveServiceTier(await e.getDefaultServiceTier()) : r,
        g[0] ?? `/`,
        O,
        O.approvalsReviewer,
      ...
      te = e.sendRequest(`thread/resume`, {
        ...
        config: j.config,
        ...(j.baseInstructions == null ? {} : { baseInstructions: j.baseInstructions }),
    ...
    u = y == null ? u : await y;
    let ie = M.thread.cwd,
      ae = Sm({ requestedCwd: h, responseCwd: re ?? null, threadCwd: ie, fallbackCwd: g[0] }),
      oe = M.thread.gitInfo,
      se = M.thread.name?.trim() ?? ``;
    sc(M.thread);
    let ce = v ? [] : nm(M, { fallbackCwd: ae ?? null }),
      le = Pm(e.getConversation(t)?.turns ?? u, ce),
      ue =
        ce.length > 0
          ? le
          : le.map((e) => ({
    ...
    e.updateConversationState(t, (e) => {
      ((e.turns = ue.map(G)),
        (e.latestModel = mm(M.model) ?? e.latestModel),
        (e.rolloutPath = M.thread.path ?? e.rolloutPath),
        (e.latestReasoningEffort = i ?? M.reasoningEffort ?? e.latestReasoningEffort),
        (e.resumeState = `resumed`),
        ne.ok &&
          ((e.threadGoal = ne.goal),
          (e.threadGoalResumeConfirmation =
            c === !0 && ne.goal != null && bp(ne.goal.status) ? ne.goal : null)),
        (e.threadRuntimeStatus = M.thread.status),
        (e.cwd = ae),
        (e.currentPermissions = fp(M)),
        (e.source = M.thread.source),
        (e.forkedFromId = M.thread.forkedFromId == null ? null : I(M.thread.forkedFromId)),
...
function Im(e) {
  for (let t of e) if (t.type === `userMessage` && Bm(t.content) != null) return t;
  return null;
}
function Lm(e) {
  return e.status !== `completed` ||
    e.error != null ||
    Bm(e.params.input) != null ||
    Im(e.items) != null
    ? !1
    : e.items.some((e) => e.type === `agentMessage` && $c(e.text) != null);
}
function Rm(e, t) {
  return Im(e) == null ? [t, ...e] : e;
}
function zm(e, t) {
  return Bm(t.params.input) != null || Bm(e.params.input) == null
    ? t.params
...
function qm(e, t) {
  let n = Km.get(e);
  return (n ?? ((n = new Xm(e)), Km.set(e, n)), n.loadRemainingConversationTurns(t));
}
function Jm() {
      ...
      try {
        let n = await this.client.listThreadTurns(e, { cursor: r, limit: 5 }),
          ...
          c = im({
            ...
            permissions: {
              approvalPolicy:
                a?.approvalPolicy ?? t.currentPermissions?.approvalPolicy ?? s.approvalPolicy,
              approvalsReviewer:
                a?.approvalsReviewer ??
                t.currentPermissions?.approvalsReviewer ??
                s.approvalsReviewer,
              sandboxPolicy:
                a?.sandboxPolicy ?? t.currentPermissions?.sandboxPolicy ?? s.sandboxPolicy,
            },
          }),
          l = this.client.getConversation(e);
        if (l == null) return;
        let u = i == null ? -1 : l.turns.findIndex((e) => e.turnId === i),
          d = u === -1 ? Pm(c, l.turns) : Pm(Pm(l.turns.slice(0, u), c), l.turns.slice(u));
        this.client.updateConversationState(e, (e) => {
...
function Zm(e, t) {
  return {
    ...e,
    hostId: e.hostId ?? t,
    turnsPagination: e.turnsPagination ?? Jm(),
...
var nh = class {
    ...
    setConversationStreamRole(e, t) {
      $n(this.getStreamRole(e), t) || (this.streamRoles.set(e, t), this.notifyStreamRoleChanged(e));
    }
    removeConversation(e) {
      (this.streamingConversations.delete(e), this.deleteConversationStreamRole(e));
    }
    ...
    handleThreadStreamStateChanged(e, t, n) {
      if (!(this.getStreamRole(e)?.role === `owner` && t.type !== `snapshot`)) {
        if (t.type === `snapshot`) {
          let r = Qm(t.conversationState, this.params.hostId);
  ...
  ah = e(u(), 1),
  oh = x({ tabId: oe().int().nonnegative() }),
  sh = x({
    contentType: P().nullable(),
    documentData: x({ contentType: P().nullable(), dataBase64: P() }).nullable().optional(),
  ...
  dh = `\\.(?:7z|aiff?|avif|bmp|bz2|dmg|docx?|eot|epub|exe|gif|gz|heic|heif|ico|iso|jpe?g|m4a|m4v|mov|mp3|mp4|odp|ods|odt|ogg|ogv|otf|parquet|pdf|pkg|png|pptx?|rar|sqlite|svg|tar|tiff?|ttf|wasm|wav|webm|webp|woff2?|xlsx?|zip)$`,
  fh = new RegExp(dh, `i`),
  ph = 100 * 1024 * 1024,
  mh = `Chrome tab document is too large.`,
  hh = {
  ...
  gh = {
    knownNonTextFileExtensionPatternSource: dh,
    maxDocumentBytes: ph,
    mediaMimeTypePrefixes: lh,
    textLikeMimeTypes: uh,
  };
async function _h(e, t = {}) {
  let n = oh.safeParse(e);
  if (!n.success) return Y(`${rh} requires a numeric tabId argument.`);
  let r = vh();
  ...
  let { tabId: i } = n.data,
    ...
    s = null;
  try {
    o = await Ah(r.scripting, i);
  } catch (e) {
    s = e;
  }
  if (o != null) {
    let e = zh(o.contentType, o.url, a?.url);
    if (e != null)
      return o.documentTooLarge === !0
        ...
        : jh({
            ...
            fetchDocument: t.fetchDocument ?? Nh,
...
`),
  ...
  let c = zh(null, null, a?.url);
  return c == null
    ? Y(s instanceof Error ? s.message : `Unable to read page text from Chrome tab ${i}.`)
    : jh({
        contentType: null,
        cwd: t.cwd,
        documentData: null,
...
async function yh(e, t) {
  ...
  try {
    let n = ch.safeParse(await e.tabs.get(t));
...
function bh(e) {
  ...
  if (t == null) return [];
  let n = xh(t.docType),
    r = { exportUrl: Ch(t, n), format: n };
  return n === `pdf` ? [r] : [r, { exportUrl: Ch(t, `pdf`), format: `pdf` }];
}
function xh(e) {
  switch (e) {
    case `document`:
...
async function wh({
  ...
  try {
    let t = await Th({ exportUrl: c.exportUrl, scripting: r, tabId: a }),
      i = Oh({ cwd: e, format: c.format, title: o });
    return (await s({ dataBase64: Eh({ base64: t, format: c.format }), path: i }), n?.(i), i);
  } catch {
    return wh({
      cwd: e,
      exportIndex: t + 1,
...
function Eh({ base64: e, format: t }) {
  if (t !== `md`) return e;
  let n = new TextDecoder().decode(Kh(e));
  return qh(new TextEncoder().encode(Dh(n)));
}
function Dh(e) {
  return e.replace(/^\s*\[[^\]]+\]:\s*<data:[^>]+>\s*\n?/gm, ``).trim();
}
function Oh({ cwd: e, format: t, title: n }) {
  return Gh(e, `${Wh(kh(n))}-${crypto.randomUUID()}.${t}`);
}
function kh(e) {
  let t = e.split(` - `),
    n = t.at(-1);
...
async function jh({
  ...
  if (t == null || c == null)
    return Y(`The Chrome tab is a non-text document, but the current thread cwd is unavailable.`);
  try {
    let l = n ?? (await r(s)),
      u = Gh(
        t,
        `chrome-tab-${o}-${globalThis.crypto.randomUUID()}${Ih(l.contentType ?? e, s) ?? i}`,
      );
    return (
    ...
    return e instanceof Error && e.message === mh
      ? Mh()
      : Y(`Unable to save the Chrome tab document.`);
  }
}
function Mh() {
  return Y(`The Chrome tab document is larger than ${Yh(ph)}, so I did not save it.`);
}
async function Nh(e) {
  let t = await fetch(e, { credentials: `include` });
  if (!t.ok) throw Error(`Unable to fetch Chrome tab document.`);
  return { contentType: t.headers.get(`content-type`), dataBase64: await Ph(t, ph) };
}
async function Ph(e, t) {
  let n = Number(e.headers.get(`content-length`) ?? NaN);
  if (Number.isFinite(n) && n > t) throw Error(mh);
  let r = e.body?.getReader();
  if (r == null) {
    let n = await e.blob();
    if (n.size > t) throw Error(mh);
    return Fh(n);
  }
  let i = [],
    a = 0;
  for (;;) {
    ...
    if (e) break;
    if (n != null) {
      if (((a += n.byteLength), a > t)) throw (await r.cancel(), Error(mh));
      i.push(new Uint8Array(n));
    }
  }
  return Fh(new Blob(i));
}
async function Fh(e) {
...
function Ih(e, t) {
  let n = Bh(e) ?? Vh(t);
  return n != null && !Hh(n) ? Lh(n, t) : Uh(t);
}
function Lh(e, t) {
  return (
    Uh(t) ??
...
function zh(e, t, n) {
  let r = Bh(e) ?? Vh(t);
  if (r != null) return Hh(r) || t == null ? null : { fileExtension: Lh(r, t), url: t };
  let i = Vh(n);
  if (i != null) return Hh(i) || n == null ? null : { fileExtension: Lh(i, n), url: n };
  if (n != null) {
    let e = Uh(n);
...
function Hh(e) {
  return lh.some((t) => e.startsWith(t))
    ? !1
    : e.startsWith(`text/`) || uh.includes(e) || e.endsWith(`+json`) || e.endsWith(`+xml`);
}
function Uh(e) {
  if (e == null) return null;
  try {
...
var Xh = [{ buildResponse: _h, spec: ih }];
new Map(Xh.map((e) => [e.spec.name, e]));
var Zh = {
    generateMemories: !0,
    useMemories: !0,
  ...
  eg = g({
    ...
    no_memories_if_mcp_or_web_search: O()
      .optional()
      .catch(void 0),
    max_raw_memories_for_consolidation: $h.optional().catch(void 0),
    max_unused_days: $h.optional().catch(void 0),
    max_rollout_age_days: $h.optional().catch(void 0),
    max_rollouts_per_startup: $h.optional().catch(void 0),
    min_rollout_idle_hours: $h.optional().catch(void 0),
    extract_model: P()
      .nullable()
      .optional()
      .catch(void 0),
...
function ng(e) {
  if (e == null) return Zh;
  let t = eg.safeParse(e.memories);
  if (!t.success) return Zh;
  let n = t.data;
  return {
    generateMemories: n.generate_memories ?? Zh.generateMemories,
    useMemories: n.use_memories ?? Zh.useMemories,
    disableOnExternalContext:
      n.disable_on_external_context ??
      n.no_memories_if_mcp_or_web_search ??
      Zh.disableOnExternalContext,
    maxRawMemoriesForConsolidation:
      n.max_raw_memories_for_consolidation ?? Zh.maxRawMemoriesForConsolidation,
    maxUnusedDays: n.max_unused_days ?? Zh.maxUnusedDays,
    maxRolloutAgeDays: n.max_rollout_age_days ?? Zh.maxRolloutAgeDays,
    maxRolloutsPerStartup: n.max_rollouts_per_startup ?? Zh.maxRolloutsPerStartup,
    minRolloutIdleHours: n.min_rollout_idle_hours ?? Zh.minRolloutIdleHours,
    extractModel: n.extract_model ?? Zh.extractModel,
    consolidationModel: n.consolidation_model ?? Zh.consolidationModel,
  };
}
function rg(e) {
  return e == null
...
function og(e, t) {
  let n = Object.fromEntries(t.map(({ keyPath: e, value: t }) => [Qh[e], t]));
  return Object.assign(structuredClone(e), { memories: sg(e.memories, n) });
}
function sg(e, t) {
  let n = tg.safeParse(e),
    r = n.success ? { ...n.data } : {};
  for (let [e, n] of Object.entries(t)) n == null ? delete r[e] : (r[e] = n);
  return r;
}
var cg = `feature_overrides`,
  lg = `3525926994`,
  ug = `memories`,
  dg = `875176429`,
  fg = `thread_tools`,
  ...
  mg = [
    ...
    { gateName: `2395575782`, featureKey: fg },
    { gateName: `1859936703`, featureKey: pg },
  ],
  hg = [
    {
      name: `3902942138`,
    ...
    { name: `745800994`, param: cg, featureAllowlist: new Set([`collaboration_modes`]) },
  ],
  gg = [
...
function _g(e) {
  let t = yg(e),
    n = bg(e),
    r = { [Sp]: Dt(e, `2380644311`) };
  return { ...t, ...n, [ug]: Dt(e, dg) && Ot(e, lg).groupName === `Test`, ...r };
}
function vg(e) {
...
function yg(e) {
  let t = {};
  for (let n of mg) Dt(e, n.gateName) && (t[n.featureKey] = !0);
  return t;
}
function bg(e) {
  let t = {};
  for (let n of hg) {
    let r = vg(Tt(e, n.name).get(n.param, {}));
...
function xg(e) {
  ...
  Array.isArray(i) && (n.include_only = Tg(i));
  ...
  Array.isArray(s) && (n.exclude = Tg(s));
  let c = e[`shell_environment_policy.set`];
  return (
    typeof c == `object` && c && !Array.isArray(c) && (n.set = wg(c)),
    Object.keys(n).length === 0 ? null : n
  );
}
function Sg(e, t) {
  let n = { ...wg(e.set) },
    r = new Set([...Tg(e.exclude), ...t.exclude]);
...
async function Eg(e, t, n, r) {
  try {
    ...
    let o = xg(i) ?? xg(await Jt(t, r)) ?? { inherit: `all` };
    return {
      ...n,
...
var Dg = 5e3,
  Og = class {
    ...
    async buildNewConversationParams(e, t, n, r, i, a, o, s) {
      ...
      if (
        ((c = ce(c, a)),
        (c = await Eg(this.params.fetchFromHost, this.params.requestClient, c, n)),
        s?.skipDynamicTools ||
    ...
    async startThread({
      ...
      let d = s?.[`features.onboarding_interactive_tools`] === !0 ? { ...l, [uc]: !0 } : l,
      ...
      return this.params.requestClient.sendRequest(`thread/start`, f, { timeoutMs: Jc });
    }
    ...
    prewarmConversation({
      ...
      return (this.params.prewarmedThreadManager.setPrewarmedThreadPromise(e, c), c);
    }
    async prewarmThread({
      model: e,
      serviceTier: t,
    ...
    async createConversation({
      ...
      let p = r === `projectless`,
        ...
        h = p ? (n[0] ?? null) : null,
        g =
          m == null && (l == null || Object.keys(l).length === 0) && !p && ag(s)
      ...
      (this.params.threadStore.ensureRecentConversationId(b),
        z.info(`Conversation created`, { safe: { conversationId: b }, sensitive: {} }));
      let x = Sm({
          requestedCwd: o ?? null,
      ...
      return (
        this.params.threadStore.setConversation({
          id: b,
          forkedFromId: y.thread.forkedFromId == null ? null : I(y.thread.forkedFromId),
          hostId: this.params.hostId,
          turns: [],
          requests: [],
          createdAt: w,
        ...
        p &&
          (this.params.projectlessConversations.saveConversationId(b).catch((e) => {
          ...
          this.params.projectlessConversations.saveOutputDirectoryHint(b, i ?? null)),
        {
          conversationId: b,
...
function Pg({
  ...
  let { createdAt: d, updatedAt: f } = Ng(e);
  return {
    id: n,
...
function Fg(e) {
  let t = q(e.conversations.get(e.conversationId)?.source)?.parentThreadId ?? null;
  if (t == null) return ``;
...
async function Ig(e, { modelProviders: t, archived: n = !1 }) {
  let r = [],
    i = async (a) => {
...
function Lg(e) {
  ...
  return {
    ...
    subagentSpinnerProjectionSignature: Rg(e),
  };
}
function Rg(e) {
  let t = [];
...
function zg({
  ...
  cc({ thread: s, threadsById: c, conversations: t, updateConversationState: u });
  let d = s.name?.trim() ?? ``,
...
var Bg = class {
  ...
  setConversation(e) {
    this.conversations.set(e.id, Zm(e, this.params.hostId));
  }
  ...
  setPinnedThreadIds(e) {
    this.pinnedConversationIds = new Set(
      e.map((e) => I(e)).filter((e) => !this.suppressedArchivedConversationIds.has(e)),
    );
    let t = !1;
    for (let n of e) {
      let e = I(n);
  ...
  upsertHydratedCollabReceiverConversation(e) {
    ...
    if (
      ...
      let n = Fg({ conversationId: t, conversations: this.conversations });
      this.params.generateConversationTitle(
        t,
...
var Hg = 2e4;
function Ug({ current: e, delta: t, maxChars: n = Hg }) {
...
var Wg = 16,
  ...
  qg = class {
    ...
    constructor(e) {
      ((this.onFlush = e.onFlush),
        (this.fallbackIntervalMs = e.fallbackIntervalMs ?? Wg),
        (this.targetCharsPerFrame = e.targetCharsPerFrame ?? Gg),
        (this.maxDrainFrames = e.maxDrainFrames ?? Kg));
    }
    enqueue(e) {
  ...
  Zg = f(`type`, [
    g({ type: A(`text`), text: P(), annotations: Yg }).strip(),
    g({ type: A(`image`), mimeType: P(), data: P(), annotations: Yg }).strip(),
    g({ type: A(`audio`), mimeType: P(), data: P(), annotations: Yg }).strip(),
    g({
    ...
    g({ type: A(`embedded_resource`), resource: Xg }).strip(),
    g({ type: A(`resource`), resource: Xg }).strip(),
  ]);
function Qg(e, t) {
  return !e && !t
    ? null
...
function n_(e) {
  return e.map((e) => ({ step: e.step, status: t_(e.status) }));
}
function r_(e) {
  switch (e.type) {
    case `read`:
...
function f_(e) {
  ...
  for (let n = e.turns.length - 1; n >= 0; --n) {
    ...
    if (i.turnId != null) {
      ...
      if (n != null) return { type: `userInput`, item: y_(n) };
      ...
      let l = C_(i, e?.approvalRequests ?? []);
      if (l != null) return { type: `approval`, item: l };
      let u = e?.latestPermissionRequest;
      if (u != null) return { type: `permissionRequest`, item: S_(u) };
...
function h_(e) {
  if (!e) return null;
  let { requestsByTurnId: t } = __(e.requests);
  for (let n = e.turns.length - 1; n >= 0; --n) {
    let r = e.turns[n];
    if (r.turnId == null) continue;
    let i = C_(r, t.get(r.turnId)?.approvalRequests ?? []);
  ...
  for (let i = e.length - 1; i >= 0; --i) {
    ...
    switch (a.method) {
      case `mcpServer/elicitation/request`: {
        let e = cl(a.params);
        if (e == null) continue;
        let r = { type: `mcpServerElicitation`, requestId: s(a.id), request: a, elicitation: e };
        if (!g_(a.params.turnId)) {
          n ??= r;
          continue;
        }
      ...
      case `item/commandExecution/requestApproval`:
      case `item/fileChange/requestApproval`:
        v_(r, a.params.turnId).approvalRequests.push(a);
        continue;
      case `item/permissions/requestApproval`: {
        let e = v_(r, a.params.turnId);
      ...
      case `item/tool/requestSetupCodexContextPicker`: {
        let e = v_(r, a.params.turnId);
        e.latestSetupCodexContextPickerRequest ??= { requestId: s(a.id), request: a };
        continue;
      }
      case `item/tool/call`:
        if (a.params.tool === `request_onboarding_input`) {
          ...
          if (e == null) continue;
          let t = v_(r, a.params.turnId);
          t.latestOnboardingInputItem ??= b_(a, e);
          continue;
        }
...
function w_(e, t) {
  let n = e.params.proposedExecpolicyAmendment ?? [],
    r = e.params.commandActions?.map(r_) ?? [],
    i = r.map((e) => e.cmd),
    a = e.params.command ?? (n.length > 0 ? c_(n) : ``),
  ...
  for (let t = e.items.length - 1; t >= 0; --t) {
    ...
    if (n != null && n.type === `planImplementation`)
      return n.isCompleted
        ? null
        : { type: `implementPlan`, id: Yf(n.turnId), turnId: n.turnId, planContent: n.planContent };
  }
  return null;
}
var O_ = 3600 * 1e3,
  ...
  j_ = class {
    ...
    getInactiveOwnerConversationIdsToUnsubscribe(e) {
      ...
      for (let [n, r] of this.inactiveOwnerConversationSinceById.entries()) {
        ...
        let a = this.inactiveOwnerConversationRetryAtById.get(n) ?? null;
        (a != null && a > e) ||
          t.push({ conversationId: n, inactiveSinceMs: r, ttlExpired: e - r >= O_ });
      }
      t.sort((e, t) => e.inactiveSinceMs - t.inactiveSinceMs);
      let n = Math.max(0, t.length - A_),
    ...
    shouldKeepConversationLoaded(e) {
      return e.threadRuntimeStatus?.type === `active`
        ? !0
        : e.turns.at(-1)?.status === `inProgress` && f_(e) == null;
    }
...
function P_(e, t, n) {
  e.updateConversationState(t, (e) => {
    ...
    e.turns.push(M_(t, n, `inProgress`));
  });
}
function F_(e, t, n) {
  return G({
...
function R_(e, t, n) {
  N_(e, t, { id: L(), type: `remoteTaskCreated`, taskId: n });
}
function z_(e, t, n) {
  N_(e, t, { id: L(), type: `personalityChanged`, personality: n });
}
function B_(e, t, n, r) {
  let i = { id: Yf(n), type: `planImplementation`, turnId: n, planContent: r, isCompleted: !1 };
  e.updateConversationState(t, (e) => {
...
var U_ = `pending-manual-context-compaction`,
  W_ = class {
    pendingCounts = new Map();
    register(e, t) {
      (this.pendingCounts.set(t, (this.pendingCounts.get(t) ?? 0) + 1),
        P_(e, t, { type: `contextCompaction`, id: U_, completed: !1, source: `manual` }));
    }
    remove(e, t) {
    ...
    removePendingItemFromTurn(e) {
      e.items = e.items.filter((e) => e.id !== U_);
    }
    removePendingItem(e, t) {
      e.updateConversationState(t, (e) => {
        let t = e.turns.findIndex((e) => e.items.some((e) => e.id === U_));
        if (t < 0) return;
        let n = e.turns[t];
        n &&
  ...
  K_ = `pasted-text.txt`,
  q_ = `pasted-text-attachments.json`,
  J_ = /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}\/pasted-text\.txt$/,
  Y_ = g({ attachmentPaths: we(P()), pendingRemovalPaths: we(P()) }),
  X_ = class {
    state = null;
    ...
    async create(e, t) {
      ...
      let r = Nc(await this.options.createAttachmentDirectory(), K_);
      (await this.options.requestClient.sendRequest(`fs/writeFile`, { path: r, dataBase64: kt(e) }),
    ...
    async getRegistryPath() {
      return Nc(await this.options.getAttachmentsRoot(), q_);
    }
  };
function Z_(e, t) {
  let n = ve(t).replace(/\/+$/, ``),
    r = ve(e);
  return r.startsWith(`${n}/`) ? J_.test(r.slice(n.length + 1)) : !1;
}
var Q_ = 4.75 * 60,
  $_ = class {
    ...
    isFresh(e) {
      return Date.now() / 1e3 - e < Q_;
    }
  };
async function ev(e) {
  try {
    let { value: t } = await e(`get-global-state`, { params: { key: N.PROJECTLESS_THREAD_IDS } }),
      n = t;
...
async function tv(e, t) {
  try {
    return (
      await e(`set-global-state`, { params: { key: N.PROJECTLESS_THREAD_IDS, value: [...t] } }), !0
    );
  } catch (e) {
    return (
...
var nv = m(P(), P()),
  ...
  iv = class {
    ...
    async load(e = !1) {
      ...
      let n = await av(this.fetchFromHost);
      return (
        n != null &&
    ...
    async saveConversationId(e) {
      ...
      (await tv(this.fetchFromHost, n)) && (this.conversationIds = n);
    }
    ...
    async saveOutputDirectoryHint(e, t) {
      if (t != null) {
        ...
        try {
          await this.saveThreadPathHint(N.THREAD_PROJECTLESS_OUTPUT_DIRECTORIES, e, t);
        } catch (t) {
...
function fv(e, t, n) {
  let r = (0, Z.default)(e.items, (e) => e.id === t && dv(e, n));
  return r
    ? r.type === n
      ? r
...
function pv(e) {
  let t = e.trim();
  return t.length === 0 ? `` : mv(Ye(t)).replace(/\s+/g, ` `).trim();
}
function mv(e) {
  return e.type === `root` || e.type === `blockquote` || e.type === `list` || e.type === `listItem`
    ? e.children.map(mv).join(` `)
    : Xe(e);
}
function hv(e) {
  return pv(e);
...
function gv(e, t) {
  ...
  if (e.turns != null) {
    let t = e.turns[0]?.params,
      ...
      r = hv(n?.message ?? ``);
    if (r) return r;
    let i = hv(n?.comments?.find((e) => e.body.trim().length > 0)?.body ?? ``);
    if (i) return i;
  }
  return _v(e.id, t);
}
...
function bv(
  ...
  (e.setConversation({
    ...
    sideConversation: o,
    hostId: e.getHostId(),
    turns: o ? [] : nm(n, { fallbackCwd: u ?? null }),
    requests: [],
    createdAt: f,
    updatedAt: m,
  ...
  (sc(r.thread),
    e.updateConversationState(t, (e) => {
      ((e.turns = i.map(G)),
        ...
        (e.forkedFromId = r.thread.forkedFromId == null ? null : I(r.thread.forkedFromId)),
...
function Pv(e, t) {
  ...
  (e.kind !== `tooManyDenials` && !r.startsWith(Nv)) ||
    t.updateConversationState(I(n), (e) => {
      ...
      t && (Q(t), t.items.push({ id: L(), type: `autoReviewInterruptionWarning` }));
    });
}
...
var Wv = class {
  ...
  setOpenReviewFileSourceFiles(e, t) {
    let n = this.openFilesByConversationId.get(e) ?? Gv();
  ...
  startWatch(e, t) {
    let n = { isStarted: !1, shouldUnwatchOnStart: !1, target: t, watchId: `open-file-${L()}` };
    return (
...
var Zv = class {
  ...
  release(e, t, n, r) {
    ...
    (this.buffers.delete(e), i != null && Qv(i, t, n, r));
  }
  push(e, t) {
    let n = th(e);
    if (n == null) return !1;
...
function Qv(e, t, n, r) {
  ...
  for (let t of e) {
    if (
      ...
      i.add(
        ey(`item/agentMessage/delta`, t.notification.params.turnId, t.notification.params.item.id),
      );
      continue;
    }
    if (
      ...
      let e = ey(t.notification.method, t.notification.params.turnId, t.notification.params.itemId),
        n = a.get(e);
      n == null
  ...
  let o = new Map();
  for (let [e, n] of a) o.set(e, $v(t, n.notification, n.text.join(``)));
  for (let t of e) {
    if (t.type === `request`) {
      r(t.request);
      continue;
    ...
    let a = ey(e.method, e.params.turnId, e.params.itemId);
...
async function ty(e, t, n) {
  let { beforeSendRequest: r, inheritThreadSettings: i = !0, ...a } = n,
    ...
    s = o?.workspaceKind === `projectless` ? fm(Om(o.turns)?.params.sandboxPolicy) : null,
    c =
      dm({
        cwd: a.cwd ?? o?.cwd,
        fallbackCwd: s,
    ...
    l = await lv({
      ...
      workspaceRoots: o?.workspaceKind === `projectless` && c == null ? [] : [c ?? `/`],
  ...
  let d = await ny(e, t),
    f = await ry(e, t),
    p =
      d == null && (u.workspaceKind === `projectless` || (await ay(e, t)))
        ? await oy({ manager: e, conversationState: u, retainedWritableRoots: f, input: a.input })
        : null,
    m = d == null ? (p == null ? u.workspaceKind : `projectless`) : `project`,
    h = m === `projectless` ? (p?.workspaceRoot ?? u.workspaceBrowserRoot ?? null) : null,
    g = i ? u.latestCollaborationMode : null,
    _ = a.collaborationMode ?? g,
    v = i ? u.latestModel : null,
    y = i ? u.latestReasoningEffort : null,
    b = _ == null ? mm(a.model ?? v) : null,
    ...
    T =
      a.approvalPolicy ??
      C?.params.approvalPolicy ??
      u.currentPermissions?.approvalPolicy ??
      w.approvalPolicy,
    E =
      a.sandboxPolicy ??
      C?.params.sandboxPolicy ??
      u.currentPermissions?.sandboxPolicy ??
      w.sandboxPolicy,
    O = ym(E, f),
    k = p == null ? O : iy(O, p.workspaceRoot),
    ee = d?.path == null ? k : iy(k, d.path),
    A =
      a.approvalsReviewer ??
      C?.params.approvalsReviewer ??
      u.currentPermissions?.approvalsReviewer ??
      w.approvalsReviewer,
    j = fm(ee),
    te =
      ...
      d?.path ??
      p?.cwd ??
      dm({ cwd: a.cwd ?? u.cwd, fallbackCwd: j, workspaceBrowserRoot: h, workspaceKind: m }),
    M = pm({ sandboxPolicy: ee, workspaceKind: m }),
    ne =
    ...
    ce = { approvalPolicy: T, approvalsReviewer: A, sandboxPolicy: M },
    le = u.currentPermissions;
  e.updateConversationState(t, (e) => {
    let t = [],
    ...
    (e.turns.push(G(r)),
      d == null
        ? p != null &&
          ...
          (e.cwd = p.cwd))
        : ((e.workspaceKind = `project`), (e.workspaceBrowserRoot = null), (e.cwd = d.path)),
  ...
  try {
    ...
    return (
      ne.length > 0 && (d != null || f.length > 0 || te !== u.cwd) && (await cy(e, t, ne)),
      d != null && (await sy(e, t, d)),
      e.updateConversationState(t, (e) => {
        let t = (0, K.default)(e.turns);
    ...
    throw (
      e.updateConversationState(t, (e) => {
        ...
        ((t.items ||= []),
          ...
          le == null ? delete e.currentPermissions : (e.currentPermissions = le));
      }),
      n
    );
  }
...
async function oy({ manager: e, conversationState: t, retainedWritableRoots: n, input: r }) {
  let i = t.cwd,
    a = lm(i);
...
async function uy(e, t, n, r, i) {
  ...
  try {
    ...
    if (
      ...
      return;
    await dy(e, { conversationId: n, title: r });
  } catch (e) {
...
async function dy(e, { conversationId: t, title: n }) {
  try {
...
async function fy(e, t, n) {
  ...
  await dy(e, { conversationId: t, title: r });
}
async function py(e, t, n) {
  ...
  (e.applyThreadTitleUpdateAndNotify(a), await dy(e, { conversationId: t, title: r }));
}
function my(e, t, n, r, i, a) {
  ...
  let s = a ?? cl(n);
  if (s == null) return;
  let c = Dm(e, n.turnId, { synthesizeMissingTurn: !1 });
  c &&
    (Q(c),
    pp(
      c,
...
var vy = 3e4,
  ...
  by = class {
    ...
    rollingDeltaCounter = new ae({ windowMs: vy });
    deltaBurstEmitGate = new Fe({ minIntervalMs: yy });
    constructor(e) {
...
var xy = 250,
  Sy = class {
    ...
    personality = null;
    manualContextCompactions = new W_();
    ...
    constructor(
      ...
      ((this.hostId = e),
        ...
        (this.pastedTextAttachments = new X_({
        ...
        (this.projectlessConversations = new iv(this.hostId, this.fetchFromHost, (e) =>
          this.getConversation(e),
        )),
        (this.threadWorkspaceState = new ov(this.fetchFromHost, this.projectlessConversations)),
        (this.openFileWatches = new Wv({
          getConversationCwd: (e) => this.getConversationCwd(e),
          requestClient: this.requestClient,
        })),
        (this.threadStore = new Bg({
          hostId: this.hostId,
        ...
        (this.inactiveThreadUnsubscriber = new j_({
          threadStore: this.threadStore,
          events: this.events,
          requestClient: this.requestClient,
          streamState: this.streamState,
        })),
        (this.webviewSampler = new by({
          enabled: !0,
          getMetrics: () =>
            cv({
              conversations: this.conversations,
        ...
        (this.fuzzyFileSearchController = new Xn((e, t) => this.sendRequest(e, t))),
        (this.threadCreation = new Og({
          scope: s,
          dispatchMessageToView: this.dispatchMessageToView,
        ...
        e.map(async (e) => {
          ...
          if (a == null || a > 47185920) {
            ...
            await this.fetchFromHost(`upload-local-file-over-sftp`, {
              params: { sourcePath: e.fsPath, targetPath: i, hostId: this.hostId },
            });
          } else {
            ...
            await this.requestClient.sendRequest(`fs/writeFile`, { path: i, dataBase64: t });
          }
    ...
    async prewarmConversation({ cwd: e, workspaceRoots: t, collaborationMode: n, agentMode: r }) {
      return this.threadCreation.prewarmConversation({
        cwd: e,
        workspaceRoots: t,
        collaborationMode: n,
        agentMode: r,
        serviceTier: this.getEffectiveServiceTier(await this.getDefaultServiceTier()) ?? null,
    ...
    async startConversation(
      ...
      let w = t?.settings.reasoning_effort,
        T = fp(x),
        E = typeof _ == `function` ? _(C) : (_ ?? !1),
        O = () => this.generateConversationTitle(b, e, S ?? null),
        k = async () => {
          (!d && (g == null || !E) && O(),
            await ty(this, b, {
              cwd: S,
    ...
    generateConversationTitle(e, t, n) {
      return uy(this, this.fetchFromHost, e, t, n);
    }
    async interruptConversation(e) {
      (await cp(this.getArchiveConversationContext(), e), await this.interruptConversationSelf(e));
    }
      ...
      if (
        ...
        switch (
          ...
          case `thread/started`: {
            ...
            (this.captureBrowserUseSessionRoute(t, q(e.source) != null, `thread_started`),
              Xv(this.dispatchMessageFromView, `thread_started`),
          ...
          case `thread/goal/updated`: {
            ...
            (this.updateConversationState(r, (e) => {
              ((e.threadGoal = t),
                ...
                bp(t.status) || (e.threadGoalResumeConfirmation = null));
            }),
              a &&
...
`) === a,
                  ...
                  jy(n.items, r, n.turnId, n.turnStartedAtMs, !1) != null
                )
                  return;
          ...
          case `turn/started`: {
            ...
            (this.markConversationStreaming(r),
              ...
              Xv(this.dispatchMessageFromView, `turn_started`));
            break;
          }
          case `turn/completed`: {
            if (
            ...
            (this.updateTurnState(r, t.id, (e) => {
              ...
              i && (B_(this, r, t.id, i), V_(this, r, t.id, i)));
            let s = this.getLastAgentMessageForTurn(r, t.id),
              c = s == null ? null : $c(s),
              l = c?.decision !== `DONT_NOTIFY`,
              u = this.scope == null ? null : vp(this.scope.get, N.QUEUED_FOLLOW_UPS),
              d = u?.data?.[r]?.[0] ?? null,
              f = !1,
              p = [];
            (this.updateConversationState(r, (e) => {
              ...
              r.length !== 0 &&
                ((p = r.map((e) => {
                  ...
                  return { ...r, pausedReason: t.status === `interrupted` ? zf : Bf };
                })),
              ...
              this.broadcastConversationSnapshot(r),
              Xv(this.dispatchMessageFromView, `turn_completed`),
          ...
          case `turn/plan/updated`: {
            ...
            this.updateTurnState(a, t, (e) => {
              let t = { id: L(), type: `todo-list`, explanation: i ?? null, plan: r };
              e.items.push(t);
            });
            break;
          }
            ...
            (this.markConversationStreaming(a),
              this.updateConversationState(a, (t) => {
                ...
                if (
                  ...
                  (Q(n),
                  e.type === `userMessage` &&
                    (jy(n.items, e.content, n.turnId, n.turnStartedAtMs, !1) != null ||
          ...
          case `item/completed`: {
            ...
            this.updateConversationState(a, (t) => {
              ...
              if (e.type === `userMessage`) {
                let t = jy(n.items, e.content, n.turnId, n.turnStartedAtMs, !1);
                if (t != null) {
                  ((t.status = `accepted`), pp(n, G({ type: `steered`, id: e.id })));
                  return;
                }
                pp(n, s);
                return;
              ...
              (Ey(e) &&
                ...
                fv(n, e.id, e.type) && (e.type, pp(n, s)));
            });
            break;
          }
          ...
          case `item/agentMessage/delta`: {
            ...
            this.webviewSampler.recordDeltaBytes(t) &&
              Xv(this.dispatchMessageFromView, `delta_burst`);
            let a = I(r);
          ...
          case `item/fileChange/patchUpdated`: {
            ...
            this.updateTurnState(
              ...
              (n) => {
                n.firstTurnWorkItemStartedAtMs = n.firstTurnWorkItemStartedAtMs ?? Date.now();
                let r = fv(n, t, `fileChange`);
                if (r) {
                  r.changes = G(e);
                  return;
                }
                pp(n, G({ type: `fileChange`, id: t, changes: e, status: `inProgress` }));
              },
              !1,
          ...
          case `serverRequest/resolved`: {
            ...
            this.updateConversationState(r, (e) => {
              (i?.method === `mcpServer/elicitation/request` && my(e, s(t), i.params, !0, null),
                i?.method === `item/permissions/requestApproval` && hy(e, s(t), i.params, !0, null),
                i?.method === `item/tool/requestUserInput` && _y(e, s(t), i.params, {}, !0),
          ...
          case `model/rerouted`: {
            ...
            this.updateTurnState(o, t, (e) => {
              let t = { id: L(), type: `modelRerouted`, fromModel: r, toModel: i, reason: a };
              e.items.push(t);
            });
            break;
          }
        ...
        switch (
          ...
          case `item/permissions/requestApproval`: {
            let n = I(r.threadId),
              i = s(t);
            this.updateConversationState(n, (t) => {
              (t.requests.push(e), (t.hasUnreadTurn = !0), hy(t, i, r, !1, null));
            });
            break;
          }
          case `item/fileChange/requestApproval`:
          case `item/commandExecution/requestApproval`: {
            ...
            (this.updateConversationState(a, (t) => {
              ...
              n === `item/fileChange/requestApproval` && Nm(this, a).catch(() => {}),
          ...
          case `item/tool/requestUserInput`: {
            ...
            this.updateConversationState(i, (t) => {
              (t.requests.push(e), (t.hasUnreadTurn = !0), _y(t, a, r, {}, !1));
            });
          ...
          case `item/tool/call`:
            if (_c(r.tool)) {
              if (r.tool === `request_option_picker` && vc(r.arguments) == null) {
                this.dispatchMessageFromView(`mcp-response`, {
                  hostId: this.hostId,
                  response: { id: s(t), result: Y(`${dc} received invalid arguments.`) },
                });
                break;
              }
              if (r.tool === `request_onboarding_input` && yc(r.arguments) == null) {
                this.dispatchMessageFromView(`mcp-response`, {
                  hostId: this.hostId,
                  response: { id: s(t), result: Y(`${fc} received invalid arguments.`) },
                });
                break;
              }
              let n = I(r.threadId);
          ...
          case `mcpServer/elicitation/request`: {
            ...
            this.updateConversationState(a, (n) => {
              (n.requests.push(G(e)), (n.hasUnreadTurn = !0), my(n, s(t), r, !1, null, i));
            });
            break;
          }
          case `account/chatgptAuthTokens/refresh`:
...
`,
    ...
    applyTerminalInteraction(e, t, n, r) {
      let i = ky(e, n),
        { commands: a, inputBuffer: o } = Ay(this.terminalInputBuffers.get(i) ?? ``, r);
            ...
            for (let t of n) {
              ...
              if (n)
                switch (t.target.type) {
                  case `agentMessage`: {
                    let e = fv(n, t.itemId, `agentMessage`);
                    e && (e.text = (e.text ?? ``) + t.delta);
                    break;
                  }
                  case `plan`: {
                    let e = fv(n, t.itemId, `plan`);
                    e && (e.text = (e.text ?? ``) + t.delta);
                    break;
                  }
                  case `reasoningSummary`: {
                    let e = fv(n, t.itemId, `reasoning`);
                    if (!e) break;
    ...
    getApprovalActionContext() {
      return sv({
        ...
        conversations: this.conversations,
        updateConversationState: this.updateConversationState.bind(this),
        upsertMcpServerElicitationSyntheticItem: my,
        upsertPermissionRequestSyntheticItem: hy,
        upsertUserInputResponseSyntheticItem: _y,
      });
    }
    ...
    async setLatestCollaborationModeForConversation(e, t) {
      let n = this.getStreamRole(e);
      (await this.sendThreadFollowerRequest(n, `thread-follower-set-collaboration-mode`, {
        conversationId: e,
        collaborationMode: t,
      })) ||
        this.updateConversationState(e, (e) => {
    ...
    hydrateCollabThreads(e) {
      for (let t of e) this.captureBrowserUseSessionRoute(I(t), !0, `hydrated_collab_thread`);
...
function jy(e, t, n, r, i) {
  return e.find(
    (e) =>
      ...
      e.status === `pending` &&
      Uf(e, n, r) &&
      Hf(e, t, { acceptMissingImageInputs: i, normalizeRestrictedImageDisplayPlaceholders: i }),
  );
}
function My(e) {
...
var Ny = { $type: `protobuf_analytics_events.v1.ChatgptUserIdentified` },
  Py = { $type: `protobuf_analytics_events.v1.ClientEventCounter` },
  Fy = wt(),
  Iy = `javascript-client`,
  Ly = 3e4,
  Ry = `__protobuf_structured_event__`,
  zy = /^[a-zA-Z][a-zA-Z\d+.-]*:\/\//;
function By(e) {
  let t = e.toLowerCase();
...
var Vy = {
  ...
  Hy = (e) => typeof e == `function`;
function Uy(e) {
  if (typeof e != `object` || !e) return null;
  let t = e;
  if (Hy(t.AnalyticsBrowser)) return t.AnalyticsBrowser;
  let n = t.default;
  if (typeof n != `object` || !n) return null;
  let r = n;
  return Hy(r.AnalyticsBrowser) ? r.AnalyticsBrowser : null;
}
var Wy = (function (e) {
...
var qy = class {
    ...
    getSegmentIoApiHostUrl() {
      ...
      try {
        return zy.test(r) ? new URL(r) : new URL(`${i}://${r}`);
      } catch {
        return;
      }
    }
    ...
    buildSegmentEnvelope(e, t, n) {
      ...
      let c = this.user?.traits?.is_openai_internal,
        l = {
          ...
          authStatus: this.user ? Wy.LoggedIn : Wy.LoggedOut,
    ...
    async sendStructuredEvent(e, t, n) {
      ...
      if (this.structuredEventTransport === `statsig`) {
        ...
        try {
          this.statsigClient.logEvent({ eventName: Ry, metadata: i });
        } catch (e) {
        ...
        let r = this.buildSegmentEnvelope(e, t, n),
          i = this.analytics.then(([e]) => e.track(Ry, r)).catch(() => void 0);
    ...
    async trackCounter(e, t) {
      return this.trackStructuredEvent(Py, { counterName: e, metricValue: t });
    }
  },
  Jy = `-9223372036854775808`,
...
function rb(e, t, n, r = {}) {
  ...
  if ((nb(a, { type: e, value: i, ...r }), Qy)) throw a;
}
function ib(e, t, n, r) {
  return rb(e, `to be within [${n}, ${r}]`, t, { min: n, max: r });
}
function ab(e, t, n) {
  if (!Number.isFinite(e)) return rb(t, `to be a finite number`, e);
  let r = tb(e, eb(n));
  return Number.isSafeInteger(r) ? r : rb(t, `to be a safe integer`, e);
}
function ob(e, t) {
...
function sb(e, t, n, r, i, a) {
  let o = e.trim();
  if (!/^[+-]?\d+$/.test(o)) return rb(t, `to be an integer string`, e);
  let s = ``,
    c = o;
  (c[0] === `+` || c[0] === `-`) && ((s = c[0] === `-` ? `-` : ``), (c = c.slice(1)));
  let l = c.replace(/^0+(?=\d)/, ``);
  if ((l === `0` && (s = ``), (s === `-` && !a) || l.length > i)) return ib(t, e, n, r);
  let u = r.startsWith(`-`) ? r.slice(1) : r;
  if (s === `-`) {
    if (ob(l, n.startsWith(`-`) ? n.slice(1) : n) > 0) return ib(t, e, n, r);
  } else if (ob(l, u) > 0) return ib(t, e, n, r);
  return s === `-` ? `-${l}` : l;
}
function cb(e, t) {
  if (e == null) return;
  if (typeof e == `string`) return sb(e, `int64`, Jy, Yy, Xy, !0);
  let n = ab(e, `int64`, t);
  if (n != null) return String(n);
}
var lb = `codex-text-link://`;
function ub(e) {
  return e.replaceAll(`](${lb}`, `](`);
}
function db(e) {
...
function hb({ filePath: e, imagePreviewMode: t, isDeletion: n, richPreviewEnabled: r }) {
  return r && !n && vb(e)
    ? `markdown`
    : t === `always` || (t === `toggle` && r)
      ? `image`
...
function gb(e) {
  let t = yb(e);
  return t == null ? `none` : t === `svg` ? `toggle` : bb.has(t) ? `always` : `none`;
}
function _b(e) {
  return yb(e) === `pdf`;
}
...
var bb = new Set([`avif`, `bmp`, `gif`, `ico`, `jpeg`, `jpg`, `png`, `tif`, `tiff`, `webp`]),
  xb = new Set([`markdown`, `md`, `mdown`, `mdx`, `mkd`]),
  Sb = l([`view`, `create`, `update`, `delete`, `suggested_create`, `suggested_update`]).transform(
    (e) => {
      switch (e) {
        case `view`:
          return `view`;
  ...
  wb = P().trim().min(1),
  Tb = l([`worktree`, `local`]),
  Eb = l([`local`, `worktree`, `thread`]),
  Db = y([P(), we(P())]).transform((e, t) => {
...
var Bb = `load_workspace_dependencies`,
  Vb = {
    name: Bb,
...
var Wb = g({ "codex/browserUse": A(!0) });
function Gb({ resultMeta: e, serverName: t }) {
  return t === `node_repl` && Wb.safeParse(e).success ? `browser-use` : null;
}
function Kb(e) {
...
function nx(e, t) {
  for (let n of t) {
    ...
    ox(e.editedPaths, e.editedFilePaths, t);
  }
}
function rx(e, t) {
  for (let { path: n } of Zb(t)) ox(e.referencedPaths, e.referencedFilePaths, n);
}
function ix(e) {
...
function ax(e) {
  let t = tx();
  for (let n of e.items)
    n && (n.type === `fileChange` ? nx(t, n.changes) : n.type === `agentMessage` && rx(t, n.text));
  return ix(t);
}
function ox(e, t, n) {
  let r = J(n);
...
function dx(e, t, n) {
  return e.type === `update` && e.move_path != null
    ? { ...e, move_path: fx(e.move_path, t, n) }
    : e;
}
function fx(e, t, n) {
  if (n == null) return e;
  ...
  let i = Cu(t, n);
  return i === t || e === i || e.startsWith(`${i}/`) ? e : ah.default.posix.join(i, e);
}
function px(e) {
  let [t, ...n] = e ?? [];
  return !t || n.length === 0
...
var vx = /^\[external_agent_tool_(call|result)(?::[^\]]*)?\]$/,
  yx = /^\[\/external_agent_tool_(call|result)\]$/,
  bx = `<EXTERNAL SESSION IMPORTED>`;
function xx(e) {
  let t = e.trimStart();
  if (
    e.trim() === bx ||
...
`);
        ...
        case `mcpToolCall`: {
          let t = {
            ...
            pluginId: n.pluginId,
            source: Gb({ resultMeta: n.result?._meta ?? null, serverName: n.server }),
            invocation: { server: n.server, tool: n.tool, arguments: n.arguments },
            result: Qg(n.result, n.error),
        ...
        case `todo-list`:
          a.push({ type: `todo-list`, explanation: n.explanation ?? null, plan: n_(n.plan) });
          break;
        ...
        case `userMessage`: {
          if (Fx(e.items, t, n.content, e.params?.input ?? [])) break;
          let r = Lf({
            input: n.content,
            attachments: n.attachments ?? Rx(n.content),
            commentAttachments: n.commentAttachments ?? [],
            normalizeRestrictedImageDisplayPlaceholders: !1,
            sentAtMs: a.length === 0 ? c : null,
          }).item;
          if (r != null) {
            let o = Ix(e.items, t, n.content, {
                acceptMissingImageInputs: !1,
                commentAttachments: n.commentAttachments ?? [],
                normalizeRestrictedImageDisplayPlaceholders: !1,
              }),
              s = i || (d == null && !Mx(a, a.length));
    ...
    switch (n.method) {
      case `item/commandExecution/requestApproval`: {
        let { id: t, params: r } = n,
          ...
          o = r.commandActions?.map(r_) ?? [],
          c = o.map((e) => e.cmd),
          l = r.command ?? (i.length > 0 ? c_(i) : ``),
...
function Dx(e, t, n) {
  ...
  if (
    ...
    return !0;
  for (let t of e.items) if (t != null && Ox(t, { isBackgroundSubagentsEnabled: r })) return !0;
  for (let e of t)
    switch (e.method) {
      case `item/commandExecution/requestApproval`:
      case `item/permissions/requestApproval`:
...
function Ox(e, { isBackgroundSubagentsEnabled: t }) {
  switch (e.type) {
    case `enteredReviewMode`:
    case `exitedReviewMode`:
      return !1;
    ...
    case `dynamicToolCall`:
      return e.tool === `automation_update` && e.status === `completed` && e.success === !0
        ...
        : !gx(e.tool);
    case `imageView`:
      return Cx(e.path) != null;
    case `userMessage`:
      return (
        Lf({
          input: e.content,
          attachments: e.attachments ?? Rx(e.content),
...
function kx({
  ...
  let a = Yb({
    status: t,
    hasStartedWork: Mx(e, i),
    firstTurnWorkItemStartedAtMs: n,
    workedCompletedAtMs: Px({ items: e, status: t, finalAssistantStartedAtMs: r }),
  });
  if (a == null) return e;
  let o = t === `in_progress` ? jx(e) : i;
...
function jx(e) {
  for (let [t, n] of e.entries()) if (!Nx(n)) return t;
  return e.length;
}
function Mx(e, t) {
  for (let n = 0; n < t; n += 1) if (!Nx(e[n])) return !0;
  return !1;
}
function Nx(e) {
  return e == null || e.type === `user-message`;
}
function Px({ items: e, status: t, finalAssistantStartedAtMs: n }) {
...
function Wx({ turn: e }) {
  ...
  for (let n of e.items)
    n.type === `mcp-tool-call` &&
      (n.invocation.server !== Hx || !n.invocation.tool.startsWith(Ux) || (t = Gx(n) ?? t));
  return t?.projectId == null
    ? null
    : { type: `appgen-app`, projectId: t.projectId, url: t.url, title: t.title };
}
function Gx(e) {
  if (e.result?.type !== `success`) return null;
  let t = Bx.safeParse(e.result.structuredContent);
  if (!t.success) return null;
  let n = Kx(t.data.current_live_url ?? t.data.deployment_url ?? t.data.url);
  return n == null
    ? null
    : {
        projectId: t.data.project_id ?? Vx.parse(e.invocation.arguments).project_id ?? null,
        url: n,
...
function Kx(e) {
  ...
  try {
    let t = new URL(e);
    return (t.protocol !== `http:` && t.protocol !== `https:`) || xe(t.href) ? null : t.href;
  } catch {
    return null;
  }
}
...
function eS(e) {
  ...
  if (!o) {
    let e = c.toLowerCase();
    if (e.length > Jx && !Yx.has(e)) return !1;
  }
  return !0;
}
function tS(e) {
...
function iS({ cwd: e, projectlessOutputDirectory: t, resourcePath: n }) {
  if (t == null) return !0;
  let r = aS(e, t).replace(/\/+$/, ``);
  if (r === ``) return !1;
  let i = aS(e, n);
...
function aS(e, t) {
  let n = jc(e ?? ``, J(t));
  return n === `` ? `` : wc(ah.default.posix.normalize(n));
}
var oS = new Set([
    `avif`,
    `csv`,
...
function fS({
  ...
  let i = SS(e),
    ...
    o = xS({
      ...
      resources: _S({
        cwd: r.cwd,
        resources: [...gS(r).map((e) => ({ type: `file`, path: e })), ...TS(e)],
      }),
    });
...
function pS({ endResources: e, turn: t }) {
  if (e.length === 0 || t.artifacts.editedFilePaths.length === 0) return !1;
  let n = new Set();
  for (let r of e)
    switch (r.type) {
      case `file`:
        if (!US(r.path)) continue;
        n.add(HS(t.cwd, r.path));
        break;
      case `google-drive`:
        break;
      case `appgen-app`:
        break;
      case `website`:
        xe(r.target) || n.add(HS(t.cwd, r.target));
        break;
    }
  return t.artifacts.editedFilePaths.every((e) => n.has(HS(t.cwd, e)));
}
function mS({ assistantContent: e, turn: t }) {
  if (t.status !== `complete`) return [];
  let n = new Map();
  for (let r of vS({ assistantContent: e, turn: t })) {
    let e = yb(r);
    if (e == null || !sS.has(e)) continue;
    let t = n.get(e) ?? [];
    (t.push(r), n.set(e, t));
  }
...
function hS({ assistantContent: e, turn: t, resourcePath: n }) {
  if (t.status !== `complete`) return null;
  let r = HS(t.cwd, J(n)),
    i = vS({ assistantContent: e, turn: t }).find((e) => HS(t.cwd, e) === r);
  if (i == null) return null;
  let a = yb(i);
  return a != null && sS.has(a) ? a : null;
}
function gS(e) {
  return yS({
    cwd: e.cwd,
...
function vS({ assistantContent: e, turn: t }) {
  return yS({ cwd: t.cwd, rawPaths: [...t.artifacts.editedFilePaths, ...wS(e)] });
}
function yS({ cwd: e, rawPaths: t }) {
  let n = new Map();
  for (let r of t) {
    let t = J(r),
      i = HS(e, t);
...
function bS(e, t) {
  ...
  for (let r of e.artifacts.editedFilePaths) {
    let i = J(r);
    if (!ze(i) || !iS({ cwd: e.cwd, projectlessOutputDirectory: t, resourcePath: i })) continue;
    let a = HS(e.cwd, i);
    n.has(a) || n.set(a, i);
  }
...
function xS({ cwd: e, projectlessOutputDirectory: t, resources: n }) {
  return t == null
    ...
    : n.filter((n) => {
        switch (n.type) {
          case `file`:
            return iS({ cwd: e, projectlessOutputDirectory: t, resourcePath: n.path });
          case `google-drive`:
            return !0;
        }
      });
...
function CS(e) {
  ...
  return uS.test(`${n.pathname}${n.search}${n.hash}`) || n.port.length === 0
    ? null
    : xe(n.href)
      ? n.href
      : null;
...
function TS(e) {
  ...
  for (let n of ES(e)) {
    ...
    let r = BS(n.destination);
    r != null && WS(r) && t.push({ type: `file`, path: r });
  }
  return t;
}
function ES(e) {
...
` ||
    ...
    if ((t === ` ` || t === `	`) && i === 0) {
      let t = e[FS(e, n)];
      if (t === `"` || t === `'` || t === `(`) return PS(e, n, r.join(``).trim());
    }
    (r.push(t), (n += 1));
  }
  return null;
...
` ||
    ...
    if (t === `>`) return PS(e, r + 1, n.join(``).trim());
    (n.push(t), (r += 1));
  }
  return null;
}
...
function BS(e) {
  let t = VS(e);
  return !eS(t) && !tS(t) ? null : J(Xx(t).path);
}
function VS(e) {
  try {
    return decodeURI(e);
...
function YS(e, t, n) {
  ...
  if (r != null) return r;
  let i = e.toLowerCase();
  return KS.get(i) ?? (n === `title` ? (t > 0 && qS.has(i) ? i : ZS(i)) : t === 0 ? ZS(i) : i);
}
function XS(e) {
  let t = e.toUpperCase();
...
function lC(e) {
  let t = $S(e)
    ...
    .split(`/`)
    .filter((e) => e.length > 0);
  return t.length === 0 ? null : (uC(t) ?? dC(t) ?? null);
}
function uC(e) {
  for (let t = 0; t < e.length; t += 1) {
    let n = e[t]?.toLowerCase(),
      r = e[t + 1]?.toLowerCase();
    if (!(n === eC || n === tC) || r !== nC) continue;
    let i = e[t + 2] ?? null,
      a = i?.toLowerCase(),
      o = a === rC || a === iC ? (e[t + 3] ?? null) : i;
    if (o != null && o.length > 0)
      return pC({
        skillId: o,
        pluginId: null,
        relativePathSegments: a === rC || a === iC ? e.slice(t + 4) : e.slice(t + 3),
      });
  }
  return null;
}
function dC(e) {
  for (let t = 0; t < e.length; t += 1) {
    if (e[t]?.toLowerCase() !== oC) continue;
    let n = fC(e, t);
    if (n == null) continue;
    let r = e.findIndex((e, n) => n > t && e.toLowerCase() === nC),
...
function pC({ skillId: e, pluginId: t, pluginMarketplaceName: n = null, relativePathSegments: r }) {
  let i = r[0]?.toLowerCase();
  return {
    skillId: e,
    skillName: QS(e.replaceAll(`_`, `-`)),
    pluginId: t,
    pluginDisplayName: t == null ? null : QS(t.replaceAll(`_`, `-`)),
    pluginMarketplaceName: n,
    isInScriptsFolder: i === aC,
    isSkillDefinitionFile: r.length === 1 && i === cC,
  };
}
function mC({
  threadId: e,
  ...
  return r.map(
    ({ fileExtension: r, fileCount: a, totalFileSizeBytes: s, knownFileSizeCount: c }) => ({
      ...
      totalFileSizeBytes: cb(s),
      knownFileSizeCount: c,
      turnStartedAtMs: cb(i.turnStartedAtMs),
      firstWorkItemStartedAtMs: cb(i.firstWorkItemStartedAtMs),
      turnDurationMs: cb(i.turnDurationMs),
      workDurationMs: cb(i.workDurationMs),
      usedSkillIds: o,
...
function gC({ threadId: e, turnId: t, inputMessageId: n, extensionSummaries: r }) {
  return r.map(
...
async function _C({
  ...
  let o = mS({ assistantContent: i, turn: Tx(r, []) });
  if (o.length === 0) return;
  let s = Date.now(),
    c = await CC({ hostId: n, extensionGroups: o }),
    l = mC({
      threadId: e,
      turnId: t,
      inputMessageId: DC(r),
      extensionSummaries: c,
      latencySummary: bC({ turn: r, createdAtMs: s }),
      usedSkillIds: kC(r),
    });
  try {
...
async function vC({
  ...
  let l = hS({ assistantContent: r, turn: n, resourcePath: i });
  if (l == null) return;
  let u = hC({
    threadId: e,
    turnId: t,
...
async function yC({ conversationId: e, turnId: t, hostId: n, turn: r, productLogger: i }) {
  let a = wC(r);
  if (a.length === 0) return;
  let o = await TC({ hostId: n, extensionGroups: a }),
    s = gC({ threadId: e, turnId: t, inputMessageId: DC(r), extensionSummaries: o });
  try {
...
function bC({ turn: e, createdAtMs: t }) {
  let n = xC(e.turnStartedAtMs),
    r = xC(e.firstTurnWorkItemStartedAtMs);
  return {
    turnStartedAtMs: n,
    firstWorkItemStartedAtMs: r,
    turnDurationMs: SC({ startedAtMs: n, createdAtMs: t }),
    workDurationMs: SC({ startedAtMs: r, createdAtMs: t }),
  };
}
function xC(e) {
  return typeof e == `number` && Number.isFinite(e) ? e : null;
}
function SC({ startedAtMs: e, createdAtMs: t }) {
  return e == null || !Number.isFinite(t) ? null : Math.max(0, t - e);
}
async function CC({ hostId: e, extensionGroups: t }) {
  return Promise.all(
    t.map(async ({ fileExtension: t, fileCount: n, resourcePaths: r }) => {
      let i = (await Promise.all(r.map((t) => PC({ hostId: e, path: t })))).filter(
        (e) => e != null,
      );
      return {
        fileExtension: t,
...
async function TC({ hostId: e, extensionGroups: t }) {
  return Promise.all(
    t.map(async ({ fileExtension: t, fileCount: n, resourcePaths: r }) => {
      let i = (await Promise.all(r.map((t) => PC({ hostId: e, path: t })))).filter(
        (e) => e != null,
...
function kC(e) {
  let t = new Set();
  for (let n of e.params.input) for (let e of jC(n)) AC(t, e);
  for (let n of e.items)
    if (n?.type === `commandExecution`)
      for (let e of n.commandActions ?? []) for (let n of NC(e)) AC(t, n);
...
async function PC({ hostId: e, path: t }) {
  try {
...
function WC(e, t = {}) {
  ...
  if (n === ``) return `{}`;
  if (!GC(n)) throw TypeError(`Unexpected input format`);
  let r = ``;
  UC.reset(n);
  for (let e of UC)
...
var KC = /[ \t\v\f\ufeff]+/,
  ...
  JC = /[.#](?:(?!-?\d)(?:[a-zA-Z0-9\xA0-\uFFFF_-])+)/,
  YC = RegExp(`(?<==)(?:true|false)`),
  XC = RegExp(
...
var nw = LC.default.states({
  main: {
    WhiteSpace: KC,
    AttributeShorthand: JC,
    BooleanLiteral: {
      match: YC,
      value(e) {
        return e === `true`;
    ...
    SingleQuotedValue: { match: ZC, value: ew, type: () => `StringLiteral` },
    DoubleQuotedLiteral: { match: QC, value: ew, type: () => `StringLiteral` },
    UnquotedLiteral: { match: $C, value: ew, type: () => `StringLiteral` },
    AttributeName: qC,
    Separator: `=`,
  },
});
function rw(e) {
  ...
  Object.defineProperties(r, {
    toString: { writable: !1, enumerable: !1, configurable: !1, value: () => tw(r) },
    getTokens: {
      writable: !1,
      enumerable: !1,
      configurable: !1,
      value: () => Array.from(nw.reset(e)),
    },
  });
  let i = [];
...
var iw = LC.default.compile({
  spaces: /[\t\v\f\ufeff ]+/,
  name: /[a-zA-Z][\w-]*/,
  attrs: { match: /\{.*\}/, value: (e) => rw(e.slice(1, -1)) },
...
var fw = `__codex_directive_escaped_double_quote__`,
  pw = `__codex_directive_escaped_single_quote__`,
  mw = `__codex_directive_quoted_backslash__`,
  hw = `__codex_directive_quoted_closing_bracket__`,
  gw = `__codex_directive_quoted_closing_brace__`,
  _w = `__codex_directive_`,
  vw = [`:::`, `::`],
  yw = Mw();
function bw(e, t = xw(e)) {
  let n = e.includes(`{`) && t ? Sw(e) : e;
  return n.includes(`:::`) ? Cw(n) : n;
}
function xw(e) {
  let t = e.indexOf(`:`);
  for (; t !== -1; ) {
...
function ww(e) {
  for (let t of e)
    (Rw(t) && Object.assign(t, Tw(t)), `tokens` in t && Array.isArray(t.tokens) && ww(t.tokens));
}
function Tw(e) {
  return {
    type: `codexDirective`,
...
function Dw(e, t) {
  ...
  let n = t;
  for (; e[n] === `:` && n - t < 3; ) n += 1;
  if (!zw(e.charCodeAt(n))) return null;
  for (n += 1; Bw(e.charCodeAt(n)); ) n += 1;
  return e[n] === `[` && ((n = Ow(e, n + 1)), n === -1) ? null : e[n] === `{` ? n : null;
}
function Ow(e, t) {
  let n = t;
  for (; n < e.length; ) {
...
`
    ...
    if (o === `\\` && e[r + 1] === n) {
      ((a += e.slice(i, r)), (a += n === `"` ? fw : pw), (r += 2), (i = r));
      continue;
    }
    if (o === `\\`) {
...
function Nw(e, t) {
  let n = e.indexOf(t);
  for (; n !== -1; ) {
    if (zw(e.charCodeAt(n + t.length)) && Lw(e, n)) return n;
    n = e.indexOf(t, n + 1);
  }
}
function Pw(e, t, n) {
...
function Fw(e, t) {
  return e.startsWith(`:::`, t) && zw(e.charCodeAt(t + 3));
}
function Iw(e, t, n) {
...
function Bw(e) {
  return zw(e) || (e >= 48 && e <= 57) || e === 45 || e === 95;
}
var Vw = {
  breaks: !0,
  gfm: !0,
...
function Zw(e) {
  let t = e.charCodeAt(0) === 65279 ? 1 : 0,
    n = pT(e, t);
  if (!fT(e.slice(t, n))) return null;
  let r = mT(e, n),
    i = r;
  for (; i < e.length; ) {
    let t = pT(e, i);
    if (fT(e.slice(i, t))) {
      let n = Qw(e.slice(r, i));
      return n.hasMetadataSyntax ? { body: e.slice(mT(e, t)), entries: n.entries } : null;
    }
    i = mT(e, t);
  }
  return null;
...
function Qw(e) {
  ...
  for (; i < t.length; ) {
    let e = t[i],
      a = e.trim();
    if (a.length === 0 || a.startsWith(`#`) || uT(e)) {
      i += 1;
      continue;
    }
    let o = e.indexOf(`:`),
...
function $w(e) {
  return sT(e) || e.startsWith(`{`) ? null : e.startsWith(`[`) ? rT(e) : nT(e);
}
function eT(e, t) {
  let n = [],
    r = t,
...
function tT(e) {
  let t = e[0];
  return t === `"` || t === `'` ? nT(e) : cT(e) ? null : nT(e);
}
function nT(e) {
  let t = e[0];
  return e.startsWith(`[`) || e.startsWith(`{`) || sT(e)
    ? null
    : t === `"` || t === `'`
      ? (aT(e, 0, !0)?.value ?? null)
      : e;
...
function rT(e) {
  let t = [],
    n = 1;
  for (; n < e.length; ) {
    if (((n = hT(e, n)), e[n] === `]`)) return e.slice(n + 1).trim().length === 0 ? t : null;
    let r = iT(e, n);
    if (r == null) return null;
    if ((t.push(r.value), (n = hT(e, r.nextIndex)), e[n] === `,`)) {
      n += 1;
      continue;
    }
...
function iT(e, t) {
  let n = e[t];
  if (n === `"` || n === `'`) return aT(e, t, !1);
  if (n === `[` || n === `{`) return null;
  let r = t;
  for (; r < e.length && e[r] !== `,` && e[r] !== `]`; ) r += 1;
  let i = e.slice(t, r).trim();
  return i.length === 0 || cT(i) ? null : { value: i, nextIndex: r };
}
function aT(e, t, n) {
  let r = e[t],
    i = ``,
...
function dT(e) {
  return e != null && uT(e) && e.trim().length > 0;
}
function fT(e) {
...
function vT(e) {
  ...
  for (; t + 1 < e.length; ) {
    let n = CT(e[t]),
      r = yT(e, t + 1),
      i = r == null ? null : yT(e, r + 1),
      a = wT(r == null ? void 0 : e[r]),
      o = CT(i == null ? void 0 : e[i]);
    ...
    if (n != null && a != null && r != null && ST(n, a)) {
      if (!xT(n, a)) {
        t += 1;
        continue;
      }
...
function bT(e) {
  if ((`tokens` in e && Array.isArray(e.tokens) && _T(e.tokens), e.type === `list`))
    for (let t of e.items) _T(t.tokens);
}
function xT(e, t) {
...
function IT(e) {
  for (let t of e) (UT(t) && VT(t), `tokens` in t && Array.isArray(t.tokens) && IT(t.tokens));
}
function LT(e) {
  for (let t = 0; t < e.length; t += 1) {
    let n = e[t];
    if (n == null || (`tokens` in n && Array.isArray(n.tokens) && LT(n.tokens), !KT(n))) continue;
    let r = [...n.tokens],
      i = t + 1,
      a = i;
    for (;;) {
...
function RT(e) {
  for (let t of e)
    `tokens` in t &&
      ...
      ((t.tokens = t.tokens.flatMap((e) => (WT(e) ? zT(e) : [e]))), RT(t.tokens));
}
function zT(e) {
  let t = 0,
    n = [];
  for (let r of e.raw.matchAll(kT)) {
    let i = r.index,
      a = r[1]?.trim() ?? ``,
      o = i == null ? null : i + r[0].length,
      s = o == null ? null : gT(e.raw, o),
      c = o == null || s == null ? `` : e.raw.slice(o, s).trim().replace(/\\/g, `/`),
      l = rS(c);
    if (i == null || a.length === 0 || c.length === 0 || s == null || l == null) continue;
    i > t && n.push(BT(e.raw.slice(t, i)));
    let u = e.raw.slice(i, s + 1);
    (n.push(
      r[0].startsWith(`!`)
        ? { type: `image`, raw: u, href: l, title: null, text: a }
        : { type: `link`, raw: u, href: l, title: null, text: a, tokens: [BT(a)] },
    ),
      (t = s + 1));
  }
  return t === 0 ? [e] : (t < e.raw.length && n.push(BT(e.raw.slice(t))), n);
}
function BT(e) {
  ...
  for (let t of e.items) {
    ...
    (e?.type === `heading` &&
      ...
      (t.tokens[0] = {
        ...
        raw: e.raw,
        text: n,
        tokens: e.tokens == null ? [BT(n)] : [BT(r), ...e.tokens],
      }),
      t.loose && (t.tokens = t.tokens.map((e) => (WT(e) ? HT(e) : e))),
      IT(t.tokens));
  }
}
function HT(e) {
...
var qT = /^::[a-zA-Z0-9-]+.*$/gm;
function JT(e, t) {
  let n = t?.lineStartNames == null ? e : ZT(e, t.lineStartNames);
  if (n == null) return [];
  let r = [];
  return (
    XT(MT(n, void 0), r),
...
function XT(e, t) {
  for (let n of e)
    (nE(n) && n.name.length > 0 && t.push({ name: n.name, attributes: tE(n.attributes) }),
      `tokens` in n && Array.isArray(n.tokens) && XT(n.tokens, t));
}
function ZT(e, t) {
  if (t.length === 0 || !QT(e, t)) return null;
  let n = new Set(t),
    r = [],
    i = 0;
  for (; i <= e.length; ) {
...
function eE(e, t, n) {
  ...
  let r = t;
  for (; e[r] === `:` && r - t < 3; ) r += 1;
  if (!rE(e.charCodeAt(r))) return null;
  let i = r + 1;
  for (; i < n && iE(e.charCodeAt(i)); ) i += 1;
...
function iE(e) {
  return rE(e) || (e >= 48 && e <= 57) || e === 45 || e === 95;
}
var aE = class {
    pending = new Map();
    listeners = new Map();
...
function sE(e) {
  ...
  switch (e) {
    case `computer-use-capture`: {
      let t = new aE(`computer-use-capture`);
      return (oE.set(e, t), t);
    }
    case `git`: {
      let t = new aE(`git`);
...
var pE = gt(
    ...
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r, watchForGitInit: i }) =>
      uE(e, fE(n), n, r, { enabled: t, ...(i ? { watchForGitInit: i } : {}) }),
    { key: vE },
  ),
  mE = ut(
    B,
  ...
  hE = R(
    ...
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r, watchForGitInit: i }, { get: a }) => {
      if (!t || e == null) return xE();
      let o = a(pE, { cwd: e, enabled: t, hostConfig: n, operationSource: r, watchForGitInit: i }),
        s = o.data ?? null;
      return (
        s != null &&
          a(
  ...
  gE = R(B, (e, { get: t }) => t(hE, e).data ?? null, { key: bE }),
  _E = R(B, (e, { get: t }) => t(hE, e).isLoading, { key: bE });
function vE({ cwd: e, enabled: t, hostConfig: n, watchForGitInit: r }) {
  return JSON.stringify({ cwd: e, enabled: t, hostConfig: n, watchForGitInit: r });
}
function yE({ commonDir: e, enabled: t, hostConfig: n, root: r }) {
  return JSON.stringify({ commonDir: e, enabled: t, hostConfig: n, root: r });
}
function bE({ cwd: e, enabled: t, hostConfig: n, watchForGitInit: r }) {
  return JSON.stringify({ cwd: e, enabled: t, hostConfig: n, watchForGitInit: r });
}
function xE() {
  let e;
...
function kE(e) {
  let t = e.params == null ? null : JSON.stringify(AE(e.params));
  return [...OE(e.metadata.commonDir, e.metadata.root, e.hostKey), e.method, t];
}
function AE(e) {
...
function ME(
  ...
  return Promise.all(
    c.map((r) => e.invalidateQueries({ queryKey: [...OE(t, n, i), r] }, { cancelRefetch: a })),
  );
}
async function NE(e, { commonDir: t, root: n }, { hostKey: r, cancelRefetch: i = !0 }) {
  let a = OE(t, n, r);
  (await e.invalidateQueries({ queryKey: [...a, `branch-diff-stats`] }, { cancelRefetch: i }),
    await e.invalidateQueries({ queryKey: [...a, `review-summary`] }, { cancelRefetch: i }),
    await e.invalidateQueries({ queryKey: [...a, `review-diff`] }, { cancelRefetch: i }));
}
function PE(e, t, { hostKey: n }) {
  return e.invalidateQueries({ queryKey: DE(t, n), exact: !1 });
}
async function FE({ cwd: e, hostConfig: t, operationSource: n }) {
  await sE(`git`).request({
    method: `invalidate-untracked-paths-cache`,
    params: { hostConfig: t, operationSource: n, ...(e == null ? {} : { cwd: F(String(e)) }) },
  });
}
async function IE({ cwd: e, hostConfig: t, operationSource: n, queryClient: r }) {
  let i = fE(t);
  try {
    let a = await r.fetchQuery(uE(e, i, t, n));
    if (a == null) return;
    await r.invalidateQueries({ queryKey: [...OE(a.commonDir, a.root, i), `status-summary`] });
  } catch {
    return;
  }
}
async function LE({ cwd: e, hostConfig: t, operationSource: n, queryClient: r }) {
  let i = fE(t);
  try {
    try {
      await FE({ cwd: e, hostConfig: t, operationSource: n });
    } catch {}
    let a = await r.fetchQuery(uE(e, i, t, n));
    if (a == null) return;
    (await r.invalidateQueries(
      { queryKey: [...OE(a.commonDir, a.root, i), `review-summary`] },
      { cancelRefetch: !0 },
    ),
      await ME(r, a, { changeType: `head`, hostKey: i }));
  } catch {
    return;
  }
}
...
function BE(e, t, n, r, i, a) {
  ...
  return {
    queryKey:
      t && n ? kE({ metadata: t, method: e, params: n, hostKey: r }) : [`git`, `disabled`, e],
    queryFn: ({ signal: r }) =>
      !t || !n
        ? Promise.reject(Error(`Missing git metadata`))
        : sE(`git`).request({ method: e, params: RE(n, i), signal: r }),
    staleTime: o,
    gcTime: 30 * 601e3,
    ...a,
...
function VE(e, t, n, r, i, a) {
  ...
  let { data: u } = EE(e, t, i, l);
  return tt(BE(n, u, u ? (typeof r == `function` ? r(u) : r) : null, s, t, a));
}
function HE(e, t, n) {
  let r = (0, Er.c)(6),
    i;
  r[0] !== t || r[1] !== e
    ? ((i = async (n) => sE(`git`).request({ method: e, params: zE(n, t) })),
      (r[0] = t),
      (r[1] = e),
      (r[2] = i))
    : (i = r[2]);
...
var UE = `task-stub`,
  ...
  YE = `git-stage`,
  XE = `git-commit`,
  ZE = `git-create-branch`,
  QE = `git-push`,
  $E = `git-create-pr`,
  eD = `pr-auto-fix-progress`,
  tD = `automation-citation`,
  nD = new Set([GE, KE, qE, YE, XE, ZE, QE, $E, eD]),
  rD = g({
    cwd: P().trim().min(1),
...
function oD(e) {
  if (!iD.some((t) => e.includes(`:${t}`))) return [];
  let t = JT(e),
    n = [];
  for (let e of t) {
    if (!iD.includes(e.name)) continue;
    let t = aD(e.name);
    if (t == null) continue;
    let r = rD.safeParse(e.attributes);
    r.success &&
      n.push({
        type: t,
        cwd: r.data.cwd,
...
async function cD({ scope: e, cwd: t, hostConfig: n }) {
  try {
    return await e.queryClient.fetchQuery(uE(t, fE(n), n, `git_action_directives`));
  } catch {
    return null;
  }
}
async function lD({ scope: e, conversationId: t, directives: n, hostConfig: r }) {
  if (n.length === 0) return;
  let i = fE(r),
    a = null,
    o = [],
  ...
  let c = await Promise.all(
    Array.from(s).map(async (t) => ({
      cwd: t,
      metadata: await cD({ scope: e, cwd: t, hostConfig: r }),
    })),
  );
  (await Promise.all(
    c.flatMap(({ metadata: t }) =>
      t == null ? [] : [ME(e.queryClient, t, { changeType: `head`, hostKey: i })],
    ),
  ),
    a != null && IC(t, a));
}
function uD(e, t) {
  t.addTurnCompletedListener((n) => {
    ...
    i.length !== 0 &&
      lD({ scope: e, conversationId: n.conversationId, directives: i, hostConfig: dD(e) });
  });
}
function dD(e) {
...
var fD = _t(B, () => ({
  ...
  queryFn: async () => {
    try {
      ...
      if (e instanceof ft && (e.status === 401 || e.status === 403 || e.status === 404))
        return null;
      throw e;
    }
  },
...
function pD(e, t) {
  t.addNotificationCallback(`error`, (t) => {
    t.params.error.codexErrorInfo === `usageLimitExceeded` && e.query.fetch(fD).catch(() => void 0);
  });
}
var mD = t((e, t) => {
    var n = nu();
...
function xD(e) {
  ...
  if (e.startsWith(hD)) {
    let t = I(e.slice(6));
    return { kind: `local`, key: vD(t), conversationId: t };
  }
  if (e.startsWith(gD)) {
    let t = e.slice(7);
    return { kind: `remote`, key: yD(t), taskId: t };
  }
  if (e.startsWith(_D)) {
    let t = e.slice(17);
    return { kind: `pending-worktree`, key: bD(t), pendingWorktreeId: t };
  }
  return null;
}
function SD({ localId: e, remoteId: t, pendingId: n }) {
  return e ? vD(I(e)) : t ? yD(t) : n ? bD(n) : null;
}
function CD(e) {
  let t = xD(e);
...
function ED({ conversationId: e, hostId: t, projectId: n }) {
  let r = new URLSearchParams({ projectId: n });
  return (t != null && r.set(`hostId`, t), `${Be(e)}?${r.toString()}`);
}
function DD({ threadIds: e, visibleThreadIds: t, nextVisibleThreadIds: n }) {
  let r = new Set(t),
    i = 0,
    a = [];
  for (let t of e) {
...
function OD({ visibleThreadKeys: e, pendingVisibleThreadOrder: t }) {
  return t == null || !PD(t.previousVisibleThreadKeys, e) || !FD(t.nextVisibleThreadKeys, e)
    ? e
    : t.nextVisibleThreadKeys;
}
function kD({ visibleThreadKeys: e, activeThreadKey: t, overThreadKey: n }) {
...
var LD = e(mD(), 1),
  RD = /\p{Extended_Pictographic}|\p{Regional_Indicator}/u,
  zD = [];
function BD() {
...
function VD({ sections: e, sectionId: t, emoji: n, name: r, threadId: i }) {
  let a = r.trim();
  return a.length === 0
    ? e
    : [
        ...(i == null ? e : XD({ sections: e, threadId: i })),
        { id: t, emoji: UD(n), name: a, threadIds: i == null ? [] : [i] },
      ];
}
function HD({ sections: e, sectionId: t, emoji: n, name: r }) {
  let i = r.trim();
...
function GD({ sections: e, sectionId: t }) {
  let n = e.filter((e) => e.id !== t);
  return n.length === e.length ? e : n;
}
function KD({ sections: e, sectionId: t, threadId: n, included: r }) {
...
function qD({ sections: e, sectionId: t, threadId: n, beforeThreadId: r }) {
  if (!e.some((e) => e.id === t)) return e;
  let i = !1,
    a = e.map((e) => {
...
function JD({ sections: e, sectionId: t, visibleThreadIds: n, nextVisibleThreadIds: r }) {
  let i = !1,
    a = e.map((e) => {
      if (e.id !== t) return e;
      let a = DD({ threadIds: e.threadIds, visibleThreadIds: n, nextVisibleThreadIds: r });
      return e.sortKey == null &&
        a.length === e.threadIds.length &&
        a.every((t, n) => t === e.threadIds[n])
        ? e
        : ((i = !0), tO({ section: e, threadIds: a, sortKey: null }));
    });
  return i ? a : e;
}
function YD({ sections: e, sectionId: t, sortKey: n }) {
  let r = !1,
    i = e.map((e) =>
      e.id !== t || (e.sortKey ?? null) === n
        ? e
        : ((r = !0), tO({ section: e, threadIds: e.threadIds, sortKey: n })),
    );
  return r ? i : e;
}
function XD({ sections: e, threadId: t }) {
  let n = !1,
    r = e.map((e) =>
...
function ZD({ sections: e, sourceThreadId: t, targetThreadId: n }) {
  if (t === n) return e;
  let r = !1,
    i = e.map((e) =>
      e.threadIds.includes(t)
        ? ((r = !0),
          { ...e, threadIds: (0, LD.default)(e.threadIds.map((e) => (e === t ? n : e))) })
        : e,
    );
  return r ? i : e;
}
function QD({ items: e, threadIds: t, sortKey: n }) {
  if (t.length === 0) return zD;
  let r = new Map(nO({ items: e, threadIds: t, sortKey: n ?? null }).map((e, t) => [e, t]));
  return e
    .map((e, t) => {
      let n = iO(e);
...
function eO({ items: e, sections: t }) {
  let n = new Map();
  for (let t of e) {
    let e = iO(t);
    if (e == null) continue;
  ...
  let r = [],
    i = new Set();
  for (let a of t)
    for (let t of nO({ items: e, threadIds: a.threadIds, sortKey: a.sortKey ?? null })) {
      let e = n.get(t);
      if (e != null) for (let t of e) i.has(t.task.key) || (i.add(t.task.key), r.push(t));
    }
  return r;
}
function tO({ section: e, threadIds: t, sortKey: n }) {
  if (n == null) {
    let { sortKey: n, ...r } = e;
...
function nO({ items: e, threadIds: t, sortKey: n }) {
  if (n == null) return t;
  let r = new Set(t),
    i = new Set(),
    a = e
      .flatMap((e, t) => {
        ...
        return a == null || !r.has(a) || i.has(a)
          ? []
          : (i.add(a), [{ threadId: a, timestamp: rO(e, n), index: t }]);
      })
...
function sO(e, t) {
  return gO(e, (e) => VD({ sections: e, ...t }));
}
function cO(e, t) {
  return gO(e, (e) => HD({ sections: e, ...t }));
}
function lO(e, t) {
  return gO(e, (e) => GD({ sections: e, sectionId: t }));
}
function uO(e, t) {
  return gO(e, (e) => KD({ sections: e, ...t }));
}
function dO(e, t) {
  return gO(e, (e) => qD({ sections: e, ...t }));
}
function fO(e, t) {
  return gO(e, (e) => JD({ sections: e, ...t }));
}
function pO(e, t) {
  return gO(e, (e) => YD({ sections: e, ...t }));
}
function mO(e, t) {
  return gO(e, (e) => XD({ sections: e, threadId: t }));
}
function hO(e, t) {
  return gO(e, (e) => ZD({ sections: e, ...t }));
}
function gO(e, t) {
  let n = async () => {
      let { value: n } = await mt(`get-global-state`, {
        ...
        i = t(r);
      i !== r && (await gp(e, N.SIDEBAR_CUSTOM_SECTIONS, i));
    },
    r = oO.then(n, n);
  return ((oO = r.catch(() => {})), r);
}
...
function vO(e) {
  e.addTurnCompletedListener((t) => {
    ...
    let a = JT(r),
      o = a.filter((e) => e.name === GE),
      s = a.some((e) => e.name === KE);
...
function SO(e, t) {
  ...
  (t.addNotificationCallback(`remoteControl/status/changed`, ({ params: t }) => {
    TO(e, n, r) && e.set(bO, n, t);
  }),
    t
      .sendRequest(`remoteControl/status/read`, void 0)
      .then((t) => {
        e.get(bO, n) === i && TO(e, n, r) && e.set(bO, n, t);
      })
      .catch((t) => {
        TO(e, n, r) &&
...
function wO(e, t) {
  let n = yO.get(e);
  n ?? ((n = new Map()), yO.set(e, n));
  let r = (n.get(t) ?? 0) + 1;
  return (n.set(t, r), r);
}
function TO(e, t, n) {
  return yO.get(e)?.get(t) === n;
}
function EO(e, t) {
  return (
    PO({ initialValue: t, key: e }),
    {
      cache: `signal`,
      resolve(t, n) {
        return MO.resolve(t, n, e).value$.atom;
      },
      scope: B,
    }
  );
...
var OO = new Map(),
  ...
  AO = !1,
  jO = st(B, []),
  MO = ut(B, (e, { signal: t }) => ({ key: e, value$: t(void 0) }));
function NO(e) {
  return (
    kO.add(e),
    e(Array.from(OO.values())),
    () => {
      kO.delete(e);
    }
  );
...
function PO(e) {
  OO.has(e.key) || (OO.set(e.key, e), FO());
}
function FO() {
  AO ||
    ((AO = !0),
...
function IO() {
  let e = Array.from(OO.values());
  kO.forEach((t) => t(e));
}
var LO = `https://chatgpt.com/cyber`,
  RO = `gpt-5.4`,
  zO = [`error`, `model/verification`],
  BO = `cyber-safety-composer-banner:repeated-blocks-last-shown-at`,
  VO = { dismissedEventId: null, event: null },
  HO = V(B, (e) => VO, void 0, { key: ({ conversationId: e, hostId: t }) => `${t}:${e}` }),
  UO = EO(BO, null);
function WO(e, t) {
  t.addNotificationCallback(zO, (n) => {
    let r = JO(n);
    r != null && GO(e, { conversationId: r.conversationId, hostId: t.getHostId() }, r);
  });
}
function GO(e, t, n, r = Date.now()) {
  qO(n.variant, e.get(UO), r) &&
    (e.set(HO, t, (e) => ({ ...e, event: { ...n, eventId: (e.event?.eventId ?? -1) + 1 } })),
    n.variant === `repeated_blocks` && e.set(UO, r));
}
function KO(e, t, n) {
  e.set(HO, t, (e) => ({ ...e, dismissedEventId: n }));
}
function qO(e, t, n) {
...
var QO = `unread-thread-ids-by-host-v1`,
  $O = {},
  ek = EO(QO, $O);
function tk(
  e,
...
function nk(e) {
  return e.get(ek) ?? _r(QO, $O);
}
var rk = { cwd: null, diff: null, turnId: null },
  ik = V(B, (e) => {
  ...
  ok = R(B, (e, { get: t }) => t(t(ak, e).state$)),
  sk = R(B, (e, { get: t }) => t(t(ak, e).error$)),
  ck = R(B, (e, { get: t }) => t(t(ak, e).appServerVersion$)),
  lk = R(B, (e, { get: t }) => t(t(ak, e).installedCodexVersion$)),
  uk = $e(B, ({ get: e }) => {
    let t = e(fk, is);
  ...
  vk = st(B, null, {
    onMount: (e, t) =>
      t.watch(({ get: t }) => {
        let n = t(hk).map((t) => t.addTurnCompletedListener(e));
        return () => {
          for (let e of n) e();
        };
      }),
  ...
  Dk = $(({ updatedAt: e }) => e),
  Ok = $(({ cwd: e }) => e ?? null),
  kk = $(({ gitInfo: e }) => e?.branch?.trim() || null),
  Ak = $(({ hasUnreadTurn: e }) => e),
  jk = $(({ unreadMessageCount: e }) => e ?? 0),
  Mk = $(({ turns: e }) => e.at(-1)?.status === `inProgress`),
  Nk = $(
  ...
  Fk = $(({ latestCollaborationMode: e }) => e),
  Ik = $(({ modelProvider: e }) => e ?? null),
  Lk = $(({ latestModel: e }) => e),
  Rk = $(({ latestReasoningEffort: e }) => e),
  zk = $(({ requests: e }) => e.at(-1) ?? null),
  Bk = $(({ latestTokenUsageInfo: e, resumeState: t }) => (t === `resumed` ? e : null)),
  Vk = $(({ requests: e }) => e.length),
  Hk = $(({ requests: e }) => e),
  Uk = $(f_),
  Wk = $(({ resumeState: e }) => e),
  Gk = $(({ rolloutPath: e }) => e),
  Kk = $(({ source: e }) => e ?? null),
  qk = $(({ source: e }) => q(e)?.parentThreadId ?? null),
  Jk = $(({ title: e }) => e),
  Yk = $(({ completedThreadGoal: e }) => e ?? null),
  Xk = $(({ threadGoal: e }) => e ?? null),
  Zk = $(({ threadGoalResumeConfirmation: e }) => e ?? null),
  Qk = $(({ threadRuntimeStatus: e }) => e ?? null),
  $k = $(({ turns: e }) => e.length),
  eA = $(({ turns: e }) => e.at(-1) ?? null),
  tA = $(({ turns: e }) => AA(e).diff),
  nA = $(({ turns: e }) => AA(e).cwd),
  rA = $(({ turns: e }) => e.at(-1)?.turnId ?? null),
  iA = $(({ turns: e }) => e.at(-1)?.status ?? null),
  aA = $(({ turns: e }) => e.at(-1)?.items.some((e) => e.type === `error` && !e.willRetry) === !0),
  oA = $(({ turns: e }) => e),
  sA = $(({ workspaceKind: e }) => e),
  cA = $(({ workspaceBrowserRoot: e }) => e ?? null),
  lA = $(({ projectlessOutputDirectory: e }) => e ?? null),
  uA = $e(B, ({ get: e }) => e(uk).getHostId()),
  dA = R(B, (e, { get: t }) => {
    let n = t(hk),
      r = OA(t, e),
  ...
  fA = R(B, (e, { get: t }) => t(dA, e)?.getHostId() ?? t(uA)),
  pA = V(B, (e) => null, {
    onMount: (e, t) => {
      let { key: n } = t;
      if (n != null)
  ...
  mA = R(B, (e, { get: t }) =>
    e == null ? !1 : !t(Ck, e) || t(Wk, e) === `needs_resume` || t(pA, e) == null,
  );
function hA(e) {
  return e == null
    ? []
...
var gA = R(B, (e, { get: t }) => {
    let n = t(Wk, e);
    if (n == null) return !1;
    if (n === `needs_resume`) return t(Qk, e)?.type === `active`;
    if (t($k, e) === 0) return n === `resuming`;
    let r = t(eA, e);
    return r == null ? !0 : r.status === `inProgress`;
  }),
  _A = $e(B, ({ get: e }) => e(wk, is).some((t) => e(gA, t))),
  vA = $e(B, ({ get: e }) => {
    let t = 0;
    for (let n of e(wk, is)) e(Ak, n) === !0 && e(qk, n) == null && (t += 1);
    return t;
  });
function yA(e, t) {
  if (t == null) return null;
  let n = OA(e.get, t);
  return (
    (n == null ? null : e.get(fk, n)) ?? e.get(hk).find((e) => e.getConversation(t) != null) ?? null
  );
}
var bA = st(B, 0);
function xA(e, t) {
...
function SA(e, { error: t, hostId: n, source: r = `unknown`, state: i }) {
  let a = e.get(ak, n),
    o = xA(e, n),
  ...
  (z.info(`remote_connections.manager_state_set`, {
    ...
    aa(e, { error: s, hostId: n, previousError: o.error, previousState: o.state, state: i }),
    a.state$.set(i),
    a.error$.set(s));
}
function CA(e, { appServerVersion: t, hostId: n, installedCodexVersion: r }) {
  let i = e.get(ak, n);
...
function DA(e, t) {
  return t == null ? null : e(TA, t);
}
function OA(e, t) {
  return DA(e, t) ?? kA(e, t);
}
function kA(e, t) {
  if (t == null) return null;
  let n = _p(e, N.THREAD_PROJECT_ASSIGNMENTS)?.[t];
...
function AA(e) {
  ...
  for (let t = e.length - 1; t >= 0; --t) {
    let i = e[t];
    if (i != null && ((r ??= MA(i)), (n ??= NA(i)), r != null && n != null)) break;
  }
...
function PA(e) {
  ...
  for (let r of e.items) {
    ...
    r.type !== `fileChange` ||
      ...
      r.status === `declined` ||
      r.changes.length === 0 ||
      t.push({ changes: i_(r.changes), cwd: n });
  }
  return t;
}
function $(e) {
