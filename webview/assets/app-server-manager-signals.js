...
function ih(e) {
  let t = oh(e),
    n = sh(e),
    r = { [Cf]: nn(e, `2380644311`, { disableExposureLog: !0 }) };
  return {
    ...t,
    ...n,
    [Xm]:
      nn(e, Zm, { disableExposureLog: !0 }) &&
      an(e, Ym, { disableExposureLog: !0 }).groupName === `Test`,
    ...r,
  };
}
function ah(e) {
...
function oh(e) {
  let t = {};
  for (let n of th) nn(e, n.gateName, { disableExposureLog: !0 }) && (t[n.featureKey] = !0);
  return t;
}
function sh(e) {
  let t = {};
  for (let n of nh) {
    let r = ah(tn(e, n.name, { disableExposureLog: !0 }).get(n.param, {}));
    for (let [e, i] of Object.entries(r)) n.featureAllowlist.has(e) && (t[e] = i);
  }
  for (let n of rh) {
    let r = tn(e, n.layerName, { disableExposureLog: !0 }).get(n.param, null);
