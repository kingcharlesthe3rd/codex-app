...
import { t as Je, v as Ye } from "./lib-1.js";
...
import { r as pt } from "./lib-2.js";
import { g as mt, h as ht, l as gt, t as _t, v as vt } from "./persisted-signal.js";
import { n as yt, t as bt } from "./rpc-2.js";
import { _ as xt, f as St, i as Ct, m as wt, n as Tt, r as Et } from "./statsig.js";
import { o as Dt, s as Ot, t as kt } from "./request.js";
function At(e) {
  return e;
}
var jt = new (class {
...
function lm(e, t, n) {
  if (e.turns.length === 0)
    return (
      B.error(`No turns for conversation`, { safe: { conversationId: e.id }, sensitive: {} }), null
    );
...
async function iv(e, t) {
  try {
    return (
      await e(`set-global-state`, { params: { key: F.PROJECTLESS_THREAD_IDS, value: [...t] } }), !0
    );
  } catch (e) {
    return (
      B.error(`Error saving projectless thread id`, { safe: {}, sensitive: { error: e } }), !1
    );
  }
}
var av = De(P(), P()),
