import { R as e, o as t, p as n, t as r } from "./app-scope.js";
import { u as i } from "./vscode-api.js";
import { b as a } from "./src-4.js";
import { a as o, i as s } from "./setting-storage.js";
...
var d = e(),
  f = `codex`;
function p(e, t = l) {
  return t.find((t) => t.id === e) ?? t.find((e) => e.id === f) ?? t[0] ?? l[0];
}
function m(e) {
  let n = (0, d.c)(9),
    i = t(r),
    c = o(a.selectedAvatarId),
    l;
  n[0] !== e || n[1] !== c ? ((l = p(c, e)), (n[0] = e), (n[1] = c), (n[2] = l)) : (l = n[2]);
  let u;
  n[3] === i
    ? (u = n[4])
    : ((u = (e) => {
        s(i, a.selectedAvatarId, e);
      }),
      (n[3] = i),
      (n[4] = u));
  let f;
  return (
    n[5] !== c || n[6] !== l || n[7] !== u
      ? ((f = { selectedAvatar: l, selectedAvatarId: c, setSelectedAvatarId: u }),
        (n[5] = c),
        (n[6] = l),
        (n[7] = u),
        (n[8] = f))
...
var h = [`custom-avatars`],
  g = n(r, () => ({
    queryKey: h,
    queryFn: () => c.customAvatars.load(),
    enabled: !0,
    refetchOnMount: !1,
    refetchOnWindowFocus: !1,
    staleTime: i.INFINITE,
  }));
export { u as a, l as i, g as n, m as r, h as t };
