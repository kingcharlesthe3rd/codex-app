import { Z as e, m as t, o as n, p as r, t as i } from "./app-scope-CWE-zIhQ.js";
import { u as a } from "./vscode-api.js";
import { x as o } from "./src-3.js";
...
function g(e) {
  let t = (0, f.c)(9),
    ...
    l;
  t[0] !== e || t[1] !== a ? ((l = m(a, e)), (t[0] = e), (t[1] = a), (t[2] = l)) : (l = t[2]);
  let u;
  t[3] === r
    ? (u = t[4])
    : ((u = (e) => {
        c(r, o.selectedAvatarId, e);
      }),
      (t[3] = r),
      (t[4] = u));
  let d;
