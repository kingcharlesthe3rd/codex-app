...
import { Z as r, a as i, c as a, g as o, o as s, s as c, t as l } from "./app-scope-CWE-zIhQ.js";
import { W as u, wr as d } from "./thread-context-inputs.js";
import { f, p } from "./vscode-api.js";
import { On as m, ei as h } from "./src.js";
import { t as g } from "./react-dom.js";
import { i as _, l as v, r as y, s as b } from "./lib-1.js";
import { a as x, l as S } from "./persisted-atom-store.js";
import { t as C } from "./clsx.js";
import { t as w } from "./proxy.js";
import { H as T, J as E } from "./single-value.js";
import {
  $ as D,
  B as O,
  C as k,
...
import { n as Ne, r as Pe, t as Fe } from "./use-transform.js";
import { t as Ie } from "./AnimatePresence.js";
import { t as Le } from "./button-oF-qgtAS.js";
import { r as Re } from "./reduced-motion-preference-BFM-v_UB.js";
import { t as ze } from "./spinner.js";
import { n as Be } from "./window-zoom-context.js";
import { t as Ve } from "./use-stable-callback.js";
import { t as He } from "./tooltip-B.js";
import { t as Ue } from "./context-menu.js";
import { n as We } from "./rpc.js";
import { t as Ge } from "./get-resize-observer-entry-size-DrKQ-0pS.js";
import {
  a as Ke,
  d as qe,
  f as Je,
...
import { f as X, l as nt, s as rt } from "./persisted-signal.js";
import { t as it } from "./constants.js";
import { t as at } from "./use-platform.js";
import { t as ot } from "./arrow-left.js";
import { t as st } from "./browser-sidebar-manager.js";
import { i as ct, r as lt, t as ut } from "./app-shell-tab-controller.js";
import { a as dt, l as ft, r as pt, t as mt } from "./error-boundary.js";
import { n as ht } from "./app-identity.js";
import { t as gt } from "./download.js";
import { t as _t } from "./with-window.js";
import { i as vt } from "./sidebar-thread-keys.js";
import { r as yt, t as bt } from "./use-window-controls-safe-area.js";
import { r as xt } from "./modal-controller-state.js";
import {
  a as St,
  d as Ct,
  i as wt,
...
import { E as kt } from "./sidebar-project-group-signals.js";
import { r as At } from "./run-command.js";
import { t as jt } from "./use-register-command-T-86rz-c.js";
import { r as Mt } from "./sidebar-thread-row-signals-ZqNv-_WT.js";
import { a as Nt } from "./command-keybindings.js";
import { t as Pt } from "./loading-page.js";
import { i as Ft, n as It, r as Lt, t as Rt } from "./sortable.esm.js";
import { n as zt, r as Bt } from "./use-resize-observer.js";
import { t as Vt } from "./collapse.js";
import { t as Ht } from "./expand.js";
import { a as Ut, t as Wt } from "./keyboard-modifier-state.js";
import { t as Gt } from "./use-merged-ref-BRG4-SOQ.js";
import { t as Kt } from "./app-shell-bottom-panel-scroll-sync.js";
import { a as qt, r as Jt, t as Yt } from "./image-preview-shortcuts.js";
import { n as Xt, t as Zt } from "./app-shell-ref.js";
var Z = e(t(), 1);
function Qt(e, t, n) {
...
var Q = n(),
  ...
  $ = r(),
  tn = `color-mix(in srgb, var(--color-token-foreground) 5%, var(--color-token-main-surface-primary))`,
  nn = `min(32rem, var(--radix-tooltip-content-available-width), calc(100vw - 16px))`,
  rn = 100;
function an(e) {
  let t = (0, $.c)(87),
    n,
  ...
  t[20] === z
    ? (B = t[21])
    : ((B = C(`block w-full min-w-0 whitespace-nowrap`, z)), (t[20] = z), (t[21] = B));
  let V;
  t[22] !== B || t[23] !== R || t[24] !== _
    ? ((V = (0, Q.jsx)(`span`, { ref: R, className: B, children: _ })),
      (t[22] = B),
      (t[23] = R),
      (t[24] = _),
      (t[25] = V))
  ...
  t[26] === u
    ? (U = t[27])
    : ((U = { ...u, "--app-shell-tab-background": tn }), (t[26] = u), (t[27] = U));
  let W = U,
    G;
  t[28] === l
    ? (G = t[29])
    : ((G = (e) => {
      ...
      (t[28] = l),
      (t[29] = G));
  let K = P && `group-hover/tab:bg-[var(--app-shell-tab-background)]`,
    q = P && (S || x) && `bg-[var(--app-shell-tab-background)]`,
    J;
  t[30] !== K || t[31] !== q
    ? ((J = C(`pointer-events-none absolute inset-0 z-0 rounded-md`, K, q)),
      (t[30] = K),
      (t[31] = q),
      (t[32] = J))
    : (J = t[32]);
  let Y;
  t[33] === J ? (Y = t[34]) : ((Y = (0, Q.jsx)(`div`, { className: J })), (t[33] = J), (t[34] = Y));
  let ee = w && b == null && `pe-2`,
    te = S && `text-token-text-primary`,
    ne = !S && `text-token-text-secondary`,
    re;
  t[35] !== ee || t[36] !== te || t[37] !== ne
    ? ((re = C(`no-drag relative flex flex-1 items-center gap-2 z-10 text-sm min-w-0`, ee, te, ne)),
      (t[35] = ee),
      (t[36] = te),
      (t[37] = ne),
      (t[38] = re))
    ...
    ? ((ae =
        ...
        (0, Q.jsxs)(`span`, {
          ...
          children: [
            a != null &&
              (0, Q.jsx)(`span`, {
                className: C(`flex size-full items-center justify-center`, F && `opacity-30`),
                children: a,
              }),
            F &&
              (0, Q.jsx)(`span`, {
  ...
  t[47] !== x || t[48] !== H || t[49] !== y
    ...
    : (oe = t[50]);
  let se;
  t[51] !== I || t[52] !== S || t[53] !== k || t[54] !== P
    ? ((se =
        k &&
        (0, Q.jsx)(`span`, {
          className: C(
            `pointer-events-none absolute inset-y-0 end-0 z-20 w-2 bg-linear-to-r from-transparent to-100%`,
            I ? `to-[var(--app-shell-tab-background)]` : `to-token-main-surface-primary`,
            P && !S && `group-hover/tab:to-[var(--app-shell-tab-background)]`,
          ),
        })),
      (t[51] = I),
      (t[52] = S),
  ...
  t[59] !== N || t[60] !== b
    ? ((le =
        b != null &&
        (0, Q.jsx)(`span`, {
          className: C(`-ms-1.5 flex shrink-0 items-center`, N && `group-hover/tab:opacity-0`),
          children: b,
        })),
      (t[59] = N),
      (t[60] = b),
  ...
  t[76] !== b
    ? ((de =
        ...
        (0, Q.jsx)(`button`, {
          ...
          onMouseDown: sn,
          onPointerDown: on,
          children: (0, Q.jsx)(en, { className: `icon-xs relative` }),
        })),
      (t[70] = O),
      (t[71] = S),
      (t[72] = w),
...
function cn(e) {
  ...
  t[0] !== n || t[1] !== l
    ...
    : (S = t[2]);
  let T;
  t[3] !== m || t[4] !== S || t[5] !== o.dndId
    ? ((T = { data: S, disabled: m, id: o.dndId, strategy: Lt }),
      (t[3] = m),
      (t[4] = S),
      (t[5] = o.dndId),
      (t[6] = T))
  ...
  t[16] === R
    ...
    : ((z = C(
      ...
      (t[17] = z));
  let B;
  t[18] === j ? (B = t[19]) : ((B = Ze.Translate.toString(j)), (t[18] = j), (t[19] = B));
  let V;
  t[20] !== B || t[21] !== M
  ...
  let K;
  t[52] !== I || t[53] !== G
    ? ((K = (0, Q.jsx)(Ue, { getItems: I, children: G })), (t[52] = I), (t[53] = G), (t[54] = K))
    : (K = t[54]);
...
function dn(e, t) {
  let n = e.get(t.sourceController.tabIds$),
    r = n.indexOf(t.tabId);
  r !== -1 &&
    (r !== t.sourceIndex && e.set(t.sourceController.tabIds$, It(n, r, t.sourceIndex)),
...
function fn(e, t, n, r) {
  let i = e.get(t.tabIds$),
    a = i.indexOf(n),
    o = i.indexOf(r);
  a === -1 || o === -1 || a === o || e.set(t.tabIds$, It(i, a, o));
}
function pn(e, t, n, r) {
...
var gn = `data-tab-preview-pin-exempt`;
function _n(e) {
  let t = (0, $.c)(20),
    {
      afterList: n,
    ...
    f = (0, Z.useContext)(un)?.dragState ?? null,
    p;
  t[0] !== s || t[1] !== f || t[2] !== l
    ? ((p = hn(l, s, f)), (t[0] = s), (t[1] = f), (t[2] = l), (t[3] = p))
    : (p = t[3]);
  let m = p,
    h = u?.tabId ?? null,
    g;
  ...
  t[12] !== u || t[13] !== d || t[14] !== s || t[15] !== a
    ? ((_ =
        u == null
          ...
          : (0, Q.jsx)(Cn, { controller: s, tab: u }, d)),
      (t[12] = u),
      (t[13] = d),
      (t[14] = s),
      (t[15] = a),
...
function vn(e) {
  ...
  t[2] !== _ || t[3] !== v
    ...
    : (y = t[4]);
  let { setNodeRef: b } = tt(y),
    x = (0, Z.useContext)(un)?.dragState ?? null,
    S,
    w,
    T,
    E,
  ...
  if (
    ...
    let e = c.map(bn),
      r;
    t[32] === c ? (r = t[33]) : ((r = c.map(yn)), (t[32] = c), (t[33] = r));
    let i = r;
    ...
    (t[43] === v
      ...
      t[47] === h
        ? (j = t[48])
        : ((j = (0, Q.jsx)(xn, { onVisibleChange: u, root: h })), (t[47] = h), (t[48] = j)),
      (S = Rt),
      (R = i),
      (z = Lt),
      (P = `tablist`));
      ...
      (L = c.map((t) => {
        ...
        return (0, Q.jsx)(
          cn,
          {
            ...
            isActive: r,
            separatorIndex: i,
            showTrailingSeparator: i < e.length - 1 && !r && !Sn(i, d),
            tab: t,
          },
          t.tabId,
        );
  ...
  let H;
  t[62] !== w || t[63] !== h
    ? ((H = (0, Q.jsx)(xn, { onVisibleChange: f, root: h, rootMargin: w })),
      (t[62] = w),
      (t[63] = h),
      (t[64] = H))
    : (H = t[64]);
...
var Cn = (0, Z.memo)(function (e) {
  ...
  t[0] !== n || t[1] !== i || t[2] !== r.isPreview || t[3] !== r.tabId
    ? ((a = (e) => {
        Tn(e.nativeEvent) || (r.isPreview && n.pinTab(i, r.tabId));
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = r.isPreview),
  ...
  let p;
  t[13] !== f || t[14] !== r.tabId
    ? ((p = (0, Q.jsx)(mt, { name: `AppShellTabPanel`, resetKey: d, fallback: En, children: f })),
      (t[13] = f),
      (t[14] = r.tabId),
      (t[15] = p))
    : (p = t[15]);
  ...
  return (
    t[2] === n
      ...
      : ((a = (0, Q.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, Q.jsx)(Le, { color: `secondary`, size: `default`, onClick: n, children: i }),
          ],
        })),
        (t[2] = n),
        (t[3] = a)),
...
function Tn(e) {
  return e.composedPath().some((e) => e instanceof Element && e.hasAttribute(gn));
}
function En(e) {
  return (0, Q.jsx)(wn, {
    onRetry: () => {
...
function On() {
  let e = (0, $.c)(17),
    ...
    n = v(),
    r = c(N),
    a = i(Nt, `toggleMaximizeSidePanel`),
    o;
  e[0] !== n || e[1] !== r
    ? ((o = r
        ? n.formatMessage({
  ...
  (e[3] !== r || e[4] !== t
    ? ((u = () => {
      ...
      (e[5] = u))
    : (u = e[5]),
    jt(`toggleMaximizeSidePanel`, u));
  let d = r ? `secondary` : `ghost`,
    f;
  e[6] === r
    ? (f = e[7])
    : ((f = r
        ? (0, Q.jsx)(Vt, { className: `icon-xs` })
        : (0, Q.jsx)(Ht, { className: `icon-xs` })),
      (e[6] = r),
      (e[7] = f));
  let p;
  ...
  return (
    e[13] !== l || e[14] !== a || e[15] !== p
      ? ((m = (0, Q.jsx)(He, { tooltipContent: l, shortcut: a, delayOpen: !0, children: p })),
        (e[13] = l),
        (e[14] = a),
        (e[15] = p),
        (e[16] = m))
...
function kn() {
  return At(`toggleMaximizeSidePanel`, `side_panel_full_width_button`);
}
function An() {
  let e = c(J),
    t = c(q),
    ...
    i = c(N),
    a = c(ke),
    { headerLeftWidth: o, headerRightWidth: s } = ie(),
    l = $t`max(0px, calc(${s}px)`;
  return (0, Q.jsx)(_n, {
...
function Mn(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Q.jsx)(b, {
        ...
        defaultMessage: `{appName} will quit to install the update, which will interrupt active local sessions on this machine`,
  ...
  t[4] === n
    ? (c = t[5])
    : ((c = (e) => {
        (e.preventDefault(), n(), We.appUpdates?.installUpdate());
      }),
      (t[4] = n),
      (t[5] = c));
  let l, u;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(Ct, { className: `sr-only`, children: i })),
      (u = (0, Q.jsx)(Ot, { className: `sr-only`, children: o })),
      (t[6] = l),
      (t[7] = u))
    : ((l = t[6]), (u = t[7]));
  let d;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(St, { children: (0, Q.jsx)(wt, { title: i, subtitle: o }) })), (t[8] = d))
    : (d = t[8]);
  let f;
  ...
  t[10] === n
    ? (p = t[11])
    : ((p = (0, Q.jsx)(Le, { color: `secondary`, onClick: n, children: f })),
      (t[10] = n),
      (t[11] = p));
  let m;
  ...
  t[13] === p
    ? (h = t[14])
    : ((h = (0, Q.jsx)(St, { children: (0, Q.jsxs)(Dt, { children: [p, m] }) })),
      (t[13] = p),
      (t[14] = h));
  let g;
  t[15] !== h || t[16] !== c
    ? ((g = (0, Q.jsxs)(Et, { as: `form`, onSubmit: c, children: [l, u, d, h] })),
      (t[15] = h),
      (t[16] = c),
      (t[17] = g))
    : (g = t[17]);
...
function In() {
  return yt() && window.electronBridge?.showApplicationMenu != null;
}
var Ln = _({
    file: {
  ...
  Rn = [
    { id: m.file, message: Ln.file },
    { id: m.edit, message: Ln.edit },
    { id: m.view, message: Ln.view },
    { id: m.help, message: Ln.help },
  ];
function zn() {
  let e = v(),
  ...
  return (0, Q.jsx)(`div`, {
    ...
    children: Rn.map(({ id: n, message: r }) =>
      (0, Q.jsx)(
        `button`,
        {
          type: `button`,
...
var Hn = o(l, Bn),
  Un = o(l, { width: window.innerWidth, height: window.innerHeight }),
  Wn = {
    px$: a(l, ({ get: e }) => e(Hn).x),
    py$: a(l, ({ get: e }) => e(Hn).y),
    hasKnownVelocity$: a(l, ({ get: e }) => e(Hn).hasKnownVelocity),
    vx$: a(l, ({ get: e }) => e(Hn).velocityX),
    vy$: a(l, ({ get: e }) => e(Hn).velocityY),
    speed$: a(l, ({ get: e }) => e(Hn).speed),
    ...
    ? ((w = () => {
        ...
        let e = (e) => ({ x: e.clientX / d, y: e.clientY / d }),
          t = (t) => {
            ...
            if (n == null) return;
            let r = e(t);
            ((h ? r.x : r.y) !== n.startPosition && (n.didMove = !0), c(Kn(u, r, n)));
          },
          n = (t) => {
            t.preventDefault();
            let n = m.current;
...
var Jn = (e) =>
  ...
  Zn = o(l, !1),
  Qn = a(l, ({ get: e }) => {
    let { automationThreadIds: t, unreadRunCount: n } = e(Mt);
    return (
      n +
      e(kt).filter((e) => {
        let n = vt(e);
...
function $n(e) {
  ...
  let { hideUnreadBadge: r, onToggleSidebar: a } = n,
    ...
    g = c(Xn),
    _ = c(Zn),
    y = i(Nt, `toggleSidebar`),
    x = i(Nt, `navigateBack`),
    S = i(Nt, `navigateForward`),
    C;
  t[2] !== d || t[3] !== f
    ? ((C = f
        ? d.formatMessage({
  ...
  (t[5] === u
    ? ((D = t[6]), (O = t[7]))
    : ((D = () => () => {
        (u.set(ce, !1), u.set(me, !1), u.set(ae, !1));
      }),
      (O = [u]),
      (t[5] = u),
      (t[6] = D),
  ...
  t[9] !== a || t[10] !== u
    ? ((j = () => {
        if ((u.set(ae, !0), a != null)) {
          a();
          return;
        }
        At(`toggleSidebar`, `sidebar_trigger`);
      }),
      (t[9] = a),
      (t[10] = u),
      (t[11] = j))
  ...
  t[28] !== y
    ...
    : (L = t[29]);
  let R;
  t[30] === d ? (R = t[31]) : ((R = d.formatMessage(rr.navigateBack)), (t[30] = d), (t[31] = R));
  let z = !g,
    B;
  t[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, Q.jsx)(b, { ...rr.navigateBack })), (t[32] = B))
    : (B = t[32]);
  let V;
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, Q.jsx)(ot, { className: `icon-xs` })), (t[33] = V))
    : (V = t[33]);
  let H;
  t[34] !== x || t[35] !== R || t[36] !== z
    ...
    : (H = t[37]);
  let U;
  t[38] === d ? (U = t[39]) : ((U = d.formatMessage(rr.navigateForward)), (t[38] = d), (t[39] = U));
  let W = !_,
    G;
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, Q.jsx)(b, { ...rr.navigateForward })), (t[40] = G))
    : (G = t[40]);
  let K;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, Q.jsx)(ot, { className: `icon-xs -scale-x-100` })), (t[41] = K))
    : (K = t[41]);
  let q;
...
function er() {
  return At(`navigateForward`, `sidebar_forward`);
}
function tr() {
  return At(`navigateBack`, `sidebar_back`);
}
function nr(e) {
  let t = (0, $.c)(17),
    {
...
var rr = _({
  ...
  ir = 280,
  ar = `app-shell:bottom-panel-height`;
function or(e, t) {
  return Number.isFinite(e) ? Math.max(160, Math.min(e, t * 0.5)) : ir;
}
function sr(e) {
  return or(x(ar, 280), e);
}
function cr(e, t) {
  S(ar, or(e, t));
}
...
function fr({
  ...
  let a = s(X),
    { isMounted: o, opacity: l, animatedSize: u } = lr({ animation: c(De), size: n, isVisible: i }),
    d = $t`${n}px`;
  return !o && !i
    ? null
    : (0, Q.jsxs)(w.div, {
...
function pr() {
  let e = (0, $.c)(33),
    ...
    a = c(z),
    o = c(lt.activeTab$),
    l = (0, Z.useSyncExternalStore)(qt, Yt, Yt),
    u = c(ve),
    d,
    m,
    g;
  if (e[0] !== n || e[1] !== o || e[2] !== t) {
    ...
    ((m = r != null),
      ...
      (e[4] = m),
      (e[5] = g));
  } else ((d = e[3]), (m = e[4]), (g = e[5]));
  let _ = g,
    v = u && ((o?.isClosable ?? !1) || _ != null),
    y = r && ((n?.isClosable ?? !1) || d != null),
    b;
  e[6] === d
    ? (b = e[7])
    : ((b = () => (d == null ? null : st.getSnapshot(d.conversationId, d.browserTabId))),
      (e[6] = d),
      (e[7] = b));
  let x = b,
    S;
  e[8] === _
    ? (S = e[9])
    : ((S = () => (_ == null ? null : st.getSnapshot(_.conversationId, _.browserTabId))),
      (e[8] = _),
      (e[9] = S));
  let C = S,
    w = (0, Z.useSyncExternalStore)(st.subscribe, x, x),
    T = (0, Z.useSyncExternalStore)(st.subscribe, C, C),
    E = w?.tabType === h.WEB,
    D = T?.tabType === h.WEB,
  ...
  (e[25] === Symbol.for(`react.memo_cache_sentinel`) ? ((F = []), (e[25] = F)) : (F = e[25]),
    p(`image-preview-zoom-command`, mr, F));
  let I, L;
  return (
    e[26] !== n || e[27] !== d || e[28] !== o || e[29] !== _ || e[30] !== t
      ? ((I = (e) => {
          let { panelId: r } = e;
          bb95: switch (r) {
            case `bottom`:
              if (ut.closeActiveTab(t)) break bb95;
              d != null && n != null && ut.closeTab(t, n.tabId);
              break bb95;
            case `right`:
              if (lt.closeActiveTab(t)) break bb95;
              _ != null && o != null && lt.closeTab(t, o.tabId);
          }
        }),
        (L = [n, d, o, _, t]),
        (e[26] = n),
        ...
        (e[32] = L))
      : ((I = e[31]), (L = e[32])),
    p(`close-active-app-shell-tab`, I, L),
    null
  );
}
function mr(e) {
...
var vr = `[&_a]:pointer-events-auto [&_button]:pointer-events-auto [&_input]:pointer-events-auto [&_select]:pointer-events-auto [&_textarea]:pointer-events-auto`;
function yr({ isHeaderEdgeScroll: e, isApplicationMenuBarEnabled: t }) {
  let {
      headerLeftWidth: n,
      headerRightWidth: r,
    ...
    _ = d.filter(({ align: e }) => e === `center`),
    v = d.filter(({ align: e }) => e === `end`),
    y = d.length > 0,
    b = g.length > 0,
    x = _.length > 0,
    S = v.length > 0,
  ...
  return (0, Q.jsx)(Ue, {
    ...
    children: (0, Q.jsxs)(w.header, {
      ...
      style: t ? { left: s } : {},
      children: [
        (0, Q.jsx)(br, { entries: p, fitWidth: n, slotWidth: t ? o : i, side: `start` }),
        E &&
          (0, Q.jsxs)(`div`, {
            "aria-hidden": h,
            ...
            children: [
              u != null &&
                (0, Q.jsx)(`div`, {
                  className: C(`pointer-events-none w-full min-w-0 flex-1`, vr),
                  children: u,
                }),
              b &&
                (0, Q.jsx)(`div`, {
        ...
        x
          ...
          : null,
        (0, Q.jsx)(br, { entries: m, fitWidth: r, slotWidth: l, side: `end` }),
      ],
    }),
  });
}
function br({ entries: e, fitWidth: t, side: n, slotWidth: r }) {
  ...
  return (0, Q.jsxs)(Q.Fragment, {
    children: [
      ...
      (0, Q.jsx)(w.div, {
        ...
        style: { width: r, minWidth: $t`${t}px` },
        children: (0, Q.jsx)(xr, { entries: e, fillSlot: !0 }),
      }),
    ],
  });
}
function xr(e) {
  ...
  if (t[0] !== n || t[1] !== i) {
    ...
    (t[6] === u
      ? (a = t[7])
      : ((a = C(`inline-flex h-full items-center gap-1.5`, u)), (t[6] = u), (t[7] = a)),
      (o = e.map(wr)),
      (s =
        r.length > 0
          ? (0, Q.jsx)(`div`, {
  ...
  return (
    t[8] !== a || t[9] !== o || t[10] !== s || t[11] !== c
      ? ((l = (0, Q.jsxs)(`div`, { className: a, children: [o, s, c] })),
        (t[8] = a),
        (t[9] = o),
        (t[10] = s),
        (t[11] = c),
...
function Or({ children: e, paddingTop: t }) {
  let n = s(l),
    { leftPanelAnimatedWidth: r, leftPanelWidth: i } = ie(),
    [a, o] = (0, Z.useState)(!1),
    u = c(Te),
    d = $t`${i}px`;
  return (0, Q.jsxs)(w.aside, {
    ...
    children: [
      (0, Q.jsx)(w.div, {
        ...
        style: { minWidth: d, width: d, opacity: c(re) },
        children: e,
      }),
      (0, Q.jsx)(Gn, {
        disabled: u,
...
function kr({
  ...
  let o = s(X),
    ...
    h = $t`${r}px`,
    {
      ...
      animatedSize: v,
      progress: y,
    } = lr({ animation: f, size: r, isVisible: t });
  return (
    Qt(y, `change`, () => {
      p.set(p.get() + 1);
    }),
...
function jr(e, t) {
  ...
  let r = E(Ae({ ...e, mainContentWidth: t.get() }));
...
function Nr(e) {
  ...
  t[5] === r
    ? (h = t[6])
    : ((h = (e) => {
        let t = Ir(e.active.data.current);
  ...
  t[7] !== o || t[8] !== r
    ? ((_ = (e) => {
        ...
        let n = Ir(e.over?.data.current);
        if (n != null)
          if (n.kind === `app-shell-tab`) {
            if (n.tabId === t.tabId) return;
            if (n.controller === t.sourceController) {
              (fn(r, t.sourceController, t.tabId, n.tabId), f(t.sourceController, null, `before`));
              return;
            }
            f(n.controller, n.tabId, zr(e));
  ...
  t[12] !== o || t[13] !== r
    ? ((x = (e) => {
        let t = l.current;
        (o != null && t != null && dn(r, t), c(null), (l.current = null));
      }),
      (t[12] = o),
      (t[13] = r),
      (t[14] = x))
  ...
  let w = C,
    T;
  t[18] === o ? (T = t[19]) : ((T = { dragState: o }), (t[18] = o), (t[19] = T));
  let E;
  t[20] === o
    ? (E = t[21])
    : ((E =
  ...
  t[22] === o
    ? (D = t[23])
    : ((D = o == null ? null : (0, Q.jsx)(Fr, { dragState: o })), (t[22] = o), (t[23] = D));
  let O;
  t[24] === D
    ? (O = t[25])
    : ((O = (0, Q.jsx)(Xe, { adjustScale: !1, zIndex: it, children: D })),
      (t[24] = D),
      (t[25] = O));
  let k;
  t[26] !== E || t[27] !== O
    ? ((k = (0, Mr.createPortal)((0, Q.jsxs)(Q.Fragment, { children: [E, O] }), document.body)),
      (t[26] = E),
      (t[27] = O),
      (t[28] = k))
    : (k = t[28]);
  ...
  return (
    t[38] !== T || t[39] !== A
      ? ((j = (0, Q.jsx)(un.Provider, { value: T, children: A })),
        (t[38] = T),
        (t[39] = A),
        (t[40] = j))
      : (j = t[40]),
...
function Pr() {
  document.dispatchEvent(
    new KeyboardEvent(`keydown`, { bubbles: !0, cancelable: !0, code: Qe.Esc, key: Qe.Esc }),
  );
}
function Fr(e) {
  let t = (0, $.c)(19),
...
function Lr(e) {
  let t = $e(e),
    n = t.filter((e) => Ir(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab`);
  if (n.length > 0) return Rr(n, e);
  let r =
      t.find((e) => Ir(e.data?.droppableContainer.data.current)?.kind === `app-shell-tab-strip`) ??
      null,
    i = r == null ? null : Ir(r.data?.droppableContainer.data.current);
  if (r != null && i?.kind === `app-shell-tab-strip`) {
    let t = e.droppableContainers.filter((e) => {
      let t = Ir(e.data.current);
      return t?.kind === `app-shell-tab` && t.controller === i.controller;
    });
    return t.length > 0 ? Rr(Ke({ ...e, droppableContainers: t }), e) : [r];
  }
  return Rr(Ke(e), e);
}
function Rr(e, t) {
  return e.map((e) => {
    let n = Ir(e.data?.droppableContainer.data.current),
    ...
    return n?.kind !== `app-shell-tab` || r == null
      ...
      : {
          ...
          data: {
            ...e.data,
            appShellTabInsertionPlacement: mn(t.pointerCoordinates?.x ?? null, r.left, r.width),
          },
        };
  });
}
...
function Yr({ bottomPanelSlot: e, children: t, leftPanelSlot: n, rightPanelSlot: r }) {
  let i = s(X),
    ...
    P = _ === `full-bleed`,
    F = `visible`;
  P ? (F = `hidden`) : O ? (F = `full-bleed`) : p && (F = `hidden`);
  let I = Pe(j()),
    R = Fe(I, (e) => `${Math.max(0, e - Gr * 2)}px`),
    { isMounted: z, animatedSize: B } = lr({ animation: c(re), size: I, isVisible: A }),
    V = Pe(window.innerWidth),
    H = Pe(window.innerHeight - 46),
    U = Pe(sr(H.get())),
    W = c(De),
    G = Fe([U, H], ([e, t]) => or(e, t)),
    K = Fe([W, G], ([e, t]) => e * t),
    ...
    ge = (0, Z.useMemo)(
      () => ({
        ...
        shellWidth: V,
        rightPanelAnimatedWidth: ae,
        rightPanelLayoutTick: J,
      }),
      [Y, ne, B, I, de, ie, ae, J, V],
    ),
    ve = d,
    be = (0, Z.useCallback)(
      (e) => (
    ...
    xe = Ve(({ width: e }) => {
      ...
      (!r && !a) ||
        ...
        (h.current = n),
        ((r && A && p && t) || (a && n)) &&
          (i.get(fe) === `right-panel` && Oe(i, `main`),
          i.get(N) && i.set(N, !1),
          i.get(ee) && je(i, !1)),
        a && n && i.get(ke) && k(i, !1));
    }),
    ...
    Ae = (0, Z.useMemo)(() => Gt(Ee, Te), [Te, Ee]);
  return (
    Qt(K, `change`, (e) => {
      let t = e - pe.current;
      if (((pe.current = e), t !== 0)) for (let e of me.current) e(t);
    }),
    (0, Q.jsx)(Xt.Provider, {
      value: a,
      children: (0, Q.jsx)(Zt.Provider, {
        value: o,
        children: (0, Q.jsx)(Kt.Provider, {
          value: be,
          children: (0, Q.jsxs)(te.Provider, {
            value: ge,
            children: [
              (0, Q.jsx)(jn, {}),
              (0, Q.jsx)(pr, {}),
              (0, Q.jsxs)(w.div, {
                ...
                onBlurCapture: (e) => {
                  (e.relatedTarget instanceof Node && e.currentTarget.contains(e.relatedTarget)) ||
                    (e.relatedTarget != null && Oe(i, $r(e.relatedTarget)), we(i, !1));
                },
                onFocusCapture: (e) => {
                  (Oe(i, $r(e.target)), we(i, ei(e.target)));
                },
                  ...
                  (0, Q.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, Q.jsx)(`main`, {
                        ...
                        children: (0, Q.jsxs)(Nr, {
                          children: [
                            (0, Q.jsx)(yr, {
                              isHeaderEdgeScroll: M,
                              isApplicationMenuBarEnabled: b,
                            }),
                            (0, Q.jsxs)(`div`, {
...
function Xr(e) {
  let t = (0, $.c)(15),
    ...
    m = i || f,
    h;
  t[0] === c ? (h = t[1]) : ((h = c ? { duration: 0 } : de), (t[0] = c), (t[1] = h));
  let g = h,
    _;
  t[2] !== n ||
  t[3] !== r ||
              ...
              (0, Q.jsxs)(`aside`, {
                ...
                children: [
                  (0, Q.jsx)(w.div, {
                    ...
                    children: (0, Q.jsx)($n, { hideUnreadBadge: !0, onToggleSidebar: u }),
                  }),
  ...
  return (
    t[13] === _
      ? (v = t[14])
      : ((v = (0, Q.jsx)(Ie, { initial: !1, children: _ })), (t[13] = _), (t[14] = v)),
    v
  );
}
function Zr(e) {
...
function $r(e) {
  ...
  let t = e.closest(`[${pe}]`)?.getAttribute(pe);
...
function ti() {
  ...
  return Number.isFinite(e) ? Br * e : Br * Vr;
}
function ni() {
  let e = (0, $.c)(6),
    t = c(dt),
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (n = e[0]);
  let r;
  e[1] === t ? (r = e[2]) : ((r = ft(t) ? (0, Q.jsx)(Fn, {}) : null), (e[1] = t), (e[2] = r));
  let i;
...
function oi(e) {
  ...
  return (
    t[4] !== e.id || t[5] !== n
      ? ((a = () => (
          n.set(G.ids$, (t) => (t.includes(e.id) ? t : [...t, e.id])),
          () => {
            (n.set(G.ids$, (t) => t.filter((t) => t !== e.id)), n.set(G.byId, e.id, null));
          }
        )),
        (o = [e.id, n]),
        (t[4] = e.id),
...
function ui(e) {
  let t = (0, $.c)(9),
    ...
    c;
  t[0] !== o || t[1] !== i
    ? ((c = i ?? he(o.value.routeTemplate)), (t[0] = o), (t[1] = i), (t[2] = c))
    : (c = t[2]);
  let l = c;
  bi(o, Se, n);
  let u, d;
  return (
    t[3] !== a || t[4] !== l || t[5] !== o || t[6] !== i
      ? ((u = () => {
          if (!(a === 600 && i == null))
            return (
              o.set(se, { defaultWidth: a, storageKey: l }),
              () => {
                o.set(se, null);
              }
            );
...
function di(e) {
  let { children: t } = e;
  return (bi(s(X), J, t), null);
}
function fi(e) {
  let { children: t } = e;
  return (bi(s(X), Y, t), null);
}
function pi(e) {
  let { children: t } = e;
  return (bi(s(X), q, t), null);
}
function mi() {
  return null;
}
...
function gi(e) {
  let { children: t } = e;
  return (bi(s(X), R, t), null);
}
function _i(e) {
  let { children: t } = e;
  return (bi(s(X), M, t), null);
}
function vi(e) {
  let { children: t } = e;
  return (bi(s(X), F, t), null);
}
function yi(e) {
  let { children: t } = e;
  return (bi(s(X), V, t), null);
}
function bi(e, t, n) {
  let r = (0, $.c)(9),
    i,
...
function xi(e) {
  let t = (0, $.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(Pt, { debugName: `AppShellContent`, fillParent: !0 })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function Ci(e) {
  let t = (0, $.c)(7),
    { children: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = wi(n)), (t[0] = n), (t[1] = r));
...
function Ei(e) {
  return (0, Z.isValidElement)(e) && e.type === si;
}
function Di(e) {
  return (0, Z.isValidElement)(e) && e.type === mi;
}
var Oi = {
  Root: (0, Z.memo)(Ci),
  LeftPanel: ri,
  Content: (0, Z.memo)(xi),
  Header: (0, Z.memo)(ii),
  HeaderAction: (0, Z.memo)(ai),
  HeaderContextMenuItem: (0, Z.memo)(oi),
  MainContentLayout: (0, Z.memo)(Si),
  BottomPanel: mi,
  BottomPanelTabs: (0, Z.memo)(hi),
  BottomPanelTabsEmptyState: (0, Z.memo)(gi),
  BottomPanelTabListAfter: (0, Z.memo)(_i),
  BottomPanelTabListAfterSticky: (0, Z.memo)(vi),
  BottomPanelOutlet: (0, Z.memo)(yi),
  RightPanel: si,
  RightPanelTabs: (0, Z.memo)(ci),
  RightPanelTabsEmptyState: (0, Z.memo)(li),
  RightPanelTabListAfter: (0, Z.memo)(di),
  RightPanelTabListAfterSticky: (0, Z.memo)(pi),
  RightPanelTabListBefore: (0, Z.memo)(fi),
  RightPanelOutlet: (0, Z.memo)(ui),
};
export {
  jn as _,
  Xn as a,
...
//# sourceMappingURL=app-shell-0b-x_r3Z.js.map
