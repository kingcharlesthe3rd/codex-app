import { h as e } from "./chunk-20.js";
import { t } from "./src-3.js";
import { n, r, t as i } from "./monotone.js";
import { t as a } from "./line-DIsP-Yv_.js";
import { _ as o, c as s, d as c, g as l, h as u, i as d, n as f, r as p, t as m } from "./step.js";
import { n as h, r as g } from "./chunk-70.js";
import { b as _, h as v } from "./chunk-3.js";
import { n as y } from "./chunk-10.js";
import { n as b, r as x, t as S } from "./chunk-9.js";
import { t as C } from "./chunk-79.js";
import { i as w, n as T } from "./chunk-5.js";
import { t as E } from "./rough.esm-2.js";
import { r as D } from "./chunk-103.js";
var ee = h((e, t, n, r, i, a) => {
        ...
        if (e) {
          ...
          ((t.id = n),
            t.querySelectorAll(`path, circle, line`).forEach((e) => {
              (e.setAttribute(`stroke`, o), s.fill && e.setAttribute(`fill`, o));
            }),
  ...
  N = h((e) => (e ? e.reduce((e, t) => e + `;` + t, ``) : ``), `getLabelStyles`),
  P = h(async (e, n) => {
    ...
    if (r) {
      let e = a.children[0],
        n = t(a);
      ((c = e.getBoundingClientRect()), n.attr(`width`, c.width), n.attr(`height`, c.height));
    }
...
var I = h((t, n) => {
    ...
    if (t.startLabelLeft) {
      let n = j.get(t.id).startLeft,
        ...
        a = t.y;
      if (r) {
        let n = e.calcTerminalLabelPosition(t.arrowTypeStart ? 10 : 0, `start_left`, r);
        ((i = n.x), (a = n.y));
      }
    ...
    if (t.startLabelRight) {
      let n = j.get(t.id).startRight,
        ...
        a = t.y;
      if (r) {
        let n = e.calcTerminalLabelPosition(t.arrowTypeStart ? 10 : 0, `start_right`, r);
        ((i = n.x), (a = n.y));
      }
      n.attr(`transform`, `translate(${i}, ${a})`);
    }
    if (t.endLabelLeft) {
      let n = j.get(t.id).endLeft,
        ...
        a = t.y;
      if (r) {
        let n = e.calcTerminalLabelPosition(t.arrowTypeEnd ? 10 : 0, `end_left`, r);
        ((i = n.x), (a = n.y));
      }
      n.attr(`transform`, `translate(${i}, ${a})`);
    }
    if (t.endLabelRight) {
      let n = j.get(t.id).endRight,
        ...
        a = t.y;
      if (r) {
        let n = e.calcTerminalLabelPosition(t.arrowTypeEnd ? 10 : 0, `end_right`, r);
        ((i = n.x), (a = n.y));
      }
      n.attr(`transform`, `translate(${i}, ${a})`);
    }
...
var V = h(function (e, t, n) {
  ...
  W = h(function (h, v, y, b, C, w, D, O = !1) {
    ...
    if (v.look === `handDrawn`) {
      ...
      let r = (e ? e + `;` + t + `;` : t) + `;` + (Y ? Y.reduce((e, t) => e + `;` + t, ``) : ``);
      ((K = h
        .append(`path`)
        .attr(`d`, J)
        .attr(`id`, v.id)
