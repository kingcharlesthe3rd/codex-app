...
import { _ as t, c as n, g as r, k as i, l as a, m as o, u as s } from "./vscode-api.js";
import { l as c } from "./statsig.js";
import { a as l, t as u } from "./request.js";
...
function se(e) {
  let r = (0, W.c)(13),
    { accountId: i, enabled: a, userId: l } = e,
    u = c(G),
    d;
  r[0] === u ? (d = r[1]) : ((d = u.get(K, s.SIX_HOURS)), (r[0] = u), (r[1] = d));
  let f = d,
    p;
  r[2] !== i || r[3] !== l
    ? ((p = Y({ accountId: i, userId: l })), (r[2] = i), (r[3] = l), (r[4] = p))
    : (p = r[4]);
  let m = a && !0,
    h;
  r[5] !== i || r[6] !== l
    ? ((h = async () => {
        let e = i != null,
          t = l != null;
        (!e || !t) &&
          o.warning(`profile_usage_query_started_without_identity`, {
        ...
        try {
          ...
          let i = r;
          throw (
            o.warning(`profile_usage_query_failed`, {
              safe: {
...
function le(e) {
  let t = (0, W.c)(6),
    { accountId: n, userId: a } = e,
    o = i(),
    s;
  t[0] !== n || t[1] !== a
    ? ((s = Y({ accountId: n, userId: a })), (t[0] = n), (t[1] = a), (t[2] = s))
    : (s = t[2]);
  let c = s,
    l;
  return (
