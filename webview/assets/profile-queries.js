...
function E(e) {
  let t = (0, H.c)(13),
    { accountId: n, enabled: r, userId: a } = e,
    o = l(U),
    s;
  t[0] === o ? (s = t[1]) : ((s = o.get(W, u.SIX_HOURS)), (t[0] = o), (t[1] = s));
  let c = s,
    d;
  t[2] !== n || t[3] !== a
    ? ((d = T({ accountId: n, userId: a })), (t[2] = n), (t[3] = a), (t[4] = d))
    : (d = t[4]);
  let f = r && !0,
    h;
  t[5] !== n || t[6] !== a
    ? ((h = async () => {
        let e = n != null,
          t = a != null;
        (!e || !t) &&
          p.warning(`profile_usage_query_started_without_identity`, {
        ...
        try {
          ...
          let r = n;
          throw (
            p.warning(`profile_usage_query_failed`, {
              safe: {
                errorCode: r instanceof m ? (r.errorCode ?? null) : null,
                hasAccountId: e,
                hasUserId: t,
                status: r instanceof m ? r.status : null,
              },
              sensitive: {},
            }),
            r
  ...
  let g;
  return (
    t[8] !== c || t[9] !== d || t[10] !== f || t[11] !== h
      ? ((g = { queryKey: d, enabled: f, queryFn: h, staleTime: c }),
        (t[8] = c),
        (t[9] = d),
        (t[10] = f),
        (t[11] = h),
...
function D(e) {
  let t = (0, H.c)(6),
    ...
    a;
  t[0] !== n || t[1] !== r
    ? ((a = T({ accountId: n, userId: r })), (t[0] = n), (t[1] = r), (t[2] = a))
    : (a = t[2]);
  let s = a,
    c;
  return (
    ...
    t[3] !== i || t[4] !== s
      ? ((c = {
          ...
          onSuccess: (e, t) => {
            ...
            n != null && i.setQueryData(s, { ...n, username: S(t) || null });
          },
        }),
        (t[3] = i),
        (t[4] = s),
...
async function M(e) {
  ...
  return (
    await v
      .getInstance()
      .post(`/wham/profiles/me/photo`, y(await z(e, t)), {
