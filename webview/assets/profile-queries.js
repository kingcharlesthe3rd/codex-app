...
import { A as t, _ as n, c as r, h as i, l as a, u as o, v as s } from "./vscode-api.js";
import { l as c } from "./statsig.js";
import { n as l } from "./base64.js";
...
function S({ accountStructure: e, plan: t, workspaceName: n }) {
  let r = U(n);
...
function re({ dailyUsage: e, todayIso: t, view: n }) {
  let r = I({ columnCount: k(t), dailyUsage: e, startDateIso: A(t) });
  switch (n) {
    case `cumulative`:
      return oe(r);
    case `daily`:
...
function T({ dailyUsage: e, todayIso: t }) {
  let n = V(L(t), -175);
  return M(I({ columnCount: 26, dailyUsage: e.filter((e) => e.date <= t), startDateIso: n })).map(
    (e, r) => (V(n, r) > t ? null : e),
  );
}
function ie({ dailyUsage: e, todayIso: t }) {
  return I({ columnCount: k(t), dailyUsage: e, startDateIso: A(t) });
}
function E({ dailyUsage: e, todayIso: t }) {
  let n = A(t),
    r = k(t),
    i = Array.from({ length: r }, () => 0),
    a = new Map(Array.from({ length: r }, (e, t) => [V(n, t * 7), t]));
  for (let n of e) {
    if (n.date > t) continue;
    let e = a.get(L(n.date));
    e != null && (i[e] += Math.max(0, n.credits));
  }
  return i;
}
function D({ dailyUsage: e, todayIso: t }) {
  return P(E({ dailyUsage: e, todayIso: t }));
}
function O(e = new Date()) {
  return e.toISOString().slice(0, 10);
}
function k(e) {
  let t = new Date(`${L(e)}T00:00:00.000Z`).getTime(),
    n = new Date(`${p}T00:00:00.000Z`).getTime(),
    r = Math.floor((t - n) / (10080 * 60 * 1e3));
  return Math.min(f, Math.max(1, r + 1));
}
function A(e) {
  return V(L(e), -(k(e) - 1) * 7);
}
function j(e, t) {
  return V(A(t), e);
}
...
function I({ columnCount: e, dailyUsage: t, startDateIso: n }) {
  let r = B(t);
  return Array.from({ length: e * 7 }, (e, t) => r.get(V(n, t)) ?? 0);
}
function L(e) {
...
function V(e, t) {
  ...
  return (n.setUTCDate(n.getUTCDate() + t), O(n));
}
function H(e) {
...
var W = e(),
  G = `3503973010`,
  K = `profile_usage_query_stale_time_ms`,
  q = `profile_usage_warm_fetch_enabled`,
  J = class extends Error {
    constructor(e) {
      (super(`Profile photo upload failed`), (this.uploadError = e));
    }
  };
function Y({ accountId: e, userId: t }) {
  return [`profile`, `usage`, t ?? null, e ?? null];
}
function se(e) {
  let t = (0, W.c)(13),
    { accountId: n, enabled: a, userId: l } = e,
    u = c(G),
    d;
  t[0] === u ? (d = t[1]) : ((d = u.get(K, o.SIX_HOURS)), (t[0] = u), (t[1] = d));
  let f = d,
    p;
  t[2] !== n || t[3] !== l
    ? ((p = Y({ accountId: n, userId: l })), (t[2] = n), (t[3] = l), (t[4] = p))
    : (p = t[4]);
  let m = a && !0,
    h;
  t[5] !== n || t[6] !== l
    ? ((h = async () => {
        let e = n != null,
          t = l != null;
        (!e || !t) &&
          i.warning(`profile_usage_query_started_without_identity`, {
        ...
        try {
          ...
          let a = n;
          throw (
            i.warning(`profile_usage_query_failed`, {
              safe: {
                errorCode: a instanceof r ? (a.errorCode ?? null) : null,
                hasAccountId: e,
                hasUserId: t,
                status: a instanceof r ? a.status : null,
              },
              sensitive: {},
            }),
            a
  ...
  return (
    t[8] !== f || t[9] !== p || t[10] !== m || t[11] !== h
      ? ((g = { queryKey: p, enabled: m, queryFn: h, staleTime: f }),
        (t[8] = f),
        (t[9] = p),
        (t[10] = m),
        (t[11] = h),
...
function ce() {
  let e = (0, W.c)(2),
    t = c(G),
    n;
  return (e[0] === t ? (n = e[1]) : ((n = t.get(q, !0)), (e[0] = t), (e[1] = n)), n);
}
function le(e) {
  let r = (0, W.c)(6),
    { accountId: i, userId: a } = e,
    o = t(),
    s;
  r[0] !== i || r[1] !== a
    ? ((s = Y({ accountId: i, userId: a })), (r[0] = i), (r[1] = a), (r[2] = s))
    : (s = r[2]);
  let c = s,
    l;
  return (
    ...
    r[3] !== o || r[4] !== c
      ? ((l = {
          ...
          onSuccess: (e, t) => {
            ...
            n != null && o.setQueryData(c, { ...n, username: C(t) || null });
          },
        }),
        (r[3] = o),
        (r[4] = c),
...
async function fe() {
  let e = await u.safeGet(`/wham/profiles/me`);
  return {
    activityInsights: $(e.stats),
    dailyUsage:
...
async function pe(e) {
  return Q(await Z({ profile_asset_pointer: await X(e) }));
}
async function X(e) {
  let t = ve();
  return (
    await a
      .getInstance()
      .post(`/wham/profiles/me/photo`, l(await _e(e, t)), {
...
async function me(e) {
  ...
  if ((e.displayName != null && (t.display_name = e.displayName), e.photo != null))
    try {
      t.profile_asset_pointer = await X(e.photo);
    } catch (e) {
      throw new J(e);
    }
  return Z(t);
...
async function he(e) {
  let t = w(e);
  if (!t.ok) throw new d(t.reason);
  await Z({ username: t.username });
}
async function Z(e) {
  return u.safePatch(`/wham/profiles/me`, { requestBody: e });
}
function ge(e, t, n) {
