...
import { _ as t, g as n, k as r, l as i, u as a } from "./vscode-api.js";
import { l as o } from "./statsig-DoZ-0xit.js";
import { a as s, t as c } from "./request.js";
...
function y({ accountStructure: e, plan: t, workspaceName: n }) {
  let r = H(n);
...
function C({ dailyUsage: e, todayIso: t, view: n }) {
  let r = F({ columnCount: k(t), dailyUsage: e, startDateIso: A(t) });
  switch (n) {
    case `cumulative`:
      return ae(r);
    case `daily`:
...
function w({ dailyUsage: e, todayIso: t }) {
  let n = B(I(t), -175);
  return j(F({ columnCount: 26, dailyUsage: e.filter((e) => e.date <= t), startDateIso: n })).map(
    (e, r) => (B(n, r) > t ? null : e),
  );
}
function T({ dailyUsage: e, todayIso: t }) {
  return F({ columnCount: k(t), dailyUsage: e, startDateIso: A(t) });
}
...
function D({ dailyUsage: e, todayIso: t }) {
  return N(E({ dailyUsage: e, todayIso: t }));
}
...
function F({ columnCount: e, dailyUsage: t, startDateIso: n }) {
  let r = z(t);
  return Array.from({ length: e * 7 }, (e, t) => r.get(B(n, t)) ?? 0);
}
function I(e) {
...
function oe(e) {
  let n = (0, U.c)(9),
    { accountId: r, enabled: i, userId: s } = e,
    c = o(W),
    l;
  n[0] === c ? (l = n[1]) : ((l = c.get(G, a.SIX_HOURS)), (n[0] = c), (n[1] = l));
  let u = l,
    d;
  n[2] !== r || n[3] !== s
    ? ((d = J({ accountId: r, userId: s })), (n[2] = r), (n[3] = s), (n[4] = d))
    : (d = n[4]);
  let f = i && !0,
    p;
  return (
    n[5] !== u || n[6] !== d || n[7] !== f
      ? ((p = { queryKey: d, enabled: f, queryFn: de, staleTime: u }),
        (n[5] = u),
        (n[6] = d),
        (n[7] = f),
        (n[8] = p))
...
function ce(e) {
  let t = (0, U.c)(6),
    ...
    s;
  t[0] !== i || t[1] !== a
    ? ((s = J({ accountId: i, userId: a })), (t[0] = i), (t[1] = a), (t[2] = s))
    : (s = t[2]);
  let c = s,
    l;
  return (
    ...
    t[3] !== o || t[4] !== c
      ? ((l = {
          ...
          onSuccess: (e, t) => {
            ...
            n != null && o.setQueryData(c, { ...n, username: b(t) || null });
          },
        }),
        (t[3] = o),
        (t[4] = c),
...
async function fe(e) {
  return Z(await X({ profile_asset_pointer: await Y(e) }));
}
async function Y(e) {
  let t = $();
  return (
    await i
      .getInstance()
      .post(`/wham/profiles/me/photo`, s(await ge(e, t)), {
