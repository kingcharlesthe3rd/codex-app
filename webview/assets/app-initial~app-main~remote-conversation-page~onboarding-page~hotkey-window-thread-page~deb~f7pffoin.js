  ...
  return s({
    ...
    queryFn: async () => {
      ...
      try {
        ...
        throw (
          n.error(`Failed to list importable browser profiles`, {
            safe: {},
            sensitive: { error: e },
          }),
          e
...
async function y(e, t) {
  try {
    ...
    throw (
      n.error(`Failed to import browser profile`, {
        safe: {
...
var b,
  ...
  S,
  C = e(() => {
    S = `has-seen-browser-profile-import-nux-v1`;
  });
function w({
  baseGateEnabled: e,
  hasSeen: t,
  ...
  return r && n && e && o && a && i != null && _(i).length > 0 && t === !1;
}
var T,
  E = e(() => {
    (x(), d(), C(), (T = a(S, !1)));
...
var O,
  k,
  A = e(() => {
    (i(), p(), (O = `browser-sidebar-comment-mode-coachmark-dismissed`), (k = c(O, !1)));
  });
export {
  E as a,
  C as c,
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~onboarding-page~hotkey-window-thread-page~deb~f7pffoin.js.map
