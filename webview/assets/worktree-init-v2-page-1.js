...
import { Ha as o, _a as s, ja as ee, js as c } from "./app-server-manager-signals.js";
import { g as te, m as ne, p as re } from "./vscode-api.js";
import { Bt as ie, ft as ae, ht as oe } from "./src-1.js";
import { c as se, o as l } from "./lib.js";
import { Br as u } from "./persisted-signal.js";
import { t as d } from "./button-DO-oxX3-.js";
import { r as ce } from "./toast-signal.js";
import { a as le, g as ue, m as de } from "./chunk-109.js";
import { n as fe } from "./use-start-new-conversation.js";
import { t as pe } from "./read-service-tier-for-request.js";
import { a as me, n as he, o as ge, r as _e } from "./pending-worktree-store.js";
import { n as ve } from "./thread-layout.js";
import { n as ye, r as be } from "./pending-worktree-conversation.js";
import { t as xe } from "./thread-scroll-layout.js";
import { d as Se, o as f, u as Ce } from "./user-message-attachments-BsuF-TwD.js";
async function we({ createPendingWorktree: e, intl: t, pendingWorktree: n, serviceTier: r }) {
  let i = m(n, t),
    a = await p(n, i, r),
    o = t.formatMessage({
...
async function p(e, t, n) {
  ...
  return {
    ...
    fileAttachments: [],
    addedFiles: [],
    agentMode: u(`agent-mode-by-host-id`, {})[e.hostId] ?? `auto`,
    model: null,
    serviceTier: n,
...
function _(e) {
  let t = (0, Te.c)(78),
    ...
    { retryPendingWorktreeConversationStart: Oe } = me(),
    C = he(p),
    w;
  t[0] === p ? (w = t[1]) : ((w = (e) => e.pendingWorktreeId === p), (t[0] = p), (t[1] = w));
  let T = ge().find(w),
    E = te({
      mutationFn: async (e) => {
        ...
        if (C)
          if ((_(C.id), t))
            try {
              let e = await ye({ entry: C, workspaceRoot: C.sourceWorkspaceRoot });
              (be(C, e), o?.(e), o ?? u(ee(e)));
            } catch (e) {
              let t = e;
              throw (
        ...
        u(
          oe(
            await we({
              ...
              intl: f,
              pendingWorktree: C,
              serviceTier: await pe(c, C.hostId, e),
            }),
          ),
        );
      }),
  ...
  t[21] === ke
    ...
    : ((P = () => {
      ...
      (t[22] = P));
  let F;
  (t[23] === p ? (F = t[24]) : ((F = [p]), (t[23] = p), (t[24] = F)), (0, h.useEffect)(P, F));
  let I, L;
  if (
    (t[25] === C
      ? ((I = t[26]), (L = t[27]))
    ...
    return null;
  if (T?.state === `succeeded`) return (0, g.jsx)(le, { to: ee(T.conversationId), replace: !0 });
  ...
  if (!C) {
    ...
    return (
      t[28] === s
        ? (e = t[29])
        : ((e = (0, g.jsx)(le, { to: s, replace: !0 })), (t[28] = s), (t[29] = e)),
      e
    );
  }
  ...
  t[30] !== C.hostId || t[31] !== C.prompt
    ? ((U = (0, g.jsx)(De, { hostId: C.hostId, prompt: C.prompt })),
      (t[30] = C.hostId),
      (t[31] = C.prompt),
      (t[32] = U))
    : (U = t[32]);
                    ...
                    (0, g.jsx)(d, {
                      ...
                      onClick: () => {
                        ...
                        (C.localEnvironmentConfigPath != null &&
                          ...
                          e.set(`mode`, `edit`)),
                          u(`/settings/local-environments?${e.toString()}`));
                      },
                      children: (0, g.jsx)(l, {
    ...
    : ((Q = (0, g.jsx)(`div`, {
        ...
        children:
          C.outputText.length > 0
            ? (0, g.jsx)(Ce, { className: `text-sm`, children: C.outputText })
            : (0, g.jsx)(`span`, {
  ...
  return (
    t[74] !== U || t[75] !== Z || t[76] !== Q
      ? (($ = (0, g.jsx)(ve, {
          children: (0, g.jsx)(xe, {
            children: (0, g.jsxs)(`div`, { className: `flex flex-col gap-4`, children: [U, Z, Q] }),
          }),
        })),
        (t[74] = U),
        (t[75] = Z),
...
function De(e) {
  ...
  t[2] === a
    ? (o = t[3])
    : ((o = a && (0, g.jsx)(f, { pullRequestNumber: a })), (t[2] = a), (t[3] = o));
  let s;
  t[4] !== n || t[5] !== r
    ? ((s = (0, g.jsx)(Se, { message: r, sentAtMs: null, hostId: n, alwaysShowActions: !0 })),
      (t[4] = n),
      (t[5] = r),
      (t[6] = s))
    : (s = t[6]);
  ...
  return (
    t[7] !== o || t[8] !== s
      ? ((c = (0, g.jsxs)(`div`, { className: `flex flex-col items-end gap-2`, children: [o, s] })),
        (t[7] = o),
        (t[8] = s),
        (t[9] = c))
      : (c = t[9]),
