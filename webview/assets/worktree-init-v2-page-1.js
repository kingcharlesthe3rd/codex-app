...
function je(e) {
  ...
  return (
    t[4] !== a || t[5] !== o
      ? ((s = (0, X.jsx)(he, { activities: o, children: a })), (t[4] = a), (t[5] = o), (t[6] = s))
      : (s = t[6]),
    s
  );
}
...
function Le(e) {
    ...
    E = re({
      mutationFn: async (e) => {
        ...
        if (w)
          if ((_(w.id), t))
            try {
              let e = await Te({ entry: w, workspaceRoot: w.sourceWorkspaceRoot });
              (se(d, {
                ...
                w.clientThreadId == null
                  ? Se(d, { conversationId: e, pendingWorktreeId: w.id }) || Ee(w, e)
                  : _e(d, { clientThreadId: w.clientThreadId, conversationId: e }),
                a?.(e),
  ...
  let k;
  t[9] !== D || t[10] !== O
    ? ((k = { mutationFn: D, onError: O }), (t[9] = D), (t[10] = O), (t[11] = k))
    : (k = t[11]);
  let A = re(k),
    j,
    M;
  ...
  if (!w) {
    ...
    return (
      t[20] === l
        ? (e = t[21])
        : ((e = (0, $.jsx)(ye, { to: l, replace: !0 })), (t[20] = l), (t[21] = e)),
      e
    );
  }
  let L;
                    ...
                    children: [
                      w.phase === `failed` &&
                        (0, $.jsx)(C, {
                          color: `secondary`,
                          onClick: () => {
                            if ((ge(d, w.hostId), w.localEnvironmentConfigPath != null)) {
                              p(
                                De({
...
function ze(e) {
  ...
  t[2] === a
    ? (o = t[3])
    : ((o = a && (0, $.jsx)(b, { pullRequestNumber: a })), (t[2] = a), (t[3] = o));
  let s;
  t[4] !== n || t[5] !== r
    ? ((s = (0, $.jsx)(v, { message: r, sentAtMs: null, hostId: n, alwaysShowActions: !0 })),
      (t[4] = n),
      (t[5] = r),
      (t[6] = s))
    : (s = t[6]);
