...
import { Js as i, Qi as a, Vi as ee, Xs as o, zs as s } from "./app-server-manager-signals.js";
...
import { a as se, g as ce, m as le } from "./chunk-8.js";
...
import { n as ge } from "./thread-layout.js";
import { n as _e } from "./pending-worktree-conversation.js";
import { t as ve } from "./thread-scroll-layout.js";
import { i as ye, o as be, s as p } from "./user-message-attachments.js";
...
function v(e) {
  let i = (0, Se.c)(77),
    { homePath: a, conversationPathBuilder: ee, onConversationReady: o } = e === void 0 ? {} : e,
    s = a === void 0 ? `/` : a,
    c = ee === void 0 ? n : ee,
    l = ie(re),
    d = le(),
    ...
    C = fe(m),
    w;
  i[0] === m ? (w = i[1]) : ((w = (e) => e.pendingWorktreeId === m), (i[0] = m), (i[1] = w));
  let T = pe().find(w),
    E = oe({
      mutationFn: async (e) => {
        ...
        if (C)
          if ((v(C.id), n))
            try {
              let e = await _e({ entry: C, workspaceRoot: C.sourceWorkspaceRoot });
              (o?.(e), o ?? d(c(e)));
            } catch (e) {
              let n = e;
              throw (
  ...
  i[2] !== x || i[3] !== p || i[4] !== d || i[5] !== C
    ? ((D = async () => {
        C && d(r(await xe({ createPendingWorktree: x, intl: p, pendingWorktree: C })));
      }),
      (i[2] = x),
      (i[3] = p),
      (i[4] = d),
  ...
  let k;
  i[10] !== D || i[11] !== O
    ? ((k = { mutationFn: D, onError: O }), (i[10] = D), (i[11] = O), (i[12] = k))
    : (k = i[12]);
  let A = oe(k),
    j,
    M;
  ...
  i[20] === De
    ...
    : ((P = () => {
      ...
      (i[21] = P));
  let F;
  (i[22] === m ? (F = i[23]) : ((F = [m]), (i[22] = m), (i[23] = F)), (0, g.useEffect)(P, F));
  let I, L;
  if (
    (i[24] === C
      ? ((I = i[25]), (L = i[26]))
    ...
    return null;
  if (T?.state === `succeeded`) return (0, _.jsx)(se, { to: c(T.conversationId), replace: !0 });
  ...
  if (!C) {
    ...
    return (
      i[27] === s
        ? (e = i[28])
        : ((e = (0, _.jsx)(se, { to: s, replace: !0 })), (i[27] = s), (i[28] = e)),
      e
    );
  }
  let R = C.phase === `queued` || C.phase === `creating`,
    ...
    Oe = C.phase === `failed` && C.worktreeGitRoot != null && C.worktreeWorkspaceRoot != null,
    ke = Oe && !H,
  ...
  return (
    i[73] !== U || i[74] !== Z || i[75] !== Q
      ? (($ = (0, _.jsx)(ge, {
          children: (0, _.jsx)(ve, {
            children: (0, _.jsxs)(`div`, { className: `flex flex-col gap-4`, children: [U, Z, Q] }),
          }),
        })),
        (i[73] = U),
        (i[74] = Z),
...
function we(e) {
  ...
  t[2] === a
    ? (o = t[3])
    : ((o = a && (0, _.jsx)(ye, { pullRequestNumber: a })), (t[2] = a), (t[3] = o));
  let s;
  t[4] !== n || t[5] !== r
    ? ((s = (0, _.jsx)(p, { message: r, sentAtMs: null, hostId: n, alwaysShowActions: !0 })),
      (t[4] = n),
      (t[5] = r),
      (t[6] = s))
    : (s = t[6]);
  ...
  return (
    t[7] !== o || t[8] !== s
      ? ((c = (0, _.jsxs)(`div`, { className: `flex flex-col items-end gap-2`, children: [o, s] })),
        (t[7] = o),
        (t[8] = s),
        (t[9] = c))
      : (c = t[9]),
