...
import { r as ze } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~pull-requests-page~new-~ozr5a6hk.js";
import {
  h as Be,
  p as Ve,
...
function vt(e) {
  let t = (0, yt.c)(15),
    ...
    l = i === void 0 ? `ghostMuted` : i,
    u = !(o !== void 0 && o) && `-me-1.5`,
    d;
  t[0] === u ? (d = t[1]) : ((d = B(`inline-flex`, u)), (t[0] = u), (t[1] = d));
  let f = a ? `text-token-text-secondary` : void 0,
    p = a ? `ghost` : l,
    m;
  t[2] !== n || t[3] !== r || t[4] !== a || t[5] !== c || t[6] !== f || t[7] !== p
    ? ((m = (0, bt.jsx)(ne, {
        "aria-label": n,
        className: f,
        color: p,
  ...
  let h;
  t[9] !== d || t[10] !== m
    ? ((h = (0, bt.jsx)(`span`, { className: d, children: m })),
      (t[9] = d),
      (t[10] = m),
      (t[11] = h))
    : (h = t[11]);
  ...
  return (
    t[12] !== g || t[13] !== s
      ? ((_ = (0, bt.jsx)(ce, { tooltipContent: s, children: g })),
        (t[12] = g),
        (t[13] = s),
        (t[14] = _))
      : (_ = t[14]),
...
function Tt(e, { action: t, item: n, surface: r }) {
  Te(e, Le, { action: t, surface: r, state: n.state, isAuthor: n.isAuthor });
}
function Et(e, { item: t, surface: n }) {
  Te(e, Ne, { surface: n, state: t.state, isAuthor: t.isAuthor });
}
function Dt(e, { kind: t, surface: n }) {
  Te(e, je, { kind: t, surface: n });
}
var Ot = e(() => {
  (De(), Pe());
});
...
function At(e) {
  let t = (0, Mt.c)(20),
    ...
    l;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((l = kt(n, r, i)), (t[0] = n), (t[1] = r), (t[2] = i), (t[3] = l))
    : (l = t[3]);
  let u;
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((u = (e, t) => {
        if (e.status === `success`) {
          if (r != null) {
            let e = (e) => {
              s.setQueryData(b(`gh-pr-status`, e), jt);
            };
            (e({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
              e({ cwd: t.cwd, headBranch: r, hostId: t.hostId, number: t.number, repo: t.repo }),
              Promise.all([
                s.invalidateQueries({ queryKey: b(`gh-pr-body`) }),
                s.invalidateQueries({ queryKey: b(`gh-pr-checks`) }),
                s.invalidateQueries({ queryKey: b(`gh-pr-comments`) }),
                s.invalidateQueries({
                  queryKey: b(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
                }),
                s.invalidateQueries({
                  queryKey: b(`gh-pr-status`, {
                    cwd: t.cwd,
                    headBranch: r,
                    hostId: t.hostId,
                    number: t.number,
  ...
  let f;
  t[8] !== a || t[9] !== l || t[10] !== u
    ? ((f = { source: a, mutationKey: l, onSuccess: u }),
      (t[8] = a),
      (t[9] = l),
      (t[10] = u),
      (t[11] = f))
    : (f = t[11]);
  let p = d(`gh-pr-merge`, f),
    m,
    h;
  t[12] !== i || t[13] !== p
    ? ((m = (e, t) => {
        p.mutate({ ...e, hostId: i }, t);
      }),
      (h = (e, t) => p.mutateAsync({ ...e, hostId: i }, t)),
      (t[12] = i),
      (t[13] = p),
      (t[14] = m),
      (t[15] = h))
...
function Pt({ cwd: e, headBranch: t, hostId: n }) {
...
function Ft(e) {
  let t = (0, It.c)(20),
    ...
    l;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((l = Pt({ cwd: n, headBranch: r, hostId: i })),
      (t[0] = n),
      (t[1] = r),
      (t[2] = i),
      (t[3] = l))
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((u = (e, t) => {
        ...
        if (
          (s.invalidateQueries({ queryKey: b(`gh-pr-comments`) }), t.action === `request-reviewers`)
        ) {
          o?.(e, t);
          return;
        }
        ...
        let n = (e) => {
          s.setQueryData(b(`gh-pr-status`, e), (e) => {
            if (e?.status !== `success`) return e;
            switch (t.action) {
              case `toggle-auto-merge`:
                return { ...e, isAutoMergeEnabled: t.enabled };
...
function Bt({ includeReviewComments: e, item: t, repo: n }) {
  return [
    Ae,
    ``,
    ...Kt({ item: t, repo: n }),
...
function Vt({ includeReviewComments: e, item: t, name: n, repo: r }) {
  return { name: n, prompt: Ut({ includeReviewComments: e, item: t, repo: r }), rrule: Wt() };
}
function Ht(e) {
  return {
    id: e.id,
...
function Ut({ includeReviewComments: e, item: t, repo: n }) {
  return [
...
function Wt() {
  return lt({ ...ot(), intervalHours: 1, intervalMinutes: Xt });
}
function Gt(e) {
  return e
...
function Yt() {
  return [
    ...
    `Use ::${K}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
...
function Qt({ conversationId: e, pendingWorktreeId: t }) {
  return e == null ? (t == null ? null : u(t)) : h(e);
}
var $t = e(() => {
  o();
});
function en(e) {
  let t = (0, tn.c)(33),
    { hostId: r, item: a, onSuccess: o, repo: c } = e,
    l = g(n),
    d = Re(),
    f = Me(),
    { createPendingWorktree: p } = ut(),
    m;
  t[0] !== r || t[1] !== a.cwd
    ? ((m = { conversationId: null, cwdOverride: a.cwd, hostId: r }),
      (t[0] = r),
      (t[1] = a.cwd),
      (t[2] = m))
    : (m = t[2]);
  let {
      agentMode: h,
      isAgentModePending: v,
      permissionProfileId: y,
      shouldSendPermissionOverrides: b,
    } = Ze(m),
    { activeMode: x } = Ye(null),
    { serviceTierSettings: S } = Ke(null),
    C;
  t[3] !== r || t[4] !== a.cwd
    ? ((C = { hostId: r, workspaceRoot: a.cwd }), (t[3] = r), (t[4] = a.cwd), (t[5] = C))
    : (C = t[5]);
  let { resolvedConfigPath: w } = s(C),
    D;
  t[6] !== x ||
  t[7] !== h ||
  t[8] !== p ||
  ...
  t[16] !== b
    ? ((D = async (e) => {
        let t = Bt({ includeReviewComments: e, item: a, repo: c }),
          n = [{ type: `text`, text: t, text_elements: [] }],
          { config: i } = await xe(`read-config-for-host`, {
            hostId: r,
            includeLayers: !1,
            cwd: a.cwd,
          }),
        ...
        return p({
          hostId: r,
          label: E(n),
          initialThreadTitle: `Codex Merge PR #${a.number}`,
          sourceWorkspaceRoot: a.cwd,
          startingState: { type: `branch`, branchName: a.headBranch },
          ...
          heartbeatAutomation: Vt({ includeReviewComments: e, item: a, name: s, repo: c }),
        });
      }),
      (t[6] = x),
      (t[7] = h),
    ...
    : (D = t[17]);
  let O;
  t[18] !== a.url || t[19] !== f || t[20] !== o || t[21] !== l
    ? ((O = (e) => {
        (_t(l, { pendingWorktreeId: e, pullRequestUrl: a.url }), o(), f(u(e)));
      }),
      (t[18] = a.url),
      (t[19] = f),
      (t[20] = o),
  ...
  t[23] !== d || t[24] !== l
    ? ((k = (e) => {
        (i.error(`Error starting pull request merge helper`, { safe: {}, sensitive: { error: e } }),
          l
            .get(Be)
            .danger(
              d.formatMessage(
  ...
  return (
    t[30] !== v || t[31] !== ee
      ? ((j = { ...ee, isAgentModePending: v }), (t[30] = v), (t[31] = ee), (t[32] = j))
      : (j = t[32]),
    j
  );
}
...
function an(e) {
  let t = (0, on.c)(102),
    { className: r, hostId: i, item: a, repo: o, size: s, stopPropagation: l, surface: u } = e,
    f = s === void 0 ? `default` : s,
    m = l === void 0 ? !1 : l,
    h = u === void 0 ? `pull_request_page` : u,
    _ = g(n),
    v = y(Ie),
    x = c(),
    S = p(ht, a.url),
    C = y(S.conversationId$),
    w = y(S.pendingWorktreeId$),
    T = y(at),
    E = Re(),
    D = Me(),
    k = y(ft),
    [A, ee] = (0, sn.useState)(!1),
    [te, N] = (0, sn.useState)(!1),
    ie;
  t[0] !== E || t[1] !== v || t[2] !== x || t[3] !== _
    ? ((ie = (e) => {
        (v.logProductEvent(be, {
          action: ke.CODEX_AUTOMATION_ACTION_UPDATED,
          source: Ce.CODEX_AUTOMATION_SOURCE_PR_MERGE_HELPER,
          success: !0,
          ...ct(e.item),
        }),
          x.invalidateQueries({ queryKey: b(`list-automations`) }),
          _.get(Be).success(
            E.formatMessage({
        ...
        (v.logProductEvent(be, {
          ...
          failureReason:
            ...
            `Automation does not exist in the app and could not be updated. It may have been deleted manually by the user.`
              ? he.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION
              : he.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
        }),
          _.get(Be).danger(
            E.formatMessage({
  ...
  let F;
  t[9] !== ie || t[10] !== P
    ? ((F = { onSuccess: ie, onError: P }), (t[9] = ie), (t[10] = P), (t[11] = F))
    : (F = t[11]);
  let I = d(`automation-update`, F),
    L = (0, sn.useId)(),
    R = i ?? a.hostId ?? `local`,
    oe = T.data,
    se = T.isLoading || T.isFetching,
    z,
    B,
    V;
  if (t[12] !== oe?.items || t[13] !== T.isError || t[14] !== se || t[15] !== C || t[16] !== w) {
    z = Xe({ automations: oe?.items ?? [], conversationId: C, includePausedAutomations: !0 });
    let e = C == null && w != null;
    ((B = z?.status === `PAUSED`),
      (V = zt({
        automationStatus: z?.status,
        hasConversation: C != null,
        isAutomationsLoading: se,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (de = t[20]);
  let U;
  t[21] !== a || t[22] !== o || t[23] !== R
    ? ((U = { hostId: R, item: a, onSuccess: de, repo: o }),
      (t[21] = a),
      (t[22] = o),
      (t[23] = R),
      (t[24] = U))
    : (U = t[24]);
  let W = en(U),
    G = W.isPending || W.isAgentModePending,
    pe = W.isPending || I.isPending || (!B && !H && W.isAgentModePending),
    me;
  t[25] !== z ||
  t[26] !== H ||
  t[27] !== B ||
  ...
  t[37] !== w
    ? ((me = (e) => {
        if ((m && e.stopPropagation(), B && z != null)) {
          (Tt(_, { action: `merge_with_codex_resumed`, item: a, surface: h }), I.mutate(Ht(z)));
          return;
        }
        if (H) {
          let e = Qt({ conversationId: C, pendingWorktreeId: w });
          e != null &&
            (Tt(_, { action: `merge_with_codex_task_opened`, item: a, surface: h }), D(e));
          return;
        }
        if (!W.isAgentModePending) {
          if (k) {
            (Tt(_, { action: `merge_with_codex_started`, item: a, surface: h }), W.mutate(!1));
            return;
          }
          (Tt(_, { action: `merge_with_codex_dialog_opened`, item: a, surface: h }), ee(!1), N(!0));
        }
      }),
      (t[25] = z),
      (t[26] = H),
  ...
  let K = me,
    q;
  t[39] !== A || t[40] !== a || t[41] !== _ || t[42] !== W || t[43] !== h
    ? ((q = (e) => {
        (e.preventDefault(),
          !W.isAgentModePending &&
            (Tt(_, { action: `merge_with_codex_started`, item: a, surface: h }), W.mutate(A)));
      }),
      (t[39] = A),
      (t[40] = a),
      (t[41] = _),
  ...
  t[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ge = (0, X.jsx)(Y, {
        ...
        description: `Tooltip explaining that the Merge with Codex pull request button starts a scheduled task to watch pull request CI`,
      })),
      (t[45] = ge))
    : (ge = t[45]);
  let _e;
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_e = (0, X.jsx)(ae, { className: `icon-xxs` })), (t[46] = _e))
    : (_e = t[46]);
  let ve;
  t[47] !== H || t[48] !== B
    ? ((ve = B
    ...
    : (ve = t[49]);
  let ye;
  t[50] !== r || t[51] !== K || t[52] !== pe || t[53] !== f || t[54] !== ve
    ? ((ye = (0, X.jsx)(ce, {
        tooltipContent: ge,
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, X.jsx)(ae, { className: `icon-sm text-token-foreground` })),
      (we = (0, X.jsx)(Y, {
  ...
  t[63] === E
    ...
    : ((Ae = E.formatMessage({
      ...
      (t[64] = Ae));
  let je;
  t[65] !== A || t[66] !== W.isPending || t[67] !== Ae
    ? ((je = (0, X.jsx)(re, {
        ...
        children: (0, X.jsxs)(`label`, {
          ...
          children: [
            De,
            (0, X.jsx)(fe, { checked: A, disabled: Oe, ariaLabel: Ae, size: `sm`, onChange: ee }),
          ],
        }),
      })),
      (t[65] = A),
  ...
  t[69] === _
    ...
    : ((Ne = (e) => {
      ...
      (t[70] = Ne));
  let Pe;
  t[71] !== k || t[72] !== L || t[73] !== W.isPending || t[74] !== Ne
    ? ((Pe = (0, X.jsx)(le, { id: L, checked: k, disabled: W.isPending, onCheckedChange: Ne })),
      (t[71] = k),
      (t[72] = L),
      (t[73] = W.isPending),
      (t[74] = Ne),
  ...
  t[85] === G
    ? (We = t[86])
    : ((We = (0, X.jsx)(ne, { color: `primary`, loading: G, type: `submit`, children: Ue })),
      (t[85] = G),
      (t[86] = We));
  let Ge;
  t[87] !== Le || t[88] !== He || t[89] !== We
    ? ((Ge = (0, X.jsxs)(ue, { children: [Le, He, We] })),
      (t[87] = Le),
      (t[88] = He),
      (t[89] = We),
      (t[90] = Ge))
  ...
  return (
    t[99] !== ye || t[100] !== qe
      ? ((Je = (0, X.jsxs)(X.Fragment, { children: [ye, qe] })),
        (t[99] = ye),
        (t[100] = qe),
        (t[101] = Je))
      : (Je = t[101]),
...
function ln(e) {
      ...
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, Z.jsx)(Ge, { className: `icon-2xs opacity-40` }),
            ],
          })),
          (t[0] = e))
        : (e = t[0]),
  ...
  if (r) {
    ...
    t[4] === c
      ...
      : ((a = c.formatMessage({
        ...
        (t[5] = a));
    let s;
    t[6] === o ? (s = t[7]) : ((s = () => o(!1)), (t[6] = o), (t[7] = s));
    let l;
    t[8] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((l = (0, Z.jsx)(Ge, { className: `icon-2xs` })), (t[8] = l))
      : (l = t[8]);
    let u;
    return (
      t[9] !== n || t[10] !== a || t[11] !== s
  ...
  t[13] === a
    ...
    : ((l = a
        ? (0, Z.jsx)(Y, {
            id: `pullRequestsPage.detail.actions.enableAutoMerge.trigger`,
            defaultMessage: `Enable auto-merge`,
            description: `Button label for enabling auto-merge when a pull request cannot be merged immediately`,
          })
        : (0, Z.jsx)(Y, {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Z.jsx)(H, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[15] = u))
    : (u = t[15]);
  let d;
  t[16] === l
    ? (d = t[17])
    : ((d = (0, Z.jsxs)(ne, { color: `secondary`, size: `toolbar`, children: [l, u] })),
      (t[16] = l),
      (t[17] = d));
  let f;
  ...
  let p;
  t[19] !== a || t[20] !== s
    ? ((p = (0, Z.jsx)(G.Item, { disabled: a, onSelect: s, children: f })),
      (t[19] = a),
      (t[20] = s),
      (t[21] = p))
    : (p = t[21]);
  let m;
  t[22] === o ? (m = t[23]) : ((m = () => o(!0)), (t[22] = o), (t[23] = m));
  let h;
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Z.jsx)(Y, {
        id: `pullRequestsPage.detail.actions.enableAutoMerge.menuItem`,
        defaultMessage: `Enable auto-merge`,
  ...
  let g;
  t[25] !== n || t[26] !== m
    ? ((g = (0, Z.jsx)(G.Item, { disabled: n, onSelect: m, children: h })),
      (t[25] = n),
      (t[26] = m),
      (t[27] = g))
    : (g = t[27]);
  let _;
  return (
    t[28] !== d || t[29] !== p || t[30] !== g
      ? ((_ = (0, Z.jsxs)(oe, { align: `end`, triggerButton: d, children: [p, g] })),
        (t[28] = d),
        (t[29] = p),
        (t[30] = g),
        (t[31] = _))
...
var un,
  Z,
  dn = e(() => {
    ((un = r()), Ee(), I(), k(), L(), V(), de(), We(), (Z = w()));
  });
function fn(e) {
  let t = (0, gn.c)(106),
    { hostId: r, item: i, pullRequestBody: a, request: o, surface: s, variant: l } = e,
    u = s === void 0 ? `pull_request_page` : s,
    d = l === void 0 ? `page` : l,
    p = g(n),
    m = Re(),
    h = c(),
  ...
  t[6] !== o
    ? ((C = async () => {
        await Promise.all([
          h.invalidateQueries({ queryKey: b(`gh-pr-board`) }),
          h.invalidateQueries({ queryKey: b(`gh-pr-body`, o) }),
          h.invalidateQueries({ queryKey: b(`gh-pr-checks`, o) }),
          h.invalidateQueries({ queryKey: b(`gh-pr-comments`, o) }),
          h.invalidateQueries({
            queryKey: b(`gh-pr-status`, { cwd: i.cwd, headBranch: i.headBranch, hostId: r }),
          }),
          h.invalidateQueries({
            queryKey: b(`gh-pr-status`, {
              cwd: i.cwd,
  ...
  t[8] !== w || t[9] !== x || t[10] !== p
    ? ((T = (e) => {
        (async () => {
          (await w(),
            e && x !== `squash` && (await me(p, f.pullRequestMergeMethod, `squash`)),
            y(!1));
        })();
      }),
      (t[8] = w),
  ...
  let A = Ft(k),
    ee;
  t[20] !== r || t[21] !== i.cwd || t[22] !== i.headBranch
    ? ((ee = {
        cwd: i.cwd,
        headBranch: i.headBranch,
        hostId: r,
  ...
  let j = Ft(ee),
    te = a != null,
    M = a?.isDraft ?? i.state === `draft`,
    re = i.state === `merged` || a?.hasOpenPr === !1,
    N = a?.isAutoMergeEnabled === !0,
    P;
  t[24] !== M || t[25] !== re || t[26] !== i.ciStatus || t[27] !== O.isPending || t[28] !== a
    ? ((P = pn(a, re, M, i.ciStatus, O.isPending)),
      (t[24] = M),
      (t[25] = re),
      (t[26] = i.ciStatus),
      (t[27] = O.isPending),
  ...
  t[30] === F
    ...
    : ((I =
      ...
      (t[31] = I));
  let L = I,
    R = !te || re || (!N && M) || A.isPending,
    oe = !te || re || j.isPending,
    se;
  t[32] !== M ||
  t[33] !== re ||
  t[34] !== te ||
  ...
  t[37] !== a ||
  t[38] !== _
    ? ((se = !S && _ && te && !re && !M && a.canMerge !== !0 && Rt(i)),
      (t[32] = M),
      (t[33] = re),
      (t[34] = te),
      (t[35] = S),
  ...
  t[46] !== u
    ? ((B = () => {
        ...
        (Tt(p, { action: a.isDraft ? `mark_ready` : `mark_draft`, item: i, surface: u }),
          j.mutate(
            { action: e, cwd: i.cwd, number: i.number, repo: a.repo },
            {
              onSuccess: (t) => {
                if (t.status !== `success`) {
                  p.get(Be).danger(t.error);
                  return;
                }
                (p.get(Be).success(mn(e, m)), E(!1));
              },
            },
          ));
      }),
  ...
  t[56] !== u
    ? ((V = (e) => {
        a != null &&
          (Tt(p, { action: e ? `enable_auto_merge` : `disable_auto_merge`, item: i, surface: u }),
          A.mutate(
            {
            ...
            },
            {
              onSuccess: (t) => {
                ...
                (p.get(Be).success(mn(`toggle-auto-merge`, m)), E(v && e));
              },
            },
          ));
      }),
  ...
  t[66] !== u
    ? ((de = () => {
        a != null &&
          (Tt(p, { action: `merge`, item: i, surface: u }),
          O.mutate(
            { cwd: i.cwd, mergeMethod: le, number: i.number, repo: a.repo },
            {
              onSuccess: (e) => {
                if (e.status !== `success`) {
                  hn({
  ...
  if (S) {
    let e = O.isPending || A.isPending,
      n;
    return (
      t[68] !== R || t[69] !== H || t[70] !== U || t[71] !== N || t[72] !== ae || t[73] !== e
        ? ((n = (0, Q.jsx)(ln, {
            autoMergeDisabled: R,
            isAutoMergeEnabled: N,
            isPending: e,
            mergeDisabled: ae,
            onAutoMergeChange: H,
            onMerge: U,
  ...
  t[75] === M
    ...
    : ((W = M
      ...
      (t[76] = W));
  let G;
  t[77] !== j.isPending || t[78] !== oe || t[79] !== ue || t[80] !== W
    ? ((G = (0, Q.jsx)(ne, {
        color: `outline`,
        disabled: oe,
        loading: j.isPending,
...
function hn({ scope: e, error: t, intl: n, mergeMethod: r, onSquashRetry: i }) {
...
function yn(e) {
  let t = (0, bn.c)(12),
    { density: n, items: r, labelTone: i } = e,
    a = n === void 0 ? `compact` : n,
    o = i === void 0 ? `tertiary` : i,
    s = a === `comfortable` ? `gap-1` : `gap-px`,
    c;
  t[0] === s ? (c = t[1]) : ((c = B(`flex flex-col`, s)), (t[0] = s), (t[1] = c));
  let l;
  if (t[2] !== a || t[3] !== r || t[4] !== o) {
    let e;
    (t[6] !== a || t[7] !== o
      ? ((e = (e) => {
          let t = (0, xn.jsx)(`span`, {
            className: B(
              `flex items-center`,
              a === `comfortable` && `min-h-7`,
              o === `primary` ? `text-token-foreground` : `text-token-text-tertiary`,
            ),
            children: e.label,
          });
          return (0, xn.jsx)(
            Ue,
            {
              ...
              label:
                e.tooltipContent == null
                  ? t
                  : (0, xn.jsx)(ce, { tooltipContent: e.tooltipContent, children: t }),
              trailing: e.trailing,
              trailingVisible: e.trailing != null,
              onClick: e.onClick,
            },
            e.id,
          );
  ...
  return (
    t[9] !== c || t[10] !== l
      ? ((u = (0, xn.jsx)(`div`, { className: c, children: l })),
        (t[9] = c),
        (t[10] = l),
        (t[11] = u))
      : (u = t[11]),
...
function Cn(e) {
  ...
  if (
    ...
    let e;
    (t[8] !== d || t[9] !== a || t[10] !== p || t[11] !== s || t[12] !== l || t[13] !== u
      ? ((e = (e, t) => {
          let n = e.link,
            r = !!s?.(e),
            i = r ? u : l;
          return {
            ...
            onClick:
              n == null
                ? void 0
                : (e) => {
                    U({ event: e, href: n, initiator: `pull_request_link` });
                  },
            tooltipContent: (0, $.jsx)(En, { status: e.status }),
          };
        }),
        (t[8] = d),
        (t[9] = a),
  ...
  let g = h,
    _;
  return (
    t[15] !== g || t[16] !== f || t[17] !== m
      ? ((_ = (0, $.jsx)(yn, { density: f, items: g, labelTone: m })),
        (t[15] = g),
        (t[16] = f),
        (t[17] = m),
        (t[18] = _))
...
function Tn(e) {
  switch (e) {
    case `failing`:
      return (0, $.jsx)(rt, { className: `icon-sm shrink-0 text-token-charts-red` });
    case `pending`:
      return (0, $.jsx)(et, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    case `passing`:
      return (0, $.jsx)(R, { className: `icon-sm shrink-0 text-token-charts-green` });
    case `skipped`:
    case `unknown`:
      return (0, $.jsx)(Ct, { className: `icon-sm shrink-0 text-token-text-tertiary` });
  }
}
function En(e) {
  let t = (0, Dn.c)(5),
...
var Dn,
  ...
  An = e(() => {
    ((Dn = r()),
      ...
      Sn(),
      ($ = w()),
      (kn = { failing: 0, pending: 1, skipped: 2, unknown: 3, passing: 4 }));
  });
export {
  vt as C,
  wt as S,
...
//# sourceMappingURL=pull-request-check-rows.js.map
