...
function yt(e) {
  let t = (0, bt.c)(15),
    ...
    u = !(o !== void 0 && o) && `-me-1.5`,
    d;
  t[0] === u ? (d = t[1]) : ((d = K(`inline-flex`, u)), (t[0] = u), (t[1] = d));
  ...
  let h;
  t[9] !== d || t[10] !== m
    ? ((h = (0, xt.jsx)(`span`, { className: d, children: m })),
      (t[9] = d),
      (t[10] = m),
      (t[11] = h))
    : (h = t[11]);
  ...
  return (
    t[12] !== g || t[13] !== s
      ? ((_ = (0, xt.jsx)(Ce, { tooltipContent: s, children: g })),
        (t[12] = g),
        (t[13] = s),
        (t[14] = _))
      : (_ = t[14]),
...
function Y(e, { action: t, item: n, surface: r }) {
  E(e, m, { action: t, surface: r, state: n.state, isAuthor: n.isAuthor });
}
function Et(e, { item: t, surface: n }) {
  E(e, O, { surface: n, state: t.state, isAuthor: t.isAuthor });
}
function Dt(e, { kind: t, surface: n }) {
  E(e, u, { kind: t, surface: n });
}
var Ot = e(() => {
  (T(), i());
});
...
function At(e) {
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((l = (e, t) => {
        if (e.status === `success`) {
          if (r != null) {
            let e = (e) => {
              s.setQueryData(d(`gh-pr-status`, e), jt);
            };
            (e({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
              e({ cwd: t.cwd, headBranch: r, hostId: t.hostId, number: t.number, repo: t.repo }),
              Promise.all([
                s.invalidateQueries({ queryKey: d(`gh-pr-body`) }),
                s.invalidateQueries({ queryKey: d(`gh-pr-checks`) }),
                s.invalidateQueries({ queryKey: d(`gh-pr-comments`) }),
                s.invalidateQueries({
                  queryKey: d(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
                }),
                s.invalidateQueries({
  ...
  t[12] !== i || t[13] !== f
    ? ((p = (e, t) => {
      ...
      (m = (e, t) => f.mutateAsync({ ...e, hostId: i }, t)),
      (t[12] = i),
      (t[13] = f),
      (t[14] = p),
      (t[15] = m))
  ...
  let h;
  return (
    t[16] !== f || t[17] !== p || t[18] !== m
      ? ((h = { ...f, mutate: p, mutateAsync: m }),
        (t[16] = f),
        (t[17] = p),
        (t[18] = m),
        (t[19] = h))
...
function Ft(e) {
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((l = (e, t) => {
        ...
        if (
          (s.invalidateQueries({ queryKey: d(`gh-pr-comments`) }), t.action === `request-reviewers`)
        ) {
          o?.(e, t);
          return;
        }
        ...
        let n = (e) => {
          s.setQueryData(d(`gh-pr-status`, e), (e) => {
            if (e?.status !== `success`) return e;
            switch (t.action) {
              case `toggle-auto-merge`:
                return { ...e, isAutoMergeEnabled: t.enabled };
...
function Yt() {
  return [
    ...
    `Use ::${P}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
...
function Qt({ conversationId: e, pendingWorktreeId: t }) {
  return e == null ? (t == null ? null : be(t)) : n(e);
}
var $t = e(() => {
  S();
});
function en(e) {
  let t = (0, tn.c)(33),
    ...
    s = ee(),
    c = He(),
    { createPendingWorktree: l } = Je(),
    u;
  t[0] !== n || t[1] !== r.cwd
    ? ((u = { conversationId: null, cwdOverride: r.cwd, hostId: n }),
      (t[0] = n),
      (t[1] = r.cwd),
      (t[2] = u))
    : (u = t[2]);
  let {
    ...
    { activeMode: h } = Ae(null),
    { serviceTierSettings: _ } = Te(null),
    y;
  t[3] !== n || t[4] !== r.cwd
    ? ((y = { hostId: n, workspaceRoot: r.cwd }), (t[3] = n), (t[4] = r.cwd), (t[5] = y))
    : (y = t[5]);
  let { resolvedConfigPath: b } = ht(y),
    x;
  t[6] !== h ||
  t[7] !== d ||
  t[8] !== l ||
  ...
  t[16] !== m
    ? ((x = async (e) => {
        let t = Bt({ includeReviewComments: e, item: r, repo: a }),
          i = [{ type: `text`, text: t, text_elements: [] }],
          { config: o } = await N(`read-config-for-host`, {
            hostId: n,
            includeLayers: !1,
            cwd: r.cwd,
          }),
        ...
        return l({
          ...
          heartbeatAutomation: Vt({ includeReviewComments: e, item: r, name: u, repo: a }),
        });
      }),
      (t[6] = h),
      (t[7] = d),
    ...
    : (x = t[17]);
  let S;
  t[18] !== r.url || t[19] !== c || t[20] !== i || t[21] !== o
    ? ((S = (e) => {
        (at(o, { pendingWorktreeId: e, pullRequestUrl: r.url }), i(), c(be(e)));
      }),
      (t[18] = r.url),
      (t[19] = c),
      (t[20] = i),
  ...
  t[23] !== s || t[24] !== o
    ? ((C = (e) => {
        (v.error(`Error starting pull request merge helper`, { safe: {}, sensitive: { error: e } }),
          o
            .get(q)
            .danger(
              s.formatMessage(
  ...
  return (
    t[30] !== f || t[31] !== T
      ? ((E = { ...T, isAgentModePending: f }), (t[30] = f), (t[31] = T), (t[32] = E))
      : (E = t[32]),
    E
  );
}
...
function an(e) {
  let t = (0, on.c)(102),
    { className: n, hostId: r, item: i, repo: a, size: o, stopPropagation: c, surface: u } = e,
    f = o === void 0 ? `default` : o,
    p = c === void 0 ? !1 : c,
    ...
    y = me(),
    b = C(st, i.url),
    x = le(b.conversationId$),
    S = le(b.pendingWorktreeId$),
    w = le(et),
    T = ee(),
    E = He(),
    D = le(it),
    [O, re] = (0, sn.useState)(!1),
    [k, A] = (0, sn.useState)(!1),
    ie;
  t[0] !== T || t[1] !== v || t[2] !== y || t[3] !== h
    ? ((ie = (e) => {
        (v.logProductEvent(je, {
          action: xe.CODEX_AUTOMATION_ACTION_UPDATED,
          source: ve.CODEX_AUTOMATION_SOURCE_PR_MERGE_HELPER,
          success: !0,
          ...Qe(e.item),
        }),
          y.invalidateQueries({ queryKey: d(`list-automations`) }),
          h
            .get(q)
            .success(
              T.formatMessage({
        ...
        (v.logProductEvent(je, {
          ...
          failureReason:
            ...
            `Automation does not exist in the app and could not be updated. It may have been deleted manually by the user.`
              ? _e.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION
              : _e.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
        }),
          h
            .get(q)
            .danger(
  ...
  let M;
  t[9] !== ie || t[10] !== j
    ? ((M = { onSuccess: ie, onError: j }), (t[9] = ie), (t[10] = j), (t[11] = M))
    : (M = t[11]);
  let se = te(`automation-update`, M),
    N = (0, sn.useId)(),
    P = r ?? i.hostId ?? `local`,
    ue = w.data,
    de = w.isLoading || w.isFetching,
    F,
    I,
    pe;
  if (t[12] !== ue?.items || t[13] !== w.isError || t[14] !== de || t[15] !== x || t[16] !== S) {
    F = dt({ automations: ue?.items ?? [], conversationId: x, includePausedAutomations: !0 });
    let e = x == null && S != null;
    ((I = F?.status === `PAUSED`),
      (pe = zt({
        automationStatus: F?.status,
        hasConversation: x != null,
        isAutomationsLoading: de,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (R = t[20]);
  let z;
  t[21] !== i || t[22] !== a || t[23] !== P
    ? ((z = { hostId: P, item: i, onSuccess: R, repo: a }),
      (t[21] = i),
      (t[22] = a),
      (t[23] = P),
      (t[24] = z))
    : (z = t[24]);
  let B = en(z),
    V = B.isPending || B.isAgentModePending,
    he = B.isPending || se.isPending || (!I && !L && B.isAgentModePending),
    H;
  t[25] !== F ||
  t[26] !== L ||
  t[27] !== I ||
  ...
  t[37] !== S
    ? ((H = (e) => {
        if ((p && e.stopPropagation(), I && F != null)) {
          (Y(h, { action: `merge_with_codex_resumed`, item: i, surface: m }), se.mutate(Ht(F)));
          return;
        }
        if (L) {
          let e = Qt({ conversationId: x, pendingWorktreeId: S });
          e != null &&
            (Y(h, { action: `merge_with_codex_task_opened`, item: i, surface: m }), E(e));
          return;
        }
        if (!B.isAgentModePending) {
          if (D) {
            (Y(h, { action: `merge_with_codex_started`, item: i, surface: m }), B.mutate(!1));
            return;
          }
          (Y(h, { action: `merge_with_codex_dialog_opened`, item: i, surface: m }), re(!1), A(!0));
        }
      }),
      (t[25] = F),
      (t[26] = L),
  ...
  let U = H,
    W;
  t[39] !== O || t[40] !== i || t[41] !== h || t[42] !== B || t[43] !== m
    ? ((W = (e) => {
        (e.preventDefault(),
          !B.isAgentModePending &&
            (Y(h, { action: `merge_with_codex_started`, item: i, surface: m }), B.mutate(O)));
      }),
      (t[39] = O),
      (t[40] = i),
      (t[41] = h),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, X.jsx)(s, { className: `icon-xxs` })), (t[46] = ye))
    : (ye = t[46]);
  let be;
  t[47] !== L || t[48] !== I
    ? ((be = I
    ...
    : (be = t[49]);
  let Se;
  t[50] !== n || t[51] !== U || t[52] !== he || t[53] !== f || t[54] !== be
    ? ((Se = (0, X.jsx)(Ce, {
        tooltipContent: K,
        children: (0, X.jsxs)(ge, {
          className: n,
          color: `secondary`,
          loading: he,
          size: f,
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Te = (0, X.jsx)(s, { className: `icon-sm text-token-foreground` })),
      (Ee = (0, X.jsx)(_, {
  ...
  t[63] === T
    ...
    : ((Me = T.formatMessage({
      ...
      (t[64] = Me));
  let Ne;
  t[65] !== O || t[66] !== B.isPending || t[67] !== Me
    ? ((Ne = (0, X.jsx)(Re, {
        ...
        children: (0, X.jsxs)(`label`, {
          ...
          children: [
            ke,
            (0, X.jsx)(fe, { checked: O, disabled: Ae, ariaLabel: Me, size: `sm`, onChange: re }),
          ],
        }),
      })),
      (t[65] = O),
  ...
  t[69] === h
    ...
    : ((J = (e) => {
      ...
      (t[70] = J));
  let Pe;
  t[71] !== D || t[72] !== N || t[73] !== B.isPending || t[74] !== J
    ? ((Pe = (0, X.jsx)(lt, { id: N, checked: D, disabled: B.isPending, onCheckedChange: J })),
      (t[71] = D),
      (t[72] = N),
      (t[73] = B.isPending),
      (t[74] = J),
  ...
  t[85] === V
    ? (We = t[86])
    : ((We = (0, X.jsx)(ge, { color: `primary`, loading: V, type: `submit`, children: Ue })),
      (t[85] = V),
      (t[86] = We));
  let Ge;
  t[87] !== Ie || t[88] !== Ve || t[89] !== We
    ? ((Ge = (0, X.jsxs)(ae, { children: [Ie, Ve, We] })),
      (t[87] = Ie),
      (t[88] = Ve),
      (t[89] = We),
      (t[90] = Ge))
  ...
  return (
    t[99] !== Se || t[100] !== qe
      ? ((Je = (0, X.jsxs)(X.Fragment, { children: [Se, qe] })),
        (t[99] = Se),
        (t[100] = qe),
        (t[101] = Je))
      : (Je = t[101]),
...
function ln(e) {
      ...
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, Z.jsx)(vt, { className: `icon-2xs opacity-40` }),
            ],
          })),
          (t[0] = e))
        : (e = t[0]),
  ...
  if (r) {
    ...
    t[8] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((l = (0, Z.jsx)(vt, { className: `icon-2xs` })), (t[8] = l))
      : (l = t[8]);
    let u;
    return (
      t[9] !== n || t[10] !== a || t[11] !== s
  ...
  t[16] === l
    ? (d = t[17])
    : ((d = (0, Z.jsxs)(ge, { color: `secondary`, size: `toolbar`, children: [l, u] })),
      (t[16] = l),
      (t[17] = d));
  let f;
  ...
  let p;
  t[19] !== a || t[20] !== s
    ? ((p = (0, Z.jsx)(Pe.Item, { disabled: a, onSelect: s, children: f })),
      (t[19] = a),
      (t[20] = s),
      (t[21] = p))
    : (p = t[21]);
  ...
  let g;
  t[25] !== n || t[26] !== m
    ? ((g = (0, Z.jsx)(Pe.Item, { disabled: n, onSelect: m, children: h })),
      (t[25] = n),
      (t[26] = m),
      (t[27] = g))
    : (g = t[27]);
  ...
  return (
    t[28] !== d || t[29] !== p || t[30] !== g
      ? ((v = (0, Z.jsxs)(B, { align: `end`, triggerButton: d, children: [p, g] })),
        (t[28] = d),
        (t[29] = p),
        (t[30] = g),
        (t[31] = v))
...
function fn(e) {
  let t = (0, gn.c)(106),
    ...
    m = ct(),
    [h, v] = (0, _n.useState)(!1),
    y = ie(he.pullRequestMergeMethod),
    b = l === `side-panel`,
    x;
  t[0] !== n ||
  t[1] !== r.cwd ||
  ...
  t[6] !== a
    ? ((x = async () => {
        await Promise.all([
          p.invalidateQueries({ queryKey: d(`gh-pr-board`) }),
          p.invalidateQueries({ queryKey: d(`gh-pr-body`, a) }),
          p.invalidateQueries({ queryKey: d(`gh-pr-checks`, a) }),
          p.invalidateQueries({ queryKey: d(`gh-pr-comments`, a) }),
          p.invalidateQueries({
            queryKey: d(`gh-pr-status`, { cwd: r.cwd, headBranch: r.headBranch, hostId: n }),
          }),
          p.invalidateQueries({
            queryKey: d(`gh-pr-status`, {
              cwd: r.cwd,
  ...
  t[8] !== S || t[9] !== y || t[10] !== u
    ? ((C = (e) => {
        (async () => {
          (await S(),
            e && y !== `squash` && (await ze(u, he.pullRequestMergeMethod, `squash`)),
            v(!1));
        })();
      }),
      (t[8] = S),
  ...
  let ne = Ft(O),
    re = i != null,
    k = i?.isDraft ?? r.state === `draft`,
    A = r.state === `merged` || i?.hasOpenPr === !1,
    ae = i?.isAutoMergeEnabled === !0,
    oe;
  t[24] !== k || t[25] !== A || t[26] !== r.ciStatus || t[27] !== E.isPending || t[28] !== i
    ? ((oe = pn(i, A, k, r.ciStatus, E.isPending)),
      (t[24] = k),
      (t[25] = A),
      (t[26] = r.ciStatus),
      (t[27] = E.isPending),
  ...
  t[30] === j
    ...
    : ((se =
      ...
      (t[31] = se));
  let N = se,
    P = !re || A || (!ae && k) || D.isPending,
    le = !re || A || ne.isPending,
    ue;
  t[32] !== k ||
  t[33] !== A ||
  t[34] !== re ||
  ...
  t[37] !== i ||
  t[38] !== m
    ? ((ue = !b && m && re && !A && !k && i.canMerge !== !0 && Rt(r)),
      (t[32] = k),
      (t[33] = A),
      (t[34] = re),
      (t[35] = b),
  ...
  t[46] !== c
    ? ((I = () => {
        ...
        (Y(u, { action: i.isDraft ? `mark_ready` : `mark_draft`, item: r, surface: c }),
          ne.mutate(
  ...
  t[56] !== c
    ? ((L = (e) => {
        i != null &&
          (Y(u, { action: e ? `enable_auto_merge` : `disable_auto_merge`, item: r, surface: c }),
          D.mutate(
            {
            ...
            },
            {
              onSuccess: (t) => {
                ...
                (u.get(q).success(mn(`toggle-auto-merge`, f)), w(h && e));
              },
            },
          ));
      }),
  ...
  t[66] !== c
    ? ((z = () => {
        i != null &&
          (Y(u, { action: `merge`, item: r, surface: c }),
          E.mutate(
            { cwd: r.cwd, mergeMethod: F, number: r.number, repo: i.repo },
            {
              onSuccess: (e) => {
                if (e.status !== `success`) {
                  hn({
  ...
  if (b) {
    let e = E.isPending || D.isPending,
      n;
    return (
      t[68] !== P || t[69] !== R || t[70] !== B || t[71] !== ae || t[72] !== M || t[73] !== e
        ? ((n = (0, Q.jsx)(ln, {
            autoMergeDisabled: P,
            isAutoMergeEnabled: ae,
            isPending: e,
            mergeDisabled: M,
            onAutoMergeChange: R,
            onMerge: B,
  ...
  t[75] === k
    ...
    : ((V = k
      ...
      (t[76] = V));
  let H;
  t[77] !== ne.isPending || t[78] !== le || t[79] !== pe || t[80] !== V
    ? ((H = (0, Q.jsx)(ge, {
        color: `outline`,
        disabled: le,
...
function yn(e) {
  let t = (0, bn.c)(12),
    ...
    c;
  t[0] === s ? (c = t[1]) : ((c = K(`flex flex-col`, s)), (t[0] = s), (t[1] = c));
  let l;
...
function Cn(e) {
          ...
          return {
            ...
            onClick:
              n == null
                ? void 0
                : (e) => {
                    ue({ event: e, href: n, initiator: `pull_request_link` });
                  },
  ...
  return (
    t[15] !== g || t[16] !== f || t[17] !== m
      ? ((v = (0, $.jsx)(yn, { density: f, items: g, labelTone: m })),
        (t[15] = g),
        (t[16] = f),
        (t[17] = m),
        (t[18] = v))
...
function Tn(e) {
  switch (e) {
    case `failing`:
      return (0, $.jsx)(tt, { className: `icon-sm shrink-0 text-token-charts-red` });
    case `pending`:
      return (0, $.jsx)(pt, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    case `passing`:
      return (0, $.jsx)(De, { className: `icon-sm shrink-0 text-token-charts-green` });
    case `skipped`:
    case `unknown`:
      return (0, $.jsx)(wt, { className: `icon-sm shrink-0 text-token-text-tertiary` });
  }
}
function En(e) {
  let t = (0, Dn.c)(5),
