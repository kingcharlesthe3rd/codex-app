...
import { r as Ge } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~pull-requests-page~new-~ozr5a6hk.js";
import {
  Bf as Ke,
  Gf as qe,
  Hr as Je,
...
function vt(e) {
  let t = (0, yt.c)(15),
    ...
    u = !(o !== void 0 && o) && `-me-1.5`,
    d;
  t[0] === u ? (d = t[1]) : ((d = z(`inline-flex`, u)), (t[0] = u), (t[1] = d));
  ...
  return (
    t[12] !== g || t[13] !== s
      ? ((_ = (0, bt.jsx)(ge, { tooltipContent: s, children: g })),
        (t[12] = g),
        (t[13] = s),
        (t[14] = _))
      : (_ = t[14]),
...
function Tt(e, { action: t, item: n, surface: r }) {
  G(e, be, { action: t, surface: r, state: n.state, isAuthor: n.isAuthor });
}
function Et(e, { item: t, surface: n }) {
  G(e, Te, { surface: n, state: t.state, isAuthor: t.isAuthor });
}
function Dt(e, { kind: t, surface: n }) {
  G(e, Se, { kind: t, surface: n });
}
var Ot = e(() => {
  (xe(), Ee());
});
...
function At(e) {
  let t = (0, Mt.c)(20),
    ...
    c;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((c = kt(n, r, i)), (t[0] = n), (t[1] = r), (t[2] = i), (t[3] = c))
    : (c = t[3]);
  let l;
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((l = (e, t) => {
        if (e.status === `success`) {
          if (r != null) {
            let e = (e) => {
              s.setQueryData(h(`gh-pr-status`, e), jt);
            };
            (e({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
              e({ cwd: t.cwd, headBranch: r, hostId: t.hostId, number: t.number, repo: t.repo }),
              Promise.all([
                s.invalidateQueries({ queryKey: h(`gh-pr-body`) }),
                s.invalidateQueries({ queryKey: h(`gh-pr-checks`) }),
                s.invalidateQueries({ queryKey: h(`gh-pr-comments`) }),
                s.invalidateQueries({
                  queryKey: h(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
                }),
                s.invalidateQueries({
                  queryKey: h(`gh-pr-status`, {
                    cwd: t.cwd,
                    headBranch: r,
                    hostId: t.hostId,
                    number: t.number,
...
function Ft(e) {
  let t = (0, It.c)(20),
    ...
    c;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((c = Pt({ cwd: n, headBranch: r, hostId: i })),
      (t[0] = n),
      (t[1] = r),
      (t[2] = i),
      (t[3] = c))
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((l = (e, t) => {
        ...
        if (
          (s.invalidateQueries({ queryKey: h(`gh-pr-comments`) }), t.action === `request-reviewers`)
        ) {
          o?.(e, t);
          return;
        }
        ...
        let n = (e) => {
          s.setQueryData(h(`gh-pr-status`, e), (e) => {
            if (e?.status !== `success`) return e;
            switch (t.action) {
              case `toggle-auto-merge`:
                return { ...e, isAutoMergeEnabled: t.enabled };
...
function Wt() {
  return Ye({ ...Xe(), intervalHours: 1, intervalMinutes: Xt });
}
function Gt(e) {
  return e
...
function Yt() {
  return [
    ...
    `Use ::${Ce}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
...
function Qt({ conversationId: e, pendingWorktreeId: t }) {
  return e == null ? (t == null ? null : p(t)) : o(e);
}
var $t = e(() => {
  c();
});
function en(e) {
  let t = (0, tn.c)(33),
    { hostId: n, item: i, onSuccess: o, repo: c } = e,
    l = s(a),
    d = Oe(),
    f = ve(),
    { createPendingWorktree: m } = C(),
    h;
  t[0] !== n || t[1] !== i.cwd
    ? ((h = { conversationId: null, cwdOverride: i.cwd, hostId: n }),
      (t[0] = n),
      (t[1] = i.cwd),
      (t[2] = h))
    : (h = t[2]);
  let {
      agentMode: g,
      isAgentModePending: _,
      permissionProfileId: v,
      shouldSendPermissionOverrides: y,
    } = tt(h),
    { activeMode: b } = rt(null),
    { serviceTierSettings: x } = Qe(null),
    S;
  t[3] !== n || t[4] !== i.cwd
    ? ((S = { hostId: n, workspaceRoot: i.cwd }), (t[3] = n), (t[4] = i.cwd), (t[5] = S))
    : (S = t[5]);
  let { resolvedConfigPath: w } = lt(S),
    E;
  t[6] !== b ||
  t[7] !== g ||
  t[8] !== m ||
  ...
  t[16] !== y
    ? ((E = async (e) => {
        let t = Bt({ includeReviewComments: e, item: i, repo: c }),
          r = [{ type: `text`, text: t, text_elements: [] }],
          { config: a } = await Re(`read-config-for-host`, {
            hostId: n,
            includeLayers: !1,
            cwd: i.cwd,
          }),
        ...
        return m({
          ...
          heartbeatAutomation: Vt({ includeReviewComments: e, item: i, name: s, repo: c }),
        });
      }),
      (t[6] = b),
      (t[7] = g),
    ...
    : (E = t[17]);
  let D;
  t[18] !== i.url || t[19] !== f || t[20] !== o || t[21] !== l
    ? ((D = (e) => {
        (Ve(l, { pendingWorktreeId: e, pullRequestUrl: i.url }), o(), f(p(e)));
      }),
      (t[18] = i.url),
      (t[19] = f),
      (t[20] = o),
  ...
  t[23] !== d || t[24] !== l
    ? ((O = (e) => {
        (r.error(`Error starting pull request merge helper`, { safe: {}, sensitive: { error: e } }),
          l
            .get(se)
            .danger(
              d.formatMessage(
  ...
  return (
    t[30] !== _ || t[31] !== A
      ? ((j = { ...A, isAgentModePending: _ }), (t[30] = _), (t[31] = A), (t[32] = j))
      : (j = t[32]),
    j
  );
}
...
function an(e) {
  let t = (0, on.c)(102),
    { className: n, hostId: r, item: i, repo: o, size: c, stopPropagation: l, surface: u } = e,
    d = c === void 0 ? `default` : c,
    p = l === void 0 ? !1 : l,
    m = u === void 0 ? `pull_request_page` : u,
    g = s(a),
    v = b(ye),
    y = _(),
    ee = f(ze, i.url),
    x = b(ee.conversationId$),
    C = b(ee.pendingWorktreeId$),
    w = b(et),
    T = Oe(),
    D = ve(),
    O = b(Ue),
    ...
    [j, M] = (0, sn.useState)(!1),
    N;
  t[0] !== T || t[1] !== v || t[2] !== y || t[3] !== g
    ? ((N = (e) => {
        (v.logProductEvent(Ne, {
          action: Fe.CODEX_AUTOMATION_ACTION_UPDATED,
          source: De.CODEX_AUTOMATION_SOURCE_PR_MERGE_HELPER,
          success: !0,
          ...$e(e.item),
        }),
        ...
        (v.logProductEvent(Ne, {
          ...
          failureReason:
            ...
            `Automation does not exist in the app and could not be updated. It may have been deleted manually by the user.`
              ? Ae.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION
              : Ae.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
        }),
          g
            .get(se)
            .danger(
  ...
  let P;
  t[9] !== N || t[10] !== te
    ? ((P = { onSuccess: N, onError: te }), (t[9] = N), (t[10] = te), (t[11] = P))
    : (P = t[11]);
  let F = S(`automation-update`, P),
    re = (0, sn.useId)(),
    I = r ?? i.hostId ?? `local`,
    oe = w.data,
    ce = w.isLoading || w.isFetching,
    L,
    R,
    z;
  if (t[12] !== oe?.items || t[13] !== w.isError || t[14] !== ce || t[15] !== x || t[16] !== C) {
    L = ht({ automations: oe?.items ?? [], conversationId: x, includePausedAutomations: !0 });
    let e = x == null && C != null;
    ((R = L?.status === `PAUSED`),
      (z = zt({
        automationStatus: L?.status,
        hasConversation: x != null,
        isAutomationsLoading: ce,
        isAutomationsQueryError: w.isError,
        isTaskStarting: e,
      })),
      (t[12] = oe?.items),
      (t[13] = w.isError),
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ue = t[20]);
  let V;
  t[21] !== i || t[22] !== o || t[23] !== I
    ? ((V = { hostId: I, item: i, onSuccess: ue, repo: o }),
      (t[21] = i),
      (t[22] = o),
      (t[23] = I),
      (t[24] = V))
    : (V = t[24]);
  let H = en(V),
    de = H.isPending || H.isAgentModePending,
    fe = H.isPending || F.isPending || (!R && !B && H.isAgentModePending),
    U;
  t[25] !== L ||
  t[26] !== B ||
  t[27] !== R ||
  ...
  t[37] !== C
    ? ((U = (e) => {
        if ((p && e.stopPropagation(), R && L != null)) {
          (Tt(g, { action: `merge_with_codex_resumed`, item: i, surface: m }), F.mutate(Ht(L)));
          return;
        }
        if (B) {
          let e = Qt({ conversationId: x, pendingWorktreeId: C });
          e != null &&
            (Tt(g, { action: `merge_with_codex_task_opened`, item: i, surface: m }), D(e));
          return;
        }
        if (!H.isAgentModePending) {
          if (O) {
            (Tt(g, { action: `merge_with_codex_started`, item: i, surface: m }), H.mutate(!1));
            return;
          }
          (Tt(g, { action: `merge_with_codex_dialog_opened`, item: i, surface: m }), A(!1), M(!0));
        }
      }),
      (t[25] = L),
      (t[26] = B),
  ...
  let W = U,
    _e;
  t[39] !== k || t[40] !== i || t[41] !== g || t[42] !== H || t[43] !== m
    ? ((_e = (e) => {
        (e.preventDefault(),
          !H.isAgentModePending &&
            (Tt(g, { action: `merge_with_codex_started`, item: i, surface: m }), H.mutate(k)));
      }),
      (t[39] = k),
      (t[40] = i),
      (t[41] = g),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = (0, X.jsx)(dt, { className: `icon-xxs` })), (t[46] = q))
    : (q = t[46]);
  let be;
  t[47] !== B || t[48] !== R
    ? ((be = R
    ...
    : (be = t[49]);
  let J;
  t[50] !== n || t[51] !== W || t[52] !== fe || t[53] !== d || t[54] !== be
    ? ((J = (0, X.jsx)(ge, {
        tooltipContent: K,
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, X.jsx)(dt, { className: `icon-sm text-token-foreground` })),
      (Ce = (0, X.jsx)(Y, {
  ...
  t[63] === T
    ...
    : ((je = T.formatMessage({
      ...
      (t[64] = je));
  let Me;
  t[65] !== k || t[66] !== H.isPending || t[67] !== je
    ? ((Me = (0, X.jsx)(ae, {
        ...
        children: (0, X.jsxs)(`label`, {
          ...
          children: [
            Ee,
            (0, X.jsx)(le, { checked: k, disabled: ke, ariaLabel: je, size: `sm`, onChange: A }),
          ],
        }),
      })),
      (t[65] = k),
  ...
  t[69] === g
    ...
    : ((Pe = (e) => {
      ...
      (t[70] = Pe));
  let Ie;
  t[71] !== O || t[72] !== re || t[73] !== H.isPending || t[74] !== Pe
    ? ((Ie = (0, X.jsx)(E, { id: re, checked: O, disabled: H.isPending, onCheckedChange: Pe })),
      (t[71] = O),
      (t[72] = re),
      (t[73] = H.isPending),
      (t[74] = Pe),
  ...
  t[85] === de
    ? (Ge = t[86])
    : ((Ge = (0, X.jsx)(ne, { color: `primary`, loading: de, type: `submit`, children: We })),
      (t[85] = de),
      (t[86] = Ge));
  let Ke;
  t[87] !== Re || t[88] !== He || t[89] !== Ge
    ? ((Ke = (0, X.jsxs)(pe, { children: [Re, He, Ge] })),
      (t[87] = Re),
      (t[88] = He),
      (t[89] = Ge),
      (t[90] = Ke))
  ...
  return (
    t[99] !== J || t[100] !== Je
      ? ((Ye = (0, X.jsxs)(X.Fragment, { children: [J, Je] })),
        (t[99] = J),
        (t[100] = Je),
        (t[101] = Ye))
      : (Ye = t[101]),
...
function ln(e) {
      ...
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, Z.jsx)(_t, { className: `icon-2xs opacity-40` }),
            ],
          })),
          (t[0] = e))
        : (e = t[0]),
  ...
  if (r) {
    ...
    t[8] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((l = (0, Z.jsx)(_t, { className: `icon-2xs` })), (t[8] = l))
      : (l = t[8]);
    let u;
    return (
      t[9] !== n || t[10] !== a || t[11] !== s
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Z.jsx)(oe, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[15] = u))
    : (u = t[15]);
  let d;
  t[16] === l
  ...
  let p;
  t[19] !== a || t[20] !== s
    ? ((p = (0, Z.jsx)(ue.Item, { disabled: a, onSelect: s, children: f })),
      (t[19] = a),
      (t[20] = s),
      (t[21] = p))
    : (p = t[21]);
  ...
  let g;
  t[25] !== n || t[26] !== m
    ? ((g = (0, Z.jsx)(ue.Item, { disabled: n, onSelect: m, children: h })),
      (t[25] = n),
      (t[26] = m),
      (t[27] = g))
    : (g = t[27]);
  ...
  return (
    t[28] !== d || t[29] !== p || t[30] !== g
      ? ((_ = (0, Z.jsxs)(I, { align: `end`, triggerButton: d, children: [p, g] })),
        (t[28] = d),
        (t[29] = p),
        (t[30] = g),
        (t[31] = _))
...
var un,
  Z,
  dn = e(() => {
    ((un = v()), J(), N(), H(), P(), U(), de(), gt(), (Z = y()));
  });
function fn(e) {
  let t = (0, gn.c)(106),
    { hostId: n, item: r, pullRequestBody: i, request: o, surface: c, variant: l } = e,
  ...
  t[6] !== o
    ? ((S = async () => {
        await Promise.all([
          m.invalidateQueries({ queryKey: h(`gh-pr-board`) }),
          m.invalidateQueries({ queryKey: h(`gh-pr-body`, o) }),
          m.invalidateQueries({ queryKey: h(`gh-pr-checks`, o) }),
          m.invalidateQueries({ queryKey: h(`gh-pr-comments`, o) }),
          m.invalidateQueries({
            queryKey: h(`gh-pr-status`, { cwd: r.cwd, headBranch: r.headBranch, hostId: n }),
          }),
          m.invalidateQueries({
            queryKey: h(`gh-pr-status`, {
              cwd: r.cwd,
  ...
  t[8] !== C || t[9] !== b || t[10] !== f
    ? ((w = (e) => {
        (async () => {
          (await C(),
            e && b !== `squash` && (await te(f, x.pullRequestMergeMethod, `squash`)),
            y(!1));
        })();
      }),
      (t[8] = C),
  ...
  let j = Ft(A),
    M = i != null,
    N = i?.isDraft ?? r.state === `draft`,
    P = r.state === `merged` || i?.hasOpenPr === !1,
    F = i?.isAutoMergeEnabled === !0,
    ie;
  t[24] !== N || t[25] !== P || t[26] !== r.ciStatus || t[27] !== D.isPending || t[28] !== i
    ? ((ie = pn(i, P, N, r.ciStatus, D.isPending)),
      (t[24] = N),
      (t[25] = P),
      (t[26] = r.ciStatus),
      (t[27] = D.isPending),
  ...
  t[37] !== i ||
  t[38] !== g
    ? ((B = !ee && g && M && !P && !N && i.canMerge !== !0 && Rt(r)),
      (t[32] = N),
      (t[33] = P),
      (t[34] = M),
      (t[35] = ee),
  ...
  t[46] !== u
    ? ((H = () => {
        ...
        (Tt(f, { action: i.isDraft ? `mark_ready` : `mark_draft`, item: r, surface: u }),
          j.mutate(
            { action: e, cwd: r.cwd, number: r.number, repo: i.repo },
            {
              onSuccess: (t) => {
                if (t.status !== `success`) {
                  f.get(se).danger(t.error);
                  return;
                }
                (f.get(se).success(mn(e, p)), T(!1));
              },
            },
          ));
      }),
  ...
  t[56] !== u
    ? ((fe = (e) => {
        i != null &&
          (Tt(f, { action: e ? `enable_auto_merge` : `disable_auto_merge`, item: r, surface: u }),
          k.mutate(
            {
            ...
            },
            {
              onSuccess: (t) => {
                ...
                (f.get(se).success(mn(`toggle-auto-merge`, p)), T(v && e));
              },
            },
          ));
      }),
  ...
  t[66] !== u
    ? ((me = () => {
        i != null &&
          (Tt(f, { action: `merge`, item: r, surface: u }),
          D.mutate(
  ...
  if (ee) {
    let e = D.isPending || k.isPending,
      n;
    return (
      t[68] !== L || t[69] !== pe || t[70] !== U || t[71] !== F || t[72] !== I || t[73] !== e
        ? ((n = (0, Q.jsx)(ln, {
            autoMergeDisabled: L,
            isAutoMergeEnabled: F,
            isPending: e,
            mergeDisabled: I,
  ...
  t[75] === N
    ...
    : ((W = N
      ...
      (t[76] = W));
  let he;
  t[77] !== j.isPending || t[78] !== z || t[79] !== de || t[80] !== W
    ? ((he = (0, Q.jsx)(ne, {
        color: `outline`,
        disabled: z,
        loading: j.isPending,
...
function yn(e) {
  let t = (0, bn.c)(12),
    ...
    c;
  t[0] === s ? (c = t[1]) : ((c = z(`flex flex-col`, s)), (t[0] = s), (t[1] = c));
  let l;
            ...
            ot,
            {
              ...
              label:
                e.tooltipContent == null
                  ? t
                  : (0, xn.jsx)(ge, { tooltipContent: e.tooltipContent, children: t }),
              trailing: e.trailing,
          ...
          return {
            ...
            onClick:
              n == null
                ? void 0
                : (e) => {
                    L({ event: e, href: n, initiator: `pull_request_link` });
                  },
...
function Tn(e) {
  switch (e) {
    case `failing`:
      return (0, $.jsx)(nt, { className: `icon-sm shrink-0 text-token-charts-red` });
    case `pending`:
      return (0, $.jsx)(pt, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    case `passing`:
      return (0, $.jsx)(W, { className: `icon-sm shrink-0 text-token-charts-green` });
    case `skipped`:
    case `unknown`:
