...
import { a as dt } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~new-thread-panel-page~o~bj5tp28r.js";
import {
  o as ft,
  s as pt,
...
function vt(e) {
  let t = (0, yt.c)(15),
    ...
    u = !(o !== void 0 && o) && `-me-1.5`,
    d;
  t[0] === u ? (d = t[1]) : ((d = Ce(`inline-flex`, u)), (t[0] = u), (t[1] = d));
  ...
  return (
    t[12] !== g || t[13] !== s
      ? ((_ = (0, bt.jsx)(se, { tooltipContent: s, children: g })),
        (t[12] = g),
        (t[13] = s),
        (t[14] = _))
      : (_ = t[14]),
...
function Tt(e, { action: t, item: n, surface: r }) {
  Te(e, J, { action: t, surface: r, state: n.state, isAuthor: n.isAuthor });
}
function Et(e, { item: t, surface: n }) {
  Te(e, H, { surface: n, state: t.state, isAuthor: t.isAuthor });
}
function Dt(e, { kind: t, surface: n }) {
  Te(e, ge, { kind: t, surface: n });
}
var Ot = e(() => {
  (B(), V());
});
...
function At(e) {
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((u = (e, t) => {
        if (e.status === `success`) {
          if (r != null) {
            let e = (e) => {
              s.setQueryData(m(`gh-pr-status`, e), jt);
            };
            (e({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
              e({ cwd: t.cwd, headBranch: r, hostId: t.hostId, number: t.number, repo: t.repo }),
              Promise.all([
                s.invalidateQueries({ queryKey: m(`gh-pr-body`) }),
                s.invalidateQueries({ queryKey: m(`gh-pr-checks`) }),
                s.invalidateQueries({ queryKey: m(`gh-pr-comments`) }),
                s.invalidateQueries({
                  queryKey: m(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
                }),
                s.invalidateQueries({
                  queryKey: m(`gh-pr-status`, {
                    cwd: t.cwd,
                    headBranch: r,
                    hostId: t.hostId,
                    number: t.number,
  ...
  let d;
  t[8] !== a || t[9] !== c || t[10] !== u
    ? ((d = { source: a, mutationKey: c, onSuccess: u }),
      (t[8] = a),
      (t[9] = c),
      (t[10] = u),
      (t[11] = d))
    : (d = t[11]);
  let f = l(`gh-pr-merge`, d),
    h,
    g;
  t[12] !== i || t[13] !== f
    ? ((h = (e, t) => {
        f.mutate({ ...e, hostId: i }, t);
      }),
      (g = (e, t) => f.mutateAsync({ ...e, hostId: i }, t)),
      (t[12] = i),
      (t[13] = f),
      (t[14] = h),
      (t[15] = g))
  ...
  let _;
  return (
    t[16] !== f || t[17] !== h || t[18] !== g
      ? ((_ = { ...f, mutate: h, mutateAsync: g }),
        (t[16] = f),
        (t[17] = h),
        (t[18] = g),
        (t[19] = _))
...
function Ft(e) {
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((u = (e, t) => {
        ...
        if (
          (s.invalidateQueries({ queryKey: m(`gh-pr-comments`) }), t.action === `request-reviewers`)
        ) {
          o?.(e, t);
          return;
        }
        ...
        let n = (e) => {
          s.setQueryData(m(`gh-pr-status`, e), (e) => {
            if (e?.status !== `success`) return e;
            switch (t.action) {
              case `toggle-auto-merge`:
                return { ...e, isAutoMergeEnabled: t.enabled };
...
function Wt() {
  return k({ ...O(), intervalHours: 1, intervalMinutes: Xt });
}
function Gt(e) {
  return e
...
function Yt() {
  return [
    ...
    `Use ::${ve}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
...
function Qt({ conversationId: e, pendingWorktreeId: t }) {
  return e == null ? (t == null ? null : _(t)) : y(e);
}
var $t = e(() => {
  r();
});
function en(e) {
  let t = (0, tn.c)(33),
    { hostId: n, item: r, onSuccess: i, repo: s } = e,
    l = te(c),
    u = Oe(),
    d = pe(),
    { createPendingWorktree: f } = ie(),
    p;
  t[0] !== n || t[1] !== r.cwd
  ...
  let {
      agentMode: m,
      isAgentModePending: h,
      permissionProfileId: g,
      shouldSendPermissionOverrides: v,
    } = T(p),
    { activeMode: y } = M(null),
    { serviceTierSettings: ee } = oe(null),
    b;
  t[3] !== n || t[4] !== r.cwd
    ? ((b = { hostId: n, workspaceRoot: r.cwd }), (t[3] = n), (t[4] = r.cwd), (t[5] = b))
    : (b = t[5]);
  let { resolvedConfigPath: x } = st(b),
    S;
  t[6] !== y ||
  t[7] !== m ||
  t[8] !== f ||
  ...
  t[16] !== v
    ? ((S = async (e) => {
        let t = Bt({ includeReviewComments: e, item: r, repo: s }),
          i = [{ type: `text`, text: t, text_elements: [] }],
          { config: a } = await we(`read-config-for-host`, {
            hostId: n,
            includeLayers: !1,
            cwd: r.cwd,
          }),
        ...
        return f({
          ...
          heartbeatAutomation: Vt({ includeReviewComments: e, item: r, name: c, repo: s }),
        });
      }),
      (t[6] = y),
      (t[7] = m),
    ...
    : (S = t[17]);
  let C;
  t[18] !== r.url || t[19] !== d || t[20] !== i || t[21] !== l
    ? ((C = (e) => {
        (Ae(l, { pendingWorktreeId: e, pullRequestUrl: r.url }), i(), d(_(e)));
      }),
      (t[18] = r.url),
      (t[19] = d),
      (t[20] = i),
  ...
  t[23] !== u || t[24] !== l
    ? ((w = (e) => {
        (o.error(`Error starting pull request merge helper`, { safe: {}, sensitive: { error: e } }),
          l
            .get(nt)
            .danger(
              u.formatMessage(
  ...
  t[26] !== S || t[27] !== C || t[28] !== w
    ? ((E = { mutationFn: S, onSuccess: C, onError: w }),
      (t[26] = S),
      (t[27] = C),
      (t[28] = w),
      (t[29] = E))
  ...
  return (
    t[30] !== h || t[31] !== D
      ? ((O = { ...D, isAgentModePending: h }), (t[30] = h), (t[31] = D), (t[32] = O))
      : (O = t[32]),
    O
  );
}
...
function an(e) {
  let t = (0, on.c)(102),
    { className: r, hostId: i, item: a, repo: o, size: s, stopPropagation: u, surface: d } = e,
    f = s === void 0 ? `default` : s,
    h = u === void 0 ? !1 : u,
    g = d === void 0 ? `pull_request_page` : d,
    _ = te(c),
    y = v(_e),
    ee = p(),
    ne = n(Me, a.url),
    b = v(ne.conversationId$),
    x = v(ne.pendingWorktreeId$),
    C = v(re),
    w = Oe(),
    T = pe(),
    E = v(Ne),
    ...
    [k, A] = (0, sn.useState)(!1),
    j;
  t[0] !== w || t[1] !== y || t[2] !== ee || t[3] !== _
    ? ((j = (e) => {
        (y.logProductEvent(me, {
          action: ye.CODEX_AUTOMATION_ACTION_UPDATED,
          source: xe.CODEX_AUTOMATION_SOURCE_PR_MERGE_HELPER,
          success: !0,
          ...S(e.item),
        }),
          ee.invalidateQueries({ queryKey: m(`list-automations`) }),
          _.get(nt).success(
            w.formatMessage({
        ...
        (y.logProductEvent(me, {
          ...
          failureReason:
            ...
            `Automation does not exist in the app and could not be updated. It may have been deleted manually by the user.`
              ? De.CODEX_AUTOMATION_FAILURE_REASON_MISSING_AUTOMATION
              : De.CODEX_AUTOMATION_FAILURE_REASON_HOST_ERROR,
        }),
          _.get(nt).danger(
            w.formatMessage({
  ...
  let ie;
  t[9] !== j || t[10] !== M
    ? ((ie = { onSuccess: j, onError: M }), (t[9] = j), (t[10] = M), (t[11] = ie))
    : (ie = t[11]);
  let N = l(`automation-update`, ie),
    P = (0, sn.useId)(),
    ae = i ?? a.hostId ?? `local`,
    oe = C.data,
    F = C.isLoading || C.isFetching,
    I,
    L,
    ce;
  if (t[12] !== oe?.items || t[13] !== C.isError || t[14] !== F || t[15] !== b || t[16] !== x) {
    I = _t({ automations: oe?.items ?? [], conversationId: b, includePausedAutomations: !0 });
    let e = b == null && x != null;
    ((L = I?.status === `PAUSED`),
      (ce = zt({
        automationStatus: I?.status,
        hasConversation: b != null,
        isAutomationsLoading: F,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (le = t[20]);
  let ue;
  t[21] !== a || t[22] !== o || t[23] !== ae
    ? ((ue = { hostId: ae, item: a, onSuccess: le, repo: o }),
      (t[21] = a),
      (t[22] = o),
      (t[23] = ae),
      (t[24] = ue))
    : (ue = t[24]);
  let z = en(ue),
    de = z.isPending || z.isAgentModePending,
    B = z.isPending || N.isPending || (!L && !R && z.isAgentModePending),
    V;
  t[25] !== I ||
  t[26] !== R ||
  t[27] !== L ||
  ...
  t[37] !== x
    ? ((V = (e) => {
        if ((h && e.stopPropagation(), L && I != null)) {
          (Tt(_, { action: `merge_with_codex_resumed`, item: a, surface: g }), N.mutate(Ht(I)));
          return;
        }
        if (R) {
          let e = Qt({ conversationId: b, pendingWorktreeId: x });
          e != null &&
            (Tt(_, { action: `merge_with_codex_task_opened`, item: a, surface: g }), T(e));
          return;
        }
        if (!z.isAgentModePending) {
          if (E) {
            (Tt(_, { action: `merge_with_codex_started`, item: a, surface: g }), z.mutate(!1));
            return;
          }
          (Tt(_, { action: `merge_with_codex_dialog_opened`, item: a, surface: g }), O(!1), A(!0));
        }
      }),
      (t[25] = I),
      (t[26] = R),
  ...
  let H = V,
    U;
  t[39] !== D || t[40] !== a || t[41] !== _ || t[42] !== z || t[43] !== g
    ? ((U = (e) => {
        (e.preventDefault(),
          !z.isAgentModePending &&
            (Tt(_, { action: `merge_with_codex_started`, item: a, surface: g }), z.mutate(D)));
      }),
      (t[39] = D),
      (t[40] = a),
      (t[41] = _),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, X.jsx)(rt, { className: `icon-xxs` })), (t[46] = G))
    : (G = t[46]);
  let K;
  t[47] !== R || t[48] !== L
    ? ((K = L
    ...
    : (K = t[49]);
  let J;
  t[50] !== r || t[51] !== H || t[52] !== B || t[53] !== f || t[54] !== K
    ? ((J = (0, X.jsx)(se, {
        tooltipContent: fe,
        children: (0, X.jsxs)(Ze, {
          className: r,
          color: `secondary`,
          loading: B,
          size: f,
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ge = (0, X.jsx)(rt, { className: `icon-sm text-token-foreground` })),
      (ve = (0, X.jsx)(q, {
  ...
  t[63] === w
    ...
    : ((Te = w.formatMessage({
      ...
      (t[64] = Te));
  let Ee;
  t[65] !== D || t[66] !== z.isPending || t[67] !== Te
    ? ((Ee = (0, X.jsx)(Ve, {
        ...
        children: (0, X.jsxs)(`label`, {
          ...
          children: [
            Ce,
            (0, X.jsx)(Ge, { checked: D, disabled: we, ariaLabel: Te, size: `sm`, onChange: O }),
          ],
        }),
      })),
      (t[65] = D),
  ...
  t[69] === _
    ...
    : ((Y = (e) => {
      ...
      (t[70] = Y));
  let ke;
  t[71] !== E || t[72] !== P || t[73] !== z.isPending || t[74] !== Y
    ? ((ke = (0, X.jsx)(ot, { id: P, checked: E, disabled: z.isPending, onCheckedChange: Y })),
      (t[71] = E),
      (t[72] = P),
      (t[73] = z.isPending),
      (t[74] = Y),
  ...
  t[85] === de
    ? (Be = t[86])
    : ((Be = (0, X.jsx)(Ze, { color: `primary`, loading: de, type: `submit`, children: Re })),
      (t[85] = de),
      (t[86] = Be));
  let He;
  t[87] !== je || t[88] !== Ie || t[89] !== Be
    ? ((He = (0, X.jsxs)(We, { children: [je, Ie, Be] })),
      (t[87] = je),
      (t[88] = Ie),
      (t[89] = Be),
      (t[90] = He))
  ...
  return (
    t[99] !== J || t[100] !== qe
      ? ((Je = (0, X.jsxs)(X.Fragment, { children: [J, qe] })),
        (t[99] = J),
        (t[100] = qe),
        (t[101] = Je))
      : (Je = t[101]),
...
function ln(e) {
      ...
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, Z.jsx)(ft, { className: `icon-2xs opacity-40` }),
            ],
          })),
          (t[0] = e))
        : (e = t[0]),
  ...
  if (r) {
    ...
    t[8] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((l = (0, Z.jsx)(ft, { className: `icon-2xs` })), (t[8] = l))
      : (l = t[8]);
    let u;
    return (
      t[9] !== n || t[10] !== a || t[11] !== s
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Z.jsx)(Ie, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[15] = u))
    : (u = t[15]);
  let d;
  t[16] === l
    ? (d = t[17])
    : ((d = (0, Z.jsxs)(Ze, { color: `secondary`, size: `toolbar`, children: [l, u] })),
      (t[16] = l),
      (t[17] = d));
  let f;
  ...
  let p;
  t[19] !== a || t[20] !== s
    ? ((p = (0, Z.jsx)(de.Item, { disabled: a, onSelect: s, children: f })),
      (t[19] = a),
      (t[20] = s),
      (t[21] = p))
    : (p = t[21]);
  ...
  let g;
  t[25] !== n || t[26] !== m
    ? ((g = (0, Z.jsx)(de.Item, { disabled: n, onSelect: m, children: h })),
      (t[25] = n),
      (t[26] = m),
      (t[27] = g))
    : (g = t[27]);
  ...
  return (
    t[28] !== d || t[29] !== p || t[30] !== g
      ? ((_ = (0, Z.jsxs)(le, { align: `end`, triggerButton: d, children: [p, g] })),
        (t[28] = d),
        (t[29] = p),
        (t[30] = g),
        (t[31] = _))
...
var un,
  Z,
  dn = e(() => {
    ((un = u()), Y(), Xe(), R(), $e(), z(), Fe(), pt(), (Z = b()));
  });
function fn(e) {
  let t = (0, gn.c)(106),
    { hostId: n, item: r, pullRequestBody: i, request: a, surface: o, variant: s } = e,
    l = o === void 0 ? `pull_request_page` : o,
    u = s === void 0 ? `page` : s,
    d = te(c),
    f = Oe(),
    h = p(),
    g = Pe(),
    [_, v] = (0, _n.useState)(!1),
    y = et(ee.pullRequestMergeMethod),
    ne = u === `side-panel`,
    b;
  t[0] !== n ||
  t[1] !== r.cwd ||
  ...
  t[6] !== a
    ? ((b = async () => {
        await Promise.all([
          h.invalidateQueries({ queryKey: m(`gh-pr-board`) }),
          h.invalidateQueries({ queryKey: m(`gh-pr-body`, a) }),
          h.invalidateQueries({ queryKey: m(`gh-pr-checks`, a) }),
          h.invalidateQueries({ queryKey: m(`gh-pr-comments`, a) }),
          h.invalidateQueries({
            queryKey: m(`gh-pr-status`, { cwd: r.cwd, headBranch: r.headBranch, hostId: n }),
          }),
          h.invalidateQueries({
            queryKey: m(`gh-pr-status`, {
              cwd: r.cwd,
  ...
  t[8] !== x || t[9] !== y || t[10] !== d
    ? ((S = (e) => {
        (async () => {
          (await x(),
            e && y !== `squash` && (await tt(d, ee.pullRequestMergeMethod, `squash`)),
            v(!1));
        })();
      }),
      (t[8] = x),
  ...
  let k = Ft(O),
    ...
    re = i?.isAutoMergeEnabled === !0,
    ie;
  t[24] !== j || t[25] !== M || t[26] !== r.ciStatus || t[27] !== T.isPending || t[28] !== i
    ? ((ie = pn(i, M, j, r.ciStatus, T.isPending)),
      (t[24] = j),
      (t[25] = M),
      (t[26] = r.ciStatus),
      (t[27] = T.isPending),
  ...
  t[37] !== i ||
  t[38] !== g
    ? ((L = !ne && g && A && !M && !j && i.canMerge !== !0 && Rt(r)),
      (t[32] = j),
      (t[33] = M),
      (t[34] = A),
      (t[35] = ne),
  ...
  t[46] !== l
    ? ((le = () => {
        ...
        (Tt(d, { action: i.isDraft ? `mark_ready` : `mark_draft`, item: r, surface: l }),
          k.mutate(
            { action: e, cwd: r.cwd, number: r.number, repo: i.repo },
            {
              onSuccess: (t) => {
                if (t.status !== `success`) {
                  d.get(nt).danger(t.error);
                  return;
                }
                (d.get(nt).success(mn(e, f)), C(!1));
              },
            },
          ));
      }),
  ...
  t[56] !== l
    ? ((de = (e) => {
        i != null &&
          (Tt(d, { action: e ? `enable_auto_merge` : `disable_auto_merge`, item: r, surface: l }),
          D.mutate(
            {
            ...
            },
            {
              onSuccess: (t) => {
                ...
                (d.get(nt).success(mn(`toggle-auto-merge`, f)), C(_ && e));
              },
            },
          ));
      }),
  ...
  t[66] !== l
    ? ((V = () => {
        i != null &&
          (Tt(d, { action: `merge`, item: r, surface: l }),
          T.mutate(
            { cwd: r.cwd, mergeMethod: R, number: r.number, repo: i.repo },
            {
              onSuccess: (e) => {
                if (e.status !== `success`) {
                  hn({
  ...
  if (ne) {
    let e = T.isPending || D.isPending,
      n;
    return (
      t[68] !== F || t[69] !== B || t[70] !== H || t[71] !== re || t[72] !== P || t[73] !== e
        ? ((n = (0, Q.jsx)(ln, {
            autoMergeDisabled: F,
            isAutoMergeEnabled: re,
            isPending: e,
            mergeDisabled: P,
            onAutoMergeChange: B,
            onMerge: H,
  ...
  t[75] === j
    ...
    : ((U = j
      ...
      (t[76] = U));
  let W;
  t[77] !== k.isPending || t[78] !== I || t[79] !== z || t[80] !== U
    ? ((W = (0, Q.jsx)(Ze, {
        color: `outline`,
        disabled: I,
        loading: k.isPending,
...
function yn(e) {
  let t = (0, bn.c)(12),
    ...
    c;
  t[0] === s ? (c = t[1]) : ((c = Ce(`flex flex-col`, s)), (t[0] = s), (t[1] = c));
  let l;
            ...
            I,
            {
              ...
              label:
                e.tooltipContent == null
                  ? t
                  : (0, xn.jsx)(se, { tooltipContent: e.tooltipContent, children: t }),
              trailing: e.trailing,
          ...
          return {
            ...
            onClick:
              n == null
                ? void 0
                : (e) => {
                    lt({ event: e, href: n, initiator: `pull_request_link` });
                  },
...
function Tn(e) {
  switch (e) {
    case `failing`:
      return (0, $.jsx)(L, { className: `icon-sm shrink-0 text-token-charts-red` });
    case `pending`:
      return (0, $.jsx)(ht, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    case `passing`:
      return (0, $.jsx)(Ke, { className: `icon-sm shrink-0 text-token-charts-green` });
    case `skipped`:
    case `unknown`:
