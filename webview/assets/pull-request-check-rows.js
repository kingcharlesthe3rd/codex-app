...
function vt(e) {
  let t = (0, yt.c)(15),
    ...
    u = !(o !== void 0 && o) && `-me-1.5`,
    d;
  t[0] === u ? (d = t[1]) : ((d = Ne(`inline-flex`, u)), (t[0] = u), (t[1] = d));
  ...
  return (
    t[12] !== g || t[13] !== s
      ? ((_ = (0, bt.jsx)(de, { tooltipContent: s, children: g })),
        (t[12] = g),
        (t[13] = s),
        (t[14] = _))
      : (_ = t[14]),
...
function Tt(e, { action: t, item: n, surface: r }) {
  be(e, Ee, { action: t, surface: r, state: n.state, isAuthor: n.isAuthor });
}
function Et(e, { item: t, surface: n }) {
  be(e, le, { surface: n, state: t.state, isAuthor: t.isAuthor });
}
function Dt(e, { kind: t, surface: n }) {
  be(e, pe, { kind: t, surface: n });
}
var Ot = e(() => {
  (ue(), L());
});
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((l = (e, t) => {
        if (e.status === `success`) {
          if (r != null) {
            let e = (e) => {
              s.setQueryData(y(`gh-pr-status`, e), jt);
            };
            (e({ cwd: t.cwd, headBranch: r, hostId: t.hostId }),
              e({ cwd: t.cwd, headBranch: r, hostId: t.hostId, number: t.number, repo: t.repo }),
              Promise.all([
                s.invalidateQueries({ queryKey: y(`gh-pr-body`) }),
                s.invalidateQueries({ queryKey: y(`gh-pr-checks`) }),
                s.invalidateQueries({ queryKey: y(`gh-pr-comments`) }),
                s.invalidateQueries({
                  queryKey: y(`gh-pr-status`, { cwd: t.cwd, headBranch: r, hostId: t.hostId }),
                }),
                s.invalidateQueries({
                  queryKey: y(`gh-pr-status`, {
                    cwd: t.cwd,
                    headBranch: r,
                    hostId: t.hostId,
                    number: t.number,
...
function Ft(e) {
  ...
  t[4] !== r || t[5] !== o || t[6] !== s
    ? ((l = (e, t) => {
        ...
        if (
          (s.invalidateQueries({ queryKey: y(`gh-pr-comments`) }), t.action === `request-reviewers`)
        ) {
          o?.(e, t);
          return;
        }
        ...
        let n = (e) => {
          s.setQueryData(y(`gh-pr-status`, e), (e) => {
            if (e?.status !== `success`) return e;
            switch (t.action) {
              case `toggle-auto-merge`:
                return { ...e, isAutoMergeEnabled: t.enabled };
...
function Wt() {
  return A({ ...b(), intervalHours: 1, intervalMinutes: Xt });
}
function Gt(e) {
  return e
...
function Yt() {
  return [
    ...
    `Use ::${I}{ciJobsFixed=1 mergeConflictsResolved=1} with the actual counts for this turn.`,
...
function Qt({ conversationId: e, pendingWorktreeId: t }) {
  return e == null ? (t == null ? null : c(t)) : f(e);
}
var $t = e(() => {
  _();
});
function en(e) {
  ...
  let {
    ...
    { activeMode: v } = j(null),
    { serviceTierSettings: y } = N(null),
    b;
  t[3] !== n || t[4] !== r.cwd
    ? ((b = { hostId: n, workspaceRoot: r.cwd }), (t[3] = n), (t[4] = r.cwd), (t[5] = b))
    : (b = t[5]);
  let { resolvedConfigPath: x } = ot(b),
    S;
  t[6] !== v ||
  t[7] !== m ||
  t[8] !== f ||
  ...
  t[16] !== ee
    ? ((S = async (e) => {
        let t = Bt({ includeReviewComments: e, item: r, repo: o }),
          i = [{ type: `text`, text: t, text_elements: [] }],
          { config: a } = await z(`read-config-for-host`, {
            hostId: n,
            includeLayers: !1,
            cwd: r.cwd,
          }),
        ...
        return f({
          ...
          heartbeatAutomation: Vt({ includeReviewComments: e, item: r, name: c, repo: o }),
        });
      }),
      (t[6] = v),
      (t[7] = m),
  ...
  t[18] !== r.url || t[19] !== d || t[20] !== i || t[21] !== s
    ? ((C = (e) => {
        (_t(s, { pendingWorktreeId: e, pullRequestUrl: r.url }), i(), d(c(e)));
      }),
      (t[18] = r.url),
      (t[19] = d),
      (t[20] = i),
  ...
  t[23] !== u || t[24] !== s
    ? ((w = (e) => {
        (a.error(`Error starting pull request merge helper`, { safe: {}, sensitive: { error: e } }),
          s
            .get(Ce)
            .danger(
              u.formatMessage(
  ...
  t[26] !== S || t[27] !== C || t[28] !== w
    ? ((T = { mutationFn: S, onSuccess: C, onError: w }),
      (t[26] = S),
      (t[27] = C),
      (t[28] = w),
      (t[29] = T))
  ...
  return (
    t[30] !== g || t[31] !== E
      ? ((D = { ...E, isAgentModePending: g }), (t[30] = g), (t[31] = E), (t[32] = D))
      : (D = t[32]),
    D
  );
}
...
function an(e) {
  let t = (0, on.c)(102),
    ...
    f = s === void 0 ? !1 : s,
    m = c === void 0 ? `pull_request_page` : c,
    h = l(Ae),
    _ = d(ve),
    v = g(),
    te = p(ht, i.url),
    b = d(te.conversationId$),
    x = d(te.pendingWorktreeId$),
    S = d(re),
    w = Oe(),
    T = ye(),
    E = d(ft),
    [D, ne] = (0, sn.useState)(!1),
    [O, k] = (0, sn.useState)(!1),
    A;
  t[0] !== w || t[1] !== _ || t[2] !== v || t[3] !== h
    ? ((A = (e) => {
        (_.logProductEvent(_e, {
          action: ce.CODEX_AUTOMATION_ACTION_UPDATED,
          source: me.CODEX_AUTOMATION_SOURCE_PR_MERGE_HELPER,
          success: !0,
          ...C(e.item),
        }),
          v.invalidateQueries({ queryKey: y(`list-automations`) }),
          h
            .get(Ce)
            .success(
              w.formatMessage({
  ...
  let ie;
  t[9] !== A || t[10] !== j
    ? ((ie = { onSuccess: A, onError: j }), (t[9] = A), (t[10] = j), (t[11] = ie))
    : (ie = t[11]);
  let ae = ee(`automation-update`, ie),
    M = (0, sn.useId)(),
    oe = r ?? i.hostId ?? `local`,
    se = S.data,
    N = S.isLoading || S.isFetching,
    P,
    F,
    I;
  if (t[12] !== se?.items || t[13] !== S.isError || t[14] !== N || t[15] !== b || t[16] !== x) {
    P = dt({ automations: se?.items ?? [], conversationId: b, includePausedAutomations: !0 });
    let e = b == null && x != null;
    ((F = P?.status === `PAUSED`),
      (I = zt({
        automationStatus: P?.status,
        hasConversation: b != null,
        isAutomationsLoading: N,
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (le = t[20]);
  let R;
  t[21] !== i || t[22] !== a || t[23] !== oe
    ? ((R = { hostId: oe, item: i, onSuccess: le, repo: a }),
      (t[21] = i),
      (t[22] = a),
      (t[23] = oe),
      (t[24] = R))
    : (R = t[24]);
  let z = en(R),
    ue = z.isPending || z.isAgentModePending,
    B = z.isPending || ae.isPending || (!F && !L && z.isAgentModePending),
    V;
  t[25] !== P ||
  t[26] !== L ||
  t[27] !== F ||
  ...
  t[37] !== x
    ? ((V = (e) => {
        if ((f && e.stopPropagation(), F && P != null)) {
          (Tt(h, { action: `merge_with_codex_resumed`, item: i, surface: m }), ae.mutate(Ht(P)));
          return;
        }
        if (L) {
          let e = Qt({ conversationId: b, pendingWorktreeId: x });
          e != null &&
            (Tt(h, { action: `merge_with_codex_task_opened`, item: i, surface: m }), T(e));
          return;
        }
        if (!z.isAgentModePending) {
          if (E) {
            (Tt(h, { action: `merge_with_codex_started`, item: i, surface: m }), z.mutate(!1));
            return;
          }
          (Tt(h, { action: `merge_with_codex_dialog_opened`, item: i, surface: m }), ne(!1), k(!0));
        }
      }),
      (t[25] = P),
      (t[26] = L),
  ...
  let H = V,
    pe;
  t[39] !== D || t[40] !== i || t[41] !== h || t[42] !== z || t[43] !== m
    ? ((pe = (e) => {
        (e.preventDefault(),
          !z.isAgentModePending &&
            (Tt(h, { action: `merge_with_codex_started`, item: i, surface: m }), z.mutate(D)));
      }),
      (t[39] = D),
      (t[40] = i),
      (t[41] = h),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, X.jsx)(Je, { className: `icon-xxs` })), (t[46] = G))
    : (G = t[46]);
  let K;
  t[47] !== L || t[48] !== F
    ? ((K = F
    ...
    : (K = t[49]);
  let he;
  t[50] !== n || t[51] !== H || t[52] !== B || t[53] !== u || t[54] !== K
    ? ((he = (0, X.jsx)(de, {
        tooltipContent: W,
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((be = (0, X.jsx)(Je, { className: `icon-sm text-token-foreground` })),
      (Se = (0, X.jsx)(Y, {
  ...
  t[63] === w
    ...
    : ((q = w.formatMessage({
      ...
      (t[64] = q));
  let J;
  t[65] !== D || t[66] !== z.isPending || t[67] !== q
    ? ((J = (0, X.jsx)($e, {
        ...
        children: (0, X.jsxs)(`label`, {
          ...
          children: [
            Ee,
            (0, X.jsx)(ze, { checked: D, disabled: De, ariaLabel: q, size: `sm`, onChange: ne }),
          ],
        }),
      })),
      (t[65] = D),
  ...
  t[69] === h
    ...
    : ((ke = (e) => {
      ...
      (t[70] = ke));
  let je;
  t[71] !== E || t[72] !== M || t[73] !== z.isPending || t[74] !== ke
    ? ((je = (0, X.jsx)(Ge, { id: M, checked: E, disabled: z.isPending, onCheckedChange: ke })),
      (t[71] = E),
      (t[72] = M),
      (t[73] = z.isPending),
      (t[74] = ke),
  ...
  t[85] === ue
    ? (Re = t[86])
    : ((Re = (0, X.jsx)(fe, { color: `primary`, loading: ue, type: `submit`, children: Le })),
      (t[85] = ue),
      (t[86] = Re));
  let Be;
  t[87] !== Ne || t[88] !== Ie || t[89] !== Re
    ? ((Be = (0, X.jsxs)(tt, { children: [Ne, Ie, Re] })),
      (t[87] = Ne),
      (t[88] = Ie),
      (t[89] = Re),
      (t[90] = Be))
  ...
  return (
    t[99] !== he || t[100] !== He
      ? ((Ue = (0, X.jsxs)(X.Fragment, { children: [he, He] })),
        (t[99] = he),
        (t[100] = He),
        (t[101] = Ue))
      : (Ue = t[101]),
...
function ln(e) {
      ...
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Z.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, Z.jsx)(it, { className: `icon-2xs opacity-40` }),
            ],
          })),
          (t[0] = e))
        : (e = t[0]),
  ...
  if (r) {
    ...
    t[8] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((l = (0, Z.jsx)(it, { className: `icon-2xs` })), (t[8] = l))
      : (l = t[8]);
    let u;
    return (
      t[9] !== n || t[10] !== a || t[11] !== s
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Z.jsx)(Fe, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[15] = u))
    : (u = t[15]);
  let d;
  t[16] === l
    ? (d = t[17])
    : ((d = (0, Z.jsxs)(fe, { color: `secondary`, size: `toolbar`, children: [l, u] })),
      (t[16] = l),
      (t[17] = d));
  let f;
  ...
  let p;
  t[19] !== a || t[20] !== s
    ? ((p = (0, Z.jsx)(Be.Item, { disabled: a, onSelect: s, children: f })),
      (t[19] = a),
      (t[20] = s),
      (t[21] = p))
    : (p = t[21]);
  ...
  let g;
  t[25] !== n || t[26] !== m
    ? ((g = (0, Z.jsx)(Be.Item, { disabled: n, onSelect: m, children: h })),
      (t[25] = n),
      (t[26] = m),
      (t[27] = g))
    : (g = t[27]);
  ...
  return (
    t[28] !== d || t[29] !== p || t[30] !== g
      ? ((_ = (0, Z.jsxs)(Ve, { align: `end`, triggerButton: d, children: [p, g] })),
        (t[28] = d),
        (t[29] = p),
        (t[30] = g),
        (t[31] = _))
...
function fn(e) {
  let t = (0, gn.c)(106),
    ...
    p = g(),
    h = pt(),
    [_, ee] = (0, _n.useState)(!1),
    v = we(m.pullRequestMergeMethod),
    te = u === `side-panel`,
    b;
  t[0] !== n ||
  t[1] !== r.cwd ||
  ...
  t[6] !== a
    ? ((b = async () => {
        await Promise.all([
          p.invalidateQueries({ queryKey: y(`gh-pr-board`) }),
          p.invalidateQueries({ queryKey: y(`gh-pr-body`, a) }),
          p.invalidateQueries({ queryKey: y(`gh-pr-checks`, a) }),
          p.invalidateQueries({ queryKey: y(`gh-pr-comments`, a) }),
          p.invalidateQueries({
            queryKey: y(`gh-pr-status`, { cwd: r.cwd, headBranch: r.headBranch, hostId: n }),
          }),
          p.invalidateQueries({
            queryKey: y(`gh-pr-status`, {
              cwd: r.cwd,
  ...
  t[8] !== x || t[9] !== v || t[10] !== d
    ? ((S = (e) => {
        (async () => {
          (await x(),
            e && v !== `squash` && (await Te(d, m.pullRequestMergeMethod, `squash`)),
            ee(!1));
        })();
      }),
      (t[8] = x),
  ...
  let O = Ft(ne),
    ...
    ie;
  t[24] !== A || t[25] !== j || t[26] !== r.ciStatus || t[27] !== T.isPending || t[28] !== i
    ? ((ie = pn(i, j, A, r.ciStatus, T.isPending)),
      (t[24] = A),
      (t[25] = j),
      (t[26] = r.ciStatus),
      (t[27] = T.isPending),
  ...
  t[37] !== i ||
  t[38] !== h
    ? ((P = !te && h && k && !j && !A && i.canMerge !== !0 && Rt(r)),
      (t[32] = A),
      (t[33] = j),
      (t[34] = k),
      (t[35] = te),
  ...
  t[46] !== c
    ? ((L = () => {
        ...
        (Tt(d, { action: i.isDraft ? `mark_ready` : `mark_draft`, item: r, surface: c }),
          O.mutate(
            { action: e, cwd: r.cwd, number: r.number, repo: i.repo },
            {
              onSuccess: (t) => {
                if (t.status !== `success`) {
                  d.get(Ce).danger(t.error);
                  return;
                }
                (d.get(Ce).success(mn(e, f)), C(!1));
              },
            },
          ));
      }),
  ...
  t[56] !== c
    ? ((R = (e) => {
        i != null &&
          (Tt(d, { action: e ? `enable_auto_merge` : `disable_auto_merge`, item: r, surface: c }),
          D.mutate(
            {
            ...
            },
            {
              onSuccess: (t) => {
                ...
                (d.get(Ce).success(mn(`toggle-auto-merge`, f)), C(_ && e));
              },
            },
          ));
      }),
  ...
  t[66] !== c
    ? ((ue = () => {
        i != null &&
          (Tt(d, { action: `merge`, item: r, surface: c }),
          T.mutate(
            { cwd: r.cwd, mergeMethod: I, number: r.number, repo: i.repo },
            {
              onSuccess: (e) => {
                if (e.status !== `success`) {
                  hn({
  ...
  if (te) {
    let e = T.isPending || D.isPending,
      n;
    return (
      t[68] !== N || t[69] !== z || t[70] !== B || t[71] !== re || t[72] !== M || t[73] !== e
        ? ((n = (0, Q.jsx)(ln, {
            autoMergeDisabled: N,
  ...
  t[75] === A
    ...
    : ((V = A
      ...
      (t[76] = V));
  let H;
  t[77] !== O.isPending || t[78] !== ce || t[79] !== le || t[80] !== V
    ? ((H = (0, Q.jsx)(fe, {
        color: `outline`,
        disabled: ce,
        loading: O.isPending,
...
function yn(e) {
  let t = (0, bn.c)(12),
    ...
    c;
  t[0] === s ? (c = t[1]) : ((c = Ne(`flex flex-col`, s)), (t[0] = s), (t[1] = c));
  let l;
            ...
            E,
            {
              ...
              label:
                e.tooltipContent == null
                  ? t
                  : (0, xn.jsx)(de, { tooltipContent: e.tooltipContent, children: t }),
              trailing: e.trailing,
          ...
          return {
            ...
            onClick:
              n == null
                ? void 0
                : (e) => {
                    He({ event: e, href: n, initiator: `pull_request_link` });
                  },
...
function Tn(e) {
  switch (e) {
    case `failing`:
      return (0, $.jsx)(T, { className: `icon-sm shrink-0 text-token-charts-red` });
    case `pending`:
      return (0, $.jsx)(lt, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    case `passing`:
      return (0, $.jsx)(Ie, { className: `icon-sm shrink-0 text-token-charts-green` });
    case `skipped`:
    case `unknown`:
