...
import { p as r } from "./vscode-api.js";
function i(e, t) {
...
var o = n(),
  ...
  l = Object.freeze({
    ...
    mac: Object.freeze({
      legacy: Object.freeze({ left: 66 + c, right: 0 }),
      modern: Object.freeze({ left: 76 + c, right: 0 }),
    }),
...
function p(e, t) {
  ...
  if (a()) return t ?? l.applicationMenu;
  if (typeof navigator > `u`) return l.default;
  let n = navigator,
...
function m() {
  ...
  let _;
  return (
    e[6] !== t || e[7] !== i ? ((_ = p(t, i)), (e[6] = t), (e[7] = i), (e[8] = _)) : (_ = e[8]), _
  );
}
function h() {
  return f();
}
export { i as n, a as r, m as t };
