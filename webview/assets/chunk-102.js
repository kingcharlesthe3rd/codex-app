import { i as e, o as t, r as n, s as r, t as i } from "./chunk.js";
import { c as a, n as o, t as s } from "./reduce.js";
import { t as c } from "./isEmpty-DCx-s7gD.js";
import { a as l, n as u, t as d } from "./flatten-CNrC-h2I.js";
import {
  a as f,
  c as p,
  d as m,
  ...
  for (let [n, r] of Object.entries(e))
    n.startsWith(`$`) ||
      (Array.isArray(r)
        ...
        : C(r) && ((r.$container = e), (r.$containerProperty = n), t.deep && ae(r, t)));
}
function F(e, t) {
  let n = e;
  for (; n; ) {
...
function pe(e, t) {
  ...
  for (let e of Object.values(n.properties))
    e.defaultValue !== void 0 && r[e.name] === void 0 && (r[e.name] = me(e.defaultValue));
}
function me(e) {
...
var xe = { $type: `Alternatives`, cardinality: `cardinality`, elements: `elements` };
function Se(e) {
...
var qe = { $type: `InfixRuleOperatorList`, associativity: `associativity`, operators: `operators` },
  Je = { $type: `InfixRuleOperators`, precedences: `precedences` },
  Ye = { $type: `Interface`, attributes: `attributes`, name: `name`, superTypes: `superTypes` };
function Xe(e) {
  return B.isInstance(e, Ye.$type);
}
var Ze = { $type: `Keyword`, cardinality: `cardinality`, predicate: `predicate`, value: `value` };
function Qe(e) {
...
var ut = { $type: `ReferenceType`, isMulti: `isMulti`, referenceType: `referenceType` },
  dt = {
    $type: `RegexToken`,
    cardinality: `cardinality`,
    lookahead: `lookahead`,
...
var jt = {
  ...
  Pt = { $type: `UnorderedGroup`, cardinality: `cardinality`, elements: `elements` };
function Ft(e) {
  return B.isInstance(e, Pt.$type);
}
var It = {
    ...
    constructor() {
      (super(...arguments),
        (this.types = {
          ...
          AbstractParserRule: { name: ge.$type, properties: {}, superTypes: [ve.$type, R.$type] },
          ...
          InfixRuleOperators: {
            name: Je.$type,
            properties: { precedences: { name: Je.precedences, defaultValue: [] } },
            superTypes: [],
          },
          Interface: {
            name: Ye.$type,
            properties: {
              ...
              name: { name: Ye.name },
              superTypes: { name: Ye.superTypes, defaultValue: [], referenceType: R.$type },
            },
            superTypes: [R.$type],
          },
          Keyword: {
          ...
          Parameter: { name: at.$type, properties: { name: { name: at.name } }, superTypes: [] },
          ParameterReference: {
            name: ot.$type,
            properties: { parameter: { name: ot.parameter, referenceType: at.$type } },
            superTypes: [Ae.$type],
          },
          ParserRule: {
            name: ct.$type,
          ...
          ReturnType: { name: pt.$type, properties: { name: { name: pt.name } }, superTypes: [] },
          RuleCall: {
            name: ht.$type,
            properties: {
...
function qt(e, t) {
  ...
  return n && r ? Kt.Inside : n ? Kt.OverlapBack : r ? Kt.OverlapFront : Kt.Outside;
}
function Jt(e, t) {
...
function Mn(e, t, n, r) {
  ...
  return D(e) && e.astNode === n ? e.content.flatMap((e) => Mn(e, t, n, !1)) : [];
}
function Nn(e, t, n) {
  if (!e) return;
...
function Pn(e, t, n) {
  ...
  do
    if (((i = r.next()), !i.done)) {
      let e = i.value;
      e.astNode === n ? Qe(e.grammarSource) && e.grammarSource.value === t && a.push(e) : r.prune();
    }
  while (!i.done);
  return a;
}
...
function zn(e, t) {
  ...
  for (let n of le(e))
    if (gt(n)) {
      if (!n.rule.ref || (lt(n.rule.ref) && !zn(n.rule.ref, t)) || Ke(n.rule.ref)) return !1;
...
var sr = class {
  ...
  ur = class extends sr {
    constructor(e) {
      (super(e.definition), (this.ignoreAmbiguities = !1), Object.assign(this, _r(e)));
    }
  },
  H = class extends sr {
    constructor(e) {
...
function gr(e) {
  ...
  } else if (e instanceof ur) return { type: `Alternative`, definition: t(e.definition) };
  ...
  else if (e instanceof mr) return { type: `Alternation`, idx: e.idx, definition: t(e.definition) };
  else if (e instanceof W) {
    let t = { type: `Terminal`, name: e.terminalType.name, label: ar(e.terminalType), idx: e.idx };
...
function Er(e) {
  let t = [],
    ...
    a,
    o = !0;
  for (; i && o; ) ((a = n[r]), (o = br(a)), (t = t.concat(Tr(a))), (r += 1), (i = n.length > r));
  return [...new Set(t)];
}
function Dr(e) {
  ...
  switch (e.type) {
    ...
    case `Alternative`:
      ...
      for (let e = 0; e < r.length; e++) {
        ...
        if ((a.type === `Group` && Wr(a) === !1) || (a.type !== `Group` && o === !1)) break;
      }
      break;
    default:
      throw Error(`non exhaustive match!`);
  ...
  n(`Line Terminator Handling`, () => {
    ...
    ((d = r.map((e) => !1)),
      t.positionTracking !== `onlyOffset` &&
        (d = r.map((t) =>
          Object.hasOwn(t, `LINE_BREAKS`) ? !!t.LINE_BREAKS : xi(t, e) === !1 && Kr(e, t.PATTERN),
        )));
  });
  let f, p, m, h;
  n(`Misc Mapping #2`, () => {
  ...
  return (
    t.safeMode ||
      n(`First Char Optimization`, () => {
        _ = r.reduce((e, n, r) => {
          if (typeof n.PATTERN == `string`) wi(e, Ei(n.PATTERN.charCodeAt(0)), h[r]);
...
function si(e) {
  let t = [],
    n = e.map((n) =>
      e.reduce(
        (e, r) =>
          n.PATTERN.source === r.PATTERN.source && !t.includes(r) && r.PATTERN !== Gi.NA
            ? (t.push(r), e.push(r), e)
            : e,
        [],
      ),
      ...
      return (
        r === Gi.NA ||
          (typeof r == `string`
            ...
            : r instanceof RegExp && fi(r) && e.push({ str: r.source, idx: n, tokenType: t })),
        e
      );
    }, []);
  return (
          ...
          this.config.skipValidations === !1 &&
            (this.TRACE_INIT(`performRuntimeChecks`, () => {
              this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(
                hi(n, this.trackStartLines, this.config.lineTerminatorCharacters),
              );
            }),
            this.TRACE_INIT(`performWarningRuntimeChecks`, () => {
              this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(
                gi(n, this.trackStartLines, this.config.lineTerminatorCharacters),
              );
            })),
              ...
              if (
                ...
                this.config.skipValidations === !1 &&
                  this.TRACE_INIT(`validatePatterns`, () => {
                    this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(Zr(n, i));
                  }),
...
` + e,
  ...
  tokenizeInternal(e, t) {
      ...
      if (u !== -1) {
        if (
          ...
          t === 0
            ...
            : ((w += t), (T = u - r), this.updateTokenEndLineColumnLocation(p, d, r, t, w, T, u));
    ...
    return (this.hasCustom || (S.length = b), { tokens: S, groups: E, errors: C });
  }
  handleModes(e, t, n, r) {
    if (e.pop === !0) {
      let i = e.push;
...
function ia(e) {
  let t = e.pattern,
    n = {};
  if (((n.name = e.name), t !== void 0 && (n.PATTERN = t), Object.hasOwn(e, Ji)))
...
inside top level rule: ->` +
  ...
  ua = {
    buildDuplicateFoundError(e, t) {
      function n(e) {
        return e instanceof W ? e.terminalType.name : e instanceof cr ? e.nonTerminalName : ``;
      }
      let r = e.name,
        i = t[0],
        a = i.idx,
...
For Further details.`),
    ...
    buildDuplicateRuleNameError(e) {
      let t;
      return (
        (t = e.topLevelRule instanceof lr ? e.topLevelRule.name : e.topLevelRule),
  ...
  ma = class extends pa {
    ...
    walkTerminal(e, t, n) {
      this.isAtEndOfPath &&
        ...
        !this.found &&
        ((this.possibleTokTypes = Tr(new ur({ definition: t.concat(n) }))), (this.found = !0));
    }
  },
  ha = class extends Cr {
    constructor(e, t) {
...
function ba(e, t, n = []) {
  ...
  for (; n.length < t && i < e.length; ) {
    ...
    else if (t instanceof dr) return o(t.definition.concat([new U({ definition: t.definition })]));
...
function Ca(e) {
  ...
  if (e instanceof dr || e === `RepetitionMandatory`) return K.REPETITION_MANDATORY;
  if (e instanceof fr || e === `RepetitionMandatoryWithSeparator`)
    return K.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (e instanceof pr || e === `RepetitionWithSeparator`) return K.REPETITION_WITH_SEPARATOR;
...
function Ya(e) {
  ...
  else if (n instanceof mr) t = n.definition.map((e) => Ya(e.definition)).flat();
      ...
      (e.accept(i),
        i.allProductions.forEach((i) => {
          ...
          if (Ia(s, e, a, o)[0].flat().length === 0) {
            ...
            r.push({ message: t, type: ds.NO_NON_EMPTY_LOOKAHEAD, ruleName: e.name });
          }
        }));
    }),
    r
      ...
      (n, r, a) => (
        t.definition[a].ignoreAmbiguities === !0 ||
          r.forEach((r) => {
            let o = [a];
            (e.forEach((e, n) => {
              a !== n && La(e, r) && t.definition[n].ignoreAmbiguities !== !0 && o.push(n);
            }),
              o.length > 1 && !La(i, r) && (i.push(r), n.push({ alts: o, path: r })));
          }),
        n
      ),
      [],
...
function ro(e, t, n, r) {
  ...
  return i.flatMap((e) => {
    ...
    let a = e.idx,
      o = e.path;
    return i
      .filter((e) => t.definition[e.idx].ignoreAmbiguities !== !0 && e.idx < a && Ra(e.path, o))
      .map((e) => {
        let i = [e.idx + 1, a + 1],
          o = t.idx === 0 ? `` : t.idx;
        return {
  ...
  return (
    e.forEach((e) => {
      ...
      if (i.includes(t)) {
        ...
        r.push({ message: i, type: ds.CONFLICT_TOKENS_RULES_NAMESPACE, ruleName: t });
      }
    }),
    r
  );
  ...
  ko = class {
    initLooksAhead(e) {
      ((this.dynamicTokensEnabled = Object.hasOwn(e, `dynamicTokensEnabled`)
        ...
        (this.maxLookahead = Object.hasOwn(e, `maxLookahead`) ? e.maxLookahead : ls.maxLookahead),
      ...
      e.forEach((e) => {
        this.TRACE_INIT(`${e.name} Rule Lookahead`, () => {
          ...
          (t.forEach((t) => {
            ...
            n.forEach((t) => {
              this.computeLookaheadFunc(e, t.idx, 768, `Repetition`, t.maxLookahead, Sr(t));
            }),
            r.forEach((t) => {
              this.computeLookaheadFunc(e, t.idx, 512, `Option`, t.maxLookahead, Sr(t));
            }),
            i.forEach((t) => {
              this.computeLookaheadFunc(e, t.idx, wo, `RepetitionMandatory`, t.maxLookahead, Sr(t));
            }),
            a.forEach((t) => {
...
var Io = `name`;
function Lo(e, t) {
  Object.defineProperty(e, Io, { enumerable: !1, configurable: !0, writable: !1, value: t });
}
function Ro(e, t) {
  let n = Object.keys(e),
    r = n.length;
...
var Wo = class {
  ...
  Go = class {
    ...
    SKIP_TOKEN() {
      return this.currIdx <= this.tokVectorLength - 2 ? (this.consumeToken(), this.LA_FAST(1)) : cs;
    }
    LA_FAST(e) {
  ...
  Ko = class {
    ...
    RULE(e, t, n = us) {
      if (this.definedRulesNames.includes(e)) {
        let t = {
          message: ua.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: this.className }),
  ...
  qo = class {
	...
	For Further details.`);
      ...
      else if (Object.hasOwn(e, `modes`) && Object.values(e.modes).flat().every(Hi)) {
    ...
    defineRule(e, t, n) {
      ...
      let r = Object.hasOwn(n, `resyncEnabled`) ? n.resyncEnabled : us.resyncEnabled,
        i = Object.hasOwn(n, `recoveryValueFunc`) ? n.recoveryValueFunc : us.recoveryValueFunc,
    ...
    atLeastOneInternalLogic(e, t, n) {
      ...
      this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, t], r, wo, e, va);
    }
    ...
    manyInternalLogic(e, t, n) {
      ...
      this.attemptInRepetitionRecovery(this.manyInternal, [e, t], r, 768, e, ga, a);
    }
  ...
  Yo = { description: `This Object indicates the Parser is during Recording Phase` };
Object.freeze(Yo);
var Xo = !0,
  Zo = 2 ** 8 - 1,
  ...
  ts = class {
    ...
    subruleInternalRecord(e, t, n) {
      ...
      let r = this.recordingProdStack.at(-1),
        i = e.ruleName,
        a = new cr({ idx: t, nonTerminalName: i, label: n?.LABEL, referencedRule: void 0 });
...
function rs(e, t) {
  ...
  let n = this.recordingProdStack.at(-1),
    r = Array.isArray(e) === !1,
    i = r === !1 ? e : e.DEF,
    a = new mr({ definition: [], idx: t, ignoreAmbiguities: r && e.IGNORE_AMBIGUITIES === !0 });
  return (
...
var os = class {
  initPerformanceTracer(e) {
    ...
    } else ((this.traceInitMaxIdent = 0), (this.traceInitPerf = ls.traceInitPerf));
    this.traceInitIndent = -1;
  }
  TRACE_INIT(e, t) {
    if (this.traceInitPerf === !0) {
...
((ps.DEFER_DEFINITION_ERRORS_HANDLING = !1), ss(ps, [So, ko, Wo, Go, qo, Ko, Jo, ts, os]));
...
function ws(e, t, n) {
  let r = J(e, t, n, { type: 5 });
  return (Ns(e, r), js(e, t, n, Ps(e, t, r, n, ks(e, t, n)), Ls(e, t, n.separator, n)));
}
function Ts(e, t, n) {
...
function Es(e, t, n) {
  let r = J(e, t, n, { type: 4 });
  return (Ns(e, r), As(e, t, n, Ps(e, t, r, n, ks(e, t, n)), Ls(e, t, n.separator, n)));
}
function Ds(e, t, n) {
...
function As(e, t, n, r, i) {
  ...
  return (
    (a.loopback = s),
    (c.loopback = s),
    (e.decisionMap[hs(t, i ? `RepetitionMandatoryWithSeparator` : `RepetitionMandatory`, n.idx)] =
      s),
    q(o, s),
...
function js(e, t, n, r, i) {
  ...
  return (
    ...
    (e.decisionMap[hs(t, i ? `RepetitionWithSeparator` : `Repetition`, n.idx)] = s),
    { left: s, right: c }
  );
}
function Ms(e, t, n, r) {
  ...
  Js = class extends Oo {
    ...
    buildLookaheadForAlternation(e) {
      let { prodOccurrence: t, rule: n, hasPredicates: r, dynamicTokensEnabled: i } = e,
        ...
        f = l(wa({ maxLookahead: 1, occurrence: t, prodType: `Alternation`, rule: n }), (e) =>
          l(e, (e) => e[0]),
        );
      if (Ys(f, !1) && !i) {
        let e = s(
    ...
    buildLookaheadForOptional(e) {
      let { prodOccurrence: t, rule: n, prodType: r, dynamicTokensEnabled: i } = e,
        ...
        m = l(wa({ maxLookahead: 1, occurrence: t, prodType: r, rule: n }), (e) =>
          l(e, (e) => e[0]),
        );
      if (Ys(m) && m[0][0] && !i) {
        let e = m[0],
...
function Qs(e, t, n, r) {
  ...
  for (;;) {
    let t = ic(i, s);
    if ((t === void 0 && (t = $s.apply(this, [e, i, s, a, n, r])), t === Hs)) return rc(o, i, s);
...
function dc(e) {
  ...
  for (let r = 0; r < n; r++) fc({ state: e.transitions[r].target, alt: r, stack: [] }, t);
  return t;
}
function fc(e, t) {
  let n = e.state;
...
var Oc = `​`,
  ...
  jc = class extends Ac {
    ...
    rule(e, t) {
      ...
      let i = this.wrapper.DEFINE_RULE(kc(e.name), this.startImplementation(n, r, t).bind(this));
    ...
    startImplementation(e, t, n) {
      return (r) => {
        ...
        if (i) {
          let n = { $type: e };
          (this.stack.push(n), e === Ec ? (n.value = ``) : t !== void 0 && (n.$infixName = t));
        }
    ...
    consume(e, t, n) {
      ...
      if (!this.isRecording() && this.isValidToken(r)) {
        ...
        if (i) {
          ...
          let e = r.image;
          (Qe(n) || (e = this.converter.convert(e, t).toString()), (o.value += e));
        }
      }
    }
    isValidToken(e) {
    ...
    getAssignment(e) {
      if (!this.assignmentMap.has(e)) {
        ...
        this.assignmentMap.set(e, {
          assignment: t,
          crossRef: t && Pe(t.terminal) ? (t.terminal.isMulti ? `multi` : `single`) : void 0,
        });
      }
  ...
  Pc = class extends Ac {
    ...
    rule(e, t) {
      let n = this.wrapper.DEFINE_RULE(kc(e.name), this.startImplementation(t).bind(this));
...
function Wc(e, t) {
  if (t.some((e) => e.calledByName)) {
    let e = t.map((e) => ({ parameterName: e.parameter?.ref?.name, predicate: Gc(e.value) }));
    return (t) => {
      let n = {};
...
function el(e, t) {
  ...
  if (e.ruleNames.has(t)) return e.ruleNames.get(t);
  {
    let n = t,
      ...
      i = t.$type;
    for (; !lt(r); )
      ((He(r) || Se(r) || Ft(r)) && (i = r.elements.indexOf(n).toString() + `:` + i),
        (n = r),
        (r = r.$container));
...
async function ml(e) {
  ...
  if ((t - ll >= ul && ((ll = t), await cl(), (ll = performance.now())), e.isCancellationRequested))
    throw fl;
}
var hl = class {
    constructor() {
...
var xl = class {
    ...
    createTextDocumentGetter(e, t) {
      let n = this.serviceRegistry,
        r;
      return () =>
        (r ??= x.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, t ?? ``));
    }
  },
  Sl = class {
    constructor(e) {
...
var El = class {
  ...
  Dl = class {
    constructor(e) {
      ((this.nameProvider = e.references.NameProvider),
        ...
        (this.hasMultiReference = ue(e.Grammar).some((e) => Pe(e) && e.isMulti)));
    }
    findDeclarations(e) {
      if (e) {
        let t = Fn(e),
    ...
    findReferences(e, t) {
      ...
      return (
        t.documentUri && (r = r.filter((e) => yl.equals(e.sourceUri, t.documentUri))),
        n.push(...r),
        M(n)
      );
    }
  ...
  Al = class {
    ...
    async collectExportedSymbolsForNode(e, t, n = ce, r = Y.CancellationToken.None) {
      let i = [];
  ...
  Ll = class {
    ...
    getGlobalScope(e, t) {
      return this.globalScopeCache.get(e, () => new Ml(this.indexManager.allElements(e)));
    }
  };
function Rl(e) {
...
var Bl = class {
    ...
    reviveReference(e, t, n, r, i) {
      ...
      if (r.$ref) {
        ...
        if (C(e)) return ((a ||= this.nameProvider.getName(e)), { $refText: a ?? ``, ref: e });
        o = e;
      } else if (r.$refs) {
        let e = [];
        for (let t of r.$refs) {
    ...
    async validateDocument(e, t = {}, n = Y.CancellationToken.None) {
      ...
      if (
        ...
        (!t.categories || t.categories.includes(`built-in`)) &&
          ...
          (t.stopAfterLexingErrors && i.some((e) => e.data?.code === Xl.LexingError)) ||
            (this.processParsingErrors(r, i, t),
            t.stopAfterParsingErrors && i.some((e) => e.data?.code === Xl.ParsingError)) ||
            (this.processLinkingErrors(e, i, t),
            t.stopAfterLinkingErrors && i.some((e) => e.data?.code === Xl.LinkingError))))
      )
        return i;
      try {
...
function ql(e) {
  ...
  return (
    typeof e.property == `string`
      ...
      : typeof e.keyword == `string` && (t = Nn(e.node.$cstNode, e.keyword, e.index)),
    (t ??= e.node.$cstNode),
  ...
  Ql = class {
    ...
    createInfoDescriptions(e) {
      ...
      w(t) && t.$nodeDescription
        ? (n = [t.$nodeDescription])
        : T(t) && (n = t.items.map((e) => e.$nodeDescription).filter((e) => e !== void 0));
  ...
  uu = i((e) => {
    ...
    (function (e) {
      function t(e) {
        ...
        return (
          t &&
          (ee.is(t.cancellationStrategy) || S.is(t.connectionStrategy) || te.is(t.messageStrategy))
        );
      }
      e.is = t;
    ...
    function k(f, p, h, _) {
      ...
      function pe(e) {
        return e === null ? `res-unknown-` + (++T).toString() : `res-` + e.toString();
      }
      function me() {
          ...
          if (r.Message.isNotification(e) && e.method === s.type.method) {
            ...
            if (r.Message.isRequest(i)) {
              let r = _?.connectionStrategy,
                a = r && r.cancelUndispatched ? r.cancelUndispatched(i, he) : void 0;
              if (a && (a.error !== void 0 || a.result !== void 0)) {
                (ie.delete(n),
                  N.delete(t),
                  (a.id = i.id),
                  je(a, e.method, Date.now()),
                  p.write(a).catch(() => y.error(`Sending response for canceled message failed.`)));
                return;
              }
            }
            let a = N.get(t);
      ...
      function Te(e) {
        ...
        function i(t, n, r) {
          ...
          (je(i, n, r), p.write(i).catch(() => y.error(`Sending response failed.`)));
        }
        function a(t, n, r) {
          t === void 0 && (t = null);
        ...
        if (c || E) {
          ...
          (e.id !== null && M.has(e.id) && u.cancel(), e.id !== null && N.set(o, u));
          try {
            let d;
            if (c)
              if (e.params === void 0) {
          ...
          if (e.id === null)
            ...
            if ((Pe(e, n), n !== void 0)) {
              ...
              try {
                ...
                e.message
                  ? y.error(`Response handler '${n.method}' failed with message: ${e.message}`)
                  : y.error(`Response handler '${n.method}' failed unexpectedly.`);
              }
            }
          }
      }
      function De(e) {
        ...
        if (n || k)
          try {
            ...
            t.message
              ? y.error(`Notification handler '${e.method}' failed with message: ${t.message}`)
              : y.error(`Notification handler '${e.method}' failed unexpectedly.`);
          }
        else ce.fire(e);
      }
      function Oe(e) {
      ...
      function ke(e) {
        if (!(P === d.Off || !F))
          if (ae === m.Text) {
            let t;
            ((P === d.Verbose || P === d.Compact) && e.params && (t = `Params: ${z(e.params)}\n\n`),
...
`)),
            ...
            } else F.log(`Received response ${e.id} without active response promise.`, n);
      ...
      function Le() {
        if (ge()) throw new x(b.AlreadyListening, `Connection is already listening`);
      }
      function Re() {
      ...
      let We = {
        ...
        onProgress: (e, t, n) => {
          if (ne.has(t)) throw Error(`Progress handler for token ${t} already registered`);
          return (
            ne.set(t, n),
            {
              dispose: () => {
        ...
        sendRequest: (e, ...t) => {
          ...
          s &&
            (l = s.onCancellationRequested(() => {
              ...
              return e === void 0
                ? (y.log(`Received no promise from cancellation strategy when cancelling id ${c}`),
                  Promise.resolve())
                : e.catch(() => {
          ...
          return (
            ke(u),
            typeof de.sender.enableCancellation == `function` && de.sender.enableCancellation(u),
        ...
        trace: async (e, t, r) => {
          ...
          (r !== void 0 &&
            (n.boolean(r)
              ? (i = r)
              : ((i = r.sendNotification || !1), (a = r.traceFormat || m.Text))),
            (P = e),
            (ae = a),
            (F = P === d.Off ? void 0 : t),
            i && !_e() && !ve() && (await We.sendNotification(g.type, { value: d.toString(e) })));
        },
        onError: oe.event,
        onClose: se.event,
...
var Hu = Bu(),
  Uu = class {
    ...
    async runCancelable(e, t, n, r) {
      for (let i of e)
        i.state < t &&
          (await ml(n), await r(i), (i.state = t), await this.notifyDocumentPhase(i, t, n));
            ...
            : this.currentState >= e && e > r.state
              ...
              : new Promise((r, i) => {
                  let a = this.onDocumentPhase(e, (e) => {
                      yl.equals(e.uri, t) && (a.dispose(), o.dispose(), r(e.uri));
                    }),
  ...
  Gu = class {
    ...
    async initializeWorkspace(e, t = Y.CancellationToken.None) {
      ...
      (await ml(t), await this.documentBuilder.build(n, this.initialBuildOptions, t));
    }
...
function Qu(e, t, n) {
  ...
  let a = ed(e),
    o = gd(r);
  return ld({ index: 0, tokens: rd({ lines: a, position: i, options: o }), position: i });
}
function $u(e, t) {
  let n = gd(t),
    r = ed(e);
    ...
    for (let o of e) {
      ...
      if (
        (i.push({
          type: `inline-tag`,
          content: l,
          range: b.create(v.create(n, a + c + r), v.create(n, a + c + l.length + r)),
        }),
        (c += l.length),
        o.length === 4)
      ) {
        ...
        i.push({
          type: `text`,
          content: e,
          range: b.create(v.create(n, a + c + r), v.create(n, a + c + e.length + r)),
        });
      } else
        i.push({
          type: `text`,
...
function md(e, t) {
  ...
  if (e.tokens[e.index]?.type === `text`)
    if (t) {
      let i = hd(e);
      return new yd(r, new Sd([i], i.range), t, b.create(n.range.start, i.range.end));
    } else {
      let i = fd(e);
...
var Td = class {
  ...
  Ed = class {
    ...
    getComment(e) {
      return Rl(e) ? e.$comment : Xt(e.$cstNode, this.grammarConfig().multilineCommentRules)?.text;
    }
  },
  Dd = class {
    constructor(e) {
  ...
  kd = class {
    ...
    createGrammarElementIdMap() {
      let e = 0;
      for (let t of ue(this.grammar)) he(t) && this.grammarElementIdMap.set(t, e++);
    }
  };
function Ad(e) {
  return {
    documentation: { CommentProvider: (e) => new Ed(e), DocumentationProvider: (e) => new Td(e) },
    parser: {
    ...
    serializer: { Hydrator: (e) => new kd(e), JsonSerializer: (e) => new Bl(e) },
    validation: { DocumentValidator: (e) => new Kl(e), ValidationRegistry: (e) => new Wl(e) },
    shared: () => e.shared,
  };
}
function jd(e) {
...
var tf = { $type: `Accelerator`, name: `name`, x: `x`, y: `y` },
  nf = { $type: `Anchor`, evolution: `evolution`, name: `name`, visibility: `visibility` },
...
var df = { $type: `Checkout`, branch: `branch` },
  ...
  pf = { $type: `ClassDefStatement`, className: `className`, styleText: `styleText` },
  mf = { $type: `Commit`, id: `id`, message: `message`, tags: `tags`, type: `type` };
function hf(e) {
...
var gf = {
  ...
  wf = { $type: `EvolutionStage`, boundary: `boundary`, name: `name`, secondName: `secondName` },
...
var Of = { $type: `Group`, icon: `icon`, id: `id`, in: `in`, title: `title` },
  kf = { $type: `Info`, accDescr: `accDescr`, accTitle: `accTitle`, title: `title` };
function Af(e) {
...
var jf = { $type: `Item`, classSelector: `classSelector`, name: `name` },
  ...
  Nf = { $type: `Label`, negX: `negX`, negY: `negY`, offsetX: `offsetX`, offsetY: `offsetY` },
  Pf = { $type: `Leaf`, classSelector: `classSelector`, name: `name`, value: `value` },
  Ff = {
    $type: `Link`,
    arrow: `arrow`,
    from: `from`,
  ...
  If = { $type: `Merge`, branch: `branch`, id: `id`, tags: `tags`, type: `type` };
function Lf(e) {
  return cp.isInstance(e, If.$type);
}
Q(Lf, `isMerge`);
var Rf = { $type: `Note`, evolution: `evolution`, text: `text`, visibility: `visibility` },
...
Q(Vf, `isPacket`);
var Hf = { $type: `PacketBlock`, bits: `bits`, end: `end`, label: `label`, start: `start` };
function Uf(e) {
...
var Jf = { $type: `Pipeline`, components: `components`, parent: `parent` },
  Yf = { $type: `PipelineComponent`, evolution: `evolution`, label: `label`, name: `name` },
  Xf = {
    $type: `Radar`,
    accDescr: `accDescr`,
    accTitle: `accTitle`,
  ...
  Qf = { $type: `Service`, icon: `icon`, iconText: `iconText`, id: `id`, in: `in`, title: `title` },
    ...
    constructor() {
      (super(...arguments),
        (this.types = {
          Accelerator: {
            name: tf.$type,
            properties: { name: { name: tf.name }, x: { name: tf.x }, y: { name: tf.y } },
            superTypes: [],
          },
          Anchor: {
            name: nf.$type,
          ...
          ClassDefStatement: {
            name: pf.$type,
            properties: { className: { name: pf.className }, styleText: { name: pf.styleText } },
            superTypes: [],
          },
          Commit: {
            name: mf.$type,
          ...
          Deaccelerator: {
            name: vf.$type,
            properties: { name: { name: vf.name }, x: { name: vf.x }, y: { name: vf.y } },
            superTypes: [],
          },
          Decorator: {
            name: yf.$type,
          ...
          Evolve: {
            name: Tf.$type,
            properties: { component: { name: Tf.component }, target: { name: Tf.target } },
            superTypes: [],
          },
          GitGraph: {
            name: Ef.$type,
          ...
          Item: {
            name: jf.$type,
            properties: { classSelector: { name: jf.classSelector }, name: { name: jf.name } },
            superTypes: [],
          },
          Junction: {
            name: Mf.$type,
          ...
          Option: {
            name: zf.$type,
            properties: { name: { name: zf.name }, value: { name: zf.value, defaultValue: !1 } },
            superTypes: [],
          },
          Packet: {
            name: Bf.$type,
          ...
          PieSection: {
            name: Kf.$type,
            properties: { label: { name: Kf.label }, value: { name: Kf.value } },
            superTypes: [],
          },
          Pipeline: {
            name: Jf.$type,
          ...
          Section: {
            name: Zf.$type,
            properties: { classSelector: { name: Zf.classSelector }, name: { name: Zf.name } },
            superTypes: [jf.$type],
          },
          Service: {
            name: Qf.$type,
          ...
          Size: {
            name: $f.$type,
            properties: { height: { name: $f.height }, width: { name: $f.width } },
            superTypes: [],
          },
          Statement: { name: ep.$type, properties: {}, superTypes: [] },
          TreeNode: {
            name: ip.$type,
            properties: { indent: { name: ip.indent }, name: { name: ip.name } },
            superTypes: [],
          },
          TreeView: {
            name: ap.$type,
          ...
          TreemapRow: {
            name: rp.$type,
            properties: { indent: { name: rp.indent }, item: { name: rp.item } },
            superTypes: [],
          },
          Wardley: {
            name: $.$type,
