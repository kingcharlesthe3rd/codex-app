...
import { c as ot, i as k, r as A, s as st, t as ct } from "./isEmpty-2.js";
import {
  A as lt,
  C as j,
  D as ut,
...
function B(e) {
  return e
    ? ((e = zt(e)), e === V || e === -V ? (e < 0 ? -1 : 1) * Gt : e === e ? e : 0)
    : e === 0
      ? e
      : 0;
}
...
function q(e, n, r, i, a, o) {
  ...
  if (d) {
    ...
    if (f == X || f == J || (p && !a)) {
      if (((s = l || p ? {} : vt(e)), !c)) return l ? cn(e, nn(s, e)) : an(e, en(s, e));
    } else {
      if (!Z[f]) return a ? e : {};
      s = Sn(e, f, c);
    }
...
function xi(e, t, n, r) {
  ...
  for (var i = -1, a = t.length, o = a - 1, s = e; s != null && ++i < a;) {
    ...
    if (i != o) {
      var d = s[c];
      ((l = r ? r(d, c, s) : void 0), l === void 0 && (l = x(d) ? d : at(t[i + 1]) ? [] : {}));
    }
    (_t(s, c, l), (s = s[c]));
  }
  return e;
  ...
  _a = e(() => {
    (ue(),
      ...
      (ga = R(function (e, t) {
        ...
        var n = t.length;
        return (
          n > 1 && I(e, t[0], t[1]) ? (t = []) : n > 2 && I(t[0], t[1], t[2]) && (t = [t[0]]),
          ji(e, Ie(t, 1), [])
        );
      })));
  }),
