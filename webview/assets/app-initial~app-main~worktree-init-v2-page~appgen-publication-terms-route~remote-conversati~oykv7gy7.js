...
function Me(e, t) {
  ...
  for (let e of t)
    for (let t of e.extensions) {
      let a = Re(t);
      ze(n, a) && a.length > i && ((r = e), (i = a.length));
    }
  return r;
}
function Ne(e, t) {
  return { file: { name: w(e), resourceUri: t } };
}
function Pe({ fileViewer: e, path: t, readContents: n, resourceUri: r }) {
  return async (i) => (Ie(i.uri, r) ? { extension: Le(t, e), ...(await n(Fe(i._meta))) } : null);
}
function Fe(e) {
...
var Be,
  Ve = t(() => {
    (xe(),
      Ae(),
      (Be = M({
        "openai/resource": M({ representation: le([`blob`, `text`]).optional() }).optional(),
      }).passthrough()));
  }),
  He = t(() => {}),
  Ue = t(() => {}),
...
function kt(e) {
  ...
  if ((t === void 0 && (t = e._meta?.[Rt]), typeof t == `string` && t.startsWith(`ui://`)))
    return t;
...
var At,
  ...
  zt = t(() => {
    (E(),
      ...
      (At = T([L(`light`), L(`dark`)]).describe(
        `Color theme preference for the host environment.`,
      )),
      (W = T([L(`inline`), L(`fullscreen`), L(`pip`)]).describe(
      ...
      (Mt = C(
        jt.describe(`Style variables for theming MCP apps.
...
for compatibility with Zod schema generation. Both are functionally equivalent for validation.`),
        T([B(), z()]).describe(`Style variables for theming MCP apps.
...
for compatibility with Zod schema generation. Both are functionally equivalent for validation.`)),
      M({
        ...
        params: M({ url: B().describe(`URL to open in the host's browser`) }),
      }),
      M({
        isError: I()
          .optional()
      ...
      M({ method: L(`ui/notifications/sandbox-proxy-ready`), params: M({}) }),
      (G = M({
        connectDomains: P(B()).optional()
...
Maps to Permission Policy \`clipboard-write\` feature.`),
      ...
      M({
        ...
        params: M({
          arguments: C(B(), h().describe(`Complete tool call arguments as key-value pairs.`))
            .optional()
      ...
      M({
        ...
        params: M({
          arguments: C(B(), h().describe(`Partial tool call arguments (incomplete, may change).`))
            .optional()
      ...
      (Nt = M({ fonts: B().optional() })),
      (Pt = M({
        variables: Mt.optional().describe(`CSS variables for theming the app.`),
        css: Nt.optional().describe(`CSS blocks that apps can inject.`),
      })),
      M({ method: L(`ui/resource-teardown`), params: M({}) }),
      C(B(), h()),
      (q = M({
      ...
      M({ method: L(`ui/notifications/request-teardown`), params: M({}).optional() }),
      (Ft = M({
        ...
        serverTools: M({
          listChanged: I().optional().describe(`Host supports tools/list_changed notifications.`),
        })
          .optional()
        ...
        sandbox: M({
          permissions: K.optional().describe(
      ...
      (It = M({
        experimental: M({}).optional().describe(`Experimental features (structure TBD).`),
        tools: M({
          listChanged: I().optional().describe(`App supports tools/list_changed notifications.`),
        })
          .optional()
          .describe(`App exposes MCP-style tools that the host can call.`),
        availableDisplayModes: P(W).optional().describe(`Display modes the app supports.`),
      })),
      M({ method: L(`ui/notifications/initialized`), params: M({}).optional() }),
      M({
...
- omitted: host decides border`),
      ...
      M({
        ...
        params: M({ mode: W.describe(`The display mode being requested.`) }),
      }),
      M({
        mode: W.describe(
      ...
      (Lt = T([L(`model`), L(`app`)]).describe(`Tool visibility scope - who can access the tool.`)),
      M({
        resourceUri: B().optional(),
        visibility: P(Lt).optional().describe(`Who can access this tool. Default: ["model", "app"]
- "model": Tool visible to and callable by the agent
- "app": Tool callable by the app from this server only`),
        csp: ke().optional(),
        permissions: ke().optional(),
      }),
      M({
        mimeTypes: P(B())
          .optional()
      ...
      M({
        ...
        params: M({
          ...
          content: P(p).describe(`Message content blocks (text, image, etc.).`),
        }),
      }),
      M({
        method: L(`ui/notifications/sandbox-resource-ready`),
        params: M({
          html: B().describe(`HTML content to load into the inner iframe.`),
          sandbox: B()
            .optional()
      ...
      M({
        ...
        params: g.describe(`Standard MCP tool execution result.`),
      }),
      (J = M({
        toolInfo: M({
          id: te.optional().describe(`JSON-RPC id of the tools/call request.`),
          tool: d.describe(`Tool definition including name, inputSchema, etc.`),
        })
          .optional()
          .describe(`Metadata of the tool call that instantiated this App.`),
        theme: At.optional().describe(`Current color theme preference.`),
        styles: Pt.optional().describe(`Style configuration for theming the app.`),
        displayMode: W.optional().describe(`How the UI is currently displayed.`),
        availableDisplayModes: P(W).optional().describe(`Display modes the host supports.`),
        containerDimensions: T([
          M({ height: H().describe(`Fixed container height in pixels.`) }),
          M({
            maxHeight: T([H(), z()]).optional().describe(`Maximum container height in pixels.`),
          }),
        ])
          .and(
            T([
              M({ width: H().describe(`Fixed container width in pixels.`) }),
              M({
                maxWidth: T([H(), z()]).optional().describe(`Maximum container width in pixels.`),
              }),
            ]),
          )
          .optional()
...
container holding the app. Specify either width or maxWidth, and either height or maxHeight.`),
        locale: B().optional().describe(`User's language and region preference in BCP 47 format.`),
        timeZone: B().optional().describe(`User's timezone in IANA format.`),
        userAgent: B().optional().describe(`Host application identifier.`),
        platform: T([L(`web`), L(`desktop`), L(`mobile`)])
          .optional()
          .describe(`Platform type for responsive design decisions.`),
        deviceCapabilities: M({
          touch: I().optional().describe(`Whether the device supports touch input.`),
          hover: I().optional().describe(`Whether the device supports hover interactions.`),
        })
          .optional()
      ...
      M({
        ...
        params: J.describe(`Partial context update containing only changed fields.`),
      }),
      M({
        method: L(`ui/update-model-context`),
        params: M({
          content: P(p).optional().describe(`Context content blocks (text, image, etc.).`),
          structuredContent: C(
            B(),
      ...
      M({
        ...
        params: M({
          appInfo: u.describe(`App identification (name and version).`),
          appCapabilities: It.describe(`Features and capabilities this app provides.`),
          protocolVersion: B().describe(`Protocol version this app supports.`),
        }),
      }),
      M({
        protocolVersion: B().describe(`Negotiated protocol version string (e.g., "2025-11-21").`),
        hostInfo: u.describe(`Host application identification and version.`),
        hostCapabilities: Ft.describe(`Features and capabilities provided by the host.`),
        hostContext: J.describe(`Rich context about the host environment.`),
      }).passthrough(),
      (Rt = `ui/resourceUri`));
  });
function Bt(e) {
  let t = (e?.icons ?? []).flatMap((e) => {
    ...
    n = Vt(t.filter((e) => e.theme == null)),
    r = Vt(t.filter((e) => e.theme === `light`)) ?? n,
    i = Vt(t.filter((e) => e.theme === `dark`)) ?? n,
    a = r ?? i,
    o = i ?? r;
...
async function Wt(e) {
  return (await tn(e)).flatMap(({ name: e, serverInfo: t, tools: n }) =>
    rn
      .parse(Object.values(n))
      .filter(Qt)
      .map((n) => ({ mentionSearchTool: n.name, server: e, title: $t(n, t, e) })),
  );
}
async function Gt(e) {
  return (await tn(e)).map(({ name: t, serverInfo: n, tools: r }) => ({
    hostId: e,
    icon: Bt(n),
    server: t,
    tools: rn.parse(Object.values(r)),
  }));
}
function Kt(e) {
  return e.flatMap(({ hostId: e, icon: t, server: n, tools: r }) =>
    r.flatMap((i) => Jt(e, t, n, i, r)),
  );
}
function qt(e) {
  return e.flatMap(({ hostId: e, icon: t, server: n, tools: r }) =>
    r.flatMap((i) => {
      let a = Yt(i).flatMap((e) => (e.type === `file` ? e.extensions : [])),
        o = Zt(i);
      return a.length === 0 || o == null || !en(i)
        ? []
        : [
            {
              extensions: a,
...
function Jt(e, t, n, r, i) {
  let a = Zt(r);
  if (a == null || !en(r)) return [];
  let o = Xt(r);
  return Yt(r).flatMap((s) => {
    switch (s.type) {
      case `global`:
      case `thread`:
        return [
...
function Yt(e) {
  let t = an.safeParse(e._meta?.[`openai/ui`]);
...
function Qt(e) {
  let t = on.safeParse(e._meta?.[`openai/capabilities`]);
  return t.success && t.data?.[`mentions/search`] != null;
}
function $t(e, t, n) {
  let r = sn.safeParse(e._meta);
  return (r.success ? r.data?.connector_name : void 0) ?? t?.title ?? t?.name ?? n;
}
function en(e) {
  let t = M({ visibility: P(le([`app`, `model`])).optional() }).safeParse(e._meta?.ui);
  return t.success && t.data.visibility?.includes(`app`) === !0;
}
async function tn(e, t = null) {
  let n = await we(`list-mcp-server-status`, {
    cursor: t,
    detail: `toolsAndAuthOnly`,
    hostId: e,
    limit: nn,
  });
  return n.nextCursor == null ? n.data : [...n.data, ...(await tn(e, n.nextCursor))];
}
var nn,
  rn,
  an,
  ...
  cn = t(() => {
    (zt(),
      ...
      Ut(),
      (nn = 100),
      (rn = he.shape.tools.element.omit({ outputSchema: !0 }).loose().array()),
      (an = M({
        entrypoints: P(
          T([
            M({ type: L(`global`) }),
            M({ type: L(`thread`) }),
            M({ extensions: P(B().trim().min(1)), type: L(`file`) }),
          ]),
        ).optional(),
      }).optional()),
      (on = M({ "mentions/search": M({}).optional() }).optional()),
      (sn = M({ connector_name: B().trim().min(1).optional() })
        .passthrough()
        .optional()));
  }),
  ln,
  ...
  _n = t(() => {
    (l(),
      ...
      (ln = fe(S, (e) => ({
        queryFn: () => Gt(e),
        queryKey: [...pe, e, `capability-catalog`],
        staleTime: 0,
      }))),
      (un = F(S, ({ get: e }) => (e(ue, `3669474837`) ? (e(ln, `local`).data ?? []) : []))),
      (dn = fe(S, (e) => ({
        queryFn: () => Wt(e),
        queryKey: [...pe, e, `capability-mention-servers`],
        staleTime: 0,
      }))),
      (fn = de(S, (e, { get: t }) => (t(ue, `3669474837`) ? (t(dn, e).data ?? []) : []))),
      (pn = F(S, ({ get: e }) => e(fn, ae))),
      (Y = de(S, (e, { get: t }) => (t(ue, `3669474837`) ? qt(t(ln, e).data ?? []) : []))),
      (mn = F(S, ({ get: e }) => e(Y, ae))),
      (hn = F(S, ({ get: e }) => Kt(e(un)))),
      (gn = F(S, ({ get: e }) => e(hn).filter((e) => e.entrypoint === `global`))));
  }),
  vn,
  yn = t(() => {
    vn = 10 * 1024 * 1024;
...
function jn(e) {
  let t = R(e);
  return t == null ? null : (Pn.get(t) ?? null);
}
function Mn(e) {
  switch (e) {
    case `csv`:
...
function Vn(e, { contentKind: t } = {}) {
  return Rn(e, t) != null || Bn(e, t) == null ? !0 : jn(e) != null;
}
var Hn,
  Un = t(() => {
    (Fn(),
...
function Gn(e) {
  return e == null ? `unknown` : V(e) ? `remote` : `local`;
}
function Kn({
  contentKind: e,
  hasMcpCapabilityFileViewer: t,
  ...
  return n != null && !V(n) && !r && !t && !Vn(i, { contentKind: e });
}
function qn({
...
function X({
  ...
  if (b != null || _ === `workspace` || y != null) {
    h(x);
    return;
  }
  let S = Xn({ browserSidebarEnabled: r, hostConfig: s, path: v });
  if (!f && S) {
    h({ path: v, cwd: a, hostId: c });
    return;
  }
  if (e != null && g) {
    let t = bn();
    ...
    let r = a == null ? v : ee(a, v),
      g = s != null && !V(s) ? s : null,
      _ = d == null && o == null && Me(r, e.get(Y, c ?? `local`)) != null,
      y = () => (
        p?.(e),
        t(e, r, {
          artifactNavigationTarget: n,
      ...
      b = (t) => {
        ...
        re(
          ...
          Wn({
            ...
            hostConfig: s,
            modifiedClick: f,
            openedSidePanelTarget: y(),
            path: v,
            windowType: `electron`,
          }),
        );
      };
    if (g != null && d == null && i == null && o == null && !U(v) && oe(r)) {
      k(`read-file-metadata`, {
        params: {
          contentSampleByteLimit: ve,
          contentSampleMaxFileBytes: vn,
          hostId: c ?? g.id,
          path: r,
        },
      })
...
function Xn({ browserSidebarEnabled: e, hostConfig: t, path: n }) {
  return e && t != null && !V(t) && U(n);
}
var Zn = t(() => {
  (_e(), N(), Ve(), _n(), f(), D(), Ae(), o(), yn(), Cn(), Tn(), Yn());
});
function Z(e, t) {
...
var Qn = t(() => {});
function $n({ targets: e, availableTargets: t, includeHiddenTargets: n = !1, mode: r = `editor` }) {
...
function er({
  ...
  let a = $n({ targets: t, availableTargets: n, includeHiddenTargets: r, mode: i });
  return a.length === 0
    ? null
    : e
...
var nr = t(() => {});
function rr({ idPrefix: e, messages: t, onOpenInTarget: n, primaryTarget: r, visibleTargets: i }) {
  return r == null
    ? []
    : [
        {
...
var ir = t(() => {});
function ar(e, { hostId: t, path: n }) {
  let r = t == null ? { path: n } : { hostId: t, path: n },
    i = O(`read-file`, r),
    a =
      e.getQueryData(i) ??
      (t == null ? void 0 : e.getQueryData(O(`read-file`, { path: n, hostId: t })));
  if (a != null) {
    Z(a.contents);
    return;
  }
  e.fetchQuery({
    queryFn: ({ signal: e }) => k(`read-file`, { params: r, signal: e }),
    queryKey: i,
...
function Q({ cwd: e, hostId: t, path: n }) {
  return {
    ...
    queryFn: () => k(`open-in-targets`, { params: { cwd: e, hostId: t, path: n } }),
...
function cr(e, { cwd: t, hostId: n, path: r }) {
...
function ur(
  ...
  let l = e.get(y, a ?? `local`),
    u = e.get(_),
    { primaryTarget: ee, visibleTargets: d } = sr(
  ...
  return (
    m &&
      f.push({
        id: p ? `workspace-file-view-file` : `workspace-file-view-browser`,
        message: p ? $.viewFile : $.viewInCodexBrowser,
        onSelect: p
          ? () => {
              X({
                scope: e,
    ...
    ee != null &&
      ...
      f.push({ id: `workspace-file-open-target-separator`, type: `separator` })),
    f.push({
    ...
    f.push({
      ...
      onSelect: () => {
        ar(e.queryClient, { hostId: a, path: c });
      },
    }),
    V(l) ||
      f.push({
        id: `workspace-file-reveal-path`,
        message: dr(e.get(Oe).data?.platform),
        onSelect: () => {
          g(`fileManager`);
        },
      }),
