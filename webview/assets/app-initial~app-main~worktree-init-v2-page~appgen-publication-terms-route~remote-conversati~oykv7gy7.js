import { a as e, n as t, o as n, r, s as i, t as a } from "./rolldown-runtime.js";
import {
  $v as o,
  A as s,
  AD as c,
...
function Be(e, t) {
  ...
  for (let e of t)
    for (let t of e.extensions) {
      let a = Ke(t);
      qe(n, a) && a.length > i && ((r = e), (i = a.length));
    }
  return r;
}
function Ve(e, t) {
  return { file: { name: Se(e), resourceUri: t } };
}
function He({ fileViewer: e, path: t, readContents: n, resourceUri: r }) {
  return async (i) => (We(i.uri, r) ? { extension: Ge(t, e), ...(await n(Ue(i._meta))) } : null);
}
function Ue(e) {
  let t = Je.safeParse(e ?? {});
...
var Je,
  Ye = t(() => {
    (fe(),
      Me(),
      (Je = R({
        "openai/resource": R({ representation: oe([`blob`, `text`]).optional() }).optional(),
      }).passthrough()));
  }),
  Xe = t(() => {}),
  Ze = t(() => {}),
...
function Lt(e) {
  ...
  if ((t === void 0 && (t = e._meta?.[Kt]), typeof t == `string` && t.startsWith(`ui://`)))
    return t;
...
var Rt,
  ...
  qt = t(() => {
    (k(),
      ...
      (Rt = D([P(`light`), P(`dark`)]).describe(
        `Color theme preference for the host environment.`,
      )),
      (z = D([P(`inline`), P(`fullscreen`), P(`pip`)]).describe(
      ...
      (Bt = T(
        zt.describe(`Style variables for theming MCP apps.
...
for compatibility with Zod schema generation. Both are functionally equivalent for validation.`),
        D([M(), w()]).describe(`Style variables for theming MCP apps.
...
for compatibility with Zod schema generation. Both are functionally equivalent for validation.`)),
      R({
        ...
        params: R({ url: M().describe(`URL to open in the host's browser`) }),
      }),
      R({
        isError: N()
          .optional()
      ...
      R({ method: P(`ui/notifications/sandbox-proxy-ready`), params: R({}) }),
      (B = R({
        connectDomains: I(M()).optional()
...
- Empty or omitted → no network connections (secure default)`),
      ...
      (V = R({
        camera: R({}).optional().describe(`Request camera access.

Maps to Permission Policy \`camera\` feature.`),
        microphone: R({}).optional().describe(`Request microphone access.

Maps to Permission Policy \`microphone\` feature.`),
        geolocation: R({}).optional().describe(`Request geolocation access.

Maps to Permission Policy \`geolocation\` feature.`),
        clipboardWrite: R({}).optional().describe(`Request clipboard write access.
...
Maps to Permission Policy \`clipboard-write\` feature.`),
      ...
      R({
        ...
        params: R({
          width: j().optional().describe(`New width in pixels.`),
          height: j().optional().describe(`New height in pixels.`),
        }),
      }),
      R({
        method: P(`ui/notifications/tool-input`),
        params: R({
          arguments: T(M(), E().describe(`Complete tool call arguments as key-value pairs.`))
            .optional()
      ...
      R({
        ...
        params: R({
          arguments: T(M(), E().describe(`Partial tool call arguments (incomplete, may change).`))
            .optional()
      ...
      (Vt = R({ fonts: M().optional() })),
      (Ht = R({
        variables: Bt.optional().describe(`CSS variables for theming the app.`),
        css: Vt.optional().describe(`CSS blocks that apps can inject.`),
      })),
      R({ method: P(`ui/resource-teardown`), params: R({}) }),
      T(M(), E()),
      (H = R({
        text: R({}).optional().describe(`Host supports text content blocks.`),
        image: R({}).optional().describe(`Host supports image content blocks.`),
        audio: R({}).optional().describe(`Host supports audio content blocks.`),
        resource: R({}).optional().describe(`Host supports resource content blocks.`),
        resourceLink: R({}).optional().describe(`Host supports resource link content blocks.`),
        structuredContent: R({}).optional().describe(`Host supports structured content.`),
      })),
      R({ method: P(`ui/notifications/request-teardown`), params: R({}).optional() }),
      (Ut = R({
        experimental: R({}).optional().describe(`Experimental features (structure TBD).`),
        openLinks: R({}).optional().describe(`Host supports opening external URLs.`),
        downloadFile: R({})
          .optional()
          .describe(`Host supports file downloads via ui/download-file.`),
        serverTools: R({
          listChanged: N().optional().describe(`Host supports tools/list_changed notifications.`),
        })
          .optional()
        ...
        logging: R({}).optional().describe(`Host accepts log messages.`),
        sandbox: R({
          permissions: V.optional().describe(
      ...
      (Wt = R({
        experimental: R({}).optional().describe(`Experimental features (structure TBD).`),
        tools: R({
          listChanged: N().optional().describe(`App supports tools/list_changed notifications.`),
        })
          .optional()
          .describe(`App exposes MCP-style tools that the host can call.`),
        availableDisplayModes: I(z).optional().describe(`Display modes the app supports.`),
      })),
      R({ method: P(`ui/notifications/initialized`), params: R({}).optional() }),
      R({
...
- omitted: host decides border`),
      ...
      R({
        ...
        params: R({ mode: z.describe(`The display mode being requested.`) }),
      }),
      R({
        mode: z.describe(
      ...
      (Gt = D([P(`model`), P(`app`)]).describe(`Tool visibility scope - who can access the tool.`)),
      R({
        resourceUri: M().optional(),
        visibility: I(Gt).optional().describe(`Who can access this tool. Default: ["model", "app"]
- "model": Tool visible to and callable by the agent
- "app": Tool callable by the app from this server only`),
        csp: be().optional(),
        permissions: be().optional(),
      }),
      R({
        mimeTypes: I(M())
          .optional()
      ...
      R({
        ...
        params: R({
          ...
          content: I(ge).describe(`Message content blocks (text, image, etc.).`),
        }),
      }),
      R({
      ...
      R({
        ...
        params: we.describe(`Standard MCP tool execution result.`),
      }),
      (U = R({
        toolInfo: R({
          id: d.optional().describe(`JSON-RPC id of the tools/call request.`),
          tool: c.describe(`Tool definition including name, inputSchema, etc.`),
        })
          .optional()
          .describe(`Metadata of the tool call that instantiated this App.`),
        theme: Rt.optional().describe(`Current color theme preference.`),
        styles: Ht.optional().describe(`Style configuration for theming the app.`),
        displayMode: z.optional().describe(`How the UI is currently displayed.`),
        availableDisplayModes: I(z).optional().describe(`Display modes the host supports.`),
        containerDimensions: D([
          R({ height: j().describe(`Fixed container height in pixels.`) }),
          R({
            maxHeight: D([j(), w()]).optional().describe(`Maximum container height in pixels.`),
          }),
        ])
          .and(
            D([
              R({ width: j().describe(`Fixed container width in pixels.`) }),
              R({
                maxWidth: D([j(), w()]).optional().describe(`Maximum container width in pixels.`),
              }),
            ]),
          )
          .optional()
...
container holding the app. Specify either width or maxWidth, and either height or maxHeight.`),
        ...
        platform: D([P(`web`), P(`desktop`), P(`mobile`)])
          .optional()
          .describe(`Platform type for responsive design decisions.`),
        deviceCapabilities: R({
          touch: N().optional().describe(`Whether the device supports touch input.`),
          hover: N().optional().describe(`Whether the device supports hover interactions.`),
        })
          .optional()
          .describe(`Device input capabilities.`),
        safeAreaInsets: R({
          top: j().describe(`Top safe area inset in pixels.`),
          right: j().describe(`Right safe area inset in pixels.`),
          bottom: j().describe(`Bottom safe area inset in pixels.`),
          left: j().describe(`Left safe area inset in pixels.`),
        })
          .optional()
      ...
      R({
        ...
        params: R({
          content: I(ge).optional().describe(`Context content blocks (text, image, etc.).`),
          structuredContent: T(
            M(),
            E().describe(`Structured content for machine-readable context data.`),
          )
            .optional()
      ...
      R({
        ...
        params: R({
          appInfo: ye.describe(`App identification (name and version).`),
          appCapabilities: Wt.describe(`Features and capabilities this app provides.`),
      ...
      R({
        ...
        hostInfo: ye.describe(`Host application identification and version.`),
        hostCapabilities: Ut.describe(`Features and capabilities provided by the host.`),
...
function Jt(e) {
  let t = (e?.icons ?? []).flatMap((e) => {
    ...
    n = W(t.filter((e) => e.theme == null)),
    r = W(t.filter((e) => e.theme === `light`)) ?? n,
    i = W(t.filter((e) => e.theme === `dark`)) ?? n,
    a = r ?? i,
    o = i ?? r;
...
async function Zt(e) {
  return (await G(e)).flatMap(({ name: e, serverInfo: t, tools: n }) =>
    K.parse(Object.values(n))
      .filter(on)
      .map((n) => ({ mentionSearchTool: n.name, server: e, title: sn(n, t, e) })),
  );
}
async function Qt(e) {
  return (await G(e)).map(({ name: t, serverInfo: n, tools: r }) => ({
    hostId: e,
    icon: Jt(n),
    server: t,
    tools: K.parse(Object.values(r)),
  }));
}
function $t(e) {
  return e.flatMap(({ hostId: e, icon: t, server: n, tools: r }) =>
    r.flatMap((i) => tn(e, t, n, i, r)),
  );
}
function en(e) {
  return e.flatMap(({ hostId: e, icon: t, server: n, tools: r }) =>
    r.flatMap((i) => {
      let a = nn(i).flatMap((e) => (e.type === `file` ? e.extensions : [])),
        o = an(i);
      return a.length === 0 || o == null || !cn(i)
        ? []
        : [
            {
              extensions: a,
...
function tn(e, t, n, r, i) {
  let a = an(r);
  if (a == null || !cn(r)) return [];
  let o = rn(r);
  return nn(r).flatMap((s) => {
    switch (s.type) {
      case `global`:
      case `thread`:
        return [
...
function nn(e) {
  let t = un.safeParse(e._meta?.[`openai/ui`]);
...
function on(e) {
  let t = dn.safeParse(e._meta?.[`openai/capabilities`]);
  return t.success && t.data?.[`mentions/search`] != null;
}
function sn(e, t, n) {
  let r = fn.safeParse(e._meta);
  return (r.success ? r.data?.connector_name : void 0) ?? t?.title ?? t?.name ?? n;
}
function cn(e) {
  let t = R({ visibility: I(oe([`app`, `model`])).optional() }).safeParse(e._meta?.ui);
  return t.success && t.data.visibility?.includes(`app`) === !0;
}
async function G(e, t = null) {
  ...
  return n.nextCursor == null ? n.data : [...n.data, ...(await G(e, n.nextCursor))];
}
var ln,
  K,
  un,
  ...
  pn = t(() => {
    (qt(),
      ...
      Xt(),
      (ln = 100),
      (K = Ie.shape.tools.element.omit({ outputSchema: !0 }).loose().array()),
      (un = R({
        entrypoints: I(
          D([
            R({ type: P(`global`) }),
            R({ type: P(`thread`) }),
            R({ extensions: I(M().trim().min(1)), type: P(`file`) }),
          ]),
        ).optional(),
      }).optional()),
      (dn = R({ "mentions/search": R({}).optional() }).optional()),
      (fn = R({ connector_name: M().trim().min(1).optional() })
        .passthrough()
        .optional()));
  }),
  q,
  ...
  bn = t(() => {
    (ve(),
      ...
      (q = ke(h, (e) => ({
        queryFn: () => Qt(e),
        queryKey: [...Ne, e, `capability-catalog`],
        staleTime: 0,
      }))),
      (J = L(h, ({ get: e }) => (e(C, `3669474837`) ? (e(q, `local`).data ?? []) : []))),
      (mn = ke(h, (e) => ({
        queryFn: () => Zt(e),
        queryKey: [...Ne, e, `capability-mention-servers`],
        staleTime: 0,
      }))),
      (hn = Oe(h, (e, { get: t }) => (t(C, `3669474837`) ? (t(mn, e).data ?? []) : []))),
      (gn = L(h, ({ get: e }) => e(hn, b))),
      (Y = Oe(h, (e, { get: t }) => (t(C, `3669474837`) ? en(t(q, e).data ?? []) : []))),
      (_n = L(h, ({ get: e }) => e(Y, b))),
      (vn = L(h, ({ get: e }) => $t(e(J)))),
      (yn = L(h, ({ get: e }) => e(vn).filter((e) => e.entrypoint === `global`))));
  }),
  xn,
  Sn = t(() => {
    xn = 10 * 1024 * 1024;
...
function Pn(e) {
  let t = me(e);
  return t == null ? null : (Ln.get(t) ?? null);
}
function Fn(e) {
  switch (e) {
    case `csv`:
...
function Wn(e, { contentKind: t } = {}) {
  return Vn(e, t) != null || Un(e, t) == null ? !0 : Pn(e) != null;
}
var Gn,
  Kn = t(() => {
    (Rn(),
...
function Jn(e) {
  return e == null ? `unknown` : F(e) ? `remote` : `local`;
}
function Yn({
  contentKind: e,
  hasMcpCapabilityFileViewer: t,
  ...
  return n != null && !F(n) && !r && !t && !Wn(i, { contentKind: e });
}
function Xn({
...
function X({
  ...
  line: d,
  modifiedClick: f = !1,
  onBeforeOpenSidePanelTab: p,
  openFile: m = Dn,
  openInSidePanel: h = !1,
  openMode: g,
  path: _,
  persistPreferredTargetPath: v,
  target: y,
  title: te,
}) {
  let b = {
  ...
  if (y != null || g === `workspace` || v != null) {
    m(b);
    return;
  }
  let ne = $n({ browserSidebarEnabled: r, hostConfig: s, path: _ });
  if (!f && ne) {
    m({ path: _, cwd: a, hostId: c });
    return;
  }
  if (e != null && h) {
    let t = Cn();
    ...
    let r = a == null ? _ : ze(a, _),
      h = s != null && !F(s) ? s : null,
      g = d == null && o == null && Be(r, e.get(Y, c ?? `local`)) != null,
      v = () => (
        p?.(e),
        t(e, r, {
          artifactNavigationTarget: n,
      ...
      y = (t) => {
        ...
        Te(
          ...
          qn({
            ...
            hostConfig: s,
            modifiedClick: f,
            openedSidePanelTarget: v(),
            path: _,
            windowType: `electron`,
          }),
        );
      };
    if (h != null && d == null && i == null && o == null && !Pe(_) && ee(r)) {
      x(`read-file-metadata`, {
        params: {
          contentSampleByteLimit: xe,
          contentSampleMaxFileBytes: xn,
          hostId: c ?? h.id,
          path: r,
        },
      })
...
function $n({ browserSidebarEnabled: e, hostConfig: t, path: n }) {
  return e && t != null && !F(t) && Pe(n);
}
var er = t(() => {
  (Re(), O(), Ye(), bn(), Ae(), A(), Me(), S(), Sn(), En(), On(), Qn());
});
function Z(e, t) {
...
var tr = t(() => {});
function nr({ idPrefix: e, messages: t, onOpenInTarget: n, primaryTarget: r, visibleTargets: i }) {
  return r == null
    ? []
    : [
        {
...
var rr = t(() => {});
function ir(e, { hostId: t, path: n }) {
  let r = t == null ? { path: n } : { hostId: t, path: n },
    i = f(`read-file`, r),
    a =
      e.getQueryData(i) ??
      (t == null ? void 0 : e.getQueryData(f(`read-file`, { path: n, hostId: t })));
  if (a != null) {
    Z(a.contents);
    return;
  }
  e.fetchQuery({
    queryFn: ({ signal: e }) => x(`read-file`, { params: r, signal: e }),
    queryKey: i,
...
function Q({ cwd: e, hostId: t, path: n }) {
  return {
    gcTime: le.INFINITE,
    queryKey: f(`open-in-targets`, { cwd: e, hostId: t, path: n }),
    queryFn: () => x(`open-in-targets`, { params: { cwd: e, hostId: t, path: n } }),
    staleTime: le.ONE_MINUTE,
  };
}
function or(e) {
  return {
...
function sr(e, { cwd: t, hostId: n, path: r }) {
  e.queryClient.prefetchQuery(Q({ cwd: t, hostId: n, path: r }));
}
function cr(e, t) {
  return e.queryClient
    .fetchQuery(Q({ cwd: t.cwd, hostId: t.hostId, path: t.path }))
    .catch(() => null)
    .then(() => lr(e, t));
}
function lr(
  ...
  let u = e.get(ne, a ?? `local`),
    d = e.get(se),
    { primaryTarget: ee, visibleTargets: f } = or(
      e.queryClient.getQueryData(Q({ cwd: r, hostId: a, path: c }).queryKey),
    ),
    p = [],
    m = s,
    h = d && !F(u) && Pe(c),
  ...
  return (
    h &&
      p.push({
        id: m ? `workspace-file-view-file` : `workspace-file-view-browser`,
        message: m ? $.viewFile : $.viewInCodexBrowser,
        onSelect: m
          ? () => {
              X({
                scope: e,
    ...
    ee != null &&
        ...
        : p.push(
            ...nr({
              ...
              messages: {
                ...
                openIn: $.openWith,
                openInTargetSubmenu: $.openWithTarget,
              },
              onOpenInTarget: _,
              primaryTarget: ee,
              visibleTargets: f,
      ...
      p.push({ id: `workspace-file-open-target-separator`, type: `separator` })),
    p.push({
    ...
    p.push({
      ...
      onSelect: () => {
        ir(e.queryClient, { hostId: a, path: c });
      },
    }),
    F(u) ||
      p.push({
        id: `workspace-file-reveal-path`,
        message: ur(e.get(Ce).data?.platform),
        onSelect: () => {
          _(`fileManager`);
        },
      }),
...
function ur(e) {
  return e === `darwin` ? $.openInFinder : e === `win32` ? $.openInExplorer : $.openInFileManager;
}
var $,
  dr = t(() => {
    (O(),
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~appgen-publication-terms-route~remote-conversati~oykv7gy7.js.map
