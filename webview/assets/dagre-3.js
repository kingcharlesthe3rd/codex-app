import { c as e, n as t, t as n } from "./reduce.js";
import { g as r } from "./_baseFor.js";
import { a as i, n as a, t as o } from "./flatten-CNrC-h2I.js";
import {
  _ as s,
  a as c,
  c as l,
...
import { g as S, t as C } from "./merge-B.js";
import { n as w, r as T } from "./union.js";
import { t as E } from "./graphlib-3.js";
var ne = class {
  constructor() {
    var e = {};
  ...
  return (
    ...
    t(e.edges(), function (t) {
      var r = n.edge(t.v, t.w) || { weight: 0, minlen: 1 },
        i = e.edge(t);
      n.setEdge(t.v, t.w, { weight: r.weight + i.weight, minlen: Math.max(r.minlen, i.minlen) });
    }),
    n
  );
}
...
function M(e, t, n, r) {
  ...
  return (arguments.length >= 4 && ((i.rank = n), (i.order = r)), A(e, `border`, i, t));
}
function N(e) {
  return l(
    i(e.nodes(), function (t) {
...
function ye(e) {
  function n(r) {
    var i = e.children(r),
      a = e.node(r);
    if ((i.length && t(i, n), Object.prototype.hasOwnProperty.call(a, `minRank`))) {
      ((a.borderLeft = []), (a.borderRight = []));
      for (var o = a.minRank, s = a.maxRank + 1; o < s; ++o)
        (P(e, `borderLeft`, `_bl`, r, a, o), P(e, `borderRight`, `_br`, r, a, o));
    }
  }
  t(e.children(), n);
}
...
function xe(e) {
  var t = e.graph().rankdir.toLowerCase();
  ((t === `bt` || t === `rl`) && Ce(e), (t === `lr` || t === `rl`) && (we(e), F(e)));
}
function F(e) {
  (t(e.nodes(), function (t) {
    Se(e.node(t));
...
function Oe(e, n) {
  function r(i) {
    t(n.nodeEdges(i), function (t) {
      var a = t.v,
        o = i === a ? t.w : a;
      !e.hasNode(o) && !z(n, t) && (e.setNode(o, {}), e.setEdge(i, o, {}), r(o));
    });
  }
...
function je(e) {
  ...
  function a(o) {
    ...
    Object.prototype.hasOwnProperty.call(n, o) ||
      ((r[o] = !0), (n[o] = !0), t(e.predecessors(o), a), delete r[o], i.push(o));
  }
...
function Ye(e, n, r) {
  var i = Xe(e),
    a = new E({ compound: !0 }).setGraph({ root: i }).setDefaultNodeLabel(function (t) {
      return e.node(t);
    });
  return (
    t(e.nodes(), function (o) {
      ...
      (s.rank === n || (s.minRank <= n && n <= s.maxRank)) &&
        ...
        Object.prototype.hasOwnProperty.call(s, `minRank`) &&
          a.setNode(o, { borderLeft: s.borderLeft[n], borderRight: s.borderRight[n] }));
    }),
    a
  );
}
    ...
    if (r.length) {
      var i = n(
        ...
        function (t, n) {
          var r = e.edge(n),
            i = e.node(n.v);
          return { sum: t.sum + r.weight * i.order, weight: t.weight + r.weight };
        },
        { sum: 0, weight: 0 },
      );
...
function nt(n) {
  ...
  function a(e) {
    return function (t) {
      t.merged ||
        ((w(t.barycenter) || w(e.barycenter) || t.barycenter >= e.barycenter) && rt(e, t));
    };
  }
  function o(e) {
    return function (t) {
...
function st(n, r, i, a) {
  ...
  t(f, function (e) {
    if (n.children(e.v).length) {
      var t = st(n, e.v, i, a);
      ((d[e.v] = t), Object.prototype.hasOwnProperty.call(t, `barycenter`) && lt(e, t));
    }
  });
  var p = tt(f, i);
  ct(p, d);
  ...
  if (l && ((m.vs = o([l, m.vs, u])), n.predecessors(l).length)) {
    ...
    (Object.prototype.hasOwnProperty.call(m, `barycenter`) || ((m.barycenter = 0), (m.weight = 0)),
      (m.barycenter = (m.barycenter * m.weight + h.order + g.order) / (m.weight + 2)),
      (m.weight += 2));
  }
  return m;
}
    ...
    return (
      t(r, function (t, c) {
        if (e.node(t).dummy === `border`) {
          ...
          l.length && ((o = e.node(l[0]).order), a(r, s, c, i, o), (s = c), (i = o));
        }
...
function yt(e, t, n) {
  ...
  Object.prototype.hasOwnProperty.call(e, t) ||
    Object.defineProperty(e, t, { enumerable: !0, configurable: !0, value: {}, writable: !0 });
  var i = e[t];
  Object.defineProperty(i, n, { enumerable: !0, configurable: !0, value: !0, writable: !0 });
}
function bt(e, t, n) {
  if (t > n) {
    var r = t;
    ...
    t(n, function (e) {
      ...
      t(e, function (e) {
        ...
        if (t.length) {
          ...
          for (var c = (t.length - 1) / 2, l = Math.floor(c), u = Math.ceil(c); l <= u; ++l) {
            var d = t[l];
            o[e] === e &&
              n < s[d] &&
              !bt(r, e, d) &&
...
function St(e, n, r, i, a) {
  ...
  function l(e, t) {
    for (var n = s.nodes(), r = n.pop(), i = {}; r; )
      (i[r] ? e(r) : ((i[r] = !0), n.push(r), (n = n.concat(t(r)))), (r = n.pop()));
  }
  function u(e) {
...
function Ot(e, t, n) {
  return function (r, i, a) {
    var o = r.node(i),
      ...
      c = 0,
      l;
    if (((c += o.width / 2), Object.prototype.hasOwnProperty.call(o, `labelpos`)))
  ...
  (t(e.nodes(), function (t) {
    ...
    t(e.edges(), function (t) {
      var r = e.edge(t),
        i = n.edge(t);
      ((r.points = i.points),
        Object.prototype.hasOwnProperty.call(i, `x`) && ((r.x = i.x), (r.y = i.y)));
    }),
...
var Ft = [`nodesep`, `edgesep`, `ranksep`, `marginx`, `marginy`],
  ...
  Vt = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: `r` },
  Ht = [`labelpos`];
function Ut(e) {
...
function Gt(e) {
  t(e.edges(), function (t) {
    ...
    if (n.width && n.height) {
      var r = e.node(t.v);
      A(e, `edge-proxy`, { rank: (e.node(t.w).rank - r.rank) / 2 + r.rank, e: t }, `_ep`);
    }
  });
}
function Kt(e) {
...
function $t(e) {
  t(e.edges(), function (t) {
    if (t.v === t.w) {
      var n = e.node(t.v);
      ((n.selfEdges ||= []), n.selfEdges.push({ e: t, label: e.edge(t) }), e.removeEdge(t));
    }
  });
}
function en(e) {
...
export { Mt as t };
//# sourceMappingURL=dagre-3.js.map
