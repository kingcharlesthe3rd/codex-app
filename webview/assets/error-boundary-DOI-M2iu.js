...
import { Z as r, c as i, g as a, s as o, t as s } from "./app-scope-CWE-zIhQ.js";
import { h as c } from "./vscode-api.js";
import { M as l, N as u, P as d, wi as f } from "./src-1.js";
import { s as p } from "./lib-1.js";
import { t as m } from "./button.js";
import { t as h } from "./spinner.js";
import { n as g } from "./rpc-1.js";
import { m as ee } from "./chunk-13.js";
import { D as te, E as ne, k as re } from "./parse-directives.js";
import { t as ie } from "./use-platform.js";
import { t as ae } from "./info.js";
import { n as oe } from "./app-identity.js";
import { t as se } from "./download.js";
...
function ue(e) {
  ...
  return ((t.version = t.version || `10.29.0`), (t[le] = t[`10.29.0`] || {}));
}
function de(e, t, n = v) {
...
var fe = [`debug`, `info`, `warn`, `error`, `log`, `assert`, `trace`],
  pe = `Sentry Logger `,
  me = {};
function he(e) {
...
function Ce() {
  return _ ? de(`loggerSettings`, () => ({ enabled: !1 })) : { enabled: !1 };
}
var b = { enable: ge, disable: _e, isEnabled: ve, log: ye, warn: be, error: xe },
  we = 50,
  Te = /\(error: (.*)\)/,
  Ee = /captureMessage|captureException/;
function De(...e) {
...
function Oe(e) {
  return Array.isArray(e) ? De(...e) : e;
}
function ke(e) {
  if (!e.length) return [];
  let t = Array.from(e);
  return (
    /sentryWrapped/.test(Ae(t).function || ``) && t.pop(),
    t.reverse(),
    Ee.test(Ae(t).function || ``) && (t.pop(), Ee.test(Ae(t).function || ``) && t.pop()),
    t
      .slice(0, we)
      .map((e) => ({ ...e, filename: e.filename || Ae(t).filename, function: e.function || `?` }))
  );
}
function Ae(e) {
  return e[e.length - 1] || {};
...
function x(e) {
  try {
    return !e || typeof e != `function` ? je : e.name || je;
  } catch {
    return je;
  }
}
...
function S(e, t) {
  if (!Fe[e]) {
    ...
    try {
      ...
      _ && b.error(`Error while instrumenting ${e}`, t);
    }
  }
}
function C(e, t) {
...
function He() {
  ((Be = v.onunhandledrejection),
    (v.onunhandledrejection = function (e) {
      return (C(`unhandledrejection`, e), Be ? Be.apply(this, arguments) : !0);
    }),
...
function E(e, t = {}) {
  ...
  try {
    let n = e,
      ...
      c = (!Array.isArray(t) && t.maxStringLength) || ot;
    for (
      ;
      n &&
      i++ < 5 &&
      ((o = st(n, s)), !(o === `html` || (i > 1 && a + r.length * 3 + o.length >= c)));
    )
...
function D(e, t, n) {
  ...
  let i = n(r);
  typeof i == `function` && ut(i, r);
  try {
    e[t] = i;
  } catch {
    _ && b.log(`Failed to replace method "${t}" in object`, e);
  }
}
function O(e, t, n) {
  try {
    ...
    _ && b.log(`Failed to add non-enumerable property "${t}" to object`, e);
  }
}
function ut(e, t) {
  try {
...
function ft(e) {
  if (We(e)) return { message: e.message, name: e.name, stack: e.stack, ...mt(e) };
  if (Qe(e)) {
    let t = { type: e.type, target: pt(e.target), currentTarget: pt(e.currentTarget), ...mt(e) };
    return (typeof CustomEvent < `u` && T(e, CustomEvent) && (t.detail = e.detail), t);
  } else return e;
}
function pt(e) {
  try {
    return $e(e) ? E(e) : Object.prototype.toString.call(e);
  } catch {
    return `<unknown>`;
  }
}
...
function _t(e, t) {
  ...
  for (let t = 0; t < e.length; t++) {
    let r = e[t];
    try {
      rt(r) ? n.push(Ne(r)) : n.push(String(r));
    } catch {
...
function vt(e, t, n = !1) {
  return w(e) ? (et(t) ? t.test(e) : w(t) ? (n ? e === t : e.includes(t)) : !1) : !1;
}
function yt(e, t = [], n = !1) {
  return t.some((t) => vt(e, t, n));
}
function bt() {
  let e = v;
...
function k(e = bt()) {
  ...
  return (
    (xt ||= `10000000100040008000100000000000`),
    xt.replace(/[018]/g, (e) => (e ^ ((St() & 15) >> (e / 4))).toString(16))
  );
}
function Ct(e) {
...
function jt() {
  let { performance: e } = v;
  if (!e?.now || !e.timeOrigin) return At;
  let t = e.timeOrigin;
  return () => (t + e.now()) / kt;
}
var Mt;
...
function Lt(e, t) {
  let n = {};
  (t ? (n = { status: t }) : e.status === `ok` && (n = { status: `exited` }), It(e, n));
}
function Rt(e) {
  return {
    sid: `${e.sid}`,
...
function zt(e, t, n = 2) {
  ...
  let r = { ...e };
  for (let e in t) Object.prototype.hasOwnProperty.call(t, e) && (r[e] = zt(r[e], t[e], n - 1));
  return r;
}
function M() {
  return k();
  ...
  Wt = class e {
    ...
    setUser(e) {
      return (
        ...
        this._session && It(this._session, { user: e }),
    ...
    removeAttribute(e) {
      return (
        e in this._attributes && (delete this._attributes[e], this._notifyScopeListeners()), this
      );
    }
    setExtras(e) {
    ...
    update(t) {
      ...
      let n = typeof t == `function` ? t(this) : t,
        ...
        } = (n instanceof e ? n.getScopeData() : Ze(n) ? t : void 0) || {};
      return (
    ...
    addBreadcrumb(e, t) {
      let n = typeof t == `number` ? t : Ut;
      if (n <= 0) return this;
      let r = { timestamp: At(), ...e, message: e.message ? gt(e.message, 2048) : e.message };
      return (
    ...
    setSDKProcessingMetadata(e) {
      return ((this._sdkProcessingMetadata = zt(this._sdkProcessingMetadata, e, 2)), this);
    }
    ...
    captureException(e, t) {
      let n = t?.event_id || k();
      if (!this._client)
        return (_ && b.warn(`No client configured on scope - will not capture exception!`), n);
    ...
    captureMessage(e, t, n) {
      let r = n?.event_id || k();
      if (!this._client)
        return (_ && b.warn(`No client configured on scope - will not capture message!`), r);
    ...
    captureEvent(e, t) {
      ...
      return this._client
        ...
        : (_ && b.warn(`No client configured on scope - will not capture event!`), n);
    }
...
function Gt() {
  return de(`defaultCurrentScope`, () => new Wt());
}
function Kt() {
  return de(`defaultIsolationScope`, () => new Wt());
}
var qt = class {
  constructor(e, t) {
    let n;
    n = e || new Wt();
    let r;
    ((r = t || new Wt()), (this._stack = [{ scope: n }]), (this._isolationScope = r));
  }
  withScope(e) {
...
function Jt() {
  let e = ue(y());
  return (e.stack = e.stack || new qt(Gt(), Kt()));
}
function Yt(e) {
  return Jt().withScope(e);
}
function Xt(e, t) {
  let n = Jt();
...
function Zt(e) {
  return Jt().withScope(() => e(Jt().getIsolationScope()));
}
function Qt() {
  return {
    withIsolationScope: Zt,
    withScope: Yt,
    withSetScope: Xt,
    withSetIsolationScope: (e, t) => Zt(t),
...
function $t(e) {
  let t = ue(e);
  return t.acs ? t.acs : Qt();
}
function P() {
  return $t(y()).getCurrentScope();
}
function F() {
  return $t(y()).getIsolationScope();
}
function en() {
  return de(`globalScope`, () => new Wt());
}
function tn(...e) {
  let t = $t(y());
  if (e.length === 2) {
...
var L = `sentry.source`,
  ...
  an = `sentry.previous_trace_sample_rate`,
  R = `sentry.op`,
  z = `sentry.origin`,
  on = `sentry.idle_span_finish_reason`,
  sn = `sentry.measurement_unit`,
  cn = `sentry.measurement_value`,
  ln = `sentry.custom_span_name`,
  un = `sentry.profile_id`,
...
function yn(e, t, n) {
  e && (O(e, gn, _n(n)), O(e, hn, t));
}
function bn(e) {
  let t = e;
  return { scope: t[hn], isolationScope: vn(t[gn]) };
}
var xn = `sentry-`,
  Sn = /^sentry-/;
function Cn(e) {
...
function wn(e) {
  if (e) return Dn(Object.entries(e).reduce((e, [t, n]) => (n && (e[`${xn}${t}`] = n), e), {}));
}
function Tn(e) {
...
function Mn(e) {
  ...
  return Nn({ host: a, pass: i, path: c, projectId: l, port: o, protocol: n, publicKey: r });
}
function Nn(e) {
  return {
    protocol: e.protocol,
...
function Pn(e) {
  ...
  return [`protocol`, `publicKey`, `host`, `projectId`].find((t) =>
    e[t] ? !1 : (b.error(`Invalid Sentry Dsn: ${t} missing`), !0),
  )
    ? !1
    : n.match(/^\d+$/)
      ? An(r)
...
function In(e) {
  let t = e.getOptions(),
    { host: n } = e.getDsn() || {},
    r;
  return (t.orgId ? (r = String(t.orgId)) : n && (r = Fn(n)), r);
}
function Ln(e) {
  let t = typeof e == `string` ? Mn(e) : Nn(e);
  if (!(!t || !Pn(t))) return t;
}
function Rn(e) {
...
var zn = RegExp(`^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$`);
function Bn(e) {
  if (!e) return;
  let t = e.match(zn);
  if (!t) return;
...
function Un(e = M(), t = N(), n) {
  return `00-${e}-${t}-${n ? `01` : `00`}`;
}
function Wn(e, t) {
  let n = Rn(t?.sample_rand);
  if (n !== void 0) return n;
  let r = Rn(t?.sample_rate);
      ...
      parent_span_id:
        `parentSpanId` in e
          ...
          : `parentSpanContext` in e
            ...
            : void 0,
      start_timestamp: Zn(i),
      timestamp: Zn(o) || void 0,
      status: nr(s),
      op: r[R],
      origin: r[z],
      links: Xn(c),
...
var rr = `_sentryChildSpans`,
  ir = `_sentryRootSpan`;
function ar(e, t) {
  (O(t, ir, e[ir] || e), e[rr] ? e[rr].add(t) : O(e, rr, new Set([t])));
}
function or(e, t) {
  e[rr] && e[rr].delete(t);
}
...
function H() {
  let e = $t(y());
  return e.getActiveSpan ? e.getActiveSpan() : Ht(P());
}
function cr() {
  Gn ||=
    (he(() => {
...
function ur() {
  ...
  function e() {
    ...
    if (t) {
      ...
      (_ && b.log(`[Tracing] Root span: ${e} -> Global error occurred`),
        t.setStatus({ code: 2, message: e }));
    }
  }
  ((e.tag = `sentry_tracingErrorCallback`), (lr = !0), Re(e), Ve(e));
}
function U(e) {
...
function fr(e, t) {
  ...
  for (let n of t) {
    if (mr(n)) {
      if (vt(e.description, n)) return (_ && dr(e), !0);
      continue;
    }
    if (!n.name && !n.op) continue;
    let t = n.name ? vt(e.description, n.name) : !0,
      r = n.op ? e.op && vt(e.op, n.op) : !0;
    if (t && r) return (_ && dr(e), !0);
  }
  return !1;
}
function pr(e, t) {
...
function br(e) {
  ...
  let l = a?.get(`sentry.dsc`),
    u = l && Cn(l);
  if (u) return s(u);
  let d = vr(e.spanContext().traceId, t),
    f = i[L],
    p = r.description;
  return (
    f !== `url` && p && (d.transaction = p),
    U() &&
      ((d.sampled = String(tr(n))),
      (d.sample_rand =
...
function Sr(e, t = 3, n = 100 * 1024) {
  let r = W(e, t);
  return Dr(r) > n ? Sr(e, t - 1, n) : r;
}
function Cr(e, t, n = 1 / 0, r = 1 / 0, i = Or()) {
  let [a, o] = i;
  if (
    t == null ||
...
function Nr(e) {
  ...
  function i(e) {
    typeof r == `string`
      ? (r = typeof e == `string` ? r + e : [Mr(r), e])
      : r.push(typeof e == `string` ? Mr(e) : e);
  }
  for (let e of n) {
    let [t, n] = e;
...
function Ir(e) {
  let t = typeof e.data == `string` ? Mr(e.data) : e.data;
  return [
    {
      type: `attachment`,
      length: t.length,
...
function Hr(e, t, n, r) {
  let i = zr(n);
  return kr(
    { sent_at: new Date().toISOString(), ...(i && { sdk: i }), ...(!!r && t && { dsn: jn(t) }) },
...
function Ur(e, t, n, r) {
  ...
  Vr(e, n?.sdk);
  let o = Br(e, i, r, t);
  return (delete e.sdkProcessingMetadata, kr(o, [[{ type: a }, e]]));
}
function Wr(e, t) {
  function n(e) {
  ...
  let r = br(e[0]),
    ...
    l = c?.length ? e.filter((e) => !fr(B(e), c)) : e,
    u = e.length - l.length;
...
function qr(e, t, n, r = H()) {
  let i = r && V(r);
  i &&
    (_ && b.log(`[Measurement] Setting measurement on root span: ${e} = ${t} ${n}`),
    i.addEvent(e, { [cn]: t, [sn]: n }));
}
function Jr(e) {
...
var Yr = 1e3,
  Xr = class {
    ...
    updateName(e) {
      ...
      this._endTime || ((this._endTime = Zn(e)), Kr(this), this._onSpanEnded());
    }
    getSpanJSON() {
      return {
        ...
        status: nr(this._status),
        timestamp: this._endTime,
        trace_id: this._traceId,
        origin: this._attributes[z],
        profile_id: this._attributes[un],
    ...
    addEvent(e, t, n) {
      _ && b.log(`[Tracing] Adding an event to span:`, e);
      let r = Zr(t) ? t : n || A(),
        i = Zr(t) ? {} : t || {},
        a = { name: e, time: Zn(r), attributes: i };
    ...
    _onSpanEnded() {
      ...
      t && (bn(this).scope || P()).captureEvent(t);
    }
    _convertSpanToTransaction() {
      if (!Qr(B(this))) return;
      this._name ||=
        (_ && b.warn("Transaction has no name, falling back to `<unlabeled transaction>`."),
        `<unlabeled transaction>`);
      let { scope: e, isolationScope: t } = bn(this),
      ...
      (delete this._attributes[ln],
        r.forEach((e) => {
          delete e.data[ln];
        }));
      let a = {
          contexts: { trace: Kn(this) },
          spans:
            r.length > Yr
              ? r.sort((e, t) => e.start_timestamp - t.start_timestamp).slice(0, Yr)
              : r,
          start_timestamp: this._startTime,
          timestamp: this._endTime,
          ...
          sdkProcessingMetadata: {
            ...
            dynamicSamplingContext: br(this),
          },
          request: n,
    ...
    mi(a)(() => {
      let n = P(),
        ...
        s =
          e.onlyIfParent && !o
            ? new xr()
            : ci({ parentSpan: o, spanArguments: r, forceTransaction: i, scope: n });
      return (
        Vt(n, s),
        ti(
          () => t(s),
...
function oi(e) {
  ...
  return (e.scope ? (t) => tn(e.scope, t) : i === void 0 ? (e) => e() : (e) => si(i, e))(() => {
    let t = P(),
      a = pi(t, i);
    return e.onlyIfParent && !a
      ? new xr()
      : ci({ parentSpan: a, spanArguments: n, forceTransaction: r, scope: t });
  });
}
function si(e, t) {
  let n = ui();
  return n.withActiveSpan ? n.withActiveSpan(e, t) : tn((n) => (Vt(n, e || void 0), t(n)));
}
function ci({ parentSpan: e, spanArguments: t, forceTransaction: n, scope: r }) {
  if (!U()) {
    let r = new xr();
    return (
      (n || !e) && _r(r, { sampled: `false`, sample_rate: `0`, transaction: t.name, ...br(r) }), r
    );
  }
  let i = F(),
    a;
  if (e && !n) ((a = fi(e, r, t)), ar(e, a));
  else if (e) {
    let n = br(e),
      { traceId: i, spanId: o } = e.spanContext(),
      s = tr(e);
    ((a = di({ traceId: i, parentSpanId: o, ...t }, r, s)), _r(a, n));
  } else {
    let {
      traceId: e,
      dsc: n,
    ...
    ((a = di({ traceId: e, parentSpanId: o, ...t }, r, s)), n && _r(a, n));
  }
  return (Gr(a), yn(a, r, i), a);
}
function li(e) {
  let t = { isStandalone: (e.experimental || {}).standalone, ...e };
  if (e.startTime) {
    let n = { ...t };
    return ((n.startTimestamp = Zn(e.startTime)), delete n.startTime, n);
  }
  return t;
}
function ui() {
...
function di(e, t, n) {
  ...
  let s = o.parentSampled ?? n,
    ...
    [u, d, f] = t.getScopeData().sdkProcessingMetadata[ii]
      ? [!1]
      : ri(
          i,
          { name: a, parentSampled: s, attributes: c, parentSampleRate: Rn(l.dsc?.sample_rate) },
          l.sampleRand,
        ),
    p = new Xr({
      ...e,
      attributes: { [L]: `custom`, [rn]: d !== void 0 && f ? d : void 0, ...c },
      sampled: u,
    });
  return (
    !u &&
      r &&
      (_ && b.log(`[Tracing] Discarding root span because its trace was not chosen to be sampled.`),
...
function fi(e, t, n) {
  let { spanId: r, traceId: i } = e.spanContext(),
    a = t.getScopeData().sdkProcessingMetadata[ii] ? !1 : tr(e),
    o = a ? new Xr({ ...n, parentSpanId: r, traceId: i, sampled: a }) : new xr({ traceId: i });
  ar(e, o);
  let s = I();
...
function mi(e) {
  return e === void 0 ? (e) => e() : (t) => si(e, t);
}
var hi = { idleTimeout: 1e3, finalTimeout: 3e4, childSpanTimeout: 15e3 },
  gi = `heartbeatFailed`,
  _i = `idleTimeout`,
  vi = `finalTimeout`,
  yi = `externalFinish`;
function bi(e, t = {}) {
  let n = new Map(),
    ...
    s = [],
    {
      idleTimeout: c = hi.idleTimeout,
      finalTimeout: l = hi.finalTimeout,
      childSpanTimeout: u = hi.childSpanTimeout,
      beforeSpanEnd: d,
  ...
  if (!p || !U()) {
    let e = new xr();
    return (_r(e, { sample_rate: `0`, sampled: `false`, ...br(e) }), e);
  }
  let m = P(),
    h = H(),
    g = xi(e);
  g.end = new Proxy(g.end, {
    apply(e, t, n) {
      if ((d && d(g), t instanceof xr)) return;
      let [r, ...i] = n,
        a = Zn(r || A()),
        o = sr(g).filter((e) => e !== g),
        s = B(g);
      ...
      let c = p.getOptions().ignoreSpans,
        u = o?.reduce(
          (e, t) => {
            let n = B(t);
            return !n.timestamp || (c && fr(n, c)) ? e : e ? Math.max(e, n.timestamp) : n.timestamp;
          },
          void 0,
        ),
        m = s.start_timestamp,
  ...
  function ae(e) {
    ((r = !0), n.clear(), s.forEach((e) => e()), Vt(m, h));
    let t = B(g),
      { start_timestamp: i } = t;
    if (!i) return;
    t.data[`sentry.idle_span_finish_reason`] || g.setAttribute(on, a);
    let o = t.status;
    ((!o || o === `unknown`) && g.setStatus({ code: 1 }),
      b.log(`[Tracing] Idle span "${t.op}" finished`));
    let u = sr(g).filter((e) => e !== g),
      d = 0;
    (u.forEach((t) => {
      t.isRecording() &&
        ...
        t.end(e),
        _ &&
          b.log(`[Tracing] Cancelling span since span ended early`, JSON.stringify(t, void 0, 2)));
      ...
      if (_) {
        ...
        i
          ? o ||
            b.log(`[Tracing] Discarding span since it finished after idle span final timeout`, e)
          : b.log(`[Tracing] Discarding span since it happened after idle span was finished`, e);
      }
      (!o || !i) && (or(g, t), d++);
    }),
  ...
  return (
    s.push(
      p.on(`spanStart`, (e) => {
        r ||
          e === g ||
          B(e).timestamp ||
          (e instanceof Xr && e.isStandaloneSpan()) ||
          (sr(g).includes(e) && re(e.spanContext().spanId));
      }),
    ),
    s.push(
      p.on(`spanEnd`, (e) => {
    ...
    setTimeout(() => {
      r || (g.setStatus({ code: 2, message: `deadline_exceeded` }), (a = vi), g.end());
    }, l),
    g
  );
}
function xi(e) {
  let t = oi(e);
  return (Vt(P(), t), _ && b.log(`[Tracing] Started span is an idle span`), t);
}
var Si = 0,
  Ci = 1,
  wi = 2;
...
var Di = class e {
  constructor(e) {
    ((this._state = Si), (this._handlers = []), this._runExecutor(e));
  }
  then(t, n) {
    return new e((e, r) => {
      (this._handlers.push([
  ...
  _executeHandlers() {
    if (this._state === Si) return;
    let e = this._handlers.slice();
    ((this._handlers = []),
      e.forEach((e) => {
        e[0] ||=
          (this._state === Ci && e[1](this._value), this._state === wi && e[2](this._value), !0);
      }));
  }
  _runExecutor(e) {
    let t = (e, t) => {
...
function ki(e, t, n, r) {
  ...
  let a = i({ ...e }, t);
  return (
    _ && a === null && b.log(`Event processor "${i.id || `?`}" dropped event`),
    tt(a) ? a.then((e) => ki(e, t, n, r + 1)) : ki(a, t, n, r + 1)
  );
}
function Ai(e, t) {
  let { fingerprint: n, span: r, breadcrumbs: i, sdkProcessingMetadata: a } = t;
  (Ni(e, t), r && Ii(e, r), Li(e, n), Pi(e, i), Fi(e, a));
}
function ji(e, t) {
  let {
    extra: n,
  ...
  (Mi(e, `extra`, n),
    ...
    Mi(e, `user`, i),
    Mi(e, `contexts`, a),
    (e.sdkProcessingMetadata = zt(e.sdkProcessingMetadata, s, 2)),
    o && (e.level = o),
...
function Ii(e, t) {
  ((e.contexts = { trace: qn(t), ...e.contexts }),
    (e.sdkProcessingMetadata = { dynamicSamplingContext: br(t), ...e.sdkProcessingMetadata }));
...
function Hi(e) {
  ...
  let r = t ? Object.keys(t) : [],
    i = n ? Object.keys(n) : [];
  if (Vi && r.length === zi && i.length === Bi) return Vi;
  ((zi = r.length), (Bi = i.length), (Vi = {}), (Ri ||= {}));
  let a = (t, n) => {
    for (let r of t) {
      let t = n[r],
        i = Ri?.[r];
      if (i && Vi && t) ((Vi[i[0]] = t), Ri && (Ri[r] = [i[0], t]));
      else if (t) {
        let n = e(r);
...
function Wi(e, t) {
  ...
  ((e.environment = e.environment || n || `production`),
    ...
    !e.dist && i && (e.dist = i));
  let o = e.request;
  (o?.url && a && (o.url = gt(o.url, a)),
    a &&
      e.exception?.values?.forEach((e) => {
        e.value &&= gt(e.value, a);
      }));
}
function Gi(e, t) {
  let n = Hi(t);
...
function Yi(e, t) {
  if (!t) return e;
  let n = e ? e.clone() : new Wt();
  return (n.update(t), n);
}
function Xi(e) {
  if (e) return Zi(e) || $i(e) ? { captureContext: e } : e;
}
function Zi(e) {
  return e instanceof Wt || typeof e == `function`;
}
var Qi = [`user`, `level`, `extra`, `contexts`, `tags`, `fingerprint`, `propagationContext`];
function $i(e) {
  return Object.keys(e).some((e) => Qi.includes(e));
}
function ea(e, t) {
  return P().captureException(e, Xi(t));
}
function ta(e, t) {
...
function aa(e) {
  let t = F(),
    ...
    i = Ft({ user: n.getUser() || t.getUser(), ...(r && { userAgent: r }), ...e }),
    a = t.getSession();
  return (a?.status === `ok` && It(a, { status: `exited` }), oa(), t.setSession(i), i);
}
function oa() {
  let e = F(),
    t = P().getSession() || e.getSession();
  (t && Lt(t), sa(), e.setSession());
}
function sa() {
  let e = F(),
    t = I(),
...
function da(e) {
  return `${ua(e)}${e.projectId}/envelope/`;
}
function fa(e, t) {
  let n = { sentry_version: la };
  return (
...
function ya(e, t, n) {
  if (n[t.name]) {
    _ && b.log(`Integration skipped because it was already installed: ${t.name}`);
    return;
  }
  if (
    ((n[t.name] = t),
    !ma.includes(t.name) && typeof t.setupOnce == `function` && (t.setupOnce(), ma.push(t.name)),
  ...
  _ && b.log(`Integration installed: ${t.name}`);
}
function G(e) {
  return e;
}
...
function Sa(e, t) {
  ...
  let r = e.getOptions(),
    i = xa(n, r._metadata, r.tunnel, e.getDsn());
  (wa().set(e, []), e.emit(`flushLogs`), e.sendEnvelope(i));
}
function Ca(e) {
  return wa().get(e);
}
function wa() {
  return de(`clientToLogBufferMap`, () => new WeakMap());
}
function Ta(e) {
  return [
    {
...
function Da(e, t) {
  ...
  if (n.length === 0) return;
  let r = e.getOptions(),
    i = Ea(n, r._metadata, r.tunnel, e.getDsn());
...
function ka() {
  return de(`clientToMetricBufferMap`, () => new WeakMap());
}
var Aa = Symbol.for(`SentryBufferFullError`);
function ja(e = 100) {
  let t = new Set();
  function n() {
    return t.size < e;
...
function Na(e, t = Date.now()) {
  ...
  let r = Date.parse(`${e}`);
  return isNaN(r) ? Ma : r - t;
}
function Pa(e, t) {
  return e[t] || e.all || 0;
}
function Fa(e, t, n = Date.now()) {
  return Pa(e, t) > n;
}
function Ia(e, { statusCode: t, headers: n }, r = Date.now()) {
  let i = { ...e },
  ...
  else o ? (i.all = r + Na(o, r)) : t === 429 && (i.all = r + 60 * 1e3);
  return i;
}
function La(e, t, n = ja(e.bufferSize || 64)) {
  let r = {},
    i = (e) => n.drain(e);
  function a(i) {
    let a = [];
    if (
      (jr(i, (t, n) => {
        let i = Rr(n);
        Fa(r, i) ? e.recordDroppedEvent(`ratelimit_backoff`, i) : a.push(t);
      }),
      a.length === 0)
    )
    ...
    return n
        ...
        t({ body: Nr(o) }).then(
          (e) => (
            e.statusCode !== void 0 &&
              ...
              _ &&
              b.warn(`Sentry responded with status code ${e.statusCode} to sent event.`),
            (r = Ia(r, e)),
            e
          ),
          (e) => {
            throw (
              s(`network_error`), _ && b.error(`Encountered error running transport request:`, e), e
            );
          },
        ),
      )
      .then(
        ...
        (e) => {
          if (e === Aa)
            return (
              _ && b.error(`Skipped sending event because buffer is full.`),
              s(`queue_overflow`),
              Promise.resolve({})
            );
          throw e;
...
function Ra(e, t, n) {
  let r = [{ type: `client_report` }, { timestamp: n || At(), discarded_events: e }];
  return kr(t ? { dsn: t } : {}, [r]);
}
function za(e) {
  let t = [];
...
var Ha = `Not capturing exception because it's already been captured.`,
  Ua = `Discarded session because of missing or non-string release`,
  Wa = Symbol.for(`SentryInternalError`),
  Ga = Symbol.for(`SentryDoNotSendEventError`),
  Ka = 5e3;
function qa(e) {
  return { message: e, [Wa]: !0 };
}
function Ja(e) {
  return { message: e, [Ga]: !0 };
}
function Ya(e) {
...
var Qa = class {
  constructor(e) {
    if (
      ...
      (this._hooks = {}),
      (this._eventProcessors = []),
      (this._promiseBuffer = ja(e.transportOptions?.bufferSize ?? 64)),
      e.dsn
        ? (this._dsn = Ln(e.dsn))
        : _ && b.warn(`No DSN provided, client will not send events.`),
      this._dsn)
    ) {
      let t = pa(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
    ...
    ((this._options.enableLogs =
      ...
      this._options.enableLogs && Za(this, `afterCaptureLog`, `flushLogs`, ao, Sa),
      (this._options.enableMetrics ?? this._options._experiments?.enableMetrics ?? !0) &&
        Za(this, `afterCaptureMetric`, `flushMetrics`, io, Da));
  }
  captureException(e, t, n) {
    let r = k();
    if (Dt(e)) return (_ && b.log(Ha), r);
    let i = { event_id: r, ...t };
    return (
      this._process(
        () =>
  ...
  captureEvent(e, t, n) {
    let r = k();
    if (t?.originalException && Dt(t.originalException)) return (_ && b.log(Ha), r);
    let i = { event_id: r, ...t },
  ...
  captureSession(e) {
    (this.sendSession(e), It(e, { init: !1 }));
  }
  getDsn() {
    return this._dsn;
  }
  ...
  recordDroppedEvent(e, t, n = 1) {
    if (this._options.sendClientReports) {
      let r = `${e}:${t}`;
      (_ && b.log(`Recording outcome: "${r}"${n > 1 ? ` (${n} times)` : ``}`),
  ...
  async sendEnvelope(e) {
    if ((this.emit(`beforeEnvelope`, e), this._isEnabled() && this._transport))
      try {
        ...
        return (_ && b.error(`Error while sending envelope:`, e), {});
      }
    return (_ && b.error(`Transport disabled`), {});
  }
  _setupIntegrations() {
    let { integrations: e } = this._options;
    ((this._integrations = _a(this, e)), va(this, e));
  }
  _updateSessionFromEvent(e, t) {
    ...
    let a = e.status === `ok`;
    ((a && e.errors === 0) || (a && n)) &&
      (It(e, { ...(n && { status: `crashed` }), errors: e.errors || Number(r || n) }),
  ...
  _prepareEvent(e, t, n, r) {
    ...
    return (
      ...
      Ui(i, e, t, n, this, r).then((e) =>
        e === null
          ? e
          : (this.emit(`postprocessEvent`, e, t),
            (e.contexts = { trace: nn(n), ...e.contexts }),
            (e.sdkProcessingMetadata = {
              dynamicSamplingContext: yr(this, n),
              ...e.sdkProcessingMetadata,
            }),
            e),
      )
  ...
  _captureEvent(e, t = {}, n = P(), r = F()) {
    return (
      _ && no(e) && b.log(`Captured error event \`${za(e)[0] || `<unknown>`}\``),
      this._processEvent(e, t, n, r).then(
        (e) => e.event_id,
        (e) => {
          _ && (Xa(e) ? b.log(e.message) : Ya(e) ? b.warn(e.message) : b.warn(e));
        },
      )
    );
  }
      ...
      .then((e) => {
        if (e === null)
          throw (
            ...
            Ja("An event processor returned `null`, will not send event.")
          );
        return t.data && t.data.__sentry__ === !0 ? e : eo(to(this, i, e, t), c);
      })
      .then((i) => {
        if (i === null) {
          ...
          throw Ja(`${c} returned \`null\`, will not send event.`);
        }
  ...
  _process(e, t) {
    (this._numProcessing++,
      this._promiseBuffer.add(e).then(
        ...
        (e) => (this._numProcessing--, e === Aa && this.recordDroppedEvent(`queue_overflow`, t), e),
      ));
  }
  _clearOutcomes() {
  ...
  _flushOutcomes() {
    _ && b.log(`Flushing outcomes...`);
    let e = this._clearOutcomes();
    if (e.length === 0) {
      _ && b.log(`No outcomes to send`);
      return;
    }
    if (!this._dsn) {
      _ && b.log(`No dsn provided, will not send outcomes`);
      return;
    }
    _ && b.log(`Sending outcomes:`, e);
    let t = Ra(e, this._options.tunnel && jn(this._dsn));
    this.sendEnvelope(t);
  }
};
function $a(e) {
...
function eo(e, t) {
  ...
  if (tt(e))
    return e.then(
      (e) => {
        if (!Ze(e) && e !== null) throw qa(n);
        return e;
      },
      (e) => {
        throw qa(`${t} rejected with ${e}`);
      },
    );
  if (!Ze(e) && e !== null) throw qa(n);
  return e;
...
function to(e, t, n, r) {
  let { beforeSend: i, beforeSendTransaction: a, beforeSendSpan: o, ignoreSpans: s } = t,
    c = n;
  if (no(c) && i) return i(c, r);
  if (ro(c)) {
    if (o || s) {
      let t = Ba(c);
      if (s?.length && fr(t, s)) return null;
      if (o) {
        let e = o(t);
        e ? (c = zt(n, Va(e))) : cr();
      }
...
function oo(e) {
  ...
  return (
    Object.values(e).forEach((e) => {
      Array.isArray(e) ? (t += e.length * so(e[0])) : Xe(e) ? (t += so(e)) : (t += 100);
    }),
    t
  );
}
...
function vo(e, t, n = [t], r = `npm`) {
  let i = e._metadata || {};
  ((i.sdk ||= {
    name: `sentry.javascript.${t}`,
    packages: n.map((e) => ({ name: `${r}:@sentry/${e}`, version: le })),
    version: le,
  }),
    (e._metadata = i));
}
function yo(e = {}) {
  ...
  let r = e.scope || P(),
    ...
    a = i ? Jn(i) : bo(r),
    o = wn(i ? br(i) : yr(t, r));
  if (!zn.test(a)) return (b.warn(`Invalid sentry-trace data. Cannot generate trace data`), {});
...
function Co(e, t) {
  let n = I(),
    r = F();
  if (!n) return;
  let { beforeBreadcrumb: i = null, maxBreadcrumbs: a = So } = n.getOptions();
  if (a <= 0) return;
  let o = { timestamp: At(), ...e },
    s = i ? he(() => i(o, t)) : o;
...
var wo,
  ...
  Ao = G((e = {}) => {
    ...
    return {
      ...
      processEvent(n, r, i) {
        return ((t ||= Mo(e, i.getOptions())), No(n, t) ? null : n);
      },
    };
  }),
  jo = G((e = {}) => ({ ...Ao(e), name: `InboundFilters` }));
function Mo(e = {}, t = {}) {
  return {
...
function No(e, t) {
  ...
  } else if (e.type === `transaction` && Fo(e, t.ignoreTransactions))
    return (
      _ &&
        b.warn(
...
function Po(e, t) {
  return t?.length ? za(e).some((e) => yt(e, t)) : !1;
}
function Fo(e, t) {
...
function zo(e) {
  try {
    ...
    return (_ && b.error(`Cannot extract url for event ${wt(e)}`), null);
  }
}
function Bo(e) {
...
function Vo(e, t, n, r, i, a) {
  ...
  o && (i.exception.values = Ho(e, t, r, a.originalException, n, i.exception.values, o, 0));
}
function Ho(e, t, n, r, i, a, o, s) {
  ...
  if (T(r[i], Error)) {
    ...
    let a = e(t, r[i]),
      l = c.length;
    (Wo(a, i, l, s), (c = Ho(e, t, n, r[i], i, [a, ...c], a, l)));
  }
  return (
    Array.isArray(r.errors) &&
      r.errors.forEach((r, a) => {
        if (T(r, Error)) {
          ...
          let l = e(t, r),
            u = c.length;
          (Wo(l, `errors[${a}]`, u, s), (c = Ho(e, t, n, r, i, [l, ...c], l, u)));
        }
      }),
    c
  );
      ...
      e in v.console &&
        D(v.console, e, function (t) {
          return (
            (me[e] = t),
            function (...t) {
              (C(`console`, { args: t, level: e }), me[e]?.apply(v.console, t));
            }
          );
        });
    });
    ...
    return {
      ...
      processEvent(t) {
        ...
        try {
          if (Xo(t, e))
            return (
              _ && b.warn(`Event dropped due to being a duplicate of previously captured event.`),
              null
            );
        } catch {}
        return (e = t);
...
function Xo(e, t) {
  return t ? !!(Zo(e, t) || Qo(e, t)) : !1;
}
function Zo(e, t) {
  let n = e.message,
    r = t.message;
  return !((!n && !r) || (n && !r) || (!n && r) || n !== r || !es(e, t) || !$o(e, t));
}
function Qo(e, t) {
  let n = ts(t),
    r = ts(e);
  return !(!n || !r || n.type !== r.type || n.value !== r.value || !es(e, t) || !$o(e, t));
}
function $o(e, t) {
  let n = Me(e),
    r = Me(t);
...
function is(e, t, n, r) {
  let i = yo({ span: n, propagateTraceparent: r }),
    a = i[`sentry-trace`],
    o = i.baggage,
    s = i.traceparent;
  if (!a) return;
  let c = t.headers || (it(e) ? e.headers : void 0);
  if (!c) return { ...i };
  if (ss(c)) {
    let e = new Headers(c);
    if (
      ...
      let t = e.get(`baggage`);
      t ? os(t) || e.set(`baggage`, `${t},${o}`) : e.set(`baggage`, o);
    }
    return e;
    ...
    let t = c.find((e) => e[0] === `baggage` && os(e[1]));
    ...
    let e = `sentry-trace` in c ? c[`sentry-trace`] : void 0,
      ...
      l = n && (Array.isArray(n) ? n.find((e) => os(e)) : os(n));
    o && !l && i.push(o);
...
function os(e) {
  return e.split(`,`).some((e) => e.trim().startsWith(xn));
}
function ss(e) {
...
function cs(e, t, n) {
  let r = po(e);
  return { name: r ? `${t} ${mo(r)}` : t, attributes: ls(e, r, t, n) };
}
function ls(e, t, n, r) {
  let i = { url: e, type: `fetch`, "http.method": n, [z]: r, [R]: `http.client` };
  return (
    t &&
      (fo(t) || ((i[`http.url`] = t.href), (i[`server.address`] = t.host)),
...
var ds = v;
function fs() {
  return `history` in ds && !!ds.history;
}
function ps() {
  if (!(`fetch` in ds)) return !1;
  try {
  ...
  if (t && typeof t.createElement == `function`)
    try {
      ...
      ((n.hidden = !0),
        ...
        n.contentWindow?.fetch && (e = ms(n.contentWindow.fetch)),
          ...
          t.apply(v, n).then(
            ...
            (e) => {
              if (
                ...
                We(e) && e.stack === void 0 && ((e.stack = r.stack), O(e, `framesToPop`, 1)),
...
function Cs(e) {
  ...
  if (e.length === 2) {
    let [t, n] = e;
    return { url: Ss(t), method: xs(n, `method`) ? String(n.method).toUpperCase() : `GET` };
  }
  let t = e[0];
  return { url: Ss(t), method: xs(t, `method`) ? String(t.method).toUpperCase() : `GET` };
}
function ws(e) {
  let [t, n] = e;
  try {
    if (typeof n == `object` && n && `headers` in n && n.headers) return new Headers(n.headers);
    if (it(t)) return new Headers(t.headers);
  } catch {}
}
function Ts() {
...
var Is = `sentry-electron-renderer-id`;
function Ls(e) {
  let t = Fs(e);
  if (window.__SENTRY_IPC__?.[t.namespace]) return window.__SENTRY_IPC__[t.namespace];
  {
    b.log(`IPC was not configured in preload script, falling back to custom protocol and fetch`);
...
function zs(e = I()) {
  ...
  let n = e.getOptions().ipcNamespace,
    r = Ls(n);
  return (Rs.set(e, r), r.sendRendererStart(), r);
}
var K = v,
  Bs = 0;
function Vs() {
...
function Us(e, t = {}) {
    ...
    try {
      ...
      throw (
        ...
        tn((r) => {
          (r.addEventProcessor(
            (e) => (
              t.mechanism && (Tt(e, void 0, void 0), Et(e, t.mechanism)),
  ...
  (ut(r, e), O(e, `__sentry_wrapped__`, r));
  try {
...
function Ks(e, t, n, r) {
  let i = I()?.getOptions().normalizeDepth,
    a = sc(t),
    o = { __serialized__: Sr(t, i) };
  if (a) return { exception: { values: [Gs(e, a)] }, extra: o };
  let s = {
    exception: {
      values: [
        {
          type: Qe(t) ? t.constructor.name : r ? `UnhandledRejection` : `Error`,
          value: ac(t, { isUnhandledRejection: r }),
        },
      ],
    },
    extra: o,
...
function qs(e, t) {
  return { exception: { values: [Gs(e, t)] } };
}
function Js(e, t) {
...
function Xs(e) {
  return e && Ys.test(e.message) ? 1 : 0;
}
function Zs(e) {
...
function tc(e, t, n, r) {
  let i = rc(e, t, n?.syntheticException || void 0, r);
  return (Et(i), (i.level = `error`), n?.event_id && (i.event_id = n.event_id), Ti(i));
}
function nc(e, t, n = `info`, r, i) {
  let a = ic(e, t, r?.syntheticException || void 0, i);
  return ((a.level = n), r?.event_id && (a.event_id = r.event_id), Ti(a));
}
function rc(e, t, n, r, i) {
  let a;
  if (Ke(t) && t.error) return qs(e, t.error);
  if (qe(t) || Je(t)) {
    let i = t;
    if (`stack` in t) a = qs(e, t);
    else {
      let t = i.name || (qe(i) ? `DOMError` : `DOMException`),
  ...
  return We(t)
    ? qs(e, t)
    : Ze(t) || Qe(t)
      ? ((a = Ks(e, t, n, i)), Et(a, { synthetic: !0 }), a)
      : ((a = ic(e, t, n, r)), Tt(a, `${t}`, void 0), Et(a, { synthetic: !0 }), a);
}
function ic(e, t, n, r) {
  let i = {};
  if (r && n) {
...
function ac(e, { isUnhandledRejection: t }) {
  let n = ht(e),
    r = t ? `promise rejection` : `exception`;
  return Ke(e)
    ? `Event \`ErrorEvent\` captured as ${r} with message \`${e.message}\``
    : Qe(e)
      ? `Event \`${oc(e)}\` (type=${e.type}) captured as ${r}`
...
var cc = class extends Qa {
  constructor(e) {
    let t = lc(e);
    (vo(t, `browser`, [`browser`], K.SENTRY_SDK_SOURCE || Es()),
      t._metadata?.sdk &&
    ...
    (K.document &&
      ...
      K.document.addEventListener(`visibilitychange`, () => {
        K.document.visibilityState === `hidden` &&
          (r && this._flushOutcomes(), i && Sa(this), s && Da(this));
      }),
      n && this.on(`beforeSendSession`, _o));
  }
  eventFromException(e, t) {
    return tc(this._options.stackParser, e, t, this._options.attachStacktrace);
  }
  eventFromMessage(e, t = `info`, n) {
    return nc(this._options.stackParser, e, t, n, this._options.attachStacktrace);
  }
  _prepareEvent(e, t, n, r) {
...
var uc = typeof __SENTRY_DEBUG__ > `u` || __SENTRY_DEBUG__,
  q = v,
  dc = (e, t) => (e > t[1] ? `poor` : e > t[0] ? `needs-improvement` : `good`),
  fc = (e, t, n, r) => {
    let i, a;
    return (o) => {
      t.value >= 0 &&
        (o || r) &&
        ((a = t.value - (i ?? 0)),
        (a || i === void 0) && ((i = t.value), (t.delta = a), (t.rating = dc(t.value, n)), e(t)));
    };
  },
  pc = (e = !0) => {
...
var _c = -1,
  vc = new Set(),
  yc = () => (q.document?.visibilityState === `hidden` && !q.document?.prerendering ? 0 : 1 / 0),
  bc = (e) => {
    if (Sc(e) && _c > -1) {
      if (e.type === `visibilitychange` || e.type === `pagehide`) for (let e of vc) e();
      isFinite(_c) ||
        ((_c = e.type === `visibilitychange` ? e.timeStamp : 0), gc(`prerenderingchange`, bc, !0));
    }
  },
  xc = () => {
    if (q.document && _c < 0) {
      ...
      ((_c =
        (q.document.prerendering
          ...
          : globalThis.performance
              ...
              .filter((t) => t.name === `hidden` && t.startTime > e)[0]?.startTime) ?? yc()),
        hc(`visibilitychange`, bc, !0),
        hc(`pagehide`, bc, !0),
        hc(`prerenderingchange`, bc, !0));
    }
    return {
      get firstHiddenTime() {
        return _c;
...
var Cc = () => `v5-${Date.now()}-${Math.floor(Math.random() * 8999999999999) + 0xe8d4a51000}`,
  wc = (e, t = -1) => {
    let n = pc(),
      r = `navigate`;
    return (
      n &&
        (q.document?.prerendering || mc() > 0
          ? (r = `prerender`)
          : q.document?.wasDiscarded
            ? (r = `restore`)
            : n.type && (r = n.type.replace(/_/g, `-`))),
      { name: e, value: t, rating: `good`, delta: 0, entries: [], id: Cc(), navigationType: r }
    );
  },
  Tc = new WeakMap();
function Ec(e, t) {
  return (Tc.get(e) || Tc.set(e, new t()), Tc.get(e));
}
var Dc = class e {
    constructor() {
          ...
          for (let t of e)
            t.name === `first-contentful-paint` &&
              ...
              t.startTime < n.firstHiddenTime &&
                ((r.value = Math.max(t.startTime - mc(), 0)), r.entries.push(t), i(!0)));
        });
      a && (i = fc(e, r, jc, t.reportAllChanges));
    });
  },
  Nc = [0.1, 0.25],
  Pc = (e, t = {}) => {
    Mc(
      kc(() => {
        let n = wc(`CLS`, 0),
          ...
          s = Oc(`layout-shift`, o);
        s &&
          ((r = fc(e, n, Nc, t.reportAllChanges)),
          i.onHidden(() => {
            (o(s.takeRecords()), r(!0));
          }),
          q?.setTimeout?.(r));
  ...
  Rc = (e) => {
    e.forEach((e) => {
      e.interactionId &&
        ((Ic = Math.min(Ic, e.interactionId)),
        (Lc = Math.max(Lc, e.interactionId)),
        (Fc = Lc ? (Lc - Ic) / 7 + 1 : 0));
    });
  },
  zc,
  Bc = () => (zc ? Fc : performance.interactionCount || 0),
  Vc = () => {
    `interactionCount` in performance ||
      zc ||
      (zc = Oc(`event`, Rc, { type: `event`, buffered: !0, durationThreshold: 0 }));
  },
  Hc = 10,
  Uc = 0,
  Wc = () => Bc() - Uc,
  Gc = class e {
    ...
    _resetInteractions() {
      ((Uc = Bc()), (this._longestInteractionList.length = 0), this._longestInteractionMap.clear());
    }
    _estimateP98LongestInteraction() {
      let e = Math.min(this._longestInteractionList.length - 1, Math.floor(Wc() / 50));
    ...
    _processEntry(e) {
      ...
      if (n || this._longestInteractionList.length < Hc || e.duration > t._latency) {
        if (
          (n
          ...
          this._longestInteractionList.length > Hc)
        ) {
          let e = this._longestInteractionList.splice(Hc);
  ...
  Kc = (e) => {
    ...
    (hc(`visibilitychange`, t, !0), hc(`pagehide`, t, !0));
  },
  qc = (e) => {
    ...
    q.document?.visibilityState === `hidden`
      ? e()
      : ((e = kc(e)),
        hc(`visibilitychange`, e, { once: !0, capture: !0 }),
        t(() => {
          (e(), gc(`visibilitychange`, e, { capture: !0 }));
        }),
        Kc(e));
  },
  Jc = [200, 500],
  ...
  Xc = (e, t = {}) => {
    ...
    Ac(() => {
      ...
      let r = wc(`INP`),
        ...
        s = Oc(`event`, o, { durationThreshold: t.durationThreshold ?? Yc });
      ((i = fc(e, r, Jc, t.reportAllChanges)),
        s &&
      ...
      let n = xc(),
        ...
        o = (e) => {
          ...
          for (let t of e)
            (a._processEntry(t),
              t.startTime < n.firstHiddenTime &&
                ((r.value = Math.max(t.startTime - mc(), 0)), (r.entries = [t]), i()));
        },
        s = Oc(`largest-contentful-paint`, o);
      if (s) {
        i = fc(e, r, Qc, t.reportAllChanges);
        let n = kc(() => {
            (o(s.takeRecords()), s.disconnect(), i(!0));
          }),
          a = (e) => {
            e.isTrusted && (qc(n), gc(e.type, a, { capture: !0 }));
          };
        for (let e of [`keydown`, `click`, `visibilitychange`]) hc(e, a, { capture: !0 });
      }
    });
  },
  el = [800, 1800],
  tl = (e) => {
    q.document?.prerendering
      ...
      : q.document?.readyState === `complete`
        ? setTimeout(e)
        : addEventListener(`load`, () => tl(e), !0);
  },
  nl = (e, t = {}) => {
    let n = wc(`TTFB`),
      r = fc(e, n, el, t.reportAllChanges);
    tl(() => {
      let e = pc();
      e && ((n.value = Math.max(e.responseStart - mc(), 0)), (n.entries = [e]), r(!0));
    });
  },
  rl = {},
  il = {},
  ...
  cl;
function ll(e, t = !1) {
  return yl(`cls`, e, hl, al, t);
}
function ul(e, t = !1) {
  return yl(`lcp`, e, gl, ol, t);
}
function dl(e) {
  return yl(`ttfb`, e, _l, sl);
}
function fl(e) {
  return yl(`inp`, e, vl, cl);
}
function pl(e, t) {
  return (xl(e, t), il[e] || (bl(e), (il[e] = !0)), Sl(e, t));
}
function ml(e, t) {
  let n = rl[e];
  if (n?.length)
...
function _l() {
  return nl((e) => {
    (ml(`ttfb`, { metric: e }), (sl = e));
  });
}
function vl() {
  return Xc((e) => {
    (ml(`inp`, { metric: e }), (cl = e));
  });
}
function yl(e, t, n, r, i = !1) {
  xl(e, t);
  let a;
  return (il[e] || ((a = n()), (il[e] = !0)), r && t({ metric: r }), Sl(e, t, i ? a : void 0));
}
function bl(e) {
  let t = {};
...
function Ml(e, t, n, r) {
  ...
  let c = El({ name: o, transaction: a, attributes: s, startTime: i });
  c && (c.addEvent(`cls`, { [sn]: ``, [cn]: e }), c.end(i));
}
function Nl(e) {
  let t = 0,
    n;
  if (!kl(`largest-contentful-paint`)) return;
  let r = ul(({ metric: e }) => {
    let r = e.entries[e.entries.length - 1];
    r && ((t = e.value), (n = r));
  }, !0);
...
function Pl(e, t, n, r) {
  ...
  let c = El({ name: o, transaction: a, attributes: s, startTime: i });
  c && (c.addEvent(`lcp`, { [sn]: `millisecond`, [cn]: e }), c.end(i));
}
function Y(e) {
...
function Fl(e) {
  ...
  if (e.nextHopProtocol != null) {
    let { name: n, version: r } = Ol(e.nextHopProtocol);
    ((t[`network.protocol.version`] = r), (t[`network.protocol.name`] = n));
  }
  return j() || Dl()?.timeOrigin
    ? Il({
        ...t,
...
var Ll = 2147483647,
  ...
  Z,
  zl;
function Bl({ recordClsStandaloneSpans: e, recordLcpStandaloneSpans: t, client: n }) {
  let r = Dl();
  if (r && j()) {
      ...
      for (let n of e)
        if (n.name === `click`) {
          let e = J(j() + n.startTime),
            ...
            a = lt(n.target);
          (a && (i.attributes[`ui.component_name`] = a), Tl(t, e, e + r, i));
        }
    }
  });
}
function Wl() {
  return ll(({ metric: e }) => {
    ...
    t && ((X.cls = { value: e.value, unit: `` }), (zl = t));
  }, !0);
}
function Gl() {
  return ul(({ metric: e }) => {
  ...
  (a.slice(Rl).forEach((n) => {
    ...
    if (!(o === `navigation` && s && i + r < s))
      switch (n.entryType) {
        ...
        case `paint`:
        case `measure`: {
          Yl(e, n, r, a, i, t.ignorePerformanceApiSpans);
          let o = xc(),
        ...
        case `resource`:
          tu(e, n, n.name, r, a, i, t.ignoreResourceSpans);
          break;
      }
  }),
    (Rl = Math.max(a.length - 1, 0)),
    nu(e),
    o === `pageload` &&
      (au(X),
      ...
      e.setAttribute(`performance.activationStart`, mc()),
      ru(e, t)),
    (Z = void 0),
    (zl = void 0),
    (X = {}));
...
function Yl(e, t, n, r, i, a) {
  if (Jl(t) || ([`mark`, `measure`].includes(t.entryType) && yt(t.name, a))) return;
  let o = pc(!1),
  ...
  (c !== l &&
    ...
    Xl(d, t),
    c <= u && Tl(e, c, u, { name: t.name, op: t.entryType, attributes: d }));
}
function Xl(e, t) {
  try {
    let n = t.detail;
    ...
    if (typeof n == `object`) {
      for (let [t, r] of Object.entries(n))
        if (r && Xe(r)) e[`sentry.browser.measure.detail.${t}`] = r;
        else if (r !== void 0)
          try {
...
function Zl(e, t, n) {
  ([`unloadEvent`, `redirect`, `domContentLoadedEvent`, `loadEvent`, `connect`].forEach((r) => {
    ...
    Ql(e, t, `secureConnection`, n, `TLS/SSL`),
    Ql(e, t, `fetch`, n, `cache`),
    Ql(e, t, `domainLookup`, n, `DNS`),
    eu(e, t, n));
}
function Ql(e, t, n, r, i = n) {
  let a = t[$l(n)],
    o = t[`${n}Start`];
  !o ||
    !a ||
...
function tu(e, t, n, r, i, a, o) {
  ...
  let u = { ...c, ...Fl(t) },
    d = a + r;
  Tl(e, d, d + i, { name: n.replace(q.location.origin, ``), op: s, attributes: u });
}
function nu(e) {
  let t = q.navigator;
  if (!t) return;
  ...
  (n &&
    ...
    wl(n.rtt) && (X[`connection.rtt`] = { value: n.rtt, unit: `millisecond` })),
    wl(t.deviceMemory) && e.setAttribute(`deviceMemory`, `${t.deviceMemory} GB`),
    wl(t.hardwareConcurrency) &&
...
function ru(e, t) {
  (Z &&
    ...
    zl?.sources &&
      ...
      zl.sources.forEach((t, n) => e.setAttribute(`cls.source.${n + 1}`, E(t.node))));
}
function iu(e, t, n) {
  n.forEach(([n, r]) => {
    let i = e[n];
    i != null && ((typeof i == `number` && i < Ll) || typeof i == `string`) && (t[r] = i);
  });
}
function au(e) {
  let t = pc(!1);
...
function ou() {
  return Dl() && j() ? pl(`element`, su) : () => void 0;
}
var su = ({ entries: e }) => {
    let t = H(),
      n = t ? V(t) : void 0,
...
function mu(e) {
  if (e.type !== uu) return !1;
  try {
    if (!e.target || e.target._sentryId !== du) return !1;
  } catch {}
  return !0;
}
function hu(e, t) {
...
function gu(e, t = !1) {
  return (n) => {
    ...
    (mu(n) || (e({ event: n, name: i, global: t }), (uu = n.type), (du = r ? r._sentryId : void 0)),
      clearTimeout(lu),
      (lu = q.setTimeout(() => {
        ((du = void 0), (uu = void 0));
      }, cu)));
  ...
  if (
    (q.addEventListener(`popstate`, () => {
      let e = q.location.href,
        t = vu;
      ((vu = e), t !== e && C(`history`, { from: t, to: e }));
    }),
    !fs())
  )
    return;
  function e(e) {
    return function (...t) {
      ...
      if (n) {
        let r = vu,
          i = xu(String(n));
        if (((vu = i), r === i)) return e.apply(this, t);
...
function Cu(e) {
  ...
  if (r && typeof r.createElement == `function`)
    try {
      ...
      uc && b.warn(`Could not create sandbox iframe for ${e} check, bailing to window.${e}: `, t);
    }
  return n && (Su[e] = n.bind(q));
}
function wu(e) {
  Su[e] = void 0;
}
var Tu = `__sentry_xhr_v3__`;
function Eu(e) {
  (Ie(`xhr`, e), S(`xhr`, Du));
}
function Du() {
  ...
  ((e.open = new Proxy(e.open, {
    apply(e, t, n) {
      ...
      ((t[Tu] = { method: a, url: o, request_headers: {} }),
...
function ku(e) {
  ...
  try {
    ...
    return (uc && b.error(t, `Failed to get xhr response headers`, e), {});
  }
  return t
    ? t
        .split(`\r
...
var Lu = ({ metric: e }) => {
  ...
  let { interactionId: r } = n,
    ...
    o = H(),
    s = o ? V(o) : void 0,
    c = r == null ? void 0 : ju.get(r),
    l = c?.span || s,
    u = l ? B(l).description : P().getScopeData().transactionName,
    d = El({
      name: c?.elementName || E(n.target),
      transaction: u,
      attributes: { [z]: `auto.http.browser.inp`, [R]: `ui.interaction.${i}`, [dn]: n.duration },
      startTime: a,
    });
  d && (d.addEvent(`inp`, { [sn]: `millisecond`, [cn]: e.value }), d.end(a + t));
};
function Ru() {
  ...
  function t(e) {
    ...
    if ((Mu.set(r, n), Mu.size > 50)) {
      let e = Mu.keys().next().value;
      e !== void 0 && Mu.delete(e);
    }
  }
  function n(e) {
  ...
  let r = ({ entries: e }) => {
    ...
    e.forEach((e) => {
      ...
      if (t == null || ju.has(t)) return;
      let i = e.target ? E(e.target) : n(e);
      if (Au.length > 10) {
        let e = Au.shift();
        ju.delete(e);
      }
      (Au.push(t), ju.set(t, { span: r, elementName: i }));
    });
  };
  (pl(`event`, r), pl(`first-input`, r));
}
var zu = 40;
function Bu(e, t = Cu(`fetch`)) {
  let n = 0,
    r = 0;
  async function i(i) {
    let a = i.body.length;
  ...
  return La(e, i, ja(e.bufferSize || zu));
}
  ...
  Ju = [
    ...
    (e) => {
      ...
      if (r) {
        ...
        let [e, t] = Qu(r[1] || `?`, r[2]);
        return Uu(t, e, r[3] ? +r[3] : void 0, r[4] ? +r[4] : void 0);
      }
    },
  ],
  Yu =
  ...
  Zu = De(Ju, [
    ...
    (e) => {
      ...
      if (t) {
        ...
        let e = t[3],
          n = t[1] || `?`;
        return (([n, e] = Qu(n, e)), Uu(e, n, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0));
      }
    },
  ]),
  Qu = (e, t) => {
...
function rd(e, t) {
  return function (n) {
    ...
    (o &&
      ...
      (Q &&
        b.warn(
          `\`dom.maxStringLength\` cannot exceed ${$u}, but a value of ${o} was configured. Sentry will use ${$u} instead.`,
        ),
      (o = $u)),
      typeof a == `string` && (a = [a]));
    try {
      let e = n.event,
        t = cd(e) ? e.target : e;
      ((r = E(t, { keyAttrs: a, maxStringLength: o })), (i = lt(t)));
    } catch {
      r = `<unknown>`;
    }
    ...
    (i && (s.data = { "ui.component_name": i }),
      Co(s, { event: n.event, name: n.name, global: n.global }));
  };
}
function id(e) {
  return function (t) {
    ...
    if (t.level === `assert`)
      if (t.args[0] === !1)
        ((n.message = `Assertion failed: ${_t(t.args.slice(1), ` `) || `console.assert`}`),
          (n.data.arguments = t.args.slice(1)));
      else return;
    Co(n, { input: t.args, level: t.level });
  };
}
function ad(e) {
  return function (t) {
    ...
    let { method: a, url: o, status_code: s, body: c } = i,
      ...
      d = { category: `xhr`, data: l, type: `http`, level: us(s) };
    (e.emit(`beforeOutgoingRequestBreadcrumb`, d, u), Co(d, u));
  };
}
function od(e) {
  return function (t) {
    ...
    if (r && !(t.fetchData.url.match(/sentry_key/) && t.fetchData.method === `POST`))
      if ((t.fetchData.method, t.fetchData.url, t.error)) {
        ...
        (e.emit(`beforeOutgoingRequestBreadcrumb`, o, a), Co(o, a));
      } else {
        let i = t.response,
        ...
        let o = { input: t.args, response: i, startTimestamp: n, endTimestamp: r },
          s = { category: `fetch`, data: a, type: `http`, level: us(a.status_code) };
        (e.emit(`beforeOutgoingRequestBreadcrumb`, s, o), Co(s, o));
      }
  };
}
function sd(e) {
...
var ld =
  ...
  dd = G((e = {}) => {
    ...
    return {
      name: ud,
      setupOnce() {
        (t.setTimeout && D(K, `setTimeout`, fd),
          t.setInterval && D(K, `setInterval`, fd),
          t.requestAnimationFrame && D(K, `requestAnimationFrame`, pd),
          t.XMLHttpRequest && `XMLHttpRequest` in K && D(XMLHttpRequest.prototype, `send`, md));
        let e = t.eventTarget;
        e && (Array.isArray(e) ? e : ld).forEach((e) => hd(e, t));
      },
    };
  });
function fd(e) {
  return function (...t) {
    let n = t[0];
    return (
      (t[0] = Us(n, { mechanism: { handled: !1, type: `auto.browser.browserapierrors.${x(e)}` } })),
      e.apply(this, t)
    );
  };
}
        ...
        e in n &&
          ...
          D(n, e, function (t) {
            let n = {
              ...
              r = dt(t);
            return (r && (n.mechanism.data.handler = x(r)), Us(t, n));
          });
      }),
      e.apply(this, t)
    );
  ...
  n?.hasOwnProperty?.(`addEventListener`) &&
    (D(n, `addEventListener`, function (n) {
      return function (r, i, a) {
        try {
          gd(i) &&
            (i.handleEvent = Us(i.handleEvent, {
              mechanism: {
                data: { handler: x(i), target: e },
                handled: !1,
        ...
        return (
          t.unregisterOriginalCallbacks && _d(this, r, i),
          n.apply(this, [
            r,
            Us(i, {
              mechanism: {
...
var vd = G(() => ({
    ...
    setupOnce() {
      ...
      (aa({ ignoreDuration: !0 }),
        ca(),
        yu(({ from: e, to: t }) => {
          e !== void 0 && e !== t && (aa({ ignoreDuration: !0 }), ca());
        }));
    },
  })),
  yd = `GlobalHandlers`,
  bd = G((e = {}) => {
    ...
    return {
      ...
      setup(e) {
        (t.onerror && (xd(e), Ed(`onerror`)),
          t.onunhandledrejection && (Sd(e), Ed(`onunhandledrejection`)));
      },
    };
  });
function xd(e) {
  Re((t) => {
    let { stackParser: n, attachStacktrace: r } = Dd();
    if (I() !== e || Vs()) return;
    let { msg: i, url: a, line: o, column: s, error: c } = t,
      l = Td(rc(n, c || i, void 0, r, !1), a, o, s);
    ((l.level = `error`),
      ta(l, {
        originalException: c,
...
function Ed(e) {
  Q && b.log(`Global Handler attached: ${e}`);
}
function Dd() {
  ...
  Nd = G((e = {}) => {
    ...
    return {
      ...
      preprocessEvent(e, r, i) {
        Vo(Gs, i.getOptions().stackParser, n, t, e, r);
      },
    };
  });
function Pd() {
...
function Id(e) {
  return [jo(), Do(), dd(), td(), bd(), Nd(), Yo(), kd(), vd()];
}
function Ld(e = {}) {
  let t = !e.skipBrowserExtensionCheck && Pd(),
    n = e.defaultIntegrations == null ? Id() : e.defaultIntegrations;
  return co(cc, {
    ...e,
    enabled: t ? !1 : e.enabled,
    stackParser: Oe(e.stackParser || Zu),
    integrations: ga({ integrations: e.integrations, defaultIntegrations: n }),
    transport: e.transport || Bu,
  });
}
function Rd(e) {
...
var Hd = new WeakMap(),
  Ud = new Map(),
  Wd = { traceFetch: !0, traceXHR: !0, enableHTTPTimings: !0, trackFetchStreamPerformance: !1 };
function Gd(e, t) {
  let {
      traceFetch: n,
      traceXHR: r,
  ...
  (n &&
    ...
    i &&
      _s((e) => {
        if (e.response) {
          let t = Hd.get(e.response);
          t && e.endTimestamp && Ud.set(t, e.endTimestamp);
        }
      }),
    gs((e) => {
      let t = ns(e, u, d, f, { propagateTraceparent: p, onRequestSpanEnd: l });
      if ((e.response && e.fetchData.__span && Hd.set(e.response, e.fetchData.__span), t)) {
        let n = zd(e.fetchData.url),
          r = n ? ho(n).host : void 0;
    ...
    r &&
      Eu((e) => {
        let t = Jd(e, u, d, f, p, l);
        t && (o && Kd(t), c?.(t, { headers: Vd(e.xhr.__sentry_xhr_v3__?.request_headers) }));
      }));
}
function Kd(e) {
  let { url: t } = B(e).data;
  if (!t || typeof t != `string`) return;
  let n = pl(`resource`, ({ entries: r }) => {
    r.forEach((r) => {
      Bd(r) && r.name.endsWith(t) && (e.setAttributes(Fl(r)), setTimeout(n));
    });
  });
}
function qd(e, t) {
  ...
  if (n) {
    ...
    let a = r.origin === i;
    return t ? yt(r.toString(), t) || (a && yt(r.pathname, t)) : a;
  } else {
    let n = !!e.match(/^\/(?!\/)/);
    return t ? yt(e, t) : n;
  }
...
function Jd(e, t, n, r, i, a) {
  ...
  if (e.endTimestamp && u) {
    ...
    n &&
      ...
      (mn(n, s.status_code), n.end(), a?.(n, { headers: Vd(ku(o)), error: e.error }), delete r[t]);
    return;
  }
  let d = zd(c),
    f = ho(d || c),
  ...
  ((o.__sentry_xhr_span_id__ = h.spanContext().spanId),
    ...
    n(c) && Yd(o, U() && m ? h : void 0, i));
  let g = I();
  return (g && g.emit(`beforeOutgoingRequestSpan`, h, e), h);
}
function Yd(e, t, n) {
  let { "sentry-trace": r, baggage: i, traceparent: a } = yo({ span: t, propagateTraceparent: n });
  r && Xd(e, r, i, a);
}
function Xd(e, t, n, r) {
  ...
  if (!(i?.[`sentry-trace`] || !e.setRequestHeader))
    try {
      if (
        ...
        let t = i?.baggage;
        (!t || !Rd(t)) && e.setRequestHeader(`baggage`, n);
      }
    } catch {}
}
function Zd() {
  K.document
    ? K.document.addEventListener(`visibilitychange`, () => {
        ...
        if (K.document.hidden && t) {
          let e = `cancelled`,
            { op: n, status: r } = B(t);
          (Q && b.log(`[Tracing] Transaction: ${e} -> since tab moved to the background, op: ${n}`),
    ...
    : Q &&
      b.warn(`[Tracing] Could not set up background tab detection due to lack of global document`);
}
var Qd = `sentry_previous_trace`,
  $d = `sentry.previous_trace`;
function ef(e, { linkPreviousTrace: t, consistentTraceSampling: n }) {
  ...
  n &&
    e.on(`beforeSampling`, (e) => {
      ...
      (t.setPropagationContext({
        ...n,
        dsc: { ...n.dsc, sample_rate: String(i.sampleRate), sampled: String(af(i.spanContext)) },
        sampleRand: i.sampleRand,
      }),
        (e.parentSampled = af(i.spanContext)),
        (e.parentSampleRate = i.sampleRate),
        (e.spanAttributes = { ...e.spanAttributes, [an]: i.sampleRate }));
    });
}
function tf(e, t, n) {
  let r = B(t);
  ...
  return o.traceId === r.trace_id
    ...
    : (Date.now() / 1e3 - e.startTimestamp <= 3600 &&
        (Q && b.log(`Adding previous_trace ${o} link to span ${{ op: r.op, ...t.spanContext() }}`),
        t.addLink({ context: o, attributes: { [fn]: `previous_trace` } }),
        t.setAttribute($d, `${o.traceId}-${o.spanId}-${af(o) ? 1 : 0}`)),
      a);
}
function nf(e) {
  try {
    K.sessionStorage.setItem(Qd, JSON.stringify(e));
  } catch (e) {
    Q && b.warn(`Could not store previous trace in sessionStorage`, e);
  }
}
function rf() {
  try {
    let e = K.sessionStorage?.getItem(Qd);
    return JSON.parse(e);
  } catch {
    return;
  }
    ...
    return {
      ...
      setup(e) {
        ...
        function t() {
          ...
          t &&
            !B(t).timestamp &&
            (Q && b.log(`[Tracing] Finishing current active span with op: ${B(t).op}`),
            t.setAttribute(on, `cancelled`),
            t.end());
        }
        (e.on(`startNavigationSpan`, (n, r) => {
          ...
          if (r?.isRedirect) {
            (Q &&
              ...
              me(e, { op: `navigation.redirect`, ...n }, !1));
            return;
          }
          ((fe = void 0),
            t(),
          ...
          (i.setPropagationContext({
            ...
            me(e, { op: `navigation`, ...n, parentSpan: null, forceTransaction: !0 }));
        }),
          e.on(`startPageLoadSpan`, (n, r = {}) => {
            if (I() !== e) return;
            t();
            let i = Vn(r.sentryTrace || df(`sentry-trace`), r.baggage || df(`baggage`)),
              a = P();
            (a.setPropagationContext(i),
              U() || (a.getPropagationContext().propagationSpanId = N()),
              a.setSDKProcessingMetadata({ normalizedRequest: Ws() }),
              me(e, { op: `pageload`, ...n }));
          }),
          e.on(`endPageloadSpan`, () => {
            le && pe && (pe.setAttribute(on, `reportPageLoaded`), pe.end());
          }));
      },
      afterAllSetup(e) {
        let n = ct();
        if (
          (ce !== `off` && ef(e, { linkPreviousTrace: ce, consistentTraceSampling: _ }), K.location)
        ) {
          if (ae) {
            let t = j();
            lf(e, {
...
function uf(e, t, n) {
  ...
  return (
    ...
    r && !i && a.setSDKProcessingMetadata({ normalizedRequest: { ...Ws(), url: r } }),
    mf(e)
  );
}
function df(e) {
  ...
  a &&
    addEventListener(
      ...
      () => {
        ...
        if (((o &&= (o.setAttribute(on, `interactionInterrupted`), o.end(), void 0)), !i.name)) {
          Q &&
            b.warn(
...
function _f(e, t) {
  let n = B(e),
    r = At();
  return !(r - n.start_timestamp > gf || (t && r - t <= gf));
}
function vf() {
  let e = en().getScopeData(),
    t = F().getScopeData(),
    n = P().getScopeData();
  return (ji(e, t), ji(e, n), (e.eventProcessors = []), e);
}
function yf(e) {
...
function xf(e) {
  let t;
  return La(e, async (e) => ((t ||= zs()), t.sendEnvelope(e.body), { statusCode: 200 }));
}
var Sf = 50,
  [, Cf] = Ju,
  [, wf] = Ms(),
...
function Ef(e) {
  return [...Id(e).filter((e) => e.name !== `BrowserSession`), bf()];
}
function Df(e = {}, t = Ld) {
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
  ...
  ((window.__SENTRY__RENDERER_INIT__ = !0),
    ...
    e.defaultIntegrations === void 0 && (e.defaultIntegrations = Ef(e)),
    e.stackParser === void 0 && (e.stackParser = Tf),
    e.ipcNamespace === void 0 && (e.ipcNamespace = `sentry-ipc`),
    e.dsn === void 0 && (e.dsn = `https://12345@dummy.dsn/12345`),
    e.transport === void 0 && (e.transport = xf),
...
function Af() {
  ...
  (Df({
    ...
    tracesSampleRate: 0,
    integrations: (e) => (t ? [...e, cf()] : e),
  }),
    na(`sessionId`, e.codexAppSessionId),
    na(`buildFlavor`, e.buildFlavor),
    na(`preRelease`, r),
    na(`bundle`, `webview`),
    na(`host`, `app`),
    re(Nf));
...
var Pf = a(s, {
  ...
  Ff = i(s, ({ get: e }) => e(Pf).isUpdateReady),
  If = i(s, ({ get: e }) => e(Pf).lifecycleState),
  Lf = i(s, ({ get: e }) => e(Pf).downloadProgressPercent),
  Rf = i(s, ({ get: e }) => e(Pf).installProgressPercent),
  zf = i(s, ({ get: e }) => e(Pf).relaunchNotice);
function Bf(e) {
  switch (e) {
    case `ready`:
    case `downloading`:
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      t[0] === r
        ...
        : ((e = () => {
            if (r === `macOS`) {
              g.appUpdates?.installUpdate();
              return;
            }
            g.appUpdates?.checkForUpdates();
          }),
          (t[0] = r),
          (t[1] = e));
      let n;
      t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((n = (0, $.jsx)(se, { className: `icon-xs` })), (t[2] = n))
        : (n = t[2]);
      let i;
      ...
      return (
        t[4] === e
          ? (a = t[5])
          : ((a = (0, $.jsxs)(m, { onClick: e, children: [n, i] })), (t[4] = e), (t[5] = a)),
        a
      );
    }
    case `ready`: {
      ...
      t[6] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(se, { className: `icon-xs` })), (t[6] = e))
        : (e = t[6]);
      let n;
      return (
...
var Jf = { componentStack: null, error: null, eventId: `` };
function Yf(e, t) {
  let n = new WeakMap();
  function r(e, t) {
    if (!n.has(e)) {
...
function Xf(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(ae, { className: `icon-lg text-token-error-foreground` })),
      (a = (0, $.jsx)(p, {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(ce, { electron: !0, children: (0, $.jsx)(Hf, {}) })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
    ? ((s = () => {
      ...
      : ((l = (0, $.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, $.jsxs)(`div`, {
              ...
              children: [o, (0, $.jsx)(m, { onClick: s, children: c })],
            }),
          ],
        })),
        (t[7] = s),
...
var Zf = class extends Wf.Component {
  state = Jf;
  ...
  componentDidCatch(e, { componentStack: t }) {
    let n = t ?? ``,
      r = qf(e) ? e : Error(String(e));
    if (qf(e)) {
      let t = Error(e.message);
      ((t.name = `React ErrorBoundary ${t.name}`), (t.stack = n), Yf(e, t));
    }
    let i = Mf(r, { boundaryName: this.props.name, componentStack: n });
...
//# sourceMappingURL=error-boundary-DOI-M2iu.js.map
