...
import { f as r, p as i } from "./chunk-93.js";
import { r as a } from "./chunk-14.js";
import { r as o } from "./chunk-18.js";
import { r as s } from "./chunk-12.js";
import { r as c } from "./chunk-57.js";
import { r as l } from "./chunk-126.js";
import { r as u } from "./chunk-13.js";
import { r as d } from "./chunk-94.js";
      ...
      (m = {
        ...
        packet: r(async () => {
          let { createPacketServices: e } = await t(
            async () => {
              let { createPacketServices: e } = await import(`./packet.js`);
        ...
        pie: r(async () => {
          let { createPieServices: e } = await t(
            async () => {
              let { createPieServices: e } = await import(`./pie.js`);
        ...
        gitGraph: r(async () => {
          let { createGitGraphServices: e } = await t(
            async () => {
              let { createGitGraphServices: e } = await import(`./gitGraph.js`);
        ...
        treemap: r(async () => {
          let { createTreemapServices: e } = await t(
            async () => {
              let { createTreemapServices: e } = await import(`./treemap.js`);
