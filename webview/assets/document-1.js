...
import { zt as f } from "./spreadsheet-2.js";
...
var m = {
  encode(t, a = new l()) {
    t.id !== void 0 && a.uint32(50).string(t.id);
    for (let e of t.charts) c.encode(e, a.uint32(10).fork()).join();
    (t.name !== `` && a.uint32(18).string(t.name),
      t.widthEmu !== 0 && a.uint32(24).int64(t.widthEmu),
      t.heightEmu !== 0 && a.uint32(32).int64(t.heightEmu));
    for (let e of t.elements) n.encode(e, a.uint32(42).fork()).join();
    for (let e of t.images) r.encode(e, a.uint32(58).fork()).join();
    for (let e of t.footnotes) g.encode(e, a.uint32(66).fork()).join();
    for (let e of t.comments) y.encode(e, a.uint32(74).fork()).join();
    for (let e of t.commentReferences) x.encode(e, a.uint32(82).fork()).join();
    for (let e of t.textStyles) o.encode(e, a.uint32(90).fork()).join();
    for (let n of t.reviewMarks) e.encode(n, a.uint32(98).fork()).join();
    for (let e of t.sections) q.encode(e, a.uint32(106).fork()).join();
    for (let e of t.numberingDefinitions) U.encode(e, a.uint32(114).fork()).join();
    for (let e of t.paragraphNumberings) G.encode(e, a.uint32(122).fork()).join();
    for (let e of t.tableStyleDefinitions) d.encode(e, a.uint32(130).fork()).join();
    for (let e of t.endnotes) _.encode(e, a.uint32(138).fork()).join();
    (t.settings !== void 0 && T.encode(t.settings, a.uint32(146).fork()).join(),
      t.theme !== void 0 && i.encode(t.theme, a.uint32(154).fork()).join());
    for (let e of t.fonts) k.encode(e, a.uint32(162).fork()).join();
    return a;
  },
  decode(t, a) {
    let l = t instanceof s ? t : new s(t),
      u = a === void 0 ? l.len : l.pos + a,
      f = p();
    for (; l.pos < u; ) {
      let t = l.uint32();
      switch (t >>> 3) {
        ...
        case 1:
          if (t !== 10) break;
          f.charts.push(c.decode(l, l.uint32()));
          continue;
        case 2:
          if (t !== 18) break;
          f.name = l.string();
        ...
        case 5:
          if (t !== 42) break;
          f.elements.push(n.decode(l, l.uint32()));
          continue;
        case 7:
          if (t !== 58) break;
          f.images.push(r.decode(l, l.uint32()));
          continue;
        case 8:
          if (t !== 66) break;
          f.footnotes.push(g.decode(l, l.uint32()));
          continue;
        case 9:
          if (t !== 74) break;
          f.comments.push(y.decode(l, l.uint32()));
          continue;
        case 10:
          if (t !== 82) break;
          f.commentReferences.push(x.decode(l, l.uint32()));
          continue;
        case 11:
          if (t !== 90) break;
          f.textStyles.push(o.decode(l, l.uint32()));
          continue;
        case 12:
          if (t !== 98) break;
          f.reviewMarks.push(e.decode(l, l.uint32()));
          continue;
        case 13:
          if (t !== 106) break;
          f.sections.push(q.decode(l, l.uint32()));
          continue;
        case 14:
          if (t !== 114) break;
          f.numberingDefinitions.push(U.decode(l, l.uint32()));
          continue;
        case 15:
          if (t !== 122) break;
          f.paragraphNumberings.push(G.decode(l, l.uint32()));
          continue;
        case 16:
          if (t !== 130) break;
          f.tableStyleDefinitions.push(d.decode(l, l.uint32()));
          continue;
        case 17:
          if (t !== 138) break;
          f.endnotes.push(_.decode(l, l.uint32()));
          continue;
        case 18:
          if (t !== 146) break;
          f.settings = T.decode(l, l.uint32());
          continue;
        case 19:
          if (t !== 154) break;
          f.theme = i.decode(l, l.uint32());
          continue;
        case 20:
          if (t !== 162) break;
          f.fonts.push(k.decode(l, l.uint32()));
          continue;
      }
      if ((t & 7) == 4 || t === 0) break;
      l.skip(t & 7);
  ...
  fromPartial(t) {
    ...
    return (
      (a.id = t.id ?? void 0),
      (a.charts = t.charts?.map((e) => c.fromPartial(e)) || []),
      (a.name = t.name ?? ``),
      (a.widthEmu = t.widthEmu ?? 0),
      (a.heightEmu = t.heightEmu ?? 0),
      (a.elements = t.elements?.map((e) => n.fromPartial(e)) || []),
      (a.images = t.images?.map((e) => r.fromPartial(e)) || []),
      (a.footnotes = t.footnotes?.map((e) => g.fromPartial(e)) || []),
      (a.comments = t.comments?.map((e) => y.fromPartial(e)) || []),
      (a.commentReferences = t.commentReferences?.map((e) => x.fromPartial(e)) || []),
      (a.textStyles = t.textStyles?.map((e) => o.fromPartial(e)) || []),
      (a.reviewMarks = t.reviewMarks?.map((t) => e.fromPartial(t)) || []),
      (a.sections = t.sections?.map((e) => q.fromPartial(e)) || []),
      (a.numberingDefinitions = t.numberingDefinitions?.map((e) => U.fromPartial(e)) || []),
      (a.paragraphNumberings = t.paragraphNumberings?.map((e) => G.fromPartial(e)) || []),
      (a.tableStyleDefinitions = t.tableStyleDefinitions?.map((e) => d.fromPartial(e)) || []),
      (a.endnotes = t.endnotes?.map((e) => _.fromPartial(e)) || []),
      (a.settings =
        t.settings !== void 0 && t.settings !== null ? T.fromPartial(t.settings) : void 0),
      (a.theme = t.theme !== void 0 && t.theme !== null ? i.fromPartial(t.theme) : void 0),
      (a.fonts = t.fonts?.map((e) => k.fromPartial(e)) || []),
      a
    );
  },
};
...
var g = {
  encode(e, n = new l()) {
    ...
    for (let r of e.paragraphs) t.encode(r, n.uint32(18).fork()).join();
    for (let t of e.referenceRunIds) n.uint32(26).string(t);
    return n;
  },
  decode(e, n) {
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (n.referenceRunIds = e.referenceRunIds?.map((e) => e) || []),
      n
    );
  },
};
...
var y = {
  encode(e, n = new l()) {
    (e.id !== `` && n.uint32(10).string(e.id),
      e.author !== `` && n.uint32(18).string(e.author),
      e.initials !== `` && n.uint32(26).string(e.initials),
      e.createdAt !== `` && n.uint32(34).string(e.createdAt));
    for (let r of e.paragraphs) t.encode(r, n.uint32(42).fork()).join();
    return n;
  },
  decode(e, n) {
    let r = e instanceof s ? e : new s(e),
...
var T = {
  encode(e, t = new l()) {
    return (
      ...
      e.footnoteProperties !== void 0 && C.encode(e.footnoteProperties, t.uint32(34).fork()).join(),
      e.endnoteProperties !== void 0 && C.encode(e.endnoteProperties, t.uint32(42).fork()).join(),
      e.displayBackgroundShape !== void 0 && t.uint32(48).bool(e.displayBackgroundShape),
      e.backgroundFill !== void 0 && u.encode(e.backgroundFill, t.uint32(58).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 4:
          if (e !== 34) break;
          i.footnoteProperties = C.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.endnoteProperties = C.decode(n, n.uint32());
          continue;
        case 6:
          if (e !== 48) break;
        ...
        case 7:
          if (e !== 58) break;
          i.backgroundFill = u.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 4:
          if (e !== 34) break;
          i.embeddedFonts.push(D.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
...
var z = {
  encode(e, t = new l()) {
    for (let r of e.elements) n.encode(r, t.uint32(10).fork()).join();
    return t;
  },
  decode(e, t) {
    let r = e instanceof s ? e : new s(e),
    ...
    for (; r.pos < i; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          a.elements.push(n.decode(r, r.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      r.skip(e & 7);
  ...
  fromPartial(e) {
    let t = R();
    return ((t.elements = e.elements?.map((e) => n.fromPartial(e)) || []), t);
  },
};
function B() {
...
var q = {
  encode(e, t = new l()) {
    ...
    for (let r of e.elements) n.encode(r, t.uint32(42).fork()).join();
    return (
  ...
  decode(e, t) {
    ...
    for (; r.pos < i; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          a.pageSetup = N.decode(r, r.uint32());
          continue;
        case 4:
          if (e !== 34) break;
          a.columns = F.decode(r, r.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          a.elements.push(n.decode(r, r.uint32()));
        ...
        case 6:
          if (e !== 50) break;
          a.header = z.decode(r, r.uint32());
          continue;
        case 7:
          if (e !== 58) break;
          a.footer = z.decode(r, r.uint32());
          continue;
        case 8:
          if (e !== 64) break;
          a.startsWithPageBreak = r.bool();
          continue;
        case 9:
          if (e !== 72) break;
          a.pageNumberStart = r.int32();
          continue;
        case 10:
          if (e !== 82) break;
          a.pageNumberFormat = r.string();
          continue;
        case 11:
          if (e !== 88) break;
          a.differentFirstPage = r.bool();
          continue;
        case 12:
          if (e !== 98) break;
          a.firstHeader = z.decode(r, r.uint32());
          continue;
        case 13:
          if (e !== 106) break;
          a.firstFooter = z.decode(r, r.uint32());
          continue;
        case 14:
          if (e !== 114) break;
          a.documentGrid = L.decode(r, r.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      r.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.elements = e.elements?.map((e) => n.fromPartial(e)) || []),
...
var Y = {
  encode(e, t = new l()) {
    ...
    for (let r of e.elements) n.encode(r, t.uint32(18).fork()).join();
  ...
  decode(e, t) {
    ...
    for (; r.pos < i; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          a.charts.push(c.decode(r, r.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      r.skip(e & 7);
...
var Z = {
    encode(e, t = new l()) {
      return (
        ...
        e.presentation !== void 0 && a.encode(e.presentation, t.uint32(26).fork()).join(),
    ...
    decode(e, t) {
      ...
      for (; n.pos < r; ) {
        ...
        switch (e >>> 3) {
          ...
          case 3:
            if (e !== 26) break;
            i.presentation = a.decode(n, n.uint32());
            continue;
          case 4:
            if (e !== 34) break;
...
//# sourceMappingURL=document-1.js.map
