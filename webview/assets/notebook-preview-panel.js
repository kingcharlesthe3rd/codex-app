...
import { FC as d, PC as f } from "./app-initial~app-main~onboarding-page.js";
import {
  d as p,
  g as m,
  m as h,
...
function fe(e) {
  ...
  t[20] !== d || t[21] !== _ || t[22] !== b
    ? ((x = (0, $.jsx)(te, { artifactType: _, centerContent: null, rightContent: b, title: d })),
      (t[20] = d),
      (t[21] = _),
      (t[22] = b),
      (t[23] = x))
...
function ge(e) {
  ...
  return (
    t[22] !== d || t[23] !== g
      ? ((_ = (0, $.jsxs)($.Fragment, { children: [d, g] })), (t[22] = d), (t[23] = g), (t[24] = _))
      : (_ = t[24]),
    _
  );
}
function _e(e) {
  ...
  if (n.cellType === `code`) {
    ...
    t[8] === r
      ...
      : ((o =
          r.length > 0
            ? (0, $.jsx)(w, { allowBasicHtml: !0, className: `text-size-chat`, children: r })
            : null),
        (t[8] = r),
        (t[9] = o));
    let s;
...
function K(e) {
  ...
  if (i != null) {
    ...
    t[0] === i
      ? (e = t[1])
      : ((e = (0, $.jsx)(w, { allowBasicHtml: !0, className: `text-size-chat`, children: i })),
        (t[0] = i),
        (t[1] = e));
    let n;
    t[2] === r
...
var Q, $;
e(() => {
  ((Q = n()), v(), p(), b(), oe(), S(), re(), g(), x(), ie(), d(), V(), de(), ($ = t()));
})();
