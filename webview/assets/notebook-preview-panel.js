import { Gi as e, Hi as t, Ji as n, Vi as r, Yi as i, ji as a, qi as o } from "./src-C.js";
...
import { n as p } from "./markdown-1.js";
...
function K(e) {
  ...
  if (n.cellType === `code`) {
    ...
    t[8] === r
      ...
      : ((o =
          r.length > 0
            ? (0, z.jsx)(p, { allowBasicHtml: !0, className: `text-size-chat`, children: r })
            : null),
        (t[8] = r),
        (t[9] = o));
    let s;
...
function J(e) {
  ...
  if (i != null) {
    ...
    t[0] === i
      ? (e = t[1])
      : ((e = (0, z.jsx)(p, { allowBasicHtml: !0, className: `text-size-chat`, children: i })),
        (t[0] = i),
        (t[1] = e));
    let n;
    t[2] === r
