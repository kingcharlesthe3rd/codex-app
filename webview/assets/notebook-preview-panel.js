...
import { n as oe, t as se } from "./artifact-preview-status.js";
function T(e) {
  let t = z.safeParse(e);
  ...
  switch (e.cell_type) {
    case `code`:
      return {
        ...
        id: n,
        outputs: (e.outputs ?? []).flatMap((t, n) => ce(t, n, k(e.metadata, n))),
        source: t,
        title: r,
      };
    case `markdown`:
...
function ce(e, t, n) {
  switch (e.output_type) {
    case `stream`: {
      ...
      return t == null
        ? []
        : [{ name: D(e, `name`) ?? `stdout`, summaryMarkdown: n, text: t, type: `stream` }];
    }
    case `error`:
      return [
        {
...
var M,
  ...
  B = e(() => {
    (l(),
      ...
      (z = t({ cells: a(R), metadata: F.optional() }).passthrough()));
  });
function V(e) {
...
function U(e) {
  ...
  let _;
  t[13] !== i || t[14] !== a
    ? ((_ = (0, $.jsx)(d, { hostId: i, path: a })), (t[13] = i), (t[14] = a), (t[15] = _))
    : (_ = t[15]);
  let v;
  t[16] !== r || t[17] !== g || t[18] !== _
    ? ((v = (0, $.jsxs)(`div`, {
    ...
    : (v = t[19]);
  let y;
  t[20] !== f || t[21] !== h || t[22] !== v
    ? ((y = (0, $.jsx)(te, { artifactType: h, centerContent: null, rightContent: v, title: f })),
      (t[20] = f),
      (t[21] = h),
      (t[22] = v),
      (t[23] = y))
...
function _e(e) {
  ...
  if (n.cellType === `code`) {
    ...
    t[8] === r
      ...
      : ((o =
          r.length > 0
            ? (0, $.jsx)(b, { allowBasicHtml: !0, className: `text-size-chat`, children: r })
            : null),
        (t[8] = r),
        (t[9] = o));
    let s;
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsxs)(`summary`, {
        ...
        children: [
          ...
          (0, $.jsx)(_, { className: `icon-2xs shrink-0` }),
          (0, $.jsx)(`span`, {
            children: (0, $.jsx)(S, {
...
function K(e) {
  ...
  if (i != null) {
    ...
    t[0] === i
      ? (e = t[1])
      : ((e = (0, $.jsx)(b, { allowBasicHtml: !0, className: `text-size-chat`, children: i })),
        (t[0] = i),
        (t[1] = e));
    let n;
    t[2] === r
...
function xe(e) {
  try {
    return { document: T(JSON.parse(new TextDecoder().decode(Se(e)))), status: `ready` };
  } catch {
    return { status: `error` };
  }
}
...
var Q, $;
e(() => {
  ((Q = i()), p(), ne(), f(), se(), m(), ee(), x(), h(), ae(), ie(), B(), fe(), ($ = c()));
})();
