  ...
  switch (e.cell_type) {
    case `code`:
      return {
        ...
        id: n,
        outputs: (e.outputs ?? []).flatMap((t, n) => O(t, n, ue(e.metadata, n))),
        source: t,
        title: r,
      };
    case `markdown`:
...
var N,
  ...
  V = e(() => {
    (p(),
      ...
      (z = l({
        cell_type: _(),
        execution_count: v().int().nullable().optional(),
        id: _().optional(),
        metadata: I.optional(),
        outputs: u(R).optional(),
        source: L,
      }).passthrough()),
      (B = l({ cells: u(z), metadata: I.optional() }).passthrough()));
  });
function H(e) {
...
function fe(e) {
  ...
  let u = l,
    d;
  t[2] !== u.document || t[3] !== u.status || t[4] !== o
    ? ((d = u.status === `ready` ? (u.document.title ?? Z(o)) : Z(o)),
      (t[2] = u.document),
      (t[3] = u.status),
      (t[4] = o),
      (t[5] = d))
  ...
  let p = d,
    m;
  t[6] !== s || t[7] !== u.document || t[8] !== u.status
    ? ((m =
        u.status === `ready`
          ? s.formatMessage(
              {
              ...
              { cellCount: u.document.cells.length },
            )
          : null),
      (t[6] = s),
      (t[7] = u.document),
  ...
  let y;
  t[13] !== i || t[14] !== a
    ? ((y = (0, $.jsx)(ee, { hostId: i, path: a })), (t[13] = i), (t[14] = a), (t[15] = y))
    : (y = t[15]);
  let b;
  t[16] !== r || t[17] !== v || t[18] !== y
    ...
    : (b = t[19]);
  let x;
  t[20] !== p || t[21] !== _ || t[22] !== b
    ? ((x = (0, $.jsx)(w, { artifactType: _, centerContent: null, rightContent: b, title: p })),
      (t[20] = p),
      (t[21] = _),
      (t[22] = b),
      (t[23] = x))
    : (x = t[23]);
  let S;
  t[24] !== u.document || t[25] !== u.status
    ? ((S =
        u.status === `ready`
          ? (0, $.jsx)(me, { document: u.document })
          : (0, $.jsx)(`div`, {
...
function ge(e) {
  let t = (0, Q.c)(25),
    { cell: n, cellNumber: r, totalCellCount: a } = e,
    o = f(),
    s;
  t[0] !== n || t[1] !== r || t[2] !== o
    ? ((s = Ce(o, n, r)), (t[0] = n), (t[1] = r), (t[2] = o), (t[3] = s))
    : (s = t[3]);
  let c = s,
    l;
  ...
  t[7] !== r || t[8] !== a
    ? ((d = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(g, {
          ...
          values: { cellNumber: r, totalCellCount: a },
        }),
      })),
      (t[7] = r),
      (t[8] = a),
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsxs)(`summary`, {
        ...
        children: [
          ...
          (0, $.jsx)(S, { className: `icon-2xs shrink-0` }),
          (0, $.jsx)(`span`, {
            children: (0, $.jsx)(g, {
...
function be(e) {
  ...
  switch (n.type) {
    ...
    case `html`: {
      let e;
      t[6] === n.html ? (e = t[7]) : ((e = H(n.html)), (t[6] = n.html), (t[7] = e));
      let i;
      t[8] === r
        ? (i = t[9])
        : ((i = r.formatMessage({
...
function q(e) {
  ...
  t[1] === n
    ? (a = t[2])
    : ((a = (0, $.jsx)(J, { className: `mt-2`, children: n })), (t[1] = n), (t[2] = a));
  let o;
  return (
    t[3] !== r || t[4] !== a
...
function J(e) {
  ...
  return (
    n[2] !== r || n[3] !== a
      ? ((o = (0, $.jsx)(`pre`, { className: a, children: r })), (n[2] = r), (n[3] = a), (n[4] = o))
      : (o = n[4]),
    o
  );
}
...
var Q, $;
e(() => {
  ((Q = h()), s(), d(), x(), ie(), te(), C(), y(), b(), ne(), m(), V(), de(), ($ = n()));
})();
