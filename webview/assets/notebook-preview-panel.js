import { Wi as e, aa as t, ca as n, la as r, na as i, sa as a, ta as o } from "./src-2.js";
...
import { lt as l } from "./vscode-api.js";
...
import { t as f } from "./code-Dj-8G3VY.js";
import "./json-2.js";
import "./folder.js";
...
import { n as m } from "./markdown-2.js";
...
function B(e) {
  ...
  t[2] !== l.document || t[3] !== l.status || t[4] !== o
    ? ((f = l.status === `ready` ? (l.document.title ?? $(o)) : $(o)),
      (t[2] = l.document),
      (t[3] = l.status),
      (t[4] = o),
      (t[5] = f))
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, z.jsxs)(`summary`, {
        ...
        children: [
          ...
          (0, z.jsx)(f, { className: `icon-2xs shrink-0` }),
          (0, z.jsx)(`span`, {
            children: (0, z.jsx)(d, {
