...
import { S_ as C, x_ as ee } from "./app-initial~app-main~onboarding-page.js";
import {
  B as w,
  H as T,
  X as te,
...
import { n as re, t as ie } from "./artifact-preview-status.js";
function ae(e) {
  let t = B.safeParse(e);
  ...
  switch (e.cell_type) {
    case `code`:
      return {
        ...
        id: n,
        outputs: (e.outputs ?? []).flatMap((t, n) => se(t, n, ue(e.metadata, n))),
        source: t,
        title: r,
      };
    case `markdown`:
...
var N,
  ...
  de = e(() => {
    (d(),
      ...
      (z = o({
        cell_type: S(),
        execution_count: u().int().nullable().optional(),
        id: S().optional(),
        metadata: I.optional(),
        outputs: n(R).optional(),
        source: L,
      }).passthrough()),
      (B = o({ cells: n(z), metadata: I.optional() }).passthrough()));
  });
function V(e) {
...
function fe(e) {
  let t = (0, Q.c)(30),
    { contentsBase64: n, headerRightContent: o, hostId: c, path: l, title: u } = e,
    d = s(),
    f;
  t[0] === n ? (f = t[1]) : ((f = xe(n)), (t[0] = n), (t[1] = f));
  let p = f,
    m;
  t[2] !== p.document || t[3] !== p.status || t[4] !== u
    ? ((m = p.status === `ready` ? (p.document.title ?? Z(u)) : Z(u)),
      (t[2] = p.document),
      (t[3] = p.status),
      (t[4] = u),
      (t[5] = m))
  ...
  let h = m,
    g;
  t[6] !== d || t[7] !== p.document || t[8] !== p.status
    ? ((g =
        p.status === `ready`
          ? d.formatMessage(
              {
  ...
  let b;
  t[13] !== c || t[14] !== l
    ? ((b = (0, $.jsx)(r, { hostId: c, path: l })), (t[13] = c), (t[14] = l), (t[15] = b))
    : (b = t[15]);
  let x;
  t[16] !== o || t[17] !== y || t[18] !== b
    ? ((x = (0, $.jsxs)(`div`, {
    ...
    : (x = t[19]);
  let S;
  t[20] !== h || t[21] !== v || t[22] !== x
    ? ((S = (0, $.jsx)(i, { artifactType: v, centerContent: null, rightContent: x, title: h })),
      (t[20] = h),
      (t[21] = v),
      (t[22] = x),
      (t[23] = S))
    : (S = t[23]);
  let C;
  t[24] !== p.document || t[25] !== p.status
    ? ((C =
        p.status === `ready`
          ? (0, $.jsx)(me, { document: p.document })
          : (0, $.jsx)(`div`, {
...
function ge(e) {
  let t = (0, Q.c)(25),
    ...
    c;
  t[0] !== n || t[1] !== r || t[2] !== o
    ? ((c = Ce(o, n, r)), (t[0] = n), (t[1] = r), (t[2] = o), (t[3] = c))
    : (c = t[3]);
  let l = c,
    u;
...
function _e(e) {
  ...
  if (n.cellType === `code`) {
    ...
    t[8] === r
      ...
      : ((s =
          r.length > 0
            ? (0, $.jsx)(T, { allowBasicHtml: !0, className: `text-size-chat`, children: r })
            : null),
        (t[8] = r),
        (t[9] = s));
    let c;
    t[10] !== n.source || t[11] !== r.length || t[12] !== o
      ? ((c = o
          ? r.length > 0
...
function be(e) {
  ...
  switch (n.type) {
    ...
    case `html`: {
      let e;
      t[6] === n.html ? (e = t[7]) : ((e = V(n.html)), (t[6] = n.html), (t[7] = e));
      let i;
      t[8] === r
        ? (i = t[9])
        : ((i = r.formatMessage({
    ...
    case `error`: {
      ...
      t[27] === n
        ? (r = t[28])
        : ((r =
            Y(n).trim().length > 0 ? (0, $.jsx)(q, { className: `mt-2`, children: Y(n) }) : null),
          (t[27] = n),
          (t[28] = r));
      let i;
      return (
    ...
    case `text`: {
      ...
      return (
        t[32] !== n.summaryMarkdown || t[33] !== n.text
          ? ((e = (0, $.jsx)(K, { rawText: n.text, summaryMarkdown: n.summaryMarkdown })),
...
function K(e) {
  ...
  if (i != null) {
    ...
    t[0] === i
      ? (e = t[1])
      : ((e = (0, $.jsx)(T, { allowBasicHtml: !0, className: `text-size-chat`, children: i })),
        (t[0] = i),
        (t[1] = e));
    let n;
    t[2] === r
...
function q(e) {
  ...
  t[1] === n
    ? (o = t[2])
    : ((o = (0, $.jsx)(J, { className: `mt-2`, children: n })), (t[1] = n), (t[2] = o));
  let s;
  return (
    t[3] !== r || t[4] !== o
      ? ((s = (0, $.jsxs)(`details`, { className: r, children: [i, o] })),
        (t[3] = r),
        (t[4] = o),
        (t[5] = s))
      : (s = t[5]),
...
function xe(e) {
  try {
    return { document: ae(JSON.parse(new TextDecoder().decode(Se(e)))), status: `ready` };
  } catch {
    return { status: `error` };
  }
}
...
var Q, $;
e(() => {
  ((Q = p()), h(), l(), g(), ie(), te(), w(), y(), b(), ne(), C(), de(), U(), ($ = x()));
})();
