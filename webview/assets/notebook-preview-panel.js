...
import { Fm as re, Pm as ie } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
import {
  f as w,
  p as ae,
} from "./app-initial~app-main~remote-conversation-page~projects-index-page.js";
import { n as oe, t as T } from "./artifact-preview-status.js";
function E(e) {
  let t = z.safeParse(e);
  ...
  switch (e.cell_type) {
    case `code`:
      return {
        ...
        id: n,
        outputs: (e.outputs ?? []).flatMap((t, n) => ce(t, n, de(e.metadata, n))),
        source: t,
        title: r,
      };
    case `markdown`:
...
function ce(e, t, n) {
  switch (e.output_type) {
    case `stream`: {
      ...
      return t == null
        ? []
        : [{ name: O(e, `name`) ?? `stdout`, summaryMarkdown: n, text: t, type: `stream` }];
    }
    case `error`:
      return [
        {
...
function fe(e) {
  ...
  let g;
  t[13] !== i || t[14] !== a
    ? ((g = (0, $.jsx)(te, { hostId: i, path: a })), (t[13] = i), (t[14] = a), (t[15] = g))
    : (g = t[15]);
  let _;
  ...
  t[20] !== d || t[21] !== m || t[22] !== _
    ? ((v = (0, $.jsx)(ee, { artifactType: m, centerContent: null, rightContent: _, title: d })),
      (t[20] = d),
      (t[21] = m),
      (t[22] = _),
      (t[23] = v))
...
function ge(e) {
  ...
  return (
    t[22] !== d || t[23] !== m
      ? ((h = (0, $.jsxs)($.Fragment, { children: [d, m] })), (t[22] = d), (t[23] = m), (t[24] = h))
      : (h = t[24]),
    h
  );
}
function _e(e) {
  ...
  if (n.cellType === `code`) {
    ...
    t[8] === r
      ...
      : ((o =
          r.length > 0
            ? (0, $.jsx)(f, { allowBasicHtml: !0, className: `text-size-chat`, children: r })
            : null),
        (t[8] = r),
        (t[9] = o));
    let s;
...
function K(e) {
  ...
  if (i != null) {
    ...
    t[0] === i
      ? (e = t[1])
      : ((e = (0, $.jsx)(f, { allowBasicHtml: !0, className: `text-size-chat`, children: i })),
        (t[0] = i),
        (t[1] = e));
    let n;
    t[2] === r
...
function xe(e) {
  try {
    return { document: E(JSON.parse(new TextDecoder().decode(Se(e)))), status: `ready` };
  } catch {
    return { status: `error` };
  }
}
...
var Q, $;
e(() => {
  ((Q = a()), v(), ne(), x(), T(), d(), p(), b(), h(), ae(), re(), B(), U(), ($ = c()));
})();
