...
function p(e) {
  ...
  return (
    t[2] !== r || t[3] !== n || t[4] !== a
      ? ((o = (0, v.jsx)(`div`, { className: a, role: `list`, "aria-label": r, children: n })),
        (t[2] = r),
        (t[3] = n),
        (t[4] = a),
        (t[5] = o))
...
function m(e) {
  let t = (0, _.c)(45),
    ...
    w = m === void 0 ? `left` : m,
    T = g === void 0 ? y : g,
    E = o == null && n != null && r != null && a != null,
    D;
  t[0] !== T || t[1] !== n || t[2] !== r || t[3] !== o || t[4] !== C || t[5] !== a || t[6] !== E
    ? ((D = E
        ? (0, v.jsx)(c, {
            id: n,
            className: T,
  ...
  t[8] === h
    ? (k = t[9])
    : ((k = l(`relative flex items-start gap-2 last:border-b-0`, h)), (t[8] = h), (t[9] = k));
  let A;
  t[10] !== O || t[11] !== w
  ...
  t[13] === d
    ? (j = t[14])
    : ((j = d == null ? null : (0, v.jsx)(`div`, { children: d })), (t[13] = d), (t[14] = j));
  let M = E ? n : void 0,
    N;
  t[15] === b
    ? (N = t[16])
    : ((N = l(`truncate text-base leading-5 text-token-foreground`, b)), (t[15] = b), (t[16] = N));
  let P;
  t[17] !== s || t[18] !== N
    ? ((P = (0, v.jsx)(`div`, { className: N, children: s })),
      (t[17] = s),
      (t[18] = N),
      (t[19] = P))
    : (P = t[19]);
  ...
  t[20] !== u || t[21] !== x
    ? ((F =
        u == null
          ? null
          : (0, v.jsx)(`div`, {
              className: l(`truncate text-xs leading-4 text-token-text-secondary`, x),
              children: u,
            })),
      (t[20] = u),
      (t[21] = x),
...
function h(e) {
  ...
  t[0] === o
    ? (d = t[1])
    : ((d = l(`flex w-full flex-col items-center gap-6`, o)), (t[0] = o), (t[1] = d));
  let f = r ?? null,
    p;
  t[2] === s
    ? (p = t[3])
    : ((p = l(`flex w-full flex-col items-center text-center`, s)), (t[2] = s), (t[3] = p));
  let m;
  t[4] === c
    ? (m = t[5])
    : ((m = l(`text-heading-lg font-semibold text-token-foreground`, c)), (t[4] = c), (t[5] = m));
  let h;
  t[6] !== m || t[7] !== i
  ...
  t[9] !== a || t[10] !== u
    ? ((g =
        a == null
          ? null
          : (0, v.jsx)(`span`, {
              className: l(`text-lg leading-6 text-token-description-foreground`, u),
              children: a,
            })),
      (t[9] = a),
      (t[10] = u),
...
function g(e) {
  let t = (0, _.c)(16),
    { children: n, fullBleed: r, hideHeader: o, showBrandIcon: s } = e,
    c = r === void 0 ? !1 : r,
    u = o === void 0 ? !1 : o,
    d = s === void 0 ? !1 : s,
    { platform: p } = f(),
