...
import "./chunk-129.js";
import "./src-2.js";
import { n as t, r as n } from "./chunk-65.js";
import { i as r, o as i, r as a } from "./invert.js";
import { D as o, I as s, b as c, d as l } from "./chunk-3.js";
import "./dist-5.js";
import "./chunk-100.js";
import "./chunk-95.js";
import "./chunk-75.js";
import { t as u } from "./chunk-42.js";
import { t as d } from "./chunk-12.js";
import "./chunk-4.js";
import "./chunk-101.js";
import "./chunk-13.js";
import { r as f, t as p } from "./chunk-115.js";
var m = (function () {
  var e = t(function (e, t, n, r) {
    ...
    v = {
      ...
      table: [
        ...
        e(l, [2, 4]),
        e(l, [2, 5]),
        { 1: [2, 6], 6: r, 12: 21, 13: i, 14: 14, 15: a, 16: o, 17: 17, 18: 18, 19: s, 22: c },
        { 6: r, 9: 22, 12: 11, 13: i, 14: 14, 15: a, 16: o, 17: 17, 18: 18, 19: s, 22: c },
        { 6: u, 7: d, 10: 23, 11: f },
        ...
        { 20: [1, 31] },
        { 6: u, 7: d, 10: 32, 11: f },
        { 1: [2, 7], 6: r, 12: 21, 13: i, 14: 14, 15: a, 16: o, 17: 17, 18: 18, 19: s, 22: c },
        e(m, [2, 14], { 7: h, 11: g }),
        e(_, [2, 8]),
        e(_, [2, 9]),
        e(_, [2, 10]),
...
var h = m,
  ...
  _ = class {
    ...
    addNode(e, t, r, i) {
      ...
      let o = c(),
        u = o.mindmap?.padding ?? l.mindmap.padding;
      switch (i) {
    ...
    decorateNode(e) {
      ...
      (e.icon && (n.icon = s(e.icon, t)), e.class && (n.class = s(e.class, t)));
    }
    type2Str(e) {
      switch (e) {
    ...
    getData() {
      let t = this.getMindmap(),
        ...
        i = o().layout !== void 0,
        a = r;
      if ((i || (a.layout = `cose-bilkent`), !t)) return { nodes: [], edges: [], config: a };
      (n.debug(`getData: mindmapRoot`, t, r), this.assignSections(t));
      let s = [],
        l = [];
      (this.flattenNodes(t, s),
        this.generateEdges(t, l),
        n.debug(`getData: processed ${s.length} nodes and ${l.length} edges`));
      let u = new Map();
      for (let e of s)
