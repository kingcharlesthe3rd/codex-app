...
function b() {
  ...
  (e[0] !== r || e[1] !== t
    ? ((a = () => {
        r === `interrupt` && d(t, o.followUpQueueMode, `steer`);
      }),
      (s = [r, t]),
      (e[0] = r),
      (e[1] = t),
  ...
  return (
    e[4] !== i || e[5] !== l
      ? ((u = { mode: i, isQueueingEnabled: l }), (e[4] = i), (e[5] = l), (e[6] = u))
      : (u = e[6]),
    u
  );
}
...
function D({ hasPlanMode: e, hasDefaultMode: t, isPlanMode: n, setSelectedMode: r }) {
    ...
    ? e.key === `Backspace` && !e.metaKey && !e.ctrlKey && !e.altKey && !e.shiftKey && o && s
      ...
      : e.key === `Escape` && !e.metaKey && !e.ctrlKey && !e.altKey && !e.shiftKey
        ...
        : e.key === `Tab` &&
            ...
            !e.ctrlKey &&
            !e.altKey &&
            (r?.() || D({ hasPlanMode: i, hasDefaultMode: a, isPlanMode: o, setSelectedMode: c }))
