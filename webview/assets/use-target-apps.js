...
import { _ as i, k as a, n as o, r as s, s as c, u as l } from "./vscode-api.js";
import { $n as u, Qn as d } from "./src-4.js";
import { c as f } from "./persisted-signal.js";
import { t as p } from "./codex-analytics-attribution.js";
var m = n(),
  h = e(t(), 1);
function g(e) {
  let t = (0, m.c)(26),
...
function y(e) {
  let t = (0, m.c)(10),
    { turnId: n, cwd: i, hostId: o, openPath: l, targets: u } = e,
    d = a(),
    h = c(`open-file`),
    g = r(f),
    _ = r(p),
  ...
  return (
    ...
    t[8] !== n
      ? ((v = (e, t) => {
          let { appPath: r, openMode: a, persistPreferred: c, line: f, column: p, path: m } = t,
            v = m ?? l ?? i;
          v &&
            (u?.find((t) => t.target === e && (t.appPath ?? null) === (r ?? null))?.kind ===
              `editor` &&
              _ != null &&
              n != null &&
            ...
            c &&
              i &&
              d.setQueryData(
                s(`open-in-targets`, { cwd: i, hostId: o, path: l }),
                (t) =>
                  t && {
                    ...t,
                    preferredTarget: e,
            ...
            h.mutate({
              ...
              ...(p == null ? {} : { column: p }),
              ...(a == null ? {} : { openMode: a }),
              ...(c && i ? { persistPreferredTargetPath: i } : {}),
              ...(o == null ? {} : { hostId: o }),
            }));
        }),
        (t[0] = i),
...
function b(e) {
  let t = (0, m.c)(13),
    { cwd: n, hostId: r, isQueryEnabled: o, openPath: c } = e,
    u = a(),
    d,
    f,
    p;
  t[0] !== n || t[1] !== r || t[2] !== c
    ? ((d = { cwd: n, hostId: r, path: c }),
      (p = i),
      (f = s(`open-in-targets`, d)),
      (t[0] = n),
      (t[1] = r),
      (t[2] = c),
      (t[3] = d),
  ...
  let h;
  t[6] !== d || t[7] !== u
    ? ((h = () => x({ params: d, queryClient: u })), (t[6] = d), (t[7] = u), (t[8] = h))
    : (h = t[8]);
  let g = o && !!(n ?? c),
    _;
  return (
    t[9] !== f || t[10] !== h || t[11] !== g
      ? ((_ = { queryKey: f, queryFn: h, enabled: g, staleTime: l.ONE_MINUTE }),
        (t[9] = f),
        (t[10] = h),
        (t[11] = g),
        (t[12] = _))
...
async function x({ params: e, queryClient: t }) {
  if (S(e.path)) {
    let n = await o(`open-in-targets`, { params: { ...e, nativeBrowserDiscovery: `known` } });
    n.targets.some((e) => e.kind === `native` && e.appPath != null) &&
      t.setQueryData(s(`open-in-targets`, e), n);
  }
  return o(`open-in-targets`, { params: e });
}
function S(e) {
  if (e == null) return !1;
  if (d(e) || u(e)) return !0;
