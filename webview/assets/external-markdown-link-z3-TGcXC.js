...
import { Kn as a, cr as o, dr as s, qn as c } from "./src-1.js";
import { n as l } from "./lib.js";
import { t as u } from "./clsx-Cir5-jBH.js";
import { t as d } from "./tooltip.js";
import { t as f } from "./context-menu-Cx-ZCB4Y.js";
import { I as p, M as m } from "./rpc-1.js";
  ...
  return typeof e != `string` ||
    ...
    : a.validateHostname && a.extractHostname && i.hostname !== null && !j(i.hostname)
      ...
      : (t === 0 ||
          ...
          ((i.subdomain = N(i.hostname, i.domain)), t === 4) ||
...
var F = (function () {
  ...
  ce = (function () {
    let e = [1, {}],
      ...
      le = [0, { dyn: t }],
      ue = [2, { web: t }],
      B = [1, { co: e, com: e, edu: e, gov: e, net: e, org: e }],
      de = [0, { p: t }],
      fe = [0, { user: t }],
      pe = [1, { ms: t }],
      V = [0, { cdn: t }],
    ...
    return [
      0,
      {
        ...
        name: [1, { her: he, his: he, ispmanager: t, keenetic: t }],
        nc: [1, { asso: e, nom: e }],
        ne: e,
        net: [
          1,
        ...
        org: [
          1,
          {
            ...
            fedorainfracloud: t,
            fedorapeople: t,
            fedoraproject: [0, { cloud: t, os: I, stg: [0, { os: I }] }],
            freedesktop: t,
            hatenadiary: t,
            hepforge: t,
            "in-dsl": t,
        ...
        edeka: e,
        education: b,
        email: [1, { crisp: [0, { on: t }], intouch: t, tawk: de, tawkto: de }],
        emerck: e,
        energy: e,
        engineer: e,
        engineering: e,
...
`),
  ...
  if (/^[a-z][a-z0-9+.-]*:\/\//i.test(i)) return n ? (H(i) ?? i) : i;
  if (/^about:/i.test(i)) return i;
  if (m(i) && !i.startsWith(`//`) && !(i.startsWith(`/`) && r)) {
    let e = p(``, i),
      t = new URL(`file:///`);
    if (o(e)) {
      let n = e.indexOf(`/`, 2);
  ...
  let a = W(i);
  if (fe(a)) return `http://${i}`;
  if (me(i, a)) return `https://${i}`;
  if (/\s/.test(i)) return q(i);
  if (n) {
    let e = H(i);
    if (e != null) return e;
  }
...
function de(e) {
  ...
  try {
    let e = new URL(t);
    if (e.protocol === `file:`) {
      let t = s(decodeURIComponent(e.pathname));
...
function H(e) {
  ...
  return (n.protocol !== `http:` && n.protocol !== `https:`) ||
    ...
    n.port.length > 0
    ? null
    : ((n.hostname = z), n.searchParams.append(le, ue), n.toString());
}
function U(e) {
...
function me(e, t) {
  return /\s/.test(e) || t == null
    ...
    : t.hostname.startsWith(`[`)
      ? G(t.hostname)
      : t.hasPort || t.hostname.startsWith(`www.`) || G(t.hostname) || K(t.hostname);
}
function W(e) {
  let t = e.search(/[/?#]/),
    n = t === -1 ? e : e.slice(0, t);
...
function Y({ conversationId: e, url: t, source: n, initiator: r }) {
  let a = J(t);
  return a == null
    ? !1
...
function Q({ conversationId: e, href: t, isBrowserSidebarEnabled: n }) {
  let r = Z(t);
  return e != null && n && X(t) && (he(t) || ve(r));
}
function _e({ conversationId: e, href: t, initiator: n }) {
  let r = Z(t),
    a = ve(r);
  return [
    {
      ...
      onSelect: () => {
        ...
        Y({ conversationId: e, url: t, source: `manual`, initiator: n });
      },
    },
    {
...
function ye({ conversationId: e, href: t, isBrowserSidebarEnabled: n }) {
  return Q({ conversationId: e, href: t, isBrowserSidebarEnabled: n });
}
function be({ conversationId: e, href: t }) {
  return _e({ conversationId: e, href: t, initiator: `markdown_link_context_menu` });
}
function xe({
  ...
  if (
    ...
    r &&
    !Se(t) &&
    Y({ conversationId: e, url: n, source: `manual`, initiator: `markdown_link_click` })
  )
  ...
  return (
    i.dispatchMessage(`open-in-browser`, {
      ...
      ...(Se(t) && ve(s) ? { useExternalBrowser: !0 } : {}),
    }),
    !0
  );
}
...
function Ee(e) {
  ...
  let f;
  t[2] !== c || t[3] !== i || t[4] !== l
    ? ((f = ye({ conversationId: c, href: i, isBrowserSidebarEnabled: l })),
      (t[2] = c),
      (t[3] = i),
      (t[4] = l),
      (t[5] = f))
  ...
  let p = f,
    m;
  t[6] === i ? (m = t[7]) : ((m = Oe(i)), (t[6] = i), (t[7] = m));
  let h = m,
    g = `_blank`;
  if (d == null) {
    let e;
...
function De(e) {
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = u(b, ne, te, `whitespace-nowrap`)), (t[6] = x))
    : (x = t[6]);
  let S;
  t[7] !== h || t[8] !== a || t[9] !== s
    ? ((S =
  ...
  t[23] !== _ || t[24] !== E || t[25] !== g
    ? ((D = (0, $.jsx)(d, { delayDuration: g, tooltipContent: _, children: E })),
      (t[23] = _),
      (t[24] = E),
      (t[25] = g),
      (t[26] = D))
  ...
  let k;
  t[27] !== i || t[28] !== s
    ? ((k = be({ conversationId: i, href: s })), (t[27] = i), (t[28] = s), (t[29] = k))
    : (k = t[29]);
  let A;
  return (
    t[30] !== O || t[31] !== k
      ? ((A = (0, $.jsx)(f, { items: k, children: O })), (t[30] = O), (t[31] = k), (t[32] = A))
      : (A = t[32]),
    A
  );
}
...
export { _e as a, de as c, Q as i, R as l, we as n, Y as o, Se as r, B as s, Ee as t };
//# sourceMappingURL=external-markdown-link-z3-TGcXC.js.map
