...
import { n as h, t as g } from "./src-1.js";
import { i as _, l as v, n as y, p as b, u as x } from "./chunk-123.js";
import { i as S, n as C, r as w } from "./chunk-88.js";
import { n as T, t as E } from "./chunk-61.js";
import { a as D, i as O, n as k, o as A, t as j } from "./chunk-51.js";
import { n as M, t as N } from "./rough.esm-2.js";
function P(e) {
...
async function ee(e) {
  let t = h(document.createElementNS(`http://www.w3.org/2000/svg`, `foreignObject`)),
...
async function le(e, t) {
  ...
  if (t.look === `handDrawn`) {
    let e = N.svg(i),
      ...
      r = P(u),
      a = e.path(r, n);
    ((d = i.insert(() => a, `:first-child`).attr(`transform`, `translate(${-s / 2}, ${o / 2})`)),
      f && d.attr(`style`, f));
  } else d = z(i, s, o, u);
  return (
    r && d.attr(`style`, r),
...
function pe(e, n) {
  ...
  return (
    ...
    J(n, p),
    (n.intersect = function (e) {
      return (t.info(`crossedCircle intersect`, n, { radius: o, point: e }), $.circle(n, o, e));
    }),
    a
  );
}
...
async function be(e, n) {
  ...
  if (n.look === `handDrawn`) {
    ...
    (u.attr(`class`, `basic label-container`).attr(`style`, i),
      e.attr(`class`, `outer-circle`).attr(`style`, i).attr(`r`, c).attr(`cx`, 0).attr(`cy`, 0),
      t.attr(`class`, `inner-circle`).attr(`style`, i).attr(`r`, l).attr(`cx`, 0).attr(`cy`, 0));
  }
  return (
    J(n, u),
    (n.intersect = function (e) {
...
function xe(e, n, { config: { themeVariables: r } }) {
  ...
  return (
    ...
    s && s.length > 0 && n.look !== `handDrawn` && f.selectAll(`path`).attr(`style`, s),
    a && n.look !== `handDrawn` && f.selectAll(`path`).attr(`style`, a),
    J(n, f),
    (n.intersect = function (e) {
      return (t.info(`filledCircle intersect`, n, { radius: 7, point: e }), $.circle(n, 7, e));
    }),
    o
  );
}
async function Se(e, n) {
  ...
  let h = P(d),
    g = p.path(h, m),
    _ = a.insert(() => g, `:first-child`).attr(`transform`, `translate(${-l / 2}, ${l / 2})`);
  return (
...
async function we(e, n) {
  ...
  return (
    ...
    J(n, g),
    (n.intersect = function (e) {
      return (t.info(`Pill intersect`, n, { radius: l, point: e }), $.polygon(n, p, e));
    }),
    a
  );
}
...
async function De(e, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  let C = x.rectangle(v, y, h, m, S),
    ...
    E = m + d.height + b,
    O = x.rectangle(-T / 2, -E / 2, T, E, { ...S, fill: `transparent`, stroke: `none` }),
    k = u.insert(() => C, `:first-child`),
    M = u.insert(() => O);
  if (n.icon) {
    let e = u.append(`g`);
    e.html(`<g>${await w(n.icon, { height: c, width: c, fallbackPrefix: `` })}</g>`);
  ...
  return (
    ...
    k.attr(`transform`, `translate(0,${p ? d.height / 2 + b / 2 : -d.height / 2 - b / 2})`),
    J(n, M),
    (n.intersect = function (e) {
...
async function Oe(e, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  let b = u.append(`g`);
  n.icon && b.html(`<g>${await w(n.icon, { height: c, width: c, fallbackPrefix: `` })}</g>`);
  let x = b.node().getBBox(),
    ...
    P = O + d.height + p,
    F = v.rectangle(-M / 2, -P / 2, M, P, { ...y, fill: `transparent`, stroke: `none` }),
  ...
  return (
    ...
    I.attr(`transform`, `translate(0,${m ? d.height / 2 + p / 2 : -d.height / 2 - p / 2})`),
    J(n, L),
    (n.intersect = function (e) {
...
async function ke(e, n, { config: { themeVariables: r, flowchart: i } }) {
  ...
  let o = n.assetHeight ?? 48,
    ...
    l = i?.wrappingWidth;
  n.width = Math.max(c, l ?? 0);
  let { shapeSvg: u, bbox: d, halfPadding: f, label: p } = await q(e, n, `icon-shape default`),
    m = n.pos === `t`,
    h = c + f * 2,
    g = c + f * 2,
  ...
  let E = C.path(Q(b, x, g, h, 5), T),
    ...
    k = h + d.height + S,
    M = C.rectangle(-O / 2, -k / 2, O, k, { ...T, fill: `transparent`, stroke: `none` }),
  ...
  return (
    ...
    P.attr(`transform`, `translate(0,${m ? d.height / 2 + S / 2 : -d.height / 2 - S / 2})`),
    J(n, F),
    (n.intersect = function (e) {
      if ((t.info(`iconSquare intersect`, n, e), !n.label)) return $.rect(n, e);
      let r = n.x ?? 0,
...
async function je(e, n, { config: { flowchart: r } }) {
  ...
  let l = Math.max(n.label ? (c ?? 0) : 0, n?.assetWidth ?? a),
    u = n.constraint === `on` && n?.assetHeight ? n.assetHeight * n.imageAspectRatio : l,
  ...
  let x = y.rectangle(g, _, u, d, b),
    ...
    C = d + p.height + v,
    w = y.rectangle(-S / 2, -C / 2, S, C, { ...b, fill: `none`, stroke: `none` }),
  ...
  return (
    ...
    T.attr(`transform`, `translate(0,${h ? p.height / 2 + v / 2 : -p.height / 2 - v / 2})`),
    J(n, E),
    (n.intersect = function (e) {
      if ((t.info(`iconSquare intersect`, n, e), !n.label)) return $.rect(n, e);
      let r = n.x ?? 0,
...
async function Me(e, t) {
  ...
  if (t.look === `handDrawn`) {
    let e = N.svg(i),
      ...
      r = P(c),
      a = e.path(r, n);
    ((l = i.insert(() => a, `:first-child`).attr(`transform`, `translate(${-o / 2}, ${s / 2})`)),
      u && l.attr(`style`, u));
  } else l = z(i, o, s, c);
  return (
    r && l.attr(`style`, r),
...
async function Ne(e, t, n) {
  ...
  if ((n?.rx && n.ry && ((f = n.rx), (p = n.ry)), t.look === `handDrawn`)) {
    let e = N.svg(a),
      n = A(t, {}),
      r = f || p ? e.path(Q(l, u, s, c, f || 0), n) : e.rectangle(l, u, s, c, n);
...
async function He(e, t, { config: { themeVariables: n } }) {
  let { labelStyles: r, nodeStyles: i } = D(t);
  ((t.labelStyle = r), t.useHtmlLabels || m().flowchart?.htmlLabels !== !1 || (t.centerLabel = !0));
...
async function Ue(e, t) {
  ...
  if (t.look === `handDrawn`) {
    ...
    ((l = i
      ...
      u && l.attr(`style`, u));
  } else ((l = z(i, o, o, c)), l.attr(`transform`, `translate(${-o / 2 + s}, ${o / 2})`));
  return (
    r && l.attr(`style`, r),
    J(t, l),
    (t.calcIntersect = function (e, t) {
...
async function Ge(e, n) {
  ...
  let g = d || [],
    _ = p.getBBox(),
    v = l.node().appendChild(await Z(g.join ? g.join(`<br/>`) : g, n.labelStyle, !0, !0)),
    y = v.children[0],
    b = h(v);
  ((m = y.getBoundingClientRect()), b.attr(`width`, m.width), b.attr(`height`, m.height));
  let x = (n.padding || 0) / 2;
  (h(v).attr(
    `transform`,
    `translate( ` +
    ...
    h(p).attr(
      `transform`,
      `translate( ` + (m.width < _.width ? 0 : -(_.width - m.width) / 2) + `, 0)`,
    ),
    (m = l.node().getBBox()),
    l.attr(`transform`, `translate(` + -m.width / 2 + `, ` + (-m.height / 2 - x + 3) + `)`));
  ...
  if (n.look === `handDrawn`) {
    ...
    ((O = o.insert(() => (t.debug(`Rough node insert CXC`, i), a), `:first-child`)),
      (E = o.insert(() => (t.debug(`Rough node insert CXC`, i), i), `:first-child`)));
  } else
...
function Qe(e, t, { config: { themeVariables: n } }) {
  ...
  let f = u.circle(0, 0, 14, { ...d, stroke: o, strokeWidth: 2 }),
    p = s ?? c,
    m = u.circle(0, 0, 5, { ...d, fill: p, stroke: p, strokeWidth: 2, fillStyle: `solid` }),
...
async function st(e, n) {
  ...
  let v = P(m),
    y = g.path(v, _),
    b = a.insert(() => y, `:first-child`).attr(`transform`, `translate(${-f / 2}, ${f / 2})`);
  return (
...
async function dt(e, t) {
  ...
  if (n.attributes.length === 0 && t.label) {
    let n = { rx: 0, ry: 0, labelPaddingX: i, labelPaddingY: i * 1.5, classes: `` };
    y(t.label, r) + n.labelPaddingX * 2 < r.er.minEntityWidth && (t.width = r.er.minEntityWidth);
      ...
      e &&
        ...
        r.attr(`class`).includes(`attribute-name`)
          ...
          : r.attr(`class`).includes(`attribute-keys`)
            ? (s += v + b)
            : r.attr(`class`).includes(`attribute-comment`) && (s += v + b + x));
    }
    r.attr(`transform`, `translate(${I + i / 2 + s}, ${c + L + f.height + a / 2})`);
  }),
    d.select(`.name`).attr(`transform`, `translate(` + -f.width / 2 + `, ` + (L + a / 2) + `)`));
...
async function W(e, t, n, r = 0, i = 0, a = [], o = ``) {
  ...
  let c = s
    .node()
    .appendChild(await C(s, t, { width: y(t, n) + 100, style: o, useHtmlLabels: n.htmlLabels }, n));
...
async function G(e, t, r, i = []) {
  ...
  if (l) {
    ...
    ((g = e.innerHTML.split(`<br>`).length),
      e.innerHTML.includes(`</math>`) && (g += e.innerHTML.split(`<mrow>`).length - 1));
            ...
            new Promise((r) => {
              function i() {
                if (((t.style.display = `flex`), (t.style.flexDirection = `column`), e)) {
                  let e = c.fontSize?.toString() ?? window.getComputedStyle(document.body).fontSize,
    ...
    (i.includes(`font-weight: bolder`) && h(f).selectAll(`tspan`).attr(`font-weight`, ``),
      (g = f.children.length));
    let e = f.children[0];
    ((f.textContent === `` || f.textContent.includes(`&gt`)) &&
      ((e.textContent =
        d[0] + d.substring(1).replaceAll(`&gt;`, `>`).replaceAll(`&lt;`, `<`).trim()),
      d[1] === ` ` && (e.textContent = e.textContent[0] + ` ` + e.textContent.substring(1))),
      e.textContent === `undefined` && (e.textContent = ``),
      (p = f.getBBox()));
  }
  return (o.attr(`transform`, `translate(0,` + (-p.height / (2 * g) + r) + `)`), p.height);
}
async function pt(e, t) {
  ...
  let m = o.members.length === 0 && o.methods.length === 0 && !n.class?.hideEmptyMembersBox,
    g = N.svg(s),
    _ = A(t, {});
  ...
  let b = -v / 2,
    ...
    S = g.rectangle(
      b - r,
      x - r - (m ? r : o.members.length === 0 && o.methods.length === 0 ? -r / 2 : 0),
      v + 2 * r,
      y + 2 * r + (m ? r * 2 : o.members.length === 0 && o.methods.length === 0 ? -r : 0),
      _,
    ),
  ...
  s.selectAll(`.text`).each((e, t, n) => {
    ...
    let u = l + x + r - (m ? r : o.members.length === 0 && o.methods.length === 0 ? -r / 2 : 0);
    a || (u -= 4);
    let d = b;
  ...
  let T = s.select(`.annotation-group`).node().getBBox().height - (m ? r / 2 : 0) || 0,
    E = s.select(`.label-group`).node().getBBox().height - (m ? r / 2 : 0) || 0,
    O = s.select(`.members-group`).node().getBBox().height - (m ? r / 2 : 0) || 0;
  ...
  if (m || o.members.length > 0 || o.methods.length > 0) {
    let e = g.line(w.x, T + E + O + x + i * 2 + r, w.x + w.width, T + E + O + x + r + i * 2, _);
    s.insert(() => e)
      .attr(`class`, `divider`)
      .attr(`style`, p);
  }
...
async function mt(e, t) {
  ...
  if (((u += d + 20), o)) {
    let e = await K(c, `${i.requirementId ? `ID: ${i.requirementId}` : ``}`, u, t.labelStyle);
    u += e;
    let n = await K(c, `${i.text ? `Text: ${i.text}` : ``}`, u, t.labelStyle);
    u += n;
    let r = await K(c, `${i.risk ? `Risk: ${i.risk}` : ``}`, u, t.labelStyle);
    ((u += r),
      await K(c, `${i.verifyMethod ? `Verification: ${i.verifyMethod}` : ``}`, u, t.labelStyle));
  } else {
    let e = await K(c, `${a.type ? `Type: ${a.type}` : ``}`, u, t.labelStyle);
    ((u += e), await K(c, `${a.docRef ? `Doc Ref: ${a.docRef}` : ``}`, u, t.labelStyle));
  }
...
async function K(e, t, n, r = ``) {
  ...
  let i = e.insert(`g`).attr(`class`, `label`).attr(`style`, r),
    ...
    l = await C(
      i,
      s(_(t)),
      { width: y(t, a) + 50, classes: `markdown-node-label`, useHtmlLabels: o, style: r },
      a,
    ),
    u;
  if (o) {
  ...
  return (i.attr(`transform`, `translate(${-u.width / 2},${-u.height / 2 + n})`), u.height);
}
async function ht(e, t, { config: n }) {
  ...
  let f = {
    ...
    m;
  d
    ? ({ label: p, bbox: m } = await St(d, (`ticket` in t && t.ticket) || ``, f))
    : ({ label: p, bbox: m } = await St(o, (`ticket` in t && t.ticket) || ``, f));
  let { label: h, bbox: g } = await St(o, (`assigned` in t && t.assigned) || ``, f);
  t.width = a;
  let _ = t?.width || 0,
    ...
    b = -_ / 2,
    x = -y / 2;
  (c.attr(`transform`, `translate(` + (l - _ / 2) + `, ` + (-v - s.height / 2) + `)`),
    p.attr(`transform`, `translate(` + (l - _ / 2) + `, ` + (-v + s.height / 2) + `)`),
    h.attr(
      `transform`,
      `translate(` + (l + _ / 2 - g.width - 20) + `, ` + (-v + s.height / 2) + `)`,
    ));
  let S,
    { rx: C, ry: w } = t,
    { cssStyles: T } = t;
  if (t.look === `handDrawn`) {
    let e = N.svg(o),
      n = A(t, {}),
      r = C || w ? e.path(Q(b, x, _, y, C || 0), n) : e.rectangle(b, x, _, y, n);
    ...
    (T(),
      ...
      (q = n(async (e, t, r) => {
        ...
        let s = e
            ...
            .attr(`class`, a)
            .attr(`id`, t.domId || t.id),
          d = s.insert(`g`).attr(`class`, `label`).attr(`style`, v(t.labelStyle)),
          f;
        ...
        return (
          o
            ? d.attr(`transform`, `translate(` + -m.width / 2 + `, ` + -m.height / 2 + `)`)
          ...
          );
        {
          ...
          for (let n of t) {
            ...
            (t.setAttributeNS(`http://www.w3.org/XML/1998/namespace`, `xml:space`, `preserve`),
              ...
              t.setAttribute(`x`, `0`),
              r ? t.setAttribute(`class`, `title-row`) : t.setAttribute(`class`, `row`),
      ...
      (Ct = n(async (e, n) => {
        ...
        let r = c(),
          ...
          { labelStyles: l, nodeStyles: d, borderStyles: f, backgroundStyles: p } = D(n),
          m = e
            .insert(`g`)
          ...
          v = await C(_, n.label, { style: n.labelStyle, useHtmlLabels: g, isNode: !0 }),
          y = v.getBBox();
        ...
        if (n.look === `handDrawn`) {
          let e = N.svg(m),
            r = A(n, { roughness: 0.7, fill: o, stroke: s, fillWeight: 3, seed: a }),
            i = e.path(Q(S, w, b, x, 0), r);
          ((T = m.insert(() => (t.debug(`Rough node insert CXC`, i), i), `:first-child`)),
            T.select(`path:nth-child(2)`).attr(`style`, f.join(`;`)),
            T.select(`path`).attr(`style`, p.join(`;`).replace(`fill`, `stroke`)));
        } else
        ...
        if (
          (_.attr(`transform`, `translate(${n.x - y.width / 2}, ${n.y - n.height / 2 + O})`), l)
        ) {
          let e = _.select(`span`);
          e && e.attr(`style`, l);
        }
      ...
      (wt = {
        ...
        roundedWithTitle: n(async (e, t) => {
          let n = c(),
            ...
            m = d.append(`rect`),
            g = p.node().appendChild(await Z(t.label, t.labelStyle, void 0, !0)),
            _ = g.getBBox();
          ...
          let v = 0 * t.padding,
            y = v / 2,
            b = (t.width <= _.width + t.padding ? _.width + t.padding : t.width) + v;
        ...
        kanbanSection: n(async (e, n) => {
          ...
          if (n.look === `handDrawn`) {
            let e = N.svg(m),
              r = A(n, { roughness: 0.7, fill: o, stroke: s, fillWeight: 4, seed: a }),
