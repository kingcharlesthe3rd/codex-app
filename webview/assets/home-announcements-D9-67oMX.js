...
import { Gt as p, Ht as m, Wt as h, cn as g } from "./thread-context-inputs.js";
import { f as _, o as v } from "./vscode-api.js";
import { n as y, r as b } from "./react.js";
import { A as x, Hi as S } from "./src-3.js";
...
import { n as Se } from "./app-identity-CNx-Ii8s.js";
...
function dt(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((g = t[1]), (_ = t[2]));
  let v;
  t[3] !== r || t[4] !== o || t[5] !== p || t[6] !== c || t[7] !== u || t[8] !== d || t[9] !== f
    ? ((v = () => {
        if (r == null) return;
        (u(!0), z(p, ee, {}));
        let e = o.model === r.model ? Promise.resolve() : d(r.model, o.reasoningEffort);
        Promise.all([f(h(r)?.id ?? `priority`, `home_banner`), e]).finally(() => {
          (c(!0), u(!1));
        });
      }),
      (t[3] = r),
...
function Q() {
  let e = (0, W.c)(19),
    ...
    v = i?.models,
    b;
  e[0] === v ? (b = e[1]) : ((b = p(v, m)), (e[0] = v), (e[1] = b));
  let x = b,
...
export { kt as t };
//# sourceMappingURL=home-announcements-D9-67oMX.js.map
