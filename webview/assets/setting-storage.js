...
function x(e) {
  return (
    (e.i ||= b()), (e.r ||= b()), (e.c ||= b()), (e.m ||= b()), (e.u ||= b()), (e.f ||= y()), e
  );
}
var S = (e, t, ...n) => t.read(...n),
  ...
  te = (e, t) => {
    ...
    try {
      ...
      ((D = !1), T.n !== ce && le && (o.set(t, T.n), s.add(t), (r = c.c) == null || r.call(c, t)));
    }
  },
  ne = (e, t) => {
    let n = O(e),
      ...
      b = (n, ...r) => {
        ...
        try {
          if (n === t) {
            ...
            (g(e, n, s),
              m(e, n),
              t !== u.n && (++_[0], i.add(n), d(e, n), (o = a.c) == null || o.call(a, n)));
            return;
          } else return p(e, n, ...r);
        } finally {
          v || (l(e), c(e));
  ...
  se = (e, t, n) => {
    ...
    ((o.v = n), delete o.e, (!s || !Object.is(c, o.v)) && (++o.n, g(c) && a(e, c)));
  },
  ce = (e, t) => {
    let n = O(e)[14];
    return h(n(e, t));
...
function k(e, t) {
  ...
  return (
    typeof e == `function` ? (r.read = e) : ((r.init = e), (r.read = _e), (r.write = ve)),
    t && (r.write = t),
    r
  );
}
...
function ot(e) {
  let t = !1,
    ...
    l = () => Qe.isFocused() && (e.networkMode === `always` || nt.isOnline()) && e.canRun(),
    ...
    async fetch(e, t) {
      ...
      (this.options.behavior?.onFetch(a, this),
        ...
        (this.#i = ot({
          ...
          fn: a.fetchFn,
          onCancel: (e) => {
            (e instanceof at && e.revert && this.setState({ ...this.#t, fetchStatus: `idle` }),
              n.abort());
          },
          onFail: (e, t) => {
    ...
    #s(e) {
      ((this.state = ((t) => {
        switch (e.type) {
          ...
          case `fetch`:
            return { ...t, ...lt(t.data, this.options), fetchMeta: e.meta ?? null };
          case `success`:
            let n = {
              ...t,
              data: e.data,
...
var dt = class extends A {
  ...
  getOptimisticResult(e) {
    ...
    return (_t(this, n) && ((this.#r = n), (this.#a = this.options), (this.#i = this.#t.state)), n);
  }
  getCurrentResult() {
    return this.#r;
  }
  ...
  #v(e) {
    (this.#x(),
      (this.#p = e),
      !(M || F(this.options.enabled, this.#t) === !1 || !Me(this.#p) || this.#p === 0) &&
...
function ht(e, t, n, r) {
  return (
    (e !== t || F(r.enabled, e) === !1) && (!n.suspense || e.state.status !== `error`) && gt(e, n)
  );
}
function gt(e, t) {
...
function jt(e, t = (e) => e(At)) {
  ...
  return k(
    (e) => {
      ...
      if (Pt({ result: i, query: t.getCurrentQuery(), throwOnError: r.throwOnError }))
        throw i.error;
      return i;
    },
    (e, t) => {
...
function Zt(e) {
  (Vt(e), Wt(e));
  for (let t of e.retainedScopeEntries.values()) for (let { node: e } of t.values()) Zt(e);
...
function an(e, t) {
  ...
  let n = sn(e) && t?.excludeFieldsFromKey != null ? new Set(t.excludeFieldsFromKey) : void 0;
...
function cn(e, t, n, r) {
  return {
    derived: (i) => {
      let a = k((r) => i((e) => r(e.atom), Object.assign(vn(e.token, t, e, r), { key: n })));
      return (Xt(e, a), zt(e, a, `family-derived`, { debugLabel: r, familyKey: n }), un(e, a));
    },
    family: rn(e, t),
    get: en(t, e),
    signal: (i, a) => {
      let o = k(typeof i == `function` ? i(Object.assign(vn(e.token, t, e), { key: n })) : i),
        s = a?.onMount;
      return (
        s != null &&
          (Xt(e, o),
...
function Tn(e, t, n) {
  ...
  return { queryClient: r.queryClient, queryOptions: t.getOptions(yn(e.chain, r, n)) };
}
function U(e, t, n) {
  let r = Tn(e, t, n);
  return {
...
function Yn({ children: e, scope: t, value: n }) {
  ...
  let u =
      t.retain == null || a == null
        ? void 0
        : Qn({ parentScope: a, providedValue: o, queryClient: i, scope: t, scopeKey: s }),
  ...
  if (
    ...
    let e = p ?? Xn({ parentScope: a, providedValue: o, queryClient: i, scope: t, scopeKey: s }),
      n = xn(r, t);
    (n.set(t.id, e), (c.current = { chain: n, node: e, parent: a, retainedEntry: u }));
  } else c.current.retainedEntry = u;
  (u == null ? Zn({ node: c.current.node, parentScope: a, providedValue: o, queryClient: i }) : d)
...
function Xn({ parentScope: e, providedValue: t, queryClient: n, scope: r, scopeKey: i }) {
  return {
...
function Qn({ parentScope: e, providedValue: t, queryClient: n, scope: r, scopeKey: i }) {
  return (
    e.retainedScopeEntries.get(r)?.get(i) ?? {
      lastUsed: 0,
      mountedCount: 0,
      node: Xn({ parentScope: e, providedValue: t, queryClient: n, scope: r, scopeKey: i }),
    }
  );
}
function $n(e, t) {
...
function ar(e) {
  ...
  if (i.current == null || i.current.node !== n) {
    ...
    ((a.get = o), (a.query = pn(a)), (a.set = l), (a.watch = s), (a.when = c), (i.current = a));
...
var Yr = !!String.prototype.startsWith && `_a`.startsWith(`a`, 1),
  ...
  ni = !0;
try {
  ni = li(`([^\\p{White_Space}\\p{Pattern_Syntax}]*)`, `yu`).exec(`a`)?.[0] === `a`;
} catch {
  ni = !1;
}
var ri = Yr
  ...
  return (
    ...
    (e.prototype.parseMessage = function (e, t, n) {
      for (var r = []; !this.isEOF(); ) {
        ...
        if (i === 123) {
          ...
          (this.bump(), r.push({ type: q.pound, location: J(o, this.clonePosition()) }));
    ...
    (e.prototype.parseTag = function (e, t) {
      ...
      if ((this.bumpSpace(), this.bumpIf(`/>`)))
        return {
          val: { type: q.literal, value: `<${r}/>`, location: J(n, this.clonePosition()) },
          err: null,
        };
      if (this.bumpIf(`>`)) {
    ...
    (e.prototype.tryParseLeftAngleBracket = function () {
      return !this.isEOF() && this.char() === 60 && (this.ignoreTag || !mi(this.peek() || 0))
        ? (this.bump(), `<`)
        : null;
    }),
    ...
    (e.prototype.parseArgument = function (e, t) {
      ...
      if ((this.bump(), this.bumpSpace(), this.isEOF()))
        return this.error(K.EXPECT_ARGUMENT_CLOSING_BRACE, J(n, this.clonePosition()));
      if (this.char() === 125)
        return (this.bump(), this.error(K.EMPTY_ARGUMENT, J(n, this.clonePosition())));
      ...
      switch (this.char()) {
        case 125:
          return (
            this.bump(),
            { val: { type: q.argument, value: r, location: J(n, this.clonePosition()) }, err: null }
          );
        case 44:
          return (
            this.bump(),
            this.bumpSpace(),
            this.isEOF()
              ? this.error(K.EXPECT_ARGUMENT_CLOSING_BRACE, J(n, this.clonePosition()))
    ...
    (e.prototype.parseIdentifierIfPossible = function () {
      var e = this.clonePosition(),
        ...
        n = ui(this.message, t),
        r = t + n.length;
      return (this.bumpTo(r), { value: n, location: J(e, this.clonePosition()) });
    }),
    (e.prototype.parseArgumentOptions = function (e, t, n, r) {
      ...
      switch (a) {
        ...
        case `time`:
          ...
          if (s && ri(s?.style, `::`, 0)) {
            ...
            if (a === `number`) {
              ...
              return u.err
                ? u
                : { val: { type: q.number, value: n, location: p, style: u.val }, err: null };
            } else {
              if (m.length === 0) return this.error(K.EXPECT_DATE_TIME_SKELETON, p);
              var h = m;
              ...
              return {
                val: { type: a === `date` ? q.date : q.time, value: n, location: p, style: d },
                err: null,
              };
            }
          }
        ...
        case `select`:
          ...
          return a === `select`
            ? { val: { type: q.select, value: n, options: ai(y.val), location: b }, err: null }
            : {
                val: {
                  type: q.plural,
                  value: n,
    ...
    (e.prototype.tryParseArgumentClose = function (e) {
      return this.isEOF() || this.char() !== 125
        ? this.error(K.EXPECT_ARGUMENT_CLOSING_BRACE, J(e, this.clonePosition()))
      ...
      for (var e = 0, t = this.clonePosition(); !this.isEOF(); )
        switch (this.char()) {
          case 39:
            ...
            var n = this.clonePosition();
            if (!this.bumpUntil(`'`))
              return this.error(K.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, J(n, this.clonePosition()));
            this.bump();
            break;
          case 123:
            ((e += 1), this.bump());
    ...
    (e.prototype.tryParsePluralOrSelectOptions = function (e, t, n, r) {
      ...
      return o.length === 0
        ? this.error(
            t === `select` ? K.EXPECT_SELECT_ARGUMENT_SELECTOR : K.EXPECT_PLURAL_ARGUMENT_SELECTOR,
            J(this.clonePosition(), this.clonePosition()),
          )
        : this.requiresOtherClause && !a
          ? this.error(K.MISSING_OTHER_CLAUSE, J(this.clonePosition(), this.clonePosition()))
          : { val: o, err: null };
    }),
    (e.prototype.tryParseDecimalInteger = function (e, t) {
      ...
      return i ? ((a *= n), ti(a) ? { val: a, err: null } : this.error(t, s)) : this.error(e, s);
    }),
...
function vi(e) {
  e.forEach(function (e) {
    if ((delete e.location, Cr(e) || wr(e)))
      for (var t in e.options) (delete e.options[t].location, vi(e.options[t].value));
    else
...
function Ci(e) {
  return e.length < 2
    ...
    : e.reduce(function (e, t) {
        var n = e[e.length - 1];
        return (
          !n || n.type !== Z.literal || t.type !== Z.literal ? e.push(t) : (n.value += t.value), e
        );
      }, []);
}
function wi(e) {
...
function Ti(e, t, n, r, i, a, o) {
  if (e.length === 1 && vr(e[0])) return [{ type: Z.literal, value: e[0].value }];
  for (var s = [], c = 0, l = e; c < l.length; c++) {
    ...
    if (Tr(u)) {
      typeof a == `number` && s.push({ type: Z.literal, value: n.getNumberFormat(t).format(a) });
      continue;
    }
    var d = u.value;
    ...
    if (yr(u)) {
      ((!f || typeof f == `string` || typeof f == `number`) &&
        ...
        s.push({ type: typeof f == `string` ? Z.literal : Z.object, value: f }));
      continue;
    }
    if (xr(u)) {
      var p =
        typeof u.style == `string` ? r.date[u.style] : Or(u.style) ? u.style.parsedOptions : void 0;
    ...
    if (Er(u)) {
      ...
      (Array.isArray(_) || (_ = [_]),
        s.push.apply(
          s,
          _.map(function (e) {
            return { type: typeof e == `string` ? Z.literal : Z.object, value: e };
          }),
        ));
    }
    if (Cr(u)) {
      ...
      if (
        ...
        (this.format = function (e) {
          ...
          var n = t.reduce(function (e, t) {
            return (
              !e.length || t.type !== Z.literal || typeof e[e.length - 1] != `string`
                ? e.push(t.value)
        ...
        (this.formatToParts = function (e) {
          return Ti(a.ast, a.locales, a.formatters, a.formats, e, void 0, a.message);
        }),
...
to autofix this issue`,
    ...
    if (Array.isArray(v) && v.length === 1 && v[0].type === q.literal) return v[0].value;
    if (!r && v && typeof v == `string` && !m) return v.replace(/'\{(.*?)\}'/gi, `{$1}`);
    if (((r = l(l({}, m), r || {})), (o = qi(o, p)), (u = qi(u, p)), !v)) {
      if (d === !1 && v === ``) return v;
      if (((!g || (a && a.toLowerCase() !== c.toLowerCase())) && f(new Li(n, a)), g))
        try {
...
`,
  ...
  try {
    ...
    return t(i, o)
      .formatToParts(c)
      .map(function (e) {
        return e.type === `literal` ? e : l(l({}, e), { value: s[e.value] || e.value });
      });
  } catch (e) {
...
var Aa =
  typeof window < `u` && !window.__REACT_INTL_BYPASS_GLOBAL_CONTEXT__
    ? window.__REACT_INTL_CONTEXT__ || (window.__REACT_INTL_CONTEXT__ = R.createContext(null))
...
((Ia.displayName = `FormattedNumberParts`), (Ia.displayName = `FormattedNumberParts`));
function La(e) {
  var t = function (t) {
    var n = Na(),
      r = t.value,
      ...
      s = typeof r == `string` ? new Date(r || 0) : r;
    return i(e === `formatDate` ? n.formatDateToParts(s, a) : n.formatTimeToParts(s, a));
  };
...
var Ka = (function (e) {
  ...
  function t() {
    ...
    return (
      (t.cache = Vi()),
      (t.state = { cache: t.cache, intl: Va(Ga(t.props), t.cache), prevConfig: Ga(t.props) }),
      t
    );
  }
  return (
    ...
    (t.prototype.render = function () {
      return (
        Sa(this.state.intl), R.createElement(ja, { value: this.state.intl }, this.props.children)
      );
    }),
...
var ro = R.createContext(no()),
  ...
  so = ({ result: e, errorResetBoundary: t, throwOnError: n, query: r, suspense: i }) =>
    e.isError &&
    !t.isReset() &&
    !e.isFetching &&
    r &&
...
function po(e, t, n) {
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !M &&
      lo(l, r) &&
      (s ? fo(o, c, i) : a.getQueryCache().get(o.queryHash)?.promise)?.catch(N).finally(() => {
        c.updateResult();
      }),
...
function To(e, t) {
  let n = e.source,
    r = t.location.origin;
  if (!(n == null || n === t) || (n === t && r !== `` && r !== Co && e.origin !== r)) return null;
  let i = e.data;
...
var jo = {
  ...
  No = class e {
    ...
    async sendRequest(e, t, n) {
      ...
      let i = { requestId: r, method: e, url: t, headers: n?.headers, body: n?.body };
...
function Lo(e, t, n) {
  ...
  return In(e, () => ({ ...s, queryFn: () => Vo(t, i, a, void 0, o), queryKey: Fo(t, i, r) }));
}
function Ro(e, t, n) {
  return Mn(e, (e) => {
    let r = n?.(e),
...
function zo(...e) {
  ...
  t[8] !== a || t[9] !== c || t[10] !== n
    ? ((x = async () =>
        (await No.getInstance().post(`vscode://codex/${n}`, JSON.stringify(a), Uo(c))).body),
      (t[8] = a),
      (t[9] = c),
      (t[10] = n),
      (t[11] = x))
...
async function Vo(e, t, n, r, i) {
  let a = (await No.getInstance().post(`vscode://codex/${e}`, JSON.stringify(t), Uo(i), r)).body;
  return n ? n(a) : a;
}
function Ho(e, t) {
  let n = (0, Vn.c)(6),
  ...
  n[0] !== r || n[1] !== e
    ? ((i = async (t) =>
        (await No.getInstance().post(`vscode://codex/${e}`, JSON.stringify(t), Uo(r))).body),
      (n[0] = r),
      (n[1] = e),
      (n[2] = i))
    : (i = n[2]);
...
async function Jo(e, t, n, r) {
  ...
  try {
    ...
    (await i.invalidate(),
      Ao.dispatchMessage(`query-cache-invalidate`, { queryKey: [...i.queryKey] }));
  }
}
function Yo(e, t, n) {
...
async function Xo(e) {
  return (await Bo(`get-setting`, { params: { key: e.key } })).value ?? e.default;
}
