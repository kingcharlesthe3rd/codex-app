...
import { R as r, c as i, o as a, s as o } from "./app-scope.js";
import { f as s, p as c } from "./vscode-api.js";
import { Lr as l } from "./src-4.js";
import { As as u, F as d } from "./app-server-manager-signals.js";
import { t as f } from "./react-dom.js";
import { c as p } from "./lib-1.js";
import { t as m } from "./clsx.js";
import { W as h, a as g, o as _, r as v, w as y } from "./app-shell-state.js";
import { t as b } from "./button.js";
import { n as x } from "./spinner.js";
import { t as S } from "./arrow-up.js";
import { i as C, t as w } from "./route-scope.js";
import { t as T } from "./x.js";
import { c as E, l as D, n as O, t as k, u as A } from "./app-shell-tab-controller.js";
import {
  C as j,
  D as M,
  E as N,
...
import { i as ve } from "./thread-context.js";
import { t as ye } from "./thread-panel-state.js";
import { t as be } from "./check-git-index-for-changes.js";
import { t as xe } from "./use-window-controls-safe-area.js";
import { t as Se } from "./app-shell-ref.js";
import { t as Ce } from "./chat.js";
import { t as we } from "./search.js";
import { d as Te } from "./review-header-toolbar-p.js";
...
import {
  ...
  t as G,
  u as Ae,
} from "./right-panel-composer-overlay-scroll-reserve-B6Ik-236.js";
import { t as je } from "./thread-layout.js";
function Me(e) {
...
function J() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, q.jsx)(`div`, { className: `mr-2 ml-2 h-4 w-px bg-token-border` })), (e[0] = r))
    : (r = e[0]);
  let i;
  e[1] === t
    ? (i = e[2])
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, q.jsx)(T, { className: `size-4 text-token-foreground` })), (e[5] = s))
    : (s = e[5]);
  let c;
  return (
    e[6] !== i || e[7] !== o
...
function Y() {
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, q.jsx)(Ce, { className: `size-4` })), (e[4] = u))
    : (u = e[4]);
  let d;
  e[5] !== i || e[6] !== s || e[7] !== c || e[8] !== l
    ? ((d = (0, q.jsx)(b, {
        className: `-m-0.5 size-6`,
        size: `icon`,
        color: i,
  ...
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, q.jsx)(Te, { className: `size-4` })), (e[14] = _))
    : (_ = e[14]);
  let v;
  e[15] !== f || e[16] !== m || e[17] !== h || e[18] !== g
    ? ((v = (0, q.jsx)(b, {
        className: `-m-0.5 size-6`,
        size: `icon`,
        color: f,
...
function Fe() {
  let e = (0, K.c)(11),
    ...
    u = o(g),
    d;
  e[0] !== r || e[1] !== i || e[2] !== n || e[3] !== l || e[4] !== u || e[5] !== t
    ? ((d = function () {
        let e = C(t.value),
          a = Ie({
            activeTabs: { bottom: r, right: i },
            browserConversationId: e,
            openPanels: { bottom: l, right: u },
          });
        if (e != null && a != null) {
          s.dispatchMessage(`browser-sidebar-command`, {
            conversationId: e,
            browserTabId: a,
        ...
        let o = document.activeElement?.id === `content-search-input`,
          c = o ? void 0 : Re();
        (R(t, o ? (t.get(B) === `conversation` ? `diff` : `conversation`) : n),
          c != null && F(t, c),
          I(t),
...
function Ie({ activeTabs: e, browserConversationId: t, openPanels: n }) {
...
function X() {
  ...
  e[3] === i
    ...
    : ((u = i
        ...
        : (0, q.jsx)(we, { className: `size-4 text-token-foreground` })),
      (e[3] = i),
      (e[4] = u));
  let d;
  e[5] === n
  ...
  e[11] === t
    ...
    : ((g = (e) => {
      ...
      (_ = (e) => {
        if (e.key === `Enter`) {
          (e.preventDefault(), re(t, { shift: e.shiftKey }));
          return;
        }
      ...
      (e[13] = _));
  let v;
  e[14] !== l || e[15] !== s || e[16] !== m || e[17] !== h || e[18] !== g || e[19] !== _
    ? ((v = (0, q.jsx)(`input`, {
...
function Z() {
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, q.jsx)(S, { className: `size-4` })), (e[6] = d))
    : (d = e[6]);
  let f;
  e[7] !== c || e[8] !== l || e[9] !== u
    ? ((f = (0, q.jsx)(b, {
  ...
  e[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, q.jsx)(S, { className: `size-4 rotate-180` })), (e[15] = v))
    : (v = e[15]);
  let y;
  ...
  let x;
  e[20] !== y || e[21] !== f
    ? ((x = (0, q.jsxs)(`div`, { className: `flex items-center gap-3`, children: [f, y] })),
      (e[20] = y),
      (e[21] = f),
      (e[22] = x))
    : (x = e[22]);
  ...
  return (
    e[23] !== s || e[24] !== x
      ? ((C = (0, q.jsx)(`div`, { className: s, children: x })),
        (e[23] = s),
        (e[24] = x),
        (e[25] = C))
      : (C = e[25]),
...
function Q() {
  ...
  let l = n ? `max-h-9 translate-y-0 py-2 opacity-100` : `max-h-0 -translate-y-2 py-0 opacity-0`,
    u;
  e[7] === l
    ? (u = e[8])
    : ((u = m(
  ...
  return (
    e[9] !== c || e[10] !== u
      ? ((d = (0, q.jsx)(`span`, { className: u, children: c })),
        (e[9] = c),
        (e[10] = u),
        (e[11] = d))
      : (d = e[11]),
...
function Be(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, q.jsx)(Pe, { className: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
...
function He() {
  let e = (0, K.c)(8),
    t = xe(),
    n = (0, $.useSyncExternalStore)(Ge, Ke, Ue),
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, q.jsx)(Fe, {})), (e[0] = r))
    : (r = e[0]);
...
function qe(e) {
  ...
  (t[0] === e
    ...
    : ((n = (t) => {
      ...
      (t[1] = n),
      (t[2] = r)),
    c(`toggle-diff-panel`, n, r));
}
function Je({ children: e, onPointerDownOutside: t }) {
  let n = a(w),
    r = (0, $.useContext)(Se),
    i = o(O.activeTab$),
    s = o(h),
    ...
    y = _ !== `hidden`,
    b = _ === `visible`,
    x = _ === `entering` || _ === `exiting`,
    S = x ? u : v;
  f.current = S;
  let C = (0, $.useEffectEvent)(() => {
    t?.();
  });
  if (
    ((0, $.useLayoutEffect)(
      () => () => {
        (De(n), n.get(W) !== 0 && n.set(W, 0));
      },
      [n],
    ),
    (0, $.useLayoutEffect)(() => {
      if (!(!y || r == null))
        return (
          r.style.setProperty(G, `102px`),
          r.style.setProperty(H, `${f.current}px`),
          () => {
            (r.style.removeProperty(G), r.style.removeProperty(H));
          }
        );
    }, [r, y]),
    (0, $.useLayoutEffect)(() => {
      (x || Ae(n, v), !(!y || r == null) && r.style.setProperty(H, `${S}px`));
    }, [x, r, n, y, v, S]),
    (0, $.useEffect)(() => {
      if (!p || !b) return;
      let e = (e) => {
        let t = e.target;
        t instanceof Node && (d.current?.contains(t) || C());
      };
      return (
  ...
  let T = (0, q.jsx)(`div`, {
    ...
    onAnimationEnd: (e) => {
      e.currentTarget === e.target && _ === `entering` && U(n, `entering`);
    },
    onTransitionEnd: (e) => {
      e.currentTarget === e.target && _ === `exiting` && U(n, `exiting`);
    },
    className: m(
    ...
    style: {
      ...
      transform: `translateY(calc(${V}px - var(${H}, 0px)))`,
    },
  ...
  return r == null ? T : (0, ze.createPortal)(T, r);
}
function Ye(e, t) {
  return e ? (t === `entering` ? `entering` : `visible`) : t === `exiting` ? `exiting` : `hidden`;
}
var Xe = i(w, ({ get: e }) => e(_) && e(O.activeTab$)?.tabId === A.DIFF),
  Ze = i(w, ({ get: e }) => e(Xe) && e(P));
function Qe(e) {
  let t = (0, K.c)(46),
    ...
    m = o(de),
    h;
  t[0] === i ? (h = t[1]) : ((h = () => ae(i)), (t[0] = i), (t[1] = h));
  let g;
  (t[2] !== i || t[3] !== l || t[4] !== p
    ? ((g = [i, l, p]), (t[2] = i), (t[3] = l), (t[4] = p), (t[5] = g))
    : (g = t[5]),
    (0, $.useEffect)(h, g));
  let _, v;
  (t[6] !== n || t[7] !== r || t[8] !== i
  ...
  (t[15] !== i || t[16] !== f
    ...
    (0, $.useEffect)(S, C));
  let T;
  t[19] !== s || t[20] !== c.bytesEstimate || t[21] !== c.fileCount || t[22] !== c.lineCount
    ? ((T = () => {
        u(`set-review-pane-snapshot-metrics-for-host`, {
          hostId: s,
      ...
      (t[19] = s),
      (t[20] = c.bytesEstimate),
      (t[21] = c.fileCount),
      (t[22] = c.lineCount),
      (t[23] = T))
    : (T = t[23]);
  let E;
  (t[24] !== s || t[25] !== c ? ((E = [s, c]), (t[24] = s), (t[25] = c), (t[26] = E)) : (E = t[26]),
    (0, $.useEffect)(T, E));
  let D, O;
  (t[27] === s
    ? ((D = t[28]), (O = t[29]))
  ...
  (t[34] === i
    ...
    (0, $.useEffect)(j, M));
  let N;
  t[37] !== s || t[38] !== i || t[39] !== f
    ? ((N = (e) => {
        if (e.hostId !== s || !f || i.value.routeKind !== `local-thread`) return;
        let t = $e(i.value.conversationId, e.notification);
        t.length !== 0 && ue(i, t);
      }),
      (t[37] = s),
      (t[38] = i),
  ...
  let I;
  return (
    t[44] === i ? (I = t[45]) : ((I = [i]), (t[44] = i), (t[45] = I)), (0, $.useEffect)(F, I), null
  );
}
function $e(e, t) {
  if (l(t.params.threadId) !== e) return [];
  let { item: n } = t.params;
...
export { Ne as a, We as i, Je as n, Me as o, qe as r, Qe as t };
