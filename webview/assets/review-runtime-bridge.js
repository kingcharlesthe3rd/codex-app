...
import { c as r, o as i, s as a, z as o } from "./app-scope.js";
import { L as s, Ts as c } from "./app-server-manager-signals.js";
import { f as l, p as u } from "./vscode-api.js";
import { Ur as d } from "./src-2.js";
import { t as f } from "./react-dom.js";
import { l as p } from "./lib.js";
import { t as m } from "./clsx-Cir5-jBH.js";
import { G as h, a as g, o as _, r as v, w as y } from "./app-shell-state.js";
import { t as b } from "./button.js";
import { n as x } from "./spinner.js";
import { t as S } from "./arrow-up.js";
import { t as C } from "./x.js";
import { t as w } from "./search.js";
import { i as T, t as E } from "./route-scope.js";
import { c as D, l as O, n as k, t as A, u as j } from "./app-shell-tab-controller.js";
import {
  A as M,
  At as ee,
  B as N,
...
import { i as Te } from "./thread-context-BQm-6r7t.js";
import { t as U } from "./thread-panel-state.js";
import { t as Ee } from "./check-git-index-for-changes.js";
import { t as De } from "./use-window-controls-safe-area.js";
import { t as Oe } from "./app-shell-ref.js";
import { t as ke } from "./chat.js";
import { t as Ae } from "./globe.js";
import { d as je } from "./review-header-toolbar.js";
import { t as Me } from "./use-command-hotkey.js";
import {
  a as Ne,
  c as W,
  d as G,
...
import { t as Re } from "./thread-layout.js";
function ze(e) {
...
function Ve(e) {
  ...
  t[0] === p
    ...
    : ((m = p
        ...
        : (0, Z.jsx)(w, { className: `size-4 text-token-foreground` })),
      (t[0] = p),
      (t[1] = m));
  let h;
  t[2] !== r || t[3] !== a
...
function He(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Z.jsx)(S, { className: `size-4` })), (t[2] = d))
    : (d = t[2]);
  let f;
  t[3] !== o || t[4] !== s || t[5] !== u
    ? ((f = (0, Z.jsx)(b, {
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Z.jsx)(S, { className: `size-4 rotate-180` })), (t[7] = h))
    : (h = t[7]);
  let g;
  t[8] !== i || t[9] !== a || t[10] !== p
    ? ((g = (0, Z.jsx)(b, {
  ...
  let _;
  t[12] !== f || t[13] !== g
    ? ((_ = (0, Z.jsxs)(`div`, { className: `flex items-center gap-3`, children: [f, g] })),
      (t[12] = f),
      (t[13] = g),
      (t[14] = _))
    : (_ = t[14]);
  ...
  return (
    t[15] !== l || t[16] !== _
      ? ((v = (0, Z.jsx)(`div`, { className: l, children: _ })),
        (t[15] = l),
        (t[16] = _),
        (t[17] = v))
      : (v = t[17]),
...
function We(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(C, { className: `size-4 text-token-foreground` })), (t[1] = a))
    : (a = t[1]);
  let o;
  return (
    t[2] !== n || t[3] !== r
...
function Ge() {
  ...
  e[2] !== r || e[3] !== o || e[4] !== t
    ? ((c = () => {
        (o === `browser` && (L(t, r), Y(r, { type: `close-find` }), z(t, H)), B(t));
      }),
      (e[2] = r),
      (e[3] = o),
      (e[4] = t),
  ...
  return (
    e[6] !== s || e[7] !== c
      ? ((l = (0, Z.jsx)(We, { label: s, onClose: c })), (e[6] = s), (e[7] = c), (e[8] = l))
      : (l = e[8]),
    l
  );
}
function Ke() {
  let e = (0, X.c)(34),
    ...
    s = a(M),
    c;
  e[0] !== r || e[1] !== o || e[2] !== s || e[3] !== t
    ? ((c = (e) => {
        if (o === `browser` && e !== `browser`) {
          (Y(r, { type: `close-find` }), N(t, e), z(t, H));
          return;
        }
        (N(t, e), e === `browser` && s.length > 0 && Y(r, { type: `set-find-query`, query: s }));
      }),
      (e[0] = r),
      (e[1] = o),
      (e[2] = s),
    ...
    : (c = e[4]);
  let l = c,
    u = o === `conversation` ? `ghostActive` : `ghost`,
    d;
  e[5] === l
    ? (d = e[6])
    : ((d = () => {
  ...
  e[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Z.jsx)(ke, { className: `size-4` })), (e[9] = h))
    : (h = e[9]);
  let g;
  e[10] !== u || e[11] !== d || e[12] !== f || e[13] !== m
    ? ((g = (0, Z.jsx)(b, {
        className: `-m-0.5 size-6`,
        size: `icon`,
        color: u,
      ...
      (e[14] = g))
    : (g = e[14]);
  let _ = o === `diff` ? `ghostActive` : `ghost`,
    v;
  e[15] === l
    ? (v = e[16])
    : ((v = () => {
  ...
  e[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, Z.jsx)(je, { className: `size-4` })), (e[19] = S))
    : (S = e[19]);
  let C;
  e[20] !== x || e[21] !== _ || e[22] !== v || e[23] !== y
    ? ((C = (0, Z.jsx)(b, {
        className: `-m-0.5 size-6`,
        size: `icon`,
        color: _,
    ...
    ? ((w =
        r == null
          ...
          : (0, Z.jsx)(b, {
              ...
              children: (0, Z.jsx)(Ae, { className: `size-4` }),
            })),
      (e[25] = r),
      (e[26] = o),
      (e[27] = n),
...
function Je() {
  ...
  e[9] !== h || e[10] !== t
    ? ((_ = () => {
      ...
      (e[11] = _))
    : (_ = e[11]);
  let y = h?.browserTabId,
    b = h?.conversationId,
    x;
  (e[12] !== h || e[13] !== t || e[14] !== y || e[15] !== b
    ? ((x = [h, y, b, t]), (e[12] = h), (e[13] = t), (e[14] = y), (e[15] = b), (e[16] = x))
    : (x = e[16]),
    (0, Q.useEffect)(_, x));
  let S;
  e[17] !== s ||
  ...
  e[24] !== t
    ? ((S = function () {
        let e = Ye({
          ...
          i = document.activeElement?.id === `content-search-input`,
          a = i ? void 0 : Qe(),
          o = i
            ? ae({ currentDomain: t.get(I), hasBrowserTarget: r != null })
            : e == null
              ? n
              : `browser`;
        if (
          (e != null && ue(t, e),
          N(t, o),
          a != null && (o === `browser` ? R(t, a) : pe(t, a)),
          o === `browser`)
        ) {
          let n = a ?? t.get(M);
          n.length > 0 && Y(e ?? r, { type: `set-find-query`, query: n });
        }
        (le(t), window.requestAnimationFrame(Ze));
      }),
      (e[17] = s),
      (e[18] = l),
      (e[19] = p),
  ...
  (e[28] === t
    ...
    : ((D = (e) => {
      ...
      (e[28] = t),
      (e[29] = D)),
    u(`browser-sidebar-find-state`, D));
  let O;
  return (
    e[30] === C
      ? (O = e[31])
...
function Ye({ activeTabs: e, browserConversationId: t, openPanels: n }) {
...
function Xe({ activeTabs: e, browserConversationId: t, openPanels: n, tabs: r }) {
  if (t == null) return null;
  for (let r of U) {
    if (!n[r]) continue;
    let i = D(e[r], t);
...
function $e() {
  ...
  e[6] !== r || e[7] !== o || e[8] !== t
    ? ((m = (e) => {
        if (o === `browser`) {
          (R(t, e), Y(r, { type: `set-find-query`, query: e }));
          return;
        }
        pe(t, e);
      }),
...
function et() {
  let e = (0, X.c)(16),
    ...
    s = a(I),
    c = a(V),
    l = s === `browser` ? r.matches : (c?.totalMatches ?? 0),
    u = a(F),
    d;
  e[0] === n
    ? (d = e[1])
  ...
  let g;
  return (
    e[9] !== u || e[10] !== l || e[11] !== d || e[12] !== f || e[13] !== m || e[14] !== h
      ? ((g = (0, Z.jsx)(He, {
          isVisible: u,
          matches: l,
          nextLabel: d,
...
function $() {
  let e = (0, X.c)(10),
    ...
    l = r === `browser` ? n.activeMatchOrdinal : s == null ? (c > 0 ? 1 : 0) : s + 1,
    u = null;
  if (i && c === 0) {
    let n;
    (e[0] === t
  ...
  return (
    e[7] !== i || e[8] !== u
      ? ((d = (0, Z.jsx)(Ue, { isVisible: i, label: u })), (e[7] = i), (e[8] = u), (e[9] = d))
      : (d = e[9]),
    d
  );
}
...
function nt(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, Z.jsx)(qe, { className: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
...
function it() {
  let e = (0, X.c)(8),
    t = De(),
    n = (0, Q.useSyncExternalStore)(st, ct, at),
    r;
  ...
  e[4] === i
    ? (a = e[5])
    : ((a = (0, Z.jsxs)(Z.Fragment, { children: [r, i] })), (e[4] = i), (e[5] = a));
  let o = a;
  ...
  return (
    e[6] === o
      ? (s = e[7])
      : ((s = (0, tt.createPortal)(o, document.body)), (e[6] = o), (e[7] = s)),
    s
  );
}
function at() {
...
function lt(e) {
  ...
  (t[0] === e
    ...
    : ((n = (t) => {
      ...
      (t[1] = n),
      (t[2] = r)),
    u(`toggle-diff-panel`, n, r));
}
function ut({ children: e, onPointerDownOutside: t }) {
  let n = i(E),
    r = (0, Q.useContext)(Oe),
    o = a(k.activeTab$),
    s = a(h),
    ...
    C = b !== `hidden`,
    w = b === `visible`,
    T = b === `entering` || b === `exiting`,
    D = T ? u : S;
  p.current = D;
  let A = (0, Q.useEffectEvent)(() => {
      t?.();
    }),
    j = (0, Q.useCallback)(() => {
      let e = d.current,
      ...
      _((e) => (e === t ? e : t));
      let i =
        r == null || e == null ? 0 : Math.max(0, r.offsetWidth - e.offsetLeft - e.offsetWidth);
      n.get(W) !== i && n.set(W, i);
    }, [r, n]);
  if (
    ((0, Q.useLayoutEffect)(
      () => () => {
        (Pe(n), n.get(q) !== 0 && n.set(q, 0), n.get(W) !== 0 && n.set(W, 0));
      },
      [n],
    ),
    (0, Q.useLayoutEffect)(() => {
    ...
    (0, Q.useLayoutEffect)(() => {
      if (!(!C || r == null))
        return (
          r.style.setProperty(J, `${g}px`),
          r.style.setProperty(K, `${p.current}px`),
          () => {
            (r.style.removeProperty(J), r.style.removeProperty(K));
          }
        );
    }, [r, g, C]),
    (0, Q.useLayoutEffect)(() => {
      b === `entering` ? G(n, S, { direction: `enter`, shouldAnimate: !0 }) : T || G(n, S);
    }, [b, T, n, S]),
    (0, Q.useLayoutEffect)(() => {
      !C || r == null || r.style.setProperty(K, `${D}px`);
    }, [r, C, D]),
    (0, Q.useEffect)(() => {
      if (!v || !w) return;
      let e = (e) => {
        let t = e.target;
        t instanceof Node && (f.current?.contains(t) || A());
      };
      return (
  ...
  let M = (0, Z.jsx)(`div`, {
    ...
    onAnimationEnd: (e) => {
      e.currentTarget === e.target && b === `entering` && Ne(n, `entering`);
    },
    onTransitionEnd: (e) => {
      e.currentTarget === e.target && b === `exiting` && Ne(n, `exiting`);
    },
    className: m(
    ...
    style: {
      ...
      transform: `translateY(calc(${x}px - var(${K}, 0px)))`,
    },
    children: (0, Z.jsx)(`div`, {
      ...
      children: (0, Z.jsx)(`div`, {
        ref: f,
        className: w ? `pointer-events-auto` : `pointer-events-none`,
        children: e,
      }),
    }),
  });
  return r == null ? M : (0, tt.createPortal)(M, r);
}
function dt(e, t) {
  return e ? (t === `entering` ? `entering` : `visible`) : t === `exiting` ? `exiting` : `hidden`;
}
var ft = r(E, ({ get: e }) => e(_) && e(k.activeTab$)?.tabId === j.DIFF),
  pt = r(E, ({ get: e }) => e(ft) && e(ie));
function mt(e) {
  let t = (0, X.c)(46),
    ...
    m = a(ve),
    h;
  t[0] === o ? (h = t[1]) : ((h = () => re(o)), (t[0] = o), (t[1] = h));
  let g;
  (t[2] !== o || t[3] !== d || t[4] !== p
    ? ((g = [o, d, p]), (t[2] = o), (t[3] = d), (t[4] = p), (t[5] = g))
    : (g = t[5]),
    (0, Q.useEffect)(h, g));
  let _, v;
  (t[6] !== n || t[7] !== r || t[8] !== o
  ...
  (t[15] !== o || t[16] !== f
    ...
    (0, Q.useEffect)(S, C));
  let w;
  t[19] !== l || t[20] !== u.bytesEstimate || t[21] !== u.fileCount || t[22] !== u.lineCount
    ? ((w = () => {
    ...
    : (w = t[23]);
  let T;
  (t[24] !== l || t[25] !== u ? ((T = [l, u]), (t[24] = l), (t[25] = u), (t[26] = T)) : (T = t[26]),
    (0, Q.useEffect)(w, T));
  let D, O;
  (t[27] === l
    ? ((D = t[28]), (O = t[29]))
  ...
  (t[34] === o
    ...
    (0, Q.useEffect)(j, M));
  let N;
  t[37] !== l || t[38] !== o || t[39] !== f
    ? ((N = (e) => {
        if (e.hostId !== l || !f || o.value.routeKind !== `local-thread`) return;
        let t = ht(o.value.conversationId, e.notification);
        t.length !== 0 && ee(o, t);
      }),
      (t[37] = l),
      (t[38] = o),
  ...
  let I;
  return (
    t[44] === o ? (I = t[45]) : ((I = [o]), (t[44] = o), (t[45] = I)), (0, Q.useEffect)(F, I), null
  );
}
function ht(e, t) {
...
export { Be as a, ot as i, ut as n, ze as o, lt as r, mt as t };
