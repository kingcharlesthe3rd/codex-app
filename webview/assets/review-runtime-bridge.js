...
import { N as n, fs as r } from "./app-server-manager-signals.js";
import { n as i, t as a } from "./jsx-runtime.js";
import { t as o } from "./clsx.js";
import { t as s } from "./react-dom.js";
import { F as c, I as l, L as u, f as d, lt as f, p } from "./vscode-api.js";
import { c as m } from "./lib-2.js";
import { i as h, t as g } from "./route-scope.js";
import { t as _ } from "./button.js";
import { n as v } from "./spinner.js";
import { W as y, a as b, o as x, w as S } from "./app-shell-state.js";
import { n as C } from "./app-shell.js";
import { t as w } from "./x.js";
import { c as T, l as E, n as D, s as O } from "./app-shell-tab-controller.js";
import {
  C as k,
  D as A,
  E as j,
...
import { i as _e } from "./thread-context.js";
import { t as ve } from "./check-git-index-for-changes.js";
import { t as ye } from "./use-window-controls-safe-area.js";
import { t as be } from "./chat.js";
import { t as xe } from "./search-C0nm-Ej1.js";
import { t as B } from "./arrow-up.js";
import { d as Se } from "./review-header-toolbar.js";
import { t as Ce } from "./use-command-hotkey.js";
import {
  a as we,
  c as Te,
  i as V,
...
import { t as Oe } from "./thread-layout-B.js";
var K = f(),
  q = a();
function J() {
  let e = (0, K.c)(9),
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, q.jsx)(w, { className: `size-4 text-token-foreground` })), (e[5] = o))
    : (o = e[5]);
  let s;
  return (
    e[6] !== i || e[7] !== a
...
function Y() {
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, q.jsx)(be, { className: `size-4` })), (e[4] = u))
    : (u = e[4]);
  let d;
  ...
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, q.jsx)(Se, { className: `size-4` })), (e[14] = y))
    : (y = e[14]);
  let b;
  ...
  e[0] !== r || e[1] !== n || e[2] !== i || e[3] !== t
    ? ((a = function () {
        ...
        if (
          e != null &&
          a != null &&
          je({ activeRightPanelTab: r, browserConversationId: e, isRightPanelOpen: i })
        ) {
        ...
        let o = document.activeElement?.id === `content-search-input`,
          s = o ? void 0 : Ne();
        (L(t, o ? (t.get(z) === `conversation` ? `diff` : `conversation`) : n),
          s != null && N(t, s),
          P(t),
...
function je({ activeRightPanelTab: e, browserConversationId: t, isRightPanelOpen: n }) {
  let r = O(e, t);
...
function X() {
  ...
  e[3] === i
    ...
    : ((u = i
        ...
        : (0, q.jsx)(xe, { className: `size-4 text-token-foreground` })),
      (e[3] = i),
      (e[4] = u));
  let d;
  e[5] === n
  ...
  e[11] === t
    ...
    : ((_ = (e) => {
      ...
      (y = (e) => {
        ...
        e.key === `Escape` && (e.preventDefault(), R(t));
      }),
      (e[11] = t),
      (e[12] = _),
      (e[13] = y));
...
function Z() {
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, q.jsx)(B, { className: `size-4` })), (e[6] = f))
    : (f = e[6]);
  let p;
  e[7] !== s || e[8] !== u || e[9] !== d
    ? ((p = (0, q.jsx)(_, {
  ...
  e[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, q.jsx)(B, { className: `size-4 rotate-180` })), (e[15] = b))
    : (b = e[15]);
  let x;
  ...
  let S;
  e[20] !== x || e[21] !== p
    ? ((S = (0, q.jsxs)(`div`, { className: `flex items-center gap-3`, children: [p, x] })),
      (e[20] = x),
      (e[21] = p),
      (e[22] = S))
    : (S = e[22]);
...
function Pe() {
  ...
  return (
    e[9] !== c || e[10] !== d
      ? ((f = (0, q.jsx)(`span`, { className: d, children: c })),
        (e[9] = c),
        (e[10] = d),
        (e[11] = f))
      : (f = e[11]),
...
function $(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, q.jsx)(ke, { className: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
...
function Ue({ children: e, onPointerDownOutside: t }) {
  ...
  if (
    ...
    (0, Q.useLayoutEffect)(() => {
      (S || De(n, v), !(!b || r == null) && r.style.setProperty(H, `${w}px`));
    }, [S, r, n, b, v, w]),
    (0, Q.useEffect)(() => {
      if (!m || !x) return;
      let e = (e) => {
...
function qe(e) {
  let t = (0, K.c)(46),
    ...
    m = l(ue),
    h;
  t[0] === o ? (h = t[1]) : ((h = () => ie(o)), (t[0] = o), (t[1] = h));
  let _;
  (t[2] !== o || t[3] !== d || t[4] !== p
