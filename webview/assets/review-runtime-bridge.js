...
import { N as n, Xs as r, er as i } from "./app-server-manager-signals.js";
import { n as a, t as o } from "./jsx-runtime.js";
import { t as s } from "./clsx.js";
import { t as c } from "./react-dom.js";
import { G as l, Q as u, X as d, Z as f, b as p, wt as m, y as h } from "./setting-storage.js";
...
import { n as w } from "./app-shell.js";
import { t as T } from "./x.js";
import { c as E, l as D, n as O, s as k } from "./app-shell-tab-controller.js";
import {
  A,
  C as j,
  Ct as ee,
...
import { t as W } from "./arrow-up.js";
...
import { t as Oe } from "./thread-layout.js";
var X = m(),
  Z = o();
function ke() {
  let e = (0, X.c)(9),
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(`div`, { className: `mr-2 ml-2 h-4 w-px bg-token-border` })), (e[0] = r))
    : (r = e[0]);
  let i;
  e[1] === t
    ? (i = e[2])
  ...
  e[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Z.jsx)(T, { className: `size-4 text-token-foreground` })), (e[5] = o))
    : (o = e[5]);
  let s;
  return (
    e[6] !== i || e[7] !== a
  ...
  e[0] !== r || e[1] !== n || e[2] !== i || e[3] !== t
    ? ((a = function () {
        ...
        if (
          e != null &&
          a != null &&
          Ne({ activeRightPanelTab: r, browserConversationId: e, isRightPanelOpen: i })
        ) {
...
function Ne({ activeRightPanelTab: e, browserConversationId: t, isRightPanelOpen: n }) {
  let r = k(e, t);
...
function Ie() {
  ...
  e[11] === t
    ...
    : ((g = (e) => {
      ...
      (e[13] = v));
  let b;
  e[14] !== s || e[15] !== a || e[16] !== m || e[17] !== h || e[18] !== g || e[19] !== v
    ? ((b = (0, Z.jsx)(`input`, {
...
function Le() {
  ...
  let S;
  e[20] !== x || e[21] !== m
    ? ((S = (0, Z.jsxs)(`div`, { className: `flex items-center gap-3`, children: [m, x] })),
      (e[20] = x),
      (e[21] = m),
      (e[22] = S))
    : (S = e[22]);
...
function $(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, Z.jsx)(je, { className: r, children: n })), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    i
  );
}
...
function Ze(e) {
  ...
  (t[15] !== s || t[16] !== p
    ...
    (0, Q.useEffect)(w, T));
  let E;
  t[19] !== c || t[20] !== l.bytesEstimate || t[21] !== l.fileCount || t[22] !== l.lineCount
    ? ((E = () => {
    ...
    : (E = t[23]);
  let D;
  (t[24] !== c || t[25] !== l ? ((D = [c, l]), (t[24] = c), (t[25] = l), (t[26] = D)) : (D = t[26]),
    (0, Q.useEffect)(E, D));
  let O, k;
  (t[27] === c
    ? ((O = t[28]), (k = t[29]))
  ...
  t[37] !== c || t[38] !== s || t[39] !== p
    ? ((P = (e) => {
        if (e.hostId !== c || !p || s.value.routeKind !== `local-thread`) return;
  ...
  t[41] !== F || t[42] !== s
    ...
    : (I = t[43]);
  let L;
  (t[44] === s ? (L = t[45]) : ((L = [s]), (t[44] = s), (t[45] = L)), (0, Q.useEffect)(I, L));
  let R;
  ...
  let V;
  return (
    t[53] === s ? (V = t[54]) : ((V = [s]), (t[53] = s), (t[54] = V)), (0, Q.useEffect)(B, V), null
  );
}
function Qe(e, n) {
