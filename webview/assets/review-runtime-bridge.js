...
import { I as s, js as c } from "./app-server-manager-signals.js";
import { f as l, p as u } from "./vscode-api.js";
import { Ar as d } from "./src-1.js";
import { t as f } from "./react-dom.js";
import { c as p } from "./lib.js";
...
import { d as Te } from "./review-header-toolbar.js";
...
function Fe() {
  let e = (0, K.c)(11),
    ...
    c = o(g),
    d;
  e[0] !== r || e[1] !== i || e[2] !== n || e[3] !== s || e[4] !== c || e[5] !== t
    ? ((d = function () {
        let e = C(t.value),
          a = Ie({
            activeTabs: { bottom: r, right: i },
            browserConversationId: e,
            openPanels: { bottom: s, right: c },
          });
        if (e != null && a != null) {
...
function Je({ children: e, onPointerDownOutside: t }) {
  let n = a(w),
    ...
    k = E ? u : S;
  p.current = k;
  let A = (0, $.useEffectEvent)(() => {
      t?.();
    }),
    j = (0, $.useCallback)(() => {
      let e = Math.max(102, d.current?.offsetHeight ?? 0);
      _((t) => (t === e ? t : e));
    }, []);
  if (
    ((0, $.useLayoutEffect)(
      () => () => {
        (Oe(n), n.get(U) !== 0 && n.set(U, 0));
      },
      [n],
    ),
    (0, $.useLayoutEffect)(() => {
    ...
    (0, $.useLayoutEffect)(() => {
      if (!(!C || r == null))
        return (
          r.style.setProperty(W, `${g}px`),
          r.style.setProperty(H, `${p.current}px`),
          () => {
            (r.style.removeProperty(W), r.style.removeProperty(H));
          }
        );
    }, [r, g, C]),
    (0, $.useLayoutEffect)(() => {
      b === `entering` ? G(n, S, { direction: `enter`, shouldAnimate: !0 }) : E || G(n, S);
    }, [b, E, n, S]),
    (0, $.useLayoutEffect)(() => {
      !C || r == null || r.style.setProperty(H, `${k}px`);
    }, [r, C, k]),
    (0, $.useEffect)(() => {
      if (!v || !T) return;
      let e = (e) => {
  ...
  let M = (0, q.jsx)(`div`, {
    ...
    onAnimationEnd: (e) => {
      e.currentTarget === e.target && b === `entering` && V(n, `entering`);
    },
    onTransitionEnd: (e) => {
      e.currentTarget === e.target && b === `exiting` && V(n, `exiting`);
    },
    className: m(
    ...
    style: {
      ...
      transform: `translateY(calc(${x}px - var(${H}, 0px)))`,
    },
    children: (0, q.jsx)(`div`, {
      ...
      children: (0, q.jsx)(`div`, {
        ref: f,
        className: T ? `pointer-events-auto` : `pointer-events-none`,
        children: e,
      }),
    }),
  });
  return r == null ? M : (0, ze.createPortal)(M, r);
}
function Ye(e, t) {
