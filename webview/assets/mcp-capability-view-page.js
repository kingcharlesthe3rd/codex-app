...
import { $u as d, Ol as f, Qu as p, kl as m } from "./app-initial~app-main~onboarding-page.js";
function h() {
  let e = (0, _.c)(7),
    { server: t, toolName: n } = o(),
    r = c(s),
    i;
  e[0] !== t || e[1] !== n || e[2] !== r
    ? ((i =
  ...
  let l;
  return (e[5] === a ? (l = e[6]) : ((l = (0, v.jsx)(f, { view: a })), (e[5] = a), (e[6] = l)), l);
}
function g() {
  let e = (0, _.c)(1),
    t;
