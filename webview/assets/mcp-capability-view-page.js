...
import { Tu as d, wu as f } from "./app-initial~app-main~onboarding-page~profile.js";
import {
  P as p,
  R as m,
...
function h() {
  ...
  e[0] !== t || e[1] !== r || e[2] !== a
    ? ((o =
        t == null || r == null
          ? null
          : (a.find((e) => e.server === t && e.tool.name === r) ?? null)),
      (e[0] = t),
      (e[1] = r),
      (e[2] = a),
      (e[3] = o))
  ...
  let c;
  return (e[5] === s ? (c = e[6]) : ((c = (0, v.jsx)(u, { view: s })), (e[5] = s), (e[6] = c)), c);
}
function g() {
  let e = (0, _.c)(1),
    t;
