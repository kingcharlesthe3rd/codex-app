...
import { p as m } from "./sidebar-project-groups-Bs-6klyU.js";
import { n as h, t as g } from "./dist-10.js";
var _ = l(),
  v = e(n(), 1),
  y = e(r(), 1);
function b() {
...
async function C(e, t, n) {
  ...
  return i
    ? i.root
    : (o.warning(`No matching origin found`, { safe: {}, sensitive: { originUrl: e } }),
      t[0] ?? null);
}
function w(e, n) {
  let r = (0, _.c)(15),
  ...
  let o = a,
    c;
  r[4] !== n.source || r[5] !== o
    ? ((c = { params: o, source: n.source }), (r[4] = n.source), (r[5] = o), (r[6] = c))
    : (c = r[6]);
