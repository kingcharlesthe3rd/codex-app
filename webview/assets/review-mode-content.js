...
function we({ reviewInstructions: e, requestMessage: t }) {
  return [y, Se.trim(), e.trim(), ce, t].join(`
`);
}
...
function Ee(e) {
  ...
  t[7] === r
    ? (u = t[8])
    : ((u = (e) => {
        (le.error(`Failed to start quick review conversation`, {
          safe: {},
          sensitive: { error: e },
        }),
          r(e));
  ...
  return (
    t[9] !== c || t[10] !== l || t[11] !== u
      ? ((f = { mutationFn: c, onSuccess: l, onError: u }),
        (t[9] = c),
        (t[10] = l),
        (t[11] = u),
        (t[12] = f))
...
function Le(e) {
  ...
  if (o) {
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Z.jsx)(K, { className: `icon-xs shrink-0 text-token-charts-red` })), (t[0] = e))
      : (e = t[0]);
    let n;
  ...
  t[16] !== i || t[17] !== n || t[18] !== h || t[19] !== g
    ? ((_ = (0, Z.jsx)(Y, { value: `unstaged`, title: h, onSelect: n, disabled: i, RightIcon: g })),
      (t[16] = i),
      (t[17] = n),
      (t[18] = h),
      (t[19] = g),
  ...
  return (
    t[21] !== m || t[22] !== _
      ? ((v = (0, Z.jsxs)(Z.Fragment, { children: [m, _] })), (t[21] = m), (t[22] = _), (t[23] = v))
      : (v = t[23]),
    v
  );
}
function Re(e) {
  return (0, Z.jsx)(`code`, { className: `font-mono`, children: e }, `command`);
}
function ze(e) {
  let t = (0, X.c)(10),
    {
  ...
  t[0] !== r || t[1] !== a || t[2] !== i || t[3] !== c || t[4] !== n || t[5] !== o || t[6] !== s
    ? ((l = i
        ? (0, Z.jsx)(`div`, {
            ...
            children: (0, Z.jsx)(O, { className: `size-3` }),
          })
        : a
          ? (0, Z.jsxs)(`div`, {
  ...
  return (
    t[8] === l
      ? (u = t[9])
      : ((u = (0, Z.jsx)(Z.Fragment, { children: l })), (t[8] = l), (t[9] = u)),
    u
  );
}
var X,
...
function Ve(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[0]);
  let [p, m] = (0, Q.useState)(u),
    h = he(),
    _;
  t[1] === s.id
    ? (_ = t[2])
    : ((_ = { hostId: s.id, source: `review_mode_content` }), (t[1] = s.id), (t[2] = _));
  let { gitRoot: v } = ye(o, _),
    {
      data: y,
      error: b,
      isFetching: x,
      isLoading: S,
      refetch: C,
    } = ge(v, s, `review_mode_content`),
    { data: ne, isLoading: w, isError: re, refetch: T } = je(v, s, `review_mode_content`),
    { data: ie, isLoading: ae, isError: oe, refetch: E } = be(v, s, `review_mode_content`),
    D = ue(ne ?? null),
    O = f(te.reviewDelivery),
    ce = Pe({ currentBranch: y, defaultTargetBranch: D, recentBranches: ie }),
    A = w || ae,
    j = re || oe,
    M;
  t[3] !== T || t[4] !== E
  ...
  t[6] !== l || t[7] !== c
    ? ((P = (e) => {
        (le.error(`Failed to start code review`, { safe: {}, sensitive: { error: e } }),
          c
            .get(I)
            .danger(
              l.formatMessage({
  ...
  t[9] !== n || t[10] !== h || t[11] !== c
    ? ((F = (e) => {
        if ((pe(c, e.diffFilter), e.delivery === `detached`)) {
          (fe(c, e.conversationId, e.baseBranch), h(e.conversationId));
          return;
        }
        fe(c, n, e.baseBranch);
        let t = c.get(de.activeTab$)?.tabId;
        (_e(c, !t?.startsWith(`sidechat:`)), c.set(me, !1));
      }),
      (t[9] = n),
      (t[10] = h),
      (t[11] = c),
  ...
  t[13] !== s.id || t[14] !== P || t[15] !== F
    ? ((L = { hostId: s.id, onError: P, onSuccess: F }),
      (t[13] = s.id),
      (t[14] = P),
      (t[15] = F),
      (t[16] = L))
    : (L = t[16]);
  let { mutate: R, isPending: z, variables: B } = Ee(L),
    V = z && B?.context.mode === `base-branch` ? B.context.baseBranch : null,
    H;
  t[17] !== n ||
  t[18] !== y ||
  t[19] !== o ||
  ...
  t[27] !== R
    ? ((H = (e) => {
        if (!z) {
          ...
          if (e === `base-branch`) {
            (ee(c, i, { target: `base_branch` }), m({ status: `choose-base` }), r());
            return;
          }
          (ee(c, i, { target: `unstaged` }),
            R(
              {
                conversationId: n,
                context: { mode: `uncommitted`, sourceBranch: y ?? `HEAD`, gitRoot: v, cwd: o },
                delivery: O ?? `inline`,
              },
              { onSuccess: a },
            ));
  ...
  if (p.status === `choose-target`) {
    ...
    t[40] === U
      ...
      : ((n = () => U(`unstaged`)),
        ...
        (t[42] = n));
    let r;
    t[43] === b ? (r = t[44]) : ((r = se(b)), (t[43] = b), (t[44] = r));
    let i;
    t[45] === C
      ? (i = t[46])
      : ((i = () => {
...
export { Ve as ReviewModeContent };
