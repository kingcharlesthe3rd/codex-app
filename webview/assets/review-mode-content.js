...
import { C as t } from "./src-C.js";
import { Hn as n, Ji as r, Xs as i, qi as a, tt as o } from "./app-server-manager-signals.js";
...
import "./notion.js";
import { t as v } from "./product-logger.js";
import "./rpc.js";
import "./statsig.js";
import "./request.js";
import { i as y } from "./app-server-manager-hooks-DfDI-9lO.js";
...
import "./proxy.js";
import { V as te } from "./app-shell-state.js";
import "./app-shell.js";
import "./apps.js";
import "./chats.js";
import "./x.js";
...
import { Nt as re, at as ie, wt as S } from "./review-navigation-model.js";
...
import { s as ae } from "./thread-side-panel-tabs-1.js";
...
import { t as se } from "./use-git-current-branch-CZf-kxlj.js";
import "./stop.js";
...
import { a as ce, t as w } from "./slash-command-item.js";
...
function A({ reviewInstructions: e, requestMessage: t }) {
  return [a, D.trim(), e.trim(), r, t].join(`
`);
}
...
function ue(e) {
  let t = (0, T.c)(13),
    ...
    f = y(n),
    m;
  t[0] !== n || t[1] !== f || t[2] !== c || t[3] !== s
    ? ((m = async (e) => {
        let { context: t, conversationId: r, delivery: a } = e,
          { gitRoot: l, cwd: u } = t,
          d = await j({ context: t, hostId: n, intl: c }),
          p = r == null ? null : s.get(o, r);
  ...
  t[7] === r
    ? (_ = t[8])
    : ((_ = (e) => {
        (l.error(`Failed to start quick review conversation`, {
          safe: {},
          sensitive: { error: e },
        }),
          r(e));
...
function pe(e) {
  ...
  let f = i ? x : void 0,
    p;
  t[9] !== n || t[10] !== d || t[11] !== f
    ? ((p = (0, N.jsx)(w, { value: `unstaged`, title: d, onSelect: n, RightIcon: f })),
      (t[9] = n),
      (t[10] = d),
      (t[11] = f),
      (t[12] = p))
  ...
  return (
    t[13] !== l || t[14] !== p
      ? ((m = (0, N.jsxs)(N.Fragment, { children: [l, p] })), (t[13] = l), (t[14] = p), (t[15] = m))
      : (m = t[15]),
    m
  );
}
function me(e) {
  ...
  t[0] !== r || t[1] !== a || t[2] !== i || t[3] !== n || t[4] !== o || t[5] !== s
    ? ((c = i
        ? (0, N.jsx)(`div`, {
            ...
            children: (0, N.jsx)(x, { className: `size-3` }),
          })
        : a
          ? (0, N.jsxs)(`div`, {
  ...
  return (
    t[7] === c
      ? (l = t[8])
      : ((l = (0, N.jsx)(N.Fragment, { children: c })), (t[7] = c), (t[8] = l)),
    l
  );
}
function P(e) {
  ...
  let { gitRoot: D } = ce(o, w),
    { data: O, isLoading: k } = se(D, s, `review_mode_content`),
    { data: A, isLoading: j, isError: M, refetch: P } = de(D, s, `review_mode_content`),
    { data: ge, isLoading: _e, isError: F, refetch: I } = le(D, s, `review_mode_content`),
    ve = ie(A ?? null),
    L = m(t.reviewDelivery),
    ye = fe({ currentBranch: O, defaultTargetBranch: ve, recentBranches: ge }),
    R = j || _e,
    z = M || F,
    B;
  n[3] !== P || n[4] !== I
  ...
  n[6] !== d || n[7] !== c
    ? ((H = (e) => {
        (l.error(`Failed to start code review`, { safe: {}, sensitive: { error: e } }),
          c
            .get(b)
            .danger(
              d.formatMessage({
  ...
  n[9] !== r || n[10] !== _ || n[11] !== c
    ? ((U = (e) => {
        if ((c.set(re, e.diffFilter), e.delivery === `detached`)) {
          (S(c, e.conversationId, e.baseBranch), _(e.conversationId));
          return;
        }
        S(c, r, e.baseBranch);
        let t = c.get(ne.activeTab$)?.tabId;
        (ae(c, !t?.startsWith(`sidechat:`)), c.set(te, !1));
      }),
      (n[9] = r),
      (n[10] = _),
      (n[11] = c),
  ...
  n[26] !== G
    ? ((q = async (e) => {
        ...
        if (e === `base-branch`) {
          (v(c, { eventName: `codex_review_target_selected`, metadata: { target: `base_branch` } }),
            g({ status: `choose-base` }),
            i());
          return;
        }
        (v(c, { eventName: `codex_review_target_selected`, metadata: { target: `unstaged` } }),
          await G({
            conversationId: r,
            context: { mode: `uncommitted`, sourceBranch: O ?? `HEAD`, gitRoot: D, cwd: o },
            delivery: L ?? `inline`,
          }),
          a());
      }),
