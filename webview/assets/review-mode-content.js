...
import { c as ve, s as X } from "./app-initial~app-main~local-conversation-page.js";
import { n as ye, t as be } from "./use-git-recent-branches.js";
var xe,
  Se = e(() => {
...
function Ce({ reviewInstructions: e, requestMessage: t }) {
  return [D, xe.trim(), e.trim(), k, t].join(`
`);
}
async function we({ context: e, hostId: t, intl: n }) {
  ...
  return {
    diffFilter: `branch`,
    prompt: Ce({
      reviewInstructions: De.replaceAll(`{baseBranch}`, e.baseBranch).replaceAll(
        `{mergeBaseSha}`,
        r.mergeBaseSha.trim(),
      ),
      requestMessage: i,
...
function Te(e) {
  ...
  t[0] !== n || t[1] !== l || t[2] !== c || t[3] !== s
    ? ((u = async (e) => {
        let { context: t, conversationId: r, delivery: i } = e,
          { gitRoot: a, cwd: o } = t,
          u = await we({ context: t, hostId: n, intl: c }),
          d = r == null ? null : s.get(ce, r);
        ...
        let f = await L(`start-conversation`, {
          hostId: n,
          input: [{ type: `text`, text: u.prompt, text_elements: [] }],
          cwd: o,
          workspaceRoots: [a],
  ...
  t[7] === r
    ? (f = t[8])
    : ((f = (e) => {
        (i.error(`Failed to start quick review conversation`, {
          safe: {},
          sensitive: { error: e },
        }),
          r(e));
  ...
  return (
    t[9] !== u || t[10] !== d || t[11] !== f
      ? ((h = { mutationFn: u, onSuccess: d, onError: f }),
        (t[9] = u),
        (t[10] = d),
        (t[11] = f),
        (t[12] = h))
...
function Ie(e) {
  ...
  if (o) {
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(E, { className: `icon-xs shrink-0 text-token-charts-red` })), (t[0] = e))
      : (e = t[0]);
    let n;
  ...
  t[16] !== i || t[17] !== n || t[18] !== m || t[19] !== h
    ? ((g = (0, Q.jsx)(X, { value: `unstaged`, title: m, onSelect: n, disabled: i, RightIcon: h })),
      (t[16] = i),
      (t[17] = n),
      (t[18] = m),
      (t[19] = h),
  ...
  t[0] !== r || t[1] !== a || t[2] !== i || t[3] !== c || t[4] !== n || t[5] !== o || t[6] !== s
    ? ((l = i
        ? (0, Q.jsx)(`div`, {
            ...
            children: (0, Q.jsx)(V, { className: `size-3` }),
          })
        : a
          ? (0, Q.jsxs)(`div`, {
...
function Be(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[0]);
  let [d, m] = (0, Ue.useState)(u),
    h = ge(),
    g;
  t[1] === s.id
    ? (g = t[2])
    : ((g = { hostId: s.id, source: `review_mode_content` }), (t[1] = s.id), (t[2] = g));
  let { gitRoot: _ } = _e(o, g),
    {
      data: v,
      error: y,
      isFetching: b,
      isLoading: x,
      refetch: C,
    } = ae(_, s, `review_mode_content`),
    { data: ie, isLoading: w, isError: T, refetch: E } = Ae(_, s, `review_mode_content`),
    { data: se, isLoading: ce, isError: ue, refetch: D } = ye(_, s, `review_mode_content`),
    O = te(ie ?? null),
    k = he(f.reviewDelivery),
    de = Ne({ currentBranch: v, defaultTargetBranch: O, recentBranches: se }),
    A = w || ce,
    j = T || ue,
    M;
  t[3] !== E || t[4] !== D
  ...
  t[6] !== l || t[7] !== c
    ? ((P = (e) => {
        (i.error(`Failed to start code review`, { safe: {}, sensitive: { error: e } }),
          c
            .get(q)
            .danger(
              l.formatMessage({
  ...
  t[9] !== n || t[10] !== h || t[11] !== c
    ? ((F = (e) => {
        if ((re(c, e.diffFilter), e.delivery === `detached`)) {
          (S(c, e.conversationId, e.baseBranch), h(e.conversationId));
          return;
        }
        S(c, n, e.baseBranch);
        let t = c.get(oe.activeTab$)?.tabId;
        (ee(c, !t?.startsWith(`sidechat:`)), c.set(ne, !1));
      }),
      (t[9] = n),
      (t[10] = h),
      (t[11] = c),
  ...
  t[13] !== s.id || t[14] !== P || t[15] !== F
    ? ((I = { hostId: s.id, onError: P, onSuccess: F }),
      ...
      (t[16] = I))
    : (I = t[16]);
  let { mutate: L, isPending: R, variables: B } = Te(I),
    V = R && B?.context.mode === `base-branch` ? B.context.baseBranch : null,
    H;
  t[17] !== n ||
  t[18] !== v ||
  t[19] !== o ||
  ...
  t[27] !== L
    ? ((H = (e) => {
        if (!R) {
          ...
          if (e === `base-branch`) {
            (pe(c, fe, { target: `base_branch` }), m({ status: `choose-base` }), r());
            return;
          }
          (pe(c, fe, { target: `unstaged` }),
            L(
              {
                conversationId: n,
                context: { mode: `uncommitted`, sourceBranch: v ?? `HEAD`, gitRoot: _, cwd: o },
                delivery: k ?? `inline`,
              },
              { onSuccess: a },
            ));
  ...
  if (d.status === `choose-target`) {
    ...
    t[40] === U
      ...
      : ((n = () => U(`unstaged`)),
        ...
        (t[42] = n));
    let r;
    t[43] === y ? (r = t[44]) : ((r = le(y)), (t[43] = y), (t[44] = r));
    let i;
    t[45] === C
      ? (i = t[46])
      : ((i = () => {
