...
import { c as ve, s as X } from "./app-initial~app-main~local-conversation-page-D.js";
...
function Be(e) {
  let t = (0, He.c)(63),
    { conversationId: n, onItemsChanged: i, onClose: a, cwd: s, hostConfig: c } = e,
    l = o(pe),
    u = N(),
    d;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  t[1] === c.id
    ? (g = t[2])
    : ((g = { hostId: c.id, source: `review_mode_content` }), (t[1] = c.id), (t[2] = g));
  let { gitRoot: _ } = _e(s, g),
    ...
    { data: ae, isLoading: C, isError: se, refetch: w } = Ae(_, c, `review_mode_content`),
    { data: ce, isLoading: E, isError: D, refetch: O } = ye(_, c, `review_mode_content`),
    de = ie(ae ?? null),
  ...
  t[6] !== u || t[7] !== l
    ? ((I = (e) => {
        (r.error(`Failed to start code review`, { safe: {}, sensitive: { error: e } }),
          l
            .get(T)
            .danger(
              u.formatMessage({
  ...
  t[27] !== z
    ? ((U = (e) => {
        if (!B) {
          ...
          if (e === `base-branch`) {
            (ue(l, P, { target: `base_branch` }), p({ status: `choose-base` }), i());
            return;
          }
          (ue(l, P, { target: `unstaged` }),
            z(
              {
                conversationId: n,
                context: { mode: `uncommitted`, sourceBranch: v ?? `HEAD`, gitRoot: _, cwd: s },
                delivery: k ?? `inline`,
              },
              { onSuccess: a },
            ));
