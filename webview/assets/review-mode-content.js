...
function Ce({ reviewInstructions: e, requestMessage: t }) {
  return [E, xe.trim(), e.trim(), z, t].join(`
`);
}
...
function Te(e) {
  ...
  t[0] !== n || t[1] !== s || t[2] !== o || t[3] !== a
    ? ((c = async (e) => {
        let { context: t, conversationId: r, delivery: i } = e,
          { gitRoot: c, cwd: l } = t,
          u = await we({ context: t, hostId: n, intl: o }),
          d = r == null ? null : a.get(_, r);
        if (i === `inline` && r != null && d === n) {
          if (s == null) throw Error(`Code review host is unavailable`);
          return (
            await T(`start-turn-for-host`, {
              hostId: s.getHostId(),
              conversationId: r,
              params: {
                cwd: l,
  ...
  t[7] === r
    ? (u = t[8])
    : ((u = (e) => {
        (m.error(`Failed to start quick review conversation`, {
          safe: {},
          sensitive: { error: e },
        }),
          r(e));
...
function Ie(e) {
  ...
  if (o) {
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(K, { className: `icon-xs shrink-0 text-token-charts-red` })), (t[0] = e))
      : (e = t[0]);
    let n;
  ...
  t[16] !== i || t[17] !== n || t[18] !== h || t[19] !== g
    ? ((_ = (0, Q.jsx)(X, { value: `unstaged`, title: h, onSelect: n, disabled: i, RightIcon: g })),
      (t[16] = i),
      (t[17] = n),
      (t[18] = h),
      (t[19] = g),
  ...
  return (
    t[21] !== m || t[22] !== _
      ? ((v = (0, Q.jsxs)(Q.Fragment, { children: [m, _] })), (t[21] = m), (t[22] = _), (t[23] = v))
      : (v = t[23]),
    v
  );
}
  ...
  t[0] !== r || t[1] !== a || t[2] !== i || t[3] !== c || t[4] !== n || t[5] !== o || t[6] !== s
    ? ((l = i
        ? (0, Q.jsx)(`div`, {
            ...
            children: (0, Q.jsx)(M, { className: `size-3` }),
          })
        : a
          ? (0, Q.jsxs)(`div`, {
...
function Be(e) {
  let t = (0, He.c)(63),
    { conversationId: n, onItemsChanged: r, onClose: i, cwd: a, hostConfig: o } = e,
    c = ie(re),
    l = x(),
    u;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[0]);
  let [d, f] = (0, Ue.useState)(u),
    p = ce(),
    h;
  t[1] === o.id
    ? (h = t[2])
    : ((h = { hostId: o.id, source: `review_mode_content` }), (t[1] = o.id), (t[2] = h));
  let { gitRoot: g } = ve(a, h),
    {
      data: _,
      error: v,
      isFetching: y,
      isLoading: b,
      refetch: S,
    } = me(g, o, `review_mode_content`),
    { data: C, isLoading: w, isError: T, refetch: E } = Ae(g, o, `review_mode_content`),
    { data: ae, isLoading: O, isError: oe, refetch: k } = ye(g, o, `review_mode_content`),
    le = pe(C ?? null),
    A = ne(de.reviewDelivery),
    ue = Ne({ currentBranch: _, defaultTargetBranch: le, recentBranches: ae }),
    j = w || O,
    M = T || oe,
    N;
  t[3] !== E || t[4] !== k
  ...
  t[6] !== l || t[7] !== c
    ? ((F = (e) => {
        (m.error(`Failed to start code review`, { safe: {}, sensitive: { error: e } }),
          c
            .get(I)
            .danger(
              l.formatMessage({
  ...
  t[9] !== n || t[10] !== p || t[11] !== c
    ? ((L = (e) => {
        if ((ge(c, e.diffFilter), e.delivery === `detached`)) {
          (he(c, e.conversationId, e.baseBranch), p(e.conversationId));
          return;
        }
        he(c, n, e.baseBranch);
        let t = c.get(ee.activeTab$)?.tabId;
        (fe(c, !t?.startsWith(`sidechat:`)), c.set(se, !1));
      }),
      (t[9] = n),
      (t[10] = p),
      (t[11] = c),
    ...
    : (L = t[12]);
  let R;
  t[13] !== o.id || t[14] !== F || t[15] !== L
    ? ((R = { hostId: o.id, onError: F, onSuccess: L }),
      (t[13] = o.id),
      (t[14] = F),
      (t[15] = L),
      (t[16] = R))
  ...
  t[27] !== z
    ? ((U = (e) => {
        if (!B) {
          ...
          if (e === `base-branch`) {
            (te(c, D, { target: `base_branch` }), f({ status: `choose-base` }), r());
            return;
          }
          (te(c, D, { target: `unstaged` }),
            z(
              {
                conversationId: n,
                context: { mode: `uncommitted`, sourceBranch: _ ?? `HEAD`, gitRoot: g, cwd: a },
                delivery: A ?? `inline`,
              },
              { onSuccess: i },
            ));
  ...
  if (d.status === `choose-target`) {
    ...
    t[40] === W
      ...
      : ((n = () => W(`unstaged`)),
        ...
        (t[42] = n));
    let r;
    t[43] === v ? (r = t[44]) : ((r = s(v)), (t[43] = v), (t[44] = r));
    let i;
    t[45] === S
      ? (i = t[46])
      : ((i = () => {
