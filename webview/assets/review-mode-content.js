...
import { Bn as l, Qn as u, vt as d } from "./thread-context-inputs.js";
import { _ as f, h as p, n as m } from "./vscode-api.js";
import "./isEqual.js";
import { w as h } from "./src-3.js";
import "./client.js";
import "./react-dom.js";
...
import { u as ne } from "./thread-side-panel-tabs-1.js";
import "./platform.js";
import { f as re } from "./persisted-signal.js";
import { i as C } from "./app-server-manager-hooks.js";
...
/* empty css                    */ import "./thread-side-panel-active-signals.js";
  ...
  if (f.status === `choose-target`) {
    ...
    t[40] === J
      ...
      : ((n = () => J(`unstaged`)),
        ...
        (t[42] = n));
    let r;
    t[43] === w ? (r = t[44]) : ((r = u(w)), (t[43] = w), (t[44] = r));
    let i;
    t[45] === O
      ? (i = t[46])
      : ((i = () => {
