...
import { g as o, m as s, n as c } from "./vscode-api.js";
import "./isEqual.js";
import { C as l } from "./src-4.js";
import {
  As as u,
  Ea as d,
  Ta as f,
...
import { fr as _, o as v } from "./persisted-signal.js";
import "./proxy.js";
import { W as ee } from "./app-shell-state.js";
import "./app-shell.js";
import "./button.js";
...
import { a as le, t as w } from "./slash-command-item-D6wU-Usp.js";
...
function k({ reviewInstructions: e, requestMessage: t }) {
  return [f, E.trim(), e.trim(), d, t].join(`
`);
}
...
function fe(e) {
  let t = (0, T.c)(13),
    { hostId: n, onError: r, onSuccess: c } = e,
    l = i(a),
    d = h(),
    f = b(n),
    m;
  t[0] !== n || t[1] !== f || t[2] !== d || t[3] !== l
    ? ((m = async (e) => {
        let { context: t, conversationId: r, delivery: i } = e,
          { gitRoot: a, cwd: o } = t,
          s = await A({ context: t, hostId: n, intl: d }),
          c = r == null ? null : l.get(p, r);
        if (i === `inline` && r != null && c === n) {
          if (f == null) throw Error(`Code review host is unavailable`);
          return (
            await u(`start-turn-for-host`, {
              ...
              params: {
                ...
                serviceTier: await C(l, n, null),
              },
            }),
            { delivery: `inline`, diffFilter: s.diffFilter, baseBranch: s.baseBranch }
          );
        }
        let m = await u(`start-conversation`, {
          hostId: n,
          input: [{ type: `text`, text: s.prompt, text_elements: [] }],
          cwd: o,
          workspaceRoots: [a],
  ...
  t[7] === r
    ? (_ = t[8])
    : ((_ = (e) => {
        (s.error(`Failed to start quick review conversation`, {
          safe: {},
          sensitive: { error: e },
        }),
          r(e));
...
function N(e) {
  let t = (0, T.c)(56),
    { conversationId: n, onItemsChanged: r, onClose: a, cwd: o, hostConfig: c } = e,
    u = i(re),
    d = h(),
    f;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (f = t[0]);
  let [p, m] = (0, de.useState)(f),
    g = se(),
    y;
  t[1] === c.id
    ? (y = t[2])
    : ((y = { hostId: c.id, source: `review_mode_content` }), (t[1] = c.id), (t[2] = y));
  let { gitRoot: b } = le(o, y),
    { data: C, isLoading: w } = ce(b, c, `review_mode_content`),
    { data: E, isLoading: D, isError: O, refetch: k } = pe(b, c, `review_mode_content`),
    { data: A, isLoading: j, isError: N, refetch: P } = ue(b, c, `review_mode_content`),
    ve = oe(E ?? null),
    F = te(l.reviewDelivery),
  ...
  t[6] !== d || t[7] !== u
    ? ((B = (e) => {
        (s.error(`Failed to start code review`, { safe: {}, sensitive: { error: e } }),
          u
            .get(x)
            .danger(
              d.formatMessage({
  ...
  t[9] !== n || t[10] !== g || t[11] !== u
    ? ((V = (e) => {
        if ((ae(u, e.diffFilter), e.delivery === `detached`)) {
          (S(u, e.conversationId, e.baseBranch), g(e.conversationId));
          return;
        }
        S(u, n, e.baseBranch);
        let t = u.get(ie.activeTab$)?.tabId;
        (ne(u, !t?.startsWith(`sidechat:`)), u.set(ee, !1));
      }),
      (t[9] = n),
      (t[10] = g),
      (t[11] = u),
    ...
    : (V = t[12]);
  let H;
  t[13] !== c.id || t[14] !== B || t[15] !== V
    ? ((H = { hostId: c.id, onError: B, onSuccess: V }),
      (t[13] = c.id),
      (t[14] = B),
      (t[15] = V),
      (t[16] = H))
  ...
  t[27] !== U
    ? ((q = (e) => {
        if (!W) {
          ...
          if (e === `base-branch`) {
            (v(u, _, { target: `base_branch` }), m({ status: `choose-base` }), r());
            return;
          }
          (v(u, _, { target: `unstaged` }),
            U(
              {
                conversationId: n,
