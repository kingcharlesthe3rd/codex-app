...
function Ie(e) {
  ...
  if (o) {
    ...
    t[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, Q.jsx)(v, { className: `icon-xs shrink-0 text-token-charts-red` })), (t[0] = e))
      : (e = t[0]);
    let n;
...
function Be(e) {
  let t = (0, He.c)(63),
    { conversationId: n, onItemsChanged: r, onClose: i, cwd: o, hostConfig: s } = e,
    u = c(ue),
    d = W(),
    f;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let { gitRoot: v } = _e(o, g),
    { data: y, error: b, isFetching: x, isLoading: S, refetch: C } = _(v, s, `review_mode_content`),
    { data: ae, isLoading: oe, isError: w, refetch: T } = Ae(v, s, `review_mode_content`),
    { data: E, isLoading: ce, isError: le, refetch: D } = ye(v, s, `review_mode_content`),
    O = ie(ae ?? null),
  ...
  t[6] !== d || t[7] !== u
    ? ((P = (e) => {
        (a.error(`Failed to start code review`, { safe: {}, sensitive: { error: e } }),
          u
            .get(V)
            .danger(
              d.formatMessage({
  ...
  t[27] !== L
    ? ((H = (e) => {
        if (!R) {
          ...
          if (e === `base-branch`) {
            (pe(u, me, { target: `base_branch` }), m({ status: `choose-base` }), r());
            return;
          }
