import { Z as e, _ as t, c as n, g as r, m as i, o as a, t as o } from "./app-scope-CWE-zIhQ.js";
import { Yt as s } from "./use-host-config.js";
import { Ea as ee } from "./thread-context-inputs.js";
import { a as c, l } from "./persisted-atom-store.js";
import { t as u } from "./persisted-atom.js";
import { t as d } from "./v4.js";
import { f, t as p } from "./persisted-signal.js";
import { a as te, o as m } from "./codex-api-C.js";
import { o as h, r as g, u as _ } from "./prompt-text.js";
...
function T(e, t) {
  for (let n of e.assistantTurns) {
    ...
    let r = e.children[n.id] ? T(e.children[n.id], t) : null;
    if (r) return [n.id, ...r];
  }
  return null;
}
var E = i(f, ({ scope: e }) => te(e.value.routeKind === `remote-thread` ? e.value.taskId : null)),
  D = i(f, ({ scope: e }) => m(e.value.routeKind === `remote-thread` ? e.value.taskId : null)),
  O = t(o, (e) => !1),
  k = n(f, ({ get: e }) => {
    let { data: t } = e(E);
    return b({
...
var ie = n(f, ({ get: e }) => {
  ...
  F = e(),
  ae = u(`last-used-continue-in-mode`, `local`);
function oe(e) {
  return e === `remote` ? `local` : e;
}
var se = p(`last-used-continue-in-mode`, `local`),
  I = p(`environment`, null),
  L = p(`composer-auto-context-enabled`, !0),
  R = `composer-prompt-drafts-v1`,
  z = {},
  B = p(R, z),
  V = t(o, (e) => void 0),
  H = t(o, (e) => []),
  U = n(o, ({ get: e }) => e(B) ?? c(R, z)),
  W = r(
    h,
    ({ scope: e }) => {
      if (e.value.kind !== `local`) return;
      let t = e.get(V, e.value.conversationId);
    ...
    },
    {
      onMount(e, t) {
        ...
        let { conversationId: n } = t.value,
          r = t.get(V, n);
        return (
          r != null && (e(Q(r)), $(t, r.prompt), t.set(V, n, void 0)),
          t.watch(({ get: e }) => {
            let r = e(H, n);
            r.length !== 0 &&
              (X(t, (e) => {
  ...
  K = n(h, ({ get: e, scope: t }) => {
    ...
    switch (r.kind) {
      case `file`:
        return { ...n, fileAttachments: s([...n.fileAttachments, r.file]) };
      case `image`: {
        let { image: e } = r;
        return { ...n, imageAttachments: [...n.imageAttachments.filter((t) => t.id !== e.id), e] };
      }
    }
  }),
  ce = n(h, ({ get: e }) => e(K).composerMode),
  q = n(h, ({ get: e, scope: t }) => {
    if (t.value.kind === `local`) {
      let n = e(V, t.value.conversationId);
      if (n != null) return n.prompt;
    }
    return e(U)[_(t.value)] ?? ``;
  }),
  le = n(h, ({ get: e }) => g(e(q))),
  ue = n(h, ({ get: e }) => ({ ...e(K), prompt: e(q) })),
  de = n(h, ({ get: e }) => e(K).pendingThreadGoalObjective),
  fe = n(h, ({ get: e }) => e(K).aeonStartTarget),
  pe = n(h, ({ get: e }) => e(K).isAutoContextOn),
  me = n(h, ({ get: e }) => e(K).imageAttachments),
  he = n(h, ({ get: e }) => e(K).appshotContexts),
  ge = n(h, ({ get: e }) => e(K).fileAttachments),
  _e = n(h, ({ get: e }) => e(K).pastedTextAttachments),
  ve = n(h, ({ get: e }) => e(K).addedFiles),
  ye = n(h, ({ get: e }) => e(K).commentAttachments),
  be = n(h, ({ get: e }) => e(K).mcpAppModelContextAttachments),
  xe = n(h, ({ get: e }) => e(K).selectedTextAttachments),
  Se = n(h, ({ get: e }) => e(K).pullRequestChecks),
  Ce = n(h, ({ get: e }) => e(K).pullRequestMergeConflict),
  we = n(h, ({ get: e }) => e(K).asyncThreadStartingState),
  Te = n(h, ({ get: e }) => e(K).followUpCloudStartingState),
  J = n(h, ({ get: e }) => e(K).defaultBranchSnapshot);
function Y(e, t) {
  let n = e.get(q),
...
function ke(e, t, n) {
  let r = n.trim();
  r.length !== 0 && e.set(H, t, (e) => [...e, { id: d(), text: r }]);
}
function Ae(e) {
  let t = (0, F.c)(3),
    n = a(h),
...
function je(e) {
  ...
  return (
    t[0] !== e || t[1] !== n
      ? ((r = (t) => {
          n.value.kind !== `local` || n.value.conversationId !== e || Me(n, t);
        }),
        (t[0] = e),
        (t[1] = n),
        (t[2] = r))
