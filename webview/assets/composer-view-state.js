...
import { Ns as s } from "./app-server-manager-signals.js";
import { Br as ee, Wr as c, t as l } from "./persisted-signal.js";
import { t as u } from "./persisted-atom.js";
import { t as d } from "./v4.js";
import { a as f, o as p } from "./codex-api.js";
import { t as m } from "./route-scope.js";
import { l as h, o as g, r as te } from "./prompt-text.js";
import { n as ne } from "./use-environment.js";
function _(e) {
  return `input_items` in e;
}
function v({ taskTurns: e, fallbackUserTurn: t, fallbackAssistantTurn: n }) {
  let r = new Map();
  return (
...
var S = a(m, ({ scope: e }) => f(e.value.routeKind === `remote-thread` ? e.value.taskId : null)),
  C = a(m, ({ scope: e }) => p(e.value.routeKind === `remote-thread` ? e.value.taskId : null)),
  w = r(m, null),
  T = n(o, (e) => !1),
  E = t(m, ({ get: e }) => {
    let { data: t } = e(S);
  ...
  D = t(m, ({ get: e }) => {
    ...
    if (t != null) return t;
    let { data: n } = e(S);
    return n?.current_assistant_turn?.id ?? b(e(E));
  }),
  O = t(m, ({ get: e }) => {
    let t = e(D);
    if (t == null) return null;
    let n = e(E).find((e) => e.id === t);
    return n == null || _(n) ? null : n;
  }),
  k = t(m, ({ get: e }) => {
    let t = e(D);
    return t == null ? !1 : e(T, t);
  });
function A(e, t) {
  e.set(w, t);
}
...
var re = t(m, ({ get: e }) => {
    ...
    if (!(t == null || n == null))
      return {
        type: `cloud`,
        hasAppliedCodeLocally: e(k),
        taskDetails: t,
        selectedTurnId: n,
        selectedTurn: e(O) ?? void 0,
      };
  }),
  N = t(g, ({ get: e, scope: t }) => {
    switch (t.value.kind) {
  ...
  P = e(),
  ie = u(`last-used-continue-in-mode`, `local`);
function F(e) {
  return e === `remote` ? `local` : e;
}
var I = l(`last-used-continue-in-mode`, `local`),
  L = l(`environment`, null),
  R = l(`composer-auto-context-enabled`, !0),
  z = `composer-prompt-drafts-v1`,
  B = {},
  V = l(z, B),
  H = n(o, (e) => void 0),
  U = n(o, (e) => []),
  W = t(o, ({ get: e }) => e(V) ?? ee(z, B)),
  G = r(
    g,
    ({ scope: e }) => {
  ...
  ae = t(g, ({ get: e }) => te(e(Y))),
  oe = t(g, ({ get: e }) => ({ ...e(q), prompt: e(Y) })),
  se = t(g, ({ get: e }) => e(q).pendingThreadGoalObjective),
  ce = t(g, ({ get: e }) => e(q).isAutoContextOn),
  le = t(g, ({ get: e }) => e(q).imageAttachments),
  ue = t(g, ({ get: e }) => e(q).appshotContexts),
  de = t(g, ({ get: e }) => e(q).fileAttachments),
  fe = t(g, ({ get: e }) => e(q).pastedTextAttachments),
  pe = t(g, ({ get: e }) => e(q).addedFiles),
  me = t(g, ({ get: e }) => e(q).commentAttachments),
  he = t(g, ({ get: e }) => e(q).mcpAppModelContextAttachments),
  ge = t(g, ({ get: e }) => e(q).selectedTextAttachments),
  _e = t(g, ({ get: e }) => e(q).pullRequestChecks),
  ve = t(g, ({ get: e }) => e(q).pullRequestMergeConflict),
  ye = t(g, ({ get: e }) => e(q).asyncThreadStartingState),
  be = t(g, ({ get: e }) => e(q).followUpCloudStartingState),
  xe = t(g, ({ get: e }) => e(q).defaultBranchSnapshot);
function Se(e, t) {
  let n = e.get(Y),
...
function Te(e, t, n) {
  let r = n.trim();
  r.length !== 0 && e.set(U, t, (e) => [...e, { id: d(), text: r }]);
}
function Ee(e) {
  let t = (0, P.c)(3),
    n = i(g),
