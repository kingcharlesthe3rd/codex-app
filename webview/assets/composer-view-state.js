import { Hs as e, Ps as t, kt as n, qs as r, zs as i } from "./app-server-manager-signals.js";
import { t as a } from "./v4.js";
import { Q as o, S as s, X as c, at as l, ot as u, rt as d, wt as f } from "./setting-storage.js";
import { a as p, o as m } from "./codex-api-B.js";
import { t as h } from "./route-scope.js";
import { n as g, s as _, u as v } from "./prompt-text.js";
...
var C = d(h, ({ scope: e }) => p(e.value.routeKind === `remote-thread` ? e.value.taskId : null)),
  w = d(h, ({ scope: e }) => m(e.value.routeKind === `remote-thread` ? e.value.taskId : null)),
  T = l(h, null),
  E = u(s, (e) => !1),
  D = o(h, ({ get: e }) => {
    let { data: t } = e(C);
