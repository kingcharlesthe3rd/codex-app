...
import { f as c, k as l, l as u, n as d, s as f } from "./vscode-api.js";
import { un as p } from "./src-1.js";
import { c as m, o as h, r as g } from "./lib.js";
import { _t as _, c as v, gt as y, ht as b, vt as x } from "./persisted-signal.js";
...
import { A as D, I as O } from "./rpc-1.js";
import { a as k, i as A } from "./request.js";
import { r as j } from "./toast-signal.js";
import { t as M } from "./chevron.js";
import { m as N } from "./chunk-109.js";
import { a as P, i as F, r as I } from "./known-app-icon.js";
import { a as L, c as R } from "./apps-queries.js";
import { o as z } from "./prompt-text.js";
import { D as B } from "./composer-view-state.js";
import { t as V } from "./plugin-install-store.js";
import { m as H } from "./use-plugins.js";
import { t as U } from "./download.js";
import { o as ee } from "./plugin-detail-route-utils.js";
import { n as te, r as ne } from "./open-target-selection.js";
import { n as re, o as ie } from "./bundled-plugin-auto-install-preference.js";
...
function Ee(e) {
  switch (e) {
    case `document`:
      return x.CODEX_GOOGLE_WORKSPACE_RESOURCE_KIND_DOCUMENT;
    case `spreadsheet`:
      return x.CODEX_GOOGLE_WORKSPACE_RESOURCE_KIND_SPREADSHEET;
    case `presentation`:
      return x.CODEX_GOOGLE_WORKSPACE_RESOURCE_KIND_PRESENTATION;
    default:
      return null;
  }
}
...
function Oe(e) {
  ...
  t[2] !== r || t[3] !== o
    ? ((c = async () => {
        await L({ hostId: r, queryClient: o });
      }),
      (t[2] = r),
      (t[3] = o),
      (t[4] = c))
  ...
  return (
    t[5] !== n || t[6] !== a || t[7] !== s || t[8] !== c
      ? ((u = (0, Q.jsx)(re, { app: n, onOpenChange: s, onConnected: c, onOAuthStarted: a })),
        (t[5] = n),
        (t[6] = a),
        (t[7] = s),
        (t[8] = c),
...
function Ae({
  ...
  let h = i(z),
    g = m(),
    _ = N(),
    { data: y, hardRefetchAppsList: x } = R({ hostId: o }),
    { availablePlugins: S, refetch: C } = H(o),
    { openPluginInstall: w, session: T } = V(),
    { pendingPluginId: E, setPluginEnabled: D } = se({ hostId: o }),
    k = a(v),
    A = me(S),
    M = A != null && E === A.plugin.id,
    P = Me(f),
    F = (e) => {
      _(ee(e, { hostId: o }));
    },
    ...
    L = async () => {
      ...
      Te({
        clickAction: b.CODEX_GOOGLE_WORKSPACE_RESOURCE_CLICK_ACTION_UPLOAD_LOCAL_FILE,
        clickSource: e,
        context: {
      ...
      if (i != null) {
        ...
        (B(h, (e) => {
          ...
          c.dispatchMessage(`open-in-browser`, { url: i }));
        return;
      }
      h.get(j).success(
        g.formatMessage(
    ...
    U = async (e) => {
      try {
        await D({ pluginDisplayName: ie(e), pluginId: e.plugin.id, enabled: !0 });
      } catch {
        return;
      }
    },
      ...
      if (!s) {
        ...
        try {
          ...
          if (i?.plugin.installed !== !0) {
            ...
            h.get(j).danger(g.formatMessage(Pe.authFailure));
            return;
          }
          if (!i.plugin.enabled) {
            await U(i);
  ...
  return (0, Q.jsxs)(W.Item, {
    disabled: s || T.kind !== `closed` || M,
    onSelect: () => {
      (te(), l?.());
    },
    children: [
...
function Ke(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Q.jsx)(T, { className: `icon-2xs rotate-180` })), (t[4] = f))
    : (f = t[4]);
  let p;
  t[5] !== i || t[6] !== c || t[7] !== d
    ? ((p = (0, Q.jsx)(S, {
  ...
  let g;
  t[9] !== c || t[10] !== p
    ? ((g = (0, Q.jsx)(E, { tooltipContent: c, children: p })),
      (t[9] = c),
      (t[10] = p),
      (t[11] = g))
    : (g = t[11]);
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, Q.jsx)(T, { className: `icon-2xs` })), (t[15] = y))
    : (y = t[15]);
  let b;
  ...
  let x;
  t[20] !== u || t[21] !== b
    ? ((x = (0, Q.jsx)(E, { tooltipContent: u, children: b })),
      (t[20] = u),
      (t[21] = b),
      (t[22] = x))
    : (x = t[22]);
  ...
  return (
    t[23] !== x || t[24] !== g || t[25] !== _
      ? ((C = (0, Q.jsxs)(`div`, { className: `flex items-center gap-0.5`, children: [g, _, x] })),
        (t[23] = x),
        (t[24] = g),
        (t[25] = _),
        (t[26] = C))
...
function qe(e) {
  ...
  let l;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(M, { className: `icon-sm` })), (t[2] = l))
    : (l = t[2]);
  let u;
  t[3] !== c || t[4] !== i
    ? ((u = (0, Q.jsxs)(S, {
  ...
  t[15] === n
    ...
    : ((f =
        n == null
          ...
          : (0, Q.jsxs)(Q.Fragment, {
              children: [
                (0, Q.jsx)(W.Separator, { paddingClassName: `py-0` }),
                (0, Q.jsx)(W.Item, {
                  RightIcon: w,
...
function Je(e) {
  ...
  let {
    ...
    T;
  t[2] !== r || t[3] !== a
    ? ((T = { cwd: null, hostId: r, openPath: a }), (t[2] = r), (t[3] = a), (t[4] = T))
    : (T = t[4]);
  let {
      canLoadTargets: E,
      preferredTarget: O,
  ...
  if (
    ...
    let e = te({ targets: k, availableTargets: A, includeHiddenTargets: !0, mode: j }),
      o = ne({ preferredTarget: O, targets: k, availableTargets: A, mode: j }),
      f = e.filter(Ye),
      m;
    (t[30] === a ? (m = t[31]) : ((m = J(a)), (t[30] = a), (t[31] = m)), (L = m != null));
    let b;
    t[32] === c
      ? (b = t[33])
      : ((b = c.formatMessage({
    ...
    let H = V,
      U;
    t[46] !== E || t[47] !== M || t[48] !== r || t[49] !== N || t[50] !== a || t[51] !== u
      ? ((U =
          E && (u || !M || N)
                ...
                L
                  ? (0, Q.jsx)(De, {
                      analyticsClickSource:
                        y.CODEX_GOOGLE_WORKSPACE_RESOURCE_CLICK_SOURCE_ARTIFACT_PREVIEW_EXPORT_MENU,
                      analyticsContext: n,
                      handleConnectApp: w,
                      hostId: r,
                      isOpening: _,
  ...
  let B;
  t[55] !== L || t[56] !== x || t[57] !== S || t[58] !== C || t[59] !== r
    ? ((B =
        L && S != null
          ? (0, Q.jsx)(Oe, { app: S, hostId: r, onClose: x, onOAuthStarted: C })
          : null),
      (t[55] = L),
      (t[56] = x),
      (t[57] = S),
...
function Xe({ hostId: e, path: t, sizeBytes: n }) {
  ...
  return (0, Q.jsx)(E, {
    ...
    children: (0, Q.jsx)(S, {
      ...
      children: l ? null : (0, Q.jsx)(U, { className: `icon-sm` }),
    }),
  });
}
function Ze(e) {
