...
import { Ha as n, Ia as r, do as i } from "./app-server-manager-signals.js";
...
import { a as y, i as b } from "./request.js";
import { o as x, r as S } from "./apps-queries.js";
import { r as C } from "./toast-signal.js";
import { t as w } from "./tooltip.js";
import { s as T } from "./prompt-text.js";
import { C as E } from "./composer-view-state.js";
import { t as D } from "./button.js";
import { t as O } from "./spinner.js";
import { t as k } from "./plugin-install-store-CS-dd4DH.js";
import { m as A } from "./use-plugins.js";
import { t as j } from "./download.js";
import { a as M } from "./plugin-detail-route-utils.js";
import { o as N, r as P } from "./plugins-availability.js";
  ...
  return (
    e.find((e) =>
      e.id === `connector_5f3c8c41a1e54ad7a76272c89e2554fa`
        ? !0
        : [e.id, e.name, ...e.pluginDisplayNames].some((e) => he(e) === `google-drive`),
    ) ?? null
  );
}
function se(e) {
...
async function ue({ hostId: e, path: t, title: n }) {
  ...
  let a = r(t),
    o = ge(t),
    s = fe({ fileBytes: b(i.contentsBase64), filename: a, mimeType: o, title: n ?? a }),
    c = y(s.body),
    l = (
      await p
        .getInstance()
        .post(re, c, { "Content-Type": `multipart/form-data; boundary=${s.boundary}`, [ie]: `1` })
    ).body,
  ...
  ye = (e) =>
    (0, Y.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, Y.jsx)(`path`, { d: `M14 2L20 8H16C14.8954 8 14 7.10457 14 6V2Z`, fill: `#1967D2` }),
        (0, Y.jsx)(`path`, {
  ...
  be = (e) =>
    (0, Y.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, Y.jsx)(`path`, { d: `M14 2L20 8H16C14.8954 8 14 7.10457 14 6V2Z`, fill: `#188038` }),
        (0, Y.jsx)(`path`, {
  ...
  xe = (e) =>
    (0, Y.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, Y.jsx)(`path`, { d: `M14 2L20 8H16C14.8954 8 14 7.10457 14 6V2Z`, fill: `#9D7607` }),
        (0, Y.jsx)(`path`, {
          fillRule: `evenodd`,
          clipRule: `evenodd`,
...
function Ce(e) {
  ...
  return (
    t[5] !== n || t[6] !== a || t[7] !== s || t[8] !== l
      ? ((u = (0, Y.jsx)(W, { app: n, onOpenChange: s, onConnected: l, onOAuthStarted: a })),
        (t[5] = n),
        (t[6] = a),
        (t[7] = s),
        (t[8] = l),
...
function Te({
  ...
  let d = f(T),
    ...
    V = async (e) => {
      try {
        await O({ pluginDisplayName: N(e), pluginId: e.plugin.id, enabled: !0 });
      } catch {
        return;
      }
    },
...
function Re(e) {
  ...
  return (
    t[23] !== x || t[24] !== g || t[25] !== _
      ? ((S = (0, Y.jsxs)(`div`, { className: `flex items-center gap-0.5`, children: [g, _, x] })),
        (t[23] = x),
        (t[24] = g),
        (t[25] = _),
        (t[26] = S))
...
function Be(e) {
  ...
  let {
    ...
    C;
  t[2] !== n || t[3] !== i
    ? ((C = { cwd: null, hostId: n, openPath: i }), (t[2] = n), (t[3] = i), (t[4] = C))
    : (C = t[4]);
  let {
      canLoadTargets: w,
      preferredTarget: T,
  ...
  if (
    ...
    let e = B({ targets: E, availableTargets: D, includeHiddenTargets: !0, mode: O }),
      r = V({ preferredTarget: T, targets: E, availableTargets: D, mode: O }),
      a = e.filter(Ve),
      s;
    (t[27] === i ? (s = t[28]) : ((s = G(i)), (t[27] = i), (t[28] = s)), (N = s != null));
    let h;
    t[29] === c
      ? (h = t[30])
      : ((h = c.formatMessage({
    ...
    t[36] !== w || t[37] !== k || t[38] !== n || t[39] !== i || t[40] !== d
      ? ((j =
          w && (d || !k)
            ? (0, Y.jsx)(ee, { cwd: null, delayMs: d ? 0 : Ie, hostId: n, openPath: i })
            : null),
        (t[36] = w),
        (t[37] = k),
        (t[38] = n),
      ...
      (F = g
        ...
        : (0, Y.jsx)(te, {
                ...
                R
                  ...
                  : a.map((e) =>
                      (0, Y.jsxs)(
                        ...
                        {
                          onSelect: () => {
                            A(e.target, { appPath: e.appPath, path: i, persistPreferred: !1 });
                          },
                          children: [
                            (0, Y.jsx)(L.ItemIcon, {
            ...
            onClick: () => {
              ...
              A(r.target, { appPath: r.appPath, path: i, persistPreferred: !1 });
            },
            children: (0, Y.jsxs)(`span`, {
              ...
              children: [
                r == null
                  ? null
                  : (0, Y.jsx)(`img`, { alt: ``, src: r.icon, className: `icon-sm` }),
                r == null || o
                  ? (0, Y.jsx)(`span`, {
...
function He({ hostId: e, path: n, sizeBytes: a }) {
  ...
  let v = async () => {
    p(!0);
    try {
      let { sizeBytes: i } = await m(`read-file-metadata`, { params: { hostId: e, path: n } });
      if ((i == null || i > 47185920) && t(u)) {
        await m(`save-file`, {
          params: { kind: `remote-file`, hostId: e, sourcePath: n, suggestedFilename: r(n) },
        });
        return;
      }
      if (i == null || i > 47185920) throw Error(`File is too large to download directly`);
      let { contentsBase64: a } = await m(`read-file-binary`, { params: { hostId: e, path: n } });
      if (a == null) return;
      await m(`save-file`, {
        params: { kind: `contents`, suggestedFilename: r(n), contentsBase64: a },
      });
    } catch {
      o.get(C).danger(_);
    } finally {
