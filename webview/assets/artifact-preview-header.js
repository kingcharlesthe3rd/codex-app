...
import { c as b, o as x, r as S } from "./lib-2.js";
import { m as C } from "./chunk-12.js";
import { a as w, o as T, s as E } from "./known-app-icon.js";
import { v as D } from "./persisted-signal-CweW-bgN.js";
import { a as O, i as k } from "./request.js";
import { a as A, c as j } from "./apps-queries.js";
import { r as M } from "./toast-signal.js";
import { t as N } from "./tooltip.js";
import { c as P } from "./prompt-text.js";
import { E as F } from "./composer-view-state.js";
import { t as I } from "./button.js";
import { t as L } from "./spinner.js";
import { t as R } from "./plugin-install-store.js";
import { m as z } from "./use-plugins.js";
import { t as B } from "./download.js";
import { o as ee } from "./plugin-detail-route-utils.js";
import { n as V, r as H } from "./open-target-selection.js";
import { t as U } from "./check-md.js";
import { t as W } from "./chevron-right.js";
import { n as G, o as te } from "./bundled-plugin-auto-install-preference.js";
import { r as K, t as ne } from "./dropdown.js";
import { t as re } from "./chevron.js";
import { n as ie, t as ae } from "./use-target-apps.js";
import { t as oe } from "./use-app-connect-flow.js";
import { t as se } from "./compound-button.js";
import { r as ce } from "./plugins-availability.js";
var le = class extends Error {
  ...
  ue = `/wham/apps/google_drive/upload`,
  de = `X-Codex-Base64`,
  fe = `Unsupported file type. Expected one of: .docx, .pptx, .xlsx.`,
  pe = /https?:\/\/(?:docs|drive)\.google\.com\/[^\s"'<>),]+/i;
function q(e) {
  switch (xe(e)) {
    case `docx`:
      return `document`;
  ...
  return (
    e.find((e) =>
      e.id === `connector_5f3c8c41a1e54ad7a76272c89e2554fa`
        ? !0
        : [e.id, e.name, ...e.pluginDisplayNames].some((e) => Se(e) === `google-drive`),
    ) ?? null
  );
}
function me(e) {
  ...
  return (
    e.find((e) =>
      [e.plugin.id.split(`@`)[0], e.plugin.name, e.displayName].some(
        (e) => e != null && Se(e) === `google-drive`,
      ),
    ) ?? null
  );
}
function ge({ apps: e, plugin: t }) {
  if (e != null && me(e)) return { kind: `upload` };
...
async function _e({ hostId: e, path: t, title: n }) {
  if (q(t) == null) throw Error(fe);
  let r = await v(`read-file-binary`, { params: { hostId: e, path: t } });
  if (r.contentsBase64 == null) throw Error(`File contents are unavailable.`);
  let i = c(t),
    a = Ce(t),
    o = ye({ fileBytes: k(r.contentsBase64), filename: i, mimeType: a, title: n ?? i }),
    s = O(o.body),
    l = (
      await g
        .getInstance()
        .post(ue, s, { "Content-Type": `multipart/form-data; boundary=${o.boundary}`, [de]: `1` })
    ).body,
    u = l.connector_result;
  if (be(u)) throw new le();
...
function ye({ fileBytes: e, filename: t, mimeType: n, title: r }) {
  ...
  return (
    ((e, t) => {
      o(`--${i}\r\nContent-Disposition: form-data; name="${we(e)}"\r\n\r\n${t}\r\n`);
    })(`arguments`, JSON.stringify({ title: r })),
    o(
      `--${i}\r\nContent-Disposition: form-data; name="file"; filename="${we(t)}"\r\nContent-Type: ${n}\r\n\r\n`,
    ),
    a.push(e),
    o(`\r\n--${i}--\r\n`),
    { body: Te(a), boundary: i }
  );
}
function be(e) {
  let t = e._meta;
...
function Y(e) {
  return typeof e == `string`
    ? ((e.match(pe)?.[0] ?? null)?.replace(/[.;:!?]+$/, ``) ?? null)
    : null;
}
function xe(e) {
  let t = c(e),
...
function Ee({ clickAction: e, clickSource: t, context: n, productLogger: r, resourceKind: a }) {
  let o = De(a);
  o != null &&
    r.logProductEvent(i, {
...
function De(e) {
  switch (e) {
    case `document`:
      return a.CODEX_GOOGLE_WORKSPACE_RESOURCE_KIND_DOCUMENT;
    case `spreadsheet`:
      return a.CODEX_GOOGLE_WORKSPACE_RESOURCE_KIND_SPREADSHEET;
    case `presentation`:
      return a.CODEX_GOOGLE_WORKSPACE_RESOURCE_KIND_PRESENTATION;
    default:
      return null;
  }
}
...
function ke(e) {
  ...
  t[2] !== r || t[3] !== o
    ? ((c = async () => {
        await A({ hostId: r, queryClient: o });
      }),
      (t[2] = r),
      (t[3] = o),
      (t[4] = c))
  ...
  return (
    t[5] !== n || t[6] !== a || t[7] !== s || t[8] !== c
      ? ((l = (0, Z.jsx)(G, { app: n, onOpenChange: s, onConnected: c, onOAuthStarted: a })),
        (t[5] = n),
        (t[6] = a),
        (t[7] = s),
        (t[8] = c),
...
function je({
  ...
  let g = f(P),
    _ = b(),
    v = C(),
    { data: y, hardRefetchAppsList: x } = j({ hostId: a }),
    { availablePlugins: S, refetch: w } = z(a),
    { openPluginInstall: T, session: E } = R(),
    { pendingPluginId: O, setPluginEnabled: k } = ce({ hostId: a }),
    A = p(D),
    N = he(S),
    I = N != null && O === N.plugin.id,
    L = Ne(d),
    B = (e) => {
      v(ee(e, { hostId: a }));
    },
    ...
    H = async () => {
      let i = r == null ? u : s(r, u);
      Ee({
        clickAction: n.CODEX_GOOGLE_WORKSPACE_RESOURCE_CLICK_ACTION_UPLOAD_LOCAL_FILE,
        clickSource: e,
        context: {
      ...
      let o = ve(await _e({ hostId: a, path: i, title: h }));
      if (o != null) {
        let e = Q(d),
          t = h?.trim(),
          n = {
            id: `google-drive-open:${d}:${i}`,
            imageAttachments: [],
            showInComposer: !1,
            text: `The user uploaded ${t == null || t.length === 0 ? i : `${t} from ${i}`} to ${e}.\n${e} link: ${o}`,
            title: `Opened in ${e}`,
          };
        (F(g, (e) => {
    ...
    U = async (e) => {
      try {
        await k({ pluginDisplayName: te(e), pluginId: e.plugin.id, enabled: !0 });
      } catch {
        return;
      }
    },
      ...
      if (!o) {
        ...
        try {
          ...
          if (r?.plugin.installed !== !0) {
            ...
            g.get(M).danger(_.formatMessage(Pe.authFailure));
            return;
          }
          if (!r.plugin.enabled) {
            await U(r);
  ...
  return (0, Z.jsxs)(K.Item, {
    disabled: o || E.kind !== `closed` || I,
    onSelect: () => {
      (W(), c?.());
    },
    children: [
      (0, Z.jsx)(K.ItemIcon, {
        children: (0, Z.jsx)(L, { "aria-hidden": !0, className: `icon-sm` }),
      }),
      (0, Z.jsx)(Me, { targetType: d }),
    ],
  });
}
function Me(e) {
...
function Ge(e) {
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = (0, Z.jsx)(`div`, { className: `min-w-0 justify-self-center`, children: r })),
      (t[4] = r),
      (t[5] = c));
  let l;
  t[6] === a
...
function Ke(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Z.jsx)(W, { className: `icon-2xs rotate-180` })), (t[4] = f))
    : (f = t[4]);
  let p;
  t[5] !== i || t[6] !== c || t[7] !== d
    ? ((p = (0, Z.jsx)(I, {
  ...
  let m;
  t[9] !== c || t[10] !== p
    ? ((m = (0, Z.jsx)(N, { tooltipContent: c, children: p })),
      (t[9] = c),
      (t[10] = p),
      (t[11] = m))
    : (m = t[11]);
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Z.jsx)(W, { className: `icon-2xs` })), (t[15] = _))
    : (_ = t[15]);
  let v;
  ...
  let y;
  t[20] !== u || t[21] !== v
    ? ((y = (0, Z.jsx)(N, { tooltipContent: u, children: v })),
      (t[20] = u),
      (t[21] = v),
      (t[22] = y))
    : (y = t[22]);
  ...
  return (
    t[23] !== y || t[24] !== m || t[25] !== h
      ? ((S = (0, Z.jsxs)(`div`, { className: `flex items-center gap-0.5`, children: [m, h, y] })),
        (t[23] = y),
        (t[24] = m),
        (t[25] = h),
        (t[26] = S))
...
function qe(e) {
  ...
  t[0] === o
    ...
    : ((c = (0, Z.jsx)(`span`, {
        ...
        children: (0, Z.jsx)(Ze, { zoomPercent: o }),
      })),
      (t[0] = o),
      (t[1] = c));
  let l;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Z.jsx)(re, { className: `icon-sm` })), (t[2] = l))
    : (l = t[2]);
  let u;
  t[3] !== c || t[4] !== i
    ? ((u = (0, Z.jsxs)(I, {
      ...
      ? ((e = (e) =>
          (0, Z.jsx)(
            K.Item,
            {
              ...
              children: (0, Z.jsx)(Ze, { zoomPercent: e }),
            },
            e,
          )),
        (t[11] = n?.selected),
  ...
  t[15] === n
    ...
    : ((f =
        n == null
          ...
          : (0, Z.jsxs)(Z.Fragment, {
              children: [
                (0, Z.jsx)(K.Separator, { paddingClassName: `py-0` }),
                (0, Z.jsx)(K.Item, {
                  RightIcon: U,
...
function Je(e) {
  let t = (0, X.c)(57),
    { analyticsContext: n, hostId: i, path: a, showLabel: o } = e,
    s = o === void 0 ? !1 : o,
    l = b(),
    u = y(`open-file`),
    [d, f] = (0, $.useState)(!1),
    ...
    [h, g] = (0, $.useState)(!1),
    _;
  t[0] === i ? (_ = t[1]) : ((_ = { hostId: i }), (t[0] = i), (t[1] = _));
  let {
      clearConnectingApp: v,
      connectingApp: S,
    ...
    T;
  t[2] !== i || t[3] !== a
    ? ((T = { cwd: null, hostId: i, openPath: a }), (t[2] = i), (t[3] = a), (t[4] = T))
    : (T = t[4]);
  let {
      canLoadTargets: E,
      preferredTarget: D,
  ...
  if (
    ...
    let e = V({ targets: O, availableTargets: k, includeHiddenTargets: !0, mode: A }),
      o = H({ preferredTarget: D, targets: O, availableTargets: k, mode: A }),
      c = e.filter(Ye),
      _;
    (t[29] === a ? (_ = t[30]) : ((_ = q(a)), (t[29] = a), (t[30] = _)), (I = _ != null));
    let v;
    t[31] === l
      ? (v = t[32])
      : ((v = l.formatMessage({
    ...
    let y = v,
      b;
    t[33] !== i || t[34] !== u || t[35] !== a
      ? ((b = () => {
          u.mutate({ cwd: null, hostId: i, path: a, target: `fileManager` });
        }),
        (t[33] = i),
        (t[34] = u),
        (t[35] = a),
    ...
    let T = C,
      P;
    t[38] !== E || t[39] !== j || t[40] !== i || t[41] !== M || t[42] !== a || t[43] !== d
      ? ((P =
          E && (d || !j || M)
            ? (0, Z.jsx)(ae, { cwd: null, delayMs: d ? 0 : We, hostId: i, openPath: a })
            : null),
        (t[38] = E),
        (t[39] = j),
        (t[40] = i),
    ...
    ((L = z),
      (R = h
        ...
        : (0, Z.jsx)(se, {
            ...
            primaryAriaLabel: o == null ? y : U,
            secondaryAriaLabel: G,
            secondaryTooltipContent: G,
            tooltipContent: U,
              ...
              children: [
                c.map((e) =>
                  (0, Z.jsxs)(
                    ...
                    {
                      onSelect: () => {
                        N(e.target, { appPath: e.appPath, path: a, persistPreferred: !1 });
                      },
                      children: [
                        (0, Z.jsx)(K.ItemIcon, {
                ...
                I
                  ? (0, Z.jsx)(Oe, {
                      analyticsClickSource:
                        r.CODEX_GOOGLE_WORKSPACE_RESOURCE_CLICK_SOURCE_ARTIFACT_PREVIEW_EXPORT_MENU,
                      analyticsContext: n,
                      handleConnectApp: w,
                      hostId: i,
                      isOpening: h,
            ...
            onClick: () => {
              ...
              N(o.target, { appPath: o.appPath, path: a, persistPreferred: !1 });
            },
            children: (0, Z.jsxs)(`span`, {
              ...
              children: [
                o == null
                  ? null
                  : (0, Z.jsx)(`img`, { alt: ``, src: o.icon, className: `icon-sm` }),
                o == null || s
                  ? (0, Z.jsx)(`span`, {
      ...
      (t[27] = L),
      (t[28] = R));
  } else ((I = t[26]), (L = t[27]), (R = t[28]));
  let z;
  t[47] !== I || t[48] !== v || t[49] !== S || t[50] !== C || t[51] !== i
    ? ((z =
        I && S != null
          ? (0, Z.jsx)(ke, { app: S, hostId: i, onClose: v, onOAuthStarted: C })
          : null),
      (t[47] = I),
      (t[48] = v),
      (t[49] = S),
  ...
  let B;
  return (
    t[53] !== L || t[54] !== R || t[55] !== z
      ? ((B = (0, Z.jsxs)(Z.Fragment, { children: [L, R, z] })),
        (t[53] = L),
        (t[54] = R),
        (t[55] = z),
        (t[56] = B))
...
function Xe({ hostId: e, path: n, sizeBytes: r }) {
  let i = f(h),
    a = b(),
    s = o(e),
    [l, u] = (0, $.useState)(!1),
  ...
  if (e === `local` || (r != null && r > 47185920 && !t(s))) return null;
  let g = async () => {
    u(!0);
    try {
      let { sizeBytes: r } = await v(`read-file-metadata`, { params: { hostId: e, path: n } });
      if ((r == null || r > 47185920) && t(s)) {
        await v(`save-file`, {
          params: { kind: `remote-file`, hostId: e, sourcePath: n, suggestedFilename: c(n) },
        });
        return;
      }
      if (r == null || r > 47185920) throw Error(`File is too large to download directly`);
      let { contentsBase64: i } = await v(`read-file-binary`, { params: { hostId: e, path: n } });
      if (i == null) return;
      await v(`save-file`, {
        params: { kind: `contents`, suggestedFilename: c(n), contentsBase64: i },
      });
    } catch {
      i.get(M).danger(m);
    } finally {
  ...
  return (0, Z.jsx)(N, {
    ...
    children: (0, Z.jsx)(I, {
      ...
      children: l ? null : (0, Z.jsx)(B, { className: `icon-sm` }),
    }),
  });
}
function Ze(e) {
