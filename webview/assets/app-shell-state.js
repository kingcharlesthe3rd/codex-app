...
import { Hs as t, kt as n, zs as r } from "./app-server-manager-signals.js";
    ...
    let v = 0,
      y = (e, n, r, o = 0, s = 0) => {
        ...
        if ((E > 0 && re(u, E), c.length === 1 && c.unshift(null), h)) {
          (d(h < ye, `Repeat count too high, must be less than 20`, `repeat-count-high`),
            (x = fe(x, h)));
          let e = [...c],
            t = [...u];
...
function Fe({ defaultWidth: e, mainContentWidth: t, storageKey: n, widthMode: i }) {
  let a = r(n, null);
  return a == null || !Number.isFinite(a) ? F(e, t, i) : a <= 1 ? R(a) : F(a, t, i);
}
...
var We = `main`,
  ...
  Qe = a(
    l,
    ({ get: e, scope: t }) => e(Ze) ?? { defaultWidth: 600, storageKey: N(t.value.routeTemplate) },
  ),
  $e = s(l, null),
  et = s(l, null),
  tt = s(l, null),
...
function Q(e, t, n = {}) {
  ...
  (e.set(Y, !1), e.set(X, n.restoreFullWidthOnNextOpen === !0 && e.get(B)), e.set(B, !1));
}
function Bt(e, t) {
  if (t) {
    (e.set(Y, !0), Q(e, !0));
