...
import { c as n, g as r, h as i, t as a } from "./app-scope.js";
import { Br as o, Wr as s, t as c } from "./persisted-signal.js";
import {
  At as l,
  Ct as u,
  Dt as d,
...
function me(e, t, n, r, i, a) {
  pe(e, i, a);
  for (let o = 0; o < t.length; o++) e.push({ value: t[o], at: C(i, a, r[o]), easing: oe(n, o) });
}
function he(e, t) {
...
function ye(e, { defaultTransition: t = {}, ...n } = {}, r, i) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    if (typeof o == `string`) {
      ...
      l.set(o.name, fe(m, o.at, p, l));
      continue;
    }
    let [u, g, _ = {}] = o;
    _.at !== void 0 && (m = fe(m, _.at, p, l));
    let v = 0,
      y = (e, n, r, o = 0, s = 0) => {
        let c = be(e),
          {
        ...
        if ((E > 0 && re(u, E), c.length === 1 && c.unshift(null), p)) {
          (d(p < ve, `Repeat count too high, must be less than 20`, `repeat-count-high`),
            (x = de(x, p)));
          let e = [...c],
            t = [...u];
          ...
          for (let r = 0; r < p; r++) {
            ...
            for (let i = 0; i < e.length; i++)
              (u.push(t[i] + (r + 1)), b.push(i === 0 ? `linear` : oe(n, i - 1)));
          }
          he(u, p);
        }
        let D = T + x;
        (me(r, c, b, u, T, D), (v = Math.max(S + x, v)), (h = Math.max(D, h)));
      };
    if (f(u)) {
      let e = A(u, s);
      y(g, _, j(`default`, e));
  ...
  return (
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        let d = o.get(r);
        ((d.keyframes[i] = s), (d.transition[i] = { ...t, duration: h, ease: l, times: c, ...n }));
      }
    }),
    o
  );
...
function M(e, t, n, r) {
  let i = [];
  if (Oe(e, t)) i.push(w(e, (k(t) && t.default) || t, n && (n.default || n)));
  else {
    let a = ue(e, t, r),
      o = a.length;
...
function ke(e, t, n) {
  let r = [];
  return (
    ye(e, t, n, { spring: g }).forEach(({ keyframes: e, transition: t }, n) => {
      r.push(...M(n, e, t));
    }),
    r
  );
...
var Ge = `main`,
  ...
  et = n(
    O,
    ({ get: e, scope: t }) => e($e) ?? { defaultWidth: 600, storageKey: P(t.value.routeTemplate) },
  ),
  tt = i(O, null),
  nt = i(O, null),
  rt = i(O, null),
...
function W(e) {
  return Number.isFinite(e) ? Math.min(Math.max(e, 240), xt) : 300;
}
var Tt = `app-shell-bottom-panel-launcher-visible`,
  Et = 100,
  G = i(a, !0),
  K = i(a, !1),
  q = i(a, !1),
...
function Vt() {
  o(`app-shell-bottom-panel-launcher-visible`, void 0) ?? s(Tt, !1);
}
function Ht(e, t) {
  (e.set(jt, t), Kt(e.get(Mt), t, e.get(D)));
}
function $(e, t, n = {}) {
  e.set(Nt, t);
  let r = e.get(Pt);
  if ((r.stop(), Kt(r, t, e.get(D)), t)) {
