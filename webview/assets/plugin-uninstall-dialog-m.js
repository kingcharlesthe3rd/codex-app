...
function h(e) {
  ...
  t[3] === b
    ? (S = t[4])
    : ((S = (0, _.jsx)(f, { className: `sr-only`, children: b })), (t[3] = b), (t[4] = S));
  let C;
  ...
  t[6] === b
    ? (w = t[7])
    : ((w = (0, _.jsx)(l, {
        children: (0, _.jsx)(p, { title: b, subtitle: C, subtitleClassName: `mt-2` }),
      })),
      (t[6] = b),
      (t[7] = w));
  let T;
  ...
  let j;
  t[19] !== i || t[20] !== k
    ? ((j = (0, _.jsx)(r, { color: `danger`, loading: i, onClick: k, children: A })),
      (t[19] = i),
      (t[20] = k),
      (t[21] = j))
    : (j = t[21]);
  ...
  t[22] !== j || t[23] !== D || t[24] !== O
    ? ((M = (0, _.jsx)(l, { children: (0, _.jsxs)(d, { children: [D, O, j] }) })),
      (t[22] = j),
      (t[23] = D),
      (t[24] = O),
      (t[25] = M))
  ...
  return (
    t[30] !== u || t[31] !== h || t[32] !== N
      ? ((P = (0, _.jsx)(c, { open: h, contentProps: x, onOpenChange: u, children: N })),
        (t[30] = u),
        (t[31] = h),
        (t[32] = N),
        (t[33] = P))
...
//# sourceMappingURL=plugin-uninstall-dialog-m.js.map
