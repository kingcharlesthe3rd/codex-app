import { fs as e, ls as t } from "./app-server-manager-signals.js";
import { B as n, V as r, f as i, h as a, u as o } from "./vscode-api.js";
var s = [`hooks`],
  c = r(a, ({ hostId: t, cwd: n }) => ({
    queryKey: [...s, t, n],
    queryFn: () => {
...
var d = n(a, (t) => ({
  ...
  onMutate: async (e, { client: n }) => {
    ...
    return (
      n.setQueriesData({ predicate: ({ queryKey: e }) => f(e, t) }, (t) => p(t, e)),
      { previousResponses: r }
    );
  },
...
//# sourceMappingURL=hooks-settings-queries-B.js.map
