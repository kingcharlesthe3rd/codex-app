...
import { Bt as u, o as d } from "./use-host-config-C.js";
...
import { n as M, r as N, t as re } from "./permissions-mode-defaults.js";
var ie = 100,
  ae = `:read-only`,
  oe = `:workspace`;
async function se(e, t) {
  let n = [],
    r = null;
  do {
    let i = await u(`list-permission-profiles`, { hostId: e, cursor: r, limit: ie, cwd: t });
...
function le(e, t, n) {
  let r = t?.allowedPermissionProfiles,
    ...
    o = t?.defaultPermissions ?? a ?? (r?.[ae] === !0 && r[oe] === !0 ? oe : null);
  return { profiles: i, defaultProfileId: o != null && i.some(({ id: e }) => e === o) ? o : null };
}
var ue = a(s, ({ hostId: e, cwd: t }) => ({
  queryKey: ce(e, t),
  queryFn: () => se(e, t),
...
function me({ defaultWorkspaceWriteMode: e, isWindowsSandboxRequired: t }) {
...
function he(e, t, n, r = null) {
  return r != null && e.includes(r)
    ...
    : e.includes(`custom`)
      ? `custom`
      : !L(e) && e.includes(`full-access`)
        ? `full-access`
        : t != null && e.includes(t)
          ? t
          : n;
}
function ge(e, t, n, r, i = null, a, o) {
  return t == null
    ? fe(e, r, i)
      ? null
...
var _e = e(),
  z = { isSet: !1, value: null },
  ve = { isSet: !1, value: null },
  ye = l(null),
  be = n(s, () => ({})),
  xe = l(!1),
  B = l(z),
  V = c((e) => l(z)),
  Se = c((e) => l(null)),
  H = r(s, (e, { get: t }) => t(p, e)?.at(-1)?.params ?? null);
function Ce(e, { requirements: t, resolvedConfig: n }) {
  switch (e) {
    case `STEPS_PROSE`:
...
function De(e) {
  ...
  return !U() || r === `global-default` ? `global-default` : (t ?? `draft`);
}
function Oe(e) {
  let n = (0, _e.c)(11),
    r = t(m, e),
...
function Ae(e) {
  ...
  let A = t(ue, O),
    ...
    ne = Te(w, E),
    M = pe(te?.defaultProfileId, Ce(w, E)),
    N = M == null ? (te?.defaultProfileId ?? null) : null,
    ie = M ?? ne,
    ae = D(E.requirements, E.resolvedConfig),
    oe =
      te != null &&
      E.requirements?.allowedPermissionProfiles != null &&
      k(E.requirements).length === 0 &&
      N == null,
    se = !E.isConfigDataPending && !oe && N == null && ae.length === 0,
    ce;
  n[7] !== r || n[8] !== d
    ? ((ce = { conversationId: r, stateScope: d }), (n[7] = r), (n[8] = d), (n[9] = ce))
    : (ce = n[9]);
  let de = De(ce),
    P = r == null && d === `composer`,
    [F, I] = v(re),
    ...
    L;
  n[10] !== x || n[11] !== c
    ? ((L = JSON.stringify([c, x])), (n[10] = x), (n[11] = c), (n[12] = L))
    : (L = n[12]);
  let R = L,
    z = ge[R] ?? ve,
    B = z.isSet ? z.value : N,
  ...
  n[13] !== R || n[14] !== p
    ? ((V = (e) => {
        p.set(be, (t) => ({ ...t, [R]: { isSet: !0, value: e } }));
      }),
      (n[13] = R),
      (n[14] = p),
      (n[15] = V))
  ...
  let H = V,
    [we, U] = v(xe),
    W;
  n[16] === r ? (W = n[17]) : ((W = Se(r)), (n[16] = r), (n[17] = W));
  let [Ae, G] = v(W),
    {
    ...
    Ie;
  n[18] !== F || n[19] !== c
    ? ((Ie = Object.hasOwn(F, c)), (n[18] = F), (n[19] = c), (n[20] = Ie))
    : (Ie = n[20]);
  let Le = Ie,
    Re = Ee(c, F, ne),
    Y = M != null && (!P || !z.isSet) && (J == null || !fe(J, ae)) ? M : Re,
    ze = E.isConfigDataPending || ae.includes(Y),
  ...
  if (de === `draft`) {
    let e = me ?? Y,
      t = we || Le,
      r = (me == null && (Be || (!z.isSet && ee))) || (!se && B == null && oe),
      i = !se,
      a;
    n[28] !== he || n[29] !== H || n[30] !== U
      ? ((a = (e) => {
          (H(null), he(e), U(!0));
        }),
        (n[28] = he),
  ...
  if (de === `global-default`) {
    ...
    n[50] !== X
      ? ((e = (e) => {
          (P && H(null), F[c] !== e && I({ ...F, [c]: e }), X(e)?.catch(Z));
        }),
        (n[44] = F),
        (n[45] = c),
        (n[46] = P),
    ...
    let a = i,
      o;
    n[57] !== r || n[58] !== P || n[59] !== Z || n[60] !== H || n[61] !== U
      ? ((o = (e) => {
          if (P) {
            (H(e), U(!0));
            return;
    ...
    let l = Le || (P && (z.isSet || N != null)),
      d = Be || (P && !z.isSet && ee) || (P && !se && B == null && oe),
      f = P ? B : Ve ? null : K,
      p = Ve || (!se && (P || (K == null && q !== `custom`))),
      m;
    return (
      n[69] !== Y ||
      n[70] !== t ||
...
function G(e) {
  ...
  let c = De(s),
    ...
    [d, f] = v(B),
    p;
  t[3] === n ? (p = t[4]) : ((p = n == null ? B : V(n)), (t[3] = n), (t[4] = p));
  let [m, h] = v(p),
    { hasThreadSelection: g, threadMode: _, threadPreferredNonFullAccessMode: y } = Oe(n),
    b;
...
function Me(e, t) {
  (t.set(ye, null), e.set(be, {}), t.set(B, z), t.set(xe, !1));
}
function Ne(e, t, n) {
  e.set(V(t), { isSet: !0, value: K(e, n) });
}
function K(e, t) {
  let n = e.get(B);
...
//# sourceMappingURL=use-permissions-mode-DcMQ-DVc.js.map
