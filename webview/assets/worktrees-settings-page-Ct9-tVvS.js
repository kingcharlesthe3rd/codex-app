...
import { S_ as z, gd as B, md as V, x_ as H } from "./app-initial~app-main~onboarding-page.js";
import { _n as U, hn as W } from "./app-initial~app-main~automations-page.js";
import {
  G,
  K as ce,
...
import { n as de, t as fe } from "./use-codex-worktrees.js";
function pe() {
  let e = (0, Z.c)(57),
    t = h(),
    { selectedHostId: n } = B(),
    {
      ...
      error: o,
      refetch: s,
    } = de(l(n), `worktrees_settings_page`),
    u;
  e[0] === n ? (u = e[1]) : ((u = { hostId: n }), (e[0] = n), (e[1] = u));
  let { data: d, isLoading: f, error: p } = w(R, u),
    { data: m, isLoading: g } = v(),
    y = _(),
    b,
    x;
  if (
    ...
    bb0: {
      let l = _e(r?.worktrees ?? [], d?.roots ?? []),
        u,
        h;
      if (e[17] !== m || e[18] !== y || e[19] !== n) {
        let t;
        (e[22] === n ? (t = e[23]) : ((t = (e) => ve(e) === n), (e[22] = n), (e[23] = t)),
          (u = (m ?? []).filter(t)));
        let r;
        (e[24] === y ? (r = e[25]) : ((r = (e) => !ee(e, y)), (e[24] = y), (e[25] = r)),
          (h = u.filter(r)),
          (e[17] = m),
          (e[18] = y),
          (e[19] = n),
      ...
      e[30] === a
        ? (T = e[31])
        : ((T = a ? null : (0, $.jsx)(H, { className: `icon-xs` })), (e[30] = a), (e[31] = T));
      let E;
      e[32] !== a || e[33] !== C || e[34] !== w || e[35] !== T
        ? ((E = (0, $.jsx)(M, {
            "aria-label": C,
            className: `shrink-0`,
            color: `ghost`,
      ...
      if (i || f) {
        ...
        e[39] === D
          ? (r = e[40])
          : ((r = (0, $.jsx)(q.Header, { title: n, actions: D })), (e[39] = D), (e[40] = r));
        let i;
        ...
        (e[42] === r
          ? (a = e[43])
          : ((a = (0, $.jsx)(W, { title: t, children: (0, $.jsxs)(q, { children: [r, i] }) })),
            (e[42] = r),
            (e[43] = a)),
          (x = a));
        break bb0;
      ...
      if (O) {
        ...
        e[46] === D
          ? (i = e[47])
          : ((i = (0, $.jsx)(q.Header, { title: r, actions: D })), (e[46] = D), (e[47] = i));
        let a;
        e[48] !== t || e[49] !== O.message
          ? ((a =
              O.message ||
              t.formatMessage({
        ...
        let s;
        (e[53] !== i || e[54] !== o
          ? ((s = (0, $.jsx)(W, { title: n, children: (0, $.jsxs)(q, { children: [i, o] }) })),
            (e[53] = i),
            (e[54] = o),
            (e[55] = s))
          : (s = e[55]),
      ...
      (e[56] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((k = (0, $.jsx)(G, { slug: `worktrees` })), (e[56] = k))
        : (k = e[56]),
        (b = (0, $.jsx)(W, {
          title: k,
          children:
...
function me(e) {
  let t = (0, Z.c)(30),
    ...
    { data: f, isLoading: p } = A(r, l(s), `worktree_restore_banner`),
    m = f?.root ?? r ?? i[0]?.dir ?? null,
    h;
  t[0] === m
    ? (h = t[1])
    : ((h = m
        ? (0, $.jsx)(`span`, { className: `truncate font-mono text-sm`, children: m })
        : (0, $.jsx)(c, {
  ...
  let b;
  t[6] !== v || t[7] !== y
    ? ((b = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col`, children: [v, y] })),
      (t[6] = v),
      (t[7] = y),
      (t[8] = b))
    : (b = t[8]);
  let x;
  t[9] !== n || t[10] !== b
    ? ((x = (0, $.jsx)(q.Header, { title: b, actions: n })), (t[9] = n), (t[10] = b), (t[11] = x))
    : (x = t[11]);
  let S;
  if (t[12] !== a || t[13] !== s || t[14] !== u || t[15] !== d || t[16] !== o || t[17] !== i) {
    let e;
    (t[19] !== a || t[20] !== s || t[21] !== u || t[22] !== d || t[23] !== o
      ? ((e = (e) =>
          (0, $.jsx)(
            he,
            {
  ...
  t[25] === S
    ? (C = t[26])
    : ((C = (0, $.jsx)(q.Content, { children: (0, $.jsx)(K, { children: S }) })),
      (t[25] = S),
      (t[26] = C));
  let w;
  return (
    t[27] !== x || t[28] !== C
      ? ((w = (0, $.jsxs)(q, { children: [x, C] })), (t[27] = x), (t[28] = C), (t[29] = w))
      : (w = t[29]),
    w
  );
}
      ...
      if (!g) {
        ...
        try {
          (t.length > 0 &&
            ...
            await o(`worktree-delete`, {
              params: { hostId: v.id, worktree: e.dir, reason: `settings-delete-targeted` },
            }),
            a());
        } catch (e) {
          (u.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: T(e) } }),
            d
              .get(F)
              .danger(
                p.formatMessage({
...
//# sourceMappingURL=worktrees-settings-page-Ct9-tVvS.js.map
