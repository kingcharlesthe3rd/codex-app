...
function Ge(e) {
  ye({ event: e, href: qe, initiator: `open_in_browser_bridge` });
}
var Ke,
  G,
  qe,
...
function at(e) {
  ...
  let g;
  t[9] !== u || t[10] !== h
    ? ((g = (0, q.jsx)(ke, { id: u, className: `sr-only`, children: h })),
      (t[9] = u),
      (t[10] = h),
      (t[11] = g))
    : (g = t[11]);
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, q.jsx)(ae, { className: `icon-xs` })), (t[16] = b))
    : (b = t[16]);
  let x;
...
var ot,
  ...
  q,
  ct = e(() => {
    ((ot = r()), I(), (st = t(i(), 1)), N(), M(), De(), O(), Je(), tt(), it(), (q = n()));
  });
function lt(e, t, n) {
  return c({
    ...
    queryFn:
      t != null && n != null
        ? ({ pageParam: t }) =>
            j.safeGet(`/wham/referrals/invite/tracking`, {
...
function dt(e) {
  let t = (0, gt.c)(85),
    ...
    i = oe(),
    { accountId: a, isLoading: o, userId: s } = L(),
    c = (0, _t.useId)(),
    [l, d] = (0, _t.useState)(`this_month`),
    f;
  t[0] !== a || t[1] !== l || t[2] !== s
    ? ((f = lt(l, s, a)), (t[0] = a), (t[1] = l), (t[2] = s), (t[3] = f))
    : (f = t[3]);
  let {
      data: p,
      fetchNextPage: m,
  ...
  if (
    ...
    let e = p?.pages.flatMap(pt),
      u = s != null && a != null,
      f = !o && !u;
    ((x = Oe),
      (ne = !0),
      (re = `max-h-[calc(100dvh_-_32px)] !w-[480px] !max-w-[calc(100vw_-_32px)] !overflow-x-hidden !overflow-y-auto !rounded-[24px] !p-0 !shadow-xl`),
      t[29] === c ? (A = t[30]) : ((A = { "aria-describedby": c }), (t[29] = c), (t[30] = A)),
      t[31] === r
        ? (S = t[32])
        : ((S = (e) => {
            e || r();
    ...
    (t[33] === Symbol.for(`react.memo_cache_sentinel`)
      ...
      t[34] === c
        ? (ee = t[35])
        : ((ee = (0, Y.jsx)(ke, { id: c, className: `sr-only`, children: m })),
          (t[34] = c),
          (t[35] = ee)),
      (D = `relative flex min-h-[406px] flex-col px-6 pb-6 text-token-text-primary`));
    let _, v;
    t[36] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((_ = (0, Y.jsx)(ie, { className: `icon-2xs rotate-180` })),
        (v = (0, Y.jsx)(P, {
    ...
    t[42] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((M = (0, Y.jsx)(ae, { className: `icon-xs` })), (t[42] = M))
      : (M = t[42]);
    let N;
    (t[43] !== r || t[44] !== j
      ? ((N = (0, Y.jsx)(te, {
    ...
    let se = yt[l],
      ce;
    t[50] === se ? (ce = t[51]) : ((ce = (0, Y.jsx)(P, { ...se })), (t[50] = se), (t[51] = ce));
    let F;
    t[52] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((F = (0, Y.jsx)(le, { className: `icon-2xs` })), (t[52] = F))
      : (F = t[52]);
    let I;
    t[53] === ce
      ? (I = t[54])
    ...
    (t[55] === l
      ...
      t[57] !== I || t[58] !== ue
        ? ((k = (0, Y.jsxs)(`div`, {
          ...
          (t[59] = k))
        : (k = t[59]),
      (T = `flex max-h-[264px] flex-col gap-4 overflow-y-auto`),
      (E =
        f || (g && p == null)
          ? (0, Y.jsx)(`p`, {
  ...
  t[60] !== m || t[61] !== h || t[62] !== v || t[63] !== _ || t[64] !== y
    ...
    : (j = t[65]);
  let M;
  t[66] !== j || t[67] !== T || t[68] !== E
    ? ((M = (0, Y.jsxs)(`div`, { className: T, children: [E, j] })),
      (t[66] = j),
      (t[67] = T),
      (t[68] = E),
      (t[69] = M))
    : (M = t[69]);
  let N;
  t[70] !== M || t[71] !== D || t[72] !== O || t[73] !== k
    ? ((N = (0, Y.jsxs)(`section`, { className: D, children: [O, k, M] })),
      (t[70] = M),
      (t[71] = D),
      (t[72] = O),
      (t[73] = k),
...
function ln(e) {
  let t = (0, In.c)(266),
    {
      ...
      offerDescription: l,
      offerTitle: u,
      referralRedemptionAction: d,
      referralBeaconType: f,
      referralGrantType: p,
      referralKey: m,
      remainingReferrals: h,
    } = e,
    g = r === void 0 ? !0 : r,
    _ = i === void 0 ? !1 : i,
    v = a === void 0 ? !1 : a,
  ...
  t[0] !== C?.structure || t[1] !== o
    ? ((E = o ?? C?.structure?.toLowerCase() === `personal`),
      (t[0] = C?.structure),
      (t[1] = o),
      (t[2] = E))
    : (E = t[2]);
  let D = E,
    O;
  t[3] === p ? (O = t[4]) : ((O = Tn(p)), (t[3] = p), (t[4] = O));
  let k = O,
    A;
  t[5] === m ? (A = t[6]) : ((A = { referralKey: m }), (t[5] = m), (t[6] = A));
  let { data: j } = _e(A),
    M = (0, Q.useId)(),
    N = (0, Q.useId)(),
    se = (0, Q.useId)(),
    ...
    [I, de] = (0, Q.useState)(``),
    fe;
  t[7] === Symbol.for(`react.memo_cache_sentinel`) ? ((fe = []), (t[7] = fe)) : (fe = t[7]);
  let [L, pe] = (0, Q.useState)(fe),
    me;
  t[8] === Symbol.for(`react.memo_cache_sentinel`) ? ((me = []), (t[8] = me)) : (me = t[8]);
  let [he, ge] = (0, Q.useState)(me),
    [ve, ye] = (0, Q.useState)(!1),
    [Se, Ee] = (0, Q.useState)(!1),
  ...
  let Le = Fe.length > 0,
    Re = L.length > 0,
    Be = h != null && h > 0 ? Math.min(h, Bn) : Bn,
    V = !(L.length < Be),
    ...
    Xe;
  t[11] === he ? (Xe = t[12]) : ((Xe = new Set(he)), (t[11] = he), (t[12] = Xe));
  let Ze = Xe,
    Qe = j?.requires_explicit_confirmation !== !1,
    $e = L.length > 0 && L.every(yn),
    et = Qe && $e,
    K = g && j != null && j.rules.length > 0,
    tt = v ? `workspace` : `user`,
    nt = _
      ? j?.time_frame_rules.find((e) => e.type === tt && e.invites_sent >= e.invites_total)
      : void 0,
    rt = g && x && D && m === `codex_referral_persistent_invite` && k === `rateLimitReset`,
    ...
    st =
      ...
      D &&
      !_ &&
      m === `codex_referral_persistent_invite` &&
      k === `rateLimitReset` &&
      it === zn &&
      j != null,
    q;
  t[13] !== st || t[14] !== R || t[15] !== l || t[16] !== u
    ? ((q = bt(R, st, u, l)), (t[13] = st), (t[14] = R), (t[15] = l), (t[16] = u), (t[17] = q))
    : (q = t[17]);
  let ct = q === `rateLimitReset`,
    lt = it * 2,
    ut;
  t[18] !== b || t[19] !== f || t[20] !== m || t[21] !== k
    ? ((ut = (e) => {
        b.logProductEvent(re, {
          ...e,
          referralBeaconType: f ?? void 0,
  ...
  t[23] === J
    ? (ft = t[24])
    : ((ft = () => {
        J({ action: T.CODEX_REFERRAL_INVITE_MODAL_ACTION_SHOWN });
      }),
      (t[23] = J),
      (t[24] = ft));
  ...
  t[28] !== Ue || t[29] !== J || t[30] !== c
    ? ((gt = () => {
        Ue || (J({ action: T.CODEX_REFERRAL_INVITE_MODAL_ACTION_CLOSE_CLICKED }), c());
      }),
      (t[28] = Ue),
      (t[29] = J),
      (t[30] = c),
  ...
  t[32] !== J || t[33] !== c
    ? ((Y = () => {
        (J({ action: T.CODEX_REFERRAL_INVITE_MODAL_ACTION_DONE_CLICKED }), c());
      }),
      (t[32] = J),
      (t[33] = c),
      (t[34] = Y))
  ...
  t[53] !== ct
    ? ((Ct = async () => {
        ...
        let n = t.filter(hn);
        if (n.length > 0) {
          (ge(n), B({ type: `error`, message: kn(n, y), reason: `invalidEmails` }));
          return;
        }
        (J({ action: T.CODEX_REFERRAL_INVITE_MODAL_ACTION_SEND_CLICKED, emailCount: t.length }),
          Me(ct ? `submittingRateLimitReset` : `submitting`));
        try {
          let e = await Ne.mutateAsync({ emails: t, referralKey: m });
          (J({
            action: T.CODEX_REFERRAL_INVITE_MODAL_ACTION_SEND_SUCCEEDED,
          ...
          (Me(`idle`),
            ...
            n != null &&
              J({
                action: T.CODEX_REFERRAL_INVITE_MODAL_ACTION_BACKEND_ERROR,
                emailCount: t.length,
    ...
    return (
      ...
      (0, $.jsx)(at, {
        form: {
          ...
          consent: { checked: ve, id: N, recipientCount: L.length, visible: et },
          submission: {
            busy: Ue,
            disabled: !$e || Le || (Qe && !ve) || W,
            inactive: W,
            loading: He,
          },
          actions: {
  ...
  let It;
  t[82] !== se || t[83] !== Ft
    ? ((It = { "aria-describedby": se, onEscapeKeyDown: Ft }),
      (t[82] = se),
      (t[83] = Ft),
      (t[84] = It))
    : (It = t[84]);
  ...
  t[118] !== _t || t[119] !== y || t[120] !== H || t[121] !== He || t[122] !== U
    ? ((on = H
        ...
        : (0, $.jsx)(`button`, {
            ...
            children: (0, $.jsx)(ae, { className: `size-4 stroke-[2.4]` }),
          })),
      (t[118] = _t),
      (t[119] = y),
      (t[120] = H),
  ...
  t[147] === M
    ? (Wn = t[148])
    : ((Wn = (0, $.jsx)(`label`, { className: `sr-only`, htmlFor: M, children: Un })),
      (t[147] = M),
      (t[148] = Wn));
  let Gn =
      Ke &&
            ...
            `span`,
            {
              ...
              children: [
                ...
                (0, $.jsx)(`button`, {
                  ...
                  type: `button`,
                  children: (0, $.jsx)(ae, { className: `size-3.5 stroke-[2.4]` }),
                }),
              ],
            },
            e,
  ...
  let xr = U ? se : void 0,
    ...
    Cr;
  t[227] !== D || t[228] !== d || t[229] !== k || t[230] !== it || t[231] !== ot || t[232] !== Sr
    ? ((Cr = (0, $.jsx)(Cn, {
        count: Sr,
        credits: it,
        grantAmount: it,
  ...
  let kr;
  t[242] !== vt || t[243] !== Dr
    ? ((kr = (0, $.jsx)(te, { className: Dr, onClick: vt, type: `button`, children: Or })),
      (t[242] = vt),
      (t[243] = Dr),
      (t[244] = kr))
    : (kr = t[244]);
...
function fn(e) {
  ye({ event: e, href: Vn, initiator: `open_in_browser_bridge` });
}
function pn(e) {
  return !e;
}
...
function Pn(e) {
  switch (e) {
    ...
    case A.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_VALIDATION_FAILED:
      return b.CODEX_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_USER;
    ...
    case A.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNKNOWN_BACKEND_ERROR:
      return b.CODEX_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_SYSTEM;
    case A.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNSPECIFIED:
    case A.UNRECOGNIZED:
      return b.CODEX_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_UNSPECIFIED;
  }
}
function Fn(e) {
  ...
  Un = e(() => {
    ((In = r()),
      ...
      (Hn = g({
        detail: l([
          f(),
          g({ message: f().optional(), failed_emails: y(f()).optional() }),
        ]).optional(),
      })));
  });
