...
function On({ onClose: e, target: t }) {
  ...
  let E = M(_e, w),
    ...
    L = w != null && !St(),
    R = u && (p || !s.some((e) => Se(e))),
    ee = !m && (_.kind === `git` || !1) && !s.some((e) => e.tabId === c.DIFF),
    ne = I && !s.some((e) => e.tabId === c.TIMELINE),
    ie = Qe(n),
    ...
    le = () => {
      w != null &&
        _n(n, hn, {
          ...
          .catch((e) => {
            (Ce.error(`Error opening side chat`, { safe: {}, sensitive: { error: e } }),
              n
                .get(je)
                .danger(
                  r.formatMessage({
    ...
    he = () => {
      b != null && (it(n, null, { hostId: x.id, target: t, workspaceRoot: b }), e?.());
    },
    ge = () => {
      (pt(n, t), e?.());
    },
    ve = (e, t, n) => {
      if (t == null) {
        d({ href: e, initiator: `mcp_app_resource`, originHostId: n });
        return;
      }
      Ie({ event: t, href: e, initiator: `mcp_app_resource`, originHostId: n });
    },
    ye = (e, t) => {
      switch (e.type) {
        case `file`:
  ...
  return {
    actions:
      _.kind === `git` ? [...z].sort((e, t) => (An[e.id] ?? z.length) - (An[t.id] ?? z.length)) : z,
...
var K,
  ...
  jn = e(() => {
    (o(),
      ...
      Ut(),
      (K = u()),
      (kn = ve(N, ({ get: e }) => e(on).filter((e) => e.entrypoint === `thread`))),
...
function Ln(e) {
  ...
  switch (n.type) {
    ...
    case `google-drive`: {
      ...
      return (
        t[4] !== n.resourceKind || t[5] !== r
          ? ((e = (0, q.jsx)($t, { className: r, resourceKind: n.resourceKind })),
            (t[4] = n.resourceKind),
            (t[5] = r),
            (t[6] = e))
          : (e = t[6]),
    ...
    case `appgen-app`: {
      let e;
      return (
        t[7] === r ? (e = t[8]) : ((e = (0, q.jsx)(Mt, { className: r })), (t[7] = r), (t[8] = e)),
        e
      );
    }
    case `website`: {
      ...
      return (
        t[9] === r
          ? (e = t[10])
          : ((e = (0, q.jsx)(Te, { className: r })), (t[9] = r), (t[10] = e)),
        e
      );
    }
  }
...
function Bn(e) {
            ...
            H.Item,
            {
              ...
              children: [
                e.mcpServerIcon == null
                  ? null
                  : (0, J.jsx)(H.ItemIcon, { children: Dt(e.mcpServerIcon) }),
                e.title,
              ],
            },
            e.id,
  ...
  t[6] !== n.length || t[7] !== s || t[8] !== a || t[9] !== o
    ? ((l = s
        ? (0, J.jsxs)(J.Fragment, {
            children: [
              n.length > 0 ? (0, J.jsx)(H.Separator, {}) : null,
              (0, J.jsx)(H.SectionLabel, {
                children: (0, J.jsx)(U, {
              ...
              o.map((e) =>
                (0, J.jsxs)(
                  ...
                  {
                    onClickCapture: (t) => {
                      I(t) && (t.preventDefault(), t.stopPropagation(), a(e, t));
                    },
                    onSelect: () => a(e),
                    children: [
                      (0, J.jsx)(H.ItemIcon, {
...
function Un(e) {
  ...
  return (
    t[7] !== i || t[8] !== c || t[9] !== d
      ? ((f = (0, Gn.jsx)(Ee, { tooltipContent: i, shortcut: c, delayOpen: !0, children: d })),
        (t[7] = i),
        (t[8] = c),
        (t[9] = d),
        (t[10] = f))
...
function qn(e) {
  ...
  if (
    ...
    bb0: {
      ((j = o ? p.filter(Zn) : p),
        (v = ln({ preferredTarget: f, targets: j, availableTargets: m, mode: `editor` })),
  ...
  t[35] === y
    ...
    : ((F = y
        ...
        : (0, Y.jsx)(`span`, {
            className: `truncate`,
            children: (0, Y.jsx)(U, { ...nr.openPrimaryTarget }),
          })),
      (t[35] = y),
      (t[36] = F));
  let I;
...
function ir(e) {
  let t = (0, ar.c)(5),
    ...
    a = M(ie, n),
    o;
  t[0] === i.cwd ? (o = t[1]) : ((o = i.cwd == null ? null : f(i.cwd)), (t[0] = i.cwd), (t[1] = o));
  let s = o;
  if (s == null || !a || i.kind !== `git` || r.kind === `remote-control`) return null;
  let c;
  return (
    t[2] !== s || t[3] !== r
      ? ((c = (0, or.jsx)(W.HeaderAction, {
...
function ur(e) {
  ...
  t[0] === _
    ? (v = t[1])
    : ((v = l(`sticky top-0 z-10 flex flex-col gap-6 bg-token-main-surface-primary`, _)),
      (t[0] = _),
      (t[1] = v));
  let b;
  t[2] !== n || t[3] !== o
  ...
  t[5] === a
    ...
    : ((x =
      ...
      (t[6] = x));
  let S;
  t[7] !== p || t[8] !== v || t[9] !== b || t[10] !== x
    ? ((S = (0, Z.jsxs)(`div`, { ref: p, className: v, children: [b, x] })),
      (t[7] = p),
      (t[8] = v),
      (t[9] = b),
      (t[10] = x),
    ...
    : (S = t[11]);
  let C;
  t[12] !== m || t[13] !== r || t[14] !== c || t[15] !== a
    ? ((C =
        a == null
          ? null
          : (0, Z.jsxs)(Z.Fragment, {
              children: [
                (0, Z.jsx)(fr, { headerHeight: m.height, root: c, onCoveredChange: f }),
  ...
  t[5] === r
    ...
    : ((d = r
        ? (0, Z.jsx)(`span`, {
            ...
            children: (0, Z.jsx)(Ne, { keysLabel: r }),
          })
        : null),
      (t[5] = r),
      (t[6] = d));
...
function hr(e) {
  ...
  let h;
  t[10] !== n || t[11] !== a
    ? ((h = (e) => a(n, e)), (t[10] = n), (t[11] = a), (t[12] = h))
    : (h = t[12]);
  let g;
  t[13] === n
    ? (g = t[14])
    : ((g = (0, Z.jsx)(`span`, {
      ...
      (t[14] = g));
  let _;
  t[15] === n ? (_ = t[16]) : ((_ = Nn(n)), (t[15] = n), (t[16] = _));
  let v;
  t[17] === _
    ? (v = t[18])
    : ((v = (0, Z.jsx)(`span`, {
  ...
  return (
    t[30] !== b || t[31] !== s
      ? ((x = (0, Z.jsx)(`li`, { className: s, children: b })),
        (t[30] = b),
        (t[31] = s),
        (t[32] = x))
      : (x = t[32]),
    ...
    ((X = V()),
      ...
      (_r = {
        closed: {
          opacity: 0,
          y: -8,
          transition: { duration: 0.06, ease: P.ease, when: `afterChildren` },
        },
        open: {
          opacity: 1,
          y: 0,
          transition: { duration: 0.09, ease: P.ease, when: `beforeChildren` },
        },
      }),
      (vr = {
      ...
      (yr = {
        closed: { opacity: 0, y: -6, transition: { duration: 0.045, ease: P.ease } },
        open: { opacity: 1, y: 0, transition: { duration: 0.075, ease: P.ease } },
      }));
  });
function xr(e) {
  let t = (0, Q.c)(26),
  ...
  (t[0] !== o || t[1] !== c || t[2] !== n
    ...
    (0, kr.useEffect)(m, h));
  let _;
  t[5] === n ? (_ = t[6]) : ((_ = () => en(n)), (t[5] = n), (t[6] = _));
  let v;
  ...
  (t[9] !== a.id || t[10] !== l || t[11] !== e.threadType || t[12] !== n || t[13] !== i
    ? ((b = () => {
        !l ||
          e.threadType === `remote` ||
          i == null ||
          it(n, null, { hostId: a.id, workspaceRoot: i });
      }),
                  ...
                  children: [
                    ...
                    (0, $.jsx)(W.HeaderAction, {
                      ...
                      children: (0, $.jsx)(Un, {
                        ...
                        onClick: () => Qt(n),
                        children: c
                          ? (0, $.jsx)(Je, { className: `icon-sm rotate-180` })
                          : (0, $.jsx)(ut, { className: `icon-sm rotate-180` }),
                      }),
                    }),
                  ],
                })
...
function Sr() {
  let e = (0, Q.c)(7),
    t = g(D),
    n;
  e[0] === t ? (n = e[1]) : ((n = re(t)), (e[0] = t), (e[1] = n));
  let r = n,
    i;
  e[2] === r
    ? (i = e[3])
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(W.RightPanelOutlet, { children: (0, $.jsx)(W.RightPanelTabs, {}) })),
      (e[4] = a))
    : (a = e[4]);
  let o;
  return (
...
function Cr(e) {
  let t = (0, Q.c)(41),
    ...
    u = y(He) === `ready`,
    d;
  t[0] !== u || t[1] !== r ? ((d = u && Qe(r)), (t[0] = u), (t[1] = r), (t[2] = d)) : (d = t[2]);
  let f = d,
    m;
  t[3] !== l || t[4] !== f || t[5] !== o || t[6] !== a || t[7] !== r
    ? ((m = () => {
        if (o) {
          if (a) {
            dt(r, `bottom`);
          ...
          st(r, `bottom`, { activateFallbackTab: !0, allowEmpty: !0 }) && r.get(Be) && Or();
        }
      }),
      (t[3] = l),
      (t[4] = f),
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, $.jsx)(W.BottomPanelOutlet, { children: (0, $.jsx)(W.BottomPanelTabs, {}) })),
      (t[18] = x))
    : (x = t[18]);
  let S;
  t[19] !== i || t[20] !== u
  ...
  t[22] === i
    ...
    : ((C = i.formatMessage({
      ...
      (t[23] = C));
  let w;
  t[24] === r ? (w = t[25]) : ((w = () => dt(r, `bottom`)), (t[24] = r), (t[25] = w));
  let T;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, $.jsx)(E, { className: `icon-xs` })), (t[26] = T))
    : (T = t[26]);
  let O;
  t[27] !== C || t[28] !== w
    ? ((O = (0, $.jsx)(W.BottomPanelTabListAfter, {
        children: (0, $.jsx)(p, {
          color: `ghost`,
          size: `toolbar`,
          uniform: !0,
    ...
    : (O = t[29]);
  let k;
  t[30] !== n || t[31] !== i || t[32] !== o || t[33] !== a || t[34] !== h || t[35] !== c
    ? ((k = o
        ? (0, $.jsx)(W.HeaderAction, {
  ...
  let A;
  return (
    t[37] !== O || t[38] !== k || t[39] !== S
      ? ((A = (0, $.jsxs)($.Fragment, { children: [b, x, S, O, k] })),
        (t[37] = O),
        (t[38] = k),
        (t[39] = S),
        (t[40] = A))
...
function wr(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(w, { className: `icon-xs` })), (t[5] = m))
    : (m = t[5]);
  let h;
  t[6] === r
    ? (h = t[7])
...
function Tr() {
  ...
  return (
    e[4] !== n || e[5] !== i
      ? ((a = (0, $.jsx)(W.HeaderContextMenuItem, {
          checked: n,
...
function Er(e) {
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, $.jsx)(W.RightPanelOutlet, { children: (0, $.jsx)(W.RightPanelTabs, {}) })),
      (t[7] = f))
    : (f = t[7]);
  let p;
  t[8] !== a || t[9] !== s
    ? ((p = s
        ? (0, $.jsxs)($.Fragment, {
            children: [
              (0, $.jsx)(W.RightPanelTabsEmptyState, { children: (0, $.jsx)(cr, {}) }),
  ...
  let h;
  t[13] === n ? (h = t[14]) : ((h = () => Qt(n)), (t[13] = n), (t[14] = h));
  let _;
  t[15] === o
    ? (_ = t[16])
    : ((_ = o
      ...
      (t[16] = _));
  let v;
  t[17] !== o || t[18] !== m || t[19] !== h || t[20] !== _ || t[21] !== c
    ? ((v = (0, $.jsx)(W.HeaderAction, {
        actionId: `thread-side-panel-close`,
        align: `end`,
        slotPosition: `right`,
        order: 300,
        children: (0, $.jsx)(Un, { label: m, pressed: o, shortcut: c, onClick: h, children: _ }),
      })),
      (t[17] = o),
      (t[18] = m),
      (t[19] = h),
  ...
  let b;
  return (
    t[23] !== v || t[24] !== l || t[25] !== u || t[26] !== p
      ? ((b = (0, $.jsxs)($.Fragment, { children: [l, u, d, f, p, v] })),
        (t[23] = v),
        (t[24] = l),
        (t[25] = u),
        (t[26] = p),
