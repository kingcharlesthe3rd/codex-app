  ...
  ze = e(() => {
    ((function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return Y.objectLiteral(t) && l.is(t.range) && (Y.string(t.uri) || Y.undefined(t.uri));
        }
        e.is = n;
      })((u ||= {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (l.is(t.originSelectionRange) || Y.undefined(t.originSelectionRange))
          );
        }
        e.is = n;
      })((d ||= {})),
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (Y.undefined(t.additionalTextEdits) || Y.typedArray(t.additionalTextEdits, v.is))
          );
        }
        e.is = n;
      })((te ||= {})),
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (Y.undefined(t.codeDescription) || Y.string(t.codeDescription?.href)) &&
            (Y.string(t.source) || Y.undefined(t.source)) &&
            (Y.undefined(t.relatedInformation) || Y.typedArray(t.relatedInformation, h.is))
          );
        }
        e.is = n;
      })((g ||= {})),
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            Y.objectLiteral(t) &&
            Y.string(t.label) &&
            (Y.boolean(t.needsConfirmation) || t.needsConfirmation === void 0) &&
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            Y.string(t.uri) &&
            (t.options === void 0 ||
              ((t.options.overwrite === void 0 || Y.boolean(t.options.overwrite)) &&
                (t.options.ignoreIfExists === void 0 || Y.boolean(t.options.ignoreIfExists)))) &&
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            Y.string(t.uri) &&
            (t.options === void 0 ||
              ((t.options.recursive === void 0 || Y.boolean(t.options.recursive)) &&
      ...
      (O = class {
        ...
        manage(e, t) {
          let n;
          if ((b.is(e) ? (n = e) : ((n = this.nextId()), (t = e)), this._annotations[n] !== void 0))
      ...
      (ae = class {
        ...
        createFile(e, t, n) {
          ...
          if (
            (r === void 0
              ? (i = C.create(e, n))
              : ((a = b.is(r) ? r : this._changeAnnotations.manage(r)), (i = C.create(e, n, a))),
        ...
        renameFile(e, t, n, r) {
          ...
          if (
            (i === void 0
              ? (a = w.create(e, t, r))
              : ((o = b.is(i) ? i : this._changeAnnotations.manage(i)), (a = w.create(e, t, r, o))),
        ...
        deleteFile(e, t, n) {
          ...
          if (
            (r === void 0
              ? (i = T.create(e, n))
              : ((a = b.is(r) ? r : this._changeAnnotations.manage(r)), (i = T.create(e, n, a))),
            this._workspaceEdit.documentChanges.push(i),
            a !== void 0)
          )
            return a;
      ...
      (function (e) {
        function t(e) {
          ...
          return (
            !!t &&
            Y.objectLiteral(t) &&
            (j.is(t.contents) || B.is(t.contents) || Y.typedArray(t.contents, B.is)) &&
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return Y.defined(t) && l.is(t.range) && (Y.undefined(t.command) || _.is(t.command));
        }
        e.is = n;
      })((_e ||= {})),
      (function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return Y.defined(t) && l.is(t.range) && (Y.undefined(t.target) || Y.string(t.target));
        }
        e.is = n;
      })((ye ||= {})),
      (function (e) {
        ...
        function n(t) {
          let n = t;
          return Y.objectLiteral(n) && l.is(n.range) && (n.parent === void 0 || e.is(n.parent));
        }
        e.is = n;
      })((be ||= {})),
      (function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return t != null && l.is(t.range) && (Y.string(t.expression) || t.expression === void 0);
        }
        e.is = n;
      })((Ee ||= {})),
      (function (e) {
...
function He(e, t, n = 0) {
  ...
  for (let t = 0; t < e.length; t++) {
    ...
    Ue(i) && (i === 13 && t + 1 < e.length && e.charCodeAt(t + 1) === 10 && t++, r.push(n + t + 1));
  }
  return r;
}
function Ue(e) {
...
var $,
  ...
  qe = e(() => {
    (($ = class e {
      ...
      getLineOffsets() {
        return (
          this._lineOffsets === void 0 && (this._lineOffsets = He(this._content, !0)),
          this._lineOffsets
        );
      }
      positionAt(e) {
...
export { Z as a, l as c, Be as i, ze as l, qe as n, X as o, Ve as r, c as s, Ke as t, r as u };
