...
function O() {
  let e = (0, A.c)(22),
    ...
    a = f(),
    u = _(),
    { getPendingAppConnectForCallbackUrl: d } = r(),
    { markRequiredAppStatus: m, session: y } = h(),
    b = (0, j.useRef)(null),
    x;
  e[0] !== m || e[1] !== y.app || e[2] !== y.kind
    ? ((x = (e) => {
        let { appId: t, status: n } = e;
        y.kind !== `connectAppBeforeInstall` ||
          (t != null && y.app.id !== t) ||
          m({ appId: y.app.id, status: n });
      }),
      (e[0] = m),
      (e[1] = y.app),
      (e[2] = y.kind),
  ...
  e[4] !== u || e[5] !== n || e[6] !== t
    ? ((T = async (e) => {
        ...
        let d = await u({ fullRedirectUrl: a ?? `` });
        bb32: switch (d.kind) {
      ...
      (e[7] = T))
    : (T = e[7]);
  let D = (0, j.useEffectEvent)(T),
    O;
  e[8] !== d || e[9] !== a.key || e[10] !== a.state || e[11] !== C || e[12] !== i || e[13] !== D
    ? ((O = () => {
        if (b.current === a.key) return;
        b.current = a.key;
        let e = g(a.state),
        ...
        D({
          ...
          shouldShowSuccessToast: !o && !c,
        }).then((e) => {
          if (
            (e.kind === `success`
              ? C({ appId: e.appId, status: `connected` })
              : (o || n == null) && C({ appId: n?.appId, status: `pending` }),
            s(l, r) != null)
          ) {
            i(r, { replace: !0 });
            return;
    ...
    : (O = e[14]);
  let N;
  (e[15] !== d || e[16] !== n || e[17] !== a.key || e[18] !== a.state || e[19] !== i
    ? ((N = [d, n, a.key, a.state, i]),
      (e[15] = d),
      (e[16] = n),
      (e[17] = a.key),
      (e[18] = a.state),
  ...
  return (
    e[21] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((P = (0, M.jsx)(`div`, {
          ...
          children: (0, M.jsx)(S, { className: `icon-sm` }),
        })),
        (e[21] = P))
      : (P = e[21]),
    P
...
var A, j, M;
e(() => {
  ((A = b()), u(), d(), (j = t(x(), 1)), m(), a(), D(), C(), n(), y(), i(), (M = T()));
})();
