...
import { nn as i, rn as a, tn as o } from "./app-initial~app-main~automations-page.js";
import { h as s, m as c, p as l } from "./avatar-overlay-pill-dismiss-button.js";
import { i as u, r as d } from "./custom-avatars-query.js";
import { n as f, t as p } from "./use-avatar-options-vcIh-Q1n.js";
function m(e) {
...
function _(e, t) {
  ...
  let n = e.samples[0];
  return (
    n != null && (Math.abs(t.screenX - n.screenX) >= 4 || Math.abs(t.screenY - n.screenY) >= 4)
  );
}
function v(e) {
  let t = e.at(-1);
...
function b(e) {
  ...
  for (; n > 0; ) {
    let r = e[n - 1];
    if (r == null || Math.abs(t.screenX - r.screenX) >= 4 || Math.abs(t.screenY - r.screenY) >= 4)
      break;
    --n;
  }
  return e[n];
  ...
  return e
    .map((e) =>
      [
        ...
        e.action?.path ?? ``,
        e.waitingRequest == null ? `` : c(e.waitingRequest, t),
      ].join(``),
    )
    .join(`\0`);
}
...
function P(e, t, n) {
  let r = Number(t.notification.kind === `activity`) - Number(e.notification.kind === `activity`);
  if (r !== 0) return r;
  if (n) {
...
function H() {
  let e = (0, U.c)(3),
    ...
    c = i(o, s),
    { isFetching: l } = n(u, s ?? o.id),
    d = c && (r || l) ? null : o,
    p;
  return (
    e[0] !== s || e[1] !== d
      ? ((p = { selectedAvatar: d, selectedAvatarId: s }), (e[0] = s), (e[1] = d), (e[2] = p))
      : (p = e[2]),
    p
  );
}
...
export { V as a, g as c, T as d, O as i, m as l, H as n, E as o, k as r, D as s, W as t, v as u };
