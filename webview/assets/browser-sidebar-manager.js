...
var l = `responsive`,
  ...
  h = { isEnabled: !1, presetId: f.id, width: f.width, height: f.height };
function g(e, t) {
  ...
  let n = b(e),
    ...
    s = { x: Math.round(n.x + Math.max(p, (n.width - a) / 2)), y: n.y, width: a, height: o };
  return {
    fitHeight: r.height,
    fitWidth: r.width,
    scale: i,
...
function _(e) {
  if (e == null) return { width: h.width, height: h.height };
  let t = ne(b(e));
  return { width: x(t.width), height: S(t.height) };
}
function v(e) {
  return e + p * 2;
}
function y({ fitHeight: e, height: t, width: n }) {
...
function ne(e) {
  return { width: Math.max(0, e.width - p * 2), height: Math.max(0, e.height - p) };
}
function re({ drag: e, fitHeight: t, fitWidth: n, pointerX: r, pointerY: i, scale: a }) {
  let o = e.edge === `bottom` || e.edge === `bottom-left` || e.edge === `bottom-right`,
    s = e.edge !== `bottom`,
    c = e.edge === `left` || e.edge === `bottom-left` ? -1 : 1;
  return {
    width: s
      ? x(oe({ fitSize: n, rawSize: e.startWidth + ((r - e.startPointerX) * c * 2) / a, scale: a }))
      : e.startWidth,
    height: o
      ? S(oe({ fitSize: t, rawSize: e.startHeight + (i - e.startPointerY) / a, scale: a }))
      : e.startHeight,
  };
}
function ie({ height: e, width: t }) {
  return { width: x(e), height: S(t) };
}
function ae(e) {
  let t = se(e.presetId),
    n =
  ...
  return { ...e, ...ie(e), presetId: n ? e.presetId : l };
}
function oe({ fitSize: e, rawSize: t, scale: n }) {
  return e <= 0 ? t : Math.min(t, e / n);
}
function se(e) {
  return m.find((t) => t.id === e) ?? null;
}
function x(e) {
  return C(e, 240, u);
}
    ...
    scheduleCommitAfterPrewarm(e, n, r = le) {
      if (
        ...
        (t.info(`IAB_TAB_SWITCH renderer prewarming Owl webview handoff before reveal`, {
          safe: { ...E(n), hostKind: e, remainingFrames: r },
          sensitive: {},
        }),
    ...
    cancel(e, n, r) {
      ...
      i != null &&
        ...
        t.info(`IAB_TAB_SWITCH renderer cancelled Owl webview handoff`, {
          safe: { ...E(i), detachOutgoing: r, hostKind: e, reason: n },
          sensitive: {},
        }));
    }
  };
...
var pe = `about:blank`,
  me = `data-browser-sidebar-conversation-id`,
  O = `data-browser-sidebar-browser-tab-id`,
  k = `data-browser-sidebar-webview-host-root`,
  A = `data-browser-sidebar-cursor-overlay-host`,
  j = `owl-webcontents-adoption-lease`,
  M = `owl-webcontents-adopted-web-contents-id`,
  N = `data-browser-sidebar-adopted-initial-url`,
  he = `persist:codex-browser-app-route:`,
  P = `var(--color-token-editor-background, var(--color-token-main-surface-primary, #fff))`,
  ge = `0.001`,
  _e = `0.001`,
  F = { x: 0, y: 0, width: 1280, height: 720 },
  I = class {
    browserTabId;
    conversationId;
    container;
      ...
      if (this.webview != null) {
        if (e == null || t == null) {
          (this.webview.removeAttribute(j),
            this.webview.removeAttribute(M),
            this.webview.removeAttribute(N));
          return;
        }
        (this.webview.setAttribute(j, e),
          this.webview.setAttribute(M, t.toString()),
          this.webview.setAttribute(N, n));
      }
    }
    resync() {
      let e = this.container;
    ...
    transfer({ browserTabId: e, conversationId: t, elementKey: n, partition: r }) {
      ...
      i == null ||
        ...
        this.cursorOverlayHost?.setAttribute(A, n),
        a.setAttribute(me, t),
        a.setAttribute(O, e),
    ...
    syncContainerStyle() {
      ...
      if (i != null && this.browserUseCaptureSurfaceSize == null) {
        ...
        return a == null
          ? r || this.state.shouldPaint === !1
            ? (V(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `bootstrap`)
            : this.isStaged
              ? (ye(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `staged`)
              : (z(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `visible`)
          : (B(e, n, t, a), `hidden`);
      }
      let a = R({
      ...
      return a == null
        ...
        : (this.attachToDom(), B(e, n, t, a), `hidden`);
    }
    ...
    parkInDom() {
      ...
      let r = this.lastVisibleBounds ?? F;
      (this.attachToDom(), V(e, n, t, r, this.state.scale, this.state.windowZoom ?? 1));
    }
    detachFromDom() {
...
function ve({ bounds: e, isVisible: t, lastVisibleBounds: n }) {
  return t ? (e != null && e.width > 0 && e.height > 0 ? e : (n ?? F)) : null;
}
function R({
  ...
  return n ? (e == null ? (t == null ? (r ?? F) : be(t)) : be(e)) : null;
}
...
function V(e, t, n, r, i, a) {
  (z(e, t, n, r, i, a), Object.assign(e.style, { pointerEvents: `none`, visibility: `hidden` }));
}
function ye(e, t, n, r, i, a) {
  (z(e, t, n, r, i, a), Object.assign(e.style, { opacity: ge, pointerEvents: `none` }));
}
function be(e) {
  return { x: F.x, y: F.y, width: e.width, height: e.height };
}
function xe(e, t, n = 1) {
  Object.assign(e.style, {
    height: `${t.height}px`,
...
var Le = { responsiveViewportSize: null, toolbarState: h },
  Re = new Set([`new-conversation`, `panel-new-conversation`]),
  X = `default`,
  ze = new (class {
    listeners = new Set();
    ...
    getBrowserUseBrowserTabSummarySyncKey(e) {
      ...
      return n == null ? `` : Ve(n, this.getSnapshot(e, n));
    }
    ...
    removeTab(e, t) {
      ...
      (r instanceof I && this.electronPageHandoff.removeTab(r),
    ...
    clearBrowserUseState() {
      ...
      for (let t of e) {
        let { browserTabId: e, conversationId: n } = Be(t);
    ...
    setBrowserUseViewportSize(e, ...t) {
      let n = t.length === 1 ? $(e, void 0) : t[0],
        ...
        i = Z(e, n),
        a = r == null ? null : { width: x(r.width), height: S(r.height) };
    ...
    reassociateTabState(n, ...r) {
      ...
      d instanceof I && this.electronPageHandoff.transferRoute(d);
      let ee = this.webviews.get(u) ?? null,
        f = this.snapshots.get(l) ?? null;
      (this.pendingElectronTransfers.delete(l),
        ...
        d != null &&
          (ee == null
            ...
            : this.disposeWebviewHost(n, a, l, f?.tabType ?? `web`)));
      let p = this.browserUseViewportSizes.get(l) ?? null,
        m = this.browserUseTabKeys.has(l),
      ...
      let _ = !1;
      (m && (this.browserUseTabKeys.add(u), this.syncBrowserUseTabKeys(n), (_ = !0)),
        g && this.browserUseActiveTabKeys.add(u),
        p != null && this.browserUseViewportSizes.set(u, p),
        h != null && this.mountStates.set(u, { claimKeys: new Set(), generation: h.generation }),
      ...
      (f != null && (this.snapshots.delete(l), this.snapshots.set(u, f)),
    ...
    removeElectronWebviewFromHandoff(e) {
      e instanceof I && this.electronPageHandoff.disposeHost(e);
    }
    ...
    getConversationBrowserTabIdsFromKeys(e, t) {
      let r = `${e}\0`,
        i = [];
      for (let e of t) e.startsWith(r) && i.push(n(e.slice(r.length)));
      return i;
    }
    ...
    syncBrowserUseTabKeys(e) {
      ...
      (this.browserUseTabIdsKeysByConversation.set(e, t.join(`\0`)),
        this.browserUseTabSummarySyncKeysByConversation.set(
          e,
          t.map((t) => Ve(t, this.getSnapshot(e, t))).join(`\0`),
        ),
        this.refreshBrowserUseTabs());
    }
    refreshBrowserUseTabs() {
      this.browserUseTabs = Array.from(this.browserUseTabKeys, Be);
    }
