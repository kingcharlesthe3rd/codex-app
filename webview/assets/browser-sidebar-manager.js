...
function p(e, t) {
  ...
  let n = _(e),
    ...
    s = { x: Math.round(n.x + Math.max(u, (n.width - a) / 2)), y: n.y, width: a, height: o };
  return {
    fitHeight: r.height,
    fitWidth: r.width,
    scale: i,
...
function v(e) {
  return { width: Math.max(0, e.width - u * 2), height: Math.max(0, e.height - u) };
}
function y({ drag: e, fitHeight: t, fitWidth: n, pointerX: r, pointerY: i, scale: a }) {
  ...
  N = class {
    ...
    setAdoptionAttributes(e, t) {
      if (this.webview != null) {
        ...
        (this.webview.setAttribute(k, e), this.webview.setAttribute(A, t.toString()));
      }
    }
    resync() {
  ...
  W = class {
    ...
    detach(e) {
      ((this.isAttached = !1),
        ...
        this.syncContainerStyle(),
        r.info(`IAB_LIFECYCLE renderer detached legacy browser sidebar webview`, {
          safe: { browserTabId: this.browserTabId, conversationId: this.conversationId },
        }));
    }
    sync(e, t) {
    ...
    dispose() {
      (r.info(`IAB_LIFECYCLE renderer disposed legacy browser sidebar webview`, {
        safe: { browserTabId: this.browserTabId, conversationId: this.conversationId },
      }),
        this.container.remove());
    }
...
var ge = { responsiveViewportSize: null, toolbarState: f },
  ...
  ve = new (class {
    ...
    getBrowserUseActiveBrowserTabId(e) {
      return this.getFirstConversationBrowserTabId(e, this.browserUseActiveStates);
    }
    ...
    removeTab(e, t) {
      ...
      (this.pendingElectronTransfers.delete(n),
        ...
        this.browserUseActiveStates.delete(n) && this.refreshBrowserUseActiveTabs(),
    ...
    getWebview(e, ...t) {
      ...
      if (s instanceof N)
        return (
          a != null &&
            s.setAdoptionAttributes(a.adoptionLease ?? null, a.adoptedWebContentsId ?? null),
          s
        );
    ...
    getLegacyWebview(e, t, n, i) {
      ...
      return (
        ...
        r.info(`IAB_LIFECYCLE renderer created legacy browser sidebar webview`, {
    ...
    setBrowserUseActive(e, ...t) {
      ...
      (i
        ? (this.browserUseActiveStates.add(a), o || this.browserUseCursorStates.delete(a))
        : (this.browserUseActiveStates.delete(a),
          s != null && this.browserUseCursorStates.set(a, { visible: !1, x: s.x, y: s.y })),
    ...
    setBrowserUseViewportSize(e, ...t) {
      ...
      (o == null ? this.browserUseViewportSizes.delete(i) : this.browserUseViewportSizes.set(i, o),
        ...
        this.setDeviceToolbarTabState(e, n, (e) =>
          o == null
            ...
            : {
                ...
                toolbarState: { ...e.toolbarState, ...o, isEnabled: !0, presetId: a },
              },
        ));
    }
    ...
    reassociateTabState(t, ...n) {
      ...
      (this.browserUseCaptureSurfaceSizes.delete(c),
        ...
        this.browserUseActiveStates.delete(c) && this.refreshBrowserUseActiveTabs(),
        this.browserUseViewportSizes.delete(c),
        this.mountStates.delete(c),
        this.pendingElectronTransfers.set(l, { sourceBrowserTabId: i, sourceConversationId: t }),
        p != null && this.browserUseViewportSizes.set(l, p),
        m != null && this.mountStates.set(l, { generation: m.generation, isClaimed: !1 }),
      ...
      (f != null && (this.snapshots.delete(c), this.snapshots.set(l, f)),
        ...
        g != null && (this.deviceToolbarTabStates.delete(c), this.deviceToolbarTabStates.set(l, g)),
    ...
    disposeAll() {
      (this.snapshots.clear(),
        ...
        this.browserUseActiveStates.size > 0 &&
          (this.browserUseActiveStates.clear(), this.refreshBrowserUseActiveTabs()),
