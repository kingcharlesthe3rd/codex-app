import { f as e, h as t } from "./vscode-api.js";
import { ei as n, hi as r, yi as i } from "./src-1.js";
import { k as a } from "./app-shell-state.js";
import { o } from "./persisted-signal.js";
import { t as s } from "./constants.js";
import { n as c } from "./browser-sidebar-open-source.js";
var l = `responsive`,
  u = 4096,
  d = 4096,
  f = `var(--gray-700)`,
  p = { id: l, width: 390, height: 844 },
  m = 20,
  h = [
    p,
  ...
  g = { isEnabled: !1, presetId: p.id, width: p.width, height: p.height };
function ee(e, t) {
  ...
  let n = y(e),
    ...
    s = { x: Math.round(n.x + Math.max(m, (n.width - a) / 2)), y: n.y, width: a, height: o };
  return {
    fitHeight: r.height,
    fitWidth: r.width,
    scale: i,
...
function te(e) {
  if (e == null) return { width: g.width, height: g.height };
  let t = x(y(e));
...
function x(e) {
  return { width: Math.max(0, e.width - m * 2), height: Math.max(0, e.height - m) };
}
function ne({ drag: e, fitHeight: t, fitWidth: n, pointerX: r, pointerY: i, scale: a }) {
  ...
  return {
    width: s
      ? S(ae({ fitSize: n, rawSize: e.startWidth + ((r - e.startPointerX) * c * 2) / a, scale: a }))
      : e.startWidth,
    height: o
      ? C(ae({ fitSize: t, rawSize: e.startHeight + (i - e.startPointerY) / a, scale: a }))
      : e.startHeight,
  };
}
...
function ie(e) {
  ...
  return { ...e, ...re(e), presetId: n ? e.presetId : l };
}
function ae({ fitSize: e, rawSize: t, scale: n }) {
...
var ce = 100,
  ...
  ue = class {
    ...
    scheduleCommitAfterPrewarm(e, n, r = le) {
      if (
...
var me = `about:blank`,
  he = `data-browser-sidebar-conversation-id`,
  ge = `data-browser-sidebar-browser-tab-id`,
  ...
  _e = `persist:codex-browser-app-route:`,
  ...
  P = class {
    ...
    hasBrowserUsePaintHost = !1;
    isBrowserUseActive = !1;
    isTabCaptureActive = !1;
    isAttached = !1;
    shouldDetachWhenInactive = !1;
    isDisposed = !1;
    ...
    constructor({
      ...
      let c = document.createElement(`div`),
        ...
        u = document.createElement(`webview`);
      ((this.browserTabId = e),
        (this.conversationId = t),
        (this.container = c),
        (this.cursorOverlayHost = l),
        (this.hostKind = r),
        (this.webview = u),
        (c.dataset.browserSidebarWebview = n),
        E(c, r),
        l.setAttribute(O, n),
        (u.className = `h-full w-full`),
        (u.style.backgroundColor = M),
        u.setAttribute(he, t),
        u.setAttribute(ge, e),
        u.setAttribute(`partition`, i),
        u.setAttribute(`webviewrole`, `tab`),
        this.setAdoptionAttributes(a ?? null, o ?? null, s),
        u.setAttribute(`src`, me));
      let d = () => {
        this.finishPendingDetach();
      };
      (u.addEventListener(`did-attach`, () => {
        this.isAttached = !0;
      }),
        u.addEventListener(`did-stop-loading`, d),
        u.addEventListener(`did-fail-load`, d),
        u.addEventListener(`render-process-gone`, d),
        u.addEventListener(`destroyed`, () => {
          ((this.isAttached = !1), this.finishPendingDetach());
        }),
        c.append(u, l));
    }
    setHostKind(e) {
      this.hostKind !== e && ((this.hostKind = e), E(this.container, e));
    }
    detach(e, n) {
      let r = this.webview;
      ...
      ((this.webviewRef = e),
        ...
        H(e, null, r));
      let a = this.isAttached && r.isLoading();
      (this.isTabCaptureActive || a
        ? ((this.shouldDetachWhenInactive = !0), this.syncContainerStyle())
        : this.detachFromDom(),
    ...
    sync(e, t) {
      ...
      ((this.webviewRef = t),
        (this.isInteractionBlocked = !1),
        (this.isStaged = !1),
        (this.shouldDetachWhenInactive = !1),
    ...
    bringToFront() {
      let e = this.container;
      e?.isConnected === !0 && e.nextElementSibling != null && Ce().append(e);
    }
    ...
    setTabCaptureActive(e) {
      if (this.isTabCaptureActive !== e) {
        if (((this.isTabCaptureActive = e), !e && this.shouldDetachWhenInactive)) {
          this.finishPendingDetach();
          return;
        }
        (e && !this.state.isVisible && (this.shouldDetachWhenInactive = !0),
          this.syncContainerStyle(),
      ...
      if (i != null && this.browserUseCaptureSurfaceSize == null) {
        ...
        return a == null
          ? r || this.state.shouldPaint === !1
            ? (z(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `bootstrap`)
            : this.isStaged
              ? (xe(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `staged`)
              : (L(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `visible`)
          : (R(e, n, t, a), `hidden`);
      }
      let a = I({
        browserUseCaptureSurfaceSize: this.browserUseCaptureSurfaceSize,
        browserUseViewportSize: this.browserUseViewportSize,
        isBrowserUseActive: this.hasBrowserUsePaintHost || this.isTabCaptureActive,
        lastVisibleBounds: this.lastVisibleBounds,
      });
      return a == null
        ? (this.parkInDom(), `hidden`)
        : (this.attachToDom(), R(e, n, t, a), `hidden`);
    }
    ...
    finishPendingDetach() {
      if (
        !(!this.shouldDetachWhenInactive || this.isTabCaptureActive) &&
        !(this.isAttached && this.webview?.isLoading())
      ) {
        if (((this.shouldDetachWhenInactive = !1), this.hasBrowserUsePaintHost)) {
          (this.syncContainerStyle(), this.applyBlockedInteractionStyle());
          return;
        }
        this.detachFromDom();
    ...
    parkInDom() {
      ...
      (this.attachToDom(), z(e, n, t, r, this.state.scale, this.state.windowZoom ?? 1));
    }
    detachFromDom() {
...
function F(e) {
  return `${_e}${encodeURIComponent(e)}`;
}
function be({ bounds: e, isVisible: t, lastVisibleBounds: n }) {
...
function I({
  ...
  return n ? (e == null ? (t == null ? (r ?? N) : B(t)) : B(e)) : null;
}
...
function z(e, t, n, r, i, a) {
  (L(e, t, n, r, i, a), Object.assign(e.style, { pointerEvents: `none`, visibility: `hidden` }));
}
function xe(e, t, n, r, i, a) {
  (L(e, t, n, r, i, a), Object.assign(e.style, { opacity: ve, pointerEvents: `none` }));
}
function B(e) {
...
var Ee = `about:blank`,
  De = `data-browser-sidebar-conversation-id`,
  Oe = `data-browser-sidebar-browser-tab-id`,
  ke = `data-browser-sidebar-retained-webview`,
  Ae = `data-browser-sidebar-cursor-overlay-host`,
  je = {
    contain: ``,
    height: `1px`,
    left: `-10000px`,
  ...
  G = class {
    ...
    constructor({
      ...
      ((this.browserTabId = e),
        ...
        (this.hostKind = a),
        (this.hasBrowserUsePaintHost = s || n != null),
        (this.isBrowserUseActive = s),
        (this.container.dataset.browserSidebarWebview = i),
        E(this.container, a),
        this.cursorOverlayHost.setAttribute(Ae, i),
        Fe(
          this.container,
          this.webview,
        ...
        this.webview.setAttribute(De, r),
        this.webview.setAttribute(Oe, e),
        this.webview.setAttribute(ke, ``),
        this.webview.setAttribute(`partition`, c),
        this.webview.setAttribute(`webviewrole`, `tab`),
        this.webview.setAttribute(`src`, o.length === 0 ? Ee : o),
    ...
    setTabCaptureActive(e) {
      this.isTabCaptureActive !== e && ((this.isTabCaptureActive = e), this.syncContainerStyle());
    }
    setBrowserUseViewportSize(e) {
      ((this.browserUseViewportSize = e),
    ...
    transfer({ browserTabId: e, conversationId: t, elementKey: n, partition: r }) {
      ((this.container.dataset.browserSidebarWebview = n),
        this.cursorOverlayHost.setAttribute(Ae, n),
        this.webview.setAttribute(De, t),
        this.webview.setAttribute(Oe, e),
    ...
    syncContainerStyle() {
      let e = Ne({
        ...
        browserUseCaptureSurfaceSize: this.browserUseCaptureSurfaceSize,
        browserUseViewportSize: this.browserUseViewportSize,
        hasBrowserUsePaintHost: this.hasBrowserUsePaintHost || this.isTabCaptureActive,
      ...
      if (e == null) {
        Fe(
          ...
          this.isBrowserUseActive || this.browserUseViewportSize != null || this.isTabCaptureActive,
        );
        return;
      }
...
function Fe(e, t, n, r, i, a) {
  if (a) {
    K(e, t, n, r ?? (i == null ? W : J(i)));
    return;
  }
  (Object.assign(e.style, je), Ie(t), q(n, { width: 1, height: 1 }));
}
function K(e, t, n, r) {
  (Object.assign(e.style, {
    contain: `layout paint size style`,
...
var Le = { responsiveViewportSize: null, toolbarState: g },
  X = `default`,
  Re = new (class {
    listeners = new Set();
    ...
    constructor() {
      (e.subscribe(`browser-sidebar-state`, (e) => {
        ...
        e.subscribe(`browser-sidebar-tab-capture-state`, (e) => {
    ...
    getBrowserUseBrowserTabSummarySyncKey(e) {
      ...
      return n == null ? `` : Be(n, this.getSnapshot(e, n));
    }
    getDeviceToolbarTabState(e, t = $(e, void 0)) {
      return this.deviceToolbarTabStates.get(Z(e, t)) ?? Le;
    }
    getMountGeneration(e, t = $(e, void 0)) {
      return this.mountStates.get(Z(e, t))?.generation ?? 0;
    }
    claimMountGeneration(e, t = $(e, void 0), n = X) {
      let r = Z(e, t),
    ...
    getWebview(e, ...n) {
      ...
      this.browserUseActiveTabKeys.has(o) && l.setBrowserUseActive(!0);
      let u = this.browserUseViewportSizes.get(o) ?? null;
      u != null && l.setBrowserUseViewportSize(u);
      let d = this.browserUseCaptureSurfaceSizes.get(o) ?? null;
      return (
        d != null && l.setBrowserUseCaptureSurfaceSize(d),
        l.setTabCaptureActive(this.tabCaptureActiveKeys.has(o)),
        this.webviews.set(o, l),
        this.notifyWebviewHostCreated(e, r, c),
        t.info(`IAB_LIFECYCLE renderer created browser sidebar webview`, {
          safe: { browserTabId: r, conversationId: e, hostKind: c },
    ...
    getRetainedWebview(e, n, r, i) {
      let a = Z(e, n),
        ...
        s = i?.hostKind ?? `right-panel`;
      if (o != null) return (o.setHostKind(s), o);
      let c = new G({
        browserTabId: n,
      ...
      return (
        c.setTabCaptureActive(this.tabCaptureActiveKeys.has(a)),
        this.webviews.set(a, c),
        this.notifyWebviewHostCreated(e, n, s),
        t.info(`IAB_LIFECYCLE renderer created retained browser sidebar webview`, {
          safe: { browserTabId: n, conversationId: e, hostKind: s },
    ...
    clearBrowserUseState() {
      ...
      for (let t of e) {
        let { browserTabId: e, conversationId: n } = ze(t);
        ...
        this.setDeviceToolbarTabState(e, n, (e) =>
          a == null
            ...
            : {
                ...
                toolbarState: { ...e.toolbarState, ...a, isEnabled: !0, presetId: l },
              },
        ));
    }
    ...
    reassociateTabState(n, ...r) {
      let a = r.length === 1 ? $(n, void 0) : r[0],
        o = r.length === 1 ? r[0] : r[1],
        s = r.length === 1 ? $(o, void 0) : r[2],
        c = r.length === 4 ? r[3] : void 0,
        l = i(Z(n, a), Z(o, s)),
        u = Z(n, a),
        d = Z(o, s);
      if (u === d || this.transferredWebviewKeys.has(l)) return;
      let f = this.webviews.get(u) ?? null;
      f instanceof P && this.electronPageHandoff.transferRoute(f);
      let p = this.webviews.get(d) ?? null,
        m = this.snapshots.get(u) ?? null;
      (this.pendingElectronTransfers.delete(u),
        this.pendingElectronTransfers.delete(d),
        this.transferredWebviewKeys.add(l));
      let h = f != null && p == null;
      f != null &&
        (h
          ...
          : this.disposeWebviewHost(n, a, u, m?.tabType ?? `web`));
      let g = this.browserUseViewportSizes.get(u) ?? null,
        ee = this.browserUseTabKeys.has(u),
        te = this.tabCaptureActiveKeys.delete(u),
        _ = this.mountStates.get(u) ?? null,
        v = this.browserUseActiveTabKeys.delete(u);
      (this.browserUseCaptureSurfaceSizes.delete(u),
        ...
        this.pendingElectronTransfers.set(d, { sourceBrowserTabId: a, sourceConversationId: n }),
      ...
      let y = !1;
      (ee && (this.browserUseTabKeys.add(d), this.syncBrowserUseTabKeys(n), (y = !0)),
        v && this.browserUseActiveTabKeys.add(d),
        g != null && this.browserUseViewportSizes.set(d, g),
        te && h && this.tabCaptureActiveKeys.add(d),
        _ != null && this.mountStates.set(d, { claimKeys: new Set(), generation: _.generation }),
      ...
      let b = this.deviceToolbarTabStates.get(u);
      (m != null && (this.snapshots.delete(u), this.snapshots.set(d, m)),
        y && this.syncBrowserUseTabKeys(o),
        b != null && (this.deviceToolbarTabStates.delete(u), this.deviceToolbarTabStates.set(d, b)),
        c?.removeSourceBrowserStateWhenEmpty && this.removeConversationBrowserStateIfEmpty(n),
        this.emitChange());
    }
    ...
    syncBrowserUseTabKeys(e) {
      ...
      (this.browserUseTabIdsKeysByConversation.set(e, t.join(`\0`)),
        this.browserUseTabSummarySyncKeysByConversation.set(
          e,
          t.map((t) => Be(t, this.getSnapshot(e, t))).join(`\0`),
        ),
        this.refreshBrowserUseTabs());
    }
    refreshBrowserUseTabs() {
      this.browserUseTabs = Array.from(this.browserUseTabKeys, ze);
    }
