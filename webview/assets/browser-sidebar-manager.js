...
import { Br as n, Tr as r, Wr as i } from "./src-1.js";
...
function ae({ drag: e, fitHeight: t, fitWidth: n, pointerX: r, pointerY: i, scale: a }) {
  let o = e.edge === `bottom` || e.edge === `bottom-left` || e.edge === `bottom-right`,
    s = e.edge !== `bottom`,
    c = e.edge === `left` || e.edge === `bottom-left` ? -1 : 1;
  return {
    width: s
      ? x(y({ fitSize: n, rawSize: e.startWidth + ((r - e.startPointerX) * c * 2) / a, scale: a }))
      : e.startWidth,
    height: o
      ? S(y({ fitSize: t, rawSize: e.startHeight + (i - e.startPointerY) / a, scale: a }))
      : e.startHeight,
  };
}
function oe({ height: e, width: t }) {
...
function se(e) {
  ...
  return { ...e, ...oe(e), presetId: n ? e.presetId : l };
}
function y({ fitSize: e, rawSize: t, scale: n }) {
...
var le = 100,
  ...
  de = class {
    ...
    disposeAll() {
      for (let e of C) (this.cancel(e, `manager-disposed`, !0), (this.paintedWebviews[e] = null));
    }
    stage(e, n, r, i) {
    ...
    scheduleCommitAfterPrewarm(e, n, r = ue) {
      if (
        ...
        (t.info(`IAB_TAB_SWITCH renderer prewarming Owl webview handoff before reveal`, {
          safe: { ...w(n), hostKind: e, remainingFrames: r },
          sensitive: {},
        }),
    ...
    cancel(e, n, r) {
      ...
      i != null &&
        ...
        t.info(`IAB_TAB_SWITCH renderer cancelled Owl webview handoff`, {
          safe: { ...w(i), detachOutgoing: r, hostKind: e, reason: n },
          sensitive: {},
        }));
    }
  };
...
var he = `about:blank`,
  ...
  D = `data-browser-sidebar-browser-tab-id`,
  O = `data-browser-sidebar-webview-host-root`,
  k = `data-browser-sidebar-cursor-overlay-host`,
  A = `owl-webcontents-adoption-lease`,
  j = `owl-webcontents-adopted-web-contents-id`,
  M = `data-browser-sidebar-adopted-initial-url`,
  ge = `persist:codex-browser-app-route:`,
  N = `var(--color-token-editor-background, var(--color-token-main-surface-primary, #fff))`,
  _e = `0.001`,
  ve = `0.001`,
  ...
  F = class {
    ...
    constructor({
      ...
      ((this.browserTabId = e),
        ...
        u.setAttribute(`src`, he),
        c.append(u, l));
    }
    setHostKind(e) {
      this.hostKind !== e && ((this.hostKind = e), T(this.container, e));
    }
    detach(e, n) {
      let r = this.webview;
    ...
    setAdoptionAttributes(e, t, n) {
      if (this.webview != null) {
        ...
        (this.webview.setAttribute(A, e),
          this.webview.setAttribute(j, t.toString()),
          this.webview.setAttribute(M, n));
      }
    }
    resync() {
      let e = this.container;
    ...
    transfer({ browserTabId: e, conversationId: t, elementKey: n, partition: r }) {
      ...
      i == null ||
        ...
        this.cursorOverlayHost?.setAttribute(k, n),
        a.setAttribute(E, t),
        a.setAttribute(D, e),
    ...
    syncContainerStyle() {
      ...
      if (i != null && this.browserUseCaptureSurfaceSize == null) {
        ...
        return a == null
          ? r || this.state.shouldPaint === !1
            ? (B(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `bootstrap`)
            : this.isStaged
              ? (be(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `staged`)
              : (R(e, n, t, i, this.state.scale, this.state.windowZoom ?? 1), `visible`)
          : (z(e, n, t, a), `hidden`);
      }
      let a = L({
      ...
      return a == null
        ...
        : (this.attachToDom(), z(e, n, t, a), `hidden`);
    }
    ...
    parkInDom() {
      ...
      let r = this.lastVisibleBounds ?? P;
      (this.attachToDom(), B(e, n, t, r, this.state.scale, this.state.windowZoom ?? 1));
    }
    detachFromDom() {
...
function I(e) {
  return `${ge}${encodeURIComponent(e)}`;
}
function ye({ bounds: e, isVisible: t, lastVisibleBounds: n }) {
  return t ? (e != null && e.width > 0 && e.height > 0 ? e : (n ?? P)) : null;
}
function L({
  ...
  return n ? (e == null ? (t == null ? (r ?? P) : V(t)) : V(e)) : null;
}
...
function B(e, t, n, r, i, a) {
  (R(e, t, n, r, i, a), Object.assign(e.style, { pointerEvents: `none`, visibility: `hidden` }));
}
function be(e, t, n, r, i, a) {
  (R(e, t, n, r, i, a), Object.assign(e.style, { opacity: _e, pointerEvents: `none` }));
}
function V(e) {
...
var Le = { responsiveViewportSize: null, toolbarState: h },
  ...
  ze = new (class {
    ...
    hasRetainedWebview(e, t = $(e, void 0)) {
      return this.webviews.get(X(e, t)) instanceof G;
    }
    ...
    getDeviceToolbarTabState(e, t = $(e, void 0)) {
      return this.deviceToolbarTabStates.get(X(e, t)) ?? Le;
    }
    ...
    removeTab(e, t) {
      ...
      (r instanceof F && this.electronPageHandoff.removeTab(r),
    ...
    clearBrowserUseState() {
      ...
      for (let t of e) {
        let { browserTabId: e, conversationId: n } = Z(t);
    ...
    reassociateTabState(n, ...r) {
      ...
      d instanceof F && this.electronPageHandoff.transferRoute(d);
      ...
      let p = this.browserUseViewportSizes.get(l) ?? null,
        ...
        te = this.browserUseActiveTabKeys.delete(l);
      ...
      let g = !1;
      (m && (this.browserUseTabKeys.add(u), this.syncBrowserUseTabKeys(n), (g = !0)),
        te && this.browserUseActiveTabKeys.add(u),
      ...
      let _ = this.localServersStates.get(n),
        v = this.deviceToolbarTabStates.get(l);
      (f != null && (this.snapshots.delete(l), this.snapshots.set(u, f)),
        g && this.syncBrowserUseTabKeys(o),
        _ != null && this.localServersStates.set(o, _),
        v != null && (this.deviceToolbarTabStates.delete(l), this.deviceToolbarTabStates.set(u, v)),
    ...
    removeElectronWebviewFromHandoff(e) {
      e instanceof F && this.electronPageHandoff.disposeHost(e);
    }
