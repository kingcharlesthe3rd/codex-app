...
var a = `updated_at`,
  ...
  N = t(r, {}),
  P = n(r, (e, { get: t }) => t(j) === e),
  F = n(r, ({ locationId: e, threadKey: t }, { get: n }) => {
    if (n(j) !== t) return !1;
    let r = n(M);
    return r == null || e == null || r === e;
  }),
  I = n(r, (e, { get: t }) => t(E)[e] === !0),
  L = n(r, (e, { get: t }) => t(N)[e] === !0),
  R = n(r, (e, { get: t }) => t(D)[e]),
  z = n(r, (e, { get: t }) => t(O)[e] === !0);
function B(e, t) {
  e.set(d, t);
}
function V(e, t) {
...
function W(e, t, n = null) {
  (e.get(j) === t && e.get(M) === n) || (e.set(j, t), e.set(M, n));
}
function G(e, t, n) {
  e.set(v, { ...e.get(D), [t]: n });
}
...
function X(e, t) {
  let n = e.get(E),
    r = { ...n };
  (n[t] === !0 ? delete r[t] : (r[t] = !0), Y(e, r));
}
function Z({ collapsedGroups: e, importedProjectRoots: t }) {
