...
import { J as M, K as oe } from "./app-initial~app-main~automations-page.js";
import { Ur as se, Wr as N } from "./app-initial~app-main~onboarding-page~profile.js";
import {
  G as P,
  K as F,
...
import { n as B, t as V } from "./segmented-toggle.js";
var H,
  U = e(() => {
    (w(),
      (H = E({
...
function ue() {
  let e = (0, fe.c)(66),
    ...
    n = ie(),
    [r, i] = (0, pe.useState)(!1),
    [a, o] = (0, pe.useState)(null),
    s = d(g.autoCleanupEnabled),
    c = d(g.keepCount),
    l;
  e[0] === t ? (l = e[1]) : ((l = (e) => x(t, g.autoCleanupEnabled, e)), (e[0] = t), (e[1] = l));
  let u, f;
  e[2] !== n || e[3] !== t
    ? ((u = (e, r) => {
        if (r) {
  ...
  let p;
  e[6] !== l || e[7] !== u || e[8] !== f
    ? ((p = { mutationFn: l, onSuccess: u, onError: f }),
      (e[6] = l),
      (e[7] = u),
      (e[8] = f),
      (e[9] = p))
  ...
  let m = _(p),
    h;
  e[10] === t ? (h = e[11]) : ((h = (e) => x(t, g.keepCount, e)), (e[10] = t), (e[11] = h));
  let v, y;
  e[12] !== n || e[13] !== t
    ? ((v = () => {
        (o(null),
  ...
  e[16] !== h || e[17] !== v || e[18] !== y
    ? ((b = { mutationFn: h, onSuccess: v, onError: y }),
      (e[16] = h),
      (e[17] = v),
      (e[18] = y),
      (e[19] = b))
  ...
  e[23] === m
    ? (k = e[24])
    : ((k = () => {
        (o(null), i(!1), m.mutate(!1));
      }),
      (e[23] = m),
      (e[24] = k));
  let A = k,
    j;
  e[25] !== T || e[26] !== c || e[27] !== a || e[28] !== re
    ? ((j = () => {
        if (T || a == null) return;
        let e = a.trim(),
  ...
  e[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, W.jsx)(D, { ...H.automaticWorktreeDeletion })),
      (N = (0, W.jsx)(D, {
  ...
  e[32] === n
    ...
    : ((P = n.formatMessage({
      ...
      (e[33] = P));
  let F;
  e[34] !== s || e[35] !== E || e[36] !== w || e[37] !== P
    ? ((F = (0, W.jsx)(se, {
        label: oe,
        description: N,
        control: (0, W.jsx)(ne, { checked: s, disabled: w, onChange: E, ariaLabel: P }),
      })),
      (e[34] = s),
      (e[35] = E),
      (e[36] = w),
  ...
  e[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = (0, W.jsx)(D, { ...H.autoDeleteLimit })), (e[39] = ce))
    : (ce = e[39]);
  let I;
  e[40] === s
    ? (I = e[41])
  ...
  e[47] === n
    ...
    : ((R = n.formatMessage({
      ...
      (e[48] = R));
  let z;
  e[49] !== M || e[50] !== T || e[51] !== C || e[52] !== L || e[53] !== le || e[54] !== R
    ? ((z = (0, W.jsx)(`div`, {
        className: `ml-6`,
  ...
  let B;
  e[56] !== I || e[57] !== z
    ? ((B = (0, W.jsx)(se, { label: ce, description: I, control: z })),
      (e[56] = I),
      (e[57] = z),
      (e[58] = B))
    : (B = e[58]);
  let V;
  e[59] !== A || e[60] !== r
    ? ((V = (0, W.jsx)(de, { open: r, onOpenChange: i, onConfirm: A })),
      (e[59] = A),
      (e[60] = r),
      (e[61] = V))
    : (V = e[61]);
  let U;
  return (
    e[62] !== F || e[63] !== B || e[64] !== V
      ? ((U = (0, W.jsxs)(W.Fragment, { children: [F, B, V] })),
        (e[62] = F),
        (e[63] = B),
        (e[64] = V),
        (e[65] = U))
...
function de(e) {
  ...
  t[5] === s
    ? (d = t[6])
    : ((d = (0, W.jsx)(c, { color: `ghost`, onClick: s, children: ee })), (t[5] = s), (t[6] = d));
  let f;
  t[7] === i
    ? (f = t[8])
    : ((f = () => {
  ...
  t[10] === f
    ? (m = t[11])
    : ((m = (0, W.jsx)(c, { color: `danger`, onClick: f, children: p })), (t[10] = f), (t[11] = m));
  let h;
  t[12] !== d || t[13] !== m
    ? ((h = (0, W.jsxs)(A, {
        children: [a, o, (0, W.jsx)(l, { children: (0, W.jsxs)(y, { children: [d, m] }) })],
      })),
      (t[12] = d),
      (t[13] = m),
      (t[14] = h))
  ...
  let g;
  return (
    t[15] !== r || t[16] !== n || t[17] !== h
      ? ((g = (0, W.jsx)(k, { open: n, showDialogClose: !1, onOpenChange: r, children: h })),
        (t[15] = r),
        (t[16] = n),
        (t[17] = h),
        (t[18] = g))
...
function K() {
  let e = (0, me.c)(193),
    ...
    n = ie(),
    r = ae(`2764989143`),
    [i, a] = (0, he.useState)(null),
    o = d(m.branchPrefix),
    s = d(m.alwaysForcePush),
    l = d(m.createPullRequestAsDraft),
    u = d(m.pullRequestMergeMethod),
    f = d(m.commitInstructions),
    p = d(m.pullRequestInstructions),
    h;
  e[0] === t ? (h = e[1]) : ((h = (e) => x(t, m.branchPrefix, e)), (e[0] = t), (e[1] = h));
  let g, v;
  e[2] !== n || e[3] !== t
    ? ((g = () => {
        (a(null),
  ...
  let y;
  e[6] !== h || e[7] !== g || e[8] !== v
    ? ((y = { mutationFn: h, onSuccess: g, onError: v }),
      (e[6] = h),
      (e[7] = g),
      (e[8] = v),
      (e[9] = y))
  ...
  let b = _(y),
    S;
  e[10] === t ? (S = e[11]) : ((S = (e) => x(t, m.alwaysForcePush, e)), (e[10] = t), (e[11] = S));
  let C, w;
  e[12] !== n || e[13] !== t
    ? ((C = (e, r) => {
        r
  ...
  e[20] === t
    ? (k = e[21])
    : ((k = (e) => x(t, m.pullRequestMergeMethod, e)), (e[20] = t), (e[21] = k));
  let A, j;
  e[22] !== n || e[23] !== t
    ? ((j = () => {
        t.get(O).success(
  ...
  e[30] === t
    ? (F = e[31])
    : ((F = (e) => x(t, m.createPullRequestAsDraft, e)), (e[30] = t), (e[31] = F));
  let I, L;
  e[32] !== n || e[33] !== t
    ? ((I = (e, r) => {
        r
  ...
  e[36] !== F || e[37] !== I || e[38] !== L
    ...
    : (R = e[39]);
  let B = _(R),
    [U, de] = (0, he.useState)(null),
    [fe, pe] = (0, he.useState)(null),
    W;
  e[40] === t
    ? (W = e[41])
    : ((W = (e) => x(t, m.commitInstructions, e)), (e[40] = t), (e[41] = W));
  let G, K;
  e[42] !== n || e[43] !== t
    ? ((G = () => {
        (de(null),
    ...
    : ((G = e[44]), (K = e[45]));
  let ge;
  e[46] !== W || e[47] !== G || e[48] !== K
    ? ((ge = { mutationFn: W, onSuccess: G, onError: K }),
      (e[46] = W),
      (e[47] = G),
      (e[48] = K),
      (e[49] = ge))
  ...
  e[50] === t
    ? (_e = e[51])
    : ((_e = (e) => x(t, m.pullRequestInstructions, e)), (e[50] = t), (e[51] = _e));
  let ve, ye;
  e[52] !== n || e[53] !== t
    ? ((ve = () => {
        (pe(null),
  ...
  e[92] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((qe = (0, q.jsx)(P, { slug: `git-settings` })), (e[92] = qe))
    : (qe = e[92]);
  let Je, Ye;
  e[93] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Je = (0, q.jsx)(D, { ...H.branchPrefix })),
      (Ye = (0, q.jsx)(D, {
  ...
  e[100] === n
    ...
    : ((Qe = n.formatMessage({
      ...
      (e[101] = Qe));
  let $e;
  e[102] !== Se || e[103] !== Ne || e[104] !== X || e[105] !== Xe || e[106] !== Ze || e[107] !== Qe
    ? (($e = (0, q.jsx)(se, {
        label: Je,
        description: Ye,
    ...
    : ($e = e[108]);
  let et;
  e[109] !== ze || e[110] !== n || e[111] !== Z || e[112] !== r || e[113] !== u
    ? ((et = r
        ? (0, q.jsx)(se, {
            label: (0, q.jsx)(D, { ...H.pullRequestMergeMethod }),
            ...
            control: (0, q.jsx)(V, {
              ...
              options: [
                {
                  id: `merge`,
                  label: (0, q.jsx)(D, { ...H.merge }),
                  ariaLabel: n.formatMessage(H.merge),
                  disabled: Z,
                },
                {
                  id: `squash`,
                  label: (0, q.jsx)(D, { ...H.squash }),
                  ariaLabel: n.formatMessage(H.squash),
                  disabled: Z,
                },
              ],
            }),
  ...
  e[115] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((tt = (0, q.jsx)(D, { ...H.alwaysForcePush })),
      (nt = (0, q.jsx)(D, {
  ...
  e[119] === n
    ...
    : ((it = n.formatMessage({
      ...
      (e[120] = it));
  let at;
  e[121] !== s || e[122] !== we || e[123] !== rt || e[124] !== it
    ? ((at = (0, q.jsx)(se, {
        label: tt,
        description: nt,
        control: (0, q.jsx)(ne, { checked: s, disabled: we, onChange: rt, ariaLabel: it }),
      })),
      (e[121] = s),
      (e[122] = we),
      (e[123] = rt),
  ...
  e[126] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ot = (0, q.jsx)(D, { ...H.createDraftPullRequests })),
      (st = (0, q.jsx)(D, {
  ...
  e[130] === n
    ...
    : ((lt = n.formatMessage({
      ...
      (e[131] = lt));
  let ut;
  e[132] !== l || e[133] !== Te || e[134] !== ct || e[135] !== lt
    ? ((ut = (0, q.jsx)(se, {
        label: ot,
        description: st,
        control: (0, q.jsx)(ne, { checked: l, disabled: Te, onChange: ct, ariaLabel: lt }),
      })),
      (e[132] = l),
      (e[133] = Te),
      (e[134] = ct),
  ...
  e[137] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((dt = (0, q.jsx)(re, { electron: !0, children: (0, q.jsx)(ue, {}) })), (e[137] = dt))
    : (dt = e[137]);
  let ft;
  e[138] !== $e || e[139] !== et || e[140] !== at || e[141] !== ut
    ? ((ft = (0, q.jsx)(z, {
        children: (0, q.jsx)(z.Content, {
          children: (0, q.jsxs)(le, { children: [$e, et, at, ut, dt] }),
        }),
      })),
      (e[138] = $e),
      (e[139] = et),
  ...
  e[143] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pt = (0, q.jsx)(D, { ...H.commitInstructions })),
      (mt = (0, q.jsx)(D, {
  ...
  e[145] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (gt = e[145]);
  let _t;
  e[146] !== Ve || e[147] !== J.isPending || e[148] !== ht
    ? ((_t = (0, q.jsx)(z.Header, {
        title: pt,
        subtitle: mt,
        actions: (0, q.jsx)(c, {
  ...
  let St;
  e[163] !== _t || e[164] !== xt
    ? ((St = (0, q.jsxs)(z, { children: [_t, xt] })), (e[163] = _t), (e[164] = xt), (e[165] = St))
    : (St = e[165]);
  let Ct, wt;
  e[166] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ct = (0, q.jsx)(D, { ...H.pullRequestInstructions })),
      (wt = (0, q.jsx)(D, {
  ...
  e[168] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Et = e[168]);
  let Dt;
  e[169] !== Ue || e[170] !== Y.isPending || e[171] !== Tt
    ? ((Dt = (0, q.jsx)(z.Header, {
        title: Ct,
        subtitle: wt,
        actions: (0, q.jsx)(c, {
  ...
  let Mt;
  e[186] !== Dt || e[187] !== jt
    ? ((Mt = (0, q.jsxs)(z, { children: [Dt, jt] })), (e[186] = Dt), (e[187] = jt), (e[188] = Mt))
    : (Mt = e[188]);
  let Nt;
  return (
    e[189] !== ft || e[190] !== St || e[191] !== Mt
      ? ((Nt = (0, q.jsxs)(oe, { title: qe, children: [ft, St, Mt] })),
        (e[189] = ft),
        (e[190] = St),
        (e[191] = Mt),
        (e[192] = Nt))
