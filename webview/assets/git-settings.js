...
import { o as r, t as ee, z as i } from "./app-scope.js";
import { _ as a } from "./vscode-api.js";
import "./isEqual.js";
import { b as o, w as s } from "./src-2.js";
import "./react-dom.js";
import { i as c, l, s as u } from "./lib.js";
import { t as d } from "./button.js";
import { a as f, i as p } from "./setting-storage.js";
...
import { a as g, i as _, l as v, n as y, r as b } from "./dialog-layout-B.js";
import { t as x } from "./with-window.js";
import { t as te } from "./toggle.js";
import "./chevron.js";
import "./electron-menu-shortcuts.js";
import { n as ne } from "./use-hotkey-Ct4Y-I9A.js";
import "./links-p.js";
...
function ce() {
  let e = (0, oe.c)(66),
    ...
    n = l(),
    [i, s] = (0, se.useState)(!1),
    [c, d] = (0, se.useState)(null),
    h = f(o.autoCleanupEnabled),
    g = f(o.keepCount),
    _;
  e[0] === t ? (_ = e[1]) : ((_ = (e) => p(t, o.autoCleanupEnabled, e)), (e[0] = t), (e[1] = _));
  let v, y;
  e[2] !== n || e[3] !== t
    ? ((v = (e, r) => {
        if (r) {
  ...
  let x = a(b),
    ne;
  e[10] === t ? (ne = e[11]) : ((ne = (e) => p(t, o.keepCount, e)), (e[10] = t), (e[11] = ne));
  let re, S;
  e[12] !== n || e[13] !== t
    ? ((re = () => {
        (d(null),
  ...
  e[23] === x
    ? (j = e[24])
    : ((j = () => {
        (d(null), s(!1), x.mutate(!1));
      }),
      (e[23] = x),
      (e[24] = j));
  let M = j,
    N;
  e[25] !== O || e[26] !== g || e[27] !== c || e[28] !== w
    ? ((N = () => {
        if (O || c == null) return;
        let e = c.trim(),
  ...
  e[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, E.jsx)(u, { ...T.automaticWorktreeDeletion })),
      (I = (0, E.jsx)(u, {
  ...
  e[32] === n
    ...
    : ((L = n.formatMessage({
      ...
      (e[33] = L));
  let R;
  e[34] !== h || e[35] !== A || e[36] !== D || e[37] !== L
    ? ((R = (0, E.jsx)(C, {
        label: F,
        description: I,
        control: (0, E.jsx)(te, { checked: h, disabled: D, onChange: A, ariaLabel: L }),
      })),
      (e[34] = h),
      (e[35] = A),
      (e[36] = D),
  ...
  e[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, E.jsx)(u, { ...T.autoDeleteLimit })), (e[39] = z))
    : (z = e[39]);
  let B;
  e[40] === h
    ? (B = e[41])
  ...
  let K;
  e[59] !== M || e[60] !== i
    ? ((K = (0, E.jsx)(le, { open: i, onOpenChange: s, onConfirm: M })),
      (e[59] = M),
      (e[60] = i),
      (e[61] = K))
    : (K = e[61]);
...
function le(e) {
  ...
  t[5] === o
    ? (c = t[6])
    : ((c = (0, E.jsx)(d, { color: `ghost`, onClick: o, children: s })), (t[5] = o), (t[6] = c));
  let l;
  t[7] === ee
    ? (l = t[8])
    : ((l = () => {
  ...
  t[10] === l
    ? (p = t[11])
    : ((p = (0, E.jsx)(d, { color: `danger`, onClick: l, children: f })), (t[10] = l), (t[11] = p));
  let m;
  t[12] !== c || t[13] !== p
    ? ((m = (0, E.jsxs)(y, {
        children: [i, a, (0, E.jsx)(g, { children: (0, E.jsxs)(b, { children: [c, p] }) })],
      })),
      (t[12] = c),
      (t[13] = p),
      (t[14] = m))
  ...
  return (
    t[15] !== r || t[16] !== n || t[17] !== m
      ? ((h = (0, E.jsx)(v, { open: n, showDialogClose: !1, onOpenChange: r, children: m })),
        (t[15] = r),
        (t[16] = n),
        (t[17] = m),
        (t[18] = h))
...
function D() {
  let e = (0, oe.c)(218),
    ...
    i = h(`2764989143`),
    o = h(`2553306736`),
    [c, g] = (0, se.useState)(null),
    _ = f(s.branchPrefix),
    v = f(s.alwaysForcePush),
    y = f(s.createPullRequestAsDraft),
    b = f(s.pullRequestMergeMethod),
    le = f(s.showSidebarPrIcons),
    D = f(s.commitInstructions),
    O = f(s.pullRequestInstructions),
    k;
  e[0] === t ? (k = e[1]) : ((k = (e) => p(t, s.branchPrefix, e)), (e[0] = t), (e[1] = k));
  let A, j;
  e[2] !== n || e[3] !== t
    ? ((A = () => {
        (g(null),
  ...
  let N = a(M),
    P;
  e[10] === t ? (P = e[11]) : ((P = (e) => p(t, s.alwaysForcePush, e)), (e[10] = t), (e[11] = P));
  let F, I;
  e[12] !== n || e[13] !== t
    ? ((F = (e, r) => {
        r
  ...
  e[20] === t
    ? (z = e[21])
    : ((z = (e) => p(t, s.pullRequestMergeMethod, e)), (e[20] = t), (e[21] = z));
  let B, V;
  e[22] !== n || e[23] !== t
    ? ((V = () => {
        t.get(m).success(
  ...
  e[30] === t
    ? (W = e[31])
    : ((W = (e) => p(t, s.createPullRequestAsDraft, e)), (e[30] = t), (e[31] = W));
  let G, K;
  e[32] !== n || e[33] !== t
    ? ((G = (e, r) => {
        r
  ...
  e[40] === t
    ? (de = e[41])
    : ((de = (e) => p(t, s.showSidebarPrIcons, e)), (e[40] = t), (e[41] = de));
  let fe, pe;
  e[42] !== n || e[43] !== t
    ? ((fe = (e, r) => {
        r
  ...
  e[50] === t
    ? (be = e[51])
    : ((be = (e) => p(t, s.commitInstructions, e)), (e[50] = t), (e[51] = be));
  let xe, Se;
  e[52] !== n || e[53] !== t
    ? ((xe = () => {
        (_e(null),
  ...
  e[60] === t
    ? (we = e[61])
    : ((we = (e) => p(t, s.pullRequestInstructions, e)), (e[60] = t), (e[61] = we));
  let Te, Ee;
  e[62] !== n || e[63] !== t
    ? ((Te = () => {
        (ye(null),
  ...
  e[105] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((it = (0, E.jsx)(re, { slug: `git-settings` })), (e[105] = it))
    : (it = e[105]);
  let at, ot;
  e[106] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((at = (0, E.jsx)(u, { ...T.branchPrefix })),
      (ot = (0, E.jsx)(u, {
  ...
  e[115] !== ke || e[116] !== He || e[117] !== X || e[118] !== st || e[119] !== ct || e[120] !== lt
    ...
    : (ut = e[121]);
  let dt;
  e[122] !== Je || e[123] !== n || e[124] !== Z || e[125] !== i || e[126] !== b
    ? ((dt = i
        ? (0, E.jsx)(C, {
            label: (0, E.jsx)(u, { ...T.pullRequestMergeMethod }),
            description: (0, E.jsx)(u, {
            ...
            control: (0, E.jsx)(ae, {
              ...
              options: [
                {
                  id: `merge`,
                  label: (0, E.jsx)(u, { ...T.merge }),
                  ariaLabel: n.formatMessage(T.merge),
                  disabled: Z,
                },
                {
                  id: `squash`,
                  label: (0, E.jsx)(u, { ...T.squash }),
  ...
  e[128] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ft = (0, E.jsx)(u, { ...T.showPullRequestIcons })),
      (pt = (0, E.jsx)(u, {
  ...
  e[134] !== Ne || e[135] !== Pe || e[136] !== mt || e[137] !== ht
    ? ((gt = (0, E.jsx)(C, {
        label: ft,
        description: pt,
        control: (0, E.jsx)(te, { checked: Pe, disabled: Ne, onChange: mt, ariaLabel: ht }),
      })),
      (e[134] = Ne),
      (e[135] = Pe),
      (e[136] = mt),
  ...
  e[139] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_t = (0, E.jsx)(u, { ...T.alwaysForcePush })),
      (vt = (0, E.jsx)(u, {
  ...
  e[143] === n
    ...
    : ((bt = n.formatMessage({
      ...
      (e[144] = bt));
  let xt;
  e[145] !== v || e[146] !== je || e[147] !== yt || e[148] !== bt
    ? ((xt = (0, E.jsx)(C, {
        label: _t,
        description: vt,
        control: (0, E.jsx)(te, { checked: v, disabled: je, onChange: yt, ariaLabel: bt }),
      })),
      (e[145] = v),
      (e[146] = je),
      (e[147] = yt),
  ...
  e[150] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((St = (0, E.jsx)(u, { ...T.createDraftPullRequests })),
      (Ct = (0, E.jsx)(u, {
  ...
  e[154] === n
    ...
    : ((Tt = n.formatMessage({
      ...
      (e[155] = Tt));
  let Et;
  e[156] !== y || e[157] !== Me || e[158] !== wt || e[159] !== Tt
    ? ((Et = (0, E.jsx)(C, {
        label: St,
        description: Ct,
        control: (0, E.jsx)(te, { checked: y, disabled: Me, onChange: wt, ariaLabel: Tt }),
      })),
      (e[156] = y),
      (e[157] = Me),
      (e[158] = wt),
  ...
  e[161] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Dt = (0, E.jsx)(x, { electron: !0, children: (0, E.jsx)(ce, {}) })), (e[161] = Dt))
    : (Dt = e[161]);
  let Ot;
  ...
  e[168] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((kt = (0, E.jsx)(u, { ...T.commitInstructions })),
      (At = (0, E.jsx)(u, {
  ...
  e[191] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((zt = (0, E.jsx)(u, { ...T.pullRequestInstructions })),
      (Bt = (0, E.jsx)(u, {
