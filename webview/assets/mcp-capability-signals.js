...
import { Xs as ie, po as _, za as ae } from "./app-server-manager-signals.js";
import {
  $ as v,
  Q as y,
  S as b,
...
import { p as ue } from "./statsig.js";
import { s as de } from "./request.js";
...
var be = A.strict(),
  ...
  ke = o({
    ...
    resources: o({ subscribe: l().optional(), listChanged: l().optional() }).optional(),
  ...
  je = k.extend({ method: u(`notifications/initialized`), params: O.optional() }),
  ...
  He = A.merge(L),
  Ue = D.extend({ method: u(`tasks/result`), params: T.extend({ taskId: h() }) });
A.loose();
var We = F.extend({ method: u(`tasks/list`) }),
  Ge = I.extend({ tasks: m(L) }),
  Ke = D.extend({ method: u(`tasks/cancel`), params: T.extend({ taskId: h() }) });
A.merge(L);
var qe = o({ uri: h(), mimeType: d(h()), _meta: a(h(), p()).optional() }),
  ...
  at = k.extend({ method: u(`notifications/resources/list_changed`), params: O.optional() }),
  ot = V,
  ...
  pt = o({ ...N.shape, ...M.shape, description: d(h()), arguments: d(m(ft)), _meta: d(g({})) }),
  ...
  H = o({ type: u(`text`), text: h(), annotations: B.optional(), _meta: a(h(), p()).optional() }),
  U = o({
    type: u(`image`),
    data: R,
    mimeType: h(),
  ...
  Ct = k.extend({ method: u(`notifications/prompts/list_changed`), params: O.optional() }),
  wt = o({
    title: h().optional(),
...
var Ot = E.extend({ name: h(), arguments: a(h(), p()).optional() }),
  ...
  At = k.extend({ method: u(`notifications/tools/list_changed`), params: O.optional() });
o({ autoRefresh: l().default(!0), debounceMs: f().int().nonnegative().default(300) });
var jt = r([`debug`, `info`, `notice`, `warning`, `error`, `critical`, `alert`, `emergency`]),
  ...
  Rt = o({
    type: u(`tool_result`),
    toolUseId: h().describe(`The unique identifier for the corresponding tool call.`),
    content: m(G).default([]),
  ...
  Wt = A.extend({
    model: h(),
    stopReason: d(r([`endTurn`, `stopSequence`, `maxTokens`, `toolUse`]).or(h())),
    role: z,
    content: c([J, m(J)]),
  }),
  Gt = o({
  ...
  Zt = c([
    ...
    E.extend({ mode: u(`url`), message: h(), elicitationId: h(), url: h().url() }),
  ]),
  Qt = D.extend({ method: u(`elicitation/create`), params: Zt }),
  $t = O.extend({ elicitationId: h() }),
  en = k.extend({ method: u(`notifications/elicitation/complete`), params: $t }),
  tn = A.extend({
    action: r([`accept`, `decline`, `cancel`]),
    content: te((e) => (e === null ? void 0 : e), a(h(), c([h(), f(), l(), m(h())])).optional()),
  }),
  ...
  sn = A.extend({
    completion: g({ values: m(h()).max(100), total: d(f().int()), hasMore: d(l()) }),
  }),
  cn = o({ uri: h().startsWith(`file://`), name: h().optional(), _meta: a(h(), p()).optional() }),
  ln = D.extend({ method: u(`roots/list`), params: T.optional() }),
  un = A.extend({ roots: m(cn) }),
  dn = k.extend({ method: u(`notifications/roots/list_changed`), params: O.optional() });
...
var fn = c([u(`light`), u(`dark`)]).describe(`Color theme preference for the host environment.`),
  Y = c([u(`inline`), u(`fullscreen`), u(`pip`)]).describe(`Display mode for UI presentation.`),
  pn = a(
    c([
...
(o({
  ...
  o({
    isError: l().optional().describe(`True if the host rejected or failed to deliver the message.`),
  }).passthrough(),
  o({ method: u(`ui/notifications/sandbox-proxy-ready`), params: o({}) }));
var X = o({
    connectDomains: m(h()).optional().describe(`Origins for network requests (fetch/XHR/WebSocket).
...
(o({
  ...
  o({
    ...
    params: o({
      arguments: a(h(), p().describe(`Complete tool call arguments as key-value pairs.`))
        .optional()
  ...
  o({
    ...
    params: o({
      arguments: a(h(), p().describe(`Partial tool call arguments (incomplete, may change).`))
        .optional()
...
var gn = o({
  ...
  resourceLink: o({}).optional().describe(`Host supports resource link content blocks.`),
  structuredContent: o({}).optional().describe(`Host supports structured content.`),
});
...
var _n = o({
    ...
    serverTools: o({
      listChanged: l().optional().describe(`Host supports tools/list_changed notifications.`),
    })
      .optional()
      .describe(`Host can proxy tool calls to the MCP server.`),
    serverResources: o({
      listChanged: l().optional().describe(`Host supports resources/list_changed notifications.`),
    })
      .optional()
  ...
  vn = o({
    experimental: o({}).optional().describe(`Experimental features (structure TBD).`),
    tools: o({
      listChanged: l().optional().describe(`App supports tools/list_changed notifications.`),
    })
      .optional()
      .describe(`App exposes MCP-style tools that the host can call.`),
    availableDisplayModes: m(Y).optional().describe(`Display modes the app supports.`),
  });
...
var yn = c([u(`model`), u(`app`)]).describe(`Tool visibility scope - who can access the tool.`);
(o({
  resourceUri: h().optional(),
  visibility: m(yn).optional().describe(`Who can access this tool. Default: ["model", "app"]
...
var bn = o({
  ...
  availableDisplayModes: m(Y).optional().describe(`Display modes the host supports.`),
  containerDimensions: c([
    o({ height: f().describe(`Fixed container height in pixels.`) }),
    o({ maxHeight: c([f(), t()]).optional().describe(`Maximum container height in pixels.`) }),
  ])
    .and(
      c([
        o({ width: f().describe(`Fixed container width in pixels.`) }),
        o({ maxWidth: c([f(), t()]).optional().describe(`Maximum container width in pixels.`) }),
      ]),
    )
    .optional().describe(`Container dimensions. Represents the dimensions of the iframe or other
container holding the app. Specify either width or maxWidth, and either height or maxHeight.`),
  locale: h().optional().describe(`User's language and region preference in BCP 47 format.`),
  ...
  deviceCapabilities: o({
    ...
    hover: l().optional().describe(`Whether the device supports hover interactions.`),
  })
    .optional()
...
(o({
  ...
  o({
    ...
    params: o({
      content: m(G).optional().describe(`Context content blocks (text, image, etc.).`),
      structuredContent: a(
        h(),
  ...
  o({
    ...
    params: o({
      ...
      appCapabilities: vn.describe(`Features and capabilities this app provides.`),
      protocolVersion: h().describe(`Protocol version this app supports.`),
    }),
  }),
  o({
    protocolVersion: h().describe(`Negotiated protocol version string (e.g., "2025-11-21").`),
    hostInfo: P.describe(`Host application identification and version.`),
    hostCapabilities: _n.describe(`Features and capabilities provided by the host.`),
    hostContext: bn.describe(`Rich context about the host environment.`),
  }).passthrough());
var xn = `ui/resourceUri`;
function Sn(e) {
  let t = e._meta?.ui?.resourceUri;
  if ((t === void 0 && (t = e._meta?.[xn]), typeof t == `string` && t.startsWith(`ui://`)))
    return t;
...
var Dn = o({
  ...
  On = o({ mentions: l(), serverName: h(), serverTitle: h().optional(), tools: Dt.shape.tools });
                    ...
                    try {
                      let r = On.parse(
                        await se(`get-openai-capabilities-server-info`, {
                          params: { hostId: e, pluginId: t.id, pluginPath: t.path, server: n },
                        }),
                      );
                      return [
                        n,
...
function Fn(e) {
  let t = o({ visibility: m(r([`app`, `model`])).optional() }).safeParse(e._meta?.ui);
  return t.success && t.data.visibility?.includes(`app`) === !0;
}
async function In(e, t) {
  let n = await ie(`read-app-plugin-extension-file-for-host`, { hostId: e, path: t });
...
var Rn = le(b, (e) => []),
  ...
  Vn = ce(b, (e, { get: t }) => {
    ...
    return {
      ...
      queryKey: [`mcp-capability-catalog`, e, t(Bn), n.map(({ id: e, path: t }) => `${e}:${t}`)],
      staleTime: 0,
    };
  }),
  $ = v(b, (e, { get: t }) => (t(ue, `3669474837`) ? (t(Vn, e).data ?? []) : [])),
  Hn = y(b, ({ get: e }) => e($, _)),
