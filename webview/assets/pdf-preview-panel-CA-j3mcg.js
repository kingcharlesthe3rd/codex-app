...
function zt({
  ...
  let y = c(he),
    ...
    K = (0, Y.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === u), [e, u]),
    ...
    me = de != null,
    _e = (0, Y.useCallback)(() => {
      (k != null && i?.(u, !1), A(null), R(null), B(null), N(``), H(null), G(!1));
    }, [k, i, u]),
    ...
    ye = (0, Y.useCallback)(() => {
      typeof window > `u` ||
        v({ animationFrameRef: w, animationWindow: window, editorWrapper: x.current });
    }, []),
    be = (0, Y.useCallback)(
      () =>
        J == null
  ...
  let Ce = (0, Y.useEffectEvent)(() => {
    ...
    ((k != null || V != null) && !be()) || (R(n), A(null), N(``), H(null), U(null), B(null), G(!1));
  });
  (0, Y.useEffect)(() => {
    if (T == null || t) return;
    let e = T.parentElement;
  ...
  let we = (e, n, r) => {
    ...
    Te = (e, n) => {
      (Pe(
        y,
        { artifactTabId: m, artifactType: `pdf`, importKind: `pdf`, threadId: g },
    ...
    Ee = (0, Y.useEffectEvent)((e, t) => {
      ...
      let n = ft({ pageElement: t, pageSize: d }) ?? (I?.selectionKind === `text` ? null : I);
  ...
  let De = (e) => {
    ...
    je = async (e, { submitDirectly: i = !1 } = {}) => {
      ...
      if (V != null) {
        ...
        (r((e) =>
          e.map((e) => (rn(e) === V ? { ...e, content: [{ content_type: `text`, text: c }] } : e)),
        ),
          _e());
        return;
      }
      if (!(k == null || c.length === 0 || ne))
        try {
          ...
          (ce(y, se, { commentType: h.kind, submitMode: i ? `direct` : `saved` }),
            Me(
              y,
              { artifactTabId: m, artifactType: `pdf`, importKind: `pdf`, threadId: g },
              {
  ...
  return (0, X.jsxs)(`div`, {
    ...
    children: [
      K.map((e) =>
        (0, X.jsx)(
          Bt,
          {
            ...
            isSelected: rn(e) === V,
            onEdit: (e) => {
              (k != null && i?.(u, !1), A(null), R(null), B(null), N(``), G(!1), U(null), H(e));
            },
            onPreviewChange: U,
          },
          rn(e),
      ...
      le == null || V != null ? null : (0, X.jsx)(Vt, { comment: le, layer: T }),
      ...
      I != null && k == null
        ...
        : null,
      P == null ? null : (0, X.jsx)(Wt, { rect: gt(P.start, P.current), pageSize: d }),
...
function Ut(e) {
  ...
  return (
    t[12] !== n.rect || t[13] !== o || t[14] !== i || t[15] !== a
      ? ((s = (0, X.jsx)(C, { bordered: o, paddingPx: 4, pageSize: i, rect: n.rect, testId: a })),
        (t[12] = n.rect),
        (t[13] = o),
        (t[14] = i),
        (t[15] = a),
...
function Zt({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ...
    : A({ layer: t, markerPoint: e.kind === `region` ? _t(e.rect) : e.point, pageSize: n });
}
async function Qt({
  anchor: e,
  commentId: t,
    ...
    ((jn = i()),
      ...
      (Pn = (0, Mn.memo)(function (e) {
        ...
        t[28] !== E.height || t[29] !== E.width || t[30] !== D || t[31] !== V
          ? ((H = { "--scale-factor": D, "--user-unit": V, height: E.height, width: E.width }),
            (t[28] = E.height),
            (t[29] = E.width),
            (t[30] = D),
            (t[31] = V),
        ...
        t[33] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((U = (0, Nn.jsx)(`canvas`, { ref: h, className: `absolute inset-0 size-full` })),
            (t[33] = U))
          : (U = t[33]);
        let W;
        t[34] !== M ||
        ...
        let ne;
        return (
          t[49] !== a || t[50] !== ee || t[51] !== te || t[52] !== W || t[53] !== G
            ? ((ne = (0, Nn.jsxs)(`div`, {
                ref: g,
...
function In(e) {
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, Z.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })), (t[53] = G))
    : (G = t[53]);
  let ne, ie;
  ...
  let se;
  return (
    t[63] !== I || t[64] !== P || t[65] !== y || t[66] !== z || t[67] !== oe || t[68] !== c
      ? ((se = (0, Z.jsxs)(`div`, {
          ref: y,
          "aria-label": c,
          autoFocus: !0,
...
var zn,
  ...
  Z,
  Vn = e(() => {
    ((zn = i()), (Bn = t(o(), 1)), J(), de(), ae(), ie(), ke(), Fn(), (Z = r()));
  });
...
function Zn(e) {
  ...
  let C = (0, Q.useRef)(S),
    ...
    A;
  t[1] === p.value ? (A = t[2]) : ((A = H(p.value)), (t[1] = p.value), (t[2] = A));
  let j = A,
    N;
  t[3] === j ? (N = t[4]) : ((N = j ?? le({ entrypoint: `home` })), (t[3] = j), (t[4] = N));
  let I = N,
    L = u(P, I),
    z;
  t[5] !== I || t[6] !== p
  ...
  if (t[8] !== L || t[9] !== s) {
    ...
    (t[11] === s
      ? (e = t[12])
      : ((e = (e) => m(e) && e.localPdfContext?.path === s), (t[11] = s), (t[12] = e)),
      (ee = L.filter(e)),
      (t[8] = L),
      (t[9] = s),
      (t[10] = ee));
  ...
  let V = ee,
    te;
  t[13] === V ? (te = t[14]) : ((te = Math.max(0, ...V.map(tr))), (t[13] = V), (t[14] = te));
  let G = te + 1,
    re,
    ie;
  (t[15] !== s || t[16] !== B
    ...
    (0, Q.useEffect)(re, ie));
  let ae;
  t[19] === r ? (ae = t[20]) : ((ae = { fileDataUrl: r }), (t[19] = r), (t[20] = ae));
  let {
  ...
  t[21] === K
    ? (de = t[22])
    : ((de = { containerRef: _, pageSelector: `[data-artifact-pdf-page]`, totalPages: K }),
      (t[21] = K),
      (t[22] = de));
  ...
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((he = (e) => {
        ...
        y.current = Hn({ anchor: e, container: t, pageSelector: `[data-artifact-pdf-page]` });
      }),
      (t[23] = he))
    : (he = t[23]);
  let ge = he,
  ...
  t[27] !== J || t[28] !== Ee || t[29] !== Ae
    ? ((Fe = () => {
        let e =
          Ae.kind === `page-width`
            ? null
            : _.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${J}"]`);
        (Ee(),
          e != null &&
  ...
  t[31] === Se
    ...
    : ((ze = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = x.current;
        n !== t && (n != null && (ge({ kind: `center` }), Se()), (x.current = t), k(t));
      }),
      (t[31] = Se),
      (t[32] = ze));
  let Be = Oe(ze),
  ...
  (t[38] !== q || t[39] !== O || t[40] !== Ae || t[41] !== He
    ? ((We = [q, O, Ae, He]), (t[38] = q), (t[39] = O), (t[40] = Ae), (t[41] = He), (t[42] = We))
    : (We = t[42]),
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        (T(!1), document.fullscreenElement === g.current && document.exitFullscreen().catch(er));
      }),
      (t[61] = st))
    : (st = t[61]);
  let ct = st,
  ...
  t[72] !== E || t[73] !== p || t[74] !== d || t[75] !== j
    ? ((xt = () => {
        (bt(!1),
          E || Ne(p, { artifactTabId: d, artifactType: `pdf`, importKind: `pdf`, threadId: j }),
          D(Qn));
      }),
      (t[72] = E),
      (t[73] = p),
  ...
  t[77] !== gt || t[78] !== vt || t[79] !== E || t[80] !== xt
    ? ((St = (0, $.jsx)(M, { active: E, activeLabel: vt, label: gt, onClick: xt })),
      (t[77] = gt),
      (t[78] = vt),
      (t[79] = E),
      (t[80] = xt),
                          ...
                          rightContent: (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              n === `default`
                                ? (0, $.jsxs)($.Fragment, {
                                    children: [
                                      (0, $.jsx)(Ce, { hostId: a, path: s, sizeBytes: l }),
                                      (0, $.jsx)(ve, {
                                        hostId: a,
                                        onBeforeOpen: o,
                                        path: s,
