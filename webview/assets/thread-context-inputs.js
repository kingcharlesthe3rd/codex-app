...
import { Ho as t, Wo as n, ia as r, is as i } from "./app-server-manager-signals.js";
import { L as a, R as o, a as s, et as c, h as l, i as u, u as d } from "./vscode-api.js";
var f = a(l, ({ get: e }) => i(e, `host_config`) ?? null),
  p = a(l, ({ get: e }) => [
  ...
  C = o(l, (e, { get: n }) => {
    let r = n(f);
    return r != null && e === r.id ? r : t(e, n(p));
  });
