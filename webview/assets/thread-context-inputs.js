...
import { t as Ze } from "./isEqual.js";
import {
  Aa as R,
  An as Qe,
  Ar as $e,
...
import { t as Qt } from "./preload-helper.js";
import { i as $t } from "./lib-1.js";
import { a as en } from "./persisted-atom-store.js";
import {
  A as tn,
  F as nn,
  I as rn,
...
import { d as dn, f as fn, g as pn, i as mn, n as hn, p as gn, r as _n } from "./statsig.js";
import { i as vn, r as yn } from "./base64.js";
import { t as bn } from "./request.js";
import { t as G } from "./v4.js";
import {
  an as xn,
  bt as Sn,
  c as Cn,
...
import { t as nr } from "./platform.js";
import { c as rr, t as ir } from "./persisted-signal.js";
var ar = class extends r {
  ...
  setOptions(e) {
    super.setOptions({ ...e, behavior: ne() });
  }
  ...
  createResult(e, t) {
    ...
    return {
      ...
      hasNextPage: b(t, n.data),
      hasPreviousPage: Ie(t, n.data),
...
function fr(e) {
  return e ? hr(e) || Array.isArray(e) || !!e[lr] || !!e.constructor?.[lr] || Sr(e) || Cr(e) : !1;
}
...
function hr(e) {
  ...
  let r = mr.get(n);
  return (r === void 0 && ((r = Function.toString.call(n)), mr.set(n, r)), r === pr);
}
function gr(e, t, n = !0) {
  _r(e) === 0
...
function _r(e) {
  let t = e[K];
  return t ? t.type_ : Array.isArray(e) ? 1 : Sr(e) ? 2 : Cr(e) ? 3 : 0;
}
function vr(e, t) {
...
function Tr(e, t) {
  if (Sr(e)) return new Map(e);
  if (Cr(e)) return new Set(e);
...
function Er(e, t = !1) {
  return kr(e) || dr(e) || !fr(e)
    ? e
    : (_r(e) > 1 && Object.defineProperties(e, { set: Or, add: Or, clear: Or, delete: Or }),
      Object.freeze(e),
      t && Object.values(e).forEach((e) => Er(e, !0)),
      e);
}
function Dr() {
  q(2);
...
function Ir(e, t) {
  t && (jr(`Patches`), (e.patches_ = []), (e.inversePatches_ = []), (e.patchListener_ = t));
}
function Lr(e) {
  (Rr(e), e.drafts_.forEach(Br), (e.drafts_ = null));
}
function Rr(e) {
  e === Nr && (Nr = e.parent_);
}
...
function Vr(e, t) {
  ...
  return (
    e !== void 0 && e !== n
      ? (n[K].modified_ && (Lr(t), q(4)),
        fr(e) && ((e = Hr(t, e)), t.parent_ || Wr(t, e)),
        t.patches_ &&
          jr(`Patches`).generateReplacementPatches_(n[K].base_, e, t.patches_, t.inversePatches_))
      : (e = Hr(t, n, [])),
    Lr(t),
...
function Hr(e, t, n) {
  ...
  let r = e.immer_.shouldUseStrictIteration(),
    i = t[K];
  if (!i) return (gr(t, (r, a) => Ur(e, i, t, r, a, n), r), t);
  if (i.scope_ !== e) return t;
  if (!i.modified_) return (Wr(e, i.base_, !0), i.base_);
  if (!i.finalized_) {
    ...
    (i.type_ === 3 && ((a = new Set(t)), t.clear(), (o = !0)),
      gr(a, (r, a) => Ur(e, i, t, r, a, n, o), r),
      Wr(e, t, !1),
      n && e.patches_ && jr(`Patches`).generatePatches_(i, n, e.patches_, e.inversePatches_));
  }
  return i.copy_;
}
function Ur(e, t, n, r, i, a, o) {
  ...
  if (!(s && !o)) {
    if (dr(i)) {
      let o = Hr(e, i, a && t && t.type_ !== 3 && !vr(t.assigned_, r) ? a.concat(r) : void 0);
      if ((br(n, r, o), dr(o))) e.canAutoFreeze_ = !1;
      else return;
    } else o && n.add(i);
    if (fr(i) && !s) {
      if (
      ...
      (Hr(e, i),
        (!t || !t.scope_.parent_) &&
          typeof r != `symbol` &&
          (Sr(n) ? n.has(r) : Object.prototype.propertyIsEnumerable.call(n, r)) &&
          Wr(e, i));
    }
  }
}
...
var Kr = {
    get(e, t) {
      if (t === K) return e;
      let n = wr(e);
      if (!vr(n, t)) return Yr(e, n, t);
      let r = n[t];
      return e.finalized_ || !fr(r)
        ? r
        : r === Jr(e.base_, t)
          ? (Qr(e), (e.copy_[t] = ei(r, e)))
          : r;
    },
    has(e, t) {
      return t in wr(e);
    ...
    set(e, t, n) {
      ...
      if (!e.modified_) {
        ...
        if (xr(n, r) && (n !== void 0 || vr(e.base_, t))) return !0;
        (Qr(e), Zr(e));
      }
    ...
    deleteProperty(e, t) {
      return (
        Jr(e.base_, t) !== void 0 || t in e.base_
          ? ((e.assigned_[t] = !1), Qr(e), Zr(e))
...
function Qr(e) {
  e.copy_ ||= Tr(e.base_, e.scope_.immer_.useStrictShallowCopy_);
}
var $r = class {
  constructor(e) {
    ((this.autoFreeze_ = !0),
      ...
      (this.produce = (e, t, n) => {
        ...
        (typeof t != `function` && q(6), n !== void 0 && typeof n != `function` && q(7));
        let r;
        if (fr(e)) {
          let i = zr(this),
            a = ei(e, void 0),
          ...
          return (Ir(i, n), Vr(r, i));
        } else if (!e || typeof e != `object`) {
          if (
            ((r = t(e)),
            r === void 0 && (r = e),
            r === cr && (r = void 0),
            this.autoFreeze_ && Er(r, !0),
            n)
          ) {
            let t = [],
              i = [];
            (jr(`Patches`).generateReplacementPatches_(e, r, t, i), n(t, i));
          }
          return r;
        } else q(1, e);
      }),
  ...
  createDraft(e) {
    (fr(e) || q(8), dr(e) && (e = ti(e)));
    let t = zr(this),
      n = ei(e, void 0);
    return ((n[K].isManual_ = !0), Rr(t), n);
  }
  finishDraft(e, t) {
    let n = e && e[K];
    (!n || !n.isManual_) && q(9);
    let { scope_: r } = n;
    return (Ir(r, t), Vr(void 0, r));
  }
  setAutoFreeze(e) {
    this.autoFreeze_ = e;
  }
  ...
  applyPatches(e, t) {
    ...
    n > -1 && (t = t.slice(n + 1));
    let r = jr(`Patches`).applyPatches_;
    return dr(e) ? r(e, t) : this.produce(e, (e) => r(e, t));
  }
};
function ei(e, t) {
  let n = Sr(e) ? jr(`MapSet`).proxyMap_(e, t) : Cr(e) ? jr(`MapSet`).proxySet_(e, t) : Gr(e, t);
  return ((t ? t.scope_ : Pr()).drafts_.push(n), n);
}
function ti(e) {
  return (dr(e) || q(10, e), ni(e));
}
function ni(e) {
  if (!fr(e) || kr(e)) return e;
  let t = e[K],
    n,
    r = !0;
  if (t) {
    ...
    ((t.finalized_ = !0),
      (n = Tr(e, t.scope_.immer_.useStrictShallowCopy_)),
...
function ri() {
  ...
  function o(t, n, r, i) {
    (r.push({ op: e, path: [], value: n === cr ? void 0 : n }),
      ...
      r.forEach((r) => {
        ...
        for (let e = 0; e < i.length - 1; e++) {
          ...
          (typeof n != `string` && typeof n != `number` && (n = `` + n),
            (t === 0 || t === 1) && (n === `__proto__` || n === `constructor`) && q(19),
            typeof o == `function` && n === `prototype` && q(19),
            (o = yr(o, n)),
            typeof o != `object` && q(18, i.join(`/`)));
        }
        let s = _r(o),
          l = c(r.value),
          u = i[i.length - 1];
  ...
  function c(e) {
    ...
    if (Sr(e)) return new Map(Array.from(e.entries()).map(([e, t]) => [e, c(t)]));
    if (Cr(e)) return new Set(Array.from(e).map(c));
    let t = Object.create(ur(e));
    for (let n in e) t[n] = c(e[n]);
    return (vr(e, lr) && (t[lr] = e[lr]), t);
  }
  function l(e) {
    return dr(e) ? c(e) : e;
  }
  Mr(`Patches`, { applyPatches_: s, generatePatches_: n, generateReplacementPatches_: o });
}
var ii = new $r(),
  ai = ii.produce,
  oi = ii.produceWithPatches.bind(ii),
  si = ii.applyPatches.bind(ii);
function J(e) {
  return e;
}
var ci = B({ code: Jt().optional(), message: R().optional() });
function li(e, t) {
  let n = ci.safeParse(e);
  ...
  async createSession(e) {
    ...
    if (this.sessionSupport !== `unsupported`)
      try {
        ...
        if (li(e, `fuzzyFileSearch/sessionStart`)) this.sessionSupport = `unsupported`;
        else throw e;
      }
    let n = !1,
      r =
  ...
  async stopSession(e) {
    if (this.sessionSupport !== `unsupported`)
      try {
        ...
        li(e, `fuzzyFileSearch/sessionStop`)
...
var _i = class {
  ...
  configNotices = [];
  fuzzyFileSearchController = new ui((e, t) => this.sendRequest(e, t));
  personality = null;
  ...
  requestClient = {
    ...
    prewarmThreadStart: (e, t) =>
      v(`prewarm-thread-start-for-host`, {
        hostId: this.hostId,
        params: e,
  ...
  getHasInProgressLocalConversation({ exceptConversationId: e } = {}) {
    return this.recentConversations.some((t) => t.id !== e && gi(t));
  }
  ...
  applyStreamRole(e, t) {
    if (!fi(this.streamRoles.get(e) ?? null, t)) {
  ...
  refreshRecentConversations(e = {}) {
    return v(`refresh-recent-conversations-for-host`, { hostId: this.hostId, ...e });
  }
  applyThreadTitleUpdateAndNotify(e) {
    this.applyConversationState(e.id, e);
  }
  broadcastConversationSnapshot(e) {
    v(`broadcast-conversation-snapshot`, { conversationId: e });
  }
  ...
  sendRequest(e, t, n) {
    return v(`send-cli-request-for-host`, {
      hostId: this.hostId,
      method: e,
      params: t,
  ...
  startWindowsSandboxSetup(e, t) {
    return v(`start-windows-sandbox-setup-for-host`, { hostId: this.hostId, mode: e, cwd: t });
  }
  async getAccount() {
    return this.sendRequest(`account/read`, { refreshToken: !1 });
  }
  unsubscribeInactiveConversation(e) {
    return v(`unsubscribe-thread-for-host`, { hostId: this.hostId, threadId: e });
  }
...
function vi(e) {
  ...
  return (
    ...
    e.addNotificationCallback(Object.keys(wt).filter(Ct), (e) => {
...
function yi(e) {
  return {
    action: Bn.CODEX_REMOTE_SSH_CONNECTION_ACTION_REFRESH,
    result: En.CODEX_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED,
    source: Wn.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
    connectionCount: e.length,
    codexManagedConnectionCount: kt(e, `codex-managed`).length,
    discoveredConnectionCount: kt(e, `discovered`).length,
    autoConnectConnectionCount: e.filter((e) => e.autoConnect).length,
  };
}
function bi(e) {
  return {
    connectionSource: xi(e.source),
...
function xi(e) {
  switch (e) {
    case `codex-managed`:
      return On.CODEX_REMOTE_SSH_CONNECTION_SOURCE_CODEX_MANAGED;
    case `discovered`:
      return On.CODEX_REMOTE_SSH_CONNECTION_SOURCE_DISCOVERED;
  }
}
function Si(e) {
  switch (e) {
    case `disconnected`:
      return Ln.CODEX_REMOTE_SSH_CONNECTION_STATE_DISCONNECTED;
    case `connecting`:
    case `restarting`:
      return Ln.CODEX_REMOTE_SSH_CONNECTION_STATE_CONNECTING;
    case `error`:
      return Ln.CODEX_REMOTE_SSH_CONNECTION_STATE_ERROR;
    case `connected`:
      return Ln.CODEX_REMOTE_SSH_CONNECTION_STATE_CONNECTED;
    case null:
      return Ln.CODEX_REMOTE_SSH_CONNECTION_STATE_UNSPECIFIED;
  }
}
function Ci(e) {
  if (e == null) return wn.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UNKNOWN;
  switch (e.code) {
    case `connection-failed`:
    case `remote-codex-not-found`:
      return wn.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_CONNECTION_FAILED;
    case `login-required`:
      return wn.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_LOGIN_REQUIRED;
    case `update-required`:
      return wn.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UPDATE_REQUIRED;
    case `restart-required`:
      return wn.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_RESTART_REQUIRED;
  }
}
var wi = new Set([`disconnected`, `connecting`, `error`, `connected`]);
function Ti(e, { connection: t, connectionState: n, connectionError: r, errorCategory: i, ...a }) {
  if (e == null) return;
  let o = i ?? (r == null ? null : Ci(r));
  e.logProductEvent(Pn, {
    ...a,
    ...(t == null ? {} : bi(t)),
    ...(n === void 0 ? {} : { connectionState: Si(n) }),
    ...(o == null ? {} : { errorCategory: o }),
  });
}
function Ei(e, { error: t, hostId: n, previousError: r, previousState: i, state: a }) {
  if (
    !wi.has(a) ||
    ...
    return;
  let o = P(e.get, `remote_ssh_connections`)?.find((e) => e.hostId === n) ?? null;
  o != null &&
    Ti(e.get(zn), {
      action: Bn.CODEX_REMOTE_SSH_CONNECTION_ACTION_STATE_CHANGED,
      source: Wn.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_CONNECTION_MANAGER,
      connection: o,
      connectionState: a,
...
var Di = t((e, t) => {
  ...
  ia = t((e, t) => {
    t.exports = na()() ? String.prototype.contains : ra();
  }),
  aa = t((e, t) => {
    var n = Zi(),
      r = ta(),
  ...
  Sa = t((e, t) => {
    ...
    t.exports = function (e) {
      ...
      if (!u(e)) {
        if ((S = e[n]) !== void 0) {
          for (ee = o(S).call(e), h && (v = new h()), x = ee.next(), g = 0; !x.done; )
            ((C = t ? d.call(t, m, x.value, g) : x.value),
              h ? ((f.value = C), p(v, g, f)) : (v[g] = C),
              (x = ee.next()),
              ++g);
          y = g;
        } else if (l(e)) {
          for (y = e.length, h && (v = new h()), g = 0, _ = 0; g < y; ++g)
            ((C = e[g]),
              g + 1 < y && ((b = C.charCodeAt(0)), b >= 55296 && b <= 56319 && (C += e[++g])),
              (C = t ? d.call(t, m, C, _) : C),
              h ? ((f.value = C), p(v, _, f)) : (v[_] = C),
              ++_);
          y = _;
        }
      }
      if (y === void 0)
        for (y = a(e.length), h && (v = new h(y)), g = 0; g < y; ++g)
          ((C = t ? d.call(t, m, e[g], g) : e[g]), h ? ((f.value = C), p(v, g, f)) : (v[g] = C));
      return (h && ((f.value = null), (v.length = y)), v);
    };
  }),
  Ca = t((e, t) => {
    t.exports = sa()() ? Array.from : Sa();
  }),
  wa = t((e, t) => {
    var n = Ca(),
      r = Array.isArray;
  ...
  Da = t((e, t) => {
    ...
    t.exports = function (e, t, a) {
      ...
      return (
        a.normalizer &&
          ((C = s(a.normalizer)), (_ = C.get), (v = C.set), (y = C.delete), (b = C.clear)),
        ...
        (D = _
          ? r(function (t) {
              ...
              if ((O && (a = O(a)), (r = _(a)), r !== null && hasOwnProperty.call(m, r)))
                return (w && h.emit(`get`, r, a, this), m[r]);
              ...
              return ((m[r] = i), T && h.emit(`set`, r, null, i), i);
            }, g)
          : t === 0
            ? function () {
                var t;
                if (hasOwnProperty.call(m, `data`))
                  return (w && h.emit(`get`, `data`, arguments, this), m.data);
                if (
                  ((t = arguments.length ? c.call(e, this, arguments) : l.call(e, this)),
                  hasOwnProperty.call(m, `data`))
                )
                  throw n(`Circular invocation`, `CIRCULAR_INVOCATION`);
                return ((m.data = t), T && h.emit(`set`, `data`, null, t), t);
              }
            : function (t) {
                var r,
                  i = arguments,
        ...
        (h = {
          ...
          delete: function (e) {
            ...
            hasOwnProperty.call(m, e) &&
              (y && y(e), (t = m[e]), delete m[e], E && h.emit(`delete`, e, t));
          },
          clear: function () {
            var e = m;
          ...
          on: function (e, t) {
            return (
              e === `get` ? (w = !0) : e === `set` ? (T = !0) : e === `delete` && (E = !0),
              f.call(this, e, t)
            );
          },
          emit: p,
        ...
        d(D, { __memoized__: i(!0), delete: i(ee), clear: i(h.clear), _get: i(x), _has: i(S) }),
        h
      );
    };
  }),
...
var io = e(no(), 1),
  ao = B({ code: Nt([Jt(), R()]), message: R().min(1) }).passthrough(),
  oo = class {
    requestLifecycleListeners = new Set();
    requestPromises = new Map();
    sendConfigReadRequestMemoized = (0, io.default)(
      (e, t, n) => {
    ...
    onResult(e, t) {
      ...
      I.error(`No promise for request ID`, { safe: { id: e }, sensitive: {} });
    }
    onError(e, t) {
      let n = this.requestPromises.get(e);
      if (n) {
        (I.error(`Request failed`, {
          safe: {
            id: e,
            method: String(n.method),
            durationMs: Date.now() - n.startedAtMs,
      ...
      I.error(`Received app server error`, { safe: {}, sensitive: { id: e, error: t } });
    }
    ...
    emitRequestLifecycleEvent(e) {
      for (let t of this.requestLifecycleListeners)
        try {
          t(e);
        } catch (t) {
          I.warning(`app_server_request_lifecycle_listener_failed`, {
            safe: { eventType: e.type },
            sensitive: { error: t },
          });
        }
    }
...
function so(e) {
  ...
  return t.success ? new lo(co(t.data)) : e;
}
function co(e) {
...
function mo(e) {
  try {
    let t = { ancestors: new Set(), remainingChars: po, truncated: !1 };
    return vo(JSON.stringify(ho(e, t, ``), null, 2) ?? String(e), t.truncated);
  } catch (e) {
    return vo(`[Unserializable payload: ${String(e)}]`, !1);
  }
}
function ho(e, t, n, r = !0) {
  if (r && e != null && (typeof e == `object` || typeof e == `function`)) {
    let r = Reflect.get(e, `toJSON`);
    if (typeof r == `function`) return ho(Reflect.apply(r, e, [n]), t, n, !1);
  }
  if (typeof e == `string`) {
  ...
  if (e instanceof Error) return ho({ message: e.message, name: e.name, stack: e.stack }, t, n);
  if (typeof e == `bigint`) return ho(e.toString(), t, n);
  if (typeof e == `function`) return ho(`[Function ${e.name || `anonymous`}]`, t, n);
  ...
  t.ancestors.add(e);
  let i = Array.isArray(e) ? go(e, t) : _o(e, t);
...
function go(e, t) {
  ...
  for (let [r, i] of e.entries())
    if (!yo(t, 2) || (n.push(ho(i, t, String(r))), t.truncated)) break;
...
function _o(e, t) {
  ...
  for (let r in e)
    if (
      ...
      (!yo(t, r.length + 5) || ((n[r] = ho(Reflect.get(e, r), t, r)), t.truncated))
    )
      break;
  return n;
}
function vo(e, t) {
  return !t && e.length <= po ? e : `${e.slice(0, po)}${fo}`;
}
function yo(e, t) {
...
var bo = e(Ze(), 1),
  ...
  So = new (class {
    ...
    syncEntriesSnapshot() {
      ...
      if (!(0, bo.default)(this.entriesSnapshot, e)) {
  ...
  Co = class {
    ...
    countsByKey = new Map();
    constructor(e) {
      ((this.hostId = e), So.addRequestRecorder(this));
    }
    getEntries() {
      return [...this.entries];
    }
    ...
    trackRequest(e) {
      ...
      (this.countsByKey.set(n, r),
        ...
        So.syncEntriesSnapshot());
    }
    finishRequest(e) {
      let t = e.endedAtMs,
        n = e.type === `completed` ? void 0 : mo(e.error),
        r = e.type === `completed` ? mo(e.result) : void 0,
        i = !1;
...
function wo(e) {
  return So.addEntriesCallback(e);
}
function To() {
  return So.getEntriesSnapshot();
}
function Eo(e) {
  So.clearEntries(e);
}
function Do(e, t) {
  t.addTurnCompletedListener((t) => {
    let n = P(e.get, `remote_ssh_connections`)?.find((e) => e.hostId === t.hostId) ?? null,
      r = P(e.get, `remote_control_connections`)?.find((e) => e.hostId === t.hostId) ?? null,
      i = null;
    (n == null
      ? r == null
        ? t.hostId === `local` && (i = Hn.CODEX_APP_TURN_TRANSPORT_LOCAL)
        : (i = Hn.CODEX_APP_TURN_TRANSPORT_REMOTE_CONTROL)
      : (i = Hn.CODEX_APP_TURN_TRANSPORT_SSH),
      i != null && Vn(e, Cn, { status: Oo(t.status), transport: i, ...(n == null ? {} : bi(n)) }));
  });
}
function Oo(e) {
  switch (e) {
    case `completed`:
      return Mn.CODEX_APP_TURN_STATUS_COMPLETED;
    case `interrupted`:
      return Mn.CODEX_APP_TURN_STATUS_INTERRUPTED;
    case `failed`:
      return Mn.CODEX_APP_TURN_STATUS_FAILED;
    case `inProgress`:
      return Mn.CODEX_APP_TURN_STATUS_IN_PROGRESS;
  }
}
function ko(e, t = {}) {
...
function Mo(e) {
  let t = Vo(e);
  if (t?.liveTailIslandId != null) {
    let e = t.islands.find((e) => e.id === t.liveTailIslandId);
    if (e != null) return e.entries.at(-1)?.turn ?? null;
  }
  return Po(e, () => !0);
}
function No(e, t) {
  let n = Vo(e);
  if (n != null) {
    for (let e of n.islands) {
      let n = e.entries.find(({ turn: e }) => t(e));
      if (n != null) return n.turn;
    }
    return null;
  }
  return e.turns.find(t) ?? null;
}
function Po(e, t) {
  let n = Vo(e);
  if (n != null) {
    for (let e = n.islands.length - 1; e >= 0; --e) {
      let r = (0, jo.default)(n.islands[e]?.entries ?? [], ({ turn: e }) => t(e));
      if (r != null) return r.turn;
    }
    return null;
  }
  return (0, jo.default)(e.turns, t) ?? null;
}
function Fo(e, t) {
  let n = Vo(e);
  if (n != null) {
    for (let e of n.islands) e.entries.forEach(({ turn: e }) => t(e));
    return;
  }
  e.turns.forEach(t);
}
function Io(e, t) {
  let n = Vo(e);
  if (n != null) {
    for (let e = 0; e < n.islands.length; e += 1) {
      let r = n.islands[e];
      if (r == null) continue;
      let i = r.entries.findIndex((e) => e.turn === t);
      if (i >= 0) {
        (r.entries.splice(i, 1),
          r.entries.length === 0 &&
            r.id === n.liveTailIslandId &&
            !n.isComplete &&
            (n.islands.splice(e, 1), (n.liveTailIslandId = null)));
        return;
      }
    }
    return;
  }
  let r = e.turns.indexOf(t);
  r >= 0 && e.turns.splice(r, 1);
}
function Lo(e, t, n) {
  if (e.turnHistory?.kind === `canonical`) {
    let r = ko({ id: `loaded-history:${G()}`, entries: t.map((e) => ({ turn: e })) });
    ((r.isComplete = n), (e.turnHistory.history = J(r)));
    return;
  }
  e.turns = t.map(J);
}
function Ro(e, t) {
  ...
  if (Vo(e) != null) {
    let t = Uo(e);
    return (t.entries.push({ key: `${t.id}:local:${G()}`, turn: n }), n);
  }
...
function zo(e, t, n) {
  let r = Mo(e);
  return r == null
    ? (I.error(`No turns for conversation`, { safe: { conversationId: e.id }, sensitive: {} }),
      null)
    : t
      ? Po(e, (e) => e.turnId === t) ||
        (n?.rebindLatestInProgressPlaceholder && r.turnId == null && r.status === `inProgress`
          ...
          : Ho(e) === 1 &&
              ...
              r.error == null &&
              r.items.length === 0
            ? (I.warning(`Rebinding placeholder latest turn to incoming event`, {
            ...
            : n?.synthesizeMissingTurn
              ? (I.warning(`Synthesizing missing turn for incoming event`, {
                  safe: { turnId: t, conversationId: e.id },
                  sensitive: {},
                }),
                Ro(e, {
              ...
              : (I.error(`Turn not found for event`, {
                  safe: { turnId: t, conversationId: e.id },
                  sensitive: {},
                }),
                null))
...
function Vo(e) {
  return e.turnHistory?.kind === `canonical` ? e.turnHistory.history : null;
}
function Ho(e) {
  let t = Vo(e);
  return t == null ? e.turns.length : t.islands.reduce((e, t) => e + t.entries.length, 0);
}
function Uo(e) {
  let t = Vo(e);
  if (t == null) throw Error(`Canonical history is required`);
  let n = t.islands.find((e) => e.id === t.liveTailIslandId);
  if (n != null) return n;
  if (t.isComplete && t.islands.length === 1) {
    let e = t.islands[0];
    if (e != null) return ((t.liveTailIslandId = e.id), e);
  }
  let r = {
    id: `local-live-tail:${G()}`,
    entries: [],
    olderBoundary: { status: `exhausted` },
    newerBoundary: { status: `exhausted` },
  };
  return (t.islands.push(r), (t.liveTailIslandId = r.id), (t.isComplete = !1), r);
}
function Wo(e) {
  return e == null ? null : (Go(e.agentNickname) ?? Go(j(e.source)?.agentNickname));
}
function Go(e) {
...
var Ko = /^(?:data:image\/|https?:\/\/|file:\/\/|app:\/\/|\/@fs)/i;
function qo(e) {
  let t = typeof e.savedPath == `string` ? Jo(e.savedPath) : null;
  return { ...e, src: t ?? Jo(e.result) };
}
function Jo(e) {
  let t = e.trim();
  return t.length === 0 ? null : ht(t) ? at(lt(t)) : Ko.test(t) ? t : `data:image/png;base64,${t}`;
}
var Yo = new Map();
function Xo(e, t) {
  let n = t.trim();
...
function es(e) {
  return e.item.type === `imageGeneration`
    ...
    : e.item.type === `collabAgentToolCall`
      ? (e.onCollabAgentToolCall?.(e.item), $o({ item: e.item, threadsById: e.threadsById }))
      : e.item;
}
function ts(e) {
  let t = Wo(e);
      ...
      e.updateConversationState(t, (t) => {
        Fo(t, (t) => {
          for (let n of t.items) {
            if (n.type !== `collabAgentToolCall` || !n.receiverThreadIds.includes(e.threadId))
              continue;
            let t = Qo({ receiverThreadIds: n.receiverThreadIds, threadsById: e.threadsById });
            (0, bo.default)(n.receiverThreads, t) || (n.receiverThreads = J(t));
          }
        });
      });
}
var is = `read_thread_terminal`,
  as = {
    name: is,
  ...
  ls = class {
    ...
    constructor() {
      (F.subscribe(`terminal-data`, (e) => {
        ...
        F.subscribe(`clear-active-terminal`, () => {
    ...
    create(e) {
      ...
      return (
        ...
        F.dispatchMessage(`terminal-create`, { ...e, sessionId: t }),
        t
      );
    }
    attach(e) {
      (e.conversationId && this.setSessionMapping(e.sessionId, e.conversationId),
        ...
        F.dispatchMessage(`terminal-attach`, e));
    }
    write(e, t) {
    ...
    runHeadlessAction(e, t) {
      (this.updateSnapshotMetadata(e, { cwd: t.cwd, title: us(t.command), rawShellTitle: null }),
        this.sendOrQueueSessionAction(e, {
          type: `terminal-run-action`,
          cwd: t.cwd,
          command: t.command,
    ...
    setTitle(e, t) {
      let n = ds(t, this.getOrCreateSnapshot(e).cwd);
    ...
    resize(e, t, n) {
      ...
      (r?.cols === t && r.rows === n) ||
        ...
        F.dispatchMessage(`terminal-resize`, { sessionId: e, cols: t, rows: n }));
    }
    close(e) {
      (this.deleteSessionMapping(e), F.dispatchMessage(`terminal-close`, { sessionId: e }));
    }
      ...
      if (n != null) {
        for (let e of n.sessionIds)
          (this.deleteSessionMapping(e, { clearConversationState: !1, notify: !1 }),
            F.dispatchMessage(`terminal-close`, { sessionId: e }));
    ...
    sendSessionAction(e, t) {
      switch (t.type) {
        case `terminal-run-action`:
          F.dispatchMessage(`terminal-run-action`, {
            sessionId: e,
            cwd: t.cwd,
            command: t.command,
          });
          return;
        case `terminal-write`:
          F.dispatchMessage(`terminal-write`, { sessionId: e, data: t.data });
          return;
      }
    }
  };
function us(e) {
  return e.replace(ss, ``).trim();
}
function ds(e, t) {
  let n = us(e);
  if (n.length === 0) return null;
  let r = us(t);
  return r.length === 0 ? n : n === r || n === tn(r) ? null : fs(n, r);
}
function fs(e, t) {
  let n = tn(t);
  for (let r of cs) {
...
var ps = new ls(),
  ms = It({}),
  hs = `No app terminal session is attached to this thread yet.`;
function Y(e) {
...
async function _s(e, t) {
  if (!ms.safeParse(e).success) return Y(`${is} takes no arguments.`);
  try {
    return gs(
      ps.getSnapshotForConversation(H(t)) ??
        (await qe(`thread-terminal-snapshot`, { params: { threadId: t } })).session,
    );
  } catch (e) {
    return (
      I.error(`Failed to resolve thread terminal snapshot`, {
        safe: { threadId: t, tool: is },
        sensitive: { error: e },
      }),
...
var vs = `Interrupted before the steer was accepted.`,
  ys = `Run ended before the steer was accepted.`;
function bs(
  e,
  t,
  n,
...
function xs(
  ...
  return Cs(e.compareKey, a.compareKey, { acceptMissingImageInputs: n });
}
function Ss(e, t, n) {
...
function Cs(e, t, { acceptMissingImageInputs: n }) {
...
async function ws(e) {
  ...
  for (let [n, r] of e.conversations) j(r.source)?.parentThreadId === e.conversationId && t.add(n);
  for (let [n, r] of e.threadsById) j(r.source)?.parentThreadId === e.conversationId && t.add(H(n));
  return Array.from(t);
}
async function Ts(e) {
  let t = [],
...
var Es = class extends Error {
    constructor(e) {
      (super(`Unarchived conversation ${e} could not be loaded`),
        (this.name = `UnarchivedConversationLoadError`));
    }
  },
  Ds = B({ message: R() }).passthrough(),
  Os = B({ error: Ds }).passthrough();
function ks(e) {
  return e?.cwd ?? (0, jo.default)(e == null ? [] : N(e), (e) => !!e.params.cwd)?.params.cwd ?? `/`;
}
function As(e, t = {}) {
  return t.cleanupWorktree !== !1 && (e == null || j(e.source) == null);
}
async function js(e, t, n) {
  let r = [],
    ...
    a = await Promise.all(
      i
        .filter((e) => e.id !== t && !!e.cwd && Rs(e.cwd, n))
        .map(async (t) => (await e.readThread(H(t.id))).thread),
    );
  for (let i of a) {
    let a = H(i.id);
    i.forkedFromId !== t ||
...
async function Ms(e, t, n) {
  ...
  if (!r) {
    I.warning(`Cannot delete conversation that doesn't exist`);
    return;
  }
  (await Bs(e, t), await Ps(e, t, ks(r), { cleanupWorktree: As(r, n), source: n.source }));
}
async function Ns(e, t) {
  (e.dispatchMessageFromView(`unarchive-thread`, { hostId: e.hostId, conversationId: t }),
    I.info(`Unarchive requested`, { safe: { conversationId: t }, sensitive: {} }));
  try {
    (await e.unarchiveThread(t),
      I.info(`Unarchive succeeded`, { safe: { conversationId: t }, sensitive: {} }));
  } catch (e) {
    throw (
      I.error(`Unarchive failed`, {
  ...
  if ((await e.loadUnarchivedThread(t), !e.conversations.has(t))) throw new Es(t);
  e.dispatchMessageFromView(`thread-unarchived`, { hostId: e.hostId, conversationId: t });
}
async function Ps(e, t, n, r) {
  I.info(`Archive requested`, { safe: { source: r.source }, sensitive: { conversationId: t } });
  ...
  if (o)
    try {
      ...
      ((o = !1),
        I.warning(`Skipping archive cleanup after handoff lookup failed`, {
          safe: { conversationId: t },
          sensitive: { error: e },
        }));
    }
  ...
  try {
    ...
    try {
      ...
      if (!Fs(n, t)) throw (i || e.deleteSuppressedArchivedConversationId(t), n);
      I.info(`Archive skipped because thread has no active rollout`, {
        safe: { conversationId: t },
        sensitive: { error: n },
      });
      try {
        ...
        throw (
          ...
          I.warning(`Failed to persist inactive thread archive`, {
            safe: { conversationId: t },
            sensitive: { error: n },
          }),
          n
...
function Fs(e, t) {
  return Is(e)?.includes(`no rollout found for thread id ${t}`) ?? !1;
}
function Is(e) {
  if (e instanceof Error) return e.message;
  let t = Ds.safeParse(e);
  if (t.success) return t.data.message;
  let n = Os.safeParse(e);
  ...
  await Promise.all(
    n.map(async (n) => {
      try {
        ...
        I.warning(`Failed to interrupt subagent descendant`, {
...
async function Bs(e, t) {
  ...
  await Promise.all(
    n.map(async (n) => {
      ...
      if (!(!r && !i))
        try {
          await Ps(e, n, r == null ? (i?.cwd ?? `/`) : ks(r), {
            cleanupWorktree: !1,
            source: `subagent_descendant`,
          });
        } catch (e) {
          I.warning(`Failed to archive subagent descendant`, {
            safe: { conversationId: t, childConversationId: n },
            sensitive: { error: e },
          });
        }
...
function Vs(e, t) {
  return {
    activePermissionProfile:
      e.activePermissionProfile ?? (t != null && !t.id.startsWith(`:`) ? t : null),
...
var Us = Ge(p, `get-global-state`, (e) => ({ params: { key: e }, staleTime: L.FIVE_SECONDS })),
  Ws = u(p, (e, { get: t }) => {
    let n = t(Us, e);
    return { ...n, data: Js(e, n.data?.value) };
  });
async function Gs(e, t, n, r) {
  let i = e.query.snapshot(Us, t);
  await i.cancel();
  let a = i.getData();
  i.setData({ value: n });
  try {
    let { success: e } = await qe(`set-global-state`, { params: { key: t, value: n } });
    if (!e) {
    ...
    (await i.invalidate(), F.dispatchMessage(`query-cache-invalidate`, { queryKey: i.queryKey }));
  }
}
function Ks(e, t) {
  return qs(e, t).data;
...
function Ys(e, t) {
  return e === z.SIDEBAR_PROJECT_THREAD_ORDERS ? At(t) : t;
}
function Xs(e) {
  switch (e) {
    case `active`:
...
function ec(e, t) {
  e?.set($s, (e) =>
    e.some((e) => e.id === t.id && e.expiresAtMs > t.updatedAtMs)
      ? e
      : [t, ...e].filter((e) => e.expiresAtMs > t.updatedAtMs),
  );
}
function tc({ prompt: e, realtimeThreadId: t, scope: n, threadId: r, threadTitle: i }) {
  let a = Date.now();
  ec(n, {
    action: { path: `/local/` + r },
    expiresAtMs: rc(a),
    id: `realtime-thread-created:` + r,
    kind: `thread-created`,
    realtimeThreadId: t,
    threadId: r,
    threadTitle: i,
...
function nc({
  ...
  ec(r, {
    ...
    direction: e,
    expiresAtMs: rc(o),
    id: `realtime-thread-message:${i}:${o}`,
    kind: `thread-message`,
    realtimeThreadId: n,
    threadId: i,
    threadTitle: a,
...
function lc(e, t, n, r, i) {
  try {
    ...
    if (!o) return;
    if (o.method !== r) {
      I.error(`Unexpected approval request method`, { safe: { method: o.method }, sensitive: {} });
      return;
    }
    let s;
    switch (r) {
...
function uc(e, t, n, r) {
  let i = sc(e, t);
  if (i) {
    cc(e, i, `thread-follower-command-approval-decision`, {
      conversationId: t,
      requestId: n,
      decision: r,
    }).catch((e) => {
      I.error(`Failed to forward command approval decision`, {
        safe: { conversationId: t },
        sensitive: { error: e },
      });
    });
  ...
  lc(e, t, n, `item/commandExecution/requestApproval`, r);
}
function dc(e, t, n, r) {
  let i = sc(e, t);
  if (i) {
    cc(e, i, `thread-follower-file-approval-decision`, {
      conversationId: t,
      requestId: n,
      decision: r,
    }).catch((e) => {
  ...
  lc(e, t, n, `item/fileChange/requestApproval`, r);
}
function fc(e, t, n, r) {
  try {
    var i = oc();
    let a = sc(e, t);
    if (a) {
      cc(e, a, `thread-follower-permissions-request-approval-response`, {
        conversationId: t,
        requestId: n,
        response: r,
      }).catch((e) => {
        I.error(`Failed to forward permissions approval response`, {
          safe: { conversationId: t },
          sensitive: { error: e },
        });
      });
    ...
    (I.info(`Sending server response`, {
      ...
      i.u(ln.notifications?.hide({ notificationId: `approval-${e.hostId}-${n}` })),
...
function pc(e, t, n, r) {
  let i = sc(e, t);
  if (i) {
    cc(e, i, `thread-follower-submit-user-input`, {
      conversationId: t,
      requestId: n,
      response: r,
    }).catch((e) => {
      I.error(`Failed to forward user-input response`, {
        safe: { conversationId: t },
        sensitive: { error: e },
      });
    });
  ...
  if (a.method !== `item/tool/requestUserInput`) {
    I.error(`Unexpected user input request method`, { safe: { method: a.method }, sensitive: {} });
    return;
  }
  let o = {};
...
function mc(e, t, n, r) {
  let i = sc(e, t);
  if (i) {
    cc(e, i, `thread-follower-submit-mcp-server-elicitation-response`, {
      conversationId: t,
      requestId: n,
      response: r,
    }).catch((e) => {
      I.error(`Failed to forward MCP server elicitation response`, {
        safe: { conversationId: t },
        sensitive: { error: e },
      });
    });
  ...
  if (a) {
    if (a.method !== `mcpServer/elicitation/request`) {
      I.error(`Unexpected MCP server elicitation request method`, {
...
function yc(e) {
  ...
  try {
    I.warning(`worker_rpc_response_error`, {
  ...
  xc = class {
    ...
    constructor(e, t) {
      ((this.requestClient = e),
        ...
        this.requestClient.addRequestLifecycleListener((e) => {
          e.type !== `failed` ||
            !Pt(e.error) ||
            (I.warning(`cloud_requirements_auth_error`, {
    ...
    cancelLogin(e) {
      this.requestClient.sendRequest(`account/login/cancel`, { loginId: e }).catch((t) => {
        I.warning(`account_login_cancel_failed`, {
    ...
    async loginWithChatGpt(e, { useStreamlinedLogin: t = !1 } = {}) {
      ...
      if (a.aborted) throw (this.cancelLogin(r), await o?.(), _c());
      let s = () => {},
        c = Lt(),
        l = async ({ trigger: e }) => {
          if (o == null) {
            I.info(`remote_chatgpt_login_port_forward_stop_skipped`, {
              safe: { hostId: this.requestClient.hostId, loginId: r, trigger: e },
              sensitive: {},
            });
            return;
          }
          (I.info(`remote_chatgpt_login_port_forward_stop_requested`, {
            safe: { hostId: this.requestClient.hostId, loginId: r, trigger: e },
            sensitive: {},
          }),
            await o(),
            I.info(`remote_chatgpt_login_port_forward_stop_finished`, {
              safe: { hostId: this.requestClient.hostId, loginId: r, trigger: e },
              sensitive: {},
            }));
        },
          ...
          complete: (e) => {
            e.loginId !== r ||
              ...
              l({ trigger: `completed` }).catch((e) => {
                I.warning(`failed to stop remote chatgpt login port forward`, {
      ...
      let d = () => {
        u.finished ||
          (I.info(`remote_chatgpt_login_abort_requested`, {
          ...
          I.info(`remote_chatgpt_login_cancel_requested`, {
            safe: { hostId: this.requestClient.hostId, loginId: r },
            sensitive: {},
          }),
          this.cancelLogin(r),
    ...
    async loginWithChatGptDeviceCode(e) {
      ...
      if (!a || !o)
        throw (
          I.warning(`chatgpt_device_code_login_response_missing_fields`, {
      ...
      let u = e.signal,
        d = () => {
          l.finished || ((l.finished = !0), s(), this.cancelLogin(n), c.reject(_c()));
        };
      return (
      ...
      switch (e.method) {
        case `mcpServer/oauthLogin/completed`: {
          ...
          (this.mcpLoginCallbacks.forEach((e) =>
            ...
            n
              ? I.info(`MCP server OAuth login completed`, { safe: {}, sensitive: { name: t } })
              : I.debug(`MCP server OAuth login failed`, {
                  safe: {},
        ...
        case `windowsSandbox/setupCompleted`: {
          ...
          if (!i) {
            (this.clearTimedOutWindowsSandboxSetupMode(t),
              I.warning(`Received windowsSandbox/setupCompleted without active setup`, {
          ...
          if (i.mode !== t) {
            (this.clearTimedOutWindowsSandboxSetupMode(t),
              I.warning(`Received windowsSandbox/setupCompleted for wrong mode`, {
        ...
        case `deprecationNotice`: {
          ...
          (this.setLatestConfigNotice({
            ...
            I.warning(`Deprecation notice`, { safe: { summary: t, details: n }, sensitive: {} }));
          return;
        }
        case `configWarning`: {
          ...
          (this.setLatestConfigNotice({
            ...
            I.debug(`Config warning`, { safe: { summary: t, details: n }, sensitive: {} }));
          return;
        }
      }
    }
    ...
    setLatestConfigNotice(e) {
      let t = this.configNotices.findIndex((t) => (0, bo.default)(t, e));
      this.configNotices = (
        t === -1
          ? [...this.configNotices, e]
...
function Cc(e) {
  ...
  for (; n > 0; ) {
    ...
    if (e.length > 0 && on(rn(r))) return { label: e, path: r, fsPath: r };
    n = t.lastIndexOf(`: `, n - 1);
  }
  return null;
}
function wc(e) {
  ...
  let n = e.slice(0, t),
    r = n.indexOf(we);
  if (r === -1) return [];
  let i = n.slice(r + we.length).split(`
`),
    a = [];
  for (let e of i) {
    let t = e.trimStart();
...
function Ec(e, { fallbackCwd: t = null } = {}) {
...
function Oc({ threadId: e, turns: t, model: n, reasoningEffort: r, cwd: i, permissions: a }) {
  return kc({ threadId: e, turns: t, model: n, reasoningEffort: r, cwd: i, permissions: a });
}
function kc({ threadId: e, turns: t, model: n, reasoningEffort: r, cwd: i, permissions: a }) {
  let o = [];
  for (let s of t) {
    let t = [],
      c = s.items[0];
    ...
    o.push({
      ...
      turnId: s.id,
      turnStartedAtMs: Ac(s.startedAt),
      durationMs: s.durationMs,
      finalAssistantStartedAtMs: Ac(s.completedAt),
      status: s.status,
      error: s.error,
      diff: null,
      items: s.items.map(jc),
    });
  }
  return o;
}
...
async function Mc({
  ...
  let a = await Pc({ conversation: e, olderCursor: t, fetchPage: r, getCurrentConversation: i });
  if (a.status === `stale`) return a;
  let o = i();
  if (o == null) return { status: `missing` };
  if (o.turnsPagination?.olderCursor !== t) return { status: `stale` };
  let s = Nc({ olderTurns: a.turns, currentTurns: N(o), oldestLoadedTurnId: n });
  return { status: `loaded`, olderTurns: a.turns, mergedTurns: s };
}
function Nc({ olderTurns: e, currentTurns: t, oldestLoadedTurnId: n }) {
  let r = n == null ? -1 : t.findIndex((e) => e.turnId === n),
    i = Ne(
      ko({
        id: `tail-hydration`,
        entries: (r === -1 ? Be(e, t) : Be(Be(t.slice(0, r), e), t.slice(r))).map((e) => ({
          turn: e,
        })),
      }),
    );
...
async function Pc({ conversation: e, olderCursor: t, fetchPage: n, getCurrentConversation: r }) {
  let i = Fc(e),
    a = [],
    o = t;
  for (; o != null; ) {
...
function Lc(e, t) {
  let n = Ic.get(e);
  return (n ?? ((n = new Bc(e)), Ic.set(e, n)), n.loadRemainingConversationTurns(t));
}
function Rc() {
...
var Bc = class {
  ...
  async loadCurrentConversationTurns(e) {
    ...
    try {
      ...
      throw (
        I.warning(`Failed to load older thread turns`, {
...
function Vc(e, t) {
  return {
    ...e,
    hostId: e.hostId ?? t,
    turnsPagination: e.turnsPagination ?? Rc(),
...
function Hc(e, t) {
  let n = e,
    r = {
      ...n,
      createdAt: Sc(n.createdAt) ?? Date.now(),
      updatedAt: Sc(n.updatedAt) ?? Sc(n.createdAt) ?? Date.now(),
      recencyAt: Sc(n.recencyAt),
      title: n.title ?? null,
      turns: (n.turns ?? []).map(Uc),
    };
  return (
      ...
      (r.turnHistory = {
        ...
        history: {
          ...
          islands: n.turnHistory.history.islands.map((e) => ({
            ...e,
            entries: e.entries.map((e) => ({ ...e, turn: Uc(e.turn) })),
          })),
        },
      }),
    Vc(r, t)
...
function Uc(e) {
  return {
    ...e,
    turnStartedAtMs: Sc(e.turnStartedAtMs),
    durationMs: e.durationMs ?? null,
    firstTurnWorkItemStartedAtMs: Sc(e.firstTurnWorkItemStartedAtMs),
    finalAssistantStartedAtMs: Sc(e.finalAssistantStartedAtMs),
...
var qc = class {
    ...
    shouldIgnoreThreadMutationAsFollower(e, t) {
      if (
        ...
        return !1;
      let n = Kc(t);
      return n ? this.getStreamRole(H(n))?.role === `follower` : !1;
    }
    shouldHandleDynamicToolCall(e) {
      return e == null ? !1 : this.getStreamRole(H(e))?.role === `owner`;
    }
    hasConversation(e) {
    ...
    broadcastIpcStatePatches(e, t) {
      ...
      (this.streamRevisionByConversationId.set(e, r),
        this.params.dispatchMessageFromView(`thread-stream-state-changed`, {
          ...
          version: qt(`thread-stream-state-changed`),
        }));
    }
    broadcastConversationSnapshot(e) {
    ...
    handleThreadStreamStateChanged(e, t, n) {
      ...
      if (t.type === `snapshot`) {
        let r = Hc(t.conversationState, this.params.hostId);
      ...
      if (i)
        try {
          let r = si(i, t.patches);
          (this.params.threadStore.setConversation(r),
            this.streamRevisionByConversationId.set(e, t.revision),
            this.resolveStreamRevisionWaiters(e, n, t.revision),
            this.params.threadStore.notifyConversationCallbacks(i.id));
        } catch (e) {
          I.warning(`Failed to apply patches for`, {
...
async function Yc(e, t) {
  return Xc((await e.sendRequest(`config/read`, { includeLayers: !1, cwd: t ?? null })).config);
}
function Xc(e) {
  let t = Zc(e.profiles),
    n = typeof e.profile == `string` ? Zc(t?.[e.profile]) : null;
  if (n == null) return e;
  let r = { ...e };
...
function Zc(e) {
  let t = Jc.safeParse(e);
  return t.success ? t.data : null;
}
var Qc = `chrome_extension`,
  $c = `browser_use_full_cdp_access`;
function el(e) {
  return e === !1;
}
(function (e) {
...
var tl = `https://chatgpt.com/backend-api`,
  nl = `agent`,
  rl = `page_content`,
  il = `codex_browser_use`;
function al(e) {
...
function ll(e, { conversationId: t, turnId: n, urlRequestSource: r = il } = {}) {
  let i;
  try {
    i = new URL(e);
  } catch {
  ...
  return fl(a)
    ...
    : {
        ...
        displayUrl: dl(i),
        endpoint: ul(i, { conversationId: t, turnId: n, urlRequestSource: r }),
      };
}
function ul(e, { conversationId: t, turnId: n, urlRequestSource: r }) {
  let i = new URL(e.origin);
  ((i.pathname = e.pathname), (i.search = e.search));
  let a = new URL(`${tl}/aura/site_status`);
  return (
...
var ml = `SAVE_TAB_CONTEXT_ASSET_CREATE`,
  hl = `SAVE_TAB_CONTEXT_ASSET_APPEND_CHUNK`,
  gl = `SAVE_TAB_CONTEXT_ASSET_FINISH`,
  _l = `SAVE_TAB_CONTEXT_ASSET_ABORT`,
  vl = `SAVE_TAB_CONTEXT_ASSET_REMOVE`,
  yl = `getTabContext`,
  bl = {
    name: yl,
  ...
  xl = It({ tabId: Jt().int().nonnegative() }),
  Sl = It({
    contentType: R().nullable(),
    documentData: It({ contentType: R().nullable(), dataBase64: R() }).nullable().optional(),
    documentTooLarge: jt().optional(),
    selectedText: R().nullable().optional(),
    text: R(),
    textWithSelectionMarkers: R().nullable().optional(),
    title: R(),
    url: R(),
  }),
  Cl = B({ url: R().optional() }),
  wl = [`audio/`, `font/`, `image/`, `video/`],
  Tl = [
  ...
  El = `\\.(?:7z|aiff?|avif|bmp|bz2|dmg|docx?|eot|epub|exe|gif|gz|heic|heif|ico|iso|jpe?g|m4a|m4v|mov|mp3|mp4|odp|ods|odt|ogg|ogv|otf|parquet|pdf|pkg|png|pptx?|rar|sqlite|svg|tar|tiff?|ttf|wasm|wav|webm|webp|woff2?|xlsx?|zip)$`,
  Dl = new RegExp(El, `i`),
  Ol = 100 * 1024 * 1024,
  kl = 16 * 1024,
  Al = `Chrome tab document is too large.`,
  jl = `${il}:extension`,
  Ml = {
  ...
  Nl = {
    knownNonTextFileExtensionPatternSource: El,
    maxDocumentBytes: Ol,
    mediaMimeTypePrefixes: wl,
    textLikeMimeTypes: Tl,
  };
async function Pl(e, t = {}) {
  let n = xl.safeParse(e);
  if (!n.success) return Y(`${yl} requires a numeric tabId argument.`);
  let r = Fl();
  if (r?.scripting == null) return Y(`Chrome tab context is unavailable in this runtime.`);
  let { tabId: i } = n.data,
    a =
      t.throwIfUrlBlocked ??
      ((e) =>
        Ll(e, { fetchSiteStatus: t.fetchSiteStatus, getSiteStatusAuth: t.getSiteStatusAuth })),
    o = await Il(r, i);
  if (o?.url == null) {
    if (t.throwIfUrlBlocked == null)
      return Y(`Unable to determine Chrome tab URL before reading tab context.`);
  } else
    try {
      await a(o.url);
    } catch (e) {
      return Y(e instanceof Error ? e.message : `Chrome tab URL is blocked.`);
    }
  let s = null,
    c = null;
  try {
    s = await Yl(r.scripting, i, t.shouldIncludeSelection?.(i) !== !1);
  } catch (e) {
    c = e;
  }
  if (s != null) {
    ...
    let e = cu(s.contentType, s.url, o?.url);
    if (e != null)
      return s.documentTooLarge === !0
        ...
        : Xl({
            ...
            fetchDocument: t.fetchDocument ?? nu,
...
`),
  ...
  let l = cu(null, null, o?.url);
  return l == null
    ? Y(c instanceof Error ? c.message : `Unable to read page text from Chrome tab ${i}.`)
    : Xl({
        contentType: null,
        documentData: null,
        fetchDocument: t.fetchDocument ?? nu,
...
async function Il(e, t) {
  ...
  try {
    let n = Cl.safeParse(await e.tabs.get(t));
...
async function Ll(e, t = {}) {
  ...
  let r;
  try {
    r = await (t.fetchSiteStatus ?? Rl)(n, t.getSiteStatusAuth);
  } catch {
    return;
  }
  if (ol(r) || sl(r)) throw Error(al(`Browser Use is not permitted on ${n.displayUrl}.`));
}
async function Rl({ endpoint: e }, t) {
  let n = await t?.();
  if (n == null) throw Error(`Unable to authenticate site-status request.`);
  let r = { Authorization: `Bearer ${n.accessToken}`, originator: il };
...
function zl(e) {
  ...
  if (t == null) return [];
  let n = Bl(t.docType),
    r = { exportUrl: Hl(t, n), format: n };
  return n === `pdf` ? [r] : [r, { exportUrl: Hl(t, `pdf`), format: `pdf` }];
}
function Bl(e) {
  switch (e) {
    case `document`:
  ...
  for (let s = e; s < i.length; s += 1) {
    ...
    if (e != null)
      try {
        let i = await n({
          dataBase64: Gl({
            base64: await Wl({ exportUrl: e.exportUrl, scripting: r, tabId: a }),
            format: e.format,
          }),
          fileName: ql({ format: e.format, title: o }),
        });
...
async function Wl({ exportUrl: e, scripting: t, tabId: n }) {
...
function Gl({ base64: e, format: t }) {
  if (t !== `md`) return e;
  let n = new TextDecoder().decode(mu(e));
  return hu(new TextEncoder().encode(Kl(n)));
}
function Kl(e) {
  return e.replace(/^\s*\[[^\]]+\]:\s*<data:[^>]+>\s*\n?/gm, ``).trim();
}
function ql({ format: e, title: t }) {
  return `${pu(Jl(t))}-${crypto.randomUUID()}.${e}`;
}
function Jl(e) {
  let t = e.split(` - `),
    n = t.at(-1);
...
async function Xl({
  ...
  if (a == null)
    return Y(`The Chrome tab is a non-text document, but this runtime cannot save it.`);
  try {
    let c = t ?? (await n(s)),
      l = await a({
        dataBase64: c.dataBase64,
        fileName: `chrome-tab-${o}-${globalThis.crypto.randomUUID()}${au(c.contentType ?? e, s) ?? r}`,
      });
    return (
      i?.(l),
      {
    ...
    return e instanceof Error && e.message === Al
      ? Zl()
      : Y(`Unable to save the Chrome tab document.`);
  }
}
function Zl() {
  return Y(`The Chrome tab document is larger than ${yu(Ol)}, so I did not save it.`);
}
async function Ql({
  ...
  try {
    ...
    return Y(`Unable to save the Chrome tab text content.`);
  }
}
function $l(e, t) {
  return vu(
...
function eu({
  ...
  return o.length === 0 || o === n.trim()
    ? e
      ? [...tu(i, a), ``, `<browser__document__content>`, n, `</browser__document__content>`].join(`
`)
      : n
    : r != null && r.trim().length > 0 && r.trim() !== n.trim()
      ? [...tu(i, a), ``, `<browser__document__content>`, r, `</browser__document__content>`].join(`
`)
      : [
          ...tu(i, a),
          ``,
...
async function nu(e) {
  ...
  return { contentType: t.headers.get(`content-type`), dataBase64: await ru(t, Ol) };
}
async function ru(e, t) {
  let n = Number(e.headers.get(`content-length`) ?? NaN);
  if (Number.isFinite(n) && n > t) throw Error(Al);
  let r = e.body?.getReader();
  if (r == null) {
    let n = await e.blob();
    if (n.size > t) throw Error(Al);
    return iu(n);
  }
  let i = [],
    a = 0;
  for (;;) {
    ...
    if (e) break;
    if (n != null) {
      if (((a += n.byteLength), a > t)) throw (await r.cancel(), Error(Al));
      i.push(new Uint8Array(n));
    }
  }
  return iu(new Blob(i));
}
async function iu(e) {
...
function au(e, t) {
  let n = lu(e) ?? uu(t);
  return n != null && !du(n) ? ou(n, t) : fu(t);
}
function ou(e, t) {
  return (
    fu(t) ??
...
function cu(e, t, n) {
  let r = lu(e) ?? uu(t);
  if (r != null) return du(r) || t == null ? null : { fileExtension: ou(r, t), url: t };
  let i = uu(n);
  if (i != null) return du(i) || n == null ? null : { fileExtension: ou(i, n), url: n };
  if (n != null) {
    let e = fu(n);
...
function du(e) {
  return wl.some((t) => e.startsWith(t))
    ? !1
    : e.startsWith(`text/`) || Tl.includes(e) || e.endsWith(`+json`) || e.endsWith(`+xml`);
}
function fu(e) {
  if (e == null) return null;
  try {
...
function gu(e) {
  return hu(new TextEncoder().encode(e));
}
function _u(e) {
...
var bu = [{ buildResponse: Pl, spec: bl }];
new Map(bu.map((e) => [e.spec.name, e]));
var xu = {
    generateMemories: !0,
    useMemories: !0,
  ...
  Cu = Nt([Jt(), Bt()])
    ...
    .pipe(Jt().int().nonnegative()),
  wu = B({
    generate_memories: jt()
      .optional()
      .catch(void 0),
    use_memories: jt()
      .optional()
      .catch(void 0),
    disable_on_external_context: jt()
      .optional()
      .catch(void 0),
    no_memories_if_mcp_or_web_search: jt()
      .optional()
      .catch(void 0),
    max_raw_memories_for_consolidation: Cu.optional().catch(void 0),
    max_unused_days: Cu.optional().catch(void 0),
    max_rollout_age_days: Cu.optional().catch(void 0),
    max_rollouts_per_startup: Cu.optional().catch(void 0),
    min_rollout_idle_hours: Cu.optional().catch(void 0),
    extract_model: R()
      .nullable()
      .optional()
      .catch(void 0),
    consolidation_model: R()
      .nullable()
      .optional()
      .catch(void 0),
  }).partial(),
...
function Eu(e) {
  if (e == null) return xu;
  let t = wu.safeParse(e.memories);
  if (!t.success) return xu;
  let n = t.data;
  return {
    generateMemories: n.generate_memories ?? xu.generateMemories,
    useMemories: n.use_memories ?? xu.useMemories,
    disableOnExternalContext:
      n.disable_on_external_context ??
      n.no_memories_if_mcp_or_web_search ??
      xu.disableOnExternalContext,
    maxRawMemoriesForConsolidation:
      n.max_raw_memories_for_consolidation ?? xu.maxRawMemoriesForConsolidation,
    maxUnusedDays: n.max_unused_days ?? xu.maxUnusedDays,
    maxRolloutAgeDays: n.max_rollout_age_days ?? xu.maxRolloutAgeDays,
    maxRolloutsPerStartup: n.max_rollouts_per_startup ?? xu.maxRolloutsPerStartup,
    minRolloutIdleHours: n.min_rollout_idle_hours ?? xu.minRolloutIdleHours,
    extractModel: n.extract_model ?? xu.extractModel,
    consolidationModel: n.consolidation_model ?? xu.consolidationModel,
  };
}
function Du(e) {
  return e == null
...
function Au(e, t) {
  let n = Object.fromEntries(t.map(({ keyPath: e, value: t }) => [Su[e], t]));
  return Object.assign(structuredClone(e), { memories: ju(e.memories, n) });
}
function ju(e, t) {
  let n = Tu.safeParse(e),
    r = n.success ? { ...n.data } : {};
  for (let [e, n] of Object.entries(t)) n == null ? delete r[e] : (r[e] = n);
  return r;
}
var Mu = `feature_overrides`,
  Nu = `3525926994`,
  Pu = `memories`,
  Fu = `875176429`,
  Iu = `open_in_codex`,
  ...
  zu = [
    ...
    { gateName: `1859936703`, featureKey: Ru },
    { gateName: `649513069`, featureKey: Iu },
  ],
  Bu = [
    {
      name: `3902942138`,
...
function Hu(e) {
  let t = Wu(e),
    n = Gu(e),
    r = { [ic]: hn(e, `2380644311`) };
  return { ...t, ...n, [Pu]: hn(e, Fu) && _n(e, Nu).groupName === `Test`, ...r };
}
function Uu(e) {
...
function Wu(e) {
  let t = {};
  for (let n of zu) hn(e, n.gateName) && (t[n.featureKey] = !0);
  return t;
}
function Gu(e) {
  let t = {};
  for (let n of Bu) {
    let r = Uu(mn(e, n.name).get(n.param, {}));
    for (let [e, i] of Object.entries(r)) n.featureAllowlist.has(e) && (t[e] = i);
  }
  for (let n of Vu) {
    let r = mn(e, n.layerName).get(n.param, null);
...
var Ku = `1574672957`,
  qu = R()
    ...
    .optional(),
  Ju = B({ desktop_context_section: qu, workspace_dependencies_section: qu });
function Yu(e, t, { disableExposureLog: n = !1 } = {}) {
  if (e == null || t == null) return null;
  let r = Ju.safeParse(mn(e, Ku, { disableExposureLog: n }).get(t, {}));
...
function Xu(e, t) {
  ...
  ((e.latestThreadSettings = t),
    ...
    (e.cwd = t.cwd),
    nd(e, n, t.collaborationMode.settings.model));
}
function Zu(e, t) {
  let n = ed(e.latestCollaborationMode, t),
...
function $u(e) {
  return e.activePermissionProfile === void 0
    ? e.sandboxPolicy === void 0
      ? e.permissions === void 0
        ? {}
        : {
            activePermissionProfile:
              e.permissions == null ? null : { id: e.permissions, extends: null },
          }
...
function rd(e) {
  ...
  Array.isArray(i) && (n.include_only = sd(i));
  ...
  Array.isArray(s) && (n.exclude = sd(s));
  let c = e[`shell_environment_policy.set`];
  return (
    typeof c == `object` && c && !Array.isArray(c) && (n.set = od(c)),
    Object.keys(n).length === 0 ? null : n
  );
}
function id(e, t) {
  let n = { ...od(e.set) },
    r = new Set([...sd(e.exclude), ...t.exclude]);
...
async function cd(e, t, n, r) {
  try {
    ...
    let o = rd(i) ?? rd(await Yc(t, r)) ?? { inherit: `all` };
    return {
      ...n,
      config: { ...i, shell_environment_policy: void 0, ...ad(id(o, a.shellEnvironment)) },
    };
  } catch (e) {
    return (
      I.warning(`Failed to apply worktree shell environment config`, {
        safe: { cwd: r },
        sensitive: { error: e },
      }),
      n
...
function ld({ requestedCwd: e, responseCwd: t, threadCwd: n, fallbackCwd: r }) {
  let i = t || n;
  return e != null && i != null && ud(e, i) ? e : i || e || r || void 0;
}
function ud(e, t) {
  let n = dd(e),
    r = dd(t);
...
function dd(e) {
  let t = e.replaceAll(`\\`, `/`);
  for (; t.length > 1 && t.endsWith(`/`) && !pd(t); ) t = t.slice(0, -1);
  return fd(t) ? t.toLowerCase() : t;
}
function fd(e) {
  ...
  hd = class {
    ...
    async buildNewConversationParams(e, t, n, r, i, a, o, s) {
      let c = await et(
        ...
        o,
        i,
        { baseInstructions: s?.baseInstructions, threadSource: s?.threadSource },
      );
      if (
        ((c = yt(c, a)),
        (c = await cd(this.params.fetchFromHost, this.params.requestClient, c, n)),
        s?.skipDynamicTools ||
          (c = {
            ...c,
    ...
    getInstructionOverrides(e, { disableExposureLog: t = !1 } = {}) {
      return Yu(this.params.scope?.get(gn) ?? null, e, { disableExposureLog: t });
    }
    async startThread({
      model: e,
      serviceTier: t,
      cwd: n,
      workspaceRoots: r,
      browserEnvironments: i,
      permissions: a,
      approvalsReviewer: o,
      memoryPreferences: s,
      baseInstructions: c,
      additionalDeveloperInstructions: l,
      config: u,
      threadSource: d,
      defaultFeatureOverrides: f,
      personality: p,
      threadStartKind: m = `default`,
    }) {
      let h = u?.[`features.onboarding_interactive_tools`] === !0 ? { ...f, [w]: !0 } : f,
        g = await this.buildNewConversationParams(e, t, n, a, o, h, p, {
          baseInstructions: c,
          additionalDeveloperInstructions: l,
          threadStartKind: m,
          threadSource: d,
        ...
        _ = Du(s);
      if ((_ != null && (g.config = { ...g.config, ..._ }), u != null)) {
        let { [w]: e, ...t } = u;
        g.config = { ...g.config, ...t };
      }
      return (
        i != null && ((g.environments = i), i.length > 0 && (g.cwd = i[0].cwd)),
        this.params.requestClient.sendRequest(
          `thread/start`,
          { ...g, ...(m === `conversational_onboarding` ? { runtimeWorkspaceRoots: r } : {}) },
          { timeoutMs: Ae },
        )
      );
    }
    ...
    prewarmConversation({
      ...
      agentMode: a,
      serviceTier: o,
      defaultFeatureOverrides: s,
      personality: c,
    }) {
      if (this.params.prewarmedThreadManager.hasPrewarmedThread(e)) return Promise.resolve(null);
      let l = i?.settings.model ?? null,
        u = Yc(this.params.requestClient, e),
        d = this.getInstructionOverrides(l, { disableExposureLog: !0 }),
        f = (async () => {
          try {
            let i = st(a, t, await u),
              d =
                n === `projectless`
                  ? Xt({
                      cwd: e,
                      projectlessOutputDirectory: r,
                      projectlessWorkspaceBrowserRoot: t[0] ?? null,
                    })
                  : null;
            return await this.prewarmThread({
              model: l,
              serviceTier: o,
              cwd: e,
              permissions: i,
              approvalsReviewer: i.approvalsReviewer,
              additionalDeveloperInstructions: d,
              defaultFeatureOverrides: s,
              personality: c,
            });
          } catch (t) {
            return (
              I.warning(`Failed to prewarm conversation`, {
                safe: {},
      ...
      return (this.params.prewarmedThreadManager.setPrewarmedThreadPromise(e, f, d), f);
    }
    async prewarmThread({
      model: e,
      serviceTier: t,
      ...
      defaultFeatureOverrides: o,
      personality: s,
    }) {
      let c = await this.buildNewConversationParams(e, t, n, r, i, o, s, {
        additionalDeveloperInstructions: a,
        disableInstructionOverrideExposureLog: !0,
      });
      return this.params.requestClient.prewarmThreadStart(c, { timeoutMs: Ae });
    }
    async createConversation({
      ...
      let h = null?.[0]?.cwd,
        ...
        _ = g === `projectless`,
        v =
          a == null || h == null || h === `/` || a.sandboxPolicy.type !== `workspaceWrite`
            ? a
            : { ...a, sandboxPolicy: { ...a.sandboxPolicy, writableRoots: [h] } },
        y = _ ? (n[0] ?? null) : null,
        b =
          d === `user` &&
          m === `default` &&
          c == null &&
          l == null &&
          (u == null || Object.keys(u).length === 0) &&
          v != null &&
          (v.activePermissionProfile == null || v.activePermissionProfile.id.startsWith(`:`)) &&
          ku(s) &&
          this.params.prewarmedThreadManager.hasPrewarmedThread(o),
        ee = b ? this.getInstructionOverrides(e?.settings.model ?? null) : null,
        x = b ? await this.params.prewarmedThreadManager.consumePrewarmedThread(o, ee) : null,
        S =
          _ && h == null
            ? Xt({ cwd: o, projectlessOutputDirectory: i, projectlessWorkspaceBrowserRoot: y })
            : null,
        C = S != null && l != null ? `${S}\n\n${l}` : (S ?? l),
        w =
          x ??
          (await this.startThread({
            ...
            memoryPreferences: s,
            permissions: v,
            approvalsReviewer: v?.approvalsReviewer ?? null,
            baseInstructions: c,
        ...
        T = Vs(w, a?.activePermissionProfile),
        E = H(w.thread.id);
      (this.params.threadStore.ensureRecentConversationId(E),
        I.info(`Conversation created`, { safe: { conversationId: E }, sensitive: {} }));
      let D = ld({
          requestedCwd: h ?? o ?? null,
          responseCwd: w.cwd ?? null,
          threadCwd: w.thread.cwd,
          fallbackCwd: n[0],
        }),
        O = await this.getStartedConversationGitInfo(w.thread, D, _);
      ts(w.thread);
      let te = Number(w.thread.createdAt) * 1e3,
        k = Number.isFinite(te) ? te : Date.now(),
        ne = Number(w.thread.updatedAt) * 1e3,
        A = Number.isFinite(ne) ? ne : k,
        re = {
          id: E,
          sessionId: w.thread.sessionId,
          forkedFromId: w.thread.forkedFromId == null ? null : H(w.thread.forkedFromId),
          hostId: this.params.hostId,
          turns: [],
          requests: [],
          createdAt: k,
          updatedAt: A,
          title: null,
          modelProvider: w.thread.modelProvider,
          ...
          projectlessOutputDirectory: _ ? (i ?? null) : null,
          source: w.thread.source,
          threadSource: w.thread.threadSource,
        };
      return (
        Zu(J(re), {
          ...Qu(
            ...
            e ?? {
              ...
              settings: {
                model: w.model,
                reasoning_effort: w.reasoningEffort ?? null,
                developer_instructions: null,
              },
            },
          ),
          activePermissionProfile: T.activePermissionProfile,
          permissions: T.activePermissionProfile?.id ?? null,
        }),
        this.params.threadStore.setConversation(re),
        _ &&
          (this.params.projectlessConversations.saveConversationId(E).catch((e) => {
            I.error(`Error saving projectless conversation id`, {
              safe: { conversationId: E },
              sensitive: { error: e },
            });
          }),
          this.params.projectlessConversations.saveWorkspaceRootHint(E, y),
          this.params.projectlessConversations.saveOutputDirectoryHint(E, i ?? null)),
        {
          conversationId: E,
          conversationResponse: w,
          effectiveCwd: D,
          firstTurnContext: { conversationId: E, gitInfo: O, workspaceKind: g },
        }
      );
    }
    ...
    let e = await Promise.all(
      d.map(async (e) => {
        try {
          ...
          return (
            I.warning(`Failed to read pinned thread`, {
              safe: {},
...
function vd(e, t) {
  return (
    ...
    (0, bo.default)(e.threadGoal, t.threadGoal) &&
    (0, bo.default)(e.threadRuntimeStatus, t.threadRuntimeStatus) &&
...
function bd(e) {
  let t = Number(e.createdAt) * 1e3,
    ...
    i = Number.isFinite(r) ? r : n,
    a = e.recencyAt == null ? null : Number(e.recencyAt) * 1e3;
  return { createdAt: n, updatedAt: i, recencyAt: Number.isFinite(a) ? a : null };
}
function xd({
  thread: e,
  hostId: t,
  ...
  let { createdAt: d, updatedAt: f, recencyAt: p } = bd(e);
  return {
    id: n,
    sessionId: e.sessionId,
    forkedFromId: e.forkedFromId == null ? null : H(e.forkedFromId),
    hostId: t,
    turns: r,
    requests: [],
    createdAt: d,
...
function Sd(e) {
  let t = j(e.conversations.get(e.conversationId)?.source)?.parentThreadId ?? null;
  if (t == null) return ``;
...
async function Cd(
  e,
  { modelProviders: t, archived: n = !1, sourceKinds: r = Ot, useStateDbOnly: i = !1 },
) {
  let a = [],
    o = async (s) => {
...
function wd(e) {
  ...
  return {
    ...
    subagentSpinnerProjectionSignature: Td(e),
  };
}
function Td(e) {
  let t = [];
...
function Ed({
  ...
  ns({ thread: s, threadsById: c, conversations: t, updateConversationState: u });
  let d = s.name?.trim() ?? ``,
    f = s.forkedFromId == null ? null : H(s.forkedFromId),
    { createdAt: p, updatedAt: m, recencyAt: h } = bd(s),
    g = s.status ?? null,
    _ = i(e),
    v = r(e),
    y = n(e);
  if (t.has(e)) {
    u(e, (e) => {
      (!e.title && d && (e.title = d),
        (e.source = s.source),
        (e.threadSource = s.threadSource ?? e.threadSource ?? null),
        ...
        (e.cwd = s.cwd),
        (e.workspaceKind = _),
        (e.workspaceBrowserRoot = _ === `projectless` ? (v ?? e.workspaceBrowserRoot) : null),
        (e.projectlessOutputDirectory =
          _ === `projectless` ? (y ?? e.projectlessOutputDirectory) : null),
  ...
  let b = _ === `projectless` && v != null ? Ut([v]) : ft();
  o({
    id: e,
...
var Dd = class {
  ...
  refreshes = new Map();
  readHydrationThreadMemoized = (0, io.default)(
    (e, t) =>
  ...
  setConversation(e) {
    this.conversations.set(e.id, Vc(e, this.params.hostId));
  }
  updateConversationState(e, t, n = !0) {
    let r = this.conversations.get(e);
    if (!r) {
      I.error(`Conversation state not found`, { safe: { conversationId: e }, sensitive: {} });
      return;
    }
    if (n) {
      let [n, i] = oi(r, t);
  ...
  notifyConversationCallbacks(e, { includeAnyCallbacks: t = !0 } = {}) {
    ...
    if (!n) {
      I.error(`No conversation state for conversation ID`, {
        safe: { conversationId: e },
        sensitive: {},
      });
      return;
  ...
  setPinnedThreadIds(e) {
    this.pinnedConversationIds = new Set(
      e.map((e) => H(e)).filter((e) => !this.suppressedArchivedConversationIds.has(e)),
    );
    let t = !1;
    for (let n of e) {
      let e = H(n);
      ...
      Promise.all(
        t.map(async (e) => {
          try {
            ...
            if (this.params.isConversationArchiving(H(e))) return;
            this.upsertHydratedCollabReceiverConversation(t.thread);
          } catch (t) {
            I.debug(`Failed to hydrate collab receiver thread`, {
              safe: { threadId: e },
              sensitive: { error: t },
            });
          } finally {
  ...
  upsertConversationFromThread(e) {
    ...
    let n = e.name?.trim() || null,
      { updatedAt: r, recencyAt: i } = bd(e),
      a = e.gitInfo,
      o = this.conversations.get(t),
      s = !o && !n,
      c = this.params.projectlessConversations.getThreadWorkspaceKind(t, e),
      l = this.params.projectlessConversations.getThreadWorkspaceBrowserRoot(e),
      u = this.params.projectlessConversations.getThreadProjectlessOutputDirectory(t, e);
    if (o) {
      let s = ai(o, (t) => {
        ((t.sessionId = e.sessionId),
          ...
          (t.cwd = e.cwd || t.cwd),
          (t.source = e.source),
          (t.forkedFromId = e.forkedFromId == null ? null : H(e.forkedFromId)),
          (t.modelProvider = e.modelProvider),
          (t.gitInfo = a ?? t.gitInfo),
          (t.workspaceKind = c),
          (t.workspaceBrowserRoot = c === `projectless` ? (l ?? t.workspaceBrowserRoot) : null),
          (t.projectlessOutputDirectory =
            c === `projectless` ? (u ?? t.projectlessOutputDirectory) : null),
          (t.resumeState = `resumed`),
          (t.updatedAt = r),
          (t.recencyAt = i),
          !t.title && n && (t.title = n));
      });
      (this.setConversation(s), this.notifyConversationCallbacks(t));
    } else
  ...
  async getUnarchivedThreadIds(e) {
    ...
    try {
      ...
      return (
        I.warning(`Failed to filter archived hydrated threads`, {
          safe: {},
          sensitive: { error: t },
        }),
        e
  ...
  async runRecentConversationRefresh(e, t) {
    ...
    if (i) {
      ...
      for (let n of s.data) {
        let r = this.threadsById.get(n.id),
          i = r != null && bd(r).updatedAt > bd(n).updatedAt ? r : n;
    ...
    for (let e of c) this.upsertRecentConversationState(H(e.id), e);
    let d = [];
    for (let e of l) {
      if (u.has(e)) continue;
  ...
  getThreadSummaryFromThread(e) {
    let t = H(e.id),
      { createdAt: n, updatedAt: r, recencyAt: i } = bd(e);
    return {
      conversationId: t,
      hostId: this.params.hostId,
      createdAt: n,
  ...
  upsertHydratedCollabReceiverConversation(e) {
    ...
    if (n) {
      let i = ai(n, (t) => {
        ((t.sessionId = e.sessionId),
          ...
          (t.recencyAt = o),
          !t.title && r && (t.title = r),
          Mo(t) ?? (t.resumeState = `needs_resume`));
      });
    ...
    if (
      ...
      let n = Sd({ conversationId: t, conversations: this.conversations });
      this.params.generateConversationTitle(
        t,
...
function jd(e, t, n) {
  ...
  return (
    ...
    (0, Ad.default)(r)?.status === `inProgress` ||
    r.some((e) =>
      e.items.some(
        (e) =>
          e.type === `collabAgentToolCall` &&
...
var Nd = 2e4;
function Pd({ current: e, delta: t, maxChars: n = Nd }) {
  ...
  Rd = class {
    ...
    constructor(e) {
      ((this.onFlush = e.onFlush),
        (this.fallbackIntervalMs = e.fallbackIntervalMs ?? Fd),
        (this.targetCharsPerFrame = e.targetCharsPerFrame ?? Id),
        (this.maxDrainFrames = e.maxDrainFrames ?? Ld));
    }
    enqueue(e) {
  ...
  Hd = class {
    ...
    updateConversationInactivityTracking(e, t = this.params.threadStore.getConversation(e)) {
      ...
      if (t != null && n?.role === `owner` && t.resumeState === `resumed` && !r) {
        ...
        (this.inactiveOwnerConversationSinceById.set(e, r),
          n ??
            I.debug(`inactive_thread_inactivity_tracking_enabled`, {
              safe: { conversationId: e, inactiveSinceMs: r, lastTurnStatus: M(t)?.status ?? null },
              sensitive: {},
            }));
      } else {
        ...
        (this.inactiveOwnerConversationRetryAtById.delete(e),
          i &&
            I.debug(`inactive_thread_inactivity_tracking_cleared`, {
              safe: {
                conversationId: e,
                hasActiveView: r,
    ...
    scheduleInactiveThreadUnsubscribeCheck() {
      ...
      if (t.length > 0) {
        (this.clearInactiveThreadUnsubscribeTimeout(),
          I.debug(`inactive_thread_unsubscribe_check_ready`, {
            safe: {
      ...
      ((this.inactiveThreadUnsubscribeNextCheckAtMs = n),
        ...
        I.debug(`inactive_thread_unsubscribe_check_scheduled`, {
          safe: {
            delayMs: r,
            nextCheckAtMs: n,
            trackedConversationCount: this.inactiveOwnerConversationSinceById.size,
    ...
    getInactiveOwnerConversationIdsToUnsubscribe(e) {
      ...
      for (let [n, r] of this.inactiveOwnerConversationSinceById.entries()) {
        ...
        let a = this.inactiveOwnerConversationRetryAtById.get(n) ?? null;
        (a != null && a > e) ||
          t.push({ conversationId: n, inactiveSinceMs: r, ttlExpired: e - r >= zd });
      }
      t.sort((e, t) => e.inactiveSinceMs - t.inactiveSinceMs);
      let n = Math.max(0, t.length - Vd),
        r = t.filter((e, t) => e.ttlExpired || t < n).map((e) => e.conversationId);
      return (
        r.length > 0 &&
          I.debug(`inactive_thread_unsubscribe_candidates_evaluated`, {
            safe: {
              candidateCount: t.length,
              conversationIdsToUnsubscribe: r,
              maxInactiveOwnerThreads: Vd,
              overage: n,
              ttlMs: zd,
            },
            sensitive: {},
    ...
    shouldKeepConversationLoaded(e) {
      return e.threadRuntimeStatus?.type === `active`
        ? !0
        : M(e)?.status === `inProgress` && le(e) == null;
    }
    async unsubscribeInactiveConversation(e) {
      ...
      if (t == null || t.resumeState !== `resumed` || n !== `owner`) {
        I.debug(`inactive_thread_unsubscribe_skipped`, {
      ...
      (this.unsubscribingConversationIds.add(e),
        I.debug(`inactive_thread_unsubscribe_started`, {
          safe: {
            conversationId: e,
      ...
      try {
        ...
        (I.info(`inactive_thread_unsubscribed`, {
        ...
        (this.inactiveOwnerConversationRetryAtById.set(e, n),
          I.warning(`inactive_thread_unsubscribe_failed`, {
...
function Ud(e, t, n = `completed`, r, i) {
  let a = Ut([]);
  return {
    params: {
      threadId: e,
...
function Wd(e, t, n) {
  e.updateConversationState(t, (e) => {
    ...
    Ro(e, Ud(t, n, `completed`, void 0, e.latestThreadSettings));
  });
}
function Gd(e, t, n) {
  e.updateConversationState(t, (e) => {
    if (No(e, (e) => e.items.some((e) => e.id === n.id)) != null) return;
    let r = Mo(e);
    if (r?.status === `inProgress`) {
      (X(r), r.items.push(n));
      return;
    }
    Ro(e, Ud(t, n, `inProgress`, r ?? void 0, e.latestThreadSettings));
  });
}
function Kd(e, t, n) {
  return {
    params: {
      threadId: e,
      input: [{ type: `text`, text: Oe(t.objective), text_elements: [] }],
      cwd: null,
...
function Yd(e, t, n) {
  Wd(e, t, { id: G(), type: `remoteTaskCreated`, taskId: n });
}
function Xd(e, t, n) {
  Wd(e, t, { id: G(), type: `personalityChanged`, personality: n });
}
function Zd(e, t, n, r) {
  let i = { id: ee(n), type: `planImplementation`, turnId: n, planContent: r, isCompleted: !1 };
  e.updateConversationState(t, (e) => {
    let t = No(e, (e) => e.turnId === n);
    t &&
...
function Qd(e, t, n, r) {
  e.updateConversationState(t, (e) => {
    ((e.requests = e.requests.filter((e) =>
      ...
      e.requests.push({ method: x, id: ee(n), params: { threadId: t, turnId: n, planContent: r } }),
      (e.hasUnreadTurn = !0));
  });
}
function $d(e, t, n) {
  e.updateConversationState(t, (e) => {
    (Fo(e, (e) => {
      if (e.turnId === n)
        for (let t of e.items) t.type === `planImplementation` && (t.isCompleted = !0);
    }),
      (e.requests = e.requests.filter((e) =>
        e.method === `item/plan/requestImplementation` ? e.params.turnId !== n : !0,
      )));
...
var ef = `pending-manual-context-compaction`,
  tf = class {
    pendingCounts = new Map();
    register(e, t) {
      (this.pendingCounts.set(t, (this.pendingCounts.get(t) ?? 0) + 1),
        Gd(e, t, { type: `contextCompaction`, id: ef, completed: !1, source: `manual` }));
    }
    remove(e, t) {
    ...
    removePendingItemFromTurn(e) {
      e.items = e.items.filter((e) => e.id !== ef);
    }
    removePendingItem(e, t) {
      e.updateConversationState(t, (e) => {
        let t = No(e, (e) => e.items.some((e) => e.id === ef));
        t &&
          (this.removePendingItemFromTurn(t),
          t.turnId == null && t.status === `inProgress` && t.items.length === 0 && Io(e, t));
      });
    }
  },
  nf = class {
  ...
  rf = `pasted-text.txt`,
  af = `pasted-text-attachments.json`,
  of = /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}\/[^/]+$/,
  sf = B({
    attachmentPaths: W(R()),
    pendingRemovalPaths: W(R()),
    textExcerptsByPath: gt(R(), R()).default({}),
  }),
  cf = class {
    state = null;
    ...
    async create(e, t) {
      return this.createManagedFile({
        ...
        filename: rf,
        label: t,
        textExcerpt: e.trim().slice(0, De),
      });
    }
    async createBase64(e, t) {
      return this.createManagedFile({ contentsBase64: e, filename: lf(t), label: t });
    }
    async createLocalFile(e, t) {
      return this.createManagedFileAttachment({
        filename: lf(t),
        label: t,
        writeAttachment: async (t) => {
          await this.options.requestClient.sendRequest(`fs/copy`, {
            destinationPath: t,
            sourcePath: e,
          });
        },
    ...
    async createManagedFile({ contentsBase64: e, filename: t, label: n, textExcerpt: r }) {
      return this.createManagedFileAttachment({
        ...
        textExcerpt: r,
        writeAttachment: async (t) => {
          await this.options.requestClient.sendRequest(`fs/writeFile`, { path: t, dataBase64: e });
        },
      });
    }
    async createManagedFileAttachment({
      filename: e,
      label: t,
      textExcerpt: n,
      writeAttachment: r,
      ...
      let a = cn(await this.createAttachmentDirectory(), e);
      (await r(a), i.attachmentPaths.add(a), n?.length && i.textExcerptsByPath.set(a, n));
      try {
      ...
      return { label: t, path: a, fsPath: a };
    }
    async remove(e) {
      let t = await this.getState();
    ...
    async readState() {
      try {
        let { dataBase64: e } = await this.options.requestClient.sendRequest(`fs/readFile`, {
          ...
          n = sf.parse(JSON.parse(vn(e))),
          r = new Set(n.attachmentPaths.filter((e) => ff(e, t)));
        return {
          attachmentPaths: r,
      ...
      let t = {
        ...
        n = this.registryWrite
          ...
          .then(async () => {
            await this.options.requestClient.sendRequest(`fs/writeFile`, {
              path: await this.getRegistryPath(),
              dataBase64: yn(JSON.stringify(t)),
            });
          });
      ((this.registryWrite = n), await n);
    }
    async getRegistryPath() {
      return cn(await this.getAttachmentsRoot(), af);
    }
    async createAttachmentDirectory() {
      let e = cn(await this.getAttachmentsRoot(), G());
      return (
    ...
    async getAttachmentsRoot() {
      ...
      return cn(e, `attachments`);
    }
  };
function lf(e) {
  let t = tn(e.trim()).replace(/[\\/:]/g, `_`);
...
function ff(e, t) {
  ...
  return of.test(i) && !i.endsWith(`/.`) && !i.endsWith(`/..`);
}
var pf = 4.75 * 60,
  mf = class {
    ...
    setPrewarmedThreadPromise(e, t, n) {
      let r = {
        ...
        startedAtSeconds: Date.now() / 1e3,
        instructionOverrides: Promise.resolve(n),
      };
      (this.prewarmedThreadByCwd.set(e, r),
        t.then(
          (t) => {
            if (this.prewarmedThreadByCwd.get(e) === r) {
              if (t == null) {
                this.prewarmedThreadByCwd.delete(e);
                return;
              }
              r.createdAtSeconds = t.thread.createdAt;
            }
          },
          () => {
            this.prewarmedThreadByCwd.get(e) === r && this.prewarmedThreadByCwd.delete(e);
          },
        ));
    }
    ...
    hasPrewarmedThread(e) {
      ...
      return t
        ? this.isFresh(t.createdAtSeconds ?? t.startedAtSeconds)
          ? !0
    ...
    async consumePrewarmedThread(e, t) {
      ...
      return !n ||
        (this.prewarmedThreadByCwd.delete(e), !(0, bo.default)(await n.instructionOverrides, t))
        ? null
        : n.promise;
    }
    isFresh(e) {
      return Date.now() / 1e3 - e < pf;
    }
  },
  hf =
    /^(.*(?:^|[\\/])Documents[\\/]+Codex)[\\/]+(?:\d{4}-\d{2}-\d{2}-[a-z0-9][a-z0-9-]*|\d{4}-\d{2}-\d{2}[\\/]+[a-z0-9][a-z0-9-]*)[\\/]*$/;
function gf(e) {
  return e?.trim().match(hf)?.[1] ?? null;
}
function _f(e) {
...
function vf({ cwd: e, fallbackCwd: t, workspaceBrowserRoot: n, workspaceKind: r }) {
...
function bf({ sandboxPolicy: e, workspaceKind: t }) {
  return t !== `projectless` || e.type !== `workspaceWrite` || yf(e) != null
    ? e
    : ft().sandboxPolicy;
}
async function xf(e) {
  try {
    let { value: t } = await e(`get-global-state`, { params: { key: z.PROJECTLESS_THREAD_IDS } }),
      n = t;
    return new Set((n ?? []).map((e) => H(e)));
  } catch (e) {
    return (
      I.warning(`Failed to load projectless thread ids`, { safe: {}, sensitive: { error: e } }),
      null
    );
  }
}
async function Sf(e, t) {
  try {
    return (
      await e(`set-global-state`, { params: { key: z.PROJECTLESS_THREAD_IDS, value: [...t] } }), !0
    );
  } catch (e) {
    return (
      I.error(`Error saving projectless thread id`, { safe: {}, sensitive: { error: e } }), !1
    );
  }
}
var Cf = gt(R(), R()),
  ...
  Tf = class {
    ...
    async load(e = !1) {
      ...
      let t = await xf(this.fetchFromHost);
      if (t == null) return !1;
      this.conversationIds = e ? t : new Set([...t, ...this.conversationIds]);
      let n = await Ef(this.fetchFromHost);
      return (
        n != null &&
    ...
    getThreadWorkspaceKind(e, t) {
      if (this.conversationIds.has(e) || (this.hostId === `local` && gf(t.cwd) != null))
        return `projectless`;
      let n = j(t.source)?.parentThreadId ?? null;
      return n == null
        ? `project`
    ...
    getThreadWorkspaceBrowserRoot(e) {
      ...
      let t = j(e.source)?.parentThreadId ?? null;
    ...
    getThreadProjectlessOutputDirectory(e, t) {
      ...
      if (n != null) return n;
      let r = j(t.source)?.parentThreadId ?? null;
      return r == null
        ? null
    ...
    async saveConversationId(e) {
      ...
      (await Sf(this.fetchFromHost, n)) && (this.conversationIds = n);
    }
    ...
    async saveWorkspaceRootHint(e, t) {
      if (t != null)
        try {
          await this.saveThreadPathHint(z.THREAD_WORKSPACE_ROOT_HINTS, e, t);
        } catch (t) {
          I.error(`Error saving projectless workspace root hint`, {
            safe: { conversationId: e },
            sensitive: { error: t },
          });
        }
    ...
    async saveOutputDirectoryHint(e, t) {
      if (t != null) {
        ...
        try {
          await this.saveThreadPathHint(z.THREAD_PROJECTLESS_OUTPUT_DIRECTORIES, e, t);
        } catch (t) {
          I.error(`Error saving projectless output directory hint`, {
            safe: { conversationId: e },
            sensitive: { error: t },
          });
        }
...
async function Ef(e) {
  try {
    let { value: t } = await e(`get-global-state`, {
        params: { key: z.THREAD_PROJECTLESS_OUTPUT_DIRECTORIES },
      }),
      n = Cf.safeParse(t).data ?? {};
    return new Map(Object.entries(n).map(([e, t]) => [H(e), t]));
  } catch (e) {
    return (
      I.warning(`Failed to load projectless output directory hints`, {
        safe: {},
        sensitive: { error: e },
      }),
      null
...
function Af(e, t, n) {
  Vn(e, Tn, { phase: t, action: n });
}
var jf = {
    role_picker: Un.CODEX_ONBOARDING_WIZARD_PHASE_ROLE_PICKER,
    task_picker: Un.CODEX_ONBOARDING_WIZARD_PHASE_TASK_PICKER,
    context_picker: Un.CODEX_ONBOARDING_WIZARD_PHASE_CONTEXT_PICKER,
  },
  Mf = {
    completed: Nn.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED,
    skip: Nn.CODEX_ONBOARDING_WIZARD_ACTION_SKIPPED,
    dismiss: Nn.CODEX_ONBOARDING_WIZARD_ACTION_DISMISSED,
  };
function Nf(e, t, n, r) {
  let i = e.getConversationRequest(t, n),
    a = i?.method === `item/tool/call` ? re.safeParse(i.params.arguments) : null;
  if (
    ...
    return;
  let { event: o, result: s } = Pf(r);
  (e.scope != null && Af(e.scope, jf[o.phase], Mf[o.action]),
    e.dispatchMessageFromView(`mcp-response`, {
      hostId: e.hostId,
      response: { id: n, result: O(s) },
    }),
    e.removeConversationRequest(t, n));
}
function Pf(e) {
...
var Ff = /^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i,
  If = class {
    directories = new Set();
    constructor(e) {
      this.options = e;
    ...
    async createDirectory() {
      let e = sn(await this.options.getCodexHome(), `attachments`, G());
      return (
        await this.options.requestClient.sendRequest(`fs/createDirectory`, {
          path: e,
          recursive: !0,
    ...
    async write({ contentsBase64: e, directoryPath: t, filename: n }) {
      await this.assertOwnedDirectory(t);
      let r = lf(n),
        i = sn(t, r);
      return (
        await this.options.requestClient.sendRequest(`fs/writeFile`, { path: i, dataBase64: e }),
        { label: r, path: i, fsPath: i }
      );
    }
    async remove(e) {
      (await this.assertOwnedDirectory(e),
    ...
    async assertOwnedDirectory(e) {
      if (!this.directories.has(e)) throw Error(`Unknown thread goal attachment directory`);
      let t = e.split(/[\\/]/u).at(-1);
      if (t == null || !Ff.test(t) || e !== sn(await this.options.getCodexHome(), `attachments`, t))
        throw Error(`Invalid thread goal attachment directory`);
    }
  },
  Lf = gt(R(), W(R()));
function Rf(e) {
...
function zf({ writableRootsByThread: e, conversationId: t, writableRoots: n }) {
  return { ...e, [t]: Uf(e[t] ?? [], n) };
}
function Bf(e, t) {
...
function Vf(e, t) {
  ...
  let n = Uf(e.writableRoots, t);
  return n.length === e.writableRoots.length ? e : { ...e, writableRoots: n };
}
function Hf(e, t) {
  return e.type === `workspaceWrite` && Bf(e.writableRoots, t);
}
function Uf(e, t) {
  let n = [...e];
...
var Wf = class {
  ...
  async getProjectAssignment(e) {
    let { value: t } = await this.fetchFromHost(`get-global-state`, {
      params: { key: z.THREAD_PROJECT_ASSIGNMENTS },
    });
    return Gt(t)[e] ?? null;
  }
  async getWritableRoots(e) {
    let { value: t } = await this.fetchFromHost(`get-global-state`, {
      params: { key: z.THREAD_WRITABLE_ROOTS },
    });
    return Rf(t)[e] ?? [];
  }
  async setProjectAssignment(e, t) {
    ...
    await this.fetchFromHost(`set-global-state`, {
      params: {
        key: z.THREAD_PROJECT_ASSIGNMENTS,
        value: Et({ assignments: Gt(n), conversationId: e, assignment: t }),
      },
    });
  }
  ...
  async mergeWritableRoots(e, t) {
    ...
    Bf(r[e] ?? [], t) &&
      (await this.fetchFromHost(`set-global-state`, {
        params: {
          key: z.THREAD_WRITABLE_ROOTS,
          value: zf({ writableRootsByThread: r, conversationId: e, writableRoots: t }),
        },
      }));
  }
};
function Gf(e) {
  return {
    ...
    getConversationRequest: (t, n) => {
      ...
      let r = e.conversations.get(t);
      return r
        ? r.requests.find((e) => e.id === n && !E(e)) ||
            (I.error(`Request not found`, { safe: { requestId: n }, sensitive: {} }), null)
        : (I.error(`Conversation state not found`, { safe: { conversationId: t }, sensitive: {} }),
          null);
    },
...
async function qf({
  ...
  try {
    ...
    if (l?.role !== `follower` || !$e(t).includes(`no-client-found`)) throw t;
    return (
      n(e, l.ownerClientId),
      await r({
        conversationId: e,
...
async function Jf(
  ...
  if (
    ...
    if (e.getStreamRole(t)?.role !== `owner`) throw Error(be);
    r(t);
    try {
...
function Xf(e, t, n) {
  let r = (0, jo.default)(e.items, (e) => e.id === t && Yf(e, n));
  return r
    ? r.type === n
      ? r
      : (I.error(`Item has unexpected type`, {
          safe: { itemId: t, type: r.type, expectedType: n },
          sensitive: {},
        }),
        null)
    : (I.error(`Item not found in turn state`, { safe: { itemId: t }, sensitive: {} }), null);
}
function Zf(e) {
  return e?.trim() || null;
}
...
async function ep(
  ...
  let d = l == null ? void 0 : ue(l)?.params,
    f = l?.latestThreadSettings,
    p = await op(e, t),
    m = l?.workspaceKind === `projectless` ? yf(f?.sandboxPolicy ?? d?.sandboxPolicy) : null,
    h = ip(l, a[0]),
    g = vf({
      cwd: l?.cwd,
      fallbackCwd: m ?? h,
  ...
  try {
    let u = l == null ? [] : N(l),
      h = await e
        ...
        .catch(
          (e) => (
            I.warning(`Failed to read thread metadata before resume`, {
              safe: { conversationId: t },
              sensitive: { error: e },
            }),
            null
    ...
    if (h != null) {
      ((g = vf({
        cwd:
          ld({ requestedCwd: g, responseCwd: null, threadCwd: h.thread.cwd, fallbackCwd: _[0] }) ??
          g,
        fallbackCwd: m ?? ip(l, _[0]),
        workspaceBrowserRoot: l?.workspaceBrowserRoot,
        workspaceKind: l?.workspaceKind,
      })),
        (_ = rp(g, a, l?.workspaceKind)));
    ...
    let y = ap({
      ...
      b = l?.workspaceKind === `projectless` && y.length === 0 ? ft() : Ut(y),
      ee =
        o?.approvalsReviewer ??
        f?.approvalsReviewer ??
        d?.approvalsReviewer ??
      ...
      x = o ?? {
        activePermissionProfile:
          f?.activePermissionProfile === void 0
            ? d?.permissions == null
              ? l?.currentPermissions?.activePermissionProfile
              : { id: d.permissions, extends: null }
            : f.activePermissionProfile,
        approvalPolicy:
          f?.approvalPolicy ??
          d?.approvalPolicy ??
          l?.currentPermissions?.approvalPolicy ??
          b.approvalPolicy,
        approvalsReviewer: ee,
        runtimeWorkspaceRoots: Uf(Uf(l?.currentPermissions?.runtimeWorkspaceRoots ?? [], y), p),
        sandboxPolicy:
          f?.sandboxPolicy ??
          d?.sandboxPolicy ??
      ...
      S = Vf(x.sandboxPolicy, p),
      C = { ...x, sandboxPolicy: bf({ sandboxPolicy: S, workspaceKind: l?.workspaceKind }) },
      w = o != null || f != null || d != null,
      T =
        o?.approvalsReviewer != null ||
        f?.approvalsReviewer != null ||
        d?.approvalsReviewer != null ||
        l?.currentPermissions?.approvalsReviewer != null,
      E = w || l?.workspaceKind === `projectless` || Hf(x.sandboxPolicy, p),
      D = T,
      ...
      k = await e.buildNewConversationParams(O, te, _[0] ?? `/`, C, C.approvalsReviewer, {
        skipDynamicTools: !0,
        threadId: t,
      }),
      ne = e.sendRequest(`thread/resume`, {
        ...
        ...(E
          ? k.permissions == null
            ? { approvalPolicy: k.approvalPolicy, sandbox: k.sandbox }
            : {
                approvalPolicy: k.approvalPolicy,
                permissions: k.permissions,
                runtimeWorkspaceRoots: k.runtimeWorkspaceRoots ?? [],
              }
          : {}),
      ...
      [A, re] = await Promise.all([
        ...
        e
          ...
          .catch(
            (e) => (
              I.warning(`Failed to hydrate thread goal after resume`, {
                safe: { conversationId: t },
                sensitive: { error: e },
              }),
              { ok: !1 }
        ...
        a =
          r == null
            ? await e
                ...
                .catch(
                  (e) => (
                    I.warning(`Failed to read legacy thread history after resume`, {
                      safe: { conversationId: t },
                      sensitive: { error: e },
                    }),
                    null
            ...
            : null;
      ie = r == null ? a != null : r.nextCursor == null;
      let o =
          r == null
            ? a == null
              ? []
            ...
            : Oc({
                ...
                reasoningEffort: i ?? l?.latestReasoningEffort ?? null,
                cwd: g ?? `/`,
                permissions: l?.currentPermissions ?? Ut(_),
              }),
        c = e.getConversation(t);
      ((u = Be(c == null ? u : N(c), o)),
        e.updateConversationState(t, (e) => {
          (Lo(e, u, ie),
            (e.turnsPagination =
    ...
    let ae = A.cwd,
      oe = A.thread.cwd,
      se = ld({ requestedCwd: g, responseCwd: ae ?? null, threadCwd: oe, fallbackCwd: _[0] }),
      ce = A.thread.gitInfo,
      j = A.thread.name?.trim() ?? ``;
    ts(A.thread);
    let le = v ? [] : Ec(A, { fallbackCwd: se ?? null }),
      ue = e.getConversation(t),
      de = Be(ue == null ? u : N(ue), le),
      M =
        le.length > 0
          ? de
          : de.map((e) => ({
    ...
    e.updateConversationState(t, (e) => {
      (Lo(e, M, ie), (e.sessionId = A.thread.sessionId));
      let t = Zf(A.model);
      ((e.rolloutPath = A.thread.path ?? e.rolloutPath),
        (e.resumeState = `resumed`),
        re.ok &&
          ((e.threadGoal = re.goal),
          (e.threadGoalResumeConfirmation =
            c === !0 && re.goal != null && Xs(re.goal.status) ? re.goal : null)),
        (e.threadRuntimeStatus = A.thread.status),
        (e.cwd = se),
        (e.currentPermissions = Vs(A)),
        (e.source = A.thread.source),
        (e.threadSource = A.thread.threadSource),
        (e.forkedFromId = A.thread.forkedFromId == null ? null : H(A.thread.forkedFromId)),
        (e.gitInfo = ce ?? e.gitInfo),
        !e.title && j && (e.title = j));
      ...
      (Zu(
        e,
        Qu(A, t ?? e.latestModel, i ?? A.reasoningEffort ?? e.latestReasoningEffort, se, {
          mode: `default`,
          settings: {
            ...s?.settings,
    ...
    let pe = e.getConversation(t)?.turnsPagination ?? null;
    (v && pe?.olderCursor != null && tp(e, t),
      I.info(`maybe_resume_success`, {
        safe: {
          conversationId: t,
          turnCount: M.length,
          latestTurnId: fe?.turnId ?? null,
          latestTurnStatus: fe?.status ?? null,
          markedStreaming: !0,
        },
        sensitive: {},
      }));
...
function tp(e, t) {
  e.loadRemainingConversationTurns(t).catch((e) => {
    I.warning(`Failed to load remaining thread turns after resume`, {
      safe: { conversationId: t },
      sensitive: { error: e },
    });
  });
...
async function np(e, t) {
  ...
  try {
    ...
    throw (
      ...
      I.warning(`Failed to resume subagent for file approval`, {
        safe: { conversationId: t },
        sensitive: { error: n },
      }),
      n
...
async function op(e, t) {
  try {
    ...
    return (
      I.warning(`Failed to load thread writable roots before resume`, {
        safe: { conversationId: t },
        sensitive: { error: e },
      }),
      []
...
var sp = `Side conversation boundary.
...
async function cp(
  ...
  !f &&
    n == null &&
    I.error(`Source conversation not found`, { safe: { sourceConversationId: t }, sensitive: {} });
  ...
  return (
    l &&
      (await e.sendRequest(`thread/inject_items`, {
        threadId: h,
        items: [{ type: `message`, role: `user`, content: [{ type: `input_text`, text: sp }] }],
      })),
    c
      ? lp(e, {
          conversationId: h,
...
function lp(
  ...
  let d = ld({
    ...
    g = {
      ...
      sideConversationParentNavigationPath: u,
      hostId: e.getHostId(),
      turns: o ? [] : Ec(n, { fallbackCwd: d ?? null }),
      requests: [],
      createdAt: p,
      updatedAt: h,
...
var up = {
  ...
  dp = { shell: `shell`, unifiedExec: `unified_exec` },
  fp = { http: `http`, https: `https`, socks5Tcp: `socks5_tcp`, socks5Udp: `socks5_udp` };
function pp(e) {
  return {
    id: e.reviewId,
    target_item_id: e.targetItemId,
    turn_id: e.turnId,
    status: up[e.review.status],
...
function mp(e) {
  switch (e.type) {
    case `command`:
      return { type: `command`, source: dp[e.source], command: e.command, cwd: e.cwd };
    case `execve`:
      return { type: `execve`, source: dp[e.source], program: e.program, argv: e.argv, cwd: e.cwd };
    case `applyPatch`:
...
function gp(e) {
  ...
  return {
    ...
    event: e.review.status === `denied` ? pp(e) : null,
    ...e.review,
  };
}
function _p(e, t) {
  ...
  if (!t.getConversation(r)) {
    I.error(`Received automatic approval review for unknown conversation`, {
...
var vp = `Automatic approval review rejected too many approval requests for this turn`;
function yp(e, t) {
  let { threadId: n, message: r } = e;
  (e.kind !== `tooManyDenials` && !r.startsWith(vp)) ||
    t.updateConversationState(H(n), (e) => {
      let t = Mo(e);
      t && (X(t), t.items.push({ id: G(), type: `autoReviewInterruptionWarning` }));
    });
}
function bp(e, t = e.id) {
  return { id: t, run: e };
}
function xp(e, t) {
  let n = Sp(e, t);
...
function Sp(e, t) {
  let n = Cp(e, (e) => e.run.id === t.id && e.run.status === `running`);
  return n >= 0
    ? n
    : t.completedAt == null
      ? -1
      : Cp(e, (e) => e.run.id === t.id && e.run.completedAt === t.completedAt);
}
function Cp(e, t) {
...
async function Ep({
  ...
  let o = n == null ? null : ue(n),
    s = o?.turnId ?? null;
  if (!s || o?.status !== `inProgress`) {
    try {
      await e();
    } catch (e) {
      I.warning(`Failed to clean background terminals after interrupt fallback`, {
        safe: { conversationId: t },
        sensitive: { error: e },
      });
    }
  ...
  let l = Op(i, { conversationId: t, sessionId: c, turnId: s });
  try {
    await a.sendRequest(`turn/interrupt`, { threadId: c, turnId: s });
  } catch (e) {
    if (!Dp(e)) throw e;
    a.updateConversationState(t, (e) => {
      let t = Po(e, (e) => e.turnId === s && e.status === `inProgress`);
...
function Dp(e) {
  return $e(e) === `no active turn to interrupt`;
}
async function Op(e, { conversationId: t, sessionId: n, turnId: r }) {
  ...
  try {
    ...
    if (o === `timeout`) {
      I.warning(`Timed out killing active node_repl execs`, {
        safe: { conversationId: t },
        sensitive: {},
      });
      return;
    ...
    o.failedCount > 0 &&
      I.warning(`Failed to kill some active node_repl execs`, {
        safe: { conversationId: t, failedCount: o.failedCount },
        sensitive: {},
      });
  } catch (e) {
    I.warning(`Failed to kill active node_repl execs`, {
      safe: { conversationId: t },
      sensitive: { error: e },
    });
  } finally {
...
var kp = 5e3,
  Ap = class {
    ...
    setOpenReviewFileSourceFiles(e, t) {
      let n = this.openFilesByConversationId.get(e) ?? jp();
    ...
    getWatchPath(e, t) {
      let n = an(this.params.getConversationCwd(e) ?? ``, t);
      return on(n) ? n : null;
    }
        ...
        this.params.requestClient
          ...
          .catch((n) => {
            this.watchesByKey.get(e) === i &&
              ...
              I.warning(`Failed to watch open file`, {
                safe: {},
    ...
    sendStopWatchRequest(e) {
      this.params.requestClient.sendRequest(`fs/unwatch`, { watchId: e }).catch((e) => {
        I.warning(`Failed to unwatch open file`, { safe: {}, sensitive: { error: e } });
      });
    }
  };
function jp() {
...
var Pp = class {
  ...
  release(e, t, n, r) {
    ...
    (this.buffers.delete(e), i != null && Fp(i, t, n, r));
  }
  push(e, t) {
    let n = Kc(e);
    if (n == null) return !1;
    let r = this.buffers.get(H(n));
...
function Fp(e, t, n, r) {
  ...
  for (let t of e) {
    if (
      ...
      i.add(
        Lp(`item/agentMessage/delta`, t.notification.params.turnId, t.notification.params.item.id),
      );
      continue;
    }
    if (
      ...
      let e = Lp(t.notification.method, t.notification.params.turnId, t.notification.params.itemId),
        n = a.get(e);
      n == null
  ...
  let o = new Map();
  for (let [e, n] of a) o.set(e, Ip(t, n.notification, n.text.join(``)));
  for (let t of e) {
    if (t.type === `request`) {
      r(t.request);
      continue;
    ...
    let a = Lp(e.method, e.params.turnId, e.params.itemId);
...
async function Rp(e, t, n) {
  let {
      beforeSendRequest: r,
      inheritThreadSettings: i = !0,
      useAppServerPermissionDefault: a,
      ...o
    } = n,
    s = o.clientUserMessageId ?? G(),
    c = e.getConversation(t),
    l = c?.environments?.[0]?.cwd,
    u =
      c?.workspaceKind === `projectless`
        ? yf(c.latestThreadSettings?.sandboxPolicy ?? ue(c)?.params.sandboxPolicy)
        : null,
    d =
      l ??
      vf({
        cwd: o.cwd ?? c?.cwd,
        fallbackCwd: u,
        workspaceBrowserRoot: c?.workspaceBrowserRoot,
        workspaceKind: c?.workspaceKind,
      }) ??
      (c?.workspaceKind === `projectless` ? null : e.getConversationCwd(t)),
    f = await qf({
      conversationId: t,
      getStreamRole: (t) => e.getStreamRole(t),
      ...
      workspaceRoots: c?.workspaceKind === `projectless` && d == null ? [] : [d ?? `/`],
      collaborationMode: o.collaborationMode ?? null,
      reasoningEffort: o.effort ?? null,
      serviceTier: o.serviceTier ?? null,
      sendRequest: (r) =>
        e.sendThreadFollowerRequest(r, `thread-follower-start-turn`, {
          conversationId: t,
          turnStartParams: { ...n, clientUserMessageId: s, serviceTier: o.serviceTier ?? null },
        }),
    });
  ...
  if (!e.isConversationStreaming(t))
    throw (
      I.error(`Conversation is not being streamed.`, {
        safe: { conversationId: t },
        sensitive: {},
      }),
  ...
  let m = await Vp(e, t),
    h = await Hp(e, t),
    g = p.environments?.[0]?.cwd,
    _ =
      g == null && m == null && (p.workspaceKind === `projectless` || (await Wp(e, t)))
        ? await Gp({ manager: e, conversationState: p, retainedWritableRoots: h, input: o.input })
        : null,
    v = m == null ? (_ == null ? p.workspaceKind : `projectless`) : `project`,
    y = v === `projectless` ? (_?.workspaceRoot ?? p.workspaceBrowserRoot ?? null) : null,
    b = i ? p.latestThreadSettings : null,
    ee = b?.collaborationMode ?? (i ? p.latestCollaborationMode : null),
    x = o.collaborationMode ?? ee,
    S = o.collaborationMode != null,
    C = b?.model ?? (i ? p.latestModel : null),
    w = b?.effort === void 0 ? (i ? p.latestReasoningEffort : null) : b.effort,
    T = S ? null : Zf(o.model ?? C),
    E = S ? null : o.effort === void 0 ? w : o.effort,
    D = ue(p),
    O = i ? (D?.params ?? null) : null,
    te =
      o.approvalPolicy != null ||
      o.approvalsReviewer != null ||
      o.sandboxPolicy != null ||
      o.permissions !== void 0,
    k = a ?? (!te && O?.useAppServerPermissionDefault === !0),
    ne = Ut(v === `projectless` && y != null && y !== `~` ? [y] : []),
    A =
      o.approvalPolicy ??
      b?.approvalPolicy ??
      D?.params.approvalPolicy ??
      p.currentPermissions?.approvalPolicy ??
      ne.approvalPolicy,
    re =
      o.sandboxPolicy ??
      b?.sandboxPolicy ??
      D?.params.sandboxPolicy ??
      p.currentPermissions?.sandboxPolicy ??
      ne.sandboxPolicy,
    ie = Vf(re, h),
    ae = _ == null ? ie : Up(ie, _.workspaceRoot),
    oe = m?.path == null ? ae : Up(ae, m.path),
    se =
      o.approvalsReviewer ??
      b?.approvalsReviewer ??
      D?.params.approvalsReviewer ??
      p.currentPermissions?.approvalsReviewer ??
      ne.approvalsReviewer,
    ce = yf(oe),
    j =
      g ??
      (m?.projectKind === `local` ? m.cwd : null) ??
      m?.path ??
      _?.cwd ??
      vf({ cwd: o.cwd ?? p.cwd, fallbackCwd: ce, workspaceBrowserRoot: y, workspaceKind: v }),
    le = bf({ sandboxPolicy: oe, workspaceKind: v }),
    de = le,
    M =
      oe.type === `workspaceWrite`
        ? Uf(
            oe.writableRoots,
            [p.cwd, j].filter((e) => e != null && e !== `~`),
          )
        : [],
    fe = v === `projectless` || m != null || de !== le || Hf(re, h),
    pe = !1,
    me = !1,
    he = null;
  k ||
    ((pe = fe || o.approvalPolicy != null || o.sandboxPolicy != null),
    (me = b != null || O != null),
    (he =
      o.permissions === void 0
        ? o.sandboxPolicy == null
          ? b?.activePermissionProfile === void 0
            ? b?.permissions === void 0
              ? (p.currentPermissions?.activePermissionProfile?.id ?? O?.permissions ?? null)
              : b.permissions
            : (b.activePermissionProfile?.id ?? null)
          : null
        : o.permissions));
  let ge = fe || (!k && (me || pe)),
    _e =
      he == null
        ? null
        : Uf(
            o.runtimeWorkspaceRoots ??
              p.currentPermissions?.runtimeWorkspaceRoots ??
              O?.runtimeWorkspaceRoots ??
              (de.type === `workspaceWrite` ? de.writableRoots : h),
            [p.cwd, j].filter((e) => e != null && e !== `~`),
          ),
    ve =
      o.personality === void 0
        ? b?.personality === void 0
          ? (O?.personality ?? e.getPersonality())
          : b.personality
        : o.personality,
    N =
      o.summary === void 0
        ...
        : o.summary,
    ye =
      b?.serviceTier === void 0
        ? O?.serviceTier === void 0
          ? null
          : O.serviceTier
        : b.serviceTier,
    xe = o.serviceTier === void 0 ? ye : o.serviceTier,
    Se = {
      threadId: t,
      clientUserMessageId: s,
      input: o.input,
      environments: p.environments,
      cwd: j,
      approvalPolicy: me || pe ? A : null,
      approvalsReviewer: k ? null : se,
      sandboxPolicy: he == null && ge ? de : null,
      permissions: he,
      ...(_e == null ? {} : { runtimeWorkspaceRoots: _e }),
      model: T,
      serviceTier: xe,
      effort: E,
      summary: N,
      ...
      responsesapiClientMetadata: {
        ...o.responsesapiClientMetadata,
        workspace_kind: v ?? `project`,
      },
      outputSchema: o.outputSchema ?? null,
      collaborationMode: x ?? null,
    ...
    Ce = {
      ...
      cwd: j,
      approvalPolicy: A,
      approvalsReviewer: se,
      sandboxPolicy: de,
      permissions: he,
      useAppServerPermissionDefault: k,
      runtimeWorkspaceRoots: _e,
      model: T ?? null,
      serviceTier: xe,
      effort: E ?? null,
      summary: N,
    ...
    we = {
      activePermissionProfile: zp(
        he,
        b?.activePermissionProfile,
        p.currentPermissions?.activePermissionProfile,
      ),
      approvalPolicy: A,
      approvalsReviewer: se,
      runtimeWorkspaceRoots: _e ?? void 0,
      sandboxPolicy: de,
    },
    Te = p.currentPermissions;
  e.updateConversationState(t, (e) => {
    let t = [],
    ...
    (Ro(e, {
      ...
      m == null
        ? _ != null &&
          ...
          (e.workspaceBrowserRoot = _.workspaceRoot),
          (e.cwd = _.cwd))
        : ((e.workspaceKind = `project`), (e.workspaceBrowserRoot = null), (e.cwd = m.path)),
      (e.latestModel = T ?? e.latestModel),
      (e.latestReasoningEffort =
        o.effort !== void 0 || b != null ? E : (E ?? e.latestReasoningEffort)),
      (e.latestCollaborationMode = x ?? e.latestCollaborationMode),
      (e.currentPermissions = we),
      (e.updatedAt = Date.now()));
  });
  try {
    await r?.();
    let n = await e.sendRequest(`turn/start`, Se, { timeoutMs: Ae });
    return (
      M.length > 0 && (m != null || h.length > 0 || j !== p.cwd) && (await qp(e, t, M)),
      m != null && (await Kp(e, t, m)),
      e.updateConversationState(t, (e) => {
        let t = Bp(e, s, n.turn.id);
    ...
    throw (
      e.updateConversationState(t, (e) => {
        ...
        Te == null ? delete e.currentPermissions : (e.currentPermissions = Te);
      }),
      n
    );
  }
...
function zp(e, t, n) {
  return e == null ? null : t?.id === e ? t : n?.id === e ? n : { id: e, extends: null };
}
function Bp(e, t, n) {
  return (
    (n == null ? null : Po(e, (e) => e.turnId === n)) ??
    Po(
      e,
...
async function Vp(e, t) {
  try {
    ...
    return (
      I.warning(`Failed to load thread project assignment`, {
        safe: { conversationId: t },
        sensitive: { error: e },
      }),
      null
...
async function Hp(e, t) {
  try {
    ...
    return (
      I.warning(`Failed to load thread writable roots`, {
        safe: { conversationId: t },
        sensitive: { error: e },
      }),
      []
...
async function Wp(e, t) {
  try {
    ...
    return (
      I.warning(`Failed to load projectless conversation membership`, {
        safe: { conversationId: t },
        sensitive: { error: e },
      }),
      !1
...
async function Gp({ manager: e, conversationState: t, retainedWritableRoots: n, input: r }) {
  let i = t.cwd,
    a = gf(i);
...
async function Kp(e, t, n) {
  try {
    ...
    I.warning(`Failed to mark thread project assignment applied`, {
      safe: { conversationId: t },
      sensitive: { error: e },
    });
  }
...
async function qp(e, t, n) {
  try {
    ...
    I.warning(`Failed to merge thread writable roots`, {
      safe: { conversationId: t },
      sensitive: { error: e },
    });
  }
...
async function Xp(e, t, n, r, i) {
  ...
  try {
    ...
    if (
      ...
      return;
    await Zp(e, { conversationId: n, title: r });
  } catch (e) {
    I.warning(`Failed to generate thread title`, {
      safe: { conversationId: n },
      sensitive: { conversationId: n, error: e },
    });
  }
}
async function Zp(e, { conversationId: t, title: n }) {
  try {
    await e.sendRequest(`thread/name/set`, { threadId: t, name: n });
  } catch (e) {
    I.warning(`Failed to set thread title`, {
      safe: { conversationId: t },
      sensitive: { error: e },
    });
  }
...
async function Qp(e, t, n) {
  ...
  await Zp(e, { conversationId: t, title: r });
}
...
var rm = 3e4,
  ...
  am = class {
    ...
    rollingDeltaCounter = new dt({ windowMs: rm });
    deltaBurstEmitGate = new St({ minIntervalMs: im });
    constructor(e) {
...
var om = 250,
  sm = class {
    ...
    personality = null;
    manualContextCompactions = new tf();
    ...
    openFileWatches;
    prewarmedThreadManager = new mf();
    inactiveThreadUnsubscriber;
    pastedTextAttachments;
    threadGoalAttachments;
    ...
    activeRealtimeThreadIds = new Set();
    resumeNotificationBuffer = new Pp();
    constructor(
      e,
      t,
      n,
      ...
      ((this.hostId = e),
        ...
        (this.pastedTextAttachments = new cf({
          hostId: this.hostId,
          fetchFromHost: this.fetchFromHost,
          requestClient: this.requestClient,
        })),
        (this.threadGoalAttachments = new If({
          getCodexHome: async () => {
        ...
        (this.lifecycle = new xc(this.requestClient, this.fetchFromHost)),
        (this.projectlessConversations = new Tf(this.hostId, this.fetchFromHost, (e) =>
          this.getConversation(e),
        )),
        (this.threadWorkspaceState = new Wf(this.fetchFromHost, this.projectlessConversations)),
        (this.openFileWatches = new Ap({
          getConversationCwd: (e) => this.getConversationCwd(e),
          requestClient: this.requestClient,
        })),
        (this.threadStore = new Dd({
          hostId: this.hostId,
        ...
        (this.inactiveThreadUnsubscriber = new Hd({
          threadStore: this.threadStore,
          events: this.events,
          requestClient: this.requestClient,
          streamState: this.streamState,
        })),
        (this.webviewSampler = new am({
          enabled: !0,
          getMetrics: () =>
            Kf({
              conversations: this.conversations,
        ...
        (this.fuzzyFileSearchController = new ui((e, t) => this.sendRequest(e, t))),
        (this.threadCreation = new hd({
          scope: s,
          dispatchMessageToView: this.dispatchMessageToView,
          fetchFromHost: this.fetchFromHost,
          hostId: this.hostId,
        ...
        (this.outputDeltaQueue = new nf({
          flushIntervalMs: 50,
          onFlush: (e) => {
            this.applyOutputDeltas(e);
          },
        })),
        (this.frameTextDeltaQueue = new Rd({
          onFlush: (e) => {
    ...
    assertThreadFollowerOwner(e) {
      if (this.getStreamRole(e)?.role !== `owner`) throw Error(be);
    }
    ...
    async getCodexHome() {
      try {
        ...
        return (
          I.warning(`Failed to load Codex home`, { safe: {}, sensitive: { error: e } }), null
        );
      }
    }
    ...
    async createThreadGoalAttachmentDirectory() {
      return this.threadGoalAttachments.createDirectory();
    }
    async writeThreadGoalAttachment(e) {
      return this.threadGoalAttachments.write(e);
    }
    async removeThreadGoalAttachmentDirectory(e) {
      await this.threadGoalAttachments.remove(e);
    }
    async copyLocalFileAttachment({ sourcePath: e, label: t }) {
      return this.pastedTextAttachments.createLocalFile(e, t);
    }
    ...
    async discardConversationFromCache(e) {
      ...
      if (t != null && gi(t))
        try {
          ...
          I.warning(`Failed to interrupt discarded conversation`, {
            safe: { conversationId: e },
            sensitive: { error: t },
          });
        }
      (await this.sendRequest(`thread/unsubscribe`, { threadId: e }, { timeoutMs: Ae }),
    ...
    async getCompleteConversationTurns(e) {
      ...
      ae(t) || (await this.loadRemainingConversationTurns(e));
      let n = Me(this.getConversation(e));
      ...
      let n = new Promise((e) => {
        ...
        .then(async () => {
          ...
          if (this.threadSettingsUpdateSupport === `unsupported`) {
            await Rp(this, e, { input: [], cwd: r.cwd ?? null });
            return;
          }
        ...
        .then(() => void 0)
        .catch((t) => {
          I.error(`Failed to continue active thread goal`, {
            safe: { conversationId: e },
            sensitive: { error: t },
          });
        })
    ...
    markAllConversationsNeedResumeAfterReconnect() {
      ...
      I.info(`websocket_reconnect_marked_threads_needing_resume`, {
        safe: {
    ...
    async startConversation(
      {
        ...
        permissions: o,
        useAppServerPermissionDefault: s = !1,
        cwd: c,
        attachments: l,
        commentAttachments: u,
        memoryPreferences: d,
        baseInstructions: f,
        skipAutoTitleGeneration: p = !1,
        additionalDeveloperInstructions: m,
        config: h,
        responsesapiClientMetadata: g,
        projectAssignment: _,
        threadSource: v,
        threadStartKind: y,
      },
      { beforeFirstTurn: b, returnAfterOptimisticTurn: ee } = {},
    ) {
      let {
        conversationId: x,
      ...
      if (
        (_ !== void 0 && (await this.threadWorkspaceState.setProjectAssignment(x, _)),
        this.threadStore.notifyConversationCallbacks(x),
        this.streamState.markConversationStreaming(x),
        this.streamState.setConversationStreamRole(x, { role: `owner` }),
        e.length === 0 && (l?.length ?? 0) === 0 && (u?.length ?? 0) === 0)
      )
        return x;
      let T = t?.settings.reasoning_effort,
        E = Vs(S, o?.activePermissionProfile),
        D = ee ? Lt() : null,
        O = () => this.generateConversationTitle(x, e, C ?? null, l),
        te = async () => {
          (!p && (b == null || D == null) && O(),
            await Rp(this, x, {
              cwd: C,
      ...
      return D == null
        ? (await te(), x)
        : (te().catch((e) => {
            (I.error(`Background first turn failed`, {
    ...
    async generateConversationTitle(e, t, n, r) {
      let i = await this.pastedTextAttachments
          ...
          .catch(
            (t) => (
              I.warning(`Failed to load pasted text excerpts for title generation`, {
                safe: { conversationId: e },
                sensitive: { error: t },
              }),
              []
...
`)}`,
      ...
      return Xp(this, this.fetchFromHost, e, a, n);
    }
    async interruptConversation(e) {
      return (await Ls(this.getArchiveConversationContext(), e), this.interruptConversationSelf(e));
    }
    ...
    async interruptConversationSelf(e) {
      ...
      try {
        ...
        (this.markConversationNeedsResumeForUnavailableOwner(e, t.ownerClientId),
          I.warning(`Falling back to local interrupt after follower owner became unavailable`, {
            safe: {
              conversationId: e,
        ...
        if (t.length > 0)
          for (let n of t) {
            ...
            if (n.method === `mcpServer/elicitation/request`) {
              this.replyWithMcpServerElicitationResponse(e, t, _e(`decline`));
              continue;
            }
          }
      }
      ...
      (await this.sendRequest(`thread/backgroundTerminals/clean`, { threadId: r?.id ?? e }),
        this.updateConversationState(
          ...
          (e) => {
            Fo(e, (e) => {
              let t =
                  e.interruptedCommandExecutionItemIds == null
                    ? new Set()
                    : new Set(e.interruptedCommandExecutionItemIds),
                n = !1;
              for (let r of e.items)
                r.type !== `commandExecution` ||
                  r.status !== `inProgress` ||
                  (t.add(r.id), (n = !0));
              n && (e.interruptedCommandExecutionItemIds = [...t]);
            });
          },
          !1,
        ));
    ...
    getArchiveConversationContext() {
      return {
        ...
        archiveInactiveThread: async (e) => {
          let { threadArchive: t } = await un.services;
          if (t == null) return !1;
        ...
        loadUnarchivedThread: (e) => this.hydrateBackgroundThreads([e]),
        removeConversationFromCache: (e) => {
          (this.threadStore.removeConversationFromCache(e),
    ...
    async archiveConversation(e, t) {
      ...
      await Ms(this.getArchiveConversationContext(), e, t);
    }
    async discardConversationIfEmpty(e) {
      if (Me(this.conversations.get(e))?.length !== 0) return !1;
      this.threadStore.removeConversationFromCache(e);
      try {
        await this.sendRequest(`thread/unsubscribe`, { threadId: e });
      } catch (t) {
        I.warning(`Failed to unsubscribe discarded empty conversation`, {
          safe: { conversationId: e },
          sensitive: { error: t },
        });
      }
    ...
    async unarchiveConversation(e) {
      (this.getStreamRole(e)?.role === `owner` &&
        (await this.sendRequest(`thread/unsubscribe`, { threadId: e }),
        this.inactiveThreadUnsubscriber.clearConversationStreamOwnership(e)),
        await Ns(this.getArchiveConversationContext(), e));
    }
    ...
    async performArchiveConversation(e, t, n) {
      await Ps(this.getArchiveConversationContext(), e, t, n);
    }
    loginWithApiKey(e) {
      ...
      if (
        ...
        switch (
          (e !== `item/commandExecution/outputDelta` &&
            I.trace(`Received app server notification`, { safe: { method: e }, sensitive: {} }),
          n.method)
        ) {
          case `account/login/completed`:
          case `account/updated`:
          ...
          case `thread/started`: {
            ...
            (this.pushRealtimeThreadCreatedNotificationFromThreadStart(e),
              Np(this.dispatchMessageFromView, `thread_started`),
          ...
          case `thread/status/changed`: {
            ...
            if (!r) {
              I.warning(`Invalid thread/status/changed notification payload`, {
                safe: {},
                sensitive: { params: t },
              });
              break;
          ...
          case `thread/goal/updated`: {
            ...
            (this.updateConversationState(r, (e) => {
              ((e.threadGoal = t),
                ...
                Xs(t.status) || (e.threadGoalResumeConfirmation = null));
            }),
              a &&
                this.sendRequest(`thread/goal/clear`, { threadId: r }).catch((e) => {
                  I.error(`Failed to clear completed thread goal`, {
          ...
          case `thread/realtime/itemAdded`: {
            ...
            let e = je(n.params.item);
            if (e == null) break;
            let t = H(n.params.threadId);
            if ((this.activeRealtimeThreadIds.add(t), !this.conversations.has(t))) {
              I.error(`Received thread/realtime/itemAdded for unknown conversation`, {
                safe: { conversationId: t },
                sensitive: {},
              });
              break;
            ...
            (this.markConversationStreaming(t),
              this.updateConversationState(t, (t) => {
                ...
                if (
                  ...
                  return;
                let r = de(e.input, e.transcriptDelta),
...
`) === a,
                  ...
                  mm(n.items, r, n.turnId, n.turnStartedAtMs, !1) != null
                )
                  return;
          ...
          case `thread/realtime/started`:
            this.activeRealtimeThreadIds.add(H(n.params.threadId));
            break;
          ...
          case `thread/realtime/closed`:
            this.activeRealtimeThreadIds.delete(H(n.params.threadId));
            break;
          case `thread/archived`: {
            let { threadId: e } = n.params;
            this.handleThreadArchived(H(e));
            break;
          }
          case `thread/deleted`: {
            let { threadId: e } = n.params;
          ...
          case `thread/unarchived`: {
            let { threadId: e } = n.params;
            this.handleThreadUnarchived(H(e));
            break;
          }
          case `skills/changed`:
            break;
          ...
          case `turn/started`: {
            ...
            if (!this.conversations.get(r)) {
              I.error(`Received turn/started for unknown conversation`, {
                safe: { conversationId: r },
                sensitive: {},
              });
              break;
            ...
            (this.markConversationStreaming(r),
              this.updateConversationState(r, (e) => {
                let n =
                  Po(e, (e) => e.turnId === t.id) ??
                  No(e, (e) => e.turnId == null && e.status === `inProgress`);
                if (n)
                  ((n.turnId = t.id),
                ...
                (n === Mo(e) &&
                  ...
                  Fo(e, (e) => {
                    for (let n of e.items)
                      n.type === `planImplementation` && n.turnId !== t.id && (n.isCompleted = !0);
                  }),
                  (e.requests = e.requests.filter((e) =>
              ...
              Np(this.dispatchMessageFromView, `turn_started`));
            break;
          }
          case `turn/completed`: {
            if (
            ...
            let { threadId: e, turn: t } = n.params,
              r = H(e);
            if (!this.conversations.get(r)) {
              I.error(`Received turn/completed for unknown conversation`, {
                safe: { conversationId: r },
                sensitive: {},
              });
              break;
            ...
            (this.updateTurnState(r, t.id, (e) => {
              if (
                ...
                return;
              let n = (0, jo.default)(e.items, (e) => e.type === `todo-list`);
              if (n) {
                let e = n.plan.filter((e) => e.status === `completed`).length;
                e < n.plan.length && ((a = n.plan.length), (o = e));
              }
              let r = (0, jo.default)(e.items, (e) => e.type === `plan`);
              if (!r) return;
              let s = r.text.trim();
              s.length !== 0 && (i = s);
            }),
              a != null &&
                o != null &&
                I.info(`turn_completed_with_incomplete_plan`, {
                  safe: {
                    conversationId: r,
                    turnId: t.id,
                    planStepCount: a,
              ...
              i && (Zd(this, r, t.id, i), Qd(this, r, t.id, i)));
            let s = this.getLastAgentMessageForTurn(r, t.id),
              c = s == null ? null : Re(s),
              l =
                c?.decision === `NOTIFY` ||
                (c?.decision !== `DONT_NOTIFY` &&
                  (t.status !== `completed` || !pm(this, r, this.getConversationOrThrow(r)))),
              u = this.scope == null ? null : qs(this.scope.get, z.QUEUED_FOLLOW_UPS),
              d = u?.data?.[r]?.[0] ?? null,
              f =
            ...
            (this.updateConversationState(r, (e) => {
              l && (e.hasUnreadTurn = !0);
              let n = Po(e, (e) => e.turnId === t.id);
              if (n == null) return;
              let r = n.items.filter(
                (e) =>
                  e.type === `steeringUserMessage` &&
                  e.status !== `accepted` &&
                  Ss(e, t.id, n.turnStartedAtMs),
              );
              r.length !== 0 &&
                ((m = r.map((e) => {
                  let { pausedReason: n, ...r } = ti(e.restoreMessage);
                  return { ...r, pausedReason: t.status === `interrupted` ? vs : ys };
                })),
              ...
              this.broadcastConversationSnapshot(r),
              Np(this.dispatchMessageFromView, `turn_completed`),
          ...
          case `turn/plan/updated`: {
            ...
            this.updateTurnState(a, t, (e) => {
              let t = { id: G(), type: `todo-list`, explanation: i ?? null, plan: r };
              e.items.push(t);
            });
            break;
          }
          ...
          case `hook/completed`: {
            ...
            if (!this.conversations.has(i)) {
              I.error(`Received ${n.method} for unknown conversation`, {
          ...
          case `item/started`: {
            ...
            if (!this.conversations.get(a)) {
              I.error(`Received item/started for unknown conversation`, {
            ...
            (this.markConversationStreaming(a),
              this.updateConversationState(a, (t) => {
                ...
                if (
                  ...
                  (X(n),
                  e.type === `userMessage` &&
                    (mm(n.items, e.content, n.turnId, n.turnStartedAtMs, !1) != null ||
                      (ce(e.content) == null && xe(e.content) == null)))
                )
                  return;
          ...
          case `item/completed`: {
            ...
            let { item: e, threadId: t, turnId: r, completedAtMs: i } = n.params,
              a = H(t);
            if (!this.conversations.get(a)) {
              I.error(`Received item/completed for unknown conversation`, {
                safe: { conversationId: a },
                sensitive: {},
              });
              break;
            ...
            this.updateConversationState(a, (t) => {
              ...
              if (e.type === `userMessage`) {
                let t = mm(n.items, e.content, n.turnId, n.turnStartedAtMs, !1);
                if (t != null) {
                  ((t.status = `accepted`), Hs(n, J({ type: `steered`, id: e.id })));
                  return;
                }
                Hs(n, s);
                return;
              ...
              (cm(e) &&
                ...
                Xf(n, e.id, e.type) && (e.type, Hs(n, s)));
            });
            break;
          }
          ...
          case `item/agentMessage/delta`: {
            ...
            this.webviewSampler.recordDeltaBytes(t) &&
              Np(this.dispatchMessageFromView, `delta_burst`);
            let a = H(r);
          ...
          case `item/commandExecution/terminalInteraction`: {
            ...
            this.applyTerminalInteraction(H(r), i, e, t);
            break;
          }
          ...
          case `item/fileChange/patchUpdated`: {
            ...
            this.updateTurnState(
              ...
              (n) => {
                n.firstTurnWorkItemStartedAtMs = n.firstTurnWorkItemStartedAtMs ?? Date.now();
                let r = Xf(n, t, `fileChange`);
                if (r) {
                  r.changes = J(e);
                  return;
                }
                Hs(n, J({ type: `fileChange`, id: t, changes: e, status: `inProgress` }));
              },
              !1,
          ...
          case `serverRequest/resolved`: {
            ...
            this.updateConversationState(r, (e) => {
              (i?.method === `mcpServer/elicitation/request` && $p(e, U(t), i.params, !0, null),
                i?.method === `item/permissions/requestApproval` && em(e, U(t), i.params, !0, null),
                i?.method === `item/tool/requestUserInput` && nm(e, U(t), i.params, {}, !0),
          ...
          case `item/mcpToolCall/progress`: {
            ...
            this.updateTurnState(a, i, (n) => {
              Xf(n, e, `mcpToolCall`) &&
                I.debug(`Ignoring mcpToolCall progress message`, {
          ...
          case `model/rerouted`: {
            ...
            this.updateTurnState(o, t, (e) => {
              let t = { id: G(), type: `modelRerouted`, fromModel: r, toModel: i, reason: a };
              e.items.push(t);
            });
            break;
          }
    ...
    onRequest(e) {
      ...
      if (
        ...
        !(n !== `currentTime/read` && this.resumeNotificationBuffer.bufferRequest(e))
      )
        switch (
          (I.debug(`Received server request`, {
            safe: {},
          ...
          case `item/permissions/requestApproval`: {
            let n = H(r.threadId),
              i = U(t);
            this.updateConversationState(n, (t) => {
              (t.requests.push(e), (t.hasUnreadTurn = !0), em(t, i, r, !1, null));
            });
            break;
          }
          case `item/fileChange/requestApproval`:
          case `item/commandExecution/requestApproval`: {
            ...
            if (!i) {
              I.error(`Missing threadId for approval request`, {
                safe: {},
            ...
            (this.updateConversationState(a, (t) => {
              ...
              n === `item/fileChange/requestApproval` && np(this, a).catch(() => {}),
          ...
          case `item/tool/requestUserInput`: {
            ...
            if (!n) {
              I.error(`Missing threadId for user input request`, {
                safe: {},
                sensitive: { id: t, params: r },
              });
              return;
            ...
            this.updateConversationState(i, (t) => {
              (t.requests.push(e), (t.hasUnreadTurn = !0), nm(t, a, r, {}, !1));
            });
          ...
          case `item/tool/requestOptionPicker`: {
            let n = `threadId` in r && typeof r.threadId == `string` ? r.threadId : null;
            if (!n) {
              I.error(`Missing threadId for option picker request`, {
                safe: {},
                sensitive: { id: t, params: r },
              });
              return;
          ...
          case `item/tool/requestSetupCodexContextPicker`: {
            let n = `threadId` in r && typeof r.threadId == `string` ? r.threadId : null;
            if (!n) {
              I.error(`Missing threadId for setup Codex context picker`, {
                safe: {},
                sensitive: { id: t, params: r },
              });
              return;
          ...
          case `item/tool/call`:
            if (r.tool === `setup_codex_step`) {
              let n = re.safeParse(r.arguments);
              if (!n.success) {
                this.dispatchMessageFromView(`mcp-response`, {
                  hostId: this.hostId,
                  response: { id: U(t), result: Y(`${C} received invalid arguments.`) },
                });
                break;
              }
              if (n.data.step !== `complete`) {
                let t = H(r.threadId);
                this.updateConversationState(t, (t) => {
                  (t.requests.push(J(e)), (t.hasUnreadTurn = !0));
                });
                break;
              }
            }
            if (
              ...
              if (r.tool === `request_option_picker` && _(r.arguments) == null) {
                this.dispatchMessageFromView(`mcp-response`, {
                  hostId: this.hostId,
                  response: { id: U(t), result: Y(`${D} received invalid arguments.`) },
                });
                break;
              }
              if (r.tool === `request_onboarding_input` && Ve(r.arguments) == null) {
                this.dispatchMessageFromView(`mcp-response`, {
                  hostId: this.hostId,
                  response: { id: U(t), result: Y(`${T} received invalid arguments.`) },
                });
                break;
              }
              let n = H(r.threadId);
          ...
          case `mcpServer/elicitation/request`: {
            ...
            if (i == null) {
              ...
              (I.info(`Sending server response`, {
                ...
                this.dispatchMessageFromView(`mcp-response`, {
                  hostId: this.hostId,
                  response: { id: U(t), result: e },
                }));
              break;
            }
            let a = H(r.threadId);
            this.updateConversationState(a, (n) => {
              (n.requests.push(J(e)), (n.hasUnreadTurn = !0), $p(n, U(t), r, !1, null, i));
            });
            break;
          }
          case `currentTime/read`:
            this.dispatchMessageFromView(`mcp-response`, {
              hostId: this.hostId,
              response: { id: U(t), result: { currentTimeAt: Math.floor(Date.now() / 1e3) } },
            });
            break;
          ...
          case `execCommandApproval`:
            I.warning(`Ignored legacy approval request`, {
              safe: { method: n, id: t },
              sensitive: {},
            });
            break;
          ...
          this.updateConversationState(
            ...
            (t) => {
              for (let { turnId: r, itemId: i, delta: a } of n) {
                let n = Po(t, (e) => Xf(e, i, `commandExecution`) != null),
                  o = n == null ? null : Xf(n, i, `commandExecution`);
                if (o != null) {
                  let e = `[output truncated]
`,
                    t = o.aggregatedOutput ?? ``,
                    n = t.startsWith(e) ? t.slice(19) : t,
                    { next: r, didTruncate: i } = Pd({ current: n, delta: a });
                  o.aggregatedOutput = i || n !== t ? e + r : r;
                }
                o ??
                  I.error(`Dropping commandExecution/outputDelta for missing item`, {
    ...
    applyTerminalInteraction(e, t, n, r) {
      let i = Jp(e, n),
        { commands: a, inputBuffer: o } = Yp(this.terminalInputBuffers.get(i) ?? ``, r);
      (o.length > 0 ? this.terminalInputBuffers.set(i, o) : this.terminalInputBuffers.delete(i),
        a.length !== 0 &&
          this.updateConversationState(
            e,
            (r) => {
              let i = Po(r, (e) => Xf(e, n, `commandExecution`) != null),
                o = i == null ? null : Xf(i, n, `commandExecution`);
              if (o != null) {
                for (let e of a) o.commandActions.push({ type: `unknown`, command: e });
                return;
              }
              I.error(`Dropping commandExecution/terminalInteraction for missing item`, {
            ...
            for (let t of n) {
              ...
              if (n)
                switch (t.target.type) {
                  case `agentMessage`: {
                    let e = Xf(n, t.itemId, `agentMessage`);
                    e && (e.text = (e.text ?? ``) + t.delta);
                    break;
                  }
                  case `plan`: {
                    let e = Xf(n, t.itemId, `plan`);
                    e && (e.text = (e.text ?? ``) + t.delta);
                    break;
                  }
                  case `reasoningSummary`: {
                    let e = Xf(n, t.itemId, `reasoning`);
                    if (!e) break;
                    let r = t.target.summaryIndex;
                    if (!Number.isSafeInteger(r) || r < 0) {
                      I.warning(`Invalid reasoning summary index`, {
                        safe: { summaryIndex: String(r) },
                        sensitive: {},
                      });
                      break;
                    }
                    let i = ac(e.summary, r, ``);
                    i[r] = i[r] + t.delta;
                    break;
                  }
                  case `reasoningContent`: {
                    ...
                    if (!Number.isSafeInteger(r) || r < 0) {
                      I.warning(`Invalid reasoning content index`, {
                        safe: { contentIndex: String(r) },
                        sensitive: {},
                      });
                      break;
                    }
                    let i = ac(e.content, r, ``);
                    i[r] = i[r] + t.delta;
                    break;
                  }
                }
    ...
    getApprovalActionContext() {
      return Gf({
        ...
        conversations: this.conversations,
        updateConversationState: this.updateConversationState.bind(this),
        upsertMcpServerElicitationSyntheticItem: $p,
        upsertPermissionRequestSyntheticItem: em,
        upsertUserInputResponseSyntheticItem: nm,
      });
    }
    ...
    replyWithCommandExecutionApprovalDecision(e, t, n) {
      uc(this.getApprovalActionContext(), e, t, n);
    }
    replyWithFileChangeApprovalDecision(e, t, n) {
      dc(this.getApprovalActionContext(), e, t, n);
    }
    replyWithPermissionsRequestApprovalResponse(e, t, n) {
      fc(this.getApprovalActionContext(), e, t, n);
    }
    replyWithUserInputResponse(e, t, n) {
      ...
      pc(this.getApprovalActionContext(), e, t, n);
    }
    replyWithSetupCodexStepResponse(e, t, n) {
      Nf(this.getSetupCodexStepActionContext(), e, t, n);
    }
    ...
    replyWithMcpServerElicitationResponse(e, t, n) {
      mc(this.getApprovalActionContext(), e, t, n);
    }
    async sendRequest(e, t, n) {
        ...
        r = (async () => {
          ...
          if (this.threadSettingsUpdateSupport !== `unsupported`)
            try {
              ...
              if (!li(e, `thread/settings/update`)) throw e;
    ...
    pushRealtimeThreadCreatedNotificationFromThreadStart(e) {
      let t = lm(e);
      if (t == null || !this.isRealtimeVoiceSourceThread(t)) return;
      let n = H(e.id);
      tc({
        prompt: dm(e.preview),
        realtimeThreadId: t,
    ...
    isRealtimeVoiceSourceThread(e) {
      return (
        this.activeRealtimeThreadIds.has(e) ||
        this.conversations.get(e)?.threadSource === `realtime_voice`
      );
    }
    getLastAgentMessageForTurn(e, t) {
      ...
      let r = ve(n, t);
      if (!r) return null;
      let i = (0, jo.default)(r.items, (e) => e.type === `agentMessage`);
    ...
    captureBrowserUseSessionRoute({
      ...
      conversationId: t,
      disposeAfterSessionActivity: n = !1,
      multiTabBrowserUseEnabled: r = !1,
    }) {
      (I.info(`IAB_LIFECYCLE webview captured browser use session route`, {
        safe: { conversationId: t, disposeAfterSessionActivity: n },
        sensitive: {},
      }),
        this.dispatchMessageFromView(`browser-use-session-route-capture`, {
          ...(e == null ? {} : { browserConversationId: e }),
          conversationId: t,
          ...(n ? { disposeAfterSessionActivity: !0 } : {}),
          ...(r ? { multiTabBrowserUseEnabled: !0 } : {}),
        }));
    }
...
function lm({ parentThreadId: e, source: t }) {
  return j(t)?.parentThreadId ?? null ?? (e == null ? null : H(e));
}
function um(e) {
  let t = j(e.source);
  return (
    dm(e.agentNickname) ?? dm(t?.agentNickname) ?? dm(e.agentRole) ?? dm(t?.agentRole) ?? dm(e.name)
  );
}
function dm(e) {
  let t = e?.trim() ?? ``;
...
function fm(e, t, n) {
  return !(!pm(e, t, n) || n.threadRuntimeStatus?.type === `active` || gi(n));
}
function pm(e, t, n) {
  return (
...
function mm(e, t, n, r, i) {
  return e.find(
    (e) =>
      ...
      e.status === `pending` &&
      Ss(e, n, r) &&
      xs(e, t, { acceptMissingImageInputs: i, normalizeRestrictedImageDisplayPlaceholders: i }),
  );
}
function hm(e) {
...
function bm({ turn: e }) {
  ...
  for (let r = e.items.length - 1; r >= 0; --r) {
    ...
    if (
      ...
      i.invocation.server !== vm ||
      !i.invocation.tool.startsWith(ym)
    )
      continue;
    let a = xm(i);
...
function xm(e) {
  ...
  let t = gm.safeParse(e.result.structuredContent);
  if (!t.success) return null;
  let n = Sm(t.data.current_live_url ?? t.data.deployment_url ?? t.data.url);
  if (n == null) return null;
  let r = t.data.project_id ?? _m.parse(e.invocation.arguments).project_id;
  return r == null
    ? null
...
function Sm(e) {
  ...
  try {
    let t = new URL(e);
    return (t.protocol !== `http:` && t.protocol !== `https:`) || Kt(t.href) ? null : t.href;
  } catch {
    return null;
  }
}
var Cm = zt([`admins_only`, `workspace_all`, `custom`, `public`]),
  wm = i(),
  Tm = [`appgen`, `projects`],
  Em = [`appgen`, `project`],
  Dm = [`appgen`, `screenshot`],
  Om = [`appgen`, `environment`],
  km = [`appgen`, `access-groups`],
  Am = B({ id: R(), name: R(), size: Jt() }),
  jm = B({
    project_id: R(),
    access_mode: Cm,
    allowed_account_user_ids: W(R()),
    allowed_workspace_group_ids: W(R()),
    allowed_tenant_group_ids: W(R()),
    revision: Jt(),
    updated_at: R(),
  }),
  Mm = jm.extend({
    allowed_groups: W(Am),
    allowed_users: W(B({ account_user_id: R(), email: R().nullable(), name: R().nullable() })),
  }),
  Nm = B({
    auth_client_id: R().nullable(),
    created_at: R(),
    current_live_url: R().nullable(),
    current_preview_url: R().nullable(),
    description: R().nullable(),
    id: R(),
    latest_version_number: Jt(),
    screenshot_url: R().nullable(),
    slug: R(),
    status: zt([`active`, `archived`, `suspended`]),
    title: R(),
    updated_at: R(),
  }),
  Pm = Nm.extend({ access_mode: Cm.nullable(), access_policy: jm.nullable() }),
  Fm = B({ cursor: R().nullable().optional(), items: W(Pm) }),
  Im = Nm.extend({
    access_mode: Cm.nullable(),
    access_policy: Mm.nullable(),
    available_access_modes: W(Cm.exclude([`admins_only`]))
      .optional()
      .catch(void 0),
  }),
  Lm = B({
    entries: W(B({ is_secret: jt(), key: R(), type: Zt(`envvar`), value: R().nullable() })),
    project_id: R(),
    revision: Jt(),
    updated_at: R().nullable(),
  }),
  Rm = B({
    tenant_groups: W(Am),
    tenant_id: R().nullable(),
    workspace_account_id: R().nullable(),
    workspace_groups: W(Am),
  }),
  zm = Nt([
    B({ error: B({}).passthrough(), id: Jt(), jsonrpc: Zt(`2.0`) }),
    B({
      id: Jt(),
      jsonrpc: Zt(`2.0`),
      result: B({ isError: jt().optional(), structuredContent: mt().optional() }),
    }),
  ]);
function Bm(e) {
  let t = (0, wm.c)(4),
...
function Wm(e) {
  let { pageParam: t } = e;
  return $m(`sites_list_sites`, { limit: 20, cursor: t ?? void 0 }, Fm);
}
async function Gm(e, t) {
  let n = Array.from(new Set(t));
  n.length !== 0 &&
    (await Promise.all([
      e.invalidateQueries({ queryKey: Tm }),
      ...n.map((t) => e.invalidateQueries({ queryKey: [...Em, t] })),
    ]));
}
function Km(e) {
  let t = (0, wm.c)(7),
  ...
  t[0] === e
    ...
    : ((r = async () => {
        ...
        let { body: t } = await Ke.getInstance().get(e.replace(/^\/api\/codex(?=\/|$)/u, `/wham`));
  ...
  return (
    t[3] !== n || t[4] !== r || t[5] !== i
      ? ((a = { enabled: n, queryFn: r, queryKey: i, staleTime: L.INFINITE }),
        (t[3] = n),
        (t[4] = r),
        (t[5] = i),
        (t[6] = a))
...
var qm = f(p, (e) => ({
    queryKey: [...Em, e],
    queryFn: () => $m(`sites_get_site`, { project_id: e }, Im),
    retry: !1,
    staleTime: L.FIVE_MINUTES,
  })),
  Jm = f(p, (e) => ({
    queryKey: [...Om, e],
    queryFn: () => $m(`sites_get_environment_variables`, { project_id: e }, Lm),
    retry: !1,
    staleTime: L.FIVE_MINUTES,
  })),
  Ym = f(p, (e) => ({
    queryKey: [...km, e],
    queryFn: () => $m(`sites_list_available_access_groups`, { name_prefix: e ?? `` }, Rm),
    enabled: e != null,
    retry: !1,
    staleTime: L.ONE_MINUTE,
  })),
  Xm = c(p, (e) => ({
    mutationKey: [...Om, e, `update`],
    mutationFn: (t) => $m(`sites_update_environment_variables`, { project_id: e, ...t }, Lm),
    onSuccess: (t, n, r, { client: i }) => {
      i.setQueryData([...Om, e], t);
    },
  })),
  Zm = c(p, (e) => ({
    mutationKey: [...Em, e, `access`, `update`],
    mutationFn: (t) => $m(`sites_update_site_access`, { project_id: e, ...t }, Mm),
    onSuccess: (t, n, r, { client: i }) => {
      (i.setQueryData([...Em, e], (e) =>
  ...
  Qm = c(p, (e) => ({
    mutationKey: [...Em, e, `delete`],
    mutationFn: () =>
      bn.safeDelete(`/wham/sites/projects/{project_id}`, {
    ...
    onSuccess: async (t, n, r, { client: i }) => {
      (i.setQueryData(Tm, (t) =>
        ...
        await Promise.all([
          i.invalidateQueries({ queryKey: [...Em, e], refetchType: `none` }),
          i.invalidateQueries({ queryKey: [...Om, e], refetchType: `none` }),
        ]));
    },
  }));
async function $m(e, t, n) {
  let { body: r } = await Ke.getInstance().post(
      `/wham/apps`,
      JSON.stringify({
        id: 1,
        jsonrpc: `2.0`,
...
var eh = zt([
  ...
  th = zt([`ACTIVE`, `PAUSED`]),
  nh = R().trim().min(1),
  rh = zt([`worktree`, `local`]),
  ih = zt([`local`, `worktree`, `thread`]),
  ah = Nt([R(), W(R())]).transform((e, t) => {
    ...
    if (n.startsWith(`[`) && n.endsWith(`]`)) {
      try {
        ...
        return (t.addIssue({ code: `custom`, message: `Invalid cwds` }), pt);
      }
      return (t.addIssue({ code: `custom`, message: `Invalid cwds` }), pt);
    }
    return n
  ...
  oh = It({
    ...
    rrule: nh.optional(),
    cwds: ah.optional(),
    destination: ih.optional(),
    executionEnvironment: rh.optional(),
    localEnvironmentConfigPath: R().trim().min(1).nullable().optional(),
    model: nh.optional(),
    reasoningEffort: ct.optional(),
    targetThreadId: nh.optional(),
    status: th.optional(),
  }).superRefine((e, t) => {
...
var vh = `load_workspace_dependencies`,
  yh = {
    name: vh,
...
var Mh = `data:image/png;base64,`,
  ...
  Fh = R().transform(Zh).pipe(R().min(1).max(120)),
  Q = Fh.optional().catch(void 0),
  Ih = R()
    .transform((e) => {
      let t = Zh(e);
      return t.length <= Nh ? t : `${t.slice(0, Nh).trimEnd()}…`;
    })
    .pipe(R().min(1))
    .optional()
    .catch(void 0),
  ...
  zh = B({
    ...
    bundleIdentifier: Q,
    bundle_identifier: Q,
    currentApp: Rh.optional().catch(void 0),
    current_app: Rh.optional().catch(void 0),
    displayName: Q,
    display_name: Q,
    direction: Lh,
    targetAppName: Q,
...
function Bh({
  ...
  let s = Uh(i);
  return Wh({
    appName: Gh(s, n?.displayName ?? null, t.formatMessage(Z.unknownApp), r),
    completed: e,
    detail: Jh(a, s),
    intl: t,
    labels: o,
...
function Vh(e, { platform: t = `macOS` } = {}) {
  let n = qh(Uh(e));
  return n == null || !Qh(n, t) ? null : n;
}
function Hh(e, { platform: t = `macOS` } = {}) {
  let n = Kh(Uh(e));
  return n == null || Qh(n, t) ? null : n;
}
function Uh(e) {
  let t = zh.safeParse(e);
  return t.success ? t.data : null;
}
function Wh({ appName: e, completed: t, detail: n, intl: r, labels: i }) {
  if (n != null && e != null) {
...
function Gh(e, t, n, r) {
  let i = Kh(e);
  return i == null ? null : Qh(i, r) ? (t ?? n) : i;
}
function Kh(e) {
  return e == null
    ? null
    : ([
        typeof e.app == `string` ? e.app : Yh(e.app),
        Yh(e.currentApp),
        Yh(e.current_app),
        e.targetAppName,
        e.target_app_name,
...
function qh(e) {
  return e == null
    ? null
    : ([
        typeof e.app == `string` ? e.app : Xh(e.app),
        Xh(e.currentApp),
        Xh(e.current_app),
        e.bundleIdentifier,
        e.bundle_identifier,
...
var tg = `browser-use`,
  ng = `browser-use:chrome`,
  rg = `computer-use`,
  ig = B({
    "codex/toolSurface": Tt(`kind`, [
      B({ kind: Zt(`browserUse`), backend: zt([`chrome`, `iab`, `cdp`]) }),
      B({
        kind: Zt(`computerUse`),
        app: Tt(`kind`, [
          B({ kind: Zt(`appId`), appId: R().min(1) }),
          B({ kind: Zt(`displayName`), displayName: R().min(1) }),
        ]).nullable(),
      }),
    ]),
  });
function ag({ resultMeta: e, serverName: t }) {
  if (t !== `node_repl` || e == null) return null;
  let n = ig.safeParse(e);
  return n.success ? n.data[`codex/toolSurface`] : null;
}
function og({ item: e, platform: t = nr() }) {
  let n = sg({ item: e, platform: t });
  if (n != null) {
    let e = cg(n),
      t = Ah(n);
    return {
  ...
  return e.source?.kind === `computerUse` || e.invocation.server === `computer-use`
    ? { groupKey: rg, logoUrl: null, name: Xn(rg), nativeAppReference: null, usesBrowserIcon: !1 }
    : null;
}
function sg({ item: e, platform: t = nr() }) {
  if (e.source?.kind === `computerUse`) return e.source.app;
  if (e.invocation.server !== `computer-use`) return null;
  let n = Vh(e.invocation.arguments, { platform: t });
  if (n != null) return { kind: `appId`, appId: n };
  let r = Hh(e.invocation.arguments, { platform: t });
...
function pg(e) {
  let t = e.startsWith(`F:`),
    n = mg(t ? e.slice(2).trim() : e);
  return t ? (n.length > 0 ? n : null) : ht(n) ? n : null;
}
function mg(e) {
  try {
    return decodeURI(e);
...
function gg(e, t) {
  for (let n of t) {
    ...
    bg(e.editedPaths, e.editedFilePaths, t);
  }
}
function _g(e, t) {
  for (let { path: n } of dg(t)) bg(e.referencedPaths, e.referencedFilePaths, n);
}
function vg(e) {
...
function yg(e) {
  let t = hg();
  for (let n of e.items)
    n && (n.type === `fileChange` ? gg(t, n.changes) : n.type === `agentMessage` && _g(t, n.text));
  return vg(t);
}
function bg(e, t, n) {
  let r = rn(n);
...
function Eg(e, t, n) {
  return e.type === `update` && e.move_path != null
    ? { ...e, move_path: Dg(e.move_path, t, n) }
    : e;
}
function Dg(e, t, n) {
  if (n == null) return e;
  ...
  let i = ge(t, n);
  return i === t || e === i || e.startsWith(`${i}/`) ? e : Sg.default.posix.join(i, e);
}
function Og(e) {
  let [t, ...n] = e ?? [];
  return !t || n.length === 0
...
var kg = B({
    kind: zt([`cron`, `heartbeat`]),
    name: R().trim().min(1),
    rrule: R().trim().min(1),
  }).strip(),
  Ag = B({
    automationId: R().trim().min(1),
    mode: zt([`create`, `update`, `delete`]).optional(),
    deleteStatus: zt([`deleted`, `not_found`]).optional(),
    snapshot: kg.nullable().optional(),
  }).strip(),
  jg = B({ error: B({ message: R() }) }).strip(),
  Mg = /^Reconnecting(?:\.\.\.)?\s+(\d+)\/(\d+)$/;
function Ng(e) {
...
var Fg = /^\[external_agent_tool_(call|result)(?::[^\]]*)?\]$/,
  Ig = /^\[\/external_agent_tool_(call|result)\]$/,
  Lg = `<EXTERNAL SESSION IMPORTED>`;
function Rg(e) {
  let t = e.trimStart();
  if (
    e.trim() === Lg ||
...
function Bg(e) {
  let t = e.trim();
  return t.length === 0 || !ht(t) ? null : at(lt(t));
}
function Vg(e) {
  for (let t of e ?? []) {
...
`);
        ...
        case `agentMessage`: {
          ...
          let s = e.status === `inProgress` && d >= 0 && t === d,
            l = s && Pg(i.content),
            u = s ? null : Re(i.content),
            f = s_({ parsedHeartbeat: u }),
        ...
        case `mcpToolCall`: {
          let t = {
            ...
            pluginId: n.pluginId,
            source: ag({ resultMeta: n.result?._meta ?? null, serverName: n.server }),
            invocation: { server: n.server, tool: n.tool, arguments: n.arguments },
            result: te(n.result, n.error),
        ...
        case `dynamicToolCall`: {
          if (n.tool === `automation_update` && n.status === `completed` && n.success === !0) {
            let e = oh.safeParse(n.arguments);
            if (e.success) {
              let t = Vg(n.contentItems),
        ...
        case `subAgentActivity`:
          ...
          a.push({
            ...
            id: n.id,
            agentThreadId: n.agentThreadId,
            displayName: Jg(n.agentPath),
            displayStatus: Yg(n.kind),
          });
          break;
        case `todo-list`:
          a.push({ type: `todo-list`, explanation: n.explanation ?? null, plan: y(n.plan) });
          break;
        ...
        case `userMessage`: {
          if (n_(e.items, t, i_(n), n.content, e.params ?? null)) break;
          let r = Te({
            input: n.content,
            attachments: n.attachments ?? o_(n.content),
            commentAttachments: n.commentAttachments ?? [],
            normalizeRestrictedImageDisplayPlaceholders: !1,
            sentAtMs: a.length === 0 ? s : null,
          }).item;
          if (r != null) {
            let o = r_(e.items, t, n, {
                acceptMissingImageInputs: !1,
                commentAttachments: n.commentAttachments ?? [],
                normalizeRestrictedImageDisplayPlaceholders: !1,
              }),
              s = i || (u == null && !$g(a, a.length));
  ...
  let p = [],
    m = e.params.cwd ? V(e.params.cwd) : null;
  for (let e of a) {
    if (e.type === `exec`) {
      e.cwd != null && (m = e.cwd);
      continue;
  ...
  g.length > 0 &&
    a.push({
      ...
      cwd: p[0]?.cwd ?? (e.params.cwd ? V(e.params.cwd) : null),
    });
  for (let n of t)
    switch (n.method) {
      case `item/commandExecution/requestApproval`: {
        let { id: t, params: r } = n,
          ...
          o = r.commandActions?.map(se) ?? [],
          s = o.map((e) => e.cmd),
          c = r.command ?? (i.length > 0 ? fe(i) : ``),
          l = s.length > 0 ? s.join(` && `) : c,
          u = o[0] ?? { type: `unknown`, cmd: l };
        a.push({
          type: `exec`,
          callId: r.itemId,
          cwd: e.params?.cwd ? V(e.params.cwd) : null,
          cmd: s.length > 0 ? s : [c],
      ...
      case `item/fileChange/requestApproval`: {
        let { id: e, params: t } = n,
          r = U(e),
          i = (0, jo.default)(a, (e) => e.type === `patch` && e.callId === t.itemId);
        i
          ? ((i.approvalRequestId = r), (i.grantRoot = t.grantRoot ? V(t.grantRoot) : null))
          : I.warning(`Patch approval for unknown itemId; skipping attachment`, {
      ...
      case `item/permissions/requestApproval`: {
        let { id: e, params: t } = n,
          r = U(e);
        (0, jo.default)(a, (e) => e.type === `permission-request` && e.requestId === r) ??
          a.push({
            type: `permission-request`,
            requestId: r,
            turnId: t.turnId,
      ...
      case `applyPatchApproval`:
      case `execCommandApproval`:
        I.warning(`Ignoring legacy approval request method`, {
...
function Kg(e, t, n) {
  ...
  if (
    ...
    return !0;
  for (let t of e.items) if (t != null && qg(t, { isBackgroundSubagentsEnabled: r })) return !0;
  for (let e of t)
    switch (e.method) {
      case `item/commandExecution/requestApproval`:
      case `item/permissions/requestApproval`:
...
function qg(e, { isBackgroundSubagentsEnabled: t }) {
  switch (e.type) {
    case `enteredReviewMode`:
    case `exitedReviewMode`:
    case `sleep`:
    ...
    case `dynamicToolCall`:
      return e.tool === `automation_update` && e.status === `completed` && e.success === !0
        ? oh.safeParse(e.arguments).success
        : !Ng(e.tool);
    case `imageView`:
      return Bg(e.path) != null;
    case `userMessage`:
      return (
        Te({
          input: e.content,
          attachments: e.attachments ?? o_(e.content),
...
function Jg(e) {
  let t = e
    .split(`/`)
    .map((e) => e.trim())
    .filter((e) => e.length > 0 && e !== `root`)
    .at(-1);
  if (t == null) return null;
  let n = t.replace(/[_-]+/g, ` `).replace(/\s+/g, ` `).trim().toLowerCase();
  return n.length === 0 ? null : n[0].toUpperCase() + n.slice(1);
}
function Yg(e) {
  switch (e) {
    case `started`:
...
function Xg({
  ...
  let a = lg({
    status: t,
    hasStartedWork: $g(e, i),
    firstTurnWorkItemStartedAtMs: n,
    workedCompletedAtMs: t_({ items: e, status: t, finalAssistantStartedAtMs: r }),
  });
  if (a == null) return e;
  let o = t === `in_progress` ? Qg(e) : i;
...
function Qg(e) {
  for (let [t, n] of e.entries()) if (!e_(n)) return t;
  return e.length;
}
function $g(e, t) {
  for (let n = 0; n < t; n += 1) if (!e_(e[n])) return !0;
  return !1;
}
function e_(e) {
  return e == null || e.type === `user-message`;
}
function t_({ items: e, status: t, finalAssistantStartedAtMs: n }) {
  if (t !== `in_progress`) return n;
  if (n == null) return null;
  for (let t of e) if (t.type === `assistant-message` && Ch(t)) return n;
  return null;
}
function n_(e, t, n, r, i) {
  if (
    !(n != null && i?.clientUserMessageId != null && n === i.clientUserMessageId) &&
    !(0, bo.default)(r, i?.input ?? [])
  )
    return !1;
  for (let n = 0; n < t; n += 1) {
    let t = e[n];
    if (!(t == null || a_(t))) return !1;
  }
  return !0;
}
function r_(e, t, n, r) {
...
function c_(e, t) {
  t.addTurnCompletedListener((n) => {
    ...
    let r = ve(t.getConversation(n.conversationId), n.turnId);
    if (r == null) return;
    let i = bm({ turn: Hg(r, []) }).map((e) => e.projectId);
    i.length !== 0 && Gm(e.queryClient, i);
  });
}
var l_ = [`owl-feature-enabled`],
  u_ = [`owl-features-state`],
  d_ = f(p, (e) => ({
    enabled: ln?.owlFeatures != null,
    queryKey: [...l_, e],
    queryFn: async () => (await ln.owlFeatures?.isOwlFeatureEnabled(e)) ?? !1,
    staleTime: L.INFINITE,
  }));
d(p, () => ({
  enabled: ln?.owlFeatures != null,
  queryKey: u_,
  queryFn: async () => (await ln.owlFeatures?.getState()) ?? null,
  staleTime: L.INFINITE,
}));
var f_ = l(p, () => ({})),
  p_ = s(p, ({ get: e }) => e(d_, ot).data === !0),
  m_ = p_,
  h_ = u(p, (e, { get: t }) => {
    let n = t(f_)[e] ?? [];
    return t(m_) || n.length > 0;
  }),
  g_ = u(p, ({ browserTabId: e, conversationId: t }, { get: n }) => {
    let r = n(f_)[t] ?? [];
    return n(m_) || r.includes(e);
  });
function __(e, t, n) {
  e.set(f_, (e) => {
    let r = e[t] ?? [];
...
function x_(e, t) {
  ...
  (t.addNotificationCallback(`thread/started`, ({ params: { thread: e } }) => {
    ...
    t.addNotificationCallback([`item/started`, `item/completed`], (e) => {
      let n = H(e.params.threadId);
      if (t.getConversation(n) == null) return;
      let i = e.params.item;
      if (S_(i)) for (let e of i.receiverThreadIds) r(H(e), `hydrated_collab_thread`);
    }),
  ...
  e.addTurnCompletedListener((t) => {
    t.hasPendingContinuation ||
      e.updateConversationState(t.conversationId, (e) => {
        let t = (0, jo.default)(
          Po(e, (e) => e.items.some((e) => e.type === `todo-list`))?.items ?? [],
          (e) => e.type === `todo-list`,
        );
...
function w_({ statsigClient: e, statsigServerClient: t }) {
  if (e !== void 0)
    return {
      sdkType: `client`,
...
var T_ = { $type: `protobuf_analytics_events.v1.ChatgptUserIdentified` },
  E_ = { $type: `protobuf_analytics_events.v1.ChatgptCreditPurchaseButtonClicked` },
  D_ = { $type: `protobuf_analytics_events.v1.ClientEventCounter` },
  O_ = pn(),
  k_ = `javascript-client`,
  A_ = 3e4,
  j_ = `__protobuf_structured_event__`,
  M_ = /^[a-zA-Z][a-zA-Z\d+.-]*:\/\//;
function N_(e) {
  let t = e.toLowerCase();
...
var P_ = {
  ...
  F_ = (e) => typeof e == `function`;
function I_(e) {
  if (typeof e != `object` || !e) return null;
  let t = e;
  if (F_(t.AnalyticsBrowser)) return t.AnalyticsBrowser;
  let n = t.default;
  if (typeof n != `object` || !n) return null;
  let r = n;
  return F_(r.AnalyticsBrowser) ? r.AnalyticsBrowser : null;
}
var L_ = (function (e) {
...
var B_ = class {
    ...
    async initialize({ user: e, statsigClient: t, statsigServerClient: n }) {
      ...
      (e && (this.user = e),
        (this.analyticsStatsigClient =
          w_({ statsigClient: t, statsigServerClient: n }) ?? this.analyticsStatsigClient),
    ...
    getSegmentIoApiHostUrl() {
      ...
      try {
        return M_.test(r) ? new URL(r) : new URL(`${i}://${r}`);
      } catch {
        return;
      }
    }
    ...
    buildSegmentEnvelope(e, t, n) {
      ...
      let c = this.user?.traits?.is_openai_internal,
        l = {
          ...
          authStatus: this.user ? L_.LoggedIn : L_.LoggedOut,
    ...
    async trackStructuredEvent(e, t, n) {
      let r = { eventId: G(), eventCreatedAt: new Date().toISOString() },
    ...
    async sendStructuredEvent(e, t, n, r) {
      ...
      if (this.structuredEventTransport === `statsig`) {
        ...
        try {
          this.analyticsStatsigClient?.logStructuredEvent(j_, a, r);
        } catch (e) {
        ...
        let r = this.buildSegmentEnvelope(e, t, n),
          i = this.analytics.then(([e]) => e.track(j_, r)).catch(() => void 0);
    ...
    async trackCounter(e, t, n) {
      return this.trackStructuredEvent(D_, { counterName: e, metricValue: t }, n);
    }
  },
  V_ = `-9223372036854775808`,
  H_ = `9223372036854775807`,
  U_ = 19,
  W_ = null,
  G_ = !1;
function K_(e) {
...
function X_(e, t, n, r = {}) {
  ...
  if ((Y_(a, { type: e, value: i, ...r }), G_)) throw a;
}
function Z_(e, t, n, r) {
  return X_(e, `to be within [${n}, ${r}]`, t, { min: n, max: r });
}
function Q_(e, t, n) {
  if (!Number.isFinite(e)) return X_(t, `to be a finite number`, e);
  let r = J_(e, q_(n));
  return Number.isSafeInteger(r) ? r : X_(t, `to be a safe integer`, e);
}
function $_(e, t) {
...
function ev(e, t, n, r, i, a) {
  let o = e.trim();
  if (!/^[+-]?\d+$/.test(o)) return X_(t, `to be an integer string`, e);
  let s = ``,
    c = o;
  (c[0] === `+` || c[0] === `-`) && ((s = c[0] === `-` ? `-` : ``), (c = c.slice(1)));
  let l = c.replace(/^0+(?=\d)/, ``);
  if ((l === `0` && (s = ``), (s === `-` && !a) || l.length > i)) return Z_(t, e, n, r);
  let u = r.startsWith(`-`) ? r.slice(1) : r;
  if (s === `-`) {
    if ($_(l, n.startsWith(`-`) ? n.slice(1) : n) > 0) return Z_(t, e, n, r);
  } else if ($_(l, u) > 0) return Z_(t, e, n, r);
  return s === `-` ? `-${l}` : l;
}
function tv(e, t) {
  if (e == null) return;
  if (typeof e == `string`) return ev(e, `int64`, V_, H_, U_, !0);
  let n = Q_(e, `int64`, t);
  if (n != null) return String(n);
}
function nv({ filePath: e, imagePreviewMode: t, isDeletion: n, richPreviewEnabled: r }) {
  return r && !n && av(e)
    ? `markdown`
    : t === `always` || (t === `toggle` && r)
      ? `image`
...
function rv(e) {
  let t = ov(e);
  return t == null ? `none` : t === `svg` ? `toggle` : sv.has(t) ? `always` : `none`;
}
function iv(e) {
  return ov(e) === `pdf`;
}
...
var sv = new Set([`avif`, `bmp`, `gif`, `ico`, `jpeg`, `jpg`, `png`, `tif`, `tiff`, `webp`]),
  cv = new Set([`markdown`, `md`, `mdown`, `mdx`, `mkd`]);
function lv(e) {
...
function uv(e) {
  ...
  return t.protocol !== `https:` && t.protocol !== `http:` ? null : lv(t);
}
function dv({ cwd: e, projectlessOutputDirectory: t, resourcePath: n }) {
  if (t == null) return !0;
  let r = fv(e, t).replace(/\/+$/, ``);
  if (r === ``) return !1;
  let i = fv(e, n);
...
function fv(e, t) {
  let n = an(e ?? ``, rn(t));
  return n === `` ? `` : nn(Sg.default.posix.normalize(n));
}
var pv = new Set([
    `avif`,
    `csv`,
...
function bv({
  ...
  let i = Av(e),
    ...
    s = kv({
      ...
      resources: Tv({
        cwd: r.cwd,
        resources: [...wv(r).map((e) => ({ type: `file`, path: e })), ...Nv(e, o)],
      }),
    });
...
function xv({ endResources: e, turn: t }) {
  if (e.length === 0 || t.artifacts.editedFilePaths.length === 0) return !1;
  let n = new Set();
  for (let r of e)
    switch (r.type) {
      case `file`:
        if (!$v(r.path)) continue;
        n.add(Qv(t.cwd, r.path));
        break;
      case `google-drive`:
        break;
      case `appgen-app`:
        break;
      case `website`:
        Kt(r.target) || n.add(Qv(t.cwd, r.target));
        break;
    }
  return t.artifacts.editedFilePaths.every((e) => n.has(Qv(t.cwd, e)));
}
function Sv({ assistantContent: e, turn: t }) {
  if (t.status !== `complete`) return [];
  let n = new Map();
  for (let r of Ev({ assistantContent: e, turn: t })) {
    let e = ov(r);
    if (e == null || !mv.has(e)) continue;
    let t = n.get(e) ?? [];
    (t.push(r), n.set(e, t));
  }
...
function Cv({ assistantContent: e, turn: t, resourcePath: n }) {
  if (t.status !== `complete`) return null;
  let r = Qv(t.cwd, rn(n)),
    i = Ev({ assistantContent: e, turn: t }).find((e) => Qv(t.cwd, e) === r);
  if (i == null) return null;
  let a = ov(i);
  return a != null && mv.has(a) ? a : null;
}
function wv(e) {
  return Dv({
    cwd: e.cwd,
...
function Ev({ assistantContent: e, turn: t }) {
  return Dv({ cwd: t.cwd, rawPaths: [...t.artifacts.editedFilePaths, ...Mv(e)] });
}
function Dv({ cwd: e, rawPaths: t }) {
  let n = new Map();
  for (let r of t) {
    let t = rn(r),
      i = Qv(e, t);
...
function Ov(e, t) {
  ...
  for (let r of e.artifacts.editedFilePaths) {
    let i = rn(r);
    if (!Ht(i) || !dv({ cwd: e.cwd, projectlessOutputDirectory: t, resourcePath: i })) continue;
    let a = Qv(e.cwd, i);
    n.has(a) || n.set(a, i);
  }
  return n.size === 1 ? (n.values().next().value ?? null) : null;
}
function kv({ cwd: e, projectlessOutputDirectory: t, resources: n }) {
  return t == null
    ? n
    : n.filter((n) => {
        switch (n.type) {
          case `file`:
            return dv({ cwd: e, projectlessOutputDirectory: t, resourcePath: n.path });
          case `google-drive`:
            return !0;
        }
      });
...
function jv(e) {
  ...
  return _v.test(`${n.pathname}${n.search}${n.hash}`) || n.port.length === 0
    ? null
    : Kt(n.href)
      ? n.href
      : null;
...
function Nv(e, t) {
  ...
  for (let r of Pv(e)) {
    ...
    let i = Xv(r.destination);
    i != null && ey(i) && n.push({ type: `file`, path: i });
  }
  return n;
}
function Pv(e) {
...
` ||
    ...
    if ((t === ` ` || t === `	`) && i === 0) {
      let t = e[Uv(e, n)];
      if (t === `"` || t === `'` || t === `(`) return Hv(e, n, r.join(``).trim());
    }
    (r.push(t), (n += 1));
  }
  return null;
...
` ||
    ...
    if (t === `>`) return Hv(e, r + 1, n.join(``).trim());
    (n.push(t), (r += 1));
  }
  return null;
}
...
function Kv(e, t) {
  ...
  return r == null
    ? null
    : { type: `google-drive`, url: n.href, title: t.get(Yv(n, r)) ?? e.label, resourceKind: r };
}
function qv(e) {
  let t = new Map();
  for (let n of e.items) {
    if (n.type !== `mcp-tool-call` || n.result?.type !== `success`) continue;
    let e = vv.safeParse(n.result.structuredContent);
...
function Xv(e) {
  let t = Zv(e);
  return !qn(t) && !Yn(t) ? null : rn(tr(t).path);
}
function Zv(e) {
  try {
    return decodeURI(e);
...
function $v(e) {
  let t = ov(e);
  return t != null && pv.has(t);
}
function ey(e) {
  let t = ov(e);
  return t != null && mv.has(t);
}
function ty(e) {
  return e
    .trim()
...
function dy(e) {
  let t = ty(e).replace(/\/+$/, ``),
    n = t.split(`/`).filter((e) => e.length > 0);
  if (n.length === 0) return null;
  let r = t.match(/^\/+/)?.[0] ?? ``;
  return fy(n, r) ?? py(n, r);
}
function fy(e, t) {
  for (let n = 0; n < e.length; n += 1) {
    let r = e[n]?.toLowerCase(),
      i = e[n + 1]?.toLowerCase();
    if (!(r === ny || r === ry) || i !== iy) continue;
    let a = (e[n + 2] ?? null)?.toLowerCase(),
      o = n + (a === ay || a === oy ? 3 : 2),
      s = e[o] ?? null;
    if (s != null && s.length > 0)
      return hy({
        skillId: s,
        skillRootPath: `${t}${e.slice(0, o + 1).join(`/`)}`,
        pluginId: null,
        isSystem: a === oy,
        relativePathSegments: e.slice(o + 1),
      });
  }
  return null;
}
function py(e, t) {
  for (let n = 0; n < e.length; n += 1) {
    if (e[n]?.toLowerCase() !== cy) continue;
    let r = my(e, n);
    if (r == null) continue;
    let i = e.findIndex((e, t) => t > n && e.toLowerCase() === iy),
      a = i >= 0 ? (e[i + 1] ?? null) : null;
    if (!(a == null || a.length === 0))
      return hy({
        skillId: a,
        skillRootPath: `${t}${e.slice(0, i + 2).join(`/`)}`,
        pluginId: r.pluginId,
        pluginMarketplaceName: r.pluginMarketplaceName,
        relativePathSegments: e.slice(i + 2),
      });
  }
  return null;
}
...
function hy({
  ...
  skillRootPath: t,
  pluginId: n,
  pluginMarketplaceName: r = null,
  isSystem: i = !1,
  relativePathSegments: a,
}) {
  let o = a[0]?.toLowerCase();
  return {
    skillId: e,
    skillRootPath: t,
    skillName: Qn(e.replaceAll(`_`, `-`)),
    pluginId: n,
    pluginDisplayName: n == null ? null : Qn(n.replaceAll(`_`, `-`)),
    pluginMarketplaceName: r,
    isSystem: i,
    isInScriptsFolder: o === sy,
    isSkillDefinitionFile: a.length === 1 && o === uy,
  };
}
function gy(e) {
  return _y(e.params.input, e.items);
}
function _y(e, t) {
  let n = new Map();
  for (let t of e) for (let e of by(t)) yy(n, e);
  for (let e of t)
    if (e.type === `commandExecution`)
      for (let t of e.commandActions ?? []) for (let e of Sy(t)) yy(n, e);
  return Array.from(n.values()).sort((e, t) =>
    e.privateIdentity < t.privateIdentity ? -1 : e.privateIdentity > t.privateIdentity ? 1 : 0,
  );
}
function vy(e) {
  return Array.from(new Set(gy(e).map((e) => e.skillId))).sort();
}
function yy(e, t) {
  let n = dy(t);
  if (n == null) return;
  let r = n.skillRootPath;
  e.set(r, {
    privateIdentity: r,
    skillId: n.skillId,
    pluginId: n.pluginId,
...
function Cy({
  ...
  return r.map(
    ({ fileExtension: r, fileCount: a, totalFileSizeBytes: s, knownFileSizeCount: c }) => ({
      ...
      totalFileSizeBytes: tv(s),
      knownFileSizeCount: c,
      turnStartedAtMs: tv(i.turnStartedAtMs),
      firstWorkItemStartedAtMs: tv(i.firstWorkItemStartedAtMs),
      turnDurationMs: tv(i.turnDurationMs),
      workDurationMs: tv(i.workDurationMs),
      usedSkillIds: o,
...
function wy({
  ...
  return r.map(
    ({ fileExtension: r, fileCount: a, totalFileSizeBytes: s, knownFileSizeCount: c }) => ({
      ...
      totalFileSizeBytes: tv(s),
      knownFileSizeCount: c,
      turnStartedTs: tv(i.turnStartedAtMs),
      firstWorkItemStartedTs: tv(i.firstWorkItemStartedAtMs),
      turnDurationMs: tv(i.turnDurationMs),
      workDurationMs: tv(i.workDurationMs),
      usedSkillIds: o,
      usedSkills: o.length > 0,
...
function Ey({ threadId: e, turnId: t, inputMessageId: n, extensionSummaries: r }) {
  return r.map(
...
async function Dy({
  ...
  let o = Sv({ assistantContent: i, turn: Hg(r, []) });
  if (o.length === 0) return;
  let s = Date.now(),
    c = await Py({ hostId: n, extensionGroups: o });
  Cy({
    threadId: e,
    turnId: t,
    inputMessageId: Uy(r),
    extensionSummaries: c,
    latencySummary: jy({ turn: r, createdAtMs: s }),
    usedSkillIds: vy(r),
  }).forEach((e) => {
    a.logProductEvent(Rn, e);
  });
}
async function Oy({ conversationId: e, turnId: t, hostId: n, turn: r, productLogger: i }) {
  let a = Iy(r);
  if (a.length === 0) return;
  let o = Date.now(),
    s = await Vy({ hostId: n, extensionGroups: a });
  wy({
    threadId: e,
    turnId: t,
    inputMessageId: Uy(r),
    extensionSummaries: s,
    latencySummary: jy({ turn: r, createdAtMs: o }),
    usedSkillIds: vy(r),
  }).forEach((e) => {
    i.logProductEvent(Dn, e);
  });
}
function ky({
  conversationId: e,
  ...
  let l = Cv({ assistantContent: r, turn: n, resourcePath: i });
  if (l == null) return;
  let u = Ty({
    threadId: e,
    turnId: t,
  ...
  c.logProductEvent(kn, u);
}
async function Ay({ conversationId: e, turnId: t, hostId: n, turn: r, productLogger: i }) {
  let a = Fy(r);
  if (a.length === 0) return;
  let o = await By({ hostId: n, extensionGroups: a });
  Ey({ threadId: e, turnId: t, inputMessageId: Uy(r), extensionSummaries: o }).forEach((e) => {
    i.logProductEvent(Fn, e);
  });
}
function jy({ turn: e, createdAtMs: t }) {
  let n = My(e.turnStartedAtMs),
    r = My(e.firstTurnWorkItemStartedAtMs);
  return {
    turnStartedAtMs: n,
    firstWorkItemStartedAtMs: r,
    turnDurationMs: Ny({ startedAtMs: n, createdAtMs: t }),
    workDurationMs: Ny({ startedAtMs: r, createdAtMs: t }),
  };
}
function My(e) {
  return typeof e == `number` && Number.isFinite(e) ? e : null;
}
function Ny({ startedAtMs: e, createdAtMs: t }) {
  return e == null || !Number.isFinite(t) ? null : Math.max(0, t - e);
}
async function Py({ hostId: e, extensionGroups: t }) {
  return Promise.all(
    t.map(async ({ fileExtension: t, fileCount: n, resourcePaths: r }) => {
      let i = (await Promise.all(r.map((t) => Gy({ hostId: e, path: t })))).filter(
        (e) => e != null,
      );
      return {
        fileExtension: t,
...
function Fy(e) {
  let t = ie(S({ attachments: e.params.attachments ?? [], input: e.params.input })),
    n = new Map();
  for (let e of t) {
    let t = Hy(e);
    if (t == null) continue;
  ...
  for (let n of e.items)
    if (!(n?.type !== `fileChange` || n.status !== `completed`))
      for (let e of n.changes) {
        let n = Ly({ turnCwd: t, path: e.path });
        (e.kind.type === `add` && r.push(n),
          e.kind.type === `update` &&
            e.kind.move_path != null &&
            i.set(nn(n), Ly({ turnCwd: t, path: e.kind.move_path })));
      }
  for (let e of r) for (let t of zy({ path: e, pathAliases: i })) n.add(nn(t));
  let a = new Map(),
    o = new Set();
  for (let r of e.items)
    if (!(r?.type !== `fileChange` || r.status !== `completed`))
      for (let e of r.changes) {
        ...
        let r = Ly({ turnCwd: t, path: e.path }),
          s = Ry({ path: Ly({ turnCwd: t, path: e.kind.move_path ?? e.path }), pathAliases: i }),
          c = nn(r),
          l = nn(s);
...
function Ly({ turnCwd: e, path: t }) {
  return an(e, t);
}
function Ry({ path: e, pathAliases: t }) {
  return zy({ path: e, pathAliases: t }).at(-1) ?? e;
}
function zy({ path: e, pathAliases: t }) {
  let n = [e],
    r = new Set([nn(e)]),
    i = e;
  for (;;) {
...
async function By({ hostId: e, extensionGroups: t }) {
  return Promise.all(
    t.map(async ({ fileExtension: t, fileCount: n, resourcePaths: r }) => {
      let i = (await Promise.all(r.map((t) => Gy({ hostId: e, path: t })))).filter(
        (e) => e != null,
...
async function Vy({ hostId: e, extensionGroups: t }) {
  return Promise.all(
    t.map(async ({ fileExtension: t, fileCount: n, resourcePaths: r }) => {
      let i = (await Promise.all(r.map((t) => Gy({ hostId: e, path: t })))).filter(
        (e) => e != null,
...
async function Gy({ hostId: e, path: t }) {
  try {
    let n = await qe(`read-file-metadata`, { params: { hostId: e, path: t } });
...
var Ky = new Set(
  ...
  Yy = /\bhttps?:\/\/[^\s<>)"'`]+/giu,
  Xy = /^google[\s_-]+drive(?:[\s_-]+app)?[.\s_-]+(.+)$/iu,
  Zy = B({
    documentUrl: R()
      .optional()
      .catch(void 0),
...
function Qy({ threadId: e, turnId: t, inputMessageId: n, summary: r }) {
  return {
    threadId: e,
    turnId: t,
    inputMessageId: n ?? void 0,
...
function $y({ lastAgentMessage: e, turn: t }) {
  let n = Hg(t, []),
    r = tb(t),
    i = nb(t.params.input),
    a = rb({ lastAgentMessage: e, turn: n });
  if (
    !(
      i.length > 0 ||
      a.length > 0 ||
    ...
    return null;
  let o = Sv({ assistantContent: e, turn: n }).length > 0;
  return {
    ...r,
...
function eb({ conversationId: e, turnId: t, turn: n, lastAgentMessage: r, productLogger: i }) {
  let a = $y({ lastAgentMessage: r, turn: n });
  if (a == null) return;
  let o = Qy({ threadId: e, turnId: t, inputMessageId: Uy(n), summary: a });
  i.logProductEvent(Sn, o);
}
function tb(e) {
  let t = new Set(),
    n = new Set(),
  ...
  for (let f of e.items) {
    if (f.type !== `mcpToolCall` || !ob(f)) continue;
    let e = lb(f.tool),
      p = ab(e),
      m = sb(f),
      h = cb(f, e);
    switch (p) {
      case `read`:
        ((o += 1), t.add(e), m && ((l += 1), hb(i, h)));
        break;
      case `write`:
        ((s += 1), n.add(e), m && ((u += 1), hb(a, h)));
        break;
      case `unknown`:
        ((c += 1), r.add(e), m && (d += 1));
        break;
  ...
  return {
    ...
    readToolNames: gb(t),
    writeToolNames: gb(n),
    unknownToolNames: gb(r),
    readArtifactKinds: gb(i),
    writtenArtifactKinds: gb(a),
  };
}
function nb(e) {
  let t = new Set();
...
function rb({ lastAgentMessage: e, turn: t }) {
  let n = new Set();
  for (let r of bv({ assistantContent: e, turn: t }))
    switch (r.type) {
      case `google-drive`:
...
function ib({
  ...
  return e && n && r.successfulReadToolCallCount > 0 && r.successfulWriteToolCallCount > 0
    ? Gn.CODEX_GOOGLE_WORKSPACE_ARTIFACT_FLOW_LOCAL_ROUNDTRIP_EDIT
    : e && r.successfulWriteToolCallCount > 0
      ? Gn.CODEX_GOOGLE_WORKSPACE_ARTIFACT_FLOW_EDIT
      : !e && t && !n && r.successfulWriteToolCallCount > 0
        ? Gn.CODEX_GOOGLE_WORKSPACE_ARTIFACT_FLOW_DIRECT_CREATE
        : Gn.CODEX_GOOGLE_WORKSPACE_ARTIFACT_FLOW_UNKNOWN;
}
function ab(e) {
  return Ky.has(e) ? `read` : qy.has(e) ? `write` : `unknown`;
}
function ob(e) {
  if ([e.server, e.pluginId ?? ``].some(mb)) return !0;
  let t = e.tool.trim();
  return lb(t) !== t;
}
function sb(e) {
...
function cb(e, t) {
  ...
  return (
    r != null && n.add(r),
    hb(n, db(e.arguments)),
    e.result != null && hb(n, db(e.result.structuredContent)),
    gb(n)
  );
}
function lb(e) {
  ...
  let r = t.lastIndexOf(`.`);
  return r === -1 || !mb(t.slice(0, r)) ? t : t.slice(r + 1);
}
function ub(e) {
  return Jy.get(e) ?? null;
}
function db(e) {
  let t = Zy.safeParse(e);
  if (!t.success) return [];
  let n = new Set();
  for (let e of [
    t.data.documentUrl,
...
function _b(e, t) {
  t.addTurnCompletedListener((n) => {
    ...
    let r = t.getConversation(n.conversationId),
      i = r == null ? null : (N(r).find(({ turnId: e }) => e === n.turnId) ?? null);
    if (i == null) return;
    let a = e.get(zn);
    (Dy({
...
async function vb(e, t) {
  if (!(t == null || t.length === 0))
    try {
      await v(`update-thread-git-branch`, { conversationId: e, branch: t });
    } catch {
      return;
    }
}
    ...
    constructor(e) {
      ((this.workerId = e),
        window.electronBridge?.subscribeToWorkerMessages?.(this.workerId, (e) => {
          gc(this.workerId, e) && this.handleMessage(e);
        }));
    }
    request(e) {
      ...
      if (e.signal?.aborted) return Promise.reject(_c());
      let n = vc(),
      ...
      if (o) {
        let e = () => {
          ...
          (r && (r.reject(_c()), this.pending.delete(n)),
...
function xb(e) {
  ...
  switch (e) {
    case `computer-use-capture`: {
      let t = new yb(`computer-use-capture`);
      return (bb.set(e, t), t);
    }
    case `git`: {
      let t = new yb(`git`);
...
var Ob = f(
    ...
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r, watchForGitInit: i }) =>
      Tb(e, Db(n), n, r, { enabled: t, ...(i ? { watchForGitInit: i } : {}) }),
    { key: Nb },
  ),
  kb = m(
    p,
  ...
  Ab = u(
    ...
    ({ cwd: e, enabled: t, hostConfig: n, operationSource: r, watchForGitInit: i }, { get: a }) => {
      if (!t || e == null) return Ib();
      let o = a(Ob, { cwd: e, enabled: t, hostConfig: n, operationSource: r, watchForGitInit: i }),
        s = o.data ?? null;
      return (
        s != null &&
          a(
  ...
  jb = u(p, (e, { get: t }) => t(Ab, e).data ?? null, { key: Fb }),
  Mb = u(p, (e, { get: t }) => t(Ab, e).isLoading, { key: Fb });
function Nb({ cwd: e, enabled: t, hostConfig: n, watchForGitInit: r }) {
  return JSON.stringify({ cwd: e, enabled: t, hostConfig: n, watchForGitInit: r });
}
function Pb({ commonDir: e, enabled: t, hostConfig: n, root: r }) {
  return JSON.stringify({ commonDir: e, enabled: t, hostConfig: n, root: r });
}
function Fb({ cwd: e, enabled: t, hostConfig: n, watchForGitInit: r }) {
  return JSON.stringify({ cwd: e, enabled: t, hostConfig: n, watchForGitInit: r });
}
function Ib() {
  let e;
...
function Gb(e) {
  let t = e.params == null ? null : JSON.stringify(Kb(e.params));
  return [...Wb(e.metadata.commonDir, e.metadata.root, e.hostKey), e.method, t];
}
function Kb(e) {
...
function Jb(
  ...
  return Promise.all(
    c.map((r) => e.invalidateQueries({ queryKey: [...Wb(t, n, i), r] }, { cancelRefetch: a })),
  );
}
async function Yb(e, { commonDir: t, root: n }, { hostKey: r, cancelRefetch: i = !0 }) {
  let a = Wb(t, n, r);
  await Promise.all([
...
function Xb(e, t, { cancelRefetch: n = !0, hostKey: r }) {
  return e.invalidateQueries({ queryKey: Ub(t, r), exact: !1 }, { cancelRefetch: n });
}
async function Zb({
  ...
  await xb(`git`).request({
    method: `invalidate-git-read-caches`,
    params: { clearUntrackedPathsCache: e, hostConfig: t, operationSource: n, paths: r, root: i },
  });
}
async function Qb({ cwd: e, hostConfig: t, operationSource: n, queryClient: r }) {
  let i = Db(t);
  try {
    let a = await r.fetchQuery(Tb(e, i, t, n));
    if (a == null) return;
    await r.invalidateQueries({ queryKey: [...Wb(a.commonDir, a.root, i), `status-summary`] });
  } catch {
    return;
  }
}
async function $b({ cwd: e, hostConfig: t, operationSource: n, queryClient: r }) {
  let i = Db(t);
  try {
    let a = await r.fetchQuery(Tb(e, i, t, n));
    if (a == null) return;
    try {
      await Zb({ clearUntrackedPathsCache: !0, hostConfig: t, operationSource: n, root: a.root });
    } catch {}
    await Jb(r, a, { changeType: `head`, hostKey: i });
  } catch {
    return;
  }
}
...
function nx(e, t, n, r, i, a) {
  let o = a?.staleTime ?? L.INFINITE;
  return {
    queryKey:
      t && n ? Gb({ metadata: t, method: e, params: n, hostKey: r }) : [`git`, `disabled`, e],
    queryFn: ({ signal: r }) =>
      !t || !n
        ? Promise.reject(Error(`Missing git metadata`))
        : xb(`git`).request({ method: e, params: ex(n, i), signal: r }),
    staleTime: o,
    gcTime: 30 * 601e3,
    ...a,
    networkMode: `always`,
...
function rx(e, t, n, r, i, a) {
  ...
  let { data: u } = Hb(e, t, i, l);
  return Ye(nx(n, u, u ? (typeof r == `function` ? r(u) : r) : null, s, t, a));
}
function ix(e, t, n) {
  let r = (0, wm.c)(6),
    i;
  r[0] !== t || r[1] !== e
    ? ((i = async (n) => xb(`git`).request({ method: e, params: tx(n, t) })),
      (r[0] = t),
      (r[1] = e),
      (r[2] = i))
    : (i = r[2]);
...
var ax = `task-stub`,
  ...
  fx = `git-stage`,
  px = `git-commit`,
  mx = `git-create-branch`,
  hx = `git-push`,
  gx = `git-create-pr`,
  _x = `pr-auto-fix-progress`,
  vx = `automation-citation`,
  yx = new Set([sx, cx, lx, ux, fx, px, mx, hx, gx, _x]),
  bx = B({
    cwd: R().trim().min(1),
    branch: R().trim().min(1).optional(),
    url: R().trim().min(1).optional(),
    isDraft: tt((e) => {
...
function Cx(e) {
  if (!xx.some((t) => e.includes(`:${t}`))) return [];
  let t = er(e),
    n = [];
  for (let e of t) {
    if (!xx.includes(e.name)) continue;
    let t = Sx(e.name);
    if (t == null) continue;
    let r = bx.safeParse(e.attributes);
    r.success &&
      n.push({
        type: t,
        cwd: r.data.cwd,
...
async function Tx({ scope: e, cwd: t, hostConfig: n }) {
  try {
    return await e.queryClient.fetchQuery(Tb(t, Db(n), n, `git_action_directives`));
  } catch {
    return null;
  }
}
async function Ex({ scope: e, conversationId: t, directives: n, hostConfig: r }) {
  if (n.length === 0) return;
  let i = Db(r),
    a = null,
    o = [],
  ...
  for (let t of n) {
    if (t.type === `create-pr` && t.branch) {
      ...
      o.push(
        (async () => {
          let t = Je(`gh-pr-status`, { cwd: i, headBranch: n, hostId: r.id });
  ...
  (o.length > 0 &&
    o.push(
      e.queryClient.invalidateQueries({ queryKey: Je(`gh-pr-body`) }),
      e.queryClient.invalidateQueries({ queryKey: Je(`gh-pr-checks`) }),
      e.queryClient.invalidateQueries({ queryKey: Je(`gh-pr-comments`) }),
    ),
    await Promise.all(o));
  let c = await Promise.all(
    Array.from(s).map(async (t) => ({
      cwd: t,
      metadata: await Tx({ scope: e, cwd: t, hostConfig: r }),
    })),
  );
  (await Promise.all(
    c.flatMap(({ metadata: t }) =>
      t == null ? [] : [Jb(e.queryClient, t, { changeType: `head`, hostKey: i })],
    ),
  ),
    a != null && vb(t, a));
}
function Dx(e, t) {
  t.addTurnCompletedListener((n) => {
    ...
    a.length !== 0 &&
      Ex({ scope: e, conversationId: n.conversationId, directives: a, hostConfig: Ox(e) });
  });
}
function Ox(e) {
  let t = P(e.get, `host_config`);
  return t != null && t.id === `local`
    ? t
    : ke(Ee, [
        ...(P(e.get, `remote_ssh_connections`) ?? []),
        ...(P(e.get, `remote_wsl_connections`) ?? []),
        ...(P(e.get, `remote_control_connections`) ?? []),
      ]);
}
var kx = new WeakMap(),
  Ax = 5e3,
  ...
  Nx = u(p, (e, { get: t }) => {
    let n = t(jx, e);
    return !t(Mx, e) && (n?.status === `connecting` || n?.status === `connected`);
  });
function Px(e, t) {
  let n = t.getHostId(),
    r = Rx(e, n),
  ...
  (t.addNotificationCallback(`remoteControl/status/changed`, ({ params: t }) => {
    ...
    t
      ...
      .then((t) => {
        e.get(jx, n) === i && zx(e, n, r) && Fx(e, n, t);
      })
      .catch((t) => {
        zx(e, n, r) &&
          I.error(`Failed to read remote-control status`, { safe: {}, sensitive: { error: t } });
      }));
}
function Fx(e, t, n) {
  (n?.status === `connected` && e.set(Mx, t, !1), e.set(jx, t, n));
}
function Ix(e, t, n) {
  e.set(Mx, t, n);
}
function Lx(e, t, { ignoreCurrentError: n = !1 } = {}) {
  let r = e.get(jx, t),
...
function Rx(e, t) {
  let n = kx.get(e);
  n ?? ((n = new Map()), kx.set(e, n));
  let r = (n.get(t) ?? 0) + 1;
  return (n.set(t, r), r);
}
function zx(e, t, n) {
  return kx.get(e)?.get(t) === n;
}
function Bx(e, t) {
...
function Hx(e) {
  ...
  let t = !1;
  e.watch(({ get: n }) => {
    let r = n(jx, Ee)?.status === `connected`;
    (r &&
      !t &&
      Gs(e, z.CODEX_MOBILE_SETUP_COMPLETED, !0).catch((e) => {
        I.error(`Failed to mark Codex mobile setup complete`, {
          safe: {},
          sensitive: { error: e },
        });
      }),
...
var Ux = d(p, () => ({
  ...
  queryFn: async () => {
    try {
      return await bn.safeGet(`/wham/usage`);
    } catch (e) {
      if (e instanceof We && (e.status === 401 || e.status === 403 || e.status === 404))
        return null;
      throw e;
    }
  },
...
function Wx(e, t) {
  t.addNotificationCallback(`error`, (t) => {
    t.params.error.codexErrorInfo === `usageLimitExceeded` && e.query.fetch(Ux).catch(() => void 0);
  });
}
var Gx = `586515394`;
function Kx(e, t) {
  ...
  (t.addNotificationCallback(`turn/started`, (r) => {
    if (!dn(e, Gx)) return;
    let i = H(r.params.threadId);
    if (t.getStreamRole(i)?.role !== `owner`) return;
    let a = t.getConversation(i);
    if (Se(a)) return;
    let o = Yx(e);
    if (e.get(zn).submitCodexAnalyticsEvent == null || o == null) return;
    let s = a == null ? [] : N(a),
    ...
    t.addTurnCompletedListener((t) => {
      if (t.turnId == null || !Xx(t.status)) return;
      let r = `${t.conversationId}:${t.turnId}`,
        i = n.get(r);
      i != null &&
        (n.delete(r), Jx(e, t.conversationId, t.hostId, t.status, t.turnId, Date.now(), i));
    }));
}
async function qx(e, t, n, r, i, a) {
  try {
    return await xb(`git`).request({
    ...
    return (
      I.warning(`Failed to start turn diff analytics capture`, {
        safe: {},
        sensitive: { error: e },
      }),
      null
...
async function Jx(e, t, n, r, i, a, o) {
  try {
    let s = await o.capture;
    if (s == null) return;
    let c = await xb(`git`).request({
      method: `turn-diff-capture-complete`,
      params: {
        capture: s,
        hostConfig: Zx(e, n),
        operationSource: `turn_diff_analytics`,
        retainCheckpoint: dn(e, Gx) && Yx(e) === o.accountId,
      },
    });
    if (c.diff.type === `error`) {
      I.warning(`Skipping failed turn diff analytics capture`, {
    ...
    if (!dn(e, Gx) || Yx(e) !== o.accountId) return;
    await e
      .get(zn)
    ...
    I.warning(`Failed to complete turn diff analytics capture`, {
      safe: { status: r },
      sensitive: { error: e },
    });
  }
...
function Yx(e) {
  let t = e.queryClient.getQueryData([`accounts`, `check`]),
    ...
    r = t?.accounts?.find(({ id: e }) => e === n),
    i = r?.is_zdr === !1 || (r?.is_zdr === !0 && r.is_openai_internal === !0);
  return n == null || !i ? null : n;
}
function Xx(e) {
  switch (e) {
    case `completed`:
...
function Qx(e) {
  e.addTurnCompletedListener((t) => {
    ...
    if (i == null || !r || r.trim().length === 0) {
      I.debug(`[Directives] skipping empty turn`, {
    ...
    let a = er(r),
      o = a.filter((e) => e.name === sx),
      s = a.some((e) => e.name === cx);
    ...
    if (o.length > 0) {
      ...
      t.length > 0 &&
        (I.info(`[Directives] creating inbox items`, {
          safe: { itemCount: t.length, conversationId: n, turnId: i },
          sensitive: {},
        }),
        F.dispatchMessage(`inbox-items-create`, { conversationId: n, turnId: i, items: t }));
    }
    if (!s) return;
    I.info(`[Directives] archiving conversation`, {
      safe: { conversationId: n, turnId: i },
      sensitive: {},
    });
    let c = $n(r);
    qe(`automation-run-archive`, {
      params: {
        threadId: n,
      ...
      I.warning(`Failed to persist archived automation message`, {
        safe: {},
        sensitive: { error: e },
      });
    });
...
var $x = `https://chatgpt.com/cyber`,
  eS = `gpt-5.4`,
  tS = [`error`, `model/verification`],
  nS = `cyber-safety-composer-banner:repeated-blocks-last-shown-at`,
  rS = { dismissedEventId: null, event: null },
  iS = a(p, (e) => rS, void 0, { key: ({ conversationId: e, hostId: t }) => `${t}:${e}` }),
  aS = ir(nS, null);
function oS(e, t) {
  t.addNotificationCallback(tS, (n) => {
    let r = uS(n);
    r != null && sS(e, { conversationId: r.conversationId, hostId: t.getHostId() }, r);
  });
}
function sS(e, t, n, r = Date.now()) {
  lS(n.variant, e.get(aS), r) &&
    (e.set(iS, t, (e) => ({ ...e, event: { ...n, eventId: (e.event?.eventId ?? -1) + 1 } })),
    n.variant === `repeated_blocks` && e.set(aS, r));
}
function cS(e, t, n) {
  e.set(iS, t, (e) => ({ ...e, dismissedEventId: n }));
}
function lS(e, t, n) {
  return e === `first_block` ? !0 : t == null || n - t >= 864e5;
}
function uS(e) {
  let t = H(e.params.threadId);
  switch (e.method) {
    case `error`:
...
function fS(e, t) {
  return F.subscribe(`ipc-broadcast`, (n) => {
    if (n.method !== e) return;
    let r = qt(e),
      i = n.version ?? 0;
    if (i !== r) {
      I.warning(`Ignoring ipc-broadcast`, {
        safe: {},
...
var mS = `unread-thread-ids-by-host-v1`,
  hS = {},
  gS = ir(mS, hS);
function _S(
  e,
  ...
  n,
  {
    ...
    hostFetch: a = qe,
    ipcBridge: o = { registerBroadcastHandler: fS, request: pS },
    useTailHydration: s = () => e?.get(gn)?.checkGate(`4261455886`) ?? !1,
  } = {},
) {
  let c = t === Ee,
    l = new sm(t, n, r, i, a, o, s, e, {
      supportsStateDbOnlyThreadList: c,
      getRecentConversationDiscoveryLimit: () =>
        e != null && c && e.get(fn, `3314958849`) ? 500 : 50,
      onExpandedThreadHistoryLoaded: (t) => {
        e != null && c && Vn(e, jn, t);
      },
      shouldPauseQueueAfterInterruptedTurn: () => e != null && dn(e, `3194650870`),
      getThreadHasUnreadTurn: ({ hostId: t, threadId: n }) =>
        (e == null ? hS : vS(e))[t]?.includes(n) === !0,
      setThreadHasUnreadTurn: ({ hostId: t, threadId: n, hasUnreadTurn: r }) => {
        if (e == null) return;
        let i = vS(e),
          a = i[t] ?? [];
        a.includes(n) !== r && e.set(gS, { ...i, [t]: r ? [...a, n] : a.filter((e) => e !== n) });
      },
    });
  return (
    e != null &&
...
function TS(e) {
  switch (CS(e?.id ?? null, e?.name)) {
    case `fast`:
      return xS.fastLabel;
    case `ultrafast`:
      return xS.ultrafastLabel;
    case null:
      return e?.name ?? xS.standardLabel;
  }
}
function ES(e) {
  switch (CS(e?.id ?? null, e?.name)) {
    case `fast`:
      return e?.description ?? xS.fastDescription;
    case `ultrafast`:
      return e?.description ?? xS.ultrafastDescription;
    case null:
      return e?.description ?? xS.standardDescription;
  }
}
function DS(e, t) {
  return t == null
...
function OS(e) {
  return [
    {
      description: xS.standardDescription,
      iconKind: null,
      label: xS.standardLabel,
      tier: null,
      value: null,
    },
    ...(e?.serviceTiers ?? []).map((e) => ({
      description: ES(e),
      iconKind: CS(e.id, e.name),
      label: TS(e),
      tier: e,
      value: e.id,
    })),
...
function kS(e, t) {
  return e?.find((e) => jS(e, t) && !e.hidden) ?? e?.find((e) => jS(e, t)) ?? null;
}
function AS(e) {
  return (
    e?.serviceTiers?.find(
      (e) => CS(e.id, e.name) === `fast` || e.name.trim().toLowerCase() === `priority`,
    ) ?? null
  );
}
function jS(e, t) {
...
function NS(e, t) {
  return DS(e, t)?.id ?? null;
}
function PS(e, t, n = !0) {
  if (!n) return null;
  if (t == null) {
    let t = e?.defaultServiceTier ?? null;
    return t == null ? null : NS(e, t);
  }
  return t === bS ? null : t;
}
function FS(e) {
...
var RS = { cwd: null, diff: null, turnId: null },
  zS = a(p, (e) => {
    let t = new oo(e, (e, t) => F.dispatchMessage(e, t)),
      n = new Co(e);
    return (
  ...
  VS = u(p, (e, { get: t }) => t(t(BS, e).state$)),
  HS = u(p, (e, { get: t }) => t(t(BS, e).error$)),
  US = u(p, (e, { get: t }) => t(t(BS, e).appServerVersion$)),
  WS = u(p, (e, { get: t }) => t(t(BS, e).installedCodexVersion$)),
  GS = s(p, ({ get: e }) => {
    let t = e(YS, Ee);
  ...
  KS = l(p, () => [Ee]);
function qS({ hostId: e, cwd: t }) {
  return `${e}:${t ?? ``}`;
}
var JS = a(p, (e) => null, void 0, { key: qS }),
  YS = a(p, (e, { get: t }) => {
    let n = t(ZS, e);
    return n == null ? null : vi(n);
  }),
  XS = a(p, (e) => !1),
  ZS = a(p, (e, { get: t, scope: n }) => {
  ...
  nC = l(p, null, {
    onMount: (e, t) =>
      t.watch(({ get: t }) => {
        let n = t(QS).map((t) => t.addTurnCompletedListener(e));
        return () => {
          for (let e of n) e();
        };
      }),
  ...
  uC = u(p, (e, { get: t }) => {
    if (e == null || !t(fn, `3314958849`)) return null;
    let n = xw(t, e);
    return n != null && n !== `local` ? null : (t(dC, `local`).get(e) ?? null);
  }),
  dC = u(p, (e, { get: t }) => new Map(t(lC, e).map((e) => [e.conversationId, e]))),
  fC = a(p, (e) => [], {
    onMount: (e, t) => {
      let { key: n } = t;
      return t.watch(({ get: t }) => {
  ...
  mC = $(({ updatedAt: e }) => e),
  hC = $(({ cwd: e }) => e ?? null),
  gC = $(({ gitInfo: e }) => e?.branch?.trim() || null),
  _C = $(({ hasUnreadTurn: e }) => e),
  vC = $(({ unreadMessageCount: e }) => e ?? 0),
  yC = $((e) => M(e)?.status === `inProgress`),
  bC = $(
  ...
  SC = $(({ latestCollaborationMode: e }) => e),
  CC = $(({ latestThreadSettings: e }) => e ?? null),
  wC = $(({ currentPermissions: e }) => e ?? null),
  TC = $(({ modelProvider: e }) => e ?? null),
  EC = $(({ latestModel: e }) => e),
  DC = $(({ latestReasoningEffort: e }) => e),
  OC = $(({ requests: e }) => e.at(-1) ?? null),
  kC = $(({ latestTokenUsageInfo: e, resumeState: t }) => (t === `resumed` ? e : null)),
  AC = $(({ requests: e }) => e.length),
  jC = $(({ requests: e }) => e),
  MC = $(le),
  NC = $(({ resumeState: e }) => e),
  PC = $(ae),
  FC = $(({ rolloutPath: e }) => e),
  IC = $(({ source: e }) => e ?? null),
  LC = $(({ threadSource: e }) => e ?? null),
  RC = $(({ source: e }) => j(e)?.parentThreadId ?? null),
  zC = $(({ title: e }) => e),
  BC = $(({ completedThreadGoal: e }) => e ?? null),
  VC = $(({ threadGoal: e }) => e ?? null),
  HC = $(({ threadGoalResumeConfirmation: e }) => e ?? null),
  UC = $(({ threadRuntimeStatus: e }) => e ?? null),
  WC = $(Ce),
  GC = $(pe),
  KC = $(M),
  qC = $((e) => Cw(N(e)).diff),
  JC = $((e) => Cw(N(e)).cwd),
  YC = $((e) => M(e)?.turnId ?? null),
  XC = $((e) => M(e)?.status ?? null),
  ZC = $((e) => M(e)?.items.some((e) => e.type === `error` && !e.willRetry) === !0),
  QC = $(N),
  $C = u(p, (e, { get: t }) => Me(t(_w, e))),
  ew = $(({ workspaceKind: e }) => e),
  tw = $(({ workspaceBrowserRoot: e }) => e ?? null),
  nw = $(({ projectlessOutputDirectory: e }) => e ?? null),
  rw = s(p, ({ get: e }) => e(GS).getHostId()),
  iw = u(p, (e, { get: t }) => {
    let n = t(QS),
      r = xw(t, e),
  ...
  aw = u(p, (e, { get: t }) => t(iw, e)?.getHostId() ?? t(rw)),
  ow = a(p, (e) => null, {
    onMount: (e, t) => {
      let { key: n } = t;
      if (n != null)
  ...
  cw = u(p, (e, { get: t }) =>
    e == null || t(sw, e) ? !1 : !t(sC, e) || t(NC, e) === `needs_resume` || t(ow, e) == null,
  );
function lw(e) {
  return e == null
    ? []
    : e
        ...
        .map((e) => ({
          conversationId: e.id,
          lastTurnStatus: M(e)?.status ?? null,
          resumeState: e.resumeState,
...
var uw = u(p, (e, { get: t }) => {
    let n = t(NC, e);
    if (n == null) return !1;
    if (n === `needs_resume`) return t(UC, e)?.type === `active`;
    if (t(WC, e) === 0) return n === `resuming`;
    let r = t(KC, e);
    return r == null ? !0 : r.status === `inProgress`;
  }),
  dw = s(p, ({ get: e }) => e(cC, Ee).some((t) => e(uw, t)));
s(p, ({ get: e }) => {
  let t = 0;
  for (let n of e(cC, Ee)) e(_C, n) === !0 && e(RC, n) == null && (t += 1);
  return t;
});
function fw(e, t) {
  if (t == null) return null;
  let n = xw(e.get, t);
  return (
    (n == null ? null : e.get(YS, n)) ?? e.get(QS).find((e) => e.getConversation(t) != null) ?? null
  );
}
var pw = l(p, 0);
function mw(e, t) {
...
function hw(e, { error: t, hostId: n, source: r = `unknown`, state: i }) {
  let a = e.get(BS, n),
    o = mw(e, n),
    s = t === void 0 ? (o.error ?? null) : t;
  (I.info(`remote_connections.manager_state_set`, {
    safe: { hostId: n, nextState: i, previousState: o.state, source: r },
    sensitive: { nextError: s, previousError: o.error },
  }),
    Ei(e, { error: s, hostId: n, previousError: o.error, previousState: o.state, state: i }),
    a.state$.set(i),
    a.error$.set(s));
}
function gw(e, { appServerVersion: t, hostId: n, installedCodexVersion: r }) {
  let i = e.get(BS, n);
    ...
    onMount: (e, t) => {
      ...
      let r = new Map(),
        ...
        a = (e, t) => {
          let a = e.filter((e) => {
              let n = e.getHostId();
              return i == null || n === i || n === t;
            }),
            o = new Map(a.map((e) => [e.getHostId(), e]));
          for (let [e, t] of r) o.get(e) !== t.manager && (t.unsubscribe(), r.delete(e));
          for (let e of a) {
            let t = e.getHostId(),
              i = r.get(t);
            if (i?.manager === e) continue;
            i?.unsubscribe();
            let a = e.addConversationCallback(n, c),
              o = e.addAnyConversationMetaCallback(c);
            r.set(t, {
              manager: e,
              unsubscribe: () => {
                (a(), o());
        ...
        o = (e, t) => {
          if (t != null) {
            let r = e.find((e) => e.getHostId() === t)?.getConversation(n) ?? null;
            if (r != null) return { conversation: r, hostId: t };
          }
          if (i != null) {
        ...
        s = (t) => {
          let r = t(QS),
            s = xw(t, n),
            c = o(r, s);
          ((i = c.hostId), a(r, s), e(c.conversation));
        },
        c = () => {
          s(t.get);
        },
...
function bw(e, t) {
  return t == null ? null : e(vw, t);
}
function xw(e, t) {
  return bw(e, t) ?? Sw(e, t);
}
function Sw(e, t) {
  if (t == null) return null;
  let n = Ks(e, z.THREAD_PROJECT_ASSIGNMENTS)?.[t];
...
function Cw(e) {
  ...
  for (let t = e.length - 1; t >= 0; --t) {
    let i = e[t];
    if (i != null && ((r ??= Tw(i)), (n ??= Ew(i)), r != null && n != null)) break;
  }
...
function ww(e) {
  return e == null ? RS : (Tw(e) ?? Ew(e) ?? RS);
}
function Tw(e) {
  return e.diff == null || e.diff.length === 0
    ? null
    : {
        cwd: e.params.cwd == null ? null : V(e.params.cwd),
        diff: e.diff,
...
function Ew(e) {
  ...
  return n.length === 0
    ? null
    : {
        cwd: t[0]?.cwd ?? (e.params.cwd == null ? null : V(e.params.cwd)),
        diff: n,
        turnId: e.turnId ?? null,
      };
}
function Dw(e) {
  let t = [],
    n = e.params.cwd == null ? null : V(e.params.cwd);
  for (let r of e.items) {
    if (r.type === `commandExecution`) {
      n = r.cwd == null ? n : V(r.cwd);
      continue;
    }
    r.type !== `fileChange` ||
      r.status === `failed` ||
      r.status === `declined` ||
      r.changes.length === 0 ||
      t.push({ changes: Le(r.changes), cwd: n });
  }
  return t;
}
function $(e) {
...
var Ow = s(p, ({ get: e }) => P(e, `host_config`) ?? null),
  kw = s(p, ({ get: e }) => [
    ...(P(e, `remote_ssh_connections`) ?? []),
    ...(P(e, `remote_wsl_connections`) ?? []),
    ...(P(e, `remote_control_connections`) ?? []),
  ]),
  Aw = Ge(p, `codex-home`, () => ({ staleTime: L.FIVE_SECONDS })),
  jw = s(p, ({ get: e }) => e(Aw, void 0)),
  Mw = Ge(p, `home-directory`, () => ({ staleTime: L.FIVE_SECONDS })),
  Nw = Ue(p, `active-workspace-roots`, { placeholderData: n, staleTime: L.FIVE_SECONDS }),
  Pw = s(p, ({ get: e }) => {
    let t = e(Nw).data?.roots?.[0] ?? null;
    if (t == null) return null;
    let n = bt({
      projectId: t,
      projectWritableRoots: rt(Ks(e, z.PROJECT_WRITABLE_ROOTS)),
      legacyRoot: ht(t) ? t : null,
    });
    return n.length === 1 ? (n[0] ?? null) : null;
  }),
  Fw = Ge(p, `workspace-root-options`, () => ({ placeholderData: n, staleTime: L.INFINITE })),
  Iw = Ue(p, `workspace-root-options`, {
    params: { hostId: Ee },
    placeholderData: n,
    staleTime: L.INFINITE,
  }),
  Lw = s(p, ({ get: e }) => Ks(e, z.REMOTE_PROJECTS) ?? []),
  Rw = s(p, ({ get: e }) => {
    let t = e(Lw),
      n = Ks(e, z.ACTIVE_REMOTE_PROJECT_ID);
    return n == null ? null : (t.find((e) => e.id === n) ?? null);
  }),
  zw = s(p, ({ get: e }) => Ks(e, z.THREAD_PROJECT_ASSIGNMENTS)),
  Bw = u(p, (e, { get: t }) => {
    let n = t(Ow);
    return n != null && e === n.id ? n : ke(e, t(kw));
  });
export {
  qC as $,
  Us as $i,
