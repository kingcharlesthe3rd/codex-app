...
var Di = t((e, t) => {
  ...
  Sa = t((e, t) => {
    ...
    t.exports = function (e) {
      ...
      if (!u(e)) {
        if ((ee = e[n]) !== void 0) {
          for (x = o(ee).call(e), h && (v = new h()), S = x.next(), g = 0; !S.done; )
            ((C = t ? d.call(t, m, S.value, g) : S.value),
  ...
  Da = t((e, t) => {
    ...
    t.exports = function (e, t, a) {
      ...
      return (
        ...
        d(D, { __memoized__: i(!0), delete: i(x), clear: i(h.clear), _get: i(S), _has: i(ee) }),
        h
      );
    };
  }),
  ...
  hd = class {
    ...
    async createConversation({
      ...
      let h = null?.[0]?.cwd,
        ...
        _ = g === `projectless`,
        v =
          h == null || h === `/` || a.sandboxPolicy.type !== `workspaceWrite`
            ? a
        ...
        b =
          ...
          (a.activePermissionProfile == null || a.activePermissionProfile.id.startsWith(`:`)) &&
          ku(s) &&
          this.params.prewarmedThreadManager.hasPrewarmedThread(o),
        x = b ? this.getInstructionOverrides(e?.settings.model ?? null) : null,
        S = b ? await this.params.prewarmedThreadManager.consumePrewarmedThread(o, x) : null,
        ee =
          _ && h == null
...
function Zd(e, t, n, r) {
  let i = { id: x(n), type: `planImplementation`, turnId: n, planContent: r, isCompleted: !1 };
  e.updateConversationState(t, (e) => {
...
function Qd(e, t, n, r) {
  e.updateConversationState(t, (e) => {
    ((e.requests = e.requests.filter((e) =>
      ...
      e.requests.push({ method: S, id: x(n), params: { threadId: t, turnId: n, planContent: r } }),
      (e.hasUnreadTurn = !0));
  });
}
function $d(e, t, n) {
...
async function ep(
  ...
  try {
    ...
    let y = ap({
      ...
      ee = Vf(S.sandboxPolicy, p),
      C = { ...S, sandboxPolicy: bf({ sandboxPolicy: ee, workspaceKind: l?.workspaceKind }) },
      ...
      E = w || l?.workspaceKind === `projectless` || Hf(S.sandboxPolicy, p),
      D = T,
...
async function Rp(e, t, n) {
  let { beforeSendRequest: r, inheritThreadSettings: i = !0, ...a } = n,
    o = a.clientUserMessageId ?? G(),
    s = e.getConversation(t),
    c = s?.environments?.[0]?.cwd,
    l =
      s?.workspaceKind === `projectless`
        ? yf(s.latestThreadSettings?.sandboxPolicy ?? ue(s)?.params.sandboxPolicy)
        : null,
    u =
      c ??
      vf({
    ...
    d = await qf({
      ...
      workspaceRoots: s?.workspaceKind === `projectless` && u == null ? [] : [u ?? `/`],
  ...
  let p = await Vp(e, t),
    m = await Hp(e, t),
    h = f.environments?.[0]?.cwd,
    g =
      h == null && p == null && (f.workspaceKind === `projectless` || (await Wp(e, t)))
        ? await Gp({ manager: e, conversationState: f, retainedWritableRoots: m, input: a.input })
        : null,
    _ = p == null ? (g == null ? f.workspaceKind : `projectless`) : `project`,
    v = _ === `projectless` ? (g?.workspaceRoot ?? f.workspaceBrowserRoot ?? null) : null,
    y = i ? f.latestThreadSettings : null,
    b = y?.collaborationMode ?? (i ? f.latestCollaborationMode : null),
    x = a.collaborationMode ?? b,
    S = a.collaborationMode != null,
    ee = y?.model ?? (i ? f.latestModel : null),
    C = y?.effort === void 0 ? (i ? f.latestReasoningEffort : null) : y.effort,
    w = S ? null : Zf(a.model ?? ee),
    T = S ? null : a.effort === void 0 ? C : a.effort,
    E = ue(f),
    D = i ? (E?.params ?? null) : null,
    O = Ut(_ === `projectless` && v != null && v !== `~` ? [v] : []),
    te =
      a.approvalPolicy ??
      y?.approvalPolicy ??
      E?.params.approvalPolicy ??
      f.currentPermissions?.approvalPolicy ??
      O.approvalPolicy,
    k =
      a.sandboxPolicy ??
      y?.sandboxPolicy ??
      E?.params.sandboxPolicy ??
      f.currentPermissions?.sandboxPolicy ??
      O.sandboxPolicy,
    ne = Vf(k, m),
    A = g == null ? ne : Up(ne, g.workspaceRoot),
    re = p?.path == null ? A : Up(A, p.path),
    ie =
      a.approvalsReviewer ??
      y?.approvalsReviewer ??
      E?.params.approvalsReviewer ??
      f.currentPermissions?.approvalsReviewer ??
      O.approvalsReviewer,
    ae = yf(re),
    oe =
      h ??
      (p?.projectKind === `local` ? p.cwd : null) ??
      p?.path ??
      g?.cwd ??
      vf({ cwd: a.cwd ?? f.cwd, fallbackCwd: ae, workspaceBrowserRoot: v, workspaceKind: _ }),
    se = bf({ sandboxPolicy: re, workspaceKind: _ }),
    ce = se,
    j =
      re.type === `workspaceWrite`
        ? Uf(
            re.writableRoots,
            [f.cwd, oe].filter((e) => e != null && e !== `~`),
          )
        : [],
    le =
      _ === `projectless` ||
    ...
    M =
      a.permissions === void 0
        ? a.sandboxPolicy == null
          ? y?.activePermissionProfile === void 0
            ? y?.permissions === void 0
              ? (f.currentPermissions?.activePermissionProfile?.id ?? D?.permissions ?? null)
              : y.permissions
            : (y.activePermissionProfile?.id ?? null)
          : null
        : a.permissions,
    fe =
      M == null
        ? null
        : Uf(
            a.runtimeWorkspaceRoots ??
              f.currentPermissions?.runtimeWorkspaceRoots ??
              D?.runtimeWorkspaceRoots ??
              (ce.type === `workspaceWrite` ? ce.writableRoots : m),
            [f.cwd, oe].filter((e) => e != null && e !== `~`),
          ),
    pe =
      a.personality === void 0
        ? y?.personality === void 0
    ...
    me =
      a.summary === void 0
        ...
        : a.summary,
    he =
      y?.serviceTier === void 0
        ? D?.serviceTier === void 0
          ? null
          : D.serviceTier
        : y.serviceTier,
    ge = a.serviceTier === void 0 ? he : a.serviceTier,
    _e = {
      threadId: t,
      ...
      cwd: oe,
      approvalPolicy: de || le ? te : null,
      approvalsReviewer: ie,
      sandboxPolicy: M == null && (de || le) ? ce : null,
      permissions: M,
      ...(fe == null ? {} : { runtimeWorkspaceRoots: fe }),
      model: w,
      serviceTier: ge,
      effort: T,
      summary: me,
    ...
    N = {
      activePermissionProfile: zp(
        M,
        y?.activePermissionProfile,
        f.currentPermissions?.activePermissionProfile,
      ),
      approvalPolicy: te,
      approvalsReviewer: ie,
      runtimeWorkspaceRoots: fe ?? void 0,
      sandboxPolicy: ce,
    },
    ye = f.currentPermissions;
  e.updateConversationState(t, (e) => {
    let t = [],
    ...
    (Ro(e, {
      ...
      p == null
        ? g != null &&
          ...
          (e.workspaceBrowserRoot = g.workspaceRoot),
          (e.cwd = g.cwd))
        : ((e.workspaceKind = `project`), (e.workspaceBrowserRoot = null), (e.cwd = p.path)),
      (e.latestModel = w ?? e.latestModel),
      (e.latestReasoningEffort =
        a.effort !== void 0 || y != null ? T : (T ?? e.latestReasoningEffort)),
      (e.latestCollaborationMode = x ?? e.latestCollaborationMode),
      (e.currentPermissions = N),
      (e.updatedAt = Date.now()));
  });
  try {
    await r?.();
    let n = await e.sendRequest(`turn/start`, _e, { timeoutMs: Ae });
    return (
      j.length > 0 && (p != null || m.length > 0 || oe !== f.cwd) && (await qp(e, t, j)),
      p != null && (await Kp(e, t, p)),
      e.updateConversationState(t, (e) => {
        let t = Bp(e, o, n.turn.id);
    ...
    throw (
      e.updateConversationState(t, (e) => {
        ...
        ye == null ? delete e.currentPermissions : (e.currentPermissions = ye);
      }),
      n
    );
  }
    ...
    async startConversation(
      {
        ...
        memoryPreferences: u,
        baseInstructions: d,
        skipAutoTitleGeneration: f = !1,
        additionalDeveloperInstructions: p,
        config: m,
      ...
      { beforeFirstTurn: y, returnAfterOptimisticTurn: b } = {},
    ) {
      let {
        conversationId: x,
      ...
      if (
        (g !== void 0 && (await this.threadWorkspaceState.setProjectAssignment(x, g)),
      ...
      let w = t?.settings.reasoning_effort,
        T = Vs(S, o.activePermissionProfile),
        E = b ? Lt() : null,
        D = () => this.generateConversationTitle(x, e, ee ?? null, c),
        O = async () => {
          (!f && (y == null || E == null) && D(),
            await Rp(this, x, {
              cwd: ee,
...
function Fy(e) {
  let t = ie(ee({ attachments: e.params.attachments ?? [], input: e.params.input })),
    n = new Map();
  for (let e of t) {
    let t = Hy(e);
    if (t == null) continue;
...
var JS = a(p, (e) => null, void 0, { key: qS }),
  ...
  wC = $(({ modelProvider: e }) => e ?? null),
  TC = $(({ latestModel: e }) => e),
  EC = $(({ latestReasoningEffort: e }) => e),
  DC = $(({ requests: e }) => e.at(-1) ?? null),
  OC = $(({ latestTokenUsageInfo: e, resumeState: t }) => (t === `resumed` ? e : null)),
  kC = $(({ requests: e }) => e.length),
  AC = $(({ requests: e }) => e),
  jC = $(le),
  MC = $(({ resumeState: e }) => e),
  NC = $(ae),
  PC = $(({ rolloutPath: e }) => e),
  FC = $(({ source: e }) => e ?? null),
  IC = $(({ threadSource: e }) => e ?? null),
  LC = $(({ source: e }) => j(e)?.parentThreadId ?? null),
  RC = $(({ title: e }) => e),
  zC = $(({ completedThreadGoal: e }) => e ?? null),
  BC = $(({ threadGoal: e }) => e ?? null),
  VC = $(({ threadGoalResumeConfirmation: e }) => e ?? null),
  HC = $(({ threadRuntimeStatus: e }) => e ?? null),
  UC = $(Ce),
  WC = $(pe),
  GC = $(M),
  KC = $((e) => Sw(N(e)).diff),
  qC = $((e) => Sw(N(e)).cwd),
  JC = $((e) => M(e)?.turnId ?? null),
  YC = $((e) => M(e)?.status ?? null),
  XC = $((e) => M(e)?.items.some((e) => e.type === `error` && !e.willRetry) === !0),
  ZC = $(N),
  QC = u(p, (e, { get: t }) => Me(t(gw, e))),
  $C = $(({ workspaceKind: e }) => e),
  ew = $(({ workspaceBrowserRoot: e }) => e ?? null),
  tw = $(({ projectlessOutputDirectory: e }) => e ?? null),
  nw = s(p, ({ get: e }) => e(GS).getHostId()),
  rw = u(p, (e, { get: t }) => {
    let n = t(QS),
      r = bw(t, e),
  ...
  iw = u(p, (e, { get: t }) => t(rw, e)?.getHostId() ?? t(nw)),
  aw = a(p, (e) => null, {
    onMount: (e, t) => {
      let { key: n } = t;
      if (n != null)
  ...
  sw = u(p, (e, { get: t }) =>
    e == null || t(ow, e) ? !1 : !t(sC, e) || t(MC, e) === `needs_resume` || t(aw, e) == null,
  );
function cw(e) {
  return e == null
    ? []
...
var lw = u(p, (e, { get: t }) => {
    let n = t(MC, e);
    if (n == null) return !1;
    if (n === `needs_resume`) return t(HC, e)?.type === `active`;
    if (t(UC, e) === 0) return n === `resuming`;
    let r = t(GC, e);
    return r == null ? !0 : r.status === `inProgress`;
  }),
  uw = s(p, ({ get: e }) => e(cC, Ee).some((t) => e(lw, t)));
s(p, ({ get: e }) => {
  let t = 0;
  for (let n of e(cC, Ee)) e(_C, n) === !0 && e(LC, n) == null && (t += 1);
  return t;
});
function dw(e, t) {
  if (t == null) return null;
...
function mw(e, { error: t, hostId: n, source: r = `unknown`, state: i }) {
  let a = e.get(BS, n),
    o = pw(e, n),
...
function hw(e, { appServerVersion: t, hostId: n, installedCodexVersion: r }) {
  let i = e.get(BS, n);
...
function yw(e, t) {
  return t == null ? null : e(_w, t);
}
function bw(e, t) {
  return yw(e, t) ?? xw(e, t);
}
function xw(e, t) {
  if (t == null) return null;
...
function Sw(e) {
  ...
  for (let t = e.length - 1; t >= 0; --t) {
    let i = e[t];
    if (i != null && ((r ??= ww(i)), (n ??= Tw(i)), r != null && n != null)) break;
  }
...
var Dw = s(p, ({ get: e }) => P(e, `host_config`) ?? null),
  Ow = s(p, ({ get: e }) => [
    ...(P(e, `remote_ssh_connections`) ?? []),
    ...(P(e, `remote_wsl_connections`) ?? []),
    ...(P(e, `remote_control_connections`) ?? []),
  ]),
  kw = Ge(p, `codex-home`, () => ({ staleTime: L.FIVE_SECONDS })),
  Aw = s(p, ({ get: e }) => e(kw, void 0)),
  jw = Ge(p, `home-directory`, () => ({ staleTime: L.FIVE_SECONDS })),
  Mw = Ue(p, `active-workspace-roots`, { placeholderData: n, staleTime: L.FIVE_SECONDS }),
  Nw = s(p, ({ get: e }) => {
    let t = e(Mw).data?.roots?.[0] ?? null;
    if (t == null) return null;
    let n = bt({
      projectId: t,
  ...
  Pw = Ge(p, `workspace-root-options`, () => ({ placeholderData: n, staleTime: L.INFINITE })),
  Fw = Ue(p, `workspace-root-options`, {
    params: { hostId: Ee },
    placeholderData: n,
    staleTime: L.INFINITE,
  }),
  Iw = s(p, ({ get: e }) => Ks(e, z.REMOTE_PROJECTS) ?? []),
  Lw = s(p, ({ get: e }) => {
    let t = e(Iw),
      n = Ks(e, z.ACTIVE_REMOTE_PROJECT_ID);
    return n == null ? null : (t.find((e) => e.id === n) ?? null);
  }),
  Rw = s(p, ({ get: e }) => Ks(e, z.THREAD_PROJECT_ASSIGNMENTS)),
  zw = u(p, (e, { get: t }) => {
    let n = t(Dw);
    return n != null && e === n.id ? n : ke(e, t(Ow));
  });
export {
  qC as $,
  Es as $i,
