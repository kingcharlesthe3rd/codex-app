...
function k(e) {
  ...
  if (
    ...
    return (
      t[7] === e.children
        ? (n = t[8])
        : ((n = (0, h.jsx)(h.Fragment, { children: e.children })), (t[7] = e.children), (t[8] = n)),
      n
    );
  }
...
function A({
  ...
  let q = (0, _.useCallback)(
      (e) => {
        (ie || ne(e), e ? G?.setActiveTooltipId(V, O) : G?.clearActiveTooltipId(V), a?.(e));
      },
      [G, ie, a, O, V],
    ),
    J = (0, _.useCallback)(() => {
    ...
    ae = (e) => {
      if ((Y(), !(K || U.current != null) && !(k === `trigger-overflows` && !F(H.current)))) {
        if (e === 0 || typeof window > `u`) {
          q(!0);
          return;
        }
        U.current = window.setTimeout(() => {
          ((U.current = null), !(k === `trigger-overflows` && !F(H.current)) && q(!0));
        }, e);
      }
    },
    X = (0, _.useCallback)(() => {
  ...
  let se = (e) => {
      ...
      let n = C ?? 0;
      (t && (n = 250), G?.skipDelayActive === !0 && G.activeSkipDelayKey === O && (n = 0), ae(n));
    },
    ...
    (ue = v
      ? (0, _.isValidElement)(e)
        ? typeof e.type == `string`
          ? (0, _.cloneElement)(e, {
              ...Q,
              "aria-describedby": P(e.props[`aria-describedby`], Z[`aria-describedby`]),
    ...
    : (0, v.createPortal)(
        (0, h.jsx)(`div`, {
          ...
          style: {
            ...
            maxWidth:
              m ?? `min(20rem, var(--radix-tooltip-content-available-width), calc(100vw - 16px))`,
