...
import { Br as t, Ii as n } from "./src-2.js";
import {
  Ks as r,
  No as i,
  Pi as a,
...
import { F as p, G as m, R as h, h as g, i as _, n as v } from "./vscode-api.js";
import { r as y } from "./react.js";
import { c as ee, o as b } from "./lib-2.js";
import { l as x, t as S } from "./persisted-signal-CweW-bgN.js";
import { r as C } from "./toast-signal.js";
import { t as w } from "./build-start-conversation-params.js";
import { n as T } from "./skill-utils.js";
import { t as E } from "./use-collaboration-mode.js";
import { c as D } from "./use-permissions-mode.js";
import { d as te } from "./onboarding-state.js";
import { t as ne } from "./use-service-tier-settings.js";
import { n as O, r as re } from "./projectless-thread.js";
import { t as ie } from "./check-circle-filled.js";
import { t as k } from "./graduation-cap.js";
...
function ue({ completed: e, hostId: t, onLocalConversationCreated: n, projectRoot: i }) {
  let o = p(g),
    c = ee(),
    ...
    O = async () => {
      if (!(T || e || v || i == null)) {
        (a(o, s.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, r.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED),
          x(!0));
        try {
          let e = pe(h.roles),
            c = j(_, Q)?.replace(/^name:\s*.*$/m, `name: ${le}`);
          (await me({
            ...
            prompt: fe(
              await de({
                ...
                repoPath: $,
                skillId: Q,
                skillStatsigOverride: c,
                forceReinstall: c == null,
              }),
            ),
            ...
            e != null &&
              a(
                ...
                r.CODEX_ONBOARDING_WIZARD_ACTION_SKIPPED,
              ),
            U(o, { hostId: t, projectRoot: i }, Z, `accepted`));
        } catch {
          o.get(C).danger(
            (0, X.jsx)(b, {
...
async function de({
  ...
  let s = await v(`install-recommended-skill`, {
    params: {
      forceReinstall: a,
      hostId: e,
      installRoot: null,
  ...
  if (!s.success || s.destination == null) throw Error(s.error ?? `Unable to install skill`);
  return (
    t(),
    await o(`list-skills-for-host`, { forceReload: !0, hostId: e }),
    se.default.join(s.destination, `SKILL.md`)
  );
}
function fe(e) {
...
async function me({
  ...
  let { config: g } = await o(`read-config-for-host`, { hostId: r, includeLayers: !1, cwd: h });
  await i(
