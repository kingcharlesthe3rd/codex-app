...
var N,
  ...
  U = e(() => {
    ((N = t(ie(), 1)),
      ...
      (I = le(F, {})),
      (L = y(o, `ambient-suggestions`, ({ projectRoot: e }) => ({ enabled: e != null }))),
      (R = y(
        o,
      ...
      (z = a(o, (e) => null)),
      (B = n(o, (e, { get: t }) => Ie(Le(t, e)))),
      (V = n(o, (e, { get: t }) => {
        let n = t(L, e);
        return n.data != null || n.isError;
      })),
      (H = n(o, ({ domain: e, hostId: t, projectRoot: n }, { get: r }) => {
...
function Ve({ completed: e, domain: t, hostId: n, onLocalConversationCreated: r, projectRoot: i }) {
  let a = g(o),
    s = _e(),
    {
      agentMode: c,
    ...
    } = ee({ conversationId: null, cwdOverride: i, hostId: n }),
    { activeMode: f } = te(null),
    { serviceTierSettings: p } = ne(null),
    m = h(Oe),
    _ = Me(),
    [v, y] = (0, J.useState)(!1),
    b = s.formatMessage({
    ...
    S = l || i == null;
  ke(D.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, !e);
  let C = async () => {
    if (!(S || e || v || i == null)) {
      (w(a, D.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, T.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED),
        y(!0));
      try {
        let e = We(m.roles),
          o = Ne(_, Z)?.replace(/^name:\s*.*$/m, `name: ${Q}`);
        (await K({
          ...
          prompt: Ue(
            await He({
              ...
              repoPath: $,
              skillId: Z,
              skillStatsigOverride: o,
              forceReinstall: o == null,
            }),
          ),
          serviceTier: p.serviceTierForRequest,
          shouldSendPermissionOverrides: d,
        }),
          e != null &&
            w(
              a,
              D.CODEX_ONBOARDING_WIZARD_PHASE_ROLE_PICKER,
              T.CODEX_ONBOARDING_WIZARD_ACTION_SKIPPED,
            ),
          k(a, { domain: t, hostId: n, projectRoot: i }, X, `accepted`));
      } catch {
        a.get(we).danger(
          (0, Y.jsx)(se, {
  ...
  return (0, Y.jsxs)(`button`, {
    ...
    children: [
      (0, Y.jsx)(`span`, {
        className: E(`flex h-5 shrink-0 items-center`, e && `opacity-30`),
        children: (0, Y.jsx)(G, { "aria-hidden": !0, className: `size-5 shrink-0` }),
      }),
      (0, Y.jsxs)(`span`, {
        className: E(`flex w-full min-w-0 flex-col gap-1 text-base`, e && `opacity-30`),
        children: [
          (0, Y.jsx)(`span`, {
...
function Ue(e) {
  return be({ name: `Setup Codex`, path: e });
}
function We(e) {
