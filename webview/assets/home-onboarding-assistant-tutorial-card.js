...
var N,
  ...
  U = e(() => {
    ((N = t(se(), 1)),
      ...
      (I = ae(F, {})),
      (L = h(D, `ambient-suggestions`, ({ projectRoot: e }) => ({ enabled: e != null }))),
      (R = h(
        D,
...
function Ve({ completed: e, domain: t, hostId: n, onLocalConversationCreated: r, projectRoot: i }) {
  ...
  let C = async () => {
    if (!(S || e || _ || i == null)) {
      (T(s, w.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, x.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED),
        v(!0));
      try {
        let e = We(h.roles),
...
async function K({
  ...
  let { config: h } = await C(`read-config-for-host`, { hostId: r, includeLayers: !1, cwd: m });
  await i(
