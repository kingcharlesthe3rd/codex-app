...
import { ln as x, un as S } from "./product-logger.js";
import { t as C } from "./persisted-signal.js";
import { t as w } from "./use-service-tier-settings.js";
...
import { c as te } from "./use-permissions-mode-DcMQ-DVc.js";
import { d as O } from "./onboarding-state.js";
import { n as k, r as ne } from "./projectless-thread.js";
import { t as re } from "./setup-codex-wizard-step-view.js";
import { t as ie } from "./check-circle-filled.js";
import { n as A, t as j } from "./recommended-skill-statsig-overrides.js";
var M = e(l(), 1),
  N = 3,
  P = `ambient-suggestions:default-statuses`,
  F = C(P, {}),
  I = f(o, `ambient-suggestions`, ({ projectRoot: e }) => ({ enabled: e != null })),
  L = f(o, `ambient-suggestions-refresh`, ({ hostId: e, plan: t, projectRoot: n }) => ({
    enabled: n != null,
    gcTime: g(t),
  ...
  R = r(o, (e) => null),
  z = i(o, (e, { get: t }) => G(q(t, e))),
  B = i(o, (e, { get: t }) => {
    let n = t(I, e);
    return n.data != null || n.isError;
  }),
  V = i(o, ({ hostId: e, projectRoot: t }, { get: n }) => {
...
function ue({ completed: e, hostId: t, onLocalConversationCreated: n, projectRoot: r }) {
  let i = a(o),
    s = _(),
    { agentMode: c, isAgentModePending: l } = te({
      conversationId: null,
      cwdOverride: r,
      hostId: t,
    }),
    { activeMode: u } = D(null),
    { serviceTierSettings: f } = w(null),
    p = m(O),
    h = A(),
    [g, y] = (0, oe.useState)(!1),
    C = s.formatMessage({
    ...
    E = l || r == null;
  re(S.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, !e);
  let k = async () => {
    if (!(E || e || g || r == null)) {
      (d(i, S.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, x.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED),
        y(!0));
      try {
        let e = pe(p.roles),
          a = j(h, Q)?.replace(/^name:\s*.*$/m, `name: ${le}`);
        (await me({
          ...
          H(i, { hostId: t, projectRoot: r }, Z, `accepted`));
      } catch {
        i.get(ee).danger(
          (0, X.jsx)(v, {
  ...
  return (0, X.jsxs)(`button`, {
    ...
    children: [
      (0, X.jsx)(`span`, {
        ...
        children: (0, X.jsx)(se, { "aria-hidden": !0, className: `size-5 shrink-0` }),
      }),
      (0, X.jsxs)(`span`, {
...
async function de({
  ...
  return (
    ...
    ce.default.join(o.destination, `SKILL.md`)
  );
}
function fe(e) {
...
async function me({
  ...
  let d = [a],
    ...
    m = await k(d, { prompt: o }),
    h = m.cwd ?? a;
  if (f && m.projectlessOutputDirectory == null)
    throw Error(`No projectless output directory found`);
  let { config: g } = await s(`read-config-for-host`, { hostId: r, includeLayers: !1, cwd: h });
  await i(
...
export { B as a, z as c, V as d, I as i, W as l, Z as n, L as o, R as r, U as s, ue as t, H as u };
