...
import { g as r, l as i, o as a, t as o } from "./app-scope.js";
import { i as s, n as c } from "./vscode-api.js";
import { r as l } from "./react.js";
import { xi as u, yr as d } from "./src-4.js";
import {
  $o as f,
  As as p,
  Vo as m,
...
import { c as ee, o as _ } from "./lib-1.js";
import { $t as v, Rr as y, en as b, t as x } from "./persisted-signal.js";
import { t as S } from "./clsx.js";
import { t as C } from "./use-collaboration-mode.js";
import { r as w } from "./toast-signal.js";
import { t as T } from "./check-circle-filled.js";
import { t as E } from "./build-start-conversation-params.js";
import { n as D } from "./skill-utils.js";
import { c as O } from "./use-permissions-mode.js";
import { d as k } from "./onboarding-state.js";
import { t as A } from "./use-service-tier-settings.js";
import { n as j, r as te } from "./projectless-thread.js";
import { t as ne } from "./graduation-cap.js";
import { n as re, t as M } from "./recommended-skill-statsig-overrides.js";
var N = e(f(), 1),
  P = 3,
  F = `ambient-suggestions:default-statuses`,
  I = x(F, {}),
  L = s(o, `ambient-suggestions`, ({ projectRoot: e }) => ({ enabled: e != null })),
  R = s(o, `ambient-suggestions-refresh`, ({ hostId: e, plan: t, projectRoot: n }) => ({
    enabled: n != null,
    gcTime: u(t),
  ...
  z = s(o, `email-domain-mail-provider`, ({ domain: e, enabled: t }) => ({
    enabled: t && e != null,
    params: e == null ? void 0 : { domain: e },
    staleTime: 1 / 0,
  })),
  B = r(o, (e) => null),
  V = i(o, (e, { get: t }) => ie(J(t, e))),
  H = i(o, (e, { get: t }) => {
    let n = t(L, e);
    return n.data != null || n.isError;
  }),
  U = i(o, ({ hostId: e, projectRoot: t }, { get: n }) => {
    let r = n(L, { hostId: e, projectRoot: t }).data?.file;
    return ae(r?.currentSuggestionIds ?? [], r?.suggestions ?? []);
  });
function W(e, t, n, r) {
  let i = q(t);
  e.set(I, (e) => {
...
function ue({ completed: e, hostId: t, onLocalConversationCreated: n, projectRoot: r }) {
  let i = a(o),
    ...
    j = async () => {
      if (!(D || e || h || r == null)) {
        (g(i, b.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, v.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED),
          y(!0));
        try {
          let e = pe(p.roles),
            a = M(m, $)?.replace(/^name:\s*.*$/m, `name: ${ce}`);
          (await me({
            ...
            e != null &&
              g(
                i,
                b.CODEX_ONBOARDING_WIZARD_PHASE_ROLE_PICKER,
                v.CODEX_ONBOARDING_WIZARD_ACTION_SKIPPED,
              ),
            W(i, { hostId: t, projectRoot: r }, Q, `accepted`));
        } catch {
          i.get(w).danger(
            (0, Z.jsx)(_, {
  ...
  return (0, Z.jsxs)(`button`, {
    ...
    children: [
      (0, Z.jsx)(`span`, {
        ...
        children: (0, Z.jsx)(ne, { "aria-hidden": !0, className: `size-5 shrink-0` }),
      }),
      (0, Z.jsxs)(`span`, {
        className: S(`flex w-full min-w-0 flex-col gap-1 text-base`, e && `opacity-30`),
        children: [
          (0, Z.jsx)(`span`, {
...
async function de({
  ...
  return (
    t(),
    await p(`list-skills-for-host`, { forceReload: !0, hostId: e }),
    oe.default.join(o.destination, `SKILL.md`)
  );
}
function fe(e) {
  return D({ name: `Setup Codex`, path: e });
}
function pe(e) {
...
async function me({
  ...
  let c = [a],
    l = te(c),
    u = [{ type: `text`, text: o, text_elements: [] }],
    d = await j(c, { prompt: o }),
    f = d.cwd ?? a;
  if (l && d.projectlessOutputDirectory == null)
    throw Error(`No projectless output directory found`);
  let { config: g } = await p(`read-config-for-host`, { hostId: r, includeLayers: !1, cwd: f });
  await i(
    await p(`start-conversation`, {
      hostId: r,
      ...E({
        additionalDeveloperInstructions: e,
        input: u,
