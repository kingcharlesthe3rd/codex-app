...
import { t as b } from "./build-start-conversation-params.js";
...
var A = e(o(), 1),
  ...
  M = i(j, {}),
  N = g(p, `ambient-suggestions`, ({ projectRoot: e }) => ({ enabled: e != null })),
  P = g(p, `ambient-suggestions-refresh`, ({ hostId: e, plan: n, projectRoot: r }) => ({
    enabled: r != null,
    gcTime: t(n),
...
function re({ completed: e, hostId: t, onLocalConversationCreated: n, projectRoot: r }) {
  let i = h(p),
    a = f(),
  ...
  return (0, X.jsxs)(`button`, {
    ...
    children: [
      (0, X.jsx)(`span`, {
        ...
        children: (0, X.jsx)(Z, { "aria-hidden": !0, className: `size-5 shrink-0` }),
      }),
      (0, X.jsxs)(`span`, {
        className: u(`flex w-full min-w-0 flex-col gap-1 text-base`, e && `opacity-30`),
        children: [
          (0, X.jsx)(`span`, {
...
async function ie({
  ...
  let o = await _(`install-recommended-skill`, {
    params: { hostId: e, installRoot: null, repoPath: n, skillId: i, skillStatsigOverride: a },
  });
...
async function ae({ hostId: e, prompt: t, skillName: n, skillsResponse: i }) {
  if (n == null) return t;
  let a = S(i ?? (await r(`list-skills-for-host`, { forceReload: !0, hostId: e })), n);
...
async function oe({
  ...
  let { config: h } = await r(`read-config-for-host`, { hostId: i, includeLayers: !1, cwd: m });
  await o(
