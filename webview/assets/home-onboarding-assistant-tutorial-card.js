...
import { hi as u, zi as d } from "./thread-context-inputs.js";
import { i as f, n as p } from "./vscode-api.js";
import { r as m } from "./react.js";
import { Rr as h, Ui as g } from "./src-3.js";
...
import { c as te } from "./use-permissions-mode.js";
...
function ue({ completed: e, hostId: t, onLocalConversationCreated: n, projectRoot: r }) {
  ...
  let k = async () => {
    if (!(E || e || g || r == null)) {
      (u(i, S.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, x.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED),
        y(!0));
      try {
        let e = pe(p.roles),
