...
import { Ig as Ce, Lg as we } from "./app-initial~app-main~onboarding-page.js";
import { k as Te, w as Ee } from "./app-initial~app-main~onboarding-page~select-workspace-page.js";
import { n as De, t as Oe } from "./setup-codex-wizard-step-view.js";
import { n as ke, r as Ae, t as je } from "./recommended-skill-statsig-overrides.js";
function j(e, t, n, r) {
  let i = M(t);
  e.set(R, (e) => {
    let a = e ?? {},
...
function M({ domain: e, hostId: t, projectRoot: n }) {
  return e == null ? `${L}:${t}:${N(n)}` : `${L}:${t}:${N(n)}:${e}`;
}
function Fe(e, t) {
  let n = M(t),
    r = e(R)?.[n];
  if (r != null) return r;
  if (t.domain == null) return P(t);
}
function N(e) {
  return e ?? ``;
}
function P(e) {
  return ie(Ie(e), void 0);
}
function Ie({ hostId: e, projectRoot: t }) {
  return `${L}:${e}:${N(t)}`;
}
function Le(e, t) {
  let n = [];
  for (let r of e) {
    let e = (0, F.default)(t, ({ id: e }) => e === r);
    if ((e?.status === `pending` && n.push(e), n.length === I)) break;
  }
  return n;
}
var F,
  ...
  G = e(() => {
    ((F = t(ge(), 1)),
      ...
      r(),
      (I = 3),
      (L = `ambient-suggestions:default-statuses`),
      (R = S(L, {})),
      (z = b(l, `ambient-suggestions`, ({ projectRoot: e }) => ({ enabled: e != null }))),
      (B = b(
        l,
      ...
      (V = d(l, (e) => null)),
      (H = s(l, (e, { get: t }) => Pe(Fe(t, e)))),
      (U = s(l, (e, { get: t }) => {
        let n = t(z, e);
        return n.data != null || n.isError;
      })),
      (W = s(l, ({ domain: e, hostId: t, projectRoot: n }, { get: r }) => {
        let i = r(z, { domain: e, hostId: t, projectRoot: n }).data?.file;
        return Le(i?.currentSuggestionIds ?? [], i?.suggestions ?? []);
      })));
  }),
  K,
  q,
...
function ze({ completed: e, domain: t, hostId: n, onLocalConversationCreated: r, projectRoot: i }) {
  let o = ne(l),
    s = ee(),
    {
      agentMode: c,
    ...
    { activeMode: h } = he(null),
    { serviceTierSettings: g } = pe(null),
    _ = a(Ee),
    v = Ae(),
    [y, b] = (0, Y.useState)(!1),
    S = s.formatMessage({
    ...
    T = d || i == null;
  De(w.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, !e);
  let E = async () => {
    if (!(T || e || y || i == null)) {
      (x(o, w.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, p.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED),
        b(!0));
      try {
        let e = He(_.roles),
          a = je(v, Q)?.replace(/^name:\s*.*$/m, `name: ${$}`);
        (await Ue({
          ...
          e != null &&
            x(
              ...
              p.CODEX_ONBOARDING_WIZARD_ACTION_SKIPPED,
            ),
          j(o, { domain: t, hostId: n, projectRoot: i }, Z, `accepted`));
      } catch {
        o.get(ve).danger(
          (0, X.jsx)(u, {
  ...
  return (0, X.jsxs)(`button`, {
    ...
    children: [
      (0, X.jsx)(`span`, {
        className: k(`flex h-5 shrink-0 items-center`, e && `opacity-30`),
        children: (0, X.jsx)(q, { "aria-hidden": !0, className: `size-5 shrink-0` }),
      }),
      (0, X.jsxs)(`span`, {
        className: k(`flex w-full min-w-0 flex-col gap-1 text-base`, e && `opacity-30`),
        children: [
          (0, X.jsx)(`span`, {
...
async function Be({
  ...
  let o = await c(`install-recommended-skill`, {
    params: {
      forceReinstall: a,
      hostId: e,
      installRoot: null,
  ...
  return (
    t(),
    await T(`list-skills-for-host`, { forceReload: !0, hostId: e }),
    J.default.join(o.destination, `SKILL.md`)
  );
}
function Ve(e) {
  return oe({ name: `Setup Codex`, path: e });
}
function He(e) {
...
async function Ue({
  ...
  let u = [o],
    ...
    p = await se(u, { prompt: s }),
    h = p.cwd ?? o;
  if (d && p.projectlessOutputDirectory == null)
    throw Error(`No projectless output directory found`);
  let { config: g } = await T(`read-config-for-host`, { hostId: r, includeLayers: !1, cwd: h });
  await i(
    await T(`start-conversation`, {
      hostId: r,
      ...Ce({
        additionalDeveloperInstructions: e,
        input: f,
...
var J,
  ...
  Ge = e(() => {
    ((J = t(ce(), 1)),
      ...
      (Q = `onboard-new-user`),
      ($ = `setup-codex`),
      (We = `skills/.curated/onboard-new-user`));
  });
export {
  z as a,
  Me as c,
