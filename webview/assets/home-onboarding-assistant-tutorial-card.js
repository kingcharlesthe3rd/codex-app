...
import { Ho as s, Yi as c, _a as l, es as u, js as d } from "./app-server-manager-signals.js";
import { i as f, n as p } from "./vscode-api.js";
import { r as m } from "./react.js";
import { _i as h, fr as g } from "./src-1.js";
import { c as ee, o as _ } from "./lib.js";
import { $t as v, Br as y, Qt as b, t as x } from "./persisted-signal.js";
...
import { c as k } from "./use-permissions-mode.js";
import { d as A } from "./onboarding-state.js";
import { n as j, r as te } from "./projectless-thread.js";
import { t as ne } from "./graduation-cap-BNP-MRaD.js";
...
var N = e(u(), 1),
  ...
  z = f(o, `email-domain-mail-provider`, ({ domain: e, enabled: t }) => ({
    enabled: t && e != null,
...
function ue({ completed: e, hostId: t, onLocalConversationCreated: n, projectRoot: r }) {
  let i = a(o),
    s = ee(),
    { agentMode: l, isAgentModePending: u } = k({
      conversationId: null,
      cwdOverride: r,
      hostId: t,
    }),
    ...
    j = async () => {
      if (!(O || e || g || r == null)) {
        (c(i, v.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, b.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED),
          y(!0));
        try {
          let e = pe(p.roles),
            a = M(h, $)?.replace(/^name:\s*.*$/m, `name: ${ce}`);
          (await me({
            ...
            e != null &&
              c(
                i,
                v.CODEX_ONBOARDING_WIZARD_PHASE_ROLE_PICKER,
                b.CODEX_ONBOARDING_WIZARD_ACTION_SKIPPED,
              ),
...
async function de({
  ...
  return (
    t(),
    await d(`list-skills-for-host`, { forceReload: !0, hostId: e }),
    oe.default.join(o.destination, `SKILL.md`)
  );
}
function fe(e) {
  return O({ name: `Setup Codex`, path: e });
}
function pe(e) {
...
async function me({
  ...
  let u = [a],
    ...
    m = await j(u, { prompt: o }),
    h = m.cwd ?? a;
  if (f && m.projectlessOutputDirectory == null)
    throw Error(`No projectless output directory found`);
  let { config: g } = await d(`read-config-for-host`, { hostId: r, includeLayers: !1, cwd: h });
  await i(
    await d(`start-conversation`, {
      hostId: r,
      ...D({
        additionalDeveloperInstructions: e,
        input: p,
