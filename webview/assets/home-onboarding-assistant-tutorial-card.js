...
var N,
  ...
  U = e(() => {
    ((N = t(se(), 1)),
      ...
      (I = fe(F, {})),
      (L = g(r, `ambient-suggestions`, ({ projectRoot: e }) => ({ enabled: e != null }))),
      (R = g(
        r,
...
function Ve({ completed: e, domain: t, hostId: n, onLocalConversationCreated: i, projectRoot: a }) {
  let c = s(r),
    l = le(),
    {
      agentMode: u,
  ...
  let w = async () => {
    if (!(C || e || v || a == null)) {
      (E(c, T.CODEX_ONBOARDING_WIZARD_PHASE_LAUNCH, D.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED),
        y(!0));
      try {
        let e = We(g.roles),
...
async function K({
  ...
  let { config: h } = await O(`read-config-for-host`, { hostId: r, includeLayers: !1, cwd: m });
  await i(
