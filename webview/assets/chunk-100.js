...
function Ge() {
  ...
  let y,
    ...
    x = We();
  t.isSupported =
    typeof d == `function` && typeof ve == `function` && Me && Me.createHTMLDocument !== void 0;
  let {
      MUSTACHE_EXPR: ze,
      ERB_EXPR: S,
      TMPLIT_EXPR: Ke,
    ...
    bt = function () {
      ...
      if (!(J && J === e)) {
        if (
          ...
          (ht = h(e, `ALLOWED_NAMESPACES`) ? v({}, e.ALLOWED_NAMESPACES, fe) : U),
          (L = h(e, `ADD_URI_SAFE_ATTR`) ? v(b(R), e.ADD_URI_SAFE_ATTR, q) : R),
          (ft = h(e, `ADD_DATA_URI_TAGS`) ? v(b(pt), e.ADD_DATA_URI_TAGS, q) : pt),
          ...
          e.FORBID_CONTENTS && (I === dt && (I = b(I)), v(I, e.FORBID_CONTENTS, q)),
          e.ADD_FORBID_CONTENTS && (I === dt && (I = b(I)), v(I, e.ADD_FORBID_CONTENTS, q)),
          ut && (w[`#text`] = !0),
          ...
          : e.namespaceURI === mt
            ? t.namespaceURI === B
              ...
              : t.namespaceURI === z
                ...
                : !!St[n]
            : e.namespaceURI === B
              ? (t.namespaceURI === z && !G[r]) || (t.namespaceURI === mt && !W[r])
                ? !1
                : !St[n] && (gt[n] || !xt[n])
  ...
  let Ot = function (e) {
      ...
      if (
        ...
        return (Y(e), !0);
      if (!(A.tagCheck instanceof Function && A.tagCheck(r)) && (!w[r] || O[r])) {
        if (
          !O[r] &&
          kt(r) &&
    ...
    Q = function (e, t, r) {
      if (k[t] || (ct && (t === `id` || t === `name`) && (r in n || r in vt))) return !1;
      if (
        !(et && !k[t] && g(qe, t)) &&
        !($e && g(Je, t)) &&
          ...
          if (
            !(
              (kt(e) &&
                ...
                ((D.attributeNameCheck instanceof RegExp && g(D.attributeNameCheck, t)) ||
    ...
    At = function (e) {
      ...
      for (; i--; ) {
        ...
        if (
          ...
          (u = r.attrValue),
          lt && (c === `id` || c === `name`) && (X(a, e), (u = `user-content-` + u)),
          rt &&
            g(
        ...
        if (y && typeof ne == `object` && typeof ne.getAttributeType == `function` && !o)
        ...
        if (u !== l)
          try {
            (o ? e.setAttributeNS(o, a, u) : e.setAttribute(a, u), Et(e) ? Y(e) : ce(t.removed));
          } catch {
            X(a, e);
          }
      }
  ...
  return (
    (t.sanitize = function (e) {
      ...
      if ((it || bt(n), (t.removed = []), typeof e == `string` && (P = !1), P)) {
        if (e.nodeName) {
          let t = q(e.nodeName);
          if (!w[t] || O[t]) throw _e(`root node is forbidden and cannot be sanitized in-place`);
        }
      } else if (e instanceof s)
        ((i = wt(`<!---->`)),
          (o = i.ownerDocument.importNode(e, !0)),
          (o.nodeType === Ve.element && o.nodeName === `BODY`) || o.nodeName === `HTML`
            ? (i = o)
            : i.appendChild(o));
      else {
        if (!N && !j && !M && e.indexOf(`<`) === -1) return y && st ? y.createHTML(e) : e;
        if (((i = wt(e)), !i)) return N ? null : st ? je : ``;
      }
      i && at && Y(i.firstChild);
      let u = Tt(P ? e : i);
      for (; (c = u.nextNode()); ) (Ot(c), At(c), c.content instanceof a && jt(c.content));
      if (P) return e;
      if (N) {
        if (ot) for (l = Pe.call(i.ownerDocument); i.firstChild; ) l.appendChild(i.firstChild);
        else l = i;
        return ((T.shadowroot || T.shadowrootmode) && (l = Le.call(r, l, !0)), l);
      }
...
` +
    ...
    (t.setConfig = function () {
      (bt(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}), (it = !0));
    }),
...
`,
  ...
  D = `#ffffff`,
  O = `#f2f2f2`,
  k = c((e, t) => (t ? n(e, { s: -40, l: 10 }) : n(e, { s: -40, l: -10 })), `mkBorder`),
  A = class {
    static {
      c(this, `Theme`);
    }
    ...
    updateColors() {
      if (
        ...
        (this.secondaryColor = this.secondaryColor || n(this.primaryColor, { h: -120 })),
        (this.tertiaryColor = this.tertiaryColor || n(this.primaryColor, { h: 180, l: 5 })),
        (this.primaryBorderColor = this.primaryBorderColor || k(this.primaryColor, this.darkMode)),
        ...
        (this.noteBorderColor = this.noteBorderColor || k(this.noteBkgColor, this.darkMode)),
        (this.noteBkgColor = this.noteBkgColor || `#fff5ad`),
        (this.noteTextColor = this.noteTextColor || `#333`),
        (this.secondaryTextColor = this.secondaryTextColor || o(this.secondaryColor)),
        (this.tertiaryTextColor = this.tertiaryTextColor || o(this.tertiaryColor)),
        ...
        (this.activationBorderColor = this.activationBorderColor || i(this.secondaryColor, 10)),
        (this.activationBkgColor = this.activationBkgColor || this.secondaryColor),
        (this.sequenceNumberColor = this.sequenceNumberColor || o(this.lineColor)),
        ...
        (this.activeTaskBkgColor = this.activeTaskBkgColor || t(this.primaryColor, 23)),
        ...
        (this.cScale8 = this.cScale8 || n(this.primaryColor, { h: 210, l: 150 })),
      ...
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        this.darkMode
          ? (this[`cScalePeer` + e] = this[`cScalePeer` + e] || t(this[`cScale` + e], 10))
          : (this[`cScalePeer` + e] = this[`cScalePeer` + e] || i(this[`cScale` + e], 10));
      ...
      for (let t = 0; t < 5; t++)
        ((this[`surface` + t] =
          this[`surface` + t] || n(this.mainBkg, { h: 180, s: -15, l: e * (5 + t * 3) })),
          (this[`surfacePeer` + t] =
            this[`surfacePeer` + t] || n(this.mainBkg, { h: 180, s: -15, l: e * (8 + t * 3) })));
      ((this.classText = this.classText || this.textColor),
        ...
        (this.quadrant2Fill = this.quadrant2Fill || n(this.primaryColor, { r: 5, g: 5, b: 5 })),
        (this.quadrant3Fill = this.quadrant3Fill || n(this.primaryColor, { r: 10, g: 10, b: 10 })),
        (this.quadrant4Fill = this.quadrant4Fill || n(this.primaryColor, { r: 15, g: 15, b: 15 })),
        (this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor),
        (this.quadrant2TextFill =
          this.quadrant2TextFill || n(this.primaryTextColor, { r: -5, g: -5, b: -5 })),
        (this.quadrant3TextFill =
          this.quadrant3TextFill || n(this.primaryTextColor, { r: -10, g: -10, b: -10 })),
        (this.quadrant4TextFill =
          this.quadrant4TextFill || n(this.primaryTextColor, { r: -15, g: -15, b: -15 })),
        ...
        (this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || D),
        (this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || O),
  ...
  et = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] =
          this[`surface` + e] || n(this.mainBkg, { h: 30, s: -30, l: -(-10 + e * 4) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || n(this.mainBkg, { h: 30, s: -30, l: -(-7 + e * 4) })));
      ...
      ((this.pieTitleTextSize = this.pieTitleTextSize || `25px`),
        ...
        (this.pieOpacity = this.pieOpacity || `0.7`));
      for (let e = 0; e < 8; e++)
        this[`venn` + (e + 1)] = this[`venn` + (e + 1)] ?? t(this[`cScale` + e], 30);
      ((this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor),
        (this.vennSetTextColor = this.vennSetTextColor ?? this.textColor),
        (this.quadrant1Fill = this.quadrant1Fill || this.primaryColor),
        (this.quadrant2Fill = this.quadrant2Fill || n(this.primaryColor, { r: 5, g: 5, b: 5 })),
    ...
    updateColors() {
      ...
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        ((this[`cScale` + e] = i(this[`cScale` + e], 10)),
          (this[`cScalePeer` + e] = this[`cScalePeer` + e] || i(this[`cScale` + e], 25)));
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        this[`cScaleInv` + e] = this[`cScaleInv` + e] || n(this[`cScale` + e], { h: 180 });
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] = this[`surface` + e] || n(this.mainBkg, { h: 30, l: -(5 + e * 5) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || n(this.mainBkg, { h: 30, l: -(7 + e * 5) })));
      if (
        ((this.scaleLabelColor =
  ...
  rt = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] =
          this[`surface` + e] || n(this.mainBkg, { h: 30, s: -30, l: -(5 + e * 5) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || n(this.mainBkg, { h: 30, s: -30, l: -(8 + e * 5) })));
      ((this.nodeBkg = this.mainBkg),
        (this.nodeBorder = this.border1),
        (this.clusterBkg = this.secondBkg),
        (this.clusterBorder = this.border2),
  ...
  it = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < this.THEME_COLOR_LIMIT; e++)
        this[`cScaleLabel` + e] = this[`cScaleLabel` + e] || this.scaleLabelColor;
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] = this[`surface` + e] || n(this.mainBkg, { l: -(5 + e * 5) })),
          (this[`surfacePeer` + e] =
  ...
  N = class {
    ...
    updateColors() {
      ...
      for (let e = 0; e < 5; e++)
        ((this[`surface` + e] =
          this[`surface` + e] || n(this.mainBkg, { h: 180, s: -15, l: c * (5 + e * 3) })),
          (this[`surfacePeer` + e] =
            this[`surfacePeer` + e] || n(this.mainBkg, { h: 180, s: -15, l: c * (8 + e * 3) })));
      ((this.classText = this.classText || this.textColor),
        ...
        (this.quadrant3Fill = this.quadrant3Fill || n(e, { r: 10, g: 10, b: 10 })),
        (this.quadrant4Fill = this.quadrant4Fill || n(e, { r: 15, g: 15, b: 15 })),
        (this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor),
        (this.quadrant2TextFill =
          this.quadrant2TextFill || n(this.primaryTextColor, { r: -5, g: -5, b: -5 })),
        (this.quadrant3TextFill =
  ...
  V = mt,
  H = c((e) => {
    if ((l.debug(`sanitizeDirective called with`, e), !(typeof e != `object` || !e))) {
      if (Array.isArray(e)) {
        e.forEach((e) => H(e));
        return;
      }
      for (let t of Object.keys(e)) {
        ...
        for (let n of [`themeCSS`, `fontFamily`, `altFontFamily`])
          t.includes(n) && (l.debug(`sanitizing css option`, t), (e[t] = ht(e[t])));
      }
      if (e.themeVariables)
  ...
  q = c((e, t) => {
    ...
    if (((n = E(n, r)), r.theme && r.theme in L)) {
      ...
      n.theme && n.theme in L && (n.themeVariables = L[n.theme].getThemeVariables(e));
    }
  ...
  J = c(
    (e) => (
      (G = E({}, U)),
      (G = E(G, e)),
      e.theme && L[e.theme] && (G.themeVariables = L[e.theme].getThemeVariables(e.themeVariables)),
      q(G, K),
      G
    ),
    `setSiteConfig`,
  ...
  Ct = c((e) => {
    e &&
      ([`secure`, ...(G.secure ?? [])].forEach((t) => {
        Object.hasOwn(e, t) &&
          (l.debug(`Denied attempt to modify a secure key ${t}`, e[t]), delete e[t]);
      }),
  ...
  Dt = c((e) => {
    e && (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) && Et(`LAZY_LOAD_DEPRECATED`);
  }, `checkConfig`),
  Z = c(() => {
    let e = {};
    gt && (e = E(e, gt));
...
var Mt = c((e) => (At(), S.sanitize(e)), `removeScript`),
  ...
  Xt = c(async (t, n) => {
      ...
      return t.replace(qt, `MathML is unsupported in this environment.`);
    {
      let { default: r } = await e(
          async () => {
            let { default: e } = await import(`./katex-DZmv-8PO.js`);
            return { default: e };
          },
          __vite__mapDeps([0, 1]),
          import.meta.url,
        ),
        i = n.forceLegacyMathML || (!Kt() && n.legacyMathML) ? `htmlAndMathml` : `mathml`;
      return t
        .split(Q)
        .map((e) =>
          Jt(e)
  ...
  an = c((e, t, n, r) => {
    let i = ``;
    return (
      e in rn && rn[e] ? (i = rn[e]({ ...n, svgId: r })) : l.warn(`No theme found for ${e}`),
      ` & {
