...
import { as as a, is as o, os as s, rs as c } from "./app-server-manager-signals.js";
...
import { r as g } from "./product-logger.js";
import { u as _ } from "./statsig.js";
import { _ as v, p as y, u as b, x } from "./codex-api-B.js";
...
import { t as E } from "./codex.js";
import { t as D } from "./app.js";
import { t as O } from "./check-lg.js";
var k = `` + new URL(`referral-modal-background-DumA0TET.png`, import.meta.url).href,
  A = h(),
  j = e(l(), 1),
  M = u(),
  N = 3,
...
function V(e) {
  ...
  let q = [...x.map((e) => _e.find((t) => t.id === e)).filter(W), ..._e.filter(ve)],
    J = q.length > 1,
    Y = q.slice(0, P),
    ye = Y.find((e) => e.id === m) ?? Y[0],
    X = Y.find((e) => e.id === g && e.id !== ye?.id) ?? Y.find((e) => e.id !== ye?.id),
    be = [
      ye,
      X,
    ...
    De = (e) => {
      l !== `collapsing` ||
        E.current.has(e) ||
        (E.current.add(e),
        E.current.size === Y.length - N && (S(D.current), u(null), w(new Set(E.current)), p(!1)));
    },
    Oe;
  ...
  let ke = (e) => {
    ...
    je = (e) => {
      ...
      if (
        (!t.dragged &&
          Math.abs(n) > oe &&
          ((t.dragged = !0), (he.current = !0), e.currentTarget.setPointerCapture(e.pointerId)),
        t.dragged)
      ) {
  ...
  t[6] === Pe
    ? (Fe = t[7])
    : ((Fe = d(`relative z-10 overflow-hidden pt-2 pb-10`, Pe)), (t[6] = Pe), (t[7] = Fe));
  let Ie, Q;
  ...
  let Le = Z.map((e) => {
      ...
      return (0, M.jsx)(
        C.div,
        {
            ...
            a && ie
              ...
              : s
                ? {
                    ...
                    duration: 0.4,
                    ease: [0.23, 1, 0.32, 1],
                    opacity: { duration: 0.14, delay: Math.max(t - N, 0) * 0.012 },
                  }
                : {
                    type: `spring`,
                    stiffness: a ? 260 : 330,
                    ...
                    opacity: {
                      duration: 0.18,
                      delay: a ? Math.max(t - N, 0) * 0.018 : o ? (Y.length - t - 1) * 0.014 : 0,
                    },
                    ...(c
                      ? {
          ...
          style: { zIndex: a ? P - t : r === 0 ? 30 : r === 1 ? 20 : r === 2 ? 10 : 9 - t },
          onAnimationComplete: () => {
  ...
  t[10] === Le
    ? (Re = t[11])
    : ((Re = (0, M.jsx)(`div`, { className: `grid min-w-full select-none`, children: Le })),
      (t[10] = Le),
      (t[11] = Re));
  let ze;
  return (
...
function de(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = { type: `spring`, stiffness: 520, damping: 34, mass: 0.7 }), (t[5] = ee))
    : (ee = t[5]);
  ...
  let b;
  t[13] !== v || t[14] !== y
    ? ((b = (0, M.jsxs)(`div`, { className: `flex min-w-0 items-center gap-2`, children: [v, y] })),
      (t[13] = v),
      (t[14] = y),
      (t[15] = b))
    : (b = t[15]);
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, M.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, M.jsx)(E, { className: `size-4 text-token-text-secondary opacity-70` }),
        ],
      })),
      (t[16] = x))
    : (x = t[16]);
...
function K(e) {
  ...
  if (h) {
    ...
    (t[6] === _
      ? (e = t[7])
      : ((e = (0, M.jsx)(V, { credits: _, onSelectedCreditIdChange: d })), (t[6] = _), (t[7] = e)),
      (C = e));
  }
  let T;
  t[8] === o
  ...
  let D;
  t[12] !== l || t[13] !== E
    ? ((D = { "aria-describedby": l, onEscapeKeyDown: E }), (t[12] = l), (t[13] = E), (t[14] = D))
    : (D = t[14]);
  let O;
...
function he(e) {
  ...
  let p;
  t[4] !== l || t[5] !== d
    ? ((p = { "aria-describedby": l, onEscapeKeyDown: d }), (t[4] = l), (t[5] = d), (t[6] = p))
    : (p = t[6]);
  let m;
  t[7] === s
    ? (m = t[8])
...
function q(e) {
  let t = (0, A.c)(5),
    ...
    i = null;
  if ((r === `workspace` ? (i = _e) : r === `personal` && (i = ge), i == null)) {
    let n;
    return (
      t[0] === e
        ? (n = t[1])
        : ((n = (0, M.jsx)(Y, { ...e, componentType: ve })), (t[0] = e), (t[1] = n)),
      n
    );
  }
  let a;
  return (
    t[2] !== i || t[3] !== e
      ? ((a = (0, M.jsx)(J, { ...e, layerName: i })), (t[2] = i), (t[3] = e), (t[4] = a))
      : (a = t[4]),
    a
  );
}
function J(e) {
  ...
  return (
    t[3] !== i || t[4] !== r
      ? ((a = (0, M.jsx)(Y, { ...r, componentType: i })), (t[3] = i), (t[4] = r), (t[5] = a))
      : (a = t[5]),
    a
  );
}
function Y(e) {
  ...
  let m = p,
    h;
  t[3] !== d || t[4] !== r || t[5] !== s || t[6] !== f || t[7] !== a || t[8] !== o || t[9] !== c
    ? ((h = async (e, t) => {
  ...
  if (n !== `card_stack`) {
    ...
    let a;
    return (
      t[13] !== l || t[14] !== m || t[15] !== f || t[16] !== e || t[17] !== n || t[18] !== i
        ? ((a = (0, M.jsx)(he, {
            availableCount: e,
            errorMessage: l,
            isResetDisabled: n,
  ...
  let _;
  return (
    t[20] !== l || t[21] !== m || t[22] !== g || t[23] !== r || t[24] !== i || t[25] !== f
      ? ((_ = (0, M.jsx)(K, {
          errorMessage: l,
          initialAvailableCount: r,
          isRateLimitReached: i,
...
var be = (e) =>
  ...
  we = 5,
  Te = t({
    detail: n([i(), t({ message: i().optional(), failed_emails: r(i()).optional() })]).optional(),
  });
function Ee(e) {
  let t = (0, A.c)(241),
    {
    ...
    [x, C] = (0, j.useState)(``),
    re;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((re = []), (t[0] = re)) : (re = t[0]);
  let [E, k] = (0, j.useState)(re),
    N;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((N = []), (t[1] = N)) : (N = t[1]);
  ...
  t[22] === Te
    ...
    : ((Ee = () => {
      ...
      (t[23] = Ee));
  let Q;
  (t[24] === Symbol.for(`react.memo_cache_sentinel`) ? ((Q = []), (t[24] = Q)) : (Q = t[24]),
    (0, j.useEffect)(Ee, Q));
  let ze;
  t[25] !== U || t[26] !== X || t[27] !== r
    ? ((ze = () => {
        U || (X({ action: c.CODEX_REFERRAL_INVITE_MODAL_ACTION_CLOSE_CLICKED }), r());
      }),
      (t[25] = U),
      (t[26] = X),
      (t[27] = r),
  ...
  t[43] !== l
    ? ((Je = async () => {
        ...
        let n = t.filter(Oe);
        if (n.length > 0) {
          (F(n), R({ type: `error`, message: Ve(n, u), reason: `invalidEmails` }));
          return;
        }
        (X({ action: c.CODEX_REFERRAL_INVITE_MODAL_ACTION_SEND_CLICKED, emailCount: t.length }),
          ae(`submitting`));
        try {
          ...
          (ae(`idle`),
            ...
            R({ type: `error`, message: He(r, u, n?.message), reason: `failedInvite` }));
        }
      }),
      (t[36] = $),
      (t[37] = x),
  ...
  t[66] === ct
    ? (lt = t[67])
    : ((lt = d(Z.backdrop, `pointer-events-none absolute inset-0 z-0 bg-white`, ct)),
      (t[66] = ct),
      (t[67] = lt));
  let ut;
  ...
  t[125] === _
    ? (Bt = t[126])
    : ((Bt = (0, M.jsx)(`label`, { className: `sr-only`, htmlFor: _, children: zt })),
      (t[125] = _),
      (t[126] = Bt));
  let Vt =
      ue &&
  ...
  t[127] === Vt
    ...
    : ((Ht = d(
      ...
      (t[128] = Ht));
  let Ut;
  if (t[129] !== E || t[130] !== _e || t[131] !== u || t[132] !== W || t[133] !== qe) {
    let e;
            ...
            `span`,
            {
              ...
              children: [
                ...
                (0, M.jsx)(`button`, {
                  ...
                  type: `button`,
                  children: (0, M.jsx)(te, { className: `size-3.5 stroke-[2.4]` }),
                }),
              ],
            },
            e,
  ...
  t[160] !== ue || t[161] !== Ht || t[162] !== Ut || t[163] !== Kt
    ? ((qt = (0, M.jsxs)(`div`, { "aria-invalid": ue, className: Ht, children: [Ut, Kt] })),
      (t[160] = ue),
      (t[161] = Ht),
      (t[162] = Ut),
      (t[163] = Kt),
        ...
        me == null
          ...
          : (0, M.jsx)(`p`, {
              ...
              className: d(
                ...
                ue ? `text-token-error-foreground` : `text-[var(--referral-modal-secondary)]`,
              ),
              id: fe,
              children: me,
            })),
  ...
  t[195] === L?.type
    ? (dn = t[196])
    : ((dn = L?.type === `success` ? (0, M.jsx)(Fe, {}) : null), (t[195] = L?.type), (t[196] = dn));
  let fn;
  t[197] !== un || t[198] !== dn
  ...
  let wn;
  t[219] !== xn || t[220] !== Sn
    ? ((wn = (0, M.jsx)(S, { className: xn, onClick: Sn, type: `button`, children: Cn })),
      (t[219] = xn),
      (t[220] = Sn),
      (t[221] = wn))
    : (wn = t[221]);
...
function We({ hasBackendDetail: e, message: t, status: n }) {
  ...
  return { errorResponsibility: $(r), errorType: r, hasBackendDetail: e, httpStatus: n };
}
