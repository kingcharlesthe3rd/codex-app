...
import { R as r, s as i } from "./app-scope.js";
import { c as a } from "./vscode-api.js";
import { Ki as o, Vi as s, ki as c, qi as l } from "./src-4.js";
import { c as ee, o as u } from "./lib-1.js";
import { In as d, Ln as f, Rn as p, c as te, zn as ne } from "./persisted-signal.js";
import { t as m } from "./clsx.js";
import { t as re } from "./button.js";
import { S as ie, _ as ae, p as oe } from "./codex-api.js";
import { t as se } from "./x.js";
import { d as ce, l as le, u as ue } from "./dialog-layout.js";
...
var he = `` + new URL(`gradient-DoN1ti1h.png`, import.meta.url).href,
  h = e(t()),
  g = n(),
  ge = (e) =>
    (0, g.jsxs)(`svg`, {
  ...
  _ = {
    mark: `_mark_bkwbb_1`,
    markSuccess: `_markSuccess_bkwbb_5`,
    render: `_render_bkwbb_10`,
    markSubmitting: `_markSubmitting_bkwbb_14`,
    referralModalSubmittingHover: `_referralModalSubmittingHover_bkwbb_1`,
    renderSubmitting: `_renderSubmitting_bkwbb_18`,
    referralModalSubmittingTilt: `_referralModalSubmittingTilt_bkwbb_1`,
    markSendAnimating: `_markSendAnimating_bkwbb_22`,
    referralModalMarkSend: `_referralModalMarkSend_bkwbb_1`,
    renderSendAnimating: `_renderSendAnimating_bkwbb_26`,
    referralModalRenderSend: `_referralModalRenderSend_bkwbb_1`,
    backdrop: `_backdrop_bkwbb_30`,
    backdropSuccess: `_backdropSuccess_bkwbb_34`,
    backdropImage: `_backdropImage_bkwbb_38`,
    backdropImageExpanded: `_backdropImageExpanded_bkwbb_47`,
    successBackdrop: `_successBackdrop_bkwbb_51`,
    successBackdropVisible: `_successBackdropVisible_bkwbb_56`,
    form: `_form_bkwbb_60`,
    formHidden: `_formHidden_bkwbb_68`,
    optionalRows: `_optionalRows_bkwbb_75`,
    optionalRowsHidden: `_optionalRowsHidden_bkwbb_84`,
    optionalRowsContent: `_optionalRowsContent_bkwbb_89`,
    consentRow: `_consentRow_bkwbb_100`,
    consentRowVisible: `_consentRowVisible_bkwbb_115`,
    consentRowContent: `_consentRowContent_bkwbb_124`,
    successPanel: `_successPanel_bkwbb_129`,
    successPanelVisible: `_successPanelVisible_bkwbb_137`,
    successIcon: `_successIcon_bkwbb_145`,
    successTitle: `_successTitle_bkwbb_146`,
    successDescription: `_successDescription_bkwbb_147`,
    successButton: `_successButton_bkwbb_148`,
    successIconVisible: `_successIconVisible_bkwbb_160`,
    successTitleVisible: `_successTitleVisible_bkwbb_161`,
    successDescriptionVisible: `_successDescriptionVisible_bkwbb_162`,
    successButtonVisible: `_successButtonVisible_bkwbb_163`,
    referralModalReducedMarkSend: `_referralModalReducedMarkSend_bkwbb_1`,
    referralModalReducedRenderSend: `_referralModalReducedRenderSend_bkwbb_1`,
  },
  v = r(),
  _e = /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
  ve = 100,
  ...
  be = 5,
  xe = s({
    detail: l([o(), s({ message: o().optional(), failed_emails: c(o()).optional() })]).optional(),
  });
function y(e) {
  let t = (0, v.c)(252),
    {
    ...
    { data: p } = oe(),
    _e;
  t[0] === c ? (_e = t[1]) : ((_e = { referralKey: c }), (t[0] = c), (t[1] = _e));
  let { data: xe } = ie(_e),
    y = (0, h.useId)(),
    b = (0, h.useId)(),
    x = (0, h.useId)(),
    [S, Be] = (0, h.useState)(``),
    Ve;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((Ve = []), (t[2] = Ve)) : (Ve = t[2]);
  let [C, He] = (0, h.useState)(Ve),
    Ue;
  t[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((Ue = []), (t[3] = Ue)) : (Ue = t[3]);
  let [We, Ge] = (0, h.useState)(Ue),
    [Ke, qe] = (0, h.useState)(!1),
    [Je, Ye] = (0, h.useState)(`idle`),
    [w, T] = (0, h.useState)(null),
    Xe = ae(),
    Ze;
  t[4] === S ? (Ze = t[5]) : ((Ze = S.trim()), (t[4] = S), (t[5] = Ze));
  let Qe = Ze.length > 0,
    $e = C.length > 0,
    E = !(C.length < be),
    D = Xe.isPending || Je === `submitting`,
    O = Je === `sendAnimation`,
    k = Je === `success`,
    A = D || O,
    j = A || k,
    et = D || O || k,
    M = w?.type === `error`,
    tt = w?.type === `error` && w.reason === `maxEmails`,
    nt = `${y}-status`,
    rt;
  t[6] === p?.structure
    ? (rt = t[7])
    : ((rt = p?.structure?.toLowerCase()), (t[6] = p?.structure), (t[7] = rt));
  let N = rt === `personal`,
    it;
  t[8] !== E || t[9] !== l || t[10] !== w || t[11] !== N
    ? ((it = w?.type === `error` ? w.message : E ? Ie(l, N) : null),
      (t[8] = E),
      (t[9] = l),
      (t[10] = w),
      (t[11] = N),
    ...
    : (it = t[12]);
  let at = it,
    ot = at == null ? void 0 : nt,
    st;
  t[13] === We ? (st = t[14]) : ((st = new Set(We)), (t[13] = We), (t[14] = st));
  let ct = st,
    lt = xe?.requires_explicit_confirmation !== !1,
    ut = C.length > 0 && C.every(Oe),
    dt = lt && ut,
    ft = xe != null && xe.rules.length > 0,
    pt;
  t[15] === s ? (pt = t[16]) : ((pt = Pe(s)), (t[15] = s), (t[16] = pt));
  let P = pt,
    F = n ?? (P === `rateLimitReset` ? ye : ve),
    mt = F * 2,
    ht;
  t[17] !== f || t[18] !== o || t[19] !== c || t[20] !== P
    ? ((ht = (e) => {
        f.logProductEvent(ne, {
          ...e,
  ...
  t[22] === I
    ? (gt = t[23])
    : ((gt = () => {
        I({ action: d.CODEX_REFERRAL_INVITE_MODAL_ACTION_SHOWN });
      }),
      (t[22] = I),
      (t[23] = gt));
  let _t = (0, h.useEffectEvent)(gt),
    vt;
  t[24] === _t
    ? (vt = t[25])
    : ((vt = () => {
      ...
      (t[25] = vt));
  let yt;
  (t[26] === Symbol.for(`react.memo_cache_sentinel`) ? ((yt = []), (t[26] = yt)) : (yt = t[26]),
    (0, h.useEffect)(vt, yt));
  let bt;
  t[27] !== A || t[28] !== I || t[29] !== r
    ? ((bt = () => {
        A || (I({ action: d.CODEX_REFERRAL_INVITE_MODAL_ACTION_CLOSE_CLICKED }), r());
      }),
      (t[27] = A),
      (t[28] = I),
      (t[29] = r),
  ...
  let L = bt,
    xt;
  t[31] !== C || t[32] !== l || t[33] !== N
    ? ((xt = (e) => {
        let t = Fe(e);
        if (t.length === 0) return { blockedByLimit: !1, emails: C };
        let n = new Set(C.map(De)),
          r = t.filter((e) => {
            let t = e.toLowerCase();
        ...
        return (
          ...
          Ge(c),
          c.length > 0
            ? T({ type: `error`, message: Le(c, l), reason: `invalidEmails` })
            : o.length > 0
              ? T({ type: `error`, message: Ie(l, N), reason: `maxEmails` })
              : T(null),
  ...
  t[35] !== C || t[36] !== l
    ? ((St = (e) => {
        ...
        (He(t),
          ...
          Ge(n),
          n.length > 0
            ? T({ type: `error`, message: Le(n, l), reason: `invalidEmails` })
            : T(null));
      }),
      (t[35] = C),
      (t[36] = l),
  ...
  t[47] !== lt
    ? ((Ct = async () => {
        if (lt && !Ke) return;
        (T(null), Ge([]));
        let e = Qe ? R(S) : { blockedByLimit: !1, emails: C };
        if (e.blockedByLimit) return;
        let t = e.emails;
        if (t.length === 0) return;
        let n = t.filter(we);
        if (n.length > 0) {
          (Ge(n), T({ type: `error`, message: Le(n, l), reason: `invalidEmails` }));
          return;
        }
        (I({ action: d.CODEX_REFERRAL_INVITE_MODAL_ACTION_SEND_CLICKED, emailCount: t.length }),
          Ye(`submitting`));
        try {
          let e = await Xe.mutateAsync({ emails: t, referralKey: c });
          (I({
            action: d.CODEX_REFERRAL_INVITE_MODAL_ACTION_SEND_SUCCEEDED,
            emailCount: e.invites.length,
          }),
            T({ type: `success`, emails: e.invites.map(Ce) }),
            Ye(`sendAnimation`));
        } catch (e) {
          let n = ze(e),
          ...
          (Ye(`idle`),
            ...
            n != null &&
              I({
                action: d.CODEX_REFERRAL_INVITE_MODAL_ACTION_BACKEND_ERROR,
                emailCount: t.length,
            ...
            T({ type: `error`, message: Re(r, l, n?.message), reason: `failedInvite` }));
        }
      }),
      (t[38] = R),
      (t[39] = S),
  ...
  let B = Ct,
    wt;
  t[49] !== R || t[50] !== S || t[51] !== C || t[52] !== B || t[53] !== z
    ? ((wt = (e) => {
        if (e.key === `Enter`) {
          if ((e.preventDefault(), Fe(S).length === 0)) {
            B();
            return;
          }
          R(S);
  ...
  t[55] === R
    ...
    : ((Et = (e) => {
        ...
        Fe(t).length <= 1 || (e.preventDefault(), R(t));
      }),
      (t[55] = R),
      (t[56] = Et));
  let Dt = Et,
  ...
  let U;
  t[66] !== x || t[67] !== H
    ? ((U = { "aria-describedby": x, onEscapeKeyDown: H }), (t[66] = x), (t[67] = H), (t[68] = U))
    : (U = t[68]);
  let W;
  t[69] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = m(
      ...
      (t[69] = W))
    : (W = t[69]);
  let Nt = k && _.backdropSuccess,
    G;
  t[70] === Nt
    ? (G = t[71])
    : ((G = m(_.backdrop, `pointer-events-none absolute inset-0 z-0 bg-white`, Nt)),
      (t[70] = Nt),
      (t[71] = G));
  let Pt = et && _.backdropImageExpanded,
    K;
  t[72] === Pt
    ? (K = t[73])
    : ((K = m(_.backdropImage, `block w-full object-cover object-[center_48%]`, Pt)),
      (t[72] = Pt),
      (t[73] = K));
  let q;
  t[74] === K
    ? (q = t[75])
    : ((q = (0, g.jsx)(`img`, { alt: ``, className: K, draggable: !1, src: he })),
      (t[74] = K),
      (t[75] = q));
  let J;
  t[76] !== G || t[77] !== q
    ? ((J = (0, g.jsx)(`div`, { "aria-hidden": !0, className: G, children: q })),
      (t[76] = G),
      (t[77] = q),
      (t[78] = J))
    : (J = t[78]);
  let Ft = k && _.successBackdropVisible,
    Y;
  t[79] === Ft
    ? (Y = t[80])
    : ((Y = m(
  ...
  t[81] === Y
    ? (X = t[82])
    : ((X = (0, g.jsx)(`div`, { "aria-hidden": !0, className: Y })), (t[81] = Y), (t[82] = X));
  let Z;
  t[83] !== w?.type || t[84] !== N || t[85] !== k
    ? ((Z = (0, g.jsx)(ce, {
        asChild: !0,
        children: (0, g.jsx)(`h2`, {
          className: `sr-only`,
          children:
            k && w?.type === `success`
              ? (0, g.jsx)(Me, {})
              : (0, g.jsx)(ke, { isPersonalAccount: N }),
        }),
      })),
      (t[83] = w?.type),
      (t[84] = N),
      ...
      (t[86] = Z))
    : (Z = t[86]);
  let It = D && _.markSubmitting,
    Lt = O && _.markSendAnimating,
    Rt = k && _.markSuccess,
    Q;
  t[87] !== It || t[88] !== Lt || t[89] !== Rt
    ? ((Q = m(_.mark, `absolute bottom-[-34px] left-[calc(50%_-_62px)] size-[124px]`, It, Lt, Rt)),
      (t[87] = It),
      (t[88] = Lt),
      (t[89] = Rt),
      (t[90] = Q))
    : (Q = t[90]);
  let zt = D && _.renderSubmitting,
    Bt = O && _.renderSendAnimating,
    Vt;
  t[91] !== zt || t[92] !== Bt
    ? ((Vt = m(
        _.render,
  ...
  let Ut;
  t[97] !== Q || t[98] !== Ht
    ? ((Ut = (0, g.jsx)(`div`, { className: Q, children: Ht })),
      (t[97] = Q),
      (t[98] = Ht),
      (t[99] = Ut))
    : (Ut = t[99]);
  let Wt;
  t[100] !== L || t[101] !== l || t[102] !== A || t[103] !== O || t[104] !== k
    ? ((Wt = O
        ? null
        : (0, g.jsx)(`button`, {
            type: `button`,
            ...
            children: (0, g.jsx)(se, { className: `size-4 stroke-[2.4]` }),
          })),
      (t[100] = L),
      (t[101] = l),
      (t[102] = A),
  ...
  t[106] !== Ut || t[107] !== Wt
    ...
    : (Gt = t[108]);
  let Kt = O || k,
    qt = (O || k) && `pointer-events-none`,
    Jt = (O || k) && _.formHidden,
    Yt;
  t[109] !== qt || t[110] !== Jt
    ? ((Yt = m(
        _.form,
        `relative z-[1] flex flex-col gap-5 rounded-b-[24px] bg-[linear-gradient(to_bottom,transparent_0px,var(--referral-modal-surface)_80px)] px-6 pb-6 pt-[88px]`,
        qt,
        Jt,
      )),
      (t[109] = qt),
  ...
  t[114] === N
    ...
    : ((Zt = (0, g.jsx)(`h2`, {
        ...
        children: (0, g.jsx)(ke, { isPersonalAccount: N }),
      })),
      (t[114] = N),
      (t[115] = Zt));
  let Qt = k ? void 0 : x,
    $t;
  t[116] !== N || t[117] !== P || t[118] !== F || t[119] !== mt
    ? (($t = (0, g.jsx)(Ae, {
        credits: F,
        grantAmount: F,
        isPersonalAccount: N,
  ...
  t[124] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((tn = (0, g.jsx)(ge, { className: `size-3.5` })), (t[124] = tn))
    : (tn = t[124]);
  let nn;
  t[125] !== P || t[126] !== F
    ? ((nn = (0, g.jsxs)(`div`, {
        ...
        children: [tn, (0, g.jsx)(je, { grantAmount: F, rewardType: P })],
      })),
      (t[125] = P),
      (t[126] = F),
      (t[127] = nn))
  ...
  t[133] === y
    ? (on = t[134])
    : ((on = (0, g.jsx)(`label`, { className: `sr-only`, htmlFor: y, children: an })),
      (t[133] = y),
      (t[134] = on));
  let sn =
      M &&
  ...
  t[135] === sn
    ...
    : ((cn = m(
      ...
      (t[136] = cn));
  let ln;
  if (t[137] !== C || t[138] !== ct || t[139] !== l || t[140] !== j || t[141] !== z) {
    let e;
    (t[143] !== ct || t[144] !== l || t[145] !== j || t[146] !== z
      ? ((e = (e) =>
          (0, g.jsxs)(
            `span`,
            {
              ...
              children: [
                ...
                (0, g.jsx)(`button`, {
                  ...
                  type: `button`,
                  children: (0, g.jsx)(se, { className: `size-3.5 stroke-[2.4]` }),
                }),
              ],
            },
            e,
  ...
  let un;
  t[148] !== tt || t[149] !== E || t[150] !== l || t[151] !== N
    ? ((un = (e) => {
  ...
  t[166] !== dn
    ...
    : (fn = t[167]);
  let pn;
  t[168] !== M || t[169] !== cn || t[170] !== ln || t[171] !== fn
    ? ((pn = (0, g.jsxs)(`div`, { "aria-invalid": M, className: cn, children: [ln, fn] })),
      (t[168] = M),
      (t[169] = cn),
      (t[170] = ln),
      (t[171] = fn),
  ...
  let hn;
  t[177] !== pn || t[178] !== mn
    ? ((hn = (0, g.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [pn, mn] })),
      (t[177] = pn),
      (t[178] = mn),
      (t[179] = hn))
    : (hn = t[179]);
  let gn = !ut || (lt && !Ke) || j,
    _n;
  t[180] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_n = (0, g.jsx)(u, {
  ...
  t[181] !== D || t[182] !== gn
    ? ((vn = (0, g.jsx)(re, {
        className: `mt-6 h-10 w-full justify-center border-0 bg-[var(--referral-modal-button-background)] text-[var(--referral-modal-button-foreground)] hover:bg-[color-mix(in_srgb,var(--referral-modal-button-background)_80%,transparent)]`,
        disabled: gn,
        loading: D,
        type: `submit`,
        children: _n,
  ...
  let yn =
      dt || ft
        ? (0, g.jsx)(`div`, {
            className: m(_.optionalRows, et && _.optionalRowsHidden),
            children: (0, g.jsxs)(`div`, {
              className: m(_.optionalRowsContent, `flex flex-col`),
              children: [
                (0, g.jsx)(`div`, {
                  "aria-hidden": !dt,
                  className: m(_.consentRow, dt && _.consentRowVisible),
                  children: (0, g.jsx)(`div`, {
                    className: _.consentRowContent,
                    children: (0, g.jsxs)(`div`, {
                ...
                ft
                  ? (0, g.jsxs)(`details`, {
                      className: `group border-t border-[var(--referral-modal-border)] pt-3`,
                      children: [
                        (0, g.jsxs)(`summary`, {
                          className: `flex cursor-interaction list-none items-center justify-between gap-3 py-1 text-left text-sm text-[var(--referral-modal-secondary)] marker:hidden [&::-webkit-details-marker]:hidden`,
                          children: [
                            (0, g.jsx)(u, {
        ...
        : null,
    bn;
  t[184] !== on || t[185] !== hn || t[186] !== vn || t[187] !== yn
    ? ((bn = (0, g.jsxs)(`div`, { className: `flex flex-col`, children: [on, hn, vn, yn] })),
      (t[184] = on),
      (t[185] = hn),
      (t[186] = vn),
      (t[187] = yn),
    ...
    : (bn = t[188]);
  let xn;
  t[189] !== Kt || t[190] !== Yt || t[191] !== Xt || t[192] !== rn || t[193] !== bn
    ? ((xn = (0, g.jsxs)(`form`, {
        "aria-hidden": Kt,
        className: Yt,
        noValidate: !0,
  ...
  t[199] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Dn = (0, g.jsx)(me, { className: `size-5` })), (t[199] = Dn))
    : (Dn = t[199]);
  let On;
  t[200] === En
    ? (On = t[201])
    : ((On = (0, g.jsx)(`div`, { className: En, "aria-hidden": `true`, children: Dn })),
      (t[200] = En),
      (t[201] = On));
  let kn = k && _.successTitleVisible,
    $;
  t[202] === kn
    ? ($ = t[203])
    : (($ = m(
  ...
  t[204] === w?.type
    ? (An = t[205])
    : ((An = w?.type === `success` ? (0, g.jsx)(Me, {}) : null), (t[204] = w?.type), (t[205] = An));
  let jn;
  t[206] !== $ || t[207] !== An
    ? ((jn = (0, g.jsx)(`h2`, { className: $, children: An })),
      (t[206] = $),
      (t[207] = An),
      (t[208] = jn))
    : (jn = t[208]);
  let Mn = k && _.successDescriptionVisible,
    Nn;
  t[209] === Mn
    ? (Nn = t[210])
    : ((Nn = m(
        _.successDescription,
      ...
      (t[210] = Nn));
  let Pn = k ? x : void 0,
    Fn = w?.type === `success` ? w.emails.length : 1,
    In;
  t[211] !== N || t[212] !== a || t[213] !== P || t[214] !== F || t[215] !== Fn
    ? ((In = (0, g.jsx)(Ne, {
        count: Fn,
        credits: F,
        grantAmount: F,
    ...
    : (In = t[216]);
  let Ln;
  t[217] !== Nn || t[218] !== Pn || t[219] !== In
    ? ((Ln = (0, g.jsx)(`p`, { className: Nn, id: Pn, children: In })),
      (t[217] = Nn),
      (t[218] = Pn),
      (t[219] = In),
      (t[220] = Ln))
    : (Ln = t[220]);
  let Rn = k ? `pointer-events-auto` : `pointer-events-none`,
    zn = k && _.successButtonVisible,
    Bn;
  t[221] !== zn || t[222] !== Rn
    ? ((Bn = m(
        _.successButton,
  ...
  t[224] !== I || t[225] !== r
    ? ((Vn = () => {
        (I({ action: d.CODEX_REFERRAL_INVITE_MODAL_ACTION_DONE_CLICKED }), r());
      }),
      (t[224] = I),
      (t[225] = r),
      (t[226] = Vn))
    : (Vn = t[226]);
  let Hn;
  t[227] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Hn = (0, g.jsx)(u, {
  ...
  let Un;
  t[228] !== Bn || t[229] !== Vn
    ? ((Un = (0, g.jsx)(re, { className: Bn, onClick: Vn, type: `button`, children: Hn })),
      (t[228] = Bn),
      (t[229] = Vn),
      (t[230] = Un))
    : (Un = t[230]);
  let Wn;
  t[231] !== Un || t[232] !== Sn || t[233] !== wn || t[234] !== On || t[235] !== jn || t[236] !== Ln
    ? ((Wn = (0, g.jsxs)(`div`, {
        "aria-hidden": Sn,
        "aria-live": `polite`,
        className: wn,
        children: [On, jn, Ln, Un],
      })),
      (t[231] = Un),
      (t[232] = Sn),
      (t[233] = wn),
  ...
  t[243] !== Gt ||
  t[244] !== xn
    ? ((Gn = (0, g.jsxs)(`section`, { className: W, children: [J, X, Z, Gt, xn, Wn] })),
      (t[238] = Wn),
      (t[239] = W),
      (t[240] = J),
      (t[241] = X),
  ...
  let Kn;
  return (
    t[246] !== Mt || t[247] !== A || t[248] !== Gn || t[249] !== V || t[250] !== U
      ? ((Kn = (0, g.jsx)(Mt, {
          open: !0,
          onOpenChange: V,
...
function Se(e) {
  return (0, g.jsx)(`li`, { children: e }, e);
}
function Ce(e) {
  return e.email;
}
...
function Ne(e) {
  ...
  if (s === `rateLimitReset`) {
    if (o === `codex_login`) {
      if (a) {
        let e;
        t[0] === i ? (e = t[1]) : ((e = (0, g.jsx)(b, { grantAmount: i })), (t[0] = i), (t[1] = e));
        let r;
        return (
          t[2] !== n || t[3] !== e
            ? ((r = (0, g.jsx)(u, {
      ...
      let e;
      t[5] === i ? (e = t[6]) : ((e = (0, g.jsx)(b, { grantAmount: i })), (t[5] = i), (t[6] = e));
      let r;
      return (
        t[7] !== n || t[8] !== e
          ? ((r = (0, g.jsx)(u, {
    ...
    if (a) {
      ...
      t[10] === i
        ? (e = t[11])
        : ((e = (0, g.jsx)(b, { grantAmount: i })), (t[10] = i), (t[11] = e));
      let r;
      return (
        t[12] !== n || t[13] !== e
          ? ((r = (0, g.jsx)(u, {
    ...
    let e;
    t[15] === i ? (e = t[16]) : ((e = (0, g.jsx)(b, { grantAmount: i })), (t[15] = i), (t[16] = e));
    let r;
    return (
      t[17] !== n || t[18] !== e
        ? ((r = (0, g.jsx)(u, {
...
function ze(e) {
  ...
  try {
    let t = xe.safeParse(JSON.parse(e.message));
    if (!t.success)
      return {
...
function S({ hasBackendDetail: e, message: t, status: n }) {
  let r = Be({ message: t, status: n });
  return { errorResponsibility: Ve(r), errorType: r, hasBackendDetail: e, httpStatus: n };
}
function Be({ message: e, status: t }) {
  return C(e)
    ? f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_REFERRAL_ALREADY_EXISTS
    : t === 400
      ? f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_VALIDATION_FAILED
      : t === 401
        ? f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_AUTHENTICATION_REQUIRED
        : t === 403
          ? f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_PERMISSION_DENIED
          : t === 409
            ? f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_REFERRAL_ALREADY_EXISTS
            : t === 429
              ? f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_RATE_LIMITED
              : t >= 500 && t < 600
                ? f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_BACKEND_ISSUE
                : f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNKNOWN_BACKEND_ERROR;
}
function Ve(e) {
  switch (e) {
    case f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_AUTHENTICATION_REQUIRED:
    case f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_PERMISSION_DENIED:
    case f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_RATE_LIMITED:
    case f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_REFERRAL_ALREADY_EXISTS:
    case f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_VALIDATION_FAILED:
      return p.CODEX_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_USER;
    case f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_BACKEND_ISSUE:
    case f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNKNOWN_BACKEND_ERROR:
      return p.CODEX_REFERRAL_INVITE_MODAL_ERROR_RESPONSIBILITY_SYSTEM;
    case f.CODEX_REFERRAL_INVITE_MODAL_BACKEND_ERROR_TYPE_UNSPECIFIED:
    case f.UNRECOGNIZED:
