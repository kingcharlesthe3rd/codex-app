...
import { Gr as o } from "./app-server-manager-signals.js";
import { f as s } from "./vscode-api.js";
import "./isEqual.js";
import "./src-1.js";
import "./react-dom.js";
import { c, o as l } from "./lib.js";
import { Nr as u, Pr as d, o as f } from "./persisted-signal.js";
...
import { t as _ } from "./google-drive.js";
...
function L(e) {
  ...
  t[9] === P
    ? (L = t[10])
    : ((L = p(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-3`, P)), (t[9] = P), (t[10] = L));
  let R;
  t[11] !== n ||
  t[12] !== a ||
  t[13] !== m ||
  ...
  t[24] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ue = t[24]);
  let G;
  t[25] !== n || t[26] !== a || t[27] !== o || t[28] !== u || t[29] !== U
    ? ((G = (0, I.jsx)(z, {
        currentPlan: n,
        targetPlan: y.PLUS,
        price: U,
  ...
  t[46] === fe
    ? (J = t[47])
    : ((J = p(`col-start-1 row-start-1 grid gap-2.5 md:grid-cols-2`, fe)),
      (t[46] = fe),
      (t[47] = J));
  ...
  t[72] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Te = t[72]);
  let $;
  t[73] !== a || t[74] !== o || t[75] !== u || t[76] !== Z || t[77] !== Q
    ? (($ = (0, I.jsx)(B, {
        title: be,
        subtitle: xe,
        priceLabel: Z,
...
function R(e) {
  let t = (0, F.c)(30),
    { currentPlan: n, defaultTab: r, onClose: c, source: l } = e,
    p = i(a),
    { email: m } = g(),
    _ = h(),
    { data: b } = v(),
  ...
  let { data: S } = T(x),
    C;
  t[1] === S ? (C = t[2]) : ((C = { billingCurrency: S, enabled: !0 }), (t[1] = S), (t[2] = C));
  let { data: w } = E(C),
    ee;
  ...
  t[14] !== p || t[15] !== l
    ? ((z = (e, t) => {
        (t === y.SELF_SERVE_BUSINESS_USAGE_BASED &&
          f(p, o, { checkoutKind: `codex_team`, entryPoint: `direct_purchase_redirect` }),
          f(p, u, { ctaAction: e, source: l, targetPlan: t }));
      }),
      (t[14] = p),
      (t[15] = l),
      (t[16] = z))
  ...
  t[19] !== m || t[20] !== _
    ? ((V = (e) => {
        s.dispatchMessage(`open-in-browser`, {
          url: D({ loginHint: m, statsigClient: _, url: e }),
        });
      }),
      (t[19] = m),
      (t[20] = _),
...
function z(e) {
  let t = (0, F.c)(29),
    ...
    f;
  t[0] !== n || t[1] !== u
    ? ((f = j({ currentPlan: n, targetPlan: u })), (t[0] = n), (t[1] = u), (t[2] = f))
    : (f = t[2]);
  let p = f,
    h;
  t[3] !== n || t[4] !== u
  ...
  t[6] !== i || t[7] !== o || t[8] !== s
    ? ((_ = s == null ? null : (0, I.jsx)(W, { detailsLabel: s, getPlansUrl: i, onOpenUrl: o })),
      ...
      (t[9] = _))
    : (_ = t[9]);
  let v = p === `upgrade` ? `primary` : `outline`,
    y = p === `current`,
    b;
  t[10] !== p || t[11] !== a || t[12] !== o || t[13] !== u || t[14] !== g
    ? ((b = () => {
        g == null || p === `current` || (a(p, u), o(g));
      }),
      (t[10] = p),
      (t[11] = a),
      (t[12] = o),
  ...
  let C;
  return (
    t[23] !== r || t[24] !== c || t[25] !== _ || t[26] !== S || t[27] !== d
      ? ((C = (0, I.jsx)(U, {
          title: d,
          priceLabel: c,
          features: r,
...
function U(e) {
  let t = (0, F.c)(41),
    ...
    d = c === void 0 ? `large` : c,
    f = d === `large` && `h-10 justify-center`,
    m;
  t[0] === f ? (m = t[1]) : ((m = p(`flex flex-col gap-1`, f)), (t[0] = f), (t[1] = m));
  let h;
  t[2] === u
    ? (h = t[3])
    : ((h = (0, I.jsx)(`div`, {
  ...
  t[6] !== m || t[7] !== h || t[8] !== g
    ? ((_ = (0, I.jsxs)(`div`, { className: m, children: [h, g] })),
      ...
      (t[9] = _))
    : (_ = t[9]);
  let v = d === `large` && `h-12 justify-center`,
    y;
  t[10] === v ? (y = t[11]) : ((y = p(`mt-3 flex flex-col`, v)), (t[10] = v), (t[11] = y));
  let b;
  t[12] !== s || t[13] !== d
    ? ((b =
        s == null
          ...
          : (0, I.jsx)(`div`, {
              className: p(
                ...
                d === `large` ? `text-2xl font-normal` : `text-base font-medium`,
              ),
              children: s,
            })),
      (t[12] = s),
  ...
  let w = r == null ? `pt-8` : `gap-3`,
    T;
  t[28] === w ? (T = t[29]) : ((T = p(`mt-3 flex flex-col`, w)), (t[28] = w), (t[29] = T));
  let E;
  t[30] === r
    ? (E = t[31])
    : ((E =
...
function se() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, I.jsx)(_, { className: `icon-sm` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
...
//# sourceMappingURL=upgrade-plan-dialog-o.js.map
