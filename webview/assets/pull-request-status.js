...
import { Aa as t, Na as n } from "./app-server-manager-signals.js";
import { n as r, t as i } from "./jsx-runtime.js";
import { t as a } from "./clsx.js";
import { lt as o } from "./vscode-api.js";
import { o as s } from "./lib-2.js";
import { t as c } from "./tooltip.js";
import { t as l } from "./button.js";
import { t as u } from "./check-circle-filled.js";
import { t as d } from "./clock.js";
import { r as f } from "./dropdown.js";
import { t as p } from "./unselected-circle-BN-IdXY-.js";
import { t as m } from "./x-circle-filled.js";
import { t as h } from "./pull-request-readonly-comment.js";
import { t as g } from "./pull-request-open.js";
var _ = i(),
  v = 5.75,
  y = 2 * Math.PI * v,
  b = 1.5;
function x({ className: e = `icon-sm shrink-0`, checks: t }) {
  let n = S(t),
    r = a(`text-token-description-foreground`, e);
  if (n.length === 0) return (0, _.jsx)(p, { className: r });
  let i = n.length > 1 ? b : 0,
    o = 0;
  return (0, _.jsx)(`svg`, {
    "aria-hidden": !0,
    className: r,
...
function O(e) {
  ...
  return (
    t[2] !== r || t[3] !== i
      ? ((o = (0, _.jsx)(`span`, { className: i, children: r })),
        (t[2] = r),
        (t[3] = i),
        (t[4] = o))
      : (o = t[4]),
...
function ee(e) {
  ...
  t[4] === a
    ? (c = t[5])
    : ((c = a == null ? null : (0, _.jsx)(`span`, { className: `shrink-0`, children: a })),
      (t[4] = a),
      (t[5] = c));
  let l;
  return (
...
function te(e) {
  ...
  t[0] === o
    ...
    : ((c =
        o?.kind === `icon`
          ? (0, _.jsx)(`span`, { className: `shrink-0 text-token-text-tertiary`, children: o.icon })
          : o?.kind === `pill`
            ? (0, _.jsx)(O, { label: o.label })
            : o?.kind === `text`
              ? (0, _.jsx)(`span`, {
  ...
  t[2] === i
    ? (u = t[3])
    : ((u = (0, _.jsx)(`span`, { className: `shrink-0`, children: i })), (t[2] = i), (t[3] = u));
  let d;
  t[4] === a
    ? (d = t[5])
    : ((d = (0, _.jsx)(`span`, {
...
function ne(e) {
  ...
  t[0] === i
    ? (o = t[1])
    : ((o = (0, _.jsx)(f.SectionLabel, { children: i })), (t[0] = i), (t[1] = o));
  let s;
  t[2] === r
    ? (s = t[3])
    : ((s = (0, _.jsx)(`div`, {
        className: `flex max-h-[104px] flex-col overflow-y-auto`,
        children: (0, _.jsx)(re, { groups: r }),
      })),
      (t[2] = r),
      (t[3] = s));
  let c;
  t[4] !== o || t[5] !== s
    ? ((c = (0, _.jsxs)(`div`, { className: `flex flex-col`, children: [o, s] })),
      (t[4] = o),
      (t[5] = s),
      (t[6] = c))
    : (c = t[6]);
  ...
  return (
    t[7] !== a || t[8] !== c
      ? ((l = (0, _.jsx)(`div`, { className: a, children: c })), (t[7] = a), (t[8] = c), (t[9] = l))
      : (l = t[9]),
    l
  );
}
function re(e) {
  ...
  return (
    t[2] === r
      ? (i = t[3])
      : ((i = (0, _.jsx)(_.Fragment, { children: r })), (t[2] = r), (t[3] = i)),
    i
  );
}
function ie(e, t) {
  return (0, _.jsx)(k, { item: e }, t);
}
function ae(e) {
  return e.items;
}
function k(e) {
  ...
  let c;
  t[4] !== n.label || t[5] !== s
    ? ((c = (0, _.jsx)(`span`, { className: s, children: n.label })),
      (t[4] = n.label),
      (t[5] = s),
      (t[6] = c))
    : (c = t[6]);
  ...
  if (!r) {
    ...
    return (
      t[20] === m
        ? (e = t[21])
        : ((e = (0, _.jsx)(`div`, { className: E, children: m })), (t[20] = m), (t[21] = e)),
      e
    );
  }
  let h;
...
function A(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i) {
    ...
    ((c = `max-w-[220px]`),
      ...
      t[7] === i
        ? (o = t[8])
        : ((o = (0, _.jsx)(f.SectionLabel, { children: i })), (t[7] = i), (t[8] = o)),
      (s =
        e.length === 0
          ? (0, _.jsx)(f.Message, { compact: !0, children: n })
          : (0, _.jsx)(`div`, {
              className: `flex max-h-[104px] flex-col overflow-y-auto`,
              children: e.map(j),
            })),
  ...
  let l;
  t[9] !== a || t[10] !== o || t[11] !== s
    ? ((l = (0, _.jsxs)(`div`, { className: a, children: [o, s] })),
      (t[9] = a),
      (t[10] = o),
      (t[11] = s),
      (t[12] = l))
  ...
  return (
    t[13] !== c || t[14] !== l
      ? ((u = (0, _.jsx)(`div`, { className: c, children: l })),
        (t[13] = c),
        (t[14] = l),
        (t[15] = u))
      : (u = t[15]),
  ...
  return (0, _.jsx)(
    c,
    {
      ...
      children: (0, _.jsxs)(`div`, {
        className: E,
        children: [
          (0, _.jsx)(`span`, { className: `shrink-0 text-token-foreground`, children: e.icon }),
          (0, _.jsx)(`span`, { className: a(D, `text-token-foreground`), children: e.label }),
        ],
      }),
    },
    t,
  ...
  return (
    t[2] === r
      ...
      : ((i = (0, _.jsx)(`div`, {
          ...
          children: (0, _.jsx)(`div`, { className: `flex flex-col gap-2`, children: r }),
        })),
        (t[2] = r),
        (t[3] = i)),
    i
...
function P(e, t) {
  return (0, _.jsxs)(
    `div`,
    {
      ...
      children: [
        (0, _.jsx)(f.SectionLabel, { children: e.title }),
        (0, _.jsx)(`div`, {
  ...
  return (0, _.jsx)(
    `div`,
    {
      ...
      children: (0, _.jsx)(h, {
        ...
        metadataTooltipContent: r.position?.path == null ? null : (0, _.jsx)(L, { comment: r }),
        surface: `card`,
        url: r.url ?? null,
      }),
    },
...
function R({ canFix: e = !1, checks: t, intl: n, onFixCheck: r, onOpenCheck: i }) {
  ...
  if (a.length !== 0) return (0, _.jsx)(ne, { groups: a, title: W(t, n) });
}
...
function B({ checks: e, ciStatus: t }) {
  if (e.length === 0)
    switch (t) {
      case `failing`:
        return (0, _.jsx)(m, { className: `icon-sm shrink-0 text-token-charts-red` });
      case `none`:
        return (0, _.jsx)(d, { className: `icon-sm shrink-0` });
      case `passing`:
        return (0, _.jsx)(u, { className: `icon-sm shrink-0 text-token-charts-green` });
      case `pending`:
        return (0, _.jsx)(w, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    }
  return t === `none`
    ? (0, _.jsx)(d, { className: `icon-sm shrink-0` })
    : (0, _.jsx)(x, { checks: e });
}
function V(e) {
  switch (e) {
  ...
  return r.length === 0
    ...
    : (0, _.jsxs)(`span`, {
        ...
        children: [
          ...
          (0, _.jsx)(`span`, { className: `font-normal text-token-foreground/60`, children: r }),
        ],
      });
}
function oe(e, t) {
...
function K(e) {
  switch (e) {
    ...
    case `pending`:
      return (0, _.jsx)(w, { className: `icon-sm shrink-0 text-token-charts-yellow` });
    case `skipped`:
      return (0, _.jsx)(C, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `successful`:
      return (0, _.jsx)(u, { className: `icon-sm shrink-0 text-token-charts-green` });
    case `unknown`:
      return (0, _.jsx)(C, { className: `icon-sm shrink-0 text-token-description-foreground` });
...
function Z(e) {
  ...
  return (
    t[5] !== s || t[6] !== c
      ? ((l = (0, _.jsx)(s, { className: c })), (t[5] = s), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
...
var de = { draft: J, open: g, merged: Y, closed: q },
  fe = {
