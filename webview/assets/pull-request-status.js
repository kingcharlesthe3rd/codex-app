...
import { t as o } from "./pull-request-open.js";
e(t());
var s = n(),
  c = (e) =>
    (0, s.jsx)(`svg`, {
...
function h(e) {
  ...
  if (t[0] !== r || t[1] !== n || t[2] !== o) {
    let { Icon: e, iconClassName: i } = w({ status: n, tone: o });
    ((c = e), (l = a(r, i)), (t[0] = r), (t[1] = n), (t[2] = o), (t[3] = c), (t[4] = l));
  } else ((c = t[3]), (l = t[4]));
  let u;
  return (
    t[5] !== c || t[6] !== l
      ? ((u = (0, s.jsx)(c, { className: l })), (t[5] = c), (t[6] = l), (t[7] = u))
      : (u = t[7]),
    u
  );
}
function g(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
    let { Icon: e, iconClassName: i } = T({ state: r, tone: o });
    ((c = e), (l = a(n, i)), (t[0] = n), (t[1] = r), (t[2] = o), (t[3] = c), (t[4] = l));
  } else ((c = t[3]), (l = t[4]));
  let u;
  return (
    t[5] !== c || t[6] !== l
...
var v = { draft: l, open: o, merged: d, closed: c },
  y = {
  ...
  b = { draft: l, failing: u, in_progress: f, merged: d, ready: p, successful: p },
  x = {
    draft: `text-token-description-foreground`,
  ...
  C = `text-token-description-foreground`;
function w({ status: e, tone: t }) {
  return {
    Icon: v[e],
    iconClassName: t === `currentColor` ? `text-current` : t === `neutral` ? C : y[e],
  };
}
function T({ state: e, tone: t }) {
  return {
    Icon: b[e],
    iconClassName:
      t === `currentColor` ? a(`text-current`, S[e]) : t === `neutral` ? a(C, S[e]) : x[e],
  };
}
export { l as a, d as i, h as n, g as r, _ as t };
