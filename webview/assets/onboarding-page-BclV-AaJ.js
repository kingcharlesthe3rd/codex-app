...
import { Ji as u, Ki as d, ds as f, qi as p } from "./app-server-manager-signals.js";
import { f as m, k as h, m as g, n as _, r as v } from "./vscode-api.js";
...
import "./react-dom.js";
import { c as M, n as N, o as P } from "./lib.js";
import { Ut as ee, Wt as F, Xt as te, Zt as ne, o as I } from "./persisted-signal.js";
import { t as L } from "./clsx-Cir5-jBH.js";
import "./app-shell-state.js";
import { t as R } from "./button-DO-oxX3-.js";
import { i as z } from "./setting-storage.js";
...
import { n as ce, t as le } from "./thread-detail-level.js";
import {
  a as B,
  d as ue,
  i as de,
...
import "./checkbox.js";
import "./minus.js";
import { n as be } from "./external-agent-onboarding-import-status.js";
import "./folders.js";
import "./search.js";
import "./globe.js";
import "./sortBy.js";
import { t as xe } from "./arrow-up-right-lg-BG8h--9V.js";
...
import { a as je } from "./onboarding-shell.js";
import "./hooks.js";
import { t as Me } from "./animated-icon-Cb-4QGzu.js";
import "./tasks.js";
import { i as W, n as Ne, t as Pe } from "./onboarding-roles.js";
var G = r(),
  Fe = [
    `animals`,
    `fitness`,
...
var Le = [
  ...
  Be = C(`step`, [
    T({ step: k(K.TeenWelcome) }),
    T({ step: k(K.TeenInterests), interests: j(S(Fe)) }),
    T({ step: k(K.TeenPrompts), prompt: O().optional() }),
    T({
      step: k(K.RoleSelection),
      roles: j(S(Le)),
      personalizedSuggestionsEnabled: w(),
      workMode: S(Re).nullable(),
    }),
    T({ step: k(K.AgentMigrationSourceSelection), providerIds: j(S(ze)), skipped: w().optional() }),
    T({ step: k(K.AgentMigrationItemSelection), action: S([`imported`, `skipped`]) }),
  ]),
  q = a(`OnboardingScope`, { parent: l }),
  J = i(q, () => K.Start),
  Y = i(q, () => null),
  Ve = i(q, () => null),
  He = i(q, () => null),
    ...
    e[11] !== g
      ? ((S = (e, o) => {
          ...
          (n(e),
            ...
            z(t, A.conversationDetailMode, y.threadDetailLevel)
              .catch(qe)
              .finally(() => {
                let e = a === `welcome`;
                (s(`auto`),
            ...
            y.fontSizes != null &&
              (z(t, x.sansFontSize, y.fontSizes.sans), z(t, x.codeFontSize, y.fontSizes.code)),
            t.set(Ce, { "guardian-approvals": h, "full-access": h }),
            l && t.set(ve, !0),
            (async () => {
              (await z(t, E.enabled, l),
                l &&
                  (await _(`ambient-suggestions-refresh`, {
                    params: { hostId: f, projectRoot: D(`~`) },
                  }),
                  await Promise.all([
...
function Je(e) {
  return e === `non_coding`
    ? { threadDetailLevel: ce, fontSizes: { sans: Ue, code: We } }
    : { threadDetailLevel: le, fontSizes: null };
}
function Ye(e) {
  let t = (0, G.c)(8),
...
function Q(e) {
  ...
  return (
    t[7] === u
      ? (f = t[8])
      : ((f = (0, Z.jsx)(Z.Fragment, { children: u })), (t[7] = u), (t[8] = f)),
    f
  );
}
function ot(e) {
...
function wt() {
  m.dispatchMessage(`open-in-browser`, { url: `https://openai.com/codex/` });
}
function Tt() {
  let e = (0, G.c)(4),
    t;
...
function $(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = L(`absolute overflow-hidden rounded-2xl border border-token-border/50 shadow-2xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  return (
...
function At() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Z.jsx)(je, {
          fullBleed: !0,
          children: (0, Z.jsx)(s, { scope: q, children: (0, Z.jsx)(kt, {}) }),
        })),
        (e[0] = t))
      : (t = e[0]),
    t
...
//# sourceMappingURL=onboarding-page-BclV-AaJ.js.map
