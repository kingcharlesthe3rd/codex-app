...
import { L as a, T as o, _ as s, ht as c, l, w as u, wt as d } from "./setting-storage.js";
...
import { t as g } from "./_baseOrderBy.js";
...
function k(e) {
  ...
  if (C(e) || y(e)) ((r = e), (t = A(e)), (n = j(e)));
    ...
    let o = e.name;
    if (((r = o), O.call(e, `weight`) && ((i = e.weight), i <= 0))) throw Error(se(o));
...
var N = class {
  constructor({ getFn: e = M.getFn, fieldNormWeight: t = M.fieldNormWeight } = {}) {
    ((this.norm = he(t, 3)), (this.getFn = e), (this.isCreated = !1), this.setIndexRecords());
  }
  setSources(e = []) {
    this.docs = e;
  }
...
function P(e, t, { getFn: n = M.getFn, fieldNormWeight: r = M.fieldNormWeight } = {}) {
  let i = new N({ getFn: n, fieldNormWeight: r });
  return (i.setKeys(e.map(k)), i.setSources(t), i.create(), i);
}
function ge(e, { getFn: t = M.getFn, fieldNormWeight: n = M.fieldNormWeight } = {}) {
...
function ve(
  ...
  for (; (_ = e.indexOf(t, m)) > -1; ) {
    let e = F(t, { currentLocation: _, expectedLocation: f, distance: i, ignoreLocation: l });
...
var L = String.prototype.normalize
  ...
  R = class {
    ...
    searchIn(e) {
      ...
      if (((e = t ? e : e.toLowerCase()), (e = n ? L(e) : e), this.pattern === e)) {
...
function Le(e, t, { includeMatches: n = M.includeMatches, includeScore: r = M.includeScore } = {}) {
  let i = [];
  return (
    n && i.push(Fe),
    r && i.push(Ie),
...
function qe(e) {
  let t = (0, $.c)(2),
    n;
  return (t[0] === e ? (n = t[1]) : ((n = He(e)), (t[0] = e), (t[1] = n)), o(n));
}
function Je(e, t, n) {
  let r = (0, $.c)(11),
    i;
...
function Ye(e, t, n) {
  ...
  return (
    r[6] !== i || r[7] !== a || r[8] !== c
      ? ((l = { queryKey: i, enabled: a, staleTime: s.FIVE_SECONDS, queryFn: c }),
        (r[6] = i),
        (r[7] = a),
        (r[8] = c),
        (r[9] = l))
...
function Qe(e, t) {
  let n = (0, $.c)(14),
    ...
    a = v(e, 200),
    c;
  n[0] === a ? (c = n[1]) : ((c = [`workspace`, `environments-search`, a]), (n[0] = a), (n[1] = c));
  let l;
  n[2] !== a || n[3] !== i
  ...
  return (
    n[9] !== c || n[10] !== l || n[11] !== u || n[12] !== d
      ? ((f = { queryKey: c, enabled: l, queryFn: u, staleTime: s.FIVE_MINUTES, select: d }),
        (n[9] = c),
        (n[10] = l),
        (n[11] = u),
        (n[12] = d),
...
async function it() {
  return at((await l(`git-origins`, { source: `workspace_repo_owner_names` })).origins);
}
function at(e) {
  let t = [];
...
async function st({ repoName: e, filename: t, contentType: n, anticipatedFileSize: r }) {
...
async function dt(e) {
  ...
  if (
    ...
    for (let n of e.images) t.push(n);
  if (e.commentAttachments?.length) for (let n of e.commentAttachments) t.push(r(n));
...
function _t(e) {
  ...
  return (
    t[3] === i
      ? (c = t[4])
      : ((c = { enabled: i, queryKey: a, queryFn: vt, staleTime: s.FIVE_SECONDS }),
        (t[3] = i),
        (t[4] = c)),
    o(c)
  );
...
function yt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = { queryKey: [`rate-limit-reset-credits`], queryFn: bt, staleTime: s.FIVE_SECONDS }),
        (e[0] = t))
      : (t = e[0]),
    o(t)
  );
...
function Ft() {
  ...
  return (
    e[1] === r
      ? (i = e[2])
      : ((i = { queryKey: n, queryFn: It, staleTime: s.ONE_MINUTE, enabled: r }),
        (e[1] = r),
        (e[2] = i)),
    o(i)
  );
...
function Lt(e) {
  ...
  let { enabled: r } = n,
    ...
    l;
  t[2] !== a || t[3] !== c
    ? ((l = [`onboarding`, `context`, c, a]), (t[2] = a), (t[3] = c), (t[4] = l))
    : (l = t[4]);
  let u = i && c === `chatgpt`,
    d;
  return (
    t[5] !== l || t[6] !== u
      ? ((d = { queryKey: l, queryFn: Rt, staleTime: s.TEN_MINUTES, enabled: u }),
        (t[5] = l),
        (t[6] = u),
        (t[7] = d))
      : (d = t[7]),
...
//# sourceMappingURL=codex-api-B.js.map
