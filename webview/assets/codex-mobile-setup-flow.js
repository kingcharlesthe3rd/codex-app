...
import { $s as i, Li as a, Pt as o, po as s } from "./app-server-manager-signals.js";
...
import { m as te } from "./chunk-8.js";
...
async function P(e = null) {
  let t = await R(() =>
    x.safeGet(`/wham/remote/control/clients`, { parameters: { query: { cursor: e, limit: E } } }),
  );
    ...
    throw e instanceof m
      ? e.status === 404
        ...
        : e.status === 403
          ? new A(e.message)
          : e.status === 401
            ? (oe(), new O(`ChatGPT auth is required to load remote control environments.`))
...
var V = 3e4,
  H = _(u, () => ({ queryKey: [`remote-control-clients`], queryFn: F, staleTime: V })),
  se = g(u, (e) => ({
    enabled: e,
...
function J(e) {
  let t = (0, ce.c)(75),
    ...
    m = (0, K.useRef)(null),
    h;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((h = { hostId: s }), (t[0] = h)) : (h = t[0]);
  let g = le(h),
    _ = f(o, s),
    [y] = i(ie),
    b = p(fe),
  ...
  t[1] !== _ || t[2] !== x || t[3] !== b.data
    ? ((S = x ?? pe({ remoteControlHostEnabled: _, hasEnrolledRemoteControlClient: b.data })),
      (t[1] = _),
      (t[2] = x),
      (t[3] = b.data),
      (t[4] = S))
  ...
  let F;
  t[18] !== E || t[19] !== l
    ? ((F = async () => ((await l.query.fetch(ue)) === `required` ? E.data === !1 : !1)),
      (t[18] = E),
      (t[19] = l),
      (t[20] = F))
    : (F = t[20]);
  ...
  (t[35] !== d || t[36] !== W
    ...
    : ((G = t[37]), (J = t[38])),
    (0, K.useEffect)(G, J));
  let Y = R.isPending || H.isPending || g.isPending || (T.data === `required` && E.isLoading);
...
function he(e) {
  ...
  t[5] === m
    ...
    : ((g = () => {
        (m(`continue_on_chatgpt`),
          b.dispatchMessage(`open-in-browser`, { url: `https://chatgpt.com/#settings/Security` }));
      }),
      (t[5] = m),
      (t[6] = g));
  let _;
  ...
  return (
    t[23] !== h || t[24] !== y
      ? ((x = (0, q.jsxs)(q.Fragment, { children: [h, y] })), (t[23] = h), (t[24] = y), (t[25] = x))
      : (x = t[25]),
    x
  );
}
