...
import { Sd as B, xd as V } from "./app-initial~app-main~onboarding-page.js";
import { Ht as H, Ut as U } from "./app-initial~app-main~automations-page.js";
import {
  a as W,
  i as G,
  n as me,
...
var we,
  ...
  ke = e(() => {
    (E(),
      ...
      (we = 3e4),
      (Te = I(p, ({ get: e }) => {
        let t = r(e, `local_remote_control_environment_id`) ?? null,
          n = !e(T, `2055603567`);
        return {
          queryKey: [`remote-control-clients`, t, n],
          queryFn: () => m(t, { includeBrowserClients: n }),
          staleTime: we,
        };
      })),
      (Ee = j(p, (e, { get: t }) => {
        ...
        return {
          enabled: i != null,
          queryKey: [`remote-control-clients`, `app-server`, e, r?.installationId],
          queryFn: () => (i == null ? Promise.resolve([]) : m(i, { appServerHostId: e })),
          staleTime: we,
        };
      })),
      (De = j(p, (e, { get: t }) => {
        let n = r(t, `local_remote_control_environment_id`) ?? null,
          i = !t(T, `2055603567`);
        return {
          enabled: e,
          queryKey: [`remote-control-clients`, n, i],
          queryFn: () => m(n, { includeBrowserClients: i }),
      ...
      (Oe = j(
        p,
        (
          { existingClientIds: e, hostId: t, localRemoteControlClientId: i, waiting: a },
          { get: o, queryClient: s },
        ) => {
          let c = null,
            l = null,
            u = !o(T, `2055603567`);
          if (a && t == null) c = r(o, `local_remote_control_environment_id`) ?? null;
          else if (a) {
            let e = o(n, t);
            ((c = e?.environmentId), (l = e?.installationId));
          }
          let d = [
          ...
          return {
            enabled: a && e != null && (t == null || c != null),
            gcTime: 0,
            queryKey: d,
            queryFn: async () => {
              let n = s.getQueryData(d);
              if (n != null || e == null) return n ?? null;
              let r = await m(c ?? null, {
                appServerHostId: t ?? void 0,
                includeBrowserClients: u,
              });
              return (
                t != null && s.setQueryData([`remote-control-clients`, `app-server`, t, l], r),
                xe(ye(r, i), e)
              );
            },
            refetchInterval: (e) => (a && e.state.data == null ? 1e3 : !1),
            staleTime: 0,
          };
        },
        { key: Ce },
...
function Ie(e) {
  return e.some((e) => e instanceof ae);
}
function Le(e) {
  switch (e) {
    case `disabled`:
...
function ze(e) {
  let t = (0, He.c)(76),
    ...
    [m] = le(ve),
    h = s(i),
    [g, v] = (0, Q.useState)(n ?? null),
    [ee, y] = (0, Q.useState)(null),
    [x] = pe(`local_remote_control_client_id`),
    S;
  t[0] !== f || t[1] !== g || t[2] !== h.data
    ? ((S = g ?? Fe({ remoteControlHostEnabled: f, hasEnrolledRemoteControlClient: h.data })),
      (t[0] = f),
      (t[1] = g),
      (t[2] = h.data),
      (t[3] = S))
  ...
  let C = S,
    ...
    T = ye(w.data, x),
    ae = s(l),
    oe = C === `waiting` && (ee == null ? T?.length : be(T, ee)) ? `connected` : C,
    se = s(ie),
    E = m === `auto` ? (C === `mfa-required` && se.data ? `allow-host` : oe) : m,
    D;
  t[4] !== E || t[5] !== c || t[6] !== a
    ? ((D = (e) => {
        ce(c, fe, { action: e, step: E, surface: a });
      }),
      (t[4] = E),
      (t[5] = c),
      (t[6] = a),
  ...
  (t[8] !== E || t[9] !== c || t[10] !== a
    ? ((k = () => {
        let e = `${a}:${E}`;
        d.current !== e && ((d.current = e), ce(c, ne, { step: E, surface: a }));
      }),
      (A = [E, c, a]),
      (t[8] = E),
      (t[9] = c),
    ...
    (0, Q.useEffect)(k, A));
  let j;
  t[13] === c ? (j = t[14]) : ((j = () => re(c)), (t[13] = c), (t[14] = j));
  let M;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (M = t[15]);
  let N;
  t[16] === j ? (N = t[17]) : ((N = { mutationFn: j, onSuccess: M }), (t[16] = j), (t[17] = N));
  let P = o(N),
    F;
  t[18] === c
    ? (F = t[19])
  ...
  t[20] === x
    ? (I = t[21])
    : ((I = (e) => {
        (y(new Set(ye(e, x)?.map(Be))), v(`waiting`));
      }),
      (t[20] = x),
      (t[21] = I));
  let L;
  ...
  t[34] !== w.error ||
  t[35] !== h.error
    ? ((H = Ie([h.error, w.error, ae.error, P.error, z.error])),
      (t[31] = z.error),
      (t[32] = P.error),
      (t[33] = ae.error),
      (t[34] = w.error),
  ...
  (t[37] !== u || t[38] !== U
    ...
    : ((W = t[39]), (G = t[40])),
    (0, Q.useEffect)(W, G));
  let K = P.isPending || z.isPending || (ae.data === `required` && se.isLoading),
    q;
  t[41] !== z.error || t[42] !== z.isError
    ? ((q = z.isError && !me(z.error)), (t[41] = z.error), (t[42] = z.isError), (t[43] = q))
    : (q = t[43]);
  let J = q;
...
function Ve(e) {
  ...
  t[0] !== d || t[1] !== u
    ? ((h = (e) => {
        ce(d, fe, { action: e, step: u, surface: `page` });
      }),
      (t[0] = d),
      (t[1] = u),
      (t[2] = h))
  ...
  return (
    t[25] !== _ || t[26] !== x
      ? ((S = (0, $.jsxs)($.Fragment, { children: [_, x] })), (t[25] = _), (t[26] = x), (t[27] = S))
      : (S = t[27]),
    S
  );
}
