      ...
      (Oe = a(
        ...
        (
          ...
          let o = null,
            s = null,
            c = !i(P, `2055603567`);
          if (r && t == null) o = M(i, `local_remote_control_environment_id`) ?? null;
          else if (r) {
            let e = i(A, t);
...
function ze(e) {
  ...
  t[0] !== d || t[1] !== m || t[2] !== p.data
    ? ((x = m ?? Fe({ remoteControlHostEnabled: d, hasEnrolledRemoteControlClient: p.data })),
      (t[0] = d),
      (t[1] = m),
      (t[2] = p.data),
      (t[3] = x))
  ...
  let S = x,
    ...
    w = ye(C.data, b),
    T = g(ue),
    ae = S === `waiting` && (ee == null ? w?.length : be(w, ee)) ? `connected` : S,
    oe = g(pe),
    E = f === `auto` ? (S === `mfa-required` && oe.data ? `allow-host` : ae) : f,
    D;
  t[4] !== E || t[5] !== s || t[6] !== a
    ? ((D = (e) => {
  ...
  (t[8] !== E || t[9] !== s || t[10] !== a
    ? ((k = () => {
        let e = `${a}:${E}`;
        u.current !== e && ((u.current = e), te(s, re, { step: E, surface: a }));
      }),
      (A = [E, s, a]),
      (t[8] = E),
      (t[9] = s),
...
function Ve(e) {
  ...
  return (
    t[25] !== _ || t[26] !== S
      ? ((C = (0, $.jsxs)($.Fragment, { children: [_, S] })), (t[25] = _), (t[26] = S), (t[27] = C))
      : (C = t[27]),
    C
  );
}
