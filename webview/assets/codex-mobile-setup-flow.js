    ...
    (o(),
      ...
      (Ee = D(_, (e, { get: t }) => {
        ...
        return {
          ...
          queryFn: () => (r == null ? Promise.resolve([]) : I(r, { appServerHostId: e })),
          staleTime: we,
        };
      })),
      (De = D(_, (e, { get: t }) => {
      ...
      (Oe = D(
        ...
        (
          ...
          let o = null,
            s = null,
            c = !i(E, `2055603567`);
          if (r && t == null) o = x(i, `local_remote_control_environment_id`) ?? null;
          else if (r) {
            let e = i(le, t);
...
async function Ae(e, t, n) {
  ...
  A(e, t, !1);
  let r = ue(e, t, { ignoreCurrentError: !0 });
  try {
    let n = je(e, t, !0);
...
async function je(e, t, n) {
  return t === `local`
    ? (await S(`set-local-remote-control-enabled`, { params: { enabled: n } }),
      W(e, n, { force: !0 }))
    : q(e, t, n);
}
var Me = e(() => {
...
function ze(e) {
  let t = (0, He.c)(76),
    ...
    [x] = oe(`local_remote_control_client_id`),
    S;
  t[0] !== l || t[1] !== p || t[2] !== f.data
    ? ((S = p ?? Fe({ remoteControlHostEnabled: l, hasEnrolledRemoteControlClient: f.data })),
      (t[0] = l),
      (t[1] = p),
      (t[2] = f.data),
      (t[3] = S))
  ...
  let C = S,
    ...
    ce = ye(w.data, x),
    T = d(de),
    le = C === `waiting` && (y == null ? ce?.length : be(ce, y)) ? `connected` : C,
    ue = d(i),
    E = u === `auto` ? (C === `mfa-required` && ue.data ? `allow-host` : le) : u,
    D;
  t[4] !== E || t[5] !== o || t[6] !== a
    ? ((D = (e) => {
        ie(o, te, { action: e, step: E, surface: a });
      }),
      (t[4] = E),
      (t[5] = o),
      (t[6] = a),
  ...
  (t[8] !== E || t[9] !== o || t[10] !== a
    ? ((k = () => {
        let e = `${a}:${E}`;
        c.current !== e && ((c.current = e), ie(o, ne, { step: E, surface: a }));
      }),
      (A = [E, o, a]),
      (t[8] = E),
      (t[9] = o),
    ...
    (0, Q.useEffect)(k, A));
  let j;
  t[13] === o ? (j = t[14]) : ((j = () => v(o)), (t[13] = o), (t[14] = j));
  let M;
  ...
  t[20] === x
    ? (I = t[21])
    : ((I = (e) => {
        (ae(new Set(ye(e, x)?.map(Be))), m(`waiting`));
      }),
      (t[20] = x),
      (t[21] = I));
  let L;
  ...
  t[34] !== w.error ||
  t[35] !== f.error
    ? ((H = Ie([f.error, w.error, T.error, P.error, z.error])),
      (t[31] = z.error),
      (t[32] = P.error),
      (t[33] = T.error),
      (t[34] = w.error),
  ...
  (t[37] !== s || t[38] !== U
    ...
    : ((W = t[39]), (G = t[40])),
    (0, Q.useEffect)(W, G));
  let K = P.isPending || z.isPending || (T.data === `required` && ue.isLoading),
    q;
  t[41] !== z.error || t[42] !== z.isError
    ? ((q = z.isError && !me(z.error)), (t[41] = z.error), (t[42] = z.isError), (t[43] = q))
    : (q = t[43]);
  let J = q;
  if ((u === `auto` && p == null && l && f.isLoading) || U) return null;
  if (a === `dialog`) {
    let e;
    t[44] === r
      ? (e = t[45])
...
function Ve(e) {
  ...
  t[0] !== u || t[1] !== l
    ? ((f = (e) => {
        ie(u, te, { action: e, step: l, surface: `page` });
      }),
      (t[0] = u),
      (t[1] = l),
      (t[2] = f))
  ...
  t[11] !== ne || t[12] !== p
    ? ((v = () => {
        (p(`manage_connections`), ne(`/settings/connections`));
      }),
      (t[11] = ne),
      (t[12] = p),
      (t[13] = v))
  ...
  return (
    t[25] !== m || t[26] !== y
      ? ((b = (0, $.jsxs)($.Fragment, { children: [m, y] })), (t[25] = m), (t[26] = y), (t[27] = b))
      : (b = t[27]),
    b
  );
}
