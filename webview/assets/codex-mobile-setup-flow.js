...
import { dd as ee, fd as _ } from "./app-initial~app-main~onboarding-page.js";
import {
  $t as v,
  Ax as y,
  Bh as b,
      ...
      (Oe = g(
        ...
        (
          ...
          let o = null,
            s = null,
            c = !i(j, `2055603567`);
          if (r && t == null) o = z(i, `local_remote_control_environment_id`) ?? null;
          else if (r) {
            let e = i(T, t);
...
function ze(e) {
  ...
  let C = S,
    ...
    re = ye(w.data, x),
    oe = c(v),
    se = C === `waiting` && (_ == null ? re?.length : be(re, _)) ? `connected` : C,
    ce = c(ne),
    T = m === `auto` ? (C === `mfa-required` && ce.data ? `allow-host` : se) : m,
    E;
  t[4] !== T || t[5] !== a || t[6] !== i
    ? ((E = (e) => {
  ...
  (t[37] !== s || t[38] !== U
    ...
    : ((W = t[39]), (G = t[40])),
    (0, Q.useEffect)(W, G));
  let K = N.isPending || z.isPending || (oe.data === `required` && ce.isLoading),
    q;
