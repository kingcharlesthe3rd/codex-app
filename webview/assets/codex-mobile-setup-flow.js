...
import { An as z, jn as B } from "./app-initial~app-main~automations-page.js";
import {
  n as V,
  t as H,
    ...
    (h(),
      ...
      (Te = w(d, ({ get: e }) => {
        ...
        return {
          ...
          queryFn: () => S(t, { includeBrowserClients: r }),
          staleTime: we,
        };
      })),
      (Ee = F(d, (e, { get: t }) => {
        ...
        return {
          ...
          queryFn: () => (r == null ? Promise.resolve([]) : S(r, { appServerHostId: e })),
          staleTime: we,
        };
      })),
      (De = F(d, (e, { get: t }) => {
        ...
        return {
          ...
          queryFn: () => S(r, { includeBrowserClients: i }),
...
async function Ae(e, t, n) {
  ...
  C(e, t, !1);
  let r = ie(e, t, { ignoreCurrentError: !0 });
  try {
    let n = je(e, t, !0);
...
async function je(e, t, n) {
  return t === `local`
    ? (await u(`set-local-remote-control-enabled`, { params: { enabled: n } }),
      U(e, n, { force: !0 }))
    : K(e, t, n);
}
var Me = e(() => {
...
function Ie(e) {
  return e.some((e) => e instanceof re);
}
function Le(e) {
  switch (e) {
    case `disabled`:
...
function ze(e) {
  let t = (0, He.c)(76),
    ...
    [b] = ae(`local_remote_control_client_id`),
    x;
  t[0] !== u || t[1] !== m || t[2] !== p.data
    ? ((x = m ?? Fe({ remoteControlHostEnabled: u, hasEnrolledRemoteControlClient: p.data })),
      (t[0] = u),
      (t[1] = m),
      (t[2] = p.data),
      (t[3] = x))
  ...
  let S = x,
    ...
    te = Z(C.data, b),
    w = le(ue),
    re = S === `waiting` && (_ == null ? te?.length : be(te, _)) ? `connected` : S,
    ie = le(ne),
    T = f === `auto` ? (S === `mfa-required` && ie.data ? `allow-host` : re) : f,
    E;
  t[4] !== T || t[5] !== s || t[6] !== a
    ? ((E = (e) => {
        ee(s, oe, { action: e, step: T, surface: a });
      }),
      (t[4] = T),
      (t[5] = s),
      (t[6] = a),
  ...
  (t[8] !== T || t[9] !== s || t[10] !== a
    ? ((O = () => {
        let e = `${a}:${T}`;
        l.current !== e && ((l.current = e), ee(s, g, { step: T, surface: a }));
      }),
      (k = [T, s, a]),
      (t[8] = T),
      (t[9] = s),
    ...
    (0, Q.useEffect)(O, k));
  let A;
  t[13] === s ? (A = t[14]) : ((A = () => o(s)), (t[13] = s), (t[14] = A));
  let j;
  ...
  t[20] === b
    ? (F = t[21])
    : ((F = (e) => {
        (v(new Set(Z(e, b)?.map(Be))), h(`waiting`));
      }),
      (t[20] = b),
      (t[21] = F));
  let I;
  ...
  t[34] !== C.error ||
  t[35] !== p.error
    ? ((V = Ie([p.error, C.error, w.error, N.error, R.error])),
      (t[31] = R.error),
      (t[32] = N.error),
      (t[33] = w.error),
      (t[34] = C.error),
  ...
  (t[37] !== c || t[38] !== H
    ...
    : ((U = t[39]), (W = t[40])),
    (0, Q.useEffect)(U, W));
  let G = N.isPending || R.isPending || (w.data === `required` && ie.isLoading),
    K;
  t[41] !== R.error || t[42] !== R.isError
    ? ((K = R.isError && !he(R.error)), (t[41] = R.error), (t[42] = R.isError), (t[43] = K))
    : (K = t[43]);
  let q = K;
  if ((f === `auto` && m == null && u && p.isLoading) || H) return null;
  if (a === `dialog`) {
    let e;
    t[44] === r
      ? (e = t[45])
...
function Ve(e) {
  ...
  t[0] !== u || t[1] !== l
    ? ((h = (e) => {
        ee(u, oe, { action: e, step: l, surface: `page` });
      }),
      (t[0] = u),
      (t[1] = l),
      (t[2] = h))
