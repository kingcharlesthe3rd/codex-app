...
import { T as pn, a as mn, r as hn, w as gn } from "./local-conversation-thread.js";
import { i as _n, r as vn } from "./thread-overflow-menu.js";
import { n as yn, t as bn } from "./use-media-query.js";
var xn,
  Sn,
  Cn = e(() => {
    (t(f()),
...
function On({ onClose: e, target: t }) {
  let n = s(U),
    i = W(),
    a = _(N.tabs$),
    c = _(F.tabs$),
  ...
  let E = o(Ft, w),
    ...
    k = o(x, `searchFiles`),
    j = o(x, `openSideChat`),
    M = o(x, `openBrowserTab`),
    P = o(x, `openReviewTab`),
    I = o(gn, w),
    L = T !== `projectless` && h != null,
    ee = w != null && !1,
    te = w != null && !Ce(),
    ne = d && (f || !l.some((e) => bt(e))),
    re = !p && (m.kind === `git` || !1) && !l.some((e) => e.tabId === Ct.DIFF),
    ie = ee && !l.some((e) => e.tabId === Ct.TIMELINE),
    ae = D(n),
    R = m.kind === `git` ? null : I,
    oe = R != null && R.length > 0,
    se = () => {
      w != null &&
        _n(n, hn, {
    ...
    le = () => {
      $t(n, {
        browserConversationId: C ?? void 0,
        browserHostDisplayName: b.display_name,
        cwd: m.cwd,
    ...
    de = () => {
      h != null && (ye(n, null, { hostId: b.id, target: t, workspaceRoot: h }), e?.());
    },
    fe = () => {
      (A(n, t), e?.());
    },
    me = (e, t, n) => {
      if (t == null) {
        Ue({ href: e, initiator: `mcp_app_resource`, originHostId: n });
        return;
      }
      nt({ event: t, href: e, initiator: `mcp_app_resource`, originHostId: n });
    },
    he = (e, t) => {
      switch (e.type) {
        case `file`:
  ...
  return {
    actions:
      m.kind === `git` ? [...z].sort((e, t) => (An[e.id] ?? z.length) - (An[t.id] ?? z.length)) : z,
...
var K,
  ...
  jn = e(() => {
    (u(),
      ...
      Lt(),
      (K = h()),
      (kn = n(a, ({ get: e }) => e(ee).filter((e) => e.entrypoint === `thread`))),
      (An = { review: 0, terminal: 1, browser: 2, "open-file": 3 }));
  });
function Mn(e) {
  switch (e.type) {
    case `file`:
...
function Ln(e) {
  ...
  switch (n.type) {
    ...
    case `generated-image`: {
      ...
      return (
        t[0] !== n.path || t[1] !== r || t[2] !== i
          ? ((e = (0, q.jsx)(fn, { iconClassName: r, imageClassName: i, path: n.path })),
            (t[0] = n.path),
            (t[1] = r),
            (t[2] = i),
            (t[3] = e))
    ...
    case `google-drive`: {
      ...
      return (
        t[4] !== n.resourceKind || t[5] !== r
          ? ((e = (0, q.jsx)(Bt, { className: r, resourceKind: n.resourceKind })),
            (t[4] = n.resourceKind),
            (t[5] = r),
            (t[6] = e))
          : (e = t[6]),
    ...
    case `appgen-app`: {
      let e;
      return (
        t[7] === r ? (e = t[8]) : ((e = (0, q.jsx)(an, { className: r })), (t[7] = r), (t[8] = e)),
        e
      );
    }
    case `website`: {
...
function Bn(e) {
            ...
            V.Item,
            {
              ...
              children: [
                e.mcpServerIcon == null
                  ? null
                  : (0, J.jsx)(V.ItemIcon, { children: ln(e.mcpServerIcon) }),
                e.title,
              ],
            },
            e.id,
  ...
  t[6] !== n.length || t[7] !== s || t[8] !== a || t[9] !== o
    ? ((l = s
        ? (0, J.jsxs)(J.Fragment, {
            children: [
              n.length > 0 ? (0, J.jsx)(V.Separator, {}) : null,
              (0, J.jsx)(V.SectionLabel, {
                children: (0, J.jsx)(G, {
              ...
              o.map((e) =>
                (0, J.jsxs)(
                  ...
                  {
                    onClickCapture: (t) => {
                      ft(t) && (t.preventDefault(), t.stopPropagation(), a(e, t));
                    },
                    onSelect: () => a(e),
                    children: [
                      (0, J.jsx)(V.ItemIcon, {
...
function Un(e) {
  ...
  return (
    t[7] !== i || t[8] !== c || t[9] !== d
      ? ((f = (0, Gn.jsx)(vt, { tooltipContent: i, shortcut: c, delayOpen: !0, children: d })),
        (t[7] = i),
        (t[8] = c),
        (t[9] = d),
        (t[10] = f))
...
function qn(e) {
  ...
  if (
    ...
    bb0: {
      ((j = o ? p.filter(Zn) : p),
        (v = $e({ preferredTarget: f, targets: j, availableTargets: m, mode: `editor` })),
      ...
      ((_ = tt),
        ...
        (k = `menuFixed`),
        (A = `pt-2`),
        (b = y ? nr.openPrimaryTarget : void 0),
        (x = y ? e : void 0),
        (S =
          n.length === 0
            ? (0, Y.jsx)(Qn, {})
  ...
  t[29] !== g || t[30] !== v
    ? ((N =
        v == null
          ? void 0
          : () => {
              g(v.target, { appPath: v.appPath, openMode: `workspace`, persistPreferred: !1 });
            }),
      (t[29] = g),
      (t[30] = v),
      (t[31] = N))
  ...
  t[35] === y
    ...
    : ((F = y
        ...
        : (0, Y.jsx)(`span`, {
            className: `truncate`,
            children: (0, Y.jsx)(G, { ...nr.openPrimaryTarget }),
          })),
      (t[35] = y),
      (t[36] = F));
  let I;
  t[37] !== P || t[38] !== F
    ? ((I = (0, Y.jsxs)(`span`, { className: `flex items-center gap-1.5`, children: [P, F] })),
      (t[37] = P),
      (t[38] = F),
      (t[39] = I))
    : (I = t[39]);
...
function ir(e) {
  let t = (0, ar.c)(5),
    ...
    a = o(yt, n),
    s;
  t[0] === i.cwd ? (s = t[1]) : ((s = i.cwd == null ? null : v(i.cwd)), (t[0] = i.cwd), (t[1] = s));
  let c = s;
  if (c == null || !a || i.kind !== `git` || r.kind === `remote-control`) return null;
  let l;
  return (
    t[2] !== c || t[3] !== r
      ? ((l = (0, or.jsx)(B.HeaderAction, {
          actionId: `thread-local-project-actions`,
          align: `end`,
          order: 100,
          children: (0, or.jsx)(qn, { cwd: c, hostConfig: r }),
        })),
        (t[2] = c),
        (t[3] = r),
        (t[4] = l))
...
function cr(e) {
  ...
  let { actions: a, onOpenArtifact: o, outputArtifacts: s } = On(i),
    c;
...
function ur(e) {
  ...
  t[0] === h
    ? (g = t[1])
    : ((g = at(`sticky top-0 z-10 flex flex-col gap-6 bg-token-main-surface-primary`, h)),
      (t[0] = h),
      (t[1] = g));
  let v;
  t[2] !== n || t[3] !== o
  ...
  t[5] === a
    ...
    : ((y =
      ...
      (t[6] = y));
  let b;
  t[7] !== d || t[8] !== g || t[9] !== v || t[10] !== y
    ? ((b = (0, Z.jsxs)(`div`, { ref: d, className: g, children: [v, y] })),
      (t[7] = d),
      (t[8] = g),
      (t[9] = v),
      (t[10] = y),
  ...
  t[12] !== f || t[13] !== r || t[14] !== s || t[15] !== a
    ? ((x =
        a == null
          ...
          : (0, Z.jsxs)(Z.Fragment, {
              children: [
                (0, Z.jsx)(fr, { headerHeight: f.height, root: s, onCoveredChange: u }),
  ...
  t[5] === r
    ...
    : ((l = r
        ? (0, Z.jsx)(`span`, {
            ...
            children: (0, Z.jsx)(gt, { keysLabel: r }),
          })
        : null),
      (t[5] = r),
      (t[6] = l));
...
function hr(e) {
  ...
  t[0] === o
    ...
    : ((s = at(
      ...
      (t[1] = s));
  let c;
  t[2] === n ? (c = t[3]) : ((c = Pn(n)), (t[2] = n), (t[3] = c));
  let l;
  ...
  t[13] === n
    ...
    : ((h = (0, Z.jsx)(`span`, {
      ...
      (t[14] = h));
  let g;
  t[15] === n ? (g = t[16]) : ((g = Nn(n)), (t[15] = n), (t[16] = g));
  let _;
  t[17] === g
    ? (_ = t[18])
    : ((_ = (0, Z.jsx)(`span`, {
    ...
    ((X = m()),
      ...
      (_r = {
        closed: {
          opacity: 0,
          y: -8,
          transition: { duration: 0.06, ease: pt.ease, when: `afterChildren` },
        },
        open: {
          opacity: 1,
          y: 0,
          transition: { duration: 0.09, ease: pt.ease, when: `beforeChildren` },
        },
      }),
      (vr = {
      ...
      (yr = {
        closed: { opacity: 0, y: -6, transition: { duration: 0.045, ease: pt.ease } },
        open: { opacity: 1, y: 0, transition: { duration: 0.075, ease: pt.ease } },
      }));
  });
function xr(e) {
  let t = (0, Q.c)(26),
    ...
    u = _(j),
    d = _(O) === `ready`,
    f = o(x, `toggleSidePanel`),
    p = `thread-${e.threadType}`,
    m = d && e.threadType === `remote` ? e.showReviewTab : d && r.kind === `git`,
    h = (0, kr.useRef)(null),
    g,
    v;
  (t[0] !== c || t[1] !== u || t[2] !== n
    ...
    (0, kr.useEffect)(g, v));
  let y;
  t[5] === n ? (y = t[6]) : ((y = () => zt(n)), (t[5] = n), (t[6] = y));
  let S;
  (t[7] === m ? (S = t[8]) : ((S = { enabled: m }), (t[7] = m), (t[8] = S)),
    Le(`openReviewTab`, y, S));
  let C, w;
  (t[9] !== a.id || t[10] !== d || t[11] !== e.threadType || t[12] !== n || t[13] !== i
    ? ((C = () => {
        !d ||
          e.threadType === `remote` ||
          i == null ||
          ye(n, null, { hostId: a.id, workspaceRoot: i });
      }),
      (w = [a.id, d, e.threadType, n, i]),
      (t[9] = a.id),
      (t[10] = d),
      (t[11] = e.threadType),
      (t[12] = n),
      ...
      ? ((E = (0, $.jsx)($.Fragment, {
          children:
            e.threadType === `remote`
              ? (0, $.jsxs)($.Fragment, {
                  children: [
                    (0, $.jsx)(Cr, { actionIdPrefix: p }),
                    (0, $.jsx)(Sr, {}),
                    (0, $.jsx)(B.HeaderAction, {
                      actionId: `${p}-panel-toggles`,
                      align: `end`,
                      order: 300,
                      slotPosition: `right`,
                      children: (0, $.jsx)(Un, {
                        label: l.formatMessage(jr.toggleSidePanel),
                        disabled: !e.showReviewTab,
                        pressed: u,
                        shortcut: f,
                        onClick: () => Rt(n),
                        children: u
                          ? (0, $.jsx)(Ae, { className: `icon-sm rotate-180` })
                          : (0, $.jsx)(me, { className: `icon-sm rotate-180` }),
                      }),
                    }),
                  ],
                })
              : (0, $.jsxs)($.Fragment, {
                  children: [
                    d && e.threadType === `local` && e.conversationId != null
...
function Sr() {
  let e = (0, Q.c)(7),
    t = s(U),
    n;
  e[0] === t ? (n = e[1]) : ((n = Pt(t)), (e[0] = t), (e[1] = n));
  let r = n,
    i;
  e[2] === r
    ? (i = e[3])
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(B.RightPanelOutlet, { children: (0, $.jsx)(B.RightPanelTabs, {}) })),
      (e[4] = a))
    : (a = e[4]);
  let o;
  return (
...
function Cr(e) {
  let t = (0, Q.c)(41),
    ...
    c = _(se) !== !1,
    l = _(z),
    u = o(x, `toggleBottomPanel`),
    d = _(F.tabs$).length,
    f = _(O) === `ready`,
    p;
  t[0] !== f || t[1] !== r ? ((p = f && D(r)), (t[0] = f), (t[1] = r), (t[2] = p)) : (p = t[2]);
  let m = p,
    h;
  t[3] !== d || t[4] !== m || t[5] !== c || t[6] !== a || t[7] !== r
    ? ((h = () => {
        if (c) {
          if (a) {
            P(r, `bottom`);
          ...
          we(r, `bottom`, { activateFallbackTab: !0, allowEmpty: !0 }) && r.get(S) && Or();
        }
      }),
      (t[3] = d),
      (t[4] = m),
  ...
  (t[9] !== m || t[10] !== r || t[11] !== l
    ...
    : (v = t[12]),
    b(`toggle-terminal`, v),
    Le(`toggleBottomPanel`, g));
  let y;
  (t[13] !== m || t[14] !== r || t[15] !== l
    ? ((y = () => {
        m && re(r, void 0, l);
      }),
      (t[13] = m),
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, $.jsx)(B.BottomPanelOutlet, { children: (0, $.jsx)(B.BottomPanelTabs, {}) })),
      (t[18] = w))
    : (w = t[18]);
  let T;
  t[19] !== i || t[20] !== f
    ? ((T = f
        ? (0, $.jsx)(B.BottomPanelTabListAfterSticky, {
            children: (0, $.jsx)(wr, {
              target: `bottom`,
  ...
  t[22] === i
    ...
    : ((E = i.formatMessage({
      ...
      (t[23] = E));
  let k;
  t[24] === r ? (k = t[25]) : ((k = () => P(r, `bottom`)), (t[24] = r), (t[25] = k));
  let A;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, $.jsx)(ut, { className: `icon-xs` })), (t[26] = A))
    : (A = t[26]);
  let j;
  t[27] !== E || t[28] !== k
    ? ((j = (0, $.jsx)(B.BottomPanelTabListAfter, {
        children: (0, $.jsx)(ze, {
          color: `ghost`,
          size: `toolbar`,
          uniform: !0,
    ...
    : (j = t[29]);
  let M;
  t[30] !== n || t[31] !== i || t[32] !== c || t[33] !== a || t[34] !== g || t[35] !== u
    ? ((M = c
        ? (0, $.jsx)(B.HeaderAction, {
            ...
            children: (0, $.jsx)(Un, {
              ...
              onClick: g,
              children: a
                ? (0, $.jsx)(Tn, { className: `icon-sm` })
                : (0, $.jsx)(Sn, { className: `icon-sm` }),
            }),
          })
        : null),
      (t[30] = n),
  ...
  let N;
  return (
    t[37] !== j || t[38] !== M || t[39] !== T
      ? ((N = (0, $.jsxs)($.Fragment, { children: [C, w, T, j, M] })),
        (t[37] = j),
        (t[38] = M),
        (t[39] = T),
        (t[40] = N))
...
function wr(e) {
  ...
  let { actions: a, hasOutputArtifacts: o, onOpenArtifact: s, outputArtifacts: c } = On(i),
    l;
  t[2] === n ? (l = t[3]) : ((l = ne(n)), (t[2] = n), (t[3] = l));
  let u = _(l.tabs$).length,
    d = (0, kr.useRef)(null);
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, $.jsx)(Ke, { className: `icon-xs` })), (t[5] = p))
    : (p = t[5]);
  let m;
  t[6] === r
    ? (m = t[7])
...
function Tr() {
  ...
  return (
    e[4] !== n || e[5] !== i
      ? ((o = (0, $.jsx)(B.HeaderContextMenuItem, {
          checked: n,
...
function Er(e) {
  let t = (0, Q.c)(28),
    n = s(U),
    r;
  t[0] === n ? (r = t[1]) : ((r = Pt(n)), (t[0] = n), (t[1] = r));
  let i = r,
    a = W(),
    c = _(j),
    l = _(O) === `ready`,
    u = o(x, `toggleSidePanel`),
    d;
  t[2] === i
    ? (d = t[3])
    : ((d = (0, $.jsx)(Dr, { browserConversationId: i })), (t[2] = i), (t[3] = d));
  let f;
  t[4] === l ? (f = t[5]) : ((f = null), (t[4] = l), (t[5] = f));
  let p;
  t[6] === Symbol.for(`react.memo_cache_sentinel`) ? ((p = null), (t[6] = p)) : (p = t[6]);
  let m;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(B.RightPanelOutlet, { children: (0, $.jsx)(B.RightPanelTabs, {}) })),
      (t[7] = m))
    : (m = t[7]);
  let h;
  t[8] !== a || t[9] !== l
    ? ((h = l
        ? (0, $.jsxs)($.Fragment, {
            children: [
              (0, $.jsx)(B.RightPanelTabsEmptyState, { children: (0, $.jsx)(cr, {}) }),
              (0, $.jsx)(B.RightPanelTabListAfterSticky, {
                children: (0, $.jsx)(wr, {
                  target: `right`,
  ...
  let v;
  t[13] === n ? (v = t[14]) : ((v = () => Rt(n)), (t[13] = n), (t[14] = v));
  let y;
  t[15] === c
    ? (y = t[16])
    : ((y = c
      ...
      (t[16] = y));
  let b;
  t[17] !== c || t[18] !== g || t[19] !== v || t[20] !== y || t[21] !== u
    ? ((b = (0, $.jsx)(B.HeaderAction, {
        actionId: `thread-side-panel-close`,
        align: `end`,
        slotPosition: `right`,
        order: 300,
        children: (0, $.jsx)(Un, { label: g, pressed: c, shortcut: u, onClick: v, children: y }),
      })),
      (t[17] = c),
      (t[18] = g),
      (t[19] = v),
  ...
  let S;
  return (
    t[23] !== b || t[24] !== d || t[25] !== f || t[26] !== h
      ? ((S = (0, $.jsxs)($.Fragment, { children: [d, f, p, m, h, b] })),
        (t[23] = b),
        (t[24] = d),
        (t[25] = f),
        (t[26] = h),
...
export { Mr as n, Dn as r, xr as t };
