...
function E(e) {
  ...
  t[12] === u
    ? (d = t[13])
    : ((d = (0, O.jsx)(`span`, { className: `truncate`, children: u })), (t[12] = u), (t[13] = d));
  let f;
...
function A(e) {
  ...
  let _ = l ? d : void 0,
    ...
    b = n[h],
    x;
  t[8] !== h || t[9] !== n || t[10] !== l || t[11] !== p
    ? ((x = l ? (0, P.jsx)(u, { className: p }) : (n[h].label ?? (0, P.jsx)(j, { action: h }))),
      (t[8] = h),
      (t[9] = n),
      (t[10] = l),
      (t[11] = p),
  ...
  return (
    t[20] !== g || t[21] !== S
      ? ((w = (0, P.jsxs)(P.Fragment, { children: [g, S] })), (t[20] = g), (t[21] = S), (t[22] = w))
      : (w = t[22]),
    w
  );
}
...
function B(e) {
  ...
  let f;
  t[4] !== u || t[5] !== l
    ? ((f = (0, H.jsxs)(`button`, { type: `button`, className: l, children: [u, d] })),
      (t[4] = u),
      (t[5] = l),
      (t[6] = f))
    : (f = t[6]);
