...
function E(e) {
  ...
  n[7] !== b || n[8] !== o || n[9] !== x || n[10] !== S
    ? ((C = { items: o, isActive: b, onSelect: x, onEscape: S }),
      ...
      (n[11] = C))
    : (C = n[11]);
  let { highlightedIndex: w, listRef: T, getInputProps: E, getItemProps: D } = g(C),
    O;
  ...
  n[32] !== N || n[33] !== O || n[34] !== f
    ...
    : (P = n[35]);
  let F;
  n[36] !== i || n[37] !== D || n[38] !== w || n[39] !== b || n[40] !== T || n[41] !== o
    ? ((F = b
        ? (0, v.jsx)(`div`, {
            ...
            children: (0, v.jsx)(`div`, {
              ref: T,
              className: t(`flex max-h-64 flex-col overflow-y-auto p-1`, o == null && `min-h-64`),
              role: `listbox`,
              children:
                o == null
                  ? (0, v.jsx)(`div`, {
    ...
    ? ((p = async () => {
        ...
        return (
          await o.safeGet(`/accounts/{account_id}/users`, {
            parameters: { path: { account_id: r }, query: { limit: 10, offset: 0, query: u } },
          })
        ).items;
      }),
      (t[5] = r),
...
export { T as a, b as c, E as i, y as l, O as n, w as o, D as r, C as s, A as t };
