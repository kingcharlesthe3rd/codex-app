            ...
            `span`,
            {
              ...
              children: [
                ...
                (0, v.jsx)(`button`, {
                  ...
                  children: (0, v.jsx)(p, { "aria-hidden": !0, className: `icon-2xs` }),
                }),
              ],
            },
            e.id,
...
function P(e) {
  ...
  t[2] !== i || t[3] !== s
    ...
    : (c = t[4]);
  let d = a === `chatgpt` && i != null && s.length > 0,
    p;
  t[5] !== i || t[6] !== s
    ? ((p = async () => {
  ...
  return (
    t[8] !== c || t[9] !== d || t[10] !== p
      ? ((m = { queryKey: c, enabled: d, queryFn: p, staleTime: r.ONE_MINUTE }),
        (t[8] = c),
        (t[9] = d),
        (t[10] = p),
        (t[11] = m))
