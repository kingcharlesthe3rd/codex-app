...
function A(e) {
  ...
  t[8] !== h || t[9] !== n || t[10] !== l || t[11] !== f
    ? ((x = l ? (0, P.jsx)(s, { className: f }) : (n[h].label ?? (0, P.jsx)(j, { action: h }))),
      (t[8] = h),
      (t[9] = n),
      (t[10] = l),
      (t[11] = f),
  ...
  return (
    t[20] !== g || t[21] !== S
      ? ((C = (0, P.jsxs)(P.Fragment, { children: [g, S] })), (t[20] = g), (t[21] = S), (t[22] = C))
      : (C = t[22]),
    C
  );
}
...
function B(e) {
  ...
  let p;
  t[4] !== u || t[5] !== l
    ? ((p = (0, H.jsxs)(`button`, { type: `button`, className: l, children: [u, d] })),
      (t[4] = u),
      (t[5] = l),
      (t[6] = p))
    : (p = t[6]);
