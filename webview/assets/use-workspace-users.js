...
function E(e) {
  ...
  t[5] === s
    ? (c = t[6])
    : ((c = s == null ? null : (0, O.jsx)(s, { "aria-hidden": !0, className: `icon-xs` })),
      (t[5] = s),
      (t[6] = c));
  let l;
  t[7] === c
  ...
  t[12] === u
    ? (f = t[13])
    : ((f = (0, O.jsx)(`span`, { className: `truncate`, children: u })), (t[12] = u), (t[13] = f));
  let p;
...
function A(e) {
  ...
  t[8] !== m || t[9] !== r || t[10] !== l || t[11] !== f
    ? ((S = l ? (0, P.jsx)(b, { className: f }) : (r[m].label ?? (0, P.jsx)(j, { action: m }))),
      (t[8] = m),
      (t[9] = r),
      (t[10] = l),
      (t[11] = f),
  ...
  return (
    t[20] !== h || t[21] !== C
      ? ((w = (0, P.jsxs)(P.Fragment, { children: [h, C] })), (t[20] = h), (t[21] = C), (t[22] = w))
      : (w = t[22]),
    w
  );
}
...
function B(e) {
  ...
  let p;
  t[4] !== u || t[5] !== l
    ? ((p = (0, H.jsxs)(`button`, { type: `button`, className: l, children: [u, f] })),
      (t[4] = u),
      (t[5] = l),
      (t[6] = p))
    : (p = t[6]);
...
function Y(e) {
  ...
  t[2] !== n || t[3] !== s
    ...
    : (c = t[4]);
  let d = i === `chatgpt` && n != null && s.length > 0,
    f;
  t[5] !== n || t[6] !== s
    ? ((f = async () => {
        ...
        return (
          await l.safeGet(`/accounts/{account_id}/users`, {
            parameters: { path: { account_id: n }, query: { limit: 10, offset: 0, query: s } },
          })
        ).items;
      }),
      (t[5] = n),
  ...
  return (
    t[8] !== c || t[9] !== d || t[10] !== f
      ? ((p = { queryKey: c, enabled: d, queryFn: f, staleTime: a.ONE_MINUTE }),
        (t[8] = c),
        (t[9] = d),
        (t[10] = f),
        (t[11] = p))
