...
import { u as n, v as r } from "./vscode-api.js";
import { s as i } from "./lib-1.js";
...
import { r as m, t as h } from "./dropdown.js";
import { t as g } from "./list-navigation.js";
var _ = t(),
  v = e();
function y(e) {
  let t = (0, _.c)(30),
  ...
  t[5] === s
    ? (l = t[6])
    : ((l = s == null ? null : (0, v.jsx)(s, { "aria-hidden": !0, className: `icon-xs` })),
      (t[5] = s),
      (t[6] = l));
  let u;
  t[7] === l
    ...
    : ((u = (0, v.jsx)(`span`, {
      ...
      (t[8] = u));
  let f;
  t[9] !== r || t[10] !== i ? ((f = r(i)), (t[9] = r), (t[10] = i), (t[11] = f)) : (f = t[11]);
  let p;
  t[12] === f
    ? (p = t[13])
    : ((p = (0, v.jsx)(`span`, { className: `truncate`, children: f })), (t[12] = f), (t[13] = p));
  let g;
...
function b(e) {
  let t = (0, _.c)(23),
    {
      ...
      cancelAction: r,
      disabled: a,
      hasPendingAccessChange: c,
      hasPendingInvitees: l,
      idleActions: u,
      isSaving: d,
      savingAriaLabel: f,
      size: p,
    ...
    h;
  t[0] !== c || t[1] !== l
    ? ((h = S({ hasPendingAccessChange: c, hasPendingInvitees: l })),
      (t[0] = c),
      (t[1] = l),
      (t[2] = h))
    : (h = t[2]);
  let g = h;
  if (g == null) return u ?? null;
  let y;
  t[3] !== r || t[4] !== a || t[5] !== d || t[6] !== p
    ? ((y =
        r == null
          ? null
          : (0, v.jsx)(o, {
  ...
  let b = d ? f : void 0,
    ...
    T = n[g],
    E;
  t[8] !== g || t[9] !== n || t[10] !== d || t[11] !== m
    ? ((E = d ? (0, v.jsx)(s, { className: m }) : (n[g].label ?? (0, v.jsx)(x, { action: g }))),
      (t[8] = g),
      (t[9] = n),
      (t[10] = d),
      (t[11] = m),
  ...
  return (
    t[20] !== y || t[21] !== D
      ? ((O = (0, v.jsxs)(v.Fragment, { children: [y, D] })), (t[20] = y), (t[21] = D), (t[22] = O))
      : (O = t[22]),
    O
  );
}
...
function E(e) {
  let t = (0, _.c)(50),
    ...
    b;
  t[0] === d ? (b = t[1]) : ((b = d.trim()), (t[0] = d), (t[1] = b));
  let x = b.length > 0,
    S;
  t[2] !== c || t[3] !== o
    ? ((S = c?.flatMap(D) ?? o), (t[2] = c), (t[3] = o), (t[4] = S))
    : (S = t[4]);
  let C = S,
    w;
  t[5] !== m || t[6] !== y
            ...
            `span`,
            {
              ...
              children: [
                ...
                (0, v.jsx)(`button`, {
                  ...
                  children: (0, v.jsx)(l, { "aria-hidden": !0, className: `icon-2xs` }),
                }),
              ],
            },
            e.id,
  ...
  let I;
  t[24] !== M || t[25] !== F
    ? ((I = M({ onKeyDown: F })), (t[24] = M), (t[25] = F), (t[26] = I))
    : (I = t[26]);
  let L = f.length === 0 ? u : void 0,
    R;
  t[27] === m
    ? (R = t[28])
    : ((R = (e) => {
      ...
      (t[28] = R));
  let z;
  t[29] !== n || t[30] !== d || t[31] !== R || t[32] !== I || t[33] !== L
    ? ((z = (0, v.jsx)(`input`, {
        ...I,
        "aria-label": n,
    ...
    ? ((V = x
        ? (0, v.jsx)(`div`, {
            ...
            children: (0, v.jsx)(`div`, {
              ref: j,
              className: a(`flex max-h-64 flex-col overflow-y-auto p-1`, C == null && `min-h-64`),
              role: `listbox`,
              children:
                C == null
                  ? (0, v.jsx)(`div`, {
                      className: `flex flex-1 items-center justify-center text-token-description-foreground`,
                      children: (0, v.jsx)(s, { className: `icon-xs` }),
                    })
                  : C.length === 0
                    ? (0, v.jsx)(`div`, {
                    ...
                    : c == null
                      ...
                      : (0, v.jsx)(O, { highlightedIndex: k, optionSections: c, getItemProps: N }),
            }),
          })
        : null),
      (t[39] = r),
...
function A(e) {
  let t = (0, _.c)(20),
    { highlightedIndex: n, index: r, option: i, getItemProps: o } = e,
    s = i.Icon,
    c;
  t[0] !== o || t[1] !== r ? ((c = o(r)), (t[0] = o), (t[1] = r), (t[2] = c)) : (c = t[2]);
  let l = r === n,
    u = r === n && `bg-token-list-hover-background`,
    d;
  t[3] === u
    ? (d = t[4])
    : ((d = a(
  ...
  t[7] === i.label
    ? (p = t[8])
    : ((p = (0, v.jsx)(`span`, { className: `text-sm text-token-foreground`, children: i.label })),
      (t[7] = i.label),
      (t[8] = p));
  let m;
  t[9] === i.secondaryLabel
    ? (m = t[10])
    : ((m =
        i.secondaryLabel == null
          ? null
          : (0, v.jsx)(`span`, {
              className: `text-sm text-token-description-foreground`,
              children: i.secondaryLabel,
            })),
      (t[9] = i.secondaryLabel),
      (t[10] = m));
  let h;
  ...
  let g;
  return (
    t[14] !== c || t[15] !== l || t[16] !== d || t[17] !== f || t[18] !== h
      ? ((g = (0, v.jsxs)(`button`, {
          type: `button`,
          ...c,
          "aria-selected": l,
...
function j(e) {
  let t = (0, _.c)(23),
    ...
    u =
      a === void 0
        ...
        : a,
    f;
  t[0] !== r || t[1] !== o ? ((f = r(o)), (t[0] = r), (t[1] = o), (t[2] = f)) : (f = t[2]);
  let p;
  ...
  let g;
  t[4] !== f || t[5] !== u
    ? ((g = (0, v.jsxs)(`button`, { type: `button`, className: u, children: [f, p] })),
      (t[4] = f),
      (t[5] = u),
      (t[6] = g))
    : (g = t[6]);
...
function P(e) {
  ...
  t[5] !== i || t[6] !== s
    ? ((d = async () => {
        ...
        return (
          await u.safeGet(`/accounts/{account_id}/users`, {
  ...
  return (
    t[8] !== c || t[9] !== l || t[10] !== d
      ? ((m = { queryKey: c, enabled: l, queryFn: d, staleTime: n.ONE_MINUTE }),
        (t[8] = c),
        (t[9] = l),
        (t[10] = d),
        (t[11] = m))
...
function F(e) {
  ...
  t[5] !== i || t[6] !== s
    ? ((d = async () => {
        if (i == null) throw Error(`account id is required`);
        return (
          await u.safeGet(`/accounts/{account_id}/groups`, {
            parameters: { path: { account_id: i }, query: { limit: 10, offset: 0, query: s } },
          })
        ).items;
      }),
