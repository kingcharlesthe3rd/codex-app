...
import { Yr as c } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~new-thread-panel-page~o~hgx54pg3.js";
import {
  Cs as l,
  Hs as u,
  Us as d,
...
e(() => {
  if (
    ...
    (document.documentElement.dataset.codexWindowChrome = j(`electron`, B)),
