...
import { h as i } from "./app-initial~app-main~onboarding-page.js";
function a(e) {
...
var Fe,
  ...
  X,
  Re = e(() => {
    ((Le = t(n(), 1)), (X = typeof window < `u` ? Le.useLayoutEffect : Le.useEffect));
  });
function ze(e) {
...
var We,
  ...
  qe,
  Je = e(() => {
    ((Ke = t(n(), 1)), Ge(), (qe = `19.2.5`.split(`.`)[0] === `17` ? Ue : Ke.useId));
  });
