    ...
    (i(),
      ...
      (E = (function () {
        ...
        return (
          ...
          (e.prototype.page = function (e, n, r, i, a) {
            ...
            return (
              ...
              n !== null && (o.name = n),
              this.normalize(t(t({}, this.baseEvent()), o))
            );
          }),
          (e.prototype.screen = function (e, n, r, i, a) {
          ...
          (e.prototype.alias = function (e, n, r, i) {
            ...
            var a = { userId: e, type: `alias`, options: t({}, r), integrations: t({}, i) };
            return (
              n !== null && (a.previousId = n),
              e === void 0
                ? this.normalize(t(t({}, a), this.baseEvent()))
                : this.normalize(t(t({}, this.baseEvent()), a))
            );
          }),
          ...
          (e.prototype.normalize = function (e) {
            var n = Object.keys(e.integrations ?? {}).reduce(function (n, r) {
              var i;
              return t(t({}, n), ((i = {}), (i[r] = !!e.integrations?.[r]), i));
            }, {});
            e.options = p(e.options || {}, function (e, t) {
              return t !== void 0;
            });
            var r = t(t({}, n), e.options?.integrations),
              i = e.options ? this.context(e.options) : [],
              a = i[0],
              o = i[1],
              c = e.options,
              l = s(e, [`options`]),
              u = t(t(t(t({ timestamp: new Date() }, l), { context: a, integrations: r }), o), {
        ...
        return (
          ...
          (e.prototype.flush = function () {
            if (this.logs.length > 1) {
              var e = this._logs.reduce(function (e, n) {
                var r,
                  i = t(t({}, n), { json: JSON.stringify(n.extras, null, ` `), extras: n.extras });
                delete i.time;
                var a = n.time?.toISOString() ?? ``;
                return (
                  e[a] && (a = `${a}-${Math.random()}`), t(t({}, e), ((r = {}), (r[a] = i), r))
                );
              }, {});
      ...
      (Q = (function (e) {
        ...
        return (
            ...
            return o(this, void 0, void 0, function () {
              ...
              return a(this, function (a) {
                switch (a.label) {
                  ...
                  case 1:
                    return (a.trys.push([1, 3, , 4]), [4, t.load(e, n)]);
                  case 2:
                    return (a.sent(), [3, 4]);
                  case 3:
                    return ((i = a.sent()), r(i), [3, 4]);
                  case 4:
                    return [2];
                }
              });
          ...
          (t.prototype.flushOne = function (e) {
            return o(this, void 0, void 0, function () {
              var t, n, r, i, o, s, c, l, u, d, c, f, p, m, h;
              return a(this, function (a) {
                switch (a.label) {
                  case 0:
                    ...
                    (e.attempts > 1 && this.emit(`delivery_retry`, e),
                      ...
                      (a.label = 1));
                  case 1:
                    return i < o.length ? ((s = o[i]), [4, we(e, s)]) : [3, 4];
                  case 2:
                    ((c = a.sent()),
                      c instanceof K && (e = c),
    ...
    return a(this, function (a) {
      switch (a.label) {
        ...
        case 3:
          ((o = a.sent()), (a.label = 4));
        case 4:
          return r?.callback ? [4, de(o, r.callback, $(i, r.timeout))] : [3, 6];
        case 5:
          ((o = a.sent()), (a.label = 6));
        case 6:
