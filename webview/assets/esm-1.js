...
import { t as i } from "./app-initial~app-main~page~onboarding-page~skills-settings~plugins-settings~remote-connectio~c59x15mv.js";
function a(e) {
    ...
    re = class {
      ...
      on(e, t, n) {
        ...
        if (
          ...
          return (
            this.debugLog(`Event bus client is disabled, not registering event`, i), () => {}
          );
        let a = (e) => {
...
function pe() {
  ...
  for (; e < 16; e++)
    ((t = z[L + e]),
      e === 6 ? (n += R[(t & 15) | 64]) : e === 8 ? (n += R[(t & 63) | 128]) : (n += R[t]),
      e & 1 && e > 1 && e < 11 && (n += `-`));
  return (L++, n);
}
var me,
  ...
  B = e(() => {
    ...
    ye = T((e) => E.emit(`form-state`, { id: e.formId, state: e.store.state }), { wait: 300 });
  }),
  V,
  be = e(() => {
    V = (e) => {
  ...
  Oe = e(() => {
    (w(),
      ...
      (De = class {
          ...
          ((this.options = {}),
            ...
            (this.mount = () => {
              let e = this.fieldMetaDerived.mount(),
                ...
                o = () => {
                  (a(), i(), r(), n(), e(), t(), E.emit(`form-unmounted`, { id: this._formId }));
                };
            ...
            (this.update = (e) => {
              ...
              let n = !!e.transform?.deps?.some((e, t) => e !== this.prevTransformArray[t]),
                r =
                  e.defaultValues && !A(e.defaultValues, t.defaultValues) && !this.state.isTouched,
              ...
              return (
                l(() => {
                  Object.values(this.fieldInfo).forEach((n) => {
                    ...
                    let r = n.instance;
                    (t.push(
                      Promise.resolve().then(() => r.validate(e, { skipFormValidation: !0 })),
                    ),
            ...
            (this.validateField = (e, t) => {
              ...
              return n
                ? (n.state.meta.isTouched || n.setMeta((e) => ({ ...e, isTouched: !0 })),
                  n.validate(t))
                : [];
            }),
            (this.validateSync = (e) => {
                ...
                l(() => {
                  for (let e of t) {
                    ...
                    for (let e of o) {
                      ...
                      let { errorMap: t, errorSourceMap: n } = this.getFieldMeta(e) ?? W,
                        o = i?.[e],
            ...
            (this.setFieldMeta = (e, t) => {
              this.baseStore.setState((n) => ({
                ...n,
                fieldMetaBase: { ...n.fieldMetaBase, [e]: D(t, n.fieldMetaBase[e]) },
              }));
            }),
            ...
            (this.setFieldValue = (e, t, n) => {
              ...
              (l(() => {
                (r ||
                  ...
                  this.baseStore.setState((n) => ({ ...n, values: k(n.values, e, t) })));
              }),
            ...
            (this.clearFieldValues = (e, t) => {
              ...
              if ((this.setFieldValue(e, [], j(t, { dontValidate: !0 })), r !== null))
                for (let t = 0; t <= r; t++) {
                  let n = `${e}[${t}]`;
                  this.deleteField(n);
                }
            ...
            (this.parseValuesWithSchema = (e) =>
              H.validate({ value: this.state.values, validationSource: `form` }, e)),
            (this.parseValuesWithSchemaAsync = (e) =>
              H.validateAsync({ value: this.state.values, validationSource: `form` }, e)),
            (this.timeoutIds = { validations: {}, listeners: {}, formListeners: {} }),
            (this._formId = e?.formId ?? pe()),
            (this._devtoolsSubmissionOverride = !1),
            (this.baseStore = new b(
              Ee({ ...e?.defaultState, values: e?.defaultValues ?? e?.defaultState?.values }),
            )),
                ...
                for (let e of Object.keys(a.fieldMetaBase)) {
                  ...
                  let d = !ue(u),
                    ...
                    p =
                      ...
                      A(l, this.getFieldInfo(e)?.instance?.options.defaultValue);
                  if (
                    c &&
                    c.isPristine === f &&
                    c.isValid === d &&
              ...
              fn: ({ prevDepVals: e, currDepVals: t, prevVal: n }) => {
                ...
                (!i || a.errorMap !== i.errorMap) &&
                  (v = Object.values(a.errorMap).reduce(
                    (e, t) => (t === void 0 ? e : t && P(t) ? (e.push(t.form), e) : (e.push(t), e)),
                    [],
                  ));
                let y = v.length === 0,
                  b = l && y,
        ...
        runValidator(e) {
          return Ce(e.validate) ? H[e.type](e.value, e.validate) : e.validate(e.value);
        }
        handleSubmit(e) {
        ...
        constructor(e) {
          ((this.options = {}),
            (this.mount = () => {
              ...
              return (
                this.options.listeners?.onMount?.({ value: this.state.value, fieldApi: this }), e
              );
            }),
            (this.update = (e) => {
              ((this.options = e),
            ...
            (this.pushValue = (e, t) => {
              (this.form.pushFieldValue(this.name, e, j(t, { dontRunListeners: !0 })),
                t?.dontRunListeners || this.triggerOnChangeListener());
            }),
            (this.insertValue = (e, t, n) => {
              (this.form.insertFieldValue(this.name, e, t, j(n, { dontRunListeners: !0 })),
                n?.dontRunListeners || this.triggerOnChangeListener());
            }),
            (this.replaceValue = (e, t, n) => {
              (this.form.replaceFieldValue(this.name, e, t, j(n, { dontRunListeners: !0 })),
                n?.dontRunListeners || this.triggerOnChangeListener());
            }),
            (this.removeValue = (e, t) => {
              (this.form.removeFieldValue(this.name, e, j(t, { dontRunListeners: !0 })),
                t?.dontRunListeners || this.triggerOnChangeListener());
            }),
            (this.swapValues = (e, t, n) => {
              (this.form.swapFieldValues(this.name, e, t, j(n, { dontRunListeners: !0 })),
                n?.dontRunListeners || this.triggerOnChangeListener());
            }),
            (this.moveValue = (e, t, n) => {
              (this.form.moveFieldValues(this.name, e, t, j(n, { dontRunListeners: !0 })),
                n?.dontRunListeners || this.triggerOnChangeListener());
            }),
            (this.clearValues = (e) => {
              (this.form.clearFieldValues(this.name, j(e, { dontRunListeners: !0 })),
            ...
            (this.validateAsync = async (e, t) => {
              ...
              let u = [];
              if (
                ((o.length || s.length) && ((u = await Promise.all(o)), await Promise.all(s)), c)
              ) {
            ...
            (this.validate = (e, t) => {
              ...
              if (r && !this.options.asyncAlways)
                return (
                  this.getInfo().validationMetaMap[q(e)]?.lastAbortController.abort(),
            ...
            (this.parseValueWithSchema = (e) =>
              H.validate({ value: this.state.value, validationSource: `field` }, e)),
            (this.parseValueWithSchemaAsync = (e) =>
              H.validateAsync({ value: this.state.value, validationSource: `field` }, e)),
            ...
            (this.store = new S({
              ...
              fn: ({ prevVal: t }) => {
                let n = t,
                  r = this.form.getFieldMeta(this.name) ?? { ...W, ...e.defaultMeta },
...
var Fe,
  ...
  X,
  Re = e(() => {
    ((Le = t(r(), 1)), (X = typeof window < `u` ? Le.useLayoutEffect : Le.useEffect));
  });
function ze(e) {
...
var Be,
  ...
  He = e(() => {
    ((Be = n()),
      ...
      (Ve = ({ children: e, ...t }) => {
        let n = ze(t);
        return (0, Be.jsx)(Be.Fragment, { children: (0, Z.useMemo)(() => D(e, n), [e, n]) });
      }));
  });
function Ue() {
...
var We,
  ...
  qe,
  Je = e(() => {
    ((Ke = t(r(), 1)), Ge(), (qe = `19.2.5`.split(`.`)[0] === `17` ? Ue : Ke.useId));
  });
  ...
  let o = (0, $.useMemo)(() => {
    ...
    return (
      ...
      (e.Subscribe = function (e) {
        return (0, Q.jsx)(Ye, { form: i, selector: e.selector, children: e.children });
      }),
      e
    );
  }, [i]);
