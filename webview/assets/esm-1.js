...
function d(e, t, n) {
  ...
  for (
    ...
    r < i && ((s = `` + t[r++]), !(s === `__proto__` || s === `constructor` || s === `prototype`));
  )
    a = a[s] =
      r === i
        ? n
...
var x,
  ...
  C,
  w = e(() => {
    (g(), b(), (x = `is not a string`), (S = `is not an object`), (C = `is nil`));
  }),
  T,
  E,
  le = e(() => {
    (s(),
      ...
      (E = (function () {
        ...
        return (
          ...
          (e.prototype.page = function (e, t, r, i, a) {
            ...
            return (
              ...
              t !== null && (o.name = t),
              this.normalize(n(n({}, this.baseEvent()), o))
            );
          }),
          (e.prototype.screen = function (e, t, r, i, a) {
          ...
          (e.prototype.identify = function (e, t, r, i) {
            return (
          ...
          (e.prototype.group = function (e, t, r, i) {
            return (
          ...
          (e.prototype.alias = function (e, t, r, i) {
            this.settings.onEventMethodCall({ type: `alias`, options: r });
            var a = { userId: e, type: `alias`, options: n({}, r), integrations: n({}, i) };
            return (
              t !== null && (a.previousId = t),
              e === void 0
                ? this.normalize(n(n({}, a), this.baseEvent()))
                : this.normalize(n(n({}, this.baseEvent()), a))
            );
          }),
          ...
          (e.prototype.normalize = function (e) {
            var t = Object.keys(e.integrations ?? {}).reduce(function (t, r) {
              var i;
              return n(n({}, t), ((i = {}), (i[r] = !!e.integrations?.[r]), i));
            }, {});
            e.options = p(e.options || {}, function (e, t) {
              return t !== void 0;
            });
            var i = n(n({}, t), e.options?.integrations),
              a = e.options ? this.context(e.options) : [],
              o = a[0],
              s = a[1],
              c = e.options,
              l = r(e, [`options`]),
              u = n(n(n(n({ timestamp: new Date() }, l), { context: o, integrations: i }), s), {
...
function de(e, t, n) {
  ...
  return ue(n)
    ...
    .catch(function (t) {
      (e?.log(`warn`, `Callback Error`, { error: t }), e?.stats.increment(`callback_error`));
    })
    .then(function () {
      return e;
    });
...
var O = e(() => {}),
  ...
  me = e(() => {
    A = (function () {
      function e(e) {
        ((this.callbacks = {}), (this.warned = !1), (this.maxListeners = e?.maxListeners ?? 10));
      }
      return (
    ...
    (s(),
      ...
      (N = (function (e) {
        ...
        function t(t, n, r) {
          ...
          return ((i.future = []), (i.maxAttempts = t), (i.queue = n), (i.seen = r ?? {}), i);
        }
        return (
...
function F() {
  ...
  for (; e < 16; e++)
    ((t = R[I + e]),
      e == 6 ? (n += L[(t & 15) | 64]) : e == 8 ? (n += L[(t & 63) | 128]) : (n += L[t]),
      e & 1 && e > 1 && e < 11 && (n += `-`));
  return (I++, n);
}
var I,
          ...
          (e.prototype.flush = function () {
            if (this.logs.length > 1) {
              var e = this._logs.reduce(function (e, t) {
                var r,
                  i = n(n({}, t), { json: JSON.stringify(t.extras, null, ` `), extras: t.extras });
                delete i.time;
                var a = t.time?.toISOString() ?? ``;
                return (
                  e[a] && (a = `${a}-${Math.random()}`), n(n({}, e), ((r = {}), (r[a] = i), r))
                );
              }, {});
              ...
              this.logs.forEach(function (e) {
                var t = e.level,
                  n = e.message,
                  r = e.extras;
                t === `info` || t === `debug` ? console.log(n, r ?? ``) : console[t](n, r ?? ``);
              });
            this._logs = [];
          }),
          e
...
function ye(e, n) {
  ...
  return (
    e.forEach(function (e) {
      ...
      } else n instanceof Function && (i = n(e));
      i !== void 0 && (r[i] = t(t([], r[i] ?? [], !0), [e], !1));
    }),
    r
  );
}
    ...
    (s(),
      ...
      (Q = (function (e) {
        ...
        return (
            ...
            return o(this, void 0, void 0, function () {
              ...
              return i(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return (i.trys.push([1, 3, , 4]), [4, t.load(e, n)]);
                  case 2:
                    return (i.sent(), [3, 4]);
                  case 3:
                    return ((a = i.sent()), r(a), [3, 4]);
                  case 4:
                    return [2];
                }
              });
          ...
          (t.prototype.deregister = function (e, t, n) {
            return o(this, void 0, void 0, function () {
              var r;
              return i(this, function (i) {
                switch (i.label) {
          ...
          (t.prototype.enqueuRetry = function (e, t) {
            return !(e instanceof G) || e.retry ? this.queue.pushWithBackoff(t) : !1;
          }),
          (t.prototype.flush = function () {
            return o(this, void 0, void 0, function () {
              var e, t, n;
                ...
                switch (r.label) {
                  ...
                  case 3:
                    return (
                      ...
                      n || (e.setFailedDelivery({ reason: t }), this.emit(`flush`, e, !1)),
                      [2, []]
                    );
                  case 4:
                    return [2, [e]];
    ...
    return i(this, function (i) {
      switch (i.label) {
        ...
        case 3:
          ((o = i.sent()), (i.label = 4));
        case 4:
          return r?.callback ? [4, de(o, r.callback, $(a, r.timeout))] : [3, 6];
        case 5:
          ((o = i.sent()), (i.label = 6));
        case 6:
...
var $,
  ...
  ke = e(() => {}),
  Ae = e(() => {
    (c(), l(), u(), le(), O(), P(), q(), Te(), Ee(), Oe(), b(), g(), w(), ke(), W(), Z());
  });
export {
  ee as _,
  G as a,
