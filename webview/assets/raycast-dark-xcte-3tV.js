var e = `Raycast Dark`,
  ...
  i = [
    ...
    { scope: [`comment`, `string.quoted.docstring.multi`], settings: { foreground: `#666666` } },
    {
      scope: [
        `constant.numeric`,
        `constant.language`,
    ...
    { scope: [`support.variable.property`], settings: { foreground: `#CCCCCC` } },
...
//# sourceMappingURL=raycast-dark-xcte-3tV.js.map
