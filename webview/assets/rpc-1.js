...
var q = {
  ...
  Ke = t(`type`, [
    r({ type: c(`pixels`), y: n() }),
    r({ type: c(`pages`), count: n() }),
    r({ type: c(`edge`), edge: e([`top`, `bottom`]) }),
  ]),
  qe = e([`previous`, `next`]),
  Je = l([r({ heading: o() }), r({ ordinal: n().int().nonnegative() })]),
  Ye = l([r({ projectId: o() }), r({ label: o() }), r({ ordinal: n().int().nonnegative() })]);
function Xe(e) {
