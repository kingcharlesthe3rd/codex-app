...
function F(e, t, n) {
  return new oe(new I(e), t, n).getRemoteMain();
}
var I = class {
    constructor(e) {
      ((this.#e = e),
  ...
  R = class {
      ...
      return (
        ...
        this.context.parent
          ? (this.context.parent.instructions.push([
            ...
            new B(this.context.parent, this.context.parent.instructions.length))
    ...
    pushCall(e, t, n) {
      ...
      return (this.instructions.push([`pipeline`, i, t, r]), new B(this, this.instructions.length));
    }
    pushGet(e, t) {
      let n = this.capture(e.dup());
      return (this.instructions.push([`pipeline`, n, t]), new B(this, this.instructions.length));
    }
    capture(e) {
      if (e instanceof B && e.mapper === this) return e.idx;
...
function H(e, t, n, r, i) {
  let a = new V(r, new T(S.deepCopyFrom(e, t, n)));
  try {
    return a.apply(i);
  } finally {
    a.dispose();
...
s.applyMap = (e, t, n, r, i) => {
  try {
    ...
    if (e instanceof Array) {
      let t = [];
      try {
        for (let a of e) t.push(H(a, e, n, r, i));
      } catch (e) {
        for (let e of t) e.dispose();
        throw e;
      }
      a = S.fromArray(t);
    } else a = e == null ? S.fromAppReturn(e) : H(e, t, n, r, i);
    return new T(a);
  } finally {
    for (let e of r) e.dispose();
  }
};
var U = class e extends u {
    state;
    static create(t) {
    ...
    onAck(e) {
      ...
      if (((this.minRtt = Math.min(this.minRtt, n)), this.firstAckTime === 0))
        ...
        let i = t - n,
          ...
          o = this.inStartupPhase ? se : q,
          s = a * this.minRtt * o;
        ((s = Math.min(s, e.windowAtSend * o)),
          (s = e.windowFullAtSend ? Math.max(s, e.windowAtSend * ce) : Math.max(s, this.window)),
          (this.window = Math.max(Math.min(s, G), K)),
          this.inStartupPhase &&
            e.sentTime >= this.roundStartTime &&
            (this.window > this.lastRoundWindow * q
...
((l.createWritableStreamHook = U.create),
  (l.createWritableStreamFromHook = de),
  (l.createReadableStreamHook = fe.create));
var J = n,
  pe = F,
  Y = new Set(),
  X = null,
...
var Q, $;
export { he as i, $ as n, Z as r, Q as t };
