...
import { t as ee } from "./preload-helper.js";
var te = Symbol(`workers-module`);
...
var p = globalThis[te],
  m = p ? p.RpcTarget : class {},
  ne = async function () {}.constructor,
  re = typeof Buffer < `u` ? Buffer.prototype : void 0;
function h(e) {
  switch (typeof e) {
    case `boolean`:
    case `number`:
  ...
  switch (t) {
    ...
    default:
      if (p) {
        if (t == p.RpcStub.prototype || e instanceof p.ServiceStub) return `rpc-target`;
        if (t == p.RpcPromise.prototype || t == p.RpcProperty.prototype) return `rpc-thenable`;
      }
      return e instanceof m ? `rpc-target` : e instanceof Error ? `error` : `unsupported`;
  }
}
function ie() {
  throw Error(`RPC map() implementation was not loaded.`);
}
var g = { applyMap: ie, sendMap: ie };
function _() {
  throw Error(`Stream implementation was not loaded.`);
}
var v = {
    createWritableStreamHook: _,
    createWritableStreamFromHook: _,
    createReadableStreamHook: _,
  },
  y = class {
    stream(e, t) {
  ...
  ae = new b(Error(`Attempted to use RPC stub after it has been disposed.`)),
  x = (e, t, n) => e.call(t, n);
function oe(e, t) {
  let n = x;
  x = e;
...
var S = Symbol(`realStub`),
  se = {
    apply(e, t, n) {
      let r = e.raw;
      return new w(x(r.hook, r.pathIfPromise || [], O.fromAppParams(n)), []);
    },
    get(e, t, n) {
      let r = e.raw;
      if (t === S) return r;
      if (t in w.prototype) return r[t];
      if (typeof t == `string`)
        return new w(r.hook, r.pathIfPromise ? [...r.pathIfPromise, t] : [t]);
      if (t === Symbol.dispose && (!r.pathIfPromise || r.pathIfPromise.length == 0))
        return () => {
          (r.hook.dispose(), (r.hook = ae));
        };
    },
    has(e, t) {
      let n = e.raw;
  ...
  C = class e extends m {
    constructor(e, t) {
      if ((super(), !(e instanceof y))) {
        ...
        if (
          ((e =
            n instanceof m || n instanceof Function
              ? j.create(n, void 0)
              : new A(O.fromAppReturn(n))),
          t)
        )
      ...
      let n = () => {};
      return ((n.raw = this), new Proxy(n, se));
    }
    hook;
    pathIfPromise;
    dup() {
    ...
    onRpcBroken(e) {
      this[S].hook.onBroken(e);
    }
    map(e) {
      let { hook: t, pathIfPromise: n } = this[S];
      return g.sendMap(t, n || [], e);
    }
    toString() {
  ...
  w = class extends C {
    ...
    then(e, t) {
      return D(this).then(...arguments);
    }
    catch(e) {
      return D(this).catch(...arguments);
    }
    finally(e) {
      return D(this).finally(...arguments);
    }
    toString() {
...
function ce(e) {
  let { hook: t, pathIfPromise: n } = e[S];
...
var O = class e {
  ...
  getHookForWritableStream(e, t, n = !0) {
    if (this.source === `params`) return v.createWritableStreamHook(e);
    if (this.source === `return`) {
      ...
      return t
        ...
        : ((t = v.createWritableStreamHook(e)),
  ...
  getHookForReadableStream(e, t, n = !0) {
    if (this.source === `params`) return v.createReadableStreamHook(e);
    if (this.source === `return`) {
      let t = this.rpcTargets?.get(e);
      return t
        ? n
          ? t.dup()
          : (this.rpcTargets?.delete(e), t)
        : ((t = v.createReadableStreamHook(e)),
          n ? ((this.rpcTargets ||= new Map()), this.rpcTargets.set(e, t), t.dup()) : t);
  ...
  deepCopy(e, t, n, r, i, a) {
    switch (h(e)) {
      ...
      case `rpc-promise`: {
        let t = e,
          a;
        if (((a = i ? le(t) : ce(t)), t instanceof w)) {
          let e = new w(a, []);
          return (this.promises.push({ parent: r, property: n, promise: e }), e);
        } else return (this.hooks.push(a), new C(a));
      }
      case `function`:
      case `rpc-target`: {
        let n = e,
          r;
        return (
          (r = a ? a.getHookForRpcTarget(n, t, i) : j.create(n, t)), this.hooks.push(r), new C(r)
        );
      }
      case `rpc-thenable`: {
        let o = e,
          s;
        return (
          (s = a ? new w(a.getHookForRpcTarget(o, t, i), []) : new w(j.create(o, t), [])),
      ...
      case `writable`: {
        let n = e,
          r;
        return (
          (r = a ? a.getHookForWritableStream(n, t, i) : v.createWritableStreamHook(n)),
          this.hooks.push(r),
          n
        );
      }
      case `readable`: {
        let n = e,
          r;
        return (
          (r = a ? a.getHookForReadableStream(n, t, i) : v.createReadableStreamHook(n)),
          this.hooks.push(r),
          n
        );
      }
  ...
  deliverTo(t, n, r) {
    if ((this.ensureDeepCopied(), this.value instanceof w))
  ...
  async deliverCall(t, n) {
    try {
      ...
      return i instanceof w ? e.fromAppReturn(i) : e.fromAppReturn(await i);
    } finally {
      this.dispose();
    }
  }
  ...
  disposeImpl(e, t) {
    switch (h(e)) {
      ...
      case `rpc-target`: {
        ...
        n ? (n.dispose(), this.rpcTargets.delete(t)) : fe(t);
        return;
      }
      case `rpc-thenable`:
        return;
      ...
      case `writable`: {
        let t = e,
          n = this.rpcTargets?.get(t);
        (n ? this.rpcTargets.delete(t) : (n = v.createWritableStreamHook(t)), n.dispose());
        return;
      }
      case `readable`: {
        let t = e,
          n = this.rpcTargets?.get(t);
        (n ? this.rpcTargets.delete(t) : (n = v.createReadableStreamHook(t)), n.dispose());
        return;
      }
      default:
        return;
  ...
  ignoreUnhandledRejections() {
    this.hooks
      ? (this.hooks.forEach((e) => {
        ...
        this.promises.forEach((e) => ue(e.promise).ignoreUnhandledRejections()))
  ...
  ignoreUnhandledRejectionsImpl(e) {
    switch (h(e)) {
      ...
      case `stub`:
      case `rpc-promise`:
        ue(e).ignoreUnhandledRejections();
        return;
      case `rpc-thenable`:
        e.then(
          (e) => {},
...
function k(e, t, n, r) {
  for (let i = 0; i < n.length; i++) {
    ...
    switch (h(e)) {
      ...
      case `stub`:
      case `rpc-promise`: {
        let { hook: t, pathIfPromise: r } = E(e);
  ...
  if (e instanceof w) {
    let { hook: t, pathIfPromise: n } = E(e);
...
var de = class extends y {
    call(e, t) {
      try {
        ...
        return new M(t.deliverCall(i.value, i.parent).then((e) => new A(e)));
      } catch (e) {
        return new b(e);
      }
    }
    map(e, t, n) {
      try {
        ...
        return r.hook
          ...
          : g.applyMap(r.value, r.parent, r.owner, t, n);
      } catch (e) {
        return new b(e);
      }
    }
    get(e) {
      try {
        ...
        let r = k(t, void 0, e, n);
        return r.hook
          ? r.hook.get(r.remainingPath)
          : new A(O.deepCopyFrom(r.value, r.parent, r.owner));
      } catch (e) {
        return new b(e);
      }
    }
  },
  A = class e extends de {
    constructor(e) {
    ...
    dup() {
      ...
      return new e(O.deepCopyFrom(t.value, void 0, t));
    }
    pull() {
    ...
    onBroken(e) {
      this.payload && this.payload.value instanceof C && this.payload.value.onRpcBroken(e);
    }
  };
function fe(e) {
...
var j = class e extends de {
    ...
    pull() {
      ...
      return `then` in e
        ? Promise.resolve(e).then((e) => O.fromAppReturn(e))
        : Promise.reject(Error(`Tried to resolve a non-promise stub.`));
    }
    ignoreUnhandledRejections() {}
    dispose() {
      this.target &&= (this.refcount && --this.refcount.count == 0 && fe(this.target), void 0);
    }
    onBroken(e) {}
  },
  M = class e extends y {
        ...
        case `request`: {
          ...
          if ((i.length > 0 && (r.headers = i), t.body))
            ...
            let e = t.arrayBuffer(),
              ...
              i = v.createReadableStreamHook(n);
  ...
  return new w(
    new M(
      new Response(t).arrayBuffer().then((t) => {
        ...
        return new A(O.fromAppReturn(r));
      }),
    ),
    [],
  );
...
var P = class e {
    ...
    promises = [];
    evaluate(e) {
      let t = O.forEvaluate(this.hooks, this.promises);
      try {
          ...
          switch (t[0]) {
            ...
            case `pipeline`: {
              ...
              let a = t[0] == `pipeline`,
                o = (e) => {
                  ...
                  } else return (this.hooks.push(e), new w(e, []));
                };
            ...
            case `promise`:
              if (typeof t[1] == `number`)
                if (t[0] == `promise`) {
                  let e = new w(this.importer.importPromise(t[1]), []);
                  return (this.promises.push({ parent: n, property: r, promise: e }), e);
                } else {
                  let e = this.importer.importStub(t[1]);
                  return (this.hooks.push(e), new C(e));
                }
              break;
            case `writable`:
              if (typeof t[1] == `number`) {
                let e = this.importer.importStub(t[1]),
                  n = v.createWritableStreamFromHook(e);
            ...
            case `readable`:
              if (typeof t[1] == `number`) {
                let e = this.importer.getPipeReadable(t[1]),
                  n = v.createReadableStreamHook(e);
  ...
  _e = class {
    constructor(e, t, n) {
      ((this.transport = e),
        ...
        this.imports.push(new F(this, 0, !1)));
      let r,
        i = new Promise((e, t) => {
          r = t;
        });
    ...
    ensureResolvingExport(e) {
      ...
      if (!t.pull) {
        let n = async () => {
            ...
            for (;;) {
              let t = await e.pull();
              if (t.value instanceof C) {
                let { hook: n, pathIfPromise: r } = E(t.value);
        ...
        (++this.pullCount,
          (t.pull = n()
            .then(
              (t) => {
                let n = N.devaluate(t.value, void 0, this, t);
                (this.send([`resolve`, e, n]), r && this.releaseExport(e, 1));
              },
              (t) => {
                (this.send([`reject`, e, N.devaluate(t, void 0, this)]),
    ...
    getImport(e) {
      if (e instanceof I && e.entry && e.entry.session === this) return e.entry.importId;
    }
    importStub(e) {
      if (this.abortReason) throw this.abortReason;
      let t = this.imports[e];
      return (t || ((t = new F(this, e, !1)), (this.imports[e] = t)), new I(!1, t));
    }
    importPromise(e) {
      if (this.abortReason) throw this.abortReason;
      if (this.imports[e])
      ...
      let t = new F(this, e, !0);
      return ((this.imports[e] = t), new I(!0, t));
    }
    getExport(e) {
    ...
    createPipe(e, t) {
      ...
      this.imports.push(r);
      let i = new I(!1, r),
        a = v.createWritableStreamFromHook(i);
      return (
        e
          .pipeTo(a)
          .catch(() => {})
    ...
    sendCall(e, t, n) {
      ...
      let r = [`pipeline`, e, t];
      if (n) {
        let e = N.devaluate(n.value, void 0, this, n);
        r.push(e[0]);
      }
      this.send([`push`, r]);
      let i = new F(this, this.imports.length, !1);
      return (this.imports.push(i), new I(!0, i));
    }
    sendStream(e, t, n) {
      if (this.abortReason) throw this.abortReason;
      let r = [`pipeline`, e, t],
        i = N.devaluate(n.value, void 0, this, n);
      r.push(i[0]);
    ...
    sendMap(e, t, n, r) {
      ...
      this.send([`push`, i]);
      let a = new F(this, this.imports.length, !1);
      return (this.imports.push(a), new I(!0, a));
    }
    sendPull(e) {
      if (this.abortReason) throw this.abortReason;
      this.send([`pull`, e]);
    ...
    abort(e, t = !0) {
      if (this.abortReason === void 0) {
        if ((this.cancelReadLoop(e), t))
          try {
            this.transport
              .send(JSON.stringify([`abort`, N.devaluate(e, void 0, this)]))
              .catch((e) => {});
          } catch {}
        if (
      ...
      for (; !this.abortReason; ) {
        ...
        if (t instanceof Array)
          switch (t[0]) {
            case `push`:
              if (t.length > 1) {
                let e = new A(new P(this).evaluate(t[1]));
            ...
            case `pipe`: {
              let { readable: e, writable: t } = new TransformStream(),
                n = v.createWritableStreamHook(t);
            ...
            case `reject`: {
              ...
              if (typeof e == `number` && t.length > 2) {
                ...
                if (n)
                  if (t[0] == `resolve`) n.resolve(new A(new P(this).evaluate(t[2])));
                  else {
                    let e = new P(this).evaluate(t[2]);
                    (e.dispose(), n.resolve(new b(e.value)));
                  }
                else t[0] == `resolve` && new P(this).evaluate(t[2]).dispose();
                continue;
              }
              break;
            }
  ...
  ve = class {
    ...
    constructor(e, t, n = {}) {
      let r;
      ((r = t ? new A(O.fromAppReturn(t)) : new b(Error(`This connection has no main object.`))),
        (this.#e = new _e(e, r, n)),
        (this.#t = new C(this.#e.getMainImport())));
    }
    getRemoteMain() {
      return this.#t;
    }
...
function ye(e, t, n) {
  return new ve(new be(e), t, n).getRemoteMain();
}
var be = class {
    constructor(e) {
      ((this.#e = e),
  ...
  xe = class {
    ...
    constructor(e, t) {
      (L
        ? (this.context = { parent: L, captures: [], subject: L.capture(e), path: t })
        : (this.context = { parent: void 0, captures: [], subject: e, path: t }),
        (L = this));
    }
    unregister() {
      L = this.context.parent;
    }
    makeInput() {
      return new z(this, 0);
    }
    makeOutput(e) {
      let t;
      try {
        t = N.devaluate(e.value, void 0, this, e);
      } finally {
        e.dispose();
      }
      return (
        ...
        this.context.parent
          ? (this.context.parent.instructions.push([
            ...
            new z(this.context.parent, this.context.parent.instructions.length))
          : this.context.subject.map(this.context.path, this.context.captures, this.instructions)
      );
    }
    pushCall(e, t, n) {
      let r = N.devaluate(n.value, void 0, this, n);
      r = r[0];
      let i = this.capture(e.dup());
      return (this.instructions.push([`pipeline`, i, t, r]), new z(this, this.instructions.length));
    }
    pushGet(e, t) {
      let n = this.capture(e.dup());
      return (this.instructions.push([`pipeline`, n, t]), new z(this, this.instructions.length));
    }
    capture(e) {
      if (e instanceof z && e.mapper === this) return e.idx;
...
g.sendMap = (e, t, n) => {
  let r = new xe(e, t),
    i;
  try {
    i = O.fromAppReturn(oe(r.pushCall.bind(r), () => n(new w(r.makeInput(), []))));
  } finally {
    r.unregister();
  }
  if (i instanceof Promise)
    throw (i.catch((e) => {}), Error(`RPC map() callbacks cannot be async.`));
  return new w(r.makeOutput(i), []);
};
function R() {
  throw Error(
    ...
    apply(e) {
      try {
        ...
        for (let t of e.slice(0, -1)) {
          let e = new P(this).evaluateCopy(t);
          if (e.value instanceof C) {
            let t = T(e.value);
            if (t) {
          ...
          this.variables.push(new A(e));
        }
        return new P(this).evaluateCopy(e[e.length - 1]);
      } finally {
        for (let e of this.variables) e.dispose();
      }
    }
...
function Ce(e, t, n, r, i) {
  let a = new Se(r, new A(O.deepCopyFrom(e, t, n)));
  try {
    return a.apply(i);
  } finally {
    a.dispose();
...
g.applyMap = (e, t, n, r, i) => {
  try {
    let a;
    if (e instanceof w) throw Error(`applyMap() can't be called on RpcPromise`);
    if (e instanceof Array) {
      let t = [];
      try {
        for (let a of e) t.push(Ce(a, e, n, r, i));
      } catch (e) {
        for (let e of t) e.dispose();
        throw e;
      }
      a = O.fromArray(t);
    } else a = e == null ? O.fromAppReturn(e) : Ce(e, t, n, r, i);
    return new A(a);
  } finally {
    for (let e of r) e.dispose();
  }
};
var we = class e extends y {
    state;
    static create(t) {
    ...
    call(e, t) {
      try {
        ...
        let i = n.writer[r];
        return new M(t.deliverCall(i, n.writer).then((e) => new A(e)));
      } catch (e) {
        return new b(e);
      }
    }
    map(e, t, n) {
      for (let e of t) e.dispose();
      return new b(Error(`Cannot use map() on a WritableStream`));
    }
    get(e) {
      return new b(Error(`Cannot access properties on a WritableStream stub`));
    }
    dup() {
...
function Ne(e) {
  ...
  return new WritableStream({
    ...
    async close() {
      ...
      let { promise: n } = e.stream([`close`], O.fromAppParams([]));
      try {
        await n;
      } catch (e) {
        throw t ?? e;
    ...
    abort(n) {
      ...
      let { promise: r } = e.stream([`abort`], O.fromAppParams([n]));
      r.then(
        () => o(),
        () => o(),
      );
...
var Pe = class e extends y {
  ...
  call(e, t) {
    return (t.dispose(), new b(Error(`Cannot call methods on a ReadableStream stub`)));
  }
  map(e, t, n) {
    for (let e of t) e.dispose();
    return new b(Error(`Cannot use map() on a ReadableStream`));
  }
  get(e) {
    return new b(Error(`Cannot access properties on a ReadableStream stub`));
  }
  dup() {
    let t = this.state;
...
((v.createWritableStreamHook = we.create),
  (v.createWritableStreamFromHook = Ne),
  (v.createReadableStreamHook = Pe.create));
var B = m,
  Fe = ye;
function V(e) {
...
function ze(e) {
  return U(e).replace(/\/+$/, ``).split(`/`).filter(Boolean).slice(-2).join(`/`);
}
function Be({ root: e, relativePath: t, includeWorkspaceRootLabel: n }) {
  let r = U(t);
  if (!n) return r;
  let i = He(e);
  return i ? (r ? `${i}/${r}` : i) : r;
...
function Ve(e, t) {
  let n = t.map((e) => U(e).replace(/\/+$/, ``));
  if (new Set(n).size <= 1) return U(e).replace(/\/+$/, ``);
...
var W = {
  ...
  G = {
    reviewFile: `[${W.reviewPath}]`,
    reviewFileToggle: `[${W.reviewFileToggle}]`,
    reviewScroll: `[${W.reviewScroll}]`,
    sidebarProjectList: (e) => `[${W.sidebarProjectListId}="${CSS.escape(e)}"]`,
    sidebarProjectRow: `[${W.sidebarProjectRow}]`,
    sidebarProjectSelect: `[${W.sidebarProjectSelect}]`,
    sidebarProjectShowAllToggle: `[${W.sidebarProjectShowAllToggle}]`,
    sidebarScroll: `[${W.sidebarScroll}]`,
    sidebarSection: `[${W.sidebarSection}]`,
    sidebarSectionToggle: `[${W.sidebarSectionToggle}]`,
    sidebarThreadRow: `[${W.sidebarThreadRow}]`,
    timelineScroll: `[${W.timelineScroll}]`,
    timelineTurn: `[data-content-search-turn-key]`,
  },
  Je = [G.sidebarSection, G.sidebarProjectRow, G.sidebarThreadRow].join(`,`),
  Ye = {
    reviewFile: (e) => ({ [W.reviewPath]: e }),
    reviewFileToggle: (e) => ({ [W.reviewFileExpanded]: String(e), [W.reviewFileToggle]: `` }),
    reviewScroll: { [W.reviewScroll]: `` },
    sidebarProjectList: ({ projectId: e, showAll: t }) => ({
      [W.sidebarProjectListId]: e,
      [W.sidebarProjectShowAll]: String(t),
    }),
    sidebarProjectRow: ({ collapsed: e, label: t, projectId: n }) => ({
      [W.sidebarProjectCollapsed]: String(e),
      [W.sidebarProjectId]: n,
      [W.sidebarProjectLabel]: t,
      [W.sidebarProjectRow]: ``,
    }),
    sidebarProjectSelect: { [W.sidebarProjectSelect]: `` },
    sidebarProjectShowAllToggle: { [W.sidebarProjectShowAllToggle]: `` },
    ...
    sidebarSection: ({ collapsed: e, heading: t }) => ({
      [W.sidebarSection]: ``,
      [W.sidebarSectionCollapsed]: String(e),
      [W.sidebarSectionHeading]: t,
    }),
    sidebarSectionToggle: { [W.sidebarSectionToggle]: `` },
    sidebarThreadRow: ({ active: e, hostId: t, id: n, kind: r, pinned: i, title: a }) => ({
      [W.sidebarThreadActive]: String(e),
      [W.sidebarThreadHostId]: t ?? ``,
      [W.sidebarThreadId]: n,
      [W.sidebarThreadKind]: r,
      [W.sidebarThreadPinned]: String(i),
      [W.sidebarThreadRow]: ``,
      [W.sidebarThreadTitle]: a,
    }),
    timelineScroll: { [W.timelineScroll]: `` },
  },
  Xe = `current`,
  ...
  Qe = c(`type`, [
    s({ type: f(`pixels`), y: d() }),
    s({ type: f(`pages`), count: d() }),
    s({ type: f(`edge`), edge: u([`top`, `bottom`]) }),
  ]),
  $e = u([`previous`, `next`]),
  et = l([s({ heading: n() }), s({ ordinal: d().int().nonnegative() })]),
  tt = l([s({ projectId: n() }), s({ label: n() }), s({ ordinal: d().int().nonnegative() })]);
function nt(e) {
...
function rt(e, t, n = {}) {
  switch (t.type) {
    ...
    case `edge`:
      if (n.isReversed) {
        H(e, t.edge === `bottom` ? 0 : e.scrollHeight);
        return;
      }
...
function it(e) {
  let t = Array.from(document.querySelectorAll(G.sidebarSection));
  if (`ordinal` in e) {
    let n = t[e.ordinal];
...
function at(e) {
  let t = Array.from(document.querySelectorAll(G.sidebarProjectRow));
  if (`ordinal` in e) {
    let n = t[e.ordinal];
...
function ot(e, t) {
  ...
  H(e, V(e) - (t.type === `pixels` ? t.y : e.clientHeight * t.count));
}
function st(e, t) {
  let n = ut(e, t);
  if (n == null) {
    ot(e, { type: `edge`, edge: t === `previous` ? `top` : `bottom` });
    return;
  }
  let r = e.getBoundingClientRect(),
    i = n.getBoundingClientRect(),
    a = V(e) + (r.bottom - i.bottom);
  H(e, t === `previous` ? Math.max(0, a - e.clientHeight + i.height) : Math.max(0, a));
}
function ct(e) {
  let t = U(e),
    n = Array.from(document.querySelectorAll(G.reviewFile)),
    r = n.find((e) => U(e.dataset.reviewPath ?? ``) === t) ?? null;
  if (r != null) return r;
  let i = n.filter((e) => {
    let n = U(e.dataset.reviewPath ?? ``);
...
function lt(e) {
  return G.sidebarProjectList(e);
}
function ut(e, t) {
  let n = e.getBoundingClientRect(),
    r = Array.from(e.querySelectorAll(G.timelineTurn)),
    i = null;
  for (let e of r) {
    let r = e.getBoundingClientRect();
    if (t === `previous`) {
...
var dt = s({ type: n() }).passthrough();
async function ft(e, t = {}) {
  let n = pt(e),
    { appActionRegistry: r } = await ee(
      async () => {
...
function St(e, t) {
  return t == null ? e : e.filter((e) => e.conversationId === t);
}
function Ct(e) {
  return (
    J.add(e),
    Y != null && e(Y),
    () => {
      (J.delete(e), J.size === 0 && Z != null && (clearTimeout(Z), (Z = null)));
    }
  );
}
var wt = new bt();
...
function Et() {
  J.size !== 0 && (Z != null && (clearTimeout(Z), (Z = null)), Q(Date.now()));
}
function Dt() {
  if (J.size === 0) return;
  let e = Date.now();
  if (X == null || e < X || e - X >= yt) {
    (Z != null && (clearTimeout(Z), (Z = null)), Q(e));
    return;
  }
  Z ??= setTimeout(
    () => {
...
})({ appActions: mt, appUpdates: _t, downloads: wt });
function kt() {
