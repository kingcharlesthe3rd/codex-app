...
import { _n as t, bn as n, hn as r, vn as i, yn as a } from "./product-logger.js";
...
function p(e) {
  switch (e) {
    case `latest`:
      return n.CODEX_PRIMARY_RUNTIME_RELEASE_LATEST;
    case `latest-alpha`:
      return n.CODEX_PRIMARY_RUNTIME_RELEASE_LATEST_ALPHA;
  }
}
function m(e) {
  switch (e) {
    case `already-current`:
      return a.CODEX_PRIMARY_RUNTIME_INSTALL_RESULT_STATUS_ALREADY_CURRENT;
    case `canceled`:
      return a.CODEX_PRIMARY_RUNTIME_INSTALL_RESULT_STATUS_CANCELED;
    case `failed`:
      return a.CODEX_PRIMARY_RUNTIME_INSTALL_RESULT_STATUS_FAILED;
    case `installed`:
      return a.CODEX_PRIMARY_RUNTIME_INSTALL_RESULT_STATUS_INSTALLED;
  }
}
function h(e) {
  switch (e) {
    case `already-current`:
      return t.CODEX_PRIMARY_RUNTIME_DEPENDENCIES_RESET_STATUS_ALREADY_CURRENT;
    case `canceled`:
      return t.CODEX_PRIMARY_RUNTIME_DEPENDENCIES_RESET_STATUS_CANCELED;
    case `failed`:
      return t.CODEX_PRIMARY_RUNTIME_DEPENDENCIES_RESET_STATUS_FAILED;
    case `installed`:
      return t.CODEX_PRIMARY_RUNTIME_DEPENDENCIES_RESET_STATUS_INSTALLED;
  }
}
function g(e) {
  return e == null || e.length === 0 ? {} : { bundleVersion: e };
}
async function _({ formatMessage: t, hostId: n, productLogger: r, release: a, toast: s }) {
  let c = Date.now(),
    u = s.info(
      t({
