...
import { _n as t, fn as n, gn as r, hn as i, mn as a } from "./persisted-signal.js";
import { s as o } from "./primary-runtime-install-state-e.js";
var s = `3026692602`,
  c = `3502101112`;
...
function u({ diagnostics: e, durationMs: t }) {
  return {
    ...
    status: e.installed
      ? n.CODEX_PRIMARY_RUNTIME_DEPENDENCIES_DIAGNOSE_STATUS_OK
      : n.CODEX_PRIMARY_RUNTIME_DEPENDENCIES_DIAGNOSE_STATUS_PROBLEM,
    ...g(e.bundleVersion),
  };
}
function d({ durationMs: e }) {
  return { durationMs: e, status: n.CODEX_PRIMARY_RUNTIME_DEPENDENCIES_DIAGNOSE_STATUS_FAILED };
}
