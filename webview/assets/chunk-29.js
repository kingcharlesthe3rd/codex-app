...
import { u as n } from "./chunk-1.js";
import { s as r, y as i } from "./chunk-101.js";
import { a, i as o, s } from "./chunk-54.js";
import { a as c, i as l, n as u, r as d } from "./chunk-85.js";
var f = {
    common: r,
    getConfig: i,
    insertCluster: o,
...
t(() => {
  m([
    { name: `dagre`, loader: t(async () => await import(`./dagre-8.js`), `loader`) },
    ...[
      {
        name: `cose-bilkent`,
        loader: t(async () => await import(`./cose-bilkent-4.js`), `loader`),
      },
    ],
  ]);
