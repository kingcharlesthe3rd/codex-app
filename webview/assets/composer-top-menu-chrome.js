...
function s(e) {
  ...
  let u = c === void 0 ? !1 : c,
    ...
    m;
  t[5] !== r || t[6] !== f || t[7] !== p
    ? ((m = n(f, p, r)), (t[5] = r), (t[6] = f), (t[7] = p), (t[8] = m))
    : (m = t[8]);
  let h;
  return (
    t[9] !== s || t[10] !== m
      ? ((h = (0, o.jsx)(`div`, { ...s, className: m })), (t[9] = s), (t[10] = m), (t[11] = h))
      : (h = t[11]),
    h
  );
}
function c(e) {
  let t = (0, a.c)(9),
    ...
    v;
  t[0] !== s || t[1] !== h || t[2] !== g || t[3] !== _
    ? ((v = n(h, g, _, s)), (t[0] = s), (t[1] = h), (t[2] = g), (t[3] = _), (t[4] = v))
    : (v = t[4]);
  let y;
  return (
    t[5] !== r || t[6] !== c || t[7] !== v
...
function l(e) {
  ...
  let d = u === void 0 ? !1 : u,
    ...
    p;
  t[5] !== s || t[6] !== f ? ((p = n(f, s)), (t[5] = s), (t[6] = f), (t[7] = p)) : (p = t[7]);
  let m = d && i.expandedTopTrayShell,
    h;
  t[8] !== c || t[9] !== m ? ((h = n(m, c)), (t[8] = c), (t[9] = m), (t[10] = h)) : (h = t[10]);
  let g;
  return (
    t[11] !== l || t[12] !== p || t[13] !== h
