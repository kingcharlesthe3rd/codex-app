...
import { Bi as r } from "./src-1.js";
import { t as i } from "./clsx.js";
import { t as a } from "./unselected-circle.js";
var o = n(),
  s = 5.75,
  c = 2 * Math.PI * s,
  l = 1.5;
function u({ className: e = `icon-sm shrink-0`, checks: t }) {
  let n = d(t),
    r = i(`text-token-description-foreground`, e);
  if (n.length === 0) return (0, o.jsx)(a, { className: r });
  let u = n.length > 1 ? l : 0,
    f = 0;
  return (0, o.jsx)(`svg`, {
    "aria-hidden": !0,
    className: r,
...
function p({ automations: e, conversationId: t, includePausedAutomations: n = !1 }) {
  return t == null
    ? null
    : (e.find(
        (e) =>
