...
var i = 180 / Math.PI,
  a = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 };
...
h.prototype = m.prototype = {
  ...
  on: function (e, t) {
    ...
    if (arguments.length < 2) {
      for (; ++a < o; ) if ((i = (e = r[a]).type) && (i = _(n[i], e.name))) return i;
      return;
    }
...
function ve(e) {
  return this.selectAll(e == null ? ge : _e(typeof e == `function` ? e : ue(e)));
}
function ye(e) {
...
function we(e, t, n, r, i, a, o) {
  ...
  for (s = 0; s < d; ++s)
    ((p = o.call(e, a[s], s, a) + ``),
      (c = l.get(p)) ? ((r[s] = c), (c.__data__ = a[s]), l.delete(p)) : (n[s] = new C(e, a[s])));
...
function Ze(e, t, n) {
  return arguments.length > 1
    ? this.each((t == null ? Je : typeof t == `function` ? Xe : Ye)(e, t, n ?? ``))
    : w(this.node(), e);
}
function w(e, t) {
...
function ct(e, t) {
  var n = nt(e + ``);
  if (arguments.length < 2) {
    for (var r = T(this.node()), i = -1, a = n.length; ++i < a; ) if (!r.contains(n[i])) return !1;
    return !0;
  }
...
V.prototype = H.prototype = {
  ...
  restart: function (e, t, n) {
    ...
    ((n = (n == null ? B() : +n) + (t == null ? 0 : +t)),
      !this._next && P !== this && (P ? (P._next = this) : (N = this), (P = this)),
      (this._call = e),
      (this._time = n),
      W());
  },
...
function W(e) {
  k ||
    ((A &&= clearTimeout(A)),
    e - I > 24
      ? (e < 1 / 0 && (A = setTimeout(U, e - R.now() - L)), (j &&= clearInterval(j)))
...
function nn(i, a) {
  var o;
  return (typeof a == `number` ? t : a instanceof e ? n : (o = e(a)) ? ((a = o), n) : r)(i, a);
}
function rn(e) {
  return function () {
    this.removeAttribute(e);
...
function An(e, t) {
  var n = this._id;
  return arguments.length < 2 ? J(this.node(), n).on.on(e) : this.each(kn(n, e, t));
}
function jn(e) {
  return function () {
  ...
  for (var r = this._groups, i = r.length, a = Array(i), o = 0; o < i; ++o)
    for (var s = r[o], c = s.length, l = (a[o] = Array(c)), u, d, f = 0; f < c; ++f)
      (u = s[f]) &&
        ...
        (`__data__` in u && (d.__data__ = u.__data__), (l[f] = d), G(l[f], t, n, f, l, J(u, n)));
...
function Hn(e, t, n) {
  ...
  return t == null
    ...
    : typeof t == `function`
      ? this.styleTween(e, Bn(e, r, Y(this, `style.` + e, t))).each(Vn(this._id, e))
...
function Jn(e) {
  return this.tween(
    `text`,
    typeof e == `function` ? qn(Y(this, `text`, e)) : Kn(e == null ? `` : e + ``),
  );
}
function Yn(e) {
  return function (t) {
...
function Qn() {
  for (
    var e = this._name, t = this._id, n = nr(), r = this._groups, i = r.length, a = 0;
    a < i;
    ++a
  )
...
([`w`, `e`].map(Q), [`n`, `s`].map(Q), [`n`, `w`, `e`, `s`, `nw`, `ne`, `sw`, `se`].map(Q));
function Q(e) {
  return { type: e };
}
function $(e, t, n) {
