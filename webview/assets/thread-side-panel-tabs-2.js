...
import { _ as Ce } from "./app-shell-0b-x_r3Z.js";
import { t as Y } from "./button-oF-qgtAS.js";
...
import { t as Dt } from "./connector-logo.js";
...
import { n as Vr, r as Hr } from "./use-resolved-theme-variant-D.js";
...
import { t as ti } from "./use-register-command-T-86rz-c.js";
...
import { n as ji } from "./dist-4.js";
import { o as Mi, r as Ni, t as Pi } from "./thread-side-panel-active-signals-C1-SoZ32.js";
...
import { t as oa } from "./back-forward-navigation-buttons-Cz-GufWg.js";
...
import { t as Sa } from "./browser-sidebar-webview-B.js";
import { t as Ca } from "./large-empty-state.js";
import { n as wa, t as Ta } from "./action-popover-primitives.js";
import {
  c as Ea,
  l as Da,
  o as Oa,
  u as ka,
} from "./pull-request-code-review-comments-BJSQHV-3.js";
...
function Eu({
  ...
  let x = s(ft),
    ...
    C = De(),
    T = Hr(Vr()),
    E = Object.keys(S.messages).length > 0 ? S.locale : S.defaultLocale,
    k = Object.fromEntries(Object.entries(S.messages).filter((e) => typeof e[1] == `string`)),
    { comments: A, setComments: j } = sa(mt(x.value) ?? t),
    P = Te(),
    ...
    Ue = l(di),
    Ge = l(fi),
    Ke = a(v, { browserTabId: n, conversationId: t }),
    Ye = a(Pi, t),
    Xe = a(g, N),
    Qe = a(g, z).data === !0,
  ...
  let $n = u && Gn.isEnabled && Kt ? Gn : { ...Gn, isEnabled: !1 },
    ...
    _r = b === `bottom` ? `bottom-panel` : `right-panel`,
    vr =
  ...
  (0, Q.useEffect)(() => {
    Ct?.conversationId !== t || Ct.browserTabId !== n || (Ir(), Xn(x));
  }, [n, Ct?.browserTabId, Ct?.conversationId, t, x]);
  let Lr = (0, Q.useEffectEvent)(
    ...
    Rr = () => {
      (On(x, { browserTabId: n, conversationId: t }), fn(x, `browser`), En(x), Fr());
    };
  ((0, Q.useEffect)(() => {
    if (!Pn || !ln) return;
    ...
    }, [bn, X.interactionMode, pn, dn, o, x, ct]),
    (0, Q.useEffect)(() => {
      if (ct == null) {
        ke.current = null;
        return;
      ...
      ((ke.current = yn),
        !(!o || e == null || e === yn) &&
          st(x, Ze, { enabled: yn, hasPendingAnnotations: pn, hasQueuedDesignTweaks: dn }));
    }, [pn, dn, yn, o, x, ct]),
    (0, Q.useEffect)(() => {
      let e = me.current;
      ((me.current = X.interactionMode),
  ...
  let Jr = (0, Q.useEffectEvent)((e = {}) => {
      ...
      w.dispatchMessage(`browser-sidebar-sync`, {
        payload: {
          ...
          runtimeIntlConfig: { defaultLocale: S.defaultLocale, locale: E, messages: k },
        },
      });
    }),
    Yr = (0, Q.useEffectEvent)((e = o) => {
      Ni(x, t, n, { isOpen: e, url: X.url });
    });
  ((0, Q.useLayoutEffect)(() => {
    let e = R.current;
    if (!e) {
    ...
    let t = null,
      n = () => {
        let t = e.getBoundingClientRect(),
          n = { x: t.x / C, y: t.y / C, width: t.width / C, height: t.height / C };
        Fe((e) =>
    ...
    (i.observe(e), n(), o && r());
    let a = b === `bottom` ? I.on(`change`, r) : F.on(`change`, r);
    return (
    ...
    (0, Q.useEffect)(() => {
      ...
      ((Se.current = null),
        (Ce.current = null),
        st(x, tt, { initiator: a, panelTarget: b, source: i }));
    }, [n, t, o, b, x]),
    D(
      `browser-sidebar-command`,
      (e) => {
    ...
    D(
      ...
      [Ye, n, wt?.browserTabId, wt?.conversationId, t, x],
    ),
    D(
  ...
  let _i = () => {
    ...
    Ui = o && m && Kt && !$n.isEnabled,
    Wi = h ? S.formatMessage(Gl.hideFloatingComposer) : S.formatMessage(Gl.showFloatingComposer);
  return (0, $.jsxs)(`div`, {
    ref: L,
                ...
                ? (0, $.jsxs)($.Fragment, {
                    children: [
                      (0, $.jsx)(`div`, {
                        ...
                        style: { bottom: tr, transform: `translateY(${h ? 0 : tr - Tu}px)` },
                      }),
                      (0, $.jsx)(Ae, {
                        tooltipContent: Wi,
                        children: (0, $.jsx)(Y, {
                          ...
                          style: {
                            bottom: tr,
                            transform: `translateY(calc(50% + ${h ? Tu / 2 : tr - Tu / 2}px))`,
                          },
                          onClick: y,
                          children: (0, $.jsx)(Je, {
                            className: J(
...
async function Od({
  ...
  if (i.scope === `section`) {
    ...
    (o(),
      _({ cwd: t, hostConfig: r, operationSource: `review_patch`, queryClient: e.queryClient }),
...
async function Ad({
  ...
  (s.size > 0 && (await i(Array.from(s))),
    a(),
    await _({ cwd: e, hostConfig: n, operationSource: `review_patch`, queryClient: r }));
}
function jd(e, t) {
  let n = e.get(Rr),
    r = e.get(Me),
...
function gf({ diffRefs: e, scrollContainerRef: t, setSelectedPathWithoutScroll: n }) {
  let r = s(ft),
    ...
    m = l(Pn),
    h = l(vn),
    g = (0, Q.useMemo)(() => c.map((e) => e.gitPath), [c]),
    {
...
function Mf(e) {
  let t = (0, Z.c)(100),
    ...
    _;
  t[0] !== o || t[1] !== c.id
    ? ((_ = { cwd: o, hostId: c.id }), (t[0] = o), (t[1] = c.id), (t[2] = _))
    : (_ = t[2]);
  let v = _,
    y = a(Wa, v),
    b = a(Ua, v),
...
function up({
  ...
  let c = s(u),
    ...
    [p, m] = (0, Q.useState)(!1),
    g = we(A.branchPrefix),
    _ = xo({ branchPrefix: g, conversationTitle: a(h, e) }),
    v = d ?? _,
    y = v.trim(),
    b = y.length === 0,
    S = y.endsWith(`/`),
    ...
    F = async () => {
      ...
      try {
        let n = await j.mutateAsync({ branch: y, failIfExists: !0, mode: `synced` });
        switch (n.status) {
          case `success`:
            break;
          case `create-error`:
...
function dp(e) {
  let t = (0, Z.c)(17),
    ...
    S = f(i ?? x),
    w =
      a(Ar, { hostConfig: S, operationSource: `local_conversation_git_actions` }).data
        ?.available !== !0,
    T;
  t[0] !== o || t[1] !== g || t[2] !== r || t[3] !== S.id
    ? ((T = { codexWorktree: o, conversationId: g, cwd: r, hostId: S.id }),
      (t[0] = o),
      (t[1] = g),
      (t[2] = r),
      (t[3] = S.id),
...
function Ip(e, t = !0, n = {}, r = `right`) {
  ...
  let l = e
    ...
    h = n.browserHostDisplayName ?? e.get(kr).display_name,
    g = n.cwd ?? e.get(Or);
  return (
    d.openTab(e, Mp, {
      contextMenuItems: Kp({
...
function Rp(
  ...
  let f = Hp(e, d, r),
    h = !e.get(m) && !p(e, d, f);
  if (
    (h && Lr(e, d, f) == null && Gt.removeTab(d, f),
    h && qt(d, f, { initialUrl: o, initiator: s, source: l }),
    !Ip(
      e,
      !0,
      {
    ...
    return (h && $t(d, f), null);
  let g = u === `right` ? (Gp(e, d, f) ?? f) : f;
  return (
    h
      ? g !== f && ($t(d, f), qt(d, g, { initialUrl: o, initiator: s, source: l }))
      : qt(d, g, { initialUrl: o, initiator: s, source: l }),
    o != null &&
      w.dispatchMessage(`browser-sidebar-command`, {
        browserTabId: g,
        conversationId: d,
...
function Hp(e, t, n) {
  ...
  return e.get(m)
    ...
    : n != null && (p(e, t, n) || (Gt.isBrowserUseTab(t, n) && r === n))
      ? n
      : (Up(e, t, n) ?? _t(t));
}
function Up(e, t, n) {
...
//# sourceMappingURL=thread-side-panel-tabs-2.js.map
