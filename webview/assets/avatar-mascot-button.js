...
import { t as s } from "./use-reduced-motion-2.js";
import { t as c } from "./persisted-atom.js";
import { t as l } from "./codex-avatar-BvRO-FvR.js";
var u = r(),
  d = e(t(), 1),
  f = n(),
  p = 4,
  ...
  h = c(`avatar-mascot-notification-badge-corner`, `top-end`);
function g(e) {
  let t = (0, u.c)(23),
    {
      ariaLabel: n,
...
function _(e) {
  ...
  t[2] === c
    ...
    : ((T = (e) => {
        ...
        if (
          ...
          (t != null && c(v({ avatarBounds: t, clientX: e.clientX, clientY: e.clientY })),
            g(null),
            e.preventDefault(),
            (y.current = !0),
            window.setTimeout(() => {
  ...
  let P = n.ariaLabel,
    ...
    L = n.isIconOnly ? `size-7 p-0` : `min-h-7 min-w-7 px-2 py-1`,
    R;
  t[9] !== I || t[10] !== L || t[11] !== F
    ? ((R = a(
  ...
  let z = b ? 1 : 0.7,
    ...
    V;
  t[13] !== z || t[14] !== B
    ? ((V = { opacity: 0, scale: z, y: B }), (t[13] = z), (t[14] = B), (t[15] = V))
    : (V = t[15]);
  let H = l == null ? void 0 : `${l.x}px ${l.y}px`,
    U;
  t[16] !== n.backgroundColor || t[17] !== n.foregroundColor || t[18] !== H
    ? ((U = { backgroundColor: n.backgroundColor, color: n.foregroundColor, translate: H }),
      (t[16] = n.backgroundColor),
      (t[17] = n.foregroundColor),
      (t[18] = H),
      (t[19] = U))
    : (U = t[19]);
  let W, G;
  t[20] === b
    ? ((W = t[21]), (G = t[22]))
    : ((W = b ? { duration: 0 } : { damping: 20, mass: 0.7, stiffness: 420, type: `spring` }),
      (G = b ? void 0 : { scale: 1.06 }),
      (t[20] = b),
      (t[21] = W),
      (t[22] = G));
  let K;
  t[23] === b ? (K = t[24]) : ((K = b ? void 0 : { scale: 0.94 }), (t[23] = b), (t[24] = K));
  let q;
  return (
    t[25] !== M ||
    t[26] !== E ||
