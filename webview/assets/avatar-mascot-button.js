...
import { n as m, t as h } from "./codex-avatar.js";
function g(e) {
  let t = (0, y.c)(23),
    {
      ariaLabel: n,
...
function _(e) {
  ...
  t[2] === a
    ...
    : ((T = (e) => {
        ...
        if (
          ...
          let t = e.currentTarget.closest(`[data-avatar-mascot='true']`)?.getBoundingClientRect();
          (t != null && a(v({ avatarBounds: t, clientX: e.clientX, clientY: e.clientY })),
            c(null),
            e.preventDefault(),
            (u.current = !0),
            window.setTimeout(() => {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (e) => {
        let t = l.current;
        t == null || t.pointerId !== e.pointerId || ((l.current = null), c(null));
      }),
      (t[5] = k))
    : (k = t[5]);
  let A = k,
  ...
  let M = j,
    ...
    F;
  t[8] !== r.content || t[9] !== r.isGlassy || t[10] !== N || t[11] !== P
    ? ((F = r.isGlassy
        ? (0, x.jsx)(`div`, {
            "aria-hidden": `true`,
            className: d(
  ...
  let V = f ? 1 : 0.7,
    ...
    U;
  t[18] !== V || t[19] !== H
    ? ((U = { opacity: 0, scale: V, y: H }), (t[18] = V), (t[19] = H), (t[20] = U))
    : (U = t[20]);
  let W;
  t[21] !== r.backgroundColor || t[22] !== r.foregroundColor || t[23] !== P
    ? ((W = { backgroundColor: r.backgroundColor, color: r.foregroundColor, translate: P }),
      (t[21] = r.backgroundColor),
      (t[22] = r.foregroundColor),
      (t[23] = P),
      (t[24] = W))
    : (W = t[24]);
  let G, K;
  t[25] === f
    ? ((G = t[26]), (K = t[27]))
    : ((G = f ? { duration: 0 } : { damping: 20, mass: 0.7, stiffness: 420, type: `spring` }),
      (K = f ? void 0 : { scale: 1.06 }),
      (t[25] = f),
      (t[26] = G),
      (t[27] = K));
  let q;
  t[28] === f ? (q = t[29]) : ((q = f ? void 0 : { scale: 0.94 }), (t[28] = f), (t[29] = q));
  let J;
  t[30] !== M ||
  t[31] !== E ||
  t[32] !== r.ariaLabel ||
  ...
  return (
    t[41] !== J || t[42] !== F
      ? ((Y = (0, x.jsxs)(x.Fragment, { children: [F, J] })), (t[41] = J), (t[42] = F), (t[43] = Y))
      : (Y = t[43]),
    Y
  );
}
...
var y,
  ...
  T = e(() => {
    ((y = c()),
      ...
      (w = a(`avatar-mascot-notification-badge-corner`, `top-end`)));
  });
