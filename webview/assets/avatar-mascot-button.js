...
function _(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (e) => {
        let t = c.current;
        t == null || t.pointerId !== e.pointerId || ((c.current = null), s(null));
      }),
      (t[5] = k))
    : (k = t[5]);
  let A = k,
  ...
  t[6] === n
    ? (j = t[7])
    : ((j = (e) => {
        if ((e.stopPropagation(), l.current)) {
          ((l.current = !1), e.preventDefault());
          return;
        }
        n.onClick();
      }),
  ...
  t[21] !== n.backgroundColor || t[22] !== n.foregroundColor || t[23] !== P
    ? ((W = { backgroundColor: n.backgroundColor, color: n.foregroundColor, translate: P }),
  ...
  t[25] === d
    ? ((G = t[26]), (K = t[27]))
    : ((G = d ? { duration: 0 } : { damping: 20, mass: 0.7, stiffness: 420, type: `spring` }),
      (K = d ? void 0 : { scale: 1.06 }),
      (t[25] = d),
      (t[26] = G),
      (t[27] = K));
  let q;
  t[28] === d ? (q = t[29]) : ((q = d ? void 0 : { scale: 0.94 }), (t[28] = d), (t[29] = q));
  let J;
  t[30] !== M ||
  t[31] !== E ||
  t[32] !== n.ariaLabel ||
...
var y,
  ...
  T = e(() => {
    ((y = n()),
      ...
      (w = o(`avatar-mascot-notification-badge-corner`, `top-end`)));
  });
