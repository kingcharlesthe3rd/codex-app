...
function _(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (e) => {
        let t = u.current;
        t == null || t.pointerId !== e.pointerId || ((u.current = null), l(null));
      }),
      (t[5] = k))
    : (k = t[5]);
  let A = k,
  ...
  t[6] === n
    ? (j = t[7])
    : ((j = (e) => {
        if ((e.stopPropagation(), d.current)) {
...
var y,
  ...
  T = e(() => {
    ((y = n()),
      ...
      (w = d(`avatar-mascot-notification-badge-corner`, `top-end`)));
  });
