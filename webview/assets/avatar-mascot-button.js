...
import { $s as t, Ps as n } from "./app-server-manager-signals.js";
...
function _(e) {
  ...
  let R = b ? 1 : 0.7,
    ...
    B;
  n[12] !== R || n[13] !== z
    ? ((B = { opacity: 0, scale: R, y: z }), (n[12] = R), (n[13] = z), (n[14] = B))
    : (B = n[14]);
  let V = l == null ? void 0 : `${l.x}px ${l.y}px`,
    H;
  n[15] !== r.backgroundColor || n[16] !== r.foregroundColor || n[17] !== V
    ? ((H = { backgroundColor: r.backgroundColor, color: r.foregroundColor, translate: V }),
  ...
  n[19] === b
    ...
    : ((U = b ? { duration: 0 } : { damping: 20, mass: 0.7, stiffness: 420, type: `spring` }),
      ...
      (n[21] = W));
  let G;
  n[22] === b ? (G = n[23]) : ((G = b ? void 0 : { scale: 0.94 }), (n[22] = b), (n[23] = G));
  let K;
  return (
    n[24] !== M ||
    n[25] !== E ||
