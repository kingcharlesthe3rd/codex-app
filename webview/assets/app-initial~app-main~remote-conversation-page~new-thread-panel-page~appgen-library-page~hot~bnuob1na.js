...
function v(e) {
  let t = (0, y.c)(67),
    ...
    d = ee(h),
    p;
  t[0] !== r || t[1] !== d ? ((p = d.includes(r)), (t[0] = r), (t[1] = d), (t[2] = p)) : (p = t[2]);
  let g = p,
  ...
  t[7] === _
    ? (M = t[8])
    : ((M = _?.config != null && Object.prototype.hasOwnProperty.call(_.config, S)),
      (t[7] = _),
      (t[8] = M));
  let N = M,
    P = !1,
  ...
  if (t[9] !== c || t[10] !== O || t[11] !== a || t[12] !== v || t[13] !== j) {
    ...
    ((t[9] = c), (t[10] = O), (t[11] = a), (t[12] = v), (t[13] = j), (t[14] = F), (t[15] = P));
  } else ((F = t[14]), (P = t[15]));
  let I = F;
