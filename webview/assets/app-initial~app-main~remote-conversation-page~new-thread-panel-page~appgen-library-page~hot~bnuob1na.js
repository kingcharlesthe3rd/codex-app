...
function v(e) {
  let t = (0, y.c)(67),
    ...
    d = ee(ae),
    p;
  t[0] !== i || t[1] !== d ? ((p = d.includes(i)), (t[0] = i), (t[1] = d), (t[2] = p)) : (p = t[2]);
  let m = p,
    { data: h, isLoading: v } = a(te, i),
    w = a(g, o),
    T = a(oe, o),
    E = h?.config?.[x],
    D;
  ...
  t[7] === h
    ? (M = t[8])
    : ((M = h?.config != null && Object.prototype.hasOwnProperty.call(h.config, S)),
      (t[7] = h),
      (t[8] = M));
  let N = M,
    P = !1,
    F;
  if (t[9] !== l || t[10] !== O || t[11] !== s || t[12] !== v || t[13] !== j) {
    if (((F = O ?? j), !s)) F = null;
    else if (((P = !v && F == null), P)) {
      let e;
      (t[16] === l
        ? (e = t[17])
        : ((e = n(ie(l, `1867347216`).get(C, null))), (t[16] = l), (t[17] = e)),
        (F = e ?? `friendly`));
    }
    ((t[9] = l), (t[10] = O), (t[11] = s), (t[12] = v), (t[13] = j), (t[14] = F), (t[15] = P));
  } else ((F = t[14]), (P = t[15]));
  let I = F;
  ...
  t[18] === u
    ? (R = t[19])
    : ((R = async () => {
        await Promise.all([u(_), u([`user-saved-config`])]);
      }),
      (t[18] = u),
      (t[19] = R));
  let z = R,
  ...
  t[20] !== i ||
  t[21] !== m ||
  t[22] !== h?.configWriteTarget?.expectedVersion ||
  t[23] !== h?.configWriteTarget?.filePath
    ? ((B = async (e) => {
        m &&
          (await f(`batch-write-config-value`, {
            hostId: i,
            edits: [{ keyPath: x, value: e, mergeStrategy: `upsert` }],
            filePath: h?.configWriteTarget?.filePath ?? null,
            expectedVersion: h?.configWriteTarget?.expectedVersion ?? null,
          }));
      }),
      (t[20] = i),
      (t[21] = m),
  ...
  t[31] !== m ||
  t[32] !== j ||
  t[33] !== h?.configWriteTarget?.expectedVersion ||
  t[34] !== h?.configWriteTarget?.filePath
    ? ((U = async () => {
        if (!m || !N) return;
  ...
  t[45] !== F || t[46] !== i || t[47] !== m || t[48] !== v
    ? ((J = () => {
        v || !m || f(`set-personality`, { hostId: i, personality: F });
      }),
      (t[45] = F),
      (t[46] = i),
      (t[47] = m),
  ...
  (t[52] !== F || t[53] !== i || t[54] !== m || t[55] !== v || t[56] !== P
    ...
    (0, b.useEffect)(X, Z));
  let Q;
  t[58] !== o || t[59] !== i || t[60] !== m || t[61] !== H
    ? ((Q = (e) => {
        m &&
          (Promise.all([
            f(`set-personality`, { hostId: i, personality: e }),
            ...(o == null
              ? []
              : [
  ...
  let $;
  return (
    t[63] !== s || t[64] !== I || t[65] !== Q
      ? (($ = { isPersonalityEnabled: s, personality: I, setPersonality: Q }),
        (t[63] = s),
        (t[64] = I),
        (t[65] = Q),
        (t[66] = $))
