...
function v(e) {
  let t = (0, y.c)(67),
    ...
    l = oe(ne),
    p;
  t[0] !== i || t[1] !== l ? ((p = l.includes(i)), (t[0] = i), (t[1] = l), (t[2] = p)) : (p = t[2]);
  let m = p,
    { data: h, isLoading: v } = d(se, i),
    w = d(ae, a),
    T = d(_, a),
    E = h?.config?.[x],
    D;
  t[3] === E ? (D = t[4]) : ((D = f(E)), (t[3] = E), (t[4] = D));
  let O = D,
    k = h?.config?.[S],
    A;
  t[5] === k ? (A = t[6]) : ((A = f(k)), (t[5] = k), (t[6] = A));
  let j = A,
    M;
  t[7] === h
    ? (M = t[8])
  ...
  if (t[9] !== s || t[10] !== O || t[11] !== o || t[12] !== v || t[13] !== j) {
    if (((F = O ?? j), !o)) F = null;
      ...
      (t[16] === s
        ? (e = t[17])
        : ((e = f(re(s, `1867347216`).get(C, null))), (t[16] = s), (t[17] = e)),
        (F = e ?? `friendly`));
    }
    ((t[9] = s), (t[10] = O), (t[11] = o), (t[12] = v), (t[13] = j), (t[14] = F), (t[15] = P));
  } else ((F = t[14]), (P = t[15]));
  let I = F;
  ...
  t[18] === c
    ? (R = t[19])
    : ((R = async () => {
        await Promise.all([c(te), c([`user-saved-config`])]);
      }),
      (t[18] = c),
      (t[19] = R));
  let z = R,
  ...
  t[45] !== F || t[46] !== i || t[47] !== m || t[48] !== v
    ? ((J = () => {
        v || !m || u(`set-personality`, { hostId: i, personality: F });
      }),
      (t[45] = F),
      (t[46] = i),
      (t[47] = m),
  ...
  t[58] !== a || t[59] !== i || t[60] !== m || t[61] !== H
    ? ((Q = (e) => {
        m &&
          (Promise.all([
            u(`set-personality`, { hostId: i, personality: e }),
            ...(a == null
              ? []
              : [
