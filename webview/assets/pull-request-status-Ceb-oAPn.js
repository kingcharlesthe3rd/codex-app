...
import { la as t, oa as n } from "./app-server-manager-signals.js";
...
function S(e) {
  ...
  t[4] === a
    ? (c = t[5])
    : ((c = a == null ? null : (0, m.jsx)(`span`, { className: `shrink-0`, children: a })),
      (t[4] = a),
      (t[5] = c));
  let l;
  return (
...
function C(e) {
  ...
  t[2] === i
    ? (u = t[3])
    : ((u = (0, m.jsx)(`span`, { className: `shrink-0 text-token-foreground`, children: i })),
      (t[2] = i),
      (t[3] = u));
  let d;
  t[4] === a
...
function w(e) {
  ...
  t[0] === i
    ? (o = t[1])
    : ((o = (0, m.jsx)(d.SectionLabel, { children: i })), (t[0] = i), (t[1] = o));
  let s;
  t[2] === r
    ? (s = t[3])
    : ((s = (0, m.jsx)(`div`, {
  ...
  let c;
  t[4] !== o || t[5] !== s
    ? ((c = (0, m.jsxs)(`div`, { className: `flex flex-col`, children: [o, s] })),
      (t[4] = o),
      (t[5] = s),
      (t[6] = c))
    : (c = t[6]);
  ...
  return (
    t[7] !== a || t[8] !== c
      ? ((l = (0, m.jsx)(`div`, { className: a, children: c })), (t[7] = a), (t[8] = c), (t[9] = l))
      : (l = t[9]),
    l
  );
}
function T(e) {
  let t = (0, v.c)(4),
    { groups: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = n.flatMap(ee).map(E)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
...
function te(e) {
  ...
  let o = r && `group-hover:underline`,
    s;
  t[2] === o ? (s = t[3]) : ((s = a(b, `text-token-foreground`, o)), (t[2] = o), (t[3] = s));
  let c;
  t[4] !== n.label || t[5] !== s
  ...
  if (!r) {
    ...
    return (
      t[20] === h
        ? (e = t[21])
        : ((e = (0, m.jsx)(`div`, { className: y, children: h })), (t[20] = h), (t[21] = e)),
      e
    );
  }
  let g;
...
function ne(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i) {
    ...
    ((c = `max-w-[220px]`),
      ...
      t[7] === i
        ? (o = t[8])
        : ((o = (0, m.jsx)(d.SectionLabel, { children: i })), (t[7] = i), (t[8] = o)),
      (s =
        e.length === 0
  ...
  return (0, m.jsx)(
    c,
    {
      ...
      children: (0, m.jsxs)(`div`, {
        className: y,
        children: [
          (0, m.jsx)(`span`, { className: `shrink-0 text-token-foreground`, children: e.icon }),
          (0, m.jsx)(`span`, { className: a(b, `text-token-foreground`), children: e.label }),
        ],
      }),
    },
    t,
  ...
  return (
    t[2] === r
      ...
      : ((i = (0, m.jsx)(`div`, {
          ...
          children: (0, m.jsx)(`div`, { className: `flex flex-col gap-2`, children: r }),
        })),
        (t[2] = r),
        (t[3] = i)),
    i
  ...
  return (0, m.jsx)(
    `div`,
    {
      ...
      children: (0, m.jsx)(f, {
        ...
        metadataTooltipContent: r.position?.path == null ? null : (0, m.jsx)(N, { comment: r }),
        surface: `card`,
        url: r.url ?? null,
      }),
    },
...
function P({ canFix: e = !1, checks: t, intl: n, onFixCheck: r, onOpenCheck: i }) {
  let a = F({ canFix: e, checks: t, intl: n, onFixCheck: r, onOpenCheck: i });
  if (a.length !== 0) return (0, m.jsx)(w, { groups: a, title: B(t, n) });
}
function F({ canFix: e = !1, checks: t, intl: n, onFixCheck: r, onOpenCheck: i }) {
  let a = [],
    o = [],
    s = [],
    c = [],
...
function I({ ciStatus: e }) {
  switch (e) {
    case `failing`:
      return (0, m.jsx)(_, { className: `icon-sm shrink-0 text-token-charts-red` });
    case `none`:
      return (0, m.jsx)(h, { className: `icon-sm shrink-0 text-token-description-foreground` });
    case `passing`:
      return (0, m.jsx)(u, { className: `icon-sm shrink-0 text-token-charts-green` });
    case `pending`:
      return (0, m.jsx)(g, { className: `icon-sm shrink-0 text-token-charts-yellow` });
  }
}
function L(e) {
  switch (e) {
  ...
  return r.length === 0
    ...
    : (0, m.jsxs)(`span`, {
        ...
        children: [
          ...
          (0, m.jsx)(`span`, { className: `font-normal text-token-foreground/60`, children: r }),
        ],
      });
}
function V(e, t) {
...
function Y(e) {
  ...
  return (
    t[5] !== s || t[6] !== c
      ? ((l = (0, m.jsx)(s, { className: c })), (t[5] = s), (t[6] = c), (t[7] = l))
      : (l = t[7]),
    l
  );
}
...
var ae = { draft: W, open: p, merged: K, closed: U },
  ...
  se = { draft: W, failing: G, in_progress: q, merged: K, ready: J, successful: J },
  ce = {
    draft: `text-token-description-foreground`,
...
function le({ status: e, tone: t }) {
  return {
    Icon: ae[e],
    iconClassName: t === `currentColor` ? `text-current` : t === `neutral` ? Q : oe[e],
  };
}
function $({ state: e, tone: t }) {
  return {
    Icon: se[e],
    iconClassName:
      t === `currentColor` ? a(`text-current`, Z[e]) : t === `neutral` ? a(Q, Z[e]) : ce[e],
  };
}
export {
  W as a,
...
//# sourceMappingURL=pull-request-status-Ceb-oAPn.js.map
