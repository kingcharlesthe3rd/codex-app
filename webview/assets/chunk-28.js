...
import { n as r, t as i } from "./rough.esm-2.js";
import { i as a, n as o, r as s } from "./chunk-49.js";
import {
  A as c,
  M as l,
  R as u,
...
import { i as _, l as v, n as y, u as b } from "./chunk-33.js";
import { i as x, n as S, r as C } from "./chunk-127.js";
import { n as w, r as T, t as E } from "./chunk-145.js";
import { a as D, i as O, n as k, o as A, t as j } from "./chunk-133.js";
function M(e) {
...
function se(e, t) {
  ...
  return (
    ...
    Y(t, m),
    (t.intersect = function (e) {
      return (a.info(`crossedCircle intersect`, t, { radius: s, point: e }), Q.circle(t, s, e));
    }),
    o
  );
}
...
async function fe(e, t) {
  ...
  if (t.width || t.height) {
    ...
    let n = e / 2 / (2.5 + e / 50);
    ((t.height = (t.height ?? 0) - o - n * 3), t.height < Ft && (t.height = Ft));
  }
...
async function me(e, t) {
  ...
  if (t.look === `handDrawn`) {
    ...
    (p.attr(`class`, `basic label-container`).attr(`style`, r),
      e.attr(`class`, `outer-circle`).attr(`style`, r).attr(`r`, d).attr(`cx`, 0).attr(`cy`, 0),
      t.attr(`class`, `inner-circle`).attr(`style`, r).attr(`r`, f).attr(`cx`, 0).attr(`cy`, 0));
  }
  return (
    Y(t, p),
    (t.intersect = function (e) {
...
function he(e, t, { config: { themeVariables: n } }) {
  ...
  return (
    ...
    c && c.length > 0 && t.look !== `handDrawn` && p.selectAll(`path`).attr(`style`, c),
    o && t.look !== `handDrawn` && p.selectAll(`path`).attr(`style`, o),
    Y(t, p),
    (t.intersect = function (e) {
      return (a.info(`filledCircle intersect`, t, { radius: 7, point: e }), Q.circle(t, 7, e));
    }),
    s
  );
}
...
function _e(e, t, { dir: n, config: { state: r, themeVariables: a } }) {
  ...
  n === `LR` && ((l = Math.max(10, t?.width ?? 0)), (u = Math.max(70, t?.height ?? 0)));
  let d = (-1 * l) / 2,
    f = (-1 * u) / 2,
    p = i.svg(s),
...
async function ve(e, t) {
  ...
  return (
    ...
    Y(t, y),
    (t.intersect = function (e) {
      return (a.info(`Pill intersect`, t, { radius: f, point: e }), Q.polygon(t, g, e));
    }),
    c
  );
}
...
async function xe(e, t, { config: { themeVariables: n, flowchart: r } }) {
  ...
  let T = S.rectangle(y, b, g, h, w),
    ...
    O = h + f.height + x,
    k = S.rectangle(-E / 2, -O / 2, E, O, { ...w, fill: `transparent`, stroke: `none` }),
    M = d.insert(() => T, `:first-child`),
    N = d.insert(() => k);
  if (t.icon) {
    let e = d.append(`g`);
    e.html(`<g>${await C(t.icon, { height: l, width: l, fallbackPrefix: `` })}</g>`);
  ...
  return (
    ...
    M.attr(`transform`, `translate(0,${m ? f.height / 2 + x / 2 : -f.height / 2 - x / 2})`),
    Y(t, N),
    (t.intersect = function (e) {
...
async function Se(e, t, { config: { themeVariables: n, flowchart: r } }) {
  ...
  let x = d.append(`g`);
  t.icon && x.html(`<g>${await C(t.icon, { height: l, width: l, fallbackPrefix: `` })}</g>`);
  let S = x.node().getBBox(),
    ...
    P = k + f.height + m,
    F = y.rectangle(-N / 2, -P / 2, N, P, { ...b, fill: `transparent`, stroke: `none` }),
  ...
  return (
    ...
    ee.attr(`transform`, `translate(0,${h ? f.height / 2 + m / 2 : -f.height / 2 - m / 2})`),
    Y(t, I),
    (t.intersect = function (e) {
...
async function Ce(e, t, { config: { themeVariables: n, flowchart: r } }) {
  ...
  let s = t.assetHeight ?? 48,
    ...
    u = r?.wrappingWidth;
  t.width = Math.max(l, u ?? 0);
  let { shapeSvg: d, bbox: f, halfPadding: p, label: m } = await J(e, t, `icon-shape default`),
    h = t.pos === `t`,
    g = l + p * 2,
    _ = l + p * 2,
  ...
  let O = T.path(Z(x, S, _, g, 5), E),
    ...
    M = g + f.height + w,
    N = T.rectangle(-k / 2, -M / 2, k, M, { ...E, fill: `transparent`, stroke: `none` }),
  ...
  return (
    ...
    P.attr(`transform`, `translate(0,${h ? f.height / 2 + w / 2 : -f.height / 2 - w / 2})`),
    Y(t, F),
    (t.intersect = function (e) {
      if ((a.info(`iconSquare intersect`, t, e), !t.label)) return Q.rect(t, e);
      let n = t.x ?? 0,
...
async function Te(e, t, { config: { flowchart: n } }) {
  ...
  let u = Math.max(t.label ? (l ?? 0) : 0, t?.assetWidth ?? o),
    d = t.constraint === `on` && t?.assetHeight ? t.assetHeight * t.imageAspectRatio : u,
  ...
  let S = b.rectangle(_, v, d, f, x),
    ...
    w = f + m.height + y,
    T = b.rectangle(-C / 2, -w / 2, C, w, { ...x, fill: `none`, stroke: `none` }),
  ...
  return (
    ...
    E.attr(`transform`, `translate(0,${g ? m.height / 2 + y / 2 : -m.height / 2 - y / 2})`),
    Y(t, O),
    (t.intersect = function (e) {
      if ((a.info(`iconSquare intersect`, t, e), !t.label)) return Q.rect(t, e);
      let n = t.x ?? 0,
...
async function De(e, t, n) {
  ...
  if ((n?.rx && n.ry && ((p = n.rx), (m = n.ry)), t.look === `handDrawn`)) {
    let e = i.svg(o),
      n = A(t, {}),
      r = p || m ? e.path(Z(u, d, c, l, p || 0), n) : e.rectangle(u, d, c, l, n);
...
async function Me(e, t) {
  ...
  if (t.width || t.height) {
    ...
    let n = e / 2 / (2.5 + e / 50);
    ((t.height = (t.height ?? 0) - s - n * 3), t.height < Ut && (t.height = Ut));
  }
  let { shapeSvg: c, bbox: l, label: u } = await J(e, t, X(t)),
...
async function Fe(e, t) {
  ...
  let { shapeSvg: a, bbox: o, label: s } = await J(e, t, X(t)),
    ...
    d = !0;
  (t.width || t.height) &&
    ((d = !1), (t.width = (t?.width ?? 0) - l * 2), (t.height = (t?.height ?? 0) - u * 3));
...
async function Le(e, t) {
  ...
  if (t.look === `handDrawn`) {
    ...
    ((u = a
      ...
      d && u.attr(`style`, d));
  } else ((u = V(a, s, s, l)), u.attr(`transform`, `translate(${-s / 2 + c}, ${s / 2})`));
  return (
    r && u.attr(`style`, r),
    Y(t, u),
    (t.calcIntersect = function (e, t) {
...
async function ze(e, n) {
  ...
  if (m(d())) {
    let e = h.children[0],
      n = t(h);
    ((g = e.getBoundingClientRect()), n.attr(`width`, g.width), n.attr(`height`, g.height));
  }
  a.info(`Text 2`, f);
  let _ = f || [],
    v = h.getBBox(),
    y = await xt(u, Array.isArray(_) ? _.join(`<br/>`) : _, n.labelStyle, !0, !0),
    b = y.children[0],
    x = t(y);
  ((g = b.getBoundingClientRect()), x.attr(`width`, g.width), x.attr(`height`, g.height));
  let S = (n.padding || 0) / 2;
  (t(y).attr(
    `transform`,
    `translate( ` +
    ...
    (g = u.node().getBBox()),
    u.attr(`transform`, `translate(` + -g.width / 2 + `, ` + (-g.height / 2 - S + 3) + `)`));
  ...
  if (n.look === `handDrawn`) {
    ...
    ((k = c.insert(() => (a.debug(`Rough node insert CXC`, r), o), `:first-child`)),
      (O = c.insert(() => (a.debug(`Rough node insert CXC`, r), r), `:first-child`)));
  } else
...
async function Ye(e, t) {
  ...
  (t.width || t.height) &&
    ...
    (t.width = Math.max((t?.width ?? 0) - o * 2 - Jt * (t.height + s * 2), 10)));
  let { shapeSvg: c, bbox: l } = await J(e, t, X(t)),
...
async function at(e, n) {
  ...
  if (r.attributes.length === 0 && n.label) {
    let t = { rx: 0, ry: 0, labelPaddingX: p, labelPaddingY: p * 1.5, classes: `` };
    y(n.label, d) + t.labelPaddingX * 2 < d.er.minEntityWidth && (n.width = d.er.minEntityWidth);
        ...
        e &&
          ...
          i.attr(`class`).includes(`attribute-name`)
            ...
            : i.attr(`class`).includes(`attribute-keys`)
              ? (o += E + O)
              : i.attr(`class`).includes(`attribute-comment`) && (o += E + O + k));
      }
      i.attr(`transform`, `translate(${z + p / 2 + o}, ${s + B + S.height + m / 2})`);
    }),
    x.select(`.name`).attr(`transform`, `translate(` + -S.width / 2 + `, ` + (B + m / 2) + `)`),
    a != null && nn.has(a))
  ) {
    let e = r.colorIndex ?? 0;
...
async function ot(e, n, r, i = 0, a = 0, o = [], s = ``) {
  let c = e
    ...
    .attr(`style`, s);
  n !== l(n) && ((n = l(n)), (n = n.replaceAll(`<`, `&lt;`).replaceAll(`>`, `&gt;`)));
  let u = c
    .node()
    .appendChild(await S(c, n, { width: y(n, r) + 100, style: s, useHtmlLabels: r.htmlLabels }, r));
...
async function lt(e, n, r, i = []) {
  ...
  if (c) {
    ...
    ((m = e.innerHTML.split(`<br>`).length),
      e.innerHTML.includes(`</math>`) && (m += e.innerHTML.split(`<mrow>`).length - 1));
            ...
            new Promise((n) => {
              function r() {
                if (((t.style.display = `flex`), (t.style.flexDirection = `column`), e)) {
                  let e = s.fontSize?.toString() ?? window.getComputedStyle(document.body).fontSize,
    ...
    (i.includes(`font-weight: bolder`) && t(u).selectAll(`tspan`).attr(`font-weight`, ``),
      (m = u.children.length));
    let e = u.children[0];
    ((u.textContent === `` || u.textContent.includes(`&gt`)) &&
      ((e.textContent =
        l[0] + l.substring(1).replaceAll(`&gt;`, `>`).replaceAll(`&lt;`, `<`).trim()),
      l[1] === ` ` && (e.textContent = e.textContent[0] + ` ` + e.textContent.substring(1))),
      e.textContent === `undefined` && (e.textContent = ``),
      (d = u.getBBox()));
  }
  return (a.attr(`transform`, `translate(0,` + (-d.height / (2 * m) + r) + `)`), d.height);
}
async function ut(e, n) {
  ...
  let v = u.members.length === 0 && u.methods.length === 0 && !r.class?.hideEmptyMembersBox,
    y = i.svg(p),
    b = A(n, {});
  ...
  let O = y.rectangle(
      w - s,
      T - s - (v ? s : u.members.length === 0 && u.methods.length === 0 ? -s / 2 : 0),
      x + 2 * s,
      S + 2 * s + E,
      b,
    ),
  ...
  let j = k.node().getBBox(),
    M = p.select(`.annotation-group`).node().getBBox().height - (v ? s / 2 : 0) || 0,
    N = p.select(`.label-group`).node().getBBox().height - (v ? s / 2 : 0) || 0,
    P = p.select(`.members-group`).node().getBBox().height - (v ? s / 2 : 0) || 0,
    F =
      (M +
        N +
        T +
  ...
  if (
    (p.selectAll(`.text`).each((e, n, i) => {
      ...
      let f = d + T + s - (v ? s : u.members.length === 0 && u.methods.length === 0 ? -s / 2 : 0);
      if (a.attr(`class`).includes(`methods-group`)) {
        let e = Math.max(P, c / 2);
        f = C ? Math.max(F, M + N + e + T + c * 2 + s) + c * 2 : M + N + e + T + c * 4 + s;
      }
      (u.members.length === 0 &&
        u.methods.length === 0 &&
  ...
  if (v || u.members.length > 0 || u.methods.length > 0) {
    let e = M + N + P + T + c * 2 + s,
      t = y.line(j.x, C ? Math.max(F, e) : e, j.x + j.width, (C ? Math.max(F, e) : e) + 0.001, b);
    p.insert(() => t)
      .attr(`class`, `divider${n.look === `neo` && !o ? ` neo-line` : ``}`)
      .attr(`style`, _);
  }
...
async function dt(e, n) {
  ...
  if (((g += _ + 20), c)) {
    let e = await q(m, `${o.requirementId ? `ID: ${o.requirementId}` : ``}`, g, n.labelStyle);
    g += e;
    let t = await q(m, `${o.text ? `Text: ${o.text}` : ``}`, g, n.labelStyle);
    g += t;
    let r = await q(m, `${o.risk ? `Risk: ${o.risk}` : ``}`, g, n.labelStyle);
    ((g += r),
      await q(m, `${o.verifyMethod ? `Verification: ${o.verifyMethod}` : ``}`, g, n.labelStyle));
  } else {
    let e = await q(m, `${s.type ? `Type: ${s.type}` : ``}`, g, n.labelStyle);
    ((g += e), await q(m, `${s.docRef ? `Doc Ref: ${s.docRef}` : ``}`, g, n.labelStyle));
  }
  ...
  if ((T.attr(`class`, `basic label-container outer-path`).attr(`style`, a), f?.length)) {
  ...
  return (
    ...
    a && n.look !== `handDrawn` && (p || f?.length) && m.selectAll(`path`).attr(`style`, a),
    m
  );
}
async function q(e, n, r, i = ``) {
  ...
  let a = e.insert(`g`).attr(`class`, `label`).attr(`style`, i),
    ...
    c = await S(
      a,
      g(_(n)),
      { width: y(n, o) + 50, classes: `markdown-node-label`, useHtmlLabels: s, style: i },
      o,
    ),
    l;
  if (s) {
    let e = c.children[0],
      n = t(c);
    ((l = e.getBoundingClientRect()), n.attr(`width`, l.width), n.attr(`height`, l.height));
  } else {
    let e = c.children[0];
...
async function ft(e, t, { config: n }) {
  ...
  let p = {
    ...
    h;
  f
    ? ({ label: m, bbox: h } = await yt(f, (`ticket` in t && t.ticket) || ``, p))
    : ({ label: m, bbox: h } = await yt(s, (`ticket` in t && t.ticket) || ``, p));
  let { label: g, bbox: _ } = await yt(s, (`assigned` in t && t.assigned) || ``, p);
  t.width = o;
  let v = t?.width || 0,
    ...
    x = -v / 2,
    S = -b / 2;
  (l.attr(`transform`, `translate(` + (u - v / 2) + `, ` + (-y - c.height / 2) + `)`),
    m.attr(`transform`, `translate(` + (u - v / 2) + `, ` + (-y + c.height / 2) + `)`),
    g.attr(
      `transform`,
      `translate(` + (u + v / 2 - _.width - 20) + `, ` + (-y + c.height / 2) + `)`,
    ));
  let C,
    { rx: w, ry: T } = t,
    { cssStyles: E } = t;
  if (t.look === `handDrawn`) {
    let e = i.svg(s),
      n = A(t, {}),
      r = w || T ? e.path(Z(x, S, v, b, w || 0), n) : e.rectangle(x, S, v, b, n);
...
var J,
  ...
  fn = e(() => {
    (T(),
      ...
      (J = o(async (e, n, r) => {
        ...
        let o = e
            ...
            .attr(`class`, i)
            .attr(`id`, n.domId || n.id),
          s = o.insert(`g`).attr(`class`, `label`).attr(`style`, v(n.labelStyle)),
          c;
        c = n.label === void 0 ? `` : typeof n.label == `string` ? n.label : n.label[0];
        let l = !!n.icon || !!n.img,
      ...
      (yt = o(async (e, n, r) => {
        ...
        if (m(d())) {
          let e = o.children[0],
            n = t(o);
          ((s = e.getBoundingClientRect()), n.attr(`width`, s.width), n.attr(`height`, s.height));
        }
        return (
          i
      ...
      (xt = o(async (e, t, n, r = !1, i = !1) => {
        ...
        return await S(
          e,
          a,
          { style: n, isTitle: r, useHtmlLabels: s, markdown: !1, isNode: i, width: 1 / 0 },
          o,
        );
      }, `createLabel`)),
      (Z = o(
      ...
      (St = o(async (e, n) => {
        ...
        let r = d(),
          ...
          { labelStyles: u, nodeStyles: f, borderStyles: p, backgroundStyles: h } = D(n),
          g = e
            .insert(`g`)
        ...
        if (m(r)) {
          let e = y.children[0],
            n = t(y);
          ((b = e.getBoundingClientRect()), n.attr(`width`, b.width), n.attr(`height`, b.height));
        }
        ...
        if (n.look === `handDrawn`) {
          let e = i.svg(g),
            t = A(n, { roughness: 0.7, fill: c, stroke: l, fillWeight: 3, seed: s }),
            r = e.path(Z(T, E, x, C, 0), t);
          ((O = g.insert(() => (a.debug(`Rough node insert CXC`, r), r), `:first-child`)),
            O.select(`path:nth-child(2)`).attr(`style`, p.join(`;`)),
            O.select(`path`).attr(`style`, h.join(`;`).replace(`fill`, `stroke`)));
        } else
        ...
        if (
          (v.attr(`transform`, `translate(${n.x - b.width / 2}, ${n.y - n.height / 2 + k})`), u)
        ) {
          let e = v.select(`span`);
          e && e.attr(`style`, u);
        }
      ...
      (Ct = {
        ...
        roundedWithTitle: o(async (e, n) => {
          ...
          if (m(r)) {
            let e = _.children[0],
              n = t(_);
            ((v = e.getBoundingClientRect()), n.attr(`width`, v.width), n.attr(`height`, v.height));
          }
          let y = 0 * n.padding,
            b = y / 2,
            x = (n.width <= v.width + n.padding ? v.width + n.padding : n.width) + y;
          ...
          if (n.look === `handDrawn`) {
            ...
            ((D = p.insert(`rect`, `:first-child`)),
              ...
              g
                ...
                .attr(`height`, C));
          return (
            h.attr(`transform`, `translate(${n.x - v.width / 2}, ${T + 1 - (m(r) ? 0 : 3)})`),
        ...
        kanbanSection: o(async (e, n) => {
          ...
          if (n.look === `handDrawn`) {
            let e = i.svg(g),
              t = A(n, { roughness: 0.7, fill: c, stroke: l, fillWeight: 4, seed: s }),
    ...
    l${-n},0`,
      ...
      (rn = new Set([`redux`, `redux-dark`, `redux-color`, `redux-dark-color`])),
      o(at, `erBox`),
      o(ot, `addText`),
      o(st, `lineToPolygon`),
      o(ct, `textHelper`),
