...
function J(e, t) {
  let n = t.get(e);
  return (
    n === void 0 && ((n = { width: q().measureText(e).width, containsCJK: S(e) }), t.set(e, n)), n
  );
}
function Y() {
  if (W !== null) return W;
...
function Qe(e) {
  ...
  bb0: {
    ...
    let e;
    (t[1] !== a || t[2] !== l.font || t[3] !== l.maxWidthPx
  ...
  t[5] === o
    ? (p = t[6])
    : ((p = n(`block min-w-0 overflow-hidden whitespace-nowrap`, o)), (t[5] = o), (t[6] = p));
  let m;
  t[7] !== d || t[8] !== c || t[9] !== p
