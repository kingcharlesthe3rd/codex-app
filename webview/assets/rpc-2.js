    ...
    switch (a(e)) {
      ...
      case `rpc-target`: {
        let n = e,
          r;
        return (
          (r = o ? o.getHookForRpcTarget(n, t, i) : D.create(n, t)), this.hooks.push(r), new g(r)
        );
      }
      case `rpc-thenable`: {
        let a = e,
...
function se(e, t, n) {
  return new oe(new F(e), t, n).getRemoteMain();
}
var F = class {
    constructor(e) {
      ((this.#e = e),
  ...
  L = class {
    ...
    constructor(e, t) {
      (I
        ? (this.context = { parent: I, captures: [], subject: I.capture(e), path: t })
        : (this.context = { parent: void 0, captures: [], subject: e, path: t }),
        (I = this));
    }
    unregister() {
      I = this.context.parent;
    }
    makeInput() {
      return new z(this, 0);
    }
...
function V(e, t, n, r, i) {
  let a = new B(r, new T(S.deepCopyFrom(e, t, n)));
  try {
    return a.apply(i);
  } finally {
    a.dispose();
...
s.applyMap = (e, t, n, r, i) => {
  try {
    ...
    if (e instanceof Array) {
      let t = [];
      try {
        for (let a of e) t.push(V(a, e, n, r, i));
      } catch (e) {
        for (let e of t) e.dispose();
        throw e;
      }
      a = S.fromArray(t);
    } else a = e == null ? S.fromAppReturn(e) : V(e, t, n, r, i);
    return new T(a);
  } finally {
    for (let e of r) e.dispose();
  }
};
var H = class e extends u {
    state;
    static create(t) {
    ...
    onAck(e) {
      ...
      if (((this.minRtt = Math.min(this.minRtt, n)), this.firstAckTime === 0))
        ...
        let i = t - n,
          ...
          o = this.inStartupPhase ? ce : K,
          s = a * this.minRtt * o;
        ((s = Math.min(s, e.windowAtSend * o)),
          (s = e.windowFullAtSend ? Math.max(s, e.windowAtSend * le) : Math.max(s, this.window)),
          (this.window = Math.max(Math.min(s, W), G)),
          this.inStartupPhase &&
            e.sentTime >= this.roundStartTime &&
            (this.window > this.lastRoundWindow * K
              ? (this.roundsWithoutIncrease = 0)
              : ++this.roundsWithoutIncrease >= ue && (this.inStartupPhase = !1),
...
((l.createWritableStreamHook = H.create),
  (l.createWritableStreamFromHook = fe),
  (l.createReadableStreamHook = pe.create));
var q = n,
  J = se,
  Y = new Set(),
  X = null,
...
function ve() {
  ...
  return (
    window.postMessage({ type: `connect-app-host`, port: t }, window.location.origin, [t]), J(e, _e)
  );
}
async function Z() {
  ((Q = ve()), ($ = await Q.services));
}
var Q, $;
export { J as a, he as i, $ as n, Z as r, Q as t };
