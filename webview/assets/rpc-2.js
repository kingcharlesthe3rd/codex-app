const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "./download.js",
      "./info-1.js",
      "./thread-page-bottom-panel-state-B.js",
...
function re(e) {
  return d(e).replace(/\/+$/, ``).split(`/`).filter(Boolean).slice(-2).join(`/`);
}
function ie({ root: e, relativePath: t, includeWorkspaceRootLabel: n }) {
  let r = d(t);
  if (!n) return r;
  let i = oe(e);
  return i ? (r ? `${i}/${r}` : i) : r;
...
function ae(e, t) {
  let n = t.map((e) => d(e).replace(/\/+$/, ``));
  if (new Set(n).size <= 1) return d(e).replace(/\/+$/, ``);
...
var m = globalThis[ue],
  h = m ? m.RpcTarget : class {},
  de = async function () {}.constructor,
  fe = typeof Buffer < `u` ? Buffer.prototype : void 0;
function g(e) {
  switch (typeof e) {
    case `boolean`:
    case `number`:
  ...
  switch (t) {
    ...
    default:
      if (m) {
        if (t == m.RpcStub.prototype || e instanceof m.ServiceStub) return `rpc-target`;
        if (t == m.RpcPromise.prototype || t == m.RpcProperty.prototype) return `rpc-thenable`;
      }
      return e instanceof h ? `rpc-target` : e instanceof Error ? `error` : `unsupported`;
  }
}
function _() {
  throw Error(`RPC map() implementation was not loaded.`);
}
var v = { applyMap: _, sendMap: _ };
function y() {
  throw Error(`Stream implementation was not loaded.`);
}
var b = {
    createWritableStreamHook: y,
    createWritableStreamFromHook: y,
    createReadableStreamHook: y,
  },
  x = class {
    stream(e, t) {
  ...
  pe = new S(Error(`Attempted to use RPC stub after it has been disposed.`)),
  C = (e, t, n) => e.call(t, n);
function me(e, t) {
  let n = C;
  C = e;
...
var w = Symbol(`realStub`),
  he = {
    apply(e, t, n) {
      let r = e.raw;
      return new E(C(r.hook, r.pathIfPromise || [], A.fromAppParams(n)), []);
    },
    get(e, t, n) {
      let r = e.raw;
      if (t === w) return r;
      ...
      if (typeof t == `string`)
        return new E(r.hook, r.pathIfPromise ? [...r.pathIfPromise, t] : [t]);
      if (t === Symbol.dispose && (!r.pathIfPromise || r.pathIfPromise.length == 0))
        return () => {
          (r.hook.dispose(), (r.hook = pe));
        };
    },
    has(e, t) {
      let n = e.raw;
  ...
  T = class e extends h {
    constructor(e, t) {
      if ((super(), !(e instanceof x))) {
        ...
        if (
          ((e =
            n instanceof h || n instanceof Function
              ? F.create(n, void 0)
              : new N(A.fromAppReturn(n))),
          t)
        )
      ...
      let n = () => {};
      return ((n.raw = this), new Proxy(n, he));
    }
    hook;
    pathIfPromise;
    dup() {
  ...
  E = class extends T {
    ...
    then(e, t) {
      return k(this).then(...arguments);
    }
    catch(e) {
      return k(this).catch(...arguments);
    }
    finally(e) {
      return k(this).finally(...arguments);
    }
    toString() {
...
var A = class e {
  ...
  deepCopy(e, t, n, r, i, a) {
    switch (g(e)) {
      ...
      case `rpc-promise`: {
        let t = e,
          a;
        if (((a = i ? _e(t) : ge(t)), t instanceof E)) {
          let e = new E(a, []);
      ...
      case `rpc-target`: {
        let n = e,
          r;
        return (
          (r = a ? a.getHookForRpcTarget(n, t, i) : F.create(n, t)), this.hooks.push(r), new T(r)
        );
      }
      case `rpc-thenable`: {
        let o = e,
          s;
        return (
          (s = a ? new E(a.getHookForRpcTarget(o, t, i), []) : new E(F.create(o, t), [])),
      ...
      case `writable`: {
        let n = e,
          r;
        return (
          (r = a ? a.getHookForWritableStream(n, t, i) : b.createWritableStreamHook(n)),
          this.hooks.push(r),
          n
        );
      }
      case `readable`: {
        let n = e,
          r;
        return (
          (r = a ? a.getHookForReadableStream(n, t, i) : b.createReadableStreamHook(n)),
          this.hooks.push(r),
          n
        );
      }
  ...
  async deliverCall(t, n) {
    try {
      ...
      return i instanceof E ? e.fromAppReturn(i) : e.fromAppReturn(await i);
    } finally {
      this.dispose();
    }
  }
  ...
  disposeImpl(e, t) {
    switch (g(e)) {
      ...
      case `rpc-target`: {
        ...
        n ? (n.dispose(), this.rpcTargets.delete(t)) : P(t);
        return;
      }
      case `rpc-thenable`:
        return;
      ...
      case `writable`: {
        let t = e,
          n = this.rpcTargets?.get(t);
        (n ? this.rpcTargets.delete(t) : (n = b.createWritableStreamHook(t)), n.dispose());
        return;
      }
      case `readable`: {
        let t = e,
          n = this.rpcTargets?.get(t);
        (n ? this.rpcTargets.delete(t) : (n = b.createReadableStreamHook(t)), n.dispose());
        return;
      }
      default:
        return;
  ...
  ignoreUnhandledRejections() {
    this.hooks
      ? (this.hooks.forEach((e) => {
        ...
        this.promises.forEach((e) => ve(e.promise).ignoreUnhandledRejections()))
  ...
  ignoreUnhandledRejectionsImpl(e) {
    switch (g(e)) {
      ...
      case `stub`:
      case `rpc-promise`:
        ve(e).ignoreUnhandledRejections();
        return;
      case `rpc-thenable`:
        e.then(
          (e) => {},
...
function j(e, t, n, r) {
  for (let i = 0; i < n.length; i++) {
    ...
    switch (g(e)) {
      ...
      case `stub`:
      case `rpc-promise`: {
        let { hook: t, pathIfPromise: r } = O(e);
  ...
  if (e instanceof E) {
    let { hook: t, pathIfPromise: n } = O(e);
...
var M = class extends x {
    call(e, t) {
      try {
        ...
        return new I(t.deliverCall(i.value, i.parent).then((e) => new N(e)));
      } catch (e) {
        return new S(e);
      }
    }
    map(e, t, n) {
      try {
        ...
        return r.hook
          ...
          : v.applyMap(r.value, r.parent, r.owner, t, n);
      } catch (e) {
        return new S(e);
      }
    }
    get(e) {
      try {
        ...
        let r = j(t, void 0, e, n);
        return r.hook
          ? r.hook.get(r.remainingPath)
          : new N(A.deepCopyFrom(r.value, r.parent, r.owner));
      } catch (e) {
        return new S(e);
      }
    }
  ...
  N = class e extends M {
    ...
    dup() {
      ...
      return new e(A.deepCopyFrom(t.value, void 0, t));
    }
    pull() {
    ...
    onBroken(e) {
      this.payload && this.payload.value instanceof T && this.payload.value.onRpcBroken(e);
    }
  };
function P(e) {
...
var F = class e extends M {
    ...
    pull() {
      ...
      return `then` in e
        ? Promise.resolve(e).then((e) => A.fromAppReturn(e))
        : Promise.reject(Error(`Tried to resolve a non-promise stub.`));
    }
    ignoreUnhandledRejections() {}
    dispose() {
      this.target &&= (this.refcount && --this.refcount.count == 0 && P(this.target), void 0);
    }
    onBroken(e) {}
  },
  I = class e extends x {
  ...
  return new E(
    new I(
      new Response(t).arrayBuffer().then((t) => {
        ...
        return new N(A.fromAppReturn(r));
      }),
    ),
    [],
  );
...
var R = class e {
    ...
    promises = [];
    evaluate(e) {
      let t = A.forEvaluate(this.hooks, this.promises);
      try {
  ...
  Ce = class {
    constructor(e, t, n) {
      ((this.transport = e),
        ...
        this.imports.push(new z(this, 0, !1)));
      let r,
        i = new Promise((e, t) => {
          r = t;
        });
      ...
      if (!t.pull) {
        let n = async () => {
            ...
            for (;;) {
              ...
              if (t.value instanceof T) {
                let { hook: n, pathIfPromise: r } = O(t.value);
        ...
        (++this.pullCount,
          (t.pull = n()
            .then(
              (t) => {
                let n = L.devaluate(t.value, void 0, this, t);
                (this.send([`resolve`, e, n]), r && this.releaseExport(e, 1));
              },
              (t) => {
                (this.send([`reject`, e, L.devaluate(t, void 0, this)]),
    ...
    getImport(e) {
      if (e instanceof B && e.entry && e.entry.session === this) return e.entry.importId;
    }
    importStub(e) {
      if (this.abortReason) throw this.abortReason;
      let t = this.imports[e];
      return (t || ((t = new z(this, e, !1)), (this.imports[e] = t)), new B(!1, t));
    }
    importPromise(e) {
      if (this.abortReason) throw this.abortReason;
      if (this.imports[e])
      ...
      let t = new z(this, e, !0);
      return ((this.imports[e] = t), new B(!0, t));
    }
    getExport(e) {
    ...
    sendCall(e, t, n) {
      ...
      let r = [`pipeline`, e, t];
      if (n) {
        let e = L.devaluate(n.value, void 0, this, n);
        r.push(e[0]);
      }
      this.send([`push`, r]);
      let i = new z(this, this.imports.length, !1);
      return (this.imports.push(i), new B(!0, i));
    }
    sendStream(e, t, n) {
      if (this.abortReason) throw this.abortReason;
      let r = [`pipeline`, e, t],
        i = L.devaluate(n.value, void 0, this, n);
      r.push(i[0]);
    ...
    sendMap(e, t, n, r) {
      ...
      this.send([`push`, i]);
      let a = new z(this, this.imports.length, !1);
      return (this.imports.push(a), new B(!0, a));
    }
    sendPull(e) {
      if (this.abortReason) throw this.abortReason;
      this.send([`pull`, e]);
    ...
    abort(e, t = !0) {
      if (this.abortReason === void 0) {
        if ((this.cancelReadLoop(e), t))
          try {
            this.transport
              .send(JSON.stringify([`abort`, L.devaluate(e, void 0, this)]))
              .catch((e) => {});
          } catch {}
        if (
      ...
      for (; !this.abortReason; ) {
        ...
        if (t instanceof Array)
          switch (t[0]) {
            case `push`:
              if (t.length > 1) {
                let e = new N(new R(this).evaluate(t[1]));
            ...
            case `reject`: {
              ...
              if (typeof e == `number` && t.length > 2) {
                ...
                if (n)
                  if (t[0] == `resolve`) n.resolve(new N(new R(this).evaluate(t[2])));
                  else {
                    let e = new R(this).evaluate(t[2]);
                    (e.dispose(), n.resolve(new S(e.value)));
                  }
                else t[0] == `resolve` && new R(this).evaluate(t[2]).dispose();
                continue;
              }
              break;
            }
  ...
  we = class {
    ...
    constructor(e, t, n = {}) {
      let r;
      ((r = t ? new N(A.fromAppReturn(t)) : new S(Error(`This connection has no main object.`))),
        (this.#e = new Ce(e, r, n)),
...
function Te(e, t, n) {
  return new we(new Ee(e), t, n).getRemoteMain();
}
var Ee = class {
    constructor(e) {
      ((this.#e = e),
  ...
  De = class {
    ...
    constructor(e, t) {
      (V
        ? (this.context = { parent: V, captures: [], subject: V.capture(e), path: t })
        : (this.context = { parent: void 0, captures: [], subject: e, path: t }),
        (V = this));
    }
    unregister() {
      V = this.context.parent;
    }
    makeInput() {
      return new U(this, 0);
    }
    makeOutput(e) {
      let t;
      try {
        t = L.devaluate(e.value, void 0, this, e);
      } finally {
        e.dispose();
      }
      return (
    ...
    pushCall(e, t, n) {
      let r = L.devaluate(n.value, void 0, this, n);
      r = r[0];
...
v.sendMap = (e, t, n) => {
  let r = new De(e, t),
    i;
  try {
    i = A.fromAppReturn(me(r.pushCall.bind(r), () => n(new E(r.makeInput(), []))));
  } finally {
    r.unregister();
  }
    ...
    apply(e) {
      try {
        ...
        for (let t of e.slice(0, -1)) {
          let e = new R(this).evaluateCopy(t);
          ...
          this.variables.push(new N(e));
        }
        return new R(this).evaluateCopy(e[e.length - 1]);
      } finally {
        for (let e of this.variables) e.dispose();
      }
    }
...
function ke(e, t, n, r, i) {
  let a = new Oe(r, new N(A.deepCopyFrom(e, t, n)));
  try {
    return a.apply(i);
  } finally {
    a.dispose();
...
v.applyMap = (e, t, n, r, i) => {
  try {
    let a;
    if (e instanceof E) throw Error(`applyMap() can't be called on RpcPromise`);
    if (e instanceof Array) {
      let t = [];
      try {
        for (let a of e) t.push(ke(a, e, n, r, i));
      } catch (e) {
        for (let e of t) e.dispose();
        throw e;
      }
      a = A.fromArray(t);
    } else a = e == null ? A.fromAppReturn(e) : ke(e, t, n, r, i);
    return new N(a);
  } finally {
    for (let e of r) e.dispose();
  }
};
var Ae = class e extends x {
    state;
    static create(t) {
    ...
    call(e, t) {
      try {
        ...
        let i = n.writer[r];
        return new I(t.deliverCall(i, n.writer).then((e) => new N(e)));
      } catch (e) {
        return new S(e);
      }
    }
    ...
    get(e) {
      return new S(Error(`Cannot access properties on a WritableStream stub`));
    }
    dup() {
    ...
    onAck(e) {
      ...
      if (((this.minRtt = Math.min(this.minRtt, n)), this.firstAckTime === 0))
        ...
        let i = t - n,
          ...
          o = this.inStartupPhase ? Pe : Fe,
          s = a * this.minRtt * o;
        ((s = Math.min(s, e.windowAtSend * o)),
          (s = e.windowFullAtSend ? Math.max(s, e.windowAtSend * Ie) : Math.max(s, this.window)),
          (this.window = Math.max(Math.min(s, Me), Ne)),
          this.inStartupPhase &&
            e.sentTime >= this.roundStartTime &&
            (this.window > this.lastRoundWindow * Fe
              ? (this.roundsWithoutIncrease = 0)
              : ++this.roundsWithoutIncrease >= Le && (this.inStartupPhase = !1),
...
function ze(e) {
  ...
  return new WritableStream({
    ...
    async close() {
      ...
      let { promise: n } = e.stream([`close`], A.fromAppParams([]));
      try {
        await n;
      } catch (e) {
        throw t ?? e;
    ...
    abort(n) {
      ...
      let { promise: r } = e.stream([`abort`], A.fromAppParams([n]));
      r.then(
        () => o(),
        () => o(),
      );
...
var Be = class e extends x {
  ...
  call(e, t) {
    return (t.dispose(), new S(Error(`Cannot call methods on a ReadableStream stub`)));
  }
  map(e, t, n) {
    for (let e of t) e.dispose();
  ...
  get(e) {
    return new S(Error(`Cannot access properties on a ReadableStream stub`));
  }
  dup() {
    let t = this.state;
...
((b.createWritableStreamHook = Ae.create),
  (b.createWritableStreamFromHook = ze),
  (b.createReadableStreamHook = Be.create));
var W = h,
  Ve = Te;
function G(e) {
...
var q = {
  ...
  J = {
    reviewFile: `[${q.reviewPath}]`,
    reviewFileToggle: `[${q.reviewFileToggle}]`,
    reviewScroll: `[${q.reviewScroll}]`,
    sidebarProjectList: (e) => `[${q.sidebarProjectListId}="${CSS.escape(e)}"]`,
    sidebarProjectRow: `[${q.sidebarProjectRow}]`,
    sidebarProjectSelect: `[${q.sidebarProjectSelect}]`,
    sidebarProjectShowAllToggle: `[${q.sidebarProjectShowAllToggle}]`,
    sidebarScroll: `[${q.sidebarScroll}]`,
    sidebarSection: `[${q.sidebarSection}]`,
    sidebarSectionToggle: `[${q.sidebarSectionToggle}]`,
    sidebarThreadRow: `[${q.sidebarThreadRow}]`,
    timelineScroll: `[${q.timelineScroll}]`,
    timelineTurn: `[data-content-search-turn-key]`,
  },
  He = [J.sidebarSection, J.sidebarProjectRow, J.sidebarThreadRow].join(`,`),
  Ue = {
    reviewFile: (e) => ({ [q.reviewPath]: e }),
    reviewFileToggle: (e) => ({ [q.reviewFileExpanded]: String(e), [q.reviewFileToggle]: `` }),
    reviewScroll: { [q.reviewScroll]: `` },
    sidebarProjectList: ({ projectId: e, showAll: t }) => ({
      [q.sidebarProjectListId]: e,
      [q.sidebarProjectShowAll]: String(t),
    }),
    sidebarProjectRow: ({ collapsed: e, label: t, projectId: n }) => ({
      [q.sidebarProjectCollapsed]: String(e),
      [q.sidebarProjectId]: n,
      [q.sidebarProjectLabel]: t,
      [q.sidebarProjectRow]: ``,
    }),
    sidebarProjectSelect: { [q.sidebarProjectSelect]: `` },
    sidebarProjectShowAllToggle: { [q.sidebarProjectShowAllToggle]: `` },
    ...
    sidebarSection: ({ collapsed: e, heading: t }) => ({
      [q.sidebarSection]: ``,
      [q.sidebarSectionCollapsed]: String(e),
      [q.sidebarSectionHeading]: t,
    }),
    sidebarSectionToggle: { [q.sidebarSectionToggle]: `` },
    sidebarThreadRow: ({ active: e, hostId: t, id: n, kind: r, pinned: i, title: a }) => ({
      [q.sidebarThreadActive]: String(e),
      [q.sidebarThreadHostId]: t ?? ``,
      [q.sidebarThreadId]: n,
      [q.sidebarThreadKind]: r,
      [q.sidebarThreadPinned]: String(i),
      [q.sidebarThreadRow]: ``,
      [q.sidebarThreadTitle]: a,
    }),
    timelineScroll: { [q.timelineScroll]: `` },
  },
  We = `current`,
  ...
  Ke = o(`type`, [
    c({ type: s(`pixels`), y: a() }),
    c({ type: s(`pages`), count: a() }),
    c({ type: s(`edge`), edge: e([`top`, `bottom`]) }),
  ]),
  qe = e([`previous`, `next`]),
  Je = n([c({ heading: i() }), c({ ordinal: a().int().nonnegative() })]),
  Ye = n([c({ projectId: i() }), c({ label: i() }), c({ ordinal: a().int().nonnegative() })]);
function Xe(e) {
...
function Ze(e, t, n = {}) {
  switch (t.type) {
    ...
    case `edge`:
      if (n.isReversed) {
        K(e, t.edge === `bottom` ? 0 : e.scrollHeight);
        return;
      }
...
function Qe(e) {
  let t = Array.from(document.querySelectorAll(J.sidebarSection));
  if (`ordinal` in e) {
    let n = t[e.ordinal];
...
function $e(e) {
  let t = Array.from(document.querySelectorAll(J.sidebarProjectRow));
  if (`ordinal` in e) {
    let n = t[e.ordinal];
...
function et(e, t) {
  ...
  K(e, G(e) - (t.type === `pixels` ? t.y : e.clientHeight * t.count));
}
function tt(e, t) {
  let n = it(e, t);
  if (n == null) {
    et(e, { type: `edge`, edge: t === `previous` ? `top` : `bottom` });
    return;
  }
  let r = e.getBoundingClientRect(),
    i = n.getBoundingClientRect(),
    a = G(e) + (r.bottom - i.bottom);
  K(e, t === `previous` ? Math.max(0, a - e.clientHeight + i.height) : Math.max(0, a));
}
function nt(e) {
  let t = d(e),
    n = Array.from(document.querySelectorAll(J.reviewFile)),
    r = n.find((e) => d(e.dataset.reviewPath ?? ``) === t) ?? null;
  if (r != null) return r;
  let i = n.filter((e) => {
    let n = d(e.dataset.reviewPath ?? ``);
...
function rt(e) {
  return J.sidebarProjectList(e);
}
function it(e, t) {
  let n = e.getBoundingClientRect(),
    r = Array.from(e.querySelectorAll(J.timelineTurn)),
    i = null;
  for (let e of r) {
    let r = e.getBoundingClientRect();
    if (t === `previous`) {
