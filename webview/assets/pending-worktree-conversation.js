import { js as e } from "./app-server-manager-signals.js";
import { m as t, n } from "./vscode-api.js";
import { Br as r, hn as i } from "./src-1.js";
...
async function c({ entry: t, workspaceRoot: n }) {
  if (t.launchMode === `fork-conversation`)
    return t.targetTurnId == null
      ? e(`fork-conversation-from-latest`, {
          hostId: t.hostId,
          conversationId: t.sourceConversationId,
          cwd: n,
          workspaceRoots: [n],
          collaborationMode: t.sourceCollaborationMode,
        })
  ...
  if (t.launchMode !== `start-conversation`)
    throw Error(`Unsupported launch mode: ${t.launchMode}`);
  return e(`start-conversation`, {
    hostId: t.hostId,
    ...a({ ...t.startConversationParamsInput, workspaceRoots: [n], cwd: n }),
    skipAutoTitleGeneration: t.initialThreadTitle != null,
  });
}
async function l({ entry: r, conversationId: a, hostConfig: o }) {
  if (r.worktreeGitRoot != null)
    try {
      await n(`worktree-set-owner-thread`, {
        params: { hostId: o.id, worktree: i(r.worktreeGitRoot), conversationId: a },
      });
    } catch (e) {
      t.warning(
  ...
  c.length !== 0 && (await e(`set-thread-title`, { conversationId: a, title: c }));
}
function u(e, t) {
