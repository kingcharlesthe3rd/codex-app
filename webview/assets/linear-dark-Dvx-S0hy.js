...
e(() => {
  ((t = `#17181d`),
    ...
    (a = `Linear Dark`),
    (o = [
      { scope: [`comment`, `punctuation.definition.comment`], settings: { foreground: `#636b7b` } },
      {
...
export { t as bg, r as chromeTheme, n as colors, s as default, i as fg, a as name, o as settings };
//# sourceMappingURL=linear-dark-Dvx-S0hy.js.map
