...
function h(e, t, n) {
  (i.dispatchMessage(`shared-object-set`, { key: t, value: n }), e.set(y, t, n));
}
function g(e, t, n) {
  let r = e.get(y, t);
...
var v,
  ...
  b = e(() => {
    ((v = t(l(), 1)),
      ...
      n(),
      m(),
      (y = u(p, (e) => window.electronBridge?.getSharedObjectSnapshotValue?.(e), {
        isEqual: v.default,
        onMount: (e, { key: t }) => {
...
function A(e) {
  ...
  let i;
  return (
    t[0] !== e || t[1] !== n ? ((i = j(e, n)), (t[0] = e), (t[1] = n), (t[2] = i)) : (i = t[2]), i
  );
}
function j(e, t) {
...
var M,
  N,
  P = e(() => {
    ((M = r()), f(), E(), k(), C(), (N = { id: D, display_name: `Local`, kind: `local` }));
  });
function F(e) {
...
//# sourceMappingURL=app-initial~app-main~remote-conversation-page~onboarding-page~projects-index-page~hotkey-wi~nek76pmq.js.map
