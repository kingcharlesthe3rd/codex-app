...
import { n as i, r as a } from "./chunk-58.js";
import {
  A as o,
  C as s,
  G as c,
...
import { n as h, t as g } from "./chunk-80.js";
import { a as _, l as v, n as y, o as b, s as x } from "./chunk-139.js";
function S(e) {
  let t = p().journey,
    n = t.maxLabelWidth;
  q = 0;
  ...
  Object.keys(K).forEach((i) => {
    ...
    (l.forEach((n, i) => {
      let a = { x: 40, y: r + 7 + i * 20, fill: `#666`, text: n, textMargin: t.boxTextMargin ?? 5 },
          ...
          parse: i(function (e) {
            ...
            for (var x, S, C, w, T, E = {}, D, O, k, A; ; ) {
              if (
                ...
                var j = ``;
                for (D in ((A = []), s[C]))
                  this.terminals_[D] && D > f && A.push(`'` + this.terminals_[D] + `'`);
                ((j = m.showPosition
                  ? `Parse error on line ` +
                    (l + 1) +
                    `:
...
Expecting ` +
                  ...
                  : `Parse error on line ` +
                    (l + 1) +
                    `: Unexpected ` +
                    (x == p ? `end of input` : `'` + (this.terminals_[x] || x) + `'`)),
                  this.parseError(j, {
                    text: m.match,
              ...
              switch (w[0]) {
                ...
                case 2:
                  if (
                    ...
                    v && (E._$.range = [o[o.length - (O || 1)].range[0], o[o.length - 1].range[1]]),
                    (T = this.performAction.apply(E, [c, u, l, h.yy, w[1], a, o].concat(ee))),
                    T !== void 0)
                  )
                    return T;
                  (O &&
...
`,
    ...
    (I = i(function (e, n) {
      ...
      return (i(c, `ambivalent`), n.score > 3 ? o(a) : n.score < 3 ? s(a) : c(a), r);
    }, `drawFace`)),
    (L = i(function (e, t) {
    ...
    (H = i(function (e, t, n, r) {
      ...
      (t.people.forEach((e) => {
        ...
        W(n)(t.task, a, o.x, o.y, o.width, o.height, { class: `task` }, n, t.colour));
    }, `drawTask`)),
    (U = i(function (e, t) {
      y(e, t);
    }, `drawBackgroundRect`)),
    ...
    (oe = i(function (e, t, r, i) {
      ...
      let _ = 0;
      (g.forEach((e) => {
        ((K[e] = { color: J.actorColours[_ % J.actorColours.length], position: _ }), _++);
      }),
        S(f),
        (Y = J.leftMargin + q),
...
//# sourceMappingURL=journeyDiagram-4.js.map
