  ...
  y = class {
    ...
    getDefaultConfig() {
      return {
        ...
        quadrantInternalBorderStrokeWidth: p.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
        quadrantExternalBorderStrokeWidth: p.quadrantChart?.quadrantExternalBorderStrokeWidth || 2,
      };
    }
    ...
    setConfig(e) {
      (r.trace(`setConfig called with: `, e), (this.config = { ...this.config, ...e }));
    }
    setThemeConfig(e) {
...
` + e,
      ...
      let p = u.securityLevel,
        m;
      p === `sandbox` && (m = t(`#i` + i));
      let h = t(p === `sandbox` ? m.nodes()[0].contentDocument.body : `body`).select(`[id="${i}"]`),
