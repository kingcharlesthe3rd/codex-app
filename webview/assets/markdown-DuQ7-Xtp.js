...
import { _ as D, o as ee } from "./vscode-api.js";
import { or as O } from "./src-1.js";
import { t as k } from "./preload-helper.js";
import { t as A } from "./react-dom.js";
import { c as j, o as M } from "./lib.js";
...
import { d as z, f as B } from "./format-skill-title.js";
import { t as re } from "./mime-types.js";
import { c as ie } from "./katex-1.js";
import { m as ae } from "./chunk-109.js";
import { t as V } from "./use-is-dark.js";
import { C as H, E as oe, T as U, s as W, w as se } from "./mention-item-B.js";
import { t as G } from "./hash-code.js";
import { t as K } from "./error-boundary.js";
import { t as q } from "./image-square.js";
...
import { l as ve, t as ye } from "./external-markdown-link.js";
import { t as be } from "./checkbox.js";
import { t as xe } from "./badge.js";
import { t as Se } from "./chat.js";
import { t as Ce } from "./code-snippet.js";
import { t as we } from "./copy-button.js";
import { t as Te } from "./image-preview-dialog.js";
var Ee = new Set([`auto`, `clip`, `hidden`, `overlay`, `scroll`]),
  Y = `data-selected-text-overlay-target`,
  De = `[${Y}]`;
function Oe({
  ...
  if (a == null || a.rangeCount === 0 || a.isCollapsed || a.toString().trim().length === 0)
    return null;
  let o = Ae(a, a.getRangeAt(0), r);
  if (o == null || (n != null && !n.contains(o.target))) return null;
  let s = le(o.range)?.trim() ?? o.range.toString().trim();
  ...
  return {
    ...
    selectedText: s,
    target: o.target,
    targetId: o.target.getAttribute(Y),
  };
}
function ke(e, t) {
  return (
...
function Ae(e, t, n) {
  let r = je(e.anchorNode, e.anchorOffset, n),
    i = je(e.focusNode, e.focusOffset, n);
  if (r != null && i != null && r.target !== i.target) return null;
  let a = r ?? i;
  return a == null ? null : { ...a, range: Ne(t, a.target) };
}
function je(e, t, n) {
  let r = Me(e),
    i = r?.closest(n);
...
function Pe(e, t, n, r) {
  ...
  let a = Array.from(e.getClientRects()),
    ...
    s = Ie(a, i);
  if (s != null && (a.length > 1 || Le(s, o) != null)) return s;
  let c = Le(e.getBoundingClientRect(), i);
  return c != null && Le(c, o) != null
    ? c
    : (Ie(Array.from(t.getClientRects()), i) ??
        Le(o, i) ??
        Ie(Array.from(n.getClientRects()), i) ??
        Le(n.getBoundingClientRect(), i));
}
function Fe(e, t) {
  let n = {
  ...
  for (; r != null && r !== document.body && r !== document.documentElement; ) {
    let e = window.getComputedStyle(r),
      t = (e.overflowX || e.overflow).split(/\s+/).some((e) => Ee.has(e)),
      i = (e.overflowY || e.overflow).split(/\s+/).some((e) => Ee.has(e));
    if (t || i) {
...
function Be(e) {
      ...
      ? ((g = () => {
          let e = a == null ? void 0 : (o?.querySelector(a) ?? void 0),
            ...
            i = () => {
              ...
              ke(p.current, t) || ((p.current = t), h(t));
            },
            s = () => {
              (r(),
  ...
  return (
    t[20] !== w || t[21] !== T
      ? ((E = (0, Re.createPortal)(w, T)), (t[20] = w), (t[21] = T), (t[22] = E))
      : (E = t[22]),
    E
  );
}
var Ve = /&(#(?:\d+|x[\da-fA-F]+)|[a-zA-Z][a-zA-Z0-9]+);/g,
  He = { amp: `&`, apos: `'`, gt: `>`, lt: `<`, nbsp: `\xA0`, quot: `"` };
function Ue(e) {
  return e.includes(`&`) ? e.replace(Ve, (e, t) => We(e, t)) : e;
}
function We(e, t) {
  return t.startsWith(`#`) ? Ge(e, t) : (He[t] ?? He[t.toLowerCase()] ?? e);
}
function Ge(e, t) {
...
var Ke = /^(https?|ircs?|mailto|xmpp|codex)$/i,
  qe = /^data:(?:image|video)\//i;
function Je(e) {
  let t = g(e),
    n = _(h(e));
  return n || t != null || se(e) || oe(e) || H(e) || U(e) || W(e) != null
    ? n
      ? e
      : (t ?? e)
    : Xe(e);
...
function Ye(e) {
  let t = g(e);
  return qe.test(e) || t != null ? (t ?? e) : Xe(e);
}
function Xe(e) {
  let t = e.indexOf(`:`),
    n = e.indexOf(`?`),
...
var Ze = `data-markdown-raw-link-label`;
function Qe(e, t) {
...
function at(e, t, n) {
  let r = n.components?.a ?? `a`,
    i = Ue(e.text),
    a = e.title == null ? void 0 : Ue(e.title);
  return (0, Q.jsx)(
    r,
    { [Ze]: i, href: Je(Ue(e.href)), title: a, children: n.renderInlineTokens(e.tokens, t, !1) },
    t,
  );
}
function ot(e, t, n) {
  let r = n.components?.img ?? `img`,
    i = e.title == null ? void 0 : Ue(e.title);
  return (0, Q.jsx)(r, { alt: Ue(e.text), src: Ye(Ue(e.href)), title: i }, t);
}
function st(e, t, n) {
  return (0, Q.jsx)(
  ...
  return (0, Q.jsx)(
    `span`,
    {
      dangerouslySetInnerHTML: {
        __html: ie.renderToString(e.text, {
...
var ut = N(`markdownCodeBlockWordWrap`, !1),
  dt = (0, Z.lazy)(async () => {
    let { MermaidDiagram: e } = await k(
      async () => {
...
function ft(e) {
  ...
  let i;
  t[3] !== n || t[4] !== r
    ? ((i = (0, Q.jsx)(dt, { fallback: n, ...r })), (t[3] = n), (t[4] = r), (t[5] = i))
    : (i = t[5]);
  let a;
  return (
    t[6] !== n || t[7] !== i
    ...
    ? ((f =
        i == null
          ...
          : (0, Q.jsxs)(F, {
              ...
              onClick: s,
              children: [
                (0, Q.jsx)(Se, { "aria-hidden": `true`, className: `icon-2xs` }),
                (0, Q.jsx)(M, {
...
function _t(e, t = ``) {
  ...
  for (let r of e.matchAll(ht)) {
    let i = r.index + r[1].length,
      a = `${t}${e.slice(0, i)}`;
    (a.length > 0 && !/\s$/.test(a)) || gt.test(a) || n.push({ content: r[2], index: i });
  }
  return n.length === 0 ? null : n;
}
function vt({ content: e, key: t }) {
  return (0, Q.jsxs)(Z.Fragment, { children: [e, yt({ content: e })] }, t);
}
function yt({ content: e, key: t }) {
  return (0, Q.jsx)(
    `span`,
    {
      "aria-hidden": !0,
...
var xt = [
    { getMatches: he, render: ({ content: e, key: t, renderInlineCode: n }) => n(e, t) },
    { getMatches: _t, render: vt },
  ],
  St = [{ matches: bt, render: yt }];
function Ct(e) {
  let t = xt.flatMap(
...
function wt({ content: e, inlineCode: t, precedingText: n }) {
  let r = St.filter(({ matches: t }) => t(e, n));
  return r.length === 0
    ? t
    : (0, Q.jsxs)(Q.Fragment, {
        children: [
...
function Et({
  ...
  let l = (0, Q.jsx)(
    `span`,
    {
      ...
      className: P(`inline-markdown`, J.inlineMarkdown, e),
      children: t,
    },
    a,
  );
  ...
  if (u != null && f(u))
    return (0, Q.jsx)(
      ue,
      { className: e, reference: h(u), cwd: n, hostId: i, onOpen: o, openInSidePanel: s },
      a,
    );
  let d = Ot(t);
  if (d != null) {
  ...
  return fe(t)
    ? (0, Q.jsx)(ge, { label: pe(t) }, a)
    : wt({ content: t, inlineCode: l, precedingText: c });
}
function Dt(e) {
...
function kt(e) {
  ...
  if (c && l) {
    ...
    t[0] !== r || t[1] !== o
      ? ((e = () =>
          (0, Q.jsx)(pt, { className: J.codeBlock, content: r, onAddSelectedTextToChat: o })),
        (t[0] = r),
        (t[1] = o),
        (t[2] = e))
      : (e = t[2]);
  ...
  if (a === `mermaid`) {
    let e = n && J.wideBlock,
      i;
    t[8] === e ? (i = t[9]) : ((i = P(J.codeBlock, e)), (t[8] = e), (t[9] = i));
    let o = n ? `mermaid` : void 0,
      c;
    t[10] !== n || t[11] !== r
      ? ((c = () =>
          (0, Q.jsx)(ft, {
            className: P(J.codeBlock, n && J.wideBlock),
            code: r,
            fallback: (0, Q.jsx)(Ce, {
              wrapperClassName: J.codeBlock,
              content: r,
              language: `plaintext`,
            }),
  ...
  return (
    t[24] !== r || t[25] !== a || t[26] !== s || t[27] !== d
      ? ((f = (0, Q.jsx)(jt, { content: r, language: a, renderImmediately: s, renderVisible: d })),
        (t[24] = r),
        (t[25] = a),
        (t[26] = s),
        (t[27] = d),
...
function At(e) {
  ...
  return (
    t[7] !== r || t[8] !== l || t[9] !== u
      ? ((d = (0, Q.jsx)(Ce, { ...r, shouldWrapCode: l, onToggleWrapCode: u })),
        (t[7] = r),
        (t[8] = l),
        (t[9] = u),
        (t[10] = d))
...
function jt(e) {
  ...
  if (t[0] !== e) {
    ...
    ((n = r ? i.renderVisible() : (0, Q.jsx)(Mt, { ...i })), (t[0] = e), (t[1] = n));
  } else n = t[1];
  return n;
}
function Mt(e) {
  ...
  let d;
  t[5] === n ? (d = t[6]) : ((d = P(J.codeBlock, n)), (t[5] = n), (t[6] = d));
  let f = a == null ? void 0 : `true`,
    p;
  t[7] === r
    ? (p = t[8])
    : ((p = (0, Q.jsx)(`pre`, {
        className: J.codeBlockPlaceholder,
...
var Pt = e(re(), 1),
  Ft = /^data:(?:image|video)\//i,
  It = `img.shields.io`,
  Lt = `/badge/`;
function Rt(e) {
  return !Ft.test(e) && !O(e) ? `image` : (zt(e)?.startsWith(`video/`) ?? !1) ? `video` : `image`;
}
function zt(e) {
...
function Bt(e) {
  ...
  return t.protocol !== `https:` || t.hostname !== It || !t.pathname.startsWith(Lt)
    ? null
...
function Ht({ contentsBase64: e, mimeType: t, path: n }) {
  return `data:${t ?? zt(n) ?? `application/octet-stream`};base64,${e}`;
}
function Ut(e) {
  return e.startsWith(`//`) ? !0 : Wt(e);
}
function Wt(e) {
  let t;
  try {
...
var Gt = new Set([`openai.com`, `chatgpt.com`, `chat.com`]),
  Kt = 500;
function qt(e, t) {
  let n = (0, X.c)(3),
    r = Xt(e, Kt),
...
function Yt(e, t) {
  let n = (0, X.c)(15),
    r = e == null,
    i;
  n[0] !== r || n[1] !== e ? ((i = !r && Jt(e)), (n[0] = r), (n[1] = e), (n[2] = i)) : (i = n[2]);
  let a = i,
    o,
    s;
  n[3] === e
...
var Zt = `my-3 block h-auto rounded-md object-contain shadow-md`,
  Qt = P(Zt, `border border-token-border`),
  $t = `max-h-[12.5rem] max-w-[12.5rem]`,
  en = `max-h-[10rem] w-auto max-w-full`,
  tn = `data-markdown-image-preview-trigger`;
function nn(e) {
  let t = (0, X.c)(80),
    {
      allowWide: n,
    ...
    T = Bt(S),
    E;
  t[0] === S ? (E = t[1]) : ((E = Rt(S)), (t[0] = S), (t[1] = E));
  let D = E,
    O = D === `video`,
    k;
  t[2] === S ? (k = t[3]) : ((k = S.startsWith(`//`)), (t[2] = S), (t[3] = k));
  let A = C != null && !k,
    M = qt(S, T == null && w && D === `image` && !A && Wt(S)),
    N = T == null && w && !A && Ut(S) && M.safeUrl == null && !M.isPending,
    F = A && O ? ce(C) : null,
    I = !O && A,
    { data: L, isLoading: te } = ee(`read-file-binary`, {
  ...
  let ne = L?.contentsBase64 ?? null,
    R =
      M.safeUrl ??
      F ??
      (I && ne != null
        ? Ht({ contentsBase64: ne, mimeType: L?.mimeType ?? null, path: C ?? S })
        : S),
    z = r ?? ``,
    B = A && !O,
    re = A && O && F == null,
    ie = N || (I && ne == null && !te) || b === R,
    ae = v?.items[v.index] ?? null,
    V = ae?.src ?? R,
    H = ae?.alt ?? z,
    oe = v != null && v.index > 0 ? v.index - 1 : null,
    U = v != null && v.index + 1 < v.items.length ? v.index + 1 : null,
    W;
  ...
  t[17] !== m || t[18] !== z
    ...
    : (me = t[19]);
  let he = me;
  if ((I && te && ne == null) || M.isPending) {
    if (c !== `scrollable`) return null;
    let e = O ? K : he,
      n;
    return (
      t[20] !== f || t[21] !== c || t[22] !== B || t[23] !== e || t[24] !== d
        ? ((n = (0, Q.jsx)(rn, {
            allowWide: f,
            isLoading: !0,
            label: e,
  ...
  if (re || ie) {
    let e = O ? le : pe,
      n;
    return (
      t[26] !== f || t[27] !== c || t[28] !== B || t[29] !== e || t[30] !== d
        ? ((n = (0, Q.jsx)(rn, {
            allowWide: f,
            label: e,
            mediaPresentation: c,
  ...
  if (O) {
    let e = f
      ...
      n;
    t[32] !== a || t[33] !== e
      ? ((n = P(Zt, e, a)), (t[32] = a), (t[33] = e), (t[34] = n))
      : (n = t[34]);
    let r;
    t[35] === R
      ? (r = t[36])
    ...
    let i;
    return (
      t[37] !== R || t[38] !== n || t[39] !== r || t[40] !== d || t[41] !== K
        ? ((i = (0, Q.jsx)(`video`, {
            className: n,
            src: R,
            title: d,
  ...
  t[47] === ve
    ? (ye = t[48])
    : ((ye = P(`cursor-zoom-in border-0 bg-transparent p-0 align-top`, ve)),
      (t[47] = ve),
      (t[48] = ye));
  let be;
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (be = t[49]);
  let Se;
  t[50] !== z || t[51] !== R || t[52] !== l
    ? ((Se = (e) => {
        y(an({ fallbackItem: { src: R, alt: z }, root: l.current, trigger: e.currentTarget }));
      }),
      (t[50] = z),
      (t[51] = R),
      (t[52] = l),
    ...
    : (Se = t[53]);
  let Ce;
  t[54] !== f || t[55] !== p || t[56] !== a || t[57] !== c || t[58] !== B
    ? ((Ce = P(
        Qt,
        c === `scrollable` ? `max-h-none !max-w-none w-auto` : f && B ? en : [$t, `h-auto w-auto`],
        p && J.imageEnter,
        a,
      )),
      (t[54] = f),
  ...
  t[60] === R
    ...
    : ((we = () => {
      ...
      (t[61] = we));
  let Ee;
  t[62] !== z || t[63] !== R || t[64] !== Ce || t[65] !== we || t[66] !== d
    ? ((Ee = (0, Q.jsx)(`img`, {
        className: Ce,
        src: R,
        alt: z,
    ...
    : (Ee = t[67]);
  let Y;
  t[68] !== de || t[69] !== ye || t[70] !== Se || t[71] !== Ee
    ? ((Y = (0, Q.jsx)(`button`, {
        type: `button`,
        className: ye,
        "aria-label": de,
  ...
  let De;
  return (
    t[73] !== h || t[74] !== H || t[75] !== V || t[76] !== ge || t[77] !== _e || t[78] !== Y
      ? ((De = (0, Q.jsx)(Te, {
          src: V,
          alt: H,
          open: h,
...
function rn(e) {
  ...
  t[2] === c
    ? (d = t[3])
    : ((d = c ? (0, Q.jsx)(I, { className: `icon-md` }) : (0, Q.jsx)(q, { className: `icon-lg` })),
      (t[2] = c),
      (t[3] = d));
  let f;
  return (
...
function an({ fallbackItem: e, root: t, trigger: n }) {
  let r = t == null ? [] : Array.from(t.querySelectorAll(`[${tn}="true"]`)),
    i = [],
    a = null;
  for (let e of r) {
...
function cn(e, t) {
  ...
  let n = Z.Children.toArray(e).filter(
    (e) => !((typeof e == `string` && on.test(e)) || ((0, Z.isValidElement)(e) && e.type === `br`)),
  );
...
function ln({
  ...
  let u = {
    ...
    p({ children: t }) {
      let n = e ? cn(t, u.img) : null;
      if (n != null && n.length > 1 && n.every((e) => Rt(e.props.src ?? ``) === `image`))
        return (0, Q.jsx)(`p`, {
          className: P(l, J.paragraph, J.mediaParagraph, J.mediaGridParagraph),
      ...
      if (n != null && n.length === 1) {
        let [e] = n,
          ...
          r = t === `image`;
        return (0, Q.jsx)(`p`, {
          className: P(l, J.paragraph, J.mediaParagraph, r && J.mediaWideBlock),
      ...
      return (0, Q.jsx)(`p`, { className: P(l, J.paragraph), children: t });
    },
    h1({ children: e }) {
      return (0, Q.jsx)(`h1`, { className: P(J.heading, J.heading1), children: e });
    },
    h2({ children: e }) {
      return (0, Q.jsx)(`h2`, { className: P(J.heading, J.heading2), children: e });
    },
    h3({ children: e }) {
      return (0, Q.jsx)(`h3`, { className: P(J.heading, J.heading3), children: e });
    },
    h4({ children: e }) {
      return (0, Q.jsx)(`h4`, { className: P(J.heading, J.heading4), children: e });
    },
    h5({ children: e }) {
      return (0, Q.jsx)(`h5`, { className: P(J.heading, J.heading5), children: e });
    },
    h6({ children: e }) {
      return (0, Q.jsx)(`h6`, { className: P(J.heading, J.heading6), children: e });
    },
    ul({ children: e, className: t }) {
      let n = t?.includes(`contains-task-list`) ?? !1;
      return (0, Q.jsx)(`ul`, {
        className: P(l, J.list, n ? J.taskList : J.unorderedList, t),
        children: e,
      });
    },
    ol({ children: e, className: t, start: n }) {
      return (t?.includes(`contains-task-list`) ?? !1) && fn(e)
        ? (0, Q.jsx)(`ol`, { className: P(l, J.list, J.taskList, t), children: e })
        : (0, Q.jsx)(`ol`, { className: P(l, J.list, J.orderedList, t), start: n, children: e });
    },
    li({ children: e, className: t }) {
      let n = t?.includes(`task-list-item`) ?? !1;
      return (0, Q.jsx)(`li`, { className: P(l, J.listItem, n && J.taskListItem, t), children: e });
    },
    a: dn({
      conversationId: null,
      cwd: n,
    ...
    blockquote({ children: e }) {
      return (0, Q.jsx)(`blockquote`, { className: P(l, J.blockquote), children: e });
    },
    hr() {
      return (0, Q.jsx)(`hr`, { className: J.horizontalRule });
    },
    table({ children: e }) {
      return (0, Q.jsx)(`div`, {
        ...
        children: (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(`table`, { className: P(l, J.table), children: e }),
        }),
      });
    },
    thead({ children: e }) {
      return (0, Q.jsx)(`thead`, { className: J.tableHead, children: e });
    },
    tbody({ children: e }) {
      return (0, Q.jsx)(`tbody`, { className: J.tableBody, children: e });
    },
    tr({ children: e }) {
      return (0, Q.jsx)(`tr`, { className: J.tableRow, children: e });
    },
    th({ children: e }) {
      return (0, Q.jsx)(`th`, { className: J.tableHeaderCell, children: e });
    },
    td({ children: e }) {
      return (0, Q.jsx)(`td`, { className: J.tableCell, children: e });
    },
  };
  return u;
}
...
function dn({
  ...
  return function ({ href: s, children: c, [Ze]: l }) {
    let u = typeof l == `string` ? l.trim() : sn(c).trim();
    if (s != null) {
      let e = de({
        cwd: t ?? null,
        hostId: n,
  ...
  return {
    ...
    renderInlineTokens(e, t, n = this.decorateText) {
      ...
      if (r.allowBasicHtml !== !0) {
        for (let [n, o] of e.entries()) i.push(...Un(wn(o, Tn(o, t, a), r, Hn(e, n))));
        return i;
      }
      return Sn(e, t, r);
    },
...
function Sn(e, t, n) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    let o = e[a],
      s = Tn(o, t, i),
      c = n.allowBasicHtml === !0 ? Nn(o) : null,
      l = c == null ? null : Pn(e, a + 1, c);
    if (c != null && l != null) {
      let t = e.slice(a + 1, l);
      (r.push(Mn(c, Sn(t, s, n), s, t)), (a = l));
      continue;
    }
    r.push(...Un(wn(o, s, n, Hn(e, a))));
  }
  return r;
}
function Cn(e, t) {
  let n = [],
    r = new Map();
  for (let i of e) n.push(...Un(wn(i, Tn(i, `root`, r), t)));
  return n;
}
function wn(e, t, n, r = ``) {
  if (Rn(e)) return pn(e, t, n);
  if (zn(e)) return lt(e, t);
  if (!Bn(e)) return `raw` in e && typeof e.raw == `string` ? e.raw : ``;
  switch (e.type) {
    case `space`:
      return null;
    case `hr`:
    ...
    case `table`:
      return vn(e, t, n);
    case `html`:
      return jn(e.raw, t, n.allowBasicHtml === !0);
    case `def`:
      return null;
  }
}
...
function En(e) {
  return Rn(e)
    ? `directive-${e.name}-${G(Dn(e))}`
    : zn(e)
      ? `math-${e.display ? `block` : `inline`}-${G(An(e.text))}`
      : Bn(e)
        ? `${e.type}-${G(On(e))}`
        : `token-${e.type}-${G(kn(e))}`;
}
...
function On(e) {
  switch (e.type) {
    case `code`:
      return `${e.lang ?? ``}:${An(e.text)}`;
    case `link`:
      return `${e.href}:${An(e.text)}`;
    case `image`:
      return `${e.href}:${An(e.text)}`;
    case `html`:
    case `space`:
...
`,
  ...
  return (n.match(/\S+/)?.[0] ?? n).slice(0, bn);
}
function jn(e, t, n) {
...
function Mn(e, t, n, r) {
  switch (e) {
    ...
    case `sub`:
      return In(r) ? (0, Q.jsx)(`span`, { children: t }, n) : (0, Q.jsx)(`sub`, { children: t }, n);
    case `sup`:
...
function Fn(e, t) {
  return Vn(e) && e.raw.trim().toLowerCase() === `</${t}>`;
}
function In(e) {
  return e.some((e) =>
    e.type === `image` && `href` in e && typeof e.href == `string` && Bt(e.href) != null
      ? !0
      : `tokens` in e && Array.isArray(e.tokens) && In(e.tokens),
  );
}
function Ln(e) {
  return (
...
function Gn({
  ...
  return (
    ...
    (0, Q.jsx)(`div`, {
      ref: g,
      [Y]: h,
      className: P(`[&>*:first-child]:mt-0`, J.markdownContent, n && J.markdownRoot, r),
      children: xn(m, {
        allowBasicHtml: e,
        components: { ...v, ...i },
        directives: o,
...
function Yn({
  ...
  (i.delayMsByKey.set(r, c),
    (i.nextSegmentStartAtMs =
      s + Zn({ fadeSegmentDelayMs: t, fadeSegmentMaxDelayMs: n, segmentDelayMs: c })),
    e.style.setProperty(`--fade-delay`, `${c}ms`));
}
function Xn({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentIndex: n }) {
  let r = n * e;
  return t == null || r <= t
    ? r
    : t +
        (n - Math.floor(t / e)) *
          Zn({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentDelayMs: t });
}
function Zn({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentDelayMs: n }) {
  return t == null || n < t ? e : Math.max(qn, e * Kn);
}
var Qn = /^\s*$/;
function $n({
  cwd: e,
  ...
  let h = Ue(m),
    g = s == null && t ? Ct(h) : null;
  if (!c && s == null && g == null) return h;
  let _ = s ?? tr({ decorations: g, segmentText: (e) => (c ? or(e, p) : [e]), text: h });
...
function er({ decorateText: e = !0, segmenter: t, text: n }) {
  let r = Ue(n);
  return tr({ decorations: e ? Ct(r) : null, segmentText: (e) => or(e, t), text: r });
}
    ...
    (f.push(
      (0, Q.jsx)(
        `span`,
        {
          ...
          className: J.fadeIn,
          style: ir({ fadeSegmentDelayMs: t, fadeSegmentMaxDelayMs: n, segmentIndex: m }),
          children: d,
        },
        r?.[p] ?? `fade-${m}`,
      ),
    ...
    ? o.map((n, o) => {
        ...
        return (0, Q.jsx)(
          `span`,
          {
            ...
            className: J.fadeIn,
            style: ir({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentIndex: s }),
            children: n,
          },
          a?.[o] ?? `fade-${s}`,
        );
...
function ir({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentIndex: n }) {
  if (!(e <= 0))
    return {
      "--fade-delay": `${Xn({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentIndex: n })}ms`,
    };
}
function ar({ fadeSegmentDelayMs: e, fadeSegmentMaxDelayMs: t, segmentKey: n, timeline: r }) {
  ...
  return (
    t[2] === n
      ...
      : ((a = (0, Q.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, Q.jsx)(F, { color: `secondary`, size: `default`, onClick: n, children: i }),
          ],
        })),
        (t[2] = n),
        (t[3] = a)),
...
function pr(e) {
  ...
  if (n != null) return n;
  let r = mr(t);
  return r.length === 0 ? `file` : (fr.get(r) ?? `file`);
}
function mr(e) {
  let t = e.lastIndexOf(`.`);
...
function hr(e) {
  ...
  if (t[0] !== l || t[1] !== o || t[2] !== a || t[3] !== i) {
    ((p = xr(a)), (d = xr(o)), (f = yr(i)));
    let e = br(f),
      n = pr(i),
      r = e.length === 0 ? gr(n, l) : null;
    m = _r(l, p, d, vr(n));
    let s =
      m == null
        ? null
...
function Cr({ cwd: e, hostId: t = w, openFileLinksInSidePanel: n = !1, shouldRenderPath: r }) {
  return {
    [p]({ attributes: i }) {
      let a = Sr(i, `path`);
      return a != null && r?.(a) === !1
        ...
        : (0, Q.jsx)(hr, {
            ...
            hostId: t,
            path: a,
            lineRangeStart: Sr(i, `lineRangeStart`) ?? Sr(i, `line_range_start`),
            lineRangeEnd: Sr(i, `lineRangeEnd`) ?? Sr(i, `line_range_end`),
            openInSidePanel: n,
          });
    },
  };
...
function Er(e) {
  ...
  t[8] === c
    ...
    : ((u = (0, Q.jsx)(`div`, {
        ...
        children: (0, Q.jsx)(F, { color: `outline`, onClick: c, children: l }),
      })),
      (t[8] = c),
      (t[9] = u));
  let d;
...
function Dr() {
  return {
    [S]({ attributes: e, rawText: t }) {
      return (0, Q.jsx)(Er, { title: Sr(e, `title`) ?? ``, prompt: t ?? `` });
    },
  };
}
function Or({
  ...
  return { ...Cr({ cwd: t, hostId: r, openFileLinksInSidePanel: a }), ...Dr(), ...wr(), ...Tr() };
}
function kr({
  allowWideBlocks: e,
  conversationId: t,
...
function jr(e) {
  switch (e?.kind ?? `chat`) {
    case `assistant-message`:
      return J.markdownText;
    case `chat`:
      return J.markdownText;
    case `small`:
      return J.markdownTextSmall;
  }
}
function Mr(e) {
  let t = (0, X.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Q.jsx)(Pr, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
    t[2] !== e.children || t[3] !== n
      ? ((r = (0, Q.jsx)(K, { name: `Markdown`, resetKey: e.children, fallback: Nr, children: n })),
        (t[2] = e.children),
        (t[3] = n),
        (t[4] = r))
      : (r = t[4]),
...
function Pr(e) {
  ...
  t[0] === e
    ...
    : (({
        ...
        openExternalLinksInThreadBrowserOnClick: f,
        onFileLinkOpen: d,
  ...
  let S = h === void 0 ? !1 : h,
    ...
    O = ne(`2957382457`),
    k;
  t[21] !== n || t[22] !== O || t[23] !== o
    ? ((k = C(Ar(n, O), o)), (t[21] = n), (t[22] = O), (t[23] = o), (t[24] = k))
    : (k = t[24]);
  let A = k,
    j;
  t[25] === x ? (j = t[26]) : ((j = jr(x)), (t[25] = x), (t[26] = j));
  let M = j,
    N;
  t[27] !== w || t[28] !== i || t[29] !== O || t[30] !== c || t[31] !== l || t[32] !== p
    ? ((N = Or({
        conversationId: w,
        cwd: i,
        enableInlineDil: O,
  ...
  t[49] !== D
    ? ((I = kr({
        ...
        conversationId: w,
        cwd: i,
        forceCodeBlockWordWrap: T,
        hideCodeBlocks: s,
        hostId: c,
        isBrowserSidebarEnabled: E,
        onAddSelectedTextToChat: u,
        onFileLinkOpen: d,
        openExternalLinksInThreadBrowserOnClick: f,
        openFileLinksInSidePanel: p,
  ...
  let L;
  t[51] !== r || t[52] !== I
    ? ((L = { ...I, ...r }), (t[51] = r), (t[52] = I), (t[53] = L))
    : (L = t[53]);
  let te = L,
    R;
  t[54] !== i || t[55] !== c || t[56] !== d || t[57] !== p
    ? ((R = (e, t, n, r) =>
        $n({
          cwd: i,
          decorateText: r,
...
function Rr(e, t) {
  ...
  return (zr(e, t, n), { textByToken: n.textByToken });
}
function zr(e, t, n, r = !0) {
  for (let i of e) Br(i, t, n, r);
}
function Br(e, t, n, r) {
  if (Gr(e)) {
    let i = Vr(e.text, t, r),
  ...
  if (e.type === `table`) {
    for (let i of e.header) zr(i.tokens, t, n, r);
    for (let i of e.rows) for (let e of i) zr(e.tokens, t, n, r);
  }
}
function Vr(e, t, n) {
  let r = Hr(t),
...
function Ur(e, t) {
  ...
  for (let r of e) {
    if (r.kind === `text`) {
      for (let e of r.segments) n.push(Wr(e, t));
      continue;
    }
    n.push(Wr(r.content, t));
  }
  return n;
}
function Wr(e, t) {
  let n = e.trim(),
    r = n.length === 0 ? `space:${t.segmentCount + 1}` : `text:${G(n)}`,
...
var Kr = /\[([^\]\n]+)\]\(([^)\n]+)$/,
  ...
  Jr = /^\s/;
function Yr(e) {
  if (e.length === 0 || (e.includes("`") && ai(e))) return e;
  if (e.includes("```") && ii(e)) return Xr(e);
  let t = e.includes(`![`) ? Zr(e) : e;
  return ((t = t.includes(`](`) ? Qr(t) : t), (t = $r(t, `**`)), (t = $r(t, `*`)), t);
}
function Xr(e) {
  return e.endsWith(`
`)
...
function Zr(e) {
  return e.replace(qr, (e, t) => t);
}
function Qr(e) {
  let t = e.match(Kr);
  return t ? (f(t[2]) || g(t[2]) != null ? e.replace(Kr, `$1`) : `${e})`) : e;
}
function $r(e, t) {
  if (!e.includes(t) || ei(e, t) % 2 == 0) return e;
  let n = ti(e, t);
  if (n < 0) return e;
...
function ei(e, t) {
  ...
  for (let r = 0; r <= e.length - t.length; ) {
    if (e.startsWith(t, r) && !ni(e, r) && !ri(e, r, t)) {
      ((n += 1), (r += t.length));
      continue;
    }
    r += 1;
...
function ti(e, t) {
  for (let n = e.length - t.length; n >= 0; --n)
    if (e.startsWith(t, n) && !ni(e, n) && !ri(e, n, t)) return n;
  return -1;
}
function ni(e, t) {
  let n = 0;
...
`,
    ...
    if (
      ...
      mi(u) ? (i = !i) : !i && hi(u) ? (r += 1) : !i && r > 0 && gi(u) && --r,
...
function _i(e) {
  let t = (0, X.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Q.jsx)(yi, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
    t[2] !== e.children || t[3] !== n
      ? ((r = (0, Q.jsx)(K, {
...
function yi(e) {
  ...
  t[0] === e
    ...
    : (({
        ...
        openExternalLinksInThreadBrowserOnClick: m,
        onFileLinkOpen: p,
  ...
  let E = _ === void 0 ? !1 : _,
    ...
    M = ne(`2957382457`),
    N;
  t[24] === Symbol.for(`react.memo_cache_sentinel`) ? ((N = ci()), (t[24] = N)) : (N = t[24]);
  let P = N,
    F;
  t[25] === Symbol.for(`react.memo_cache_sentinel`) ? ((F = Jn()), (t[25] = F)) : (F = t[25]);
  let I = F,
    L;
  try {
    let e;
    (t[26] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = new Intl.Segmenter(void 0, { granularity: `word` })), (t[26] = e))
      : (e = t[26]),
      (L = e));
  } catch {
    L = null;
  ...
  let te = L,
    R;
  if (t[27] !== n || t[28] !== M || t[29] !== o || t[30] !== u) {
    let e = Ar(n, M),
      r = u ? Yr(bi(e)) : e;
    ((R = u ? li(r, o, P) : C(r, o)),
      (t[27] = n),
  ...
  let z = R,
    B;
  t[32] === T ? (B = t[33]) : ((B = jr(T)), (t[32] = T), (t[33] = B));
  let re = B,
    ie;
  t[34] !== u || t[35] !== z
    ? ((ie = u ? Rr(z, te) : void 0), (t[34] = u), (t[35] = z), (t[36] = ie))
    : (ie = t[36]);
  let ae = ie,
    V;
  t[37] !== D || t[38] !== i || t[39] !== M || t[40] !== l || t[41] !== d || t[42] !== h
    ? ((V = Or({
        conversationId: D,
        cwd: i,
        enableInlineDil: M,
...
function xi(e) {
  ...
  let n = 2;
  for (; Si(t.charCodeAt(n)); ) n += 1;
  return n === 2 ? !1 : m.has(t.slice(2, n));
}
function Si(e) {
  return (
...
export { Be as i, Mr as n, Cr as r, _i as t };
//# sourceMappingURL=markdown-DuQ7-Xtp.js.map
