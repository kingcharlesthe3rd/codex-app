import { G as e, l as t, p as n, t as r } from "./app-scope-CWE-zIhQ.js";
import { i, n as a, r as o, u as s } from "./vscode-api.js";
import { _n as c } from "./src-1.js";
var l = i(r, `gh-cli-status`, (e) => ({
    gcTime: s.INFINITE,
    params: { hostId: e },
    staleTime: (e) =>
...
function d(e, t) {
  e.query.invalidate(l, t);
}
var f = n(r, (e, { get: t }) => ({
    enabled: e.cwd != null && e.headBranch.length > 0 && t(u, e.hostId) === `available`,
    queryFn: () =>
      a(`gh-pr-status`, {
        source: e.operationSource,
        params: { cwd: c(e.cwd ?? `/`), headBranch: e.headBranch, hostId: e.hostId },
      }),
...
function g(t, n) {
  return _(t) &&
    t.mergeBlocker === `conflicts` &&
    _(n) &&
    t.url != null &&
    t.url === n.url &&
    n.mergeBlocker === `unknown`
    ? e(t, { ...n, mergeBlocker: `conflicts` })
    : e(t, n);
}
function _(e) {
  return (
