...
import { a as p, o as m } from "./workbook-1.js";
import {
  $ as ee,
  A as te,
  C as h,
...
import { n as me, t as he } from "./PopcornPageNumberNavigation.js";
import {
  a as ge,
  f as _e,
  n as ve,
...
function G(e, t, n) {
  (W({ slide: e, left: 72, top: 48, width: 620, height: 50, text: t, fontSize: 30, bold: !0 }),
    W({
      slide: e,
      left: 72,
      top: 100,
...
function K(e, t, n, r, i, a) {
  (W({ slide: e, left: t, top: n, width: r, height: 24, text: i, fontSize: 14, bold: !0 }),
    W({
      slide: e,
      left: t,
      top: n + 22,
...
function xt(e, t) {
  ...
  let a = q({ slide: n, left: 72, top: 300, width: 346, height: 208, fill: Y.cloud });
  ((a.line.fill = Y.blue),
    (a.line.width = 1),
    K(
      n,
  ...
  let o = q({ slide: n, left: 444, top: 300, width: 346, height: 208, fill: Y.lavender });
  ...
  let s = q({ slide: n, left: 816, top: 300, width: 390, height: 208, fill: Y.mintTint });
  ((s.line.fill = Y.mint),
    K(
      n,
      842,
...
function J(e) {
  ...
  (G(
    ...
    [
      ...
      { label: `Dash-dot-dot 3px`, style: `dash-dot-dot`, color: Y.rose, width: 3 },
    ].forEach((e, n) => {
      let r = 84 + n * 228,
        i = t.shapes.add({
...
function St(e) {
  ...
  ((a.fill = { type: `solid`, color: `#F8FAFC`, pattern: { type: `lightGrid`, color: Y.indigo } }),
...
function Tt(e) {
  ...
  (t.shapes.add({
    ...
    K(t, 154, 378, 270, `Process shapes`, `Flowchart decision, rect, and terminator geometries.`),
    K(
      t,
      510,
      378,
    ...
    K(t, 900, 378, 230, `Transforms`, `Rotated and gradient-filled accent chevron.`));
}
function Et(e) {
  let t = U(e, `#FAFBFF`);
  G(
  ...
  let r = q({ slide: t, left: 474, top: 176, width: 326, height: 240, fill: `#FFFFFF` });
  ((r.text = [
...
`),
  ...
  let i = q({ slide: t, left: 840, top: 176, width: 354, height: 240, fill: `#F8FBFF` });
...
function Ot(e) {
  ...
  ((u.xValues = [1.5, 3.2, 6.8, 12.4, 24.9]),
    ...
    K(t, 846, 418, 356, `Scatter`, `XY data with connected markers and explicit axis titles.`));
}
function kt(e, t, n) {
  let r = U(e);
  G(
...
function At(e) {
  ...
  let n = q({ slide: t, left: 72, top: 154, width: 1136, height: 388, fill: `#FFFFFF` });
  n.line.fill = `#BFDBFE`;
  let r = t.images.add({
...
function Mt() {
  let e = p.create(),
    t = le(),
    n = O();
  return (xt(e, n), J(e), St(e), wt(e), Tt(e), Et(e), Dt(e), Ot(e), kt(e, t, n), At(e), jt(e), e);
}
var Nt,
  Pt,
  Y,
...
var qt,
  ...
  Yt = e(() => {
    (v(),
      ...
      (Jt = class {
        id = qt++;
        #e = se(`presentation-main-controller`);
        #t = Vt();
        #n = new Set();
        #r = new Set();
        #i = [];
        ...
        #v = !1;
        constructor(e = {}) {
          let t = e.presentationProto ?? e.presentation?.toProto() ?? Mt().toProto();
          ((this.#a = new A(
            (e.workerFactory ?? Lt)(),
            (e) => this.#C(e),
            (e) => {
        ...
        attachViewport(e) {
          ...
          ((this.#u ??= { ...o }),
            ...
            e.overlayCanvas && Wt(e.overlayCanvas, this.#u, { resizeIntrinsicBitmap: !0 }),
            this.#_.then(() => {
              if (this.#v) return;
              let n = t();
        ...
        setStageBackgroundColor(e) {
          ...
          t.length === 0 ||
            t === this.#g ||
            ((this.#g = t),
            this.#a.dispatch({ kind: `set-stage-background-color`, backgroundColor: t }));
        }
        setViewportInsets(e) {
        ...
        editThreadComment(e, t, n) {
          return (
            this.#a.dispatch({ kind: `edit-thread-comment`, threadId: e, commentId: t, body: n }),
            !0
          );
        }
        deleteThreadComment(e, t) {
          return (
            this.#a.dispatch({ kind: `delete-thread-comment`, threadId: e, commentId: t }), !0
          );
        }
        ...
        textPointerDown(e, t) {
          return (
            this.#a.dispatch({ kind: `text-pointer-down`, point: e, shiftKey: t?.shiftKey }), !0
          );
        }
        textPointerMove(e) {
...
function tn(e, t, n, r) {
  let i = $t(t, r),
    a = ut({ ...e, x: e.x - i.left, y: e.y - i.top }, { width: i.width, height: i.height }, n),
...
function an(e, t, n) {
  ...
  return Math.max(hn, Math.min(i / Math.max(t.width, 1), a / Math.max(t.height, 1)));
}
function on(e) {
  let t = en(e.viewport),
    n = { x: t.x, y: t.y },
    r = { width: e.frame.width + t.x * 2, height: e.frame.height + t.y * 2 },
    i = je(e.camera, n.x, n.y),
...
function un(e) {
  let t = { ...e.camera, k: rn(e.camera.k) },
    n = on({ viewport: e.viewport, frame: e.frame, camera: t, viewportInsets: e.viewportInsets });
...
function zn({ notesHeight: e, minHeight: t = 80, setNotesHeight: n }) {
  ...
  return (0, Vn.jsx)(`div`, {
    ...
    children: (0, Vn.jsx)(`div`, { className: `h-[3px] w-full rounded bg-gray-300` }),
  });
}
var Bn,
  Vn,
    ...
    (0, qn.jsx)(qn.Fragment, {
      children: (0, Kn.useMemo)(
        ...
        let m = u === e.threadId,
          ...
          te = e.target.kind === `slide` ? e.slideLabel : (e.target.elementName ?? e.slideLabel);
        return (0, qn.jsx)(
          We,
          {
            open: m,
            ...
            trigger: (0, qn.jsx)(`button`, {
              ...
              children: (0, qn.jsx)(pe, { className: `size-4` }),
            }),
            content: (0, qn.jsx)(ft, {
...
function yr({
  ...
  let re = jn(e),
    ...
    k = h && m?.drawing != null && m.drawing.enabled !== !1,
  ...
  let me = (0, X.useRef)(null),
    ...
    ve = (0, X.useRef)(null),
    [N, be] = (0, X.useState)(null),
    [Se, P] = (0, X.useState)(null),
    Ce = (0, X.useRef)(null);
  Ce.current = Se;
  let [we, Te] = (0, X.useState)([]),
    ke = (0, X.useRef)([]);
  ke.current = we;
  let je = (0, X.useRef)(null),
    Me = (0, X.useRef)(null),
    Fe = (0, X.useRef)(p),
    Ie = (0, X.useCallback)((e) => {
      (M((t) => (t === e ? null : t)),
    ...
    We = (0, X.useCallback)(
      (e) => {
        (Ie(e), m?.annotation?.onDismiss?.(e));
      },
      [Ie, m?.annotation],
    ),
    Ge = (0, X.useCallback)((e) => {
      P((t) => {
    ...
    Je = I.viewportInsets,
    Xe = Tr(I.width, I.height, F, _.selectedSlideFrame, Je) ?? _.slideRect,
    L = Xe === _.slideRect ? _ : { ..._, slideRect: Xe },
    ...
    Ze = (0, X.useMemo)(() => $n({ snapshot: _ }), [_]),
    Qe = (0, X.useMemo)(() => {
      let e = L.slideRect;
      return e ? { left: e.left, top: e.top, width: e.width, height: e.height } : null;
    }, [L.slideRect]),
    $e = (0, X.useMemo)(
      () => (A?.target ? ir(A.target, L.slideRect) : null),
      [A?.target, L.slideRect],
    ),
    et = (0, X.useMemo)(
      () => (A?.target ? ar(A.target, L.slideRect) : null),
      [A?.target, L.slideRect],
    ),
    tt = $e ?? et,
    V = (0, X.useMemo)(() => (!O || !N ? null : ur(N.start, N.current)), [O, N]),
    H = (0, X.useMemo)(() => {
      if (!V || !N) return null;
      let e = er({ snapshot: _, frame: V, anchorPoint: N.current });
      return e ? ir(e, L.slideRect) : null;
    }, [N, V, _, L.slideRect]),
    it = (0, X.useMemo)(
      () =>
        V
          ? dr(_.selectedSlideElementTargets, V).flatMap((e) => {
          ...
          : [],
      [V, _.selectedSlideElementTargets],
    ),
    ot = (0, X.useMemo)(
      () => (A?.target.type === `presentation-region` ? A.target.containedElements : []),
      [A],
    ),
    st = (0, X.useMemo)(
      () =>
        ge && _.hoveredElementId
          ? (_.selectedSlideElementTargets.find((e) => e.id === _.hoveredElementId) ?? null)
          : null,
      [ge, _.hoveredElementId, _.selectedSlideElementTargets],
    ),
    lt = (0, X.useMemo)(
      () =>
        H ||
        ...
        (!O || !c
          ...
          : st
            ...
            : null),
      [$e, O, st, c, H, R, z, _.selectedSlideIdx, L.slideRect],
    ),
    {
      annotations: ut,
    ...
    } = Pe(m?.annotation?.handleRef, { onDismissAnnotation: We, onDismissAllAnnotations: Ue }),
    ht = (0, X.useMemo)(() => ut.filter((e) => e.target.slideId === R), [R, ut]),
    gt = (0, X.useMemo)(
    ...
    _t = (0, X.useMemo)(
      () =>
        fe == null || A?.mode === `edit`
          ? null
          : (gt.find(({ annotation: e }) => e.annotationId === fe) ?? null),
      [A?.mode, fe, gt],
    ),
    vt = (0, X.useMemo)(() => (H ? it : ot), [ot, it, H]),
    { drawings: yt, addPendingDrawing: U } = Oe(m?.drawing?.handleRef),
    bt = (0, X.useMemo)(() => yt.filter((e) => e.target.slideId === R), [R, yt]),
    W = (0, X.useMemo)(
      () =>
        new de(
          {
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      ...
      let n =
        y.current && ie.current
          ? e.attachViewport({ host: y.current, canvas: ie.current, overlayCanvas: ae.current })
          : void 0;
      return (
        W?.attachContainer(y.current),
        t.start(),
        () => {
    ...
    (0, X.useEffect)(() => {
      (t.setViewportInsets(s), typeof e.setViewportInsets == `function` && e.setViewportInsets(s));
    }, [e, t, s]),
    (0, X.useEffect)(() => {
      B || D(!1);
    }, [B]),
    ...
    (0, X.useEffect)(() => {
      _.selectedSlideFrame && t.hasInitializedCamera() && e.setViewportCamera(F);
    }, [F, e, t, _.selectedSlideFrame]),
    (0, X.useEffect)(() => {
      let e = y.current;
      !_.selectedSlideFrame ||
        !e ||
        W.updateState({ state: a ? _.textEditState : null, blocks: _.textLayoutBlocks });
    }, [a, F, _.selectedSlideFrame, _.textEditState, _.textLayoutBlocks, W]),
    (0, X.useEffect)(() => {
  ...
  let G = (0, X.useCallback)(() => {
    ...
    K = (0, X.useCallback)(() => {
      (Me.current?.(), (Me.current = null), Ge(null));
    }, [Ge]),
    q = (0, X.useCallback)(() => {
      ((je.current = null), (ke.current = []), Te([]));
    }, []),
    xt = (0, X.useCallback)(() => {
      ((he.current = !1), j(null), be(null), G());
    }, [G]),
    J = (0, X.useCallback)(() => {
      let e = pe.current;
    ...
    Ct = (0, X.useCallback)(
      (e) => {
        e == null ||
          ...
          !k ||
          !u ||
          ((je.current = R), (ke.current = [...ke.current, e]), Te(ke.current));
      },
      [R, k, u],
    ),
    wt = (0, X.useCallback)(
      (e) => {
        ...
        let t = Ve(e),
          n = Ve(e.map((e) => ({ ...e, points: e.points.map(St) }))),
          r = y.current,
          i = ie.current;
        ...
        let a = { width: r.clientWidth, height: r.clientHeight },
          ...
          l = tr({
            ...
            frame: c,
            viewportBounds: s,
            containedElements: dr(_.selectedSlideElementTargets, c).flatMap((e) => {
              let t = _.selectedSlideElementTargets.find((t) => t.id === e);
              return t
                ? [
                    {
        ...
        let u = Re(`drawing`),
          d = rr(l);
        U({ drawingId: u, artifactKind: `presentation`, label: d, target: l, strokes: e });
      ...
      [U, St, m?.drawing, _, L.slideRect],
    ),
    Tt = (e) => {
      ((he.current = !1),
        M(e.annotationId),
        j({ mode: `edit`, annotationId: e.annotationId, target: e.target, body: e.body }));
    },
    Et = (e = `saved`, t = `button`) => {
      if (!A?.target) return;
      let n = A.body.trim();
    ...
    Dt = () => {
      A?.mode === `edit` && (mt(A.annotationId), M((e) => (e === A.annotationId ? null : e)), xt());
    };
  ((0, X.useEffect)(() => {
    (O || (A?.mode !== `edit` && j(null)), (!O || !c) && (be(null), (ve.current = null)));
  }, [O, A?.mode, c]),
    (0, X.useEffect)(() => {
      if (k && u) {
        (j(null), be(null), (ve.current = null), _e(!1), e.setHoveredElementId(null));
        return;
      }
      let t = p !== Fe.current;
      (K(), ke.current.length > 0 && !t && q());
    }, [K, q, e, p, k, u]),
    (0, X.useEffect)(() => {
      if (p === Fe.current) return;
      Fe.current = p;
      let e = ke.current;
      if (e.length === 0) {
        q();
    ...
    (0, X.useEffect)(() => {
      A && A.target.slideId !== R && (M(null), be(null), (ve.current = null), j(null));
    }, [A, R]),
    (0, X.useEffect)(
      () => () => {
        K();
    ...
    (0, X.useEffect)(() => {
      je.current == null || je.current === R || q();
    }, [q, R]),
    (0, X.useEffect)(() => {
      let e = y.current,
        t = b.current,
        n = k && u ? `crosshair` : O && c && !A ? ye : ``;
      return (
        e && (e.style.cursor = n),
        t && (t.style.cursor = n),
        () => {
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      ...
      if ((Ot(n), k && u)) {
        ...
        (Dr(t, x),
          ...
          Ge({ color: rt, strokeWidth: 3, points: [n] }),
          t.preventDefault(),
          t.stopPropagation());
        return;
      }
      ...
      if (O && c) {
        ...
        if ((r != null && i === `replace` && j(null), !n)) {
          (r != null && i !== `replace` && J(), (ve.current = null), be(null));
          return;
        }
      ...
      let r = W.isActive(),
        i =
          ...
          C.current === _.primarySelectedElementId
            ? _.primarySelectedElementId
            : void 0;
      if ((r || i) && W.tryPointerDown(n, { shiftKey: t.shiftKey, restrictToBlockId: i })) {
        (t.preventDefault(),
          (S.current = `text`),
          (w.current = null),
          (T.current = null),
      ...
      r && (W.clear(), (C.current = null));
      let o = _.primarySelectedElementId
          ? _.selectedSlideElementTargets.find((e) => e.id === _.primarySelectedElementId)
          : null,
        s = _.selectedElementIds.length === 1 ? (o?.frame ?? null) : null,
        l = _.selectedElementIds.length === 1 && o ? lr([o], n, F.k) : null,
        d = l ? null : fr(s, n, F.k),
        f = !l && !d && !!o?.canRotate && pr(s, n, F.k),
        p = l
          ? l.endpoint === `from`
            ? `connector-from`
            : `connector-to`
        ...
        m =
          l?.elementId ??
          (p === `move` ? sr(_.selectedSlideElementTargets, n, F.k) : _.primarySelectedElementId);
      if (!m) {
        if (((w.current = null), (T.current = null), (E.current = !1), r)) return;
        (Dr(t, x),
          (S.current = `marquee`),
          (C.current = null),
    ...
    At = (t) => {
      ...
      if (O && c) {
        ...
        if (r != null && n) {
          ...
          (e && pe.current && ((he.current = !1), j(null)),
            be(e ? { start: r.start, current: n } : null),
            t.preventDefault(),
            t.stopPropagation());
        }
        if (!n) {
        ...
        _e(!0);
        let i = sr(_.selectedSlideElementTargets, n, F.k);
        (e.setHoveredElementId(i), (t.currentTarget.style.cursor = pe.current ? `` : ye));
        return;
      }
      if (S.current === `text`) {
        n && W.pointerMove(n);
      ...
      if (S.current === `element` && n) {
        (T.current && Math.hypot(n.x - T.current.x, n.y - T.current.y) > jr && (E.current = !0),
      ...
      let r = _.primarySelectedElementId
        ...
        o = _.selectedElementIds.length === 1 && r ? lr([r], n, F.k) : null;
      if (o) {
        (e.setHoveredElementId(o.elementId), (t.currentTarget.style.cursor = `crosshair`));
        return;
      }
      let s = fr(i, n, F.k);
      if (s) {
      ...
      if (i && r?.canRotate && pr(i, n, F.k)) {
        (e.setHoveredElementId(_.primarySelectedElementId), (t.currentTarget.style.cursor = He()));
        return;
      }
      ...
      let l = sr(_.selectedSlideElementTargets, n, F.k);
      (e.setHoveredElementId(l), (t.currentTarget.style.cursor = l ? `move` : ``));
    },
    jt = (t, n) => {
      if (k && u) {
        if (x.current != null && x.current !== t.pointerId) return;
        Ot(Cr(t, y.current, F, _, Je));
        let e = Ce.current;
        (Or(t, x), (Me.current = null), Ge(null), n && Ct(e));
        return;
      }
      if (O && c) {
        if (x.current != null && x.current !== t.pointerId) return;
        (Ot(Cr(t, y.current, F, _, Je)), Or(t, x));
        let r = ve.current;
        if (((ve.current = null), be(null), !n || !r)) return;
        let i = Cr(t, y.current, F, _, Je);
        if (!i) return;
        let a = ur(r.start, i),
        ...
        if (o) {
          if (r.clickedElementTarget) {
            ...
            (e.setHoveredElementId(null),
              _e(!1),
              m?.annotation?.onStart?.(`annotation_mode_pointer`, { annotationMode: c }),
              (he.current = !1),
      ...
      let r = S.current;
      if (!r) return;
      if ((Ot(Cr(t, y.current, F, _, Je)), Or(t, x), r === `text`)) {
        ((S.current = null), W.pointerUp());
        return;
      }
      if (r === `marquee`) {
        ((S.current = null),
      ...
      S.current = null;
      let i = w.current,
        a = !!n && !E.current && !!i && _.textLayoutBlocks.some((e) => e.id === i);
      ((w.current = null),
        (T.current = null),
        (E.current = !1),
    ...
    Mt = (t) => {
      ...
      if (!a) return;
      let n = wr(t.clientX, t.clientY, y.current, F, _, Je);
      n &&
    ...
    Nt = (e) =>
      !e.metaKey && !e.ctrlKey
        ...
        : e.key === `0`
          ...
          : e.key === `=` || e.key === `+`
            ? (t.zoomTo(nn(_.zoom + 0.1, _.fitScale ?? 1), { settled: !0 }), e.preventDefault(), !0)
            : e.key === `-`
    ...
    Pt = (t) => {
      if (
        ...
        if (t.key === `Enter` && _.selectedElementIds.length === 1 && _.primarySelectedElementId) {
          W.activateBlockEnd(_.primarySelectedElementId) && t.preventDefault();
          return;
        }
    ...
    children: (0, Z.jsxs)(`div`, {
      ...
      children: [
        (0, Z.jsx)(`canvas`, {
          ...
          className: f(`absolute inset-0 h-full w-full select-none`),
        }),
        (0, Z.jsx)(`canvas`, {
          ref: ae,
        ...
        (0, Z.jsx)(`canvas`, {
          ...
          onPointerLeave: (t) => {
            x.current ??
              (Ot(null),
              e.setHoveredElementId(null),
              (t.currentTarget.style.cursor = k && u ? `crosshair` : ``));
          },
            ...
            `div`,
            {
              children: [
                ...
                (0, Z.jsx)(nt, {
                  ...
                  position: n,
                  selected: A?.mode === `edit` && A.annotationId === e.annotationId,
                  title: e.label,
                  onMouseEnter: () => {
                    M(e.annotationId);
                  },
...
function br(e, t) {
  let n = window.getComputedStyle(e),
    r = t === `codex` ? xr(n.getPropertyValue(`--color-background-surface`)) : null;
  if (r) return r;
  let i = n.backgroundColor.trim();
  return i.length > 0 && i !== `transparent` && i !== `rgba(0, 0, 0, 0)` ? i : Me(t);
}
function xr(e) {
  let t = e.trim();
...
function Tr(e, t, n, r, i) {
  return !r || e <= 0 || t <= 0
    ? null
    : on({ viewport: { width: e, height: t }, frame: r, camera: n, viewportInsets: i }).slideRect;
}
function Er(e) {
    ...
    (Ge(),
      ...
      (Ir = class {
        ...
        #y(e, t, n) {
          ...
          if (i && this.#s) {
            this.#e.setCamera(
              Math.abs(t.zoom - 1) < Fr
                ? sn({ viewport: a, frame: r, zoomFactor: t.zoom, viewportInsets: this.#l })
                : cn({
          ...
          if (t.camera) {
            let n = sn({ viewport: a, frame: r, zoomFactor: t.zoom, viewportInsets: this.#l }).k,
              i = dn({ camera: t.camera, viewport: a, frame: r, viewportInsets: this.#l });
...
function Kr({
  ...
  fileMenuContent: c,
  headerRightContent: d,
  headerTitleContent: p,
  zoomToFitLabel: m,
  renderHeaderZoomControl: ee,
  onClose: te,
  renderSlideThumbnailOverlay: h,
  className: ne,
  enablePageNavigation: re,
  theme: _ = `web`,
  isEditing: v = !0,
  hideSpeakerNotes: ae = !1,
  reviewTools: b,
  onHyperlinkClick: x,
  annotationsEnabled: S = !0,
  drawingAnnotationsEnabled: C = !0,
  ...
  if (!T) return null;
  let E = An(T),
    { panels: se, stageOverlays: ce } = (0, Q.useMemo)(() => Zt(t), [t]),
    le = S && b?.annotation?.enabled !== !1,
    [ue, D] = (0, Q.useState)(!1),
    O = C && b?.drawing?.enabled !== !1,
    [de, k] = (0, Q.useState)(!1),
    [A, fe] = (0, Q.useState)(0),
    M = (0, Q.useMemo)(() => new Ir(), []);
  ((0, Q.useEffect)(() => {
    le || D(!1);
  }, [le]),
    (0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      !ue || !le || (T.clearElementSelection(), T.setHoveredElementId(null));
    }, [le, ue, T]),
    (0, Q.useEffect)(() => {
      !de || !O || (T.clearElementSelection(), T.setHoveredElementId(null));
    }, [T, O, de]),
    (0, Q.useEffect)(() => {
      if (!ue) return;
      let e = (e) => {
  ...
  let [pe, me] = (0, Q.useState)(() =>
      Object.fromEntries(se.map((e) => [e.id, e.defaultOpen ?? !1])),
    ),
    [ge, _e] = (0, Q.useState)(Zr),
    [N, ye] = (0, Q.useState)(() => Object.fromEntries(E.slideIds.map((e) => [e, null]))),
    [xe, Se] = (0, Q.useState)(() => Object.fromEntries(E.slideIds.map((e) => [e, null]))),
    [P, Ce] = (0, Q.useState)(() => E.slideIds),
    [Te, Ee] = (0, Q.useState)(null),
    [De, Oe] = (0, Q.useState)(!1),
    [ke, je] = (0, Q.useState)(!1),
    ...
    He = (0, Q.useRef)([]),
    Ue = (0, Q.useRef)(null),
    We = (0, Q.useRef)(new Set()),
    Ge = (0, Q.useRef)(N),
    F = (0, Q.useRef)(xe),
    Ke = (0, Q.useRef)(P),
    qe = a(u(i, { activationConstraint: { distance: 4 } })),
    I = (0, Q.useMemo)(() => [ve], []),
    Ye = n === `left`,
    Xe = n === `bottom`,
    L = _ === `codex`,
    ...
    $e = !ae && Le && ge > 0,
    et = (0, Q.useMemo)(
      () => ({ left: Qe ? Qr : 0, top: 0, right: 0, bottom: $e ? Wr(ge, _) : 0 }),
      [ge, $e, Qe, _],
    );
  ((0, Q.useEffect)(() => {
    ...
    be(() => {
      ...
      let t = null,
        n = (e) => {
          let t = e >= 749,
            n = z && e > 0 && e <= 688;
          (je((e) => (e === t ? e : t)), Ne((e) => e || !0), Fe((e) => (e === n ? e : n)));
        };
      if (
        (n(e.clientWidth),
        typeof window < `u` &&
  ...
  let nt = (0, Q.useMemo)(
    ...
    V = (0, Q.useMemo)(() => Object.fromEntries(E.slideIds.map((e, t) => [e, t])), [E.slideIds]),
    H = E.slideIds[E.selectedSlideIdx] ?? null,
    rt = E.fitScale ?? (E.slideRect && E.zoom > 0 ? E.slideRect.scale / E.zoom : null),
    it = rt ? rn(rt) : null,
    at = E.slideRect?.scale ?? rn(rt ? rt * E.zoom : E.zoom),
    ot = it != null && Math.abs(E.zoom - 1) < ti,
    st = z && (!Me || Pe),
    ct = !st,
    lt = Ze && !st,
    ut = (e) => {
    ...
    gt = (0, Q.useCallback)((e, t, n) => {
      ((Ve.current[e] = t), t && Ue.current && n && Ue.current.observe(t));
    }, []),
    _t = (0, Q.useCallback)(() => {}, []),
    vt = (0, Q.useCallback)(() => {
      T.addSlide();
    ...
    yt = (0, Q.useCallback)(
      async (e, t) => {
        ...
        if (
          ...
          try {
            await mt();
            let t = await T.requestSlideThumbnail(e, r ? { cssMaxPx: ri } : void 0);
            (r ? Se : ye)((e) => (e[n] === t ? e : { ...e, [n]: t }));
          } finally {
            We.current.delete(a);
          }
        }
  ...
  ((0, Q.useEffect)(() => {
    ...
    (e && (We.current.delete(`rail:${e}`), We.current.delete(`stacked-page:${e}`)),
      yt(E.selectedSlideIdx, { force: !0 }),
      e &&
        F.current[e] != null &&
        yt(E.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [yt, E.presentationVersion, E.selectedSlideIdx, E.slideIds]),
    (0, Q.useEffect)(() => {
      if (!(typeof IntersectionObserver > `u`)) {
        (Ue.current?.disconnect(),
          (Ue.current = new IntersectionObserver(
            (e) => {
              for (let t of e) {
                ...
                (yt(n, { cacheKind: r, force: i }),
                  ...
                  Ue.current?.unobserve(t.target));
              }
            },
            { root: ze.current, rootMargin: `200px`, threshold: 0.05 },
          )));
        for (let e of [...Ve.current, ...He.current]) e && Ue.current.observe(e);
        return () => {
          Ue.current?.disconnect();
        };
      }
    }, [yt, E.presentationVersion, E.slideCount]));
    ...
    G = (0, Q.useCallback)(
      (e) => {
        ...
        let r = Ke.current,
          i = r.indexOf(t),
          a = r.indexOf(n);
        i < 0 || a < 0 || i === a || (Ce((e) => Gr(e, i, a)), T.moveSlide(i, a));
      },
      [T],
    ),
    K = (0, Q.useCallback)((e) => {
      let t = e.relatedTarget;
      (t instanceof Node && e.currentTarget.contains(t)) || Oe(!1);
    }, []),
    q = (0, Q.useCallback)((e) => {
      let t = e.relatedTarget;
      (t instanceof Node && e.currentTarget.parentElement?.contains(t)) || Oe(!1);
    }, []),
    xt = (0, Q.useCallback)((e, t, n) => {
      ((He.current[e] = n), n && Ue.current && F.current[t] == null && Ue.current.observe(n));
    }, []),
    J = (0, Q.useCallback)(
      (e, t = `default`, n) => {
        let r = Vr(e, t);
          ...
          ? (0, $.jsxs)(o, {
              ...
              children: [
                (0, $.jsx)(Je, {
                  ...
                  strategy: R,
                  children: (0, $.jsxs)(`div`, {
                    className: f(`flex min-w-full justify-[safe_center]`, r),
                    children: [
                      P.map((r, i) => {
                        let a = N[r] ?? null;
                        return (0, $.jsx)(
      ...
      [Te, vt, ht, P, I, W, G, bt, _t, v, gt, h, H, pt, qe, V, nt, N],
    );
  return (0, $.jsx)(`div`, {
    className: f(
      ...
      children: [
        (0, $.jsx)(g, {
          ...
          centeredContent: lt
            ...
            : null,
          actions: (0, $.jsxs)(`div`, {
            className: f(`flex items-center`, L ? `gap-1` : `gap-2`),
            children: [
              b?.annotation && le
                ? (0, $.jsx)(we, {
                    active: ue,
                    onClick: () => {
                      let e = !ue;
                      (e && (b?.annotation?.onModeEnabled?.(), k(!1)), D(e));
                    },
          ...
          icon: (0, $.jsx)(oe, {
            kind: `presentation`,
            children: (0, $.jsx)(ie, { className: `size-4` }),
          }),
        }),
        (0, $.jsx)(`div`, {
                    ...
                    children: [
                      (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(yr, {
                          ...
                          drawingCommitToken: A,
                          reviewTools: b,
                          onHyperlinkClick: x,
                          annotationsEnabled: S,
                          drawingAnnotationsEnabled: C,
...
function qr({ index: e, label: t, thumbnail: n, isSelected: r, onSelect: i, buttonRef: a }) {
  return (0, $.jsx)(`button`, {
    ref: a,
    type: `button`,
    "data-index": e,
    ...
    children: n
      ...
      : (0, $.jsx)(`div`, { className: `popcorn-presentation-stacked-page-placeholder` }),
  });
}
function Jr({
  controller: e,
  ...
  return (0, $.jsxs)(`div`, {
    ...
    style: i === `codex` ? { ...Ae, left: `${a}px` } : { left: `${a}px` },
...
function Yr({ controller: e, panels: t, panelControls: n, panelOpenState: r, isEditing: i }) {
  return !i || t.length === 0
    ? null
    : (0, $.jsx)(`div`, {
...
var Q,
  ...
  gi = e(() => {
    (c(),
      ...
      (ri = 960),
      (ii = { width: `94px` }),
      (ai = { width: `18px`, minWidth: `18px`, fontSize: `11px`, lineHeight: `14px` }),
      (oi = { borderRadius: `8px`, boxShadow: `0px 4px 16px 0px rgba(0, 0, 0, 0.05)` }),
      ...
      (pi = (0, Q.memo)(function ({
        ...
        let ee = zr(s, c),
          ...
          h = Hr(c),
          g = Ur(c),
          ne = c === `floating` ? ii : void 0,
          re = { ...(c === `floating` ? ai : {}), ...(i ? { color: si } : {}) };
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            (0, $.jsx)(`div`, {
              className: f(`text-token-text-primary`, g, te),
              style: re,
              children: t + 1,
            }),
            (0, $.jsxs)(`div`, {
              "data-testid": `${l}-${t}-surface`,
              className: f(`relative overflow-hidden border bg-white`, h, m ? `shadow-lg` : null),
              style: {
                ...oi,
                ...ne,
                borderColor: i ? si : ui,
              ...
              children: [
                r
                  ...
                  : (0, $.jsx)(`div`, {
                      className: f(h, `animate-pulse bg-gray-200`),
      ...
      (mi = (0, Q.memo)(function ({
        ...
        return (0, $.jsx)(B, {
          ...
          trigger: (0, $.jsx)(`div`, {
            ref: h,
            style: {
              transform: ge.Translate.toString(g),
              transition: _ ? void 0 : ne,
              opacity: _ ? 0 : 1,
              position: `relative`,
              display: `inline-flex`,
            },
      ...
      (hi = (0, Q.memo)(function ({
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            (0, $.jsx)(`div`, {
              "aria-hidden": `true`,
              className: f(`text-token-text-primary invisible`, o, i),
              style: c,
              children: `00`,
            }),
            (0, $.jsx)(`div`, {
              ...
              children: (0, $.jsx)(`div`, {
                ...
                children: (0, $.jsx)(ae, { className: `size-4` }),
              }),
            }),
          ],
        });
...
function _i({
  ...
  enablePageNavigation: y,
  artifactSearchEnabled: ie = !1,
  commentThreadsEnabled: ae = !1,
  workerFactory: b,
}) {
  let x = Ue({ initialCrdtState: o, externalCrdtUpdates: t }),
    S = (0, Si.useRef)(s),
    C = (0, Si.useRef)(null),
    w = j(
      void 0,
    ...
    oe = (0, Si.useMemo)(() => bi(d), [d]),
    se = (0, Si.useMemo)(() => xi(oe), [oe]);
  return (
    (0, Si.useEffect)(() => {
      w && S.current !== s && ((S.current = s), w.replaceFromProto(s ?? vi().toProto()));
    }, [w, s]),
    (0, Si.useEffect)(() => {
      if (!w || g == null) return;
      let e = () => {
        if (g.requestId === C.current) return !0;
        let e = null;
        if (g.slideId != null) {
          let t = w.getSnapshot().slideIds.indexOf(g.slideId);
          t >= 0 && (e = t);
        }
        return (
          ...
          e == null
            ? g.slideId == null
            : ((C.current = g.requestId),
              w.setSelectedSlideIdx(e),
              w.setSelectedElementId(g.objectId ?? null),
              !0)
        );
      };
      if (e()) return;
    ...
    (0, Si.useEffect)(() => {
      if (w && p)
        return w.subscribeImageHydrationRequests((e) => {
          let t = T.current + 1;
          ((T.current = t),
            p(e)
              .then((e) => {
                if (!(T.current !== t || e.length === 0)) return w.hydrateImageAssets(e);
              })
              .catch(() => {}));
        });
    }, [w, p]),
    w
      ? (0, Ci.jsxs)(`section`, {
          className: f(`no-drag relative h-full min-h-0 bg-token-bg-primary`, e),
          style: st(ee),
          ...
          children: [
              ...
              headerRightContent:
                oe.length > 0
                  ? (0, Ci.jsxs)(Ci.Fragment, {
                      children: [(0, Ci.jsx)(yi, { count: oe.length }), r],
                    })
                  : r,
              renderHeaderZoomControl: a,
              zoomToFitLabel: i,
            ...
            (0, Ci.jsx)(it, { artifactLabel: `Presentation`, restoreState: E }),
          ],
        })
      : null
  );
