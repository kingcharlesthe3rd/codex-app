...
import { a as o, o as s } from "./workbook-1.js";
import {
  $ as c,
  A as l,
  C as u,
...
import { n as D, t as O } from "./PopcornPageNumberNavigation.js";
import {
  Bn as k,
  Mn as A,
  On as pe,
    ...
    (0, qn.jsx)(qn.Fragment, {
      children: (0, Kn.useMemo)(
        ...
        let m = d === e.threadId,
          ...
          ee = e.target.kind === `slide` ? e.slideLabel : (e.target.elementName ?? e.slideLabel);
        return (0, qn.jsx)(
          We,
          {
            open: m,
...
function yr({
  ...
  let je = (0, X.useRef)(null),
    ...
    tt = $e ?? et,
    rt = (0, X.useMemo)(() => (!D || !ye ? null : ur(ye.start, ye.current)), [D, ye]),
    V = (0, X.useMemo)(() => {
      if (!rt || !ye) return null;
      let e = er({ snapshot: _, frame: rt, anchorPoint: ye.current });
      return e ? ir(e, L.slideRect) : null;
    }, [ye, rt, _, L.slideRect]),
    at = (0, X.useMemo)(
      () =>
        rt
          ? dr(_.selectedSlideElementTargets, rt).flatMap((e) => {
          ...
          : [],
      [rt, _.selectedSlideElementTargets],
    ),
    st = (0, X.useMemo)(
    ...
    ct = (0, X.useMemo)(
      () =>
        _e && _.hoveredElementId
          ? (_.selectedSlideElementTargets.find((e) => e.id === _.hoveredElementId) ?? null)
          : null,
      [_e, _.hoveredElementId, _.selectedSlideElementTargets],
    ),
    ut = (0, X.useMemo)(
      () =>
        V ||
        ...
        (!D || !l
          ...
          : ct
            ...
            : null),
      [$e, D, ct, l, V, R, z, _.selectedSlideIdx, L.slideRect],
    ),
    {
      annotations: dt,
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      ...
      let n =
        v.current && ae.current
          ? e.attachViewport({ host: v.current, canvas: ae.current, overlayCanvas: y.current })
          : void 0;
      return (
    ...
    (0, X.useEffect)(() => {
      ...
      !_.selectedSlideFrame ||
        !e ||
        U.updateState({ state: o ? _.textEditState : null, blocks: _.textLayoutBlocks });
  ...
  ((0, X.useEffect)(() => {
    (D || (k?.mode !== `edit` && A(null)), (!D || !l) && (xe(null), (M.current = null)));
  }, [D, k?.mode, l]),
    (0, X.useEffect)(() => {
      if (O && d) {
        (A(null), xe(null), (M.current = null), ve(!1), e.setHoveredElementId(null));
        return;
      }
      let t = p !== Fe.current;
    ...
    (0, X.useEffect)(() => {
      k && k.target.slideId !== R && (j(null), xe(null), (M.current = null), A(null));
    }, [k, R]),
    (0, X.useEffect)(
      () => () => {
        G();
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      ...
      if (!m) {
        if (((C.current = null), (w.current = null), (T.current = !1), r)) return;
        (Dr(t, b),
          (x.current = `marquee`),
          (S.current = null),
    ...
    At = (t) => {
      ...
      if (D && l) {
        ...
        if (r != null && n) {
          ...
          (e && me.current && ((ge.current = !1), A(null)),
        ...
        ve(!0);
        let i = sr(_.selectedSlideElementTargets, n, F.k);
        (e.setHoveredElementId(i), (t.currentTarget.style.cursor = me.current ? `` : be));
        return;
      }
      if (x.current === `text`) {
        n && U.pointerMove(n);
      ...
      if (x.current === `element` && n) {
        (w.current && Math.hypot(n.x - w.current.x, n.y - w.current.y) > jr && (T.current = !0),
    ...
    jt = (t, n) => {
      if (O && d) {
        if (b.current != null && b.current !== t.pointerId) return;
        Ot(Cr(t, v.current, F, _, Je));
        let e = we.current;
        (Or(t, b), (Me.current = null), Ge(null), n && Ct(e));
        return;
      }
      if (D && l) {
        if (b.current != null && b.current !== t.pointerId) return;
        (Ot(Cr(t, v.current, F, _, Je)), Or(t, b));
        let r = M.current;
        if (((M.current = null), xe(null), !n || !r)) return;
        let i = Cr(t, v.current, F, _, Je);
        if (!i) return;
        let a = ur(r.start, i),
      ...
      let r = x.current;
      if (!r) return;
      if ((Ot(Cr(t, v.current, F, _, Je)), Or(t, b), r === `text`)) {
      ...
      x.current = null;
      let i = C.current,
        a = !!n && !T.current && !!i && _.textLayoutBlocks.some((e) => e.id === i);
      ((C.current = null),
        (w.current = null),
        (T.current = !1),
    ...
    Mt = (t) => {
      ...
      if (!o) return;
      let n = wr(t.clientX, t.clientY, v.current, F, _, Je);
      n &&
...
function Kr({
  ...
  let [D, k] = (0, Q.useState)(() => Object.fromEntries(x.map((e) => [e.id, e.defaultOpen ?? !1]))),
    [j, he] = (0, Q.useState)(Zr),
    [M, be] = (0, Q.useState)(() => Object.fromEntries(b.slideIds.map((e) => [e, null]))),
    [Se, Ce] = (0, Q.useState)(() => Object.fromEntries(b.slideIds.map((e) => [e, null]))),
    [N, we] = (0, Q.useState)(() => b.slideIds),
    ...
    F = (0, Q.useRef)(Se),
    Ke = (0, Q.useRef)(N),
    qe = ve(me(ge, { activationConstraint: { distance: 4 } })),
    I = (0, Q.useMemo)(() => [ye], []),
    Ye = n === `left`,
    Xe = n === `bottom`,
    L = h === `codex`,
    ...
    $e = !ne && Le && j > 0,
    et = (0, Q.useMemo)(
      () => ({ left: Qe ? Qr : 0, top: 0, right: 0, bottom: $e ? Wr(j, h) : 0 }),
      [j, $e, Qe, h],
    );
  ((0, Q.useEffect)(() => {
  ...
  let nt = (0, Q.useMemo)(
      () => Object.fromEntries(b.slideIds.map((e, t) => [e, b.slideLabels[t] ?? `Slide ${t + 1}`])),
      [b.slideIds, b.slideLabels],
    ),
    rt = (0, Q.useMemo)(() => Object.fromEntries(b.slideIds.map((e, t) => [e, t])), [b.slideIds]),
    V = b.slideIds[b.selectedSlideIdx] ?? null,
    it = b.fitScale ?? (b.slideRect && b.zoom > 0 ? b.slideRect.scale / b.zoom : null),
    at = it ? rn(it) : null,
    ot = b.slideRect?.scale ?? rn(it ? it * b.zoom : b.zoom),
    st = at != null && Math.abs(b.zoom - 1) < ti,
    ct = z && (!Me || Pe),
    lt = !ct,
    ut = Ze && !ct,
    dt = (e) => {
    ...
    bt = (0, Q.useCallback)(
      async (e, t) => {
        ...
        if (
          ...
          try {
            await ht();
            let t = await y.requestSlideThumbnail(e, r ? { cssMaxPx: ri } : void 0);
  ...
  ((0, Q.useEffect)(() => {
    ...
    (e && (We.current.delete(`rail:${e}`), We.current.delete(`stacked-page:${e}`)),
      bt(b.selectedSlideIdx, { force: !0 }),
      e &&
        F.current[e] != null &&
        bt(b.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [bt, b.presentationVersion, b.selectedSlideIdx, b.slideIds]),
    (0, Q.useEffect)(() => {
    ...
    }, [bt, b.presentationVersion, b.slideCount]));
  let H = (0, Q.useCallback)(
    ...
    W = (0, Q.useCallback)(
      (e) => {
        ...
        let r = Ke.current,
          i = r.indexOf(t),
          a = r.indexOf(n);
        i < 0 || a < 0 || i === a || (we((e) => Gr(e, i, a)), y.moveSlide(i, a));
      },
      [y],
    ),
    G = (0, Q.useCallback)((e) => {
    ...
    J = (0, Q.useCallback)(
      ...
      [P, yt, gt, N, I, U, W, xt, vt, g, _t, f, V, mt, qe, rt, nt, M],
    );
  return (0, $.jsx)(`div`, {
    className: i(
      ...
      children: [
        (0, $.jsx)(d, {
          ...
          centeredContent: ut
            ...
            : null,
          actions: (0, $.jsxs)(`div`, {
            className: i(`flex items-center`, L ? `gap-1` : `gap-2`),
            children: [
              re?.annotation && C
                ? (0, $.jsx)(Te, {
                    active: w,
    ...
    (j(),
      ...
      (pi = (0, Q.memo)(function ({
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            (0, $.jsx)(`div`, {
              className: i(`text-token-text-primary`, g, ee),
              style: re,
              children: t + 1,
            }),
            (0, $.jsxs)(`div`, {
              "data-testid": `${u}-${t}-surface`,
              className: i(`relative overflow-hidden border bg-white`, te, m ? `shadow-lg` : null),
              style: {
                ...oi,
                ...ne,
                borderColor: a ? si : ui,
              ...
              children: [
                r
                  ? (0, $.jsx)(`img`, {
                      src: r,
                      alt: ``,
                      className: i(`block`, te),
                      style: ne,
                      draggable: !1,
                    })
                  : (0, $.jsx)(`div`, {
                      className: i(te, `animate-pulse bg-gray-200`),
      ...
      (mi = (0, Q.memo)(function ({
        ...
        return (0, $.jsx)(B, {
          ...
          trigger: (0, $.jsx)(`div`, {
            ref: g,
            style: {
              transform: k.Translate.toString(ne),
...
function _i({
  ...
  let b = Ue({ initialCrdtState: s, externalCrdtUpdates: t }),
    x = (0, Si.useRef)(c),
    S = (0, Si.useRef)(null),
    C = le(
      void 0,
  ...
  return (
    (0, Si.useEffect)(() => {
      C && x.current !== c && ((x.current = c), C.replaceFromProto(c ?? vi().toProto()));
    }, [C, c]),
    (0, Si.useEffect)(() => {
      if (!C || g == null) return;
      let e = () => {
      ...
      if (C && p)
        return C.subscribeImageHydrationRequests((e) => {
          ...
          ((w.current = t),
            p(e)
              .then((e) => {
                if (!(w.current !== t || e.length === 0)) return C.hydrateImageAssets(e);
              })
              .catch(() => {}));
        });
    }, [C, p]),
    C
      ? (0, Ci.jsxs)(`section`, {
          ...
          children: [
              ...
              headerRightContent:
                se.length > 0
                  ? (0, Ci.jsxs)(Ci.Fragment, {
                      children: [(0, Ci.jsx)(yi, { count: se.length }), r],
                    })
                  : r,
              renderHeaderZoomControl: o,
              zoomToFitLabel: a,
            ...
            (0, Ci.jsx)(at, { artifactLabel: `Presentation`, restoreState: T }),
          ],
        })
      : null
  );
