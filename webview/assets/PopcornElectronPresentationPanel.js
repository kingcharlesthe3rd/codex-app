...
import { a as te, o as ne } from "./workbook-1.js";
import {
  $ as re,
  A as m,
  C as ie,
...
import { n as ve, t as ye } from "./PopcornPageNumberNavigation.js";
import {
  Cn as be,
  Sn as j,
...
var pn,
  ...
  vn,
  yn = e(() => {
    ((_n = t(a())), (vn = (0, _n.createContext)(null)));
  });
        ...
        return (0, qn.jsx)(
          Ue,
          {
            ...
            trigger: (0, qn.jsx)(`button`, {
              ...
              children: (0, qn.jsx)(A, { className: `size-4` }),
            }),
            content: (0, qn.jsx)(ft, {
...
function yr({
  ...
  let je = (0, X.useRef)(null),
    ...
    qe = L.viewportInsets,
    Ye = Tr(L.width, L.height, I, h.selectedSlideFrame, qe) ?? h.slideRect,
    R = Ye === h.slideRect ? h : { ...h, slideRect: Ye },
    z = h.slideIds[h.selectedSlideIdx] ?? `slide-${h.selectedSlideIdx}`,
    B = h.slideLabels[h.selectedSlideIdx] ?? `Slide ${h.selectedSlideIdx + 1}`,
    V = (0, X.useMemo)(() => Er(R), [R]),
    Xe = (0, X.useMemo)(() => $n({ snapshot: h }), [h]),
    Ze = (0, X.useMemo)(() => {
      let e = R.slideRect;
      return e ? { left: e.left, top: e.top, width: e.width, height: e.height } : null;
    }, [R.slideRect]),
    Qe = (0, X.useMemo)(
      () => (O?.target ? ir(O.target, R.slideRect) : null),
      [O?.target, R.slideRect],
    ),
    $e = (0, X.useMemo)(
      () => (O?.target ? ar(O.target, R.slideRect) : null),
      [O?.target, R.slideRect],
    ),
    et = Qe ?? $e,
    nt = (0, X.useMemo)(() => (!E || !j ? null : ur(j.start, j.current)), [E, j]),
    H = (0, X.useMemo)(() => {
      if (!nt || !j) return null;
      let e = er({ snapshot: h, frame: nt, anchorPoint: j.current });
      return e ? ir(e, R.slideRect) : null;
    }, [j, nt, h, R.slideRect]),
    it = (0, X.useMemo)(
      () =>
        nt
          ? dr(h.selectedSlideElementTargets, nt).flatMap((e) => {
          ...
          : [],
      [nt, h.selectedSlideElementTargets],
    ),
    ot = (0, X.useMemo)(
    ...
    st = (0, X.useMemo)(
      () =>
        ve && h.hoveredElementId
          ? (h.selectedSlideElementTargets.find((e) => e.id === h.hoveredElementId) ?? null)
          : null,
      [ve, h.hoveredElementId, h.selectedSlideElementTargets],
    ),
    lt = (0, X.useMemo)(
      () =>
        H ||
        ...
        (!E || !l
          ...
          : st
            ...
            : null),
      [Qe, E, st, l, H, z, B, h.selectedSlideIdx, R.slideRect],
    ),
    {
      annotations: ut,
    ...
    } = Pe(p?.annotation?.handleRef, { onDismissAnnotation: Ue, onDismissAllAnnotations: F }),
    ht = (0, X.useMemo)(() => ut.filter((e) => e.target.slideId === z), [z, ut]),
    gt = (0, X.useMemo)(
      () => ht.map((e) => ({ annotation: e, bounds: ir(e.target, R.slideRect) })),
      [ht, R.slideRect],
    ),
    _t = (0, X.useMemo)(
      () =>
    ...
    { drawings: yt, addPendingDrawing: U } = Oe(p?.drawing?.handleRef),
    bt = (0, X.useMemo)(() => yt.filter((e) => e.target.slideId === z), [z, yt]),
    W = (0, X.useMemo)(
      () =>
        new pe(
          {
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      ...
      let n =
        g.current && _.current
          ? e.attachViewport({ host: g.current, canvas: _.current, overlayCanvas: se.current })
          : void 0;
      return (
        W?.attachContainer(g.current),
        t.start(),
        () => {
    ...
    (0, X.useEffect)(() => {
      h.selectedSlideFrame && t.hasInitializedCamera() && e.setViewportCamera(I);
    }, [I, e, t, h.selectedSlideFrame]),
    (0, X.useEffect)(() => {
      let e = g.current;
      !h.selectedSlideFrame ||
        !e ||
        W.updateState({ state: o ? h.textEditState : null, blocks: h.textLayoutBlocks });
    }, [o, I, h.selectedSlideFrame, h.textEditState, h.textLayoutBlocks, W]),
    (0, X.useEffect)(() => {
  ...
  let G = (0, X.useCallback)(() => {
    ...
    K = (0, X.useCallback)(() => {
      (Me.current?.(), (Me.current = null), We(null));
    }, [We]),
    q = (0, X.useCallback)(() => {
      ((je.current = null), (ke.current = []), P([]));
    }, []),
    xt = (0, X.useCallback)(() => {
      ((A.current = !1), k(null), M(null), G());
    }, [G]),
    J = (0, X.useCallback)(() => {
      let e = ge.current;
    ...
    Ct = (0, X.useCallback)(
      (e) => {
        e == null ||
          ...
          !D ||
          !d ||
          ((je.current = z), (ke.current = [...ke.current, e]), P(ke.current));
      },
      [z, D, d],
    ),
    wt = (0, X.useCallback)(
    ...
    Dt = () => {
      O?.mode === `edit` &&
        (mt(O.annotationId), he((e) => (e === O.annotationId ? null : e)), xt());
    };
  ((0, X.useEffect)(() => {
    (E || (O?.mode !== `edit` && k(null)), (!E || !l) && (M(null), (be.current = null)));
  }, [E, O?.mode, l]),
    (0, X.useEffect)(() => {
      if (D && d) {
        (k(null), M(null), (be.current = null), ye(!1), e.setHoveredElementId(null));
        return;
      }
      let t = f !== Fe.current;
    ...
    (0, X.useEffect)(() => {
      O && O.target.slideId !== z && (he(null), M(null), (be.current = null), k(null));
    }, [O, z]),
    (0, X.useEffect)(
      () => () => {
        K();
    ...
    (0, X.useEffect)(() => {
      je.current == null || je.current === z || q();
    }, [q, z]),
    (0, X.useEffect)(() => {
      let e = g.current,
        t = ce.current,
        n = D && d ? `crosshair` : E && l && !O ? xe : ``;
      return (
        e && (e.style.cursor = n),
        t && (t.style.cursor = n),
        () => {
    ...
    (0, X.useEffect)(() => {
      ...
      c &&
        ...
        R.slideRect &&
          h.selectedSlideFrame &&
          (c.save(),
          c.translate(R.slideRect.left, R.slideRect.top),
          c.scale(R.slideRect.scale, R.slideRect.scale),
          W?.drawOverlay(c),
          c.restore()));
    }, [
      L.height,
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      ...
      if (E && l) {
        ...
        if ((r != null && i === `replace` && k(null), !n)) {
          (r != null && i !== `replace` && J(), (be.current = null), M(null));
          return;
        }
        let a = sr(h.selectedSlideElementTargets, n, I.k);
      ...
      if (!o) {
        ...
        let i = sr(h.selectedSlideElementTargets, n, I.k);
      ...
      let a = h.primarySelectedElementId
        ...
        c = h.selectedElementIds.length === 1 && a ? lr([a], n, I.k) : null,
        u = c ? null : fr(s, n, I.k),
        ee = !c && !u && !!a?.canRotate && pr(s, n, I.k),
        f = c
          ? c.endpoint === `from`
            ? `connector-from`
            : `connector-to`
        ...
        p =
          c?.elementId ??
          (f === `move` ? sr(h.selectedSlideElementTargets, n, I.k) : h.primarySelectedElementId);
      if (!p) {
    ...
    At = (t) => {
      ...
      if (E && l) {
        ...
        if (r != null && n) {
          ...
          (e && ge.current && ((A.current = !1), k(null)),
            M(e ? { start: r.start, current: n } : null),
            t.preventDefault(),
            t.stopPropagation());
        }
        if (!n) {
        ...
        ye(!0);
        let i = sr(h.selectedSlideElementTargets, n, I.k);
        (e.setHoveredElementId(i), (t.currentTarget.style.cursor = ge.current ? `` : xe));
        return;
      }
      if (y.current === `text`) {
        n && W.pointerMove(n);
      ...
      if (!o) {
        ...
        let r = n ? sr(h.selectedSlideElementTargets, n, I.k) : null;
      ...
      let r = h.primarySelectedElementId
        ...
        a = h.selectedElementIds.length === 1 && r ? lr([r], n, I.k) : null;
      if (a) {
      ...
      if (s) {
        (e.setHoveredElementId(h.primarySelectedElementId),
          (t.currentTarget.style.cursor = Je(s) ?? ``));
        return;
      }
      ...
      let c = sr(h.selectedSlideElementTargets, n, I.k);
      (e.setHoveredElementId(c), (t.currentTarget.style.cursor = c ? `move` : ``));
    },
    jt = (t, n) => {
      if (D && d) {
        if (v.current != null && v.current !== t.pointerId) return;
        Ot(Cr(t, g.current, I, h, qe));
        let e = we.current;
        (Or(t, v), (Me.current = null), We(null), n && Ct(e));
        return;
      }
      if (E && l) {
        if (v.current != null && v.current !== t.pointerId) return;
        (Ot(Cr(t, g.current, I, h, qe)), Or(t, v));
        let r = be.current;
        if (((be.current = null), M(null), !n || !r)) return;
        let i = Cr(t, g.current, I, h, qe);
        if (!i) return;
        let a = ur(r.start, i),
      ...
      let r = y.current;
      if (!r) return;
      if ((Ot(Cr(t, g.current, I, h, qe)), Or(t, v), r === `text`)) {
        ((y.current = null), W.pointerUp());
        return;
      }
      if (r === `marquee`) {
        ((y.current = null),
    ...
    Mt = (t) => {
      ...
      if (!o) return;
      let n = wr(t.clientX, t.clientY, g.current, I, h, qe);
      n &&
    ...
    Pt = (t) => {
      if (
        ...
        if (t.key === `Enter` && h.selectedElementIds.length === 1 && h.primarySelectedElementId) {
          W.activateBlockEnd(h.primarySelectedElementId) && t.preventDefault();
          return;
        }
...
function Kr({
  ...
  let [ge, _e] = (0, Q.useState)(() =>
      Object.fromEntries(w.map((e) => [e.id, e.defaultOpen ?? !1])),
    ),
    [A, ve] = (0, Q.useState)(Zr),
    [j, xe] = (0, Q.useState)(() => Object.fromEntries(C.slideIds.map((e) => [e, null]))),
    [Se, Ce] = (0, Q.useState)(() => Object.fromEntries(C.slideIds.map((e) => [e, null]))),
    ...
    I = (0, Q.useRef)(Se),
    Ge = (0, Q.useRef)(N),
    Ke = ee(p(s, { activationConstraint: { distance: 4 } })),
    L = (0, Q.useMemo)(() => [be], []),
    Je = n === `left`,
    Ye = n === `bottom`,
    R = h === `codex`,
    ...
    Qe = !g && Le && A > 0,
    $e = (0, Q.useMemo)(
      () => ({ left: Ze ? Qr : 0, top: 0, right: 0, bottom: Qe ? Wr(A, h) : 0 }),
      [A, Qe, Ze, h],
    );
  ((0, Q.useEffect)(() => {
  ...
  let tt = (0, Q.useMemo)(
      () => Object.fromEntries(C.slideIds.map((e, t) => [e, C.slideLabels[t] ?? `Slide ${t + 1}`])),
      [C.slideIds, C.slideLabels],
    ),
    nt = (0, Q.useMemo)(() => Object.fromEntries(C.slideIds.map((e, t) => [e, t])), [C.slideIds]),
    H = C.slideIds[C.selectedSlideIdx] ?? null,
    rt = C.fitScale ?? (C.slideRect && C.zoom > 0 ? C.slideRect.scale / C.zoom : null),
    it = rt ? rn(rt) : null,
    at = C.slideRect?.scale ?? rn(rt ? rt * C.zoom : C.zoom),
    ot = it != null && Math.abs(C.zoom - 1) < ti,
    st = B && (!Me || Pe),
    ct = !st,
    lt = Xe && !st,
    ut = (e) => {
    ...
    gt = (0, Q.useCallback)((e, t, n) => {
      ((Ve.current[e] = t), t && F.current && n && F.current.observe(t));
    }, []),
    _t = (0, Q.useCallback)(() => {}, []),
    vt = (0, Q.useCallback)(() => {
      S.addSlide();
    ...
    yt = (0, Q.useCallback)(
      async (e, t) => {
        ...
        if (
          ...
          try {
            await mt();
            let t = await S.requestSlideThumbnail(e, r ? { cssMaxPx: ri } : void 0);
            (r ? Ce : xe)((e) => (e[n] === t ? e : { ...e, [n]: t }));
          } finally {
            Ue.current.delete(a);
          }
        }
  ...
  ((0, Q.useEffect)(() => {
    ...
    (e && (Ue.current.delete(`rail:${e}`), Ue.current.delete(`stacked-page:${e}`)),
      yt(C.selectedSlideIdx, { force: !0 }),
      e &&
        I.current[e] != null &&
        yt(C.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [yt, C.presentationVersion, C.selectedSlideIdx, C.slideIds]),
    (0, Q.useEffect)(() => {
      if (!(typeof IntersectionObserver > `u`)) {
        ...
        for (let e of [...Ve.current, ...He.current]) e && F.current.observe(e);
        return () => {
          F.current?.disconnect();
        };
      }
    }, [yt, C.presentationVersion, C.slideCount]));
  let U = (0, Q.useCallback)(
    ...
    G = (0, Q.useCallback)(
      (e) => {
        ...
        let r = Ge.current,
          i = r.indexOf(t),
          a = r.indexOf(n);
        i < 0 || a < 0 || i === a || (we((e) => Gr(e, i, a)), S.moveSlide(i, a));
      },
      [S],
    ),
    K = (0, Q.useCallback)((e) => {
    ...
    xt = (0, Q.useCallback)((e, t, n) => {
      ((He.current[e] = n), n && F.current && I.current[t] == null && F.current.observe(n));
    }, []),
    J = (0, Q.useCallback)(
      (e, t = `default`, n) => {
        let r = Vr(e, t);
      ...
      [P, vt, ht, N, L, W, G, bt, _t, oe, gt, re, H, pt, Ke, nt, tt, j],
    );
  return (0, $.jsx)(`div`, {
    className: i(
      ...
      children: [
        (0, $.jsx)(ae, {
          ...
          centeredContent: lt
            ...
            : null,
          actions: (0, $.jsxs)(`div`, {
            className: i(`flex items-center`, R ? `gap-1` : `gap-2`),
            children: [
              _?.annotation && de
                ? (0, $.jsx)(Te, {
                    active: fe,
        ...
        (0, $.jsx)(`div`, {
          ...
          children: (0, $.jsxs)(`div`, {
            ...
            className: i(
              ...
              B && `popcorn-presentation-editor-shell--small-stacked`,
              Ye
                ? `flex-col`
                : Je || V
                  ? `flex-row`
              ...
              st
                ...
                : (0, $.jsxs)(`div`, {
                    className: i(
                      ...
                      V && `popcorn-presentation-main-panel--codex-responsive`,
                    ),
                    children: [
                      (0, $.jsx)(`div`, {
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            ...
            (0, $.jsxs)(`div`, {
              ...
              className: i(`relative overflow-hidden border bg-white`, re, p ? `shadow-lg` : null),
              style: {
                ...oi,
                ...ie,
                borderColor: a ? si : ui,
      ...
      (mi = (0, Q.memo)(function ({
        ...
        return (0, $.jsx)(V, {
          ...
          trigger: (0, $.jsx)(`div`, {
            ref: m,
            style: {
              transform: f.Translate.toString(ie),
...
function _i({
  ...
  let v = F({ initialCrdtState: s, externalCrdtUpdates: t }),
    y = (0, Si.useRef)(c),
    b = (0, Si.useRef)(null),
    x = he(
      void 0,
    ...
    x
      ? (0, Ci.jsxs)(`section`, {
          ...
          children: [
            ...
            (0, Ci.jsx)(it, { artifactLabel: `Presentation`, restoreState: C }),
          ],
        })
      : null
  );
...
var Si, Ci;
e(() => {
  (ne(), n(), (Si = t(a())), gi(), Yt(), ie(), B(), et(), (Ci = r()));
})();
