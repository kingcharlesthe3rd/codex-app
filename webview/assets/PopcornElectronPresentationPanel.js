...
import { i as r } from "./workbook-DBfv-lpS.js";
...
import { a as oe, d as se, f as y, i as b, n as x, p as S, t as ce } from "./core.esm.js";
...
function _n({
    ...
    St = (0, F.useCallback)(
      (e) => {
        ...
        ge({
          ...
          viewportSize: a,
          baseCanvas: i,
          overlayCanvases: [se.current, y.current],
          strokes: e,
          projectPoint: $,
        })
          .then((t) => {
  ...
  let Et = (t) => {
    ...
    Dt = (t) => {
      ...
      if (!m) {
        if (((ce.current = null), (C.current = null), (le.current = !1), r)) return;
        (Tn(t, b),
          (x.current = `marquee`),
          (S.current = null),
    ...
    kt = (t, n) => {
      if (O && d) {
        ...
        let e = He.current;
        (En(t, b), (Ke.current = null), Ye(null), n && xt(e));
        return;
      }
      if (D && l) {
        if (b.current != null && b.current !== t.pointerId) return;
        (Et(xn(t, v.current, V, _, U)), En(t, b));
        let r = N.current;
      ...
      let r = x.current;
      if (!r) return;
      if ((Et(xn(t, v.current, V, _, U)), En(t, b), r === `text`)) {
        ((x.current = null), Y.pointerUp());
        return;
      }
      if (r === `marquee`) {
        ((x.current = null),
...
function Qn({
  ...
  let [Ce, Te] = (0, F.useState)(() =>
    ...
    Ke = (0, F.useRef)(E),
    qe = (0, F.useRef)(O),
    z = y(se(b, { activationConstraint: { distance: 4 } })),
    Je = (0, F.useMemo)(() => [C], []),
    B = n === `left`,
    Ye = n === `bottom`,
    V = h === `codex`,
      ...
      children: [
        (0, L.jsx)(p, {
          ...
          actions: (0, L.jsxs)(`div`, {
            className: i(`flex items-center`, V ? `gap-1` : `gap-2`),
            children: [
              _?.annotation && pe
                ? (0, L.jsx)(je, {
                    active: me,
...
function nr({ controller: e, panel: t, panelControls: n, isPanelOpen: r }) {
  ...
  return (t.isVisible?.({ controller: e, snapshot: a }) ?? !0)
    ? (0, L.jsx)(`div`, {
        ...
        className: i(
          ...
          r ? `pointer-events-auto translate-x-0` : `pointer-events-none translate-x-full`,
        ),
    ...
    return (0, L.jsxs)(`button`, {
      ...
      children: [
        ...
        (0, L.jsxs)(`div`, {
          ...
          className: i(`relative overflow-hidden border bg-white`, h, m ? `shadow-lg` : null),
          style: {
            ...Un,
            ...ne,
            borderColor: a ? Wn : qn,
  ...
  ir = (0, F.memo)(function ({
    ...
    return (0, L.jsx)(T, {
      ...
      trigger: (0, L.jsx)(`div`, {
        ref: g,
        style: {
          transform: S.Translate.toString(ne),
...
function or({
  ...
  artifactSearchEnabled: ie = !1,
  commentThreadsEnabled: ae = !1,
  workerFactory: v,
}) {
  let oe = Pe({ initialCrdtState: o, externalCrdtUpdates: t }),
    se = (0, F.useRef)(s),
    y = ne(
      void 0,
      () =>
        new ft({
          initialCrdtState: oe.initialCrdtState,
          initialSelectedSlideIdx: c,
          initialZoom: l,
    ...
    x = Le({
      ...
      controller: y,
      externalCrdtUpdates: oe.externalCrdtUpdates,
      onCrdtUpdate: u,
    }),
    S = (0, F.useMemo)(() => lr(d), [d]),
    ce = (0, F.useMemo)(() => ur(S), [S]);
  return (
    (0, F.useEffect)(() => {
      y && se.current !== s && ((se.current = s), y.replaceFromProto(s ?? sr().toProto()));
    }, [y, s]),
    (0, F.useEffect)(() => {
      if (y && f)
