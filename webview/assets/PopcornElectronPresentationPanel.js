...
import { nx as p, rx as m } from "./app-initial~app-main~new-thread-panel-page.js";
import { or as ee, sr as te } from "./app-initial~app-main~automations-page.js";
import { a as ne, o as h } from "./workbook-1.js";
import {
  $ as re,
  A as ie,
  C as g,
...
import { n as N, t as ve } from "./PopcornPageNumberNavigation.js";
import {
  $ as ye,
  A as be,
  B as xe,
...
var qt,
  ...
  Yt = e(() => {
    (se(),
      ...
      (Jt = class {
        id = qt++;
        #e = E(`presentation-main-controller`);
        #t = Vt();
        #n = new Set();
        #r = new Set();
        #i = [];
        ...
        #C(e) {
          switch (e.kind) {
            ...
            case `inspector`:
              ...
              return;
            case `debug-log`:
              E(e.namespace).debug(e.message, e.details);
              return;
            default:
              return e;
          }
        ...
        return (0, qn.jsx)(
          We,
          {
            ...
            trigger: (0, qn.jsx)(`button`, {
              ...
              children: (0, qn.jsx)(_e, { className: `size-4` }),
            }),
            content: (0, qn.jsx)(pt, {
...
function yr({
  ...
  let je = (0, X.useRef)(null),
    ...
    Je = I.viewportInsets,
    Xe = Tr(I.width, I.height, F, g.selectedSlideFrame, Je) ?? g.slideRect,
    ...
    tt = $e ?? et,
    rt = (0, X.useMemo)(() => (!D || !ve ? null : ur(ve.start, ve.current)), [D, ve]),
    V = (0, X.useMemo)(() => {
      if (!rt || !ve) return null;
      let e = er({ snapshot: g, frame: rt, anchorPoint: ve.current });
      return e ? ir(e, L.slideRect) : null;
    }, [ve, rt, g, L.slideRect]),
    at = (0, X.useMemo)(
      () =>
        rt
          ? dr(g.selectedSlideElementTargets, rt).flatMap((e) => {
          ...
          : [],
      [rt, g.selectedSlideElementTargets],
    ),
    st = (0, X.useMemo)(
    ...
    ct = (0, X.useMemo)(
      () =>
        ge && g.hoveredElementId
          ? (g.selectedSlideElementTargets.find((e) => e.id === g.hoveredElementId) ?? null)
          : null,
      ...
      () =>
        ...
        (!D || !c
          ...
          : ct
            ...
            : null),
      [$e, D, ct, c, V, R, z, g.selectedSlideIdx, L.slideRect],
    ),
    {
      annotations: dt,
    ...
    { drawings: bt, addPendingDrawing: H } = Oe(m?.drawing?.handleRef),
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      ...
      let n =
        _.current && oe.current
          ? e.attachViewport({ host: _.current, canvas: oe.current, overlayCanvas: v.current })
          : void 0;
      return (
    ...
    (0, X.useEffect)(() => {
      ...
      (g.selectedElementIds.length !== 1 ||
        ...
        (x.current = null);
    }, [g.primarySelectedElementId, g.selectedElementIds, g.textEditState, g.textLayoutBlocks]),
    (0, X.useEffect)(() => {
      g.selectedSlideFrame && t.hasInitializedCamera() && e.setViewportCamera(F);
    }, [F, e, t, g.selectedSlideFrame]),
    (0, X.useEffect)(() => {
      let e = _.current;
      !g.selectedSlideFrame ||
        !e ||
        U.updateState({ state: a ? g.textEditState : null, blocks: g.textLayoutBlocks });
    }, [a, F, g.selectedSlideFrame, g.textEditState, g.textLayoutBlocks, U]),
    (0, X.useEffect)(() => {
  ...
  let W = (0, X.useCallback)(() => {
      ...
      (e) => {
        ...
        let a = { width: r.clientWidth, height: r.clientHeight },
          ...
          l = tr({
            ...
            frame: c,
            viewportBounds: s,
            containedElements: dr(g.selectedSlideElementTargets, c).flatMap((e) => {
              let t = g.selectedSlideElementTargets.find((t) => t.id === e);
              return t
                ? [
                    {
        ...
        Ee({
          ...
          viewportSize: a,
          baseCanvas: i,
          overlayCanvases: [v.current, se.current],
          strokes: e,
          projectPoint: St,
        })
          .then((t) => {
    ...
    Dt = () => {
      k?.mode === `edit` && (ht(k.annotationId), j((e) => (e === k.annotationId ? null : e)), q());
    };
  ((0, X.useEffect)(() => {
    (D || (k?.mode !== `edit` && A(null)), (!D || !c) && (be(null), (N.current = null)));
  }, [D, k?.mode, c]),
    (0, X.useEffect)(() => {
      if (O && u) {
        (A(null), be(null), (N.current = null), _e(!1), e.setHoveredElementId(null));
        return;
      }
      let t = f !== Fe.current;
    ...
    (0, X.useEffect)(() => {
      k && k.target.slideId !== R && (j(null), be(null), (N.current = null), A(null));
    }, [k, R]),
    (0, X.useEffect)(
      () => () => {
        G();
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      ...
      if (D && c) {
        ...
        if ((r != null && i === `replace` && A(null), !n)) {
          (r != null && i !== `replace` && J(), (N.current = null), be(null));
          return;
        }
        let a = sr(g.selectedSlideElementTargets, n, F.k);
        e.setHoveredElementId(a);
        let o = a == null ? null : (g.selectedSlideElementTargets.find((e) => e.id === a) ?? null);
        ((N.current = {
      ...
      if (!a) {
        ...
        let i = sr(g.selectedSlideElementTargets, n, F.k);
      ...
      let o = g.primarySelectedElementId
          ? g.selectedSlideElementTargets.find((e) => e.id === g.primarySelectedElementId)
          : null,
        s = g.selectedElementIds.length === 1 ? (o?.frame ?? null) : null,
        l = g.selectedElementIds.length === 1 && o ? lr([o], n, F.k) : null,
        d = l ? null : fr(s, n, F.k),
        ...
        m =
          l?.elementId ??
          (p === `move` ? sr(g.selectedSlideElementTargets, n, F.k) : g.primarySelectedElementId);
      if (!m) {
    ...
    At = (t) => {
      ...
      if (D && c) {
        ...
        _e(!0);
        let i = sr(g.selectedSlideElementTargets, n, F.k);
        (e.setHoveredElementId(i), (t.currentTarget.style.cursor = me.current ? `` : ye));
        return;
      }
      if (b.current === `text`) {
        n && U.pointerMove(n);
      ...
      if (b.current === `element` && n) {
        (C.current && Math.hypot(n.x - C.current.x, n.y - C.current.y) > jr && (w.current = !0),
      ...
      if (!a) {
        ...
        let r = n ? sr(g.selectedSlideElementTargets, n, F.k) : null;
      ...
      let r = g.primarySelectedElementId
        ...
        o = g.selectedElementIds.length === 1 && r ? lr([r], n, F.k) : null;
      if (o) {
      ...
      if (i && r?.canRotate && pr(i, n, F.k)) {
        (e.setHoveredElementId(g.primarySelectedElementId), (t.currentTarget.style.cursor = He()));
        return;
      }
      ...
      let l = sr(g.selectedSlideElementTargets, n, F.k);
      (e.setHoveredElementId(l), (t.currentTarget.style.cursor = l ? `move` : ``));
    },
    jt = (t, n) => {
      if (O && u) {
        if (y.current != null && y.current !== t.pointerId) return;
        Ot(Cr(t, _.current, F, g, Je));
        let e = Ce.current;
        (Or(t, y), (Me.current = null), Ge(null), n && Ct(e));
        return;
      }
      if (D && c) {
        if (y.current != null && y.current !== t.pointerId) return;
        (Ot(Cr(t, _.current, F, g, Je)), Or(t, y));
        let r = N.current;
        if (((N.current = null), be(null), !n || !r)) return;
        let i = Cr(t, _.current, F, g, Je);
        if (!i) return;
        let a = ur(r.start, i),
      ...
      let r = b.current;
      if (!r) return;
      if ((Ot(Cr(t, _.current, F, g, Je)), Or(t, y), r === `text`)) {
      ...
      b.current = null;
      let i = S.current,
        a = !!n && !w.current && !!i && g.textLayoutBlocks.some((e) => e.id === i);
      ((S.current = null),
        (C.current = null),
        (w.current = !1),
    ...
    Mt = (t) => {
      ...
      if (!a) return;
      let n = wr(t.clientX, t.clientY, _.current, F, g, Je);
      n &&
    ...
    Nt = (e) =>
      !e.metaKey && !e.ctrlKey
        ...
        : e.key === `0`
          ...
          : e.key === `=` || e.key === `+`
            ? (t.zoomTo(nn(g.zoom + 0.1, g.fitScale ?? 1), { settled: !0 }), e.preventDefault(), !0)
            : e.key === `-`
    ...
    Pt = (t) => {
      if (
        ...
        if (
          ...
          r !== g.selectedSlideIdx && (e.setSelectedSlideIdx(r), t.preventDefault());
          return;
        }
        if (!a) {
          if (t.key === `Escape` && k) {
        ...
        if (t.key === `Enter` && g.selectedElementIds.length === 1 && g.primarySelectedElementId) {
...
function Kr({
  ...
  if (!w) return null;
  let T = An(w),
    { panels: ce, stageOverlays: le } = (0, Q.useMemo)(() => Zt(t), [t]),
    ue = x && v?.annotation?.enabled !== !1,
    [E, D] = (0, Q.useState)(!1),
    O = S && v?.drawing?.enabled !== !1,
    [k, A] = (0, Q.useState)(!1),
    [fe, pe] = (0, Q.useState)(0),
    j = (0, Q.useMemo)(() => new Ir(), []);
  ((0, Q.useEffect)(() => {
    ue || D(!1);
  }, [ue]),
    (0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      !E || !ue || (w.clearElementSelection(), w.setHoveredElementId(null));
    }, [ue, E, w]),
    (0, Q.useEffect)(() => {
  ...
  let [me, M] = (0, Q.useState)(() =>
      Object.fromEntries(ce.map((e) => [e.id, e.defaultOpen ?? !1])),
    ),
    [ge, _e] = (0, Q.useState)(Zr),
    [N, ye] = (0, Q.useState)(() => Object.fromEntries(T.slideIds.map((e) => [e, null]))),
    [xe, Se] = (0, Q.useState)(() => Object.fromEntries(T.slideIds.map((e) => [e, null]))),
    [P, Ce] = (0, Q.useState)(() => T.slideIds),
    ...
    F = (0, Q.useRef)(xe),
    Ke = (0, Q.useRef)(P),
    qe = f(d(i, { activationConstraint: { distance: 4 } })),
    I = (0, Q.useMemo)(() => [te], []),
    Ye = n === `left`,
    Xe = n === `bottom`,
    L = g === `codex`,
    ...
    $e = !oe && Le && ge > 0,
    et = (0, Q.useMemo)(
      () => ({ left: Qe ? Qr : 0, top: 0, right: 0, bottom: $e ? Wr(ge, g) : 0 }),
      [ge, $e, Qe, g],
    );
  ((0, Q.useEffect)(() => {
  ...
  let nt = (0, Q.useMemo)(
    ...
    rt = (0, Q.useMemo)(() => Object.fromEntries(T.slideIds.map((e, t) => [e, t])), [T.slideIds]),
    V = T.slideIds[T.selectedSlideIdx] ?? null,
    it = T.fitScale ?? (T.slideRect && T.zoom > 0 ? T.slideRect.scale / T.zoom : null),
    at = it ? rn(it) : null,
    ot = T.slideRect?.scale ?? rn(it ? it * T.zoom : T.zoom),
    st = at != null && Math.abs(T.zoom - 1) < ti,
    ct = z && (!Me || Pe),
    lt = !ct,
    ut = Ze && !ct,
    dt = (e) => {
    ...
    bt = (0, Q.useCallback)(
      async (e, t) => {
        ...
        if (
          ...
          try {
            await ht();
            let t = await w.requestSlideThumbnail(e, r ? { cssMaxPx: ri } : void 0);
  ...
  ((0, Q.useEffect)(() => {
    ...
    (e && (We.current.delete(`rail:${e}`), We.current.delete(`stacked-page:${e}`)),
      bt(T.selectedSlideIdx, { force: !0 }),
      e &&
        F.current[e] != null &&
        bt(T.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [bt, T.presentationVersion, T.selectedSlideIdx, T.slideIds]),
    (0, Q.useEffect)(() => {
    ...
    }, [bt, T.presentationVersion, T.slideCount]));
  let H = (0, Q.useCallback)(
    ...
    W = (0, Q.useCallback)(
      (e) => {
        ...
        let r = Ke.current,
          i = r.indexOf(t),
          a = r.indexOf(n);
        i < 0 || a < 0 || i === a || (Ce((e) => Gr(e, i, a)), w.moveSlide(i, a));
      },
      [w],
    ),
    G = (0, Q.useCallback)((e) => {
    ...
    J = (0, Q.useCallback)(
      ...
      [Te, yt, gt, P, I, U, W, xt, vt, _, _t, h, V, mt, qe, rt, nt, N],
    );
  return (0, $.jsx)(`div`, {
    className: p(
            ...
            children: [
              v?.annotation && ue
                ? (0, $.jsx)(we, {
                    ...
                    onClick: () => {
                      let e = !E;
                      (e && (v?.annotation?.onModeEnabled?.(), A(!1)), D(e));
                    },
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            ...
            (0, $.jsxs)(`div`, {
              ...
              className: p(`relative overflow-hidden border bg-white`, ne, m ? `shadow-lg` : null),
              style: {
                ...oi,
                ...re,
                borderColor: i ? si : ui,
      ...
      (mi = (0, Q.memo)(function ({
        ...
        return (0, $.jsx)(B, {
          ...
          trigger: (0, $.jsx)(`div`, {
            ref: ne,
            style: {
              transform: s.Translate.toString(h),
...
function _i({
  ...
  artifactSearchEnabled: oe = !1,
  commentThreadsEnabled: v = !1,
  workerFactory: se,
}) {
  let y = Ue({ initialCrdtState: o, externalCrdtUpdates: t }),
    b = (0, Si.useRef)(s),
    x = (0, Si.useRef)(null),
    S = he(
      void 0,
  ...
  return (
    (0, Si.useEffect)(() => {
      S && b.current !== s && ((b.current = s), S.replaceFromProto(s ?? vi().toProto()));
    }, [S, s]),
    (0, Si.useEffect)(() => {
      if (!S || h == null) return;
      let e = () => {
      ...
      if (S && f)
        return S.subscribeImageHydrationRequests((e) => {
          ...
          ((C.current = t),
            f(e)
              .then((e) => {
                if (!(C.current !== t || e.length === 0)) return S.hydrateImageAssets(e);
              })
              .catch(() => {}));
        });
    }, [S, f]),
      ...
      ? (0, Ci.jsxs)(`section`, {
          ...
          children: [
            (0, Ci.jsx)(Kr, {
              ...
              enablePageNavigation: _,
              artifactSearchEnabled: oe,
              commentThreadsEnabled: v,
            }),
            (0, Ci.jsx)(at, { artifactLabel: `Presentation`, restoreState: w }),
          ],
        })
      : null
  );
