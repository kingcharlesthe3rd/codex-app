...
import { a as ee, o as te } from "./workbook-2.js";
import {
  $ as ne,
  A as h,
  C as re,
...
import { n as ge, t as _e } from "./PopcornPageNumberNavigation.js";
import {
  nn as N,
  rn as ve,
...
function yr({
  ...
  let Ae = (0, X.useRef)(null),
    ...
    tt = $e ?? et,
    V = (0, X.useMemo)(() => (!D || !ve ? null : ur(ve.start, ve.current)), [D, ve]),
    H = (0, X.useMemo)(() => {
      if (!V || !ve) return null;
    ...
    } = Ne(m?.annotation?.handleRef, { onDismissAnnotation: Ue, onDismissAllAnnotations: He }),
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      g.selectedSlideFrame && t.hasInitializedCamera() && e.setViewportCamera(I);
  ...
  let G = (0, X.useCallback)(() => {
    ...
    Dt = () => {
      k?.mode === `edit` && (mt(k.annotationId), j((e) => (e === k.annotationId ? null : e)), xt());
    };
  ((0, X.useEffect)(() => {
    (D || (k?.mode !== `edit` && A(null)), (!D || !c) && (P(null), (N.current = null)));
  }, [D, k?.mode, c]),
    (0, X.useEffect)(() => {
      if (O && u) {
        (A(null), P(null), (N.current = null), _e(!1), e.setHoveredElementId(null));
        return;
      }
      let t = f !== Pe.current;
    ...
    (0, X.useEffect)(() => {
      k && k.target.slideId !== R && (j(null), P(null), (N.current = null), A(null));
    }, [k, R]),
    (0, X.useEffect)(
      () => () => {
        K();
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      ...
      let o = g.primarySelectedElementId
        ...
        m =
          l?.elementId ??
          (p === `move` ? sr(g.selectedSlideElementTargets, n, I.k) : g.primarySelectedElementId);
      if (!m) {
...
function Kr({
  ...
  let [me, he] = (0, Q.useState)(() =>
    ...
    [N, ye] = (0, Q.useState)(() => Object.fromEntries(w.slideIds.map((e) => [e, null]))),
    [be, xe] = (0, Q.useState)(() => Object.fromEntries(w.slideIds.map((e) => [e, null]))),
    ...
    $e = !_ && Ie && M > 0,
    et = (0, Q.useMemo)(
      () => ({ left: Qe ? Qr : 0, top: 0, right: 0, bottom: $e ? Wr(M, g) : 0 }),
      [M, $e, Qe, g],
    );
  ((0, Q.useEffect)(() => {
  ...
  let nt = (0, Q.useMemo)(
    ...
    V = (0, Q.useMemo)(() => Object.fromEntries(w.slideIds.map((e, t) => [e, t])), [w.slideIds]),
  ...
  ((0, Q.useEffect)(() => {
    ...
    (0, Q.useEffect)(() => {
      if (!(typeof IntersectionObserver > `u`)) {
        ...
        for (let e of [...Be.current, ...Ve.current]) e && He.current.observe(e);
        return () => {
          He.current?.disconnect();
        };
      }
  ...
  let U = (0, Q.useCallback)(
    ...
    G = (0, Q.useCallback)(
      (e) => {
        ...
        let r = Ge.current,
          i = r.indexOf(t),
          a = r.indexOf(n);
        i < 0 || a < 0 || i === a || (Se((e) => Gr(e, i, a)), C.moveSlide(i, a));
      },
      [C],
    ),
    K = (0, Q.useCallback)((e) => {
    ...
    xt = (0, Q.useCallback)((e, t, n) => {
      ((Ve.current[e] = n), n && He.current && I.current[t] == null && He.current.observe(n));
    }, []),
    J = (0, Q.useCallback)(
      (e, t = `default`, n) => {
        let r = Vr(e, t);
