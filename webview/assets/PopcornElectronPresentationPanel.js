...
import { a as ae, d as b, f as x, i as S, n as C, p as w, t as T } from "./core.esm.js";
...
function q(e, t) {
  ...
  let a = K({ slide: n, left: 72, top: 300, width: 346, height: 208, fill: B.cloud });
  ((a.line.fill = B.blue),
    (a.line.width = 1),
    G(
      n,
  ...
  let o = K({ slide: n, left: 444, top: 300, width: 346, height: 208, fill: B.lavender });
  ...
  let s = K({ slide: n, left: 816, top: 300, width: 390, height: 208, fill: B.mintTint });
  ((s.line.fill = B.mint),
    G(
      n,
      842,
...
function Je(e) {
  ...
  (W(
    ...
    [
      ...
      { label: `Dash-dot-dot 3px`, style: `dash-dot-dot`, color: B.rose, width: 3 },
    ].forEach((e, n) => {
      let r = 84 + n * 228,
        i = t.shapes.add({
...
function Ye(e) {
  ...
  ((a.fill = { type: `solid`, color: `#F8FAFC`, pattern: { type: `lightGrid`, color: B.indigo } }),
...
function rt() {
  let e = r.create(),
    t = ee(),
    n = l();
  return (q(e, n), Je(e), Ye(e), Xe(e), Ze(e), Y(e), Qe(e), $e(e), et(e, t, n), tt(e), nt(e), e);
}
function it() {
  return new Worker(
...
var dt = class {
  ...
  attachViewport(e) {
    ...
    ((this.#u ??= { ...o }),
      ...
      e.overlayCanvas && lt(e.overlayCanvas, this.#u, { resizeIntrinsicBitmap: !0 }),
      this.#_.then(() => {
        if (this.#v) return;
        let n = t();
...
function Z(e, t, n, r) {
  let i = gt(t, r),
    a = Re({ ...e, x: e.x - i.left, y: e.y - i.top }, { width: i.width, height: i.height }, n),
...
function yt(e, t, n) {
  ...
  return Math.max(X, Math.min(i / Math.max(t.width, 1), a / Math.max(t.height, 1)));
}
function $(e) {
  let t = _t(e.viewport),
    n = { x: t.x, y: t.y },
...
function Ct(e) {
  let t = { ...e.camera, k: Q(e.camera.k) },
    n = $({ viewport: e.viewport, frame: e.frame, camera: t, viewportInsets: e.viewportInsets });
...
function Vt({ notesHeight: e, minHeight: t = 80, setNotesHeight: n }) {
  ...
  return (0, R.jsx)(`div`, {
    ...
    children: (0, R.jsx)(`div`, { className: `h-[3px] w-full rounded bg-gray-300` }),
  });
}
function Ht({
  threads: e,
...
function gn({
  ...
  let We = (0, L.useRef)(null),
    ...
    Qe = Ze ?? Y,
    $e = (0, L.useMemo)(() => (!O || !Ie ? null : nn(Ie.start, Ie.current)), [O, Ie]),
    et = (0, L.useMemo)(() => {
      if (!$e || !Ie) return null;
    ...
    } = le(m?.annotation?.handleRef, { onDismissAnnotation: qe, onDismissAllAnnotations: B }),
    lt = (0, L.useMemo)(() => at.filter((e) => e.target.slideId === q), [q, at]),
    ut = (0, L.useMemo)(
    ...
    ht = (0, L.useMemo)(() => pt.filter((e) => e.target.slideId === q), [q, pt]),
    X = (0, L.useMemo)(
      () =>
        new re(
          {
  ...
  ((0, L.useEffect)(
    ...
    (0, L.useEffect)(() => {
      _.selectedSlideFrame && t.hasInitializedCamera() && e.setViewportCamera(H);
    }, [H, e, t, _.selectedSlideFrame]),
    (0, L.useEffect)(() => {
      let e = y.current;
      !_.selectedSlideFrame ||
        !e ||
        X.updateState({ state: o ? _.textEditState : null, blocks: _.textLayoutBlocks });
  ...
  let gt = (0, L.useCallback)(() => {
      ...
      (e) => {
        ...
        let a = { width: r.clientWidth, height: r.clientHeight },
          ...
          l = Yt({
            ...
            frame: c,
            viewportBounds: s,
            containedElements: rn(_.selectedSlideElementTargets, c).flatMap((e) => {
              let t = _.selectedSlideElementTargets.find((t) => t.id === e);
              return t
                ? [
                    {
        ...
        let u = _e(`drawing`),
          d = Zt(l);
        mt({ drawingId: u, artifactKind: `presentation`, label: d, target: l, strokes: e });
    ...
    wt = () => {
      A?.mode === `edit` && (ct(A.annotationId), M((e) => (e === A.annotationId ? null : e)), Q());
    };
  ((0, L.useEffect)(() => {
    (O || (A?.mode !== `edit` && j(null)), (!O || !l) && (F(null), (P.current = null)));
  }, [O, A?.mode, l]),
    (0, L.useEffect)(() => {
      if (k && d) {
        (j(null), F(null), (P.current = null), Pe(!1), e.setHoveredElementId(null));
        return;
      }
      let t = p !== Ge.current;
    ...
    (0, L.useEffect)(() => {
      A && A.target.slideId !== q && (M(null), F(null), (P.current = null), j(null));
    }, [A, q]),
    (0, L.useEffect)(
      () => () => {
        _t();
  ...
  let Tt = (t) => {
    ...
    Et = (t) => {
      ...
      let r = X.isActive(),
        i =
          ...
          C.current === _.primarySelectedElementId
            ? _.primarySelectedElementId
            : void 0;
      if ((r || i) && X.tryPointerDown(n, { shiftKey: t.shiftKey, restrictToBlockId: i })) {
        (t.preventDefault(),
          (S.current = `text`),
          (w.current = null),
          (T.current = null),
      ...
      let a = _.primarySelectedElementId
        ...
        m =
          c?.elementId ??
          (p === `move` ? en(_.selectedSlideElementTargets, n, H.k) : _.primarySelectedElementId);
      if (!m) {
        if (((w.current = null), (T.current = null), (oe.current = !1), r)) return;
        (wn(t, x),
          (S.current = `marquee`),
          (C.current = null),
    ...
    Dt = (t) => {
      ...
      if (O && l) {
        ...
        (e.setHoveredElementId(i), (t.currentTarget.style.cursor = je.current ? `` : Te));
        return;
      }
      if (S.current === `text`) {
        n && X.pointerMove(n);
      ...
      if (S.current === `element` && n) {
        (T.current && Math.hypot(n.x - T.current.x, n.y - T.current.y) > pn && (oe.current = !0),
      ...
      if (i && r?.canRotate && on(i, n, H.k)) {
        (e.setHoveredElementId(_.primarySelectedElementId), (t.currentTarget.style.cursor = Fe()));
        return;
      }
    ...
    Ot = (t, n) => {
      ...
      S.current = null;
      let i = w.current,
        a = !!n && !oe.current && !!i && _.textLayoutBlocks.some((e) => e.id === i);
      ((w.current = null),
        (T.current = null),
        (oe.current = !1),
    ...
    At = (e) =>
      !e.metaKey && !e.ctrlKey
        ...
        : e.key === `0`
          ...
          : e.key === `=` || e.key === `+`
            ? (t.zoomTo(vt(_.zoom + 0.1, _.fitScale ?? 1), { settled: !0 }), e.preventDefault(), !0)
            : e.key === `-`
...
function _n(e, t) {
  let n = window.getComputedStyle(e),
    r = t === `codex` ? vn(n.getPropertyValue(`--color-background-surface`)) : null;
  if (r) return r;
  let i = n.backgroundColor.trim();
  return i.length > 0 && i !== `transparent` && i !== `rgba(0, 0, 0, 0)` ? i : Ce(t);
}
function vn(e) {
  let t = e.trim();
...
function Sn(e, t, n, r, i) {
  return !r || e <= 0 || t <= 0
    ? null
    : $({ viewport: { width: e, height: t }, frame: r, camera: n, viewportInsets: i }).slideRect;
}
function Cn(e) {
...
var En = 1e-4,
  Dn = class {
    ...
    #y(e, t, n) {
      ...
      if (i && this.#s) {
        this.#e.setCamera(
          Math.abs(t.zoom - 1) < En
            ? bt({ viewport: a, frame: r, zoomFactor: t.zoom, viewportInsets: this.#l })
            : xt({
      ...
      if (t.camera) {
        let n = bt({ viewport: a, frame: r, zoomFactor: t.zoom, viewportInsets: this.#l }).k,
...
var Bn = { width: `94px` },
  Vn = { width: `18px`, minWidth: `18px`, fontSize: `11px`, lineHeight: `14px` },
  Hn = { borderRadius: `8px`, boxShadow: `0px 4px 16px 0px rgba(0, 0, 0, 0.05)` },
  ...
  Gn = [`0px 2px 8px 0px rgba(2, 133, 255, 0.16)`, `0px 4px 16px 0px rgba(0, 0, 0, 0.05)`].join(
    `, `,
  ),
...
function Zn({
  ...
  let [be, xe] = (0, L.useState)(() =>
    ...
    [Te, Ee] = (0, L.useState)(() => Object.fromEntries(D.slideIds.map((e) => [e, null]))),
    [De, O] = (0, L.useState)(() => Object.fromEntries(D.slideIds.map((e) => [e, null]))),
    ...
    Se(() => {
      ...
      let t = null,
        n = (e) => {
          let t = e >= 749,
            n = U && e > 0 && e <= 688;
          (Me((e) => (e === t ? e : t)), Ne((e) => e || !0), Fe((e) => (e === n ? e : n)));
        };
      if (
        (n(e.clientWidth),
        typeof window < `u` &&
  ...
  let J = (0, L.useMemo)(
      () => Object.fromEntries(D.slideIds.map((e, t) => [e, D.slideLabels[t] ?? `Slide ${t + 1}`])),
      [D.slideIds, D.slideLabels],
    ),
    Xe = (0, L.useMemo)(() => Object.fromEntries(D.slideIds.map((e, t) => [e, t])), [D.slideIds]),
    Ze = D.slideIds[D.selectedSlideIdx] ?? null,
    Y = D.fitScale ?? (D.slideRect && D.zoom > 0 ? D.slideRect.scale / D.zoom : null),
    Qe = Y ? Q(Y) : null,
    ...
    mt = (0, L.useCallback)(
      async (e, t) => {
        ...
        if (
          ...
          try {
            await Ue();
            let t = await E.requestSlideThumbnail(e, r ? { cssMaxPx: Pn } : void 0);
  ...
  ((0, L.useEffect)(() => {
    ...
    (e && (He.current.delete(`rail:${e}`), He.current.delete(`stacked-page:${e}`)),
  ...
  let ht = (0, L.useCallback)(
    ...
    vt = (0, L.useCallback)((e) => {
      let t = e.relatedTarget;
      (t instanceof Node && e.currentTarget.parentElement?.contains(t)) || Ae(!1);
    }, []),
    yt = (0, L.useCallback)((e, t, n) => {
      ((Ve.current[e] = n), n && I.current && z.current[t] == null && I.current.observe(n));
    }, []),
    $ = (0, L.useCallback)(
      (e, t = `default`, n) => {
        let r = Ln(e, t);
...
function Qn({ index: e, label: t, thumbnail: n, isSelected: r, onSelect: i, buttonRef: a }) {
  return (0, R.jsx)(`button`, {
    ...
    children: n
      ...
      : (0, R.jsx)(`div`, { className: `popcorn-presentation-stacked-page-placeholder` }),
  });
}
function $n({
  controller: e,
...
function er({ controller: e, panels: t, panelControls: n, panelOpenState: r, isEditing: i }) {
  return !i || t.length === 0
    ? null
    : (0, R.jsx)(`div`, {
...
function ar({
  ...
  return (
    (0, L.useEffect)(() => {
      b && ae.current !== s && ((ae.current = s), b.replaceFromProto(s ?? or().toProto()));
    }, [b, s]),
    (0, L.useEffect)(() => {
      if (b && f)
        return b.subscribeImageHydrationRequests((e) => {
          ...
          ((x.current = t),
            f(e)
              .then((e) => {
                if (!(x.current !== t || e.length === 0)) return b.hydrateImageAssets(e);
              })
              .catch(() => {}));
        });
    }, [b, f]),
      ...
      ? (0, R.jsxs)(`section`, {
          ...
          children: [
            (0, R.jsx)(Zn, {
              ...
              headerRightContent:
                C.length > 0
                  ? (0, R.jsxs)(R.Fragment, { children: [(0, R.jsx)(sr, { count: C.length }), n] })
                  : n,
              renderHeaderZoomControl: a,
              zoomToFitLabel: r,
