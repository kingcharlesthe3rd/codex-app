...
import { t as v } from "./PopcornPageNumberNavigation.js";
import { a as oe, d as se, f as ce, i as y, n as b, p as x, t as S } from "./core.esm.js";
import { t as C } from "./modifiers.esm.js";
import {
  $ as w,
  A as le,
  B as T,
...
var L = n();
function R(e, t) {
  if (t && t.width > 0 && t.height > 0) return { width: t.width, height: t.height };
...
function Ge(e, t) {
  return R(e, { width: t.contentRect.width, height: t.contentRect.height });
}
var Ke = 1280,
  qe = 720,
  z = {
  ...
  Je = [
    { type: `lightGrid`, color: z.indigo },
    { type: `smallGrid`, color: z.blue },
    { type: `largeGrid`, color: z.cyan },
    { type: `darkGrid`, color: z.ink },
    { type: `dotGrid`, color: z.violet },
    { type: `cross`, color: z.blue },
    { type: `diagonalCross`, color: z.violet },
    { type: `horizontal`, color: z.mint },
    { type: `vertical`, color: z.rose },
    { type: `lightHorizontal`, color: z.cyan },
    { type: `lightVertical`, color: z.blue },
    { type: `narrowHorizontal`, color: z.ink },
    { type: `narrowVertical`, color: z.muted },
    { type: `dashedHorizontal`, color: z.indigo },
    { type: `dashedVertical`, color: z.rose },
    { type: `upwardDiagonal`, color: z.mint },
    { type: `downwardDiagonal`, color: z.blue },
    { type: `wideUpwardDiagonal`, color: z.cyan },
    { type: `wideDownwardDiagonal`, color: z.violet },
    { type: `dashedUpwardDiagonal`, color: z.amber },
    { type: `dashedDownwardDiagonal`, color: z.rose },
    { type: `smallCheck`, color: z.indigo },
    { type: `largeCheck`, color: z.blue },
    { type: `openDiamond`, color: z.cyan },
    { type: `solidDiamond`, color: z.violet },
    { type: `dottedDiamond`, color: z.amber },
    { type: `plaid`, color: z.rose },
    { type: `weave`, color: z.ink },
    { type: `wave`, color: z.blue },
    { type: `zigZag`, color: z.violet },
    { type: `horizontalBrick`, color: z.amber },
    { type: `diagonalBrick`, color: z.rose },
    { type: `sphere`, color: z.mint },
    { type: `divot`, color: z.indigo },
    { type: `shingle`, color: z.cyan },
    { type: `trellis`, color: z.blue },
    { type: `lightTrellis`, color: z.violet },
    { type: `darkTrellis`, color: z.ink },
    { type: `smallConfetti`, color: z.amber },
    { type: `largeConfetti`, color: z.rose },
    { type: `gray125`, color: z.ink },
    { type: `gray0625`, color: z.muted },
    { type: `percent10`, color: z.indigo },
    { type: `percent20`, color: z.blue },
    { type: `percent30`, color: z.cyan },
    { type: `percent40`, color: z.violet },
    { type: `percent50`, color: z.amber },
    { type: `percent60`, color: z.rose },
    { type: `percent70`, color: z.mint },
    { type: `percent80`, color: z.ink },
    { type: `percent90`, color: z.muted },
    { type: `lightGray`, color: z.ink },
    { type: `mediumGray`, color: z.ink },
    { type: `darkGray`, color: z.ink },
  ];
function B(e, t = z.canvas) {
  let n = e.slides.add();
  return (n.setViewportSize(Ke, qe), (n.background.fill = t), Ye(n), n);
}
function Ye(e) {
...
function V(e) {
  let t = e.slide.shapes.add({
    ...
    fill: e.fill,
    line: e.radiusLine ? { style: `solid`, fill: z.border, width: 1 } : void 0,
  });
  return (
    (t.text = e.text),
    (t.text.fontSize = e.fontSize ?? 16),
    (t.text.color = e.color ?? z.ink),
    (t.text.bold = !!e.bold),
...
function H(e, t, n) {
  (V({ slide: e, left: 72, top: 48, width: 620, height: 50, text: t, fontSize: 30, bold: !0 }),
    V({
      slide: e,
      left: 72,
      top: 100,
...
function U(e, t, n, r, i, a) {
  (V({ slide: e, left: t, top: n, width: r, height: 24, text: i, fontSize: 14, bold: !0 }),
    V({
      slide: e,
      left: t,
      top: n + 22,
...
function W(e) {
  return e.slide.shapes.add({
    ...
    position: { left: e.left, top: e.top, width: e.width, height: e.height },
    fill: e.fill ?? z.panel,
    line: { style: `solid`, fill: z.border, width: 1 },
  });
}
function G(e, t) {
  let n = B(e, `#F7FAFF`),
  ...
  ((i.position = { left: 706, top: 88, width: 500, height: 300 }), (i.fit = `cover`));
  let a = W({ slide: n, left: 72, top: 300, width: 346, height: 208, fill: z.cloud });
  ((a.line.fill = z.blue),
    (a.line.width = 1),
    U(
      n,
  ...
  let o = W({ slide: n, left: 444, top: 300, width: 346, height: 208, fill: z.lavender });
  ((o.line.fill = z.violet),
    U(
      n,
      470,
      328,
  ...
  let s = W({ slide: n, left: 816, top: 300, width: 390, height: 208, fill: z.mintTint });
  ((s.line.fill = z.mint),
    U(
      n,
      842,
...
function K(e) {
  ...
  (H(
    ...
    [
      { label: `Solid 1px`, style: `solid`, color: z.blue, width: 1 },
      { label: `Dashed 2px`, style: `dashed`, color: z.indigo, width: 2 },
      { label: `Dotted 2px`, style: `dotted`, color: z.cyan, width: 2 },
      { label: `Dash-dot 3px`, style: `dash-dot`, color: z.violet, width: 3 },
      { label: `Dash-dot-dot 3px`, style: `dash-dot-dot`, color: z.rose, width: 3 },
    ].forEach((e, n) => {
      let r = 84 + n * 228,
        i = t.shapes.add({
  ...
  let r = t.shapes.add({
    ...
    fill: `#ffffff`,
    line: { style: `dash-dot`, fill: z.violet, width: 2 },
  });
  ((r.text = `Dash-dot`),
  ...
  let i = t.shapes.add({
    ...
    fill: `#ffffff`,
    line: { style: `dotted`, fill: z.cyan, width: 2 },
  });
  ((i.text = `Dotted`), (i.text.alignment = `center`), (i.text.verticalAlignment = `middle`));
}
function Xe(e) {
  let t = B(e, `#FBFBFE`);
  H(
  ...
  let n = W({ slide: t, left: 86, top: 188, width: 240, height: 220 });
  ((n.fill = z.blue),
    (n.line.fill = z.blue),
    U(t, 104, 422, 206, `Solid fill`, `Theme/RGB-backed surface`));
  let r = W({ slide: t, left: 368, top: 188, width: 240, height: 220 });
  ((r.fill = {
    type: `gradient`,
    gradientKind: `linear`,
    angleDeg: 30,
    ...
    (r.line.fill = z.blue),
    U(t, 386, 422, 206, `Linear gradient`, `Two-stop diagonal blend`));
  let i = W({ slide: t, left: 650, top: 188, width: 240, height: 220 });
  ((i.fill = {
    type: `gradient`,
    gradientKind: `path`,
    angleDeg: 135,
    ...
    (i.line.fill = z.violet),
    U(t, 668, 422, 206, `Path gradient`, `Centered radial emphasis`));
  let a = W({ slide: t, left: 932, top: 188, width: 240, height: 220 });
  ((a.fill = { type: `solid`, color: `#F8FAFC`, pattern: { type: `lightGrid`, color: z.indigo } }),
    (a.line.fill = z.indigo),
    U(t, 950, 422, 206, `Pattern fill`, `Light grid overlay`));
  let o = t.shapes.add({
    geometry: `roundRect`,
    ...
    Je.forEach((e, n) => {
      ...
      ((s.text.alignment = `center`),
        t.shapes.add({
          ...
          fill: { type: `solid`, color: `#F8FAFC`, pattern: { type: e.type, color: e.color } },
          line: { style: `solid`, fill: z.border, width: 1 },
        }));
    }));
}
function Qe(e) {
  ...
  let n = t.shapes.add({
    ...
    fill: `#DBEAFE`,
    line: { style: `solid`, fill: z.blue, width: 2 },
  });
  ((n.text = `Decision`), (n.text.alignment = `center`), (n.text.verticalAlignment = `middle`));
  let r = t.shapes.add({
    geometry: `rect`,
    position: { left: 448, top: 220, width: 190, height: 110 },
    fill: `#EDE9FE`,
    line: { style: `solid`, fill: z.violet, width: 2 },
  });
  ((r.text = `Process`), (r.text.alignment = `center`), (r.text.verticalAlignment = `middle`));
  let i = t.shapes.add({
    geometry: `flowChartTerminator`,
    position: { left: 764, top: 220, width: 212, height: 110 },
    fill: `#ECFDF5`,
    line: { style: `solid`, fill: z.mint, width: 2 },
  });
  ((i.text = `Terminator`), (i.text.alignment = `center`), (i.text.verticalAlignment = `middle`));
  let a = t.shapes.add({
    geometry: `chevron`,
    ...
    line: { style: `solid`, fill: z.amber, width: 2 },
  });
  (t.shapes.add({
    geometry: `connector`,
    kind: `straight`,
    ...
    t.shapes.add({
      ...
      to: i,
      toIdx: 1,
      line: { style: `dashed`, fill: z.violet, width: 2 },
    ...
    t.shapes.add({
      ...
      to: a,
      toIdx: 1,
      line: { style: `dash-dot`, fill: z.amber, width: 2 },
      head: { type: `triangle`, width: `med`, length: `med` },
    }),
    U(t, 154, 378, 270, `Process shapes`, `Flowchart decision, rect, and terminator geometries.`),
    U(
      t,
      510,
      378,
    ...
    U(t, 900, 378, 230, `Transforms`, `Rotated and gradient-filled accent chevron.`));
}
function $e(e) {
  let t = B(e, `#FAFBFF`);
  H(
  ...
  let n = W({ slide: t, left: 82, top: 176, width: 360, height: 180 });
  ((n.text = [`Quarterly Design Review`, `Shared text engine`]),
    ...
    (n.text.get(`Quarterly Design Review`).color = z.blue),
    (n.text.get(`Shared text engine`).fontSize = 16),
    (n.text.get(`Shared text engine`).color = z.muted));
  let r = W({ slide: t, left: 474, top: 176, width: 326, height: 240, fill: `#FFFFFF` });
  ((r.text = [
...
`),
  ...
  let i = W({ slide: t, left: 840, top: 176, width: 354, height: 240, fill: `#F8FBFF` });
...
function J(e) {
  ...
  let i = t.tables.add({
    ...
    values: [
      [`Pattern`, `Example`],
      [`Rich text`, [{ run: `Inline `, textStyle: { bold: !0 } }, `formatting`]],
      [`Multi-line`, [[{ run: `Line 1`, textStyle: { italic: !0 } }], [{ run: `Line 2` }]]],
    ],
  });
...
function et(e) {
  ...
  ((o.categories = a.categories), (o.values = [60, 80, 25]), (o.fill = `accent1`));
  let s = a.series.add(`Services`);
  ((s.categories = a.categories), (s.values = [30, 40, 10]), (s.fill = `accent3`));
  ...
  ((l.position = { left: 844, top: 168, width: 362, height: 230 }), (l.title = `Scatter`));
  ...
  ((u.xValues = [1.5, 3.2, 6.8, 12.4, 24.9]),
    ...
    U(t, 846, 418, 356, `Scatter`, `XY data with connected markers and explicit axis titles.`));
}
function tt(e, t, n) {
  let r = B(e);
  H(
  ...
  ((i.position = { left: 96, top: 188, width: 304, height: 208 }), (i.fit = `contain`));
  let a = r.images.add({ dataUrl: t, alt: `Aurora cover treatment` });
  ((a.position = { left: 486, top: 188, width: 304, height: 208 }), (a.fit = `cover`));
...
function nt(e) {
  ...
  let n = W({ slide: t, left: 72, top: 154, width: 1136, height: 388, fill: `#FFFFFF` });
  n.line.fill = `#BFDBFE`;
  let r = t.images.add({
...
function rt(e) {
  ...
  if (!t || !n || !r) return;
  let i =
    t.shapes.items.find((e) => e.text.toString().includes(`Slides Feature Catalog`)) ??
    t.shapes.items[0];
  i &&
    e.comments
      .addThread(
      ...
      e.comments
        .addThread(
          ...
          `This callout label is useful for text-range comment placement checks.`,
          {
            ...
            author: { id: `popcorn-demo-reviewer`, displayName: `Noah Reviewer`, initials: `NR` },
  ...
  e.comments
    .addThread(
      ...
      `Slide-level thread anchored in open space so marker projection can be checked independently of element geometry.`,
      {
        ...
        author: { id: `popcorn-demo-pm`, displayName: `Mia PM`, initials: `MP` },
...
function it() {
  let e = i.create(),
    t = ee(),
    n = l();
  return (G(e, n), K(e), Xe(e), q(e), Qe(e), $e(e), J(e), et(e), tt(e, t, n), nt(e), rt(e), e);
}
function at() {
  return new Worker(
    new URL(`` + new URL(`runtime.worker-CnG-97Cx.js`, import.meta.url).href, `` + import.meta.url),
...
function dt(e) {
  if (
    !(
      ...
      (!e?.requiresCanvasTransfer || `transferControlToOffscreen` in HTMLCanvasElement.prototype)
    )
  )
    throw Error(
...
var ft = class {
  ...
  #v = !1;
  constructor(e = {}) {
    let t = e.presentationProto ?? e.presentation?.toProto() ?? it().toProto();
    ((this.#a = new d(
      (e.workerFactory ?? at)(),
      (e) => this.#C(e),
      (e) => {
  ...
  dispatch(e) {}
  attachViewport(e) {
    dt({ requiresCanvasTransfer: !!e.overlayCanvas });
    let t = (t) => {
        let n = R(e.host, t);
        return {
      ...
      i = this.#s !== e.canvas;
    if ((i && (this.#s = e.canvas), (this.#c = e.canvas.getContext(`2d`)), !this.#c))
    ...
    ((this.#u ??= { ...o }),
      (this.#d ??= { ...o }),
      ut(e.canvas, this.#u, { resizeIntrinsicBitmap: !0 }),
      e.overlayCanvas && ut(e.overlayCanvas, this.#u, { resizeIntrinsicBitmap: !0 }),
      this.#_.then(() => {
        if (this.#v) return;
        let n = t();
        if (((this.#d = { ...n }), this.#u ?? this.#y(n), i)) {
          if (this.#s !== e.canvas) return;
          this.#a.dispatch({ kind: `attach-canvas`, width: n.width, height: n.height, dpr: n.dpr });
  ...
  #y(e) {
    ((this.#u = { ...e }),
      this.#s && (ut(this.#s, e), this.#x()),
      this.#l && ut(this.#l, e, { resizeIntrinsicBitmap: !1 }));
  }
  requestExport(e) {
    return this.#a.request({ kind: `export`, format: e?.format ?? `proto` }).then((e) => {
  ...
  loadInitialCrdtState(e) {
    return this.#a.request({ kind: `load-initial-crdt-state`, update: e }).then((e) => {
      if (e.kind !== `load-initial-crdt-state`)
        throw Error(`Unexpected initial CRDT load response: ${e.kind}`);
    });
  }
  applyCrdtUpdate(e) {
    return this.#a.request({ kind: `apply-crdt-update`, update: e }).then((e) => {
      if (e.kind !== `apply-crdt-update`) throw Error(`Unexpected CRDT apply response: ${e.kind}`);
    });
  }
  hydrateImageAssets(e) {
    return this.#a.request({ kind: `hydrate-image-assets`, assets: e }).then((e) => {
  ...
  replaceFromProto(e) {
    return this.#a.request({ kind: `replace-from-proto`, presentationProto: e }).then((e) => {
  ...
  #S(e) {
    ...
    (this.#h?.bitmap.close(),
      ...
      r &&
        e.resizeId != null &&
        (this.#a.dispatch({ kind: `commit-viewport-resize`, resizeId: e.resizeId }), this.#b()));
  }
  ...
  setStageBackgroundColor(e) {
    ...
    t.length === 0 ||
      t === this.#g ||
      ((this.#g = t), this.#a.dispatch({ kind: `set-stage-background-color`, backgroundColor: t }));
  }
  setViewportInsets(e) {
  ...
  replyToCommentThread(e, t) {
    return (this.#a.dispatch({ kind: `reply-comment-thread`, threadId: e, body: t }), !0);
  }
  resolveCommentThread(e) {
    return (this.#a.dispatch({ kind: `resolve-comment-thread`, threadId: e }), !0);
  }
  reopenCommentThread(e) {
    return (this.#a.dispatch({ kind: `reopen-comment-thread`, threadId: e }), !0);
  }
  deleteCommentThread(e) {
    return (this.#a.dispatch({ kind: `delete-comment-thread`, threadId: e }), !0);
  }
  ...
  editThreadComment(e, t, n) {
    return (
      this.#a.dispatch({ kind: `edit-thread-comment`, threadId: e, commentId: t, body: n }), !0
    );
  }
  deleteThreadComment(e, t) {
    return (this.#a.dispatch({ kind: `delete-thread-comment`, threadId: e, commentId: t }), !0);
  }
  ...
  endSelectionMarquee(e) {
    return (this.#a.dispatch({ kind: `end-selection-marquee`, commit: e?.commit }), !0);
  }
  textPointerDown(e, t) {
    return (this.#a.dispatch({ kind: `text-pointer-down`, point: e, shiftKey: t?.shiftKey }), !0);
  }
  textPointerMove(e) {
  ...
  textSelectWordAtPoint(e) {
    return (this.#a.dispatch({ kind: `text-select-word-at-point`, point: e }), !0);
  }
  textSelectParagraphAtPoint(e) {
    return (this.#a.dispatch({ kind: `text-select-paragraph-at-point`, point: e }), !0);
  }
  textActivateBlockEnd(e) {
    return (this.#a.dispatch({ kind: `text-activate-block-end`, blockId: e }), !0);
  }
  textClear() {
  ...
  clearPresenceCursor(e, t) {
    this.#a.dispatch({ kind: `clear-presence-cursor`, presenceId: e, slideId: t?.slideId });
  }
  clearPresenceSelection(e, t) {
    this.#a.dispatch({ kind: `clear-presence-selection`, presenceId: e, slideId: t?.slideId });
  }
  ...
  endElementInteraction(e) {
    return (this.#a.dispatch({ kind: `end-element-interaction`, commit: e?.commit }), !0);
  }
  nudgeSelectedElements(e) {
    return (this.#a.dispatch({ kind: `nudge-selected-elements`, dx: e.dx, dy: e.dy }), !0);
  }
  ...
  moveSlide(e, t) {
    return (this.#a.dispatch({ kind: `move-slide`, fromIndex: e, toIndex: t }), !0);
  }
  deleteSlide(e) {
  ...
  updateSelectedElementFrame(e) {
    return (this.#a.dispatch({ kind: `update-selected-element-frame`, framePatch: e }), !0);
  }
  updateSelectedElementStyle(e) {
    return (this.#a.dispatch({ kind: `update-selected-element-style`, stylePatch: e }), !0);
  }
  reorderSelectedElement(e) {
    return (this.#a.dispatch({ kind: `reorder-selected-element`, direction: e }), !0);
  }
  undo() {
  ...
  exportPresentationProto() {
    return this.requestExport({ format: `proto` }).then((e) => e.presentationProto);
  }
  requestSlideThumbnail(e, t) {
    return this.#_.then(() =>
      this.#a
        ...
        .then((e) => {
          if (e.kind !== `slide-thumbnail`) throw Error(`Unexpected thumbnail response: ${e.kind}`);
          return e.result;
        }),
    );
  }
  #C(e) {
    switch (e.kind) {
      ...
      case `viewport-resize-ready`:
        ...
        (this.#y(this.#d),
          this.#a.dispatch({ kind: `commit-viewport-resize`, resizeId: e.resizeId }));
        return;
      case `viewport-frame`:
        this.#S(e);
        return;
      case `viewport-frame-presented`:
        ...
        ((this.#f = null), this.#y({ width: e.width, height: e.height, dpr: e.dpr }));
        return;
      case `editor`:
        this.#t.patch(e.state);
        return;
...
function mt(e) {
  let t = [],
    n = [];
  for (let r of e) (t.push(...(r.panels ?? [])), n.push(...(r.stageOverlays ?? [])));
...
function yt(e, t, n, r) {
  let i = Y(t, r),
    a = ze({ ...e, x: e.x - i.left, y: e.y - i.top }, { width: i.width, height: i.height }, n),
...
function bt(e, t = 1) {
  let n = Math.max(t, _t);
  return Math.min(4 / n, Math.max(gt / n, e));
}
function X(e) {
  return Math.min(4, Math.max(gt, e));
}
function Z(e, t, n) {
  let r = Y(e, n),
    i = Math.max(1, r.width - ht * 2),
    a = Math.max(1, r.height - ht * 2);
  return Math.max(_t, Math.min(i / Math.max(t.width, 1), a / Math.max(t.height, 1)));
}
function Q(e) {
  let t = vt(e.viewport),
    n = { x: t.x, y: t.y },
    r = { width: e.frame.width + t.x * 2, height: e.frame.height + t.y * 2 },
    i = Ve(e.camera, n.x, n.y),
    a = Z(e.viewport, e.frame, e.viewportInsets);
  return {
    fitScale: a,
...
function $(e) {
  let t = Z(e.viewport, e.frame, e.viewportInsets),
    n = bt(e.zoomFactor ?? 1, t),
    r = Q({
      viewport: e.viewport,
      frame: e.frame,
    ...
    i = Y(e.viewport, e.viewportInsets),
    a = r.slideOrigin.x + e.frame.width / 2,
    o = r.slideOrigin.y + e.frame.height / 2;
  return yt(
    { k: t * n, x: i.left + i.width / 2 - a * t * n, y: i.top + i.height / 2 - o * t * n },
    e.viewport,
    r.worldSize,
    e.viewportInsets,
  );
...
function xt(e) {
  ...
  let t = Y(e.previousViewport, e.viewportInsets),
    n = Y(e.nextViewport, e.viewportInsets),
    r = Q({
...
function St(e) {
  ...
  return yt(e.camera, e.viewport, t.worldSize, e.viewportInsets);
}
function Ct(e) {
  let t = { ...e.camera, k: X(e.camera.k) },
    n = Q({ viewport: e.viewport, frame: e.frame, camera: t, viewportInsets: e.viewportInsets });
  return yt(t, e.viewport, n.worldSize, e.viewportInsets);
}
function wt(e) {
  let t = Z(e.viewport, e.frame, e.viewportInsets);
  return bt(e.camera.k / Math.max(t, 2 ** -52), t);
}
function Tt(e) {
  let t = Q({
      viewport: e.viewport,
    ...
    n = ke(e.camera, e.viewportX, e.viewportY);
  return { x: n.x - t.slideOrigin.x, y: n.y - t.slideOrigin.y };
}
var Et = (0, F.createContext)(null);
function Dt({ controller: e, children: t }) {
  return (0, L.jsx)(Et.Provider, { value: e, children: t });
}
function Ot(e, t) {
  return (
...
function Nt(e, t) {
  let n = (0, F.useRef)(e.getSnapshot()),
    r = (0, F.useCallback)(() => {
      let r = e.getSnapshot(),
        i = n.current;
      return t(i, r) ? i : ((n.current = r), r);
    }, [t, e]);
  return (0, F.useSyncExternalStore)((t) => e.subscribe(t), r, r);
}
function Pt(e) {
  return Lt(e, `shell`);
}
...
function Vt({ notesHeight: e, minHeight: t = 80, setNotesHeight: n }) {
  ...
  return (0, L.jsx)(`div`, {
    ...
    children: (0, L.jsx)(`div`, { className: `h-[3px] w-full rounded bg-gray-300` }),
  });
}
function Ht({
  threads: e,
  ...
  let [f, p] = (0, F.useState)(null);
  return (
    (0, F.useEffect)(() => {
      f && (e.some((e) => e.threadId === f) || p(null));
    }, [f, e]),
    (0, L.jsx)(L.Fragment, {
      children: (0, F.useMemo)(
        () =>
          t
            ? e.map((e) => ({
                thread: e,
        ...
        let ee = f === e.threadId,
          ...
          h = e.target.kind === `slide` ? e.slideLabel : (e.target.elementName ?? e.slideLabel);
        return (0, L.jsx)(
          k,
          {
            open: ee,
            ...
            trigger: (0, L.jsx)(`button`, {
              ...
              children: (0, L.jsx)(o, { className: `size-4` }),
            }),
            content: (0, L.jsx)(Ne, {
...
function Ut(e) {
  return { left: e.left, top: e.top, width: e.width, height: e.height, rotation: e.rotation };
}
function Wt(e) {
  return { x: e.x, y: e.y };
}
...
function qt(e) {
  ...
  let a = r == null ? null : (e.snapshot.inspector.slideElements.find((e) => e.id === r) ?? null),
    o =
      a == null
        ? null
    ...
    ...(e.anchorPoint == null
      ...
      : {
          ...
          primaryElementOffset:
            i == null ? null : { x: e.anchorPoint.x - i.left, y: e.anchorPoint.y - i.top },
        }),
  };
}
function Jt(e) {
...
function $t(e, t) {
  let n = e.type === `presentation-region` ? e.anchorPoint : (e.anchorPoint ?? null);
  return n
    ? t
      ? { left: t.left + n.x * t.scale, top: t.top + n.y * t.scale, width: 0, height: 0 }
...
function en(e, t, n = 1) {
  ...
  for (let n = 0; n < e.length; n += 1) {
    ...
    if (!a) continue;
    let o = a.frame;
    if (!o || (!cn(o, t) && !un(a, t, i))) continue;
    let s = a.zIndex;
    (!r || s > r.z || (s === r.z && n > r.order)) && (r = { id: a.id, z: s, order: n });
  }
  return r?.id ?? null;
}
function tn(e, t) {
  ...
  for (let r = 0; r < e.length; r += 1) {
    let i = e[r];
    if (!i || !cn(i.frame, t)) continue;
    let a = i.zIndex;
    (!n || a > n.z || (a === n.z && r > n.order)) && (n = { target: i, z: a, order: r });
  }
...
function an(e, t) {
  return e
    .filter((e) => ln(t, e.frame))
    .sort((t, n) => (t.zIndex === n.zIndex ? e.indexOf(t) - e.indexOf(n) : t.zIndex - n.zIndex))
    .map((e) => e.id);
}
function on(e, t, n = 1) {
  return e ? j(e, t, n) : null;
}
function sn(e, t, n = 1) {
  return e ? P(e, t, n) : !1;
}
...
var fn = {
  ...
  mn = 3,
  hn = 6,
  gn = { left: 0, top: 0, right: 0, bottom: 0 };
function _n({
  controller: e,
  runtime: t,
  snapshot: n,
  ...
  let re = Ft(e),
    ...
    E = (0, F.useRef)(null),
    _e = (0, F.useRef)(null),
    [Ce, we] = (0, F.useState)(0),
    [Oe, ke] = (0, F.useState)(!1),
    D = te && m?.annotation != null && m.annotation.enabled !== !1,
    O = h && m?.drawing != null && m.drawing.enabled !== !1,
    [k, A] = (0, F.useState)(null),
    [je, j] = (0, F.useState)(null),
    Ne = (0, F.useRef)(k);
  Ne.current = k;
  let Pe = (0, F.useRef)(null),
    M = (0, F.useRef)(!1),
    [Fe, Le] = (0, F.useState)(!1),
    N = (0, F.useRef)(null),
    [Re, P] = (0, F.useState)(null),
    [ze, Ve] = (0, F.useState)(null),
    He = (0, F.useRef)(null);
  He.current = ze;
  let [I, We] = (0, F.useState)([]),
    R = (0, F.useRef)([]);
  R.current = I;
  let Ge = (0, F.useRef)(null),
    ...
    B = (0, F.useCallback)(
      (e) => {
        (z(e), m?.annotation?.onDismiss?.(e));
      },
      [z, m?.annotation],
    ),
    Ye = (0, F.useCallback)((e) => {
      Ve((t) => {
        let n = typeof e == `function` ? e(t) : e;
        return ((He.current = n), n);
      });
    }, []),
    V = (0, F.useSyncExternalStore)(
      (e) => t.subscribeToCameraChanges(e),
      () => t.getCamera(),
      () => t.getCamera(),
    ),
    H = (0, F.useSyncExternalStore)(
      (e) => t.subscribeToLayoutChanges(e),
      () => t.getLayoutSnapshot(),
      () => t.getLayoutSnapshot(),
    ),
    U = H.viewportInsets,
    W = Cn(H.width, H.height, V, _.selectedSlideFrame, U) ?? _.slideRect,
    G = W === _.slideRect ? _ : { ..._, slideRect: W },
    K = _.slideIds[_.selectedSlideIdx] ?? `slide-${_.selectedSlideIdx}`,
    Xe = _.slideLabels[_.selectedSlideIdx] ?? `Slide ${_.selectedSlideIdx + 1}`,
    Ze = (0, F.useMemo)(() => wn(G), [G]),
    q = (0, F.useMemo)(() => qt({ snapshot: _ }), [_]),
    Qe = (0, F.useMemo)(() => {
      let e = G.slideRect;
      return e ? { left: e.left, top: e.top, width: e.width, height: e.height } : null;
    }, [G.slideRect]),
    $e = (0, F.useMemo)(
      () => (k?.target ? Qt(k.target, G.slideRect) : null),
      [k?.target, G.slideRect],
    ),
    J = (0, F.useMemo)(
      () => (k?.target ? $t(k.target, G.slideRect) : null),
      [k?.target, G.slideRect],
    ),
    et = $e ?? J,
    tt = (0, F.useMemo)(() => (!D || !Re ? null : rn(Re.start, Re.current)), [D, Re]),
    nt = (0, F.useMemo)(() => {
      if (!tt || !Re) return null;
      let e = Jt({ snapshot: _, frame: tt, anchorPoint: Re.current });
      return e ? Qt(e, G.slideRect) : null;
    }, [Re, tt, _, G.slideRect]),
    rt = (0, F.useMemo)(
      () =>
        tt
          ? an(_.selectedSlideElementTargets, tt).flatMap((e) => {
          ...
          : [],
      [tt, _.selectedSlideElementTargets],
    ),
    it = (0, F.useMemo)(
      () => (k?.target.type === `presentation-region` ? k.target.containedElements : []),
      [k],
    ),
    at = (0, F.useMemo)(
      () =>
        Fe && _.hoveredElementId
          ? (_.selectedSlideElementTargets.find((e) => e.id === _.hoveredElementId) ?? null)
          : null,
      [Fe, _.hoveredElementId, _.selectedSlideElementTargets],
    ),
    ot = (0, F.useMemo)(
      () =>
        nt ||
        ...
        (!D || !l
          ...
          : at
            ...
            : null),
      [$e, D, at, l, nt, K, Xe, _.selectedSlideIdx, G.slideRect],
    ),
    {
      annotations: st,
      addPendingAnnotation: ct,
      updatePendingAnnotation: lt,
      dismissAnnotation: ut,
    } = ue(m?.annotation?.handleRef, { onDismissAnnotation: B, onDismissAllAnnotations: Je }),
    dt = (0, F.useMemo)(() => st.filter((e) => e.target.slideId === K), [K, st]),
    ft = (0, F.useMemo)(
      () => dt.map((e) => ({ annotation: e, bounds: Qt(e.target, G.slideRect) })),
      [dt, G.slideRect],
    ),
    pt = (0, F.useMemo)(
      () =>
        je == null || k?.mode === `edit`
          ? null
          : (ft.find(({ annotation: e }) => e.annotationId === je) ?? null),
      [k?.mode, je, ft],
    ),
    mt = (0, F.useMemo)(() => (nt ? rt : it), [it, rt, nt]),
    { drawings: ht, addPendingDrawing: gt } = de(m?.drawing?.handleRef),
    _t = (0, F.useMemo)(() => ht.filter((e) => e.target.slideId === K), [K, ht]),
    Y = (0, F.useMemo)(
      () =>
        new ae(
          {
  ...
  ((0, F.useEffect)(
    ...
    (0, F.useEffect)(() => {
      ...
      let n =
        v.current && oe.current
          ? e.attachViewport({ host: v.current, canvas: oe.current, overlayCanvas: se.current })
          : void 0;
      return (
        Y?.attachContainer(v.current),
        t.start(),
        () => {
          (n?.(), t.dispose(), Y?.dispose());
        }
      );
    }, [e, t, Y]),
    (0, F.useEffect)(
    ...
    (0, F.useEffect)(() => {
      (t.setViewportInsets(c), typeof e.setViewportInsets == `function` && e.setViewportInsets(c));
    }, [e, t, c]),
    (0, F.useEffect)(() => {
      Ze || ke(!1);
    }, [Ze]),
    (0, F.useEffect)(() => {
      ...
      (_.selectedElementIds.length !== 1 ||
        ...
        (x.current = null);
    }, [_.primarySelectedElementId, _.selectedElementIds, _.textEditState, _.textLayoutBlocks]),
    (0, F.useEffect)(() => {
      _.selectedSlideFrame && t.hasInitializedCamera() && e.setViewportCamera(V);
    }, [V, e, t, _.selectedSlideFrame]),
    (0, F.useEffect)(() => {
      let e = v.current;
      !_.selectedSlideFrame ||
        !e ||
        Y.updateState({ state: o ? _.textEditState : null, blocks: _.textLayoutBlocks });
    }, [o, V, _.selectedSlideFrame, _.textEditState, _.textLayoutBlocks, Y]),
    (0, F.useEffect)(() => {
    ...
    (0, F.useEffect)(() => {
      ...
      let n = null,
        ...
        i = () => {
          n ??= window.requestAnimationFrame(() => {
            ((n = null), e.setStageBackgroundColor(vn(t, s)));
          });
        };
      if ((i(), typeof MutationObserver < `u`)) {
        let e = (e) => {
          ...
          (t.observe(e, { attributes: !0, attributeFilter: [`class`, `data-theme`, `style`] }),
            r.push(t));
        };
        (e(t),
      ...
      return () => {
        (n != null && window.cancelAnimationFrame(n), r.forEach((e) => e.disconnect()));
      };
    }, [e, s]),
    (0, F.useEffect)(() => {
      o ||
  ...
  let vt = (0, F.useCallback)(() => {
      try {
        v.current?.focus({ preventScroll: !0 });
      } catch {}
    }, []),
    yt = (0, F.useCallback)(() => {
      (Ke.current?.(), (Ke.current = null), Ye(null));
    }, [Ye]),
    X = (0, F.useCallback)(() => {
      ((Ge.current = null), (R.current = []), We([]));
    }, []),
    Z = (0, F.useCallback)(() => {
      ((M.current = !1), A(null), P(null), vt());
    }, [vt]),
    Q = (0, F.useCallback)(() => {
      let e = Ne.current;
      return e?.mode === `create` && e.body.trim().length > 0
        ? M.current
          ? (Z(), !0)
          : ((M.current = !0), le(Pe.current), !1)
        : (Z(), !0);
    }, [Z]),
    $ = (0, F.useCallback)(
      (e) => {
        let t = G.slideRect;
        return t ? { x: t.left + e.x * t.scale, y: t.top + e.y * t.scale } : { x: e.x, y: e.y };
      },
      [G.slideRect],
    ),
    xt = (0, F.useCallback)(
      (e) => {
        e == null ||
          ...
          !O ||
          !d ||
          ((Ge.current = K), (R.current = [...R.current, e]), We(R.current));
      },
      [K, O, d],
    ),
    St = (0, F.useCallback)(
      (e) => {
        ...
        let t = Ue(e),
          n = Ue(e.map((e) => ({ ...e, points: e.points.map($) }))),
          r = v.current,
          i = oe.current;
        if (!t || !n || !r || !i || !G.slideRect) return;
        let a = { width: r.clientWidth, height: r.clientHeight },
          ...
          l = Yt({
            ...
            frame: c,
            viewportBounds: s,
            containedElements: an(_.selectedSlideElementTargets, c).flatMap((e) => {
              let t = _.selectedSlideElementTargets.find((t) => t.id === e);
              return t
                ? [
                    {
        ...
        let u = ve(`drawing`),
          d = Zt(l);
        gt({ drawingId: u, artifactKind: `presentation`, label: d, target: l, strokes: e });
        ...
        he({
          ...
          .catch((e) => {
            console.error(`Failed to capture presentation drawing screenshot`, e);
          });
      },
      [gt, $, m?.drawing, _, G.slideRect],
    ),
    Ct = (e) => {
      ((M.current = !1),
        j(e.annotationId),
        A({ mode: `edit`, annotationId: e.annotationId, target: e.target, body: e.body }));
    },
    wt = (e = `saved`, t = `button`) => {
      if (!k?.target) return;
      let n = k.body.trim();
    ...
    Tt = () => {
      k?.mode === `edit` && (ut(k.annotationId), j((e) => (e === k.annotationId ? null : e)), Z());
    };
  ((0, F.useEffect)(() => {
    (D || (k?.mode !== `edit` && A(null)), (!D || !l) && (P(null), (N.current = null)));
  }, [D, k?.mode, l]),
    (0, F.useEffect)(() => {
      if (O && d) {
        (A(null), P(null), (N.current = null), Le(!1), e.setHoveredElementId(null));
        return;
      }
      let t = p !== qe.current;
      (yt(), R.current.length > 0 && !t && X());
    }, [yt, X, e, p, O, d]),
    (0, F.useEffect)(() => {
      if (p === qe.current) return;
      qe.current = p;
      let e = R.current;
      if (e.length === 0) {
        X();
    ...
    (0, F.useEffect)(() => {
      if (!D || !l) {
        (Le(!1), e.setHoveredElementId(null));
        return;
      }
      (Le(!1), e.setHoveredElementId(null));
    }, [D, l, e]),
    (0, F.useEffect)(() => {
      k && k.target.slideId !== K && (j(null), P(null), (N.current = null), A(null));
    }, [k, K]),
    (0, F.useEffect)(
      () => () => {
        yt();
    ...
    (0, F.useEffect)(() => {
      Ge.current == null || Ge.current === K || X();
    }, [X, K]),
    (0, F.useEffect)(() => {
      let e = v.current,
        t = ce.current,
        n = O && d ? `crosshair` : D && l && !k ? Ee : ``;
      return (
        e && (e.style.cursor = n),
        t && (t.style.cursor = n),
        () => {
    ...
    (0, F.useEffect)(() => {
      ...
      let o = `${t}px`,
        s = `${n}px`;
      (e.style.width !== o && (e.style.width = o), e.style.height !== s && (e.style.height = s));
      ...
      c &&
        ...
        G.slideRect &&
          _.selectedSlideFrame &&
          (c.save(),
          c.translate(G.slideRect.left, G.slideRect.top),
          c.scale(G.slideRect.scale, G.slideRect.scale),
          Y?.drawOverlay(c),
          c.restore()));
    }, [
      H.height,
  ...
  let Et = (t) => {
      ((_e.current = t ? { x: Math.round(t.x), y: Math.round(t.y) } : null),
    ...
    Dt = (t) => {
      (ke(!1), v.current?.focus());
      let n = xn(t, v.current, V, _, U);
      if ((Et(n), O && d)) {
        if (!n) return;
        (Tn(t, y),
          (Ke.current = () => {
          ...
          Ye({ color: fe, strokeWidth: 3, points: [n] }),
          t.preventDefault(),
          t.stopPropagation());
        return;
      }
      ...
      if (D && l) {
        let r = Ne.current,
          i = r?.mode === `create` ? (r.body.trim().length === 0 ? `close` : `keep`) : `replace`;
        if ((r != null && i === `replace` && A(null), !n)) {
          (r != null && i !== `replace` && Q(), (N.current = null), P(null));
          return;
        }
        let a = en(_.selectedSlideElementTargets, n, V.k);
        e.setHoveredElementId(a);
        let o = a == null ? null : (_.selectedSlideElementTargets.find((e) => e.id === a) ?? null);
        ((N.current = {
      ...
      if (!o) {
        ...
        let i = en(_.selectedSlideElementTargets, n, V.k);
      ...
      let r = Y.isActive(),
        i =
          ...
          _.selectedElementIds.length === 1 &&
          _.primarySelectedElementId &&
          x.current === _.primarySelectedElementId
            ? _.primarySelectedElementId
            : void 0;
      if ((r || i) && Y.tryPointerDown(n, { shiftKey: t.shiftKey, restrictToBlockId: i })) {
        (t.preventDefault(),
          (b.current = `text`),
          (S.current = null),
          (C.current = null),
      ...
      r && (Y.clear(), (x.current = null));
      let a = _.primarySelectedElementId
          ? _.selectedSlideElementTargets.find((e) => e.id === _.primarySelectedElementId)
          : null,
        s = _.selectedElementIds.length === 1 ? (a?.frame ?? null) : null,
        c = _.selectedElementIds.length === 1 && a ? nn([a], n, V.k) : null,
        u = c ? null : on(s, n, V.k),
        f = !c && !u && !!a?.canRotate && sn(s, n, V.k),
        p = c
          ? c.endpoint === `from`
            ? `connector-from`
            : `connector-to`
        ...
        m =
          c?.elementId ??
          (p === `move` ? en(_.selectedSlideElementTargets, n, V.k) : _.primarySelectedElementId);
      if (!m) {
        if (((S.current = null), (C.current = null), (w.current = !1), r)) return;
        (Tn(t, y),
          (b.current = `marquee`),
          (x.current = null),
    ...
    Ot = (t) => {
      ...
      if (D && l) {
        ...
        if (r != null && n) {
          Le(!0);
          let e = Math.hypot(n.x - r.start.x, n.y - r.start.y) >= hn;
          (e && Ne.current && ((M.current = !1), A(null)),
        ...
        Le(!0);
        let i = en(_.selectedSlideElementTargets, n, V.k);
        (e.setHoveredElementId(i), (t.currentTarget.style.cursor = Ne.current ? `` : Ee));
        return;
      }
      if (b.current === `text`) {
        n && Y.pointerMove(n);
      ...
      if (b.current === `element` && n) {
        (C.current && Math.hypot(n.x - C.current.x, n.y - C.current.y) > mn && (w.current = !0),
      ...
      if (!o) {
        if (n && tn(_.hyperlinkTargets, n)) {
          (e.setHoveredElementId(null), (t.currentTarget.style.cursor = `pointer`));
          return;
        }
        let r = n ? en(_.selectedSlideElementTargets, n, V.k) : null;
      ...
      let r = _.primarySelectedElementId
        ...
        a = _.selectedElementIds.length === 1 && r ? nn([r], n, V.k) : null;
      if (a) {
        (e.setHoveredElementId(a.elementId), (t.currentTarget.style.cursor = `crosshair`));
        return;
      }
      let s = on(i, n, V.k);
      if (s) {
        (e.setHoveredElementId(_.primarySelectedElementId),
          (t.currentTarget.style.cursor = Ae(s) ?? ``));
        return;
      }
      if (i && r?.canRotate && sn(i, n, V.k)) {
        (e.setHoveredElementId(_.primarySelectedElementId), (t.currentTarget.style.cursor = Ie()));
        return;
      }
      if (Y.isActive() && Y.hasTextCursorAtPoint(n)) {
        (e.setHoveredElementId(null), (t.currentTarget.style.cursor = `text`));
        return;
      }
      let c = en(_.selectedSlideElementTargets, n, V.k);
      (e.setHoveredElementId(c), (t.currentTarget.style.cursor = c ? `move` : ``));
    },
    kt = (t, n) => {
      if (O && d) {
        if (y.current != null && y.current !== t.pointerId) return;
        Et(xn(t, v.current, V, _, U));
        let e = He.current;
        (En(t, y), (Ke.current = null), Ye(null), n && xt(e));
        return;
      }
      if (D && l) {
        if (y.current != null && y.current !== t.pointerId) return;
        (Et(xn(t, v.current, V, _, U)), En(t, y));
        let r = N.current;
        if (((N.current = null), P(null), !n || !r)) return;
        let i = xn(t, v.current, V, _, U);
        if (!i) return;
        let a = rn(r.start, i),
          o = Math.hypot(i.x - r.start.x, i.y - r.start.y) < hn;
        if (o) {
          if (r.clickedElementTarget) {
            ...
            (e.setHoveredElementId(null),
              Le(!1),
              m?.annotation?.onStart?.(`annotation_mode_pointer`, { annotationMode: l }),
              (M.current = !1),
      ...
      let r = b.current;
      if (!r) return;
      if ((Et(xn(t, v.current, V, _, U)), En(t, y), r === `text`)) {
        ((b.current = null), Y.pointerUp());
        return;
      }
      if (r === `marquee`) {
        ((b.current = null),
      ...
      b.current = null;
      let i = S.current,
        a = !!n && !w.current && !!i && _.textLayoutBlocks.some((e) => e.id === i);
      ((S.current = null),
        (C.current = null),
        (w.current = !1),
    ...
    At = (t) => {
      ...
      if (!o) return;
      let n = Sn(t.clientX, t.clientY, v.current, V, _, U);
      n &&
        (e.endSelectionMarquee({ commit: !1 }),
        e.endElementInteraction({ commit: !1 }),
        Y.selectWordAtPoint(n) && t.preventDefault());
    },
    jt = (e) =>
      !e.metaKey && !e.ctrlKey
        ? !1
        : e.key === `0`
          ...
          : e.key === `=` || e.key === `+`
            ? (t.zoomTo(bt(_.zoom + 0.1, _.fitScale ?? 1), { settled: !0 }), e.preventDefault(), !0)
            : e.key === `-`
              ? (t.zoomTo(bt(_.zoom - 0.1, _.fitScale ?? 1), { settled: !0 }),
                e.preventDefault(),
                !0)
              : !1,
    Mt = (t) => {
      if (
        ...
        if (
          ...
          r !== _.selectedSlideIdx && (e.setSelectedSlideIdx(r), t.preventDefault());
          return;
        }
        if (!o) {
          if (t.key === `Escape` && k) {
        ...
        if (l) return (jt(t), void 0);
        if (Y.isActive()) {
          t.key === `Escape` && (Y.clear(), t.preventDefault());
          return;
        }
        if (t.key === `/` && !t.metaKey && !t.ctrlKey && !t.altKey) {
          let e = !!Ze;
          (ke(e), e && t.preventDefault());
          return;
        }
        if (t.key === `Escape` && Oe) {
          (ke(!1), t.preventDefault());
          return;
        }
        if (t.key === `Enter` && _.selectedElementIds.length === 1 && _.primarySelectedElementId) {
          Y.activateBlockEnd(_.primarySelectedElementId) && t.preventDefault();
          return;
        }
    ...
    children: (0, L.jsxs)(`div`, {
      ...
      children: [
        (0, L.jsx)(`canvas`, {
          ...
          className: r(`absolute inset-0 h-full w-full select-none`),
        }),
        (0, L.jsx)(`canvas`, {
          ref: se,
        ...
        (0, L.jsx)(`canvas`, {
          ...
          onPointerUp: (e) => kt(e, !0),
          onPointerCancel: (e) => kt(e, !1),
          onDoubleClick: At,
        ...
        _t.length > 0
          ? (0, L.jsx)(be, {
              ...
              strokes: _t.flatMap((e) => e.strokes),
              projectPoint: $,
              clipBounds: Qe,
            })
          : null,
            ...
            `div`,
            {
              children: [
                ...
                (0, L.jsx)(De, {
                  ...
                  position: n,
                  selected: k?.mode === `edit` && k.annotationId === e.annotationId,
                  title: e.label,
                  onMouseEnter: () => {
                    j(e.annotationId);
                  },
        ...
        pt
          ? (0, L.jsx)(ye, {
              body: pt.annotation.body,
              markerPosition: pe(pt.bounds),
...
function vn(e, t) {
  let n = window.getComputedStyle(e),
    r = t === `codex` ? yn(n.getPropertyValue(`--color-background-surface`)) : null;
  if (r) return r;
  let i = n.backgroundColor.trim();
  return i.length > 0 && i !== `transparent` && i !== `rgba(0, 0, 0, 0)` ? i : we(t);
}
function yn(e) {
  let t = e.trim();
  return t.length === 0 || t === `transparent` || t === `rgba(0, 0, 0, 0)` || t.startsWith(`var(`)
    ? null
    : t;
}
function bn(e) {
...
function xn(e, t, n, r, i) {
  return Sn(e.clientX, e.clientY, t, n, r, i);
}
...
function Cn(e, t, n, r, i) {
  return !r || e <= 0 || t <= 0
    ? null
    : Q({ viewport: { width: e, height: t }, frame: r, camera: n, viewportInsets: i }).slideRect;
}
function wn(e) {
  if (e.selectedElementIds.length !== 1 || !e.primarySelectedElementId) return null;
  let t = e.inspector.selectedElement,
    n =
      t?.id === e.primarySelectedElementId
        ? t.frame
        : e.selectedSlideElementTargets.find((t) => t.id === e.primarySelectedElementId)?.frame;
  if (!n) return null;
  let r = e.slideRect;
  return r
    ? {
...
var Dn = 1e-4,
  On = class {
    ...
    #u = { selectedSlideIdx: 0, selectedSlideFrame: null, zoom: 1, camera: null };
    #d = null;
    #f = new Set();
    #p = { width: 0, height: 0, viewportInsets: { left: 0, top: 0, right: 0, bottom: 0 } };
    constructor() {
      this.#e = new Oe({
        enabled: !0,
        ...
        minZoom: 0.01,
        maxZoom: 64,
        getViewportSize: () => ({ width: this.#c.width, height: this.#c.height }),
        getWorldSize: () => {
          let e = this.#v();
          return e
            ? Q({
        ...
        e &&
          (typeof ResizeObserver < `u` &&
            ((this.#r = new ResizeObserver((t) => {
              let n = t[0];
              this.scheduleLayoutSync(n ? Ge(e, n) : null);
            })),
            this.#r.observe(e)),
    ...
    setViewportInsets(e) {
      let t = this.#l;
      (t.left === e.left && t.top === e.top && t.right === e.right && t.bottom === e.bottom) ||
    ...
    #g() {
      ...
      ((this.#a = null),
        ...
        this.#y(this.#u, this.#u, {
          viewportChanged: t.width !== this.#c.width || t.height !== this.#c.height,
          previousViewport: { width: t.width, height: t.height },
        }));
    }
    #_() {
      let e = this.#p,
        t = { width: this.#c.width, height: this.#c.height, viewportInsets: { ...this.#l } };
      if (
        !(
          e.width === t.width &&
          e.height === t.height &&
    ...
    #y(e, t, n) {
      ...
      if (i && this.#s) {
        this.#e.setCamera(
          Math.abs(t.zoom - 1) < Dn
            ? $({ viewport: a, frame: r, zoomFactor: t.zoom, viewportInsets: this.#l })
            : xt({
      ...
      if (t.camera) {
        let n = $({ viewport: a, frame: r, zoomFactor: t.zoom, viewportInsets: this.#l }).k,
          i = wt({ camera: t.camera, viewport: a, frame: r, viewportInsets: this.#l });
...
var Vn = { width: `94px` },
  Hn = { width: `18px`, minWidth: `18px`, fontSize: `11px`, lineHeight: `14px` },
  Un = { borderRadius: `8px`, boxShadow: `0px 4px 16px 0px rgba(0, 0, 0, 0.05)` },
  Wn = `var(--color-token-interactive-label-accent-default, rgba(2, 133, 255, 1))`,
  Gn = `var(--color-token-interactive-bg-accent-muted-context, rgba(2, 133, 255, 0.10))`,
  Kn = [`0px 2px 8px 0px rgba(2, 133, 255, 0.16)`, `0px 4px 16px 0px rgba(0, 0, 0, 0.05)`].join(
    `, `,
  ),
  qn = `var(--color-token-border-default, var(--color-border, rgba(13, 13, 13, 0.10)))`,
  Jn = { ...Un, borderColor: qn },
  Yn = {
    borderRadius: `16px`,
...
function Xn(e, t) {
  return e <= 0 ? 0 : e + jn + (t === `codex` ? 0 : Mn);
}
function Zn(e, t, n) {
  let r = [...e],
    [i] = r.splice(t, 1);
...
function Qn({
  ...
  reviewTools: _,
  onHyperlinkClick: ie,
  annotationsEnabled: ae = !0,
  drawingAnnotationsEnabled: x = !0,
  commentThreadsEnabled: le = !0,
}) {
  let T = ne(
    e,
    (0, F.useCallback)(() => pt(), []),
  ...
  if (!T) return null;
  let E = Pt(T),
    { panels: ue, stageOverlays: de } = (0, F.useMemo)(() => mt(t), [t]),
    fe = ae && _?.annotation?.enabled !== !1,
    [pe, me] = (0, F.useState)(!1),
    he = x && _?.drawing?.enabled !== !1,
    [ge, ve] = (0, F.useState)(!1),
    [ye, be] = (0, F.useState)(0),
    xe = (0, F.useMemo)(() => new On(), []);
  ((0, F.useEffect)(() => {
    fe || me(!1);
  }, [fe]),
    (0, F.useEffect)(() => {
    ...
    (0, F.useEffect)(() => {
      !pe || !fe || (T.clearElementSelection(), T.setHoveredElementId(null));
    }, [fe, pe, T]),
    (0, F.useEffect)(() => {
      !ge || !he || (T.clearElementSelection(), T.setHoveredElementId(null));
    }, [T, he, ge]),
    (0, F.useEffect)(() => {
      if (!pe) return;
      let e = (e) => {
  ...
  let [Se, we] = (0, F.useState)(() =>
      Object.fromEntries(ue.map((e) => [e.id, e.defaultOpen ?? !1])),
    ),
    [Te, Ee] = (0, F.useState)(kn),
    [De, Oe] = (0, F.useState)(() => Object.fromEntries(E.slideIds.map((e) => [e, null]))),
    [ke, D] = (0, F.useState)(() => Object.fromEntries(E.slideIds.map((e) => [e, null]))),
    [O, Ae] = (0, F.useState)(() => E.slideIds),
    [k, A] = (0, F.useState)(null),
    [Me, j] = (0, F.useState)(!1),
    [Ne, Pe] = (0, F.useState)(!1),
    [M, Fe] = (0, F.useState)(!1),
    [Ie, Le] = (0, F.useState)(!1),
    [N, P] = (0, F.useState)(() =>
    ...
    Ue = (0, F.useRef)([]),
    I = (0, F.useRef)(null),
    R = (0, F.useRef)(new Set()),
    Ge = (0, F.useRef)(De),
    Ke = (0, F.useRef)(ke),
    qe = (0, F.useRef)(O),
    z = ce(se(y, { activationConstraint: { distance: 4 } })),
    Je = (0, F.useMemo)(() => [C], []),
    B = n === `left`,
    Ye = n === `bottom`,
    V = h === `codex`,
    ...
    K = !re && N && Te > 0,
    Xe = (0, F.useMemo)(
      () => ({ left: G ? An : 0, top: 0, right: 0, bottom: K ? Xn(Te, h) : 0 }),
      [Te, K, G, h],
    );
  ((0, F.useEffect)(() => {
    ...
    Ce(() => {
      ...
      let t = null,
        n = (e) => {
          let t = e >= 749,
            n = H && e > 0 && e <= 688;
          (Pe((e) => (e === t ? e : t)), Fe((e) => e || !0), Le((e) => (e === n ? e : n)));
        };
      if (
        (n(e.clientWidth),
        typeof window < `u` &&
      ...
      let r = new ResizeObserver((t) => {
        let r = t[0];
        n(r?.contentRect.width && r.contentRect.width > 0 ? r.contentRect.width : e.clientWidth);
      });
      return (
        r.observe(e),
        () => {
  ...
  ((0, F.useEffect)(() => {
    ...
    (0, F.useEffect)(() => {
      (Ae(E.slideIds),
        Oe((e) => {
          let t = {};
          for (let n of E.slideIds) t[n] = e[n] ?? null;
          return t;
        }),
        D((e) => {
          let t = {};
  ...
  let q = (0, F.useMemo)(
      () => Object.fromEntries(E.slideIds.map((e, t) => [e, E.slideLabels[t] ?? `Slide ${t + 1}`])),
      [E.slideIds, E.slideLabels],
    ),
    Qe = (0, F.useMemo)(() => Object.fromEntries(E.slideIds.map((e, t) => [e, t])), [E.slideIds]),
    $e = E.slideIds[E.selectedSlideIdx] ?? null,
    J = E.fitScale ?? (E.slideRect && E.zoom > 0 ? E.slideRect.scale / E.zoom : null),
    et = J ? X(J) : null,
    tt = E.slideRect?.scale ?? X(J ? J * E.zoom : E.zoom),
    nt = et != null && Math.abs(E.zoom - 1) < Nn,
    rt = H && (!M || Ie),
    it = !rt,
    at = W && !rt,
    ot = (e) => {
    ...
    dt = (0, F.useCallback)((e, t, n) => {
      ((He.current[e] = t), t && I.current && n && I.current.observe(t));
    }, []),
    ft = (0, F.useCallback)(() => {}, []),
    ht = (0, F.useCallback)(() => {
      T.addSlide();
    ...
    gt = (0, F.useCallback)(
      async (e, t) => {
        if (e < 0 || e >= T.getSnapshot().slideCount) return;
        let n = T.getSnapshot().slideIds[e];
        if (!n) return;
        let r = t?.cacheKind === `stacked-page`,
          i = r ? Ke.current[n] : Ge.current[n],
        ...
        if (
          !(
            ...
            R.current.has(a) ||
            e < 0 ||
            e >= T.getSnapshot().slideCount
          )
        ) {
          R.current.add(a);
          try {
            await We();
            let t = await T.requestSlideThumbnail(e, r ? { cssMaxPx: Fn } : void 0);
            (r ? D : Oe)((e) => (e[n] === t ? e : { ...e, [n]: t }));
          } finally {
            R.current.delete(a);
          }
        }
  ...
  ((0, F.useEffect)(() => {
    let e = E.slideIds[E.selectedSlideIdx];
    (e && (R.current.delete(`rail:${e}`), R.current.delete(`stacked-page:${e}`)),
      gt(E.selectedSlideIdx, { force: !0 }),
      e &&
        Ke.current[e] != null &&
        gt(E.selectedSlideIdx, { cacheKind: `stacked-page`, force: !0 }));
  }, [gt, E.presentationVersion, E.selectedSlideIdx, E.slideIds]),
    (0, F.useEffect)(() => {
          ...
          (I.current = new IntersectionObserver(
            (e) => {
              for (let t of e) {
                ...
                let r =
                    t.target.getAttribute(`data-thumbnail-cache-kind`) === `stacked-page`
                      ? `stacked-page`
                      : `rail`,
                  i = r === `stacked-page`;
                (gt(n, { cacheKind: r, force: i }),
                  gt(n + 1, { cacheKind: r, force: i }),
                  I.current?.unobserve(t.target));
              }
            },
            { root: ze.current, rootMargin: `200px`, threshold: 0.05 },
          )));
        for (let e of [...He.current, ...Ue.current]) e && I.current.observe(e);
        return () => {
          I.current?.disconnect();
        };
      }
    }, [gt, E.presentationVersion, E.slideCount]));
  let _t = (0, F.useCallback)(
      (e) => {
        ...
        let n = E.selectedSlideIdx,
          r = E.slideIds.length - 1,
          i = t < 0 ? Math.max(0, n - 1) : Math.min(r, n + 1);
        if (i === n) return;
        T.setSelectedSlideIdx(i);
        let a = e.currentTarget.classList.contains(`popcorn-presentation-stacked-pages`)
          ? Ue.current[i]
          : He.current[i];
      ...
      [T, E.selectedSlideIdx, E.slideIds.length],
    ),
    Y = (0, F.useCallback)((e) => {
      A(typeof e.active.id == `string` ? e.active.id : null);
    }, []),
    vt = (0, F.useCallback)(() => {
      (Ae(E.slideIds), A(null));
    }, [E.slideIds]),
    yt = (0, F.useCallback)(
      (e) => {
        A(null);
        ...
        let r = qe.current,
          i = r.indexOf(t),
          a = r.indexOf(n);
        i < 0 || a < 0 || i === a || (Ae((e) => Zn(e, i, a)), T.moveSlide(i, a));
      },
      [T],
    ),
    bt = (0, F.useCallback)((e) => {
      let t = e.relatedTarget;
      (t instanceof Node && e.currentTarget.contains(t)) || j(!1);
    }, []),
    Z = (0, F.useCallback)((e) => {
      let t = e.relatedTarget;
      (t instanceof Node && e.currentTarget.parentElement?.contains(t)) || j(!1);
    }, []),
    Q = (0, F.useCallback)((e, t, n) => {
      ((Ue.current[e] = n), n && I.current && Ke.current[t] == null && I.current.observe(n));
    }, []),
    $ = (0, F.useCallback)(
      (e, t = `default`, n) => {
        let i = Rn(e, t);
          ...
          ? (0, L.jsxs)(S, {
              ...
              children: [
                (0, L.jsx)(w, {
                  ...
                  strategy: Re,
                  children: (0, L.jsxs)(`div`, {
                    className: r(`flex min-w-full justify-[safe_center]`, i),
                    children: [
                      O.map((r, i) => {
                        let a = De[r] ?? null;
                        return (0, L.jsx)(
                          ir,
                          {
                            slideId: r,
                            index: i,
                            snapshotIndex: Qe[r] ?? -1,
                            label: q[r] ?? `Slide ${i + 1}`,
                            thumbnail: a,
                            isSelected: r === $e,
                            canDelete: O.length > 1,
                            onSelectSlide: lt,
                            onDeleteSlide: ut,
                            renderSlideThumbnailOverlay: d,
      ...
      [k, ht, ut, O, Je, vt, yt, Y, ft, g, dt, d, $e, lt, z, Qe, q, De],
    );
  return (0, L.jsx)(`div`, {
    className: r(
    ...
    children: (0, L.jsxs)(Dt, {
      ...
      children: [
        (0, L.jsx)(p, {
          ...
          centeredContent: at
            ? (0, L.jsx)(v, {
                currentIndex: E.selectedSlideIdx,
                totalCount: E.slideCount,
                itemLabel: `slide`,
                onChangeIndex: (e) => T.setSelectedSlideIdx(e),
                testId: `popcorn-presentation-page-navigation`,
              })
            : null,
          actions: (0, L.jsxs)(`div`, {
            className: r(`flex items-center`, V ? `gap-1` : `gap-2`),
            children: [
              _?.annotation && fe
                ? (0, L.jsx)(je, {
                    active: pe,
                    onClick: () => {
                      let e = !pe;
                      (e && (_?.annotation?.onModeEnabled?.(), ve(!1)), me(e));
                    },
        ...
        (0, L.jsx)(`div`, {
          ...
          children: (0, L.jsxs)(`div`, {
            ...
            className: r(
              ...
              H && `popcorn-presentation-editor-shell--small-stacked`,
              Ye
                ? `flex-col`
                : B || U
                  ? `flex-row`
              ...
              rt
                ...
                : (0, L.jsxs)(`div`, {
                    className: r(
                      ...
                      U && `popcorn-presentation-main-panel--codex-responsive`,
                    ),
                    children: [
                      (0, L.jsx)(`div`, {
                        ...
                        children: (0, L.jsx)(_n, {
                          ...
                          viewportInsets: Xe,
                          annotationMode: pe,
                          onAnnotationModeChange: me,
                          drawingMode: ge,
                          onDrawingModeChange: ve,
                          drawingCommitToken: ye,
                          reviewTools: _,
                          onHyperlinkClick: ie,
                          annotationsEnabled: ae,
                          drawingAnnotationsEnabled: x,
                          commentThreadsEnabled: le,
                          annotationPortalContainerElement: ze.current,
                        }),
                      }),
                      re
                        ? null
...
function $n({ index: e, label: t, thumbnail: n, isSelected: r, onSelect: i, buttonRef: a }) {
  return (0, L.jsx)(`button`, {
    ...
    children: n
      ...
      : (0, L.jsx)(`div`, { className: `popcorn-presentation-stacked-page-placeholder` }),
  });
}
function er({
  controller: e,
  ...
  return (0, L.jsxs)(`div`, {
    ...
    style: i === `codex` ? { ...Be, left: `${a}px` } : { left: `${a}px` },
    ...
    children: [
      i === `codex`
        ...
        : (0, L.jsx)(`div`, {
            ...
            children: (0, L.jsx)(Vt, { notesHeight: t, setNotesHeight: n }),
          }),
      (0, L.jsx)(`div`, {
...
function tr({ controller: e, panels: t, panelControls: n, panelOpenState: r, isEditing: i }) {
  return !i || t.length === 0
    ? null
    : (0, L.jsx)(`div`, {
        ...
        children: t.map((t) =>
          (0, L.jsx)(
            nr,
            { controller: e, panel: t, panelControls: n, isPanelOpen: r[t.id] ?? !1 },
            t.id,
          ),
        ),
      });
}
function nr({ controller: e, panel: t, panelControls: n, isPanelOpen: i }) {
  ...
  return (t.isVisible?.({ controller: e, snapshot: a }) ?? !0)
    ? (0, L.jsx)(`div`, {
        ...
        className: r(
          ...
          i ? `pointer-events-auto translate-x-0` : `pointer-events-none translate-x-full`,
        ),
...
var rr = (0, F.memo)(function ({
    ...
    let ee = In(c, l),
      ...
      h = zn(l),
      g = Bn(l),
      ne = l === `floating` ? Vn : void 0,
      re = { ...(l === `floating` ? Hn : {}), ...(a ? { color: Wn } : {}) };
    return (0, L.jsxs)(`button`, {
      ...
      style: a ? { backgroundColor: Gn } : void 0,
      ...f,
      ...p,
      children: [
        (0, L.jsx)(`div`, {
          className: r(`text-token-text-primary`, g, te),
          style: re,
          children: t + 1,
        }),
        (0, L.jsxs)(`div`, {
          "data-testid": `${u}-${t}-surface`,
          className: r(`relative overflow-hidden border bg-white`, h, m ? `shadow-lg` : null),
          style: {
            ...Un,
            ...ne,
            borderColor: a ? Wn : qn,
            borderWidth: a ? `2px` : void 0,
            boxShadow: a ? Kn : Un.boxShadow,
          },
          children: [
            i
              ? (0, L.jsx)(`img`, {
              ...
              : (0, L.jsx)(`div`, {
                  className: r(h, `animate-pulse bg-gray-200`),
  ...
  ir = (0, F.memo)(function ({
    ...
    return (0, L.jsx)(E, {
      ...
      trigger: (0, L.jsx)(`div`, {
        ref: g,
        style: {
          transform: x.Translate.toString(ne),
  ...
  ar = (0, F.memo)(function ({
    ...
    let i = In(t, n),
      ...
      o = zn(n),
      c = Bn(n),
      l = n === `floating` ? Vn : void 0,
      u = n === `floating` ? Hn : void 0;
    return (0, L.jsxs)(`button`, {
      type: `button`,
      onClick: e,
      ...
      children: [
        (0, L.jsx)(`div`, {
          "aria-hidden": `true`,
          className: r(`text-token-text-primary invisible`, c, a),
          style: u,
          children: `00`,
        }),
        (0, L.jsx)(`div`, {
          ...
          children: (0, L.jsx)(`div`, {
            ...
            children: (0, L.jsx)(s, { className: `size-4` }),
          }),
        }),
      ],
    });
...
function or({
  ...
  enablePageNavigation: ae,
  artifactSearchEnabled: v = !1,
  commentThreadsEnabled: oe = !1,
  workerFactory: se,
}) {
  let ce = Le({ initialCrdtState: o, externalCrdtUpdates: t }),
    y = (0, F.useRef)(s),
    b = (0, F.useRef)(null),
    x = ne(
      void 0,
      () =>
        new ft({
          initialCrdtState: ce.initialCrdtState,
          initialSelectedSlideIdx: c,
          initialZoom: l,
          presentationProto: s ?? sr().toProto(),
          workerFactory: se,
        }),
    ),
    S = (0, F.useRef)(0),
    C = A({
      ...
      controller: x,
      externalCrdtUpdates: ce.externalCrdtUpdates,
      onCrdtUpdate: u,
    }),
    w = (0, F.useMemo)(() => lr(d), [d]),
    le = (0, F.useMemo)(() => ur(w), [w]);
  return (
    (0, F.useEffect)(() => {
      x && y.current !== s && ((y.current = s), x.replaceFromProto(s ?? sr().toProto()));
    }, [x, s]),
    (0, F.useEffect)(() => {
      if (!x || h == null) return;
      let e = () => {
        if (h.requestId === b.current) return !0;
        let e = null;
        if (h.slideId != null) {
          let t = x.getSnapshot().slideIds.indexOf(h.slideId);
          t >= 0 && (e = t);
        }
        return (
          ...
          e == null
            ? h.slideId == null
            : ((b.current = h.requestId),
              x.setSelectedSlideIdx(e),
              x.setSelectedElementId(h.objectId ?? null),
              !0)
        );
      };
      if (e()) return;
      ...
      if (x && f)
        return x.subscribeImageHydrationRequests((e) => {
          ...
          ((S.current = t),
            f(e)
              .then((e) => {
                if (!(S.current !== t || e.length === 0)) return x.hydrateImageAssets(e);
              })
              .catch(() => {}));
        });
    }, [x, f]),
    x
      ? (0, L.jsxs)(`section`, {
          className: r(`no-drag relative h-full min-h-0 bg-token-bg-primary`, e),
          style: N(m),
          ...
          children: [
            (0, L.jsx)(Qn, {
              ...
              headerRightContent:
                w.length > 0
                  ? (0, L.jsxs)(L.Fragment, { children: [(0, L.jsx)(cr, { count: w.length }), n] })
                  : n,
              renderHeaderZoomControl: a,
              zoomToFitLabel: i,
            ...
            (0, L.jsx)(Pe, { artifactLabel: `Presentation`, restoreState: C }),
          ],
        })
      : null
  );
...
function lr(e) {
  return e.flatMap((e) =>
    ...
    !e.elementId
      ? []
      : [{ requestId: e.requestId, slideId: e.slideId, elementId: e.elementId }],
  );
}
function ur(e) {
  let t = {};
...
export { or as PopcornElectronPresentationPanel };
