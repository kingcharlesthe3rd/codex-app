...
import { a as ee, o as te } from "./workbook-1.js";
import {
  $ as ne,
  A as h,
  C as re,
...
import { n as _e, t as ve } from "./PopcornPageNumberNavigation.js";
import {
  dn as ye,
  un as M,
...
function yr({
  ...
  let Ae = (0, X.useRef)(null),
    ...
    et = Qe ?? $e,
    nt = (0, X.useMemo)(() => (!E || !M ? null : ur(M.start, M.current)), [E, M]),
    H = (0, X.useMemo)(() => {
      if (!nt || !M) return null;
    ...
    } = Ne(p?.annotation?.handleRef, { onDismissAnnotation: He, onDismissAllAnnotations: I }),
    ht = (0, X.useMemo)(() => ut.filter((e) => e.target.slideId === B), [B, ut]),
    gt = (0, X.useMemo)(
    ...
    bt = (0, X.useMemo)(() => yt.filter((e) => e.target.slideId === B), [B, yt]),
    W = (0, X.useMemo)(
      () =>
        new pe(
          {
  ...
  ((0, X.useEffect)(
    ...
    (0, X.useEffect)(() => {
      ...
      let n =
        _.current && v.current
          ? e.attachViewport({ host: _.current, canvas: v.current, overlayCanvas: oe.current })
          : void 0;
      return (
    ...
    (0, X.useEffect)(() => {
      g.selectedSlideFrame && t.hasInitializedCamera() && e.setViewportCamera(L);
    }, [L, e, t, g.selectedSlideFrame]),
    (0, X.useEffect)(() => {
      let e = _.current;
      !g.selectedSlideFrame ||
        !e ||
        W.updateState({ state: a ? g.textEditState : null, blocks: g.textLayoutBlocks });
  ...
  let G = (0, X.useCallback)(() => {
    ...
    Dt = () => {
      O?.mode === `edit` && (mt(O.annotationId), A((e) => (e === O.annotationId ? null : e)), xt());
    };
  ((0, X.useEffect)(() => {
    (E || (O?.mode !== `edit` && k(null)), (!E || !c) && (N(null), (ye.current = null)));
  }, [E, O?.mode, c]),
    (0, X.useEffect)(() => {
      if (D && u) {
        (k(null), N(null), (ye.current = null), ve(!1), e.setHoveredElementId(null));
        return;
      }
      let t = f !== Pe.current;
    ...
    (0, X.useEffect)(() => {
      O && O.target.slideId !== B && (A(null), N(null), (ye.current = null), k(null));
    }, [O, B]),
    (0, X.useEffect)(
      () => () => {
        K();
  ...
  let Ot = (t) => {
    ...
    kt = (t) => {
      ...
      let o = g.primarySelectedElementId
        ...
        m =
          l?.elementId ??
          (p === `move` ? sr(g.selectedSlideElementTargets, n, L.k) : g.primarySelectedElementId);
      if (!m) {
    ...
    At = (t) => {
      ...
      if (i && r?.canRotate && pr(i, n, L.k)) {
        (e.setHoveredElementId(g.primarySelectedElementId), (t.currentTarget.style.cursor = Ve()));
        return;
      }
        ...
        if (o) {
          if (r.clickedElementTarget) {
            ...
            (e.setHoveredElementId(null),
              ve(!1),
              p?.annotation?.onStart?.(`annotation_mode_pointer`, { annotationMode: c }),
              (j.current = !1),
...
function br(e, t) {
  ...
  return i.length > 0 && i !== `transparent` && i !== `rgba(0, 0, 0, 0)` ? i : je(t);
}
function xr(e) {
  let t = e.trim();
...
function Kr({
  ...
  let [he, ge] = (0, Q.useState)(() =>
    ...
    [xe, Se] = (0, Q.useState)(() => Object.fromEntries(w.slideIds.map((e) => [e, null]))),
    ...
    Qe = !_ && Ie && j > 0,
    $e = (0, Q.useMemo)(
      () => ({ left: Ze ? Qr : 0, top: 0, right: 0, bottom: Qe ? Wr(j, g) : 0 }),
      [j, Qe, Ze, g],
    );
  ((0, Q.useEffect)(() => {
    ...
    N(() => {
      ...
      let t = null,
        n = (e) => {
          let t = e >= 749,
            n = V && e > 0 && e <= 688;
          (Ae((e) => (e === t ? e : t)), Me((e) => e || !0), Pe((e) => (e === n ? e : n)));
        };
      if (
        (n(e.clientWidth),
        typeof window < `u` &&
  ...
  let tt = (0, Q.useMemo)(
    ...
    nt = (0, Q.useMemo)(() => Object.fromEntries(w.slideIds.map((e, t) => [e, t])), [w.slideIds]),
    H = w.slideIds[w.selectedSlideIdx] ?? null,
    rt = w.fitScale ?? (w.slideRect && w.zoom > 0 ? w.slideRect.scale / w.zoom : null),
    it = rt ? rn(rt) : null,
  ...
  let U = (0, Q.useCallback)(
    ...
    G = (0, Q.useCallback)(
      (e) => {
        ...
        let r = We.current,
          i = r.indexOf(t),
          a = r.indexOf(n);
        i < 0 || a < 0 || i === a || (Ce((e) => Gr(e, i, a)), C.moveSlide(i, a));
      },
      [C],
    ),
    K = (0, Q.useCallback)((e) => {
    ...
    q = (0, Q.useCallback)((e) => {
      let t = e.relatedTarget;
      (t instanceof Node && e.currentTarget.parentElement?.contains(t)) || De(!1);
    }, []),
    xt = (0, Q.useCallback)((e, t, n) => {
      ((Ve.current[e] = n), n && I.current && L.current[t] == null && I.current.observe(n));
    }, []),
    J = (0, Q.useCallback)(
      (e, t = `default`, n) => {
        let r = Vr(e, t);
        ...
        return (0, $.jsxs)(`button`, {
          ...
          children: [
            ...
            (0, $.jsxs)(`div`, {
              ...
              className: m(`relative overflow-hidden border bg-white`, ne, p ? `shadow-lg` : null),
              style: {
                ...oi,
                ...re,
                borderColor: i ? si : ui,
...
function _i({
  ...
  return (
    ...
    S
      ? (0, Ci.jsxs)(`section`, {
          className: m(`no-drag relative h-full min-h-0 bg-token-bg-primary`, e),
          style: st(ee),
