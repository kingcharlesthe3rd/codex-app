...
import { n as i, r as a } from "./react.js";
import { n as o, s } from "./statsig-DoZ-0xit.js";
import { d as c } from "./thread-context-inputs.js";
...
function E(e) {
  let t = (0, b.c)(14),
    ...
    a;
  t[0] !== n || t[1] !== i || t[2] !== r
    ? ((a = n && !i && o(r, `1482884768`)), (t[0] = n), (t[1] = i), (t[2] = r), (t[3] = a))
    : (a = t[3]);
  let c = a,
    u;
  t[4] === c ? (u = t[5]) : ((u = { enabled: c }), (t[4] = c), (t[5] = u));
  let d = l(u),
  ...
  let p = i || (c && d.isLoading),
    m;
  t[7] !== c || t[8] !== f || t[9] !== r
    ? ((m = c && f && o(r, `3150044490`)), (t[7] = c), (t[8] = f), (t[9] = r), (t[10] = m))
    : (m = t[10]);
  let h;
  return (
    t[11] !== p || t[12] !== m
...
function O() {
  let e = (0, b.c)(15),
    ...
    n = f(),
    [a, o] = i(u),
    { data: s, isLoading: l } = r(c),
    d = (s?.roots?.length ?? 0) > 0,
    p;
  e[0] !== d || e[1] !== l || e[2] !== n || e[3] !== a || e[4] !== t
    ? ((p = D({
        arm: t,
        isRemoteHost: n,
        isLoadingRoots: l,
