...
import { f as i } from "./thread-context-inputs.js";
import { n as a, r as o } from "./react.js";
import { n as s, s as c } from "./statsig.js";
import { y as l } from "./codex-api-C.js";
...
function w(e) {
  ...
  let f;
  t[4] !== n || t[5] !== u || t[6] !== s
    ? ((f = S({ onboardingTarget: n, assignment: s, evaluateExperimentArm: u })),
      (t[4] = n),
      (t[5] = u),
      (t[6] = s),
      (t[7] = f))
  ...
  let p = f,
    m,
    g;
  (t[8] !== n || t[9] !== i || t[10] !== l || t[11] !== s
    ? ((m = () => {
        n === `workspace` &&
          s == null &&
          i({ arm: _(l), assignedAtMs: Date.now(), experimentName: h });
      }),
      (g = [n, i, l, s]),
      (t[8] = n),
      (t[9] = i),
  ...
  return (
    t[14] !== p || t[15] !== s
      ? ((v = { workspaceOnboardingExperimentAssignment: s, workspaceOnboardingExperimentArm: p }),
        (t[14] = p),
        (t[15] = s),
        (t[16] = v))
      : (v = t[16]),
...
function E(e) {
  let t = (0, b.c)(14),
    { enabled: n } = e,
    { client: r, isLoading: i } = c(),
    a;
  t[0] !== n || t[1] !== i || t[2] !== r
    ? ((a = n && !i && s(r, `1482884768`)), (t[0] = n), (t[1] = i), (t[2] = r), (t[3] = a))
    : (a = t[3]);
  let o = a,
    u;
  t[4] === o ? (u = t[5]) : ((u = { enabled: o }), (t[4] = o), (t[5] = u));
  let d = l(u),
  ...
  let p = i || (o && d.isLoading),
    m;
  t[7] !== o || t[8] !== f || t[9] !== r
    ? ((m = o && f && s(r, `3150044490`)), (t[7] = o), (t[8] = f), (t[9] = r), (t[10] = m))
    : (m = t[10]);
  let h;
  return (
    t[11] !== p || t[12] !== m
      ? ((h = { isLoading: p, shouldUseTeenOnboarding: m }), (t[11] = p), (t[12] = m), (t[13] = h))
      : (h = t[13]),
    h
  );
}
...
function O() {
  let e = (0, b.c)(15),
    ...
    n = f(),
    [o, s] = a(u),
    { data: c, isLoading: l } = r(i),
    d = (c?.roots?.length ?? 0) > 0,
    p;
  e[0] !== d || e[1] !== l || e[2] !== n || e[3] !== o || e[4] !== t
    ? ((p = D({
        arm: t,
        isRemoteHost: n,
        isLoadingRoots: l,
  ...
  return (
    ...
    e[13] !== c
      ? ((h = {
          ...
          isRemoteHost: n,
          workspaceOnboardingAutoLaunchApplied: o,
          setWorkspaceOnboardingAutoLaunchApplied: s,
