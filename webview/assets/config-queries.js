import { Zi as e, aa as t, sa as n } from "./src-2.js";
import { Wo as r, fs as i } from "./app-server-manager-signals.js";
import {
  A as a,
  I as o,
  V as s,
...
function A(e, t) {
  ...
  return (
    n[7] !== l || n[8] !== d || n[9] !== f
      ? ((h = { queryKey: d, queryFn: f, staleTime: p.FIVE_MINUTES, enabled: l, select: j }),
        (n[7] = l),
        (n[8] = d),
        (n[9] = f),
        (n[10] = h))
