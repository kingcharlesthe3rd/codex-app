import { Z as e, p as t, s as n, t as r } from "./app-scope-CWE-zIhQ.js";
import { Bt as i, r as a } from "./use-host-config-C.js";
import { n as o } from "./thread-context-inputs.js";
import { A as s, _ as c, h as l, o as u, u as d, v as f } from "./vscode-api.js";
import { Aa as p, Oa as m, ba as h } from "./src-1.js";
...
function k(e, t) {
  let r = (0, _.c)(11),
    i = t?.hostId ?? `local`,
    { data: a } = n(o),
    c = t?.useActiveWorkspaceRoot ?? i === `local`,
    l = e ?? (c ? (a?.roots?.[0] ?? null) : null),
    u = t?.enabled ?? !0,
    p = s(),
    m;
  r[0] !== i || r[1] !== l ? ((m = [...v, i, l]), (r[0] = i), (r[1] = l), (r[2] = m)) : (m = r[2]);
  let h;
  r[3] !== i || r[4] !== p || r[5] !== l
    ? ((h = () => N(p, i, l)), (r[3] = i), (r[4] = p), (r[5] = l), (r[6] = h))
    : (h = r[6]);
  let g;
  return (
    r[7] !== u || r[8] !== m || r[9] !== h
      ? ((g = { queryKey: m, queryFn: h, staleTime: d.FIVE_MINUTES, enabled: u, select: A }),
        (r[7] = u),
        (r[8] = m),
        (r[9] = h),
        (r[10] = g))
...
function M(e) {
  ...
  let o;
  t[1] === r ? (o = t[2]) : ((o = () => P(r, a, null, !1)), (t[1] = r), (t[2] = o));
  let c;
  return (
    t[3] !== n || t[4] !== o
      ? ((c = { queryKey: i, queryFn: o, staleTime: 1 / 0, enabled: n, select: te }),
        (t[3] = n),
        (t[4] = o),
        (t[5] = c))
      : (c = t[5]),
...
function ne(e, t) {
  let r = (0, _.c)(11),
    i = t?.hostId ?? `local`,
    { data: a } = n(o),
    c = t?.cwdMode === `preserve-null` ? (e ?? null) : (e ?? a?.roots?.[0] ?? null),
    l = s(),
    u;
  r[0] !== i || r[1] !== c ? ((u = [...S, i, c]), (r[0] = i), (r[1] = c), (r[2] = u)) : (u = r[2]);
  let p;
  r[3] !== i || r[4] !== l || r[5] !== c
    ? ((p = () => N(l, i, c)), (r[3] = i), (r[4] = l), (r[5] = c), (r[6] = p))
    : (p = r[6]);
  let m = t?.enabled ?? !0,
    h;
  return (
    r[7] !== u || r[8] !== p || r[9] !== m
      ? ((h = { queryKey: u, queryFn: p, staleTime: d.FIVE_MINUTES, enabled: m, select: re }),
        (r[7] = u),
        (r[8] = p),
        (r[9] = m),
        (r[10] = h))
...
var F = t(r, ({ authMethod: e, hostId: t }) => L({ authMethod: e, hostId: t }));
function I({ authMethod: e, hostId: t }) {
  return [...x, t, `auth`, e ?? null];
}
function L({ authMethod: e, hostId: t }) {
  return {
    queryKey: I({ authMethod: e, hostId: t }),
    queryFn: async () => {
      try {
...
function R(e, t) {
  let r = (0, _.c)(10),
    ...
    s;
  r[0] !== e || r[1] !== a?.roots
    ? ((s = e ?? a?.roots ?? []), (r[0] = e), (r[1] = a?.roots), (r[2] = s))
    : (s = r[2]);
  let c = s,
    l;
  r[3] === c ? (l = r[4]) : ((l = { roots: c }), (r[3] = c), (r[4] = l));
  let f;
  r[5] === i
    ? (f = r[6])
    : ((f = { enabled: i, staleTime: d.FIVE_MINUTES }), (r[5] = i), (r[6] = f));
  let p;
  return (
    r[7] !== l || r[8] !== f
      ? ((p = { params: l, queryConfig: f, select: z }), (r[7] = l), (r[8] = f), (r[9] = p))
      : (p = r[9]),
    u(`local-custom-agents`, p)
  );
}
function z(e) {
...
function B(e) {
  ...
  return (
    t[5] !== a || t[6] !== o
      ? ((s = { mutationFn: a, onError: V, onSuccess: o }), (t[5] = a), (t[6] = o), (t[7] = s))
      : (s = t[7]),
    c(s)
  );
}
...
function H(e) {
  ...
  t[6] !== f || t[7] !== u || t[8] !== r
    ? ((m = async (e) => {
        ...
        let i = [...U(r, u), ...U(r, f)];
        for (let [e, a] of i) r.setQueryData(e, G(a, t, n));
  ...
  let b;
  return (
    t[15] !== p || t[16] !== m || t[17] !== h || t[18] !== y
      ? ((b = { mutationFn: p, onMutate: m, onError: h, onSettled: y }),
        (t[15] = p),
        (t[16] = m),
        (t[17] = h),
        (t[18] = y),
...
var q = t(r, (e) => Y(e, `full`)),
  J = t(r, (e) => Y(e, `toolsAndAuthOnly`));
function Y(e, t) {
  return {
    queryKey: [...T, e, t],
    queryFn: async () =>
      i(`list-mcp-server-status`, { hostId: e, cursor: null, limit: 100, detail: t }),
    staleTime: d.FIVE_MINUTES,
  };
}
function ie(e) {
  let t = (0, _.c)(14),
    ...
    p = o ?? ``,
    m;
  t[0] !== u || t[1] !== r || t[2] !== p || t[3] !== a
    ? ((m = [...ee, u, a, r, p]), (t[0] = u), (t[1] = r), (t[2] = p), (t[3] = a), (t[4] = m))
    : (m = t[4]);
  let h;
  ...
  return (
    t[10] !== m || t[11] !== h || t[12] !== g
      ? ((v = { queryKey: m, queryFn: h, staleTime: d.FIVE_MINUTES, enabled: g }),
        (t[10] = m),
        (t[11] = h),
        (t[12] = g),
        (t[13] = v))
...
async function ae(e, t) {
  let { layers: n } = await P(e, t, null, !0);
  return $(n);
}
function $(e) {
