...
import { ds as i, js as a } from "./app-server-manager-signals.js";
import { _ as o, g as s, k as c, m as l, o as u, u as d } from "./vscode-api.js";
import { Ki as f, ea as p, na as m } from "./src-1.js";
...
function A(e, t) {
  let r = (0, _.c)(11),
    i = t?.hostId ?? `local`,
    { data: a } = n(g),
    s = t?.useActiveWorkspaceRoot ?? i === `local`,
    l = e ?? (s ? (a?.roots?.[0] ?? null) : null),
    u = t?.enabled ?? !0,
    f = c(),
    p;
  r[0] !== i || r[1] !== l ? ((p = [...v, i, l]), (r[0] = i), (r[1] = l), (r[2] = p)) : (p = r[2]);
  let m;
  r[3] !== i || r[4] !== f || r[5] !== l
    ? ((m = () => M(f, i, l)), (r[3] = i), (r[4] = f), (r[5] = l), (r[6] = m))
    : (m = r[6]);
  let h;
  return (
    r[7] !== u || r[8] !== p || r[9] !== m
      ? ((h = { queryKey: p, queryFn: m, staleTime: d.FIVE_MINUTES, enabled: u, select: j }),
        (r[7] = u),
        (r[8] = p),
        (r[9] = m),
        (r[10] = h))
...
var ee = t(r, (e, { queryClient: t }) => ({
  ...
  queryFn: async () => {
    try {
      ...
      return (l.error(`Failed to load config`, { safe: {}, sensitive: { error: e } }), k);
    }
  },
...
function te(e) {
  let t = (0, _.c)(6),
    ...
    r = c(),
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = [...b, i]), (t[0] = a)) : (a = t[0]);
  let s;
  t[1] === r ? (s = t[2]) : ((s = () => N(r, i, null, !1)), (t[1] = r), (t[2] = s));
  let l;
  return (
    t[3] !== n || t[4] !== s
      ? ((l = { queryKey: a, queryFn: s, staleTime: 1 / 0, enabled: n, select: ne }),
        (t[3] = n),
        (t[4] = s),
        (t[5] = l))
      : (l = t[5]),
...
function re(e, t) {
  let r = (0, _.c)(11),
    i = t?.hostId ?? `local`,
    { data: a } = n(g),
    s = t?.cwdMode === `preserve-null` ? (e ?? null) : (e ?? a?.roots?.[0] ?? null),
    l = c(),
    u;
  r[0] !== i || r[1] !== s ? ((u = [...S, i, s]), (r[0] = i), (r[1] = s), (r[2] = u)) : (u = r[2]);
  let f;
  r[3] !== i || r[4] !== l || r[5] !== s
    ? ((f = () => M(l, i, s)), (r[3] = i), (r[4] = l), (r[5] = s), (r[6] = f))
    : (f = r[6]);
  let p = t?.enabled ?? !0,
    m;
  return (
    r[7] !== u || r[8] !== f || r[9] !== p
      ? ((m = { queryKey: u, queryFn: f, staleTime: d.FIVE_MINUTES, enabled: p, select: ie }),
        (r[7] = u),
        (r[8] = f),
        (r[9] = p),
        (r[10] = m))
  ...
  return e.fetchQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return (l.error(`Failed to load layered config`, { safe: {}, sensitive: { error: e } }), k);
      }
    },
    staleTime: d.FIVE_MINUTES,
  });
...
function N(e, t, n, r) {
  return e.fetchQuery({
    queryKey: [...w, t, n, r],
    queryFn: () => a(`read-config-for-host`, { hostId: t, includeLayers: r, cwd: n }),
    staleTime: 0,
  });
}
...
function I({ authMethod: e, hostId: t }) {
  return {
    ...
    queryFn: async () => {
      try {
        return await a(`get-config-requirements-for-host`, { hostId: t });
      } catch (e) {
        return (
...
function L(e, t) {
  ...
  r[5] === i
    ? (l = r[6])
    : ((l = { enabled: i, staleTime: d.FIVE_MINUTES }), (r[5] = i), (r[6] = l));
  let f;
  return (
    r[7] !== c || r[8] !== l
      ? ((f = { params: c, queryConfig: l, select: R }), (r[7] = c), (r[8] = l), (r[9] = f))
      : (f = r[9]),
    u(`local-custom-agents`, f)
  );
}
function R(e) {
...
function z(e) {
  ...
  t[0] === n
    ...
    : ((i = (e) => {
        ...
        return a(`batch-write-config-value`, {
          hostId: n,
  ...
  return (
    t[5] !== i || t[6] !== o
      ? ((c = { mutationFn: i, onError: B, onSuccess: o }), (t[5] = i), (t[6] = o), (t[7] = c))
      : (c = t[7]),
    s(c)
  );
}
...
function Y(e, t, n) {
  return {
    queryKey: [...T, e, n],
    queryFn: async () =>
      a(`list-mcp-server-status`, { hostId: e, cursor: null, limit: 100, detail: n }),
    staleTime: d.FIVE_MINUTES,
    enabled: t,
  };
}
function ae(e) {
  let t = (0, _.c)(14),
    { hostId: n, server: r, threadId: i, uri: s, enabled: c } = e,
    u = c === void 0 ? !0 : c,
    f = n ?? `local`,
    p = s ?? ``,
    m;
  t[0] !== f || t[1] !== r || t[2] !== p || t[3] !== i
    ? ((m = [...E, f, i, r, p]), (t[0] = f), (t[1] = r), (t[2] = p), (t[3] = i), (t[4] = m))
    : (m = t[4]);
  let h;
  t[5] !== f || t[6] !== r || t[7] !== i || t[8] !== s
    ? ((h = async () =>
        a(`read-mcp-resource`, { hostId: f, server: r, threadId: i, uri: s ?? `` }).catch((e) => {
          throw (
            l.error(`Failed to read MCP resource`, {
              safe: { server: r, threadId: i, uri: s },
              sensitive: { error: e },
            }),
            e
          );
