...
import { Xs as r, po as i } from "./app-server-manager-signals.js";
import {
  C as a,
  L as o,
  S as s,
...
function O(e, t) {
  let n = (0, _.c)(11),
    ...
    f = o(),
    p;
  n[0] !== r || n[1] !== s ? ((p = [...v, r, s]), (n[0] = r), (n[1] = s), (n[2] = p)) : (p = n[2]);
  let m;
  n[3] !== r || n[4] !== f || n[5] !== s
  ...
  return (
    n[7] !== d || n[8] !== p || n[9] !== m
      ? ((h = { queryKey: p, queryFn: m, staleTime: u.FIVE_MINUTES, enabled: d, select: k }),
        (n[7] = d),
        (n[8] = p),
        (n[9] = m),
        (n[10] = h))
...
var A = d(s, (e, { queryClient: t }) => ({
  ...
  queryFn: async () => {
    try {
      ...
      return (a.error(`Failed to load config`, { safe: {}, sensitive: { error: e } }), D);
    }
  },
...
function j(e) {
  ...
  let s;
  t[1] === r ? (s = t[2]) : ((s = () => P(r, i, null, !1)), (t[1] = r), (t[2] = s));
  let l;
  return (
    t[3] !== n || t[4] !== s
...
function re(e, t) {
  let n = (0, _.c)(11),
    r = t?.hostId ?? `local`,
    { data: i } = l(g),
    a = t?.cwdMode === `preserve-null` ? (e ?? null) : (e ?? i?.roots?.[0] ?? null),
    s = o(),
    d;
  n[0] !== r || n[1] !== a ? ((d = [...S, r, a]), (n[0] = r), (n[1] = a), (n[2] = d)) : (d = n[2]);
  let f;
  n[3] !== r || n[4] !== s || n[5] !== a
  ...
  return (
    n[7] !== d || n[8] !== f || n[9] !== p
      ? ((m = { queryKey: d, queryFn: f, staleTime: u.FIVE_MINUTES, enabled: p, select: M }),
        (n[7] = d),
        (n[8] = f),
        (n[9] = p),
        (n[10] = m))
  ...
  return e.fetchQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return (a.error(`Failed to load layered config`, { safe: {}, sensitive: { error: e } }), D);
      }
    },
    staleTime: u.FIVE_MINUTES,
  });
...
function P(e, t, n, i) {
  return e.fetchQuery({
    queryKey: [...w, t, n, i],
    queryFn: () => r(`read-config-for-host`, { hostId: t, includeLayers: i, cwd: n }),
    staleTime: 0,
  });
}
var F = d(s, (e) => I(e, !0));
  ...
  return {
    ...
    queryFn: async () => {
      try {
        ...
        return (
          a.error(`Failed to load config requirements`, { safe: {}, sensitive: { error: e } }),
          { requirements: null }
        );
      }
    },
...
function L(e, t) {
  ...
  return (
    n[7] !== s || n[8] !== c
      ? ((d = { params: s, queryConfig: c, select: R }), (n[7] = s), (n[8] = c), (n[9] = d))
      : (d = n[9]),
  ...
  t[0] === n
    ...
    : ((a = (e) => {
        ...
        return r(`batch-write-config-value`, {
          hostId: n,
          edits: [{ keyPath: `mcp_servers.${i}`, value: a, mergeStrategy: `replace` }],
          filePath: t,
...
function B(e) {
  a.error(`Failed to write MCP server config`, { safe: {}, sensitive: { error: e } });
}
function V(e) {
  let t = (0, _.c)(20),
    n = e?.hostId ?? `local`,
  ...
  t[6] !== d || t[7] !== l || t[8] !== i
    ? ((m = async (e) => {
        ...
        await Promise.all([i.cancelQueries({ queryKey: l }), i.cancelQueries({ queryKey: d })]);
        let r = [...H(i, l), ...H(i, d)];
  ...
  t[10] === i
    ? (g = t[11])
    : ((g = (e, t, n) => {
        a.error(`Failed to update MCP server enabled state`, { safe: {}, sensitive: { error: e } });
        for (let [e, t] of n?.previousConfigResponses ?? []) i.setQueryData(e, t);
      }),
      (t[10] = i),
      (t[11] = g));
  let y;
...
function Y(e, t, n) {
  return {
    queryKey: [...T, e, n],
    queryFn: async () =>
      r(`list-mcp-server-status`, { hostId: e, cursor: null, limit: 100, detail: n }),
    staleTime: u.FIVE_MINUTES,
    enabled: t,
  };
}
function ie(e) {
  ...
  t[0] !== f || t[1] !== i || t[2] !== p || t[3] !== o
    ? ((m = [...ee, f, o, i, p]), (t[0] = f), (t[1] = i), (t[2] = p), (t[3] = o), (t[4] = m))
    : (m = t[4]);
  let h;
  t[5] !== f || t[6] !== i || t[7] !== o || t[8] !== s
    ? ((h = async () =>
        r(`read-mcp-resource`, { hostId: f, server: i, threadId: o, uri: s ?? `` }).catch((e) => {
          throw (
