import { p as e, s as t, t as n, z as r } from "./app-scope.js";
import { Ts as i, zs as a } from "./app-server-manager-signals.js";
import { A as o, _ as s, h as c, o as l, u, v as d } from "./vscode-api.js";
import { aa as f, ha as p, pa as m } from "./src-2.js";
...
function A(e, n) {
  let r = (0, _.c)(11),
    ...
    c = e ?? (s ? (a?.roots?.[0] ?? null) : null),
    l = n?.enabled ?? !0,
    f = o(),
    p;
  r[0] !== i || r[1] !== c ? ((p = [...v, i, c]), (r[0] = i), (r[1] = c), (r[2] = p)) : (p = r[2]);
  let m;
  r[3] !== i || r[4] !== f || r[5] !== c
    ? ((m = () => M(f, i, c)), (r[3] = i), (r[4] = f), (r[5] = c), (r[6] = m))
    : (m = r[6]);
  let h;
  return (
    r[7] !== l || r[8] !== p || r[9] !== m
      ? ((h = { queryKey: p, queryFn: m, staleTime: u.FIVE_MINUTES, enabled: l, select: j }),
        (r[7] = l),
        (r[8] = p),
        (r[9] = m),
        (r[10] = h))
...
var ee = e(n, (e, { queryClient: t }) => ({
  queryKey: [...y, e],
  queryFn: async () => {
    try {
      return await N(t, e, null, !0);
    } catch (e) {
      return (c.error(`Failed to load config`, { safe: {}, sensitive: { error: e } }), k);
    }
  },
...
function te(e) {
  let t = (0, _.c)(6),
    ...
    r = o(),
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((i = [...b, a]), (t[0] = i)) : (i = t[0]);
  let s;
  t[1] === r ? (s = t[2]) : ((s = () => N(r, a, null, !1)), (t[1] = r), (t[2] = s));
  let c;
  return (
    t[3] !== n || t[4] !== s
      ? ((c = { queryKey: i, queryFn: s, staleTime: 1 / 0, enabled: n, select: ne }),
        (t[3] = n),
        (t[4] = s),
        (t[5] = c))
      : (c = t[5]),
...
function re(e, n) {
  let r = (0, _.c)(11),
    i = n?.hostId ?? `local`,
    { data: a } = t(g),
    s = n?.cwdMode === `preserve-null` ? (e ?? null) : (e ?? a?.roots?.[0] ?? null),
    c = o(),
    l;
  r[0] !== i || r[1] !== s ? ((l = [...S, i, s]), (r[0] = i), (r[1] = s), (r[2] = l)) : (l = r[2]);
  let f;
  r[3] !== i || r[4] !== c || r[5] !== s
    ? ((f = () => M(c, i, s)), (r[3] = i), (r[4] = c), (r[5] = s), (r[6] = f))
    : (f = r[6]);
  let p = n?.enabled ?? !0,
    m;
  return (
    r[7] !== l || r[8] !== f || r[9] !== p
      ? ((m = { queryKey: l, queryFn: f, staleTime: u.FIVE_MINUTES, enabled: p, select: ie }),
        (r[7] = l),
        (r[8] = f),
        (r[9] = p),
        (r[10] = m))
  ...
  return e.fetchQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return (c.error(`Failed to load layered config`, { safe: {}, sensitive: { error: e } }), k);
      }
    },
    staleTime: u.FIVE_MINUTES,
  });
...
var P = e(n, ({ authMethod: e, hostId: t }) => I({ authMethod: e, hostId: t }));
  ...
  return {
    ...
    queryFn: async () => {
      try {
        ...
        return (
          c.error(`Failed to load config requirements`, { safe: {}, sensitive: { error: e } }),
          { requirements: null }
        );
      }
    },
...
function L(e, n) {
  ...
  let s = o,
    c;
  r[3] === s ? (c = r[4]) : ((c = { roots: s }), (r[3] = s), (r[4] = c));
  let d;
  r[5] === i
    ? (d = r[6])
    : ((d = { enabled: i, staleTime: u.FIVE_MINUTES }), (r[5] = i), (r[6] = d));
  let f;
  return (
    r[7] !== c || r[8] !== d
      ? ((f = { params: c, queryConfig: d, select: R }), (r[7] = c), (r[8] = d), (r[9] = f))
      : (f = r[9]),
    l(`local-custom-agents`, f)
  );
}
function R(e) {
...
function z(e) {
  ...
  return (
    t[5] !== a || t[6] !== o
      ? ((c = { mutationFn: a, onError: B, onSuccess: o }), (t[5] = a), (t[6] = o), (t[7] = c))
      : (c = t[7]),
    s(c)
  );
}
function B(e) {
  c.error(`Failed to write MCP server config`, { safe: {}, sensitive: { error: e } });
}
function V(e) {
  let t = (0, _.c)(20),
    n = e?.hostId ?? `local`,
  ...
  t[10] === r
    ? (g = t[11])
    : ((g = (e, t, n) => {
        c.error(`Failed to update MCP server enabled state`, { safe: {}, sensitive: { error: e } });
...
var K = e(n, (e) => Y(e, !0, `full`)),
  q = e(n, (e) => Y(e, !0, `toolsAndAuthOnly`)),
  J = e(n, (e) => Y(e, !1, `full`));
function Y(e, t, n) {
  return {
    queryKey: [...T, e, n],
...
function ae(e) {
  let t = (0, _.c)(14),
    ...
    p = o ?? ``,
    m;
  t[0] !== f || t[1] !== r || t[2] !== p || t[3] !== a
    ? ((m = [...E, f, a, r, p]), (t[0] = f), (t[1] = r), (t[2] = p), (t[3] = a), (t[4] = m))
    : (m = t[4]);
  let h;
  t[5] !== f || t[6] !== r || t[7] !== a || t[8] !== o
    ? ((h = async () =>
        i(`read-mcp-resource`, { hostId: f, server: r, threadId: a, uri: o ?? `` }).catch((e) => {
          throw (
            c.error(`Failed to read MCP resource`, {
  ...
  return (
    t[10] !== m || t[11] !== h || t[12] !== g
      ? ((v = { queryKey: m, queryFn: h, staleTime: u.FIVE_MINUTES, enabled: g }),
        (t[10] = m),
        (t[11] = h),
        (t[12] = g),
        (t[13] = v))
