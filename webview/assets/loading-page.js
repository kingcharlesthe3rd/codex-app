...
function u(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = i(`relative inline-flex shrink-0 items-center justify-center`, n)),
      (t[0] = n),
      (t[1] = r));
  let o;
  ...
  return (
    t[4] === r
      ? (d = t[5])
      : ((d = (0, c.jsxs)(`div`, { "aria-hidden": `true`, className: r, children: [o, u] })),
        (t[4] = r),
        (t[5] = d)),
    d
  );
...
function f(e) {
  let t = (0, s.c)(21),
    { overlay: n, fillParent: r, showLogo: a, debugName: o } = e,
    l = n === void 0 ? !1 : n,
    f = r === void 0 ? !1 : r,
    p = a === void 0 ? !0 : a,
    [m, h] = (0, d.useState)(!1),
  ...
  t[0] === g
    ? (_ = t[1])
    : ((_ = i(`flex items-center justify-center`, g)), (t[0] = g), (t[1] = _));
  let v;
