  ...
  t[54] !== M || t[55] !== F || t[56] !== I || t[57] !== Ie
    ? ((Le = function (e) {
        ...
        switch (e.kind) {
          ...
          case `group`:
            return Ie(
              u({ accessGroups: F, accessPolicy: M, group: e.group, knownAccessGroups: I }),
            );
        }
      }),
      (t[54] = M),
                ...
                V
                  ? (0, $.jsx)(z, {
                      children: (0, $.jsx)(Re, {
                        ...
                        options: !de || A == null || j == null || L == null ? void 0 : he,
...
function Ke(e) {
  ...
  let m;
  t[14] !== d || t[15] !== p
    ? ((m = (0, $.jsx)(Se, { title: d, titleClassName: `truncate pr-8`, subtitle: p })),
      (t[14] = d),
      (t[15] = p),
      (t[16] = m))
    : (m = t[16]);
  ...
  let g;
  t[18] !== o || t[19] !== r
    ? ((g = (0, $.jsx)(E, { color: `secondary`, disabled: o, onClick: r, children: h })),
      (t[18] = o),
      (t[19] = r),
      (t[20] = g))
    : (g = t[20]);
  ...
  t[22] === o
    ? (v = t[23])
    : ((v = (0, $.jsx)(E, { color: `danger`, loading: o, type: `submit`, children: _ })),
      (t[22] = o),
      (t[23] = v));
  let y;
  t[24] !== v || t[25] !== g
...
function Ze(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i) {
    let e = _({ availableAccessModes: n, currentAccessMode: r, isWorkspaceAccount: i });
...
function Qe(e) {
  ...
  let m = p,
    h;
  t[3] !== a || t[4] !== s
    ? ((h = et({ action: `visit`, isSaving: a, liveUrl: s })), (t[3] = a), (t[4] = s), (t[5] = h))
    : (h = t[5]);
  let g = h,
    _;
  ...
  let S;
  t[18] !== m || t[19] !== d || t[20] !== a || t[21] !== s || t[22] !== f || t[23] !== g
    ? ((S =
        s === void 0
          ? null
          : (0, $.jsxs)(`div`, {
                ...
                (0, $.jsx)(T, {
                  ...
                  children: (0, $.jsx)(`span`, {
                    ...
                    children: (0, $.jsxs)(E, {
                      ...
                      size: `toolbar`,
                      onClick: (e) => {
                        s != null && M({ event: e, href: s, initiator: `mcp_app_resource` });
                      },
                      children: [
                        s == null
                          ? null
                          : (0, $.jsx)(de, { className: `icon-xs`, ExternalIcon: c, href: s }),
                        (0, $.jsx)(k, {
