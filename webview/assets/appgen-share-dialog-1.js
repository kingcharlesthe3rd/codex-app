...
function Re(e) {
  let t = (0, Q.c)(104),
    { onClose: r, projectId: i } = e,
    o = pe(),
    c = s(n),
    { email: l } = ae(),
    { data: f } = oe(),
    m = f?.structure === `workspace`,
    { data: h, isError: g, isLoading: y } = a(fe, i),
    b = a(ce, i),
    [x, w] = (0, at.useState)(``),
    T;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((T = []), (t[0] = T)) : (T = t[0]);
  let [E, D] = (0, at.useState)(T),
    O;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((O = []), (t[1] = O)) : (O = t[1]);
  let [k, A] = (0, at.useState)(O),
    [ee, te] = (0, at.useState)(null),
    ne;
  t[2] === x ? (ne = t[3]) : ((ne = x.trim()), (t[2] = x), (t[3] = ne));
  let re = ne,
    se = ie(re, 200),
    { data: le } = Ne(m ? x : ``),
    { data: M } = a(de, m ? se : null),
    ue = se === re,
    { data: N } = a(de, m ? `` : null),
    P,
    F,
  ...
  if (
    ...
    ((L = et(M)),
      ...
      (I = P?.allowed_users ?? []),
      (F = P?.allowed_groups ?? []));
    let e = new Set(I.map(We));
    z = Ee({
      currentAccountUserId: f?.account_user_id,
      existingAccountUserIds: e,
      selectedAccountUserIds: E.map(Ue),
      workspaceUsers: le,
    });
    let n = new Set(F.map(He));
    B = new Set(R.map(Ve));
    let r;
    t[20] !== n || t[21] !== k
  ...
  let Fe = Pe,
    Ie;
  t[54] !== P || t[55] !== L || t[56] !== R || t[57] !== Fe
    ? ((Ie = function (e) {
        if (P == null) return Promise.resolve();
        switch (e.kind) {
          case `user`:
            return Fe(ge(P, e.user.account_user_id));
          case `group`:
            return Fe(
              ve({ accessGroups: L, accessPolicy: P, group: e.group, knownAccessGroups: R }),
            );
        }
      }),
      (t[54] = P),
  ...
  t[66] === Ce
    ...
    : ((J = (0, $.jsxs)(`div`, {
        ...
        children: [
          (0, $.jsx)(S, { className: `sr-only`, children: Ce }),
          (0, $.jsx)(_, { title: Ce, titleClassName: `truncate pr-8` }),
        ],
      })),
      (t[66] = Ce),
      (t[67] = J));
    ...
    ? ((Y = y
        ...
        : g || h == null || P == null
          ...
          : (0, $.jsxs)($.Fragment, {
              children: [
                (0, $.jsx)(v, {
                  children: (0, $.jsx)(Ke, { liveUrl: h.current_live_url, title: h.title }),
                }),
                H
                  ? (0, $.jsx)(v, {
                      children: (0, $.jsx)(Le, {
                        ...
                        options: !ue || M == null || N == null || z == null ? void 0 : ye,
      ...
      (t[89] = Y))
    : (Y = t[89]);
  let Xe = y || g || h == null || P == null ? void 0 : h.current_live_url,
    X;
  t[90] !== V ||
  t[91] !== W ||
  t[92] !== we ||
  ...
  t[97] !== J || t[98] !== Y || t[99] !== X
    ? ((Z = (0, $.jsxs)(u, { className: `px-4 py-3`, children: [J, Y, X] })),
      (t[97] = J),
      (t[98] = Y),
      (t[99] = X),
      (t[100] = Z))
...
function Ge(e) {
  ...
  let y;
  t[14] !== f || t[15] !== h
    ? ((y = (0, $.jsx)(_, { title: f, titleClassName: `truncate pr-8`, subtitle: h })),
      (t[14] = f),
      (t[15] = h),
      (t[16] = y))
    : (y = t[16]);
  ...
  let C;
  t[18] !== o || t[19] !== r
    ? ((C = (0, $.jsx)(g, { color: `secondary`, disabled: o, onClick: r, children: b })),
      (t[18] = o),
      (t[19] = r),
      (t[20] = C))
    : (C = t[20]);
  ...
  t[22] === o
    ? (T = t[23])
    : ((T = (0, $.jsx)(g, { color: `danger`, loading: o, type: `submit`, children: w })),
      (t[22] = o),
      (t[23] = T));
  let E;
  t[24] !== T || t[25] !== C
    ? ((E = (0, $.jsx)(v, { children: (0, $.jsxs)(D, { children: [C, T] }) })),
      (t[24] = T),
      (t[25] = C),
      (t[26] = E))
    : (E = t[26]);
  let O;
  t[27] !== E || t[28] !== d || t[29] !== y
    ? ((O = (0, $.jsxs)(u, {
        as: `form`,
...
function Ke(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(b, { className: `icon-md` }),
      })),
      (t[2] = o))
    : (o = t[2]);
  let s;
...
function qe(e) {
  ...
  if (
    ...
    let e = Je({ activeAccessUsers: r, currentAccountUserId: d, currentUserEmail: u }),
    ...
    ((g = t[11]), (_ = t[12]), (y = t[13]), (b = t[14]), (x = t[15]), (S = t[16]), (C = t[17]));
  let w;
  ...
  let T;
  t[40] !== _ || t[41] !== y || t[42] !== b || t[43] !== w
    ? ((T = (0, $.jsxs)(`div`, { className: _, children: [y, b, w] })),
      (t[40] = _),
      (t[41] = y),
      (t[42] = b),
      (t[43] = w),
  ...
  let E;
  return (
    t[45] !== g || t[46] !== x || t[47] !== S || t[48] !== C || t[49] !== T
      ? ((E = (0, $.jsxs)(g, { className: x, children: [S, C, T] })),
        (t[45] = g),
        (t[46] = x),
        (t[47] = S),
        (t[48] = C),
...
function Xe(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i) {
    let e = he({ availableAccessModes: n, currentAccessMode: r, isWorkspaceAccount: i });
...
function Ze(e) {
  let t = (0, Q.c)(35),
    ...
    p;
  t[0] !== o || t[1] !== c
    ? ((p = $e({ action: `copyLink`, isSaving: o, liveUrl: c })),
      (t[0] = o),
      (t[1] = c),
      (t[2] = p))
    : (p = t[2]);
  let m = p,
    h;
  t[3] !== o || t[4] !== c
    ? ((h = $e({ action: `visit`, isSaving: o, liveUrl: c })), (t[3] = o), (t[4] = c), (t[5] = h))
    : (h = t[5]);
  let _ = h,
    y;
  ...
  let w;
  t[18] !== m || t[19] !== d || t[20] !== o || t[21] !== c || t[22] !== f || t[23] !== _
    ? ((w =
        c === void 0
          ? null
          : (0, $.jsxs)(`div`, {
                ...
                (0, $.jsx)(E, {
                  ...
                  children: (0, $.jsx)(`span`, {
                    ...
                    children: (0, $.jsxs)(g, {
                      ...
                      size: `toolbar`,
                      onClick: (e) => {
                        c != null && A({ event: e, href: c, initiator: `mcp_app_resource` });
                      },
                      children: [
                        c == null
                          ? null
                          : (0, $.jsx)(Se, { className: `icon-xs`, ExternalIcon: R, href: c }),
                        (0, $.jsx)(j, {
