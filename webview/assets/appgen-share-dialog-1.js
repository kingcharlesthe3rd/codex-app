...
import { t as _ } from "./use-debounced-value.js";
...
import { t as D } from "./sites-color.js";
import { t as O } from "./globe.js";
import { t as k } from "./building.js";
import { t as A } from "./arrow-up-right-lg.js";
import { t as j } from "./lock.js";
import { t as M } from "./link.js";
import {
  d as ee,
  f as te,
  h as ne,
...
function ge(e) {
  let t = (0, P.c)(99),
    ...
    { email: d } = m(),
    { data: p } = g(),
    { data: v, isError: T, isLoading: E } = i(ae, r),
    D = i(se, r),
    [O, k] = (0, he.useState)(``),
    A;
...
function Ce(e) {
  ...
  let g;
  t[14] !== p || t[15] !== h
    ? ((g = (0, F.jsx)(S, { title: p, titleClassName: `truncate pr-8`, subtitle: h })),
      (t[14] = p),
      (t[15] = h),
      (t[16] = g))
    : (g = t[16]);
  ...
  let v;
  t[18] !== o || t[19] !== r
    ? ((v = (0, F.jsx)(d, { color: `secondary`, disabled: o, onClick: r, children: _ })),
      (t[18] = o),
      (t[19] = r),
      (t[20] = v))
    : (v = t[20]);
  ...
  t[22] === o
    ? (D = t[23])
    : ((D = (0, F.jsx)(d, { color: `danger`, loading: o, type: `submit`, children: y })),
      (t[22] = o),
      (t[23] = D));
  let O;
  t[24] !== D || t[25] !== v
...
function ke(e) {
  let t = (0, P.c)(27),
    ...
    y;
  t[0] !== i || t[1] !== u
    ? ((y = G({ action: `copyLink`, isSaving: i, liveUrl: u })), (t[0] = i), (t[1] = u), (t[2] = y))
    : (y = t[2]);
  let x = y,
    S;
  t[3] !== i || t[4] !== u
    ? ((S = G({ action: `visit`, isSaving: i, liveUrl: u })), (t[3] = i), (t[4] = u), (t[5] = S))
    : (S = t[5]);
  let C = S,
    w;
  t[6] === m
    ? (w = t[7])
    : ((w = { invite: { onClick: m }, share: { onClick: m } }), (t[6] = m), (t[7] = w));
  let T;
  t[8] === f ? (T = t[9]) : ((T = { onClick: f }), (t[8] = f), (t[9] = T));
  let E;
  t[10] !== x || t[11] !== g || t[12] !== i || t[13] !== u || t[14] !== _ || t[15] !== C
    ? ((E =
        u === void 0
          ? null
          : (0, F.jsxs)(`div`, {
                ...
                (0, F.jsx)(p, {
                  ...
                  children: (0, F.jsx)(`span`, {
                    ...
                    children: (0, F.jsxs)(d, {
                      ...
                      size: `toolbar`,
                      onClick: () => {
                        u != null && s.dispatchMessage(`open-in-browser`, { url: u });
                      },
                      children: [
