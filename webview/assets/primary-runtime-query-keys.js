...
import { F as n, I as r, L as i } from "./src-3.js";
async function a(e) {
  try {
...
function o(e) {
  let a = e.getLayer(`2096615506`).get(n, r),
    o = i.safeParse(a);
  return (
    o.success ||
    ...
    { source: a === r ? `default` : `statsig-layer`, value: o.success ? o.data : r }
  );
}
function s(r) {
  (t.info(`Codex runtime config selected`, {
    safe: { artifact: n, source: r.source },
    sensitive: { runtimeInstallConfig: r.value },
  }),
    e.dispatchMessage(`codex-runtimes-config-changed`, { config: c(r.value) }));
}
function c(e) {
  return { runtimes: { [n]: e } };
}
