...
import { Gn as L, Kn as R, Wn as ae } from "./app-initial~app-main~automations-page.js";
import {
  gi as oe,
  mi as z,
  vc as B,
...
import { n as me, t as he } from "./trending-topics.js";
import { n as ge, t as _e } from "./appgen-share-dialog--o3-U-xq.js";
function ve() {
  let e = (0, ye.c)(5),
...
function Se(e) {
  ...
  let o = a === `list` ? `h-[50px] w-20` : `aspect-square w-full`,
    s;
  t[5] !== r || t[6] !== o
    ? ((s = M(`relative shrink-0 overflow-hidden`, o, r)), (t[5] = r), (t[6] = o), (t[7] = s))
    : (s = t[7]);
  let c;
  return (
    t[8] !== n || t[9] !== i || t[10] !== s
...
function Ce(e) {
  ...
  let a = i === `list` ? `text-sm leading-5` : `text-xs leading-[18px]`,
    o;
  t[4] !== n || t[5] !== a
    ? ((o = M(`truncate font-medium text-token-foreground`, a, n)),
      (t[4] = n),
      (t[5] = a),
      (t[6] = o))
    : (o = t[6]);
...
function we(e) {
  ...
  t[3] === n
    ? (i = t[4])
    : ((i = M(`text-xs leading-[18px] text-token-text-secondary`, n)), (t[3] = n), (t[4] = i));
  let a;
  return (
    t[5] !== r || t[6] !== i
...
function Ee(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Y.jsx)(y, { "aria-hidden": !0, className: `icon-xs` })), (t[4] = f))
    : (f = t[4]);
  let p;
  return (
...
function De(e) {
  ...
  let a = (i === void 0 ? !1 : i) && `[@container_(max-width:620px)]:hidden`,
    o;
  t[4] !== n || t[5] !== a
    ? ((o = M(`pl-4 text-xs leading-[18px] text-token-text-secondary`, a, n)),
      (t[4] = n),
      (t[5] = a),
      (t[6] = o))
    : (o = t[6]);
...
function je(e) {
  let t = (0, Me.c)(55),
    { onEdit: n, projectId: r, projectTitle: i, surface: o, viewMode: s } = e,
    c = ie(),
    l = ne(),
    d = u(a),
    f = re(`262557526`),
  ...
  t[1] !== c || t[2] !== i
    ? ((m = c.formatMessage(
      ...
      (t[3] = m))
    : (m = t[3]);
  let h = s === `grid` ? `ghost` : `ghostTertiary`,
    g = s === `grid` ? `toolbar` : `composer`,
    _;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, X.jsx)(v, { "aria-hidden": !0, className: `icon-xs` })), (t[4] = _))
    : (_ = t[4]);
  let y;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, X.jsx)(se, { "aria-hidden": !0, className: `icon-xs` })), (t[17] = O))
    : (O = t[17]);
  let A;
  t[18] !== T || t[19] !== D || t[20] !== S || t[21] !== w
    ? ((A = (0, X.jsx)(C, {
        tooltipContent: x,
        children: (0, X.jsx)(U, {
          "aria-label": S,
  ...
  let F = s === `grid` ? `ghost` : `outline`,
    ...
    R;
  t[27] !== r || t[28] !== d
    ? ((R = () => oe(d, _e, { projectId: r })), (t[27] = r), (t[28] = d), (t[29] = R))
    : (R = t[29]);
  let z;
  ...
  t[31] === s
    ...
    : ((B =
      ...
      (t[32] = B));
  let V;
  t[33] !== N || t[34] !== P || t[35] !== F || t[36] !== I || t[37] !== R || t[38] !== B
    ? ((V = (0, X.jsx)(C, {
        tooltipContent: M,
        children: (0, X.jsxs)(U, {
          className: N,
  ...
  t[48] !== o
    ? ((H = f
        ...
        : (0, X.jsxs)(X.Fragment, { children: [o === `sites` ? b : j, o === `sites` ? j : b] })),
      (t[40] = f),
      (t[41] = b),
      (t[42] = c),
      (t[43] = l),
  ...
  let W;
  t[50] !== V || t[51] !== H
    ? ((W = (0, X.jsxs)(X.Fragment, { children: [V, H] })), (t[50] = V), (t[51] = H), (t[52] = W))
    : (W = t[52]);
  let G = W;
  if (s === `grid`) return G;
  let K;
  return (
    t[53] === G ? (K = t[54]) : ((K = (0, X.jsx)(Oe, { children: G })), (t[53] = G), (t[54] = K)), K
  );
}
var Me,
  X,
...
function Ke(e, t) {
  if (t === `all`) return !0;
  let { accessMode: n, groupCount: r, userCount: i } = S(e.access_policy),
...
function Ye(e, t, r) {
  ...
  switch (r.type) {
    ...
    case `edit`:
      a = i.formatMessage(
        ...
        { siteMention: B({ projectId: r.projectId, title: r.projectTitle }) },
      );
      break;
  }
  let o;
  switch (r.type) {
    case `create`:
      o = de({ defaultPrompt: a, pluginDisplayName: `Sites`, pluginId: A });
      break;
    case `edit`:
      o = `${a} `;
      break;
