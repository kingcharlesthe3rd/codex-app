...
import { n as _e, t as ve } from "./appgen-share-dialog-Ca-VUEmz.js";
function ye() {
  let e = (0, be.c)(5),
...
function De(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, J.jsx)(L, { "aria-hidden": !0, className: `icon-xs` })), (t[4] = p))
    : (p = t[4]);
  let m;
  return (
    t[5] !== s || t[6] !== a || t[7] !== u || t[8] !== d || t[9] !== f
      ? ((m = (0, J.jsx)(g, {
          tooltipContent: l,
          children: (0, J.jsx)(w, {
            "aria-label": u,
...
function Me(e) {
  let t = (0, Ne.c)(55),
    { onEdit: n, projectId: r, projectTitle: o, surface: c, viewMode: l } = e,
    u = ne(),
    d = re(),
    f = ee(s),
    h = p(`262557526`),
  ...
  t[1] !== u || t[2] !== o
    ? ((v = u.formatMessage(
      ...
      (t[3] = v))
    : (v = t[3]);
  let y = l === `grid` ? `ghost` : `ghostTertiary`,
    b = l === `grid` ? `toolbar` : `composer`,
    x;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, Y.jsx)(oe, { "aria-hidden": !0, className: `icon-xs` })), (t[4] = x))
    : (x = t[4]);
  let S;
  t[5] !== n || t[6] !== v || t[7] !== y || t[8] !== b
    ? ((S = (0, Y.jsx)(g, {
        tooltipContent: _,
        children: (0, Y.jsx)(w, {
          "aria-label": v,
  ...
  t[11] !== u || t[12] !== o
    ? ((E = u.formatMessage(
      ...
      (t[13] = E))
    : (E = t[13]);
  let D = l === `grid` ? `ghost` : `ghostTertiary`,
    O = l === `grid` ? `toolbar` : `composer`,
    k;
  t[14] !== d || t[15] !== r
    ? ((k = () => {
        d(fe(r));
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, Y.jsx)(se, { "aria-hidden": !0, className: `icon-xs` })), (t[17] = A))
    : (A = t[17]);
  let j;
  t[18] !== O || t[19] !== k || t[20] !== E || t[21] !== D
    ? ((j = (0, Y.jsx)(g, {
        tooltipContent: T,
        children: (0, Y.jsx)(w, {
          "aria-label": E,
  ...
  t[24] !== u || t[25] !== o
    ? ((F = u.formatMessage(
      ...
      (t[26] = F))
    : (F = t[26]);
  let I = l === `grid` ? `ghost` : `outline`,
    L = l === `grid`,
    R;
  t[27] !== r || t[28] !== f
    ? ((R = () => m(f, ve, { projectId: r })), (t[27] = r), (t[28] = f), (t[29] = R))
    : (R = t[29]);
  let z;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, Y.jsx)(ie, { "aria-hidden": !0, className: `icon-xs` })), (t[30] = z))
    : (z = t[30]);
  let B;
  t[31] === l
    ? (B = t[32])
    : ((B =
      ...
      (t[32] = B));
  let V;
  t[33] !== P || t[34] !== F || t[35] !== I || t[36] !== L || t[37] !== R || t[38] !== B
    ? ((V = (0, Y.jsx)(g, {
        tooltipContent: N,
        children: (0, Y.jsxs)(w, {
          className: P,
  ...
  t[48] !== c
    ? ((H = h
        ...
        : (0, Y.jsxs)(Y.Fragment, { children: [c === `sites` ? C : M, c === `sites` ? M : C] })),
      (t[40] = h),
      (t[41] = C),
      (t[42] = u),
      (t[43] = d),
  ...
  let U;
  t[50] !== V || t[51] !== H
    ? ((U = (0, Y.jsxs)(Y.Fragment, { children: [V, H] })), (t[50] = V), (t[51] = H), (t[52] = U))
    : (U = t[52]);
  let W = U;
  if (l === `grid`) return W;
  let G;
  return (
    t[53] === W ? (G = t[54]) : ((G = (0, Y.jsx)(ke, { children: W })), (t[53] = W), (t[54] = G)), G
  );
}
var Ne,
  Y,
...
function Ye(e, t, r) {
  ...
  switch (r.type) {
    ...
    case `edit`:
      a = i.formatMessage(
        ...
        { siteMention: n({ projectId: r.projectId, title: r.projectTitle }) },
      );
      break;
  }
  let o;
  switch (r.type) {
    case `create`:
      o = V({ defaultPrompt: a, pluginDisplayName: `Sites`, pluginId: D });
      break;
    case `edit`:
      o = `${a} `;
      break;
