...
import { Cn as ae, Tn as M, wn as N } from "./app-initial~app-main~automations-page.js";
import {
  f as P,
  p as F,
...
import { n as fe, t as pe } from "./use-element-in-view.js";
import { n as me, t as he } from "./trending-topics-D41t-u7e.js";
import { n as ge, t as _e } from "./appgen-share-dialog-1.js";
function ve() {
  let e = (0, ye.c)(5),
    [t, n] = (0, q.useState)(null),
...
function xe(e) {
  ...
  return (
    t[7] !== r || t[8] !== o
      ? ((s = (0, Y.jsx)(`div`, { className: o, ...r })), (t[7] = r), (t[8] = o), (t[9] = s))
      : (s = t[9]),
    s
  );
}
function Se(e) {
  ...
  let o = a === `list` ? `h-[50px] w-20` : `aspect-square w-full`,
    s;
  t[5] !== r || t[6] !== o
    ? ((s = P(`relative shrink-0 overflow-hidden`, o, r)), (t[5] = r), (t[6] = o), (t[7] = s))
    : (s = t[7]);
  let c;
  return (
    t[8] !== n || t[9] !== i || t[10] !== s
...
function Ce(e) {
  ...
  let a = i === `list` ? `text-sm leading-5` : `text-xs leading-[18px]`,
    o;
  t[4] !== n || t[5] !== a
    ? ((o = P(`truncate font-medium text-token-foreground`, a, n)),
      (t[4] = n),
      (t[5] = a),
      (t[6] = o))
    : (o = t[6]);
...
function we(e) {
  ...
  t[3] === n
    ? (i = t[4])
    : ((i = P(`text-xs leading-[18px] text-token-text-secondary`, n)), (t[3] = n), (t[4] = i));
  let a;
  return (
    t[5] !== r || t[6] !== i
      ? ((a = (0, Y.jsx)(`div`, { className: i, ...r })), (t[5] = r), (t[6] = i), (t[7] = a))
      : (a = t[7]),
    a
  );
}
...
function Ee(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Y.jsx)(B, { "aria-hidden": !0, className: `icon-xs` })), (t[4] = f))
    : (f = t[4]);
  let p;
  return (
...
function De(e) {
  ...
  let a = (i === void 0 ? !1 : i) && `[@container_(max-width:620px)]:hidden`,
    o;
  t[4] !== n || t[5] !== a
    ? ((o = P(`pl-4 text-xs leading-[18px] text-token-text-secondary`, a, n)),
      (t[4] = n),
      (t[5] = a),
      (t[6] = o))
    : (o = t[6]);
...
var J,
  ...
  Ae = e(() => {
    ((J = i()),
      ...
      H(),
      (Y = r()),
      (ke = `absolute inset-0 cursor-interaction rounded-xl bg-transparent focus-visible:ring-1 focus-visible:ring-token-focus-border focus-visible:outline-none focus-visible:ring-inset`));
  });
function je(e) {
  let t = (0, Me.c)(55),
  ...
  t[1] !== s || t[2] !== i
    ? ((m = s.formatMessage(
      ...
      (t[3] = m))
    : (m = t[3]);
  let h = o === `grid` ? `ghost` : `ghostTertiary`,
    g = o === `grid` ? `toolbar` : `composer`,
    _;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, X.jsx)(K, { "aria-hidden": !0, className: `icon-xs` })), (t[4] = _))
    : (_ = t[4]);
  let v;
  t[5] !== n || t[6] !== m || t[7] !== h || t[8] !== g
    ? ((v = (0, X.jsx)(C, {
        tooltipContent: f,
        children: (0, X.jsx)(w, {
          "aria-label": m,
  ...
  t[11] !== s || t[12] !== i
    ? ((x = s.formatMessage(
      ...
      (t[13] = x))
    : (x = t[13]);
  let S = o === `grid` ? `ghost` : `ghostTertiary`,
    T = o === `grid` ? `toolbar` : `composer`,
    E;
  t[14] !== l || t[15] !== r
    ? ((E = () => {
        l(N(r));
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, X.jsx)(se, { "aria-hidden": !0, className: `icon-xs` })), (t[17] = D))
    : (D = t[17]);
  let O;
  t[18] !== T || t[19] !== E || t[20] !== x || t[21] !== S
    ? ((O = (0, X.jsx)(C, {
        tooltipContent: b,
        children: (0, X.jsx)(w, {
          "aria-label": x,
  ...
  t[24] !== s || t[25] !== i
    ? ((P = s.formatMessage(
      ...
      (t[26] = P))
    : (P = t[26]);
  let F = o === `grid` ? `ghost` : `outline`,
    I = o === `grid`,
    L;
  t[27] !== r || t[28] !== u
    ? ((L = () => ue(u, _e, { projectId: r })), (t[27] = r), (t[28] = u), (t[29] = L))
    : (L = t[29]);
  let z;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, X.jsx)(ee, { "aria-hidden": !0, className: `icon-xs` })), (t[30] = z))
    : (z = t[30]);
  let B;
  t[31] === o
    ? (B = t[32])
    : ((B =
      ...
      (t[32] = B));
  let V;
  t[33] !== M || t[34] !== P || t[35] !== F || t[36] !== I || t[37] !== L || t[38] !== B
    ? ((V = (0, X.jsx)(C, {
        tooltipContent: j,
        children: (0, X.jsxs)(w, {
          className: M,
  ...
  t[48] !== a
    ? ((H = d
        ...
        : (0, X.jsxs)(X.Fragment, { children: [a === `sites` ? y : k, a === `sites` ? k : y] })),
      (t[40] = d),
      (t[41] = y),
      (t[42] = s),
      (t[43] = l),
  ...
  let U;
  t[50] !== V || t[51] !== H
    ? ((U = (0, X.jsxs)(X.Fragment, { children: [V, H] })), (t[50] = V), (t[51] = H), (t[52] = U))
    : (U = t[52]);
  let W = U;
  if (o === `grid`) return W;
  let G;
  return (
    t[53] === W ? (G = t[54]) : ((G = (0, X.jsx)(Oe, { children: W })), (t[53] = W), (t[54] = G)), G
  );
}
var Me,
  X,
...
function Ke(e, t) {
  if (t === `all`) return !0;
  let { accessMode: n, groupCount: r, userCount: i } = _(e.access_policy),
...
function Ye(e, t, n) {
  ...
  switch (n.type) {
    ...
    case `edit`:
      i = r.formatMessage(
        ...
        { siteMention: L({ projectId: n.projectId, title: n.projectTitle }) },
      );
      break;
  }
  let o;
  switch (n.type) {
    case `create`:
      o = le({ defaultPrompt: i, pluginDisplayName: `Sites`, pluginId: x });
      break;
    case `edit`:
      o = `${i} `;
      break;
