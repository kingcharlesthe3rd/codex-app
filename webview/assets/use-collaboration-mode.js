...
import { $s as t, Da as n, Ps as r, R as i, Xs as a } from "./app-server-manager-signals.js";
import { n as o } from "./jsx-runtime.js";
import { C as s, Y as c, bt as l, wt as u } from "./setting-storage.js";
import { r as d } from "./app-server-manager-hooks-DfDI-9lO.js";
...
function C(e) {
  ...
  r[27] !== E || r[28] !== k.length || r[29] !== L
    ...
    : (R = r[30]);
  let z;
  (r[31] !== E || r[32] !== k ? ((z = [k, E]), (r[31] = E), (r[32] = k), (r[33] = z)) : (z = r[33]),
    (0, S.useEffect)(R, z));
  let B;
  ...
  let H = !E,
    U;
  return (
    r[41] !== N || r[42] !== k || r[43] !== O || r[44] !== F || r[45] !== V || r[46] !== H
      ? ((U = {
          modes: k,
          activeMode: V,
          selectedMode: O,
