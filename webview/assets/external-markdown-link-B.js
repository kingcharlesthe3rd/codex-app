...
import { $n as a, er as o, hr as s, vr as c } from "./src-4.js";
import { Io as l, Mo as u } from "./app-server-manager-signals.js";
import { n as d } from "./lib-1.js";
import { t as f } from "./clsx.js";
import { t as p } from "./tooltip.js";
import { t as m } from "./context-menu.js";
import { t as h } from "./known-app-icon.js";
import { t as g } from "./external-link-source.js";
import { t as _ } from "./copy-to-clipboard.js";
import { a as v, i as y, n as b, o as ee, r as te, s as ne } from "./inline-mention-style.js";
import { t as x } from "./globe.js";
import { t as re } from "./external-link-favicon.js";
function S(e, t) {
...
function w(e, t, n) {
  if (n.validHosts !== null) {
    let e = n.validHosts;
    for (let n of e) if (S(t, n)) return n;
  }
  let r = 0;
  if (t.startsWith(`.`)) for (; r < t.length && t[r] === `.`; ) r += 1;
  return e.length === t.length - r ? null : C(t, e);
}
function T(e, t) {
...
function j(e) {
  if (
    e.length > 255 ||
    e.length === 0 ||
    (!A(e.charCodeAt(0)) && e.charCodeAt(0) !== 46 && e.charCodeAt(0) !== 95)
  )
    return !1;
  let t = -1,
    n = -1,
  ...
  for (let i = 0; i < r; i += 1) {
    ...
    if (r === 46) {
      ...
      t = i;
    } else if (!(A(r) || r === 45 || r === 95)) return !1;
    n = r;
  }
  ...
  return typeof e != `string` ||
    (a.extractHostname
      ? a.mixedInputs
        ...
        : (i.hostname = E(e, !1))
      : (i.hostname = e),
    a.detectIp && i.hostname !== null && ((i.isIp = k(i.hostname)), i.isIp))
    ? i
    : a.validateHostname && a.extractHostname && i.hostname !== null && !j(i.hostname)
      ? ((i.hostname = null), i)
      : (t === 0 ||
          i.hostname === null ||
          (n(i.hostname, a, i), t === 2 || i.publicSuffix === null) ||
          ((i.domain = w(i.publicSuffix, i.hostname, a)), t === 3 || i.domain === null) ||
          ((i.subdomain = P(i.hostname, i.domain)), t === 4) ||
          (i.domainWithoutSuffix = T(i.domain, i.publicSuffix)),
        i);
}
function oe(e, t, n) {
...
var I = (function () {
  ...
  se = (function () {
    let e = [1, {}],
      ...
      L = [0, { app: t }],
      ce = [0, { site: t }],
      R = [1, { com: e, edu: e, net: e, org: e }],
      z = [0, { j: t }],
      le = [0, { dyn: t }],
      ue = [2, { web: t }],
      de = [1, { co: e, com: e, edu: e, gov: e, net: e, org: e }],
      B = [0, { p: t }],
      fe = [0, { user: t }],
      pe = [1, { ms: t }],
      V = [0, { cdn: t }],
      ...
      me = [0, { cust: t }],
      W = [0, { s3: t }],
      G = [1, { biz: e, com: e, edu: e, gov: e, info: e, net: e, org: e }],
      K = [0, { ipfs: t }],
      q = [1, { framer: t }],
      J = [0, { forgot: t }],
      Y = [0, { core: [0, { blob: t, file: t, web: t }], servicebus: t }],
      X = [1, { gs: e }],
      he = [0, { nes: e }],
    ...
    return [
      0,
      {
        ...
        eu: [
          1,
          {
            amazonwebservices: [0, { on: [0, { "eusc-de-east-1": [0, { "cognito-idp": P }] }] }],
            cloudns: t,
            prvw: t,
            deuxfleurs: t,
            dogado: [0, { jelastic: t }],
        ...
        name: [1, { her: J, his: J, ispmanager: t, keenetic: t }],
        nc: [1, { asso: e, nom: e }],
        ne: e,
        net: [
          1,
        ...
        cloud: [
          1,
          {
            ...
            jote: t,
            jotelulu: t,
            k2: [0, { elastic: t, "ru-msk": ne, "ru-spb": ne, s3: t, website: t }],
            kuleuven: t,
            laravel: t,
            linkyard: t,
            magentosite: i,
        ...
        edeka: e,
        education: b,
        email: [1, { crisp: [0, { on: t }], intouch: t, tawk: B, tawkto: B }],
        emerck: e,
        energy: e,
        engineer: e,
        engineering: e,
...
`),
  ...
  if (u(n) && !n.startsWith(`//`) && !(n.startsWith(`/`) && t)) {
    let e = l(``, n),
      t = new URL(`file:///`);
    if (s(e)) {
      let n = e.indexOf(`/`, 2);
  ...
  let r = V(n);
  return ue(r) ? `http://${n}` : pe(n, r) ? `https://${n}` : me(n);
}
function le(e) {
  let t = e.trim();
  ...
  try {
    let e = new URL(t);
    if (e.protocol === `file:`) {
      let t = c(decodeURIComponent(e.pathname));
...
function ue(e) {
  return e != null && B(e.hostname);
}
function de(e) {
  return e.protocol !== `http:` && e.protocol !== `https:` ? !1 : B(e.hostname);
}
function B(e) {
  return o(e);
}
...
function pe(e, t) {
  return /\s/.test(e) || t == null
    ...
    : t.hostname.startsWith(`[`)
      ? H(t.hostname)
      : t.hasPort || t.hostname.startsWith(`www.`) || H(t.hostname) || U(t.hostname);
}
function V(e) {
  let t = e.search(/[/?#]/),
    n = t === -1 ? e : e.slice(0, t);
...
function K({ conversationId: e, url: t, source: n, initiator: r }) {
  let a = G(t);
  return a == null
    ? !1
...
function X({ conversationId: e, href: t, isBrowserSidebarEnabled: n }) {
  let r = Y(t);
  return e != null && n && J(t) && (W(t) || Z(r));
}
function he({ conversationId: e, href: t, initiator: n }) {
  let r = Y(t),
    a = Z(r);
  return [
    {
      ...
      onSelect: () => {
        if (a) {
          i.dispatchMessage(`open-in-browser`, { url: r, source: `manual`, initiator: n });
          return;
        }
        K({ conversationId: e, url: t, source: `manual`, initiator: n });
      },
    },
    {
      ...
      onSelect: () => {
        i.dispatchMessage(`open-in-browser`, { url: r, useExternalBrowser: !0 });
      },
    },
...
function Z(e) {
  try {
    ...
    return (t === `http:` || t === `https:`) && a(e);
  } catch {
    return !1;
  }
}
function ge({ conversationId: e, href: t, isBrowserSidebarEnabled: n }) {
  return X({ conversationId: e, href: t, isBrowserSidebarEnabled: n });
}
function Q({ conversationId: e, href: t }) {
  return he({ conversationId: e, href: t, initiator: `markdown_link_context_menu` });
}
function _e({
  conversationId: e = null,
  event: t,
  href: n,
  isBrowserSidebarEnabled: r = !1,
  ...
  if (
    ...
    r &&
    !ve(t) &&
    K({ conversationId: e, url: n, source: `manual`, initiator: `markdown_link_click` })
  )
...
function Se(e) {
  let t = (0, xe.c)(30),
    {
      ...
      openExternalLinksInThreadBrowserOnClick: o,
      originHostId: s,
    } = e,
    c = r === void 0 ? null : r,
    l = a === void 0 ? !1 : a,
    u = o === void 0 ? !1 : o,
    d = (0, ye.useContext)(be);
  if (!i) {
    let e;
    return (
      t[0] === n
  ...
  let f;
  t[2] !== c || t[3] !== i || t[4] !== l
    ? ((f = ge({ conversationId: c, href: i, isBrowserSidebarEnabled: l })),
      (t[2] = c),
      (t[3] = i),
      (t[4] = l),
      (t[5] = f))
  ...
  let p = f,
    m;
  t[6] === i ? (m = t[7]) : ((m = we(i)), (t[6] = i), (t[7] = m));
  let h = m,
    g = `_blank`;
  if (d == null) {
    let e;
    return (
      ...
      t[15] !== s
        ? ((e = (0, $.jsx)(Ce, {
            canShowContextMenu: p,
            conversationId: c,
            href: i,
            isBrowserSidebarEnabled: l,
            linkTarget: g,
            openExternalLinksInThreadBrowserOnClick: u,
            originHostId: s,
            sourceIcon: h,
            children: n,
          })),
  ...
  let v;
  return (
    t[26] !== d || t[27] !== i || t[28] !== _
      ? ((v = (0, $.jsx)(d, { href: i, iconClassName: y, children: _ })),
        (t[26] = d),
        (t[27] = i),
        (t[28] = _),
        (t[29] = v))
...
function Ce(e) {
  let t = (0, xe.c)(33),
    {
      ...
      originHostId: d,
      sourceIcon: h,
      tooltipDelayDuration: g,
    } = e,
    _ = o ?? s,
    y;
  t[0] !== i || t[1] !== s || t[2] !== c || t[3] !== u || t[4] !== d
    ? ((y = (e) => {
        _e({
          conversationId: i,
          event: e,
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = f(b, ne, te, `whitespace-nowrap`)), (t[6] = x))
    : (x = t[6]);
  let S;
  t[7] !== h || t[8] !== a || t[9] !== s
    ? ((S =
        a ??
        (h == null
          ? (0, $.jsx)(re, { className: `icon-xs absolute top-1/2 -translate-y-1/2`, href: s })
          : (0, $.jsx)(h, {
              "aria-hidden": !0,
  ...
  t[11] === S
    ? (C = t[12])
    : ((C = (0, $.jsx)(`span`, { "data-markdown-copy": `exclude`, className: v, children: S })),
      (t[11] = S),
      (t[12] = C));
  let w;
  t[13] === r
    ? (w = t[14])
    : ((w = (0, $.jsx)(`span`, { className: `break-words whitespace-normal`, children: r })),
      (t[13] = r),
      (t[14] = w));
  let T;
  t[15] !== C || t[16] !== w
    ? ((T = (0, $.jsxs)(`span`, { className: x, children: [C, w] })),
      (t[15] = C),
      (t[16] = w),
      (t[17] = T))
    : (T = t[17]);
  let E;
  t[18] !== s || t[19] !== l || t[20] !== y || t[21] !== T
    ? ((E = (0, $.jsx)(`a`, {
        className: ee,
        href: s,
    ...
    : (E = t[22]);
  let D;
  t[23] !== _ || t[24] !== E || t[25] !== g
    ? ((D = (0, $.jsx)(p, { delayDuration: g, tooltipContent: _, children: E })),
      (t[23] = _),
      (t[24] = E),
      (t[25] = g),
      (t[26] = D))
    : (D = t[26]);
  let O = D;
  if (i == null || !n) return O;
  let k;
  t[27] !== i || t[28] !== s
    ? ((k = Q({ conversationId: i, href: s })), (t[27] = i), (t[28] = s), (t[29] = k))
    : (k = t[29]);
  let A;
  return (
    t[30] !== O || t[31] !== k
      ? ((A = (0, $.jsx)(m, { items: k, children: O })), (t[30] = O), (t[31] = k), (t[32] = A))
      : (A = t[32]),
    A
  );
}
function we(e) {
  let t = g(e);
  return t == null ? null : (h(t.appId) ?? x);
}
export { he as a, le as c, X as i, R as l, be as n, K as o, ve as r, z as s, Se as t };
//# sourceMappingURL=external-markdown-link-B.js.map
