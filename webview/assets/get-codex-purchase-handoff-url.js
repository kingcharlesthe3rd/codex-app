...
import { _ as r, g as i, k as a, o, u as s } from "./vscode-api.js";
import { ta as c } from "./src-4.js";
import { On as l } from "./app-server-manager-signals.js";
import { i as u } from "./statsig-DoZ-0xit.js";
...
function O(e) {
  let t = (0, h.c)(8),
    { enabled: n } = e,
    { data: i, isLoading: a } = f(),
    o = i?.id ?? null,
    c;
  t[0] === o ? (c = t[1]) : ((c = [..._, E, o]), (t[0] = o), (t[1] = c));
  let l = n && !a && i != null,
    u;
  t[2] === i
    ? (u = t[3])
    : ((u = (e) => (i ? (e.accounts?.[i.id]?.entitlement?.billing_currency ?? null) : null)),
      (t[2] = i),
      (t[3] = u));
  let d;
  return (
...
function k(e) {
  ...
  t[2] === i
    ? (u = t[3])
    : ((u = (e) =>
        i ? (e.accounts?.[i.id]?.last_active_subscription.purchase_origin_platform ?? null) : null),
      (t[2] = i),
      (t[3] = u));
  let d;
  return (
...
function A(e) {
  ...
  let { accountId: a, isLoading: o } = V(i),
    c;
  t[2] === a ? (c = t[3]) : ((c = [...b, a]), (t[2] = a), (t[3] = c));
  let l = n && !o && a != null,
    u;
  t[4] === a
    ? (u = t[5])
...
function j(e) {
  ...
  let { accountId: a, isLoading: o } = V(i),
    c;
  t[2] === a ? (c = t[3]) : ((c = [...x, a]), (t[2] = a), (t[3] = c));
  let l = n && !o && a != null,
    u;
  t[4] === a ? (u = t[5]) : ((u = async () => (a == null ? null : H(a))), (t[4] = a), (t[5] = u));
  let d;
  return (
    t[6] !== c || t[7] !== l || t[8] !== u
      ? ((d = {
...
function P() {
  ...
  e[1] !== o || e[2] !== r
    ? ((c = {
        ...
        mutationFn: L,
        onSuccess: (e) => {
          m(e.immediate_top_up_status) || U({ scope: r, queryClient: o, response: e });
        },
      }),
      (e[1] = o),
      (e[2] = r),
  ...
  e[9] !== o || e[10] !== r
    ? ((_ = {
        ...
        mutationFn: F,
        onSuccess: (e) => {
          U({ scope: r, queryClient: o, response: e });
        },
      }),
      (e[9] = o),
      (e[10] = r),
...
function B() {
  ...
  e[4] !== r || e[5] !== t
    ? ((c = (e) => {
        (t.setQueryData([...x, r], (t) => W(t, e)), t.invalidateQueries({ queryKey: [...x, r] }));
      }),
      (e[4] = r),
      (e[5] = t),
      (e[6] = c))
...
function U({ scope: e, queryClient: t, response: n }) {
  (t.setQueryData(g, n), n.immediate_top_up_status === `succeeded` && e.query.invalidate(l));
}
function W(e, t) {
...
//# sourceMappingURL=get-codex-purchase-handoff-url.js.map
