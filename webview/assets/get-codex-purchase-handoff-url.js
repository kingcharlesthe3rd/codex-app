...
import { Mn as r } from "./app-server-manager-signals.js";
import { A as i, _ as a, o, u as s, v as c } from "./vscode-api.js";
import { Ca as l } from "./src-2.js";
import { i as u } from "./statsig.js";
import { t as d } from "./request.js";
import { t as f } from "./codex-api-error.js";
  ...
  t[4] === i
    ...
    : ((u = async () => {
        ...
        try {
          ...
          let t = e;
          if (t instanceof Error && f(t)?.message === w) return null;
          throw t;
        }
      }),
      (t[4] = i),
...
function V(e) {
  let t = (0, h.c)(8),
    { enabled: n } = e,
    { data: r, isLoading: i, hasEverErrored: a } = p(),
    c = r?.id == null && (!i || a),
    l = n && c,
    u;
  t[0] === l
  ...
  let { data: d, isLoading: f } = o(`account-info`, u);
  if (r?.id != null) {
    let e;
    return (
      t[2] === r.id
  ...
  return (
    t[5] !== f || t[6] !== m
      ? ((g = { accountId: m, isLoading: f }), (t[5] = f), (t[6] = m), (t[7] = g))
      : (g = t[7]),
    g
  );
}
