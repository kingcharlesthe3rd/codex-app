...
import { kn as r } from "./app-server-manager-signals.js";
import { _ as i, g as a, k as o, o as s, u as c } from "./vscode-api.js";
import { ua as l } from "./src-1.js";
import { i as u } from "./statsig.js";
...
function O(e) {
  let t = (0, h.c)(8),
    { enabled: n } = e,
    { data: r, isLoading: a } = f(),
    o = r?.id ?? null,
    s;
  t[0] === o ? (s = t[1]) : ((s = [..._, E, o]), (t[0] = o), (t[1] = s));
  let l = n && !a && r != null,
    u;
  t[2] === r
    ? (u = t[3])
...
function A(e) {
  ...
  let { accountId: a, isLoading: o } = V(r),
    s;
  t[2] === a ? (s = t[3]) : ((s = [...b, a]), (t[2] = a), (t[3] = s));
  let l = n && !o && a != null,
    u;
  t[4] === a
    ? (u = t[5])
...
function P() {
  ...
  e[1] !== i || e[2] !== r
    ? ((c = {
        ...
        mutationFn: L,
        onSuccess: (e) => {
          m(e.immediate_top_up_status) || U({ scope: r, queryClient: i, response: e });
        },
      }),
      (e[1] = i),
      (e[2] = r),
  ...
  e[9] !== i || e[10] !== r
    ? ((_ = {
        ...
        mutationFn: F,
        onSuccess: (e) => {
          U({ scope: r, queryClient: i, response: e });
        },
      }),
      (e[9] = i),
      (e[10] = r),
...
function B() {
  ...
  return (
    e[7] !== i || e[8] !== s || e[9] !== c
      ? ((l = { mutationKey: i, mutationFn: s, onSuccess: c }),
        (e[7] = i),
        (e[8] = s),
        (e[9] = c),
        (e[10] = l))
...
function U({ scope: e, queryClient: t, response: n }) {
  (t.setQueryData(g, n), n.immediate_top_up_status === `succeeded` && e.query.invalidate(r));
}
function W(e, t) {
