...
import { t } from "./line-DIsP-Yv_.js";
import { h as n } from "./step.js";
import { t as r } from "./clone-1.js";
import { s as i } from "./invert.js";
import { t as a } from "./channel-4.js";
import "./dist-5.js";
import "./marked.esm.js";
import { n as o, r as s } from "./chunk-4.js";
import {
  D as c,
  L as l,
  a as u,
...
import { c as g, h as _, i as v } from "./chunk-56.js";
import { n as y } from "./chunk-130.js";
import { t as b } from "./chunk-89.js";
import { n as x, t as S } from "./chunk-73.js";
import { n as C, t as w } from "./chunk-147.js";
import { t as T } from "./graphlib-1.js";
var E = (function () {
    ...
    for (let e of n) {
      if (
        (typeof a == `number` &&
          ...
          e.widthInColumns > a &&
          s.warn(`Block ${e.id} width ${e.widthInColumns} exceeds configured column width ${a}`),
        (e.label &&= ie(e.label)),
        e.type === `classDef`)
      ) {
        ae(e.id, e.css);
...
function R(e, t, n = 0, r = 0) {
  ...
  if (e.children?.length > 0) {
    ...
    ((i = o.width),
      (a = o.height),
      s.debug(`setBlockSizes abc95 maxWidth of`, e.id, `:s children is `, i, a));
    for (let t of e.children)
      t.size &&
        (s.debug(
          `abc95 Setting size of children of ${e.id} id=${t.id} ${i} ${a} ${JSON.stringify(t.size)}`,
        ),
        (t.size.width = i * (t.widthInColumns ?? 1) + I * ((t.widthInColumns ?? 1) - 1)),
        (t.size.height = a),
        (t.size.x = 0),
        (t.size.y = 0),
        s.debug(
...
function z(e, t) {
  ...
  let n = e.columns ?? -1;
  if (
    (s.debug(`layoutBlocks columns abc95`, e.id, `=>`, n, e), e.children && e.children.length > 0)
  ) {
    ...
    for (let r of e.children) {
      ...
      (n > 0 && (h = Math.min(h, n - (c % n))), (c += h), s.debug(`abc88 columnsPos`, r, c));
    }
  }
  s.debug(
...
var V = o(async (e, t, n, r = !1, i = !1) => {
  ...
  Te = o(async (t, n) => {
    ...
    (o.attr(`transform`, S(u, i)), (H[n.id] = a), (n.width = l.width), (n.height = l.height));
    let f;
    if (n.startLabelLeft) {
...
function W(e, t) {
  m(d()) && e && ((e.style.width = t.length * 9 + `px`), (e.style.height = `12px`));
}
...
var Ee = o((e, t) => {
    ...
    if (e.startLabelLeft) {
      let t = U[e.id].startLeft,
        ...
        i = e.y;
      if (n) {
        let t = _.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, `start_left`, n);
        ((r = t.x), (i = t.y));
      }
    ...
    if (e.startLabelRight) {
      let t = U[e.id].startRight,
        ...
        i = e.y;
      if (n) {
        let t = _.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, `start_right`, n);
        ((r = t.x), (i = t.y));
      }
      t.attr(`transform`, `translate(${r}, ${i})`);
    }
    if (e.endLabelLeft) {
      let t = U[e.id].endLeft,
        ...
        i = e.y;
      if (n) {
        let t = _.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, `end_left`, n);
        ((r = t.x), (i = t.y));
      }
      t.attr(`transform`, `translate(${r}, ${i})`);
    }
    if (e.endLabelRight) {
      let t = U[e.id].endRight,
        ...
        i = e.y;
      if (n) {
        let t = _.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, `end_right`, n);
        ((r = t.x), (i = t.y));
      }
      t.attr(`transform`, `translate(${r}, ${i})`);
    }
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    if (Math.abs(i - t.y) * o > Math.abs(r - t.x) * l) {
      ...
      return (
        s.debug(`sides calc abc89, Q ${u}, q ${e}, R ${d}, r ${c}`, { _x: i, _y: a }),
        c === 0 && ((i = t.x), (a = t.y)),
        d === 0 && (i = t.x),
        u === 0 && (a = t.y),
        { x: i, y: a }
  ...
  Ae = o(function (e, r, i, a, o, l, u) {
    ...
    let C = e
        ...
        .attr(`style`, i.style),
      w = ``;
    ((d().flowchart.arrowMarkerAbsolute || d().state.arrowMarkerAbsolute) && (w = c(!0)),
      Se(C, i, w, u, o));
    let T = {};
...
var K = {
  ...
  q = o(async (t, n, r, i) => {
    ...
    let c = t
      ...
      f;
    f = n.labelText === void 0 ? `` : typeof n.labelText == `string` ? n.labelText : n.labelText[0];
    let p;
    p =
    ...
    return (
      s
        ? u.attr(`transform`, `translate(` + -h.width / 2 + `, ` + -h.height / 2 + `)`)
...
var Ue = o(async (e, t) => {
  ...
  X = o((e, t) => `${t || `node default`}${We(e.classes)} ${We(e.class)}`, `getClassesFromNode`),
  Ge = o(async (e, t) => {
...
var at = o(async (t, n) => {
    ...
    let i = t
      ...
      u = ``;
    ((u = typeof l == `object` ? l[0] : l), s.info(`Label text abc79`, u, l, typeof l == `object`));
    ...
    return (
      ...
      (p = c.node().getBBox()),
      c.attr(`transform`, `translate(` + -p.width / 2 + `, ` + (-p.height / 2 - v + 3) + `)`),
      a
  ...
  ft = {
    ...
    class_box: o(async (t, n) => {
      ...
      let a = t
        ...
        g = await V(
          f,
          n.classData.annotations[0] ? `«` + n.classData.annotations[0] + `»` : ``,
          n.labelStyle,
          !0,
          !0,
        ),
      ...
      n.classData.type !== void 0 &&
        n.classData.type !== `` &&
        (m(d()) ? (v += `&lt;` + n.classData.type + `&gt;`) : (v += `<` + n.classData.type + `>`));
      ...
      if (
        ...
        let t = (l - _.width) / 2;
        (e(g).attr(`transform`, `translate( ` + ((-1 * l) / 2 + t) + `, ` + (-1 * u) / 2 + `)`),
          (p = _.height + 4));
      }
      let C = (l - b.width) / 2;
      return (
