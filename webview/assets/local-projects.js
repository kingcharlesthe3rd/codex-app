...
import { Ba as i, Fi as a, Ia as o, Li as s, po as c } from "./app-server-manager-signals.js";
...
async function v({
  ...
  if (c.folderPath != null) {
    (u.dispatchMessage(`electron-rename-workspace-root-option`, { root: c.folderPath, label: l }),
      s?.(c.folderPath, l));
    return;
  }
  let d = e?.[c.projectId];
    ...
    d =
      l.metadataProjectId == null
        ...
        : [
            s(
              r.LOCAL_PROJECTS,
              t({ localProjects: n ?? {}, projectId: l.metadataProjectId, project: null }),
            ),
...
async function T({ projectId: t, prompt: i, validateProjectId: a = !1 }) {
  let [{ value: o }, { value: s }, u] = await Promise.all([
      ...
      a ? l(`workspace-root-options`, { params: { hostId: c } }) : Promise.resolve(null),
    ]),
    d = e(o),
    f = Object.hasOwn(d, t);
...
`)}`,
  ...
  let h = await p({ projectId: t, projectWritableRoots: m, legacyRoot: f ? null : t, prompt: i });
  return {
    cwd: h.cwd,
