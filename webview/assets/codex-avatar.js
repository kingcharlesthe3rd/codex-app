...
var l,
  ...
  d,
  f = e(() => {
    d = `` + new URL(`codex-spritesheet-v4-Bl6P89d_.webp`, import.meta.url).href;
  }),
  p,
  m = e(() => {
    p = `` + new URL(`dewey-spritesheet-v4-gAYk_M9g.webp`, import.meta.url).href;
  }),
  h,
  g = e(() => {
    h = `` + new URL(`fireball-spritesheet-v4-BtU8R9Qp.webp`, import.meta.url).href;
  }),
  _,
  v = e(() => {
    _ = `` + new URL(`hoots-spritesheet-v4-BYSNdvho.webp`, import.meta.url).href;
  }),
  y,
  b = e(() => {
    y = `` + new URL(`null-signal-spritesheet-v4-CCoTR-8t.webp`, import.meta.url).href;
  }),
  x,
  S = e(() => {
    x = `` + new URL(`rocky-spritesheet-v4-3RlTi26B.webp`, import.meta.url).href;
  }),
  C,
  w = e(() => {
  ...
  T,
  E = e(() => {
    T = `` + new URL(`stacky-spritesheet-v4-CaUJd4fY.webp`, import.meta.url).href;
  });
function D(e) {
  let t = (0, j.c)(6),
          ...
          c = window.setTimeout(() => {
            ...
            if (n >= r.length) {
              if (t.loopStartIndex != null) {
                ((a = t.loopStartIndex), (e.style.backgroundPosition = A(r[a])), l());
                return;
              }
              c = null;
              return;
...
function V(e) {
  let t = (0, W.c)(14),
    { assetRef: r, className: i, spritesheetUrl: a, state: o } = e,
    c = o === void 0 ? `idle` : o,
    l = (0, G.useRef)(null),
    u = n(),
    d;
  t[0] === r ? (d = t[1]) : ((d = H(r)), (t[0] = r), (t[1] = d));
  let f = d,
    p;
  (t[2] !== u || t[3] !== c
    ...
    D(p));
  let m;
  t[5] === i ? (m = t[6]) : ((m = s(`codex-avatar-root`, i)), (t[5] = i), (t[6] = m));
  let h = `url(${a ?? q[f]})`,
    g;
  t[7] === h ? (g = t[8]) : ((g = { backgroundImage: h }), (t[7] = h), (t[8] = g));
  let _;
  return (
    t[9] !== f || t[10] !== c || t[11] !== m || t[12] !== g
      ? ((_ = (0, K.jsx)(`div`, {
          ref: l,
          className: m,
