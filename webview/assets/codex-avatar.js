...
import { S as a, X as o, _ as s, a as c, i as l, rt as u, wt as d } from "./setting-storage.js";
...
function y(e) {
  let n = (0, g.c)(9),
    ...
    s;
  n[0] !== e || n[1] !== i ? ((s = v(i, e)), (n[0] = e), (n[1] = i), (n[2] = s)) : (s = n[2]);
  let u;
  n[3] === r
    ? (u = n[4])
    : ((u = (e) => {
  ...
  return (
    n[5] !== i || n[6] !== s || n[7] !== u
      ? ((d = { selectedAvatar: s, selectedAvatarId: i, setSelectedAvatarId: u }),
        (n[5] = i),
        (n[6] = s),
        (n[7] = u),
        (n[8] = d))
