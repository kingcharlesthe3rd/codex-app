...
import { i as E } from "./react.js";
import { o as D } from "./lib-2.js";
import { o as O, p as k } from "./statsig.js";
import { t as A } from "./request.js";
import { t as j } from "./route-scope.js";
import { a as M } from "./setting-storage.js";
import { g as N, h as ee } from "./diff-view-mode.js";
import { n as te } from "./app-shell-tab-controller.js";
import { N as ne } from "./review-navigation-model.js";
import { i as re } from "./thread-context.js";
...
import { A as I } from "./app-server-dynamic-tools.js";
import { c as L, i as R } from "./local-conversation-background-terminals-model.js";
...
function xe(e) {
  ...
  return (
    t[0] !== o || t[1] !== s || t[2] !== a || t[3] !== i || t[4] !== c
      ? ((l = () =>
          ne(c, { conversationSource: o, diffSource: s }, { orchestrationId: i, isDefault: a })),
        (u = [o, s, a, i, c]),
        (t[0] = o),
        (t[1] = s),
        (t[2] = a),
...
function Ne(e) {
  ...
  return (
    t[0] === e
      ? ((n = t[1]), (r = t[2]))
      : ((n = (t) => s.subscribeToSessionSnapshot(e, t)),
        (r = () => s.getSnapshot(e)),
        (t[0] = e),
        (t[1] = n),
        (t[2] = r)),
...
//# sourceMappingURL=process-manager-target-CiTD-21N.js.map
