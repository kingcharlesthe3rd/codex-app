...
import { G as n } from "./src-4.js";
import { mr as r, sr as i } from "./app-server-manager-signals.js";
...
function f({ codexHome: e, cwd: t, gitMetadata: r, hostId: i }) {
  return t == null
...
var p = t(a, ({ get: e }) =>
    r(e(c), e(o), e(l), `local_conversation_thread`, { watchForGitInit: !0 }),
  ),
  m = e(a, ({ get: e }) => {
    let t = e(p),
      n = t.data ?? null;
