import { c as e, m as t } from "./app-scope.js";
import { br as n, pr as r } from "./app-server-manager-signals.js";
import { J as i } from "./src-2.js";
import { t as a } from "./route-scope.js";
import { a as o, i as s, n as c, r as l, t as u } from "./thread-context-BQm-6r7t.js";
import { t as d } from "./git-current-branch-query.js";
function f({ codexHome: e, cwd: t, gitMetadata: n, hostId: r }) {
  return t == null
...
var p = t(a, ({ get: e }) =>
    n(e(c), e(o), e(l), `local_conversation_thread`, { watchForGitInit: !0 }),
  ),
  m = e(a, ({ get: e }) => {
    let t = e(p),
      n = t.data ?? null;
