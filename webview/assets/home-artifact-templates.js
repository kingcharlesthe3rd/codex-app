...
`),
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (e) => {
        ...
        (c(e.scrollLeft > n + 1), d(e.scrollLeft < t - 1));
      }),
      (e[2] = x))
    : (x = e[2]);
  let S = le(x),
    C = (e) => {
      if (
        ...
        (n.current = e),
        e == null || de === `` || (S(e), typeof ResizeObserver > `u`))
      )
        return;
  ...
  e[9] !== p || e[10] !== S
    ? ((j = (e) => {
        ...
        let { maximum: r, minimum: i } = L(t),
          o = (0, z.default)(t.scrollLeft + e * t.clientWidth, i, r);
        if ((a.current?.stop(), t.style.removeProperty(`scroll-snap-type`), p)) {
          (t.scrollTo({ left: o }), S(t));
          return;
        }
        ((t.style.scrollSnapType = `none`),
          (a.current = te(t.scrollLeft, o, {
            duration: 0.2,
