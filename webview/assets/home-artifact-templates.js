...
import { o as r, t as i } from "./app-scope-CWE-zIhQ.js";
import "./isEqual.js";
import { l as a, r as o, s } from "./lib-1.js";
import { t as c } from "./clsx.js";
import { r as l } from "./toast-signal.js";
import "./composer-footer.js";
import { n as u, r as d, t as f } from "./home-row-layout.js";
import { t as p } from "./arrow-left.js";
import { n as m, t as h } from "./use-composer-controller.js";
var g = e(t(), 1),
  _ = `` + new URL(`budget-planner-B_xX3PJl.xlsx`, import.meta.url).href,
  v = `` + new URL(`content-calendar-D2hO7r4o.xlsx`, import.meta.url).href,
  y = `` + new URL(`design-review-DfDJVwWu.pptx`, import.meta.url).href,
  b = `` + new URL(`meeting-notes-hfgk-Kdr.docx`, import.meta.url).href,
  x = `` + new URL(`monthly-business-review-CqJbQRLF.pptx`, import.meta.url).href,
  S = `` + new URL(`budget-planner-DdzCe8wU.png`, import.meta.url).href,
  C = `` + new URL(`content-calendar-Ct37j4gK.png`, import.meta.url).href,
  w = `` + new URL(`design-review-D5ZTsvgZ.png`, import.meta.url).href,
  T = `` + new URL(`meeting-notes-HtllKJ8V.png`, import.meta.url).href,
  E = `` + new URL(`monthly-business-review-iy1-PqJc.png`, import.meta.url).href,
  D = `` + new URL(`project-brief-bL95n3Ke.png`, import.meta.url).href,
  O = `` + new URL(`project-tracker-BsrXHgJI.png`, import.meta.url).href,
  k = `` + new URL(`report-outline-CQViP9Z5.png`, import.meta.url).href,
  A = `` + new URL(`sales-discovery-CFt_AKqR.png`, import.meta.url).href,
  j = `` + new URL(`project-brief-Dgi4V0mX.docx`, import.meta.url).href,
  M = `` + new URL(`project-tracker-BL3pNzWv.xlsx`, import.meta.url).href,
  N = `` + new URL(`report-outline-DUfNp9Wv.docx`, import.meta.url).href,
  P = `` + new URL(`sales-discovery-DI8H6s1v.pptx`, import.meta.url).href,
  F = [
    {
      id: `project-brief`,
      kind: `document`,
  ...
  return (
    e.descendants((e) => {
      if (t != null || (e.type.name !== `skillMention` && e.type.name !== `pluginMention`))
        return !0;
      let n = z(typeof e.attrs.path == `string` ? e.attrs.path : ``);
      return (n != null && (t = n), !0);
    }),
    t
  );
...
function z(e) {
  ...
  if (t.startsWith(L)) return B(t.slice(9).split(`@`)[0]);
...
var V = {
  ...
  H = n(),
  U = 25;
function W({ backPrompt: e, canUseTemplateAttachments: t, onAddFileAssetAttachment: n }) {
  let o = r(i),
    _ = h(),
    v = a(),
    y = m(_, (e) => R(e.view.state.doc)),
    b = y == null ? null : I(y),
    [x, S] = (0, g.useState)(null),
    C = x != null;
  if (!t || b == null || b.length === 0) return null;
  let w = y === `document`,
    T = async (e) => {
      S(e.id);
      try {
        (await n({ assetUrl: e.assetUrl, label: e.filename }), _.focus());
      } catch {
        o.get(l).danger(
          v.formatMessage({
  ...
  return (0, H.jsxs)(`section`, {
    ...
    children: [
      ...
      (0, H.jsx)(`div`, {
        className: c(`grid grid-cols-1 gap-4 px-3`, w ? `sm:grid-cols-4` : `sm:grid-cols-3`),
        children: b.map((e, t) => {
          let n = x === e.id;
          return (0, H.jsxs)(
            `button`,
            {
              ...
              style: { animationDelay: `calc(var(--transition-duration-basic) + ${t * U}ms)` },
        ...
        : (0, H.jsx)(`button`, {
            ...
            children: (0, H.jsxs)(f, {
              children: [
                (0, H.jsx)(u, {
                  "aria-hidden": `true`,
                  children: (0, H.jsx)(p, { className: `icon-xs shrink-0` }),
                }),
                (0, H.jsx)(d, {
                  children: (0, H.jsx)(s, {
...
export { W as HomeArtifactTemplates };
