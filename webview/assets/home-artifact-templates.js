...
function I() {
  let e = (0, R.c)(50),
    ...
    g = h != null,
    v;
  e[0] === g ? (v = e[1]) : ((v = { enabled: g }), (e[0] = g), (e[1] = v));
  let { skills: y } = ne(d ?? void 0, f, v),
    b = h == null ? [] : ve(y, h),
    ue = b.map(be).join(`
`),
    x;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (e) => {
        ...
        (c(e.scrollLeft > n + 1), u(e.scrollLeft < t - 1));
      }),
      (e[2] = x))
    : (x = e[2]);
  let S = ie(x),
    C = (e) => {
      if (
        ...
        (n.current = e),
        e == null || ue === `` || (S(e), typeof ResizeObserver > `u`))
      )
        return;
  ...
  if (h == null || b.length === 0) return null;
  let w;
  e[3] === y ? (w = e[4]) : ((w = y.find(ye)), (e[3] = y), (e[4] = w));
  let T = w,
    E = h === `document`,
    D;
  e[5] === m
  ...
  e[9] !== p || e[10] !== S
    ? ((j = (e) => {
        let t = n.current;
        if (t == null) return;
        let { maximum: r, minimum: i } = L(t),
          a = (0, z.default)(t.scrollLeft + e * t.clientWidth, i, r);
        if ((o.current?.stop(), t.style.removeProperty(`scroll-snap-type`), p)) {
          (t.scrollTo({ left: a }), S(t));
          return;
        }
        ((t.style.scrollSnapType = `none`),
          (o.current = oe(t.scrollLeft, a, {
            duration: 0.2,
  ...
  let K;
  e[24] !== s || e[25] !== l || e[26] !== I || e[27] !== U || e[28] !== W || e[29] !== G
    ? ((K = (0, V.jsx)(le, {
        backLabel: I,
        canGoBack: s,
        canGoForward: l,
