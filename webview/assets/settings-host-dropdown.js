...
import { Tr as a, wr as o } from "./app-initial~app-main~onboarding-page.js";
import {
  O as s,
  S as c,
  dt as l,
...
function C(e) {
  let n = (0, E.c)(43),
    ...
    M;
  n[0] !== r || n[1] !== l
    ? ((M = r.find((e) => e.hostId === l) ?? null), (n[0] = r), (n[1] = l), (n[2] = M))
    : (M = n[2]);
  let N = M,
    P;
  n[3] !== j || n[4] !== _
  ...
  let F = P,
    I = N?.displayName ?? F,
    L;
  n[6] === F ? (L = n[7]) : ((L = { hostId: t, displayName: F }), (n[6] = F), (n[7] = L));
  let R;
  n[8] !== r || n[9] !== L ? ((R = [L, ...r]), (n[8] = r), (n[9] = L), (n[10] = R)) : (R = n[10]);
  let z = R,
    B = C ? `hidden` : void 0,
    V;
  n[11] !== O || n[12] !== s || n[13] !== N || n[14] !== A
    ? ((V =
        N == null
  ...
  let U;
  n[18] !== N || n[19] !== k
    ? ((U = N != null && k ? (0, D.jsx)(w, {}) : null), (n[18] = N), (n[19] = k), (n[20] = U))
    : (U = n[20]);
  let W;
  n[21] !== C ||
  n[22] !== V ||
  ...
  return (
    n[38] !== K || n[39] !== q || n[40] !== Y || n[41] !== G
      ? ((X = (0, D.jsxs)(c, { align: K, contentWidth: q, triggerButton: G, children: [J, Y] })),
        (n[38] = K),
        (n[39] = q),
        (n[40] = Y),
        (n[41] = G),
...
function T(e) {
  ...
  if (!a) {
    let e;
    t[0] === n ? (e = t[1]) : ((e = p(n, `text-token-foreground`)), (t[0] = n), (t[1] = e));
    let r;
    return (
  ...
  return (
    t[4] !== n || t[5] !== r || t[6] !== i
      ? ((o = (0, D.jsx)(x, { className: n, hostId: r, hostIdsForColorAssignment: i })),
        (t[4] = n),
        (t[5] = r),
        (t[6] = i),
        (t[7] = o))
