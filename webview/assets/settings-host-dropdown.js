...
function C(e) {
  let r = (0, E.c)(43),
    ...
    M;
  r[0] !== a || r[1] !== u
    ? ((M = a.find((e) => e.hostId === u) ?? null), (r[0] = a), (r[1] = u), (r[2] = M))
    : (M = r[2]);
  let N = M,
    P;
  r[3] !== j || r[4] !== g
  ...
  let F = P,
    I = N?.displayName ?? F,
    L;
  r[6] === F ? (L = r[7]) : ((L = { hostId: i, displayName: F }), (r[6] = F), (r[7] = L));
  let R;
  r[8] !== a || r[9] !== L ? ((R = [L, ...a]), (r[8] = a), (r[9] = L), (r[10] = R)) : (R = r[10]);
  let z = R,
    B = C ? `hidden` : void 0,
    V;
  r[11] !== O || r[12] !== l || r[13] !== N || r[14] !== A
    ? ((V =
        N == null
  ...
  let U;
  r[18] !== N || r[19] !== k
    ? ((U = N != null && k ? (0, D.jsx)(w, {}) : null), (r[18] = N), (r[19] = k), (r[20] = U))
    : (U = r[20]);
  let W;
  r[21] !== C ||
  r[22] !== V ||
  ...
  let X;
  return (
    r[38] !== K || r[39] !== q || r[40] !== Y || r[41] !== G
      ? ((X = (0, D.jsxs)(s, { align: K, contentWidth: q, triggerButton: G, children: [J, Y] })),
        (r[38] = K),
        (r[39] = q),
        (r[40] = Y),
        (r[41] = G),
...
function T(e) {
  ...
  if (!a) {
    let e;
    t[0] === n ? (e = t[1]) : ((e = g(n, `text-token-foreground`)), (t[0] = n), (t[1] = e));
    let r;
    return (
      t[2] === e ? (r = t[3]) : ((r = (0, D.jsx)(l, { className: e })), (t[2] = e), (t[3] = r)), r
    );
  }
  let o;
  return (
    t[4] !== n || t[5] !== r || t[6] !== i
      ? ((o = (0, D.jsx)(S, { className: n, hostId: r, hostIdsForColorAssignment: i })),
        (t[4] = n),
        (t[5] = r),
        (t[6] = i),
        (t[7] = o))
