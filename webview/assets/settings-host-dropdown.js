...
import { Sn as _, xn as v } from "./app-initial~app-main~onboarding-page.js";
import {
  H as y,
  K as b,
...
function C(e) {
  let t = (0, E.c)(43),
    ...
    M;
  t[0] !== a || t[1] !== d
    ? ((M = a.find((e) => e.hostId === d) ?? null), (t[0] = a), (t[1] = d), (t[2] = M))
    : (M = t[2]);
  let N = M,
    P;
  t[3] !== j || t[4] !== g
  ...
  let F = P,
    I = N?.displayName ?? F,
    L;
  t[6] === F ? (L = t[7]) : ((L = { hostId: r, displayName: F }), (t[6] = F), (t[7] = L));
  let R;
  t[8] !== a || t[9] !== L ? ((R = [L, ...a]), (t[8] = a), (t[9] = L), (t[10] = R)) : (R = t[10]);
  let z = R,
    B = C ? `hidden` : void 0,
    V;
  t[11] !== O || t[12] !== l || t[13] !== N || t[14] !== A
    ? ((V =
        N == null
  ...
  return (
    t[38] !== K || t[39] !== q || t[40] !== Y || t[41] !== G
      ? ((X = (0, D.jsxs)(u, { align: K, contentWidth: q, triggerButton: G, children: [J, Y] })),
        (t[38] = K),
        (t[39] = q),
        (t[40] = Y),
        (t[41] = G),
...
function T(e) {
  ...
  if (!o) {
    let e;
    n[0] === r ? (e = n[1]) : ((e = f(r, `text-token-foreground`)), (n[0] = r), (n[1] = e));
    let i;
    return (
      n[2] === e ? (i = n[3]) : ((i = (0, D.jsx)(t, { className: e })), (n[2] = e), (n[3] = i)), i
    );
  }
  let s;
  return (
