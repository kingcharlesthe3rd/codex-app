...
import { Jn as _, qn as v } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
import {
  H as y,
  R as b,
...
function C(e) {
  ...
  let F = P,
    I = N?.displayName ?? F,
    L;
  t[6] === F ? (L = t[7]) : ((L = { hostId: h, displayName: F }), (t[6] = F), (t[7] = L));
  let R;
...
function T(e) {
  let t = (0, E.c)(8),
    { className: n, hostId: r, hostIdsForColorAssignment: a, useRemoteHostColors: o } = e;
  if (!o) {
    let e;
    t[0] === n ? (e = t[1]) : ((e = l(n, `text-token-foreground`)), (t[0] = n), (t[1] = e));
    let r;
    return (
      t[2] === e ? (r = t[3]) : ((r = (0, D.jsx)(i, { className: e })), (t[2] = e), (t[3] = r)), r
    );
  }
  let s;
  return (
    t[4] !== n || t[5] !== r || t[6] !== a
      ? ((s = (0, D.jsx)(x, { className: n, hostId: r, hostIdsForColorAssignment: a })),
        (t[4] = n),
        (t[5] = r),
        (t[6] = a),
        (t[7] = s))
