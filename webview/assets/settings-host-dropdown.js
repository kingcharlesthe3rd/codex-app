...
import { Mr as r, Nr as i } from "./app-initial~app-main~onboarding-page.js";
import {
  lS as a,
  uS as o,
...
function C(e) {
  let t = (0, E.c)(43),
    ...
    M;
  t[0] !== n || t[1] !== u
    ? ((M = n.find((e) => e.hostId === u) ?? null), (t[0] = n), (t[1] = u), (t[2] = M))
    : (M = t[2]);
  let N = M,
    P;
  t[3] !== j || t[4] !== h
  ...
  let F = P,
    I = N?.displayName ?? F,
    L;
  t[6] === F ? (L = t[7]) : ((L = { hostId: d, displayName: F }), (t[6] = F), (t[7] = L));
  let R;
  ...
  return (
    t[38] !== K || t[39] !== q || t[40] !== Y || t[41] !== G
      ? ((X = (0, D.jsxs)(_, { align: K, contentWidth: q, triggerButton: G, children: [J, Y] })),
        (t[38] = K),
        (t[39] = q),
        (t[40] = Y),
        (t[41] = G),
...
function T(e) {
  ...
  if (!a) {
    let e;
    t[0] === n ? (e = t[1]) : ((e = f(n, `text-token-foreground`)), (t[0] = n), (t[1] = e));
    let r;
    return (
  ...
  return (
    t[4] !== n || t[5] !== r || t[6] !== i
      ? ((o = (0, D.jsx)(b, { className: n, hostId: r, hostIdsForColorAssignment: i })),
        (t[4] = n),
        (t[5] = r),
        (t[6] = i),
        (t[7] = o))
