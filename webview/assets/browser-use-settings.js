...
import { J as Zt, K as Qt } from "./app-initial~app-main~automations-page.js";
import {
  b as $t,
  x as en,
  y as tn,
...
function Yn(e) {
  let t = (0, Xn.c)(6),
    { service: n } = e,
    r = C(L);
  if (!Ot(`1834314516`)) return null;
  let i = n ?? Ce.browserProfileImport;
  ...
  return (
    t[4] === a
      ? (s = t[5])
      : ((s = (0, Zn.jsx)(_, { color: `secondary`, size: `toolbar`, onClick: a, children: o })),
        (t[4] = a),
        (t[5] = s)),
    s
  );
...
function or(e) {
  ...
  t[3] !== n || t[4] !== i.search || t[5] !== o?.params
    ? ((v = gr({ kind: n, search: i.search, siteSettingsRoutePath: o?.params[`*`] ?? null })),
      (y = vr(n, v)),
      (t[3] = n),
      (t[4] = i.search),
      (t[5] = o?.params),
    ...
    : ((v = t[6]), (y = t[7]));
  let x = y,
    C = d?.initialUrl === v ? d : null,
    w = C?.url ?? v,
    T = p?.url === w ? p.title : null,
    E;
  t[8] !== w || t[9] !== n ? ((E = jr(n, w)), (t[8] = w), (t[9] = n), (t[10] = E)) : (E = t[10]);
  let D = E,
    O = en($t()),
    k;
  t[11] === r
  ...
  let P = (0, Ir.useEffectEvent)(N),
    F;
  t[17] !== v || t[18] !== n || t[19] !== P || t[20] !== h.partition || t[21] !== _ || t[22] !== x
    ? ((F = () => {
        let e = s.current;
        if (e == null) return;
        let t = window.electronBridge?.sendMessageFromView,
          ...
          p = () => {
            !i ||
              ...
              t({ mountId: r, type: `browser-settings-webview-unmounted` }).catch((e) => {
                mt.warning(`Failed to unmount browser settings webview`, {
                  safe: { kind: n },
                  sensitive: { error: e },
                });
              }));
          };
        ((l.current = Dr(n, v)), (u.current = null));
        let g = (e) => {
            let t = o;
            t != null &&
              Cr(t).then((n) => {
                a || o !== t || Sr(t, v) !== e || m(n == null ? null : { title: n, url: e });
              });
          },
          y = () => {
            if (o == null || a) return;
            let e = yr(o, v),
              t = d != null && e.url === x ? { ...e, url: d } : e,
              r = u.current,
              i = Or(l.current ?? Dr(n, v), t.url, r);
          ...
          S = () => {
            ...
            let e = d;
            ((d = null),
              kr({ sourceUrl: x, targetUrl: e, webview: o }).catch((t) => {
                mt.warning(`Failed to open initial browser settings URL`, {
                  safe: { kind: n },
        ...
        return (
          (async () => {
            try {
              ...
              for (let e of b) o.addEventListener(e, y);
              ((c.current = o), e.append(o), y());
            } catch (e) {
              let t = e;
              mt.error(`Failed to mount browser settings webview`, {
                safe: { kind: n },
                sensitive: { error: t },
              });
            }
          ...
          () => {
            ...
            for (let e of b) o?.removeEventListener(e, y);
            (o?.remove(), o != null && mr(o), p());
          }
        );
      }),
      (t[17] = v),
    ...
    : (F = t[23]);
  let ee;
  (t[24] !== v || t[25] !== n || t[26] !== h || t[27] !== _ || t[28] !== x
    ? ((ee = [v, n, h, _, x]),
      (t[24] = v),
      (t[25] = n),
      (t[26] = h),
    ...
    ? ((I = (e) => {
      ...
      (re = (e) => {
        ...
        return (
          (l.current = o),
          (u.current = e),
          f(Er({ history: o, initialUrl: v, url: i, webview: t })),
          kr({ sourceUrl: a, targetUrl: i, webview: t }).catch((e) => {
            mt.warning(`Failed to navigate browser settings webview`, {
              safe: { kind: n },
  ...
  t[51] === I
    ...
    : ((de = () => {
      ...
      (t[52] = de));
  let L;
  t[53] !== A || t[54] !== M || t[55] !== se || t[56] !== ce || t[57] !== ue || t[58] !== de
    ? ((L = (0, K.jsx)(`div`, {
    ...
    ? ((b =
        u == null
          ? (0, K.jsx)(`span`, {
              ...
              children: (0, K.jsx)(B, { ...c.breadcrumbLabel }),
            })
          : (0, K.jsxs)(K.Fragment, {
              children: [
                (0, K.jsx)(cr, { onClick: a, children: (0, K.jsx)(B, { ...c.breadcrumbLabel }) }),
                (0, K.jsx)(lr, {}),
...
function lr() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, K.jsx)(_e, { className: `icon-xs text-token-text-secondary` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
...
function pr(e, t) {
  ...
  if (t != null) return t;
  let r = Nr(n);
  return r == null ? Pr(n) : (0, K.jsx)(B, { ...r });
}
function mr(e) {
  hr(e) && e.destroy();
}
...
function gr({ kind: e, search: t, siteSettingsRoutePath: n }) {
  let r = Lr[e];
  return e === `siteSettings` ? (ze(new URLSearchParams(t).get(`site`)) ?? _r(n) ?? r.url) : r.url;
}
function _r(e) {
...
function vr(e, t) {
  return e === `siteSettings` && Mr(t) === `siteDetails` ? Ct : t;
}
function yr(e, t) {
...
function Dr(e, t) {
  return e !== `siteSettings` || Mr(t) == null
    ...
    : { entries: [Ct, t], index: 1, preferHistoryControls: !0 };
}
function Or(e, t, n) {
      ...
      : ((r = (0, q.jsx)(je, {
          ...
          children: (0, q.jsxs)(W, {
            children: [
              n,
              (0, q.jsx)(W.Content, {
                children: (0, q.jsx)(U, { children: (0, q.jsx)(Br, { hostId: t }) }),
              }),
            ],
          }),
        })),
...
function Br(e) {
  let t = (0, Vr.c)(25),
    { hostId: n } = e,
    r = pt(),
    { data: i, isLoading: a } = A(mn),
    o;
  t[0] === n ? (o = t[1]) : ((o = { hostId: n }), (t[0] = n), (t[1] = o));
  let { data: s, isPending: c } = ue(Lt, o),
    l;
  t[2] === n ? (l = t[3]) : ((l = { hostId: n }), (t[2] = n), (t[3] = l));
  let u = kn(l),
    d = s?.requirements?.featureRequirements?.[te],
    f;
  t[4] === d ? (f = t[5]) : ((f = Dt(d)), (t[4] = d), (t[5] = f));
  let p = f,
    m = a || c,
    ...
    ? ((g = (0, q.jsxs)(`div`, {
        ...
        children: [
          (0, q.jsxs)(`span`, {
            ...
            children: [
              (0, q.jsx)(Fn, { className: `icon-xs shrink-0` }),
              (0, q.jsx)(B, {
  ...
  t[17] !== h || t[18] !== x || t[19] !== S || t[20] !== b
    ? ((C = (0, q.jsx)(pe, { ariaLabel: b, checked: h, disabled: x, onChange: S })),
      (t[17] = h),
      (t[18] = x),
      (t[19] = S),
      (t[20] = b),
  ...
  return (
    t[22] !== C || t[23] !== y
      ? ((w = (0, q.jsx)(H, { label: g, description: y, control: C })),
        (t[22] = C),
        (t[23] = y),
        (t[24] = w))
      : (w = t[24]),
...
function oi() {
  let e = (0, bi.c)(12),
    { selectedHostId: t } = fn(),
    { data: n, isError: r, isLoading: i } = A(mn),
    a;
  e[0] === t ? (a = e[1]) : ((a = { hostId: t }), (e[0] = t), (e[1] = a));
  let { data: o, isError: s, isPending: c } = ue(Lt, a),
  ...
  e[2] !== o?.requirements?.featureRequirements || e[3] !== s || e[4] !== c || e[5] !== l
    ? ((f =
        l && !s && !c && !Dt(o?.requirements?.featureRequirements?.browser_use_full_cdp_access)),
...
function si(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = () => {
      ...
      (h = (0, X.jsx)(re, { className: `icon-xs` })),
      (g = (0, X.jsx)(B, {
  ...
  t[11] === v
    ? (x = t[12])
    : ((x = (0, X.jsx)(W.Header, { actions: v, title: y, subtitle: b })), (t[11] = v), (t[12] = x));
  let S;
  ...
  let C;
  t[18] !== o || t[19] !== d
    ? ((C = (0, X.jsx)(hi, { open: o, visibleResources: d, onOpenChange: s })),
      (t[18] = o),
      (t[19] = d),
      (t[20] = C))
    : (C = t[20]);
  ...
  let T;
  return (
    t[24] !== S || t[25] !== C || t[26] !== w || t[27] !== x
      ? ((T = (0, X.jsxs)(W, { className: `gap-2`, children: [x, S, C, w] })),
        (t[24] = S),
        (t[25] = C),
        (t[26] = w),
        (t[27] = x),
  ...
  return (0, X.jsx)(E, {
    ...
    triggerButton: (0, X.jsxs)(Mn, {
      ...
      children: [
        (0, X.jsx)(`span`, {
          ...
          children:
            c === `custom`
              ? (0, X.jsx)(De, { className: `icon-xs text-token-text-secondary` })
              : (0, X.jsx)(di, { value: c }),
        }),
    ...
    children: (0, X.jsxs)(`div`, {
      ...
      children: [
        ...
        (0, X.jsx)(z.Separator, {}),
        (0, X.jsx)(z.Item, {
          RightIcon: c === `custom` ? zt : void 0,
          onSelect: e,
          children: (0, X.jsxs)(`div`, {
            className: `flex min-w-0 items-center gap-2`,
            children: [
              (0, X.jsx)(De, { className: `icon-xs shrink-0 text-token-text-secondary` }),
              (0, X.jsx)(B, {
...
function di(e) {
  let t = (0, bi.c)(6),
    ...
    o;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((o = u(`size-2 shrink-0 rounded-full`, r, i, a)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a),
      (t[3] = o))
  ...
  return (0, X.jsxs)(X.Fragment, {
    children: [
      (0, X.jsx)(_, {
        ...
        size: `icon`,
        children: (0, X.jsx)(En, { className: `icon-2xs` }),
      }),
      (0, X.jsx)(It, {
        open: r,
        onOpenChange: i,
              ...
              children: [
                ...
                (0, X.jsx)(E, {
                  ...
                  triggerButton: (0, X.jsxs)(Mn, {
                    ...
                    children: [
                      (0, X.jsx)(di, { value: s }),
                      (0, X.jsx)(`span`, { id: y, className: `truncate`, children: _i(s) }),
                    ],
                  }),
...
function Di(e) {
  ...
  let { pendingPluginId: x, setPluginEnabled: S } = on(b),
    C;
  t[7] === o ? (C = t[8]) : ((C = { hostId: o }), (t[7] = o), (t[8] = C));
  let { pendingUninstallPluginId: w, uninstallPlugin: T } = an(C),
  ...
  if (A === 0) {
    ...
    return (
      t[12] === n
        ? (e = t[13])
        : ((e = (0, Z.jsx)(U, { children: (0, Z.jsx)(zn, { children: n }) })),
          (t[12] = n),
          (t[13] = e)),
      e
    );
            ...
            ? (0, Z.jsx)(
                H,
                {
                  ...
                  icon: (0, Z.jsx)(`span`, {
                    ...
                    children:
                      e.icon ?? (0, Z.jsx)(Ne, { className: `icon-md text-token-text-secondary` }),
                  }),
                  label: (0, Z.jsx)(`span`, {
                ...
                ji,
                {
                  ...
                  onToggleInstalledPluginEnabled: (t, n) => {
                    S({
                      ...
                      pluginDisplayName: e.displayName ?? at(t),
                      enabled: n,
                    });
                  },
                  onUninstallPlugin: D,
  ...
  let N;
  t[31] !== j || t[32] !== M
    ? ((N = (0, Z.jsxs)(U, { className: `overflow-hidden`, children: [j, M] })),
      (t[31] = j),
      (t[32] = M),
      (t[33] = N))
    : (N = t[33]);
  ...
  let ne;
  return (
    t[53] !== ee || t[54] !== te || t[55] !== N
      ? ((ne = (0, Z.jsxs)(Z.Fragment, { children: [N, ee, te] })),
        (t[53] = ee),
        (t[54] = te),
        (t[55] = N),
        (t[56] = ne))
...
function ki(e) {
  ...
  t[0] === n.icon
    ? (i = t[1])
    : ((i = n.icon ?? (0, Z.jsx)(Ne, { className: `icon-md text-token-text-secondary` })),
      (t[0] = n.icon),
      (t[1] = i));
  let a;
  t[2] === i
  ...
  t[16] === u
    ? (d = t[17])
    : ((d = (0, Z.jsx)(pe, { ariaLabel: u, checked: !1, disabled: !0, onChange: Ai })),
      (t[16] = u),
      (t[17] = d));
  let f;
  return (
...
function ji(e) {
  ...
  if (
    ...
    let e = i.displayName ?? at(i.plugin),
    ...
    t[13] !== i.plugin || t[14] !== o
      ? ((v = () => {
        ...
        (t[15] = v))
      : (v = t[15]);
    let y = i.showIconBorder === !1 ? `border-0` : `border border-token-border-default`,
      b;
    t[16] === y
      ? (b = t[17])
      : ((b = u(
    ...
    let x =
        ...
        (0, Z.jsx)(Xe, {
          ...
          fallback: (0, Z.jsx)(Ne, { className: `icon-md text-token-text-secondary` }),
        }),
      S;
    t[18] !== b || t[19] !== x
  ...
  return (
    t[37] !== m || t[38] !== h || t[39] !== g
      ? ((v = (0, Z.jsxs)(`div`, { className: m, children: [h, g] })),
        (t[37] = m),
        (t[38] = h),
        (t[39] = g),
        (t[40] = v))
    ...
    if (r === `downloads` && !l) {
      ...
      return (
        e[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(Kt, { to: `/settings/browser-use`, replace: !0 })), (e[4] = t))
          : (t = e[4]),
        t
      );
    }
    ...
    if (!i.enabled && !a) {
      ...
      return (
        e[6] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, $.jsx)(Kt, { to: `/settings/browser-use`, replace: !0 })), (e[6] = t))
          : (t = e[6]),
        t
      );
    }
...
function zi() {
  ...
  e[1] !== i || e[2] !== r.availablePlugins
    ? ((a = Fi(r.availablePlugins, oe, i)), (e[1] = i), (e[2] = r.availablePlugins), (e[3] = a))
    : (a = e[3]);
  let o = a,
    s;
  ...
  e[14] !== o || e[15] !== m
    ? ((E =
        o == null && ua(m)
          ? [
              {
                description: (0, $.jsx)(B, { ...Qe.restrictedAvailabilityDescription }),
                icon: (0, $.jsx)(un, { className: `h-full w-full text-token-foreground` }),
                id: `browser-use-unavailable`,
                title: (0, $.jsx)(B, { ...Qe.label }),
              },
            ]
          : []),
      (e[14] = o),
        ...
        ? (0, $.jsxs)(W, {
            children: [
              ...
              (0, $.jsx)(W.Content, {
                children: (0, $.jsxs)(U, {
                  children: [
                    _ ? (0, $.jsx)(je, { electron: !0, children: (0, $.jsx)(Zi, {}) }) : null,
                    (0, $.jsx)($i, {}),
    ...
    : ((j = C
        ? (0, $.jsxs)(W, {
            children: [
              ...
              (0, $.jsx)(W.Content, { children: (0, $.jsx)(U, { children: (0, $.jsx)(Wi, {}) }) }),
            ],
          })
        : null),
      (e[30] = C),
  ...
  e[32] !== _ || e[33] !== f.downloads
    ? ((M =
        !_ || !f.downloads.enabled
          ? null
          : (0, $.jsx)(je, { electron: !0, children: (0, $.jsx)(Bi, {}) })),
      (e[32] = _),
      (e[33] = f.downloads),
      (e[34] = M))
    : (M = e[34]);
...
function Bi() {
  let e = C(L),
    ...
    [r, i] = (0, _a.useState)(!1),
    a = Ce?.downloads,
    o = w(F.downloadDirectory),
    s = w(F.promptForDownloadLocation);
  if (a == null) return null;
  let c = async () => {
    i(!0);
    try {
      let t = await a.chooseDownloadDirectory();
      t != null && (await Ae(e, F.downloadDirectory, t));
    } catch {
      e.get(V).danger(
        t.formatMessage({
          ...
          children: [
            ...
            (0, $.jsx)(H, {
              ...
              control: (0, $.jsx)(pe, {
                ...
                checked: s,
                onChange: (t) => {
                  Ae(e, F.promptForDownloadLocation, t);
                },
              }),
            }),
            (0, $.jsx)(H, {
...
function Vi(e) {
  ...
  let s = o,
    c;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, $.jsx)(je, { electron: !0, children: (0, $.jsx)(oi, {}) })), (t[8] = c))
    : (c = t[8]);
  let l;
  return (
    t[9] === s
      ...
      : ((l = (0, $.jsxs)($.Fragment, {
          children: [
            c,
            (0, $.jsx)(je, { browser: !0, chromeExtension: !0, extension: !0, children: s }),
          ],
        })),
        (t[9] = s),
        (t[10] = l)),
...
function qi(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, $.jsx)(_, { color: `secondary`, onClick: o, size: `toolbar`, children: s })),
      (t[4] = o),
      (t[5] = c));
  let l;
  return (
...
function Xi() {
  let e = (0, Q.c)(14),
    t = C(L),
    n = w(F.annotationScreenshotsMode),
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = {
        id: `always`,
    ...
    ? ((d = (0, $.jsx)(`div`, {
        ...
        children: a.map((e) => {
          ...
          return (0, $.jsx)(
            ...
            {
              allowWrap: !0,
              RightIcon: r ? zt : void 0,
              onSelect: () => {
                Ae(t, F.annotationScreenshotsMode, e.id);
              },
...
function Zi() {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(Mn, { children: (0, $.jsx)(Qi, { target: n }) })), (e[2] = n), (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = xa.map((e) =>
        (0, $.jsx)(
          z.Item,
          {
            onSelect: () => {
              n !== e &&
                (Ae(t, ke.openLinkInTargetPreference, e),
                xe(t, Be, { setting: `web_url`, previousDestination: n, selectedDestination: e }));
            },
            RightIcon: n === e ? zt : void 0,
            children: (0, $.jsx)(`span`, {
              className: `text-sm`,
...
function $i() {
  let e = (0, Q.c)(10),
    t = C(L),
    n = w(ke.openLocalUrlInTargetPreference),
    r,
    i;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(B, {
  ...
  e[2] === n
    ? (a = e[3])
    : ((a = (0, $.jsx)(Mn, { children: (0, $.jsx)(ea, { target: n }) })), (e[2] = n), (e[3] = a));
  let o;
  e[4] !== t || e[5] !== n
    ? ((o = xa.map((e) =>
        (0, $.jsx)(
          z.Item,
          {
            onSelect: () => {
              n !== e &&
                (Ae(t, ke.openLocalUrlInTargetPreference, e),
                xe(t, Be, {
                  setting: `local_url`,
...
function sa() {
  ...
  let k;
  e[21] !== T || e[22] !== O
    ? ((k = (0, $.jsx)(Mn, { className: `w-[152px]`, disabled: T, children: O })),
      (e[21] = T),
      (e[22] = O),
      (e[23] = k))
    : (k = e[23]);
  ...
  return (
    e[32] !== M || e[33] !== S
      ? ((N = (0, $.jsx)(H, { label: x, description: S, control: M })),
        (e[32] = M),
        (e[33] = S),
        (e[34] = N))
      : (N = e[34]),
...
function ca() {
  ...
  let b;
  e[13] !== _ || e[14] !== y
    ? ((b = (0, $.jsx)(Mn, { className: `w-[152px]`, disabled: _, children: y })),
      (e[13] = _),
      (e[14] = y),
      (e[15] = b))
    : (b = e[15]);
    ...
    (t[5] === o
      ...
      : ((e = (e) => ({
          ...
          onTryInChat: () => {
            o({
              prefillPrompt: p({
                defaultPrompt: Rt(e.plugin.interface?.defaultPrompt),
                pluginDisplayName: at(e),
                pluginId: e.plugin.id,
              }),
              startInSidebar: !0,
...
function da(e) {
  ...
  t[15] !== n || t[16] !== a || t[17] !== o
    ? ((x = Wr(a, n, o)), (t[15] = n), (t[16] = a), (t[17] = o), (t[18] = x))
    : (x = t[18]);
  let S;
  t[19] !== b || t[20] !== x
    ? ((S = (0, $.jsx)(W.Header, { actions: y, title: b, subtitle: x })),
      (t[19] = b),
      (t[20] = x),
      (t[21] = S))
    : (S = t[21]);
  ...
  let E;
  return (
    t[33] !== T || t[34] !== S || t[35] !== w
      ? ((E = (0, $.jsxs)(W, { children: [S, w, T] })),
        (t[33] = T),
        (t[34] = S),
        (t[35] = w),
        (t[36] = E))
...
function pa(e) {
  ...
  let y;
  t[15] !== h || t[16] !== g
    ? ((y = (0, $.jsx)(v, { children: (0, $.jsx)(x, { title: h, subtitle: g }) })),
      (t[15] = h),
      (t[16] = g),
      (t[17] = y))
    : (y = t[17]);
  ...
  let j;
  t[40] !== D || t[41] !== A
    ? ((j = (0, $.jsx)(v, { children: (0, $.jsxs)(Se, { children: [D, A] }) })),
      (t[40] = D),
      (t[41] = A),
      (t[42] = j))
    : (j = t[42]);
  let M;
  t[43] !== w || t[44] !== j || t[45] !== m || t[46] !== y
    ? ((M = (0, $.jsxs)(Bt, { as: `form`, onSubmit: m, children: [y, w, j] })),
      (t[43] = w),
      (t[44] = j),
      (t[45] = m),
      (t[46] = y),
  ...
  return (
    t[48] !== o || t[49] !== M || t[50] !== p
      ? ((N = (0, $.jsx)(It, { open: o, onOpenChange: p, size: `compact`, children: M })),
        (t[48] = o),
        (t[49] = M),
        (t[50] = p),
        (t[51] = N))
...
function ma(e) {
  ...
  let S;
  t[18] !== n || t[19] !== i
    ? ((S = Xr(i, n)), (t[18] = n), (t[19] = i), (t[20] = S))
    : (S = t[20]);
  let w;
  t[21] !== b || t[22] !== S
    ? ((w = (0, $.jsx)(v, { children: (0, $.jsx)(x, { title: b, subtitle: S }) })),
      (t[21] = b),
      (t[22] = S),
      (t[23] = w))
    : (w = t[23]);
  ...
  t[26] === d
    ? (D = t[27])
    : ((D = (0, $.jsx)(_, { color: `ghost`, disabled: d, onClick: E, children: T })),
      (t[26] = d),
      (t[27] = D));
  let O;
  t[28] === p
  ...
  let A;
  t[31] !== d || t[32] !== O
    ? ((A = (0, $.jsx)(_, { color: `danger`, loading: d, onClick: O, children: k })),
      (t[31] = d),
      (t[32] = O),
      (t[33] = A))
    : (A = t[33]);
  ...
  let M;
  t[37] !== j || t[38] !== w
    ? ((M = (0, $.jsxs)(Bt, { children: [w, j] })), (t[37] = j), (t[38] = w), (t[39] = M))
    : (M = t[39]);
  let N;
  t[40] !== M || t[41] !== h
    ? ((N = (0, $.jsx)(It, { open: h, onOpenChange: g, size: `compact`, children: M })),
      (t[40] = M),
      (t[41] = h),
      (t[42] = N))
    : (N = t[42]);
  ...
  return (
    t[43] !== N || t[44] !== m
      ? ((P = (0, $.jsxs)($.Fragment, { children: [m, N] })), (t[43] = N), (t[44] = m), (t[45] = P))
      : (P = t[45]),
    P
  );
}
          ...
          (0, $.jsx)(
            H,
            {
              ...
              control: (0, $.jsx)(_, {
                ...
                size: `icon`,
                children: (0, $.jsx)(En, { className: `icon-2xs` }),
              }),
            },
            e,
          )),
