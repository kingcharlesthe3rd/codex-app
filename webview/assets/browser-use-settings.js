...
import { n as l } from "./use-host-config-C.js";
import { Bi as u, zi as d } from "./thread-context-inputs.js";
...
import { a as be, n as xe, r as Se } from "./use-is-plugins-enabled-B.js";
...
import { s as Ge } from "./check-plugin-availability-C.js";
...
import {
  ...
  t as pt,
  u as mt,
} from "./browser-use-origin-state-queries-C.js";
...
function sn(e) {
  ...
  let m = mt(p),
    h = l?.requirements?.featureRequirements?.[d],
    g;
  t[4] === h ? (g = t[5]) : ((g = u(h)), (t[4] = h), (t[5] = g));
  let _ = g,
    v = o || f,
...
function On() {
  ...
  let { data: c, isError: l, isPending: d } = i(_e, o),
    f = n?.fullCdpAccessEnabled === !0,
    p = r || (f && l),
    m = a || (f && d),
    h;
  e[2] !== c?.requirements?.featureRequirements || e[3] !== l || e[4] !== d || e[5] !== f
    ? ((h = f && !l && !d && !u(c?.requirements?.featureRequirements?.browser_use_full_cdp_access)),
