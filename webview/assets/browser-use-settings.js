...
import { ti as l, us as u } from "./app-server-manager-signals.js";
import { _ as d, f, g as p, m } from "./vscode-api.js";
import { t as h } from "./queryOptions.js";
import {
  $n as g,
  B as _,
  Fn as v,
...
import { c as I, n as L, o as R, r as z } from "./lib.js";
import { t as B } from "./clsx-Cir5-jBH.js";
import { t as V } from "./button-DO-oxX3-.js";
import { a as H, i as ee } from "./setting-storage.js";
...
import { n as ie } from "./rpc-1.js";
import { a as ae, o as oe } from "./statsig.js";
import { c as se } from "./config-queries.js";
import { r as W } from "./toast-signal.js";
import { t as ce } from "./chevron.js";
import { a as le, m as ue, n as de, p as fe } from "./chunk-109.js";
import { t as pe } from "./connector-logo.js";
import { t as me } from "./route-scope.js";
import { k as he } from "./mention-item-B.js";
import { t as ge } from "./apps.js";
import { t as _e } from "./chats.js";
import { a as ve, n as ye, r as be } from "./use-is-plugins-enabled.js";
import { c as xe, m as Se, y as Ce } from "./use-plugins.js";
import { t as we } from "./with-window.js";
import { n as Te, r as Ee } from "./use-resolved-theme-variant.js";
import { o as De } from "./plugin-detail-route-utils.js";
import { t as Oe } from "./settings.cog.js";
import {
  a as G,
  d as ke,
  i as Ae,
...
import { o as ze } from "./bundled-plugin-auto-install-preference.js";
import { t as Be } from "./checkbox.js";
import { n as Ve, t as He } from "./use-plugin-install-flow.js";
import { r as K, t as q } from "./dropdown.js";
import { t as Ue } from "./trash.js";
import { t as We } from "./plus.js";
import { t as Ge } from "./settings-host-context.js";
import { s as Ke } from "./check-plugin-availability.js";
import { t as qe } from "./toggle.js";
import { t as Je } from "./shield-exclamation.js";
import { t as Ye } from "./settings-shared.js";
...
import { n as ct, r as lt } from "./plugins-availability.js";
import { n as J } from "./settings-row.js";
import { n as Y, t as X } from "./settings-group.js";
import { t as ut } from "./settings-empty-state.js";
import { t as dt } from "./use-home-directory.js";
import { t as ft } from "./browser-use.js";
import { n as pt, t as mt } from "./browser-use-elevated-risk-learn-more-url.js";
import { t as ht } from "./plugin-uninstall-dialog.js";
var gt = `browser_use_full_cdp_access`;
function _t(e) {
  return e === !1;
}
var vt = 3e4;
  ...
  return h({
    ...
    queryFn: async () => {
      try {
        ...
        throw (
          m.error(`Failed to list importable browser profiles`, {
            safe: {},
            sensitive: { error: e },
          }),
          e
...
async function bt(e, t) {
  try {
    ...
    throw (
      m.error(`Failed to import browser profile`, {
        safe: {
...
var Z = e(t()),
  ...
  xt = (e) =>
    (0, Q.jsxs)(`svg`, {
      ...
      ...e,
      children: [
        (0, Q.jsx)(`circle`, { cx: 8, cy: 8, r: 7, fill: `url(#atlas-gradient)` }),
        (0, Q.jsx)(`path`, {
          d: `M8 3.25v9.5M3.25 8h9.5M4.64 4.64l6.72 6.72M11.36 4.64l-6.72 6.72`,
          stroke: `white`,
          strokeWidth: 1.15,
          strokeLinecap: `round`,
        }),
        (0, Q.jsx)(`circle`, { cx: 8, cy: 8, r: 1.45, fill: `white` }),
        (0, Q.jsx)(`defs`, {
          children: (0, Q.jsxs)(`linearGradient`, {
            ...
            children: [
              (0, Q.jsx)(`stop`, { stopColor: `#6977F8` }),
              (0, Q.jsx)(`stop`, { offset: 1, stopColor: `#6552D9` }),
            ],
          }),
        }),
      ],
  ...
  St = (e) =>
    (0, Q.jsxs)(`svg`, {
      ...
      children: [
        (0, Q.jsx)(`path`, {
          d: `M8 1a7 7 0 0 1 6.06 3.5H8a3.5 3.5 0 0 0-3.03 1.75L3.96 4.5A7 7 0 0 1 8 1Z`,
          fill: `#EA4335`,
        }),
        (0, Q.jsx)(`path`, {
          d: `M14.06 4.5A7 7 0 0 1 8 15l3.03-5.25A3.5 3.5 0 0 0 11.5 8c0-1.94-1.56-3.5-3.5-3.5h6.06Z`,
          fill: `#FBBC04`,
        }),
        (0, Q.jsx)(`path`, {
          d: `M8 15A7 7 0 0 1 3.96 4.5l3.03 5.25A3.5 3.5 0 0 0 11.03 9.75L8 15Z`,
          fill: `#34A853`,
        }),
        (0, Q.jsx)(`circle`, {
          cx: 8,
  ...
  Ct = z({
    ...
    title: {
      ...
      defaultMessage: `Import browser data`,
...
function wt(e) {
  let t = (0, $.c)(54),
    {
      ...
      profiles: l,
      profilesHaveError: u,
      requiresElevatedChromeConsent: d,
      result: f,
      selectedProfile: p,
      onCancel: m,
      onElevatedChromeConsentChange: h,
      onImport: g,
      onImportCookiesChange: _,
      onImportPasswordsChange: v,
      onProfilePickerOpenChange: y,
      onSelectProfile: b,
    } = e;
  if (f != null) {
    let e;
    return (
      t[0] !== m || t[1] !== f
        ? ((e = (0, Q.jsx)(jt, { result: f, onDone: m })), (t[0] = m), (t[1] = f), (t[2] = e))
        : (e = t[2]),
      e
    );
  }
  let x = p?.hasCookies === !0 && i,
    S = p?.hasPasswords === !0 && a,
    C = p == null || (!x && !S) || (d && !n),
    w;
  t[3] === g
    ? (w = t[4])
            ...
            subtitle: (0, Q.jsx)(Fe, {
              ...
              children: (0, Q.jsx)(`div`, {
                children: (0, Q.jsx)(R, {
                  ...
                  defaultMessage: `Bring your saved passwords and cookies into Codex`,
  ...
  t[16] === l?.length
    ...
    : ((A =
      ...
      (t[17] = A));
  let j;
  t[18] !== x || t[19] !== S || t[20] !== o || t[21] !== _ || t[22] !== v || t[23] !== p
    ? ((j =
        p != null &&
        (0, Q.jsxs)(Y, {
          children: [
            (0, Q.jsx)(Dt, {
              available: p.hasCookies,
              checked: x,
              disabled: o,
              kind: `cookies`,
              onChange: _,
    ...
    : (j = t[24]);
  let M;
  t[25] !== n || t[26] !== o || t[27] !== h || t[28] !== d
    ? ((M = d && (0, Q.jsx)(Ot, { checked: n, disabled: o, onChange: h })),
      (t[25] = n),
      (t[26] = o),
      (t[27] = h),
      (t[28] = d),
  ...
  let N;
  t[30] !== r || t[31] !== u
    ? ((N = (0, Q.jsx)(kt, { importFailed: r, profileDiscoveryFailed: u })),
      (t[30] = r),
      (t[31] = u),
      (t[32] = N))
    : (N = t[32]);
  let P;
  t[33] !== N || t[34] !== k || t[35] !== A || t[36] !== j || t[37] !== M
    ? ((P = (0, Q.jsxs)(G, { className: `gap-3`, children: [k, A, j, M, N] })),
      (t[33] = N),
      (t[34] = k),
      (t[35] = A),
      (t[36] = j),
  ...
  let B;
  t[47] !== I || t[48] !== z
    ? ((B = (0, Q.jsx)(G, { children: (0, Q.jsxs)(Ne, { className: Pe, children: [I, z] }) })),
      (t[47] = I),
      (t[48] = z),
      (t[49] = B))
    : (B = t[49]);
  let H;
  return (
    t[50] !== w || t[51] !== P || t[52] !== B
      ? ((H = (0, Q.jsxs)(Me, { as: `form`, onSubmit: w, children: [D, P, B] })),
        (t[50] = w),
        (t[51] = P),
        (t[52] = B),
        (t[53] = H))
...
function Tt(e) {
  let t = (0, $.c)(24),
    ...
    l;
  t[0] === o ? (l = t[1]) : ((l = o ? Pt(o) : null), (t[0] = o), (t[1] = l));
  let u = l,
    d;
  t[2] === o ? (d = t[3]) : ((d = o ? Ft(o) : void 0), (t[2] = o), (t[3] = d));
  let f = d,
    p;
  ...
  let m;
  t[5] !== r || t[6] !== o
    ? ((m = (0, Q.jsx)(Et, { isLoading: r, selectedProfile: o })),
      (t[5] = r),
      (t[6] = o),
      (t[7] = m))
    : (m = t[7]);
  ...
  t[12] !== c || t[13] !== a || t[14] !== u
    ? ((g = a?.map((e) => {
        ...
        return (0, Q.jsx)(
          ...
          {
            "aria-label": Ft(e),
            RightIcon: t === u ? U : void 0,
            onSelect: () => c(e),
            children: (0, Q.jsx)(Mt, { profile: e }),
          },
          t,
        );
      })),
  ...
  t[16] === g
    ? (_ = t[17])
    : ((_ = (0, Q.jsx)(K.Section, { className: `max-h-[250px] overflow-y-auto`, children: g })),
      (t[16] = g),
      (t[17] = _));
  let v;
  return (
    t[18] !== n || t[19] !== s || t[20] !== i || t[21] !== h || t[22] !== _
      ? ((v = (0, Q.jsxs)(`div`, {
...
function Et(e) {
  ...
  let i;
  return (
    t[2] === r ? (i = t[3]) : ((i = (0, Q.jsx)(Mt, { profile: r })), (t[2] = r), (t[3] = i)), i
  );
}
function Dt(e) {
  let t = (0, $.c)(18),
  ...
  if (a === `cookies`) {
    ...
    if (
      ...
      (t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(R, {
            id: `settings.browserUse.profileImport.cookies.description`,
            defaultMessage: `Keep your signed-in sessions when browsing with Codex`,
            description: `Description for importing browser cookies`,
          })),
          (t[1] = e))
        : (e = t[1]),
        (l = e));
      ...
      (t[2] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(R, {
            id: `settings.browserUse.profileImport.cookies.unavailable`,
            defaultMessage: `No cookies were found in this profile`,
            description: `Description when the selected browser profile has no cookies`,
          })),
          (t[2] = e))
        : (e = t[2]),
        (l = e));
    ...
    if (
      (t[3] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(R, { ...Ct.passwords })), (t[3] = e))
        : (e = t[3]),
      (c = e),
      n)
    ) {
      ...
      (t[4] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(R, {
            id: `settings.browserUse.profileImport.passwords.description`,
            defaultMessage: `Use your saved passwords when browsing with Codex`,
            description: `Description for importing browser passwords`,
          })),
          (t[4] = e))
        : (e = t[4]),
        (l = e));
      ...
      (t[5] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Q.jsx)(R, {
            id: `settings.browserUse.profileImport.passwords.unavailable`,
            defaultMessage: `No passwords were found in this profile`,
            description: `Description when the selected browser profile has no passwords`,
          })),
          (t[5] = e))
        : (e = t[5]),
        (l = e));
  ...
  let u;
  t[6] !== c || t[7] !== s
    ? ((u = (0, Q.jsx)(`span`, { id: s, children: c })), (t[6] = c), (t[7] = s), (t[8] = u))
    : (u = t[8]);
  let d = !n || i,
    f;
  t[9] !== r || t[10] !== s || t[11] !== o || t[12] !== d
    ? ((f = (0, Q.jsx)(qe, { "aria-labelledby": s, checked: r, disabled: d, onChange: o })),
      (t[9] = r),
      (t[10] = s),
      (t[11] = o),
      (t[12] = d),
  ...
  return (
    t[14] !== l || t[15] !== u || t[16] !== f
      ? ((p = (0, Q.jsx)(J, { description: l, label: u, control: f })),
        (t[14] = l),
        (t[15] = u),
        (t[16] = f),
        (t[17] = p))
...
function Ot(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(`p`, {
        ...
        children: (0, Q.jsx)(R, {
          ...
          defaultMessage: `Windows protects Chrome cookies and passwords with App-Bound Encryption, so Codex needs administrator approval to import them`,
  ...
  let s;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((s = (0, Q.jsx)(Be, { checked: n, disabled: r, onCheckedChange: i })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = i),
      (t[5] = s))
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(`span`, {
        children: (0, Q.jsx)(R, {
          ...
          defaultMessage: `I understand Codex will request administrator approval to import this Chrome data`,
...
function At(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Q.jsx)(`p`, {
          className: `bg-token-error-background rounded-lg px-3 py-2 text-sm text-token-error-foreground`,
          role: `alert`,
          children: n,
        })),
        (t[0] = n),
...
function jt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Q.jsx)(ke, {
        ...
        children: (0, Q.jsx)(`h2`, {
          className: `sr-only`,
          children: (0, Q.jsx)(R, { ...Lt.complete }),
        }),
      })),
      (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Q.jsx)(U, { className: `icon-sm` })), (t[1] = a))
    : (a = t[1]);
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(R, { ...Lt.complete })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsxs)(G, {
        children: [
          ...
          (0, Q.jsx)(Ae, {
            icon: a,
            iconBackgroundClassName: `bg-token-success-background text-token-success-foreground`,
            title: o,
            subtitle: (0, Q.jsx)(Fe, {
              asChild: !0,
              children: (0, Q.jsx)(`div`, {
                children: (0, Q.jsx)(R, {
                  ...
                  defaultMessage: `Your browser data is now available in Codex`,
  ...
  t[4] === n.cookies
    ? (c = t[5])
    : ((c =
        n.cookies != null && (0, Q.jsx)(Nt, { count: n.cookies.imported ?? 0, kind: `cookies` })),
      (t[4] = n.cookies),
      (t[5] = c));
  let l;
  t[6] === n
    ? (l = t[7])
    : ((l = n.passwords != null && (0, Q.jsx)(Nt, { count: It(n), kind: `passwords` })),
      (t[6] = n),
      (t[7] = l));
  let u;
  t[8] !== c || t[9] !== l
    ? ((u = (0, Q.jsx)(G, { children: (0, Q.jsxs)(Y, { children: [c, l] }) })),
      (t[8] = c),
      (t[9] = l),
      (t[10] = u))
    : (u = t[10]);
  ...
  t[12] === r
    ...
    : ((f = (0, Q.jsx)(G, {
        children: (0, Q.jsx)(Ne, {
          className: Pe,
          children: (0, Q.jsx)(V, { color: `primary`, onClick: r, type: `button`, children: d }),
        }),
      })),
      (t[12] = r),
      (t[13] = f));
  ...
  return (
    t[14] !== u || t[15] !== f
      ? ((p = (0, Q.jsxs)(Me, { children: [s, u, f] })), (t[14] = u), (t[15] = f), (t[16] = p))
      : (p = t[16]),
    p
  );
}
function Mt(e) {
  let t = (0, $.c)(10),
    { profile: n } = e,
    r = xt;
  n.source === `chrome` && (r = St);
  let i;
  t[0] === r
    ? (i = t[1])
    : ((i = (0, Q.jsx)(r, { className: `size-4 shrink-0` })), (t[0] = r), (t[1] = i));
  let a;
  t[2] === n.appName
    ? (a = t[3])
    : ((a = (0, Q.jsx)(`span`, {
      ...
      (t[2] = n.appName),
      (t[3] = a));
  let o = n.profileName || n.profileDirectoryName,
    s;
  t[4] === o
    ? (s = t[5])
    : ((s = (0, Q.jsx)(`span`, {
...
function Nt(e) {
  ...
  if (r === `cookies`) {
    ...
    (t[0] === n
      ? (e = t[1])
      : ((e = (0, Q.jsx)(R, {
          id: `settings.browserUse.profileImport.cookiesImported`,
          defaultMessage: `{count, plural, one {# cookie imported} other {# cookies imported}}`,
          description: `Summary of cookies imported from a browser profile`,
          values: { count: n },
        })),
        (t[0] = n),
        (t[1] = e)),
    ...
    (t[2] === n
      ? (e = t[3])
      : ((e = (0, Q.jsx)(R, {
          id: `settings.browserUse.profileImport.passwordsImported`,
          defaultMessage: `{count, plural, one {# password imported} other {# passwords imported}}`,
          description: `Summary of passwords imported from a browser profile`,
          values: { count: n },
        })),
        (t[2] = n),
        (t[3] = e)),
  ...
  let a;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Q.jsx)(U, { className: `icon-xs text-token-success-foreground` })), (t[4] = a))
    : (a = t[4]);
  let o;
  return (
    t[5] === i
      ...
      : ((o = (0, Q.jsxs)(`div`, {
          ...
          children: [
            a,
            (0, Q.jsx)(`span`, { className: `text-sm text-token-text-primary`, children: i }),
          ],
        })),
        (t[5] = i),
        (t[6] = o)),
...
function It(e) {
  let t = e.passwords;
  return t == null ? 0 : (t.imported ?? (t.profile?.imported ?? 0) + (t.account?.imported ?? 0));
}
var Lt = z({
  complete: {
...
function Rt(e) {
  let t = (0, $.c)(2),
    { service: n } = e;
  if (!oe(`1834314516`)) return null;
  let r = n ?? ie.browserProfileImport;
  if (r == null) return null;
  let i;
  return (
    t[0] === r ? (i = t[1]) : ((i = (0, Q.jsx)(zt, { service: r })), (t[0] = r), (t[1] = i)), i
  );
}
function zt(e) {
  let t = (0, $.c)(48),
    ...
    h;
  t[0] !== r || t[1] !== n ? ((h = yt(n, r)), (t[0] = r), (t[1] = n), (t[2] = h)) : (h = t[2]);
  let g = d(h),
    _;
  t[3] === n ? (_ = t[4]) : ((_ = { mutationFn: (e) => bt(n, e) }), (t[3] = n), (t[4] = _));
  let v = p(_),
    y = g.data,
    b;
  t[5] !== y || t[6] !== a
    ? ((b = y?.find((e) => Vt(e) === a) ?? y?.[0] ?? null), (t[5] = y), (t[6] = a), (t[7] = b))
    : (b = t[7]);
  let x = b,
    S = x?.hasCookies === !0 && s,
    ...
    w =
      ...
      x?.source === `chrome`,
    T;
  t[8] === x ? (T = t[9]) : ((T = x ? Vt(x) : null), (t[8] = x), (t[9] = T));
  let E = T,
    D = E != null && f === E,
    O;
  t[10] === v.data
    ? (O = t[11])
    : ((O = v.data != null && Ht(v.data)), (t[10] = v.data), (t[11] = O));
  let k = O,
    A = null;
  v.data != null && !k && (A = v.data);
  let j;
  t[12] === v
    ? (j = t[13])
    : ((j = () => {
        v.isPending || (i(!1), m(null), v.reset());
      }),
      (t[12] = v),
      (t[13] = j));
  let M = j,
  ...
  t[17] === E
    ...
    : ((L = (e) => {
      ...
      (t[18] = L));
  let z;
  t[19] !== S || t[20] !== v || t[21] !== C || t[22] !== w || t[23] !== x
    ? ((z = () => {
        x != null && v.mutate(Bt(x, S, C, w));
      }),
      (t[19] = S),
      (t[20] = v),
      (t[21] = C),
  ...
  t[41] !== B
    ? ((H = (0, Q.jsx)(wt, {
        ...
        requiresElevatedChromeConsent: w,
        result: A,
        selectedProfile: x,
        onCancel: M,
        onElevatedChromeConsentChange: L,
        onImport: z,
...
function Ht(e) {
  return [e.cookies, e.passwords, e.passwords?.profile, e.passwords?.account].some(
    (e) =>
      e != null &&
      ((e.failed ?? 0) > 0 || e.error != null || (e.status != null && e.status !== `success`)),
  );
}
var Ut = {
  contactInfo: {
...
function Wt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(Jt, { kind: `contactInfo` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Gt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(Jt, { kind: `extensions` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Kt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(Jt, { kind: `passwordManager` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function qt() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(Jt, { kind: `siteSettings` })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Jt(e) {
  let t = (0, $.c)(3),
    { kind: n } = e,
    r;
  return (t[1] === n ? (r = t[2]) : ((r = (0, Q.jsx)(Yt, { kind: n })), (t[1] = n), (t[2] = r)), r);
}
function Yt(e) {
  let t = (0, $.c)(20),
    { kind: n } = e,
          ...
          d = () => {
            !o ||
              ...
              t({ mountId: r, type: `browser-settings-webview-unmounted` }).catch((e) => {
                m.warning(`Failed to unmount browser settings webview`, {
                  safe: { kind: n },
                  sensitive: { error: e },
                });
              }));
        ...
        return (
          (async () => {
            try {
              ...
              let t = e;
              m.error(`Failed to mount browser settings webview`, {
                safe: { kind: n },
                sensitive: { error: t },
              });
            }
  ...
  (t[15] !== n || t[16] !== c
    ? ((p = () => {
        ...
        e?.({ themeVariant: c, type: `browser-settings-webview-theme-changed` }).catch((e) => {
          m.warning(`Failed to sync browser settings webview theme`, {
            safe: { kind: n },
            sensitive: { error: e },
          });
        });
...
function Xt() {
  ...
  e[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(ne, { className: `icon-xs text-token-text-secondary` })), (e[7] = s))
    : (s = e[7]);
  let c;
  e[8] === n
    ? (c = e[9])
      ...
      : ((r = (0, Q.jsx)(we, {
          ...
          children: (0, Q.jsxs)(X, {
            children: [
              n,
              (0, Q.jsx)(X.Content, {
                children: (0, Q.jsx)(Y, { children: (0, Q.jsx)(en, { hostId: t }) }),
              }),
            ],
          }),
        })),
...
function en(e) {
  let t = (0, $.c)(25),
    { hostId: n } = e,
    r = I(),
    { data: a, isLoading: o } = s(ot),
    c;
  t[0] === n ? (c = t[1]) : ((c = { hostId: n }), (t[0] = n), (t[1] = c));
  let { data: l, isPending: u } = i(se, c),
    d;
  t[2] === n ? (d = t[3]) : ((d = { hostId: n }), (t[2] = n), (t[3] = d));
  let f = st(d),
    p = l?.requirements?.featureRequirements?.[gt],
    m;
  t[4] === p ? (m = t[5]) : ((m = _t(p)), (t[4] = p), (t[5] = m));
  let h = m,
    g = o || u,
    _ = a?.fullCdpAccessEnabled === !0 && !g && !h,
    v;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, Q.jsxs)(`div`, {
        ...
        children: [
          (0, Q.jsxs)(`span`, {
            ...
            children: [
              (0, Q.jsx)(Je, { className: `icon-xs shrink-0` }),
              (0, Q.jsx)(R, {
  ...
  t[11] === b
    ? (x = t[12])
    : ((x = (0, Q.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [y, b] })),
      (t[11] = b),
      (t[12] = x));
  let S;
  t[13] === r
  ...
  t[17] !== _ || t[18] !== C || t[19] !== w || t[20] !== S
    ? ((T = (0, Q.jsx)(qe, { ariaLabel: S, checked: _, disabled: C, onChange: w })),
      (t[17] = _),
      (t[18] = C),
      (t[19] = w),
      (t[20] = S),
  ...
  return (
    t[22] !== T || t[23] !== x
      ? ((E = (0, Q.jsx)(J, { label: v, description: x, control: T })),
        (t[22] = T),
        (t[23] = x),
        (t[24] = E))
      : (E = t[24]),
...
function fn() {
  let e = (0, $.c)(13),
    ...
    a = i(l, M),
    o = t.data === !0 && r.data === !0,
    s = t.isLoading || r.isLoading,
    c;
  e[0] !== o || e[1] !== s
    ? ((c = { enabled: o, isLoading: s }), (e[0] = o), (e[1] = s), (e[2] = c))
    : (c = e[2]);
  let u = c,
    d = t.data === !0 && n.data === !0,
    f = t.isLoading || n.isLoading,
    p;
  e[3] !== d || e[4] !== f
    ? ((p = { enabled: d, isLoading: f }), (e[3] = d), (e[4] = f), (e[5] = p))
    : (p = e[5]);
  let m = t.data === !0 && a.data === !0,
    h = t.isLoading || a.isLoading,
    g;
  e[6] !== m || e[7] !== h
  ...
  return (
    e[9] !== u || e[10] !== p || e[11] !== g
      ? ((v = { contactInfo: u, extensions: p, passwordManager: u, siteSettings: g }),
        (e[9] = u),
        (e[10] = p),
        (e[11] = g),
        (e[12] = v))
...
function pn({ featureEnabled: e, inAppBrowser: t, isFeatureLoading: n }) {
...
function hn(e, t) {
  let n = new Set();
  for (let r of t) {
    for (let t of yn(e, r, `allowed`)) n.add(t);
    for (let t of yn(e, r, `denied`)) n.add(t);
  }
  return [...n]
    ...
    .map((t) => ({
      origin: t,
      values: {
        origin: vn(e, `origin`, t),
        download: vn(e, `download`, t),
        upload: vn(e, `upload`, t),
        fullCdp: vn(e, `fullCdp`, t),
      },
    }));
}
function gn(e, t) {
  if (t.some((t) => t !== `origin` && e.values[t] !== `default`)) return `custom`;
...
function _n({ nextValues: e, origin: t, resources: n, values: r }) {
  return n.flatMap((n) => {
    let i = r[n],
      a = e[n];
    if (a === i) return [];
...
function vn(e, t, n) {
  return yn(e, t, `denied`).includes(n)
    ? `denied`
    : yn(e, t, `allowed`).includes(n)
      ? `allowed`
      : `default`;
}
function yn(e, t, n) {
...
var bn = [`allowed`, `denied`],
  xn = [`default`, `allowed`, `denied`],
  Sn = { origin: `origin`, download: `download`, upload: `upload`, fullCdp: `fullCdp` },
  Cn = { download: `default`, upload: `default`, fullCdp: `default` },
  wn = { origin: `default`, ...Cn };
function Tn() {
  let e = (0, $.c)(12),
    { selectedHostId: t } = Ge(),
    { data: n, isError: r, isLoading: a } = s(ot),
    o;
  e[0] === t ? (o = e[1]) : ((o = { hostId: t }), (e[0] = t), (e[1] = o));
  let { data: c, isError: l, isPending: u } = i(se, o),
    d = n?.fullCdpAccessEnabled === !0,
    f = r || (d && l),
    p = a || (d && u),
    m;
  e[2] !== c?.requirements?.featureRequirements || e[3] !== l || e[4] !== u || e[5] !== d
    ? ((m =
        d && !l && !u && !_t(c?.requirements?.featureRequirements?.browser_use_full_cdp_access)),
...
function En(e) {
  let t = (0, $.c)(29),
    { isError: n, isFullCdpAccessEnabled: r, isLoading: i, originsConfig: a } = e,
    [o, s] = (0, Z.useState)(!1),
    [c, l] = (0, Z.useState)(),
    u,
    d;
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = () => {
      ...
      (h = (0, Q.jsx)(We, { className: `icon-xs` })),
      (g = (0, Q.jsx)(R, {
  ...
  t[11] === _
    ? (b = t[12])
    : ((b = (0, Q.jsx)(X.Header, { actions: _, title: v, subtitle: y })), (t[11] = _), (t[12] = b));
  let x;
          ...
          children: n
            ...
            : i || f == null
              ...
              : f.length === 0
                ...
                : (0, Q.jsx)(Dn, { rows: f, onCustomize: l, visibleResources: d }),
        }),
      })),
      (t[13] = n),
      (t[14] = i),
  ...
  let S;
  t[18] !== o || t[19] !== d
    ? ((S = (0, Q.jsx)(Pn, { open: o, visibleResources: d, onOpenChange: s })),
      (t[18] = o),
      (t[19] = d),
      (t[20] = S))
    : (S = t[20]);
  ...
  let w;
  return (
    t[24] !== x || t[25] !== S || t[26] !== C || t[27] !== b
      ? ((w = (0, Q.jsxs)(X, { className: `gap-2`, children: [b, x, S, C] })),
        (t[24] = x),
        (t[25] = S),
        (t[26] = C),
        (t[27] = b),
...
function Dn(e) {
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(`div`, {
        className: `px-4 py-3 text-xs text-token-text-secondary`,
        children: (0, Q.jsx)(R, {
  ...
  return (
    t[8] === a
      ? (s = t[9])
      : ((s = (0, Q.jsxs)(Q.Fragment, { children: [a, o] })), (t[8] = a), (t[9] = s)),
    s
  );
}
function On(e) {
  let t = (0, $.c)(25),
    ...
    a;
  t[0] !== r || t[1] !== i ? ((a = gn(r, i)), (t[0] = r), (t[1] = i), (t[2] = a)) : (a = t[2]);
  let o = a,
    s;
  t[3] === r.origin
    ? (s = t[4])
  ...
  t[15] !== n || t[16] !== r || t[17] !== i
    ? ((d = (0, Q.jsx)(kn, { row: r, visibleResources: i, onCustomize: n })),
      (t[15] = n),
      (t[16] = r),
      (t[17] = i),
      (t[18] = d))
    : (d = t[18]);
  let f;
  t[19] === r ? (f = t[20]) : ((f = (0, Q.jsx)(Mn, { row: r })), (t[19] = r), (t[20] = f));
  let p;
  return (
...
function kn({ onCustomize: e, row: t, visibleResources: n }) {
  let r = o(c),
    i = I(),
    [a, s] = (0, Z.useState)(!1),
    l = tt(),
  ...
  return (0, Q.jsx)(q, {
    ...
    triggerButton: (0, Q.jsxs)(Ye, {
      ...
      children: [
        (0, Q.jsx)(`span`, {
          ...
          children:
            u === `custom`
              ? (0, Q.jsx)(Oe, { className: `icon-xs text-token-text-secondary` })
              : (0, Q.jsx)(An, { value: u }),
        }),
        (0, Q.jsx)(`span`, { className: `truncate`, children: In(u) }),
      ],
    }),
    children: (0, Q.jsxs)(`div`, {
      ...
      children: [
          ...
          (0, Q.jsx)(
            K.Item,
            {
              ...
              children: (0, Q.jsxs)(`div`, {
                ...
                children: [
                  (0, Q.jsx)(An, { value: e }),
                  (0, Q.jsx)(`span`, { className: `truncate`, children: In(e) }),
                ],
              }),
            },
            e,
        ...
        (0, Q.jsx)(K.Separator, {}),
        (0, Q.jsx)(K.Item, {
          RightIcon: u === `custom` ? U : void 0,
          onSelect: e,
          children: (0, Q.jsxs)(`div`, {
            className: `flex min-w-0 items-center gap-2`,
            children: [
              (0, Q.jsx)(Oe, { className: `icon-xs shrink-0 text-token-text-secondary` }),
              (0, Q.jsx)(R, {
...
function An(e) {
  let t = (0, $.c)(6),
    ...
    o;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((o = B(`size-2 shrink-0 rounded-full`, r, i, a)),
      (t[0] = r),
      (t[1] = i),
      (t[2] = a),
      (t[3] = o))
  ...
  let s;
  return (
    t[4] === o ? (s = t[5]) : ((s = (0, Q.jsx)(`span`, { className: o })), (t[4] = o), (t[5] = s)),
    s
  );
}
function jn(e) {
  let t = (0, $.c)(21),
    ...
    s = `${r} ${o}`,
    c;
  t[0] === a ? (c = t[1]) : ((c = (0, Q.jsx)(An, { value: a })), (t[0] = a), (t[1] = c));
  let l;
  t[2] === a ? (l = t[3]) : ((l = Ln(a)), (t[2] = a), (t[3] = l));
  let u;
  t[4] !== l || t[5] !== o
    ? ((u = (0, Q.jsx)(`span`, { id: o, className: `truncate`, children: l })),
      (t[4] = l),
      (t[5] = o),
      (t[6] = u))
    : (u = t[6]);
        ...
        (0, Q.jsx)(
          K.Item,
          {
            ...
            children: (0, Q.jsxs)(`div`, {
              ...
              children: [
                (0, Q.jsx)(An, { value: e }),
                (0, Q.jsx)(`span`, { className: `truncate`, children: Ln(e) }),
              ],
            }),
          },
          e,
  ...
  t[15] === f
    ? (p = t[16])
    : ((p = (0, Q.jsx)(`div`, { className: `flex flex-col`, children: f })),
      (t[15] = f),
      (t[16] = p));
  let m;
  return (
  ...
  return (0, Q.jsxs)(Q.Fragment, {
    children: [
      (0, Q.jsx)(V, {
        ...
        size: `icon`,
        children: (0, Q.jsx)(Ue, { className: `icon-2xs` }),
      }),
      (0, Q.jsx)(je, {
        open: r,
        onOpenChange: i,
...
function Nn({ onOpenChange: e, row: t, visibleResources: n }) {
  let r = o(c),
    [i, a] = (0, Z.useState)(t.values),
    [s, l] = (0, Z.useState)(!1),
    u = tt(),
    d = async () => {
      if (!s) {
        ...
        try {
          (await u.mutateAsync(
            _n({ nextValues: i, origin: t.origin, resources: n, values: t.values }),
          ),
            e(!1));
        } catch {
          r.get(W).danger(Rn());
          ...
          children: (0, Q.jsx)(Ae, {
            ...
            subtitle: (0, Q.jsx)(Fe, {
              ...
              children: (0, Q.jsxs)(`div`, {
                className: `flex flex-col gap-1`,
                children: [
                  (0, Q.jsx)(`span`, { className: `text-token-text-primary`, children: t.origin }),
                  (0, Q.jsx)(R, {
          ...
          children: (0, Q.jsx)(Y, {
            ...
            children: n.map((e) => {
              ...
              return (0, Q.jsx)(
                J,
                {
                  label: (0, Q.jsx)(`span`, { id: t, children: Fn(e) }),
                  control: (0, Q.jsx)(jn, {
                    disabled: s,
                    labelId: t,
                    value: i[e],
...
function Pn({ onOpenChange: e, open: t, visibleResources: n }) {
  let r = o(c),
    i = I(),
    [a, s] = (0, Z.useState)(``),
    [l, u] = (0, Z.useState)(`allowed`),
    [d, f] = (0, Z.useState)(Cn),
    [p, m] = (0, Z.useState)(!1),
    [h, g] = (0, Z.useState)(!1),
    _ = tt(),
    ...
    x = async () => {
      ...
      if (!(t.length === 0 || h)) {
        ...
        try {
          (await _.mutateAsync(
            _n({ nextValues: { ...d, origin: l }, origin: t, resources: n, values: wn }),
          ),
            b(),
            e(!1));
        } catch {
              ...
              children: [
                ...
                (0, Q.jsx)(q, {
                  ...
                  triggerButton: (0, Q.jsxs)(Ye, {
                    ...
                    children: [
                      (0, Q.jsx)(An, { value: l }),
                      (0, Q.jsx)(`span`, { id: y, className: `truncate`, children: In(l) }),
                    ],
                  }),
                  children: (0, Q.jsx)(`div`, {
                    className: `flex flex-col`,
...
function zn(e) {
  ...
  let { pendingPluginId: x, setPluginEnabled: S } = lt(b),
    C;
  t[7] === o ? (C = t[8]) : ((C = { hostId: o }), (t[7] = o), (t[8] = C));
  let { pendingUninstallPluginId: w, uninstallPlugin: T } = ct(C),
  ...
  if (A === 0) {
    ...
    return (
      t[12] === n
        ? (e = t[13])
        : ((e = (0, Q.jsx)(Y, { children: (0, Q.jsx)(ut, { children: n }) })),
          (t[12] = n),
          (t[13] = e)),
      e
    );
          ...
          (0, Q.jsx)(
            Un,
            {
              ...
              onToggleInstalledPluginEnabled: (e, t) => {
                S({ pluginId: e.plugin.id, pluginDisplayName: ze(e), enabled: t });
              },
              onUninstallPlugin: D,
            },
            e.plugin.plugin.id,
  ...
  let M;
  t[29] === l ? (M = t[30]) : ((M = l.map(Bn)), (t[29] = l), (t[30] = M));
  let N;
  t[31] !== j || t[32] !== M
    ? ((N = (0, Q.jsxs)(Y, { className: `overflow-hidden`, children: [j, M] })),
      (t[31] = j),
      (t[32] = M),
      (t[33] = N))
    : (N = t[33]);
...
function Vn(e) {
  ...
  t[0] === n.icon
    ? (i = t[1])
    : ((i = n.icon ?? (0, Q.jsx)(ge, { className: `icon-md text-token-text-secondary` })),
      (t[0] = n.icon),
      (t[1] = i));
  let a;
  t[2] === i
  ...
  t[16] === u
    ? (d = t[17])
    : ((d = (0, Q.jsx)(qe, { ariaLabel: u, checked: !1, disabled: !0, onChange: Hn })),
      (t[16] = u),
      (t[17] = d));
  let f;
  return (
  ...
  if (
    ...
    let y =
        ...
        (0, Q.jsx)(pe, {
          ...
          fallback: (0, Q.jsx)(ge, { className: `icon-md text-token-text-secondary` }),
        }),
      b;
    t[18] !== v || t[19] !== y
...
function Wn(e, t, n) {
  let r = e.filter((e) => e.plugin.name === t || e.plugin.id.split(`@`)[0] === t),
    i = O(Ce());
  return (
    (i == null ? void 0 : r.find((e) => e.marketplaceName === i)) ??
    r.find((e) => g(e.marketplaceName)) ??
    r.find((e) => e.marketplaceName === `openai-curated`) ??
    r.find((e) => Ke(n, e.marketplacePath)) ??
    null
  );
}
var Gn = `browser-browsing-data-options`,
  Kn = [`cookies`, `siteData`, `cache`],
  qn = a(me, null);
function Jn() {
  let e = (0, $.c)(14),
    t = o(me),
  ...
  let c = dn(a),
    l;
  e[2] === i ? (l = e[3]) : ((l = { hostId: i }), (e[2] = i), (e[3] = l));
  let u = be(l);
  if (r != null) {
    let i = c[r],
      a = i.isLoading && n === r;
    if (!i.enabled && !a) {
      ...
      return (
        e[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, Q.jsx)(le, { to: `/settings/browser-use`, replace: !0 })), (e[5] = t))
          : (t = e[5]),
        t
      );
    }
    n !== r && t.set(qn, r);
    let o;
    return (e[6] === r ? (o = e[7]) : ((o = ir(r)), (e[6] = r), (e[7] = o)), o);
  }
  n != null && t.set(qn, null);
  let d;
  ...
  e[9] === u.available
    ...
    : ((f = u.available
        ? (0, Q.jsx)(R, {
            ...
            values: { computerUseSettingsLink: Yn },
          })
        : void 0),
      (e[9] = u.available),
      (e[10] = f));
...
function Xn() {
  ...
  e[1] !== i || e[2] !== r.availablePlugins
    ? ((a = Wn(r.availablePlugins, P, i)), (e[1] = i), (e[2] = r.availablePlugins), (e[3] = a))
    : (a = e[3]);
  let o = a,
    s;
  ...
  let g = be(h),
    _ = u.enabled && !u.isLoading,
    v = f.passwordManager.enabled,
    y = f.contactInfo.enabled,
    b = f.siteSettings.enabled,
    x = f.extensions.enabled,
    S = m.available || g.available,
    C = b || S,
    w;
  e[14] !== o || e[15] !== m
    ? ((w =
        o == null && hr(m)
          ? [
              {
                description: (0, Q.jsx)(R, { ...he.restrictedAvailabilityDescription }),
                icon: (0, Q.jsx)(ft, { className: `h-full w-full text-token-foreground` }),
                id: `browser-use-unavailable`,
                title: (0, Q.jsx)(R, { ...he.label }),
              },
            ]
          : []),
      (e[14] = o),
    ...
    : ((D = v
        ? (0, Q.jsxs)(X, {
            children: [
              ...
              (0, Q.jsx)(X.Content, { children: (0, Q.jsx)(Y, { children: (0, Q.jsx)(Qn, {}) }) }),
            ],
          })
        : null),
      (e[22] = v),
    ...
    : ((O = y
        ? (0, Q.jsxs)(X, {
            children: [
              (0, Q.jsx)(X.Header, {
                title: (0, Q.jsx)(R, {
                  id: `settings.browserUse.autofill.title`,
                  defaultMessage: `Autofill`,
                  description: `Title for browser autofill settings section`,
                }),
              }),
              (0, Q.jsx)(X.Content, { children: (0, Q.jsx)(Y, { children: (0, Q.jsx)($n, {}) }) }),
            ],
          })
        : null),
      (e[24] = y),
    ...
    : ((k = x
        ? (0, Q.jsxs)(X, {
            children: [
              ...
              (0, Q.jsx)(X.Content, { children: (0, Q.jsx)(Y, { children: (0, Q.jsx)(er, {}) }) }),
            ],
          })
        : null),
      (e[26] = x),
    ...
    : ((A = _
        ? (0, Q.jsxs)(X, {
            children: [
              ...
              (0, Q.jsx)(X.Content, {
                children: (0, Q.jsxs)(Y, { children: [(0, Q.jsx)(or, {}), (0, Q.jsx)(ar, {})] }),
              }),
            ],
          })
        : null),
    ...
    ? ((j = C
        ? (0, Q.jsxs)(X, {
            children: [
              ...
              (0, Q.jsx)(X.Content, {
                children: (0, Q.jsxs)(Y, {
                  children: [b ? (0, Q.jsx)(tr, {}) : null, S ? (0, Q.jsx)(fr, {}) : null],
                }),
              }),
            ],
          })
  ...
  e[34] === S
    ...
    : ((M = S
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [(0, Q.jsx)(Zn, { surface: `inAppBrowser` }), (0, Q.jsx)($t, {})],
          })
        : null),
      (e[34] = S),
      (e[35] = M));
  ...
  return (
    ...
    e[41] !== E ||
    e[42] !== D
      ? ((N = (0, Q.jsxs)(Q.Fragment, { children: [E, D, O, k, A, j, M] })),
        (e[36] = O),
        (e[37] = k),
        (e[38] = A),
        (e[39] = j),
...
function Zn(e) {
  ...
  t[0] === n
    ? ((r = t[1]), (i = t[2]), (a = t[3]))
    : ((r = (0, Q.jsx)(gr, { kind: `denied`, surface: n })),
      (i = (0, Q.jsx)(gr, { kind: `allowed`, surface: n })),
      (a =
        n === `googleChrome`
          ? (0, Q.jsxs)(Q.Fragment, {
              children: [
                (0, Q.jsx)(gr, { kind: `denied`, resource: `downloads`, surface: n }),
                (0, Q.jsx)(gr, { kind: `allowed`, resource: `downloads`, surface: n }),
                (0, Q.jsx)(gr, { kind: `denied`, resource: `uploads`, surface: n }),
                (0, Q.jsx)(gr, { kind: `allowed`, resource: `uploads`, surface: n }),
              ],
            })
          : null),
      (t[0] = n),
  ...
  let o;
  t[4] !== r || t[5] !== i || t[6] !== a
    ? ((o = (0, Q.jsxs)(Q.Fragment, { children: [r, i, a] })),
      (t[4] = r),
      (t[5] = i),
      (t[6] = a),
      (t[7] = o))
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(we, { electron: !0, children: (0, Q.jsx)(Tn, {}) })), (t[8] = c))
    : (c = t[8]);
  let l;
  return (
    t[9] === s
      ...
      : ((l = (0, Q.jsxs)(Q.Fragment, {
          children: [
            c,
            (0, Q.jsx)(we, { browser: !0, chromeExtension: !0, extension: !0, children: s }),
          ],
        })),
        (t[9] = s),
        (t[10] = l)),
...
function nr(e) {
  ...
  t[4] === o
    ? (c = t[5])
    : ((c = (0, Q.jsx)(V, { color: `secondary`, onClick: o, size: `toolbar`, children: s })),
      (t[4] = o),
      (t[5] = c));
  let l;
  return (
    t[6] !== n || t[7] !== r || t[8] !== c
      ? ((l = (0, Q.jsx)(J, { label: r, description: n, control: c })),
        (t[6] = n),
        (t[7] = r),
        (t[8] = c),
        (t[9] = l))
...
function rr() {
  let e = fe(D) != null,
    ...
    n = fe(C) != null,
    r = fe(j) != null;
  return t ? `contactInfo` : e ? `extensions` : n ? `passwordManager` : r ? `siteSettings` : null;
}
function ir(e) {
  switch (e) {
    case `contactInfo`:
...
function ar() {
  let e = (0, $.c)(14),
    t = o(c),
    n = H(E.annotationScreenshotsMode),
    r;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = {
        id: `always`,
  ...
  let a = i,
    s;
  e[2] === n ? (s = e[3]) : ((s = a.find((e) => e.id === n) ?? a[0]), (e[2] = n), (e[3] = s));
  let l = s,
    u,
    d;
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  e[6] === l.label
    ...
    : ((f = (0, Q.jsx)(Ye, {
        className: `w-[168px]`,
        children: (0, Q.jsx)(`span`, { className: `truncate`, children: l.label }),
      })),
      (e[6] = l.label),
      (e[7] = f));
  let p;
    ...
    ? ((p = (0, Q.jsx)(`div`, {
        ...
        children: a.map((e) => {
          ...
          return (0, Q.jsx)(
            ...
            {
              allowWrap: !0,
              RightIcon: r ? U : void 0,
              onSelect: () => {
                ee(t, E.annotationScreenshotsMode, e.id);
              },
  ...
  let e = o(c),
    ...
    l = async (t, n) => {
      if (!s) {
        i(t);
        try {
          (await a.mutateAsync(n), e.get(W).success(ur(t)));
        } catch {
          e.get(W).danger(dr(t));
        } finally {
          i(null);
...
function sr(e) {
  let t = (0, $.c)(17),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = cr(a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === o
    ? (s = t[3])
    : ((s = (0, Q.jsx)(`div`, {
  ...
  t[4] !== a || t[5] !== i
    ...
    : (c = t[6]);
  let l;
  t[7] === a ? (l = t[8]) : ((l = lr(a)), (t[7] = a), (t[8] = l));
  let u;
...
function fr() {
  let e = (0, $.c)(35),
    t = o(c),
    { data: n, isLoading: r } = s(ot),
    i = n?.approvalMode,
    a = $e(),
    { value: l } = ae(mt),
    u;
  e[0] === l ? (u = e[1]) : ((u = pt(l)), (e[0] = l), (e[1] = u));
  let d = u,
    p;
  e[2] === d
    ? (p = e[3])
    : ((p = (e) => {
        (e.preventDefault(), f.dispatchMessage(`open-in-browser`, { url: d }));
      }),
      (e[2] = d),
      (e[3] = p));
  let m = p,
  ...
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = [
        _,
        {
          ...
          elevatedRiskDisclaimer: (0, Q.jsx)(R, {
  ...
  let y = v,
    b;
  e[9] === i ? (b = e[10]) : ((b = y.find((e) => e.id === i) ?? y[0]), (e[9] = i), (e[10] = b));
  let x = b,
    S = a.isPending,
    C;
  e[11] !== i || e[12] !== S || e[13] !== t || e[14] !== a
    ? ((C = async (e) => {
        if (!(e === i || S))
          try {
  ...
  e[19] === k
    ? (A = e[20])
    : ((A = (0, Q.jsx)(`span`, { className: `truncate`, children: k })), (e[19] = k), (e[20] = A));
  let j;
  e[21] !== O || e[22] !== A
    ? ((j = (0, Q.jsx)(Ye, { className: `w-[152px]`, disabled: O, children: A })),
      (e[21] = O),
      (e[22] = A),
      (e[23] = j))
    : (j = e[23]);
  let M;
  e[24] !== i || e[25] !== w || e[26] !== S
    ? ((M = (0, Q.jsx)(`div`, {
        className: `flex flex-col`,
        children: y.map((e) => {
          let t = e.id === i;
  ...
  return (
    e[32] !== N || e[33] !== E
      ? ((P = (0, Q.jsx)(J, { label: T, description: E, control: N })),
        (e[32] = N),
        (e[33] = E),
        (e[34] = P))
      : (P = e[34]),
...
function pr() {
  ...
  let d = u,
    f;
  e[2] === i ? (f = e[3]) : ((f = d.find((e) => e.id === i) ?? d[0]), (e[2] = i), (e[3] = f));
  let p = f,
    m = a.isPending,
    h;
  e[4] !== i || e[5] !== m || e[6] !== t || e[7] !== a
    ? ((h = async (e) => {
        if (!(e === i || m))
          try {
            await a.mutateAsync(e);
  ...
  e[11] === x
    ? (S = e[12])
    : ((S = (0, Q.jsx)(`span`, { className: `truncate`, children: x })), (e[11] = x), (e[12] = S));
  let C;
  e[13] !== b || e[14] !== S
    ? ((C = (0, Q.jsx)(Ye, { className: `w-[152px]`, disabled: b, children: S })),
      (e[13] = b),
      (e[14] = S),
      (e[15] = C))
    : (C = e[15]);
  let w;
  e[16] !== g || e[17] !== i || e[18] !== m
    ? ((w = (0, Q.jsx)(`div`, {
        className: `flex flex-col`,
        children: d.map((e) => {
          let t = e.id === i;
    ...
    (t[5] === o
      ...
      : ((e = (e) => ({
          ...
          onTryInChat: () => {
            o({
              prefillPrompt: Re({
                defaultPrompt: Le(e.plugin.interface?.defaultPrompt),
                pluginDisplayName: ze(e),
                pluginId: e.plugin.id,
              }),
              startInSidebar: !0,
...
function gr(e) {
  let t = (0, $.c)(37),
    ...
    l = i === void 0 ? `inAppBrowser` : i,
    u = o(c),
    { data: d, isLoading: f } = s(ot),
    [p, m] = (0, Z.useState)(!1),
    h = nt(),
    g = it(),
    _;
  t[0] !== n || t[1] !== d || t[2] !== a
    ? ((_ = d == null ? [] : xr(d, a, n)), (t[0] = n), (t[1] = d), (t[2] = a), (t[3] = _))
    : (_ = t[3]);
  let v = _,
    y = a === `origins` ? h.isPending : g.isPending,
    b;
  t[4] !== g || t[5] !== h || t[6] !== n || t[7] !== v || t[8] !== a || t[9] !== u
    ? ((b = async (e) => {
        let t = e.trim();
        if (t.length === 0 || v.includes(t)) return !0;
        try {
          return (
            a === `origins`
              ? await h.mutateAsync({ kind: n, origin: t })
              : await g.mutateAsync({
                  kind: n,
                  origin: t,
                  transferKind: a === `downloads` ? `download` : `upload`,
                }),
            u.get(W).success(rn(a, n)),
            !0
          );
        } catch {
          return (
  ...
  let C;
  t[12] !== n || t[13] !== a
    ? ((C = tn(a, n)), (t[12] = n), (t[13] = a), (t[14] = C))
    : (C = t[14]);
  let w;
  t[15] !== n || t[16] !== a || t[17] !== l
    ? ((w = nn(a, n, l)), (t[15] = n), (t[16] = a), (t[17] = l), (t[18] = w))
    : (w = t[18]);
  let T;
  t[19] !== C || t[20] !== w
    ? ((T = (0, Q.jsx)(X.Header, { actions: S, title: C, subtitle: w })),
      (t[19] = C),
      (t[20] = w),
      (t[21] = T))
    : (T = t[21]);
  let E;
  t[22] !== f || t[23] !== n || t[24] !== v || t[25] !== a
    ? ((E = (0, Q.jsx)(X.Content, {
        children: (0, Q.jsx)(Y, {
          children: f
            ? (0, Q.jsxs)(`div`, {
            ...
            : (0, Q.jsx)(yr, { kind: n, origins: v, resource: a }),
        }),
      })),
      (t[22] = f),
      (t[23] = n),
    ...
    : (E = t[26]);
  let D;
  t[27] !== x || t[28] !== p || t[29] !== y || t[30] !== n || t[31] !== a
    ? ((D = (0, Q.jsx)(vr, {
        kind: n,
        isSaving: y,
        open: p,
  ...
  let O;
  return (
    t[33] !== D || t[34] !== T || t[35] !== E
      ? ((O = (0, Q.jsxs)(X, { children: [T, E, D] })),
        (t[33] = D),
        (t[34] = T),
        (t[35] = E),
        (t[36] = O))
...
function _r(e) {
  let t = (0, $.c)(4),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(We, { className: `icon-xs` })),
      (i = (0, Q.jsx)(R, {
        id: `settings.browserUse.domains.add`,
        defaultMessage: `Add`,
        description: `Button label to add a browser use domain`,
...
function vr(e) {
  ...
  t[7] === f
    ...
    : ((m = (e) => {
      ...
      (t[8] = m));
  let h;
  t[9] !== r || t[10] !== s ? ((h = on(s, r)), (t[9] = r), (t[10] = s), (t[11] = h)) : (h = t[11]);
  let g;
  t[12] !== r || t[13] !== s
    ? ((g = sn(s, r)), (t[12] = r), (t[13] = s), (t[14] = g))
    : (g = t[14]);
  let _;
  t[15] !== h || t[16] !== g
    ? ((_ = (0, Q.jsx)(G, { children: (0, Q.jsx)(Ae, { title: h, subtitle: g }) })),
      (t[15] = h),
      (t[16] = g),
      (t[17] = _))
    : (_ = t[17]);
  ...
  let O;
  t[40] !== w || t[41] !== D
    ? ((O = (0, Q.jsx)(G, { children: (0, Q.jsxs)(Ne, { children: [w, D] }) })),
      (t[40] = w),
      (t[41] = D),
      (t[42] = O))
    : (O = t[42]);
  ...
  t[43] !== x || t[44] !== O || t[45] !== m || t[46] !== _
    ? ((k = (0, Q.jsxs)(Me, { as: `form`, onSubmit: m, children: [_, x, O] })),
      (t[43] = x),
      (t[44] = O),
      (t[45] = m),
      (t[46] = _),
  ...
  return (
    t[48] !== o || t[49] !== k || t[50] !== p
      ? ((A = (0, Q.jsx)(je, { open: o, onOpenChange: p, size: `compact`, children: k })),
        (t[48] = o),
        (t[49] = k),
        (t[50] = p),
        (t[51] = A))
...
function yr(e) {
  let t = (0, $.c)(46),
    ...
    d = at(),
    f = rt(),
    p = i === `origins` ? d.isPending : f.isPending,
    m;
  t[0] !== n || t[1] !== l || t[2] !== f || t[3] !== d || t[4] !== i || t[5] !== a
    ? ((m = async () => {
        if (l != null)
          try {
            (i === `origins`
              ? await d.mutateAsync({ kind: n, origin: l })
              : await f.mutateAsync({
                  kind: n,
                  origin: l,
  ...
  let h = m,
    g;
  t[7] !== s || t[8] !== p || t[9] !== n || t[10] !== r || t[11] !== i
    ? ((g = (0, Q.jsx)(br, {
        kind: n,
        intl: s,
        isSaving: p,
  ...
  let y = l ?? ``,
    b;
  t[14] !== n || t[15] !== i || t[16] !== y
    ? ((b = cn(i, n, y)), (t[14] = n), (t[15] = i), (t[16] = y), (t[17] = b))
    : (b = t[17]);
  let x;
  t[18] !== n || t[19] !== i
    ? ((x = ln(i, n)), (t[18] = n), (t[19] = i), (t[20] = x))
    : (x = t[20]);
  let S;
  t[21] !== b || t[22] !== x
    ? ((S = (0, Q.jsx)(G, { children: (0, Q.jsx)(Ae, { title: b, subtitle: x }) })),
      (t[21] = b),
      (t[22] = x),
      (t[23] = S))
    : (S = t[23]);
  ...
  t[26] === p
    ? (T = t[27])
    : ((T = (0, Q.jsx)(V, { color: `ghost`, disabled: p, onClick: w, children: C })),
      (t[26] = p),
      (t[27] = T));
  let E;
  t[28] === h
  ...
  let O;
  t[31] !== p || t[32] !== E
    ? ((O = (0, Q.jsx)(V, { color: `danger`, loading: p, onClick: E, children: D })),
      (t[31] = p),
      (t[32] = E),
      (t[33] = O))
    : (O = t[33]);
  let k;
  t[34] !== T || t[35] !== O
    ? ((k = (0, Q.jsx)(G, { children: (0, Q.jsxs)(Ne, { children: [T, O] }) })),
      (t[34] = T),
      (t[35] = O),
      (t[36] = k))
    : (k = t[36]);
  let A;
  t[37] !== k || t[38] !== S
    ? ((A = (0, Q.jsxs)(Me, { children: [S, k] })), (t[37] = k), (t[38] = S), (t[39] = A))
    : (A = t[39]);
  let j;
  t[40] !== A || t[41] !== _
    ? ((j = (0, Q.jsx)(je, { open: _, onOpenChange: v, size: `compact`, children: A })),
      (t[40] = A),
      (t[41] = _),
      (t[42] = j))
    : (j = t[42]);
  ...
  return (
    t[43] !== j || t[44] !== g
      ? ((M = (0, Q.jsxs)(Q.Fragment, { children: [g, j] })), (t[43] = j), (t[44] = g), (t[45] = M))
      : (M = t[45]),
    M
  );
}
function br(e) {
  ...
  if (o.length === 0) {
    let e;
    t[0] !== i || t[1] !== s ? ((e = un(s, i)), (t[0] = i), (t[1] = s), (t[2] = e)) : (e = t[2]);
    let n;
    return (
      t[3] === e
        ? (n = t[4])
...
//# sourceMappingURL=browser-use-settings.js.map
