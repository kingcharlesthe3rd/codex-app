...
import { R as r, c as i, h as a, o, s, t as c } from "./app-scope.js";
import { Co as l } from "./app-server-manager-signals.js";
import { _ as u, c as d, m as f, o as p, u as m } from "./vscode-api.js";
...
import { h as x } from "./codex-api.js";
import { o as S } from "./prompt-text.js";
import { r as C } from "./skus.js";
import { t as w } from "./folder.js";
import { r as T } from "./local-projects.js";
import { t as E } from "./worktree.js";
import { t as D } from "./folder-open.js";
import { t as O } from "./sortBy.js";
import { t as k } from "./score-query-match-CZO-nWKm.js";
var A = r(),
  j = e(t(), 1),
...
function I(e) {
  ...
  let { enabled: r } = n,
    ...
    f = i && s === `chatgpt`,
    g;
  t[2] === f ? (g = t[3]) : ((g = { queryConfig: { enabled: f } }), (t[2] = f), (t[3] = g));
  let { data: _, isLoading: S, isError: w } = p(`account-info`, g),
    T = _?.plan ?? void 0,
    E = C(T),
    D;
  t[4] === _?.accountId
    ? (D = t[5])
    : ((D = async () =>
        y.safeGet(`/accounts/{account_id}/settings`, {
  ...
  let {
      ...
      enabled: i && !!_?.accountId && E && s === `chatgpt`,
      queryFn: D,
      staleTime: m.ONE_MINUTE,
    }),
    F = i && s === `chatgpt`,
    I;
  t[6] === F ? (I = t[7]) : ((I = { enabled: F }), (t[6] = F), (t[7] = I));
  let { data: R, isLoading: z, error: B } = x(I),
    V = v(`1907601843`),
    H = S || k || z,
    U = B instanceof d && B.status === 404,
    W = L(T, s, {
      isLoading: H,
      hasErrors: w || (E && P) || (!!B && !U),
    ...
    G,
    K;
  (t[8] !== W || t[9] !== i || t[10] !== a || t[11] !== l
    ? ((G = () => {
        i && (a.set(N, W), W !== `loading` && W !== `error` && l(W));
      }),
      (K = [W, i, a, l]),
      (t[8] = W),
      (t[9] = i),
...
function L(
  ...
  let s = C(e),
    c = (e) => {
      o && !o.current && (f.info(e), (o.current = !0));
    };
  return t === `chatgpt`
    ? n
      ? `loading`
...
function z(e, t) {
  let n = `~`;
  return (
    t != null && (n = t.projectKind === `remote` ? t.path : T.getThreadStartCwd(t)), e.set(R, n), n
  );
}
var B = e(O(), 1),
  V = e(l(), 1),
  ...
  U = a(S, []),
  W = a(S, !1),
  G = i(S, ({ get: e }) => Z((0, V.default)([...e(U), ...e(H)], (e) => e.id))),
  K = /^\s*\/[^/\r\n]*\s*$/;
function q(e) {
  let t = (0, A.c)(7),
    n,
...
function X(e, t) {
  return Z([...e.filter((e) => e.id !== t.id), t].filter((e) => e.enabled !== !1));
}
function Z(e) {
...
function te(e, t) {
  return Math.max(k(e.title, t), ...(e.searchAliases ?? []).map((e) => k(e, t)));
}
function ne(e, t) {
  return t ? e.filter((e) => !e.requiresEmptyComposer) : e;
}
function re(e) {
  return e.trim().length === 0 ? !1 : !K.test(e);
}
var $ = n(),
  ie = (e) =>
    (0, $.jsxs)(`svg`, {
...
function oe(e) {
  ...
  if (r) {
    let e;
    return (
      t[0] === o ? (e = t[1]) : ((e = (0, $.jsx)(E, { className: o })), (t[0] = o), (t[1] = e)), e
    );
  }
  if (s) {
    let e;
    return (
      t[2] === o ? (e = t[3]) : ((e = (0, $.jsx)(ae, { className: o })), (t[2] = o), (t[3] = e)), e
    );
  }
  if (n) {
    let e;
    return (
      t[4] === o ? (e = t[5]) : ((e = (0, $.jsx)(ie, { className: o })), (t[4] = o), (t[5] = e)), e
    );
  }
  if (c) {
    let e;
    return (
      t[6] === o ? (e = t[7]) : ((e = (0, $.jsx)(D, { className: o })), (t[6] = o), (t[7] = e)), e
    );
  }
  let l;
  return (
    t[8] === o ? (l = t[9]) : ((l = (0, $.jsx)(w, { className: o })), (t[8] = o), (t[9] = l)), l
  );
}
function se({
