...
import { c as r, g as i, o as a, s as o, t as s, z as c } from "./app-scope.js";
import { Mo as l } from "./app-server-manager-signals.js";
...
import { t as b } from "./folder.js";
import { t as x } from "./use-auth.js";
import { r as S } from "./skus.js";
import { h as C } from "./codex-api.js";
...
function I(e) {
  ...
  let { data: _, isLoading: b, isError: w } = f(`account-info`, g),
    T = _?.plan ?? void 0,
    E = S(T),
    D;
  t[4] === _?.accountId
  ...
  let {
      ...
      enabled: i && !!_?.accountId && E && c === `chatgpt`,
      queryFn: D,
  ...
  let { data: R, isLoading: z, error: B } = C(I),
    V = v(`1907601843`),
    H = b || k || z,
    U = B instanceof u && B.status === 404,
    W = L(T, c, {
      isLoading: H,
      hasErrors: w || (E && P) || (!!B && !U),
    ...
    G,
    K;
  (t[8] !== W || t[9] !== i || t[10] !== o || t[11] !== l
    ? ((G = () => {
        i && (o.set(N, W), W !== `loading` && W !== `error` && l(W));
      }),
      (K = [W, i, o, l]),
      (t[8] = W),
      (t[9] = i),
...
var B = e(O(), 1),
  ...
  U = i(w, []),
  W = i(w, !1),
  G = r(w, ({ get: e }) => Z((0, V.default)([...e(U), ...e(H)], (e) => e.id))),
  K = /^\s*\/[^/\r\n]*\s*$/;
function q(e) {
  let t = (0, A.c)(7),
    n,
...
function oe(e) {
  ...
  let l;
  return (
    t[8] === o ? (l = t[9]) : ((l = (0, $.jsx)(b, { className: o })), (t[8] = o), (t[9] = l)), l
  );
}
function se({
