...
import { Ps as t, ec as n, tc as r } from "./app-server-manager-signals.js";
...
import { h as y } from "./codex-api-B.js";
import { r as b } from "./skus.js";
...
function O() {
  ...
  if ((a === `loading` || a === `error`) && r != null) {
    let t;
    return (e[2] === r ? (t = e[3]) : ((t = { access: r }), (e[2] = r), (e[3] = t)), t);
  }
  let o;
...
function A(e) {
  ...
  let { enabled: i } = n,
    ...
    h = a && d === `chatgpt`,
    x;
  t[2] === h ? (x = t[3]) : ((x = { queryConfig: { enabled: h } }), (t[2] = h), (t[3] = x));
...
function N(e, t) {
  let n = `~`;
  return (
    t != null && (n = t.projectKind === `remote` ? t.path : x.getThreadStartCwd(t)), e.set(M, n), n
  );
}
var P = e(S(), 1),
  F = f([]),
...
function R(e) {
  ...
  t[5] !== n || t[6] !== s
    ? ((c = () => {
        s((e) => (0, P.default)([...e.filter((e) => e.id !== n.id), n].filter(V), [B, z]));
      }),
      (t[5] = n),
      (t[6] = s),
      (t[7] = c))
...
function H(e, t) {
  ...
  return (
    ...
    (0, P.default)(
      e.map((e) => ({ command: e, score: C(e.title, n) })).filter((e) => e.score > 0),
      [
