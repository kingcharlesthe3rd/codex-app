...
import { _ as l, c as u, m as d, o as f, u as p } from "./vscode-api.js";
import { i as m, r as h } from "./react.js";
import { do as g } from "./app-server-manager-signals.js";
import { t as _ } from "./persisted-atom.js";
import { o as v } from "./statsig-DoZ-0xit.js";
...
function I(e) {
  ...
  let { enabled: r } = n,
    ...
    h = i && s === `chatgpt`,
    g;
  t[2] === h ? (g = t[3]) : ((g = { queryConfig: { enabled: h } }), (t[2] = h), (t[3] = g));
  let { data: _, isLoading: S, isError: w } = f(`account-info`, g),
    T = _?.plan ?? void 0,
    E = C(T),
    D;
  t[4] === _?.accountId
  ...
  let { data: R, isLoading: z, error: B } = x(I),
    ...
    G,
    K;
  (t[8] !== W || t[9] !== i || t[10] !== a || t[11] !== d
    ? ((G = () => {
        i && (a.set(N, W), W !== `loading` && W !== `error` && d(W));
      }),
      (K = [W, i, a, d]),
      (t[8] = W),
      (t[9] = i),
