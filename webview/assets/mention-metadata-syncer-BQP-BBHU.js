...
function A(e) {
  ...
  if (
    ...
    let e = ee({ appName: i, windowTitle: g }),
      o = d ?? ``,
      s;
    t[31] !== a || t[32] !== f || t[33] !== o
    ...
    let c = s,
      l;
    t[35] !== c || t[36] !== u
      ? ((l = u ?? [c]), (t[35] = c), (t[36] = u), (t[37] = l))
      : (l = t[37]);
    let h = l;
    R = h[I] ?? c;
    let x;
    (t[38] === R.accessibilityText
      ? (x = t[39])
      : ((x = R.accessibilityText?.trim() ?? ``), (t[38] = R.accessibilityText), (t[39] = x)),
      (L = x),
      (B = L.length > 0),
      (V = A && B),
      (U = I > 0 ? I - 1 : null),
      (H = I + 1 < h.length ? I + 1 : null));
    let w = m != null && m.length > 0,
      D = p ?? 140,
      O;
    t[40] !== p || t[41] !== b
      ? ((O = b === `composer` ? E(p) : void 0), (t[40] = p), (t[41] = b), (t[42] = O))
      : (O = t[42]);
    let j = O,
      M;
    (t[43] === y
    ...
    let ne = Q,
      ...
      re = v ? `cursor-interaction` : `cursor-default`;
    (t[53] !== $ || t[54] !== re
      ? ((K = r($, re)), (t[53] = $), (t[54] = re), (t[55] = K))
      : (K = t[55]),
      t[56] === j
        ? (q = t[57])
        : ((q = j == null ? void 0 : { height: j }), (t[56] = j), (t[57] = q)),
      (J = v ? `button` : void 0),
      (Y = v ? e : void 0),
      (X = v ? 0 : void 0),
      t[58] !== z || t[59] !== v
        ? ((Z = v
            ? (e) => {
                (e.key === `Enter` || e.key === ` `) && (e.preventDefault(), z(!0));
              }
            : void 0),
          (t[58] = z),
          (t[59] = v),
  ...
  let $;
  t[70] !== L || t[71] !== V
    ? (($ = V ? (0, k.jsx)(M, { accessibilityText: L }) : void 0),
      (t[70] = L),
      (t[71] = V),
      (t[72] = $))
    : ($ = t[72]);
...
function L(e) {
  let t = (0, D.c)(14),
    ...
    c;
  t[0] !== r || t[1] !== i || t[2] !== a
    ? ((c = I(r, i, a)), (t[0] = r), (t[1] = i), (t[2] = a), (t[3] = c))
    : (c = t[3]);
  let { data: l } = o(c),
    u,
    d,
...
function W(e) {
  ...
  let { availablePlugins: h } = g(i, o, p),
    y;
  t[3] === h ? (y = t[4]) : ((y = v(h)), (t[3] = h), (t[4] = y));
  let b = y != null,
    x;
  t[5] === b ? (x = t[6]) : ((x = { enabled: b }), (t[5] = b), (t[6] = x));
  let { nativeApps: S } = _(x),
    C,
    w;
  return (
    t[7] !== n ||
...
export { A as a, F as i, V as n, E as o, te as r, H as t };
//# sourceMappingURL=mention-metadata-syncer-BQP-BBHU.js.map
