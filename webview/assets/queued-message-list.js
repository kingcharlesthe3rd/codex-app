...
import { Rt as i } from "./use-host-config.js";
import "./thread-context-inputs.js";
import "./vscode-api.js";
import "./isEqual.js";
import "./src.js";
import "./react-dom.js";
import { i as a, l as o, s } from "./lib-1.js";
...
import { t as u } from "./tooltip-B.js";
...
import "./statsig.js";
import "./request.js";
import { t as d } from "./warning.js";
import "./markdown-to-search-text.js";
import { a as f, d as p, f as m, i as h, p as ne, t as re } from "./core.esm.js";
import { r as g, t as _ } from "./modifiers.esm-BFjb-QXg.js";
import "./marked.esm.js";
import "./product-logger.js";
import { h as ie } from "./parse-directives.js";
import "./platform.js";
...
import { a as ae, i as oe, n as y, t as se } from "./sortable.esm.js";
import { r as b, t as x } from "./dropdown.js";
import "./globe.js";
import { t as S } from "./three-dots.js";
import { t as C } from "./drag.js";
import "./composer-top-menu-chrome.js";
import { i as ce, o as le, t as ue } from "./above-composer-panel-row.js";
import "./browser-sidebar-state.js";
import { t as w } from "./trash-DL-ar7Ww.js";
import { n as T } from "./comment-attachment-labels.js";
import "./external-link-favicon.js";
import "./external-markdown-link.js";
import { t as de } from "./user-formatted-text.js";
var fe = r();
e(t());
var E = n(),
  pe = (e) =>
...
function D(e) {
  let t = (0, fe.c)(40),
    {
      ...
      onReorderMessages: m,
      onQueueingChange: h,
      onResumeInterruptedQueue: ne,
    } = e,
    g = o(),
    _;
  t[0] === n ? (_ = t[1]) : ((_ = n.map(O)), (t[0] = n), (t[1] = _));
  let v = _,
    oe;
  t[2] !== v || t[3] !== m
    ? ((oe = { messageIds: v, onReorderMessages: m }), (t[2] = v), (t[3] = m), (t[4] = oe))
    : (oe = t[4]);
  let y = he(oe);
    ...
    t[27] !== p
      ? ((e = (e) => {
          let {
            ...
            } = ce(e.context.commentAttachments ?? []),
            o = i(e.context.fileAttachments, e.context.generatedPastedTextAttachmentPaths);
          return (0, E.jsx)(
            k,
            {
              messageId: e.id,
              messageText: ge(g, {
                ...
                pastedTextAttachmentPreview:
                  e.context.pastedTextAttachments?.[0]?.preview ?? (o == null ? void 0 : ``),
                pastedTextAttachmentCount: e.context.pastedTextAttachments?.length ?? o?.length,
                selectedTextAttachmentCount: e.context.selectedTextAttachments?.length,
              }),
  ...
  t[29] === x
    ? (S = t[30])
    : ((S = (0, E.jsx)(ee, { initial: !1, children: x })), (t[29] = x), (t[30] = S));
  let C;
  t[31] !== v || t[32] !== S
    ? ((C = (0, E.jsx)(se, { items: v, strategy: ae, children: S })),
      (t[31] = v),
      (t[32] = S),
      (t[33] = C))
    : (C = t[33]);
  let w;
  t[34] !== y || t[35] !== C
    ? ((w = (0, E.jsx)(re, { ...y, children: C })), (t[34] = y), (t[35] = C), (t[36] = w))
    : (w = t[36]);
  let T;
  return (
    t[37] !== b || t[38] !== w
...
function k(e) {
  let t = (0, fe.c)(92),
    ...
    g = o(),
    _;
  t[0] === n ? (_ = t[1]) : ((_ = { id: n }), (t[0] = n), (t[1] = _));
  let {
      attributes: ie,
      listeners: ae,
      setNodeRef: y,
    ...
    D = i ? _e.retryQueuedMessage : _e.sendQueuedMessageNow,
    O;
  t[2] === ce ? (O = t[3]) : ((O = ne.Translate.toString(ce)), (t[2] = ce), (t[3] = O));
  let k;
  t[4] !== O || t[5] !== le
    ? ((k = { transform: O, transition: le }), (t[4] = O), (t[5] = le), (t[6] = k))
    : (k = t[6]);
  let he, ge, ve, ye;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((he = { height: 0, opacity: 0 }),
      (ge = { height: `auto`, opacity: 1 }),
      (ve = { height: 0, opacity: 0 }),
      (ye = { duration: 0.18 }),
      (t[7] = he),
      (t[8] = ge),
      (t[9] = ve),
      (t[10] = ye))
    : ((he = t[7]), (ge = t[8]), (ve = t[9]), (ye = t[10]));
  let be = ee || T ? `opacity-60` : void 0,
    xe = T ? `opacity-100` : `opacity-0 group-hover:opacity-100`,
    A;
  t[11] === xe
    ? (A = t[12])
    : ((A = c(
  ...
  t[13] === A
    ? (j = t[14])
    : ((j = (0, E.jsx)(C, { className: A, "aria-hidden": !0 })), (t[13] = A), (t[14] = j));
  let Se;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (0, E.jsx)(pe, { className: `icon-2xs text-token-input-placeholder-foreground/70` })),
      (t[15] = Se))
    : (Se = t[15]);
  let M;
  t[16] !== ie || t[17] !== ae || t[18] !== se || t[19] !== j
    ? ((M = (0, E.jsxs)(`span`, {
        ref: se,
  ...
  let L;
  t[31] !== g || t[32] !== D
    ? ((L = g.formatMessage(D)), (t[31] = g), (t[32] = D), (t[33] = L))
    : (L = t[33]);
  let R;
  t[34] !== n || t[35] !== h
    ? ((R = (e) => {
  ...
  t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ce = (0, E.jsx)(me, { className: `icon-2xs shrink-0` })), (t[37] = Ce))
    : (Ce = t[37]);
  let z;
  t[38] === D ? (z = t[39]) : ((z = (0, E.jsx)(s, { ...D })), (t[38] = D), (t[39] = z));
  let B;
  ...
  t[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((we = (0, E.jsx)(w, { className: `icon-2xs` })), (t[52] = we))
    : (we = t[52]);
  let W;
  t[53] !== H || t[54] !== U
    ? ((W = (0, E.jsx)(te, {
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Te = (0, E.jsx)(S, { className: `icon-2xs` })), (t[58] = Te))
    : (Te = t[58]);
  let K;
  t[59] === G
    ? (K = t[60])
  ...
  t[72] !== Y || t[73] !== X
    ...
    : (Z = t[74]);
  let Q;
  t[75] !== K || t[76] !== J || t[77] !== Z
    ? ((Q = (0, E.jsxs)(x, { align: `end`, triggerButton: K, children: [J, Z] })),
      (t[75] = K),
      (t[76] = J),
      (t[77] = Z),
      (t[78] = Q))
    : (Q = t[78]);
  let De;
  t[79] !== V || t[80] !== W || t[81] !== Q
    ? ((De = (0, E.jsxs)(E.Fragment, { children: [V, W, Q] })),
      (t[79] = V),
      (t[80] = W),
      (t[81] = Q),
      (t[82] = De))
    : (De = t[82]);
  let $;
  t[83] !== M || t[84] !== F || t[85] !== De || t[86] !== be
    ? (($ = (0, E.jsx)(ue, { className: be, icon: M, title: F, actions: De })),
      (t[83] = M),
      (t[84] = F),
      (t[85] = De),
      (t[86] = be),
...
function he(e) {
  ...
  let a = m(p(h, i)),
    o;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = [g, _]), (t[1] = o)) : (o = t[1]);
  let s;
  t[2] !== n || t[3] !== r
    ? ((s = (e) => {
  ...
  return (
    t[5] !== a || t[6] !== s
      ? ((c = { sensors: a, collisionDetection: f, modifiers: o, onDragEnd: s }),
        (t[5] = a),
        (t[6] = s),
        (t[7] = c))
      : (c = t[7]),
...
function ge(
  e,
  {
    ...
    designTweakCount: r,
    diffCommentCount: i,
    pastedTextAttachmentCount: a = 0,
    pastedTextAttachmentPreview: o,
    selectedTextAttachmentCount: s = 0,
  },
) {
  ...
  if (o != null) {
    ...
    return a <= 1
      ...
      : e.formatMessage(
          ...
          { preview: t, remainingCount: a - 1 },
        );
  }
  return n > 0 || r > 0 || i > 0
    ? T(e, { annotationCount: n, designTweakCount: r, commentCount: i })
    : s > 0
      ? e.formatMessage(
          {
