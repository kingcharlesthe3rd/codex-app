...
import "./src-C.js";
import { qr as t } from "./app-server-manager-signals.js";
import { n, t as r } from "./jsx-runtime.js";
import { t as i } from "./clsx.js";
import "./react-dom.js";
import "./Combination.js";
import { a, d as o, f as s, i as c, p as l, t as u } from "./core.esm.js";
import { r as d, t as f } from "./modifiers.esm.js";
import "./marked.esm-BR-H6018.js";
import { G as p, U as m, V as h, wt as g } from "./setting-storage.js";
...
import { t as b } from "./AnimatePresence-Dsr-oiZk.js";
import "./apps.js";
import "./x.js";
...
import { a as ee, i as x, n as S, t as te } from "./sortable.esm.js";
import "./check-md.js";
...
import "./search.js";
import "./skills.js";
import { r as C, t as ne } from "./dropdown.js";
import "./globe.js";
import { t as re } from "./three-dots.js";
import { t as ie } from "./trash.js";
import { t as ae } from "./warning.js";
...
import { l as se, r as ce, s as le, t as ue } from "./above-composer-panel-row.js";
...
function ge(e) {
  let n = (0, pe.c)(32),
    ...
    m = p(),
    h;
  n[0] === r ? (h = n[1]) : ((h = r.map(T)), (n[0] = r), (n[1] = h));
  let g = h,
    _;
  n[2] !== g || n[3] !== d
    ? ((_ = { messageIds: g, onReorderMessages: d }), (n[2] = g), (n[3] = d), (n[4] = _))
    : (_ = n[4]);
  let v = D(_);
  ...
  if (
    ...
    n[22] !== l
      ? ((e = (e) => {
          let {
            annotationCommentAttachments: n,
            designTweakCommentAttachments: r,
            diffCommentAttachments: u,
          } = le(e.commentAttachments);
          return (0, w.jsx)(
            E,
            {
              messageId: e.id,
              messageText: O(m, {
                text: t(e.text),
                browserCommentCount: n.length,
                designTweakCount: r.length,
                diffCommentCount: u.length,
  ...
  n[24] === y
    ? (x = n[25])
    : ((x = (0, w.jsx)(b, { initial: !1, children: y })), (n[24] = y), (n[25] = x));
  let S;
  n[26] !== g || n[27] !== x
    ? ((S = (0, w.jsx)(te, { items: g, strategy: ee, children: x })),
      (n[26] = g),
      (n[27] = x),
      (n[28] = S))
    : (S = n[28]);
    ...
    n[29] !== v || n[30] !== S
      ? ((C = (0, w.jsx)(se, {
          children: (0, w.jsx)(`div`, {
            ...
            children: (0, w.jsx)(u, { ...v, children: S }),
          }),
        })),
        (n[29] = v),
        (n[30] = S),
...
function E(e) {
  ...
  let {
    ...
    T = a ? _e.retryQueuedMessage : _e.sendQueuedMessageNow,
    E;
  t[2] === ce ? (E = t[3]) : ((E = l.Translate.toString(ce)), (t[2] = ce), (t[3] = E));
  let D;
  t[4] !== E || t[5] !== le
    ? ((D = { transform: E, transition: le }), (t[4] = E), (t[5] = le), (t[6] = D))
    : (D = t[6]);
  let O, ve, ye, be;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = { height: 0, opacity: 0 }),
      ...
      (t[9] = ye),
      (t[10] = be))
    : ((O = t[7]), (ve = t[8]), (ye = t[9]), (be = t[10]));
  let xe = s || ge ? `opacity-60` : void 0,
    Se = ge ? `opacity-100` : `opacity-0 group-hover:opacity-100`,
    k;
  t[11] === Se
    ? (k = t[12])
    : ((k = i(
  ...
  t[13] === k
    ? (A = t[14])
    : ((A = (0, w.jsx)(de, { className: k, "aria-hidden": !0 })), (t[13] = k), (t[14] = A));
  let Ce;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ce = (0, w.jsx)(me, { className: `icon-2xs text-token-input-placeholder-foreground/70` })),
      (t[15] = Ce))
    : (Ce = t[15]);
  let j;
  t[16] !== ee || t[17] !== S || t[18] !== se || t[19] !== A
    ? ((j = (0, w.jsxs)(`span`, {
        ref: se,
  ...
  let I;
  t[31] !== g || t[32] !== T
    ? ((I = g.formatMessage(T)), (t[31] = g), (t[32] = T), (t[33] = I))
    : (I = t[33]);
  let L;
  t[34] !== n || t[35] !== f
    ? ((L = (e) => {
  ...
  t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((we = (0, w.jsx)(he, { className: `icon-2xs shrink-0` })), (t[37] = we))
    : (we = t[37]);
  let R;
  t[38] === T ? (R = t[39]) : ((R = (0, w.jsx)(m, { ...T })), (t[38] = T), (t[39] = R));
  let z;
  ...
  t[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Te = (0, w.jsx)(ie, { className: `icon-2xs` })), (t[52] = Te))
    : (Te = t[52]);
  let U;
  t[53] !== V || t[54] !== H
    ? ((U = (0, w.jsx)(v, {
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ee = (0, w.jsx)(re, { className: `icon-2xs` })), (t[58] = Ee))
    : (Ee = t[58]);
  let G;
  t[59] === W
    ? (G = t[60])
  ...
  t[75] !== G || t[76] !== q || t[77] !== X
    ? ((Z = (0, w.jsxs)(ne, { align: `end`, triggerButton: G, children: [q, X] })),
      (t[75] = G),
      (t[76] = q),
      (t[77] = X),
      (t[78] = Z))
  ...
  t[79] !== B || t[80] !== U || t[81] !== Z
    ? ((Q = (0, w.jsxs)(w.Fragment, { children: [B, U, Z] })),
      (t[79] = B),
      (t[80] = U),
      (t[81] = Z),
      (t[82] = Q))
  ...
  t[83] !== j || t[84] !== P || t[85] !== Q || t[86] !== xe
    ? (($ = (0, w.jsx)(ue, { className: xe, icon: j, title: P, actions: Q })),
      (t[83] = j),
      (t[84] = P),
      (t[85] = Q),
      (t[86] = xe),
...
function D(e) {
  ...
  let l = s(o(c, i)),
    u;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((u = [d, f]), (t[1] = u)) : (u = t[1]);
  let p;
  t[2] !== n || t[3] !== r
    ? ((p = (e) => {
  ...
  return (
    t[5] !== l || t[6] !== p
      ? ((m = { sensors: l, collisionDetection: a, modifiers: u, onDragEnd: p }),
        (t[5] = l),
        (t[6] = p),
        (t[7] = m))
      : (m = t[7]),
...
function O(
  ...
  return t.trim().length > 0
    ? t
    : n > 0 || r > 0 || i > 0
      ? ce(e, { annotationCount: n, designTweakCount: r, commentCount: i })
      : a > 0
        ? e.formatMessage(
            {
...
export { ge as QueuedMessageList };
