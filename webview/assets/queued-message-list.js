...
import "./src-2.js";
import { La as t, ni as n } from "./app-server-manager-signals.js";
import { n as r, t as i } from "./jsx-runtime.js";
import { t as a } from "./clsx.js";
import "./react-dom.js";
import "./Combination.js";
import { a as o, d as s, f as c, i as l, p as u, t as d } from "./core.esm.js";
import { r as f, t as p } from "./modifiers.esm.js";
import "./marked.esm-BR-H6018.js";
import { lt as m } from "./vscode-api.js";
import { c as ee, o as h, r as g } from "./lib-2.js";
...
import { a as ae, i as v, n as y, t as oe } from "./sortable.esm.js";
import "./search.js";
import { r as se, t as b } from "./dropdown.js";
import "./globe.js";
import { t as x } from "./three-dots.js";
import { t as S } from "./trash.js";
import { t as C } from "./warning.js";
import "./composer-top-menu-chrome.js";
import { l as ce, r as w, s as le, t as ue } from "./above-composer-panel-row.js";
import "./browser-sidebar-state.js";
import { t as de } from "./drag-PYQT-pAy.js";
import { t as fe } from "./user-formatted-text.js";
var pe = m();
e(r());
var T = i(),
  me = (e) =>
...
function E(e) {
  let r = (0, pe.c)(40),
    {
      ...
      onReorderMessages: m,
      onQueueingChange: g,
      onResumeInterruptedQueue: te,
    } = e,
    _ = ee(),
    ie;
  r[0] === i ? (ie = r[1]) : ((ie = i.map(D)), (r[0] = i), (r[1] = ie));
  let v = ie,
    y;
  r[2] !== v || r[3] !== m
    ? ((y = { messageIds: v, onReorderMessages: m }), (r[2] = v), (r[3] = m), (r[4] = y))
    : (y = r[4]);
  let se = ge(y);
  ...
  if (
    ...
    r[27] !== p
      ? ((e = (e) => {
          let {
            annotationCommentAttachments: r,
            designTweakCommentAttachments: i,
            diffCommentAttachments: o,
          } = le(e.context.commentAttachments ?? []);
          return (0, T.jsx)(
            O,
            {
              messageId: e.id,
              messageText: _e(_, {
                text: n(e.text),
                browserCommentCount: r.length,
                designTweakCount: i.length,
                diffCommentCount: o.length,
                generatedPastedTextAttachmentCount: t(
  ...
  r[29] === x
    ? (S = r[30])
    : ((S = (0, T.jsx)(re, { initial: !1, children: x })), (r[29] = x), (r[30] = S));
  let C;
  r[31] !== v || r[32] !== S
    ? ((C = (0, T.jsx)(oe, { items: v, strategy: ae, children: S })),
      (r[31] = v),
      (r[32] = S),
      (r[33] = C))
    : (C = r[33]);
  let w;
  r[34] !== se || r[35] !== C
    ? ((w = (0, T.jsx)(d, { ...se, children: C })), (r[34] = se), (r[35] = C), (r[36] = w))
    : (w = r[36]);
  let de;
  return (
    r[37] !== b || r[38] !== w
...
function O(e) {
  let t = (0, pe.c)(92),
    ...
    m = ee(),
    g;
  t[0] === n ? (g = t[1]) : ((g = { id: n }), (t[0] = n), (t[1] = g));
  let {
      attributes: re,
      listeners: ae,
      setNodeRef: y,
    ...
    E = i ? ve.retryQueuedMessage : ve.sendQueuedMessageNow,
    D;
  t[2] === ce ? (D = t[3]) : ((D = u.Translate.toString(ce)), (t[2] = ce), (t[3] = D));
  let O;
  t[4] !== D || t[5] !== w
    ? ((O = { transform: D, transition: w }), (t[4] = D), (t[5] = w), (t[6] = O))
    : (O = t[6]);
  let ge, _e, ye, be;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ge = { height: 0, opacity: 0 }),
      (_e = { height: `auto`, opacity: 1 }),
      ...
      (t[9] = ye),
      (t[10] = be))
    : ((ge = t[7]), (_e = t[8]), (ye = t[9]), (be = t[10]));
  let xe = s || le ? `opacity-60` : void 0,
    Se = le ? `opacity-100` : `opacity-0 group-hover:opacity-100`,
    k;
  t[11] === Se
    ? (k = t[12])
    : ((k = a(
  ...
  t[13] === k
    ? (A = t[14])
    : ((A = (0, T.jsx)(de, { className: k, "aria-hidden": !0 })), (t[13] = k), (t[14] = A));
  let Ce;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ce = (0, T.jsx)(me, { className: `icon-2xs text-token-input-placeholder-foreground/70` })),
      (t[15] = Ce))
    : (Ce = t[15]);
  let j;
  t[16] !== re || t[17] !== ae || t[18] !== oe || t[19] !== A
    ? ((j = (0, T.jsxs)(`span`, {
        ref: oe,
  ...
  let I;
  t[31] !== m || t[32] !== E
    ? ((I = m.formatMessage(E)), (t[31] = m), (t[32] = E), (t[33] = I))
    : (I = t[33]);
  let L;
  t[34] !== n || t[35] !== f
    ? ((L = (e) => {
  ...
  t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((we = (0, T.jsx)(he, { className: `icon-2xs shrink-0` })), (t[37] = we))
    : (we = t[37]);
  let R;
  t[38] === E ? (R = t[39]) : ((R = (0, T.jsx)(h, { ...E })), (t[38] = E), (t[39] = R));
  let z;
  ...
  t[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Te = (0, T.jsx)(S, { className: `icon-2xs` })), (t[52] = Te))
    : (Te = t[52]);
  let U;
  t[53] !== V || t[54] !== H
    ? ((U = (0, T.jsx)(ne, {
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ee = (0, T.jsx)(x, { className: `icon-2xs` })), (t[58] = Ee))
    : (Ee = t[58]);
  let G;
  t[59] === W
    ? (G = t[60])
  ...
  t[75] !== G || t[76] !== q || t[77] !== X
    ? ((Z = (0, T.jsxs)(b, { align: `end`, triggerButton: G, children: [q, X] })),
      (t[75] = G),
      (t[76] = q),
      (t[77] = X),
      (t[78] = Z))
  ...
  t[83] !== j || t[84] !== P || t[85] !== Q || t[86] !== xe
    ? (($ = (0, T.jsx)(ue, { className: xe, icon: j, title: P, actions: Q })),
      (t[83] = j),
      (t[84] = P),
      (t[85] = Q),
      (t[86] = xe),
...
function ge(e) {
  ...
  let a = c(s(l, i)),
    u;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((u = [f, p]), (t[1] = u)) : (u = t[1]);
  let d;
  t[2] !== n || t[3] !== r
    ? ((d = (e) => {
  ...
  return (
    t[5] !== a || t[6] !== d
      ? ((m = { sensors: a, collisionDetection: o, modifiers: u, onDragEnd: d }),
        (t[5] = a),
        (t[6] = d),
        (t[7] = m))
      : (m = t[7]),
...
function _e(
  e,
  {
    ...
    designTweakCount: r,
    diffCommentCount: i,
    generatedPastedTextAttachmentCount: a = 0,
    selectedTextAttachmentCount: o = 0,
  },
) {
  return t.trim().length > 0
    ...
    : a > 0
      ? e.formatMessage(
          {
            id: `composer.queuedMessage.pastedTextAttachments`,
            defaultMessage: `{count, plural, one {Pasted text.txt} other {# pasted text files}}`,
            description: `Summary shown for generated pasted text files in an attachment-only queued message`,
          },
          { count: a },
        )
      : n > 0 || r > 0 || i > 0
        ? w(e, { annotationCount: n, designTweakCount: r, commentCount: i })
        : o > 0
          ? e.formatMessage(
              {
