...
function W(e) {
  let t = (0, Te.c)(40),
    ...
    h = fe(),
    te;
  t[0] === n ? (te = t[1]) : ((te = n.map(Ce)), (t[0] = n), (t[1] = te));
  let g = te,
    _;
  t[2] !== g || t[3] !== f
    ? ((_ = { messageIds: g, onReorderMessages: f }), (t[2] = g), (t[3] = f), (t[4] = _))
    : (_ = t[4]);
  let re = K(_);
    ...
    t[27] !== d
      ? ((e = (e) => {
          let {
            ...
            } = R(e.context.commentAttachments ?? []),
            c = se(e.context.fileAttachments, e.context.generatedPastedTextAttachmentPaths);
          return (0, q.jsx)(
            G,
            {
              messageId: e.id,
  ...
  t[29] === y
    ? (b = t[30])
    : ((b = (0, q.jsx)(j, { initial: !1, children: y })), (t[29] = y), (t[30] = b));
  let x;
  t[31] !== g || t[32] !== b
    ? ((x = (0, q.jsx)(c, { items: g, strategy: ee, children: b })),
      (t[31] = g),
      (t[32] = b),
      (t[33] = x))
    : (x = t[33]);
  let S;
  t[34] !== re || t[35] !== x
    ? ((S = (0, q.jsx)(ne, { ...re, children: x })), (t[34] = re), (t[35] = x), (t[36] = S))
    : (S = t[36]);
  let C;
  return (
    t[37] !== v || t[38] !== S
...
function G(e) {
  let t = (0, Te.c)(92),
    ...
    m = fe(),
    h;
  t[0] === n ? (h = t[1]) : ((h = { id: n }), (t[0] = n), (t[1] = h));
  let {
      attributes: g,
      listeners: _,
      setNodeRef: ne,
    ...
    w = i ? Ee.retryQueuedMessage : Ee.sendQueuedMessageNow,
    T;
  t[2] === b ? (T = t[3]) : ((T = o.Translate.toString(b)), (t[2] = b), (t[3] = T));
  let E;
  t[4] !== T || t[5] !== S
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ie = { height: 0, opacity: 0 }),
      ...
      (t[9] = ce),
      (t[10] = le))
    : ((ie = t[7]), (se = t[8]), (ce = t[9]), (le = t[10]));
  let ue = ee || C ? `opacity-60` : void 0,
    de = C ? `opacity-100` : `opacity-0 group-hover:opacity-100`,
    O;
  t[11] === de
    ? (O = t[12])
    : ((O = pe(
  ...
  t[13] === O
    ? (k = t[14])
    : ((k = (0, q.jsx)(x, { className: O, "aria-hidden": !0 })), (t[13] = O), (t[14] = k));
  let me;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (0, q.jsx)(xe, { className: `icon-2xs text-token-input-placeholder-foreground/70` })),
      (t[15] = me))
    : (me = t[15]);
  let A;
  t[16] !== g || t[17] !== _ || t[18] !== v || t[19] !== k
    ? ((A = (0, q.jsxs)(`span`, {
        ref: v,
  ...
  let F;
  t[31] !== m || t[32] !== w
    ? ((F = m.formatMessage(w)), (t[31] = m), (t[32] = w), (t[33] = F))
    : (F = t[33]);
  let I;
  t[34] !== n || t[35] !== f
    ? ((I = (e) => {
  ...
  t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, q.jsx)(Se, { className: `icon-2xs shrink-0` })), (t[37] = ye))
    : (ye = t[37]);
  let L;
  t[38] === w ? (L = t[39]) : ((L = (0, q.jsx)(D, { ...w })), (t[38] = w), (t[39] = L));
  let R;
  ...
  t[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, q.jsx)(a, { className: `icon-2xs` })), (t[52] = H))
    : (H = t[52]);
  let U;
  t[53] !== B || t[54] !== V
    ? ((U = (0, q.jsx)(oe, {
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ce = (0, q.jsx)(y, { className: `icon-2xs` })), (t[58] = Ce))
    : (Ce = t[58]);
  let G;
  t[59] === W
    ? (G = t[60])
  ...
  t[72] !== Y || t[73] !== X
    ...
    : (Z = t[74]);
  let Q;
  t[75] !== G || t[76] !== J || t[77] !== Z
    ? ((Q = (0, q.jsxs)(ge, { align: `end`, triggerButton: G, children: [J, Z] })),
      (t[75] = G),
      (t[76] = J),
      (t[77] = Z),
      (t[78] = Q))
    : (Q = t[78]);
  let $;
  t[79] !== z || t[80] !== U || t[81] !== Q
    ? (($ = (0, q.jsxs)(q.Fragment, { children: [z, U, Q] })),
      (t[79] = z),
      (t[80] = U),
      (t[81] = Q),
      (t[82] = $))
    : ($ = t[82]);
  let De;
  t[83] !== A || t[84] !== N || t[85] !== $ || t[86] !== ue
    ? ((De = (0, q.jsx)(be, { className: ue, icon: A, title: N, actions: $ })),
      (t[83] = A),
      (t[84] = N),
      (t[85] = $),
      (t[86] = ue),
...
function K(e) {
  ...
  let a = u(T(b, i)),
    o;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = [N, F]), (t[1] = o)) : (o = t[1]);
  let s;
  t[2] !== n || t[3] !== r
    ? ((s = (e) => {
  ...
  return (
    t[5] !== a || t[6] !== s
      ? ((c = { sensors: a, collisionDetection: v, modifiers: o, onDragEnd: s }),
        (t[5] = a),
        (t[6] = s),
        (t[7] = c))
      : (c = t[7]),
