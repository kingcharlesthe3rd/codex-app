...
import { Gn as ue, Jn as A, Kn as j } from "./app-initial~app-main~automations-page.js";
import {
  fi as de,
  pi as fe,
...
function K(e) {
  let t = (0, Ce.c)(40),
    ...
    g = te(),
    _;
  t[0] === n ? (_ = t[1]) : ((_ = n.map(xe)), (t[0] = n), (t[1] = _));
  let v = _,
    y;
  t[2] !== v || t[3] !== f
    ? ((y = { messageIds: v, onReorderMessages: f }), (t[2] = v), (t[3] = f), (t[4] = y))
    : (y = t[4]);
  let b = J(y);
    ...
    t[27] !== d
      ? ((e = (e) => {
          let {
            ...
            } = B(e.context.commentAttachments ?? []),
            a = h(e.context.fileAttachments, e.context.generatedPastedTextAttachmentPaths);
          return (0, Y.jsx)(
            q,
            {
              messageId: e.id,
              messageText: Se(g, {
                ...
                pastedTextAttachmentPreview:
                  e.context.pastedTextAttachments?.[0]?.preview ?? (a == null ? void 0 : ``),
                pastedTextAttachmentCount: e.context.pastedTextAttachments?.length ?? a?.length,
  ...
  t[29] === C
    ? (w = t[30])
    : ((w = (0, Y.jsx)(ee, { initial: !1, children: C })), (t[29] = C), (t[30] = w));
  let T;
  t[31] !== v || t[32] !== w
    ? ((T = (0, Y.jsx)(ae, { items: v, strategy: ce, children: w })),
      (t[31] = v),
      (t[32] = w),
      (t[33] = T))
    : (T = t[33]);
  let E;
  t[34] !== b || t[35] !== T
    ? ((E = (0, Y.jsx)(O, { ...b, children: T })), (t[34] = b), (t[35] = T), (t[36] = E))
    : (E = t[36]);
  let D;
  return (
    t[37] !== S || t[38] !== E
...
function q(e) {
  let t = (0, Ce.c)(92),
    ...
    h = te(),
    _;
  t[0] === i ? (_ = t[1]) : ((_ = { id: i }), (t[0] = i), (t[1] = _));
  let {
      attributes: y,
      listeners: b,
      setNodeRef: ne,
    ...
    D = c ? we.retryQueuedMessage : we.sendQueuedMessageNow,
    O;
  t[2] === w ? (O = t[3]) : ((O = ie.Translate.toString(w)), (t[2] = w), (t[3] = O));
  let k;
  t[4] !== O || t[5] !== T
    ? ((k = { transform: O, transition: T }), (t[4] = O), (t[5] = T), (t[6] = k))
    : (k = t[6]);
  let re, ae, se, ce;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = { height: 0, opacity: 0 }),
      (ae = { height: `auto`, opacity: 1 }),
      ...
      (t[9] = se),
      (t[10] = ce))
    : ((re = t[7]), (ae = t[8]), (se = t[9]), (ce = t[10]));
  let le = l || E ? `opacity-60` : void 0,
    ue = E ? `opacity-100` : `opacity-0 group-hover:opacity-100`,
    A;
  t[11] === ue
    ? (A = t[12])
    : ((A = r(
  ...
  t[13] === A
    ? (j = t[14])
    : ((j = (0, Y.jsx)(ge, { className: A, "aria-hidden": !0 })), (t[13] = A), (t[14] = j));
  let fe;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((fe = (0, Y.jsx)(ye, { className: `icon-2xs text-token-input-placeholder-foreground/70` })),
      (t[15] = fe))
    : (fe = t[15]);
  let M;
  t[16] !== y || t[17] !== b || t[18] !== S || t[19] !== j
    ? ((M = (0, Y.jsxs)(`span`, {
        ref: S,
  ...
  let L;
  t[31] !== h || t[32] !== D
    ? ((L = h.formatMessage(D)), (t[31] = h), (t[32] = D), (t[33] = L))
    : (L = t[33]);
  let R;
  t[34] !== i || t[35] !== p
    ? ((R = (e) => {
        (e.stopPropagation(), p(i));
      }),
      (t[34] = i),
      (t[35] = p),
      (t[36] = R))
  ...
  t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_e = (0, Y.jsx)(be, { className: `icon-2xs shrink-0` })), (t[37] = _e))
    : (_e = t[37]);
  let z;
  t[38] === D ? (z = t[39]) : ((z = (0, Y.jsx)(x, { ...D })), (t[38] = D), (t[39] = z));
  let B;
  ...
  t[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = (0, Y.jsx)(pe, { className: `icon-2xs` })), (t[52] = W))
    : (W = t[52]);
  let G;
  t[53] !== H || t[54] !== U
    ? ((G = (0, Y.jsx)(a, {
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xe = (0, Y.jsx)(C, { className: `icon-2xs` })), (t[58] = xe))
    : (xe = t[58]);
  let q;
  t[59] === K
    ? (q = t[60])
  ...
  let Te;
  t[75] !== q || t[76] !== X || t[77] !== $
    ? ((Te = (0, Y.jsxs)(o, { align: `end`, triggerButton: q, children: [X, $] })),
      (t[75] = q),
      (t[76] = X),
      (t[77] = $),
      (t[78] = Te))
    : (Te = t[78]);
  let Ee;
  t[79] !== V || t[80] !== G || t[81] !== Te
    ? ((Ee = (0, Y.jsxs)(Y.Fragment, { children: [V, G, Te] })),
      (t[79] = V),
      (t[80] = G),
      (t[81] = Te),
      (t[82] = Ee))
    : (Ee = t[82]);
  let De;
  t[83] !== M || t[84] !== F || t[85] !== Ee || t[86] !== le
    ? ((De = (0, Y.jsx)(ve, { className: le, icon: M, title: F, actions: Ee })),
      (t[83] = M),
      (t[84] = F),
      (t[85] = Ee),
      (t[86] = le),
...
function J(e) {
  ...
  let a = re(T(S, i)),
    o;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = [A, j]), (t[1] = o)) : (o = t[1]);
  let s;
  t[2] !== n || t[3] !== r
    ? ((s = (e) => {
  ...
  return (
    t[5] !== a || t[6] !== s
      ? ((c = { sensors: a, collisionDetection: E, modifiers: o, onDragEnd: s }),
        (t[5] = a),
        (t[6] = s),
        (t[7] = c))
      : (c = t[7]),
...
function Se(
  ...
  return n > 0 || r > 0 || i > 0 || a > 0
    ? F(e, { annotationCount: n, designTweakCount: r, commentCount: i + a })
    : c > 0
      ? e.formatMessage(
          {
