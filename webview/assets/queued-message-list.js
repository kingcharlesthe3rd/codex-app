...
function U(e) {
  let t = (0, Ee.c)(40),
    ...
    g = re(),
    _;
  t[0] === i ? (_ = t[1]) : ((_ = i.map(we)), (t[0] = i), (t[1] = _));
  let v = _,
    ie;
  t[2] !== v || t[3] !== m
    ? ((ie = { messageIds: v, onReorderMessages: m }), (t[2] = v), (t[3] = m), (t[4] = ie))
    : (ie = t[4]);
  let y = G(ie);
    ...
    t[27] !== p
      ? ((e = (e) => {
          let {
            ...
            s = o(e.context.fileAttachments, e.context.generatedPastedTextAttachmentPaths);
          return (0, K.jsx)(
            W,
            {
              messageId: e.id,
              messageText: Te(g, {
                ...
                pastedTextAttachmentPreview:
                  e.context.pastedTextAttachments?.[0]?.preview ?? (s == null ? void 0 : ``),
                pastedTextAttachmentCount: e.context.pastedTextAttachments?.length ?? s?.length,
  ...
  t[29] === x
    ? (S = t[30])
    : ((S = (0, K.jsx)(te, { initial: !1, children: x })), (t[29] = x), (t[30] = S));
  let C;
  t[31] !== v || t[32] !== S
    ? ((C = (0, K.jsx)(E, { items: v, strategy: he, children: S })),
      (t[31] = v),
      (t[32] = S),
      (t[33] = C))
    : (C = t[33]);
  let w;
  t[34] !== y || t[35] !== C
    ? ((w = (0, K.jsx)(ae, { ...y, children: C })), (t[34] = y), (t[35] = C), (t[36] = w))
    : (w = t[36]);
  let T;
  return (
    t[37] !== b || t[38] !== w
...
function W(e) {
  ...
  let {
    ...
    w = o ? De.retryQueuedMessage : De.sendQueuedMessageNow,
    T;
  t[2] === ae ? (T = t[3]) : ((T = _e.Translate.toString(ae)), (t[2] = ae), (t[3] = T));
  let E;
  t[4] !== T || t[5] !== S
    ? ((E = { transform: T, transition: S }), (t[4] = T), (t[5] = S), (t[6] = E))
    : (E = t[6]);
  let oe, ce, le, de;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = { height: 0, opacity: 0 }),
      (ce = { height: `auto`, opacity: 1 }),
      (le = { height: 0, opacity: 0 }),
      (de = { duration: 0.18 }),
      (t[7] = oe),
      (t[8] = ce),
      (t[9] = le),
      (t[10] = de))
    : ((oe = t[7]), (ce = t[8]), (le = t[9]), (de = t[10]));
  let pe = l || C ? `opacity-60` : void 0,
    me = C ? `opacity-100` : `opacity-0 group-hover:opacity-100`,
    D;
  t[11] === me
    ? (D = t[12])
    : ((D = ie(
  ...
  t[13] === D
    ? (O = t[14])
    : ((O = (0, K.jsx)(se, { className: D, "aria-hidden": !0 })), (t[13] = D), (t[14] = O));
  let he;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((he = (0, K.jsx)(Se, { className: `icon-2xs text-token-input-placeholder-foreground/70` })),
      (t[15] = he))
    : (he = t[15]);
  let k;
  t[16] !== _ || t[17] !== v || t[18] !== b || t[19] !== O
    ? ((k = (0, K.jsxs)(`span`, {
        ref: b,
  ...
  let P;
  t[31] !== h || t[32] !== w
    ? ((P = h.formatMessage(w)), (t[31] = h), (t[32] = w), (t[33] = P))
    : (P = t[33]);
  let F;
  t[34] !== n || t[35] !== m
    ? ((F = (e) => {
  ...
  t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((xe = (0, K.jsx)(Ce, { className: `icon-2xs shrink-0` })), (t[37] = xe))
    : (xe = t[37]);
  let I;
  t[38] === w ? (I = t[39]) : ((I = (0, K.jsx)(r, { ...w })), (t[38] = w), (t[39] = I));
  let L;
  ...
  t[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, K.jsx)(x, { className: `icon-2xs` })), (t[52] = V))
    : (V = t[52]);
  let H;
  t[53] !== z || t[54] !== B
    ? ((H = (0, K.jsx)(ee, {
  ...
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((we = (0, K.jsx)(fe, { className: `icon-2xs` })), (t[58] = we))
    : (we = t[58]);
  let W;
  t[59] === U
    ? (W = t[60])
  ...
  t[72] !== J || t[73] !== Y
    ...
    : (X = t[74]);
  let Z;
  t[75] !== W || t[76] !== q || t[77] !== X
    ? ((Z = (0, K.jsxs)(d, { align: `end`, triggerButton: W, children: [q, X] })),
      (t[75] = W),
      (t[76] = q),
      (t[77] = X),
      (t[78] = Z))
    : (Z = t[78]);
  let Q;
  t[79] !== R || t[80] !== H || t[81] !== Z
    ? ((Q = (0, K.jsxs)(K.Fragment, { children: [R, H, Z] })),
      (t[79] = R),
      (t[80] = H),
      (t[81] = Z),
      (t[82] = Q))
    : (Q = t[82]);
  let $;
  t[83] !== k || t[84] !== M || t[85] !== Q || t[86] !== pe
    ? (($ = (0, K.jsx)(be, { className: pe, icon: k, title: M, actions: Q })),
      (t[83] = k),
      (t[84] = M),
      (t[85] = Q),
      (t[86] = pe),
...
function G(e) {
  ...
  let a = O(k(w, i)),
    o;
  t[1] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = [I, F]), (t[1] = o)) : (o = t[1]);
  let s;
  t[2] !== n || t[3] !== r
    ? ((s = (e) => {
  ...
  return (
    t[5] !== a || t[6] !== s
      ? ((c = { sensors: a, collisionDetection: ce, modifiers: o, onDragEnd: s }),
        (t[5] = a),
        (t[6] = s),
        (t[7] = c))
      : (c = t[7]),
...
function Te(
  ...
  return n > 0 || r > 0 || i > 0 || a > 0
    ? R(e, { annotationCount: n, designTweakCount: r, commentCount: i + a })
    : c > 0
      ? e.formatMessage(
          {
