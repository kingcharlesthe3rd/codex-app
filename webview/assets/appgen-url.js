...
import { gn as u } from "./app-server-manager-signals.js";
import { n as d, t as f } from "./jsx-runtime.js";
import { S as p, _ as m, g as h, nt as g, rt as _, tt as v } from "./setting-storage.js";
...
function w({ accessGroups: e, accessPolicy: t, group: n, knownAccessGroups: r }) {
  return {
...
function T({
  ...
  return {
    ...(u ? { allowed_workspace_group_ids: E(c.filter((e) => e.source === `workspace`)) } : {}),
    ...(d ? { allowed_tenant_group_ids: E(c.filter((e) => e.source === `tenant`)) } : {}),
  };
}
function E(e) {
...
var D = t([`admins_only`, `workspace_all`, `custom`, `public`]),
  ...
  P = N.extend({
    allowed_groups: c(M),
    allowed_users: c(n({ account_user_id: l(), email: l().nullable(), name: l().nullable() })),
  }),
  F = n({
  ...
  z = n({
    entries: c(n({ is_secret: i(), key: l(), type: a(`envvar`), value: l().nullable() })),
    project_id: l(),
    revision: o(),
  ...
  q = v(p, (e) => ({
    ...
    mutationFn: (t) => X(`sites_update_environment`, { project_id: e, ...t }, z),
