...
import { bi as t, fi as n, gi as r, hi as i, vi as a, yi as o, zr as s } from "./src-C.js";
import { ni as c, po as l, v as u } from "./app-server-manager-signals.js";
import { n as d, t as f } from "./jsx-runtime.js";
import { t as p } from "./clsx.js";
import { B as m, G as h, U as g, V as _, Y as v, Z as y, wt as b } from "./setting-storage.js";
import { o as x } from "./statsig.js";
import { c as S } from "./app-server-manager-hooks-DfDI-9lO.js";
import { C } from "./config-queries.js";
import { d as w } from "./apps-queries.js";
...
import { a as j, i as M, l as N, n as P, r as F, t as I } from "./dialog-layout.js";
import {
  a as L,
  i as ee,
  n as R,
...
import { t as he } from "./automation-queries.js";
import { t as ge } from "./laptop.js";
import { a as _e, c as ve, i as ye, o as be, r as xe } from "./prompt-editor.js";
...
import { a as De, d as Oe, f as ke, l as Ae, n as je, s as Me } from "./automation-schedule.js";
import {
  f as Ne,
  g as Pe,
  h as Fe,
...
function At(e) {
  ...
  let ce = U,
    ...
    ue = ye(H),
    G;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((G = { hostId: l }), (t[2] = G)) : (G = t[2]);
  let de = w(G),
  ...
  let ge = he != null,
    xe;
  t[5] === ge ? (xe = t[6]) : ((xe = { enabled: ge }), (t[5] = ge), (t[6] = xe));
  ...
  (t[7] !== de || t[8] !== K || t[9] !== Oe || t[10] !== De || t[11] !== H
    ? ((Ae = () => {
        H.syncMentionMetadata({ skills: Oe, apps: de, plugins: K, nativeApps: De });
      }),
      (ke = [de, K, Oe, De, H]),
      (t[7] = de),
      (t[8] = K),
  ...
  t[35] !== o || t[36] !== n || t[37] !== s
    ? ((it = o ? null : (0, J.jsx)(We, { draft: n, action: s ? `save` : `create` })),
      (t[35] = o),
      (t[36] = n),
      (t[37] = s),
      (t[38] = it))
  ...
  t[41] === i
    ? (pt = t[42])
    : ((pt = (e) => {
        i((t) => ({ ...t, rawRrule: null, scheduleConfig: e, scheduleDirty: !0 }));
      }),
      (t[41] = i),
      (t[42] = pt));
  let mt = pt,
          ...
          children: (0, J.jsxs)(gt, {
            ...
            children: [
              ...
              B === `dialog` && !s && se
                ...
                : null,
              se && B !== `dialog` ? (0, J.jsx)(ht, { className: ot, children: bt(!s) }) : null,
              (0, J.jsx)(ht, {
                className: ot,
                children: (0, J.jsxs)(`div`, {
                  ref: ae,
                          ...
                          children: [
                            ...
                            $
                              ? (0, J.jsx)(Yt, {
                                  ...
                                  onSelect: (e) => {
                                    i((t) =>
                                      ze({ draft: t, threadId: e.threadId, title: e.title }),
                                    );
                                  },
                                })
                              : (0, J.jsx)(Te, {
...
function Rt(e) {
  ...
  if (
    ...
    b = ue;
    let R;
    t[35] === a ? (R = t[36]) : ((R = p(`min-w-0`, a)), (t[35] = a), (t[36] = R));
    let z;
    t[37] === u
      ? (z = t[38])
...
function zt(e) {
  ...
  let S;
  t[20] !== x || t[21] !== _
    ? ((S = (0, J.jsxs)(`div`, { className: `relative w-full`, children: [_, x] })),
      (t[20] = x),
      (t[21] = _),
      (t[22] = S))
    : (S = t[22]);
...
function qt(e) {
  let t = (0, q.c)(34),
    ...
    { data: _ } = D(),
    v;
  t[0] === m.locale ? (v = t[1]) : ((v = A(m.locale)), (t[0] = m.locale), (t[1] = v));
  let y = v,
    b = _?.models == null,
    x;
  t[2] === m
  ...
  t[13] === f
    ? (T = t[14])
    : ((T = f
        ? (0, J.jsx)(G, { className: `icon-2xs shrink-0 text-token-input-placeholder-foreground` })
        : null),
      (t[13] = f),
      (t[14] = T));
  let O;
  ...
  if (
    ...
    t[26] === b
      ...
      : ((a = b.formatMessage({
        ...
        (t[27] = a));
    let s;
    t[28] === c ? (s = t[29]) : ((s = p(`min-w-0`, c)), (t[28] = c), (t[29] = s));
    let l;
    t[30] !== w || t[31] !== v
...
function Yt(e) {
  let t = (0, q.c)(41),
    ...
    v;
  t[0] !== r || t[1] !== n
    ? ((v = r.find((e) => e.threadId === n) ?? null), (t[0] = r), (t[1] = n), (t[2] = v))
    : (v = t[2]);
  let y = v,
    b;
  t[3] !== m || t[4] !== y?.title
  ...
  t[10] === d
    ? (w = t[11])
    : ((w = d ? (0, J.jsx)(K, { className: `icon-xs shrink-0` }) : null), (t[10] = d), (t[11] = w));
  let T;
  t[12] === x
    ? (T = t[13])
    : ((T = (0, J.jsx)(`span`, {
...
function Xt(e) {
  ...
  if (
    ...
    (t[27] !== m || t[28] !== l || t[29] !== n
      ...
      (t[14] = S),
      (t[15] = C));
  } else ((_ = t[9]), (v = t[10]), (y = t[11]), (b = t[12]), (x = t[13]), (S = t[14]), (C = t[15]));
  let w;
  ...
  return (
    t[35] !== _ || t[36] !== w || t[37] !== x || t[38] !== S || t[39] !== C
      ? ((D = (0, J.jsx)(_, { align: x, contentWidth: S, triggerButton: C, children: w })),
        (t[35] = _),
        (t[36] = w),
        (t[37] = x),
        (t[38] = S),
...
function Zt(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, J.jsx)(G, { className: `icon-xxs shrink-0 text-token-description-foreground` })),
      (t[4] = u))
    : (u = t[4]);
  let d;
  t[5] !== n || t[6] !== c || t[7] !== l
...
//# sourceMappingURL=automation-dialog-CF-eu0qk.js.map
