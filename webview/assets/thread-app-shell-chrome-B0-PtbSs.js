...
function Dn({ onClose: e, target: t }) {
  ...
  let E = p(Ze, w),
    ...
    k = p(R, `searchFiles`),
    A = p(R, `openSideChat`),
    j = p(R, `openBrowserTab`),
    M = p(R, `openReviewTab`),
    F = p(hn, w),
    I = T !== `projectless` && y != null,
    L = w != null && !1,
    ee = w != null && !tn(),
    te = l && (h || !s.some((e) => rt(e))),
    ne = !_ && (v.kind === `git` || !1) && !s.some((e) => e.tabId === Ie.DIFF),
    ie = L && !s.some((e) => e.tabId === Ie.TIMELINE),
    ae = le(n),
    z = v.kind === `git` ? null : F,
    ue = z != null && z.length > 0,
    B = () => {
      w != null &&
        gn(n, mn, {
          ...
          .catch((e) => {
            (o.error(`Error opening side chat`, { safe: {}, sensitive: { error: e } }),
              n
                .get(ot)
                .danger(
                  r.formatMessage({
    ...
    ve = () => {
      y != null && (D(n, null, { hostId: b.id, target: t, workspaceRoot: y }), e?.());
    },
    ye = () => {
      (fe(n, t), e?.());
    },
    xe = (e, t, n) => {
      if (t == null) {
        Pt({ href: e, initiator: `mcp_app_resource`, originHostId: n });
        return;
      }
      kt({ event: t, href: e, initiator: `mcp_app_resource`, originHostId: n });
    },
    Se = (e, t) => {
      switch (e.type) {
        case `file`:
  ...
  return {
    actions:
      v.kind === `git` ? [...V].sort((e, t) => (kn[e.id] ?? V.length) - (kn[t.id] ?? V.length)) : V,
    hasOutputArtifacts: ue,
    onOpenArtifact: Se,
    outputArtifacts: z,
  };
}
var q,
  ...
  An = e(() => {
    (l(),
      ...
      Ce(),
      (q = r()),
      (On = v(gt, ({ get: e }) => e(Qt).filter((e) => e.entrypoint === `thread`))),
...
function In(e) {
  ...
  switch (n.type) {
    ...
    case `google-drive`: {
      ...
      return (
        t[4] !== n.resourceKind || t[5] !== r
          ? ((e = (0, Rn.jsx)(we, { className: r, resourceKind: n.resourceKind })),
            (t[4] = n.resourceKind),
            (t[5] = r),
            (t[6] = e))
          : (e = t[6]),
    ...
    case `appgen-app`: {
      let e;
      return (
        t[7] === r ? (e = t[8]) : ((e = (0, Rn.jsx)(qt, { className: r })), (t[7] = r), (t[8] = e)),
        e
      );
    }
    case `website`: {
      ...
      return (
        t[9] === r
          ? (e = t[10])
          : ((e = (0, Rn.jsx)(At, { className: r })), (t[9] = r), (t[10] = e)),
        e
      );
    }
  }
            ...
            K.Item,
            {
              ...
              children: [
                e.mcpServerIcon == null
                  ? null
                  : (0, J.jsx)(K.ItemIcon, { children: cn(e.mcpServerIcon) }),
                e.title,
              ],
            },
            e.id,
            ...
            children: [
              ...
              o.map((e) =>
                (0, J.jsxs)(
                  ...
                  {
                    onClickCapture: (t) => {
                      Et(t) && (t.preventDefault(), t.stopPropagation(), a(e, t));
                    },
                    onSelect: () => a(e),
                    children: [
                      (0, J.jsx)(K.ItemIcon, {
...
function Un(e) {
  ...
  return (
    t[7] !== i || t[8] !== c || t[9] !== d
      ? ((f = (0, Gn.jsx)(Ge, { tooltipContent: i, shortcut: c, delayOpen: !0, children: d })),
        (t[7] = i),
        (t[8] = c),
        (t[9] = d),
        (t[10] = f))
...
function qn(e) {
  ...
  if (
    ...
    bb0: {
      ((j = o ? p.filter(Zn) : p),
        (v = ct({ preferredTarget: f, targets: j, availableTargets: m, mode: `editor` })),
...
function ir(e) {
  let t = (0, ar.c)(5),
    ...
    a = p(lt, n),
    o;
  t[0] === i.cwd ? (o = t[1]) : ((o = i.cwd == null ? null : m(i.cwd)), (t[0] = i.cwd), (t[1] = o));
  let s = o;
  if (s == null || !a || i.kind !== `git` || r.kind === `remote-control`) return null;
  let c;
  return (
    t[2] !== s || t[3] !== r
      ? ((c = (0, or.jsx)(B.HeaderAction, {
...
function ur(e) {
  ...
  t[0] === g
    ? (_ = t[1])
    : ((_ = _t(`sticky top-0 z-10 flex flex-col gap-6 bg-token-main-surface-primary`, g)),
      (t[0] = g),
      (t[1] = _));
  let v;
  t[2] !== n || t[3] !== o
  ...
  t[5] === a
    ...
    : ((y =
      ...
      (t[6] = y));
  let b;
  t[7] !== d || t[8] !== _ || t[9] !== v || t[10] !== y
    ? ((b = (0, Z.jsxs)(`div`, { ref: d, className: _, children: [v, y] })),
      (t[7] = d),
      (t[8] = _),
      (t[9] = v),
      (t[10] = y),
    ...
    : (b = t[11]);
  let x;
  t[12] !== p || t[13] !== r || t[14] !== s || t[15] !== a
    ? ((x =
        a == null
          ? null
          : (0, Z.jsxs)(Z.Fragment, {
              children: [
                (0, Z.jsx)(fr, { headerHeight: p.height, root: s, onCoveredChange: u }),
  ...
  t[5] === r
    ...
    : ((l = r
        ? (0, Z.jsx)(`span`, {
            ...
            children: (0, Z.jsx)(st, { keysLabel: r }),
          })
        : null),
      (t[5] = r),
      (t[6] = l));
    ...
    ((X = i()),
      ...
      (_r = {
        closed: {
          opacity: 0,
          y: -8,
          transition: { duration: 0.06, ease: bt.ease, when: `afterChildren` },
        },
        open: {
          opacity: 1,
          y: 0,
          transition: { duration: 0.09, ease: bt.ease, when: `beforeChildren` },
        },
      }),
      (vr = {
      ...
      (yr = {
        closed: { opacity: 0, y: -6, transition: { duration: 0.045, ease: bt.ease } },
        open: { opacity: 1, y: 0, transition: { duration: 0.075, ease: bt.ease } },
      }));
  });
function xr(e) {
  let t = (0, Q.c)(26),
    ...
    l = f(_e),
    d = f(z) === `ready`,
    m = p(R, `toggleSidePanel`),
    h = `thread-${e.threadType}`,
    g = d && e.threadType === `remote` ? e.showReviewTab : d && r.kind === `git`,
    _ = (0, kr.useRef)(null),
    v,
    y;
  (t[0] !== o || t[1] !== l || t[2] !== n
    ...
    (0, kr.useEffect)(v, y));
  let C;
  t[5] === n ? (C = t[6]) : ((C = () => ce(n)), (t[5] = n), (t[6] = C));
  let w;
  (t[7] === g ? (w = t[8]) : ((w = { enabled: g }), (t[7] = g), (t[8] = w)),
    jt(`openReviewTab`, C, w));
  let T, E;
  (t[9] !== a.id || t[10] !== d || t[11] !== e.threadType || t[12] !== n || t[13] !== i
    ? ((T = () => {
        !d ||
          e.threadType === `remote` ||
          i == null ||
          D(n, null, { hostId: a.id, workspaceRoot: i });
      }),
      (E = [a.id, d, e.threadType, n, i]),
      (t[9] = a.id),
      (t[10] = d),
      (t[11] = e.threadType),
      (t[12] = n),
                  ...
                  children: [
                    ...
                    (0, $.jsx)(B.HeaderAction, {
                      ...
                      children: (0, $.jsx)(Un, {
                        ...
                        onClick: () => x(n),
                        children: l
                          ? (0, $.jsx)(b, { className: `icon-sm rotate-180` })
                          : (0, $.jsx)(te, { className: `icon-sm rotate-180` }),
                      }),
                    }),
                  ],
                })
...
function Sr() {
  let e = (0, Q.c)(7),
    t = u(H),
    n;
  e[0] === t ? (n = e[1]) : ((n = qe(t)), (e[0] = t), (e[1] = n));
  let r = n,
    i;
  e[2] === r
    ? (i = e[3])
...
function Cr(e) {
  let t = (0, Q.c)(41),
    ...
    o = f(E) !== !1,
    s = f(ye),
    l = p(R, `toggleBottomPanel`),
    d = f(re.tabs$).length,
    m = f(z) === `ready`,
    h;
  t[0] !== m || t[1] !== r ? ((h = m && le(r)), (t[0] = m), (t[1] = r), (t[2] = h)) : (h = t[2]);
  let g = h,
    _;
  t[3] !== d || t[4] !== g || t[5] !== o || t[6] !== a || t[7] !== r
    ? ((_ = () => {
        if (o) {
          if (a) {
            L(r, `bottom`);
          ...
          Se(r, `bottom`, { activateFallbackTab: !0, allowEmpty: !0 }) && r.get(V) && Or();
        }
      }),
      (t[3] = d),
      (t[4] = g),
  ...
  (t[9] !== g || t[10] !== r || t[11] !== s
    ...
    : (y = t[12]),
    c(`toggle-terminal`, y),
    jt(`toggleBottomPanel`, v));
  let b;
  (t[13] !== g || t[14] !== r || t[15] !== s
    ? ((b = () => {
        g && Oe(r, void 0, s);
      }),
      (t[13] = g),
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, $.jsx)(B.BottomPanelOutlet, { children: (0, $.jsx)(B.BottomPanelTabs, {}) })),
      (t[18] = S))
    : (S = t[18]);
  let w;
  t[19] !== i || t[20] !== m
  ...
  t[22] === i
    ...
    : ((T = i.formatMessage({
      ...
      (t[23] = T));
  let D;
  t[24] === r ? (D = t[25]) : ((D = () => L(r, `bottom`)), (t[24] = r), (t[25] = D));
  let O;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, $.jsx)(dt, { className: `icon-xs` })), (t[26] = O))
    : (O = t[26]);
  let k;
  t[27] !== T || t[28] !== D
    ? ((k = (0, $.jsx)(B.BottomPanelTabListAfter, {
        children: (0, $.jsx)(Ke, {
          color: `ghost`,
          size: `toolbar`,
          uniform: !0,
    ...
    : (k = t[29]);
  let A;
  t[30] !== n || t[31] !== i || t[32] !== o || t[33] !== a || t[34] !== v || t[35] !== l
    ? ((A = o
        ? (0, $.jsx)(B.HeaderAction, {
  ...
  let j;
  return (
    t[37] !== k || t[38] !== A || t[39] !== w
      ? ((j = (0, $.jsxs)($.Fragment, { children: [x, S, w, k, A] })),
        (t[37] = k),
        (t[38] = A),
        (t[39] = w),
        (t[40] = j))
...
function wr(e) {
  ...
  let { actions: a, hasOutputArtifacts: o, onOpenArtifact: s, outputArtifacts: c } = Dn(i),
    l;
  t[2] === n ? (l = t[3]) : ((l = y(n)), (t[2] = n), (t[3] = l));
  let u = f(l.tabs$).length,
    d = (0, kr.useRef)(null);
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, $.jsx)(wt, { className: `icon-xs` })), (t[5] = m))
    : (m = t[5]);
  let h;
  t[6] === r
    ? (h = t[7])
...
function Tr() {
  ...
  return (
    e[4] !== n || e[5] !== i
      ? ((a = (0, $.jsx)(B.HeaderContextMenuItem, {
          checked: n,
...
function Er(e) {
  let t = (0, Q.c)(28),
    n = u(H),
    r;
  t[0] === n ? (r = t[1]) : ((r = qe(n)), (t[0] = n), (t[1] = r));
  let i = r,
    a = W(),
    o = f(_e),
    s = f(z) === `ready`,
    c = p(R, `toggleSidePanel`),
    l;
  t[2] === i
    ? (l = t[3])
  ...
  let m;
  t[6] === Symbol.for(`react.memo_cache_sentinel`) ? ((m = null), (t[6] = m)) : (m = t[6]);
  let h;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, $.jsx)(B.RightPanelOutlet, { children: (0, $.jsx)(B.RightPanelTabs, {}) })),
      (t[7] = h))
    : (h = t[7]);
  let g;
  t[8] !== a || t[9] !== s
    ...
    : (g = t[10]);
  let _;
  t[11] === a ? (_ = t[12]) : ((_ = a.formatMessage(jr.toggleSidePanel)), (t[11] = a), (t[12] = _));
  let v;
  t[13] === n ? (v = t[14]) : ((v = () => x(n)), (t[13] = n), (t[14] = v));
  let y;
  t[15] === o
    ? (y = t[16])
    : ((y = o
      ...
      (t[16] = y));
  let S;
  t[17] !== o || t[18] !== _ || t[19] !== v || t[20] !== y || t[21] !== c
    ? ((S = (0, $.jsx)(B.HeaderAction, {
        actionId: `thread-side-panel-close`,
        align: `end`,
        slotPosition: `right`,
        order: 300,
        children: (0, $.jsx)(Un, { label: _, pressed: o, shortcut: c, onClick: v, children: y }),
      })),
      (t[17] = o),
      (t[18] = _),
      (t[19] = v),
  ...
  let C;
  return (
    t[23] !== S || t[24] !== l || t[25] !== d || t[26] !== g
      ? ((C = (0, $.jsxs)($.Fragment, { children: [l, d, m, h, g, S] })),
        (t[23] = S),
        (t[24] = l),
        (t[25] = d),
        (t[26] = g),
...
//# sourceMappingURL=thread-app-shell-chrome-B0-PtbSs.js.map
