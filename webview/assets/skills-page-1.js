...
import { Ht as xe, Ut as Se } from "./app-initial~app-main~automations-page.js";
import {
  r as Ce,
  t as we,
...
function Ke() {
  let e = (0, I.c)(103),
    ...
    f = me(d),
    p;
  e[0] === d ? (p = e[1]) : ((p = d?.map(Ye)), (e[0] = d), (e[1] = p));
  let h = p,
    [_, ee] = (0, L.useState)(m),
    y;
  e[2] !== f || e[3] !== _ ? ((y = pe(_, f)), (e[2] = f), (e[3] = _), (e[4] = y)) : (y = e[4]);
  let b = y,
    [se, ce] = (0, L.useState)(null),
    [le, ue] = (0, L.useState)(null),
    x;
  e[5] !== le || e[6] !== se
    ? ((x = { container: se, target: le }), (e[5] = le), (e[6] = se), (e[7] = x))
    : (x = e[7]);
  let fe = Ee(x),
    [S, he] = (0, L.useState)(``),
    [C, _e] = (0, L.useState)(!1),
  ...
  let M;
  e[9] !== be || e[10] !== b
    ? ((M = { forceReloadSkills: be, hostId: b, onInstalled: j }),
      (e[9] = be),
      (e[10] = b),
      (e[11] = M))
    : (M = e[11]);
  ...
  e[17] !== r || e[18] !== Ke || e[19] !== Ue || e[20] !== k
    ? ((F = (e) => {
        ...
        return ge({
          scope: t,
          intl: r,
          repoLabel: ye({ skillPath: n, roots: k, fallbackLabel: Ue }),
          adminLabel: Ke,
        });
      }),
      (e[17] = r),
  ...
  e[49] !== S || e[50] !== W || e[51] !== G
    ...
    : (K = e[52]);
  let q;
  e[53] !== w || e[54] !== t || e[55] !== T || e[56] !== A || e[57] !== l
    ? ((q = () => {
        if (!A) return;
        oe(t, n, {});
        let e = Be({ creatorPath: A, isFirstOpen: !w, kind: `skill` });
        (w || T(!0), l({ prefillPrompt: e, startInSidebar: !0 }));
      }),
      (e[53] = w),
      (e[54] = t),
      (e[55] = T),
  ...
  e[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((lt = (0, R.jsx)(a, { className: `icon-xs` })),
      (ut = (0, R.jsx)(c, {
  ...
  let X;
  e[69] !== z || e[70] !== Y
    ? ((X = (0, R.jsx)(xe, { start: z, trailing: Y })), (e[69] = z), (e[70] = Y), (e[71] = X))
    : (X = e[71]);
  let dt;
...
function Ze(e) {
  ...
  let d;
  if (t[3] !== a || t[4] !== s || t[5] !== n || t[6] !== u || t[7] !== l) {
    let e;
    (t[9] !== s || t[10] !== n || t[11] !== u || t[12] !== l
      ? ((e = (e) => {
          let { skill: t } = e,
            r =
              t.scope === `repo`
                ...
                : [],
            i = t.scope === `repo` ? Ne({ skillPath: t.path, roots: l }) : null;
          return (0, R.jsx)(
            Pe,
            {
              skill: t,
  ...
  let f;
  return (
    t[14] === d ? (f = t[15]) : ((f = (0, R.jsx)(j, { children: d })), (t[14] = d), (t[15] = f)), f
  );
}
function Qe(e) {
  let t = (0, I.c)(2),
...
function $e(e) {
  ...
  if (
    ...
    bb0: {
      ...
      p = j;
      let v;
      (t[21] !== s || t[22] !== n || t[23] !== d || t[24] !== f || t[25] !== u || t[26] !== l
        ? ((v = (e) =>
            (0, R.jsx)(
              Ve,
              {
