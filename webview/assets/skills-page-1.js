...
import { _r as f, o as p } from "./persisted-signal.js";
import { t as m } from "./button-DO-oxX3-.js";
import { n as h } from "./selectable-remote-connections-signal.js";
import { p as g } from "./codex-api.js";
import { O as ee } from "./mention-item-B.js";
import { r as te } from "./skill-utils.js";
import { t as _ } from "./use-is-plugins-enabled.js";
import { n as ne } from "./use-start-new-conversation-jDp-QANK.js";
import { y as v } from "./links.js";
import { t as re } from "./plus.js";
import { t as ie } from "./use-connected-remote-connections.js";
import { r as ae } from "./settings-host-context.js";
...
import { a as he, i as ge, n as _e, o as C, r as ve, s as ye, t as w } from "./plugins-page.js";
var T = r(),
  E = e(t(), 1);
function be(e) {
  let t = (0, T.c)(6),
  ...
  t[3] !== n || t[4] !== r
    ...
    : (o = t[5]);
  let s = o;
  return (0, E.useSyncExternalStore)(a, s, s);
}
function D() {}
var O = n();
function xe() {
...
function k() {
  let e = (0, T.c)(103),
    ...
    y = ie(v),
    b;
  e[0] === v ? (b = e[1]) : ((b = v?.map(Te)), (e[0] = v), (e[1] = b));
  let x = b,
    [S, _e] = (0, E.useState)(s),
    C;
  e[2] !== y || e[3] !== S ? ((C = ae(S, y)), (e[2] = y), (e[3] = S), (e[4] = C)) : (C = e[4]);
  let w = C,
    [D, xe] = (0, E.useState)(null),
    [k, we] = (0, E.useState)(null),
    A;
  e[5] !== k || e[6] !== D
    ? ((A = { container: D, target: k }), (e[5] = k), (e[6] = D), (e[7] = A))
    : (A = e[7]);
  let ke = be(A),
    [j, Ae] = (0, E.useState)(``),
    [M, je] = (0, E.useState)(!1),
    ...
    { errorMessage: ze, isLoading: Be, refresh: Ve, repoRoot: He, skills: Ue } = pe(Re, w),
    We;
  ...
  let Ge;
  e[9] !== Ne || e[10] !== w
    ? ((Ge = { forceReloadSkills: Ne, hostId: w, onInstalled: We }),
      (e[9] = Ne),
      (e[10] = w),
      (e[11] = Ge))
    : (Ge = e[11]);
  let { installRecommendedSkill: Ke, installingSkillId: qe } = de(Ge),
    Je;
  e[12] === n ? (Je = e[13]) : ((Je = ce({ scope: `repo`, intl: n })), (e[12] = n), (e[13] = Je));
  let Ye = Je,
    Xe = r?.name ?? void 0,
    Ze;
  e[14] !== n || e[15] !== Xe
    ? ((Ze = ce({ scope: `admin`, intl: n, adminLabel: Xe })),
      (e[14] = n),
      (e[15] = Xe),
      (e[16] = Ze))
    : (Ze = e[16]);
  let Qe = Ze,
    $e;
  e[17] !== n || e[18] !== Qe || e[19] !== Ye || e[20] !== I
    ? (($e = (e) => {
        let { scope: t, skillPath: r } = e;
        return ce({
          scope: t,
          intl: n,
          repoLabel: se({ skillPath: r, roots: I, fallbackLabel: Ye }),
          adminLabel: Qe,
        });
      }),
      (e[17] = n),
  ...
  let it = rt,
    at;
  (e[28] === Symbol.for(`react.memo_cache_sentinel`) ? ((at = []), (e[28] = at)) : (at = e[28]),
    (0, E.useEffect)(Ce, at));
  let R;
  e[29] === ke
    ? (R = e[30])
  ...
  e[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ct = (0, O.jsx)(oe, { className: `icon-xs` })), (e[37] = ct))
    : (ct = e[37]);
  let V;
  e[38] === M
    ? (V = e[39])
  ...
  e[49] !== j || e[50] !== U || e[51] !== W
    ...
    : (G = e[52]);
  let K;
  e[53] !== N || e[54] !== t || e[55] !== Me || e[56] !== L || e[57] !== _
    ? ((K = () => {
        if (!L) return;
        p(t, f, {});
        let e = ge({ creatorPath: L, isFirstOpen: !N, kind: `skill` });
        (N || Me(!0), _({ prefillPrompt: e, startInSidebar: !0 }));
      }),
      (e[53] = N),
      (e[54] = t),
      (e[55] = Me),
  ...
  e[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ut = (0, O.jsx)(re, { className: `icon-xs` })),
      (dt = (0, O.jsx)(d, {
  ...
  let Y;
  e[69] !== R || e[70] !== J
    ? ((Y = (0, O.jsx)(le, { start: R, trailing: J })), (e[69] = R), (e[70] = J), (e[71] = Y))
    : (Y = e[71]);
  let ft;
...
function Ce() {
  return ((document.documentElement.dataset.hideHeaderDivider = `true`), we);
}
function we() {
...
function De(e) {
  ...
  let u;
  return (
    t[14] === l ? (u = t[15]) : ((u = (0, O.jsx)(C, { children: l })), (t[14] = l), (t[15] = u)), u
  );
}
function A(e) {
  let t = (0, T.c)(2),
...
function Oe(e) {
  ...
  if (
    ...
    bb0: {
      ...
      t[13] === u
        ? (e = t[14])
        : ((e = (e) => !S({ installedSkillMatchKeys: u, skill: e })), (t[13] = u), (t[14] = e));
      let g = a.filter(e),
      ...
      if (i) {
        ...
        (t[17] === i
          ...
          : ((n = (0, O.jsx)(`div`, {
              className: `flex min-h-0 flex-1 items-center justify-center`,
              children: (0, O.jsx)(y, { title: e, description: i }),
            })),
            (t[17] = i),
            (t[18] = n)),
          (h = n));
        ...
        ? ((_ = (e) =>
            (0, O.jsx)(
              _e,
              {
                ...
                canInstall: s,
                hostId: n,
                isInstalled: S({ installedSkillMatchKeys: u, skill: e }),
                isInstalling: f === e.id,
                repoRoot: c,
                onInstall: l,
              },
