...
import { n as k, t as we } from "./page-search-input.js";
import { n as Te, t as A } from "./use-element-in-view.js";
import {
  B as Ee,
  G as De,
  I as Oe,
...
import { n as Ue, t as We } from "./settings-host-dropdown.js";
function F() {
  let e = (0, I.c)(3),
    t;
  if (
...
function Ge() {
  ...
  let g = d,
    [_, v] = (0, L.useState)(me),
    y;
  e[2] !== u || e[3] !== _ ? ((y = _e(_, u)), (e[2] = u), (e[3] = _), (e[4] = y)) : (y = e[4]);
  let b = y,
    [te, re] = (0, L.useState)(null),
    [ie, ce] = (0, L.useState)(null),
    x;
  e[5] !== ie || e[6] !== te
    ? ((x = { container: te, target: ie }), (e[5] = ie), (e[6] = te), (e[7] = x))
    : (x = e[7]);
  let de = Te(x),
    [S, fe] = (0, L.useState)(``),
    [w, ge] = (0, L.useState)(!1),
    ...
    { errorMessage: je, isLoading: Me, refresh: Ne, repoRoot: Pe, skills: Re } = Fe(Oe, b),
    M;
  ...
  let { installRecommendedSkill: Be, installingSkillId: Ve } = ke(N),
    P;
  e[12] === n ? (P = e[13]) : ((P = h({ scope: `repo`, intl: n })), (e[12] = n), (e[13] = P));
  let He = P,
    Ue = i?.name ?? void 0,
    F;
  e[14] !== n || e[15] !== Ue
    ? ((F = h({ scope: `admin`, intl: n, adminLabel: Ue })), (e[14] = n), (e[15] = Ue), (e[16] = F))
    : (F = e[16]);
  let Ge = F,
    Je;
...
function Ze(e) {
  ...
  let u;
  return (
    t[14] === l ? (u = t[15]) : ((u = (0, R.jsx)(M, { children: l })), (t[14] = l), (t[15] = u)), u
  );
}
function Qe(e) {
  let t = (0, I.c)(2),
...
function $e(e) {
  ...
  if (
    ...
    bb0: {
      ...
      t[13] === u
        ? (e = t[14])
        : ((e = (e) => !j({ installedSkillMatchKeys: u, skill: e })), (t[13] = u), (t[14] = e));
      let h = a.filter(e),
