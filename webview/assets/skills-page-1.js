...
import { t as b } from "./plugin-auth.js";
...
import { r as se } from "./settings-host-context.js";
...
import { C, N as w, _ as ue, g as de, h as fe, i as T, m as pe } from "./plugin-detail-page-2.js";
import { a as me, i as he, n as ge, o as _e, r as ve, s as E, t as ye } from "./plugins-page.js";
var D = d(),
  O = e(a(), 1);
function be(e) {
  let t = (0, D.c)(6),
...
function j() {
  let e = (0, D.c)(10),
    ...
    o;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = { hostId: r }), (e[0] = o)) : (o = e[0]);
  let s = x(o),
    { authMethod: d } = m(),
    p;
  e[1] === d ? (p = e[2]) : ((p = b(d)), (e[1] = d), (e[2] = p));
  let h = p,
    _,
    v;
  if (
...
function M() {
  ...
  let x = b,
    [te, S] = (0, O.useState)(r),
    C;
  e[2] !== g || e[3] !== te ? ((C = se(te, g)), (e[2] = g), (e[3] = te), (e[4] = C)) : (C = e[4]);
  let w = C,
  ...
  let j = be(k),
    ...
    { errorMessage: Le, isLoading: Re, refresh: ze, repoRoot: Be, skills: Ve } = de(Ie, w),
    He;
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((He = () => {
        Oe(!0);
  ...
  let { installRecommendedSkill: We, installingSkillId: Ge } = pe(Ue),
    Ke;
  e[12] === o ? (Ke = e[13]) : ((Ke = oe({ scope: `repo`, intl: o })), (e[12] = o), (e[13] = Ke));
  let qe = Ke,
    Je = d?.name ?? void 0,
    Ye;
  e[14] !== o || e[15] !== Je
  ...
  let tt = et,
    nt;
  (e[28] === Symbol.for(`react.memo_cache_sentinel`) ? ((nt = []), (e[28] = nt)) : (nt = e[28]),
    (0, O.useEffect)(Se, nt));
  let z;
  e[29] === j
    ? (z = e[30])
  ...
  let X;
  e[69] !== z || e[70] !== Y
    ? ((X = (0, A.jsx)(ce, { start: z, trailing: Y })), (e[69] = z), (e[70] = Y), (e[71] = X))
    : (X = e[71]);
  let lt;
...
function Te(e) {
  ...
  return (
    t[2] !== r || t[3] !== i
      ? ((a = (0, A.jsxs)(`section`, { className: `flex flex-col gap-4`, children: [i, r] })),
        (t[2] = r),
        (t[3] = i),
        (t[4] = a))
      : (a = t[4]),
...
function Ee(e) {
  ...
  let d;
  return (
    t[14] === u ? (d = t[15]) : ((d = (0, A.jsx)(E, { children: u })), (t[14] = u), (t[15] = d)), d
  );
}
function N(e) {
  let t = (0, D.c)(2),
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, A.jsx)(`span`, { className: `text-token-description-foreground`, children: n })),
        (t[0] = n),
        (t[1] = r)),
    r
  );
...
function De(e) {
  ...
  if (
    ...
    bb0: {
      ...
      t[13] === d
        ? (e = t[14])
        : ((e = (e) => !C({ installedSkillMatchKeys: d, skill: e })), (t[13] = d), (t[14] = e));
      let g = a.filter(e),
      ...
      p = E;
      let y;
      (t[21] !== s || t[22] !== n || t[23] !== d || t[24] !== f || t[25] !== u || t[26] !== c
        ? ((y = (e) =>
            (0, A.jsx)(
              ge,
              {
  ...
  return (
    t[28] !== p || t[29] !== m
      ? ((g = (0, A.jsx)(p, { children: m })), (t[28] = p), (t[29] = m), (t[30] = g))
      : (g = t[30]),
    g
  );
}
