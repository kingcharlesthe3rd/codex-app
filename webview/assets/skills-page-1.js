...
import { n as O, t as Te } from "./page-search-input-a2-XgvYV.js";
...
function Ke() {
  let e = (0, I.c)(103),
    ...
    c = h(s),
    p;
  e[0] === s ? (p = e[1]) : ((p = s?.map(Ye)), (e[0] = s), (e[1] = p));
  let m = p,
    [g, ne] = (0, L.useState)(r),
    v;
  e[2] !== c || e[3] !== g ? ((v = _(g, c)), (e[2] = c), (e[3] = g), (e[4] = v)) : (v = e[4]);
  let y = v,
    [b, ie] = (0, L.useState)(null),
    [ae, se] = (0, L.useState)(null),
    S;
  e[5] !== ae || e[6] !== b
    ? ((S = { container: b, target: ae }), (e[5] = ae), (e[6] = b), (e[7] = S))
    : (S = e[7]);
  let de = Ee(S),
    [C, pe] = (0, L.useState)(``),
    [w, he] = (0, L.useState)(!1),
  ...
  let M;
  e[9] !== ye || e[10] !== y
    ? ((M = { forceReloadSkills: ye, hostId: y, onInstalled: j }),
      (e[9] = ye),
      (e[10] = y),
      (e[11] = M))
    : (M = e[11]);
  let { installRecommendedSkill: Ve, installingSkillId: He } = Ae(M),
    N;
  e[12] === n ? (N = e[13]) : ((N = te({ scope: `repo`, intl: n })), (e[12] = n), (e[13] = N));
  let Ue = N,
    We = a?.name ?? void 0,
    P;
  e[14] !== n || e[15] !== We
    ? ((P = te({ scope: `admin`, intl: n, adminLabel: We })),
      (e[14] = n),
      (e[15] = We),
      (e[16] = P))
    : (P = e[16]);
  ...
  e[17] !== n || e[18] !== Ke || e[19] !== Ue || e[20] !== k
    ? ((F = (e) => {
        ...
        return te({
          scope: t,
          intl: n,
          repoLabel: ee({ skillPath: r, roots: k, fallbackLabel: Ue }),
          adminLabel: Ke,
        });
      }),
      (e[17] = n),
  ...
  e[29] === de
    ...
    : ((z = de
      ...
      (e[30] = z));
  let B;
  e[31] !== c || e[32] !== m || e[33] !== y
    ? ((B =
        c != null && c.length > 0 && m != null
          ? (0, R.jsx)(Ge, {
  ...
  e[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = (0, R.jsx)(re, { className: `icon-xs` })), (e[37] = st))
    : (st = e[37]);
  let H;
  e[38] === w
    ? (H = e[39])
  ...
  e[49] !== C || e[50] !== W || e[51] !== G
    ...
    : (K = e[52]);
  let q;
  e[53] !== T || e[54] !== t || e[55] !== ve || e[56] !== A || e[57] !== o
    ? ((q = () => {
        if (!A) return;
        le(t, ce, {});
        let e = Be({ creatorPath: A, isFirstOpen: !T, kind: `skill` });
        (T || ve(!0), o({ prefillPrompt: e, startInSidebar: !0 }));
      }),
      (e[53] = T),
      (e[54] = t),
      (e[55] = ve),
  ...
  e[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((lt = (0, R.jsx)(_e, { className: `icon-xs` })),
      (ut = (0, R.jsx)(x, {
  ...
  let X;
  e[69] !== z || e[70] !== Y
    ? ((X = (0, R.jsx)(we, { start: z, trailing: Y })), (e[69] = z), (e[70] = Y), (e[71] = X))
    : (X = e[71]);
  let dt;
    ...
    bb0: {
      ...
      let h = a.filter(e),
        ...
        ee = h.filter((e) =>
          g.length === 0
            ? !0
            : [e.name, e.description, e.shortDescription ?? ``].join(` `).toLowerCase().includes(g),
        );
      if (r) {
        let e;
      ...
      if (i) {
        ...
        (t[17] === i
          ...
          : ((n = (0, R.jsx)(`div`, {
              className: `flex min-h-0 flex-1 items-center justify-center`,
              children: (0, R.jsx)(b, { title: e, description: i }),
            })),
            (t[17] = i),
            (t[18] = n)),
          (m = n));
