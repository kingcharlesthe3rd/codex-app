...
import { bt as me, xt as S } from "./app-initial~app-main~automations-page.js";
import {
  $s as he,
  Qs as ge,
  Xa as C,
...
function Je() {
  ...
  let f = d,
    [m, h] = (0, I.useState)(pe),
    g;
  e[2] !== l || e[3] !== m ? ((g = v(m, l)), (e[2] = l), (e[3] = m), (e[4] = g)) : (g = e[4]);
  let _ = g,
    [te, ne] = (0, I.useState)(null),
    [re, ae] = (0, I.useState)(null),
    y;
  e[5] !== re || e[6] !== te
    ? ((y = { container: te, target: re }), (e[5] = re), (e[6] = te), (e[7] = y))
    : (y = e[7]);
  let le = Oe(y),
    [x, fe] = (0, I.useState)(``),
    [S, ge] = (0, I.useState)(!1),
    ...
    { errorMessage: Pe, isLoading: Fe, refresh: Ie, repoRoot: Le, skills: Ve } = Re(je, _),
    k;
  ...
  let { installRecommendedSkill: Ue, installingSkillId: We } = Me(A),
    j;
  e[12] === n ? (j = e[13]) : ((j = we({ scope: `repo`, intl: n })), (e[12] = n), (e[13] = j));
  let Ge = j,
    Ke = r?.name ?? void 0,
    M;
  e[14] !== n || e[15] !== Ke
  ...
  let X;
  e[69] !== z || e[70] !== Y
    ? ((X = (0, L.jsx)(me, { start: z, trailing: Y })), (e[69] = z), (e[70] = Y), (e[71] = X))
    : (X = e[71]);
  let dt;
...
function et(e) {
  ...
  return (
    t[28] !== p || t[29] !== m
      ? ((g = (0, L.jsx)(p, { children: m })), (t[28] = p), (t[29] = m), (t[30] = g))
      : (g = t[30]),
    g
  );
}
