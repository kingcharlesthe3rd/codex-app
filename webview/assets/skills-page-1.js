...
import { Ho as t, Vo as n } from "./app-server-manager-signals.js";
...
import { g as f } from "./persisted-signal.js";
import { p } from "./codex-api.js";
import { E as m } from "./mention-item.js";
import { r as h } from "./skill-utils.js";
...
import { a as pe, i as me, n as he, o as ge, r as _e, s as C, t as w } from "./plugins-page.js";
var T = s(),
  E = e(r(), 1);
function ve(e) {
  let t = (0, T.c)(6),
...
function k() {
  let e = (0, T.c)(103),
    ...
    { data: s } = p(),
    _ = ee(),
    [v] = n(`remote_connections`),
    y = ne(v),
    b;
  e[0] === v ? (b = e[1]) : ((b = v?.map(Ce)), (e[0] = v), (e[1] = b));
  let x = b,
    [S, he] = (0, E.useState)(t),
    C;
  e[2] !== y || e[3] !== S ? ((C = oe(S, y)), (e[2] = y), (e[3] = S), (e[4] = C)) : (C = e[4]);
  let w = C,
    [D, ye] = (0, E.useState)(null),
    [k, Se] = (0, E.useState)(null),
    A;
  e[5] !== k || e[6] !== D
  ...
  let De = ve(A),
    ...
    je = c(me),
    {
      forceReloadSkills: Me,
      installedSkillMatchKeys: Ne,
      isFetching: Pe,
      isLoading: Fe,
      markSkillsUpdated: N,
      skills: P,
    ...
    {
      canInstallRecommendedSkills: Ie,
      defaultRecommendedRepoRoot: Le,
      skillCreatorPath: I,
    } = de(w),
    { errorMessage: Re, isLoading: ze, refresh: Be, repoRoot: Ve, skills: He } = ue(Le, w),
    Ue;
  ...
  let We;
  e[9] !== Me || e[10] !== w
    ? ((We = { forceReloadSkills: Me, hostId: w, onInstalled: Ue }),
      (e[9] = Me),
      (e[10] = w),
      (e[11] = We))
    : (We = e[11]);
  let { installRecommendedSkill: Ge, installingSkillId: Ke } = fe(We),
    qe;
  e[12] === i ? (qe = e[13]) : ((qe = ae({ scope: `repo`, intl: i })), (e[12] = i), (e[13] = qe));
  let Je = qe,
    Ye = s?.name ?? void 0,
    Xe;
  e[14] !== i || e[15] !== Ye
    ? ((Xe = ae({ scope: `admin`, intl: i, adminLabel: Ye })),
      (e[14] = i),
      (e[15] = Ye),
      (e[16] = Xe))
    : (Xe = e[16]);
  let Ze = Xe,
    Qe;
  e[17] !== i || e[18] !== Ze || e[19] !== Je || e[20] !== F
    ? ((Qe = (e) => {
        let { scope: t, skillPath: n } = e;
        return ae({
          scope: t,
          intl: i,
          repoLabel: ie({ skillPath: n, roots: F, fallbackLabel: Je }),
          adminLabel: Ze,
        });
      }),
      (e[17] = i),
  ...
  let rt = nt,
    L;
  (e[28] === Symbol.for(`react.memo_cache_sentinel`) ? ((L = []), (e[28] = L)) : (L = e[28]),
    (0, E.useEffect)(xe, L));
  let R;
  e[29] === De
    ? (R = e[30])
  ...
  e[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, O.jsx)(re, { className: `icon-xs` })), (e[37] = V))
    : (V = e[37]);
  let H;
  e[38] === M
    ? (H = e[39])
  ...
  e[49] !== j || e[50] !== W || e[51] !== G
    ...
    : (K = e[52]);
  let q;
  e[53] !== Ae || e[54] !== r || e[55] !== je || e[56] !== I || e[57] !== _
    ? ((q = () => {
        if (!I) return;
        f(r, { eventName: `codex_skill_new_clicked` });
        let e = pe({ creatorPath: I, isFirstOpen: !Ae, kind: `skill` });
        (Ae || je(!0), _({ prefillPrompt: e, startInSidebar: !0 }));
      }),
      (e[53] = Ae),
      (e[54] = r),
      (e[55] = je),
  ...
  e[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = (0, O.jsx)(te, { className: `icon-xs` })),
      (ct = (0, O.jsx)(d, {
  ...
  let X;
  e[69] !== R || e[70] !== Y
    ? ((X = (0, O.jsx)(se, { start: R, trailing: Y })), (e[69] = R), (e[70] = Y), (e[71] = X))
    : (X = e[71]);
  let lt;
    ...
    bb0: {
      ...
      let g = a.filter(e),
        ...
        ee = g.filter((e) =>
          _.length === 0
            ? !0
            : [e.name, e.description, e.shortDescription ?? ``].join(` `).toLowerCase().includes(_),
        );
      if (r) {
        let e;
