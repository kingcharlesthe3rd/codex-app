...
import { An as Ce, jn as E } from "./app-initial~app-main~automations-page.js";
import {
  r as we,
  t as D,
...
function Ke() {
  let e = (0, I.c)(103),
    ...
    f = xe(d),
    m;
  e[0] === d ? (m = e[1]) : ((m = d?.map(Ye)), (e[0] = d), (e[1] = m));
  let h = m,
    [_, te] = (0, L.useState)(l),
    y;
  e[2] !== f || e[3] !== _ ? ((y = Se(_, f)), (e[2] = f), (e[3] = _), (e[4] = y)) : (y = e[4]);
  let b = y,
    [re, ie] = (0, L.useState)(null),
    [se, ce] = (0, L.useState)(null),
    x;
  e[5] !== se || e[6] !== re
    ? ((x = { container: re, target: se }), (e[5] = se), (e[6] = re), (e[7] = x))
    : (x = e[7]);
  let le = Ee(x),
    [S, fe] = (0, L.useState)(``),
    [C, ge] = (0, L.useState)(!1),
    ...
    T = g(Le),
    {
      forceReloadSkills: _e,
      installedSkillMatchKeys: ve,
      isFetching: ye,
      isLoading: E,
      markSkillsUpdated: D,
    ...
    { errorMessage: Me, isLoading: Ne, refresh: Pe, repoRoot: Fe, skills: ze } = Ie(ke, b),
    j;
  ...
  let M;
  e[9] !== _e || e[10] !== b
    ? ((M = { forceReloadSkills: _e, hostId: b, onInstalled: j }),
      (e[9] = _e),
      (e[10] = b),
      (e[11] = M))
    : (M = e[11]);
  let { installRecommendedSkill: Ve, installingSkillId: He } = Ae(M),
    N;
  e[12] === n ? (N = e[13]) : ((N = pe({ scope: `repo`, intl: n })), (e[12] = n), (e[13] = N));
  let Ue = N,
    We = a?.name ?? void 0,
    P;
  e[14] !== n || e[15] !== We
    ? ((P = pe({ scope: `admin`, intl: n, adminLabel: We })),
      (e[14] = n),
      (e[15] = We),
      (e[16] = P))
    : (P = e[16]);
  let Ke = P,
    F;
  e[17] !== n || e[18] !== Ke || e[19] !== Ue || e[20] !== k
    ? ((F = (e) => {
        let { scope: t, skillPath: r } = e;
        return pe({
          scope: t,
          intl: n,
          repoLabel: de({ skillPath: r, roots: k, fallbackLabel: Ue }),
          adminLabel: Ke,
        });
      }),
      (e[17] = n),
  ...
  e[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = (0, R.jsx)(be, { className: `icon-xs` })), (e[37] = st))
    : (st = e[37]);
  let H;
  e[38] === C
    ? (H = e[39])
  ...
  e[49] !== S || e[50] !== W || e[51] !== G
    ...
    : (K = e[52]);
  let q;
  e[53] !== w || e[54] !== t || e[55] !== T || e[56] !== A || e[57] !== c
    ? ((q = () => {
        if (!A) return;
        p(t, ue, {});
        let e = Be({ creatorPath: A, isFirstOpen: !w, kind: `skill` });
        (w || T(!0), c({ prefillPrompt: e, startInSidebar: !0 }));
      }),
      (e[53] = w),
      (e[54] = t),
      (e[55] = T),
  ...
  e[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((lt = (0, R.jsx)(r, { className: `icon-xs` })),
      (ut = (0, R.jsx)(s, {
  ...
  let X;
  e[69] !== z || e[70] !== Y
    ? ((X = (0, R.jsx)(Ce, { start: z, trailing: Y })), (e[69] = z), (e[70] = Y), (e[71] = X))
    : (X = e[71]);
  let dt;
...
function Ze(e) {
  ...
  let u;
  if (t[3] !== a || t[4] !== o || t[5] !== n || t[6] !== l || t[7] !== c) {
    let e;
    (t[9] !== o || t[10] !== n || t[11] !== l || t[12] !== c
      ? ((e = (e) => {
          let { skill: t } = e,
            r =
              t.scope === `repo`
                ...
                : [],
            i = t.scope === `repo` ? Ne({ skillPath: t.path, roots: c }) : null;
          return (0, R.jsx)(
            Pe,
            {
              skill: t,
  ...
  let d;
  return (
    t[14] === u ? (d = t[15]) : ((d = (0, R.jsx)(j, { children: u })), (t[14] = u), (t[15] = d)), d
  );
}
function Qe(e) {
  let t = (0, I.c)(2),
...
function $e(e) {
  ...
  if (
    ...
    bb0: {
      ...
      t[13] === d
        ? (e = t[14])
        : ((e = (e) => !A({ installedSkillMatchKeys: d, skill: e })), (t[13] = d), (t[14] = e));
      let g = a.filter(e),
      ...
      p = j;
      let v;
      (t[21] !== c || t[22] !== n || t[23] !== d || t[24] !== f || t[25] !== u || t[26] !== l
        ? ((v = (e) =>
            (0, R.jsx)(
              Ve,
              {
                ...
                canInstall: c,
                hostId: n,
                isInstalled: A({ installedSkillMatchKeys: d, skill: e }),
                isInstalling: f === e.id,
                repoRoot: l,
                onInstall: u,
              },
  ...
  return (
    t[28] !== p || t[29] !== m
      ? ((g = (0, R.jsx)(p, { children: m })), (t[28] = p), (t[29] = m), (t[30] = g))
      : (g = t[30]),
    g
  );
}
