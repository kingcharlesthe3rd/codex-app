...
import { Bt as s, U as c, n as l, sn as u } from "./use-host-config.js";
import { Hn as d, d as f } from "./thread-context-inputs.js";
import { h as p, n as m } from "./vscode-api.js";
import "./isEqual.js";
import { Ar as h, jr as g } from "./src.js";
import "./react-dom.js";
...
import { s as C } from "./app-server-manager-hooks-D4-J16ZL.js";
...
import "./links.js";
import { t as T } from "./use-is-background-subagents-enabled.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as E } from "./settings-host-context.js";
...
import { t as j } from "./use-codex-worktrees-Zr-sRUtW.js";
...
function I() {
  let e = (0, N.c)(57),
    ...
    { selectedHostId: n } = E(),
    {
      ...
      error: s,
      refetch: c,
    } = j(l(n), `worktrees_settings_page`),
    d;
  e[0] === n ? (d = e[1]) : ((d = { hostId: n }), (e[0] = n), (e[1] = d));
  let { data: p, isLoading: m, error: h } = i(f, d),
    { data: g, isLoading: x } = C(),
    w = T(),
    M,
    P;
  if (
    ...
    bb0: {
      let i = B(r?.worktrees ?? [], p?.roots ?? []),
        l,
        d;
      if (e[17] !== g || e[18] !== w || e[19] !== n) {
        let t;
        (e[22] === n ? (t = e[23]) : ((t = (e) => W(e) === n), (e[22] = n), (e[23] = t)),
          (l = (g ?? []).filter(t)));
        let r;
        (e[24] === w ? (r = e[25]) : ((r = (e) => !u(e, w)), (e[24] = w), (e[25] = r)),
          (d = l.filter(r)),
          (e[17] = g),
          (e[18] = w),
          (e[19] = n),
      ...
      e[30] === o
        ? (j = e[31])
        : ((j = o ? null : (0, F.jsx)(S, { className: `icon-xs` })), (e[30] = o), (e[31] = j));
      let N;
      e[32] !== o || e[33] !== T || e[34] !== E || e[35] !== j
        ? ((N = (0, F.jsx)(y, {
            "aria-label": T,
            className: `shrink-0`,
            color: `ghost`,
      ...
      if (a || m) {
        ...
        e[37] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((t = (0, F.jsx)(D, { slug: `worktrees` })), (e[37] = t))
          : (t = e[37]);
        let n;
        ...
        e[39] === I
          ? (r = e[40])
          : ((r = (0, F.jsx)(A.Header, { title: n, actions: I })), (e[39] = I), (e[40] = r));
        let i;
        ...
        (e[42] === r
          ? (a = e[43])
          : ((a = (0, F.jsx)(O, { title: t, children: (0, F.jsxs)(A, { children: [r, i] }) })),
            (e[42] = r),
            (e[43] = a)),
          (P = a));
        break bb0;
      ...
      if (R) {
        ...
        e[44] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((n = (0, F.jsx)(D, { slug: `worktrees` })), (e[44] = n))
          : (n = e[44]);
        let r;
        ...
        e[46] === I
          ? (i = e[47])
          : ((i = (0, F.jsx)(A.Header, { title: r, actions: I })), (e[46] = I), (e[47] = i));
        let a;
        ...
        let s;
        (e[53] !== i || e[54] !== o
          ? ((s = (0, F.jsx)(O, { title: n, children: (0, F.jsxs)(A, { children: [i, o] }) })),
            (e[53] = i),
            (e[54] = o),
            (e[55] = s))
          : (s = e[55]),
      ...
      (e[56] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((V = (0, F.jsx)(D, { slug: `worktrees` })), (e[56] = V))
        : (V = e[56]),
        (M = (0, F.jsx)(O, {
          title: V,
          children:
              ...
              : _.map((e, t) =>
                  (0, F.jsx)(
                    L,
                    {
                      action: t === 0 ? I : null,
                      allConversations: l,
                      visibleConversations: f,
                      hostId: n,
                      isConversationsLoading: x,
                      onWorktreeDeleted: () => {
                        c();
                      },
                      repoRoot: e.repoRoot,
...
function L(e) {
  let t = (0, N.c)(30),
    ...
    { data: f, isLoading: p } = d(r, l(s), `worktree_restore_banner`),
    m = f?.root ?? r ?? i[0]?.dir ?? null,
    h;
  t[0] === m
    ? (h = t[1])
    : ((h = m
        ? (0, F.jsx)(`span`, { className: `truncate font-mono text-sm`, children: m })
        : (0, F.jsx)(v, {
  ...
  let x;
  t[6] !== y || t[7] !== b
    ? ((x = (0, F.jsxs)(`div`, { className: `flex min-w-0 flex-col`, children: [y, b] })),
      (t[6] = y),
      (t[7] = b),
      (t[8] = x))
    : (x = t[8]);
  let S;
  t[9] !== n || t[10] !== x
    ? ((S = (0, F.jsx)(A.Header, { title: x, actions: n })), (t[9] = n), (t[10] = x), (t[11] = S))
    : (S = t[11]);
  let C;
  if (t[12] !== a || t[13] !== s || t[14] !== c || t[15] !== u || t[16] !== o || t[17] !== i) {
    let e;
    (t[19] !== a || t[20] !== s || t[21] !== c || t[22] !== u || t[23] !== o
      ? ((e = (e) =>
          (0, F.jsx)(
            R,
            {
              allConversations: V(e.dir, a),
              hostId: s,
              visibleConversations: V(e.dir, o),
              isConversationsLoading: c,
              onWorktreeDeleted: u,
              worktree: e,
            },
  ...
  t[25] === C
    ? (w = t[26])
    : ((w = (0, F.jsx)(A.Content, { children: (0, F.jsx)(k, { children: C }) })),
      (t[25] = C),
      (t[26] = w));
  let T;
  return (
    t[27] !== S || t[28] !== w
      ? ((T = (0, F.jsxs)(A, { children: [S, w] })), (t[27] = S), (t[28] = w), (t[29] = T))
      : (T = t[29]),
    T
  );
}
        ...
        try {
          (t.length > 0 &&
            ...
            await m(`worktree-delete`, {
              params: { hostId: T.id, worktree: e.dir, reason: `settings-delete-targeted` },
            }),
            u());
        } catch (e) {
          (p.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: h(e) } }),
            d
              .get(x)
              .danger(
                g.formatMessage({
...
function H(e, t) {
  ...
  let n = e.map((e, n) => ({ worktree: e, index: n, conversationCount: V(e.dir, t).length }));
  return (
    n.sort((e, t) => {
