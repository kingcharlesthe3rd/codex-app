...
import { Un as r, Xs as i, do as a, ni as o } from "./app-server-manager-signals.js";
...
import "./statsig.js";
import "./request.js";
import { s as _ } from "./app-server-manager-hooks-DfDI-9lO.js";
...
import { n as E } from "./is-subagent-conversation-Tg4-cSB_.js";
...
function L(e) {
  ...
  t[0] === h
    ? (g = t[1])
    : ((g = h
        ? (0, F.jsx)(`span`, { className: `truncate font-mono text-sm`, children: h })
        : (0, F.jsx)(f, {
      ...
      if (!C) {
        ...
        try {
          (t.length > 0 &&
            (await Promise.all(
              t.map((e) =>
                i(`archive-conversation`, { conversationId: e.id, cleanupWorktree: !1 }),
              ),
            )),
          ...
          (l.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: n(e) } }),
            g
              .get(y)
              .danger(
                v.formatMessage({
