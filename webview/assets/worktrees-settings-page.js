...
import { Ar as t, vn as n } from "./src-2.js";
import { Bo as r, Ci as i, Qn as a, bc as o } from "./app-server-manager-signals.js";
...
function L(e) {
  let t = (0, N.c)(30),
    ...
    { data: f, isLoading: p } = a(i, r(l), `worktree_restore_banner`),
    m = f?.root ?? i ?? o[0]?.dir ?? null,
    h;
  t[0] === m
    ? (h = t[1])
    : ((h = m
