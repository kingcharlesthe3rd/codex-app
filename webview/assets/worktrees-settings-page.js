...
import { Jt as s, Vi as c, js as l, sr as u, us as d } from "./app-server-manager-signals.js";
import { m as f, n as p } from "./vscode-api.js";
import "./isEqual.js";
import { Bt as m, ar as h } from "./src-1.js";
import "./react-dom.js";
...
import { s as b } from "./app-server-manager-hooks.js";
import "./invalidate-queries-and-broadcast.js";
import { u as x } from "./thread-context-inputs.js";
...
import { t as C } from "./use-navigate-to-local-conversation.js";
import "./links.js";
import { t as w } from "./use-is-background-subagents-enabled.js";
import "./sortBy.js";
...
function I() {
  let e = (0, N.c)(57),
    ...
    { selectedHostId: n } = T(),
    {
      ...
      error: c,
      refetch: l,
    } = j(d(n), `worktrees_settings_page`),
    u;
  e[0] === n ? (u = e[1]) : ((u = { hostId: n }), (e[0] = n), (e[1] = u));
  let { data: f, isLoading: p, error: m } = i(x, u),
    { data: h, isLoading: S } = b(),
    C = w(),
    M,
    P;
  if (
    ...
    bb0: {
      let i = B(r?.worktrees ?? [], f?.roots ?? []),
        u,
        d;
      if (e[17] !== h || e[18] !== C || e[19] !== n) {
        let t;
        (e[22] === n ? (t = e[23]) : ((t = (e) => W(e) === n), (e[22] = n), (e[23] = t)),
          (u = (h ?? []).filter(t)));
        let r;
        (e[24] === C ? (r = e[25]) : ((r = (e) => !s(e, C)), (e[24] = C), (e[25] = r)),
          (d = u.filter(r)),
          (e[17] = h),
          (e[18] = C),
          (e[19] = n),
      ...
      e[30] === o
        ? (j = e[31])
        : ((j = o ? null : (0, F.jsx)(E, { className: `icon-xs` })), (e[30] = o), (e[31] = j));
      let N;
      e[32] !== o || e[33] !== w || e[34] !== T || e[35] !== j
        ? ((N = (0, F.jsx)(v, {
            "aria-label": w,
            className: `shrink-0`,
            color: `ghost`,
...
function L(e) {
  let t = (0, N.c)(30),
    ...
    { data: f, isLoading: p } = u(r, d(s), `worktree_restore_banner`),
  ...
  t[9] !== n || t[10] !== x
    ...
    : (S = t[11]);
  let C;
  if (t[12] !== a || t[13] !== s || t[14] !== c || t[15] !== l || t[16] !== o || t[17] !== i) {
    let e;
      ...
      if (!x) {
        ...
        try {
          (t.length > 0 &&
            ...
            await p(`worktree-delete`, {
              params: { hostId: T.id, worktree: e.dir, reason: `settings-delete-targeted` },
            }),
            s());
        } catch (e) {
          (f.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: m(e) } }),
            u
              .get(S)
              .danger(
                b.formatMessage({
