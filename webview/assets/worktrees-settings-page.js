...
import { dt as R, lt as z } from "./app-initial~app-main~automations-page.js";
import {
  At as B,
  Ni as V,
  Pi as H,
    ...
    bb0: {
      ...
      if (e[17] !== p || e[18] !== h || e[19] !== n) {
        ...
        (e[22] === n ? (t = e[23]) : ((t = (e) => ve(e) === n), (e[22] = n), (e[23] = t)),
          (l = (p ?? []).filter(t)));
        let r;
        (e[24] === h ? (r = e[25]) : ((r = (e) => !ne(e, h)), (e[24] = h), (e[25] = r)),
          (y = l.filter(r)),
          (e[17] = p),
          (e[18] = h),
          (e[19] = n),
      ...
      e[30] === a
        ? (E = e[31])
        : ((E = a ? null : (0, $.jsx)(g, { className: `icon-xs` })), (e[30] = a), (e[31] = E));
      let D;
      ...
      if (i || d) {
        ...
        (e[42] === r
          ? (a = e[43])
          : ((a = (0, $.jsx)(z, { title: t, children: (0, $.jsxs)(q, { children: [r, i] }) })),
            (e[42] = r),
            (e[43] = a)),
          (v = a));
        break bb0;
      ...
      if (A) {
        ...
        let s;
        (e[53] !== i || e[54] !== o
          ? ((s = (0, $.jsx)(z, { title: n, children: (0, $.jsxs)(q, { children: [i, o] }) })),
            (e[53] = i),
            (e[54] = o),
            (e[55] = s))
          : (s = e[55]),
...
function me(e) {
  ...
  let y;
  t[9] !== n || t[10] !== v
    ? ((y = (0, $.jsx)(q.Header, { title: v, actions: n })), (t[9] = n), (t[10] = v), (t[11] = y))
    : (y = t[11]);
  let b;
  ...
  t[25] === b
    ? (x = t[26])
    : ((x = (0, $.jsx)(q.Content, { children: (0, $.jsx)(G, { children: b }) })),
      (t[25] = b),
      (t[26] = x));
  let S;
  return (
    t[27] !== y || t[28] !== x
      ? ((S = (0, $.jsxs)(q, { children: [y, x] })), (t[27] = y), (t[28] = x), (t[29] = S))
      : (S = t[29]),
    S
  );
}
    ...
    g = async () => {
      if (!f) {
        ...
        try {
          ...
          (a.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: m(e) } }),
            s
              .get(ie)
              .danger(
                u.formatMessage({
