...
import { lt as V, ut as H } from "./app-initial~app-main~automations-page.js";
import {
  O as U,
  k as W,
...
import {
  r as G,
  t as ce,
} from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~new-thread-panel-page~o~ozpabocf.js";
import {
  r as le,
  t as K,
...
function pe() {
  ...
  let { data: f, isLoading: p, error: m } = ne(r, d),
    { data: h, isLoading: g } = w(),
    _ = R(),
    v,
    y;
  if (
    ...
    bb0: {
      let r = _e(a?.worktrees ?? [], f?.roots ?? []),
        l,
        d;
      if (e[17] !== h || e[18] !== _ || e[19] !== n) {
        let t;
        (e[22] === n ? (t = e[23]) : ((t = (e) => ve(e) === n), (e[22] = n), (e[23] = t)),
          (l = (h ?? []).filter(t)));
        let r;
        (e[24] === _ ? (r = e[25]) : ((r = (e) => !T(e, _)), (e[24] = _), (e[25] = r)),
          (d = l.filter(r)),
          (e[17] = h),
          (e[18] = _),
          (e[19] = n),
      ...
      e[30] === s
        ? (E = e[31])
        : ((E = s ? null : (0, $.jsx)(z, { className: `icon-xs` })), (e[30] = s), (e[31] = E));
      let O;
      e[32] !== s || e[33] !== C || e[34] !== w || e[35] !== E
        ? ((O = (0, $.jsx)(D, {
            "aria-label": C,
            className: `shrink-0`,
            color: `ghost`,
      ...
      if (o || p) {
        ...
        e[39] === k
          ? (r = e[40])
          : ((r = (0, $.jsx)(V.Header, { title: n, actions: k })), (e[39] = k), (e[40] = r));
        let a;
        ...
        (e[42] === r
          ? (o = e[43])
          : ((o = (0, $.jsx)(K, { title: t, children: (0, $.jsxs)(V, { children: [r, a] }) })),
            (e[42] = r),
            (e[43] = o)),
          (y = o));
        break bb0;
      ...
      if (A) {
        ...
        e[46] === k
          ? (a = e[47])
          : ((a = (0, $.jsx)(V.Header, { title: r, actions: k })), (e[46] = k), (e[47] = a));
        let o;
        ...
        let c;
        (e[53] !== a || e[54] !== s
          ? ((c = (0, $.jsx)(K, { title: n, children: (0, $.jsxs)(V, { children: [a, s] }) })),
            (e[53] = a),
            (e[54] = s),
            (e[55] = c))
          : (c = e[55]),
      ...
      (e[56] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((j = (0, $.jsx)(U, { slug: `worktrees` })), (e[56] = j))
        : (j = e[56]),
        (v = (0, $.jsx)(K, {
          title: j,
          children:
...
function me(e) {
  let t = (0, Z.c)(30),
    ...
    { data: f, isLoading: m } = p(r, l(c), `worktree_restore_banner`),
    h = f?.root ?? r ?? a[0]?.dir ?? null,
    g;
  t[0] === h
    ? (g = t[1])
    : ((g = h
        ? (0, $.jsx)(`span`, { className: `truncate font-mono text-sm`, children: h })
        : (0, $.jsx)(i, {
  ...
  let x;
  t[6] !== y || t[7] !== b
    ? ((x = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col`, children: [y, b] })),
      (t[6] = y),
      (t[7] = b),
      (t[8] = x))
    : (x = t[8]);
  let S;
  t[9] !== n || t[10] !== x
    ? ((S = (0, $.jsx)(V.Header, { title: x, actions: n })), (t[9] = n), (t[10] = x), (t[11] = S))
    : (S = t[11]);
  let C;
  if (t[12] !== o || t[13] !== c || t[14] !== u || t[15] !== d || t[16] !== s || t[17] !== a) {
    let e;
    (t[19] !== o || t[20] !== c || t[21] !== u || t[22] !== d || t[23] !== s
      ? ((e = (e) =>
          (0, $.jsx)(
            he,
            {
  ...
  t[25] === C
    ? (w = t[26])
    : ((w = (0, $.jsx)(V.Content, { children: (0, $.jsx)(q, { children: C }) })),
      (t[25] = C),
      (t[26] = w));
  let T;
  return (
    t[27] !== S || t[28] !== w
      ? ((T = (0, $.jsxs)(V, { children: [S, w] })), (t[27] = S), (t[28] = w), (t[29] = T))
      : (T = t[29]),
    T
  );
}
        ...
        try {
          (t.length > 0 &&
            ...
            await d(`worktree-delete`, {
              params: { hostId: g.id, worktree: e.dir, reason: `settings-delete-targeted` },
            }),
            c());
        } catch (e) {
          (n.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: re(e) } }),
            u
              .get(S)
              .danger(
                p.formatMessage({
