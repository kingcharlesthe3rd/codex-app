...
import { Dt as P, Tt as F } from "./app-initial~app-main~automations-page.js";
import {
  $ as I,
  L,
  Q as R,
...
function pe() {
  let e = (0, Z.c)(57),
    ...
    { selectedHostId: n } = S(),
    {
      ...
      error: s,
      refetch: c,
    } = de(o(n), `worktrees_settings_page`),
    u;
  e[0] === n ? (u = e[1]) : ((u = { hostId: n }), (e[0] = n), (e[1] = u));
  let { data: d, isLoading: f, error: p } = g(l, u),
    { data: m, isLoading: h } = j(),
    _ = E(),
    v,
    y;
  if (
    ...
    bb0: {
      let o = _e(r?.worktrees ?? [], d?.roots ?? []),
        l,
        u;
      if (e[17] !== m || e[18] !== _ || e[19] !== n) {
        let t;
        (e[22] === n ? (t = e[23]) : ((t = (e) => ve(e) === n), (e[22] = n), (e[23] = t)),
          (l = (m ?? []).filter(t)));
        let r;
        (e[24] === _ ? (r = e[25]) : ((r = (e) => !re(e, _)), (e[24] = _), (e[25] = r)),
          (u = l.filter(r)),
          (e[17] = m),
          (e[18] = _),
          (e[19] = n),
      ...
      e[30] === a
        ? (w = e[31])
        : ((w = a ? null : (0, $.jsx)(O, { className: `icon-xs` })), (e[30] = a), (e[31] = w));
      let T;
      e[32] !== a || e[33] !== S || e[34] !== C || e[35] !== w
        ? ((T = (0, $.jsx)(z, {
            "aria-label": S,
            className: `shrink-0`,
            color: `ghost`,
      ...
      if (i || f) {
        ...
        e[39] === E
          ? (r = e[40])
          : ((r = (0, $.jsx)(K.Header, { title: n, actions: E })), (e[39] = E), (e[40] = r));
        let i;
        ...
        (e[42] === r
          ? (a = e[43])
          : ((a = (0, $.jsx)(F, { title: t, children: (0, $.jsxs)(K, { children: [r, i] }) })),
            (e[42] = r),
            (e[43] = a)),
          (y = a));
        break bb0;
      ...
      if (D) {
        ...
        e[46] === E
          ? (i = e[47])
          : ((i = (0, $.jsx)(K.Header, { title: r, actions: E })), (e[46] = E), (e[47] = i));
        let a;
        e[48] !== t || e[49] !== D.message
          ? ((a =
              D.message ||
              t.formatMessage({
        ...
        let s;
        (e[53] !== i || e[54] !== o
          ? ((s = (0, $.jsx)(F, { title: n, children: (0, $.jsxs)(K, { children: [i, o] }) })),
            (e[53] = i),
            (e[54] = o),
            (e[55] = s))
          : (s = e[55]),
...
function me(e) {
  let t = (0, Z.c)(30),
    ...
    { data: d, isLoading: f } = te(r, o(c), `worktree_restore_banner`),
  ...
  let b;
  t[9] !== n || t[10] !== y
    ? ((b = (0, $.jsx)(K.Header, { title: y, actions: n })), (t[9] = n), (t[10] = y), (t[11] = b))
    : (b = t[11]);
  let x;
  if (t[12] !== a || t[13] !== c || t[14] !== l || t[15] !== u || t[16] !== s || t[17] !== i) {
    let e;
    (t[19] !== a || t[20] !== c || t[21] !== l || t[22] !== u || t[23] !== s
      ? ((e = (e) =>
          (0, $.jsx)(
            he,
            {
  ...
  t[25] === x
    ? (S = t[26])
    : ((S = (0, $.jsx)(K.Content, { children: (0, $.jsx)(q, { children: x }) })),
      (t[25] = x),
      (t[26] = S));
  let C;
  return (
    t[27] !== b || t[28] !== S
      ? ((C = (0, $.jsxs)(K, { children: [b, S] })), (t[27] = b), (t[28] = S), (t[29] = C))
      : (C = t[29]),
    C
  );
}
    ...
    g = async () => {
      if (!p) {
        ...
        try {
          ...
          (a.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: i(e) } }),
            l
              .get(V)
              .danger(
                f.formatMessage({
