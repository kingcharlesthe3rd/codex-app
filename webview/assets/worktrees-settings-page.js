...
import { m as s, n as c } from "./vscode-api.js";
import "./isEqual.js";
import { Xt as l, fr as u } from "./src-4.js";
import {
  As as d,
  ir as f,
  ji as p,
...
import "./react-dom.js";
import { c as g, o as _ } from "./lib-1.js";
...
function I() {
  let e = (0, N.c)(57),
    ...
    { selectedHostId: n } = T(),
    {
      ...
      error: s,
      refetch: c,
    } = j(m(n), `worktrees_settings_page`),
    l;
  e[0] === n ? (l = e[1]) : ((l = { hostId: n }), (e[0] = n), (e[1] = l));
  let { data: u, isLoading: d, error: f } = i(x, l),
    { data: p, isLoading: S } = b(),
    C = w(),
    M,
    P;
  if (
    ...
    bb0: {
      let i = B(r?.worktrees ?? [], u?.roots ?? []),
        l,
        m;
      if (e[17] !== p || e[18] !== C || e[19] !== n) {
        let t;
        (e[22] === n ? (t = e[23]) : ((t = (e) => W(e) === n), (e[22] = n), (e[23] = t)),
          (l = (p ?? []).filter(t)));
        let r;
        (e[24] === C ? (r = e[25]) : ((r = (e) => !h(e, C)), (e[24] = C), (e[25] = r)),
          (m = l.filter(r)),
          (e[17] = p),
          (e[18] = C),
          (e[19] = n),
...
function L(e) {
  let t = (0, N.c)(30),
    ...
    { data: u, isLoading: d } = f(r, m(s), `worktree_restore_banner`),
    p = u?.root ?? r ?? i[0]?.dir ?? null,
    h;
  t[0] === p
    ? (h = t[1])
    : ((h = p
        ? (0, F.jsx)(`span`, { className: `truncate font-mono text-sm`, children: p })
        : (0, F.jsx)(_, {
      ...
      if (!x) {
        ...
        try {
          (t.length > 0 &&
            ...
            await c(`worktree-delete`, {
              params: { hostId: T.id, worktree: e.dir, reason: `settings-delete-targeted` },
            }),
            u());
        } catch (e) {
          (s.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: l(e) } }),
            f
              .get(S)
              .danger(
                b.formatMessage({
