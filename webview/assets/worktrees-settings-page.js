...
import { h as f, n as p } from "./vscode-api.js";
import "./isEqual.js";
import { hr as m, mr as h } from "./src-2.js";
import "./react-dom.js";
...
import { u as S } from "./thread-context-inputs.js";
...
import { t as E } from "./settings-host-context.js";
...
function I() {
  ...
  let { data: f, isLoading: p, error: m } = r(S, u),
    { data: h, isLoading: b } = C(),
    w = T(),
    M,
    P;
  if (
    ...
    bb0: {
      let r = B(i?.worktrees ?? [], f?.roots ?? []),
        u,
        d;
      if (e[17] !== h || e[18] !== w || e[19] !== n) {
        let t;
        (e[22] === n ? (t = e[23]) : ((t = (e) => W(e) === n), (e[22] = n), (e[23] = t)),
          (u = (h ?? []).filter(t)));
        let r;
        (e[24] === w ? (r = e[25]) : ((r = (e) => !l(e, w)), (e[24] = w), (e[25] = r)),
          (d = u.filter(r)),
          (e[17] = h),
          (e[18] = w),
          (e[19] = n),
      ...
      e[30] === o
        ? (j = e[31])
        : ((j = o ? null : (0, F.jsx)(x, { className: `icon-xs` })), (e[30] = o), (e[31] = j));
      let N;
    ...
    E = async () => {
      if (!S) {
        ...
        try {
          ...
          (f.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: h(e) } }),
            u
              .get(b)
              .danger(
                x.formatMessage({
