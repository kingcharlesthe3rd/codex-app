...
import { Nr as t, vn as n } from "./src-2.js";
import { Ei as r, Qn as i, Uo as a, fs as o } from "./app-server-manager-signals.js";
import { n as s, t as c } from "./jsx-runtime.js";
import "./react-dom.js";
import "./marked.esm-BR-H6018.js";
import { F as l, P as u, g as d, h as f, lt as p, n as m } from "./vscode-api.js";
...
import { u as v } from "./thread-context-inputs.js";
...
import { t as j } from "./use-codex-worktrees-Cz6-FuqU.js";
...
function I() {
  ...
  let { data: d, isLoading: f, error: p } = u(v, l),
    { data: m, isLoading: y } = _(),
    S = C(),
    M,
    P;
  if (
    ...
    bb0: {
      let a = B(r?.worktrees ?? [], d?.roots ?? []),
        l,
        u;
      if (e[17] !== m || e[18] !== S || e[19] !== n) {
        let t;
        (e[22] === n ? (t = e[23]) : ((t = (e) => W(e) === n), (e[22] = n), (e[23] = t)),
          (l = (m ?? []).filter(t)));
        let r;
        (e[24] === S ? (r = e[25]) : ((r = (e) => !E(e, S)), (e[24] = S), (e[25] = r)),
          (u = l.filter(r)),
          (e[17] = m),
          (e[18] = S),
          (e[19] = n),
      ...
      e[30] === o
        ? (j = e[31])
        : ((j = o ? null : (0, F.jsx)(w, { className: `icon-xs` })), (e[30] = o), (e[31] = j));
      let N;
...
function L(e) {
  let t = (0, N.c)(30),
    ...
    { data: f, isLoading: p } = i(r, a(l), `worktree_restore_banner`),
    m = f?.root ?? r ?? o[0]?.dir ?? null,
    h;
  t[0] === m
    ? (h = t[1])
    : ((h = m
  ...
  t[9] !== n || t[10] !== x
    ...
    : (S = t[11]);
  let C;
  if (t[12] !== s || t[13] !== l || t[14] !== u || t[15] !== d || t[16] !== c || t[17] !== o) {
    let e;
    ...
    E = async () => {
      if (!C) {
        ...
        try {
          ...
          (d.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: n(e) } }),
            p
              .get(y)
              .danger(
                v.formatMessage({
