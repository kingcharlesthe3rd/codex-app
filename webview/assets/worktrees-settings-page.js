    ...
    bb0: {
      ...
      if (e[17] !== p || e[18] !== h || e[19] !== n) {
        ...
        (e[22] === n ? (t = e[23]) : ((t = (e) => ve(e) === n), (e[22] = n), (e[23] = t)),
          (l = (p ?? []).filter(t)));
        let r;
        (e[24] === h ? (r = e[25]) : ((r = (e) => !oe(e, h)), (e[24] = h), (e[25] = r)),
          (v = l.filter(r)),
          (e[17] = p),
          (e[18] = h),
          (e[19] = n),
      ...
      e[30] === a
        ? (E = e[31])
        : ((E = a ? null : (0, $.jsx)(V, { className: `icon-xs` })), (e[30] = a), (e[31] = E));
      let D;
      ...
      if (i || d) {
        ...
        e[39] === O
          ? (r = e[40])
          : ((r = (0, $.jsx)(G.Header, { title: n, actions: O })), (e[39] = O), (e[40] = r));
        let i;
        ...
        (e[42] === r
          ? (a = e[43])
          : ((a = (0, $.jsx)(q, { title: t, children: (0, $.jsxs)(G, { children: [r, i] }) })),
            (e[42] = r),
            (e[43] = a)),
          (_ = a));
        break bb0;
      ...
      if (k) {
        ...
        e[46] === O
          ? (i = e[47])
          : ((i = (0, $.jsx)(G.Header, { title: r, actions: O })), (e[46] = O), (e[47] = i));
        let a;
        ...
        let s;
        (e[53] !== i || e[54] !== o
          ? ((s = (0, $.jsx)(q, { title: n, children: (0, $.jsxs)(G, { children: [i, o] }) })),
            (e[53] = i),
            (e[54] = o),
            (e[55] = s))
          : (s = e[55]),
...
function me(e) {
  ...
  t[0] === f
    ? (p = t[1])
    : ((p = f
        ? (0, $.jsx)(`span`, { className: `truncate font-mono text-sm`, children: f })
        : (0, $.jsx)(N, {
  ...
  let v;
  t[6] !== g || t[7] !== _
    ? ((v = (0, $.jsxs)(`div`, { className: `flex min-w-0 flex-col`, children: [g, _] })),
      (t[6] = g),
      (t[7] = _),
      (t[8] = v))
    : (v = t[8]);
  let y;
  t[9] !== n || t[10] !== v
    ? ((y = (0, $.jsx)(G.Header, { title: v, actions: n })), (t[9] = n), (t[10] = v), (t[11] = y))
    : (y = t[11]);
  let b;
  ...
  t[25] === b
    ? (x = t[26])
    : ((x = (0, $.jsx)(G.Content, { children: (0, $.jsx)(K, { children: b }) })),
      (t[25] = b),
      (t[26] = x));
  let S;
  return (
    t[27] !== y || t[28] !== x
      ? ((S = (0, $.jsxs)(G, { children: [y, x] })), (t[27] = y), (t[28] = x), (t[29] = S))
      : (S = t[29]),
    S
  );
}
    ...
    _ = async () => {
      if (!p) {
        ...
        try {
          ...
          (n.error(`Failed to delete worktree`, { safe: {}, sensitive: { error: u(e) } }),
            l
              .get(D)
              .danger(
                f.formatMessage({
