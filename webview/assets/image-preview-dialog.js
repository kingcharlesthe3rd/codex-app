...
import { In as r } from "./src-4.js";
import { t as i } from "./react-dom.js";
import { c as a } from "./lib-1.js";
...
import { d as te, l as ne } from "./dialog-layout.js";
...
function p({
  ...
  let x = a(),
    ...
    R = L[0] ?? I,
    z = L.at(-1) ?? I,
    ze = I == null ? null : x.formatNumber(I / 100, { style: `percent`, maximumFractionDigits: 0 }),
    B = _e(e, t),
    ...
    K = (0, l.useCallback)((e) => {
      ...
      C((e) => (e?.width === t && e.height === n ? e : { width: t, height: n }));
    }, []),
    q = (0, l.useCallback)(
      (t) => {
        let n = ue(t);
  ...
  let X = ({ clientX: t, clientY: n, zoomPercent: r }) => {
      ...
      ((S.scrollLeft += c.left + c.width * o - t), (S.scrollTop += c.top + c.height * s - n));
    },
    We = (t) => {
      if (S == null) {
    ...
    Q = s((e) => {
      ...
      let n = he({ event: e, fallbackPoint: k.current, previewViewportNode: S });
    ...
    qe = (0, l.useCallback)(
      (e) => {
        let t = O.current;
        if (t !== e) {
          if ((t?.removeEventListener(`wheel`, Q), (O.current = e), Ae(e), e == null)) {
            C(null);
            return;
          }
    ...
    Je = (e) => {
      if (((k.current = { clientX: e.clientX, clientY: e.clientY }), e.pointerType !== `touch`))
        return;
      if (
      ...
      j.current = null;
      let t = g(A.current);
      M.current = t == null || I == null ? null : { distance: t.distance, zoomPercent: I };
    },
    Ye = (e) => {
      if (
        ...
        S == null ||
          ...
          (j.current.pointerId === e.pointerId &&
            (e.preventDefault(),
            e.stopPropagation(),
            (S.scrollLeft = j.current.scrollLeft - (e.clientX - j.current.clientX)),
            (S.scrollTop = j.current.scrollTop - (e.clientY - j.current.clientY))));
      }
    },
    $ = (e) => {
      ...
      let n = g(A.current);
      ((j.current = null),
        (M.current = n == null || I == null ? null : { distance: n.distance, zoomPercent: I }));
    };
  return (
    (0, l.useEffect)(() => {
      if (!r) return;
    ...
    (0, u.jsx)(ne, {
      ...
      overlayClassName: o(`!bg-black/90`, be && `!animate-none`),
      portalContainer: Oe,
      showDialogClose: !1,
      triggerContent: h,
      contentProps: {
        ...
        onKeyDown: (e) => {
          e.defaultPrevented ||
            (e.key === `ArrowLeft` && b != null && (e.preventDefault(), e.stopPropagation(), U()),
            e.key === `ArrowRight` && y != null && (e.preventDefault(), e.stopPropagation(), W()));
        },
        onCloseAutoFocus: Ee,
      },
      children: (0, u.jsxs)(`div`, {
        ...
        children: [
          (0, u.jsxs)(`div`, {
            ...
            children: [
              _ == null
                ...
                : (0, u.jsx)(`button`, {
                    type: `button`,
                    className: o(d, `relative`, _.active ? `h-9 min-w-0 p-1` : `h-9 min-w-10 px-3`),
                    ...
                    children: (0, u.jsx)(`span`, {
                      className: o(
                        ...
                        _.active && `bg-token-text-link-foreground px-3 py-1 text-white`,
                        !_.active && `p-1`,
                      ),
                      children: _.label,
                    }),
              ...
              (0, u.jsx)(`a`, {
                ...
                children: (0, u.jsx)(ee, { className: `icon-xs` }),
              }),
              (0, u.jsx)(`button`, {
                type: `button`,
                className: f,
                ...
                children: (0, u.jsx)(c, { className: `icon-sm` }),
              }),
            ],
          }),
          b == null
            ...
            : (0, u.jsx)(`button`, {
                type: `button`,
                className: o(f, `absolute top-1/2 left-3 z-10 -translate-y-1/2 p-0`),
                "aria-label": Le,
                onClick: (e) => {
                  (e.stopPropagation(), U());
                },
          ...
          y == null
            ...
            : (0, u.jsx)(`button`, {
                type: `button`,
                className: o(f, `absolute top-1/2 right-3 z-10 -translate-y-1/2 p-0`),
                "aria-label": Re,
                onClick: (e) => {
                  (e.stopPropagation(), W());
                },
          ...
          (0, u.jsxs)(`div`, {
            ...
            children: [
              (0, u.jsx)(te, {
                asChild: !0,
                children: (0, u.jsx)(`h2`, { className: `sr-only`, children: N }),
              }),
              p ??
                (0, u.jsx)(
                  `img`,
