...
import { t as oe } from "./plus-d3DP-DMx.js";
var u = e(n(), 1),
  se = e(a(), 1),
  d = r(),
  ce = 200,
  f = `no-drag pointer-events-auto flex cursor-interaction items-center justify-center rounded-full bg-token-editor-background/95 text-token-foreground shadow-md ring-1 ring-black/5 backdrop-blur-sm transition-transform hover:bg-token-menu-background hover:ring-token-focus-border focus:outline-none focus-visible:ring-1 focus-visible:ring-token-focus-border active:scale-95 disabled:cursor-not-allowed disabled:opacity-50`,
  p = i(f, `h-10 min-w-10 px-3`);
function m({
  src: e,
  alt: t,
  caption: n,
  ...
  imageDecoding: ye,
  imageDraggable: be,
  imageFetchPriority: xe,
  imageLoading: Se,
  imageReferrerPolicy: Ce,
  onCloseAutoFocus: we,
  onImageError: Te,
  onNextImage: x,
  onPreviousImage: S,
  portalContainer: Ee,
  showZoomControls: De = !0,
}) {
  let C = o(),
    [w, Oe] = (0, u.useState)(null),
    [ke, T] = (0, u.useState)(null),
    [E, D] = (0, u.useState)(null),
    [O, Ae] = (0, u.useState)(null),
    k = (0, u.useRef)(null),
    A = (0, u.useRef)(null),
    j = (0, u.useRef)(null),
    ...
    I = O?.src === e ? O : null,
    L = ue({ naturalSize: I, previewViewportSize: ke }),
    R = (E?.src === e ? E.zoomPercent : null) ?? L,
    z = fe(L),
    B = z[0] ?? R,
    V = z.at(-1) ?? R,
    Le = R == null ? null : C.formatNumber(R / 100, { style: `percent`, maximumFractionDigits: 0 }),
    H = ge(e, t),
    Re = R != null && B != null && R > B,
    ze = R != null && V != null && R < V,
    U = n?.trim() || null,
    Be = S != null || x != null,
    W = () => {
      (M.current.clear(), (N.current = null), (P.current = null), D(null));
    },
    G = () => {
      S != null && (W(), S());
    },
    ...
    q = (0, u.useCallback)((e) => {
      ...
      T((e) => (e?.width === t && e.height === n ? e : { width: t, height: n }));
    }, []),
    J = (0, u.useCallback)(
      (t) => {
        let n = le(t);
        return n == null ? !1 : (w != null && q(w), Ae({ src: e, ...n }), !0);
      },
      [w, e, q],
    ),
    Y = (0, u.useCallback)(
  ...
  if (R != null && I != null) {
    let e = R / 100;
    X = { width: `${I.width * e}px`, height: `${I.height * e}px` };
  }
  let Z = ({ clientX: t, clientY: n, zoomPercent: r }) => {
      let i = k.current;
      if (w == null || i == null) {
        D({ src: e, zoomPercent: r });
        return;
      }
      let a = i.getBoundingClientRect(),
        o = a.width > 0 ? he((t - a.left) / a.width) : 0.5,
        s = a.height > 0 ? he((n - a.top) / a.height) : 0.5;
      if (
        ((0, se.flushSync)(() => {
          D({ src: e, zoomPercent: r });
        }),
        !w.isConnected || !i.isConnected)
      )
        return;
      let c = i.getBoundingClientRect();
      ((w.scrollLeft += c.left + c.width * o - t), (w.scrollTop += c.top + c.height * s - n));
    },
    Ue = (t) => {
      if (w == null) {
        D({ src: e, zoomPercent: t });
        return;
      }
      let n = w.getBoundingClientRect();
      Z({ clientX: n.left + n.width / 2, clientY: n.top + n.height / 2, zoomPercent: t });
    },
    Q = (e) => {
      R != null && Ue(de({ currentZoomPercent: R, direction: e, zoomRamp: z }));
    },
    We = () => {
      (D(null), w != null && ((w.scrollLeft = 0), (w.scrollTop = 0)));
    },
    Ge = l((e) => {
      switch (e.type) {
        case `step-zoom`:
    ...
    $ = l((e) => {
      if (!e.ctrlKey || R == null) return;
      (e.preventDefault(), e.stopPropagation());
      let t = h({
        maximumZoomPercent: V,
        minimumZoomPercent: B,
        zoomPercent: R * Math.exp(-pe(e) / ce),
      });
      if (t == null || t === R) return;
      let n = me({ event: e, fallbackPoint: j.current, previewViewportNode: w });
      Z({ clientX: n.clientX, clientY: n.clientY, zoomPercent: t });
    }),
    Ke = (0, u.useCallback)(
      (e) => {
        let t = A.current;
        if (t !== e) {
          if ((t?.removeEventListener(`wheel`, $), (A.current = e), Oe(e), e == null)) {
            T(null);
            return;
          }
          (e.addEventListener(`wheel`, $, { passive: !1 }), q(e));
        }
      },
      [$, q],
    ),
    qe = (e) => {
      if (((j.current = { clientX: e.clientX, clientY: e.clientY }), e.pointerType !== `touch`))
        return;
      if (
        (typeof e.currentTarget.setPointerCapture == `function` &&
          e.currentTarget.setPointerCapture(e.pointerId),
        M.current.set(e.pointerId, { clientX: e.clientX, clientY: e.clientY }),
        M.current.size === 1 && w != null)
      ) {
        N.current = {
      ...
      N.current = null;
      let t = _(M.current);
      P.current = t == null || R == null ? null : { distance: t.distance, zoomPercent: R };
    },
    Je = (e) => {
      if (
        ((j.current = { clientX: e.clientX, clientY: e.clientY }),
        e.pointerType === `touch` && M.current.has(e.pointerId))
      ) {
        if (
          (M.current.set(e.pointerId, { clientX: e.clientX, clientY: e.clientY }),
          M.current.size > 1)
        ) {
          (e.preventDefault(), e.stopPropagation(), (N.current = null));
          let t = P.current,
            n = _(M.current);
          ...
          Z({ clientX: n.clientX, clientY: n.clientY, zoomPercent: r });
          return;
        }
        w == null ||
          N.current == null ||
          (N.current.pointerId === e.pointerId &&
            (e.preventDefault(),
            e.stopPropagation(),
            (w.scrollLeft = N.current.scrollLeft - (e.clientX - N.current.clientX)),
            (w.scrollTop = N.current.scrollTop - (e.clientY - N.current.clientY))));
      }
    },
    Ye = (e) => {
      if (e.pointerType !== `touch`) return;
      if (
        (M.current.delete(e.pointerId),
      ...
      let t = M.current.entries().next().value;
      if (M.current.size === 1 && t != null) {
        let [e, n] = t;
        ((N.current =
          w == null
            ? null
      ...
      let n = _(M.current);
      ((N.current = null),
        (P.current = n == null || R == null ? null : { distance: n.distance, zoomPercent: R }));
    };
  return (
    (0, u.useEffect)(() => {
      if (!r) return;
    ...
    (0, u.useEffect)(() => {
      if (w == null || (q(w), typeof ResizeObserver > `u`)) return;
    ...
    (0, d.jsx)(te, {
      ...
      overlayClassName: i(`!bg-black/90`, y && `!animate-none`),
      portalContainer: Ee,
      showDialogClose: !1,
      triggerContent: g,
      contentProps: {
        ...
        onKeyDown: (e) => {
          e.defaultPrevented ||
            (e.key === `ArrowLeft` && S != null && (e.preventDefault(), e.stopPropagation(), G()),
            e.key === `ArrowRight` && x != null && (e.preventDefault(), e.stopPropagation(), Ve()));
        },
        onCloseAutoFocus: we,
      },
      children: (0, d.jsxs)(`div`, {
        className: i(
          ...
          Be ? `px-16 sm:px-20` : `px-4 sm:px-8`,
        ),
        onPointerDown: (e) => {
          e.target === e.currentTarget && K(!1);
        },
          ...
          (0, d.jsxs)(`div`, {
            ...
            children: [
              v == null
                ...
                : (0, d.jsx)(`button`, {
                    type: `button`,
                    className: i(f, `relative`, v.active ? `h-9 min-w-0 p-1` : `h-9 min-w-10 px-3`),
              ...
              (0, d.jsx)(`a`, {
                ...
                children: (0, d.jsx)(c, { className: `icon-xs` }),
              }),
              (0, d.jsx)(`button`, {
                type: `button`,
                className: p,
                ...
                children: (0, d.jsx)(s, { className: `icon-sm` }),
              }),
            ],
          }),
          S == null
            ...
            : (0, d.jsx)(`button`, {
                type: `button`,
                className: i(p, `absolute top-1/2 left-3 z-10 -translate-y-1/2 p-0`),
                "aria-label": Fe,
                onClick: (e) => {
                  (e.stopPropagation(), G());
                },
                ...
                children: (0, d.jsx)(ne, { className: `icon-sm` }),
              }),
          x == null
            ? null
            : (0, d.jsx)(`button`, {
                type: `button`,
                className: i(p, `absolute top-1/2 right-3 z-10 -translate-y-1/2 p-0`),
                "aria-label": Ie,
                onClick: (e) => {
                ...
                children: (0, d.jsx)(ne, { className: `icon-sm rotate-180` }),
              }),
          (0, d.jsxs)(`div`, {
            ref: Ke,
            ...
            onPointerCancelCapture: Ye,
            onPointerDownCapture: qe,
            onPointerMoveCapture: Je,
            onPointerUpCapture: Ye,
            onPointerDown: (e) => {
              e.target === e.currentTarget && K(!1);
            },
            children: [
              (0, d.jsx)(ee, {
                asChild: !0,
                children: (0, d.jsx)(`h2`, { className: `sr-only`, children: F }),
              }),
              m ??
                (0, d.jsx)(
                  `img`,
                  {
                    ...
                    className: i(
                      ...
                      X == null ? `max-h-full max-w-full` : `block max-w-none`,
                    ),
                    style: X,
                    decoding: ye,
                    draggable: be,
                ...
                ? (0, d.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, d.jsx)(`button`, {
                        ...
                        children: (0, d.jsx)(oe, { className: `icon-xs` }),
                      }),
                    ],
                  })
                : null,
...
function de({ currentZoomPercent: e, direction: t, zoomRamp: n }) {
  if (t === `in`) {
...
function me({ event: e, fallbackPoint: t, previewViewportNode: n }) {
