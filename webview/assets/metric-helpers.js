...
function v(e, r) {
  var i = _(e),
    a = n(n([], r, !0), i, !0).reduce(function (e, n) {
      var r;
      return t(t({}, e), ((r = {}), (r[n.id] = n), r));
    }, {});
...
function b(e, n) {
  var r = y(e);
  C.setItem(e, JSON.stringify(t(t({}, r), n)));
}
function x(e) {
  C.removeItem(e);
}
...
function k(e, n) {
  var r = Object.entries(n.integrations ?? {}).reduce(function (e, n) {
    var r,
      i,
      a = n[0],
      o = n[1];
  ...
  return Object.entries(e.integrations).reduce(function (e, n) {
    var i,
      a = n[0],
      o = n[1];
    return t(t({}, e), ((i = {}), (i[a] = t(t({}, o), r[a])), i));
  }, {});
}
var A = e(() => {
  i();
