...
import { a, f as o, p as s } from "./middleware.js";
import { l as c } from "./load-script-CGHs-PpL.js";
var l = function () {
    var e,
      t,
      n = !1,
    ...
    return (
      (t.prototype.push = function () {
        ...
        var r = t.map(function (t) {
          return e.updateAttempts(t) > e.maxAttempts || e.includes(t) ? !1 : (e.queue.push(t), !0);
        });
        return (
      ...
      (t.prototype.pushWithBackoff = function (e, t) {
        var n = this;
        if ((t === void 0 && (t = 0), t == 0 && this.getAttempts(e) === 0)) return this.push(e)[0];
...
var y = { getItem: function () {}, setItem: function () {}, removeItem: function () {} };
try {
