...
function h(e) {
  ...
  t[6] === b
    ? (w = t[7])
    : ((w = (0, _.jsx)(l, {
        children: (0, _.jsx)(f, { title: b, subtitle: C, subtitleClassName: `mt-2` }),
      })),
      (t[6] = b),
      (t[7] = w));
  let T;
  ...
  let j;
  t[19] !== r || t[20] !== k
    ? ((j = (0, _.jsx)(s, { color: `danger`, loading: r, onClick: k, children: A })),
      (t[19] = r),
      (t[20] = k),
      (t[21] = j))
    : (j = t[21]);
  ...
  t[22] !== j || t[23] !== D || t[24] !== O
    ? ((M = (0, _.jsx)(l, { children: (0, _.jsxs)(u, { children: [D, O, j] }) })),
      (t[22] = j),
      (t[23] = D),
      (t[24] = O),
      (t[25] = M))
  ...
  return (
    t[30] !== p || t[31] !== h || t[32] !== N
      ? ((P = (0, _.jsx)(d, { open: h, contentProps: x, onOpenChange: p, children: N })),
        (t[30] = p),
        (t[31] = h),
        (t[32] = N),
        (t[33] = P))
