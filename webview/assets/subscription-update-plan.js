...
function N(e) {
  ...
  if (p.kind === `saved_card_upgrade`) {
    ...
    t[29] === g
      ? (_ = t[30])
      : ((_ = d(`flex justify-between gap-4 font-semibold`, g)), (t[29] = g), (t[30] = _));
    let v;
  ...
  t[70] === b
    ? (k = t[71])
    : ((k = (0, I.jsx)(y, { children: (0, I.jsx)(S, { title: O, subtitle: b }) })),
      (t[70] = b),
      (t[71] = k));
  let A;
  t[72] === w ? (A = t[73]) : ((A = (0, I.jsx)(y, { children: w })), (t[72] = w), (t[73] = A));
  let j;
  ...
  let L;
  t[82] !== T || t[83] !== n
    ? ((L = (0, I.jsx)(a, { color: `primary`, loading: n, type: `submit`, children: T })),
      (t[82] = T),
      (t[83] = n),
      (t[84] = L))
    : (L = t[84]);
  ...
  t[85] !== M || t[86] !== N || t[87] !== L
    ? ((R = (0, I.jsx)(y, { children: (0, I.jsxs)(x, { children: [M, N, L] }) })),
      (t[85] = M),
      (t[86] = N),
      (t[87] = L),
      (t[88] = R))
