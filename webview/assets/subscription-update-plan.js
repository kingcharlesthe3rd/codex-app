...
import { n as E, r as D } from "./plan-pricing-BL-ew2t5.js";
function O(e) {
  let t = (0, k.c)(18),
    { ariaLabel: r, className: a, options: o, selectedId: s, onSelect: c } = e,
    l = (0, A.useId)(),
    u;
  t[0] === a
    ? (u = t[1])
    : ((u = i(`bg-token-foreground/10 inline-grid gap-1 rounded-2xl p-1`, a)),
      (t[0] = a),
      (t[1] = u));
  let d = `repeat(${o.length}, minmax(0, 1fr))`,
    f;
  t[2] === d ? (f = t[3]) : ((f = { gridTemplateColumns: d }), (t[2] = d), (t[3] = f));
  let p;
  if (t[4] !== l || t[5] !== c || t[6] !== o || t[7] !== s) {
    let e;
    (t[9] !== l || t[10] !== c || t[11] !== s
      ? ((e = (e) => {
          let t = e.id === s;
...
function N(e) {
  ...
  let y = _,
    ...
    w,
    T;
  if (f.kind === `saved_card_upgrade`) {
    let e;
    bb0: switch (f.updatedPlan) {
    ...
    let n;
    if (t[2] !== f.paymentMethod.card_brand || t[3] !== f.paymentMethod.card_last4) {
      let e = f.paymentMethod.card_brand?.trim() ?? ``,
        r;
      t[5] === f.paymentMethod.card_last4
        ? (r = t[6])
        : ((r = f.paymentMethod.card_last4?.trim() ?? ``),
          (t[5] = f.paymentMethod.card_last4),
          (t[6] = r));
      let i = r;
      ((n = e),
        e && i ? (n = `${e.toUpperCase()} *${i}`) : i && (n = `*${i}`),
        (t[2] = f.paymentMethod.card_brand),
        (t[3] = f.paymentMethod.card_last4),
        (t[4] = n));
    } else n = t[4];
    let r;
    (t[7] === e
    ...
    t[14] !== f.minorUnitExponent
      ? ((o = P(m, g.positive_line_item_total, g.currency, f.minorUnitExponent)),
        (t[11] = m),
        (t[12] = g.currency),
        (t[13] = g.positive_line_item_total),
        (t[14] = f.minorUnitExponent),
    ...
    t[27] !== f.minorUnitExponent
      ? ((d =
                ...
                children: [
                  ...
                  (0, I.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, I.jsx)(`span`, {
                        children: P(m, g.amount_due.tax_amount, g.currency, f.minorUnitExponent),
                      }),
                    ],
                  }),
                ],
        ...
        (t[28] = d))
      : (d = t[28]);
    let p = g.amount_due.tax_amount > 0 && `mt-2`,
      h;
    t[29] === p
      ? (h = t[30])
      : ((h = i(`flex justify-between gap-4 font-semibold`, p)), (t[29] = p), (t[30] = h));
    let _;
    ...
    t[34] !== g.currency ||
    t[35] !== f.minorUnitExponent
      ? ((v = P(m, g.amount_due.amount, g.currency, f.minorUnitExponent)),
        (t[32] = m),
        (t[33] = g.amount_due.amount),
        (t[34] = g.currency),
        (t[35] = f.minorUnitExponent),
  ...
  t[70] === C
    ? (k = t[71])
    : ((k = (0, I.jsx)(s, { children: (0, I.jsx)(c, { title: O, subtitle: C }) })),
      (t[70] = C),
      (t[71] = k));
  let A;
  t[72] === w ? (A = t[73]) : ((A = (0, I.jsx)(s, { children: w })), (t[72] = w), (t[73] = A));
  let j;
  ...
  t[75] !== n || t[76] !== r
    ...
    : (M = t[77]);
  let N;
  t[78] !== n || t[79] !== l || t[80] !== f.kind
    ? ((N =
        f.kind === `scheduled_downgrade`
          ? (0, I.jsx)(o, {
              color: `secondary`,
              disabled: n,
              type: `button`,
  ...
  let L;
  t[82] !== T || t[83] !== n
    ? ((L = (0, I.jsx)(o, { color: `primary`, loading: n, type: `submit`, children: T })),
      (t[82] = T),
      (t[83] = n),
      (t[84] = L))
    : (L = t[84]);
  ...
  t[85] !== M || t[86] !== N || t[87] !== L
    ? ((R = (0, I.jsx)(s, { children: (0, I.jsxs)(p, { children: [M, N, L] }) })),
      (t[85] = M),
      (t[86] = N),
      (t[87] = L),
      (t[88] = R))
  ...
  t[89] !== y || t[90] !== R || t[91] !== k || t[92] !== A
    ? ((z = (0, I.jsxs)(S, { as: `form`, onSubmit: y, children: [k, A, R] })),
      (t[89] = y),
      (t[90] = R),
      (t[91] = k),
      (t[92] = A),
