...
import { t as o } from "./channel-2.js";
import {
  B as s,
  C as c,
  H as l,
...
import "./dist-5.js";
import "./chunk-5.js";
import { t as v } from "./chunk-84.js";
import "./chunk-4.js";
import "./chunk-72.js";
import { t as ee } from "./chunk-36.js";
import { t as te } from "./chunk-12.js";
import "./chunk-3.js";
import { o as ne } from "./chunk-98.js";
import "./chunk-120.js";
import { r as y, t as b } from "./chunk-111.js";
import { n as x, t as S } from "./chunk-10.js";
var C = `flowchart-`,
  w = class {
    constructor() {
    ...
    addSingleLink(e, n, r, a) {
      ...
      if (
        (s !== void 0 &&
          ...
          (o.labelType = s.type)),
        r !== void 0 &&
          ((o.type = r.type), (o.stroke = r.stroke), (o.length = r.length > 10 ? 10 : r.length)),
...
You have to call mermaid.initialize.`);
    ...
    setLink(t, n, r) {
      (t.split(`,`).forEach((t) => {
        ...
        i !== void 0 && ((i.link = e.formatUrl(n, this.config)), (i.linkTarget = r));
      }),
    ...
    addSubGraph(e, t, n) {
      ...
      let s = r((e) => {
        ...
        u = p().flowchart ?? {};
      if (
        ((l ??= u.inheritDir ? (this.getDirection() ?? p().direction ?? void 0) : void 0),
        this.version === `gen-1`)
      )
      ...
      ((a ??= `subGraph` + this.subCount),
        ...
        (this.subCount += 1));
      let d = { id: a, nodes: c, title: o.trim(), classes: [], dir: l, labelType: n.type };
      return (
    ...
    destructStartLink(e) {
      ...
      let r = `normal`;
      return (
        t.includes(`=`) && (r = `thick`), t.includes(`.`) && (r = `dotted`), { type: n, stroke: r }
      );
    }
    countChar(e, t) {
      let n = t.length,
    ...
    getData() {
      ...
      return (
        s.forEach((n, i) => {
          let { arrowTypeStart: a, arrowTypeEnd: o } = this.destructEdgeType(n.type),
            c = [...(s.defaultStyle ?? [])];
  ...
  T = {
    ...
    draw: r(async function (t, r, a, o) {
      ...
      (e.insertTitle(m, `flowchartTitleText`, c?.titleTopMargin || 0, o.db.getDiagramTitle()),
      ...
      for (let e of f.nodes) {
        ...
        (i.setAttributeNS(`http://www.w3.org/2000/svg`, `class`, e.cssClasses),
          ...
          s === `sandbox`
            ...
            : e.linkTarget &&
              i.setAttributeNS(`http://www.w3.org/2000/svg`, `target`, e.linkTarget));
    ...
    var e = r(function (e, t, n, r) {
      ...
      nt = {
        ...
        table: [
          ...
          e(A, [2, 7]),
          e(A, [2, 8]),
          { 8: j, 9: M, 11: N, 21: 58, 41: 59, 72: 63, 75: [1, 64], 77: [1, 66], 78: [1, 65] },
          { 8: j, 9: M, 11: N, 21: 67 },
          { 8: j, 9: M, 11: N, 21: 68 },
          { 8: j, 9: M, 11: N, 21: 69 },
          { 8: j, 9: M, 11: N, 21: 70 },
          ...
          { 30: 180, 50: [1, 179], 67: R, 80: z, 81: B, 82: 171, 116: V, 117: H, 118: U },
          ...
          { 30: 186, 65: [1, 187], 67: R, 80: z, 81: B, 82: 171, 116: V, 117: H, 118: U },
          ...
          { 67: R, 69: [1, 230], 71: [1, 231], 82: 218, 116: V, 117: H, 118: U },
          { 67: R, 69: [1, 233], 71: [1, 232], 82: 218, 116: V, 117: H, 118: U },
          ...
          e(A, [2, 34]),
          e(ye, [2, 52]),
          { 10: G, 60: K, 84: q, 105: J, 107: 278, 108: 242, 109: Y, 110: X, 111: Z, 112: Q },
          e($, [2, 133]),
          {
            14: ce,
            44: le,
        ...
        parse: r(function (e) {
          ...
          for (var y, b, x, S, C, w = {}, T, E, D, O; ; ) {
            if (
              ...
              var re = ``;
              for (T in ((O = []), s[x]))
                this.terminals_[T] && T > f && O.push(`'` + this.terminals_[T] + `'`);
              ((re = h.showPosition
                ? `Parse error on line ` +
                  (l + 1) +
                  `:
...
Expecting ` +
            ...
            if (S[0] instanceof Array && S.length > 1)
              throw Error(
                `Parse Error: multiple actions possible at state: ` + x + `, token: ` + y,
              );
            switch (S[0]) {
              case 1:
                (n.push(y),
              ...
              case 2:
                if (
                  ...
                  ee && (w._$.range = [o[o.length - (E || 1)].range[0], o[o.length - 1].range[1]]),
                  (C = this.performAction.apply(w, [c, u, l, g.yy, S[1], a, o].concat(m))),
                  C !== void 0)
                )
                  return C;
                (E &&
        ...
        conditions: {
          ...
          INITIAL: {
            rules: [
              ...
              77, 80, 82, 84, 85, 86, 88, 90, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105,
