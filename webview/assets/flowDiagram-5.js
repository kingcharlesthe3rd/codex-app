...
import { c as i, l as a, t as o } from "./dist-1.js";
import {
  B as s,
  C as c,
  U as l,
...
import { n as h, t as ie } from "./src-1.js";
import { g, s as _, u as v } from "./chunk-123.js";
import { i as y } from "./chunk-88.js";
import { n as b, t as x } from "./chunk-76.js";
import { n as S } from "./chunk-83.js";
import { n as C } from "./chunk-61.js";
import { n as w, t as T } from "./chunk-22.js";
import { n as E, t as ae } from "./chunk-116.js";
import { n as oe } from "./chunk-51.js";
import { i as se, s as D } from "./chunk-89.js";
import { n as O } from "./chunk-117.js";
import { i as k, n as A, t as j } from "./chunk-106.js";
import { n as ce, r as le, t as ue } from "./chunk-105.js";
        ...
        if (
          ...
          t === void 0
            ...
            : ((this.config = f()),
              ...
              (d.labelType = t.type),
              u.startsWith(`"`) && u.endsWith(`"`) && (u = u.substring(1, u.length - 1)),
              (d.text = u)),
          n !== void 0 && (d.type = n),
          r?.forEach((e) => {
            d.styles.push(e);
          ...
          a !== void 0 && (d.dir = a),
          d.props === void 0 ? (d.props = o) : o !== void 0 && Object.assign(d.props, o),
          c !== void 0)
        ) {
          if (c.shape) {
            if (c.shape !== c.shape.toLowerCase() || c.shape.includes(`_`))
              throw Error(`No such shape: ${c.shape}. Shape names should be lowercase.`);
            if (!D(c.shape)) throw Error(`No such shape: ${c.shape}.`);
            d.type = c?.shape;
          }
          (c?.label && (d.text = c?.label),
            c?.icon && ((d.icon = c?.icon), !c.label?.trim() && d.text === e && (d.text = ``)),
            c?.form && (d.form = c?.form),
            c?.pos && (d.pos = c?.pos),
            c?.img && ((d.img = c?.img), !c.label?.trim() && d.text === e && (d.text = ``)),
      ...
      addSingleLink(e, n, r, i) {
        ...
        if (
          (o !== void 0 &&
            ...
            (a.labelType = o.type)),
          r !== void 0 &&
            ((a.type = r.type), (a.stroke = r.stroke), (a.length = r.length > 10 ? 10 : r.length)),
...
You have to call mermaid.initialize.`);
      ...
      addClass(e, t) {
        ...
        e.split(`,`).forEach((e) => {
          ...
          (t === void 0 && ((t = { id: e, styles: [], textStyles: [] }), this.classes.set(e, t)),
            n?.forEach((e) => {
              if (/color/.exec(e)) {
      ...
      setTooltip(e, t) {
        if (t !== void 0) {
          ...
          for (let n of e.split(`,`))
            this.tooltips.set(this.version === `gen-1` ? this.lookUpDomId(n) : n, t);
        }
      }
      setClickFun(e, t, n) {
      ...
      setLink(e, t, n) {
        (e.split(`,`).forEach((e) => {
          ...
          r !== void 0 && ((r.link = g.formatUrl(t, this.config)), (r.linkTarget = n));
        }),
      ...
      setupToolTips(e) {
        ...
        ((t._groups || t)[0][0] === null &&
          (t = h(`body`).append(`div`).attr(`class`, `mermaidTooltip`).style(`opacity`, 0)),
          h(e)
            .select(`svg`)
            .selectAll(`g.node`)
            .on(`mouseover`, (e) => {
      ...
      addSubGraph(e, r, i) {
        ...
        let s = n((e) => {
          ...
          u = f().flowchart ?? {};
        if (
          ((l ??= u.inheritDir ? (this.getDirection() ?? f().direction ?? void 0) : void 0),
          this.version === `gen-1`)
        )
        ...
        ((a ??= `subGraph` + this.subCount),
          ...
          (this.subCount += 1));
        let d = { id: a, nodes: c, title: o.trim(), classes: [], dir: l, labelType: i.type };
        return (
      ...
      indexNodes2(e, t) {
        ...
        if (((this.secCount += 1), this.secCount > 2e3)) return { result: !1, count: 0 };
      ...
      destructEndLink(e) {
        ...
        return (o && ((i = `dotted`), (a = o)), { type: r, stroke: i, length: a });
      }
      destructLink(e, t) {
        ...
        if (t) {
          ...
          return (
            r.type === `double_arrow` && (r.type = `double_arrow_point`), (r.length = n.length), r
          );
        }
        return n;
      }
      ...
      getData() {
        ...
        return (
          o.forEach((t, r) => {
            let { arrowTypeStart: i, arrowTypeEnd: a } = this.destructEdgeType(t.type),
              s = [...(o.defaultStyle ?? [])];
    ...
    (pe = {
      ...
      draw: n(async function (e, n, r, i) {
        ...
        (g.insertTitle(d, `flowchartTitleText`, o?.titleTopMargin || 0, i.db.getDiagramTitle()),
        ...
        for (let e of u.nodes) {
          ...
          (r.setAttributeNS(`http://www.w3.org/2000/svg`, `class`, e.cssClasses),
            r.setAttributeNS(`http://www.w3.org/2000/svg`, `rel`, `noopener`),
            a === `sandbox`
              ? r.setAttributeNS(`http://www.w3.org/2000/svg`, `target`, `_top`)
              : e.linkTarget &&
                r.setAttributeNS(`http://www.w3.org/2000/svg`, `target`, e.linkTarget));
    ...
    (M = (function () {
      var e = n(function (e, t, n, r) {
        ...
        ye = [8, 9, 11, 44, 60, 75, 77, 78, 89, 102, 105, 106, 109, 111, 114, 115, 116],
        ...
        nt = {
            ...
            switch (i) {
              ...
              case 45:
                (r.addVertex(
                  ...
                  (this.$ = { stmt: a[s - 1], nodes: a[s - 1].concat(a[s - 3].nodes) }));
                break;
              case 46:
              ...
              case 49:
                (r.addVertex(
                  ...
                  (this.$ = { stmt: a[s - 1], nodes: a[s - 1], shapeData: a[s] }));
                break;
              case 50:
              ...
              case 77:
                ...
                this.$ = { type: c.type, stroke: c.stroke, length: c.length, text: a[s - 1] };
                break;
              case 78:
                var c = r.destructLink(a[s], a[s - 2]);
                this.$ = {
              ...
              case 84:
                var c = r.destructLink(a[s]);
                this.$ = { type: c.type, stroke: c.stroke, length: c.length, id: a[s - 1] };
                break;
              case 85:
                this.$ = a[s - 1];
                break;
          ...
          table: [
            ...
            e(O, [2, 7]),
            e(O, [2, 8]),
            { 8: k, 9: A, 11: j, 21: 58, 41: 59, 72: 63, 75: [1, 64], 77: [1, 66], 78: [1, 65] },
            { 8: k, 9: A, 11: j, 21: 67 },
            { 8: k, 9: A, 11: j, 21: 68 },
            { 8: k, 9: A, 11: j, 21: 69 },
            { 8: k, 9: A, 11: j, 21: 70 },
            ...
            { 30: 180, 50: [1, 179], 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            ...
            { 30: 186, 65: [1, 187], 67: z, 80: B, 81: V, 82: 171, 116: H, 117: U, 118: W },
            ...
            { 67: z, 69: [1, 230], 71: [1, 231], 82: 218, 116: H, 117: U, 118: W },
            { 67: z, 69: [1, 233], 71: [1, 232], 82: 218, 116: H, 117: U, 118: W },
            ...
            e(O, [2, 34]),
            e(ve, [2, 52]),
            { 10: K, 60: q, 84: J, 105: Y, 107: 278, 108: 242, 109: X, 110: Z, 111: $e, 112: Q },
            e($, [2, 133]),
            {
              14: ue,
              44: de,
          ...
          parse: n(function (e) {
            ...
            for (var ne in this.yy)
              Object.prototype.hasOwnProperty.call(this.yy, ne) && (m.yy[ne] = this.yy[ne]);
            (p.setInput(e, m.yy),
              (m.yy.lexer = p),
              (m.yy.parser = this),
            ...
            for (var _, v, y, b, x, S = {}, C, w, T, E; ; ) {
              if (
                ...
                var ae = ``;
                for (C in ((E = []), s[y]))
                  this.terminals_[C] && C > ee && E.push(`'` + this.terminals_[C] + `'`);
                ((ae = p.showPosition
                  ? `Parse error on line ` +
                    (l + 1) +
                    `:
...
Expecting ` +
                  ...
                  : `Parse error on line ` +
                    (l + 1) +
                    `: Unexpected ` +
                    (_ == te ? `end of input` : `'` + (this.terminals_[_] || _) + `'`)),
                  this.parseError(ae, {
                    text: p.match,
              ...
              if (b[0] instanceof Array && b.length > 1)
                throw Error(
                  `Parse Error: multiple actions possible at state: ` + y + `, token: ` + _,
                );
              switch (b[0]) {
                case 1:
                  (r.push(_),
                ...
                case 2:
                  if (
                    ...
                    h && (S._$.range = [o[o.length - (w || 1)].range[0], o[o.length - 1].range[1]]),
                    (x = this.performAction.apply(S, [c, u, l, m.yy, b[1], a, o].concat(f))),
                    x !== void 0)
                  )
                    return x;
                  (w &&
...
//# sourceMappingURL=flowDiagram-5.js.map
