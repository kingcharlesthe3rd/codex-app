import { $s as e, ec as t, qs as n } from "./app-server-manager-signals.js";
...
function d() {
  ...
  t[0] === i
    ...
    : ((a = (e) => {
        ...
        return (i((e) => ({ activeOperationId: null, operations: [...e.operations, t] })), t);
      }),
      (t[0] = i),
      (t[1] = a));
  let c = a,
  ...
  t[4] === i
    ? (d = t[5])
    : ((d = (e, t) => {
        i((r) => ({ ...r, operations: r.operations.map((r) => (r.id === e ? n(r, t) : r)) }));
      }),
      (t[4] = i),
      (t[5] = d));
  let m = d,
  ...
  let b = y,
    x;
  return (
    t[12] !== u || t[13] !== c || t[14] !== b || t[15] !== v || t[16] !== g || t[17] !== m
      ? ((x = {
