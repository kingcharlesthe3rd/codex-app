...
import { Bt as s, K as c, r as l } from "./use-host-config.js";
import { Aa as u, Oa as d, na as f, u as p } from "./thread-context-inputs.js";
import { A as m, _ as h, c as g, n as _, r as v, u as y, v as b } from "./vscode-api.js";
import "./isEqual.js";
import { ai as x, jr as S } from "./src.js";
import "./react-dom.js";
import { i as C, l as w, s as T } from "./lib-1.js";
import "./proxy.js";
...
import "./x.js";
import { D as A } from "./rpc.js";
import "./statsig.js";
import { t as j } from "./request.js";
import "./chevron.js";
import { t as M } from "./clock-Cid-cc8u.js";
...
import { t as F } from "./folder.js";
import { a as I, i as L, l as R, n as z, r as B } from "./dialog-layout.js";
import { a as V, f as H, o as ee } from "./sidebar-project-group-signals.js";
import "./sidebar-project-groups.js";
import "./_defineProperty.js";
import "./initial-route-atom.js";
import { t as te } from "./use-navigate-to-local-conversation.js";
import "./links.js";
import { t as ne } from "./chat.js";
import { r as U, s as re, t as ie } from "./dropdown.js";
import "./three-dots.js";
import { t as ae } from "./cloud.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { n as oe, r as se } from "./settings-host-context.js";
import { t as W } from "./get-project-name.js";
import { t as ce } from "./trash-DL-ar7Ww.js";
import { i as le, t as G } from "./settings-shared.js";
import { t as ue } from "./settings-content-layout.js";
import { t as de } from "./more-menu-trigger.js";
import { r as fe } from "./settings-row.js";
import { t as pe } from "./settings-surface.js";
import { t as me } from "./settings-group.js";
import { t as he } from "./infinite-scroll-pagination-spinner.js";
import { t as ge } from "./filter.js";
import { t as K } from "./control-group.js";
var q = r(),
  _e = e(t(), 1),
  J = C({
    delete: {
...
function xe({
  ...
  return [
    ...(t ?? []).map((e) => {
      let t = c(e.title ?? ``).trim(),
        n = e.task_status_display?.environment_label?.trim() ?? ``,
        o = W(n),
        s = Te({ assignment: a?.[e.id], projects: r });
      return {
        kind: `cloud`,
        createdAt: Y(e.created_at, e.updated_at),
        filterGroupId: i.has(e.id) ? ye : (s?.groupId ?? `special:none`),
        projectId: o == null ? null : n,
        projectLabel: o,
        searchValues: [t, o ?? ``, n],
        task: e,
        title: t,
        updatedAt: Y(e.updated_at, e.created_at),
      };
    }),
    ...(n ?? []).map((t) => {
      let n = c(t.name?.trim() || t.preview).trim(),
        s = W(t.cwd),
        l = W(t.path),
        u = s ?? l,
        d = Te({ assignment: a?.[t.id], fallbackPaths: [o?.[t.id], t.cwd], projects: r });
      return {
        kind: `local`,
        createdAt: Y(t.createdAt, t.updatedAt),
        filterGroupId: e.has(t.id) ? ve : i.has(t.id) ? ye : (d?.groupId ?? `special:none`),
        projectId: s == null ? (l == null ? null : t.path) : t.cwd,
        projectLabel: u,
        searchValues: [n, u ?? ``],
        thread: t,
        title: n,
        updatedAt: Y(t.updatedAt, t.createdAt),
      };
    }),
  ].sort((e, t) => t.updatedAt - e.updatedAt);
}
function Se(e) {
  let t = new P(e, { ignoreLocation: !0, keys: [`searchValues`], threshold: 0.4 });
  return (n) => {
    let r = n.trim();
...
function Ce({
  ...
  if (t === `none`)
    return o.length === 0
      ? []
      : [{ id: `all`, projectLabel: null, entries: [...o].sort((e, t) => Ee(e, t, a)) }];
  let s = new Map();
  for (let e of o) {
    let t = e.projectId ?? ``,
      n = s.get(t);
  ...
  let c = [...s.values()];
  for (let e of c) e.entries.sort((e, t) => Ee(e, t, a));
  return c.sort((e, t) => {
    if (a === `alphabetical`) {
...
function Te({ assignment: e, fallbackPaths: t = [], projects: n }) {
  if (e != null) {
    let t = n.find((t) =>
  ...
  for (let e of t) {
    ...
    let t = S(e).replace(/\/+$/, ``),
      r = n.filter(
        (e) => e.projectKind === `local` && e.path != null && S(e.path).replace(/\/+$/, ``) === t,
      );
...
function De(e, t) {
  let n = 0;
  for (let r of e.entries) n = Math.max(n, X(r, t));
  return n;
}
var Z = n();
function Q(e) {
  ...
  t[0] === n.id
    ...
    : ((d = [`recover-cloud-task`, n.id]),
      (f = () =>
        j.safePost(`/wham/tasks/{task_id}/recover`, { parameters: { path: { task_id: n.id } } })),
      (t[0] = n.id),
      (t[1] = d),
      (t[2] = f));
  let p;
  t[3] !== l || t[4] !== a
    ? ((p = () => {
        a.get(k).danger(l.formatMessage(J.unarchiveError));
      }),
      (t[3] = l),
      (t[4] = a),
      (t[5] = p))
    ...
    ? ((g = () => {
        (s.setQueryData([`tasks`, `archived`], (e) =>
          ...
          a.get(k).info(
            (0, Z.jsxs)(`span`, {
              children: [
                (0, Z.jsx)(T, { ...J.unarchiveSuccessPlain }),
                (0, Z.jsx)(`button`, {
  ...
  t[11] === s
    ...
    : ((_ = () => {
      ...
      (t[12] = _));
  let v;
  t[13] !== d || t[14] !== f || t[15] !== p || t[16] !== g || t[17] !== _
    ? ((v = { mutationKey: d, mutationFn: f, onError: p, onSuccess: g, onSettled: _ }),
      (t[13] = d),
      (t[14] = f),
      (t[15] = p),
      (t[16] = g),
  ...
  let y = h(v),
    b;
  t[19] === n.title ? (b = t[20]) : ((b = c(n.title ?? ``).trim()), (t[19] = n.title), (t[20] = b));
  let x = b,
    S,
    C,
    D,
    O;
  if (t[21] !== n || t[22] !== l || t[23] !== r) {
    let e = Oe(n),
      i;
    (t[28] !== n.task_status_display?.environment_label || t[29] !== r
      ...
      (C = i),
      (D = e != null),
      (S = D ? l.formatDate(e, { year: `numeric`, month: `short`, day: `numeric` }) : ``),
      (O = D ? l.formatTime(e, { hour: `numeric`, minute: `2-digit` }) : ``),
      (t[21] = n),
      (t[22] = l),
      (t[23] = r),
      (t[24] = S),
      ...
      (t[26] = D),
      (t[27] = O));
  } else ((S = t[24]), (C = t[25]), (D = t[26]), (O = t[27]));
  let A = O,
    M;
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, Z.jsx)(ae, { className: `icon-sm shrink-0` })), (t[31] = M))
    : (M = t[31]);
  let P;
  t[32] === x
    ? (P = t[33])
  ...
  t[34] === P
    ...
    : ((F = (0, Z.jsxs)(`div`, {
        ...
        children: [M, (0, Z.jsx)(`span`, { className: `truncate`, children: P })],
      })),
      (t[34] = P),
      (t[35] = F));
  let I;
  t[36] !== S || t[37] !== C || t[38] !== D || t[39] !== A
    ? ((I = D
        ? C
          ? (0, Z.jsx)(T, {
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, Z.jsx)(T, { ...J.unarchive })), (t[48] = B))
    : (B = t[48]);
  let V;
  t[49] !== z || t[50] !== y.isPending
    ? ((V = (0, Z.jsx)(E, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
async function Pe(e) {
  try {
    return await j.safeGet(`/wham/tasks/list`, {
      parameters: { query: { limit: 20, cursor: e, task_filter: `archived` } },
    });
  } catch (e) {
    if (e instanceof g && (e.status === 401 || e.status === 403 || e.status === 404))
...
var $ = C({
    ...
    automations: {
      ...
      description: `Project filter option showing archived automation chats`,
    },
    type: {
...
function Le() {
  ...
  e[0] === t
    ...
    : ((c = {
      ...
      (e[0] = t),
      (e[1] = c));
  let { data: u, isLoading: d, isError: f } = b(c),
    {
      data: m,
      fetchNextPage: h,
      hasNextPage: g,
      isLoading: _,
      isFetchNextPageError: x,
      isFetchingNextPage: S,
      isError: C,
    } = ke(),
    w;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = v(`inbox-items`, { limit: Ie })), (e[2] = w))
    : (w = e[2]);
  let T = t === l,
    E;
  e[3] === T
    ? (E = e[4])
    : ((E = { queryKey: w, queryFn: Be, enabled: T, staleTime: y.FIVE_SECONDS }),
      (e[3] = T),
      (e[4] = E));
  let { data: D, isLoading: O } = b(E),
    k,
    A;
  if (
    e[5] !== D ||
    ...
    (e[18] === D?.items
      ? (c = e[19])
      : ((c = new Set(D?.items.flatMap(ze) ?? [])), (e[18] = D?.items), (e[19] = c)),
      (A = xe({
  ...
  let j = A,
    M;
  e[20] === k ? (M = e[21]) : ((M = k.map(Re)), (e[20] = k), (e[21] = M));
  let N = `${t}:${M.join(`,`)}`,
    P = g && !x,
    F = d || _ || (t === `local` && O),
    I = f || (m == null && C),
...
function Be() {
  return _(`inbox-items`, { params: { limit: Ie } });
}
function Ve(e) {
  let t = (0, q.c)(121),
    {
    ...
    b = N(),
    S = te(),
    [C, D] = (0, _e.useState)(null),
    [O, A] = (0, _e.useState)(``),
    [j, M] = (0, _e.useState)(`all`),
    [P, F] = (0, _e.useState)(Fe),
    [I, L] = (0, _e.useState)(`updated`),
    R = new Set([...r.map(Ge), ye, ve]),
    z = P.kind === `all` || R.has(P.groupId) ? P : Fe,
    B = z.kind === `all` ? `project` : `none`,
    V;
  t[0] !== z || t[1] !== n || t[2] !== j || t[3] !== O || t[4] !== I || t[5] !== B
    ? ((V = Ce({
        entries: n,
        groupKey: B,
        kindFilter: j,
  ...
  let H = V,
    ...
    ne;
  t[7] !== n || t[8] !== a
    ? ((ne = a === `local` && n.some(We)), (t[7] = n), (t[8] = a), (t[9] = ne))
    : (ne = t[9]);
  let U = ne,
    re;
  t[10] !== a || t[11] !== b || t[12] !== S || t[13] !== _
    ? ((re = (e) => {
        (x(e.id), a === `local` && S(e.id));
      }),
      (t[10] = a),
      (t[11] = b),
      (t[12] = S),
  ...
  t[15] === a
    ? ((ae = t[16]), (oe = t[17]))
    : ((ae = [`unarchive-thread`, a]),
      (oe = async (e) => (
        await s(`unarchive-conversation`, { hostId: a, conversationId: x(e.id) }),
        e
      )),
      (t[15] = a),
      (t[16] = ae),
  ...
  t[18] !== a || t[19] !== v || t[20] !== _
    ? ((se = async (e) => {
        (_.get(k).info(
          ...
          await v.cancelQueries({ queryKey: [`archived-threads`, a] }));
        let t = v.getQueryData([`archived-threads`, a]) ?? [];
        return (
          v.setQueryData(
            [`archived-threads`, a],
    ...
    : (se = t[21]);
  let W;
  t[22] !== a || t[23] !== y || t[24] !== v || t[25] !== _
    ? ((W = (e, t, n) => {
        let r = e instanceof f;
        (!r && n?.previousThreads && v.setQueryData([`archived-threads`, a], n.previousThreads),
          _.get(k).danger(y.formatMessage(r ? J.openError : J.unarchiveError), {
  ...
  t[30] !== a || t[31] !== v
    ? ((de = () => {
        v.invalidateQueries({ queryKey: [`archived-threads`, a] });
      }),
      (t[30] = a),
      (t[31] = v),
      (t[32] = de))
    : (de = t[32]);
  let ge;
  t[33] !== de || t[34] !== ae || t[35] !== oe || t[36] !== se || t[37] !== W || t[38] !== G
    ? ((ge = {
        mutationKey: ae,
        mutationFn: oe,
        onMutate: se,
  ...
  t[40] === a
    ? ((be = t[41]), (xe = t[42]))
    : ((be = [`delete-archived-conversations`, a]),
      (xe = async (e) =>
        e.kind === `all`
          ? s(`delete-all-archived-conversations`, { hostId: a })
          : e.kind === `project`
            ? (
                await Promise.all(
                  e.threadIds.map((e) =>
                    s(`delete-archived-conversation`, { hostId: a, conversationId: x(e) }),
                  ),
                )
              ).flat()
            : s(`delete-archived-conversation`, { hostId: a, conversationId: x(e.thread.id) })),
      (t[40] = a),
      (t[41] = be),
      (t[42] = xe));
  let Se;
  t[43] !== a || t[44] !== v || t[45] !== _
    ? ((Se = async (e) => {
        let t = e.kind === `single` ? [e.thread.id] : e.threadIds;
        (_.get(k).info(
          e.kind === `single`
            ? (0, Z.jsx)(T, { ...J.deleting })
            : (0, Z.jsx)(T, { ...J.deletingAll }),
          { id: et(e), duration: 0, hasCloseButton: !1 },
        ),
          await v.cancelQueries({ queryKey: [`archived-threads`, a] }));
        let n = v.getQueryData([`archived-threads`, a]) ?? [];
        return (
          v.setQueryData(
            [`archived-threads`, a],
    ...
    : (Se = t[46]);
  let Te;
  t[47] !== a || t[48] !== y || t[49] !== v || t[50] !== _
    ? ((Te = (e, t, n) => {
        (n?.previousThreads && v.setQueryData([`archived-threads`, a], n.previousThreads),
          _.get(k).danger(
            y.formatMessage(
              d(e, `thread/delete`)
                ? J.deleteUnsupported
  ...
  t[52] !== y || t[53] !== _
    ? ((Y = (e, t) => {
        ...
        _.get(k).success(y.formatMessage(J.deleteSuccessPlain), { id: et(t) });
      }),
      (t[52] = y),
      (t[53] = _),
      (t[54] = Y))
  ...
  t[55] !== a || t[56] !== v
    ...
    : (X = t[57]);
  let Ee;
  t[58] !== be || t[59] !== xe || t[60] !== Se || t[61] !== Te || t[62] !== Y || t[63] !== X
    ? ((Ee = {
        mutationKey: be,
        mutationFn: xe,
        onMutate: Se,
  ...
  if (l) {
    ...
    t[68] !== z || t[69] !== j || t[70] !== r || t[71] !== I
      ? ((e = (0, Z.jsx)(`div`, {
          ...
          children: (0, Z.jsx)(Ke, {
            ...
            projects: r,
            sortKey: I,
            onKindFilterChange: M,
            onProjectFilterChange: F,
    ...
    t[73] !== ee || t[74] !== u || t[75] !== H.length
      ...
      : (n = t[76]);
    let i;
    if (t[77] !== z.kind || t[78] !== Q || t[79] !== a || t[80] !== K || t[81] !== H) {
      let e;
      (t[83] !== z.kind || t[84] !== Q || t[85] !== a || t[86] !== K
        ? ((e = (e) =>
            (0, Z.jsx)(
              Ye,
              {
                ...
                hostId: a,
                isDeleteDisabled: Q,
                projectArchivedThreads: we(e.entries, e.id),
                unarchivingThreadId: K.variables?.id ?? null,
                isUnarchiving: K.isPending,
                showHeader: z.kind === `all`,
                onDelete: (e) => {
                  D({ kind: `single`, thread: e });
                },
                onUnarchive: (e) => {
                  K.mutate(e);
                },
                onDeleteProject: (e, t) => {
                  D({ kind: `project`, projectLabel: e, threads: t });
                },
              },
              e.id,
            )),
    ...
    t[88] === g
      ...
      : ((o = () => {
        ...
        (t[89] = o));
    let s;
    t[90] !== ee || t[91] !== u || t[92] !== o
      ? ((s = (0, Z.jsx)(he, { hasNextPage: ee, isFetchingNextPage: u, onLoadNextPage: o })),
        (t[90] = ee),
        (t[91] = u),
        (t[92] = o),
        (t[93] = s))
      : (s = t[93]);
    let c;
    t[94] !== n || t[95] !== i || t[96] !== s
      ? ((c = (0, Z.jsx)(`div`, {
          className: `min-h-0 flex-1 overflow-y-auto`,
          children: (0, Z.jsxs)(`div`, { className: `flex flex-col`, children: [n, i, s] }),
        })),
        (t[94] = n),
        (t[95] = i),
        (t[96] = s),
    ...
    let l;
    (t[98] !== e || t[99] !== c
      ? ((l = (0, Z.jsxs)(pe, { className: `max-h-[min(80vh)]`, children: [e, c] })),
        (t[98] = e),
        (t[99] = c),
        (t[100] = l))
      : (l = t[100]),
  ...
  t[101] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = (0, Z.jsx)(le, { slug: `data-controls` })), (t[101] = ke))
    : (ke = t[101]);
  let Ae;
  t[102] !== Q || t[103] !== U || t[104] !== p || t[105] !== l
    ? ((Ae =
        U && !l && !p
          ? (0, Z.jsxs)(E, {
              color: `danger`,
              ...
              children: [
                (0, Z.jsx)(ce, { className: `icon-xs shrink-0` }),
                (0, Z.jsx)(T, { ...J.deleteAll }),
              ],
            })
          : null),
      (t[102] = Q),
  ...
  t[107] === Oe
    ...
    : ((je = (0, Z.jsx)(me, {
        className: `gap-2`,
        children: (0, Z.jsx)(me.Content, { children: Oe }),
      })),
      (t[107] = Oe),
      (t[108] = je));
  let Me;
  t[109] !== n || t[110] !== De || t[111] !== C
    ? ((Me = () => {
        if (C != null) {
          if ((D(null), C.kind === `all`)) {
            De.mutate({ kind: `all`, threadIds: n.flatMap(Ue) });
            return;
          }
          if (C.kind === `project`) {
            De.mutate({
              ...
              threadIds: C.threads.map(He),
            });
            return;
          }
          De.mutate({ kind: `single`, thread: C.thread });
        }
      }),
      (t[109] = n),
      (t[110] = De),
  ...
  let Pe;
  t[114] !== C || t[115] !== Me
    ? ((Pe = (0, Z.jsx)(Ze, { state: C, onConfirm: Me, onOpenChange: Ne })),
      (t[114] = C),
      (t[115] = Me),
      (t[116] = Pe))
    : (Pe = t[116]);
...
function Ke(e) {
  ...
  t[17] !== s || t[18] !== r || t[19] !== i
    ? ((y = (0, Z.jsx)(Je, { projectFilter: r, projects: i, onProjectFilterChange: s })),
      (t[17] = s),
      (t[18] = r),
      (t[19] = i),
      (t[20] = y))
  ...
  let b;
  t[21] !== v || t[22] !== y
    ? ((b = (0, Z.jsxs)(K, { className: `shrink-0`, children: [v, y] })),
      (t[21] = v),
      (t[22] = y),
      (t[23] = b))
    : (b = t[23]);
...
function qe(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Z.jsx)(ge, { className: `icon-xs shrink-0` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === n ? (l = t[4]) : ((l = Qe(n)), (t[3] = n), (t[4] = l));
  let u;
  t[5] === l
    ? (u = t[6])
    : ((u = (0, Z.jsx)(`span`, { className: `truncate`, children: (0, Z.jsx)(T, { ...l }) })),
      (t[5] = l),
      (t[6] = u));
  let d;
  t[7] !== s || t[8] !== u
    ? ((d = (0, Z.jsxs)(G, { className: `w-[150px] md:w-36`, "aria-label": s, children: [c, u] })),
      (t[7] = s),
      (t[8] = u),
      (t[9] = d))
    : (d = t[9]);
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Z.jsx)(U.SectionLabel, { children: (0, Z.jsx)(T, { ...$.type }) })), (t[10] = f))
    : (f = t[10]);
  let p = n === `all` ? D : void 0,
    m;
  t[11] === i
    ? (m = t[12])
    : ((m = () => {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Z.jsx)(T, { ...$.allChats })), (t[13] = h))
    : (h = t[13]);
  let g;
  t[14] !== p || t[15] !== m
    ? ((g = (0, Z.jsx)(U.Item, { RightIcon: p, onSelect: m, children: h })),
      (t[14] = p),
      (t[15] = m),
      (t[16] = g))
    : (g = t[16]);
  let _ = n === `local` ? D : void 0,
    v;
  t[17] === i
    ? (v = t[18])
    : ((v = () => {
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, Z.jsx)(T, { ...$.local })), (t[19] = y))
    : (y = t[19]);
  let b;
  t[20] !== _ || t[21] !== v
    ? ((b = (0, Z.jsx)(U.Item, { RightIcon: _, onSelect: v, children: y })),
      (t[20] = _),
      (t[21] = v),
      (t[22] = b))
    : (b = t[22]);
  let x = n === `cloud` ? D : void 0,
    S;
  t[23] === i
    ? (S = t[24])
    : ((S = () => {
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (0, Z.jsx)(T, { ...$.cloud })), (t[25] = C))
    : (C = t[25]);
  let E;
  t[26] !== x || t[27] !== S
    ? ((E = (0, Z.jsx)(U.Item, { RightIcon: x, onSelect: S, children: C })),
      (t[26] = x),
      (t[27] = S),
      (t[28] = E))
    : (E = t[28]);
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, Z.jsx)(U.Separator, {})), (t[29] = O))
    : (O = t[29]);
  let k;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, Z.jsx)(U.SectionLabel, { children: (0, Z.jsx)(T, { ...$.sortBy }) })), (t[30] = k))
    : (k = t[30]);
  let A = r === `updated` ? D : void 0,
    j;
  t[31] === a
    ? (j = t[32])
    : ((j = () => {
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, Z.jsx)(T, { ...$.updated })), (t[33] = M))
    : (M = t[33]);
  let N;
  t[34] !== A || t[35] !== j
    ? ((N = (0, Z.jsx)(U.Item, { RightIcon: A, onSelect: j, children: M })),
      (t[34] = A),
      (t[35] = j),
      (t[36] = N))
    : (N = t[36]);
  let P = r === `created` ? D : void 0,
    F;
  t[37] === a
    ? (F = t[38])
    : ((F = () => {
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (0, Z.jsx)(T, { ...$.created })), (t[39] = I))
    : (I = t[39]);
  let L;
  t[40] !== P || t[41] !== F
    ? ((L = (0, Z.jsx)(U.Item, { RightIcon: P, onSelect: F, children: I })),
      (t[40] = P),
      (t[41] = F),
      (t[42] = L))
    : (L = t[42]);
  let R = r === `alphabetical` ? D : void 0,
    z;
  t[43] === a
    ? (z = t[44])
    : ((z = () => {
  ...
  t[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, Z.jsx)(T, { ...$.alphabetical })), (t[45] = B))
    : (B = t[45]);
  let V;
  t[46] !== R || t[47] !== z
    ? ((V = (0, Z.jsx)(U.Item, { RightIcon: R, onSelect: z, children: B })),
      (t[46] = R),
      (t[47] = z),
      (t[48] = V))
    : (V = t[48]);
...
function Je(e) {
  let t = (0, q.c)(54),
    ...
    p,
    m;
  if (t[0] !== a || t[1] !== i || t[2] !== n.groupId || t[3] !== n.kind || t[4] !== r) {
    let e = n.kind === `group` ? r.find((e) => e.groupId === n.groupId) : null,
      h = new Map();
    for (let e of r) {
      let t = h.get(e.label) ?? [];
      (t.push(e.path ?? e.projectId), h.set(e.label, t));
    }
    ((o = ie), (s = `bottom`), (c = `end`), (l = `workspace`), (u = `tall`));
    let g;
    t[14] === a
      ? (g = t[15])
      : ((g = a.formatMessage($.filterArchivedChatsByProject)), (t[14] = a), (t[15] = g));
    let _;
    t[16] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((_ = (0, Z.jsx)(F, { className: `icon-xs shrink-0` })), (t[16] = _))
      : (_ = t[16]);
    let v =
        n.kind === `all`
          ? (0, Z.jsx)(T, { ...$.allProjects })
          : n.groupId === `special:automations`
            ? (0, Z.jsx)(T, { ...$.automations })
    ...
    (t[17] === v
      ? (y = t[18])
      : ((y = (0, Z.jsx)(`span`, { className: `truncate`, children: v })),
        (t[17] = v),
        (t[18] = y)),
      t[19] !== y || t[20] !== g
        ? ((d = (0, Z.jsxs)(G, {
    ...
    (t[24] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((S = (0, Z.jsx)(T, { ...$.allProjects })), (t[24] = S))
      : (S = t[24]),
      t[25] !== b || t[26] !== x
        ? ((f = (0, Z.jsx)(U.Item, { RightIcon: b, onSelect: x, children: S })),
          (t[25] = b),
          (t[26] = x),
          (t[27] = f))
        : (f = t[27]),
      t[28] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((p = (0, Z.jsx)(U.Separator, {})), (t[28] = p))
        : (p = t[28]),
      (m = r.map((e) => {
        let t = h.get(e.label) ?? [],
          r = t.length > 1 ? A(e.path ?? e.projectId, t) : void 0,
          a = n.kind === `group` && n.groupId === e.groupId;
        return (0, Z.jsx)(
          U.Item,
          {
            LeftIcon: F,
            ...
            tooltipAlign: `center`,
            onSelect: () => {
              i({ kind: `group`, groupId: e.groupId });
            },
            children: $e(e.label),
          },
          e.groupId,
  ...
  let h;
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Z.jsx)(U.Separator, {})), (t[29] = h))
    : (h = t[29]);
  let g = n.kind === `group` && n.groupId === `special:none` ? D : void 0,
    _;
  t[30] === i
    ? (_ = t[31])
    : ((_ = () => {
        i({ kind: `group`, groupId: ye });
      }),
      (t[30] = i),
      (t[31] = _));
  let v;
  t[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, Z.jsx)(T, { ...$.chats })), (t[32] = v))
    : (v = t[32]);
  let y;
  t[33] !== g || t[34] !== _
    ? ((y = (0, Z.jsx)(U.Item, { LeftIcon: ne, RightIcon: g, onSelect: _, children: v })),
      (t[33] = g),
      (t[34] = _),
      (t[35] = y))
    : (y = t[35]);
  let b = n.kind === `group` && n.groupId === `special:automations` ? D : void 0,
    x;
  t[36] === i
    ? (x = t[37])
    : ((x = () => {
        i({ kind: `group`, groupId: ve });
      }),
      (t[36] = i),
      (t[37] = x));
  let S;
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, Z.jsx)(T, { ...$.automations })), (t[38] = S))
    : (S = t[38]);
  let C;
  t[39] !== b || t[40] !== x
    ? ((C = (0, Z.jsx)(U.Item, { LeftIcon: M, RightIcon: b, onSelect: x, children: S })),
      (t[39] = b),
      (t[40] = x),
      (t[41] = C))
    : (C = t[41]);
...
function Ye(e) {
        ...
        ? (0, Z.jsxs)(`div`, {
            ...
            children: [
              (0, Z.jsxs)(`span`, {
                ...
                children: [
                  (0, Z.jsx)(F, { className: `icon-xs shrink-0` }),
                  (0, Z.jsx)(`span`, {
                    className: `truncate`,
                    children:
                      n.projectLabel == null
                  ...
                  m
                    ? (0, Z.jsx)(ie, {
                        ...
                        children: (0, Z.jsx)(U.Item, {
                          ...
                          children: (0, Z.jsx)(T, { ...$.deleteProjectChats }),
                        }),
                      })
                    : null,
                ],
  ...
  return (
    t[26] !== h || t[27] !== g
      ? ((_ = (0, Z.jsxs)(`div`, { className: `flex flex-col`, children: [h, g] })),
        (t[26] = h),
        (t[27] = g),
        (t[28] = _))
      : (_ = t[28]),
...
function Xe(e) {
  ...
  t[0] !== n.name || t[1] !== n.preview
    ? ((d = c(n.name?.trim() || n.preview).trim()), (t[0] = n.name), (t[1] = n.preview), (t[2] = d))
    : (d = t[2]);
  let f = d,
    p,
    m,
  ...
  if (
    ...
    (t[13] !== n.cwd || t[14] !== n.path || t[15] !== o
      ...
      (h = a),
      (m = i != null),
      (p = m ? u.formatDate(i, { year: `numeric`, month: `short`, day: `numeric` }) : ``),
  ...
  t[21] === b
    ? (x = t[22])
    : ((x = (0, Z.jsx)(`div`, { className: `truncate text-base font-medium`, children: b })),
      (t[21] = b),
      (t[22] = x));
  let S;
  t[23] !== p || t[24] !== m || t[25] !== h || t[26] !== _
    ? ((S = m
        ? h
          ? (0, Z.jsx)(T, {
              ...
              values: { date: p, time: _, repo: h },
            })
          : (0, Z.jsx)(T, {
              id: `settings.dataControls.archivedChats.dateTime`,
              defaultMessage: `{date}, {time}`,
              description: `Date and time for an archived chat`,
              values: { date: p, time: _ },
            })
        : null),
      (t[23] = p),
      (t[24] = m),
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, Z.jsx)(T, { ...J.unarchive })), (t[41] = j))
    : (j = t[41]);
  let M;
  t[42] !== r || t[43] !== i || t[44] !== A
    ? ((M = (0, Z.jsx)(E, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
function Ze(e) {
  ...
  t[8] === s
    ? (l = t[9])
    : ((l = (0, Z.jsx)(E, { color: `ghost`, onClick: s, children: c })), (t[8] = s), (t[9] = l));
  let u;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Z.jsx)(T, { ...J.delete })), (t[10] = u))
    : (u = t[10]);
  let d;
  t[11] === r
    ? (d = t[12])
    : ((d = (0, Z.jsx)(E, { color: `danger`, onClick: r, children: u })), (t[11] = r), (t[12] = d));
  let f;
  t[13] !== l || t[14] !== d
    ? ((f = (0, Z.jsx)(I, { children: (0, Z.jsxs)(B, { children: [l, d] }) })),
      (t[13] = l),
      (t[14] = d),
      (t[15] = f))
    : (f = t[15]);
  ...
  return (
    t[20] !== i || t[21] !== p
      ? ((m = (0, Z.jsx)(R, { open: !0, showDialogClose: !1, onOpenChange: i, children: p })),
        (t[20] = i),
        (t[21] = p),
        (t[22] = m))
      : (m = t[22]),
...
export { Le as DataControlsSettings };
