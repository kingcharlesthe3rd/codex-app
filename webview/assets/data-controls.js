...
import { Xs as n, ii as r, po as i, w as a } from "./app-server-manager-signals.js";
...
function U({ cloudTasks: e, localThreads: t }) {
  return [
    ...(e ?? []).map((e) => ({ kind: `cloud`, at: W(e.updated_at, e.created_at), task: e })),
    ...(t ?? []).map((e) => ({ kind: `local`, at: W(e.updatedAt, e.createdAt), thread: e })),
  ].sort((e, t) => t.at - e.at);
}
function W(e, t) {
...
function te(e) {
  ...
  t[0] === n.id
    ...
    : ((d = [`recover-cloud-task`, n.id]),
      (p = () =>
        x.safePost(`/wham/tasks/{task_id}/recover`, { parameters: { path: { task_id: n.id } } })),
      (t[0] = n.id),
      (t[1] = d),
      (t[2] = p));
  let h;
  ...
  t[13] !== d || t[14] !== p || t[15] !== h || t[16] !== g || t[17] !== v
    ? ((y = { mutationKey: d, mutationFn: p, onError: h, onSuccess: g, onSettled: v }),
      (t[13] = d),
      (t[14] = p),
      (t[15] = h),
      (t[16] = g),
  ...
  t[32] === N
    ...
    : ((P = (0, G.jsxs)(`div`, {
        ...
        children: [j, (0, G.jsx)(`span`, { className: `truncate`, children: N })],
      })),
      (t[32] = N),
      (t[33] = P));
  let F;
...
function Q() {
  ...
  let { data: i, isLoading: a, isError: o } = d(r),
    ...
    m;
  e[2] !== s || e[3] !== i
    ? ((m = U({ cloudTasks: s, localThreads: i })), (e[2] = s), (e[3] = i), (e[4] = m))
    : (m = e[4]);
  let g = m,
    _;
...
function re(e) {
  ...
  r[6] === s
    ...
    : ((P = [`unarchive-thread`, s]),
      (F = async (e) => (
        await n(`unarchive-conversation`, { hostId: s, conversationId: t(e.id) }),
        e
      )),
      (r[6] = s),
      (r[7] = P),
  ...
  r[13] !== s || r[14] !== C || r[15] !== x || r[16] !== y
    ? ((z = (e, t, n) => {
        (n?.previousThreads && x.setQueryData([`archived-threads`, s], n.previousThreads),
          y.get(S).danger(C.formatMessage(H.unarchiveError), { id: `unarchive-thread-${t.id}` }));
      }),
      (r[13] = s),
      (r[14] = C),
      (r[15] = x),
  ...
  r[18] !== s || r[19] !== N || r[20] !== y
    ? ((U = async (e) => {
        let r = t(e.id),
          i = await n(`hydrate-pinned-threads`, { hostId: s, threadIds: [e.id] }).then(
            () => y.get(a, r),
            ae,
          );
        y.get(S).info(
  ...
  r[22] !== s || r[23] !== x
    ...
    : (W = r[24]);
  let ne;
  r[25] !== P || r[26] !== F || r[27] !== I || r[28] !== z || r[29] !== U || r[30] !== W
    ? ((ne = {
        mutationKey: P,
        mutationFn: F,
        onMutate: I,
    ...
    : ((q = [`delete-archived-conversations`, s]),
      (J = async (e) =>
        e.kind === `all`
          ...
          : n(`delete-archived-conversation`, { hostId: s, conversationId: t(e.thread.id) })),
      (r[32] = s),
      (r[33] = q),
      (r[34] = J));
  let Y;
  ...
  r[39] !== s || r[40] !== C || r[41] !== x || r[42] !== y
    ? ((X = (e, t, n) => {
        (n?.previousThreads && x.setQueryData([`archived-threads`, s], n.previousThreads),
          y
            .get(S)
            .danger(C.formatMessage(t.kind === `all` ? H.deleteAllError : H.deleteError), {
              id: de(t),
            }));
      }),
      (r[39] = s),
  ...
  r[47] !== s || r[48] !== x
    ...
    : (Q = r[49]);
  let re;
  r[50] !== q || r[51] !== J || r[52] !== Y || r[53] !== X || r[54] !== Z || r[55] !== Q
    ? ((re = {
        mutationKey: q,
        mutationFn: J,
        onMutate: Y,
  ...
  if (r[63] !== o || r[64] !== $ || r[65] !== s || r[66] !== K) {
    ...
    (r[68] !== $ || r[69] !== s || r[70] !== K
      ? ((e = (e) => {
          switch (e.kind) {
            case `cloud`:
              return (0, G.jsx)(te, { archivedTask: e.task }, `cloud:${e.task.id}`);
            case `local`:
              return (0, G.jsx)(
                le,
                {
  ...
  r[72] !== d || r[73] !== h || r[74] !== v
    ? ((me = (0, G.jsx)(se, { hasNextPage: d, isFetchingNextPage: h, onLoadNextPage: v })),
      (r[72] = d),
      (r[73] = h),
      (r[74] = v),
      (r[75] = me))
...
function se(e) {
  ...
  let l;
  if (
    (t[8] !== n || t[9] !== r ? ((l = [n, r]), (t[8] = n), (t[9] = r), (t[10] = l)) : (l = t[10]),
    (0, V.useEffect)(c, l),
    !n && !r)
  )
    return null;
  ...
  return (
    t[11] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((u = (0, G.jsx)(`div`, {
          ...
          children: (0, G.jsx)(w, { className: `icon-xs text-token-text-secondary` }),
        })),
        (t[11] = u))
      : (u = t[11]),
    u
...
function le(e) {
  ...
  t[0] !== n.name || t[1] !== n.preview
    ? ((d = r(n.name?.trim() || n.preview).trim()), (t[0] = n.name), (t[1] = n.preview), (t[2] = d))
    : (d = t[2]);
  let p = d,
    m,
    h,
  ...
  if (
    ...
    (t[12] !== n.cwd || t[13] !== n.path
      ...
      (g = a),
      (h = i != null),
      (m = h ? u.formatDate(i, { year: `numeric`, month: `short`, day: `numeric` }) : ``),
  ...
  t[19] === x
    ? (S = t[20])
    : ((S = (0, G.jsx)(`div`, { className: `truncate text-base font-medium`, children: x })),
      (t[19] = x),
      (t[20] = S));
  let w;
...
function ue(e) {
  ...
  t[7] === s
    ? (l = t[8])
    : ((l = (0, G.jsx)(ee, { color: `ghost`, onClick: s, children: c })), (t[7] = s), (t[8] = l));
  let u;
  ...
  return (
    t[19] !== i || t[20] !== m
      ? ((h = (0, G.jsx)(D, { open: !0, showDialogClose: !1, onOpenChange: i, children: m })),
        (t[19] = i),
        (t[20] = m),
        (t[21] = h))
      : (h = t[21]),
