...
import { Ho as n, Ti as r, bc as i, w as a } from "./app-server-manager-signals.js";
...
function W({ cloudTasks: e, localThreads: t }) {
  return [
    ...
    ...(t ?? []).map((e) => ({
      ...
      searchValues: [r(e.name?.trim() || e.preview).trim(), N(e.cwd) ?? N(e.path) ?? ``],
      thread: e,
    })),
  ].sort((e, t) => t.at - e.at);
}
...
function ne(e) {
  ...
  t[0] === n.id
    ...
    : ((d = [`recover-cloud-task`, n.id]),
      (p = () =>
        S.safePost(`/wham/tasks/{task_id}/recover`, { parameters: { path: { task_id: n.id } } })),
      (t[0] = n.id),
      (t[1] = d),
      (t[2] = p));
  let m;
  ...
  let b = u(_),
    w;
  t[19] === n.title ? (w = t[20]) : ((w = r(n.title ?? ``).trim()), (t[19] = n.title), (t[20] = w));
  let T = w,
    E,
    D,
    O,
...
function ie(e) {
  let r = (0, V.c)(93),
    ...
    [O, k] = (0, H.useState)(``),
    j;
  r[0] === o ? (j = r[1]) : ((j = te(o)), (r[0] = o), (r[1] = j));
  let M = j(O),
    N;
  r[2] !== o || r[3] !== s
    ? ((N = s === `local` && o.some(se)), (r[2] = o), (r[3] = s), (r[4] = N))
    : (N = r[4]);
  let P = N,
    F;
  r[5] !== s || r[6] !== w || r[7] !== T
  ...
  r[25] !== s || r[26] !== b
    ...
    : (Y = r[27]);
  let re;
  r[28] !== z || r[29] !== W || r[30] !== G || r[31] !== q || r[32] !== J || r[33] !== Y
    ? ((re = {
        mutationKey: z,
        mutationFn: W,
        onMutate: G,
  ...
  r[50] !== s || r[51] !== b
    ...
    : (pe = r[52]);
  let me;
  r[53] !== Z || r[54] !== Q || r[55] !== $ || r[56] !== ie || r[57] !== fe || r[58] !== pe
    ? ((me = {
        mutationKey: Z,
        mutationFn: Q,
        onMutate: $,
  ...
  if (p) {
    let e;
    return (
      r[60] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, K.jsx)(R, {
            children: (0, K.jsx)(L, {
              label: (0, K.jsx)(y, {
  ...
  if (h) {
    let e;
    return (
      r[61] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, K.jsx)(R, {
            children: (0, K.jsx)(L, {
              label: (0, K.jsx)(y, {
  ...
  if (o.length === 0) {
    let e;
    return (
      r[62] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, K.jsx)(R, {
            children: (0, K.jsx)(L, {
              label: (0, K.jsx)(y, {
  ...
  let _e;
  r[63] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_e = (0, K.jsx)(ce, { onSearchQueryChange: k })), (r[63] = _e))
    : (_e = r[63]);
  let ve = R,
    ye =
      M.length === 0 && !d && !m
  ...
  r[68] !== d || r[69] !== m || r[70] !== g
    ...
    : (Se = r[71]);
  let Ce;
  r[72] !== ve || r[73] !== ye || r[74] !== xe || r[75] !== Se
    ? ((Ce = (0, K.jsxs)(ve, {
  ...
  r[80] !== o || r[81] !== he || r[82] !== E
    ...
    : (Te = r[83]);
  let Ee;
  r[84] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ee = (e) => {
        e || D(null);
      }),
      (r[84] = Ee))
  ...
  let Oe;
  return (
    r[88] !== _e || r[89] !== Ce || r[90] !== we || r[91] !== De
...
function le(e) {
  ...
  t[0] !== n.name || t[1] !== n.preview
    ? ((u = r(n.name?.trim() || n.preview).trim()), (t[0] = n.name), (t[1] = n.preview), (t[2] = u))
    : (u = t[2]);
  let d = u,
    f,
    p,
  ...
  if (
    ...
    (t[12] !== n.cwd || t[13] !== n.path
      ? ((a = N(n.cwd) ?? N(n.path)), (t[12] = n.cwd), (t[13] = n.path), (t[14] = a))
      : (a = t[14]),
      (m = a),
      (p = i != null),
