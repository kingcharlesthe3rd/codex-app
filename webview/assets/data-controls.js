...
import { A as f, _ as p, c as m, u as h, v as g } from "./vscode-api.js";
import "./isEqual.js";
import { Ur as _ } from "./src-2.js";
import "./react-dom.js";
...
import "./rpc-2.js";
import "./statsig.js";
import { t as T } from "./request.js";
import "./platform.js";
import "./marked.esm.js";
import { r as E, t as D } from "./dropdown.js";
import { t as O } from "./search.js";
import { a as k, i as A, l as j, n as M, r as N } from "./dialog-layout-B.js";
import "./with-window.js";
import { t as P } from "./folder.js";
import "./selectable-remote-connections-signal.js";
import "./chevron.js";
import { m as F } from "./chunk-9.js";
import { t as I } from "./fuse.js";
import "./_baseEach.js";
import "./_baseOrderBy.js";
import "./_defineProperty.js";
import "./initial-route-atom.js";
import { t as L } from "./use-navigate-to-local-conversation.js";
import "./links-p.js";
import { t as R } from "./folders.js";
import "./three-dots.js";
import { t as z } from "./trash.js";
import { t as B } from "./cloud.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as V } from "./settings-host-context.js";
import { t as H } from "./get-project-name.js";
import { i as U, t as ee } from "./settings-shared.js";
import { t as te } from "./settings-content-layout.js";
import { t as ne } from "./more-menu-trigger-3O9O-Cbz.js";
import { r as re } from "./settings-row.js";
import { t as ie } from "./settings-surface.js";
import { t as ae } from "./settings-group.js";
import { t as oe } from "./infinite-scroll-pagination-spinner.js";
import { t as se } from "./filter.js";
import { t as ce } from "./control-group.js";
var W = a(),
  le = e(t(), 1),
  G = v({
    delete: {
...
function ue({ cloudTasks: e, localThreads: t }) {
  return [
    ...(e ?? []).map((e) => {
      ...
      return {
        kind: `cloud`,
        createdAt: K(e.created_at, e.updated_at),
        projectId: r == null ? null : n,
        projectLabel: r,
        searchValues: [t, r ?? ``, n],
        task: e,
        title: t,
        updatedAt: K(e.updated_at, e.created_at),
      };
    }),
    ...(t ?? []).map((e) => {
      ...
      return {
        kind: `local`,
        createdAt: K(e.createdAt, e.updatedAt),
        projectId: n == null ? (r == null ? null : e.path) : e.cwd,
        projectLabel: i,
        searchValues: [t, i ?? ``],
        thread: e,
        title: t,
        updatedAt: K(e.updatedAt, e.createdAt),
      };
    }),
  ].sort((e, t) => t.updatedAt - e.updatedAt);
}
function de(e) {
  let t = new I(e, { ignoreLocation: !0, keys: [`searchValues`], threshold: 0.4 });
  return (n) => {
    let r = n.trim();
    return r.length === 0 ? e : t.search(r).map(({ item: e }) => e);
  };
}
function fe({ entries: e, groupKey: t, kindFilter: n, searchQuery: r, sortKey: i }) {
  let a = de(e.filter((e) => n === `all` || e.kind === n))(r);
  if (t === `none`)
    return a.length === 0
      ? []
      : [{ id: `all`, projectLabel: null, entries: [...a].sort((e, t) => J(e, t, i)) }];
  let o = new Map();
  for (let e of a) {
    let t = e.projectId ?? ``,
      n = o.get(t);
  ...
  let s = [...o.values()];
  for (let e of s) e.entries.sort((e, t) => J(e, t, i));
  return s.sort((e, t) => {
    if (i === `alphabetical`) {
...
function me(e, t) {
  let n = 0;
  for (let r of e.entries) n = Math.max(n, q(r, t));
  return n;
}
var Y = n();
function X(e) {
  let t = (0, W.c)(55),
    { archivedTask: n, showProjectName: a } = e,
    o = r(i),
    s = f(),
    l = y(),
    u = F(),
  ...
  t[0] === n.id
    ...
    : ((d = [`recover-cloud-task`, n.id]),
      (m = () =>
        T.safePost(`/wham/tasks/{task_id}/recover`, { parameters: { path: { task_id: n.id } } })),
      (t[0] = n.id),
      (t[1] = d),
      (t[2] = m));
  let h;
  t[3] !== l || t[4] !== o
    ? ((h = () => {
        o.get(w).danger(l.formatMessage(G.unarchiveError));
      }),
      (t[3] = l),
      (t[4] = o),
      (t[5] = h))
    ...
    ? ((g = () => {
        (s.setQueryData([`tasks`, `archived`], (e) =>
          ...
          o.get(w).info(
            (0, Y.jsxs)(`span`, {
              children: [
                (0, Y.jsx)(b, { ...G.unarchiveSuccessPlain }),
                (0, Y.jsx)(`button`, {
  ...
  t[11] === s
    ...
    : ((_ = () => {
      ...
      (t[12] = _));
  let v;
  t[13] !== d || t[14] !== m || t[15] !== h || t[16] !== g || t[17] !== _
    ? ((v = { mutationKey: d, mutationFn: m, onError: h, onSuccess: g, onSettled: _ }),
      (t[13] = d),
      (t[14] = m),
      (t[15] = h),
      (t[16] = g),
  ...
  let S = p(v),
    C;
  t[19] === n.title ? (C = t[20]) : ((C = c(n.title ?? ``).trim()), (t[19] = n.title), (t[20] = C));
  let E = C,
    D,
    O,
    k,
    A;
  if (t[21] !== n || t[22] !== l || t[23] !== a) {
    let e = he(n),
      r;
    (t[28] !== n.task_status_display?.environment_label || t[29] !== a
      ? ((r = a ? n.task_status_display?.environment_label?.trim() : null),
      ...
      (O = r),
      (k = e != null),
      (D = k ? l.formatDate(e, { year: `numeric`, month: `short`, day: `numeric` }) : ``),
      (A = k ? l.formatTime(e, { hour: `numeric`, minute: `2-digit` }) : ``),
      (t[21] = n),
      (t[22] = l),
      (t[23] = a),
      (t[24] = D),
      ...
      (t[26] = k),
      (t[27] = A));
  } else ((D = t[24]), (O = t[25]), (k = t[26]), (A = t[27]));
  let j = A,
    M;
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, Y.jsx)(B, { className: `icon-sm shrink-0` })), (t[31] = M))
    : (M = t[31]);
  let N;
  t[32] === E
    ? (N = t[33])
  ...
  t[34] === N
    ...
    : ((P = (0, Y.jsxs)(`div`, {
        ...
        children: [M, (0, Y.jsx)(`span`, { className: `truncate`, children: N })],
      })),
      (t[34] = N),
      (t[35] = P));
  let I;
  t[36] !== D || t[37] !== O || t[38] !== k || t[39] !== j
    ? ((I = k
        ? O
          ? (0, Y.jsx)(b, {
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, Y.jsx)(b, { ...G.unarchive })), (t[48] = V))
    : (V = t[48]);
  let H;
  t[49] !== z || t[50] !== S.isPending
    ? ((H = (0, Y.jsx)(x, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
async function xe(e) {
  try {
    return await T.safeGet(`/wham/tasks/list`, {
      parameters: { query: { limit: 20, cursor: e, task_filter: `archived` } },
    });
  } catch (e) {
    if (e instanceof m && (e.status === 401 || e.status === 403 || e.status === 404))
...
function Q() {
  ...
  e[0] === t
    ...
    : ((n = {
      ...
      (e[0] = t),
      (e[1] = n));
  let { data: r, isLoading: i, isError: a } = g(n),
    {
      data: o,
      fetchNextPage: s,
      hasNextPage: c,
    ...
    m;
  e[2] !== o || e[3] !== r || e[4] !== t
    ? ((m = ue({ cloudTasks: o, localThreads: t === `local` ? r : [] })),
      (e[2] = o),
      (e[3] = r),
      (e[4] = t),
      (e[5] = m))
...
function $(e) {
  let t = (0, W.c)(118),
    ...
    [O, k] = (0, le.useState)(``),
    [A, j] = (0, le.useState)(`project`),
    [M, N] = (0, le.useState)(`all`),
    [P, I] = (0, le.useState)(`updated`),
    R;
  t[0] !== n || t[1] !== A || t[2] !== M || t[3] !== O || t[4] !== P
    ? ((R = fe({ entries: n, groupKey: A, kindFilter: M, searchQuery: O, sortKey: P })),
      (t[0] = n),
      (t[1] = A),
      (t[2] = M),
      (t[3] = O),
  ...
  let B = R,
    ...
    H;
  t[6] !== n || t[7] !== a
    ? ((H = a === `local` && n.some(Te)), (t[6] = n), (t[7] = a), (t[8] = H))
    : (H = t[8]);
  let ee = H,
    ne;
  t[9] !== a || t[10] !== C || t[11] !== T || t[12] !== g
    ? ((ne = (e) => {
        (_(e.id), a === `local` && T(e.id));
      }),
      (t[9] = a),
      (t[10] = C),
      (t[11] = T),
  ...
  t[14] === a
    ? ((ce = t[15]), (ue = t[16]))
    : ((ce = [`unarchive-thread`, a]),
      (ue = async (e) => (
        await l(`unarchive-conversation`, { hostId: a, conversationId: _(e.id) }),
        e
      )),
      (t[14] = a),
      (t[15] = ce),
  ...
  t[17] !== a || t[18] !== v || t[19] !== g
    ...
    : (de = t[20]);
  let K;
  t[21] !== a || t[22] !== S || t[23] !== v || t[24] !== g
    ? ((K = (e, t, n) => {
        (n?.previousThreads && v.setQueryData([`archived-threads`, a], n.previousThreads),
          g.get(w).danger(S.formatMessage(G.unarchiveError), { id: `unarchive-thread-${t.id}` }));
      }),
      (t[21] = a),
      (t[22] = S),
      (t[23] = v),
    ...
    : (K = t[25]);
  let q;
  t[26] !== a || t[27] !== se || t[28] !== g
    ? ((q = async (e) => {
        let t = _(e.id),
          n = await l(`hydrate-pinned-threads`, { hostId: a, threadIds: [e.id] }).then(
            () => g.get(s, t),
            we,
          );
        g.get(w).info(
  ...
  t[30] !== a || t[31] !== v
    ...
    : (J = t[32]);
  let me;
  t[33] !== ce || t[34] !== ue || t[35] !== de || t[36] !== K || t[37] !== q || t[38] !== J
    ? ((me = {
        mutationKey: ce,
        mutationFn: ue,
        onMutate: de,
  ...
  t[40] === a
    ? ((he = t[41]), (ge = t[42]))
    : ((he = [`delete-archived-conversations`, a]),
      (ge = async (e) =>
        e.kind === `all`
          ? l(`delete-all-archived-conversations`, { hostId: a })
          : e.kind === `project`
            ? (
                await Promise.all(
                  e.threadIds.map((e) =>
                    l(`delete-archived-conversation`, { hostId: a, conversationId: _(e) }),
                  ),
                )
              ).flat()
            : l(`delete-archived-conversation`, { hostId: a, conversationId: _(e.thread.id) })),
      (t[40] = a),
      (t[41] = he),
      (t[42] = ge));
  let _e;
  t[43] !== a || t[44] !== v || t[45] !== g
    ? ((_e = async (e) => {
        ...
        (g
          ...
          .info(
            e.kind === `single`
              ? (0, Y.jsx)(b, { ...G.deleting })
              : (0, Y.jsx)(b, { ...G.deletingAll }),
            { id: Fe(e), duration: 0, hasCloseButton: !1 },
          ),
          await v.cancelQueries({ queryKey: [`archived-threads`, a] }));
  ...
  t[52] !== S || t[53] !== g
    ? ((ye = (e, t) => {
        ...
        g.get(w).success(S.formatMessage(G.deleteSuccessPlain), { id: Fe(t) });
      }),
      (t[52] = S),
      (t[53] = g),
      (t[54] = ye))
  ...
  t[55] !== a || t[56] !== v
    ...
    : (be = t[57]);
  let xe;
  t[58] !== he || t[59] !== ge || t[60] !== _e || t[61] !== ve || t[62] !== ye || t[63] !== be
    ? ((xe = {
        mutationKey: he,
        mutationFn: ge,
        onMutate: _e,
  ...
  if (u) {
    ...
    t[72] !== V || t[73] !== d || t[74] !== B.length
      ...
      : (n = t[75]);
    let r;
    if (t[76] !== Q || t[77] !== A || t[78] !== a || t[79] !== X || t[80] !== B) {
      let e;
      (t[82] !== Q || t[83] !== A || t[84] !== a || t[85] !== X
        ? ((e = (e) =>
            (0, Y.jsx)(
              ke,
              {
                ...
                hostId: a,
                isDeleteDisabled: Q,
                projectArchivedThreads: pe(e.entries, e.id),
                unarchivingThreadId: X.variables?.id ?? null,
                isUnarchiving: X.isPending,
    ...
    let i;
    t[87] !== V || t[88] !== d || t[89] !== h
      ? ((i = (0, Y.jsx)(oe, { hasNextPage: V, isFetchingNextPage: d, onLoadNextPage: h })),
        (t[87] = V),
        (t[88] = d),
        (t[89] = h),
        (t[90] = i))
      : (i = t[90]);
    let o;
    t[91] !== n || t[92] !== r || t[93] !== i
      ? ((o = (0, Y.jsx)(`div`, {
          className: `min-h-0 flex-1 overflow-y-auto`,
          children: (0, Y.jsxs)(`div`, { className: `flex flex-col`, children: [n, r, i] }),
        })),
        (t[91] = n),
        (t[92] = r),
        (t[93] = i),
    ...
    let s;
    (t[95] !== e || t[96] !== o
      ? ((s = (0, Y.jsxs)(ie, { className: `max-h-[min(80vh)]`, children: [e, o] })),
        (t[95] = e),
        (t[96] = o),
        (t[97] = s))
      : (s = t[97]),
  ...
  t[98] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((De = (0, Y.jsx)(U, { slug: `data-controls` })), (t[98] = De))
    : (De = t[98]);
  let Oe;
  t[99] !== Q || t[100] !== ee || t[101] !== m || t[102] !== u
    ? ((Oe =
        ee && !u && !m
          ? (0, Y.jsxs)(x, {
              color: `danger`,
              ...
              children: [
                (0, Y.jsx)(z, { className: `icon-xs shrink-0` }),
                (0, Y.jsx)(b, { ...G.deleteAll }),
              ],
            })
          : null),
      (t[99] = Q),
  ...
  t[104] === $
    ...
    : ((Ae = (0, Y.jsx)(ae, {
        className: `gap-2`,
        children: (0, Y.jsx)(ae.Content, { children: $ }),
      })),
      (t[104] = $),
      (t[105] = Ae));
  let Me;
  t[106] !== n || t[107] !== Z || t[108] !== E
    ? ((Me = () => {
        if (E != null) {
          if ((D(null), E.kind === `all`)) {
            Z.mutate({ kind: `all`, threadIds: n.flatMap(Ce) });
            return;
          }
          if (E.kind === `project`) {
            Z.mutate({
              ...
              threadIds: E.threads.map(Se),
            });
            return;
          }
          Z.mutate({ kind: `single`, thread: E.thread });
        }
      }),
      (t[106] = n),
      (t[107] = Z),
  ...
  let Pe;
  t[111] !== E || t[112] !== Me
    ? ((Pe = (0, Y.jsx)(je, { state: E, onConfirm: Me, onOpenChange: Ne })),
      (t[111] = E),
      (t[112] = Me),
      (t[113] = Pe))
    : (Pe = t[113]);
...
function Ee(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (f = t[0]);
  let p;
  t[1] === l ? (p = t[2]) : ((p = l.formatMessage(Z.searchArchivedChats)), (t[1] = l), (t[2] = p));
  let m;
  t[3] === l ? (m = t[4]) : ((m = l.formatMessage(Z.searchArchivedChats)), (t[3] = l), (t[4] = m));
  let h;
  t[5] === s
    ? (h = t[6])
    : ((h = (e) => {
  ...
  let v;
  t[17] !== n || t[18] !== a
    ? ((v = (0, Y.jsx)(Oe, { groupKey: n, onGroupKeyChange: a })),
      (t[17] = n),
      (t[18] = a),
      (t[19] = v))
    : (v = t[19]);
  let b;
  t[20] !== _ || t[21] !== v
    ? ((b = (0, Y.jsxs)(ce, { className: `shrink-0`, children: [_, v] })),
      (t[20] = _),
      (t[21] = v),
      (t[22] = b))
    : (b = t[22]);
...
function De(e) {
  let t = (0, W.c)(57),
    ...
    o = y(),
    s;
  t[0] === o ? (s = t[1]) : ((s = o.formatMessage(Z.filterArchivedChats)), (t[0] = o), (t[1] = s));
  let c;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Y.jsx)(se, { className: `icon-xs shrink-0` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === n ? (l = t[4]) : ((l = Me(n)), (t[3] = n), (t[4] = l));
  let u;
  t[5] === l
    ? (u = t[6])
    : ((u = (0, Y.jsx)(`span`, { className: `truncate`, children: (0, Y.jsx)(b, { ...l }) })),
      (t[5] = l),
      (t[6] = u));
  let d;
  t[7] !== s || t[8] !== u
    ? ((d = (0, Y.jsxs)(ee, { className: `w-[150px] md:w-36`, "aria-label": s, children: [c, u] })),
      (t[7] = s),
      (t[8] = u),
      (t[9] = d))
    : (d = t[9]);
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Y.jsx)(E.SectionLabel, { children: (0, Y.jsx)(b, { ...Z.type }) })), (t[10] = f))
    : (f = t[10]);
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Y.jsx)(b, { ...Z.allChats })), (t[13] = h))
    : (h = t[13]);
  let g;
  t[14] !== p || t[15] !== m
    ? ((g = (0, Y.jsx)(E.Item, { RightIcon: p, onSelect: m, children: h })),
      (t[14] = p),
      (t[15] = m),
      (t[16] = g))
    : (g = t[16]);
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, Y.jsx)(b, { ...Z.local })), (t[19] = x))
    : (x = t[19]);
  let C;
  t[20] !== _ || t[21] !== v
    ? ((C = (0, Y.jsx)(E.Item, { RightIcon: _, onSelect: v, children: x })),
      (t[20] = _),
      (t[21] = v),
      (t[22] = C))
    : (C = t[22]);
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, Y.jsx)(b, { ...Z.cloud })), (t[25] = O))
    : (O = t[25]);
  let k;
  t[26] !== w || t[27] !== T
    ? ((k = (0, Y.jsx)(E.Item, { RightIcon: w, onSelect: T, children: O })),
      (t[26] = w),
      (t[27] = T),
      (t[28] = k))
    : (k = t[28]);
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, Y.jsx)(E.Separator, {})), (t[29] = A))
    : (A = t[29]);
  let j;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, Y.jsx)(E.SectionLabel, { children: (0, Y.jsx)(b, { ...Z.sortBy }) })), (t[30] = j))
    : (j = t[30]);
  let M = r === `updated` ? S : void 0,
    N;
  t[31] === a
    ? (N = t[32])
    : ((N = () => {
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (0, Y.jsx)(b, { ...Z.updated })), (t[33] = P))
    : (P = t[33]);
  let F;
  t[34] !== M || t[35] !== N
    ? ((F = (0, Y.jsx)(E.Item, { RightIcon: M, onSelect: N, children: P })),
      (t[34] = M),
      (t[35] = N),
      (t[36] = F))
    : (F = t[36]);
  let I = r === `created` ? S : void 0,
    L;
  t[37] === a
    ? (L = t[38])
    : ((L = () => {
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, Y.jsx)(b, { ...Z.created })), (t[39] = R))
    : (R = t[39]);
  let z;
  t[40] !== I || t[41] !== L
    ? ((z = (0, Y.jsx)(E.Item, { RightIcon: I, onSelect: L, children: R })),
      (t[40] = I),
      (t[41] = L),
      (t[42] = z))
    : (z = t[42]);
  ...
  t[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, Y.jsx)(b, { ...Z.alphabetical })), (t[45] = H))
    : (H = t[45]);
  let U;
  t[46] !== B || t[47] !== V
    ? ((U = (0, Y.jsx)(E.Item, { RightIcon: B, onSelect: V, children: H })),
      (t[46] = B),
      (t[47] = V),
      (t[48] = U))
    : (U = t[48]);
...
function Oe(e) {
  let t = (0, W.c)(26),
    ...
    i = y(),
    a;
  t[0] === i ? (a = t[1]) : ((a = i.formatMessage(Z.groupArchivedChats)), (t[0] = i), (t[1] = a));
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Y.jsx)(R, { className: `icon-xs shrink-0` })), (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] === n ? (s = t[4]) : ((s = Ne(n)), (t[3] = n), (t[4] = s));
  let c;
  t[5] === s
    ? (c = t[6])
    : ((c = (0, Y.jsx)(`span`, { className: `truncate`, children: (0, Y.jsx)(b, { ...s }) })),
      (t[5] = s),
      (t[6] = c));
  let l;
  t[7] !== a || t[8] !== c
    ? ((l = (0, Y.jsxs)(ee, { className: `w-[150px] md:w-36`, "aria-label": a, children: [o, c] })),
      (t[7] = a),
      (t[8] = c),
      (t[9] = l))
    : (l = t[9]);
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Y.jsx)(b, { ...Z.project })), (t[12] = f))
    : (f = t[12]);
  let p;
  t[13] !== u || t[14] !== d
    ? ((p = (0, Y.jsx)(E.Item, { RightIcon: u, onSelect: d, children: f })),
      (t[13] = u),
      (t[14] = d),
      (t[15] = p))
    : (p = t[15]);
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, Y.jsx)(b, { ...Z.none })), (t[18] = g))
    : (g = t[18]);
  let _;
  t[19] !== m || t[20] !== h
    ? ((_ = (0, Y.jsx)(E.Item, { RightIcon: m, onSelect: h, children: g })),
      (t[19] = m),
      (t[20] = h),
      (t[21] = _))
    : (_ = t[21]);
...
function ke(e) {
        ...
        ? (0, Y.jsxs)(`div`, {
            ...
            children: [
              (0, Y.jsxs)(`span`, {
                ...
                children: [
                  (0, Y.jsx)(P, { className: `icon-xs shrink-0` }),
                  (0, Y.jsx)(`span`, {
                    className: `truncate`,
                    children:
                      n.projectLabel == null
                  ...
                  m
                    ? (0, Y.jsx)(D, {
                        ...
                        children: (0, Y.jsx)(E.Item, {
                          ...
                          children: (0, Y.jsx)(b, { ...Z.deleteProjectChats }),
                        }),
                      })
                    : null,
                ],
  ...
  return (
    t[26] !== h || t[27] !== g
      ? ((_ = (0, Y.jsxs)(`div`, { className: `flex flex-col`, children: [h, g] })),
        (t[26] = h),
        (t[27] = g),
        (t[28] = _))
      : (_ = t[28]),
...
function Ae(e) {
  ...
  t[21] === w
    ? (T = t[22])
    : ((T = (0, Y.jsx)(`div`, { className: `truncate text-base font-medium`, children: w })),
      (t[21] = w),
      (t[22] = T));
  let E;
    ...
    ? ((k = a
        ? (0, Y.jsx)(C, {
            ...
            children: (0, Y.jsx)(x, {
              ...
              disabled: r,
              onClick: s,
              children: (0, Y.jsx)(z, { className: `icon-xs` }),
            }),
          })
        : null),
      (t[33] = S),
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, Y.jsx)(b, { ...G.unarchive })), (t[41] = j))
    : (j = t[41]);
  let M;
...
function je(e) {
  ...
  t[8] === s
    ? (l = t[9])
    : ((l = (0, Y.jsx)(x, { color: `ghost`, onClick: s, children: c })), (t[8] = s), (t[9] = l));
  let u;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Y.jsx)(b, { ...G.delete })), (t[10] = u))
    : (u = t[10]);
  let d;
  t[11] === r
    ? (d = t[12])
    : ((d = (0, Y.jsx)(x, { color: `danger`, onClick: r, children: u })), (t[11] = r), (t[12] = d));
  let f;
  t[13] !== l || t[14] !== d
    ? ((f = (0, Y.jsx)(k, { children: (0, Y.jsxs)(N, { children: [l, d] }) })),
      (t[13] = l),
      (t[14] = d),
      (t[15] = f))
    : (f = t[15]);
  ...
  return (
    t[20] !== i || t[21] !== p
      ? ((m = (0, Y.jsx)(j, { open: !0, showDialogClose: !1, onOpenChange: i, children: p })),
        (t[20] = i),
        (t[21] = p),
        (t[22] = m))
      : (m = t[22]),
