...
import { n as tt, t as nt } from "./infinite-scroll-pagination-spinner.js";
import { n as rt, t as it } from "./filter.js";
import { n as at, t as ot } from "./control-group.js";
var X,
  st = e(() => {
    (G(),
      (X = pe({
...
function lt({
  ...
  return [
    ...(t ?? []).map((e) => {
      let t = J(e.title ?? ``).trim(),
        n = e.task_status_display?.environment_label?.trim() ?? ``,
        o = Ke(n),
        s = pt({ assignment: a?.[e.id], projects: r }),
        c = s?.label ?? o;
      return {
        kind: `cloud`,
        createdAt: mt(e.created_at, e.updated_at),
        filterGroupId: i.has(e.id) ? yt : (s?.groupId ?? `special:none`),
        projectId: o == null ? null : n,
        projectLabel: c,
        searchValues: [t, c ?? ``, n],
        task: e,
        title: t,
        updatedAt: mt(e.updated_at, e.created_at),
      };
    }),
    ...(n ?? []).map((t) => {
      let n = J(t.name?.trim() || t.preview).trim(),
        s = Ke(t.cwd),
        c = Ke(t.path),
        l = pt({ assignment: a?.[t.id], fallbackPaths: [o?.[t.id], t.cwd], projects: r }),
        u = l?.label ?? s ?? c;
      return {
        kind: `local`,
        createdAt: mt(t.createdAt, t.updatedAt),
        filterGroupId: e.has(t.id) ? vt : i.has(t.id) ? yt : (l?.groupId ?? `special:none`),
        projectId: s == null ? (c == null ? null : t.path) : t.cwd,
        projectLabel: u,
        searchValues: [n, u ?? ``, s ?? ``, c ?? ``],
        thread: t,
        title: n,
        updatedAt: mt(t.updatedAt, t.createdAt),
      };
    }),
  ].sort((e, t) => t.updatedAt - e.updatedAt);
}
function ut(e) {
  let t = new ce(e, { ignoreLocation: !0, keys: [`searchValues`], threshold: 0.4 });
  return (n) => {
    let r = n.trim();
...
function dt({
  ...
  if (t === `none`)
    return o.length === 0
      ? []
      : [{ id: `all`, projectLabel: null, entries: [...o].sort((e, t) => gt(e, t, a)) }];
  let s = new Map();
  for (let e of o) {
    let t = e.projectId ?? ``,
      n = s.get(t);
  ...
  let c = [...s.values()];
  for (let e of c) e.entries.sort((e, t) => gt(e, t, a));
  return c.sort((e, t) => {
    if (a === `alphabetical`) {
...
function pt({ assignment: e, fallbackPaths: t = [], projects: n }) {
  if (e != null) {
    let t = n.find((t) =>
  ...
  for (let e of t) {
    ...
    let t = a(e).replace(/\/+$/, ``),
      r = n.filter(
        (e) => e.projectKind === `local` && e.path != null && a(e.path).replace(/\/+$/, ``) === t,
      );
...
function _t(e, t) {
  let n = 0;
  for (let r of e.entries) n = Math.max(n, ht(r, t));
  return n;
}
var vt,
  yt,
  bt = e(() => {
    (F(), Ce(), We(), ye(), (vt = `special:automations`), (yt = `special:none`));
  });
function xt(e) {
  let t = (0, Ct.c)(55),
  ...
  t[0] === n.id
    ...
    : ((u = [`recover-cloud-task`, n.id]),
      (d = () =>
        q.safePost(`/wham/tasks/{task_id}/recover`, { parameters: { path: { task_id: n.id } } })),
      (t[0] = n.id),
      (t[1] = u),
      (t[2] = d));
  let f;
  t[3] !== c || t[4] !== a
    ? ((f = () => {
        a.get(H).danger(c.formatMessage(X.unarchiveError));
      }),
      (t[3] = c),
      (t[4] = a),
      (t[5] = f))
    ...
    ? ((m = () => {
        (s.setQueryData([`tasks`, `archived`], (e) =>
          ...
          a.get(H).info(
            (0, Z.jsxs)(`span`, {
              children: [
                (0, Z.jsx)(Y, { ...X.unarchiveSuccessPlain }),
                (0, Z.jsx)(`button`, {
  ...
  let _ = w(g),
    v;
  t[19] === n.title ? (v = t[20]) : ((v = J(n.title ?? ``).trim()), (t[19] = n.title), (t[20] = v));
  let y = v,
    b,
    x,
    S,
  ...
  if (t[21] !== n || t[22] !== c || t[23] !== r) {
    ...
    (t[28] !== n.task_status_display?.environment_label || t[29] !== r
      ...
      (x = i),
      (S = e != null),
      (b = S ? c.formatDate(e, { year: `numeric`, month: `short`, day: `numeric` }) : ``),
      (C = S ? c.formatTime(e, { hour: `numeric`, minute: `2-digit` }) : ``),
      (t[21] = n),
      (t[22] = c),
      (t[23] = r),
      (t[24] = b),
  ...
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Z.jsx)(Ie, { className: `icon-sm shrink-0` })), (t[31] = E))
    : (E = t[31]);
  let D;
  t[32] === y
    ? (D = t[33])
  ...
  t[34] === D
    ...
    : ((O = (0, Z.jsxs)(`div`, {
        ...
        children: [E, (0, Z.jsx)(`span`, { className: `truncate`, children: D })],
      })),
      (t[34] = D),
      (t[35] = O));
  let k;
  t[36] !== b || t[37] !== x || t[38] !== S || t[39] !== T
    ? ((k = S
        ? x
          ? (0, Z.jsx)(Y, {
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, Z.jsx)(Y, { ...X.unarchive })), (t[48] = N))
    : (N = t[48]);
  let P;
  t[49] !== M || t[50] !== _.isPending
    ? ((P = (0, Z.jsx)(I, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
var Ct,
  Z,
  wt = e(() => {
    ((Ct = g()), n(), c(), G(), Te(), j(), re(), Re(), Ce(), r(), K(), st(), (Z = y()));
  });
function Tt() {
  let e = (0, jt.c)(2),
    t;
...
async function At(e) {
  try {
    return await q.safeGet(`/wham/tasks/list`, {
...
function Nt() {
  ...
  e[0] === t
    ...
    : ((o = {
        ...
        queryFn: () => Ee(`list-archived-threads`, { hostId: t }),
        enabled: !0,
        staleTime: b.FIVE_SECONDS,
      }),
      (e[0] = t),
      (e[1] = o));
  let { data: s, isLoading: c, isError: l } = d(o),
    {
      data: f,
      fetchNextPage: p,
      hasNextPage: m,
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = u(`inbox-items`, { limit: $t })), (e[2] = y))
    : (y = e[2]);
  let x = t === Se,
    C;
  e[3] === x
    ? (C = e[4])
    : ((C = { queryKey: y, queryFn: It, enabled: x, staleTime: b.FIVE_SECONDS }),
      (e[3] = x),
      (e[4] = C));
  let { data: w, isLoading: T } = d(C),
    E,
    D;
  if (
    e[5] !== w ||
    ...
    (e[18] === w?.items
      ? (l = e[19])
      : ((l = new Set(w?.items.flatMap(Ft) ?? [])), (e[18] = w?.items), (e[19] = l)),
      (D = lt({
  ...
  let O = D,
    k;
  e[20] === E ? (k = e[21]) : ((k = E.map(Pt)), (e[20] = E), (e[21] = k));
  let A = `${t}:${k.join(`,`)}`,
    j = m && !g,
    M = c || h || (t === `local` && T),
    P = l || (f == null && v),
...
function It() {
  return v(`inbox-items`, { params: { limit: $t } });
}
function Lt(e) {
  let t = (0, Xt.c)(121),
    {
    ...
    g = fe(),
    _ = O(),
    [v, y] = (0, Zt.useState)(null),
    [b, x] = (0, Zt.useState)(``),
    [S, T] = (0, Zt.useState)(`all`),
    [E, D] = (0, Zt.useState)(Qt),
    [k, A] = (0, Zt.useState)(`updated`),
    j = new Set([...r.map(Vt), yt, vt]),
    M = E.kind === `all` || j.has(E.groupId) ? E : Qt,
    N = M.kind === `all` ? `project` : `none`,
    P;
  t[0] !== M || t[1] !== n || t[2] !== S || t[3] !== b || t[4] !== k || t[5] !== N
    ? ((P = dt({
        entries: n,
        groupKey: N,
        kindFilter: S,
  ...
  let F = P,
    ...
    R;
  t[7] !== n || t[8] !== a
    ? ((R = a === `local` && n.some(Bt)), (t[7] = n), (t[8] = a), (t[9] = R))
    : (R = t[9]);
  let z = R,
    B;
  t[10] !== a || t[11] !== g || t[12] !== _ || t[13] !== f
    ? ((B = (e) => {
        (C(e.id), a === `local` && _(e.id));
      }),
      (t[10] = a),
      (t[11] = g),
      (t[12] = _),
  ...
  t[15] === a
    ? ((V = t[16]), (te = t[17]))
    : ((V = [`unarchive-thread`, a]),
      (te = async (e) => (
        await Ee(`unarchive-conversation`, { hostId: a, conversationId: C(e.id) }),
        e
      )),
      (t[15] = a),
      (t[16] = V),
  ...
  t[18] !== a || t[19] !== m || t[20] !== f
    ...
    : (ne = t[21]);
  let re;
  t[22] !== a || t[23] !== h || t[24] !== m || t[25] !== f
    ? ((re = (e, t, n) => {
        let r = e instanceof me;
        (!r && n?.previousThreads && m.setQueryData([`archived-threads`, a], n.previousThreads),
          f
            .get(H)
            .danger(h.formatMessage(r ? X.openError : X.unarchiveError), {
  ...
  t[27] !== ee || t[28] !== f
    ? ((U = (e) => {
        f.get(H).info(
          (0, Q.jsxs)(`span`, {
            children: [
              (0, Q.jsx)(Y, { ...X.unarchiveSuccessPlain }),
              (0, Q.jsx)(`button`, {
                className: `pointer-events-auto ml-1 cursor-interaction text-token-link underline-offset-2 hover:underline`,
                type: `button`,
                onClick: () => {
  ...
  t[30] !== a || t[31] !== m
    ...
    : (ie = t[32]);
  let ae;
  t[33] !== ie || t[34] !== V || t[35] !== te || t[36] !== ne || t[37] !== re || t[38] !== U
    ? ((ae = {
        mutationKey: V,
        mutationFn: te,
        onMutate: ne,
  ...
  t[40] === a
    ? ((oe = t[41]), (se = t[42]))
    : ((oe = [`delete-archived-conversations`, a]),
      (se = async (e) =>
        e.kind === `all`
          ? Ee(`delete-all-archived-conversations`, { hostId: a })
          : e.kind === `project`
            ? (
                await Promise.all(
                  e.threadIds.map((e) =>
                    Ee(`delete-archived-conversation`, { hostId: a, conversationId: C(e) }),
                  ),
                )
              ).flat()
            : Ee(`delete-archived-conversation`, { hostId: a, conversationId: C(e.thread.id) })),
      (t[40] = a),
      (t[41] = oe),
      (t[42] = se));
  let ce;
  t[43] !== a || t[44] !== m || t[45] !== f
    ? ((ce = async (e) => {
        ...
        (f
          ...
          .info(
            e.kind === `single`
              ? (0, Q.jsx)(Y, { ...X.deleting })
              : (0, Q.jsx)(Y, { ...X.deletingAll }),
            { id: Yt(e), duration: 0, hasCloseButton: !1 },
          ),
          await m.cancelQueries({ queryKey: [`archived-threads`, a] }));
    ...
    : (ce = t[46]);
  let le;
  t[47] !== a || t[48] !== h || t[49] !== m || t[50] !== f
    ? ((le = (e, t, n) => {
        (n?.previousThreads && m.setQueryData([`archived-threads`, a], n.previousThreads),
          f
            .get(H)
            .danger(
              h.formatMessage(
  ...
  t[52] !== h || t[53] !== f
    ? ((ue = (e, t) => {
        ...
        f.get(H).success(h.formatMessage(X.deleteSuccessPlain), { id: Yt(t) });
      }),
      (t[52] = h),
      (t[53] = f),
      (t[54] = ue))
  ...
  t[55] !== a || t[56] !== m
    ...
    : (de = t[57]);
  let pe;
  t[58] !== oe || t[59] !== se || t[60] !== ce || t[61] !== le || t[62] !== ue || t[63] !== de
    ? ((pe = {
        mutationKey: oe,
        mutationFn: se,
        onMutate: ce,
  ...
  if (c) {
    ...
    t[68] !== M || t[69] !== S || t[70] !== r || t[71] !== k
      ? ((e = (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(Ht, {
            ...
            projects: r,
            sortKey: k,
            onKindFilterChange: T,
            onProjectFilterChange: D,
    ...
    t[73] !== L || t[74] !== l || t[75] !== F.length
      ...
      : (n = t[76]);
    let i;
    if (t[77] !== M.kind || t[78] !== K || t[79] !== a || t[80] !== W || t[81] !== F) {
      let e;
      (t[83] !== M.kind || t[84] !== K || t[85] !== a || t[86] !== W
        ? ((e = (e) =>
            (0, Q.jsx)(
              Gt,
              {
                ...
                hostId: a,
                isDeleteDisabled: K,
                projectArchivedThreads: ft(e.entries, e.id),
    ...
    t[88] === d
      ...
      : ((o = () => {
        ...
        (t[89] = o));
    let s;
    t[90] !== L || t[91] !== l || t[92] !== o
      ? ((s = (0, Q.jsx)(nt, { hasNextPage: L, isFetchingNextPage: l, onLoadNextPage: o })),
        (t[90] = L),
        (t[91] = l),
        (t[92] = o),
        (t[93] = s))
    ...
    t[94] !== n || t[95] !== i || t[96] !== s
      ? ((c = (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsxs)(`div`, { className: `flex flex-col`, children: [n, i, s] }),
        })),
        (t[94] = n),
        (t[95] = i),
        (t[96] = s),
    ...
    let u;
    (t[98] !== e || t[99] !== c
      ? ((u = (0, Q.jsxs)(Qe, { className: `max-h-[min(80vh)]`, children: [e, c] })),
        (t[98] = e),
        (t[99] = c),
        (t[100] = u))
      : (u = t[100]),
  ...
  t[101] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((he = (0, Q.jsx)(Je, { slug: `data-controls` })), (t[101] = he))
    : (he = t[101]);
  let ge;
  t[102] !== K || t[103] !== z || t[104] !== u || t[105] !== c
    ? ((ge =
        z && !c && !u
          ? (0, Q.jsxs)(I, {
              color: `danger`,
              ...
              children: [
                (0, Q.jsx)(He, { className: `icon-xs shrink-0` }),
                (0, Q.jsx)(Y, { ...X.deleteAll }),
              ],
            })
          : null),
      (t[102] = K),
  ...
  t[107] === q
    ...
    : ((_e = (0, Q.jsx)(Xe, {
        className: `gap-2`,
        children: (0, Q.jsx)(Xe.Content, { children: q }),
      })),
      (t[107] = q),
      (t[108] = _e));
  let ve;
  t[109] !== n || t[110] !== G || t[111] !== v
    ? ((ve = () => {
        if (v != null) {
          if ((y(null), v.kind === `all`)) {
            G.mutate({ kind: `all`, threadIds: n.flatMap(zt) });
            return;
          }
          if (v.kind === `project`) {
            G.mutate({
  ...
  let J;
  t[114] !== v || t[115] !== ve
    ? ((J = (0, Q.jsx)(qt, { state: v, onConfirm: ve, onOpenChange: ye })),
      (t[114] = v),
      (t[115] = ve),
      (t[116] = J))
    : (J = t[116]);
...
function Ht(e) {
  ...
  t[17] !== s || t[18] !== r || t[19] !== i
    ? ((y = (0, Q.jsx)(Wt, { projectFilter: r, projects: i, onProjectFilterChange: s })),
      (t[17] = s),
      (t[18] = r),
      (t[19] = i),
      (t[20] = y))
  ...
  let b;
  t[21] !== v || t[22] !== y
    ? ((b = (0, Q.jsxs)(ot, { className: `shrink-0`, children: [v, y] })),
      (t[21] = v),
      (t[22] = y),
      (t[23] = b))
    : (b = t[23]);
...
function Ut(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(it, { className: `icon-xs shrink-0` })), (t[2] = c))
    : (c = t[2]);
  let l;
  t[3] === n ? (l = t[4]) : ((l = Jt(n)), (t[3] = n), (t[4] = l));
  let u;
  t[5] === l
    ? (u = t[6])
    : ((u = (0, Q.jsx)(`span`, { className: `truncate`, children: (0, Q.jsx)(Y, { ...l }) })),
      (t[5] = l),
      (t[6] = u));
  let d;
  t[7] !== s || t[8] !== u
    ? ((d = (0, Q.jsxs)(qe, { className: `w-[150px] md:w-36`, "aria-label": s, children: [c, u] })),
      (t[7] = s),
      (t[8] = u),
      (t[9] = d))
    : (d = t[9]);
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Q.jsx)(U.SectionLabel, { children: (0, Q.jsx)(Y, { ...$.type }) })), (t[10] = f))
    : (f = t[10]);
  let p = n === `all` ? P : void 0,
    m;
  t[11] === i
    ? (m = t[12])
    : ((m = () => {
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, Q.jsx)(Y, { ...$.local })), (t[19] = y))
    : (y = t[19]);
  let b;
  t[20] !== _ || t[21] !== v
    ? ((b = (0, Q.jsx)(U.Item, { RightIcon: _, onSelect: v, children: y })),
      (t[20] = _),
      (t[21] = v),
      (t[22] = b))
    : (b = t[22]);
  let x = n === `cloud` ? P : void 0,
    S;
  t[23] === i
    ? (S = t[24])
    : ((S = () => {
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = (0, Q.jsx)(Y, { ...$.cloud })), (t[25] = C))
    : (C = t[25]);
  let w;
  t[26] !== x || t[27] !== S
    ? ((w = (0, Q.jsx)(U.Item, { RightIcon: x, onSelect: S, children: C })),
      (t[26] = x),
      (t[27] = S),
      (t[28] = w))
    : (w = t[28]);
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, Q.jsx)(U.Separator, {})), (t[29] = T))
    : (T = t[29]);
  let E;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(U.SectionLabel, { children: (0, Q.jsx)(Y, { ...$.sortBy }) })), (t[30] = E))
    : (E = t[30]);
  let D = r === `updated` ? P : void 0,
    O;
  t[31] === a
    ? (O = t[32])
    : ((O = () => {
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((k = (0, Q.jsx)(Y, { ...$.updated })), (t[33] = k))
    : (k = t[33]);
  let A;
  t[34] !== D || t[35] !== O
    ? ((A = (0, Q.jsx)(U.Item, { RightIcon: D, onSelect: O, children: k })),
      (t[34] = D),
      (t[35] = O),
      (t[36] = A))
    : (A = t[36]);
  let j = r === `created` ? P : void 0,
    M;
  t[37] === a
    ? (M = t[38])
    : ((M = () => {
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, Q.jsx)(Y, { ...$.created })), (t[39] = N))
    : (N = t[39]);
  let F;
  t[40] !== j || t[41] !== M
    ? ((F = (0, Q.jsx)(U.Item, { RightIcon: j, onSelect: M, children: N })),
      (t[40] = j),
      (t[41] = M),
      (t[42] = F))
    : (F = t[42]);
  let I = r === `alphabetical` ? P : void 0,
    L;
  t[43] === a
    ? (L = t[44])
    : ((L = () => {
  ...
  t[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, Q.jsx)(Y, { ...$.alphabetical })), (t[45] = R))
    : (R = t[45]);
  let z;
  t[46] !== I || t[47] !== L
    ? ((z = (0, Q.jsx)(U.Item, { RightIcon: I, onSelect: L, children: R })),
      (t[46] = I),
      (t[47] = L),
      (t[48] = z))
    : (z = t[48]);
...
function Wt(e) {
  ...
  if (
    ...
    ((c = V), (l = `bottom`), (u = `end`), (d = `workspace`), (f = `tall`));
    let o;
    t[19] === a
      ? (o = t[20])
    ...
    t[21] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((_ = (0, Q.jsx)(M, { className: `icon-xs shrink-0` })), (t[21] = _))
      : (_ = t[21]);
    let v;
    t[22] !== n.groupId || t[23] !== n.kind || t[24] !== s
      ? ((v =
          n.kind === `all`
            ? (0, Q.jsx)(Y, { ...$.allProjects })
            : n.groupId === `special:automations`
              ? (0, Q.jsx)(Y, { ...$.automations })
    ...
    let S;
    (t[33] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((S = (0, Q.jsx)(Y, { ...$.allProjects })), (t[33] = S))
      : (S = t[33]),
      t[34] !== b || t[35] !== x
        ? ((m = (0, Q.jsx)(U.Item, { RightIcon: b, onSelect: x, children: S })),
          (t[34] = b),
          (t[35] = x),
          (t[36] = m))
        : (m = t[36]),
      t[37] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((h = (0, Q.jsx)(U.Separator, {})), (t[37] = h))
        : (h = t[37]),
      (g = r.map((t) => {
        let r = e.get(t.label) ?? [],
          a = r.length > 1 ? ge(t.path ?? t.projectId, r) : void 0,
          o = n.kind === `group` && n.groupId === t.groupId;
        return (0, Q.jsx)(
          U.Item,
          {
            LeftIcon: M,
            RightIcon: o ? P : void 0,
            tooltipText: a,
            tooltipAlign: `center`,
            onSelect: () => {
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Q.jsx)(U.Separator, {})), (t[38] = _))
    : (_ = t[38]);
  let v = n.kind === `group` && n.groupId === `special:none` ? P : void 0,
    y;
  t[39] === i
    ? (y = t[40])
    : ((y = () => {
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Q.jsx)(Y, { ...$.chats })), (t[41] = b))
    : (b = t[41]);
  let x;
  t[42] !== v || t[43] !== y
    ? ((x = (0, Q.jsx)(U.Item, { LeftIcon: E, RightIcon: v, onSelect: y, children: b })),
      (t[42] = v),
      (t[43] = y),
      (t[44] = x))
    : (x = t[44]);
  let S = n.kind === `group` && n.groupId === `special:automations` ? P : void 0,
    C;
  t[45] === i
    ? (C = t[46])
    : ((C = () => {
        i({ kind: `group`, groupId: vt });
      }),
      (t[45] = i),
      (t[46] = C));
  let w;
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, Q.jsx)(Y, { ...$.automations })), (t[47] = w))
    : (w = t[47]);
  let T;
  t[48] !== S || t[49] !== C
    ? ((T = (0, Q.jsx)(U.Item, { LeftIcon: Ve, RightIcon: S, onSelect: C, children: w })),
      (t[48] = S),
      (t[49] = C),
      (t[50] = T))
    : (T = t[50]);
...
function Gt(e) {
        ...
        ? (0, Q.jsxs)(`div`, {
            ...
            children: [
              (0, Q.jsxs)(`span`, {
                ...
                children: [
                  (0, Q.jsx)(M, { className: `icon-xs shrink-0` }),
                  (0, Q.jsx)(`span`, {
                    className: `truncate`,
                    children:
                      n.projectLabel == null
                  ...
                  p
                    ? (0, Q.jsx)(V, {
                        ...
                        children: (0, Q.jsx)(U.Item, {
                          ...
                          children: (0, Q.jsx)(Y, { ...$.deleteProjectChats }),
                        }),
                      })
                    : null,
                ],
  ...
  return (
    t[26] !== m || t[27] !== h
      ? ((g = (0, Q.jsxs)(`div`, { className: `flex flex-col`, children: [m, h] })),
        (t[26] = m),
        (t[27] = h),
        (t[28] = g))
      : (g = t[28]),
...
function Kt(e) {
  ...
  t[0] !== n.name || t[1] !== n.preview
    ? ((u = J(n.name?.trim() || n.preview).trim()), (t[0] = n.name), (t[1] = n.preview), (t[2] = u))
    : (u = t[2]);
  let d = u,
    f,
    p,
  ...
  t[21] === y
    ? (b = t[22])
    : ((b = (0, Q.jsx)(`div`, { className: `truncate text-base font-medium`, children: y })),
      (t[21] = y),
      (t[22] = b));
  let x;
  ...
  let E;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(Y, { ...X.unarchive })), (t[41] = E))
    : (E = t[41]);
  let D;
  t[42] !== r || t[43] !== i || t[44] !== T
    ? ((D = (0, Q.jsx)(I, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
function qt(e) {
  ...
  t[8] === s
    ? (l = t[9])
    : ((l = (0, Q.jsx)(I, { color: `ghost`, onClick: s, children: c })), (t[8] = s), (t[9] = l));
  let u;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Q.jsx)(Y, { ...X.delete })), (t[10] = u))
    : (u = t[10]);
  let d;
  t[11] === r
    ? (d = t[12])
    : ((d = (0, Q.jsx)(I, { color: `danger`, onClick: r, children: u })), (t[11] = r), (t[12] = d));
  let f;
  t[13] !== l || t[14] !== d
    ? ((f = (0, Q.jsx)(ee, { children: (0, Q.jsxs)(oe, { children: [l, d] }) })),
      (t[13] = l),
      (t[14] = d),
      (t[15] = f))
    : (f = t[15]);
  ...
  return (
    t[20] !== i || t[21] !== p
      ? ((m = (0, Q.jsx)(se, { open: !0, showDialogClose: !1, onOpenChange: i, children: p })),
        (t[20] = i),
        (t[21] = p),
        (t[22] = m))
      : (m = t[22]),
...
export { Nt as DataControlsSettings };
