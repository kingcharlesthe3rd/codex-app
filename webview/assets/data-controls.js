...
import { _n as Ue, hn as We } from "./app-initial~app-main~automations-page.js";
import {
  G as Ge,
  K as Ke,
...
function ut({
  ...
  return [
    ...
    ...(n ?? []).map((t) => {
      let n = z(t.name?.trim() || t.preview).trim(),
        s = Ze(t.cwd),
        c = Ze(t.path),
...
function dt(e) {
  let t = new o(e, { ignoreLocation: !0, keys: [`searchValues`], threshold: 0.4 });
  return (n) => {
    let r = n.trim();
...
function mt({ assignment: e, fallbackPaths: t = [], projects: n }) {
  ...
  for (let e of t) {
    ...
    let t = ye(e).replace(/\/+$/, ``),
      r = n.filter(
        (e) => e.projectKind === `local` && e.path != null && ye(e.path).replace(/\/+$/, ``) === t,
      );
...
var yt,
  bt,
  xt = e(() => {
    (L(), B(), Ye(), ge(), (yt = `special:automations`), (bt = `special:none`));
  });
function St(e) {
  let t = (0, wt.c)(55),
  ...
  t[0] === n.id
    ...
    : ((c = [`recover-cloud-task`, n.id]),
      (l = () =>
        I.safePost(`/wham/tasks/{task_id}/recover`, { parameters: { path: { task_id: n.id } } })),
      (t[0] = n.id),
      (t[1] = c),
      (t[2] = l));
  let u;
    ...
    ? ((d = () => {
        (a.setQueryData([`tasks`, `archived`], (e) =>
          ...
          i.get(q).info(
            (0, X.jsxs)(`span`, {
              children: [
                (0, X.jsx)(_, { ...Y.unarchiveSuccessPlain }),
                (0, X.jsx)(`button`, {
  ...
  t[13] !== c || t[14] !== l || t[15] !== u || t[16] !== d || t[17] !== f
    ? ((p = { mutationKey: c, mutationFn: l, onError: u, onSuccess: d, onSettled: f }),
      (t[13] = c),
      (t[14] = l),
      (t[15] = u),
      (t[16] = d),
  ...
  let m = Se(p),
    g;
  t[19] === n.title ? (g = t[20]) : ((g = z(n.title ?? ``).trim()), (t[19] = n.title), (t[20] = g));
  let v = g,
    y,
    b,
    x,
  ...
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, X.jsx)(Pe, { className: `icon-sm shrink-0` })), (t[31] = w))
    : (w = t[31]);
  let T;
  t[32] === v
    ? (T = t[33])
  ...
  t[46] === m
    ? (j = t[47])
    : ((j = () => {
        m.isPending || m.mutate();
      }),
      (t[46] = m),
      (t[47] = j));
  let M;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, X.jsx)(_, { ...Y.unarchive })), (t[48] = M))
    : (M = t[48]);
  let N;
  t[49] !== j || t[50] !== m.isPending
    ? ((N = (0, X.jsx)(fe, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
var wt,
  X,
  Tt = e(() => {
    ((wt = U()), y(), b(), A(), p(), ae(), n(), Le(), B(), d(), l(), ct(), (X = we()));
  });
function Et() {
  let e = (0, Mt.c)(2),
    t;
...
async function jt(e) {
  try {
    return await I.safeGet(`/wham/tasks/list`, {
...
function Pt() {
  ...
  e[0] === t
    ...
    : ((c = {
        ...
        queryFn: () => ne(`list-archived-threads`, { hostId: t }),
        enabled: !0,
        staleTime: x.FIVE_SECONDS,
      }),
      (e[0] = t),
      (e[1] = c));
  let { data: l, isLoading: d, isError: f } = re(c),
    {
      data: p,
      fetchNextPage: m,
      hasNextPage: h,
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = u(`inbox-items`, { limit: $t })), (e[2] = b))
    : (b = e[2]);
  let S = t === T,
    C;
  e[3] === S
    ? (C = e[4])
    : ((C = { queryKey: b, queryFn: Lt, enabled: S, staleTime: x.FIVE_SECONDS }),
      (e[3] = S),
      (e[4] = C));
  let { data: w, isLoading: E } = re(C),
    D,
    O;
  if (
    e[5] !== w ||
    ...
    (e[18] === w?.items
      ? (c = e[19])
      : ((c = new Set(w?.items.flatMap(It) ?? [])), (e[18] = w?.items), (e[19] = c)),
      (O = ut({
  ...
  let k = O,
    A;
  e[20] === D ? (A = e[21]) : ((A = D.map(Ft)), (e[20] = D), (e[21] = A));
  let j = `${t}:${A.join(`,`)}`,
    M = h && !_,
    N = d || g || (t === `local` && E),
    P = f || (p == null && y),
...
function Lt() {
  return m(`inbox-items`, { params: { limit: $t } });
}
function Rt(e) {
  let t = (0, Z.c)(121),
    {
    ...
    [b, x] = (0, Zt.useState)(``),
    [S, C] = (0, Zt.useState)(`all`),
    [w, T] = (0, Zt.useState)(Qt),
    [E, D] = (0, Zt.useState)(`updated`),
    O = new Set([...r.map(Ht), bt, yt]),
    A = w.kind === `all` || O.has(w.groupId) ? w : Qt,
    M = A.kind === `all` ? `project` : `none`,
    N;
  t[0] !== A || t[1] !== n || t[2] !== S || t[3] !== b || t[4] !== E || t[5] !== M
    ? ((N = ft({
        entries: n,
        groupKey: M,
        kindFilter: S,
  ...
  let F = N,
    ...
    ee;
  t[7] !== n || t[8] !== a
    ? ((ee = a === `local` && n.some(Vt)), (t[7] = n), (t[8] = a), (t[9] = ee))
    : (ee = t[9]);
  let L = ee,
    R;
  t[10] !== a || t[11] !== m || t[12] !== g || t[13] !== d
    ? ((R = (e) => {
        (i(e.id), a === `local` && g(e.id));
      }),
      (t[10] = a),
      (t[11] = m),
      (t[12] = g),
  ...
  t[15] === a
    ? ((B = t[16]), (re = t[17]))
    : ((B = [`unarchive-thread`, a]),
      (re = async (e) => (
        await ne(`unarchive-conversation`, { hostId: a, conversationId: i(e.id) }),
        e
      )),
      (t[15] = a),
      (t[16] = B),
  ...
  t[18] !== a || t[19] !== f || t[20] !== d
    ? ((V = async (e) => {
        (d
          ...
          await f.cancelQueries({ queryKey: [`archived-threads`, a] }));
        let t = f.getQueryData([`archived-threads`, a]) ?? [];
        return (
          f.setQueryData(
            [`archived-threads`, a],
    ...
    : (V = t[21]);
  let H;
  t[22] !== a || t[23] !== p || t[24] !== f || t[25] !== d
    ? ((H = (e, t, n) => {
        let r = e instanceof P;
        (!r && n?.previousThreads && f.setQueryData([`archived-threads`, a], n.previousThreads),
          d
            .get(q)
  ...
  t[27] !== z || t[28] !== d
    ? ((ie = (e) => {
        d.get(q).info(
          (0, Q.jsxs)(`span`, {
            children: [
              (0, Q.jsx)(_, { ...Y.unarchiveSuccessPlain }),
              (0, Q.jsx)(`button`, {
                className: `pointer-events-auto ml-1 cursor-interaction text-token-link underline-offset-2 hover:underline`,
                type: `button`,
                onClick: () => {
  ...
  t[30] !== a || t[31] !== f
    ? ((ae = () => {
        f.invalidateQueries({ queryKey: [`archived-threads`, a] });
      }),
      (t[30] = a),
      (t[31] = f),
      (t[32] = ae))
    : (ae = t[32]);
  let oe;
  t[33] !== ae || t[34] !== B || t[35] !== re || t[36] !== V || t[37] !== H || t[38] !== ie
    ? ((oe = {
        mutationKey: B,
        mutationFn: re,
        onMutate: V,
  ...
  t[40] === a
    ? ((W = t[41]), (se = t[42]))
    : ((W = [`delete-archived-conversations`, a]),
      (se = async (e) =>
        e.kind === `all`
          ? ne(`delete-all-archived-conversations`, { hostId: a })
          : e.kind === `project`
            ? (
                await Promise.all(
                  e.threadIds.map((e) =>
                    ne(`delete-archived-conversation`, { hostId: a, conversationId: i(e) }),
                  ),
                )
              ).flat()
            : ne(`delete-archived-conversation`, { hostId: a, conversationId: i(e.thread.id) })),
      (t[40] = a),
      (t[41] = W),
      (t[42] = se));
  let le;
  t[43] !== a || t[44] !== f || t[45] !== d
    ? ((le = async (e) => {
        ...
        (d
          ...
          .info(
            e.kind === `single`
              ? (0, Q.jsx)(_, { ...Y.deleting })
              : (0, Q.jsx)(_, { ...Y.deletingAll }),
            { id: Xt(e), duration: 0, hasCloseButton: !1 },
          ),
          await f.cancelQueries({ queryKey: [`archived-threads`, a] }));
        let n = f.getQueryData([`archived-threads`, a]) ?? [];
        return (
          f.setQueryData(
            [`archived-threads`, a],
    ...
    : (le = t[46]);
  let ue;
  t[47] !== a || t[48] !== p || t[49] !== f || t[50] !== d
    ? ((ue = (e, t, n) => {
        (n?.previousThreads && f.setQueryData([`archived-threads`, a], n.previousThreads),
          d
            .get(q)
            .danger(
              p.formatMessage(
  ...
  t[52] !== p || t[53] !== d
    ? ((pe = (e, t) => {
        ...
        d.get(q).success(p.formatMessage(Y.deleteSuccessPlain), { id: Xt(t) });
      }),
      (t[52] = p),
      (t[53] = d),
      (t[54] = pe))
  ...
  t[55] !== a || t[56] !== f
    ...
    : (me = t[57]);
  let he;
  t[58] !== W || t[59] !== se || t[60] !== le || t[61] !== ue || t[62] !== pe || t[63] !== me
    ? ((he = {
        mutationKey: W,
        mutationFn: se,
        onMutate: le,
  ...
  if (s) {
    ...
    t[68] !== A || t[69] !== S || t[70] !== r || t[71] !== E
      ? ((e = (0, Q.jsx)(`div`, {
          ...
          children: (0, Q.jsx)(Ut, {
            ...
            projects: r,
            sortKey: E,
            onKindFilterChange: C,
            onProjectFilterChange: T,
    ...
    t[73] !== I || t[74] !== c || t[75] !== F.length
      ...
      : (n = t[76]);
    let i;
    if (t[77] !== A.kind || t[78] !== G || t[79] !== a || t[80] !== U || t[81] !== F) {
      let e;
      (t[83] !== A.kind || t[84] !== G || t[85] !== a || t[86] !== U
        ? ((e = (e) =>
            (0, Q.jsx)(
              Kt,
              {
    ...
    t[88] === u
      ...
      : ((o = () => {
        ...
        (t[89] = o));
    let s;
    t[90] !== I || t[91] !== c || t[92] !== o
      ? ((s = (0, Q.jsx)(rt, { hasNextPage: I, isFetchingNextPage: c, onLoadNextPage: o })),
        (t[90] = I),
        (t[91] = c),
        (t[92] = o),
        (t[93] = s))
  ...
  t[101] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (_e = t[101]);
  let ve;
  t[102] !== G || t[103] !== L || t[104] !== l || t[105] !== s
    ? ((ve =
        L && !s && !l
          ? (0, Q.jsxs)(fe, {
              color: `danger`,
  ...
  t[107] === K
    ...
    : ((ye = (0, Q.jsx)(tt, {
      ...
      (t[108] = ye));
  let be;
  t[109] !== n || t[110] !== ge || t[111] !== v
    ? ((be = () => {
        if (v != null) {
          if ((y(null), v.kind === `all`)) {
            ge.mutate({ kind: `all`, threadIds: n.flatMap(Bt) });
            return;
          }
          if (v.kind === `project`) {
            ge.mutate({
          ...
          ge.mutate({ kind: `single`, thread: v.thread });
        }
      }),
      (t[109] = n),
      (t[110] = ge),
  ...
  let we;
  t[114] !== v || t[115] !== be
    ? ((we = (0, Q.jsx)(Jt, { state: v, onConfirm: be, onOpenChange: Ce })),
      (t[114] = v),
      (t[115] = be),
      (t[116] = we))
    : (we = t[116]);
...
function Wt(e) {
  ...
  t[5] === l
    ? (u = t[6])
    : ((u = (0, Q.jsx)(`span`, { className: `truncate`, children: (0, Q.jsx)(_, { ...l }) })),
      (t[5] = l),
      (t[6] = u));
  let d;
  t[7] !== s || t[8] !== u
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Q.jsx)(J.SectionLabel, { children: (0, Q.jsx)(_, { ...$.type }) })), (t[10] = f))
    : (f = t[10]);
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Q.jsx)(_, { ...$.local })), (t[19] = b))
    : (b = t[19]);
  let x;
  t[20] !== v || t[21] !== y
    ? ((x = (0, Q.jsx)(J.Item, { RightIcon: v, onSelect: y, children: b })),
      (t[20] = v),
      (t[21] = y),
      (t[22] = x))
    : (x = t[22]);
  let S = n === `cloud` ? H : void 0,
    C;
  t[23] === i
    ? (C = t[24])
    : ((C = () => {
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, Q.jsx)(_, { ...$.cloud })), (t[25] = w))
    : (w = t[25]);
  let T;
  t[26] !== S || t[27] !== C
    ? ((T = (0, Q.jsx)(J.Item, { RightIcon: S, onSelect: C, children: w })),
      (t[26] = S),
      (t[27] = C),
      (t[28] = T))
    : (T = t[28]);
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(J.Separator, {})), (t[29] = E))
    : (E = t[29]);
  let D;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, Q.jsx)(J.SectionLabel, { children: (0, Q.jsx)(_, { ...$.sortBy }) })), (t[30] = D))
    : (D = t[30]);
  let O = r === `updated` ? H : void 0,
    A;
  t[31] === a
    ? (A = t[32])
    : ((A = () => {
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (0, Q.jsx)(_, { ...$.updated })), (t[33] = j))
    : (j = t[33]);
  let M;
  t[34] !== O || t[35] !== A
    ? ((M = (0, Q.jsx)(J.Item, { RightIcon: O, onSelect: A, children: j })),
      (t[34] = O),
      (t[35] = A),
      (t[36] = M))
    : (M = t[36]);
  let N = r === `created` ? H : void 0,
    P;
  t[37] === a
    ? (P = t[38])
    : ((P = () => {
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, Q.jsx)(_, { ...$.created })), (t[39] = F))
    : (F = t[39]);
  let I;
  t[40] !== N || t[41] !== P
    ? ((I = (0, Q.jsx)(J.Item, { RightIcon: N, onSelect: P, children: F })),
      (t[40] = N),
      (t[41] = P),
      (t[42] = I))
    : (I = t[42]);
  let ee = r === `alphabetical` ? H : void 0,
    L;
  t[43] === a
    ? (L = t[44])
    : ((L = () => {
  ...
  t[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, Q.jsx)(_, { ...$.alphabetical })), (t[45] = R))
    : (R = t[45]);
  let z;
  t[46] !== ee || t[47] !== L
    ? ((z = (0, Q.jsx)(J.Item, { RightIcon: ee, onSelect: L, children: R })),
      (t[46] = ee),
      (t[47] = L),
      (t[48] = z))
    : (z = t[48]);
...
function Gt(e) {
  ...
  if (
    ...
    ((c = W), (l = `bottom`), (u = `end`), (d = `workspace`), (f = `tall`));
    let o;
    t[19] === a
      ? (o = t[20])
    ...
    t[22] !== n.groupId || t[23] !== n.kind || t[24] !== s
      ? ((y =
          n.kind === `all`
            ? (0, Q.jsx)(_, { ...$.allProjects })
            : n.groupId === `special:automations`
              ? (0, Q.jsx)(_, { ...$.automations })
    ...
    let C;
    (t[33] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((C = (0, Q.jsx)(_, { ...$.allProjects })), (t[33] = C))
      : (C = t[33]),
      t[34] !== x || t[35] !== S
        ? ((m = (0, Q.jsx)(J.Item, { RightIcon: x, onSelect: S, children: C })),
          (t[34] = x),
          (t[35] = S),
          (t[36] = m))
        : (m = t[36]),
      ...
      (g = r.map((t) => {
        let r = e.get(t.label) ?? [],
          a = r.length > 1 ? me(t.path ?? t.projectId, r) : void 0,
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, Q.jsx)(_, { ...$.chats })), (t[41] = x))
    : (x = t[41]);
  let S;
  t[42] !== y || t[43] !== b
    ? ((S = (0, Q.jsx)(J.Item, { LeftIcon: Ge, RightIcon: y, onSelect: b, children: x })),
      (t[42] = y),
      (t[43] = b),
      (t[44] = S))
    : (S = t[44]);
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, Q.jsx)(_, { ...$.automations })), (t[47] = T))
    : (T = t[47]);
  let E;
  t[48] !== C || t[49] !== w
    ? ((E = (0, Q.jsx)(J.Item, { LeftIcon: Ne, RightIcon: C, onSelect: w, children: T })),
      (t[48] = C),
      (t[49] = w),
      (t[50] = E))
    : (E = t[50]);
                  ...
                  p
                    ? (0, Q.jsx)(W, {
                        ...
                        children: (0, Q.jsx)(J.Item, {
                          ...
                          children: (0, Q.jsx)(_, { ...$.deleteProjectChats }),
                        }),
                      })
                    : null,
                ],
...
function qt(e) {
  ...
  t[0] !== n.name || t[1] !== n.preview
    ? ((u = z(n.name?.trim() || n.preview).trim()), (t[0] = n.name), (t[1] = n.preview), (t[2] = u))
    : (u = t[2]);
  let d = u,
    f,
    p,
  ...
  let D;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, Q.jsx)(_, { ...Y.unarchive })), (t[41] = D))
    : (D = t[41]);
  let O;
...
function Jt(e) {
  ...
  t[8] === s
    ? (u = t[9])
    : ((u = (0, Q.jsx)(fe, { color: `ghost`, onClick: s, children: l })), (t[8] = s), (t[9] = u));
  let d;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(_, { ...Y.delete })), (t[10] = d))
    : (d = t[10]);
  let f;
  t[11] === r
    ? (f = t[12])
    : ((f = (0, Q.jsx)(fe, { color: `danger`, onClick: r, children: d })),
      (t[11] = r),
      (t[12] = f));
  let p;
  t[13] !== u || t[14] !== f
    ? ((p = (0, Q.jsx)(Oe, { children: (0, Q.jsxs)(F, { children: [u, f] }) })),
      (t[13] = u),
      (t[14] = f),
      (t[15] = p))
    : (p = t[15]);
  let m;
  t[16] !== a || t[17] !== o || t[18] !== p
    ? ((m = (0, Q.jsxs)(ke, { children: [a, o, p] })),
      (t[16] = a),
      (t[17] = o),
      (t[18] = p),
      (t[19] = m))
  ...
  return (
    t[20] !== i || t[21] !== m
      ? ((h = (0, Q.jsx)(ee, { open: !0, showDialogClose: !1, onOpenChange: i, children: m })),
        (t[20] = i),
        (t[21] = m),
        (t[22] = h))
      : (h = t[22]),
