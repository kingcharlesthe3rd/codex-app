...
import { J as De, K as Oe } from "./app-initial~app-main~automations-page.js";
import {
  $ as ke,
  Q as Ae,
  _t as je,
...
function ut({
  ...
  return [
    ...
    ...(n ?? []).map((t) => {
      let n = H(t.name?.trim() || t.preview).trim(),
        s = Xe(t.cwd),
        c = Xe(t.path),
...
function dt(e) {
  let t = new Te(e, { ignoreLocation: !0, keys: [`searchValues`], threshold: 0.4 });
  return (n) => {
    let r = n.trim();
...
function mt({ assignment: e, fallbackPaths: t = [], projects: n }) {
  ...
  for (let e of t) {
    ...
    let t = m(e).replace(/\/+$/, ``),
      r = n.filter(
        (e) => e.projectKind === `local` && e.path != null && m(e.path).replace(/\/+$/, ``) === t,
      );
...
var yt,
  bt,
  xt = e(() => {
    (te(), G(), Ze(), Se(), (yt = `special:automations`), (bt = `special:none`));
  });
function St(e) {
  let t = (0, wt.c)(55),
  ...
  t[3] !== o || t[4] !== i
    ? ((d = () => {
        i.get(q).danger(o.formatMessage(Y.unarchiveError));
      }),
      (t[3] = o),
      (t[4] = i),
      (t[5] = d))
    ...
    ? ((p = () => {
        (a.setQueryData([`tasks`, `archived`], (e) =>
          ...
          i.get(q).info(
            (0, X.jsxs)(`span`, {
              children: [
                (0, X.jsx)(K, { ...Y.unarchiveSuccessPlain }),
                (0, X.jsx)(`button`, {
  ...
  t[11] === a
    ...
    : ((m = () => {
      ...
      (t[12] = m));
  let h;
  t[13] !== l || t[14] !== u || t[15] !== d || t[16] !== p || t[17] !== m
    ? ((h = { mutationKey: l, mutationFn: u, onError: d, onSuccess: p, onSettled: m }),
      (t[13] = l),
      (t[14] = u),
      (t[15] = d),
      (t[16] = p),
  ...
  let g = b(h),
    _;
  t[19] === n.title ? (_ = t[20]) : ((_ = H(n.title ?? ``).trim()), (t[19] = n.title), (t[20] = _));
  let v = _,
    y,
    x,
    S,
  ...
  if (t[21] !== n || t[22] !== o || t[23] !== r) {
    ...
    (t[28] !== n.task_status_display?.environment_label || t[29] !== r
      ...
      (x = i),
      (S = e != null),
      (y = S ? o.formatDate(e, { year: `numeric`, month: `short`, day: `numeric` }) : ``),
      (w = S ? o.formatTime(e, { hour: `numeric`, minute: `2-digit` }) : ``),
      (t[21] = n),
      (t[22] = o),
      (t[23] = r),
      (t[24] = y),
      ...
      (t[26] = S),
      (t[27] = w));
  } else ((y = t[24]), (x = t[25]), (S = t[26]), (w = t[27]));
  let D = w,
    O;
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, X.jsx)(Ue, { className: `icon-sm shrink-0` })), (t[31] = O))
    : (O = t[31]);
  let k;
  t[32] === v
    ? (k = t[33])
  ...
  t[34] === k
    ...
    : ((A = (0, X.jsxs)(`div`, {
        ...
        children: [O, (0, X.jsx)(`span`, { className: `truncate`, children: k })],
      })),
      (t[34] = k),
      (t[35] = A));
  let j;
  t[36] !== y || t[37] !== x || t[38] !== S || t[39] !== D
    ? ((j = S
        ? x
          ? (0, X.jsx)(K, {
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (0, X.jsx)(K, { ...Y.unarchive })), (t[48] = F))
    : (F = t[48]);
  let I;
  t[49] !== P || t[50] !== g.isPending
    ? ((I = (0, X.jsx)(c, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
var wt,
  X,
  Tt = e(() => {
    ((wt = ge()), a(), i(), ae(), le(), x(), V(), Ge(), G(), r(), h(), ct(), (X = s()));
  });
function Et() {
  let e = (0, Mt.c)(2),
    t;
...
async function jt(e) {
  try {
    ...
    if (e instanceof ue && (e.status === 401 || e.status === 403 || e.status === 404))
...
function Pt() {
  ...
  e[0] === t
    ...
    : ((o = {
        ...
        queryFn: () => pe(`list-archived-threads`, { hostId: t }),
        enabled: !0,
        staleTime: R.FIVE_SECONDS,
      }),
      (e[0] = t),
      (e[1] = o));
  let { data: s, isLoading: c, isError: l } = _(o),
    {
      data: u,
      fetchNextPage: d,
      hasNextPage: f,
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = P(`inbox-items`, { limit: $t })), (e[2] = b))
    : (b = e[2]);
  let x = t === k,
    S;
  e[3] === x
    ? (S = e[4])
    : ((S = { queryKey: b, queryFn: Lt, enabled: x, staleTime: R.FIVE_SECONDS }),
      (e[3] = x),
      (e[4] = S));
  let { data: C, isLoading: w } = _(S),
    T,
    E;
  if (
    e[5] !== C ||
    ...
    (e[18] === C?.items
      ? (l = e[19])
      : ((l = new Set(C?.items.flatMap(It) ?? [])), (e[18] = C?.items), (e[19] = l)),
      (E = ut({
  ...
  let D = E,
    O;
  e[20] === T ? (O = e[21]) : ((O = T.map(Ft)), (e[20] = T), (e[21] = O));
  let A = `${t}:${O.join(`,`)}`,
    j = f && !m,
    M = c || p || (t === `local` && w),
    N = l || (u == null && v),
...
function Lt() {
  return F(`inbox-items`, { params: { limit: $t } });
}
function Rt(e) {
  let t = (0, Z.c)(121),
    {
    ...
    [D, O] = (0, Zt.useState)(Qt),
    [k, A] = (0, Zt.useState)(`updated`),
    j = new Set([...r.map(Ht), bt, yt]),
    M = D.kind === `all` || j.has(D.groupId) ? D : Qt,
    N = M.kind === `all` ? `project` : `none`,
    P;
  t[0] !== M || t[1] !== n || t[2] !== w || t[3] !== x || t[4] !== k || t[5] !== N
    ? ((P = ft({
        entries: n,
        groupKey: N,
        kindFilter: w,
  ...
  let F = P,
    ...
    L;
  t[7] !== n || t[8] !== i
    ? ((L = i === `local` && n.some(Vt)), (t[7] = n), (t[8] = i), (t[9] = L))
    : (L = t[9]);
  let R = L,
    z;
  t[10] !== i || t[11] !== g || t[12] !== _ || t[13] !== p
    ? ((z = (e) => {
        (he(e.id), i === `local` && _(e.id));
      }),
      (t[10] = i),
      (t[11] = g),
      (t[12] = _),
  ...
  t[15] === i
    ? ((ee = t[16]), (te = t[17]))
    : ((ee = [`unarchive-thread`, i]),
      (te = async (e) => (
        await pe(`unarchive-conversation`, { hostId: i, conversationId: he(e.id) }),
        e
      )),
      (t[15] = i),
      (t[16] = ee),
  ...
  t[18] !== i || t[19] !== m || t[20] !== p
    ? ((V = async (e) => {
        (p
          ...
          await m.cancelQueries({ queryKey: [`archived-threads`, i] }));
        let t = m.getQueryData([`archived-threads`, i]) ?? [];
        return (
          m.setQueryData(
            [`archived-threads`, i],
    ...
    : (V = t[21]);
  let ne;
  t[22] !== i || t[23] !== h || t[24] !== m || t[25] !== p
    ? ((ne = (e, t, n) => {
        let r = e instanceof u;
        (!r && n?.previousThreads && m.setQueryData([`archived-threads`, i], n.previousThreads),
          p
            .get(q)
  ...
  t[27] !== B || t[28] !== p
    ? ((re = (e) => {
        p.get(q).info(
          (0, Q.jsxs)(`span`, {
            children: [
              (0, Q.jsx)(K, { ...Y.unarchiveSuccessPlain }),
              (0, Q.jsx)(`button`, {
                className: `pointer-events-auto ml-1 cursor-interaction text-token-link underline-offset-2 hover:underline`,
                type: `button`,
                onClick: () => {
  ...
  t[30] !== i || t[31] !== m
    ? ((ie = () => {
        m.invalidateQueries({ queryKey: [`archived-threads`, i] });
      }),
      (t[30] = i),
      (t[31] = m),
      (t[32] = ie))
    : (ie = t[32]);
  let ae;
  t[33] !== ie || t[34] !== ee || t[35] !== te || t[36] !== V || t[37] !== ne || t[38] !== re
    ? ((ae = {
        mutationKey: ee,
        mutationFn: te,
        onMutate: V,
  ...
  t[40] === i
    ? ((oe = t[41]), (se = t[42]))
    : ((oe = [`delete-archived-conversations`, i]),
      (se = async (e) =>
        e.kind === `all`
          ? pe(`delete-all-archived-conversations`, { hostId: i })
          : e.kind === `project`
            ? (
                await Promise.all(
                  e.threadIds.map((e) =>
                    pe(`delete-archived-conversation`, { hostId: i, conversationId: he(e) }),
                  ),
                )
              ).flat()
            : pe(`delete-archived-conversation`, { hostId: i, conversationId: he(e.thread.id) })),
      (t[40] = i),
      (t[41] = oe),
      (t[42] = se));
  let le;
  t[43] !== i || t[44] !== m || t[45] !== p
    ? ((le = async (e) => {
        ...
        (p
          ...
          .info(
            e.kind === `single`
              ? (0, Q.jsx)(K, { ...Y.deleting })
              : (0, Q.jsx)(K, { ...Y.deletingAll }),
            { id: Xt(e), duration: 0, hasCloseButton: !1 },
          ),
          await m.cancelQueries({ queryKey: [`archived-threads`, i] }));
        let n = m.getQueryData([`archived-threads`, i]) ?? [];
        return (
          m.setQueryData(
            [`archived-threads`, i],
    ...
    : (le = t[46]);
  let ue;
  t[47] !== i || t[48] !== h || t[49] !== m || t[50] !== p
    ? ((ue = (e, t, n) => {
        (n?.previousThreads && m.setQueryData([`archived-threads`, i], n.previousThreads),
          p
            .get(q)
            .danger(
              h.formatMessage(
  ...
  t[52] !== h || t[53] !== p
    ? ((de = (e, t) => {
        ...
        p.get(q).success(h.formatMessage(Y.deleteSuccessPlain), { id: Xt(t) });
      }),
      (t[52] = h),
      (t[53] = p),
      (t[54] = de))
  ...
  t[55] !== i || t[56] !== m
    ...
    : (me = t[57]);
  let ge;
  t[58] !== oe || t[59] !== se || t[60] !== le || t[61] !== ue || t[62] !== de || t[63] !== me
    ? ((ge = {
        mutationKey: oe,
        mutationFn: se,
        onMutate: le,
  ...
  if (o) {
    ...
    t[73] !== I || t[74] !== s || t[75] !== F.length
      ...
      : (n = t[76]);
    let a;
    if (t[77] !== M.kind || t[78] !== W || t[79] !== i || t[80] !== H || t[81] !== F) {
      let e;
      (t[83] !== M.kind || t[84] !== W || t[85] !== i || t[86] !== H
        ? ((e = (e) =>
            (0, Q.jsx)(
              Kt,
              {
                ...
                unarchivingThreadId: H.variables?.id ?? null,
                isUnarchiving: H.isPending,
    ...
    t[88] === d
      ...
      : ((o = () => {
        ...
        (t[89] = o));
    let c;
    t[90] !== I || t[91] !== s || t[92] !== o
      ? ((c = (0, Q.jsx)(rt, { hasNextPage: I, isFetchingNextPage: s, onLoadNextPage: o })),
        (t[90] = I),
        (t[91] = s),
        (t[92] = o),
        (t[93] = c))
      : (c = t[93]);
    let l;
    t[94] !== n || t[95] !== a || t[96] !== c
      ? ((l = (0, Q.jsx)(`div`, {
          className: `min-h-0 flex-1 overflow-y-auto`,
          children: (0, Q.jsxs)(`div`, { className: `flex flex-col`, children: [n, a, c] }),
        })),
        (t[94] = n),
        (t[95] = a),
        (t[96] = c),
    ...
    let u;
    (t[98] !== e || t[99] !== l
      ? ((u = (0, Q.jsxs)($e, { className: `max-h-[min(80vh)]`, children: [e, l] })),
        (t[98] = e),
        (t[99] = l),
        (t[100] = u))
      : (u = t[100]),
  ...
  t[101] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_e = (0, Q.jsx)(qe, { slug: `data-controls` })), (t[101] = _e))
    : (_e = t[101]);
  let ve;
  t[102] !== W || t[103] !== R || t[104] !== l || t[105] !== o
    ? ((ve =
        R && !o && !l
          ? (0, Q.jsxs)(c, {
              color: `danger`,
  ...
  t[107] === G
    ...
    : ((ye = (0, Q.jsx)(tt, {
        className: `gap-2`,
        children: (0, Q.jsx)(tt.Content, { children: G }),
      })),
      (t[107] = G),
      (t[108] = ye));
  let be;
  t[109] !== n || t[110] !== U || t[111] !== v
    ? ((be = () => {
        if (v != null) {
          if ((y(null), v.kind === `all`)) {
            U.mutate({ kind: `all`, threadIds: n.flatMap(Bt) });
            return;
          }
          if (v.kind === `project`) {
            U.mutate({
              ...
              threadIds: v.threads.map(zt),
            });
            return;
          }
          U.mutate({ kind: `single`, thread: v.thread });
        }
      }),
      (t[109] = n),
      (t[110] = U),
  ...
  let xe;
  t[114] !== v || t[115] !== be
    ? ((xe = (0, Q.jsx)(Jt, { state: v, onConfirm: be, onOpenChange: J })),
      (t[114] = v),
      (t[115] = be),
      (t[116] = xe))
    : (xe = t[116]);
...
function Wt(e) {
  ...
  t[5] === l
    ? (u = t[6])
    : ((u = (0, Q.jsx)(`span`, { className: `truncate`, children: (0, Q.jsx)(K, { ...l }) })),
      (t[5] = l),
      (t[6] = u));
  let d;
  t[7] !== s || t[8] !== u
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Q.jsx)(U.SectionLabel, { children: (0, Q.jsx)(K, { ...$.type }) })), (t[10] = f))
    : (f = t[10]);
  let m = n === `all` ? J : void 0,
    h;
  t[11] === i
    ? (h = t[12])
    : ((h = () => {
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, Q.jsx)(K, { ...$.allChats })), (t[13] = g))
    : (g = t[13]);
  let _;
  t[14] !== m || t[15] !== h
    ? ((_ = (0, Q.jsx)(U.Item, { RightIcon: m, onSelect: h, children: g })),
      (t[14] = m),
      (t[15] = h),
      (t[16] = _))
    : (_ = t[16]);
  ...
  t[19] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Q.jsx)(K, { ...$.local })), (t[19] = b))
    : (b = t[19]);
  let x;
  t[20] !== v || t[21] !== y
    ? ((x = (0, Q.jsx)(U.Item, { RightIcon: v, onSelect: y, children: b })),
      (t[20] = v),
      (t[21] = y),
      (t[22] = x))
    : (x = t[22]);
  let S = n === `cloud` ? J : void 0,
    C;
  t[23] === i
    ? (C = t[24])
    : ((C = () => {
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, Q.jsx)(K, { ...$.cloud })), (t[25] = w))
    : (w = t[25]);
  let T;
  t[26] !== S || t[27] !== C
    ? ((T = (0, Q.jsx)(U.Item, { RightIcon: S, onSelect: C, children: w })),
      (t[26] = S),
      (t[27] = C),
      (t[28] = T))
    : (T = t[28]);
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(U.Separator, {})), (t[29] = E))
    : (E = t[29]);
  let D;
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, Q.jsx)(U.SectionLabel, { children: (0, Q.jsx)(K, { ...$.sortBy }) })), (t[30] = D))
    : (D = t[30]);
  let O = r === `updated` ? J : void 0,
    k;
  t[31] === a
    ? (k = t[32])
    : ((k = () => {
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, Q.jsx)(K, { ...$.updated })), (t[33] = A))
    : (A = t[33]);
  let j;
  t[34] !== O || t[35] !== k
    ? ((j = (0, Q.jsx)(U.Item, { RightIcon: O, onSelect: k, children: A })),
      (t[34] = O),
      (t[35] = k),
      (t[36] = j))
    : (j = t[36]);
  let M = r === `created` ? J : void 0,
    N;
  t[37] === a
    ? (N = t[38])
    : ((N = () => {
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = (0, Q.jsx)(K, { ...$.created })), (t[39] = P))
    : (P = t[39]);
  let F;
  t[40] !== M || t[41] !== N
    ? ((F = (0, Q.jsx)(U.Item, { RightIcon: M, onSelect: N, children: P })),
      (t[40] = M),
      (t[41] = N),
      (t[42] = F))
    : (F = t[42]);
  let I = r === `alphabetical` ? J : void 0,
    L;
  t[43] === a
    ? (L = t[44])
    : ((L = () => {
  ...
  t[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, Q.jsx)(K, { ...$.alphabetical })), (t[45] = R))
    : (R = t[45]);
  let z;
  t[46] !== I || t[47] !== L
...
function Gt(e) {
  ...
  if (
    ...
    ((c = p), (l = `bottom`), (u = `end`), (d = `workspace`), (f = `tall`));
    let o;
    t[19] === a
      ? (o = t[20])
    ...
    t[21] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((v = (0, Q.jsx)(j, { className: `icon-xs shrink-0` })), (t[21] = v))
      : (v = t[21]);
    let y;
    t[22] !== n.groupId || t[23] !== n.kind || t[24] !== s
      ? ((y =
          n.kind === `all`
            ? (0, Q.jsx)(K, { ...$.allProjects })
            : n.groupId === `special:automations`
              ? (0, Q.jsx)(K, { ...$.automations })
    ...
    let C;
    (t[33] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((C = (0, Q.jsx)(K, { ...$.allProjects })), (t[33] = C))
      : (C = t[33]),
      t[34] !== x || t[35] !== S
      ...
      (_ = r.map((t) => {
        let r = e.get(t.label) ?? [],
          a = r.length > 1 ? we(t.path ?? t.projectId, r) : void 0,
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, Q.jsx)(K, { ...$.chats })), (t[41] = x))
    : (x = t[41]);
  let S;
  t[42] !== y || t[43] !== b
    ? ((S = (0, Q.jsx)(U.Item, { LeftIcon: Ae, RightIcon: y, onSelect: b, children: x })),
      (t[42] = y),
      (t[43] = b),
      (t[44] = S))
    : (S = t[44]);
  let C = n.kind === `group` && n.groupId === `special:automations` ? J : void 0,
    w;
  t[45] === i
    ? (w = t[46])
    : ((w = () => {
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, Q.jsx)(K, { ...$.automations })), (t[47] = T))
    : (T = t[47]);
  let E;
  t[48] !== C || t[49] !== w
    ? ((E = (0, Q.jsx)(U.Item, { LeftIcon: Ve, RightIcon: C, onSelect: w, children: T })),
      (t[48] = C),
      (t[49] = w),
      (t[50] = E))
    : (E = t[50]);
...
function Kt(e) {
        ...
        ? (0, Q.jsxs)(`div`, {
            ...
            children: [
              (0, Q.jsxs)(`span`, {
                ...
                children: [
                  (0, Q.jsx)(j, { className: `icon-xs shrink-0` }),
                  (0, Q.jsx)(`span`, {
                    className: `truncate`,
                    children:
                      n.projectLabel == null
                  ...
                  m
                    ? (0, Q.jsx)(p, {
                        ...
                        children: (0, Q.jsx)(U.Item, {
                          ...
                          children: (0, Q.jsx)(K, { ...$.deleteProjectChats }),
                        }),
                      })
                    : null,
                ],
  ...
  return (
    t[26] !== h || t[27] !== g
      ? ((_ = (0, Q.jsxs)(`div`, { className: `flex flex-col`, children: [h, g] })),
        (t[26] = h),
        (t[27] = g),
        (t[28] = _))
      : (_ = t[28]),
...
function qt(e) {
  ...
  t[0] !== n.name || t[1] !== n.preview
    ? ((d = H(n.name?.trim() || n.preview).trim()), (t[0] = n.name), (t[1] = n.preview), (t[2] = d))
    : (d = t[2]);
  let f = d,
    p,
    m,
  ...
  t[21] === b
    ? (x = t[22])
    : ((x = (0, Q.jsx)(`div`, { className: `truncate text-base font-medium`, children: b })),
      (t[21] = b),
      (t[22] = x));
  let S;
  ...
  let D;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, Q.jsx)(K, { ...Y.unarchive })), (t[41] = D))
    : (D = t[41]);
  let O;
  t[42] !== r || t[43] !== i || t[44] !== E
    ? ((O = (0, Q.jsx)(c, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
function Jt(e) {
  ...
  t[8] === s
    ? (f = t[9])
    : ((f = (0, Q.jsx)(c, { color: `ghost`, onClick: s, children: u })), (t[8] = s), (t[9] = f));
  let p;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, Q.jsx)(K, { ...Y.delete })), (t[10] = p))
    : (p = t[10]);
  let m;
  t[11] === r
    ? (m = t[12])
    : ((m = (0, Q.jsx)(c, { color: `danger`, onClick: r, children: p })), (t[11] = r), (t[12] = m));
  let h;
  t[13] !== f || t[14] !== m
    ? ((h = (0, Q.jsx)(l, { children: (0, Q.jsxs)(O, { children: [f, m] }) })),
      (t[13] = f),
      (t[14] = m),
      (t[15] = h))
    : (h = t[15]);
  ...
  return (
    t[20] !== i || t[21] !== g
      ? ((_ = (0, Q.jsx)(be, { open: !0, showDialogClose: !1, onOpenChange: i, children: g })),
        (t[20] = i),
        (t[21] = g),
        (t[22] = _))
      : (_ = t[22]),
