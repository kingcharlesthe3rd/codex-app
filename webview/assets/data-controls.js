...
import { dt as we, lt as Te } from "./app-initial~app-main~automations-page.js";
import {
  Bt as Ee,
  Er as De,
  Gt as Oe,
...
function ut({
  ...
  return [
    ...
    ...(n ?? []).map((t) => {
      let n = B(t.name?.trim() || t.preview).trim(),
        s = Be(t.cwd),
        c = Be(t.path),
...
function dt(e) {
  let t = new Pe(e, { ignoreLocation: !0, keys: [`searchValues`], threshold: 0.4 });
  return (n) => {
    let r = n.trim();
...
function mt({ assignment: e, fallbackPaths: t = [], projects: n }) {
  ...
  for (let e of t) {
    ...
    let t = y(e).replace(/\/+$/, ``),
      r = n.filter(
        (e) => e.projectKind === `local` && e.path != null && y(e.path).replace(/\/+$/, ``) === t,
      );
...
var yt,
  bt,
  xt = e(() => {
    (je(), ee(), Ve(), pe(), (yt = `special:automations`), (bt = `special:none`));
  });
function St(e) {
  let t = (0, wt.c)(55),
  ...
  t[3] !== s || t[4] !== i
    ? ((d = () => {
        i.get(U).danger(s.formatMessage(Y.unarchiveError));
      }),
      (t[3] = s),
      (t[4] = i),
      (t[5] = d))
  ...
  t[11] === a
    ...
    : ((h = () => {
      ...
      (t[12] = h));
  let g;
  t[13] !== l || t[14] !== u || t[15] !== d || t[16] !== m || t[17] !== h
    ? ((g = { mutationKey: l, mutationFn: u, onError: d, onSuccess: m, onSettled: h }),
      (t[13] = l),
      (t[14] = u),
      (t[15] = d),
      (t[16] = m),
  ...
  let _ = f(g),
    v;
  t[19] === n.title ? (v = t[20]) : ((v = B(n.title ?? ``).trim()), (t[19] = n.title), (t[20] = v));
  let y = v,
    b,
    x,
    S,
  ...
  if (t[21] !== n || t[22] !== s || t[23] !== r) {
    ...
    (t[28] !== n.task_status_display?.environment_label || t[29] !== r
      ...
      (x = i),
      (S = e != null),
      (b = S ? s.formatDate(e, { year: `numeric`, month: `short`, day: `numeric` }) : ``),
  ...
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, X.jsx)(I, { className: `icon-sm shrink-0` })), (t[31] = T))
    : (T = t[31]);
  let E;
  t[32] === y
    ? (E = t[33])
  ...
  t[34] === E
    ...
    : ((D = (0, X.jsxs)(`div`, {
        ...
        children: [T, (0, X.jsx)(`span`, { className: `truncate`, children: E })],
      })),
      (t[34] = E),
      (t[35] = D));
  let O;
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, X.jsx)(q, { ...Y.unarchive })), (t[48] = M))
    : (M = t[48]);
  let N;
  t[49] !== j || t[50] !== _.isPending
    ? ((N = (0, X.jsx)(se, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
var wt,
  X,
  Tt = e(() => {
    ((wt = r()), s(), a(), K(), le(), G(), te(), C(), ee(), be(), R(), ct(), (X = n()));
  });
function Et() {
  let e = (0, Mt.c)(2),
    t;
...
function Pt() {
  ...
  e[0] === t
    ...
    : ((o = {
        ...
        queryFn: () => re(`list-archived-threads`, { hostId: t }),
        enabled: !0,
        staleTime: v.FIVE_SECONDS,
      }),
      (e[0] = t),
      (e[1] = o));
  let { data: s, isLoading: u, isError: d } = l(o),
    {
      data: f,
      fetchNextPage: p,
      hasNextPage: m,
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = S(`inbox-items`, { limit: $t })), (e[2] = b))
    : (b = e[2]);
  let x = t === Ce,
    C;
  e[3] === x
    ? (C = e[4])
    : ((C = { queryKey: b, queryFn: Lt, enabled: x, staleTime: v.FIVE_SECONDS }),
      (e[3] = x),
      (e[4] = C));
  let { data: w, isLoading: T } = l(C),
    E,
    D;
  if (
    e[5] !== w ||
...
function Lt() {
  return h(`inbox-items`, { params: { limit: $t } });
}
function Rt(e) {
  let t = (0, Z.c)(121),
    {
    ...
    P;
  t[0] !== M || t[1] !== n || t[2] !== C || t[3] !== x || t[4] !== k || t[5] !== N
    ? ((P = ft({
        entries: n,
        groupKey: N,
        kindFilter: C,
  ...
  let R = L,
    z;
  t[10] !== i || t[11] !== _ || t[12] !== v || t[13] !== m
    ? ((z = (e) => {
        (d(e.id), i === `local` && v(e.id));
      }),
      (t[10] = i),
      (t[11] = _),
      (t[12] = v),
  ...
  t[15] === i
    ? ((te = t[16]), (ne = t[17]))
    : ((te = [`unarchive-thread`, i]),
      (ne = async (e) => (
        await re(`unarchive-conversation`, { hostId: i, conversationId: d(e.id) }),
        e
      )),
      (t[15] = i),
      (t[16] = te),
  ...
  t[18] !== i || t[19] !== h || t[20] !== m
    ? ((B = async (e) => {
        (m
          ...
          await h.cancelQueries({ queryKey: [`archived-threads`, i] }));
        let t = h.getQueryData([`archived-threads`, i]) ?? [];
        return (
          h.setQueryData(
            [`archived-threads`, i],
    ...
    : (B = t[21]);
  let ie;
  t[22] !== i || t[23] !== g || t[24] !== h || t[25] !== m
    ? ((ie = (e, t, n) => {
        let r = e instanceof de;
        (!r && n?.previousThreads && h.setQueryData([`archived-threads`, i], n.previousThreads),
          m
            .get(U)
            .danger(g.formatMessage(r ? Y.openError : Y.unarchiveError), {
  ...
  t[30] !== i || t[31] !== h
    ? ((oe = () => {
        h.invalidateQueries({ queryKey: [`archived-threads`, i] });
      }),
      (t[30] = i),
      (t[31] = h),
      (t[32] = oe))
    : (oe = t[32]);
  let ce;
  t[33] !== oe || t[34] !== te || t[35] !== ne || t[36] !== B || t[37] !== ie || t[38] !== ae
    ? ((ce = {
        mutationKey: te,
        mutationFn: ne,
        onMutate: B,
  ...
  t[40] === i
    ? ((le = t[41]), (H = t[42]))
    : ((le = [`delete-archived-conversations`, i]),
      (H = async (e) =>
        e.kind === `all`
          ? re(`delete-all-archived-conversations`, { hostId: i })
          : e.kind === `project`
            ? (
                await Promise.all(
                  e.threadIds.map((e) =>
                    re(`delete-archived-conversation`, { hostId: i, conversationId: d(e) }),
                  ),
                )
              ).flat()
            : re(`delete-archived-conversation`, { hostId: i, conversationId: d(e.thread.id) })),
      (t[40] = i),
      (t[41] = le),
      (t[42] = H));
  let fe;
  t[43] !== i || t[44] !== h || t[45] !== m
    ? ((fe = async (e) => {
        ...
        (m
          ...
          await h.cancelQueries({ queryKey: [`archived-threads`, i] }));
        let n = h.getQueryData([`archived-threads`, i]) ?? [];
        return (
          h.setQueryData(
            [`archived-threads`, i],
    ...
    : (fe = t[46]);
  let pe;
  t[47] !== i || t[48] !== g || t[49] !== h || t[50] !== m
    ? ((pe = (e, t, n) => {
        (n?.previousThreads && h.setQueryData([`archived-threads`, i], n.previousThreads),
          m
            .get(U)
            .danger(
              g.formatMessage(
  ...
  t[52] !== g || t[53] !== m
    ? ((me = (e, t) => {
        ...
        m.get(U).success(g.formatMessage(Y.deleteSuccessPlain), { id: Xt(t) });
      }),
      (t[52] = g),
      (t[53] = m),
      (t[54] = me))
  ...
  t[55] !== i || t[56] !== h
    ...
    : (he = t[57]);
  let ge;
  t[58] !== le || t[59] !== H || t[60] !== fe || t[61] !== pe || t[62] !== me || t[63] !== he
    ? ((ge = {
        mutationKey: le,
        mutationFn: H,
        onMutate: fe,
  ...
  if (s) {
    ...
    t[73] !== I || t[74] !== c || t[75] !== F.length
      ...
      : (n = t[76]);
    let a;
    if (t[77] !== M.kind || t[78] !== G || t[79] !== i || t[80] !== V || t[81] !== F) {
      let e;
      (t[83] !== M.kind || t[84] !== G || t[85] !== i || t[86] !== V
        ? ((e = (e) =>
            (0, Q.jsx)(
              Kt,
              {
    ...
    t[90] !== I || t[91] !== c || t[92] !== o
      ...
      : (s = t[93]);
    let l;
    t[94] !== n || t[95] !== a || t[96] !== s
      ? ((l = (0, Q.jsx)(`div`, {
          className: `min-h-0 flex-1 overflow-y-auto`,
          children: (0, Q.jsxs)(`div`, { className: `flex flex-col`, children: [n, a, s] }),
        })),
        (t[94] = n),
        (t[95] = a),
        (t[96] = s),
    ...
    let d;
    (t[98] !== e || t[99] !== l
      ? ((d = (0, Q.jsxs)(Xe, { className: `max-h-[min(80vh)]`, children: [e, l] })),
        (t[98] = e),
        (t[99] = l),
        (t[100] = d))
      : (d = t[100]),
  ...
  t[101] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ye = (0, Q.jsx)(Qe, { slug: `data-controls` })), (t[101] = ye))
    : (ye = t[101]);
  let be;
  t[102] !== G || t[103] !== R || t[104] !== l || t[105] !== s
    ? ((be =
        R && !s && !l
          ? (0, Q.jsxs)(se, {
              color: `danger`,
  ...
  let Ee;
  t[114] !== y || t[115] !== Ce
    ? ((Ee = (0, Q.jsx)(Jt, { state: y, onConfirm: Ce, onOpenChange: we })),
      (t[114] = y),
      (t[115] = Ce),
      (t[116] = Ee))
    : (Ee = t[116]);
...
function Wt(e) {
  ...
  let d;
  t[7] !== s || t[8] !== u
    ? ((d = (0, Q.jsxs)($e, { className: `w-[150px] md:w-36`, "aria-label": s, children: [c, u] })),
      (t[7] = s),
      (t[8] = u),
      (t[9] = d))
    : (d = t[9]);
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Q.jsx)(J.SectionLabel, { children: (0, Q.jsx)(q, { ...$.type }) })), (t[10] = f))
    : (f = t[10]);
  ...
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(J.SectionLabel, { children: (0, Q.jsx)(q, { ...$.sortBy }) })), (t[30] = E))
    : (E = t[30]);
  ...
  let A;
  t[34] !== D || t[35] !== O
    ? ((A = (0, Q.jsx)(J.Item, { RightIcon: D, onSelect: O, children: k })),
      (t[34] = D),
      (t[35] = O),
      (t[36] = A))
    : (A = t[36]);
  ...
  let P;
  t[40] !== j || t[41] !== M
    ? ((P = (0, Q.jsx)(J.Item, { RightIcon: j, onSelect: M, children: N })),
      (t[40] = j),
      (t[41] = M),
      (t[42] = P))
    : (P = t[42]);
  ...
  let R;
  t[46] !== F || t[47] !== I
    ? ((R = (0, Q.jsx)(J.Item, { RightIcon: F, onSelect: I, children: L })),
      (t[46] = F),
      (t[47] = I),
      (t[48] = R))
    : (R = t[48]);
...
function Gt(e) {
  ...
  if (
    ...
    ((c = Me), (l = `bottom`), (u = `end`), (d = `workspace`), (f = `tall`));
    let o;
    t[19] === a
      ? (o = t[20])
    ...
    t[21] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((_ = (0, Q.jsx)(Ne, { className: `icon-xs shrink-0` })), (t[21] = _))
      : (_ = t[21]);
    let v;
    ...
    let S;
    (t[33] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((S = (0, Q.jsx)(q, { ...$.allProjects })), (t[33] = S))
      : (S = t[33]),
      t[34] !== b || t[35] !== x
      ...
      (g = r.map((t) => {
        let r = e.get(t.label) ?? [],
          a = r.length > 1 ? ce(t.path ?? t.projectId, r) : void 0,
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Q.jsx)(q, { ...$.chats })), (t[41] = b))
    : (b = t[41]);
  let x;
  t[42] !== v || t[43] !== y
    ? ((x = (0, Q.jsx)(J.Item, { LeftIcon: Le, RightIcon: v, onSelect: y, children: b })),
      (t[42] = v),
      (t[43] = y),
      (t[44] = x))
    : (x = t[44]);
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, Q.jsx)(q, { ...$.automations })), (t[47] = w))
    : (w = t[47]);
  let T;
  t[48] !== S || t[49] !== C
    ? ((T = (0, Q.jsx)(J.Item, { LeftIcon: M, RightIcon: S, onSelect: C, children: w })),
      (t[48] = S),
      (t[49] = C),
      (t[50] = T))
    : (T = t[50]);
        ...
        ? (0, Q.jsxs)(`div`, {
            ...
            children: [
              (0, Q.jsxs)(`span`, {
                ...
                children: [
                  (0, Q.jsx)(Ne, { className: `icon-xs shrink-0` }),
                  (0, Q.jsx)(`span`, {
                    className: `truncate`,
                    children:
                      n.projectLabel == null
...
function qt(e) {
  ...
  t[0] !== n.name || t[1] !== n.preview
    ? ((u = B(n.name?.trim() || n.preview).trim()), (t[0] = n.name), (t[1] = n.preview), (t[2] = u))
    : (u = t[2]);
  let d = u,
    f,
    p,
  ...
  let D;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((D = (0, Q.jsx)(q, { ...Y.unarchive })), (t[41] = D))
    : (D = t[41]);
  let O;
...
function Jt(e) {
  ...
  t[8] === s
    ? (l = t[9])
    : ((l = (0, Q.jsx)(se, { color: `ghost`, onClick: s, children: c })), (t[8] = s), (t[9] = l));
  let u;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  t[11] === r
    ? (d = t[12])
    : ((d = (0, Q.jsx)(se, { color: `danger`, onClick: r, children: u })),
      (t[11] = r),
      (t[12] = d));
  let f;
  t[13] !== l || t[14] !== d
    ? ((f = (0, Q.jsx)(We, { children: (0, Q.jsxs)(Ke, { children: [l, d] }) })),
      (t[13] = l),
      (t[14] = d),
      (t[15] = f))
    : (f = t[15]);
  ...
  return (
    t[20] !== i || t[21] !== p
      ? ((m = (0, Q.jsx)(Ue, { open: !0, showDialogClose: !1, onOpenChange: i, children: p })),
        (t[20] = i),
        (t[21] = p),
        (t[22] = m))
      : (m = t[22]),
