...
import { Dt as xe, Tt as Se } from "./app-initial~app-main~automations-page.js";
import {
  Ci as Ce,
  Fi as we,
  Gn as Te,
...
function dt(e) {
  let t = new ke(e, { ignoreLocation: !0, keys: [`searchValues`], threshold: 0.4 });
  return (n) => {
    let r = n.trim();
...
var yt,
  bt,
  xt = e(() => {
    (Pe(), ve(), Ye(), T(), (yt = `special:automations`), (bt = `special:none`));
  });
function St(e) {
  let t = (0, wt.c)(55),
  ...
  t[11] === a
    ...
    : ((p = () => {
      ...
      (t[12] = p));
  let m;
  t[13] !== c || t[14] !== l || t[15] !== u || t[16] !== f || t[17] !== p
    ? ((m = { mutationKey: c, mutationFn: l, onError: u, onSuccess: f, onSettled: p }),
      (t[13] = c),
      (t[14] = l),
      (t[15] = u),
      (t[16] = f),
  ...
  let h = D(m),
    _;
  t[19] === n.title ? (_ = t[20]) : ((_ = K(n.title ?? ``).trim()), (t[19] = n.title), (t[20] = _));
  let v = _,
    y,
    b,
    x,
  ...
  if (t[21] !== n || t[22] !== o || t[23] !== r) {
    ...
    (t[28] !== n.task_status_display?.environment_label || t[29] !== r
      ...
      (b = i),
      (x = e != null),
      (y = x ? o.formatDate(e, { year: `numeric`, month: `short`, day: `numeric` }) : ``),
  ...
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((w = (0, X.jsx)(I, { className: `icon-sm shrink-0` })), (t[31] = w))
    : (w = t[31]);
  let T;
  t[32] === v
    ? (T = t[33])
  ...
  t[34] === T
    ...
    : ((O = (0, X.jsxs)(`div`, {
        ...
        children: [w, (0, X.jsx)(`span`, { className: `truncate`, children: T })],
      })),
      (t[34] = T),
      (t[35] = O));
  let k;
  ...
  t[46] === h
    ? (M = t[47])
    : ((M = () => {
        h.isPending || h.mutate();
      }),
      (t[46] = h),
      (t[47] = M));
  let N;
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = (0, X.jsx)(G, { ...Y.unarchive })), (t[48] = N))
    : (N = t[48]);
  let P;
  t[49] !== M || t[50] !== h.isPending
    ? ((P = (0, X.jsx)(Be, {
        className: `shrink-0`,
        color: `secondary`,
        size: `toolbar`,
...
var wt,
  X,
  Tt = e(() => {
    ((wt = f()), y(), h(), q(), pe(), ze(), Re(), N(), ve(), A(), le(), ct(), (X = k()));
  });
function Et() {
  let e = (0, Mt.c)(2),
    t;
...
async function jt(e) {
  try {
    ...
    if (e instanceof r && (e.status === 401 || e.status === 403 || e.status === 404))
...
function Pt() {
  ...
  e[0] === t
    ...
    : ((s = {
        ...
        queryFn: () => ge(`list-archived-threads`, { hostId: t }),
        enabled: !0,
        staleTime: o.FIVE_SECONDS,
      }),
      (e[0] = t),
      (e[1] = s));
  let { data: u, isLoading: d, isError: f } = S(s),
    {
      data: p,
      fetchNextPage: m,
      hasNextPage: h,
  ...
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = _(`inbox-items`, { limit: $t })), (e[2] = x))
    : (x = e[2]);
  let w = t === c,
    T;
  e[3] === w
    ? (T = e[4])
    : ((T = { queryKey: x, queryFn: Lt, enabled: w, staleTime: o.FIVE_SECONDS }),
      (e[3] = w),
      (e[4] = T));
  let { data: E, isLoading: D } = S(T),
    O,
    k;
  if (
    e[5] !== E ||
    ...
    (e[18] === E?.items
      ? (c = e[19])
      : ((c = new Set(E?.items.flatMap(It) ?? [])), (e[18] = E?.items), (e[19] = c)),
      (k = ut({
  ...
  let A = k,
    M;
  e[20] === O ? (M = e[21]) : ((M = O.map(Ft)), (e[20] = O), (e[21] = M));
  let N = `${t}:${M.join(`,`)}`,
    P = h && !v,
    I = d || g || (t === `local` && D),
    L = f || (p == null && b),
...
function Lt() {
  return b(`inbox-items`, { params: { limit: $t } });
}
function Rt(e) {
  let t = (0, Z.c)(121),
    {
    ...
    m = fe(),
    h = He(),
    [_, v] = (0, Zt.useState)(null),
    [y, b] = (0, Zt.useState)(``),
    [x, S] = (0, Zt.useState)(`all`),
    [C, w] = (0, Zt.useState)(Qt),
    [T, k] = (0, Zt.useState)(`updated`),
    A = new Set([...r.map(Ht), bt, yt]),
    j = C.kind === `all` || A.has(C.groupId) ? C : Qt,
    M = j.kind === `all` ? `project` : `none`,
    N;
  t[0] !== j || t[1] !== n || t[2] !== x || t[3] !== y || t[4] !== T || t[5] !== M
    ? ((N = ft({
        entries: n,
        groupKey: M,
        kindFilter: x,
  ...
  let P = N,
    ...
    I;
  t[7] !== n || t[8] !== i
    ? ((I = i === `local` && n.some(Vt)), (t[7] = n), (t[8] = i), (t[9] = I))
    : (I = t[9]);
  let L = I,
    z;
  t[10] !== i || t[11] !== m || t[12] !== h || t[13] !== u
    ? ((z = (e) => {
        (O(e.id), i === `local` && h(e.id));
      }),
      (t[10] = i),
      (t[11] = m),
      (t[12] = h),
  ...
  t[15] === i
    ? ((ne = t[16]), (re = t[17]))
    : ((ne = [`unarchive-thread`, i]),
      (re = async (e) => (
        await ge(`unarchive-conversation`, { hostId: i, conversationId: O(e.id) }),
        e
      )),
      (t[15] = i),
      (t[16] = ne),
  ...
  t[18] !== i || t[19] !== f || t[20] !== u
    ? ((ie = async (e) => {
        (u
          ...
          await f.cancelQueries({ queryKey: [`archived-threads`, i] }));
        let t = f.getQueryData([`archived-threads`, i]) ?? [];
        return (
          f.setQueryData(
            [`archived-threads`, i],
    ...
    : (ie = t[21]);
  let ae;
  t[22] !== i || t[23] !== p || t[24] !== f || t[25] !== u
    ? ((ae = (e, t, n) => {
        let r = e instanceof _e;
        (!r && n?.previousThreads && f.setQueryData([`archived-threads`, i], n.previousThreads),
          u
            .get(J)
            .danger(p.formatMessage(r ? Y.openError : Y.unarchiveError), {
  ...
  t[30] !== i || t[31] !== f
    ? ((oe = () => {
        f.invalidateQueries({ queryKey: [`archived-threads`, i] });
      }),
      (t[30] = i),
      (t[31] = f),
      (t[32] = oe))
    : (oe = t[32]);
  let se;
  t[33] !== oe || t[34] !== ne || t[35] !== re || t[36] !== ie || t[37] !== ae || t[38] !== B
    ? ((se = {
        mutationKey: ne,
        mutationFn: re,
        onMutate: ie,
  ...
  t[40] === i
    ? ((H = t[41]), (U = t[42]))
    : ((H = [`delete-archived-conversations`, i]),
      (U = async (e) =>
        e.kind === `all`
          ? ge(`delete-all-archived-conversations`, { hostId: i })
          : e.kind === `project`
            ? (
                await Promise.all(
                  e.threadIds.map((e) =>
                    ge(`delete-archived-conversation`, { hostId: i, conversationId: O(e) }),
                  ),
                )
              ).flat()
            : ge(`delete-archived-conversation`, { hostId: i, conversationId: O(e.thread.id) })),
      (t[40] = i),
      (t[41] = H),
      (t[42] = U));
  let W;
  t[43] !== i || t[44] !== f || t[45] !== u
    ? ((W = async (e) => {
        ...
        (u
          ...
          await f.cancelQueries({ queryKey: [`archived-threads`, i] }));
        let n = f.getQueryData([`archived-threads`, i]) ?? [];
        return (
          f.setQueryData(
            [`archived-threads`, i],
    ...
    : (W = t[46]);
  let ce;
  t[47] !== i || t[48] !== p || t[49] !== f || t[50] !== u
    ? ((ce = (e, t, n) => {
        (n?.previousThreads && f.setQueryData([`archived-threads`, i], n.previousThreads),
          u
            .get(J)
            .danger(
              p.formatMessage(
  ...
  t[52] !== p || t[53] !== u
    ? ((le = (e, t) => {
        ...
        u.get(J).success(p.formatMessage(Y.deleteSuccessPlain), { id: Xt(t) });
      }),
      (t[52] = p),
      (t[53] = u),
      (t[54] = le))
  ...
  t[55] !== i || t[56] !== f
    ...
    : (ue = t[57]);
  let pe;
  t[58] !== H || t[59] !== U || t[60] !== W || t[61] !== ce || t[62] !== le || t[63] !== ue
    ? ((pe = {
        mutationKey: H,
        mutationFn: U,
        onMutate: W,
  ...
  if (o) {
    ...
    t[73] !== F || t[74] !== s || t[75] !== P.length
      ...
      : (n = t[76]);
    let a;
    if (t[77] !== j.kind || t[78] !== K || t[79] !== i || t[80] !== V || t[81] !== P) {
      let e;
      (t[83] !== j.kind || t[84] !== K || t[85] !== i || t[86] !== V
        ? ((e = (e) =>
            (0, Q.jsx)(
              Kt,
              {
                ...
                onDelete: (e) => {
                  v({ kind: `single`, thread: e });
                },
                onUnarchive: (e) => {
                  V.mutate(e);
                },
                onDeleteProject: (e, t) => {
                  v({ kind: `project`, projectLabel: e, threads: t });
                },
              },
              e.id,
            )),
    ...
    t[88] === l
      ...
      : ((o = () => {
        ...
        (t[89] = o));
    let c;
    t[90] !== F || t[91] !== s || t[92] !== o
      ? ((c = (0, Q.jsx)(rt, { hasNextPage: F, isFetchingNextPage: s, onLoadNextPage: o })),
        (t[90] = F),
        (t[91] = s),
        (t[92] = o),
        (t[93] = c))
    ...
    let d;
    (t[98] !== e || t[99] !== u
      ? ((d = (0, Q.jsxs)(tt, { className: `max-h-[min(80vh)]`, children: [e, u] })),
        (t[98] = e),
        (t[99] = u),
        (t[100] = d))
      : (d = t[100]),
  ...
  t[101] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ve = (0, Q.jsx)(qe, { slug: `data-controls` })), (t[101] = ve))
    : (ve = t[101]);
  let ye;
  t[102] !== K || t[103] !== L || t[104] !== c || t[105] !== o
    ? ((ye =
        L && !o && !c
          ? (0, Q.jsxs)(Be, {
              color: `danger`,
              ...
              children: [
                (0, Q.jsx)(ee, { className: `icon-xs shrink-0` }),
  ...
  t[107] === he
    ...
    : ((q = (0, Q.jsx)(Qe, {
        className: `gap-2`,
        children: (0, Q.jsx)(Qe.Content, { children: he }),
      })),
      (t[107] = he),
      (t[108] = q));
  let xe;
  t[109] !== n || t[110] !== me || t[111] !== _
    ? ((xe = () => {
        if (_ != null) {
          if ((v(null), _.kind === `all`)) {
            me.mutate({ kind: `all`, threadIds: n.flatMap(Bt) });
            return;
          }
          if (_.kind === `project`) {
            me.mutate({
              ...
              threadIds: _.threads.map(zt),
            });
            return;
          }
          me.mutate({ kind: `single`, thread: _.thread });
        }
      }),
      (t[109] = n),
      (t[110] = me),
  ...
  let we;
  t[114] !== _ || t[115] !== xe
    ? ((we = (0, Q.jsx)(Jt, { state: _, onConfirm: xe, onOpenChange: Ce })),
      (t[114] = _),
      (t[115] = xe),
      (t[116] = we))
    : (we = t[116]);
...
function Wt(e) {
  ...
  t[5] === l
    ? (u = t[6])
    : ((u = (0, Q.jsx)(`span`, { className: `truncate`, children: (0, Q.jsx)(G, { ...l }) })),
      (t[5] = l),
      (t[6] = u));
  let d;
  t[7] !== s || t[8] !== u
    ? ((d = (0, Q.jsxs)(Ke, { className: `w-[150px] md:w-36`, "aria-label": s, children: [c, u] })),
      (t[7] = s),
      (t[8] = u),
      (t[9] = d))
    : (d = t[9]);
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Q.jsx)(U.SectionLabel, { children: (0, Q.jsx)(G, { ...$.type }) })), (t[10] = f))
    : (f = t[10]);
  ...
  t[30] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(U.SectionLabel, { children: (0, Q.jsx)(G, { ...$.sortBy }) })), (t[30] = E))
    : (E = t[30]);
  ...
  t[45] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = (0, Q.jsx)(G, { ...$.alphabetical })), (t[45] = L))
    : (L = t[45]);
  let R;
  t[46] !== F || t[47] !== I
...
function Gt(e) {
  ...
  if (
    ...
    ((c = B), (l = `bottom`), (u = `end`), (d = `workspace`), (f = `tall`));
    let o;
    t[19] === a
      ? (o = t[20])
    ...
    t[21] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((_ = (0, Q.jsx)(Ce, { className: `icon-xs shrink-0` })), (t[21] = _))
      : (_ = t[21]);
    let v;
    ...
    let S;
    (t[33] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((S = (0, Q.jsx)(G, { ...$.allProjects })), (t[33] = S))
      : (S = t[33]),
      t[34] !== b || t[35] !== x
      ...
      (g = r.map((t) => {
        let r = e.get(t.label) ?? [],
          a = r.length > 1 ? w(t.path ?? t.projectId, r) : void 0,
          o = n.kind === `group` && n.groupId === t.groupId;
        return (0, Q.jsx)(
          U.Item,
          {
            LeftIcon: Ce,
            RightIcon: o ? H : void 0,
            tooltipText: a,
            tooltipAlign: `center`,
            onSelect: () => {
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (_ = t[38]);
  let v = n.kind === `group` && n.groupId === `special:none` ? H : void 0,
    y;
  t[39] === i
    ? (y = t[40])
    : ((y = () => {
  ...
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Q.jsx)(G, { ...$.chats })), (t[41] = b))
    : (b = t[41]);
  let x;
  t[42] !== v || t[43] !== y
    ? ((x = (0, Q.jsx)(U.Item, { LeftIcon: We, RightIcon: v, onSelect: y, children: b })),
      (t[42] = v),
      (t[43] = y),
      (t[44] = x))
    : (x = t[44]);
  let S = n.kind === `group` && n.groupId === `special:automations` ? H : void 0,
    C;
  t[45] === i
    ? (C = t[46])
    : ((C = () => {
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, Q.jsx)(G, { ...$.automations })), (t[47] = T))
    : (T = t[47]);
  let E;
  t[48] !== S || t[49] !== C
    ? ((E = (0, Q.jsx)(U.Item, { LeftIcon: P, RightIcon: S, onSelect: C, children: T })),
      (t[48] = S),
      (t[49] = C),
      (t[50] = E))
    : (E = t[50]);
        ...
        ? (0, Q.jsxs)(`div`, {
            ...
            children: [
              (0, Q.jsxs)(`span`, {
                ...
                children: [
                  (0, Q.jsx)(Ce, { className: `icon-xs shrink-0` }),
                  (0, Q.jsx)(`span`, {
                    className: `truncate`,
                    children:
                      n.projectLabel == null
      ...
      ? ((e = (e) => {
          switch (e.kind) {
            case `cloud`:
              return (0, Q.jsx)(
                St,
                { archivedTask: e.task, showProjectName: !l },
                `cloud:${e.task.id}`,
              );
            case `local`:
              return (0, Q.jsx)(
...
function qt(e) {
  ...
  t[0] !== n.name || t[1] !== n.preview
    ? ((u = K(n.name?.trim() || n.preview).trim()), (t[0] = n.name), (t[1] = n.preview), (t[2] = u))
    : (u = t[2]);
  let d = u,
    f,
    p,
  ...
  let E;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = (0, Q.jsx)(G, { ...Y.unarchive })), (t[41] = E))
    : (E = t[41]);
  let D;
...
function Jt(e) {
  ...
  t[8] === s
    ? (l = t[9])
    : ((l = (0, Q.jsx)(Be, { color: `ghost`, onClick: s, children: c })), (t[8] = s), (t[9] = l));
  let u;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Q.jsx)(G, { ...Y.delete })), (t[10] = u))
    : (u = t[10]);
  let d;
  t[11] === r
    ? (d = t[12])
    : ((d = (0, Q.jsx)(Be, { color: `danger`, onClick: r, children: u })),
      (t[11] = r),
      (t[12] = d));
  let f;
  t[13] !== l || t[14] !== d
    ? ((f = (0, Q.jsx)(Me, { children: (0, Q.jsxs)(Fe, { children: [l, d] }) })),
      (t[13] = l),
      (t[14] = d),
      (t[15] = f))
    : (f = t[15]);
  ...
  return (
    t[20] !== i || t[21] !== p
      ? ((m = (0, Q.jsx)(we, { open: !0, showDialogClose: !1, onOpenChange: i, children: p })),
        (t[20] = i),
        (t[21] = p),
        (t[22] = m))
      : (m = t[22]),
