...
import { i as r } from "./chunk-55.js";
import { L as i, P as a, k as o, s, y as c } from "./chunk-102.js";
...
function fe(e, t) {
    ...
    n
      ? r
        ...
        : (t.push(
          ...
          (i.top = i.left = 0))
      : r &&
        (t.push(`translate(` + (0 - i.left).toString() + ` ` + (i.height + i.top).toString() + `)`),
        t.push(`scale(1 -1)`),
        (i.top = i.left = 0));
    let s;
  ...
  o === null
    ...
    : ((u = o === `auto` ? c : o), (f = s === null ? se(u, l / c) : s === `auto` ? l : s));
  let p = {},
    h = (e, t) => {
      de(t) || (p[e] = t.toString());
    };
...
const pe = /\sid="(\S+)"/g,
  me = `IconifyId` + Date.now().toString(16) + ((Math.random() * 16777216) | 0).toString(16);
let he = 0;
function ge(e, t = me) {
  let n = [],
    r;
...
var x = {
  ...
  rt = b(/^!?\[(ref)\](?:\[\])?/)
    .replace(`ref`, T)
    .getRegex(),
  it = b(`reflink|nolink(?!\\()`, `g`).replace(`reflink`, nt).replace(`nolink`, rt).getRegex(),
...
function I(e, t) {
  ...
  } else if (x.escapeTestNoEncode.test(e)) return e.replace(x.escapeReplaceNoEncode, lt);
  return e;
}
function ut(e) {
  try {
  ...
  z = class e {
    ...
    constructor(e) {
      ...
      (this.options.pedantic
        ...
        : this.options.gfm &&
          ((t.block = P.gfm), this.options.breaks ? (t.inline = F.breaks) : (t.inline = F.gfm)),
...
`,
    ...
    blockTokens(e, t = [], n = !1) {
      for (
        this.options.pedantic && (e = e.replace(x.tabCharGlobal, `    `).replace(x.spaceLine, ``));
        e;
      ) {
        let r;
        if (
          ...
          ? e.tokens[0]?.type === `paragraph`
            ? ((e.tokens[0].text = n + ` ` + e.tokens[0].text),
              e.tokens[0].tokens &&
                ...
                ((e.tokens[0].tokens[0].text = n + ` ` + I(e.tokens[0].tokens[0].text)),
          ...
          if (e.hooks) {
            ...
            for (let n in e.hooks) {
              ...
              U.passThroughHooks.has(n)
                ? (t[r] = (e) => {
                    if (this.defaults.async && U.passThroughHooksRespectAsync.has(n))
                      return (async () => {
        ...
        if ((i.hooks && ((i.hooks.options = i), (i.hooks.block = e)), i.async))
          return (async () => {
            let n = i.hooks ? await i.hooks.preprocess(t) : t,
              r = await (i.hooks ? await i.hooks.provideLexer() : e ? z.lex : z.lexInline)(n, i),
              a = i.hooks ? await i.hooks.processAllTokens(r) : r;
            i.walkTokens && (await Promise.all(this.walkTokens(a, i.walkTokens)));
            let o = await (i.hooks ? await i.hooks.provideParser() : e ? H.parse : H.parseInline)(
              a,
              i,
            );
...
var gt = {
  ...
  vt = t((t) => {
    for (let n of t) {
      ...
      if ((e.debug(`Registering icon pack:`, n.name), `loader` in n)) _t.set(n.name, n.loader);
...
`)
          .forEach((e, n) => {
            (n !== 0 && (o++, a.push([])),
              e.split(` `).forEach((e) => {
                ((e = e.replace(/&#39;/g, `'`)), e && a[o].push({ content: e, type: t }));
              }));
          })
...
function J(e, t, n = [], r = []) {
  ...
  let a = e.shift() ?? { content: ` `, type: `normal` },
    o = [...r];
  if ((i !== `` && o.push({ content: i, type: `normal` }), o.push(a), t(o))) return J(e, t, n, o);
...
async function At(e, t, n, r, l = !1, u = c()) {
  ...
  (d.attr(`width`, `${Math.min(10 * n, X)}px`), d.attr(`height`, `${Math.min(10 * n, X)}px`));
...
`,
  ...
  (h.html(p),
    ...
    n !== 1 / 0 && (f.style(`max-width`, n + `px`), f.style(`text-align`, `center`)),
...
function Nt(e, n, r, i = !1, a = !1) {
  let o = 1.1,
    s = n.append(`g`),
    c = s.insert(`rect`).attr(`class`, `background`).attr(`style`, `stroke: none`),
...
var Ft = t(
  async (
    ...
    if ((e.debug(`XYZ createText`, i, a, s, c, l, d, `addSvgBackground: `, p), l)) {
      let e = await Pt(r(u ? Et(i, m) : Tt(i)), m),
        n = i.replace(/\\\\/g, `\\`);
      return await At(
        t,
        { isNode: d, label: o(i) ? n : e, labelStyle: a.replace(`fill:`, `color:`) },
        f,
        c,
        p,
        m,
      ...
      let e = r(i.replace(/<br\s*\/?>/g, `<br/>`)),
        o = Nt(f, t, u ? wt(e.replace(`<br>`, `<br/>`), m) : Ct(e), i ? p : !1, !d);
      if (d) {
