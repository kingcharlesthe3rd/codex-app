...
import { a as n, i as r, n as i, o as a, r as o, t as s } from "./esm.js";
import { n as c, r as l } from "./chunk-64.js";
import { L as u, P as d, k as f, s as p, y as m } from "./chunk-99.js";
import { i as h } from "./chunk-48.js";
var g = {
  ...
  y = c((e) => {
    for (let t of e) {
      ...
      if ((l.debug(`Registering icon pack:`, t.name), `loader` in t)) v.set(t.name, t.loader);
  ...
  S = c(async (e, t, n) => {
    ...
    let s = r(a, t);
    return u(i(o(s.body), { ...s.attributes, ...n }), m());
  }, `getIconSVG`);
...
function D(t, { markdownAutoWrap: n } = {}) {
  let r = e.lexer(t);
  function i(e) {
    return e.type === `text`
      ? n === !1
  ...
  return (c(i, `output`), r.map(i).join(``));
}
c(D, `markdownToHTML`);
function O(e) {
...
function M(e, t, n = [], r = []) {
  ...
  let a = e.shift() ?? { content: ` `, type: `normal` },
    o = [...r];
  if ((i !== `` && o.push({ content: i, type: `normal` }), o.push(a), t(o))) return M(e, t, n, o);
...
async function F(e, t, n, r, i = !1, a = m()) {
  ...
  (o.attr(`width`, `${Math.min(10 * n, P)}px`), o.attr(`height`, `${Math.min(10 * n, P)}px`));
...
`,
  ...
  (h.html(c),
    ...
    n !== 1 / 0 && (s.style(`max-width`, n + `px`), s.style(`text-align`, `center`)),
...
var U = c(
  async (
    ...
    if ((l.debug(`XYZ createText`, n, r, i, a, o, c, `addSvgBackground: `, d), o)) {
      let t = await H(h(s ? D(n, p) : E(n)), p),
        i = n.replace(/\\\\/g, `\\`);
      return await F(
        e,
        { isNode: c, label: f(n) ? i : t, labelStyle: r.replace(`fill:`, `color:`) },
        u,
        a,
        d,
        p,
      ...
      let a = h(n.replace(/<br\s*\/?>/g, `<br/>`)),
        o = z(u, e, s ? T(a.replace(`<br>`, `<br/>`), p) : w(a), n ? d : !1, !c);
      if (c) {
        ...
        let n = r
          ...
          .replace(/fill:[^;]+;?/g, ``)
          .replace(/color:/g, `fill:`);
        t(o).select(`text`).attr(`style`, n);
      }
      return (
        i
          ? t(o).selectAll(`tspan.text-outer-tspan`).classed(`title-row`, !0)
          : t(o).selectAll(`tspan.text-outer-tspan`).classed(`row`, !0),
        o
      );
    }
  },
