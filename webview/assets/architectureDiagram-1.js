...
import { n, t as r } from "./src-3.js";
import { n as i, t as a } from "./cytoscape.esm-2.js";
import { t as o } from "./cytoscape-fcose.js";
...
import { r as ee, s as te, u as ne } from "./chunk-32.js";
import { a as re, i as ie, n as T, o as ae, r as E } from "./chunk-128.js";
import { n as oe, t as se } from "./chunk-17.js";
import { n as ce, t as le } from "./mermaid-parser.core-2.js";
function D(e, t, n) {
  e.forEach((e) => {
    t.add({
      group: `nodes`,
          ...
          if (l) {
            ...
            Object.entries(c).forEach(([e, i]) => {
              ...
              d &&
                !s[c] &&
                (o.push(c),
                n.push({ [j[e]]: d, [j[P(e)]]: l, gap: 1.5 * t.getConfigField(`iconSize`) }));
            });
          }
        }
      }
...
function k(e, t, r, i, o, { spatialMaps: l, groupAlignments: u }) {
  return new Promise((d) => {
    let f = n(`body`).append(`div`).attr(`id`, `cy`).attr(`style`, `display:none`),
      p = a({
        ...
        style: [
          ...
          { selector: `.node-group`, style: { padding: `${o.getConfigField(`padding`)}px` } },
        ],
      ...
      g = p.layout({
        ...
        idealEdgeLength(e) {
          let [t, n] = e.connectedNodes(),
            { parent: r } = J(t),
            { parent: i } = J(n);
          return r === i ? 1.5 * o.getConfigField(`iconSize`) : 0.5 * o.getConfigField(`iconSize`);
        },
        edgeElasticity(e) {
          let [t, n] = e.connectedNodes(),
            { parent: r } = J(t),
      ...
      getDataStructures() {
        if (this.dataStructures === void 0) {
          let e = {},
            ...
            n = Object.keys(t)[0],
            r = { [n]: 1 },
            i = Object.keys(t).reduce((e, t) => (t === n ? e : { ...e, [t]: 1 }), {}),
            a = c((e) => {
              let n = { [e]: [0, 0] },
                a = [e];
              for (; a.length > 0;) {
          ...
          this.dataStructures = { adjList: t, spatialMaps: o, groupAlignments: e };
        }
...
`,
      ...
      await Promise.all(
        t.edges().map(async (t) => {
          let {
            ...
            w = i + 4;
          if (
            (d && (I(l) ? (_ += l === `L` ? -w : w) : (y += l === `T` ? -w : w + 18)),
            h && (I(p) ? (S += p === `L` ? -w : w) : (C += p === `T` ? -w : w + 18)),
            !d &&
            ...
            if (g) {
              ...
              if (
                ...
                r.attr(`transform`, `translate(` + b + `, ` + x + `) rotate(-90)`);
              else if (e === `XY`) {
                let e = V(l, p);
                if (e && z(e)) {
          ...
          if (s.type === `group`) {
            ...
            if (s.icon) {
              ...
              (e.html(
                ...
                e.attr(`transform`, `translate(` + (m + o + 1) + `, ` + (h + o + 1) + `)`),
                (m += i),
                (h += a / 2 - 1 - 2));
            }
            if (s.label) {
              ...
              (await T(
                ...
                e.attr(`transform`, `translate(` + (m + o + 4) + `, ` + (h + o + 2) + `)`));
            }
    ...
    (ye = c(async function (e, t, n, r) {
      ...
      for (let a of n) {
        ...
        let s = n.append(`g`);
        if (a.icon)
          s.html(`<g>${await E(a.icon, { height: o, width: o, fallbackPrefix: $.prefix })}</g>`);
        else if (a.iconText) {
          s.html(`<g>${await E(`blank`, { height: o, width: o, fallbackPrefix: $.prefix })}</g>`);
          let e = s
              .append(`g`)
    ...
    (xe = {
      ...
      renderer: {
        draw: c(async (e, t, n, r) => {
          ...
          let p = u.append(`g`);
          (p.attr(`class`, `architecture-groups`), await ye(i, f, a, t), be(i, f, o, t));
          let m = await k(a, o, s, c, i, l);
          (await _e(d, m, i, t),
            await ve(p, m, i, t),
            de(i, m),
            b(void 0, u, i.getConfigField(`padding`), i.getConfigField(`useMaxWidth`)));
        }, `draw`),
      },
      styles: Z,
    }));
