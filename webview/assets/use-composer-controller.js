...
((r.prototype = {
  ...
  update: function (e, t, n) {
    var i = n && n != e ? this.remove(n) : this,
      a = i.find(e),
      o = i.content.slice();
    return (a == -1 ? o.push(n || e, t) : ((o[a + 1] = t), n && (o[a] = n)), new r(o));
  },
  remove: function (e) {
    var t = this.find(e);
    if (t == -1) return this;
  ...
  prepend: function (e) {
    return ((e = r.from(e)), e.size ? new r(e.content.concat(this.subtract(e).content)) : this);
  },
  append: function (e) {
    return ((e = r.from(e)), e.size ? new r(this.subtract(e).content.concat(e.content)) : this);
  },
  subtract: function (e) {
    var t = this;
    e = r.from(e);
...
function h(e, t, n) {
  if (n.openStart > e.depth) throw new d(`Inserted content deeper than insertion position`);
  if (e.depth - n.openStart != t.depth - n.openEnd) throw new d(`Inconsistent open depths`);
  return ee(e, t, n, 0);
}
function ee(e, t, n, r) {
  let i = e.index(r),
...
function re(e, t, n, r, i) {
  ...
  return (
    ...
    a && s && t.index(i) == n.index(i)
      ...
      : (a && g(v(a, y(e, t, i + 1)), c), _(t, n, i, c), s && g(v(s, y(n, r, i + 1)), c)),
    _(r, null, i, c),
    new o(c)
  );
}
...
var ae = class e {
    ...
    blockRange(e = this, t) {
      ...
      for (
        ...
        if (e.pos <= this.end(n) && (!t || t(this.node(n)))) return new le(this, e, n);
      return null;
    }
    sameParent(e) {
  ...
  b = class e {
    ...
    toString() {
      ...
      return (
        this.content.size && (e += `(` + this.content.toStringInner() + `)`), fe(this.marks, e)
      );
    }
    contentMatchAt(e) {
...
var x = class e {
  ...
  fillBefore(e, t = !1, n = 0) {
    ...
    function i(a, s) {
      ...
      if (c && (!t || c.validEnd)) return o.from(s.map((e) => e.createAndFill()));
...
var Ae = class e {
  ...
  createChecked(e = null, t, n) {
    return (
      (t = o.from(t)), this.checkContent(t), new b(this, this.computeAttrs(e), t, u.setFrom(n))
    );
  }
...
var Me = class {
    constructor(e, t, n) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(n, `default`)),
        ...
        (this.validate = typeof n.validate == `string` ? je(e, t, n.validate) : n.validate));
    }
    get isRequired() {
  ...
  Ne = class e {
    ...
    create(e = null) {
      return !e && this.instance ? this.instance : new u(this, De(this.attrs, e));
    }
    static compile(t, n) {
      let r = Object.create(null),
        i = 0;
  ...
  Pe = class {
    constructor(e) {
      ...
      for (let e in this.nodes) {
        ...
        t.markSet =
          i == `_` ? null : i ? Fe(this, i.split(` `)) : i == `` || !t.inlineContent ? [] : null;
      }
    ...
    inlineContext(e) {
      return this.type
        ...
        : this.content.length
          ...
          : e.parentNode && !ze.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
    }
  },
  Ue = class {
    constructor(e, t, n) {
      ...
      ((i = r
        ? new T(r.type, r.attrs, u.none, !0, t.topMatch || r.type.contentMatch, a)
        : n
...
`),
    ...
    insertNode(e, t, n) {
      ...
      if (r) {
        ...
        for (let i of r.concat(e.marks))
          (t.type ? t.type.allowsMarkType(i.type) : qe(i.type, e.type)) && (n = i.addToSet(n));
    ...
    enterInner(e, t, n, r = !1, i) {
      ...
      return (
        (n = n.filter((t) =>
          (a.type ? a.type.allowsMarkType(t.type) : qe(t.type, e)) ? ((s = t.addToSet(s)), !1) : !0,
        )),
...
function P(e, t, n) {
  ...
  for (let i = 0; i < e.childCount; i++) {
    let a = e.child(i);
    (a.content.size && (a = a.copy(P(a.content, t, a))), a.isInline && (a = t(a, n, i)), r.push(a));
  }
...
var L = class e extends M {
  ...
  apply(e) {
    ...
    return N.fromReplace(e, this.pos, this.pos + 1, new f(o.from(n), 0, t.isLeaf ? 0 : 1));
  }
  invert(t) {
    ...
    if (!d) s.push(new z(c, u, f.empty));
      ...
      if (i && l.isText && n.whitespace != `pre`) {
        let e,
          ...
          r;
        for (; (e = t.exec(l.text)); )
          ((r ||= new f(o.from(n.schema.text(` `, n.allowedMarks(l.marks))), 0, 0)),
...
function dt(e, t, n) {
  ...
  for (let e = a, t = !1; e > n; e--)
    t || r.index(e) > 0 ? ((t = !0), (d = o.from(r.node(e).copy(d))), p++) : l--;
  let m = o.empty,
    h = 0;
  for (let e = a, t = !1; e > n; e--)
    t || i.after(e + 1) < i.end(e) ? ((t = !0), (m = o.from(i.node(e).copy(m))), h++) : u++;
...
function pt(e, t, n, r, i) {
  ...
  e.doc.nodesBetween(t, n, (t, n) => {
    ...
    if (t.isTextblock && !t.hasMarkup(r, s) && gt(e.doc, e.mapping.slice(a).map(n), r)) {
      let i = null;
      ...
      (i === !1 && ht(e, t, n, a), ut(e, e.mapping.slice(a).map(n, 1), r, void 0, i === null));
      let c = e.mapping.slice(a),
        l = c.map(n, 1),
        u = c.map(n + t.nodeSize, 1);
      return (
        e.step(new B(l, u, l + 1, u - 1, new f(o.from(r.create(s, null, t.marks)), 0, 0), 1, !0)),
        i === !0 && mt(e, t, n, a),
        !1
      );
    }
...
function _t(e, t, n, r, i) {
  ...
  e.step(new B(t, t + a.nodeSize, t + 1, t + a.nodeSize - 1, new f(o.from(s), 0, 0), 1, !0));
}
...
var wt = class {
  ...
  openMore() {
    ...
    return !r.childCount || r.firstChild.isLeaf
      ? !1
      : ((this.unplaced = new f(e, t + 1, Math.max(n, r.size + t >= e.size - n ? t + 1 : 0))), !0);
  }
  dropNode() {
    let { content: e, openStart: t, openEnd: n } = this.unplaced,
      r = Tt(e, t);
    ...
    for (; l < s.childCount; ) {
      ...
      (l++,
        (l > 1 || c == 0 || e.content.size) &&
          ((d = t),
          u.push(Et(e.mark(p.allowedMarks(e.marks)), l == 1 ? c : 0, l == s.childCount ? m : -1))));
    }
...
function Et(e, t, n) {
  ...
  let r = e.content;
  return (
    t > 1 && (r = r.replaceChild(0, Et(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0))),
    t > 0 &&
      ((r = e.type.contentMatch.fillBefore(r).append(r)),
      n <= 0 && (r = r.append(e.type.contentMatch.matchFragment(r).fillBefore(o.empty, !0)))),
    e.copy(r)
  );
}
...
var Ft = class e extends M {
  ...
  apply(e) {
    ...
    return N.fromReplace(e, this.pos, this.pos + 1, new f(o.from(r), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return A.empty;
  }
...
var Lt = class {
  ...
  G = class {
    constructor(e, t, n) {
      ((this.$anchor = e), (this.$head = t), (this.ranges = n || [new zt(e.min(t), e.max(t))]));
    }
    get anchor() {
    ...
    replaceWith(e, t) {
      ...
      for (let i = 0; i < r.length; i++) {
        let { $from: a, $to: o } = r[i],
          ...
          c = s.map(a.pos),
          l = s.map(o.pos);
        i ? e.deleteRange(c, l) : (e.replaceRangeWith(c, l, t), Gt(e, n, t.isInline ? -1 : 1));
      }
    }
...
var Kt = 1,
  ...
  Jt = class extends Lt {
    ...
    ensureMarks(e) {
      return (
        u.sameSet(this.storedMarks || this.selection.$from.marks(), e) || this.setStoredMarks(e),
        this
      );
    }
    addStoredMark(e) {
    ...
    replaceSelectionWith(e, t = !0) {
      ...
      return (
        t &&
          (e = e.mark(
            this.storedMarks || (n.empty ? n.$from.marks() : n.$from.marksAcross(n.$to) || u.none),
          )),
...
function $t(e, t, n) {
  for (let r in e) {
    let i = e[r];
    (i instanceof Function ? (i = i.bind(t)) : r == `handleDOMEvents` && (i = $t(i, t, {})),
      (n[r] = i));
  }
  return n;
}
...
var $ = e(t(), 1),
  ...
  dn = (e, t) => {
    let n = (0, ln.c)(6),
      r;
    n[0] === e.view ? (r = n[1]) : ((r = (t) => on(e.view, t)), (n[0] = e.view), (n[1] = r));
    let i, a;
    return (
      n[2] !== e || n[3] !== t
        ? ((i = () => t(e)), (a = () => t(e)), (n[2] = e), (n[3] = t), (n[4] = i), (n[5] = a))
        : ((i = n[4]), (a = n[5])),
