...
function fe(e, t) {
  return e.plugin.name === t && e.marketplaceName === E && e.plugin.id === `${t}@${E}`;
}
var C,
  w,
  T,
  ...
  function o(o) {
    ...
    if (l || !e) {
      ...
      return (
        s[0] === f
          ? (e = s[1])
          : ((e = (0, X.createElement)(Ue(r ?? n?.name ?? ``, i ?? n?.description), {
              className: f,
            })),
            (s[0] = f),
            (s[1] = e)),
...
function ze({ size: e = `small`, iconSmall: t, iconLarge: n, basePath: i, smallOnly: o }) {
  let s = (e) => {
    let t = e.trim();
...
function tt(e, t) {
  return (
    Math.max(_(e.label, t), _(e.shortName, t), _(`@${e.label}`, t), _(`@${e.shortName}`, t)) > 0
  );
}
function nt({ alias: e, mentionPath: t, mentionDisplayName: n, plugins: r }) {
  return n === e.label && r.some((n) => e.isMentionPlugin(n) && t === p(n.plugin.id));
}
function rt({ mentionPath: e, mentionDisplayName: t, plugins: n }) {
  return (
    it.find((r) => nt({ alias: r, mentionPath: e, mentionDisplayName: t, plugins: n }))?.label ??
    null
  );
}
var Q,
  ...
  at = e(() => {
    (pe(),
      ...
      (Q = {
        ...
        windowsOfficeAppIdPattern: /^Microsoft\.Office\.(?:EXCEL|EXCEL\.EXE)(?:\.\d+)?$/i,
      ...
      ($ = {
        ...
        windowsOfficeDesktopAppIdPattern: /^Microsoft\.Office\.Desktop_[^!]+!PowerPoint$/i,
        isMentionPlugin: S,
      }),
      (it = [Q, $]));
  });
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~appgen-settings-page~appgen-publication-terms-ro~g0k1g2bt.js.map
