...
function al(e) {
  ...
  let n = rl,
    ...
    o = () => {
      ...
      for (let e of i) sl(e);
      (r.push(el({ tagName: `span`, properties: { "data-char": a }, children: i })),
        (i = []),
        (a = void 0));
    },
    s = (e) => {
...
function xl({ item: e, arr: t, enableJoin: n, isNeutral: r = !1, isLastItem: i = !1 }) {
  let a = t[t.length - 1];
  if (a == null || i || !n) {
...
function Dl({ lines: e, startingLine: t = 0, totalLines: n = 1 / 0, callback: r }) {
