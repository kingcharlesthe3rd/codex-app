...
function Lc(e, t, n, r) {
  if (t && n) {
    ...
    if (e) {
      let r = Ec(i, o);
      ((e.value = kc(e.value, o, r)), (t.value = Ac(t.value, r)), (n.value = Ac(n.value, r)));
    }
    if (r) {
      let e = Dc(a, s);
      ((r.value = Oc(r.value, s, e)), (t.value = jc(t.value, e)), (n.value = jc(n.value, e)));
    }
  } else if (n) {
    if (e) {
      let e = X(n.value);
...
(new (class extends Y {
  ...
  new (class extends Y {
    ...
    castInput(e, t) {
      ...
      return typeof e == `string` ? e : JSON.stringify(Hc(e, null, null, r), null, `  `);
    }
    equals(e, t, n) {
...
function Hc(e, t, n, r, i) {
  ...
  if ((e && e.toJSON && (e = e.toJSON()), typeof e == `object` && e)) {
    ...
    for (i.sort(), a = 0; a < i.length; a += 1) ((s = i[a]), (o[s] = Hc(e[s], t, n, r, s)));
    (t.pop(), n.pop());
  } else o = e;
  return o;
}
...
function Jc(e) {
  ...
  return (
    ...
    [parseInt(r.slice(0, 2), 16), parseInt(r.slice(2, 4), 16), parseInt(r.slice(4, 6), 16), i]
  );
}
function Yc(e) {
...
function $c(e) {
  ...
  (Z(r, `editor.background`, i),
    ...
    Z(r, `sideBarSectionHeader.foreground`, n[`sideBarSectionHeader.foreground`] ?? s),
    Z(r, `list.activeSelectionForeground`, n[`list.activeSelectionForeground`] ?? s),
    Z(
      r,
...
function al(e, t) {
  ...
  for (let n of e) {
    ...
    let e = rl.get(n.name);
    (e ?? ((e = n), rl.set(n.name, e)), il.add(e.name), t.loadLanguageSync(e.data));
  }
}
const ol = new Set(),
  sl = Cc();
function cl(e, t) {
  ...
  for (let n of e) {
    ...
    } else ((e = n), (n = n.name), sl.getResolvedTheme(n) ?? sl.seedResolvedTheme(n, e));
...
function bl(e) {
  ...
  let n = vl,
    ...
    o = () => {
      ...
      for (let e of i) Sl(e);
      (r.push(hl({ tagName: `span`, properties: { "data-char": a }, children: i })),
        (i = []),
        (a = void 0));
    },
    s = (e) => {
...
function Vl({ item: e, arr: t, enableJoin: n, isNeutral: r = !1, isLastItem: i = !1 }) {
  let a = t[t.length - 1];
  if (a == null || i || !n) {
...
function Wl({
  ...
  let p = 0;
  for (let e of l)
    (e[0] === 1 && i.push(Bl({ line: n, spanStart: p, spanLength: e[1].length })),
      (p += e[1].length));
  p = 0;
  for (let e of u)
    (e[0] === 1 && a.push(Bl({ line: r, spanStart: p, spanLength: e[1].length })),
      (p += e[1].length));
}
function Gl() {
  return {
