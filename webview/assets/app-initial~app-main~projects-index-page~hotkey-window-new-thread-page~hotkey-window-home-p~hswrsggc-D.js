...
function Y(e) {
  ...
  return (
    t[0] !== n || t[1] !== i
      ? ((a = i ? (0, tt.jsx)(qe, { className: n }) : (0, tt.jsx)(H, { className: n })),
        (t[0] = n),
        (t[1] = i),
        (t[2] = a))
      : (a = t[2]),
...
function rt(e) {
    ...
    (t[18] === h
      ...
      (w = b.map((e) => {
        let t = i[e.projectId] ?? null,
          r = (0, X.jsx)(Y, { className: `icon-xs`, isRemoteProject: e.projectKind === `remote` }),
          s = e.repositoryData?.rootFolder,
          c = s != null && s !== e.label,
          l = n.get(e.label) ?? [],
          u = l.length > 1 && e.path != null ? U(e.path, l) : null;
        return (0, X.jsx)(
          `div`,
          {
            className: `flex flex-col`,
            children: (0, X.jsxs)(x, {
              RightIcon: a.includes(e.projectId) ? B : void 0,
      ...
      (t[15] = w),
      (t[16] = T));
  } else ((y = t[11]), (b = t[12]), (S = t[13]), (C = t[14]), (w = t[15]), (T = t[16]));
  let O;
  t[23] !== p || t[24] !== b.length
    ...
    : (O = t[25]);
  let k;
  t[26] !== y || t[27] !== C || t[28] !== w || t[29] !== O
    ? ((k = (0, X.jsxs)(y, { className: C, children: [w, O] })),
      (t[26] = y),
      (t[27] = C),
      (t[28] = w),
      (t[29] = O),
                    ...
                    children: (0, X.jsxs)(X.Fragment, {
                      children: [
                        ...
                        d
                          ...
                          : null,
                        g ? (0, X.jsx)(x, { LeftIcon: D, onSelect: l, children: c }) : null,
                      ],
                    }),
                  }),
                ],
  ...
  let j;
  return (
    t[39] !== n || t[40] !== T || t[41] !== k || t[42] !== A
      ? ((j = (0, X.jsxs)(X.Fragment, { children: [T, k, n, A] })),
        (t[39] = n),
        (t[40] = T),
        (t[41] = k),
        (t[42] = A),
...
var it,
  ...
  ct = e(() => {
    (r(),
      ...
      (st = ve(A, ({ get: e }) => {
        let t = e(re),
          n = e(ke, { threadKeys: t, enabled: !0 }).groups,
          r = new Map(e(G, t).map((e) => [e.task.key, e]));
        return Re(e(Ne), n, r);
      })));
  }),
  lt,
...
function ft(e) {
  let t = (0, pt.c)(26),
    { children: n, disabled: r, menuOpen: i, onClearProject: o } = e,
    s = r === void 0 ? !1 : r,
    c = Te(),
    [l, u] = (0, mt.useState)(!1),
    d = !s && !i && !l,
  ...
  let p = f,
    ...
    g;
  t[2] !== m || t[3] !== h
    ? ((g = a(`group/project-selector relative inline-flex shrink-0 rounded-full`, m, h)),
      (t[2] = m),
      (t[3] = h),
      (t[4] = g))
    : (g = t[4]);
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((T = (0, Z.jsx)(ut, { "aria-hidden": !0, className: `size-4` })), (t[12] = T))
    : (T = t[12]);
  let E;
  t[13] !== p || t[14] !== S || t[15] !== C || t[16] !== w
    ? ((E = (0, Z.jsx)(`button`, {
        className: S,
        type: `button`,
        "aria-label": p,
    ...
    : (E = t[17]);
  let D;
  t[18] !== p || t[19] !== E || t[20] !== b
    ? ((D = (0, Z.jsx)(Ae, { disabled: b, tooltipContent: p, children: E })),
      (t[18] = p),
      (t[19] = E),
      (t[20] = b),
      (t[21] = D))
...
var pt,
  ...
  Z,
  ht = e(() => {
    ((pt = L()), F(), (mt = t(b(), 1)), xe(), be(), dt(), Ue(), (Z = o()));
  });
function gt(e) {
  let t = (0, yt.c)(22),
    n,
  ...
  t[0] === e
    ...
    : (({
      ...
      (t[8] = d));
  let f;
  t[9] === i ? (f = t[10]) : ((f = a(K.externalFooterItem, `min-w-0`, i)), (t[9] = i), (t[10] = f));
  let p;
...
function _t(e) {
  let t = (0, yt.c)(11),
    { categoryLabel: n, className: r, collapse: i, icon: o, value: s, valueClassName: c } = e,
    l;
  t[0] === r
    ? (l = t[1])
    : ((l = a(K.externalFooterItem, `flex min-w-0 items-center gap-1`, r)), (t[0] = r), (t[1] = l));
  let u;
  t[2] !== n || t[3] !== i || t[4] !== o || t[5] !== s || t[6] !== c
    ? ((u = (0, Q.jsx)(vt, {
        categoryLabel: n,
        collapse: i,
        icon: o,
...
function vt(e) {
  let t = (0, yt.c)(26),
    { categoryLabel: n, collapse: r, icon: i, indicator: o, value: s, valueClassName: c } = e,
    l = je(`2700454473`) ? `icon-xs` : `icon-2xs`,
    [u, d] = (0, bt.useState)(null),
    [f, p] = (0, bt.useState)(null),
    m;
  ...
  bb0: switch (o) {
    ...
    case `chevron`: {
      ...
      t[3] === l
        ...
        : ((e = a(
          ...
          (t[4] = e));
      let n;
      (t[5] === e ? (n = t[6]) : ((n = (0, Q.jsx)(j, { className: e })), (t[5] = e), (t[6] = n)),
        (y = n));
      break bb0;
    }
    case `collapsible-chevron`: {
      ...
      t[7] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = a(K.secondaryChevron, K.externalFooterItemChevron, `inline-flex`)), (t[7] = e))
        : (e = t[7]);
      let n;
      t[8] === l
        ? (n = t[9])
        : ((n = a(l, `shrink-0 text-token-input-placeholder-foreground`)), (t[8] = l), (t[9] = n));
      let r;
      (t[10] === n
        ? (r = t[11])
        : ((r = (0, Q.jsx)(`span`, { className: e, children: (0, Q.jsx)(j, { className: n }) })),
          (t[10] = n),
          (t[11] = r)),
        (y = r));
    }
        ...
        n != null || s != null
          ? (0, Q.jsxs)(`span`, {
              className: a(
                ...
                n != null && K.externalFooterItemTextWithCategoryLabel,
  ...
  let S;
  return (
    t[22] !== b || t[23] !== x || t[24] !== y
      ? ((S = (0, Q.jsxs)(Q.Fragment, { children: [b, x, y] })),
        (t[22] = b),
        (t[23] = x),
        (t[24] = y),
        (t[25] = S))
...
var yt,
  ...
  Q,
  xt = e(() => {
    ((yt = L()), F(), (bt = t(b(), 1)), k(), i(), Ie(), Ye(), h(), He(), Ue(), (Q = o()));
  });
function St({
  ...
  let _ = d(A),
    ...
    oe = (0, wt.useRef)(!1),
    P = v(st).filter((e) => (e.projectKind === `local` ? t : r)),
    F = Ke(),
    I = k && !F,
    le = Le(),
    fe = e !== void 0,
    pe = !F,
    { selectedRemoteProject: me, selectedRemoteProjectId: he } = ie(),
    { remoteConnections: ge } = ee(),
    _e = ze(ge),
    { data: ve, isLoading: be } = v(te),
    { data: xe } = w(de.PROJECT_APPEARANCES),
    Se = ae(xe),
    Ce = r && le && !F && _e.length > 0,
    we = (e) => {
      N(_, y, {});
      let t = P.find((t) => t.projectId === e);
      if (t == null) return;
      if ((ce(_, t), t.projectKind === `remote`)) {
        Oe(_, { projectId: t.projectId, projectKind: `remote` });
        return;
      }
      let n = ye.select(_, t);
      s?.(n);
    ...
    Ne = (e) => {
      oe.current && ((oe.current = !1), e.preventDefault(), L());
    },
    Pe = () => {
      (N(_, f, {}), C({ setActive: !0 }));
    },
    Fe = () => {
      (N(_, y, {}), ce(_, null), Oe(_, null), s?.(null));
    },
    B = ve?.roots?.[0] ?? null;
  fe ? (B = e) : r && (B = he ?? B);
  let V = B == null ? null : (Se[B] ?? null),
    ...
    Be = n && c === `home` && P.length === 0 && !F;
  if (!fe && be && ve == null && !Be && he == null) return null;
  let W =
      B == null
        ? null
        : Ct({ activeProjectId: B, groups: P, remoteConnections: ge, selectedRemoteProject: me }),
    G =
    ...
    qe = I
      ? (0, $.jsx)(R.Item, { LeftIcon: E, onSelect: Me, children: Ge })
        ...
        children: (0, $.jsxs)(u, {
          ...
          children: [
            (0, $.jsx)(`span`, {
              ...
              "data-project-selector-icon": U || void 0,
              children: H
                ? (0, $.jsx)(Xe, { className: a(M, `shrink-0`) })
                : V == null
                  ? (0, $.jsx)(Y, {
            ...
            (0, $.jsx)(j, { className: a(M, `shrink-0 text-token-input-placeholder-foreground`) }),
          ],
        }),
      }),
    q = `always`;
      ...
      (0, $.jsx)(Ae, {
        ...
        children: (0, $.jsx)(gt, {
          ...
          icon: (0, $.jsx)(`span`, {
            ...
            children:
              H || W == null
                ? (0, $.jsx)(Y, { className: `icon-xs shrink-0` })
                : V == null
                  ? (0, $.jsx)(Y, {
  ...
  let $e = (0, $.jsx)(m, {
    ...
    disabled: i,
    triggerButton: h ?? (c === `hero` ? Ze() : c === `home` ? J() : Je()),
    ...
    children: (0, $.jsx)(rt, {
      ...
      projectlessActionLabel: (0, $.jsx)(z, {
        id: `composer.localCwdDropdown.clearProject`,
        defaultMessage: `Don't work in a project`,
        description: `Menu item that clears the selected project and starts projectless chats`,
      }),
      onSelectProjectless: U ? Fe : void 0,
      footerItems: n ? qe : null,
      onAddRemoteProject: Ce ? Pe : void 0,
      children: null,
    }),
  });
  return c !== `hero` && U && h == null
    ? (0, $.jsx)(ft, { disabled: i, menuOpen: Ie, onClearProject: Fe, children: $e })
    : $e;
}
function Ct({ activeProjectId: e, groups: t, remoteConnections: n, selectedRemoteProject: r }) {
...
//# sourceMappingURL=app-initial~app-main~projects-index-page~hotkey-window-new-thread-page~hotkey-window-home-p~hswrsggc-D.js.map
