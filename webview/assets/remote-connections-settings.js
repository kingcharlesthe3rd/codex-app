...
import { r as V, t as H } from "./product-logger.js";
import "./rpc.js";
import { o as oe } from "./statsig.js";
import "./request.js";
import { o as se } from "./app-server-manager-hooks-DfDI-9lO.js";
...
import { a as X, d as ge, i as _e, l as ve, n as ye, r as be } from "./dialog-layout.js";
...
import "./badge.js";
import "./search.js";
import { r as we, t as Te } from "./dropdown.js";
import "./globe.js";
import "./three-dots.js";
import { t as Ee } from "./trash.js";
import "./chevron.js";
import { t as De } from "./use-app-server-connection-state-B13v-ij1.js";
...
import { i as ze } from "./settings-shared.js";
...
import { a as Je, i as Ye, t as Xe } from "./codex-mobile-setup-dialog.js";
...
import { r as at, t as ot } from "./onboarding-login-content.js";
import { t as st } from "./tabs.js";
import { t as ct } from "./useForm.js";
var Z = e(O()),
  Q = k(),
  lt = (e) =>
    (0, Q.jsxs)(`svg`, {
...
function bt() {
  let e = (0, $.c)(35),
    ...
    o = I(p, S),
    s;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((s = { hostId: S }), (e[0] = s)) : (s = e[0]);
  let c = et(s),
    l;
  e[1] !== r || e[2] !== t || e[3] !== c
    ? ((l = (e) => {
  ...
  e[11] !== u || e[12] !== o || e[13] !== c.isPending || e[14] !== _
    ? ((v = (0, Q.jsx)(We, {
        ...
        label: m,
        description: h,
        control: (0, Q.jsx)(Le, { checked: o, disabled: g, onChange: u, ariaLabel: _ }),
      })),
      (e[11] = u),
      (e[12] = o),
      (e[13] = c.isPending),
  ...
  return (
    e[32] !== D || e[33] !== v
      ? ((O = (0, Q.jsxs)(Ke, {
          children: [
            d,
            (0, Q.jsx)(Ke.Content, { children: (0, Q.jsxs)(Ge, { children: [v, D] }) }),
          ],
        })),
        (e[32] = D),
        (e[33] = v),
...
function xt(e) {
  ...
  let B;
  t[39] !== R || t[40] !== z
    ? ((B = (0, Q.jsx)(Ke.Header, { title: R, actions: z })), (t[39] = R), (t[40] = z), (t[41] = B))
    : (B = t[41]);
  let V;
  ...
  t[68] !== V || t[69] !== oe || t[70] !== se || t[71] !== U || t[72] !== W
    ? ((G = (0, Q.jsx)(Ke.Content, { children: (0, Q.jsxs)(Ge, { children: [V, oe, se, U, W] }) })),
      (t[68] = V),
      (t[69] = oe),
      (t[70] = se),
      (t[71] = U),
...
function Et(e) {
  return e.last_seen_at == null
    ...
    : (0, Q.jsx)(N, {
        ...
        values: { date: (0, Q.jsx)(Oe, { dateString: e.last_seen_at }, `last-seen-at`) },
      });
}
var Dt = P({
    keepLiveMacLabel: {
...
function At(e) {
  ...
  t[0] === o
    ? (l = t[1])
    : ((l = (0, Q.jsx)(X, { children: (0, Q.jsx)(_e, { title: o }) })), (t[0] = o), (t[1] = l));
...
function Bt(e) {
  ...
  t[49] === l
    ? (P = t[50])
    : ((P = (0, Q.jsx)(Y, { color: `primary`, type: `submit`, loading: l, children: M })),
      (t[49] = l),
      (t[50] = P));
  let F;
  t[51] !== j || t[52] !== P
    ? ((F = (0, Q.jsx)(X, { className: `pt-4`, children: (0, Q.jsxs)(be, { children: [j, P] }) })),
      (t[51] = j),
      (t[52] = P),
      (t[53] = F))
    : (F = t[53]);
  ...
  t[54] !== O || t[55] !== F || t[56] !== y || t[57] !== b || t[58] !== S
    ? ((I = (0, Q.jsxs)(ye, { as: `form`, onSubmit: y, children: [b, S, O, F] })),
      (t[54] = O),
      (t[55] = F),
      (t[56] = y),
      (t[57] = b),
  ...
  return (
    t[60] !== s || t[61] !== n || t[62] !== I || t[63] !== v
      ? ((te = (0, Q.jsx)(ve, { open: n, onOpenChange: s, size: v, children: I })),
        (t[60] = s),
        (t[61] = n),
        (t[62] = I),
        (t[63] = v),
...
function Qt(e) {
  ...
  let _;
  t[2] !== o || t[3] !== d
    ? ((_ = (0, Q.jsx)(we.Item, { LeftIcon: fe, className: Xt, onSelect: d, children: o })),
      (t[2] = o),
      (t[3] = d),
      (t[4] = _))
    : (_ = t[4]);
  ...
  t[10] !== m || t[11] !== h
    ? ((b =
        h != null && m != null
          ? (0, Q.jsx)(we.Item, { LeftIcon: Re, className: Xt, onSelect: m, children: h })
          : null),
      (t[10] = m),
      (t[11] = h),
      (t[12] = b))
...
function nn(e) {
  ...
  let U;
  t[35] !== C || t[36] !== se
    ? ((U = (0, Q.jsx)(N, { ...C, values: se })), (t[35] = C), (t[36] = se), (t[37] = U))
    : (U = t[37]);
  let W;
  t[38] !== z ||
  t[39] !== a ||
  ...
  let G;
  t[46] !== n || t[47] !== b
    ? ((G = (0, Q.jsx)(rn, { connection: n, state: b })), (t[46] = n), (t[47] = b), (t[48] = G))
    : (G = t[48]);
  let K;
  t[49] !== x ||
  t[50] !== z ||
...
function un(e) {
  let t = (0, $.c)(86),
    ...
    f = ee(),
    { appServerVersion: p, error: m, installedCodexVersion: h, state: g } = De(n.hostId),
    _ = n.displayName,
    v;
  t[0] === f
    ? (v = t[1])
  ...
  if (
    ...
    ((M =
      ...
      (t[23] = j),
      (t[24] = M));
  } else ((D = t[19]), (O = t[20]), (k = t[21]), (A = t[22]), (j = t[23]), (M = t[24]));
  let P = M,
    F,
    I;
  ...
  t[68] !== n.hostId || t[69] !== d
    ? ((U = (e) => d(n.hostId, e)), (t[68] = n.hostId), (t[69] = d), (t[70] = U))
    : (U = t[70]);
  let W;
  ...
  let K;
  t[78] !== H || t[79] !== G
    ? ((K = (0, Q.jsxs)(`div`, { className: `flex items-center gap-2`, children: [H, G] })),
      (t[78] = H),
      (t[79] = G),
      (t[80] = K))
    : (K = t[80]);
  ...
  return (
    t[81] !== _ || t[82] !== ne || t[83] !== K || t[84] !== L
      ? ((q = (0, Q.jsx)($t, { displayName: _, icon: F, description: L, status: ne, control: K })),
        (t[81] = _),
        (t[82] = ne),
        (t[83] = K),
        (t[84] = L),
...
function dn({ error: e, restartAvailableNotice: t, state: n }) {
  return n === `error`
    ...
    : t == null
      ...
      : { statusError: u(t), isRestartAvailableNotice: e == null, statusState: `error` };
}
...
function yn(e) {
  ...
  return (
    t[17] !== l || t[18] !== u || t[19] !== d
      ? ((f = (0, Q.jsxs)(ye, { className: `gap-2 px-6 py-5`, children: [l, u, d] })),
        (t[17] = l),
        (t[18] = u),
        (t[19] = d),
        (t[20] = f))
  ...
  if (e.source === `remote-control`) {
    ...
    return [
      ...
      },
      {
        ...
        value: e.lastSeenAt == null ? gn : (0, Q.jsx)(Oe, { dateString: e.lastSeenAt }),
      },
    ];
  }
  let r = [],
...
function On(e) {
  ...
  t[4] === l
    ? (u = t[5])
    : ((u = (0, Q.jsx)(ge, { className: `sr-only`, children: l })), (t[4] = l), (t[5] = u));
  let d;
    ...
    ? ((a = n.online
        ...
        : n.lastSeenAt == null
          ...
          : (0, Q.jsx)(N, {
              ...
              values: { date: (0, Q.jsx)(Oe, { dateString: n.lastSeenAt }, `last-used-at`) },
            })),
      (t[2] = n.lastSeenAt),
      (t[3] = n.online),
      (t[4] = a))
...
function Fn(e) {
  ...
  t[5] === u
    ? (f = t[6])
    : ((f = (0, Q.jsx)(X, { children: (0, Q.jsx)(_e, { title: u, subtitle: d }) })),
      (t[5] = u),
      (t[6] = f));
  let p;
  ...
  return (
    t[23] !== a || t[24] !== r || t[25] !== y
      ? ((b = (0, Q.jsx)(ve, { open: r, onOpenChange: a, size: `compact`, children: y })),
        (t[23] = a),
        (t[24] = r),
        (t[25] = y),
        (t[26] = b))
...
function er() {
  let e = F(M),
    ...
    Xe = R(`authorize-remote-control-connections`, {
      ...
      onError: (t) => {
        (H(e, {
          ...
          j.warning(`${Xn} remote_control_authorize_failed`, { safe: {}, sensitive: { error: t } }),
          e
            .get(q)
            .danger(
              t instanceof ne && t.errorCode === `remote_control_enrollment_account_mismatch`
                ? i.formatMessage({
    ...
    Qe = ae({ mutationFn: (t) => f(e, s.ADDED_REMOTE_CONTROL_ENV_IDS, [...Te, ...t]) }),
      ...
      onError: (n, { autoConnect: r, hostId: a }) => {
        ...
        (r &&
          ...
          D(t, {
            ...
            connection: o,
            errorCategory: T.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_CONNECTION_FAILED,
          }),
              ...
              .catch((e) => {
                throw (
                  D(t, {
                    ...
                    result: C.CODEX_REMOTE_SSH_CONNECTION_RESULT_FAILED,
                    source: y.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
                    errorCategory: T.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UNKNOWN,
                  }),
                  e
                );
              }),
      ...
      if (!it)
        try {
          ...
          (t.push(ie(`refresh-remote-connections`, { signal: e })),
            ye && t.push(ie(`refresh-remote-control-connections`, { signal: e })),
            await Promise.all(t));
        } catch (e) {
          if (e instanceof DOMException && e.name === `AbortError`) return;
          j.debug(`${Xn} auto_refresh_failed`, { safe: {}, sensitive: { error: e } });
        }
    });
  (0, Z.useEffect)(() => {
    let e = null,
  ...
  let _t = async () => {
    ...
    xt = (e) => {
      if (g == null || rt) return;
      let n = g.mode === `edit` ? (Ce.find((e) => e.hostId === g.hostId) ?? null) : null,
    ...
    Dt = async (t) => {
      try {
        (await m(`logout`, { hostId: t }), vt(t, `error`, { code: `login-required` }));
      } catch (n) {
        (j.warning(`${Xn} logout_failed`, { safe: {}, sensitive: { error: n, hostId: t } }),
          e
            .get(q)
            .danger(
              i.formatMessage({
    ...
    children: [
                          ...
                          : (0, Q.jsx)(Q.Fragment, {
                              children: (0, Q.jsx)(_n, {
                                ...
                                onEditSshConnection: (e) => {
                                  ...
                                  t != null && S({ mode: `edit`, hostId: e, draft: Ft(t) });
                                },
                                onInstallCodex: bt,
      ...
      re
        ? (0, Q.jsx)(jt, {
            ...
            onAddManually: () => {
              (z(!1), S({ mode: `add`, draft: Pt(), returnToDiscoveryDialog: !0 }));
            },
            onOpenChange: z,
            onRefresh: () => {
              ct().catch(We);
