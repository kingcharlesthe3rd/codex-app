...
import { Bt as c, o as l, r as u } from "./use-host-config-C.js";
import {
  ba as d,
  ta as f,
  tn as p,
...
import { i as Tt, n as Et, t as Dt } from "./onboarding-login-content.js";
...
function Kt(e) {
  ...
  t[5] === n
    ? (h = t[6])
    : ((h = n ? void 0 : (0, Q.jsx)(gt, { className: `icon-sm` })), (t[5] = n), (t[6] = h));
  let g, _;
  t[7] === n
    ? ((g = t[8]), (_ = t[9]))
    : ((g = n
  ...
  let b;
  return (
    t[18] !== h || t[19] !== g || t[20] !== _ || t[21] !== y
      ? ((b = (0, Q.jsx)(ft, { icon: h, label: g, description: _, control: y })),
        (t[18] = h),
        (t[19] = g),
        (t[20] = _),
        (t[21] = y),
    ...
    (t[39] !== n.hostId || t[40] !== E || t[41] !== _
      ? ((f = function () {
          b.dispatchMessage(`codex-app-server-restart`, {
            hostId: n.hostId,
            killCodexProcess: !0,
            remoteControlEnabled: !E && _.get(m, n.hostId),
          });
        }),
        (t[39] = n.hostId),
        (t[40] = E),
        ...
        !E && (D || o) && C === `connected`
          ? (0, Q.jsx)(V, {
              ...
              children: (0, Q.jsx)(z, {
                ...
                onClick: (e) => {
                  (e.stopPropagation(), o ? h(n.hostId) : d(n.hostId));
                },
...
function Wn({
  ...
  onRenameRemoteControlConnection: h,
...
function Kn(e) {
  let t = (0, $.c)(40),
    ...
    h;
  t[0] !== n.hostId || t[1] !== a
    ? ((h = a.includes(n.hostId)), (t[0] = n.hostId), (t[1] = a), (t[2] = h))
    : (h = t[2]);
  let g = h,
    _ = i(m, n.hostId),
    v = r && d === `connected`,
...
function Hr() {
  let e = a(s),
    ...
    i = ge(),
    u = ve(),
    { connectionsAction: m, connectionsTab: b } = _e(),
    { platform: w } = we(),
    T = U(`782640499`),
    E = U(Ke),
    O = r.formatMessage({
    ...
    lt = qr({ routeAction: m, routeSlug: b, search: i.search }),
    dt = (b != null && at == null) || (m != null && (b !== `ssh` || m !== `add`)),
    ft = Ze({
    ...
    Ft = Pt || Ge || (E && N == null),
    It = (t) => {
      n.getForHostId(t) ?? n.addManager(p(e, t, e.get(_, t)));
    },
    Lt = async () => {
      try {
        let e = [];
          ...
          e.push(
            yt
              ...
              .then(({ remoteConnections: e }) => {
                t.logProductEvent(le, h(e.filter(j)));
              })
              .catch((e) => {
                throw (
                  d(t, {
