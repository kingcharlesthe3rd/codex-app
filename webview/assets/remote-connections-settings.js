...
import { c, f as l, g as u, m as d, n as f, s as p } from "./vscode-api.js";
import "./isEqual.js";
import {
  C as m,
  Xt as h,
...
import { a as se, i as q } from "./setting-storage.js";
...
import "./rpc-2.js";
import { o as de } from "./statsig-DoZ-0xit.js";
import "./request.js";
import "./platform.js";
...
import { i as pe, r as me } from "./selectable-remote-connections-signal-DJZ-ZbLr.js";
...
import { t as ye } from "./terminal.js";
import "./app-intl-signal.js";
import { t as be } from "./info.js";
import "./error-boundary.js";
import "./download.js";
import { t as xe } from "./with-window.js";
import "./window-app-action-helpers.js";
import "./use-window-controls-safe-area.js";
import { g as Se, h as Ce } from "./use-plugin-install-flow.js";
import { t as we } from "./code.js";
import "./folder.js";
...
import { a as Y, d as Oe, i as ke, l as Ae, n as je, r as Me, u as Ne } from "./dialog-layout.js";
...
import "./badge.js";
import "./search.js";
import { r as Fe, t as Ie } from "./dropdown.js";
import "./globe.js";
import "./three-dots.js";
import { t as Le } from "./trash.js";
import "./chevron.js";
import { t as Re } from "./use-app-server-connection-state.js";
import { t as ze } from "./format-relative-date-time.js";
import "./remote-host-globe-icon.js";
import "./cloud.js";
import { t as Be } from "./macbook.js";
import "./worktree.js";
import "./thread-env-icon.js";
import "./check-plugin-availability.js";
import { n as Ve, t as He } from "./app-server-connection-state.js";
import "./alert-1.js";
import { t as Ue } from "./laptop.js";
import { t as We } from "./log-out.js";
...
import { i as qe } from "./settings-shared.js";
import "./thread-page-header.js";
import { t as Je } from "./settings-content-layout.js";
import { t as Ye } from "./more-menu-trigger.js";
import { t as Xe } from "./large-empty-state.js";
import "./plugins-availability.js";
import { t as Ze } from "./sun.js";
import { n as Qe } from "./settings-row.js";
import { n as $e, t as X } from "./settings-group.js";
import { t as et } from "./settings-empty-state.js";
import {
  a as tt,
  d as nt,
  f as rt,
...
import { a as st, i as ct, n as lt, o as ut, r as dt, t as ft } from "./codex-mobile-setup-flow.js";
import "./use-home-directory.js";
import "./cursor.js";
import "./segmented-toggle.js";
import { r as pt, t as mt } from "./onboarding-login-content.js";
import { t as ht } from "./tabs.js";
import { t as gt } from "./useForm.js";
var Z = e(t()),
  Q = n(),
  _t = (e) =>
    (0, Q.jsxs)(`svg`, {
...
function bt(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Q.jsx)(ft, { onClose: n, variant: `dialog` })), (t[0] = n), (t[1] = r)),
    r
  );
}
var xt = (e) =>
...
function St(e) {
  switch (e.deviceType) {
    case `phone`:
      return (0, Q.jsx)(xt, { className: `icon-sm` });
    case `laptop`:
      return (0, Q.jsx)(Be, { className: `icon-sm` });
    case `desktop`:
      return (0, Q.jsx)(Ue, { className: `icon-sm` });
    default:
      return (0, Q.jsx)(Ue, { className: `icon-sm` });
  }
}
function Ct(e) {
  switch (e.clientType) {
    case `CODEX_CLI`:
      return (0, Q.jsx)(ye, { className: `icon-sm` });
    case `CODEX_DESKTOP_APP`:
      return (0, Q.jsx)(Ue, { className: `icon-sm` });
    case `CODEX_IDE_VSCODE`:
    case `CODEX_IDE_XCODE`:
    case `CODEX_IDE_JETBRAINS`:
      return (0, Q.jsx)(we, { className: `icon-sm` });
    case `CODEX_UNKNOWN`:
      return (0, Q.jsx)(Ue, { className: `icon-sm` });
  }
}
var wt = `remote-control-client-revoke-success`,
  Tt = `remote-control-client-revoke-error`,
  Et = `[remote-connections/settings]`;
function Dt(e) {
  let t = (0, $.c)(22),
    { clients: n, scrollAfterThreeRows: r, onRevoked: i, onRevokeResult: o } = e,
    c = r === void 0 ? !1 : r,
    l = a(s),
    f = P(),
    p;
  t[0] !== f || t[1] !== o || t[2] !== i || t[3] !== l
    ? ((p = (e, t) => {
        let { clientId: n } = t;
        (o?.(`succeeded`),
          i(n),
  ...
  t[5] !== f || t[6] !== o || t[7] !== l
    ? ((m = (e, t) => {
        let { clientId: n } = t;
        (o?.(`failed`),
          d.warning(`${Et} remote_control_client_revoke_failed`, {
            safe: {},
  ...
  let h;
  t[9] !== p || t[10] !== m
    ? ((h = { mutationFn: ut, onSuccess: p, onError: m }), (t[9] = p), (t[10] = m), (t[11] = h))
    : (h = t[11]);
  let g = u(h),
    _ = g.isPending ? g.variables?.clientId : null,
    v = c && n.length > 3 ? `max-h-52 overflow-y-auto` : void 0,
    y;
  ...
  return (
    t[19] !== v || t[20] !== y
      ? ((b = (0, Q.jsx)($e, { className: v, children: y })), (t[19] = v), (t[20] = y), (t[21] = b))
      : (b = t[21]),
    b
  );
}
...
function kt(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = { mutationFn: (e) => ot(r, n, e) }), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    u(i)
  );
}
function At() {
  let e = (0, $.c)(2),
    { data: t, isLoading: n } = ge(S.CODEX_MOBILE_SETUP_COMPLETED);
  if (n) return null;
  if (!t) {
    let t;
    return (
      e[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((t = (0, Q.jsx)(Mt, { mode: `setup` })), (e[0] = t))
        : (t = e[0]),
      t
    );
  }
  ...
  return (
    e[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Q.jsxs)(Q.Fragment, {
          children: [(0, Q.jsx)(Mt, { mode: `manage` }), (0, Q.jsx)(jt, {})],
        })),
        (e[1] = r))
      : (r = e[1]),
    r
...
function jt() {
  let e = (0, $.c)(41),
    ...
    { platform: r } = ve(),
    o = de(tt),
    c = se(m.keepRemoteControlAwakeWhilePluggedIn),
    l = i(O, M),
    u;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((u = { hostId: M }), (e[0] = u)) : (u = e[0]);
  let d = kt(u),
    f;
  e[1] !== n || e[2] !== t || e[3] !== d
    ? ((f = (e) => {
  ...
  e[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, Q.jsx)(nt, { className: `icon-sm` })), (e[6] = g))
    : (g = e[6]);
  let _, v;
  e[7] === o
    ? ((_ = e[8]), (v = e[9]))
    : ((_ = o
        ? (0, Q.jsx)(F, { ...Ft.allowConnectionsLabel })
        : (0, Q.jsx)(F, {
  ...
  e[10] !== n || e[11] !== o
    ? ((y = o
        ? n.formatMessage(Ft.allowConnectionsLabel)
        : n.formatMessage({
            id: `settings.remoteConnections.localHost.remoteControl.label`,
            defaultMessage: `Allow this device to be discovered and controlled`,
            description: `Label for allowing remote control on this device`,
    ...
    : (y = e[12]);
  let b;
  e[13] !== p || e[14] !== l || e[15] !== d.isPending || e[16] !== y
    ? ((b = (0, Q.jsx)(Ge, { checked: l, disabled: d.isPending, onChange: p, ariaLabel: y })),
      (e[13] = p),
      (e[14] = l),
      (e[15] = d.isPending),
      (e[16] = y),
    ...
    : (b = e[17]);
  let x;
  e[18] !== _ || e[19] !== v || e[20] !== b
    ? ((x = (0, Q.jsx)(Qe, { icon: g, label: _, description: v, control: b })),
      (e[18] = _),
      (e[19] = v),
      (e[20] = b),
      (e[21] = x))
  ...
  e[22] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, Q.jsx)(Ze, { className: `icon-sm` })), (e[22] = S))
    : (S = e[22]);
  let C;
  e[23] === r
    ? (C = e[24])
    : ((C =
        r === `windows`
          ? (0, Q.jsx)(F, { ...Ft.keepLiveWindowsLabel })
          : (0, Q.jsx)(F, { ...Ft.keepLiveMacLabel })),
      (e[23] = r),
      (e[24] = C));
  let w;
  ...
  e[26] === t
    ? (E = e[27])
    : ((E = (e) => {
        q(t, m.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[26] = t),
      (e[27] = E));
  let D;
  e[28] !== n || e[29] !== r
    ? ((D =
        r === `windows`
          ? n.formatMessage(Ft.keepLiveWindowsLabel)
          : n.formatMessage(Ft.keepLiveMacLabel)),
      (e[28] = n),
      (e[29] = r),
      (e[30] = D))
    : (D = e[30]);
  let k;
  e[31] !== T || e[32] !== E || e[33] !== D
    ? ((k = (0, Q.jsx)(Ge, { checked: T, onChange: E, ariaLabel: D })),
      (e[31] = T),
      (e[32] = E),
      (e[33] = D),
      (e[34] = k))
  ...
  let A;
  e[35] !== C || e[36] !== k
    ? ((A = (0, Q.jsx)(Qe, { icon: S, label: C, description: w, control: k })),
      (e[35] = C),
      (e[36] = k),
      (e[37] = A))
    : (A = e[37]);
  ...
  return (
    e[38] !== A || e[39] !== x
      ? ((j = (0, Q.jsxs)(X, {
          children: [h, (0, Q.jsx)(X.Content, { children: (0, Q.jsxs)($e, { children: [x, A] }) })],
        })),
        (e[38] = A),
        (e[39] = x),
        (e[40] = j))
...
function Mt(e) {
  let t = (0, $.c)(50),
    ...
    [p] = j(`local_remote_control_client_id`),
    m = o(dt),
    h = l === `waiting`,
    g;
  t[0] !== d || t[1] !== p || t[2] !== h
    ? ((g = { existingClientIds: d, hostId: null, localRemoteControlClientId: p, waiting: h }),
      (t[0] = d),
      (t[1] = p),
      (t[2] = h),
      (t[3] = g))
    : (g = t[3]);
  let _ = i(ct, g),
    v = l === `waiting` ? _.data : null,
    y = v === `connected` ? `connected` : v === `dismiss` ? null : l,
    b;
  t[4] === r.query ? (b = t[5]) : ((b = r.query.snapshot(dt)), (t[4] = r.query), (t[5] = b));
  let x = b,
    S;
  t[6] !== p || t[7] !== m.data
    ? ((S = st(m.data, p)), (t[6] = p), (t[7] = m.data), (t[8] = S))
    : (S = t[8]);
  let C = S,
    w = C?.length,
    T = m.error instanceof rt,
    E,
    D;
  (t[9] !== n || t[10] !== w || t[11] !== m.isLoading || t[12] !== r
    ? ((E = () => {
        n !== `manage` || m.isLoading || w == null || W(r, B, { clientCount: w });
      }),
      (D = [n, w, m.isLoading, r]),
      (t[9] = n),
      (t[10] = w),
    ...
    (0, Z.useEffect)(E, D));
  let O;
  t[15] !== n || t[16] !== w || t[17] !== C || t[18] !== r
    ? ((O = () => {
        if ((W(r, R, { existingClientCount: w ?? 0, source: n }), n === `setup`)) {
          De(r, bt);
          return;
        }
        (f(new Set(C?.map(Pt))), u(`waiting`));
      }),
      (t[15] = n),
      (t[16] = w),
      (t[17] = C),
  ...
  t[22] === c
    ...
    : ((P =
      ...
      (t[23] = P));
  let I;
  t[24] !== k || t[25] !== N || t[26] !== n || t[27] !== m.isLoading
    ? ((I =
        n === `manage` && N
          ? (0, Q.jsx)(K, {
              color: `secondary`,
  ...
  let L;
  t[29] !== I || t[30] !== P
    ? ((L = (0, Q.jsx)(X.Header, { title: P, actions: I })), (t[29] = I), (t[30] = P), (t[31] = L))
    : (L = t[31]);
  let z;
  t[32] !== k ||
  t[33] !== n ||
  ...
  t[41] !== r
    ? ((z = (0, Q.jsx)(X.Content, {
        children:
          n === `manage` && !m.isError && C != null && C.length > 0
            ? (0, Q.jsx)(Dt, {
                clients: C,
                onRevoked: (e) => {
                  (x.setData((t) => t?.filter((t) => t.clientId !== e)), x.invalidate());
                },
                onRevokeResult: (e) => {
                  W(r, H, { result: e });
                },
  ...
  let ee;
  return (
    t[46] !== L || t[47] !== z || t[48] !== V
      ? ((ee = (0, Q.jsxs)(X, { children: [L, z, V] })),
        (t[46] = L),
        (t[47] = z),
        (t[48] = V),
        (t[49] = ee))
...
var Ft = I({
  ...
  It = `[remote-connections/auth]`;
function Lt({ hostId: e, open: t, onOpenChange: n }) {
  let r = a(s),
    i = P(),
    ...
    S = async () => {
      if (e == null) {
        x(`Remote connection manager is unavailable.`);
        return;
      }
      if (v) {
        (o?.abort(), c(null));
      ...
      c(t);
      try {
        let { authUrl: n, completion: r } = await pt({ hostId: e, signal: t.signal });
        l.dispatchMessage(`open-in-browser`, { url: n });
        let i = await r;
        if (!i.success) {
          (d.warning(`${It} chatgpt_sign_in_failed`, {
            safe: {},
            sensitive: { hostId: e, error: i.error ?? `Unknown error` },
          }),
            x(i.error ?? `Unknown error`));
          return;
        }
        b({ abortPendingLogin: !1 });
      } catch (t) {
    ...
    C = async () => {
      ...
      if (!(!t || g)) {
        ...
        try {
          ...
          (d.warning(`${It} api_key_sign_in_failed`, {
            safe: {},
            sensitive: { error: t, hostId: e },
          }),
            x(t));
      ...
      children: [
        ...
        (0, Q.jsx)(Y, {
          children: (0, Q.jsx)(`div`, {
            ...
            children: (0, Q.jsx)(mt, {
              apiKeyValue: u,
              isApiKeyEntryVisible: p,
              isApiKeySignInPending: g,
              isChatGptSignInPending: v,
              onApiKeySecondaryAction: () => {
                (f(``), m(!1));
              },
              onApiKeySubmit: C,
              onApiKeyValueChange: f,
              onChatGptSignIn: S,
              onShowApiKeyEntry: () => m(!0),
              apiKeySecondaryActionLabel: (0, Q.jsx)(F, {
...
function Rt(e) {
  ...
  t[0] === o
    ? (l = t[1])
    : ((l = (0, Q.jsx)(Y, { children: (0, Q.jsx)(ke, { title: o }) })), (t[0] = o), (t[1] = l));
  ...
  t[5] !== u || t[6] !== d
    ? ((f = (0, Q.jsx)(Y, {
        ...
        children: (0, Q.jsx)(`div`, {
          className: `h-[300px]`,
          children: (0, Q.jsx)($e, { className: u, children: d }),
        }),
      })),
      (t[5] = u),
      (t[6] = d),
...
function zt(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, Q.jsx)(Ke, { className: `icon-sm` })), (t[5] = v))
    : (v = t[5]);
  let y;
          ...
          : n.map((e) => {
              ...
              return (0, Q.jsx)(
                `div`,
                {
                  ...
                  tabIndex: r ? -1 : 0,
                  children: (0, Q.jsx)(Qe, {
                    icon: (0, Q.jsx)(Ue, { className: `icon-sm` }),
                    label: t,
...
function Wt(e, { connectionAnalyticsId: t } = {}) {
...
function Gt({ draft: e, editingHostId: t, existingConnections: n }) {
  let r = [],
...
function Jt(e) {
  ...
  t[0] !== o || t[1] !== a
    ? ((f = (e) => {
        let t = Gt({ draft: e, existingConnections: a, editingHostId: o });
  ...
  t[18] !== _.Subscribe || t[19] !== x
    ? ((S = (0, Q.jsx)(_.Subscribe, { selector: x, children: Xt })),
      (t[18] = _.Subscribe),
      (t[19] = x),
      (t[20] = S))
    : (S = t[20]);
  ...
  t[49] === l
    ? (N = t[50])
    : ((N = (0, Q.jsx)(K, { color: `primary`, type: `submit`, loading: l, children: M })),
      (t[49] = l),
      (t[50] = N));
  let I;
  t[51] !== j || t[52] !== N
    ? ((I = (0, Q.jsx)(Y, { className: `pt-4`, children: (0, Q.jsxs)(Me, { children: [j, N] }) })),
      (t[51] = j),
      (t[52] = N),
      (t[53] = I))
    : (I = t[53]);
  let L;
  t[54] !== O || t[55] !== I || t[56] !== y || t[57] !== b || t[58] !== S
    ? ((L = (0, Q.jsxs)(je, { as: `form`, onSubmit: y, children: [b, S, O, I] })),
      (t[54] = O),
      (t[55] = I),
      (t[56] = y),
      (t[57] = b),
  ...
  let R;
  return (
    t[60] !== s || t[61] !== n || t[62] !== L || t[63] !== v
      ? ((R = (0, Q.jsx)(Ae, { open: n, onOpenChange: s, size: v, children: L })),
        (t[60] = s),
        (t[61] = n),
        (t[62] = L),
        (t[63] = v),
...
function Zt(e) {
  return (0, Q.jsx)(`div`, { children: en(e) }, e);
}
function Qt(e) {
  let t = (0, $.c)(16),
...
function tn(e) {
  return {
    refreshSource: ie.CODEX_REMOTE_CONTROL_REFRESH_SOURCE_SETTINGS,
    ...
    unsupportedAppServerVersionConnectionCount: e.filter((e) => !x(e.appServerVersion)).length,
  };
}
var nn = (e) =>
    (0, Q.jsxs)(`svg`, {
...
function an(e) {
  ...
  return (
    t[6] !== o || t[7] !== a
      ? ((s = (0, Q.jsx)(ue, { tooltipContent: a, openWhen: `trigger-overflows`, children: o })),
        (t[6] = o),
        (t[7] = a),
        (t[8] = s))
      : (s = t[8]),
...
var on = `text-sm electron:!text-sm`,
  sn = `!size-5 !rounded-full !p-0 electron:!rounded-full electron:!p-0`;
function cn(e) {
  let t = (0, $.c)(29),
    {
      actionsLabel: n,
  ...
  t[0] === n
    ? (g = t[1])
    : ((g = (0, Q.jsx)(Ye, { label: n, size: `icon`, iconClassName: `icon-sm`, className: sn })),
      (t[0] = n),
      (t[1] = g));
  let _;
  t[2] !== o || t[3] !== d
    ? ((_ = (0, Q.jsx)(Fe.Item, { LeftIcon: be, className: on, onSelect: d, children: o })),
      (t[2] = o),
      (t[3] = d),
      (t[4] = _))
    : (_ = t[4]);
  ...
  t[10] !== m || t[11] !== h
    ? ((b =
        h != null && m != null
          ? (0, Q.jsx)(Fe.Item, { LeftIcon: Ke, className: on, onSelect: m, children: h })
          : null),
      (t[10] = m),
      (t[11] = h),
      (t[12] = b))
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = (0, Q.jsx)(Fe.Separator, {})), (t[15] = S))
    : (S = t[15]);
  let C;
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((C = G(on, `text-token-charts-red`)), (t[16] = C))
    : (C = t[16]);
  let w = r ? a : null,
    T;
...
function ln(e) {
  let t = (0, $.c)(22),
    ...
    l;
  t[0] !== a || t[1] !== s
    ? ((l = s ?? (0, Q.jsx)(an, { value: a })), (t[0] = a), (t[1] = s), (t[2] = l))
    : (l = t[2]);
  let u = l,
    d = o ?? c,
    f;
  ...
  t[14] !== n || t[15] !== r || t[16] !== d || t[17] !== h
    ? ((g = (0, Q.jsx)(Qe, { className: n, icon: d, label: h, control: r })),
      (t[14] = n),
      (t[15] = r),
      (t[16] = d),
      (t[17] = h),
...
function un(e, t) {
  return !e.online || !x(e.appServerVersion)
  ...
  return t.online
    ? x(t.appServerVersion)
      ...
      : e.formatMessage(
          ...
          { currentVersion: t.appServerVersion, requiredVersion: b },
        )
    : e.formatMessage({
...
function fn(e) {
  ...
  let C = S,
    w;
  t[6] === g ? (w = t[7]) : ((w = g.trim()), (t[6] = g), (t[7] = w));
  let T = w,
    E;
  t[8] === h
    ? (E = t[9])
  ...
  let ne = te,
    re;
  t[25] !== ne || t[26] !== n || t[27] !== o || t[28] !== d || t[29] !== T
    ? ((re = async () => {
        if (!(T.length === 0 || o)) {
          if (T === n.displayName) {
            ne();
  ...
  let ie = re,
    ae = n.displayName,
    oe;
  t[31] === n ? (oe = t[32]) : ((oe = Ct(n)), (t[31] = n), (t[32] = oe));
  let U;
  t[33] === n.appServerVersion
    ? (U = t[34])
    : ((U = { currentVersion: n.appServerVersion, requiredVersion: b }),
      (t[33] = n.appServerVersion),
      (t[34] = U));
  let W;
  t[35] !== C || t[36] !== U
    ? ((W = (0, Q.jsx)(F, { ...C, values: U })), (t[35] = C), (t[36] = U), (t[37] = W))
    : (W = t[37]);
  let G;
  t[38] !== ne ||
  t[39] !== i ||
  ...
  let se;
  t[46] !== n || t[47] !== v
    ? ((se = (0, Q.jsx)(pn, { connection: n, state: v })), (t[46] = n), (t[47] = v), (t[48] = se))
    : (se = t[48]);
  let q;
  t[49] !== y ||
  t[50] !== ne ||
...
function pn(e) {
  ...
  let o = a,
    s;
  t[4] !== n || t[5] !== r ? ((s = un(n, r)), (t[4] = n), (t[5] = r), (t[6] = s)) : (s = t[6]);
  let c;
  t[7] !== o || t[8] !== s
  ...
  return (
    t[10] !== o || t[11] !== c
      ? ((l = (0, Q.jsx)(ue, { tooltipContent: o, children: c })),
        (t[10] = o),
        (t[11] = c),
        (t[12] = l))
      : (l = t[12]),
...
function mn(e, t, n, r) {
  return !e && !t
    ? hn.signedInDeviceAuthorizationRequiredOfflineSubtitle
    : e
      ? t
        ? n
          ? r === `connecting` || r === `restarting`
            ? hn.signedInDeviceConnectingSubtitle
            : r === `error`
              ? hn.signedInDeviceConnectionFailedSubtitle
              : r === `connected`
                ? hn.signedInDeviceOnlineSubtitle
                : hn.signedInDeviceDisconnectedSubtitle
          : hn.signedInDeviceUpdateRequiredSubtitle
        : hn.signedInDeviceOfflineSubtitle
      : hn.signedInDeviceAuthorizationRequiredSubtitle;
}
var hn = I({
  ...
  gn = `` + new URL(`dialog-artwork-ssh-remote-control-allow-Cx1m-RXh.png`, import.meta.url).href;
function _n(e) {
  let t = (0, $.c)(19),
  ...
  t[4] === c
    ...
    : ((l = (0, Q.jsx)(`div`, {
        ...
        children: (0, Q.jsx)(`img`, { alt: c, className: `h-full w-full object-cover`, src: gn }),
      })),
      (t[4] = c),
      (t[5] = l));
  let u;
...
function vn(e) {
          ...
          a == null
            ...
            : (0, Q.jsx)(ue, {
                ...
                children: (0, Q.jsx)(`span`, {
                  ...
                  children: (0, Q.jsx)(be, { "aria-hidden": !0, className: `icon-xs shrink-0` }),
                }),
              })),
        (t[3] = s),
        (t[4] = a),
  ...
  t[16] === l
    ...
    : ((u = (0, Q.jsx)(`span`, { className: `min-w-0 break-words`, children: l })),
      ...
      (t[17] = u));
  let d;
  t[18] === n ? (d = t[19]) : ((d = (0, Q.jsx)(bn, { action: n })), (t[18] = n), (t[19] = d));
  let f;
  return (
    t[20] !== u || t[21] !== d
...
function bn(e) {
  ...
  t[4] !== n.renderInElectronOnly || t[5] !== o
    ? ((s = n.renderInElectronOnly === !0 ? (0, Q.jsx)(xe, { electron: !0, children: o }) : o),
  ...
  return (
    t[7] !== n.tooltipText || t[8] !== c
      ? ((l =
          n.tooltipText == null
            ? c
            : (0, Q.jsx)(ue, { tooltipContent: n.tooltipText, children: c })),
        (t[7] = n.tooltipText),
        (t[8] = c),
        (t[9] = l))
      : (l = t[9]),
...
function xn(e) {
  let t = (0, $.c)(108),
    ...
    h = P(),
    { appServerVersion: g, error: _, installedCodexVersion: v, state: y } = Re(n.hostId),
    b = n.displayName,
    x = he(),
    S;
  t[0] === h
  ...
  if (
    ...
    z = Cn({ appServerVersion: g, installedCodexVersion: v, state: y });
    let e;
    (t[31] !== n.displayName || t[32] !== h
      ? ((e = h.formatMessage(
          {
    ...
    let {
      ...
      statusState: u,
    } = Sn({ error: _, restartAvailableNotice: z, state: y });
    ((B = s),
      (I = l),
      (V =
        u == null
          ? null
          : Ve(h, { canLogin: !0, error: B, state: u, surface: `connections-row` })));
    let d = !M && (B?.code === `remote-codex-not-found` || B?.code === `update-required`);
    ((ee =
      V == null || d
        ? null
        : wn({
  ...
  t[36] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((te = (0, Q.jsx)(ye, { className: `icon-sm` })),
      (ne = (0, Q.jsx)(F, {
      ...
      (t[37] = ne))
    : ((te = t[36]), (ne = t[37]));
  let re = V?.message ?? null,
    ie;
  t[38] !== I || t[39] !== z || t[40] !== H || t[41] !== B || t[42] !== re
    ? ((ie = (0, Q.jsxs)(Q.Fragment, {
        children: [
          ne,
          (0, Q.jsx)(vn, {
            action: H,
    ...
    : (ie = t[43]);
  let ae;
  t[44] !== n || t[45] !== _ || t[46] !== y
    ? ((ae = (0, Q.jsx)(En, { connection: n, error: _, state: y })),
      (t[44] = n),
      (t[45] = _),
      (t[46] = y),
      (t[47] = ae))
  ...
  t[48] !== b || t[49] !== h
    ...
    : (oe = t[50]);
  let U;
  t[51] !== n.hostId || t[52] !== s
    ? ((U = () => s(n.hostId)), (t[51] = n.hostId), (t[52] = s), (t[53] = U))
    : (U = t[53]);
  let W;
  t[54] !== n || t[55] !== f
    ? ((W = () => f(n)), (t[54] = n), (t[55] = f), (t[56] = W))
    : (W = t[56]);
  let G = N ? k : void 0,
    se;
  t[57] !== N || t[58] !== n.hostId
    ? ((se = N
        ? () => {
            Tn(n.hostId);
          }
    ...
    : (se = t[59]);
  let q;
  t[60] !== n.hostId || t[61] !== l || t[62] !== y
    ? ((q = y === `connected` ? () => l(n.hostId) : void 0),
      (t[60] = n.hostId),
      (t[61] = l),
      (t[62] = y),
      (t[63] = q))
    : (q = t[63]);
  let ce;
  t[64] !== n.hostId || t[65] !== d
    ? ((ce = () => d(n.hostId)), (t[64] = n.hostId), (t[65] = d), (t[66] = ce))
    : (ce = t[66]);
  let le;
  t[67] !== T ||
  t[68] !== D ||
  ...
  t[87] !== y
    ? ((fe =
        (x || a) && y === `connected`
          ? (0, Q.jsx)(ue, {
              ...
              children: (0, Q.jsx)(K, {
                ...
                onClick: (e) => {
                  (e.stopPropagation(), a ? p(n.hostId) : u(n.hostId));
                },
                children: (0, Q.jsx)(nn, { className: `icon-sm` }),
              }),
            })
          : null),
      (t[79] = n.hostId),
      ...
      (t[88] = fe))
    : (fe = t[88]);
  let pe = n.autoConnect,
    me;
  t[89] !== n.hostId || t[90] !== m
    ? ((me = (e) => m(n.hostId, e)), (t[89] = n.hostId), (t[90] = m), (t[91] = me))
    : (me = t[91]);
  let ge;
  t[92] !== n.displayName || t[93] !== h
    ? ((ge = h.formatMessage(
        {
    ...
    : (ge = t[94]);
  let J;
  t[95] !== n.autoConnect || t[96] !== me || t[97] !== ge
    ? ((J = (0, Q.jsx)(Ge, { checked: pe, onChange: me, ariaLabel: ge })),
      (t[95] = n.autoConnect),
      (t[96] = me),
      (t[97] = ge),
      (t[98] = J))
    : (J = t[98]);
  let _e;
  t[99] !== le || t[100] !== fe || t[101] !== J
    ? ((_e = (0, Q.jsxs)(`div`, { className: `flex items-center gap-1.5`, children: [le, fe, J] })),
      (t[99] = le),
      (t[100] = fe),
      (t[101] = J),
      (t[102] = _e))
  ...
  let ve;
  return (
    t[103] !== b || t[104] !== ie || t[105] !== ae || t[106] !== _e
      ? ((ve = (0, Q.jsx)(ln, {
          displayName: b,
          icon: te,
          description: ie,
...
function Sn({ error: e, restartAvailableNotice: t, state: n }) {
  return n === `error`
    ? {
        statusError: e ?? (t == null ? null : g(t)),
        isRestartAvailableNotice: !1,
        statusState: `error`,
      }
    : t == null
      ? { statusError: null, isRestartAvailableNotice: !1, statusState: n }
      : { statusError: g(t), isRestartAvailableNotice: e == null, statusState: `error` };
}
function Cn({ appServerVersion: e, installedCodexVersion: t, state: n }) {
  return n == null ||
    e == null ||
    t == null ||
    !y({ appServerVersion: e, installedCodexVersion: t })
    ? null
  ...
  switch (e.kind) {
    ...
    case `restart`:
      return e.tooltipText == null
        ? { label: e.label, onClick: () => Tn(n) }
        : { label: e.label, tooltipText: e.tooltipText, onClick: () => Tn(n) };
    case `settings`:
      return null;
  }
}
function Tn(e) {
  l.dispatchMessage(`codex-app-server-restart`, { hostId: e, killCodexProcess: !0 });
}
function En(e) {
  let t = (0, $.c)(18),
  ...
  if (i === `error`) {
    let e;
    t[0] !== r || t[1] !== a || t[2] !== i
      ? ((e = Ve(a, { canLogin: !1, error: r, state: i, surface: `connections-row` })),
        (t[0] = r),
        (t[1] = a),
        (t[2] = i),
        (t[3] = e))
    ...
    return (
      t[6] !== o || t[7] !== s
        ? ((c = (0, Q.jsx)(ue, { tooltipContent: o, children: s })),
          (t[6] = o),
          (t[7] = s),
          (t[8] = c))
        : (c = t[8]),
  ...
  if (i != null) {
    ...
    return (
      t[9] === n.hostId
        ? (e = t[10])
        : ((e = (0, Q.jsx)(He, { hostId: n.hostId })), (t[9] = n.hostId), (t[10] = e)),
      e
    );
  }
  let o;
  ...
  return (
    t[15] !== s || t[16] !== c
      ? ((l = (0, Q.jsx)(ue, { tooltipContent: s, children: c })),
        (t[15] = s),
        (t[16] = c),
        (t[17] = l))
      : (l = t[17]),
...
function On({
  ...
  let y = a(s),
    ...
    j = de(tt),
    M = A ? (O?.hostId ?? null) : w,
    N = M == null ? null : (e.find((e) => e.hostId === M) ?? null),
    P = async (e, t) => {
      if (S == null) {
        C(e.envId);
        try {
    ...
    children: [
      ...
      E == null
        ...
        : (0, Q.jsx)(In, {
            ...
            onRemoteControlAllowedForSshConnection: _,
            onAllowed: (e) => {
              (D(null), E.startPairingAfterAllow ? L(e) : T(e));
            },
            onOpenChange: (e) => {
              e || D(null);
            },
...
function kn(e) {
  let t = (0, $.c)(11),
    ...
    l = n != null,
    u;
  t[0] !== n || t[1] !== a || t[2] !== o || t[3] !== s || t[4] !== r || t[5] !== i
    ? ((u =
        n == null
          ? null
          : (0, Q.jsx)(An, {
...
function An(e) {
  let t = (0, $.c)(31),
    ...
    { appServerVersion: c, error: l, state: u } = Re(n.hostId),
    d = he(),
    f = n.source === `remote-control`,
    p;
  t[0] !== n || t[1] !== l || t[2] !== f || t[3] !== u
    ? ((p = f
        ? (0, Q.jsxs)(jn, {
            children: [
              (0, Q.jsx)(pn, { connection: n, state: u }),
              (0, Q.jsx)(F, {
        ...
        : (0, Q.jsx)(Mn, { connection: n, error: l, state: u })),
      (t[0] = n),
      (t[1] = l),
      (t[2] = f),
      (t[3] = u),
  ...
  t[8] !== c || t[9] !== n || t[10] !== u
    ? ((h = (0, Q.jsx)(Y, {
        className: `pt-0`,
        children: (0, Q.jsx)(Ln, { connection: n, state: u, appServerVersion: c }),
      })),
      (t[8] = c),
      (t[9] = n),
      (t[10] = u),
    ...
    : (h = t[11]);
  let g;
  t[12] !== n || t[13] !== f || t[14] !== s || t[15] !== i
    ? ((g = f
        ? null
        : (0, Q.jsx)(Pn, {
            connection: n,
            remoteControlAllowed: i.includes(n.hostId),
            onAdd: () => s(n.hostId),
          })),
      (t[12] = n),
      (t[13] = f),
    ...
    ? ((_ =
        !f && (d || r) && u === `connected`
          ? (0, Q.jsx)(Fn, {
              connection: n,
              oneToOnePairingInAppEnabled: r,
              remoteControlSetupRequired: !i.includes(n.hostId),
              onDisableRemoteControl: a,
              onRequestRemoteControlAllow: o,
            })
          : null),
  ...
  let v;
  return (
    t[26] !== m || t[27] !== h || t[28] !== g || t[29] !== _
      ? ((v = (0, Q.jsxs)(je, { className: `gap-2 px-6 py-5`, children: [m, h, g, _] })),
        (t[26] = m),
        (t[27] = h),
        (t[28] = g),
        (t[29] = _),
...
function Mn(e) {
  ...
  return (
    t[0] !== n || t[1] !== r || t[2] !== i
      ? ((a = (0, Q.jsx)(Nn, { connection: n, error: r, state: i })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i),
        (t[3] = a))
...
function Nn(e) {
  let t = (0, $.c)(7),
    ...
    a;
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((a = (0, Q.jsx)(En, { connection: n, error: r, state: i })),
      (t[0] = n),
      (t[1] = r),
      (t[2] = i),
      (t[3] = a))
  ...
  let s;
  return (
    t[5] === a ? (s = t[6]) : ((s = (0, Q.jsxs)(jn, { children: [a, o] })), (t[5] = a), (t[6] = s)),
    s
  );
}
function Pn(e) {
  let t = (0, $.c)(20),
    { connection: n, remoteControlAllowed: r, onAdd: o } = e,
    c = a(s),
    l = i(lt, n.hostId),
    u;
  t[0] !== n.hostId || t[1] !== c.query
    ? ((u = c.query.snapshot(lt, n.hostId)), (t[0] = n.hostId), (t[1] = c.query), (t[2] = u))
    : (u = t[2]);
  let d = u,
    f = l.data,
    p = (f?.length ?? 0) > 0,
  ...
  t[8] === h
    ? (g = t[9])
    : ((g = (0, Q.jsx)(X.Header, { title: m, actions: h })), (t[8] = h), (t[9] = g));
  let _;
  t[10] !== p || t[11] !== o || t[12] !== r || t[13] !== f || t[14] !== l || t[15] !== d
    ? ((_ = (0, Q.jsx)(X.Content, {
        children:
          p && f != null
            ? (0, Q.jsx)(Dt, {
                ...
                onRevoked: (e) => {
                  (d.setData((t) => t?.filter((t) => t.clientId !== e)), d.invalidate());
                },
              })
            : (0, Q.jsx)($e, {
  ...
  return (
    t[17] !== g || t[18] !== _
      ? ((v = (0, Q.jsx)(Y, { className: `pt-0`, children: (0, Q.jsxs)(X, { children: [g, _] }) })),
        (t[17] = g),
        (t[18] = _),
        (t[19] = v))
      : (v = t[19]),
...
function Fn(e) {
  ...
  t[6] === r
    ? (_ = t[7])
    : ((_ = r ? (0, Q.jsx)(nn, { className: `icon-sm text-token-text-primary` }) : void 0),
      (t[6] = r),
      (t[7] = _));
  let v;
  t[8] !== r || t[9] !== o
  ...
  let x;
  return (
    t[23] !== _ || t[24] !== v || t[25] !== y || t[26] !== b
      ? ((x = (0, Q.jsx)(Y, {
          className: `pt-0`,
          children: (0, Q.jsx)($e, {
            children: (0, Q.jsx)(Qe, { icon: _, label: v, description: y, control: b }),
          }),
        })),
        (t[23] = _),
        (t[24] = v),
...
function In(e) {
  ...
  return (
    t[12] !== u || t[13] !== o || t[14] !== g
      ? ((_ = (0, Q.jsx)(_n, { allowing: u, open: !0, onAllow: g, onOpenChange: o })),
        (t[12] = u),
        (t[13] = o),
        (t[14] = g),
        (t[15] = _))
...
function Ln(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== c || t[3] !== o || t[4] !== i) {
    ...
    (t[10] === s
      ...
      : ((d = (e) => {
          let t = e.copyValue,
            n = typeof e.value == `string` ? (0, Q.jsx)(an, { value: e.value }) : e.value;
          return (0, Q.jsxs)(
            `div`,
            {
  ...
  if (e.source === `remote-control`) {
    ...
    return [
      ...
      },
      {
        ...
        value: e.lastSeenAt == null ? Dn : (0, Q.jsx)(ze, { dateString: e.lastSeenAt }),
      },
    ];
  }
  let r = [],
  ...
  (e.source === `discovered` &&
    ...
    r.push(
      ...
      },
      {
        ...
        value: e.sshPort == null ? Dn : String(e.sshPort),
      },
      {
...
function Vn(e) {
  ...
  let h;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Q.jsx)(it, { variant: `dialog` })), (t[14] = h))
    : (h = t[14]);
  let g;
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, Q.jsx)(F, {
...
function Un(e) {
  ...
  let g = r || i,
    _;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Q.jsx)(Ke, { className: `icon-sm` })), (t[5] = _))
    : (_ = t[5]);
  let v;
              ...
              return (0, Q.jsx)(
                `div`,
                {
                  ...
                  children: (0, Q.jsx)(Qe, {
                    icon: Ct(e),
                    label: e.displayName,
                    description: (0, Q.jsx)(Kn, { connection: e }),
                    control: (0, Q.jsx)(`div`, {
                      className: `relative flex items-center`,
                      onClick: Gn,
                      onKeyDown: Wn,
...
function Jn(e) {
  ...
  t[5] === u
    ? (f = t[6])
    : ((f = (0, Q.jsx)(Y, { children: (0, Q.jsx)(ke, { title: u, subtitle: d }) })),
      (t[5] = u),
      (t[6] = f));
  let p;
  ...
  let v;
  t[16] !== _ || t[17] !== h
    ? ((v = (0, Q.jsx)(Y, { children: (0, Q.jsxs)(Me, { children: [h, _] }) })),
      (t[16] = _),
      (t[17] = h),
      (t[18] = v))
    : (v = t[18]);
...
var Xn = `remote-connections-refresh-success`,
  Zn = `remote-connections-refresh-error`,
  Qn = `remote-connections-save-success`,
  $n = `remote-connections-save-error`,
  er = `remote-connections-connect-toggle-error`,
  tr = `remote-connections-install-codex-error`,
  nr = `remote-connections-logout-error`,
  rr = `remote-control-environment-rename-success`,
  ir = `remote-control-environment-rename-error`,
  ar = `remote-control-environment-delete-success`,
  or = `remote-control-environment-delete-error`,
  sr = `remote-control-authorize-success`,
  cr = `remote-control-authorize-error`,
  lr = `[remote-connections/settings]`,
  ur = 15e3,
  dr = [],
  fr = [],
  pr = [];
function mr() {
  let e = a(s),
    ...
    [h] = j(`remote_ssh_connections`),
    { data: g } = ge(S.HOST_ID_REMOTE_CONTROL_ALLOWED),
    [_] = j(`remote_control_connections`),
    [v] = j(`remote_control_connections_state`),
    ...
    [he, _e] = (0, Z.useState)(null),
    [ye, be] = (0, Z.useState)(null),
    we = Se(),
    Te = !l,
    Ee = h == null,
    De = we && _ == null,
    Y = [...(h ?? dr)].sort(hr),
    Oe = gr(_ ?? fr),
    { data: ke } = ge(S.ADDED_REMOTE_CONTROL_ENV_IDS),
    Ae = pe({ addedRemoteControlEnvIds: ke, remoteControlConnections: Oe }),
    je = g ?? pr,
    Me = me({ addedRemoteControlEnvIds: ke, remoteControlConnections: Oe }),
    Ne = Ae.length > 0,
    Pe = v?.authRequired === !0,
    ...
    Ie = Yn({
      ...
      showRemoteControlConnectionsSection: we,
    }),
    Le = !Ne && Fe && !Pe,
    Re = Y.map((e) => Wt(Ut(e), { connectionAnalyticsId: e.connectionAnalyticsId })),
    ze = new Set(Re.map((e) => e.hostId)),
    Be = x.filter((e) => !ze.has(e.hostId)),
    Ve = we && !0,
    He = Te && (we || !1),
    Ue = Ce({
      selectedConnectionsTab: ce,
      showControlOtherDevices: Te,
      showControlThisMacTab: Ve,
      showRemoteControlConnectionsSection: we,
      showRemoteSshConnections: !0,
      showTabbedSshPage: we && !0,
    }),
    We = () => {
      e.get(J).success(
        r.formatMessage({
    ...
    Ge = (t) => {
      (d.warning(`${lr} refresh_failed`, { safe: {}, sensitive: { error: t } }),
        e
          .get(J)
          .danger(
            t instanceof Error
    ...
    Ye = p(`refresh-remote-connections`),
    Ze = p(`discover-remote-ssh-connections`),
    Qe = p(`refresh-remote-control-connections`),
    et = p(`authorize-remote-control-connections`, {
      onSuccess: () => {
        (W(e, te, { result: `succeeded` }),
          e
            .get(J)
            .success(
              r.formatMessage({
      ...
      onError: (t) => {
        (W(e, te, { result: `failed` }),
          d.warning(`${lr} remote_control_authorize_failed`, { safe: {}, sensitive: { error: t } }),
          e
            .get(J)
            .danger(
              t instanceof c && t.errorCode === `remote_control_enrollment_account_mismatch`
                ? r.formatMessage({
    ...
    tt = p(`save-codex-managed-remote-ssh-connections`, {
      onSuccess: () => {
        e.get(J).success(
          r.formatMessage({
      ...
      onError: (t) => {
        (d.warning(`${lr} save_failed`, { safe: {}, sensitive: { error: t } }),
          e
            .get(J)
            .danger(
              r.formatMessage({
    ...
    nt = u({ mutationFn: (t) => D(e, S.ADDED_REMOTE_CONTROL_ENV_IDS, [...ke, ...t]) }),
    rt = p(`set-remote-connection-auto-connect`, {
      onError: (n, { autoConnect: i, hostId: a }) => {
        let o = Y.find((e) => e.hostId === a);
        (i &&
          o != null &&
          N(t, {
            action: re.CODEX_REMOTE_SSH_CONNECTION_ACTION_CONNECT,
            result: U.CODEX_REMOTE_SSH_CONNECTION_RESULT_FAILED,
            source: L.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
            connection: o,
            errorCategory: ae.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_CONNECTION_FAILED,
          }),
          d.warning(`${lr} connect_toggle_failed`, {
            safe: { autoConnect: i },
    ...
    it = p(`install-remote-codex`, {
      onError: (t, { hostId: n }) => {
        (d.warning(`${lr} install_remote_codex_failed`, {
          safe: {},
    ...
    at = p(`rename-remote-control-environment`, {
      onSuccess: () => {
        e.get(J).success(
          r.formatMessage({
      ...
      onError: (t, { envId: n }) => {
        (d.warning(`${lr} remote_control_rename_failed`, {
          safe: {},
    ...
    ot = p(`delete-remote-control-environment`, {
      onSuccess: () => {
        e.get(J).success(
          r.formatMessage({
      ...
      onError: (t, { envId: n }) => {
        (d.warning(`${lr} remote_control_delete_failed`, {
          safe: {},
          sensitive: { envId: n, error: t },
        }),
          e
    ...
    ct =
      ...
      ot.isPending,
    lt = (t) => {
      n.getForHostId(t) ?? n.addManager(E(e, t, e.get(k, t)));
    },
    ut = async () => {
      try {
        let e = [];
        (N(t, {
          action: re.CODEX_REMOTE_SSH_CONNECTION_ACTION_REFRESH,
          result: U.CODEX_REMOTE_SSH_CONNECTION_RESULT_STARTED,
          source: L.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
        }),
          e.push(
            Ye.mutateAsync(void 0)
              .then(({ remoteConnections: e }) => {
                t.logProductEvent(ee, T(e));
              })
              .catch((e) => {
                throw (
                  N(t, {
    ...
    dt = async () => {
      let { discoveredRemoteConnections: e } = await Ze.mutateAsync(void 0);
      O([...e].sort(hr));
    },
    ft = async () => {
      try {
    ...
    mt = () => {
      if (nt.isPending) return;
      let t = Me.filter((e) => R.includes(e.envId)).map((e) => e.envId);
      if (t.length === 0) {
        G(!1);
        return;
      }
      (W(e, z, { addableConnectionCount: Me.length, existingConnectionCount: Ae.length }),
        nt.mutate(t, {
          onSuccess: () => {
            (B([]), G(!1));
          },
    ...
    $ = () => {
      (W(e, te, { result: `started` }), et.mutate(void 0));
    },
    yt = async () => {
      let { remoteControlConnections: e } = await Qe.mutateAsync(void 0);
      t.logProductEvent(ne, tn(e));
    },
    bt = (0, Z.useEffectEvent)(async (e) => {
      if (!ct)
        try {
          let t = [];
          (t.push(f(`refresh-remote-connections`, { signal: e })),
            we && t.push(f(`refresh-remote-control-connections`, { signal: e })),
            await Promise.all(t));
        } catch (e) {
          if (e instanceof DOMException && e.name === `AbortError`) return;
          d.debug(`${lr} auto_refresh_failed`, { safe: {}, sensitive: { error: e } });
        }
    });
  (0, Z.useEffect)(() => {
    let e = null,
  ...
  let xt = async () => {
      if (ye != null)
        try {
          (await ot.mutateAsync({ envId: ye.envId }), be(null));
        } catch {}
    },
    St = (t, r, i) => {
      (lt(t),
    ...
    wt = (e) => {
      if (y == null || st) return;
      let n = y.mode === `edit` ? (Y.find((e) => e.hostId === y.hostId) ?? null) : null,
        r = y.mode === `add` ? !0 : (n?.autoConnect ?? !1),
        i = Wt(e, { connectionAnalyticsId: n?.connectionAnalyticsId }),
        a =
          y.mode === `add`
            ? [...Re, i]
            : Re.filter((e) => e.hostId !== y.hostId)
                .concat(i)
                .sort(hr);
      tt.mutate(
        { remoteConnections: a },
        {
          onSuccess: ({ remoteConnections: e }) => {
            ...
            N(t, {
              action: re.CODEX_REMOTE_SSH_CONNECTION_ACTION_SAVE_CONNECTION,
              result: U.CODEX_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED,
              source: L.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
              connection: n,
            });
            let a = y.mode === `add` && y.returnToDiscoveryDialog;
            (b(null), a && H(!0), r && Ot(i.hostId, !0));
          },
          onError: () => {
            N(t, {
              action: re.CODEX_REMOTE_SSH_CONNECTION_ACTION_SAVE_CONNECTION,
    ...
    Tt = (e) => {
      st || tt.mutate({ remoteConnections: Re.filter((t) => t.hostId !== e) });
    },
    Et = (e) => {
    ...
    Dt = () => {
      if (st) return;
      let e = Be.filter((e) => M.includes(e.hostId));
      if (e.length === 0) {
        H(!1);
        return;
      }
      let t = e.map((e) => Wt({ ...Ut(e), displayName: e.sshAlias?.trim() || e.displayName }));
      tt.mutate(
        { remoteConnections: [...Re, ...t].sort(hr) },
        {
          onSuccess: () => {
            (t.forEach((e) => {
              Ot(e.hostId, !0);
        ...
        rt.mutate(
          { hostId: e, autoConnect: n },
          {
            onSuccess: ({ remoteConnections: r, state: i, error: a }) => {
              St(e, i, a);
              let o = r.find((t) => t.hostId === e && C(t));
              if (n && o != null) {
                let e = i === `connected` && a == null;
                N(t, {
                  action: re.CODEX_REMOTE_SSH_CONNECTION_ACTION_CONNECT,
                  result: e
                    ? U.CODEX_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED
                    : U.CODEX_REMOTE_SSH_CONNECTION_RESULT_FAILED,
                  source: L.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
                  connection: o,
                  connectionState: i,
                  ...(e
    ...
    kt = async (t) => {
      je.includes(t) || (await D(e, S.HOST_ID_REMOTE_CONTROL_ALLOWED, [...je, t]));
    },
    jt = () => {
      ft();
    },
    Mt = async (t) => {
      try {
        (await w(`logout`, { hostId: t }), St(t, `error`, { code: `login-required` }));
      } catch (n) {
        (d.warning(`${lr} logout_failed`, { safe: {}, sensitive: { error: n, hostId: t } }),
          e
            .get(J)
            .danger(
              r.formatMessage({
  ...
  return (0, Q.jsxs)(Q.Fragment, {
    children: [
      (0, Q.jsxs)(Je, {
        title: (0, Q.jsx)(qe, { slug: `connections` }),
        subtitle: null,
        children: [
          It.length >= 2
            ? (0, Q.jsx)(ht, {
            ...
            : null,
          Ue === `control-this-mac`
            ? (0, Q.jsx)(xe, { electron: !0, children: (0, Q.jsx)(At, {}) })
            : null,
          Te && Ue === `access-other-devices` && Ie
            ? (0, Q.jsxs)(X, {
                children: [
                  (0, Q.jsx)(X.Header, {
                    title:
                            ...
                            children: [
                              Le
                                ...
                                : (0, Q.jsx)(On, {
                                    ...
                                    showEmptyState: !1,
                                    remoteControlAllowedHostIds: je,
                                    onEditSshConnection: () => {},
                                    onInstallCodex: () => {},
                                    ...
                                    onRequestDeleteRemoteControlConnection: be,
                          ...
                          : (0, Q.jsx)(Q.Fragment, {
                              children: (0, Q.jsx)(On, {
                                ...
                                onEditSshConnection: (e) => {
                                  let t = Y.find((t) => t.hostId === e);
                                  t != null && b({ mode: `edit`, hostId: e, draft: Ut(t) });
                                },
                                onInstallCodex: Ct,
      ...
      y == null
        ...
        : (0, Q.jsx)(Jt, {
            ...
            mode: y.mode,
            draft: y.draft,
            existingConnections: Y,
            editingHostId: y.mode === `edit` ? y.hostId : null,
            onOpenChange: (e) => {
              if (!e) {
                let e = y.mode === `add` && y.returnToDiscoveryDialog;
                (b(null), e && H(!0));
              }
            },
            onSubmit: wt,
            isSaving: tt.isPending,
          }),
      V
        ? (0, Q.jsx)(zt, {
            connections: Be,
            ...
            onAddManually: () => {
              (H(!1), b({ mode: `add`, draft: Ht(), returnToDiscoveryDialog: !0 }));
            },
            onOpenChange: H,
            onRefresh: () => {
              dt().catch(Ge);
      ...
      Te && ie
        ...
        : null,
      Te && se
        ? (0, Q.jsx)(Vn, { authorizing: et.isPending, open: !0, onAuthorize: $, onOpenChange: q })
        : null,
      (0, Q.jsx)(Lt, {
        hostId: he,
        open: he != null,
...
export { mr as RemoteConnectionsSettings };
