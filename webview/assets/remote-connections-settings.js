...
import { _ as v, c as y, f as b, g as x, m as S, n as C, s as w } from "./vscode-api.js";
import "./isEqual.js";
import {
  $r as T,
  Bt as E,
...
import "./react-dom.js";
import { c as F, o as I, r as L } from "./lib.js";
import {
  $n as R,
  Bn as z,
  Gn as B,
...
import { a as ce, i as q } from "./setting-storage.js";
...
import { o as fe } from "./app-server-manager-hooks.js";
import "./invalidate-queries-and-broadcast.js";
import "./thread-context-inputs.js";
import "./config-queries.js";
import { i as pe, r as me } from "./selectable-remote-connections-signal.js";
import { r as he } from "./remote-connection-visibility.js";
...
import "./chevron.js";
import "./core.esm.js";
import { m as _e } from "./chunk-109.js";
...
import "./apps.js";
import "./chats.js";
import { t as ve } from "./info.js";
import { t as ye } from "./x.js";
import "./projectless-thread.js";
import "./plugin-install-store.js";
import { t as be } from "./use-platform.js";
...
import { r as yt, t as bt } from "./onboarding-login-content.js";
import { t as xt } from "./tabs.js";
import { t as St } from "./useForm.js";
var Z = e(t()),
  Q = n(),
  Ct = (e) =>
    (0, Q.jsxs)(`svg`, {
...
function Et(e) {
  ...
  return (
    t[0] === n
      ? (r = t[1])
      : ((r = (0, Q.jsx)(vt, { onClose: n, variant: `dialog` })), (t[0] = n), (t[1] = r)),
    r
  );
}
var Dt = (e) =>
...
function Ot(e) {
  switch (e.deviceType) {
    case `phone`:
      return (0, Q.jsx)(Dt, { className: `icon-sm` });
    case `laptop`:
      return (0, Q.jsx)(He, { className: `icon-sm` });
    case `desktop`:
...
function kt(e) {
  switch (e.clientType) {
    case `CODEX_CLI`:
      return (0, Q.jsx)(xe, { className: `icon-sm` });
    case `CODEX_DESKTOP_APP`:
      return (0, Q.jsx)(Ge, { className: `icon-sm` });
    case `CODEX_IDE_VSCODE`:
    case `CODEX_IDE_XCODE`:
    case `CODEX_IDE_JETBRAINS`:
      return (0, Q.jsx)(Ce, { className: `icon-sm` });
    case `CODEX_UNKNOWN`:
      return (0, Q.jsx)(Ge, { className: `icon-sm` });
  }
}
var At = `remote-control-client-revoke-success`,
  jt = `remote-control-client-revoke-error`,
  Mt = `[remote-connections/settings]`;
function Nt(e) {
  let t = (0, $.c)(23),
  ...
  t[5] !== d || t[6] !== c || t[7] !== u
    ? ((p = (e, t) => {
        let { clientId: n } = t;
        (c?.(`failed`),
          S.warning(`${Mt} remote_control_client_revoke_failed`, {
            safe: {},
  ...
  let m;
  t[9] !== f || t[10] !== p
    ? ((m = { mutationFn: ht, onSuccess: f, onError: p }), (t[9] = f), (t[10] = p), (t[11] = m))
    : (m = t[11]);
  let h = x(m),
  ...
  return (
    t[19] !== r || t[20] !== _ || t[21] !== v
      ? ((y = (0, Q.jsxs)(tt, { className: _, children: [r, v] })),
        (t[19] = r),
        (t[20] = _),
        (t[21] = v),
        (t[22] = y))
...
function Pt(e) {
  return e.lastSeenAt == null
    ...
    : (0, Q.jsx)(I, {
        ...
        values: { date: (0, Q.jsx)(Ve, { dateString: e.lastSeenAt }, `last-seen-at`) },
      });
}
function Ft(e) {
  let t = (0, $.c)(3),
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = { mutationFn: (e) => mt(r, n, e) }), (t[0] = n), (t[1] = r), (t[2] = i))
      : (i = t[2]),
    x(i)
  );
}
function It() {
  let e = (0, $.c)(4),
    t = de(it),
    { data: n, isLoading: r } = ge(N.CODEX_MOBILE_SETUP_COMPLETED);
  if (r) return null;
  if (!n) {
    let n;
    return (
      e[0] === t
        ? (n = e[1])
        : ((n = (0, Q.jsx)(zt, { mode: `setup`, oneToOnePairingInAppEnabled: t })),
          (e[0] = t),
          (e[1] = n)),
      n
    );
  ...
  return (
    e[2] === t
      ...
      : ((i = (0, Q.jsxs)(Q.Fragment, {
          children: [
            (0, Q.jsx)(zt, { mode: `manage`, oneToOnePairingInAppEnabled: t }),
            (0, Q.jsx)(Lt, { oneToOnePairingInAppEnabled: t }),
          ],
        })),
        (e[2] = t),
        (e[3] = i)),
...
function Lt(e) {
  let t = (0, $.c)(22),
    ...
    i = F(),
    { platform: o } = be(),
    c = ce(D.keepRemoteControlAwakeWhilePluggedIn),
    l;
  ...
  t[1] === n
    ? (u = t[2])
    : ((u = n ? null : (0, Q.jsx)(Rt, { oneToOnePairingInAppEnabled: !1 })),
      (t[1] = n),
      (t[2] = u));
  let d;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)($e, { className: `icon-sm` })), (t[3] = d))
    : (d = t[3]);
  let f;
  t[4] === o
    ? (f = t[5])
    : ((f =
        o === `windows`
          ? (0, Q.jsx)(I, { ...Ut.keepLiveWindowsLabel })
          : (0, Q.jsx)(I, { ...Ut.keepLiveMacLabel })),
      (t[4] = o),
      (t[5] = f));
  let p;
  ...
  t[7] === r
    ? (h = t[8])
    : ((h = (e) => {
        q(r, D.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (t[7] = r),
      (t[8] = h));
  let g;
  t[9] !== i || t[10] !== o
    ? ((g =
        o === `windows`
          ? i.formatMessage(Ut.keepLiveWindowsLabel)
          : i.formatMessage(Ut.keepLiveMacLabel)),
      (t[9] = i),
      (t[10] = o),
      (t[11] = g))
    : (g = t[11]);
  ...
  t[12] !== m || t[13] !== h || t[14] !== g
    ? ((_ = (0, Q.jsx)(qe, { checked: m, onChange: h, ariaLabel: g })),
      (t[12] = m),
      (t[13] = h),
      (t[14] = g),
      (t[15] = _))
  ...
  let v;
  t[16] !== f || t[17] !== _
    ? ((v = (0, Q.jsx)(et, { icon: d, label: f, description: p, control: _ })),
      (t[16] = f),
      (t[17] = _),
      (t[18] = v))
    : (v = t[18]);
  ...
  return (
    t[19] !== v || t[20] !== u
      ? ((y = (0, Q.jsxs)(nt, {
          children: [
            l,
            (0, Q.jsx)(nt.Content, { children: (0, Q.jsxs)(tt, { children: [u, v] }) }),
          ],
        })),
        (t[19] = v),
        (t[20] = u),
...
function Rt(e) {
  let t = (0, $.c)(23),
    ...
    l = i(c, d),
    u;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((u = { hostId: d }), (t[0] = u)) : (u = t[0]);
  let f = Ft(u),
    p;
  t[1] !== o || t[2] !== r || t[3] !== f
    ? ((p = (e) => {
  ...
  t[5] === n
    ? (h = t[6])
    : ((h = n ? void 0 : (0, Q.jsx)(ot, { className: `icon-sm` })), (t[5] = n), (t[6] = h));
  let g, _;
  t[7] === n
    ? ((g = t[8]), (_ = t[9]))
    : ((g = n
        ? (0, Q.jsx)(I, { ...Ut.allowConnectionsLabel })
        : (0, Q.jsx)(I, {
  ...
  t[10] !== o || t[11] !== n
    ? ((v = n
        ? o.formatMessage(Ut.allowConnectionsLabel)
        : o.formatMessage({
            id: `settings.remoteConnections.localHost.remoteControl.label`,
            defaultMessage: `Allow this device to be discovered and controlled`,
            description: `Label for allowing remote control on this device`,
    ...
    : (v = t[12]);
  let y;
  t[13] !== m || t[14] !== l || t[15] !== f.isPending || t[16] !== v
    ? ((y = (0, Q.jsx)(qe, { checked: l, disabled: f.isPending, onChange: m, ariaLabel: v })),
      (t[13] = m),
      (t[14] = l),
      (t[15] = f.isPending),
      (t[16] = v),
  ...
  return (
    t[18] !== h || t[19] !== g || t[20] !== _ || t[21] !== y
      ? ((b = (0, Q.jsx)(et, { icon: h, label: g, description: _, control: y })),
        (t[18] = h),
        (t[19] = g),
        (t[20] = _),
        (t[21] = y),
...
function zt(e) {
  let t = (0, $.c)(84),
    ...
    [_] = m(`local_remote_control_client_id`),
    y = i(c, d),
    b;
  t[0] === l ? (b = t[1]) : ((b = ut(l)), (t[0] = l), (t[1] = b));
  let { data: S, isFetching: C } = v(b),
    w = o(gt),
    T = h?.existingClientIds ?? null,
    E = h?.step === `waiting`,
    D;
  t[2] !== _ || t[3] !== T || t[4] !== E
    ? ((D = { existingClientIds: T, hostId: null, localRemoteControlClientId: _, waiting: E }),
      (t[2] = _),
      (t[3] = T),
      (t[4] = E),
      (t[5] = D))
    : (D = t[5]);
  let O = i(_t, D),
    k = h?.step === `waiting` ? O.data : null,
    A = k === `connected` ? `connected` : k === `dismiss` ? null : (h?.step ?? null),
    j;
  t[6] === l.query ? (j = t[7]) : ((j = l.query.snapshot(gt)), (t[6] = l.query), (t[7] = j));
  let M = j,
    N;
  t[8] !== _ || t[9] !== w.data
    ? ((N = pt(w.data, _)), (t[8] = _), (t[9] = w.data), (t[10] = N))
    : (N = t[10]);
  let P = N,
    L = w.isError && C,
    R = !S && (w.isLoading || L),
    z = w.isError && !S && !L,
    B = S ? 0 : P?.length,
    te = w.error instanceof st,
    ne;
  t[11] !== f || t[12] !== u || t[13] !== l
    ? ((ne = (e) => {
        if ((g(null), e instanceof st)) {
          u(`/login`, { replace: !0 });
          return;
        }
        l.get(Y).danger(
  ...
  t[15] === M
    ? (ae = t[16])
    : ((ae = async (e) => (await M.invalidate({ exact: !0, refetchType: `none` }), M.fetch())),
      (t[15] = M),
      (t[16] = ae));
  let V;
  t[17] === _
    ...
    : ((V = (e, t) => {
      ...
      (t[18] = V));
  let oe;
  t[19] !== re || t[20] !== ae || t[21] !== V
    ? ((oe = { mutationFn: ae, onSuccess: V, onError: re }),
      (t[19] = re),
      (t[20] = ae),
      (t[21] = V),
      (t[22] = oe))
  ...
  let H = x(oe),
    U;
  t[23] === l ? (U = t[24]) : ((U = () => at(l)), (t[23] = l), (t[24] = U));
  let G;
  t[25] === H
    ? (G = t[26])
    : ((G = (e) => {
        if (e) {
          g({ existingClientIds: null, step: `mfa-required` });
          return;
        }
        H.mutate(`preflight`);
      }),
      ...
      (t[26] = G));
  let ce;
  t[27] !== re || t[28] !== U || t[29] !== G
    ? ((ce = { mutationFn: U, onSuccess: G, onError: re }),
      (t[27] = re),
      (t[28] = U),
      (t[29] = G),
      (t[30] = ce))
  ...
  let q = x(ce),
    ue,
    J;
  (t[31] !== n || t[32] !== B || t[33] !== w.isLoading || t[34] !== l
    ? ((ue = () => {
        n !== `manage` || w.isLoading || B == null || W(l, ie, { clientCount: B });
      }),
      (J = [n, B, w.isLoading, l]),
      (t[31] = n),
      (t[32] = B),
    ...
    (0, Z.useEffect)(ue, J));
  let de;
  t[37] !== q || t[38] !== S || t[39] !== n || t[40] !== B || t[41] !== l
    ? ((de = () => {
        if ((W(l, se, { existingClientCount: B ?? 0, source: n }), n === `setup`)) {
          De(l, Et);
          return;
        }
        if (S) {
  ...
  t[53] !== H
    ? ((ye =
        n === `manage` && !ge && he
          ? (0, Q.jsx)(K, {
              color: `secondary`,
              disabled: w.isLoading || q.isPending || H.isPending,
              loading: q.isPending || H.isPending,
              onClick: fe,
              children: (0, Q.jsx)(I, {
  ...
  let xe;
  t[55] !== ve || t[56] !== ye
    ? ((xe = (0, Q.jsx)(nt.Header, { title: ve, actions: ye })),
      (t[55] = ve),
      (t[56] = ye),
      (t[57] = xe))
    : (xe = t[57]);
  ...
  t[72] !== ge ||
  t[73] !== H
    ? ((Se = (0, Q.jsx)(nt.Content, {
        children: ge
          ? (0, Q.jsx)(tt, { children: (0, Q.jsx)(Rt, { oneToOnePairingInAppEnabled: !0 }) })
          : n === `manage` && !S && !z && P != null && P.length > 0
            ? (0, Q.jsx)(Nt, {
                clients: P,
                leadingRow: r ? (0, Q.jsx)(Rt, { oneToOnePairingInAppEnabled: !0 }) : void 0,
                onRevoked: (e) => {
            ...
            : (0, Q.jsxs)(tt, {
                children: [
                  n === `manage` && r ? (0, Q.jsx)(Rt, { oneToOnePairingInAppEnabled: !0 }) : null,
                  n === `setup`
                    ? (0, Q.jsx)(Qe, {
                        spacing: `compact`,
                        title: null,
    ...
    : (Se = t[74]);
  let Ce;
  t[75] !== h?.step || t[76] !== me || t[77] !== H || t[78] !== A
    ? ((Ce =
        A == null
          ? null
          : (0, Q.jsxs)(Q.Fragment, {
  ...
  let we;
  return (
    t[80] !== xe || t[81] !== Se || t[82] !== Ce
      ? ((we = (0, Q.jsxs)(nt, { children: [xe, Se, Ce] })),
        (t[80] = xe),
        (t[81] = Se),
        (t[82] = Ce),
        (t[83] = we))
...
var Ut = L({
  ...
  Wt = `[remote-connections/auth]`;
function Gt({ hostId: e, open: t, onOpenChange: n }) {
  let r = a(s),
    i = F(),
    ...
    x = async () => {
      ...
      c(t);
      try {
        let { authUrl: n, completion: r } = await yt({ hostId: e, signal: t.signal });
        b.dispatchMessage(`open-in-browser`, { url: n });
        let i = await r;
        if (!i.success) {
          (S.warning(`${Wt} chatgpt_sign_in_failed`, {
            safe: {},
    ...
    C = async () => {
      ...
      if (!(!t || m)) {
        h(!0);
        try {
          (await f(`login-with-api-key-for-host`, { hostId: e, apiKey: t }),
            v({ abortPendingLogin: !1 }));
        } catch (t) {
          (S.warning(`${Wt} api_key_sign_in_failed`, {
            safe: {},
            sensitive: { error: t, hostId: e },
          }),
            y(t));
        ...
        (0, Q.jsx)(X, {
          children: (0, Q.jsx)(`div`, {
            ...
            children: (0, Q.jsx)(bt, {
              ...
              apiKeySecondaryActionLabel: (0, Q.jsx)(I, {
...
function Kt(e) {
  ...
  t[0] === o
    ? (l = t[1])
    : ((l = (0, Q.jsx)(X, { children: (0, Q.jsx)(ke, { title: o }) })), (t[0] = o), (t[1] = l));
  ...
  t[5] !== u || t[6] !== d
    ? ((f = (0, Q.jsx)(X, {
        ...
        children: (0, Q.jsx)(`div`, {
          className: `h-[300px]`,
          children: (0, Q.jsx)(tt, { className: u, children: d }),
        }),
      })),
      (t[5] = u),
      (t[6] = d),
  ...
  t[10] !== c || t[11] !== l || t[12] !== f || t[13] !== p
    ? ((m = (0, Q.jsxs)(je, { as: `form`, onSubmit: c, children: [l, f, p] })),
      (t[10] = c),
      (t[11] = l),
      (t[12] = f),
      (t[13] = p),
  ...
  return (
    t[15] !== s || t[16] !== a || t[17] !== m
      ? ((h = (0, Q.jsx)(Ae, { open: a, onOpenChange: s, children: m })),
        (t[15] = s),
        (t[16] = a),
        (t[17] = m),
        (t[18] = h))
...
function qt(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, Q.jsx)(Je, { className: `icon-sm` })), (t[5] = v))
    : (v = t[5]);
  let y;
  ...
  t[15] === S
    ? (w = t[16])
    : ((w = (0, Q.jsx)(K, { type: `submit`, size: `large`, disabled: S, children: C })),
      (t[15] = S),
      (t[16] = w));
  let T;
          ...
          : n.map((e) => {
              ...
              return (0, Q.jsx)(
                `div`,
                {
                  ...
                  tabIndex: r ? -1 : 0,
                  children: (0, Q.jsx)(et, {
                    icon: (0, Q.jsx)(Ge, { className: `icon-sm` }),
                    label: t,
...
function Qt(e, { connectionAnalyticsId: t } = {}) {
...
function $t({ draft: e, editingHostId: t, existingConnections: n }) {
  let r = [],
...
function nn(e) {
  ...
  t[0] !== o || t[1] !== a
    ? ((f = (e) => {
        let t = $t({ draft: e, existingConnections: a, editingHostId: o });
  ...
  t[19] !== _.Subscribe || t[20] !== S
    ? ((C = (0, Q.jsx)(_.Subscribe, { selector: S, children: an })),
      (t[19] = _.Subscribe),
      (t[20] = S),
      (t[21] = C))
    : (C = t[21]);
  ...
  t[50] === l
    ? (P = t[51])
    : ((P = (0, Q.jsx)(K, { color: `primary`, type: `submit`, loading: l, children: N })),
      (t[50] = l),
      (t[51] = P));
  let L;
  t[52] !== M || t[53] !== P
    ? ((L = (0, Q.jsx)(X, { className: `pt-4`, children: (0, Q.jsxs)(Me, { children: [M, P] }) })),
      (t[52] = M),
      (t[53] = P),
      (t[54] = L))
    : (L = t[54]);
  let R;
  t[55] !== C || t[56] !== k || t[57] !== L || t[58] !== b || t[59] !== x
    ? ((R = (0, Q.jsxs)(je, { as: `form`, onSubmit: b, children: [x, C, k, L] })),
      (t[55] = C),
      (t[56] = k),
      (t[57] = L),
      (t[58] = b),
...
function on(e) {
  return (0, Q.jsx)(`div`, { children: ln(e) }, e);
}
function sn(e) {
  let t = (0, $.c)(16),
...
function un(e) {
  return {
    refreshSource: te.CODEX_REMOTE_CONTROL_REFRESH_SOURCE_SETTINGS,
    ...
    unsupportedAppServerVersionConnectionCount: e.filter((e) => !P(e.appServerVersion)).length,
  };
}
var dn = (e) =>
    (0, Q.jsxs)(`svg`, {
...
var mn = `text-sm electron:!text-sm`,
  hn = `!size-5 !rounded-full !p-0 electron:!rounded-full electron:!p-0`;
function gn(e) {
  let t = (0, $.c)(27),
    {
      actionsLabel: n,
  ...
  t[0] === n
    ? (h = t[1])
    : ((h = (0, Q.jsx)(Ze, { label: n, size: `icon`, iconClassName: `icon-sm`, className: hn })),
      (t[0] = n),
      (t[1] = h));
  let g;
  t[2] !== m || t[3] !== s || t[4] !== u
    ? ((g = (0, Q.jsx)(Le.Item, { LeftIcon: m, className: mn, onSelect: u, children: s })),
      (t[2] = m),
      (t[3] = s),
      (t[4] = u),
      (t[5] = g))
  ...
  t[8] !== f || t[9] !== p
    ? ((v =
        p != null && f != null
          ? (0, Q.jsx)(Le.Item, { LeftIcon: Je, className: mn, onSelect: f, children: p })
          : null),
      (t[8] = f),
      (t[9] = p),
      (t[10] = v))
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Q.jsx)(Le.Separator, {})), (t[13] = b))
    : (b = t[13]);
  let x;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = G(mn, `text-token-charts-red`)), (t[14] = x))
    : (x = t[14]);
  let S = r ? a : null,
    C;
...
function _n(e) {
  let t = (0, $.c)(22),
    ...
    l;
  t[0] !== a || t[1] !== s
    ? ((l = s ?? (0, Q.jsx)(pn, { value: a })), (t[0] = a), (t[1] = s), (t[2] = l))
    : (l = t[2]);
  let u = l,
    d = o ?? c,
    f;
  ...
  t[14] !== n || t[15] !== r || t[16] !== d || t[17] !== h
    ? ((g = (0, Q.jsx)(et, { className: n, icon: d, label: h, control: r })),
      (t[14] = n),
      (t[15] = r),
      (t[16] = d),
      (t[17] = h),
...
function vn(e, t) {
  return !e.online || !P(e.appServerVersion)
...
function bn(e) {
  ...
  let ie = re,
    ae;
  t[25] !== ie || t[26] !== n || t[27] !== o || t[28] !== d || t[29] !== C
    ? ((ae = async () => {
        if (!(C.length === 0 || o)) {
          if (C === n.displayName) {
            ie();
  ...
  let V = ae,
    oe = n.displayName,
    H;
  t[31] === n ? (H = t[32]) : ((H = kt(n)), (t[31] = n), (t[32] = H));
  let U;
  t[33] === n.appServerVersion
    ? (U = t[34])
    : ((U = { currentVersion: n.appServerVersion, requiredVersion: O }),
      (t[33] = n.appServerVersion),
      (t[34] = U));
  let W;
  t[35] !== x || t[36] !== U
    ? ((W = (0, Q.jsx)(I, { ...x, values: U })), (t[35] = x), (t[36] = U), (t[37] = W))
    : (W = t[37]);
  let se;
  t[38] !== ie ||
  t[39] !== i ||
    ...
    ? ((se = a
        ? (0, Q.jsx)(`input`, {
            ...
            onKeyDown: (e) => {
              e.key === `Enter`
                ? (e.preventDefault(), V())
                : e.key === `Escape` && (e.preventDefault(), ie());
            },
            autoFocus: !0,
          })
        : void 0),
  ...
  let G;
  t[46] !== n || t[47] !== v
    ? ((G = (0, Q.jsx)(xn, { connection: n, state: v })), (t[46] = n), (t[47] = v), (t[48] = G))
    : (G = t[48]);
  let ce;
  t[49] !== y ||
  t[50] !== ie ||
...
function xn(e) {
  let t = (0, $.c)(13),
    ...
    a;
  t[0] !== n || t[1] !== i || t[2] !== r
    ? ((a = yn(i, n, r)), (t[0] = n), (t[1] = i), (t[2] = r), (t[3] = a))
    : (a = t[3]);
  let o = a,
    s;
  t[4] !== n || t[5] !== r ? ((s = vn(n, r)), (t[4] = n), (t[5] = r), (t[6] = s)) : (s = t[6]);
  let c;
  t[7] !== o || t[8] !== s
...
function Sn(e, t, n, r) {
  return !e && !t
    ? Cn.signedInDeviceAuthorizationRequiredOfflineSubtitle
    : e
      ? t
        ? n
          ? r === `connecting` || r === `restarting`
            ? Cn.signedInDeviceConnectingSubtitle
            : r === `error`
              ? Cn.signedInDeviceConnectionFailedSubtitle
              : r === `connected`
                ? Cn.signedInDeviceOnlineSubtitle
                : Cn.signedInDeviceDisconnectedSubtitle
          : Cn.signedInDeviceUpdateRequiredSubtitle
        : Cn.signedInDeviceOfflineSubtitle
      : Cn.signedInDeviceAuthorizationRequiredSubtitle;
}
var Cn = L({
  ...
  wn = `` + new URL(`dialog-artwork-ssh-remote-control-allow-Cx1m-RXh.png`, import.meta.url).href;
function Tn(e) {
  let t = (0, $.c)(19),
  ...
  t[4] === c
    ...
    : ((l = (0, Q.jsx)(`div`, {
        ...
        children: (0, Q.jsx)(`img`, { alt: c, className: `h-full w-full object-cover`, src: wn }),
      })),
      (t[4] = c),
      (t[5] = l));
  let u;
...
function En(e) {
          ...
          a == null
            ...
            : (0, Q.jsx)(J, {
                ...
                children: (0, Q.jsx)(`span`, {
                  ...
                  children: (0, Q.jsx)(ve, { "aria-hidden": !0, className: `icon-xs shrink-0` }),
                }),
              })),
        (t[3] = s),
        (t[4] = a),
  ...
  t[16] === l
    ...
    : ((u = (0, Q.jsx)(`span`, { className: `min-w-0 break-words`, children: l })),
      ...
      (t[17] = u));
  let d;
  t[18] === n ? (d = t[19]) : ((d = (0, Q.jsx)(On, { action: n })), (t[18] = n), (t[19] = d));
  let f;
  return (
    t[20] !== u || t[21] !== d
...
function On(e) {
  ...
  t[4] !== n.renderInElectronOnly || t[5] !== o
    ? ((s = n.renderInElectronOnly === !0 ? (0, Q.jsx)(Se, { electron: !0, children: o }) : o),
...
function kn(e) {
  let t = (0, $.c)(101),
    ...
    m = F(),
    { appServerVersion: h, error: g, installedCodexVersion: _, state: v } = Be(n.hostId),
    y = n.displayName,
    b = he(),
    x;
  t[0] === m
  ...
  if (
    ...
    P = jn({ appServerVersion: h, installedCodexVersion: _, state: v });
    let e;
    ...
    let {
      ...
      statusState: u,
    } = An({ error: g, restartAvailableNotice: P, state: v });
    ((L = c),
      (j = l),
      (R =
        u == null
          ? null
          : Ue(m, { canLogin: !0, error: L, state: u, surface: `connections-row` })));
    let d = !k && (L?.code === `remote-codex-not-found` || L?.code === `update-required`);
    ((z =
      R == null || d
        ? null
        : Mn({
  ...
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, Q.jsx)(xe, { className: `icon-sm` })),
      (te = (0, Q.jsx)(I, {
      ...
      (t[35] = te))
    : ((ee = t[34]), (te = t[35]));
  let ne = R?.message ?? null,
    re;
  t[36] !== j || t[37] !== P || t[38] !== B || t[39] !== L || t[40] !== ne
    ? ((re = (0, Q.jsxs)(Q.Fragment, {
        children: [
          te,
          (0, Q.jsx)(En, {
            action: B,
  ...
  t[42] !== n || t[43] !== g || t[44] !== v
    ? ((ie = (0, Q.jsx)(Pn, { connection: n, error: g, state: v })),
      (t[42] = n),
      (t[43] = g),
      (t[44] = v),
      (t[45] = ie))
  ...
  t[55] !== n.hostId || t[56] !== c || t[57] !== v
    ? ((U = v === `connected` ? () => c(n.hostId) : void 0),
      (t[55] = n.hostId),
      (t[56] = c),
      (t[57] = v),
      (t[58] = U))
        ...
        (b || a) && v === `connected`
          ? (0, Q.jsx)(J, {
              ...
              children: (0, Q.jsx)(K, {
                ...
                children: (0, Q.jsx)(dn, { className: `icon-sm` }),
              }),
            })
          : null),
      (t[72] = n.hostId),
  ...
  t[82] !== n.hostId || t[83] !== p
    ? ((q = (e) => p(n.hostId, e)), (t[82] = n.hostId), (t[83] = p), (t[84] = q))
    : (q = t[84]);
  let le;
  t[85] !== n.displayName || t[86] !== m
    ...
    : (le = t[87]);
  let ue;
  t[88] !== n.autoConnect || t[89] !== q || t[90] !== le
    ? ((ue = (0, Q.jsx)(qe, { checked: ce, onChange: q, ariaLabel: le })),
      (t[88] = n.autoConnect),
      (t[89] = q),
      (t[90] = le),
      (t[91] = ue))
    : (ue = t[91]);
  let fe;
  t[92] !== se || t[93] !== G || t[94] !== ue
    ? ((fe = (0, Q.jsxs)(`div`, { className: `flex items-center gap-1.5`, children: [se, G, ue] })),
      (t[92] = se),
      (t[93] = G),
      (t[94] = ue),
      (t[95] = fe))
  ...
  let pe;
  return (
    t[96] !== y || t[97] !== ie || t[98] !== fe || t[99] !== re
      ? ((pe = (0, Q.jsx)(_n, {
          displayName: y,
          icon: ee,
          description: re,
...
function An({ error: e, restartAvailableNotice: t, state: n }) {
  return n === `error`
    ? {
        statusError: e ?? (t == null ? null : T(t)),
        isRestartAvailableNotice: !1,
        statusState: `error`,
      }
    : t == null
      ? { statusError: null, isRestartAvailableNotice: !1, statusState: n }
      : { statusError: T(t), isRestartAvailableNotice: e == null, statusState: `error` };
}
function jn({ appServerVersion: e, installedCodexVersion: t, state: n }) {
  return n == null ||
    e == null ||
    t == null ||
  ...
  switch (e.kind) {
    ...
    case `restart`:
      return e.tooltipText == null
        ? { label: e.label, onClick: () => Nn(n) }
        : { label: e.label, tooltipText: e.tooltipText, onClick: () => Nn(n) };
    case `settings`:
      return null;
  }
}
function Nn(e) {
  b.dispatchMessage(`codex-app-server-restart`, { hostId: e, killCodexProcess: !0 });
}
function Pn(e) {
  let t = (0, $.c)(18),
  ...
  if (i === `error`) {
    let e;
    t[0] !== r || t[1] !== a || t[2] !== i
      ? ((e = Ue(a, { canLogin: !1, error: r, state: i, surface: `connections-row` })),
        (t[0] = r),
        (t[1] = a),
        (t[2] = i),
        (t[3] = e))
  ...
  if (i != null) {
    ...
    return (
      t[9] === n.hostId
        ? (e = t[10])
        : ((e = (0, Q.jsx)(We, { hostId: n.hostId })), (t[9] = n.hostId), (t[10] = e)),
      e
    );
  }
  let o;
...
function In({
  ...
  showEmptyState: o,
  emptyState: l,
  remoteControlAllowedHostIds: u,
  onEditSshConnection: d,
  onInstallCodex: f,
    ...
    children: [
      ...
      D == null
        ...
        : (0, Q.jsx)(Wn, {
            ...
            onRemoteControlAllowedForSshConnection: v,
            onAllowed: (e) => {
              (O(null), D.startPairingAfterAllow ? R(e) : E(e));
            },
            onOpenChange: (e) => {
              e || O(null);
            },
                ...
                n.source === `remote-control`
                  ...
                  : (0, Q.jsx)(J, {
                      ...
                      children: (0, Q.jsx)(K, {
                        ...
                        children: (0, Q.jsx)(Te, { "aria-hidden": !0, className: `icon-sm` }),
                      }),
                    }),
                (0, Q.jsx)(Rn, {
                  connection: n,
...
function Rn(e) {
  let t = (0, $.c)(43),
    ...
    { appServerVersion: u, error: d, state: f } = Be(n.hostId),
    p = he(),
  ...
  t[3] === b
    ? (x = t[4])
    : ((x = G(`break-words text-lg leading-snug`, b)), (t[3] = b), (t[4] = x));
  let S;
  t[5] !== n || t[6] !== d || t[7] !== m || t[8] !== f
    ? ((S = m
        ? (0, Q.jsxs)(zn, {
            children: [
              (0, Q.jsx)(xn, { connection: n, state: f }),
              (0, Q.jsx)(I, {
        ...
        : (0, Q.jsx)(Bn, { connection: n, error: d, state: f })),
      (t[5] = n),
      (t[6] = d),
      (t[7] = m),
      (t[8] = f),
  ...
  t[10] !== n.displayName || t[11] !== x || t[12] !== S
    ? ((C = (0, Q.jsx)(X, {
        children: (0, Q.jsx)(ke, { title: y, titleClassName: x, className: `gap-2`, subtitle: S }),
      })),
      (t[10] = n.displayName),
      (t[11] = x),
      (t[12] = S),
    ...
    : (C = t[13]);
  let w;
  t[14] !== u || t[15] !== n || t[16] !== f
    ? ((w = (0, Q.jsx)(X, {
        className: `pt-0`,
        children: (0, Q.jsx)(Gn, { connection: n, state: f, appServerVersion: u }),
      })),
      (t[14] = u),
      (t[15] = n),
      (t[16] = f),
  ...
  t[27] !== f
    ? ((T =
        !m && (!r || f === `connected`)
          ? (0, Q.jsx)(Hn, {
              connection: n,
              showAddDeviceOnly: r && !g,
              showAvailabilityOnly: v && !_,
              leadingRow: v
                ? (0, Q.jsx)(Un, {
                    connection: n,
                    oneToOnePairingInAppEnabled: !0,
                    remoteControlSetupRequired: !1,
                    onDisableRemoteControl: o,
                    onRequestRemoteControlAllow: s,
                  })
                : void 0,
  ...
  let D;
  return (
    t[38] !== C || t[39] !== w || t[40] !== T || t[41] !== E
      ? ((D = (0, Q.jsxs)(je, { className: `gap-2 px-6 py-5`, children: [C, w, T, E] })),
        (t[38] = C),
        (t[39] = w),
        (t[40] = T),
        (t[41] = E),
...
function Bn(e) {
  ...
  return (
    t[0] !== n || t[1] !== r || t[2] !== i
      ? ((a = (0, Q.jsx)(Vn, { connection: n, error: r, state: i })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i),
        (t[3] = a))
...
function Vn(e) {
  ...
  let s;
  return (
    t[5] === a ? (s = t[6]) : ((s = (0, Q.jsxs)(zn, { children: [a, o] })), (t[5] = a), (t[6] = s)),
    s
  );
}
function Hn(e) {
  let t = (0, $.c)(25),
    {
      ...
      showAddDeviceOnly: c,
      showAvailabilityOnly: l,
      onAdd: u,
    } = e,
    d = a(s),
    f = i(ft, n.hostId),
    p;
  t[0] !== n.hostId || t[1] !== d.query
    ? ((p = d.query.snapshot(ft, n.hostId)), (t[0] = n.hostId), (t[1] = d.query), (t[2] = p))
    : (p = t[2]);
  let m = p,
    h = f.data,
    g = (h?.length ?? 0) > 0,
  ...
  t[10] === v
    ? (y = t[11])
    : ((y = (0, Q.jsx)(nt.Header, { title: _, actions: v })), (t[10] = v), (t[11] = y));
  let b;
  t[12] !== g ||
  t[13] !== r ||
  t[14] !== u ||
  ...
  t[19] !== c ||
  t[20] !== l
    ? ((b = (0, Q.jsx)(nt.Content, {
        children: l
          ? (0, Q.jsx)(tt, { children: r })
          : !c && g && h != null
            ? (0, Q.jsx)(Nt, {
                clients: h,
                leadingRow: r,
  ...
  return (
    t[22] !== y || t[23] !== b
      ? ((x = (0, Q.jsx)(X, {
          className: `pt-0`,
          children: (0, Q.jsxs)(nt, { children: [y, b] }),
        })),
        (t[22] = y),
        (t[23] = b),
        (t[24] = x))
...
function Un(e) {
  let t = (0, $.c)(25),
    {
      connection: n,
      oneToOnePairingInAppEnabled: r,
      remoteControlSetupRequired: o,
      onDisableRemoteControl: l,
      onRequestRemoteControlAllow: u,
    } = e,
    d = a(s),
    f = F(),
    p = i(c, n.hostId),
  ...
  return (
    t[21] !== v || t[22] !== y || t[23] !== b
      ? ((x = (0, Q.jsx)(et, { label: v, description: y, control: b })),
        (t[21] = v),
        (t[22] = y),
        (t[23] = b),
        (t[24] = x))
...
function Wn(e) {
  ...
  return (
    t[12] !== u || t[13] !== o || t[14] !== g
      ? ((_ = (0, Q.jsx)(Tn, { allowing: u, open: !0, onAllow: g, onOpenChange: o })),
        (t[12] = u),
        (t[13] = o),
        (t[14] = g),
        (t[15] = _))
...
function Gn(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== c || t[3] !== o || t[4] !== i) {
    ...
    (t[10] === s
      ...
      : ((d = (e) => {
          let t = e.copyValue,
            n = typeof e.value == `string` ? (0, Q.jsx)(pn, { value: e.value }) : e.value;
          return (0, Q.jsxs)(
            `div`,
            {
  ...
  if (e.source === `remote-control`) {
    ...
    return [
      ...
      },
      {
        ...
        value: e.lastSeenAt == null ? Fn : (0, Q.jsx)(Ve, { dateString: e.lastSeenAt }),
      },
    ];
  }
  let r = [],
  ...
  (e.source === `discovered` &&
    ...
    r.push(
      ...
      },
      {
        ...
        value: e.sshPort == null ? Fn : String(e.sshPort),
      },
      {
...
function Yn(e) {
  ...
  t[4] === l
    ? (u = t[5])
    : ((u = (0, Q.jsx)(Oe, { className: `sr-only`, children: l })), (t[4] = l), (t[5] = u));
  let d;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, Q.jsx)(Xn, {})), (t[6] = d))
    : (d = t[6]);
  ...
  let h;
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, Q.jsx)(ct, { variant: `dialog` })), (t[14] = h))
    : (h = t[14]);
  let g;
  ...
  let _;
  t[16] !== n || t[17] !== i
    ? ((_ = (0, Q.jsx)(K, { size: `large`, loading: n, onClick: i, children: g })),
      (t[16] = n),
      (t[17] = i),
      (t[18] = _))
    : (_ = t[18]);
...
function Zn(e) {
  ...
  let g = r || i,
    _;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Q.jsx)(Je, { className: `icon-sm` })), (t[5] = _))
    : (_ = t[5]);
  let v;
  ...
  t[14] === x
    ? (C = t[15])
    : ((C = (0, Q.jsx)(K, { type: `submit`, size: `large`, disabled: x, children: S })),
      (t[14] = x),
      (t[15] = C));
  let w;
  t[16] !== C || t[17] !== v
              ...
              return (0, Q.jsx)(
                `div`,
                {
                  ...
                  children: (0, Q.jsx)(et, {
                    icon: kt(e),
                    label: e.displayName,
                    description: (0, Q.jsx)(er, { connection: e }),
                    control: (0, Q.jsx)(`div`, {
                      className: `relative flex items-center`,
                      onClick: $n,
                      onKeyDown: Qn,
    ...
    ? ((a = n.online
        ...
        : n.lastSeenAt == null
          ...
          : (0, Q.jsx)(I, {
              ...
              values: { date: (0, Q.jsx)(Ve, { dateString: n.lastSeenAt }, `last-used-at`) },
            })),
      (t[2] = n.lastSeenAt),
      (t[3] = n.online),
      (t[4] = a))
...
function nr(e) {
  ...
  t[5] === u
    ? (f = t[6])
    : ((f = (0, Q.jsx)(X, { children: (0, Q.jsx)(ke, { title: u, subtitle: d }) })),
      (t[5] = u),
      (t[6] = f));
  let p;
  ...
  t[14] === i
    ? (_ = t[15])
    : ((_ = (0, Q.jsx)(K, { color: `danger`, loading: i, type: `submit`, children: g })),
      (t[14] = i),
      (t[15] = _));
  let v;
  t[16] !== _ || t[17] !== h
    ? ((v = (0, Q.jsx)(X, { children: (0, Q.jsxs)(Me, { children: [h, _] }) })),
      (t[16] = _),
      (t[17] = h),
      (t[18] = v))
    : (v = t[18]);
  ...
  t[19] !== c || t[20] !== v || t[21] !== f
    ? ((y = (0, Q.jsxs)(je, { as: `form`, onSubmit: c, children: [f, v] })),
      (t[19] = c),
      (t[20] = v),
      (t[21] = f),
      (t[22] = y))
  ...
  return (
    t[23] !== a || t[24] !== r || t[25] !== y
      ? ((b = (0, Q.jsx)(Ae, { open: r, onOpenChange: a, size: `compact`, children: y })),
        (t[23] = a),
        (t[24] = r),
        (t[25] = y),
        (t[26] = b))
...
var ir = `remote-connections-refresh-success`,
  ar = `remote-connections-refresh-error`,
  or = `remote-connections-save-success`,
  sr = `remote-connections-save-error`,
  cr = `remote-connections-connect-toggle-error`,
  lr = `remote-connections-install-codex-error`,
  ur = `remote-connections-logout-error`,
  dr = `remote-control-environment-rename-success`,
  fr = `remote-control-environment-rename-error`,
  pr = `remote-control-environment-delete-success`,
  mr = `remote-control-environment-delete-error`,
  hr = `remote-control-authorize-success`,
  gr = `remote-control-authorize-error`,
  _r = `[remote-connections/settings]`,
  vr = 15e3,
  yr = [],
  br = [],
  xr = [];
function Sr() {
  let e = a(s),
    ...
    [v] = m(`remote_ssh_connections`),
    { data: b } = ge(N.HOST_ID_REMOTE_CONTROL_ALLOWED),
    [T] = m(`remote_control_connections`),
    [E] = m(`remote_control_connections_state`),
    [D, O] = (0, Z.useState)(null),
    [k, A] = (0, Z.useState)(yr),
    [j, P] = (0, Z.useState)([]),
    [L, B] = (0, Z.useState)([]),
    [ee, te] = (0, Z.useState)(!1),
    [ie, se] = (0, Z.useState)(!1),
    [G, ce] = (0, Z.useState)(!1),
    [q, le] = (0, Z.useState)(`control-this-mac`),
    [ue, he] = (0, Z.useState)(null),
    ...
    Te = [...(v ?? yr)].sort(Cr),
    Ee = wr(T ?? br),
    { data: De } = ge(N.ADDED_REMOTE_CONTROL_ENV_IDS),
    X = pe({ addedRemoteControlEnvIds: De, remoteControlConnections: Ee }),
    Oe = b ?? xr,
    ke = me({ addedRemoteControlEnvIds: De, remoteControlConnections: Ee }),
    Ae = X.length > 0,
    je = E?.authRequired === !0,
    Me = E?.clientAuthorized === !0,
    Ne = rr({
    ...
    Pe = !Ae && Me && !je,
    Le = Te.map((e) => Qt(Zt(e), { connectionAnalyticsId: e.connectionAnalyticsId })),
    Re = new Set(Le.map((e) => e.hostId)),
    ze = k.filter((e) => !Re.has(e.hostId)),
    Be = ye && !0,
    Ve = xe && (ye || !1),
    He = Ie({
      selectedConnectionsTab: q,
      showControlOtherDevices: xe,
      showControlThisMacTab: Be,
      showRemoteControlConnectionsSection: ye,
    ...
    We = (t) => {
      (S.warning(`${_r} refresh_failed`, { safe: {}, sensitive: { error: t } }),
        e
          .get(Y)
          .danger(
            t instanceof Error
    ...
    Ge = w(`refresh-remote-connections`),
    Ke = w(`discover-remote-ssh-connections`),
    qe = w(`refresh-remote-control-connections`),
    Ze = w(`authorize-remote-control-connections`, {
      onSuccess: () => {
        (W(e, z, { result: `succeeded` }),
          e
            .get(Y)
            .success(
              r.formatMessage({
      ...
      onError: (t) => {
        (W(e, z, { result: `failed` }),
          S.warning(`${_r} remote_control_authorize_failed`, { safe: {}, sensitive: { error: t } }),
          e
            .get(Y)
            .danger(
    ...
    $e = w(`save-codex-managed-remote-ssh-connections`, {
      onSuccess: () => {
        e.get(Y).success(
          r.formatMessage({
      ...
      onError: (t) => {
        (S.warning(`${_r} save_failed`, { safe: {}, sensitive: { error: t } }),
          e
            .get(Y)
            .danger(
              r.formatMessage({
    ...
    et = x({ mutationFn: (t) => l(e, N.ADDED_REMOTE_CONTROL_ENV_IDS, [...De, ...t]) }),
    rt = w(`set-remote-connection-auto-connect`, {
      onError: (n, { autoConnect: i, hostId: a }) => {
        let o = Te.find((e) => e.hostId === a);
        (i &&
          o != null &&
          u(t, {
            action: oe.CODEX_REMOTE_SSH_CONNECTION_ACTION_CONNECT,
            result: R.CODEX_REMOTE_SSH_CONNECTION_RESULT_FAILED,
            source: ne.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
            connection: o,
            errorCategory: V.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_CONNECTION_FAILED,
          }),
          S.warning(`${_r} connect_toggle_failed`, {
            safe: { autoConnect: i },
    ...
    it = w(`install-remote-codex`, {
      onError: (t, { hostId: n }) => {
        (S.warning(`${_r} install_remote_codex_failed`, {
          safe: {},
    ...
    at = w(`rename-remote-control-environment`, {
      onSuccess: () => {
        e.get(Y).success(
          r.formatMessage({
      ...
      onError: (t, { envId: n }) => {
        (S.warning(`${_r} remote_control_rename_failed`, {
          safe: {},
    ...
    ot = w(`delete-remote-control-environment`, {
      onSuccess: () => {
        e.get(Y).success(
          r.formatMessage({
      ...
      onError: (t, { envId: n }) => {
        (S.warning(`${_r} remote_control_delete_failed`, {
          safe: {},
          sensitive: { envId: n, error: t },
        }),
          e
    ...
    ct =
      ...
      ot.isPending,
    lt = (t) => {
      n.getForHostId(t) ?? n.addManager(_(e, t, e.get(p, t)));
    },
    ut = async () => {
      try {
        let e = [];
        (u(t, {
          action: oe.CODEX_REMOTE_SSH_CONNECTION_ACTION_REFRESH,
          result: R.CODEX_REMOTE_SSH_CONNECTION_RESULT_STARTED,
          source: ne.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
        }),
          e.push(
            Ge.mutateAsync(void 0)
              .then(({ remoteConnections: e }) => {
                t.logProductEvent(H, g(e));
              })
              .catch((e) => {
                throw (
                  u(t, {
                    ...
                    result: R.CODEX_REMOTE_SSH_CONNECTION_RESULT_FAILED,
                    source: ne.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
                    errorCategory: V.CODEX_REMOTE_SSH_CONNECTION_ERROR_CATEGORY_UNKNOWN,
                  }),
                  e
                );
              }),
    ...
    dt = async () => {
      let { discoveredRemoteConnections: e } = await Ke.mutateAsync(void 0);
      A([...e].sort(Cr));
    },
    ft = async () => {
      try {
    ...
    mt = () => {
      if (et.isPending) return;
      let t = ke.filter((e) => L.includes(e.envId)).map((e) => e.envId);
      if (t.length === 0) {
        se(!1);
        return;
      }
      (W(e, ae, { addableConnectionCount: ke.length, existingConnectionCount: X.length }),
        et.mutate(t, {
          onSuccess: () => {
            (B([]), se(!1));
          },
    ...
    gt = () => {
      (W(e, z, { result: `started` }), Ze.mutate(void 0));
    },
    _t = async () => {
      let { remoteControlConnections: e } = await qe.mutateAsync(void 0);
      t.logProductEvent(re, un(e));
    },
    vt = (0, Z.useEffectEvent)(async (e) => {
      if (!ct)
        try {
          let t = [];
          (t.push(C(`refresh-remote-connections`, { signal: e })),
            ye && t.push(C(`refresh-remote-control-connections`, { signal: e })),
            await Promise.all(t));
        } catch (e) {
          if (e instanceof DOMException && e.name === `AbortError`) return;
          S.debug(`${_r} auto_refresh_failed`, { safe: {}, sensitive: { error: e } });
        }
    });
  (0, Z.useEffect)(() => {
    let e = null,
  ...
  let yt = async () => {
      if (_e != null)
        try {
          (await ot.mutateAsync({ envId: _e.envId }), ve(null));
        } catch {}
    },
    bt = (t, r, i) => {
      (lt(t),
    ...
    $ = (e) => {
      if (D == null || st) return;
      let n = D.mode === `edit` ? (Te.find((e) => e.hostId === D.hostId) ?? null) : null,
        r = D.mode === `add` ? !0 : (n?.autoConnect ?? !1),
        i = Qt(e, { connectionAnalyticsId: n?.connectionAnalyticsId }),
        a =
          D.mode === `add`
            ? [...Le, i]
            : Le.filter((e) => e.hostId !== D.hostId)
                .concat(i)
                .sort(Cr);
      $e.mutate(
        { remoteConnections: a },
        {
          onSuccess: ({ remoteConnections: e }) => {
            ...
            (u(t, {
              action: oe.CODEX_REMOTE_SSH_CONNECTION_ACTION_SAVE_CONNECTION,
              result: R.CODEX_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED,
              source: ne.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
              connection: n,
            }),
              O(null),
    ...
    Tt = (e) => {
      st || $e.mutate({ remoteConnections: Le.filter((t) => t.hostId !== e) });
    },
    Et = (e) => {
    ...
    Dt = () => {
      if (st) return;
      let e = ze.filter((e) => j.includes(e.hostId));
      if (e.length === 0) {
        te(!1);
        return;
      }
      let t = e.map((e) => Qt({ ...Zt(e), displayName: e.sshAlias?.trim() || e.displayName }));
      $e.mutate(
        { remoteConnections: [...Le, ...t].sort(Cr) },
        {
          onSuccess: () => {
            (t.forEach((e) => {
              Ot(e.hostId, !0);
        ...
        rt.mutate(
          { hostId: e, autoConnect: n },
          {
            onSuccess: ({ remoteConnections: r, state: i, error: a }) => {
              bt(e, i, a);
              let o = r.find((t) => t.hostId === e && M(t));
              if (n && o != null) {
                let e = i === `connected` && a == null;
                u(t, {
                  action: oe.CODEX_REMOTE_SSH_CONNECTION_ACTION_CONNECT,
                  result: e
                    ? R.CODEX_REMOTE_SSH_CONNECTION_RESULT_SUCCEEDED
                    : R.CODEX_REMOTE_SSH_CONNECTION_RESULT_FAILED,
                  source: ne.CODEX_REMOTE_SSH_CONNECTION_EVENT_SOURCE_SETTINGS,
                  connection: o,
                  connectionState: i,
                  ...(e
    ...
    kt = async (t) => {
      Oe.includes(t) || (await l(e, N.HOST_ID_REMOTE_CONTROL_ALLOWED, [...Oe, t]));
    },
    At = () => {
      ft();
    },
    jt = async (t) => {
      try {
        (await f(`logout`, { hostId: t }), bt(t, `error`, { code: `login-required` }));
      } catch (n) {
        (S.warning(`${_r} logout_failed`, { safe: {}, sensitive: { error: n, hostId: t } }),
          e
            .get(Y)
            .danger(
              r.formatMessage({
  ...
  return (0, Q.jsxs)(Q.Fragment, {
    children: [
      (0, Q.jsxs)(Xe, {
        title: (0, Q.jsx)(Ye, { slug: `connections` }),
        subtitle: null,
        children: [
          Ft.length >= 2
            ? (0, Q.jsx)(xt, {
            ...
            : null,
          He === `control-this-mac`
            ? (0, Q.jsx)(Se, { electron: !0, children: (0, Q.jsx)(It, {}) })
            : null,
          xe && He === `access-other-devices` && Ne
            ? (0, Q.jsxs)(nt, {
                children: [
                  (0, Q.jsx)(nt.Header, {
                    title:
                      ...
                      children: [
                        (0, Q.jsx)(J, {
                          ...
                          children: (0, Q.jsx)(K, {
                            ...
                            children: (0, Q.jsx)(Je, { className: `icon-xs` }),
                          }),
                        }),
                        Ae
                          ? (0, Q.jsx)(K, {
                              ...
                              Pe
                                ...
                                : (0, Q.jsx)(In, {
                                    ...
                                    onRenameRemoteControlConnection: async (e, t) => {
                                      await at.mutateAsync({ envId: e, name: t });
                                    },
                        ...
                        : Te.length === 0
                          ...
                          : (0, Q.jsx)(Q.Fragment, {
                              children: (0, Q.jsx)(In, {
                                ...
                                disabled: ct,
                                clientAuthorized: Me,
                                installingCodexHostId: it.isPending
                                  ? (it.variables?.hostId ?? null)
                                  : null,
                                showEmptyState: !1,
                                remoteControlAllowedHostIds: Oe,
                                onEditSshConnection: (e) => {
                                  let t = Te.find((t) => t.hostId === e);
                                  t != null && O({ mode: `edit`, hostId: e, draft: Zt(t) });
                                },
                                onInstallCodex: St,
                                onRemoveSshConnection: Tt,
                                onRenameRemoteControlConnection: async () => {},
                                onRequestDeleteRemoteControlConnection: () => {},
                                onToggleConnection: Ot,
                                onRemoteControlAllowedForSshConnection: kt,
                                onLogoutConnection: (e) => {
                                  jt(e);
                                },
                                onAuthenticate: (e) => {
      ...
      D == null
        ...
        : (0, Q.jsx)(nn, {
            ...
            mode: D.mode,
            draft: D.draft,
            existingConnections: Te,
            editingHostId: D.mode === `edit` ? D.hostId : null,
            onOpenChange: (e) => {
              e || O(null);
            },
            onSubmit: $,
      ...
      ee
        ? (0, Q.jsx)(qt, {
            ...
            isSaving: $e.isPending,
            open: !0,
            refreshing: Ke.isPending,
            onAddManually: () => {
              (te(!1), O({ mode: `add`, draft: Xt() }));
            },
            onOpenChange: te,
            onRefresh: () => {
              dt().catch(We);
      ...
      xe && ie
        ...
        : null,
      xe && G
        ? (0, Q.jsx)(Yn, { authorizing: Ze.isPending, open: !0, onAuthorize: gt, onOpenChange: ce })
        : null,
      (0, Q.jsx)(Gt, {
        hostId: ue,
        open: ue != null,
...
export { Sr as RemoteConnectionsSettings };
