import { t as e } from "./app-scope.js";
import { a as t, u as n } from "./vscode-api.js";
import { o as r, r as i, t as a } from "./tslib.es6.js";
import { F as o, L as s, N as c, P as l, j as u } from "./persisted-signal.js";
...
function hn(e) {
  switch (e) {
    case `cron`:
      return c.CODEX_AUTOMATION_KIND_CRON;
    case `heartbeat`:
      return c.CODEX_AUTOMATION_KIND_HEARTBEAT;
  }
}
function gn(e) {
  switch (e) {
    case `ACTIVE`:
      return s.CODEX_AUTOMATION_STATUS_ACTIVE;
    case `PAUSED`:
      return s.CODEX_AUTOMATION_STATUS_PAUSED;
    case `DELETED`:
      return s.CODEX_AUTOMATION_STATUS_DELETED;
  }
}
function _n(e) {
  if (d(e))
    switch (e) {
      case `none`:
        return l.CODEX_AUTOMATION_REASONING_EFFORT_NONE;
      case `minimal`:
        return l.CODEX_AUTOMATION_REASONING_EFFORT_MINIMAL;
      case `low`:
        return l.CODEX_AUTOMATION_REASONING_EFFORT_LOW;
      case `medium`:
        return l.CODEX_AUTOMATION_REASONING_EFFORT_MEDIUM;
      case `high`:
        return l.CODEX_AUTOMATION_REASONING_EFFORT_HIGH;
      case `xhigh`:
        return l.CODEX_AUTOMATION_REASONING_EFFORT_XHIGH;
      case `max`:
        return l.CODEX_AUTOMATION_REASONING_EFFORT_MAX;
    }
}
function vn(e) {
  switch (e) {
    case `worktree`:
      return u.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_WORKTREE;
    case `local`:
      return u.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_LOCAL;
  }
}
function yn(e) {
  switch (e) {
    case K.SECONDLY:
      return o.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_SECONDLY;
    case K.MINUTELY:
      return o.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MINUTELY;
    case K.HOURLY:
      return o.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_HOURLY;
    case K.DAILY:
      return o.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_DAILY;
    case K.WEEKLY:
      return o.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_WEEKLY;
    case K.MONTHLY:
      return o.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MONTHLY;
    case K.YEARLY:
      return o.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_YEARLY;
  }
}
function bn(e, t) {
