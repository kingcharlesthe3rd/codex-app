import { Cs as e, Es as t, Ss as n, bs as r, ws as i } from "./app-server-manager-signals.js";
...
var v = function (e, t, n) {
  ...
  ae = function (e) {
    return new Date(te.getTime() + e * ee);
  },
  oe = function (e) {
    var t = e.getUTCMonth();
    return t === 1 && D(e.getUTCFullYear()) ? 29 : T[t];
  },
  k = function (e) {
    return E[e.getUTCDay()];
  },
  se = function (e, t) {
    var n = w(e, t + 1, 1);
    return [k(n), oe(n)];
  ...
  ue = function (e) {
    for (var t = [], n = 0; n < e.length; n++) t.push(le(e[n]));
    return t;
  },
  A = function (e) {
    e.sort(function (e, t) {
  ...
  me = function (e, t) {
    var n = Intl.DateTimeFormat().resolvedOptions().timeZone,
      r = new Date(pe(e, n)),
      i = new Date(pe(e, t ?? `UTC`)).getTime() - r.getTime();
    ...
    return (
      (e.isFullyConvertible = function (t) {
        ...
        for (var r in t.origOptions) {
          if (_e([`dtstart`, `tzid`, `wkst`, `freq`], r)) return !0;
          if (!_e(e.IMPLEMENTED[t.options.freq], r)) return !1;
        }
        return n;
      }),
      ...
      (e.prototype.toString = function () {
        ...
        if (
          ((this.text = [t(`every`)]), this[W.FREQUENCIES[this.options.freq]](), this.options.until)
        ) {
          this.add(t(`until`));
...
function xe(e, t) {
  ...
  function i() {
    ...
    switch (r.symbol) {
      case `day(s)`:
        ((n.freq = W.DAILY), r.nextSymbol() && (o(), d()));
        break;
      case `weekday(s)`:
        ((n.freq = W.WEEKLY),
          (n.byweekday = [W.MO, W.TU, W.WE, W.TH, W.FR]),
          r.nextSymbol(),
          o(),
          d());
        break;
      case `week(s)`:
        ((n.freq = W.WEEKLY), r.nextSymbol() && (a(), o(), d()));
        break;
      case `hour(s)`:
        ((n.freq = W.HOURLY), r.nextSymbol() && (a(), d()));
        break;
      case `minute(s)`:
        ((n.freq = W.MINUTELY), r.nextSymbol() && (a(), d()));
        break;
      case `month(s)`:
        ((n.freq = W.MONTHLY), r.nextSymbol() && (a(), d()));
        break;
      case `year(s)`:
        ((n.freq = W.YEARLY), r.nextSymbol() && (a(), d()));
        break;
      case `monday`:
      case `tuesday`:
      case `wednesday`:
      ...
      case `sunday`:
        if (
          ((n.freq = W.WEEKLY),
          (n.byweekday = [W[r.symbol.substr(0, 2).toUpperCase()]]),
          !r.nextSymbol())
        )
          return;
        for (; r.accept(`comma`); ) {
          ...
          (n.byweekday.push(W[t]), r.nextSymbol());
        }
        (o(), u(), d());
        break;
      case `january`:
      ...
      case `november`:
      case `december`:
        if (((n.freq = W.YEARLY), (n.bymonth = [s()]), !r.nextSymbol())) return;
        for (; r.accept(`comma`); ) {
          if (r.isDone()) throw Error(`Unexpected end`);
          var i = s();
  ...
  function a() {
    ...
    if (e || t)
      do {
        ...
        if (i)
          a
            ? (r.nextSymbol(), (n.byweekday ||= []), n.byweekday.push(W[a].nth(i)))
            : ((n.bymonthday ||= []), n.bymonthday.push(i), r.accept(`day(s)`));
        else if (a) (r.nextSymbol(), (n.byweekday ||= []), n.byweekday.push(W[a]));
        else if (r.symbol === `weekday(s)`)
          (r.nextSymbol(), (n.byweekday ||= [W.MO, W.TU, W.WE, W.TH, W.FR]));
...
var Ce = function (e, t) {
    return (t === void 0 && (t = ge), new W(xe(e, t) || void 0));
  },
  P = [`count`, `until`, `interval`, `byweekday`, `bymonthday`, `bymonth`];
((M.IMPLEMENTED = []),
  (M.IMPLEMENTED[N.HOURLY] = P),
  (M.IMPLEMENTED[N.MINUTELY] = P),
  (M.IMPLEMENTED[N.DAILY] = [`byhour`].concat(P)),
  (M.IMPLEMENTED[N.WEEKLY] = P),
  (M.IMPLEMENTED[N.MONTHLY] = P),
  (M.IMPLEMENTED[N.YEARLY] = [`byweekno`, `byyearday`].concat(P)));
var we = function (e, t, n, r) {
    return new M(e, t, n, r).toString();
  },
  Te = M.isFullyConvertible,
  F = (function () {
    function e(e, t, n, r) {
  ...
  Ee = (function (e) {
    ...
    return (
      ...
      (t.prototype.getWeekday = function () {
        return k(new Date(this.getTime()));
      }),
      ...
      (t.prototype.fixDay = function () {
        if (!(this.day <= 28)) {
          var e = se(this.year, this.month - 1)[1];
          if (!(this.day <= e))
            for (; this.day > e; ) {
              if (
                ((this.day -= e),
...
function De(e) {
  for (var t = [], n = Object.keys(e), r = 0, i = n; r < i.length; r++) {
    var a = i[r];
    (C(dt, a) || t.push(a), ne(e[a]) && !O(e[a]) && t.push(a));
  }
...
function Oe(e) {
  var t = s(s({}, ut), De(e));
  if ((u(t.byeaster) && (t.freq = W.YEARLY), !(u(t.freq) && W.FREQUENCIES[t.freq])))
    throw Error(`Invalid frequency: ${t.freq} ${e.freq}`);
  if (
    ((t.dtstart ||= new Date(new Date().setMilliseconds(0))),
    u(t.wkst) ? d(t.wkst) || (t.wkst = t.wkst.weekday) : (t.wkst = W.MO.weekday),
    u(t.bysetpos))
  ) {
  ...
  if ((u(t.byweekno) && !p(t.byweekno) && (t.byweekno = [t.byweekno]), !u(t.byweekday)))
    ...
    !t.byweekday.n || t.freq > W.MONTHLY
    ...
    for (var o = [], c = [], n = 0; n < t.byweekday.length; n++) {
      ...
      !m.n || t.freq > W.MONTHLY ? o.push(m.weekday) : c.push([m.weekday, m.n]);
    }
  ...
  return (
    u(t.byhour)
      ...
      : (t.byhour = t.freq < W.HOURLY ? [t.dtstart.getUTCHours()] : null),
    u(t.byminute)
      ? d(t.byminute) && (t.byminute = [t.byminute])
      : (t.byminute = t.freq < W.MINUTELY ? [t.dtstart.getUTCMinutes()] : null),
    u(t.bysecond)
      ? d(t.bysecond) && (t.bysecond = [t.bysecond])
      : (t.bysecond = t.freq < W.SECONDLY ? [t.dtstart.getUTCSeconds()] : null),
    { parsedOptions: t }
  );
}
function ke(e) {
...
function I(e) {
  ...
  var r = n[1],
    i = n[2];
  return (r && (t.tzid = r), (t.dtstart = fe(i)), t);
}
function je(e) {
    ...
    e
      ...
      .forEach(function (n) {
        ...
        switch (i.toUpperCase()) {
          case `FREQ`:
            t.freq = N[a.toUpperCase()];
            break;
          case `WKST`:
            t.wkst = U[a.toUpperCase()];
            break;
          case `COUNT`:
          case `INTERVAL`:
          case `BYSETPOS`:
...
function Ne(e) {
  return e.indexOf(`,`) === -1 ? Pe(e) : e.split(`,`).map(Pe);
}
function Pe(e) {
...
var L = (function () {
  ...
  return (
    ...
    (e.prototype.toString = function () {
      var e = de(this.date.getTime(), this.isUTC);
    ...
    (e.prototype.rezonedDate = function () {
      return this.isUTC ? this.date : me(this.date, this.tzid);
    }),
    e
  );
})();
function Ie(e) {
  for (var t = [], n = ``, r = Object.keys(e), i = Object.keys(ut), a = 0; a < r.length; a++)
    if (r[a] !== `tzid` && C(i, r[a])) {
...
function Le(e, t) {
  return e ? `DTSTART` + new L(new Date(e), t).toString() : ``;
}
function Re(e, t) {
...
var ze = (function () {
    ...
    return (
      ...
      (e.prototype._cacheGet = function (e, t) {
        ...
        if (!n && this.all) {
          for (var c = new j(e, t), o = 0; o < this.all.length && c.accept(this.all[o]); o++);
          ((n = c.getValue()), this._cacheAdd(e, n, t));
        }
        return p(n) ? ue(n) : n instanceof Date ? le(n) : n;
      }),
      e
    );
  })(),
  ...
  We = a(
    a(
      a(
        a(
          a(
            a(a(a(a(a(a(a(a([], z, !0), Ue, !0), z, !0), R, !0), z, !0), R, !0), z, !0), z, !0),
            R,
            !0,
          ),
          z,
  ...
  Ge = a(
    a(
      a(
        a(
          a(
            a(a(a(a(a(a(a(a([], z, !0), He, !0), z, !0), R, !0), z, !0), R, !0), z, !0), z, !0),
            R,
            !0,
          ),
          z,
  ...
  Je = a(
    a(
      a(
        a(
          a(
            a(a(a(a(a(a(a(a([], V, !0), qe, !0), V, !0), B, !0), V, !0), B, !0), V, !0), V, !0),
            B,
            !0,
          ),
          V,
  ...
  Ye = a(
    a(
      a(
        a(
          a(
            a(a(a(a(a(a(a(a([], V, !0), Ke, !0), V, !0), B, !0), V, !0), B, !0), V, !0), V, !0),
            B,
            !0,
          ),
          V,
  ...
  Xe = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366],
  Ze = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365],
  Qe = (function () {
...
function $e(e, t) {
  var n = w(e, 1, 1),
    ...
    a = ie(n),
    o = k(n),
    c = s(s({ yearlen: r, nextyearlen: i, yearordinal: a, yearweekday: o }, et(e)), {
      wnomask: null,
    });
  ...
  if (d) {
    ...
    if (C(t.byweekno, -1)) S = -1;
      ...
      var T = k(w(e - 1, 1, 1)),
        ee = y(7 - T.valueOf() + t.wkst, 7),
        te = D(e - 1) ? 366 : 365,
        E = void 0;
      (ee >= 4 ? ((ee = 0), (E = te + y(T - t.wkst, 7))) : (E = r - d),
        (S = Math.floor(52 + y(E, 7) / 4)));
    }
...
function et(e) {
  var t = D(e) ? 366 : 365,
    n = k(w(e, 1, 1));
  return t === 365
    ? { mmask: Be, mdaymask: Ge, nmdaymask: Ye, wdaymask: Qe.slice(n), mrange: Ze }
    : { mmask: Ve, mdaymask: We, nmdaymask: Je, wdaymask: Qe.slice(n), mrange: Xe };
}
function tt(e, t, n, r, i, a) {
  ...
  else a.freq === W.MONTHLY && (s = [r.slice(t - 1, t + 1)]);
  if (x(s)) return o;
  o.nwdaymask = h(0, n);
...
var rt = (function () {
  ...
  return (
    (e.prototype.rebuild = function (e, t) {
      var n = this.options;
      if (
        (e !== this.lastyear && (this.yearinfo = $e(e, n)),
        ...
        var r = this.yearinfo,
          ...
          a = r.mrange,
          o = r.wdaymask;
        this.monthinfo = tt(e, t, i, a, o, n);
      }
      u(n.byeaster) && (this.eastermask = nt(e, n.byeaster));
    }),
    ...
    (e.prototype.wdayset = function (e, t, n) {
      for (
        var r = h(null, this.yearlen + 7), i = ie(w(e, t, n)) - this.yearordinal, a = i, o = 0;
...
function at(e, t) {
  ...
  for (var d = lt(l, c, t); ; ) {
    var f = l.getdayset(r)(c.year, c.month, c.day),
      ...
      g = ct(p, m, h, l, t);
    if (S(o))
      for (var _ = it(o, d, m, h, l, p), v = 0; v < _.length; v++) {
        var y = _[v];
        if (a && y > a) return H(e);
        if (y >= n) {
          var b = st(y, t);
          if (!e.accept(b) || (s && (--s, !s))) return H(e);
        }
      }
    else
      for (var v = m; v < h; v++) {
        var x = p[v];
        if (u(x))
          for (var C = ae(l.yearordinal + x), w = 0; w < d.length; w++) {
            var T = d[w],
              y = ce(C, T);
            if (a && y > a) return H(e);
            if (y >= n) {
    ...
    if (t.interval === 0 || (c.add(t, g), c.year > 9999)) return H(e);
    (Se(r) || (d = l.gettimeset(r)(c.hour, c.minute, c.second, 0)), l.rebuild(c.year, c.month));
  }
}
function ot(e, t, n) {
  var r = n.bymonth,
...
function st(e, t) {
  return new L(e, t.tzid).rezonedDate();
}
function H(e) {
  return e.getValue();
}
...
function lt(e, t, n) {
  ...
  return Se(r)
    ? ke(n)
    : (r >= W.HOURLY && S(i) && !C(i, t.hour)) ||
        (r >= W.MINUTELY && S(a) && !C(a, t.minute)) ||
        (r >= W.SECONDLY && S(o) && !C(o, t.second))
      ? []
...
var U = {
  ...
  W = (function () {
    function e(e, t) {
      (e === void 0 && (e = {}),
        t === void 0 && (t = !1),
        (this._cache = t ? null : new ze()),
        (this.origOptions = De(e)),
        (this.options = Oe(e).parsedOptions));
    }
    return (
      ...
      (e.prototype.all = function (e) {
        ...
        return (t === !1 && ((t = this._iter(new j(`all`, {}))), this._cacheAdd(`all`, t)), t);
      }),
      (e.prototype.between = function (e, t, n, r) {
        if ((n === void 0 && (n = !1), !O(e) || !O(t)))
        ...
        return (
          a === !1 && ((a = this._iter(new j(`between`, i))), this._cacheAdd(`between`, a, i)), a
        );
      }),
      (e.prototype.before = function (e, t) {
        ...
        return (
          r === !1 && ((r = this._iter(new j(`before`, n))), this._cacheAdd(`before`, r, n)), r
        );
      }),
      (e.prototype.after = function (e, t) {
        if ((t === void 0 && (t = !1), !O(e))) throw Error(`Invalid date passed in to RRule.after`);
        var n = { dt: e, inc: t },
          r = this._cacheGet(`after`, n);
        return (
          r === !1 && ((r = this._iter(new j(`after`, n))), this._cacheAdd(`after`, r, n)), r
        );
      }),
...
var pt = { dtstart: null, cache: !1, unfold: !1, forceset: !1, compatible: !1, tzid: null };
function mt(e, t) {
  var n = [],
    r = [],
    i = [],
    ...
    c = o.tzid;
  return (
    xt(e, t.unfold).forEach(function (e) {
      if (e) {
        var t = bt(e),
          o = t.name,
          s = t.parms,
...
function ht(e, t) {
  ...
  if (
    ...
    return (
      ...
      r.forEach(function (e) {
        u.rrule(new W(_t(e, s, c), l));
      }),
      i.forEach(function (e) {
        u.rdate(e);
      }),
      a.forEach(function (e) {
        u.exrule(new W(_t(e, s, c), l));
      }),
  ...
  var d = r[0] || {};
  return new W(_t(d, d.dtstart || t.dtstart || s, d.tzid || t.tzid || c), l);
}
function gt(e, t) {
  return (t === void 0 && (t = {}), ht(e, vt(t)));
}
function _t(e, t, n) {
...
var Tt = (function (e) {
  ...
  function t(t) {
    ...
    return (
      (n.dtstart = wt.apply(n, [`dtstart`])),
      (n.tzid = wt.apply(n, [`tzid`])),
      (n._rrule = []),
      (n._rdate = []),
      (n._exrule = []),
      (n._exdate = []),
  ...
  return (
    (t.prototype._iter = function (e) {
      return ft(e, this._rrule, this._exrule, this._rdate, this._exdate, this.tzid());
    }),
    ...
    (t.prototype.valueOf = function () {
      var e = [];
      return (
        !this._rrule.length && this._dtstart && (e = e.concat(Ie({ dtstart: this._dtstart }))),
...
`)
        ...
        this._rdate.length && e.push(Ot(`RDATE`, this._rdate, this.tzid())),
        this._exdate.length && e.push(Ot(`EXDATE`, this._exdate, this.tzid())),
        e
      );
    }),
...
function Et(e, t) {
  if (!(e instanceof W)) throw TypeError(String(e) + ` is not RRule instance`);
  C(t.map(String), String(e)) || t.push(e);
}
function Dt(e, t) {
  if (!(e instanceof Date)) throw TypeError(String(e) + ` is not Date instance`);
  C(t.map(Number), Number(e)) || (t.push(e), A(t));
}
function Ot(e, t, n) {
  var r = !n || n.toUpperCase() === `UTC`;
  return `${r ? `${e}:` : `${e};TZID=${n}:`}${t
    .map(function (e) {
      return de(e.valueOf(), r);
    })
    .join(`,`)}`;
}
var G = [`SU`, `MO`, `TU`, `WE`, `TH`, `FR`, `SA`];
function K(e) {
  let t = new Map(G.map((e, t) => [e, t]));
...
function jt(e, t, n, r, i) {
  ...
  if (i === `long` && e.length === 1) {
    let n = e[0];
    return n ? At(n, t) : null;
  }
  return e.length > 2 && Rt(e) ? Lt(e, t) : Mt(e, t, e.length > 2 ? `short` : i);
}
function q(e, t) {
  return e.length === t.length ? t.every((t) => e.includes(t)) : !1;
}
function Mt(e, t, n) {
  let r = e.map((e) => (n === `short` ? It(e, t) : Nt(e, t, `long`)));
...
function It(e, t) {
  let n = Nt(e, t, `short`),
    r = Nt(e, t, `long`);
  return n.length >= r.length ? t.formatDate(Pt(e), { weekday: `narrow` }) : n;
}
function Lt(e, t) {
  let n = K(e),
    r = n[0],
...
var J = Array.from(G),
  ...
  Bt = `09:00`,
  Vt = `MO`,
  Ht = new Set([`freq`, `interval`, `dtstart`, `tzid`]),
  Ut = new Set([...Ht, `byweekday`, `byminute`]),
  Wt = new Set([...Ut, `byhour`]),
  Gt = { MO: W.MO, TU: W.TU, WE: W.WE, TH: W.TH, FR: W.FR, SA: W.SA, SU: W.SU };
function Kt() {
  return {
    mode: `daily`,
    intervalHours: 24,
...
function Zt(e) {
  let t = {
    ...
    ...(e.reasoningEffort == null ? {} : { reasoningEffort: fn(e.reasoningEffort) }),
  };
  if (e.kind !== `cron`) return t;
  let n = { ...t, cwdCount: e.cwds.length, executionEnvironment: pn(e.executionEnvironment) };
  return (
...
function Qt(e) {
  switch (e.mode) {
    case `hourly`:
      return e.intervalMinutes == null ? an(e.intervalHours) : on(e.intervalMinutes);
    case `daily`:
      return cn({ time: e.time, weekdays: J });
    case `weekdays`:
      return cn({ time: e.time, weekdays: Array.from(Y) });
    case `weekly`:
...
function $t(e) {
  switch (e.mode) {
    case `hourly`:
      return e.intervalMinutes == null ? X(e.intervalHours) != null : Z(e.intervalMinutes) != null;
    case `daily`:
    case `weekdays`:
    case `weekly`:
...
function en(e, t) {
  return t === `custom`
    ? {
        ...e,
        mode: `custom`,
        customRrule: e.mode === `custom` && e.customRrule.trim() ? e.customRrule : Qt(e),
      }
    : t === `hourly`
      ? {
          ...e,
          mode: `hourly`,
          intervalHours: e.mode === `hourly` ? (X(e.intervalHours) ?? 1) : 1,
          intervalMinutes: e.intervalMinutes == null ? null : (Z(e.intervalMinutes) ?? 30),
        }
      : t === `daily`
        ? { ...e, mode: `daily`, weekdays: J }
        : t === `weekdays`
          ? { ...e, mode: `weekdays`, weekdays: Array.from(Y) }
          : { ...e, mode: `weekly`, weekdays: [wn(e.weekdays)] };
}
function tn(e) {
  return e.length > 0 ? K(e) : J;
}
function nn(e, t) {
  return hn(Q(Qt(e)), t) ?? null;
}
function rn({ rrule: e, intl: t, fallbackMessage: n }) {
  return e ? (hn(Q(e), t) ?? n) : null;
}
function an(e) {
  let t = X(e) ?? 1;
  return new W({
    ...
    interval: t,
    byminute: 0,
    byweekday: J.map((e) => Gt[e]),
  }).toString();
}
function on(e) {
  let t = Z(e) ?? 30;
  return new W({ freq: W.MINUTELY, interval: t }).toString();
}
function X(e) {
...
function sn(e) {
  return e.hasMultipleTimeValues
    ? null
    : e.freq === W.MINUTELY && $(e, Ht)
      ? (Z(e.interval) ?? 30)
      : e.freq === W.HOURLY && $(e, Ut) && (e.minute == null || e.minute === 0) && q(e.weekdays, J)
        ? (X(e.interval) ?? 1) * 60
        : null;
}
...
function Q(e) {
  if (!e) return null;
  try {
    let t = gt(e, { forceset: !0, tzid: On() ?? void 0 }),
      n = t.rrules()[0];
    if (!n) return null;
    let r = n.options,
      i = Sn(r.byweekday) ?? Cn(e) ?? J,
      a = xn(r.byminute);
    return {
      freq: r.freq,
      isStandaloneRrule:
...
function ln(e) {
  ...
  if (e.freq === W.HOURLY && $(e, Ut) && e.interval === 1 && e.minute === 0 && q(e.weekdays, J))
    return `hourly`;
  if ($(e, Wt) && e.interval === 1 && (e.freq === W.DAILY || e.freq === W.WEEKLY)) {
    if (q(e.weekdays, J)) return `daily`;
    if (q(e.weekdays, Y)) return `weekdays`;
...
function un(e) {
  switch (e) {
    case `cron`:
      return n.CODEX_AUTOMATION_KIND_CRON;
    case `heartbeat`:
      return n.CODEX_AUTOMATION_KIND_HEARTBEAT;
  }
}
function dn(e) {
  switch (e) {
...
function fn(t) {
  switch (t) {
    case `none`:
      return e.CODEX_AUTOMATION_REASONING_EFFORT_NONE;
    case `minimal`:
      return e.CODEX_AUTOMATION_REASONING_EFFORT_MINIMAL;
    case `low`:
      return e.CODEX_AUTOMATION_REASONING_EFFORT_LOW;
    case `medium`:
      return e.CODEX_AUTOMATION_REASONING_EFFORT_MEDIUM;
    case `high`:
      return e.CODEX_AUTOMATION_REASONING_EFFORT_HIGH;
    case `xhigh`:
      return e.CODEX_AUTOMATION_REASONING_EFFORT_XHIGH;
  }
}
function pn(e) {
  switch (e) {
...
function hn(e, t) {
  ...
  let n = tn(e.weekdays),
    r = n.length === G.length;
  if (e.freq === W.MINUTELY)
    return _n({ intervalMinutes: e.interval, intl: t, isEveryDay: r, weekdays: n });
  if (e.freq === W.HOURLY)
    return gn({ intervalHours: e.interval, intl: t, isEveryDay: r, weekdays: n });
  if (e.freq !== W.DAILY && e.freq !== W.WEEKLY) return null;
  let i = kt(e.time, t);
...
function Sn(e) {
  if (!e) return null;
  let t = new Map(G.map((e) => [Gt[e].weekday, e])),
    n = (Array.isArray(e) ? e : [e])
      .map((e) => {
        if (typeof e == `string`) {
          let t = e.toUpperCase();
          return G.includes(t) ? t : null;
        }
        return typeof e == `number`
          ? (t.get(e) ?? null)
