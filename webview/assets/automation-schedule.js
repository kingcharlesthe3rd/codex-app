import { t as e } from "./app-scope-CWE-zIhQ.js";
import { a as t, u as n } from "./vscode-api.js";
import { o as r, r as i, t as a } from "./tslib.es6.js";
import { I as o, R as s, U as c, V as l, z as u } from "./product-logger.js";
import { i as d } from "./models-and-reasoning-efforts.js";
var f = t(e, `list-automations`, {
    enabled: !0,
...
function S(e, t, n) {
  ...
  return (
    ...
    r.length > t
      ? String(r)
      : ((t -= r.length), t > n.length && (n += b(n, t / n.length)), n.slice(0, t) + String(r))
  );
}
var C = function (e, t, n) {
  ...
  T = function (e, t) {
    return { div: Math.floor(e / t), mod: w(e, t) };
  },
  E = function (e) {
  ...
  ce = function (e) {
    var t = e.getUTCMonth();
    return t === 1 && A(e.getUTCFullYear()) ? 29 : ee[t];
  },
  M = function (e) {
  ...
  pe = function (e, t) {
    ...
    var n = new Date(e);
    return [
      S(n.getUTCFullYear().toString(), 4, `0`),
      S(n.getUTCMonth() + 1, 2, `0`),
      S(n.getUTCDate(), 2, `0`),
      `T`,
      S(n.getUTCHours(), 2, `0`),
      S(n.getUTCMinutes(), 2, `0`),
      S(n.getUTCSeconds(), 2, `0`),
      t ? `Z` : ``,
    ].join(``);
  },
  me = function (e) {
  ...
  F = (function () {
    function e(e, t, n, r) {
      ...
      if (h(this.origOptions.byweekday)) {
        var o = v(this.origOptions.byweekday)
    ...
    return (
      ...
      (e.prototype.toString = function () {
        ...
        if (
          ((this.text = [t(`every`)]), this[K.FREQUENCIES[this.options.freq]](), this.options.until)
        ) {
          this.add(t(`until`));
      ...
      (e.prototype.weekdaytext = function (e) {
        var t = g(e) ? (e + 1) % 7 : e.getJsWeekday();
  ...
  function a() {
    ...
    if (e || t)
      do {
        ...
        if (i)
          a
            ? (r.nextSymbol(), (n.byweekday ||= []), n.byweekday.push(K[a].nth(i)))
            : ((n.bymonthday ||= []), n.bymonthday.push(i), r.accept(`day(s)`));
        else if (a) (r.nextSymbol(), (n.byweekday ||= []), n.byweekday.push(K[a]));
...
var Te = function (e, t) {
  ...
  L = [`count`, `until`, `interval`, `byweekday`, `bymonthday`, `bymonth`];
((F.IMPLEMENTED = []),
  (F.IMPLEMENTED[I.HOURLY] = L),
  (F.IMPLEMENTED[I.MINUTELY] = L),
  (F.IMPLEMENTED[I.DAILY] = [`byhour`].concat(L)),
  (F.IMPLEMENTED[I.WEEKLY] = L),
  (F.IMPLEMENTED[I.MONTHLY] = L),
  (F.IMPLEMENTED[I.YEARLY] = [`byweekno`, `byyearday`].concat(L)));
var Ee = function (e, t, n, r) {
    return new F(e, t, n, r).toString();
  },
  De = F.isFullyConvertible,
  R = (function () {
    function e(e, t, n, r) {
  ...
  Oe = (function (e) {
    ...
    return (
      ...
      (t.prototype.getWeekday = function () {
        return M(new Date(this.getTime()));
      }),
      ...
      (t.prototype.addHours = function (e, t, n) {
        for (t && (this.hour += Math.floor((23 - this.hour) / e) * e); ; ) {
          this.hour += e;
          var r = T(this.hour, 24),
            i = r.div,
            a = r.mod;
          if ((i && ((this.hour = a), this.addDaily(i)), E(n) || O(n, this.hour))) break;
        }
      }),
      (t.prototype.addMinutes = function (e, t, n, r) {
        for (
          ...
          this.minute += e;
          var i = T(this.minute, 60),
            a = i.div,
            o = i.mod;
          if (
            (a && ((this.minute = o), this.addHours(a, !1, n)),
            (E(n) || O(n, this.hour)) && (E(r) || O(r, this.minute)))
          )
            break;
        }
      }),
      (t.prototype.addSeconds = function (e, t, n, r, i) {
        for (
          ...
          this.second += e;
          var a = T(this.second, 60),
            o = a.div,
            s = a.mod;
          if (
            (o && ((this.second = s), this.addMinutes(o, !1, n, r)),
            (E(n) || O(n, this.hour)) && (E(r) || O(r, this.minute)) && (E(i) || O(i, this.second)))
          )
            break;
        }
      }),
...
function ke(e) {
  for (var t = [], n = Object.keys(e), r = 0, i = n; r < i.length; r++) {
    var o = i[r];
    (O(mt, o) || t.push(o), ie(e[o]) && !j(e[o]) && t.push(o));
  }
...
function Ae(e) {
  var t = a(a({}, pt), ke(e));
  if ((h(t.byeaster) && (t.freq = K.YEARLY), !(h(t.freq) && K.FREQUENCIES[t.freq])))
    throw Error(`Invalid frequency: ${t.freq} ${e.freq}`);
  if (
    ((t.dtstart ||= new Date(new Date().setMilliseconds(0))),
    h(t.wkst) ? g(t.wkst) || (t.wkst = t.wkst.weekday) : (t.wkst = K.MO.weekday),
    h(t.bysetpos))
  ) {
    g(t.bysetpos) && (t.bysetpos = [t.bysetpos]);
  ...
  if (
    ...
    switch (t.freq) {
      ...
      case K.MONTHLY:
        ...
        break;
      case K.WEEKLY:
        t.byweekday = [M(t.dtstart)];
        break;
    }
  if (
    (h(t.bymonth) && !v(t.bymonth) && (t.bymonth = [t.bymonth]),
    h(t.byyearday) && !v(t.byyearday) && g(t.byyearday) && (t.byyearday = [t.byyearday]),
    !h(t.bymonthday))
  )
    ((t.bymonthday = []), (t.bynmonthday = []));
  else if (v(t.bymonthday)) {
    for (var i = [], o = [], n = 0; n < t.bymonthday.length; n++) {
      var r = t.bymonthday[n];
      r > 0 ? i.push(r) : r < 0 && o.push(r);
    }
    ((t.bymonthday = i), (t.bynmonthday = o));
  } else
    t.bymonthday < 0
      ? ((t.bynmonthday = [t.bymonthday]), (t.bymonthday = []))
      : ((t.bynmonthday = []), (t.bymonthday = [t.bymonthday]));
  if ((h(t.byweekno) && !v(t.byweekno) && (t.byweekno = [t.byweekno]), !h(t.byweekday)))
    t.bynweekday = null;
  else if (g(t.byweekday)) ((t.byweekday = [t.byweekday]), (t.bynweekday = null));
  else if (_(t.byweekday))
    ((t.byweekday = [m.fromStr(t.byweekday).weekday]), (t.bynweekday = null));
  else if (t.byweekday instanceof m)
    ...
    for (var s = [], c = [], n = 0; n < t.byweekday.length; n++) {
      var l = t.byweekday[n];
      if (g(l)) {
        s.push(l);
        continue;
      } else if (_(l)) {
        s.push(m.fromStr(l).weekday);
        continue;
      }
      !l.n || t.freq > K.MONTHLY ? s.push(l.weekday) : c.push([l.weekday, l.n]);
    }
    ((t.byweekday = D(s) ? s : null), (t.bynweekday = D(c) ? c : null));
  }
  return (
    h(t.byhour)
      ? g(t.byhour) && (t.byhour = [t.byhour])
      : (t.byhour = t.freq < K.HOURLY ? [t.dtstart.getUTCHours()] : null),
    h(t.byminute)
      ? g(t.byminute) && (t.byminute = [t.byminute])
      : (t.byminute = t.freq < K.MINUTELY ? [t.dtstart.getUTCMinutes()] : null),
    h(t.bysecond)
      ? g(t.bysecond) && (t.bysecond = [t.bysecond])
...
function ze(e) {
  for (var t = [], n = ``, r = Object.keys(e), i = Object.keys(pt), a = 0; a < r.length; a++)
    if (r[a] !== `tzid` && O(i, r[a])) {
      ...
      if (!(!h(s) || (v(s) && !s.length))) {
        switch (o) {
          case `FREQ`:
            ...
            break;
          case `WKST`:
            c = g(s) ? new m(s).toString() : s.toString();
            break;
          case `BYWEEKDAY`:
            ((o = `BYDAY`),
              (c = x(s)
                .map(function (e) {
                  return e instanceof m ? e : v(e) ? new m(e[0], e[1]) : new m(e);
                })
                .toString()));
            break;
          case `DTSTART`:
...
function Be(e, t) {
  return e ? `DTSTART` + new Re(new Date(e), t).toString() : ``;
}
function Ve(e, t) {
...
var He = (function () {
    ...
    return (
      ...
      (e.prototype._cacheGet = function (e, t) {
        ...
        if (!n && this.all) {
          for (var c = new P(e, t), o = 0; o < this.all.length && c.accept(this.all[o]); o++);
          ((n = c.getValue()), this._cacheAdd(e, n, t));
        }
        return v(n) ? fe(n) : n instanceof Date ? de(n) : n;
      }),
      e
    );
  })(),
          ...
          r(
            r(
              r(
                r(
                  r(
                    r(r(r(r([], b(1, 31), !0), b(2, 28), !0), b(3, 31), !0), b(4, 30), !0),
                    b(5, 31),
                    !0,
                  ),
                  b(6, 30),
          ...
          r(
            r(
              r(
                r(
                  r(
                    r(r(r(r([], b(1, 31), !0), b(2, 29), !0), b(3, 31), !0), b(4, 30), !0),
                    b(5, 31),
                    !0,
                  ),
                  b(6, 30),
  ...
  qe = r(
    r(
      r(
        r(
          r(
            r(r(r(r(r(r(r(r([], V, !0), Ke, !0), V, !0), B, !0), V, !0), B, !0), V, !0), V, !0),
            B,
            !0,
          ),
          V,
  ...
  Je = r(
    r(
      r(
        r(
          r(
            r(r(r(r(r(r(r(r([], V, !0), Ge, !0), V, !0), B, !0), V, !0), B, !0), V, !0), V, !0),
            B,
            !0,
          ),
          V,
  ...
  Ze = r(
    r(
      r(
        r(
          r(
            r(r(r(r(r(r(r(r([], U, !0), Xe, !0), U, !0), H, !0), U, !0), H, !0), U, !0), U, !0),
            H,
            !0,
          ),
          U,
  ...
  Qe = r(
    r(
      r(
        r(
          r(
            r(r(r(r(r(r(r(r([], U, !0), Ye, !0), U, !0), H, !0), U, !0), H, !0), U, !0), U, !0),
            H,
            !0,
          ),
          U,
  ...
  et = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365],
  tt = (function () {
    for (var e = [], t = 0; t < 55; t++) e = e.concat(y(7));
    return e;
  })();
function nt(e, t) {
  var n = k(e, 1, 1),
    ...
    o = oe(n),
    s = M(n),
    c = a(a({ yearlen: r, nextyearlen: i, yearordinal: o, yearweekday: s }, rt(e)), {
      wnomask: null,
    });
  if (E(t.byweekno)) return c;
  c.wnomask = b(0, r + 7);
  var l,
    u,
    d = (l = w(7 - s + t.wkst, 7));
  d >= 4 ? ((d = 0), (u = c.yearlen + w(s - t.wkst, 7))) : (u = r - d);
  for (
    var f = Math.floor(u / 7), p = w(u, 7), m = Math.floor(f + p / 4), h = 0;
    h < t.byweekno.length;
    h++
  ) {
    var g = t.byweekno[h];
    if ((g < 0 && (g += m + 1), g > 0 && g <= m)) {
      ...
      for (var v = 0; v < 7 && ((c.wnomask[_] = 1), _++, c.wdaymask[_] !== t.wkst); v++);
    }
  }
  if (O(t.byweekno, 1)) {
    var _ = d + m * 7;
    if ((d !== l && (_ -= 7 - l), _ < r))
      for (var h = 0; h < 7 && ((c.wnomask[_] = 1), (_ += 1), c.wdaymask[_] !== t.wkst); h++);
  }
  if (d) {
    var y = void 0;
    if (O(t.byweekno, -1)) y = -1;
    else {
      var x = M(k(e - 1, 1, 1)),
        S = w(7 - x.valueOf() + t.wkst, 7),
        C = A(e - 1) ? 366 : 365,
        T = void 0;
      (S >= 4 ? ((S = 0), (T = C + w(x - t.wkst, 7))) : (T = r - d),
        (y = Math.floor(52 + w(T, 7) / 4)));
    }
    if (O(t.byweekno, y)) for (var _ = 0; _ < d; _++) c.wnomask[_] = 1;
  }
  return c;
}
function rt(e) {
  var t = A(e) ? 366 : 365,
    n = M(k(e, 1, 1));
  return t === 365
    ? { mmask: Ue, mdaymask: Je, nmdaymask: Qe, wdaymask: tt.slice(n), mrange: et }
    : { mmask: We, mdaymask: qe, nmdaymask: Ze, wdaymask: tt.slice(n), mrange: $e };
}
function it(e, t, n, r, i, a) {
  var o = { lastyear: e, lastmonth: t, nwdaymask: [] },
    s = [];
  if (a.freq === K.YEARLY)
    if (E(a.bymonth)) s = [[0, n]];
    else
  ...
  for (var c = 0; c < s.length; c++)
    for (var l = s[c], u = l[0], d = l[1] - 1, f = 0; f < a.bynweekday.length; f++) {
      var p = void 0,
        ...
        g = m[1];
      (g < 0
        ? ((p = d + (g + 1) * 7), (p -= w(i[p] - h, 7)))
        : ((p = u + (g - 1) * 7), (p += w(7 - i[p] + h, 7))),
...
var ot = (function () {
  ...
  return (
    (e.prototype.rebuild = function (e, t) {
      var n = this.options;
      if (
        (e !== this.lastyear && (this.yearinfo = nt(e, n)),
        D(n.bynweekday) && (t !== this.lastmonth || e !== this.lastyear))
      ) {
        var r = this.yearinfo,
          i = r.yearlen,
          a = r.mrange,
          o = r.wdaymask;
        this.monthinfo = it(e, t, i, a, o, n);
      }
      h(n.byeaster) && (this.eastermask = at(e, n.byeaster));
    }),
    ...
    (e.prototype.mdayset = function (e, t) {
      for (
        var n = this.mrange[t - 1], r = this.mrange[t], i = b(null, this.yearlen), a = n;
        a < r;
        a++
      )
        i[a] = a;
    ...
    (e.prototype.wdayset = function (e, t, n) {
      for (
        var r = b(null, this.yearlen + 7), i = oe(k(e, t, n)) - this.yearordinal, a = i, o = 0;
    ...
    (e.prototype.ddayset = function (e, t, n) {
      var r = b(null, this.yearlen),
        i = oe(k(e, t, n)) - this.yearordinal;
...
function st(e, t, n, r, i, a) {
  for (var o = [], s = 0; s < e.length; s++) {
    var c = void 0,
      ...
      u = e[s];
    u < 0
      ? ((c = Math.floor(u / t.length)), (l = w(u, t.length)))
      : ((c = Math.floor((u - 1) / t.length)), (l = w(u - 1, t.length)));
    for (var d = [], f = n; f < r; f++) {
      var p = a[f];
      h(p) && d.push(p);
    }
...
function ct(e, t) {
  ...
  for (var u = ft(l, c, t); ; ) {
    var d = l.getdayset(r)(c.year, c.month, c.day),
      ...
      g = dt(f, p, m, l, t);
    if (D(o))
      for (var _ = st(o, u, p, m, l, f), v = 0; v < _.length; v++) {
        var y = _[v];
        if (a && y > a) return W(e);
        if (y >= n) {
          var b = ut(y, t);
...
function lt(e, t, n) {
  ...
  return (
    (D(r) && !O(r, e.mmask[t])) ||
    (D(i) && !e.wnomask[t]) ||
    (D(a) && !O(a, e.wdaymask[t])) ||
    (D(e.nwdaymask) && !e.nwdaymask[t]) ||
    (o !== null && !O(e.eastermask, t)) ||
    ((D(s) || D(c)) && !O(s, e.mdaymask[t]) && !O(c, e.nmdaymask[t])) ||
    (D(l) &&
      ((t < e.yearlen && !O(l, t + 1) && !O(l, -e.yearlen + t)) ||
        (t >= e.yearlen && !O(l, t + 1 - e.yearlen) && !O(l, -e.nextyearlen + t - e.yearlen))))
  );
}
function ut(e, t) {
  return new Re(e, t.tzid).rezonedDate();
}
function W(e) {
  return e.getValue();
}
...
function ft(e, t, n) {
  ...
  return we(r)
    ? je(n)
    : (r >= K.HOURLY && D(i) && !O(i, t.hour)) ||
        (r >= K.MINUTELY && D(a) && !O(a, t.minute)) ||
        (r >= K.SECONDLY && D(o) && !O(o, t.second))
      ? []
  ...
  K = (function () {
    ...
    return (
      ...
      (e.prototype.all = function (e) {
        ...
        return (t === !1 && ((t = this._iter(new P(`all`, {}))), this._cacheAdd(`all`, t)), t);
      }),
      (e.prototype.between = function (e, t, n, r) {
        if ((n === void 0 && (n = !1), !j(e) || !j(t)))
        ...
        return (
          a === !1 && ((a = this._iter(new P(`between`, i))), this._cacheAdd(`between`, a, i)), a
        );
      }),
      (e.prototype.before = function (e, t) {
        ...
        return (
          r === !1 && ((r = this._iter(new P(`before`, n))), this._cacheAdd(`before`, r, n)), r
        );
      }),
      (e.prototype.after = function (e, t) {
        if ((t === void 0 && (t = !1), !j(e))) throw Error(`Invalid date passed in to RRule.after`);
        var n = { dt: e, inc: t },
          r = this._cacheGet(`after`, n);
        return (
          r === !1 && ((r = this._iter(new P(`after`, n))), this._cacheAdd(`after`, r, n)), r
        );
      }),
      ...
      (e.DAILY = I.DAILY),
      (e.HOURLY = I.HOURLY),
      (e.MINUTELY = I.MINUTELY),
      (e.SECONDLY = I.SECONDLY),
      (e.MO = G.MO),
      (e.TU = G.TU),
      (e.WE = G.WE),
      (e.TH = G.TH),
...
function ht(e, t, n, r, i, a) {
  ...
  for (var l = 0; l < r.length; l++) {
    var u = new Re(r[l], a).rezonedDate();
...
var gt = { dtstart: null, cache: !1, unfold: !1, forceset: !1, compatible: !1, tzid: null };
function _t(e, t) {
  var n = [],
    r = [],
    i = [],
    ...
    c = o.tzid;
  return (
    wt(e, t.unfold).forEach(function (e) {
      if (e) {
        var t = Ct(e),
          o = t.name,
          s = t.parms,
...
function vt(e, t) {
  ...
  if (
    ...
    return (
      ...
      r.forEach(function (e) {
        u.rrule(new K(bt(e, s, c), l));
      }),
      i.forEach(function (e) {
        u.rdate(e);
      }),
      a.forEach(function (e) {
        u.exrule(new K(bt(e, s, c), l));
      }),
  ...
  var d = r[0] || {};
  return new K(bt(d, d.dtstart || t.dtstart || s, d.tzid || t.tzid || c), l);
}
function yt(e, t) {
  return (t === void 0 && (t = {}), vt(e, xt(t)));
}
function bt(e, t, n) {
  return a(a({}, e), { dtstart: t, tzid: n });
}
function xt(e) {
  var t = [],
    n = Object.keys(e),
...
var Ot = (function (e) {
  ...
  function t(t) {
    ...
    return (
      (n.dtstart = Dt.apply(n, [`dtstart`])),
      (n.tzid = Dt.apply(n, [`tzid`])),
      (n._rrule = []),
      (n._rdate = []),
      (n._exrule = []),
      (n._exdate = []),
  ...
  return (
    (t.prototype._iter = function (e) {
      return ht(e, this._rrule, this._exrule, this._rdate, this._exdate, this.tzid());
    }),
    ...
    (t.prototype.valueOf = function () {
      var e = [];
      return (
        !this._rrule.length && this._dtstart && (e = e.concat(ze({ dtstart: this._dtstart }))),
...
`)
        ...
        this._rdate.length && e.push(jt(`RDATE`, this._rdate, this.tzid())),
        this._exdate.length && e.push(jt(`EXDATE`, this._exdate, this.tzid())),
        e
      );
    }),
...
function kt(e, t) {
  ...
  O(t.map(String), String(e)) || t.push(e);
}
function At(e, t) {
  if (!(e instanceof Date)) throw TypeError(String(e) + ` is not Date instance`);
  O(t.map(Number), Number(e)) || (t.push(e), N(t));
}
function jt(e, t, n) {
...
function Pt(e, t, n, r, i) {
  ...
  return e.length > 2 && Vt(e) ? Bt(e, t) : Ft(e, t, e.length > 2 ? `short` : i);
}
function Y(e, t) {
  return e.length === t.length ? t.every((t) => e.includes(t)) : !1;
}
function Ft(e, t, n) {
  let r = e.map((e) => (n === `short` ? zt(e, t) : It(e, t, `long`)));
...
function zt(e, t) {
  let n = It(e, t, `short`),
    r = It(e, t, `long`);
  return n.length >= r.length ? t.formatDate(Lt(e), { weekday: `narrow` }) : n;
}
function Bt(e, t) {
  let n = J(e),
    r = n[0],
...
var X = Array.from(q),
  ...
  Wt = `09:00`,
  Gt = `MO`,
  Kt = new Set([`freq`, `interval`, `dtstart`, `tzid`]),
  qt = new Set([...Kt, `byweekday`, `byminute`]),
  Jt = new Set([...qt, `byhour`]),
  Yt = { MO: K.MO, TU: K.TU, WE: K.WE, TH: K.TH, FR: K.FR, SA: K.SA, SU: K.SU };
function Xt() {
  return {
    mode: `daily`,
    intervalHours: 24,
...
function tn(e) {
  let t = e.reasoningEffort == null ? void 0 : _n(e.reasoningEffort),
    n = {
      kind: hn(e.kind),
      ...(`status` in e ? { status: gn(e.status) } : {}),
      ...en(e.rrule),
      hasModel: e.model != null,
      ...(t == null ? {} : { reasoningEffort: t }),
    };
  if (e.kind !== `cron`) return n;
  let r = { ...n, cwdCount: e.cwds.length, executionEnvironment: vn(e.executionEnvironment) };
  return (
...
function nn(e) {
  switch (e.mode) {
    case `hourly`:
      return e.intervalMinutes == null ? ln(e.intervalHours) : un(e.intervalMinutes);
    case `daily`:
      return fn({ time: e.time, weekdays: X });
    case `weekdays`:
      return fn({ time: e.time, weekdays: Array.from(Ht) });
    case `weekly`:
      return fn({ time: e.time, weekdays: [kn(e.weekdays)] });
    case `custom`:
...
function rn(e) {
  switch (e.mode) {
    ...
    case `weekdays`:
    case `weekly`:
      return An(e.time) != null;
    case `custom`:
      return jn(e.customRrule.trim());
  }
}
function an(e, t) {
  return t === `custom`
    ? {
        ...e,
        mode: `custom`,
        customRrule: e.mode === `custom` && e.customRrule.trim() ? e.customRrule : nn(e),
      }
    : t === `hourly`
      ? {
          ...e,
      ...
      : t === `daily`
        ...
        : t === `weekdays`
          ? { ...e, mode: `weekdays`, weekdays: Array.from(Ht) }
          : { ...e, mode: `weekly`, weekdays: [kn(e.weekdays)] };
}
function on(e) {
  return e.length > 0 ? J(e) : X;
}
function sn(e, t) {
  return bn($(nn(e)), t) ?? null;
}
function cn({ rrule: e, intl: t, fallbackMessage: n }) {
  return e ? (bn($(e), t) ?? n) : null;
}
function ln(e) {
  let t = Z(e) ?? 1;
  return new K({
...
function dn(e) {
  return e.hasMultipleTimeValues
    ? null
    : e.freq === K.MINUTELY && pn(e, Kt)
      ? (Q(e.interval) ?? 30)
      : e.freq === K.HOURLY && pn(e, qt) && (e.minute == null || e.minute === 0) && Y(e.weekdays, X)
        ? (Z(e.interval) ?? 1) * 60
        : null;
}
function fn({ time: e, weekdays: t }) {
  let n = An(e) ?? An(Wt);
  return n
    ? new K({
        freq: K.WEEKLY,
...
function $(e) {
  if (!e) return null;
  try {
    let t = yt(e, { forceset: !0, tzid: Nn() ?? void 0 }),
      n = t.rrules()[0];
    if (!n) return null;
    let r = n.options,
      i = Dn(r.byweekday) ?? On(e) ?? X,
      a = En(r.byminute);
    return {
      freq: r.freq,
      isStandaloneRrule:
...
function mn(e) {
  ...
  if (e.freq === K.HOURLY && pn(e, qt) && e.interval === 1 && e.minute === 0 && Y(e.weekdays, X))
    return `hourly`;
  if (pn(e, Jt) && e.interval === 1 && (e.freq === K.DAILY || e.freq === K.WEEKLY)) {
    if (Y(e.weekdays, X)) return `daily`;
    if (Y(e.weekdays, Ht)) return `weekdays`;
...
function hn(e) {
  switch (e) {
    case `cron`:
      return s.CODEX_AUTOMATION_KIND_CRON;
    case `heartbeat`:
      return s.CODEX_AUTOMATION_KIND_HEARTBEAT;
  }
}
function gn(e) {
  switch (e) {
    case `ACTIVE`:
      return c.CODEX_AUTOMATION_STATUS_ACTIVE;
    case `PAUSED`:
      return c.CODEX_AUTOMATION_STATUS_PAUSED;
    case `DELETED`:
      return c.CODEX_AUTOMATION_STATUS_DELETED;
  }
}
function _n(e) {
  if (d(e))
    switch (e) {
      case `none`:
        return u.CODEX_AUTOMATION_REASONING_EFFORT_NONE;
      case `minimal`:
        return u.CODEX_AUTOMATION_REASONING_EFFORT_MINIMAL;
      case `low`:
        return u.CODEX_AUTOMATION_REASONING_EFFORT_LOW;
      case `medium`:
        return u.CODEX_AUTOMATION_REASONING_EFFORT_MEDIUM;
      case `high`:
        return u.CODEX_AUTOMATION_REASONING_EFFORT_HIGH;
      case `xhigh`:
        return u.CODEX_AUTOMATION_REASONING_EFFORT_XHIGH;
      case `max`:
        return u.CODEX_AUTOMATION_REASONING_EFFORT_MAX;
    }
}
function vn(e) {
  switch (e) {
    case `worktree`:
      return o.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_WORKTREE;
    case `local`:
      return o.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_LOCAL;
  }
}
function yn(e) {
  switch (e) {
    case K.SECONDLY:
      return l.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_SECONDLY;
    case K.MINUTELY:
      return l.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MINUTELY;
    case K.HOURLY:
      return l.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_HOURLY;
    case K.DAILY:
      return l.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_DAILY;
    case K.WEEKLY:
      return l.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_WEEKLY;
    case K.MONTHLY:
      return l.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MONTHLY;
    case K.YEARLY:
      return l.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_YEARLY;
  }
}
function bn(e, t) {
  ...
  if (e.freq === K.MINUTELY)
    return Sn({ intervalMinutes: e.interval, intl: t, isEveryDay: r, weekdays: n });
  if (e.freq === K.HOURLY)
    return xn({ intervalHours: e.interval, intl: t, isEveryDay: r, weekdays: n });
  if (e.freq !== K.DAILY && e.freq !== K.WEEKLY) return null;
  let i = Mt(e.time, t);
  return i ? wn({ intl: t, isEveryDay: r, timeLabel: i, weekdays: n }) : null;
}
function xn({ intervalHours: e, intl: t, isEveryDay: n, weekdays: r }) {
  let i =
    e === 1
      ? t.formatMessage({
...
function Sn({ intervalMinutes: e, intl: t, isEveryDay: n, weekdays: r }) {
  let i = Cn({ intervalMinutes: e, intl: t });
  if (n) return i;
  let a = t.formatMessage(
    {
      id: `settings.automations.scheduleSummary.intervalDayCount`,
...
function Cn({ intervalMinutes: e, intl: t }) {
  return e === 1
    ? t.formatMessage({
...
function wn({ intl: e, isEveryDay: t, timeLabel: n, weekdays: r }) {
  let i = Y(r, Ht),
    a = Y(r, Ut);
  if (t)
...
function Tn(e, t, n) {
  ...
  return r != null && i != null
    ? Mn(r, i)
    : n.dtstart
      ? Mn(n.dtstart.getHours(), n.dtstart.getMinutes())
      : Wt;
}
function En(e) {
  return Array.isArray(e)
...
function Dn(e) {
  if (!e) return null;
  let t = new Map(q.map((e) => [Yt[e].weekday, e])),
