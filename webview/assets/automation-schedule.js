...
import { B as o, I as s, L as c, P as l, R as u } from "./product-logger.js";
...
function gn(e) {
  switch (e) {
    case `ACTIVE`:
      return o.CODEX_AUTOMATION_STATUS_ACTIVE;
    case `PAUSED`:
      return o.CODEX_AUTOMATION_STATUS_PAUSED;
    case `DELETED`:
      return o.CODEX_AUTOMATION_STATUS_DELETED;
  }
}
function _n(e) {
  if (d(e))
    switch (e) {
      case `none`:
        return c.CODEX_AUTOMATION_REASONING_EFFORT_NONE;
      case `minimal`:
        return c.CODEX_AUTOMATION_REASONING_EFFORT_MINIMAL;
      case `low`:
        return c.CODEX_AUTOMATION_REASONING_EFFORT_LOW;
      case `medium`:
        return c.CODEX_AUTOMATION_REASONING_EFFORT_MEDIUM;
      case `high`:
        return c.CODEX_AUTOMATION_REASONING_EFFORT_HIGH;
      case `xhigh`:
        return c.CODEX_AUTOMATION_REASONING_EFFORT_XHIGH;
      case `max`:
        return c.CODEX_AUTOMATION_REASONING_EFFORT_MAX;
    }
}
function vn(e) {
  switch (e) {
    case `worktree`:
      return l.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_WORKTREE;
    case `local`:
      return l.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_LOCAL;
  }
}
function yn(e) {
  switch (e) {
    case K.SECONDLY:
      return u.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_SECONDLY;
    case K.MINUTELY:
      return u.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MINUTELY;
    case K.HOURLY:
      return u.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_HOURLY;
    case K.DAILY:
      return u.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_DAILY;
    case K.WEEKLY:
      return u.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_WEEKLY;
    case K.MONTHLY:
      return u.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MONTHLY;
    case K.YEARLY:
      return u.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_YEARLY;
  }
}
function bn(e, t) {
