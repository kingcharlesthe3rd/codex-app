...
async function L(e, t, r = null) {
  let i = await E({
    transcript: r == null ? await w(e.audio) : await R(r, e.audio),
    cleanupEnabled: t,
  });
  (U === e && (U = null),
...
function ee(e) {
  ...
  t[7] !== o || t[8] !== c
    ? ((j = () => {
        ((x.current = null), p(null), o?.(null), _(null), y(!1), h(`idle`), c?.(!1));
      }),
      (t[7] = o),
      (t[8] = c),
      (t[9] = j))
        ...
        return (
          ...
          () => {
            ...
            (t != null && P(t),
              o?.(null),
              c?.(!1),
              u && n.dispatchMessage(`global-dictation-pet-renderer-ready`, { ready: !1 }));
          }
        );
      }),
      (H = [o, c, u]),
  ...
  t[28] !== f || t[29] !== A || t[30] !== U || t[31] !== m
    ? ((W = (e) => {
        if ((e.stopPropagation(), m === `listening` && f != null)) {
          n.dispatchMessage(`global-dictation-stop-requested`, { sessionId: f });
          return;
        }
        if (U) {
          A();
        ...
        m === `error` &&
          f != null &&
          n.dispatchMessage(`global-dictation-dismiss`, { sessionId: f });
      }),
      (t[28] = f),
      (t[29] = A),
      (t[30] = U),
...
function te(e) {
  let t = (0, Z.c)(40),
    { canRetryError: n, errorMessage: o, onClick: s, status: c, waveformCanvasRef: l } = e,
    u = a(),
    d = c === `transcribing`,
    f = c === `error` && n,
    h;
  ...
  t[10] === c
    ...
    : ((_ = p(
        ...
        c === `listening`
          ? p(`cursor-interaction text-white`, Y.recordingOrb)
          : `bg-token-dropdown-background text-token-text-secondary`,
        c === `error` && `cursor-interaction`,
      )),
      (t[10] = c),
      (t[11] = _));
  let v;
  t[12] !== c || t[13] !== l
    ? ((v =
        c === `listening`
          ? (0, $.jsx)(`canvas`, { ref: l, className: `size-10 text-white`, "aria-hidden": `true` })
          : null),
      (t[12] = c),
      (t[13] = l),
      (t[14] = v))
  ...
  t[15] === d
    ? (y = t[16])
    : ((y = d ? (0, $.jsx)(m, { className: `icon-sm` }) : null), (t[15] = d), (t[16] = y));
  let b;
  t[17] === f
    ? (b = t[18])
    : ((b = f ? (0, $.jsx)(A, { className: `icon-sm` }) : null), (t[17] = f), (t[18] = b));
  let x;
  t[19] !== n || t[20] !== c
    ? ((x = c === `error` && !n ? (0, $.jsx)(r, { className: `icon-sm` }) : null),
      (t[19] = n),
      (t[20] = c),
      (t[21] = x))
    : (x = t[21]);
...
var Z,
  ...
  $,
  ne = e(() => {
    ((Z = u()), d(), (Q = t(f(), 1)), o(), h(), S(), x(), _(), v(), j(), q(), X(), ($ = g()));
  });
export { N as a, I as i, ne as n, P as o, q as r, ee as t };
//# sourceMappingURL=global-dictation-orb-CBcl-6tx.js.map
