...
import { m as L } from "./chunk-8.js";
import { o as te } from "./statsig.js";
import { t as R } from "./request.js";
import { t as z } from "./use-is-dark.js";
...
import { o as de, t as fe } from "./external-markdown-link.js";
import { t as pe } from "./image-square.js";
import { t as me } from "./filesystem-media-src.js";
import { a as he, i as ge, l as W, n as _e, r as ve, s as ye, t as G } from "./inline-mentions.js";
import { t as K } from "./code-snippet.js";
...
function Pe(e) {
  for (let t of [`.katex-display`, q])
    for (let n of Array.from(e.querySelectorAll(t)))
      n.querySelector(Ce) ?? n.replaceWith(e.ownerDocument.createTextNode(n.textContent ?? ``));
}
function Fe(e) {
...
function Ye(e) {
  ...
  return (
    t[19] !== C || t[20] !== w
      ? ((T = (0, We.createPortal)(C, w)), (t[19] = C), (t[20] = w), (t[21] = T))
      : (T = t[21]),
    T
  );
}
function Xe(e, t, n, r) {
  ...
  let c = t?.contains(s) === !0 ? t : void 0,
    ...
    u = it(o, l instanceof HTMLElement ? l.getBoundingClientRect().top : void 0);
  if (u == null) return null;
  let d = c?.getBoundingClientRect();
  return {
    portalTarget: c,
    rect: d == null ? u : new DOMRect(u.left - d.left, u.top - d.top, u.width, u.height),
...
function nt(e, t) {
  ...
  return (
    ...
    r.compareBoundaryPoints(Range.END_TO_END, n) > 0 && r.setEnd(n.endContainer, n.endOffset),
    r.toString()
  );
}
function rt(e) {
...
function it(e, t) {
  let n = at(e);
  if (n == null || (t != null && ((n.bottom = Math.min(n.bottom, t)), n.bottom <= n.top)))
    return null;
  let r = [];
...
function at(e) {
  let t = { bottom: window.innerHeight, left: 0, right: window.innerWidth, top: 0 };
  for (let n of ot(e)) if (((t = ct(t, n)), t.right <= t.left || t.bottom <= t.top)) return null;
  return t;
}
function ot(e) {
  let t = new Set();
  for (let n of st(e)) {
    ...
    for (; e != null; ) (e instanceof HTMLElement && t.add(e), (e = e.parentElement));
  }
  return Array.from(t);
}
function st(e) {
...
function Tt(e, t, n) {
  return (0, Z.jsx)(n.components?.code ?? `code`, { inline: !0, children: e.text }, t);
}
function Et(e, t, n) {
  return (0, Z.jsx)(
    n.components?.a ?? `a`,
...
function Nt(e) {
  ...
  let i;
  t[3] !== n || t[4] !== r
    ? ((i = (0, Z.jsx)(Mt, { fallback: n, ...r })), (t[3] = n), (t[4] = r), (t[5] = i))
    : (i = t[5]);
  let a;
  return (
    t[6] !== n || t[7] !== i
...
function Pt(e) {
    ...
    ? ((f =
        i == null
          ...
          : (0, Z.jsxs)(H, {
              ...
              onClick: s,
              children: [
                (0, Z.jsx)(le, { "aria-hidden": `true`, className: `icon-2xs` }),
                (0, Z.jsx)(M, {
  ...
  return (
    t[17] !== u || t[18] !== d || t[19] !== m || t[20] !== h
      ? ((g = (0, Z.jsxs)(`div`, { className: u, "data-theme": d, children: [m, h] })),
        (t[17] = u),
        (t[18] = d),
        (t[19] = m),
        (t[20] = h),
...
function Lt({
  ...
  if (s != null && f(s))
    return (0, Z.jsx)(
      he,
      { className: e, reference: S(s), cwd: n, hostId: r, onOpen: a, openInSidePanel: o },
      i,
    );
  let c = zt(t);
  if (c != null) {
  ...
  return _e(t)
    ...
    : (0, Z.jsx)(`span`, { className: D(`inline-markdown`, W.inlineMarkdown, e), children: t }, i);
}
function Rt(e) {
...
function Bt(e) {
  ...
  if (c && l) {
    ...
    t[0] !== r || t[1] !== o
      ? ((e = () =>
          (0, Z.jsx)(Pt, { className: W.codeBlock, content: r, onAddSelectedTextToChat: o })),
        (t[0] = r),
        (t[1] = o),
        (t[2] = e))
      : (e = t[2]);
  ...
  return (
    t[24] !== r || t[25] !== a || t[26] !== s || t[27] !== d
      ? ((f = (0, Z.jsx)(Ht, { content: r, language: a, renderImmediately: s, renderVisible: d })),
        (t[24] = r),
        (t[25] = a),
        (t[26] = s),
        (t[27] = d),
...
function Ht(e) {
  ...
  if (t[0] !== e) {
    ...
    ((n = r ? i.renderVisible() : (0, Z.jsx)(Ut, { ...i })), (t[0] = e), (t[1] = n));
  } else n = t[1];
  return n;
}
function Ut(e) {
...
var Gt = e(ae(), 1),
  ...
  Jt = `/badge/`;
function Yt(e) {
  return !Kt.test(e) && !t(e) ? `image` : (Xt(e)?.startsWith(`video/`) ?? !1) ? `video` : `image`;
}
function Xt(e) {
...
function Zt(e) {
  ...
  return t.protocol !== `https:` || t.hostname !== qt || !t.pathname.startsWith(Jt)
    ? null
...
function sn(e, t) {
  let n = (0, Y.c)(15),
    r = e == null,
    i;
  n[0] !== r || n[1] !== e ? ((i = !r && on(e)), (n[0] = r), (n[1] = e), (n[2] = i)) : (i = n[2]);
  let a = i,
    o,
    s;
  n[3] === e
...
function mn(e) {
  ...
  let te = I?.contentsBase64 ?? null,
    R =
      ...
      N ??
      (P && te != null
        ? $t({ contentsBase64: te, mimeType: I?.mimeType ?? null, path: S ?? x })
        : x),
    z = r ?? ``,
    B = A && !O,
    ne = A && O && N == null,
  ...
  t[50] !== z || t[51] !== R || t[52] !== c
    ? ((Ce = (e) => {
        v(gn({ fallbackItem: { src: R, alt: z }, root: c.current, trigger: e.currentTarget }));
      }),
      (t[50] = z),
      (t[51] = R),
      (t[52] = c),
  ...
  t[54] !== f || t[55] !== p || t[56] !== a || t[57] !== s || t[58] !== B
    ? ((we = D(
        un,
        s === `scrollable` ? `max-h-none !max-w-none w-auto` : f && B ? fn : [dn, `h-auto w-auto`],
        p && W.imageEnter,
        a,
      )),
      (t[54] = f),
  ...
  let De;
  return (
    t[73] !== h || t[74] !== H || t[75] !== V || t[76] !== G || t[77] !== K || t[78] !== Ee
      ? ((De = (0, Z.jsx)(xe, {
          src: V,
          alt: H,
          open: h,
...
function hn(e) {
  ...
  t[2] === c
    ? (d = t[3])
    : ((d = c ? (0, Z.jsx)(U, { className: `icon-md` }) : (0, Z.jsx)(pe, { className: `icon-lg` })),
      (t[2] = c),
      (t[3] = d));
  let f;
  return (
...
function yn(e, t) {
  ...
  let n = X.Children.toArray(e).filter(
    (e) => !((typeof e == `string` && _n.test(e)) || ((0, X.isValidElement)(e) && e.type === `br`)),
  );
...
function bn({
  ...
  let l = {
    ...
    p({ children: t }) {
      ...
      if (n != null && n.length > 1 && n.every((e) => Yt(e.props.src ?? ``) === `image`))
        return (0, Z.jsx)(`p`, {
    ...
    h1({ children: e }) {
      return (0, Z.jsx)(`h1`, { className: D(W.heading, W.heading1), children: e });
    },
    h2({ children: e }) {
      return (0, Z.jsx)(`h2`, { className: D(W.heading, W.heading2), children: e });
    },
    h3({ children: e }) {
      return (0, Z.jsx)(`h3`, { className: D(W.heading, W.heading3), children: e });
    },
    h4({ children: e }) {
      return (0, Z.jsx)(`h4`, { className: D(W.heading, W.heading4), children: e });
    },
    h5({ children: e }) {
      return (0, Z.jsx)(`h5`, { className: D(W.heading, W.heading5), children: e });
    },
    h6({ children: e }) {
      return (0, Z.jsx)(`h6`, { className: D(W.heading, W.heading6), children: e });
    },
    ...
    ol({ children: e, className: t, start: n }) {
      return (t?.includes(`contains-task-list`) ?? !1) && Cn(e)
        ? (0, Z.jsx)(`ol`, { className: D(c, W.list, W.taskList, t), children: e })
        : (0, Z.jsx)(`ol`, { className: D(c, W.list, W.orderedList, t), start: n, children: e });
    },
    li({ children: e, className: t }) {
      let n = t?.includes(`task-list-item`) ?? !1;
      return (0, Z.jsx)(`li`, { className: D(c, W.listItem, n && W.taskListItem, t), children: e });
    },
    a: Sn({
      conversationId: null,
      cwd: n,
    ...
    img(e) {
      return (0, Z.jsx)(mn, { ...e, animateEnter: t, hostId: a, mediaPresentation: o, rootRef: s });
    },
    blockquote({ children: e }) {
      return (0, Z.jsx)(`blockquote`, { className: D(c, W.blockquote), children: e });
    },
    hr() {
    ...
    table({ children: e }) {
      return (0, Z.jsx)(`div`, {
        ...
        children: (0, Z.jsx)(`div`, {
          ...
          children: (0, Z.jsx)(`table`, { className: D(c, W.table), children: e }),
        }),
      });
    },
    thead({ children: e }) {
...
function On(e, t, n) {
  return (0, Z.jsxs)(
    n.components?.li ?? `li`,
    {
      ...
      children: [
        e.task
          ? (0, Z.jsx)(`input`, { type: `checkbox`, checked: !!e.checked, disabled: !0 })
          : null,
...
function In(e, t, n, r) {
  switch (e) {
    ...
    case `sub`:
      return Bn(r) ? (0, Z.jsx)(`span`, { children: t }, n) : (0, Z.jsx)(`sub`, { children: t }, n);
    case `sup`:
...
function Bn(e) {
  return e.some((e) =>
    e.type === `image` && `href` in e && typeof e.href == `string` && Zt(e.href) != null
      ? !0
...
function qn({
  ...
  return (
    ...
    (0, Z.jsx)(`div`, {
      ref: h,
      [qe]: m,
      className: D(`[&>*:first-child]:mt-0`, W.markdownContent, n && W.markdownRoot, r),
      children: jn(p, {
        allowBasicHtml: e,
        components: { ...v, ...i },
        directives: o,
...
function Xn({
  ...
  let d = n ?? Qn({ segmentText: (e) => (r ? nr(e, c) : [e]), mentions: u, text: l });
...
function $n({
  ...
  for (let t of s) {
    if (t.kind === `text`) {
      (c.push(...tr({ fadeText: n, fadeSegmentStartIndex: l, segments: t.segments })),
        (l += t.segments.length));
      continue;
    }
    (c.push(
...
function er({
  ...
  return n ? (0, Z.jsx)(`span`, { className: W.fadeIn, children: c }, `fade-${r}`) : c;
}
function tr({ fadeText: e, fadeSegmentStartIndex: t, segments: n }) {
  return e
    ? n.map((e, n) => {
        let r = t + n;
        return (0, Z.jsx)(`span`, { className: W.fadeIn, children: e }, `fade-${r}`);
      })
    : n;
}
function nr(e, t) {
  ...
  return (
    t[2] === n
      ...
      : ((a = (0, Z.jsxs)(`div`, {
          ...
          children: [
            r,
            (0, Z.jsx)(H, { color: `secondary`, size: `default`, onClick: n, children: i }),
          ],
        })),
        (t[2] = n),
        (t[3] = a)),
...
function Cr({ cwd: e, enableInlineDil: t, hostId: n, openFileLinksInSidePanel: r }) {
  return { ...vr({ cwd: e, hostId: n, openFileLinksInSidePanel: r }), ...Sr(), ...yr(), ...br() };
}
function wr({
  allowWideBlocks: e,
  conversationId: t,
...
function Dr(e) {
  let t = (0, Y.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Z.jsx)(kr, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
...
function kr(e) {
  ...
  t[25] !== i || t[26] !== D || t[27] !== c || t[28] !== d
    ? ((j = Cr({ cwd: i, enableInlineDil: D, hostId: c, openFileLinksInSidePanel: d })),
      (t[25] = i),
      (t[26] = D),
      (t[27] = c),
      (t[28] = d),
...
function Fr(e, t, n) {
  if (zr(e)) {
    let r = Ir(e.text, t);
    (n.textByToken.set(e, { parts: r, startIndex: n.segmentCount }), (n.segmentCount += Rr(r)));
    return;
  }
...
function Ur(e) {
  ...
  return ((t = t.includes(`](`) ? Kr(t) : t), (t = qr(t, `**`)), (t = qr(t, `*`)), t);
}
function Wr(e) {
  return e.endsWith(`
`)
...
`,
      ...
      u = l.trimStart();
    if (
      (n != null && u.length > 0 && si(l) ? ((t = n), (n = null)) : u.length > 0 && (n = null),
...
function di(e) {
  let t = (0, Y.c)(5),
    n;
  t[0] === e ? (n = t[1]) : ((n = (0, Z.jsx)(pi, { ...e })), (t[0] = e), (t[1] = n));
  let r;
  return (
    t[2] !== e.children || t[3] !== n
      ? ((r = (0, Z.jsx)(oe, {
...
function pi(e) {
  ...
  let S = m === void 0 ? !1 : m,
    ...
    O = te(`2957382457`),
    k;
  t[20] === Symbol.for(`react.memo_cache_sentinel`) ? ((k = ni()), (t[20] = k)) : (k = t[20]);
  let ee = k,
    A;
  try {
    let e;
  ...
  t[32] !== i || t[33] !== O || t[34] !== c || t[35] !== f
    ? ((R = Cr({ cwd: i, enableInlineDil: O, hostId: c, openFileLinksInSidePanel: f })),
      (t[32] = i),
      (t[33] = O),
      (t[34] = c),
      (t[35] = f),
