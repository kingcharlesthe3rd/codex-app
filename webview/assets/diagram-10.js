import { t as e } from "./defaultLocale-2.js";
import { i as t, r as n, t as r } from "./src-2.js";
import { t as i } from "./ordinal-1.js";
import { r as a } from "./chunk-55.js";
import "./chunk-107.js";
import { O as o, k as s } from "./runtime.worker-2.js";
import "./chunk-63.js";
import "./chunk-61.js";
import "./chunk-108.js";
import "./chunk-95.js";
...
import "./dist-2.js";
import { t as b } from "./chunk-37.js";
import { t as x } from "./mermaid-parser.core-CrF-Svsf.js";
import { t as S } from "./chunk-82.js";
...
var D = n((e, t) => {
    ...
    let i = E(r),
      a = n((e, n) => {
        for (let r of e)
          (t.addNode(r, n), r.children && r.children.length > 0 && a(r.children, n + 1));
      }, `addNodesRecursively`);
    a(i, 0);
  }, `populate`),
        ...
        V.append(`text`)
          ...
          .each(function (e) {
            ...
            (t.style(`font-size`, `${c}px`),
              (a.getComputedTextLength() > o || c < 8 || s < c) && t.style(`display`, `none`));
          }),
        f.showValues !== !1 &&
          V.append(`text`)
