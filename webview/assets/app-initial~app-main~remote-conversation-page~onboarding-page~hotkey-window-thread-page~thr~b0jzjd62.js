...
function R(e) {
  let t = (0, z.c)(31),
    { cwd: n, hostConfig: r, onErrorMessage: a, showErrorToast: o } = e,
    s = o === void 0 ? !1 : o,
    c = m(b),
    l = L(),
    u = A(),
    d;
  t[0] === r ? (d = t[1]) : ((d = i(r)), (t[0] = r), (t[1] = d));
  let p = d,
    h = n ?? ``,
    g;
  t[2] !== p || t[3] !== h
    ? ((g = [`git`, `init-repo`, p, h]), (t[2] = p), (t[3] = h), (t[4] = g))
    : (g = t[4]);
  let _;
  t[5] !== n || t[6] !== r
    ? ((_ = async () => {
        ...
        await P(`git`).request({
          ...
          params: { cwd: f(n), hostConfig: r, operationSource: `review_model` },
        });
      }),
      (t[5] = n),
      (t[6] = r),
    ...
    : (_ = t[7]);
  let y;
  t[8] !== n || t[9] !== p || t[10] !== u || t[11] !== l || t[12] !== c
    ? ((y = async () => {
        c.get(F).success(
          u.formatMessage({
        ...
        let e = [l.invalidateQueries({ queryKey: ee(`git-origins`) })];
        (n != null && e.push(l.invalidateQueries({ queryKey: [`git`, `metadata`, p, n] })),
          await Promise.all(e));
      }),
      (t[8] = n),
      (t[9] = p),
  ...
  t[14] !== u || t[15] !== a || t[16] !== c || t[17] !== s
    ...
    : (x = t[18]);
  let S;
  t[19] !== g || t[20] !== _ || t[21] !== y || t[22] !== x
    ? ((S = { mutationKey: g, mutationFn: _, onSuccess: y, onError: x }),
      (t[19] = g),
      (t[20] = _),
      (t[21] = y),
      (t[22] = x),
  ...
  let T = w,
    ...
    D;
  return (
    t[27] !== T || t[28] !== C.isPending || t[29] !== E
      ? ((D = {
...
function B(e) {
  ...
  let l =
    ...
    d;
  t[2] === l ? (d = t[3]) : ((d = u(`flex shrink-0 items-center`, l)), (t[2] = l), (t[3] = d));
  let f;
  t[4] !== s || t[5] !== n
    ? ((f = s.formatNumber(n)), (t[4] = s), (t[5] = n), (t[6] = f))
    : (f = t[6]);
  let p;
  t[7] === f
    ? (p = t[8])
  ...
  let h =
    ...
    g;
  t[12] === h ? (g = t[13]) : ((g = u(`flex shrink-0 items-center`, h)), (t[12] = h), (t[13] = g));
  let _;
  t[14] !== s || t[15] !== r
    ? ((_ = s.formatNumber(r)), (t[14] = s), (t[15] = r), (t[16] = _))
    : (_ = t[16]);
  let v;
  t[17] === _
    ? (v = t[18])
  ...
  let b;
  return (
    t[22] !== y || t[23] !== c || t[24] !== m
      ? ((b = (0, W.jsxs)(`span`, { "data-thread-find-skip": !0, className: c, children: [m, y] })),
        (t[22] = y),
        (t[23] = c),
        (t[24] = m),
        (t[25] = b))
...
function re(e) {
  ...
  let c =
      o === `monochrome`
        ...
        : `text-token-git-decoration-added-resource-foreground`,
    l;
  t[2] === c ? (l = t[3]) : ((l = u(`flex shrink-0 items-center`, c)), (t[2] = c), (t[3] = l));
  let d;
  t[4] === n
    ? (d = t[5])
    : ((d = (0, W.jsx)(N, {
  ...
  let f;
  t[6] !== l || t[7] !== d
    ? ((f = (0, W.jsx)(`span`, { className: l, children: d })), (t[6] = l), (t[7] = d), (t[8] = f))
    : (f = t[8]);
  let p =
      o === `monochrome`
        ? `text-token-input-placeholder-foreground`
        : `text-token-git-decoration-deleted-resource-foreground`,
    m;
  t[9] === p ? (m = t[10]) : ((m = u(`flex shrink-0 items-center`, p)), (t[9] = p), (t[10] = m));
  let h;
  t[11] === r
    ? (h = t[12])
    : ((h = (0, W.jsx)(N, {
  ...
  let _;
  return (
    t[16] !== g || t[17] !== s || t[18] !== f
      ? ((_ = (0, W.jsxs)(`span`, { "data-thread-find-skip": !0, className: s, children: [f, g] })),
        (t[16] = g),
        (t[17] = s),
        (t[18] = f),
        (t[19] = _))
...
function ie(e) {
  let t = (0, U.c)(12),
    ...
    i = K[n],
    a;
  t[0] === i ? (a = t[1]) : ((a = u(`diff-stat-digit-stack`, i)), (t[0] = i), (t[1] = a));
  let o;
  ...
  let c = s,
    ...
    d;
  t[5] === l ? (d = t[6]) : ((d = u(`diff-stat-digit-column`, l)), (t[5] = l), (t[6] = d));
  let f;
  t[7] === c
    ? (f = t[8])
    : ((f = (0, W.jsx)(`span`, { className: `diff-stat-digit-clip`, children: c })),
      (t[7] = c),
      (t[8] = f));
  let p;
  return (
    t[9] !== d || t[10] !== f
      ? ((p = (0, W.jsx)(`span`, { "aria-hidden": `true`, className: d, children: f })),
        (t[9] = d),
        (t[10] = f),
        (t[11] = p))
      : (p = t[11]),
...
function oe(e) {
  ...
  let a;
  t[4] === r ? (a = t[5]) : ((a = u(`gap-3`, r)), (t[4] = r), (t[5] = a));
  let o;
  return (
    t[6] !== n || t[7] !== i || t[8] !== a
      ? ((o = (0, Q.jsx)(I, { ...i, className: a, children: n })),
        (t[6] = n),
        (t[7] = i),
        (t[8] = a),
        (t[9] = o))
...
function se(e) {
  ...
  t[0] === a
    ? (l = t[1])
    : ((l = u(`flex items-start justify-between`, a)), (t[0] = a), (t[1] = l));
  let d;
  t[2] === c
    ? (d = t[3])
    : ((d = u(`flex h-9 w-9 items-center justify-center rounded-xl`, c)), (t[2] = c), (t[3] = d));
  let f;
  t[4] !== n || t[5] !== d
    ? ((f = (0, Q.jsx)(`span`, { className: d, children: n })), (t[4] = n), (t[5] = d), (t[6] = f))
    : (f = t[6]);
  let p;
  t[7] === o
    ? (p = t[8])
    : ((p = o
        ? (0, Q.jsx)(te, { className: `icon-xs mt-0.5 text-token-description-foreground` })
        : null),
      (t[7] = o),
      (t[8] = p));
  let m;
  return (
    t[9] !== l || t[10] !== f || t[11] !== p
      ? ((m = (0, Q.jsxs)(`div`, { className: l, children: [f, p] })),
        (t[9] = l),
        (t[10] = f),
        (t[11] = p),
        (t[12] = m))
...
function ce(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = u(`text-token-foreground heading-dialog font-semibold`, r)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
...
function le(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = u(`text-token-description-foreground flex flex-col gap-3`, r)), (t[0] = r), (t[1] = i));
  let a;
  return (
    t[2] !== n || t[3] !== i
      ? ((a = (0, Q.jsx)(`div`, { className: i, children: n })), (t[2] = n), (t[3] = i), (t[4] = a))
...
function ue(e) {
  ...
  if (t[0] !== i || t[1] !== n || t[2] !== r) {
    ...
    (t[8] === i
      ? (c = t[9])
      : ((c = u(`flex flex-1 items-center justify-between gap-2`, i)), (t[8] = i), (t[9] = c)),
      (l = (0, Q.jsx)(C, { electron: !0, children: d(`medium`) })),
      (a = C),
      (o = !0),
      (s = d(`toolbar`)),
      (t[0] = i),
  ...
  t[10] !== a || t[11] !== o || t[12] !== s
    ? ((d = (0, Q.jsx)(a, { extension: o, children: s })),
      (t[10] = a),
      (t[11] = o),
      (t[12] = s),
      (t[13] = d))
  ...
  let f;
  return (
    t[14] !== c || t[15] !== l || t[16] !== d
      ? ((f = (0, Q.jsxs)(`div`, { className: c, children: [l, d] })),
        (t[14] = c),
        (t[15] = l),
        (t[16] = d),
        (t[17] = f))
...
function de(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = u(`grid grid-cols-[minmax(0,1fr)_auto] items-center gap-x-6`, a)),
      (t[0] = a),
      (t[1] = o));
  let s;
  t[2] === n
  ...
  t[6] !== s || t[7] !== c
    ...
    : (l = t[8]);
  let d;
  t[9] === i ? (d = t[10]) : ((d = i ?? (0, Q.jsx)(`span`, {})), (t[9] = i), (t[10] = d));
  let f;
  return (
    t[11] !== o || t[12] !== l || t[13] !== d
      ? ((f = (0, Q.jsxs)(`div`, { className: o, children: [l, d] })),
        (t[11] = o),
        (t[12] = l),
        (t[13] = d),
        (t[14] = f))
...
function J(e) {
  ...
  t[0] === o
    ? (s = t[1])
    : ((s = u(`grid grid-cols-[auto_minmax(0,1fr)] items-center gap-x-6`, o)),
      (t[0] = o),
      (t[1] = s));
  let c;
  t[2] === n
  ...
  t[4] !== r || t[5] !== c
    ...
    : (l = t[6]);
  let d;
  t[7] === a ? (d = t[8]) : ((d = u(`min-w-0 truncate text-right`, a)), (t[7] = a), (t[8] = d));
  let f;
  t[9] !== d || t[10] !== i
    ? ((f = (0, Q.jsx)(`div`, { className: d, children: i })), (t[9] = d), (t[10] = i), (t[11] = f))
    : (f = t[11]);
  let p;
  return (
    t[12] !== s || t[13] !== l || t[14] !== f
      ? ((p = (0, Q.jsxs)(`div`, { className: s, children: [l, f] })),
        (t[12] = s),
        (t[13] = l),
        (t[14] = f),
        (t[15] = p))
...
function fe(e) {
  let t = (0, X.c)(8),
    ...
    s;
  t[0] === o ? (s = t[1]) : ((s = u(`rounded-lg p-2`, o)), (t[0] = o), (t[1] = s));
  let c;
  return (
...
function pe(e) {
  let t = (0, X.c)(15),
    ...
    o;
  t[0] === a ? (o = t[1]) : ((o = u(`flex flex-col gap-2`, a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
  ...
  return (
    t[11] !== o || t[12] !== s || t[13] !== l
      ? ((d = (0, Q.jsxs)(`div`, { className: o, children: [s, l] })),
        (t[11] = o),
        (t[12] = s),
        (t[13] = l),
        (t[14] = d))
...
function me(e) {
  ...
  t[3] === a
    ? (f = t[4])
    : ((f = u(`vertical-scroll-fade-mask max-h-64 overflow-y-auto [--edge-fade-distance:2rem]`, a)),
      (t[3] = a),
      (t[4] = f));
  let p;
  t[5] !== r || t[6] !== f
    ? ((p = (0, Q.jsx)(`div`, { className: f, children: r })), (t[5] = r), (t[6] = f), (t[7] = p))
    : (p = t[7]);
  let m;
  return (
    t[8] !== i || t[9] !== o || t[10] !== p
