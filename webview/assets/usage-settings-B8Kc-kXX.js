...
import { n as ft, t as pt } from "./esm.js";
import { r as mt, t as ht } from "./plan-pricing-BL-ew2t5.js";
function J(e) {
...
function Tt(e) {
  ...
  let { data: p } = Qe(f),
    h;
  t[1] === p ? (h = t[2]) : ((h = { billingCurrency: p, enabled: !0 }), (t[1] = p), (t[2] = h));
  let { data: g } = $e(h),
    [_, v] = (0, cn.useState)(!1),
    y;
  ...
  let x;
  t[5] !== r || t[6] !== g || t[7] !== c
    ? ((x = Gt({ intl: c, creditDetails: r, pricingInfo: g })),
      (t[5] = r),
      (t[6] = g),
      (t[7] = c),
      (t[8] = x))
  ...
  t[21] !== D || t[22] !== S
    ...
    : (O = t[23]);
  let k;
  t[24] !== u || t[25] !== s || t[26] !== n.isEnabled || t[27] !== l
    ? ((k = (e) => {
        let t = Xe(l, `personal`);
        (Be(s, {
          audience: `personal`,
  ...
  t[30] === k
    ? (j = t[31])
    : ((j = (0, Y.jsx)(d, { color: `outline`, size: `toolbar`, onClick: k, children: A })),
      (t[30] = k),
      (t[31] = j));
  let N;
  t[32] !== O || t[33] !== j
    ...
    : (N = t[34]);
  let P;
  t[35] !== r || t[36] !== o || t[37] !== i || t[38] !== _ || t[39] !== n || t[40] !== a
    ? ((P = _
        ? (0, Y.jsx)(Ot, {
            open: _,
            serverState: n,
  ...
  return (
    t[42] !== N || t[43] !== P
      ? ((te = (0, Y.jsxs)(Y.Fragment, { children: [N, P] })),
        (t[42] = N),
        (t[43] = P),
        (t[44] = te))
      : (te = t[44]),
...
function Dt(e) {
  ye({ event: e, href: pn, initiator: `open_in_browser_bridge` });
}
function Ot(e) {
  let t = (0, sn.c)(74),
    {
  ...
  let { data: _, isPending: v } = Qe(g),
    y;
  t[2] !== _ || t[3] !== n
    ? ((y = { billingCurrency: _, enabled: n }), (t[2] = _), (t[3] = n), (t[4] = y))
    : (y = t[4]);
  let { data: b, isPending: x } = $e(y),
    C = v || x,
    w = (0, cn.useId)(),
    T = (0, cn.useId)(),
    E = (0, cn.useId)(),
    D = (0, cn.useId)(),
    k = a.isPending || o.isPending,
    A = s.isPending,
    j = k || A,
    [N, P] = (0, cn.useState)(null),
    [te, re] = (0, cn.useState)(!1),
    ie;
  t[5] !== u || t[6] !== l
    ? ((ie = (e) => {
        l.get(me).danger(rn(e, u), ln);
      }),
      (t[5] = u),
      (t[6] = l),
      (t[7] = ie))
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ue = [`usage-settings`, `auto-top-up`, `manage-payment`]), (t[16] = ue))
    : (ue = t[16]);
  let de;
  t[17] !== u || t[18] !== l
    ? ((de = {
  ...
  t[20] === R
    ? (fe = t[21])
    : ((fe = () => {
        R.isPending || R.mutate();
      }),
      (t[20] = R),
      (t[21] = fe));
  let z = fe,
    B = r.rechargeThreshold ?? un,
    pe = r.rechargeTarget ?? dn,
    V;
  t[22] !== B || t[23] !== pe
    ? ((V = { isEnabled: !0, rechargeThreshold: B, rechargeTarget: pe }),
      (t[22] = B),
      (t[23] = pe),
      (t[24] = V))
    : (V = t[24]);
  ...
  t[33] !== o
    ? ((W = async (e) => {
        let { value: t } = e,
          n = _t({ draftState: t, serverState: r, isSaving: j });
        if (n.isSaveEnabled)
          switch (n.saveIntent) {
            case `disable`:
            case `none`:
            ...
            case `enable`:
              try {
                if ((oe(), st((await a.mutateAsync(on(t))).immediate_top_up_status))) {
                  ce({ draftState: t });
                  return;
                }
                (I(`enable`), c(!1));
            ...
            case `update`:
              try {
                if ((oe(), st((await o.mutateAsync(on(t))).immediate_top_up_status))) {
                  ce({ draftState: t });
                  return;
                }
                (I(`update`), c(!1));
  ...
  let he;
  t[35] !== V || t[36] !== W
    ? ((he = { defaultValues: V, validators: H, onSubmit: W }),
      (t[35] = V),
      (t[36] = W),
      (t[37] = he))
    : (he = t[37]);
  ...
  let be = ye,
    xe;
  t[41] !== s || t[42] !== c || t[43] !== r.isEnabled || t[44] !== F || t[45] !== I
    ? ((xe = async () => {
        if (r.isEnabled)
          try {
            (await s.mutateAsync(), I(`disable`), c(!1));
          } catch {
            F(`disable`);
          }
      }),
  ...
  t[69] !== E
    ? ((Ce = (e) => {
        let { values: t, submissionAttempts: a } = e,
          o = _t({ draftState: t, serverState: r, isSaving: j }),
          s = Jt({
            intl: u,
            creditBalance: i?.balance,
            rechargeThreshold: t.rechargeThreshold,
          ...
          m =
            !te && s != null && (o.saveIntent === `enable` || o.saveIntent === `update`)
        ...
        return (0, Y.jsx)(ge, {
          ...
          contentProps: { "aria-describedby": T, onOpenAutoFocus: At },
          shouldIgnoreClickOutside: j,
          onOpenChange: be,
          children: (0, Y.jsx)(`form`, {
            onSubmit: (e) => {
              (e.preventDefault(), ve.handleSubmit());
            },
            children: (0, Y.jsxs)(_e, {
                ...
                (0, Y.jsxs)(f, {
                  ...
                  children: [
                    (0, Y.jsx)(ve.Field, {
                      ...
                      children: (e) => {
                        ...
                        return (0, Y.jsx)(Ht, {
                          ...
                          footerContent: en({ fieldError: t, fieldName: `threshold`, intl: u }),
                          footerTone: `error`,
                        ...
                        return (0, Y.jsx)(Ht, {
                          ...
                          footerContent:
                            n == null
                              ...
                              : en({ fieldError: n, fieldName: `target`, intl: u }),
                    ...
                    te
                      ? (0, Y.jsx)(zt, {
                          amount: N,
                          isManagePaymentPending: R.isPending,
                          onManagePaymentClick: z,
  ...
  let we;
  return (
    t[71] !== ve.Subscribe || t[72] !== Ce
      ? ((we = (0, Y.jsx)(ve.Subscribe, { selector: jt, children: Ce })),
        (t[71] = ve.Subscribe),
        (t[72] = Ce),
        (t[73] = we))
      : (we = t[73]),
...
function Pt(e) {
  u({ href: e.url, initiator: `open_in_browser_bridge` });
}
async function Ft() {
  return await E.safeGet(`/payments/customer_portal`);
}
function It(e) {
  let t = (0, sn.c)(4),
...
function Ht(e) {
  ...
  return (
    t[17] !== g || t[18] !== _ || t[19] !== v || t[20] !== y
      ? ((b = (0, Y.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [g, _, v, y] })),
        (t[17] = g),
        (t[18] = _),
        (t[19] = v),
        (t[20] = y),
...
function Ut(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Y.jsx)(ce, { className: `icon-xxs text-token-description-foreground` })),
      (t[2] = i))
    : (i = t[2]);
  let a;
  return (
...
function Gt({ intl: e, creditDetails: t, pricingInfo: n }) {
  ...
  return t == null
    ...
    : t.unlimited
      ...
      : n == null
        ? r
        : (Re({ intl: e, creditQuantity: Kt(t.balance), pricingInfo: n }) ?? r);
}
function Kt(e) {
...
var sn,
  ...
  hn = e(() => {
    ((sn = B()),
      ...
      (un = `125`),
      (dn = `250`),
      (fn = `${se}/settings/usage?credit_modal=true`),
...
function gn(e) {
  ...
  let s = I(o),
    ...
    u = l != null,
    f;
  t[1] === u ? (f = t[2]) : ((f = { enabled: u }), (t[1] = u), (t[2] = f));
  let { data: p } = Qe(f),
    h = l != null,
    g;
  t[3] !== p || t[4] !== h
    ? ((g = { billingCurrency: p, enabled: h }), (t[3] = p), (t[4] = h), (t[5] = g))
    : (g = t[5]);
  let { data: _ } = nt(g);
  ...
  let v =
      _ == null
        ...
        : ht({
            intl: a,
            amount: _.monthlyAmounts[l.pricePlan],
            currencyCode: _.currencyCode,
            minorUnitExponent: _.minorUnitExponent,
          }),
    y = q,
    b;
  ...
  t[16] !== E || t[17] !== D || t[18] !== O
    ? ((k = (0, X.jsx)(d, { color: E, size: `toolbar`, onClick: D, children: O })),
      (t[16] = E),
      (t[17] = D),
      (t[18] = O),
      (t[19] = k))
  ...
  let N;
  return (
    t[31] !== y || t[32] !== M || t[33] !== b
      ? ((N = (0, X.jsxs)(y, { children: [b, M] })),
        (t[31] = y),
        (t[32] = M),
        (t[33] = b),
        (t[34] = N))
...
function _n(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (o = t[4]);
  let s;
  t[5] === a ? (s = t[6]) : ((s = ie(a)), (t[5] = a), (t[6] = s));
  let c;
  return (
    t[7] === s
      ? (c = t[8])
...
var xn,
  X,
  Sn = e(() => {
    ((xn = B()), i(), L(), T(), x(), ue(), Ue(), r(), dt(), je(), ut(), ae(), mt(), D(), (X = l()));
  });
function Cn() {
  let e = (0, Dn.c)(1),
    t;
...
function wn() {
  return E.safeGet(`/wham/usage/daily-token-usage-breakdown`);
}
function Tn(e) {
  let t = (0, Dn.c)(2),
    { enabled: n } = e,
...
function En() {
  return E.safeGet(`/wham/usage/credit-usage-events`);
}
var Dn,
  On,
  kn,
...
function Mn(e, t) {
  return (0, Z.jsx)(
    ...
    {
      label: (0, Z.jsx)(Pn, { date: e.date }),
      description: (0, Z.jsx)(U, { ...Bn[e.product_surface] }),
...
function Nn(e) {
  ...
  if (a && n == null) {
    ...
    t[2] === s
      ? (n = t[3])
      : ((n = (0, Z.jsx)(d, { color: `secondary`, size: `toolbar`, onClick: s, children: e })),
        (t[2] = s),
        (t[3] = n));
    let r;
    return (
      t[4] !== i || t[5] !== n
        ? ((r = (0, Z.jsx)(G, { label: i, control: n })), (t[4] = i), (t[5] = n), (t[6] = r))
        : (r = t[6]),
      r
    );
  }
  if (n == null || n.length === 0) {
    ...
    return (
      t[7] === r
        ? (e = t[8])
        : ((e = (0, Z.jsx)(G, { label: r, control: null })), (t[7] = r), (t[8] = e)),
      e
    );
  }
  let l;
...
function Pn(e) {
  ...
  return (
    t[2] === i
      ? (a = t[3])
      : ((a = (0, Z.jsx)(F, { value: i, month: `short`, day: `numeric`, year: `numeric` })),
        (t[2] = i),
        (t[3] = a)),
    a
  );
    ...
    t[0] !== n || t[1] !== r
      ? ((i =
          n === `credits`
            ...
            : (0, Z.jsx)(W, { value: r / 100, style: `percent`, maximumFractionDigits: 0 })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function Kn(e) {
  let t = (0, cr.c)(6),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(j, { "aria-hidden": !0, className: `icon-sm text-token-text-tertiary` })),
      (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
...
function qn(e) {
  let t = (0, cr.c)(28),
    ...
    s = le(),
    [c, l] = (0, lr.useState)(!1),
    [u, f] = (0, lr.useState)(n?.justification ?? ``),
    p;
  ...
  t[12] !== r || t[13] !== _ || t[14] !== v || t[15] !== y
    ...
    : (b = t[16]);
  let x;
  t[17] !== h || t[18] !== s || t[19] !== c || t[20] !== i || t[21] !== u || t[22] !== n
    ? ((x = c
        ? (0, Q.jsx)(K, {
...
function Jn(e) {
  ...
  if (
    ...
    if (t[14] !== n.resetAt) {
      let e = Oe(n.resetAt);
      ((i = e == null ? null : De(e)), (t[14] = n.resetAt), (t[15] = i));
    } else i = t[15];
    let a = i,
      p;
...
function Yn(e) {
  ...
  if (t[0] !== n.bucket.resetsAt) {
    let e = Oe(n.bucket.resetsAt ?? null);
    ((r = e == null ? null : De(e)), (t[0] = n.bucket.resetsAt), (t[1] = r));
  } else r = t[1];
  let i = r,
    a;
  t[2] === i
  ...
  let o = a,
    ...
    c;
  t[4] === s ? (c = t[5]) : ((c = Ae(s)), (t[4] = s), (t[5] = c));
  let l = c,
    u;
  ...
  return (
    t[10] !== o || t[11] !== u || t[12] !== d
      ? ((f = (0, Q.jsx)(G, { className: `gap-6`, label: u, description: o, control: d })),
        (t[10] = o),
        (t[11] = u),
        (t[12] = d),
        (t[13] = f))
...
function Xn(e, t) {
  let n = t == null ? (e.find((e) => e.limitName == null) ?? null) : Ie(e, t);
  return n == null ? [] : lt({ entry: n, keyPrefix: t ?? `core` });
}
function Zn(e) {
...
function or(e) {
  ...
  let l;
  t[5] !== a || t[6] !== o
    ? ((l = (0, Q.jsx)(`progress`, { max: 100, value: a, "aria-label": o, className: s })),
      (t[5] = a),
      (t[6] = o),
      (t[7] = l))
    : (l = t[7]);
  ...
  return (
    t[13] !== l || t[14] !== d
      ? ((f = (0, Q.jsxs)(`div`, { className: `flex items-center gap-2`, children: [l, d] })),
        (t[13] = l),
        (t[14] = d),
        (t[15] = f))
      : (f = t[15]),
...
function gr() {
  let e = (0, br.c)(63),
    ...
    a;
  e[0] === i ? (a = e[1]) : ((a = w(i)), (e[0] = i), (e[1] = a));
  let o = a,
    s = o && n && !r,
    { data: c, isLoading: l, isError: u, refetch: f } = v(oe),
    p;
  e[2] === t ? (p = e[3]) : ((p = { enabled: t }), (e[2] = t), (e[3] = p));
  let { data: m, isLoading: h, isError: g, refetch: _ } = Pe(p),
    y;
  e[4] === s ? (y = e[5]) : ((y = { enabled: s }), (e[4] = s), (e[5] = y));
  let { data: b, isLoading: x, isError: S, refetch: C } = rt(y),
    T =
    ...
    E = s && T,
    D;
  e[6] === E ? (D = e[7]) : ((D = { enabled: E }), (e[6] = E), (e[7] = D));
  let { data: ee, refetch: O } = et(D),
    k = ee?.kind === `openai_native`,
    j = s && T && k,
    M;
  e[8] === j ? (M = e[9]) : ((M = { enabled: j }), (e[8] = j), (e[9] = M));
  let { data: N, isLoading: P, isError: te, refetch: ne } = ot(M),
    re = it(),
    {
      enableAutoTopUpMutation: ie,
      updateAutoTopUpMutation: F,
      disableAutoTopUpMutation: ae,
    } = qe(),
    I;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (0, $.jsx)(ze, { slug: `usage` })), (e[10] = I))
    : (I = e[10]);
  let L = I;
  if (!n && !r) return null;
  let se = !n && r,
    ce = o
      ? (x && b == null) || (T && k && P && N == null)
      : (t && h && m == null) || (l && c == null),
    le = o
      ? (S && b == null) || (T && k && te && N == null)
      : (t && g && m == null) || (u && c == null),
    ue;
  e[11] !== t ||
  e[12] !== T ||
  ...
  if (se || le || ce) {
    ...
    if (se) {
      ...
      (e[24] === de
        ? (a = e[25])
        : ((a = (0, $.jsx)(d, { color: `secondary`, size: `toolbar`, onClick: de, children: i })),
          (e[24] = de),
          (e[25] = a)),
        (n = a));
    } else {
    ...
    return (
      e[27] !== n || e[28] !== t
        ? ((r = (0, $.jsx)(yr, { title: L, rowLabel: t, rowControl: n })),
          (e[27] = n),
          (e[28] = t),
          (e[29] = r))
        : (r = e[29]),
      ...
      e[39] !== ee
        ? ((o = (0, $.jsx)(xe, {
            ...
            children: (0, $.jsx)(Hn, {
              ...
              canRequestEnterpriseMonthlyUsageLimit: T,
              workspaceRequestPolicy: ee,
              workspaceMonthlyUsage: i,
              workspaceAdminRequests: a,
              isWorkspaceAdminRequestsLoading: P,
              isSavingWorkspaceAdminRequest: re.isPending,
              saveWorkspaceAdminRequest: re.mutateAsync,
            }),
          })),
          (e[32] = T),
          (e[33] = P),
  ...
  e[41] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (R = e[41]);
  let fe;
  e[42] === i ? (fe = e[43]) : ((fe = (0, $.jsx)(gn, { plan: i })), (e[42] = i), (e[43] = fe));
  let z;
  e[44] !== m || e[45] !== t || e[46] !== ae || e[47] !== ie || e[48] !== c?.credits || e[49] !== F
    ? ((z =
        t && m != null
          ? (0, $.jsx)(Tt, {
              serverState: m,
  ...
  e[51] === B
    ? (pe = e[52])
    : ((pe = (0, $.jsx)(Hn, { rateLimitStatus: B })), (e[51] = B), (e[52] = pe));
  let V;
  e[53] === t
    ? (V = e[54])
    : ((V = (0, $.jsx)(A, { browser: !0, children: (0, $.jsx)(jn, { showCreditHistory: t }) })),
      (e[53] = t),
      (e[54] = V));
  let H;
  e[55] === i ? (H = e[56]) : ((H = (0, $.jsx)(_n, { plan: i })), (e[55] = i), (e[56] = H));
  let W;
  return (
    e[57] !== z || e[58] !== pe || e[59] !== V || e[60] !== H || e[61] !== fe
      ? ((W = (0, $.jsxs)(xe, {
          title: L,
          subtitle: R,
          subtitleClassName: `whitespace-normal`,
          titleStackClassName: `gap-2 pb-1`,
          children: [fe, z, pe, V, H],
        })),
        (e[57] = z),
        (e[58] = pe),
        (e[59] = V),
...
function vr(e) {
  ye({ event: e, href: H, initiator: `open_in_browser_bridge` });
}
function yr(e) {
  let t = (0, br.c)(6),
  ...
  t[0] !== i || t[1] !== r
    ? ((a = (0, $.jsx)(q, {
        children: (0, $.jsx)(q.Content, {
          children: (0, $.jsx)(K, {
            children: (0, $.jsx)(G, { className: `gap-6`, label: r, control: i }),
          }),
        }),
      })),
      (t[0] = i),
  ...
  return (
    t[3] !== a || t[4] !== n
      ? ((o = (0, $.jsx)(xe, { title: n, children: a })), (t[3] = a), (t[4] = n), (t[5] = o))
      : (o = t[5]),
    o
  );
}
...
//# sourceMappingURL=usage-settings-B8Kc-kXX.js.map
