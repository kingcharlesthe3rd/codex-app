...
import { Cu as D, Su as O } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
function k(e) {
  let t = (0, L.c)(13),
  ...
  t[0] === _
    ? ((v = t[1]), (y = t[2]))
    : ((v = (e) => _.on(`change`, e)), (y = () => _.get()), (t[0] = _), (t[1] = v), (t[2] = y));
  ...
  t[3] === C
    ? ((w = t[4]), (T = t[5]))
    : ((w = (e) => C.on(`change`, e)), (T = () => C.get()), (t[3] = C), (t[4] = w), (t[5] = T));
  let E = (0, R.useSyncExternalStore)(w, T, j),
    D = s(n, { bottom: i, right: a }, { bottom: p || b > 0, right: S || E > 0 }),
    O;
  (t[6] === n
    ? (O = t[7])
    : ((O = () => h.getBrowserUseBrowserTabIdsKey(n)), (t[6] = n), (t[7] = O)),
    (0, R.useSyncExternalStore)(h.subscribe, O, A));
  let k = P({ conversationId: n, mountedBrowserTabIds: D, panelTabs: [...x, ...c] });
...
function P({ conversationId: e, mountedBrowserTabIds: t, panelTabs: n }) {
  ...
  for (let i of n) {
    let n = T(i, e) ?? null;
    n == null || h.isBrowserUseTab(e, n) || t.includes(n) || (F(e, n) && r.add(n));
  }
  return Array.from(r);
}
function F(e, t) {
...
var L, R, z;
e(() => {
  ((L = i()), n(), (R = t(r(), 1)), w(), c(), x(), S(), E(), p(), b(), D(), (z = a()));
})();
