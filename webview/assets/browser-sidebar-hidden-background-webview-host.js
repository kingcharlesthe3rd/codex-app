...
import { _h as y, od as b, ph as x, sd as S } from "./app-initial~app-main~onboarding-page.js";
import {
  Ht as C,
  Qt as w,
  Vt as T,
...
function k(e) {
  ...
  t[0] === f
    ? ((m = t[1]), (g = t[2]))
    : ((m = (e) => f.on(`change`, e)), (g = () => f.get()), (t[0] = f), (t[1] = m), (t[2] = g));
  let v = (0, R.useSyncExternalStore)(m, g, M),
    y = c(a.tabs$),
    b = c(d),
    S = c(_),
    C,
  ...
  t[3] === S
    ? ((C = t[4]), (w = t[5]))
    : ((C = (e) => S.on(`change`, e)), (w = () => S.get()), (t[3] = S), (t[4] = C), (t[5] = w));
  let E = (0, R.useSyncExternalStore)(C, w, j),
    D = x(n, { bottom: o, right: s }, { bottom: u || v > 0, right: b || E > 0 }),
    O;
  (t[6] === n
    ? (O = t[7])
    : ((O = () => T.getBrowserUseBrowserTabIdsKey(n)), (t[6] = n), (t[7] = O)),
    (0, R.useSyncExternalStore)(T.subscribe, O, A));
  let k = P({ conversationId: n, mountedBrowserTabIds: D, panelTabs: [...y, ...l] });
...
function P({ conversationId: e, mountedBrowserTabIds: t, panelTabs: n }) {
  ...
  for (let i of n) {
    let n = v(i, e) ?? null;
    n == null || T.isBrowserUseTab(e, n) || t.includes(n) || (F(e, n) && r.add(n));
  }
  return Array.from(r);
}
function F(e, t) {
...
var L, R, z;
e(() => {
  ((L = u()), r(), (R = t(f(), 1)), l(), m(), s(), y(), n(), C(), E(), S(), (z = g()));
})();
