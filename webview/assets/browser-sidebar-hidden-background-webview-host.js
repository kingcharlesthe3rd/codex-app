...
function k(e) {
  ...
  t[0] === f
    ? ((g = t[1]), (v = t[2]))
    : ((g = (e) => f.on(`change`, e)), (v = () => f.get()), (t[0] = f), (t[1] = g), (t[2] = v));
  ...
  let E = (0, R.useSyncExternalStore)(w, T, j),
    D = m(n, { bottom: i, right: a }, { bottom: l || y > 0, right: S || E > 0 }),
    O;
  (t[6] === n
    ? (O = t[7])
...
function P({ conversationId: e, mountedBrowserTabIds: t, panelTabs: n }) {
  ...
  for (let i of n) {
    let n = T(i, e) ?? null;
    n == null || _.isBrowserUseTab(e, n) || t.includes(n) || (F(e, n) && r.add(n));
  }
  return Array.from(r);
}
function F(e, t) {
...
var L, R, z;
e(() => {
  ((L = r()), a(), (R = t(i(), 1)), D(), c(), f(), l(), E(), g(), S(), C(), (z = n()));
})();
