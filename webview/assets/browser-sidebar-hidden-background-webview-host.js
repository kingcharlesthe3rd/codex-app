...
import { i as _ } from "./thread-browser-panel-tabs-CU-ZDBn5.js";
...
function S(e) {
  ...
  let S = (0, b.useSyncExternalStore)(g, v, T),
    O = r(d.tabs$),
    k = r(a),
    A = r(o),
    j,
  ...
  let N = (0, b.useSyncExternalStore)(j, M, w),
    P = _(n, { bottom: i, right: l }, { bottom: m || S > 0, right: k || N > 0 }),
    F;
  (t[6] === n
    ? (F = t[7])
    : ((F = () => p.getBrowserUseBrowserTabIdsKey(n)), (t[6] = n), (t[7] = F)),
    (0, b.useSyncExternalStore)(p.subscribe, F, C));
...
function D({ conversationId: e, mountedBrowserTabIds: t, panelTabs: n }) {
  ...
  for (let i of n) {
    let n = u(i, e) ?? null;
    n == null || p.isBrowserUseTab(e, n) || t.includes(n) || (O(e, n) && r.add(n));
  }
  return Array.from(r);
}
function O(e, t) {
  return p.isBrowserUseTab(e, t) ? !1 : k(e, t) != null;
}
function k(e, t) {
  let n = h(e, t),
    r = m(e, t),
