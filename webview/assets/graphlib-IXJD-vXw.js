import { g as e } from "./merge-1.js";
import { x as t } from "./_baseFor-1.js";
import { S as n, i as r, n as i, r as a } from "./_baseUniq-1.js";
import { t as o } from "./isEmpty-2.js";
import { f as s, p as c, r as l } from "./runtime.worker-2.js";
var u = `\0`,
  d = `\0`,
  f = ``,
  p = class {
    constructor(t = {}) {
      ((this._isDirected = Object.prototype.hasOwnProperty.call(t, `directed`) ? t.directed : !0),
        (this._isMultigraph = Object.prototype.hasOwnProperty.call(t, `multigraph`)
          ? t.multigraph
          : !1),
        ...
        (this._nodes = {}),
        this._isCompound && ((this._parent = {}), (this._children = {}), (this._children[d] = {})),
        (this._in = {}),
        (this._preds = {}),
        (this._out = {}),
        (this._sucs = {}),
    ...
    setNode(e, t) {
      return Object.prototype.hasOwnProperty.call(this._nodes, e)
        ...
        : ((this._nodes[e] = arguments.length > 1 ? t : this._defaultNodeLabelFn(e)),
          this._isCompound &&
            ((this._parent[e] = d), (this._children[e] = {}), (this._children[d][e] = !0)),
          (this._in[e] = {}),
          (this._preds[e] = {}),
          (this._out[e] = {}),
          (this._sucs[e] = {}),
    ...
    setParent(e, t) {
      ...
      if (s(t)) t = d;
        ...
        for (var n = t; !s(n); n = this.parent(n))
          if (n === e) throw Error(`Setting ` + t + ` as parent of ` + e + ` would create a cycle`);
        this.setNode(t);
      }
      return (
        this.setNode(e),
    ...
    filterNodes(e) {
      ...
      function a(e) {
        var r = n.parent(e);
        return r === void 0 || t.hasNode(r) ? ((i[e] = r), r) : r in i ? i[r] : a(r);
      }
      return (
        this._isCompound &&
    ...
    edge(e, t, n) {
      var r =
        arguments.length === 1 ? v(this._isDirected, arguments[0]) : g(this._isDirected, e, t, n);
...
export { p as t };
//# sourceMappingURL=graphlib-IXJD-vXw.js.map
