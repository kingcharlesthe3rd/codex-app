...
import { c as ee, o as c } from "./lib.js";
import { b as l, o as u, y as d } from "./persisted-signal.js";
...
import { n as b } from "./composer-footer.js";
import { n as x, t as S } from "./home-row-layout-CsU-2CyT.js";
import { t as C } from "./with-window.js";
import { t as w } from "./use-is-remote-host.js";
import { t as T } from "./folder.js";
import {
  a as E,
  h as D,
  k as O,
...
import { C as A } from "./sidebar-thread-row-signals-De-atrPX.js";
import { t as le } from "./sidebar-thread-list-signals.js";
import { t as ue } from "./compose.js";
import { a as j, i as M, r as N, t as de } from "./dropdown.js";
import { t as fe } from "./globe.js";
import { t as pe } from "./plus.js";
import { t as me } from "./use-connected-remote-connections.js";
import { p as he, r as ge } from "./local-remote-selection.js";
import { n as _e, t as ve } from "./add-project-menu-items.js";
var ye = `1257656532`,
  be = e(t()),
  P = n(),
  xe = (e) =>
...
function Ce(e) {
  ...
  if (
    ...
    (t[17] === m
      ...
      : ((s = m.formatMessage({
        ...
        (t[18] = s)),
      t[19] !== g || t[20] !== s
        ? ((S = (0, P.jsx)(j, { value: g, onChange: o, placeholder: s, className: `mb-1` })),
          (t[19] = g),
          (t[20] = s),
          (t[21] = S))
        : (S = t[21]),
      ...
      (x = v.map((e) => {
        let t = e.repositoryData?.rootFolder,
          ...
          o = !!e.isCodexWorktree,
          s = a.get(e.label) ?? [],
          ee = s.length > 1 && e.path != null ? ne(e.path, s) : null;
        return (0, P.jsx)(
          `div`,
          {
            className: `flex flex-col`,
            children: (0, P.jsxs)(M, {
              RightIcon: r.includes(e.projectId) ? p : void 0,
              tooltipText: ee ?? void 0,
              tooltipAlign: `center`,
              onSelect: (t) => {
                (f && t.preventDefault(), i(e.projectId));
              },
              children: [
                (0, P.jsx)(N.ItemIcon, {
                  size: `xs`,
                ...
                (0, P.jsxs)(N.Section, {
                  ...
                  children: [
                    ...
                    d
                      ...
                      : null,
                    h ? (0, P.jsx)(M, { LeftIcon: xe, onSelect: s, children: o }) : null,
                  ],
                }),
              ],
            }),
  ...
  let D;
  return (
    t[38] !== S || t[39] !== T || t[40] !== E
      ? ((D = (0, P.jsxs)(P.Fragment, { children: [S, T, E] })),
        (t[38] = S),
        (t[39] = T),
        (t[40] = E),
        (t[41] = D))
...
var we = i(s, ({ get: e }) => {
  let t = e(O),
    n = e(k, { threadKeys: t, enabled: !0 }).groups,
...
function F(e) {
  let t = (0, Se.c)(81),
    ...
    z = k && Oe && !L && Pe.length > 0,
    Le = (e) => {
      u(M, l, {});
      let t = I.find((t) => t.projectId === e);
      if (t == null) return;
      if ((he(M, t), t.projectKind === `remote`)) {
        ce(M, { projectId: t.projectId, projectKind: `remote` });
        return;
      }
      let n = se.select(M, t);
      p?.(n);
  ...
  t[8] !== p || t[9] !== M
    ? ((He = () => {
        (u(M, l, {}), he(M, null), ce(M, null), p?.(null));
      }),
      (t[8] = p),
      (t[9] = M),
      (t[10] = He))
  ...
  let U = H == null && Ae,
    We = Ae && H != null,
    Ge = j === `home` && I.length === 0 && !L;
  if (!ke && Ie && Fe == null && !Ge && Me == null) return null;
  let W =
      H == null
        ? null
        : Ee({ activeProjectId: H, groups: I, remoteConnections: Ne, selectedRemoteProject: je }),
    Ke =
            ...
            (0, P.jsxs)(S, {
              children: [
                (0, P.jsx)(x, {
                  children:
                    U || W == null
                      ? (0, P.jsx)(_e, { className: `icon-xs shrink-0` })
                      : (0, P.jsx)(ge, {
                          isCodexWorktree: !!W?.isCodexWorktree,
                          isGitRepository: W?.repositoryData != null,
                          isRemoteProject: W?.projectKind === `remote`,
                ...
                (0, P.jsx)(b, { collapse: `xs`, className: `max-w-40 truncate`, children: Je }),
              ],
            }),
            (0, P.jsx)(y, {
              className: `icon-2xs shrink-0 text-token-input-placeholder-foreground`,
        ...
        (0, P.jsxs)(`button`, {
          ...
          children: [
            (0, P.jsx)(`span`, {
              ...
              children: (0, P.jsx)(`span`, { className: `min-w-0 truncate`, children: G }),
            }),
            (0, P.jsx)(y, {
  ...
  t[51] === V
    ? (J = t[52])
    : ((J = (e) => {
        F.current && ((F.current = !1), e.preventDefault(), V());
      }),
      (t[51] = V),
      (t[52] = J));
  let nt = j === `hero` ? `center` : `start`,
    Y;
  t[53] !== Qe || t[54] !== tt || t[55] !== q || t[56] !== O || t[57] !== j
    ? ((Y = O ?? (j === `hero` ? tt() : j === `home` ? q() : Qe())),
      (t[53] = Qe),
      (t[54] = tt),
      (t[55] = q),
      (t[56] = O),
  ...
  let at = z ? Ve : void 0,
    Q;
  t[66] !== I || t[67] !== Le || t[68] !== X || t[69] !== it || t[70] !== Z || t[71] !== at
    ? ((Q = (0, P.jsx)(Ce, {
        groups: I,
