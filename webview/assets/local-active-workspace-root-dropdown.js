...
import { Na as t } from "./app-server-manager-signals.js";
import { n, t as r } from "./jsx-runtime.js";
import { t as i } from "./clsx.js";
import { G as a, Q as o, S as s, U as c, X as l, Z as u, wt as d } from "./setting-storage.js";
...
import { n as _ } from "./composer-footer.js";
import { n as v, t as y } from "./home-row-layout.js";
import { t as re } from "./with-window.js";
import { t as b } from "./use-is-remote-host.js";
import { r as x } from "./local-projects.js";
import { i as S, n as C, r as w, t as T } from "./open-project-setup-dialog.js";
import { t as E } from "./folder.js";
import { g as D, l as O, u as k } from "./sidebar-project-group-signals.js";
...
import { a as M, i as N, r as P, t as le } from "./dropdown.js";
...
import { u as he } from "./local-remote-selection.js";
var ge = `1257656532`,
  _e = e(n()),
  F = r(),
  ve = (e) =>
  ...
  if (
    ...
    (n[17] === m
      ...
      : ((c = m.formatMessage({
        ...
        (n[18] = c)),
      n[19] !== g || n[20] !== c
        ? ((S = (0, F.jsx)(M, { value: g, onChange: s, placeholder: c, className: `mb-1` })),
          (n[19] = g),
          (n[20] = c),
          (n[21] = S))
        : (S = n[21]),
      ...
      (n[14] = x),
      (n[15] = S));
  } else ((_ = n[10]), (v = n[11]), (y = n[12]), (b = n[13]), (x = n[14]), (S = n[15]));
  let C;
                ...
                (0, F.jsxs)(P.Section, {
                  ...
                  children: [
                    ...
                    p
                      ...
                      : null,
                    h ? (0, F.jsx)(N, { LeftIcon: ve, onSelect: u, children: l }) : null,
                  ],
                }),
              ],
            }),
...
function I(e) {
  ...
  t[6] === N
    ? (H = t[7])
    : ((H = () => {
        (f(N, { eventName: `codex_app_workspace_root_add_clicked` }), w({ setActive: !0 }));
      }),
      (t[6] = N),
      (t[7] = H));
  let Re = H,
  ...
  let G =
      U == null
        ? null
        : Ce({ activeProjectId: U, groups: L, remoteConnections: je, selectedRemoteProject: ke }),
    Ue =
          ...
          children: [
            (0, F.jsxs)(y, {
              children: [
                ...
                (0, F.jsx)(_, { collapse: `xs`, className: `max-w-40 truncate`, children: Ge }),
              ],
            }),
            (0, F.jsx)(de, {
              className: `icon-2xs shrink-0 text-token-input-placeholder-foreground`,
        ...
        (0, F.jsxs)(`button`, {
          ...
          children: [
            (0, F.jsx)(`span`, {
              ...
              children: (0, F.jsx)(`span`, { className: `min-w-0 truncate`, children: K }),
            }),
            (0, F.jsx)(de, {
  ...
  let rt = z ? Re : void 0,
    Q;
  t[66] !== L || t[67] !== Fe || t[68] !== X || t[69] !== nt || t[70] !== Z || t[71] !== rt
    ? ((Q = (0, F.jsx)(be, {
        groups: L,
