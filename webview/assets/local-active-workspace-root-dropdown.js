...
import { Z as r, c as i, l as a, o, s, t as c } from "./app-scope-CWE-zIhQ.js";
import { n as l } from "./thread-context-inputs.js";
import { ai as u } from "./src.js";
import { l as ee, s as d } from "./lib-1.js";
...
import { n as h } from "./composer-footer.js";
import { D as g } from "./rpc.js";
import { o as re } from "./statsig.js";
import { t as _ } from "./chevron.js";
import { h as v, m as y, t as b } from "./product-logger.js";
import { n as x, t as S } from "./remote-connection-visibility.js";
import { a as C } from "./remote-projects.js";
import { n as w, t as T } from "./home-row-layout.js";
import { t as E } from "./with-window.js";
import { a as D, c as O, r as ie, t as k } from "./sidebar-thread-keys.js";
import { t as ae } from "./use-is-remote-host.js";
import { t as oe } from "./folder.js";
import { a as se, n as ce, r as le, t as ue } from "./open-project-setup-dialog.js";
import { r as de } from "./local-projects.js";
import { t as fe } from "./select-project.js";
import { S as A, d as pe, f as j, w as me } from "./sidebar-project-group-signals.js";
import { C as M, d as N, i as P, n as he, u as ge } from "./sidebar-thread-row-signals-ZqNv-_WT.js";
import { t as _e } from "./compose.js";
import { a as ve, i as F, r as I, t as ye } from "./dropdown.js";
import { t as be } from "./local-project-sources-gate.js";
import { t as xe } from "./globe.js";
import { t as Se } from "./use-connected-remote-connections.js";
import { f as Ce, r as we } from "./local-remote-selection.js";
import { n as Te, t as Ee } from "./add-project-menu-items.js";
var De = [],
  L = [],
  Oe = { allSidebarThreadKeys: L, pinnedThreadKeys: L, unpinnedThreadKeys: L },
  ke = new WeakMap(),
  Ae = i(c, ({ get: e, scope: t }) => {
    let n = z(ke.get(t.node) ?? Oe, V({ get: e, threadKeys: e(A), pinnedThreadIds: e(he) }));
    return (ke.set(t.node, n), n);
  }),
  R = a(
    c,
    (e, { get: t }) =>
              ...
              : [
                  {
                    task: n,
                    isPinned: t(N, e),
                    isAutomationRun: t(ge, e),
                    automationDisplayName: t(P, e),
                  },
                ];
          }),
    { isEqual: je },
...
function z(e, t) {
  let n = B(e.allSidebarThreadKeys, t.allSidebarThreadKeys),
    r = B(e.pinnedThreadKeys, t.pinnedThreadKeys),
    i = B(e.unpinnedThreadKeys, t.unpinnedThreadKeys);
...
function V({ get: e, threadKeys: t, pinnedThreadIds: n }) {
  if (t.length === 0) return Oe;
  let r = new Set(t),
    i = [];
  for (let n of t) O(n)?.kind === `pending-worktree` && e(N, n) && i.push(n);
  for (let e of n) {
    let t = k(u(e));
    if (r.has(t)) {
      i.push(t);
...
function Pe(e) {
    ...
    (t[17] === p
      ...
      (x = v.map((e) => {
        let t = e.repositoryData?.rootFolder,
          ...
          o = !!e.isCodexWorktree,
          s = a.get(e.label) ?? [],
          c = s.length > 1 && e.path != null ? g(e.path, s) : null;
        return (0, H.jsx)(
          `div`,
          {
            className: `flex flex-col`,
            children: (0, H.jsxs)(F, {
              RightIcon: r.includes(e.projectId) ? f : void 0,
              tooltipText: c ?? void 0,
              tooltipAlign: `center`,
              onSelect: (t) => {
                (ne && t.preventDefault(), i(e.projectId));
              },
              children: [
                (0, H.jsx)(I.ItemIcon, {
                  size: `xs`,
      ...
      (t[14] = x),
      (t[15] = S));
  } else ((_ = t[10]), (v = t[11]), (y = t[12]), (b = t[13]), (x = t[14]), (S = t[15]));
  let C;
  t[22] !== te || t[23] !== v.length
    ...
    : (C = t[24]);
  let w;
  t[25] !== _ || t[26] !== b || t[27] !== x || t[28] !== C
    ? ((w = (0, H.jsxs)(_, { className: b, children: [x, C] })),
      (t[25] = _),
      (t[26] = b),
      (t[27] = x),
      (t[28] = C),
                ...
                (0, H.jsxs)(I.Section, {
                  ...
                  children: [
                    ...
                    u
                      ...
                      : null,
                    m ? (0, H.jsx)(F, { LeftIcon: U, onSelect: s, children: o }) : null,
                  ],
                }),
              ],
            }),
  ...
  let D;
  return (
    t[38] !== S || t[39] !== w || t[40] !== T
      ? ((D = (0, H.jsxs)(H.Fragment, { children: [S, w, T] })),
        (t[38] = S),
        (t[39] = w),
        (t[40] = T),
        (t[41] = D))
...
var Fe = i(c, ({ get: e }) => {
  let t = e(A),
    n = e(pe, { threadKeys: t, enabled: !0 }).groups,
    r = new Map(e(R, t).map((e) => [e.task.key, e]));
  return M(e(j), n, r);
});
function Ie(e) {
  let t = (0, Ne.c)(81),
    ...
    ge = n !== void 0,
    ve = !N,
    { selectedRemoteProject: F, selectedRemoteProjectId: De } = C(),
    { remoteConnections: L } = S(),
    Oe = Se(L),
    { data: ke, isLoading: Ae } = s(l),
    R = D && he && !N && Oe.length > 0,
    je = (e) => {
      b(A, v, {});
      let t = M.find((t) => t.projectId === e);
      if (t == null) return;
      if ((Ce(A, t), t.projectKind === `remote`)) {
        fe(A, { projectId: t.projectId, projectKind: `remote` });
        return;
      }
      let n = de.select(A, t);
      u?.(n);
  ...
  t[8] !== u || t[9] !== A
    ? ((Be = () => {
        (b(A, v, {}), Ce(A, null), fe(A, null), u?.(null));
      }),
      (t[8] = u),
      (t[9] = A),
      (t[10] = Be))
  ...
  let G = W == null && ve,
    He = ve && W != null,
    Ue = k === `home` && M.length === 0 && !N;
  if (!ge && Ae && ke == null && !Ue && De == null) return null;
  let K =
      W == null
        ? null
        : Re({ activeProjectId: W, groups: M, remoteConnections: L, selectedRemoteProject: F }),
    We =
            ...
            (0, H.jsxs)(T, {
              children: [
                (0, H.jsx)(w, {
                  children:
                    G || K == null
                      ? (0, H.jsx)(Te, { className: `icon-xs shrink-0` })
                      : (0, H.jsx)(we, {
                          isCodexWorktree: !!K?.isCodexWorktree,
                          isGitRepository: K?.repositoryData != null,
                          isRemoteProject: K?.projectKind === `remote`,
                ...
                (0, H.jsx)(h, { collapse: `xs`, className: `max-w-40 truncate`, children: Ke }),
              ],
            }),
            (0, H.jsx)(_, {
              className: `icon-2xs shrink-0 text-token-input-placeholder-foreground`,
        ...
        (0, H.jsxs)(`button`, {
          ...
          children: [
            (0, H.jsx)(`span`, {
              ...
              children: (0, H.jsx)(`span`, { className: `min-w-0 truncate`, children: q }),
            }),
            (0, H.jsx)(_, {
  ...
  t[51] === U
    ? (Y = t[52])
    : ((Y = (e) => {
        j.current && ((j.current = !1), e.preventDefault(), U());
      }),
      (t[51] = U),
      (t[52] = Y));
  let tt = k === `hero` ? `center` : `start`,
    X;
  t[53] !== Ze || t[54] !== et || t[55] !== J || t[56] !== E || t[57] !== k
    ? ((X = E ?? (k === `hero` ? et() : k === `home` ? J() : Ze())),
      (t[53] = Ze),
      (t[54] = et),
      (t[55] = J),
      (t[56] = E),
  ...
  let it = R ? ze : void 0,
    $;
  t[66] !== M || t[67] !== je || t[68] !== Z || t[69] !== rt || t[70] !== Q || t[71] !== it
    ? (($ = (0, H.jsx)(Pe, {
        groups: M,
        selectedProjectIds: Z,
        onSelectProjectId: je,
...
function Re({ activeProjectId: e, groups: t, remoteConnections: n, selectedRemoteProject: r }) {
