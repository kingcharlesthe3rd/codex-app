import { i as e, r as t, s as n } from "./chunk.js";
import {
  B as r,
  C as i,
  E as a,
...
import { t as k } from "./clone-1.js";
import { c as Se, n as Ce, t as we } from "./reduce.js";
import { t as Te } from "./isEmpty-DCx-s7gD.js";
import { a as Ee, n as De, t as Oe } from "./flatten-CNrC-h2I.js";
import { c as ke, d as Ae, n as je, o as A, r as Me, s as Ne, t as Pe, u as Fe } from "./main.js";
function j(e) {
...
function Re(e) {
  return (
    typeof e == `object` && !!e && j(e.container) && Ie(e.reference) && typeof e.message == `string`
  );
}
var ze = class {
  constructor() {
...
function tt(e, t) {
  ...
  return n && r ? et.Inside : n ? et.OverlapBack : r ? et.OverlapFront : et.Outside;
}
function nt(e, t) {
...
var Mn = class extends ze {
    ...
    getTypeMetaData(e) {
      switch (e) {
        case mt:
          return { name: mt, properties: [{ name: `cardinality` }, { name: `lookahead` }] };
        case gt:
          return { name: gt, properties: [{ name: `elements`, defaultValue: [] }] };
        case _t:
          return { name: _t, properties: [{ name: `elementType` }] };
        case vt:
          return { name: vt, properties: [{ name: `true`, defaultValue: !1 }] };
        case bt:
          return { name: bt, properties: [{ name: `left` }, { name: `right` }] };
        case St:
          return { name: St, properties: [{ name: `left` }, { name: `right` }] };
        case wt:
          return {
            name: wt,
            properties: [
        ...
        case Xt:
          return { name: Xt, properties: [{ name: `types`, defaultValue: [] }] };
        case Zt:
          return {
            name: Zt,
            properties: [
        ...
        case An:
          return { name: An, properties: [{ name: `cardinality` }, { name: `lookahead` }] };
        default:
...
function Nn(e) {
  for (let [t, n] of Object.entries(e))
    t.startsWith(`$`) ||
      (Array.isArray(n)
        ? n.forEach((n, r) => {
            j(n) && ((n.$container = e), (n.$containerProperty = t), (n.$containerIndex = r));
          })
...
function Hn(e, t) {
  ...
  for (let e of n.properties)
    e.defaultValue !== void 0 && r[e.name] === void 0 && (r[e.name] = Un(e.defaultValue));
}
function Un(e) {
...
function ur(e) {
  return Array.prototype.map
    .call(e, (e) => (/\w/.test(e) ? `[${e.toLowerCase()}${e.toUpperCase()}]` : lr(e)))
    .join(``);
}
function dr(e, t) {
  let n = fr(e),
...
function xr(e, t, n, r) {
  ...
  return Be(e) && e.astNode === n ? e.content.flatMap((e) => xr(e, t, n, !1)) : [];
}
function Sr(e, t, n) {
  if (!e) return;
...
function Cr(e, t, n) {
  ...
  do
    if (((i = r.next()), !i.done)) {
      let e = i.value;
      e.astNode === n ? pn(e.grammarSource) && e.grammarSource.value === t && a.push(e) : r.prune();
    }
  while (!i.done);
  return a;
}
...
function Fr(e, t) {
  ...
  if (Tn(e)) {
    ...
    return Hr(Fr(t.definition), { cardinality: e.cardinality, lookahead: e.lookahead });
  ...
  } else if (jn(e)) return Hr(Pr, { cardinality: e.cardinality, lookahead: e.lookahead });
...
function Rr(e) {
  return Hr(`${Pr}*?${Fr(e.terminal)}`, { cardinality: e.cardinality, lookahead: e.lookahead });
}
function zr(e) {
  return Hr(`(?!${Fr(e.terminal)})${Pr}*?`, { cardinality: e.cardinality, lookahead: e.lookahead });
}
function Br(e) {
  return e.right
    ...
    : Hr(Vr(e.left), { cardinality: e.cardinality, lookahead: e.lookahead, wrap: !1 });
}
function Vr(e) {
  return lr(e.value);
}
...
function Qr(e, t, n, r) {
  ...
  if (!s) return c;
  (n && (t = te(t, g(n))),
    r ? ((a = le), (o = !1)) : t.length >= Zr && ((a = se), (o = !1), (t = new me(t))));
  outer: for (; ++i < s; ) {
    var u = e[i],
      d = n == null ? u : n(u);
...
function F(e, t, n) {
  ...
  return r ? ((t = n || t === void 0 ? 1 : xe(t)), Kr(e, t < 0 ? 0 : t, r)) : [];
}
function ei(e, t, n) {
  var r = e == null ? 0 : e.length;
  return r ? ((t = n || t === void 0 ? 1 : xe(t)), (t = r - t), Kr(e, 0, t < 0 ? 0 : t)) : [];
}
function ti(e, t) {
...
function I(e, t, n, r) {
  ...
  var i = e.length;
  return (
    n < 0 && (n = ci(i + n, 0)), E(e) ? n <= i && e.indexOf(t, n) > -1 : !!i && ce(e, t, n) > -1
  );
}
var li = Math.max;
function ui(e, t, n) {
...
function Mi(e) {
  ...
  } else if (e instanceof R) return { type: `Alternative`, definition: t(e.definition) };
  ...
  else if (e instanceof V) return { type: `Repetition`, idx: e.idx, definition: t(e.definition) };
  else if (e instanceof U) return { type: `Alternation`, idx: e.idx, definition: t(e.definition) };
  else if (e instanceof W) {
    let t = { type: `Terminal`, name: e.terminalType.name, label: Ei(e.terminalType), idx: e.idx };
...
function zi(e, t, n) {
  return [
    new z({ definition: [new W({ terminalType: e.separator })].concat(e.definition) }),
  ].concat(t, n);
}
function Bi(e) {
...
function Vi(e) {
  let t = [],
    ...
    a,
    o = !0;
  for (; i && o; ) ((a = n[r]), (o = Fi(a)), (t = t.concat(Bi(a))), (r += 1), (i = n.length > r));
  return xi(t);
}
function Hi(e) {
  ...
  switch (e.type) {
    ...
    case `Alternative`:
      ...
      for (let e = 0; e < r.length; e++) {
        ...
        if ((a.type === `Group` && aa(a) === !1) || (a.type !== `Group` && o === !1)) break;
      }
      break;
    default:
      throw Error(`non exhaustive match!`);
...
function aa(e) {
  let t = e.quantifier;
  return t && t.atLeast === 0 ? !0 : e.value ? (d(e.value) ? ri(e.value, aa) : aa(e.value)) : !1;
}
  ...
  n(`Line Terminator Handling`, () => {
    ...
    ((p = T(r, (e) => !1)),
      t.positionTracking !== `onlyOffset` &&
        (p = T(r, (t) =>
          D(t, `LINE_BREAKS`) ? !!t.LINE_BREAKS : La(t, e) === !1 && sa(e, t.PATTERN),
        )));
  });
  let m, h, g, _;
  n(`Misc Mapping #2`, () => {
  ...
  let t = [],
    n = T(e, (n) =>
      C(
        e,
        (e, r) =>
          n.PATTERN.source === r.PATTERN.source && !I(t, r) && r.PATTERN !== K.NA
            ? (t.push(r), e.push(r), e)
            : e,
        [],
      ),
        ...
        return (
          r === K.NA ||
            (E(r)
              ...
              : mi(r) && Oa(r) && e.push({ str: r.source, idx: n, tokenType: t })),
          e
        );
      },
      [],
    ...
    t &&
      w(a, (e) => {
        ...
        if (t !== !1) {
          ...
          D(e, `LINE_BREAKS`) ? e.LINE_BREAKS === !0 && (i = !0) : sa(o, e.PATTERN) && (i = !0);
      }),
    t &&
      !i &&
      r.push({
...
a boolean 2nd argument is no longer supported`);
    ...
    (n === !0
      ...
      this.TRACE_INIT(`Lexer Constructor`, () => {
        ...
        (this.TRACE_INIT(`Lexer Config handling`, () => {
          ...
          else if (this.config.lineTerminatorCharacters === oo.lineTerminatorCharacters)
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
          ...
          this.config.skipValidations === !1 &&
            (this.TRACE_INIT(`performRuntimeChecks`, () => {
              this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(
                ja(n, this.trackStartLines, this.config.lineTerminatorCharacters),
              );
            }),
            this.TRACE_INIT(`performWarningRuntimeChecks`, () => {
              this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(
                Ma(n, this.trackStartLines, this.config.lineTerminatorCharacters),
              );
            })),
        ...
        if (
          ...
          let e = T(this.lexerDefinitionErrors, (e) => e.message).join(`-----------------------
`);
          throw Error(
...
` + e,
        ...
        (w(this.lexerDefinitionWarning, (e) => {
          ...
          this.TRACE_INIT(`Choosing sub-methods implementations`, () => {
            if (
              (da
                ...
                : ((this.updateLastIndex = S), (this.match = this.matchWithExec)),
              r && (this.handleModes = S),
              this.trackStartLines === !1 && (this.computeNewColumn = v),
              this.trackEndLines === !1 && (this.updateTokenEndLineColumnLocation = S),
          ...
          this.TRACE_INIT(`Failed Optimization Warnings`, () => {
            let e = C(this.canModeBeOptimized, (e, t, n) => (t === !1 && e.push(n), e), []);
...
` + e,
  ...
  tokenizeInternal(e, t) {
    ...
    for (; v < ee; ) {
      ...
      for (n = 0; n < ce; n++) {
        ...
        if (
          (u === !1
            ? me.isCustom === !0
              ? ((g = r.exec(_, v, ne, ae)),
                g === null ? (s = null) : ((s = g[0]), g.payload !== void 0 && (c = g.payload)))
      ...
      if (s !== null) {
        if (
          ...
          while (t === !0);
          e !== 0 &&
            ((ie += e), (b = u - n), this.updateTokenEndLineColumnLocation(p, d, n, e, ie, b, u));
        }
        ...
        if (
          ...
          (h = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(_, t, m, n, i)),
    ...
    return (this.hasCustom || (ne.length = y), { tokens: ne, groups: ae, errors: re });
  }
  handleModes(e, t, n, r) {
    if (e.pop === !0) {
      let i = e.push;
...
inside top level rule: ->` +
  ...
  Eo = {
    buildDuplicateFoundError(e, t) {
      function n(e) {
        return e instanceof W ? e.terminalType.name : e instanceof L ? e.nonTerminalName : ``;
      }
      let r = e.name,
        i = ii(t),
        a = i.idx,
...
For Further details.`),
    ...
    buildDuplicateRuleNameError(e) {
      let t;
      return (
        (t = e.topLevelRule instanceof ki ? e.topLevelRule.name : e.topLevelRule),
  ...
  Ao = class extends ko {
    ...
    walkTerminal(e, t, n) {
      this.isAtEndOfPath &&
        ...
        !this.found &&
        ((this.possibleTokTypes = Bi(new R({ definition: t.concat(n) }))), (this.found = !0));
    }
  },
  jo = class extends Ri {
    constructor(e, t) {
...
function Io(e, t, n = []) {
  ...
  for (; n.length < t && i < e.length; ) {
    ...
    else if (t instanceof B) return o(t.definition.concat([new V({ definition: t.definition })]));
    else if (t instanceof Ai)
      return o([
        new R({ definition: t.definition }),
        new V({ definition: [new W({ terminalType: t.separator })].concat(t.definition) }),
      ]);
    ...
    else if (t instanceof V) r = o(t.definition.concat([new V({ definition: t.definition })]));
...
function Lo(e, t, n, r) {
  let i = `EXIT_NONE_TERMINAL`,
    ...
    u = [],
    d = [];
  for (d.push({ idx: -1, def: e, ruleStack: [], occurrenceStack: [] }); !O(d); ) {
    let e = d.pop();
    if (e === o) {
      s && ye(d).idx <= l && d.pop();
      continue;
    ...
    if (h === i) {
      ...
      let t = k(m);
      t.push(h.idx);
      let n = { idx: f, def: h.definition.concat(a, F(r)), ruleStack: e, occurrenceStack: t };
      d.push(n);
    } else if (h instanceof z) {
      let e = { idx: f, def: F(r), ruleStack: p, occurrenceStack: m };
      (d.push(e), d.push(o));
      let t = { idx: f, def: h.definition.concat(F(r)), ruleStack: p, occurrenceStack: m };
      d.push(t);
    } else if (h instanceof B) {
      let e = new V({ definition: h.definition, idx: h.idx }),
        t = { idx: f, def: h.definition.concat([e], F(r)), ruleStack: p, occurrenceStack: m };
      d.push(t);
      ...
      let t = new V({
        ...
        n = { idx: f, def: h.definition.concat([t], F(r)), ruleStack: p, occurrenceStack: m };
      d.push(n);
      ...
      d.push({ idx: f, def: h.definition.concat(F(r)), ruleStack: p, occurrenceStack: m });
...
function zo(e) {
  ...
  if (e instanceof B || e === `RepetitionMandatory`) return q.REPETITION_MANDATORY;
  if (e instanceof Ai || e === `RepetitionMandatoryWithSeparator`)
    return q.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (e instanceof H || e === `RepetitionWithSeparator`) return q.REPETITION_WITH_SEPARATOR;
    ...
    w(e, (e) => {
      ...
      w(a, (i) => {
        ...
        if (O(_e(c))) {
          ...
          r.push({ message: t, type: J.NO_NON_EMPTY_LOOKAHEAD, ruleName: e.name });
        }
      });
    }),
    r
      ...
      (n, r, a) => (
        t.definition[a].ignoreAmbiguities === !0 ||
          w(r, (r) => {
            let o = [a];
            (w(e, (e, n) => {
              a !== n && $o(e, r) && t.definition[n].ignoreAmbiguities !== !0 && o.push(n);
            }),
              o.length > 1 && !$o(i, r) && (i.push(r), n.push({ alts: o, path: r })));
          }),
        n
      ),
      [],
  ...
  return qr(
    ai(i, (e) => {
      ...
      let a = e.idx,
        o = e.path;
      return T(
        b(i, (e) => t.definition[e.idx].ignoreAmbiguities !== !0 && e.idx < a && es(e.path, o)),
        (e) => {
          let i = [e.idx + 1, a + 1],
            o = t.idx === 0 ? `` : t.idx;
          return {
  ...
  return (
    w(e, (e) => {
      ...
      if (I(i, t)) {
        ...
        r.push({ message: i, type: J.CONFLICT_TOKENS_RULES_NAMESPACE, ruleName: t });
      }
    }),
    r
  );
...
function Ss(e) {
  return (
    (e = ge(e, { errMsgProvider: Eo })), rs(e.rules, e.tokenTypes, e.errMsgProvider, e.grammarName)
  );
}
  ...
  Ls = class {
    initRecoverable(e) {
      ((this.firstAfterRepMap = {}),
        (this.resyncFollows = {}),
        (this.recoveryEnabled = D(e, `recoveryEnabled`) ? e.recoveryEnabled : Tc.recoveryEnabled),
    ...
    flattenFollowSet() {
      return _e(T(this.buildFullFollowKeyStack(), (e) => this.getFollowSetFromFollowKey(e)));
    }
  ...
  Ws = class {
    initLooksAhead(e) {
      ((this.dynamicTokensEnabled = D(e, `dynamicTokensEnabled`)
        ...
        (this.maxLookahead = D(e, `maxLookahead`) ? e.maxLookahead : Tc.maxLookahead),
      ...
      w(e, (e) => {
        this.TRACE_INIT(`${e.name} Rule Lookahead`, () => {
          ...
          (w(t, (t) => {
            ...
            w(n, (t) => {
              this.computeLookaheadFunc(e, t.idx, 768, `Repetition`, t.maxLookahead, Li(t));
            }),
            w(r, (t) => {
              this.computeLookaheadFunc(e, t.idx, 512, `Option`, t.maxLookahead, Li(t));
            }),
            w(i, (t) => {
              this.computeLookaheadFunc(e, t.idx, zs, `RepetitionMandatory`, t.maxLookahead, Li(t));
            }),
            w(a, (t) => {
...
var Zs = `name`;
function Qs(e, t) {
  Object.defineProperty(e, Zs, { enumerable: !1, configurable: !0, writable: !1, value: t });
}
function $s(e, t) {
  let n = y(e),
    r = n.length;
...
var ac = class {
  ...
  oc = class {
    ...
    SKIP_TOKEN() {
      return this.currIdx <= this.tokVector.length - 2 ? (this.consumeToken(), this.LA(1)) : wc;
    }
    LA(e) {
  ...
  sc = class {
    ...
    RULE(e, t, n = Ec) {
      if (I(this.definedRulesNames, e)) {
        let t = {
          message: Eo.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: this.className }),
  ...
  cc = class {
	...
	For Further details.`);
      ...
      if (d(e)) this.tokensMap = C(e, (e, t) => ((e[t.name] = t), e), {});
        ...
        this.tokensMap = C(xi(_e(x(e.modes))), (e, t) => ((e[t.name] = t), e), {});
      ...
      ((this.tokensMap.EOF = xo),
        (this.tokenMatcher = ri(D(e, `modes`) ? _e(x(e.modes)) : x(e), (e) => O(e.categoryMatches))
          ? Ga
          : Wa),
        Ja(x(this.tokensMap)));
    }
    defineRule(e, t, n) {
      ...
      let r = D(n, `resyncEnabled`) ? n.resyncEnabled : Ec.resyncEnabled,
        i = D(n, `recoveryValueFunc`) ? n.recoveryValueFunc : Ec.recoveryValueFunc,
    ...
    atLeastOneInternalLogic(e, t, n) {
      ...
      this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, t], r, zs, e, Po);
    }
    ...
    atLeastOneSepFirstInternalLogic(e, t, n) {
      ...
      if (this.getLaFuncFromCache(n).call(this) === !0) {
        ...
        throw this.raiseEarlyExitException(e, q.REPETITION_MANDATORY_WITH_SEPARATOR, t.ERR_MSG);
    }
    manyInternal(e, t) {
    ...
    manyInternalLogic(e, t, n) {
      ...
      this.attemptInRepetitionRecovery(this.manyInternal, [e, t], r, 768, e, Mo, a);
    }
  ...
  dc = { description: `This Object indicates the Parser is during Recording Phase` };
Object.freeze(dc);
var fc = !0,
  pc = 2 ** 8 - 1,
  ...
  _c = class {
    ...
    subruleInternalRecord(e, t, n) {
      ...
      let r = ye(this.recordingProdStack),
        i = e.ruleName,
        a = new L({ idx: t, nonTerminalName: i, label: n?.LABEL, referencedRule: void 0 });
...
function yc(e, t) {
  ...
  let n = ye(this.recordingProdStack),
    r = d(e) === !1,
    i = r === !1 ? e : e.DEF,
    a = new U({ definition: [], idx: t, ignoreAmbiguities: r && e.IGNORE_AMBIGUITIES === !0 });
  return (
...
var Sc = class {
  initPerformanceTracer(e) {
    ...
    } else ((this.traceInitMaxIdent = 0), (this.traceInitPerf = Tc.traceInitPerf));
    this.traceInitIndent = -1;
  }
  TRACE_INIT(e, t) {
    if (this.traceInitPerf === !0) {
...
`)}`,
  ...
  constructor(e, t) {
	...
	For further details.`);
    this.skipValidations = D(t, `skipValidations`) ? t.skipValidations : Tc.skipValidations;
  }
};
((Oc.DEFER_DEFINITION_ERRORS_HANDLING = !1), Cc(Oc, [Ls, Ws, ac, oc, cc, sc, lc, uc, _c, Sc]));
...
function zc(e, t, n) {
  let r = X(e, t, n, { type: 5 });
  return (Jc(e, r), Kc(e, t, n, Yc(e, t, r, n, Wc(e, t, n)), Qc(e, t, n.separator, n)));
}
function Bc(e, t, n) {
...
function Vc(e, t, n) {
  let r = X(e, t, n, { type: 4 });
  return (Jc(e, r), Gc(e, t, n, Yc(e, t, r, n, Wc(e, t, n)), Qc(e, t, n.separator, n)));
}
function Hc(e, t, n) {
...
function Gc(e, t, n, r, i) {
  ...
  return (
    (a.loopback = s),
    (c.loopback = s),
    (e.decisionMap[Ac(t, i ? `RepetitionMandatoryWithSeparator` : `RepetitionMandatory`, n.idx)] =
      s),
    Y(o, s),
...
function Kc(e, t, n, r, i) {
  ...
  return (
    ...
    (e.decisionMap[Ac(t, i ? `RepetitionWithSeparator` : `Repetition`, n.idx)] = s),
    { left: s, right: c }
  );
}
function qc(e, t, n, r) {
  ...
  ll = class extends Us {
    ...
    buildLookaheadForAlternation(e) {
      let { prodOccurrence: t, rule: n, hasPredicates: r, dynamicTokensEnabled: i } = e,
        ...
        l = Ee(Bo({ maxLookahead: 1, occurrence: t, prodType: `Alternation`, rule: n }), (e) =>
          Ee(e, (e) => e[0]),
        );
      if (ul(l, !1) && !i) {
        let e = we(
    ...
    buildLookaheadForOptional(e) {
      let { prodOccurrence: t, rule: n, prodType: r, dynamicTokensEnabled: i } = e,
        ...
        s = Ac(n, r, t),
        c = this.atn.decisionMap[s].decision,
        l = Ee(Bo({ maxLookahead: 1, occurrence: t, prodType: r, rule: n }), (e) =>
          Ee(e, (e) => e[0]),
        );
      if (ul(l) && l[0][0] && !i) {
        let e = l[0],
...
function pl(e, t, n, r) {
  ...
  for (;;) {
    let t = yl(i, s);
    if ((t === void 0 && (t = ml.apply(this, [e, i, s, a, n, r])), t === rl)) return vl(o, i, s);
...
function El(e) {
  ...
  for (let r = 0; r < n; r++) Dl({ state: e.transitions[r].target, alt: r, stack: [] }, t);
  return t;
}
function Dl(e, t) {
  let n = e.state;
...
var Ul = `​`,
  ...
  Kl = class extends Gl {
    ...
    rule(e, t) {
      let n = this.computeRuleType(e),
        r = this.wrapper.DEFINE_RULE(Wl(e.name), this.startImplementation(n, t).bind(this));
    ...
    consume(e, t, n) {
      ...
      if (!this.isRecording() && this.isValidToken(r)) {
        ...
        if (i) {
          ...
          let e = r.image;
          (pn(n) || (e = this.converter.convert(e, t).toString()), (o.value += e));
        }
      }
    }
    isValidToken(e) {
    ...
    construct() {
      ...
      return (
        ...
        this.stack.pop(),
        Hl(e) ? this.converter.convert(e.value, e.$cstNode) : (Hn(this.astReflection, e), e)
      );
    }
    getAssignment(e) {
      if (!this.assignmentMap.has(e)) {
        let t = Pn(e, nn);
        this.assignmentMap.set(e, { assignment: t, isCrossRef: t ? sn(t.terminal) : !1 });
      }
  ...
  Yl = class extends Gl {
    ...
    rule(e, t) {
      let n = this.wrapper.DEFINE_RULE(Wl(e.name), this.startImplementation(t).bind(this));
...
function lu(e, t, n = t.terminal) {
  if (!n) {
    ...
    if (!n) throw Error(`Could not find name assignment for type: ` + Ar(t.type.ref));
    return lu(e, t, n);
...
function pu(e, t) {
  ...
  if (e.ruleNames.has(t)) return e.ruleNames.get(t);
  {
    let n = t,
      ...
      i = t.$type;
    for (; !Rt(r); )
      ((dn(r) || en(r) || Dn(r)) && (i = r.elements.indexOf(n).toString() + `:` + i),
        (n = r),
        (r = r.$container));
...
var vu = class {
    ...
    buildTokens(e, t) {
      ...
      return (
        r.forEach((e) => {
          let t = e.PATTERN;
          typeof t == `object` && t && `test` in t && cr(t) ? i.unshift(e) : i.push(e);
        }),
        i
      );
    }
...
async function Du(e) {
  ...
  if ((t - Su >= Cu && ((Su = t), await xu(), (Su = performance.now())), e.isCancellationRequested))
    throw Tu;
}
var Ou = class {
    constructor() {
  ...
  ((() => {
    ...
    class c {
      ...
      static parse(e, t = !1) {
        let n = s.exec(e);
        return n
          ? new u(n[2] || ``, ee(n[4] || ``), ee(n[5] || ``), ee(n[7] || ``), ee(n[9] || ``), t)
          : new u(``, ``, ``, ``, ``);
      }
      static file(t) {
        let n = ``;
    ...
    function h(e, t) {
      ...
      return (
        s && ((r += `?`), (r += n(s, !1, !1))), c && ((r += `#`), (r += t ? c : f(c, !1, !1))), r
      );
    }
    function g(e) {
      try {
...
var Nu = class {
    ...
    fromTextDocument(e, t, n) {
      return (
        (t ??= Au.parse(e.uri)),
        Z.CancellationToken.is(n) ? this.createAsync(t, e, n) : this.create(t, e, n)
      );
    }
    fromString(e, t, n) {
    ...
    createTextDocumentGetter(e, t) {
      let n = this.serviceRegistry,
        r;
      return () =>
        (r ??= Pe.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, t ?? ``));
    }
  },
  Pu = class {
    constructor(e) {
  ...
  Iu = class {
    ...
    async link(e, t = Z.CancellationToken.None) {
      for (let n of zn(e.parseResult.value)) (await Du(t), Vn(n).forEach((t) => this.doLink(t, e)));
    }
    doLink(e, t) {
      let n = e.reference;
      if (n._ref === void 0) {
...
var Ru = class {
  ...
  zu = class {
    ...
    findDeclaration(e) {
      if (e) {
        ...
        if (t && n) {
          ...
          if (Array.isArray(r)) {
            for (let t of r)
              if (Ie(t) && t.$refNode && t.$refNode.offset <= e.offset && t.$refNode.end >= e.end)
                return t.ref;
          }
        }
        if (n) {
    ...
    findReferences(e, t) {
      ...
      return (
        t.documentUri && (r = r.filter((e) => Mu.equals(e.sourceUri, t.documentUri))),
        n.push(...r),
        M(n)
      );
    }
  ...
  Yu = class {
    ...
    getScope(e) {
      ...
      if (r) {
        ...
        do {
          let e = r.get(i);
          (e.length > 0 && t.push(M(e).filter((e) => this.reflection.isSubtype(e.type, n))),
            (i = i.$container));
        } while (i);
      }
    ...
    getGlobalScope(e, t) {
      return this.globalScopeCache.get(e, () => new Wu(this.indexManager.allElements(e)));
    }
  };
function Xu(e) {
...
var Qu = class {
    ...
    reviveReference(e, t, n, r, i) {
      ...
      if (r.$ref) {
        ...
        if (j(e)) return ((a ||= this.nameProvider.getName(e)), { $refText: a ?? ``, ref: e });
        o = e;
      }
      if (o) {
        let n = { $refText: a ?? `` };
    ...
    async validateDocument(e, t = {}, n = Z.CancellationToken.None) {
      ...
      if (
        ...
        (!t.categories || t.categories.includes(`built-in`)) &&
          ...
          (t.stopAfterLexingErrors && i.some((e) => e.data?.code === sd.LexingError)) ||
            (this.processParsingErrors(r, i, t),
            t.stopAfterParsingErrors && i.some((e) => e.data?.code === sd.ParsingError)) ||
            (this.processLinkingErrors(e, i, t),
            t.stopAfterLinkingErrors && i.some((e) => e.data?.code === sd.LinkingError))))
      )
        return i;
      try {
...
function id(e) {
  ...
  return (
    typeof e.property == `string`
      ...
      : typeof e.keyword == `string` && (t = Sr(e.node.$cstNode, e.keyword, e.index)),
    (t ??= e.node.$cstNode),
...
var md = class {
      ...
      for (let n of e) {
        ...
        if (n.state === Q.Validated) {
          if (typeof t.validation == `boolean` && t.validation)
            ((n.state = Q.IndexedReferences), (n.diagnostics = void 0), this.buildState.delete(e));
          else if (typeof t.validation == `object`) {
            let r = this.buildState.get(e),
              i = r?.result?.validationChecks;
            if (i) {
              let a = (t.validation.categories ?? td.all).filter((e) => !i.includes(e));
              a.length > 0 &&
                (this.buildState.set(e, {
                  completed: !1,
                  options: {
                    validation: Object.assign(Object.assign({}, t.validation), { categories: a }),
                  },
                  result: r.result,
                }),
    ...
    async update(e, t, n = Z.CancellationToken.None) {
      ...
      let i = this.sortDocuments(
        this.langiumDocuments.all
          .filter((e) => e.state < Q.Linked || !this.buildState.get(e.uri.toString())?.completed)
          .toArray(),
      );
    ...
    async buildDocuments(e, t, n) {
      (this.prepareBuild(e, t),
        await this.runCancelable(e, Q.Parsed, n, (e) => this.langiumDocumentFactory.update(e, n)),
    ...
    async runCancelable(e, t, n, r) {
      ...
      for (let e of i)
        (await Du(n), await r(e), (e.state = t), await this.notifyDocumentPhase(e, t, n));
...
function Cd(e, t, n) {
  ...
  let a = Td(e),
    o = Vd(r);
  return Pd({ index: 0, tokens: Od({ lines: a, position: i, options: o }), position: i });
}
function wd(e, t) {
  let n = Vd(t),
    r = Td(e);
    ...
    for (let o of e) {
      ...
      if (
        (i.push({
          type: `inline-tag`,
          content: l,
          range: Ne.create(A.create(n, a + c + r), A.create(n, a + c + l.length + r)),
        }),
        (c += l.length),
        o.length === 4)
      ) {
        ...
        i.push({
          type: `text`,
          content: e,
          range: Ne.create(A.create(n, a + c + r), A.create(n, a + c + e.length + r)),
        });
      } else
        i.push({
          type: `text`,
...
function zd(e, t) {
  ...
  if (e.tokens[e.index]?.type === `text`)
    if (t) {
      let i = Bd(e);
      return new Wd(r, new qd([i], i.range), t, Ne.create(n.range.start, i.range.end));
    } else {
      let i = Ld(e);
...
var Xd = class {
  ...
  Zd = class {
    ...
    getComment(e) {
      return Xu(e) ? e.$comment : it(e.$cstNode, this.grammarConfig().multilineCommentRules)?.text;
    }
  },
  Qd = class {
    constructor(e) {
  ...
  ef = class {
    ...
    createGrammarElementIdMap() {
      let e = 0;
      for (let t of zn(this.grammar)) ht(t) && this.grammarElementIdMap.set(t, e++);
    }
  };
function tf(e) {
  return {
    documentation: { CommentProvider: (e) => new Zd(e), DocumentationProvider: (e) => new Xd(e) },
    parser: {
    ...
    serializer: { Hydrator: (e) => new ef(e), JsonSerializer: (e) => new Qu(e) },
    validation: { DocumentValidator: (e) => new rd(e), ValidationRegistry: (e) => new nd(e) },
    shared: () => e.shared,
  };
}
function nf(e) {
  ...
  rp = class extends ze {
    ...
    getTypeMetaData(e) {
      switch (e) {
        ...
        case xf:
          return { name: xf, properties: [{ name: `label` }, { name: `name` }] };
        case Sf:
          return { name: Sf, properties: [{ name: `name` }, { name: `order` }] };
        case wf:
        ...
        case Ef:
          return { name: Ef, properties: [{ name: `className` }, { name: `styleText` }] };
        case Df:
          return {
            name: Df,
            properties: [
        ...
        case jf:
          return { name: jf, properties: [{ name: `axis` }, { name: `value` }] };
        case Mf:
          return {
            name: Mf,
            properties: [
        ...
        case Lf:
          return { name: Lf, properties: [{ name: `classSelector` }, { name: `name` }] };
        case Rf:
        ...
        case Vf:
          return { name: Vf, properties: [{ name: `name` }, { name: `value`, defaultValue: !1 }] };
        case Hf:
          return {
            name: Hf,
            properties: [
        ...
        case qf:
          return { name: qf, properties: [{ name: `label` }, { name: `value` }] };
        case Yf:
          return {
            name: Yf,
            properties: [
        ...
        case $f:
          return { name: $f, properties: [{ name: `indent` }, { name: `item` }] };
        case ep:
          return {
            name: ep,
            properties: [
        ...
        case np:
          return { name: np, properties: [{ name: `classSelector` }, { name: `name` }] };
        default:
          return { name: e, properties: [] };
      }
    }
