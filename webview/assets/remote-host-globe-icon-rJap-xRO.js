...
function y(e) {
  let t = (0, _.c)(11),
    ...
    l;
  t[0] !== o || t[1] !== s
    ? ((l = s.includes(o) ? s : [o, ...s]), (t[0] = o), (t[1] = s), (t[2] = l))
    : (l = t[2]);
  let u = l,
    d;
  t[3] !== c || t[4] !== u ? ((d = h(u, c)), (t[3] = c), (t[4] = u), (t[5] = d)) : (d = t[5]);
  let f = d[o],
    p;
  ...
  return (
    t[8] !== r || t[9] !== p
      ? ((m = (0, v.jsx)(i, { className: r, style: p })), (t[8] = r), (t[9] = p), (t[10] = m))
      : (m = t[10]),
    m
  );
}
export { h as n, a as r, y as t };
//# sourceMappingURL=remote-host-globe-icon-rJap-xRO.js.map
