...
function ut(e) {
  if (!e.isEnabled) return String(Tt[0]);
  let t = Ct(e.rechargeTarget ?? ``);
  return t.kind === `valid` ? String(t.value) : String(Tt[0]);
}
function dt(e) {
  if (!e.isEnabled) return `125`;
  let t = Ct(e.rechargeThreshold ?? ``);
  return t.kind === `valid` ? String(t.value) : `125`;
}
function ft(e) {
  return e.isEnabled ? (e.rechargeMonthlyLimit == null ? `` : St(e.rechargeMonthlyLimit)) : ``;
}
function pt(e) {
  let t = Ct(e);
  switch (t.kind) {
...
function mt({ minimumBalance: e, targetBalance: t }) {
  let n = pt(t);
  if (n != null) return n;
  let r = Ct(e),
    i = Ct(t);
...
function ht(e) {
  ...
  let t = e.amountPerCredit * 10 ** e.minorUnitExponent,
    n = Math.ceil(Et / t);
  return Math.max(250, wt(n, 250));
}
function gt({ value: e, pricingInfo: t }) {
  let n = Ct(e);
  switch (n.kind) {
    case `missing`:
      return `missing`;
    case `invalid`:
      return `not-whole-number`;
    case `valid`:
      return n.value < ht(t) ? `below-minimum` : n.value % 250 == 0 ? null : `invalid-increment`;
  }
}
function _t({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r }) {
  let i = vt({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r });
  if (i == null) return null;
  let a = Math.round(i);
  return Math.abs(i - a) > 1e-6 ? null : String(a);
}
function vt({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r }) {
  let i = St(e)
    .replaceAll(n, ``)
    .replaceAll(r, `.`)
    .replace(/[^\d.]/g, ``);
...
function yt({ monthlyLimit: e, targetBalance: t }) {
  let n = Ct(e),
    r = Ct(t);
  switch (n.kind) {
    case `missing`:
...
function bt({ minimumBalance: e, targetBalance: t, monthlyLimit: n }) {
  if (
    pt(e) != null ||
    mt({ minimumBalance: e, targetBalance: t }) != null ||
    yt({ monthlyLimit: n, targetBalance: t }) != null
  )
    return null;
  let r = Number.parseInt(St(e), 10),
    i = Number.parseInt(St(t), 10),
    a = St(n);
  return {
...
function xt({ isEnabled: e, serverState: t, savePayload: n }) {
  return e
    ? n == null
      ? null
      : t.isEnabled
...
var Tt,
  Et,
  Dt = e(() => {
    ((Tt = [500, 1e3, 2e3]), (Et = 1e3));
  });
function Ot({ intl: e, creditQuantity: t, pricingInfo: n }) {
...
function kt({ intl: e, creditQuantity: t, pricingInfo: n }) {
  let r = Nt({ intl: e, amount: t * n.amountPerCredit, pricingInfo: n });
  return r == null
    ? null
    : r
...
function At({ intl: e, pricingInfo: t }) {
  return (
    Nt({ intl: e, amount: 0, pricingInfo: t })?.find((e) => e.type === `currency`)?.value ?? null
  );
}
function jt({ intl: e, creditQuantity: t, pricingInfo: n }) {
...
function Mt({ intl: e, creditBalance: t, rechargeTarget: n, pricingInfo: r }) {
  let i = Number.parseInt(St(n), 10);
  if (!Number.isFinite(i)) return null;
  let a = Math.max(0, Math.floor(Number(t ?? 0))),
    o = Math.max(0, i - a);
  return o === 0 ? null : Ot({ intl: e, creditQuantity: o, pricingInfo: r });
}
function Nt({ intl: e, amount: t, pricingInfo: n }) {
  return Number.isFinite(t)
    ? e.formatters
...
function Ft(e) {
  let t = (0, Ut.c)(41),
    ...
    p;
  t[0] === r ? (p = t[1]) : ((p = St(r)), (t[0] = r), (t[1] = p));
  let m = p,
    h = i === `preset`,
    g;
        ...
        : (0, Y.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, Y.jsx)(It, {
                ...
                value: r,
                pricingInfo: a,
                placeholder: kt({ intl: n, creditQuantity: s, pricingInfo: a }) ?? ``,
                hasError: o != null,
  ...
  t[33] !== o || t[34] !== s || t[35] !== c
    ? ((T =
        o == null ? null : (0, Y.jsx)(Lt, { fieldError: o, minimumQuantity: s, quantityStep: c })),
      (t[33] = o),
      (t[34] = s),
      (t[35] = c),
      (t[36] = T))
...
function It(e) {
  ...
  if (t[0] !== p || t[1] !== n || t[2] !== i || t[3] !== f || t[4] !== r) {
    let e = f
      ? kt({ intl: n, creditQuantity: Number.parseInt(St(r), 10), pricingInfo: i })
      : jt({ intl: n, creditQuantity: Number.parseInt(St(r), 10), pricingInfo: i });
    ((_ = p ?? e ?? r),
      (g = f && _.length > 0 ? At({ intl: n, pricingInfo: i }) : null),
      (h = zt({ intl: n, value: _, pricingInfo: i })),
      (v = Bt({ intl: n, value: _, pricingInfo: i })),
      (t[0] = p),
      (t[1] = n),
      (t[2] = i),
      (t[3] = f),
  ...
  t[17] !== n || t[18] !== l || t[19] !== u || t[20] !== i
    ? ((w = (e) => {
        ...
        if (!Ht({ intl: n, value: t, pricingInfo: i })) return;
        m(t);
        let r = zt({ intl: n, value: t, pricingInfo: i });
  ...
  return (
    t[35] !== D || t[36] !== T || t[37] !== E
      ? ((O = (0, Y.jsxs)(`div`, { className: `relative`, children: [T, E, D] })),
        (t[35] = D),
        (t[36] = T),
        (t[37] = E),
        (t[38] = O))
...
function Rt(e) {
  let t = (0, Ut.c)(18),
    ...
    s;
  t[0] !== n || t[1] !== a || t[2] !== r
    ? ((s = jt({ intl: a, creditQuantity: n, pricingInfo: r })),
      (t[0] = n),
      (t[1] = a),
      (t[2] = r),
      (t[3] = s))
...
function zt({ intl: e, value: t, pricingInfo: n }) {
  let r = t.trim();
  if (r.length === 0) return ``;
  let { groupSeparator: i, decimalSeparator: a } = Vt({ intl: e, pricingInfo: n });
  return _t({ value: r, pricingInfo: n, groupSeparator: i, decimalSeparator: a });
}
function Bt({ intl: e, value: t, pricingInfo: n }) {
  let r = t.trim();
  if (r.length === 0) return null;
  let { groupSeparator: i, decimalSeparator: a } = Vt({ intl: e, pricingInfo: n });
  return vt({ value: r, pricingInfo: n, groupSeparator: i, decimalSeparator: a });
}
function Vt({ intl: e, pricingInfo: t }) {
  let n = e.formatters
    .getNumberFormat(e.locale, {
      style: `currency`,
...
function Ht({ intl: e, value: t, pricingInfo: n }) {
  let { groupSeparator: r, decimalSeparator: i } = Vt({ intl: e, pricingInfo: n }),
    a = At({ intl: e, pricingInfo: n }),
    o = 0;
  for (let e of t)
    if (
...
function Kt(e) {
  ...
  t[12] === o
    ? (S = t[13])
    : ((S = o == null ? null : (0, Jt.jsx)(Lt, { fieldError: o })), (t[12] = o), (t[13] = S));
  let C;
  t[14] !== x || t[15] !== S
    ? ((C = (0, Jt.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [v, x, S] })),
      (t[14] = x),
      (t[15] = S),
      (t[16] = C))
    : (C = t[16]);
  ...
  t[33] === s
    ? (A = t[34])
    : ((A = s == null ? null : (0, Jt.jsx)(Lt, { fieldError: s })), (t[33] = s), (t[34] = A));
  let j;
  t[35] !== k || t[36] !== A
    ? ((j = (0, Jt.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [T, k, A] })),
      (t[35] = k),
      (t[36] = A),
      (t[37] = j))
    : (j = t[37]);
  ...
  return (
    t[43] !== j || t[44] !== M || t[45] !== C
      ? ((N = (0, Jt.jsxs)(Jt.Fragment, { children: [C, j, M] })),
        (t[43] = j),
        (t[44] = M),
        (t[45] = C),
        (t[46] = N))
...
function Xt(e) {
  let t = (0, hn.c)(39),
    { source: r, creditDetails: i, pricingInfo: a, onOpenChange: o, dialogDescriptionId: s } = e,
    c = l(n),
    { email: u } = de(),
    d = Ne(),
    f = Fe(),
    [p, m] = (0, gn.useState)(String(Tt[0])),
    [h, g] = (0, gn.useState)(`preset`),
    [_, v] = (0, gn.useState)(!1),
    [y, b] = (0, gn.useState)(!1),
    S;
  t[0] !== y || t[1] !== a || t[2] !== p
    ? ((S = y ? `invalid-currency-amount` : gt({ value: p, pricingInfo: a })),
      (t[0] = y),
      (t[1] = a),
      (t[2] = p),
      (t[3] = S))
  ...
  t[8] === j
    ...
    : ((N = (0, X.jsx)(z, {
      ...
      (t[9] = N));
  let P;
  t[10] !== i || t[11] !== f || t[12] !== a || t[13] !== N
    ? ((P = (0, X.jsx)(ln, { intl: f, creditDetails: i, pricingInfo: a, actions: N })),
      (t[10] = i),
      (t[11] = f),
      (t[12] = a),
      (t[13] = N),
  ...
  t[21] !== d
    ? ((F = () => {
        (v(!0),
          w ??
            dn({ scope: c, source: r, email: u, quantity: p, onOpenChange: o, statsigClient: d }));
      }),
      (t[15] = u),
      (t[16] = o),
      (t[17] = p),
  ...
  let I = _ ? w : null,
    L;
  t[23] === a ? (L = t[24]) : ((L = ht(a)), (t[23] = a), (t[24] = L));
  let R;
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ee = t[26]);
  let B;
  t[27] !== h || t[28] !== f || t[29] !== a || t[30] !== p || t[31] !== I || t[32] !== L
    ? ((B = (0, X.jsx)(C, {
...
function Qt(e) {
  let t = (0, hn.c)(153),
    ...
    v = Fe(),
    y;
  t[0] === a ? (y = t[1]) : ((y = ut(a)), (t[0] = a), (t[1] = y));
  let b = y,
    [x, S] = (0, gn.useState)(b),
    [w, T] = (0, gn.useState)(pn(b) ? `preset` : `custom`),
    E;
  t[2] === a ? (E = t[3]) : ((E = dt(a)), (t[2] = a), (t[3] = E));
  let [D, O] = (0, gn.useState)(E),
    k;
  t[4] === a ? (k = t[5]) : ((k = () => ft(a)), (t[4] = a), (t[5] = k));
  let [A, j] = (0, gn.useState)(k),
    M;
  t[6] !== _ || t[7] !== i
    ? ((M = () => i !== `add-credits` || !je(_, `2317709095`)), (t[6] = _), (t[7] = i), (t[8] = M))
    : (M = t[8]);
  let [N, P] = (0, gn.useState)(M),
    [F, I] = (0, gn.useState)(!1),
    [R, ee] = (0, gn.useState)(!1),
    [z, B] = (0, gn.useState)(!1),
    [te, V] = (0, gn.useState)(!1),
    [H, ne] = (0, gn.useState)(!1),
    [re, ie] = (0, gn.useState)(!1),
    [ae, oe] = (0, gn.useState)(!1),
    [se, U] = (0, gn.useState)(null),
    ce = c.isPending || d.isPending,
    le = f.isPending,
    W = ce || le,
    G = i === `add-credits` && !N,
    ue;
  t[9] !== te || t[10] !== G || t[11] !== D || t[12] !== s || t[13] !== x
    ? ((ue = te
        ? `invalid-currency-amount`
        : G
          ? gt({ value: x, pricingInfo: s })
          : mt({ minimumBalance: D, targetBalance: x })),
      (t[9] = te),
      (t[10] = G),
      (t[11] = D),
      (t[12] = s),
  ...
  let fe = ue,
    K;
  t[15] !== H || t[16] !== D
    ? ((K = H ? `invalid-currency-amount` : pt(D)), (t[15] = H), (t[16] = D), (t[17] = K))
    : (K = t[17]);
  let pe = K,
    me;
  t[18] !== re || t[19] !== A || t[20] !== x
    ? ((me = re ? `invalid-currency-amount` : yt({ monthlyLimit: A, targetBalance: x })),
      (t[18] = re),
      (t[19] = A),
      (t[20] = x),
      (t[21] = me))
  ...
  let he = me,
    q,
    _e;
  t[22] !== H || t[23] !== re || t[24] !== D || t[25] !== A || t[26] !== a || t[27] !== x
    ? ((q = H || re ? null : bt({ minimumBalance: D, targetBalance: x, monthlyLimit: A })),
      (_e = xt({ isEnabled: !0, serverState: a, savePayload: q })),
      (t[22] = H),
      (t[23] = re),
      (t[24] = D),
      (t[25] = A),
  ...
  t[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ce = [`usage-settings`, `credit-reload`, `manage-payment`]), (t[31] = Ce))
    : (Ce = t[31]);
  let we;
  t[32] !== v || t[33] !== h
    ? ((we = {
  ...
  t[50] !== d
    ? ((Ee = async () => {
        if ((I(!0), G)) {
          fe ??
            dn({ scope: h, source: r, email: g, quantity: x, onOpenChange: p, statsigClient: _ });
          return;
        }
        if ((ee(!0), B(!0), !(ve == null || W)))
          try {
            if ((Se(), q == null)) return;
            let e = ve === `enable` ? await c.mutateAsync(q) : await d.mutateAsync(q);
            if ((ge(h, De, { action: ve, source: r }), We(e.immediate_top_up_status))) {
              (oe(!0),
                U(
                  Mt({
                    intl: v,
                    creditBalance: o?.balance,
                    rechargeTarget: q.recharge_target,
                    pricingInfo: s,
                  }),
                ));
              return;
            }
            (fn({ scope: h, intl: v, intent: ve, kind: `success` }), p(!1));
          } catch {
            fn({ scope: h, intl: v, intent: ve, kind: `danger` });
          }
      }),
      (t[35] = o),
      (t[36] = g),
  ...
  let Oe = Ee,
    ke;
  t[52] !== f || t[53] !== v || t[54] !== p || t[55] !== h || t[56] !== r
    ? ((ke = async () => {
        try {
          (await f.mutateAsync(),
            ge(h, De, { action: `disable`, source: r }),
            fn({ scope: h, intl: v, intent: `disable`, kind: `success` }),
            p(!1));
        } catch {
          fn({ scope: h, intl: v, intent: `disable`, kind: `danger` });
        }
      }),
      (t[52] = f),
      (t[53] = v),
  ...
  bb0: switch (i) {
    ...
    case `setup-auto-reload`: {
      ...
      (t[61] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        (Me = e));
      let n;
      (t[62] !== v || t[63] !== D || t[64] !== A || t[65] !== s || t[66] !== x
        ? ((n = (0, X.jsx)(an, {
            intl: v,
            targetBalance: x,
            minimumBalance: D,
        ...
        (Pe = n));
      let r;
      (t[68] !== v || t[69] !== D || t[70] !== A || t[71] !== s || t[72] !== x
        ? ((r = (0, X.jsx)(an, {
            intl: v,
            targetBalance: x,
            minimumBalance: D,
    ...
    case `manage-auto-reload`: {
      ...
      (t[74] === Symbol.for(`react.memo_cache_sentinel`)
        ...
        (Me = e));
      let n;
      (t[75] !== v || t[76] !== D || t[77] !== A || t[78] !== s || t[79] !== x
        ? ((n = (0, X.jsx)(an, {
            intl: v,
            targetBalance: x,
            minimumBalance: D,
        ...
        (Pe = n));
      let r;
      (t[81] !== v || t[82] !== D || t[83] !== A || t[84] !== s || t[85] !== x
        ? ((r = (0, X.jsx)(an, {
            intl: v,
            targetBalance: x,
            minimumBalance: D,
  ...
  t[96] !== i
    ? ((ze = (0, X.jsx)(nn, {
        ...
        isDisablePending: le,
        isActionPending: W,
        isAddCreditsSubmitDisabled: ye,
        isAutoReloadSettingsSubmitDisabled: be,
        onTurnOff: Le,
      })),
      (t[89] = W),
      (t[90] = ye),
    ...
    : (ze = t[97]);
  let Be;
  t[98] !== o || t[99] !== v || t[100] !== s || t[101] !== ze
    ? ((Be = (0, X.jsx)(ln, { intl: v, creditDetails: o, pricingInfo: s, actions: ze })),
      (t[98] = o),
      (t[99] = v),
      (t[100] = s),
      (t[101] = ze),
  ...
  let He = F ? fe : null,
    Ue;
  t[105] !== G || t[106] !== s
    ? ((Ue = G ? ht(s) : 125), (t[105] = G), (t[106] = s), (t[107] = Ue))
    : (Ue = t[107]);
  let Ge = G ? 250 : null,
    Ke,
    qe;
  ...
  t[117] !== x
    ? ((Ye = (0, X.jsx)(Ft, {
        ...
        onInvalidCurrencyDraftChange: V,
        onBlur: Je,
      })),
      (t[111] = w),
      (t[112] = v),
  ...
  t[139] !== z
    ? ((Ze = G
        ...
        : (0, X.jsx)(Kt, {
            ...
            monthlyLimit: A,
            pricingInfo: s,
            minimumBalanceError: R ? pe : null,
            monthlyLimitError: z ? he : null,
            hasImmediateTopUpFailure: ae,
            immediateTopUpFailureAmount: se,
            isManagePaymentPending: Te.isPending,
            onMinimumBalanceChange: (e) => {
              (Se(), O(e));
            },
            onInvalidMinimumBalanceCurrencyDraftChange: ne,
            ...
            onInvalidMonthlyLimitCurrencyDraftChange: ie,
            onMonthlyLimitBlur: () => {
              B(!0);
            },
            onOpenManagePayment: () => {
  ...
  t[141] !== Ye || t[142] !== Xe || t[143] !== Ze
    ? ((Qe = (0, X.jsxs)(C, { className: `gap-4 pt-4`, children: [Ye, Xe, Ze] })),
      (t[141] = Ye),
      (t[142] = Xe),
      (t[143] = Ze),
      (t[144] = Qe))
  ...
  return (
    ...
    t[151] !== Me
      ? (($e = (0, X.jsx)(mn, {
          dialogDescriptionId: m,
          screenReaderTitle: Me,
          screenReaderDescription: Ie,
          headerTitle: Me,
          headerSubtitle: Pe,
          footer: Be,
          onSubmit: Ve,
...
function en(e) {
  T({ href: e.url, initiator: `open_in_browser_bridge` });
}
async function tn() {
  return await Pe.safeGet(`/payments/customer_portal`);
}
function nn(e) {
  let t = (0, hn.c)(18),
    {
  ...
  return (
    t[15] !== u || t[16] !== f
      ? ((p = (0, X.jsxs)(z, { className: `w-auto`, children: [u, f] })),
        (t[15] = u),
        (t[16] = f),
        (t[17] = p))
      : (p = t[17]),
...
function rn(e) {
  let t = (0, hn.c)(16),
    ...
    s;
  t[0] !== n || t[1] !== i || t[2] !== o
    ? ((s = jt({ intl: n, creditQuantity: Number.parseInt(St(i), 10), pricingInfo: o })),
      (t[0] = n),
      (t[1] = i),
      (t[2] = o),
      (t[3] = s))
  ...
  let c = s,
    l;
  t[4] !== n || t[5] !== o || t[6] !== r
    ? ((l = jt({ intl: n, creditQuantity: Number.parseInt(St(r), 10), pricingInfo: o })),
      (t[4] = n),
      (t[5] = o),
      (t[6] = r),
      (t[7] = l))
  ...
  let u = l,
    d;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((d = jt({ intl: n, creditQuantity: Number.parseInt(St(a), 10), pricingInfo: o })),
      (t[8] = n),
      (t[9] = a),
      (t[10] = o),
      (t[11] = d))
...
function an(e) {
  ...
  t[6] === c
    ? (u = t[7])
    : ((u = c === `button` ? (0, X.jsx)(sn, { children: (0, X.jsx)(on, {}) }) : (0, X.jsx)(on, {})),
      (t[6] = c),
      (t[7] = u));
  let d;
  return (
...
function cn(e) {
  ae({ event: e, href: vn, initiator: `open_in_browser_bridge` });
}
function ln(e) {
  let t = (0, hn.c)(12),
    ...
    o;
  t[0] !== r || t[1] !== n || t[2] !== i
    ? ((o = un({ intl: n, creditDetails: r, pricingInfo: i })),
      (t[0] = r),
      (t[1] = n),
      (t[2] = i),
      (t[3] = o))
...
function un({ intl: e, creditDetails: t, pricingInfo: n }) {
  return t == null || t.unlimited
    ? null
    : (jt({ intl: e, creditQuantity: Math.floor(Number(t.balance ?? 0)), pricingInfo: n }) ??
        e.formatNumber(0));
}
function dn({ scope: e, source: t, email: n, quantity: r, onOpenChange: i, statsigClient: a }) {
  let o = St(r);
  (ge(e, we, { creditQuantity: ce(o), source: t }),
    $e(e, {
      audience: `personal`,
    ...
    T({
      href: Ue({
        loginHint: n,
        statsigClient: a,
        url: `${s}/purchase/credits?quantity=${encodeURIComponent(o)}`,
      }),
      initiator: `open_in_browser_bridge`,
    }),
    i(!1));
}
function fn({ scope: e, intl: t, intent: n, kind: r }) {
  let i;
  switch (n) {
    case `enable`:
      i =
  ...
  if (r === `success`) {
    e.get(Re).success(i, _n);
    return;
  }
  e.get(Re).danger(i, _n);
}
function pn(e) {
  let t = St(e);
  return Tt.some((e) => String(e) === t);
}
function mn(e) {
  let t = (0, hn.c)(21),
    {
  ...
  t[14] === s
    ? (g = t[15])
    : ((g = (0, X.jsx)(C, { className: `pt-4`, children: s })), (t[14] = s), (t[15] = g));
  let _;
  return (
    t[16] !== l || t[17] !== u || t[18] !== h || t[19] !== g
      ? ((_ = (0, X.jsxs)(m, { as: `form`, onSubmit: u, children: [h, l, g] })),
        (t[16] = l),
        (t[17] = u),
        (t[18] = h),
        (t[19] = g),
...
var hn,
  ...
  bn = e(() => {
    ((hn = r()),
      ...
      (X = p()),
      (_n = { duration: 3 }),
      (vn = `https://help.openai.com/en/articles/20001106-codex-rate-card`),
      (yn = `min-w-[88px] justify-center`));
  });
function xn(e) {
  let t = (0, wn.c)(26),
    n = (0, Tn.useId)(),
  ...
  if (r) {
    ...
    let r;
    (t[8] !== n || t[9] !== e
      ? ((r = (0, Z.jsx)(Xt, { ...e, dialogDescriptionId: n })),
        (t[8] = n),
        (t[9] = e),
        (t[10] = r))
      : (r = t[10]),
    ...
    let r;
    (t[11] !== n || t[12] !== e
      ? ((r = (0, Z.jsx)(Qt, { ...e, dialogDescriptionId: n })),
        (t[11] = n),
        (t[12] = e),
        (t[13] = r))
      : (r = t[13]),
  ...
  t[15] === n
    ? (s = t[16])
    : ((s = { "aria-describedby": n, onOpenAutoFocus: Sn }), (t[15] = n), (t[16] = s));
  let c;
  t[17] !== i || t[18] !== e
    ? ((c = (t) => {
...
function Cn(e) {
  ...
  let d;
  t[6] !== i || t[7] !== u
    ? ((d = (0, Z.jsx)(`p`, { id: i, className: `sr-only`, children: u })),
      (t[6] = i),
      (t[7] = u),
      (t[8] = d))
    : (d = t[8]);
  ...
  t[11] !== f || t[12] !== c
    ? ((p = (0, Z.jsx)(C, {
        children: (0, Z.jsx)(S, { title: c, subtitle: f, titleSize: `base` }),
      })),
      (t[11] = f),
      (t[12] = c),
      (t[13] = p))
  ...
  t[18] === o
    ? (_ = t[19])
    : ((_ = (0, Z.jsx)(x, { color: `outline`, onClick: o, children: g })),
      (t[18] = o),
      (t[19] = _));
  let v;
  t[20] !== h || t[21] !== _
  ...
  return (
    t[23] !== v || t[24] !== l || t[25] !== d || t[26] !== p
      ? ((y = (0, Z.jsxs)(m, { className: `gap-0 px-4 py-4`, children: [l, d, p, v] })),
        (t[23] = v),
        (t[24] = l),
        (t[25] = d),
        (t[26] = p),
...
function Dn(e) {
  ...
  let { data: c, isError: l, refetch: u } = Ge(s),
    { enableAutoTopUpMutation: f, updateAutoTopUpMutation: p, disableAutoTopUpMutation: m } = Je(),
    h;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = { enabled: !0 }), (t[2] = h))
    : (h = t[2]);
  let { data: g, isPending: _, isError: v, refetch: y } = Ze(h),
    b;
  t[3] === g ? (b = t[4]) : ((b = { billingCurrency: g, enabled: !0 }), (t[3] = g), (t[4] = b));
  let { data: x, isPending: S, isError: C, refetch: w } = Ye(b),
    T = _ || S,
    E;
  t[5] !== y || t[6] !== w
    ? ((E = () => {
...
var On,
  kn,
  An = e(() => {
    ((On = r()), f(), Ce(), tt(), En(), (kn = p()));
  });
function jn({ intent: e, isCombinedModalEnabled: t }) {
  return t ? `combined-modal` : e === `purchase` ? `legacy-purchase` : `legacy-auto-reload`;
}
function Mn({ intent: e, isAutoReloadEnabled: t }) {
  return e === `purchase`
    ? t
      ? `one-time-purchase`
      : `add-credits`
    ...
    e[0] !== i || e[1] !== t || e[2] !== r
      ? ((a = (e) => {
          if (e.intent === `purchase` && e.isCustomCheckoutEnabled) {
            qe(
              Ue({ loginHint: i, statsigClient: r, url: `${s}/purchase/credits?quantity=1000` }),
              e.event,
            );
            return;
          }
          if (e.intent === `purchase` && e.event != null && F(e.event)) {
            qe(e.legacyUrl, e.event);
            return;
          }
          let n = he(r, Fn, { disableExposureLog: !1 }).get(`enabled`, !1);
          if (jn({ intent: e.intent, isCombinedModalEnabled: n }) === `combined-modal`) {
            (ge(t, Te, { isAutoReloadEnabledAtOpen: e.isAutoReloadEnabled, source: e.source }),
              h(t, Dn, {
                source: e.source,
                variant: Mn({ intent: e.intent, isAutoReloadEnabled: e.isAutoReloadEnabled }),
              }));
            return;
          }
...
function Hn({ intl: e, minutes: t, variant: n = `summary` }) {
  let r = t ?? 0,
    i = Un(r, Zn);
  if (i != null)
    return n === `summary`
...
function Un(e, t) {
  ...
  return Wn(e, n * t) ? n : null;
}
function Wn(e, t) {
  return e >= t * 0.95 && e <= t * 1.05;
}
function Gn(e, t = new Date()) {
...
var Jn,
  ...
  $n,
  er = e(() => {
    ((Jn = 1440), (Yn = 7 * Jn), (Xn = 30 * Jn), (Zn = 365 * Jn), (Qn = 60 * Jn), ($n = 90));
  });
function tr(e) {
...
function sr(e) {
  let t = yr(e?.effective_monthly_limit?.limit),
    n = yr(e?.current_month_usage);
  if (t == null || n == null || t < 0) return null;
  let r = t === 0 ? 100 : Math.min(Math.max((n / t) * 100, 0), 100);
  return { limit: t, used: n, usedPercent: r, remainingPercent: Bn(r) };
}
function cr(e) {
  return e?.effective_monthly_limit?.enforcement_mode === `HARD_CAP`
    ? yr(e.effective_monthly_limit.limit)
    : null;
}
function lr(e) {
  let t = cr(e),
...
function ur(e, t) {
  return !vr(e) || !lr(t) ? !1 : fr(e, t);
}
function dr(e, t) {
  return or(e) != null && fr(e, t);
}
function fr(e, t) {
  let n = cr(t),
    r = yr(e?.spend_control?.individual_limit?.limit ?? null);
  return n != null && (r == null || r === n);
}
function pr(e) {
  if (e?.rate_limit_reached_type != null) return !0;
  let t = tr(e),
    n = V(e?.plan_type) && e?.credits?.unlimited === !1 && e?.credits?.has_credits === !1;
  return !!(t?.limit_reached === !0 || t?.allowed === !1 || n || vr(e));
}
function mr({ rateLimitStatus: e, isWorkspaceAccount: t }) {
  let n = e?.rate_limit_reached_type?.type,
    r = n != null && n !== `rate_limit_reached`;
  return t && _r(e) && !vr(e) && !r;
}
function hr({ rateLimitStatus: e, isWorkspaceAccount: t }) {
  return t && vr(e);
}
function gr({ rateLimitStatus: e, isWorkspaceAccount: t, isCreditsEnabled: n }) {
  let r = !t && _r(e);
  return (
    n &&
    !hr({ rateLimitStatus: e, isWorkspaceAccount: t }) &&
    pr(e) &&
    !r &&
    !mr({ rateLimitStatus: e, isWorkspaceAccount: t })
  );
}
function _r(e) {
  let t = nr(e);
...
function Cr(e) {
  return e == null
    ...
    : {
        ...
        windowMinutes: e.limit_window_seconds == null ? null : e.limit_window_seconds / wr,
...
function Er(e, t, n, r = null) {
  return {
    limitId: null,
    limitName: r,
    primary: Br(e?.primary_window),
    secondary: Br(e?.secondary_window),
    credits: Vr(t),
...
function Or(e) {
  ...
  let t = [],
    n = Dr(e),
    r = Er(e.rate_limit, e.credits, e.plan_type, n);
  r && t.push({ limitName: null, snapshot: r, blocked: pr(e) });
  ...
  if (Array.isArray(i))
    for (let n of i) {
      ...
      let i = Er(n.rate_limit, null, e.plan_type, r);
      i && t.push({ limitName: r, snapshot: i, blocked: br(n) });
    }
  return t;
}
function kr(e, { activeLimitName: t, selectedModel: n } = {}) {
  if (e.length === 0) return e;
  let r = Lr(n),
    i = Lr(t),
    a = r ?? (i && !Ir(i) ? i : null);
  return a
    ? e.filter((e) => (e.limitName == null ? !0 : Lr(e.limitName) === a))
    : e.filter((e) => e.limitName == null);
}
function Ar(e, { activeLimitName: t, selectedModel: n } = {}) {
  ...
  return o && i?.blocked === !0
    ? i
    : o && a?.blocked === !0 && !Ir(a.limitName)
      ? a
      : (r ?? i ?? a ?? e[0] ?? null);
}
function jr(e, t = {}) {
  let n = Ar(e, t);
  return n == null ? null : zn(n.snapshot);
}
function Mr(e) {
  return zr(e)?.resetsAt ?? null;
}
function Nr(e, t = {}) {
  if (e == null || pr(e)) return !1;
  let n = t.activeLimitName ?? Dr(e),
    r = e.additional_rate_limits;
  if (!Array.isArray(r)) return n != null && !Ir(n);
  let i = Lr(t.selectedModel);
  return i != null && r.some((e) => (br(e) ? Lr(e.limit_name) === i : !1))
    ? !0
    : n != null && !Ir(n);
}
function Pr(e, t) {
  ...
  return Array.isArray(r) ? r.some((e) => (br(e) ? Lr(e.limit_name) === n : !1)) : !1;
}
function Fr(e) {
...
function Ir(e) {
  return e == null ? !0 : e.trim().toLowerCase() === Ur;
}
function Lr(e) {
  if (e == null) return null;
  let t = e
...
function Rr(e, t) {
  let n = Lr(t);
  return n == null ? null : (e.find((e) => Lr(e.limitName) === n) ?? null);
}
function zr(e) {
  if (e == null) return null;
...
function Kr(e) {
  let t = Or(e).find((e) => e.limitName == null) ?? null;
  return [t?.snapshot.primary, t?.snapshot.secondary]
    .filter(Ln)
    .map((e) => ({
      usedPercent: e.usedPercent,
      remainingPercent: Bn(e.usedPercent),
...
function Zr(e) {
  ...
  t[3] === o
    ...
    : ((_ = o ? { opacity: 0, scale: 0.985, y: -4 } : { opacity: 1, scale: 1, y: 0 }),
      ...
      (t[4] = _));
  let v;
  t[5] === p ? (v = t[6]) : ((v = p ? { duration: 0 } : ti), (t[5] = p), (t[6] = v));
  let y;
  t[7] !== o || t[8] !== s
    ? ((y = () => {
        o && s();
  ...
  t[23] === k
    ? (A = t[24])
    : ((A = R(`justify-center border-transparent !text-sm !leading-5 font-medium`, k)),
      (t[23] = k),
      (t[24] = A));
  let j = n === (g ?? `automatic`),
    M;
  ...
  t[29] === f
    ? (P = t[30])
    : ((P = (0, ei.jsx)(`span`, { id: f, children: N })), (t[29] = f), (t[30] = P));
  let F;
  t[31] !== i ||
  t[32] !== D ||
  t[33] !== O ||
  ...
  t[37] !== P
    ...
    : (F = t[38]);
  let I;
  t[39] !== E || t[40] !== F || t[41] !== S
    ? ((I = (0, ei.jsxs)(`div`, { className: S, children: [E, F] })),
      (t[39] = E),
      (t[40] = F),
      (t[41] = S),
      (t[42] = I))
...
var Qr,
  ...
  ni = e(() => {
    ((Qr = r()),
      ...
      I(),
      (ei = p()),
      (ti = { duration: 0.18, ease: [0.3, 0, 1, 1] }));
  });
function ri(e) {
  let t = (0, ii.c)(44),
    {
  ...
  let x = !h && `transition-transform`,
    ...
    C;
  t[9] !== x || t[10] !== S
    ? ((C = R(`icon-2xs shrink-0 text-token-text-secondary`, x, S)),
      (t[9] = x),
      (t[10] = S),
      (t[11] = C))
    : (C = t[11]);
  let w;
  t[12] === C ? (w = t[13]) : ((w = (0, oi.jsx)(B, { className: C })), (t[12] = C), (t[13] = w));
  let T;
  t[14] !== b || t[15] !== w
    ? ((T = (0, oi.jsxs)(`span`, {
  ...
  let k;
  t[38] !== D || t[39] !== O
    ? ((k = (0, oi.jsx)(pe, { initial: !1, onExitComplete: D, children: O })),
      (t[38] = D),
      (t[39] = O),
      (t[40] = k))
    : (k = t[40]);
...
var ii,
  ...
  ci = e(() => {
    ((ii = r()),
      ...
      ni(),
      (oi = p()),
      (si = { duration: 0.3, ease: [0.4, 0, 0.2, 1] }));
  });
function li(e) {
  let t = (0, xi.c)(15),
    n = G(0),
  ...
  t[2] !== e || t[3] !== i || t[4] !== n
    ? ((d = (t) => {
        ...
        fe(n, 1, { duration: Fi / 1e3, ease: `linear` }).then(t, t);
      }),
      (t[2] = e),
      (t[3] = i),
      (t[4] = n),
...
function gi(e) {
  return `color-mix(in srgb, ${Mi} ${((1 - e) * 100).toFixed(3)}%, ${Ni} ${(e * 100).toFixed(3)}%)`;
}
function _i(e) {
  let t = yi(e);
  return t <= 0 || t >= 1
...
function vi(e) {
  return `${-110 + 340 * Li(yi(e))}%`;
}
function yi(e) {
  return xe(0, 1, (e * Fi - Pi - Di) / Oi);
}
function bi(e) {
  return xe(0, 1, (e * Fi - Pi) / Ai);
}
var xi,
  Si,
  Ci,
  ...
  Bi = e(() => {
    ((xi = r()),
      ...
      (Ni = `#5865F2`),
      (Pi = Si + Ci),
      (Fi = Pi + Math.ceil(Math.max(Oi + 80, Oi * Ei + Ti + 30))),
      (Ii = se(0.25, 0.1, 0.25, 1)),
      (Li = se(0.4, 0, 0.2, 1)),
      (Ri = ue([0, 0.16, 0.42, 0.7, 1], [0, 0.14, ji, 0.3, 0], { ease: Li })),
      (zi = ue([0, 0.42, 0.7, 1], [0.93, 0.985, 1, 1], { ease: Li })));
  }),
  Vi,
  Hi,
  Ui,
  Wi = e(() => {
    ((Vi = `_shimmer_1lvpw_1`), (Hi = `_bloom_1lvpw_14`), (Ui = { shimmer: Vi, bloom: Hi }));
  });
function Gi(e) {
  let t = (0, qi.c)(19),
    {
...
function Xi(e) {
  ...
  if (t[5] !== n || t[6] !== o || t[7] !== a.resetsAt || t[8] !== a.windowMinutes) {
    ...
    (t[14] !== o || t[15] !== a.windowMinutes
      ? ((r = Qi(a.windowMinutes, o)), (t[14] = o), (t[15] = a.windowMinutes), (t[16] = r))
      : (r = t[16]),
      (g = r),
      t[17] === n
        ? (h = t[18])
  ...
  t[21] !== f || t[22] !== p || t[23] !== m
    ? ((_ = (0, ea.jsxs)(`div`, { className: f, children: [p, m] })),
      (t[21] = f),
      (t[22] = p),
      (t[23] = m),
      (t[24] = _))
  ...
  t[34] !== r || t[35] !== c || t[36] !== d
    ? ((b = r ? (0, ea.jsx)(W.span, { children: d }, `remaining-percent`) : c),
      (t[34] = r),
      (t[35] = c),
      (t[36] = d),
      (t[37] = b))
  ...
  return (
    t[40] !== x || t[41] !== h || t[42] !== _ || t[43] !== y
      ? ((S = (0, ea.jsxs)(`div`, { className: h, children: [_, y, x] })),
        (t[40] = x),
        (t[41] = h),
        (t[42] = _),
        (t[43] = y),
...
function ra(e) {
  let t = (0, oa.c)(108),
    ...
    _ = g(),
    v = (0, sa.useRef)(null),
    [b, w] = (0, sa.useState)(null),
    [T, E] = (0, sa.useState)(aa),
    [k, A] = (0, sa.useState)(null),
    [j, M] = (0, sa.useState)(!1),
    [N, P] = (0, sa.useState)(null),
    [F, I] = (0, sa.useState)(`idle`),
    [L, ee] = (0, sa.useState)(null),
    z = li(h),
    B;
  t[0] === d ? (B = t[1]) : ((B = d.slice(0, 2)), (t[0] = d), (t[1] = B));
  let V = B,
    H;
  t[2] !== V || t[3] !== L
    ? ((H =
    ...
    : (H = t[4]);
  let ne = H,
    ie = F === `awaiting-refresh` && !ne,
    ae = L != null && F !== `idle` && !(F === `awaiting-refresh` && ne) ? L : V,
    oe;
  t[5] !== b || t[6] !== r || t[7] !== T
    ? ((oe = b == null ? (r?.filter((e) => !T.has(e.id)) ?? null) : b.credits),
      (t[5] = b),
      (t[6] = r),
      (t[7] = T),
      (t[8] = oe))
    : (oe = t[8]);
  let se = oe,
    U = b?.availableCount ?? Math.min(n, k ?? n),
    ce = b?.creditId ?? null,
    le = F === `redeeming` ? ce : null,
    W = F === `retry` ? ce : null,
    G = F === `hiding-row` ? ce : null,
    ue = s != null || u != null,
    de = o || (F !== `idle` && F !== `retry` && F !== `awaiting-refresh`),
    fe = de || ie,
    K = F === `revealing-usage` || F === `awaiting-refresh`,
    pe = N == null ? void 0 : `max(${16 / _}px, calc(50dvh / ${_} - ${N}px))`,
    me = pe == null ? void 0 : `calc(100dvh / ${_} - ${16 / _}px - ${pe})`,
    he;
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((he = () => {
        let e = v.current?.closest(`.codex-dialog`);
        e instanceof HTMLElement && P(e.offsetHeight / 2);
      }),
      (t[9] = he))
    : (he = t[9]);
  let ge = he,
  ...
  t[24] !== ae
    ? ((ve = async (e) => {
        ...
        let n = b?.availableCount ?? U;
        (w({
          availableCount: n,
          creditId: t,
          credits: b?.credits ?? se,
        ...
        switch (r.status) {
          case `failed`:
            (w(null), ee(null), I(`idle`));
            return;
          case `retry`:
            (w((e) => (e == null ? null : { ...e, creditId: r.creditId ?? `automatic` })),
              I(`retry`));
            return;
          case `completed`: {
  ...
  t[26] === F
    ? (be = t[27])
    : ((be = () => {
        F === `hiding-row` && (I(`collapsing-panel`), M(!1));
      }),
      (t[26] = F),
      (t[27] = be));
  let xe = be,
    Se;
  t[28] !== b || t[29] !== F || t[30] !== _e
    ? ((Se = () => {
        F !== `collapsing-panel` ||
          b == null ||
  ...
  t[35] === f
    ...
    : ((Ee = f.formatMessage({
      ...
      (t[35] = f),
      (t[36] = Ee));
  let De = pe == null ? void 0 : `translateX(-50%)`,
    Oe = pe == null ? void 0 : `0 0`,
    ke;
  t[37] !== pe || t[38] !== De || t[39] !== Oe
    ? ((ke = { height: `auto`, top: pe, transform: De, translate: Oe }),
      (t[37] = pe),
      (t[38] = De),
      (t[39] = Oe),
      (t[40] = ke))
  ...
  t[43] !== p || t[44] !== ke || t[45] !== Ae
    ? ((je = {
      ...
      (t[46] = je))
    : (je = t[46]);
  let Me = me ?? `calc(100dvh / ${_} - ${32 / _}px)`,
    Ne;
  t[47] === Me ? (Ne = t[48]) : ((Ne = { maxHeight: Me }), (t[47] = Me), (t[48] = Ne));
  let Pe;
  t[49] === K
    ? (Pe = t[50])
    : ((Pe = K
  ...
  t[55] === p
    ...
    : ((ze = (0, Q.jsx)(S, {
        title: Le,
        subtitle: (0, Q.jsx)(D, { asChild: !0, id: p, children: Re }),
        subtitleSize: `base`,
  ...
  let Be;
  t[57] !== Ie || t[58] !== ze
    ? ((Be = (0, Q.jsxs)(C, { children: [Ie, ze] })), (t[57] = Ie), (t[58] = ze), (t[59] = Be))
    : (Be = t[59]);
  let Ve = ae.length === 2 ? `h-[140px]` : `h-[70px]`,
    He;
  t[60] === Ve
    ? (He = t[61])
    : ((He = R(
        ...
        ae.length === 0
          ...
          : ae.map((e, t) =>
              (0, Q.jsx)(
                Xi,
                {
                  className: R(t > 0 && `border-t border-token-border`),
                  isResetFillActive: F === `revealing-usage` || ie,
                  resetFillAnimation: z,
                  usageWindow: e,
                },
                `${e.windowMinutes}-${t}`,
              ),
  ...
  let We;
  t[67] !== He || t[68] !== Ue
    ? ((We = (0, Q.jsx)(`div`, { className: He, children: Ue })),
      (t[67] = He),
      (t[68] = Ue),
      (t[69] = We))
    : (We = t[69]);
  ...
  let Ke;
  t[83] !== We || t[84] !== Ge
    ? ((Ke = (0, Q.jsxs)(C, { className: `gap-4 pt-4`, children: [We, Ge] })),
      (t[83] = We),
      (t[84] = Ge),
      (t[85] = Ke))
    : (Ke = t[85]);
  ...
  t[86] !== i || t[87] !== ue
    ...
    : (qe = t[88]);
  let Je;
  t[89] !== fe || t[90] !== s || t[91] !== u || t[92] !== h || t[93] !== ue
    ? ((Je = ue
        ? (0, Q.jsx)(C, {
            className: `pt-4`,
            children: (0, Q.jsxs)(`div`, {
              className: R(`grid gap-3`, s != null && u != null ? `grid-cols-2` : `grid-cols-1`),
              children: [
                u == null
                  ? null
                  : (0, Q.jsxs)(x, {
                      ...
                      size: `medium`,
                      children: [
                        (0, Q.jsx)(Yr, { className: `icon-base` }),
                        (0, Q.jsx)(J, {
                ...
                s == null
                  ...
                  : (0, Q.jsxs)(x, {
                      ...
                      size: `medium`,
                      children: [
                        (0, Q.jsx)(te, { className: `icon-base` }),
                        (0, Q.jsx)(J, {
    ...
    : (Je = t[94]);
  let Ye;
  t[95] !== Ne || t[96] !== Be || t[97] !== Ke || t[98] !== qe || t[99] !== Je
    ? ((Ye = (0, Q.jsxs)(m, {
        className: `overflow-y-auto text-token-foreground`,
        style: Ne,
        children: [Be, Ke, qe, Je],
      })),
      (t[95] = Ne),
      (t[96] = Be),
      (t[97] = Ke),
...
var oa,
  ...
  ua = e(() => {
    ((oa = r()),
      ...
      na(),
      (Q = p()),
      (ca = `h-[84px] flex-col justify-center gap-2 !rounded-2xl !text-base !leading-5 font-medium`),
      (la = `transition-transform duration-100 ease-out active:scale-[0.98]`));
  });
function da(e) {
  let t = (0, fa.c)(26),
    r,
  ...
  t[0] === e
    ? ((r = t[1]), (i = t[2]), (a = t[3]))
    : (({ currentPlan: r, onClose: i, ...a } = e), (t[0] = e), (t[1] = r), (t[2] = i), (t[3] = a));
  let o = l(n),
    s;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let c = ot(s),
    ...
    f = Ne(),
    p;
  t[5] === r ? (p = t[6]) : ((p = st(r)), (t[5] = r), (t[6] = p));
  let m = p,
    h = m,
    g;
  ...
  let { data: _ } = Ge(g),
    y;
  t[9] !== _ || t[10] !== u || t[11] !== i || t[12] !== o || t[13] !== f
    ? ((y = (e) => {
        let t = Ke(f, `personal`);
        if (
          (i(),
  ...
  let b = m ? y : void 0,
    x;
  t[15] !== r || t[16] !== c || t[17] !== i || t[18] !== d || t[19] !== o
    ? ((x =
        r === v.PRO
          ? void 0
          : (e) => {
  ...
  let S;
  return (
    t[21] !== i || t[22] !== a || t[23] !== b || t[24] !== x
      ? ((S = (0, pa.jsx)(ra, { ...a, onAddCredits: b, onClose: i, onUpgradePlan: x })),
        (t[21] = i),
        (t[22] = a),
        (t[23] = b),
        (t[24] = x),
...
var fa,
  pa,
  ma = e(() => {
    ((fa = r()), f(), rt(), In(), Xe(), ct(), tt(), i(), it(), Ve(), ke(), E(), ua(), (pa = p()));
  });
function ha(e) {
  let t = (0, _a.c)(26),
    ...
    { data: s } = me(),
    { data: c } = d(Ae),
    { data: l, isLoading: u } = Ie(),
    f;
  t[0] === l?.credits
    ? (f = t[1])
    : ((f = l?.credits.filter(ga) ?? null), (t[0] = l?.credits), (t[1] = f));
  let p = f,
    m = l?.available_count ?? r ?? 0,
    h;
  t[2] !== s?.plan_type || t[3] !== c?.plan_type
    ? ((h = at(s?.plan_type ?? c?.plan_type)?.pricePlan ?? null),
      (t[2] = s?.plan_type),
      (t[3] = c?.plan_type),
      (t[4] = h))
    : (h = t[4]);
  let g = h,
    _ = c ?? null,
    v;
  t[5] === _ ? (v = t[6]) : ((v = Kr(_)), (t[5] = _), (t[6] = v));
  let y = v;
  if (g != null) {
    let e;
    return (
...
var _a,
  va,
  ya = e(() => {
    ((_a = r()), f(), ye(), Ce(), it(), qr(), ma(), ua(), (va = p()));
  }),
  ba,
  xa = e(() => {
    ba = `` + new URL(`app-D0g8sCle.png`, import.meta.url).href;
  }),
  Sa,
  Ca = e(() => {
    Sa = `` + new URL(`referral-modal-background-DumA0TET.png`, import.meta.url).href;
  });
function wa(e) {
  let t = (0, Ta.c)(43),
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Da.jsx)(ee, { className: `size-4 stroke-[2.4]` })), (t[13] = _))
    : (_ = t[13]);
  let v;
...
var Ta,
  ...
  Da,
  Oa = e(() => {
    ((Ta = r()), (Ea = t(c(), 1)), q(), xa(), Ca(), j(), _(), b(), P(), (Da = p()));
  });
function ka(e) {
  let t = (0, Ra.c)(22),
    ...
    [a, o] = (0, za.useState)(!1),
    [s, c] = (0, za.useState)(!1),
    [l, u] = (0, za.useState)(null),
    [d, f] = (0, za.useState)(!1),
    [p, m] = (0, za.useState)(null),
    [h, g] = (0, za.useState)(null),
    [_, v] = (0, za.useState)(null),
    y;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((y = []), (t[0] = y)) : (y = t[0]);
  let [b, x] = (0, za.useState)(y),
    [S, C] = (0, za.useState)(Na),
    [w, T] = (0, za.useState)(0),
    [E, D] = (0, za.useState)(!1),
    O = (0, za.useRef)(new Set()),
    k = (0, za.useRef)([]),
    A = (0, za.useRef)(null),
    j = (0, za.useRef)(0),
    M = (0, za.useRef)(null),
    ...
    I = (0, za.useRef)(!1),
    L;
  t[1] === i ? (L = t[2]) : ((L = (e) => La(e, i)), (t[1] = i), (t[2] = L));
  let ee = n.map(L),
    z;
  t[3] === b ? (z = t[4]) : ((z = (e) => !b.some((t) => t === e.id)), (t[3] = b), (t[4] = z));
  let B = [...b.map((e) => ee.find((t) => t.id === e)).filter(Ma), ...ee.filter(z)],
    te = B.length > 1,
    V = B.slice(0, Ha),
    H = V.find((e) => e.id === p) ?? V[0],
    ne = V.find((e) => e.id === h && e.id !== H?.id) ?? V.find((e) => e.id !== H?.id),
    re = [
      H,
      ne,
      V.find((e) => e.id === _ && e.id !== H?.id && e.id !== ne?.id) ??
        V.find((e) => e.id !== H?.id && e.id !== ne?.id),
    ].filter(ja),
    ie = d ? V.filter((e) => !S.has(e.id)) : re,
    ae = s && l !== `collapsing`,
    oe = a
      ? i.formatMessage({
    ...
    le = (e) => {
      ...
      let t = e,
        n = null,
        r = (e) => {
          let i = n == null ? Wa : Math.min(e - n, Ga),
            a = j.current;
          n = e;
          let o = ce(a + t * i);
          if (((t *= Ka ** (i / Wa)), Math.abs(t) < qa || o === a)) {
            ((N.current = null), D(!1));
            return;
          }
          N.current = window.requestAnimationFrame(r);
        };
      Math.abs(e) >= qa ? (N.current = window.requestAnimationFrame(r)) : D(!1);
    },
    G = (e) => {
      l !== `collapsing` ||
        O.current.has(e) ||
        (O.current.add(e),
        O.current.size === V.length - Va && (x(k.current), u(null), C(new Set(O.current)), f(!1)));
    },
    ue;
  (t[5] === Symbol.for(`react.memo_cache_sentinel`) ? ((ue = []), (t[5] = ue)) : (ue = t[5]),
    (0, za.useEffect)(
      () => () => {
  ...
  let de = (e) => {
      ...
      if ((se(), U(), D(!1), a)) {
        let t = e ?? H?.id,
          n = Math.max(
            B.findIndex((e) => e.id === t),
            0,
          ),
          i = n > 0 ? [B[n], ...B.slice(0, n), ...B.slice(n + 1)] : B,
          a = i.slice(0, Ha),
          s = a[0];
        (s != null && (m(s.id), r(s.id), (k.current = i.map(Aa))),
          g(a[1]?.id ?? null),
          v(a[2]?.id ?? null),
          u(`collapsing`),
          O.current.clear(),
    ...
    K = (e) => {
      ...
      if (
        ...
        let r = Math.max(e.timeStamp - t.lastTimestamp, 1),
          i = Math.min(Math.max((t.lastX - e.clientX) / r, -Ya), Ya);
        ((t.velocity = t.velocity * Xa + i * Za),
          (t.lastX = e.clientX),
  ...
  t[6] === he
    ? (ge = t[7])
    : ((ge = R(`relative z-10 overflow-hidden pt-2 pb-10`, he)), (t[6] = he), (t[7] = ge));
  let q, _e;
  ...
  let J = ie.map((e) => {
      ...
      return (0, Ba.jsx)(
        W.div,
        {
          ...
          initial: !1,
          animate: a
            ? { x: Fa(t) - w, y: 0, rotate: 0, opacity: 1, scale: 1 }
            : {
                x: i?.x ?? 0,
            ...
            a && E
              ...
              : s
                ? {
                    ...
                    duration: 0.4,
                    ease: [0.23, 1, 0.32, 1],
                    opacity: { duration: 0.14, delay: Math.max(t - Va, 0) * 0.012 },
                  }
                : {
                    type: `spring`,
                    stiffness: a ? 260 : 330,
                    ...
                    opacity: {
                      duration: 0.18,
                      delay: a ? Math.max(t - Va, 0) * 0.018 : o ? (V.length - t - 1) * 0.014 : 0,
                    },
                    ...(c
                      ? {
          ...
          style: { zIndex: a ? Ha - t : r === 0 ? 30 : r === 1 ? 20 : r === 2 ? 10 : 9 - t },
          onAnimationComplete: () => {
            (a && l === `expanding` && t === V.length - 1 && u(null),
              r == null && l === `collapsing` && G(e.id),
              !a &&
                l === `collapsing` &&
                V.length <= Va &&
                r === re.length - 1 &&
  ...
  t[10] === J
    ? (ve = t[11])
    : ((ve = (0, Ba.jsx)(`div`, { className: `grid min-w-full select-none`, children: J })),
      (t[10] = J),
      (t[11] = ve));
  let ye;
  return (
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, Ba.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, Ba.jsx)(A, { className: `size-4 text-token-text-secondary opacity-70` }),
        ],
      })),
      (t[16] = b))
    : (b = t[16]);
...
function Fa(e) {
  return Math.ceil(e / 2) * Ua * (e % 2 == 0 ? -1 : 1);
}
function Ia({ cardCount: e, stripWidth: t }) {
  let n = Math.max(t / 2 - Ua / 2, 0);
  return {
    minimum: Math.min(-Math.floor((e - 1) / 2) * Ua + n, 0),
    maximum: Math.max(Math.ceil((e - 1) / 2) * Ua - n, 0),
  };
}
function La(e, t) {
...
function to(e) {
  let t = (0, ro.c)(74),
    ...
    c = Fe(),
    l = (0, io.useId)(),
    [u, d] = (0, io.useState)(null),
    [f, p] = (0, io.useState)(null),
    { data: h, error: g, isLoading: _ } = Ie(),
    v = h?.available_count ?? r ?? 0,
    b,
    S,
    C;
  if (t[0] !== f || t[1] !== v || t[2] !== h?.credits || t[3] !== u) {
    let e = h?.credits.filter(no) ?? [];
    ((b = f?.availableCount ?? v),
      (S = f == null ? e : [f.credit]),
      (C = S.find((e) => e.id === u)?.id ?? S[0]?.id),
      (t[0] = f),
      (t[1] = v),
      (t[2] = h?.credits),
      (t[3] = u),
      ...
      (t[5] = S),
      (t[6] = C));
  } else ((b = t[4]), (S = t[5]), (C = t[6]));
  let w = C,
    T = _ || a || b === 0 || w == null,
    E;
  t[7] !== w || t[8] !== b || t[9] !== S || t[10] !== o || t[11] !== s
    ? ((E = async () => {
        let e = S.find((e) => e.id === w);
        if (e != null)
          switch ((await s(e.id, b)).status) {
            case `completed`:
              (p(null), o());
              return;
            case `failed`:
  ...
  if (_) {
    ...
    (t[15] === S
      ? (e = t[16])
      : ((e = (0, $.jsx)(ka, { credits: S, onSelectedCreditIdChange: d })),
        (t[15] = S),
        (t[16] = e)),
      (A = e));
  }
  ...
  let N;
  t[21] !== l || t[22] !== M
    ? ((N = { "aria-describedby": l, onEscapeKeyDown: M }), (t[21] = l), (t[22] = M), (t[23] = N))
    : (N = t[23]);
  let P;
  t[24] === k
    ? (P = t[25])
  ...
  let I;
  t[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (0, $.jsx)(ee, { className: `size-4 stroke-[2.2]` })), (t[28] = I))
    : (I = t[28]);
  let L;
  ...
  t[53] === n
    ...
    : ((ae =
      ...
      (t[54] = ae));
  let oe;
  t[55] !== H || t[56] !== re || t[57] !== ie || t[58] !== ae
    ? ((oe = (0, $.jsxs)(`div`, {
...
var ro,
  ...
  $,
  ao = e(() => {
    ((ro = r()), (io = t(c(), 1)), q(), ye(), j(), _(), b(), P(), eo(), ($ = p()));
  });
function oo() {
  let e = !1,
    t;
...
function lo(e) {
  let t = (0, mo.c)(5),
    ...
    i = null;
  if ((r === `workspace` ? (i = vo) : r === `personal` && (i = _o), i == null)) {
    let n;
    return (
      t[0] === e
        ? (n = t[1])
        : ((n = (0, go.jsx)(fo, { ...e, componentType: yo })), (t[0] = e), (t[1] = n)),
      n
    );
  }
  let a;
  return (
    t[2] !== i || t[3] !== e
      ? ((a = (0, go.jsx)(uo, { ...e, layerName: i })), (t[2] = i), (t[3] = e), (t[4] = a))
      : (a = t[4]),
    a
  );
}
function uo(e) {
  ...
  let i = ve(n).get(`component_type`, yo) === `card_stack` ? `card_stack` : yo,
    a;
  return (
    t[3] !== i || t[4] !== r
      ? ((a = (0, go.jsx)(fo, { ...r, componentType: i })), (t[3] = i), (t[4] = r), (t[5] = a))
      : (a = t[5]),
    a
  );
}
function fo(e) {
  ...
  t[11] !== c
    ? ((v = async (e, t) => {
        ...
        p(null);
        let o = await d.redeem({ availableCount: n, consume: m.mutateAsync, creditId: e });
        switch (o.status) {
          case `in_flight`:
          ...
          case `rejected`:
            return (p(so(o.code, u)), { status: `failed` });
          case `reset`: {
            ...
            return (
              ...
              ge(c, Ee, {
                ...
                componentType: r,
                isRateLimitReached: a,
                redemptionMethod: o.creditId == null ? `automatic` : `selected_credit`,
                remainingCount: e,
              }),
              s(e),
  ...
  if (r !== `card_stack`) {
    let e;
    return (
      t[13] !== f || t[14] !== _ || t[15] !== y || t[16] !== i || t[17] !== h
        ? ((e = (0, go.jsx)(po, {
            errorMessage: f,
            initialAvailableCount: i,
            isResetting: h,
  ...
  let b;
  return (
    t[19] !== f || t[20] !== _ || t[21] !== y || t[22] !== i || t[23] !== a || t[24] !== h
      ? ((b = (0, go.jsx)(to, {
          errorMessage: f,
          initialAvailableCount: i,
          isRateLimitReached: a,
