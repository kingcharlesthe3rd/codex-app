...
var wt,
  ...
  Et,
  Dt = e(() => {
    (l(), et(), (wt = new URL(r)), (Tt = `${wt.pathname}/purchase/`), (Et = `3800100299`));
  });
function Ot(e) {
...
function It(e) {
  ...
  let s = n && !a && i != null,
    c;
  t[4] === i ? (c = t[5]) : ((c = async () => (i == null ? null : Xt(i))), (t[4] = i), (t[5] = c));
  let l;
  return (
    t[6] !== o || t[7] !== s || t[8] !== c
      ? ((l = {
...
function Bt({ accountId: e, updatedPlan: t }) {
  return K.safePost(`/subscriptions/update`, { requestBody: { account_id: e, updated_plan: t } });
}
function Vt({ accountId: e }) {
  return K.safePost(`/subscriptions/update/cancel_pending`, { requestBody: { account_id: e } });
}
function Ht() {
  let e = (0, cn.c)(16),
    t = c(a),
  ...
  e[1] !== n || e[2] !== t
    ? ((i = {
        ...
        mutationFn: Gt,
        onSuccess: (e) => {
          Ot(e.immediate_top_up_status) || Zt({ scope: t, queryClient: n, response: e });
        },
      }),
      (e[1] = n),
      (e[2] = t),
  ...
  e[1] === r
    ...
    : ((i = [...gn, r, `save`]),
      (a = async (e) => {
        ...
        return K.safePatch(`/accounts/{account_id}/workspace_admin_requests/{request_id}`, {
...
function Yt(e) {
  ...
  t[0] === s
    ? (c = t[1])
    : ((c = { queryConfig: { enabled: s, staleTime: C.ONE_MINUTE } }), (t[0] = s), (t[1] = c));
...
function Zt({ scope: e, queryClient: t, response: n }) {
  (t.setQueryData(ln, n), n.immediate_top_up_status === `succeeded` && e.query.invalidate(tt));
}
function Qt(e, t) {
...
function $t() {
  return K.safeGet(`/accounts/check/{version}`, { parameters: { path: { version: xn } } });
}
function en(e) {
...
async function on(e) {
  return K.safePost(`/accounts/send_add_credits_nudge_email`, { requestBody: e });
}
function sn(e) {
  return {
...
function wn(e, t) {
  return qe(e, kn[t], { disableExposureLog: !1 }).get(`is_custom_checkout_enabled`, !1);
}
...
var kn,
  An = e(() => {
    (Re(), we(), ct(), Ve(), et(), (kn = { personal: `2336405413`, workspace: `3431030460` }));
  });
function jn({ intl: e, amount: t, currencyCode: n, currencyFractionDigits: r }) {
...
function In(e) {
  return e.isEnabled ? (e.rechargeMonthlyLimit == null ? `` : Kn(e.rechargeMonthlyLimit)) : ``;
}
function Ln(e) {
  let t = qn(e);
  switch (t.kind) {
...
function Bn({ value: e, pricingInfo: t }) {
  ...
  switch (n.kind) {
    ...
    case `invalid`:
      return `not-whole-number`;
    case `valid`:
      return n.value < zn(t) ? `below-minimum` : n.value % 250 == 0 ? null : `invalid-increment`;
  }
}
function Vn({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r }) {
  let i = Hn({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r });
  if (i == null) return null;
  let a = Math.round(i);
  return Math.abs(i - a) > 1e-6 ? null : String(a);
}
function Hn({ value: e, pricingInfo: t, groupSeparator: n, decimalSeparator: r }) {
  let i = Kn(e)
    .replaceAll(n, ``)
    .replaceAll(r, `.`)
    .replace(/[^\d.]/g, ``);
...
function er({ intl: e, pricingInfo: t }) {
  return (
    rr({ intl: e, amount: 0, pricingInfo: t })?.find((e) => e.type === `currency`)?.value ?? null
  );
}
...
function ar(e) {
  ...
  let C;
  t[20] !== g || t[21] !== S
    ? ((C = (0, J.jsxs)(`div`, { className: `grid grid-cols-4 gap-2`, children: [g, S] })),
      (t[20] = g),
      (t[21] = S),
      (t[22] = C))
    : (C = t[22]);
        ...
        : (0, J.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, J.jsx)(or, {
                ...
                value: r,
                pricingInfo: a,
                placeholder: $n({ intl: n, creditQuantity: s, pricingInfo: a }) ?? ``,
                hasError: o != null,
  ...
  t[33] !== o || t[34] !== s || t[35] !== c
    ? ((T =
        o == null ? null : (0, J.jsx)(sr, { fieldError: o, minimumQuantity: s, quantityStep: c })),
      (t[33] = o),
      (t[34] = s),
      (t[35] = c),
      (t[36] = T))
  ...
  return (
    t[37] !== w || t[38] !== T || t[39] !== C
      ? ((E = (0, J.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [C, w, T] })),
        (t[37] = w),
        (t[38] = T),
        (t[39] = C),
        (t[40] = E))
...
function or(e) {
  ...
  if (t[0] !== p || t[1] !== n || t[2] !== i || t[3] !== f || t[4] !== r) {
    let e = f
      ? $n({ intl: n, creditQuantity: Number.parseInt(Kn(r), 10), pricingInfo: i })
      : tr({ intl: n, creditQuantity: Number.parseInt(Kn(r), 10), pricingInfo: i });
    ((_ = p ?? e ?? r),
  ...
  return (
    t[35] !== D || t[36] !== T || t[37] !== E
      ? ((O = (0, J.jsxs)(`div`, { className: `relative`, children: [T, E, D] })),
        (t[35] = D),
        (t[36] = T),
        (t[37] = E),
        (t[38] = O))
...
function lr({ intl: e, value: t, pricingInfo: n }) {
  ...
  let { groupSeparator: i, decimalSeparator: a } = dr({ intl: e, pricingInfo: n });
  return Vn({ value: r, pricingInfo: n, groupSeparator: i, decimalSeparator: a });
}
function ur({ intl: e, value: t, pricingInfo: n }) {
  let r = t.trim();
  if (r.length === 0) return null;
  let { groupSeparator: i, decimalSeparator: a } = dr({ intl: e, pricingInfo: n });
  return Hn({ value: r, pricingInfo: n, groupSeparator: i, decimalSeparator: a });
}
...
function fr({ intl: e, value: t, pricingInfo: n }) {
  let { groupSeparator: r, decimalSeparator: i } = dr({ intl: e, pricingInfo: n }),
...
function gr(e) {
  ...
  t[12] === o
    ? (S = t[13])
    : ((S = o == null ? null : (0, vr.jsx)(sr, { fieldError: o })), (t[12] = o), (t[13] = S));
  let C;
  t[14] !== x || t[15] !== S
    ? ((C = (0, vr.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [v, x, S] })),
      (t[14] = x),
      (t[15] = S),
      (t[16] = C))
    : (C = t[16]);
  ...
  t[33] === s
    ? (A = t[34])
    : ((A = s == null ? null : (0, vr.jsx)(sr, { fieldError: s })), (t[33] = s), (t[34] = A));
  let j;
  t[35] !== k || t[36] !== A
    ? ((j = (0, vr.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [T, k, A] })),
      (t[35] = k),
      (t[36] = A),
      (t[37] = j))
    : (j = t[37]);
...
function br(e) {
  let t = (0, Rr.c)(39),
    { source: n, creditDetails: r, pricingInfo: i, onOpenChange: o, dialogDescriptionId: s } = e,
    l = c(a),
    { email: u } = ee(),
    d = Ke(),
    f = He(),
  ...
  t[10] !== r || t[11] !== f || t[12] !== i || t[13] !== j
    ? ((M = (0, Y.jsx)(Mr, { intl: f, creditDetails: r, pricingInfo: i, actions: j })),
      (t[10] = r),
      (t[11] = f),
      (t[12] = i),
      (t[13] = j),
  ...
  t[21] !== d
    ? ((N = () => {
        (v(!0),
          S ??
            Pr({ scope: l, source: n, email: u, quantity: p, onOpenChange: o, statsigClient: d }));
      }),
      (t[15] = u),
      (t[16] = o),
      (t[17] = p),
  ...
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (te = t[26]);
  let ne;
  t[27] !== h || t[28] !== f || t[29] !== i || t[30] !== p || t[31] !== P || t[32] !== F
    ? ((ne = (0, Y.jsx)(le, {
...
function Sr(e) {
  ...
  let [A, j] = (0, zr.useState)(k),
    M;
  t[6] !== g || t[7] !== r
    ? ((M = () => r !== `add-credits` || !Be(g, `2317709095`)), (t[6] = g), (t[7] = r), (t[8] = M))
    : (M = t[8]);
  ...
  let he = pe,
    ge;
  t[15] !== z || t[16] !== T
    ? ((ge = z ? `invalid-currency-amount` : Ln(T)), (t[15] = z), (t[16] = T), (t[17] = ge))
    : (ge = t[17]);
  let _e = ge,
    ve;
  t[18] !== oe || t[19] !== A || t[20] !== b
    ? ((ve = oe ? `invalid-currency-amount` : Un({ monthlyLimit: A, targetBalance: b })),
      (t[18] = oe),
      (t[19] = A),
      (t[20] = b),
      (t[21] = ve))
  ...
  let ye = ve,
    be,
    xe;
  t[22] !== z || t[23] !== oe || t[24] !== T || t[25] !== A || t[26] !== i || t[27] !== b
    ? ((be = z || oe ? null : Wn({ minimumBalance: T, targetBalance: b, monthlyLimit: A })),
  ...
  t[50] !== u
    ? ((ke = async () => {
        if ((I(!0), U)) {
          he ??
            Pr({ scope: m, source: n, email: h, quantity: b, onOpenChange: f, statsigClient: g });
          return;
        }
        if ((ne(!0), re(!0), !(W == null || H)))
          try {
            if ((Te(), be == null)) return;
            let e = W === `enable` ? await l.mutateAsync(be) : await u.mutateAsync(be);
            if ((Pe(m, We, { action: W, source: n }), Ot(e.immediate_top_up_status))) {
              (B(!0),
                de(
                  nr({
                    intl: _,
  ...
  t[98] !== o || t[99] !== _ || t[100] !== s || t[101] !== Le
    ? ((K = (0, Y.jsx)(Mr, { intl: _, creditDetails: o, pricingInfo: s, actions: Le })),
      (t[98] = o),
      (t[99] = _),
      (t[100] = s),
      (t[101] = Le),
  ...
  t[141] !== Ye || t[142] !== Xe || t[143] !== Ze
    ? ((Qe = (0, Y.jsxs)(le, { className: `gap-4 pt-4`, children: [Ye, Xe, Ze] })),
      (t[141] = Ye),
      (t[142] = Xe),
      (t[143] = Ze),
      (t[144] = Qe))
...
function Dr(e) {
  let t = (0, Rr.c)(16),
    ...
    s;
  t[0] !== n || t[1] !== i || t[2] !== o
    ? ((s = tr({ intl: n, creditQuantity: Number.parseInt(Kn(i), 10), pricingInfo: o })),
      (t[0] = n),
      (t[1] = i),
      (t[2] = o),
      (t[3] = s))
  ...
  let c = s,
    l;
  t[4] !== n || t[5] !== o || t[6] !== r
    ? ((l = tr({ intl: n, creditQuantity: Number.parseInt(Kn(r), 10), pricingInfo: o })),
      (t[4] = n),
      (t[5] = o),
      (t[6] = r),
      (t[7] = l))
  ...
  let u = l,
    d;
  t[8] !== n || t[9] !== a || t[10] !== o
    ? ((d = tr({ intl: n, creditQuantity: Number.parseInt(Kn(a), 10), pricingInfo: o })),
      (t[8] = n),
      (t[9] = a),
      (t[10] = o),
      (t[11] = d))
...
function Or(e) {
  ...
  t[6] === c
    ? (u = t[7])
    : ((u = c === `button` ? (0, Y.jsx)(Ar, { children: (0, Y.jsx)(kr, {}) }) : (0, Y.jsx)(kr, {})),
      (t[6] = c),
      (t[7] = u));
  let d;
  return (
    t[8] !== l || t[9] !== u
      ? ((d = (0, Y.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [l, u] })),
        (t[8] = l),
        (t[9] = u),
        (t[10] = d))
      : (d = t[10]),
...
function Mr(e) {
  ...
  t[7] === a
    ? (l = t[8])
    : ((l = (0, Y.jsx)(`div`, { className: `shrink-0`, children: a })), (t[7] = a), (t[8] = l));
  let u;
  return (
    t[9] !== c || t[10] !== l
      ? ((u = (0, Y.jsxs)(`div`, {
...
function Nr({ intl: e, creditDetails: t, pricingInfo: n }) {
  return t == null || t.unlimited
    ? null
    : (tr({ intl: e, creditQuantity: Math.floor(Number(t.balance ?? 0)), pricingInfo: n }) ??
        e.formatNumber(0));
}
function Pr({ scope: e, source: t, email: n, quantity: i, onOpenChange: a, statsigClient: o }) {
  let s = Kn(i);
...
function Lr(e) {
  ...
  let p;
  t[7] !== o || t[8] !== a
    ? ((p = (0, Y.jsx)(Ne, { title: a, subtitle: o })), (t[7] = o), (t[8] = a), (t[9] = p))
    : (p = t[9]);
  let m;
  ...
  t[14] === s
    ? (h = t[15])
    : ((h = (0, Y.jsx)(le, { className: `pt-4`, children: s })), (t[14] = s), (t[15] = h));
  let g;
  return (
    t[16] !== l || t[17] !== u || t[18] !== m || t[19] !== h
      ? ((g = (0, Y.jsxs)(se, { as: `form`, onSubmit: u, children: [m, l, h] })),
        (t[16] = l),
        (t[17] = u),
        (t[18] = m),
        (t[19] = h),
...
function Wr(e) {
  ...
  t[15] === n
    ? (s = t[16])
    : ((s = { "aria-describedby": n, onOpenAutoFocus: Gr }), (t[15] = n), (t[16] = s));
  let c;
  t[17] !== i || t[18] !== e
    ? ((c = (t) => {
...
function Kr(e) {
  ...
  t[20] !== m || t[21] !== g
    ? ((_ = (0, X.jsx)(le, {
        className: `pt-4`,
        children: (0, X.jsxs)(`div`, { className: `flex justify-end gap-3`, children: [m, g] }),
      })),
      (t[20] = m),
      (t[21] = g),
      (t[22] = _))
  ...
  return (
    t[23] !== _ || t[24] !== l || t[25] !== d || t[26] !== p
      ? ((v = (0, X.jsxs)(se, { className: `gap-0 px-4 py-4`, children: [l, d, p, _] })),
        (t[23] = _),
        (t[24] = l),
        (t[25] = d),
        (t[26] = p),
...
function Xr(e) {
  ...
  let { data: c, isError: l, refetch: u } = At(s),
    { enableAutoTopUpMutation: d, updateAutoTopUpMutation: f, disableAutoTopUpMutation: p } = Ht(),
    m;
  ...
  let { data: h, isPending: g, isError: _, refetch: v } = jt(m),
    y;
  t[3] === h ? (y = t[4]) : ((y = { billingCurrency: h, enabled: !0 }), (t[3] = h), (t[4] = y));
    ...
    e[0] !== i || e[1] !== t || e[2] !== n
      ? ((o = (e) => {
          if (e.intent === `purchase` && e.isCustomCheckoutEnabled) {
            En(
              Ct({ loginHint: i, statsigClient: n, url: `${r}/purchase/credits?quantity=1000` }),
              e.event,
            );
            return;
          }
          ...
          if (ei({ intent: e.intent, isCombinedModalEnabled: a }) === `combined-modal`) {
            (Pe(t, Ue, { isAutoReloadEnabledAtOpen: e.isAutoReloadEnabled, source: e.source }),
              A(t, Xr, {
                source: e.source,
                variant: ti({ intent: e.intent, isAutoReloadEnabled: e.isAutoReloadEnabled }),
              }));
            return;
          }
...
function oi(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = () => (qe(r, `337040058`, { disableExposureLog: !n }).get(ci, !1) ? _t : ft)),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
var _i,
  ...
  Di = e(() => {
    (L(),
      ...
      (Ei = { [I.FREE]: 0, [I.GO]: 1, [I.PLUS]: 2, [I.PROLITE]: 3, [I.PRO]: 4 }));
  }),
  Oi,
  ki,
  Ai = e(() => {
...
function ji() {
  ...
  e[0] === t
    ? (n = e[1])
    : ((n = qe(t, Ii, { disableExposureLog: !0 }).get(`surface`, `web`)), (e[0] = t), (e[1] = n));
  let r = n;
...
async function Pi(e, t, n, r, i) {
  ...
  if (
    (r === I.PLUS &&
      (a = qe(t, Ii, { disableExposureLog: !1 }).get(`default_plus_to_business`, !1)
        ? `business`
        : `personal`),
    n == null)
  )
...
function Bi(e) {
  return e == null
    ...
    : {
        ...
        windowMinutes: e.limit_window_seconds == null ? null : e.limit_window_seconds / Vi,
...
function Zi(e, t) {
  ...
  return Array.isArray(r) ? r.some((e) => (ot(e) ? ea(e.limit_name) === n : !1)) : !1;
}
function Qi(e) {
...
function ma(e) {
  ...
  t[3] === o
    ...
    : ((_ = o ? { opacity: 0, scale: 0.985, y: -4 } : { opacity: 1, scale: 1, y: 0 }),
      ...
      (t[4] = _));
  let v;
  t[5] === p ? (v = t[6]) : ((v = p ? { duration: 0 } : va), (t[5] = p), (t[6] = v));
  let y;
  t[7] !== o || t[8] !== s
    ? ((y = () => {
        o && s();
  ...
  t[23] === O
    ? (k = t[24])
    : ((k = W(`justify-center border-transparent !text-sm !leading-5 font-medium`, O)),
      (t[23] = O),
      (t[24] = k));
  let A = n === (g ?? `automatic`),
    j;
  ...
  t[29] === f
    ? (N = t[30])
    : ((N = (0, _a.jsx)(`span`, { id: f, children: M })), (t[29] = f), (t[30] = N));
  let P;
  t[31] !== i ||
  t[32] !== E ||
  t[33] !== D ||
...
function ba(e) {
  ...
  t[9] !== x || t[10] !== S
    ...
    : (C = t[11]);
  let w;
  t[12] === C ? (w = t[13]) : ((w = (0, Ca.jsx)(U, { className: C })), (t[12] = C), (t[13] = w));
  let T;
  t[14] !== b || t[15] !== w
    ? ((T = (0, Ca.jsxs)(`span`, {
...
var Ra,
  ...
  oo,
  so = e(() => {
    ((io = `_shimmer_1lvpw_1`), (ao = `_bloom_1lvpw_14`), (oo = { shimmer: io, bloom: ao }));
  });
function co(e) {
  let t = (0, uo.c)(19),
    {
...
function mo(e) {
  ...
  if (t[5] !== n || t[6] !== o || t[7] !== a.resetsAt || t[8] !== a.windowMinutes) {
    ...
    (t[14] !== o || t[15] !== a.windowMinutes
      ? ((r = go(a.windowMinutes, o)), (t[14] = o), (t[15] = a.windowMinutes), (t[16] = r))
      : (r = t[16]),
      (g = r),
      t[17] === n
        ? (h = t[18])
...
function xo(e) {
    ...
    ? ((ye = async (e) => {
        ...
        switch (r.status) {
          case `failed`:
            ...
            return;
          case `retry`:
            (v((e) => (e == null ? null : { ...e, creditId: r.creditId ?? `automatic` })),
              O(`retry`));
            return;
          case `completed`: {
  ...
  let Fe = me ?? `calc(100dvh / ${h} - ${32 / h}px)`,
    G;
  t[47] === Fe ? (G = t[48]) : ((G = { maxHeight: Fe }), (t[47] = Fe), (t[48] = G));
  let Ie;
  t[49] === U
    ? (Ie = t[50])
    : ((Ie = U
  ...
  let Be;
  t[57] !== Le || t[58] !== ze
    ? ((Be = (0, Z.jsxs)(le, { children: [Le, ze] })), (t[57] = Le), (t[58] = ze), (t[59] = Be))
    : (Be = t[59]);
  ...
  t[89] !== H || t[90] !== s || t[91] !== u || t[92] !== m || t[93] !== de
    ? ((Ye = de
        ? (0, Z.jsx)(le, {
            className: `pt-4`,
            children: (0, Z.jsxs)(`div`, {
              className: W(`grid gap-3`, s != null && u != null ? `grid-cols-2` : `grid-cols-1`),
              children: [
                u == null
                  ? null
                  : (0, Z.jsxs)(R, {
...
function ko(e) {
  ...
  return (
    t[21] !== r || t[22] !== i || t[23] !== y || t[24] !== b
      ? ((x = (0, jo.jsx)(xo, { ...i, onAddCredits: y, onClose: r, onUpgradePlan: b })),
        (t[21] = r),
        (t[22] = i),
        (t[23] = y),
        (t[24] = b),
...
var Ao,
  jo,
  Mo = e(() => {
    ((Ao = g()), u(), ct(), ai(), An(), li(), Sn(), i(), Di(), zi(), et(), L(), Oo(), (jo = S()));
  });
function No(e) {
  let t = (0, Fo.c)(26),
...
var Fo,
  ...
  Bo,
  Vo = e(() => {
    Bo = `` + new URL(`referral-modal-background-DumA0TET.png`, import.meta.url).href;
  });
function Ho(e) {
  let t = (0, Uo.c)(43),
...
var Uo,
  ...
  Go,
  Ko = e(() => {
    ((Uo = g()), (Wo = t(d(), 1)), G(), zo(), Vo(), M(), j(), k(), ke(), (Go = S()));
  });
function qo(e) {
  let t = (0, ns.c)(22),
  ...
  let te = n.map(ee),
    ne;
  t[3] === b ? (ne = t[4]) : ((ne = (e) => !b.some((t) => t === e.id)), (t[3] = b), (t[4] = ne));
  let L = [...b.map((e) => te.find((t) => t.id === e)).filter(Xo), ...te.filter(ne)],
    re = L.length > 1,
    R = L.slice(0, as),
    ie = R.find((e) => e.id === p) ?? R[0],
    z = R.find((e) => e.id === h && e.id !== ie?.id) ?? R.find((e) => e.id !== ie?.id),
    ae = [
      ie,
      z,
    ...
    fe = (e) => {
      l !== `collapsing` ||
        O.current.has(e) ||
        (O.current.add(e),
        O.current.size === R.length - is && (x(k.current), u(null), C(new Set(O.current)), f(!1)));
    },
    V;
  (t[5] === Symbol.for(`react.memo_cache_sentinel`) ? ((V = []), (t[5] = V)) : (V = t[5]),
    (0, Q.useEffect)(
      () => () => {
  ...
  t[6] === _e
    ? (ve = t[7])
    : ((ve = W(`relative z-10 overflow-hidden pt-2 pb-10`, _e)), (t[6] = _e), (t[7] = ve));
  let ye, be;
  ...
  let xe = oe.map((e) => {
      ...
      return (0, rs.jsx)(
        ge.div,
        {
            ...
            a && E
              ...
              : s
                ? {
                    ...
                    duration: 0.4,
                    ease: [0.23, 1, 0.32, 1],
                    opacity: { duration: 0.14, delay: Math.max(t - is, 0) * 0.012 },
                  }
                : {
                    type: `spring`,
                    stiffness: a ? 260 : 330,
                    ...
                    opacity: {
                      duration: 0.18,
                      delay: a ? Math.max(t - is, 0) * 0.018 : o ? (R.length - t - 1) * 0.014 : 0,
                    },
                    ...(c
                      ? {
          ...
          style: { zIndex: a ? as - t : r === 0 ? 30 : r === 1 ? 20 : r === 2 ? 10 : 9 - t },
          onAnimationComplete: () => {
  ...
  t[10] === xe
    ? (Se = t[11])
    : ((Se = (0, rs.jsx)(`div`, { className: `grid min-w-full select-none`, children: xe })),
      (t[10] = xe),
      (t[11] = Se));
  let Ce;
  return (
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (0, rs.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, rs.jsx)(bt, { className: `size-4 text-token-text-secondary opacity-70` }),
        ],
      })),
      (t[16] = b))
    : (b = t[16]);
...
function vs(e) {
  ...
  let O;
  t[21] !== l || t[22] !== D
    ? ((O = { "aria-describedby": l, onEscapeKeyDown: D }), (t[21] = l), (t[22] = D), (t[23] = O))
    : (O = t[23]);
  let k;
  t[24] === w
    ? (k = t[25])
...
var bs,
  ...
  $,
  Ss = e(() => {
    ((bs = g()), (xs = t(d(), 1)), G(), F(), M(), j(), k(), ke(), _s(), ($ = S()));
  });
function Cs() {
  let e = !1,
    t;
...
function Es(e) {
  let t = (0, As.c)(5),
    ...
    i = null;
  if ((r === `workspace` ? (i = Ps) : r === `personal` && (i = Ns), i == null)) {
    let n;
    return (
      t[0] === e
        ? (n = t[1])
        : ((n = (0, Ms.jsx)(Os, { ...e, componentType: Fs })), (t[0] = e), (t[1] = n)),
      n
    );
  }
  let a;
  return (
    t[2] !== i || t[3] !== e
      ? ((a = (0, Ms.jsx)(Ds, { ...e, layerName: i })), (t[2] = i), (t[3] = e), (t[4] = a))
      : (a = t[4]),
    a
  );
}
function Ds(e) {
  ...
  return (
    t[3] !== i || t[4] !== r
      ? ((a = (0, Ms.jsx)(Os, { ...r, componentType: i })), (t[3] = i), (t[4] = r), (t[5] = a))
      : (a = t[5]),
    a
  );
}
function Os(e) {
  ...
  t[11] !== l
    ? ((v = async (e, t) => {
        ...
        p(null);
        let o = await d.redeem({ availableCount: a, consume: m.mutateAsync, creditId: e });
        switch (o.status) {
          case `in_flight`:
  ...
  let b;
  return (
    t[19] !== f || t[20] !== _ || t[21] !== y || t[22] !== r || t[23] !== i || t[24] !== h
      ? ((b = (0, Ms.jsx)(vs, {
          errorMessage: f,
          initialAvailableCount: r,
          isRateLimitReached: i,
