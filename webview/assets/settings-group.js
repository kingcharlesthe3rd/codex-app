...
function a(e) {
  let t = (0, r.c)(6),
    ...
    c;
  t[0] === s ? (c = t[1]) : ((c = n(`flex flex-col`, s)), (t[0] = s), (t[1] = c));
  let l;
  return (
    t[2] !== a || t[3] !== o || t[4] !== c
...
function o(e) {
  ...
  let p = f
    ...
    m;
  t[1] !== c || t[2] !== p ? ((m = n(p, c)), (t[1] = c), (t[2] = p), (t[3] = m)) : (m = t[3]);
  let h = u === `none` ? `gap-0` : `gap-1`,
    g;
  t[4] === h ? (g = t[5]) : ((g = n(`flex min-w-0 flex-1 flex-col`, h)), (t[4] = h), (t[5] = g));
  let _;
  t[6] === a
    ? (_ = t[7])
    : ((_ = a
...
function s(e) {
  let t = (0, r.c)(5),
    ...
    s;
  t[0] === o ? (s = t[1]) : ((s = n(`flex flex-col gap-1.5`, o)), (t[0] = o), (t[1] = s));
  let c;
  return (
    t[2] !== a || t[3] !== s
      ? ((c = (0, i.jsx)(`div`, { className: s, children: a })), (t[2] = a), (t[3] = s), (t[4] = c))
      : (c = t[4]),
    c
  );
}
