      ...
      (Xe = class e extends He {
        ...
        use(e, ...t) {
          ...
          function a(e) {
            ...
            (o(e.plugins), e.settings && (r.settings = (0, B.default)(!0, r.settings, e.settings)));
          }
          function o(e) {
            let t = -1;
            if (e != null)
          ...
          function s(e, t) {
            ...
            if (i === -1) n.push([e, ...t]);
              ...
              let [r, ...a] = t,
                o = n[i][1];
              (he(o) && he(r) && (r = (0, B.default)(!0, o, r)), (n[i] = [e, r, ...a]));
            }
          }
        }
      }),
  ...
  function c(e, t) {
    ...
    for (; d;) {
      let n = d.index,
        ...
        o = i(...d, a);
      if (
        (typeof o == `string` && (o = o.length > 0 ? { type: `text`, value: o } : void 0),
        o === !1
          ? (r.lastIndex = n + 1)
...
function ft() {
  return {
    unsafe: [
      ...
      { character: `.`, before: `[Ww]`, after: `[\\-.\\w]`, inConstruct: H, notInConstruct: U },
      { character: `:`, before: `[ps]`, after: `\\/`, inConstruct: H, notInConstruct: U },
    ],
  };
}
function pt(e) {
...
function yt(e, t, n, r, i) {
  let a = ``;
  if (!Ct(i) || (/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !xt(n))) return !1;
  let o = St(n + r);
  if (!o[0]) return !1;
  let s = {
    type: `link`,
...
function Ct(e, t) {
  ...
  return (e.index === 0 || d(n) || y(n)) && (!t || n !== 47);
}
var H,
  U,
  wt = e(() => {
    (l(), O(), h(), ut(), (H = `phrasing`), (U = [`autolink`, `link`, `image`, `label`]));
  }),
  Tt = e(() => {
    wt();
  });
...
function Ht() {
  return { canContainEols: [`delete`], enter: { strikethrough: Wt }, exit: { strikethrough: Gt } };
}
function Ut() {
  return {
...
function nn() {
  return {
    ...
    exit: { codeText: cn, table: an, tableData: W, tableHeader: W, tableRow: W },
  };
}
function rn(e) {
  let t = e._align;
...
`,
    ...
    handlers: { inlineCode: p, table: s, tableCell: l, tableRow: c },
  };
  function s(e, t, n, r) {
...
function pn() {
  return {
    exit: { taskListCheckValueChecked: hn, taskListCheckValueUnchecked: hn, paragraph: gn },
  };
}
function mn() {
  return { unsafe: [{ atBreak: !0, character: `-`, after: `[:|-]` }], handlers: { listItem: _n } };
}
function hn(e) {
...
function _n(e, t, n, r) {
  let i = e.children[0],
    ...
    c = n.createTracker(r);
  a && c.move(s);
  let l = o.listItem(e, t, n, { ...r, ...c.current() });
...
function Dn(e, t, n) {
  ...
  function s(t) {
    if (p(t) && i.length < 5) return ((i += String.fromCodePoint(t)), e.consume(t), s);
    if (t === 58) {
      let n = i.toLowerCase();
  ...
  function l(t) {
    return t === null || ce(t) || C(t) || d(t) || y(t) ? n(t) : e.attempt(q, e.attempt(J, u), n)(t);
  }
  function u(n) {
...
function jn(e, t, n) {
  ...
  function i(e) {
    return e === null || e === 40 || e === 91 || C(e) || d(e) ? t(e) : r(e);
  }
  function a(e) {
    return p(e) ? o(e) : n(e);
  }
...
function Nn(e) {
  return (
    e === null || e === 40 || e === 42 || e === 95 || e === 91 || e === 93 || e === 126 || C(e)
  );
}
function Pn(e) {
  return !p(e);
...
function Kn(e, t, n) {
  ...
  function l(s) {
    if (a > 999 || (s === 93 && !o) || s === null || s === 91 || C(s)) return n(s);
    if (s === 93) {
      e.exit(`chunkString`);
    ...
    return (C(s) || (o = !0), a++, e.consume(s), s === 92 ? u : l);
  }
  function u(t) {
...
function qn(e, t, n) {
  ...
  function u(t) {
    if (o > 999 || (t === 93 && !s) || t === null || t === 91 || C(t)) return n(t);
    if (t === 93) {
      e.exit(`chunkString`);
    ...
    return (C(t) || (s = !0), o++, e.consume(t), t === 92 ? d : u);
  }
  function d(t) {
...
var Zn,
  Qn = e(() => {
    (ee(), S(), h(), re(), (Zn = { tokenize: Xn, partial: !0 }));
  }),
  $n = e(() => {
    Qn();
  });
      ...
      if (
        ...
        for (; r--;)
          if (
            ...
            (s && E(o, o.length, 0, f(s, e.slice(r + 1, n), t)),
              E(o, o.length, 0, [
                [`exit`, a, t],
                [`enter`, e[n][1], t],
                [`exit`, e[n][1], t],
...
function lr(e, t, n) {
  ...
  function s(e) {
    ...
    let i = t > -1 ? r.events[t][1].type : null,
      a = i === `tableHead` || i === `tableRow` ? ne : c;
    return a === ne && r.parser.lazy[r.now().line] ? n(e) : a(e);
  }
  function c(t) {
  ...
  function h(t) {
    return T(t) ? b(e, g, `whitespace`)(t) : g(t);
  }
  function g(t) {
    return t === 58
      ? ((a += 1),
  ...
  function _(t) {
    return T(t) ? b(e, v, `whitespace`)(t) : v(t);
  }
  function v(n) {
    return n === 124
      ? m(n)
...
function hr(e, t, n) {
  ...
  function s(r) {
    return w(r) ? t(r) : T(r) ? e.check({ tokenize: gr }, t, n)(r) : n(r);
  }
}
function gr(e, t, n) {
...
var _r,
  vr = e(() => {
    (S(), h(), (_r = { name: `tasklistCheck`, tokenize: hr }));
  }),
  yr = e(() => {
    vr();
  });
function br(e) {
  return oe([wn(), Un(), er(e), cr(), mr()]);
}
var xr = e(() => {
  (le(), Hn(), $n(), nr(), pr(), yr());
});
...
function kr(e) {
  ...
  for (let e of t.children) {
    let t = e.children.map((e) => Or(ue(e)));
...
//# sourceMappingURL=workbook-from-markdown-D.js.map
