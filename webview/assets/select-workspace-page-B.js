...
import { i as C, n as w } from "./react.js";
import { c as ee, o as T } from "./lib-2.js";
import { m as te } from "./chunk-9.js";
import { g as E, h as D } from "./persisted-signal.js";
import "./rpc-2.js";
import "./statsig.js";
import "./request.js";
import { s as O } from "./app-server-manager-hooks.js";
...
import { a as oe, i as se } from "./onboarding-state.js";
...
import "./minus.js";
import "./search.js";
import { n as ue, t as j } from "./add-project-menu-items.js";
import "./dropdown.js";
import "./plus.js";
...
import { a as he, i as N, n as P, r as F, t as ge } from "./onboarding-shell.js";
var I = e(l(), 1);
function _e(e, t) {
  let n = f(t),
    r = n.getQueryCache();
  return I.useSyncExternalStore(
    I.useCallback((e) => r.subscribe(g.batchCalls(e)), [r]),
    () => n.isFetching(e),
    () => n.isFetching(e),
  );
}
...
function B() {
  let e = (0, L.c)(112),
    ...
    [o, s] = w(oe),
    c = C(se),
    { data: l, isFetching: u } = O(),
    d = l === void 0 ? [] : l,
    f = de(),
    g;
  e[0] === f ? (g = e[1]) : ((g = (e) => !fe(e, f)), (e[0] = f), (e[1] = g));
  let y = d.filter(g).map(Ee),
    { data: b, isFetching: T } = m(k),
    { data: ne, isFetching: re } = h(ae, {
      params: { dirs: (0, R.default)(Ae(y), Te).sort(we) },
      source: `onboarding_workspace_select`,
    }),
    { data: le, isFetching: ue } = ie(),
    {
      autoLaunchAction: j,
      isRemoteHost: M,
  ...
  let Ie = Fe,
    ...
    ze = je({ tasks: y, gitOrigins: ne?.origins, codexHome: le?.codexHome }),
    Be = (0, R.default)([...(q ?? []), ...ze, ...ge], Ce).sort(Se),
    Ve;
  e[6] === b?.labels
    ? (Ve = e[7])
    : ((Ve = (e) => {
  ...
  e[17] !== P
    ? ((Ge = (e) => {
        B((t) => (0, R.default)([...t, e.root], be));
        let n = { ...H, [e.root]: !0 };
        U(n);
        let i = J.includes(e.root);
        E(t, {
          eventName: `codex_onboarding_workspace_selection_changed`,
          metadata: {
            action: `toggle_root`,
            selected_workspaces_count: ke(n, J) + (i ? 0 : 1),
            total_workspaces_count: i ? J.length : J.length + 1,
            experiment_arm: P,
            checked: !0,
      ...
      (e[18] = Ge))
    : (Ge = e[18]),
    x(`workspace-root-option-picked`, Ge));
  let Ke;
  (e[19] !== r.accountId ||
  e[20] !== r.userId ||
  e[21] !== J.length ||
  ...
  e[28] !== P
    ? ((Ke = (e) => {
        if ((G(!1), e.success)) {
          (E(t, {
            ...
            metadata: {
              ...
              total_workspaces_count: J.length,
              auto_navigated: !1,
              experiment_arm: P,
              user_id: r.userId ?? void 0,
              workspace_id: r.accountId ?? void 0,
            ...
            D(t, n, { selectedWorkspacesCount: 1, experimentArm: P }),
            K(null),
      ...
      (e[29] = Ke))
    : (Ke = e[29]),
    x(`electron-onboarding-skip-workspace-result`, Ke));
  let qe;
  e[30] !== r.accountId ||
  e[31] !== r.userId ||
  e[32] !== Re ||
        ...
        (U(i),
          E(t, {
            ...
            metadata: {
              action: `toggle_root`,
              checked: n,
              selected_workspaces_count: ke(i, J),
              total_workspaces_count: J.length,
              experiment_arm: P,
              user_id: r.userId ?? void 0,
              workspace_id: r.accountId ?? void 0,
        ...
        (U(n),
          E(t, {
            ...
            metadata: {
              action: `select_all`,
              checked: e,
              selected_workspaces_count: ke(n, J),
              total_workspaces_count: J.length,
              experiment_arm: P,
              user_id: r.userId ?? void 0,
              workspace_id: r.accountId ?? void 0,
  ...
  e[63] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((nt = { queryKey: [S, `paths-exist`] }), (e[63] = nt))
    : (nt = e[63]);
  let rt = _e(nt),
    Z = u || T || re || ue || rt > 0,
    it = He.length > 0,
  ...
  e[64] !== Ze || e[65] !== Z || e[66] !== j || e[67] !== N
    ...
    : (ct = e[68]);
  let lt;
  (e[69] !== Z || e[70] !== j || e[71] !== N
    ? ((lt = [Z, j, N]), (e[69] = Z), (e[70] = j), (e[71] = N), (e[72] = lt))
    : (lt = e[72]),
    (0, I.useEffect)(ct, lt));
  let ut;
  e[73] !== r.accountId ||
  ...
  e[82] !== P
    ? ((ut = (e, a) => {
        (E(t, {
          ...
          D(t, n, { selectedWorkspacesCount: e.length, experimentArm: P }));
        let l = e;
        (c(Math.floor(Date.now() / 1e3)),
          o === `workspace` && q != null && (l = (0, R.default)([...q, ...e], ve)),
          _.dispatchMessage(`electron-update-workspace-root-options`, { roots: l }),
          s(`auto`),
          (Le.current += 1),
          ce.select(t, { path: e[0], projectId: e[0] }),
          i(`/`, { replace: !0, state: { focusComposerNonce: Le.current } }));
      }),
      (e[73] = r.accountId),
      (e[74] = r.userId),
      (e[75] = i),
...
function Ee(e) {
  return { kind: `local`, key: o(e.id), at: e.createdAt, conversation: e };
}
function V(e) {
  let t = (0, L.c)(7),
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = r ? (0, z.jsx)(ue, { className: `h-10 w-10`, "aria-hidden": `true` }) : null),
      (t[0] = r),
      (t[1] = i));
  let a, o;
...
function H(e) {
  ...
  t[1] !== n || t[2] !== r || t[3] !== s || t[4] !== c
    ? ((u = (0, z.jsx)(ne, { className: n, color: r, size: s, onClick: c, children: l })),
      (t[1] = n),
      (t[2] = r),
      (t[3] = s),
      (t[4] = c),
  ...
  return (
    t[6] !== a || t[7] !== o || t[8] !== d
      ? ((f = (0, z.jsx)(j, { triggerButton: d, onStartFromScratch: a, onUseExistingFolder: o })),
        (t[6] = a),
        (t[7] = o),
        (t[8] = d),
        (t[9] = f))
...
function Oe(e) {
  ...
  t[12] !== b
    ? ((S = r
        ? (0, z.jsxs)(P, {
            className: d(n && `pointer-events-none opacity-50`),
  ...
  let C;
  t[14] !== x || t[15] !== S
    ? ((C = (0, z.jsxs)(`div`, { className: `flex w-full flex-col gap-2`, children: [x, S] })),
      (t[14] = x),
      (t[15] = S),
      (t[16] = C))
    : (C = t[16]);
...
function W(e) {
  let t = (0, L.c)(21),
    { index: n, isDisabled: i, isSelected: o, skipExistenceCheck: c, option: l, onToggle: u } = e,
    d = l.root,
    f;
  t[0] === d ? (f = t[1]) : ((f = s(d)), (t[0] = d), (t[1] = f));
  let p = f,
    m = a(d).replace(/\/+$/, ``),
    h,
    g;
  ...
  t[7] !== h || t[8] !== g || t[9] !== v
    ? ((y = { params: h, placeholderData: g, queryConfig: v }),
      ...
      (t[10] = y))
    : (y = t[10]);
  let { data: x } = b(`paths-exist`, y);
  if (!(c || (x?.existingPaths ?? []).some((e) => a(e).replace(/\/+$/, ``) === m))) return null;
  let S = `workspace-root-${n}`,
    C;
  t[11] !== u || t[12] !== d
    ? ((C = (e) => {
        u(d, e);
  ...
  let w;
  return (
    t[14] !== S || t[15] !== p || t[16] !== i || t[17] !== o || t[18] !== l.label || t[19] !== C
      ? ((w = (0, z.jsx)(F, {
          checkboxId: S,
          checkboxClassName: ge,
          checked: o,
...
function je({ tasks: e, gitOrigins: n, codexHome: r }) {
  let i = Ae(e);
...
//# sourceMappingURL=select-workspace-page-B.js.map
