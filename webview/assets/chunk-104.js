import { c as e, g as t, i as n, n as r, r as i, t as a } from "./_baseUniq-1.js";
import { t as o } from "./isEmpty-1.js";
import {
  $ as s,
  _ as c,
  et as l,
...
var te = class e {
  ...
  join(e = `,`) {
    let t = this.iterator(),
      ...
      r,
      i = !1;
    do ((r = t.next()), r.done || (i && (n += e), (n += ne(r.value))), (i = !0));
    while (!r.done);
    return n;
  }
  indexOf(e, t = 0) {
  ...
  for (let [n, r] of Object.entries(e))
    n.startsWith(`$`) ||
      (Array.isArray(r)
        ...
        : v(r) && ((r.$container = e), (r.$containerProperty = n), t.deep && ae(r, t)));
}
function oe(e, t) {
  let n = e;
  for (; n; ) {
          ...
          if (Array.isArray(r)) {
            for (; t.arrayIndex < r.length; ) {
              let i = t.arrayIndex++,
                a = r[i];
              if (y(a) || b(r))
                return { done: !1, value: { reference: a, container: e, property: n, index: i } };
            }
            t.arrayIndex = 0;
          }
        }
...
function ue(e, t) {
  ...
  for (let e of Object.values(n.properties))
    e.defaultValue !== void 0 && r[e.name] === void 0 && (r[e.name] = de(e.defaultValue));
}
function de(e) {
...
const ye = { $type: `Alternatives`, cardinality: `cardinality`, elements: `elements` };
function be(e) {
...
const Ge = {
  ...
  qe = { $type: `Interface`, attributes: `attributes`, name: `name`, superTypes: `superTypes` };
function Je(e) {
  return L.isInstance(e, qe.$type);
}
const Ye = { $type: `Keyword`, cardinality: `cardinality`, predicate: `predicate`, value: `value` };
function Xe(e) {
  return L.isInstance(e, Ye.$type);
}
const Ze = {
...
const ct = { $type: `ReferenceType`, isMulti: `isMulti`, referenceType: `referenceType` },
  lt = {
    $type: `RegexToken`,
    cardinality: `cardinality`,
    lookahead: `lookahead`,
...
const kt = {
  ...
  Mt = { $type: `UnorderedGroup`, cardinality: `cardinality`, elements: `elements` };
function Nt(e) {
  ...
  constructor() {
    (super(...arguments),
      (this.types = {
        ...
        AbstractParserRule: { name: pe.$type, properties: {}, superTypes: [he.$type, ge.$type] },
        ...
        GrammarImport: { name: Re.$type, properties: { path: { name: Re.path } }, superTypes: [] },
        Group: {
          name: ze.$type,
          properties: {
        ...
        InfixRuleOperators: {
          name: Ke.$type,
          properties: { precedences: { name: Ke.precedences, defaultValue: [] } },
          superTypes: [],
        },
        Interface: {
          name: qe.$type,
          properties: {
            ...
            name: { name: qe.name },
            superTypes: { name: qe.superTypes, defaultValue: [], referenceType: ge.$type },
          },
          superTypes: [ge.$type],
        },
        Keyword: {
        ...
        Parameter: { name: rt.$type, properties: { name: { name: rt.name } }, superTypes: [] },
        ParameterReference: {
          name: it.$type,
          properties: { parameter: { name: it.parameter, referenceType: rt.$type } },
          superTypes: [ke.$type],
        },
        ParserRule: {
          name: ot.$type,
        ...
        ReturnType: { name: dt.$type, properties: { name: { name: dt.name } }, superTypes: [] },
        RuleCall: {
          name: pt.$type,
          properties: {
...
function Gt(e, t) {
  ...
  let n =
    ...
    r =
      e.end.line < t.end.line || (e.end.line === t.end.line && e.end.character <= t.end.character);
  return n && r ? Wt.Inside : n ? Wt.OverlapBack : r ? Wt.OverlapFront : Wt.Outside;
}
function Kt(e, t) {
...
function kn(e, t, n) {
  ...
  if (r.length !== 0)
    return ((n = n === void 0 ? 0 : Math.max(0, Math.min(n, r.length - 1))), r[n]);
}
function An(e, t, n, r) {
  if (!r) {
  ...
  return w(e) && e.astNode === n ? e.content.flatMap((e) => An(e, t, n, !1)) : [];
}
function jn(e, t, n) {
  if (!e) return;
...
function Mn(e, t, n) {
  ...
  do
    if (((i = r.next()), !i.done)) {
      let e = i.value;
      e.astNode === n ? Xe(e.grammarSource) && e.grammarSource.value === t && a.push(e) : r.prune();
    }
  while (!i.done);
  return a;
}
...
function Ln(e, t) {
  ...
  for (let n of N(e))
    if (mt(n)) {
      if (!n.rule.ref || (st(n.rule.ref) && !Ln(n.rule.ref, t)) || We(n.rule.ref)) return !1;
...
var ar = class {
  ...
  cr = class extends ar {
    constructor(e) {
      (super(e.definition), (this.ignoreAmbiguities = !1), Object.assign(this, hr(e)));
    }
  },
  z = class extends ar {
    constructor(e) {
...
function mr(e) {
  ...
  } else if (e instanceof cr) return { type: `Alternative`, definition: t(e.definition) };
  else if (e instanceof z) return { type: `Option`, idx: e.idx, definition: t(e.definition) };
  ...
  else if (e instanceof B) return { type: `Repetition`, idx: e.idx, definition: t(e.definition) };
  else if (e instanceof fr) return { type: `Alternation`, idx: e.idx, definition: t(e.definition) };
  else if (e instanceof V) {
    let t = { type: `Terminal`, name: e.terminalType.name, label: rr(e.terminalType), idx: e.idx };
    typeof e.label == `string` && (t.terminalLabel = e.label);
    let n = e.terminalType.PATTERN;
    return (e.terminalType.PATTERN && (t.pattern = n instanceof RegExp ? n.source : n), t);
...
function Sr(e, t, n) {
  return [
    new z({ definition: [new V({ terminalType: e.separator })].concat(e.definition) }),
  ].concat(t, n);
}
function Cr(e) {
...
function wr(e) {
  let t = [],
    ...
    a,
    o = !0;
  for (; i && o; ) ((a = n[r]), (o = vr(a)), (t = t.concat(Cr(a))), (r += 1), (i = n.length > r));
  return [...new Set(t)];
}
function Tr(e) {
  ...
  switch (e.type) {
    ...
    case `Alternative`:
      ...
      for (let e = 0; e < r.length; e++) {
        ...
        if ((a.type === `Group` && Hr(a) === !1) || (a.type !== `Group` && o === !1)) break;
      }
      break;
    default:
      throw Error(`non exhaustive match!`);
...
`,
  ...
  n(`Transform Patterns`, () => {
    ((i = !1),
      (a = r.map((e) => {
        ...
        if (t instanceof RegExp) {
          let e = t.source;
          return e.length === 1 && e !== `^` && e !== `$` && e !== `.` && !t.ignoreCase
            ? e
            : e.length === 2 &&
                e[0] === `\\` &&
                ![
  ...
  n(`misc mapping`, () => {
    ((o = r.map((e) => e.tokenTypeIdx)),
      ...
      (c = r.map((e) => {
        let t = e.LONGER_ALT;
        if (t) return Array.isArray(t) ? t.map((e) => r.indexOf(e)) : [r.indexOf(t)];
      })),
  ...
  n(`Line Terminator Handling`, () => {
    ...
    ((d = r.map((e) => !1)),
      t.positionTracking !== `onlyOffset` &&
        (d = r.map((t) =>
          Object.hasOwn(t, `LINE_BREAKS`) ? !!t.LINE_BREAKS : vi(t, e) === !1 && Wr(e, t.PATTERN),
        )));
  });
  let f, p, m, h;
  n(`Misc Mapping #2`, () => {
  ...
  return (
    t.safeMode ||
      n(`First Char Optimization`, () => {
        _ = r.reduce((e, n, r) => {
          if (typeof n.PATTERN == `string`) xi(e, Ci(n.PATTERN.charCodeAt(0)), h[r]);
...
function ii(e) {
  let t = [],
    n = e.map((n) =>
      e.reduce(
        (e, r) =>
          n.PATTERN.source === r.PATTERN.source && !t.includes(r) && r.PATTERN !== Hi.NA
            ? (t.push(r), e.push(r), e)
            : e,
        [],
      ),
...
function ai(e) {
  return e
    ...
    .map((e) => ({
      message:
        `Token Type: ->` + e.name + `<- static 'GROUP' can only be Lexer.SKIPPED/Lexer.NA/A String`,
      ...
      return (
        r === Hi.NA ||
          (typeof r == `string`
            ...
            : r instanceof RegExp && li(r) && e.push({ str: r.source, idx: n, tokenType: t })),
        e
      );
    }, []);
  return (
    e.forEach((e, r) => {
      n.forEach(({ str: n, idx: i, tokenType: a }) => {
        if (r < i && ci(n, e.PATTERN)) {
          ...
          t.push({ message: n, type: H.UNREACHABLE_PATTERN, tokenTypes: [e, a] });
        }
      });
    }),
    t
        ...
        n.forEach((e, i) => {
          e === void 0
            ...
            : Object.hasOwn(e, `LONGER_ALT`) &&
              (Array.isArray(e.LONGER_ALT) ? e.LONGER_ALT : [e.LONGER_ALT]).forEach((i) => {
                i !== void 0 &&
                  !n.includes(i) &&
                  r.push({
    ...
    if (
      ...
      (this.TRACE_INIT = (e, t) => {
        if (this.traceInitPerf === !0) {
          ...
          return (
            this.traceInitIndent < this.traceInitMaxIdent && a(`${n}<-- <${e}> time: ${r}ms`),
            this.traceInitIndent--,
            i
          );
        } else return t();
    ...
    (n === !0
      ...
      this.TRACE_INIT(`Lexer Constructor`, () => {
        ...
        (this.TRACE_INIT(`Lexer Config handling`, () => {
          ...
          else if (this.config.lineTerminatorCharacters === Vi.lineTerminatorCharacters)
          ...
          this.config.skipValidations === !1 &&
            (this.TRACE_INIT(`performRuntimeChecks`, () => {
              this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(
                fi(n, this.trackStartLines, this.config.lineTerminatorCharacters),
              );
            }),
            this.TRACE_INIT(`performWarningRuntimeChecks`, () => {
              this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(
                pi(n, this.trackStartLines, this.config.lineTerminatorCharacters),
              );
            })),
              ...
              if (
                ...
                this.config.skipValidations === !1 &&
                  this.TRACE_INIT(`validatePatterns`, () => {
                    this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(Jr(n, i));
                  }),
                ...
                (this.TRACE_INIT(`analyzeTokenTypes`, () => {
                  ...
                  (this.charCodeToPatternIdxToConfig[e] = r.charCodeToPatternIdxToConfig),
                  (this.emptyGroups = Object.assign({}, this.emptyGroups, r.emptyGroups)),
...
` + e,
  ...
  tokenizeInternal(e, t) {
          ...
          (d === !1
            ? A.isCustom === !0
              ? ((g = r.exec(_, y, S, T)),
                g === null
                  ? (s = null)
                  : ((s = g[0]), (u = s.length), g.payload !== void 0 && (c = g.payload)))
          ...
          if (((o = A.longerAlt), o !== void 0)) {
            ...
            for (i = 0; i < t; i++) {
              ...
              if (
                ...
                t.isCustom === !0
                  ? ((g = n.exec(_, y, S, T)),
                    g === null ? (a = null) : ((a = g[0]), g.payload !== void 0 && (l = g.payload)))
      ...
      if (u !== -1) {
        if (
          ...
          t === 0
            ...
            : ((w += t), (ee = u - r), this.updateTokenEndLineColumnLocation(p, d, r, t, w, ee, u));
        ...
        if (
          ...
          (h = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(
            _,
            t,
            m,
            n,
    ...
    return (this.hasCustom || (S.length = b), { tokens: S, groups: T, errors: C });
  }
  handleModes(e, t, n, r) {
    if (e.pop === !0) {
      let i = e.push;
  ...
  updateTokenEndLineColumnLocation(e, t, n, r, i, a, o) {
    ...
    t !== void 0 &&
      ((s = n === o - 1),
      (c = s ? -1 : 0),
      (r === 1 && s === !0) || ((e.endLine = i + c), (e.endColumn = a - 1 + -c)));
  }
...
function ea(e) {
  let t = e.pattern,
    n = {};
  if (((n.name = e.name), t !== void 0 && (n.PATTERN = t), Object.hasOwn(e, `parent`)))
...
inside top level rule: ->` +
  ...
  oa = {
    buildDuplicateFoundError(e, t) {
      function n(e) {
        return e instanceof V ? e.terminalType.name : e instanceof or ? e.nonTerminalName : ``;
      }
      let r = e.name,
        i = t[0],
        a = i.idx,
...
For Further details.`),
    ...
    buildDuplicateRuleNameError(e) {
      let t;
      return (
        (t = e.topLevelRule instanceof sr ? e.topLevelRule.name : e.topLevelRule),
  ...
  ua = class extends la {
    ...
    walkTerminal(e, t, n) {
      this.isAtEndOfPath &&
        ...
        !this.found &&
        ((this.possibleTokTypes = Cr(new cr({ definition: t.concat(n) }))), (this.found = !0));
    }
  },
  da = class extends xr {
    constructor(e, t) {
...
function ga(e, t, n = []) {
  ...
  for (; n.length < t && i < e.length; ) {
    ...
    else if (t instanceof lr) return o(t.definition.concat([new B({ definition: t.definition })]));
    else if (t instanceof ur)
      return o([
        new cr({ definition: t.definition }),
        new B({ definition: [new V({ terminalType: t.separator })].concat(t.definition) }),
      ]);
    ...
    else if (t instanceof B) r = o(t.definition.concat([new B({ definition: t.definition })]));
...
function _a(e, t, n, r) {
  let i = `EXIT_NONE_TERMINAL`,
    ...
    u = [],
    d = [];
  for (d.push({ idx: -1, def: e, ruleStack: [], occurrenceStack: [] }); d.length !== 0; ) {
    let e = d.pop();
    if (e === o) {
    ...
    if (h === i) {
      ...
      let t = [...m];
      t.push(h.idx);
      let n = { idx: f, def: h.definition.concat(a, r.slice(1)), ruleStack: e, occurrenceStack: t };
      d.push(n);
    } else if (h instanceof z) {
      let e = { idx: f, def: r.slice(1), ruleStack: p, occurrenceStack: m };
      (d.push(e), d.push(o));
      let t = { idx: f, def: h.definition.concat(r.slice(1)), ruleStack: p, occurrenceStack: m };
      d.push(t);
    } else if (h instanceof lr) {
      let e = new B({ definition: h.definition, idx: h.idx }),
        t = { idx: f, def: h.definition.concat([e], r.slice(1)), ruleStack: p, occurrenceStack: m };
      d.push(t);
    } else if (h instanceof ur) {
      let e = new B({
          definition: [new V({ terminalType: h.separator })].concat(h.definition),
          idx: h.idx,
        }),
        t = { idx: f, def: h.definition.concat([e], r.slice(1)), ruleStack: p, occurrenceStack: m };
      d.push(t);
      ...
      let t = new B({
        ...
        n = { idx: f, def: h.definition.concat([t], r.slice(1)), ruleStack: p, occurrenceStack: m };
      d.push(n);
      ...
      d.push({ idx: f, def: h.definition.concat(r.slice(1)), ruleStack: p, occurrenceStack: m });
...
function ya(e) {
  ...
  if (e instanceof lr || e === `RepetitionMandatory`) return U.REPETITION_MANDATORY;
  if (e instanceof ur || e === `RepetitionMandatoryWithSeparator`)
    return U.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (e instanceof dr || e === `RepetitionWithSeparator`) return U.REPETITION_WITH_SEPARATOR;
...
var Ta = class extends xr {
    ...
    walkAtLeastOne(e, t, n) {
      this.checkIsTarget(e, U.REPETITION_MANDATORY, t, n) || super.walkOption(e, t, n);
    }
    walkAtLeastOneSep(e, t, n) {
    ...
    walkManySep(e, t, n) {
      this.checkIsTarget(e, U.REPETITION_WITH_SEPARATOR, t, n) || super.walkOption(e, t, n);
    }
  },
  Ea = class extends gr {
    constructor(e, t, n) {
...
function Ia(e) {
  return e.lookaheadStrategy
    .validate({ rules: e.rules, tokenTypes: e.tokenTypes, grammarName: e.grammarName })
...
function Ga(e) {
  ...
  else if (n instanceof fr) t = n.definition.map((e) => Ga(e.definition)).flat();
      ...
      (e.accept(i),
        i.allProductions.forEach((i) => {
          ...
          if (Ma(s, e, a, o)[0].flat().length === 0) {
            let t = n.buildEmptyRepetitionError({ topLevelRule: e, repetition: i });
            r.push({ message: t, type: rs.NO_NON_EMPTY_LOOKAHEAD, ruleName: e.name });
          }
        }));
    }),
    r
      ...
      (n, r, a) => (
        t.definition[a].ignoreAmbiguities === !0 ||
          r.forEach((r) => {
            let o = [a];
            (e.forEach((e, n) => {
              a !== n && Na(e, r) && t.definition[n].ignoreAmbiguities !== !0 && o.push(n);
            }),
              o.length > 1 && !Na(i, r) && (i.push(r), n.push({ alts: o, path: r })));
          }),
        n
      ),
      [],
...
function $a(e, t, n, r) {
  ...
  return i.flatMap((e) => {
    ...
    let a = e.idx,
      o = e.path;
    return i
      .filter((e) => t.definition[e.idx].ignoreAmbiguities !== !0 && e.idx < a && Pa(e.path, o))
      .map((e) => {
        let i = [e.idx + 1, a + 1],
          o = t.idx === 0 ? `` : t.idx;
        return {
  ...
  return (
    e.forEach((e) => {
      ...
      if (i.includes(t)) {
        ...
        r.push({ message: i, type: rs.CONFLICT_TOKENS_RULES_NAMESPACE, ruleName: t });
      }
    }),
    r
  );
  ...
  wo = class {
    initLooksAhead(e) {
      ((this.dynamicTokensEnabled = Object.hasOwn(e, `dynamicTokensEnabled`)
        ...
        (this.maxLookahead = Object.hasOwn(e, `maxLookahead`) ? e.maxLookahead : ts.maxLookahead),
      ...
      e.forEach((e) => {
        this.TRACE_INIT(`${e.name} Rule Lookahead`, () => {
          ...
          (t.forEach((t) => {
            ...
            n.forEach((t) => {
              this.computeLookaheadFunc(e, t.idx, 768, `Repetition`, t.maxLookahead, br(t));
            }),
            r.forEach((t) => {
              this.computeLookaheadFunc(e, t.idx, 512, `Option`, t.maxLookahead, br(t));
            }),
            i.forEach((t) => {
              this.computeLookaheadFunc(e, t.idx, yo, `RepetitionMandatory`, t.maxLookahead, br(t));
            }),
            a.forEach((t) => {
...
var Ro = class {
  ...
  zo = class {
    ...
    SKIP_TOKEN() {
      return this.currIdx <= this.tokVectorLength - 2 ? (this.consumeToken(), this.LA_FAST(1)) : es;
    }
    LA_FAST(e) {
  ...
  Bo = class {
    ...
    RULE(e, t, n = ns) {
      if (this.definedRulesNames.includes(e)) {
        let t = {
          message: oa.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: this.className }),
  ...
  Vo = class {
	...
	For Further details.`);
      ...
      if (Array.isArray(e)) this.tokensMap = e.reduce((e, t) => ((e[t.name] = t), e), {});
      else if (Object.hasOwn(e, `modes`) && Object.values(e.modes).flat().every(zi)) {
        let t = Object.values(e.modes).flat();
        this.tokensMap = [...new Set(t)].reduce((e, t) => ((e[t.name] = t), e), {});
      } else if (typeof e == `object` && e) this.tokensMap = Object.assign({}, e);
      else
        throw Error(
    ...
    defineRule(e, t, n) {
      ...
      let r = Object.hasOwn(n, `resyncEnabled`) ? n.resyncEnabled : ns.resyncEnabled,
        i = Object.hasOwn(n, `recoveryValueFunc`) ? n.recoveryValueFunc : ns.recoveryValueFunc,
    ...
    atLeastOneInternalLogic(e, t, n) {
      ...
      } else throw this.raiseEarlyExitException(e, U.REPETITION_MANDATORY, t.ERR_MSG);
      this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, t], r, yo, e, ma);
    }
    ...
    atLeastOneSepFirstInternalLogic(e, t, n) {
      ...
      if (this.getLaFuncFromCache(n).call(this) === !0) {
        ...
        throw this.raiseEarlyExitException(e, U.REPETITION_MANDATORY_WITH_SEPARATOR, t.ERR_MSG);
    }
    manyInternal(e, t) {
    ...
    manyInternalLogic(e, t, n) {
      ...
      this.attemptInRepetitionRecovery(this.manyInternal, [e, t], r, 768, e, fa, a);
    }
    ...
    subruleInternal(e, t, n) {
      ...
      try {
        ...
        return (
          ...
          this.cstPostNonTerminal(r, n !== void 0 && n.LABEL !== void 0 ? n.LABEL : e.ruleName),
          r
        );
      } catch (t) {
...
const Uo = { description: `This Object indicates the Parser is during Recording Phase` };
Object.freeze(Uo);
...
var qo = class {
  ...
  subruleInternalRecord(e, t, n) {
    ...
    let r = this.recordingProdStack.at(-1),
      i = e.ruleName,
      a = new or({ idx: t, nonTerminalName: i, label: n?.LABEL, referencedRule: void 0 });
...
function Yo(e, t) {
  ...
  let n = this.recordingProdStack.at(-1),
    r = Array.isArray(e) === !1,
    i = r === !1 ? e : e.DEF,
    a = new fr({ definition: [], idx: t, ignoreAmbiguities: r && e.IGNORE_AMBIGUITIES === !0 });
  return (
...
var Qo = class {
  initPerformanceTracer(e) {
    ...
    } else ((this.traceInitMaxIdent = 0), (this.traceInitPerf = ts.traceInitPerf));
    this.traceInitIndent = -1;
  }
  TRACE_INIT(e, t) {
    if (this.traceInitPerf === !0) {
  ...
  performSelfAnalysis() {
    this.TRACE_INIT(`performSelfAnalysis`, () => {
      ...
      if (
        ...
        !e.DEFER_DEFINITION_ERRORS_HANDLING && this.definitionErrors.length !== 0)
      )
        throw (
...
((as.DEFER_DEFINITION_ERRORS_HANDLING = !1), $o(as, [_o, wo, Ro, zo, Vo, Bo, Ho, qo, Qo]));
...
function gs(e, t, n) {
  let r = G(e, t, n, { type: 5 });
  return (Ts(e, r), Cs(e, t, n, Es(e, t, r, n, xs(e, t, n)), ks(e, t, n.separator, n)));
}
function _s(e, t, n) {
...
function vs(e, t, n) {
  let r = G(e, t, n, { type: 4 });
  return (Ts(e, r), Ss(e, t, n, Es(e, t, r, n, xs(e, t, n)), ks(e, t, n.separator, n)));
}
function ys(e, t, n) {
...
function Ss(e, t, n, r, i) {
  ...
  return (
    (a.loopback = s),
    (c.loopback = s),
    (e.decisionMap[ss(t, i ? `RepetitionMandatoryWithSeparator` : `RepetitionMandatory`, n.idx)] =
      s),
    W(o, s),
...
function Cs(e, t, n, r, i) {
  ...
  return (
    ...
    (e.decisionMap[ss(t, i ? `RepetitionWithSeparator` : `Repetition`, n.idx)] = s),
    { left: s, right: c }
  );
}
function ws(e, t, n, r) {
...
function Ls(e, t) {
  ...
  return (r) => {
    let i = r.toString(),
      a = n[i];
    return a === void 0 ? ((a = { atnStartState: e, decision: t, states: {} }), (n[i] = a), a) : a;
  };
}
var Rs = class {
  constructor() {
...
var Bs = class extends Co {
  ...
  buildLookaheadForAlternation(e) {
    let { prodOccurrence: t, rule: i, hasPredicates: a, dynamicTokensEnabled: o } = e,
      s = this.dfas,
      l = this.logging,
      u = ss(i, `Alternation`, t),
      d = this.atn.decisionMap[u].decision,
      f = c(ba({ maxLookahead: 1, occurrence: t, prodType: `Alternation`, rule: i }), (e) =>
        c(e, (e) => e[0]),
      );
    if (Vs(f, !1) && !o) {
      let e = r(
  ...
  buildLookaheadForOptional(e) {
    let { prodOccurrence: t, rule: i, prodType: a, dynamicTokensEnabled: s } = e,
      l = this.dfas,
      u = this.logging,
      d = ss(i, a, t),
      f = this.atn.decisionMap[d].decision,
      p = c(ba({ maxLookahead: 1, occurrence: t, prodType: a, rule: i }), (e) => c(e, (e) => e[0]));
    if (Vs(p) && p[0][0] && !s) {
      let e = p[0],
        t = h(e);
...
function Ws(e, t, n, r) {
  ...
  for (;;) {
    let t = Xs(i, s);
    if ((t === void 0 && (t = Gs.apply(this, [e, i, s, a, n, r])), t === Ps)) return Ys(o, i, s);
...
function rc(e) {
  ...
  for (let r = 0; r < n; r++) ic({ state: e.transitions[r].target, alt: r, stack: [] }, t);
  return t;
}
function ic(e, t) {
  let n = e.state;
  ...
  Vl = l(() => {
    ((function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return J.objectLiteral(t) && J.uinteger(t.line) && J.uinteger(t.character);
        }
        e.is = n;
      })((K ||= {})),
      (function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return J.objectLiteral(t) && q.is(t.range) && (J.string(t.uri) || J.undefined(t.uri));
        }
        e.is = n;
      })((_c ||= {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (q.is(t.originSelectionRange) || J.undefined(t.originSelectionRange))
          );
        }
        e.is = n;
      })((vc ||= {})),
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (J.undefined(t.additionalTextEdits) || J.typedArray(t.additionalTextEdits, Ac.is))
          );
        }
        e.is = n;
      })((xc ||= {})),
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            (J.undefined(t.codeDescription) || J.string(t.codeDescription?.href)) &&
            (J.string(t.source) || J.undefined(t.source)) &&
            (J.undefined(t.relatedInformation) || J.typedArray(t.relatedInformation, wc.is))
          );
        }
        e.is = n;
      })((Oc ||= {})),
      ...
      (function (e) {
        function t(e, t, n) {
          let r = { label: e };
          return (
            t !== void 0 && (r.needsConfirmation = t), n !== void 0 && (r.description = n), r
          );
        }
        e.create = t;
        function n(e) {
          ...
          return (
            J.objectLiteral(t) &&
            J.string(t.label) &&
            (J.boolean(t.needsConfirmation) || t.needsConfirmation === void 0) &&
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return J.defined(t) && Wc.is(t.textDocument) && Array.isArray(t.edits);
        }
        e.is = n;
      })((Pc ||= {})),
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            J.string(t.uri) &&
            (t.options === void 0 ||
              ((t.options.overwrite === void 0 || J.boolean(t.options.overwrite)) &&
                (t.options.ignoreIfExists === void 0 || J.boolean(t.options.ignoreIfExists)))) &&
      ...
      (function (e) {
        ...
        function n(e) {
          ...
          return (
            ...
            J.string(t.uri) &&
            (t.options === void 0 ||
              ((t.options.recursive === void 0 || J.boolean(t.options.recursive)) &&
      ...
      (Bc = class {
        ...
        manage(e, t) {
          let n;
          if (
            (Mc.is(e) ? (n = e) : ((n = this.nextId()), (t = e)), this._annotations[n] !== void 0)
          )
      ...
      (Vc = class {
        ...
        createFile(e, t, n) {
          ...
          if (
            (r === void 0
              ? (i = Fc.create(e, n))
              : ((a = Mc.is(r) ? r : this._changeAnnotations.manage(r)), (i = Fc.create(e, n, a))),
        ...
        deleteFile(e, t, n) {
          ...
          if (
            (r === void 0
              ? (i = Lc.create(e, n))
              : ((a = Mc.is(r) ? r : this._changeAnnotations.manage(r)), (i = Lc.create(e, n, a))),
            this._workspaceEdit.documentChanges.push(i),
            a !== void 0)
          )
            return a;
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return J.defined(t) && J.string(t.uri) && (t.version === null || J.integer(t.version));
        }
        e.is = n;
      })((Wc ||= {})),
      (function (e) {
      ...
      (function (e) {
        function t(e) {
          ...
          return (
            !!t &&
            J.objectLiteral(t) &&
            (qc.is(t.contents) || nl.is(t.contents) || J.typedArray(t.contents, nl.is)) &&
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return J.defined(t) && q.is(t.range) && (J.undefined(t.command) || kc.is(t.command));
        }
        e.is = n;
      })((_l ||= {})),
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return J.defined(t) && J.uinteger(t.tabSize) && J.boolean(t.insertSpaces);
        }
        e.is = n;
      })((vl ||= {})),
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return J.defined(t) && q.is(t.range) && (J.undefined(t.target) || J.string(t.target));
        }
        e.is = n;
      })((yl ||= {})),
      (function (e) {
        ...
        function n(t) {
          let n = t;
          return J.objectLiteral(n) && q.is(n.range) && (n.parent === void 0 || e.is(n.parent));
        }
        e.is = n;
      })((bl ||= {})),
      (function (e) {
      ...
      (function (e) {
        ...
        function n(e) {
          let t = e;
          return t != null && q.is(t.range) && (J.string(t.expression) || t.expression === void 0);
        }
        e.is = n;
      })((El ||= {})),
      (function (e) {
...
var Zl = class {
  ...
  Ql = class extends Zl {
    ...
    rule(e, t) {
      ...
      let i = this.wrapper.DEFINE_RULE(Xl(e.name), this.startImplementation(n, r, t).bind(this));
      return (this.allRules.set(e.name, i), st(e) && e.entry && (this.mainRule = i), i);
    }
    registerPrecedenceMap(e) {
      ...
      for (let t = 0; t < e.operators.precedences.length; t++) {
        ...
        for (let e of r.operators)
          n.set(e.value, { precedence: t, rightAssoc: r.associativity === `right` });
      }
    ...
    parse(e, t = {}) {
      ...
      if (!r)
        throw Error(t.rule ? `No rule found with name '${t.rule}'` : `No main rule available.`);
    ...
    startImplementation(e, t, n) {
      return (r) => {
        ...
        if (i) {
          let n = { $type: e };
          (this.stack.push(n), e === Jl ? (n.value = ``) : t !== void 0 && (n.$infixName = t));
        }
    ...
    consume(e, t, n) {
      ...
      if (!this.isRecording() && this.isValidToken(r)) {
        ...
        if (i) {
          ...
          let e = r.image;
          (Xe(n) || (e = this.converter.convert(e, t).toString()), (o.value += e));
        }
      }
    }
    isValidToken(e) {
    ...
    subrule(e, t, n, r, i) {
      ...
      try {
        ...
        this.isRecording() ||
          ...
          o !== void 0 && a && a.length > 0 && this.performSubruleAssignment(o, r, a));
      }
    }
    ...
    constructInfix(e, t) {
      ...
      return { $type: e.$type, $cstNode: e.$cstNode, left: f, operator: r[i], right: p };
    }
    getAssignment(e) {
      if (!this.assignmentMap.has(e)) {
        ...
        this.assignmentMap.set(e, {
          assignment: t,
          crossRef: t && Me(t.terminal) ? (t.terminal.isMulti ? `multi` : `single`) : void 0,
        });
      }
  ...
  tu = class extends Zl {
    ...
    rule(e, t) {
      let n = this.wrapper.DEFINE_RULE(Xl(e.name), this.startImplementation(t).bind(this));
...
function su(e, t) {
  ...
  if (!n)
    throw Error(`Could not resolve reference to infix operator rule: ` + t.call.rule.$refText);
  ...
  let r = t.operators.precedences.flatMap((e) => e.operators),
    ...
    a = { $container: i, $type: `Assignment`, feature: `parts`, operator: `+=`, terminal: t.call },
  ...
  let s = {
    ...
    c = { ...a, $container: o };
  o.elements.push(s, c);
  let l = r.map((t) => e.tokens[t.value]).map((t, n) => ({ ALT: () => e.parser.consume(n, t, s) })),
    u;
  return (t) => {
    ((u ??= bu(e, n)),
...
function du(e, t) {
  if (t.some((e) => e.calledByName)) {
    let e = t.map((e) => ({ parameterName: e.parameter?.ref?.name, predicate: fu(e.value) }));
    return (t) => {
      let n = {};
      ...
      (t) =>
        e.parser.alternatives(
          ...
          n.map((n, a) => {
            ...
            let c = n.GATE;
            return (
              c ? (o.GATE = () => c(t)) : (o.GATE = () => !s.unorderedGroups.get(i(r, s))?.[a]), o
            );
          }),
        ),
      `*`,
...
function _u(e, t, n = t.terminal) {
  if (!n) {
    ...
    if (!n) throw Error(`Could not find name assignment for type: ` + zn(t.type.ref));
    return _u(e, t, n);
    ...
    if (i) {
      ...
      return (a) =>
        e.parser.alternatives(r, [
          { ALT: () => e.parser.atLeastOne(t, { DEF: () => n(a) }), GATE: () => i(a) },
          { ALT: is(), GATE: () => !i(a) },
        ]);
...
function xu(e, t) {
  ...
  if (e.ruleNames.has(t)) return e.ruleNames.get(t);
  {
    let n = t,
      ...
      i = t.$type;
    for (; !st(r); )
      ((Be(r) || be(r) || Nt(r)) && (i = r.elements.indexOf(n).toString() + `:` + i),
        (n = r),
        (r = r.$container));
...
var ku = s((e) => {
  ...
  Au = s((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }),
      (e.stringArray = e.array = e.func = e.error = e.number = e.string = e.boolean = void 0));
    function t(e) {
      return e === !0 || e === !1;
    }
    e.boolean = t;
    ...
    (function (e) {
      ...
      function t(t) {
        ...
        return (
          ...
          (r === e.None ||
            r === e.Cancelled ||
            (n.boolean(r.isCancellationRequested) && !!r.onCancellationRequested))
        );
      }
      e.is = t;
...
async function Ru(e) {
  ...
  if ((t - Pu >= 10 && ((Pu = t), await Nu(), (Pu = performance.now())), e.isCancellationRequested))
    throw Iu;
}
var zu = class {
    constructor() {
  ...
  Bu = class e {
      ...
      for (let n of t)
        if (e.isIncremental(n)) {
          ...
          if (a - i === s.length) for (let e = 0, t = s.length; e < t; e++) o[e + i + 1] = s[e];
            ...
            s.length < 1e4
              ? o.splice(i + 1, a - i, ...s)
              : (this._lineOffsets = o = o.slice(0, i + 1).concat(s, o.slice(a + 1)));
    ...
    getLineOffsets() {
      return (
        this._lineOffsets === void 0 && (this._lineOffsets = Uu(this._content, !0)),
        this._lineOffsets
      );
    }
    positionAt(e) {
...
function Uu(e, t, n = 0) {
  ...
  for (let t = 0; t < e.length; t++) {
    ...
    Wu(i) && (i === 13 && t + 1 < e.length && e.charCodeAt(t + 1) === 10 && t++, r.push(n + t + 1));
  }
  return r;
}
function Wu(e) {
...
(() => {
            ...
            if (n === 47) {
              if (!(a === s - 1 || o === 1))
                if (a !== s - 1 && o === 2) {
                  ...
                  (r.length > 0 ? (r += `/` + e.slice(a + 1, s)) : (r = e.slice(a + 1, s)),
                    (i = s - a - 1));
              ((a = s), (o = 0));
            } else n === 46 && o !== -1 ? ++o : (o = -1);
          }
        ...
        var r = {
          resolve: function () {
            for (var e, r = ``, i = !1, a = arguments.length - 1; a >= -1 && !i; a--) {
              var o;
              (a >= 0 ? (o = arguments[a]) : (e === void 0 && (e = process.cwd()), (o = e)),
                t(o),
                o.length !== 0 && ((r = o + `/` + r), (i = o.charCodeAt(0) === 47)));
            }
          ...
          relative: function (e, n) {
            ...
            var p = ``;
            for (d = i + u + 1; d <= a; ++d)
              (d !== a && e.charCodeAt(d) !== 47) || (p.length === 0 ? (p += `..`) : (p += `/..`));
            return p.length > 0
              ? p + n.slice(s + u)
          ...
          dirname: function (e) {
            if ((t(e), e.length === 0)) return `.`;
            for (
              var n = e.charCodeAt(0), r = n === 47, i = -1, a = !0, o = e.length - 1;
              o >= 1;
              --o
            )
            ...
            if (n !== void 0 && n.length > 0 && n.length <= e.length) {
              ...
              for (r = e.length - 1; r >= 0; --r) {
                ...
                if (l === 47) {
                  ...
                  (c === -1 && ((o = !1), (c = r + 1)),
                    s >= 0 && (l === n.charCodeAt(s) ? --s == -1 && (a = r) : ((s = -1), (a = c))));
              }
          ...
          parse: function (e) {
            ...
            var r,
              ...
              a = i === 47;
            a ? ((n.root = `/`), (r = 1)) : (r = 0);
            for (var o = -1, s = 0, c = -1, l = !0, u = e.length - 1, d = 0; u >= r; --u)
              if ((i = e.charCodeAt(u)) !== 47)
                (c === -1 && ((l = !1), (c = u + 1)),
                  i === 46 ? (o === -1 ? (o = u) : d !== 1 && (d = 1)) : o !== -1 && (d = -1));
              else if (!l) {
                s = u + 1;
                break;
              }
            return (
              o === -1 || c === -1 || d === 0 || (d === 1 && o === c - 1 && o === s + 1)
                ? c !== -1 && (n.base = n.name = s === 0 && a ? e.slice(1, c) : e.slice(s, c))
                : (s === 0 && a
  ...
  class u {
    ...
    static parse(e, t = !1) {
      let n = l.exec(e);
      return n
        ? new f(n[2] || ``, b(n[4] || ``), b(n[5] || ``), b(n[7] || ``), b(n[9] || ``), t)
        : new f(``, ``, ``, ``, ``);
    }
    static file(e) {
      let t = ``;
  ...
  class f extends u {
    ...
    toString(e = !1) {
      return e ? _(this, !0) : ((this._formatted ||= _(this, !1)), this._formatted);
    }
    toJSON() {
      let e = { $mid: 1 };
      return (
  ...
  function m(e, t, n) {
    ...
    for (let a = 0; a < e.length; a++) {
      ...
      if (
        ...
        t === void 0
          ? i === -1 && (i = a)
          : (i !== -1 && ((r += encodeURIComponent(e.substring(i, a))), (i = -1)), (r += t));
      }
    }
  ...
  function _(e, t) {
    ...
    if ((i && ((r += i), (r += `:`)), (a || i === `file`) && ((r += `/`), (r += `/`)), a)) {
      ...
      ((a = a.toLowerCase()),
        (e = a.lastIndexOf(`:`)),
        e === -1 ? (r += n(a, !1, !0)) : ((r += n(a.substr(0, e), !1, !0)), (r += a.substr(e))));
    }
    if (o) {
    ...
    return (
      s && ((r += `?`), (r += n(s, !1, !1))), c && ((r += `#`), (r += t ? c : m(c, !1, !1))), r
    );
  }
  function v(e) {
    try {
...
(function (e) {
  ...
  function a(e, t) {
    ...
    return (
      ...
      r === n ? !0 : r.length < n.length || r.charAt(n.length) !== `/` ? !1 : r.startsWith(n)
    );
  }
  e.contains = a;
})((Xu ||= {}));
var Zu = class {
    ...
    getNode(e, t) {
      ...
      for (let e of n) {
        ...
        if (!n)
          if (t) ((n = { name: e, children: new Map(), parent: r }), r.children.set(e, n));
          else return;
        r = n;
      }
      return r;
...
var Qu = class {
    ...
    fromTextDocument(e, t, n) {
      return (
        (t ??= Ju.parse(e.uri)),
        Y.CancellationToken.is(n) ? this.createAsync(t, e, n) : this.create(t, e, n)
      );
    }
    fromString(e, t, n) {
      return Y.CancellationToken.is(n) ? this.createAsync(t, e, n) : this.create(t, e, n);
    }
    fromModel(e, t) {
    ...
    createLangiumDocument(e, t, n, r) {
      let i;
      if (n) i = { parseResult: e, uri: t, state: X.Parsed, references: [], textDocument: n };
      else {
    ...
    createTextDocumentGetter(e, t) {
      let n = this.serviceRegistry,
        r;
      return () =>
        (r ??= Vu.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, t ?? ``));
    }
  },
  $u = class {
    constructor(e) {
...
var td = class {
  ...
  async link(e, t = Y.CancellationToken.None) {
    if (this.profiler?.isActive(`linking`)) {
      ...
      for (let n of P(e.parseResult.value)) (await Ru(t), le(n).forEach((t) => this.doLink(t, e)));
  }
  doLink(e, t) {
    let n = e.reference;
...
var rd = class {
  ...
  id = class {
    constructor(e) {
      ((this.nameProvider = e.references.NameProvider),
        ...
        (this.hasMultiReference = P(e.Grammar).some((e) => Me(e) && e.isMulti)));
    }
    findDeclarations(e) {
      if (e) {
        let t = Nn(e),
  ...
  sd = class {
    ...
    async collectExportedSymbolsForNode(e, t, n = se, r = Y.CancellationToken.None) {
      let i = [];
  ...
  md = class {
    ...
    getScope(e) {
      ...
      if (r) {
        let i = e.container;
        do
          (r.has(i) && t.push(r.getStream(i).filter((e) => this.reflection.isSubtype(e.type, n))),
            (i = i.$container));
        while (i);
      }
    ...
    getGlobalScope(e, t) {
      return this.globalScopeCache.get(e, () => new ld(this.indexManager.allElements(e)));
    }
  };
function hd(e) {
...
var _d = class {
    ...
    replacer(e, t, { refText: n, sourceText: r, textRegions: i, comments: a, uriConverter: o }) {
      if (!this.ignoreProperties.has(e))
        if (y(t)) {
          ...
          } else return { $error: t.error?.message ?? `Could not resolve reference`, $refText: r };
        } else if (b(t)) {
    ...
    reviveReference(e, t, n, r, i) {
      ...
      if (r.$ref) {
        ...
        if (v(e)) return ((a ||= this.nameProvider.getName(e)), { $refText: a ?? ``, ref: e });
        o = e;
      } else if (r.$refs) {
        let e = [];
        for (let t of r.$refs) {
        ...
        if (e.length === 0)
          ((s = { $refText: a ?? ``, items: e }), (o ??= `Could not resolve multi-reference`));
        else return { $refText: a ?? ``, items: e };
      }
      if (o)
        return (
          (s ??= { $refText: a ?? ``, ref: void 0 }),
          (s.error = { info: { container: e, property: t, reference: s }, message: o }),
          s
        );
    }
    getRefNode(e, t, n) {
      try {
        ...
        return a
          ? r === t.length - 1
            ? a.parseResult.value
            : this.astNodeLocator.getAstNode(a.parseResult.value, t.substring(r + 1)) ||
    ...
    getServices(e) {
      ...
      if (!i)
        throw t
          ...
          : Error(`The service registry contains no services for the extension '${n}'.`);
      return i;
    }
    hasServices(e) {
      try {
...
var xd = class {
  ...
  register(e, t = this, n = `fast`) {
    if (n === `built-in`)
      throw Error(`The 'built-in' category is reserved for lexer, parser, and linker errors.`);
  ...
  async handleException(e, t, n, r) {
    try {
      ...
      (console.error(`${t}:`, e),
        ...
        n(`error`, `${t}: ${e instanceof Error ? e.message : String(e)}`, { node: r }));
    }
  }
  addEntry(e, t) {
    if (e === `AstNode`) {
  ...
  async validateDocument(e, t = {}, n = Y.CancellationToken.None) {
    ...
    if (
      ...
      (!t.categories || t.categories.includes(`built-in`)) &&
        ...
        (t.stopAfterLexingErrors && i.some((e) => e.data?.code === Dd.LexingError)) ||
          (this.processParsingErrors(r, i, t),
          t.stopAfterParsingErrors && i.some((e) => e.data?.code === Dd.ParsingError)) ||
          (this.processLinkingErrors(e, i, t),
          t.stopAfterLinkingErrors && i.some((e) => e.data?.code === Dd.LinkingError))))
    )
      return i;
    try {
...
function wd(e) {
  ...
  return (
    typeof e.property == `string`
      ...
      : typeof e.keyword == `string` && (t = jn(e.node.$cstNode, e.keyword, e.index)),
    (t ??= e.node.$cstNode),
  ...
  kd = class {
    ...
    createInfoDescriptions(e) {
      ...
      y(t) && t.$nodeDescription
        ? (n = [t.$nodeDescription])
        : b(t) && (n = t.items.map((e) => e.$nodeDescription).filter((e) => e !== void 0));
...
var Md = class {
  ...
  Rd = s((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }),
      (e.ReadableStreamMessageReader = e.AbstractMessageReader = e.MessageReader = void 0));
    let t = ku(),
      n = Au(),
      r = ju(),
      i = Ld();
    ...
    var o = class {
      ...
      asError(e) {
        return e instanceof Error
          ? e
          : Error(`Reader received error. Reason: ${n.string(e.message) ? e.message : `unknown`}`);
      }
    };
    ...
    ((function (e) {
      function n(e) {
        ...
        if (e === void 0 || typeof e == `string`) n = e ?? `utf-8`;
          ...
          if (
            ((n = e.charset ?? `utf-8`),
            e.contentDecoder !== void 0 && ((r = e.contentDecoder), i.set(r.name, r)),
            e.contentDecoders !== void 0)
          )
            for (let t of e.contentDecoders) i.set(t.name, t);
          if (
            (e.contentTypeDecoder !== void 0 && ((a = e.contentTypeDecoder), o.set(a.name, a)),
            e.contentTypeDecoders !== void 0)
          )
            for (let t of e.contentTypeDecoders) o.set(t.name, t);
        }
        return (
          a === void 0 && ((a = (0, t.default)().applicationJson.decoder), o.set(a.name, a)),
          {
            charset: n,
            contentDecoder: r,
            contentDecoders: i,
          ...
          try {
            for (this.buffer.append(e); ; ) {
              if (this.nextMessageLength === -1) {
                ...
                let n = parseInt(t);
                if (isNaN(n)) {
                  this.fireError(Error(`Content-Length value must be a number. Got ${t}`));
                  return;
                }
  ...
  zd = s((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }),
      (e.WriteableStreamMessageWriter = e.AbstractMessageWriter = e.MessageWriter = void 0));
    let t = ku(),
      n = Au(),
      r = Ld(),
      i = ju();
    ...
    var o = class {
      ...
      asError(e) {
        return e instanceof Error
          ? e
          : Error(`Writer received error. Reason: ${n.string(e.message) ? e.message : `unknown`}`);
      }
    };
    ...
    ((function (e) {
      function n(e) {
        return e === void 0 || typeof e == `string`
          ? { charset: e ?? `utf-8`, contentTypeEncoder: (0, t.default)().applicationJson.encoder }
          : {
        ...
        async write(e) {
          return this.writeSemaphore.lock(async () =>
            this.options.contentTypeEncoder
              ...
              .then((e) =>
                this.options.contentEncoder === void 0 ? e : this.options.contentEncoder.encode(e),
              )
              .then(
                (t) => {
                  let n = [];
  ...
  Vd = s((e) => {
    ...
    (function (e) {
      function t(e) {
        ...
        return (
          t &&
          (C.is(t.cancellationStrategy) || v.is(t.connectionStrategy) || w.is(t.messageStrategy))
        );
      }
      e.is = t;
    ...
    function te(f, v, b, x) {
          ...
          if (r.Message.isNotification(e) && e.method === s.type.method) {
            ...
            if (r.Message.isRequest(i)) {
              let r = x?.connectionStrategy,
                a = r && r.cancelUndispatched ? r.cancelUndispatched(i, _e) : void 0;
              if (a && (a.error !== void 0 || a.result !== void 0)) {
                (ae.delete(n),
                  j.delete(t),
                  (a.id = i.id),
                  Pe(a, e.method, Date.now()),
                  v.write(a).catch(() => S.error(`Sending response for canceled message failed.`)));
                return;
              }
            }
            let a = j.get(t);
      ...
      function Oe(e) {
        ...
        function i(t, n, r) {
          ...
          (Pe(i, n, r), v.write(i).catch(() => S.error(`Sending response failed.`)));
        }
        function a(t, n, r) {
          t === void 0 && (t = null);
        ...
        if (c || E) {
          ...
          (e.id !== null && A.has(e.id) && u.cancel(), e.id !== null && j.set(o, u));
          try {
            let d;
            if (c)
              if (e.params === void 0) {
                ...
                if (s !== void 0 && s.parameterStructures === r.ParameterStructures.byName) {
                  i(
                    new r.ResponseError(
                      r.ErrorCodes.InvalidParams,
                ...
                if (s !== void 0 && s.parameterStructures === r.ParameterStructures.byPosition) {
                  i(
                    new r.ResponseError(
                      r.ErrorCodes.InvalidParams,
          ...
          i(
            new r.ResponseError(r.ErrorCodes.MethodNotFound, `Unhandled method ${e.method}`),
            e.method,
            l,
          );
      }
      ...
      function je(e) {
        ...
        if (n.string(t.id) || n.number(t.id)) {
          let e = t.id,
            n = oe.get(e);
          n && n.reject(Error(`The received response has neither a result nor an error property.`));
        }
      }
      function I(e) {
        if (e != null)
      ...
      function Me(e) {
        if (!(M === d.Off || !N))
          if (se === p.Text) {
            let t;
            ((M === d.Verbose || M === d.Compact) && e.params && (t = `Params: ${I(e.params)}\n\n`),
...
`)),
            ...
            } else N.log(`Received response ${e.id} without active response promise.`, n);
          } else Re(`receive-response`, e);
      }
      function Re(e, t) {
        if (!N || M === d.Off) return;
        let n = { isLSPMessage: !0, type: e, message: t, timestamp: Date.now() };
        N.log(n);
      }
      function ze() {
      ...
      let qe = {
        ...
        sendProgress: (e, t, n) => qe.sendNotification(l.type, { token: t, value: n }),
        ...
        sendRequest: (e, ...t) => {
          ...
          s &&
            (l = s.onCancellationRequested(() => {
              ...
              return e === void 0
                ? (S.log(`Received no promise from cancellation strategy when cancelling id ${c}`),
                  Promise.resolve())
                : e.catch(() => {
          ...
          return (
            Me(u),
            typeof fe.sender.enableCancellation == `function` && fe.sender.enableCancellation(u),
        ...
        onRequest: (e, t) => {
          ...
          return (
            u.is(e)
              ? ((r = void 0), (E = e))
              : n.string(e)
                ? ((r = null), t !== void 0 && ((r = e), D.set(e, { handler: t, type: void 0 })))
                : t !== void 0 && ((r = e.method), D.set(e.method, { type: e, handler: t })),
            {
              dispose: () => {
        ...
        trace: async (e, t, r) => {
          ...
          (r !== void 0 &&
            (n.boolean(r)
              ? (i = r)
              : ((i = r.sendNotification || !1), (a = r.traceFormat || p.Text))),
            (M = e),
            (se = a),
            (N = M === d.Off ? void 0 : t),
            i && !ye() && !be() && (await qe.sendNotification(m.type, { value: d.toString(e) })));
        },
        onError: ce.event,
        onClose: le.event,
    ...
    var r = class {
        ...
        onClose(e) {
          return (
            ...
            t.Disposable.create(() => this.socket.removeEventListener(`close`, e))
          );
        }
        onError(e) {
          return (
            this.socket.addEventListener(`error`, e),
            t.Disposable.create(() => this.socket.removeEventListener(`error`, e))
          );
        }
        onEnd(e) {
          return (
          ...
          decoder: Object.freeze({
            ...
            decode: (e, t) => {
              if (!(e instanceof Uint8Array))
                throw Error(`In a Browser environments only Uint8Arrays are supported.`);
  ...
  Yd = s((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }),
      (e.DidChangeWorkspaceFoldersNotification = e.WorkspaceFoldersRequest = void 0));
    let t = Z();
    var n;
    (function (e) {
  ...
  df = s((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }),
      (e.InlayHintRefreshRequest = e.InlayHintResolveRequest = e.InlayHintRequest = void 0));
    let t = Z();
    var n;
    (function (e) {
    ...
    (function (e) {
      ...
      function s(e, t) {
        ...
        return (
          ...
          e.executionSummary !== t.executionSummary && n.add(`executionSummary`),
  ...
  hf = s((e) => {
    ...
    (function (e) {
      function t(e) {
        ...
        return (
          r.objectLiteral(t) &&
          (r.string(t.notebookType) || r.string(t.scheme) || r.string(t.pattern))
        );
      }
      e.is = t;
    ...
    (function (e) {
      function t(e) {
        let t = e;
        return (
          r.objectLiteral(t) && (t.workDoneProgress === void 0 || r.boolean(t.workDoneProgress))
        );
      }
      e.is = t;
      function n(e) {
...
var bf = vf(),
  xf = class {
    ...
    async buildDocuments(e, t, n) {
      (this.prepareBuild(e, t),
        await this.runCancelable(e, X.Parsed, n, (e) => this.langiumDocumentFactory.update(e, n)),
    ...
    prepareBuild(e, t) {
      for (let n of e) {
        ...
        (!r || r.completed) &&
          this.buildState.set(e, { completed: !1, options: t, result: r?.result });
      }
    }
    async runCancelable(e, t, n, r) {
      for (let i of e)
        i.state < t &&
          (await Ru(n), await r(i), (i.state = t), await this.notifyDocumentPhase(i, t, n));
            ...
            : this.currentState >= e && e > r.state
              ...
              : new Promise((r, i) => {
                  let a = this.onDocumentPhase(e, (e) => {
                      Xu.equals(e.uri, t) && (a.dispose(), o.dispose(), r(e.uri));
                    }),
    ...
    async validate(e, t) {
      let n = this.serviceRegistry.getServices(e.uri).validation.DocumentValidator,
  ...
  Cf = class {
    ...
    async initializeWorkspace(e, t = Y.CancellationToken.None) {
      ...
      (await Ru(t), await this.documentBuilder.build(n, this.initialBuildOptions, t));
    }
    async performStartup(e) {
      ...
      let r = [];
      await Promise.all(
        e.map((e) => this.getRootFolder(e)).map(async (e) => this.traverseFolder(e, r)),
      );
      let i = k(r)
        ...
        await Promise.all(
          n.map(async (e) => {
            this.shouldIncludeEntry(e) &&
              (e.isDirectory ? await this.traverseFolder(e.uri, t) : e.isFile && t.push(e.uri));
          }),
        );
      } catch (t) {
...
function Af(e, t, n) {
  ...
  let a = Mf(e),
    o = Jf(r);
  return Vf({ index: 0, tokens: Ff({ lines: a, position: i, options: o }), position: i });
}
function jf(e, t) {
  let n = Jf(t),
    r = Mf(e);
    ...
    for (let o of e) {
      ...
      if (
        (i.push({
          type: `inline-tag`,
          content: l,
          range: q.create(K.create(n, a + c + r), K.create(n, a + c + l.length + r)),
        }),
        (c += l.length),
        o.length === 4)
      ) {
        ...
        i.push({
          type: `text`,
          content: e,
          range: q.create(K.create(n, a + c + r), K.create(n, a + c + e.length + r)),
        });
      } else
        i.push({
          type: `text`,
...
function Kf(e, t) {
  ...
  if (e.tokens[e.index]?.type === `text`)
    if (t) {
      let i = qf(e);
      return new Zf(r, new ep([i], i.range), t, q.create(n.range.start, i.range.end));
    } else {
      let i = Wf(e);
...
function Qf(e, t, n) {
  if (e === `linkplain` || e === `linkcode` || e === `link`) {
    ...
    return (
      (e === `linkcode` || (e === `link` && n.link === `code`)) && (i = `\`${i}\``),
...
var rp = class {
  ...
  ip = class {
    ...
    getComment(e) {
      return hd(e) ? e.$comment : Jt(e.$cstNode, this.grammarConfig().multilineCommentRules)?.text;
    }
  },
  ap = class {
    constructor(e) {
  ...
  sp = class {
    ...
    dehydrateAstNode(e, t) {
      ...
      ((n.$type = e.$type),
        ...
        e.$cstNode !== void 0 && (n.$cstNode = this.dehydrateCstNode(e.$cstNode, t)));
      for (let [r, i] of Object.entries(e))
        if (!r.startsWith(`$`))
          if (Array.isArray(i)) {
            let e = [];
    ...
    dehydrateReference(e, t) {
      let n = {};
      return (
        (n.$refText = e.$refText), e.$refNode && (n.$refNode = t.cstNodes.get(e.$refNode)), n
      );
    }
    ...
    createGrammarElementIdMap() {
      let e = 0;
      for (let t of P(this.grammar)) fe(t) && this.grammarElementIdMap.set(t, e++);
    }
  };
function cp(e) {
  return {
    documentation: { CommentProvider: (e) => new ip(e), DocumentationProvider: (e) => new rp(e) },
    parser: {
    ...
    serializer: { Hydrator: (e) => new sp(e), JsonSerializer: (e) => new _d(e) },
    validation: { DocumentValidator: (e) => new Cd(e), ValidationRegistry: (e) => new xd(e) },
    shared: () => e.shared,
  };
}
function lp(e) {
...
var Np = { $type: `Accelerator`, name: `name`, x: `x`, y: `y` },
  Pp = { $type: `Anchor`, evolution: `evolution`, name: `name`, visibility: `visibility` },
...
var Hp = { $type: `Checkout`, branch: `branch` },
  ...
  Wp = { $type: `ClassDefStatement`, className: `className`, styleText: `styleText` },
  Gp = { $type: `Commit`, id: `id`, message: `message`, tags: `tags`, type: `type` };
function Kp(e) {
...
var qp = {
  ...
  tm = { $type: `EvolutionStage`, boundary: `boundary`, name: `name`, secondName: `secondName` },
...
var am = { $type: `Group`, icon: `icon`, id: `id`, in: `in`, title: `title` },
  om = { $type: `Info`, accDescr: `accDescr`, accTitle: `accTitle`, title: `title` };
function sm(e) {
...
var cm = { $type: `Item`, classSelector: `classSelector`, name: `name` },
  ...
  um = { $type: `Label`, negX: `negX`, negY: `negY`, offsetX: `offsetX`, offsetY: `offsetY` },
  dm = { $type: `Leaf`, classSelector: `classSelector`, name: `name`, value: `value` },
  fm = {
    $type: `Link`,
    arrow: `arrow`,
    from: `from`,
  ...
  pm = { $type: `Merge`, branch: `branch`, id: `id`, tags: `tags`, type: `type` };
function mm(e) {
  return zm.isInstance(e, pm.$type);
}
Q(mm, `isMerge`);
var hm = { $type: `Note`, evolution: `evolution`, text: `text`, visibility: `visibility` },
...
Q(vm, `isPacket`);
var ym = { $type: `PacketBlock`, bits: `bits`, end: `end`, label: `label`, start: `start` };
function bm(e) {
...
var Tm = { $type: `Pipeline`, components: `components`, parent: `parent` },
  Em = { $type: `PipelineComponent`, evolution: `evolution`, label: `label`, name: `name` },
  Dm = {
    $type: `Radar`,
    accDescr: `accDescr`,
    accTitle: `accTitle`,
  ...
  km = { $type: `Service`, icon: `icon`, iconText: `iconText`, id: `id`, in: `in`, title: `title` },
    ...
    constructor() {
      (super(...arguments),
        (this.types = {
          Accelerator: {
            name: Np.$type,
            properties: { name: { name: Np.name }, x: { name: Np.x }, y: { name: Np.y } },
            superTypes: [],
          },
          Anchor: {
            name: Pp.$type,
          ...
          ClassDefStatement: {
            name: Wp.$type,
            properties: { className: { name: Wp.className }, styleText: { name: Wp.styleText } },
            superTypes: [],
          },
          Commit: {
            name: Gp.$type,
          ...
          Deaccelerator: {
            name: Yp.$type,
            properties: { name: { name: Yp.name }, x: { name: Yp.x }, y: { name: Yp.y } },
            superTypes: [],
          },
          Decorator: {
            name: Xp.$type,
          ...
          Evolve: {
            name: nm.$type,
            properties: { component: { name: nm.component }, target: { name: nm.target } },
            superTypes: [],
          },
          GitGraph: {
            name: rm.$type,
          ...
          Item: {
            name: cm.$type,
            properties: { classSelector: { name: cm.classSelector }, name: { name: cm.name } },
            superTypes: [],
          },
          Junction: {
            name: lm.$type,
          ...
          Option: {
            name: gm.$type,
            properties: { name: { name: gm.name }, value: { name: gm.value, defaultValue: !1 } },
            superTypes: [],
          },
          Packet: {
            name: _m.$type,
          ...
          PieSection: {
            name: Cm.$type,
            properties: { label: { name: Cm.label }, value: { name: Cm.value } },
            superTypes: [],
          },
          Pipeline: {
            name: Tm.$type,
          ...
          Section: {
            name: Om.$type,
            properties: { classSelector: { name: Om.classSelector }, name: { name: Om.name } },
            superTypes: [cm.$type],
          },
          Service: {
            name: km.$type,
          ...
          Size: {
            name: Am.$type,
            properties: { height: { name: Am.height }, width: { name: Am.width } },
            superTypes: [],
          },
          Statement: { name: jm.$type, properties: {}, superTypes: [] },
          TreeNode: {
            name: Fm.$type,
            properties: { indent: { name: Fm.indent }, name: { name: Fm.name } },
            superTypes: [],
          },
          TreeView: {
            name: Im.$type,
          ...
          TreemapRow: {
            name: Pm.$type,
            properties: { indent: { name: Pm.indent }, item: { name: Pm.item } },
            superTypes: [],
          },
          Wardley: {
            name: $.$type,
