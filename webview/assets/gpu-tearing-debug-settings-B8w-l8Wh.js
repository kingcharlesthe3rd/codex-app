...
import { Bi as t, D as n, Ki as r, ma as i, na as a, qi as o, sa as s, zi as c } from "./src-2.js";
import { ho as l, uo as u } from "./app-server-manager-signals.js";
...
import { c as x, o as S } from "./lib-2.js";
import { g as ee } from "./persisted-signal-CweW-bgN.js";
import { o as C } from "./statsig.js";
import { i as w, m as T, n as E } from "./sidebar-signals.js";
import { r as D } from "./toast-signal.js";
import { n as O } from "./skill-utils.js";
import { t as k } from "./button.js";
import { a as A, r as j, s as M } from "./setting-storage.js";
import { t as te } from "./spinner.js";
import { t as N } from "./apps.js";
import { t as P } from "./x.js";
import { d as F, g as I, l as L, m as R, u as z } from "./diff-view-mode.js";
import { t as B } from "./terminal.js";
import { t as V } from "./mcp.js";
import { t as H } from "./use-stable-callback.js";
import { a as U, i as W, l as ne, n as G } from "./dialog-layout.js";
...
import { t as se } from "./x-circle.js";
import { t as ce } from "./format-relative-date-time.js";
import { t as le } from "./arrow-top-right.js";
import { s as ue } from "./permissions-mode-visibility.js";
import { t as de } from "./alert-2.js";
import { t as fe } from "./use-recommended-skills.js";
...
import { t as Ae } from "./scroll-to-bottom-buton.js";
import { t as je } from "./hooks.js";
function Me(e) {
  return i(c, e);
}
var Ne = `external-agent-config-import-settings`,
  ...
  Re = a({
    ...
    theme: a({
      ...
      fonts: a({ code: Le, ui: Le }),
      ink: X,
      opaqueWindows: r(),
      semanticColors: a({ diffAdded: X, diffRemoved: X, skill: X }),
      surface: X,
    }),
...
function ze(e) {
  let t = m(_),
    ...
    o = I(i, e),
    s = F(e),
    c = { codeThemeId: z(a, e).id, theme: o },
    l = (0, J.useRef)(c),
    u = (0, J.useRef)(c),
    d = (0, J.useRef)(0),
  ...
  let p = (0, J.useCallback)(
      (e) => {
        ((l.current = e), j(t, n, e.theme), j(t, r, e.codeThemeId));
      },
      [n, r, t],
    ),
    h = (0, J.useCallback)(
    ...
    g = (0, J.useCallback)(
      async (e) => {
        await h(e, async () => {
          ...
          await M(n, e.theme);
          try {
            await M(r, e.codeThemeId);
          } catch (e) {
            throw (await M(n, t.theme).catch(() => void 0), e);
          }
          u.current = e;
        });
      },
      ...
      async (e) => {
        ...
        await h(t, async () => {
          ...
          if (i.codeThemeId !== t.codeThemeId) {
            await M(r, t.codeThemeId);
            try {
              await M(n, e);
            } catch (e) {
              throw (await M(r, i.codeThemeId).catch(() => void 0), e);
            }
            u.current = t;
            return;
          }
          (await M(n, e), (u.current = t));
        });
      },
      [n, r, h],
    ),
  ...
  return {
    ...
    fonts: w.theme.fonts,
    importThemeString: C,
    selectedCodeTheme: z(w.codeThemeId, e),
    setCodeThemeId: x,
    setFontsPatch: b,
    setThemePatch: y,
    theme: w.theme,
...
async function ot({
  ...
  let o = n(a);
  if (o != null) return O({ name: o.name, path: o.path });
  try {
    let n = await e(a);
    ...
    return !o.success || o.destination == null
      ? st(a, t)
      : (await r?.(), O({ name: n.name, path: Q(o.destination, `SKILL.md`) }));
  } catch {
    return st(a, t);
  }
}
function st(e, t) {
  return O({ name: e, path: t });
}
...
function pt(e) {
  ...
  let C = b,
    ...
    T = h.importChoices.length === 0 && h.remainingArtifacts.length > 0,
    E;
  t[16] !== h.importChoices || t[17] !== f
    ? ((E = h.importChoices.length === 0 ? null : xe(f, h.importChoices)),
  ...
  let A = O,
    j;
  t[21] !== h.providerIds || t[22] !== D || t[23] !== A
    ? ((j = (e) => {
        D != null && A({ source: `settings`, action: e, ...he(D, we(D), h.providerIds) });
      }),
      (t[21] = h.providerIds),
      (t[22] = D),
      (t[23] = A),
  ...
  t[28] !== h || t[29] !== M
    ? ((F = () => {
        (M(`skipped`), h.setImportDialogOpen(!1));
      }),
      (t[28] = h),
      (t[29] = M),
      (t[30] = F))
  ...
  let I = F,
    L;
  t[31] !== h.detectedItems || t[32] !== h.selectedImportProviderIds || t[33] !== D || t[34] !== f
    ? ((L =
  ...
  let R = L,
    z;
  t[36] !== h || t[37] !== A || t[38] !== R || t[39] !== I || t[40] !== u
    ? ((z =
    ...
    : (z = t[41]);
  let B;
  t[42] !== h.isImportDialogOpen || t[43] !== h.setImportDialogOpen || t[44] !== z
    ? ((B = (0, Y.jsx)(ne, {
  ...
  if (u === `general-row`) {
    if (!o) return C;
    let e = D != null || h.remainingArtifacts.length > 0,
      r = D == null && h.remainingArtifacts.length > 0,
    ...
    let f = g || h.isImporting || (!e && (!i || !a)),
      p = !e && a ? h.openCompletedImportDialog : r ? h.openRemainingArtifactsDialog : P,
      m;
  ...
  return (
    t[85] !== C || t[86] !== U
      ? ((W = (0, Y.jsxs)(Y.Fragment, { children: [U, C] })), (t[85] = C), (t[86] = U), (t[87] = W))
      : (W = t[87]),
    W
  );
}
          ...
          content: ({ close: e, level: t }) =>
            (0, Y.jsx)(de, {
              ...
              children: (0, Y.jsxs)(`div`, {
                ...
                children: [
                  (0, Y.jsx)(te, { className: `icon-sm text-token-text-secondary` }),
                  (0, Y.jsx)(S, {
        ...
        ((f = n.length),
          ...
          await me({
            ...
            onImportedProjectRootsReady: (e) => {
              T(o, w({ collapsedGroups: l, importedProjectRoots: e }));
            },
    ...
    case `mcp`: {
      ...
      return (
        t[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, Y.jsx)(V, { className: `icon-sm` })), (t[2] = e))
          : (e = t[2]),
        e
      );
    }
    ...
    return (
      t[1] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, Y.jsx)(`span`, {
            ...
            children: (0, Y.jsx)(ie, { className: `icon-2xs text-token-success` }),
          })),
          (t[1] = e))
        : (e = t[1]),
      e
  ...
  return (
    t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, Y.jsx)(`span`, {
          ...
          children: (0, Y.jsx)(P, { className: `icon-2xs text-token-editor-error-foreground` }),
        })),
        (t[2] = r))
      : (r = t[2]),
    r
...
function jt(e) {
  return e === `success`
    ? (0, Y.jsx)(ie, { className: `icon-md text-token-charts-green` })
    : e === `error`
...
//# sourceMappingURL=gpu-tearing-debug-settings-B8w-l8Wh.js.map
