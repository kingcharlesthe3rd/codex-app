...
import { Xt as _, Zt as v } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
import {
  v as y,
  y as b,
...
function x(e) {
  let t = (0, k.c)(12),
    ...
    s = m(),
    l;
  t[0] === n ? (l = t[1]) : ((l = c(`icon-2xs no-drag shrink-0`, n)), (t[0] = n), (t[1] = l));
  let u;
  ...
  t[4] !== i || t[5] !== l || t[6] !== u
    ? ((f = (0, A.jsx)(`span`, {
        ...
        children: (0, A.jsx)(y, { className: l, hostId: i, hostIdsForColorAssignment: u }),
      })),
      (t[4] = i),
      (t[5] = l),
      (t[6] = u),
  ...
  return (
    t[8] !== a || t[9] !== o.display_name || t[10] !== f
      ? ((p = O({ disableTooltip: a, icon: f, tooltipContent: o.display_name })),
        (t[8] = a),
        (t[9] = o.display_name),
        (t[10] = f),
        (t[11] = p))
...
function C(e) {
  let t = (0, k.c)(19),
    ...
    l = m(),
    u;
  t[0] === n ? (u = t[1]) : ((u = c(`icon-2xs no-drag shrink-0`, n)), (t[0] = n), (t[1] = u));
  let f;
  t[2] === l ? (f = t[3]) : ((f = l.map(w)), (t[2] = l), (t[3] = f));
  let p;
  t[4] !== a || t[5] !== u || t[6] !== f
    ? ((p = (0, A.jsx)(y, { className: u, hostId: a, hostIdsForColorAssignment: f })),
      (t[4] = a),
      (t[5] = u),
      (t[6] = f),
      (t[7] = p))
  ...
  t[8] === n
    ? (h = t[9])
    : ((h = c(`icon-2xs text-token-description-foreground no-drag shrink-0`, n)),
      (t[8] = n),
      (t[9] = h));
  let g;
  t[10] === h ? (g = t[11]) : ((g = (0, A.jsx)(i, { className: h })), (t[10] = h), (t[11] = g));
  let _;
  t[12] !== p || t[13] !== g
    ? ((_ = (0, A.jsxs)(`span`, {
  ...
  return (
    t[15] !== o || t[16] !== s.display_name || t[17] !== _
      ? ((v = O({ disableTooltip: o, icon: _, tooltipContent: s.display_name })),
        (t[15] = o),
        (t[16] = s.display_name),
        (t[17] = _),
        (t[18] = v))
...
function T(e) {
  ...
  t[0] === n
    ? (o = t[1])
    : ((o = c(`icon-2xs text-token-description-foreground no-drag shrink-0`, n)),
      (t[0] = n),
      (t[1] = o));
  let s;
  t[2] === o
...
function E(e) {
  ...
  t[0] === n
    ? (a = t[1])
    : ((a = c(`icon-2xs translate-x-px text-token-description-foreground no-drag shrink-0`, n)),
      (t[0] = n),
      (t[1] = a));
  let o;
  t[2] === a
...
//# sourceMappingURL=app-initial~app-main~appgen-page~remote-conversation-page~projects-index-page~appgen-librar~clc2xu64.js.map
