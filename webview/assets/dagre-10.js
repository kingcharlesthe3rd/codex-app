...
import "./chunk-34.js";
import { t as n } from "./clone-2.js";
import { _ as r, f as i } from "./runtime.worker-2.js";
import { b as a } from "./chunk-87.js";
import "./dist-5.js";
import "./chunk-127.js";
import "./chunk-54.js";
import { n as o } from "./chunk-146.js";
import { t as s } from "./graphlib-3.js";
import "./chunk-134.js";
import { a as c, c as l, i as u, l as d, n as f, t as p, u as m } from "./chunk-30.js";
import { a as h, i as g, n as _, r as v, t as y } from "./chunk-67.js";
import { t as b } from "./dagre-6.js";
function x(e) {
  var t = {
...
var w = new Map(),
      ...
      a.forEach((a) => {
        if (n.children(a).length > 0) A(a, n, r, i);
          ...
          (e.info(`cp `, a, ` to `, i, ` with parent `, t),
            r.setNode(a, o),
            i !== n.parent(a) &&
              (e.warn(`Setting parent`, a, n.parent(a)), r.setParent(a, n.parent(a))),
            t !== i && a !== t
  ...
  P = t(
    (e) => (!w.has(e) || !w.get(e).externalConnections ? e : w.has(e) ? w.get(e).id : e),
    `getAnchorId`,
  ),
  F = t((t, n) => {
    if (!t || n > 10) {
    ...
    (t.nodes().forEach(function (n) {
      t.children(n).length > 0 &&
        (e.warn(`Cluster identified`, n, ` Replacement id in edges: `, N(n, t, n)),
        T.set(n, j(n, t)),
    ...
    (t.edges().forEach(function (n) {
      ...
      (e.warn(`Edge ` + n.v + ` -> ` + n.w + `: ` + JSON.stringify(n)),
        e.warn(`Edge ` + n.v + ` -> ` + n.w + `: ` + JSON.stringify(t.edge(n))));
      let i = n.v,
        a = n.w;
      if (
        (e.warn(`Fix XXX`, w, `ids:`, n.v, n.w, `Translating: `, w.get(n.v), ` --- `, w.get(n.w)),
        w.get(n.v) || w.get(n.w))
      ) {
        if (
    ...
    for (let i of r)
      if (
        ...
        w.get(i)?.clusterData?.dir &&
          ((r = w.get(i).clusterData.dir), e.warn(`Fixing dir`, w.get(i).clusterData.dir, r));
  ...
  z = t(async (n, r, i, a, s, f) => {
    ...
    (r.nodes() ? e.info(`Recursive render XXX`, r.nodes()) : e.info(`No nodes found for`, r),
...
Parent cluster`,
            ...
            r.setNode(s.id, n),
            r.parent(t) || (e.trace(`Setting parent`, t, s.id), r.setParent(t, s.id, n)));
        }
        if ((e.info(`(Insert) Node XXX` + t + `: ` + JSON.stringify(r.node(t))), n?.clusterNode)) {
          ...
          r.children(t).length > 0
            ? (e.trace(`Cluster - the non recursive path XBX`, t, n.id, n, n.width, `Graph:`, r),
              e.trace(N(n.id, r)),
      ...
      await t(async () => {
        let t = r.edges().map(async function (t) {
          ...
          (e.info(`Edge ` + t.v + ` -> ` + t.w + `: ` + JSON.stringify(t)),
            e.info(`Edge ` + t.v + ` -> ` + t.w + `: `, t, ` `, JSON.stringify(r.edge(t))),
            e.info(`Fix`, w, `ids:`, t.v, t.w, `Translating: `, w.get(t.v), w.get(t.w)),
            await v(C, n));
        });
        await Promise.all(t);
      }, `processEdges`)(),
      ...
      await Promise.all(
        R(r).map(async function (t) {
          ...
          if (
            ...
            (e.info(`A pure cluster node XBX1`, t, n.id, n.x, n.y, n.width, n.height, r.parent(t)),
              (n.height += D),
              r.node(n.parentId));
            let i = n?.padding / 2 || 0,
...
export { B as render };
//# sourceMappingURL=dagre-10.js.map
