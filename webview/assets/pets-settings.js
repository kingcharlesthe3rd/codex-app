...
import { Cr as R, Sr as z } from "./app-initial~app-main~onboarding-page.js";
import { ct as oe, lt as B, st as se, ut as ce } from "./app-initial~app-main~automations-page.js";
...
import { n as Ee, t as De } from "./app-initial~app-main~pets-settings.js";
import {
  n as Oe,
  t as ke,
...
function Pe(e) {
  ...
  let c = n?.id ?? `default`,
    ...
    f;
  t[3] !== l || t[4] !== u || t[5] !== d
    ? ((f = (0, H.jsx)(ue, { assetRef: l, className: u, spritesheetUrl: d })),
      (t[3] = l),
      (t[4] = u),
      (t[5] = d),
      (t[6] = f))
...
function Ie(e) {
  ...
  let d;
  t[5] !== c || t[6] !== l
    ? ((d = { onSuccess: l, onError: c }), (t[5] = c), (t[6] = l), (t[7] = d))
    : (d = t[7]);
  let { mutate: f } = r(`open-file`, d),
    p;
  ...
  t[9] === n
    ? (m = t[10])
    : ((m = (0, W.jsx)(`span`, { className: `font-mono text-xs break-all`, children: n })),
      (t[9] = n),
      (t[10] = m));
  let h;
  t[11] !== n || t[12] !== f
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, W.jsx)(o, {
      ...
      (_ = (0, W.jsx)(w, { className: `icon-2xs` })),
      (t[14] = g),
      (t[15] = _))
    : ((g = t[14]), (_ = t[15]));
  let v;
  t[16] === h
    ? (v = t[17])
    : ((v = (0, W.jsxs)(k, { color: `ghost`, onClick: h, size: `toolbar`, children: [g, _] })),
      (t[16] = h),
      (t[17] = v));
  let y;
  return (
    t[18] !== m || t[19] !== v
      ? ((y = (0, W.jsx)(z, { label: p, description: m, control: v })),
        (t[18] = m),
        (t[19] = v),
        (t[20] = y))
      : (y = t[20]),
...
function ze(e) {
  let t = (0, K.c)(77),
    ...
    f = a(De),
    p = a(E),
    { selectedAvatar: m, setSelectedAvatarId: h } = we(r),
    g,
    _,
    v,
    y,
  ...
  if (
    ...
    t[20] === p
      ...
      : ((a = (e, t) => {
          p.logProductEvent(
            ne,
            xe({ action: e, selectedAvatar: t, source: ee.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS }),
          );
        }),
        (t[20] = p),
        (t[21] = a));
    ...
    t[22] !== h || t[23] !== E
      ? ((D = (e) => {
          (h(e.id), E(O.CODEX_AVATAR_OVERLAY_ACTION_PET_SELECTED, e));
        }),
        (t[22] = h),
        (t[23] = E),
        (t[24] = D))
    ...
    let j;
    t[25] !== i || t[26] !== l || t[27] !== m || t[28] !== E
      ? ((j = l
          ? (0, q.jsx)(k, {
              color: `secondary`,
              loading: i,
              onClick: () => {
                (E(O.CODEX_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED, m), l());
              },
              size: `toolbar`,
              children: (0, q.jsx)(o, {
    ...
    t[30] === u
      ...
      : ((M = u
        ...
        (t[31] = M));
    let N;
    t[32] !== f || t[33] !== m || t[34] !== E
      ? ((N = () => {
          (E(
            f
              ? O.CODEX_AVATAR_OVERLAY_ACTION_CLOSE_REQUESTED
              : O.CODEX_AVATAR_OVERLAY_ACTION_OPEN_REQUESTED,
            m,
          ),
            d.dispatchMessage(`avatar-overlay-open`, {}));
        }),
        (t[32] = f),
        (t[33] = m),
        (t[34] = E),
    ...
    let F;
    (t[38] !== N || t[39] !== P
      ? ((F = (0, q.jsx)(k, { color: `secondary`, onClick: N, size: `toolbar`, children: P })),
        (t[38] = N),
        (t[39] = P),
        (t[40] = F))
      : (F = t[40]),
      t[41] !== j || t[42] !== M || t[43] !== F
        ? ((b = (0, q.jsxs)(`div`, {
    ...
    (t[49] !== A || t[50] !== m
      ? ((I = (e) =>
          (0, q.jsx)(G, { avatar: e, isSelected: e.id === m.id, onSelectAvatar: A }, e.id)),
        (t[49] = A),
        (t[50] = m),
        (t[51] = I))
      : (I = t[51]),
  ...
  t[55] === n
    ? (D = t[56])
    : ((D = n == null ? null : (0, q.jsx)(Ie, { avatarDirectory: n })), (t[55] = n), (t[56] = D));
  let A;
  t[57] !== y ||
  t[58] !== b ||
  t[59] !== x ||
  ...
  t[62] !== w ||
  t[63] !== D
    ? ((A = (0, q.jsxs)(`div`, { className: y, children: [b, x, S, C, w, D] })),
      (t[57] = y),
      (t[58] = b),
      (t[59] = x),
      (t[60] = S),
  ...
  let j;
  t[65] !== g || t[66] !== A
    ? ((j = (0, q.jsx)(g, { children: A })), (t[65] = g), (t[66] = A), (t[67] = j))
    : (j = t[67]);
  let M;
  t[68] !== _ || t[69] !== j
    ? ((M = (0, q.jsx)(_, { children: j })), (t[68] = _), (t[69] = j), (t[70] = M))
    : (M = t[70]);
  let N;
  t[71] !== v || t[72] !== M
    ? ((N = (0, q.jsx)(v, { children: M })), (t[71] = v), (t[72] = M), (t[73] = N))
    : (N = t[73]);
  let P;
  return (
    t[74] !== N || t[75] !== T
      ? ((P = (0, q.jsx)(`section`, { className: T, children: N })),
        (t[74] = N),
        (t[75] = T),
        (t[76] = P))
      : (P = t[76]),
...
function G(e) {
  ...
  let c;
  return (
    t[6] !== n.description || t[7] !== n.displayName || t[8] !== a || t[9] !== s
      ? ((c = (0, q.jsx)(z, {
          icon: a,
          label: n.displayName,
...
async function Ue({ forceReloadSkills: e, skillStatsigOverride: t }) {
  ...
  return (
    await e(),
    `${_({ name: J, path: oe(n.destination, `SKILL.md`) })} create a pet based on what you know about me`
  );
}
var J,
  Y,
  We = e(() => {
    (se(), j(), p(), y(), (J = `hatch-pet`), (Y = `skills/.curated/hatch-pet`));
  });
function Ge() {
  let e = (0, X.c)(1),
    t;
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(v, { electron: !0, children: (0, Q.jsx)(Ke, {}) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Ke() {
  let e = x(u),
    [t, n] = (0, Z.useState)(!1),
    { avatarDirectory: r, avatarOptions: i, isError: a, isLoading: s } = Me(),
    c = C(),
    l = pe(),
    { forceReload: d } = h(void 0, m),
    f = ge(),
    p = async () => {
      n(!0);
      try {
