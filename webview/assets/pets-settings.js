...
import { br as p, xr as m } from "./app-initial~app-main~onboarding-page.js";
import {
  BC as h,
  Df as g,
  Gx as _,
...
import { at as ne, dt as P, lt as F, ot as I } from "./app-initial~app-main~automations-page.js";
import {
  f as L,
  p as R,
...
import { n as de, r as fe, t as pe } from "./recommended-skill-statsig-overrides.js";
import {
  I as z,
  L as B,
...
function Fe(e) {
  ...
  t[16] === h
    ? (v = t[17])
    : ((v = (0, G.jsxs)(y, { color: `ghost`, onClick: h, size: `toolbar`, children: [g, _] })),
      (t[16] = h),
      (t[17] = v));
  let b;
  return (
...
function Re(e) {
  ...
  if (
    ...
    t[20] === f
      ...
      : ((l = (e, t) => {
          f.logProductEvent(
            ee,
            ne({ action: e, selectedAvatar: t, source: te.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS }),
          );
        }),
        (t[20] = f),
        (t[21] = l));
    ...
    t[25] !== i || t[26] !== c || t[27] !== p || t[28] !== C
      ? ((M = c
          ? (0, J.jsx)(y, {
              ...
              loading: i,
              onClick: () => {
                (C(w.CODEX_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED, p), c());
              },
              size: `toolbar`,
              children: (0, J.jsx)(k, {
    ...
    let I;
    (t[38] !== P || t[39] !== F
      ? ((I = (0, J.jsx)(y, { color: `secondary`, onClick: P, size: `toolbar`, children: F })),
        (t[38] = P),
        (t[39] = F),
        (t[40] = I))
      : (I = t[40]),
    ...
    (t[49] !== j || t[50] !== p
      ? ((L = (e) =>
          (0, J.jsx)(K, { avatar: e, isSelected: e.id === p.id, onSelectAvatar: j }, e.id)),
        (t[49] = j),
        (t[50] = p),
        (t[51] = L))
      : (L = t[51]),
  ...
  t[55] === n
    ? (A = t[56])
    : ((A = n == null ? null : (0, J.jsx)(Fe, { avatarDirectory: n })), (t[55] = n), (t[56] = A));
  let j;
  t[57] !== b ||
  t[58] !== x ||
  t[59] !== S ||
  ...
  let M;
  t[65] !== g || t[66] !== j
    ? ((M = (0, J.jsx)(g, { children: j })), (t[65] = g), (t[66] = j), (t[67] = M))
    : (M = t[67]);
  let N;
  t[68] !== _ || t[69] !== M
    ? ((N = (0, J.jsx)(_, { children: M })), (t[68] = _), (t[69] = M), (t[70] = N))
    : (N = t[70]);
  let P;
  t[71] !== v || t[72] !== N
    ? ((P = (0, J.jsx)(v, { children: N })), (t[71] = v), (t[72] = N), (t[73] = P))
    : (P = t[73]);
  let F;
  return (
    t[74] !== P || t[75] !== O
...
var Y,
  X,
  Ue = e(() => {
    (ve(), M(), ae(), f(), (Y = `hatch-pet`), (X = `skills/.curated/hatch-pet`));
  });
function We() {
  let e = (0, Z.c)(1),
    t;
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(z, { electron: !0, children: (0, Q.jsx)(Ge, {}) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
