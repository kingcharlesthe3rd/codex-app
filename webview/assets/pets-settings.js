...
import { ln as z, un as B } from "./app-initial~app-main~onboarding-page.js";
import {
  _n as ae,
  gt as oe,
  hn as se,
...
import { n as we, t as Te } from "./app-initial~app-main~pets-settings.js";
import {
  n as Ee,
  t as De,
...
import { n as je, t as Me } from "./use-avatar-options-vcIh-Q1n.js";
function Ne(e) {
  let t = (0, H.c)(11),
  ...
  let c = n?.id ?? `default`,
    ...
    f;
  t[3] !== l || t[4] !== u || t[5] !== d
    ? ((f = (0, U.jsx)(me, { assetRef: l, className: u, spritesheetUrl: d })),
      (t[3] = l),
      (t[4] = u),
      (t[5] = d),
      (t[6] = f))
...
function Fe(e) {
  ...
  t[9] === n
    ? (p = t[10])
    : ((p = (0, G.jsx)(`span`, { className: `font-mono text-xs break-all`, children: n })),
      (t[9] = n),
      (t[10] = p));
  let h;
  t[11] !== n || t[12] !== l
    ? ((h = () => {
        l({ path: n, cwd: null, target: `fileManager`, openMode: `workspace` });
      }),
      (t[11] = n),
      (t[12] = l),
      (t[13] = h))
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, G.jsx)(d, {
      ...
      (v = (0, G.jsx)(P, { className: `icon-2xs` })),
      (t[14] = _),
      (t[15] = v))
    : ((_ = t[14]), (v = t[15]));
  let y;
  t[16] === h
    ? (y = t[17])
    : ((y = (0, G.jsxs)(k, { color: `ghost`, onClick: h, size: `toolbar`, children: [_, v] })),
      (t[16] = h),
      (t[17] = y));
  let x;
  return (
    t[18] !== p || t[19] !== y
      ? ((x = (0, G.jsx)(z, { label: f, description: p, control: y })),
        (t[18] = p),
        (t[19] = y),
        (t[20] = x))
      : (x = t[20]),
...
function Re(e) {
  let t = (0, q.c)(77),
    ...
    u = x(Te),
    f = x(v),
    { selectedAvatar: p, setSelectedAvatarId: m } = de(r),
    h,
    g,
    _,
    y,
  ...
  if (
    ...
    t[22] !== m || t[23] !== x
      ? ((O = (e) => {
          (m(e.id), x(S.CODEX_AVATAR_OVERLAY_ACTION_PET_SELECTED, e));
        }),
        (t[22] = m),
        (t[23] = x),
        (t[24] = O))
    ...
    let j;
    t[25] !== i || t[26] !== c || t[27] !== p || t[28] !== x
      ? ((j = c
          ? (0, J.jsx)(k, {
              color: `secondary`,
              loading: i,
              onClick: () => {
                (x(S.CODEX_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED, p), c());
              },
              size: `toolbar`,
              children: (0, J.jsx)(d, {
    ...
    t[30] === l
      ...
      : ((M = l
        ...
        (t[31] = M));
    let N;
    t[32] !== u || t[33] !== p || t[34] !== x
      ? ((N = () => {
          (x(
            u
              ? S.CODEX_AVATAR_OVERLAY_ACTION_CLOSE_REQUESTED
              : S.CODEX_AVATAR_OVERLAY_ACTION_OPEN_REQUESTED,
            p,
          ),
    ...
    let F;
    (t[38] !== N || t[39] !== P
      ? ((F = (0, J.jsx)(k, { color: `secondary`, onClick: N, size: `toolbar`, children: P })),
        (t[38] = N),
        (t[39] = P),
        (t[40] = F))
      : (F = t[40]),
    ...
    (t[49] !== A || t[50] !== p
      ? ((I = (e) =>
          (0, J.jsx)(K, { avatar: e, isSelected: e.id === p.id, onSelectAvatar: A }, e.id)),
        (t[49] = A),
        (t[50] = p),
        (t[51] = I))
      : (I = t[51]),
  ...
  t[55] === n
    ? (O = t[56])
    : ((O = n == null ? null : (0, J.jsx)(Fe, { avatarDirectory: n })), (t[55] = n), (t[56] = O));
  let A;
  t[57] !== y ||
  t[58] !== b ||
  t[59] !== C ||
  ...
  t[62] !== E ||
  t[63] !== O
    ? ((A = (0, J.jsxs)(`div`, { className: y, children: [b, C, w, T, E, O] })),
      (t[57] = y),
      (t[58] = b),
      (t[59] = C),
      (t[60] = w),
  ...
  let j;
  t[65] !== h || t[66] !== A
    ? ((j = (0, J.jsx)(h, { children: A })), (t[65] = h), (t[66] = A), (t[67] = j))
    : (j = t[67]);
  let M;
  t[68] !== g || t[69] !== j
    ? ((M = (0, J.jsx)(g, { children: j })), (t[68] = g), (t[69] = j), (t[70] = M))
    : (M = t[70]);
  let N;
  t[71] !== _ || t[72] !== M
    ? ((N = (0, J.jsx)(_, { children: M })), (t[71] = _), (t[72] = M), (t[73] = N))
    : (N = t[73]);
  let P;
  return (
    t[74] !== N || t[75] !== D
      ? ((P = (0, J.jsx)(`section`, { className: D, children: N })),
        (t[74] = N),
        (t[75] = D),
        (t[76] = P))
      : (P = t[76]),
...
function K(e) {
  let t = (0, q.c)(11),
    ...
    a;
  t[0] === n ? (a = t[1]) : ((a = (0, J.jsx)(Ne, { avatar: n })), (t[0] = n), (t[1] = a));
  let o;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((o = r
        ? (0, J.jsx)(k, {
...
async function He({ forceReloadSkills: e, skillStatsigOverride: t }) {
  ...
  return (
    await e(),
    `${E({ name: Y, path: oe(n.destination, `SKILL.md`) })} create a pet based on what you know about me`
  );
}
var Y,
  X,
  Ue = e(() => {
    (ce(), y(), N(), i(), (Y = `hatch-pet`), (X = `skills/.curated/hatch-pet`));
  });
function We() {
  let e = (0, Z.c)(1),
    t;
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(R, { electron: !0, children: (0, Q.jsx)(Ge, {}) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Ge() {
  let e = b(u),
    [t, n] = (0, Ke.useState)(!1),
    { avatarDirectory: r, avatarOptions: i, isError: a, isLoading: s } = je(),
    c = o(),
    l = be(),
    { forceReload: f } = te(void 0, p),
    m = ve(),
    h = async () => {
      n(!0);
      try {
        l({
          prefillPrompt: await He({
            forceReloadSkills: f,
            skillStatsigOverride: ye(m, `hatch-pet`),
          }),
        });
      } catch {
        e.get(I).danger(
