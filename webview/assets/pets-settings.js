...
import { n as pe, t as me } from "./codex-avatar.js";
import { Ur as z, Wr as B } from "./app-initial~app-main~onboarding-page~profile.js";
import {
  G as he,
  K as ge,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~appgen-library-page~hot~djo67r4n.js";
import { n as _e, r as ve, t as ye } from "./recommended-skill-statsig-overrides.js";
import {
  g as be,
  h as xe,
  l as Se,
...
import { r as Ae, t as je } from "./custom-avatars-query.js";
import { n as Me, t as Ne } from "./use-avatar-options.js";
function Pe(e) {
  let t = (0, V.c)(11),
    { avatar: n, className: r, size: i } = e,
    a = i === void 0 ? `md` : i,
    s = a === `sm` ? `size-8` : `size-16`,
    c;
  t[0] !== r || t[1] !== s
    ? ((c = o(
  ...
  let l = n?.id ?? `default`,
    ...
    p;
  t[3] !== u || t[4] !== d || t[5] !== f
    ? ((p = (0, H.jsx)(me, { assetRef: u, className: d, spritesheetUrl: f })),
      (t[3] = u),
      (t[4] = d),
      (t[5] = f),
      (t[6] = p))
  ...
  return (
    t[7] !== c || t[8] !== l || t[9] !== p
      ? ((m = (0, H.jsx)(`div`, { className: c, "data-avatar-id": l, children: p })),
        (t[7] = c),
        (t[8] = l),
        (t[9] = p),
        (t[10] = m))
...
function Ie(e) {
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, W.jsx)(I, {
      ...
      (g = (0, W.jsx)(T, { className: `icon-2xs` })),
      (t[14] = h),
      (t[15] = g))
    : ((h = t[14]), (g = t[15]));
  let v;
  t[16] === m
    ? (v = t[17])
    : ((v = (0, W.jsxs)(l, { color: `ghost`, onClick: m, size: `toolbar`, children: [h, g] })),
      (t[16] = m),
      (t[17] = v));
  let y;
  return (
    t[18] !== p || t[19] !== v
      ? ((y = (0, W.jsx)(z, { label: f, description: p, control: v })),
        (t[18] = p),
        (t[19] = v),
        (t[20] = y))
      : (y = t[20]),
...
function ze(e) {
  let t = (0, K.c)(77),
    ...
    d = p(se),
    f = p(u),
    { selectedAvatar: m, setSelectedAvatarId: h } = Ee(r),
    g,
    _,
    v,
    y,
  ...
  if (
    ...
    t[20] === f
      ...
      : ((u = (e, t) => {
          f.logProductEvent(
            ee,
            ce({ action: e, selectedAvatar: t, source: re.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS }),
          );
        }),
        (t[20] = f),
        (t[21] = u));
    ...
    t[22] !== h || t[23] !== p
      ? ((E = (e) => {
          (h(e.id), p(L.CODEX_AVATAR_OVERLAY_ACTION_PET_SELECTED, e));
        }),
        (t[22] = h),
        (t[23] = p),
        (t[24] = E))
      : (E = t[24]);
    let D = E;
    ((T = `flex flex-col gap-[var(--padding-panel)]`),
      (v = ke),
      (_ = ke.Content),
      (g = xe),
      (y = `flex flex-col divide-y divide-token-border bg-token-bg-secondary/20`));
    let O;
    t[25] !== i || t[26] !== s || t[27] !== m || t[28] !== p
      ? ((O = s
          ? (0, q.jsx)(l, {
              color: `secondary`,
              loading: i,
              onClick: () => {
                (p(L.CODEX_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED, m), s());
              },
              size: `toolbar`,
              children: (0, q.jsx)(I, {
    ...
    t[30] === c
      ...
      : ((k = c
        ...
        (t[31] = k));
    let A;
    t[32] !== d || t[33] !== m || t[34] !== p
      ? ((A = () => {
          (p(
            d
              ? L.CODEX_AVATAR_OVERLAY_ACTION_CLOSE_REQUESTED
              : L.CODEX_AVATAR_OVERLAY_ACTION_OPEN_REQUESTED,
            m,
          ),
            ne.dispatchMessage(`avatar-overlay-open`, {}));
        }),
        (t[32] = d),
        (t[33] = m),
        (t[34] = p),
    ...
    let M;
    (t[38] !== A || t[39] !== j
      ? ((M = (0, q.jsx)(l, { color: `secondary`, onClick: A, size: `toolbar`, children: j })),
        (t[38] = A),
        (t[39] = j),
        (t[40] = M))
      : (M = t[40]),
      t[41] !== O || t[42] !== k || t[43] !== M
        ? ((b = (0, q.jsxs)(`div`, {
    ...
    (t[49] !== D || t[50] !== m
      ? ((N = (e) =>
          (0, q.jsx)(G, { avatar: e, isSelected: e.id === m.id, onSelectAvatar: D }, e.id)),
        (t[49] = D),
        (t[50] = m),
        (t[51] = N))
      : (N = t[51]),
  ...
  t[55] === n
    ? (E = t[56])
    : ((E = n == null ? null : (0, q.jsx)(Ie, { avatarDirectory: n })), (t[55] = n), (t[56] = E));
  let D;
  t[57] !== y ||
  t[58] !== b ||
  t[59] !== x ||
  ...
  t[62] !== w ||
  t[63] !== E
    ? ((D = (0, q.jsxs)(`div`, { className: y, children: [b, x, S, C, w, E] })),
      (t[57] = y),
      (t[58] = b),
      (t[59] = x),
      (t[60] = S),
  ...
  let O;
  t[65] !== g || t[66] !== D
    ? ((O = (0, q.jsx)(g, { children: D })), (t[65] = g), (t[66] = D), (t[67] = O))
    : (O = t[67]);
  let k;
  t[68] !== _ || t[69] !== O
    ? ((k = (0, q.jsx)(_, { children: O })), (t[68] = _), (t[69] = O), (t[70] = k))
    : (k = t[70]);
  let A;
  t[71] !== v || t[72] !== k
    ? ((A = (0, q.jsx)(v, { children: k })), (t[71] = v), (t[72] = k), (t[73] = A))
    : (A = t[73]);
  let j;
  return (
    t[74] !== A || t[75] !== T
      ? ((j = (0, q.jsx)(`section`, { className: T, children: A })),
        (t[74] = A),
        (t[75] = T),
        (t[76] = j))
      : (j = t[76]),
...
function G(e) {
  let t = (0, K.c)(11),
    ...
    a;
  t[0] === n ? (a = t[1]) : ((a = (0, q.jsx)(Pe, { avatar: n })), (t[0] = n), (t[1] = a));
  let o;
  t[2] !== n || t[3] !== r || t[4] !== i
    ? ((o = r
        ? (0, q.jsx)(l, {
...
async function Ue({ forceReloadSkills: e, skillStatsigOverride: t }) {
  let n = await E(`install-recommended-skill`, {
    params: {
      forceReinstall: !0,
      hostId: x,
      installRoot: null,
  ...
  return (
    await e(),
    `${ie({ name: J, path: Ce(n.destination, `SKILL.md`) })} create a pet based on what you know about me`
  );
}
var J,
  Y,
  We = e(() => {
    (Se(), S(), P(), n(), (J = `hatch-pet`), (Y = `skills/.curated/hatch-pet`));
  });
function Ge() {
  let e = (0, X.c)(1),
    t;
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(w, { electron: !0, children: (0, Q.jsx)(Ke, {}) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
function Ke() {
  let e = d(_),
    [t, n] = (0, Z.useState)(!1),
    { avatarDirectory: r, avatarOptions: i, isError: a, isLoading: o } = Me(),
    s = v(),
    c = y(),
    { forceReload: l } = b(void 0, x),
    u = ve(),
    f = async () => {
      n(!0);
      try {
        c({
          prefillPrompt: await Ue({
            forceReloadSkills: l,
            skillStatsigOverride: ye(u, `hatch-pet`),
          }),
        });
      } catch {
        e.get(R).danger(
