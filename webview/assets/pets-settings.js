...
import { gt as ne, ht as re } from "./app-initial~app-main~automations-page.js";
import { n as ie, t as ae } from "./codex-avatar.js";
import {
  bn as oe,
  yn as se,
} from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~pull-requests-page~new-~ozr5a6hk.js";
import { Fn as B, In as V } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
import {
  H as ce,
  V as le,
  ir as ue,
...
import { n as fe, r as pe, t as me } from "./recommended-skill-statsig-overrides.js";
import {
  J as he,
  d as ge,
  f as _e,
...
import { n as De, t as Oe } from "./app-initial~app-main~pets-settings.js";
...
function Fe(e) {
  ...
  t[9] === n
    ? (m = t[10])
    : ((m = (0, G.jsx)(`span`, { className: `font-mono text-xs break-all`, children: n })),
      (t[9] = n),
      (t[10] = m));
  let h;
  t[11] !== n || t[12] !== d
  ...
  t[16] === h
    ? (y = t[17])
    : ((y = (0, G.jsxs)(b, { color: `ghost`, onClick: h, size: `toolbar`, children: [_, v] })),
      (t[16] = h),
      (t[17] = y));
  let x;
  return (
...
function Re(e) {
  ...
  if (
    ...
    t[20] === u
      ...
      : ((f = (e, t) => {
          u.logProductEvent(
            ee,
            re({ action: e, selectedAvatar: t, source: te.CODEX_AVATAR_OVERLAY_SOURCE_SETTINGS }),
          );
        }),
        (t[20] = u),
        (t[21] = f));
    ...
    t[25] !== i || t[26] !== s || t[27] !== d || t[28] !== D
      ? ((A = s
          ? (0, J.jsx)(b, {
              ...
              loading: i,
              onClick: () => {
                (D(I.CODEX_AVATAR_OVERLAY_ACTION_CUSTOM_PET_CREATE_STARTED, d), s());
              },
              size: `toolbar`,
              children: (0, J.jsx)(z, {
    ...
    let P;
    (t[38] !== M || t[39] !== N
      ? ((P = (0, J.jsx)(b, { color: `secondary`, onClick: M, size: `toolbar`, children: N })),
        (t[38] = M),
        (t[39] = N),
        (t[40] = P))
      : (P = t[40]),
    ...
    (t[49] !== k || t[50] !== d
      ? ((F = (e) =>
          (0, J.jsx)(K, { avatar: e, isSelected: e.id === d.id, onSelectAvatar: k }, e.id)),
        (t[49] = k),
        (t[50] = d),
        (t[51] = F))
      : (F = t[51]),
  ...
  t[55] === n
    ? (D = t[56])
    : ((D = n == null ? null : (0, J.jsx)(Fe, { avatarDirectory: n })), (t[55] = n), (t[56] = D));
  let O;
  t[57] !== y ||
  t[58] !== x ||
  t[59] !== S ||
  ...
  let k;
  t[65] !== g || t[66] !== O
    ? ((k = (0, J.jsx)(g, { children: O })), (t[65] = g), (t[66] = O), (t[67] = k))
    : (k = t[67]);
  let A;
  t[68] !== _ || t[69] !== k
    ? ((A = (0, J.jsx)(_, { children: k })), (t[68] = _), (t[69] = k), (t[70] = A))
    : (A = t[70]);
  let M;
  t[71] !== v || t[72] !== A
    ? ((M = (0, J.jsx)(v, { children: A })), (t[71] = v), (t[72] = A), (t[73] = M))
    : (M = t[73]);
  let N;
  return (
    t[74] !== M || t[75] !== E
...
function We() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(w, { electron: !0, children: (0, Q.jsx)(Ge, {}) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
