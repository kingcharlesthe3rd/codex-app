...
import { l as r, o as i, u as a } from "./statsig.js";
import { t as o } from "./use-auth.js";
import { n as s, t as c } from "./skus.js";
...
function p() {
  let e = (0, u.c)(21),
    { authMethod: c, isLoading: p } = o(),
    h = c === `chatgpt`,
    _ = r(d),
    v = i(`3909937021`),
    y = a(),
    { data: b, isLoading: x, hasEverErrored: S } = l(),
    C;
  e[0] === h
    ? (C = e[1])
...
function m({
  ...
  return {
    ...
    isUsageSettingsVisible: a || (i && o && n) || (i && c && r),
  };
}
function h(e) {
  return e === c.PLUS || e === c.PRO || e === c.PROLITE;
}
function g(e) {
