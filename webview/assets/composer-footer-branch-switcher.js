...
import { Wn as le } from "./app-initial~app-main~remote-conversation-page~pull-requests-page~onboarding-page~hotkey-win~fzw0jvy4.js";
import {
  I as ue,
  L as de,
...
function Ce(e) {
  ...
  let { data: B, isLoading: Oe, refetch: V } = c(k, i, `async_task_starting_state_dropdown`, I),
    H = A && y && !!k,
    U;
  ...
  t[14] === $e
    ? (et = t[15])
    : ((et = (0, z.jsx)(ue, { electron: !0, children: $e })), (t[14] = $e), (t[15] = et));
  let tt;
  t[16] === Ye
    ? (tt = t[17])
    : ((tt = (0, z.jsx)(ue, { browser: !0, children: Ye })), (t[16] = Ye), (t[17] = tt));
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ot = t[25]);
  let J;
  t[26] === a ? (J = t[27]) : ((J = w(`whitespace-nowrap`, a)), (t[26] = a), (t[27] = J));
...
function Te(e) {
  ...
  return (
    t[12] !== y || t[13] !== b || t[14] !== S || t[15] !== x || t[16] !== w
      ? ((T = { branches: y, defaultBranch: b, fetching: x, error: S, refetch: w }),
        (t[12] = y),
        (t[13] = b),
        (t[14] = S),
        (t[15] = x),
...
function Ee(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = w(`text-sm text-token-description-foreground px-[var(--padding-row-x)] py-1`, n)),
      (t[0] = n),
      (t[1] = i));
  let a;
  return (
