...
import {
  ...
  t as M,
  u as ye,
} from "./git-branch-switcher.js";
import { n as be, t as xe } from "./use-git-recent-branches.js";
function Se(e) {
  let t = (0, Ce.c)(11),
    { children: n, color: r, borderColor: i, badgeEnabled: o } = e,
  ...
  t[2] !== i || t[3] !== s || t[4] !== l
    ...
    : (u = t[5]);
  let d;
  t[6] === u ? (d = t[7]) : ((d = (0, N.jsx)(`div`, { className: u })), (t[6] = u), (t[7] = d));
  let f;
  return (
    t[8] !== n || t[9] !== d
      ? ((f = (0, N.jsxs)(`div`, { className: `relative`, children: [n, d] })),
        (t[8] = n),
        (t[9] = d),
        (t[10] = f))
      : (f = t[10]),
...
function Te(e) {
  let t = (0, I.c)(48),
    ...
    C = se(),
    T;
  t[0] === _ ? (T = t[1]) : ((T = { enabled: _ }), (t[0] = _), (t[1] = T));
  let ce = me(T),
    D = u ?? ce,
    de = le(C),
  ...
  let j = A,
    ve = !O && !!pe && g && !!k,
    M;
  t[3] === ve ? (M = t[4]) : ((M = { enabled: ve }), (t[3] = ve), (t[4] = M));
  let {
      data: ye,
      isFetching: be,
      error: xe,
  ...
  let { data: z, isLoading: ke, refetch: B } = ue(D, i, `async_task_starting_state_dropdown`, F),
    V = O && _ && !!D,
    H;
  t[7] === V ? (H = t[8]) : ((H = { enabled: V }), (t[7] = V), (t[8] = H));
  let { data: U } = ge(D, i, `async_task_starting_state_dropdown`, H),
    {
      branches: W,
      defaultBranch: Ae,
      fetching: je,
  ...
  t[9] !== k || t[10] !== D || t[11] !== i || t[12] !== Pe
    ? ((Fe = {
      ...
      (t[13] = Fe))
    : (Fe = t[13]);
  let { data: Ie, isFetching: Le, error: Re, refetch: ze } = f(_e, Fe),
    Be = n.type === `branch` ? n.branchName : void 0,
    q = O ? Ae : fe,
    Ve = O ? (K ? Ie : W) : K ? ye?.filter((e) => e.toLowerCase().includes(Ne)) : void 0,
  ...
  t[14] === $e
    ? (et = t[15])
    : ((et = (0, R.jsx)(h, { electron: !0, children: $e })), (t[14] = $e), (t[15] = et));
  let tt;
  t[16] === Ye
    ? (tt = t[17])
    : ((tt = (0, R.jsx)(h, { browser: !0, children: Ye })), (t[16] = Ye), (t[17] = tt));
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ot = t[25]);
  let J;
  t[26] === o ? (J = t[27]) : ((J = a(`whitespace-nowrap`, o)), (t[26] = o), (t[27] = J));
  let st = n.type === `working-tree` && Xe,
    ct;
  t[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ct = (0, R.jsx)(x, { className: `icon-xs` })), (t[28] = ct))
    : (ct = t[28]);
  let lt;
  t[29] === st
    ? (lt = t[30])
  ...
  t[34] === j
    ...
    : ((X = (e) => {
      ...
      (t[35] = X));
  let Z;
  t[36] !== y || t[37] !== Y || t[38] !== X
    ? ((Z = (0, R.jsx)(w.SearchInput, {
        autoFocus: !1,
        placeholder: Y,
        value: y,
        onChange: ut,
  ...
  let dt = Ze
      ? (0, R.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, R.jsx)(w.Item, {
              LeftIcon: Ee,
              RightIcon: n.type === `working-tree` ? oe : void 0,
              SubText: Xe
                ? (0, R.jsx)(`span`, {
  ...
  let ft =
      k && We
        ? (0, R.jsx)(`div`, {
            ...
            children: (0, R.jsx)(b, { className: `icon-xxs` }),
          })
        : k && Ge
          ? (0, R.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, R.jsx)(s, {
                  ...
                  children: (0, R.jsx)(te, { className: `icon-xxs` }),
                }),
              ],
            })
          : (0, R.jsxs)(`div`, {
              ...
              children: [
                He &&
                  (0, R.jsx)(w.Item, {
                    LeftIcon: x,
                    RightIcon: Be === q ? oe : void 0,
                    onClick: () => {
                      (r({ type: `branch`, branchName: q }), j(!1));
                    },
                    children: q,
                  }),
                Ue?.map((e) =>
                  (0, R.jsx)(
                    ...
                    {
                      LeftIcon: x,
                      RightIcon: e === Be ? oe : void 0,
                      onClick: () => {
                        (r({ type: `branch`, branchName: e }), j(!1));
                      },
                      children: e,
                    },
                    e,
...
function Ee(e) {
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, R.jsx)(Se, {
          borderColor: `border-token-side-bar-background`,
          children: (0, R.jsx)(x, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
function De(e) {
  ...
  let {
      ...
      error: d,
      refetch: f,
    } = pe(n, r, `async_task_starting_state_dropdown`, s),
    p;
  ...
  let ne = x,
    S;
  return (
    t[12] !== _ || t[13] !== v || t[14] !== b || t[15] !== y || t[16] !== ne
      ? ((S = { branches: _, defaultBranch: v, fetching: y, error: b, refetch: ne }),
        (t[12] = _),
        (t[13] = v),
        (t[14] = b),
        (t[15] = y),
...
function Oe(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = a(`text-sm text-token-description-foreground px-[var(--padding-row-x)] py-1`, n)),
      (t[0] = n),
      (t[1] = i));
  let o;
  return (
    t[2] !== r || t[3] !== i
      ? ((o = (0, R.jsx)(`div`, { className: i, children: r })), (t[2] = r), (t[3] = i), (t[4] = o))
      : (o = t[4]),
    o
  );
}
...
function B(e) {
  ...
  return t == null
    ...
    : (0, U.jsx)(ie, {
        tooltipContent: i,
        children: (0, U.jsx)(he, {
          categoryLabel: (0, U.jsx)(E, { ...W.branchCategory }),
          className: `px-0`,
          collapse: `sm`,
          disabled: n,
          icon: (0, U.jsx)(x, { className: `icon-xs` }),
