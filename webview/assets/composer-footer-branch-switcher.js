...
import { Ta as s } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~new-thread-panel-page~o~kg2pu5rs.js";
import {
  $s as c,
  Dm as l,
  Em as u,
...
function Ee(e) {
  ...
  let { data: R, isLoading: Ae, refetch: z } = pe(T, a, `async_task_starting_state_dropdown`, P),
    B = E && _ && !!T,
    V;
  ...
  t[14] === $e
    ? (et = t[15])
    : ((et = (0, L.jsx)(v, { electron: !0, children: $e })), (t[14] = $e), (t[15] = et));
  let tt;
  t[16] === Ye
    ? (tt = t[17])
    : ((tt = (0, L.jsx)(v, { browser: !0, children: Ye })), (t[16] = Ye), (t[17] = tt));
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ot = t[25]);
  let st;
  t[26] === o ? (st = t[27]) : ((st = y(`whitespace-nowrap`, o)), (t[26] = o), (t[27] = st));
...
function Oe(e) {
  ...
  if (t[4] !== i || t[5] !== c || t[6] !== m || t[7] !== a) {
    let e = [
        c,
        i,
        N({ currentBranch: i, gitDefaultBranch: c, recentBranches: m, remoteDefaultBranch: a }),
        ...(m ?? []),
      ],
      n = new Set();
    ((h = []),
  ...
  return (
    t[12] !== h || t[13] !== g || t[14] !== v || t[15] !== _ || t[16] !== b
      ? ((x = { branches: h, defaultBranch: g, fetching: _, error: v, refetch: b }),
        (t[12] = h),
        (t[13] = g),
        (t[14] = v),
        (t[15] = _),
...
function ke(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = y(`text-sm text-token-description-foreground px-[var(--padding-row-x)] py-1`, n)),
      (t[0] = n),
      (t[1] = i));
  let a;
  return (
