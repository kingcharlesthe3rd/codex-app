...
import { t as ee } from "./use-debounced-value-Dw-7BPJJ.js";
import { n as g, r as _ } from "./composer-footer.js";
import { t as v } from "./chevron.js";
import { t as y } from "./branch-D.js";
import { C as te } from "./codex-api.js";
import { i as ne, n as b } from "./use-environment.js";
import { t as x } from "./use-git-current-branch.js";
import { t as S } from "./use-git-default-branch.js";
import { o as C } from "./slash-command-item.js";
...
function ce(e) {
  ...
  let { data: z } = ie(O, S, `async_task_starting_state_dropdown`, R),
    {
      branches: Fe,
      defaultBranch: Ie,
      fetching: Le,
  ...
  t[5] !== M || t[6] !== O || t[7] !== S || t[8] !== Be
    ? ((H = {
      ...
      (t[9] = H))
    : (H = t[9]);
  let { data: Ve, isFetching: He, error: Ue, refetch: We } = r(re, H),
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (W = t[20]);
  let G;
  t[21] === w ? (G = t[22]) : ((G = s(`whitespace-nowrap`, w)), (t[21] = w), (t[22] = G));
  let dt = n?.type === `working-tree` && tt,
    ft;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ft = (0, E.jsx)(y, { className: `icon-xs` })), (t[23] = ft))
    : (ft = t[23]);
  let K;
  t[24] === dt
    ? (K = t[25])
  ...
  let pt = he
      ? null
      : (0, E.jsx)(g, { collapse: `secondary`, className: `max-w-40 truncate`, children: st }),
    mt;
  t[26] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((mt = (0, E.jsx)(_, {
        children: (0, E.jsx)(v, { className: `icon-2xs text-token-input-placeholder-foreground` }),
      })),
      (t[26] = mt))
    : (mt = t[26]);
  let q;
  ...
  let _t =
      M && Ye
        ? (0, E.jsx)(`div`, {
            ...
            children: (0, E.jsx)(l, { className: `icon-xxs` }),
          })
        : M && Xe
          ? (0, E.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, E.jsx)(c, {
                  ...
                  children: (0, E.jsx)(f, { className: `icon-xxs` }),
                }),
              ],
            })
          : (0, E.jsxs)(`div`, {
              ...
              children: [
                qe &&
                  (0, E.jsx)(p.Item, {
                    ...
                    onClick: () => {
                      (i({ type: `branch`, branchName: U }), P(!1));
                    },
                    children: U,
                  }),
                Je?.map((e) =>
                  (0, E.jsx)(
                    p.Item,
                    {
                      ...
                      onClick: () => {
                        (i({ type: `branch`, branchName: e }), P(!1));
                      },
                      children: e,
                    },
                    e,
...
function le(e) {
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, E.jsx)(oe, {
          borderColor: `border-token-side-bar-background`,
          children: (0, E.jsx)(y, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
function ue(e) {
  ...
  let x = b,
    C;
  return (
    t[12] !== v || t[13] !== y || t[14] !== ne || t[15] !== te || t[16] !== x
      ? ((C = { branches: v, defaultBranch: y, fetching: te, error: ne, refetch: x }),
        (t[12] = v),
        (t[13] = y),
        (t[14] = ne),
        (t[15] = te),
...
function de(e) {
  ...
  return (
    t[2] !== r || t[3] !== i
      ? ((a = (0, E.jsx)(`div`, { className: i, children: r })), (t[2] = r), (t[3] = i), (t[4] = a))
      : (a = t[4]),
    a
  );
}
  ...
  return t == null
    ...
    : (0, E.jsx)(d, {
        ...
        children: (0, E.jsxs)(c, {
          ...
          disabled: n,
          children: [
            (0, E.jsx)(y, { className: `icon-xs` }),
            (0, E.jsx)(g, { collapse: `sm`, className: `max-w-40 truncate text-sm`, children: t }),
            r
              ? (0, E.jsx)(l, { className: `icon-xs text-token-input-placeholder-foreground` })
              : (0, E.jsx)(_, {
                  children: (0, E.jsx)(v, {
