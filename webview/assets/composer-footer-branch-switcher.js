...
import { c as ge, l as _e, n as j, s as ve, t as M, u as ye } from "./git-branch-switcher.js";
...
function Te(e) {
  let t = (0, I.c)(48),
    ...
    oe = n(),
    E;
  t[0] === S ? (E = t[1]) : ((E = { enabled: S }), (t[0] = S), (t[1] = E));
  let ce = me(E),
    D = h ?? ce,
    ue = l(oe),
  ...
  let { data: z, isLoading: ke, refetch: B } = le(D, u, `async_task_starting_state_dropdown`, F),
    V = O && S && !!D,
    H;
  t[7] === V ? (H = t[8]) : ((H = { enabled: V }), (t[7] = V), (t[8] = H));
  let { data: U } = ge(D, u, `async_task_starting_state_dropdown`, H),
    {
      branches: W,
      defaultBranch: Ae,
      fetching: je,
  ...
  t[9] !== k || t[10] !== D || t[11] !== u || t[12] !== Pe
    ? ((Fe = {
      ...
      (t[13] = Fe))
    : (Fe = t[13]);
  let { data: Ie, isFetching: Le, error: Re, refetch: ze } = p(_e, Fe),
    Be = o.type === `branch` ? o.branchName : void 0,
    q = O ? Ae : de,
    ...
    $e =
      o.type === `working-tree`
        ...
        : (0, R.jsx)(r, {
            ...
            values: { branch: o.branchName },
          }),
    et;
  t[14] === $e
    ? (et = t[15])
    : ((et = (0, R.jsx)(se, { electron: !0, children: $e })), (t[14] = $e), (t[15] = et));
  let tt;
  t[16] === Ye
    ? (tt = t[17])
    : ((tt = (0, R.jsx)(se, { browser: !0, children: Ye })), (t[16] = Ye), (t[17] = tt));
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ot = t[25]);
  let st;
  t[26] === f ? (st = t[27]) : ((st = C(`whitespace-nowrap`, f)), (t[26] = f), (t[27] = st));
  let ct = o.type === `working-tree` && Xe,
    lt;
  t[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((lt = (0, R.jsx)(i, { className: `icon-xs` })), (t[28] = lt))
    : (lt = t[28]);
  let ut;
  t[29] === ct
    ? (ut = t[30])
  ...
  let ft = Ze
      ? (0, R.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, R.jsx)(T.Item, {
              LeftIcon: Ee,
              RightIcon: o.type === `working-tree` ? m : void 0,
              SubText: Xe
                ? (0, R.jsx)(`span`, {
  ...
  let pt =
      k && We
        ? (0, R.jsx)(`div`, {
            ...
            children: (0, R.jsx)(ie, { className: `icon-xxs` }),
          })
        : k && Ge
          ? (0, R.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, R.jsx)(b, {
                  ...
                  children: (0, R.jsx)(pe, { className: `icon-xxs` }),
                }),
              ],
            })
          : (0, R.jsxs)(`div`, {
              ...
              children: [
                He &&
                  (0, R.jsx)(T.Item, {
                    LeftIcon: i,
                    RightIcon: Be === q ? m : void 0,
                    onClick: () => {
                      (s({ type: `branch`, branchName: q }), j(!1));
                    },
                    children: q,
                  }),
                Ue?.map((e) =>
...
function Ee(e) {
  ...
  return (
    t[0] === n
      ...
      : ((r = (0, R.jsx)(Se, {
          borderColor: `border-token-side-bar-background`,
          children: (0, R.jsx)(i, { className: n }),
        })),
        (t[0] = n),
        (t[1] = r)),
    r
...
function Oe(e) {
  ...
  t[0] === n
    ? (i = t[1])
    : ((i = C(`text-sm text-token-description-foreground px-[var(--padding-row-x)] py-1`, n)),
      (t[0] = n),
      (t[1] = i));
  let a;
  return (
...
function B(e) {
  let { currentBranch: t, disabled: n, isPending: a, switchTooltipText: o } = e;
  return t == null
    ? null
    : (0, U.jsx)(re, {
        tooltipContent: o,
        children: (0, U.jsx)(he, {
          categoryLabel: (0, U.jsx)(r, { ...W.branchCategory }),
          className: `px-0`,
          collapse: `sm`,
          disabled: n,
          icon: (0, U.jsx)(i, { className: `icon-xs` }),
          indicator: a ? `pending` : `collapsible-chevron`,
          value: t,
