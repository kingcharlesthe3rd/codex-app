...
function Tt(e) {
  ...
  t[30] === A
    ? (M = t[31])
    : ((M = (0, Y.jsx)(w, { color: `outline`, size: `toolbar`, onClick: A, children: j })),
      (t[30] = A),
      (t[31] = M));
  let N;
  t[32] !== k || t[33] !== M
    ...
    : (N = t[34]);
  let P;
  t[35] !== r || t[36] !== c || t[37] !== i || t[38] !== _ || t[39] !== n || t[40] !== s
    ? ((P = _
        ? (0, Y.jsx)(Ot, {
            open: _,
            serverState: n,
...
function Ot(e) {
  ...
  let { data: h, isPending: _ } = rt(m),
    v;
  t[2] !== h || t[3] !== n
    ? ((v = { billingCurrency: h, enabled: n }), (t[2] = h), (t[3] = n), (t[4] = v))
    : (v = t[4]);
    ...
    ? ((he = async (e) => {
        ...
        if (n.isSaveEnabled)
          switch (n.saveIntent) {
            ...
            case `enable`:
              try {
                if ((ue(), Je((await s.mutateAsync(on(t))).immediate_top_up_status))) {
                  fe({ draftState: t });
                  return;
                }
                (L(`enable`), u(!1));
            ...
            case `update`:
              try {
                if ((ue(), Je((await c.mutateAsync(on(t))).immediate_top_up_status))) {
                  fe({ draftState: t });
                  return;
                }
                (L(`update`), u(!1));
  ...
  let ye = ve,
    be;
  t[41] !== l || t[42] !== u || t[43] !== r.isEnabled || t[44] !== I || t[45] !== L
    ? ((be = async () => {
        if (r.isEnabled)
          try {
  ...
  t[69] !== k
    ? ((Se = (e) => {
        let { values: t, submissionAttempts: a } = e,
          ...
          c =
            !ie && s != null && (o.saveIntent === `enable` || o.saveIntent === `update`)
...
function Ut(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Y.jsx)(v, { className: `icon-xxs text-token-description-foreground` })), (t[2] = i))
    : (i = t[2]);
  let a;
  return (
    t[3] === r
...
function gn(e) {
  ...
  t[16] !== E || t[17] !== D || t[18] !== O
    ? ((k = (0, X.jsx)(w, { color: E, size: `toolbar`, onClick: D, children: O })),
      (t[16] = E),
      (t[17] = D),
      (t[18] = O),
      (t[19] = k))
  ...
  t[20] !== S || t[21] !== T || t[22] !== k || t[23] !== C
    ? ((A = (0, X.jsx)(S, { className: `gap-6`, label: C, description: T, control: k })),
      (t[20] = S),
      (t[21] = T),
      (t[22] = k),
      (t[23] = C),
...
var xn,
  X,
  Sn = e(() => {
    ((xn = d()), c(), F(), b(), P(), Ae(), Ve(), i(), lt(), V(), ct(), Fe(), mt(), Ue(), (X = p()));
  });
function Cn() {
  let e = (0, Dn.c)(1),
    t;
...
function Nn(e) {
  ...
  if (a && n == null) {
    ...
    t[2] === s
      ? (n = t[3])
      : ((n = (0, Z.jsx)(w, { color: `secondary`, size: `toolbar`, onClick: s, children: e })),
        (t[2] = s),
        (t[3] = n));
    let r;
    return (
      t[4] !== i || t[5] !== n
        ? ((r = (0, Z.jsx)(z, { label: i, control: n })), (t[4] = i), (t[5] = n), (t[6] = r))
        : (r = t[6]),
      r
    );
  }
  if (n == null || n.length === 0) {
    ...
    return (
      t[7] === r
        ? (e = t[8])
        : ((e = (0, Z.jsx)(z, { label: r, control: null })), (t[7] = r), (t[8] = e)),
      e
    );
  }
  let l;
    ...
    t[0] !== n || t[1] !== r
      ? ((i =
          n === `credits`
            ...
            : (0, Z.jsx)(se, { value: r / 100, style: `percent`, maximumFractionDigits: 0 })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
                            ...
                            control:
                              c == null
                                ...
                                : (0, Q.jsx)(w, {
                                    ...
                                    onClick: (e) => {
                                      A({ event: e, href: c, initiator: `open_in_browser_bridge` });
                                    },
                                    children: (0, Q.jsx)(R, {
...
function Kn(e) {
  let t = (0, cr.c)(6),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(Se, { "aria-hidden": !0, className: `icon-sm text-token-text-tertiary` })),
      (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
...
function qn(e) {
  let t = (0, cr.c)(28),
    { pendingRequest: n, isLoading: r, isSaving: i, saveWorkspaceAdminRequest: s } = e,
    c = o(a),
    l = ce(),
    [u, d] = (0, lr.useState)(!1),
  ...
  t[12] !== r || t[13] !== _ || t[14] !== v || t[15] !== y
    ...
    : (b = t[16]);
  let x;
  t[17] !== h || t[18] !== l || t[19] !== u || t[20] !== i || t[21] !== f || t[22] !== n
    ? ((x = u
        ? (0, Q.jsx)(q, {
...
function Yn(e) {
  ...
  return (
    t[10] !== o || t[11] !== u || t[12] !== d
      ? ((f = (0, Q.jsx)(z, { className: `gap-6`, label: u, description: o, control: d })),
        (t[10] = o),
        (t[11] = u),
        (t[12] = d),
        (t[13] = f))
...
function gr() {
  ...
  if (L || ce || se) {
    ...
    if (L) {
      ...
      (e[24] === ue
        ? (a = e[25])
        : ((a = (0, $.jsx)(w, { color: `secondary`, size: `toolbar`, onClick: ue, children: i })),
          (e[24] = ue),
          (e[25] = a)),
        (n = a));
    } else {
  ...
  e[41] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (de = e[41]);
  let z;
  e[42] === i ? (z = e[43]) : ((z = (0, $.jsx)(gn, { plan: i })), (e[42] = i), (e[43] = z));
  let B;
  e[44] !== p || e[45] !== t || e[46] !== F || e[47] !== re || e[48] !== c?.credits || e[49] !== ae
    ? ((B =
        t && p != null
          ? (0, $.jsx)(Tt, {
              serverState: p,
  ...
  e[53] === t
    ? (U = e[54])
    : ((U = (0, $.jsx)(j, { browser: !0, children: (0, $.jsx)(jn, { showCreditHistory: t }) })),
      (e[53] = t),
      (e[54] = U));
  let W;
...
function yr(e) {
  ...
  t[0] !== i || t[1] !== r
    ? ((a = (0, $.jsx)(K, {
        children: (0, $.jsx)(K.Content, {
          children: (0, $.jsx)(q, {
            children: (0, $.jsx)(z, { className: `gap-6`, label: r, control: i }),
          }),
        }),
      })),
      (t[0] = i),
  ...
  return (
    t[3] !== a || t[4] !== n
      ? ((o = (0, $.jsx)(dt, { title: n, children: a })), (t[3] = a), (t[4] = n), (t[5] = o))
      : (o = t[5]),
    o
  );
}
