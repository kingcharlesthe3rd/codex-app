...
import "./checkbox.js";
import "./minus.js";
import { i as N, n as re, r as P, t as F } from "./rate-limit-rows.js";
import { E as I, O as ie, j as ae, n as L, o as oe, y as se } from "./use-rate-limit.js";
import {
  a as R,
  c as ce,
  n as z,
  ...
  t as V,
  u as H,
} from "./plan-management-state.js";
import "./links.js";
import { t as U } from "./upgrade-plan-dialog-launcher.js";
import "./chevron.js";
...
import { t as ue } from "./settings-empty-state.js";
import { t as de } from "./useForm.js";
import { t as fe } from "./plan-pricing.js";
...
function he({ draftState: e, serverState: t, isSaving: n }) {
  let r = me({ rechargeThreshold: e.rechargeThreshold, rechargeTarget: e.rechargeTarget }),
...
function De(e) {
  ...
  let b;
  t[5] !== r || t[6] !== m || t[7] !== s
    ? ((b = Ye({ intl: s, creditDetails: r, pricingInfo: m })),
      (t[5] = r),
      (t[6] = m),
      (t[7] = s),
      (t[8] = b))
  ...
  t[28] === O
    ? (te = t[29])
    : ((te = (0, $.jsx)(g, { color: `outline`, onClick: O, children: k })),
      (t[28] = O),
      (t[29] = te));
  let A;
  t[30] !== D || t[31] !== te
...
function ke(e) {
  (e.preventDefault(), l.dispatchMessage(`open-in-browser`, { url: Te }));
}
function Ae(e) {
  let t = (0, Y.c)(72),
    {
  ...
  t[2] !== y || t[3] !== n
    ...
    : (D = t[4]);
  let { data: O, isPending: te } = ee(D),
    A = E || te,
    j = (0, X.useId)(),
    M = (0, X.useId)(),
    N = (0, X.useId)(),
    re = (0, X.useId)(),
    P = a.isPending || s.isPending,
    F = l.isPending,
    I = P || F,
  ...
  t[20] === G
    ...
    : ((K = () => {
      ...
      (t[21] = K));
  let q = K,
    J = r.rechargeThreshold ?? Se,
    ue = r.rechargeTarget ?? Ce,
    fe;
  t[22] !== J || t[23] !== ue
    ? ((fe = { isEnabled: !0, rechargeThreshold: J, rechargeTarget: ue }),
      (t[22] = J),
      (t[23] = ue),
      (t[24] = fe))
    : (fe = t[24]);
  ...
  t[33] !== s
    ? ((Z = async (e) => {
        let { value: t } = e,
          n = he({ draftState: t, serverState: r, isSaving: I });
        if (n.isSaveEnabled)
          switch (n.saveIntent) {
            case `disable`:
            case `none`:
            ...
            case `enable`:
              try {
                if ((V(), k((await a.mutateAsync(lt(t))).immediate_top_up_status))) {
                  U({ draftState: t });
                  return;
                }
                (z(`enable`), d(!1));
            ...
            case `update`:
              try {
                if ((V(), k((await s.mutateAsync(lt(t))).immediate_top_up_status))) {
                  U({ draftState: t });
                  return;
                }
                (z(`update`), d(!1));
  ...
  let me;
  t[35] !== fe || t[36] !== Z
    ? ((me = { defaultValues: fe, validators: pe, onSubmit: Z }),
      (t[35] = fe),
      (t[36] = Z),
      (t[37] = me))
    : (me = t[37]);
  ...
  t[67] !== N
    ? ((be = (e) => {
        let { values: t, submissionAttempts: a } = e,
          o = he({ draftState: t, serverState: r, isSaving: I }),
          s = Qe({
            intl: _,
            creditBalance: i?.balance,
            rechargeThreshold: t.rechargeThreshold,
        ...
        return (0, $.jsx)(C, {
          ...
          contentProps: { "aria-describedby": M, onOpenAutoFocus: Me },
                ...
                (0, $.jsxs)(b, {
                  ...
                  children: [
                    (0, $.jsx)(Q.Field, {
                      ...
                      children: (e) => {
                        let t = a > 0 || e.state.meta.isBlurred ? et(e.state.meta.errors) : null;
                        return (0, $.jsx)(Ke, {
                          id: N,
                          label: (0, $.jsx)(p, {
                          ...
                          footerContent: it({ fieldError: t, fieldName: `threshold`, intl: _ }),
                          footerTone: `error`,
                    ...
                    (0, $.jsx)(Q.Field, {
                      name: `rechargeTarget`,
                      children: (e) => {
                        let n = a > 0 || e.state.meta.isBlurred ? tt(e.state.meta.errors) : null,
                          r = Ze({
                            intl: _,
                            rechargeThreshold: t.rechargeThreshold,
                        ...
                        return (0, $.jsx)(Ke, {
                          ...
                          footerContent:
                            n == null
                              ...
                              : it({ fieldError: n, fieldName: `target`, intl: _ }),
                    ...
                    L
                      ? (0, $.jsx)(Ve, {
                          amount: ie,
                          isManagePaymentPending: G.isPending,
                          onManagePaymentClick: q,
                        })
                      : null,
                  ],
                }),
...
function Ye({ intl: e, creditDetails: t, pricingInfo: n }) {
  ...
  return t == null
    ...
    : t.unlimited
      ...
      : n == null
        ? r
        : (P({ intl: e, creditQuantity: Xe(t.balance), pricingInfo: n }) ?? r);
}
function Xe(e) {
  return Math.floor(Number(e ?? 0));
}
function Ze({ intl: e, rechargeThreshold: t, rechargeTarget: n, pricingInfo: r }) {
...
function ut(e) {
  ...
  let { data: l } = ne(c),
    ...
    m;
  t[2] !== l || t[3] !== d
    ? ((m = { billingCurrency: l, enabled: d }), (t[2] = l), (t[3] = d), (t[4] = m))
    : (m = t[4]);
  let { data: h } = j(m);
  ...
  t[8] !== r || t[9] !== a.pricePlan
    ? ((x = () => {
        U(r, a.pricePlan, `usage_settings_plan_row`);
      }),
      (t[8] = r),
      (t[9] = a.pricePlan),
      (t[10] = x))
  ...
  return (
    t[13] !== b || t[14] !== x || t[15] !== S
      ? ((C = (0, $.jsx)(g, { color: b, size: `toolbar`, onClick: x, children: S })),
        (t[13] = b),
        (t[14] = x),
        (t[15] = S),
        (t[16] = C))
      ...
      : ((c = (0, $.jsxs)(J, {
          children: [
            ...
            (0, $.jsx)(J.Content, {
              ...
              children: (0, $.jsx)(`p`, { children: (0, $.jsx)(ft, { platform: s }) }),
            }),
          ],
        })),
        (t[7] = s),
...
function xt(e) {
  ...
  if (
    ...
    bb0: {
      let e = oe(n),
        t = Ot(e, null),
        r = u ? jt(f) : At({ rateLimitStatus: n, coreUsageLimitRows: t }),
              ...
              children: [
                ...
                (0, $.jsxs)(J.Content, {
                  children: [
                    (0, $.jsxs)(q, {
                      children: [
                        r == null ? null : (0, $.jsx)(Et, { usageLimit: r }, r.key),
                        s
                          ? (0, $.jsx)(ue, {
                              children: (0, $.jsx)(p, {
          ...
          a.length > 0
            ? (0, $.jsxs)(J, {
                children: [
                  ...
                  (0, $.jsx)(J.Content, { children: (0, $.jsx)(q, { children: a.map(St) }) }),
                ],
              })
            : null));
    }
...
function Dt(e) {
  ...
  if (t[0] !== n.bucket.resetsAt) {
    let e = ae(n.bucket.resetsAt ?? null);
  ...
  let o = a,
    ...
    c;
  t[4] === s ? (c = t[5]) : ((c = ie(s)), (t[4] = s), (t[5] = c));
  let l = c,
    u;
  t[6] === n ? (u = t[7]) : ((u = kt(n)), (t[6] = n), (t[7] = u));
  let d;
  t[8] === l ? (d = t[9]) : ((d = (0, $.jsx)(Rt, { remainingPercent: l })), (t[8] = l), (t[9] = d));
  let f;
  return (
    t[10] !== o || t[11] !== u || t[12] !== d
      ? ((f = (0, $.jsx)(K, { className: `gap-6`, label: u, description: o, control: d })),
        (t[10] = o),
        (t[11] = u),
        (t[12] = d),
        (t[13] = f))
...
function Pt(e) {
  return e.kind === `spend_limit` && e.target.source === yt && e.target.source_id === bt;
}
function Ft(e) {
...
function Bt() {
  ...
  let { data: _, isLoading: y, isError: b, refetch: x } = A(h),
    S;
  e[4] === l ? (S = e[5]) : ((S = { enabled: l }), (e[4] = l), (e[5] = S));
  let { data: C, isLoading: w, isError: T, refetch: D } = O(S),
    k = C?.effective_monthly_limit?.limit != null && C.effective_monthly_limit.limit >= 0,
    ee = l && k,
    ne;
  e[6] === ee ? (ne = e[7]) : ((ne = { enabled: ee }), (e[6] = ee), (e[7] = ne));
  let { data: j, isLoading: N, isError: re, refetch: P } = M(ne),
    F = te(),
    { enableAutoTopUpMutation: I, updateAutoTopUpMutation: ie, disableAutoTopUpMutation: ae } = E(),
    L;
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = (0, $.jsx)(le, { slug: `usage` })), (e[8] = L))
    : (L = e[8]);
  let oe = L;
  if (!r && !i) return null;
  let se = !r && i,
    R = c ? (w && C == null) || (k && N && j == null) : (t && y && _ == null) || (d && u == null),
    ce = c ? (T && C == null) || (k && re && j == null) : (t && b && _ == null) || (f && u == null);
  if (se || ce || R) {
    let n,
      r = null;
    if (se) {
    ...
    return (
      e[23] !== r || e[24] !== n
        ? ((i = (0, $.jsx)(Ut, { title: oe, rowLabel: n, rowControl: r })),
          (e[23] = r),
          (e[24] = n),
          (e[25] = i))
        : (i = e[25]),
      ...
      e[34] !== F.mutateAsync
        ? ((o = (0, $.jsx)(G, {
            ...
            children: (0, $.jsx)(xt, {
              ...
              canRequestEnterpriseMonthlyUsageLimit: k,
              workspaceMonthlyUsage: i,
              workspaceAdminRequests: a,
              isWorkspaceAdminRequestsLoading: N,
              isSavingWorkspaceAdminRequest: F.isPending,
              saveWorkspaceAdminRequest: F.mutateAsync,
            }),
          })),
          (e[28] = k),
          (e[29] = N),
  ...
  e[36] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (z = e[36]);
  let B;
  e[37] === a ? (B = e[38]) : ((B = (0, $.jsx)(ut, { plan: a })), (e[37] = a), (e[38] = B));
  let V;
  e[39] !== _ || e[40] !== t || e[41] !== ae || e[42] !== I || e[43] !== u?.credits || e[44] !== ie
    ? ((V =
        t && _ != null
          ? (0, $.jsx)(De, {
              serverState: _,
  ...
  e[46] === H
    ? (U = e[47])
    : ((U = (0, $.jsx)(xt, { rateLimitStatus: H })), (e[46] = H), (e[47] = U));
  let W;
  e[48] === a ? (W = e[49]) : ((W = (0, $.jsx)(dt, { plan: a })), (e[48] = a), (e[49] = W));
  let K;
  return (
...
function Ht(e) {
  (e.preventDefault(), l.dispatchMessage(`open-in-browser`, { url: z }));
}
function Ut(e) {
  let t = (0, Y.c)(6),
  ...
  t[0] !== i || t[1] !== r
    ? ((a = (0, $.jsx)(J, {
        children: (0, $.jsx)(J.Content, {
          children: (0, $.jsx)(q, {
            children: (0, $.jsx)(K, { className: `gap-6`, label: r, control: i }),
          }),
        }),
      })),
      (t[0] = i),
  ...
  return (
    t[3] !== a || t[4] !== n
      ? ((o = (0, $.jsx)(G, { title: n, children: a })), (t[3] = a), (t[4] = n), (t[5] = o))
      : (o = t[5]),
    o
  );
}
