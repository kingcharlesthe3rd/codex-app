...
import { gt as fe, vt as B } from "./app-initial~app-main~automations-page.js";
import {
  h as V,
  p as pe,
...
import { Mt as W, jt as G } from "./app-initial~app-main~onboarding-page.js";
import {
  n as me,
  t as he,
...
function Tt(e) {
  ...
  let x;
  t[5] !== i || t[6] !== g || t[7] !== l
    ? ((x = Gt({ intl: l, creditDetails: i, pricingInfo: g })),
      (t[5] = i),
      (t[6] = g),
      (t[7] = l),
      (t[8] = x))
  ...
  t[21] !== O || t[22] !== S
    ...
    : (k = t[23]);
  let A;
  t[24] !== d || t[25] !== c || t[26] !== r.isEnabled || t[27] !== u
    ? ((A = (e) => {
        let t = be(u, `personal`);
        (Oe(c, {
          audience: `personal`,
  ...
  t[30] === A
    ? (M = t[31])
    : ((M = (0, Y.jsx)(C, { color: `outline`, size: `toolbar`, onClick: A, children: j })),
      (t[30] = A),
      (t[31] = M));
  let N;
  t[32] !== k || t[33] !== M
    ...
    : (N = t[34]);
  let P;
  t[35] !== i || t[36] !== s || t[37] !== a || t[38] !== _ || t[39] !== r || t[40] !== o
    ? ((P = _
        ? (0, Y.jsx)(Ot, {
            open: _,
            serverState: r,
...
function Dt(e) {
  I({ event: e, href: pn, initiator: `open_in_browser_bridge` });
}
function Ot(e) {
  let t = (0, sn.c)(74),
    {
  ...
  let { data: g, isPending: _ } = Ee(h),
    y;
  t[2] !== g || t[3] !== r
    ? ((y = { billingCurrency: g, enabled: r }), (t[2] = g), (t[3] = r), (t[4] = y))
    : (y = t[4]);
  let { data: b, isPending: S } = we(y),
    E = _ || S,
    D = (0, cn.useId)(),
    O = (0, cn.useId)(),
    k = (0, cn.useId)(),
    ...
    N = c.isPending,
    P = M || N,
    [F, ee] = (0, cn.useState)(null),
    [I, ne] = (0, cn.useState)(!1),
    L;
  t[5] !== d || t[6] !== u
    ? ((L = (e) => {
        u.get(V).danger(rn(e, d), ln);
      }),
      (t[5] = d),
      (t[6] = u),
      (t[7] = L))
  ...
  t[20] === B
    ...
    : ((pe = () => {
      ...
      (t[21] = pe));
  let H = pe,
    U = i.rechargeThreshold ?? un,
    W = i.rechargeTarget ?? dn,
    G;
  t[22] !== U || t[23] !== W
    ? ((G = { isEnabled: !0, rechargeThreshold: U, rechargeTarget: W }),
      (t[22] = U),
      (t[23] = W),
      (t[24] = G))
    : (G = t[24]);
  ...
  t[33] !== s
    ? ((he = async (e) => {
        let { value: t } = e,
          n = _t({ draftState: t, serverState: i, isSaving: P });
        if (n.isSaveEnabled)
          switch (n.saveIntent) {
            case `disable`:
            case `none`:
            ...
            case `enable`:
              try {
                if ((oe(), ve((await o.mutateAsync(on(t))).immediate_top_up_status))) {
                  ce({ draftState: t });
                  return;
                }
                (ie(`enable`), l(!1));
            ...
            case `update`:
              try {
                if ((oe(), ve((await s.mutateAsync(on(t))).immediate_top_up_status))) {
                  ce({ draftState: t });
                  return;
                }
                (ie(`update`), l(!1));
  ...
  let ge;
  t[35] !== G || t[36] !== he
    ? ((ge = { defaultValues: G, validators: me, onSubmit: he }),
      (t[35] = G),
      (t[36] = he),
      (t[37] = ge))
    : (ge = t[37]);
  ...
  let xe = ye,
    Ce;
  t[41] !== c || t[42] !== l || t[43] !== i.isEnabled || t[44] !== z || t[45] !== ie
    ? ((Ce = async () => {
        if (i.isEnabled)
          try {
            (await c.mutateAsync(), ie(`disable`), l(!1));
          } catch {
            z(`disable`);
          }
      }),
  ...
  t[69] !== k
    ? ((De = (e) => {
        let { values: t, submissionAttempts: n } = e,
          o = _t({ draftState: t, serverState: i, isSaving: P }),
          s = Jt({
            intl: d,
            creditBalance: a?.balance,
            rechargeThreshold: t.rechargeThreshold,
                ...
                (0, Y.jsxs)(T, {
                  ...
                  children: [
                    (0, Y.jsx)(_e.Field, {
                      ...
                      children: (e) => {
                        let t = n > 0 || e.state.meta.isBlurred ? Xt(e.state.meta.errors) : null;
                        return (0, Y.jsx)(Ht, {
                          id: k,
                          label: (0, Y.jsx)(R, {
                    ...
                    (0, Y.jsx)(_e.Field, {
                      name: `rechargeTarget`,
                      children: (e) => {
                        let r = n > 0 || e.state.meta.isBlurred ? Zt(e.state.meta.errors) : null,
                          i = qt({
                            intl: d,
                            rechargeThreshold: t.rechargeThreshold,
                        ...
                        return (0, Y.jsx)(Ht, {
                          ...
                          footerContent:
                            r == null
                              ...
                              : en({ fieldError: r, fieldName: `target`, intl: d }),
  ...
  let ke;
  return (
    t[71] !== _e.Subscribe || t[72] !== De
      ? ((ke = (0, Y.jsx)(_e.Subscribe, { selector: jt, children: De })),
        (t[71] = _e.Subscribe),
        (t[72] = De),
        (t[73] = ke))
      : (ke = t[73]),
...
async function Ft() {
  return await ue.safeGet(`/payments/customer_portal`);
}
function It(e) {
  let t = (0, sn.c)(4),
...
function Ut(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Y.jsx)(j, { className: `icon-xxs text-token-description-foreground` })), (t[2] = i))
    : (i = t[2]);
  let a;
  return (
    t[3] === r
...
function Gt({ intl: e, creditDetails: t, pricingInfo: n }) {
  ...
  return t == null
    ...
    : t.unlimited
      ...
      : n == null
        ? r
        : (rt({ intl: e, creditQuantity: Kt(t.balance), pricingInfo: n }) ?? r);
}
function Kt(e) {
...
function gn(e) {
  ...
  t[16] !== E || t[17] !== D || t[18] !== O
    ? ((k = (0, X.jsx)(C, { color: E, size: `toolbar`, onClick: D, children: O })),
      (t[16] = E),
      (t[17] = D),
      (t[18] = O),
      (t[19] = k))
    : (k = t[19]);
  let A;
  t[20] !== S || t[21] !== T || t[22] !== k || t[23] !== w
    ? ((A = (0, X.jsx)(S, { className: `gap-6`, label: w, description: T, control: k })),
      (t[20] = S),
      (t[21] = T),
      (t[22] = k),
      (t[23] = w),
  ...
  let j;
  t[25] !== x || t[26] !== A
    ? ((j = (0, X.jsx)(x, { children: A })), (t[25] = x), (t[26] = A), (t[27] = j))
    : (j = t[27]);
  let M;
  t[28] !== j || t[29] !== b.Content
    ? ((M = (0, X.jsx)(b.Content, { children: j })), (t[28] = j), (t[29] = b.Content), (t[30] = M))
    : (M = t[30]);
  let N;
  return (
...
function _n(e) {
  let t = (0, xn.c)(9),
    { plan: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = Le(n)), (t[0] = n), (t[1] = r));
  let i;
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (o = t[4]);
  let s;
  t[5] === a ? (s = t[6]) : ((s = He(a)), (t[5] = a), (t[6] = s));
  let c;
  return (
    t[7] === s
      ? (c = t[8])
...
function wn() {
  return ue.safeGet(`/wham/usage/daily-token-usage-breakdown`);
}
function Tn(e) {
  let t = (0, Dn.c)(2),
    { enabled: n } = e,
...
function En() {
  return ue.safeGet(`/wham/usage/credit-usage-events`);
}
var Dn,
  On,
  kn,
...
function jn(e) {
  ...
  return (
    t[27] !== b || t[28] !== x
      ? ((S = (0, Z.jsxs)(Z.Fragment, { children: [b, x] })), (t[27] = b), (t[28] = x), (t[29] = S))
      : (S = t[29]),
    S
  );
}
...
function Nn(e) {
  ...
  if (a && n == null) {
    ...
    t[2] === s
      ? (n = t[3])
      : ((n = (0, Z.jsx)(C, { color: `secondary`, size: `toolbar`, onClick: s, children: e })),
        (t[2] = s),
        (t[3] = n));
    let r;
    return (
...
function Pn(e) {
  ...
  return (
    t[2] === i
      ? (a = t[3])
      : ((a = (0, Z.jsx)(ce, { value: i, month: `short`, day: `numeric`, year: `numeric` })),
        (t[2] = i),
        (t[3] = a)),
    a
  );
    ...
    t[0] !== n || t[1] !== r
      ? ((i =
          n === `credits`
            ...
            : (0, Z.jsx)(ae, { value: r / 100, style: `percent`, maximumFractionDigits: 0 })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function Hn(e) {
                            ...
                            control:
                              c == null
                                ...
                                : (0, Q.jsx)(C, {
                                    ...
                                    onClick: (e) => {
                                      I({ event: e, href: c, initiator: `open_in_browser_bridge` });
                                    },
                                    children: (0, Q.jsx)(R, {
  ...
  return (
    t[12] !== _ || t[13] !== v
      ? ((b = (0, Q.jsxs)(Q.Fragment, { children: [_, v] })), (t[12] = _), (t[13] = v), (t[14] = b))
      : (b = t[14]),
    b
  );
}
...
function Kn(e) {
  let t = (0, cr.c)(6),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(_, { "aria-hidden": !0, className: `icon-sm text-token-text-tertiary` })),
      (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
...
function qn(e) {
  let t = (0, cr.c)(28),
    { pendingRequest: r, isLoading: i, isSaving: a, saveWorkspaceAdminRequest: o } = e,
    s = f(n),
    c = de(),
    [l, u] = (0, lr.useState)(!1),
    [d, p] = (0, lr.useState)(r?.justification ?? ``),
    m;
  ...
  t[12] !== i || t[13] !== _ || t[14] !== v || t[15] !== y
    ...
    : (b = t[16]);
  let x;
  t[17] !== h || t[18] !== c || t[19] !== l || t[20] !== a || t[21] !== d || t[22] !== r
    ? ((x = l
        ? (0, Q.jsx)(K, {
...
function Jn(e) {
  ...
  if (
    ...
    if (t[14] !== n.resetAt) {
      let e = Qe(n.resetAt);
      ((i = e == null ? null : Ye(e)), (t[14] = n.resetAt), (t[15] = i));
    } else i = t[15];
    let a = i,
      p;
...
function Yn(e) {
  ...
  if (t[0] !== n.bucket.resetsAt) {
    let e = Qe(n.bucket.resetsAt ?? null);
    ((r = e == null ? null : Ye(e)), (t[0] = n.bucket.resetsAt), (t[1] = r));
  } else r = t[1];
  let i = r,
    a;
  t[2] === i
  ...
  let o = a,
    ...
    c;
  t[4] === s ? (c = t[5]) : ((c = We(s)), (t[4] = s), (t[5] = c));
  let l = c,
    u;
...
function Xn(e, t) {
  let n = t == null ? (e.find((e) => e.limitName == null) ?? null) : $e(e, t);
...
function gr() {
  let e = (0, br.c)(63),
    ...
    a;
  e[0] === i ? (a = e[1]) : ((a = k(i)), (e[0] = i), (e[1] = a));
  let o = a,
    s = o && n && !r,
    { data: c, isLoading: l, isError: u, refetch: d } = m(se),
    f;
  e[2] === t ? (f = e[3]) : ((f = { enabled: t }), (e[2] = t), (e[3] = f));
  let { data: p, isLoading: h, isError: g, refetch: _ } = ye(f),
    v;
  e[4] === s ? (v = e[5]) : ((v = { enabled: s }), (e[4] = s), (e[5] = v));
  let { data: y, isLoading: b, isError: x, refetch: S } = _e(v),
    w =
  ...
  let { data: O, refetch: A } = ge(E),
    j = O?.kind === `openai_native`,
    M = s && w && j,
    N;
  e[8] === M ? (N = e[9]) : ((N = { enabled: M }), (e[8] = M), (e[9] = N));
  let { data: P, isLoading: F, isError: ee, refetch: te } = Ne(N),
    I = xe(),
    { enableAutoTopUpMutation: ne, updateAutoTopUpMutation: L, disableAutoTopUpMutation: z } = Ce(),
    re;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = (0, $.jsx)(lt, { slug: `usage` })), (e[10] = re))
    : (re = e[10]);
  let ie = re;
  if (!n && !r) return null;
  let ae = !n && r,
    oe = o
      ? (b && y == null) || (w && j && F && P == null)
      : (t && h && p == null) || (l && c == null),
    ce = o
      ? (x && y == null) || (w && j && ee && P == null)
      : (t && g && p == null) || (u && c == null),
    le;
  e[11] !== t ||
  e[12] !== w ||
  ...
  if (ae || ce || oe) {
    ...
    if (ae) {
      ...
      (e[24] === ue
        ? (a = e[25])
        : ((a = (0, $.jsx)(C, { color: `secondary`, size: `toolbar`, onClick: ue, children: i })),
          (e[24] = ue),
          (e[25] = a)),
        (n = a));
    } else {
  ...
  e[41] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (de = e[41]);
  let B;
  e[42] === i ? (B = e[43]) : ((B = (0, $.jsx)(gn, { plan: i })), (e[42] = i), (e[43] = B));
  let V;
  e[44] !== p || e[45] !== t || e[46] !== z || e[47] !== ne || e[48] !== c?.credits || e[49] !== L
    ? ((V =
        t && p != null
          ? (0, $.jsx)(Tt, {
              serverState: p,
              creditDetails: c?.credits ?? null,
              enableAutoTopUpMutation: ne,
  ...
  e[51] === pe
    ? (H = e[52])
    : ((H = (0, $.jsx)(Hn, { rateLimitStatus: pe })), (e[51] = pe), (e[52] = H));
  let U;
  e[53] === t
    ? (U = e[54])
    : ((U = (0, $.jsx)(D, { browser: !0, children: (0, $.jsx)(jn, { showCreditHistory: t }) })),
      (e[53] = t),
      (e[54] = U));
  let W;
  e[55] === i ? (W = e[56]) : ((W = (0, $.jsx)(_n, { plan: i })), (e[55] = i), (e[56] = W));
  let G;
  return (
    e[57] !== V || e[58] !== H || e[59] !== U || e[60] !== W || e[61] !== B
      ? ((G = (0, $.jsxs)(fe, {
          title: ie,
          subtitle: de,
          subtitleClassName: `whitespace-normal`,
...
function vr(e) {
  I({ event: e, href: Be, initiator: `open_in_browser_bridge` });
}
function yr(e) {
  let t = (0, br.c)(6),
  ...
  return (
    t[3] !== a || t[4] !== n
      ? ((o = (0, $.jsx)(fe, { title: n, children: a })), (t[3] = a), (t[4] = n), (t[5] = o))
      : (o = t[5]),
    o
  );
}
