...
import { ln as s } from "./thread-context-inputs.js";
import { _ as c, f as l, u, v as d } from "./vscode-api.js";
import "./isEqual.js";
import { Ra as f } from "./src.js";
import "./react-dom.js";
import { i as p, l as m, n as h, s as g, t as _ } from "./lib-1.js";
...
import { n as C } from "./skus.js";
import { t as w } from "./with-window.js";
import "./modal-controller-state.js";
import { a as T, d as E, i as D, l as O, n as k, r as A } from "./dialog-layout.js";
...
import "./checkbox.js";
import "./minus.js";
import { t as L } from "./format-currency.js";
import { n as oe, r as se, t as R } from "./rate-limit-rows.js";
import "./links.js";
import { t as ce } from "./use-codex-pricing-url.js";
import { S as z, T as le, b as B, o as ue, p as de } from "./rate-limit-status.js";
import { a as fe, c as pe, n as V, o as me, t as he, u as H } from "./plan-management-state.js";
import { n as U, o as W } from "./use-rate-limit.js";
import { t as ge } from "./use-usage-settings-access.js";
import { t as G } from "./banner.js";
import { i as _e } from "./settings-shared.js";
...
import { t as ve } from "./settings-empty-state.js";
import { t as ye } from "./useForm.js";
import { t as be } from "./plan-pricing.js";
var X = r(),
  Z = e(t(), 1);
function Q(e) {
  return e == null ? `` : e.trim();
}
function xe({ rechargeThreshold: e, rechargeTarget: t }) {
  let n = Ee(e),
    r = Ee(t),
    i = De(n),
    a = Oe({ parsedThreshold: n, parsedTarget: r });
  return { rechargeThresholdError: i, rechargeTargetError: a, isValid: i == null && a == null };
}
function Se({ draftState: e, serverState: t, isSaving: n }) {
  let r = xe({ rechargeThreshold: e.rechargeThreshold, rechargeTarget: e.rechargeTarget }),
    i = we({ draftState: e, serverState: t }),
    a = Ce({ draftState: e, serverState: t, validation: r });
  return { validation: r, hasChanges: i, saveIntent: a, isSaveEnabled: i && a !== `none` && !n };
}
function Ce({ draftState: e, serverState: t, validation: n }) {
  return e.isEnabled
    ? n.isValid
      ? t.isEnabled
...
function we({ draftState: e, serverState: t }) {
...
function Te({ rechargeThreshold: e, rechargeTarget: t }) {
  let n = Q(e),
    r = Q(t);
...
function Oe({ parsedThreshold: e, parsedTarget: t }) {
  switch (t.kind) {
    case `missing`:
      return `missing`;
    case `invalid`:
...
var $ = n(),
  ...
  Ae = `125`,
  je = `250`,
  Me = `${f}/settings/usage?credit_modal=true`,
  Ne = `https://help.openai.com/en/articles/20001106-codex-rate-card`,
  Pe = `min-w-[88px] justify-center`;
function Fe(e) {
  let t = (0, X.c)(43),
    {
      serverState: n,
  ...
  let b;
  t[5] !== r || t[6] !== f || t[7] !== s
    ? ((b = rt({ intl: s, creditDetails: r, pricingInfo: f })),
      (t[5] = r),
      (t[6] = f),
      (t[7] = s),
      (t[8] = b))
  ...
  t[28] === O
    ? (A = t[29])
    : ((A = (0, $.jsx)(y, { color: `outline`, size: `toolbar`, onClick: O, children: k })),
      (t[28] = O),
      (t[29] = A));
  let j;
  t[30] !== D || t[31] !== A
  ...
  return (
    t[40] !== j || t[41] !== M
      ? ((N = (0, $.jsxs)($.Fragment, { children: [j, M] })), (t[40] = j), (t[41] = M), (t[42] = N))
      : (N = t[42]),
    N
  );
}
...
function Le(e) {
  (e.preventDefault(), l.dispatchMessage(`open-in-browser`, { url: Ne }));
}
function Re(e) {
  let t = (0, X.c)(72),
    {
  ...
  let { data: _, isPending: v } = ee(h),
    b;
  t[2] !== _ || t[3] !== n
    ? ((b = { billingCurrency: _, enabled: n }), (t[2] = _), (t[3] = n), (t[4] = b))
    : (b = t[4]);
  let { data: S, isPending: C } = re(b),
    w = v || C,
    j = (0, Z.useId)(),
    M = (0, Z.useId)(),
    N = (0, Z.useId)(),
    P = (0, Z.useId)(),
    te = s.isPending || l.isPending,
    ne = u.isPending,
    I = te || ne,
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((fe = [`usage-settings`, `auto-top-up`, `manage-payment`]), (t[16] = fe))
    : (fe = t[16]);
  let pe;
  t[17] !== p || t[18] !== f
    ? ((pe = {
  ...
  t[20] === V
    ...
    : ((me = () => {
      ...
      (t[21] = me));
  let he = me,
    H = r.rechargeThreshold ?? Ae,
    U = r.rechargeTarget ?? je,
    W;
  t[22] !== H || t[23] !== U
    ? ((W = { isEnabled: !0, rechargeThreshold: H, rechargeTarget: U }),
      (t[22] = H),
      (t[23] = U),
      (t[24] = W))
    : (W = t[24]);
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ge = { onChange: Ue, onSubmit: He }), (t[25] = ge))
    : (ge = t[25]);
  let G;
  t[26] !== s ||
  t[27] !== de ||
  ...
  t[33] !== l
    ? ((G = async (e) => {
        let { value: t } = e,
          n = Se({ draftState: t, serverState: r, isSaving: I });
        if (n.isSaveEnabled)
          switch (n.saveIntent) {
            case `disable`:
            case `none`:
            ...
            case `enable`:
              try {
                if ((B(), F((await s.mutateAsync(_t(t))).immediate_top_up_status))) {
                  de({ draftState: t });
                  return;
                }
                (z(`enable`), d(!1));
            ...
            case `update`:
              try {
                if ((B(), F((await l.mutateAsync(_t(t))).immediate_top_up_status))) {
                  de({ draftState: t });
                  return;
                }
                (z(`update`), d(!1));
  ...
  let _e;
  t[35] !== W || t[36] !== G
    ? ((_e = { defaultValues: W, validators: ge, onSubmit: G }),
      (t[35] = W),
      (t[36] = G),
      (t[37] = _e))
    : (_e = t[37]);
  ...
  let J = q,
    Y;
  t[41] !== u || t[42] !== d || t[43] !== r.isEnabled || t[44] !== R || t[45] !== z
    ? ((Y = async () => {
        if (r.isEnabled)
          try {
            (await u.mutateAsync(), z(`disable`), d(!1));
          } catch {
            R(`disable`);
          }
      }),
  ...
  t[67] !== N
    ? ((be = (e) => {
        let { values: t, submissionAttempts: i } = e,
          o = Se({ draftState: t, serverState: r, isSaving: I }),
          s = ot({
            intl: p,
            creditBalance: a?.balance,
            rechargeThreshold: t.rechargeThreshold,
          ...
          c =
            !L && s != null && (o.saveIntent === `enable` || o.saveIntent === `update`)
        ...
        return (0, $.jsx)(O, {
          ...
          contentProps: { "aria-describedby": M, onOpenAutoFocus: Be },
                ...
                (0, $.jsxs)(T, {
                  ...
                  children: [
                    (0, $.jsx)(K.Field, {
                      ...
                      children: (e) => {
                        let t = i > 0 || e.state.meta.isBlurred ? ct(e.state.meta.errors) : null;
                        return (0, $.jsx)(et, {
                          id: N,
                          label: (0, $.jsx)(g, {
                          ...
                          footerContent: ft({ fieldError: t, fieldName: `threshold`, intl: p }),
                          footerTone: `error`,
                    ...
                    (0, $.jsx)(K.Field, {
                      name: `rechargeTarget`,
                      children: (e) => {
                        let n = i > 0 || e.state.meta.isBlurred ? lt(e.state.meta.errors) : null,
                          r = at({
                            intl: p,
                            rechargeThreshold: t.rechargeThreshold,
                        ...
                        return (0, $.jsx)(et, {
                          ...
                          footerContent:
                            n == null
                              ...
                              : ft({ fieldError: n, fieldName: `target`, intl: p }),
  ...
  let Q;
  return (
    t[69] !== K.Subscribe || t[70] !== be
      ? ((Q = (0, $.jsx)(K.Subscribe, { selector: Ve, children: be })),
        (t[69] = K.Subscribe),
        (t[70] = be),
        (t[71] = Q))
      : (Q = t[71]),
          ...
          content:
            n === `enable`
              ? (0, $.jsx)(g, {
                  ...
                  values: { amount: r, creditCount: i, strong: Je },
                })
              : (0, $.jsx)(g, {
...
function rt({ intl: e, creditDetails: t, pricingInfo: n }) {
  ...
  return t == null
    ...
    : t.unlimited
      ...
      : n == null
        ? r
        : (se({ intl: e, creditQuantity: it(t.balance), pricingInfo: n }) ?? r);
}
function it(e) {
  return Math.floor(Number(e ?? 0));
}
function at({ intl: e, rechargeThreshold: t, rechargeTarget: n, pricingInfo: r }) {
  if (r == null) return null;
  let i = Te({ rechargeThreshold: t, rechargeTarget: n });
  return i == null
    ? null
    : {
        creditCount: i,
...
function st({ rechargeThreshold: e, rechargeTarget: t }) {
  let n = xe({ rechargeThreshold: e, rechargeTarget: t });
...
function lt(e) {
  if (e == null) return null;
  for (let t of e) if (dt(t)) return t;
  return null;
}
function ut(e) {
...
function vt(e) {
  ...
  t[7] === b
    ...
    : ((D =
      ...
      (t[7] = b),
      (t[8] = D));
  let O = u.cta === `upgrade` ? `primary` : `outline`,
    k;
  ...
  t[16] !== O || t[17] !== k || t[18] !== A
    ? ((M = (0, $.jsx)(y, { color: O, size: `toolbar`, onClick: k, children: A })),
      (t[16] = O),
      (t[17] = k),
      (t[18] = A),
      (t[19] = M))
    : (M = t[19]);
  let N;
  t[20] !== T || t[21] !== D || t[22] !== M || t[23] !== E
    ? ((N = (0, $.jsx)(T, { className: `gap-6`, label: E, description: D, control: M })),
      (t[20] = T),
      (t[21] = D),
      (t[22] = M),
      (t[23] = E),
  ...
  let P;
  t[25] !== w || t[26] !== N
    ? ((P = (0, $.jsx)(w, { children: N })), (t[25] = w), (t[26] = N), (t[27] = P))
    : (P = t[27]);
  let F;
  t[28] !== P || t[29] !== C.Content
    ? ((F = (0, $.jsx)(C.Content, { children: P })), (t[28] = P), (t[29] = C.Content), (t[30] = F))
    : (F = t[30]);
  let ne;
  return (
    t[31] !== x || t[32] !== F || t[33] !== S
      ? ((ne = (0, $.jsxs)(x, { children: [S, F] })),
        (t[31] = x),
        (t[32] = F),
        (t[33] = S),
        (t[34] = ne))
...
function yt(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (o = t[4]);
  let s;
  t[5] === a ? (s = t[6]) : ((s = me(a)), (t[5] = a), (t[6] = s));
  let c;
  return (
    t[7] === s
      ? (c = t[8])
      : ((c = (0, $.jsxs)(Y, {
          children: [
            ...
            (0, $.jsx)(Y.Content, {
              ...
              children: (0, $.jsx)(`p`, { children: (0, $.jsx)(bt, { platform: s }) }),
            }),
          ],
        })),
        (t[7] = s),
...
function Ht(e) {
  let t = (0, X.c)(15),
    {
      ...
      isSavingWorkspaceAdminRequest: u,
      saveWorkspaceAdminRequest: d,
    } = e,
    f = r === void 0 ? !1 : r,
    p = i === void 0 ? !1 : i,
    m = o === void 0 ? null : o,
  ...
  if (
    ...
    bb0: {
      let e = W(n),
        t = Yt(e, null),
        r = f ? Qt(m) : Zt({ rateLimitStatus: n, coreUsageLimitRows: t }),
        i = r == null ? t : t.filter(Gt),
        o = Yt(e, Lt),
        s = f && p,
        c = a?.kind === `custom` ? a.request_url : null,
        u = f && r == null && i.length === 0;
      if (r == null && i.length === 0 && o.length === 0 && !u && !s) {
        S = null;
        break bb0;
      }
      ((b =
        r != null || i.length > 0 || u || s
          ? (0, $.jsxs)(Y, {
              children: [
                (0, $.jsx)(Y.Header, {
                  title: (0, $.jsx)(g, {
                            ...
                            control:
                              c == null
                                ...
                                : (0, $.jsx)(y, {
                                    ...
                                    onClick: () => {
                                      l.dispatchMessage(`open-in-browser`, { url: c });
                                    },
                                    children: (0, $.jsx)(g, {
          ...
          o.length > 0
            ? (0, $.jsxs)(Y, {
                children: [
                  ...
                  (0, $.jsx)(Y.Content, { children: (0, $.jsx)(J, { children: o.map(Ut) }) }),
                ],
              })
            : null));
    }
    ((t[0] = p),
      ...
      (t[10] = x),
      (t[11] = S));
  } else ((b = t[9]), (x = t[10]), (S = t[11]));
  if (S !== Symbol.for(`react.early_return_sentinel`)) return S;
  let C;
  return (
    t[12] !== b || t[13] !== x
      ? ((C = (0, $.jsxs)($.Fragment, { children: [b, x] })), (t[12] = b), (t[13] = x), (t[14] = C))
      : (C = t[14]),
    C
  );
}
...
function Kt(e) {
  ...
  t[12] !== r || t[13] !== b || t[14] !== S || t[15] !== C
    ...
    : (w = t[16]);
  let T;
  t[17] !== _ || t[18] !== l || t[19] !== u || t[20] !== a || t[21] !== f || t[22] !== n
    ? ((T = u
        ? (0, $.jsx)(J, {
...
function qt(e) {
  ...
  if (
    ...
    if (t[14] !== n.resetAt) {
      let e = le(n.resetAt);
      ((i = e == null ? null : B(e)), (t[14] = n.resetAt), (t[15] = i));
    } else i = t[15];
    let a = i,
      p;
...
function Jt(e) {
  ...
  if (t[0] !== n.bucket.resetsAt) {
    let e = le(n.bucket.resetsAt ?? null);
    ((r = e == null ? null : B(e)), (t[0] = n.bucket.resetsAt), (t[1] = r));
  } else r = t[1];
  let i = r,
    a;
  t[2] === i
...
function Yt(e, t) {
  let n = t == null ? (e.find((e) => e.limitName == null) ?? null) : U(e, t);
  return n == null ? [] : R({ entry: n, keyPrefix: t ?? `core` });
}
function Xt(e) {
...
function Qt(e) {
  ...
  return t == null
    ...
    : {
        ...
        resetAt: null,
        usedCredits: String(t.used),
        limitCredits: String(t.limit),
      };
}
function $t(e) {
...
function cn() {
  let e = (0, X.c)(63),
    ...
    o;
  e[0] === i ? (o = e[1]) : ((o = C(i)), (e[0] = i), (e[1] = o));
  let c = o,
    l = c && n && !r,
    { data: u, isLoading: d, isError: f, refetch: p } = a(s),
    m;
  e[2] === t ? (m = e[3]) : ((m = { enabled: t }), (e[2] = t), (e[3] = m));
  let { data: h, isLoading: _, isError: v, refetch: b } = M(m),
    x;
  e[4] === l ? (x = e[5]) : ((x = { enabled: l }), (e[4] = l), (e[5] = x));
  let { data: S, isLoading: T, isError: E, refetch: D } = I(x),
    O =
      S?.effective_monthly_limit?.limit != null &&
      S.effective_monthly_limit.limit >= 0 &&
      S.effective_monthly_limit.enforcement_mode === `HARD_CAP`,
    k = l && O,
    A;
  e[6] === k ? (A = e[7]) : ((A = { enabled: k }), (e[6] = k), (e[7] = A));
  let { data: j, refetch: ee } = ne(A),
    F = j?.kind === `openai_native`,
    te = l && O && F,
    re;
  e[8] === te ? (re = e[9]) : ((re = { enabled: te }), (e[8] = te), (e[9] = re));
  let { data: ae, isLoading: L, isError: oe, refetch: se } = P(re),
    R = N(),
    {
      enableAutoTopUpMutation: ce,
      updateAutoTopUpMutation: z,
      disableAutoTopUpMutation: le,
    } = ie(),
    B;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (0, $.jsx)(_e, { slug: `usage` })), (e[10] = B))
    : (B = e[10]);
  let ue = B;
  if (!n && !r) return null;
  let de = !n && r,
    fe = c
      ? (T && S == null) || (O && F && L && ae == null)
      : (t && _ && h == null) || (d && u == null),
    pe = c
      ? (E && S == null) || (O && F && oe && ae == null)
      : (t && v && h == null) || (f && u == null),
    V;
  e[11] !== t ||
  e[12] !== O ||
  ...
  if (de || pe || fe) {
    ...
    if (de) {
      ...
      (e[24] === me
        ? (a = e[25])
        : ((a = (0, $.jsx)(y, { color: `secondary`, size: `toolbar`, onClick: me, children: i })),
          (e[24] = me),
          (e[25] = a)),
        (n = a));
    } else {
    ...
    return (
      e[27] !== n || e[28] !== t
        ? ((r = (0, $.jsx)(dn, { title: ue, rowLabel: t, rowControl: n })),
          (e[27] = n),
          (e[28] = t),
          (e[29] = r))
        : (r = e[29]),
      ...
      e[39] !== j
        ? ((o = (0, $.jsx)(K, {
            ...
            children: (0, $.jsx)(Ht, {
              ...
              workspaceRequestPolicy: j,
              workspaceMonthlyUsage: i,
              workspaceAdminRequests: a,
              isWorkspaceAdminRequestsLoading: L,
  ...
  e[41] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (he = e[41]);
  let H;
  e[42] === i ? (H = e[43]) : ((H = (0, $.jsx)(vt, { plan: i })), (e[42] = i), (e[43] = H));
  let U;
  e[44] !== h || e[45] !== t || e[46] !== le || e[47] !== ce || e[48] !== u?.credits || e[49] !== z
    ? ((U =
        t && h != null
          ? (0, $.jsx)(Fe, {
              serverState: h,
  ...
  e[51] === W
    ? (G = e[52])
    : ((G = (0, $.jsx)(Ht, { rateLimitStatus: W })), (e[51] = W), (e[52] = G));
  let q;
  e[53] === t
    ? (q = e[54])
    : ((q = (0, $.jsx)(w, { browser: !0, children: (0, $.jsx)(jt, { showCreditHistory: t }) })),
      (e[53] = t),
      (e[54] = q));
  let J;
  e[55] === i ? (J = e[56]) : ((J = (0, $.jsx)(yt, { plan: i })), (e[55] = i), (e[56] = J));
  let Y;
  return (
    e[57] !== U || e[58] !== G || e[59] !== q || e[60] !== J || e[61] !== H
      ? ((Y = (0, $.jsxs)(K, {
          title: ue,
          subtitle: he,
          subtitleClassName: `whitespace-normal`,
