...
import { f as s, g as c } from "./vscode-api.js";
import "./isEqual.js";
import { ta as l } from "./src-4.js";
import { On as u } from "./app-server-manager-signals.js";
import "./react-dom.js";
...
var $ = n(),
  ...
  Ce = `125`,
  we = `250`,
  Te = `${l}/settings/usage?credit_modal=true`,
...
function Ae(e) {
  (e.preventDefault(), s.dispatchMessage(`open-in-browser`, { url: Ee }));
}
function je(e) {
  let t = (0, Y.c)(72),
    {
    ...
    ? ((me = async (e) => {
        ...
        if (n.isSaveEnabled)
          switch (n.saveIntent) {
            ...
            case `update`:
              try {
                if ((V(), k((await l.mutateAsync(ut(t))).immediate_top_up_status))) {
                  U({ draftState: t });
                  return;
                }
                (z(`update`), p(!1));
...
function Vt() {
  ...
  if (!n && !r) return null;
  let L = !n && r,
    R = s ? (w && C == null) || (O && M && ne == null) : (t && y && _ == null) || (d && l == null),
    ce = s
  ...
  if (L || ce || R) {
    ...
    if (L) {
      ...
      (e[20] === a
        ? (c = e[21])
        : ((c = (0, $.jsx)(m, { color: `secondary`, size: `toolbar`, onClick: a, children: o })),
          (e[20] = a),
          (e[21] = c)),
        (r = c));
    } else {
  ...
  let V;
  e[39] !== _ || e[40] !== t || e[41] !== oe || e[42] !== F || e[43] !== l?.credits || e[44] !== ae
    ? ((V =
        t && _ != null
          ? (0, $.jsx)(Oe, {
              serverState: _,
...
function Ut(e) {
  (e.preventDefault(), s.dispatchMessage(`open-in-browser`, { url: V }));
}
function Wt(e) {
  let t = (0, Y.c)(6),
