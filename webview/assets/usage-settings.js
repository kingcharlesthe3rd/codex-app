...
import { Hn as _e, Un as ve, _n as ye, hn as be } from "./app-initial~app-main~automations-page.js";
import {
  G as xe,
  K as Se,
  S as Ce,
...
import { n as ft, t as pt } from "./esm-2.js";
...
function Tt(e) {
  ...
  let { data: h } = Ge(m),
    g;
  t[1] === h ? (g = t[2]) : ((g = { billingCurrency: h, enabled: !0 }), (t[1] = h), (t[2] = g));
  let { data: _ } = Ve(g),
    [v, y] = (0, cn.useState)(!1),
    x;
  ...
  let C;
  t[5] !== i || t[6] !== _ || t[7] !== l
    ? ((C = Gt({ intl: l, creditDetails: i, pricingInfo: _ })),
      (t[5] = i),
      (t[6] = _),
      (t[7] = l),
      (t[8] = C))
  ...
  t[9] === C
    ? (w = t[10])
    : ((w = (0, Y.jsx)(`div`, { className: `text-sm text-token-text-primary`, children: C })),
      (t[9] = C),
      (t[10] = w));
  let T, E;
  ...
  t[21] !== k || t[22] !== w
    ...
    : (A = t[23]);
  let j;
  t[24] !== p || t[25] !== c || t[26] !== n.isEnabled || t[27] !== f
    ? ((j = (e) => {
        let t = Pe(f, `personal`);
        (Ue(c, {
          audience: `personal`,
  ...
  t[30] === j
    ? (N = t[31])
    : ((N = (0, Y.jsx)(F, { color: `outline`, size: `toolbar`, onClick: j, children: M })),
      (t[30] = j),
      (t[31] = N));
  let P;
  t[32] !== A || t[33] !== N
    ...
    : (P = t[34]);
  let I;
  t[35] !== i || t[36] !== s || t[37] !== a || t[38] !== v || t[39] !== n || t[40] !== o
    ? ((I = v
        ? (0, Y.jsx)(Ot, {
            open: v,
            serverState: n,
  ...
  return (
    t[42] !== P || t[43] !== I
      ? ((L = (0, Y.jsxs)(Y.Fragment, { children: [P, I] })), (t[42] = P), (t[43] = I), (t[44] = L))
      : (L = t[44]),
    L
  );
}
...
function Dt(e) {
  k({ event: e, href: pn, initiator: `open_in_browser_bridge` });
}
function Ot(e) {
  let t = (0, sn.c)(74),
    {
    ...
    g = r(),
    _;
  t[0] === n ? (_ = t[1]) : ((_ = { enabled: n }), (t[0] = n), (t[1] = _));
  let { data: v, isPending: y } = Ge(_),
    x;
  t[2] !== v || t[3] !== n
    ? ((x = { billingCurrency: v, enabled: n }), (t[2] = v), (t[3] = n), (t[4] = x))
    : (x = t[4]);
  let { data: S, isPending: w } = Ve(x),
    E = y || w,
    D = (0, cn.useId)(),
    O = (0, cn.useId)(),
    k = (0, cn.useId)(),
    ...
    M = l.isPending,
    N = j || M,
    [P, I] = (0, cn.useState)(null),
    [L, te] = (0, cn.useState)(!1),
    R;
  t[5] !== h || t[6] !== p
    ? ((R = (e) => {
        p.get(oe).danger(rn(e, h), ln);
      }),
      (t[5] = h),
      (t[6] = p),
      (t[7] = R))
  ...
  t[20] === U
    ...
    : ((W = () => {
      ...
      (t[21] = W));
  let G = W,
    de = a.rechargeThreshold ?? un,
    fe = a.rechargeTarget ?? dn,
    pe;
  t[22] !== de || t[23] !== fe
    ? ((pe = { isEnabled: !0, rechargeThreshold: de, rechargeTarget: fe }),
      (t[22] = de),
      (t[23] = fe),
      (t[24] = pe))
    : (pe = t[24]);
  ...
  t[33] !== c
    ? ((he = async (e) => {
        let { value: t } = e,
          n = _t({ draftState: t, serverState: a, isSaving: N });
        if (n.isSaveEnabled)
          switch (n.saveIntent) {
            case `disable`:
            case `none`:
            ...
            case `enable`:
              try {
                if ((B(), Ye((await s.mutateAsync(on(t))).immediate_top_up_status))) {
                  ue({ draftState: t });
                  return;
                }
                (ie(`enable`), f(!1));
            ...
            case `update`:
              try {
                if ((B(), Ye((await c.mutateAsync(on(t))).immediate_top_up_status))) {
                  ue({ draftState: t });
                  return;
                }
                (ie(`update`), f(!1));
  ...
  let ye = ve,
    be;
  t[41] !== l || t[42] !== f || t[43] !== a.isEnabled || t[44] !== z || t[45] !== ie
    ? ((be = async () => {
        if (a.isEnabled)
          try {
            (await l.mutateAsync(), ie(`disable`), f(!1));
          } catch {
            z(`disable`);
          }
      }),
  ...
  t[69] !== k
    ? ((Se = (e) => {
        let { values: t, submissionAttempts: r } = e,
          s = _t({ draftState: t, serverState: a, isSaving: N }),
          c = Jt({
            intl: h,
            creditBalance: o?.balance,
            rechargeThreshold: t.rechargeThreshold,
          ...
          l =
            !L && c != null && (s.saveIntent === `enable` || s.saveIntent === `update`)
              ? { saveIntent: s.saveIntent, amount: c.amount, creditCount: c.creditCount }
              : null;
        return (0, Y.jsx)(T, {
          open: n,
          size: `default`,
          contentClassName: `w-[536px] max-w-[calc(100vw-2rem)]`,
          contentProps: { "aria-describedby": O, onOpenAutoFocus: At },
                ...
                (0, Y.jsxs)(ce, {
                  ...
                  children: [
                    (0, Y.jsx)(_e.Field, {
                      ...
                      children: (e) => {
                        let t = r > 0 || e.state.meta.isBlurred ? Xt(e.state.meta.errors) : null;
                        return (0, Y.jsx)(Ht, {
                          id: k,
                          label: (0, Y.jsx)(d, {
                          ...
                          footerContent: en({ fieldError: t, fieldName: `threshold`, intl: h }),
                          footerTone: `error`,
                    ...
                    (0, Y.jsx)(_e.Field, {
                      name: `rechargeTarget`,
                      children: (e) => {
                        let n = r > 0 || e.state.meta.isBlurred ? Zt(e.state.meta.errors) : null,
                          i = qt({
                            intl: h,
                            rechargeThreshold: t.rechargeThreshold,
                        ...
                        return (0, Y.jsx)(Ht, {
                          ...
                          footerContent:
                            n == null
                              ...
                              : en({ fieldError: n, fieldName: `target`, intl: h }),
                  ...
                  children: (0, Y.jsxs)(C, {
                    children: [
                      ...
                      (0, Y.jsx)(F, {
                        ...
                        className: mn,
                        loading: j,
                        disabled: !s.isSaveEnabled,
                        children: a.isEnabled
                          ? (0, Y.jsx)(d, {
...
function Pt(e) {
  se({ href: e.url, initiator: `open_in_browser_bridge` });
}
async function Ft() {
...
function Ut(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Y.jsx)(ne, { className: `icon-xxs text-token-description-foreground` })),
      (t[2] = i))
    : (i = t[2]);
  let a;
  return (
...
function Gt({ intl: e, creditDetails: t, pricingInfo: n }) {
  ...
  return t == null
    ...
    : t.unlimited
      ...
      : n == null
        ? r
        : (Fe({ intl: e, creditQuantity: Kt(t.balance), pricingInfo: n }) ?? r);
}
function Kt(e) {
...
var sn,
  ...
  hn = e(() => {
    ((sn = M()),
      ...
      (un = `125`),
      (dn = `250`),
      (fn = `${E}/settings/usage?credit_modal=true`),
...
function gn(e) {
  ...
  let o = Re(a),
    ...
    l = c != null,
    f;
  t[1] === l ? (f = t[2]) : ((f = { enabled: l }), (t[1] = l), (t[2] = f));
  let { data: p } = Ge(f),
    m = c != null,
    h;
  t[3] !== p || t[4] !== m
    ? ((h = { billingCurrency: p, enabled: m }), (t[3] = p), (t[4] = m), (t[5] = h))
    : (h = t[5]);
  let { data: g } = ot(h);
  ...
  t[16] !== E || t[17] !== D || t[18] !== O
    ? ((k = (0, X.jsx)(F, { color: E, size: `toolbar`, onClick: D, children: O })),
      (t[16] = E),
      (t[17] = D),
      (t[18] = O),
      (t[19] = k))
...
function _n(e) {
  let t = (0, xn.c)(9),
    { plan: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = et(n)), (t[0] = n), (t[1] = r));
  let i;
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (o = t[4]);
  let s;
  t[5] === a ? (s = t[6]) : ((s = je(a)), (t[5] = a), (t[6] = s));
  let c;
  return (
    t[7] === s
      ? (c = t[8])
...
function bn(e, t) {
  k({ event: e, href: t, initiator: `open_in_browser_bridge` });
}
var xn,
  X,
  Sn = e(() => {
...
function wn() {
  return w.safeGet(`/wham/usage/daily-token-usage-breakdown`);
}
function Tn(e) {
  let t = (0, Dn.c)(2),
    { enabled: n } = e,
...
function En() {
  return w.safeGet(`/wham/usage/credit-usage-events`);
}
var Dn,
  On,
  kn,
...
function jn(e) {
  ...
  let l = c,
    ...
    f = Math.min(o, u - 1),
    p;
  t[4] !== a.data?.data || t[5] !== f
    ? ((p = a.data?.data.slice(f * Rn, (f + 1) * Rn)),
      (t[4] = a.data?.data),
      (t[5] = f),
      (t[6] = p))
    : (p = t[6]);
  ...
  t[12] === r.data?.units
    ...
    : ((b = (e) =>
      ...
      (t[13] = b));
  let x;
  t[14] !== r.isError || t[15] !== r.isLoading || t[16] !== g || t[17] !== y || t[18] !== b
    ? ((x = (0, Z.jsxs)(q, {
        children: [
          h,
          (0, Z.jsx)(q.Content, {
    ...
    : (x = t[19]);
  let S;
  t[20] !== l.length || t[21] !== u || t[22] !== a || t[23] !== f || t[24] !== n || t[25] !== m
    ? ((S = n
        ? (0, Z.jsxs)(q, {
            children: [
              (0, Z.jsx)(q.Header, {
...
function Mn(e, t) {
  return (0, Z.jsx)(
    ...
    {
      label: (0, Z.jsx)(Pn, { date: e.date }),
      description: (0, Z.jsx)(d, { ...Bn[e.product_surface] }),
...
function Nn(e) {
  ...
  if (a && n == null) {
    ...
    t[2] === s
      ? (n = t[3])
      : ((n = (0, Z.jsx)(F, { color: `secondary`, size: `toolbar`, onClick: s, children: e })),
        (t[2] = s),
        (t[3] = n));
    let r;
    return (
      t[4] !== i || t[5] !== n
        ? ((r = (0, Z.jsx)(W, { label: i, control: n })), (t[4] = i), (t[5] = n), (t[6] = r))
        : (r = t[6]),
      r
    );
  }
  if (n == null || n.length === 0) {
    ...
    return (
      t[7] === r
        ? (e = t[8])
        : ((e = (0, Z.jsx)(W, { label: r, control: null })), (t[7] = r), (t[8] = e)),
      e
    );
  }
  let l;
...
function Pn(e) {
  ...
  return (
    t[2] === i
      ? (a = t[3])
      : ((a = (0, Z.jsx)(S, { value: i, month: `short`, day: `numeric`, year: `numeric` })),
        (t[2] = i),
        (t[3] = a)),
    a
  );
    ...
    t[0] !== n || t[1] !== r
      ? ((i =
          n === `credits`
            ...
            : (0, Z.jsx)(L, { value: r / 100, style: `percent`, maximumFractionDigits: 0 })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function Hn(e) {
  ...
  if (
    ...
    bb0: {
      let e = Ze(n),
        t = Xn(e, null),
        r = f ? $n(m, n) : Qn({ rateLimitStatus: n, coreUsageLimitRows: t }),
          ...
          ? (0, Q.jsxs)(q, {
              children: [
                ...
                (0, Q.jsxs)(q.Content, {
                  children: [
                    l
                      ? (0, Q.jsx)(Kn, { currentMonthUsage: m?.current_month_usage ?? null })
                      : null,
                    r != null || i.length > 0
                      ? (0, Q.jsxs)(K, {
                          children: [
                            ...
                            control:
                              c == null
                                ...
                                : (0, Q.jsx)(F, {
                                    ...
                                    onClick: (e) => {
                                      k({ event: e, href: c, initiator: `open_in_browser_bridge` });
                                    },
                                    children: (0, Q.jsx)(d, {
          ...
          o.length > 0
            ? (0, Q.jsxs)(q, {
                children: [
                  ...
                  (0, Q.jsx)(q.Content, { children: (0, Q.jsx)(K, { children: o.map(Un) }) }),
                ],
              })
            : null));
    }
    ((t[0] = p),
      ...
      (t[10] = y),
      (t[11] = b));
  } else ((v = t[9]), (y = t[10]), (b = t[11]));
  if (b !== Symbol.for(`react.early_return_sentinel`)) return b;
  let x;
  return (
    t[12] !== v || t[13] !== y
      ? ((x = (0, Q.jsxs)(Q.Fragment, { children: [v, y] })), (t[12] = v), (t[13] = y), (t[14] = x))
      : (x = t[14]),
    x
  );
}
...
function Kn(e) {
  let t = (0, cr.c)(6),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(Ee, { "aria-hidden": !0, className: `icon-sm text-token-text-tertiary` })),
      (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
...
function qn(e) {
  ...
  t[12] !== r || t[13] !== _ || t[14] !== v || t[15] !== y
    ...
    : (x = t[16]);
  let S;
  t[17] !== h || t[18] !== s || t[19] !== c || t[20] !== i || t[21] !== f || t[22] !== n
    ? ((S = c
        ? (0, Q.jsx)(K, {
...
function Jn(e) {
  ...
  if (
    ...
    if (t[14] !== n.resetAt) {
      let e = G(n.resetAt);
      ((i = e == null ? null : U(e)), (t[14] = n.resetAt), (t[15] = i));
    } else i = t[15];
    let a = i,
      m;
    ...
    (t[20] === a
      ...
      (t[12] = f),
      (t[13] = p));
  } else ((o = t[7]), (s = t[8]), (c = t[9]), (l = t[10]), (u = t[11]), (f = t[12]), (p = t[13]));
  let m;
  t[23] !== s || t[24] !== c
    ? ((m = (0, Q.jsx)(`div`, { className: s, children: c })),
      (t[23] = s),
      (t[24] = c),
      (t[25] = m))
    : (m = t[25]);
  let h;
  t[26] !== l || t[27] !== u || t[28] !== m
    ? ((h = (0, Q.jsxs)(`div`, { className: l, children: [u, m] })),
      (t[26] = l),
      (t[27] = u),
      (t[28] = m),
      (t[29] = h))
  ...
  t[32] === _
    ? (v = t[33])
    : ((v = (0, Q.jsx)(`div`, { className: `bg-[#0285FF]`, style: { width: _ } })),
      (t[32] = _),
      (t[33] = v));
  let y;
    ...
    ? ((x =
        p != null || o != null
          ? (0, Q.jsxs)(`div`, {
              ...
              children: [
                (0, Q.jsx)(`div`, { className: `text-xs text-token-text-tertiary`, children: p }),
                (0, Q.jsx)(`div`, {
  ...
  let S;
  return (
    t[41] !== y || t[42] !== x || t[43] !== f || t[44] !== h
      ? ((S = (0, Q.jsxs)(`div`, { className: f, children: [h, y, x] })),
        (t[41] = y),
        (t[42] = x),
        (t[43] = f),
        (t[44] = h),
...
function Yn(e) {
  ...
  if (t[0] !== n.bucket.resetsAt) {
    let e = G(n.bucket.resetsAt ?? null);
    ((r = e == null ? null : U(e)), (t[0] = n.bucket.resetsAt), (t[1] = r));
  } else r = t[1];
  let i = r,
    a;
  t[2] === i
  ...
  let o = a,
    ...
    c;
  t[4] === s ? (c = t[5]) : ((c = he(s)), (t[4] = s), (t[5] = c));
  let l = c,
    u;
  t[6] === n ? (u = t[7]) : ((u = Zn(n)), (t[6] = n), (t[7] = u));
  let f;
  t[8] === l ? (f = t[9]) : ((f = (0, Q.jsx)(or, { remainingPercent: l })), (t[8] = l), (t[9] = f));
  let p;
  return (
    t[10] !== o || t[11] !== u || t[12] !== f
      ? ((p = (0, Q.jsx)(W, { className: `gap-6`, label: u, description: o, control: f })),
        (t[10] = o),
        (t[11] = u),
        (t[12] = f),
        (t[13] = p))
...
function Xn(e, t) {
  let n = t == null ? (e.find((e) => e.limitName == null) ?? null) : Je(e, t);
  return n == null ? [] : we({ entry: n, keyPrefix: t ?? `core` });
}
function Zn(e) {
...
function gr() {
  ...
  let s = a,
    c = s && n && !r,
    { data: l, isLoading: u, isError: f, refetch: p } = O(o),
    m;
  e[2] === t ? (m = e[3]) : ((m = { enabled: t }), (e[2] = t), (e[3] = m));
  let { data: h, isLoading: g, isError: _, refetch: v } = Xe(m),
    y;
  e[4] === c ? (y = e[5]) : ((y = { enabled: c }), (e[4] = c), (e[5] = y));
  let { data: b, isLoading: x, isError: S, refetch: C } = Ke(y),
    w =
      b?.effective_monthly_limit?.limit != null &&
      b.effective_monthly_limit.limit >= 0 &&
      b.effective_monthly_limit.enforcement_mode === `HARD_CAP`,
    T = c && w,
    E;
  e[6] === T ? (E = e[7]) : ((E = { enabled: T }), (e[6] = T), (e[7] = E));
  let { data: ee, refetch: D } = nt(E),
    k = ee?.kind === `openai_native`,
    A = c && w && k,
    j;
  e[8] === A ? (j = e[9]) : ((j = { enabled: A }), (e[8] = A), (e[9] = j));
  let { data: M, isLoading: N, isError: P, refetch: I } = $e(j),
    L = it(),
    { enableAutoTopUpMutation: te, updateAutoTopUpMutation: R, disableAutoTopUpMutation: z } = ke(),
    ne;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ne = (0, $.jsx)(xe, { slug: `usage` })), (e[10] = ne))
    : (ne = e[10]);
  let re = ne;
  if (!n && !r) return null;
  let ae = !n && r,
    oe = s
      ? (x && b == null) || (w && k && N && M == null)
      : (t && g && h == null) || (u && l == null),
    B = s
      ? (S && b == null) || (w && k && P && M == null)
      : (t && _ && h == null) || (f && l == null),
    se;
  e[11] !== t ||
  e[12] !== w ||
  ...
  if (ae || B || oe) {
    ...
    if (ae) {
      ...
      (e[24] === ce
        ? (a = e[25])
        : ((a = (0, $.jsx)(F, { color: `secondary`, size: `toolbar`, onClick: ce, children: i })),
          (e[24] = ce),
          (e[25] = a)),
        (n = a));
    } else {
    ...
    return (
      e[27] !== n || e[28] !== t
        ? ((r = (0, $.jsx)(yr, { title: re, rowLabel: t, rowControl: n })),
          (e[27] = n),
          (e[28] = t),
          (e[29] = r))
        : (r = e[29]),
      ...
      e[39] !== ee
        ? ((o = (0, $.jsx)(be, {
            ...
            children: (0, $.jsx)(Hn, {
              ...
              canRequestEnterpriseMonthlyUsageLimit: w,
              workspaceRequestPolicy: ee,
              workspaceMonthlyUsage: i,
              workspaceAdminRequests: a,
              isWorkspaceAdminRequestsLoading: N,
  ...
  e[41] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (le = e[41]);
  let V;
  e[42] === i ? (V = e[43]) : ((V = (0, $.jsx)(gn, { plan: i })), (e[42] = i), (e[43] = V));
  let H;
  e[44] !== h || e[45] !== t || e[46] !== z || e[47] !== te || e[48] !== l?.credits || e[49] !== R
    ? ((H =
        t && h != null
          ? (0, $.jsx)(Tt, {
              serverState: h,
              ...
              updateAutoTopUpMutation: R,
              disableAutoTopUpMutation: z,
            })
          : null),
      (e[44] = h),
      (e[45] = t),
  ...
  e[51] === U
    ? (W = e[52])
    : ((W = (0, $.jsx)(Hn, { rateLimitStatus: U })), (e[51] = U), (e[52] = W));
  let G;
  e[53] === t
    ? (G = e[54])
    : ((G = (0, $.jsx)(ue, { browser: !0, children: (0, $.jsx)(jn, { showCreditHistory: t }) })),
      (e[53] = t),
      (e[54] = G));
  let de;
  e[55] === i ? (de = e[56]) : ((de = (0, $.jsx)(_n, { plan: i })), (e[55] = i), (e[56] = de));
  let fe;
  return (
    e[57] !== H || e[58] !== W || e[59] !== G || e[60] !== de || e[61] !== V
      ? ((fe = (0, $.jsxs)(be, {
          title: re,
          subtitle: le,
          subtitleClassName: `whitespace-normal`,
...
function vr(e) {
  k({ event: e, href: ct, initiator: `open_in_browser_bridge` });
}
function yr(e) {
  let t = (0, br.c)(6),
  ...
  t[0] !== i || t[1] !== r
    ? ((a = (0, $.jsx)(q, {
        children: (0, $.jsx)(q.Content, {
          children: (0, $.jsx)(K, {
            children: (0, $.jsx)(W, { className: `gap-6`, label: r, control: i }),
          }),
        }),
      })),
      (t[0] = i),
  ...
  return (
    t[3] !== a || t[4] !== n
      ? ((o = (0, $.jsx)(be, { title: n, children: a })), (t[3] = a), (t[4] = n), (t[5] = o))
      : (o = t[5]),
    o
  );
}
