...
import { kn as s } from "./app-server-manager-signals.js";
import { f as c, g as l } from "./vscode-api.js";
import "./isEqual.js";
import { ua as u } from "./src-1.js";
import "./react-dom.js";
...
import "./x.js";
import { n as v, t as y } from "./skus.js";
import "./with-window.js";
import "./modal-controller-state.js";
import { a as b, d as x, i as S, l as C, n as w, r as T } from "./dialog-layout.js";
import { t as E } from "./upgrade-plan-dialog-launcher.js";
...
import "./checkbox.js";
import "./minus.js";
import { i as ie, n as N, r as P, t as F } from "./rate-limit-rows.js";
import "./links.js";
import { t as ae } from "./use-codex-pricing-url.js";
import { E as oe, O as I, j as se, n as L, o as R, y as ce } from "./use-rate-limit.js";
import { a as z, c as B, n as V, o as H, t as U, u as W } from "./plan-management-state.js";
...
import { t as fe } from "./useForm.js";
import { t as pe } from "./plan-pricing.js";
import { t as me } from "./use-usage-settings-access.js";
var Y = r(),
  X = e(t(), 1);
function Z(e) {
  return e == null ? `` : e.trim();
}
function Q({ rechargeThreshold: e, rechargeTarget: t }) {
  let n = ye(e),
    r = ye(t),
    i = be(n),
    a = xe({ parsedThreshold: n, parsedTarget: r });
...
function he({ draftState: e, serverState: t, isSaving: n }) {
  let r = Q({ rechargeThreshold: e.rechargeThreshold, rechargeTarget: e.rechargeTarget }),
    i = _e({ draftState: e, serverState: t }),
    a = ge({ draftState: e, serverState: t, validation: r });
  return { validation: r, hasChanges: i, saveIntent: a, isSaveEnabled: i && a !== `none` && !n };
}
function ge({ draftState: e, serverState: t, validation: n }) {
  return e.isEnabled
    ? n.isValid
      ? t.isEnabled
...
function _e({ draftState: e, serverState: t }) {
...
function ve({ rechargeThreshold: e, rechargeTarget: t }) {
  let n = Z(e),
    r = Z(t);
...
function xe({ parsedThreshold: e, parsedTarget: t }) {
  switch (t.kind) {
    case `missing`:
      return `missing`;
    case `invalid`:
...
var $ = n(),
  ...
  Ce = `125`,
  we = `250`,
  Te = `${u}/settings/usage?credit_modal=true`,
  Ee = `https://help.openai.com/en/articles/20001106-codex-rate-card`,
  De = `min-w-[88px] justify-center`;
function Oe(e) {
  let t = (0, Y.c)(43),
    {
      serverState: n,
  ...
  let { data: u } = ne(l),
    p;
  t[1] === u ? (p = t[2]) : ((p = { billingCurrency: u, enabled: !0 }), (t[1] = u), (t[2] = p));
  let { data: h } = te(p),
    [g, _] = (0, X.useState)(!1),
    v;
  ...
  let b;
  t[5] !== r || t[6] !== h || t[7] !== s
    ? ((b = Xe({ intl: s, creditDetails: r, pricingInfo: h })),
      (t[5] = r),
      (t[6] = h),
      (t[7] = s),
      (t[8] = b))
  ...
  t[28] === O
    ? (k = t[29])
    : ((k = (0, $.jsx)(m, { color: `outline`, onClick: O, children: ee })),
      (t[28] = O),
      (t[29] = k));
  let A;
  t[30] !== D || t[31] !== k
    ...
    : (A = t[32]);
  let j;
  t[33] !== r || t[34] !== o || t[35] !== i || t[36] !== g || t[37] !== n || t[38] !== a
    ? ((j = g
        ? (0, $.jsx)(je, {
            open: g,
            serverState: n,
...
function Ae(e) {
  (e.preventDefault(), c.dispatchMessage(`open-in-browser`, { url: Ee }));
}
function je(e) {
  let t = (0, Y.c)(72),
    {
  ...
  let { data: y, isPending: E } = ne(v),
    D;
  t[2] !== y || t[3] !== n
    ? ((D = { billingCurrency: y, enabled: n }), (t[2] = y), (t[3] = n), (t[4] = D))
    : (D = t[4]);
  let { data: O, isPending: ee } = te(D),
    A = E || ee,
    j = (0, X.useId)(),
    M = (0, X.useId)(),
    re = (0, X.useId)(),
    ie = (0, X.useId)(),
    N = s.isPending || c.isPending,
    P = u.isPending,
    F = N || P,
    [ae, oe] = (0, X.useState)(null),
    [I, se] = (0, X.useState)(!1),
    L;
  t[5] !== g || t[6] !== h
    ? ((L = (e) => {
        h.get(_).danger(ct(e, g), Se);
      }),
      (t[5] = g),
      (t[6] = h),
      (t[7] = L))
  ...
  t[20] === K
    ...
    : ((le = () => {
      ...
      (t[21] = le));
  let ue = le,
    q = r.rechargeThreshold ?? Ce,
    J = r.rechargeTarget ?? we,
    de;
  t[22] !== q || t[23] !== J
  ...
  t[25] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = { onChange: Ie, onSubmit: Fe }), (t[25] = pe))
    : (pe = t[25]);
  let me;
  t[26] !== s ||
  t[27] !== U ||
  ...
  t[33] !== c
    ? ((me = async (e) => {
        let { value: t } = e,
          n = he({ draftState: t, serverState: r, isSaving: F });
        if (n.isSaveEnabled)
          switch (n.saveIntent) {
            case `disable`:
            case `none`:
            ...
            case `enable`:
              try {
                if ((V(), k((await s.mutateAsync(ut(t))).immediate_top_up_status))) {
                  U({ draftState: t });
                  return;
                }
                (z(`enable`), p(!1));
            ...
            case `update`:
              try {
                if ((V(), k((await c.mutateAsync(ut(t))).immediate_top_up_status))) {
                  U({ draftState: t });
                  return;
                }
                (z(`update`), p(!1));
  ...
  let Z;
  t[35] !== de || t[36] !== me
    ? ((Z = { defaultValues: de, validators: pe, onSubmit: me }),
      (t[35] = de),
      (t[36] = me),
      (t[37] = Z))
    : (Z = t[37]);
  ...
  let _e = ge,
    ve;
  t[41] !== u || t[42] !== p || t[43] !== r.isEnabled || t[44] !== R || t[45] !== z
    ? ((ve = async () => {
        if (r.isEnabled)
          try {
            (await u.mutateAsync(), z(`disable`), p(!1));
          } catch {
            R(`disable`);
          }
      }),
  ...
  t[67] !== re
    ? ((be = (e) => {
        let { values: t, submissionAttempts: i } = e,
          o = he({ draftState: t, serverState: r, isSaving: F }),
          s = $e({
            intl: g,
            creditBalance: a?.balance,
            rechargeThreshold: t.rechargeThreshold,
          ...
          c =
            !I && s != null && (o.saveIntent === `enable` || o.saveIntent === `update`)
        ...
        return (0, $.jsx)(C, {
          ...
          contentProps: { "aria-describedby": M, onOpenAutoFocus: Ne },
                ...
                (0, $.jsxs)(b, {
                  ...
                  children: [
                    (0, $.jsx)(Q.Field, {
                      ...
                      children: (e) => {
                        let t = i > 0 || e.state.meta.isBlurred ? tt(e.state.meta.errors) : null;
                        return (0, $.jsx)(qe, {
                          id: re,
                          label: (0, $.jsx)(f, {
                          ...
                          footerContent: at({ fieldError: t, fieldName: `threshold`, intl: g }),
                          footerTone: `error`,
                    ...
                    (0, $.jsx)(Q.Field, {
                      name: `rechargeTarget`,
                      children: (e) => {
                        let n = i > 0 || e.state.meta.isBlurred ? nt(e.state.meta.errors) : null,
                          r = Qe({
                            intl: g,
                            rechargeThreshold: t.rechargeThreshold,
                        ...
                        return (0, $.jsx)(qe, {
                          ...
                          footerContent:
                            n == null
                              ...
                              : at({ fieldError: n, fieldName: `target`, intl: g }),
  ...
  return (
    t[69] !== Q.Subscribe || t[70] !== be
      ? ((xe = (0, $.jsx)(Q.Subscribe, { selector: Pe, children: be })),
        (t[69] = Q.Subscribe),
        (t[70] = be),
        (t[71] = xe))
      : (xe = t[71]),
          ...
          content:
            n === `enable`
              ? (0, $.jsx)(f, {
                  ...
                  values: { amount: r, creditCount: i, strong: Ve },
                })
              : (0, $.jsx)(f, {
...
function qe(e) {
    ...
    ? ((y =
        l == null
          ...
          : (0, $.jsx)(`div`, {
              className: p(
                `text-sm`,
                h === `error` ? `text-token-error-foreground` : `text-token-text-secondary`,
              ),
              children: l,
            })),
      (t[14] = l),
  ...
  return (
    t[17] !== g || t[18] !== _ || t[19] !== v || t[20] !== y
      ? ((b = (0, $.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [g, _, v, y] })),
        (t[17] = g),
        (t[18] = _),
        (t[19] = v),
        (t[20] = y),
...
function Je(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(h, { className: `icon-xxs text-token-description-foreground` })), (t[2] = i))
    : (i = t[2]);
  let a;
  return (
    t[3] === r
...
function Xe({ intl: e, creditDetails: t, pricingInfo: n }) {
  ...
  return t == null
    ...
    : t.unlimited
      ...
      : n == null
        ? r
        : (P({ intl: e, creditQuantity: Ze(t.balance), pricingInfo: n }) ?? r);
}
function Ze(e) {
  return Math.floor(Number(e ?? 0));
}
function Qe({ intl: e, rechargeThreshold: t, rechargeTarget: n, pricingInfo: r }) {
  if (r == null) return null;
  let i = ve({ rechargeThreshold: t, rechargeTarget: n });
  return i == null
    ? null
    : {
        creditCount: i,
...
function et({ rechargeThreshold: e, rechargeTarget: t }) {
  let n = Q({ rechargeThreshold: e, rechargeTarget: t });
...
function nt(e) {
  if (e == null) return null;
  for (let t of e) if (it(t)) return t;
  return null;
}
function rt(e) {
...
function ut(e) {
  return { recharge_threshold: Z(e.rechargeThreshold), recharge_target: Z(e.rechargeTarget) };
}
function dt(e) {
  let t = (0, Y.c)(20),
    { plan: n } = e,
  ...
  let c = ae(s),
    ...
    p = u != null,
    h;
  t[1] === p ? (h = t[2]) : ((h = { enabled: p }), (t[1] = p), (t[2] = h));
  let { data: g } = ne(h),
    _ = u != null,
    v;
  t[3] !== g || t[4] !== _
    ? ((v = { billingCurrency: g, enabled: _ }), (t[3] = g), (t[4] = _), (t[5] = v))
    : (v = t[5]);
  let { data: y } = M(v);
  ...
  let b =
      y == null
        ...
        : pe({
            intl: a,
            amount: y.monthlyAmounts[u.pricePlan],
            currencyCode: y.currencyCode,
            minorUnitExponent: y.minorUnitExponent,
          }),
    x;
  ...
  return (
    t[16] !== T || t[17] !== C || t[18] !== w
      ? ((D = (0, $.jsx)(m, { color: C, size: `toolbar`, onClick: w, children: T })),
        (t[16] = T),
        (t[17] = C),
        (t[18] = w),
        (t[19] = D))
          ...
          children: (0, $.jsx)(q, {
            children: (0, $.jsx)(ue, {
              ...
              label: (0, $.jsxs)(`div`, {
                ...
                children: [mt(u.displayPlan), S],
              }),
              description: ht(u.pricePlan),
              control: D,
            }),
          }),
        }),
      ...
      : ((c = (0, $.jsxs)(J, {
          children: [
            ...
            (0, $.jsx)(J.Content, {
              ...
              children: (0, $.jsx)(`p`, { children: (0, $.jsx)(pt, { platform: s }) }),
            }),
          ],
        })),
        (t[7] = s),
...
function gt(e) {
  c.dispatchMessage(`open-in-browser`, { url: e });
}
var _t = `gpt-5.3-codex-spark`,
  vt = 300,
  yt = 30 * ce,
  bt = `account_user_spend_controls`,
  xt = `account_user.credit_limits`;
function St(e) {
  let t = (0, Y.c)(14),
    {
      rateLimitStatus: n,
  ...
  if (
    ...
    bb0: {
      let e = R(n),
        t = kt(e, null),
        r = u ? Mt(p) : jt({ rateLimitStatus: n, coreUsageLimitRows: t }),
        i = r == null ? t : t.filter(Tt),
        a = kt(e, _t),
        o = u && d,
              ...
              children: [
                ...
                (0, $.jsxs)(J.Content, {
                  children: [
                    (0, $.jsxs)(q, {
                      children: [
                        r == null ? null : (0, $.jsx)(Dt, { usageLimit: r }, r.key),
                        s
                          ? (0, $.jsx)(de, {
                              children: (0, $.jsx)(f, {
          ...
          a.length > 0
            ? (0, $.jsxs)(J, {
                children: [
                  ...
                  (0, $.jsx)(J.Content, { children: (0, $.jsx)(q, { children: a.map(Ct) }) }),
                ],
              })
            : null));
    }
...
function Ct(e) {
  return (0, $.jsx)(Ot, { rateLimitRow: e }, e.key);
}
function wt(e) {
  return (0, $.jsx)(Ot, { rateLimitRow: e }, e.key);
}
...
function Et(e) {
  let t = (0, Y.c)(28),
    { pendingRequest: n, isLoading: r, isSaving: a, saveWorkspaceAdminRequest: s } = e,
    c = i(o),
    l = d(),
    [u, p] = (0, X.useState)(!1),
    [h, g] = (0, X.useState)(n?.justification ?? ``),
    v;
  t[0] !== l || t[1] !== h || t[2] !== n || t[3] !== s || t[4] !== c
    ? ((v = () => {
        let e = h.trim();
        if (e.length === 0) {
          c.get(_).warning(
  ...
  t[12] !== r || t[13] !== x || t[14] !== S || t[15] !== C
    ...
    : (w = t[16]);
  let T;
  t[17] !== y || t[18] !== l || t[19] !== u || t[20] !== a || t[21] !== h || t[22] !== n
    ? ((T = u
        ? (0, $.jsx)(q, {
...
function Dt(e) {
  ...
  t[0] === n.usedPercent
    ? (i = t[1])
    : ((i = Bt(n.usedPercent)), (t[0] = n.usedPercent), (t[1] = i));
  let a = i,
    o,
    s,
    c,
  ...
  if (
    ...
    let e = Bt(n.remainingPercent),
      i;
    if (t[14] !== n.resetAt) {
      let e = se(n.resetAt);
      ((i = e == null ? null : oe(e)), (t[14] = n.resetAt), (t[15] = i));
    } else i = t[15];
    let a = i,
      d;
      ...
      ? ((d =
          n.usedCredits == null || n.limitCredits == null
            ...
            : r.formatMessage(
                ...
                { used: Rt(r, n.usedCredits), limit: Rt(r, n.limitCredits) },
              )),
        (t[16] = r),
        (t[17] = n.limitCredits),
        (t[18] = n.usedCredits),
    ...
    (t[20] === a
      ...
      (t[12] = p),
      (t[13] = m));
  } else ((o = t[7]), (s = t[8]), (c = t[9]), (l = t[10]), (u = t[11]), (p = t[12]), (m = t[13]));
  let h;
  t[23] !== s || t[24] !== c
    ? ((h = (0, $.jsx)(`div`, { className: s, children: c })),
      (t[23] = s),
      (t[24] = c),
      (t[25] = h))
    : (h = t[25]);
  let g;
  t[26] !== l || t[27] !== u || t[28] !== h
    ? ((g = (0, $.jsxs)(`div`, { className: l, children: [u, h] })),
      (t[26] = l),
      (t[27] = u),
      (t[28] = h),
      (t[29] = g))
    ...
    ? ((x =
        m != null || o != null
          ? (0, $.jsxs)(`div`, {
              ...
              children: [
                (0, $.jsx)(`div`, { className: `text-xs text-token-text-tertiary`, children: m }),
                (0, $.jsx)(`div`, {
...
function Ot(e) {
  ...
  if (t[0] !== n.bucket.resetsAt) {
    let e = se(n.bucket.resetsAt ?? null);
    ((r = e == null ? null : oe(e)), (t[0] = n.bucket.resetsAt), (t[1] = r));
  } else r = t[1];
  let i = r,
    a;
  t[2] === i
  ...
  let o = a,
    ...
    c;
  t[4] === s ? (c = t[5]) : ((c = I(s)), (t[4] = s), (t[5] = c));
  let l = c,
    u;
  t[6] === n ? (u = t[7]) : ((u = At(n)), (t[6] = n), (t[7] = u));
  let d;
  t[8] === l ? (d = t[9]) : ((d = (0, $.jsx)(zt, { remainingPercent: l })), (t[8] = l), (t[9] = d));
  let p;
  return (
    t[10] !== o || t[11] !== u || t[12] !== d
      ? ((p = (0, $.jsx)(ue, { className: `gap-6`, label: u, description: o, control: d })),
        (t[10] = o),
        (t[11] = u),
        (t[12] = d),
        (t[13] = p))
...
function kt(e, t) {
  let n = t == null ? (e.find((e) => e.limitName == null) ?? null) : L(e, t);
...
function jt({ rateLimitStatus: e, coreUsageLimitRows: t }) {
  ...
  let r = t.find(It) ?? null;
  if (r == null) return null;
  let i = r.bucket.usedPercent ?? 0;
  return {
    key: r.key,
    usedPercent: i,
    remainingPercent: I(i),
...
function Mt(e) {
  ...
  let r = t === 0 ? 100 : Bt((n / t) * 100);
  return {
    key: `workspace-monthly`,
    usedPercent: r,
    remainingPercent: Bt(100 - r),
    resetAt: null,
...
function Nt(e) {
  return e?.items.find((e) => e.status === `pending` && Pt(e) != null) ?? null;
}
function Pt(e) {
  return e.payloads.find(Ft) ?? null;
}
function Ft(e) {
  return e.kind === `spend_limit` && e.target.source === bt && e.target.source_id === xt;
}
function It(e) {
  return Lt(e.bucket.windowDurationMins ?? 0, yt);
}
function Lt(e, t) {
...
function zt(e) {
  let t = (0, Y.c)(16),
    ...
    r = d(),
    i;
  t[0] === n ? (i = t[1]) : ((i = Bt(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === r
    ? (o = t[3])
  ...
  return (
    t[13] !== c || t[14] !== u
      ? ((f = (0, $.jsxs)(`div`, { className: `flex items-center gap-2`, children: [c, u] })),
        (t[13] = c),
        (t[14] = u),
        (t[15] = f))
      : (f = t[15]),
...
function Vt() {
  let e = (0, Y.c)(55),
    ...
    o;
  e[0] === i ? (o = e[1]) : ((o = v(i)), (e[0] = i), (e[1] = o));
  let c = o,
    l = c && n && !r,
    { data: u, isLoading: d, isError: p, refetch: h } = a(s),
    g;
  e[2] === t ? (g = e[3]) : ((g = { enabled: t }), (e[2] = t), (e[3] = g));
  let { data: _, isLoading: y, isError: b, refetch: x } = j(g),
    S;
  e[4] === l ? (S = e[5]) : ((S = { enabled: l }), (e[4] = l), (e[5] = S));
  let { data: C, isLoading: w, isError: T, refetch: E } = ee(S),
    O = C?.effective_monthly_limit?.limit != null && C.effective_monthly_limit.limit >= 0,
    k = l && O,
    te;
  e[6] === k ? (te = e[7]) : ((te = { enabled: k }), (e[6] = k), (e[7] = te));
  let { data: ne, isLoading: M, isError: ie, refetch: N } = re(te),
    P = A(),
    { enableAutoTopUpMutation: F, updateAutoTopUpMutation: ae, disableAutoTopUpMutation: oe } = D(),
    I;
  e[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = (0, $.jsx)(K, { slug: `usage` })), (e[8] = I))
    : (I = e[8]);
  let se = I;
  if (!n && !r) return null;
  let L = !n && r,
    R = c ? (w && C == null) || (O && M && ne == null) : (t && y && _ == null) || (d && u == null),
    ce = c
      ? (T && C == null) || (O && ie && ne == null)
      : (t && b && _ == null) || (p && u == null);
  if (L || ce || R) {
    let n,
      r = null;
    if (L) {
      ...
      (e[20] === a
        ? (s = e[21])
        : ((s = (0, $.jsx)(m, { color: `secondary`, size: `toolbar`, onClick: a, children: o })),
          (e[20] = a),
          (e[21] = s)),
        (r = s));
    } else {
    ...
    return (
      e[23] !== r || e[24] !== n
        ? ((i = (0, $.jsx)(Wt, { title: se, rowLabel: n, rowControl: r })),
          (e[23] = r),
          (e[24] = n),
          (e[25] = i))
        : (i = e[25]),
      ...
      e[34] !== P.mutateAsync
        ? ((o = (0, $.jsx)(le, {
            ...
            children: (0, $.jsx)(St, {
              ...
              canRequestEnterpriseMonthlyUsageLimit: O,
              workspaceMonthlyUsage: i,
              workspaceAdminRequests: a,
              isWorkspaceAdminRequestsLoading: M,
  ...
  e[36] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (z = e[36]);
  let B;
  e[37] === i ? (B = e[38]) : ((B = (0, $.jsx)(dt, { plan: i })), (e[37] = i), (e[38] = B));
  let V;
  e[39] !== _ || e[40] !== t || e[41] !== oe || e[42] !== F || e[43] !== u?.credits || e[44] !== ae
    ? ((V =
        t && _ != null
          ? (0, $.jsx)(Oe, {
              serverState: _,
  ...
  e[46] === H
    ? (U = e[47])
    : ((U = (0, $.jsx)(St, { rateLimitStatus: H })), (e[46] = H), (e[47] = U));
  let W;
  e[48] === i ? (W = e[49]) : ((W = (0, $.jsx)(ft, { plan: i })), (e[48] = i), (e[49] = W));
  let G;
  return (
    e[50] !== U || e[51] !== W || e[52] !== B || e[53] !== V
      ? ((G = (0, $.jsxs)(le, {
          title: se,
          subtitle: z,
          subtitleClassName: `whitespace-normal`,
...
function Ut(e) {
  (e.preventDefault(), c.dispatchMessage(`open-in-browser`, { url: V }));
}
function Wt(e) {
  let t = (0, Y.c)(6),
  ...
  t[0] !== i || t[1] !== r
    ? ((a = (0, $.jsx)(J, {
        children: (0, $.jsx)(J.Content, {
          children: (0, $.jsx)(q, {
            children: (0, $.jsx)(ue, { className: `gap-6`, label: r, control: i }),
          }),
        }),
      })),
      (t[0] = i),
  ...
  return (
    t[3] !== a || t[4] !== n
      ? ((o = (0, $.jsx)(le, { title: n, children: a })), (t[3] = a), (t[4] = n), (t[5] = o))
      : (o = t[5]),
    o
  );
}
export { Vt as UsageSettings };
