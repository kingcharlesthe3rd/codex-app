...
import { lt as K, ut as _e } from "./app-initial~app-main~automations-page.js";
import {
  $ as ve,
  Ct as ye,
  Dt as be,
...
function Tt(e) {
  ...
  let { data: p } = Ze(d),
    m;
  t[1] === p ? (m = t[2]) : ((m = { billingCurrency: p, enabled: !0 }), (t[1] = p), (t[2] = m));
  let { data: _ } = et(m),
    [v, y] = (0, cn.useState)(!1),
    b;
  ...
  let S;
  t[5] !== r || t[6] !== _ || t[7] !== c
    ? ((S = Gt({ intl: c, creditDetails: r, pricingInfo: _ })),
      (t[5] = r),
      (t[6] = _),
      (t[7] = c),
      (t[8] = S))
  ...
  t[9] === S
    ? (C = t[10])
    : ((C = (0, Y.jsx)(`div`, { className: `text-sm text-token-text-primary`, children: S })),
      (t[9] = S),
      (t[10] = C));
  let w, T;
  ...
  t[30] === A
    ? (N = t[31])
    : ((N = (0, Y.jsx)(M, { color: `outline`, size: `toolbar`, onClick: A, children: j })),
      (t[30] = A),
      (t[31] = N));
  let P;
  t[32] !== k || t[33] !== N
    ...
    : (P = t[34]);
  let te;
  t[35] !== r || t[36] !== o || t[37] !== i || t[38] !== v || t[39] !== n || t[40] !== a
    ? ((te = v
        ? (0, Y.jsx)(Ot, {
            open: v,
            serverState: n,
  ...
  return (
    t[42] !== P || t[43] !== te
      ? ((F = (0, Y.jsxs)(Y.Fragment, { children: [P, te] })),
        (t[42] = P),
        (t[43] = te),
        (t[44] = F))
      : (F = t[44]),
...
function Dt(e) {
  L({ event: e, href: pn, initiator: `open_in_browser_bridge` });
}
function Ot(e) {
  let t = (0, sn.c)(74),
    {
  ...
  let { data: y, isPending: b } = Ze(v),
    x;
  t[2] !== y || t[3] !== n
    ? ((x = { billingCurrency: y, enabled: n }), (t[2] = y), (t[3] = n), (t[4] = x))
    : (x = t[4]);
  let { data: S, isPending: C } = et(x),
    w = b || C,
    T = (0, cn.useId)(),
    D = (0, cn.useId)(),
    O = (0, cn.useId)(),
    ...
    N = l.isPending,
    P = j || N,
    [F, ne] = (0, cn.useState)(null),
    [re, I] = (0, cn.useState)(!1),
    L;
  t[5] !== m || t[6] !== p
    ? ((L = (e) => {
        p.get(k).danger(rn(e, m), ln);
      }),
      (t[5] = m),
      (t[6] = p),
      (t[7] = L))
  ...
  let de = W,
    ...
    pe;
  t[22] !== fe || t[23] !== G
    ? ((pe = { isEnabled: !0, rechargeThreshold: fe, rechargeTarget: G }),
      (t[22] = fe),
      (t[23] = G),
      (t[24] = pe))
    : (pe = t[24]);
  ...
  t[33] !== c
    ? ((he = async (e) => {
        let { value: t } = e,
          n = _t({ draftState: t, serverState: r, isSaving: P });
        if (n.isSaveEnabled)
          switch (n.saveIntent) {
            case `disable`:
            case `none`:
            ...
            case `enable`:
              try {
                if ((le(), Ve((await s.mutateAsync(on(t))).immediate_top_up_status))) {
                  B({ draftState: t });
                  return;
                }
                (z(`enable`), d(!1));
            ...
            case `update`:
              try {
                if ((le(), Ve((await c.mutateAsync(on(t))).immediate_top_up_status))) {
                  B({ draftState: t });
                  return;
                }
                (z(`update`), d(!1));
  ...
  t[69] !== O
    ? ((xe = (e) => {
        let { values: t, submissionAttempts: i } = e,
          s = _t({ draftState: t, serverState: r, isSaving: P }),
          c = Jt({
            intl: m,
            creditBalance: a?.balance,
            rechargeThreshold: t.rechargeThreshold,
          ...
          l =
            !re && c != null && (s.saveIntent === `enable` || s.saveIntent === `update`)
        ...
        return (0, Y.jsx)(ie, {
          ...
          contentProps: { "aria-describedby": D, onOpenAutoFocus: At },
                ...
                (0, Y.jsxs)(o, {
                  ...
                  children: [
                    (0, Y.jsx)(K.Field, {
                      ...
                      children: (e) => {
                        let t = i > 0 || e.state.meta.isBlurred ? Xt(e.state.meta.errors) : null;
                        return (0, Y.jsx)(Ht, {
                          id: O,
                          label: (0, Y.jsx)(f, {
                          ...
                          footerContent: en({ fieldError: t, fieldName: `threshold`, intl: m }),
                          footerTone: `error`,
                    ...
                    (0, Y.jsx)(K.Field, {
                      name: `rechargeTarget`,
                      children: (e) => {
                        let n = i > 0 || e.state.meta.isBlurred ? Zt(e.state.meta.errors) : null,
                          r = qt({
                            intl: m,
                            rechargeThreshold: t.rechargeThreshold,
                        ...
                        return (0, Y.jsx)(Ht, {
                          ...
                          footerContent:
                            n == null
                              ...
                              : en({ fieldError: n, fieldName: `target`, intl: m }),
  ...
  let Se;
  return (
    t[71] !== K.Subscribe || t[72] !== xe
      ? ((Se = (0, Y.jsx)(K.Subscribe, { selector: jt, children: xe })),
        (t[71] = K.Subscribe),
        (t[72] = xe),
        (t[73] = Se))
      : (Se = t[73]),
...
function Pt(e) {
  _({ href: e.url, initiator: `open_in_browser_bridge` });
}
async function Ft() {
...
function Ut(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Y.jsx)(re, { className: `icon-xxs text-token-description-foreground` })),
      (t[2] = i))
    : (i = t[2]);
  let a;
  return (
...
function Gt({ intl: e, creditDetails: t, pricingInfo: n }) {
  ...
  return t == null
    ...
    : t.unlimited
      ...
      : n == null
        ? r
        : (Je({ intl: e, creditQuantity: Kt(t.balance), pricingInfo: n }) ?? r);
}
function Kt(e) {
...
var sn,
  ...
  hn = e(() => {
    ((sn = C()),
      ...
      (un = `125`),
      (dn = `250`),
      (fn = `${le}/settings/usage?credit_modal=true`),
...
function gn(e) {
  ...
  let { data: d } = Ze(u),
    ...
    m;
  t[3] !== d || t[4] !== p
    ? ((m = { billingCurrency: d, enabled: p }), (t[3] = d), (t[4] = p), (t[5] = m))
    : (m = t[5]);
  let { data: g } = Oe(m);
  ...
  t[16] !== T || t[17] !== E || t[18] !== D
    ? ((O = (0, X.jsx)(M, { color: T, size: `toolbar`, onClick: E, children: D })),
      (t[16] = T),
      (t[17] = E),
      (t[18] = D),
      (t[19] = O))
  ...
  t[20] !== S || t[21] !== w || t[22] !== O || t[23] !== C
    ? ((k = (0, X.jsx)(S, { className: `gap-6`, label: C, description: w, control: O })),
      (t[20] = S),
      (t[21] = w),
      (t[22] = O),
      (t[23] = C),
  ...
  let A;
  t[25] !== x || t[26] !== k
    ? ((A = (0, X.jsx)(x, { children: k })), (t[25] = x), (t[26] = k), (t[27] = A))
    : (A = t[27]);
  let j;
  t[28] !== A || t[29] !== b.Content
    ? ((j = (0, X.jsx)(b.Content, { children: A })), (t[28] = A), (t[29] = b.Content), (t[30] = j))
    : (j = t[30]);
  let N;
  return (
    t[31] !== v || t[32] !== j || t[33] !== y
      ? ((N = (0, X.jsxs)(v, { children: [y, j] })),
        (t[31] = v),
        (t[32] = j),
        (t[33] = y),
        (t[34] = N))
...
function _n(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (o = t[4]);
  let s;
  t[5] === a ? (s = t[6]) : ((s = qe(a)), (t[5] = a), (t[6] = s));
  let c;
  return (
    t[7] === s
      ? (c = t[8])
...
function jn(e) {
  ...
  t[4] !== a.data?.data || t[5] !== d
    ? ((p = a.data?.data.slice(d * Rn, (d + 1) * Rn)),
      (t[4] = a.data?.data),
      (t[5] = d),
      (t[6] = p))
    : (p = t[6]);
  ...
  t[14] !== r.isError || t[15] !== r.isLoading || t[16] !== g || t[17] !== y || t[18] !== b
    ...
    : (x = t[19]);
  let S;
  t[20] !== l.length || t[21] !== u || t[22] !== a || t[23] !== d || t[24] !== n || t[25] !== m
    ? ((S = n
        ? (0, Z.jsxs)(K, {
            children: [
              (0, Z.jsx)(K.Header, {
...
function Mn(e, t) {
  return (0, Z.jsx)(
    ...
    {
      label: (0, Z.jsx)(Pn, { date: e.date }),
      description: (0, Z.jsx)(f, { ...Bn[e.product_surface] }),
...
function Nn(e) {
  ...
  if (a && n == null) {
    ...
    t[2] === s
      ? (n = t[3])
      : ((n = (0, Z.jsx)(M, { color: `secondary`, size: `toolbar`, onClick: s, children: e })),
        (t[2] = s),
        (t[3] = n));
    let r;
    return (
    ...
    t[0] !== n || t[1] !== r
      ? ((i =
          n === `credits`
            ...
            : (0, Z.jsx)(ue, { value: r / 100, style: `percent`, maximumFractionDigits: 0 })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function Hn(e) {
  ...
  if (
    ...
    bb0: {
      let e = Te(n),
        t = Xn(e, null),
        r = d ? $n(m, n) : Qn({ rateLimitStatus: n, coreUsageLimitRows: t }),
                            ...
                            control:
                              c == null
                                ...
                                : (0, Q.jsx)(M, {
                                    ...
                                    onClick: (e) => {
                                      L({ event: e, href: c, initiator: `open_in_browser_bridge` });
                                    },
                                    children: (0, Q.jsx)(f, {
...
function Kn(e) {
  let t = (0, cr.c)(6),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Q.jsx)(ot, { "aria-hidden": !0, className: `icon-sm text-token-text-tertiary` })),
      (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
...
function qn(e) {
  let t = (0, cr.c)(28),
    ...
    s = ae(),
    [c, l] = (0, lr.useState)(!1),
    [u, d] = (0, lr.useState)(n?.justification ?? ``),
    p;
  ...
  t[12] !== r || t[13] !== _ || t[14] !== v || t[15] !== y
    ...
    : (b = t[16]);
  let x;
  t[17] !== m || t[18] !== s || t[19] !== c || t[20] !== i || t[21] !== u || t[22] !== n
    ? ((x = c
        ? (0, Q.jsx)(q, {
...
function Jn(e) {
  ...
  if (
    ...
    if (t[14] !== n.resetAt) {
      let e = he(n.resetAt);
      ((i = e == null ? null : W(e)), (t[14] = n.resetAt), (t[15] = i));
    } else i = t[15];
    let a = i,
      m;
    ...
    (t[20] === a
      ...
      (t[12] = d),
      (t[13] = p));
  } else ((o = t[7]), (s = t[8]), (c = t[9]), (l = t[10]), (u = t[11]), (d = t[12]), (p = t[13]));
  let m;
  t[23] !== s || t[24] !== c
  ...
  let x;
  return (
    t[41] !== y || t[42] !== b || t[43] !== d || t[44] !== h
      ? ((x = (0, Q.jsxs)(`div`, { className: d, children: [h, y, b] })),
        (t[41] = y),
        (t[42] = b),
        (t[43] = d),
        (t[44] = h),
...
function Yn(e) {
  ...
  if (t[0] !== n.bucket.resetsAt) {
    let e = he(n.bucket.resetsAt ?? null);
    ((r = e == null ? null : W(e)), (t[0] = n.bucket.resetsAt), (t[1] = r));
  } else r = t[1];
  let i = r,
    a;
  t[2] === i
  ...
  let o = a,
    ...
    c;
  t[4] === s ? (c = t[5]) : ((c = me(s)), (t[4] = s), (t[5] = c));
  let l = c,
    u;
  ...
  return (
    t[10] !== o || t[11] !== u || t[12] !== d
      ? ((p = (0, Q.jsx)(G, { className: `gap-6`, label: u, description: o, control: d })),
        (t[10] = o),
        (t[11] = u),
        (t[12] = d),
        (t[13] = p))
...
function Xn(e, t) {
  let n = t == null ? (e.find((e) => e.limitName == null) ?? null) : Be(e, t);
  return n == null ? [] : it({ entry: n, keyPrefix: t ?? `core` });
}
function Zn(e) {
...
function gr() {
  let e = (0, br.c)(63),
    ...
    a;
  e[0] === i ? (a = e[1]) : ((a = l(i)), (e[0] = i), (e[1] = a));
  let o = a,
    s = o && n && !r,
    { data: u, isLoading: d, isError: p, refetch: m } = c(A),
    h;
  e[2] === t ? (h = e[3]) : ((h = { enabled: t }), (e[2] = t), (e[3] = h));
  let { data: g, isLoading: _, isError: v, refetch: y } = $e(h),
    b;
  e[4] === s ? (b = e[5]) : ((b = { enabled: s }), (e[4] = s), (e[5] = b));
  let { data: S, isLoading: C, isError: ee, refetch: w } = xe(b),
    T =
  ...
  let { data: O, refetch: k } = be(D),
    j = O?.kind === `openai_native`,
    N = s && T && j,
    P;
  e[8] === N ? (P = e[9]) : ((P = { enabled: N }), (e[8] = N), (e[9] = P));
  let { data: te, isLoading: F, isError: ne, refetch: re } = ke(P),
    I = Qe(),
    {
  ...
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, $.jsx)(tt, { slug: `usage` })), (e[10] = R))
    : (R = e[10]);
  let oe = R;
  if (!n && !r) return null;
  let z = !n && r,
    se = o
      ? (C && S == null) || (T && j && F && te == null)
      : (t && _ && g == null) || (d && u == null),
    ce = o
      ? (ee && S == null) || (T && j && ne && te == null)
      : (t && v && g == null) || (p && u == null),
    le;
  e[11] !== t ||
  e[12] !== T ||
  ...
  if (z || ce || se) {
    ...
    if (z) {
      ...
      (e[24] === ue
        ? (a = e[25])
        : ((a = (0, $.jsx)(M, { color: `secondary`, size: `toolbar`, onClick: ue, children: i })),
          (e[24] = ue),
          (e[25] = a)),
        (n = a));
    } else {
  ...
  let H;
  e[44] !== g || e[45] !== t || e[46] !== L || e[47] !== ie || e[48] !== u?.credits || e[49] !== ae
    ? ((H =
        t && g != null
          ? (0, $.jsx)(Tt, {
              serverState: g,
  ...
  e[53] === t
    ? (de = e[54])
    : ((de = (0, $.jsx)(x, { browser: !0, children: (0, $.jsx)(jn, { showCreditHistory: t }) })),
      (e[53] = t),
      (e[54] = de));
  let fe;
  e[55] === i ? (fe = e[56]) : ((fe = (0, $.jsx)(_n, { plan: i })), (e[55] = i), (e[56] = fe));
  let G;
  return (
    e[57] !== H || e[58] !== W || e[59] !== de || e[60] !== fe || e[61] !== V
      ? ((G = (0, $.jsxs)(ut, {
          title: oe,
          subtitle: B,
          subtitleClassName: `whitespace-normal`,
          titleStackClassName: `gap-2 pb-1`,
          children: [V, H, W, de, fe],
        })),
        (e[57] = H),
        (e[58] = W),
        (e[59] = de),
...
function vr(e) {
  L({ event: e, href: Ce, initiator: `open_in_browser_bridge` });
}
function yr(e) {
  let t = (0, br.c)(6),
  ...
  return (
    t[3] !== a || t[4] !== n
      ? ((o = (0, $.jsx)(ut, { title: n, children: a })), (t[3] = a), (t[4] = n), (t[5] = o))
      : (o = t[5]),
    o
  );
}
