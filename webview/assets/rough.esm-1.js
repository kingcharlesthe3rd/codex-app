...
function r(e, t) {
  ...
  let a = 1;
  return (
    t.roughness >= 1 && (t.randomizer?.next() || Math.random()) > 0.7 && (a = i), n(e, i, r, a || 1)
  );
}
var i = class {
  constructor(e) {
...
function y(e, t, n, r, i, a, o, s, c, l) {
  ...
  if (Math.abs(_) > (120 * Math.PI) / 180) {
    let e = m,
      t = n,
      s = r;
    ((m = c && m > p ? p + ((120 * Math.PI) / 180) * 1 : p + ((120 * Math.PI) / 180) * -1),
      (f = y((n = h + i * Math.cos(m)), (r = g + a * Math.sin(m)), t, s, i, a, o, 0, c, [
        m,
        e,
        h,
        g,
  ...
  let b = Math.cos(p),
    ...
    k = [n + T * C, r - E * S],
    A = [n, r];
  if (((O[0] = 2 * D[0] - O[0]), (O[1] = 2 * D[1] - O[1]), l)) return [O, k, A].concat(f);
  {
    f = [O, k, A].concat(f);
    let e = [];
...
function S(e, t, n) {
  ...
  if (r > 2) {
    let i = [];
    for (let t = 0; t < r - 1; t++) i.push(...F(e[t][0], e[t][1], e[t + 1][0], e[t + 1][1], n));
    return (
      t && i.push(...F(e[r - 1][0], e[r - 1][1], e[0][0], e[0][1], n)), { type: `path`, ops: i }
    );
  }
  return r === 2 ? x(e[0][0], e[0][1], e[1][0], e[1][1], n) : { type: `path`, ops: [] };
}
...
function w(e, t) {
  if (e.length) {
    let n = typeof e[0][0] == `number` ? [e] : e,
      ...
      i = t.disableMultiStroke ? [] : L(n[0], 1.5 * (1 + 0.22 * t.roughness), j(t));
    for (let e = 1; e < n.length; e++) {
      let a = n[e];
      if (a.length) {
        let e = L(a, 1 * (1 + 0.2 * t.roughness), t),
          n = t.disableMultiStroke ? [] : L(a, 1.5 * (1 + 0.22 * t.roughness), j(t));
...
function T(e, t, n) {
  let r = Math.sqrt(2 * Math.PI * Math.sqrt(((e / 2) ** 2 + (t / 2) ** 2) / 2)),
    ...
    s = Math.abs(t / 2),
    c = 1 - n.curveFitting;
  return ((o += P(o * c, n)), (s += P(s * c, n)), { increment: a, rx: o, ry: s });
}
function E(e, t, n, r) {
  let [i, a] = z(r.increment, e, t, r.rx, r.ry, 1, r.increment * N(0.1, N(0.4, 1, n), n), n),
    o = R(i, null, n);
  ...
  for (let r of e)
    if (r.length) {
      ...
      if (i > 2) {
        ...
        for (let a = 1; a < i; a++)
          n.push({ op: `lineTo`, data: [r[a][0] + P(e, t), r[a][1] + P(e, t)] });
      }
    }
  ...
  return (
    a &&
      (o
        ...
        : h.push({ op: `move`, data: [e + (v ? 0 : P(u, i, l)), t + (v ? 0 : P(u, i, l))] })),
    o
      ? h.push({
          op: `bcurveTo`,
          data: [
...
function L(e, t, n) {
  if (!e.length) return [];
  let r = [];
  (r.push([e[0][0] + P(t, n), e[0][1] + P(t, n)]), r.push([e[0][0] + P(t, n), e[0][1] + P(t, n)]));
...
function z(e, t, n, r, i, a, o, s) {
  ...
  if (s.roughness === 0) {
    ...
    l.push([P(a, s) + t + 0.9 * r * Math.cos(u - e), P(a, s) + n + 0.9 * i * Math.sin(u - e)]);
    ...
    (l.push([
      ...
      l.push([P(a, s) + t + 0.98 * r * Math.cos(u + o), P(a, s) + n + 0.98 * i * Math.sin(u + o)]),
      l.push([
...
function B(e, t, n, r, i, a, o, s, c) {
  let l = a + P(0.1, c),
    u = [];
  u.push([P(s, c) + t + 0.9 * r * Math.cos(l - e), P(s, c) + n + 0.9 * i * Math.sin(l - e)]);
  for (let a = l; a <= o; a += e)
...
function V(e, t, n, r, i, a, o, s) {
  ...
  for (let p = 0; p < d; p++)
    (p === 0
      ...
      : c.push({ op: `move`, data: [o[0] + (f ? 0 : P(l[0], s)), o[1] + (f ? 0 : P(l[0], s))] }),
      (u = f ? [i, a] : [i + P(l[p], s), a + P(l[p], s)]),
      c.push({
        op: `bcurveTo`,
        data: [e + P(l[p], s), t + P(l[p], s), n + P(l[p], s), r + P(l[p], s), u[0], u[1]],
      }));
  return c;
}
function H(e) {
...
function q(e, t, n, r) {
  ...
  if (
    ...
    let n = e[t + 0];
    (i.length ? ((a = i[i.length - 1]), (o = n), Math.sqrt(W(a, o))) > 1 && i.push(n) : i.push(n),
      i.push(e[t + 3]));
  } else {
    let r = 0.5,
      a = e[t + 0],
...
var Q = class {
        ...
        if (c.fillStyle === `solid`) {
          ...
          l.push(
            (function (e, t, n, r, i, a, o) {
              ...
              return (
                m.push([s + l * Math.cos(f), c + u * Math.sin(f)]), m.push([s, c]), A([m], o)
              );
            })(e, t, n, r, i, a, c),
          );
          ...
          if (i.length) {
            ...
            for (let r of e)
              r.length < 3
                ? t.push(...r)
                : r.length === 3
                  ? t.push(...X(U([r[0], r[0], r[1], r[2]]), 10, (1 + n.roughness) / 2))
    ...
    polygon(e, t) {
      let n = this._o(t),
        ...
        i = S(e, !0, n);
      return (
        n.fill && (n.fillStyle === `solid` ? r.push(k([e], n)) : r.push(A([e], n))),
        n.stroke !== Z && r.push(i),
        this._d(`polygon`, r, n)
      );
    }
