...
e(() => {
  ((t = `#f7f8fa`),
    ...
    (a = `Linear Light`),
    (o = [
      { scope: [`comment`, `punctuation.definition.comment`], settings: { foreground: `#8a93a6` } },
      {
    ...
    (s = `light`),
    (c = { bg: t, colors: n, chromeTheme: r, fg: i, name: a, settings: o, type: s }));
})();
export {
  t as bg,
  r as chromeTheme,
...
//# sourceMappingURL=linear-light-D.js.map
