...
import "./src-C.js";
import { $s as t } from "./app-server-manager-signals.js";
...
function k(e) {
  ...
  let R = L,
    z;
  n[16] !== r || n[17] !== R
    ? ((z = R ? (0, _.createPortal)((0, b.jsx)(M, { suggestion: R }, R.id), r) : null),
      (n[16] = r),
      (n[17] = R),
      (n[18] = z))
    : (z = n[18]);
  ...
  return (
    n[19] === z
      ? (B = n[20])
      : ((B = (0, b.jsx)(b.Fragment, { children: z })), (n[19] = z), (n[20] = B)),
    B
  );
}
function A(e) {
...
function M(e) {
  ...
  t[0] === s
    ? (u = t[1])
    : ((u = s ? (0, b.jsx)(s, { className: `icon-xs shrink-0` }) : null), (t[0] = s), (t[1] = u));
  let d = u,
    m;
  t[2] !== c || t[3] !== l || t[4] !== n
    ? ((m = (e) => {
