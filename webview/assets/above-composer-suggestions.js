...
function R(e) {
  ...
  let d = c ? `items-start` : `items-center`,
    f;
  t[2] === d ? (f = t[3]) : ((f = E(`flex min-w-0 flex-1 gap-2`, d)), (t[2] = d), (t[3] = f));
  let p;
  t[4] === r
    ? (p = t[5])
    : ((p =
  ...
  let m = c ? `flex flex-col gap-1 text-sm` : `flex items-center gap-2`,
    h;
  t[6] === m ? (h = t[7]) : ((h = E(`min-w-0 flex-1`, m)), (t[6] = m), (t[7] = h));
  let g = c ? `min-w-0 leading-5 break-words` : `truncate leading-[18px]`,
    _;
  t[8] === g
    ? (_ = t[9])
    : ((_ = E(`text-sm font-medium text-token-foreground`, g)), (t[8] = g), (t[9] = _));
  let v;
  t[10] !== _ || t[11] !== s
    ? ((v = (0, B.jsx)(`span`, { className: _, children: s })),
      (t[10] = _),
      (t[11] = s),
      (t[12] = v))
    : (v = t[12]);
  ...
  t[16] !== v || t[17] !== y || t[18] !== h
    ? ((b = (0, B.jsxs)(`div`, { className: h, children: [v, y] })),
      (t[16] = v),
      (t[17] = y),
      (t[18] = h),
      (t[19] = b))
  ...
  t[20] !== b || t[21] !== f || t[22] !== p
    ? ((x = (0, B.jsxs)(`div`, { className: f, children: [p, b] })),
      (t[20] = b),
      (t[21] = f),
      (t[22] = p),
      (t[23] = x))
  ...
  t[24] === n
    ? (S = t[25])
    : ((S = (0, B.jsx)(`div`, { className: `flex shrink-0 items-center gap-1`, children: n })),
      (t[24] = n),
      (t[25] = S));
  let C;
  return (
...
function H({
  ...
  let i = F(t),
    { icon: o, pluginName: s, title: c } = U(e, t);
  return {
    id: i,
    title: c,
    icon: o,
...
function de(e) {
  let t = (0, Y.c)(32),
    ...
    s = d(),
    u;
  t[0] === a ? (u = t[1]) : ((u = p(a)), (t[0] = a), (t[1] = u));
  let f = u,
    { activeMode: h, modes: g, setSelectedMode: y } = ee(f),
    b;
  t[2] === g ? (b = t[3]) : ((b = g.some(fe)), (t[2] = g), (t[3] = b));
  let x = b,
    S = h.mode === `plan`,
    C = pe(f),
    w;
  ...
  let [T, E] = te(w),
    D;
  t[6] === T ? (D = t[7]) : ((D = new Set(T)), (t[6] = T), (t[7] = D));
  let k = D,
    A;
  t[8] === r ? (A = t[9]) : ((A = (e) => ne(e.view.state.doc, r)), (t[8] = r), (t[9] = A));
  let j = m(s, A),
    M;
  t[10] !== k || t[11] !== j
    ? ((M = j != null && !k.has(F(j)) ? j : null), (t[10] = k), (t[11] = j), (t[12] = M))
    : (M = t[12]);
  let N = M,
    P;
  t[13] !== k || t[14] !== x || t[15] !== S || t[16] !== i
    ? ((P = (e) =>
        ae({
  ...
  let I = m(s, P),
    L;
  t[18] === s ? (L = t[19]) : ((L = (e) => re(s, e)), (t[18] = s), (t[19] = L));
  let R;
  t[20] !== N || t[21] !== o || t[22] !== E || t[23] !== y || t[24] !== I || t[25] !== L
    ? ((R = ce({
        intl: o,
        artifactPluginSuggestionKind: N,
        activateArtifactPlugin: L,
        shouldShowPlanSuggestion: I,
        setSelectedCollaborationMode: y,
...
function me(e) {
  let t = (0, Y.c)(28),
    ...
    [a, o] = (0, X.useState)(!1),
    s = r.icon,
    c = r.actionDisabled === !0 || a,
    u = r.dismissOnAction !== !1,
    d;
  t[0] === s
    ? (d = t[1])
  ...
  t[6] === r
    ? (h = t[7])
    : ((h = (e) => {
        (e.stopPropagation(), r.onDismiss());
      }),
      (t[6] = r),
      (t[7] = h));
  let g = h,
    _;
  t[8] !== m || t[9] !== c || t[10] !== a || t[11] !== r.actionLabel
    ? ((_ = (0, Q.jsx)(C, {
        className: `px-2.5`,
        color: `secondary`,
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, Q.jsx)(n, { className: `icon-xs` })), (t[15] = y))
    : (y = t[15]);
  let b;
  t[16] !== g || t[17] !== v
    ? ((b = (0, Q.jsx)(`button`, {
  ...
  let x;
  t[19] !== _ || t[20] !== b
    ? ((x = (0, Q.jsxs)(Q.Fragment, { children: [_, b] })), (t[19] = _), (t[20] = b), (t[21] = x))
    : (x = t[21]);
  let S;
  return (
    t[22] !== f || t[23] !== r.id || t[24] !== r.meta || t[25] !== r.title || t[26] !== x
      ? ((S = (0, Q.jsx)(R, {
          actions: x,
          icon: f,
          meta: r.meta,
