...
import { at as a, lt as o } from "./vscode-api.js";
...
import { r as u, t as d } from "./use-collaboration-mode.js";
...
function x(e) {
  let t = (0, y.c)(31),
    { actions: n, icon: i, layout: a, meta: o, suggestionId: s, title: c } = e,
  ...
  let f = l ? `items-start` : `items-center`,
    p;
  t[2] === f ? (p = t[3]) : ((p = r(`flex min-w-0 flex-1 gap-2`, f)), (t[2] = f), (t[3] = p));
  let m;
  t[4] === i
    ? (m = t[5])
    : ((m =
  ...
  let h = l ? `flex flex-col gap-1 text-sm` : `flex items-center gap-2`,
    g;
  t[6] === h ? (g = t[7]) : ((g = r(`min-w-0 flex-1`, h)), (t[6] = h), (t[7] = g));
  let _ = l ? `min-w-0 leading-5 break-words` : `truncate leading-[18px]`,
    v;
  t[8] === _
    ? (v = t[9])
    : ((v = r(`text-sm font-medium text-token-foreground`, _)), (t[8] = _), (t[9] = v));
  let x;
  t[10] !== v || t[11] !== c
...
function k(e) {
  let t = (0, y.c)(21),
    ...
    o = c(),
    l = g(),
    { activeMode: f, modes: p, setSelectedMode: m } = d(r),
    v;
...
function M(e) {
  ...
  t[0] === o
    ? (u = t[1])
    : ((u = o ? (0, b.jsx)(o, { className: `icon-xs shrink-0` }) : null), (t[0] = o), (t[1] = u));
  let d = u,
    m;
  t[2] !== s || t[3] !== l || t[4] !== n
    ? ((m = (e) => {
  ...
  let _ = g,
    S;
  t[8] !== h || t[9] !== s || t[10] !== i || t[11] !== n.actionLabel
    ? ((S = (0, b.jsx)(f, {
        className: `px-2.5`,
        color: `secondary`,
        size: `default`,
  ...
  let D;
  return (
    t[22] !== d || t[23] !== n.id || t[24] !== n.meta || t[25] !== n.title || t[26] !== E
      ? ((D = (0, b.jsx)(x, {
          actions: E,
          icon: d,
          meta: n.meta,
