...
function de(e) {
  let t = (0, Y.c)(32),
    { portalTarget: n, hideArtifactPluginSuggestions: i, showPlanKeywordSuggestion: o } = e,
    s = r(u),
    c = A(),
    d = x(),
    f;
  ...
  let O = D,
    k;
  t[8] === i ? (k = t[9]) : ((k = (e) => te(e.view.state.doc, i)), (t[8] = i), (t[9] = k));
  let j = E(d, k),
    M;
  t[10] !== O || t[11] !== j
    ? ((M = j != null && !O.has(R(j)) ? j : null), (t[10] = O), (t[11] = j), (t[12] = M))
    : (M = t[12]);
  let N = M,
    F;
  ...
  let z;
  t[20] !== N || t[21] !== c || t[22] !== T || t[23] !== _ || t[24] !== I || t[25] !== L
    ? ((z = ce({
        intl: c,
...
function me(e) {
  ...
  let b;
  t[19] !== h || t[20] !== y
    ? ((b = (0, Q.jsxs)(Q.Fragment, { children: [h, y] })), (t[19] = h), (t[20] = y), (t[21] = b))
    : (b = t[21]);
  let x;
  return (
