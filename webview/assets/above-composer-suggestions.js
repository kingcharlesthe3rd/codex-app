...
function z(e) {
  ...
  let d = c ? `items-start` : `items-center`,
    f;
  t[2] === d ? (f = t[3]) : ((f = S(`flex min-w-0 flex-1 gap-2`, d)), (t[2] = d), (t[3] = f));
  let p;
  t[4] === r
    ? (p = t[5])
    : ((p =
  ...
  let m = c ? `flex flex-col gap-1 text-sm` : `flex items-center gap-2`,
    h;
  t[6] === m ? (h = t[7]) : ((h = S(`min-w-0 flex-1`, m)), (t[6] = m), (t[7] = h));
  let g = c ? `min-w-0 leading-5 break-words` : `truncate leading-[18px]`,
    _;
  t[8] === g
    ? (_ = t[9])
    : ((_ = S(`text-sm font-medium text-token-foreground`, g)), (t[8] = g), (t[9] = _));
  let v;
  t[10] !== _ || t[11] !== s
...
function J(e) {
  let t = (0, Y.c)(32),
    ...
    f = P(),
    p;
  t[0] === a ? (p = t[1]) : ((p = ee(a)), (t[0] = a), (t[1] = p));
  let m = p,
    { activeMode: h, modes: g, setSelectedMode: _ } = d(m),
    v;
  ...
  let [w, T] = c(C),
    E;
  t[6] === w ? (E = t[7]) : ((E = new Set(w)), (t[6] = w), (t[7] = E));
  let O = E,
    k;
  t[8] === r ? (k = t[9]) : ((k = (e) => ne(e.view.state.doc, r)), (t[8] = r), (t[9] = k));
  let A = M(f, k),
    j;
  t[10] !== O || t[11] !== A
    ? ((j = A != null && !O.has(R(A)) ? A : null), (t[10] = O), (t[11] = A), (t[12] = j))
    : (j = t[12]);
  let N = j,
    F;
  t[13] !== O || t[14] !== y || t[15] !== x || t[16] !== i
    ? ((F = (e) =>
        oe({
  ...
  let I = M(f, F),
    L;
  t[18] === f ? (L = t[19]) : ((L = (e) => te(f, e)), (t[18] = f), (t[19] = L));
  let z;
  t[20] !== N || t[21] !== l || t[22] !== T || t[23] !== _ || t[24] !== I || t[25] !== L
    ? ((z = le({
        intl: l,
...
function me(e) {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (0, Q.jsx)(g, { className: `icon-xs` })), (t[15] = y))
    : (y = t[15]);
  let x;
  t[16] !== h || t[17] !== v
    ? ((x = (0, Q.jsx)(`button`, {
  ...
  let S;
  t[19] !== _ || t[20] !== x
    ? ((S = (0, Q.jsxs)(Q.Fragment, { children: [_, x] })), (t[19] = _), (t[20] = x), (t[21] = S))
    : (S = t[21]);
  let C;
  return (
    t[22] !== u || t[23] !== n.id || t[24] !== n.meta || t[25] !== n.title || t[26] !== S
      ? ((C = (0, Q.jsx)(z, {
          actions: S,
          icon: u,
          meta: n.meta,
