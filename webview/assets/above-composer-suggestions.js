...
import { R as r, v as i } from "./app-scope.js";
...
import { n as d, t as f } from "./use-collaboration-mode.js";
...
import { t as m } from "./plan.js";
import { n as h, t as g } from "./use-composer-controller.js";
var _ = e(o(), 1),
  v = e(t(), 1),
  y = r(),
  b = n();
...
function k(e) {
  let t = (0, y.c)(21),
    ...
    c = s(),
    l = g(),
    { activeMode: u, modes: p, setSelectedMode: m } = f(r),
    v;
  t[0] === p ? (v = t[1]) : ((v = p.some(A)), (t[0] = p), (t[1] = v));
  let x = v,
    S = u.mode === `plan`,
    T = j(r),
    D;
...
function M(e) {
  ...
  t[0] === o
    ? (d = t[1])
    : ((d = o ? (0, b.jsx)(o, { className: `icon-xs shrink-0` }) : null), (t[0] = o), (t[1] = d));
  let f = d,
    m;
  t[2] !== c || t[3] !== l || t[4] !== n
    ? ((m = (e) => {
  ...
  let D;
  return (
    t[22] !== f || t[23] !== n.id || t[24] !== n.meta || t[25] !== n.title || t[26] !== E
      ? ((D = (0, b.jsx)(x, {
          actions: E,
          icon: f,
          meta: n.meta,
