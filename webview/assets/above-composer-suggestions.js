...
import { Wn as _ } from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~project~okyna5mq.js";
import {
  Sx as v,
  nx as y,
  rx as b,
...
function z(e) {
  ...
  let d = c ? `items-start` : `items-center`,
    f;
  t[2] === d ? (f = t[3]) : ((f = y(`flex min-w-0 flex-1 gap-2`, d)), (t[2] = d), (t[3] = f));
  let p;
  t[4] === r
    ? (p = t[5])
    : ((p =
  ...
  let m = c ? `flex flex-col gap-1 text-sm` : `flex items-center gap-2`,
    h;
  t[6] === m ? (h = t[7]) : ((h = y(`min-w-0 flex-1`, m)), (t[6] = m), (t[7] = h));
  let g = c ? `min-w-0 leading-5 break-words` : `truncate leading-[18px]`,
    _;
  t[8] === g
    ? (_ = t[9])
    : ((_ = y(`text-sm font-medium text-token-foreground`, g)), (t[8] = g), (t[9] = _));
  let v;
  t[10] !== _ || t[11] !== s
  ...
  t[13] !== c || t[14] !== a
    ...
    : (b = t[15]);
  let x;
  t[16] !== v || t[17] !== b || t[18] !== h
    ? ((x = (0, V.jsxs)(`div`, { className: h, children: [v, b] })),
      (t[16] = v),
      (t[17] = b),
      (t[18] = h),
      (t[19] = x))
...
function de(e) {
  let t = (0, Y.c)(32),
    ...
    p = d(),
    h;
  t[0] === a ? (h = t[1]) : ((h = O(a)), (t[0] = a), (t[1] = h));
  let g = h,
    { activeMode: _, modes: v, setSelectedMode: y } = m(g),
    b;
  t[2] === v ? (b = t[3]) : ((b = v.some(fe)), (t[2] = v), (t[3] = b));
  let S = b,
    C = _.mode === `plan`,
    w = pe(g),
    T;
  ...
  let [E, D] = o(T),
    k;
  t[6] === E ? (k = t[7]) : ((k = new Set(E)), (t[6] = E), (t[7] = k));
  let A = k,
    j;
  t[8] === r ? (j = t[9]) : ((j = (e) => te(e.view.state.doc, r)), (t[8] = r), (t[9] = j));
  let M = u(p, j),
    N;
  t[10] !== A || t[11] !== M
    ? ((N = M != null && !A.has(F(M)) ? M : null), (t[10] = A), (t[11] = M), (t[12] = N))
    : (N = t[12]);
  let P = N,
    I;
  t[13] !== A || t[14] !== S || t[15] !== C || t[16] !== i
    ? ((I = (e) =>
        W({
  ...
  let L = u(p, I),
    R;
  t[18] === p ? (R = t[19]) : ((R = (e) => ne(p, e)), (t[18] = p), (t[19] = R));
  let z;
  t[20] !== P || t[21] !== l || t[22] !== D || t[23] !== y || t[24] !== L || t[25] !== R
    ? ((z = ce({
        intl: l,
        artifactPluginSuggestionKind: P,
...
function me(e) {
  ...
  t[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, Q.jsx)(M, { className: `icon-xs` })), (t[15] = _))
    : (_ = t[15]);
  let v;
  t[16] !== m || t[17] !== g
    ? ((v = (0, Q.jsx)(`button`, {
  ...
  let y;
  t[19] !== h || t[20] !== v
    ? ((y = (0, Q.jsxs)(Q.Fragment, { children: [h, v] })), (t[19] = h), (t[20] = v), (t[21] = y))
    : (y = t[21]);
  let b;
  return (
    t[22] !== u || t[23] !== n.id || t[24] !== n.meta || t[25] !== n.title || t[26] !== y
      ? ((b = (0, Q.jsx)(z, {
          actions: y,
          icon: u,
          meta: n.meta,
