import { i as e, n as t, r as n, s as r } from "./rolldown-runtime.js";
import { At as i, Ot as a, Tt as o, wt as s } from "./merge-1.js";
import {
  A as c,
  C as l,
  F as u,
...
import { n as O } from "./isEmpty-1.js";
import {
  A as fe,
  D as pe,
  O as me,
...
import { n as Oe, t as ke } from "./isEmpty-2.js";
import { c as Ae, i as je, l as Me, n as Ne, r as Pe, s as k, t as Fe } from "./main-DKA-NIZV.js";
function A(e) {
...
function Re(e) {
  return (
    typeof e == `object` && !!e && A(e.container) && Ie(e.reference) && typeof e.message == `string`
  );
}
function ze(e) {
    ...
    ((Ke = class e {
      ...
      join(e = `,`) {
        let t = this.iterator(),
          ...
          r,
          i = !1;
        do ((r = t.next()), r.done || (i && (n += e), (n += We(r.value))), (i = !0));
        while (!r.done);
        return n;
      }
      indexOf(e, t = 0) {
...
function rt(e, t) {
  ...
  return n && r ? _t.Inside : n ? _t.OverlapBack : r ? _t.OverlapFront : _t.Outside;
}
function it(e, t) {
      ...
      (fr = class extends He {
        ...
        computeIsSubtype(e, t) {
          switch (e) {
            ...
            case On:
              return this.isSubtype(`Condition`, t) || this.isSubtype(`ValueLiteral`, t);
            case kn:
            case An:
            case In:
            case zn:
            ...
            case Bn:
              return this.isSubtype(`AbstractRule`, t) || this.isSubtype(`AbstractType`, t);
            case Gn:
        ...
        getTypeMetaData(e) {
          switch (e) {
            case Tn:
              return { name: Tn, properties: [{ name: `cardinality` }, { name: `lookahead` }] };
            case En:
              return { name: En, properties: [{ name: `elements`, defaultValue: [] }] };
            case Dn:
              return { name: Dn, properties: [{ name: `elementType` }] };
            case On:
              return { name: On, properties: [{ name: `true`, defaultValue: !1 }] };
            case kn:
              return { name: kn, properties: [{ name: `left` }, { name: `right` }] };
            case An:
              return { name: An, properties: [{ name: `left` }, { name: `right` }] };
            case jn:
              return {
                name: jn,
                properties: [
            ...
            case Kn:
              return { name: Kn, properties: [{ name: `name` }, { name: `type` }] };
            case qn:
              return {
                name: qn,
                properties: [
            ...
            case Jn:
              return { name: Jn, properties: [{ name: `types`, defaultValue: [] }] };
            case Yn:
              return {
                name: Yn,
                properties: [
...
function hr(e) {
  for (let [t, n] of Object.entries(e))
    t.startsWith(`$`) ||
      (Array.isArray(n)
        ? n.forEach((n, r) => {
            A(n) && ((n.$container = e), (n.$containerProperty = t), (n.$containerIndex = r));
          })
...
function Er(e, t) {
  ...
  for (let e of n.properties)
    e.defaultValue !== void 0 && r[e.name] === void 0 && (r[e.name] = Dr(e.defaultValue));
}
function Dr(e) {
  ...
  for (let [r, i] of Object.entries(e))
    if (!r.startsWith(`$`))
      if (A(i)) n[r] = Or(i, t);
        ...
        let e = [];
        for (let a of i)
          A(a) ? e.push(Or(a, t)) : Ie(a) ? e.push(t(n, r, a.$refNode, a.$refText)) : e.push(a);
        n[r] = e;
      } else n[r] = i;
  return (hr(n), n);
}
...
function Yr(e) {
  try {
    ...
    for (let r of t.value.value)
      (ai.reset(e), ai.visit(r), n.push({ start: ai.startRegexp, end: ai.endRegex }));
    return n;
  } catch {
    return [];
  }
...
function $r(e) {
  return Array.prototype.map
    .call(e, (e) => (/\w/.test(e) ? `[${e.toLowerCase()}${e.toUpperCase()}]` : Qr(e)))
    .join(``);
}
function ei(e, t) {
  let n = ti(e),
...
function _i(e, t, n, r) {
  ...
  return ze(e) && e.astNode === n ? e.content.flatMap((e) => _i(e, t, n, !1)) : [];
}
function vi(e, t) {
...
function bi(e, t, n) {
  ...
  do
    if (((i = r.next()), !i.done)) {
      let e = i.value;
      e.astNode === n ? ln(e.grammarSource) && e.grammarSource.value === t && a.push(e) : r.prune();
    }
  while (!i.done);
  return a;
}
...
function Fi(e) {
  return Zt(e) ? (e.type?.name ?? `string`) : Oi(e) ? e.name : (Mi(e) ?? e.name);
}
function Ii(e) {
...
function Ri(e, t) {
  ...
  if (hn(e)) {
    ...
    return Gi(Ri(t.definition), { cardinality: e.cardinality, lookahead: e.lookahead });
  ...
  } else if (vn(e)) return Gi(Ki, { cardinality: e.cardinality, lookahead: e.lookahead });
...
function Vi(e) {
  return Gi(`${Ki}*?${Ri(e.terminal)}`, { cardinality: e.cardinality, lookahead: e.lookahead });
}
function Hi(e) {
  return Gi(`(?!${Ri(e.terminal)})${Ki}*?`, { cardinality: e.cardinality, lookahead: e.lookahead });
}
function Ui(e) {
  return e.right
    ...
    : Gi(Wi(e.left), { cardinality: e.cardinality, lookahead: e.lookahead, wrap: !1 });
}
function Wi(e) {
  return Qr(e.value);
}
...
function sa(e) {
  ...
  } else if (e instanceof I) return { type: `Alternative`, definition: t(e.definition) };
  else if (e instanceof L) return { type: `Option`, idx: e.idx, definition: t(e.definition) };
  ...
  else if (e instanceof H) return { type: `Alternation`, idx: e.idx, definition: t(e.definition) };
  else if (e instanceof U) {
    let t = { type: `Terminal`, name: e.terminalType.name, label: ia(e.terminalType), idx: e.idx };
...
function ya(e, t, n) {
  return [
    new L({ definition: [new U({ terminalType: e.separator })].concat(e.definition) }),
  ].concat(t, n);
}
var ba,
  xa = t(() => {
...
function Ca(e) {
  let t = [],
    ...
    a,
    o = !0;
  for (; i && o; ) ((a = n[r]), (o = ma(a)), (t = t.concat(Sa(a))), (r += 1), (i = n.length > r));
  return ie(t);
}
function wa(e) {
  ...
  switch (e.type) {
    ...
    case `Alternative`:
      ...
      for (let e = 0; e < r.length; e++) {
        ...
        if ((a.type === `Group` && Ua(a) === !1) || (a.type !== `Group` && o === !1)) break;
      }
      break;
    default:
      throw Error(`non exhaustive match!`);
...
function Ua(e) {
  let t = e.quantifier;
  return t && t.atLeast === 0 ? !0 : e.value ? (i(e.value) ? g(e.value, Ua) : Ua(e.value)) : !1;
}
function Wa(e, t) {
  ...
  n(`Transform Patterns`, () => {
    ((a = !1),
      (o = S(r, (e) => {
        ...
        if (ue(n)) {
          let e = n.source;
          return e.length === 1 && e !== `^` && e !== `$` && e !== `.` && !n.ignoreCase
            ? e
            : e.length === 2 &&
                e[0] === `\\` &&
                !D(
  ...
  n(`Line Terminator Handling`, () => {
    ...
    ((m = S(r, (e) => !1)),
      t.positionTracking !== `onlyOffset` &&
        (m = S(r, (t) =>
          E(t, `LINE_BREAKS`) ? !!t.LINE_BREAKS : vo(t, e) === !1 && Wa(e, t.PATTERN),
        )));
  });
  let ee, h, g, _;
  n(`Misc Mapping #2`, () => {
    ...
    t.safeMode ||
      n(`First Char Optimization`, () => {
        b = T(
          r,
          (e, n, r) => {
            if (typeof n.PATTERN == `string`) xo(e, So(n.PATTERN.charCodeAt(0)), _[r]);
  ...
  let t = [],
    n = S(e, (n) =>
      T(
        e,
        (e, r) =>
          n.PATTERN.source === r.PATTERN.source && !D(t, r) && r.PATTERN !== G.NA
            ? (t.push(r), e.push(r), e)
            : e,
        [],
      ),
        ...
        return (
          r === G.NA ||
            (l(r)
              ...
              : ue(r) && lo(r) && e.push({ str: r.source, idx: n, tokenType: t })),
          e
        );
      },
      [],
    ...
    v(e, (e, r) => {
      v(n, ({ str: n, idx: i, tokenType: a }) => {
        if (r < i && co(n, e.PATTERN)) {
          ...
          t.push({ message: n, type: W.UNREACHABLE_PATTERN, tokenTypes: [e, a] });
        }
      });
    }),
    t
    ...
    t &&
      v(a, (e) => {
        ...
        if (t !== !1) {
          ...
          E(e, `LINE_BREAKS`) ? e.LINE_BREAKS === !0 && (i = !0) : Wa(o, e.PATTERN) && (i = !0);
      }),
    t &&
      !i &&
      r.push({
...
a boolean 2nd argument is no longer supported`);
          ...
          (n === !0
            ...
            this.TRACE_INIT(`Lexer Constructor`, () => {
              ...
              (this.TRACE_INIT(`Lexer Config handling`, () => {
                if (this.config.lineTerminatorsPattern === Zo.lineTerminatorsPattern)
                  this.config.lineTerminatorsPattern = Ao;
                else if (this.config.lineTerminatorCharacters === Zo.lineTerminatorCharacters)
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
                ...
                this.config.skipValidations === !1 &&
                  (this.TRACE_INIT(`performRuntimeChecks`, () => {
                    this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(
                      po(n, this.trackStartLines, this.config.lineTerminatorCharacters),
                    );
                  }),
                  this.TRACE_INIT(`performWarningRuntimeChecks`, () => {
                    this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(
                      mo(n, this.trackStartLines, this.config.lineTerminatorCharacters),
                    );
                  })),
              ...
              if (
                    ...
                    if (
                      ...
                      this.config.skipValidations === !1 &&
                        this.TRACE_INIT(`validatePatterns`, () => {
                          this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(Xa(e, a));
                        }),
                      ...
                      (this.TRACE_INIT(`analyzeTokenTypes`, () => {
                        ...
                        (this.emptyGroups = m({}, this.emptyGroups, r.emptyGroups)),
                ...
                !O(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling)
              ) {
...
` + e,
              ...
              (v(this.lexerDefinitionWarning, (e) => {
                ...
                this.TRACE_INIT(`Choosing sub-methods implementations`, () => {
                  if (
                    (Do
                      ...
                      : ((this.updateLastIndex = p), (this.match = this.matchWithExec)),
                    r && (this.handleModes = p),
                    this.trackStartLines === !1 && (this.computeNewColumn = o),
                    this.trackEndLines === !1 && (this.updateTokenEndLineColumnLocation = p),
                ...
                this.TRACE_INIT(`Failed Optimization Warnings`, () => {
                  let e = T(this.canModeBeOptimized, (e, t, n) => (t === !1 && e.push(n), e), []);
	 ...
	 Or inspect the console log for details on how to resolve these issues.`);
        ...
        tokenize(e, t = this.defaultMode) {
          if (!O(this.lexerDefinitionErrors)) {
            let e = S(this.lexerDefinitionErrors, (e) => e.message).join(`-----------------------
`);
            throw Error(
          ...
          for (; y < v; ) {
            ...
            if (s !== null) {
              if (
                ...
                d !== void 0 &&
                  ((f = O.tokenTypeIdx),
                  (p = this.createTokenInstance(s, y, f, O.tokenType, re, ie, u)),
              ...
              if (
                ...
                ne.push({ offset: t, line: n, column: i, length: m, message: h }),
                fe === !1)
              )
                break;
            }
          }
          return (this.hasCustom || (x.length = b), { tokens: x, groups: ae, errors: ne });
        }
        handleModes(e, t, n, r) {
          if (e.pop === !0) {
            let i = e.push;
...
inside top level rule: ->` +
      ...
      (vs = {
        buildDuplicateFoundError(e, t) {
          function n(e) {
            return e instanceof U ? e.terminalType.name : e instanceof F ? e.nonTerminalName : ``;
          }
          let r = e.name,
            i = c(t),
            a = i.idx,
...
For Further details.`),
        ...
        buildDuplicateRuleNameError(e) {
          let t;
          return (
            (t = e.topLevelRule instanceof la ? e.topLevelRule.name : e.topLevelRule),
...
function Cs(e, t, n = []) {
  ...
  for (; n.length < t && i < e.length; ) {
    ...
    else if (t instanceof R) return o(t.definition.concat([new B({ definition: t.definition })]));
    else if (t instanceof z)
      return o([
        new I({ definition: t.definition }),
        new B({ definition: [new U({ terminalType: t.separator })].concat(t.definition) }),
      ]);
...
function ws(e, t, n, r) {
  let i = `EXIT_NONE_TERMINAL`,
    ...
    d = [],
    p = [];
  for (p.push({ idx: -1, def: e, ruleStack: [], occurrenceStack: [] }); !O(p); ) {
    let e = p.pop();
    if (e === o) {
      s && ee(p).idx <= l && p.pop();
      continue;
    ...
    if (_ === i) {
      ...
      let t = x(g);
      t.push(_.idx);
      let n = { idx: m, def: _.definition.concat(a, f(r)), ruleStack: e, occurrenceStack: t };
      p.push(n);
    } else if (_ instanceof L) {
      let e = { idx: m, def: f(r), ruleStack: h, occurrenceStack: g };
      (p.push(e), p.push(o));
      let t = { idx: m, def: _.definition.concat(f(r)), ruleStack: h, occurrenceStack: g };
      p.push(t);
    } else if (_ instanceof R) {
      let e = new B({ definition: _.definition, idx: _.idx }),
        t = { idx: m, def: _.definition.concat([e], f(r)), ruleStack: h, occurrenceStack: g };
      p.push(t);
    } else if (_ instanceof z) {
      let e = new B({
          definition: [new U({ terminalType: _.separator })].concat(_.definition),
          idx: _.idx,
        }),
        t = { idx: m, def: _.definition.concat([e], f(r)), ruleStack: h, occurrenceStack: g };
      p.push(t);
      ...
      let t = new B({
        ...
        n = { idx: m, def: _.definition.concat([t], f(r)), ruleStack: h, occurrenceStack: g };
      p.push(n);
      ...
      p.push({ idx: m, def: _.definition.concat(f(r)), ruleStack: h, occurrenceStack: g });
      ...
      (Ds = class extends Es {
        ...
        walkTerminal(e, t, n) {
          this.isAtEndOfPath &&
            ...
            !this.found &&
            ((this.possibleTokTypes = Sa(new I({ definition: t.concat(n) }))), (this.found = !0));
        }
      }),
      (Os = class extends ba {
        constructor(e, t) {
...
function Ps(e) {
  ...
  if (e instanceof R || e === `RepetitionMandatory`) return K.REPETITION_MANDATORY;
  if (e instanceof z || e === `RepetitionMandatoryWithSeparator`)
    return K.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (e instanceof V || e === `RepetitionWithSeparator`) return K.REPETITION_WITH_SEPARATOR;
    ...
    v(e, (e) => {
      ...
      v(a, (i) => {
        ...
        if (O(d(c))) {
          ...
          r.push({ message: t, type: q.NO_NON_EMPTY_LOOKAHEAD, ruleName: e.name });
        }
      });
    }),
    r
      ...
      (n, r, a) => (
        t.definition[a].ignoreAmbiguities === !0 ||
          v(r, (r) => {
            let o = [a];
            (v(e, (e, n) => {
              a !== n && Ks(e, r) && t.definition[n].ignoreAmbiguities !== !0 && o.push(n);
            }),
              o.length > 1 && !Ks(i, r) && (i.push(r), n.push({ alts: o, path: r })));
          }),
        n
      ),
      [],
  ...
  return ne(
    _(i, (e) => {
      ...
      let a = e.idx,
        o = e.path;
      return S(
        h(i, (e) => t.definition[e.idx].ignoreAmbiguities !== !0 && e.idx < a && qs(e.path, o)),
        (e) => {
          let i = [e.idx + 1, a + 1],
            o = t.idx === 0 ? `` : t.idx;
          return {
  ...
  return (
    v(e, (e) => {
      ...
      if (D(i, t)) {
        ...
        r.push({ message: i, type: q.CONFLICT_TOKENS_RULES_NAMESPACE, ruleName: t });
      }
    }),
    r
  );
...
function yc(e) {
  return (
    (e = de(e, { errMsgProvider: vs })), $s(e.rules, e.tokenTypes, e.errMsgProvider, e.grammarName)
  );
}
var bc = t(() => {
  (w(), Ss(), _c(), ys());
  ...
  Rc = t(() => {
    (hs(),
      ...
      (Lc = class {
        ...
        flattenFollowSet() {
          return d(S(this.buildFullFollowKeyStack(), (e) => this.getFollowSetFromFollowKey(e)));
        }
      ...
      (qc = class {
        initLooksAhead(e) {
          ((this.dynamicTokensEnabled = E(e, `dynamicTokensEnabled`)
            ...
            (this.maxLookahead = E(e, `maxLookahead`) ? e.maxLookahead : Hl.maxLookahead),
          ...
          v(e, (e) => {
            this.TRACE_INIT(`${e.name} Rule Lookahead`, () => {
              ...
              (v(t, (t) => {
                ...
                v(n, (t) => {
                  this.computeLookaheadFunc(e, t.idx, 768, `Repetition`, t.maxLookahead, ga(t));
                }),
                v(r, (t) => {
                  this.computeLookaheadFunc(e, t.idx, 512, `Option`, t.maxLookahead, ga(t));
                }),
                v(i, (t) => {
...
var tl = t(() => {});
function nl(e, t) {
  Object.defineProperty(e, rl, { enumerable: !1, configurable: !0, writable: !1, value: t });
}
var rl,
  il = t(() => {
    rl = `name`;
  ...
  hl = t(() => {
    (Kl(),
      (ml = class {
        ...
        SKIP_TOKEN() {
          return this.currIdx <= this.tokVector.length - 2 ? (this.consumeToken(), this.LA(1)) : Vl;
        }
        LA(e) {
  ...
  yl = t(() => {
	...
	For Further details.`);
          ...
          if (i(e)) this.tokensMap = T(e, (e, t) => ((e[t.name] = t), e), {});
            ...
            this.tokensMap = T(ie(d(b(e.modes))), (e, t) => ((e[t.name] = t), e), {});
        ...
        defineRule(e, t, n) {
          ...
          let r = E(n, `resyncEnabled`) ? n.resyncEnabled : Ul.resyncEnabled,
            i = E(n, `recoveryValueFunc`) ? n.recoveryValueFunc : Ul.recoveryValueFunc,
        ...
        atLeastOneInternalLogic(e, t, n) {
          ...
          this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, t], r, Bc, e, js);
        }
        ...
        manyInternalLogic(e, t, n) {
          ...
          this.attemptInRepetitionRecovery(this.manyInternal, [e, t], r, 768, e, ks, a);
        }
    ...
    (Ns(),
      ...
      (Sl = class {
        ...
        computeContentAssist(e, t) {
          ...
          if (le(n)) throw Error(`Rule ->${e}<- does not exist in this grammar.`);
...
function Tl(e, t) {
  ...
  let n = ee(this.recordingProdStack),
    r = i(e) === !1,
    a = r === !1 ? e : e.DEF,
    o = new H({ definition: [], idx: t, ignoreAmbiguities: r && e.IGNORE_AMBIGUITIES === !0 });
  return (
...
var Ol,
  ...
  Fl = t(() => {
    (w(),
      ...
      Kl(),
      Uc(),
      (Ol = { description: `This Object indicates the Parser is during Recording Phase` }),
      Object.freeze(Ol),
      (kl = !0),
      (Al = 2 ** 8 - 1),
	...
	https://chevrotain.io/docs/guide/internals.html#grammar-recording`;
        ...
        subruleInternalRecord(e, t, n) {
          ...
          let r = ee(this.recordingProdStack),
            i = e.ruleName,
            a = new F({ idx: t, nonTerminalName: i, label: n?.LABEL, referencedRule: void 0 });
    ...
    (w(),
      ...
      (Il = class {
        initPerformanceTracer(e) {
          ...
          } else ((this.traceInitMaxIdent = 0), (this.traceInitPerf = Hl.traceInitPerf));
          this.traceInitIndent = -1;
        }
        TRACE_INIT(e, t) {
          if (this.traceInitPerf === !0) {
...
var Vl,
  ...
  Kl = t(() => {
    (w(),
      ...
      (Ul = Object.freeze({ recoveryValueFunc: () => void 0, resyncEnabled: !0 })),
      (function (e) {
              ...
              O(this.definitionErrors) &&
                ...
                this.TRACE_INIT(`ComputeLookaheadFunctions`, () => {
                  ...
                  ((t = (e = this.lookaheadStrategy).initialize) == null ||
                    ...
                    this.preComputeLookaheadFunctions(b(this.gastProductionsCache)));
                })),
...
`)}`,
	...
	For further details.`);
          this.skipValidations = E(t, `skipValidations`) ? t.skipValidations : Hl.skipValidations;
        }
      }),
...
function $l(e, t, n) {
  let r = Y(e, t, n, { type: 5 });
  return (cu(e, r), ou(e, t, n, lu(e, t, r, n, iu(e, t, n)), fu(e, t, n.separator, n)));
}
function eu(e, t, n) {
...
function tu(e, t, n) {
  let r = Y(e, t, n, { type: 4 });
  return (cu(e, r), au(e, t, n, lu(e, t, r, n, iu(e, t, n)), fu(e, t, n.separator, n)));
}
function nu(e, t, n) {
...
function au(e, t, n, r, i) {
  ...
  return (
    (a.loopback = s),
    (c.loopback = s),
    (e.decisionMap[Jl(t, i ? `RepetitionMandatoryWithSeparator` : `RepetitionMandatory`, n.idx)] =
      s),
    J(o, s),
...
function ou(e, t, n, r, i) {
  ...
  return (
    ...
    (e.decisionMap[Jl(t, i ? `RepetitionWithSeparator` : `Repetition`, n.idx)] = s),
    { left: s, right: c }
  );
}
function su(e, t, n, r) {
...
function Au(e, t, n, r) {
  ...
  for (;;) {
    let t = Iu(i, s);
    if ((t === void 0 && (t = ju.apply(this, [e, i, s, a, n, r])), t === Cu)) return Fu(o, i, s);
...
function Uu(e) {
  ...
  for (let r = 0; r < n; r++) Wu({ state: e.transitions[r].target, alt: r, stack: [] }, t);
  return t;
}
function Wu(e, t) {
  let n = e.state;
      ...
      (ed = class extends Wc {
        ...
        buildLookaheadForAlternation(e) {
          let { prodOccurrence: t, rule: n, hasPredicates: r, dynamicTokensEnabled: i } = e,
            ...
            l = fe(Fs({ maxLookahead: 1, occurrence: t, prodType: `Alternation`, rule: n }), (e) =>
              fe(e, (e) => e[0]),
            );
          if (Du(l, !1) && !i) {
            let e = Se(
        ...
        buildLookaheadForOptional(e) {
          let { prodOccurrence: t, rule: n, prodType: r, dynamicTokensEnabled: i } = e,
            ...
            s = Jl(n, r, t),
            c = this.atn.decisionMap[s].decision,
            l = fe(Fs({ maxLookahead: 1, occurrence: t, prodType: r, rule: n }), (e) =>
              fe(e, (e) => e[0]),
            );
          if (Du(l) && l[0][0] && !i) {
            let e = l[0],
    ...
    (Me(),
      ...
      (rd = class {
        ...
        addHiddenNodes(e) {
          let t = [];
          for (let n of e) {
            let e = new ad(n.startOffset, n.image.length, tt(n), n.tokenType, !0);
  ...
  xd = t(() => {
    (ql(),
      ...
      (hd = class extends md {
        ...
        rule(e, t) {
          let n = this.computeRuleType(e),
            r = this.wrapper.DEFINE_RULE(pd(e.name), this.startImplementation(n, t).bind(this));
        ...
        consume(e, t, n) {
          ...
          if (!this.isRecording() && this.isValidToken(r)) {
            ...
            if (i) {
              ...
              let e = r.image;
              (ln(n) || (e = this.converter.convert(e, t).toString()), (o.value += e));
            }
          }
        }
        isValidToken(e) {
        ...
        construct() {
          ...
          return (
            ...
            this.stack.pop(),
            ud(e) ? this.converter.convert(e.value, e.$cstNode) : (Er(this.astReflection, e), e)
          );
        }
        getAssignment(e) {
          if (!this.assignmentMap.has(e)) {
            let t = gr(e, rn);
            this.assignmentMap.set(e, { assignment: t, isCrossRef: t ? on(t.terminal) : !1 });
          }
        ...
        assign(e, t, n, r, i) {
          let a = this.current,
            o;
          switch (
            ((o = i && typeof n == `string` ? this.linker.buildReference(a, t, r, n) : n), e)
          ) {
            case `=`:
              a[t] = o;
              break;
      ...
      (vd = class extends md {
        ...
        rule(e, t) {
          let n = this.wrapper.DEFINE_RULE(pd(e.name), this.startImplementation(t).bind(this));
...
function Nd(e, t, n = t.terminal) {
  if (!n) {
    ...
    if (!n) throw Error(`Could not find name assignment for type: ` + Ni(t.type.ref));
    return Nd(e, t, n);
...
function Ld(e, t) {
  ...
  if (e.ruleNames.has(t)) return e.ruleNames.get(t);
  {
    let n = t,
      ...
      i = t.$type;
    for (; !Kt(r); )
      ((cn(r) || nn(r) || gn(r)) && (i = r.elements.indexOf(n).toString() + `:` + i),
        (n = r),
        (r = r.$container));
      ...
      (Gd = class {
        ...
        buildTokens(e, t) {
          ...
          return (
            r.forEach((e) => {
              let t = e.PATTERN;
              typeof t == `object` && t && `test` in t && Zr(t) ? i.unshift(e) : i.push(e);
            }),
            i
          );
        }
        ...
        findLongerAlt(e, t) {
          return t.reduce((t, n) => {
            let r = n?.PATTERN;
            return (r?.source && ei(`^` + r.source + `$`, e.value) && t.push(n), t);
          }, []);
        }
      }));
  }),
...
async function Z(e) {
  ...
  if ((t - tf >= nf && ((tf = t), await Zd(), (tf = performance.now())), e.isCancellationRequested))
    throw rf;
}
var tf,
  nf,
      ...
      ((() => {
        ...
        class c {
          ...
          static parse(e, t = !1) {
            let n = s.exec(e);
            return n
              ? new u(n[2] || ``, _(n[4] || ``), _(n[5] || ``), _(n[7] || ``), _(n[9] || ``), t)
              : new u(``, ``, ``, ``, ``);
          }
          static file(t) {
            let n = ``;
          ...
          static revive(e) {
            if (e) {
              if (e instanceof c) return e;
              {
                let t = new u(e);
                return (
                  (t._formatted = e.external), (t._fsPath = e._sep === l ? e.fsPath : null), t
                );
              }
            }
            return e;
        ...
        class u extends c {
          ...
          toString(e = !1) {
            return e ? ee(this, !0) : ((this._formatted ||= ee(this, !1)), this._formatted);
          }
          toJSON() {
            let e = { $mid: 1 };
            return (
        ...
        (function (e) {
          ((e.joinPath = function (e, ...t) {
            ...
            (e.resolvePath = function (e, ...t) {
              ...
              let i = y.resolve(n, ...t);
              return (
                r && i[0] === `/` && !e.authority && (i = i.substring(1)), e.with({ path: i })
              );
            }),
    ...
    (Ne(),
      ...
      (pf = class {
        ...
        fromTextDocument(e, t, n) {
          return (
            (t ??= cf.parse(e.uri)),
            X.CancellationToken.is(n) ? this.createAsync(t, e, n) : this.create(t, e, n)
          );
        }
        fromString(e, t, n) {
          return X.CancellationToken.is(n) ? this.createAsync(t, e, n) : this.create(t, e, n);
        }
        fromModel(e, t) {
        ...
        createLangiumDocument(e, t, n, r) {
          let i;
          if (n) i = { parseResult: e, uri: t, state: Q.Parsed, references: [], textDocument: n };
          else {
...
var bf,
    ...
    (qi(),
      ...
      (Sf = class {
        ...
        findReferences(e, t) {
          ...
          return (
            t.documentUri && (r = r.filter((e) => df.equals(e.sourceUri, t.documentUri))),
            n.push(...r),
            j(n)
          );
        }
  ...
  Of = t(() => {
    (Xd(),
      ...
      (Df = class {
        ...
        async computeExportsForNode(e, t, n = br, r = X.CancellationToken.None) {
          let i = [];
  ...
  Mf = t(() => {
    (Xe(),
      ...
      (Af = class {
        constructor(e, t, n) {
          ((this.elements = new Map()), (this.caseInsensitive = n?.caseInsensitive ?? !1));
          for (let t of e) {
      ...
      (zf = class {
        ...
        getScope(e) {
          ...
          if (r) {
            ...
            do {
              let e = r.get(i);
              (e.length > 0 && t.push(j(e).filter((e) => this.reflection.isSubtype(e.type, n))),
                (i = i.$container));
            } while (i);
          }
        ...
        getGlobalScope(e, t) {
          return this.globalScopeCache.get(e, () => new Af(this.indexManager.allElements(e)));
        }
      }));
  });
function Vf(e) {
      ...
      (Uf = class {
        ...
        serialize(e, t) {
          let n = t ?? {},
            ...
            a = r ? (e, t) => r(e, t, i) : i;
          try {
            return ((this.currentDocument = vr(e)), JSON.stringify(e, a, t?.space));
          } finally {
          ...
          if (!this.ignoreProperties.has(e))
            if (Ie(t)) {
              ...
              if (
                ...
                r && !e && ((n ??= Object.assign({}, t)), (n.$sourceText = t.$cstNode?.text)),
                a)
              ) {
                n ??= Object.assign({}, t);
        ...
        reviveReference(e, t, n, r, i) {
          ...
          if (r.$ref) {
            ...
            if (A(e)) return ((a ||= this.nameProvider.getName(e)), { $refText: a ?? ``, ref: e });
            o = e;
          }
          if (o) {
            let n = { $refText: a ?? `` };
            return ((n.error = { container: e, property: t, message: o, reference: n }), n);
          } else return;
        }
        getRefNode(e, t, n) {
          try {
...
function Zf(e) {
  ...
  return (
    typeof e.property == `string`
      ...
      : typeof e.keyword == `string` && (t = yi(e.node.$cstNode, e.keyword, e.index)),
    (t ??= e.node.$cstNode),
        ...
        async validateDocument(e, t = {}, n = X.CancellationToken.None) {
          ...
          if (
            ...
            (!t.categories || t.categories.includes(`built-in`)) &&
              ...
              (t.stopAfterLexingErrors && i.some((e) => e.data?.code === tp.LexingError)) ||
                (this.processParsingErrors(r, i, t),
                t.stopAfterParsingErrors && i.some((e) => e.data?.code === tp.ParsingError)) ||
                (this.processLinkingErrors(e, i, t),
                t.stopAfterLinkingErrors && i.some((e) => e.data?.code === tp.LinkingError))))
          )
            return i;
          try {
    ...
    (Xd(),
      ...
      (rp = class {
        ...
        createDescription(e, t, n) {
          ...
          let a,
            o = () => (a ??= nt(this.nameProvider.getNameNode(e) ?? e.$cstNode));
          return {
            node: e,
            name: t,
            get nameSegment() {
      ...
      (mp = class {
          ...
          for (let n of e) {
            ...
            if (n.state === Q.Validated) {
              if (typeof t.validation == `boolean` && t.validation)
                ...
                if (i) {
                  let a = (t.validation.categories ?? Jf.all).filter((e) => !i.includes(e));
                  a.length > 0 &&
        ...
        async update(e, t, n = X.CancellationToken.None) {
          ...
          let i = this.sortDocuments(
            this.langiumDocuments.all
              .filter(
                (e) => e.state < Q.Linked || !this.buildState.get(e.uri.toString())?.completed,
              )
              .toArray(),
          );
        ...
        async runCancelable(e, t, n, r) {
          ...
          for (let e of i)
            (await Z(n), await r(e), (e.state = t), await this.notifyDocumentPhase(e, t, n));
        ...
        waitUntil(e, t, n) {
          let r;
          if ((t && `path` in t ? (r = t) : (n = t), (n ??= X.CancellationToken.None), r)) {
    ...
    (Xd(),
      ...
      (vp = class {
        ...
        async initializeWorkspace(e, t = X.CancellationToken.None) {
          ...
          (await Z(t), await this.documentBuilder.build(n, this.initialBuildOptions, t));
        }
        async performStartup(e) {
          let t = this.serviceRegistry.all.flatMap((e) => e.LanguageMetaData.fileExtensions),
            n = [],
            r = (e) => {
              (n.push(e),
            ...
            i.map(async (t) => {
              this.includeEntry(e, t, n) &&
                (t.isDirectory
                  ...
                  : t.isFile && r(await this.langiumDocuments.getOrCreateDocument(t.uri)));
            }),
          );
        }
        includeEntry(e, t, n) {
...
function Dp(e, t, n) {
  ...
  let a = kp(e),
    o = Vp(r);
  return Pp({ index: 0, tokens: Ap({ lines: a, position: i, options: o }), position: i });
}
function Op(e, t) {
  let n = Vp(t),
    r = kp(e);
    ...
    for (let o of e) {
      ...
      if (
        (i.push({
          type: `inline-tag`,
          content: l,
          range: Ae.create(k.create(n, a + c + r), k.create(n, a + c + l.length + r)),
        }),
        (c += l.length),
        o.length === 4)
      ) {
        ...
        i.push({
          type: `text`,
          content: e,
          range: Ae.create(k.create(n, a + c + r), k.create(n, a + c + e.length + r)),
        });
      } else
        i.push({
          type: `text`,
...
function zp(e, t) {
  ...
  if (e.tokens[e.index]?.type === `text`)
    if (t) {
      let i = Bp(e);
      return new Zp(r, new Qp([i], i.range), t, Ae.create(n.range.start, i.range.end));
    } else {
      let i = Lp(e);
    ...
    (ld(),
      ...
      (dm = class {
        ...
        createGrammarElementIdMap() {
          let e = 0;
          for (let t of Sr(this.grammar)) jt(t) && this.grammarElementIdMap.set(t, e++);
        }
      }));
  });
function pm(e) {
  return {
    documentation: { CommentProvider: (e) => new rm(e), DocumentationProvider: (e) => new tm(e) },
    parser: {
    ...
    serializer: { Hydrator: (e) => new dm(e), JsonSerializer: (e) => new Uf(e) },
    validation: { DocumentValidator: (e) => new ep(e), ValidationRegistry: (e) => new Yf(e) },
    shared: () => e.shared,
  };
}
function mm(e) {
    ...
    (ql(),
      ...
      (jm = class extends Gd {
        ...
        buildTokens(e, t) {
          ...
          return o.length > 0
            ? {
                modes: { [Am.REGULAR]: [s, c, ...u, l], [Am.IGNORE_INDENTATION]: [...u, l] },
        ...
        buildTerminalToken(e) {
          ...
          return t.name === n
            ...
            : t.name === r
              ...
              : t.name === i
                ? ts({ name: i, pattern: this.whitespaceRegExp, group: G.SKIPPED })
                : t;
        }
...
var Um,
  ...
  qm = t(() => {
    (Rf(), lp(), e(Km, cp), Ef(), pp(), St(), Gm(), of(), Xe(), ff(), kr(), Xd(), yt(), qi(), si());
  }),
  Jm = t(() => {
    (np(), Xf());
  }),
  ...
  Zm = t(() => {
    (hm(), wm(), Kf(), Tm(), Ue(), Em(), Om(), Fm(), Im(), Lm(), qm(), e(Xm, Km), Jm(), Ym(), pr());
  });
function Qm(e) {
      ...
      (Rh = class extends He {
        ...
        getTypeMetaData(e) {
          switch (e) {
            ...
            case fh:
              return { name: fh, properties: [{ name: `label` }, { name: `name` }] };
            case ph:
              return { name: ph, properties: [{ name: `name` }, { name: `order` }] };
            case mh:
            ...
            case gh:
              return { name: gh, properties: [{ name: `className` }, { name: `styleText` }] };
            case _h:
              return {
                name: _h,
                properties: [
            ...
            case bh:
              return { name: bh, properties: [{ name: `axis` }, { name: `value` }] };
            case xh:
              return {
                name: xh,
                properties: [
            ...
            case wh:
              return { name: wh, properties: [{ name: `classSelector` }, { name: `name` }] };
            case Th:
            ...
            case Ah:
              return { name: Ah, properties: [{ name: `label` }, { name: `value` }] };
            case jh:
              return {
                name: jh,
                properties: [
            ...
            case Ph:
              return { name: Ph, properties: [{ name: `indent` }, { name: `item` }] };
            case Fh:
              return {
                name: Fh,
                properties: [
            ...
            case Lh:
              return { name: Lh, properties: [{ name: `classSelector` }, { name: `name` }] };
            default:
              return { name: e, properties: [] };
          }
        }
