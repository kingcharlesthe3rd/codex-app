...
var ht,
  gt = e(() => {
    (Qe(), (ht = ue(`codex-sidebar-chat-order-v1`, void 0)));
  }),
  _t,
  vt,
  yt,
  ...
  Ct = e(() => {
    (S(),
      ...
      me(),
      (_t = g(h, () => !0)),
      (vt = g(h, ({ get: e }) => e(_t) && e(be, e(We)).kind === `local`)),
      (yt = g(h, ({ get: e }) => e(x, `824038554`) || e(x, `12346831`))),
      (bt = g(h, ({ get: e }) => {
        let t = e(Je, e(We)).data?.config,
          n = e(x, `4114442250`);
      ...
      (xt = g(h, ({ get: e }) =>
        e(bt) ? e(Pe).filter((t) => e(a, t.hostId) === `connected`) : [],
      )),
      (z = g(h, ({ get: e }) => e(xt).length > 0)),
      (St = f(h, ({ localProjectActionsEnabled: e }, { get: t }) => {
        let n = t(z),
          r = t(Ge);
...
function Tt({ tasks: e, order: t }) {
  return t == null ? e : Et(e, t.sortKey == null ? t : At(e, t.sortKey));
}
function Et(e, t) {
  let n = new Map();
  for (let t of e) {
...
function Dt({ order: e, tasks: t, visibleThreadIds: n, nextVisibleThreadIds: r }) {
  return {
    threadIds: it({
      threadIds: (e == null
        ? wt(t)
...
function Ot({ order: e, tasks: t, threadId: n, beforeThreadId: r }) {
  let i = e == null ? B(t) : kt({ order: e, tasks: t }).threadIds,
    a = i.filter((e) => e !== n),
    o = r == null ? 0 : a.indexOf(r),
    s = o === -1 ? a.length : o,
    c = [...a.slice(0, s), n, ...a.slice(s)];
  return at(i, c) ? { threadIds: i } : { threadIds: c };
}
function kt({ order: e, tasks: t }) {
  let n = Mt(e.threadIds, B(t));
...
function At(e, t) {
  return {
    threadIds: B(
      e
        .flatMap((e, n) => (V(e) == null ? [] : [{ task: e, timestamp: jt(e, t), index: n }]))
...
function Ft(e) {
  return [...e].sort(
    (e, t) => It[e.attentionState] - It[t.attentionState] || t.recencyAt - e.recencyAt,
  );
}
var It,
  Lt = e(() => {
    It = { waiting: 0, unread: 1, active: 2, idle: 3 };
  });
function Rt({ projectSidebarEnabled: e, organizeMode: t, showProjectsTitle: n, showRecent: r }) {
  return e
    ? r
      ? (0, H.jsx)(v, {
...
function zt({ projectSidebarEnabled: e, organizeMode: t, showProjectsTitle: n, showRecent: r }) {
  return e
    ? r
      ? `All chats`
      : t === `connection`
...
function Vt(e, t) {
  return e
    ...
    .sort((e, n) => {
      let r = Wt(e.group.threadKeys, t)[0]?.at ?? -1 / 0,
        i = Wt(n.group.threadKeys, t)[0]?.at ?? -1 / 0;
...
function Wt(e, t) {
  return Ut(e, t).map((e) => e.task);
}
function Gt({ defaultProjectLabel: e, projectLabel: t, repositoryLabel: n }) {
...
function Kt({
  ...
  if (t.kind === `local`)
    return { isProjectless: !1, label: (t.conversation.cwd ? M(t.conversation.cwd) : ``) || e };
  if (t.kind === `remote`)
  ...
  return { isProjectless: !1, label: o ? M(o) : e };
}
var H,
  qt = e(() => {
    (ae(), P(), (H = qe()));
...
function Yt({ items: e, projectlessThreadIds: t }) {
  return e.filter((e) => {
    switch (e.task.kind) {
      case `local`:
        return (
...
function Qt(e, t) {
  ...
  let r = e(i, t);
  return r == null ? !1 : r === 0 ? n === `resuming` : e(_, t) === `inProgress`;
}
var $t,
  U,
  en,
  ...
  pn = e(() => {
    (S(),
      ...
      P(),
      ($t = []),
      (U = g(h, ({ get: e }) => e(pt).data?.threadIds ?? $t)),
      (en = g(h, ({ get: e }) => {
        let t = l(e, N.THREAD_PROJECT_ASSIGNMENTS),
          n = l(e, N.PROJECTLESS_THREAD_IDS);
        return e(we, {
          threadKeys: e(w),
          enabled: !0,
      ...
      (W = f(h, (e, { get: t }) => t(en).find((t) => t.threadKeys.includes(e)) ?? null)),
      (tn = f(h, (e, { get: t }) => {
        let n = t(j, e);
        return n?.kind === `local`
          ? l(t, N.THREAD_PROJECT_ASSIGNMENTS)?.[n.conversation.id]
          : void 0;
      })),
      (nn = g(h, ({ get: e }) => Xt(e(en)))),
      (G = f(h, (e, { get: t }) => {
        let n = Be(e);
        switch (n?.kind) {
          case `pending-worktree`:
            return t(se, n.pendingWorktreeId)?.isPinned === !0;
          case `local`:
          case `remote`: {
            let n = Ye(e);
            return n != null && t(U).includes(n);
          }
          case void 0:
            return !1;
        }
      ...
      (rn = f(h, (e, { get: t }) => {
        let n = Re(e);
        return n != null && t(C).automationThreadIds.has(n);
      })),
      (an = f(h, (e, { get: t }) => {
        let n = Re(e);
        return n == null ? null : (t(C).automationDisplayNames.get(n) ?? null);
      })),
      (on = f(
        h,
        (e, { get: t }) => {
          ...
          let r = l(t, N.PROJECTLESS_THREAD_IDS);
          return Kt({
            chatLabel: t(R).formatMessage({
            ...
            showProjectlessHoverCard: t(yt),
          });
        },
        { isEqual: (e, t) => e?.isProjectless === t?.isProjectless && e?.label === t?.label },
      )),
      (sn = f(h, (e, { get: t }) => t(W, e)?.projectId ?? null)),
      (cn = f(h, (e, { get: t }) => {
        let n = t(W, e)?.hostId;
        if (n == null) return null;
        let r = t(be, n);
      ...
      (ln = f(h, (e, { get: t }) => {
        let n = t(j, e);
        return n?.kind === `local`
          ? ge({ cwd: n.conversation.cwd ?? null, assignment: t(tn, e) })
          : null;
      })),
      (un = f(h, (e, { get: t }) => {
        let n = t(W, e),
        ...
        if (
          ...
          let n = r.conversation.gitInfo.originUrl,
            a = t(ln, e);
          (n != null && (i = ie(n)?.repoName ?? null),
            i == null && a != null && !te(a) && (i = M(a)));
        }
        return Gt({
          defaultProjectLabel: n?.path == null ? i : M(n.path),
          projectLabel: n?.label ?? null,
          repositoryLabel: i,
        });
      })),
      (dn = f(h, (e, { get: t }) =>
        e == null ? null : (l(t, N.THREAD_WORKSPACE_ROOT_HINTS)?.[e] ?? null),
      )),
      (fn = f(h, (e, { get: t }) =>
        e == null ? null : (l(t, N.SIDEBAR_THREAD_METADATA)?.[e]?.labelColor ?? null),
      )));
  });
function mn(e, t) {
...
function hn(e, t) {
  let n = gn(e.allSidebarThreadKeys, t.allSidebarThreadKeys),
    r = gn(e.pinnedThreadKeys, t.pinnedThreadKeys),
    i = gn(e.unpinnedThreadKeys, t.unpinnedThreadKeys);
...
function _n({ get: e, threadKeys: t, pinnedThreadIds: n }) {
  if (t.length === 0) return bn;
  let r = new Set(t),
    i = [];
  for (let n of t) Be(n)?.kind === `pending-worktree` && e(G, n) && i.push(n);
  for (let e of n) {
    let t = Ve(o(e));
    if (r.has(t)) {
      i.push(t);
  ...
  return { allSidebarThreadKeys: [...i, ...c], pinnedThreadKeys: i, unpinnedThreadKeys: c };
}
var vn,
  yn,
  bn,
  ...
  wn = e(() => {
    (S(),
      ...
      (vn = []),
      (yn = []),
      (bn = { allSidebarThreadKeys: yn, pinnedThreadKeys: yn, unpinnedThreadKeys: yn }),
      (xn = new WeakMap()),
      (Sn = g(h, ({ get: e, scope: t }) => {
        let n = hn(xn.get(t.node) ?? bn, _n({ get: e, threadKeys: e(w), pinnedThreadIds: e(U) }));
        return (xn.set(t.node, n), n);
      })),
      (Cn = f(
        h,
        (e, { get: t }) =>
                  ...
                  : [
                      {
                        task: n,
                        isPinned: t(G, e),
                        isAutomationRun: t(rn, e),
                        automationDisplayName: t(an, e),
                      },
                    ];
              }),
        { isEqual: mn },
...
function Dn(e, t) {
  let n = e.get(Me),
    r = e.get(de);
  (!e.get(Z).initialized && n === `recent` && !r && e.set(X, (e) => e ?? `updated_at`),
    e.set(Y, (e) => En(Tn(e, n, r), t, n)));
}
function On({
  enabled: e,
...
function kn(e, t) {
  e.set(Y, (e) => ({ ...(e ?? J), initialized: !0, mode: t }));
}
function An(e, t) {
  e.set(Y, (e) => ({ ...J, ...e, chatSortMode: t }));
}
function jn(e, t) {
  e.set(X, t);
}
function Mn(e, t) {
  let n = e.get(Z).projectSortMode;
  (e.set(X, (e) => e ?? n), e.set(Y, (e) => ({ ...J, ...e, projectSortMode: t })));
}
function Nn({
  aeonThreadKeys: e,
...
function Pn({ pinnedProjectGroups: e, threadKeys: t }) {
  let n = new Set(e.flatMap((e) => e.threadKeys));
  return t.filter((e) => !n.has(e));
}
function Fn({ groups: e, items: t }) {
...
function In({ groups: e, items: t, projectOrder: n }) {
  let r = new Map(t.map((e) => [e.task.key, e.recencyAt]));
  return Ae(
    e
      .map((e, t) => ({ group: e, index: t, recencyAt: Bn(e, r) }))
      .sort((e, t) => t.recencyAt - e.recencyAt || e.index - t.index)
      .map(({ group: e }) => e),
    n,
  );
}
function Ln({ items: e, attentionStateByThreadKey: t, unreadThreadKeys: n }) {
  return Ft(
    e.map((e) => ({
      item: e,
      attentionState: zn(t.get(e.task.key) ?? `idle`, n.has(e.task.key)),
...
function Rn({
  ...
  return r === `priority`
    ? Ln({ attentionStateByThreadKey: e, items: t, unreadThreadKeys: i })
    : r === `manual`
      ? Tt({
...
function Vn({ items: e, projectGroups: t, projectlessThreadIds: n }) {
  let r = new Set(t.flatMap((e) => e.threadKeys));
  return Hn(e.filter((e) => !e.isPinned && qn(e, n) && !r.has(e.task.key)));
}
function Hn(e) {
  return e
...
function Un(e, t) {
  return e(Cn, t).map((t) => ({ ...t, recencyAt: Wn(e, t) }));
}
function Wn(e, t) {
  switch (t.task.kind) {
    case `local`:
      return (
        e(Fe, t.task.conversation.id) ??
...
function Gn(e, t) {
  ...
  e.connectionGroups != null &&
    ...
    (n = Se(e.connectionGroups, t.connectionGroups));
  let r = K(e.projectGroups, t.projectGroups),
    i = K(e.pinnedProjectThreadKeys, t.pinnedProjectThreadKeys),
    a = K(e.projectlessThreadKeys, t.projectlessThreadKeys),
    o = K(e.shortcutThreadKeys, t.shortcutThreadKeys),
    s = K(e.threadKeys, t.threadKeys),
    c = Kn(e.threadAttentionStateByKey, t.threadAttentionStateByKey),
    l = Kn(e.threadRecencyAtByKey, t.threadRecencyAtByKey),
    u = K(e.navigationThreadKeys, t.navigationThreadKeys);
...
var Jn,
  ...
  ir = e(() => {
    (S(),
      ...
      (Zn = {
        ...
        navigationThreadKeys: q,
        pinnedProjectThreadKeys: q,
        projectCount: 0,
        projectGroups: Jn,
        projectlessThreadKeys: q,
        shortcutThreadKeys: q,
        threadAttentionStateByKey: Yn,
        threadRecencyAtByKey: Xn,
        threadKeys: q,
      }),
      (Qn = new WeakMap()),
      ($n = 9),
      (Y = ue(`flat-project-sidebar-preferences-v1`, J)),
      (X = ue(`codex-sidebar-sort-mode-v1`, void 0)),
      (Z = g(h, ({ get: e }) => Tn(e(Y), e(Me), e(de)))),
      (er = g(h, ({ get: e }) => e(X) ?? e(Z).projectSortMode)),
      (tr = g(h, ({ get: e }) => {
        let t = e(Z).mode;
        return t === `connection` && !e(z) ? `project` : t;
      })),
      (nr = g(
        h,
        ({ get: e }) => l(e, N.ACTIVE_REMOTE_PROJECT_ID) ?? e(ze).data?.roots?.[0] ?? null,
      )),
      (rr = g(h, ({ get: e, scope: t }) => {
        let { allSidebarThreadKeys: n, pinnedThreadKeys: r } = e(Sn),
          i = q,
          a = n,
          o = Un(e, a),
          s = new Map(n.map((t) => [t, e(oe, t)])),
          c = new Set(n.filter((t) => e(y, t))),
          u = new Map(n.map((e) => [e, zn(s.get(e) ?? `idle`, c.has(e))])),
          d = o.flatMap((e) => (e.task.kind === `local` ? [e.task.conversation.id] : [])),
          f = l(e, N.SIDEBAR_PROJECT_THREAD_ORDERS),
          { projectlessThreadIds: p, threadProjectAssignments: m } = Te(e, {
            conversationIds: d,
            projectlessThreadIds: l(e, N.PROJECTLESS_THREAD_IDS),
            threadProjectAssignments: l(e, N.THREAD_PROJECT_ASSIGNMENTS),
          }),
          h = l(e, N.PINNED_PROJECT_IDS),
          g = e(we, {
            threadKeys: a,
            enabled: !0,
            threadProjectAssignments: m,
            projectlessThreadIds: p,
          }),
          { groups: _, isWorkspaceRootOptionsLoading: v } = g,
          { pinnedGroups: b, unpinnedGroups: x } = Oe(_, h),
          S = Fn({ groups: b, items: o }),
          C = In({
            groups: Fn({ groups: x, items: o }),
            items: o,
            projectOrder: l(e, N.PROJECT_ORDER),
          }),
          w = Vn({ items: o, projectGroups: _, projectlessThreadIds: new Set(p ?? []) }),
          T = new Map(o.map((e) => [e.task.key, e])),
          E = e(er),
          D = e(ht) ?? null;
        ((C = C.map((e) => {
          let t = Rn({
        ...
        let O = Rn({
          ...
          k = e(tr),
          ee = Pn({ pinnedProjectGroups: b, threadKeys: O }),
          te =
            k === `connection`
              ? je({
                  connectionGroupOrder: l(e, N.CONNECTION_GROUP_ORDER),
                  groups: e(ce, ee),
                  includeEmptyGroup: e(vt),
                })
              : void 0,
          ne = S.flatMap((e) =>
            Rn({
          ...
          re = C.slice(0, 5).flatMap((e) => e.threadKeys),
          ie = Nn({
            aeonThreadKeys: i,
            connectionThreadKeys: te?.flatMap((e) => e.threadKeys),
            mode: k,
            pinnedProjectThreadKeys: ne,
            pinnedThreadKeys: r,
            projectlessThreadKeys: w,
            projectThreadKeys: re,
            threadKeys: O,
          }),
          ae = {
            connectionGroups: te,
            ...
            navigationThreadKeys: ie,
            pinnedProjectThreadKeys: ne,
            projectCount: _.length,
            projectGroups: C,
            projectlessThreadKeys: w,
            shortcutThreadKeys: ie.slice(0, $n),
            threadAttentionStateByKey: u,
            threadRecencyAtByKey: new Map(o.map((e) => [e.task.key, e.recencyAt])),
            threadKeys: O,
          },
          A = Gn(Qn.get(t.node) ?? Zn, ae);
        return (Qn.set(t.node, A), A);
      })));
  }),
  ar,
  or,
  ...
  cr = e(() => {
    (ot(),
      ...
      (or = ar.fromCwd$),
      (sr = ar.queryByMetadata$));
  });
function lr(e) {
  return (
    e.find((e) => fr(e.configPath) === `environment.toml` && e.type === `success`) ||
    e.find((e) => e.type === `success`) ||
    (e[0] ?? null)
  );
}
function ur(e) {
  return lr(e)?.configPath ?? null;
}
function dr(e, t) {
  let n = xe(I(t), `.codex/environments`),
    r = new Set(e.map((e) => I(e.configPath))),
    i = xe(n, Ie);
  if (!r.has(I(i))) return i;
  let a = 2;
  for (;;) {
    let e = xe(n, `environment-${a}.toml`);
...
function _r({
  ...
  let a = hr(i, n),
    { defaultEnvironment: o, defaultEnvironmentNormalized: s, availableEnvironments: c } = mr(t),
    l = o?.configPath ?? null,
...
function yr(e) {
  let t = (0, xr.c)(37),
    ...
    [i, a] = et(Sr),
    o;
  t[0] !== n || t[1] !== r ? ((o = hr(r, n)), (t[0] = n), (t[1] = r), (t[2] = o)) : (o = t[2]);
  let s = o,
    c = r ?? ``,
    l;
  t[3] !== n || t[4] !== c
  ...
  let f;
  t[8] !== l || t[9] !== d
    ? ((f = { params: l, queryConfig: d, select: br }), (t[8] = l), (t[9] = d), (t[10] = f))
    : (f = t[10]);
  let { data: p, isLoading: m, isFetching: h, error: g } = Ne(`local-environments`, f),
    _,
    v;
  t[11] !== g ||
  t[12] !== n ||
...
var xr,
  ...
  Cr = e(() => {
    ((xr = Ee()),
      ...
      O(),
      c(),
      (Sr = ve(`local-env-selections-by-workspace`, {})));
  });
async function wr(e, { sourceConversationId: t, sourceWorkspaceRoot: n }) {
  if (t == null) return null;
  try {
    let r = e.get(T, t),
      i = Er(e, t),
      a = await _e(`fork-conversation-from-latest`, {
        hostId: r,
        conversationId: t,
        cwd: n ?? void 0,
    ...
    return (ct(e, { sourceConversationId: t, targetConversationId: a }), a);
  } catch (t) {
    return (
      b.error(`Error forking local task`, { safe: {}, sensitive: { error: t } }),
      e.get(Ke).danger(e.get(R).formatMessage(L.forkThreadError)),
      null
    );
  }
}
async function Tr(
  e,
  { localEnvironmentSelectionsByWorkspace: t, sourceConversationId: n, sourceWorkspaceRoot: r },
) {
  if (n == null || r == null) return null;
  let i = e.get(T, n),
    a = await m(`git-origins`, {
      params: { dirs: [r], hostId: i },
      source: `fork_conversation_actions`,
    });
  if ((a.origins.find((e) => e.dir === r)?.root ?? a.origins[0]?.root ?? null) == null)
    return (e.get(Ke).danger(e.get(R).formatMessage(L.forkThreadRequiresGitRepo)), null);
  let o = await Dr({ hostId: i, localEnvironmentSelectionsByWorkspace: t, sourceWorkspaceRoot: r }),
    s = e.get(R),
    c = Er(e, n),
    l = ft({
      hostId: i,
      label: s.formatMessage(L.forkPendingWorktreeTitle),
      sourceWorkspaceRoot: r,
      startingState: { type: `working-tree` },
      localEnvironmentConfigPath: o,
      launchMode: `fork-conversation`,
      prompt: s.formatMessage(L.forkPendingWorktreePrompt),
      startConversationParamsInput: null,
      sourceConversationId: n,
      sourceCollaborationMode: c,
      targetTurnId: null,
    });
  return (dt(e, { pendingWorktreeId: l, sourceConversationId: n, sourceWorkspaceRoot: r }), l);
}
function Er(e, t) {
  return e.get(ye, t) == null ? e.get(Ce, t) : null;
}
async function Dr({ hostId: e, localEnvironmentSelectionsByWorkspace: t, sourceWorkspaceRoot: n }) {
  let r = e ?? `local`;
  try {
    let { environments: e } = await m(`local-environments`, {
