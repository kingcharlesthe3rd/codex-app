...
import { a as g, o as _ } from "./plugin-detail-page-utils.js";
function v(e) {
...
function S(e) {
  return e.some(
    (e) =>
      x(e.marketplaceName) || (e.marketplaceDisplayName != null && x(e.marketplaceDisplayName)),
  );
}
function C(e) {
  return l(e.marketplaceName) || (e.marketplaceDisplayName != null && l(e.marketplaceDisplayName));
}
function w(e, t) {
    ...
    i.trim().length !== 0 &&
      (t.has(e) ||
        ...
        n.push({
          label: b(i),
          subLabelSource:
            r.marketplacePath == null ? r.remoteMarketplaceName : O(r.marketplacePath),
          value: e,
        })));
  }
  let r = new Map(),
...
function M({
  ...
  let i = t.filter((e) =>
    w(r, E(e))
      ? n == null
        ? !0
        : s(e) === n && (e.marketplaceDisplayName?.trim() || e.marketplaceName).trim().length > 0
      : !1,
  );
  if (!e) return V(i);
  let a = new Map();
  for (let e of i) {
    let t = e.plugin.remotePluginId ?? e.plugin.shareContext?.remotePluginId,
      n = t == null ? `plugin:${s(e)}:${e.plugin.id}` : `remote:${t}`,
      r = a.get(n);
...
function N(e) {
  return e.filter((e) => {
    let t = i(e.plugin.id);
    return e.plugin.name !== `browser` || t == null || !d(t);
  });
}
function P(e) {
  return e.find((e) => e.plugin.name === `record-and-replay` && d(e.marketplaceName)) ?? null;
}
function F({
  availablePlugins: e,
  ...
  let a = e.find((e) => _(n, e.marketplacePath)),
    o = a == null ? null : s(a),
    c = i.filter((e) => o != null && s(e) === o),
    l = I(t, r, c);
  return { marketplaceFilterValue: o, plugins: [...c, ...l], remotePlugins: l };
}
function I(e, t, n) {
  let r = new Set([
      ...n.flatMap((e) => {
  ...
  for (let { plugin: e } of t) {
    ...
    if (r.has(t)) continue;
    let n = i(e.id);
    if (n == null) throw Error(`remote plugin share ${e.id} is missing marketplace name`);
    (r.add(t),
      a.push({
        ...u(e),
...
function L({ installedPlugins: e, sharedWithYouPlugins: t, workspacePlugins: n }) {
...
function z({ categoryOrder: e = [], plugins: t, connectedPlugins: n = t, featuredPluginIds: r }) {
  ...
  return [
    ...(i.length > 0 ? [{ section: { id: `plugins-connected`, title: null }, plugins: i }] : []),
    ...(a.length > 0
...
function B(e) {
  return e.sort((e, t) => {
    let r = n(e.plugin);
    return r === n(t.plugin)
      ? r || e.plugin.installed === t.plugin.installed
        ? 0
        : e.plugin.installed
          ? 1
          : -1
...
export { P as a, L as c, N as d, C as i, D as l, S as n, F as o, K as r, M as s, b as t, z as u };
