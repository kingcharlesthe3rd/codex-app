...
function C(e) {
  return p(e.marketplaceName) || (e.marketplaceDisplayName != null && p(e.marketplaceDisplayName));
}
function w(e, t) {
...
function k(e) {
  let t = e.map((e) => d(e).replace(/\/+$/, ``).split(`/`).filter(Boolean)),
...
function M({
  ...
  let i = t.filter((e) =>
    w(r, E(e))
      ? n == null
        ? !0
        : c(e) === n && (e.marketplaceDisplayName?.trim() || e.marketplaceName).trim().length > 0
      : !1,
  );
  if (!e) return V(i);
  let a = new Map();
...
function P(e) {
  return e.find((e) => e.plugin.name === `record-and-replay` && o(e.marketplaceName)) ?? null;
}
function F({
  availablePlugins: e,
  ...
  let a = e.find((e) => _(n, e.marketplacePath)),
    o = a == null ? null : c(a),
    s = i.filter((e) => o != null && c(e) === o),
    l = I(t, r, s);
  return { marketplaceFilterValue: o, plugins: [...s, ...l], remotePlugins: l };
}
function I(e, t, n) {
  let i = new Set([
      ...n.flatMap((e) => {
