...
function C(e) {
  return u(e.marketplaceName) || (e.marketplaceDisplayName != null && u(e.marketplaceDisplayName));
}
function w(e, t) {
...
function N(e) {
  return e.filter((e) => {
    let t = c(e.plugin.id);
    return e.plugin.name !== `browser` || t == null || !r(t);
  });
}
function P(e) {
  return e.find((e) => e.plugin.name === `record-and-replay` && r(e.marketplaceName)) ?? null;
}
function F({
  availablePlugins: e,
