...
function C(e) {
  return d(e.marketplaceName) || (e.marketplaceDisplayName != null && d(e.marketplaceDisplayName));
}
function w(e, t) {
...
function M({
  ...
  let i = t.filter((e) =>
    w(r, E(e))
      ? n == null
        ? !0
        : u(e) === n && (e.marketplaceDisplayName?.trim() || e.marketplaceName).trim().length > 0
      : !1,
  );
  if (!e) return V(i);
  let a = new Map();
...
function N(e) {
  return e.filter((e) => {
    let t = i(e.plugin.id);
    return e.plugin.name !== `browser` || t == null || !s(t);
  });
}
function P(e) {
  return e.find((e) => e.plugin.name === `record-and-replay` && s(e.marketplaceName)) ?? null;
}
function F({
  availablePlugins: e,
