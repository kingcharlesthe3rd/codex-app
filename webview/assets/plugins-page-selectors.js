...
function C(e) {
  return f(e.marketplaceName) || (e.marketplaceDisplayName != null && f(e.marketplaceDisplayName));
}
function w(e, t) {
...
function M({
  ...
  let i = t.filter((e) =>
    w(r, E(e))
      ? n == null
        ? !0
        : p(e) === n && (e.marketplaceDisplayName?.trim() || e.marketplaceName).trim().length > 0
      : !1,
  );
  if (!e) return V(i);
  let a = new Map();
  for (let e of i) {
    let t = e.plugin.remotePluginId ?? e.plugin.shareContext?.remotePluginId,
      n = t == null ? `plugin:${p(e)}:${e.plugin.id}` : `remote:${t}`,
      r = a.get(n);
