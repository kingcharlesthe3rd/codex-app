...
import { a as r, g as i, m as a, o, s, t as c, z as l } from "./app-scope.js";
import {
  At as u,
  Mn as d,
  Mt as f,
...
import { j as x, ki as S } from "./src-2.js";
import { l as C, s as w } from "./lib.js";
import { t as T } from "./persisted-signal.js";
import { t as E } from "./clsx-Cir5-jBH.js";
import { t as D } from "./persisted-atom.js";
import { t as O } from "./button.js";
import { a as k, i as A } from "./setting-storage.js";
import { t as j } from "./x.js";
import { Ht as M, Ut as N, Wt as P, at as F, ot as I, st as L, t as R } from "./product-logger.js";
import { c as ee, o as te, u as ne } from "./statsig.js";
import { t as z } from "./request.js";
import { t as re } from "./app-intl-signal.js";
import { r as ie } from "./modal-controller-state.js";
...
import { r as ce } from "./remote-connection-visibility.js";
import { t as V } from "./use-auth.js";
import { t as le } from "./skus.js";
import { t as ue } from "./use-platform.js";
import { c as de } from "./apps-queries.js";
import { t as fe } from "./codex-Dw-qSlib.js";
import { t as pe } from "./use-model-settings.js";
import { n as me } from "./model-queries.js";
import { n as he } from "./use-webview-execution-target.js";
import { f as ge, m as H } from "./chunk-9.js";
import { n as _e, t as ve } from "./use-service-tier-settings.js";
import { p as ye } from "./codex-api.js";
import { h as be, r as xe, t as U } from "./onboarding-state.js";
import { r as W, t as Se } from "./ambient-suggestions-connected-apps-consent.js";
import { t as Ce } from "./use-is-remote-host.js";
import { n as we, t as Te } from "./use-fast-mode-personalized-estimate.js";
import { t as Ee } from "./lightning-bolt.js";
import { t as G } from "./remote-connections-onboarding-signals.js";
import { t as De } from "./globe.js";
import { t as Oe } from "./face.js";
import { t as ke } from "./use-is-background-subagents-enabled.js";
import { t as Ae } from "./use-active-conversation-id.js";
import { n as je, t as Me } from "./rate-limit-reset-modal.js";
import { t as Ne } from "./banner.js";
import { t as Pe } from "./team.js";
var K = l(),
  q = n();
function J(e) {
  let t = (0, K.c)(13),
  ...
  t[0] === r
    ? (o = t[1])
    : ((o = r ? (0, q.jsx)(r, { className: `icon-xs` }) : null), (t[0] = r), (t[1] = o));
  let s;
  return (
    t[2] !== n.ariaLabel ||
    t[3] !== n.className ||
...
function Y(e) {
  ...
  t[0] !== n || t[1] !== m || t[2] !== c || t[3] !== d || t[4] !== f
    ? ((g = (e) =>
        (0, q.jsxs)(`div`, {
          ...
          children: [
            f ? (0, q.jsx)(J, { action: f }) : null,
            d ? (0, q.jsx)(J, { action: d }) : null,
            c ? (0, q.jsx)(J, { action: c }) : null,
          ],
        })),
      (t[0] = n),
      (t[1] = m),
  ...
  t[34] === a
    ? (M = t[35])
    : ((M = E(`text-token-text-secondary mt-0.5 text-base leading-relaxed text-pretty`, a)),
      (t[34] = a),
      (t[35] = M));
  let N;
  t[36] !== s || t[37] !== M
    ? ((N = (0, q.jsx)(`div`, { className: M, children: s })),
      (t[36] = s),
      (t[37] = M),
      (t[38] = N))
    : (N = t[38]);
  let P;
  t[39] !== y || t[40] !== x || t[41] !== j || t[42] !== N
    ? ((P = (0, q.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [j, N, y, x] })),
      (t[39] = y),
      (t[40] = x),
      (t[41] = j),
      (t[42] = N),
...
function Fe(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, q.jsx)(w, {
      ...
      (o = (0, q.jsx)(Oe, { className: `icon-sm` })),
      (s = (0, q.jsx)(w, {
...
function Ie() {
  ...
  let { data: d, isLoading: f } = v(`account-info`, u),
    ...
    C = h && b && y === !0 && p === !1,
    { data: w, isLoading: T } = de({ enabled: C, hostId: g }),
    E;
  e[2] === w ? (E = e[3]) : ((E = w === void 0 ? [] : w), (e[2] = w), (e[3] = E));
  let D = E,
    O;
  e[4] === D ? (O = e[5]) : ((O = Se(D)), (e[4] = D), (e[5] = O));
  let j = Le({
      hasConnectedApps: O.length > 0,
      isLoadingApps: T,
      isLoadingEligibilityInputs: i || !m || _ || f,
      shouldLoadApps: C,
    }),
    M,
    N;
...
var X = e(t(), 1),
  ...
  He = a(c, ({ get: e }) => {
    let t = e(Re);
    return {
      queryKey: [`codex-app-home-beacon`, t, e(re).locale],
      enabled: e(Z),
      refetchOnMount: !1,
      ...
      queryFn: async () => ({
        accountId: t,
        response: await z.safeGet(`/beacons/home`, {
...
function Ue({ actionId: e, beaconId: t }) {
  return `${t}:${e}`;
}
function We(e) {
...
function Ge({ accountId: e, response: t }) {
  return t.beacon_ui_response == null
    ? { accountId: e, beacon: null, shouldKeepLastServedBeacon: !0 }
    : { accountId: e, beacon: We(t), shouldKeepLastServedBeacon: !1 };
}
function Ke(e) {
  let t = qe(e.action_v2);
  return t != null && Je(t) ? t : null;
}
function qe(e) {
...
function Ye({ accountId: e, authMethod: t, isAuthLoading: n }) {
  return !n && t === `chatgpt` && e != null;
}
function Xe({ isAuthLoading: e }) {
  return e;
}
async function Q(e, t, n) {
  try {
    await z.safePost(`/beacons/event`, {
      requestBody:
        n == null
...
function $e() {
  let e = (0, K.c)(30),
    ...
    h,
    g;
  if (e[0] !== n || e[1] !== r || e[2] !== l?.id || e[3] !== i || e[4] !== u || e[5] !== a) {
    let t = u.getContext().user?.customIDs?.account_id;
    ((h = n ?? l?.id ?? t ?? a ?? null),
      (g = Ye({ accountId: h, authMethod: r, isAuthLoading: i })),
      (e[0] = n),
      (e[1] = r),
      (e[2] = l?.id),
      (e[3] = i),
  ...
  let _ = g,
    v;
  e[8] === i ? (v = e[9]) : ((v = Xe({ isAuthLoading: i })), (e[8] = i), (e[9] = v));
  let y = v,
    b,
    x;
  (e[10] !== h || e[11] !== t || e[12] !== _
    ? ((b = () => {
        (t.set(Re, h), t.set(Z, _));
      }),
      (x = [h, t, _]),
      (e[10] = h),
      (e[11] = t),
      ...
      (e[14] = x))
    : ((b = e[13]), (x = e[14])),
    (0, X.useLayoutEffect)(b, x));
  let S, C;
  (e[15] !== f.data || e[16] !== t
    ? ((S = () => {
        f.data?.accountId != null &&
          f.data.beacon != null &&
          t.set(Ve, { accountId: f.data.accountId, beacon: f.data.beacon });
      }),
      (C = [f.data, t]),
      (e[15] = f.data),
      (e[16] = t),
  ...
  if (e[19] !== d || e[20] !== w || e[21] !== h || e[22] !== _) {
    let t = w != null && h != null ? $(h, w.beacon_id) : null;
...
function et(e) {
  ...
  return (
    t[9] !== r || t[10] !== i || t[11] !== u
      ? ((d = (0, q.jsx)(tt, { beacon: r, localActionHandlers: i, onDismiss: u })),
        (t[9] = r),
        (t[10] = i),
        (t[11] = u),
        (t[12] = d))
...
function tt(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== o) {
    let e = n.action_items.find(rt),
      i = n.action_items.find(nt),
      a = (e) => {
        if (e == null || e.text == null) return;
        let t = r?.[Ue({ actionId: e.id, beaconId: n.beacon_id })],
          i = Ke(e);
        if (!(i == null && t == null))
          return {
            label: e.text,
            onClick: () => {
              if ((Q(n, `click`, e.id), t?.({ action: e, beacon: n }) !== !0 && i != null)) {
                if (!i.startsWith(`/`)) {
...
function it(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, q.jsx)(`img`, { alt: ``, src: je, className: `h-8 w-8 shrink-0` })), (t[1] = o))
    : (o = t[1]);
  let s;
...
var at = D(`has-seen-app-upsell-banner`, !1);
function ot(e) {
  let t = (0, K.c)(6),
    { platform: n, isLoading: r } = ue(),
...
function ct(e) {
  let t = (0, K.c)(27),
    {
      ...
      isSubmitting: a,
      modelSettings: s,
      setHasSeenFastModeHomeBanner: l,
      setIsSubmitting: u,
  ...
  let g, _;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, q.jsx)(Ee, { className: `icon-sm text-[#FFC93C]` })),
      (_ = (0, q.jsx)(w, {
    ...
    : ((g = t[1]), (_ = t[2]));
  let v;
  t[3] !== r || t[4] !== s || t[5] !== m || t[6] !== l || t[7] !== u || t[8] !== d || t[9] !== p
    ? ((v = () => {
        if (r == null) return;
        (u(!0), R(m, F, {}));
        let e = s.model === r.model ? Promise.resolve() : d(r.model, s.reasoningEffort);
        Promise.all([p(f(r)?.id ?? `priority`, `home_banner`), e]).finally(() => {
          (l(!0), u(!1));
        });
      }),
      (t[3] = r),
...
var lt = D(`has-seen-fast-mode-home-banner`, !1);
function ut() {
  let e = (0, K.c)(19),
    t = o(c),
    n = C(),
    { isServiceTierAllowed: r } = _e(),
    { data: i } = me(),
    [a, s] = y(lt),
    { modelSettings: l, setModelAndReasoningEffort: d } = pe(),
    { serviceTierSettings: f, setServiceTier: m } = ve(),
    [h, g] = (0, X.useState)(!1),
    _ = (0, X.useRef)(!1),
    v = i?.models,
    b;
  e[0] === v ? (b = e[1]) : ((b = p(v, u)), (e[0] = v), (e[1] = b));
  let x = b,
    S = r && x != null && !a && f.selectedServiceTier == null && !f.isLoading,
    { estimate: T, estimateStatus: E } = we(S),
...
var dt = `multi_agent`,
  ft = D(`has-seen-multi-agent-composer-banner`, !1);
function pt() {
  let e = (0, K.c)(5),
    { hostId: t } = he(Ae()),
    n = ke(),
    [i] = y(ft),
    { data: a, isLoading: o } = r(oe, t),
    s;
  e[0] === a ? (s = e[1]) : ((s = a?.some(mt) ?? !1), (e[0] = a), (e[1] = s));
  let c = s,
    l = n && !i && o,
    u = n && !i && !c,
    d;
...
function gt(e) {
  let t = (0, K.c)(31),
    ...
    i = C(),
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((a = { hostId: g }), (t[0] = a)) : (a = t[0]);
  let s = se(a),
    [, l] = h(`composer_prefill`),
    [u, d] = y(ft),
    [f, p] = (0, X.useState)(!1),
    m = (0, X.useRef)(!1),
    _ = !u,
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, q.jsx)(w, {
      ...
      (T = (0, q.jsx)(Pe, { className: `icon-sm` })),
      (E = (0, q.jsx)(w, {
  ...
  let D;
  t[9] !== i || t[10] !== n || t[11] !== r || t[12] !== l || t[13] !== s || t[14] !== d
    ? ((D = () => {
        p(!0);
        ...
        (R(r, M, { action: `try_now` }),
          s.mutateAsync({ featureName: ht, enabled: !0 }).finally(() => {
            (n ? n() : l({ text: e }), d(!0), p(!1));
          }));
      }),
      (t[9] = i),
      (t[10] = n),
...
function vt({ entries: e }) {
  let t = (0, X.useRef)(void 0),
    n = t.current;
  if (n === void 0) {
    let r = _t(e);
...
function yt(e) {
  ...
  t[0] !== n || t[1] !== i
    ? ((a = () => {
        ie(i, Me, { initialAvailableCount: n, isRateLimitReached: !1, onResetComplete: bt });
      }),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a))
  ...
  return (
    t[3] !== r || t[4] !== a
      ? ((s = (0, q.jsx)(xt, { onDismiss: r, onSeeResets: a })), (t[3] = r), (t[4] = a), (t[5] = s))
      : (s = t[5]),
    s
  );
}
...
var St = 1440 * 60 * 1e3,
  Ct = T(`rate-limit-reset-home-announcement-dismissal-by-account-id`, {});
function wt() {
  let e = (0, K.c)(9),
    t = o(c),
    { accountId: n, isLoading: r } = V(),
    i = s(Ct),
    { data: a, isLoading: l } = s(d),
  ...
  e[0] !== n || e[1] !== u || e[2] !== t
    ? ((m = () => {
        n != null &&
          t.set(Ct, (e) => ({ ...e, [n]: { availableCount: u, dismissedAtMs: Date.now() } }));
      }),
      (e[0] = n),
      (e[1] = u),
      (e[2] = t),
      (e[3] = m))
    : (m = e[3]);
  let h = n != null && u > 0 && (f == null || f.availableCount < u || p - f.dismissedAtMs >= St),
    g = r || (a == null && l),
    _;
  return (
    e[4] !== u || e[5] !== m || e[6] !== h || e[7] !== g
      ? ((_ = { availableCount: u, dismiss: m, isEligible: h, isLoading: g }),
        (e[4] = u),
        (e[5] = m),
        (e[6] = h),
        (e[7] = g),
...
function Tt(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, q.jsx)(w, {
      ...
      (l = (0, q.jsx)(De, { className: `icon-sm` })),
      (u = (0, q.jsx)(w, {
      ...
      (t[2] = l),
      (t[3] = u))
    : ((a = t[0]), (s = t[1]), (l = t[2]), (u = t[3]));
  let d;
  t[4] !== n || t[5] !== r
    ? ((d = {
        label: u,
        onClick: () => {
          (r.set(G, !0), n(`/settings/connections`));
        },
        className: `px-3 max-[400px]:flex-1 max-[400px]:justify-center`,
      }),
      (t[4] = n),
...
function Et() {
  ...
  let o = m(a),
    c;
  e[1] === o ? (c = e[2]) : ((c = o?.some(Dt) ?? !1), (e[1] = o), (e[2] = c));
  let l = c,
    u = !n && o === void 0,
    d = !u && r && !i && !n && l,
    f;
...
function Ot() {
  ...
  e[0] !== r || e[1] !== t.pathname
    ? ((i = be({ hideFirstNewThreadOnboardingPromos: r, pathname: t.pathname })),
      (e[0] = r),
      (e[1] = t.pathname),
      (e[2] = i))
    : (i = e[2]);
  ...
  e[16] === a
    ...
    : ((f = (0, q.jsx)(B, {
        extension: !0,
        children: (0, q.jsx)(At, { shouldHideOnboardingPromos: a }),
      })),
      (e[16] = a),
      (e[17] = f));
  let p;
  return (
    e[18] !== d || e[19] !== f
      ? ((p = (0, q.jsxs)(q.Fragment, { children: [d, f] })), (e[18] = d), (e[19] = f), (e[20] = p))
      : (p = e[20]),
    p
  );
}
function kt(e) {
  ...
  let h;
  t[6] !== p || t[7] !== m
    ? ((h = (0, q.jsx)(Fe, { onDismiss: p, onDisable: m })), (t[6] = p), (t[7] = m), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== r || t[10] !== h
  ...
  t[12] !== s.availableCount || t[13] !== s.dismiss
    ? ((_ = (0, q.jsx)(yt, { availableCount: s.availableCount, onDismiss: s.dismiss })),
  ...
  t[19] !== c.accountId || t[20] !== c.beacon
    ? ((x =
        c.beacon != null && c.accountId != null
          ? (0, q.jsx)(et, { accountId: c.accountId, beacon: c.beacon })
          : null),
      (t[19] = c.accountId),
      (t[20] = c.beacon),
      (t[21] = x))
  ...
  t[26] === l.navigate
    ? (T = t[27])
    : ((T = (0, q.jsx)(Tt, { navigate: l.navigate })), (t[26] = l.navigate), (t[27] = T));
  let E;
  ...
  t[36] === d
    ? (N = t[37])
    : ((N = d.content == null ? null : (0, q.jsx)(ct, { ...d })), (t[36] = d), (t[37] = N));
  let P;
  ...
  return (
    t[42] !== S || t[43] !== E || t[44] !== A || t[45] !== P || t[46] !== g || t[47] !== v
      ? ((F = (0, q.jsx)(vt, { entries: [g, v, S, E, A, P] })),
        (t[42] = S),
        (t[43] = E),
        (t[44] = A),
        (t[45] = P),
...
function At(e) {
  ...
  t[11] === a
    ? (g = t[12])
    : ((g = a.content == null ? null : (0, q.jsx)(ct, { ...a })), (t[11] = a), (t[12] = g));
  let _;
...
export { Ot as t };
//# sourceMappingURL=home-announcements-1.js.map
