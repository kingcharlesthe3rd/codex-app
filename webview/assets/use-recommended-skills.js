...
function m(e) {
  ...
  t[0] === n
    ? (_ = t[1])
    : ((_ = r(`recommended-skills`, { hostId: n, refresh: !1 })), (t[0] = n), (t[1] = _));
  let v = _,
    y;
  ...
  t[9] !== n || t[10] !== d || t[11] !== v
    ? ((T = async () => {
        let e = await i(`recommended-skills`, { params: { hostId: n, refresh: !0 } });
        d.setQueryData(v, e);
      }),
      (t[9] = n),
      (t[10] = d),
  ...
  t[13] !== n || t[14] !== S.data?.skills || t[15] !== d || t[16] !== v
    ? ((O = async (e) => {
        ...
        if (t) return t;
        let r = await i(`recommended-skills`, { params: { hostId: n, refresh: !1 } });
