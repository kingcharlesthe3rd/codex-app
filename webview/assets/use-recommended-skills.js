...
function m(e) {
  ...
  t[0] === i
    ? (_ = t[1])
    : ((_ = n(`recommended-skills`, { hostId: i, refresh: !1 })), (t[0] = i), (t[1] = _));
  let v = _,
    y;
  ...
  t[4] === c
    ? (b = t[5])
    : ((b = { enabled: c, staleTime: a.FIVE_MINUTES }), (t[4] = c), (t[5] = b));
  let x;
  t[6] !== y || t[7] !== b
  ...
  let S = u(`recommended-skills`, x),
    ...
    w = s(`install-recommended-skill`),
    T;
  t[9] !== i || t[10] !== d || t[11] !== v
    ? ((T = async () => {
        let e = await r(`recommended-skills`, { params: { hostId: i, refresh: !0 } });
        d.setQueryData(v, e);
      }),
      (t[9] = i),
      (t[10] = d),
  ...
  t[13] !== i || t[14] !== S.data?.skills || t[15] !== d || t[16] !== v
    ? ((O = async (e) => {
        ...
        if (t) return t;
        let n = await r(`recommended-skills`, { params: { hostId: i, refresh: !1 } });
