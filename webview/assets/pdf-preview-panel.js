...
import { i as Me, n as Ne, r as Pe, t as Fe } from "./artifact-analytics.js";
import { n as Ie, t as Le } from "./artifact-preview-status.js";
function Re(e) {
  let t = (0, He.c)(19),
  ...
  (t[0] !== n || t[1] !== r || t[2] !== i
    ? ((u = () => {
        ...
        let a = new Map(),
          l = new IntersectionObserver(
            (n) => {
              ...
              let r = Ve({ container: e, pageElements: t, pageVisibilityByElement: a });
              r != null &&
        ...
        let u = Ve({ container: e, pageElements: t, pageVisibilityByElement: a });
        return (
          u != null && o(u),
          () => {
...
var He,
  ...
  Ge,
  Ke = e(() => {
    ((He = s()), (Ue = t(a(), 1)), (We = [0, 0.25, 0.5, 0.75, 1]), (Ge = 100));
  });
function qe(e) {
  let t = (0, Xe.c)(9),
    { fileDataUrl: n } = e,
  ...
  at = e(() => {
    it = class {
      ...
      addLinkAttributes(e, t) {
        ...
        e.onclick = (e) => {
          (e.preventDefault(), e.stopPropagation(), this.linkNavigation?.onExternalLink?.(t, e));
        };
      }
...
function ot(e) {
        ...
        let l = !1,
          ...
          d = async function () {
            ...
            let c = i.getViewport({ scale: 1 }),
              u = new it({ linkNavigation: r, pageSelector: a, pdfDocument: o, scrollRootRef: s });
  ...
  return (
    t[8] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((d = (0, lt.jsx)(`div`, { ref: c, className: `annotationLayer` })), (t[8] = d))
      : (d = t[8]),
    d
  );
}
...
function ft({ pageElement: e, pageSize: t }) {
  ...
  if (n == null || r == null || r.isCollapsed || r.rangeCount === 0 || !At(r, n)) return null;
  let i = Nt(r.toString());
  ...
  return {
    askForEditAnchor: wt({ clientRects: o, pageElement: e, pageSize: t, selection: r }) ?? void 0,
    kind: `region`,
    nearbyText: i,
    rect: s,
    selectedText: i,
...
function pt({
  ...
  for (let o of i.ownerDocument.elementsFromPoint?.(e, t) ?? []) {
    ...
    let e = vt({ includePreviewMetadata: n, pageElement: i, pageSize: a, target: o });
    if (e != null) return e;
  }
  return null;
}
...
function vt({ includePreviewMetadata: e, pageElement: t, pageSize: n, target: r }) {
  let i = yt(r, t);
  if (i == null) return null;
  let a = St({ clientRects: [i.element.getBoundingClientRect()], pageElement: t, pageSize: n });
...
function yt(e, t) {
  ...
  let r = bt(e, t, (e) => e.matches(`.annotationLayer a, .annotationLayer .linkAnnotation`));
...
function jt(e) {
  ...
  return n.length > 0
    ? n
    : Nt((e instanceof HTMLAnchorElement ? e : e.querySelector(`a`))?.href ?? ``);
}
function Mt(e, t) {
...
function zt({
  ...
  let v = p(o),
    ...
    [M, N] = (0, Y.useState)(``),
    [P, I] = (0, Y.useState)(null),
    [te, L] = (0, Y.useState)(null),
    [R, z] = (0, Y.useState)(null),
    [B, V] = (0, Y.useState)(null),
    [H, U] = (0, Y.useState)(null),
    [W, G] = (0, Y.useState)(!1),
    [re, ie] = (0, Y.useState)(!1),
    K = y.formatMessage({
    ...
    se = (0, Y.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === d), [e, d]),
    ce = H == null ? null : (se.find((e) => rn(e) === H) ?? null),
    le = B == null ? null : (se.find((e) => rn(e) === B) ?? null),
    ue = le == null ? null : Yt(le),
    pe = k ?? ue,
    me = (0, Y.useMemo)(
      () =>
        k == null
          ? ue == null || le == null || B == null
            ? null
            : Kt({
                anchor: ue,
                body: Xt(le),
      ...
      [c, k, M, ue, le, B, d, f, m, _],
    ),
    ge = pe == null ? null : Zt({ anchor: pe, layer: D, pageSize: f }),
    _e = pe != null,
    J = (0, Y.useCallback)(() => {
      (k != null && s?.(d, !1), A(null), L(null), z(null), N(``), V(null), G(!1));
    }, [k, s, d]),
    ...
    ye = (0, Y.useCallback)(() => {
      typeof window > `u` ||
        w({ animationFrameRef: C, animationWindow: window, editorWrapper: x.current });
    }, []),
    be = (0, Y.useCallback)(
      () =>
        me == null
          ? !1
          : me.target.mode === `create` && M.trim().length > 0
            ? W
              ? (J(), !0)
              : (G(!0), ye(), !1)
            : (J(), !0),
    ...
    xe = (0, Y.useEffectEvent)(() => {
      if (pe == null) return;
      let e = Zt({ anchor: pe, layer: D, pageSize: f });
      e != null && b(x.current, e);
    });
  (0, Y.useEffect)(() => {
    if (!_e || D == null) return;
  ...
  let Se = (0, Y.useEffectEvent)((e) => {
    ...
    (t instanceof Node && x.current?.contains(t)) ||
      ...
      e.stopPropagation(),
      be() &&
        (t instanceof Node ? t.ownerDocument : D?.ownerDocument)
          ?.getSelection()
          ?.removeAllRanges());
  });
  (0, Y.useEffect)(() => {
    if (t || me?.target.mode !== `create` || D == null) return;
    let e = D.ownerDocument,
      n = (e) => {
        Se(e);
      };
  ...
  let Ce = (0, Y.useEffectEvent)(() => {
    ...
    ((k != null || B != null) && !be()) || (L(n), A(null), N(``), V(null), U(null), z(null), G(!1));
  });
  (0, Y.useEffect)(() => {
    if (D == null || t) return;
    let e = D.parentElement;
  ...
  let we = (e, n, r) => {
    ...
    Te = (e, n) => {
      (Pe(
        v,
        { artifactTabId: h, artifactType: `pdf`, importKind: `pdf`, threadId: g },
    ...
    Ee = (0, Y.useEffectEvent)((e, t) => {
      if (k != null || B != null || !E(e)) return;
      let n = ft({ pageElement: t, pageSize: f }) ?? (te?.selectionKind === `text` ? null : te);
      n != null && (e.preventDefault(), e.stopPropagation(), Te(n, `ask_codex_shortcut`));
    });
  (0, Y.useEffect)(() => {
    if (D == null || t) return;
    let e = D.parentElement;
  ...
  let De = (e) => {
      ((k != null || B != null) && !be()) || Te(e, `annotation_mode_pointer`);
    },
    Oe = (e) => {
    ...
    Ae = (e) => {
      ...
      let t = dt(e, f) ?? P.current;
      (e.preventDefault(),
        e.stopPropagation(),
        e.currentTarget.hasPointerCapture(e.pointerId) &&
          e.currentTarget.releasePointerCapture(e.pointerId));
      let n = { ...P, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
        r = ht(n),
        i = mt(n, r);
      if (!r) {
      ...
      (Te(i, `annotation_mode_pointer`), I(null));
    },
    je = async (e, { submitDirectly: o = !1 } = {}) => {
      let s = e.body.trim();
      if (B != null) {
        if (s.length === 0 || re) return;
        (a((e) =>
          e.map((e) => (rn(e) === B ? { ...e, content: [{ content_type: `text`, text: s }] } : e)),
        ),
          J());
        return;
      }
      if (!(k == null || s.length === 0 || re))
        try {
          ie(!0);
          let p = qt({ anchor: k, pageSize: f }),
            y = crypto.randomUUID(),
            b;
          try {
            b = await Qt({
          ...
          (fe(v, ae, { commentType: p.kind, submitMode: o ? `direct` : `saved` }),
            Me(
              v,
              { artifactTabId: h, artifactType: `pdf`, importKind: `pdf`, threadId: g },
              {
                annotationModeEnabled: t,
                annotationTargetKind: p.kind,
  ...
  return (0, X.jsxs)(`div`, {
    ref: O,
    className: de(`absolute inset-0 z-[3]`, !t && `pointer-events-none`),
    "data-testid": `artifact-pdf-comment-layer`,
    style: t ? { cursor: j } : void 0,
    onPointerDown: Oe,
    onPointerMove: ke,
    onPointerUp: Ae,
    onPointerCancel: () => {
    ...
    children: [
      se.map((e) =>
        (0, X.jsx)(
          Bt,
          {
            ...
            isSelected: rn(e) === B,
            onEdit: (e) => {
              (k != null && s?.(d, !1), A(null), L(null), z(null), N(``), G(!1), U(null), V(e));
            },
            onPreviewChange: U,
          },
          rn(e),
      ...
      ce == null || B != null ? null : (0, X.jsx)(Vt, { comment: ce, layer: D }),
      ...
      te != null && k == null
        ? (0, X.jsx)(ne, {
            anchor: te.askForEditAnchor,
            label: q,
            pageSize: f,
            rect: te.rect,
            testId: `artifact-pdf-ask-for-edit-button`,
            onClick: () => Te(te, `ask_codex_button`),
          })
        : null,
      P == null ? null : (0, X.jsx)(Wt, { rect: gt(P.start, P.current), pageSize: f }),
      k == null ? null : (0, X.jsx)(Ht, { anchor: k, label: r, pageSize: f }),
      pe == null || ge == null || me == null
        ? null
        : (0, X.jsx)(`div`, {
            ref: x,
            className: ee,
            style: { left: ge.x, top: ge.y, height: S, width: 294 },
            ...
            children: (0, X.jsx)(
              T,
              {
                ...
                onCancel: J,
                onDelete: (e) => {
                  (a((t) => t.filter((t) => rn(t) !== e)), J());
                },
                onDirectSubmit: (e) => {
                  je(e, { submitDirectly: !0 });
                },
                onEscape: J,
                onBodyChange: me.target.mode === `create` ? ve : void 0,
...
function Bt(e) {
  ...
  let d = u,
    f;
  t[5] !== l || t[6] !== a ? ((f = () => a(l)), (t[5] = l), (t[6] = a), (t[7] = f)) : (f = t[7]);
  let p = f,
    m;
  ...
  if (s.kind === `region`) {
    ...
    t[17] !== l || t[18] !== i
      ...
      : (o = t[19]);
    let c;
    t[20] === s.pageRect ? (c = t[21]) : ((c = _t(s.pageRect)), (t[20] = s.pageRect), (t[21] = c));
    let u;
...
function Ht(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n || t[1] !== i
      ...
      : (e = t[2]);
    let a;
    t[3] === n.rect ? (a = t[4]) : ((a = _t(n.rect)), (t[3] = n.rect), (t[4] = a));
    let o;
    t[5] !== r || t[6] !== i || t[7] !== a
  ...
  return (
    t[12] !== n.point || t[13] !== r || t[14] !== i
      ? ((a = (0, X.jsx)(Gt, { draft: !0, label: r, point: n.point, pageSize: i })),
        (t[12] = n.point),
        (t[13] = r),
        (t[14] = i),
        (t[15] = a))
...
function Ut(e) {
  ...
  return (
    t[12] !== n.rect || t[13] !== o || t[14] !== i || t[15] !== a
      ? ((s = (0, X.jsx)(F, { bordered: o, paddingPx: 4, pageSize: i, rect: n.rect, testId: a })),
        (t[12] = n.rect),
        (t[13] = o),
        (t[14] = i),
        (t[15] = a),
...
function Zt({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ? D({ layer: t, pageSize: n, rect: e.rect })
    : z({ layer: t, markerPoint: e.kind === `region` ? _t(e.rect) : e.point, pageSize: n });
}
async function Qt({
  anchor: e,
  commentId: t,
...
function $t(e, t) {
  ...
  return en({ x: e.point.x - 180, y: e.point.y - 120, width: 360, height: 240 }, t);
}
function en(e, t) {
  let n = Math.min(Math.max(e.width, 1), t.width),
    r = Math.min(Math.max(e.height, 1), t.height);
  return { x: an(e.x, 0, t.width - n), y: an(e.y, 0, t.height - r), width: n, height: r };
}
...
function ln(e) {
  ...
  return (
    t[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((s = (0, fn.jsx)(`div`, { ref: i, className: `textLayer` })), (t[4] = s))
      : (s = t[4]),
    s
  );
}
...
function mn(e) {
  ...
  t[13] !== S || t[14] !== n
    ? ((D = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: vn(S(e), `out`) })));
      }),
      (t[13] = S),
      (t[14] = n),
      (t[15] = D))
  ...
  t[16] !== S || t[17] !== n
    ? ((k = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: vn(S(e), `in`) })));
      }),
      (t[16] = S),
      (t[17] = n),
      (t[18] = k))
...
var bn,
  ...
  kn = e(() => {
    ((bn = s()),
      ...
      (En = 5),
      (Dn = 200),
      (On = [Cn, 0.4, 0.5, 0.67, 0.75, 0.9, 1, 1.1, 1.25, 1.5, 1.75, 2, 2.5, 3, 4, 5, 6, 7, wn]));
  });
function An() {}
var jn,
  Mn,
    ...
    ((jn = s()),
      ...
      (Pn = (0, Mn.memo)(function (e) {
        ...
        (t[12] === d
          ...
          (0, Mn.useEffect)(I, te));
        let L;
        t[15] !== E.height || t[16] !== E.width || t[17] !== f || t[18] !== S || t[19] !== k
          ? ((L = () => {
              let e = h.current;
              if (e == null) return;
              if (S == null || !k) {
        ...
        let z = C == null ? void 0 : ``,
          ne = S?.userUnit ?? 1,
          B;
        t[28] !== E.height || t[29] !== E.width || t[30] !== D || t[31] !== ne
          ? ((B = { "--scale-factor": D, "--user-unit": ne, height: E.height, width: E.width }),
            (t[28] = E.height),
            (t[29] = E.width),
            (t[30] = D),
            (t[31] = ne),
        ...
        t[33] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((H = (0, Nn.jsx)(`canvas`, { ref: h, className: `absolute inset-0 size-full` })),
            (t[33] = H))
          : (H = t[33]);
        let U;
        t[34] !== M ||
        ...
        let G;
        return (
          t[49] !== a || t[50] !== z || t[51] !== V || t[52] !== U || t[53] !== W
            ? ((G = (0, Nn.jsxs)(`div`, {
                ref: g,
...
function In(e) {
  let t = (0, zn.c)(70),
    ...
    u = (0, Bn.useRef)(null),
    d;
  t[0] !== n || t[1] !== r ? ((d = Rn(n, r)), (t[0] = n), (t[1] = r), (t[2] = d)) : (d = t[2]);
  let [f, p] = (0, Bn.useState)(d),
    [m, h] = (0, Bn.useState)(null),
    g;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (e) => {
        h({ height: Math.floor(e.contentRect.height), width: Math.floor(e.contentRect.width) });
      }),
      (t[3] = g))
    : (g = t[3]);
  let _ = te(g),
  ...
  let x = b,
    S;
  t[8] !== x || t[9] !== a
    ? ((S = { onExternalLink: a, onPageChange: x }), (t[8] = x), (t[9] = a), (t[10] = S))
    : (S = t[10]);
  let C = S,
    w;
  t[11] === l
  ...
  let F = ee,
    I;
  t[30] !== o || t[31] !== m
    ? ((I = Ln({ pageViewportSize: o, presentationSize: m })),
      (t[30] = o),
      (t[31] = m),
      (t[32] = I))
    : (I = t[32]);
  let L;
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((L = { kind: `page-width` }), (t[33] = L))
    : (L = t[33]);
  let R;
  t[34] !== O || t[35] !== C || t[36] !== o || t[37] !== s || t[38] !== I
    ? ((R = (0, Z.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ne = (0, Z.jsx)(W, { className: `icon-2xs rotate-180` })), (t[40] = ne))
    : (ne = t[40]);
  let B;
  t[41] !== A || t[42] !== T || t[43] !== z
    ? ((B = (0, Z.jsx)(De, {
        "aria-label": T,
        color: `ghost`,
        disabled: z,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = (0, Z.jsx)(W, { className: `icon-2xs` })), (t[48] = U))
    : (U = t[48]);
  let G;
  t[49] !== M || t[50] !== D || t[51] !== H
    ? ((G = (0, Z.jsx)(De, {
        "aria-label": D,
        color: `ghost`,
        disabled: H,
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = (0, Z.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })), (t[53] = re))
    : (re = t[53]);
  let ie, ae;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ie = (0, Z.jsx)(Te, { className: `icon-2xs` })),
      (ae = (0, Z.jsx)(se, {
  ...
  let q;
  return (
    t[63] !== F || t[64] !== P || t[65] !== y || t[66] !== R || t[67] !== oe || t[68] !== c
      ? ((q = (0, Z.jsxs)(`div`, {
          ref: y,
          "aria-label": c,
          autoFocus: !0,
...
var zn,
  ...
  Z,
  Vn = e(() => {
    ((zn = s()), (Bn = t(a(), 1)), ge(), Ee(), G(), we(), O(), Fn(), (Z = m()));
  });
function Hn({ anchor: e, container: t, pageSelector: n }) {
  let r = t.getBoundingClientRect(),
    ...
    o = Wn({ anchorClientX: i, anchorClientY: a, container: t, pageSelector: n });
...
function Wn({ anchorClientX: e, anchorClientY: t, container: n, pageSelector: r }) {
  ...
  for (let i of Kn(n, r)) {
    let n = i.getBoundingClientRect(),
      r = qn({ max: n.bottom, min: n.top, value: t }) + qn({ max: n.right, min: n.left, value: e });
    r < s && ((s = r), (o = i));
  }
  return o;
}
...
function Xn(e) {
  ...
  return (
    t[11] !== r || t[12] !== p
      ? ((m = (0, $.jsx)(ke, { name: `PdfPreviewPanel`, resetKey: r, fallback: f, children: p })),
        (t[11] = r),
        (t[12] = p),
        (t[13] = m))
      : (m = t[13]),
...
function Zn(e) {
  ...
  let w = (0, Q.useRef)(C),
    [T, E] = (0, Q.useState)(!1),
    [D, O] = (0, Q.useState)(!1),
    [k, j] = (0, Q.useState)(null),
    N;
  t[1] === f.value ? (N = t[2]) : ((N = ue(f.value)), (t[1] = f.value), (t[2] = N));
  let P = N,
    ee;
  t[3] === P ? (ee = t[4]) : ((ee = P ?? oe({ entrypoint: `home` })), (t[3] = P), (t[4] = ee));
  let F = ee,
    I = l(A, F),
    R;
  t[5] !== F || t[6] !== f
  ...
  if (t[8] !== I || t[9] !== s) {
    ...
    (t[11] === s
      ? (e = t[12])
      : ((e = (e) => h(e) && e.localPdfContext?.path === s), (t[11] = s), (t[12] = e)),
      (ne = I.filter(e)),
      (t[8] = I),
      (t[9] = s),
      (t[10] = ne));
  ...
  let B = ne,
    V;
  t[13] === B ? (V = t[14]) : ((V = Math.max(0, ...B.map(tr))), (t[13] = B), (t[14] = V));
  let H = V + 1,
    W,
    G;
  (t[15] !== s || t[16] !== z
    ? ((W = () => () => {
        z((e) => {
          let t = e.filter((e) => !(h(e) && e.localPdfContext?.path === s));
    ...
    (0, Q.useEffect)(W, G));
  let re;
  t[19] === r ? (re = t[20]) : ((re = { fileDataUrl: r }), (t[19] = r), (t[20] = re));
  let {
      loadedFileDataUrl: ie,
      loadState: ae,
      numPages: K,
      pageViewportSize: q,
      pdfDocument: se,
  ...
  t[21] === K
    ? (ce = t[22])
    : ((ce = { containerRef: _, pageSelector: `[data-artifact-pdf-page]`, totalPages: K }),
      (t[21] = K),
      (t[22] = ce));
  let { currentPage: de, goToNextPage: pe, goToPreviousPage: ge } = Re(ce),
    J;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((J = (e) => {
        ...
        b.current = Hn({ anchor: e, container: t, pageSelector: `[data-artifact-pdf-page]` });
      }),
      (t[23] = J))
    : (J = t[23]);
  let ve = J,
    we;
  t[24] !== q || t[25] !== k
    ? ((we = { onBeforeZoom: ve, pageViewportSize: q, pageWidth: k }),
      (t[24] = q),
      (t[25] = k),
      (t[26] = we))
    : (we = t[26]);
  let {
    ...
    Fe;
  t[27] !== de || t[28] !== Ee || t[29] !== ke
    ? ((Fe = () => {
        let e =
          ke.kind === `page-width`
            ? null
            : _.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${de}"]`);
        (Ee(),
          e != null &&
  ...
  t[31] === Te
    ...
    : ((ze = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = S.current;
        n !== t && (n != null && (ve({ kind: `center` }), Te()), (S.current = t), j(t));
      }),
      (t[31] = Te),
      (t[32] = ze));
  let Be = te(ze),
  ...
  t[36] === He
    ...
    : ((Ue = () => {
      ...
      (t[37] = Ue));
  let We;
  (t[38] !== q || t[39] !== k || t[40] !== ke || t[41] !== He
    ? ((We = [q, k, ke, He]), (t[38] = q), (t[39] = k), (t[40] = ke), (t[41] = He), (t[42] = We))
    : (We = t[42]),
  ...
  (t[43] === r
    ? ((Ge = t[44]), (Ke = t[45]))
    : ((Ge = () => {
        x.current !== r && ((x.current = r), ve({ kind: `center` }));
      }),
      (Ke = [ve, r]),
      (t[43] = r),
      (t[44] = Ge),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Je = t[46]);
  let Ye;
  (t[47] === r ? (Ye = t[48]) : ((Ye = [r]), (t[47] = r), (t[48] = Ye)), (0, Q.useEffect)(Je, Ye));
  let Xe, Ze;
  (t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Xe = () => {
        let e = () => {
          document.fullscreenElement !== g.current && E(!1);
        };
        return (
  ...
  t[53] !== K || t[54] !== f
    ? ((rt = () => {
        ((v.current = !0), fe(f, le, { pageCount: K }));
      }),
      (t[53] = K),
      (t[54] = f),
      (t[55] = rt))
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        (E(!1), document.fullscreenElement === g.current && document.exitFullscreen().catch(er));
      }),
      (t[61] = st))
    : (st = t[61]);
  let ct = st,
  ...
  t[62] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((lt = (e, t) => {
        (E(!1),
          (document.fullscreenElement === g.current ? document.exitFullscreen() : Promise.resolve())
            .catch($n)
            .finally(() => {
              Ae({ event: t, href: e, initiator: `open_in_browser_bridge` });
            }));
      }),
      (t[62] = lt))
    : (lt = t[62]);
  ...
  let vt = _t,
    ...
    xt;
  t[72] !== D || t[73] !== f || t[74] !== u || t[75] !== P
    ? ((xt = () => {
        (bt(!1),
          D || Ne(f, { artifactTabId: u, artifactType: `pdf`, importKind: `pdf`, threadId: P }),
          O(Qn));
      }),
      (t[72] = D),
      (t[73] = f),
    ...
    : (xt = t[76]);
  let St;
  t[77] !== gt || t[78] !== vt || t[79] !== D || t[80] !== xt
    ? ((St = (0, $.jsx)(M, { active: D, activeLabel: vt, label: gt, onClick: xt })),
      (t[77] = gt),
      (t[78] = vt),
      (t[79] = D),
      (t[80] = xt),
                          ...
                          rightContent: (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, $.jsx)(Se, {
                                ...
                                fitOption: { selected: ke.kind === `page-width`, onSelect: Le },
                              }),
                              n === `default`
                                ? (0, $.jsxs)($.Fragment, {
                                    children: [
                                      (0, $.jsx)(_e, { hostId: a, path: s, sizeBytes: c }),
                                      (0, $.jsx)(be, {
                                        hostId: a,
                                        onBeforeOpen: o,
                                        path: s,
