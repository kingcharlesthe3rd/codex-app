...
var He,
  ...
  Ge,
  Ke = e(() => {
    ((He = L()), (Ue = t(h(), 1)), (We = [0, 0.25, 0.5, 0.75, 1]), (Ge = 100));
  });
function qe(e) {
  let t = (0, Xe.c)(9),
    { fileDataUrl: n } = e,
...
function zt({
  ...
  let g = u(x),
    ...
    v = (0, Y.useRef)(null),
    y = (0, Y.useRef)(null),
    [b, ee] = (0, Y.useState)(null),
    [S, w] = (0, Y.useState)(null),
    [E, D] = (0, Y.useState)(``),
    [O, A] = (0, Y.useState)(null),
    [j, M] = (0, Y.useState)(null),
    [N, F] = (0, Y.useState)(null),
    ...
    ie = (0, Y.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === l), [e, l]),
    G = R == null ? null : (ie.find((e) => rn(e) === R) ?? null),
    ae = I == null ? null : (ie.find((e) => rn(e) === I) ?? null),
    oe = ae == null ? null : Yt(ae),
    se = S ?? oe,
    K = (0, Y.useMemo)(
      () =>
        S == null
          ? oe == null || ae == null || I == null
            ? null
            : Kt({
                anchor: oe,
                body: Xt(ae),
      ...
      [o, S, E, oe, ae, I, l, d, f, h],
    ),
    ce = se == null ? null : Zt({ anchor: se, layer: b, pageSize: d }),
    le = se != null,
    q = (0, Y.useCallback)(() => {
      (S != null && i?.(l, !1), w(null), M(null), F(null), D(``), L(null), B(!1));
    }, [S, i, l]),
    ue = (0, Y.useCallback)((e) => {
      (D(e), B(!1));
    }, []),
    de = (0, Y.useCallback)(() => {
      typeof window > `u` ||
        xe({ animationFrameRef: y, animationWindow: window, editorWrapper: v.current });
    }, []),
    he = (0, Y.useCallback)(
      () =>
        K == null
    ...
    ge = (0, Y.useEffectEvent)(() => {
      if (se == null) return;
      let e = Zt({ anchor: se, layer: b, pageSize: d });
      e != null && J(v.current, e);
    });
  (0, Y.useEffect)(() => {
    if (!le || b == null) return;
  ...
  let _e = (0, Y.useEffectEvent)((e) => {
    let t = e.target;
    (t instanceof Node && v.current?.contains(t)) ||
      (e.preventDefault(),
      e.stopPropagation(),
      he() &&
        (t instanceof Node ? t.ownerDocument : b?.ownerDocument)
          ?.getSelection()
          ?.removeAllRanges());
  });
  (0, Y.useEffect)(() => {
    if (t || K?.target.mode !== `create` || b == null) return;
    let e = b.ownerDocument,
      n = (e) => {
        _e(e);
      };
  ...
  let ve = (0, Y.useEffectEvent)(() => {
    ...
    ((S != null || I != null) && !he()) || (M(n), w(null), D(``), L(null), z(null), F(null), B(!1));
  });
  (0, Y.useEffect)(() => {
    if (b == null || t) return;
    let e = b.parentElement;
  ...
  let Se = (e, n, r) => {
    ...
    Ce = (e, n) => {
      (Pe(
        g,
        { artifactTabId: p, artifactType: `pdf`, importKind: `pdf`, threadId: m },
    ...
    we = (0, Y.useEffectEvent)((e, t) => {
      if (S != null || I != null || !ke(e)) return;
      let n = ft({ pageElement: t, pageSize: d }) ?? (j?.selectionKind === `text` ? null : j);
      n != null && (e.preventDefault(), e.stopPropagation(), Ce(n, `ask_codex_shortcut`));
    });
  (0, Y.useEffect)(() => {
    if (b == null || t) return;
    let e = b.parentElement;
  ...
  let Te = (e) => {
      ((S != null || I != null) && !he()) || Ce(e, `annotation_mode_pointer`);
    },
    De = (e) => {
    ...
    Ae = (e) => {
      ...
      let t = dt(e, d) ?? O.current;
      (e.preventDefault(),
        e.stopPropagation(),
        e.currentTarget.hasPointerCapture(e.pointerId) &&
          e.currentTarget.releasePointerCapture(e.pointerId));
      let n = { ...O, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
        r = ht(n),
        i = mt(n, r);
      if (!r) {
      ...
      if (S != null && i.kind === `point`) {
        (he(), A(null));
        return;
      }
      (Ce(i, `annotation_mode_pointer`), A(null));
    },
    je = async (e, { submitDirectly: i = !1 } = {}) => {
      let a = e.body.trim();
      if (I != null) {
        if (a.length === 0 || V) return;
        (r((e) =>
          e.map((e) => (rn(e) === I ? { ...e, content: [{ content_type: `text`, text: a }] } : e)),
        ),
          q());
        return;
      }
      if (!(S == null || a.length === 0 || V))
        try {
          re(!0);
          let u = qt({ anchor: S, pageSize: d }),
            _ = crypto.randomUUID(),
            v;
          try {
            v = await Qt({
          ...
          (C(g, k, { commentType: u.kind, submitMode: i ? `direct` : `saved` }),
            Me(
              g,
              { artifactTabId: p, artifactType: `pdf`, importKind: `pdf`, threadId: m },
              {
                annotationModeEnabled: t,
                annotationTargetKind: u.kind,
  ...
  return (0, X.jsxs)(`div`, {
    ref: ee,
    className: a(`absolute inset-0 z-[3]`, !t && `pointer-events-none`),
    "data-testid": `artifact-pdf-comment-layer`,
    style: t ? { cursor: Ee } : void 0,
    onPointerDown: De,
    onPointerMove: Oe,
    onPointerUp: Ae,
    onPointerCancel: () => {
    ...
    children: [
      ie.map((e) =>
        (0, X.jsx)(
          Bt,
          {
            ...
            isSelected: rn(e) === I,
            onEdit: (e) => {
              (S != null && i?.(l, !1), w(null), M(null), F(null), D(``), B(!1), z(null), L(e));
            },
            onPreviewChange: z,
          },
          rn(e),
      ...
      G == null || I != null ? null : (0, X.jsx)(Vt, { comment: G, layer: b }),
      N != null && S == null && I == null
        ? (0, X.jsx)(fe, {
            paddingPx: 4,
            pageSize: d,
            rect: N.rect,
      ...
      j != null && S == null
        ? (0, X.jsx)(pe, {
            ...
            onClick: () => Ce(j, `ask_codex_button`),
          })
        : null,
      O == null ? null : (0, X.jsx)(Wt, { rect: gt(O.start, O.current), pageSize: d }),
      S == null ? null : (0, X.jsx)(Ht, { anchor: S, label: n, pageSize: d }),
      se == null || ce == null || K == null
        ? null
        : (0, X.jsx)(`div`, {
            ref: v,
            className: me,
            style: { left: ce.x, top: ce.y, height: be, width: 294 },
            ...
            children: (0, X.jsx)(
              ye,
              {
                ...
                onCancel: q,
                onDelete: (e) => {
                  (r((t) => t.filter((t) => rn(t) !== e)), q());
                },
                onDirectSubmit: (e) => {
                  je(e, { submitDirectly: !0 });
                },
                onEscape: q,
                onBodyChange: K.target.mode === `create` ? ue : void 0,
...
function Ut(e) {
  ...
  return (
    t[12] !== n.rect || t[13] !== o || t[14] !== i || t[15] !== a
      ? ((s = (0, X.jsx)(fe, { bordered: o, paddingPx: 4, pageSize: i, rect: n.rect, testId: a })),
        (t[12] = n.rect),
        (t[13] = o),
        (t[14] = i),
        (t[15] = a),
...
function Zt({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ? we({ layer: t, pageSize: n, rect: e.rect })
    : De({ layer: t, markerPoint: e.kind === `region` ? _t(e.rect) : e.point, pageSize: n });
}
async function Qt({
  anchor: e,
  commentId: t,
...
function mn(e) {
  ...
  let b = y,
    ee;
  t[6] !== r || t[7] !== i
    ? ((ee = (e) => gn({ pageViewportSize: r, pageWidth: i, resize: e })),
      (t[6] = r),
      (t[7] = i),
      (t[8] = ee))
    : (ee = t[8]);
  ...
  t[13] !== x || t[14] !== n
    ? ((E = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: vn(x(e), `out`) })));
      }),
      (t[13] = x),
      (t[14] = n),
      (t[15] = E))
  ...
  t[16] !== x || t[17] !== n
    ? ((O = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: vn(x(e), `in`) })));
      }),
      (t[16] = x),
      (t[17] = n),
      (t[18] = O))
  ...
  t[19] !== x || t[20] !== n
    ? ((A = (e) => {
        ...
        ((p.current = 0),
          ...
          g(),
          s((e) => ({ kind: `percentage`, value: vn(x(e), t) })));
      }),
      (t[19] = x),
      (t[20] = n),
      (t[21] = A))
    ...
    ((jn = L()),
      ...
      (Pn = (0, Mn.memo)(function (e) {
        let t = (0, jn.c)(55),
          ...
          ee = _?.pdfDocument === l,
          x = ee ? _.page : null,
          S = ee ? _.viewportSize : null,
          C = S ?? s,
          w;
        t[0] !== c || t[1] !== u || t[2] !== C
          ? ((w = _n({ pageViewportSize: C, pageWidth: c, resize: u })),
            (t[0] = c),
            (t[1] = u),
            (t[2] = C),
            (t[3] = w))
          : (w = t[3]);
        let T = w,
          E = S != null && S.width > 0 ? T.width / S.width : 1,
          D = Math.abs(r - a),
          O = y || D <= 2,
          k = y || D <= 2,
          A = y ? 50 : 50 + D * 40,
        ...
        (t[12] === d
          ...
          (0, Mn.useEffect)(F, I));
        let L;
        t[15] !== T.height || t[16] !== T.width || t[17] !== f || t[18] !== x || t[19] !== O
          ? ((L = () => {
              let e = h.current;
              if (e == null) return;
              if (x == null || !O) {
              ...
              if (t.width <= 0 || T.width <= 0 || T.height <= 0) return;
              let n = null,
                r = window.devicePixelRatio || 1,
                i = Math.ceil(T.width * r),
                a = Math.ceil(T.height * r);
        ...
        let z = S == null ? void 0 : ``,
          ne = x?.userUnit ?? 1,
          B;
        t[28] !== T.height || t[29] !== T.width || t[30] !== E || t[31] !== ne
          ? ((B = { "--scale-factor": E, "--user-unit": ne, height: T.height, width: T.width }),
            (t[28] = T.height),
            (t[29] = T.width),
            (t[30] = E),
            (t[31] = ne),
        ...
        t[33] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((re = (0, Nn.jsx)(`canvas`, { ref: h, className: `absolute inset-0 size-full` })),
            (t[33] = re))
          : (re = t[33]);
        let H;
        t[34] !== j ||
        ...
        let W;
        return (
          t[49] !== a || t[50] !== z || t[51] !== V || t[52] !== H || t[53] !== U
            ? ((W = (0, Nn.jsxs)(`div`, {
                ref: g,
...
function In(e) {
  let t = (0, zn.c)(70),
    ...
    d = (0, Bn.useRef)(null),
    f;
  t[0] !== n || t[1] !== r ? ((f = Rn(n, r)), (t[0] = n), (t[1] = r), (t[2] = f)) : (f = t[2]);
  let [p, m] = (0, Bn.useState)(f),
    [h, g] = (0, Bn.useState)(null),
    v;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (e) => {
        g({ height: Math.floor(e.contentRect.height), width: Math.floor(e.contentRect.width) });
      }),
      (t[3] = v))
    : (v = t[3]);
  let y = Ae(v),
  ...
  let C = x,
    w;
  t[8] !== C || t[9] !== a
    ? ((w = { onExternalLink: a, onPageChange: C }), (t[8] = C), (t[9] = a), (t[10] = w))
    : (w = t[10]);
  let T = w,
    E;
  t[11] === u
  ...
  let z = L,
    ne;
  t[30] !== o || t[31] !== h
    ? ((ne = Ln({ pageViewportSize: o, presentationSize: h })),
      (t[30] = o),
      (t[31] = h),
      (t[32] = ne))
    : (ne = t[32]);
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (B = t[33]);
  let V;
  t[34] !== A || t[35] !== T || t[36] !== o || t[37] !== s || t[38] !== ne
    ? ((V = (0, Z.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, Z.jsx)(S, { className: `icon-2xs rotate-180` })), (t[40] = H))
    : (H = t[40]);
  let U;
  t[41] !== M || t[42] !== D || t[43] !== re
    ? ((U = (0, Z.jsx)(l, {
        "aria-label": D,
        color: `ghost`,
        disabled: re,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, Z.jsx)(S, { className: `icon-2xs` })), (t[48] = G))
    : (G = t[48]);
  let ae;
  t[49] !== P || t[50] !== k || t[51] !== ie
    ? ((ae = (0, Z.jsx)(l, {
        "aria-label": k,
        color: `ghost`,
        disabled: ie,
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, Z.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })), (t[53] = oe))
    : (oe = t[53]);
  let se, K;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (0, Z.jsx)(_, { className: `icon-2xs` })),
      (K = (0, Z.jsx)(R, {
  ...
  let q;
  return (
    t[63] !== z || t[64] !== I || t[65] !== ee || t[66] !== V || t[67] !== le || t[68] !== c
      ? ((q = (0, Z.jsxs)(`div`, {
          ref: ee,
          "aria-label": c,
          autoFocus: !0,
...
var zn,
  ...
  Z,
  Vn = e(() => {
    ((zn = L()), (Bn = t(h(), 1)), j(), b(), s(), y(), je(), Fn(), (Z = o()));
  });
...
function Xn(e) {
  ...
  return (
    t[11] !== r || t[12] !== p
      ? ((m = (0, $.jsx)(K, { name: `PdfPreviewPanel`, resetKey: r, fallback: f, children: p })),
        (t[11] = r),
        (t[12] = p),
        (t[13] = m))
      : (m = t[13]),
...
function Zn(e) {
  let t = (0, rr.c)(125),
    ...
    w = (0, Q.useRef)(null),
    T;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((T = new Set()), (t[0] = T)) : (T = t[0]);
  let E = (0, Q.useRef)(T),
    [D, k] = (0, Q.useState)(!1),
    [A, j] = (0, Q.useState)(!1),
    [M, N] = (0, Q.useState)(null),
    P;
  t[1] === h.value ? (P = t[2]) : ((P = d(h.value)), (t[1] = h.value), (t[2] = P));
  let I = P,
    L;
  t[3] === I ? (L = t[4]) : ((L = I ?? O({ entrypoint: `home` })), (t[3] = I), (t[4] = L));
  let R = L,
    V = ee(ne, R),
    H;
  t[5] !== R || t[6] !== h
  ...
  if (t[8] !== V || t[9] !== s) {
    ...
    (t[11] === s
      ? (e = t[12])
      : ((e = (e) => f(e) && e.localPdfContext?.path === s), (t[11] = s), (t[12] = e)),
      (ie = V.filter(e)),
      (t[8] = V),
      (t[9] = s),
      (t[10] = ie));
  ...
  let G = ie,
    K;
  t[13] === G ? (K = t[14]) : ((K = Math.max(0, ...G.map(tr))), (t[13] = G), (t[14] = K));
  let q = K + 1,
    ue,
    fe;
  (t[15] !== s || t[16] !== W
    ? ((ue = () => () => {
        W((e) => {
          let t = e.filter((e) => !(f(e) && e.localPdfContext?.path === s));
    ...
    (0, Q.useEffect)(ue, fe));
  let pe;
  t[19] === r ? (pe = t[20]) : ((pe = { fileDataUrl: r }), (t[19] = r), (t[20] = pe));
  let {
  ...
  t[21] === J
    ? (ve = t[22])
    : ((ve = { containerRef: y, pageSelector: `[data-artifact-pdf-page]`, totalPages: J }),
      (t[21] = J),
      (t[22] = ve));
  let { currentPage: ye, goToNextPage: be, goToPreviousPage: xe } = Re(ve),
    Se;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (e) => {
        ...
        x.current = Hn({ anchor: e, container: t, pageSelector: `[data-artifact-pdf-page]` });
      }),
      (t[23] = Se))
    : (Se = t[23]);
  let Ce = Se,
    we;
  t[24] !== ge || t[25] !== M
    ? ((we = { onBeforeZoom: Ce, pageViewportSize: ge, pageWidth: M }),
      (t[24] = ge),
      (t[25] = M),
      (t[26] = we))
    : (we = t[26]);
  let {
    ...
    Fe;
  t[27] !== ye || t[28] !== Ee || t[29] !== ke
    ? ((Fe = () => {
        let e =
          ke.kind === `page-width`
            ? null
            : y.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${ye}"]`);
        (Ee(),
          e != null &&
  ...
  t[31] === Te
    ...
    : ((ze = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = w.current;
        n !== t && (n != null && (Ce({ kind: `center` }), Te()), (w.current = t), N(t));
      }),
      (t[31] = Te),
      (t[32] = ze));
  let Be = Ae(ze),
  ...
  t[36] === He
    ...
    : ((Ue = () => {
      ...
      (t[37] = Ue));
  let We;
  (t[38] !== ge || t[39] !== M || t[40] !== ke || t[41] !== He
    ? ((We = [ge, M, ke, He]), (t[38] = ge), (t[39] = M), (t[40] = ke), (t[41] = He), (t[42] = We))
    : (We = t[42]),
  ...
  (t[43] === r
    ? ((Ge = t[44]), (Ke = t[45]))
    : ((Ge = () => {
        S.current !== r && ((S.current = r), Ce({ kind: `center` }));
      }),
      (Ke = [Ce, r]),
      (t[43] = r),
      (t[44] = Ge),
  ...
  (t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Xe = () => {
        let e = () => {
          document.fullscreenElement !== _.current && k(!1);
        };
        return (
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        (k(!1), document.fullscreenElement === _.current && document.exitFullscreen().catch(er));
      }),
      (t[61] = st))
    : (st = t[61]);
  let ct = st,
  ...
  t[62] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((lt = (e, t) => {
        (k(!1),
          (document.fullscreenElement === _.current ? document.exitFullscreen() : Promise.resolve())
            .catch($n)
            .finally(() => {
              z({ event: t, href: e, initiator: `open_in_browser_bridge` });
            }));
      }),
      (t[62] = lt))
    : (lt = t[62]);
  ...
  let vt = _t,
    ...
    xt;
  t[72] !== A || t[73] !== h || t[74] !== l || t[75] !== I
    ? ((xt = () => {
        (bt(!1),
          A || Ne(h, { artifactTabId: l, artifactType: `pdf`, importKind: `pdf`, threadId: I }),
          j(Qn));
      }),
      (t[72] = A),
      (t[73] = h),
    ...
    : (xt = t[76]);
  let St;
  t[77] !== gt || t[78] !== vt || t[79] !== A || t[80] !== xt
    ? ((St = (0, $.jsx)(de, { active: A, activeLabel: vt, label: gt, onClick: xt })),
      (t[77] = gt),
      (t[78] = vt),
      (t[79] = A),
      (t[80] = xt),
                          ...
                          rightContent: (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              n === `default`
                                ? (0, $.jsxs)($.Fragment, {
                                    children: [
                                      (0, $.jsx)(le, { hostId: a, path: s, sizeBytes: c }),
                                      (0, $.jsx)(U, {
                                        hostId: a,
                                        onBeforeOpen: o,
                                        path: s,
