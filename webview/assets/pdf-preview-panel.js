...
var He,
  ...
  Ge,
  Ke = e(() => {
    ((He = a()), (Ue = t(u(), 1)), (We = [0, 0.25, 0.5, 0.75, 1]), (Ge = 100));
  });
function qe(e) {
  let t = (0, Xe.c)(9),
    { fileDataUrl: n } = e,
...
function zt({
  ...
  let v = d(i),
    ...
    U = (0, Y.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === f), [e, f]),
    ie = ee == null ? null : (U.find((e) => rn(e) === ee) ?? null),
    ae = F == null ? null : (U.find((e) => rn(e) === F) ?? null),
    W = ae == null ? null : Yt(ae),
    G = w ?? W,
    K = (0, Y.useMemo)(
      () =>
        w == null
          ? W == null || ae == null || F == null
            ? null
            : Kt({
                anchor: W,
                body: Xt(ae),
      ...
      [s, w, E, W, ae, F, f, p, m, _],
    ),
    ce = G == null ? null : Zt({ anchor: G, layer: S, pageSize: p }),
    le = G != null,
    q = (0, Y.useCallback)(() => {
      (w != null && o?.(f, !1), T(null), j(null), P(null), D(``), I(null), z(!1));
    }, [w, o, f]),
    ...
    pe = (0, Y.useCallback)(() => {
      typeof window > `u` ||
        de({ animationFrameRef: x, animationWindow: window, editorWrapper: b.current });
    }, []),
    he = (0, Y.useCallback)(
      () =>
        K == null
    ...
    ve = (0, Y.useEffectEvent)(() => {
      if (G == null) return;
      let e = Zt({ anchor: G, layer: S, pageSize: p });
      e != null && _e(b.current, e);
    });
  (0, Y.useEffect)(() => {
    if (!le || S == null) return;
  ...
  let be = (0, Y.useEffectEvent)(() => {
    ...
    ((w != null || F != null) && !he()) || (j(n), T(null), D(``), I(null), L(null), P(null), z(!1));
  });
  (0, Y.useEffect)(() => {
    if (S == null || t) return;
    let e = S.parentElement;
  ...
  let xe = (e, n, r) => {
    ...
    we = (0, Y.useEffectEvent)((e, t) => {
      if (w != null || F != null || !ge(e)) return;
      let n = ft({ pageElement: t, pageSize: p }) ?? (A?.selectionKind === `text` ? null : A);
      n != null && (e.preventDefault(), e.stopPropagation(), Se(n, `ask_codex_shortcut`));
    });
  (0, Y.useEffect)(() => {
    if (S == null || t) return;
    let e = S.parentElement;
  ...
  let De = (e) => {
      ((w != null || F != null) && !he()) || Se(e, `annotation_mode_pointer`);
    },
    Oe = (e) => {
    ...
    Ae = (e) => {
      ...
      let n = { ...O, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
        ...
        i = mt(n, r);
      if (!r) {
        let t = xe(e.clientX, e.clientY, !0);
        if (t != null) {
          (k(null), De(t));
          return;
        }
      ...
      (Se(i, `annotation_mode_pointer`), k(null));
    },
    je = async (e, { submitDirectly: i = !1 } = {}) => {
      let o = e.body.trim();
      if (F != null) {
        if (o.length === 0 || te) return;
        (a((e) =>
          e.map((e) => (rn(e) === F ? { ...e, content: [{ content_type: `text`, text: o }] } : e)),
        ),
          q());
        return;
      }
      if (!(w == null || o.length === 0 || te))
        try {
          B(!0);
          let d = qt({ anchor: w, pageSize: p }),
            y = crypto.randomUUID(),
            b;
          try {
            b = await Qt({
          ...
          (re(v, oe, { commentType: d.kind, submitMode: i ? `direct` : `saved` }),
            Me(
              v,
              { artifactTabId: h, artifactType: `pdf`, importKind: `pdf`, threadId: g },
              {
                annotationModeEnabled: t,
                annotationTargetKind: d.kind,
  ...
  return (0, X.jsxs)(`div`, {
    ref: C,
    className: N(`absolute inset-0 z-[3]`, !t && `pointer-events-none`),
    "data-testid": `artifact-pdf-comment-layer`,
    style: t ? { cursor: me } : void 0,
    onPointerDown: Oe,
    onPointerMove: ke,
    onPointerUp: Ae,
    onPointerCancel: () => {
    ...
    children: [
      U.map((e) =>
        (0, X.jsx)(
          Bt,
          {
            ...
            isSelected: rn(e) === F,
            onEdit: (e) => {
              (w != null && o?.(f, !1), T(null), j(null), P(null), D(``), z(!1), L(null), I(e));
            },
            onPreviewChange: L,
          },
          rn(e),
      ...
      ie == null || F != null ? null : (0, X.jsx)(Vt, { comment: ie, layer: S }),
      ...
      A != null && w == null
        ? (0, X.jsx)(Ee, {
            ...
            onClick: () => Se(A, `ask_codex_button`),
          })
        : null,
      O == null ? null : (0, X.jsx)(Wt, { rect: gt(O.start, O.current), pageSize: p }),
      w == null ? null : (0, X.jsx)(Ht, { anchor: w, label: n, pageSize: p }),
      G == null || ce == null || K == null
        ? null
        : (0, X.jsx)(`div`, {
            ref: b,
            className: Ce,
            style: { left: ce.x, top: ce.y, height: J, width: 294 },
            ...
            children: (0, X.jsx)(
              ue,
              {
                ...
                onCancel: q,
                onDelete: (e) => {
                  (a((t) => t.filter((t) => rn(t) !== e)), q());
                },
                onDirectSubmit: (e) => {
                  je(e, { submitDirectly: !0 });
                },
                onEscape: q,
                onBodyChange: K.target.mode === `create` ? fe : void 0,
...
function Ut(e) {
  ...
  return (
    t[12] !== n.rect || t[13] !== o || t[14] !== i || t[15] !== a
      ? ((s = (0, X.jsx)(Te, { bordered: o, paddingPx: 4, pageSize: i, rect: n.rect, testId: a })),
        (t[12] = n.rect),
        (t[13] = o),
        (t[14] = i),
        (t[15] = a),
...
function Zt({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ? Se({ layer: t, pageSize: n, rect: e.rect })
    : fe({ layer: t, markerPoint: e.kind === `region` ? _t(e.rect) : e.point, pageSize: n });
}
async function Qt({
  anchor: e,
  commentId: t,
    ...
    ((jn = a()),
      ...
      (Pn = (0, Mn.memo)(function (e) {
        ...
        t[26] !== m
          ...
          : (z = t[27]),
          (0, Mn.useEffect)(R, z));
        let te = C == null ? void 0 : ``,
          B = S?.userUnit ?? 1,
          ne;
        t[28] !== E.height || t[29] !== E.width || t[30] !== D || t[31] !== B
          ? ((ne = { "--scale-factor": D, "--user-unit": B, height: E.height, width: E.width }),
            (t[28] = E.height),
            (t[29] = E.width),
            (t[30] = D),
            (t[31] = B),
        ...
        t[33] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((V = (0, Nn.jsx)(`canvas`, { ref: h, className: `absolute inset-0 size-full` })),
            (t[33] = V))
          : (V = t[33]);
        let H;
        t[34] !== M ||
        ...
        let ie;
        return (
          t[49] !== a || t[50] !== te || t[51] !== re || t[52] !== H || t[53] !== U
            ? ((ie = (0, Nn.jsxs)(`div`, {
                ref: g,
...
function In(e) {
  ...
  let N = M,
    F;
  t[21] !== N || t[22] !== x || t[23] !== j || t[24] !== r || t[25] !== i
    ? ((F = (e) => {
        if (e.key === `Escape`) {
          (e.preventDefault(), i());
          return;
  ...
  t[27] !== N || t[28] !== j
    ? ((ee = (e) => {
        ...
        e.clientX < t.left + t.width / 2 ? j() : N();
      }),
      (t[27] = N),
      (t[28] = j),
      (t[29] = ee))
  ...
  let te;
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((te = { kind: `page-width` }), (t[33] = te))
    : (te = t[33]);
  let B;
  t[34] !== k || t[35] !== w || t[36] !== o || t[37] !== s || t[38] !== z
    ? ((B = (0, Z.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = (0, Z.jsx)(L, { className: `icon-2xs rotate-180` })), (t[40] = re))
    : (re = t[40]);
  let V;
  t[41] !== j || t[42] !== E || t[43] !== ne
    ? ((V = (0, Z.jsx)(C, {
        "aria-label": E,
        color: `ghost`,
        disabled: ne,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, Z.jsx)(L, { className: `icon-2xs` })), (t[48] = ae))
    : (ae = t[48]);
  let W;
  t[49] !== N || t[50] !== O || t[51] !== ie
    ? ((W = (0, Z.jsx)(C, {
        "aria-label": O,
        color: `ghost`,
        disabled: ie,
  ...
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, Z.jsx)(P, { className: `icon-2xs` })),
      (K = (0, Z.jsx)(H, {
  ...
  let ue;
  return (
    t[63] !== R || t[64] !== I || t[65] !== y || t[66] !== B || t[67] !== q || t[68] !== c
      ? ((ue = (0, Z.jsxs)(`div`, {
          ref: y,
          "aria-label": c,
          autoFocus: !0,
...
var zn,
  ...
  Z,
  Vn = e(() => {
    ((zn = a()), (Bn = t(u(), 1)), V(), O(), j(), A(), K(), Fn(), (Z = m()));
  });
...
function Xn(e) {
  ...
  return (
    t[11] !== r || t[12] !== p
      ? ((m = (0, $.jsx)(b, { name: `PdfPreviewPanel`, resetKey: r, fallback: f, children: p })),
        (t[11] = r),
        (t[12] = p),
        (t[13] = m))
      : (m = t[13]),
...
function Zn(e) {
  let t = (0, rr.c)(125),
    ...
    D = (0, Q.useRef)(null),
    O;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((O = new Set()), (t[0] = O)) : (O = t[0]);
  let k = (0, Q.useRef)(O),
    [A, j] = (0, Q.useState)(!1),
    [N, P] = (0, Q.useState)(!1),
    [F, I] = (0, Q.useState)(null),
    L;
  t[1] === m.value ? (L = t[2]) : ((L = ie(m.value)), (t[1] = m.value), (t[2] = L));
  let R = L,
    B;
  t[3] === R ? (B = t[4]) : ((B = R ?? ne({ entrypoint: `home` })), (t[3] = R), (t[4] = B));
  let V = B,
    H = c(ke, V),
    U;
  t[5] !== V || t[6] !== m
  ...
  if (t[8] !== H || t[9] !== l) {
    ...
    (t[11] === l
      ? (e = t[12])
      : ((e = (e) => n(e) && e.localPdfContext?.path === l), (t[11] = l), (t[12] = e)),
      (oe = H.filter(e)),
      (t[8] = H),
      (t[9] = l),
      (t[10] = oe));
  ...
  (t[15] !== l || t[16] !== W
    ? ((q = () => () => {
        W((e) => {
          let t = e.filter((e) => !(n(e) && e.localPdfContext?.path === l));
    ...
    (0, Q.useEffect)(q, ue));
  let de;
  t[19] === i ? (de = t[20]) : ((de = { fileDataUrl: i }), (t[19] = i), (t[20] = de));
  let {
      loadedFileDataUrl: fe,
      loadState: pe,
      numPages: J,
      pageViewportSize: me,
      pdfDocument: he,
  ...
  t[21] === J
    ? (ge = t[22])
    : ((ge = { containerRef: _, pageSelector: `[data-artifact-pdf-page]`, totalPages: J }),
      (t[21] = J),
      (t[22] = ge));
  let { currentPage: _e, goToNextPage: ve, goToPreviousPage: ye } = Re(ge),
    be;
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((be = (e) => {
        ...
        C.current = Hn({ anchor: e, container: t, pageSelector: `[data-artifact-pdf-page]` });
      }),
      (t[23] = be))
    : (be = t[23]);
  let xe = be,
    Se;
  t[24] !== me || t[25] !== F
    ? ((Se = { onBeforeZoom: xe, pageViewportSize: me, pageWidth: F }),
      (t[24] = me),
      (t[25] = F),
      (t[26] = Se))
    : (Se = t[26]);
  let {
    ...
    Fe;
  t[27] !== _e || t[28] !== we || t[29] !== De
    ? ((Fe = () => {
        let e =
          De.kind === `page-width`
            ? null
            : _.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${_e}"]`);
        (we(),
          e != null &&
  ...
  t[31] === Ce
    ...
    : ((ze = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = D.current;
        n !== t && (n != null && (xe({ kind: `center` }), Ce()), (D.current = t), I(t));
      }),
      (t[31] = Ce),
      (t[32] = ze));
  let Be = ce(ze),
  ...
  t[36] === He
    ...
    : ((Ue = () => {
      ...
      (t[37] = Ue));
  let We;
  (t[38] !== me || t[39] !== F || t[40] !== De || t[41] !== He
    ? ((We = [me, F, De, He]), (t[38] = me), (t[39] = F), (t[40] = De), (t[41] = He), (t[42] = We))
    : (We = t[42]),
  ...
  (t[43] === i
    ? ((Ge = t[44]), (Ke = t[45]))
    : ((Ge = () => {
        E.current !== i && ((E.current = i), xe({ kind: `center` }));
      }),
      (Ke = [xe, i]),
      (t[43] = i),
      (t[44] = Ge),
  ...
  t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Je = t[46]);
  let Ye;
  (t[47] === i ? (Ye = t[48]) : ((Ye = [i]), (t[47] = i), (t[48] = Ye)), (0, Q.useEffect)(Je, Ye));
  let Xe, Ze;
  (t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Xe = () => {
        let e = () => {
          document.fullscreenElement !== g.current && j(!1);
        };
        return (
  ...
  t[53] !== J || t[54] !== m
    ? ((rt = () => {
        ((b.current = !0), re(m, te, { pageCount: J }));
      }),
      (t[53] = J),
      (t[54] = m),
      (t[55] = rt))
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        (j(!1), document.fullscreenElement === g.current && document.exitFullscreen().catch(er));
      }),
      (t[61] = st))
    : (st = t[61]);
  let ct = st,
  ...
  let vt = _t,
    ...
    xt;
  t[72] !== N || t[73] !== m || t[74] !== f || t[75] !== R
    ? ((xt = () => {
        (bt(!1),
          N || Ne(m, { artifactTabId: f, artifactType: `pdf`, importKind: `pdf`, threadId: R }),
          P(Qn));
      }),
      (t[72] = N),
      (t[73] = m),
    ...
    : (xt = t[76]);
  let St;
  t[77] !== gt || t[78] !== vt || t[79] !== N || t[80] !== xt
    ? ((St = (0, $.jsx)(je, { active: N, activeLabel: vt, label: gt, onClick: xt })),
      (t[77] = gt),
      (t[78] = vt),
      (t[79] = N),
      (t[80] = xt),
                          ...
                          rightContent: (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, $.jsx)(S, {
                                ...
                                fitOption: { selected: De.kind === `page-width`, onSelect: Le },
                              }),
                              r === `default`
                                ? (0, $.jsxs)($.Fragment, {
                                    children: [
                                      (0, $.jsx)(w, { hostId: o, path: l, sizeBytes: u }),
                                      (0, $.jsx)(y, {
                                        hostId: o,
                                        onBeforeOpen: s,
                                        path: l,
