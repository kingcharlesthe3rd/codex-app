const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./pdf-2.js", "./pdf-1.js", "./chunk.js", "./preload-helper.js"]),
) => i.map((i) => d[i]);
...
import "./isEqual.js";
import { Ar as s, Ot as c, kt as l } from "./src-1.js";
import { t as u } from "./preload-helper.js";
import "./react-dom.js";
import { c as d, o as f } from "./lib.js";
import { Dt as p, an as m, o as h } from "./persisted-signal.js";
import { t as g } from "./clsx-Cir5-jBH.js";
import "./proxy.js";
import { t as _ } from "./button-DO-oxX3-.js";
...
import { i as y, t as te } from "./route-scope.js";
...
import { t as x } from "./error-boundary.js";
import "./download.js";
...
import { n as S } from "./use-resize-observer.js";
...
import { t as ne } from "./use-diff-comments.js";
import { r as C } from "./right-panel-composer-overlay-scroll-reserve.js";
...
import { t as w } from "./annotation-mode-button.js";
import { i as T, r as E } from "./browser-sidebar-comment-light-dismiss.js";
...
import { a as D, i as O, n as k, r as A, s as j, t as M } from "./artifact-preview-header.js";
import "./plugins-availability.js";
import { t as N } from "./artifact-preview-status.js";
import {
  a as P,
  c as F,
  d as I,
...
function oe(e) {
  ...
  (t[0] !== n || t[1] !== r || t[2] !== i
    ? ((u = () => {
        ...
        let a = new Map(),
          l = new IntersectionObserver(
            (n) => {
              ...
              let r = Y({ container: e, pageElements: t, pageVisibilityByElement: a });
              r != null &&
        ...
        let u = Y({ container: e, pageElements: t, pageVisibilityByElement: a });
        return (
          u != null && o(u),
          () => {
    ...
    ? ((f = (e) => {
        ...
        let a = null,
          ...
          u = () => {
            ...
            ((s.current = null), l());
            let n = Y({ container: t, pageElements: se(t, r), pageVisibilityByElement: new Map() });
            n != null && o(n);
          },
          d = () => {
            (a != null && clearTimeout(a), (a = setTimeout(u, ae)));
          };
        ((c.current = l),
...
function Y({ container: e, pageElements: t, pageVisibilityByElement: n }) {
...
function de(e) {
  let t = (0, q.c)(9),
    ...
    [a, o] = (0, J.useState)(`loading`),
    [s, c] = (0, J.useState)(0),
    [l, u] = (0, J.useState)(null),
    [d, f] = (0, J.useState)(null),
    p,
    m;
  (t[0] === n
    ? ((p = t[1]), (m = t[2]))
...
async function Z() {
  ...
  le ??= u(() => import(`./pdf-2.js`), __vite__mapDeps([0, 1, 2, 3]), import.meta.url);
  let e = await le;
  return (
    (!ue || e.GlobalWorkerOptions.workerSrc !== X) &&
      ((e.GlobalWorkerOptions.workerSrc = X), (ue = !0)),
    e
  );
}
function fe(e) {
        ...
        let l = !1,
          ...
          d = async function () {
            ...
            let c = i.getViewport({ scale: 1 }),
              u = new pe({ linkNavigation: r, pageSelector: a, pdfDocument: o, scrollRootRef: s });
...
function ye(e, t) {
  ...
  return n.width <= 0 || n.height <= 0
    ? null
    : {
        x: Ve(((e.clientX - n.left) / n.width) * t.width, 0, t.width),
        y: Ve(((e.clientY - n.top) / n.height) * t.height, 0, t.height),
      };
}
function be({ pageElement: e, pageSize: t }) {
  let n = e.querySelector(`.textLayer`),
    r = e.ownerDocument.getSelection();
  if (n == null || r == null || r.isCollapsed || r.rangeCount === 0 || !Le(r, n)) return null;
  let i = Be(r.toString());
  if (i.length === 0) return null;
  let a = r.getRangeAt(0);
  if (!n.contains(a.commonAncestorContainer)) return null;
  let o = Array.from(a.getClientRects()),
    s = ke({ clientRects: o, pageElement: e, pageSize: t });
  if (s == null) return null;
  let c = Ae({ clientRects: o, pageElement: e, pageSize: t }),
    l = je({ clientRects: o, pageElement: e, pageSize: t, selection: r });
  return {
...
function xe({
  ...
  for (let o of i.ownerDocument.elementsFromPoint?.(e, t) ?? []) {
    ...
    let e = Te({ includePreviewMetadata: n, pageElement: i, pageSize: a, target: o });
    if (e != null) return e;
  }
  return null;
}
function Se(e, t = !1) {
  let n = we(e.start, e.current);
  return !t && n.width < ge && n.height < ge
    ? { kind: `point`, point: e.current }
    : { kind: `region`, rect: n };
}
function Ce(e) {
  return (
    Math.abs(e.clientCurrent.x - e.clientStart.x) >= _e ||
    Math.abs(e.clientCurrent.y - e.clientStart.y) >= _e
  );
}
function we(e, t) {
  return {
...
function Te({ includePreviewMetadata: e, pageElement: t, pageSize: n, target: r }) {
  let i = Ee(r, t);
  if (i == null) return null;
  let a = ke({ clientRects: [i.element.getBoundingClientRect()], pageElement: t, pageSize: n });
  if (a == null) return null;
  let o = e ? Re(i.element) : ``;
  return {
    kind: `region`,
...
function Ee(e, t) {
  ...
  let r = De(e, t, (e) => e.matches(`.annotationLayer a, .annotationLayer .linkAnnotation`));
  if (r != null) return { element: r, selectionKind: `link` };
  let i = De(e, t, (e) => e.matches(`.annotationLayer section`));
...
function ke({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = t.getBoundingClientRect();
  if (r.width <= 0 || r.height <= 0) return null;
  let i = Fe(e);
  if (i == null) return null;
  let a = Ve(((i.left - r.left) / r.width) * n.width, 0, n.width),
    o = Ve(((i.top - r.top) / r.height) * n.height, 0, n.height),
    s = Ve(((i.right - r.left) / r.width) * n.width, 0, n.width),
    c = Ve(((i.bottom - r.top) / r.height) * n.height, 0, n.height);
  return s <= a || c <= o ? null : { x: a, y: o, width: s - a, height: c - o };
}
function Ae({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = [];
  for (let i of Ne(e)) {
    let e = ke({ clientRects: [i], pageElement: t, pageSize: n });
    e != null && r.push(e);
  }
  return r;
}
function je({ clientRects: e, pageElement: t, pageSize: n, selection: r }) {
...
function Me({ clientX: e, clientY: t, pageElement: n, pageSize: r }) {
  let i = n.getBoundingClientRect();
  return {
    x: Ve(((e - i.left) / i.width) * r.width, 0, r.width),
    y: Ve(((t - i.top) / i.height) * r.height, 0, r.height),
  };
}
function Ne(e) {
  let t = [],
...
function Re(e) {
  ...
  return n.length > 0
    ? n
    : Be((e instanceof HTMLAnchorElement ? e : e.querySelector(`a`))?.href ?? ``);
}
function ze(e, t) {
  if (e.nodeType === Node.TEXT_NODE) {
    let n = Be(e.textContent ?? ``);
    n.length > 0 && t.push(n);
    return;
  }
  for (let n of e.childNodes) ze(n, t);
}
function Be(e) {
  return e.replace(/\s+/g, ` `).trim().slice(0, ve);
}
function Ve(e, t, n) {
...
function Ue({
  ...
  let y = i(a),
    ...
    ce = (0, J.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === m), [e, m]),
    Y = H == null ? null : (ce.find((e) => st(e) === H) ?? null),
    X = I == null ? null : (ce.find((e) => st(e) === I) ?? null),
    le = X == null ? null : $e(X),
    ue = C ?? le,
    de = (0, J.useMemo)(
      () =>
        C == null
          ? le == null || X == null || I == null
            ? null
            : Xe({
                anchor: le,
                body: et(X),
      ...
      [l, C, D, le, X, I, m, _, v, ee],
    ),
    Z = ue == null ? null : tt({ anchor: ue, layer: S, pageSize: _ }),
    fe = ue != null,
    pe = (0, J.useCallback)(() => {
      (C != null && s?.(m, !1), w(null), M(null), P(null), O(``), L(null), G(!1));
    }, [C, s, m]),
    ...
    he = (0, J.useCallback)(() => {
      typeof window > `u` ||
        E({ animationFrameRef: x, animationWindow: window, editorWrapper: b.current });
    }, []),
    ge = (0, J.useCallback)(
      () =>
        de == null
          ? !1
          : de.target.mode === `create` && D.trim().length > 0
            ? W
              ? (pe(), !0)
              : (G(!0), he(), !1)
            : (pe(), !0),
    ...
    _e = (0, J.useEffectEvent)(() => {
      if (ue == null) return;
      let e = tt({ anchor: ue, layer: S, pageSize: _ });
      e != null && re(b.current, e);
    });
  (0, J.useEffect)(() => {
    if (!fe || S == null) return;
  ...
  (0, J.useEffect)(() => {
    if (t || de?.target.mode !== `create` || S == null) return;
    let e = S.ownerDocument,
      n = (e) => {
        ve(e);
      };
  ...
  let $ = (0, J.useEffectEvent)(() => {
    if (t || S == null) return;
    let e = S.parentElement;
    if (e == null) return;
    let n = be({ pageElement: e, pageSize: _ });
    if (n == null) {
      M(null);
      return;
    }
    ((C != null || I != null) && !ge()) || (M(n), w(null), O(``), L(null), U(null), P(null), G(!1));
  });
  (0, J.useEffect)(() => {
    if (S == null || t) return;
    let e = S.parentElement;
  ...
  let Te = (e, n, r) => {
    ...
    Ee = (e) => {
      (C ?? s?.(m, !0), w(e), M(null), P(null), O(``), L(null), U(null), G(!1));
    },
    De = (0, J.useEffectEvent)((e, t) => {
      if (C != null || I != null || !B(e)) return;
      let n = be({ pageElement: t, pageSize: _ }) ?? (j?.selectionKind === `text` ? null : j);
      n != null && (e.preventDefault(), e.stopPropagation(), Ee(n));
    });
  (0, J.useEffect)(() => {
    if (S == null || t) return;
    let e = S.parentElement;
  ...
  let Oe = (e) => {
    ...
    je = (e) => {
      ...
      let t = ye(e, _) ?? k.current;
      (e.preventDefault(),
        e.stopPropagation(),
        e.currentTarget.hasPointerCapture(e.pointerId) &&
          e.currentTarget.releasePointerCapture(e.pointerId));
      let n = { ...k, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
        r = Ce(n),
        i = Se(n, r);
      if (!r) {
        let t = Te(e.clientX, e.clientY, !0);
        if (t != null) {
          (A(null), Oe(t));
          return;
        }
      }
      if (C != null && i.kind === `point`) {
        (ge(), A(null));
        return;
      }
      (Ee(i), A(null));
    },
    Me = async (e, { submitDirectly: t = !1 } = {}) => {
      let i = e.body.trim();
      if (I != null) {
        if (i.length === 0 || q) return;
        (r((e) =>
          e.map((e) => (st(e) === I ? { ...e, content: [{ content_type: `text`, text: i }] } : e)),
        ),
          pe());
        return;
      }
      if (!(C == null || i.length === 0 || q))
        try {
          ie(!0);
          let e = Ze({ anchor: C, pageSize: _ }),
            a = crypto.randomUUID(),
            s;
          try {
            s = await nt({
          ...
          (h(y, p, { commentType: e.kind, submitMode: t ? `direct` : `saved` }),
            t
  ...
  return (0, Q.jsxs)(`div`, {
    ref: ne,
    className: g(`absolute inset-0 z-[3]`, !t && `pointer-events-none`),
    "data-testid": `artifact-pdf-comment-layer`,
    style: t ? { cursor: F } : void 0,
    onPointerDown: ke,
    onPointerMove: Ae,
    onPointerUp: je,
    onPointerCancel: () => {
    ...
    children: [
      ce.map((e) =>
        (0, Q.jsx)(
          We,
          {
            ...
            isSelected: st(e) === I,
            onEdit: (e) => {
              (C != null && s?.(m, !1), w(null), M(null), P(null), O(``), G(!1), U(null), L(e));
            },
            onPreviewChange: U,
          },
          st(e),
      ...
      Y == null || I != null ? null : (0, Q.jsx)(Ge, { comment: Y, layer: S }),
      N != null && C == null && I == null
        ? (0, Q.jsx)(R, {
            paddingPx: 4,
            pageSize: _,
            rect: N.rect,
      ...
      j != null && C == null
        ...
        : null,
      k == null ? null : (0, Q.jsx)(Je, { rect: we(k.start, k.current), pageSize: _ }),
      C == null ? null : (0, Q.jsx)(Ke, { anchor: C, label: n, pageSize: _ }),
      ue == null || Z == null || de == null
        ? null
        : (0, Q.jsx)(`div`, {
            ref: b,
            className: K,
            style: { left: Z.x, top: Z.y, height: z, width: 294 },
            ...
            children: (0, Q.jsx)(
              T,
              {
                ...
                onCancel: pe,
                onDelete: (e) => {
                  (r((t) => t.filter((t) => st(t) !== e)), pe());
                },
                onDirectSubmit: (e) => {
                  Me(e, { submitDirectly: !0 });
                },
                onEscape: pe,
                onBodyChange: de.target.mode === `create` ? me : void 0,
                onLightDismissibilityChange: He,
                onMounted: He,
                onSubmit: (e) => {
                  Me(e);
                },
...
function We(e) {
  ...
  if (s == null) return null;
  let c;
  t[0] === n ? (c = t[1]) : ((c = st(n)), (t[0] = n), (t[1] = c));
  let l = c,
    u;
  ...
  if (s.kind === `region`) {
    ...
    t[15] !== s.selectionRects
      ? ((e =
          s.selectionKind == null
            ? (0, Q.jsx)(Je, { rect: s.pageRect, pageSize: s.pageSize })
            : (0, Q.jsx)(qe, {
                bordered: !0,
                anchor: {
                  kind: `region`,
    ...
    t[17] !== l || t[18] !== i
      ...
      : (o = t[19]);
    let c;
    t[20] === s.pageRect ? (c = t[21]) : ((c = $(s.pageRect)), (t[20] = s.pageRect), (t[21] = c));
    let u;
...
function Ge(e) {
  let t = (0, q.c)(9),
    { comment: n, layer: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = Qe(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
...
function Ke(e) {
    ...
    t[0] !== n || t[1] !== i
      ? ((e =
          n.selectionKind == null
            ? (0, Q.jsx)(Je, { rect: n.rect, pageSize: i })
            : (0, Q.jsx)(qe, {
                bordered: !0,
                anchor: n,
                pageSize: i,
      ...
      : (e = t[2]);
    let a;
    t[3] === n.rect ? (a = t[4]) : ((a = $(n.rect)), (t[3] = n.rect), (t[4] = a));
    let o;
    t[5] !== r || t[6] !== i || t[7] !== a
      ? ((o = (0, Q.jsx)(Ye, { draft: !0, label: r, point: a, pageSize: i })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = a),
        (t[8] = o))
  ...
  return (
    t[12] !== n.point || t[13] !== r || t[14] !== i
      ? ((a = (0, Q.jsx)(Ye, { draft: !0, label: r, point: n.point, pageSize: i })),
        (t[12] = n.point),
        (t[13] = r),
        (t[14] = i),
        (t[15] = a))
...
function Ze({ anchor: e, pageSize: t }) {
...
function Qe(e) {
  ...
  return t == null
    ? null
    : t.kind === `region`
      ? { pageSize: t.pageSize, point: $(t.pageRect) }
...
function tt({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ? I({ layer: t, pageSize: n, rect: e.rect })
    : L({ layer: t, markerPoint: e.kind === `region` ? $(e.rect) : e.point, pageSize: n });
}
async function nt({
  anchor: e,
  commentId: t,
  ...
  return (
    ...
    at({ anchor: e, context: u, crop: o, markerLabel: n, scale: s }),
    {
      commentId: t,
...
function rt(e, t) {
  ...
  return it({ x: e.point.x - 180, y: e.point.y - 120, width: 360, height: 240 }, t);
}
function it(e, t) {
  let n = Math.min(Math.max(e.width, 1), t.width),
    r = Math.min(Math.max(e.height, 1), t.height);
  return { x: ct(e.x, 0, t.width - n), y: ct(e.y, 0, t.height - r), width: n, height: r };
}
function at({ anchor: e, context: t, crop: n, markerLabel: r, scale: i }) {
  if (
    (t.save(),
    (t.strokeStyle = G),
    (t.fillStyle = G),
    ...
    let a = (e.rect.x - n.x) * i,
      ...
      s = e.rect.width * i,
      c = e.rect.height * i;
    (t.strokeRect(a, o, s, c), ot(t, r, a + s, o));
  } else ot(t, r, (e.point.x - n.x) * i, (e.point.y - n.y) * i);
  t.restore();
}
function ot(e, t, n, r) {
  (e.beginPath(),
...
var ut = { height: 792, width: 612 },
  dt = 0.3,
  ft = 8,
  pt = 1e-4,
  mt = 5,
  ht = 200,
  gt = [dt, 0.4, 0.5, 0.67, 0.75, 0.9, 1, 1.1, 1.25, 1.5, 1.75, 2, 2.5, 3, 4, 5, 6, 7, ft];
function _t(e) {
  let t = (0, q.c)(36),
  ...
  let y = ee,
    te;
  t[6] !== r || t[7] !== i
    ? ((te = (e) => yt({ pageViewportSize: r, pageWidth: i, resize: e })),
      (t[6] = r),
      (t[7] = i),
      (t[8] = te))
    : (te = t[8]);
  ...
  t[11] === y
    ? (ne = t[12])
    : ((ne = (e) => {
        y({ kind: `percentage`, value: St(e / 100) });
      }),
      (t[11] = y),
      (t[12] = ne));
  let C = ne,
  ...
  t[13] !== b || t[14] !== n
    ? ((w = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: xt(b(e), `out`) })));
      }),
      (t[13] = b),
      (t[14] = n),
      (t[15] = w))
  ...
  t[16] !== b || t[17] !== n
    ? ((E = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: xt(b(e), `in`) })));
      }),
      (t[16] = b),
      (t[17] = n),
      (t[18] = E))
  ...
  t[19] !== b || t[20] !== n
    ? ((O = (e) => {
        ...
        ((p.current = 0),
          ...
          g(),
          s((e) => ({ kind: `percentage`, value: xt(b(e), t) })));
      }),
      (t[19] = b),
      (t[20] = n),
      (t[21] = O))
  ...
  let k = O,
    A;
  t[22] !== b || t[23] !== o
    ? ((A = Math.round(b(o) * 100)), (t[22] = b), (t[23] = o), (t[24] = A))
    : (A = t[24]);
  let j;
  return (
    t[25] !== T ||
...
function yt({ pageViewportSize: e, pageWidth: t, resize: n }) {
  if (n.kind === `percentage`) return St(n.value);
  let r = e?.width ?? ut.width;
  return t == null || t <= 0 || r <= 0 ? 1 : St(t / r);
}
function bt({ pageViewportSize: e, pageWidth: t, resize: n }) {
  let r = e ?? ut,
    i = r.width / r.height,
    a =
      n.kind === `page-width` && t != null && t > 0
        ? t
        : r.width * yt({ pageViewportSize: e, pageWidth: t, resize: n });
  return { height: Math.round(a / i), width: Math.round(a) };
}
function xt(e, t) {
  let n = St(e);
  if (t === `in`) {
    for (let e of gt) if (e > n + pt) return e;
...
function St(e) {
  return Math.min(ft, Math.max(dt, e));
}
var Ct = (0, J.memo)(function (e) {
  let t = (0, q.c)(55),
    {
      commentLayer: n,
      currentPage: r,
    ...
    te = _?.pdfDocument === l,
    b = te ? _.page : null,
    x = te ? _.viewportSize : null,
    S = x ?? s,
    ne;
  t[0] !== c || t[1] !== u || t[2] !== S
    ? ((ne = bt({ pageViewportSize: S, pageWidth: c, resize: u })),
      (t[0] = c),
      (t[1] = u),
      (t[2] = S),
      (t[3] = ne))
    : (ne = t[3]);
  let C = ne,
    w = x != null && x.width > 0 ? C.width / x.width : 1,
    T = Math.abs(r - a),
    E = ee || T <= 2,
    D = ee || T <= 2,
    O = ee ? 50 : 50 + T * 40,
  ...
  (t[12] === d
    ...
    (0, J.useEffect)(P, F));
  let I;
  t[15] !== C.height || t[16] !== C.width || t[17] !== f || t[18] !== b || t[19] !== E
    ? ((I = () => {
        let e = h.current;
        if (e == null) return;
        if (b == null || !E) {
        ...
        if (f) return;
        let t = b.getViewport({ scale: 1 });
        if (t.width <= 0 || C.width <= 0 || C.height <= 0) return;
        let n = null,
          r = window.devicePixelRatio || 1,
          i = Math.ceil(C.width * r),
          a = Math.ceil(C.height * r);
        ((e.width = i), (e.height = a), e.getContext(`2d`)?.clearRect(0, 0, i, a));
        try {
          ((n = b.render({ canvas: e, viewport: b.getViewport({ scale: i / t.width }) })),
            n.promise.catch(wt));
        } catch {
          return;
        }
  ...
  let R = x == null ? void 0 : ``,
    z = b?.userUnit ?? 1,
    B;
  t[28] !== C.height || t[29] !== C.width || t[30] !== w || t[31] !== z
    ? ((B = { "--scale-factor": w, "--user-unit": z, height: C.height, width: C.width }),
      (t[28] = C.height),
      (t[29] = C.width),
      (t[30] = w),
      (t[31] = z),
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, Q.jsx)(`canvas`, { ref: h, className: `absolute inset-0 size-full` })), (t[33] = H))
    : (H = t[33]);
  let U;
  t[34] !== k ||
  t[35] !== f ||
  ...
  t[42] !== O
    ...
    : (U = t[43]);
  let W;
  t[44] !== n || t[45] !== x || t[46] !== b || t[47] !== a
    ? ((W =
        b == null || x == null || n == null
          ? null
          : (0, Q.jsx)(
              Ue,
              {
  ...
  let G;
  return (
    t[49] !== a || t[50] !== R || t[51] !== V || t[52] !== U || t[53] !== W
      ? ((G = (0, Q.jsxs)(`div`, {
          ref: g,
...
function Tt(e) {
  let t = (0, q.c)(70),
    ...
    u = (0, J.useRef)(null),
    p;
  t[0] !== n || t[1] !== r ? ((p = Dt(n, r)), (t[0] = n), (t[1] = r), (t[2] = p)) : (p = t[2]);
  let [m, h] = (0, J.useState)(p),
    [g, ee] = (0, J.useState)(null),
    y;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = (e) => {
        ee({ height: Math.floor(e.contentRect.height), width: Math.floor(e.contentRect.width) });
      }),
      (t[3] = y))
    : (y = t[3]);
  let te = S(y),
  ...
  let w = C,
    T;
  t[8] !== w || t[9] !== a
    ? ((T = { onExternalLink: a, onPageChange: w }), (t[8] = w), (t[9] = a), (t[10] = T))
    : (T = t[10]);
  let E = T,
    D;
  t[11] === l
  ...
  let F = P,
    I;
  t[21] !== F || t[22] !== w || t[23] !== N || t[24] !== r || t[25] !== i
    ? ((I = (e) => {
        if (e.key === `Escape`) {
          (e.preventDefault(), i());
          return;
  ...
  let z = R,
    B;
  t[30] !== o || t[31] !== g
    ? ((B = Et({ pageViewportSize: o, presentationSize: g })),
      (t[30] = o),
      (t[31] = g),
      (t[32] = B))
    : (B = t[32]);
  let V;
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = { kind: `page-width` }), (t[33] = V))
    : (V = t[33]);
  let H;
  t[34] !== j || t[35] !== E || t[36] !== o || t[37] !== s || t[38] !== B
    ? ((H = (0, Q.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((W = (0, Q.jsx)(v, { className: `icon-2xs rotate-180` })), (t[40] = W))
    : (W = t[40]);
  let G;
  t[41] !== N || t[42] !== O || t[43] !== U
    ? ((G = (0, Q.jsx)(_, {
        "aria-label": O,
        color: `ghost`,
        disabled: U,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ie = (0, Q.jsx)(v, { className: `icon-2xs` })), (t[48] = ie))
    : (ie = t[48]);
  let ae;
  t[49] !== F || t[50] !== A || t[51] !== re
    ? ((ae = (0, Q.jsx)(_, {
        "aria-label": A,
        color: `ghost`,
        disabled: re,
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, Q.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })), (t[53] = oe))
    : (oe = t[53]);
  let se, ce;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (0, Q.jsx)(b, { className: `icon-2xs` })),
      (ce = (0, Q.jsx)(f, {
  ...
  let le;
  return (
    t[63] !== z || t[64] !== L || t[65] !== ne || t[66] !== H || t[67] !== X || t[68] !== c
      ? ((le = (0, Q.jsxs)(`div`, {
          ref: ne,
          "aria-label": c,
          autoFocus: !0,
...
function Et({ pageViewportSize: e, presentationSize: t }) {
  let n = e?.width ?? 612,
    r = e?.height ?? 792;
...
function Ot({ anchor: e, container: t, pageSelector: n }) {
  let r = t.getBoundingClientRect(),
    i = e.kind === `point` ? e.clientX : r.left + r.width / 2,
    a = e.kind === `point` ? e.clientY : r.top + r.height / 2,
    o = At({ anchorClientX: i, anchorClientY: a, container: t, pageSelector: n });
  ...
  return c.width <= 0 || c.height <= 0
    ...
    : {
        ...
        pageNumber: s,
        ratioX: Pt((i - c.left) / c.width),
        ratioY: Pt((a - c.top) / c.height),
      };
}
function kt({ anchorState: e, container: t, pageSelector: n }) {
  let r = jt({ container: t, pageNumber: e.pageNumber, pageSelector: n });
  if (r == null) return !1;
  let i = t.getBoundingClientRect(),
...
function At({ anchorClientX: e, anchorClientY: t, container: n, pageSelector: r }) {
  ...
  for (let i of Mt(n, r)) {
    let n = i.getBoundingClientRect(),
      r = Nt({ max: n.bottom, min: n.top, value: t }) + Nt({ max: n.right, min: n.left, value: e });
    r < s && ((s = r), (o = i));
  }
  return o;
}
function jt({ container: e, pageNumber: t, pageSelector: n }) {
  return Mt(e, n).find((e) => Number(e.dataset.pageNumber) === t) ?? null;
}
function Mt(e, t) {
  return Array.from(e.querySelectorAll(t));
}
function Nt({ max: e, min: t, value: n }) {
...
function Ft(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (l = t[0]);
  let u;
  t[1] !== n || t[2] !== r || t[3] !== i || t[4] !== a || t[5] !== o || t[6] !== s || t[7] !== c
    ? ((u = (0, Q.jsx)(It, {
        fileDataUrl: n,
        headerRightContent: r,
        hostId: i,
  ...
  return (
    t[9] !== n || t[10] !== u
      ? ((d = (0, Q.jsx)(x, { name: `PdfPreviewPanel`, resetKey: n, fallback: l, children: u })),
        (t[9] = n),
        (t[10] = u),
        (t[11] = d))
      : (d = t[11]),
...
function It(e) {
  let t = (0, q.c)(112),
    ...
    P = (0, J.useRef)(null),
    F;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((F = new Set()), (t[0] = F)) : (F = t[0]);
  let I = (0, J.useRef)(F),
    [L, R] = (0, J.useState)(!1),
    [z, B] = (0, J.useState)(!1),
  ...
  t[1] === g.value
    ? (U = t[2])
    : ((U = y(g.value) ?? s(`new-conversation`)), (t[1] = g.value), (t[2] = U));
  let W = U,
    [G, K] = ne(W),
    re;
  if (t[3] !== G || t[4] !== u) {
    ...
    (t[6] === u
      ? (e = t[7])
      : ((e = (e) => l(e) && e.localPdfContext?.path === u), (t[6] = u), (t[7] = e)),
      (re = G.filter(e)),
      (t[3] = G),
      (t[4] = u),
      (t[5] = re));
  ...
  let ie = re,
    ae;
  t[8] === ie ? (ae = t[9]) : ((ae = Math.max(0, ...ie.map(Bt))), (t[8] = ie), (t[9] = ae));
  let se = ae + 1,
    ce,
    Y;
  (t[10] !== u || t[11] !== K
    ...
    (0, J.useEffect)(ce, Y));
  let X;
  t[14] === n ? (X = t[15]) : ((X = { fileDataUrl: n }), (t[14] = n), (t[15] = X));
  let {
      loadedFileDataUrl: le,
      loadState: ue,
      numPages: Z,
      pageViewportSize: fe,
      pdfDocument: pe,
  ...
  t[16] === Z
    ? (me = t[17])
    : ((me = { containerRef: b, pageSelector: `[data-artifact-pdf-page]`, totalPages: Z }),
      (t[16] = Z),
      (t[17] = me));
  let { currentPage: he, goToNextPage: ge, goToPreviousPage: _e } = oe(me),
    ve;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ve = (e) => {
        ...
        T.current = Ot({ anchor: e, container: t, pageSelector: `[data-artifact-pdf-page]` });
      }),
      (t[18] = ve))
    : (ve = t[18]);
  let ye = ve,
    be;
  t[19] !== fe || t[20] !== V
    ? ((be = { onBeforeZoom: ye, pageViewportSize: fe, pageWidth: V }),
      (t[19] = fe),
      (t[20] = V),
      (t[21] = be))
    : (be = t[21]);
  let {
    ...
    Oe;
  t[22] !== he || t[23] !== Se || t[24] !== $
    ? ((Oe = () => {
        let e =
          $.kind === `page-width`
            ? null
            : b.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${he}"]`);
        (Se(),
          e != null &&
  ...
  t[26] === xe
    ...
    : ((Ae = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = P.current;
        n !== t && (n != null && (ye({ kind: `center` }), xe()), (P.current = t), H(t));
      }),
      (t[26] = xe),
      (t[27] = Ae));
  let je = S(Ae),
  ...
  t[31] === Ne
    ...
    : ((Pe = () => {
      ...
      (t[32] = Pe));
  let Fe;
  (t[33] !== fe || t[34] !== V || t[35] !== $ || t[36] !== Ne
    ? ((Fe = [fe, V, $, Ne]), (t[33] = fe), (t[34] = V), (t[35] = $), (t[36] = Ne), (t[37] = Fe))
    : (Fe = t[37]),
    (0, J.useLayoutEffect)(Pe, Fe));
  let Ie, Le;
  (t[38] === n
    ? ((Ie = t[39]), (Le = t[40]))
    : ((Ie = () => {
        E.current !== n && ((E.current = n), ye({ kind: `center` }));
      }),
      (Le = [ye, n]),
      (t[38] = n),
      (t[39] = Ie),
      (t[40] = Le)),
    (0, J.useLayoutEffect)(Ie, Le));
  let Re;
  t[41] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Re = t[41]);
  let ze;
  (t[42] === n ? (ze = t[43]) : ((ze = [n]), (t[42] = n), (t[43] = ze)), (0, J.useEffect)(Re, ze));
  let Be, Ve;
  (t[44] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Be = () => {
        let e = () => {
          document.fullscreenElement !== v.current && R(!1);
        };
        return (
  ...
  t[46] === Ce
    ...
    : ((He = (e) => {
        let t = b.current;
        t !== e &&
          (t?.removeEventListener(`wheel`, Ce),
          (b.current = e),
          e?.addEventListener(`wheel`, Ce, { passive: !1 }));
      }),
      (t[46] = Ce),
      (t[47] = He));
  let Ue = He,
  ...
  t[48] !== Z || t[49] !== g
    ? ((qe = () => {
        ((x.current = !0), h(g, m, { pageCount: Z }));
      }),
      (t[48] = Z),
      (t[49] = g),
      (t[50] = qe))
    : (qe = t[50]);
  let Je = (0, J.useEffectEvent)(qe),
    Ye;
  t[51] !== Je || t[52] !== Ge
    ? ((Ye = () => {
        !Ge || x.current || Je();
    ...
    : (Ye = t[53]);
  let Xe;
  (t[54] === Ge ? (Xe = t[55]) : ((Xe = [Ge]), (t[54] = Ge), (t[55] = Xe)),
    (0, J.useEffect)(Ye, Xe));
  let Ze;
  t[56] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ze = () => {
        (R(!1), document.fullscreenElement === v.current && document.exitFullscreen().catch(zt));
      }),
      (t[56] = Ze))
    : (Ze = t[56]);
  let Qe = Ze,
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (dt = t[67]);
  let ft;
  t[68] !== ot || t[69] !== ct || t[70] !== z
    ? ((ft = (0, Q.jsx)(w, { active: z, activeLabel: ct, label: ot, onClick: dt })),
      (t[68] = ot),
      (t[69] = ct),
      (t[70] = z),
      (t[71] = ft))
                          ...
                          rightContent: (0, Q.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, Q.jsx)(D, {
                                ...
                                fitOption: { selected: $.kind === `page-width`, onSelect: ke },
                              }),
                              (0, Q.jsx)(M, { hostId: a, path: u, sizeBytes: f }),
                              (0, Q.jsx)(A, { hostId: a, onBeforeOpen: c, path: u, showLabel: !0 }),
                              r,
                            ],
                          }),
                        })
