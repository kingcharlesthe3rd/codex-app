...
function zt({
  ...
  let v = a(r),
    ...
    U = (0, Y.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === u), [e, u]),
    ...
    le = G != null,
    q = (0, Y.useCallback)(() => {
      (w != null && o?.(u, !1), T(null), j(null), N(null), D(``), ee(null), R(!1));
    }, [w, o, u]),
    ...
    me = (0, Y.useCallback)(() => {
      typeof window > `u` ||
        ue({ animationFrameRef: x, animationWindow: window, editorWrapper: b.current });
    }, []),
    he = (0, Y.useCallback)(
      () =>
        K == null
  ...
  let be = (e, n, r) => {
    ...
    xe = (e, n) => {
      (Pe(
        v,
        { artifactTabId: m, artifactType: `pdf`, importKind: `pdf`, threadId: h },
    ...
    Se = (0, Y.useEffectEvent)((e, t) => {
      ...
      let n = ft({ pageElement: t, pageSize: f }) ?? (A?.selectionKind === `text` ? null : A);
      n != null && (e.preventDefault(), e.stopPropagation(), xe(n, `ask_codex_shortcut`));
    });
  (0, Y.useEffect)(() => {
    if (S == null || t) return;
    let e = S.parentElement;
  ...
  let Ee = (e) => {
    ...
    je = async (e, { submitDirectly: r = !1 } = {}) => {
      ...
      if (P != null) {
        ...
        (i((e) =>
          e.map((e) => (rn(e) === P ? { ...e, content: [{ content_type: `text`, text: a }] } : e)),
        ),
          q());
        return;
      }
      if (!(w == null || a.length === 0 || z))
        try {
          ...
          (re(v, ie, { commentType: o.kind, submitMode: r ? `direct` : `saved` }),
            Me(
              v,
              { artifactTabId: m, artifactType: `pdf`, importKind: `pdf`, threadId: h },
              {
  ...
  return (0, X.jsxs)(`div`, {
    ...
    children: [
      U.map((e) =>
        (0, X.jsx)(
          Bt,
          {
            ...
            isSelected: rn(e) === P,
            onEdit: (e) => {
              (w != null && o?.(u, !1), T(null), j(null), N(null), D(``), R(!1), te(null), ee(e));
            },
            onPreviewChange: te,
          },
          rn(e),
      ...
      ae == null || P != null ? null : (0, X.jsx)(Vt, { comment: ae, layer: S }),
      ...
      A != null && w == null
        ...
        : null,
      O == null ? null : (0, X.jsx)(Wt, { rect: gt(O.start, O.current), pageSize: f }),
...
function Ut(e) {
  ...
  return (
    t[12] !== n.rect || t[13] !== o || t[14] !== i || t[15] !== a
      ? ((s = (0, X.jsx)(we, { bordered: o, paddingPx: 4, pageSize: i, rect: n.rect, testId: a })),
        (t[12] = n.rect),
        (t[13] = o),
        (t[14] = i),
        (t[15] = a),
...
function Zt({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ...
    : xe({ layer: t, markerPoint: e.kind === `region` ? _t(e.rect) : e.point, pageSize: n });
}
async function Qt({
  anchor: e,
  commentId: t,
  ...
  Fn = e(() => {
    ((jn = p()),
      ...
      (Pn = (0, Mn.memo)(function (e) {
        ...
        let ie;
        return (
          t[49] !== a || t[50] !== z || t[51] !== re || t[52] !== H || t[53] !== U
            ? ((ie = (0, Nn.jsxs)(`div`, {
                ref: g,
...
function In(e) {
  ...
  let x = b,
    C;
  t[8] !== x || t[9] !== a
    ? ((C = { onExternalLink: a, onPageChange: x }), (t[8] = x), (t[9] = a), (t[10] = C))
    : (C = t[10]);
  let w = C,
    T;
  t[11] === l
  ...
  let de;
  return (
    t[63] !== R || t[64] !== I || t[65] !== y || t[66] !== ne || t[67] !== ue || t[68] !== c
      ? ((de = (0, Z.jsxs)(`div`, {
          ref: y,
          "aria-label": c,
          autoFocus: !0,
...
function Xn(e) {
  ...
  return (
    t[11] !== r || t[12] !== p
      ? ((m = (0, $.jsx)(je, { name: `PdfPreviewPanel`, resetKey: r, fallback: f, children: p })),
        (t[11] = r),
        (t[12] = p),
        (t[13] = m))
      : (m = t[13]),
...
function Zn(e) {
  let t = (0, rr.c)(125),
    ...
    E = (0, Q.useRef)(null),
    D;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((D = new Set()), (t[0] = D)) : (D = t[0]);
  let k = (0, Q.useRef)(D),
    [N, F] = (0, Q.useState)(!1),
    [I, te] = (0, Q.useState)(!1),
    [L, R] = (0, Q.useState)(null),
    z;
  t[1] === m.value ? (z = t[2]) : ((z = oe(m.value)), (t[1] = m.value), (t[2] = z));
  let B = z,
    V;
  t[3] === B ? (V = t[4]) : ((V = B ?? ce({ entrypoint: `home` })), (t[3] = B), (t[4] = V));
  let H = V,
    U = i(b, H),
    ie;
  t[5] !== H || t[6] !== m
  ...
  if (t[8] !== U || t[9] !== l) {
    ...
    (t[11] === l
      ? (e = t[12])
      : ((e = (e) => f(e) && e.localPdfContext?.path === l), (t[11] = l), (t[12] = e)),
      (G = U.filter(e)),
      (t[8] = U),
      (t[9] = l),
      (t[10] = G));
  ...
  let le = G,
    ue;
  t[13] === le ? (ue = t[14]) : ((ue = Math.max(0, ...le.map(tr))), (t[13] = le), (t[14] = ue));
  let de = ue + 1,
    fe,
    q;
  (t[15] !== l || t[16] !== W
  ...
  t[21] === J
    ? (ye = t[22])
    : ((ye = { containerRef: _, pageSelector: `[data-artifact-pdf-page]`, totalPages: J }),
      (t[21] = J),
      (t[22] = ye));
  ...
  t[27] !== be || t[28] !== De || t[29] !== Ae
    ? ((Fe = () => {
        let e =
          Ae.kind === `page-width`
            ? null
            : _.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${be}"]`);
        (De(),
          e != null &&
  ...
  t[31] === Ee
    ...
    : ((ze = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = E.current;
        n !== t && (n != null && (we({ kind: `center` }), Ee()), (E.current = t), R(t));
      }),
      (t[31] = Ee),
      (t[32] = ze));
  let Be = S(ze),
  ...
  (t[38] !== _e || t[39] !== L || t[40] !== Ae || t[41] !== He
    ? ((We = [_e, L, Ae, He]), (t[38] = _e), (t[39] = L), (t[40] = Ae), (t[41] = He), (t[42] = We))
    : (We = t[42]),
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        (F(!1), document.fullscreenElement === g.current && document.exitFullscreen().catch(er));
      }),
      (t[61] = st))
    : (st = t[61]);
  let ct = st,
  ...
  t[72] !== I || t[73] !== m || t[74] !== d || t[75] !== B
    ? ((xt = () => {
        (bt(!1),
          I || Ne(m, { artifactTabId: d, artifactType: `pdf`, importKind: `pdf`, threadId: B }),
          te(Qn));
      }),
      (t[72] = I),
      (t[73] = m),
  ...
  t[77] !== gt || t[78] !== vt || t[79] !== I || t[80] !== xt
    ? ((St = (0, $.jsx)(me, { active: I, activeLabel: vt, label: gt, onClick: xt })),
      (t[77] = gt),
      (t[78] = vt),
      (t[79] = I),
      (t[80] = xt),
                          ...
                          rightContent: (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, $.jsx)(w, {
                                ...
                                fitOption: { selected: Ae.kind === `page-width`, onSelect: Le },
                              }),
                              n === `default`
                                ? (0, $.jsxs)($.Fragment, {
                                    children: [
                                      (0, $.jsx)(j, { hostId: s, path: l, sizeBytes: u }),
                                      (0, $.jsx)(M, {
                                        hostId: s,
                                        onBeforeOpen: c,
                                        path: l,
