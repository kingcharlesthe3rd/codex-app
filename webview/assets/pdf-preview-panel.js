...
import { St as t, xt as n, zr as r } from "./src-C.js";
...
import { G as l, S as u, U as d, X as f, wt as p, y as m } from "./setting-storage.js";
import "./known-app-icon.js";
import "./branch.js";
import "./github-mark.js";
import "./google-drive.js";
import "./notion.js";
import { t as h } from "./product-logger.js";
import "./rpc.js";
import "./statsig.js";
import "./request.js";
...
import { i as _, t as v } from "./route-scope.js";
...
import "./check-md.js";
import { t as C } from "./chevron-right.js";
...
import { t as O } from "./annotation-mode-button.js";
import "./drag.js";
import "./link.js";
...
import { a as k, i as A, n as j, r as M, s as N, t as P } from "./artifact-preview-header.js";
...
async function J() {
  ...
  G ??= i(() => import(`./pdf-1.js`), __vite__mapDeps([0, 1, 2, 3]), import.meta.url);
  let e = await G;
  return (
    (!K || e.GlobalWorkerOptions.workerSrc !== W) &&
      ((e.GlobalWorkerOptions.workerSrc = W), (K = !0)),
    e
  );
}
function Y(e) {
        ...
        let l = !1,
          ...
          d = async function () {
            ...
            let c = i.getViewport({ scale: 1 }),
              u = new ie({ linkNavigation: r, pageSelector: a, pdfDocument: o, scrollRootRef: s });
...
function $({
  ...
  let y = f(u),
    ...
    S = (0, U.useRef)(null),
    C = (0, U.useRef)(null),
    [E, D] = (0, U.useState)(null),
    [O, k] = (0, U.useState)(``),
    [A, j] = (0, U.useState)(null),
    [M, N] = (0, U.useState)(null),
    [P, F] = (0, U.useState)(null),
    [I, L] = (0, U.useState)(!1),
    [R, z] = (0, U.useState)(!1),
    ee = b.formatMessage({
    ...
    te = (0, U.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === p), [e, p]),
    re = t ? te : [],
    H = P == null ? null : (re.find((e) => Oe(e) === P) ?? null),
    W = M == null ? null : (re.find((e) => Oe(e) === M) ?? null),
    G = W == null ? null : be(W),
    K = E ?? G,
    q = (0, U.useMemo)(
      () =>
        E == null
          ? G == null || W == null || M == null
            ? null
            : pe({
                anchor: G,
                body: xe(W),
    ...
    J = K == null ? null : Se({ anchor: K, layer: x.current, pageSize: g }),
    Y = (0, U.useCallback)(() => {
      (E != null && a?.(p, !1), D(null), k(``), N(null), L(!1));
    }, [E, a, p]),
    ie = (0, U.useCallback)((e) => {
      (k(e), L(!1));
    }, []),
    ae = (0, U.useCallback)(() => {
      typeof window > `u` ||
        T({ animationFrameRef: C, animationWindow: window, editorWrapper: S.current });
    }, []),
    oe = (0, U.useCallback)(
      () =>
        q == null
          ? !1
          : q.target.mode === `create` && O.trim().length > 0
            ? I
              ? (Y(), !0)
              : (L(!0), ae(), !1)
            : (Y(), !0),
    ...
    Z = (e) => {
      ...
      n != null &&
        ...
        F(null),
        j({ pointerId: e.pointerId, start: n, current: n }));
    },
    $ = (e) => {
      ...
      t != null &&
        (e.preventDefault(),
        e.stopPropagation(),
        j((n) => (n == null || n.pointerId !== e.pointerId ? n : { ...n, current: t })));
    },
    fe = (e) => {
      if (A == null || e.pointerId !== A.pointerId) return;
      let t = me(e, g) ?? A.current;
      (e.preventDefault(),
        e.stopPropagation(),
        e.currentTarget.hasPointerCapture(e.pointerId) &&
          e.currentTarget.releasePointerCapture(e.pointerId));
      let n = he({ ...A, current: t });
      if (E != null && n.kind === `point`) {
        (oe(), j(null));
        return;
      }
      (E ?? a?.(p, !0), D(n), k(``), N(null), L(!1), j(null));
    },
    _e = async (e, { submitDirectly: t = !1 } = {}) => {
      let a = e.body.trim();
      if (M != null) {
        if (a.length === 0 || R) return;
        (i((e) =>
          e.map((e) => (Oe(e) === M ? { ...e, content: [{ content_type: `text`, text: a }] } : e)),
        ),
          Y());
        return;
      }
      if (!(E == null || a.length === 0 || R))
        try {
          z(!0);
          let e = ve({ anchor: E, pageSize: g }),
            s = crypto.randomUUID(),
            l;
          try {
            l = await Ce({
          ...
          (h(y, {
            ...
            metadata: { comment_type: e.kind, submit_mode: t ? `direct` : `saved` },
          }),
            t
  ...
  return (0, X.jsxs)(`div`, {
    ref: x,
    className: s(`absolute inset-0 z-[3]`, !t && `pointer-events-none`),
    "data-testid": `artifact-pdf-comment-layer`,
    style: t ? { cursor: B } : void 0,
    onPointerDown: Z,
    onPointerMove: $,
    onPointerUp: fe,
    onPointerCancel: () => j(null),
    children: [
      re.map((e) =>
        (0, X.jsx)(
          ce,
          {
            ...
            isSelected: Oe(e) === M,
            onEdit: (e) => {
              (E != null && a?.(p, !1), D(null), k(``), L(!1), F(null), N(e));
            },
            onPreviewChange: F,
          },
          Oe(e),
      ...
      H == null || M != null ? null : (0, X.jsx)(le, { comment: H, layer: x.current }),
      A == null ? null : (0, X.jsx)(de, { rect: ge(A.start, A.current), pageSize: g }),
      E == null ? null : (0, X.jsx)(ue, { anchor: E, label: r, pageSize: g }),
      K == null || J == null || q == null || typeof document > `u`
        ? null
        : (0, se.createPortal)(
            (0, X.jsx)(`div`, {
              ref: S,
              className: ne,
              style: { left: J.x, top: J.y, height: V, width: 294 },
              ...
              children: (0, X.jsx)(
                w,
                {
                  ...
                  onCancel: Y,
                  onDelete: (e) => {
                    (i((t) => t.filter((t) => Oe(t) !== e)), Y());
                  },
                  onDirectSubmit: (e) => {
                    _e(e, { submitDirectly: !0 });
                  },
                  onEscape: Y,
                  onBodyChange: q.target.mode === `create` ? ie : void 0,
                  onLightDismissibilityChange: Q,
                  onMounted: Q,
                  onSubmit: (e) => {
                    _e(e);
                  },
...
function ce(e) {
  ...
  let f = d,
    p;
  t[5] !== u || t[6] !== a ? ((p = () => a(u)), (t[5] = u), (t[6] = a), (t[7] = p)) : (p = t[7]);
  let m = p,
    h;
  ...
  if (s.kind === `region`) {
    ...
    t[10] !== s.pageRect || t[11] !== s.pageSize
      ? ((e = (0, X.jsx)(de, { rect: s.pageRect, pageSize: s.pageSize })),
        (t[10] = s.pageRect),
        (t[11] = s.pageSize),
        (t[12] = e))
      : (e = t[12]);
    let a = n.position.line,
      o;
    t[13] !== u || t[14] !== i
      ? ((o = () => i(u)), (t[13] = u), (t[14] = i), (t[15] = o))
      : (o = t[15]);
    let c;
    t[16] === s.pageRect ? (c = t[17]) : ((c = _e(s.pageRect)), (t[16] = s.pageRect), (t[17] = c));
    let l;
    t[18] !== n.position.line ||
    t[19] !== f ||
    t[20] !== g ||
    t[21] !== r ||
    t[22] !== s.pageSize ||
    ...
    return (
      t[27] !== e || t[28] !== l
        ? ((d = (0, X.jsxs)(X.Fragment, { children: [e, l] })),
          (t[27] = e),
          (t[28] = l),
          (t[29] = d))
        : (d = t[29]),
  ...
  let _;
  t[30] !== u || t[31] !== i
    ? ((_ = () => i(u)), (t[30] = u), (t[31] = i), (t[32] = _))
    : (_ = t[32]);
  let v;
  return (
    t[33] !== n.position.line ||
    t[34] !== f ||
    t[35] !== g ||
    t[36] !== r ||
    t[37] !== s.pagePoint ||
...
function le(e) {
  let t = (0, H.c)(9),
    { comment: n, layer: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = ye(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === n ? (o = t[3]) : ((o = xe(n)), (t[2] = n), (t[3] = o));
  let s = o;
...
function ue(e) {
  ...
  if (n.kind === `region`) {
    let e;
    t[0] !== n.rect || t[1] !== i
      ? ((e = (0, X.jsx)(de, { rect: n.rect, pageSize: i })),
        (t[0] = n.rect),
        (t[1] = i),
        (t[2] = e))
      : (e = t[2]);
    ...
    let o;
    t[5] !== r || t[6] !== i || t[7] !== a
      ? ((o = (0, X.jsx)(fe, { draft: !0, label: r, point: a, pageSize: i })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = a),
        (t[8] = o))
  ...
  return (
    t[12] !== n.point || t[13] !== r || t[14] !== i
      ? ((a = (0, X.jsx)(fe, { draft: !0, label: r, point: n.point, pageSize: i })),
        (t[12] = n.point),
        (t[13] = r),
        (t[14] = i),
        (t[15] = a))
...
function me(e, t) {
  ...
  return n.width <= 0 || n.height <= 0
    ? null
    : {
        x: ke(((e.clientX - n.left) / n.width) * t.width, 0, t.width),
        y: ke(((e.clientY - n.top) / n.height) * t.height, 0, t.height),
      };
}
function he(e) {
  let t = ge(e.start, e.current);
  return t.width < Z || t.height < Z
...
function ve({ anchor: e, pageSize: t }) {
...
function Se({ anchor: e, layer: t, pageSize: n }) {
  return L({ layer: t, markerPoint: e.kind === `region` ? _e(e.rect) : e.point, pageSize: n });
}
async function Ce({
  anchor: e,
  commentId: t,
  ...
  return (
    ...
    Ee({ anchor: e, context: u, crop: o, markerLabel: n, scale: s }),
    {
      commentId: t,
...
function we(e, t) {
  ...
  return Te({ x: e.point.x - 180, y: e.point.y - 120, width: 360, height: 240 }, t);
}
function Te(e, t) {
  let n = Math.min(Math.max(e.width, 1), t.width),
    r = Math.min(Math.max(e.height, 1), t.height);
  return { x: ke(e.x, 0, t.width - n), y: ke(e.y, 0, t.height - r), width: n, height: r };
}
function Ee({ anchor: e, context: t, crop: n, markerLabel: r, scale: i }) {
  if (
    (t.save(),
    (t.strokeStyle = I),
    (t.fillStyle = I),
    ...
    let a = (e.rect.x - n.x) * i,
      ...
      s = e.rect.width * i,
      c = e.rect.height * i;
    (t.strokeRect(a, o, s, c), De(t, r, a + s, o));
  } else De(t, r, (e.point.x - n.x) * i, (e.point.y - n.y) * i);
  t.restore();
}
function De(e, t, n, r) {
  (e.beginPath(),
...
var je = { height: 792, width: 612 },
  Me = 0.3,
  Ne = 8,
  Pe = 1e-4,
  Fe = 5,
  Ie = 200,
  Le = [Me, 0.4, 0.5, 0.67, 0.75, 0.9, 1, 1.1, 1.25, 1.5, 1.75, 2, 2.5, 3, 4, 5, 6, 7, Ne];
function Re(e) {
  let t = (0, H.c)(36),
  ...
  let b = y,
    x;
  t[6] !== r || t[7] !== i
    ? ((x = (e) => Be({ pageViewportSize: r, pageWidth: i, resize: e })),
      (t[6] = r),
      (t[7] = i),
      (t[8] = x))
    : (x = t[8]);
  ...
  t[11] === b
    ? (T = t[12])
    : ((T = (e) => {
        b({ kind: `percentage`, value: Ue(e / 100) });
      }),
      (t[11] = b),
      (t[12] = T));
  let E = T,
  ...
  t[13] !== S || t[14] !== n
    ? ((D = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: He(S(e), `out`) })));
      }),
      (t[13] = S),
      (t[14] = n),
      (t[15] = D))
  ...
  t[16] !== S || t[17] !== n
    ? ((k = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: He(S(e), `in`) })));
      }),
      (t[16] = S),
      (t[17] = n),
      (t[18] = k))
  ...
  t[19] !== S || t[20] !== n
    ? ((j = (e) => {
        ...
        ((p.current = 0),
          ...
          g(),
          s((e) => ({ kind: `percentage`, value: He(S(e), t) })));
      }),
      (t[19] = S),
      (t[20] = n),
      (t[21] = j))
...
function Be({ pageViewportSize: e, pageWidth: t, resize: n }) {
  if (n.kind === `percentage`) return Ue(n.value);
  let r = e?.width ?? je.width;
  return t == null || t <= 0 || r <= 0 ? 1 : Ue(t / r);
}
function Ve({ pageViewportSize: e, pageWidth: t, resize: n }) {
  let r = e ?? je,
    i = r.width / r.height,
    a =
      n.kind === `page-width` && t != null && t > 0
        ? t
        : r.width * Be({ pageViewportSize: e, pageWidth: t, resize: n });
  return { height: Math.round(a / i), width: Math.round(a) };
}
function He(e, t) {
  let n = Ue(e);
  if (t === `in`) {
    for (let e of Le) if (e > n + Pe) return e;
...
function Ue(e) {
  return Math.min(Ne, Math.max(Me, e));
}
var We = (0, U.memo)(function (e) {
  let t = (0, H.c)(50),
    {
      commentLayer: n,
      currentPage: r,
    ...
    [v, y] = (0, U.useState)(!1),
    [b, x] = (0, U.useState)(null),
    S = b ?? s,
    C;
  t[0] !== c || t[1] !== u || t[2] !== S
    ? ((C = Ve({ pageViewportSize: S, pageWidth: c, resize: u })),
      (t[0] = c),
      (t[1] = u),
      (t[2] = S),
      (t[3] = C))
  ...
  let L = g?.userUnit ?? 1,
    R;
  t[24] !== w.height || t[25] !== w.width || t[26] !== T || t[27] !== L
    ? ((R = { "--scale-factor": T, "--user-unit": L, height: w.height, width: w.width }),
      (t[24] = w.height),
      (t[25] = w.width),
      (t[26] = T),
      (t[27] = L),
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ee = (0, X.jsx)(`canvas`, { ref: m, className: `absolute inset-0 size-full` })),
      (t[29] = ee))
    : (ee = t[29]);
  let B;
  t[30] !== A ||
...
function Ke(e) {
  let t = (0, H.c)(70),
    ...
    f = (0, U.useRef)(null),
    p;
  t[0] !== n || t[1] !== r ? ((p = Je(n, r)), (t[0] = n), (t[1] = r), (t[2] = p)) : (p = t[2]);
  let [m, h] = (0, U.useState)(p),
    [g, _] = (0, U.useState)(null),
    v;
  ...
  let R = L,
    z;
  t[21] !== R || t[22] !== D || t[23] !== I || t[24] !== r || t[25] !== i
    ? ((z = (e) => {
        if (e.key === `Escape`) {
          (e.preventDefault(), i());
          return;
  ...
  t[27] !== R || t[28] !== I
    ? ((B = (e) => {
        ...
        e.clientX < t.left + t.width / 2 ? I() : R();
      }),
      (t[27] = R),
      (t[28] = I),
      (t[29] = B))
  ...
  let te = B,
    V;
  t[30] !== o || t[31] !== g
    ? ((V = qe({ pageViewportSize: o, presentationSize: g })),
      (t[30] = o),
      (t[31] = g),
      (t[32] = V))
    : (V = t[32]);
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, X.jsx)(C, { className: `icon-2xs rotate-180` })), (t[40] = G))
    : (G = t[40]);
  let K;
  t[41] !== I || t[42] !== j || t[43] !== W
    ? ((K = (0, X.jsx)(y, {
        "aria-label": j,
        color: `ghost`,
        disabled: W,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Y = (0, X.jsx)(C, { className: `icon-2xs` })), (t[48] = Y))
    : (Y = t[48]);
  let ie;
  t[49] !== R || t[50] !== N || t[51] !== J
    ? ((ie = (0, X.jsx)(y, {
        "aria-label": N,
        color: `ghost`,
        disabled: J,
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, X.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })), (t[53] = ae))
    : (ae = t[53]);
  let oe, se;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, X.jsx)(b, { className: `icon-2xs` })),
      (se = (0, X.jsx)(d, {
  ...
  let $;
  return (
    t[63] !== te || t[64] !== ee || t[65] !== T || t[66] !== re || t[67] !== Q || t[68] !== c
      ? (($ = (0, X.jsxs)(`div`, {
          ref: T,
          "aria-label": c,
          autoFocus: !0,
...
function qe({ pageViewportSize: e, presentationSize: t }) {
  let n = e?.width ?? 612,
    r = e?.height ?? 792;
...
function Ye({ anchor: e, container: t, pageSelector: n }) {
  let r = t.getBoundingClientRect(),
    i = e.kind === `point` ? e.clientX : r.left + r.width / 2,
    a = e.kind === `point` ? e.clientY : r.top + r.height / 2,
    o = Ze({ anchorClientX: i, anchorClientY: a, container: t, pageSelector: n });
  ...
  return c.width <= 0 || c.height <= 0
    ...
    : {
        ...
        pageNumber: s,
        ratioX: tt((i - c.left) / c.width),
        ratioY: tt((a - c.top) / c.height),
      };
}
function Xe({ anchorState: e, container: t, pageSelector: n }) {
  let r = Qe({ container: t, pageNumber: e.pageNumber, pageSelector: n });
  if (r == null) return;
...
function Ze({ anchorClientX: e, anchorClientY: t, container: n, pageSelector: r }) {
...
function Qe({ container: e, pageNumber: t, pageSelector: n }) {
  return $e(e, n).find((e) => Number(e.dataset.pageNumber) === t) ?? null;
}
function $e(e, t) {
...
function nt(e) {
  ...
  return (
    t[8] !== n || t[9] !== l
      ? ((u = (0, X.jsx)(x, { name: `PdfPreviewPanel`, fallback: c, children: l }, n)),
        (t[8] = n),
        (t[9] = l),
        (t[10] = u))
      : (u = t[10]),
...
function rt(e) {
  let n = (0, H.c)(103),
    { fileDataUrl: i, headerRightContent: a, hostId: o, path: s, sizeBytes: c, title: u } = e,
    d = f(v),
    p = l(),
    y = (0, U.useRef)(null),
    b = (0, U.useRef)(null),
    ...
    w = (0, U.useRef)(null),
    T;
  n[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((T = new Set()), (n[0] = T)) : (T = n[0]);
  let I = (0, U.useRef)(T),
    [L, R] = (0, U.useState)(!1),
    [z, ee] = (0, U.useState)(!1),
    [B, te] = (0, U.useState)(null),
    V;
  n[1] === d.value
    ? (V = n[2])
    : ((V = _(d.value) ?? r(`new-conversation`)), (n[1] = d.value), (n[2] = V));
  let ne = V,
    [W, G] = E(ne),
    K;
  if (n[3] !== W || n[4] !== s) {
    ...
    (n[6] === s
      ? (e = n[7])
      : ((e = (e) => t(e) && e.localPdfContext?.path === s), (n[6] = s), (n[7] = e)),
      (K = W.filter(e)),
      (n[3] = W),
      (n[4] = s),
      (n[5] = K));
  ...
  let J = K,
    Y;
  n[8] === J ? (Y = n[9]) : ((Y = Math.max(0, ...J.map(st))), (n[8] = J), (n[9] = Y));
  let ie = Y + 1,
    ae,
    oe;
  (n[10] !== s || n[11] !== G
    ...
    (0, U.useEffect)(ae, oe));
  let se;
  n[14] === i ? (se = n[15]) : ((se = { fileDataUrl: i }), (n[14] = i), (n[15] = se));
  let { loadState: Z, numPages: Q, pageViewportSize: $, pdfDocument: ce } = q(se),
    le;
  n[16] === Q
    ? (le = n[17])
    : ((le = { containerRef: b, pageSelector: `[data-artifact-pdf-page]`, totalPages: Q }),
      (n[16] = Q),
      (n[17] = le));
  let { currentPage: ue, goToNextPage: de, goToPreviousPage: fe } = re(le),
    pe;
  n[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((pe = (e) => {
        ...
        C.current = Ye({ anchor: e, container: t, pageSelector: `[data-artifact-pdf-page]` });
      }),
      (n[18] = pe))
    : (pe = n[18]);
  let me = pe,
    he;
  n[19] !== $ || n[20] !== B
    ? ((he = { onBeforeZoom: me, pageViewportSize: $, pageWidth: B }),
      (n[19] = $),
      (n[20] = B),
      (n[21] = he))
    : (he = n[21]);
  let {
    ...
    we;
  n[22] !== ue || n[23] !== _e || n[24] !== be
    ? ((we = () => {
        let e =
          be.kind === `page-width`
            ? null
            : b.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${ue}"]`);
        (_e(),
          e != null &&
  ...
  n[26] === ge
    ...
    : ((Ee = (e) => {
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = w.current;
        n !== t && (n != null && (me({ kind: `center` }), ge()), (w.current = t), te(t));
      }),
      (n[26] = ge),
      (n[27] = Ee));
  let De = S(Ee),
  ...
  n[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Oe = () => {
        ...
        e == null ||
          t == null ||
          ((C.current = null),
          Xe({ anchorState: e, container: t, pageSelector: `[data-artifact-pdf-page]` }));
      }),
      (n[28] = Oe))
    : (Oe = n[28]);
  let ke;
  (n[29] !== Q || n[30] !== $ || n[31] !== B || n[32] !== be
    ? ((ke = [Q, `[data-artifact-pdf-page]`, $, B, be]),
      (n[29] = Q),
      (n[30] = $),
      (n[31] = B),
      (n[32] = be),
      (n[33] = ke))
    : (ke = n[33]),
    (0, U.useLayoutEffect)(Oe, ke));
  let Ae;
  n[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ae = () => {
        ((C.current = null), (x.current = !1), R(!1), ee(!1));
      }),
      (n[34] = Ae))
    : (Ae = n[34]);
  let je;
  (n[35] === i ? (je = n[36]) : ((je = [i]), (n[35] = i), (n[36] = je)), (0, U.useEffect)(Ae, je));
  let Me, Ne;
  (n[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Me = () => {
        let e = () => {
          document.fullscreenElement !== y.current && R(!1);
        };
        return (
  ...
  n[39] === ve
    ...
    : ((Pe = (e) => {
        ...
        t !== e &&
          ...
          (b.current = e),
          e?.addEventListener(`wheel`, ve, { passive: !1 }));
      }),
      (n[39] = ve),
      (n[40] = Pe));
  let Fe = Pe,
  ...
  n[41] !== Q || n[42] !== d
    ? ((ze = () => {
        ((x.current = !0),
          h(d, { eventName: `codex_pdf_preview_viewed`, metadata: { page_count: Q } }));
      }),
      (n[41] = Q),
      (n[42] = d),
      (n[43] = ze))
    : (ze = n[43]);
  let Be = (0, U.useEffectEvent)(ze),
    Ve;
  n[44] !== Ie || n[45] !== Be
    ? ((Ve = () => {
        !Ie || x.current || Be();
    ...
    : (Ve = n[46]);
  let He;
  (n[47] === Ie ? (He = n[48]) : ((He = [Ie]), (n[47] = Ie), (n[48] = He)),
    (0, U.useEffect)(Ve, He));
  let Ue;
  n[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = () => {
        (R(!1), document.fullscreenElement === y.current && document.exitFullscreen().catch(ot));
      }),
      (n[49] = Ue))
    : (Ue = n[49]);
  let Ge = Ue,
  ...
  n[50] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((qe = (e) => {
        (R(!1),
          (document.fullscreenElement === y.current ? document.exitFullscreen() : Promise.resolve())
            .catch(at)
            .finally(() => {
    ...
    ? (($e = () => {
        ...
        let e = (e) => {
          e.defaultPrevented ||
            e.key !== `Escape` ||
            I.current.size > 0 ||
            (e.preventDefault(), e.stopPropagation(), ee(!1));
        };
        return (
  ...
  n[60] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (ft = n[60]);
  let pt;
  n[61] !== nt || n[62] !== lt || n[63] !== z
    ? ((pt = (0, X.jsx)(O, { active: z, activeLabel: lt, label: nt, onClick: ft })),
      (n[61] = nt),
      (n[62] = lt),
      (n[63] = z),
      (n[64] = pt))
                          ...
                          rightContent: (0, X.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, X.jsx)(k, {
                                ...
                                fitOption: { selected: be.kind === `page-width`, onSelect: Te },
                              }),
                              (0, X.jsx)(P, { hostId: o, path: s, sizeBytes: c }),
                              (0, X.jsx)(M, { hostId: o, path: s, showLabel: !0 }),
                              a,
                            ],
                          }),
                        })
