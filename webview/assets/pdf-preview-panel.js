const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./pdf-1.js", "./pdf-2.js", "./chunk-Bj-mKKzh.js", "./preload-helper.js"]),
) => i.map((i) => d[i]);
import { s as e } from "./chunk-Bj-mKKzh.js";
import { Ct as t, Yr as n, wt as r } from "./src-2.js";
...
import { F as c, f as l, h as u, lt as d } from "./vscode-api.js";
import { c as f, o as p } from "./lib-2.js";
import "./known-app-icon.js";
import "./branch.js";
import "./github-mark.js";
import "./google-drive-CC-Egn92.js";
import "./notion.js";
import { g as m } from "./persisted-signal.js";
import "./rpc-2.js";
import "./statsig.js";
import "./request.js";
...
import { t as b } from "./error-boundary.js";
import "./download.js";
...
import "./arrow-up.js";
import { i as C, o as w, r as T } from "./browser-sidebar-comment-light-dismiss.js";
import "./sortBy.js";
import "./prompt-editor.js";
/* empty css                    */ import "./appshot-availability-CHEIX-Tb.js";
...
import { n as E } from "./arrow-rotate-ccw.js";
...
import { t as P } from "./artifact-preview-status.js";
import {
  a as ee,
  c as F,
  d as I,
...
function se(e) {
  ...
  return (
    t[3] !== r || t[4] !== a || t[5] !== s || t[6] !== l
      ? ((p = { loadState: r, numPages: a, pageViewportSize: s, pdfDocument: l }),
        (t[3] = r),
        (t[4] = a),
        (t[5] = s),
        (t[6] = l),
...
async function ce() {
  ...
  ae ??= i(() => import(`./pdf-1.js`), __vite__mapDeps([0, 1, 2, 3]), import.meta.url);
  let e = await ae;
  return (
    (!oe || e.GlobalWorkerOptions.workerSrc !== q) &&
      ((e.GlobalWorkerOptions.workerSrc = q), (oe = !0)),
    e
  );
}
function J(e) {
...
function Q(e) {
        ...
        let l = !1,
          ...
          d = async function () {
            ...
            let c = i.getViewport({ scale: 1 }),
              u = new Y({ linkNavigation: r, pageSelector: a, pdfDocument: o, scrollRootRef: s });
  ...
  return (
    t[8] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((d = (0, Z.jsx)(`div`, { ref: c, className: `annotationLayer` })), (t[8] = d))
      : (d = t[8]),
    d
  );
}
...
function de(e, t) {
  ...
  return n.width <= 0 || n.height <= 0
    ? null
    : {
        x: Pe(((e.clientX - n.left) / n.width) * t.width, 0, t.width),
        y: Pe(((e.clientY - n.top) / n.height) * t.height, 0, t.height),
      };
}
function fe({ pageElement: e, pageSize: t }) {
  let n = e.querySelector(`.textLayer`),
    r = e.ownerDocument.getSelection();
  if (n == null || r == null || r.isCollapsed || r.rangeCount === 0 || !Ae(r, n)) return null;
  let i = Ne(r.toString());
  if (i.length === 0) return null;
  let a = r.getRangeAt(0);
  if (!n.contains(a.commonAncestorContainer)) return null;
  let o = Array.from(a.getClientRects()),
    s = Se({ clientRects: o, pageElement: e, pageSize: t });
  if (s == null) return null;
  let c = Ce({ clientRects: o, pageElement: e, pageSize: t }),
    l = we({ clientRects: o, pageElement: e, pageSize: t, selection: r });
  return {
...
function pe({
  ...
  for (let o of i.ownerDocument.elementsFromPoint?.(e, t) ?? []) {
    ...
    let e = ve({ includePreviewMetadata: n, pageElement: i, pageSize: a, target: o });
    if (e != null) return e;
  }
  return null;
}
function me(e, t = !1) {
  let n = ge(e.start, e.current);
...
function he(e) {
  return (
    Math.abs(e.clientCurrent.x - e.clientStart.x) >= le ||
    Math.abs(e.clientCurrent.y - e.clientStart.y) >= le
  );
}
function ge(e, t) {
  return {
...
function ve({ includePreviewMetadata: e, pageElement: t, pageSize: n, target: r }) {
  let i = ye(r, t);
  if (i == null) return null;
  let a = Se({ clientRects: [i.element.getBoundingClientRect()], pageElement: t, pageSize: n });
  if (a == null) return null;
  let o = e ? je(i.element) : ``;
  return {
    kind: `region`,
...
function ye(e, t) {
  ...
  let r = be(e, t, (e) => e.matches(`.annotationLayer a, .annotationLayer .linkAnnotation`));
  if (r != null) return { element: r, selectionKind: `link` };
  let i = be(e, t, (e) => e.matches(`.annotationLayer section`));
...
function Se({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = t.getBoundingClientRect();
  if (r.width <= 0 || r.height <= 0) return null;
  let i = Oe(e);
  if (i == null) return null;
  let a = Pe(((i.left - r.left) / r.width) * n.width, 0, n.width),
    o = Pe(((i.top - r.top) / r.height) * n.height, 0, n.height),
    s = Pe(((i.right - r.left) / r.width) * n.width, 0, n.width),
    c = Pe(((i.bottom - r.top) / r.height) * n.height, 0, n.height);
  return s <= a || c <= o ? null : { x: a, y: o, width: s - a, height: c - o };
}
function Ce({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = [];
  for (let i of Ee(e)) {
    let e = Se({ clientRects: [i], pageElement: t, pageSize: n });
    e != null && r.push(e);
  }
  return r;
}
function we({ clientRects: e, pageElement: t, pageSize: n, selection: r }) {
...
function Te({ clientX: e, clientY: t, pageElement: n, pageSize: r }) {
  let i = n.getBoundingClientRect();
  return {
    x: Pe(((e - i.left) / i.width) * r.width, 0, r.width),
    y: Pe(((t - i.top) / i.height) * r.height, 0, r.height),
  };
}
function Ee(e) {
  let t = [],
...
function je(e) {
  ...
  return n.length > 0
    ? n
    : Ne((e instanceof HTMLAnchorElement ? e : e.querySelector(`a`))?.href ?? ``);
}
function Me(e, t) {
  if (e.nodeType === Node.TEXT_NODE) {
    let n = Ne(e.textContent ?? ``);
    n.length > 0 && t.push(n);
    return;
  }
  for (let n of e.childNodes) Me(n, t);
}
function Ne(e) {
  return e.replace(/\s+/g, ` `).trim().slice(0, ue);
}
function Pe(e, t, n) {
...
function Ie({
  ...
  let y = c(u),
    ...
    x = (0, K.useRef)(null),
    S = (0, K.useRef)(null),
    [w, E] = (0, K.useState)(null),
    [D, O] = (0, K.useState)(null),
    [k, A] = (0, K.useState)(``),
    [j, M] = (0, K.useState)(null),
    [N, P] = (0, K.useState)(null),
    [ee, I] = (0, K.useState)(null),
    [L, te] = (0, K.useState)(null),
    [ne, H] = (0, K.useState)(null),
    [re, U] = (0, K.useState)(!1),
    [G, q] = (0, K.useState)(!1),
    ae = b.formatMessage({
    ...
    se = (0, K.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === h), [e, h]),
    ce = ne == null ? null : (se.find((e) => et(e) === ne) ?? null),
    J = L == null ? null : (se.find((e) => et(e) === L) ?? null),
    Y = J == null ? null : Ke(J),
    X = D ?? Y,
    Q = (0, K.useMemo)(
      () =>
        D == null
          ? Y == null || J == null || L == null
            ? null
            : Ue({
                anchor: Y,
                body: qe(J),
    ...
    $ = X == null ? null : Je({ anchor: X, layer: w, pageSize: g }),
    le = X != null,
    ue = (0, K.useCallback)(() => {
      (D != null && a?.(h, !1), O(null), P(null), I(null), A(``), te(null), U(!1));
    }, [D, a, h]),
    ...
    ve = (0, K.useCallback)(() => {
      typeof window > `u` ||
        T({ animationFrameRef: S, animationWindow: window, editorWrapper: x.current });
    }, []),
    ye = (0, K.useCallback)(
      () =>
        Q == null
          ? !1
          : Q.target.mode === `create` && k.trim().length > 0
            ? re
              ? (ue(), !0)
              : (U(!0), ve(), !1)
            : (ue(), !0),
    ...
    be = (0, K.useEffectEvent)(() => {
      if (X == null) return;
      let e = Je({ anchor: X, layer: w, pageSize: g });
      e != null && ie(x.current, e);
    });
  (0, K.useEffect)(() => {
    if (!le || w == null) return;
  ...
  (0, K.useEffect)(() => {
    if (n || Q?.target.mode !== `create` || w == null) return;
    let e = w.ownerDocument,
      t = (e) => {
        xe(e);
      };
  ...
  let Se = (0, K.useEffectEvent)(() => {
    if (n || w == null) return;
    let e = w.parentElement;
    if (e == null) return;
    let t = fe({ pageElement: e, pageSize: g });
    if (t == null) {
      P(null);
      return;
    }
    ((D != null || L != null) && !ye()) ||
      (P(t), O(null), A(``), te(null), H(null), I(null), U(!1));
  });
  (0, K.useEffect)(() => {
    if (w == null || n) return;
    let e = w.parentElement;
  ...
  let Ce = (e, t, r) => {
    ...
    we = (e) => {
      (D ?? a?.(h, !0), O(e), P(null), I(null), A(``), te(null), H(null), U(!1));
    },
    Te = (0, K.useEffectEvent)((e, t) => {
      if (D != null || L != null || !B(e)) return;
      let n = fe({ pageElement: t, pageSize: g }) ?? (N?.selectionKind === `text` ? null : N);
      n != null && (e.preventDefault(), e.stopPropagation(), we(n));
    });
  (0, K.useEffect)(() => {
    if (w == null || n) return;
    let e = w.parentElement;
  ...
  let Ee = (e) => {
      ((D != null || L != null) && !ye()) || we(e);
    },
    De = (e) => {
      if (!n || !e.isPrimary || e.button !== 0) return;
      let t = de(e, g);
      t != null &&
        (e.preventDefault(),
        e.stopPropagation(),
    ...
    ke = (e) => {
      ...
      let n = { ...j, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
        ...
        i = me(n, r);
      if (!r) {
        let t = Ce(e.clientX, e.clientY, !0);
        if (t != null) {
          (M(null), Ee(t));
          return;
        }
    ...
    Ae = async (e, { submitDirectly: n = !1 } = {}) => {
      let a = e.body.trim();
      if (L != null) {
        if (a.length === 0 || G) return;
        (i((e) =>
          e.map((e) => (et(e) === L ? { ...e, content: [{ content_type: `text`, text: a }] } : e)),
        ),
          ue());
        return;
      }
      if (!(D == null || a.length === 0 || G))
        try {
          q(!0);
          let e = We({ anchor: D, pageSize: g }),
            s = crypto.randomUUID(),
            c;
          try {
            c = await Ye({
          ...
          (m(y, {
            ...
            metadata: { comment_type: e.kind, submit_mode: n ? `direct` : `saved` },
          }),
            n
  ...
  return (0, Z.jsxs)(`div`, {
    ref: E,
    className: s(`absolute inset-0 z-[3]`, !n && `pointer-events-none`),
    "data-testid": `artifact-pdf-comment-layer`,
    style: n ? { cursor: F } : void 0,
    onPointerDown: De,
    onPointerMove: Oe,
    onPointerUp: ke,
    onPointerCancel: () => {
    ...
    children: [
      se.map((e) =>
        (0, Z.jsx)(
          Le,
          {
            ...
            isSelected: et(e) === L,
            onEdit: (e) => {
              (D != null && a?.(h, !1), O(null), P(null), I(null), A(``), U(!1), H(null), te(e));
            },
            onPreviewChange: H,
          },
          et(e),
      ...
      ce == null || L != null ? null : (0, Z.jsx)(Re, { comment: ce, layer: w }),
      ee != null && D == null && L == null
        ? (0, Z.jsx)(R, {
            paddingPx: 4,
            pageSize: g,
            rect: ee.rect,
      ...
      N != null && D == null
        ...
        : null,
      j == null ? null : (0, Z.jsx)(Ve, { rect: ge(j.start, j.current), pageSize: g }),
      D == null ? null : (0, Z.jsx)(ze, { anchor: D, label: r, pageSize: g }),
      X == null || $ == null || Q == null
        ? null
        : (0, Z.jsx)(`div`, {
            ref: x,
            className: W,
            style: { left: $.x, top: $.y, height: z, width: 294 },
            ...
            children: (0, Z.jsx)(
              C,
              {
                ...
                onCancel: ue,
                onDelete: (e) => {
                  (i((t) => t.filter((t) => et(t) !== e)), ue());
                },
                onDirectSubmit: (e) => {
                  Ae(e, { submitDirectly: !0 });
                },
                onEscape: ue,
                onBodyChange: Q.target.mode === `create` ? _e : void 0,
...
function Le(e) {
  ...
  if (s == null) return null;
  let c;
  t[0] === n ? (c = t[1]) : ((c = et(n)), (t[0] = n), (t[1] = c));
  let l = c,
    u;
  ...
  if (s.kind === `region`) {
    ...
    t[15] !== s.selectionRects
      ? ((e =
          s.selectionKind == null
            ? (0, Z.jsx)(Ve, { rect: s.pageRect, pageSize: s.pageSize })
            : (0, Z.jsx)(Be, {
                bordered: !0,
                anchor: {
                  kind: `region`,
    ...
    t[17] !== l || t[18] !== i
      ...
      : (o = t[19]);
    let c;
    t[20] === s.pageRect ? (c = t[21]) : ((c = _e(s.pageRect)), (t[20] = s.pageRect), (t[21] = c));
    let u;
    ...
    return (
      t[31] !== e || t[32] !== u
        ? ((f = (0, Z.jsxs)(Z.Fragment, { children: [e, u] })),
          (t[31] = e),
          (t[32] = u),
          (t[33] = f))
        : (f = t[33]),
...
function Re(e) {
  let t = (0, G.c)(9),
    { comment: n, layer: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = Ge(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === n ? (o = t[3]) : ((o = qe(n)), (t[2] = n), (t[3] = o));
  let s = o;
  if (a == null) return null;
  let c;
  return (
...
function ze(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n || t[1] !== i
      ? ((e =
          n.selectionKind == null
            ? (0, Z.jsx)(Ve, { rect: n.rect, pageSize: i })
            : (0, Z.jsx)(Be, {
                bordered: !0,
                anchor: n,
                pageSize: i,
      ...
      : (e = t[2]);
    let a;
    t[3] === n.rect ? (a = t[4]) : ((a = _e(n.rect)), (t[3] = n.rect), (t[4] = a));
    let o;
    t[5] !== r || t[6] !== i || t[7] !== a
      ? ((o = (0, Z.jsx)(He, { draft: !0, label: r, point: a, pageSize: i })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = a),
        (t[8] = o))
    ...
    return (
      t[9] !== e || t[10] !== o
        ? ((s = (0, Z.jsxs)(Z.Fragment, { children: [e, o] })),
          (t[9] = e),
          (t[10] = o),
          (t[11] = s))
        : (s = t[11]),
  ...
  return (
    t[12] !== n.point || t[13] !== r || t[14] !== i
      ? ((a = (0, Z.jsx)(He, { draft: !0, label: r, point: n.point, pageSize: i })),
        (t[12] = n.point),
        (t[13] = r),
        (t[14] = i),
        (t[15] = a))
...
function Be(e) {
  ...
  return (
    t[12] !== n.rect || t[13] !== o || t[14] !== i || t[15] !== a
      ? ((s = (0, Z.jsx)(R, { bordered: o, paddingPx: 4, pageSize: i, rect: n.rect, testId: a })),
        (t[12] = n.rect),
        (t[13] = o),
        (t[14] = i),
        (t[15] = a),
...
function We({ anchor: e, pageSize: t }) {
...
function Ge(e) {
  ...
  return t == null
    ? null
    : t.kind === `region`
      ? { pageSize: t.pageSize, point: _e(t.pageRect) }
...
function Je({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ? I({ layer: t, pageSize: n, rect: e.rect })
    : L({ layer: t, markerPoint: e.kind === `region` ? _e(e.rect) : e.point, pageSize: n });
}
async function Ye({
  anchor: e,
  commentId: t,
  ...
  return (
    ...
    Qe({ anchor: e, context: u, crop: o, markerLabel: n, scale: s }),
    {
      commentId: t,
...
function Xe(e, t) {
  ...
  return Ze({ x: e.point.x - 180, y: e.point.y - 120, width: 360, height: 240 }, t);
}
function Ze(e, t) {
  let n = Math.min(Math.max(e.width, 1), t.width),
    r = Math.min(Math.max(e.height, 1), t.height);
  return { x: tt(e.x, 0, t.width - n), y: tt(e.y, 0, t.height - r), width: n, height: r };
}
function Qe({ anchor: e, context: t, crop: n, markerLabel: r, scale: i }) {
  if (
    (t.save(),
    (t.strokeStyle = U),
    (t.fillStyle = U),
    ...
    let a = (e.rect.x - n.x) * i,
      ...
      s = e.rect.width * i,
      c = e.rect.height * i;
    (t.strokeRect(a, o, s, c), $e(t, r, a + s, o));
  } else $e(t, r, (e.point.x - n.x) * i, (e.point.y - n.y) * i);
  t.restore();
}
function $e(e, t, n, r) {
  (e.beginPath(),
...
function nt(e) {
  ...
  return (
    t[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((s = (0, Z.jsx)(`div`, { ref: i, className: `textLayer` })), (t[4] = s))
      : (s = t[4]),
    s
  );
}
var rt = { height: 792, width: 612 },
  it = 0.3,
  at = 8,
  ot = 1e-4,
  st = 5,
  ct = 200,
  lt = [it, 0.4, 0.5, 0.67, 0.75, 0.9, 1, 1.1, 1.25, 1.5, 1.75, 2, 2.5, 3, 4, 5, 6, 7, at];
function ut(e) {
  let t = (0, G.c)(36),
  ...
  let b = y,
    x;
  t[6] !== r || t[7] !== i
    ? ((x = (e) => ft({ pageViewportSize: r, pageWidth: i, resize: e })),
      (t[6] = r),
      (t[7] = i),
      (t[8] = x))
    : (x = t[8]);
  ...
  t[11] === b
    ? (T = t[12])
    : ((T = (e) => {
        b({ kind: `percentage`, value: ht(e / 100) });
      }),
      (t[11] = b),
      (t[12] = T));
  let E = T,
  ...
  t[13] !== S || t[14] !== n
    ? ((D = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: mt(S(e), `out`) })));
      }),
      (t[13] = S),
      (t[14] = n),
      (t[15] = D))
  ...
  t[16] !== S || t[17] !== n
    ? ((k = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: mt(S(e), `in`) })));
      }),
      (t[16] = S),
      (t[17] = n),
      (t[18] = k))
  ...
  t[19] !== S || t[20] !== n
    ? ((j = (e) => {
        ...
        ((p.current = 0),
          ...
          g(),
          s((e) => ({ kind: `percentage`, value: mt(S(e), t) })));
      }),
      (t[19] = S),
      (t[20] = n),
      (t[21] = j))
...
function ft({ pageViewportSize: e, pageWidth: t, resize: n }) {
  if (n.kind === `percentage`) return ht(n.value);
  let r = e?.width ?? rt.width;
  return t == null || t <= 0 || r <= 0 ? 1 : ht(t / r);
}
function pt({ pageViewportSize: e, pageWidth: t, resize: n }) {
  let r = e ?? rt,
    i = r.width / r.height,
    a =
      n.kind === `page-width` && t != null && t > 0
        ? t
        : r.width * ft({ pageViewportSize: e, pageWidth: t, resize: n });
  return { height: Math.round(a / i), width: Math.round(a) };
}
function mt(e, t) {
  let n = ht(e);
  if (t === `in`) {
    for (let e of lt) if (e > n + ot) return e;
    return lt[lt.length - 1];
  }
...
function ht(e) {
  return Math.min(at, Math.max(it, e));
}
var gt = (0, K.memo)(function (e) {
  let t = (0, G.c)(50),
    {
      commentLayer: n,
      currentPage: r,
    ...
    [v, y] = (0, K.useState)(!1),
    [b, x] = (0, K.useState)(null),
    S = b ?? s,
    C;
  t[0] !== c || t[1] !== u || t[2] !== S
    ? ((C = pt({ pageViewportSize: S, pageWidth: c, resize: u })),
      (t[0] = c),
      (t[1] = u),
      (t[2] = S),
      (t[3] = C))
    : (C = t[3]);
  let w = C,
    T = b != null && b.width > 0 ? w.width / b.width : 1,
    E = Math.abs(r - a),
    D = v || E <= 2,
    O = v || E <= 2,
    k = v ? 50 : 50 + E * 40,
        ...
        return (
          ...
          (async function () {
            try {
              ...
              (_(t), x({ height: n.height, width: n.width }));
            } catch {
              e || (_(null), x(null));
            }
          })(),
  ...
  (t[8] === d
    ...
    (0, K.useEffect)(N, P));
  let ee;
  t[11] !== w.height || t[12] !== w.width || t[13] !== f || t[14] !== g || t[15] !== D
    ? ((ee = () => {
        let e = m.current;
        if (e == null) return;
        if (g == null || !D) {
        ...
        try {
          ((n = g.render({ canvas: e, viewport: g.getViewport({ scale: i / t.width }) })),
            n.promise.catch(_t));
        } catch {
          return;
        }
  ...
  let I = g?.userUnit ?? 1,
    L;
  t[24] !== w.height || t[25] !== w.width || t[26] !== T || t[27] !== I
  ...
  t[29] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, Z.jsx)(`canvas`, { ref: m, className: `absolute inset-0 size-full` })), (t[29] = R))
    : (R = t[29]);
  let z;
  t[30] !== A ||
  t[31] !== f ||
  ...
  t[38] !== k
    ...
    : (z = t[39]);
  let B;
  t[40] !== n || t[41] !== b || t[42] !== g || t[43] !== a
    ? ((B =
        g == null || b == null || n == null
          ? null
          : (0, Z.jsx)(
              Ie,
              {
...
function vt(e) {
  let t = (0, G.c)(70),
    ...
    u = (0, K.useRef)(null),
    d;
  t[0] !== n || t[1] !== r ? ((d = bt(n, r)), (t[0] = n), (t[1] = r), (t[2] = d)) : (d = t[2]);
  let [m, h] = (0, K.useState)(d),
    [g, _] = (0, K.useState)(null),
    b;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (e) => {
        _({ height: Math.floor(e.contentRect.height), width: Math.floor(e.contentRect.width) });
      }),
      (t[3] = b))
    : (b = t[3]);
  let C = S(b),
  ...
  let D = E,
    O;
  t[8] !== D || t[9] !== a
    ? ((O = { onExternalLink: a, onPageChange: D }), (t[8] = D), (t[9] = a), (t[10] = O))
    : (O = t[10]);
  let k = O,
    A;
  t[11] === l
  ...
  let L = I,
    te;
  t[21] !== L || t[22] !== D || t[23] !== F || t[24] !== r || t[25] !== i
    ? ((te = (e) => {
        if (e.key === `Escape`) {
          (e.preventDefault(), i());
          return;
        ...
        e.key === `End` && (e.preventDefault(), D(r));
      }),
      (t[21] = L),
      (t[22] = D),
      (t[23] = F),
  ...
  t[27] !== L || t[28] !== F
    ? ((z = (e) => {
        ...
        e.clientX < t.left + t.width / 2 ? F() : L();
      }),
      (t[27] = L),
      (t[28] = F),
      (t[29] = z))
  ...
  let B = z,
    V;
  t[30] !== o || t[31] !== g
    ? ((V = yt({ pageViewportSize: o, presentationSize: g })),
      (t[30] = o),
      (t[31] = g),
      (t[32] = V))
    : (V = t[32]);
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ne = { kind: `page-width` }), (t[33] = ne))
    : (ne = t[33]);
  let H;
  t[34] !== P || t[35] !== k || t[36] !== o || t[37] !== s || t[38] !== V
    ? ((H = (0, Z.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = (0, Z.jsx)(x, { className: `icon-2xs rotate-180` })), (t[40] = U))
    : (U = t[40]);
  let W;
  t[41] !== F || t[42] !== j || t[43] !== re
    ? ((W = (0, Z.jsx)(v, {
        "aria-label": j,
        color: `ghost`,
        disabled: re,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, Z.jsx)(x, { className: `icon-2xs` })), (t[48] = ae))
    : (ae = t[48]);
  let oe;
  t[49] !== L || t[50] !== N || t[51] !== q
    ? ((oe = (0, Z.jsx)(v, {
        "aria-label": N,
        color: `ghost`,
        disabled: q,
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((se = (0, Z.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })), (t[53] = se))
    : (se = t[53]);
  let ce, J;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = (0, Z.jsx)(y, { className: `icon-2xs` })),
      (J = (0, Z.jsx)(p, {
  ...
  let Q;
  return (
    t[63] !== B || t[64] !== R || t[65] !== T || t[66] !== H || t[67] !== X || t[68] !== c
      ? ((Q = (0, Z.jsxs)(`div`, {
          ref: T,
          "aria-label": c,
          autoFocus: !0,
...
function yt({ pageViewportSize: e, presentationSize: t }) {
  let n = e?.width ?? 612,
    r = e?.height ?? 792;
...
function xt({ anchor: e, container: t, pageSelector: n }) {
  let r = t.getBoundingClientRect(),
    i = e.kind === `point` ? e.clientX : r.left + r.width / 2,
    a = e.kind === `point` ? e.clientY : r.top + r.height / 2,
    o = Ct({ anchorClientX: i, anchorClientY: a, container: t, pageSelector: n });
  ...
  return c.width <= 0 || c.height <= 0
    ...
    : {
        ...
        pageNumber: s,
        ratioX: Dt((i - c.left) / c.width),
        ratioY: Dt((a - c.top) / c.height),
      };
}
function St({ anchorState: e, container: t, pageSelector: n }) {
  let r = wt({ container: t, pageNumber: e.pageNumber, pageSelector: n });
  if (r == null) return;
  let i = t.getBoundingClientRect(),
...
function Ct({ anchorClientX: e, anchorClientY: t, container: n, pageSelector: r }) {
  ...
  for (let i of Tt(n, r)) {
    let n = i.getBoundingClientRect(),
      r = Et({ max: n.bottom, min: n.top, value: t }) + Et({ max: n.right, min: n.left, value: e });
    r < s && ((s = r), (o = i));
  }
  return o;
}
function wt({ container: e, pageNumber: t, pageSelector: n }) {
  return Tt(e, n).find((e) => Number(e.dataset.pageNumber) === t) ?? null;
}
function Tt(e, t) {
  return Array.from(e.querySelectorAll(t));
}
function Et({ max: e, min: t, value: n }) {
...
function Ot(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[0]);
  let d;
  t[1] !== l || t[2] !== r || t[3] !== i || t[4] !== a || t[5] !== o || t[6] !== s || t[7] !== c
    ? ((d = (0, Z.jsx)(kt, {
  ...
  return (
    t[9] !== r || t[10] !== d
      ? ((f = (0, Z.jsx)(b, { name: `PdfPreviewPanel`, fallback: u, children: d }, r)),
        (t[9] = r),
        (t[10] = d),
        (t[11] = f))
      : (f = t[11]),
...
function kt(e) {
  ...
  let I = (0, K.useRef)(F),
    [L, R] = (0, K.useState)(!1),
    [z, B] = (0, K.useState)(!1),
    [V, ne] = (0, K.useState)(null),
    H;
  t[1] === v.value
    ? (H = t[2])
    : ((H = g(v.value) ?? n(`new-conversation`)), (t[1] = v.value), (t[2] = H));
  let re = H,
    [U, W] = E(re),
    ie;
  if (t[3] !== U || t[4] !== u) {
    ...
    (t[6] === u
      ? (e = t[7])
      : ((e = (e) => r(e) && e.localPdfContext?.path === u), (t[6] = u), (t[7] = e)),
      (ie = U.filter(e)),
      (t[3] = U),
      (t[4] = u),
      (t[5] = ie));
  ...
  let q = ie,
    ae;
  t[8] === q ? (ae = t[9]) : ((ae = Math.max(0, ...q.map(Nt))), (t[8] = q), (t[9] = ae));
  let oe = ae + 1,
    ce,
    J;
  (t[10] !== u || t[11] !== W
    ? ((ce = () => () => {
        W((e) => {
          let t = e.filter((e) => !(r(e) && e.localPdfContext?.path === u));
    ...
    (0, K.useEffect)(ce, J));
  let Y;
  t[14] === a ? (Y = t[15]) : ((Y = { fileDataUrl: a }), (t[14] = a), (t[15] = Y));
  let { loadState: X, numPages: Q, pageViewportSize: $, pdfDocument: le } = se(Y),
    ue;
  t[16] === Q
    ? (ue = t[17])
    : ((ue = { containerRef: x, pageSelector: `[data-artifact-pdf-page]`, totalPages: Q }),
      (t[16] = Q),
      (t[17] = ue));
  let { currentPage: de, goToNextPage: fe, goToPreviousPage: pe } = te(ue),
    me;
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((me = (e) => {
        ...
        T.current = xt({ anchor: e, container: t, pageSelector: `[data-artifact-pdf-page]` });
      }),
      (t[18] = me))
    : (me = t[18]);
  let he = me,
    ge;
  t[19] !== $ || t[20] !== V
    ? ((ge = { onBeforeZoom: he, pageViewportSize: $, pageWidth: V }),
      (t[19] = $),
      (t[20] = V),
      (t[21] = ge))
    : (ge = t[21]);
  let {
    ...
    Te;
  t[22] !== de || t[23] !== ve || t[24] !== xe
    ? ((Te = () => {
        let e =
          xe.kind === `page-width`
            ? null
            : x.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${de}"]`);
        (ve(),
          e != null &&
  ...
  t[26] === _e
    ...
    : ((De = (e) => {
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = ee.current;
        n !== t && (n != null && (he({ kind: `center` }), _e()), (ee.current = t), ne(t));
      }),
      (t[26] = _e),
      (t[27] = De));
  let Oe = S(De),
  ...
  t[28] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ke = () => {
        ...
        e == null ||
          t == null ||
          ((T.current = null),
          St({ anchorState: e, container: t, pageSelector: `[data-artifact-pdf-page]` }));
      }),
      (t[28] = ke))
    : (ke = t[28]);
  let Ae;
  (t[29] !== Q || t[30] !== $ || t[31] !== V || t[32] !== xe
    ? ((Ae = [Q, `[data-artifact-pdf-page]`, $, V, xe]),
      (t[29] = Q),
      (t[30] = $),
      (t[31] = V),
      (t[32] = xe),
      (t[33] = Ae))
    : (Ae = t[33]),
    (0, K.useLayoutEffect)(ke, Ae));
  let je;
  t[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((je = () => {
        ((T.current = null), (C.current = !1), R(!1), B(!1));
      }),
      (t[34] = je))
    : (je = t[34]);
  let Me;
  (t[35] === a ? (Me = t[36]) : ((Me = [a]), (t[35] = a), (t[36] = Me)), (0, K.useEffect)(je, Me));
  let Ne, Pe;
  (t[37] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ne = () => {
        let e = () => {
          document.fullscreenElement !== b.current && R(!1);
        };
        return (
  ...
  t[39] === ye
    ...
    : ((Fe = (e) => {
        let t = x.current;
        t !== e &&
          (t?.removeEventListener(`wheel`, ye),
          (x.current = e),
          e?.addEventListener(`wheel`, ye, { passive: !1 }));
      }),
      (t[39] = ye),
      (t[40] = Fe));
  let Ie = Fe,
  ...
  t[41] !== Q || t[42] !== v
    ? ((ze = () => {
        ((C.current = !0),
          m(v, { eventName: `codex_pdf_preview_viewed`, metadata: { page_count: Q } }));
      }),
      (t[41] = Q),
      (t[42] = v),
      (t[43] = ze))
    : (ze = t[43]);
  let Be = (0, K.useEffectEvent)(ze),
    Ve;
  t[44] !== Le || t[45] !== Be
    ? ((Ve = () => {
        !Le || C.current || Be();
    ...
    : (Ve = t[46]);
  let He;
  (t[47] === Le ? (He = t[48]) : ((He = [Le]), (t[47] = Le), (t[48] = He)),
    (0, K.useEffect)(Ve, He));
  let Ue;
  t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = () => {
        (R(!1), document.fullscreenElement === b.current && document.exitFullscreen().catch(Mt));
      }),
      (t[49] = Ue))
    : (Ue = t[49]);
  let We = Ue,
  ...
  t[50] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ge = (e) => {
        (R(!1),
          (document.fullscreenElement === b.current ? document.exitFullscreen() : Promise.resolve())
            .catch(jt)
            .finally(() => {
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (rt = t[61]);
  let it;
  t[62] !== Qe || t[63] !== et || t[64] !== z
    ? ((it = (0, Z.jsx)(w, { active: z, activeLabel: et, label: Qe, onClick: rt })),
      (t[62] = Qe),
      (t[63] = et),
      (t[64] = z),
      (t[65] = it))
  ...
  bb0: {
    ...
    t[73] !== p
      ? ((e = {
          ...
          conversationId: re,
          isCommentMode: z,
          nextCommentNumber: oe,
          onCommentsChange: W,
          onDraftActiveChange: Je,
          pageCount: Q,
          path: u,
          title: p,
        }),
                  ...
                  children: [
                    Le
                      ? (0, Z.jsx)(A, {
                          artifactType: `PDF`,
                          title: Pt(p),
                          centerContent: (0, Z.jsx)(k, {
                            currentPage: de,
                            onNextPage: fe,
                            onPreviousPage: pe,
                            totalPages: Q,
                          }),
                          rightContent: (0, Z.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, Z.jsx)(O, {
                                ...
                                zoomPercent: Ce,
                                zoomOptions: M,
                                onZoomPercentChange: Se,
                                fitOption: { selected: xe.kind === `page-width`, onSelect: Ee },
                              }),
                              (0, Z.jsx)(N, { hostId: s, path: u, sizeBytes: d }),
                              (0, Z.jsx)(j, { hostId: s, path: u, showLabel: !0 }),
                              o,
                            ],
                          }),
                        })
