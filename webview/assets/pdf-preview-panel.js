const __vite__mapDeps = (
  ...
  m = __vite__mapDeps,
  d = m.f ||
    (m.f = ["./pdf.js", "./pdf-1.js", "./chunk.js", "./preload-helper.js"]),
) => i.map((i) => d[i]);
...
import "./isEqual.js";
import { At as s, jt as c } from "./src-1.js";
...
import "./check-md.js";
import { t as m } from "./chevron-right.js";
import "./use-stable-callback.js";
import { t as h } from "./tooltip-B.js";
...
import { It as _, gn as v, t as ee } from "./product-logger.js";
import "./parse-directives.js";
import "./platform.js";
import { S as y, f as b, h as x } from "./persisted-signal.js";
...
import "./terminal.js";
import { t as S } from "./error-boundary-DOI-M2iu.js";
...
import { n as te } from "./use-resize-observer.js";
...
import { a as C, c as w, i as T, n as E, o as D, r as O } from "./image-preview-dialog.js";
...
import { t as k } from "./use-diff-comments.js";
...
import "./annotate.js";
import { t as j } from "./annotation-mode-button.js";
import { i as M, r as ne } from "./browser-sidebar-comment-light-dismiss.js";
import "./arrow-rotate-ccw.js";
import "./link.js";
import { n as N, r as re, t as P } from "./artifact-analytics.js";
import { t as F } from "./artifact-preview-status.js";
import {
  a as ie,
  c as ae,
  d as I,
...
function ue(e) {
        ...
        let a = new Map(),
          l = new IntersectionObserver(
            (n) => {
              ...
              let r = fe({ container: e, pageElements: t, pageVisibilityByElement: a });
              r != null &&
                ((s.current != null && r !== s.current) ||
                  (r === s.current && ((s.current = null), c.current?.(), (c.current = null)),
                  o(r)));
            },
            { root: e, threshold: q },
          );
        for (let e of t) (a.set(e, 0), l.observe(e));
        let u = fe({ container: e, pageElements: t, pageVisibilityByElement: a });
        return (
          u != null && o(u),
          () => {
            (l.disconnect(), (s.current = null), c.current?.(), (c.current = null));
          }
        );
      }),
      (d = [n, r, i]),
  ...
  t[5] !== n || t[6] !== r
    ? ((f = (e) => {
        ...
        let a = null,
          l = () => {
            (a != null && (clearTimeout(a), (a = null)), t.removeEventListener(`scroll`, d));
          },
          u = () => {
            if (s.current !== e) return;
            ((s.current = null), l());
            let n = fe({ container: t, pageElements: J(t, r), pageVisibilityByElement: new Map() });
            n != null && o(n);
          },
          d = () => {
            (a != null && clearTimeout(a), (a = setTimeout(u, le)));
          };
        ((c.current = l),
...
function fe({ container: e, pageElements: t, pageVisibilityByElement: n }) {
...
async function Y() {
  ...
  me ??= l(() => import(`./pdf.js`), __vite__mapDeps([0, 1, 2, 3]), import.meta.url);
  let e = await me;
  return (
    (!he || e.GlobalWorkerOptions.workerSrc !== pe) &&
      ((e.GlobalWorkerOptions.workerSrc = pe), (he = !0)),
    e
  );
}
function _e(e) {
...
var X = class {
  ...
  constructor({ linkNavigation: e, pageSelector: t, pdfDocument: n, scrollRootRef: r }) {
  ...
  addLinkAttributes(e, t) {
    ...
    e.onclick = (e) => {
      (e.preventDefault(), e.stopPropagation(), this.linkNavigation?.onExternalLink?.(t));
    };
  }
...
function ve(e) {
        ...
        let l = !1,
          ...
          d = async function () {
            ...
            let c = i.getViewport({ scale: 1 }),
              u = new X({ linkNavigation: r, pageSelector: a, pdfDocument: o, scrollRootRef: s });
  ...
  return (
    t[8] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((d = (0, Q.jsx)(`div`, { ref: c, className: `annotationLayer` })), (t[8] = d))
      : (d = t[8]),
    d
  );
}
...
function xe(e, t) {
  ...
  return n.width <= 0 || n.height <= 0
    ? null
    : {
        x: We(((e.clientX - n.left) / n.width) * t.width, 0, t.width),
        y: We(((e.clientY - n.top) / n.height) * t.height, 0, t.height),
      };
}
function Se({ pageElement: e, pageSize: t }) {
  let n = e.querySelector(`.textLayer`),
    r = e.ownerDocument.getSelection();
  if (n == null || r == null || r.isCollapsed || r.rangeCount === 0 || !Be(r, n)) return null;
  let i = Ue(r.toString());
  if (i.length === 0) return null;
  let a = r.getRangeAt(0);
  if (!n.contains(a.commonAncestorContainer)) return null;
  let o = Array.from(a.getClientRects()),
    s = Me({ clientRects: o, pageElement: e, pageSize: t });
  if (s == null) return null;
  let c = Ne({ clientRects: o, pageElement: e, pageSize: t }),
    l = Pe({ clientRects: o, pageElement: e, pageSize: t, selection: r });
  return {
...
function Ce({
  ...
  for (let o of i.ownerDocument.elementsFromPoint?.(e, t) ?? []) {
    ...
    let e = Oe({ includePreviewMetadata: n, pageElement: i, pageSize: a, target: o });
    if (e != null) return e;
  }
  return null;
}
function we(e, t = !1) {
  let n = Ee(e.start, e.current);
  return !t && n.width < ye && n.height < ye
    ? { kind: `point`, point: e.current }
    : { kind: `region`, rect: n };
}
function Te(e) {
  return (
    Math.abs(e.clientCurrent.x - e.clientStart.x) >= $ ||
    Math.abs(e.clientCurrent.y - e.clientStart.y) >= $
  );
}
function Ee(e, t) {
  return {
...
function Oe({ includePreviewMetadata: e, pageElement: t, pageSize: n, target: r }) {
  let i = ke(r, t);
  if (i == null) return null;
  let a = Me({ clientRects: [i.element.getBoundingClientRect()], pageElement: t, pageSize: n });
  if (a == null) return null;
  let o = e ? Ve(i.element) : ``;
  return {
    kind: `region`,
...
function ke(e, t) {
  ...
  let r = Ae(e, t, (e) => e.matches(`.annotationLayer a, .annotationLayer .linkAnnotation`));
  if (r != null) return { element: r, selectionKind: `link` };
  let i = Ae(e, t, (e) => e.matches(`.annotationLayer section`));
...
function je(e) {
  return e.matches(`.textLayer span:not(.markedContent)`) && e.getAttribute(`role`) !== `img`;
}
function Me({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = t.getBoundingClientRect();
  if (r.width <= 0 || r.height <= 0) return null;
  let i = Re(e);
  if (i == null) return null;
  let a = We(((i.left - r.left) / r.width) * n.width, 0, n.width),
    o = We(((i.top - r.top) / r.height) * n.height, 0, n.height),
    s = We(((i.right - r.left) / r.width) * n.width, 0, n.width),
    c = We(((i.bottom - r.top) / r.height) * n.height, 0, n.height);
  return s <= a || c <= o ? null : { x: a, y: o, width: s - a, height: c - o };
}
function Ne({ clientRects: e, pageElement: t, pageSize: n }) {
  let r = [];
  for (let i of Ie(e)) {
    let e = Me({ clientRects: [i], pageElement: t, pageSize: n });
    e != null && r.push(e);
  }
  return r;
}
function Pe({ clientRects: e, pageElement: t, pageSize: n, selection: r }) {
...
function Fe({ clientX: e, clientY: t, pageElement: n, pageSize: r }) {
  let i = n.getBoundingClientRect();
  return {
    x: We(((e - i.left) / i.width) * r.width, 0, r.width),
    y: We(((t - i.top) / i.height) * r.height, 0, r.height),
  };
}
function Ie(e) {
  let t = [],
...
function Ve(e) {
  ...
  return n.length > 0
    ? n
    : Ue((e instanceof HTMLAnchorElement ? e : e.querySelector(`a`))?.href ?? ``);
}
function He(e, t) {
...
function Ke({
  ...
  let x = i(a),
    ...
    [E, D] = (0, K.useState)(null),
    [O, k] = (0, K.useState)(``),
    [A, j] = (0, K.useState)(null),
    [P, F] = (0, K.useState)(null),
    [ie, I] = (0, K.useState)(null),
    [L, H] = (0, K.useState)(null),
    [U, W] = (0, K.useState)(null),
    [oe, G] = (0, K.useState)(!1),
    [q, le] = (0, K.useState)(!1),
    ue = S.formatMessage({
    ...
    fe = (0, K.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === m), [e, m]),
    pe = U == null ? null : (fe.find((e) => ut(e) === U) ?? null),
    me = L == null ? null : (fe.find((e) => ut(e) === L) ?? null),
    he = me == null ? null : nt(me),
    ge = E ?? he,
    Y = (0, K.useMemo)(
      () =>
        E == null
          ? he == null || me == null || L == null
            ? null
            : $e({
                anchor: he,
                body: rt(me),
      ...
      [l, E, O, he, me, L, m, h, g, b],
    ),
    _e = ge == null ? null : it({ anchor: ge, layer: w, pageSize: h }),
    X = ge != null,
    Z = (0, K.useCallback)(() => {
      (E != null && c?.(m, !1), D(null), F(null), I(null), k(``), H(null), G(!1));
    }, [E, c, m]),
    ...
    ye = (0, K.useCallback)(() => {
      typeof window > `u` ||
        ne({ animationFrameRef: C, animationWindow: window, editorWrapper: te.current });
    }, []),
    $ = (0, K.useCallback)(
      () =>
        Y == null
          ? !1
          : Y.target.mode === `create` && O.trim().length > 0
            ? oe
              ? (Z(), !0)
              : (G(!0), ye(), !1)
            : (Z(), !0),
    ...
    be = (0, K.useEffectEvent)(() => {
      if (ge == null) return;
      let e = it({ anchor: ge, layer: w, pageSize: h });
      e != null && ce(te.current, e);
    });
  (0, K.useEffect)(() => {
    if (!X || w == null) return;
  ...
  let De = (0, K.useEffectEvent)((e) => {
    let t = e.target;
    (t instanceof Node && te.current?.contains(t)) ||
      (e.preventDefault(),
      e.stopPropagation(),
      $() &&
  ...
  (0, K.useEffect)(() => {
    if (t || Y?.target.mode !== `create` || w == null) return;
    let e = w.ownerDocument,
      n = (e) => {
        De(e);
      };
  ...
  let Oe = (0, K.useEffectEvent)(() => {
    if (t || w == null) return;
    let e = w.parentElement;
    if (e == null) return;
    let n = Se({ pageElement: e, pageSize: h });
    if (n == null) {
      F(null);
      return;
    }
    ((E != null || L != null) && !$()) || (F(n), D(null), k(``), H(null), W(null), I(null), G(!1));
  });
  (0, K.useEffect)(() => {
    if (w == null || t) return;
    let e = w.parentElement;
    ...
    return (
      ...
      () => {
        (e.removeEventListener(`mouseup`, n), e.removeEventListener(`keyup`, n));
      }
    );
  }, [t, w]);
  let ke = (e, n, r) => {
    ...
    Ae = (e, n) => {
      (N(
        x,
        { artifactTabId: v, artifactType: `pdf`, importKind: `pdf`, threadId: y },
    ...
    je = (0, K.useEffectEvent)((e, t) => {
      if (E != null || L != null || !B(e)) return;
      let n = Se({ pageElement: t, pageSize: h }) ?? (P?.selectionKind === `text` ? null : P);
      n != null && (e.preventDefault(), e.stopPropagation(), Ae(n, `ask_codex_shortcut`));
    });
  (0, K.useEffect)(() => {
    if (w == null || t) return;
    let e = w.parentElement;
  ...
  let Me = (e) => {
      ((E != null || L != null) && !$()) || Ae(e, `annotation_mode_pointer`);
    },
    Ne = (e) => {
    ...
    Fe = (e) => {
      ...
      let t = xe(e, h) ?? A.current;
      (e.preventDefault(),
        e.stopPropagation(),
        e.currentTarget.hasPointerCapture(e.pointerId) &&
          e.currentTarget.releasePointerCapture(e.pointerId));
      let n = { ...A, current: t, clientCurrent: { x: e.clientX, y: e.clientY } },
        r = Te(n),
        i = we(n, r);
      if (!r) {
        let t = ke(e.clientX, e.clientY, !0);
        if (t != null) {
          (j(null), Me(t));
          return;
        }
      ...
      (Ae(i, `annotation_mode_pointer`), j(null));
    },
    Ie = async (e, { submitDirectly: i = !1 } = {}) => {
      let a = e.body.trim();
      if (L != null) {
        if (a.length === 0 || q) return;
        (r((e) =>
          e.map((e) => (ut(e) === L ? { ...e, content: [{ content_type: `text`, text: a }] } : e)),
        ),
          Z());
        return;
      }
      if (!(E == null || a.length === 0 || q))
        try {
          le(!0);
          let c = et({ anchor: E, pageSize: h }),
            u = crypto.randomUUID(),
            f;
          try {
            f = await at({
          ...
          (ee(x, _, { commentType: c.kind, submitMode: i ? `direct` : `saved` }),
            re(
              x,
              { artifactTabId: v, artifactType: `pdf`, importKind: `pdf`, threadId: y },
              {
                annotationModeEnabled: t,
                annotationTargetKind: c.kind,
  ...
  return (0, Q.jsxs)(`div`, {
    ...
    children: [
      fe.map((e) =>
        (0, Q.jsx)(
          qe,
          {
            ...
            isSelected: ut(e) === L,
            onEdit: (e) => {
              (E != null && c?.(m, !1), D(null), F(null), I(null), k(``), G(!1), W(null), H(e));
            },
            onPreviewChange: W,
          },
          ut(e),
      ...
      pe == null || L != null ? null : (0, Q.jsx)(Je, { comment: pe, layer: w }),
      ie != null && E == null && L == null
        ? (0, Q.jsx)(R, {
            paddingPx: 4,
            pageSize: h,
            rect: ie.rect,
      ...
      P != null && E == null
        ? (0, Q.jsx)(V, {
            anchor: P.askForEditAnchor,
            label: de,
            pageSize: h,
            rect: P.rect,
            testId: `artifact-pdf-ask-for-edit-button`,
            onClick: () => Ae(P, `ask_codex_button`),
          })
        : null,
      A == null ? null : (0, Q.jsx)(Ze, { rect: Ee(A.start, A.current), pageSize: h }),
      E == null ? null : (0, Q.jsx)(Ye, { anchor: E, label: n, pageSize: h }),
      ge == null || _e == null || Y == null
        ? null
        : (0, Q.jsx)(`div`, {
            ref: te,
            className: se,
            style: { left: _e.x, top: _e.y, height: z, width: 294 },
            ...
            children: (0, Q.jsx)(
              M,
              {
                ...
                onCancel: Z,
                onDelete: (e) => {
                  (r((t) => t.filter((t) => ut(t) !== e)), Z());
                },
                onDirectSubmit: (e) => {
                  Ie(e, { submitDirectly: !0 });
                },
                onEscape: Z,
                onBodyChange: Y.target.mode === `create` ? ve : void 0,
                onLightDismissibilityChange: Ge,
                onMounted: Ge,
                onSubmit: (e) => {
                  Ie(e);
                },
...
function qe(e) {
  ...
  if (s == null) return null;
  let c;
  t[0] === n ? (c = t[1]) : ((c = ut(n)), (t[0] = n), (t[1] = c));
  let l = c,
    d;
  ...
  let f = d,
    p;
  t[5] !== l || t[6] !== a ? ((p = () => a(l)), (t[5] = l), (t[6] = a), (t[7] = p)) : (p = t[7]);
  let m = p,
    h;
  ...
  if (s.kind === `region`) {
    ...
    t[15] !== s.selectionRects
      ? ((e =
          s.selectionKind == null
            ? (0, Q.jsx)(Ze, { rect: s.pageRect, pageSize: s.pageSize })
            : (0, Q.jsx)(Xe, {
                bordered: !0,
                anchor: {
                  kind: `region`,
    ...
    t[17] !== l || t[18] !== i
      ...
      : (o = t[19]);
    let c;
    t[20] === s.pageRect ? (c = t[21]) : ((c = De(s.pageRect)), (t[20] = s.pageRect), (t[21] = c));
    let u;
    ...
    return (
      t[31] !== e || t[32] !== u
        ? ((d = (0, Q.jsxs)(Q.Fragment, { children: [e, u] })),
          (t[31] = e),
          (t[32] = u),
          (t[33] = d))
        : (d = t[33]),
...
function Je(e) {
  let t = (0, G.c)(9),
    { comment: n, layer: r } = e,
    i;
  t[0] === n ? (i = t[1]) : ((i = tt(n)), (t[0] = n), (t[1] = i));
  let a = i,
    o;
  t[2] === n ? (o = t[3]) : ((o = rt(n)), (t[2] = n), (t[3] = o));
  let s = o;
  if (a == null) return null;
  let c;
  return (
...
function Ye(e) {
  ...
  if (n.kind === `region`) {
    ...
    t[0] !== n || t[1] !== i
      ? ((e =
          n.selectionKind == null
            ? (0, Q.jsx)(Ze, { rect: n.rect, pageSize: i })
            : (0, Q.jsx)(Xe, {
                bordered: !0,
                anchor: n,
                pageSize: i,
      ...
      : (e = t[2]);
    let a;
    t[3] === n.rect ? (a = t[4]) : ((a = De(n.rect)), (t[3] = n.rect), (t[4] = a));
    let o;
    t[5] !== r || t[6] !== i || t[7] !== a
      ? ((o = (0, Q.jsx)(Qe, { draft: !0, label: r, point: a, pageSize: i })),
        (t[5] = r),
        (t[6] = i),
        (t[7] = a),
        (t[8] = o))
    ...
    return (
      t[9] !== e || t[10] !== o
        ? ((s = (0, Q.jsxs)(Q.Fragment, { children: [e, o] })),
          (t[9] = e),
          (t[10] = o),
          (t[11] = s))
        : (s = t[11]),
  ...
  return (
    t[12] !== n.point || t[13] !== r || t[14] !== i
      ? ((a = (0, Q.jsx)(Qe, { draft: !0, label: r, point: n.point, pageSize: i })),
        (t[12] = n.point),
        (t[13] = r),
        (t[14] = i),
        (t[15] = a))
...
function Xe(e) {
  ...
  if (n.selectionKind === `text`) {
    ...
    t[0] !== n.rect || t[1] !== n.selectionRects
      ? ((e =
          n.selectionRects == null || n.selectionRects.length === 0 ? [n.rect] : n.selectionRects),
        (t[0] = n.rect),
  ...
  return (
    t[12] !== n.rect || t[13] !== o || t[14] !== i || t[15] !== a
      ? ((s = (0, Q.jsx)(R, { bordered: o, paddingPx: 4, pageSize: i, rect: n.rect, testId: a })),
        (t[12] = n.rect),
        (t[13] = o),
        (t[14] = i),
        (t[15] = a),
...
function $e({
  ...
  let c = e.kind === `region` ? e.rect : { x: e.point.x, y: e.point.y, width: 1, height: 1 },
    l = e.kind === `region` ? { x: e.rect.x + e.rect.width, y: e.rect.y } : e.point;
  return {
    sessionId:
      o.mode === `edit`
        ? `pdf-comment-edit:${o.commentId}`
        : e.kind === `region`
          ? [`pdf-comment`, r, `region`, e.rect.x, e.rect.y, e.rect.width, e.rect.height].join(`:`)
...
function et({ anchor: e, pageSize: t }) {
  return e.kind === `region`
    ? {
        ...
        ...(e.selectionKind == null ? {} : { selectionKind: e.selectionKind }),
...
function tt(e) {
  ...
  return t == null
    ? null
    : t.kind === `region`
      ? { pageSize: t.pageSize, point: De(t.pageRect) }
  ...
  return t == null
    ...
    : t.kind === `region`
      ? {
          ...
          ...(t.selectionKind == null ? {} : { selectionKind: t.selectionKind }),
...
function it({ anchor: e, layer: t, pageSize: n }) {
  return e.kind === `region` && e.selectionKind != null
    ? I({ layer: t, pageSize: n, rect: e.rect })
    : L({ layer: t, markerPoint: e.kind === `region` ? De(e.rect) : e.point, pageSize: n });
}
async function at({
  anchor: e,
  commentId: t,
  ...
  return (
    u.drawImage(c, o.x * s, o.y * s, o.width * s, o.height * s, 0, 0, l.width, l.height),
    ct({ anchor: e, context: u, crop: o, markerLabel: n, scale: s }),
    {
      commentId: t,
...
function ot(e, t) {
  if (e.kind === `region`) {
    let n = Math.max(24, Math.min(72, Math.min(e.rect.width, e.rect.height) * 0.25));
    return st(
      {
        x: e.rect.x - n,
        y: e.rect.y - n,
  ...
  return st({ x: e.point.x - 180, y: e.point.y - 120, width: 360, height: 240 }, t);
}
function st(e, t) {
  let n = Math.min(Math.max(e.width, 1), t.width),
    r = Math.min(Math.max(e.height, 1), t.height);
  return { x: dt(e.x, 0, t.width - n), y: dt(e.y, 0, t.height - r), width: n, height: r };
}
function ct({ anchor: e, context: t, crop: n, markerLabel: r, scale: i }) {
  if (
    (t.save(),
    (t.strokeStyle = oe),
    (t.fillStyle = oe),
    ...
    let a = (e.rect.x - n.x) * i,
      ...
      s = e.rect.width * i,
      c = e.rect.height * i;
    (t.strokeRect(a, o, s, c), lt(t, r, a + s, o));
  } else lt(t, r, (e.point.x - n.x) * i, (e.point.y - n.y) * i);
  t.restore();
}
function lt(e, t, n, r) {
  (e.beginPath(),
...
function ft(e) {
    ...
    ? ((a = () => {
        ...
        let a = !1,
          ...
          c = async function () {
            ...
            o = new e.TextLayer({
              container: t,
              textContentSource: r.streamTextContent({ includeMarkedContent: !0 }),
        ...
        return (
          ...
          () => {
            ((a = !0), s != null && clearTimeout(s), o?.cancel(), (t.innerHTML = ``));
          }
        );
      }),
      (o = [n, r]),
  ...
  return (
    t[4] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((s = (0, Q.jsx)(`div`, { ref: i, className: `textLayer` })), (t[4] = s))
      : (s = t[4]),
    s
  );
}
var pt = { height: 792, width: 612 },
  mt = 0.3,
  ht = 8,
  gt = 1e-4,
  _t = 5,
  vt = 200,
  yt = [mt, 0.4, 0.5, 0.67, 0.75, 0.9, 1, 1.1, 1.25, 1.5, 1.75, 2, 2.5, 3, 4, 5, 6, 7, ht];
function bt(e) {
  let t = (0, G.c)(36),
  ...
  let y = ee,
    b;
  t[6] !== r || t[7] !== i
    ? ((b = (e) => St({ pageViewportSize: r, pageWidth: i, resize: e })),
      (t[6] = r),
      (t[7] = i),
      (t[8] = b))
    : (b = t[8]);
  ...
  t[11] === y
    ? (C = t[12])
    : ((C = (e) => {
        y({ kind: `percentage`, value: Tt(e / 100) });
      }),
      (t[11] = y),
      (t[12] = C));
  let w = C,
  ...
  t[13] !== x || t[14] !== n
    ? ((T = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: wt(x(e), `out`) })));
      }),
      (t[13] = x),
      (t[14] = n),
      (t[15] = T))
  ...
  t[16] !== x || t[17] !== n
    ? ((D = () => {
        (n({ kind: `center` }), g(), s((e) => ({ kind: `percentage`, value: wt(x(e), `in`) })));
      }),
      (t[16] = x),
      (t[17] = n),
      (t[18] = D))
  ...
  t[19] !== x || t[20] !== n
    ? ((k = (e) => {
        ...
        ((p.current = 0),
          ...
          g(),
          s((e) => ({ kind: `percentage`, value: wt(x(e), t) })));
      }),
      (t[19] = x),
      (t[20] = n),
      (t[21] = k))
  ...
  let A = k,
    j;
  t[22] !== x || t[23] !== o
    ? ((j = Math.round(x(o) * 100)), (t[22] = x), (t[23] = o), (t[24] = j))
    : (j = t[24]);
  let M;
  return (
    t[25] !== E ||
...
function St({ pageViewportSize: e, pageWidth: t, resize: n }) {
  if (n.kind === `percentage`) return Tt(n.value);
  let r = e?.width ?? pt.width;
  return t == null || t <= 0 || r <= 0 ? 1 : Tt(t / r);
}
function Ct({ pageViewportSize: e, pageWidth: t, resize: n }) {
  let r = e ?? pt,
    i = r.width / r.height,
    a =
      n.kind === `page-width` && t != null && t > 0
        ? t
        : r.width * St({ pageViewportSize: e, pageWidth: t, resize: n });
  return { height: Math.round(a / i), width: Math.round(a) };
}
function wt(e, t) {
  let n = Tt(e);
  if (t === `in`) {
    for (let e of yt) if (e > n + gt) return e;
...
function Tt(e) {
  return Math.min(ht, Math.max(mt, e));
}
var Et = (0, K.memo)(function (e) {
  let t = (0, G.c)(55),
    {
      commentLayer: n,
      currentPage: r,
    ...
    b = _?.pdfDocument === l,
    x = b ? _.page : null,
    S = b ? _.viewportSize : null,
    te = S ?? s,
    C;
  t[0] !== c || t[1] !== u || t[2] !== te
    ? ((C = Ct({ pageViewportSize: te, pageWidth: c, resize: u })),
      (t[0] = c),
      (t[1] = u),
      (t[2] = te),
      (t[3] = C))
    : (C = t[3]);
  let w = C,
    T = S != null && S.width > 0 ? w.width / S.width : 1,
    E = Math.abs(r - a),
    D = ee || E <= 2,
    O = ee || E <= 2,
    k = ee ? 50 : 50 + E * 40,
        ...
        return (
          ...
          (async function () {
            try {
              ...
              v({ page: t, pdfDocument: l, viewportSize: { height: n.height, width: n.width } });
            } catch {
              e || v(null);
            }
          })(),
  ...
  (t[12] === d
    ...
    : ((re = () => {
        ...
        let t = new IntersectionObserver(
          (e) => {
            let t = e[0];
            t != null && y(t.isIntersecting || t.intersectionRatio > 0);
          },
    ...
    (0, K.useEffect)(re, P));
  let F;
  t[15] !== w.height || t[16] !== w.width || t[17] !== f || t[18] !== x || t[19] !== D
    ? ((F = () => {
        let e = h.current;
        if (e == null) return;
        if (x == null || !D) {
        ...
        if (f) return;
        let t = x.getViewport({ scale: 1 });
        if (t.width <= 0 || w.width <= 0 || w.height <= 0) return;
        let n = null,
          r = window.devicePixelRatio || 1,
          i = Math.ceil(w.width * r),
          a = Math.ceil(w.height * r);
        ((e.width = i), (e.height = a), e.getContext(`2d`)?.clearRect(0, 0, i, a));
        try {
          ((n = x.render({ canvas: e, viewport: x.getViewport({ scale: i / t.width }) })),
            n.promise.catch(Dt));
        } catch {
          return;
        }
  ...
  t[26] !== m
    ...
    : (ie = t[27]),
    (0, K.useEffect)(F, ie));
  let ae = S == null ? void 0 : ``,
    I = x?.userUnit ?? 1,
    L;
  t[28] !== w.height || t[29] !== w.width || t[30] !== T || t[31] !== I
    ? ((L = { "--scale-factor": T, "--user-unit": I, height: w.height, width: w.width }),
      (t[28] = w.height),
      (t[29] = w.width),
      (t[30] = T),
      (t[31] = I),
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((z = (0, Q.jsx)(`canvas`, { ref: h, className: `absolute inset-0 size-full` })), (t[33] = z))
    : (z = t[33]);
  let B;
  t[34] !== A ||
  t[35] !== f ||
  ...
  t[42] !== k
    ...
    : (B = t[43]);
  let V;
  t[44] !== n || t[45] !== S || t[46] !== x || t[47] !== a
    ? ((V =
        x == null || S == null || n == null
          ? null
          : (0, Q.jsx)(
              Ke,
              {
  ...
  let H;
  return (
    t[49] !== a || t[50] !== ae || t[51] !== R || t[52] !== B || t[53] !== V
      ? ((H = (0, Q.jsxs)(`div`, {
          ref: g,
...
function Ot(e) {
  let t = (0, G.c)(70),
    ...
    f = (0, K.useRef)(null),
    h;
  t[0] !== n || t[1] !== r ? ((h = At(n, r)), (t[0] = n), (t[1] = r), (t[2] = h)) : (h = t[2]);
  let [_, v] = (0, K.useState)(h),
    [ee, y] = (0, K.useState)(null),
    b;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((b = (e) => {
        y({ height: Math.floor(e.contentRect.height), width: Math.floor(e.contentRect.width) });
      }),
      (t[3] = b))
    : (b = t[3]);
  let x = te(b),
  ...
  let T = w,
    E;
  t[8] !== T || t[9] !== a
    ? ((E = { onExternalLink: a, onPageChange: T }), (t[8] = T), (t[9] = a), (t[10] = E))
    : (E = t[10]);
  let D = E,
    O;
  t[11] === l
  ...
  let P = re,
    F;
  t[21] !== P || t[22] !== T || t[23] !== N || t[24] !== r || t[25] !== i
    ? ((F = (e) => {
        if (e.key === `Escape`) {
          (e.preventDefault(), i());
          return;
    ...
    ? ((ae = (e) => {
        if (
          ...
          (e.target instanceof Element &&
            e.target.closest(`a,button,input,select,textarea,[role='button']`) != null)
        )
          return;
        let t = e.currentTarget.getBoundingClientRect();
        e.clientX < t.left + t.width / 2 ? N() : P();
      }),
      (t[27] = P),
      (t[28] = N),
      (t[29] = ae))
  ...
  let I = ae,
    L;
  t[30] !== o || t[31] !== ee
    ? ((L = kt({ pageViewportSize: o, presentationSize: ee })),
      (t[30] = o),
      (t[31] = ee),
      (t[32] = L))
    : (L = t[32]);
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (R = t[33]);
  let z;
  t[34] !== M || t[35] !== D || t[36] !== o || t[37] !== s || t[38] !== L
    ? ((z = (0, Q.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (0, Q.jsx)(m, { className: `icon-2xs rotate-180` })), (t[40] = V))
    : (V = t[40]);
  let H;
  t[41] !== N || t[42] !== k || t[43] !== B
    ? ((H = (0, Q.jsx)(p, {
        "aria-label": k,
        color: `ghost`,
        disabled: B,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((oe = (0, Q.jsx)(m, { className: `icon-2xs` })), (t[48] = oe))
    : (oe = t[48]);
  let se;
  t[49] !== P || t[50] !== j || t[51] !== W
    ? ((se = (0, Q.jsx)(p, {
        "aria-label": j,
        color: `ghost`,
        disabled: W,
  ...
  t[53] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = (0, Q.jsx)(`div`, { className: `mx-1 h-4 w-px bg-white/25` })), (t[53] = ce))
    : (ce = t[53]);
  let q, le;
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((q = (0, Q.jsx)(g, { className: `icon-2xs` })),
      (le = (0, Q.jsx)(d, {
  ...
  let de;
  return (
    t[63] !== I || t[64] !== ie || t[65] !== C || t[66] !== z || t[67] !== J || t[68] !== c
      ? ((de = (0, Q.jsxs)(`div`, {
          ref: C,
          "aria-label": c,
          autoFocus: !0,
...
function kt({ pageViewportSize: e, presentationSize: t }) {
  let n = e?.width ?? 612,
    r = e?.height ?? 792;
...
function jt({ anchor: e, container: t, pageSelector: n }) {
  let r = t.getBoundingClientRect(),
    i = e.kind === `point` ? e.clientX : r.left + r.width / 2,
    a = e.kind === `point` ? e.clientY : r.top + r.height / 2,
    o = Nt({ anchorClientX: i, anchorClientY: a, container: t, pageSelector: n });
  ...
  return c.width <= 0 || c.height <= 0
    ...
    : {
        ...
        pageNumber: s,
        ratioX: Lt((i - c.left) / c.width),
        ratioY: Lt((a - c.top) / c.height),
      };
}
function Mt({ anchorState: e, container: t, pageSelector: n }) {
  let r = Pt({ container: t, pageNumber: e.pageNumber, pageSelector: n });
  if (r == null) return !1;
  let i = t.getBoundingClientRect(),
...
function Nt({ anchorClientX: e, anchorClientY: t, container: n, pageSelector: r }) {
  ...
  for (let i of Ft(n, r)) {
    let n = i.getBoundingClientRect(),
      r = It({ max: n.bottom, min: n.top, value: t }) + It({ max: n.right, min: n.left, value: e });
    r < s && ((s = r), (o = i));
  }
  return o;
}
function Pt({ container: e, pageNumber: t, pageSelector: n }) {
  return Ft(e, n).find((e) => Number(e.dataset.pageNumber) === t) ?? null;
}
function Ft(e, t) {
  return Array.from(e.querySelectorAll(t));
}
function It({ max: e, min: t, value: n }) {
...
function Rt(e) {
  ...
  return (
    t[11] !== r || t[12] !== p
      ? ((m = (0, Q.jsx)(S, { name: `PdfPreviewPanel`, resetKey: r, fallback: f, children: p })),
        (t[11] = r),
        (t[12] = p),
        (t[13] = m))
      : (m = t[13]),
...
function zt(e) {
  let t = (0, G.c)(122),
    ...
    ie = (0, K.useRef)(null),
    ae;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((ae = new Set()), (t[0] = ae)) : (ae = t[0]);
  let I = (0, K.useRef)(ae),
    [L, R] = (0, K.useState)(!1),
    [z, B] = (0, K.useState)(!1),
    [V, H] = (0, K.useState)(null),
    U;
  t[1] === g.value ? (U = t[2]) : ((U = x(g.value)), (t[1] = g.value), (t[2] = U));
  let W = U,
    oe;
  t[3] === W ? (oe = t[4]) : ((oe = W ?? y({ entrypoint: `home` })), (t[3] = W), (t[4] = oe));
  let se = oe,
    [ce, q] = k(se),
    le;
  if (t[5] !== ce || t[6] !== d) {
    ...
    (t[8] === d
      ? (e = t[9])
      : ((e = (e) => c(e) && e.localPdfContext?.path === d), (t[8] = d), (t[9] = e)),
      (le = ce.filter(e)),
      (t[5] = ce),
      (t[6] = d),
      (t[7] = le));
  ...
  let J = le,
    de;
  t[10] === J ? (de = t[11]) : ((de = Math.max(0, ...J.map(Ut))), (t[10] = J), (t[11] = de));
  let fe = de + 1,
    pe,
    me;
  (t[12] !== d || t[13] !== q
    ? ((pe = () => () => {
        q((e) => {
          let t = e.filter((e) => !(c(e) && e.localPdfContext?.path === d));
    ...
    (0, K.useEffect)(pe, me));
  let he;
  t[16] === r ? (he = t[17]) : ((he = { fileDataUrl: r }), (t[16] = r), (t[17] = he));
  let {
      loadedFileDataUrl: Y,
      loadState: _e,
      numPages: X,
  ...
  t[18] === X
    ? (ye = t[19])
    : ((ye = { containerRef: M, pageSelector: `[data-artifact-pdf-page]`, totalPages: X }),
      (t[18] = X),
      (t[19] = ye));
  let { currentPage: $, goToNextPage: be, goToPreviousPage: xe } = ue(ye),
    Se;
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Se = (e) => {
        ...
        N.current = jt({ anchor: e, container: t, pageSelector: `[data-artifact-pdf-page]` });
      }),
      (t[20] = Se))
    : (Se = t[20]);
  let Ce = Se,
    we;
  t[21] !== Z || t[22] !== V
    ? ((we = { onBeforeZoom: Ce, pageViewportSize: Z, pageWidth: V }),
      (t[21] = Z),
      (t[22] = V),
      (t[23] = we))
    : (we = t[23]);
  let {
    ...
    Ne;
  t[24] !== $ || t[25] !== Ee || t[26] !== ke
    ? ((Ne = () => {
        let e =
          ke.kind === `page-width`
            ? null
            : M.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${$}"]`);
        (Ee(),
          e != null &&
  ...
  t[28] === Te
    ...
    : ((Fe = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = ie.current;
        n !== t && (n != null && (Ce({ kind: `center` }), Te()), (ie.current = t), H(t));
      }),
      (t[28] = Te),
      (t[29] = Fe));
  let Ie = te(Fe),
  ...
  t[30] !== X || t[31] !== ve
    ? ((Le = () => {
        ...
        e == null ||
          ...
          X < 1 ||
          (Mt({
            anchorState: { ...e, pageNumber: Math.min(e.pageNumber, X) },
            container: t,
  ...
  t[33] === Re
    ...
    : ((ze = () => {
      ...
      (t[34] = ze));
  let Be;
  (t[35] !== Z || t[36] !== V || t[37] !== ke || t[38] !== Re
    ? ((Be = [Z, V, ke, Re]), (t[35] = Z), (t[36] = V), (t[37] = ke), (t[38] = Re), (t[39] = Be))
    : (Be = t[39]),
    (0, K.useLayoutEffect)(ze, Be));
  let Ve, He;
  (t[40] === r
    ? ((Ve = t[41]), (He = t[42]))
    : ((Ve = () => {
        re.current !== r && ((re.current = r), Ce({ kind: `center` }));
      }),
      (He = [Ce, r]),
      (t[40] = r),
      (t[41] = Ve),
      (t[42] = He)),
    (0, K.useLayoutEffect)(Ve, He));
  let Ue;
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ue = () => {
        ((ne.current = !1), R(!1), B(!1));
      }),
      (t[43] = Ue))
    : (Ue = t[43]);
  let We;
  (t[44] === r ? (We = t[45]) : ((We = [r]), (t[44] = r), (t[45] = We)), (0, K.useEffect)(Ue, We));
  let Ge, Ke;
  (t[46] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ge = () => {
        let e = () => {
          document.fullscreenElement !== S.current && R(!1);
        };
        return (
  ...
  t[50] !== X || t[51] !== g
    ? ((Qe = () => {
        ((ne.current = !0), ee(g, v, { pageCount: X }));
      }),
      (t[50] = X),
      (t[51] = g),
      (t[52] = Qe))
    : (Qe = t[52]);
  let $e = (0, K.useEffectEvent)(Qe),
    et;
  t[53] !== $e || t[54] !== Xe
    ? ((et = () => {
        !Xe || ne.current || $e();
    ...
    : (et = t[55]);
  let tt;
  (t[56] === Xe ? (tt = t[57]) : ((tt = [Xe]), (t[56] = Xe), (t[57] = tt)),
    (0, K.useEffect)(et, tt));
  let nt;
  t[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((nt = () => {
        (R(!1), document.fullscreenElement === S.current && document.exitFullscreen().catch(Ht));
      }),
      (t[58] = nt))
    : (nt = t[58]);
  let rt = nt,
  ...
  t[59] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((it = (e) => {
        (R(!1),
          (document.fullscreenElement === S.current ? document.exitFullscreen() : Promise.resolve())
            .catch(Vt)
            .finally(() => {
              o.dispatchMessage(`open-in-browser`, { url: e });
            }));
      }),
      (t[59] = it))
    : (it = t[59]);
  ...
  t[67] === _
    ...
    : ((ft = _.formatMessage({
      ...
      (t[68] = ft));
  let pt = ft,
    [mt, ht] = (0, K.useState)(!1),
    gt;
  t[69] !== z || t[70] !== g || t[71] !== p || t[72] !== W
    ? ((gt = () => {
        (ht(!1),
          z || P(g, { artifactTabId: p, artifactType: `pdf`, importKind: `pdf`, threadId: W }),
          B(Bt));
      }),
      (t[69] = z),
      (t[70] = g),
    ...
    : (gt = t[73]);
  let _t;
  t[74] !== dt || t[75] !== pt || t[76] !== z || t[77] !== gt
    ? ((_t = (0, Q.jsx)(j, { active: z, activeLabel: pt, label: dt, onClick: gt })),
      (t[74] = dt),
      (t[75] = pt),
      (t[76] = z),
      (t[77] = gt),
  ...
  t[88] !== m
    ? ((yt = {
        ...
        conversationId: se,
        isCommentMode: z,
        nextCommentNumber: fe,
        onCommentsChange: q,
        onDraftActiveChange: st,
        pageCount: X,
        path: d,
        tabId: p,
        threadId: W,
                          ...
                          rightContent: (0, Q.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, Q.jsx)(D, {
                                ...
                                zoomPercent: je,
                                zoomOptions: w,
                                onZoomPercentChange: Ae,
                                fitOption: { selected: ke.kind === `page-width`, onSelect: Pe },
                              }),
                              n === `default`
                                ? (0, Q.jsxs)(Q.Fragment, {
                                    children: [
                                      (0, Q.jsx)(E, { hostId: s, path: d, sizeBytes: f }),
                                      (0, Q.jsx)(T, {
                                        hostId: s,
                                        onBeforeOpen: l,
                                        path: d,
