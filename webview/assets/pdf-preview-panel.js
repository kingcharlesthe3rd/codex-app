...
import {
  n as Ae,
  t as je,
} from "./app-initial~app-main~remote-conversation-page~onboarding-page~hotkey-window-thread-page~thr~cr83yrz8-D.js";
...
var He,
  ...
  Ge,
  Ke = e(() => {
    ((He = V()), (Ue = t(K(), 1)), (We = [0, 0.25, 0.5, 0.75, 1]), (Ge = 100));
  });
function qe(e) {
  let t = (0, Xe.c)(9),
    { fileDataUrl: n } = e,
...
async function Je() {
  ...
  $e ??= P(() => import(`./pdf.js`), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6]), import.meta.url);
  let e = await $e;
  return (
...
function zt({
  ...
  let y = N(d),
    ...
    ae = (0, Y.useMemo)(() => e.filter((e) => e.localPdfContext?.pageNumber === f), [e, f]),
    oe = z == null ? null : (ae.find((e) => rn(e) === z) ?? null),
    se = L == null ? null : (ae.find((e) => rn(e) === L) ?? null),
    K = se == null ? null : Yt(se),
    le = D ?? K,
    q = (0, Y.useMemo)(
      () =>
        D == null
          ? K == null || se == null || L == null
            ? null
            : Kt({
                anchor: K,
                body: Xt(se),
      ...
      [o, D, k, K, se, L, f, p, m, _],
    ),
    ue = le == null ? null : Zt({ anchor: le, layer: w, pageSize: p }),
    de = le != null,
    pe = (0, Y.useCallback)(() => {
      (D != null && a?.(f, !1), O(null), F(null), I(null), A(``), R(null), H(!1));
    }, [D, a, f]),
    me = (0, Y.useCallback)((e) => {
      (A(e), H(!1));
    }, []),
    he = (0, Y.useCallback)(() => {
      typeof window > `u` ||
        we({ animationFrameRef: C, animationWindow: window, editorWrapper: x.current });
    }, []),
    ve = (0, Y.useCallback)(
      () =>
        q == null
    ...
    ye = (0, Y.useEffectEvent)(() => {
      if (le == null) return;
      let e = Zt({ anchor: le, layer: w, pageSize: p });
      e != null && E(x.current, e);
    });
  (0, Y.useEffect)(() => {
    if (!de || w == null) return;
  ...
  (0, Y.useEffect)(() => {
    if (t || q?.target.mode !== `create` || w == null) return;
    let e = w.ownerDocument,
      n = (e) => {
        xe(e);
      };
  ...
  let Se = (0, Y.useEffectEvent)(() => {
    ...
    if (e == null) return;
    let n = ft({ pageElement: e, pageSize: p });
    if (n == null) {
      F(null);
      return;
    }
    ((D != null || L != null) && !ve()) || (F(n), O(null), A(``), R(null), B(null), I(null), H(!1));
  });
  (0, Y.useEffect)(() => {
    if (w == null || t) return;
    let e = w.parentElement;
  ...
  let Ce = (e, n, r) => {
    ...
    Ee = (0, Y.useEffectEvent)((e, t) => {
      if (D != null || L != null || !T(e)) return;
      let n = ft({ pageElement: t, pageSize: p }) ?? (P?.selectionKind === `text` ? null : P);
  ...
  let De = (e) => {
      ((D != null || L != null) && !ve()) || Te(e, `annotation_mode_pointer`);
    },
    Oe = (e) => {
    ...
    Ae = (e) => {
      ...
      (Te(i, `annotation_mode_pointer`), M(null));
    },
    je = async (e, { submitDirectly: a = !1 } = {}) => {
      let s = e.body.trim();
      if (L != null) {
        if (s.length === 0 || U) return;
        (r((e) =>
          e.map((e) => (rn(e) === L ? { ...e, content: [{ content_type: `text`, text: s }] } : e)),
        ),
          pe());
        return;
      }
      if (!(D == null || s.length === 0 || U))
        try {
          W(!0);
          let u = qt({ anchor: D, pageSize: p }),
            d = crypto.randomUUID(),
            v;
          try {
            v = await Qt({
          ...
          (S(y, fe, { commentType: u.kind, submitMode: a ? `direct` : `saved` }),
            Me(
              y,
              { artifactTabId: h, artifactType: `pdf`, importKind: `pdf`, threadId: g },
              {
  ...
  return (0, X.jsxs)(`div`, {
    ...
    children: [
      ae.map((e) =>
        (0, X.jsx)(
          Bt,
          {
            ...
            isSelected: rn(e) === L,
            onEdit: (e) => {
              (D != null && a?.(f, !1), O(null), F(null), I(null), A(``), H(!1), B(null), R(e));
            },
            onPreviewChange: B,
          },
          rn(e),
      ...
      oe == null || L != null ? null : (0, X.jsx)(Vt, { comment: oe, layer: w }),
      te != null && D == null && L == null
        ? (0, X.jsx)(ge, {
            paddingPx: 4,
            pageSize: p,
            rect: te.rect,
      ...
      P != null && D == null
        ? (0, X.jsx)(_e, {
            ...
            onClick: () => Te(P, `ask_codex_button`),
          })
        : null,
      j == null ? null : (0, X.jsx)(Wt, { rect: gt(j.start, j.current), pageSize: p }),
      D == null ? null : (0, X.jsx)(Ht, { anchor: D, label: n, pageSize: p }),
      le == null || ue == null || q == null
        ? null
        : (0, X.jsx)(`div`, {
            ref: x,
            className: J,
            style: { left: ue.x, top: ue.y, height: s, width: 294 },
            ...
            children: (0, X.jsx)(
              be,
              {
                ...
                onCancel: pe,
                onDelete: (e) => {
                  (r((t) => t.filter((t) => rn(t) !== e)), pe());
                },
                onDirectSubmit: (e) => {
                  je(e, { submitDirectly: !0 });
                },
                onEscape: pe,
                onBodyChange: q.target.mode === `create` ? me : void 0,
...
function Ut(e) {
  ...
  return (
    t[12] !== n.rect || t[13] !== o || t[14] !== i || t[15] !== a
      ? ((s = (0, X.jsx)(ge, { bordered: o, paddingPx: 4, pageSize: i, rect: n.rect, testId: a })),
        (t[12] = n.rect),
        (t[13] = o),
        (t[14] = i),
        (t[15] = a),
...
function Zt({ anchor: e, layer: t, pageSize: r }) {
  return e.kind === `region` && e.selectionKind != null
    ? oe({ layer: t, pageSize: r, rect: e.rect })
    : n({ layer: t, markerPoint: e.kind === `region` ? _t(e.rect) : e.point, pageSize: r });
}
async function Qt({
  anchor: e,
  commentId: t,
    ...
    ((jn = V()),
      ...
      (Pn = (0, Mn.memo)(function (e) {
        ...
        t[0] !== c || t[1] !== u || t[2] !== w
          ...
          : (T = t[3]);
        let E = T,
          ee = C != null && C.width > 0 ? E.width / C.width : 1,
          D = Math.abs(r - a),
          O = y || D <= 2,
          k = y || D <= 2,
          A = y ? 50 : 50 + D * 40,
        ...
        (t[12] === d
          ...
          (0, Mn.useEffect)(te, I));
        let L;
        t[15] !== E.height || t[16] !== E.width || t[17] !== f || t[18] !== S || t[19] !== O
          ? ((L = () => {
              let e = h.current;
              if (e == null) return;
              if (S == null || !O) {
        ...
        let z = C == null ? void 0 : ``,
          B = S?.userUnit ?? 1,
          V;
        t[28] !== E.height || t[29] !== E.width || t[30] !== ee || t[31] !== B
          ? ((V = { "--scale-factor": ee, "--user-unit": B, height: E.height, width: E.width }),
            (t[28] = E.height),
            (t[29] = E.width),
            (t[30] = ee),
            (t[31] = B),
        ...
        let G;
        return (
          t[49] !== a || t[50] !== z || t[51] !== ne || t[52] !== U || t[53] !== W
            ? ((G = (0, Nn.jsxs)(`div`, {
                ref: g,
...
function In(e) {
  ...
  let [m, h] = (0, Bn.useState)(f),
    [g, _] = (0, Bn.useState)(null),
    y;
  ...
  let P = N,
    F;
  t[21] !== P || t[22] !== w || t[23] !== M || t[24] !== r || t[25] !== i
    ? ((F = (e) => {
        if (e.key === `Escape`) {
          (e.preventDefault(), i());
          return;
  ...
  let R = L,
    z;
  t[30] !== s || t[31] !== g
    ? ((z = Ln({ pageViewportSize: s, presentationSize: g })),
      (t[30] = s),
      (t[31] = g),
      (t[32] = z))
    : (z = t[32]);
  ...
  t[33] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (B = t[33]);
  let V;
  t[34] !== A || t[35] !== E || t[36] !== s || t[37] !== c || t[38] !== z
    ? ((V = (0, Z.jsx)(`div`, {
  ...
  t[40] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (0, Z.jsx)(U, { className: `icon-2xs rotate-180` })), (t[40] = H))
    : (H = t[40]);
  let W;
  t[41] !== M || t[42] !== D || t[43] !== ne
    ? ((W = (0, Z.jsx)(re, {
        "aria-label": D,
        color: `ghost`,
        disabled: ne,
  ...
  t[48] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, Z.jsx)(U, { className: `icon-2xs` })), (t[48] = ae))
    : (ae = t[48]);
  let oe;
  ...
  t[54] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (0, Z.jsx)(o, { className: `icon-2xs` })),
      (ce = (0, Z.jsx)(p, {
  ...
  let ue;
  return (
    t[63] !== R || t[64] !== te || t[65] !== S || t[66] !== V || t[67] !== q || t[68] !== l
      ? ((ue = (0, Z.jsxs)(`div`, {
          ref: S,
          "aria-label": l,
          autoFocus: !0,
...
var zn,
  ...
  Z,
  Vn = e(() => {
    ((zn = V()), (Bn = t(K(), 1)), C(), R(), H(), me(), te(), Fn(), (Z = de()));
  });
...
function Xn(e) {
  ...
  return (
    t[11] !== r || t[12] !== p
      ? ((m = (0, $.jsx)(Oe, { name: `PdfPreviewPanel`, resetKey: r, fallback: f, children: p })),
        (t[11] = r),
        (t[12] = p),
        (t[13] = m))
      : (m = t[13]),
...
function Zn(e) {
  ...
  let E = (0, Q.useRef)(T),
    ...
    R;
  t[1] === p.value ? (R = t[2]) : ((R = ue(p.value)), (t[1] = p.value), (t[2] = R));
  let z = R,
    B;
  t[3] === z ? (B = t[4]) : ((B = z ?? he({ entrypoint: `home` })), (t[3] = z), (t[4] = B));
  let V = B,
    ne = F(Te, V),
    H;
  t[5] !== V || t[6] !== p
  ...
  if (t[8] !== ne || t[9] !== s) {
    ...
    (t[11] === s
      ? (e = t[12])
      : ((e = (e) => q(e) && e.localPdfContext?.path === s), (t[11] = s), (t[12] = e)),
      (W = ne.filter(e)),
      (t[8] = ne),
      (t[9] = s),
      (t[10] = W));
  ...
  let G = W,
    re;
  t[13] === G ? (re = t[14]) : ((re = Math.max(0, ...G.map(tr))), (t[13] = G), (t[14] = re));
  let ie = re + 1,
    ae,
    oe;
  (t[15] !== s || t[16] !== U
    ? ((ae = () => () => {
        U((e) => {
          let t = e.filter((e) => !(q(e) && e.localPdfContext?.path === s));
    ...
    (0, Q.useEffect)(ae, oe));
  let K;
  t[19] === r ? (K = t[20]) : ((K = { fileDataUrl: r }), (t[19] = r), (t[20] = K));
  let {
  ...
  t[21] === J
    ? (me = t[22])
    : ((me = { containerRef: _, pageSelector: `[data-artifact-pdf-page]`, totalPages: J }),
      (t[21] = J),
      (t[22] = me));
  let { currentPage: ge, goToNextPage: _e, goToPreviousPage: ve } = Re(me),
    ye;
  ...
  let be = ye,
    xe;
  t[24] !== fe || t[25] !== P
    ? ((xe = { onBeforeZoom: be, pageViewportSize: fe, pageWidth: P }),
      (t[24] = fe),
      (t[25] = P),
      (t[26] = xe))
    : (xe = t[26]);
  let {
    ...
    Fe;
  t[27] !== ge || t[28] !== we || t[29] !== ke
    ? ((Fe = () => {
        let e =
          ke.kind === `page-width`
            ? null
            : _.current?.querySelector(`[data-artifact-pdf-page][data-page-number="${ge}"]`);
        (we(),
          e != null &&
  ...
  t[31] === Se
    ...
    : ((ze = (e) => {
        ...
        let t = Math.max(0, Math.floor(e.contentRect.width) - 48),
          n = C.current;
        n !== t && (n != null && (be({ kind: `center` }), Se()), (C.current = t), te(t));
      }),
      (t[31] = Se),
      (t[32] = ze));
  let Be = I(ze),
  ...
  t[36] === He
    ...
    : ((Ue = () => {
      ...
      (t[37] = Ue));
  let We;
  (t[38] !== fe || t[39] !== P || t[40] !== ke || t[41] !== He
    ? ((We = [fe, P, ke, He]), (t[38] = fe), (t[39] = P), (t[40] = ke), (t[41] = He), (t[42] = We))
    : (We = t[42]),
  ...
  (t[43] === r
    ? ((Ge = t[44]), (Ke = t[45]))
    : ((Ge = () => {
        x.current !== r && ((x.current = r), be({ kind: `center` }));
      }),
      (Ke = [be, r]),
      (t[43] = r),
      (t[44] = Ge),
  ...
  (t[49] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Xe = () => {
        let e = () => {
          document.fullscreenElement !== h.current && O(!1);
        };
        return (
  ...
  t[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((st = () => {
        (O(!1), document.fullscreenElement === h.current && document.exitFullscreen().catch(er));
      }),
      (t[61] = st))
    : (st = t[61]);
  let ct = st,
  ...
  t[62] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((lt = (e, t) => {
        (O(!1),
          (document.fullscreenElement === h.current ? document.exitFullscreen() : Promise.resolve())
            .catch($n)
            .finally(() => {
  ...
  let vt = _t,
    ...
    xt;
  t[72] !== k || t[73] !== p || t[74] !== u || t[75] !== z
    ? ((xt = () => {
        (bt(!1),
          k || Ne(p, { artifactTabId: u, artifactType: `pdf`, importKind: `pdf`, threadId: z }),
          M(Qn));
      }),
      (t[72] = k),
      (t[73] = p),
    ...
    : (xt = t[76]);
  let St;
  t[77] !== gt || t[78] !== vt || t[79] !== k || t[80] !== xt
    ? ((St = (0, $.jsx)(je, { active: k, activeLabel: vt, label: gt, onClick: xt })),
      (t[77] = gt),
      (t[78] = vt),
      (t[79] = k),
      (t[80] = xt),
                          ...
                          rightContent: (0, $.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              n === `default`
                                ? (0, $.jsxs)($.Fragment, {
                                    children: [
                                      (0, $.jsx)(A, { hostId: a, path: s, sizeBytes: c }),
                                      (0, $.jsx)(l, {
                                        hostId: a,
                                        onBeforeOpen: o,
                                        path: s,
