import { R as e, a as t, c as n, t as r, u as i } from "./app-scope.js";
import { Bi as a, Ki as o, Lr as s, Ui as c, Vi as l } from "./src-4.js";
import {
  D as u,
  Fn as d,
  La as f,
...
var C = c((e) => x(e), a().finite()).optional(),
  w = c((e) => S(e), a().int()).optional(),
  T = l({
    title: o().trim().min(1),
    body: o().trim().min(1),
    file: o().trim().min(1),
...
function A(e, t) {
  let n = [];
  for (let r of h(e, { lineStartNames: [d] })) {
...
var F = e(),
  ...
  L = i(r, (e) => {
    let t = new WeakMap(),
      i = I;
    return n(r, ({ get: n }) => {
      let r = N({ cache: t, storedModelComments: I, turns: n(v, e) });
      return (B(i, r) || (i = r), i);
    });
  });
function R(e, n) {
  let r = (0, F.c)(10),
    [i, a] = g(`diff_comments`),
    [o] = g(`diff_comments_from_model`),
    s = t(L, n),
    c = i?.[e] ?? I,
    l = o?.[e] ?? I,
    u;
  r[0] !== l || r[1] !== s
    ? ((u = z({ storedModelComments: l, turnModelComments: s })),
      (r[0] = l),
      (r[1] = s),
      (r[2] = u))
    : (u = r[2]);
  ...
  return (
    r[6] !== c || r[7] !== d || r[8] !== p
      ? ((m = { comments: c, modelComments: d, setComments: p }),
        (r[6] = c),
        (r[7] = d),
        (r[8] = p),
        (r[9] = m))
...
function V(e) {
  let n = (0, F.c)(11),
    ...
    o = i === void 0 ? !0 : i,
    { comments: c, modelComments: l, setComments: d } = R(r, a),
    f = String(r),
    p;
  n[0] === f ? (p = n[1]) : ((p = s(f)), (n[0] = f), (n[1] = p));
  let h = p,
    g = t(_, h) ?? ``,
    v = t(m, h),
    b = t(u, h) ?? void 0,
    x;
  n[2] !== g || n[3] !== v || n[4] !== b
    ? ((x = { cwd: v, headBranch: g, hostId: b, operationSource: `diff_comment_sources` }),
      (n[2] = g),
      (n[3] = v),
      (n[4] = b),
      (n[5] = x))
