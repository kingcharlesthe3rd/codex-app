import { Z as e, a as t, c as n, t as r, u as i } from "./app-scope-CWE-zIhQ.js";
import { Tt as a, jt as o, o as s } from "./use-host-config-C.js";
import { A as c, Lt as l, R as u, V as d, yn as f } from "./thread-context-inputs.js";
import { Aa as p, Da as m, Ta as h, ai as g, wa as _ } from "./src-1.js";
import { t as v } from "./parse-directives.js";
...
var C = m((e) => x(e), _().finite()).optional(),
  w = m((e) => S(e), _().int()).optional(),
  T = h({
    title: p().trim().min(1),
    body: p().trim().min(1),
    file: p().trim().min(1),
...
function k(e, t) {
  ...
  let { title: r, body: i, file: a, priority: s, start: c, end: l } = n.data,
    u = Math.max(1, c ?? 1),
    d = Math.max(1, l ?? u),
    f = d < u ? u : d,
    p = O({ title: D(r, s), body: i });
  return p.length === 0
    ? null
    : {
...
function A(e, t) {
  let n = [];
  for (let r of v(e, { lineStartNames: [f] })) {
...
var F = e(),
  ...
  L = i(r, (e) => {
    let t = new WeakMap();
    return n(r, ({ get: n }) => N({ cache: t, storedModelComments: I, turns: n(l, e) }), {
      isEqual: B,
    });
  });
function R(e, n) {
  let r = (0, F.c)(10),
    [i, a] = s(`diff_comments`),
    [o] = s(`diff_comments_from_model`),
    c = t(L, n),
    l = i?.[e] ?? I,
    u = o?.[e] ?? I,
    d;
  r[0] !== u || r[1] !== c
    ? ((d = z({ storedModelComments: u, turnModelComments: c })),
      (r[0] = u),
      (r[1] = c),
      (r[2] = d))
    : (d = r[2]);
  ...
  return (
    r[6] !== l || r[7] !== f || r[8] !== m
      ? ((h = { comments: l, modelComments: f, setComments: m }),
        (r[6] = l),
        (r[7] = f),
        (r[8] = m),
        (r[9] = h))
...
function B(e, t) {
  return e.length === t.length
    ? e.every((e, n) => {
        let r = t[n];
        return r != null && a(e) === a(r);
      })
    : !1;
}
function V(e) {
  let n = (0, F.c)(11),
    { conversationId: r, enablePullRequestComments: i, localConversationId: a } = e,
    o = i === void 0 ? !0 : i,
    { comments: s, modelComments: l, setComments: f } = R(r, a),
    p = String(r),
    m;
  n[0] === p ? (m = n[1]) : ((m = g(p)), (n[0] = p), (n[1] = m));
  let h = m,
    _ = t(u, h) ?? ``,
    v = t(c, h),
    b = t(d, h) ?? void 0,
  ...
  n[2] !== _ || n[3] !== v || n[4] !== b
    ...
    : (x = n[5]);
  let S = t(y, x),
    C = o && S.type === `success` ? S.data.commentAttachments : void 0,
    w;
  return (
    n[6] !== s || n[7] !== l || n[8] !== f || n[9] !== C
      ? ((w = {
          commentProps: {
            enableComments: !0,
            comments: s,
