import { a as e, c as t, t as n, u as r, z as i } from "./app-scope.js";
import {
  O as a,
  Sr as o,
  T as s,
...
import { Ur as m, fa as h, ha as g, la as _, ua as v } from "./src-2.js";
...
var C = h((e) => x(e), _().finite()).optional(),
  w = h((e) => S(e), _().int()).optional(),
  T = v({
    title: g().trim().min(1),
    body: g().trim().min(1),
    file: g().trim().min(1),
...
function A(e, t) {
  let n = [];
  for (let r of o(e, { lineStartNames: [c] })) {
...
var F = i(),
  ...
  L = r(n, (e) => {
    let r = new WeakMap(),
      i = I;
    return t(n, ({ get: t }) => {
      let n = N({ cache: r, storedModelComments: I, turns: t(p, e) });
      return (B(i, n) || (i = n), i);
    });
  });
function R(t, n) {
  ...
  r[3] !== t || r[4] !== a
    ? ((p = (e) => {
        a((n) => {
          ...
          return a.length === 0 ? (r[t] === void 0 || delete r[t], r) : ((r[t] = a), r);
        });
      }),
      (r[3] = t),
      (r[4] = a),
...
function B(e, t) {
  return e.length === t.length
    ? e.every((e, n) => {
        let r = t[n];
        return r != null && d(e) === d(r);
      })
    : !1;
}
function V(t) {
  let n = (0, F.c)(11),
    { conversationId: r, enablePullRequestComments: i, localConversationId: o } = t,
    c = i === void 0 ? !0 : i,
    { comments: u, modelComments: d, setComments: f } = R(r, o),
    p = String(r),
    h;
  n[0] === p ? (h = n[1]) : ((h = m(p)), (n[0] = p), (n[1] = h));
  let g = h,
    _ = e(s, g) ?? ``,
    v = e(l, g),
    b = e(a, g) ?? void 0,
