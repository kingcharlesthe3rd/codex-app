...
function he(e) {
  let t = !1,
    ...
    l = () => k.isFocused() && (e.networkMode === `always` || de.isOnline()) && e.canRun(),
    u = () => pe(e.networkMode) && e.canRun(),
    f = (e) => {
      a() || (r?.(), i.resolve(e));
    },
    p = (e) => {
    ...
    async fetch(e, t) {
      ...
      (this.options.behavior?.onFetch(a, this),
        ...
        (this.#i = he({
          ...
          fn: a.fetchFn,
          onCancel: (e) => {
            (e instanceof me && e.revert && this.setState({ ...this.#t, fetchStatus: `idle` }),
              n.abort());
          },
          onFail: (e, t) => {
...
var be = class extends s {
  ...
  onSubscribe() {
    this.listeners.size === 1 &&
      ...
      Se(this.#t, this.options) ? this.#h() : this.updateResult(),
      this.#y());
  }
  onUnsubscribe() {
  ...
  setOptions(e) {
    ...
    (r && we(this.#t, n, this.options, t) && this.#h(),
      this.updateResult(),
      r &&
        (this.#t !== n ||
  ...
  getOptimisticResult(e) {
    ...
    return (Ee(this, n) && ((this.#r = n), (this.#a = this.options), (this.#i = this.#t.state)), n);
  }
  getCurrentResult() {
    return this.#r;
  }
    ...
    (this.#x(),
      ...
      !(d || _(this.options.enabled, this.#t) === !1 || !m(this.#p) || this.#p === 0) &&
        (this.#f = l.setInterval(() => {
          (this.options.refetchIntervalInBackground || k.isFocused()) && this.#h();
        }, this.#p)));
  }
  #y() {
...
function Se(e, t) {
  return xe(e, t) || (e.state.data !== void 0 && Ce(e, t, t.refetchOnMount));
}
function Ce(e, t, n) {
  if (_(t.enabled, e) !== !1 && g(t.staleTime, e) !== `static`) {
    let r = typeof n == `function` ? n(e) : n;
    return r === `always` || (r !== !1 && Te(e, t));
  }
  return !1;
}
function we(e, t, n, r) {
  return (
    (e !== t || _(r.enabled, e) === !1) && (!n.suspense || e.state.status !== `error`) && Te(e, n)
  );
}
function Te(e, t) {
...
function Ae(e, t) {
  return t ? Oe(e, t) != null : !1;
}
function je(e, t) {
  return !t || !e.getPreviousPageParam ? !1 : ke(e, t) != null;
}
var Me = class extends ge {
  #e;
  #t;
  #n;
  #r;
...
var Pe = class extends s {
  ...
  resumePausedMutations() {
    ...
    return A.batch(() => Promise.all(e.map((e) => e.continue().catch(f))));
  }
};
function j(e) {
...
var Fe = class extends s {
  ...
  Ie = class {
    ...
    #s;
    constructor(e = {}) {
      ((this.#e = e.queryCache || new Fe()),
        (this.#t = e.mutationCache || new Pe()),
    ...
    ensureQueryData(e) {
      ...
      return r === void 0
        ? this.fetchQuery(e)
        : (e.revalidateIfStale && n.isStaleByTime(g(t.staleTime, n)) && this.prefetchQuery(t),
          Promise.resolve(r));
    }
    getQueriesData(e) {
    ...
    setQueryDefaults(e, t) {
      this.#r.set(x(e), { queryKey: e, defaultOptions: t });
    }
    getQueryDefaults(e) {
      let t = [...this.#r.values()],
        n = {};
    ...
    setMutationDefaults(e, t) {
      this.#i.set(x(e), { mutationKey: e, defaultOptions: t });
    }
    ...
    defaultQueryOptions(e) {
      ...
      return (
        (t.queryHash ||= b(t.queryKey, t)),
        t.refetchOnReconnect === void 0 && (t.refetchOnReconnect = t.networkMode !== `always`),
        t.throwOnError === void 0 && (t.throwOnError = !!t.suspense),
        !t.networkMode && t.persister && (t.networkMode = `offlineFirst`),
        t.queryFn === ae && (t.enabled = !1),
        t
      );
    }
...
function Ue(e) {
  return (
    (e.i ||= P()), (e.r ||= P()), (e.c ||= P()), (e.m ||= P()), (e.u ||= P()), (e.f ||= He()), e
  );
}
var We = (e, t, ...n) => t.read(...n),
  Ge = (e, t, ...n) => t.write(...n),
  Ke = (e, t) => t.INTERNAL_onInit?.call(t, e),
  qe = (e, t, n) => t.onMount?.call(t, n),
  Je = (e, t) => {
    var n;
    let r = F(e),
      i = r[0],
  ...
  Xe = (e) => {
    ...
    for (; d.length; ) {
      ...
      l.add(t);
      for (let e of Ve(t, i, n)) l.has(e) || d.push(e);
    }
  ...
  $e = (e, t, ...n) => {
    let r = F(e),
      ...
      v = (n, ...r) => {
        ...
        try {
          if (n === t) {
            if (!M(n)) throw Error(`atom not writable`);
            let t = u.n,
              s = r[0];
            (m(e, n, s),
              p(e, n),
  ...
  rt = (e, t, n) => {
    let r = F(e),
      ...
      s = `v` in o,
      c = o.v;
    if (ze(n)) for (let r of o.d.keys()) Be(t, n, i(e, r));
    ((o.v = n), delete o.e, (!s || !Object.is(c, o.v)) && (++o.n, ze(c) && a(e, c)));
  },
  it = (e, t) => {
    let n = F(e)[14];
    return N(n(e, t));
...
function dt(...e) {
  ...
  return (lt.set(t, Object.freeze(n)), t);
}
var ft = 0;
function I(e, t) {
  let n = `atom${++ft}`,
  ...
  return (
    typeof e == `function` ? (r.read = e) : ((r.init = e), (r.read = pt), (r.write = mt)),
    t && (r.write = t),
    r
  );
}
    ...
    (n.INTERNAL_onInit = (e) => {
      ...
      function l() {
        ...
        let S = (r, ...a) => {
          ...
          try {
            if ((++i, r === n)) {
              if (!M(r)) throw Error(`atom not writable`);
              let t = o.n,
                n = a[0];
        ...
        S.recurse = (t, ...r) => {
          if (s) {
            if (yt()) throw Error(`set.recurse is not allowed in cleanup`);
            return;
          }
          try {
...
function Ct(e, t = vt()) {
  ...
  if (!r) {
    let i = bt(e),
      a = t.sub(i, () => {});
    ((r = () => {
      a &&= (n.delete(e), n.size === 0 && L.delete(t), void a());
    }),
      n.set(e, r));
  }
  return r;
  ...
  let n = I(0),
    ...
    a = I((t) => {
      let n = t(r),
        ...
        o = t(i).get(n);
      return ((a._optimisticResults = `optimistic`), o?.setOptions(a), Et(a));
    }),
    o = I((e) => {
      let t = e(r),
        n = e(i).get(t);
  ...
  return I(
    (e) => {
      ...
      let t = e(o),
        r = e(a),
        i = e(e(s));
      if (Dt(r, i)) return t.fetchOptimistic(r);
      if (Ot({ result: i, query: t.getCurrentQuery(), throwOnError: r.throwOnError }))
        throw i.error;
      return i;
    },
    (e, t) => {
...
function Ot({ result: e, throwOnError: t, query: n }) {
  return e.isError && !e.isFetching && kt(t, [e.error, n]);
}
function kt(e, t) {
  return typeof e == `function` ? e(...t) : !!e;
}
...
function Mt(e, t) {
  (e.debugEntries.add(t), zt(e.store).add(e));
  let n = z.get(e.store);
  n?.entries != null && (n.entries.add(t), Vt(n));
}
function Nt(e) {
...
function Bt(e, t) {
  ...
  let n = new Set();
  for (let t of zt(e)) for (let e of t.debugEntries) n.add(e);
...
function Ht(e) {
  (Nt(e), It(e));
  for (let t of e.retainedScopeEntries.values()) for (let { node: e } of t.values()) Ht(e);
...
function Ut(e, t, n) {
  return function (r, i) {
    if (i !== void 0 || arguments.length === 2) {
      let a = r,
        o = q(t, e, a.scope);
      return G(a) ? a.read(o, e, i, n) : a.resolve(o, e, i);
    }
    if (W(r)) return n != null && r.store === t.store ? n(r.atom) : r.get();
    let a = q(t, e, r.scope);
    return H(a, r.resolve(a, e), n);
  };
}
function Wt(e, t, n, r) {
  if (W(n)) return r != null && n.store === e.store ? r(n.atom) : n.get();
  let i = q(e, t, n.scope);
...
function qt(e, t) {
  ...
  if (!Array.isArray(e) && !Yt(e)) return e;
  let n = Yt(e) && t?.excludeFieldsFromKey != null ? new Set(t.excludeFieldsFromKey) : void 0;
  return JSON.stringify(Jt(e, n));
}
function Jt(e, t) {
  if (Array.isArray(e)) return e.map((e) => Jt(e));
  if (!Yt(e)) return e;
  let n = {};
  for (let r of Object.keys(e).sort()) t?.has(r) || (n[r] = Jt(e[r]));
  return n;
}
function Yt(e) {
...
function Xt(e, t, n, r) {
  return {
    derived: (i) => {
      let a = I((r) => i((e) => r(e.atom), Object.assign(an(e.token, t, e, r), { key: n })));
      return (V(e, a), B(e, a, `family-derived`, { debugLabel: r, familyKey: n }), Qt(e, a));
    },
    family: Kt(e, t),
    get: Ut(t, e),
    signal: (i, a) => {
      let o = I(typeof i == `function` ? i(Object.assign(an(e.token, t, e), { key: n })) : i),
        s = a?.onMount;
      return (
        s != null &&
          (V(e, o),
...
function K(e, t, n) {
  return G(t) ? t.resolve(e.node, e.chain, n) : t;
}
function en(e, t, n, r, i) {
  return G(t) ? [K(e, t, n), r, i] : [K(e, t), n, r];
}
function tn(e) {
  return W(e) && `set` in e;
}
...
function on(e, t, n) {
  return Object.assign(an(t.token, e, t, n), { get: Ut(e, t, n) });
}
function sn(e, t) {
  (e.parent != null && sn(e.parent, t), t(e.contextVersionAtom));
}
function cn(e, t) {
  let n = new Map(),
    r = t.parent;
...
function X(e, t, n, r) {
  let i = r == null ? rn(n) : void 0,
    a = {
      chain: t,
      get: Ut(t, n, r),
      node: n,
      query: $t({ chain: t, node: n }, r),
      get queryClient() {
        if (n.queryClient == null) throw Error(`Missing query client`);
        return n.queryClient;
      },
  ...
  function s(r) {
    return Ct((i) => r(X(e, t, n, i)), n.store);
  }
  function c(e) {
    return un(s, e);
  }
...
function dn(e, t, n) {
  ...
  return { queryClient: r.queryClient, queryOptions: t.getOptions(on(e.chain, r, n)) };
}
function Z(e, t, n) {
  let r = dn(e, t, n);
  return {
...
function fn(e) {
  let t = e.parent == null ? void 0 : fn(e.parent);
...
function mn(e, t, n) {
  let r = U(
    ...
    e,
    (r, i) => {
      let a = I(typeof t == `function` ? t(an(e, i, r)) : t),
        o = n?.onMount;
      return (
        o != null &&
          (V(r, a),
...
function gn(e, t, n) {
  return bn(Q(e, (n) => yn(e, (e) => t(n, e)), n));
}
function _n(e, t, n) {
  return bn(Q(e, (n) => xn(e, (e) => t(n, e)), n));
}
function vn(e, t, n) {
  return bn(Q(e, (n) => Sn(e, (e) => t(n, e)), n));
}
function yn(e, t) {
  let n = U(
    `cached`,
...
function bn(e, t = `readable-family`) {
  return Object.assign(e, {
    kind: t,
    read(t, n, r, i) {
      return Wt(t, n, e.resolve(t, n, r), i);
    },
  });
}
function xn(e, t) {
...
function Sn(e, t) {
  let n = U(
    ...
    (e, n) => {
      ...
      let r = I({ data: void 0, error: null, status: `idle`, variables: void 0 }),
        i = 0;
      return I((a) => {
        let o = a(r),
          s = async (a, o) => {
...
function Cn(e, t) {
  return Ct((n) => t(X(e.scope, e.chain, e.node, n)), e.node.store);
}
function wn(e, t) {
  return un((t) => Cn(e, t), t);
}
function Tn(e, t, n, r) {
  if (nn(t)) {
...
var En = o(),
  Dn = e(i(), 1),
  On = r(),
  $ = (0, R.createContext)(new Map()),
  kn = (0, R.createContext)(void 0),
  An = {},
  jn = 0;
function Mn(e) {
  let t = (0, En.c)(3),
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, On.jsx)(kn.Provider, { value: r, children: n })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function Nn({ children: e, scope: t, value: n }) {
  let r = (0, R.useContext)($),
    i = (0, R.useContext)(kn),
  ...
  let u =
      t.retain == null || a == null
        ? void 0
        : In({ parentScope: a, providedValue: o, queryClient: i, scope: t, scopeKey: s }),
    d = u != null && !(0, Dn.default)(u.node.value, o),
    f = a?.queryClient ?? i,
    p =
  ...
  if (
    ...
    let e = p ?? Pn({ parentScope: a, providedValue: o, queryClient: i, scope: t, scopeKey: s }),
      n = cn(r, t);
    (n.set(t.id, e), (c.current = { chain: n, node: e, parent: a, retainedEntry: u }));
  } else c.current.retainedEntry = u;
  (u == null ? Fn({ node: c.current.node, parentScope: a, providedValue: o, queryClient: i }) : d)
    ...
    (0, R.useLayoutEffect)(() => {
      if (!(m == null || a == null))
        return (
          ...
          Ln(a, t),
          () => {
            (--m.mountedCount, (m.lastUsed = zn()), Ln(a, t));
          }
        );
    }, [m, a, t]),
    (0, On.jsx)($.Provider, { value: c.current.chain, children: e })
  );
}
function Pn({ parentScope: e, providedValue: t, queryClient: n, scope: r, scopeKey: i }) {
  return {
    cachedBindings: new Map(),
    contextVersionAtom: I(0),
...
function Fn({ node: e, parentScope: t, providedValue: n, queryClient: r }) {
  let i = !(0, Dn.default)(e.value, n);
  return ((e.queryClient = t?.queryClient ?? r), (e.value = n), i);
}
function In({ parentScope: e, providedValue: t, queryClient: n, scope: r, scopeKey: i }) {
  return (
    e.retainedScopeEntries.get(r)?.get(i) ?? {
      lastUsed: 0,
      mountedCount: 0,
      node: Pn({ parentScope: e, providedValue: t, queryClient: n, scope: r, scopeKey: i }),
    }
  );
}
function Ln(e, t) {
  ...
  if (r != null)
    for (; r.size > n; ) {
      let e = Rn(r);
      if (e == null) return;
      (r.delete(e.key), Ht(e.entry.node));
    }
}
function Rn(e) {
  let t = null;
  ...
  if (i.current == null || i.current.node !== n) {
    ...
    function o(e, t) {
      if (t !== void 0 || arguments.length === 2) {
        let n = e,
          r = J(a.chain, n.scope);
        return G(n) ? n.read(r, a.chain, t) : n.resolve(r, a.chain, t);
      }
      if (W(e)) return e.get();
      let n = e,
        r = J(a.chain, n.scope);
    ...
    ((a.get = o), (a.query = $t(a)), (a.set = l), (a.watch = s), (a.when = c), (i.current = a));
