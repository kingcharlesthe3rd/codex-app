...
import { fm as c } from "./app-initial~app-main~onboarding-page.js";
import { Dv as l } from "./app-initial~app-main~worktree-init-v2-page~remote-conversation-page~new-thread-panel-page~o~bj5tp28r.js";
import {
  f as u,
  p as d,
...
function v(e) {
  let t = (0, b.c)(13),
    ...
    a = r === void 0 ? !1 : r,
    o;
  t[0] === n ? (o = t[1]) : ((o = u(`order-2 flex min-w-0 flex-col`, n)), (t[0] = n), (t[1] = o));
  let s;
  t[2] !== i || t[3] !== o
  ...
  let d;
  t[7] !== a || t[8] !== c
    ? ((d = a ? (0, S.jsx)(p, { expandedTopTray: !0, inFlow: !0, children: c }) : c),
      (t[7] = a),
      (t[8] = c),
      (t[9] = d))
    : (d = t[9]);
...
function T(e) {
  ...
  t[9] === r
    ? (d = t[10])
    : ((d = u(`group flex min-w-0 items-center justify-between gap-2 py-0.5 text-sm`, r)),
      (t[9] = r),
      (t[10] = d));
  let f;
  t[11] === i
    ...
    : ((f =
      ...
      (t[12] = f));
  let p;
  t[13] === c ? (p = t[14]) : ((p = u(`min-w-0 flex-1 leading-4`, c)), (t[13] = c), (t[14] = p));
  let m;
  t[15] === a
    ? (m = t[16])
    : ((m =
  ...
  t[24] !== n || t[25] !== l
    ? ((_ =
        l != null || n != null
          ? (0, D.jsxs)(`div`, { className: `flex shrink-0 items-center gap-1`, children: [l, n] })
          : null),
      (t[24] = n),
      (t[25] = l),
      (t[26] = _))
