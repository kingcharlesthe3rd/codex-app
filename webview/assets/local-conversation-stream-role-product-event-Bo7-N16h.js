...
function N(e) {
  ...
  return (
    ...
    t[14] !== d ||
    t[15] !== r
      ? ((_ = [h, n, c.isEligible, c.reason, m, s, d, r]),
        (t[8] = h),
        (t[9] = n),
        (t[10] = c.isEligible),
        (t[11] = c.reason),
    ...
    t[0] !== r || t[1] !== i
      ? ((a = () => {
          ...
          return i.watch((t) => {
            let { get: n } = t,
              a = n(h, r);
            a == null || e || ((e = !0), g(i, _, { streamRole: a.role }));
          });
        }),
        (o = [r, i]),
        (t[0] = r),
...
var R,
  z,
  B = e(() => {
    ((R = d()), x(), m(), (z = t(C(), 1)), S(), v(), r());
  });
export { I as i, B as n, N as r, L as t };
//# sourceMappingURL=local-conversation-stream-role-product-event-Bo7-N16h.js.map
