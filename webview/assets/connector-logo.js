...
import { n as a, t as o } from "./known-app-icon.js";
import { u as s, x as c } from "./apps-queries.js";
...
function p(e) {
  ...
  if (
    ...
    bb0: {
      ...
      let e;
      t[12] !== r || t[13] !== o
        ? ((e = m({ appInfo: r, knownAppId: o })), (t[12] = r), (t[13] = o), (t[14] = e))
        : (e = t[14]);
      let n = e;
      if (n != null) {
        let e;
      ...
      if (
        ((S = h({ logoUrl: s ?? r?.logoUrl, logoDarkUrl: p ?? r?.logoUrlDark, isDarkTheme: y })),
...
function _(e) {
  ...
  return (
    t[0] !== r || t[1] !== n || t[2] !== o || t[3] !== a
      ? ((c = (0, f.jsx)(v, { className: n, alt: r, fallback: a, src: o }, o)),
        (t[0] = r),
        (t[1] = n),
        (t[2] = o),
        (t[3] = a),
