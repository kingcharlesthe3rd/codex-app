...
import { l as a, p as o } from "./apps-queries.js";
...
function _(e) {
  let t = (0, u.c)(5),
    { className: n, alt: r, connectorLogoRequest: i, fallback: o } = e,
    s = a(i);
  if (s == null) return o;
  let c;
  return (
    t[0] !== r || t[1] !== n || t[2] !== s || t[3] !== o
      ? ((c = (0, f.jsx)(v, { className: n, alt: r, fallback: o, src: s }, s)),
        (t[0] = r),
        (t[1] = n),
        (t[2] = s),
        (t[3] = o),
