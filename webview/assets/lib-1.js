...
import { a as r, o as i, r as a, t as o } from "./tslib.es6.js";
function s(e, t) {
...
function Xe(e) {
  return e.length < 2
    ...
    : e.reduce(function (e, t) {
        var n = e[e.length - 1];
        return (
          !n || n.type !== P.literal || t.type !== P.literal ? e.push(t) : (n.value += t.value), e
        );
      }, []);
}
function Ze(e) {
...
var rn = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        return (
          Rt(this.state.intl), q.createElement(Gt, { value: this.state.intl }, this.props.children)
        );
      }),
...
var gn = Z(`formatDate`);
Z(`formatTime`);
var _n = Z(`formatNumber`);
(Z(`formatList`), Z(`formatDisplayName`), Xt(`formatDate`), Xt(`formatTime`));
export { pn as a, Q as c, mn as i, X as l, _n as n, rn as o, hn as r, tn as s, gn as t };
