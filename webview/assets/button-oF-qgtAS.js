...
function l(e) {
  ...
  let y = f === void 0 ? !1 : f,
    b = p === void 0 ? !1 : p,
    x = m === void 0 ? `primary` : m,
    S = h === void 0 ? `default` : h,
    C = g === void 0 ? !1 : g,
    w = _ === void 0 ? !1 : _,
    T = v ?? `button`,
    E = i[S],
    ...
    k = b && `min-w-0`,
    A;
  t[11] !== u || t[12] !== O || t[13] !== k || t[14] !== E || t[15] !== D || t[16] !== y
    ? ((A = n(
  ...
  t[18] === w
    ? (M = t[19])
    : ((M = w && (0, o.jsx)(r, { className: `icon-xxs` })), (t[18] = w), (t[19] = M));
  let N;
  return (
    t[20] !== l || t[21] !== d || t[22] !== A || t[23] !== j || t[24] !== M || t[25] !== T
      ? ((N = (0, o.jsxs)(`button`, {
          type: T,
          className: A,
          disabled: j,
...
//# sourceMappingURL=button-oF-qgtAS.js.map
