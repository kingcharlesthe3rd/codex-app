...
import { C as t, U as n, at as r } from "./src-C.js";
import { Un as i, do as a, po as o, tc as s } from "./app-server-manager-signals.js";
...
import { f as v, m as y } from "./chunk-8.js";
...
import { n as b } from "./rpc.js";
import { d as x, o as S } from "./statsig.js";
import "./request.js";
...
import { s as C } from "./prompt-text.js";
import "./use-environment.js";
import { C as w, a as T, p as re, t as ie } from "./composer-view-state.js";
...
import "./spinner.js";
import { t as D } from "./use-codex-home.js";
import "./os-info.js";
...
import { r as ae } from "./remote-projects.js";
...
import { c as oe, l as k, n as se, t as A } from "./composer.js";
...
import { t as ce } from "./local-active-workspace-root-dropdown.js";
import { r as M, t as le } from "./dropdown.js";
import "./globe.js";
import "./set-pinned-thread.js";
import "./thread-actions.js";
import { i as N, n as ue, t as de } from "./popover.js";
import "./face.js";
...
import { t as pe } from "./get-project-name.js";
import "./stop.js";
...
import { c as he } from "./local-remote-selection.js";
...
import { a as ge } from "./slash-command-item.js";
...
import { t as _e } from "./more-menu-trigger.js";
...
import { t as ye } from "./use-floating-window-pointer-interactivity.js";
import { n as be, t as xe } from "./composer-footer-branch-switcher.js";
import "./git-branch-switcher.js";
import "./use-git-recent-branches.js";
import { t as Se } from "./use-hotkey-window-dismiss-on-escape.js";
var L = e(c(), 1),
  R = g(),
  z = l();
function Ce(e) {
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, z.jsx)(P, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[10] = g))
    : (g = t[10]);
  let _;
  t[11] !== m || t[12] !== h
    ? ((_ = (0, z.jsxs)(z.Fragment, { children: [m, h, g] })),
      (t[11] = m),
      (t[12] = h),
      (t[13] = _))
    : (_ = t[13]);
  ...
  if (a) {
    ...
    return (
      t[18] !== a || t[19] !== e
        ? ((n = (0, z.jsx)(ne, { tooltipContent: a, children: e })),
          (t[18] = a),
          (t[19] = e),
          (t[20] = n))
        : (n = t[20]),
  ...
  t[22] === b
    ? (S = t[23])
    : ((S = (0, z.jsx)(ne, { tooltipContent: x, children: b })), (t[22] = b), (t[23] = S));
  let te = n === `local` ? j : void 0,
    C;
  t[24] === p
    ? (C = t[25])
    : ((C = () => {
  ...
  let T;
  t[27] !== te || t[28] !== C
    ? ((T = (0, z.jsx)(M.Item, { LeftIcon: I, RightIcon: te, onSelect: C, children: w })),
      (t[27] = te),
      (t[28] = C),
      (t[29] = T))
    : (T = t[29]);
  let re = n === `cloud` ? j : void 0,
    D;
  t[30] === p
    ? (D = t[31])
    : ((D = () => {
  ...
  let O;
  t[33] !== re || t[34] !== D
    ? ((O = (0, z.jsx)(M.Item, { LeftIcon: F, RightIcon: re, onSelect: D, children: ae })),
      (t[33] = re),
      (t[34] = D),
      (t[35] = O))
    : (O = t[35]);
  let oe = n === `worktree` ? j : void 0,
    k;
  t[36] === p
    ? (k = t[37])
    : ((k = () => {
...
function we({ activeWorkspaceRoot: e, defaultToProjectless: t, prefillCwd: n }) {
  return n ?? (t ? `~` : e);
}
function Te(e) {
  let t = (0, R.c)(25),
...
var Oe = {
  ...
  ke = [`[data-composer-overlay-floating-ui]`, `[data-above-composer-portal] > *`];
function Ae() {
  let e = (0, R.c)(104),
    r = f(C);
  Se();
  let s = ee(),
    ...
    ne = S(`505458`),
    ie = x(),
    { selectedRemoteProject: E } = ae(),
    O = (0, L.useRef)(null),
    j = (0, L.useRef)(null),
    M = (0, L.useRef)(null),
    le = (0, L.useRef)(null),
    P = c.state,
    F = P?.focusComposerNonce ?? null,
    I = P?.prefillCwd ?? null,
    { data: fe, isLoading: he } = p(te),
    ye = m(t.hotkeyWindowProjectlessDefaultEnabled),
    Ee = fe?.roots[0] ?? null,
    Ae = ye === !0,
    Re;
  e[0] !== Ee || e[1] !== I || e[2] !== Ae
    ? ((Re = we({ activeWorkspaceRoot: Ee, defaultToProjectless: Ae, prefillCwd: I })),
      (e[0] = Ee),
      (e[1] = I),
      (e[2] = Ae),
      (e[3] = Re))
  ...
  let ze = Re,
    B = E == null && ze === `~`,
    V = E == null && !B ? ze : null,
    { data: Be, isLoading: Ve } = i(V, g, `hotkey_window_home_page`),
    H = Be?.root ?? null,
    He;
  e[4] !== _ || e[5] !== V || e[6] !== H || e[7] !== ne
    ? ((He = V != null && H != null && ne && !n(V, _)),
      (e[4] = _),
      (e[5] = V),
      (e[6] = H),
      (e[7] = ne),
    ...
    : (He = e[8]);
  let U = He,
    Ue = E == null && !he && !Ve && H == null,
    We = B || Ue,
    Ge = {
      fallbackMode: `local`,
      isAvailabilityLoading: !We && (he || Ve || ie),
      isCloudAvailable: !We,
      isLocalAvailable: !0,
    ...
    qe = p(T),
    Je = se(),
    W = oe({ ...Ge, composerMode: Ke }),
    Ye = W === `worktree` && V != null,
    Xe;
  e[9] === Ye
    ? (Xe = e[10])
    : ((Xe = { enabled: Ye, source: `hotkey_window_worktree_source` }), (e[9] = Ye), (e[10] = Xe));
  let { gitRoot: Ze } = ge(V, Xe),
    Qe = W === `worktree` ? V : null,
    $e;
  e[11] === Qe
    ? ($e = e[12])
    : (($e = { hostId: o, workspaceRoot: Qe }), (e[11] = Qe), (e[12] = $e));
  let {
      environments: et,
      isLoading: tt,
      error: nt,
    ...
    [at, ot] = (0, L.useState)(!1),
    [st, ct] = (0, L.useState)(null),
    lt;
  e[13] === F
    ? (lt = e[14])
    : ((lt = { activationNonce: F, interactiveRegionRef: j, onInteractiveChange: Pe }),
      (e[13] = F),
      (e[14] = lt));
  let ut = De(lt),
    dt;
  (e[15] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((dt = (e) => {
      ...
      (e[15] = dt))
    : (dt = e[15]),
    h(`hotkey-window-home-composer-position-changed`, dt));
  let ft;
  e[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ft = (e) => {
        ...
        (c?.minimumComposerTopInsetPx === s.minimumComposerTopInsetPx &&
          ...
          ((le.current = s), b.hotkeyWindowHotkeys?.homeLayoutChanged(s));
      }),
      (e[16] = ft))
    : (ft = e[16]);
  let pt = ft,
    mt;
  (e[17] === F ? (mt = e[18]) : ((mt = [F]), (e[17] = F), (e[18] = mt)), (0, L.useEffect)(Ne, mt));
  let ht, gt;
  (e[19] === Je
    ? ((ht = e[20]), (gt = e[21]))
    : ((ht = () => {
        ...
        return (
          j.current != null && n?.observe(j.current),
          t(),
          () => {
  ...
  let yt = vt,
    bt = Me,
    xt;
  e[26] !== c.hash || e[27] !== c.pathname || e[28] !== c.search || e[29] !== P || e[30] !== l
    ? ((xt = (e) => {
        let t = e ?? `~`,
          n = { ...P, prefillCwd: t };
        l({ pathname: c.pathname, search: c.search, hash: c.hash }, { replace: !0, state: n });
      }),
      (e[26] = c.hash),
      (e[27] = c.pathname),
      (e[28] = c.search),
  ...
  e[34] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Dt = (e) => {
        M.current === e.pointerId && b.hotkeyWindowHotkeys?.homeDragMove();
      }),
      (e[34] = Dt))
    : (Dt = e[34]);
  let Ot = Dt,
  ...
  e[60] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Pt = u(Oe.home, `relative h-full w-full overflow-hidden bg-transparent pb-1`)),
      (e[60] = Pt))
    : (Pt = e[60]);
  let Ft = ut && `no-drag`,
    It;
  e[61] === Ft
    ? (It = e[62])
    : ((It = u(Oe.homeShell, `absolute inset-x-1 bottom-1 px-[15px] pb-[13px] pt-[17px]`, Ft)),
      (e[61] = Ft),
      (e[62] = It));
  let Lt;
  e[63] === st
    ? (Lt = e[64])
    : ((Lt = st == null ? void 0 : { bottom: `auto`, top: st }), (e[63] = st), (e[64] = Lt));
  let Rt;
  e[65] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Rt = (0, z.jsx)(`div`, {
        className: Oe.shellUnderlay,
        "aria-hidden": `true`,
  ...
  let zt = !B,
    Bt;
  e[66] !== W || e[67] !== G || e[68] !== U || e[69] !== zt
    ? ((Bt = (0, z.jsx)(Te, { composerMode: W, enabled: zt, setComposerMode: G, showWorktree: U })),
      (e[66] = W),
      (e[67] = G),
      (e[68] = U),
      (e[69] = zt),
  ...
  e[71] === Nt
    ...
    : ((q = (0, z.jsx)(N, {
        asChild: !0,
        children: (0, z.jsx)(_e, { label: Nt, size: `composer` }),
      })),
      (e[71] = Nt),
      (e[72] = q));
  let Vt;
  ...
  e[78] !== W || e[79] !== G || e[80] !== U || e[81] !== kt
    ...
    : (Y = e[82]);
  let X;
  e[83] !== W || e[84] !== nt || e[85] !== tt || e[86] !== rt || e[87] !== it || e[88] !== et
    ? ((X =
        W === `worktree`
          ? (0, z.jsx)(Ie, {
              label: (0, z.jsx)(d, {
  ...
  e[92] === W
    ...
    : ((Q =
        W === `cloud`
          ? null
          : (0, z.jsx)(k, { conversationId: null, hostId: o, DropdownContainer: Fe })),
      (e[92] = W),
      (e[93] = Q));
  let $;
  e[94] !== J || e[95] !== Y || e[96] !== X || e[97] !== Z || e[98] !== Q
    ? (($ = (0, z.jsx)(ue, {
        align: `center`,
        side: `top`,
        sideOffset: 10,
  ...
  let Wt;
  return (
    e[100] !== at || e[101] !== q || e[102] !== $
      ? ((Wt = (0, z.jsxs)(de, { open: at, onOpenChange: ot, children: [q, $] })),
        (e[100] = at),
        (e[101] = q),
        (e[102] = $),
        (e[103] = Wt))
        ...
        children: [
          ...
          (0, z.jsx)(`div`, {
            ...
            children: (0, z.jsx)(A, {
              ...
              surfaceClassName: Oe.composerSurface,
...
function je() {
  _.dispatchMessage(`show-settings`, { section: `local-environments` });
}
function Me(e) {
  b.hotkeyWindowHotkeys?.open({ path: r(e) });
}
function Ne() {
  O();
}
...
function Fe(e) {
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, z.jsx)(Ie, { label: r, control: n })), (t[1] = n), (t[2] = i)),
    i
  );
}
function Ie(e) {
  ...
  t[2] === r
    ? (a = t[3])
    : ((a = (0, z.jsx)(`div`, { className: `min-w-0`, children: r })), (t[2] = r), (t[3] = a));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, z.jsxs)(`div`, {
...
export { Ae as HotkeyWindowHomePage };
