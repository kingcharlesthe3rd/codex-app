...
import { St as Me, xt as Ne } from "./app-initial~app-main~automations-page.js";
import {
  dn as Pe,
  on as Fe,
...
import { n as at, t as ot } from "./worktree-environment-dropdown.js";
...
function ht(e) {
  ...
  let x;
  t[22] !== v || t[23] !== y
    ? ((x = (0, z.jsx)(me.Item, { LeftIcon: g, RightIcon: v, onSelect: y, children: b })),
      (t[22] = v),
      (t[23] = y),
      (t[24] = x))
    : (x = t[24]);
...
function W() {
  ...
  let a = we(),
    ...
    j = ye(A),
    ce = k(A),
    M = vt({ composerWorkspaceRoot: T, selectedRemoteProjectPath: D?.remotePath ?? null }),
    le = D == null && T == null && w,
  ...
  let P = ge,
    ...
    Me;
  e[5] !== A || e[6] !== je
    ? ((Me = { enabled: je, hostId: A, source: `hotkey_window_worktree_source` }),
      (e[5] = A),
      (e[6] = je),
      (e[7] = Me))
    : (Me = e[7]);
  let { gitRoot: Pe } = nt(M, Me),
    ...
    Re;
  e[8] !== A || e[9] !== Ie
    ? ((Re = { hostId: A, workspaceRoot: Ie }), (e[8] = A), (e[9] = Ie), (e[10] = Re))
    : (Re = e[10]);
  let {
      environments: ze,
      isLoading: Be,
  ...
  e[11] === y
    ? (et = e[12])
    : ((et = { activationNonce: y, interactiveRegionRef: g, onInteractiveChange: Mt }),
      (e[11] = y),
      (e[12] = et));
  let it = Ct(et),
    at;
  ...
  let ct = st,
    lt;
  (e[15] === y ? (lt = e[16]) : ((lt = [y]), (e[15] = y), (e[16] = lt)), (0, G.useEffect)(jt, lt));
  let ut, mt;
  (e[17] === De
    ? ((ut = e[18]), (mt = e[19]))
    : ((mt = () => {
  ...
  let yt = gt,
    xt = At,
    St;
  e[25] !== o.hash || e[26] !== o.pathname || e[27] !== o.search || e[28] !== v || e[29] !== s
    ? ((St = (e) => {
        let t = e ?? `~`,
          n = { ...v, prefillCwd: t };
        s({ pathname: o.pathname, search: o.search, hash: o.hash }, { replace: !0, state: n });
      }),
      (e[25] = o.hash),
      (e[26] = o.pathname),
      (e[27] = o.search),
  ...
  e[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ht = pe(Ot.home, `relative h-full w-full overflow-hidden bg-transparent pb-1`)),
      (Ut = (0, K.jsx)(qe, {})),
      (e[61] = Ht),
      (e[62] = Ut))
    : ((Ht = e[61]), (Ut = e[62]));
  ...
  e[63] === Wt
    ? (Gt = e[64])
    : ((Gt = pe(Ot.homeShell, `absolute inset-x-1 bottom-1 px-[15px] pb-[13px] pt-[17px]`, Wt)),
      (e[63] = Wt),
      (e[64] = Gt));
  let Kt;
  e[65] === Ze
    ? (Kt = e[66])
    : ((Kt = Ze == null ? void 0 : { bottom: `auto`, top: Ze }), (e[65] = Ze), (e[66] = Kt));
  let qt;
  ...
  e[68] !== I || e[69] !== z || e[70] !== P || e[71] !== Jt
    ? ((Yt = (0, K.jsx)(bt, { composerMode: I, enabled: Jt, setComposerMode: z, showWorktree: P })),
      (e[68] = I),
      (e[69] = z),
      (e[70] = P),
      (e[71] = Jt),
  ...
  e[80] !== I || e[81] !== z || e[82] !== P || e[83] !== W || e[84] !== $t
    ...
    : (Y = e[85]);
  let X;
  e[86] !== I || e[87] !== Ve || e[88] !== Be || e[89] !== He || e[90] !== Ue || e[91] !== ze
    ? ((X =
        I === `worktree`
          ? (0, K.jsx)(Pt, {
              label: (0, K.jsx)(L, {
  ...
  e[95] === I
    ...
    : ((Q =
        I === `cloud`
          ? null
          : (0, K.jsx)(We, { conversationId: null, hostId: Ee, DropdownContainer: Nt })),
      (e[95] = I),
      (e[96] = Q));
  let $;
  ...
  return (
    e[103] !== Ge || e[104] !== q || e[105] !== $
      ? ((en = (0, K.jsxs)(ue, { open: Ge, onOpenChange: Xe, children: [q, $] })),
        (e[103] = Ge),
        (e[104] = q),
        (e[105] = $),
        (e[106] = en))
