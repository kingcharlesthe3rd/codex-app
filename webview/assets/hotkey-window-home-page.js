...
import { n as it, t as at } from "./worktree-environment-dropdown.js";
import { n as ot, t as st } from "./use-floating-window-pointer-interactivity.js";
import { i as ct, n as lt, r as ut, t as dt } from "./composer-footer-branch-switcher.js";
import { n as ft, t as pt } from "./use-hotkey-window-dismiss-on-escape.js";
function mt(e) {
  let t = (0, z.c)(52),
    {
      canUseCloud: n,
  ...
  t[0] !== r || t[1] !== s
    ? ((u =
        r === `cloud`
          ? (0, B.jsx)(ee, { className: `icon-2xs` })
          : r === `worktree` && s
            ? (0, B.jsx)(R, { className: `icon-2xs` })
            : (0, B.jsx)($e, { className: `icon-2xs` })),
      (t[0] = r),
      (t[1] = s),
      (t[2] = u))
    : (u = t[2]);
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, B.jsx)(he, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[7] = f))
    : (f = t[7]);
  let p;
  t[8] !== u || t[9] !== d
    ? ((p = (0, B.jsxs)(B.Fragment, { children: [u, d, f] })), (t[8] = u), (t[9] = d), (t[10] = p))
    : (p = t[10]);
  let m = p;
  if (o) {
    let e;
    ...
    return (
      t[13] !== o || t[14] !== e
        ? ((n = (0, B.jsx)(re, { tooltipContent: o, children: e })),
          (t[13] = o),
          (t[14] = e),
          (t[15] = n))
        : (n = t[15]),
  ...
  let b;
  t[22] !== _ || t[23] !== v
    ? ((b = (0, B.jsx)(Se.Item, { LeftIcon: $e, RightIcon: _, onSelect: v, children: y })),
      (t[22] = _),
      (t[23] = v),
      (t[24] = b))
    : (b = t[24]);
  let te = r === `cloud` ? A : void 0,
    x = !n,
    S;
  t[25] === i
    ? (S = t[26])
...
var z,
  B,
  ht = e(() => {
    ((z = i()), M(), se(), P(), E(), j(), fe(), g(), Qe(), Ze(), (B = r()));
  });
function gt({ activeWorkspaceRoot: e, defaultToProjectless: t, prefillCwd: n }) {
  return n ?? (t ? `~` : e);
}
function _t({ composerWorkspaceRoot: e, selectedRemoteProjectPath: t }) {
  return t ?? (e === `~` ? null : e);
}
var vt = e(() => {
  m();
...
var Ct,
  ...
  W = e(() => {
    ((H = `_home_reiaa_1`),
      (Tt = `_homeShell_reiaa_20`),
      (U = `_shellUnderlay_reiaa_21`),
      (Et = `_composerSurface_reiaa_22`),
      (Dt = { home: H, homeShell: Tt, shellUnderlay: U, composerSurface: Et }));
  });
function G() {
  let e = (0, Ft.c)(107),
    t = l(_e);
  ...
  let n = ce(),
    ...
    o = S(),
    { access: c } = qe(),
    { selectedRemoteProject: u } = ge(),
    m = (0, K.useRef)(null),
    g = (0, K.useRef)(null),
    v = (0, K.useRef)(null),
    ee = (0, K.useRef)(null),
    b = r.state,
    x = b?.focusComposerNonce ?? null,
    w = b?.prefillCwd ?? null,
    { data: re, isLoading: ie } = f(C),
    ae = oe(d.hotkeyWindowProjectlessDefaultEnabled),
    E = gt({
      activeWorkspaceRoot: re?.roots[0] ?? null,
      defaultToProjectless: ae === !0,
      prefillCwd: w,
    }),
    D = w == null ? u : null,
    O = D == null && E === `~`,
    ...
    j = le(A),
    se = ye(A),
    M = _t({ composerWorkspaceRoot: E, selectedRemoteProjectPath: D?.remotePath ?? null }),
    ue = D == null && E == null && ie,
    fe = be({ cwd: M, hostId: A, isLoading: ue }),
    { data: me, isLoading: he } = T(M, j, `hotkey_window_home_page`),
    P = me?.root ?? null,
    ve;
  e[0] !== se || e[1] !== M || e[2] !== P || e[3] !== a
    ? ((ve = M != null && P != null && a && !h(M, se)),
      (e[0] = se),
      (e[1] = M),
      (e[2] = P),
      (e[3] = a),
    ...
    : (ve = e[4]);
  let F = ve,
    Se = D == null && !ie && !he && P == null,
    Ce = O || Se,
    Ee = {
      fallbackMode: `local`,
      isAvailabilityLoading: !Ce && ((D == null && ie) || he || o),
      isCloudAvailable: !Ce,
      isLocalAvailable: !0,
      isWorktreeAvailable: F,
    },
    De = p(xe, fe),
    ke = f(Oe),
    Ae = Le(),
    I = Ke({ ...Ee, composerMode: De, cloudAccess: c }),
    Pe = I === `worktree` && M != null,
    L;
  e[5] !== A || e[6] !== Pe
    ? ((L = { enabled: Pe, hostId: A, source: `hotkey_window_worktree_source` }),
      (e[5] = A),
      (e[6] = Pe),
      (e[7] = L))
    : (L = e[7]);
  let { gitRoot: Ie } = nt(M, L),
    Re = I === `worktree` ? M : null,
    ze;
  e[8] !== A || e[9] !== Re
    ? ((ze = { hostId: A, workspaceRoot: Re }), (e[8] = A), (e[9] = Re), (e[10] = ze))
    : (ze = e[10]);
  let {
      environments: Be,
      isLoading: Ue,
      error: We,
      resolvedConfigPath: Je,
      updateSelection: Ye,
    } = et(ze),
    [Ze, Qe] = (0, K.useState)(!1),
    [R, $e] = (0, K.useState)(null),
    tt;
  e[11] === x
    ? (tt = e[12])
    : ((tt = { activationNonce: x, interactiveRegionRef: g, onInteractiveChange: jt }),
      (e[11] = x),
      (e[12] = tt));
  let rt = St(tt),
    it;
  (e[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((it = (e) => {
      ...
      (e[13] = it))
    : (it = e[13]),
    s(`hotkey-window-home-composer-position-changed`, it));
  let ot;
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ot = (e) => {
        let t = m.current,
          n = g.current;
        if (!t || !n) return;
        let r = Pt(window.getComputedStyle(t).paddingBottom),
        ...
        (c?.minimumComposerTopInsetPx === s.minimumComposerTopInsetPx &&
          ...
          ((ee.current = s), y.hotkeyWindowHotkeys?.homeLayoutChanged(s));
      }),
      (e[14] = ot))
    : (ot = e[14]);
  let st = ot,
    ct;
  (e[15] === x ? (ct = e[16]) : ((ct = [x]), (e[15] = x), (e[16] = ct)), (0, K.useEffect)(At, ct));
  let lt, pt;
  (e[17] === Ae
    ? ((lt = e[18]), (pt = e[19]))
    : ((pt = () => {
  ...
  let vt = ht,
    bt = kt,
    xt;
  e[25] !== r.hash || e[26] !== r.pathname || e[27] !== r.search || e[28] !== b || e[29] !== i
    ? ((xt = (e) => {
        let t = e ?? `~`,
          n = { ...b, prefillCwd: t };
        i({ pathname: r.pathname, search: r.search, hash: r.hash }, { replace: !0, state: n });
      }),
      (e[25] = r.hash),
      (e[26] = r.pathname),
      (e[27] = r.search),
  ...
  e[31] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((V = (e) => {
        v.current === e.pointerId &&
          ...
          y.hotkeyWindowHotkeys?.homeDragEnd());
      }),
      (e[31] = V))
    : (V = e[31]);
  let wt = V,
  ...
  e[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((H = (e) => {
        e.button === 0 &&
          ...
          y.hotkeyWindowHotkeys?.homeDragStart({
  ...
  e[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((U = (e) => {
        v.current === e.pointerId && y.hotkeyWindowHotkeys?.homeDragMove();
      }),
      (e[33] = U))
    : (U = e[33]);
  let Et = U,
  ...
  e[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Vt = pe(Dt.home, `relative h-full w-full overflow-hidden bg-transparent pb-1`)),
      (Ht = (0, q.jsx)(Ge, {})),
      (e[61] = Vt),
      (e[62] = Ht))
    : ((Vt = e[61]), (Ht = e[62]));
  ...
  e[63] === Ut
    ? (Wt = e[64])
    : ((Wt = pe(Dt.homeShell, `absolute inset-x-1 bottom-1 px-[15px] pb-[13px] pt-[17px]`, Ut)),
      (e[63] = Ut),
      (e[64] = Wt));
  let Gt;
  e[65] === R
    ? (Gt = e[66])
    : ((Gt = R == null ? void 0 : { bottom: `auto`, top: R }), (e[65] = R), (e[66] = Gt));
  let Kt;
  e[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Kt = (0, q.jsx)(`div`, {
        className: Dt.shellUnderlay,
        "aria-hidden": `true`,
  ...
  let qt = !O && !ue,
    Jt;
  e[68] !== I || e[69] !== B || e[70] !== F || e[71] !== qt
    ? ((Jt = (0, q.jsx)(yt, { composerMode: I, enabled: qt, setComposerMode: B, showWorktree: F })),
      (e[68] = I),
      (e[69] = B),
      (e[70] = F),
      (e[71] = qt),
  ...
  e[73] === Bt
    ...
    : ((J = (0, q.jsx)(Te, {
        asChild: !0,
        children: (0, q.jsx)(_, { label: Bt, size: `composer` }),
      })),
      (e[73] = Bt),
      (e[74] = J));
  let Yt;
  e[75] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Yt = (0, q.jsx)(N, {
      ...
      (e[75] = Yt))
    : (Yt = e[75]);
  let Xt = O ? null : (D?.id ?? M ?? void 0),
    Y;
  e[76] !== Ct || e[77] !== Xt
    ? ((Y = (0, q.jsx)(Nt, {
        label: Yt,
        control: (0, q.jsx)(Xe, {
          activeProjectIdOverride: Xt,
          allowRemoteProjects: !1,
          onWorkspaceRootSelected: Ct,
        }),
      })),
      (e[76] = Ct),
      (e[77] = Xt),
  ...
  e[79] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Zt = (0, q.jsx)(N, {
      ...
      (e[79] = Zt))
    : (Zt = e[79]);
  let Qt = Ee.isCloudAvailable && c === `enabled`,
    X;
  e[80] !== I || e[81] !== B || e[82] !== F || e[83] !== G || e[84] !== Qt
    ? ((X = (0, q.jsx)(Nt, {
        label: Zt,
        control: (0, q.jsx)(mt, {
          canUseCloud: Qt,
    ...
    : (X = e[85]);
  let Z;
  e[86] !== I || e[87] !== We || e[88] !== Ue || e[89] !== Je || e[90] !== Ye || e[91] !== Be
    ? ((Z =
        I === `worktree`
          ? (0, q.jsx)(Nt, {
              label: (0, q.jsx)(N, {
              ...
              control: (0, q.jsx)(at, {
                ...
                isLoading: Ue,
                hasError: We != null,
                selectedConfigPath: Je,
                onSelectConfigPath: Ye,
                onOpenSettings: Ot,
              }),
            })
          : null),
  ...
  e[95] === I
    ...
    : (($ =
        I === `cloud`
          ? null
          : (0, q.jsx)(Fe, { conversationId: null, hostId: de, DropdownContainer: Mt })),
      (e[95] = I),
      (e[96] = $));
  let $t;
  e[97] !== Y || e[98] !== X || e[99] !== Z || e[100] !== Q || e[101] !== $
    ? (($t = (0, q.jsx)(je, {
        align: `center`,
        side: `top`,
        sideOffset: 10,
  ...
  let en;
  return (
    e[103] !== Ze || e[104] !== J || e[105] !== $t
      ? ((en = (0, q.jsxs)(Me, { open: Ze, onOpenChange: Qe, children: [J, $t] })),
        (e[103] = Ze),
        (e[104] = J),
        (e[105] = $t),
        (e[106] = en))
          ...
          children: [
            ...
            (0, q.jsx)(`div`, {
              ...
              children: (0, q.jsx)(Ve, {
                ...
                surfaceClassName: Dt.composerSurface,
                composerModeAvailability: Ee,
                placeholderText: W,
                defaultCwd: O ? `~` : void 0,
...
function Ot() {
  a.dispatchMessage(`show-settings`, { section: `local-environments` });
}
function kt(e) {
  y.hotkeyWindowHotkeys?.open({ path: u(e) });
}
function At() {
  Pe();
}
function jt(e) {
  y.hotkeyWindowHotkeys?.homePointerInteractionChanged({ isInteractive: e });
}
function Mt(e) {
  let t = (0, Ft.c)(3),
    { children: n } = e,
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, q.jsx)(Nt, { label: r, control: n })), (t[1] = n), (t[2] = i)),
    i
  );
}
function Nt(e) {
...
e(() => {
  ((Ft = i()),
    ...
    W(),
    (q = r()),
    (It = [`[data-composer-overlay-floating-ui]`, `[data-above-composer-portal] > *`]));
})();
export { G as HotkeyWindowHomePage };
