...
import { Tn as Pe, wn as Fe } from "./app-initial~app-main~automations-page.js";
import {
  F as Ie,
  I as Le,
  Jn as Re,
...
function dt(e) {
  ...
  t[0] !== r || t[1] !== c
    ? ((d =
        r === `cloud`
          ? (0, U.jsx)(Me, { className: `icon-2xs` })
          : r === `worktree` && c
            ? (0, U.jsx)(re, { className: `icon-2xs` })
            : (0, U.jsx)(V, { className: `icon-2xs` })),
      (t[0] = r),
      (t[1] = c),
      (t[2] = d))
    : (d = t[2]);
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, U.jsx)(de, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[7] = p))
    : (p = t[7]);
  let m;
  t[8] !== d || t[9] !== f
    ? ((m = (0, U.jsxs)(U.Fragment, { children: [d, f, p] })), (t[8] = d), (t[9] = f), (t[10] = m))
    : (m = t[10]);
  let h = m;
  if (s) {
    let e;
    ...
    return (
      t[13] !== s || t[14] !== e
        ? ((n = (0, U.jsx)(L, { tooltipContent: s, children: e })),
          (t[13] = s),
          (t[14] = e),
          (t[15] = n))
        : (n = t[15]),
  ...
  let x;
  t[22] !== v || t[23] !== y
    ? ((x = (0, U.jsx)(z.Item, { LeftIcon: V, RightIcon: v, onSelect: y, children: b })),
      (t[22] = v),
      (t[23] = y),
      (t[24] = x))
    : (x = t[24]);
  let S = r === `cloud` ? oe : void 0,
    C = !n,
    w;
  t[25] === a
    ? (w = t[26])
...
var H,
  U,
  ft = e(() => {
    ((H = M()), v(), se(), I(), j(), Ee(), R(), Ne(), je(), u(), (U = Ce()));
  });
...
function J() {
  ...
  let n = ee(),
    ...
    re = C?.prefillCwd ?? null,
    { data: D, isLoading: k } = A(ye),
    oe = te(xe.hotkeyWindowProjectlessDefaultEnabled),
    se = pt({
      activeWorkspaceRoot: D?.roots[0] ?? null,
      defaultToProjectless: oe === !0,
      prefillCwd: re,
    }),
    j = re == null ? f : null,
    M = j == null && se === `~`,
    ...
    P = a(N),
    ce = ve(N),
    F = mt({ composerWorkspaceRoot: se, selectedRemoteProjectPath: j?.remotePath ?? null }),
    de = j == null && se == null && k,
    me = ie({ cwd: F, hostId: N, isLoading: de }),
    { data: he, isLoading: ge } = ue(F, P, `hotkey_window_home_page`),
    I = he?.root ?? null,
    L;
  e[0] !== ce || e[1] !== F || e[2] !== I || e[3] !== s
    ? ((L = F != null && I != null && s && !h(F, ce)),
      (e[0] = ce),
      (e[1] = F),
      (e[2] = I),
      (e[3] = s),
    ...
    : (L = e[4]);
  let R = L,
    Se = j == null && !k && !ge && I == null,
    Ce = M || Se,
    z = {
      fallbackMode: `local`,
      isAvailabilityLoading: !Ce && ((j == null && k) || ge || u),
      isCloudAvailable: !Ce,
      isLocalAvailable: !0,
    ...
    Ee = A(pe),
    De = We(),
    B = Ve({ ...z, composerMode: Te, cloudAccess: d }),
    ke = B === `worktree` && F != null,
    V;
  e[5] !== N || e[6] !== ke
    ? ((V = { enabled: ke, hostId: N, source: `hotkey_window_worktree_source` }),
      (e[5] = N),
      (e[6] = ke),
      (e[7] = V))
    : (V = e[7]);
  let { gitRoot: je } = Je(F, V),
    Me = B === `worktree` ? F : null,
    Ne;
  e[8] !== N || e[9] !== Me
    ? ((Ne = { hostId: N, workspaceRoot: Me }), (e[8] = N), (e[9] = Me), (e[10] = Ne))
    : (Ne = e[10]);
  let {
      environments: Pe,
      isLoading: Ie,
      error: Re,
      resolvedConfigPath: ze,
      updateSelection: Be,
    } = $e(Ne),
    [He, Ue] = (0, Y.useState)(!1),
    [Ge, qe] = (0, Y.useState)(null),
    Xe;
  e[11] === w
    ? (Xe = e[12])
    : ((Xe = { activationNonce: w, interactiveRegionRef: y, onInteractiveChange: Ot }),
      (e[11] = w),
      (e[12] = Xe));
  let et = yt(Xe),
    tt;
  (e[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((tt = (e) => {
      ...
      (e[13] = tt))
    : (tt = e[13]),
    ne(`hotkey-window-home-composer-position-changed`, tt));
  let rt;
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((rt = (e) => {
        ...
        (c?.minimumComposerTopInsetPx === s.minimumComposerTopInsetPx &&
          ...
          ((S.current = s), b.hotkeyWindowHotkeys?.homeLayoutChanged(s));
      }),
      (e[14] = rt))
    : (rt = e[14]);
  let it = rt,
  ...
  let ht = ft,
    _t = Et,
    vt;
  e[25] !== r.hash || e[26] !== r.pathname || e[27] !== r.search || e[28] !== C || e[29] !== o
    ? ((vt = (e) => {
        let t = e ?? `~`,
          n = { ...C, prefillCwd: t };
        o({ pathname: r.pathname, search: r.search, hash: r.hash }, { replace: !0, state: n });
      }),
      (e[25] = r.hash),
      (e[26] = r.pathname),
      (e[27] = r.search),
  ...
  e[33] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = (e) => {
        x.current === e.pointerId && b.hotkeyWindowHotkeys?.homeDragMove();
      }),
      (e[33] = K))
    : (K = e[33]);
  let Ct = K,
  ...
  e[61] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Rt = be(wt.home, `relative h-full w-full overflow-hidden bg-transparent pb-1`)),
      (zt = (0, X.jsx)(Qe, {})),
      (e[61] = Rt),
      (e[62] = zt))
    : ((Rt = e[61]), (zt = e[62]));
  ...
  e[63] === Bt
    ? (Vt = e[64])
    : ((Vt = be(wt.homeShell, `absolute inset-x-1 bottom-1 px-[15px] pb-[13px] pt-[17px]`, Bt)),
      (e[63] = Bt),
      (e[64] = Vt));
  let Ht;
  e[65] === Ge
    ? (Ht = e[66])
    : ((Ht = Ge == null ? void 0 : { bottom: `auto`, top: Ge }), (e[65] = Ge), (e[66] = Ht));
  let Ut;
  ...
  let Wt = !M && !de,
    Gt;
  e[68] !== B || e[69] !== U || e[70] !== R || e[71] !== Wt
    ? ((Gt = (0, X.jsx)(gt, { composerMode: B, enabled: Wt, setComposerMode: U, showWorktree: R })),
      (e[68] = B),
      (e[69] = U),
      (e[70] = R),
      (e[71] = Wt),
  ...
  e[73] === Lt
    ...
    : ((Z = (0, X.jsx)(fe, {
        asChild: !0,
        children: (0, X.jsx)(Ae, { label: Lt, size: `composer` }),
      })),
      (e[73] = Lt),
      (e[74] = Z));
  let Kt;
  ...
  e[79] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Jt = (0, X.jsx)(i, {
      ...
      (e[79] = Jt))
    : (Jt = e[79]);
  let Yt = z.isCloudAvailable && d === `enabled`,
    Xt;
  e[80] !== B || e[81] !== U || e[82] !== R || e[83] !== J || e[84] !== Yt
    ? ((Xt = (0, X.jsx)(At, {
        label: Jt,
        control: (0, X.jsx)(dt, {
          canUseCloud: Yt,
    ...
    : (Xt = e[85]);
  let Zt;
  e[86] !== B || e[87] !== Re || e[88] !== Ie || e[89] !== ze || e[90] !== Be || e[91] !== Pe
    ? ((Zt =
        B === `worktree`
          ? (0, X.jsx)(At, {
              label: (0, X.jsx)(i, {
  ...
  e[95] === B
    ...
    : (($t =
        B === `cloud`
          ? null
          : (0, X.jsx)(Le, { conversationId: null, hostId: m, DropdownContainer: kt })),
      (e[95] = B),
      (e[96] = $t));
  let $;
  e[97] !== Q || e[98] !== Xt || e[99] !== Zt || e[100] !== Qt || e[101] !== $t
    ? (($ = (0, X.jsx)(we, {
        align: `center`,
        side: `top`,
        sideOffset: 10,
  ...
  let en;
  return (
    e[103] !== He || e[104] !== Z || e[105] !== $
      ? ((en = (0, X.jsxs)(_e, { open: He, onOpenChange: Ue, children: [Z, $] })),
        (e[103] = He),
        (e[104] = Z),
        (e[105] = $),
        (e[106] = en))
...
function Et(e) {
  b.hotkeyWindowHotkeys?.open({ path: k(e) });
}
function Dt() {
  y();
}
...
function kt(e) {
  ...
  return (
    t[1] === n
      ? (a = t[2])
      : ((a = (0, X.jsx)(At, { label: r, control: n })), (t[1] = n), (t[2] = a)),
    a
  );
}
function At(e) {
