...
import { ds as o, sr as s, us as c } from "./app-server-manager-signals.js";
import { f as l, p as u } from "./vscode-api.js";
import { i as ee } from "./react.js";
import "./isEqual.js";
import { J as d, T as f, ut as p } from "./src-1.js";
import "./react-dom.js";
import { c as te, o as m } from "./lib.js";
import "./persisted-signal.js";
import { t as h } from "./clsx-Cir5-jBH.js";
import "./proxy.js";
import "./app-shell-state.js";
import { t as g } from "./button-DO-oxX3-.js";
import { a as _ } from "./setting-storage.js";
...
import { n as b } from "./rpc-1.js";
import { o as x, u as ne } from "./statsig.js";
import "./request.js";
...
import { a as re } from "./remote-projects.js";
...
import "./waveform.js";
import "./katex-1.js";
import { f as w, m as ae } from "./chunk-109.js";
...
import { D as oe, m as E, o as se, t as ce } from "./composer-view-state.js";
...
import { t as D } from "./focus-composer.js";
...
import { d as le, f as O, n as ue, t as k } from "./composer.js";
...
import { t as A } from "./local-active-workspace-root-dropdown.js";
import { r as j, t as de } from "./dropdown.js";
import "./globe.js";
import "./set-pinned-thread.js";
import "./thread-actions.js";
import { i as M, n as N, t as fe } from "./popover.js";
import "./face.js";
import "./three-dots.js";
import "./trash.js";
import "./use-app-server-connection-state-CCnw-hJJ.js";
import { t as pe } from "./cloud.js";
import { t as P } from "./macbook.js";
...
import { t as he } from "./get-project-name.js";
...
import { d as _e } from "./local-remote-selection.js";
...
import { a as ve } from "./slash-command-item.js";
...
import { t as F } from "./use-floating-window-pointer-interactivity.js";
import { n as xe, t as Se } from "./composer-footer-branch-switcher-B-sWS9-u.js";
import "./git-branch-switcher.js";
import "./use-git-recent-branches.js";
import { t as Ce } from "./use-hotkey-window-dismiss-on-escape-D4h-fjJ0.js";
var I = e(t(), 1),
  L = r(),
  R = n();
function we(e) {
  ...
  t[3] !== n || t[4] !== o
    ? ((f =
        n === `cloud`
          ? (0, R.jsx)(pe, { className: `icon-2xs` })
          : n === `worktree` && o
            ? (0, R.jsx)(me, { className: `icon-2xs` })
            : (0, R.jsx)(P, { className: `icon-2xs` })),
      (t[3] = n),
      (t[4] = o),
      (t[5] = f))
    : (f = t[5]);
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, R.jsx)(ie, { className: `icon-2xs text-token-input-placeholder-foreground` })),
      (t[10] = h))
    : (h = t[10]);
  let _;
  t[11] !== f || t[12] !== p
    ? ((_ = (0, R.jsxs)(R.Fragment, { children: [f, p, h] })),
      (t[11] = f),
      (t[12] = p),
      (t[13] = _))
    : (_ = t[13]);
  ...
  if (a) {
    ...
    return (
      t[18] !== a || t[19] !== e
        ? ((n = (0, R.jsx)(y, { tooltipContent: a, children: e })),
          (t[18] = a),
          (t[19] = e),
          (t[20] = n))
        : (n = t[20]),
  ...
  t[22] === ne
    ? (C = t[23])
    : ((C = (0, R.jsx)(y, { tooltipContent: S, children: ne })), (t[22] = ne), (t[23] = C));
  let re = n === `local` ? v : void 0,
    w;
  t[24] === d
    ? (w = t[25])
    : ((w = () => {
  ...
  let T;
  t[27] !== re || t[28] !== w
    ? ((T = (0, R.jsx)(j.Item, { LeftIcon: P, RightIcon: re, onSelect: w, children: ae })),
      (t[27] = re),
      (t[28] = w),
      (t[29] = T))
    : (T = t[29]);
  let oe = n === `cloud` ? v : void 0,
    E;
  t[30] === d
    ? (E = t[31])
    : ((E = () => {
  ...
  let D;
  t[33] !== oe || t[34] !== E
    ? ((D = (0, R.jsx)(j.Item, { LeftIcon: pe, RightIcon: oe, onSelect: E, children: se })),
      (t[33] = oe),
      (t[34] = E),
      (t[35] = D))
    : (D = t[35]);
  let le = n === `worktree` ? v : void 0,
    O;
  t[36] === d
    ? (O = t[37])
    : ((O = () => {
...
function Te({ activeWorkspaceRoot: e, defaultToProjectless: t, prefillCwd: n }) {
  return n ?? (t ? `~` : e);
}
function Ee({ composerWorkspaceRoot: e, selectedRemoteProjectPath: t }) {
  return t ?? (e === `~` ? null : e);
}
function De(e) {
  let t = (0, L.c)(25),
...
var ke = {
  ...
  Ae = [`[data-composer-overlay-floating-ui]`, `[data-above-composer-portal] > *`];
function B() {
  let e = (0, L.c)(102),
    t = i(T);
  Ce();
  let n = te(),
    ...
    ee = x(`505458`),
    p = ne(),
    { selectedRemoteProject: g } = re(),
    v = (0, I.useRef)(null),
    y = (0, I.useRef)(null),
    ie = (0, I.useRef)(null),
    ce = (0, I.useRef)(null),
    D = r.state,
    j = D?.focusComposerNonce ?? null,
    de = D?.prefillCwd ?? null,
    { data: pe, isLoading: P } = a(S),
    me = _(f.hotkeyWindowProjectlessDefaultEnabled),
    _e = Te({
      activeWorkspaceRoot: pe?.roots[0] ?? null,
      defaultToProjectless: me === !0,
      prefillCwd: de,
    }),
    F = de == null ? g : null,
    z = F == null && _e === `~`,
    ...
    Re = c(B),
    ze = C(B),
    V = Ee({ composerWorkspaceRoot: _e, selectedRemoteProjectPath: F?.remotePath ?? null }),
    { data: Be, isLoading: Ve } = s(V, Re, `hotkey_window_home_page`),
    H = Be?.root ?? null,
    He;
  e[0] !== ze || e[1] !== V || e[2] !== H || e[3] !== ee
    ? ((He = V != null && H != null && ee && !d(V, ze)),
      (e[0] = ze),
      (e[1] = V),
      (e[2] = H),
      (e[3] = ee),
    ...
    : (He = e[4]);
  let U = He,
    Ue = F == null && !P && !Ve && H == null,
    We = z || Ue,
    Ge = {
      fallbackMode: `local`,
      isAvailabilityLoading: !We && ((F == null && P) || Ve || p),
      isCloudAvailable: !We,
      isLocalAvailable: !0,
    ...
    Xe;
  e[5] !== B || e[6] !== Ye
    ? ((Xe = { enabled: Ye, hostId: B, source: `hotkey_window_worktree_source` }),
      (e[5] = B),
      (e[6] = Ye),
      (e[7] = Xe))
    : (Xe = e[7]);
  let { gitRoot: Ze } = ve(V, Xe),
    Qe = W === `worktree` ? V : null,
    $e;
  e[8] !== B || e[9] !== Qe
    ? (($e = { hostId: B, workspaceRoot: Qe }), (e[8] = B), (e[9] = Qe), (e[10] = $e))
    : ($e = e[10]);
  let {
      environments: et,
      isLoading: tt,
    ...
    [at, ot] = (0, I.useState)(!1),
    [st, ct] = (0, I.useState)(null),
    lt;
  e[11] === j
    ? (lt = e[12])
    : ((lt = { activationNonce: j, interactiveRegionRef: y, onInteractiveChange: Pe }),
      (e[11] = j),
      (e[12] = lt));
  let ut = Oe(lt),
    dt;
  (e[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((dt = (e) => {
      ...
      (e[13] = dt))
    : (dt = e[13]),
    u(`hotkey-window-home-composer-position-changed`, dt));
  let ft;
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ft = (e) => {
        ...
        (c?.minimumComposerTopInsetPx === s.minimumComposerTopInsetPx &&
          ...
          ((ce.current = s), b.hotkeyWindowHotkeys?.homeLayoutChanged(s));
      }),
      (e[14] = ft))
    : (ft = e[14]);
  let pt = ft,
    mt;
  (e[15] === j ? (mt = e[16]) : ((mt = [j]), (e[15] = j), (e[16] = mt)), (0, I.useEffect)(Ne, mt));
  let ht, gt;
  (e[17] === Je
    ? ((ht = e[18]), (gt = e[19]))
    : ((gt = () => {
  ...
  let yt = vt,
    bt = Me,
    xt;
  e[24] !== r.hash || e[25] !== r.pathname || e[26] !== r.search || e[27] !== D || e[28] !== l
    ? ((xt = (e) => {
        let t = e ?? `~`,
          n = { ...D, prefillCwd: t };
        l({ pathname: r.pathname, search: r.search, hash: r.hash }, { replace: !0, state: n });
      }),
      (e[24] = r.hash),
      (e[25] = r.pathname),
      (e[26] = r.search),
  ...
  e[32] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Dt = (e) => {
        ie.current === e.pointerId && b.hotkeyWindowHotkeys?.homeDragMove();
      }),
      (e[32] = Dt))
    : (Dt = e[32]);
  let Ot = Dt,
  ...
  e[58] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Pt = h(ke.home, `relative h-full w-full overflow-hidden bg-transparent pb-1`)),
      (e[58] = Pt))
    : (Pt = e[58]);
  let Ft = ut && `no-drag`,
    It;
  e[59] === Ft
    ? (It = e[60])
    : ((It = h(ke.homeShell, `absolute inset-x-1 bottom-1 px-[15px] pb-[13px] pt-[17px]`, Ft)),
      (e[59] = Ft),
      (e[60] = It));
  let Lt;
  e[61] === st
  ...
  e[64] !== W || e[65] !== G || e[66] !== U || e[67] !== zt
    ? ((Bt = (0, R.jsx)(De, { composerMode: W, enabled: zt, setComposerMode: G, showWorktree: U })),
      (e[64] = W),
      (e[65] = G),
      (e[66] = U),
      (e[67] = zt),
  ...
  e[69] === Nt
    ...
    : ((q = (0, R.jsx)(M, {
        asChild: !0,
        children: (0, R.jsx)(ye, { label: Nt, size: `composer` }),
      })),
      (e[69] = Nt),
      (e[70] = q));
  let Vt;
  ...
  e[90] === W
    ...
    : ((Q =
        W === `cloud`
          ? null
          : (0, R.jsx)(O, { conversationId: null, hostId: o, DropdownContainer: Fe })),
      (e[90] = W),
      (e[91] = Q));
  let $;
  ...
  return (
    e[98] !== at || e[99] !== q || e[100] !== $
      ? ((Wt = (0, R.jsxs)(fe, { open: at, onOpenChange: ot, children: [q, $] })),
        (e[98] = at),
        (e[99] = q),
        (e[100] = $),
        (e[101] = Wt))
        ...
        children: [
          ...
          (0, R.jsx)(`div`, {
            ...
            children: (0, R.jsx)(k, {
              ...
              surfaceClassName: ke.composerSurface,
...
function je() {
  l.dispatchMessage(`show-settings`, { section: `local-environments` });
}
function Me(e) {
  b.hotkeyWindowHotkeys?.open({ path: p(e) });
}
function Ne() {
  D();
}
function Pe(e) {
  b.hotkeyWindowHotkeys?.homePointerInteractionChanged({ isInteractive: e });
}
function Fe(e) {
  let t = (0, L.c)(3),
    { children: n } = e,
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, R.jsx)(Ie, { label: r, control: n })), (t[1] = n), (t[2] = i)),
    i
  );
}
function Ie(e) {
  ...
  t[2] === r
    ? (a = t[3])
    : ((a = (0, R.jsx)(`div`, { className: `min-w-0`, children: r })), (t[2] = r), (t[3] = a));
  let o;
  return (
    t[4] !== i || t[5] !== a
      ? ((o = (0, R.jsxs)(`div`, {
...
export { B as HotkeyWindowHomePage };
