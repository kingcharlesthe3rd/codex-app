...
import { Xs as t, gn as n } from "./app-server-manager-signals.js";
import {
  C as r,
  L as i,
  S as a,
...
import { t as _ } from "./startCase-Bo0-xpFk.js";
...
async function w({ connectorId: e, theme: t }) {
  let n = await l.getInstance().get(`/aip/connectors/${encodeURIComponent(e)}/logo?theme=${t}`);
  ...
  return {
    ...
    queryFn: async () =>
      h.safeGet(`/aip/connectors/{connector_id}`, {
        parameters: { path: { connector_id: e }, query: { include_logo: !1, include_actions: t } },
  ...
  if (s == null)
    try {
      ...
      return (
        ...
        I({ app: e, openInBrowser: i }) ? { kind: `browser-fallback` } : { kind: `failed` }
      );
    }
  if (s == null) return { kind: `failed` };
  let c = ie(s);
  if (re(s) || c === `UNSUPPORTED`)
    return I({ app: e, openInBrowser: i }) ? { kind: `browser-fallback` } : { kind: `failed` };
  try {
    let n = a == null ? void 0 : { personalized: a };
    if (c === `NONE`)
      return (
        await h.safePost(`/aip/connectors/links/noauth`, {
          requestBody: { connector_id: s.id, name: s.name, action_names: [], tool_settings: n },
          additionalHeaders: { [T]: E },
        }),
...
function V(e) {
  ...
  let a = i,
    o;
  return (t[2] === a ? (o = t[3]) : ((o = a.some(H)), (t[2] = a), (t[3] = o)), o);
}
function H(e) {
...
function _e(e) {
  ...
  let c = G(s),
    ...
    u;
  t[5] !== l || t[6] !== a || t[7] !== o
    ? ((u = { apps: l, enabled: a, hostId: o }), (t[5] = l), (t[6] = a), (t[7] = o), (t[8] = u))
    : (u = t[8]);
  let d = K(u);
  if (l == null) return c;
  let f;
...
function K(e) {
  let t = (0, B.c)(16),
    ...
    d = s ? n : void 0,
    f;
  t[0] === d ? (f = t[1]) : ((f = d == null ? void 0 : Te(d)), (t[0] = d), (t[1] = f));
  let p = f,
    m;
  t[2] !== p || t[3] !== l ? ((m = Q(l, p)), (t[2] = p), (t[3] = l), (t[4] = m)) : (m = t[4]);
  let h;
  t[5] !== p || t[6] !== u
    ? ((h = async () => {
  ...
  bb0: {
    ...
    (t[12] !== d || t[13] !== v.data
      ? ((e = !1),
        (n = d.map((t) => {
          let n = $({ logoUrl: t.logoUrl, connectorLogoDataUrlByCacheKey: v.data }),
            r = $({ logoUrl: t.logoUrlDark, connectorLogoDataUrlByCacheKey: v.data });
...
function be(e) {
  let t = (0, B.c)(5),
    n = e ?? ``,
    r;
  t[0] === n ? (r = t[1]) : ((r = k(n, { includeActions: !0 })), (t[0] = n), (t[1] = r));
  let i = e != null,
    a;
  return (
    t[2] !== r || t[3] !== i
...
async function J({ forceRefetch: e, hostId: n }) {
  try {
    let r = async (i) => {
      let a = await t(`list-apps`, { hostId: n, cursor: i, limit: fe, forceRefetch: e });
      return a.nextCursor == null ? a.data : [...a.data, ...(await r(a.nextCursor))];
    };
    return await r(null);
  } catch (e) {
    throw (
      r.error(`Failed to load apps list`, { safe: { error: String(e) }, sensitive: {} }),
...
async function Ee({ queryClient: e, requests: t }) {
  let n = await Promise.all(
      t.map(async (t) => ({ cacheKey: C(t), dataUrl: await e.fetchQuery(Z(t)) })),
    ),
    r = new Map();
  return (
    n.forEach((e) => {
