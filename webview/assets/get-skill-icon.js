...
import { Mr as i, Nr as a } from "./src-3.js";
import { I as o, P as s } from "./rpc-1.js";
import { i as c, r as l } from "./known-app-icon.js";
import { t as u } from "./bug.js";
import { t as d } from "./chrome.js";
import { t as f } from "./codex.js";
import { t as p } from "./openai-blossom.js";
import { t as m } from "./pencil.js";
import { n as h, t as g } from "./filesystem-media-src.js";
var _ = e(t()),
  v = n(),
  y = (e) =>
    (0, v.jsxs)(`svg`, {
  ...
  function o(o) {
    ...
    if (l || !e) {
      ...
      return (
        s[0] === f
          ? (e = s[1])
          : ((e = (0, _.createElement)(V(r ?? n?.name ?? ``, i ?? n?.description), {
              className: f,
            })),
            (s[0] = f),
            (s[1] = e)),
    ...
    if (u) {
      ...
      return (
        c[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((o = (0, _.createElement)(A(e, t, n, r, i, a))), (c[2] = o))
          : (o = c[2]),
        o
      );
    }
...
function P({ size: e = `small`, iconSmall: t, iconLarge: n, basePath: r, smallOnly: s }) {
  let c = (e) => {
    let t = e.trim();
    ...
    let s = o(t),
      c = a(s);
    if (k.test(s) && !c) return { url: s, isCustomPath: !1 };
    let l = i(s),
      u = r && !l ? F(s, r) : s;
    if (i(u)) {
      let e = window.location.protocol;
      return e === `http:` || e === `https:`
        ? { url: h(u), isCustomPath: !!r }
        : { url: g(u), isCustomPath: !!r };
    }
    return { url: u, isCustomPath: !!r };
  };
  if (e === `large`) {
    let e = n || t || null;
    if (!e) return { url: null, useCurrentColorMask: !1 };
    let { url: r, isCustomPath: i } = c(e);
    return { url: r, useCurrentColorMask: !!r && i && M(r) };
  }
  let l = s ? t || null : t || n || null;
  if (!l) return { url: null, useCurrentColorMask: !1 };
  let { url: u, isCustomPath: d } = c(l);
  return { url: u, useCurrentColorMask: !!u && d && M(u) };
}
function F(e, t) {
  let n = o(t).replace(/\/+$/, ``),
    r = n.lastIndexOf(`/`);
  return o(s(r >= 0 ? n.slice(0, r) : ``, e.startsWith(`/`) ? e.slice(1) : e));
}
var I = `[data-codex-window-type="electron"]`;
function L() {
...
function R(e) {
  ...
  return (
    t[4] !== u || t[5] !== l
      ? ((d = (0, _.createElement)(u, { "aria-hidden": !0, className: l })),
        (t[4] = u),
        (t[5] = l),
        (t[6] = d))
      : (d = t[6]),
...
var z = {
  "gh-address-comments": T,
  "buildkite-fix-ci": C,
  "sentry-observability": E,
  "linear-implement-ticket": c,
  "figma-implement-design": y,
  "skill-creator": R,
};
function B(e) {
...
function H(
  ...
  return u.url
    ? u.useCurrentColorMask
      ? j(u.url, o, e, s, c, t)
      : A(u.url, o, e, s, c, t)
    : (l ?? V(s ?? e?.name ?? ``, c ?? e?.description));
}
export { H as t };
//# sourceMappingURL=get-skill-icon.js.map
