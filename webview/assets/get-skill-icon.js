...
import { Fr as t, Pr as n } from "./src-2.js";
import { ho as r, po as i } from "./app-server-manager-signals.js";
...
function P({ size: e = `small`, iconSmall: i, iconLarge: a, basePath: o, smallOnly: s }) {
  let c = (e) => {
    let i = e.trim();
    ...
    if (n(u)) {
      ...
      return e === `http:` || e === `https:`
        ? { url: h(u), isCustomPath: !!o }
        : { url: g(u), isCustomPath: !!o };
    }
  ...
  if (e === `large`) {
    ...
    return { url: t, useCurrentColorMask: !!t && n && M(t) };
  }
