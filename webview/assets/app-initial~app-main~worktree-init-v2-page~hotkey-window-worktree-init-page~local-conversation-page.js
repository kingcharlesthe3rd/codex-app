...
import { Jb as c, Ub as l, fo as u, mo as d } from "./app-initial~app-main~onboarding-page.js";
import {
  C_ as f,
  fv as p,
  pv as m,
...
async function v({ entry: e, threadGoalObjective: t, workspaceRoot: n }) {
  ...
  if (e.launchMode === `fork-conversation`) {
    ...
    return (
      (t =
        e.targetTurnId == null
          ? await m(`fork-conversation-from-latest`, {
              hostId: e.hostId,
      ...
      r != null &&
        (await m(`add-worktree-init-synthetic-turn`, { conversationId: t, worktreeInit: r })),
      t
    );
  }
  ...
  let i =
      t == null
        ...
        : {
            ...e.startConversationParamsInput,
            fileAttachments: y(e),
            input: x(e.startConversationParamsInput.input, h(t)),
          },
...
async function b({ entry: e, conversationId: t, hostConfig: r, threadGoalObjective: i }) {
  let s = e.initialThreadTitle == null && e.labelEdited,
    c = (e.initialThreadTitle ?? (s ? e.label : ``)).trim();
  if (
    (c.length > 0 &&
      (await m(`set-thread-title`, {
        conversationId: t,
        title: c,
        ...(s ? { onlyIfUntitled: !0 } : {}),
      })),
    ...
    try {
      await o(`worktree-set-owner-thread`, {
        params: { hostId: r.id, worktree: a(e.worktreeGitRoot), conversationId: t },
      });
    } catch (e) {
      n.warning(
  ...
  if (e.isPinned)
    try {
      await d(t, !0, e.pinnedBeforeThreadId);
    } catch (e) {
...
function S(e, t) {
  ...
  let r = e.browserTransferSourceBrowserTabIds,
    i = r != null && r.length > 0,
    a = s(`${n}:legacy`),
    o = r != null && r.length > 0 ? r : [e.browserTransferSourceBrowserTabId ?? a],
    l =
      e.browserTransferSourceBrowserTabId != null && o.includes(e.browserTransferSourceBrowserTabId)
        ? e.browserTransferSourceBrowserTabId
        : o.at(-1);
  for (let r of o)
    c(t, {
      active: r === l,
      browserTabId: i || e.browserTransferSourceBrowserTabId != null ? r : s(`${t}:legacy`),
...
//# sourceMappingURL=app-initial~app-main~worktree-init-v2-page~hotkey-window-worktree-init-page~local-conversation-page.js.map
