...
import { Fn as f, t as p } from "./product-logger.js";
import { l as m } from "./statsig.js";
import { d as h, l as g, n as _, u as v } from "./dialog-layout-B.js";
import { t as y } from "./codex-Dw-qSlib.js";
import { p as b, u as x, x as S } from "./codex-api.js";
...
function ee(e) {
  ...
  let [C, w] = (0, E.useState)(S),
    ...
    le = (0, E.useRef)(!1),
    ue;
  t[1] === i ? (ue = t[2]) : ((ue = (e) => G(e, i)), (t[1] = i), (t[2] = ue));
  let de = n.map(ue),
    fe;
  ...
  let pe = [...C.map((e) => de.find((t) => t.id === e)).filter(U), ...de.filter(fe)],
    ...
    Te = (e) => {
      f !== `collapsing` ||
        Y.current.has(e) ||
        (Y.current.add(e),
        Y.current.size === $.length - O && (w(X.current), p(null), ee(new Set(Y.current)), h(!1)));
    },
    Ee;
  ...
  let De = (e) => {
      ...
      if ((xe(), Se(), J(!1), a)) {
        let t = e ?? he?.id,
          ...
          a = i.slice(0, k),
          o = a[0];
        (o != null && (_(o.id), r(o.id), (X.current = i.map(V))),
          y(a[1]?.id ?? null),
          x(a[2]?.id ?? null),
          p(`collapsing`),
          Y.current.clear(),
    ...
    Me = a ? `cursor-grab touch-none active:cursor-grabbing` : `touch-none`,
    Ne;
  t[6] === Me
    ? (Ne = t[7])
    : ((Ne = c(`relative z-10 overflow-hidden pt-2 pb-10`, Me)), (t[6] = Me), (t[7] = Ne));
  let Pe, Fe;
  ...
  let Ie = ve.map((e) => {
      let t = $.findIndex((t) => t.id === e.id),
        n = a ? null : _e.findIndex((t) => t.id === e.id),
        r = n === -1 ? null : n,
      ...
      return (0, D.jsx)(
        l.div,
        {
          ...
          animate: a
            ...
            : {
                x: i?.x ?? 0,
                y: c ? [0, r === 0 ? -6 : -10, r === 0 ? -1 : -2, r === 0 ? -2 : -4, u] : u,
                rotate: i?.rotate ?? -2,
                opacity: o ? 0 : 1,
                scale: o ? 0.985 : 1,
              },
            ...
            a && q
              ...
              : s
                ...
                : {
                    ...
                    opacity: {
                      duration: 0.18,
                      delay: a ? Math.max(t - O, 0) * 0.018 : o ? ($.length - t - 1) * 0.014 : 0,
                    },
                    ...(c
                      ? {
          ...
          style: { zIndex: a ? k - t : r === 0 ? 30 : r === 1 ? 20 : r === 2 ? 10 : 9 - t },
          onAnimationComplete: () => {
            (a && f === `expanding` && t === $.length - 1 && p(null),
              r == null && f === `collapsing` && Te(e.id),
              !a &&
                f === `collapsing` &&
                $.length <= O &&
                r === _e.length - 1 &&
                (w(X.current), p(null), h(!1)));
          },
          children: (0, D.jsx)(W, {
            card: e,
            isExpanded: a,
...
function W(e) {
  let t = (0, T.c)(36),
    ...
    u = i && `shadow-[0_10px_28px_rgba(0,0,0,0.06)]`,
    d =
      a != null &&
  ...
  t[0] !== u || t[1] !== d
    ...
    : (f = t[2]);
  let p;
  t[3] === r ? (p = t[4]) : ((p = r ? { y: -4 } : void 0), (t[3] = r), (t[4] = p));
  let m;
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = { type: `spring`, stiffness: 520, damping: 34, mass: 0.7 }), (t[5] = m))
    : (m = t[5]);
  let h = a == null ? void 0 : `button`,
    g = a == null ? void 0 : 0,
    _ = a == null ? void 0 : r,
    v = a == null ? void 0 : o,
    b;
  ...
  t[16] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((O = (0, D.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, D.jsx)(y, { className: `size-4 text-token-text-secondary opacity-70` }),
        ],
      })),
      (t[16] = O))
    : (O = t[16]);
...
function re({ cardCount: e, stripWidth: t }) {
...
function K(e) {
  let t = (0, T.c)(67),
    ...
    f = o(),
    p = (0, E.useId)(),
    [m, y] = (0, E.useState)(null),
    { data: b, error: x, isLoading: C } = S(),
    w = b?.available_count ?? r ?? 0,
    O,
    k;
  t[0] !== b?.credits || t[1] !== m
    ? ((O = b?.credits.filter(ie) ?? []),
      (k = O.find((e) => e.id === m)?.id ?? O[0]?.id),
      (t[0] = b?.credits),
      (t[1] = m),
      (t[2] = O),
      (t[3] = k))
  ...
  if (C) {
    ...
    (t[6] === O
      ? (e = t[7])
      : ((e = (0, D.jsx)(ee, { credits: O, onSelectedCreditIdChange: y })), (t[6] = O), (t[7] = e)),
      (M = e));
  }
  let N;
  t[8] === c
  ...
  let F;
  t[12] !== p || t[13] !== P
    ? ((F = { "aria-describedby": p, onEscapeKeyDown: P }), (t[12] = p), (t[13] = P), (t[14] = F))
    : (F = t[14]);
  let I;
  t[15] !== A || t[16] !== w || t[17] !== l
    ? ((I = (e) => {
        (e.preventDefault(), A != null && l(A, w));
      }),
      (t[15] = A),
      (t[16] = w),
      (t[17] = l),
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((R = (0, D.jsx)(d, { className: `size-4 stroke-[2.2]` })), (t[21] = R))
    : (R = t[21]);
  let z;
  t[22] !== a || t[23] !== c || t[24] !== L
    ? ((z = (0, D.jsx)(`button`, {
        type: `button`,
        disabled: a,
        onClick: c,
...
function q(e) {
  ...
  let b;
  t[4] !== p || t[5] !== y
    ? ((b = { "aria-describedby": p, onEscapeKeyDown: y }), (t[4] = p), (t[5] = y), (t[6] = b))
    : (b = t[6]);
  let x;
  t[7] === l
    ? (x = t[8])
  ...
  t[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, D.jsx)(d, { className: `size-4 stroke-[2.4]` })), (t[13] = A))
    : (A = t[13]);
  let j;
  t[14] !== a || t[15] !== c || t[16] !== k
    ? ((j = (0, D.jsxs)(`div`, {
...
function oe(e) {
  ...
  let i = m(n).get(`component_type`, X) === `card_stack` ? `card_stack` : X,
    a;
  return (
    t[3] !== i || t[4] !== r
...
function se(e) {
  ...
  t[12] !== u
    ? ((C = async (e, t) => {
        let r = t === void 0 ? (a ?? 0) : t;
        if (!(y || r === 0)) {
          _(null);
          try {
            let t = await v.mutateAsync({ creditId: e, redeemRequestId: m });
            if (t.code !== `reset`) {
              _(Q(t.code, d));
              return;
            }
  ...
  if (n !== `card_stack`) {
    let e = a ?? 0,
      n = y || (a ?? 0) === 0,
      r;
    t[14] === w ? (r = t[15]) : ((r = () => w()), (t[14] = w), (t[15] = r));
    let i;
    return (
      t[16] !== g || t[17] !== S || t[18] !== y || t[19] !== e || t[20] !== n || t[21] !== r
        ? ((i = (0, D.jsx)(q, {
            availableCount: e,
            errorMessage: g,
            isResetDisabled: n,
  ...
  let O;
  return (
    t[23] !== g || t[24] !== S || t[25] !== w || t[26] !== a || t[27] !== s || t[28] !== y
      ? ((O = (0, D.jsx)(K, {
          errorMessage: g,
          initialAvailableCount: a,
          isRateLimitReached: s,
