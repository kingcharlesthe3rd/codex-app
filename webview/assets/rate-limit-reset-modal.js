...
import { Mn as c, o as l } from "./persisted-signal.js";
import { t as u } from "./clsx.js";
import { t as d } from "./proxy.js";
import { t as f } from "./button.js";
import { l as p } from "./statsig-DoZ-0xit.js";
...
function V(e) {
  ...
  let [C, w] = (0, E.useState)(S),
    ...
    le = (0, E.useRef)(!1),
    ue;
  t[1] === i ? (ue = t[2]) : ((ue = (e) => re(e, i)), (t[1] = i), (t[2] = ue));
  let de = n.map(ue),
    fe;
  ...
  let pe = [...C.map((e) => de.find((t) => t.id === e)).filter(U), ...de.filter(fe)],
    ...
    Te = (e) => {
      f !== `collapsing` ||
        Y.current.has(e) ||
        (Y.current.add(e),
        Y.current.size === $.length - O && (w(X.current), p(null), V(new Set(Y.current)), h(!1)));
    },
    Ee;
...
function K(e) {
  ...
  if (C) {
    ...
    (t[6] === O
      ? (e = t[7])
      : ((e = (0, D.jsx)(V, { credits: O, onSelectedCreditIdChange: m })), (t[6] = O), (t[7] = e)),
      (M = e));
  }
  let N;
  t[8] === c
