...
import { l as f } from "./statsig.js";
import { Un as p, t as m } from "./product-logger.js";
import { p as h, u as g, x as _ } from "./codex-api.js";
...
function K(e) {
  let t = (0, T.c)(67),
    ...
    f = o(),
    p = (0, E.useId)(),
    [m, h] = (0, E.useState)(null),
    { data: g, error: v, isLoading: C } = _(),
  ...
  if (C) {
    ...
    (t[6] === O
      ? (e = t[7])
      : ((e = (0, D.jsx)(ee, { credits: O, onSelectedCreditIdChange: h })), (t[6] = O), (t[7] = e)),
      (M = e));
  }
  let N;
  t[8] === c
...
function q(e) {
  ...
  let g;
  t[4] !== p || t[5] !== h
    ? ((g = { "aria-describedby": p, onEscapeKeyDown: h }), (t[4] = p), (t[5] = h), (t[6] = g))
    : (g = t[6]);
  let _;
  t[7] === l
    ? (_ = t[8])
...
function oe(e) {
  ...
  let i = f(n).get(`component_type`, X) === `card_stack` ? `card_stack` : X,
    a;
  return (
    t[3] !== i || t[4] !== r
...
function se(e) {
  ...
  t[12] !== u
    ? ((C = async (e, t) => {
        let i = t === void 0 ? (r ?? 0) : t;
        if (!(b || i === 0)) {
          v(null);
          try {
            let t = await y.mutateAsync({ creditId: e, redeemRequestId: f });
            if (t.code !== `reset`) {
              v(Q(t.code, d));
              return;
            }
            let r = Math.max(i - 1, 0);
            (h.current ||
              ((h.current = !0),
              m(u, p, {
                availableCountBefore: i,
                componentType: n,
                isRateLimitReached: s,
  ...
  if (n !== `card_stack`) {
    let e = r ?? 0,
      n = b || (r ?? 0) === 0,
      i;
    t[14] === w ? (i = t[15]) : ((i = () => w()), (t[14] = w), (t[15] = i));
    let a;
    return (
      t[16] !== _ || t[17] !== S || t[18] !== b || t[19] !== e || t[20] !== n || t[21] !== i
        ? ((a = (0, D.jsx)(q, {
            availableCount: e,
            errorMessage: _,
            isResetDisabled: n,
  ...
  let O;
  return (
    t[23] !== _ || t[24] !== S || t[25] !== w || t[26] !== r || t[27] !== s || t[28] !== b
      ? ((O = (0, D.jsx)(K, {
          errorMessage: _,
          initialAvailableCount: r,
          isRateLimitReached: s,
