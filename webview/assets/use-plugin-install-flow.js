...
import { Xs as o, fo as s, ur as c, wo as l, za as u } from "./app-server-manager-signals.js";
...
import { f as te } from "./chunk-8.js";
import { t as O } from "./queryOptions.js";
import { o as ne, p as k } from "./statsig.js";
import { t as A } from "./request.js";
import { t as re } from "./invalidate-queries-and-broadcast.js";
import { C as j, c as M } from "./config-queries.js";
import { r as ie } from "./remote-connection-visibility.js";
import { g as N, h as ae, m as P, s as F, y as I } from "./apps-queries.js";
...
import { t as V } from "./plugin-install-store-CS-dd4DH.js";
import { t as ce } from "./use-platform.js";
import { i as H, n as le, r as U } from "./use-is-plugins-enabled.js";
import { d as ue, f as de, n as W, o as fe, p as G, s as pe } from "./use-plugins.js";
import { l as me, n as he } from "./dialog-layout.js";
import { a as K, o as q, s as J } from "./plugins-availability.js";
import { n as ge, r as _e } from "./plugin-config-edits.js";
import { m as ve } from "./links.js";
import { t as Y } from "./badge.js";
import { t as ye } from "./openai-blossom.js";
...
import { i as De, n as Oe } from "./app-connect-oauth.js";
import { o as ke, r as Ae } from "./computer-use-app-approvals-query.js";
import { t as je } from "./hooks-settings-queries.js";
var X = E();
function Me() {
  let e = (0, X.c)(3),
...
function ze(e) {
  let t = (0, X.c)(10),
    ...
    r = n != null,
    i;
  t[0] === n ? (i = t[1]) : ((i = Le({ browserExtensionId: n })), (t[0] = n), (t[1] = i));
  let a;
  t[2] !== r || t[3] !== i
    ? ((a = { enabled: r, refetchOnWindowFocus: !0, staleTime: C.FIVE_SECONDS, ...i }),
      (t[2] = r),
      (t[3] = i),
      (t[4] = a))
    : (a = t[4]);
...
function Ke(e) {
  ...
  t[0] !== a || t[1] !== n || t[2] !== r || t[3] !== i
    ? ((o = Ye(a, i)),
      ...
      (s = n && o != null),
      (c =
        o == null ? [`plugins`, `browser-extension-setup`, `missing`] : $e({ hostId: r, path: o })),
      (t[0] = a),
      (t[1] = n),
      (t[2] = r),
      (t[3] = i),
  ...
  t[13] !== s || t[14] !== c || t[15] !== u
    ? ((d = { enabled: s, queryKey: c, queryFn: u, retry: !1, staleTime: C.INFINITE }),
      (t[13] = s),
      (t[14] = c),
      (t[15] = u),
      (t[16] = d))
...
async function qe({
  ...
  let o = await Ge({
    codexHome: t ?? (await w(`codex-home`, { params: { hostId: n } })).codexHome,
    hostId: n,
  ...
  return (
    await Promise.all(
      o.map(async (e) => ({
        browserExtension: e,
        needsSetup: !Re(await i.fetchQuery({ ...Le({ browserExtensionId: e.id }), staleTime: 0 })),
      })),
    )
  )
...
function it(e) {
  ...
  t[0] !== n || t[1] !== s.kind || t[2] !== s.plugin
    ? ((g = s.kind === `details` ? { hostId: n, ...fe(s.plugin) } : { hostId: n }),
      (t[0] = n),
      (t[1] = s.kind),
      (t[2] = s.plugin),
      (t[3] = g))
  ...
  let { blockedReason: _, isLoading: b } = Ce(g),
    ...
    E;
  t[4] === h ? (E = t[5]) : ((E = h == null ? null : pe(h)), (t[4] = h), (t[5] = E));
  ...
  t[14] === j
    ? (M = t[15])
    : ((M = [`plugins`, `install-modal`, `disclosure`, j]), (t[14] = j), (t[15] = M));
  let ie = A && re,
    N;
  t[16] === k
    ? (N = t[17])
    : ((N = async () => {
        ...
        return { blurbs: Nt(e.flatMap(ot)), personalizationToggles: e.flatMap(at) };
      }),
      (t[16] = k),
      (t[17] = N));
  let ae;
  t[18] !== ie || t[19] !== N || t[20] !== M
    ? ((ae = { queryKey: M, enabled: ie, staleTime: C.FIVE_MINUTES, queryFn: N }),
      (t[18] = ie),
      (t[19] = N),
      (t[20] = M),
      (t[21] = ae))
  ...
  if (
    ...
    (t[34] !== m || t[35] !== I || t[36] !== p || t[37] !== L.plugin.id
      ...
      (V = Pt({ draftModes: R, personalizationToggles: A ? P?.personalizationToggles : void 0 })),
      (t[22] = m),
      (t[23] = P?.personalizationToggles),
      (t[24] = d),
      (t[25] = l),
  ...
  let de = !c,
    W;
  t[42] !== I || t[43] !== L
    ? ((W = (0, Q.jsx)(lt, { phase: I, plugin: L })), (t[42] = I), (t[43] = L), (t[44] = W))
    : (W = t[44]);
  let G;
  t[45] !== R ||
  t[46] !== H ||
...
function lt(e) {
  ...
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Q.jsx)(B, { className: `icon-md text-token-text-secondary` })), (t[6] = l))
    : (l = t[6]);
  let u;
...
function ut(e) {
  ...
  let h = m,
    ...
    _;
  t[4] !== l || t[5] !== g
    ? ((_ = g ? null : (0, Q.jsx)(At, { plugin: l })), (t[4] = l), (t[5] = g), (t[6] = _))
    : (_ = t[6]);
  let v;
  t[7] !== p || t[8] !== g
    ? ((v =
  ...
  t[10] !== i || t[11] !== l || t[12] !== u || t[13] !== g
    ? ((b = !g && u != null ? (0, Q.jsx)(ft, { hostId: i, plugin: l, pluginDetail: u }) : null),
      (t[10] = i),
      (t[11] = l),
      (t[12] = u),
      (t[13] = g),
  ...
  t[15] !== a || t[16] !== c || t[17] !== u || t[18] !== g || t[19] !== d
    ? ((x = !g && u != null && d ? (0, Q.jsx)(vt, { enabled: a, onChange: c }) : null),
      (t[15] = a),
      (t[16] = c),
      (t[17] = u),
      (t[18] = g),
        ...
        !g && h.length > 0
          ? (0, Q.jsxs)($, {
              children: [
                ...
                (0, Q.jsx)(`div`, { className: `flex flex-wrap gap-2`, children: h.map(dt) }),
              ],
            })
          : null),
      (t[21] = h),
  ...
  let w;
  return (
    t[30] !== _ || t[31] !== v || t[32] !== b || t[33] !== x || t[34] !== S || t[35] !== C
      ? ((w = (0, Q.jsxs)(`div`, {
    ...
    t[4] !== n || t[5] !== r || t[6] !== s
      ? ((c = (0, Q.jsx)($, {
          children: (0, Q.jsxs)(`div`, {
            ...
            children: [o, (0, Q.jsx)(Ee, { checked: n, ariaLabel: s, onChange: r })],
          }),
        })),
        (t[4] = n),
        (t[5] = r),
            ...
            `div`,
            {
              ...
              children: [
                  ...
                  children: [
                    (0, Q.jsx)(`span`, {
                      ...
                      children: (0, Q.jsx)(L, {
                        ...
                        className: `size-full object-contain`,
                        logoUrl: e.logoUrl,
                        fallback: (0, Q.jsx)(B, { className: `icon-md text-token-text-secondary` }),
                      }),
                    }),
                    (0, Q.jsxs)(`div`, {
                ...
                (0, Q.jsx)(se, {
                  ...
                  loading: e.status === `launching` || e.status === `waitingForCallback`,
  ...
  return (
    t[6] === a
      ...
      : ((o = (0, Q.jsxs)(`div`, {
          ...
          children: [i, (0, Q.jsx)(`div`, { className: `flex flex-col`, children: a })],
        })),
        (t[6] = a),
        (t[7] = o)),
    o
...
function Ct(e) {
  ...
  return (
    t[3] === i
      ...
      : ((a = (0, Q.jsxs)(`div`, {
          className: `flex flex-col gap-3`,
          children: [r, (0, Q.jsx)(`div`, { className: `flex flex-col`, children: i })],
        })),
        (t[3] = i),
        (t[4] = a)),
    a
        ...
        (0, Q.jsxs)(`div`, {
          ...
          children: [
            (0, Q.jsx)(L, {
              ...
              fallback: (0, Q.jsx)(B, { className: `size-10 text-token-text-secondary` }),
              logoUrl: e.iconUrl,
            }),
            (0, Q.jsxs)(`div`, {
              className: `min-w-0 flex-1`,
...
function Et() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, Q.jsx)(`div`, { children: Array.from({ length: 3 }).map(Dt) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
...
function At(e) {
  ...
  t[6] !== i || t[7] !== a
    ...
    : (o = t[8]);
  let s;
  t[9] === n ? (s = t[10]) : ((s = (0, Q.jsx)(jt, { plugin: n })), (t[9] = n), (t[10] = s));
  let c;
  return (
    t[11] !== o || t[12] !== s
      ? ((c = (0, Q.jsxs)($, { children: [o, s] })), (t[11] = o), (t[12] = s), (t[13] = c))
      : (c = t[13]),
    c
  );
}
...
function Mt(e) {
  ...
  for (; (r = rt.exec(e)) != null; ) {
    ...
    (t.push((0, Q.jsx)(Tt, { url: s, children: a }, `${s}-${r.index}`)), (n = r.index + i.length));
  }
...
function It(e) {
  return e.interface?.displayName?.trim() || c(e.name.split(`:`).pop() || e.name);
}
function Lt({ forceReloadPlugins: e, hostId: t }) {
  let n = x(_),
    ...
    f = ne(`2761268526`),
    { data: p } = S(j, t),
    { clearPendingAppConnect: v, isAppConnectPending: y, markAppConnectOAuthPending: b } = Oe(),
    {
    ...
    { data: k = [], hardRefetchAppsList: A } = F({ enabled: E.kind === `needsApps`, hostId: t }),
    M = H({ hostId: t }),
    ie = le({ hostId: t }),
    L = U({ hostId: t }),
    oe = M.available,
    ...
    he = ee({
      mutationFn: async (e) => {
        ...
        return (
          await J({ hostId: t, marketplacePath: e.marketplacePath, pluginName: e.plugin.name }), n
        );
      },
    }),
    ve = pe || he.isPending,
    ...
    installPlugin: async (i = {}, s = !1) => {
      ...
      try {
        ...
        try {
          ...
          (m.error(`Failed to install plugin`, { safe: {}, sensitive: { error: e } }),
            n
              .get(R)
              .danger(
                r.formatMessage({
        ...
        if (h.authPolicy === `ON_USE` || (h.appsNeedingAuth.length === 0 && _.length === 0)) {
    ...
    }),
    {
      ...
      requiredApps: n.requiredApps.map((e) => {
        ...
        return (
          n?.isAccessible === !0
            ? (i = `connected`)
            : e.status === `waitingForCallback` && !t(e.app.id) && (i = `pending`),
          {
            appId: e.app.id,
...
export { ze as a, Pe as c, Ke as i, Me as l, it as n, Ie as o, et as r, Fe as s, Lt as t };
