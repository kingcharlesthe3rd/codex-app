...
import { a as r, l as i, o as a, t as o, z as s } from "./app-scope.js";
import { Ls as c, Qi as l, Ts as u, fs as d } from "./app-server-manager-signals.js";
...
import { i as ne, l as O, s as k } from "./lib.js";
import { t as A } from "./clsx-Cir5-jBH.js";
import { t as j } from "./button.js";
import { t as M } from "./use-reduced-motion-2.js";
...
import { nn as L, tn as R } from "./product-logger.js";
import { t as z } from "./format-skill-title.js";
import { N as B } from "./rpc-Hf-fxjh7.js";
import { f as V, o as ae } from "./statsig.js";
import { t as H } from "./request.js";
import { t as oe } from "./invalidate-queries-and-broadcast.js";
import { c as U, w as se } from "./config-queries.js";
import { r as W, t as ce } from "./dropdown.js";
import { d as G, l as le, n as K } from "./dialog-layout-B.js";
import { t as q } from "./badge-C.js";
import { t as J } from "./toggle.js";
import { n as ue, r as de, t as fe } from "./use-in-app-browser-use-availability.js";
import { n as pe, t as me } from "./check-plugin-availability.js";
...
import { c as Te, y as Ee } from "./apps-queries.js";
import { r as De } from "./plugin-detail-queries.js";
import { t as Oe } from "./openai-blossom.js";
import { n as ke, t as Ae } from "./filesystem-media-src.js";
import { t as je } from "./apps-2.js";
import { t as Me } from "./chevron.js";
import { f as Ne } from "./chunk-9.js";
import { p as Pe } from "./codex-api.js";
import { t as Fe } from "./connector-logo.js";
import { t as Ie } from "./chats.js";
import { t as Le } from "./info-1.js";
import { t as Re } from "./plugin-install-store.js";
import { t as ze } from "./settings.cog.js";
import { t as Y } from "./use-skills.js";
import { n as X } from "./use-start-new-conversation-C--5hYOa.js";
import { n as Be, r as Ve } from "./plugin-config-edits.js";
import { n as He } from "./plugin-prefill-prompt.js";
import {
  i as Ue,
  n as We,
  o as Ge,
...
import { t as Je } from "./upgrade-plan-dialog-launcher.js";
import { m as Ye } from "./links-p.js";
import { t as Xe } from "./use-codex-pricing-url.js";
import { c as Ze } from "./plan-management-state.js";
import { t as Qe } from "./lock.js";
import { t as $e } from "./connected-apps.js";
import { i as Z, n as et } from "./app-connect-oauth-DZ-_I6sG.js";
import { o as tt, r as nt } from "./computer-use-app-approvals-query.js";
import { t as rt } from "./hooks-settings-queries.js";
var Q = s();
function it() {
  let e = (0, Q.c)(3),
    [t] = d(`remote_control_connections_state`),
    n = he(),
    r;
  return (
    e[0] !== t || e[1] !== n
      ? ((r = at({ remoteControlConnectionsState: t, slingshotEnabled: n })),
        (e[0] = t),
        (e[1] = n),
        (e[2] = r))
      : (r = e[2]),
...
function at({ remoteControlConnectionsState: e, slingshotEnabled: t }) {
...
var st = {
    ...
    "progression-donut-fill": `_progression-donut-fill_9hstz_1`,
  },
  $ = n(),
  ct = 12,
  lt = 120,
  ...
  dt = 100;
function ft(e) {
  return !Number.isFinite(e) || e < ut ? ut : e > dt ? dt : e;
}
function pt(e) {
  let t = (0, Q.c)(28),
    {
      className: n,
      animateOnMount: r,
      animateOnMountDelayMs: i,
      percent: a,
      reducedMotion: o,
      size: s,
      strokeWidth: c,
      transitionDurationMs: l,
    } = e,
    u = r === void 0 ? !1 : r,
    d = i === void 0 ? 0 : i,
    f = o === void 0 ? !1 : o,
    ...
    y = `0 0 ${p} ${p}`,
    b;
  t[0] === n ? (b = t[1]) : ((b = A(`shrink-0`, n)), (t[0] = n), (t[1] = b));
  let x = p / 2,
    S = p / 2,
    C;
  t[2] !== g || t[3] !== m || t[4] !== S || t[5] !== x
    ? ((C = (0, $.jsx)(`circle`, {
        cx: x,
        cy: S,
        r: g,
  ...
  let w = p / 2,
    T = p / 2,
    ee = _ === ut ? 0 : 1,
    te = u && !f && st.fillOnMount,
    E;
  t[7] === te ? (E = t[8]) : ((E = A(te)), (t[7] = te), (t[8] = E));
  let D = u && !f ? `${d}ms` : void 0,
    ne = f ? `none` : `stroke-dashoffset ${h}ms ease-out, opacity ${h}ms ease-out`,
    O;
  t[9] !== D || t[10] !== ne
    ? ((O = { animationDelay: D, transition: ne }), (t[9] = D), (t[10] = ne), (t[11] = O))
    : (O = t[11]);
  let k = `rotate(-90 ${p / 2} ${p / 2})`,
    j;
  t[12] !== v ||
  t[13] !== g ||
  t[14] !== m ||
  ...
  let M;
  return (
    t[22] !== p || t[23] !== C || t[24] !== j || t[25] !== y || t[26] !== b
      ? ((M = (0, $.jsxs)(`svg`, {
          "aria-hidden": `true`,
          width: p,
          height: p,
...
var mt = i(
    ...
    (e, { get: t }) =>
      t(V, `2296472986`) &&
      at({
        remoteControlConnectionsState: c(t, `remote_control_connections_state`),
        slingshotEnabled: t(V, `1042620455`),
      }) &&
      t(U, { hostId: e }).data?.requirements?.computerUse?.allowLockedComputerUse !== !1,
  ),
  ht = e(t()),
  gt = (e) =>
    (0, $.jsxs)(`svg`, {
...
function vt(e) {
  ...
  t[4] !== n || t[5] !== y || t[6] !== b
    ...
    : (E = t[7]);
  let D = E,
    ne = S && `bg-token-foreground/5`,
    O = d ? `cursor-interaction` : null,
    k;
  t[8] !== g || t[9] !== ne || t[10] !== O
    ? ((k = A(
  ...
  let j = S ? `true` : void 0,
    ...
    N = _ === `inline` && `gap-2`,
    P;
  t[12] === N ? (P = t[13]) : ((P = A(`flex items-center gap-3`, N)), (t[12] = N), (t[13] = P));
  let F = x === `outside` ? D : null,
    ie = T ? `items-center gap-3` : null,
    I;
  t[14] === ie ? (I = t[15]) : ((I = A(`flex min-w-0 flex-1`, ie)), (t[14] = ie), (t[15] = I));
  let L = _ === `stacked` ? `flex-col` : `items-center gap-3`,
    R;
  t[16] !== a || t[17] !== L
    ? ((R = A(`flex min-w-0 flex-1 justify-center gap-0.5`, L, a)),
      (t[16] = a),
      (t[17] = L),
      (t[18] = R))
    : (R = t[18]);
  let z = _ === `inline` && `w-28 shrink-0 sm:w-48`,
    B = T || x === `inline` ? null : `justify-between`,
    V;
  t[19] !== z || t[20] !== B
    ? ((V = A(`flex min-w-0 items-center gap-2`, z, B)), (t[19] = z), (t[20] = B), (t[21] = V))
    : (V = t[21]);
  let ae = x === `inline` ? D : null,
    H;
  t[22] === r
    ? (H = t[23])
    : ((H = (0, $.jsx)(`div`, {
  ...
  t[24] === c
    ? (oe = t[25])
    : ((oe = c?.length
        ? (0, $.jsx)(`div`, { className: `flex shrink-0 items-center gap-1`, children: c.map(yt) })
        : null),
      (t[24] = c),
      (t[25] = oe));
  let U;
  ...
  let se = T ? null : te,
    W;
  t[29] !== V || t[30] !== ae || t[31] !== U || t[32] !== se
    ? ((W = (0, $.jsxs)(`div`, { className: V, children: [ae, U, se] })),
      (t[29] = V),
      (t[30] = ae),
      (t[31] = U),
      (t[32] = se),
  ...
  t[34] !== i || t[35] !== o || t[36] !== _
    ...
    : (ce = t[37]);
  let G;
  t[38] !== R || t[39] !== W || t[40] !== ce
    ? ((G = (0, $.jsxs)(`div`, { className: R, children: [W, ce] })),
      (t[38] = R),
      (t[39] = W),
      (t[40] = ce),
      (t[41] = G))
  ...
  let le = T ? te : null,
    K;
  t[42] !== I || t[43] !== G || t[44] !== le
    ? ((K = (0, $.jsxs)(`div`, { className: I, children: [G, le] })),
      (t[42] = I),
      (t[43] = G),
      (t[44] = le),
      (t[45] = K))
    : (K = t[45]);
  let q;
  t[46] !== P || t[47] !== F || t[48] !== K
    ? ((q = (0, $.jsxs)(`div`, { className: P, children: [F, K] })),
      (t[46] = P),
      (t[47] = F),
      (t[48] = K),
      (t[49] = q))
...
function St(e) {
  let t = (0, Q.c)(47),
    ...
    F;
  t[0] !== h || t[1] !== M
    ? ((F = h ?? M.formatMessage(xt.connectApp)), (t[0] = h), (t[1] = M), (t[2] = F))
    : (F = t[2]);
  let L = F,
    R = n.isEnabled,
    z = ee === `disabled-by-admin` && !n.isAccessible,
    B = y === n.id,
    V;
  t[3] !== T || t[4] !== M
    ? ((V = T == null ? null : M.formatMessage(xt.connectedTo, { email: T })),
      (t[3] = T),
      (t[4] = M),
      (t[5] = V))
    : (V = t[5]);
                  ...
                  children: [
                    ...
                    (0, $.jsx)(P, {
                      ...
                      children: (0, $.jsx)(`button`, {
                        ...
                        "aria-label": ae,
                        onClick: Dt,
                        children: (0, $.jsx)(Le, { className: `icon-2xs` }),
                      }),
                    }),
                  ],
                },
  ...
  t[9] === u
    ? (U = t[10])
    : ((U = A(`group justify-center border-none`, u)), (t[9] = u), (t[10] = U));
  let se;
  t[11] !== n || t[12] !== r
    ? ((se =
        r ??
        (0, $.jsx)(Fe, {
          ...
          appInfo: n,
          className: `icon-md`,
          fallback: (0, $.jsx)($e, { className: `icon-sm text-token-text-secondary` }),
        })),
      (t[11] = n),
      (t[12] = r),
      (t[13] = se))
  ...
  t[14] === n.description
    ? (G = t[15])
    : ((G = n.description ?? (0, $.jsx)(k, { ...xt.noDescription })),
      (t[14] = n.description),
      (t[15] = G));
  let le;
  t[16] !== n || t[17] !== x
    ...
    ? ((K =
        z && l != null
          ...
          : n.isAccessible && te === `toggle`
                ...
                children: [
                  D === `menu`
                    ...
                    : (0, $.jsx)(`div`, {
                        ...
                        children: (0, $.jsx)(P, {
                          tooltipContent: (0, $.jsx)(k, { ...xt.manageOnChatGpt }),
                          children: (0, $.jsx)(j, {
                            color: `ghost`,
                            size: `icon`,
                            "aria-label": M.formatMessage(xt.manageOnChatGpt),
                            onClick: (e) => {
                              (e.stopPropagation(), S?.(Ee(n)));
                            },
                            children: (0, $.jsx)(ze, { className: `icon-sm` }),
                          }),
                        }),
                      }),
                  D === `menu`
                    ...
                    : (0, $.jsx)(P, {
                        tooltipContent: R
                          ? (0, $.jsx)(k, { ...xt.disableToggleTooltip })
                          : (0, $.jsx)(k, { ...xt.enableToggleTooltip }),
                        children: (0, $.jsx)(`div`, {
                          onClick: wt,
                          onKeyDown: Ct,
                          children: (0, $.jsx)(J, {
                            ...
                            ariaLabel: M.formatMessage(xt.enableToggleAria),
                          }),
                        }),
                      }),
                ],
            ...
            : n.isAccessible
              ? (0, $.jsx)(_t, {
                  ariaLabel: M.formatMessage(R ? xt.enabledStatus : xt.disabledStatus),
                  icon: R
                    ? (0, $.jsx)(N, { className: `icon-sm` })
                    : (0, $.jsx)(bt, { className: `icon-sm` }),
                })
              : ne
                ? (0, $.jsx)(P, {
                    disabled: !z && !_,
                    ...
                    children: (0, $.jsx)(`div`, {
                      children: (0, $.jsx)(j, {
                        ...
                        size: `toolbar`,
                        disabled: z || E,
                        "aria-label": _ ? M.formatMessage(xt.connectingApp) : L,
                        onClick: (e) => {
                          (e.stopPropagation(), !z && b(n));
                        },
                        children: _ ? (0, $.jsx)(re, { className: `icon-xxs` }) : L,
                      }),
                    }),
                  })
                : null),
...
function Ot({ browserExtensionId: e }) {
  return x({
    queryKey:
      e == null
...
function At(e) {
  let t = (0, Q.c)(10),
    ...
    r = n != null,
    i;
  t[0] === n ? (i = t[1]) : ((i = Ot({ browserExtensionId: n })), (t[0] = n), (t[1] = i));
  let a;
  t[2] !== r || t[3] !== i
  ...
  let { data: o, isLoading: s } = b(a),
    c;
  t[5] === o ? (c = t[6]) : ((c = kt(o)), (t[5] = o), (t[6] = c));
  let l = n != null && s,
    u;
  return (
    t[7] !== c || t[8] !== l
...
var jt = `assets/google-chrome.png`,
  Mt = `scripts/extension-id.json`,
  Nt = `https://chromewebstore.google.com/detail/codex/`,
  Pt = S([`chrome`, `chrome-dev`, `chrome-internal`]),
  Ft = E({ extensionId: ee().trim().min(1) });
async function It({ codexHome: e, hostId: t, plugin: n, queryClient: r }) {
  try {
    let i = Bt(e, n);
    if (i == null) return [];
    ...
    return await r.fetchQuery({
      queryFn: async () => {
        ...
        return [
          Ht({
            codexHome: e,
            extensionId: Ft.parse(JSON.parse(t.contents)).extensionId,
            plugin: n,
          }),
        ];
      },
...
function Lt(e) {
  ...
  t[0] !== a || t[1] !== n || t[2] !== r || t[3] !== i
    ? ((o = Bt(a, i)),
      ...
      (s = n && o != null),
      (c =
        o == null ? [`plugins`, `browser-extension-setup`, `missing`] : Wt({ hostId: r, path: o })),
      (t[0] = a),
      (t[1] = n),
      (t[2] = r),
      (t[3] = i),
  ...
  t[8] !== a || t[9] !== o || t[10] !== r || t[11] !== i
    ? ((u = async () => {
        ...
        return [
          Ht({
            codexHome: a,
            extensionId: Ft.parse(JSON.parse(e.contents)).extensionId,
            plugin: i,
          }),
        ];
      }),
...
async function Rt({
  ...
  if (e !== `ON_INSTALL` || a !== `electron` || Vt(r) == null) return [];
  let o = await It({
    codexHome: t ?? (await g(`codex-home`, { params: { hostId: n } })).codexHome,
    hostId: n,
    plugin: await zt({ hostId: n, plugin: r }),
    queryClient: i,
  });
  return (
    await Promise.all(
      o.map(async (e) => ({
        browserExtension: e,
        needsSetup: !kt(await i.fetchQuery({ ...Ot({ browserExtensionId: e.id }), staleTime: 0 })),
      })),
    )
  )
...
async function zt({ hostId: e, plugin: t }) {
  try {
    return xe((await u(`read-plugin`, { hostId: e, ...Se(t) })).plugin);
  } catch (e) {
    return (
...
function Bt(e, t) {
  return e == null || t?.plugin.source.type !== `local` || Vt(t) == null
    ? null
    : B(
        te({
          codexHome: e,
...
function Vt(e) {
  let t = Pt.safeParse(e.plugin.name);
  return !t.success || !e.plugin.id.startsWith(`${t.data}@`) ? null : t.data;
}
function Ht({ codexHome: e, extensionId: t, plugin: n }) {
  return {
    iconUrl:
      Ut(
...
function Jt(e) {
  return qt.get(e) ?? null;
}
function Yt(e, t) {
  return t === `connector-unavailable` && Jt(e) != null;
}
function Xt(e) {
  let t = (0, Q.c)(9),
    { upsellId: n } = e;
...
function $t(e) {
  let t = (0, Q.c)(8),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(N, { className: `icon-sm mt-0.5 shrink-0 text-token-text-secondary` })),
      (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === r
...
var en = `OAI-Product-Sku`,
  tn = `CODEX`,
  nn = /\[([^\]]+)\]\(([^)]+)\)/g,
  rn = 480,
  an = `min(720px, calc(100vh - 2rem))`;
function on(e) {
  let t = (0, Q.c)(144),
    {
      hostId: n,
    ...
    h = i === void 0 ? !1 : i,
    g = a(o),
    [v, x] = (0, ht.useState)(null),
    [S, C] = (0, ht.useState)(null),
    { platform: w } = ve(),
    { authMethod: T, planAtLogin: ee } = ge(),
    { data: te } = Pe(),
    E = T === `chatgpt`,
    D;
  t[0] === E ? (D = t[1]) : ((D = { queryConfig: { enabled: E } }), (t[0] = E), (t[1] = D));
  let { data: ne } = _(`account-info`, D),
    O = te?.plan_type ?? ne?.plan ?? ee,
    A;
  t[2] === O ? (A = t[3]) : ((A = Ze(O)?.pricePlan ?? null), (t[2] = O), (t[3] = A));
  let M = A,
    re;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((re = { logExposure: !0 }), (t[4] = re))
    : (re = t[4]);
  let N = Xe(re),
    F = Je(),
    ie = r(mt, n),
    I = m.kind === `closed` ? null : m.plugin,
    L;
  t[5] !== m.kind || t[6] !== m.requiredApps
    ? ((L = m.kind === `needsApps` ? m.requiredApps.map(fn) : void 0),
      (t[5] = m.kind),
      (t[6] = m.requiredApps),
      (t[7] = L))
    : (L = t[7]);
  let R = L,
    z;
  t[8] !== n || t[9] !== R || t[10] !== m.kind || t[11] !== m.plugin
    ? ((z =
        m.kind === `details`
          ? { hostId: n, ...Se(m.plugin), pluginSummary: m.plugin.plugin }
          : { hostId: n, pluginApps: R }),
      (t[8] = n),
      (t[9] = R),
      (t[10] = m.kind),
      (t[11] = m.plugin),
    ...
    : (z = t[12]);
  let {
      blockedReasonsByConnectorId: B,
      blockedReason: V,
      isConnectorAvailabilityLoading: ae,
      isLoading: H,
    } = pe(z),
    oe = I != null && me(I.plugin),
    U = m.kind === `details` ? V : null,
    se = m.kind === `details` && H,
    W = oe ? `disabled-by-admin` : U,
    ce = W != null,
    G = W === `disabled-by-admin`,
    q = I?.marketplacePath ?? null,
    J;
  t[13] === I ? (J = t[14]) : ((J = I == null ? null : we(I)), (t[13] = I), (t[14] = J));
  let ue = I?.remoteMarketplaceName ?? null,
    de = I != null,
    fe;
  t[15] !== n || t[16] !== ue || t[17] !== de || t[18] !== q || t[19] !== J
    ? ((fe = {
        hostId: n,
        marketplacePath: q,
        pluginName: J,
        remoteMarketplaceName: ue,
        enabled: de,
      }),
      (t[15] = n),
      (t[16] = ue),
  ...
  let { plugin: he } = De(fe),
    ...
    ke,
    Ae;
  t[21] !== B || t[22] !== _e || t[23] !== m.kind || t[24] !== m.plugin
    ? ((be = _e?.filter((e) => B[e.id] !== `disabled-by-admin`)),
      (Ce = m.kind === `details` && m.plugin.plugin.authPolicy === `ON_INSTALL`),
    ...
    : ((be = t[25]),
      ...
      (Ae = t[32]));
  let je;
  t[33] !== Te || t[34] !== Ee || t[35] !== Oe || t[36] !== ke
    ? ((je = [Te, Ee, Oe, ke]),
      (t[33] = Te),
      (t[34] = Ee),
      (t[35] = Oe),
  ...
  t[38] === be
    ...
    : ((Ne = async () => {
        ...
        let e = await Promise.all(be.map(un));
        return { blurbs: Gn(e.flatMap(ln)), personalizationToggles: e.flatMap(cn) };
      }),
      (t[38] = be),
      (t[39] = Ne));
  let Fe;
  t[40] !== je || t[41] !== Me || t[42] !== Ne
    ? ((Fe = { queryKey: je, enabled: Me, staleTime: y.FIVE_MINUTES, queryFn: Ne }),
      (t[40] = je),
      (t[41] = Me),
      (t[42] = Ne),
      (t[43] = Fe))
    : (Fe = t[43]);
  let { data: Ie, isLoading: Le } = Ae(Fe),
    Re;
  t[44] !== h || t[45] !== l
    ? ((Re = (e) => {
  ...
  if (m.kind === `connectApp`) {
    let e;
    t[47] === m.app ? (e = t[48]) : ((e = Bn(m.app)), (t[47] = m.app), (t[48] = e));
    let n;
  ...
  if (m.kind === `installing`) {
    let e;
    return (
      t[57] !== ze || t[58] !== m.plugin || t[59] !== m.progressPercent
        ? ((e = (0, $.jsx)(pn, {
            onOpenChange: ze,
            plugin: m.plugin,
  ...
  if (
    t[61] !== ie ||
    t[62] !== Ie?.personalizationToggles ||
    t[63] !== S ||
    t[64] !== v ||
    t[65] !== Y ||
    t[66] !== w ||
    ...
    Be = v?.pluginId === X.plugin.id ? v.modes : {};
    let e;
    (t[73] !== ie || t[74] !== Y || t[75] !== w || t[76] !== X.plugin.id
      ? ((e = Y === `details` && w === `macOS` && ie && ye(X.plugin.id)),
        (t[73] = ie),
        (t[74] = Y),
        (t[75] = w),
        (t[76] = X.plugin.id),
      ...
      : (e = t[77]),
      (He = e),
      (Ve = S?.pluginId === X.plugin.id ? S.enabled : !0),
      (Ue = Kn({
        draftModes: Be,
        personalizationToggles: Ce ? Ie?.personalizationToggles : void 0,
      })),
      (t[61] = ie),
      (t[62] = Ie?.personalizationToggles),
      (t[63] = S),
      ...
      (t[71] = He),
      (t[72] = Ue));
  } else ((Be = t[69]), (Ve = t[70]), (He = t[71]), (Ue = t[72]));
  let qe = Ue,
    Ye = Ce && (ae || (xe && Le)),
    $e;
  t[78] !== W || t[79] !== X.plugin.name
    ? (($e = Yt(X.plugin.name, W)), (t[78] = W), (t[79] = X.plugin.name), (t[80] = $e))
    : ($e = t[80]);
  let Z = $e,
    et;
  t[81] !== X.plugin.name || t[82] !== Z
    ? ((et = Z ? Jt(X.plugin.name) : null), (t[81] = X.plugin.name), (t[82] = Z), (t[83] = et))
    : (et = t[83]);
  let tt = et,
    nt = !h,
    rt;
  t[84] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((rt = { "aria-describedby": void 0, style: { maxHeight: an, width: rn } }), (t[84] = rt))
    : (rt = t[84]);
  ...
  t[85] === Y
    ? (ot = t[86])
    : ((ot = Y === `needsApps` ? { maxHeight: an, padding: 0 } : { maxHeight: an }),
      (t[85] = Y),
      (t[86] = ot));
  let st;
  t[87] !== Y || t[88] !== X || t[89] !== Z
    ? ((st = Y === `details` ? (0, $.jsx)(hn, { plugin: X, showUpgradeBadge: Z }) : null),
      (t[87] = Y),
      (t[88] = X),
      (t[89] = Z),
      (t[90] = st))
  ...
  t[112] !== He
    ? ((ct =
        Y === `needsApps`
          ? (0, $.jsx)(_n, {
              appInstallBlockedReasonsById: B,
              appOrder: _e?.map(sn),
              isAppBlockedReasonLoading: H,
              onConnectRequiredApp: s,
              onOpenChange: ze,
              onTryInChat: f,
              onViewDetails: p,
                ...
                children:
                  tt == null
                    ? (0, $.jsx)(bn, {
                        ...
                        disclosureData: Ce ? Ie : void 0,
                        hostId: n,
                        installLockedComputerUse: Ve,
                        isLoadingDisclosureData: Ye,
                        onAppPersonalizationModeChange: (e) => {
                          let { appId: t, mode: n } = e;
                          x({ modes: { ...Be, [t]: n }, pluginId: X.plugin.id });
                        },
                        ...
                        showLockedComputerUseInstall: He,
                      })
                    : (0, $.jsx)(Xt, { upsellId: tt }),
              })
            : null),
      (t[91] = B),
      (t[92] = Be),
          ...
          ? (0, $.jsx)(P, {
              tooltipContent:
                W === `connector-unavailable` && !Z
                  ...
                  : null,
              disabled: W !== `connector-unavailable` || Z,
              children: (0, $.jsx)(`div`, {
                ...
                children: (0, $.jsx)(j, {
                  ...
                  children: h
                    ? (0, $.jsx)(k, {
                        ...
                        values: { pluginName: Ge(X) },
                      })
                    : G
                      ? (0, $.jsxs)($.Fragment, {
                          children: [
                            (0, $.jsx)(gt, { className: `icon-sm` }),
                            (0, $.jsx)(k, {
  ...
  t[132] !== at || t[133] !== ot || t[134] !== st || t[135] !== ct || t[136] !== lt
    ? ((ut = (0, $.jsxs)(K, { className: at, style: ot, children: [st, ct, lt] })),
      (t[132] = at),
      (t[133] = ot),
      (t[134] = st),
      (t[135] = ct),
  ...
  let dt;
  return (
    t[138] !== ze || t[139] !== h || t[140] !== nt || t[141] !== it || t[142] !== ut
      ? ((dt = (0, $.jsx)(le, {
          open: !0,
          onOpenChange: ze,
...
async function un(e) {
  return {
    app: e,
    connectorTos: await H.safeGet(`/aip/connectors/{connector_id}/tos`, {
      parameters: { path: { connector_id: e.id } },
      additionalHeaders: { [en]: tn },
    }),
  };
}
function dn(e) {
...
function pn(e) {
  ...
  let o = a,
    s;
  t[2] === r ? (s = t[3]) : ((s = Ge(r)), (t[2] = r), (t[3] = s));
  let c = s,
    l = M(),
    u = i === 100,
    d;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = { "aria-describedby": void 0, style: { maxHeight: an, width: rn } }), (t[4] = d))
    : (d = t[4]);
  let f;
  t[5] !== r || t[6] !== i || t[7] !== l
    ? ((f = (0, $.jsx)(mn, { plugin: r, progressPercent: i, reducedMotion: l })),
      (t[5] = r),
      (t[6] = i),
      (t[7] = l),
      (t[8] = f))
...
function mn(e) {
  ...
  let o;
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(je, { className: `icon-lg text-token-text-secondary` })), (t[3] = o))
    : (o = t[3]);
  let s;
  t[4] === n.logoPath
    ? (s = t[5])
...
function hn(e) {
  ...
  let a = i,
    o;
  t[2] === n ? (o = t[3]) : ((o = (0, $.jsx)(gn, { plugin: n })), (t[2] = n), (t[3] = o));
  let s;
  t[4] === n ? (s = t[5]) : ((s = Ge(n)), (t[4] = n), (t[5] = s));
  let c;
  t[6] === s
    ? (c = t[7])
    : ((c = (0, $.jsx)(G, {
  ...
  t[8] === a
    ...
    : ((l = a
      ...
      (t[9] = l));
  let u;
  t[10] === r ? (u = t[11]) : ((u = r ? (0, $.jsx)(Zt, {}) : null), (t[10] = r), (t[11] = u));
  let d;
...
function gn(e) {
  ...
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(Oe, { className: `size-12` }),
      })),
      (t[0] = r))
    : (r = t[0]);
  let i;
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (i = t[1]);
  let a;
  t[2] === n ? (a = t[3]) : ((a = Ge(n)), (t[2] = n), (t[3] = a));
  let o;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(je, { className: `icon-md text-token-text-secondary` })), (t[4] = o))
    : (o = t[4]);
  let s;
  return (
...
function _n(e) {
  let t = (0, Q.c)(22),
    ...
    f;
  t[0] === l ? (f = t[1]) : ((f = (0, $.jsx)(vn, { plugin: l })), (t[0] = l), (t[1] = f));
  let p;
  ...
  t[8] === d
    ? (m = t[9])
    : ((m = (0, $.jsx)(Nn, { requiredBrowserExtensions: d })), (t[8] = d), (t[9] = m));
  let h;
  t[10] !== p || t[11] !== m
    ? ((h = (0, $.jsxs)(Ke, {
  ...
  t[13] !== o || t[14] !== s || t[15] !== c || t[16] !== l
    ? ((g = (0, $.jsx)(yn, { onOpenChange: o, onTryInChat: s, onViewDetails: c, plugin: l })),
      (t[13] = o),
      (t[14] = s),
      (t[15] = c),
      (t[16] = l),
...
function vn(e) {
  ...
  t[5] !== n.logoPath || t[6] !== a
    ...
    : (s = t[7]);
  let c;
  t[8] === n ? (c = t[9]) : ((c = Ge(n)), (t[8] = n), (t[9] = c));
  let l;
  t[10] === c
    ? (l = t[11])
    : ((l = (0, $.jsx)(G, {
...
function yn(e) {
  let t = (0, Q.c)(14),
    ...
    s;
  t[0] === o ? (s = t[1]) : ((s = He(o)), (t[0] = o), (t[1] = s));
  let c = s;
...
function bn(e) {
  let t = (0, Q.c)(37),
    ...
    p;
  t[0] === l ? (p = t[1]) : ((p = qn(l)), (t[0] = l), (t[1] = p));
  let m = p,
    h;
  ...
  let g = h,
    ...
    y;
  t[4] !== l || t[5] !== v
    ? ((y = v ? (0, $.jsx)(Vn, { plugin: l }) : null), (t[4] = l), (t[5] = v), (t[6] = y))
    : (y = t[6]);
  let b;
  t[7] !== m || t[8] !== v
    ? ((b =
  ...
  t[10] !== i || t[11] !== l || t[12] !== u || t[13] !== v
    ? ((x = v && u != null ? (0, $.jsx)(Sn, { hostId: i, plugin: l, pluginDetail: u }) : null),
      (t[10] = i),
      (t[11] = l),
      (t[12] = u),
      (t[13] = v),
  ...
  t[15] !== a || t[16] !== c || t[17] !== u || t[18] !== v || t[19] !== f
    ? ((S = v && u != null && f ? (0, $.jsx)(On, { enabled: a, onChange: c }) : null),
      (t[15] = a),
      (t[16] = c),
      (t[17] = u),
      (t[18] = v),
        ...
        v && g.length > 0
          ? (0, $.jsxs)(Un, {
              children: [
                ...
                (0, $.jsx)(`div`, { className: `flex flex-wrap gap-2`, children: g.map(xn) }),
              ],
            })
          : null),
      (t[21] = g),
    ...
    t[4] !== n || t[5] !== r || t[6] !== s
      ? ((c = (0, $.jsx)(Un, {
          children: (0, $.jsxs)(`div`, {
            ...
            children: [o, (0, $.jsx)(J, { checked: n, ariaLabel: s, onChange: r })],
          }),
        })),
        (t[4] = n),
        (t[5] = r),
...
function An(e) {
  ...
  if (i) {
    ...
    return (
      t[0] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = (0, $.jsx)(Un, { children: (0, $.jsx)(In, {}) })), (t[0] = e))
        : (e = t[0]),
      e
    );
  }
...
function jn(e) {
  let t = (0, Q.c)(23),
    ...
    s = O(),
    c;
  t[0] === r ? (c = t[1]) : ((c = new Map(r?.map(Mn))), (t[0] = r), (t[1] = c));
  let l = c,
    u,
    d,
    f;
        ...
        ? ((p = (e) => {
            ...
            return (0, $.jsx)(
              St,
              {
                ...
                installActionLabel: zn(e.status, s),
...
function Nn(e) {
  ...
  let r;
  t[0] === n ? (r = t[1]) : ((r = n.map(Pn)), (t[0] = n), (t[1] = r));
  let i;
  return (
    t[2] === r
      ? (i = t[3])
          ...
          children: [
            (0, $.jsx)(`span`, {
              ...
              children: (0, $.jsx)(Fe, {
                ...
                fallback: (0, $.jsx)(je, { className: `icon-md text-token-text-secondary` }),
                logoUrl: e.iconUrl,
              }),
            }),
            (0, $.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, $.jsx)(`div`, {
                  ...
                  children: (0, $.jsx)(k, { ...Gt.codexChromeDescription }),
                }),
              ],
            }),
          ],
...
function In() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, $.jsx)(`div`, { children: Array.from({ length: 3 }).map(Ln) })), (e[0] = t))
      : (t = e[0]),
    t
  );
}
              ...
              children: [
                (0, $.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, $.jsx)(`div`, { children: Wn(e.blurb.description) }),
                  ],
                }),
                (0, $.jsx)(J, {
          ...
          (0, $.jsxs)(
            `div`,
            {
              ...
              children: [
                ...
                (0, $.jsx)(`div`, { children: Wn(e.description) }),
              ],
            },
            `${e.title}-${t}`,
          )),
...
function Vn(e) {
  let t = (0, Q.c)(14),
    { plugin: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = Ge(n)), (t[0] = n), (t[1] = r));
  let i;
  t[2] === r
    ? (i = t[3])
    : ((i = (0, $.jsx)(`div`, {
  ...
  t[6] !== i || t[7] !== a
    ...
    : (o = t[8]);
  let s;
  t[9] === n ? (s = t[10]) : ((s = (0, $.jsx)(Hn, { plugin: n })), (t[9] = n), (t[10] = s));
  let c;
  return (
    t[11] !== o || t[12] !== s
      ? ((c = (0, $.jsxs)(Un, { children: [o, s] })), (t[11] = o), (t[12] = s), (t[13] = c))
      : (c = t[13]),
    c
  );
}
...
function Wn(e) {
  ...
  for (; (r = nn.exec(e)) != null; ) {
    ...
    (t.push((0, $.jsx)(Fn, { url: s, children: a }, `${s}-${r.index}`)), (n = r.index + i.length));
  }
...
function Kn({ draftModes: e, personalizationToggles: t }) {
  let n = { ...e };
  if (t == null) return n;
...
function Jn(e) {
  return e.interface?.displayName?.trim() || z(e.name.split(`:`).pop() || e.name);
}
var Yn = 55,
  Xn = 90;
function Zn({ forceReloadPlugins: e, hostId: t }) {
  let n = a(o),
    i = O(),
    s = Ne(),
    c = f(),
    g = _e(t),
    _ = n.query.snapshot(nt),
    v = oe(),
    [, y] = d(`composer_prefill`),
    b = X(),
    x = ae(`2761268526`),
    { data: S } = r(se, t),
    { clearPendingAppConnect: T, isAppConnectPending: ee, markAppConnectOAuthPending: te } = et(),
    {
      claimPluginInstall: E,
      closePluginInstallAppConnect: ne,
      closePluginInstall: k,
      markRequiredAppStatus: A,
      openPluginInstallDetails: j,
      openPluginInstall: M,
      openRequiredAppConnect: re,
      session: N,
      setPluginInstallProgress: P,
      setPluginInstallNeedsApps: ie,
    } = Re(),
    { data: I = [], hardRefetchAppsList: z } = Te({
      enabled: N.kind === `needsApps` || N.kind === `connectApp`,
      hostId: t,
    }),
    B =
      N.kind === `needsApps` || N.kind === `connectApp` ? N.requiredApps.map((e) => e.app) : void 0,
    V = N.kind === `details` || N.kind === `installing` ? N.plugin : null,
    H = V == null || (V.marketplacePath == null && V.plugin.remotePluginId == null) ? null : Se(V),
    { blockedReasonsByConnectorId: U } = pe({ hostId: t, pluginApps: B }),
    { blockedReason: W, isLoading: ce } = pe(
      V == null
        ? { hostId: t }
        : H == null
          ? { hostId: t, pluginSummary: V.plugin }
          : { hostId: t, ...H, pluginSummary: V.plugin },
    ),
    G = de({ hostId: t }),
    le = fe({ hostId: t }),
    K = ue({ hostId: t }),
    ...
    J = le.available,
    he = K.available,
    [ge, ve] = (0, ht.useState)(!1),
    xe = p({
      mutationFn: async (e) => {
        let n = await u(`install-plugin`, { hostId: t, ...Se(e) });
        return (
          await Ue({ hostId: t, marketplacePath: e.marketplacePath, pluginName: e.plugin.name }), n
        );
      },
    }),
    we = ge || xe.isPending,
    Ee = we || N.kind === `installing`,
    De = Qn({ apps: I, appInstallBlockedReasonsById: U, isAppConnectPending: ee, session: N }),
    Oe =
      De.kind === `needsApps` &&
      De.requiredBrowserExtensions.length === 0 &&
      De.requiredApps.length > 0 &&
      De.requiredApps.every((e) => e.status === `connected`),
    ke = (0, ht.useEffectEvent)((e, t) => {
      if (t != null) {
        b({ prefillPrompt: e, prefillCwd: t.prefillCwd, startInSidebar: t.startInSidebar });
        return;
      }
      y({ text: e });
    }),
    Ae = (0, ht.useEffectEvent)((t) => {
      k();
      let r = t.postInstallComposerPrefill?.trim();
      (r && ke(r, t.postInstallNewConversation),
        n
          .get(F)
          .success(
            i.formatMessage(
  ...
  (0, ht.useEffect)(() => {
    !Oe || De.kind !== `needsApps` || Ae(De);
  }, [Oe, De]);
  let je = (e) => !((!q && ye(e.plugin.id)) || (!J && Ce(e.plugin.id)) || (!he && be(e.plugin.id))),
    Me = async ({ installLockedComputerUse: r = !1, options: a, plugin: o }) => {
      if (we || ce || !je(o)) {
        k();
        return;
      }
      ve(!0);
      try {
        if (me(o.plugin) || W === `disabled-by-admin`) {
          j(o, a);
          return;
        }
        let s;
        try {
          ((s = await xe.mutateAsync(o)),
            P(Yn),
            a.origin === `setup_codex` &&
              l(
                n,
                L.CODEX_ONBOARDING_WIZARD_PHASE_PLUGIN_INSTALL,
                R.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED,
              ));
        } catch (e) {
          let t =
          ...
          (h.error(`manual_plugin_install_failed`, {
            safe: { ...C(t), errorCategory: D(e) },
            sensitive: { ...w(t), error: e },
          }),
            n
              .get(F)
              .danger(
        ...
        let d = Ve(o.plugin.id);
        if (
          (d != null &&
            (await qe(n, d, !1),
            await u(`batch-write-config-value`, {
              hostId: t,
              edits: Be({ pluginId: o.plugin.id, enabled: !0 }),
        ...
        (e().catch((e) => {
          (h.error(`Failed to refresh plugins after install`, {
            safe: {},
            sensitive: { error: e },
          }),
            n
        ...
        if (
          ...
          s.authPolicy === `ON_USE` || (s.appsNeedingAuth.length === 0 && f.length === 0))
        ) {
          let e = a.postInstallComposerPrefill?.trim();
          (e && ke(e, a.postInstallNewConversation), k());
          return;
        }
        ie({
          ...
          browserExtensions: f,
          connectingAppId:
            s.authPolicy === `ON_INSTALL` && s.appsNeedingAuth.length === 1 && f.length === 0
    ...
    Pe = (0, ht.useEffectEvent)((e) => {
      E({ hostId: t, pluginId: e.plugin.plugin.id }) &&
        Me({
          options: {
            origin: e.origin,
  ...
  return (
    (0, ht.useEffect)(() => {
      N.kind !== `installing` || N.installStarted || ce || Pe(N);
    }, [ce, N]),
    {
      closePluginInstall: () => {
        if (!Ee) {
          if ((xe.reset(), N.kind === `connectApp`)) {
            ne();
            return;
          }
          k();
      ...
      connectRequiredApp: async (e) => {
        if (De.kind !== `needsApps`) return;
        let t = De.requiredApps.find((t) => t.appId === e);
        if (
          t == null ||
          U[e] != null ||
          t.status === `connected` ||
      ...
      handleRequiredAppConnected: async (e) => {
        A({ appId: e, status: `connected` });
        try {
          await Z({ hostId: t, queryClient: c, refreshAppsList: z });
        } catch (e) {
      ...
      handleRequiredAppOAuthStarted: ({ app: e, redirectUrl: n }) => {
        (A({ appId: e.id, status: `waitingForCallback` }),
          te({
            app: e,
            hostId: t,
            redirectUrl: n,
        ...
        N.kind === `details` &&
          (await Me({
            ...
            options: {
              ...
              postInstallNewConversation: N.postInstallNewConversation,
            },
            plugin: N.plugin,
          }));
      },
      ...
      openPluginInstall: (e, n = {}) => {
        Ee || !je(e) || (xe.reset(), M(t, e, n));
      },
      session: De,
    }
  );
}
function Qn({ apps: e, isAppConnectPending: t, appInstallBlockedReasonsById: n, session: r }) {
  ...
  let a = r.requiredApps.map((e) =>
    $n({ appInstallBlockedReasonsById: n, appsById: i, isAppConnectPending: t, requiredApp: e }),
  );
