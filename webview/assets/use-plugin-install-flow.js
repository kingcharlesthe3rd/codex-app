...
import { Ts as c, Yi as l, js as u, ms as d } from "./app-server-manager-signals.js";
import {
  _ as f,
  f as p,
  g as m,
...
import { Fi as S, Zi as C, na as w, or as T, rr as ee } from "./src-1.js";
import { c as te, o as E, r as D } from "./lib.js";
import { $t as ne, Qt as re } from "./persisted-signal.js";
import { t as O } from "./clsx-Cir5-jBH.js";
import { t as k } from "./button-DO-oxX3-.js";
import { t as ie } from "./use-reduced-motion-1.js";
import { t as ae } from "./spinner.js";
import { t as A } from "./check-md.js";
import { t as oe } from "./tooltip.js";
import { N as j } from "./rpc-1.js";
import { f as M, o as N } from "./statsig.js";
import { t as P } from "./request.js";
import { t as F } from "./format-skill-title.js";
import { t as I } from "./invalidate-queries-and-broadcast.js";
import { c as L, w as R } from "./config-queries.js";
import { r as z } from "./remote-connection-visibility.js";
import { t as se } from "./use-auth.js";
import { t as B } from "./use-codex-home.js";
import { r as V } from "./toast-signal.js";
import { t as ce } from "./chevron.js";
import { f as le } from "./chunk-109.js";
import { p as H } from "./codex-api.js";
import { c as U, l as W, y as ue } from "./apps-queries.js";
import { t as G } from "./connector-logo.js";
...
import { n as Ee, t as De } from "./filesystem-media-src.js";
import { d as Oe, l as ke, n as Ae } from "./dialog-layout.js";
import { t as je } from "./use-skills-J.js";
import { n as Me } from "./use-start-new-conversation-jDp-QANK.js";
...
import { t as Be } from "./upgrade-plan-dialog-launcher.js";
import { m as Y } from "./links.js";
import { t as Ve } from "./use-codex-pricing-url.js";
import { c as He } from "./plan-management-state.js";
import { t as Ue } from "./badge.js";
import { r as We, t as Ge } from "./dropdown.js";
import { n as Ke, t as qe } from "./check-plugin-availability.js";
...
var ct = a(
    ...
    (e, { get: t }) =>
      ...
      it({
        ...
        slingshotEnabled: t(M, `1042620455`),
      }) &&
      t(L, { hostId: e }).data?.requirements?.computerUse?.allowLockedComputerUse !== !1,
  ),
  Q = n(),
  lt = (e) =>
    (0, Q.jsxs)(`svg`, {
...
function dt(e) {
  ...
  let ie = S ? `true` : void 0,
    ...
    oe = _ === `inline` && `gap-2`,
    j;
  t[12] === oe ? (j = t[13]) : ((j = O(`flex items-center gap-3`, oe)), (t[12] = oe), (t[13] = j));
  let M = x === `outside` ? D : null,
    N = T ? `items-center gap-3` : null,
    P;
  t[14] === N ? (P = t[15]) : ((P = O(`flex min-w-0 flex-1`, N)), (t[14] = N), (t[15] = P));
  let F = _ === `stacked` ? `flex-col` : `items-center gap-3`,
    I;
  t[16] !== a || t[17] !== F
    ? ((I = O(`flex min-w-0 flex-1 justify-center gap-0.5`, F, a)),
      (t[16] = a),
      (t[17] = F),
      (t[18] = I))
    : (I = t[18]);
  let L = _ === `inline` && `w-28 shrink-0 sm:w-48`,
    R = T || x === `inline` ? null : `justify-between`,
    z;
  t[19] !== L || t[20] !== R
    ? ((z = O(`flex min-w-0 items-center gap-2`, L, R)), (t[19] = L), (t[20] = R), (t[21] = z))
    : (z = t[21]);
  let se = x === `inline` ? D : null,
    B;
  t[22] === r
    ? (B = t[23])
    : ((B = (0, Q.jsx)(`div`, {
  ...
  let le = T ? null : te,
    H;
  t[29] !== z || t[30] !== se || t[31] !== ce || t[32] !== le
    ? ((H = (0, Q.jsxs)(`div`, { className: z, children: [se, ce, le] })),
      (t[29] = z),
      (t[30] = se),
      (t[31] = ce),
      (t[32] = le),
  ...
  t[34] !== i || t[35] !== o || t[36] !== _
    ...
    : (U = t[37]);
  let W;
  t[38] !== I || t[39] !== H || t[40] !== U
    ? ((W = (0, Q.jsxs)(`div`, { className: I, children: [H, U] })),
      (t[38] = I),
      (t[39] = H),
      (t[40] = U),
      (t[41] = W))
  ...
  let ue = T ? te : null,
    G;
  t[42] !== P || t[43] !== W || t[44] !== ue
    ? ((G = (0, Q.jsxs)(`div`, { className: P, children: [W, ue] })),
      (t[42] = P),
      (t[43] = W),
      (t[44] = ue),
      (t[45] = G))
    : (G = t[45]);
  let K;
  t[46] !== j || t[47] !== M || t[48] !== G
    ? ((K = (0, Q.jsxs)(`div`, { className: j, children: [M, G] })),
      (t[46] = j),
      (t[47] = M),
      (t[48] = G),
      (t[49] = K))
...
function mt(e) {
  let t = (0, Z.c)(47),
    ...
    M;
  t[0] !== h || t[1] !== j
    ? ((M = h ?? j.formatMessage($.connectApp)), (t[0] = h), (t[1] = j), (t[2] = M))
    : (M = t[2]);
  let N = M,
    P = n.isEnabled,
    ...
    L;
  t[3] !== T || t[4] !== j
    ? ((L = T == null ? null : j.formatMessage($.connectedTo, { email: T })),
      (t[3] = T),
      (t[4] = j),
      (t[5] = L))
    : (L = t[5]);
                  ...
                  children: [
                    ...
                    (0, Q.jsx)(oe, {
                      ...
                      children: (0, Q.jsx)(`button`, {
                        ...
                        "aria-label": R,
                        onClick: yt,
                        children: (0, Q.jsx)(fe, { className: `icon-2xs` }),
                      }),
                    }),
                  ],
                },
  ...
  t[9] === u
    ? (B = t[10])
    : ((B = O(`group justify-center border-none`, u)), (t[9] = u), (t[10] = B));
  let V;
  t[11] !== n || t[12] !== r
    ? ((V =
        r ??
  ...
  t[14] === n.description
    ? (le = t[15])
    : ((le = n.description ?? (0, Q.jsx)(E, { ...$.noDescription })),
      (t[14] = n.description),
      (t[15] = le));
  let H;
  t[16] !== n || t[17] !== x
    ...
    ? ((U =
        F && l != null
          ...
          : n.isAccessible && D === `toggle`
                    ...
                    : (0, Q.jsx)(`div`, {
                        ...
                        children: (0, Q.jsx)(oe, {
                          ...
                          children: (0, Q.jsx)(k, {
                            color: `ghost`,
                            size: `icon`,
                            "aria-label": j.formatMessage($.manageOnChatGpt),
                            onClick: (e) => {
                              (e.stopPropagation(), S?.(ue(n)));
                            },
                            children: (0, Q.jsx)(Te, { className: `icon-sm` }),
                          }),
                        }),
                      }),
                  re === `menu`
                    ...
                    : (0, Q.jsx)(oe, {
                        ...
                        children: (0, Q.jsx)(`div`, {
                          ...
                          children: (0, Q.jsx)(Ye, {
                            ...
                            ariaLabel: j.formatMessage($.enableToggleAria),
                          }),
                        }),
                      }),
                ],
            ...
            : n.isAccessible
              ? (0, Q.jsx)(ut, {
                  ariaLabel: j.formatMessage(P ? $.enabledStatus : $.disabledStatus),
                  icon: P
                    ? (0, Q.jsx)(A, { className: `icon-sm` })
                ...
                ? (0, Q.jsx)(oe, {
                    ...
                    children: (0, Q.jsx)(`div`, {
                      children: (0, Q.jsx)(k, {
                        ...
                        size: `toolbar`,
                        disabled: F || ne,
                        "aria-label": _ ? j.formatMessage($.connectingApp) : N,
                        onClick: (e) => {
                          (e.stopPropagation(), !F && b(n));
                        },
                        children: _ ? (0, Q.jsx)(ae, { className: `icon-xxs` }) : N,
                      }),
                    }),
                  })
                : null),
  ...
  return x({
    queryKey:
      e == null
        ...
        : y(`chrome-extension-installed-read`, { extensionId: e }),
    queryFn: async () =>
      e == null
        ? { installed: !1 }
        : _(`chrome-extension-installed-read`, { params: { extensionId: e } }),
...
function St(e) {
  ...
  let a;
  t[2] !== r || t[3] !== i
    ? ((a = { enabled: r, refetchOnWindowFocus: !0, staleTime: b.FIVE_SECONDS, ...i }),
      (t[2] = r),
      (t[3] = i),
      (t[4] = a))
    : (a = t[4]);
  let { data: o, isLoading: s } = f(a),
    c;
  t[5] === o ? (c = t[6]) : ((c = xt(o)), (t[5] = o), (t[6] = c));
  let l = n != null && s,
    u;
  return (
    t[7] !== c || t[8] !== l
...
var Ct = `assets/google-chrome.png`,
  ...
  Et = S([`chrome`, `chrome-dev`, `chrome-internal`]),
  Dt = C({ extensionId: w().trim().min(1) });
async function Ot({ codexHome: e, hostId: t, plugin: n, queryClient: r }) {
  try {
    ...
    return await r.fetchQuery({
      queryFn: async () => {
        let t = await _(`read-file`, { params: a });
        return [
          Pt({
            codexHome: e,
    ...
    return (
      g.warning(`Failed to read plugin browser extension setup`, {
        safe: {},
...
function kt(e) {
  ...
  t[8] !== a || t[9] !== o || t[10] !== r || t[11] !== i
    ? ((u = async () => {
        ...
        let e = await _(`read-file`, { params: { hostId: r, path: o } });
        return [
          Pt({
            codexHome: a,
  ...
  t[13] !== s || t[14] !== c || t[15] !== u
    ? ((d = { enabled: s, queryKey: c, queryFn: u, retry: !1, staleTime: b.INFINITE }),
      (t[13] = s),
      (t[14] = c),
      (t[15] = u),
      (t[16] = d))
...
async function At({
  ...
  let o = await Ot({
    codexHome: t ?? (await _(`codex-home`, { params: { hostId: n } })).codexHome,
    hostId: n,
...
async function jt({ hostId: e, plugin: t }) {
  try {
    ...
    return (
      g.warning(`Failed to read installed plugin browser extension setup`, {
        safe: {},
...
function Wt(e) {
  let t = (0, Z.c)(8),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, Q.jsx)(A, { className: `icon-sm mt-0.5 shrink-0 text-token-text-secondary` })),
      (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === r
...
function Qt(e) {
  let t = (0, Z.c)(143),
    ...
    g = r === void 0 ? !1 : r,
    _ = o(s),
    [y, x] = (0, ot.useState)(null),
    [S, C] = (0, ot.useState)(null),
    { platform: w } = he(),
    { authMethod: T, planAtLogin: ee } = se(),
    { data: te } = H(),
    D = T === `chatgpt`,
    ne;
  t[0] === D ? (ne = t[1]) : ((ne = { queryConfig: { enabled: D } }), (t[0] = D), (t[1] = ne));
  let { data: re } = v(`account-info`, ne),
    O = te?.plan_type ?? re?.plan ?? ee,
    ie;
  t[2] === O ? (ie = t[3]) : ((ie = He(O)?.pricePlan ?? null), (t[2] = O), (t[3] = ie));
  let ae = ie,
    A;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = { logExposure: !0 }), (t[4] = A))
    : (A = t[4]);
  let j = Ve(A),
    M = Be(),
    N = i(ct, n),
    P = h.kind === `closed` ? null : h.plugin,
    F;
  t[5] !== h.kind || t[6] !== h.requiredApps
    ? ((F = h.kind === `needsApps` ? h.requiredApps.map(an) : void 0),
      (t[5] = h.kind),
      (t[6] = h.requiredApps),
      (t[7] = F))
    : (F = t[7]);
  let I = F,
    L;
  t[8] !== n || t[9] !== I || t[10] !== h.kind || t[11] !== h.plugin
    ? ((L = h.kind === `details` ? { hostId: n, ...Se(h.plugin) } : { hostId: n, pluginApps: I }),
      (t[8] = n),
      (t[9] = I),
      (t[10] = h.kind),
      (t[11] = h.plugin),
      (t[12] = L))
    : (L = t[12]);
  let { blockedReasonsByConnectorId: R, blockedReason: z, isLoading: B } = Ke(L),
    V = P != null && qe(P.plugin),
    ce = h.kind === `details` ? z : null,
    le = h.kind === `details` && B,
    U = V ? `disabled-by-admin` : ce,
    W = U != null,
    ue = U === `disabled-by-admin`,
    G = P?.marketplacePath ?? null,
    K;
  t[13] === P ? (K = t[14]) : ((K = P == null ? null : we(P)), (t[13] = P), (t[14] = K));
  let de = P?.remoteMarketplaceName ?? null,
    fe = P != null,
    pe;
  ...
  let { plugin: me } = Je(pe),
    ...
    q,
    Ee;
  t[21] !== R || t[22] !== ge || t[23] !== h.kind || t[24] !== h.plugin
    ? ((_e = ge?.filter((e) => R[e.id] !== `disabled-by-admin`)),
      (be = h.kind === `details` && h.plugin.plugin.authPolicy === `ON_INSTALL`),
    ...
    : ((_e = t[25]),
      ...
      (Ee = t[32]));
  let De;
  t[33] !== xe || t[34] !== Ce || t[35] !== Te || t[36] !== q
    ? ((De = [xe, Ce, Te, q]), (t[33] = xe), (t[34] = Ce), (t[35] = Te), (t[36] = q), (t[37] = De))
    : (De = t[37]);
  let Oe = be && ve && !B,
    je;
  t[38] === _e
    ...
    : ((je = async () => {
        ...
        let e = await Promise.all(_e.map(nn));
        return { blurbs: Rn(e.flatMap(tn)), personalizationToggles: e.flatMap(en) };
      }),
      (t[38] = _e),
      (t[39] = je));
  let Me;
  t[40] !== De || t[41] !== Oe || t[42] !== je
    ? ((Me = { queryKey: De, enabled: Oe, staleTime: b.FIVE_MINUTES, queryFn: je }),
      (t[40] = De),
      (t[41] = Oe),
      (t[42] = je),
      (t[43] = Me))
  ...
  t[44] !== g || t[45] !== l
    ...
    : (Fe = t[46]);
  let Ie = Fe;
  if (h.kind === `closed`) return null;
  if (h.kind === `connectApp`) {
    let e;
    t[47] === h.app ? (e = t[48]) : ((e = Nn(h.app)), (t[47] = h.app), (t[48] = e));
    let n;
    t[49] !== u || t[50] !== h.app.appId
      ? ((n = async () => {
          await u(h.app.appId);
        }),
        (t[49] = u),
    ...
    return (
      t[52] !== l || t[53] !== d || t[54] !== e || t[55] !== n
        ? ((r = (0, Q.jsx)(Le, { app: e, onOpenChange: l, onConnected: n, onOAuthStarted: d })),
          (t[52] = l),
          (t[53] = d),
          (t[54] = e),
          (t[55] = n),
  ...
  if (h.kind === `installing`) {
    let e;
    return (
      t[57] !== Ie || t[58] !== h.plugin
        ? ((e = (0, Q.jsx)(on, { onOpenChange: Ie, plugin: h.plugin })),
          (t[57] = Ie),
          (t[58] = h.plugin),
          (t[59] = e))
        : (e = t[59]),
  ...
  let J = h.kind === `needsApps` ? `needsApps` : `details`,
    Y = h.plugin,
    Ue,
    We,
    Ge,
  ...
  if (
    ...
    Ue = y?.pluginId === Y.plugin.id ? y.modes : {};
    let e;
    (t[72] !== N || t[73] !== J || t[74] !== w || t[75] !== Y.plugin.id
      ? ((e = J === `details` && w === `macOS` && N && ye(Y.plugin.id)),
        (t[72] = N),
        (t[73] = J),
        (t[74] = w),
        (t[75] = Y.plugin.id),
      ...
      : (e = t[76]),
      (Ge = e),
      (We = S?.pluginId === Y.plugin.id ? S.enabled : !0),
      (Ye = zn({
        draftModes: Ue,
        personalizationToggles: be ? Ne?.personalizationToggles : void 0,
      })),
      (t[60] = N),
      (t[61] = Ne?.personalizationToggles),
      (t[62] = S),
      ...
      (t[70] = Ge),
      (t[71] = Ye));
  } else ((Ue = t[68]), (We = t[69]), (Ge = t[70]), (Ye = t[71]));
  let Ze = Ye,
    Qe = be && ve && (B || Pe),
    $e;
  t[77] !== U || t[78] !== Y.plugin.name
    ? (($e = Bt(Y.plugin.name, U)), (t[77] = U), (t[78] = Y.plugin.name), (t[79] = $e))
    : ($e = t[79]);
  let X = $e,
    et;
  ...
  t[106] !== tt ||
  t[107] !== h.kind ||
  t[108] !== h.requiredApps ||
  t[109] !== h.requiredBrowserExtensions ||
  t[110] !== be ||
  t[111] !== Ge
    ? ((dt =
        J === `needsApps`
          ? (0, Q.jsx)(un, {
              appInstallBlockedReasonsById: R,
              appOrder: ge?.map($t),
              isAppBlockedReasonLoading: B,
              onConnectRequiredApp: a,
              onOpenChange: Ie,
              onTryInChat: p,
              onViewDetails: m,
              plugin: Y,
              requiredApps: h.kind === `needsApps` ? h.requiredApps : [],
              requiredBrowserExtensions: h.kind === `needsApps` ? h.requiredBrowserExtensions : [],
            })
          : J === `details`
            ? (0, Q.jsx)(ze, {
                ...
                children:
                  tt == null
                    ? (0, Q.jsx)(pn, {
                        ...
                        disclosureData: be ? Ne : void 0,
                        hostId: n,
                        installLockedComputerUse: We,
                        isLoadingDisclosureData: Qe,
                        onAppPersonalizationModeChange: (e) => {
                          let { appId: t, mode: n } = e;
                          x({ modes: { ...Ue, [t]: n }, pluginId: Y.plugin.id });
                        },
                        ...
                        plugin: Y,
                        pluginDetail: me,
                        shouldShowInstallDisclosure: be,
                        showLockedComputerUseInstall: Ge,
                      })
          ...
          ? (0, Q.jsx)(oe, {
              tooltipContent:
                U === `connector-unavailable` && !X
                  ...
                  : null,
              disabled: U !== `connector-unavailable` || X,
              children: (0, Q.jsx)(`div`, {
  ...
  t[131] !== at || t[132] !== st || t[133] !== ut || t[134] !== dt || t[135] !== ft
    ? ((pt = (0, Q.jsxs)(Ae, { className: at, style: st, children: [ut, dt, ft] })),
      (t[131] = at),
      (t[132] = st),
      (t[133] = ut),
      (t[134] = dt),
  ...
  let $;
  return (
    t[137] !== Ie || t[138] !== g || t[139] !== nt || t[140] !== it || t[141] !== pt
      ? (($ = (0, Q.jsx)(ke, {
          open: !0,
          onOpenChange: Ie,
...
async function nn(e) {
  return {
    app: e,
    connectorTos: await P.safeGet(`/aip/connectors/{connector_id}/tos`, {
...
function on(e) {
  ...
  t[4] !== r || t[5] !== d
    ...
    : (f = t[6]);
  let p;
  t[7] === r ? (p = t[8]) : ((p = Re(r)), (t[7] = r), (t[8] = p));
  let m;
  t[9] === p
    ? (m = t[10])
    : ((m = (0, Q.jsx)(Oe, {
...
function cn(e) {
  ...
  let s;
  t[4] === n ? (s = t[5]) : ((s = Re(n)), (t[4] = n), (t[5] = s));
  let c;
  t[6] === s
    ? (c = t[7])
    : ((c = (0, Q.jsx)(Oe, {
...
function ln(e) {
  ...
  t[3] === a
    ...
    : ((o = (0, Q.jsx)(`span`, { className: `flex items-center gap-1`, children: a })),
      ...
      (t[4] = o));
  let s;
  t[5] === r ? (s = t[6]) : ((s = Re(r)), (t[5] = r), (t[6] = s));
  let c;
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = (0, Q.jsx)(K, { className: `icon-md text-token-text-secondary` })), (t[7] = c))
    : (c = t[7]);
  let l;
...
function dn(e) {
  ...
  t[1] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (i = t[1]);
  let a;
  t[2] === n ? (a = t[3]) : ((a = Re(n)), (t[2] = n), (t[3] = a));
  let o;
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, Q.jsx)(K, { className: `icon-md text-token-text-secondary` })), (t[4] = o))
    : (o = t[4]);
  let s;
  t[5] !== n.logoPath || t[6] !== a
    ...
    : (s = t[7]);
  let c;
  t[8] === n ? (c = t[9]) : ((c = Re(n)), (t[8] = n), (t[9] = c));
  let l;
  t[10] === c
    ? (l = t[11])
    : ((l = (0, Q.jsx)(Oe, {
          ...
          children: [
            (0, Q.jsx)(`span`, {
              ...
              children: (0, Q.jsx)(G, {
                ...
                fallback: (0, Q.jsx)(K, { className: `icon-md text-token-text-secondary` }),
                logoUrl: e.iconUrl,
              }),
            }),
            (0, Q.jsxs)(`div`, {
...
function On(e) {
  ...
  t[4] === a
    ? (o = t[5])
    : ((o = (e) => {
        (e.preventDefault(), p.dispatchMessage(`open-in-browser`, { url: a }));
      }),
      (t[4] = a),
      (t[5] = o));
  let s;
...
function Vn(e) {
  return e.interface?.displayName?.trim() || F(e.name.split(`:`).pop() || e.name);
}
function Hn({ forceReloadPlugins: e, hostId: t }) {
  let n = o(s),
    ...
    c = h(),
    f = B(t),
    _ = n.query.snapshot(tt),
    v = I(),
    [, y] = d(`composer_prefill`),
    b = Me(),
    x = N(`2761268526`),
    { data: S } = i(R, t),
    { clearPendingAppConnect: C, isAppConnectPending: w, markAppConnectOAuthPending: T } = X(),
    {
      claimPluginInstall: ee,
      closePluginInstallAppConnect: E,
      closePluginInstall: D,
      markRequiredAppStatus: O,
      openPluginInstallDetails: k,
      openPluginInstall: ie,
      openRequiredAppConnect: ae,
      session: A,
      setPluginInstallNeedsApps: oe,
    } = me(),
    { data: j = [], hardRefetchAppsList: M } = U({
      enabled: A.kind === `needsApps` || A.kind === `connectApp`,
      hostId: t,
    }),
    P = W({ apps: j, enabled: A.kind === `needsApps` || A.kind === `connectApp` }) ?? j,
    F =
      A.kind === `needsApps` || A.kind === `connectApp` ? A.requiredApps.map((e) => e.app) : void 0,
    L = A.kind === `details` || A.kind === `installing` ? A.plugin : null,
    { blockedReasonsByConnectorId: z } = Ke({ hostId: t, pluginApps: F }),
    { blockedReason: se, isLoading: ce } = Ke(L == null ? { hostId: t } : { hostId: t, ...Se(L) }),
    H = ge({ hostId: t }),
    ue = _e({ hostId: t }),
    G = ve({ hostId: t }),
    K = H.available,
    de = ue.available,
    fe = G.available,
    [pe, he] = (0, ot.useState)(!1),
    xe = m({
      mutationFn: async (e) => {
        let n = await u(`install-plugin`, { hostId: t, ...Se(e) });
        return (
          await Ie({ hostId: t, marketplacePath: e.marketplacePath, pluginName: e.plugin.name }), n
        );
      },
    }),
    we = pe || xe.isPending,
    Te = we || A.kind === `installing`,
    q = Un({ apps: P, appInstallBlockedReasonsById: z, isAppConnectPending: w, session: A }),
    Ee =
      q.kind === `needsApps` &&
        ...
        n
          ...
          .success(
            r.formatMessage(
              ...
              { pluginName: Re(t.plugin) },
            ),
          ),
        e().catch((e) => {
          g.error(`Failed to refresh plugins after plugin app setup`, {
            safe: {},
            sensitive: { error: e },
          });
        }));
  ...
  let ke = (e) =>
      !((!K && ye(e.plugin.id)) || (!de && Ce(e.plugin.id)) || (!fe && be(e.plugin.id))),
    Ae = (e) => {
      n.get(V).success(
        r.formatMessage(
          {
    ...
    Fe = async ({ installLockedComputerUse: i = !1, options: a, plugin: o }) => {
      if (we || ce || !ke(o)) {
        D();
        return;
      }
      he(!0);
      try {
        if (qe(o.plugin) || se === `disabled-by-admin`) {
          k(o, a);
          return;
        }
        let s;
        try {
          ((s = await xe.mutateAsync(o)),
            a.origin === `setup_codex` &&
              l(
                n,
                ne.CODEX_ONBOARDING_WIZARD_PHASE_PLUGIN_INSTALL,
                re.CODEX_ONBOARDING_WIZARD_ACTION_COMPLETED,
              ));
        } catch (e) {
          (g.error(`Failed to install plugin`, { safe: {}, sensitive: { error: e } }),
            n
              .get(V)
              .danger(
                r.formatMessage({
        ...
        let d = Pe(o.plugin.id);
        if (
          (d != null &&
            (await J(n, d, !1),
            await u(`batch-write-config-value`, {
              hostId: t,
              edits: Ne({ pluginId: o.plugin.id, enabled: !0 }),
          ...
          try {
            ...
            (g.error(`Failed to enable Locked Computer Use after install`, {
              safe: {},
              sensitive: { error: t },
            }),
              (e = !0));
        ...
        (e().catch((e) => {
          (g.error(`Failed to refresh plugins after install`, {
            safe: {},
            sensitive: { error: e },
          }),
            n
          ...
          Promise.all([v(je), v(nt)]).catch((e) => {
            g.error(`Failed to refresh plugin skills and hooks after install`, {
              safe: {},
              sensitive: { error: e },
            });
          }));
        ...
        if (
          (Ae(o), s.authPolicy === `ON_USE` || (s.appsNeedingAuth.length === 0 && p.length === 0))
        ) {
          let e = a.postInstallComposerPrefill?.trim();
          (e && De(e, a.postInstallNewConversation), D());
          return;
        }
        oe({
          ...
          browserExtensions: p,
          connectingAppId:
            s.authPolicy === `ON_INSTALL` && s.appsNeedingAuth.length === 1 && p.length === 0
    ...
    Le = (0, ot.useEffectEvent)((e) => {
      ee({ hostId: t, pluginId: e.plugin.plugin.id }) &&
        Fe({
          options: {
            origin: e.origin,
  ...
  return (
    (0, ot.useEffect)(() => {
      A.kind !== `installing` || A.installStarted || ce || Le(A);
    }, [ce, A]),
    {
      closePluginInstall: () => {
        if (!Te) {
          if ((xe.reset(), A.kind === `connectApp`)) {
            E();
            return;
          }
          D();
      ...
      connectRequiredApp: async (e) => {
        ...
        if (!x && n) {
          p.dispatchMessage(`open-in-browser`, { url: n });
          return;
        }
        (C({ appId: e }), ae(e));
      },
      handleRequiredAppConnected: async (e) => {
        ...
        try {
          await $e({ hostId: t, queryClient: c, refreshAppsList: M });
        } catch (e) {
          g.error(`Failed to refresh apps after plugin app connect`, {
            safe: {},
            sensitive: { error: e },
          });
        }
