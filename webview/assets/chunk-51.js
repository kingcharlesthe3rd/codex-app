...
import { i as f, l as p, n as m } from "./chunk-56.js";
import { n as h, r as g } from "./chunk-130.js";
import { n as _, t as v } from "./chunk-147.js";
import { a as y, i as b, r as x, t as S } from "./chunk-134.js";
var C = n(async (t, n, r) => {
    let a,
    ...
    let l = t
      ...
      d;
    d = n.label === void 0 ? `` : typeof n.label == `string` ? n.label : n.label[0];
    let m = !!n.icon || !!n.img,
  ...
  w = n(async (t, n, r) => {
    ...
    if (u(o())) {
      let t = c.children[0],
        n = e(c);
      ((l = t.getBoundingClientRect()), n.attr(`width`, l.width), n.attr(`height`, l.height));
    }
    return (
      a
        ? s.attr(`transform`, `translate(` + -l.width / 2 + `, ` + -l.height / 2 + `)`)
...
var j = n((e, t) => {
  ...
  M = n(async (e, t, n, r = !1, i = !1) => {
    ...
    return await h(
      e,
      a,
      { style: n, isTitle: r, useHtmlLabels: c, markdown: !1, isNode: i, width: 1 / 0 },
      s,
    );
  }, `createLabel`),
  N = n(
  ...
  P = n(async (n, i) => {
    ...
    let a = o(),
      ...
      { labelStyles: f, nodeStyles: p, borderStyles: m, backgroundStyles: g } = b(i),
      v = n
        .insert(`g`)
    ...
    C =
      i.labelType === `markdown`
        ? await h(S, i.label, { style: i.labelStyle, useHtmlLabels: x, isNode: !0, width: i.width })
    ...
    if (i.look === `handDrawn`) {
      let e = t.svg(v),
        n = y(i, { roughness: 0.7, fill: l, stroke: d, fillWeight: 3, seed: c }),
        a = e.path(N(D, O, T, E, 0), n);
      ((k = v.insert(() => (r.debug(`Rough node insert CXC`, a), a), `:first-child`)),
    ...
    if ((S.attr(`transform`, `translate(${i.x - w.width / 2}, ${i.y - i.height / 2 + A})`), f)) {
      let e = S.select(`span`);
      e && e.attr(`style`, f);
    }
  ...
  F = {
    ...
    roundedWithTitle: n(async (n, r) => {
      ...
      let y = 0 * r.padding,
        b = y / 2,
        x = (r.width <= v.width + r.padding ? v.width + r.padding : r.width) + y;
      ...
      if (r.look === `handDrawn`) {
        ...
        ((D = m.insert(`rect`, `:first-child`)),
          D.attr(`class`, `outer`)
            ...
            .attr(`height`, S)
            .attr(`data-look`, r.look),
          g.attr(`class`, `inner`).attr(`x`, w).attr(`y`, E).attr(`width`, x).attr(`height`, C));
      return (
        h.attr(`transform`, `translate(${r.x - v.width / 2}, ${T + 1 - (u(i) ? 0 : 3)})`),
    ...
    divider: n((e, n) => {
      let { themeVariables: r, handDrawnSeed: i } = o(),
        { nodeBorder: a } = r,
        s = e.insert(`g`).attr(`class`, n.cssClasses).attr(`id`, n.domId).attr(`data-look`, n.look),
    ...
    kanbanSection: n(async (n, i) => {
      ...
      if (i.look === `handDrawn`) {
        let e = t.svg(v),
          n = y(i, { roughness: 0.7, fill: l, stroke: d, fillWeight: 4, seed: c }),
...
function H(e, t, n, r) {
  {
    ...
    let g = Math.abs(h / 2),
      _ = a * f - d * o,
      v = _ < 0 ? (_ - g) / h : (_ + g) / h;
    return ((_ = u * o - i * f), { x: v, y: _ < 0 ? (_ - g) / h : (_ + g) / h });
  }
}
n(H, `intersectLine`);
function re(e, t) {
...
async function ce(e, n) {
  ...
  if (n.look === `handDrawn`) {
    let e = t.svg(c),
      ...
      i = D(m),
      a = e.path(i, r);
    ((h = c.insert(() => a, `:first-child`).attr(`transform`, `translate(${-u / 2}, ${d / 2})`)),
      g && h.attr(`style`, g));
  } else h = q(c, u, d, m);
  return (
    i && h.attr(`style`, i),
...
function fe(e, n) {
  ...
  return (
    ...
    T(n, m),
    (n.intersect = function (e) {
      return (r.info(`crossedCircle intersect`, n, { radius: s, point: e }), W.circle(n, s, e));
    }),
    o
  );
}
...
var _e = n(
  ...
  ye = n(
    (e, t, n, r, i, a) => [`M${e - n / 2},${-r / 2}`, `a${i},${a} 0,0,0 ${n},0`].join(` `),
...
async function Se(e, n) {
  ...
  if (n.width || n.height) {
    ...
    let t = e / 2 / (2.5 + e / 50);
    ((n.height = (n.height ?? 0) - o - t * 3), n.height < be && (n.height = be));
  }
  ...
  return (
    ...
    (n.intersect = function (e) {
      ...
      if (
        ...
        let i = m * m * (1 - (r * r) / (f * f));
        (i > 0 && (i = Math.sqrt(i)), (i = m - i), e.y - (n.y ?? 0) > 0 && (i = -i), (t.y += i));
      }
      return t;
    }),
    c
...
async function we(e, n) {
  ...
  if (n.look === `handDrawn`) {
    ...
    (m.attr(`class`, `basic label-container`).attr(`style`, a),
      e.attr(`class`, `outer-circle`).attr(`style`, a).attr(`r`, d).attr(`cx`, 0).attr(`cy`, 0),
      t.attr(`class`, `inner-circle`).attr(`style`, a).attr(`r`, f).attr(`cx`, 0).attr(`cy`, 0));
  }
  return (
    T(n, m),
    (n.intersect = function (e) {
...
function Te(e, n, { config: { themeVariables: i } }) {
  ...
  return (
    ...
    c && c.length > 0 && n.look !== `handDrawn` && p.selectAll(`path`).attr(`style`, c),
    o && n.look !== `handDrawn` && p.selectAll(`path`).attr(`style`, o),
    T(n, p),
    (n.intersect = function (e) {
      return (r.info(`filledCircle intersect`, n, { radius: 7, point: e }), W.circle(n, 7, e));
    }),
    s
  );
}
...
function ke(e, n, { dir: r, config: { state: i, themeVariables: a } }) {
  ...
  r === `LR` && ((l = Math.max(10, n?.width ?? 0)), (u = Math.max(70, n?.height ?? 0)));
  let d = (-1 * l) / 2,
    f = (-1 * u) / 2,
    p = t.svg(s),
...
async function Ae(e, n) {
  ...
  return (
    ...
    T(n, x),
    (n.intersect = function (e) {
      return (r.info(`Pill intersect`, n, { radius: f, point: e }), W.polygon(n, g, e));
    }),
    c
  );
}
...
async function Me(e, n) {
  ...
  if (n.look === `handDrawn`) {
    let e = t.svg(l),
      ...
      i = je(0, 0, p, d, f),
      a = e.path(i, r);
    ((h = l.insert(() => a, `:first-child`).attr(`transform`, `translate(${-p / 2}, ${d / 2})`)),
      g && h.attr(`style`, g));
  } else h = q(l, p, d, m);
  return (
    i && h.attr(`style`, i),
...
async function Pe(e, n, { config: { themeVariables: i, flowchart: a } }) {
  ...
  let A = O.rectangle(w, E, _, h, k),
    ...
    M = h + f.height + D,
    N = O.rectangle(-j / 2, -M / 2, j, M, { ...k, fill: `transparent`, stroke: `none` }),
    P = d.insert(() => A, `:first-child`),
    F = d.insert(() => N);
  if (n.icon) {
    let e = d.append(`g`);
    e.html(`<g>${await g(n.icon, { height: l, width: l, fallbackPrefix: `` })}</g>`);
  ...
  return (
    ...
    P.attr(`transform`, `translate(0,${m ? f.height / 2 + D / 2 : -f.height / 2 - D / 2})`),
    T(n, F),
    (n.intersect = function (e) {
...
async function Fe(e, n, { config: { themeVariables: i, flowchart: a } }) {
  ...
  let D = d.append(`g`);
  n.icon && D.html(`<g>${await g(n.icon, { height: l, width: l, fallbackPrefix: `` })}</g>`);
  let O = D.node().getBBox(),
    ...
    I = N + f.height + m,
    ee = w.rectangle(-F / 2, -I / 2, F, I, { ...E, fill: `transparent`, stroke: `none` }),
  ...
  return (
    ...
    te.attr(`transform`, `translate(0,${h ? f.height / 2 + m / 2 : -f.height / 2 - m / 2})`),
    T(n, L),
    (n.intersect = function (e) {
...
async function Ie(e, n, { config: { themeVariables: i, flowchart: a } }) {
  ...
  let s = n.assetHeight ?? 48,
    ...
    u = a?.wrappingWidth;
  n.width = Math.max(l, u ?? 0);
  let { shapeSvg: d, bbox: f, halfPadding: p, label: m } = await C(e, n, `icon-shape default`),
    h = n.pos === `t`,
    _ = l + p * 2,
    v = l + p * 2,
  ...
  let M = A.path(N(D, O, v, _, 5), j),
    ...
    F = _ + f.height + k,
    I = A.rectangle(-P / 2, -F / 2, P, F, { ...j, fill: `transparent`, stroke: `none` }),
  ...
  return (
    ...
    ee.attr(`transform`, `translate(0,${h ? f.height / 2 + k / 2 : -f.height / 2 - k / 2})`),
    T(n, te),
    (n.intersect = function (e) {
      if ((r.info(`iconSquare intersect`, n, e), !n.label)) return W.rect(n, e);
      let t = n.x ?? 0,
...
async function Re(e, n, { config: { flowchart: i } }) {
  ...
  let u = Math.max(n.label ? (l ?? 0) : 0, n?.assetWidth ?? o),
    d = n.constraint === `on` && n?.assetHeight ? n.assetHeight * n.imageAspectRatio : u,
  ...
  let E = S.rectangle(_, v, d, f, w),
    ...
    O = f + m.height + x,
    k = S.rectangle(-D / 2, -O / 2, D, O, { ...w, fill: `none`, stroke: `none` }),
  ...
  return (
    ...
    A.attr(`transform`, `translate(0,${g ? m.height / 2 + x / 2 : -m.height / 2 - x / 2})`),
    T(n, j),
    (n.intersect = function (e) {
      if ((r.info(`iconSquare intersect`, n, e), !n.label)) return W.rect(n, e);
      let t = n.x ?? 0,
...
async function ze(e, n) {
  ...
  if (n.look === `handDrawn`) {
    let e = t.svg(c),
      ...
      i = D(f),
      a = e.path(i, r);
    ((p = c.insert(() => a, `:first-child`).attr(`transform`, `translate(${-u / 2}, ${d / 2})`)),
      m && p.attr(`style`, m));
  } else p = q(c, u, d, f);
  return (
    i && p.attr(`style`, i),
...
async function Be(e, n, r) {
  ...
  if ((r?.rx && r.ry && ((m = r.rx), (h = r.ry)), n.look === `handDrawn`)) {
    let e = t.svg(o),
      r = y(n, {}),
      i = m || h ? e.path(N(u, d, c, l, m || 0), r) : e.rectangle(u, d, c, l, r);
...
async function He(e, n) {
  ...
  if (n.look === `handDrawn`) {
    let e = t.svg(c),
      ...
      i = D(f),
      a = e.path(i, r);
    ((p = c.insert(() => a, `:first-child`).attr(`transform`, `translate(${-d / 2}, ${u / 2})`)),
      m && p.attr(`style`, m));
  } else p = q(c, d, u, f);
  return (
    i && p.attr(`style`, i),
...
async function Xe(e, n) {
  ...
  if (n.width || n.height) {
    ...
    let t = e / 2 / (2.5 + e / 50);
    ((n.height = (n.height ?? 0) - s - t * 3), n.height < Je && (n.height = Je));
  }
  let { shapeSvg: c, bbox: l, label: u } = await C(e, n, E(n)),
...
async function $e(e, n) {
  ...
  let { shapeSvg: a, bbox: o, label: s } = await C(e, n, E(n)),
    ...
    d = !0;
  (n.width || n.height) &&
    ((d = !1), (n.width = (n?.width ?? 0) - l * 2), (n.height = (n?.height ?? 0) - u * 3));
...
async function nt(e, n) {
  ...
  if (n.look === `handDrawn`) {
    ...
    ((u = a
      ...
      d && u.attr(`style`, d));
  } else ((u = q(a, s, s, l)), u.attr(`transform`, `translate(${-s / 2 + c}, ${s / 2})`));
  return (
    i && u.attr(`style`, i),
    T(n, u),
    (n.calcIntersect = function (e, t) {
...
async function it(n, i) {
  ...
  if (u(o())) {
    let t = h.children[0],
      n = e(h);
    ((g = t.getBoundingClientRect()), n.attr(`width`, g.width), n.attr(`height`, g.height));
  }
  r.info(`Text 2`, p);
  let _ = p || [],
    v = h.getBBox(),
    x = await M(f, Array.isArray(_) ? _.join(`<br/>`) : _, i.labelStyle, !0, !0),
    S = x.children[0],
    C = e(x);
  ((g = S.getBoundingClientRect()), C.attr(`width`, g.width), C.attr(`height`, g.height));
  let w = (i.padding || 0) / 2;
  (e(x).attr(
    `transform`,
    `translate( ` +
    ...
    e(h).attr(
      `transform`,
      `translate( ` + (g.width < v.width ? 0 : -(v.width - g.width) / 2) + `, 0)`,
    ),
    (g = f.node().getBBox()),
    f.attr(`transform`, `translate(` + -g.width / 2 + `, ` + (-g.height / 2 - w + 3) + `)`));
  ...
  if (i.look === `handDrawn`) {
    ...
    ((j = l.insert(() => (r.debug(`Rough node insert CXC`, a), o), `:first-child`)),
      (A = l.insert(() => (r.debug(`Rough node insert CXC`, a), a), `:first-child`)));
  } else
...
function dt(e, n, { config: { themeVariables: r } }) {
  ...
  ((n.width || n.height) &&
    ((n.width ?? 0) < 14 && (n.width = 14), (n.height ?? 0) < 14 && (n.height = 14)),
    (n.width ||= 14),
    (n.height ||= 14));
  let d = e
      .insert(`g`)
  ...
  let m = f.circle(0, 0, n.width, { ...p, stroke: s, strokeWidth: 2 }),
    h = c ?? l,
    g = ((n.width ?? 0) * 5) / 14,
    _ = f.circle(0, 0, g, { ...p, fill: h, stroke: h, strokeWidth: 2, fillStyle: `solid` }),
...
async function gt(e, n) {
  ...
  (n.width || n.height) &&
    ...
    (n.width = Math.max((n?.width ?? 0) - o * 2 - ht * (n.height + s * 2), 10)));
  let { shapeSvg: c, bbox: l } = await C(e, n, E(n)),
...
var yt = n(
  ...
  xt = n(
    (e, t, n, r, i, a) => [`M${e + n / 2},${-r / 2}`, `a${i},${a} 0,0,0 0,${r}`].join(` `),
    `createInnerCylinderPathD`,
  ),
  St = 5,
  Ct = 10;
...
async function Ft(n, r) {
  ...
  if (i.attributes.length === 0 && r.label) {
    let e = { rx: 0, ry: 0, labelPaddingX: h, labelPaddingY: h * 1.5, classes: `` };
    m(r.label, p) + e.labelPaddingX * 2 < p.er.minEntityWidth && (r.width = p.er.minEntityWidth);
        ...
        e &&
          ...
          i.attr(`class`).includes(`attribute-name`)
            ...
            : i.attr(`class`).includes(`attribute-keys`)
              ? (o += A + j)
              : i.attr(`class`).includes(`attribute-comment`) && (o += A + j + M));
      }
      i.attr(`transform`, `translate(${V + h / 2 + o}, ${s + H + w.height + g / 2})`);
    }),
    C.select(`.name`).attr(`transform`, `translate(` + -w.width / 2 + `, ` + (H + g / 2) + `)`),
    a != null && Nt.has(a))
  ) {
    let e = i.colorIndex ?? 0;
...
async function It(t, n, r, i = 0, a = 0, o = [], l = ``) {
  let u = t
    ...
    .attr(`style`, l);
  n !== c(n) && ((n = c(n)), (n = n.replaceAll(`<`, `&lt;`).replaceAll(`>`, `&gt;`)));
  let d = u
    .node()
    .appendChild(await h(u, n, { width: m(n, r) + 100, style: l, useHtmlLabels: r.htmlLabels }, r));
  ...
  if (s(r.htmlLabels)) {
    ...
    let n = e(d);
    ((f = t.getBoundingClientRect()), n.attr(`width`, f.width), n.attr(`height`, f.height));
  }
  return f;
}
n(It, `addText`);
...
async function zt(t, r, i, o = []) {
  ...
  if (p) {
    ...
    ((y = t.innerHTML.split(`<br>`).length),
      t.innerHTML.includes(`</math>`) && (y += t.innerHTML.split(`<mrow>`).length - 1));
            ...
            new Promise((r) => {
              function i() {
                if (((t.style.display = `flex`), (t.style.flexDirection = `column`), e)) {
                  let e = u.fontSize?.toString() ?? window.getComputedStyle(document.body).fontSize,
    ...
    (o.includes(`font-weight: bolder`) && e(_).selectAll(`tspan`).attr(`font-weight`, ``),
      (y = _.children.length));
    let t = _.children[0];
    ((_.textContent === `` || _.textContent.includes(`&gt`)) &&
      ((t.textContent =
        g[0] + g.substring(1).replaceAll(`&gt;`, `>`).replaceAll(`&lt;`, `<`).trim()),
      g[1] === ` ` && (t.textContent = t.textContent[0] + ` ` + t.textContent.substring(1))),
      t.textContent === `undefined` && (t.textContent = ``),
      (v = _.getBBox()));
  }
  return (c.attr(`transform`, `translate(0,` + (-v.height / (2 * y) + i) + `)`), v.height);
}
n(zt, `addText`);
async function Bt(n, r) {
  ...
  let v = f.members.length === 0 && f.methods.length === 0 && !i.class?.hideEmptyMembersBox,
    x = t.svg(p),
    S = y(r, {});
  ...
  let A = x.rectangle(
      D - l,
      O - l - (v ? l : f.members.length === 0 && f.methods.length === 0 ? -l / 2 : 0),
      C + 2 * l,
      w + 2 * l + k,
      S,
    ),
  ...
  let M = j.node().getBBox(),
    N = p.select(`.annotation-group`).node().getBBox().height - (v ? l / 2 : 0) || 0,
    P = p.select(`.label-group`).node().getBBox().height - (v ? l / 2 : 0) || 0,
    F = p.select(`.members-group`).node().getBBox().height - (v ? l / 2 : 0) || 0,
    I =
      (N +
        P +
        O +
  ...
  if (
    (p.selectAll(`.text`).each((t, n, r) => {
      ...
      let c = s + O + l - (v ? l : f.members.length === 0 && f.methods.length === 0 ? -l / 2 : 0);
      if (a.attr(`class`).includes(`methods-group`)) {
        let e = Math.max(F, u / 2);
        c = E ? Math.max(I, N + P + e + O + u * 2 + l) + u * 2 : N + P + e + O + u * 4 + l;
      }
      (f.members.length === 0 &&
        f.methods.length === 0 &&
        ...
        d || (c -= 4));
      let m = D;
      ((a.attr(`class`).includes(`label-group`) || a.attr(`class`).includes(`annotation-group`)) &&
  ...
  if (v || f.members.length > 0 || f.methods.length > 0) {
    let e = N + P + F + O + u * 2 + l,
      t = x.line(M.x, E ? Math.max(I, e) : e, M.x + M.width, (E ? Math.max(I, e) : e) + 0.001, S);
    p.insert(() => t)
      .attr(`class`, `divider${r.look === `neo` && !c ? ` neo-line` : ``}`)
      .attr(`style`, _);
  }
...
async function Vt(n, r) {
  ...
  if (((g += _ + 20), l)) {
    let e = await $(m, `${s.requirementId ? `ID: ${s.requirementId}` : ``}`, g, r.labelStyle);
    g += e;
    let t = await $(m, `${s.text ? `Text: ${s.text}` : ``}`, g, r.labelStyle);
    g += t;
    let n = await $(m, `${s.risk ? `Risk: ${s.risk}` : ``}`, g, r.labelStyle);
    ((g += n),
      await $(m, `${s.verifyMethod ? `Verification: ${s.verifyMethod}` : ``}`, g, r.labelStyle));
  } else {
    let e = await $(m, `${c.type ? `Type: ${c.type}` : ``}`, g, r.labelStyle);
    ((g += e), await $(m, `${c.docRef ? `Doc Ref: ${c.docRef}` : ``}`, g, r.labelStyle));
  }
  ...
  if ((k.attr(`class`, `basic label-container outer-path`).attr(`style`, a), f?.length)) {
  ...
  return (
    ...
    a && r.look !== `handDrawn` && (p || f?.length) && m.selectAll(`path`).attr(`style`, a),
    m
  );
}
n(Vt, `requirementBox`);
async function $(t, n, r, i = ``) {
  ...
  let s = t.insert(`g`).attr(`class`, `label`).attr(`style`, i),
    ...
    u = await h(
      s,
      a(f(n)),
      { width: m(n, c) + 50, classes: `markdown-node-label`, useHtmlLabels: l, style: i },
      c,
    ),
    d;
  if (l) {
    let t = u.children[0],
      n = e(u);
    ((d = t.getBoundingClientRect()), n.attr(`width`, d.width), n.attr(`height`, d.height));
  } else {
    let e = u.children[0];
    for (let t of e.children) i && t.setAttribute(`style`, i);
    ((d = u.getBBox()), (d.height += 6));
  }
  return (s.attr(`transform`, `translate(${-d.width / 2},${-d.height / 2 + r})`), d.height);
}
n($, `addText`);
var Ht = n((e) => {
  switch (e) {
...
async function Ut(e, n, { config: r }) {
  ...
  f
    ...
    : ({ label: m, bbox: h } = await w(s, (`ticket` in n && n.ticket) || ``, p));
  let { label: g, bbox: _ } = await w(s, (`assigned` in n && n.assigned) || ``, p);
  n.width = o;
  let v = n?.width || 0,
    ...
    D = -v / 2,
    O = -S / 2;
  (l.attr(`transform`, `translate(` + (u - v / 2) + `, ` + (-x - c.height / 2) + `)`),
    m.attr(`transform`, `translate(` + (u - v / 2) + `, ` + (-x + c.height / 2) + `)`),
    g.attr(
      `transform`,
      `translate(` + (u + v / 2 - _.width - 20) + `, ` + (-x + c.height / 2) + `)`,
    ));
  let k,
    { rx: A, ry: j } = n,
    { cssStyles: M } = n;
  if (n.look === `handDrawn`) {
    let e = t.svg(s),
      r = y(n, {}),
      i = A || j ? e.path(N(D, O, v, S, A || 0), r) : e.rectangle(D, O, v, S, r);
  ...
  tn = n((e) => {
    ...
    return (
      e.clusterNode
        ? t.attr(
            `transform`,
            `translate(` + (e.x + n - e.width / 2) + `, ` + (e.y - e.height / 2 - 8) + `)`,
          )
