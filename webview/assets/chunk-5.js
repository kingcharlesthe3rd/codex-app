import { n as e } from "./marked.esm.js";
import { i as t } from "./chunk-13.js";
import { t as n } from "./src-5.js";
import { n as r, r as i } from "./chunk-61.js";
import { I as a, N as o, O as s, s as c, y as l } from "./chunk-60.js";
import { a as u, i as d, n as f, o as p, r as m, t as h } from "./esm.js";
var g = {
  ...
  y = r((e) => {
    for (let t of e) {
      ...
      if ((i.debug(`Registering icon pack:`, t.name), `loader` in t)) v.set(t.name, t.loader);
      else if (`icons` in t) _.set(t.name, t.icons);
      else
        throw (
          i.error(`Invalid icon loader:`, t),
          Error(`Invalid icon loader. Must have either "icons" or "loader" property.`)
        );
    }
  }, `registerIconPacks`),
  b = r(async (e, t) => {
    let n = p(e, !0, t !== void 0);
    ...
    if (!a) {
      ...
      try {
        ((a = { ...(await e()), prefix: r }), _.set(r, a));
      } catch (e) {
        throw (i.error(e), Error(`Failed to load icon set: ${n.prefix}`));
      }
    }
    let o = u(a, n.name);
  ...
  S = r(async (e, t, n) => {
    let r;
    try {
      r = await b(e, t?.fallbackPrefix);
    } catch (e) {
      (i.error(e), (r = g));
    }
    let o = d(r, t);
    return a(f(m(o.body), { ...o.attributes, ...n }), l());
  }, `getIconSVG`);
...
`)
          .forEach((e, n) => {
            (n !== 0 && (s++, o.push([])),
              e.split(` `).forEach((e) => {
                ((e = e.replace(/&#39;/g, `'`)), e && o[s].push({ content: e, type: t }));
              }));
          })
...
r(w, `markdownToLines`);
function T(t, { markdownAutoWrap: n } = {}) {
  let a = e.lexer(t);
  function o(e) {
    return e.type === `text`
      ? n === !1
          ...
          : e.type === `paragraph`
            ...
            : e.type === `space`
              ...
              : e.type === `html`
                ...
                : e.type === `escape`
                  ? e.text
                  : (i.warn(`Unsupported markdown: ${e.type}`), e.raw);
  }
  return (r(o, `output`), a.map(o).join(``));
}
r(T, `markdownToHTML`);
function E(e) {
  return Intl.Segmenter ? [...new Intl.Segmenter().segment(e)].map((e) => e.segment) : [...e];
}
r(E, `splitTextToChars`);
function D(e, t) {
  return O(e, [], E(t.content), t.type);
}
r(D, `splitWordToFitWidth`);
function O(e, t, n, r) {
  if (n.length === 0)
    return [
...
r(O, `splitWordToFitWidthRecursion`);
function k(e, t) {
  if (
    e.some(({ content: e }) =>
      e.includes(`
...
function A(e, t, n = [], r = []) {
  ...
  let a = e.shift() ?? { content: ` `, type: `normal` },
    o = [...r];
  if ((i !== `` && o.push({ content: i, type: `normal` }), o.push(a), t(o))) return A(e, t, n, o);
...
r(A, `splitLineToFitWidthRecursion`);
function j(e, t) {
  t && e.attr(`style`, t);
}
r(j, `applyStyle`);
async function M(e, t, n, r, i = !1, u = l()) {
...
r(F, `computeDimensionOfText`);
function I(e, t, n, i = !1) {
  let a = 1.1,
    o = t.append(`g`),
    s = o.insert(`rect`).attr(`class`, `background`).attr(`style`, `stroke: none`),
    c = o.append(`text`).attr(`y`, `-10.1`),
    l = 0;
  for (let t of n) {
    let n = r((t) => P(o, a, t) <= e, `checkWidth`),
      i = n(t) ? [t] : k(t, n);
...
r(L, `updateTextContentAndStyles`);
...
var z = r(
  async (
    ...
    if ((i.debug(`XYZ createText`, r, a, o, c, l, u, `addSvgBackground: `, f), l)) {
      let n = await R(t(T(r, p)), p),
        i = r.replace(/\\\\/g, `\\`);
      return await M(
        e,
        { isNode: u, label: s(r) ? i : n, labelStyle: a.replace(`fill:`, `color:`) },
        d,
        c,
        f,
        p,
      ...
      let t = I(d, e, w(r.replace(/<br\s*\/?>/g, `<br/>`).replace(`<br>`, `<br/>`), p), r ? f : !1);
      if (u) {
