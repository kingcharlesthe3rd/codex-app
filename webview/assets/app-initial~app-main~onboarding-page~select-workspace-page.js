...
var y,
  b,
  x = e(() => {
    ((y = `last_completed_onboarding`), (b = `electron:onboarding-projectless-completed`));
  });
...
var S,
  ...
  H = e(() => {
    (a(),
      ...
      (A = h(`electron:onboarding-plugin-suggestions-v2-enabled-at-completion`, !1)),
...
var X,
  ...
  ve,
  ye = e(() => {
    (de(), (X = `Playground`), (Z = `93537254`), (Q = `t5_onboarding_v2`), (ve = `arm`));
  });
...
function Se(e) {
  ...
  let l;
  t[4] !== n || t[5] !== c || t[6] !== o
    ? ((l = be({ onboardingTarget: n, assignment: o, evaluateExperimentArm: c })),
      (t[4] = n),
      (t[5] = c),
      (t[6] = o),
      (t[7] = l))
...
function we(e) {
  let t = (0, $.c)(14),
    ...
    a;
  t[0] !== n || t[1] !== i || t[2] !== r
    ? ((a = n && !i && ce(r, `1482884768`)), (t[0] = n), (t[1] = i), (t[2] = r), (t[3] = a))
    : (a = t[3]);
  let o = a,
    s;
  ...
  let u = i || (o && c.isLoading),
    d;
  t[7] !== o || t[8] !== l || t[9] !== r
    ? ((d = o && l && ce(r, `3150044490`)), (t[7] = o), (t[8] = l), (t[9] = r), (t[10] = d))
    : (d = t[10]);
  let f;
  return (
    t[11] !== u || t[12] !== d
