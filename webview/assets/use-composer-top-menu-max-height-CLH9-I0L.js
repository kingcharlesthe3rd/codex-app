...
import { Dr as t, Er as n } from "./src-2.js";
...
import { f as c } from "./chunk-12.js";
import { n as l } from "./composer-top-menu-chrome.js";
var u = `data-hotkey-window-home-composer-menu-open`;
function d(e) {
...
function y(e) {
  ...
  for (let e = 0; e < p; e += 1)
    for (let n = 0; n < m; n += 1) {
      if (!x(t, e * m + n)) continue;
      (r.push({ animationDelayMs: w(e), column: n, row: e }), i.add(S(n, e)));
      let a = p - 1 - n;
      a !== n && (r.push({ animationDelayMs: w(e), column: a, row: e }), i.add(S(a, e)));
    }
  if (r.length === 0) {
    let e = Math.floor(p / 2);
    (r.push({ animationDelayMs: w(e), column: e, row: e }), i.add(S(e, e)));
  }
  return { cells: r, color: T(n), scanCells: C(i) };
}
function b(e) {
  let t = g;
  for (let n = 0; n < e.length; n += 1) t = (t * _ + e.charCodeAt(n)) % h;
  return t;
}
function x(e, t) {
...
function C(e) {
  ...
  for (let n = 0; n < p; n += 1)
    for (let r = 0; r < p; r += 1)
      t.push({ animationDelayMs: w(n), column: r, filled: e.has(S(r, n)), row: n });
  return t;
}
function w(e) {
  return e * f;
...
function T(e) {
  return E(Math.floor((e / h) * v.length));
}
function E(e) {
  return v[e % v.length] ?? `var(--color-token-charts-yellow)`;
}
var D = {
...
function j(e) {
  ...
  if (t[5] !== s || t[6] !== n || t[7] !== r || t[8] !== i) {
    let e = y(i);
    ((c = r),
      t[17] === n ? (l = t[18]) : ((l = o(`shrink-0`, n)), (t[17] = n), (t[18] = l)),
      (u = `-2 -1 24 24`),
      (d = `none`),
      (f = `crispEdges`),
      ...
      (m = e.cells.map((t) =>
        (0, k.jsx)(
          `rect`,
          {
            className: s ? D.filledScanCell : void 0,
            x: t.column * A,
            y: t.row * A,
            width: A,
            height: A,
...
function M(e, i) {
  let a = r(e.path)?.pluginMarketplaceName ?? null;
  return i == null || a == null || !t(a) || a === n(i);
}
var N = e(i(), 1);
function P(e) {
  let t = (0, O.c)(10),
    ...
    c;
  t[0] !== r || t[1] !== a || t[2] !== o
    ? ((c = F({ isLoading: r, query: a, resultCount: o })),
      (t[0] = r),
      (t[1] = a),
      (t[2] = o),
      (t[3] = c))
...
function F({ isLoading: e, query: t, resultCount: n }) {
...
function I(e) {
  let t = (0, O.c)(13),
    ...
    u = c(),
    f = s === `embeddedExpandedTopTray`;
  if (s === `expandedTopTray` || f || d(u.pathname)) {
    let e;
    t[0] === r
      ? (e = t[1])
      : ((e = o(`relative flex w-full flex-col overflow-hidden text-sm`, r)),
        (t[0] = r),
        (t[1] = e));
    let i;
    return (
      t[2] !== n || t[3] !== a || t[4] !== e || t[5] !== f
        ? ((i = (0, k.jsx)(l, {
            embedded: f,
            expandedTopTray: !0,
            containerRef: a,
  ...
  return (
    t[9] !== n || t[10] !== a || t[11] !== p
      ? ((m = (0, k.jsx)(`div`, { ref: a, className: p, children: n })),
        (t[9] = n),
        (t[10] = a),
        (t[11] = p),
        (t[12] = m))
...
function L(e) {
  ...
  let l;
  t[0] !== r || t[1] !== c
    ? ((l = o(c, `flex w-full flex-1 flex-col overflow-y-auto`, r)),
      (t[0] = r),
      (t[1] = c),
      (t[2] = l))
    : (l = t[2]);
  ...
  return (
    t[3] !== n || t[4] !== a || t[5] !== l
      ? ((u = (0, k.jsx)(`div`, { ref: a, className: l, children: n })),
        (t[3] = n),
        (t[4] = a),
        (t[5] = l),
        (t[6] = u))
...
function R(e) {
  let t = (0, O.c)(6),
    ...
    s = c(),
    l =
      a === `expandedTopTray` || a === `embeddedExpandedTopTray` || d(s.pathname)
    ...
    u;
  t[0] !== r || t[1] !== l ? ((u = o(l, r)), (t[0] = r), (t[1] = l), (t[2] = u)) : (u = t[2]);
  let f;
  return (
    t[3] !== n || t[4] !== u
      ? ((f = (0, k.jsx)(`div`, { className: u, children: n })), (t[3] = n), (t[4] = u), (t[5] = f))
      : (f = t[5]),
    f
  );
}
...
var V = 8,
  H = `--composer-top-menu-max-height`;
function U(e) {
  let t = (0, O.c)(4),
        ...
        let e = null,
          ...
          i = () => {
            let e = n.getBoundingClientRect(),
              ...
              i = `${Math.max(0, Math.floor(r - 46 - V))}px`;
            i !== t && ((t = i), n.style.setProperty(H, i));
          },
          a = () => {
...
//# sourceMappingURL=use-composer-top-menu-max-height-CLH9-I0L.js.map
