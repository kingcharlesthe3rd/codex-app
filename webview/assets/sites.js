...
import { d as r } from "./statsig.js";
import { t as i } from "./app-intl-signal.js";
import { w as a } from "./mention-item.js";
import { t as o } from "./plugin-config-edits.js";
import { t as s } from "./plugin-prefill-prompt.js";
function c(e, t, n) {
  let c = e.get(i),
    l;
  switch (n.type) {
    case `create`:
      (r(e, `3696170016`) && n.setSelectedMode(`plan`),
        (l = c.formatMessage({
    ...
    case `edit`:
      l = c.formatMessage(
        ...
        { siteMention: a({ projectId: n.projectId, title: n.projectTitle }) },
      );
      break;
  }
  t({
    ...
    prefillPrompt:
      n.type === `create`
        ? s({ defaultPrompt: l, pluginDisplayName: `Sites`, pluginId: o })
        : `${l} `,
    startInSidebar: !0,
  });
}
var l = `/sites/:projectId/settings`;
function u(e) {
...
export { c as i, l as n, u as r, f as t };
