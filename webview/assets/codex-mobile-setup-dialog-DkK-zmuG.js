...
import { Sr as We, xr as Ge } from "./app-initial~app-main~automations-page.js";
import {
  Ot as Ke,
  St as qe,
  bt as Je,
...
var lt,
  ut = e(() => {
    (v(), (lt = N(`electron:codex-mobile-setup-step-debug-override`, `auto`)));
  }),
  dt,
  ft = e(() => {
...
function Zt() {
  let e = (0, en.c)(55),
    ...
    i = ee(`410065390`),
    o;
  e[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((o = { hostId: x }), (e[0] = o)) : (o = e[0]);
  let s = w(o).available,
    c = O(xe.keepRemoteControlAwakeWhilePluggedIn),
    l = se($e, x),
    d = ce(Je),
    f;
  e[1] === t.query ? (f = e[2]) : ((f = t.query.snapshot(Je)), (e[1] = t.query), (e[2] = f));
  let p = f,
    m;
  e[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((m = []), (e[3] = m)) : (m = e[3]);
  let h = Ne(x, m),
    g;
  e[4] !== r || e[5] !== h.availablePlugins
    ? ((g = $t(h.availablePlugins, nn, r)), (e[4] = r), (e[5] = h.availablePlugins), (e[6] = g))
    : (g = e[6]);
  let _ = g,
    v = _?.plugin.installed === !0 && _.plugin.enabled,
    y;
  e[7] !== r || e[8] !== h.availablePlugins
    ? ((y = Qt(h.availablePlugins, r)), (e[7] = r), (e[8] = h.availablePlugins), (e[9] = y))
    : (y = e[9]);
  let b = y,
    S;
  e[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = { hostId: x }), (e[10] = S))
    : (S = e[10]);
  let { pendingPluginId: C, setPluginEnabled: T } = Pe(S),
    E;
  e[11] === h.forceReload
    ? (E = e[12])
    : ((E = { forceReloadPlugins: h.forceReload, hostId: x }),
      (e[11] = h.forceReload),
      (e[12] = E));
  let {
      closePluginInstall: D,
      connectRequiredApp: te,
      handleRequiredAppConnected: ne,
      handleRequiredAppOAuthStarted: re,
      installPlugin: ie,
      isInstalling: k,
      openPluginInstall: A,
      session: j,
  ...
  e[13] === p
    ...
    : ((ae = {
      ...
      (e[14] = ae));
  let N = Te(ae),
    P = n === `macOS` && v && l && d.data?.enabled != null,
    le;
  e[15] !== _ || e[16] !== d.data?.enabled || e[17] !== A || e[18] !== T || e[19] !== N
    ? ((le = (e) => {
        if (_ != null) {
          if (!_.plugin.installed) {
            e && A(_);
            return;
          }
          if (!e && d.data?.enabled) {
            N.mutate(!1, {
              onSuccess: (e) => {
                e === !1 && T({ enabled: !1, pluginDisplayName: a(_), pluginId: _.plugin.id });
              },
            });
            return;
          }
          T({ enabled: e, pluginDisplayName: a(_), pluginId: _.plugin.id });
        }
      }),
      (e[15] = _),
      (e[16] = d.data?.enabled),
  ...
  e[21] !== b || e[22] !== A || e[23] !== T
    ? ((I = (e) => {
        if (b != null) {
          ...
          T({ enabled: e, pluginDisplayName: a(b), pluginId: b.plugin.id });
        }
      }),
      (e[21] = b),
      (e[22] = A),
    ...
    : (I = e[24]);
  let ue = I,
    de = b?.plugin.installed === !0 && b.plugin.enabled,
    L = h.isLoading || b == null || k || C === b.plugin.id,
    fe = h.isLoading || _ == null || k || N.isPending || C === _.plugin.id,
    R = c ?? !1,
    pe = d.data?.enabled ?? !1,
    me = !v || d.isLoading || N.isPending,
    z;
  e[25] === t
    ? (z = e[26])
    : ((z = (e) => {
        je(t, xe.keepRemoteControlAwakeWhilePluggedIn, e);
      }),
      (e[25] = t),
      (e[26] = z));
  let B;
  ...
  e[37] !== V
    ? ((H = (0, tn.jsx)(Ke, {
        ...
        onInstall: ie,
        onRequiredAppConnected: ne,
        onRequiredAppOAuthStarted: re,
        onOpenChange: V,
        session: j,
      })),
      (e[31] = te),
...
function Qt(e, t) {
  return z.isInternal(d()) ? ($t(e, on, t) ?? $t(e, an, t) ?? $t(e, rn, t)) : $t(e, rn, t);
}
function $t(e, t, n) {
...
function cn(e) {
  ...
  t[0] === i
    ? (c = t[1])
    : ((c = i === `page` ? (0, q.jsx)(Ie, { className: `size-11 text-token-foreground` }) : void 0),
      (t[0] = i),
      (t[1] = c));
  let l, u;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
  ...
  let d =
    ...
    p;
  t[4] === d ? (p = t[5]) : ((p = W(`flex w-full flex-col`, d)), (t[4] = d), (t[5] = p));
  let m;
  ...
  t[31] !== i
    ? ((g = s.showChromeExtensionSetup
        ? (0, q.jsx)(un, {
            icon: (0, q.jsx)(we, { className: `icon-base` }),
            variant: i,
            title: (0, q.jsx)(f, {
  ...
  t[41] !== n || t[42] !== y
    ? ((x = (0, q.jsx)(`div`, {
        ...
        children: (0, q.jsx)(H, { size: `large`, className: y, onClick: n, children: b }),
      })),
      (t[41] = n),
      (t[42] = y),
      (t[43] = x))
  ...
  return (
    t[55] !== s.pluginInstallModal || t[56] !== T
      ? ((E = (0, q.jsxs)(q.Fragment, { children: [T, s.pluginInstallModal] })),
...
function wi(e) {
  let t = (0, Ii.c)(82),
    { deviceType: n, hostId: r, onDeviceTypeChange: a, showDeviceTypeSelector: s, size: c } = e,
    l = r === void 0 ? x : r,
    u = s === void 0 ? !0 : s,
    ...
    m = ee(ne),
    g = ee(o),
    [_, v] = (0, Li.useState)(`ios`),
    [y, b] = (0, Li.useState)(!1),
    [S, w] = (0, Li.useState)(`phone`),
    T = u ? (n ?? S) : `phone`,
    [E] = (0, Li.useState)(Ti),
    D;
  t[0] !== l || t[1] !== E
    ? ((D = { hostId: l, openId: E }), (t[0] = l), (t[1] = E), (t[2] = D))
    : (D = t[2]);
  let O = se(i, D),
    k = m && !g,
    A = k && O.error == null ? (O.data ?? null) : null,
    j = A?.manualPairingCode ?? null,
    ae = k && A == null && (O.error == null || O.isFetching),
    oe = !m || A?.pairingCode != null,
    M = T === `phone` && !m && !g,
    N = k && T === `computer` && !ae,
    P;
  t[3] !== n || t[4] !== a
  ...
  if (g) {
    ...
    let e = A?.pairingCode,
      n;
    (t[21] !== R || t[22] !== L || t[23] !== _ || t[24] !== d || t[25] !== e
      ? ((n = (0, Z.jsx)(qr, {
          ariaLabel: L,
          centerLogoAriaLabel: R,
          pairingCode: e,
    ...
    (t[27] === O.error
      ? (e = t[28])
      : ((e = (0, Z.jsx)(Fi, { error: O.error })), (t[27] = O.error), (t[28] = e)),
      (z = e));
  } else if (m) {
    let e;
    (t[29] !== j || t[30] !== O.error || t[31] !== d
      ? ((e = (0, Z.jsx)(Oi, { error: O.error, manualPairingCode: j, size: d })),
        (t[29] = j),
        (t[30] = O.error),
        (t[31] = d),
        (t[32] = e))
  ...
  let B = d === `compact` ? null : `mt-3`,
    V;
  t[34] === B
    ? (V = t[35])
    : ((V = W(`flex w-full flex-col items-center gap-4`, B)), (t[34] = B), (t[35] = V));
  let U;
  t[36] !== p || t[37] !== g || t[38] !== ce || t[39] !== T || t[40] !== u
    ? ((U =
        u && !g
          ? (0, Z.jsx)(`div`, {
      ...
      (t[41] = U))
    : (U = t[41]);
  let he = d === `compact` ? `bg-transparent` : `bg-token-bg-primary`,
    ge = M ? null : `justify-center`,
    _e =
      T === `computer`
        ? d === `compact`
  ...
  t[46] !== z || t[47] !== M
    ? ((be = M
        ? (0, Z.jsx)(`div`, { className: `flex flex-1 items-center justify-center`, children: z })
        : z),
      (t[46] = z),
      (t[47] = M),
      (t[48] = be))
  ...
  t[60] !== ue
              ...
              T === `phone` && oe
                ? (0, Z.jsx)(ve, {
                    ...
                    children: (0, Z.jsx)(H, {
                      ...
                      onClick: () => b(!0),
                      size: `icon`,
                      children: (0, Z.jsx)(ie, { className: `icon-xs` }),
                    }),
                  })
                : null,
              (0, Z.jsx)(ve, {
                ...
                children: (0, Z.jsx)(H, {
                  ...
                  size: `icon`,
                  children: (0, Z.jsx)(Ue, {
                    className: W(`icon-xs`, O.isFetching ? `animate-spin` : null),
                  }),
                }),
              }),
            ],
    ...
    : (Se = t[61]);
  let Ce;
  t[62] !== ye || t[63] !== be || t[64] !== xe || t[65] !== Se
    ? ((Ce = (0, Z.jsxs)(`div`, { className: ye, children: [be, xe, Se] })),
      (t[62] = ye),
      (t[63] = be),
      (t[64] = xe),
      (t[65] = Se),
    ...
    : (Ce = t[66]);
  let we;
  t[67] === N ? (we = t[68]) : ((we = N ? (0, Z.jsx)(Pi, {}) : null), (t[67] = N), (t[68] = we));
  let Te;
  t[69] !== R || t[70] !== p || t[71] !== y || t[72] !== A || t[73] !== L || t[74] !== _
    ? ((Te =
        A?.pairingCode == null
          ? null
          : (0, Z.jsxs)(re, {
  ...
  let Ee;
  return (
    t[76] !== V || t[77] !== U || t[78] !== Ce || t[79] !== we || t[80] !== Te
      ? ((Ee = (0, Z.jsxs)(`div`, { className: V, children: [U, Ce, we, Te] })),
        (t[76] = V),
        (t[77] = U),
        (t[78] = Ce),
        (t[79] = we),
...
function Di(e) {
  let t = (0, Ii.c)(3),
    ...
    r;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((r = (0, Z.jsx)(ye, { className: `size-7 text-token-text-secondary` })), (t[0] = r))
    : (r = t[0]);
  let i;
  return (
    t[1] === n
...
function zi(e) {
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (u = t[3]);
  let d;
  t[4] === o ? (d = t[5]) : ((d = (0, Q.jsx)(Ui, { variant: o })), (t[4] = o), (t[5] = d));
  ...
  t[15] !== r || t[16] !== a || t[17] !== _
    ? ((y = (0, Q.jsx)(H, { onClick: r, size: `large`, className: _, loading: a, children: v })),
      (t[15] = r),
      (t[16] = a),
      (t[17] = _),
      (t[18] = y))
  ...
  return (
    t[27] !== l || t[28] !== b || t[29] !== x || t[30] !== S || t[31] !== d || t[32] !== o
      ? ((C = (0, Q.jsxs)(Bt, { variant: o, heading: l, description: u, children: [d, b, x, S] })),
        (t[27] = l),
        (t[28] = b),
        (t[29] = x),
        (t[30] = S),
...
function Bi(e) {
  ...
  return (
    t[8] !== l || t[9] !== u || t[10] !== a
      ? ((d = (0, Q.jsxs)(Bt, { variant: a, heading: o, description: s, children: [l, u] })),
        (t[8] = l),
        (t[9] = u),
        (t[10] = a),
        (t[11] = d))
...
function Vi(e) {
  ...
  t[3] === n
    ? (s = t[4])
    : ((s = (0, Q.jsx)(H, { size: `large`, className: `justify-center`, onClick: n, children: o })),
      (t[3] = n),
      (t[4] = s));
  let c;
  return (
...
function Ui(e) {
  ...
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Q.jsx)(Gi, {
        icon: (0, Q.jsx)(Ge, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Q.jsx)(f, {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, Q.jsx)(Gi, {
        icon: (0, Q.jsx)(Re, { "aria-hidden": !0, className: `size-5` }),
        title: (0, Q.jsx)(f, {
...
var Ki,
  Q,
  qi = e(() => {
    ((Ki = L()), B(), D(), F(), P(), he(), ze(), We(), g(), Ut(), Xt(), Ri(), (Q = G()));
  });
function Ji(e) {
  let t = (0, Yi.c)(16),
  ...
  if (o === `page`) {
    ...
    return (
      t[6] !== u || t[7] !== n
        ? ((r = (0, Xi.jsx)(Bt, { variant: `page`, heading: u, description: e, children: n })),
          (t[6] = u),
          (t[7] = n),
          (t[8] = r))
        : (r = t[8]),
  ...
  return (
    t[13] !== u || t[14] !== d
      ? ((p = (0, Xi.jsx)(Bt, { variant: `dialog`, heading: u, children: d })),
        (t[13] = u),
        (t[14] = d),
        (t[15] = p))
      : (p = t[15]),
...
function sa(e) {
  ...
  let b;
  t[1] !== _ || t[2] !== v || t[3] !== f
    ? ((b = ca(_, v, f)), (t[1] = _), (t[2] = v), (t[3] = f), (t[4] = b))
    : (b = t[4]);
  let x;
  t[5] === b
    ? (x = t[6])
    : ((x = (0, ua.jsx)(h, { className: `sr-only`, children: b })), (t[5] = b), (t[6] = x));
  let S;
  t[7] !== g || t[8] !== f
    ? ((S = (e) => {
        (E(g, k, { action: `continue_on_chatgpt`, step: f, surface: `dialog` }),
          le({
            event: e,
    ...
    : (S = t[9]);
  let w;
  t[10] !== i || t[11] !== g || t[12] !== f
    ? ((w = () => {
        (E(g, k, { action: `finish_setup`, step: f, surface: `dialog` }), i(!1));
      }),
      (t[10] = i),
      (t[11] = g),
      (t[12] = f),
...
//# sourceMappingURL=codex-mobile-setup-dialog-DkK-zmuG.js.map
