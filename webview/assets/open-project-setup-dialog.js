...
import { Bt as l, r as u } from "./use-host-config-C.js";
import { B as d, n as f, ta as p } from "./thread-context-inputs.js";
import { A as m, f as h, p as g, r as _ } from "./vscode-api.js";
import { Br as v } from "./src-1.js";
import { i as y, l as b, r as x, s as S } from "./lib-1.js";
import { t as C } from "./clsx.js";
import { t as w } from "./button.js";
import { t as T } from "./tooltip-B.js";
import { r as E } from "./toast-signal.js";
import { t as D } from "./x.js";
import { A as O, n as k } from "./rpc-1.js";
import { t as A } from "./request.js";
import { t as j } from "./use-global-state.js";
import { a as M } from "./remote-projects.js";
import { r as N, t as ee } from "./sidebar-thread-keys.js";
...
import { n as R, r as z } from "./local-projects.js";
import { t as B } from "./select-project.js";
import { P as V, T as H, u as oe, y as se } from "./sidebar-project-group-signals.js";
var U = r(),
  W = e(t(), 1),
  G = n(),
  ce = y({
...
function ue(e) {
  ...
  t[14] === u.title
    ? (O = t[15])
    : ((O = (0, G.jsx)(S, { ...u.title })), (t[14] = u.title), (t[15] = O));
  let k;
  t[16] === u.subtitle
    ? (k = t[17])
    : ((k = (0, G.jsx)(S, { ...u.subtitle })), (t[16] = u.subtitle), (t[17] = k));
  let A;
  t[18] !== O || t[19] !== k
    ? ((A = (0, G.jsx)(I, { children: (0, G.jsx)(te, { title: O, subtitle: k }) })),
      (t[18] = O),
      (t[19] = k),
      (t[20] = A))
    : (A = t[20]);
  ...
  t[28] !== M || t[29] !== N || t[30] !== ee || t[31] !== p
    ...
    : (P = t[32]);
  let F;
  t[33] === i ? (F = t[34]) : ((F = null), (t[33] = i), (t[34] = F));
  let L;
  t[35] !== P || t[36] !== F
    ? ((L = (0, G.jsxs)(I, { className: `gap-2`, children: [P, F] })),
      (t[35] = P),
      (t[36] = F),
      (t[37] = L))
    : (L = t[37]);
  ...
  t[39] === s
    ? (R = t[40])
    : ((R = (0, G.jsx)(w, { color: `outline`, type: `button`, onClick: s, children: ae })),
      (t[39] = s),
      (t[40] = R));
  let z;
  ...
  t[42] === v
    ? (B = t[43])
    : ((B = (0, G.jsx)(w, { color: `primary`, type: `submit`, disabled: v, children: z })),
      (t[42] = v),
      (t[43] = B));
  let V;
  t[44] !== R || t[45] !== B
    ? ((V = (0, G.jsx)(I, { children: (0, G.jsxs)(ie, { children: [R, B] }) })),
      (t[44] = R),
      (t[45] = B),
      (t[46] = V))
    : (V = t[46]);
  let H;
  t[47] !== T || t[48] !== L || t[49] !== V || t[50] !== A
    ? ((H = (0, G.jsxs)(re, { as: `form`, onSubmit: T, children: [A, L, V] })),
      (t[47] = T),
      (t[48] = L),
      (t[49] = V),
      (t[50] = A),
...
function K({ label: e, path: t, queryClient: n }) {
  n.setQueryData(_(`workspace-root-options`, { hostId: u }), (n) => {
    if (n == null) return n;
    if (e.length === 0) {
...
function q(e) {
  return e.flatMap((e) => {
    ...
    if (e.kind === `remote`) {
      ...
      return n || !r ? [] : [{ kind: `remote`, taskId: e.task.id, threadKey: N(e.task.id) }];
    }
    return [];
  });
}
async function J({ archiveableTasks: e, currentThreadKey: t }) {
  let n = await Promise.all(
      e.map(async (e) => {
        try {
          return (
            e.kind === `local`
              ? await l(`archive-conversation`, {
                  conversationId: e.conversationId,
                  source: `project_archive`,
                })
              : await A.safePost(`/wham/tasks/{task_id}/archive`, {
...
async function pe(e) {
  await Promise.all(
    e.map(async (e) => {
      try {
        if (e.kind === `local`) {
          await l(`mark-conversation-as-read`, { conversationId: e.conversationId });
          return;
        }
        await A.safePost(`/wham/tasks/{task_id}/mark_read`, {
          parameters: { path: { task_id: e.taskId } },
        });
      } catch {}
    }),
...
function me(e) {
  ...
  let f;
  t[9] !== u || t[10] !== d
    ? ((f = (0, G.jsx)(I, { children: (0, G.jsx)(te, { title: u, subtitle: d }) })),
      (t[9] = u),
      (t[10] = d),
      (t[11] = f))
    : (f = t[11]);
  ...
  let _;
  t[20] !== s || t[21] !== g
    ? ((_ = (0, G.jsx)(w, { color: `danger`, type: `submit`, disabled: s, children: g })),
      (t[20] = s),
      (t[21] = g),
      (t[22] = _))
    : (_ = t[22]);
  let v;
  t[23] !== _ || t[24] !== h
    ? ((v = (0, G.jsx)(I, { children: (0, G.jsxs)(ie, { children: [h, _] }) })),
      (t[23] = _),
      (t[24] = h),
      (t[25] = v))
    : (v = t[25]);
  ...
  t[26] !== v || t[27] !== l || t[28] !== f
    ? ((y = (0, G.jsxs)(re, { as: `form`, onSubmit: l, children: [f, v] })),
      (t[26] = v),
      (t[27] = l),
      (t[28] = f),
      (t[29] = y))
  ...
  return (
    t[30] !== c || t[31] !== y
      ? ((b = (0, G.jsx)(ne, { open: !0, onOpenChange: c, size: `compact`, children: y })),
        (t[30] = c),
        (t[31] = y),
        (t[32] = b))
      : (b = t[32]),
...
function X(e) {
    ...
    ? ((x = () => {
        y.length === 0 ||
          ...
          (async () => {
            ...
            } = await J({ archiveableTasks: y, currentThreadKey: a });
            if (
  ...
  let S = x,
    C;
  return (
    t[13] !== y.length || t[14] !== S || t[15] !== h || t[16] !== l || t[17] !== n
      ? ((C = (0, G.jsx)(me, {
          open: !0,
          onOpenChange: l,
          onConfirm: S,
...
function he({
  ...
  let a = o(c),
    l = b(),
    [u, d] = (0, W.useState)(!1),
    { data: m } = j(v.PROJECT_ORDER),
    { data: h } = j(v.PINNED_PROJECT_IDS),
    { data: g } = j(v.LOCAL_PROJECTS),
    _ = s(f).data?.roots,
    y = z.getId(e),
    x = k.projectWritableRoots?.clearRoots;
  return (0, G.jsx)(Z, {
    projectLabel: t,
    isRemoving: u,
    removeDisabled: x == null,
    onConfirm: () => {
      x == null ||
        u ||
        (d(!0),
        (async () => {
          try {
            (await z.remove({
              clearWritableRoots: x,
              existingLocalProjects: g,
              pinnedProjectIds: h,
              project: e,
              projectOrder: m,
              setGlobalSetting: (e, t) => p(a, e, t),
              workspaceRootOptions: n,
            }),
              _?.includes(y) === !0 && B(a, null),
              r(!1),
              i(!1));
          } catch {
            a.get(E).danger(l.formatMessage(Q.removeError, { projectLabel: t }));
          } finally {
            d(!1);
          }
        })());
...
function ge({ projectId: e, projectLabel: t, onOpenChange: n, onDropdownOpenChange: r }) {
  let i = o(c),
    a = b(),
    [s, l] = (0, W.useState)(!1),
    { data: u } = j(v.PROJECT_ORDER),
    { data: d } = j(v.PINNED_PROJECT_IDS),
    { remoteProjects: f, selectedRemoteProjectId: m, setRemoteProjects: h } = M();
  return (0, G.jsx)(Z, {
    projectLabel: t,
    isRemoving: s,
    removeDisabled: !1,
          ...
          try {
            (await h(f.filter((t) => t.id !== e)),
              await Promise.all([
                ...
                p(i, v.PINNED_PROJECT_IDS, _e(d, e)),
              ]),
              m === e && B(i, null),
              n(!1),
              r(!1));
          } catch {
            i.get(E).danger(a.formatMessage(Q.removeError, { projectLabel: t }));
          } finally {
            l(!1);
          }
        })());
...
function Z(e) {
  ...
  t[8] === l
    ? (d = t[9])
    : ((d = (0, G.jsx)(I, { children: (0, G.jsx)(te, { title: l, subtitle: u }) })),
      (t[8] = l),
      (t[9] = d));
  let f;
  ...
  let _;
  t[18] !== g || t[19] !== h
    ? ((_ = (0, G.jsx)(w, { color: `danger`, type: `submit`, disabled: h, children: g })),
      (t[18] = g),
      (t[19] = h),
      (t[20] = _))
    : (_ = t[20]);
  let v;
  t[21] !== _ || t[22] !== m
    ? ((v = (0, G.jsx)(I, { children: (0, G.jsxs)(ie, { children: [m, _] }) })),
      (t[21] = _),
      (t[22] = m),
      (t[23] = v))
    : (v = t[23]);
  ...
  t[24] !== v || t[25] !== c || t[26] !== d
    ? ((y = (0, G.jsxs)(re, { as: `form`, onSubmit: c, children: [d, v] })),
      (t[24] = v),
      (t[25] = c),
      (t[26] = d),
      (t[27] = y))
  ...
  return (
    t[28] !== s || t[29] !== y
      ? ((b = (0, G.jsx)(ne, { open: !0, onOpenChange: s, size: `compact`, children: y })),
        (t[28] = s),
        (t[29] = y),
        (t[30] = b))
      : (b = t[30]),
...
function ve(e) {
  let t = (0, U.c)(18),
    ...
    s = i === void 0 ? `` : i,
    l;
  t[0] === a ? (l = t[1]) : ((l = a === void 0 ? [] : a), (t[0] = a), (t[1] = l));
  let u = l,
    d = b(),
    f = o(c),
    { data: m } = j(v.LOCAL_PROJECTS),
    { data: h } = j(v.PROJECT_ORDER),
    g;
  t[2] !== r || t[3] !== m || t[4] !== h || t[5] !== f
    ? ((g = async (e) => {
        ...
        let a = crypto.randomUUID(),
          { project: o, roots: s } = await z.create({
            ...
            projectId: a,
            projectOrder: h,
            setGlobalSetting: (e, t) => p(f, e, t),
            sources: n,
          });
        (await z.setWritableRootsQueryData(f, o.projectId, s), z.select(f, o));
      }),
      (t[2] = r),
      (t[3] = m),
      (t[4] = h),
  ...
  let T;
  return (
    t[12] !== s || t[13] !== u || t[14] !== n || t[15] !== _ || t[16] !== w
      ? ((T = (0, G.jsx)(be, {
          initialName: s,
          initialSources: u,
          onClose: n,
...
function ye(e) {
  let t = (0, U.c)(20),
    { onClose: n, initialName: r, initialSources: i, project: a, showDeleteAction: s } = e,
    l = s === void 0 ? !1 : s,
    u = b(),
    d = o(c),
    f = m(),
    { data: h } = j(v.LOCAL_PROJECTS),
    g;
  t[0] !== h || t[1] !== a || t[2] !== f || t[3] !== d
    ? ((g = async (e) => {
        let { name: t, sources: n } = e,
          r = k.projectWritableRoots?.addRoot,
          i = k.projectWritableRoots?.clearRoots;
        ...
        let o = await z.edit({
          ...
          now: Date.now(),
          project: a,
          setGlobalSetting: (e, t) => p(d, e, t),
          sources: n,
          updateWorkspaceRootLabel: (e, t) => {
            K({ label: t, path: e, queryClient: f });
          },
        });
        await z.setWritableRootsQueryData(d, z.getId(a), o);
      }),
      (t[0] = h),
      (t[1] = a),
      (t[2] = f),
  ...
  let _ = g,
    y = a.projectId,
    x;
  t[5] === i ? (x = t[6]) : ((x = i.join(`\0`)), (t[5] = i), (t[6] = x));
  let C = `${y}:${r}:${x}`,
    w = l ? a : void 0,
    T,
    E,
...
function be(e) {
  let t = (0, U.c)(81),
    ...
    [y, x] = (0, W.useState)(i),
    T;
  t[0] === a ? (T = t[1]) : ((T = R(a)), (t[0] = a), (t[1] = T));
  let [D, O] = (0, W.useState)(T),
    [k, A] = (0, W.useState)(!1),
    [j, M] = (0, W.useState)(!1),
    [N, ee] = (0, W.useState)(!1),
    F;
  ...
  (t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((B = (e) => {
      ...
      (t[3] = B))
    : (B = t[3]),
    g(`workspace-root-option-picked`, B));
  let V = xe,
    H;
  t[4] !== N || t[5] !== y || t[6] !== l || t[7] !== u || t[8] !== d || t[9] !== _ || t[10] !== D
    ? ((H = async (e) => {
        if ((e.preventDefault(), !N)) {
          ee(!0);
          try {
            (await u({ name: y, sources: D }), l());
          } catch {
            (ee(!1), _.get(E).danger(d));
          }
        }
      }),
      (t[4] = N),
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = (e) => {
        (e.preventDefault(), A(!1), z(Ce(e.dataTransfer)));
      }),
      (t[12] = ce))
    : (ce = t[12]);
  let le = ce,
  ...
  t[18] === m
    ? (J = t[19])
    : ((J = (0, G.jsx)(L, { className: `contents`, children: m })), (t[18] = m), (t[19] = J));
  let Y;
  t[20] === p
    ? (Y = t[21])
    : ((Y = (0, G.jsx)(ae, { className: `contents`, children: p })), (t[20] = p), (t[21] = Y));
  let fe;
  t[22] !== Y || t[23] !== J
    ? ((fe = (0, G.jsx)(I, { children: (0, G.jsx)(te, { title: J, subtitle: Y }) })),
      (t[22] = Y),
      (t[23] = J),
      (t[24] = fe))
    : (fe = t[24]);
    ...
    : ((Ee =
        D.length === 0
          ? (0, G.jsxs)(`div`, {
              ...
              children: [
                (0, G.jsx)(P, { className: `icon-sm text-token-description-foreground` }),
                (0, G.jsx)(`div`, {
  ...
  t[53] === l
    ? (Ae = t[54])
    : ((Ae = (0, G.jsx)(w, { color: `ghost`, type: `button`, onClick: l, children: ke })),
      (t[53] = l),
      (t[54] = Ae));
  let $;
  t[55] !== N || t[56] !== f
    ? (($ = (0, G.jsx)(w, { color: `primary`, type: `submit`, loading: N, children: f })),
      (t[55] = N),
      (t[56] = f),
      (t[57] = $))
    : ($ = t[57]);
  let je;
  t[58] !== Ae || t[59] !== $
    ? ((je = (0, G.jsxs)(ie, { className: `w-auto`, children: [Ae, $] })),
      (t[58] = Ae),
      (t[59] = $),
      (t[60] = je))
    : (je = t[60]);
  ...
  t[61] !== Oe || t[62] !== je
    ...
    : (Me = t[63]);
  let Ne;
  t[64] !== fe || t[65] !== Z || t[66] !== De || t[67] !== Me || t[68] !== q
    ? ((Ne = (0, G.jsxs)(re, {
        as: `form`,
        onSubmit: q,
        className: `gap-0`,
  ...
  let Fe;
  return (
    t[77] !== Ne || t[78] !== Pe || t[79] !== K
      ? ((Fe = (0, G.jsxs)(ne, { open: !0, onOpenChange: K, size: `default`, children: [Ne, Pe] })),
        (t[77] = Ne),
        (t[78] = Pe),
        (t[79] = K),
        (t[80] = Fe))
...
function xe() {
  h.dispatchMessage(`electron-pick-workspace-root-option`, { allowMultiple: !0 });
}
function Se(e) {
  let t = (0, U.c)(28),
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = (0, G.jsx)(D, { className: `icon-3xs` })), (t[11] = p))
    : (p = t[11]);
  let m;
  ...
  t[17] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, G.jsx)(P, { className: `icon-sm shrink-0 text-token-description-foreground` })),
      (t[17] = h))
    : (h = t[17]);
  let g;
  t[18] === o
  ...
  t[20] !== g || t[21] !== u || t[22] !== m
    ? ((_ = (0, G.jsxs)(`div`, { className: u, children: [m, h, g] })),
      (t[20] = g),
      (t[21] = u),
      (t[22] = m),
      (t[23] = _))
  ...
  return (
    t[24] !== a || t[25] !== _ || t[26] !== d
      ? ((v = (0, G.jsx)(a, { tooltipContent: d, children: _ })),
        (t[24] = a),
        (t[25] = _),
        (t[26] = d),
        (t[27] = v))
...
function ke(e, { initialName: t, initialSources: n, project: r, showDeleteAction: i }) {
  F(e, ye, { initialName: t, initialSources: n, project: r, showDeleteAction: i });
}
function Ae() {
