...
import { c as le, f as ue, i as de, k as fe, p as pe, r as me, u as W } from "./vscode-api.js";
import { ar as he, mr as G } from "./src-1.js";
import { c as ge, n as K, o as q, r as _e } from "./lib.js";
import { t as ve } from "./clsx-Cir5-jBH.js";
import { t as J } from "./button-DO-oxX3-.js";
import { t as ye } from "./tooltip.js";
import { A as be, n as Y } from "./rpc-1.js";
import { f as xe } from "./statsig.js";
import { t as Se } from "./request.js";
import { d as Ce, n as we, t as Te } from "./thread-context-inputs.js";
import { n as Ee } from "./selectable-remote-connections-signal.js";
import { A as De } from "./sidebar-signals.js";
import { t as Oe } from "./use-global-state.js";
...
function $e(e) {
  ...
  t[14] === u.title
    ? (T = t[15])
    : ((T = (0, $.jsx)(q, { ...u.title })), (t[14] = u.title), (t[15] = T));
  let E;
  t[16] === u.subtitle
    ? (E = t[17])
    : ((E = (0, $.jsx)(q, { ...u.subtitle })), (t[16] = u.subtitle), (t[17] = E));
  let D;
  t[18] !== T || t[19] !== E
  ...
  let P;
  t[35] !== M || t[36] !== N
    ? ((P = (0, $.jsxs)(X, { className: `gap-2`, children: [M, N] })),
      (t[35] = M),
      (t[36] = N),
      (t[37] = P))
    : (P = t[37]);
  ...
  t[39] === s
    ? (ee = t[40])
    : ((ee = (0, $.jsx)(J, { color: `outline`, type: `button`, onClick: s, children: F })),
      (t[39] = s),
      (t[40] = ee));
  let I;
  ...
  t[42] === v
    ? (L = t[43])
    : ((L = (0, $.jsx)(J, { color: `primary`, type: `submit`, disabled: v, children: I })),
      (t[42] = v),
      (t[43] = L));
  let R;
  t[44] !== ee || t[45] !== L
    ? ((R = (0, $.jsx)(X, { children: (0, $.jsxs)(ze, { children: [ee, L] }) })),
      (t[44] = ee),
      (t[45] = L),
      (t[46] = R))
    : (R = t[46]);
  let z;
  t[47] !== S || t[48] !== P || t[49] !== R || t[50] !== D
    ? ((z = (0, $.jsxs)(Re, { as: `form`, onSubmit: S, children: [D, P, R] })),
      (t[47] = S),
      (t[48] = P),
      (t[49] = R),
      (t[50] = D),
...
function tt({ label: e, path: t, queryClient: n }) {
  n.setQueryData(me(`workspace-root-options`, { hostId: P }), (n) => {
    if (n == null) return n;
    if (e.length === 0) {
...
var nt = s(f, (e) => []),
  rt = c(f, (e, { get: t }) => t(nt, e).some((e) => t(T, e) === !0)),
  it = c(f, (e, { get: t }) => t(nt, e).filter((e) => t(b, e) === !0)),
  at = c(f, (e, { get: t }) => {
    let n = t(b, e);
...
var ct = c(f, (e, { get: t }) => {
    ...
    return ut({
      ...
      isResponseInProgress: t(T, e),
      resumeState: t(V, e) ?? (n == null ? null : `needs_resume`),
      threadRuntimeStatus: t(j, e) ?? n?.threadRuntimeStatus ?? null,
      latestTurnHasSystemError: t(C, e) === !0,
    });
  }),
  lt = c(f, (e, { get: t }) =>
    dt({
      pendingRequestType: t(E, e)?.type ?? null,
      requests: t(R, e),
      resumeState: t(V, e),
      threadRuntimeStatus: t(j, e),
    }),
  );
function ut({
...
function dt({ pendingRequestType: e, requests: t, resumeState: n, threadRuntimeStatus: r }) {
  return t == null || n == null
    ? null
    : n === `needs_resume`
      ? r?.type === `active` && r.activeFlags.includes(`waitingOnApproval`) && m(t)
        ? `approval`
...
var ft = e(g(), 1),
  ...
  Tt = u(f, () => ({
    ...
    queryFn: async () => {
      try {
        ...
        if (e instanceof le && (e.status === 401 || e.status === 403 || e.status === 404))
          return [];
        throw e;
      }
    },
  ...
  Et = o(f, ({ get: e }) => e(Ee) ?? []),
  Dt = o(f, ({ get: e }) =>
    (e(Ee) ?? []).filter((e) => e.autoConnect).sort((e, t) => e.hostId.localeCompare(t.hostId)),
  ),
  Ot = o(f, ({ get: e }) => new Set(e(Dt).map((e) => e.hostId))),
  kt = o(f, ({ get: e }) => tn(e).map((e) => e.id)),
  At = c(f, (e, { get: t }) => tn(t).find((t) => t.id === e) ?? null),
  jt = o(f, ({ get: e }) => {
    let t = e(De),
      n = e(Ot),
      r = new Set(),
    ...
    if (e(xe, `3314958849`))
      for (let n of e(ie, P)) {
        ...
        r.has(a) ||
          ...
          i.push({
            conversationId: a,
            at: $t(t === `updated_at` ? n.updatedAt : n.createdAt, n.createdAt),
          }));
      }
    for (let n of e(ne, P))
      r.has(n) || (e(B, n) ?? (r.add(n), i.push({ conversationId: n, at: Jt(e, n, t) })));
    for (let a of n)
      for (let n of e(ne, a))
        r.has(n) || (e(B, n) ?? (r.add(n), i.push({ conversationId: n, at: Jt(e, n, t) })));
    return i.length === 0
  ...
  Mt = c(f, (e, { get: t }) => t(Tt).data?.find((t) => t.id === e) ?? null),
  Nt = p(f, (e) => {
    let t = null;
    return o(f, ({ get: n }) => {
      let r = n(De),
        ...
        u = n(R, e),
        d = n(U, e),
        f = n(M, e)?.getConversation(e) ?? null,
        p = f ?? (d == null ? null : h(d));
      ...
      let m = {
        ...
        isInProgress:
          f == null
            ...
            : Xt({ latestTurnStatus: c, resumeState: o, turnCount: s }),
      };
      return t != null &&
        t.key === m.key &&
        t.at === m.at &&
  ...
  Pt = p(f, (e) => {
    ...
    return o(f, ({ get: n }) => {
      ...
      let i = { kind: `remote`, key: D(r.id), at: Qt(r, n(De)), task: r };
  ...
  Ft = p(f, (e) => {
    ...
    return o(f, ({ get: n }) => {
      let r = n(At, e);
      if (r == null) return ((t = null), null);
      let i = { kind: `pending-worktree`, key: se(r.id), at: r.createdAt, pendingWorktree: r };
      return t != null &&
        t.key === i.key &&
        t.at === i.at &&
  ...
  It = c(f, (e, { get: t }) => {
    ...
    switch (n?.kind) {
      case `local`:
        return t(t(Nt, n.conversationId));
      case `remote`:
        return t(t(Pt, n.taskId));
      case `pending-worktree`:
        return t(t(Ft, n.pendingWorktreeId));
      case void 0:
        return null;
    }
  }),
  Lt = c(f, (e, { get: t }) => {
    ...
    switch (n?.kind) {
      case `local`: {
        let e = t(O, n.conversationId) === !0,
          r = e ? null : t(U, n.conversationId);
        return !e && r == null
          ? null
          : {
              kind: `local`,
              ...
              cwd: t(I, n.conversationId) ?? r?.cwd ?? null,
              gitBranch: t(ae, n.conversationId) ?? r?.gitInfo?.branch ?? null,
              hostId: t(_, n.conversationId) ?? r?.hostId ?? null,
              source: t(ee, n.conversationId) ?? r?.source ?? null,
              summary: r ?? void 0,
              workspaceKind: t(S, n.conversationId) ?? r?.workspaceKind ?? null,
            };
      }
      case `remote`:
        return t(t(Pt, n.taskId));
  ...
  Rt = o(f, ({ get: e }) => {
    let t = e(De),
      n = (0, ft.default)(e(Tt).data ?? _t, `id`).map((e) => ({ key: D(e.id), at: Qt(e, t) })),
      r = e(jt).map((n) => ({ key: N(n), at: Jt(e, n, t) })),
      i = e(kt).flatMap((t) => {
        let n = e(At, t);
        return n == null ? [] : [{ key: se(n.id), at: n.createdAt }];
      });
    return Gt([...n, ...r, ...i]);
  }),
  zt = o(
      ...
      : Kt(
          e.map((e) => {
            ...
            switch (n?.kind) {
              ...
              case `pending-worktree`:
                return t(At, n.pendingWorktreeId)?.needsAttention === !0 ? `waiting` : `idle`;
              case void 0:
                return `idle`;
            }
          }),
...
function Yt(e, t) {
  ...
  switch (n?.kind) {
    case `local`:
      return Jt(e, n.conversationId, `updated_at`);
    case `remote`: {
      let t = e(Mt, n.taskId);
      return t == null ? 0 : Qt(t, `updated_at`);
    }
    case `pending-worktree`:
    case void 0:
      return 0;
...
function Xt({ latestTurnStatus: e, resumeState: t, turnCount: n }) {
  return t == null || t === `needs_resume` ? !1 : n === 0 ? t === `resuming` : e === `inProgress`;
}
function Zt(e) {
  return w(e.conversation)?.status === `inProgress`;
}
function Qt(e, t) {
  return (
    (t === `updated_at`
...
function en(e, t) {
  return e(O, t) ? e(at, t) === !0 : e(U, t)?.hasUnreadTurn === !0;
}
function tn(e) {
  return k(e, `pending_worktrees`) ?? pt;
}
function nn(e) {
  return e.flatMap((e) => {
    if (e.kind === `local`)
    ...
    if (e.kind === `remote`) {
      ...
      return n || !r ? [] : [{ kind: `remote`, taskId: e.task.id, threadKey: D(e.task.id) }];
    }
    return [];
  });
}
async function rn({ archiveableTasks: e, currentThreadKey: t }) {
  let n = await Promise.all(
      e.map(async (e) => {
        try {
          return (
            e.kind === `local`
              ? await z(`archive-conversation`, {
                  conversationId: e.conversationId,
                  source: `project_archive`,
                })
              : await Se.safePost(`/wham/tasks/{task_id}/archive`, {
...
var on = c(f, (e, { get: t }) =>
  an(t(t(Vt, e)), (e, n) => [...((t(b, e) ?? n) ? [e] : []), ...t(it, e)]),
);
async function sn(e) {
  await Promise.all(
    e.map(async (e) => {
      try {
        if (e.kind === `local`) {
          await z(`mark-conversation-as-read`, { conversationId: e.conversationId });
          return;
        }
        await Se.safePost(`/wham/tasks/{task_id}/mark_read`, {
          parameters: { path: { task_id: e.taskId } },
        });
      } catch {}
    }),
...
function cn(e) {
  ...
  let _;
  t[20] !== s || t[21] !== g
    ? ((_ = (0, $.jsx)(J, { color: `danger`, type: `submit`, disabled: s, children: g })),
      (t[20] = s),
      (t[21] = g),
      (t[22] = _))
    : (_ = t[22]);
...
function ln(e) {
  let t = (0, Z.c)(19),
    ...
    g = a(Wt, r),
    _;
  t[0] === g ? (_ = t[1]) : ((_ = nn(g)), (t[0] = g), (t[1] = _));
  let v = _,
    y;
  t[2] !== v ||
  t[3] !== i ||
    ...
    ? ((y = () => {
        v.length === 0 ||
          ...
          (async () => {
            ...
            } = await rn({ archiveableTasks: v, currentThreadKey: i });
            if (
  ...
  let b = y,
    x;
  return (
    t[13] !== v.length || t[14] !== b || t[15] !== m || t[16] !== s || t[17] !== n
      ? ((x = (0, $.jsx)(cn, {
          open: !0,
          onOpenChange: s,
          onConfirm: b,
...
function un({
  ...
  let a = l(f),
    o = ge(),
    [s, c] = (0, Q.useState)(!1),
    { data: u } = Oe(G.PROJECT_ORDER),
    { data: p } = Oe(G.PINNED_PROJECT_IDS),
    { data: m } = Oe(G.LOCAL_PROJECTS),
    h = d(Te).data?.roots,
    g = He.getId(e),
    _ = Y.projectWritableRoots?.clearRoots;
  return (0, $.jsx)(fn, {
    projectLabel: t,
    isRemoving: s,
      ...
      _ == null ||
        ...
        (async () => {
          try {
            ...
            a.get(ke).danger(o.formatMessage(mn.removeError, { projectLabel: t }));
          } finally {
            c(!1);
          }
        })());
...
function dn({ projectId: e, projectLabel: t, onOpenChange: n, onDropdownOpenChange: r }) {
  let i = l(f),
    a = ge(),
    [o, s] = (0, Q.useState)(!1),
    { data: c } = Oe(G.PROJECT_ORDER),
    { data: u } = Oe(G.PINNED_PROJECT_IDS),
          ...
          try {
            (await m(d.filter((t) => t.id !== e)),
              await Promise.all([
                ...
                v(i, G.PINNED_PROJECT_IDS, pn(u, e)),
              ]),
              p === e && Ue(i, null),
              n(!1),
              r(!1));
          } catch {
            i.get(ke).danger(a.formatMessage(mn.removeError, { projectLabel: t }));
          } finally {
            s(!1);
          }
        })());
...
function fn(e) {
  ...
  let _;
  t[18] !== g || t[19] !== h
    ? ((_ = (0, $.jsx)(J, { color: `danger`, type: `submit`, disabled: h, children: g })),
      (t[18] = g),
      (t[19] = h),
      (t[20] = _))
    : (_ = t[20]);
...
function hn({ entries: e, remoteConnections: t }) {
  let n = [],
    r = new Map(),
...
function gn({ groups: e, remoteConnections: t }) {
...
var Sn = [],
  ...
  wn = [],
  Tn = o(f, ({ get: e }) => [
    ...(k(e, `remote_ssh_connections`) ?? []),
    ...(k(e, `remote_control_connections`) ?? []),
  ]),
  En = u(f, () => ({
  ...
  Dn = de(f, `paths-exist`, (e) => ({
    enabled: e.length > 0,
    params: { hostId: P, paths: e },
    staleTime: W.FIVE_SECONDS,
  })),
  On = o(f, ({ get: e }) => {
    let t = e(re);
    return e(je, {
      params: {
        hostId: t,
        dirs: Je([], t, e(Ce).data?.roots, []).find(({ hostId: e }) => e === t)?.dirs ?? Cn,
      },
  ...
  kn = o(f, ({ get: e }) => {
    let t = e(Ce).data,
      n = e(On).data?.origins ?? wn,
      r = Bn(e);
    return Xe(
      [...We(t, n, e(we, void 0).data?.codexHome), ...Ye(H(e, G.LOCAL_PROJECTS)), ...Ge(r, e(Et))],
      H(e, G.PROJECT_ORDER),
    );
  }),
  An = o(f, ({ get: e }) => e(Ce).data?.roots),
  jn = o(f, ({ get: e }) => e(Ce).data?.labels ?? {}),
  Mn = c(f, (e, { get: t }) => {
    let n = t(Ce),
      r = n.data?.roots,
      i = n.data?.labels ?? {},
    ...
    let o = t(re),
      ...
      c = Bn(t),
      l = c.filter((e) => t(te, e.hostId) === `connected`),
      u = Je([], o, r, l),
      d = t(On),
      ...
      p = Object.fromEntries(u.map(({ hostId: e }, t) => [e, f[t]?.data?.origins ?? wn]));
    if (f.length > 0 && n.isLoading && f.every((e) => e.isLoading))
      return { ...a, isWorkspaceRootOptionsLoading: !0 };
    let m = Je(s, o, r, l, t(we, void 0).data?.codexHome),
      h = Ke(m, u),
      ...
      _ = Object.fromEntries(h.map(({ hostId: e }, t) => [e, g[t]?.data?.origins ?? wn])),
      v = Object.fromEntries(
        m.map(({ hostId: e }) => {
          let t = new Map((p[e] ?? wn).map((e) => [he(e.dir), e]));
          return (
            _[e]?.forEach((e) => {
              t.set(he(e.dir), e);
            }),
      ...
      y = Xe(
        [
          ...We(n.data, p[o] ?? wn, t(we, void 0).data?.codexHome),
          ...Ye(H(t, G.LOCAL_PROJECTS)),
          ...Ge(c, t(Et)),
        ],
        H(t, G.PROJECT_ORDER),
      ),
      b = {},
      x = s.some((e) => e.kind === `remote`),
      S = e.projectlessThreadIds == null ? void 0 : new Set(e.projectlessThreadIds);
    return {
      groups:
        s.length === 0
          ? y
          : qe(
              ...
              t(we, void 0).data?.codexHome,
              {
                gitOriginsByHostId: v,
                primaryHostId: o,
                remoteProjects: c,
                enabledRemoteHostIds: t(Ot),
                threadProjectAssignments: e.threadProjectAssignments,
                projectlessThreadIds: S,
                threadWorkspaceRootHints: H(t, G.THREAD_WORKSPACE_ROOT_HINTS),
  ...
  Nn = c(f, (e, { get: t }) => {
    let n = t(Tn).filter((e) => t(te, e.hostId) === `connected`);
    return vn(
      gn({ groups: hn({ entries: t(Wt, e), remoteConnections: t(Tn) }), remoteConnections: n }),
      H(t, G.CONNECTION_GROUP_ORDER),
    );
  }),
  Pn = c(f, (e, { get: t }) => Hn(e.groupIds, H(t, Vn(e.organizeMode)), e.organizeMode)),
  Fn = c(f, (e, { get: t }) => {
    let n = e ?? [],
      r = t(Dn, n).data;
    return {
      existingWorkspaceRootSet: new Set(
        (r?.existingPaths ?? []).map((e) => he(e).replace(/\/+$/, ``)),
      ),
...
function In(e, t) {
  ...
  if (n.length === 0 || e.get(x, G.THREAD_WORKSPACE_ROOT_HINTS).isLoading) return;
  let r = { ...H(e.get, G.THREAD_WORKSPACE_ROOT_HINTS) },
    i = !1;
  for (let [e, t] of n) r[e] !== t && ((r[e] = t), (i = !0));
  i && v(e, G.THREAD_WORKSPACE_ROOT_HINTS, r);
}
async function Ln(e, t, n, r) {
  if (!Un(n, r)) return;
  let i = Rn(t, n, r, H(e.get, Vn(t)));
  await v(e, Vn(t), i);
}
function Rn(e, t, n, r) {
  let i = Hn(t, r, e),
...
function Vn(e) {
  switch (e) {
    case `connection`:
      return G.CONNECTION_GROUP_ORDER;
    case `project`:
      return G.PROJECT_ORDER;
  }
}
function Hn(e, t, n) {
...
function Wn(e) {
  ...
  let c = s,
    u = ge(),
    d = l(f),
    { data: p } = Oe(G.LOCAL_PROJECTS),
    { data: m } = Oe(G.PROJECT_ORDER),
    h;
  t[2] !== r || t[3] !== p || t[4] !== m || t[5] !== d
    ? ((h = async (e) => {
        ...
        let i = Y.projectWritableRoots?.addRoot;
  ...
  let S;
  return (
    t[12] !== o || t[13] !== c || t[14] !== n || t[15] !== g || t[16] !== x
      ? ((S = (0, $.jsx)(Kn, {
          initialName: o,
          initialSources: c,
          onClose: n,
...
function Gn(e) {
  ...
  t[0] !== p || t[1] !== a || t[2] !== d || t[3] !== u
    ? ((m = async (e) => {
        let { name: t, sources: n } = e,
          r = Y.projectWritableRoots?.addRoot,
          i = Y.projectWritableRoots?.clearRoots;
  ...
  let h = m,
    g = a.projectId,
    _;
  t[5] === i ? (_ = t[6]) : ((_ = i.join(`\0`)), (t[5] = i), (t[6] = _));
  let y = `${g}:${r}:${_}`,
    b = s ? a : void 0,
    x,
    S,
...
function Kn(e) {
  let t = (0, Z.c)(81),
    ...
    [v, y] = (0, Q.useState)(i),
    b;
  t[0] === a ? (b = t[1]) : ((b = Ve(a)), (t[0] = a), (t[1] = b));
  ...
  (t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((j = (e) => {
      ...
      (t[3] = j))
    : (j = t[3]),
    pe(`workspace-root-option-picked`, j));
  let M = qn,
    N;
  t[4] !== D || t[5] !== v || t[6] !== o || t[7] !== s || t[8] !== c || t[9] !== g || t[10] !== x
    ? ((N = async (e) => {
        if ((e.preventDefault(), !D)) {
          O(!0);
          try {
            (await s({ name: v, sources: x }), o());
          } catch {
            (O(!1), g.get(ke).danger(c));
          }
        }
      }),
      (t[4] = D),
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((F = (e) => {
        (e.preventDefault(), w(!1), A(Yn(e.dataTransfer)));
      }),
      (t[12] = F))
    : (F = t[12]);
  let ee = F,
  ...
  t[18] === m
    ? (B = t[19])
    : ((B = (0, $.jsx)(Fe, { className: `contents`, children: m })), (t[18] = m), (t[19] = B));
  let te;
  t[20] === p
    ? (te = t[21])
    : ((te = (0, $.jsx)(Be, { className: `contents`, children: p })), (t[20] = p), (t[21] = te));
  let V;
  t[22] !== te || t[23] !== B
    ? ((V = (0, $.jsx)(X, { children: (0, $.jsx)(Ie, { title: B, subtitle: te }) })),
      (t[22] = te),
      (t[23] = B),
      (t[24] = V))
    : (V = t[24]);
  ...
  t[38] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ce = (e) => {
      ...
      (U = (e) => {
        (e.preventDefault(), (e.dataTransfer.dropEffect = `copy`), w(!0));
      }),
      (le = () => {
        w(!1);
      }),
      ...
      (t[39] = U),
      (t[40] = le))
    : ((ce = t[38]), (U = t[39]), (le = t[40]));
  let ue = C && `border-token-focus-border bg-token-bg-secondary`,
    de;
  t[41] === ue
    ? (de = t[42])
    : ((de = ve(
  ...
  t[53] === o
    ? (G = t[54])
    : ((G = (0, $.jsx)(J, { color: `ghost`, type: `button`, onClick: o, children: he })),
      (t[53] = o),
      (t[54] = G));
  let K;
  t[55] !== D || t[56] !== u
    ? ((K = (0, $.jsx)(J, { color: `primary`, type: `submit`, loading: D, children: u })),
      (t[55] = D),
      (t[56] = u),
      (t[57] = K))
    : (K = t[57]);
  let _e;
  t[58] !== G || t[59] !== K
    ? ((_e = (0, $.jsxs)(ze, { className: `w-auto`, children: [G, K] })),
      (t[58] = G),
      (t[59] = K),
      (t[60] = _e))
    : (_e = t[60]);
  ...
  t[61] !== W || t[62] !== _e
    ...
    : (ye = t[63]);
  let be;
  t[64] !== V || t[65] !== H || t[66] !== me || t[67] !== ye || t[68] !== z
    ? ((be = (0, $.jsxs)(Re, {
        as: `form`,
        onSubmit: z,
        className: `gap-0`,
    ...
    : (be = t[69]);
  let Y;
  t[70] !== n || t[71] !== r || t[72] !== i || t[73] !== T || t[74] !== o || t[75] !== _
    ? ((Y =
        T && n != null
          ? (0, $.jsx)(un, {
              project: n,
  ...
  let xe;
  return (
    t[77] !== be || t[78] !== Y || t[79] !== R
      ? ((xe = (0, $.jsxs)(Le, { open: !0, onOpenChange: R, size: `default`, children: [be, Y] })),
        (t[77] = be),
        (t[78] = Y),
        (t[79] = R),
        (t[80] = xe))
...
function qn() {
  ue.dispatchMessage(`electron-pick-workspace-root-option`, {});
}
function Jn(e) {
  let t = (0, Z.c)(28),
...
function $n(e) {
  Pe(e, Qe, {
    ...
    trimOnSave: !0,
    onSave: (e) => {
      ue.dispatchMessage(`electron-create-new-workspace-root-option`, { projectName: e });
    },
  });
}
function er(e) {
...
function tr(e, { initialName: t, initialSources: n, project: r, showDeleteAction: i }) {
  Pe(e, Gn, { initialName: t, initialSources: n, project: r, showDeleteAction: i });
}
function nr() {
  ue.dispatchMessage(`electron-add-new-workspace-root-option`, {});
}
function rr({ hostId: e, setActive: t } = {}) {
  ue.dispatchHostMessage({ type: `open-create-remote-project-modal`, hostId: e, setActive: t });
}
export {
  Ht as A,
  tt as B,
