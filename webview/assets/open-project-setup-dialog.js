...
import { Qi as d, n as f, z as p } from "./thread-context-inputs.js";
import { A as m, f as h, p as g, r as _ } from "./vscode-api.js";
import { Br as v } from "./src-3.js";
...
import { a as I, d as L, i as te, l as ne, n as re, r as ie, u as ae } from "./dialog-layout.js";
...
function ge({ projectId: e, projectLabel: t, onOpenChange: n, onDropdownOpenChange: r }) {
  let i = o(c),
    ...
    { data: f } = j(v.PINNED_PROJECT_IDS),
    { remoteProjects: p, selectedRemoteProjectId: m, setRemoteProjects: h } = M();
  return (0, G.jsx)(Z, {
    projectLabel: t,
    isRemoving: s,
    removeDisabled: !1,
          ...
          try {
            (await h(p.filter((t) => t.id !== e)),
              await Promise.all([
                ...
                d(i, v.PINNED_PROJECT_IDS, _e(f, e)),
              ]),
              m === e && B(i, null),
              n(!1),
              r(!1));
...
function ve(e) {
  ...
  t[2] !== r || t[3] !== m || t[4] !== h || t[5] !== p
    ? ((g = async (e) => {
        ...
        (await z.setWritableRootsQueryData(p, o.projectId, s), z.select(p, o));
      }),
      (t[2] = r),
      (t[3] = m),
      (t[4] = h),
    ...
    ? ((g = async (e) => {
        ...
        let o = await z.edit({
          ...
          updateWorkspaceRootLabel: (e, t) => {
            K({ label: t, path: e, queryClient: p });
          },
        });
        await z.setWritableRootsQueryData(f, z.getId(a), o);
      }),
      (t[0] = h),
      (t[1] = a),
      (t[2] = p),
