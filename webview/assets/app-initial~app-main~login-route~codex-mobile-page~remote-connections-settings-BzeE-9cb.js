...
import { oh as d, sh as f } from "./app-initial~app-main~onboarding-page.js";
var p,
  m = e(() => {
...
async function h(e, t, n, { shouldApplyStatus: r = () => !0 } = {}) {
  let a = e.get(c, t),
    o = await s(`set-remote-control-enabled-for-host`, { enabled: n, hostId: t }),
    l = e.get(c, t),
    u = l !== a && (l?.status === `connected` || l?.status === `errored`);
  return (r() && (!n || !u) && i(e, t, o), o);
}
var g = e(() => {
  (l(), n());
});
async function _(e, t, { force: n = !1 } = {}) {
  ...
  let i = ++b,
    a = h(e, r, t, { shouldApplyStatus: () => i === b });
  x = { enabled: t, promise: a };
  try {
    let n = await a;
    return i === b ? ((v = t), n) : (y != null && y !== t && (await _(e, y, { force: !0 })), n);
  } catch (e) {
    throw (i === b && v === t && (v = void 0), e);
  } finally {
...
var E,
  D = e(() => {
    (l(), t(), d(), (E = `token_invalidated`));
  });
export { _ as a, p as c, S as i, m as l, w as n, g as o, T as r, h as s, D as t };
//# sourceMappingURL=app-initial~app-main~login-route~codex-mobile-page~remote-connections-settings-BzeE-9cb.js.map
