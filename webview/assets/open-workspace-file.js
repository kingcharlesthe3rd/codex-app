...
import { Gr as t, Hr as n, Ur as r, Wr as i } from "./app-server-manager-signals.js";
import { n as a } from "./vscode-api.js";
import { Ji as o, Yn as s, gr as c, hn as l, sn as u, ua as d } from "./src-2.js";
import { t as f } from "./mime-types.js";
import { t as p, zr as m } from "./product-logger.js";
import { A as h, I as g } from "./rpc-Hf-fxjh7.js";
import { r as _ } from "./mcp-capability-signals.js";
import { t as v } from "./send-open-file-request.js";
var y = d({
  "openai/resource": d({ representation: o([`blob`, `text`]).optional() }).optional(),
}).passthrough();
function b(e, t) {
  let n = h(e),
    r = null,
...
function x(e, t) {
  return { file: { name: h(e), resourceUri: t } };
}
...
function z(e, r) {
  if (r === `image` || r === `pdf`) return `always`;
  if (r != null && r !== `text`) return `none`;
  let a = n(e);
  return r == null && a === `always`
    ? `always`
    : (r == null && a === `toggle`) || i(e) || I(e)
      ? `toggle`
      : r == null && t(e)
        ? `always`
        : `none`;
...
function U({
  ...
  let c = F(o),
    ...
    d = (0, H.lookup)(o);
  return {
    artifactImportKind: c?.importKind ?? `none`,
    artifactType: c?.artifactType ?? `none`,
    extension: r(o) ?? `none`,
    hostKind: W(n),
    mimeType: typeof d == `string` ? d : `unknown`,
    modifiedClick: i,
    outcome: K({
      artifactPresentationExists: c != null,
    ...
    reviewPreviewKind: l ?? `none`,
    unsupportedPreviewType: u ?? `none`,
    windowType: s,
  };
}
function W(e) {
  return e == null ? `unknown` : u(e) ? `remote` : `local`;
}
function G({
  contentKind: e,
  hasMcpCapabilityFileViewer: t,
  ...
  return n != null && !u(n) && !r && !t && !V(i, { contentKind: e });
}
function K({
...
function q({
  ...
  let P = {
    ...
    ...(i == null ? {} : { column: i }),
    ...(D == null ? {} : { openMode: D }),
    ...(j == null ? {} : { persistPreferredTargetPath: j }),
    ...(h == null ? {} : { hostId: h }),
  };
  if (M != null || D === `workspace` || j != null) {
    T(P);
    return;
  }
  let F = J({ browserSidebarEnabled: r, hostConfig: f, path: k });
  if (!C && F) {
    T({ path: k, cwd: o, ...(h == null ? {} : { hostId: h }) });
    return;
  }
  if (e != null && E) {
    let t = A();
    ...
    let r = o == null ? k : g(o, k),
      v = f != null && !u(f) ? f : null,
      E = S == null && d == null && b(r, e.get(_, h ?? `local`)) != null,
      D = () => (
        w?.(e),
        t(e, r, {
          ...(n == null ? {} : { artifactNavigationTarget: n }),
          ...(h == null ? {} : { hostId: h }),
          ...(S == null ? {} : { line: S }),
          ...(d == null ? {} : { endLine: d }),
          ...(y == null ? {} : { icon: y }),
      ...
      j = (t) => {
        ...
        p(
          ...
          U({
            ...
            hostConfig: f,
            modifiedClick: C,
            openedSidePanelTarget: D(),
            path: k,
            windowType: `electron`,
          }),
        );
      };
    if (v != null && S == null && i == null && d == null && !s(k) && c(r)) {
      a(`read-file-metadata`, {
        params: {
          contentSampleByteLimit: l,
...
function J({ browserSidebarEnabled: e, hostConfig: t, path: n }) {
  return e && t != null && !u(t) && s(n);
}
export {
  N as a,
  j as c,
