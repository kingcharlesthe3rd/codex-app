...
import { fr as t, hr as n, mr as r, pr as i } from "./thread-context-inputs.js";
import { n as a } from "./vscode-api.js";
import { Mr as o, Ta as s, la as c, or as l, un as u, yn as d } from "./src-1.js";
...
function z(e, i) {
  if (i === `image` || i === `pdf`) return `always`;
  if (i != null && i !== `text`) return `none`;
  let a = t(e);
  return i == null && a === `always`
    ? `always`
    : (i == null && a === `toggle`) || r(e) || I(e)
      ? `toggle`
      : i == null && n(e)
        ? `always`
        : `none`;
