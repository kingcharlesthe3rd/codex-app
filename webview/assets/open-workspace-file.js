...
import { dr as t, fr as n, mr as r, pr as i } from "./thread-context-inputs.js";
import { n as a } from "./vscode-api.js";
import { Mr as o, Ta as s, la as c, or as l, un as u, yn as d } from "./src-3.js";
import { A as f, L as p } from "./rpc-1.js";
import { Jr as m, t as h } from "./product-logger.js";
import { r as g } from "./mcp-capability-signals.js";
import { t as _ } from "./send-open-file-request.js";
import { t as v } from "./mime-types.js";
var y = s({
  "openai/resource": s({ representation: c([`blob`, `text`]).optional() }).optional(),
}).passthrough();
function b(e, t) {
  let n = f(e),
    r = null,
...
function x(e, t) {
  return { file: { name: f(e), resourceUri: t } };
}
...
function z(e, n) {
  if (n === `image` || n === `pdf`) return `always`;
  if (n != null && n !== `text`) return `none`;
  let a = t(e);
  return n == null && a === `always`
    ? `always`
    : (n == null && a === `toggle`) || i(e) || I(e)
      ? `toggle`
      : n == null && r(e)
        ? `always`
        : `none`;
...
function B(e, t) {
  ...
  let r = n(e),
    i = r == null ? null : (L.get(r) ?? null);
  if (
    i != null &&
    (t == null || t === `archive` || t === `binary` || (t === `text` && r === `rtf`))
  )
    return i;
  if (t == null) return null;
  switch (t) {
...
function q({
  ...
  if (!C && F) {
    T({ path: k, cwd: s, ...(v == null ? {} : { hostId: v }) });
    return;
  }
  if (e != null && E) {
    let t = A();
    ...
    let r = s == null ? k : p(s, k),
      _ = f != null && !u(f) ? f : null,
      E = S == null && c == null && b(r, e.get(g, v ?? `local`)) != null,
      D = () => (
        w?.(e),
        t(e, r, {
    ...
    if (_ != null && S == null && i == null && c == null && !l(k) && o(r)) {
      a(`read-file-metadata`, {
        params: {
          contentSampleByteLimit: d,
