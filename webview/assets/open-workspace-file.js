...
import { Br as t, Hr as n, Vr as r, zr as i } from "./app-server-manager-signals.js";
import { n as a } from "./vscode-api.js";
import { Fi as o, Gn as s, Zi as c, cn as l, gn as u, or as d } from "./src-1.js";
import { Fr as f, o as p } from "./persisted-signal.js";
import { A as m, I as h } from "./rpc-1.js";
import { r as g } from "./mcp-capability-signals.js";
import { t as _ } from "./send-open-file-request.js";
import { t as v } from "./mime-types.js";
var y = o([`blob`, `text`]),
  b = c({ "openai/resource": c({ representation: y.optional() }).optional() }).passthrough();
function x(e, t) {
  let n = m(e),
    r = null,
    i = 0;
...
function S(e, t) {
  return { file: { name: m(e), resourceUri: t } };
}
...
function P(e) {
  let n = t(e);
  return n == null ? null : (N.get(n) ?? null);
}
function F(e) {
  switch (e) {
    case `csv`:
...
function B(e, t) {
  ...
  let a = i(e);
  return t == null && a === `always`
    ? `always`
    : (t == null && a === `toggle`) || r(e) || L(e)
      ? `toggle`
      : t == null && n(e)
        ? `always`
        : `none`;
...
function V(e, n) {
  if (n === `image` || n === `pdf`) return null;
  let r = t(e),
    i = r == null ? null : (R.get(r) ?? null);
  if (
    i != null &&
    (n == null || n === `archive` || n === `binary` || (n === `text` && r === `rtf`))
  )
    return i;
...
function W({
  contentKind: e,
  hasMcpCapabilityFileViewer: n = !1,
  hostConfig: r,
  modifiedClick: i,
...
function G(e) {
  return e == null ? `unknown` : l(e) ? `remote` : `local`;
}
function K({
  contentKind: e,
  ...
  return n != null && !l(n) && !r && !t && !H(i, { contentKind: e });
}
function q({
...
function J({
  ...
  let P = Y({ browserSidebarEnabled: n, hostConfig: c, path: D });
  if (!S && P) {
    w({ path: D, cwd: i, ...(m == null ? {} : { hostId: m }) });
    return;
  }
  if (e != null && T) {
    let t = j();
    ...
    let n = i == null ? D : h(i, D),
      _ = c != null && !l(c) ? c : null,
      T = b == null && o == null && x(n, e.get(g, m ?? `local`)) != null,
      E = () => (
        C?.(e),
        t(e, n, {
          ...(m == null ? {} : { hostId: m }),
    ...
    if (_ != null && b == null && r == null && o == null && !s(D) && d(n)) {
      a(`read-file-metadata`, {
        params: {
          contentSampleByteLimit: u,
