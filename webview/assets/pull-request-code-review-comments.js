...
import { Ia as n, Ya as r, ka as i } from "./app-server-manager-signals.js";
...
function I({ currentComments: e, nextComments: t }) {
  let n = new Set(e.map(i)),
    r = t.filter((t) => e.some((e) => B({ currentComment: e, nextComment: t }))),
    a = t.filter((e) => F(e).length > 0 && !n.has(i(e)));
  return (0, P.default)([...r, ...a], i);
}
function L(e) {
  return {
...
function z({ comments: e, filePaths: t, workspaceRoot: r }) {
  let i = new Map();
  for (let a of e) {
    let e = t.find((e) => n(a.position.path, e, r ?? void 0));
