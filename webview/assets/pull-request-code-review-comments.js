...
import { wn as r } from "./src-4.js";
import { La as i, Wa as a, do as o } from "./app-server-manager-signals.js";
import { o as s } from "./lib-1.js";
import { t as c } from "./use-stable-callback.js";
import { Ht as l } from "./review-navigation-model.js";
import { n as u, r as d } from "./file-tree-search-input.js";
import { r as f } from "./right-panel-composer-overlay-scroll-reserve-B6Ik-236.js";
var p = {
  hunkLineCount: 50,
  lineHeight: 12 * 1.8,
  diffHeaderHeight: 0,
...
function m(e) {
  ...
  return {
    ...
    fileGap: g(t.getPropertyValue(`--diffs-gap-block`), p.fileGap),
  };
}
function h(e, t) {
  return (
...
function b(e) {
  let t = (0, v.c)(41),
    ...
    _ = h === void 0 ? !1 : h,
    b;
  t[0] === a ? (b = t[1]) : ((b = a == null ? null : r(a)), (t[0] = a), (t[1] = b));
  let T = b,
    E;
...
function R({ comments: e, filePaths: t, workspaceRoot: n }) {
  let r = new Map();
  for (let i of e) {
    let e = t.find((e) => a(i.position.path, e, n ?? void 0));
