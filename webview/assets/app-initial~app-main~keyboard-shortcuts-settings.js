...
import { Bv as c, Vv as l, qv as u } from "./app-initial~app-main~onboarding-page.js";
import {
  h as d,
  m as f,
...
function p(e, t) {
  return `titleIntlId` in e
    ? h(g, e.titleIntlId)
      ? t.formatMessage(g[e.titleIntlId])
      : ``
    : t.formatMessage(_[e.electron.menuTitleIntlId]);
}
function m(e, t, n) {
  let r =
    u(e) && h(v, e.descriptionIntlId)
      ? t.formatMessage(v[e.descriptionIntlId], { appName: f })
      : ``;
  return { title: n?.title ?? p(e, t), description: n?.description ?? r };
}
function h(e, t) {
...
function w(e) {
  return e.kind !== `webview` || e.commandMenuGroupKey == null
    ? l.length
    : l.indexOf(e.commandMenuGroupKey);
}
var T = e(() => {
  c();
});
function E(e) {
  ...
  return (
    t[29] !== S || t[30] !== C
      ? ((w = (0, O.jsxs)(`div`, { className: `relative`, children: [S, C] })),
        (t[29] = S),
        (t[30] = C),
        (t[31] = w))
      : (w = t[31]),
...
export { S as a, m as c, T as i, y as l, k as n, b as o, C as r, x as s, E as t };
//# sourceMappingURL=app-initial~app-main~keyboard-shortcuts-settings.js.map
