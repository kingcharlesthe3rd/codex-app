...
function Te(...e) {
  let t = -1,
    n;
  for (; ++t < e.length; ) (j(e[t]), e[t] && (n = n === void 0 ? e[t] : n + `/` + e[t]));
  ...
  Be = e(() => {
    (xe(),
      ...
      (ze = class {
        constructor(e) {
          let t;
          ((t = e ? (Me(e) ? { path: e } : typeof e == `string` || Re(e) ? { value: e } : e) : {}),
        ...
        set basename(e) {
          (P(e, `basename`), N(e, `basename`), (this.path = M.join(this.dirname || ``, e)));
        }
        get dirname() {
          return typeof this.path == `string` ? M.dirname(this.path) : void 0;
        }
        set dirname(e) {
          (Le(this.basename, `dirname`), (this.path = M.join(e || ``, this.basename)));
        }
        get extname() {
        ...
        set path(e) {
          (Me(e) && (e = Pe(e)), P(e, `path`), this.path !== e && this.history.push(e));
        }
        get stem() {
...
function We(e) {
  if (!me(e) || typeof e.type != `string`) throw TypeError("Expected node, got `" + e + "`");
}
function Ge(e, t, n) {
        ...
        use(e, ...t) {
          ...
          function s(e, t) {
            ...
            if (i === -1) n.push([e, ...t]);
              ...
              let [r, ...a] = t,
                o = n[i][1];
              (me(o) && me(r) && (r = (0, B.default)(!0, o, r)), (n[i] = [e, r, ...a]));
            }
          }
        }
      }),
...
var H,
  U,
  wt = e(() => {
    (ue(), k(), D(), ut(), (H = `phrasing`), (U = [`autolink`, `link`, `image`, `label`]));
  }),
  Tt = e(() => {
    wt();
  });
...
function At(e) {
  ...
  (n.type, (n.identifier = g(this.sliceSerialize(e)).toLowerCase()), (n.label = t));
}
function jt(e) {
  this.exit(e);
}
...
function Dn(e, t, n) {
  ...
  function l(t) {
    return t === null || ee(t) || E(t) || b(t) || y(t) ? n(t) : e.attempt(q, e.attempt(J, u), n)(t);
  }
  function u(n) {
...
function Nn(e) {
  return (
    e === null || e === 40 || e === 42 || e === 95 || e === 91 || e === 93 || e === 126 || E(e)
  );
}
function Pn(e) {
  return !p(e);
...
function Kn(e, t, n) {
  ...
  function l(s) {
    if (a > 999 || (s === 93 && !o) || s === null || s === 91 || E(s)) return n(s);
    if (s === 93) {
      e.exit(`chunkString`);
...
function qn(e, t, n) {
  ...
  function u(t) {
    if (o > 999 || (t === 93 && !s) || t === null || t === 91 || E(t)) return n(t);
    if (t === 93) {
      e.exit(`chunkString`);
