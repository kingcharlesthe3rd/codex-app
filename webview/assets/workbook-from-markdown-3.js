...
function qe(e) {
  if (!O(e) || typeof e.type != `string`) throw TypeError("Expected node, got `" + e + "`");
}
function Je(e, t, n) {
        ...
        use(e, ...t) {
          ...
          function s(e, t) {
            ...
            if (i === -1) n.push([e, ...t]);
              ...
              let [r, ...a] = t,
                o = n[i][1];
              (O(o) && O(r) && (r = (0, L.default)(!0, o, r)), (n[i] = [e, r, ...a]));
            }
          }
        }
      }),
...
function Et(e, t) {
  ...
  return (e.index === 0 || c(n) || h(n)) && (!t || n !== 47);
}
var z,
  B,
  Dt = e(() => {
    (se(), D(), r(), pt(), (z = `phrasing`), (B = [`autolink`, `link`, `image`, `label`]));
  }),
  Ot = e(() => {
    Dt();
  });
...
function bn(e, t, n, r) {
  let i = e.children[0],
    ...
    s = n.createTracker(r);
  a && s.move(o);
  let c = fe.listItem(e, t, n, { ...r, ...s.current() });
...
function On(e, t, n) {
  ...
  function c(t) {
    return H(t) ? (e.consume(t), c) : t === 64 ? (e.consume(t), l) : n(t);
  }
  function l(t) {
    return t === 46
      ? e.check(Bn, d, u)(t)
...
function An(e, t, n) {
  ...
  function l(t) {
    if (o(t) && i.length < 5) return ((i += String.fromCodePoint(t)), e.consume(t), l);
    if (t === 58) {
      let n = i.toLowerCase();
      if (n === `http` || n === `https`) return (e.consume(t), u);
    }
    return n(t);
  }
  function u(t) {
    return t === 47 ? (e.consume(t), a ? d : ((a = !0), u)) : n(t);
  }
  function d(t) {
    return t === null || C(t) || f(t) || c(t) || h(t) ? n(t) : e.attempt(W, e.attempt(G, p), n)(t);
  }
  function p(n) {
...
function Pn(e, t, n) {
  ...
  function i(e) {
    return e === null || e === 40 || e === 91 || f(e) || c(e) ? t(e) : r(e);
  }
  function a(e) {
    return o(e) ? s(e) : n(e);
  }
  function s(t) {
    return t === 59 ? (e.consume(t), r) : o(t) ? (e.consume(t), s) : n(t);
  }
}
function Fn(e, t, n) {
  return r;
...
function In(e) {
  return (
    e === null || e === 40 || e === 42 || e === 95 || e === 91 || e === 93 || e === 126 || f(e)
  );
}
function Ln(e) {
  return !o(e);
...
function qn(e, t, n) {
  ...
  function u(t) {
    ...
    return (f(t) || (s = !0), o++, e.consume(t), t === 92 ? p : u);
  }
  function p(t) {
  ...
  function m(t) {
    return t === 58
      ? (e.enter(`definitionMarker`),
        ...
        _(e, h, `gfmFootnoteDefinitionWhitespace`))
      : n(t);
  }
  function h(e) {
    return t(e);
...
function Jn(e, t, n) {
  return e.check(b, t, e.attempt(Zn, t, n));
}
function Yn(e) {
...
function Xn(e, t, n) {
  let r = this;
  return _(e, i, `gfmFootnoteDefinitionIndent`, 5);
  function i(e) {
...
var Zn,
  Qn = e(() => {
    (re(), s(), r(), u(), (Zn = { tokenize: Xn, partial: !0 }));
  }),
  $n = e(() => {
    Qn();
  });
function er(e) {
      ...
      if (
        ...
        for (; r--; )
          if (
            ...
            (s && y(o, o.length, 0, ee(s, e.slice(r + 1, n), t)),
              y(o, o.length, 0, [
                [`exit`, a, t],
                [`enter`, e[n][1], t],
                [`exit`, e[n][1], t],
  ...
  function i(e, n, r) {
    ...
    return c;
    function c(t) {
      return i === 126 && o[o.length - 1][1].type !== `characterEscape`
        ? r(t)
...
function lr(e, t, n) {
  ...
  function d(t) {
    return t === null || t === 124 || f(t)
      ? (e.exit(`data`), u(t))
      : (e.consume(t), t === 92 ? m : d);
  }
  function m(t) {
  ...
  function g(t) {
    return t === 45 || t === 58
      ? v(t)
      : t === 124
        ? ((o = !0), e.enter(`tableCellDivider`), e.consume(t), e.exit(`tableCellDivider`), ee)
        : C(t);
  }
  function ee(t) {
    return p(t) ? _(e, v, `whitespace`)(t) : v(t);
  }
  function v(t) {
    return t === 58
      ? ((a += 1),
    ...
    return t === 45
      ...
      : t === 58
        ? ((o = !0),
          ...
          e.exit(`tableDelimiterMarker`),
          te)
        : (e.exit(`tableDelimiterFiller`), te(t));
  }
  function te(t) {
    return p(t) ? _(e, x, `whitespace`)(t) : x(t);
  }
  function x(n) {
    return n === 124
      ? g(n)
...
function hr(e, t, n) {
  ...
  function s(r) {
    return S(r) ? t(r) : p(r) ? e.check({ tokenize: gr }, t, n)(r) : n(r);
  }
}
function gr(e, t, n) {
  return _(e, r, `whitespace`);
  function r(e) {
    return e === null ? n(e) : t(e);
  }
}
var _r,
  vr = e(() => {
    (s(), r(), (_r = { name: `tasklistCheck`, tokenize: hr }));
  }),
  yr = e(() => {
    vr();
  });
function br(e) {
  return g([Dn(), Un(), er(e), cr(), mr()]);
}
var xr = e(() => {
  (ie(), Hn(), $n(), nr(), pr(), yr());
});
