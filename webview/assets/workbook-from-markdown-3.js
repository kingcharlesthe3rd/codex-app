...
function Ee(...e) {
  let t = -1,
    n;
  for (; ++t < e.length; ) (A(e[t]), e[t] && (n = n === void 0 ? e[t] : n + `/` + e[t]));
...
var j,
  ke = e(() => {
    j = { basename: Ce, dirname: we, extname: Te, join: Ee, sep: `/` };
  });
function Ae() {
  return `/`;
}
...
function N(e, t) {
  if (e && e.includes(j.sep))
    throw Error("`" + t + "` cannot be a path: did not expect `" + j.sep + "`");
}
function P(e, t) {
  ...
  Be = e(() => {
    (Se(),
      ...
      (ze = class {
        constructor(e) {
          let t;
          ((t = e ? (M(e) ? { path: e } : typeof e == `string` || Re(e) ? { value: e } : e) : {}),
            (this.cwd = `cwd` in t ? `` : je.cwd()),
            (this.data = {}),
            (this.history = []),
            (this.messages = []),
            this.value,
        ...
        set basename(e) {
          (P(e, `basename`), N(e, `basename`), (this.path = j.join(this.dirname || ``, e)));
        }
        get dirname() {
          return typeof this.path == `string` ? j.dirname(this.path) : void 0;
        }
        set dirname(e) {
          (Le(this.basename, `dirname`), (this.path = j.join(e || ``, this.basename)));
        }
        get extname() {
        ...
        set path(e) {
          (M(e) && (e = Pe(e)), P(e, `path`), this.path !== e && this.history.push(e));
        }
        get stem() {
        ...
        set stem(e) {
          (P(e, `stem`),
            N(e, `stem`),
            (this.path = j.join(this.dirname || ``, e + (this.extname || ``))));
        }
        fail(e, t, n) {
...
function qe(e) {
  if (!he(e) || typeof e.type != `string`) throw TypeError("Expected node, got `" + e + "`");
}
function Je(e, t, n) {
  if (!n) throw Error("`" + e + "` finished async. Use `" + t + "` instead");
}
function I(e) {
  return Ye(e) ? e : new ze(e);
}
function Ye(e) {
  return !!(e && typeof e == `object` && `message` in e && `messages` in e);
}
function Xe(e) {
  return typeof e == `string` || Ze(e);
}
function Ze(e) {
  return !!(e && typeof e == `object` && `byteLength` in e && `byteOffset` in e);
}
    ...
    (pe(),
      ...
      ($e = class e extends He {
        ...
        copy() {
          ...
          return (t.data((0, L.default)(!0, {}, this.namespace)), t);
        }
        data(e, t) {
          return typeof e == `string`
            ? arguments.length === 2
              ? (Ke(`data`, this.frozen), (this.namespace[e] = t), this)
              : (Qe.call(this.namespace, e) && this.namespace[e]) || void 0
            : e
              ? (Ke(`data`, this.frozen), (this.namespace = e), this)
              : this.namespace;
        }
        freeze() {
        ...
        parse(e) {
          ...
          return (We(`parse`, n), n(String(t), t));
        }
        process(e, t) {
          let n = this;
          return (
            this.freeze(),
            We(`process`, this.parser || this.Parser),
            Ge(`process`, this.compiler || this.Compiler),
          ...
          function r(r, i) {
            ...
            n.run(o, a, function (e, t, r) {
              ...
              let i = t,
                a = n.stringify(i, r);
              (Xe(a) ? (r.value = a) : (r.result = a), s(e, r));
            });
            function s(e, n) {
        ...
        processSync(e) {
          ...
          return (
            this.freeze(),
            We(`processSync`, this.parser || this.Parser),
            Ge(`processSync`, this.compiler || this.Compiler),
            this.process(e, r),
            Je(`processSync`, `process`, t),
            n
          );
          function r(e, r) {
            ((t = !0), fe(e), (n = r));
        ...
        runSync(e, t) {
          let n = !1,
            r;
          return (this.run(e, t, i), Je(`runSync`, `run`, n), r);
          function i(e, t) {
            (fe(e), (r = t), (n = !0));
          }
        }
        stringify(e, t) {
          ...
          return (Ge(`stringify`, r), qe(e), r(e, n));
        }
        use(e, ...t) {
          let n = this.attachers,
            r = this.namespace;
          if ((Ke(`use`, this.frozen), e != null))
          ...
          function a(e) {
            ...
            (o(e.plugins), e.settings && (r.settings = (0, L.default)(!0, r.settings, e.settings)));
          }
          function o(e) {
            let t = -1;
            if (e != null)
          ...
          function s(e, t) {
            ...
            if (i === -1) n.push([e, ...t]);
              ...
              let [r, ...a] = t,
                o = n[i][1];
              (he(o) && he(r) && (r = (0, L.default)(!0, o, r)), (n[i] = [e, r, ...a]));
            }
          }
        }
      }),
...
function lt(e) {
  ...
  for (; ++r < n.length; ) {
    let e = n[r];
    t.push([ut(e[0]), dt(e[1])]);
  }
  return t;
}
function ut(e) {
  return typeof e == `string` ? new RegExp(ot(e), `g`) : e;
}
function dt(e) {
...
function mt() {
  return {
    ...
    exit: {
      literalAutolink: bt,
      literalAutolinkEmail: yt,
      literalAutolinkHttp: _t,
      literalAutolinkWww: vt,
    },
  };
}
function ht() {
  return {
    unsafe: [
      ...
      { character: `.`, before: `[Ww]`, after: `[\\-.\\w]`, inConstruct: z, notInConstruct: B },
      { character: `:`, before: `[ps]`, after: `\\/`, inConstruct: z, notInConstruct: B },
    ],
  };
}
function gt(e) {
...
function St(e, t, n, r, i) {
  let a = ``;
  if (!Et(i) || (/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !wt(n))) return !1;
  let o = Tt(n + r);
  if (!o[0]) return !1;
  let s = {
    type: `link`,
...
function Et(e, t) {
  ...
  return (e.index === 0 || h(n) || p(n)) && (!t || n !== 47);
}
var z,
  B,
  Dt = e(() => {
    (ae(), O(), C(), pt(), (z = `phrasing`), (B = [`autolink`, `link`, `image`, `label`]));
  }),
  Ot = e(() => {
    Dt();
  });
...
function zt() {
  return {
    enter: {
      ...
      gfmFootnoteCall: At,
      gfmFootnoteDefinitionLabelString: jt,
...
function Bt(e) {
  ...
  return (
    ...
    {
      handlers: { footnoteDefinition: n, footnoteReference: Rt },
      ...
      e.children &&
        ...
        (o += a.move(
          (t
            ? `
`
            : ` `) + r.indentLines(r.containerFlow(e, a.current()), t ? Ht : Vt),
        ))),
      s(),
      o
    );
...
function Gt() {
  return { canContainEols: [`delete`], enter: { strikethrough: qt }, exit: { strikethrough: Jt } };
}
function Kt() {
  return {
    unsafe: [{ character: `~`, inConstruct: `phrasing`, notInConstruct: Zt }],
    handlers: { delete: Yt },
  };
}
function qt(e) {
...
function on() {
  return {
    enter: { table: sn, tableData: un, tableHeader: un, tableRow: ln },
    exit: { codeText: dn, table: cn, tableData: V, tableHeader: V, tableRow: V },
  };
}
function sn(e) {
  let t = e._align;
...
`),
  ...
  function l(e, t) {
    return tn(e, { align: t, alignDelimiters: r, padding: n, stringLength: i });
  }
  function u(e, t, n) {
    let r = e.children,
      i = -1,
...
function gn() {
  return {
    exit: { taskListCheckValueChecked: vn, taskListCheckValueUnchecked: vn, paragraph: yn },
  };
}
function _n() {
  return { unsafe: [{ atBreak: !0, character: `-`, after: `[:|-]` }], handlers: { listItem: bn } };
}
function vn(e) {
...
function bn(e, t, n, r) {
  let i = e.children[0],
    ...
    s = n.createTracker(r);
  a && s.move(o);
  let c = de.listItem(e, t, n, { ...r, ...s.current() });
...
function Cn() {
  return [mt(), zt(), Gt(), on(), gn()];
}
function wn(e) {
  return { extensions: [ht(), Bt(e), Kt(), pn(e), _n()] };
}
var Tn = e(() => {
    (Ot(), Wt(), $t(), hn(), Sn());
  }),
...
function On(e, t, n) {
  ...
  return c;
  function c(t) {
    return !H(t) || !Rn.call(r, r.previous) || U(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`), e.enter(`literalAutolinkEmail`), l(t));
  }
  function l(t) {
    return H(t) ? (e.consume(t), l) : t === 64 ? (e.consume(t), u) : n(t);
  }
  function u(t) {
    return t === 46
      ? e.check(Bn, f, d)(t)
  ...
  function d(t) {
    return (e.consume(t), (i = !0), u);
  }
  function f(o) {
    return a && i && s(r.previous)
...
function kn(e, t, n) {
  ...
  return i;
  function i(t) {
    return (t !== 87 && t !== 119) || !In.call(r, r.previous) || U(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`),
        e.enter(`literalAutolinkWww`),
        e.check(zn, e.attempt(W, e.attempt(G, a), n), n)(t));
  }
  function a(n) {
...
function An(e, t, n) {
  ...
  return o;
  function o(t) {
    return (t === 72 || t === 104) && Ln.call(r, r.previous) && !U(r.events)
      ? (e.enter(`literalAutolink`),
  ...
  function c(t) {
    if (s(t) && i.length < 5) return ((i += String.fromCodePoint(t)), e.consume(t), c);
    if (t === 58) {
      let n = i.toLowerCase();
  ...
  function u(t) {
    return t === null || m(t) || S(t) || h(t) || p(t) ? n(t) : e.attempt(W, e.attempt(G, d), n)(t);
  }
  function d(n) {
...
function Pn(e, t, n) {
  ...
  function i(e) {
    return e === null || e === 40 || e === 91 || S(e) || h(e) ? t(e) : r(e);
  }
  function a(e) {
    return s(e) ? o(e) : n(e);
  }
  function o(t) {
    return t === 59 ? (e.consume(t), r) : s(t) ? (e.consume(t), o) : n(t);
  }
}
function Fn(e, t, n) {
  return r;
...
function H(e) {
  return e === 43 || e === 45 || e === 46 || e === 95 || o(e);
}
function U(e) {
  let t = e.length,
    n = !1;
...
var zn,
  ...
  Vn = e(() => {
    for (
      C(),
        zn = { tokenize: jn, partial: !0 },
        W = { tokenize: Mn, partial: !0 },
        G = { tokenize: Nn, partial: !0 },
        K = { tokenize: Pn, partial: !0 },
        Bn = { tokenize: Fn, partial: !0 },
        q = { name: `wwwAutolink`, tokenize: kn, previous: In },
        J = { name: `protocolAutolink`, tokenize: An, previous: Ln },
        Y = { name: `emailAutolink`, tokenize: On, previous: Rn },
        X = {},
        Z = 48;
      Z < 123;
    )
...
function Wn(e, t, n) {
  ...
  function s(i) {
    ...
    let s = u(r.sliceSerialize({ start: o.end, end: r.now() }));
...
function Kn(e, t, n) {
  ...
  function l(s) {
    ...
    if (s === 93) {
      ...
      return i.includes(u(r.sliceSerialize(a)))
        ? (e.enter(`gfmFootnoteCallLabelMarker`),
          e.consume(s),
          e.exit(`gfmFootnoteCallLabelMarker`),
    ...
    return (S(s) || (o = !0), a++, e.consume(s), s === 92 ? d : l);
  }
  function d(t) {
...
function qn(e, t, n) {
  ...
  function d(t) {
    ...
    return (S(t) || (s = !0), o++, e.consume(t), t === 92 ? f : d);
  }
  function f(t) {
  ...
  function p(t) {
    return t === 58
      ? (e.enter(`definitionMarker`),
        ...
        D(e, m, `gfmFootnoteDefinitionWhitespace`))
      : n(t);
  }
  function m(e) {
    return t(e);
...
function Jn(e, t, n) {
  return e.check(ne, t, e.attempt(Zn, t, n));
}
function Yn(e) {
...
function Xn(e, t, n) {
  let r = this;
  return D(e, i, `gfmFootnoteDefinitionIndent`, 5);
  function i(e) {
...
var Zn,
  Qn = e(() => {
    (E(), v(), C(), c(), (Zn = { tokenize: Xn, partial: !0 }));
  }),
  $n = e(() => {
    Qn();
  });
function er(e) {
  let t = (e || {}).singleTilde,
    n = { name: `strikethrough`, tokenize: a, resolveAll: r };
  return (
      ...
      if (
        ...
        for (; r--; )
          if (
            ...
            (c && i(s, s.length, 0, te(c, e.slice(r + 1, n), t)),
              i(s, s.length, 0, [
                [`exit`, o, t],
                [`enter`, e[n][1], t],
                [`exit`, e[n][1], t],
...
function lr(e, t, n) {
  ...
  function c(e) {
    ...
    let r = t > -1 ? i.events[t][1].type : null,
      a = r === `tableHead` || r === `tableRow` ? w : l;
    return a === w && i.parser.lazy[i.now().line] ? n(e) : a(e);
  }
  function l(t) {
    return (e.enter(`tableHead`), e.enter(`tableRow`), u(t));
  }
  function u(e) {
    return e === 124 ? d(e) : ((s = !0), (o += 1), d(e));
  }
  function d(t) {
    return t === null
      ? n(t)
      : r(t)
        ...
        : f(t)
          ...
          : ((o += 1),
            s && ((s = !1), (a += 1)),
            t === 124
              ? (e.enter(`tableCellDivider`), e.consume(t), e.exit(`tableCellDivider`), (s = !0), d)
              : (e.enter(`data`), p(t)));
  }
  function p(t) {
  ...
  function g(t) {
    return t === 45 || t === 58
      ? v(t)
      : t === 124
        ? ((s = !0), e.enter(`tableCellDivider`), e.consume(t), e.exit(`tableCellDivider`), _)
        : C(t);
  }
  function _(t) {
    return f(t) ? D(e, v, `whitespace`)(t) : v(t);
  }
  function v(t) {
    return t === 58
      ? ((o += 1),
  ...
  function ee(t) {
    return t === 45 ? (e.enter(`tableDelimiterFiller`), y(t)) : C(t);
  }
  function y(t) {
    return t === 45
      ? (e.consume(t), y)
  ...
  function b(t) {
    return f(t) ? D(e, x, `whitespace`)(t) : x(t);
  }
  function x(n) {
    return n === 124
      ? g(n)
  ...
  function T(n) {
    return n === 124
      ? (e.enter(`tableCellDivider`), e.consume(n), e.exit(`tableCellDivider`), T)
      : n === null || r(n)
        ? (e.exit(`tableRow`), t(n))
        : f(n)
          ? D(e, T, `whitespace`)(n)
...
function hr(e, t, n) {
  ...
  function c(i) {
    return r(i) ? t(i) : f(i) ? e.check({ tokenize: gr }, t, n)(i) : n(i);
  }
}
function gr(e, t, n) {
  return D(e, r, `whitespace`);
  function r(e) {
    return e === null ? n(e) : t(e);
  }
}
var _r,
  vr = e(() => {
    (v(), C(), (_r = { name: `tasklistCheck`, tokenize: hr }));
  }),
  yr = e(() => {
    vr();
  });
function br(e) {
  return d([Dn(), Un(), er(e), cr(), mr()]);
}
var xr = e(() => {
  (g(), Hn(), $n(), nr(), pr(), yr());
});
function Sr(e) {
  ...
  (i.push(br(n)), a.push(Cn()), o.push(wn(n)));
}
var Cr,
  wr = e(() => {
    (En(), xr(), (Cr = {}));
...
//# sourceMappingURL=workbook-from-markdown-3.js.map
