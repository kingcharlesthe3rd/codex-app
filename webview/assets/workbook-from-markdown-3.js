...
var A,
  Ae = e(() => {
    A = { basename: we, dirname: Te, extname: Ee, join: De, sep: `/` };
  });
function je() {
  return `/`;
}
...
var P,
  ...
  Ve = e(() => {
    (Ce(),
      ...
      Ne(),
      Le(),
      (P = [`history`, `path`, `basename`, `stem`, `extname`, `dirname`]),
      (Be = class {
        constructor(e) {
          let t;
          ((t = e ? (j(e) ? { path: e } : typeof e == `string` || ze(e) ? { value: e } : e) : {}),
            (this.cwd = `cwd` in t ? `` : Me.cwd()),
            (this.data = {}),
            (this.history = []),
            (this.messages = []),
            this.value,
          ...
          let r;
          for (r in t) P.includes(r) || (this[r] = t[r]);
        }
        get basename() {
          return typeof this.path == `string` ? A.basename(this.path) : void 0;
        }
        set basename(e) {
          (N(e, `basename`), M(e, `basename`), (this.path = A.join(this.dirname || ``, e)));
        }
        get dirname() {
          return typeof this.path == `string` ? A.dirname(this.path) : void 0;
        }
        set dirname(e) {
          (Re(this.basename, `dirname`), (this.path = A.join(e || ``, this.basename)));
        }
        get extname() {
          return typeof this.path == `string` ? A.extname(this.path) : void 0;
        }
        set extname(e) {
          if ((M(e, `extname`), Re(this.dirname, `extname`), e)) {
        ...
        set path(e) {
          (j(e) && (e = Fe(e)), N(e, `path`), this.path !== e && this.history.push(e));
        }
        get stem() {
...
function Ge(e) {
  if (!ge(e) || typeof e.type != `string`) throw TypeError("Expected node, got `" + e + "`");
}
function Ke(e, t, n) {
  if (!n) throw Error("`" + e + "` finished async. Use `" + t + "` instead");
}
function R(e) {
  return qe(e) ? e : new Be(e);
}
function qe(e) {
    ...
    (me(),
      ...
      (Ze = class e extends Ue {
        ...
        copy() {
          ...
          return (t.data((0, z.default)(!0, {}, this.namespace)), t);
        }
        data(e, t) {
          return typeof e == `string`
            ? arguments.length === 2
              ? (L(`data`, this.frozen), (this.namespace[e] = t), this)
              : (Xe.call(this.namespace, e) && this.namespace[e]) || void 0
            : e
              ? (L(`data`, this.frozen), (this.namespace = e), this)
              : this.namespace;
        }
        freeze() {
        ...
        process(e, t) {
          ...
          return (
            ...
            I(`process`, this.compiler || this.Compiler),
          ...
          function r(r, i) {
            ...
            n.run(o, a, function (e, t, r) {
              ...
              let i = t,
                a = n.stringify(i, r);
              (Je(a) ? (r.value = a) : (r.result = a), s(e, r));
            });
            function s(e, n) {
        ...
        processSync(e) {
          ...
          return (
            ...
            I(`processSync`, this.compiler || this.Compiler),
            this.process(e, r),
            Ke(`processSync`, `process`, t),
            n
          );
          function r(e, r) {
            ((t = !0), pe(e), (n = r));
        ...
        runSync(e, t) {
          let n = !1,
            r;
          return (this.run(e, t, i), Ke(`runSync`, `run`, n), r);
          function i(e, t) {
            (pe(e), (r = t), (n = !0));
          }
        }
        stringify(e, t) {
          ...
          return (I(`stringify`, r), Ge(e), r(e, n));
        }
        use(e, ...t) {
          let n = this.attachers,
            r = this.namespace;
          if ((L(`use`, this.frozen), e != null))
          ...
          function a(e) {
            ...
            (o(e.plugins), e.settings && (r.settings = (0, z.default)(!0, r.settings, e.settings)));
          }
          function o(e) {
            let t = -1;
            if (e != null)
          ...
          function s(e, t) {
            ...
            if (i === -1) n.push([e, ...t]);
              ...
              let [r, ...a] = t,
                o = n[i][1];
              (ge(o) && ge(r) && (r = (0, z.default)(!0, o, r)), (n[i] = [e, r, ...a]));
            }
          }
        }
      }),
...
function st(e) {
  ...
  for (; ++r < n.length; ) {
    let e = n[r];
    t.push([ct(e[0]), lt(e[1])]);
  }
  return t;
}
function ct(e) {
  return typeof e == `string` ? new RegExp(it(e), `g`) : e;
}
function lt(e) {
...
function pt() {
  return {
    unsafe: [
      ...
      { character: `.`, before: `[Ww]`, after: `[\\-.\\w]`, inConstruct: V, notInConstruct: H },
      { character: `:`, before: `[ps]`, after: `\\/`, inConstruct: V, notInConstruct: H },
    ],
  };
}
function mt(e) {
...
function bt(e, t, n, r, i) {
  let a = ``;
  if (!wt(i) || (/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !St(n))) return !1;
  let o = Ct(n + r);
  if (!o[0]) return !1;
  let s = {
    type: `link`,
...
function wt(e, t) {
  ...
  return (e.index === 0 || l(n) || b(n)) && (!t || n !== 47);
}
var V,
  H,
  Tt = e(() => {
    (fe(), D(), a(), dt(), (V = `phrasing`), (H = [`autolink`, `link`, `image`, `label`]));
  }),
  Et = e(() => {
    Tt();
  });
...
function Rt(e) {
  ...
  return (
    ...
    {
      handlers: { footnoteDefinition: n, footnoteReference: It },
      ...
      e.children &&
        ...
        (o += a.move(
          (t
            ? `
`
            : ` `) + r.indentLines(r.containerFlow(e, a.current()), t ? Bt : zt),
        ))),
      s(),
      o
    );
...
function Ut() {
  return { canContainEols: [`delete`], enter: { strikethrough: Gt }, exit: { strikethrough: Kt } };
}
function Wt() {
  return {
    unsafe: [{ character: `~`, inConstruct: `phrasing`, notInConstruct: Yt }],
    handlers: { delete: qt },
  };
}
function Gt(e) {
...
function $t(e, t) {
  ...
  let d = -1;
  if (typeof r == `object` && `length` in r) for (; ++d < l; ) a[d] = tn(r[d]);
  else {
    let e = tn(r);
    for (; ++d < l; ) a[d] = e;
  }
...
function rn() {
  return {
    enter: { table: an, tableData: cn, tableHeader: cn, tableRow: sn },
    exit: { codeText: ln, table: on, tableData: U, tableHeader: U, tableRow: U },
  };
}
function an(e) {
  let t = e._align;
...
function ln(e) {
  let t = this.resume();
  this.data.inTable && (t = t.replace(/\\([\\|])/g, un));
...
`),
  ...
  function l(e, t) {
    return $t(e, { align: t, alignDelimiters: r, padding: n, stringLength: i });
  }
  function u(e, t, n) {
    let r = e.children,
      i = -1,
...
function mn() {
  return {
    exit: { taskListCheckValueChecked: gn, taskListCheckValueUnchecked: gn, paragraph: _n },
  };
}
function hn() {
...
function vn(e, t, n, r) {
  let i = e.children[0],
    ...
    s = n.createTracker(r);
  a && s.move(o);
  let c = ae.listItem(e, t, n, { ...r, ...s.current() });
...
function xn() {
  return [ft(), Lt(), Ut(), rn(), mn()];
}
function Sn(e) {
  return { extensions: [pt(), Rt(e), Wt(), dn(e), hn()] };
}
var Cn = e(() => {
    (Et(), Ht(), Zt(), pn(), bn());
  }),
...
function En(e, t, n) {
  ...
  return o;
  function o(t) {
    return !W(t) || !In.call(r, r.previous) || G(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`), e.enter(`literalAutolinkEmail`), s(t));
  }
  function s(t) {
    return W(t) ? (e.consume(t), s) : t === 64 ? (e.consume(t), c) : n(t);
  }
  function c(t) {
    return t === 46
      ? e.check(Rn, u, l)(t)
...
function Dn(e, t, n) {
  ...
  return i;
  function i(t) {
    return (t !== 87 && t !== 119) || !Pn.call(r, r.previous) || G(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`),
        e.enter(`literalAutolinkWww`),
        e.check(Ln, e.attempt(K, e.attempt(q, a), n), n)(t));
  }
  function a(n) {
...
function On(e, t, n) {
  ...
  return o;
  function o(t) {
    return (t === 72 || t === 104) && Fn.call(r, r.previous) && !G(r.events)
      ? (e.enter(`literalAutolink`),
  ...
  function c(t) {
    return t === 47 ? (e.consume(t), a ? d : ((a = !0), c)) : n(t);
  }
  function d(t) {
    return t === null || ie(t) || u(t) || l(t) || b(t) ? n(t) : e.attempt(K, e.attempt(q, f), n)(t);
  }
  function f(n) {
...
function Mn(e, t, n) {
  ...
  function i(e) {
    return e === null || e === 40 || e === 91 || u(e) || l(e) ? t(e) : r(e);
  }
  function a(e) {
    return m(e) ? o(e) : n(e);
  }
...
function W(e) {
  return e === 43 || e === 45 || e === 46 || e === 95 || _(e);
}
function G(e) {
  let t = e.length,
    n = !1;
  ...
  Vn = e(() => {
    for (
      a(),
        ...
        K = { tokenize: An, partial: !0 },
        q = { tokenize: jn, partial: !0 },
        J = { tokenize: Mn, partial: !0 },
        Rn = { tokenize: Nn, partial: !0 },
        zn = { name: `wwwAutolink`, tokenize: Dn, previous: Pn },
        Bn = { name: `protocolAutolink`, tokenize: On, previous: Fn },
        Y = { name: `emailAutolink`, tokenize: En, previous: In },
        X = {},
        Z = 48;
      Z < 123;
    )
...
function Kn(e, t, n) {
  ...
  function l(s) {
    ...
    return (u(s) || (o = !0), a++, e.consume(s), s === 92 ? d : l);
  }
  function d(t) {
...
function qn(e, t, n) {
  ...
  function f(t) {
    ...
    return (u(t) || (s = !0), o++, e.consume(t), t === 92 ? p : f);
  }
  function p(t) {
    return t === 91 || t === 92 || t === 93 ? (e.consume(t), o++, f) : f(t);
  }
  function m(t) {
    return t === 58
      ? (e.enter(`definitionMarker`),
        ...
        c(e, ee, `gfmFootnoteDefinitionWhitespace`))
      : n(t);
  }
  function ee(e) {
    return t(e);
...
function Jn(e, t, n) {
  return e.check(i, t, e.attempt(Zn, t, n));
}
function Yn(e) {
...
function Xn(e, t, n) {
  let r = this;
  return c(e, i, `gfmFootnoteDefinitionIndent`, 5);
  function i(e) {
...
var Zn,
  Qn = e(() => {
    (T(), d(), a(), p(), (Zn = { tokenize: Xn, partial: !0 }));
  }),
  $n = e(() => {
    Qn();
  });
      ...
      if (
        ...
        for (; r--; )
          if (
            ...
            (s && C(o, o.length, 0, ee(s, e.slice(r + 1, n), t)),
              C(o, o.length, 0, [
                [`exit`, a, t],
                [`enter`, e[n][1], t],
                [`exit`, e[n][1], t],
...
function lr(e, t, n) {
      ...
      : y(t)
        ...
        : v(t)
          ...
          : ((a += 1),
            o && ((o = !1), (i += 1)),
            t === 124
              ? (e.enter(`tableCellDivider`), e.consume(t), e.exit(`tableCellDivider`), (o = !0), f)
              : (e.enter(`data`), p(t)));
  }
  function p(t) {
  ...
  function h(t) {
    return t === 45 || t === 58
      ? g(t)
      : t === 124
        ? ((o = !0), e.enter(`tableCellDivider`), e.consume(t), e.exit(`tableCellDivider`), te)
        : S(t);
  }
  function te(t) {
    return v(t) ? c(e, g, `whitespace`)(t) : g(t);
  }
  function g(t) {
    return t === 58
      ? ((a += 1),
  ...
  function _(t) {
    return t === 45 ? (e.enter(`tableDelimiterFiller`), ne(t)) : S(t);
  }
  function ne(t) {
    return t === 45
      ? (e.consume(t), ne)
  ...
  function b(t) {
    return v(t) ? c(e, x, `whitespace`)(t) : x(t);
  }
  function x(n) {
    return n === 124
      ? h(n)
...
function hr(e, t, n) {
  ...
  function s(r) {
    return y(r) ? t(r) : v(r) ? e.check({ tokenize: gr }, t, n)(r) : n(r);
  }
}
function gr(e, t, n) {
  return c(e, r, `whitespace`);
  function r(e) {
    return e === null ? n(e) : t(e);
  }
}
var _r,
  vr = e(() => {
    (d(), a(), (_r = { name: `tasklistCheck`, tokenize: hr }));
  }),
  yr = e(() => {
    vr();
  });
function br(e) {
  return f([Tn(), Un(), er(e), cr(), mr()]);
}
var xr = e(() => {
  (S(), Hn(), $n(), nr(), pr(), yr());
});
function Sr(e) {
  ...
  (i.push(br(n)), a.push(xn()), o.push(Sn(n)));
}
var Cr,
  wr = e(() => {
    (wn(), xr(), (Cr = {}));
