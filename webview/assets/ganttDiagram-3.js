...
import { i as D, n as O, o as k, r as A } from "./chunk-58.js";
import {
  A as j,
  C as M,
  G as ee,
...
import { g as ce, u as le } from "./chunk-41.js";
var ue = n((e, t) => {
    (function (n, r) {
...
` +
    ...
    (Ct = { monday: v, tuesday: x, wednesday: l, thursday: h, friday: s, saturday: b, sunday: c }),
    (wt = O((e, t) => {
      let n = [...e].map(() => -1 / 0),
      ...
      renderer: {
        ...
        draw: O(function (e, t, n, s) {
          ...
          let l = N().securityLevel,
            h;
          l === `sandbox` && (h = C(`#i` + t));
          let v = C(l === `sandbox` ? h.nodes()[0].contentDocument.body : `body`),
          ...
          let k = {},
            A = 2 * c.topPadding;
          if (s.db.getDisplayMode() === `compact` || c.displayMode === `compact`) {
            let e = {};
          ...
          function te(e, t, n) {
            let a = c.barHeight,
              ...
              l = c.topPadding,
              u = c.leftPadding,
              d = r().domain([0, E.length]).range([`#00B9FA`, `#F95002`]).interpolate(i);
          ...
          function ne(e, n, r, i, a, o, l) {
            ...
            j.append(`g`)
              ...
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e.type === n) return `section section` + (t % c.numberSectionStyles);
            ...
            if (
              (d
                ...
                .attr(`x`, function (e) {
                  return e.milestone
                    ? M(e.startTime) + i + 0.5 * (M(e.endTime) - M(e.startTime)) - 0.5 * a
                    : M(e.startTime) + i;
                })
                .attr(`y`, function (e, t) {
                  return ((t = e.order), e.vert ? c.gridLineStartPadding : t * n + r);
                })
                ...
                .attr(`height`, function (e) {
                  return e.vert ? T.length * (c.barHeight + c.barGap) + c.barHeight * 2 : a;
                })
                .attr(`transform-origin`, function (e, t) {
                  return (
                    (t = e.order),
                    (M(e.startTime) + i + 0.5 * (M(e.endTime) - M(e.startTime))).toString() +
                      `px ` +
                ...
                .attr(`class`, function (e) {
                  ...
                  let n = 0;
                  for (let [t, r] of E.entries()) e.type === r && (n = t % c.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              d
                ...
                .attr(`x`, function (e) {
                  ...
                  if (
                    (e.milestone &&
                      ((t += 0.5 * (M(e.endTime) - M(e.startTime)) - 0.5 * a), (n = t + a)),
                    e.vert)
                  )
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? c.gridLineStartPadding + T.length * (c.barHeight + c.barGap) + 60
                    : ((t = e.order), t * n + c.barHeight / 2 + (c.fontSize / 2 - 2) + r);
                })
                .attr(`text-height`, a)
                .attr(`class`, function (e) {
                  let t = M(e.startTime),
                  ...
                  let o = 0;
                  for (let [t, n] of E.entries()) e.type === n && (o = t % c.numberSectionStyles);
                  let s = ``;
                  return (
                    e.active && (s = e.crit ? `activeCritText` + o : `activeText` + o),
                    e.done
                      ? (s = e.crit ? s + ` doneCritText` + o : s + ` doneText` + o)
                      : e.crit && (s = s + ` critText` + o),
                    e.milestone && (s += ` milestoneText`),
                    e.vert && (s += ` vertText`),
                    r > n - t
                      ? n + r + 1.5 * c.leftPadding > l
                        ? i + ` taskTextOutsideLeft taskTextOutside` + o + ` ` + s
                        : i + ` taskTextOutsideRight taskTextOutside` + o + ` ` + s + ` width-` + r
          ...
          function se(e, t, n, r) {
            ...
            let l = w(M)
                ...
                .tickFormat(_(o)),
              u = /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(
            ...
            j.append(`g`)
              ...
              .append(function (e) {
                ...
                for (let [e, n] of t.entries()) {
                  let t = b.createElementNS(`http://www.w3.org/2000/svg`, `tspan`);
              ...
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e[0] === n) return `sectionTitle sectionTitle` + (t % c.numberSectionStyles);
                return `sectionTitle`;
              });
          }
          O(ce, `vertLabels`);
