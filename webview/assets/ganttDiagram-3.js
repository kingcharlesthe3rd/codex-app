...
import { i as D, n as O, o as k, r as A } from "./chunk-2.js";
import {
  A as j,
  C as M,
  G as ee,
...
` +
    ...
    (Ct = { monday: u, tuesday: p, wednesday: f, thursday: h, friday: v, saturday: d, sunday: g }),
    (wt = O((e, t) => {
      let n = [...e].map(() => -1 / 0),
      ...
      renderer: {
        ...
        draw: O(function (e, t, n, u) {
          ...
          let f = N().securityLevel,
            p;
          f === `sandbox` && (p = C(`#i` + t));
          let h = C(f === `sandbox` ? p.nodes()[0].contentDocument.body : `body`),
          ...
          function te(e, t, n) {
            let a = d.barHeight,
              ...
              s = d.topPadding,
              c = d.leftPadding,
              l = r().domain([0, E.length]).range([`#00B9FA`, `#F95002`]).interpolate(i);
          ...
          function ne(e, n, r, i, a, o, s) {
            ...
            let c = [...new Set(e.map((e) => e.order))].map((t) => e.find((e) => e.order === t));
            j.append(`g`)
              .selectAll(`rect`)
              .data(c)
              .enter()
              ...
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e.type === n) return `section section` + (t % d.numberSectionStyles);
            ...
            if (
              (l
                ...
                .attr(`y`, function (e, t) {
                  return ((t = e.order), e.vert ? d.gridLineStartPadding : t * n + r);
                })
                ...
                .attr(`height`, function (e) {
                  return e.vert ? T.length * (d.barHeight + d.barGap) + d.barHeight * 2 : a;
                })
                ...
                .attr(`class`, function (e) {
                  ...
                  let n = 0;
                  for (let [t, r] of E.entries()) e.type === r && (n = t % d.numberSectionStyles);
                  let r = ``;
                  return (
                    e.active
                      ? e.crit
              ...
              l
                ...
                .attr(`y`, function (e, t) {
                  return e.vert
                    ? d.gridLineStartPadding + T.length * (d.barHeight + d.barGap) + 60
                    : ((t = e.order), t * n + d.barHeight / 2 + (d.fontSize / 2 - 2) + r);
                })
                .attr(`text-height`, a)
                .attr(`class`, function (e) {
                  let t = M(e.startTime),
                  ...
                  let o = 0;
                  for (let [t, n] of E.entries()) e.type === n && (o = t % d.numberSectionStyles);
                  let c = ``;
                  return (
          ...
          function re(e, n, r, i, a, o, s, c) {
            ...
            for (let { startTime: e, endTime: t } of o)
              ((l === void 0 || e < l) && (l = e), (f === void 0 || t > f) && (f = t));
            if (!l || !f) return;
          ...
          function se(e, t, n, r) {
            ...
            if (f !== null) {
              ...
              if (isNaN(e) || e <= 0)
                D.warn(`Invalid tick interval value: "${f[1]}". Skipping custom tick interval.`);
              else {
                let t = f[2],
            ...
            j.append(`g`)
              ...
              .append(function (e) {
                ...
                for (let [e, n] of t.entries()) {
                  let t = g.createElementNS(`http://www.w3.org/2000/svg`, `tspan`);
              ...
              .attr(`class`, function (e) {
                for (let [t, n] of E.entries())
                  if (e[0] === n) return `sectionTitle sectionTitle` + (t % d.numberSectionStyles);
                return `sectionTitle`;
              });
          }
          O(ce, `vertLabels`);
