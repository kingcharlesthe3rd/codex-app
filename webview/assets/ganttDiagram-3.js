      ...
      draw: n(function (t, i, a, o) {
        ...
        function C(e, t, n) {
          let r = s.barHeight,
            ...
            a = s.topPadding,
            c = s.leftPadding,
            l = f().domain([0, _.length]).range([`#00B9FA`, `#F95002`]).interpolate(_e);
        ...
        function w(e, t, n, a, c, l, u) {
          ...
          b.append(`g`)
            ...
            .attr(`class`, function (e) {
              for (let [t, n] of _.entries())
                if (e.type === n) return `section section` + (t % s.numberSectionStyles);
          ...
          if (
            (f
              ...
              .attr(`x`, function (e) {
                return e.milestone
                  ? x(e.startTime) + a + 0.5 * (x(e.endTime) - x(e.startTime)) - 0.5 * c
                  : x(e.startTime) + a;
              })
              .attr(`y`, function (e, r) {
                return ((r = e.order), e.vert ? s.gridLineStartPadding : r * t + n);
              })
              ...
              .attr(`height`, function (e) {
                return e.vert ? g.length * (s.barHeight + s.barGap) + s.barHeight * 2 : c;
              })
              ...
              .attr(`class`, function (e) {
                ...
                let n = 0;
                for (let [t, r] of _.entries()) e.type === r && (n = t % s.numberSectionStyles);
                let r = ``;
                return (
                  e.active
                    ? e.crit
            ...
            f
              ...
              .attr(`x`, function (e) {
                ...
                if (
                  (e.milestone &&
                    ((t += 0.5 * (x(e.endTime) - x(e.startTime)) - 0.5 * c), (n = t + c)),
                  e.vert)
                )
              ...
              .attr(`y`, function (e, r) {
                return e.vert
                  ? s.gridLineStartPadding + g.length * (s.barHeight + s.barGap) + 60
                  : ((r = e.order), r * t + s.barHeight / 2 + (s.fontSize / 2 - 2) + n);
              })
              .attr(`text-height`, c)
              .attr(`class`, function (e) {
                let t = x(e.startTime),
                ...
                let a = 0;
                for (let [t, n] of _.entries()) e.type === n && (a = t % s.numberSectionStyles);
                let o = ``;
                return (
        ...
        function A(e, t) {
          ...
          b.append(`g`)
            ...
            .attr(`class`, function (e) {
              for (let [t, n] of _.entries())
                if (e[0] === n) return `sectionTitle sectionTitle` + (t % s.numberSectionStyles);
              return `sectionTitle`;
            });
        }
        n(A, `vertLabels`);
