...
import { r as ue } from "./pending-worktree-store.js";
import { r as de } from "./modal-controller-state.js";
import { a as fe } from "./open-project-setup-dialog.js";
import {
  d as pe,
  f as me,
  g as he,
...
import { h as xe } from "./sidebar-project-group-signals.js";
import {
  a as Se,
  c as Ce,
  d as we,
...
import { t as Be } from "./use-app-server-connection-state-B13v-ij1.js";
import { t as Ve } from "./format-relative-date-time.js";
import { a as He, i as Ue, o as We, s as Ge, t as Ke } from "./local-task-row.js";
...
import { n as Ze, o as Qe, y as $e } from "./realtime-controller.js";
import { t as et } from "./local-environment-selection.js";
import { n as tt, t as nt } from "./fork-conversation-actions.js";
function rt(e, t, n) {
  let r = S(e);
  if (r != null) {
    t(r);
...
function it(e, t) {
  let n = S(t);
  n != null && he.start(`thread_switch_completed`, { conversationId: n, needsResume: e.get(_, n) });
}
function at(e, t) {
...
function ct(e) {
  ...
  t[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((S = { onArchiveStart: y, onArchiveSuccess: ee, onArchiveError: x }), (t[4] = S))
    : (S = t[4]);
  let C = S,
    w;
      ...
      ? ((e = (e) => {
          ...
          return d == null
            ? (0, Z.jsxs)(
                st.Fragment,
                {
                  children: [a, (0, Z.jsx)(`div`, { className: u, role: `listitem`, children: n })],
                },
                t,
              )
            : (0, Z.jsxs)(
                st.Fragment,
                { children: [a, (0, Z.jsx)(d, { className: u, item: e, children: n })] },
                t,
              );
        }),
        (t[21] = r),
  ...
  let j;
  return (
    t[36] !== p || t[37] !== o || t[38] !== A || t[39] !== E || t[40] !== O || t[41] !== k
      ? ((j = (0, Z.jsxs)(`div`, {
          className: E,
          role: `list`,
          "aria-label": o,
...
function pt(e) {
  ...
  let s = r?.active && `opacity-100`,
    c;
  t[0] !== i || t[1] !== s ? ((c = D(ft, s, i)), (t[0] = i), (t[1] = s), (t[2] = c)) : (c = t[2]);
  let l;
  t[3] !== n || t[4] !== r || t[5] !== o
    ? ((l = r?.active
        ? (0, Z.jsx)(W, {
...
function xt(e) {
  let t = (0, X.c)(13),
    ...
    o = P(l, r),
    s = P(f, r),
    c = St({ latestTurnStatus: P(i, r), resumeState: a, streamRole: o, threadRuntimeStatus: s }),
    u = bt[c],
    d;
  t[0] === n
    ? (d = t[1])
    : ((d = D(`flex size-3 items-center justify-center`, n)), (t[0] = n), (t[1] = d));
  let p = Q[c],
    m;
  t[2] === p ? (m = t[3]) : ((m = D(`block size-2 rounded-full`, p)), (t[2] = p), (t[3] = m));
  let h;
  t[4] === m ? (h = t[5]) : ((h = (0, Z.jsx)(`span`, { className: m })), (t[4] = m), (t[5] = h));
  let g;
  t[6] !== d || t[7] !== h || t[8] !== u
...
function St({ latestTurnStatus: e, resumeState: t, streamRole: n, threadRuntimeStatus: r }) {
  return n == null
    ? t === `needs_resume`
      ? `needs-resume`
      : `read-only`
...
function wt(e) {
          ...
          : [
              {
                ...
                icon: (0, Z.jsx)(Y, { className: o == null ? void 0 : `translate-x-0.5` }),
                onClick: s.onClick,
              },
            ]),
      (t[0] = o),
  ...
  return (
    t[20] !== f || t[21] !== p || t[22] !== h
      ? ((g = (0, Z.jsx)(pt, { actions: f, confirmAction: p, className: h, tooltipSide: `right` })),
        (t[20] = f),
        (t[21] = p),
        (t[22] = h),
        (t[23] = g))
...
function Tt(e) {
  ...
  let {
    ...
    { isActive: Y, onDoubleClick: rt, extraIconBadges: it, priorityIndicatorNode: at, ...ot } = S,
    { createPendingWorktree: ct } = ue(),
    lt = u(et),
    ut;
  i[4] === c ? (ut = i[5]) : ((ut = { conversationId: c }), (i[4] = c), (i[5] = ut));
  let { canOpenThreadInNewWindow: dt, openThreadInNewWindow: ft } = be(ut),
    pt = Se !== `projectless`,
    mt;
  i[6] !== W || i[7] !== B ? ((mt = t(B, W)), (i[6] = W), (i[7] = B), (i[8] = mt)) : (mt = i[8]);
  let ht = mt,
    _t = B != null,
    Q = Se === `projectless` && (B == null || B === `~`) ? (xe ?? ee ?? null) : B,
    bt = me && he ? { id: `active-status`, icon: (0, Z.jsx)(xt, { conversationId: c }) } : null,
    St = null,
    Tt;
  i[9] !== c || i[10] !== B || i[11] !== k || i[12] !== O
    ? ((Tt = async () => {
        let e = await nt(O, { sourceConversationId: c, sourceWorkspaceRoot: B });
        e != null && k(`/local/${e}`);
      }),
      (i[9] = c),
      (i[10] = B),
  ...
  let Dt = Tt,
    Ot;
  i[14] !== c || i[15] !== ct || i[16] !== B || i[17] !== lt || i[18] !== k || i[19] !== O
    ? ((Ot = async () => {
        let e = await tt(O, {
  ...
  i[32] === Nt
    ? (Ft = i[33])
    : ((Ft = Nt == null ? null : (0, Z.jsx)(Et, { automation: Nt })), (i[32] = Nt), (i[33] = Ft));
  let It = Ft,
    Lt;
  i[34] !== De ||
  i[35] !== Ge ||
  ...
  i[58] !== Q || i[59] !== Be
    ? ((qt = () => {
        Q && se({ path: Q, cwd: n(Q), target: `fileManager`, openFile: Be.mutate });
      }),
      (i[58] = Q),
      (i[59] = Be),
      (i[60] = qt))
  ...
  i[61] !== Kt || i[62] !== Y || i[63] !== rt
    ? ((Yt = (e) => {
        (rt?.(e), !e.defaultPrevented && Y && e.target?.closest(`[data-thread-title]`) && Kt());
      }),
      (i[61] = Kt),
      (i[62] = Y),
      (i[63] = rt),
  ...
  i[92] !== we
    ? ((Zt = () => [
        ...
        ...(ie == null || ie === `local`
          ? [{ id: `open-thread-folder`, message: gt(J), enabled: !!Q, onSelect: Jt }]
          : []),
        {
          id: `copy-cwd`,
        ...
        ...(dt
          ? [
              ...
              { id: `open-thread-new-window`, message: q.openInNewWindow, onSelect: ft },
            ]
          : []),
      ]),
      (i[65] = _t),
  ...
  i[122] !== Ht || i[123] !== Pt || i[124] !== N || i[125] !== I
    ? ((sn = N
        ? (0, Z.jsx)(pe, { heartbeatAutomationName: Pt, open: !0, onOpenChange: I, onConfirm: Ht })
        : null),
      (i[122] = Ht),
      (i[123] = Pt),
      (i[124] = N),
...
function kt(e) {
  let t = (0, X.c)(83),
    ...
    U = A(),
    W = ne(),
    { cancelPendingWorktree: ae, renamePendingWorktree: oe, setPendingWorktreePinned: se } = ue(),
  ...
  t[2] === Re
    ? (Ke = t[3])
    : ((Ke = Re == null ? null : (0, Z.jsx)(dt, { badge: Re })), (t[2] = Re), (t[3] = Ke));
  let qe = Ke,
    Je;
  t[4] === w
    ? (Je = t[5])
  ...
  let Y = Xe,
    ...
    $e =
      n.kind === `local` && ye === `project` && Ze != null && Ze !== `local` && Qe !== `connected`,
    et;
  t[9] !== ae ||
  t[10] !== J ||
  t[11] !== U ||
    ...
    ? ((et = function (e) {
        ...
        return (0, Z.jsx)(ke, {
          getItems: () => [
            ...
            ...(t.phase === `failed`
              ? [{ id: `archive-thread`, message: q.archiveThread, onSelect: r }]
              : []),
          ],
          children: (0, Z.jsx)(Ue, {
            task: t,
  ...
  t[72] !== K
    ? ((it = function (e) {
        let t = ce,
          ...
          f = ee(c),
          p =
            v == null ? void 0 : d({ conversationId: c, hostId: v.hostId, projectId: v.projectId }),
          m = n
            ? { rest: null, hover: null }
            : me({
                isPinned: i,
          ...
          b = pe == null ? void 0 : (0, Z.jsx)(Ve, { dateString: new Date(pe).toISOString() });
        return (0, Z.jsx)(Tt, {
          conversationId: c,
          conversationRoute: p,
          isAutomationRun: o,
...
var jt = O(j, (e) => {
    let t =
      !e.isExpanded &&
      e.maxItems != null &&
      Nt({ threadKeys: e.threadKeys, currentThreadKey: e.currentThreadKey, maxItems: e.maxItems });
    return {
      isForceExpanded: t,
...
function It(e) {
  ...
  t[3] !== w || t[4] !== ee || t[5] !== O || t[6] !== n
    ? ((k = { threadKeys: n, currentThreadKey: ee, isExpanded: w, maxItems: O }),
      (t[3] = w),
      (t[4] = ee),
      (t[5] = O),
      (t[6] = n),
  ...
  t[8] === a
    ...
    : ((j = (e) => {
        ...
        return a == null
          ...
          : (0, Z.jsx)(a, { threadKey: t.threadKey, className: n, children: r });
      }),
      (t[8] = a),
      (t[9] = j));
  let M = j,
  ...
  t[35] === v
    ? (L = t[36])
    : ((L = D(`isolate flex flex-col [contain:layout_paint]`, v)), (t[35] = v), (t[36] = L));
...
export { dt as a, rt as c, gt as i, it as l, Pt as n, ot as o, Ft as r, at as s, It as t };
//# sourceMappingURL=sidebar-thread-section-Be-PJHWS.js.map
