      ...
      (E = (function () {
        ...
        return (
          ...
          (e.prototype.alias = function (e, t, n, r) {
            ...
            var i = { userId: e, type: `alias`, options: s({}, n), integrations: s({}, r) };
            return (
          ...
          (e.prototype.normalize = function (e) {
            ...
            var r = s(s({}, n), e.options?.integrations),
              ...
              c = e.options,
              l = t(e, [`options`]),
              u = s(s(s(s({ timestamp: new Date() }, l), { context: a, integrations: r }), o), {
          ...
          (e.prototype.flush = function () {
            if (this.logs.length > 1) {
              var e = this._logs.reduce(function (e, t) {
                var n,
                  r = s(s({}, t), { json: JSON.stringify(t.extras, null, ` `), extras: t.extras });
                delete r.time;
                var i = t.time?.toISOString() ?? ``;
                return (
                  e[i] && (i = `${i}-${Math.random()}`), s(s({}, e), ((n = {}), (n[i] = r), n))
                );
              }, {});
              ...
              return n(this, function (n) {
                switch (n.label) {
                  ...
                  case 3:
                    return (
                      (i = n.sent()),
                      e.log(`warn`, `Failed to unload destination`, { plugin: t.name, error: i }),
                      [3, 4]
                    );
                  case 4:
                    return [2];
