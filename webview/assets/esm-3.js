      ...
      (E = (function () {
        ...
        return (
          ...
          (e.prototype.normalize = function (e) {
            ...
            var r = n(n({}, t), e.options?.integrations),
              i = e.options ? this.context(e.options) : [],
              a = i[0],
              s = i[1],
              c = e.options,
              l = o(e, [`options`]),
              u = n(n(n(n({ timestamp: new Date() }, l), { context: a, integrations: r }), s), {
    ...
    return t(this, function (t) {
      switch (t.label) {
        ...
        case 1:
          return [2, t.sent()];
        case 2:
          return ((n = t.sent()), [2, Promise.reject(n)]);
        case 3:
          return [2];
      }
    });
      ...
      (Q = (function (e) {
        ...
        return (
                ...
                switch (t.label) {
                  case 0:
                    return (
                      this.plugins.push(n),
                      (i = function (t) {
                        (o.failedInitializations.push(n.name),
                          o.emit(`initialization_failure`, n),
              ...
              return t(this, function (t) {
                switch (t.label) {
                  ...
                  case 3:
                    return (
                      (n = t.sent()),
                      (r = this.enqueuRetry(n, e)),
                      r || (e.setFailedDelivery({ reason: n }), this.emit(`flush`, e, !1)),
                      [2, []]
                    );
                  case 4:
                    return [2, [e]];
          ...
          (n.prototype.flushOne = function (e) {
            return a(this, void 0, void 0, function () {
              var n, r, i, a, o, s, c, l, u, d, c, f, p, m, h;
              return t(this, function (t) {
                switch (t.label) {
                  case 0:
                    if (!this.isReady()) throw Error(`Not ready`);
                    (e.attempts > 1 && this.emit(`delivery_retry`, e),
                      (n = this.availableExtensions(e.event.integrations ?? {})),
                      (r = n.before),
                      (i = n.enrichment),
                      (a = 0),
                      (o = r),
    ...
    return t(this, function (t) {
      switch (t.label) {
        ...
        case 3:
          ((o = t.sent()), (t.label = 4));
        case 4:
          return i?.callback ? [4, de(o, i.callback, $(a, i.timeout))] : [3, 6];
        case 5:
          ((o = t.sent()), (t.label = 6));
        case 6:
          return (i?.debug && o.flush(), [2, o]);
      }
    });
  });
}
