...
import { c as a, f as o } from "./vscode-api.js";
import { Aa as s, Ta as c, ja as l, pa as ee } from "./src.js";
import { l as te, s as u } from "./lib-1.js";
import { t as d } from "./clsx.js";
import { t as ne } from "./proxy.js";
import { t as re } from "./AnimatePresence.js";
import { t as ie } from "./button-oF-qgtAS.js";
import { t as ae } from "./use-reduced-motion-1.js";
import { t as oe } from "./x.js";
import { t as se } from "./chevron.js";
import { Jn as f, Xn as ce, Yn as p, qn as m, r as le } from "./product-logger.js";
import { S as ue, _ as de, p as fe } from "./codex-api.js";
import { d as pe, l as me, u as he } from "./dialog-layout.js";
import { t as ge } from "./checkbox.js";
import { t as _e } from "./animations.js";
import { t as ve } from "./check-lg.js";
var ye = `` + new URL(`referral-modal-flower-background-BUTY95no.webp`, import.meta.url).href,
  be = `` + new URL(`referral-modal-paper-plane-DqBQhLW-.webp`, import.meta.url).href,
  h = e(t()),
  g = n(),
  xe = (e) =>
    (0, g.jsxs)(`svg`, {
      ...
      ...e,
      children: [
        (0, g.jsx)(`circle`, { cx: 10, cy: 10, r: 7.5, fill: `#5865F2` }),
        (0, g.jsx)(`path`, {
  ...
  Ce = 1,
  we = 5,
  Te = `https://help.openai.com/articles/20001271`,
  Ee = c({
    detail: l([s(), c({ message: s().optional(), failed_emails: ee(s()).optional() })]).optional(),
  });
function b(e) {
  let t = (0, v.c)(256),
    {
      grantAmount: n,
      hasReachedReferralLimit: r,
      hasReachedWorkspaceReferralLimit: a,
      isPersonalAccount: o,
      onClose: s,
      referralRedemptionAction: c,
      referralBeaconType: l,
      referralGrantType: ee,
      referralKey: f,
      remainingReferrals: p,
    } = e,
    y = r === void 0 ? !1 : r,
    Ee = a === void 0 ? !1 : a,
    b = te(),
    ...
    { data: C } = fe(),
    Je;
  t[0] === f ? (Je = t[1]) : ((Je = { referralKey: f }), (t[0] = f), (t[1] = Je));
  let { data: w } = ue(Je),
    T = (0, h.useId)(),
    Ye = (0, h.useId)(),
    Xe = (0, h.useId)(),
    ...
    [E, Qe] = (0, h.useState)(``),
    $e;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? (($e = []), (t[2] = $e)) : ($e = t[2]);
  let [D, et] = (0, h.useState)($e),
    tt;
  t[3] === Symbol.for(`react.memo_cache_sentinel`) ? ((tt = []), (t[3] = tt)) : (tt = t[3]);
  let [nt, rt] = (0, h.useState)(tt),
    [it, at] = (0, h.useState)(!1),
    [ot, st] = (0, h.useState)(!1),
    [O, ct] = (0, h.useState)(`idle`),
    [k, A] = (0, h.useState)(null),
    lt = de(),
    ut;
  t[4] === E ? (ut = t[5]) : ((ut = E.trim()), (t[4] = E), (t[5] = ut));
  let dt = ut.length > 0,
    ft = D.length > 0,
    j = p != null && p > 0 ? Math.min(p, we) : we,
    M = !(D.length < j),
    N = lt.isPending || O === `submitting`,
    P = O === `sendAnimation`,
    F = O === `success`,
    I = N || P,
    L = I || F,
    ...
    mt = P || F,
    R = k?.type === `error`,
    ht = k?.type === `error` && k.reason === `maxEmails`,
    gt = `${T}-status`,
    _t;
  t[6] !== C?.structure || t[7] !== o
    ? ((_t = o ?? C?.structure?.toLowerCase() === `personal`),
      (t[6] = C?.structure),
      (t[7] = o),
      (t[8] = _t))
    : (_t = t[8]);
  let z = _t,
    vt;
  t[9] !== M || t[10] !== b || t[11] !== k || t[12] !== z || t[13] !== j
    ? ((vt = k?.type === `error` ? k.message : M ? We(b, z, j) : null),
      (t[9] = M),
      (t[10] = b),
      (t[11] = k),
      (t[12] = z),
    ...
    : (vt = t[14]);
  let yt = vt,
    bt = yt == null ? void 0 : gt,
    xt;
  t[15] === nt ? (xt = t[16]) : ((xt = new Set(nt)), (t[15] = nt), (t[16] = xt));
  let St = xt,
    Ct = w?.requires_explicit_confirmation !== !1,
    wt = D.length > 0 && D.every(Le),
    Tt = Ct && wt,
    Et = w != null && w.rules.length > 0,
    Dt = Ee ? `workspace` : `user`,
    Ot = y
      ? w?.time_frame_rules.find((e) => e.type === Dt && e.invites_sent >= e.invites_total)
      : void 0,
    kt;
  t[17] === ee ? (kt = t[18]) : ((kt = He(ee)), (t[17] = ee), (t[18] = kt));
  let B = kt,
    V = n ?? (B === `rateLimitReset` ? Ce : Se),
    At = V * 2,
    jt;
  t[19] !== x || t[20] !== l || t[21] !== f || t[22] !== B
    ? ((jt = (e) => {
        x.logProductEvent(ce, {
          ...e,
          referralBeaconType: l ?? void 0,
          referralRewardType: B,
          referralKey: f,
        });
      }),
      (t[19] = x),
  ...
  t[24] === H
    ? (Mt = t[25])
    : ((Mt = () => {
        H({ action: m.CODEX_REFERRAL_INVITE_MODAL_ACTION_SHOWN });
      }),
      (t[24] = H),
      (t[25] = Mt));
  let Nt = (0, h.useEffectEvent)(Mt),
    Pt;
  t[26] === Nt
    ? (Pt = t[27])
    : ((Pt = () => {
      ...
      (t[27] = Pt));
  let Ft;
  (t[28] === Symbol.for(`react.memo_cache_sentinel`) ? ((Ft = []), (t[28] = Ft)) : (Ft = t[28]),
    (0, h.useEffect)(Pt, Ft));
  let It;
  t[29] !== I || t[30] !== H || t[31] !== s
    ? ((It = () => {
        I || (H({ action: m.CODEX_REFERRAL_INVITE_MODAL_ACTION_CLOSE_CLICKED }), s());
      }),
      (t[29] = I),
      (t[30] = H),
      (t[31] = s),
  ...
  let U = It,
    Lt;
  t[33] !== D || t[34] !== b || t[35] !== z || t[36] !== j
    ? ((Lt = (e) => {
        let t = Ue(e);
        if (t.length === 0) return { blockedByLimit: !1, emails: D };
        let n = new Set(D.map(Ie)),
          r = t.filter((e) => {
            let t = e.toLowerCase();
        ...
        return (
          ...
          rt(c),
          c.length > 0
            ? A({ type: `error`, message: Ge(c, b), reason: `invalidEmails` })
            : o.length > 0
              ? A({ type: `error`, message: We(b, z, j), reason: `maxEmails` })
              : A(null),
  ...
  t[38] !== D || t[39] !== b
    ? ((Rt = (e) => {
        ...
        (et(t),
          ...
          rt(n),
          n.length > 0
            ? A({ type: `error`, message: Ge(n, b), reason: `invalidEmails` })
            : A(null));
      }),
      (t[38] = D),
      (t[39] = b),
  ...
  t[50] !== Ct
    ? ((zt = async () => {
        if (Ct && !it) return;
        (A(null), rt([]));
        let e = dt ? W(E) : { blockedByLimit: !1, emails: D };
        if (e.blockedByLimit) return;
        let t = e.emails;
        if (t.length === 0) return;
        let n = t.filter(Ne);
        if (n.length > 0) {
          (rt(n), A({ type: `error`, message: Ge(n, b), reason: `invalidEmails` }));
          return;
        }
        (H({ action: m.CODEX_REFERRAL_INVITE_MODAL_ACTION_SEND_CLICKED, emailCount: t.length }),
          ct(`submitting`));
        try {
          let e = await lt.mutateAsync({ emails: t, referralKey: f });
          (H({
            action: m.CODEX_REFERRAL_INVITE_MODAL_ACTION_SEND_SUCCEEDED,
            emailCount: e.invites.length,
          }),
            A({ type: `success`, emails: e.invites.map(Me) }),
            ct(`sendAnimation`));
        } catch (e) {
          let n = qe(e),
          ...
          (ct(`idle`),
            ...
            n != null &&
              H({
                action: m.CODEX_REFERRAL_INVITE_MODAL_ACTION_BACKEND_ERROR,
                emailCount: t.length,
            ...
            A({ type: `error`, message: Ke(r, b, n?.message), reason: `failedInvite` }));
        }
      }),
      (t[41] = W),
      (t[42] = E),
  ...
  let K = zt,
    Bt;
  t[52] !== W || t[53] !== E || t[54] !== D || t[55] !== K || t[56] !== G
    ? ((Bt = (e) => {
        if (e.key === `Enter`) {
          if ((e.preventDefault(), Ue(E).length === 0)) {
            K();
            return;
          }
          W(E);
  ...
  t[58] === W
    ...
    : ((Ht = (e) => {
        ...
        Ue(t).length <= 1 || (e.preventDefault(), W(t));
      }),
      (t[58] = W),
      (t[59] = Ht));
  let Ut = Ht,
  ...
  let Y;
  t[69] !== Xe || t[70] !== J
    ? ((Y = { "aria-describedby": Xe, onEscapeKeyDown: J }), (t[69] = Xe), (t[70] = J), (t[71] = Y))
    : (Y = t[71]);
  let X;
  t[72] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((X = d(
      ...
      (t[72] = X))
    : (X = t[72]);
  let Yt = mt && _.backdropExpanded,
    Xt = F && _.backdropSuccess,
    Z;
  t[73] !== Yt || t[74] !== Xt
    ? ((Z = d(
        _.backdrop,
      ...
      (t[75] = Z))
    : (Z = t[75]);
  let Zt = mt && _.backdropImageExpanded,
    Q;
  t[76] === Zt ? (Q = t[77]) : ((Q = d(_.backdropImage, `w-full`, Zt)), (t[76] = Zt), (t[77] = Q));
  let Qt;
  t[78] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Qt = { backgroundImage: `url(${ye})` }), (t[78] = Qt))
    : (Qt = t[78]);
  let $t;
  t[79] === Q
    ? ($t = t[80])
    : (($t = (0, g.jsx)(`div`, { className: Q, style: Qt })), (t[79] = Q), (t[80] = $t));
  let en;
  t[81] !== Z || t[82] !== $t
    ? ((en = (0, g.jsx)(`div`, { "aria-hidden": !0, className: Z, children: $t })),
      (t[81] = Z),
      (t[82] = $t),
      (t[83] = en))
    : (en = t[83]);
  let tn = F && _.successBackdropVisible,
    nn;
  t[84] === tn
    ? (nn = t[85])
    : ((nn = d(
  ...
  t[86] === nn
    ? (rn = t[87])
    : ((rn = (0, g.jsx)(`div`, { "aria-hidden": !0, className: nn })), (t[86] = nn), (t[87] = rn));
  let an;
  t[88] !== k?.type || t[89] !== z || t[90] !== F
    ? ((an = (0, g.jsx)(pe, {
        asChild: !0,
        children: (0, g.jsx)(`h2`, {
          className: `sr-only`,
          children:
            F && k?.type === `success`
              ? (0, g.jsx)(Be, {})
              : (0, g.jsx)(Re, { isPersonalAccount: z }),
        }),
      })),
      (t[88] = k?.type),
      (t[89] = z),
      ...
      (t[91] = an))
    : (an = t[91]);
  let on = N && _.markSubmitting,
    sn = P && _.markSendAnimating,
    cn = F && _.markSuccess,
    ln;
  t[92] !== on || t[93] !== sn || t[94] !== cn
    ? ((ln = d(_.mark, `absolute left-[calc(50%_-_62px)] top-[55px] size-[124px]`, on, sn, cn)),
      (t[92] = on),
      (t[93] = sn),
      (t[94] = cn),
      (t[95] = ln))
    : (ln = t[95]);
  let un = N && _.renderSubmitting,
    dn = P && _.renderSendAnimating,
    fn;
  t[96] !== un || t[97] !== dn
    ? ((fn = d(
        _.render,
  ...
  let mn;
  t[102] !== ln || t[103] !== pn
    ? ((mn = (0, g.jsx)(`div`, { className: ln, children: pn })),
      (t[102] = ln),
      (t[103] = pn),
      (t[104] = mn))
    : (mn = t[104]);
  let hn;
  t[105] !== U || t[106] !== b || t[107] !== P || t[108] !== N || t[109] !== F
    ? ((hn = P
        ? null
        : (0, g.jsx)(`button`, {
            type: `button`,
            ...
            children: (0, g.jsx)(oe, { className: `size-4 stroke-[2.4]` }),
          })),
      (t[105] = U),
      (t[106] = b),
      (t[107] = P),
  ...
  t[111] !== mn || t[112] !== hn
    ...
    : (gn = t[113]);
  let _n = P || F,
    vn = (P || F) && `pointer-events-none`,
    yn = (P || F) && _.formHidden,
    bn;
  t[114] !== vn || t[115] !== yn
    ? ((bn = d(_.form, `relative z-[1] flex flex-col gap-5 px-8 pb-6 pt-[41px]`, vn, yn)),
      (t[114] = vn),
      (t[115] = yn),
      (t[116] = bn))
    : (bn = t[116]);
  ...
  t[119] === z
    ...
    : ((Sn = (0, g.jsx)(`h2`, {
        ...
        children: (0, g.jsx)(Re, { isPersonalAccount: z }),
      })),
      (t[119] = z),
      (t[120] = Sn));
  let Cn = F ? void 0 : Xe,
    wn;
  t[121] !== y || t[122] !== z || t[123] !== B || t[124] !== V || t[125] !== At
    ? ((wn = (0, g.jsx)(ze, {
        grantAmount: V,
        hasReachedReferralLimit: y,
        isPersonalAccount: z,
        rewardType: B,
        totalCredits: At,
      })),
  ...
  t[134] === T
    ? (On = t[135])
    : ((On = (0, g.jsx)(`label`, { className: `sr-only`, htmlFor: T, children: Dn })),
      (t[134] = T),
      (t[135] = On));
  let kn =
      R &&
  ...
  t[136] === kn
    ...
    : ((An = d(
      ...
      (t[137] = An));
  let jn;
  if (t[138] !== D || t[139] !== St || t[140] !== b || t[141] !== L || t[142] !== G) {
    let e;
    (t[144] !== St || t[145] !== b || t[146] !== L || t[147] !== G
      ? ((e = (e) =>
          (0, g.jsxs)(
            `span`,
            {
              ...
              children: [
                ...
                (0, g.jsx)(`button`, {
                  ...
                  type: `button`,
                  children: (0, g.jsx)(oe, { className: `size-3.5 stroke-[2.4]` }),
                }),
              ],
            },
            e,
  ...
  let Mn;
  t[149] !== ht || t[150] !== M || t[151] !== b || t[152] !== z || t[153] !== j
    ? ((Mn = (e) => {
  ...
  t[168] !== Nn
    ...
    : (Pn = t[169]);
  let Fn;
  t[170] !== R || t[171] !== An || t[172] !== jn || t[173] !== Pn
    ? ((Fn = (0, g.jsxs)(`div`, { "aria-invalid": R, className: An, children: [jn, Pn] })),
      (t[170] = R),
      (t[171] = An),
      (t[172] = jn),
      (t[173] = Pn),
        ...
        yt == null
          ...
          : (0, g.jsx)(`p`, {
              ...
              className: d(
                ...
                R ? `text-token-error-foreground` : `text-[var(--referral-modal-secondary)]`,
              ),
              id: gt,
              children: yt,
            })),
  ...
  let In;
  t[179] !== Fn || t[180] !== $
    ? ((In = (0, g.jsxs)(`div`, { className: `flex flex-col gap-2`, children: [Fn, $] })),
      (t[179] = Fn),
      (t[180] = $),
      (t[181] = In))
    : (In = t[181]);
  ...
  let Bn = y
      ? (0, g.jsxs)(`div`, {
          ...
          children: [
            (0, g.jsx)(`div`, {
              ...
              children:
                Ot == null
                  ? (0, g.jsx)(xe, { className: `size-5` })
                  : Array.from({ length: Ot.invites_total }, je),
            }),
            (0, g.jsx)(`p`, {
              ...
              children:
                Ot == null
                  ...
                  : (0, g.jsx)(u, {
                      ...
                      values: { inviteLimit: Ot.invites_total, scope: Dt },
                    }),
            }),
            (0, g.jsx)(`p`, {
    ...
    Vn =
      Tt || Et
        ? (0, g.jsx)(`div`, {
            className: d(_.optionalRows, pt && _.optionalRowsHidden),
            children: (0, g.jsxs)(`div`, {
              className: d(_.optionalRowsContent, `flex flex-col`),
              children: [
                (0, g.jsx)(`div`, {
                  "aria-hidden": !Tt,
                  className: d(_.consentRow, Tt && _.consentRowVisible),
        ...
        : null,
    Hn;
  t[186] !== On || t[187] !== In || t[188] !== zn || t[189] !== Bn || t[190] !== Vn
    ? ((Hn = (0, g.jsxs)(`div`, { className: `flex flex-col`, children: [On, In, zn, Bn, Vn] })),
      (t[186] = On),
      (t[187] = In),
      (t[188] = zn),
      (t[189] = Bn),
    ...
    : (Hn = t[191]);
  let Un;
  t[192] !== _n || t[193] !== bn || t[194] !== xn || t[195] !== En || t[196] !== Hn
    ? ((Un = (0, g.jsxs)(`form`, {
        "aria-hidden": _n,
        className: bn,
        noValidate: !0,
  ...
  t[200] === qn
    ...
    : ((Jn = d(
      ...
      (t[201] = Jn));
  let Yn;
  t[202] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Yn = (0, g.jsx)(ve, { className: `size-5` })), (t[202] = Yn))
    : (Yn = t[202]);
  let Xn;
  t[203] === Jn
    ? (Xn = t[204])
    : ((Xn = (0, g.jsx)(`div`, { className: Jn, "aria-hidden": `true`, children: Yn })),
      (t[203] = Jn),
      (t[204] = Xn));
  let Zn = F && _.successTitleVisible,
    Qn;
  t[205] === Zn
    ? (Qn = t[206])
    : ((Qn = d(
  ...
  t[207] === k?.type
    ? ($n = t[208])
    : (($n = k?.type === `success` ? (0, g.jsx)(Be, {}) : null), (t[207] = k?.type), (t[208] = $n));
  let er;
  t[209] !== Qn || t[210] !== $n
    ? ((er = (0, g.jsx)(`h2`, { className: Qn, children: $n })),
      (t[209] = Qn),
      (t[210] = $n),
      (t[211] = er))
    : (er = t[211]);
  let tr = F && _.successDescriptionVisible,
    nr;
  t[212] === tr
    ? (nr = t[213])
    : ((nr = d(
      ...
      (t[213] = nr));
  let rr = F ? Xe : void 0,
    ir = k?.type === `success` ? k.emails.length : 1,
    ar;
  t[214] !== y || t[215] !== z || t[216] !== c || t[217] !== B || t[218] !== V || t[219] !== ir
    ? ((ar = (0, g.jsx)(Ve, {
        count: ir,
        credits: V,
        grantAmount: V,
    ...
    : (ar = t[220]);
  let or;
  t[221] !== ar || t[222] !== nr || t[223] !== rr
    ? ((or = (0, g.jsx)(`p`, { className: nr, id: rr, children: ar })),
      (t[221] = ar),
      (t[222] = nr),
      (t[223] = rr),
      (t[224] = or))
    : (or = t[224]);
  let sr = F ? `pointer-events-auto` : `pointer-events-none`,
    cr = F && _.successButtonVisible,
    lr;
  t[225] !== sr || t[226] !== cr
    ? ((lr = d(
        _.successButton,
  ...
  t[228] !== H || t[229] !== s
    ? ((ur = () => {
        (H({ action: m.CODEX_REFERRAL_INVITE_MODAL_ACTION_DONE_CLICKED }), s());
      }),
      (t[228] = H),
      (t[229] = s),
      (t[230] = ur))
    : (ur = t[230]);
  let dr;
  t[231] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((dr = (0, g.jsx)(u, {
  ...
  let fr;
  t[232] !== lr || t[233] !== ur
    ? ((fr = (0, g.jsx)(ie, { className: lr, onClick: ur, type: `button`, children: dr })),
      (t[232] = lr),
      (t[233] = ur),
      (t[234] = fr))
    : (fr = t[234]);
  let pr;
  t[235] !== or || t[236] !== fr || t[237] !== Wn || t[238] !== Kn || t[239] !== Xn || t[240] !== er
    ? ((pr = (0, g.jsxs)(`div`, {
        "aria-hidden": Wn,
        "aria-live": `polite`,
        className: Kn,
        children: [Xn, er, or, fr],
      })),
      (t[235] = or),
      (t[236] = fr),
      (t[237] = Wn),
  ...
  t[247] !== gn ||
  t[248] !== Un
    ? ((mr = (0, g.jsxs)(`section`, { className: X, children: [en, rn, an, gn, Un, pr] })),
      (t[242] = pr),
      (t[243] = X),
      (t[244] = en),
      (t[245] = rn),
  ...
  let hr;
  return (
    t[250] !== Jt || t[251] !== I || t[252] !== mr || t[253] !== q || t[254] !== Y
      ? ((hr = (0, g.jsx)(Jt, {
          open: !0,
          onOpenChange: q,
...
function ke(e) {
  (e.preventDefault(), o.dispatchMessage(`open-in-browser`, { url: Te }));
}
function Ae(e) {
  return !e;
}
function je(e, t) {
  return (0, g.jsx)(xe, { className: `size-5` }, t);
}
function Me(e) {
  return e.email;
}
...
function Ve(e) {
  ...
  if (s === `rateLimitReset`) {
    if (o === `codex_login`) {
      if (a) {
        let e;
        t[4] === i ? (e = t[5]) : ((e = (0, g.jsx)(x, { grantAmount: i })), (t[4] = i), (t[5] = e));
        let r;
        return (
          t[6] !== n || t[7] !== e
            ? ((r = (0, g.jsx)(u, {
      ...
      let e;
      t[9] === i ? (e = t[10]) : ((e = (0, g.jsx)(x, { grantAmount: i })), (t[9] = i), (t[10] = e));
      let r;
      return (
        t[11] !== n || t[12] !== e
          ? ((r = (0, g.jsx)(u, {
    ...
    if (a) {
      ...
      t[14] === i
        ? (e = t[15])
        : ((e = (0, g.jsx)(x, { grantAmount: i })), (t[14] = i), (t[15] = e));
      let r;
      return (
        t[16] !== n || t[17] !== e
          ? ((r = (0, g.jsx)(u, {
    ...
    let e;
    t[19] === i ? (e = t[20]) : ((e = (0, g.jsx)(x, { grantAmount: i })), (t[19] = i), (t[20] = e));
    let r;
    return (
      t[21] !== n || t[22] !== e
        ? ((r = (0, g.jsx)(u, {
...
function qe(e) {
  ...
  try {
    let t = Ee.safeParse(JSON.parse(e.message));
    if (!t.success)
      return {
        backendErrorAnalytics: C({ hasBackendDetail: !1, status: e.status }),
        failedEmails: void 0,
        message: void 0,
      };
...
function C({ hasBackendDetail: e, message: t, status: n }) {
  let r = Je({ message: t, status: n });
  return { errorResponsibility: w(r), errorType: r, hasBackendDetail: e, httpStatus: n };
}
...
export { b as t };
//# sourceMappingURL=referral-invite-modal-CL-_nI4E.js.map
