...
var s,
  c = e(() => {
    s = `` + new URL(`codex-app-ga-logo--UgmJjKM.png`, import.meta.url).href;
  }),
  l,
  u,
  d = e(() => {
          ...
          children: [
            ...
            (0, l.jsx)(`defs`, {
              children: (0, l.jsx)(`clipPath`, {
                id: `clip0_1683_12416`,
                children: (0, l.jsx)(`rect`, { width: 36, height: 36, fill: `white` }),
              }),
            }),
          ],
        })));
...
function f(e) {
  ...
  return (
    t[0] !== r || t[1] !== i
      ? ((a =
          r === n.ChatGPT
            ? (0, m.jsx)(u, { "aria-hidden": `true`, className: i })
            : (0, m.jsx)(`img`, {
                alt: ``,
                "aria-hidden": `true`,
                className: i,
...
export { s as a, d as i, h as n, c as o, u as r, f as t };
//# sourceMappingURL=app-initial~app-main~onboarding-page~login-route~appearance-settings~general-settings.js.map
