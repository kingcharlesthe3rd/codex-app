import { i as e, n as t, r as n, t as r } from "./src-5.js";
import { f as i } from "./chunk-33.js";
import { A as a } from "./runtime.worker-1.js";
import { $ as o, K as s, Q as c, a as l, b as u, o as d, tt as f, y as p } from "./chunk-84.js";
  ...
  var e = n(function (e, t, n, r) {
    ...
    u = {
      ...
      table: [
        ...
        e(t, [2, 10], { 1: [2, 1] }),
        e(t, [2, 6]),
        { 12: 21, 14: r, 15: i, 17: a, 19: o, 20: s, 21: 17, 22: 18, 23: c, 24: l },
        e(t, [2, 8]),
        e(t, [2, 9]),
        e(t, [2, 11]),
        { 16: [1, 22] },
...
var v = ``,
  ...
  te = n(function (e, t) {
    ...
    return (n(c, `ambivalent`), t.score > 3 ? o(i) : t.score < 3 ? s(i) : c(i), r);
  }, `drawFace`),
  ne = n(function (e, t) {
...
var ce = n(function (e, t, n, i, a, o = !1) {
    ...
    if (
      ...
      l && p.attr(`transform`, `translate(${t.width / 2}, ${o ? t.padding / 2 + 3 : t.padding})`),
      ue(f, t, u, a, i),
  ...
  de = n(function (t, n, i, a) {
    ...
    x.forEach(function (t) {
      let n = { number: O, descr: t, section: O, width: 150, padding: 20, maxHeight: S },
    ...
    for (let [t, n] of y.entries()) {
      let r = { number: t, descr: n, section: n.section, width: 150, padding: 20, maxHeight: C },
  ...
  W = n(function (t, n, r, i, a, o, s, c, l, u, d, f) {
    for (let c of n) {
      let n = { descr: c.task, section: r, number: r, width: 150, padding: 20, maxHeight: o };
      e.debug(`taskNode`, n);
  ...
  fe = n(function (t, n, r, i, a, o, s) {
    ...
    a += 100;
    for (let l of n) {
      let n = { descr: l, section: r, number: r, width: 150, padding: 20, maxHeight: 50 };
      e.debug(`eventNode`, n);
  ...
  _e = n(function (t, n, r, a) {
    ...
    p.forEach(function (t) {
      let n = { number: w, descr: t, section: w, width: D, padding: K, maxHeight: h },
    ...
    for (let [t, n] of d.entries()) {
      let r = { number: t, descr: n, section: n.section, width: G, padding: K, maxHeight: g },
    ...
    T
      ? p.forEach((t) => {
          let n = d.filter((e) => e.section === t),
            r = { number: w, descr: t, section: w, width: D, padding: K, maxHeight: h };
  ...
  $ = n(function (t, n, r, i, a, o, s, c, l) {
    for (let u of n) {
      let n = { descr: u.task, section: r, number: r, width: G, padding: K, maxHeight: o };
      e.debug(`taskNode`, n);
  ...
  ve = n(function (t, n, r, i, a, o, s) {
    let c = o;
    for (let o of n) {
      let n = { descr: o, section: r, number: r, width: q, padding: K, maxHeight: 0 };
      e.debug(`eventNode`, n);
