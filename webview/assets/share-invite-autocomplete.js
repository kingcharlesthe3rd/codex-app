...
import { Ah as r, jh as i } from "./app-initial~app-main~onboarding-page.js";
import {
  dt as a,
  ut as o,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~onboarding-page~project~okyna5mq.js";
import { nx as s, rx as c } from "./app-initial~app-main~new-thread-panel-page.js";
import {
  $ as l,
  F as u,
  P as d,
...
function p(e) {
  let t = (0, v.c)(68),
    ...
    O;
  t[0] === C ? (O = t[1]) : ((O = C === void 0 ? [] : C), (t[0] = C), (t[1] = O));
  let k = O,
    A = ee === void 0 ? !0 : ee,
  ...
  t[17] !== N || t[18] !== L || t[19] !== R || t[20] !== I
    ? ((z = { items: N, isActive: I, onSelect: L, onEscape: R }),
      ...
      (t[21] = z))
    : (z = t[21]);
  let { highlightedIndex: B, listRef: ae, getInputProps: oe, getItemProps: V } = i(z),
    se = j === `field` && `relative`,
    H;
  t[22] === se ? (H = t[23]) : ((H = s(se)), (t[22] = se), (t[23] = H));
  let U =
      j === `field`
  ...
  t[24] === U
    ? (W = t[25])
    : ((W = s(`flex w-full flex-wrap items-center gap-1 text-base text-token-input-foreground`, U)),
      (t[24] = U),
      (t[25] = W));
  let G;
  t[26] !== o || t[27] !== E || t[28] !== k || t[29] !== j
    ? ((G =
        j === `field`
          ? k.map((e) =>
              (0, y.jsxs)(
                  ...
                  children: [
                    ...
                    o != null && E != null
                      ? (0, y.jsx)(`button`, {
                          ...
                          children: (0, y.jsx)(d, { "aria-hidden": !0, className: `icon-2xs` }),
                        })
                      : null,
                  ],
                },
  ...
  t[36] === T
    ...
    : ((Y = (e) => {
      ...
      (t[37] = Y));
  let X;
  t[38] !== n || t[39] !== D || t[40] !== x || t[41] !== q || t[42] !== J || t[43] !== Y
    ? ((X = (0, y.jsx)(`input`, {
        ...q,
        "aria-label": n,
    ...
    : (X = t[44]);
  let Z;
  t[45] !== c || t[46] !== W || t[47] !== G || t[48] !== X || t[49] !== w
    ? ((Z = (0, y.jsxs)(`div`, { className: W, children: [c, G, X, w] })),
      (t[45] = c),
      (t[46] = W),
      (t[47] = G),
      (t[48] = X),
    ...
    ? ((Q = F
        ? (0, y.jsx)(`div`, {
            className: s(
              ...
              j === `field` && `absolute z-10 mt-2 rounded-md border border-token-border shadow-sm`,
            ),
              ...
              children:
                N == null
                  ? (0, y.jsx)(`div`, {
                      ...
                      children: (0, y.jsx)(l, { className: `icon-xs` }),
                    })
                  : N.length === 0
                    ? (0, y.jsx)(`div`, {
...
function _(e) {
  let t = (0, v.c)(25),
    { disabled: n, highlightedIndex: r, index: i, option: a, selected: c, getItemProps: l } = e,
    u = a.Icon,
    d;
  t[0] !== l || t[1] !== i ? ((d = l(i)), (t[0] = l), (t[1] = i), (t[2] = d)) : (d = t[2]);
  let f = c ?? i === r,
  ...
  t[8] === a.label
    ? (g = t[9])
    : ((g = (0, y.jsx)(`span`, { className: `text-sm text-token-foreground`, children: a.label })),
      (t[8] = a.label),
      (t[9] = g));
  let _;
  ...
  t[15] === c
    ? (x = t[16])
    : ((x = c ? (0, y.jsx)(o, { "aria-hidden": !0, className: `icon-sm shrink-0` }) : null),
      (t[15] = c),
      (t[16] = x));
  let S;
  return (
