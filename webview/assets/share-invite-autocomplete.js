...
function p(e) {
  ...
  t[17] !== P || t[18] !== R || t[19] !== z || t[20] !== L
    ? ((B = { items: P, isActive: L, onSelect: R, onEscape: z }),
      ...
      (t[21] = B))
    : (B = t[21]);
  let { highlightedIndex: V, listRef: H, getInputProps: ie, getItemProps: U } = f(B),
    ae = M === `field` && `relative`,
    W;
                  ...
                  children: [
                    ...
                    o != null && D != null
                      ? (0, y.jsx)(`button`, {
                          ...
                          children: (0, y.jsx)(c, { "aria-hidden": !0, className: `icon-2xs` }),
                        })
                      : null,
                  ],
                },
  ...
  t[36] === E
    ...
    : ((Y = (e) => {
      ...
      (t[37] = Y));
  let X;
  t[38] !== n || t[39] !== O || t[40] !== x || t[41] !== J || t[42] !== se || t[43] !== Y
    ? ((X = (0, y.jsx)(`input`, {
        ...J,
        "aria-label": n,
...
function _(e) {
  let t = (0, v.c)(25),
    { disabled: n, highlightedIndex: r, index: i, option: a, selected: s, getItemProps: c } = e,
    u = a.Icon,
    d;
  ...
  t[15] === s
    ? (x = t[16])
    : ((x = s ? (0, y.jsx)(o, { "aria-hidden": !0, className: `icon-sm shrink-0` }) : null),
      (t[15] = s),
      (t[16] = x));
  let S;
  return (
