...
function p(e) {
  let n = (0, v.c)(68),
    ...
    k = a === void 0 ? !1 : a,
    ne = f === void 0 ? `default` : f,
    A;
  n[0] === C ? (A = n[1]) : ((A = C === void 0 ? [] : C), (n[0] = C), (n[1] = A));
  let j = A,
    M = ee === void 0 ? !0 : ee,
    N = te === void 0 ? `field` : te,
    P;
  n[2] !== g || n[3] !== p
    ? ((P = g?.flatMap(m) ?? p), (n[2] = g), (n[3] = p), (n[4] = P))
    : (P = n[4]);
  let F = P,
    I;
  n[5] !== k || n[6] !== F || n[7] !== x || n[8] !== M || n[9] !== N
    ? ((I =
        N === `menu`
          ? F != null || (M && x.trim().length > 0)
          : !k && x.trim().length > 0 && (M || F != null)),
      (n[5] = k),
      (n[6] = F),
      (n[7] = x),
      (n[8] = M),
  ...
  n[14] !== T || n[15] !== E
    ...
    : (B = n[16]);
  let V;
  n[17] !== F || n[18] !== z || n[19] !== B || n[20] !== R
    ? ((V = { items: F, isActive: R, onSelect: z, onEscape: B }),
      (n[17] = F),
      (n[18] = z),
      (n[19] = B),
      (n[20] = R),
      (n[21] = V))
    : (V = n[21]);
  let { highlightedIndex: H, listRef: re, getInputProps: ie, getItemProps: U } = r(V),
    ae = N === `field` && `relative`,
    W;
  n[22] === ae ? (W = n[23]) : ((W = s(ae)), (n[22] = ae), (n[23] = W));
  let oe =
      N === `field`
          ...
          ? j.map((e) =>
              (0, y.jsxs)(
                `span`,
                {
                  ...
                  children: [
                    (0, y.jsx)(`span`, { className: `truncate`, children: e.chipLabel ?? e.label }),
                    l != null && D != null
                      ? (0, y.jsx)(`button`, {
                          type: `button`,
                          "aria-label": l(e),
                          ...
                          children: (0, y.jsx)(t, { "aria-hidden": !0, className: `icon-2xs` }),
                        })
                      : null,
                  ],
                },
  ...
  n[31] === L
    ? (q = n[32])
    : ((q = (e) => {
        L && e.key === `Enter` && e.preventDefault();
      }),
      (n[31] = L),
      (n[32] = q));
  let J;
  n[33] !== ie || n[34] !== q
    ...
    : (J = n[35]);
  let se = N === `menu` || j.length === 0 ? b : void 0,
    Y;
  n[36] === E
    ? (Y = n[37])
    : ((Y = (e) => {
      ...
      (n[37] = Y));
  let X;
  n[38] !== i || n[39] !== k || n[40] !== x || n[41] !== J || n[42] !== se || n[43] !== Y
    ? ((X = (0, y.jsx)(`input`, {
        ...J,
        "aria-label": i,
    ...
    : (X = n[44]);
  let Z;
  n[45] !== u || n[46] !== G || n[47] !== K || n[48] !== X || n[49] !== w
    ? ((Z = (0, y.jsxs)(`div`, { className: G, children: [u, K, X, w] })),
      (n[45] = u),
      (n[46] = G),
      (n[47] = K),
      (n[48] = X),
    ...
    ? ((Q = L
        ? (0, y.jsx)(`div`, {
            className: s(
              ...
              N === `field` && `absolute z-10 mt-2 rounded-md border border-token-border shadow-sm`,
            ),
            children: (0, y.jsx)(`div`, {
              ref: re,
              className: s(
                `flex max-h-64 flex-col overflow-y-auto p-1`,
                F == null && (ne === `compact` ? `min-h-16` : `min-h-64`),
              ),
              role: `listbox`,
              children:
                F == null
...
function _(e) {
  let t = (0, v.c)(25),
    { disabled: r, highlightedIndex: i, index: a, option: o, selected: c, getItemProps: l } = e,
    u = o.Icon,
    d;
  t[0] !== l || t[1] !== a ? ((d = l(a)), (t[0] = l), (t[1] = a), (t[2] = d)) : (d = t[2]);
  let f = c ?? a === i,
  ...
  t[3] === p
    ...
    : ((m = s(
      ...
      (t[4] = m));
  let h;
  t[5] !== u || t[6] !== o.imageUrl
    ? ((h =
        o.imageUrl == null
          ? u == null
            ? null
            : (0, y.jsx)(u, { "aria-hidden": !0, className: `icon-sm mt-0.5 shrink-0` })
          : (0, y.jsx)(`img`, {
              alt: ``,
  ...
  t[8] === o.label
    ? (g = t[9])
    : ((g = (0, y.jsx)(`span`, { className: `text-sm text-token-foreground`, children: o.label })),
      (t[8] = o.label),
      (t[9] = g));
  let _;
  t[10] === o.secondaryLabel
    ? (_ = t[11])
    : ((_ =
  ...
  let b;
  t[12] !== g || t[13] !== _
    ? ((b = (0, y.jsxs)(`span`, { className: `flex min-w-0 flex-1 flex-col`, children: [g, _] })),
      (t[12] = g),
      (t[13] = _),
      (t[14] = b))
    : (b = t[14]);
  ...
  t[15] === c
    ? (x = t[16])
    : ((x = c ? (0, y.jsx)(n, { "aria-hidden": !0, className: `icon-sm shrink-0` }) : null),
      (t[15] = c),
      (t[16] = x));
  let S;
  return (
...
//# sourceMappingURL=share-invite-autocomplete.js.map
