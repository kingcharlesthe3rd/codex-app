...
import { M_ as d, j_ as f } from "./app-initial~app-main~onboarding-page.js";
function p(e) {
  let t = (0, v.c)(68),
    {
      ariaLabel: n,
    ...
    D = i === void 0 ? !1 : i,
    O = f === void 0 ? `default` : f,
    k;
  t[0] === C ? (k = t[1]) : ((k = C === void 0 ? [] : C), (t[0] = C), (t[1] = k));
  let A = k,
    j = ee === void 0 ? !0 : ee,
  ...
  t[17] !== P || t[18] !== R || t[19] !== z || t[20] !== L
    ? ((B = { items: P, isActive: L, onSelect: R, onEscape: z }),
      ...
      (t[21] = B))
    : (B = t[21]);
  let { highlightedIndex: V, listRef: H, getInputProps: ie, getItemProps: U } = d(B),
    ae = M === `field` && `relative`,
    W;
                  ...
                  children: [
                    ...
                    o != null && T != null
                      ? (0, y.jsx)(`button`, {
                          ...
                          children: (0, y.jsx)(r, { "aria-hidden": !0, className: `icon-2xs` }),
                        })
                      : null,
                  ],
                },
    ...
    ? ((Q = I
        ? (0, y.jsx)(`div`, {
            className: u(
              ...
              M === `field` && `absolute z-10 mt-2 rounded-md border border-token-border shadow-sm`,
            ),
