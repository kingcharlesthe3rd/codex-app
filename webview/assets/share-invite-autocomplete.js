...
function p(e) {
  ...
  t[17] !== N || t[18] !== L || t[19] !== R || t[20] !== I
    ? ((z = { items: N, isActive: I, onSelect: L, onEscape: R }),
      ...
      (t[21] = z))
    : (z = t[21]);
  let { highlightedIndex: B, listRef: ae, getInputProps: oe, getItemProps: V } = f(z),
    se = j === `field` && `relative`,
    H;
  t[22] === se ? (H = t[23]) : ((H = c(se)), (t[22] = se), (t[23] = H));
  let U =
      j === `field`
  ...
  t[24] === U
    ? (W = t[25])
    : ((W = c(`flex w-full flex-wrap items-center gap-1 text-base text-token-input-foreground`, U)),
      (t[24] = U),
      (t[25] = W));
  let G;
                  ...
                  children: [
                    ...
                    o != null && E != null
                      ? (0, y.jsx)(`button`, {
                          ...
                          children: (0, y.jsx)(l, { "aria-hidden": !0, className: `icon-2xs` }),
                        })
                      : null,
                  ],
                },
  ...
  t[38] !== n || t[39] !== D || t[40] !== x || t[41] !== q || t[42] !== J || t[43] !== Y
    ...
    : (X = t[44]);
  let Z;
  t[45] !== s || t[46] !== W || t[47] !== G || t[48] !== X || t[49] !== w
    ? ((Z = (0, y.jsxs)(`div`, { className: W, children: [s, G, X, w] })),
      (t[45] = s),
      (t[46] = W),
      (t[47] = G),
      (t[48] = X),
              ...
              children:
                N == null
                  ? (0, y.jsx)(`div`, {
                      ...
                      children: (0, y.jsx)(i, { className: `icon-xs` }),
                    })
                  : N.length === 0
                    ? (0, y.jsx)(`div`, {
...
function _(e) {
  let t = (0, v.c)(25),
    { disabled: n, highlightedIndex: r, index: i, option: a, selected: o, getItemProps: s } = e,
    l = a.Icon,
    d;
  t[0] !== s || t[1] !== i ? ((d = s(i)), (t[0] = s), (t[1] = i), (t[2] = d)) : (d = t[2]);
  let f = o ?? i === r,
  ...
  t[5] !== l || t[6] !== a.imageUrl
    ? ((h =
        a.imageUrl == null
          ? l == null
            ? null
            : (0, y.jsx)(l, { "aria-hidden": !0, className: `icon-sm mt-0.5 shrink-0` })
          : (0, y.jsx)(`img`, {
              alt: ``,
  ...
  t[15] === o
    ? (x = t[16])
    : ((x = o ? (0, y.jsx)(u, { "aria-hidden": !0, className: `icon-sm shrink-0` }) : null),
      (t[15] = o),
      (t[16] = x));
  let S;
  return (
