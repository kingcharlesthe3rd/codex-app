...
import { t as i } from "./isEmpty-2.js";
import { a, d as o, h as s, i as c, m as l, r as u } from "./chunk-13.js";
import { t as d } from "./src-1.js";
import { t as f } from "./clsx.js";
import "./react-dom.js";
import { i as p, n as m, r as h } from "./chunk-63.js";
import {
  J as g,
  M as _,
  P as v,
...
import { i as B } from "./chunk-6.js";
import "./chunk-94.js";
import "./chunk-73.js";
import "./chunk-4.js";
import "./chunk-99.js";
import "./chunk-12.js";
import { n as te } from "./chunk-113.js";
import { n as ne, t as re } from "./chunk-10.js";
import { t as ie } from "./chunk-7.js";
import { n as ae, r as oe, t as se } from "./Serializer.js";
import { lt as ce } from "./vscode-api.js";
import { c as le, o as ue } from "./lib-2.js";
import { t as de } from "./use-is-dark.js";
import "./window-zoom-context.js";
import { t as fe } from "./tooltip.js";
...
import "./check-md.js";
import { n as he, t as ge } from "./expand.js";
import "./copy.js";
...
`);
  ...
  _t = {
    ...
    loader: m(async () => {
      let { diagram: e } = await t(
        async () => {
          let { diagram: e } = await import(`./blockDiagram-2.js`);
          return { diagram: e };
        },
        __vite__mapDeps([
...
:root { --mermaid-alt-font-family: ${e.altFontFamily}}`),
  ...
  nn = m((e, t, n, r, i) => {
    ...
    let o = a.append(`svg`).attr(`id`, t).attr(`width`, `100%`).attr(`xmlns`, zt);
...
var rn = m((e, t, n, r) => {
  ...
  an = m(async function (e, t, n) {
    ...
    n === void 0
      ? (rn(document, e, c, o),
        p
          ? ((f = d(G(d(`body`), o).nodes()[0].contentDocument.body)), (f.node().style.margin = 0))
          : (f = d(`body`)),
        nn(f, e, c))
      : (n && (n.innerHTML = ``),
        p
          ? ((f = d(G(d(n), o).nodes()[0].contentDocument.body)), (f.node().style.margin = 0))
          : (f = d(n)),
    ...
    (cn(x, O, k, A), f.select(`[id="${e}"]`).selectAll(`foreignobject > *`).attr(`xmlns`, Vt));
...
var ln = m((e, t, n) => {
  ...
  un = m(async function (e = { querySelector: `.mermaid` }) {
    try {
      ...
      if ((o(t) && h.error(t.str), Y.parseError && Y.parseError(t), !e.suppressErrors))
  ...
  dn = m(async function (
    ...
    for (let t of Array.from(i)) {
      if ((h.info(`Rendering diagram: ` + t.id), t.getAttribute(`data-processed`))) continue;
...
function Mn(e) {
  ...
  let d = u,
    p;
  t[5] === d ? (p = t[6]) : ((p = d == null ? null : Sn(d)), (t[5] = d), (t[6] = p));
  let m = p;
  if (d == null) {
    let e;
  ...
  let g = a == null ? void 0 : `true`,
    _ = !!o,
    v;
  t[16] !== n || t[17] !== l || t[18] !== m || t[19] !== i || t[20] !== d || t[21] !== _
    ? ((v = (0, Z.jsx)(Nn, {
        code: n,
        diagramId: l,
        diagramKind: m,
...
function Nn(e) {
  let t = (0, ve.c)(57),
    { code: n, diagramId: r, diagramKind: i, fallback: a, isDark: o, sanitizedCode: s } = e,
    c = le(),
    l = (0, X.useRef)(null),
    ...
    h = `${o ? `dark` : `light`}::${s}`,
    g;
  t[0] === n ? (g = t[1]) : ((g = ["```mermaid", n, "```"]), (t[0] = n), (t[1] = g));
  let _ = g.join(`
`),
    v;
  t[2] === _
  ...
  let E;
  if (
    (t[18] !== n || t[19] !== r || t[20] !== i || t[21] !== o || t[22] !== h || t[23] !== s
      ? ((E = [n, r, i, o, h, s]),
        (t[18] = n),
        (t[19] = r),
        (t[20] = i),
  ...
  let M;
  t[37] !== y || t[38] !== j
    ? ((M = (0, Z.jsx)(_e, { iconClassName: `icon-2xs`, iconOnly: !0, buttonText: j, onCopy: y })),
      (t[37] = y),
      (t[38] = j),
      (t[39] = M))
    : (M = t[39]);
  ...
  t[40] !== A || t[41] !== M
    ? ((N = (0, Z.jsxs)(`div`, {
      ...
      (t[42] = N))
    : (N = t[42]);
  let P = p ? `max-h-[var(--markdown-wide-block-max-height)] overflow-auto` : `overflow-x-auto`,
    F;
  ...
  t[48] === n
    ? (R = t[49])
    : ((R = (0, Z.jsx)(`pre`, { className: `sr-only whitespace-pre-wrap`, children: n })),
      (t[48] = n),
      (t[49] = R));
  let z;
