...
function fe(e) {
  ...
  t[2] !== y.formatMessage || t[3] !== S
    ? ((C = g(S, y.formatMessage)), (t[2] = y.formatMessage), (t[3] = S), (t[4] = C))
    : (C = t[4]);
  ...
  if (t[50] !== A || t[51] !== w || t[52] !== V || t[53] !== b) {
    let e = (t) =>
      t.map((t) =>
        t.type === `separator`
          ? (0, h.jsx)(l, { className: `mx-1 my-1 border-t border-token-border/60` }, t.id)
          : t.type === `checkbox`
            ? (0, h.jsx)(
                ie,
                {
                  tooltipContent: t.tooltipMessage
                    ? (0, h.jsx)(f, { ...t.tooltipMessage, values: t.tooltipMessageValues })
                    : null,
                  children: (0, h.jsx)(ee, {
                    checked: t.checked ?? !1,
                    className: r(
                  ...
                  d,
                  {
                    children: [
                      (0, h.jsx)(s, {
                        ...
                        disabled: t.enabled === !1,
                        children: (0, h.jsx)(me, { icon: t.icon, label: F(t), showChevron: !0 }),
                      }),
                      (0, h.jsx)(o, {
                        children: (0, h.jsx)(a, {
    ...
    ((W = i),
      ...
      t[65] === V
        ? (X = t[66])
        : ((X = (0, h.jsx)(te, { asChild: !0, children: V })), (t[65] = V), (t[66] = X)),
      (U = o),
      (H = c),
  ...
  t[69] !== H || t[70] !== G || t[71] !== K || t[72] !== q || t[73] !== J
    ? ((Z = (0, h.jsx)(H, { className: G, collisionPadding: K, style: q, children: J })),
      (t[69] = H),
      (t[70] = G),
      (t[71] = K),
      (t[72] = q),
  ...
  let Q;
  t[75] !== U || t[76] !== Z
    ? ((Q = (0, h.jsx)(U, { children: Z })), (t[75] = U), (t[76] = Z), (t[77] = Q))
    : (Q = t[77]);
  let $;
  return (
...
function pe(e) {
  return e.message ? (0, h.jsx)(f, { ...e.message, values: e.messageValues }) : e.id;
}
function me(e) {
  let t = (0, ce.c)(15),
  ...
  t[0] !== n || t[1] !== a
    ? ((s = a
        ? (0, h.jsx)(`span`, {
            ...
            children: n ? (0, h.jsx)(oe, { "aria-hidden": !0, className: `icon-xs` }) : null,
          })
        : null),
      (t[0] = n),
      (t[1] = a),
  ...
  t[3] !== r || t[4] !== i
    ? ((c = r
        ? (0, h.jsx)(`img`, { alt: typeof i == `string` ? i : ``, src: r, className: `icon-sm` })
        : null),
      (t[3] = r),
      (t[4] = i),
      (t[5] = c))
  ...
  t[6] === i
    ? (l = t[7])
    : ((l = (0, h.jsx)(`span`, { className: `truncate`, children: i })), (t[6] = i), (t[7] = l));
  let u;
  t[8] === o
    ? (u = t[9])
    : ((u = o ? (0, h.jsx)(se, { className: `icon-xs ml-auto opacity-50` }) : null),
      (t[8] = o),
      (t[9] = u));
  let d;
  return (
