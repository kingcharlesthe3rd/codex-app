...
import { lt as f } from "./vscode-api.js";
import { c as ne, o as re } from "./lib-2.js";
...
function he(e) {
  ...
  t[0] !== n || t[1] !== a
    ? ((s = a
        ? (0, m.jsx)(`span`, {
            ...
            children: n ? (0, m.jsx)(se, { "aria-hidden": !0, className: `icon-xs` }) : null,
          })
        : null),
      (t[0] = n),
      (t[1] = a),
  ...
  t[8] === o
    ? (u = t[9])
    : ((u = o ? (0, m.jsx)(ce, { className: `icon-xs ml-auto opacity-50` }) : null),
      (t[8] = o),
      (t[9] = u));
  let d;
  return (
