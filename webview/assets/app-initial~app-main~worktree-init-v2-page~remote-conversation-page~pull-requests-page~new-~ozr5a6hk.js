...
var At,
  ...
  qt = e(() => {
    (i(),
      ...
      (Lt = _e(d, `active-workspace-roots`, { placeholderData: ge, staleTime: A.FIVE_SECONDS })),
      (R = a(d, ({ get: e }) => {
        let t = e(Lt);
        return t.isPending
          ? !0
          : (t.data?.roots ?? []).length === 1 && et(e, p.PROJECT_WRITABLE_ROOTS).isPending;
      })),
      (Rt = k(d, (e, { get: t }) =>
        pe({
          projectId: e,
...
function Jt(e, t) {
  let n = (0, V.c)(11),
    ...
    l = E(),
    u;
  n[0] !== r || n[1] !== s ? ((u = [...H, r, s]), (n[0] = r), (n[1] = s), (n[2] = u)) : (u = n[2]);
  let d;
  n[3] !== r || n[4] !== l || n[5] !== s
  ...
  return (
    n[7] !== c || n[8] !== u || n[9] !== d
      ? ((f = { queryKey: u, queryFn: d, staleTime: A.FIVE_MINUTES, enabled: c, select: Yt }),
        (n[7] = c),
        (n[8] = u),
        (n[9] = d),
        (n[10] = f))
...
function Xt(e) {
  let t = (0, V.c)(6),
    ...
    r = E(),
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`) ? ((i = [...Cn, N]), (t[0] = i)) : (i = t[0]);
  let a;
  t[1] === r ? (a = t[2]) : ((a = () => z(r, N, null, !1)), (t[1] = r), (t[2] = a));
  let o;
  return (
    t[3] !== n || t[4] !== a
      ? ((o = { queryKey: i, queryFn: a, staleTime: 1 / 0, enabled: n, select: Zt }),
        (t[3] = n),
        (t[4] = a),
        (t[5] = o))
      : (o = t[5]),
...
function Qt(e, t) {
  let n = (0, V.c)(11),
    ...
    c = E(),
    l;
  n[0] !== r || n[1] !== s ? ((l = [...Tn, r, s]), (n[0] = r), (n[1] = s), (n[2] = l)) : (l = n[2]);
  let u;
  n[3] !== r || n[4] !== c || n[5] !== s
  ...
  return (
    n[7] !== l || n[8] !== u || n[9] !== d
      ? ((f = { queryKey: l, queryFn: u, staleTime: A.FIVE_MINUTES, enabled: d, select: $t }),
        (n[7] = l),
        (n[8] = u),
        (n[9] = d),
        (n[10] = f))
  ...
  return e.fetchQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return (
          o.error(`Failed to load layered config`, { safe: {}, sensitive: { error: e } }), jn
        );
      }
    },
...
function z(e, t, n, r) {
  return e.fetchQuery({
    queryKey: [...En, t, n, r],
    queryFn: () => L(`read-config-for-host`, { hostId: t, includeLayers: r, cwd: n }),
    staleTime: 0,
  });
}
  ...
  return {
    ...
    queryFn: async () => {
      try {
        ...
        return (
          o.error(`Failed to load config requirements`, { safe: {}, sensitive: { error: e } }),
          { requirements: null }
        );
      }
    },
...
function rn(e, t) {
  ...
  return (
    n[4] !== s || n[5] !== l
      ? ((u = { params: s, queryConfig: l, select: an }), (n[4] = s), (n[5] = l), (n[6] = u))
      : (u = n[6]),
...
function on(e) {
  ...
  return (
    t[5] !== i || t[6] !== a
      ? ((o = { mutationFn: i, onError: sn, onSuccess: a }), (t[5] = i), (t[6] = a), (t[7] = o))
      : (o = t[7]),
    be(o)
  );
}
function sn(e) {
  o.error(`Failed to write MCP server config`, { safe: {}, sensitive: { error: e } });
}
function cn(e) {
  let t = (0, V.c)(20),
    n = e?.hostId ?? `local`,
  ...
  t[6] !== l || t[7] !== s || t[8] !== r
    ? ((d = async (e) => {
        ...
        await Promise.all([r.cancelQueries({ queryKey: s }), r.cancelQueries({ queryKey: l })]);
        let i = [...ln(r, s), ...ln(r, l)];
  ...
  t[10] === r
    ? (f = t[11])
    : ((f = (e, t, n) => {
        o.error(`Failed to update MCP server enabled state`, { safe: {}, sensitive: { error: e } });
...
function pn(e, t) {
  return {
    queryKey: [...Dn, e, t],
    queryFn: async () =>
      L(`list-mcp-server-status`, { hostId: e, cursor: null, limit: 100, detail: t }),
    staleTime: A.FIVE_MINUTES,
  };
}
function mn(e) {
  ...
  t[0] !== l || t[1] !== r || t[2] !== u || t[3] !== i
    ? ((d = [...On, l, i, r, u]), (t[0] = l), (t[1] = r), (t[2] = u), (t[3] = i), (t[4] = d))
    : (d = t[4]);
  let f;
  t[5] !== l || t[6] !== r || t[7] !== i || t[8] !== a
    ? ((f = async () =>
        L(`read-mcp-resource`, { hostId: l, server: r, threadId: i, uri: a ?? `` }).catch((e) => {
          throw (
  ...
  return (
    t[10] !== d || t[11] !== f || t[12] !== p
      ? ((m = { queryKey: d, queryFn: f, staleTime: A.FIVE_MINUTES, enabled: p }),
        (t[10] = d),
        (t[11] = f),
        (t[12] = p),
        (t[13] = m))
      ...
      (Mn = m(d, (e, { queryClient: t }) => ({
        ...
        queryFn: async () => {
          try {
            ...
            return (o.error(`Failed to load config`, { safe: {}, sensitive: { error: e } }), jn);
          }
        },
        staleTime: A.FIVE_MINUTES,
        select: ({ config: e, layers: t }) => ({ config: e, configWriteTarget: vn(t) }),
      }))),
      (Nn = m(d, ({ authMethod: e, hostId: t }) => nn({ authMethod: e, hostId: t }))),
      (Pn = m(d, (e) => pn(e, `full`))),
...
async function Jn() {
  return (await W(() => M.safeGet(`/wham/remote/control/mfa_requirement`))).requirement;
}
async function Yn() {
...
async function Xn(e = null) {
  let t = await W(() =>
    M.safeGet(`/wham/remote/control/clients`, { parameters: { query: { cursor: e, limit: er } } }),
  );
    ...
    throw e instanceof ne
      ? e.status === 404
        ...
        : e.status === 403
          ? new ir(e.message)
          : e.status === 401
            ? (Bn(), new nr(`ChatGPT auth is required to load remote control environments.`))
...
async function or(e, { appServerHostId: t, includeBrowserClients: n = !0 } = {}) {
...
function ur(e, t, n) {
  return {
    ...
    lastSeenAt: e.lastSeenAt == null ? null : new Date(Number(e.lastSeenAt) * 1e3).toISOString(),
    ...
    (i(),
      ...
      (wr = g(d, ({ get: e }) => {
        ...
        return {
          ...
          queryFn: async () => (t ? (n == null ? !1 : (await cr(N, n)).length > 0) : Xn()),
          staleTime: 0,
        };
      })),
      (Tr = m(
        ...
        ({ hostId: e, openId: t }, { get: n, scope: r }) => ({
          ...
          queryFn: async () => (
            await Ge(r, e),
            L(`start-remote-control-pairing-for-host`, { hostId: e, manualCode: !0 })
          ),
          retry: !1,
          gcTime: 0,
          staleTime: (e) => {
  ...
  Fr = e(() => {
    (S(),
      ...
      (Pr = a(
        d,
        ({ get: e }) =>
          F(e, `remote_ssh_connections`) == null || F(e, `remote_control_connections`) == null,
      )));
  });
function Ir() {
  let e = (0, Br.c)(3),
  ...
  return (
    e[0] !== r || e[1] !== n
      ? ((i = Object.getOwnPropertyDescriptor(r, `remote_connections`)?.value === !0 || n),
        (e[0] = r),
        (e[1] = n),
        (e[2] = i))
      : (i = e[2]),
...
function Rr() {
  let e = j(Nr) ?? [];
  return { remoteConnections: e, enabledRemoteHostIdSet: new Set(e.flatMap(zr)) };
}
function zr(e) {
...
var ti,
  ...
  Di = e(() => {
    (S(),
      ...
      (wi = k(d, (e, { get: t }) =>
        Object.fromEntries(e.filter((e) => t(G, `codex:${e}`) === !1).map((e) => [e, !0])),
      )),
...
function Ai(e, t) {
  return L(`refresh-recent-conversations-for-host`, { hostId: e, sortKey: gt(t) })
    .then(() => !0)
    .catch(
      (n) => (
...
function Ni(e, t) {
  return Mi({
    ...
    subscribeToManager: (e, t) =>
      ji([e.addAnyConversationCallback(t), e.addAnyConversationMetaCallback(t)]),
  });
}
...
async function Fi({ scope: e, appServerRegistry: t, enabledRemoteHostIds: n, sortKey: r }) {
  if (!(await Promise.all(ki(e, t).map((e) => Ai(e.getHostId(), r)))).includes(!0))
    throw Error(`Failed to refresh recent conversations`);
  return Pi({ appServerRegistry: t, enabledRemoteHostIds: n, sortKey: r });
}
function Ii({ scope: e, appServerRegistry: t, sortKey: n, refreshesInFlightHostIds: r }) {
  for (let i of ki(e, t)) {
    let e = i.getHostId();
...
function Ui(e) {
  let t = (0, J.c)(6),
    ...
    i;
  t[0] !== r || t[1] !== e
    ? ((i = (t) => (e == null ? Wi : Ni(r, t))), (t[0] = r), (t[1] = e), (t[2] = i))
    : (i = t[2]);
  let a = i,
    o;
  t[3] !== r || t[4] !== e
...
function Ji(e) {
  ...
  let o = a,
    ...
    u = E(),
    f;
  t[2] === Symbol.for(`react.memo_cache_sentinel`) ? ((f = new Set()), (t[2] = f)) : (f = t[2]);
  let p = (0, Y.useRef)(f),
    m,
    g;
  ...
  t[15] !== r || t[16] !== o || t[17] !== n || t[18] !== l
    ? ((y = async () =>
        Fi({ scope: n, appServerRegistry: r, enabledRemoteHostIds: Li(o), sortKey: l })),
      (t[15] = r),
      (t[16] = o),
      (t[17] = n),
      (t[18] = l),
  ...
  return (
    t[20] !== v || t[21] !== y
      ? ((b = { queryKey: v, staleTime: A.INFINITE, structuralSharing: Yi, queryFn: y }),
        (t[20] = v),
        (t[21] = y),
        (t[22] = b))
      : (b = t[22]),
    ...
    ((Ra = 100),
      ...
      (Ha = class {
        ...
        matchingDegree(e) {
          ...
          if (t != null) return Sa(this.mainMatcher.matchingDegree(e, !1, t), t);
          if (this.fallbackMatcher == null) return za;
          let n = this.fallbackMatcher.match(e);
          return n == null ? za : Sa(this.fallbackMatcher.matchingDegree(e, !1, n), n);
        }
      }),
      (Ua = class {
        myPattern;
          ...
          for (let t of n)
            for (let n = t.startOffset; n < t.endOffset; n += 1) {
              let i = n === t.startOffset && t !== r,
                d = !1;
              for (; l <= n; ) (l === n ? (d = !0) : i && (c += 1), (l = wa(e, l)));
              let f = e[n];
              if (((s = Ea(this.myPattern, f, s + 1, this.myPattern.length, !0)), s < 0)) break;
        ...
        matchBySubstring(e) {
          ...
          return ja(e, 0, n.length, n) ? [{ startOffset: 0, endOffset: n.length }] : null;
        }
        ...
        checkForSpecialChars(e, t, n, r) {
          return n < 0 ||
            (!this.hasSeparators && !this.mixedCase && Oa(e, this.hardSeparators, t, n) !== -1) ||
            (this.hasDots && !this.isPatternChar(r - 1, `.`) && ka(e, `.`, t, n) !== -1)
            ? -1
            : n;
        }
        ...
        isMiddleMatch(e, t, n) {
          return !this.isPatternChar(t - 1, `*`) || this.isWildcard(t + 1) || !La(e[n])
            ? !1
            : !X(e, n);
        }
...
function io({ files: e, includeDirectories: t, isWindowsHost: n, query: r, roots: i }) {
  return oo(
...
function so(e) {
  o.warning(`Failed to close fuzzy file search session`, { safe: {}, sensitive: { error: e } });
}
var co,
  lo,
  $,
  ...
  po = e(() => {
    ((co = D()),
      ...
      (fo = (e, t, n, r) => {
        ...
        return (
          i[21] !== l || i[22] !== s
            ? ((w = { response: s, isLoading: l }), (i[21] = l), (i[22] = s), (i[23] = w))
            : (w = i[23]),
          w
        );
      }));
