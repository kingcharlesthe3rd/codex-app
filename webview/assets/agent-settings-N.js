...
import { Hi as t, Un as n, qi as r, zn as i } from "./src-C.js";
import { Xs as a, do as o } from "./app-server-manager-signals.js";
...
import { n as S } from "./rpc.js";
import { c as C, l as te, o as w } from "./statsig.js";
import "./request.js";
import { t as T } from "./app-server-manager-hooks-DfDI-9lO.js";
...
import { t as ge } from "./alert.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { t as _e } from "./toggle.js";
import { i as ve, t as ye } from "./settings-shared.js";
import { t as B } from "./settings-host-context.js";
import { t as be } from "./arrow-top-right.js";
import { t as xe } from "./alert-1.js";
import { t as V } from "./settings-content-layout.js";
import { i as H, t as Se } from "./primary-runtime-install-action.js";
import { a as Ce, n as we } from "./primary-runtime-query-keys.js";
import { a as Te, i as Ee, n as De, r as Oe } from "./primary-runtime-install-state.js";
import { n as U } from "./settings-row.js";
import { n as ke, t as W } from "./settings-group.js";
import { t as G } from "./lock.js";
import { n as Ae, t as je } from "./primary-runtime-install-status-message.js";
import { t as Me } from "./open-in-targets-query.js";
var K = b(),
  q = e(s(), 1);
async function Ne({ filePath: e, keyPath: t, value: n }) {
  let r = Fe(t, n);
  if (r == null) throw Error(`Unsupported config key for project config write.`);
  await Pe({ filePath: e, field: r });
}
async function Pe({ filePath: e, field: t }) {
  let n = ``;
  try {
    n = (await _(`read-file`, { params: { path: e } })).contents;
  } catch (e) {
    if (!Q(e)) throw Error(`Failed to read project config.`);
  }
  let r = J(n, t.name, t.value);
  if (r !== n)
    try {
      await _(`local-environment-config-save`, { params: { configPath: e, raw: r } });
    } catch {
...
function J(e, t, n) {
  return t === `network_access` ? Y(e, n === !0) : Ie(e, t, String(n));
}
function Ie(e, t, n) {
  let r =
      e.length > 0
...
function Re(e) {
  ...
  t[7] === x
    ? (S = t[8])
    : ((S = (0, $.jsx)(W.Header, { title: b, subtitle: x })), (t[7] = x), (t[8] = S));
  let C = W,
    te = ke,
    w;
  t[9] === s
  ...
  t[19] !== D || t[20] !== C.Content
    ? ((O = (0, $.jsx)(C.Content, { children: D })), (t[19] = D), (t[20] = C.Content), (t[21] = O))
    : (O = t[21]);
  let k;
  return (
    t[22] !== y || t[23] !== O || t[24] !== S
      ? ((k = (0, $.jsxs)(y, { children: [S, O] })),
        (t[22] = y),
        (t[23] = O),
        (t[24] = S),
        (t[25] = k))
...
var He = t({ workspaceRoot: r().min(1).nullable().optional() }).passthrough();
function Ue(e) {
...
function Ke() {
  ...
  e[9] === t
    ? (u = e[10])
    : ((u = (0, $.jsx)(F, { electron: !0, children: (0, $.jsx)(Ze, { hostId: t }) })),
      (e[9] = t),
      (e[10] = u));
  let d, p;
  ...
  e[16] === t
    ...
    : ((_ = (0, $.jsx)(F, {
      ...
      (e[17] = _));
  let v;
  e[18] !== _ || e[19] !== l || e[20] !== u
    ? ((v = (0, $.jsxs)(W, {
        className: `gap-2`,
        children: [ee, (0, $.jsxs)(W.Content, { children: [l, u, _] })],
      })),
      (e[18] = _),
      (e[19] = l),
      (e[20] = u),
  ...
  let y;
  e[22] !== a || e[23] !== t
    ? ((y = a ? (0, $.jsx)(Re, { hostId: t }) : null), (e[22] = a), (e[23] = t), (e[24] = y))
    : (y = e[24]);
  let b;
  e[25] === y
    ? (b = e[26])
    : ((b = (0, $.jsx)(F, { electron: !0, children: y })), (e[25] = y), (e[26] = b));
  let x;
  e[27] !== i || e[28] !== n || e[29] !== t
    ? ((x = i && n.kind === `local` ? (0, $.jsx)(Je, { hostId: t }) : null),
      (e[27] = i),
      (e[28] = n),
      (e[29] = t),
      (e[30] = x))
  ...
  e[31] === x
    ? (S = e[32])
    : ((S = (0, $.jsx)(F, { electron: !0, children: x })), (e[31] = x), (e[32] = S));
  let C;
  return (
    e[33] !== v || e[34] !== b || e[35] !== S
      ? ((C = (0, $.jsx)($.Fragment, {
          children: (0, $.jsxs)(V, { title: s, subtitle: c, children: [v, b, S] }),
        })),
        (e[33] = v),
        (e[34] = b),
        (e[35] = S),
...
function Je(e) {
  ...
  return (
    t[0] === n
      ? (i = t[1])
      : ((i = (0, $.jsx)(Ye, { hostId: n, primaryRuntime: r })), (t[0] = n), (t[1] = i)),
    i
  );
}
function Ye(e) {
  let t = (0, K.c)(97),
    ...
    { data: l, isLoading: _ } = m(ae, r),
    v;
  t[0] === r ? (v = t[1]) : ((v = { hostId: r }), (t[0] = r), (t[1] = v));
  let b = oe(v),
    x;
  t[2] === l ? (x = t[3]) : ((x = l?.find(Xe)), (t[2] = l), (t[3] = x));
  let S = x,
    w = S?.enabled === !0,
    T;
  t[4] !== r || t[5] !== i
    ? ((T = () => i.diagnoseDependencies({ hostId: r })), (t[4] = r), (t[5] = i), (t[6] = T))
    : (T = t[6]);
  let E;
  t[7] === r ? (E = t[8]) : ((E = we(r)), (t[7] = r), (t[8] = E));
  let D;
  t[9] !== T || t[10] !== E
    ? ((D = { queryFn: T, queryKey: E, staleTime: g.FIVE_SECONDS }),
      (t[9] = T),
      (t[10] = E),
      (t[11] = D))
    : (D = t[11]);
  let O = d(D),
    k;
  t[12] !== r || t[13] !== i
    ? ((k = { mutationFn: () => i.diagnoseDependencies({ hostId: r }) }),
      (t[12] = r),
      (t[13] = i),
      (t[14] = k))
    : (k = t[14]);
  ...
  t[15] !== i || t[16] !== s
    ? ((ne = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Ce(s), i.runUpdateNow({ release: t }));
        },
      }),
      (t[15] = i),
      (t[16] = s),
  ...
  t[18] !== r || t[19] !== i || t[20] !== s
    ? ((ie = {
        mutationFn: async (e) => {
          let { release: t } = e;
          return (await Ce(s), i.resetDependencies({ hostId: r, release: t }));
        },
      }),
      (t[18] = r),
      (t[19] = i),
  ...
  t[22] === r
    ? (le = t[23])
    : ((le = { mutationFn: () => Te({ hostId: r }) }), (t[22] = r), (t[23] = le));
  let M = y(le),
    ue = h(Ee),
    N = h(Oe),
    P = ue?.hostId === r ? ue : null,
    F;
  t[24] === a ? (F = t[25]) : ((F = a.get(se)), (t[24] = a), (t[25] = F));
  let I = F,
    pe = _ || b.isPending || A.isPending || re.isPending || j.isPending || M.isPending,
    L;
  t[26] === P ? (L = t[27]) : ((L = De(P)), (t[26] = P), (t[27] = L));
  let R = L,
    he =
  ...
  t[57] === G
    ? (Me = t[58])
    : ((Me = (0, $.jsx)(`span`, { className: `text-sm text-token-text-secondary`, children: G })),
      (t[57] = G),
      (t[58] = Me));
  let q;
  t[59] !== H || t[60] !== Me
    ? ((q = (0, $.jsx)(U, { label: V, description: H, control: Me })),
      (t[59] = H),
      (t[60] = Me),
      (t[61] = q))
    : (q = t[61]);
  ...
  t[62] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ne = (0, $.jsx)(f, {
      ...
      (t[63] = Pe))
    : ((Ne = t[62]), (Pe = t[63]));
  let Fe = _ || b.isPending || S == null,
    J;
  t[64] !== N || t[65] !== re || t[66] !== b
    ? ((J = (e) => {
        b.mutate(
  ...
  t[68] === o
    ...
    : ((Ie = o.formatMessage({
      ...
      (t[69] = Ie));
  let Y;
  t[70] !== w || t[71] !== Fe || t[72] !== J || t[73] !== Ie
    ? ((Y = (0, $.jsx)(U, {
        label: Ne,
        description: Pe,
        control: (0, $.jsx)(_e, { checked: w, disabled: Fe, onChange: J, ariaLabel: Ie }),
      })),
      (t[70] = w),
      (t[71] = Fe),
      (t[72] = J),
  ...
  let Ke;
  return (
    t[92] !== q || t[93] !== Y || t[94] !== Re || t[95] !== Ge
      ? ((Ke = (0, $.jsxs)(W, {
          className: `gap-2`,
          children: [
            xe,
            (0, $.jsx)(W.Content, { children: (0, $.jsxs)(ke, { children: [q, Y, Re, Ge] }) }),
          ],
        })),
        (t[92] = q),
        (t[93] = Y),
...
function Ze({ hostId: e }) {
  let t = ee(),
    ...
    z = [...ue, pe, ...(me == null ? [] : [me])],
    ge = ue.length > 0,
    ve = y == null ? (z[0]?.key ?? null) : `project:${y}`,
    B = z.find((e) => e.key === o) ?? z.find((e) => e.key === ve) ?? z[0] ?? null,
    { data: xe } = m(Me, {
      cwd: B?.workspaceRoot == null ? (y == null ? null : i(y)) : i(B.workspaceRoot),
      hostId: e,
    }),
    V = rt(B?.layer?.config ?? null),
    H = ct(ae?.approval_policy ?? null) ?? `on-request`,
    Se = ae?.sandbox_mode == null ? `read-only` : ae.sandbox_mode,
    Ce = V.sandboxMode == null && Se === `workspace-write`,
    we = V.sandboxMode === `workspace-write` || Ce,
    Te = V.approvalPolicy ?? H,
    Ee = V.sandboxMode ?? Se,
    De = V.networkAccess ?? ae?.sandbox_workspace_write?.network_access ?? !1,
    Oe = se == null ? null : A(se, `approval_policy`, [`approvalPolicy`]),
    G = se == null ? null : A(se, `sandbox_mode`),
    Ae = se == null ? null : A(se, `sandbox_workspace_write`, [`network_access`]),
    je = B?.kind === `project` ? (B.layer?.disabledReason ?? null) : null,
    K = it(B, t),
    Pe = We.filter((e) =>
  ...
  async function J(t, n, i) {
    if (!(B == null || B.filePath == null) && c == null) {
      ...
      try {
        (B.kind === `project`
          ? await Ne({ filePath: B.filePath, keyPath: n, value: i })
          : await a(`write-config-value`, {
              hostId: e,
              keyPath: n,
              value: i,
          ...
          await Promise.all([
            ...
            r.invalidateQueries({ queryKey: [...re, e] }),
        ...
        actions: (0, $.jsxs)(ce, {
          ...
          onClick: () => {
            B?.filePath != null &&
              P({
                path: B.filePath,
                cwd: B.workspaceRoot == null ? null : i(B.workspaceRoot),
                hostId: e,
                ...
                children: Pe.map((e) =>
                  (0, $.jsx)(
                    L.Item,
                    {
                      ...
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        J(`approval`, `approval_policy`, e.value);
                      },
                      SubText: (0, $.jsx)(`div`, {
                        className: `pt-1 text-sm text-token-text-secondary`,
                        children: e.description,
                      }),
                      children: (0, $.jsx)(`span`, { className: `text-sm`, children: e.label }),
                    },
                    e.value,
                  ),
                ),
                ...
                children: Fe.map((e) =>
                  (0, $.jsx)(
                    L.Item,
                    {
                      ...
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        J(`sandbox`, `sandbox_mode`, e.value);
                      },
                      SubText: (0, $.jsx)(`div`, {
                        className: `pt-1 text-sm text-token-text-secondary`,
                        children: e.description,
            ...
            we
              ? (0, $.jsx)(U, {
                  ...
                  control: (0, $.jsx)(_e, {
                    ...
                    disabled: Q || Z != null,
                    onChange: (e) => {
                      J(`network`, `sandbox_workspace_write.network_access`, e);
                    },
...
function et(e, t) {
  ...
  for (let r of e) {
    ...
    let e = tt(r.name.dotCodexFolder);
    n.push({
      ...
      label: t.formatMessage(
        ...
        { repoName: nt(e ?? r.name.dotCodexFolder) },
      ),
...
function ot(e) {
  return We.find((t) => t.value === e) ?? null;
}
function st(e) {
  return Ge.find((t) => t.value === e) ?? null;
}
function ct(e) {
  return e === `untrusted` || e === `on-failure` || e === `on-request` || e === `never` ? e : null;
}
export { Ke as AgentSettings };
//# sourceMappingURL=agent-settings-N.js.map
