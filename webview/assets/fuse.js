...
var f = `Incorrect 'index' type`,
  p = (e) => `Invalid value for key ${e}`,
  m = (e) => `Pattern length exceeds max of ${e}.`,
  h = (e) => `Missing ${e} property in key`,
  g = (e) => `Property 'weight' in key '${e}' must be a positive integer`,
...
var C = { includeMatches: !1, findAllMatches: !1, minMatchCharLength: 1 },
  w = {
    isCaseSensitive: !1,
    ignoreDiacritics: !1,
    includeScore: !1,
  ...
  ee = { location: 0, threshold: 0.6, distance: 100 },
  te = {
    useExtendedSearch: !1,
    getFn: S,
    ignoreLocation: !1,
      ...
      if (l(o)) {
        if (e(o)) {
          ...
          for (; n.length; ) {
            ...
            if (l(a))
              if (i(a) && !u(a)) {
                let e = { v: a, i: r, n: this.norm.get(a) };
                t.push(e);
              } else
                e(a) &&
                  a.forEach((e, t) => {
...
function M(
  ...
  for (; (v = e.indexOf(t, h)) > -1; ) {
    let e = k(t, { currentLocation: v, expectedLocation: f, distance: i, ignoreLocation: l });
  ...
  let C = { isMatch: h >= 0, score: Math.max(0.001, b) };
  if (g) {
    let e = A(_, s);
  ...
  P = class {
    constructor(
      e,
      {
        ...
        findAllMatches: a = T.findAllMatches,
        minMatchCharLength: o = T.minMatchCharLength,
        isCaseSensitive: s = T.isCaseSensitive,
        ignoreDiacritics: c = T.ignoreDiacritics,
        ignoreLocation: l = T.ignoreLocation,
      } = {},
    ) {
      if (
...
var ue = new Set([z.type, B.type]),
  de = class {
    constructor(
      e,
      {
        isCaseSensitive: t = T.isCaseSensitive,
        ignoreDiacritics: n = T.ignoreDiacritics,
      ...
      ((this.query = null),
        ...
        (e = n ? N(e) : e),
        (this.pattern = e),
        (this.query = le(this.pattern, this.options)));
    }
...
function Z(t, n, { auto: r = !0 } = {}) {
  let a = (t) => {
    ...
    if (me(t)) {
      let e = s ? t[J.PATH] : o[0],
        a = s ? t[J.PATTERN] : t[e];
      if (!i(a)) throw Error(p(e));
      let c = { keyId: x(e), pattern: a };
...
var $ = class {
  ...
  search(e, { limit: t = -1 } = {}) {
    ...
    return (
      Q(l, { ignoreFieldNorm: c }),
      o && l.sort(s),
      a(t) && t > -1 && (l = l.slice(0, t)),
      _e(l, this._docs, { includeMatches: n, includeScore: r })
    );
  }
  _searchStringList(e) {
  ...
  _findMatches({ key: t, value: n, searcher: r }) {
    ...
    if (e(n))
      n.forEach(({ v: e, i: n, n: a }) => {
        ...
        o && i.push({ score: s, key: t, value: e, idx: n, norm: a, indices: c });
      });
    else {
      let { v: e, n: a } = n,
        { isMatch: o, score: s, indices: c } = r.searchIn(e);
      o && i.push({ score: s, key: t, value: e, norm: a, indices: c });
    }
    return i;
  }
};
