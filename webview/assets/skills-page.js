...
import { i as s, r as c } from "./react.js";
import { us as l } from "./app-server-manager-signals.js";
import { c as u, o as d } from "./lib-1.js";
import { o as f, vr as p } from "./persisted-signal.js";
import { t as m } from "./button.js";
import { n as h } from "./selectable-remote-connections-signal-DJZ-ZbLr.js";
import { p as g } from "./codex-api.js";
import { D as ee } from "./mention-item.js";
...
import { a as he, i as ge, n as _e, o as ve, r as ye, s as C, t as w } from "./plugins-page.js";
var T = r(),
  E = e(t(), 1);
function be(e) {
  let t = (0, T.c)(6),
...
function k() {
  ...
  let ke = be(A),
    ...
    { errorMessage: ze, isLoading: Be, refresh: Ve, repoRoot: He, skills: Ue } = fe(Re, w),
    We;
  ...
  e[53] !== N || e[54] !== t || e[55] !== Me || e[56] !== L || e[57] !== _
    ? ((K = () => {
        if (!L) return;
        f(t, p, {});
        let e = he({ creatorPath: L, isFirstOpen: !N, kind: `skill` });
