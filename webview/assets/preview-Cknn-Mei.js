const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./3Dmol.js", "./rolldown-runtime.js"]),
) => i.map((i) => d[i]);
...
function G(e) {
  let t = (0, Z.c)(17),
    { className: n, fallback: i, hostId: a, path: o, showFileName: s } = e,
    c = s === void 0 ? !1 : s,
    l = o != null && o.length > 0,
    u = o ?? ``,
    d;
  t[0] !== a || t[1] !== u
    ? ((d = { path: u, hostId: a }), (t[0] = a), (t[1] = u), (t[2] = d))
    : (d = t[2]);
  let f;
  ...
  t[5] !== d || t[6] !== f
    ...
    : (p = t[7]);
  let { data: m, isError: g, isLoading: _ } = r(`read-file`, p);
  if (!l) return i;
  if (_) {
    let e;
    t[8] === n
      ? (e = t[9])
      : ((e = h(`flex h-full items-center justify-center bg-token-main-surface-primary`, n)),
        (t[8] = n),
        (t[9] = e));
    let r;
    t[10] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, $.jsx)(E, { className: `text-sm` })), (t[10] = r))
      : (r = t[10]);
    let i;
    return (
      t[11] === e
        ? (i = t[12])
        : ((i = (0, $.jsx)(`div`, { className: e, children: r })), (t[11] = e), (t[12] = i)),
      i
    );
  }
  if (g || m == null) return i;
  let v = c ? (o ?? void 0) : void 0,
    y;
  return (
    t[13] !== n || t[14] !== m.contents || t[15] !== v
      ? ((y = (0, $.jsx)(K, { className: n, contents: m.contents, filePath: v })),
        (t[13] = n),
        (t[14] = m.contents),
        (t[15] = v),
        (t[16] = y))
...
function K({ className: e, contents: n, filePath: r }) {
  let i = ee(),
    a = (0, Q.useMemo)(() => j(n), [n]),
    [s, c] = (0, Q.useState)(0),
    [l, d] = (0, Q.useState)(null),
    [f, m] = (0, Q.useState)(`idle`),
    [h, _] = (0, Q.useState)(0),
    [b, S] = (0, Q.useState)(null),
    [C, D] = (0, Q.useState)(null),
    ...
    z = R.find((e) => e.chainId === b) ?? R[0] ?? null,
    B = C?.modelIndex === s ? C : null,
    V = (0, Q.useMemo)(() => ie(z, B), [z, B]),
    H = (0, Q.useMemo)(() => ae(V), [V]),
    U = (0, Q.useMemo)(() => ie(z, A?.modelIndex === s ? A : null), [s, z, A]),
  ...
  function Y(e) {
    z != null && (k(e), G({ chainId: z.chainId, endIndex: e, modelIndex: s, startIndex: e }));
  }
  function X(e) {
    O == null ||
      z == null ||
  ...
  function ue() {
    let e = P.current;
    (k(null), e != null && e.modelIndex === s && M(e));
  }
  function Z(e) {
    if (z == null) return;
    let t = { chainId: z.chainId, endIndex: e, modelIndex: s, startIndex: e };
    (k(null), G(t), M(t));
  }
  function de() {
    (G(null), k(null), M(null), _((e) => e + 1));
  }
  return (
    (0, Q.useEffect)(() => {
      ...
      return (
        ...
        (async () => {
          try {
            let n = se(
              await o(
                () => import(`./3Dmol.js`).then((e) => t(e.default, 1)),
                __vite__mapDeps([0, 1]),
                import.meta.url,
              ),
            );
            if (!e) return;
            let r = n(l, { backgroundColor: `white`, disableFog: !0 });
            ((N.current = r),
              r.addModel(L, `pdb`),
              re(r, null),
              r.zoomTo(),
            ...
            e && (J(l, N.current), (N.current = null), m(`error`));
          }
        })(),
        () => {
          ((e = !1), J(l, N.current), (N.current = null));
        }
      );
    }, [L, h, l]),
    (0, Q.useEffect)(() => {
      let e = N.current;
      e == null || f !== `idle` || (re(e, H), e.render());
    }, [H, f]),
    (0, Q.useEffect)(() => {
      let e = N.current;
      e == null || f !== `idle` || A == null || W == null || (e.zoomTo(W, 350, !0), e.render());
    }, [W, A, f]),
    F.length === 0 || I == null
      ? (0, $.jsx)(te, {
          className: e,
                  ...
                  ? (0, $.jsx)(p, {
                      ...
                      triggerButton: (0, $.jsxs)(u, {
                        ...
                        children: [
                          ...
                          (0, $.jsx)(g, { className: `icon-2xs opacity-65` }),
                        ],
                      }),
                      children: F.map((e, t) =>
                        (0, $.jsx)(
              ...
              children: [
                ...
                f === `loading`
                  ? (0, $.jsx)(`div`, {
                      ...
                      children: (0, $.jsx)(E, { className: `text-sm` }),
                    })
                  : null,
                f === `error`
                  ? (0, $.jsx)(`div`, {
...
function te(e) {
  ...
  t[0] === r
    ? (a = t[1])
    : ((a = h(`flex h-full min-h-0 flex-col bg-token-main-surface-primary`, r)),
      (t[0] = r),
      (t[1] = a));
  let o;
  t[2] === i
...
function ne(e) {
  ...
  let T = w,
    E;
  t[3] !== n || t[4] !== f || t[5] !== r || t[6] !== c.chainId
    ? ((E =
        n.length > 1
          ? (0, $.jsx)(p, {
              align: `start`,
              ...
              children: n.map((e) =>
                (0, $.jsx)(
                  y.Item,
                  {
                    RightIcon: e.chainId === c.chainId ? v : void 0,
                    ...
                    children: (0, $.jsx)(x, {
                      ...
                      values: { chainId: X(e.chainId), count: e.residues.length },
                    }),
                  },
                  e.chainId,
                ),
  ...
  t[20] === a
    ? (M = t[21])
    : ((M = (e) => {
        if (_.current !== e.pointerId) return;
      ...
      (t[21] = M));
  let N;
  if (t[22] !== f || t[23] !== o || t[24] !== c.residues || t[25] !== b) {
    let e;
    (t[27] !== f || t[28] !== o || t[29] !== b
      ? ((e = (e, t) => {
          ...
          return (0, $.jsx)(
            `button`,
            {
              ...
              "aria-label": f.formatMessage(
                ...
                { chainId: X(e.chainId), residueName: e.residueName, residueNumber: Y(e) },
              ),
              "aria-pressed": n,
              className: h(
...
function q(e) {
  let t = (0, Z.c)(7),
    ...
    i;
  t[0] === r ? (i = t[1]) : ((i = h(`h-2.5 w-2.5 rounded-sm`, r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === i ? (a = t[3]) : ((a = (0, $.jsx)(`span`, { className: i })), (t[2] = i), (t[3] = a));
  let o;
  return (
    t[4] !== n || t[5] !== a
      ? ((o = (0, $.jsxs)(`span`, {
...
function re(e, t) {
  ...
  let n = { not: t };
  (e.setStyle(n, pe), e.addStyle({ and: [n, { hetflag: !1 }] }, me), e.setStyle(t, he));
}
function ie(e, t) {
...
e(() => {
  ((Z = n()),
    ...
    ($ = s()),
    c(),
    (de = { cartoon: { colorscheme: { gradient: `roygb`, max: 100, min: 50, prop: `b` } } }),
    (fe = { stick: { radius: 0.12 } }),
    (pe = {
      cartoon: { colorscheme: { gradient: `roygb`, max: 100, min: 50, prop: `b` }, opacity: 0.34 },
    }),
    (me = { stick: { hidden: !0 } }),
    (he = { cartoon: { color: `#f97316` }, stick: { color: `#f97316`, radius: 0.12 } }),
    (ge = []));
})();
export { G as PdbPreviewFromFile };
//# sourceMappingURL=preview-Cknn-Mei.js.map
