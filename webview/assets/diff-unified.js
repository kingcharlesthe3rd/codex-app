...
import { k as g, m as _ } from "./vscode-api.js";
import { c as v, o as y } from "./lib.js";
...
import { t as te } from "./button-DO-oxX3-.js";
import { t as C } from "./chevron-right.js";
import { t as w } from "./use-stable-callback.js";
import { t as ne } from "./tooltip.js";
import { F as re, M as ie, S as T, k as ae, x as oe } from "./rpc-1.js";
import { t as se } from "./link-external.js";
import { c as ce, n as le } from "./shiki-highlight-provider-gate.js";
import { t as ue } from "./use-platform.js";
import { s as de } from "./diff-view-mode.js";
import { t as fe } from "./iconResolver.js";
import { n as E, r as pe } from "./parse-diff.js";
import { t as D } from "./file-diff.js";
import { t as me } from "./hash-code.js";
import { t as O } from "./error-boundary.js";
import { t as he } from "./copy-to-clipboard.js";
import { t as ge } from "./minus.js";
...
import { t as P } from "./undo-C_qr-caq.js";
import { r as Te } from "./diff-stats.js";
var F = { loadingResultsShimmer: `_loadingResultsShimmer_1cbkl_1` },
  I = r(),
  L = n(),
  Ee = { sm: `h-3`, md: `h-3.5`, lg: `h-4` },
  De = 120,
  R = 2147483647;
function z(e) {
  let t = (0, I.c)(10),
  ...
  t[4] === n
    ? (o = t[5])
    : ((o = x(F.loadingResultsShimmer, `rounded-md`, n)), (t[4] = n), (t[5] = o));
  let s;
  return (
    t[6] !== a || t[7] !== r || t[8] !== o
      ? ((s = (0, L.jsx)(`div`, { ...r, "aria-hidden": a, className: o })),
        (t[6] = a),
        (t[7] = r),
        (t[8] = o),
        (t[9] = s))
...
function B(e) {
  ...
  t[0] !== l || t[1] !== u || t[2] !== d || t[3] !== f
    ? ((m = Oe({ count: l, maxWidth: u, minWidth: d, seed: f })),
      (t[0] = l),
      (t[1] = u),
      (t[2] = d),
      (t[3] = f),
    ...
    (t[11] !== r || t[12] !== p
      ? ((e = (e, t) =>
          (0, L.jsx)(
            ...
            {
              className: x(Ee[p], r),
              style: { width: `${ke(e)}%`, "--loading-results-shimmer-delay": `${-t * De}ms` },
            },
            t,
          )),
        (t[11] = r),
  ...
  return (
    t[14] !== g || t[15] !== _
      ? ((v = (0, L.jsx)(`div`, { className: g, children: _ })),
        (t[14] = g),
        (t[15] = _),
        (t[16] = v))
      : (v = t[16]),
...
function Oe({ count: e, maxWidth: t, minWidth: n, seed: r }) {
  let i = ke(Math.min(n, t)),
    a = ke(Math.max(n, t)),
    o = a - i,
    s = Ae(`${r}:${e}:${i}:${a}`);
  return Array.from({ length: Math.max(0, e) }, () => ((s = je(s)), i + (s / R) * o));
}
function ke(e) {
...
function Ae(e) {
  let t = 0;
  for (let n = 0; n < e.length; n += 1) t = (t * 31 + e.charCodeAt(n)) % R;
  return t === 0 ? 1 : t;
}
function je(e) {
  return (e * 48271) % R;
...
function Me(e) {
  let t = (0, I.c)(22),
    ...
    f;
  t[0] === n ? (f = t[1]) : ((f = (0, L.jsx)(Ne, { ...n })), (t[0] = n), (t[1] = f));
  let p = f,
    m = s ? `binary` : u ? `rename-without-changes` : `empty`,
    g;
  t[2] === m ? (g = t[3]) : ((g = (0, L.jsx)(Fe, { kind: m })), (t[2] = m), (t[3] = g));
  let _ = g,
    v,
    y;
  t[4] !== r || t[5] !== c || t[6] !== d
    ? ((v = h(r)),
      (y = l({ filePath: r, imagePreviewMode: v, isDeletion: c, richPreviewEnabled: d })),
      (t[4] = r),
      (t[5] = c),
      (t[6] = d),
      (t[7] = v),
  ...
  if (b === `markdown`) {
    let e;
    return (
      t[9] !== p || t[10] !== n.diffViewClassName || t[11] !== i
        ? ((e = (0, L.jsx)(j, { className: n.diffViewClassName, path: i, fallback: p })),
          (t[9] = p),
...
function Ne(e) {
  ...
  return (
    t[22] !== l || t[23] !== _
      ? ((v = (0, L.jsx)(O, { name: `FileDiff`, fallback: u, children: _ }, l)),
        (t[22] = l),
        (t[23] = _),
        (t[24] = v))
      : (v = t[24]),
...
var Le = b(`load-full-files`, !0),
  Re = b(`skip-revert-confirmation`, !1),
  V = 250;
function ze(e) {
  let t = e.closest(T.timelineScroll);
  if (t == null) return;
...
function Be(e) {
  let t = (0, I.c)(31),
    { action: n, className: r, color: i, size: a, scope: o, onClick: s } = e,
    c = i === void 0 ? `ghost` : i,
    l = a === void 0 ? `composerSm` : a,
    u = v(),
    d;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((d = (0, L.jsx)(P, { className: `icon-2xs` })), (t[0] = d))
    : (d = t[0]);
  let f = d;
  if (n === `stage`) {
    let e;
    (t[1] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, L.jsx)(k, { className: `icon-2xs` })), (t[1] = e))
      : (e = t[1]),
      (f = e));
  } else if (n === `unstage`) {
    let e;
    (t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, L.jsx)(ge, { className: `icon-2xs` })), (t[2] = e))
      : (e = t[2]),
      (f = e));
  }
  let p;
  ...
  let m;
  t[21] !== r || t[22] !== c || t[23] !== f || t[24] !== s || t[25] !== l || t[26] !== p
    ? ((m = (0, L.jsx)(te, {
        className: r,
        color: c,
        size: l,
  ...
  return (
    t[28] !== m || t[29] !== p
      ? ((h = (0, L.jsx)(ne, { tooltipContent: p, children: m })),
        (t[28] = m),
        (t[29] = p),
        (t[30] = h))
      : (h = t[30]),
...
function We(e, t, n, r) {
  ...
  for (let d of e.hunks) {
    ...
    if (m < 0 || h < 0 || m !== h || f + d.additionCount > a || p + d.deletionCount > i)
      return null;
    if (!H(t, n, u, l, m, r)) return (Ge(e, `collapsed_context_mismatch`), null);
    let g = f,
      _ = p,
      v = [];
  ...
  if (o.length > 0) {
    let o = a - l,
      d = i - u;
    if (o < 0 || d < 0) return (Ge(e, `negative_trailing_context`), null);
    if (o !== d) return (Ge(e, `trailing_context_line_count_mismatch`), null);
    if (!H(t, n, u, l, o, r)) return (Ge(e, `trailing_context_mismatch`), null);
    ((s += o), (c += o));
  }
...
function H(e, t, n, r, i, a) {
  for (let o = 0; o < i; o += 1) {
    let i = e[n + o],
      s = t[r + o];
    if (i == null || s == null || !Ke(i, s, a)) return !1;
  }
  return !0;
}
function Ke(e, t, n) {
  return n ? e.replace(Ve, ``) === t.replace(Ve, ``) : e === t;
}
var qe = c(s, (e, { signal: t }) => ({
...
function Ye({
  ...
  return `${e.metadata.cacheKey ?? `${e.metadata.name}:${e.metadata.prevObjectId ?? `none`}:${e.metadata.newObjectId ?? `none`}:${e.additions}:${e.deletions}`}:${a ?? ``}:${d(t)}:${i ? `next-disk-fallback` : `next-object-only`}:${n ? `ignore-whitespace` : `exact-whitespace`}:${r ? `full` : `partial`}`;
}
async function Xe({
  diff: e,
  hostConfig: t,
  ...
  let p = Ue(e.metadata, d.lines, f.lines, { ignoreWhitespace: n });
...
function st(e) {
  let t = (0, I.c)(173),
    {
      ...
      onCommentsChange: S,
      commentAuthorLabel: te,
      commentAuthorAvatarUrl: C,
      onReadonlyCommentReply: ne,
      defaultOpen: T,
      diffViewWrap: oe,
      showHunkActions: se,
      onHunkAction: ce,
      onPostRender: de,
      hunkActionsVariant: fe,
      cwd: E,
      richPreviewEnabled: pe,
      roundedCorners: D,
      background: me,
      diffSurface: O,
      ...
      hostConfig: N,
      loadFullContent: P,
      fullContentNextFallbackToDisk: Te,
      fullContentIgnoreWhitespace: F,
      metrics: Ee,
      displayPathOverride: De,
      isLoading: R,
    ...
    Qe;
  t[0] !== Fe || t[1] !== c
    ? ((Qe = () => Fe && c.metadata.type !== `deleted`), (t[0] = Fe), (t[1] = c), (t[2] = Qe))
    : (Qe = t[2]);
  let [G, et] = (0, W.useState)(Qe),
    [tt, nt] = (0, W.useState)(Ie),
    it = (0, W.useRef)(null),
    at = (0, W.useRef)(null),
    ot = (0, W.useRef)(lt),
    st = g(),
    ...
    ft = $e(et, Se),
    pt = v(),
    ht = c.metadata.type === `deleted`,
    gt = c.metadata.name,
    _t;
  t[3] !== E || t[4] !== gt
    ? ((_t = gt && gt !== `/dev/null` ? f(gt, E) : gt), (t[3] = E), (t[4] = gt), (t[5] = _t))
    : (_t = t[5]);
  let vt = _t,
    K = De ?? vt ?? gt ?? ``,
    yt;
  t[6] === K ? (yt = t[7]) : ((yt = K && !ie(K) ? K : null), (t[6] = K), (t[7] = yt));
  let bt = yt,
    q,
    xt;
  t[8] !== E || t[9] !== c.metadata.prevName || t[10] !== c.metadata.type
    ? ((q =
        ...
        c.metadata.prevName != null
          ? f(c.metadata.prevName, E)
          : null),
      (xt = q == null ? null : (re(q).split(`/`).pop() ?? q)),
      (t[8] = E),
  ...
  bb0: {
    ...
    let e = dt === `windows`,
      n;
    (t[16] !== E || t[17] !== e || t[18] !== vt
      ? ((n = ae(E, vt, e)), (t[16] = E), (t[17] = e), (t[18] = vt), (t[19] = n))
      : (n = t[19]),
      (Ct = n));
  }
  let J = Ct,
    wt;
  t[20] === K ? (wt = t[21]) : ((wt = re(K).split(`/`).pop() ?? K), (t[20] = K), (t[21] = wt));
  let Tt = wt,
    Et = q == null ? K : `${q}${rt}${K}`,
    Y = St == null ? Tt : `${St}${rt}${Tt}`,
    X;
  t[22] !== Tt || t[23] !== K || t[24] !== St || t[25] !== q
    ? ((X =
        q == null || St == null
          ? [{ fileName: Tt, path: K }]
          : [
  ...
  let At = E ?? null,
    jt;
  t[30] !== Z || t[31] !== J || t[32] !== At
    ? ((jt = { cwd: At, hostId: Z, openPath: J }),
      (t[30] = Z),
      (t[31] = J),
      (t[32] = At),
      (t[33] = jt))
    : (jt = t[33]);
  let Mt = o(i(ye, jt).preferredTargetOverride$),
    Nt;
  t[34] !== E || t[35] !== Z || t[36] !== J || t[37] !== st
    ? ((Nt = async () => {
        try {
          return await _e({ cwd: E ?? null, hostId: Z, openPath: J, queryClient: st });
        } catch {
          return null;
        }
      }),
  ...
  t[42] === ve
    ...
    : ((It = () => {
      ...
      (t[43] = It));
  let Lt = It,
    Rt = ht ? (c.firstDeletionLine ?? 1) : (c.firstAdditionLine ?? 1),
    zt;
  t[44] !== E || t[45] !== Z || t[46] !== J || t[47] !== U
    ? ((zt = (e) => {
        let { lineNumber: t, event: n } = e;
        J && (n.metaKey || n.ctrlKey) && Ce(U, { path: J, line: t, cwd: E ?? null, hostId: Z });
      }),
      (t[44] = E),
      (t[45] = Z),
      (t[46] = J),
  ...
  let Bt = w(zt),
    Vt;
  t[49] !== E || t[50] !== Rt || t[51] !== Z || t[52] !== J || t[53] !== U
    ? ((Vt = (e, t, n) => {
        if (!J) return;
        let r = it.current ?? Rt;
        ((it.current = null),
  ...
  t[61] !== U
    ? ((Ut = () => {
        J &&
          (async () => {
            let { primaryTarget: e } = xe({ data: await Q(), preferredTargetOverride: Mt });
            if (e != null) {
              A(U, {
                cwd: E ?? null,
                hostId: Z,
            ...
            Ce(U, { cwd: E ?? null, hostId: Z, line: Rt, path: J });
          })();
      }),
      (t[55] = E),
      (t[56] = Rt),
  ...
  let Jt = qt,
    Yt;
  t[67] !== ft || t[68] !== G || t[69] !== Xe
    ? ((Yt = (e) => {
        let t = !G;
        if ((Xe && e != null && ze(e.currentTarget), e?.altKey)) {
          ft(t);
          return;
        }
        et(t);
  ...
  let Xt = w(Yt),
    Zt;
  t[71] !== E || t[72] !== Rt || t[73] !== Z || t[74] !== J || t[75] !== U || t[76] !== Xt
    ? ((Zt = (e) => {
        (e.stopPropagation(), Xt(e));
      }),
      (t[71] = E),
      (t[72] = Rt),
      (t[73] = Z),
  ...
  t[80] === bt
    ...
    : ((rn =
      ...
      (t[80] = bt),
      (t[81] = rn));
  let an = Be && `rounded-lg`,
    on = Ze && G && `pb-0.5`,
    sn;
  t[82] !== n || t[83] !== an || t[84] !== on
    ? ((sn = x(`group/file-diff flex flex-col overflow-clip`, an, on, n)),
      (t[82] = n),
      (t[83] = an),
      (t[84] = on),
      (t[85] = sn))
  ...
  let cn;
  t[86] !== Ve || t[87] !== He
    ? ((cn = le(Ve, He)), (t[86] = Ve), (t[87] = He), (t[88] = cn))
    : (cn = t[88]);
  let ln = `var(--codex-diffs-surface-override, ${cn})`,
    un = Ve ? `var(--codex-diffs-surface)` : void 0,
    dn;
  t[89] !== ln || t[90] !== un
    ? ((dn = { "--codex-diffs-surface": ln, backgroundColor: un }),
      (t[89] = ln),
      (t[90] = un),
      (t[91] = dn))
    : (dn = t[91]);
  let fn;
  t[92] !== c.metadata.name || t[93] !== ce
    ? ((fn = (e) => {
        ce?.({ path: c.metadata.name, action: e, scope: `file` });
      }),
      (t[92] = c.metadata.name),
      (t[93] = ce),
      (t[94] = fn))
    : (fn = t[94]);
  let pn = $,
  ...
  t[115] !== vt
    ? ((hn = (0, L.jsx)(ut, {
        ...
        showDiffStats: Ye,
        toggleAriaLabel: mn,
        workspaceRelativePath: vt,
        showHunkActions: Le,
        hunkActionsVariant: Re,
        headerVariant: Je,
        isLoading: Ke,
      })),
      (t[97] = c),
  ...
  t[154] !== tt
    ? ((gn = G
        ? (0, L.jsx)(mt, {
            ...
            handleLineClick: Kt,
            handleLineNumberClick: Jt,
            hostConfig: N,
            hoveredLineRef: at,
            hunkActionsVariant: Re,
            hunkSeparators: d,
            loadFullContent: We,
            fullContentNextFallbackToDisk: Ge,
            fullContentIgnoreWhitespace: H,
            readonlyComments: y,
            submittingCommentKeys: b,
            onCommentsChange: S,
            commentAuthorLabel: te,
            ...
            openFilePath: J ?? null,
            open: G,
            requestChangesRef: ot,
            richPreviewEnabled: V,
            showHunkActions: Le,
            showLoadError: qe,
            useReviewLineInfoSeparators: Ze,
            viewType: l,
            wrapLines: tt,
            metrics: Ee,
          })
  ...
  t[156] === gn
    ? (_n = t[157])
    : ((_n = (0, L.jsx)(ee, { children: gn })), (t[156] = gn), (t[157] = _n));
  let vn;
  t[158] !== sn || t[159] !== dn || t[160] !== hn || t[161] !== _n
    ? ((vn = (0, L.jsxs)(`div`, {
        onContextMenu: nn,
        className: sn,
        style: dn,
  ...
  return (
    ...
    t[171] !== vn
      ? ((yn = (0, L.jsx)(M, {
          canOpenFile: $,
          loadOpenTargets: Q,
          preferredTargetOverride: Mt,
          onRequestChanges: en,
          onCopyPath: Ft,
          onCopyRelativePath: rn,
          onToggleWrap: Lt,
          handleOpenInTarget: Ht,
          disableNative: Ue,
          children: vn,
        })),
        (t[163] = $),
...
function ut(e) {
  let t = (0, I.c)(93),
    ...
    S = s === `full-review`,
    ee;
  t[0] === m ? (ee = t[1]) : ((ee = oe.reviewFileToggle(m)), (t[0] = m), (t[1] = ee));
  let w = S ? `ghostMuted` : `ghost`,
    re;
  t[2] === p
    ? (re = t[3])
    : ((re = (e) => {
      ...
      (t[2] = p),
      (t[3] = re));
  let ie = m ? `rotate-90` : `rotate-0`,
    T;
  t[4] === ie
    ? (T = t[5])
    : ((T = x(`icon-2xs transition-transform duration-200`, ie)), (t[4] = ie), (t[5] = T));
  let ae;
  t[6] === T ? (ae = t[7]) : ((ae = (0, L.jsx)(C, { className: T })), (t[6] = T), (t[7] = ae));
  let se;
  t[8] !== ee || t[9] !== w || t[10] !== re || t[11] !== ae || t[12] !== y
    ? ((se = (0, L.jsx)(te, {
        ...ee,
    ...
    : (se = t[13]);
  let ce = se,
    le = v && `z-10 sticky top-0`,
    ue = S && v && `backdrop-blur-sm`,
    de;
  t[14] !== le || t[15] !== ue
    ? ((de = x(`cursor-interaction select-none focus-visible:outline-none`, le, ue)),
      (t[14] = le),
      (t[15] = ue),
      (t[16] = de))
    : (de = t[16]);
  let fe =
    ...
    E;
  t[17] === fe ? (E = t[18]) : ((E = { backgroundColor: fe }), (t[17] = fe), (t[18] = E));
  let pe;
  t[19] === S
    ? (pe = t[20])
    : ((pe = S ? void 0 : { backgroundColor: `var(--codex-diffs-header-surface)` }),
      (t[19] = S),
      (t[20] = pe));
  let D;
  t[21] !== l || t[22] !== v || t[23] !== S
    ? ((D = x(
        `group/diff-header text-size-chat @container/diff-header relative flex items-center gap-2`,
        S
          ? x(
              v
                ? `bg-[color-mix(in_srgb,var(--color-token-list-active-selection-background)_88%,transparent)]`
                : `bg-[var(--color-token-list-active-selection-background)]`,
              `pt-2 pb-2 ps-3 pe-2 hover:bg-token-list-hover-background`,
              l ? `mb-2` : `mb-0.5`,
            )
      ...
      (t[24] = D))
    : (D = t[24]);
  let me = S ? `gap-0.5` : `gap-2`,
    O;
  t[25] === me
    ? (O = t[26])
    : ((O = x(`text-size-chat flex min-w-0 flex-1 items-center text-token-text-primary`, me)),
      (t[25] = me),
      (t[26] = O));
  let he = S && `gap-2 pl-1`,
    ge;
  t[27] === he
    ? (ge = t[28])
    : ((ge = x(`flex min-w-0 items-center`, he)), (t[27] = he), (t[28] = ge));
  let k;
  t[29] !== i || t[30] !== S
    ? ((k = S ? (0, L.jsx)(yt, { path: i }) : null), (t[29] = i), (t[30] = S), (t[31] = k))
    : (k = t[31]);
  let _e;
  t[32] === i
    ? (_e = t[33])
    : ((_e = (0, L.jsx)(`span`, { className: `font-mono`, children: i })),
      (t[32] = i),
      (t[33] = _e));
  let A = !S && `pl-[6px]`,
    j;
  ...
  t[38] !== i || t[39] !== a || t[40] !== S
    ...
    : (be = t[41]);
  let M;
  t[42] !== d || t[43] !== j || t[44] !== ve || t[45] !== ye || t[46] !== be
    ? ((M = (0, L.jsxs)(`button`, {
        type: `button`,
        className: j,
        disabled: ve,
  ...
  let xe;
  t[48] !== _e || t[49] !== M
    ? ((xe = (0, L.jsx)(ne, { tooltipContent: _e, delayDuration: 200, children: M })),
      (t[48] = _e),
      (t[49] = M),
      (t[50] = xe))
    : (xe = t[50]);
  let Se;
  t[51] !== ge || t[52] !== k || t[53] !== xe
    ? ((Se = (0, L.jsxs)(`div`, { className: ge, children: [k, xe] })),
      (t[51] = ge),
      (t[52] = k),
      (t[53] = xe),
      (t[54] = Se))
  ...
  t[55] !== ce || t[56] !== S
    ...
    : (Ce = t[57]);
  let we;
  t[58] !== O || t[59] !== Se || t[60] !== Ce
    ? ((we = (0, L.jsxs)(`div`, { className: O, children: [Se, Ce] })),
      (t[58] = O),
      (t[59] = Se),
      (t[60] = Ce),
      (t[61] = we))
    : (we = t[61]);
  let N;
  t[62] !== c || t[63] !== u || t[64] !== _ || t[65] !== S
    ? ((N = _ ? (0, L.jsx)(St, { onFileAction: u, useMutedButtonStyle: S, variant: c }) : null),
      (t[62] = c),
      (t[63] = u),
      (t[64] = _),
      (t[65] = S),
    ...
    : (N = t[66]);
  let P;
  t[67] !== n || t[68] !== i || t[69] !== h
    ? ((P = h
        ? (0, L.jsx)(
            `span`,
            {
              className: `flex shrink-0 items-center`,
              children: (0, L.jsx)(Te, { linesAdded: n.additions, linesRemoved: n.deletions }),
            },
            i,
          )
        : null),
    ...
    : (P = t[70]);
  let F;
  t[71] !== o || t[72] !== f || t[73] !== g || t[74] !== S
    ? ((F = g
        ? (0, L.jsx)(ft, { headerOpenAction: o, onOpenInEditor: f, useMutedButtonStyle: S })
        : null),
      (t[71] = o),
      (t[72] = f),
      (t[73] = g),
  ...
  t[76] !== N || t[77] !== P || t[78] !== F || t[79] !== Ee
    ...
    : (De = t[80]);
  let R;
  t[81] !== D || t[82] !== we || t[83] !== De
    ? ((R = (0, L.jsxs)(`div`, { className: D, children: [we, De] })),
      (t[81] = D),
      (t[82] = we),
      (t[83] = De),
      (t[84] = R))
  ...
  let z;
  t[85] !== pe || t[86] !== R
    ? ((z = (0, L.jsx)(`div`, { style: pe, children: R })), (t[85] = pe), (t[86] = R), (t[87] = z))
    : (z = t[87]);
  let B;
  return (
    t[88] !== p || t[89] !== de || t[90] !== E || t[91] !== z
      ? ((B = (0, L.jsx)(`div`, {
          role: `button`,
          onClick: p,
          className: de,
...
function dt(e, t) {
  ...
  return (0, L.jsxs)(
    ...
    {
      children: [
        t > 0 ? (0, L.jsx)(`span`, { className: `text-token-text-primary`, children: rt }) : null,
        (0, L.jsx)(`span`, { children: r.slice(0, Math.max(0, r.length - n.length)) }),
        (0, L.jsx)(`span`, { className: `text-token-text-primary`, children: n }),
      ],
    },
    `${r}:${t}`,
  );
...
function ft(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((h = (0, L.jsx)(se, { className: `icon-2xs` })), (t[11] = h))
    : (h = t[11]);
  let g;
  ...
  let _;
  t[17] !== l || t[18] !== g
    ? ((_ = (0, L.jsx)(ne, { tooltipContent: l, children: g })),
      (t[17] = l),
      (t[18] = g),
      (t[19] = _))
    : (_ = t[19]);
  ...
  return (
    t[20] !== _ || t[21] !== d
      ? ((y = (0, L.jsx)(`div`, { className: d, onClick: pt, children: _ })),
        (t[20] = _),
        (t[21] = d),
        (t[22] = y))
      : (y = t[22]),
...
function mt(e) {
  let t = (0, I.c)(137),
    {
      ...
      open: ge,
      requestChangesRef: k,
      richPreviewEnabled: _e,
      showHunkActions: A,
      showLoadError: j,
      useReviewLineInfoSeparators: ve,
      viewType: ye,
      wrapLines: be,
    } = e,
    M = a(s),
  ...
  let Ee = F,
    ...
    z = (0, W.useRef)(!1),
    B = y ?? De,
    Oe = f.additions + f.deletions,
    ke;
  t[1] === f ? (ke = t[2]) : ((ke = E(f)), (t[1] = f), (t[2] = ke));
  let Ae = ke,
    je = Oe > G,
    Ne = je || !Ce ? `none` : `word-alt`,
    Pe = f.additions === 0 && f.deletions === 0,
    Fe = Pe && f.metadata.type === `rename-pure`,
    Ie = Ae,
    Re;
  t[3] !== d || t[4] !== f || t[5] !== w || t[6] !== C || t[7] !== N || t[8] !== B
    ? ((Re = Ye({
        diff: f,
        hostConfig: B,
        ignoreWhitespace: w,
        loadFullFilesEnabled: N,
    ...
    : (Re = t[9]);
  let V = i(qe, Re),
    ze = o(V.fullDiffMetadata$),
    Be = o(V.fullContentLoadFailed$),
    Ve = o(V.fullContentUnavailable$),
    He = o(V.isLoadingFullContent$),
    Ue =
      te &&
      N &&
      d != null &&
      ge &&
      f.metadata.isPartial &&
      !f.isBinary &&
      !f.isGitlink &&
      !Pe &&
      !Ie &&
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (H = t[18]);
  let Ke;
  (t[19] === V.key ? (Ke = t[20]) : ((Ke = [V.key]), (t[19] = V.key), (t[20] = Ke)),
    (0, W.useEffect)(H, Ke));
  let Xe, Ze;
  (t[21] !== d ||
  t[22] !== f ||
  ...
  t[28] !== Ue
    ...
    : ((Xe = t[29]), (Ze = t[30])),
    (0, W.useEffect)(Xe, Ze));
  let Qe = ze ?? f.metadata,
    $e;
  t[31] !== Ae || t[32] !== ze
    ? (($e = ze == null ? Ae : pe(ze)), (t[31] = Ae), (t[32] = ze), (t[33] = $e))
    : ($e = t[33]);
  let et = $e,
    tt;
  t[34] !== je || t[35] !== Qe
    ? ((tt = je ? { ...Qe, lang: `text` } : Qe), (t[34] = je), (t[35] = Qe), (t[36] = tt))
    : (tt = t[36]);
  let nt = tt,
    rt = x === `staged` ? null : he,
    it;
  t[37] !== d || t[38] !== f || t[39] !== x || t[40] !== rt || t[41] !== B.id
    ? ((it = J({ diff: f, openFilePath: rt, cwd: d, hostId: B.id, hunkActionsVariant: x })),
      (t[37] = d),
      (t[38] = f),
      (t[39] = x),
      (t[40] = rt),
    ...
    : (it = t[42]);
  let at = it,
    ot = f.metadata.type === `new`,
    st = f.metadata.type === `deleted`,
    ct;
  t[43] !== g ||
  t[44] !== oe ||
  t[45] !== ae ||
  ...
  bb0: {
    ...
    let e;
    (t[58] !== f.metadata.hunks || t[59] !== f.metadata.name
      ? ((e = []),
        f.metadata.hunks.forEach((t, n) => {
          let r = U(t);
          r &&
            e.push({
              side: r.side,
              lineNumber: r.lineNumber,
              metadata: { kind: `hunk-actions`, path: f.metadata.name, hunkIndex: n },
            });
        }),
        (t[58] = f.metadata.hunks),
        (t[59] = f.metadata.name),
        (t[60] = e))
      : (e = t[60]),
      (pt = e));
  }
  ...
  let Y = Tt,
    X;
  t[70] !== dt || t[71] !== g || t[72] !== ut || t[73] !== f || t[74] !== b || t[75] !== O
    ? ((X = () => {
        if (!g) return;
        let e = b.current;
        if (!e) return;
        let t = Se(e.side, e.lineNumber);
        ut.has(t) ||
          (dt({
            side: e.side,
            lineNumber: e.lineNumber,
            localDiffHunk: Et(f, e.side, e.lineNumber),
          }),
          O?.());
      }),
      (t[70] = dt),
  ...
  (t[77] !== Dt || t[78] !== k
    ...
    (0, W.useEffect)(Z, Ot));
  let kt;
  t[81] !== x || t[82] !== fe || t[83] !== ft
    ? ((kt = (e) => {
        let t = e.metadata;
        return t
          ? t.kind === `hunk-actions`
            ? (0, L.jsx)(Ct, { path: t.path, hunkIndex: t.hunkIndex, onHunkAction: fe, variant: x })
            : ft(e)
          : null;
      }),
      (t[81] = x),
  ...
  t[126] !== be
    ? ((Nt = se
        ? (0, L.jsx)(vt, { diff: f, lines: K(f) })
        : j
          ? (0, L.jsx)(q, { onRetry: ue })
          : et
            ? (0, L.jsx)(_t, { canOpenFile: n, onOpenInEditor: me })
            : (0, L.jsxs)(L.Fragment, {
                children: [
                  Be ? (0, L.jsx)(xt, { onRetry: Ge }) : null,
                  (0, L.jsx)(Me, {
                    diffViewProps: {
                      diffViewClassName: m,
                      disableScrollAnchor: xe != null,
                      fileDiff: nt,
                      isLoadingFullContent: He,
                      metrics: ne,
                      viewType: ye,
                      wrapLines: be,
                      hunkSeparators: ee,
                      ...
                      selectedLines: P,
                      lineAnnotations: bt,
                      renderAnnotation: A || h ? At : void 0,
                      onGutterUtilityClick: g ? Mt : void 0,
                      onPostRender: D,
                      useReviewLineInfoSeparators: ve,
                    },
                    filePath: f.metadata.name,
                    previewPath: rt,
                    imagePreview: at,
                    hasNoChanges: Pe,
    ...
    t[1] !== r || t[2] !== a
      ? ((o = (0, L.jsx)(`div`, {
          ...
          children: (0, L.jsxs)(`div`, {
            ...
            "aria-live": `polite`,
            role: `status`,
            children: [i, (0, L.jsx)(B, { lines: r, minWidth: 42, maxWidth: 96, seed: a })],
          }),
        })),
        (t[1] = r),
        (t[2] = a),
...
function K(e) {
  return Math.min(nt, Math.max(tt, e.additions + e.deletions + 2 * et));
}
function yt(e) {
  let t = (0, I.c)(15),
    { path: n } = e,
  ...
  t[0] === n
    ? ((r = t[1]), (i = t[2]), (a = t[3]))
    : ((r = ot.resolveIcon(`file-tree-icon-file`, n)),
      (a = `size-4 shrink-0`),
      (i = bt(r.token)),
      (t[0] = n),
      (t[1] = r),
  ...
  let s = r.viewBox ?? `0 0 16 16`,
    c = `#${r.name}`,
    l;
  t[6] === c ? (l = t[7]) : ((l = (0, L.jsx)(`use`, { href: c })), (t[6] = c), (t[7] = l));
  let u;
  t[8] !== s || t[9] !== l
    ? ((u = (0, L.jsx)(`svg`, {
        "aria-hidden": !0,
  ...
  return (
    t[11] !== a || t[12] !== o || t[13] !== u
      ? ((d = (0, L.jsx)(`span`, { className: a, style: o, children: u })),
        (t[11] = a),
        (t[12] = o),
        (t[13] = u),
        (t[14] = d))
...
function St(e) {
  let t = (0, I.c)(19),
    { variant: n, onFileAction: r, useMutedButtonStyle: i } = e,
    a = n === `staged` ? `unstage` : `stage`,
    o = i ? `text-token-text-tertiary hover:text-token-text-primary` : void 0,
    s = i ? `ghostMuted` : `ghost`,
    c = i ? `toolbar` : void 0,
    l;
  t[0] === r
    ? (l = t[1])
  ...
  t[7] !== a || t[8] !== r
    ...
    : (d = t[9]);
  let f;
  t[10] !== a || t[11] !== o || t[12] !== s || t[13] !== c || t[14] !== d
    ? ((f = (0, L.jsx)(Be, {
        scope: `file`,
        action: a,
        className: o,
...
function Ct(e) {
  ...
  let l;
  t[9] !== o || t[10] !== c
    ? ((l = (0, L.jsx)(Be, { scope: `hunk`, action: o, onClick: c })),
      (t[9] = o),
      (t[10] = c),
      (t[11] = l))
    : (l = t[11]);
...
function J({ diff: e, openFilePath: t, cwd: n, hostId: r, hunkActionsVariant: i }) {
  let a = wt(
      i === `unstaged`
        ? { cwd: n, hostId: r, path: e.oldPath, ref: `index` }
        : { cwd: n, hostId: r, path: e.oldPath, ref: `head` },
    ),
    o = i === `staged` ? wt({ cwd: n, hostId: r, path: e.newPath, ref: `index` }) : Tt(t, r);
...
function Et(e, t, n) {
  let r = e.metadata.hunks.find((e) =>
    t === `additions`
      ? Y(n, e.additionStart, e.additionCount)
      : Y(n, e.deletionStart, e.deletionCount),
  );
  if (!r) return;
  let i = [
    X(
  ...
  for (let t of r.hunkContent) {
    ...
    i.push(...n.map((e) => `-${X(e)}`), ...r.map((e) => `+${X(e)}`));
  }
  return i.join(`
`);
}
...
export { ze as a, $e as i, Dt as n, Le as o, st as r, Re as s, Z as t };
