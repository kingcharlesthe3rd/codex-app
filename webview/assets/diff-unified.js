...
import { c as m, n as h } from "./shiki-highlight-provider-gate.js";
...
import { t as E } from "./file-diff.js";
...
function Te(e) {
  ...
  t[4] === n
    ? (o = t[5])
    : ((o = g(Se.loadingResultsShimmer, `rounded-md`, n)), (t[4] = n), (t[5] = o));
  let s;
  return (
    t[6] !== a || t[7] !== r || t[8] !== o
...
function Ee(e) {
  ...
  t[5] === n
    ? (_ = t[6])
    : ((_ = g(`flex w-full flex-col items-start gap-2`, n)), (t[5] = n), (t[6] = _));
  let v;
  if (t[7] !== r || t[8] !== h || t[9] !== p) {
    let e;
    (t[11] !== r || t[12] !== p
      ? ((e = (e, t) =>
          (0, z.jsx)(Te, { className: g(Ce[p], r), style: { width: `${De(e)}%` } }, t)),
        (t[11] = r),
        (t[12] = p),
        (t[13] = e))
      : (e = t[13]),
...
function B({ count: e, maxWidth: t, minWidth: n, seed: r }) {
  let i = De(Math.min(n, t)),
    ...
    o = a - i,
    s = Oe(`${r}:${e}:${i}:${a}`);
  return Array.from({ length: Math.max(0, e) }, () => ((s = ke(s)), i + (s / we) * o));
}
function De(e) {
...
function Ae(e) {
  let n = (0, R.c)(22),
    ...
    p;
  n[0] === r ? (p = n[1]) : ((p = (0, z.jsx)(je, { ...r })), (n[0] = r), (n[1] = p));
  let m = p,
    h = c ? `binary` : u ? `rename-without-changes` : `empty`,
    g;
  n[2] === h ? (g = n[3]) : ((g = (0, z.jsx)(Ne, { kind: h })), (n[2] = h), (n[3] = g));
  let _ = g,
    v,
    y;
  n[4] !== i || n[5] !== l || n[6] !== f
    ? ((v = t(i)),
      (y = d({ filePath: i, imagePreviewMode: v, isDeletion: l, richPreviewEnabled: f })),
      (n[4] = i),
      (n[5] = l),
      (n[6] = f),
      (n[7] = v),
  ...
  if (ee === `markdown`) {
    ...
    return (
      n[9] !== m || n[10] !== r.diffViewClassName || n[11] !== a
        ? ((e = (0, z.jsx)(j, { className: r.diffViewClassName, path: a, fallback: m })),
          (n[9] = m),
...
function je(e) {
  ...
  t[12] !== l || t[13] !== a.fileDiff
    ...
    : (_ = t[14]);
  let v;
  t[15] !== a || t[16] !== f || t[17] !== p || t[18] !== m || t[19] !== h || t[20] !== _
    ? ((v = (0, z.jsx)(E, {
        className: f,
        diffStyle: p,
        overflow: m,
...
function Be(e, t, n, r) {
  ...
  for (let d of e.hunks) {
    ...
    if (m < 0 || h < 0 || m !== h || f + d.additionCount > a || p + d.deletionCount > i)
      return null;
    if (!He(t, n, u, l, m, r)) return (Ve(e, `collapsed_context_mismatch`), null);
    let g = f,
      _ = p,
      v = [];
  ...
  if (o.length > 0) {
    ...
    if (!He(t, n, u, l, o, r)) return (Ve(e, `trailing_context_mismatch`), null);
    ((s += o), (c += o));
  }
...
function et(e) {
  let t = (0, R.c)(166),
    ...
    Ze;
  t[0] !== Fe || t[1] !== c
    ? ((Ze = () => Fe && c.metadata.type !== `deleted`), (t[0] = Fe), (t[1] = c), (t[2] = Ze))
    : (Ze = t[2]);
  let [K, Qe] = (0, W.useState)(Ze),
    ...
    ht;
  t[3] !== D || t[4] !== mt
    ? ((ht = mt && mt !== `/dev/null` ? o(mt, D) : mt), (t[3] = D), (t[4] = mt), (t[5] = ht))
    : (ht = t[5]);
  let gt = ht,
    q = Te ?? gt ?? mt ?? ``,
    _t;
  t[6] === q ? (_t = t[7]) : ((_t = q && !i(q) ? q : null), (t[6] = q), (t[7] = _t));
  let vt = _t,
    J,
    yt;
  ...
  let X = Y,
    xt;
  t[20] === q ? (xt = t[21]) : ((xt = a(q).split(`/`).pop() ?? q), (t[20] = q), (t[21] = xt));
  let St = xt,
    Ct = J == null ? q : `${J} -> ${q}`,
    Z = bt == null ? St : `${bt} -> ${St}`,
    Q = L?.id,
  ...
  t[29] !== D || t[30] !== Q || t[31] !== X || t[32] !== ct
    ? ((kt = async () => {
        try {
          return await A({ cwd: D ?? null, hostId: Q, openPath: X, queryClient: ct });
        } catch {
          return null;
        }
      }),
  ...
  t[39] !== D || t[40] !== Q || t[41] !== X || t[42] !== G
    ? ((It = (e) => {
        ...
        X && (n.metaKey || n.ctrlKey) && I(G, { path: X, line: t, cwd: D ?? null, hostId: Q });
      }),
      (t[39] = D),
      (t[40] = Q),
      (t[41] = X),
  ...
  t[56] !== G
    ? ((Bt = () => {
        X &&
          (async () => {
            let { primaryTarget: e } = be({ data: await At(), preferredTargetOverride: Ot });
            if (e != null) {
              ve(G, {
                cwd: D ?? null,
                hostId: Q,
...
function rt(e) {
  let t = (0, R.c)(72),
    ...
    b = o === `full-review`,
    ne;
  t[0] === m ? (ne = t[1]) : ((ne = fe.reviewFileToggle(m)), (t[0] = m), (t[1] = ne));
  let x;
  t[2] === p
    ? (x = t[3])
    : ((x = (e) => {
  ...
  t[4] === S
    ? (C = t[5])
    : ((C = g(`icon-2xs transition-transform duration-200`, S)), (t[4] = S), (t[5] = C));
  let T;
  t[6] === C ? (T = t[7]) : ((T = (0, z.jsx)(me, { className: C })), (t[6] = C), (t[7] = T));
  let ie;
  ...
  t[13] === oe
    ? (se = t[14])
    : ((se = g(`cursor-interaction select-none focus-visible:outline-none`, oe)),
      (t[13] = oe),
      (t[14] = se));
  let ce;
  ...
  t[20] === i
    ? (O = t[21])
    : ((O = (0, z.jsx)(`span`, { className: `font-mono`, children: i })), (t[20] = i), (t[21] = O));
  ...
  let A;
  t[31] !== O || t[32] !== k
    ? ((A = (0, z.jsx)(re, { tooltipContent: O, delayDuration: 200, children: k })),
      (t[31] = O),
      (t[32] = k),
      (t[33] = A))
    : (A = t[33]);
    ...
    ? ((P = h
        ? (0, z.jsx)(
            `span`,
            {
              ...
              children: (0, z.jsx)(_e, { linesAdded: n.additions, linesRemoved: n.deletions }),
            },
            i,
          )
        : null),
  ...
  t[50] !== a || t[51] !== f || t[52] !== _
    ? ((ye = _ ? (0, z.jsx)(it, { headerOpenAction: a, onOpenInEditor: f }) : null),
      (t[50] = a),
      (t[51] = f),
      (t[52] = _),
      (t[53] = ye))
...
function ot(e) {
  ...
  let ke = Oe,
    ...
    Ie = ke,
    V;
  t[3] !== o || t[4] !== c || t[5] !== C || t[6] !== S || t[7] !== be || t[8] !== B
    ? ((V = Ke({
        diff: c,
        hostConfig: B,
        ignoreWhitespace: C,
  ...
  t[18] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (Ue = t[18]);
  let qe;
  (t[19] === H.key ? (qe = t[20]) : ((qe = [H.key]), (t[19] = H.key), (t[20] = qe)),
    (0, W.useEffect)(Ue, qe));
  let Ye, G;
  (t[21] !== o ||
  t[22] !== c ||
  ...
  let Qe = K,
    $e;
  t[34] !== je || t[35] !== Xe
    ? (($e = je ? { ...Xe, lang: `text` } : Xe), (t[34] = je), (t[35] = Xe), (t[36] = $e))
    : ($e = t[36]);
  let et = $e,
    tt = v === `staged` ? null : he,
    nt;
  t[37] !== o || t[38] !== c || t[39] !== v || t[40] !== tt || t[41] !== B.id
    ? ((nt = gt({ diff: c, openFilePath: tt, cwd: o, hostId: B.id, hunkActionsVariant: v })),
      (t[37] = o),
      (t[38] = c),
      (t[39] = v),
      (t[40] = tt),
        ...
        c.metadata.hunks.forEach((t, n) => {
          ...
          r &&
            e.push({
              ...
              metadata: { kind: `hunk-actions`, path: c.metadata.name, hunkIndex: n },
            });
        }),
  ...
  let Z = Ct,
    Q;
  t[70] !== _t || t[71] !== f || t[72] !== q || t[73] !== c || t[74] !== _ || t[75] !== me
    ? ((Q = () => {
        if (!f) return;
        let e = _.current;
        if (!e) return;
  ...
  t[81] !== v || t[82] !== fe || t[83] !== J
    ? ((Dt = (e) => {
        ...
        return t
          ? t.kind === `hunk-actions`
            ? (0, z.jsx)(ht, { path: t.path, hunkIndex: t.hunkIndex, onHunkAction: fe, variant: v })
            : J(e)
          : null;
      }),
      (t[81] = v),
    ...
    t[1] !== r || t[2] !== a
      ? ((o = (0, z.jsx)(`div`, {
          ...
          children: (0, z.jsxs)(`div`, {
            ...
            "aria-live": `polite`,
            role: `status`,
            children: [i, (0, z.jsx)(Ee, { lines: r, minWidth: 42, maxWidth: 96, seed: a })],
          }),
        })),
        (t[1] = r),
        (t[2] = a),
