...
import { c as p, n as m } from "./shiki-highlight-provider-gate.js";
...
import { c as te, o as C } from "./lib-2.js";
import { t as w } from "./persisted-signal-CweW-bgN.js";
import { t as ne } from "./tooltip.js";
import { t as T } from "./button.js";
import { t as E } from "./link-external.js";
import { t as re } from "./proxy.js";
import { t as ie } from "./AnimatePresence.js";
import { t as ae } from "./use-platform.js";
import { s as oe } from "./diff-view-mode.js";
import { n as se, r as ce } from "./parse-diff.js";
import { t as D } from "./file-diff.js";
import { t as le } from "./hash-code.js";
import { t as O } from "./error-boundary.js";
import { g as ue, h as de } from "./window-app-action-helpers.js";
...
import { t as me } from "./plus-d3DP-DMx.js";
import { t as j } from "./undo.js";
import { r as he } from "./diff-stats.js";
import {
  a as M,
  c as N,
  d as P,
...
function je(e) {
  let t = (0, L.c)(22),
    ...
    p;
  t[0] === r ? (p = t[1]) : ((p = (0, R.jsx)(Me, { ...r })), (t[0] = r), (t[1] = p));
  let m = p,
  ...
  t[4] !== i || t[5] !== u || t[6] !== f
    ? ((v = a(i)),
      (y = n({ filePath: i, imagePreviewMode: v, isDeletion: u, richPreviewEnabled: f })),
      (t[4] = i),
      (t[5] = u),
      (t[6] = f),
      (t[7] = v),
  ...
  if (b === `markdown`) {
    let e;
    return (
      t[9] !== m || t[10] !== r.diffViewClassName || t[11] !== o
        ? ((e = (0, R.jsx)(P, { className: r.diffViewClassName, path: o, fallback: m })),
          (t[9] = m),
          (t[10] = r.diffViewClassName),
          (t[11] = o),
          (t[12] = e))
        : (e = t[12]),
      e
  ...
  if (b === `image`) {
    let e = v === `always` ? _ : m,
      ...
      i;
    return (
      t[13] !== r.diffViewClassName || t[14] !== s || t[15] !== e || t[16] !== n
        ? ((i = (0, R.jsx)(F, {
            className: r.diffViewClassName,
            imagePreview: s,
            fallback: e,
            showMissingPreview: n,
          })),
          (t[13] = r.diffViewClassName),
          (t[14] = s),
          (t[15] = e),
          (t[16] = n),
          (t[17] = i))
  ...
  if (b === `pdf`) {
    let e;
    return (
      t[18] !== r.diffViewClassName || t[19] !== _ || t[20] !== s
        ? ((e = (0, R.jsx)(Se, {
            className: r.diffViewClassName,
            imagePreview: s,
            fallback: _,
...
function H(e) {
  ...
  if (n === `stage`) {
    ...
    (t[2] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((e = (0, R.jsx)(pe, { className: `icon-2xs` })), (t[2] = e))
      : (e = t[2]),
      (s = e));
  }
  let c;
...
function et(e) {
  let n = (0, L.c)(166),
    ...
    Ze;
  n[0] !== Ie || n[1] !== a
    ? ((Ze = () => Ie && a.metadata.type !== `deleted`), (n[0] = Ie), (n[1] = a), (n[2] = Ze))
    : (Ze = n[2]);
  let [K, Qe] = (0, W.useState)(Ze),
    ...
    ht;
  n[3] !== O || n[4] !== mt
    ? ((ht = mt && mt !== `/dev/null` ? t(mt, O) : mt), (n[3] = O), (n[4] = mt), (n[5] = ht))
    : (ht = n[5]);
  let gt = ht,
    q = Ee ?? gt ?? mt ?? ``,
    _t;
  n[6] === q ? (_t = n[7]) : ((_t = q && !o(q) ? q : null), (n[6] = q), (n[7] = _t));
  let vt = _t,
    J,
    yt;
  n[8] !== O || n[9] !== a.metadata.prevName || n[10] !== a.metadata.type
    ? ((J =
        (a.metadata.type === `rename-pure` || a.metadata.type === `rename-changed`) &&
        a.metadata.prevName != null
          ? t(a.metadata.prevName, O)
          : null),
      (yt = J == null ? null : (s(J).split(`/`).pop() ?? J)),
      (n[8] = O),
      (n[9] = a.metadata.prevName),
      (n[10] = a.metadata.type),
      (n[11] = J),
      (n[12] = yt))
    : ((J = n[11]), (yt = n[12]));
  let bt = yt,
  ...
  bb0: {
    ...
    let e = lt === `windows`,
      t;
    (n[16] !== O || n[17] !== e || n[18] !== gt
      ? ((t = c(O, gt, e)), (n[16] = O), (n[17] = e), (n[18] = gt), (n[19] = t))
      : (t = n[19]),
      (Y = t));
  }
  let X = Y,
    xt;
  n[20] === q ? (xt = n[21]) : ((xt = s(q).split(`/`).pop() ?? q), (n[20] = q), (n[21] = xt));
  let St = xt,
    Ct = J == null ? q : `${J} -> ${q}`,
    Z = bt == null ? St : `${bt} -> ${St}`,
    Q = xe?.id,
  ...
  let Lt = A(It),
    Rt;
  n[44] !== O || n[45] !== $ || n[46] !== Q || n[47] !== X || n[48] !== G
    ? ((Rt = (e, t, n) => {
        if (!X) return;
        let r = it.current ?? $;
        ((it.current = null),
  ...
  let qt = A(Kt),
    Jt;
  n[66] !== O || n[67] !== $ || n[68] !== Q || n[69] !== X || n[70] !== G || n[71] !== qt
    ? ((Jt = (e) => {
  ...
  let tn = ze && `rounded-lg`,
    nn;
  n[77] !== r || n[78] !== tn
    ? ((nn = h(`group/file-diff flex flex-col overflow-clip`, tn, r)),
      (n[77] = r),
      (n[78] = tn),
      (n[79] = nn))
    : (nn = n[79]);
  let rn;
  n[80] !== Be || n[81] !== Ve
    ? ((rn = m(Be, Ve)), (n[80] = Be), (n[81] = Ve), (n[82] = rn))
    : (rn = n[82]);
  ...
  n[83] !== an || n[84] !== on
    ...
    : (sn = n[85]);
  let cn;
  n[86] !== a.metadata.name || n[87] !== ce
    ? ((cn = (e) => {
        ce?.({ path: a.metadata.name, action: e, scope: `file` });
      }),
      (n[86] = a.metadata.name),
      (n[87] = ce),
      (n[88] = cn))
    : (cn = n[88]);
  let ln = jt,
  ...
  n[149] === fn
    ? (pn = n[150])
    : ((pn = (0, R.jsx)(ie, { children: fn })), (n[149] = fn), (n[150] = pn));
  let mn;
  n[151] !== nn || n[152] !== sn || n[153] !== dn || n[154] !== pn
    ? ((mn = (0, R.jsxs)(`div`, {
        onContextMenu: $t,
        className: nn,
        style: sn,
...
function rt(e) {
  ...
  t[2] === p
    ...
    : ((te = (e) => {
      ...
      (t[2] = p),
      (t[3] = te));
  let C = m ? `rotate-90` : `rotate-0`,
    w;
  t[4] === C
    ? (w = t[5])
    : ((w = h(`icon-2xs transition-transform duration-200`, C)), (t[4] = C), (t[5] = w));
  let E;
  t[6] === w ? (E = t[7]) : ((E = (0, R.jsx)(fe, { className: w })), (t[6] = w), (t[7] = E));
  let re;
...
function ot(e) {
  ...
  let we = Ce,
    ...
    ke;
  t[1] === l ? (ke = t[2]) : ((ke = se(l)), (t[1] = l), (t[2] = ke));
  let Ae = ke,
    Me = Oe > Ze,
    ...
    Le = Ae,
    B;
  t[3] !== c || t[4] !== l || t[5] !== w || t[6] !== C || t[7] !== ve || t[8] !== z
    ? ((B = Ke({
        diff: l,
        hostConfig: z,
        ignoreWhitespace: w,
  ...
  let Xe = H ?? l.metadata,
    K;
  t[31] !== Ae || t[32] !== H
    ? ((K = H == null ? Ae : ce(H)), (t[31] = Ae), (t[32] = H), (t[33] = K))
    : (K = t[33]);
  let Qe = K,
    $e;
  t[34] !== Me || t[35] !== Xe
  ...
  let et = $e,
    tt = x === `staged` ? null : pe,
    nt;
  t[37] !== c || t[38] !== l || t[39] !== x || t[40] !== tt || t[41] !== z.id
  ...
  bb0: {
    ...
    let e;
    (t[58] !== l.metadata.hunks || t[59] !== l.metadata.name
      ? ((e = []),
        ...
        (t[58] = l.metadata.hunks),
        (t[59] = l.metadata.name),
        (t[60] = e))
      : (e = t[60]),
      (yt = e));
  }
  ...
  let Z = Ct,
    Q;
  t[70] !== _t || t[71] !== f || t[72] !== q || t[73] !== l || t[74] !== b || t[75] !== fe
    ? ((Q = () => {
        if (!f) return;
        let e = b.current;
        if (!e) return;
  ...
  t[125] !== F
    ? ((jt = le
        ...
        : N
          ...
          : Qe
            ? (0, R.jsx)(lt, { canOpenFile: n, onOpenInEditor: A })
            : (0, R.jsxs)(R.Fragment, {
                children: [
