import { R as e, a as t, o as n, t as r } from "./app-scope.js";
import { js as i } from "./app-server-manager-signals.js";
import { g as a, k as o, m as s } from "./vscode-api.js";
import { c, r as l } from "./lib.js";
import { t as u } from "./invalidate-queries-and-broadcast.js";
import { s as d, w as f } from "./config-queries.js";
...
function v(e) {
  let l = (0, h.c)(28),
    ...
    C = c(),
    w;
  l[0] === g ? (w = l[1]) : ((w = m(g)), (l[0] = g), (l[1] = w));
  let T = w,
    E;
  l[2] !== T || l[3] !== S
    ? ((E = async () => {
        await Promise.all([S(T), S(d), S([`user-saved-config`])]);
      }),
      (l[2] = T),
      (l[3] = S),
      (l[4] = E))
  ...
  l[12] !== T || l[13] !== C || l[14] !== x || l[15] !== v
    ? ((A = (e, t) => {
        ...
        v.get(p).success(C.formatMessage(r ? _.enableSuccess : _.disableSuccess, { appName: i }));
      }),
      (j = (e, t, n) => {
