...
function D(e) {
  let t = (0, k.c)(28),
    ...
    u = f(),
    p;
  t[0] === n ? (p = t[1]) : ((p = m(n)), (t[0] = n), (t[1] = p));
  let h = p,
    g;
  t[2] !== h || t[3] !== l
    ? ((g = async () => {
        await Promise.all([l(h), l(d), l([`user-saved-config`])]);
      }),
      (t[2] = h),
      (t[3] = l),
      (t[4] = g))
  ...
  t[9] !== h || t[10] !== c
    ? ((C = async (e) => {
        ...
        await c.cancelQueries({ queryKey: h });
        let r = c.getQueryData(h);
        return (
          r &&
            c.setQueryData(
              h,
    ...
    : (C = t[11]);
  let D, A;
  t[12] !== h || t[13] !== u || t[14] !== c || t[15] !== i
    ? ((D = (e, t) => {
        let { appId: n, appName: r, enabled: a } = t,
          o = r ?? c.getQueryData(h)?.find((e) => e.id === n)?.name ?? n;
        i.get(T).success(u.formatMessage(a ? j.enableSuccess : j.disableSuccess, { appName: o }));
      }),
      (A = (e, t, n) => {
        (s.error(`Failed to update app enablement`, { safe: {}, sensitive: { error: e } }),
          i.get(T).danger(u.formatMessage(j.updateError)),
          n?.previousApps && c.setQueryData(h, n.previousApps));
      }),
      (t[12] = h),
      (t[13] = u),
      (t[14] = c),
    ...
    : ((D = t[16]), (A = t[17]));
  let M;
  t[18] !== _ || t[19] !== x || t[20] !== C || t[21] !== D || t[22] !== A
    ? ((M = { mutationFn: x, onMutate: C, onSuccess: D, onError: A, onSettled: _ }),
      (t[18] = _),
      (t[19] = x),
      (t[20] = C),
      (t[21] = D),
