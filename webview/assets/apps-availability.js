...
function D(e) {
  ...
  t[12] !== _ || t[13] !== m || t[14] !== u || t[15] !== s
    ? ((D = (e, t) => {
        ...
        s.get(f).success(m.formatMessage(i ? j.enableSuccess : j.disableSuccess, { appName: a }));
      }),
      (A = (e, t, r) => {
        (n.error(`Failed to update app enablement`, { safe: {}, sensitive: { error: e } }),
  ...
  t[18] !== b || t[19] !== S || t[20] !== T || t[21] !== D || t[22] !== A
    ? ((M = { mutationFn: S, onMutate: T, onSuccess: D, onError: A, onSettled: b }),
      (t[18] = b),
      (t[19] = S),
      (t[20] = T),
      (t[21] = D),
