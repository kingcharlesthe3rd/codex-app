...
import { g as i, k as a, m as o } from "./vscode-api.js";
import { As as s } from "./app-server-manager-signals.js";
import { c, r as l } from "./lib-1.js";
import { t as u } from "./invalidate-queries-and-broadcast.js";
import { s as d, w as f } from "./config-queries-BHYT-TjG.js";
...
function v(e) {
  ...
  l[12] !== T || l[13] !== C || l[14] !== x || l[15] !== v
    ? ((A = (e, t) => {
      ...
      (j = (e, t, n) => {
        (o.error(`Failed to update app enablement`, { safe: {}, sensitive: { error: e } }),
