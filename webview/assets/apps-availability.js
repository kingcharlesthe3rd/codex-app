import { Z as e, a as t, o as n, t as r } from "./app-scope-CWE-zIhQ.js";
import { Bt as i } from "./use-host-config-C.js";
import { A as a, _ as o, h as s } from "./vscode-api.js";
import { i as c, l } from "./lib-1.js";
import { r as u } from "./toast-signal.js";
import { t as d } from "./invalidate-queries-and-broadcast.js";
import { C as f, s as p } from "./config-queries.js";
import { n as m } from "./apps-queries.js";
var h = e(),
  g = `apps`,
  _ = c({
    enableSuccess: {
...
function v(e) {
  let c = (0, h.c)(28),
    ...
    C = l(),
    w;
  c[0] === g ? (w = c[1]) : ((w = m(g)), (c[0] = g), (c[1] = w));
  let T = w,
    E;
  c[2] !== T || c[3] !== S
    ? ((E = async () => {
        await Promise.all([S(T), S(p), S([`user-saved-config`])]);
      }),
      (c[2] = T),
      (c[3] = S),
      (c[4] = E))
  ...
  let D = E,
    O;
  c[5] !== g ||
  c[6] !== b?.configWriteTarget?.expectedVersion ||
  c[7] !== b?.configWriteTarget?.filePath
    ? ((O = async (e) => {
        let { appId: t, enabled: n } = e;
        await i(`batch-write-config-value`, {
          hostId: g,
          edits: y({ appId: t, enabled: n }),
  ...
  c[9] !== T || c[10] !== x
    ...
    : (k = c[11]);
  let A, j;
  c[12] !== T || c[13] !== C || c[14] !== x || c[15] !== v
    ? ((A = (e, t) => {
        let { appId: n, enabled: r } = t,
          i = x.getQueryData(T)?.find((e) => e.id === n)?.name ?? n;
        v.get(u).success(C.formatMessage(r ? _.enableSuccess : _.disableSuccess, { appName: i }));
      }),
      (j = (e, t, n) => {
        (s.error(`Failed to update app enablement`, { safe: {}, sensitive: { error: e } }),
          v.get(u).danger(C.formatMessage(_.updateError)),
    ...
    : ((A = c[16]), (j = c[17]));
  let M;
  c[18] !== D || c[19] !== O || c[20] !== k || c[21] !== A || c[22] !== j
  ...
  let N = o(M),
    ...
    F;
  return (
    c[24] !== N.isPending || c[25] !== N.mutateAsync || c[26] !== P
