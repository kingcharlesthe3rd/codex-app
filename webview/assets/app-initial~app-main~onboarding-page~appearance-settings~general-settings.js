...
import { Aa as Ue, ka as We } from "./app-initial~app-main~onboarding-page~profile.js";
import {
  dt as Ge,
  ft as Ke,
} from "./app-initial~app-main~remote-conversation-page~new-thread-panel-page~appgen-library-page~hot~djo67r4n.js";
import { t as qe } from "./app-initial~app-main~worktree-init-v2-page~page~remote-conversation-page~pull-requests-page~iwrno211.js";
import {
  n as Je,
  t as Ye,
...
function Ze(e) {
  return (0, et.default)(e, ({ itemType: e }) => {
    switch (e) {
      case `CONFIG`:
        return 0;
      case `AGENTS_MD`:
...
function pt(e) {
  let t = (0, ht.c)(16),
    ...
    o;
  t[0] === r ? (o = t[1]) : ((o = (0, K.jsx)(mt, { variant: r })), (t[0] = r), (t[1] = o));
  let s;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, K.jsx)(ct, { className: `h-12 w-10 text-token-foreground` })), (t[2] = s))
    : (s = t[2]);
  let c;
  t[3] === n
    ? (c = t[4])
    : ((c = (0, K.jsx)(Ye, { appBrand: n, className: `size-12` })), (t[3] = n), (t[4] = c));
  let l;
  t[5] !== o || t[6] !== c
    ? ((l = (0, K.jsxs)(`div`, {
...
function mt(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = u(`flex size-12 shrink-0 items-center justify-center rounded-xl`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, K.jsx)(dt, { className: `size-6` })), (t[2] = a))
    : (a = t[2]);
  let o;
  return (
    t[3] === i
      ? (o = t[4])
      : ((o = (0, K.jsx)(`div`, { className: i, children: a })), (t[3] = i), (t[4] = o)),
    o
  );
}
var ht,
...
function _t(e) {
  ...
  let D = E,
    O;
  t[14] !== n || t[15] !== f || t[16] !== _
    ? ((O = f
        ? (0, q.jsx)(m, {
            children: (0, q.jsx)(h, {
              title: (0, q.jsx)(ie, { className: `contents`, children: _ }),
              subtitle: (0, q.jsx)(ke, { className: `sr-only`, children: y }),
            }),
          })
        : (0, q.jsx)(pt, { appBrand: n, sourceIconVariant: `neutral`, title: _, subtitle: y })),
      (t[14] = n),
      (t[15] = f),
      (t[16] = _),
      (t[17] = O))
    : (O = t[17]);
  let A = f ? `mt-4 flex w-full flex-col` : `mt-8 flex w-full max-w-xs flex-col`,
    j;
  ...
  if (t[21] !== r || t[22] !== u) {
    ...
    (t[26] === u
      ? (n = t[27])
      : ((n = (e) =>
          (0, q.jsx)(vt, { providerId: e, selected: u.includes(e), onToggle: () => T(e) }, e)),
        (t[26] = u),
        (t[27] = n)),
      (N = xt.filter(e).map(n)),
      (t[21] = r),
  ...
  let I;
  t[32] !== P || t[33] !== A
    ? ((I = (0, q.jsxs)(`div`, { className: A, children: [j, P, F] })),
      (t[32] = P),
      (t[33] = A),
      (t[34] = I))
    : (I = t[34]);
  let L;
  t[35] !== x || t[36] !== C || t[37] !== f || t[38] !== a || t[39] !== s
    ? ((L = f
        ? (0, q.jsx)(`div`, {
            className: `mt-4`,
            children: (0, q.jsxs)(k, {
  ...
  t[41] !== I || t[42] !== L || t[43] !== O
    ? ((R = (0, q.jsxs)(q.Fragment, { children: [O, I, L] })),
      (t[41] = I),
      (t[42] = L),
      (t[43] = O),
      (t[44] = R))
  ...
  let z = R,
    B;
  return (
    t[45] !== z || t[46] !== D || t[47] !== f
      ? ((B = f
          ? (0, q.jsx)(Te, { as: `form`, className: `gap-0`, onSubmit: D, children: z })
          : (0, q.jsx)(`div`, {
...
function vt(e) {
  ...
  t[10] !== i || t[11] !== r || t[12] !== f
    ? ((p = (0, q.jsx)(E, { checked: r, ariaLabel: f, onChange: i })),
      (t[10] = i),
      (t[11] = r),
      (t[12] = f),
      (t[13] = p))
...
function Dt(e) {
  ...
  return (
    t[2] !== r || t[3] !== n || t[4] !== a
      ? ((o = (0, Y.jsx)(`div`, { className: a, role: `list`, "aria-label": r, children: n })),
        (t[2] = r),
        (t[3] = n),
        (t[4] = a),
        (t[5] = o))
...
function Ot(e) {
  let t = (0, J.c)(45),
    ...
    b = p === void 0 ? `left` : p,
    x = h === void 0 ? jt : h,
    S = o == null && n != null && r != null && a != null,
    C;
  t[0] !== x || t[1] !== n || t[2] !== r || t[3] !== o || t[4] !== y || t[5] !== a || t[6] !== S
    ? ((C = S
        ? (0, Y.jsx)(Ve, {
            id: n,
            className: x,
  ...
  t[8] === m
    ? (T = t[9])
    : ((T = u(`relative flex items-start gap-2 last:border-b-0`, m)), (t[8] = m), (t[9] = T));
  let E;
  t[10] !== w || t[11] !== b
    ? ((E = b === `left` ? (0, Y.jsx)(`div`, { children: w }) : null),
      (t[10] = w),
      (t[11] = b),
      (t[12] = E))
    : (E = t[12]);
  ...
  t[13] === l
    ? (D = t[14])
    : ((D = l == null ? null : (0, Y.jsx)(`div`, { children: l })), (t[13] = l), (t[14] = D));
  let O = S ? n : void 0,
    k;
  t[15] === g
    ? (k = t[16])
    : ((k = u(`truncate text-base leading-5 text-token-foreground`, g)), (t[15] = g), (t[16] = k));
  let A;
  t[17] !== s || t[18] !== k
    ? ((A = (0, Y.jsx)(`div`, { className: k, children: s })),
      (t[17] = s),
      (t[18] = k),
      (t[19] = A))
    : (A = t[19]);
  ...
  t[20] !== c || t[21] !== _
    ? ((j =
        c == null
          ? null
          : (0, Y.jsx)(`div`, {
              className: u(`truncate text-xs leading-4 text-token-text-secondary`, _),
              children: c,
            })),
      (t[20] = c),
      (t[21] = _),
  ...
  let M;
  t[23] !== A || t[24] !== j
    ? ((M = (0, Y.jsxs)(`div`, { className: `min-w-0 flex-1`, children: [A, j] })),
      (t[23] = A),
      (t[24] = j),
      (t[25] = M))
    : (M = t[25]);
  ...
  t[33] === f
    ? (F = t[34])
    : ((F = f == null ? null : (0, Y.jsx)(`div`, { children: f })), (t[33] = f), (t[34] = F));
  let I;
  t[35] !== w || t[36] !== b
    ? ((I = b === `right` ? (0, Y.jsx)(`div`, { children: w }) : null),
      (t[35] = w),
      (t[36] = b),
      (t[37] = I))
    : (I = t[37]);
  let L;
  return (
    t[38] !== P || t[39] !== F || t[40] !== I || t[41] !== T || t[42] !== E || t[43] !== D
      ? ((L = (0, Y.jsxs)(`div`, { className: T, role: `listitem`, children: [E, D, P, F, I] })),
        (t[38] = P),
        (t[39] = F),
        (t[40] = I),
        (t[41] = T),
...
function kt(e) {
  ...
  t[0] === o
    ? (d = t[1])
    : ((d = u(`flex w-full flex-col items-center gap-6`, o)), (t[0] = o), (t[1] = d));
  let f = r ?? null,
    p;
  t[2] === s
    ? (p = t[3])
    : ((p = u(`flex w-full flex-col items-center text-center`, s)), (t[2] = s), (t[3] = p));
  let m;
  t[4] === c
    ? (m = t[5])
    : ((m = u(`text-heading-lg font-semibold text-token-foreground`, c)), (t[4] = c), (t[5] = m));
  let h;
  t[6] !== m || t[7] !== i
    ? ((h = (0, Y.jsx)(`span`, { className: m, children: i })), (t[6] = m), (t[7] = i), (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== a || t[10] !== l
    ? ((g =
        a == null
          ? null
          : (0, Y.jsx)(`span`, {
              className: u(`text-lg leading-6 text-token-description-foreground`, l),
              children: a,
            })),
      (t[9] = a),
      (t[10] = l),
  ...
  t[12] !== p || t[13] !== h || t[14] !== g
    ? ((_ = (0, Y.jsxs)(`div`, { className: p, children: [h, g] })),
      (t[12] = p),
      (t[13] = h),
      (t[14] = g),
      (t[15] = _))
  ...
  return (
    t[16] !== n || t[17] !== d || t[18] !== f || t[19] !== _
      ? ((v = (0, Y.jsxs)(`div`, { className: d, children: [f, _, n] })),
        (t[16] = n),
        (t[17] = d),
        (t[18] = f),
        (t[19] = _),
...
function At(e) {
  ...
  let g;
  t[9] !== n || t[10] !== h
    ? ((g = (0, Y.jsx)(`div`, { className: h, children: n })), (t[9] = n), (t[10] = h), (t[11] = g))
    : (g = t[11]);
  let _;
  return (
    t[12] !== p || t[13] !== m || t[14] !== g
      ? ((_ = (0, Y.jsxs)(`div`, {
          ...
          children: [f, (0, Y.jsxs)(F, { browser: !0, electron: !0, children: [p, m, g] })],
        })),
        (t[12] = p),
        (t[13] = m),
        (t[14] = g),
...
var J,
  ...
  Mt = e(() => {
    ((J = U()),
      ...
      l(),
      (Y = d()),
      (jt = `h-[18px] w-[18px] rounded-[3px] border-[1px]`));
  });
function Nt(e) {
  let t = (0, It.c)(10),
...
function Pt(e) {
                ...
                (0, X.jsxs)(`label`, {
                  ...
                  children: [
                    (0, X.jsx)(`div`, {
                      ...
                      children: (0, X.jsx)(Ft, { icon: e.icon }),
                    }),
                    (0, X.jsxs)(`div`, {
                ...
                e.tooltip == null
                  ...
                  : (0, X.jsx)(ve, {
                      ...
                      children: (0, X.jsx)(`button`, {
                        ...
                        children: (0, X.jsx)(L, { className: `size-4`, "aria-hidden": `true` }),
                      }),
                    }),
                (0, X.jsx)(`div`, {
  ...
  t[11] === f
    ? (m = t[12])
    : ((m = (0, X.jsx)(`div`, { className: `flex flex-col gap-2`, children: f })),
      (t[11] = f),
      (t[12] = m));
  let h = l === 0,
    g;
  ...
  return (
    t[20] !== m || t[21] !== v
      ? ((y = (0, X.jsxs)(`div`, { className: `flex flex-col gap-4 p-4`, children: [u, d, m, v] })),
        (t[20] = m),
        (t[21] = v),
        (t[22] = y))
      : (y = t[22]),
...
function Ft(e) {
  ...
  switch (n) {
    case `instructions`: {
      ...
      return (
        t[0] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(Pe, { className: `icon-base` })), (t[0] = e))
          : (e = t[0]),
        e
      );
    }
    case `settings`: {
      ...
      return (
        t[1] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(Ie, { className: `icon-base` })), (t[1] = e))
          : (e = t[1]),
        e
      );
    }
    case `skills`: {
      ...
      return (
        t[2] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(Le, { className: `icon-base` })), (t[2] = e))
          : (e = t[2]),
        e
      );
    }
    case `plugins`: {
      ...
      return (
        t[3] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(R, { className: `icon-base` })), (t[3] = e))
          : (e = t[3]),
        e
      );
    }
    case `projects`: {
      ...
      return (
        t[4] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(je, { className: `icon-base` })), (t[4] = e))
          : (e = t[4]),
        e
      );
    }
    case `chats`: {
      ...
      return (
        t[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(Tt, { className: `icon-base` })), (t[5] = e))
          : (e = t[5]),
        e
      );
    }
    case `hooks`: {
      ...
      return (
        t[6] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(We, { className: `icon-base` })), (t[6] = e))
          : (e = t[6]),
        e
      );
    }
    case `commands`: {
      ...
      return (
        t[7] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(Be, { className: `icon-base` })), (t[7] = e))
          : (e = t[7]),
        e
      );
    }
    case `agents`: {
      ...
      return (
        t[8] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, X.jsx)(Ge, { className: `icon-base` })), (t[8] = e))
          : (e = t[8]),
        e
      );
    }
...
async function Bt({
  ...
  try {
    ...
    return (
      H.warning(`Failed to add imported project roots after import`, {
        safe: { hostId: e },
        sensitive: { error: t },
      }),
      []
...
async function Vt({ hostId: e, projectRoots: t }) {
  ...
  let n = await z(`paths-exist`, { params: { hostId: e, paths: t } }),
...
async function Ht(e) {
  let t = (
    await Promise.allSettled(
      [...e]
        ...
        .map(
          async (e) => (
            await z(`add-workspace-root-option`, { params: { root: e, setActive: !1 } }),
            e
          ),
        ),
    )
  ...
  t.length > 0 &&
    H.warning(`Failed to add some imported project roots after import`, {
      safe: { failedRootCount: t.length, totalRootCount: e.length },
      sensitive: { errors: t.map((e) => e.reason) },
    });
}
function Ut(e = A) {
  return _e(`refresh-recent-conversations-for-host`, { hostId: e });
}
async function Wt(e) {
  try {
    await e();
  } catch (e) {
    H.warning(`Failed to refresh recent conversations after import`, {
      safe: {},
      sensitive: { error: e },
    });
  }
...
async function en({ hostId: e, includeHome: t, workspaceRoots: n }) {
  return z(`external-agent-import-detect`, {
    params: {
      hostId: e,
      includeHome: t,
      providers: nn,
...
async function tn({ hostId: e, items: t }) {
  return t.length === 0
    ? { projectRoots: [] }
    : z(`external-agent-import-import`, { params: { hostId: e, items: t } });
}
var nn,
  rn = e(() => {
    (n(), (nn = [`claude-code`, `claude-cowork`]));
  });
async function an(e) {
  await Promise.all([
    ...
    e.invalidateQueries({ queryKey: be }),
    e.invalidateQueries({ queryKey: oe }),
    e.invalidateQueries({ queryKey: I(`local-custom-agents`) }),
    e.invalidateQueries({ queryKey: I(`external-agent-import-status`) }),
    e.invalidateQueries({ queryKey: I(`external-agent-imported-connectors`) }),
  ]);
}
var on = e(() => {
  (Ce(), D(), De(), n());
...
function sn({ items: e, surface: t }) {
  H.info(`external_agent_import_user_flow_started`, { safe: { surface: t, ...un(e) } });
}
function cn({
  durationMs: e,
  error: t,
  ...
  if (a === `success`) {
    H.info(`external_agent_import_user_flow_finished`, { safe: s });
    return;
  }
  H.warning(`external_agent_import_user_flow_finished`, { safe: s, sensitive: { error: t } });
}
function ln(e) {
  switch (e) {
    case `import`:
...
function fn(e) {
  ...
  let l = b(c),
    u = l.data?.items ?? gn,
    d = l.data?.unsupportedProjects ?? _n,
    f;
  t[10] === u ? (f = t[11]) : ((f = u.filter(mn)), (t[10] = u), (t[11] = f));
  let p = f,
    m;
  t[12] === u ? (m = t[13]) : ((m = u.filter(pn)), (t[12] = u), (t[13] = m));
  let h = m,
    g;
  t[14] !== p || t[15] !== h
    ? ((g = Kt({ homeItems: p, projectItems: h })), (t[14] = p), (t[15] = h), (t[16] = g))
    : (g = t[16]);
  let _ = g,
    v;
  t[17] === _ ? (v = t[18]) : ((v = _ == null ? [] : qt(_)), (t[17] = _), (t[18] = v));
  let y = v,
    x = n && l.isLoading,
    S;
  t[19] === _
    ? (S = t[20])
    : ((S = (e) => (_ == null ? [] : Jt({ model: _, selection: e }))), (t[19] = _), (t[20] = S));
  let w = S,
    T;
  t[21] === a
    ? (T = t[22])
  ...
  t[26] === l
    ? (j = t[27])
    : ((j = async () => (await l.refetch()).data?.items ?? gn), (t[26] = l), (t[27] = j));
  let M;
  return (
    t[28] !== y ||
    t[29] !== u ||
...
function yn(e) {
  ...
  let {
    ...
    h;
  t[2] === s ? (h = t[3]) : ((h = Sn(s)), (t[2] = s), (t[3] = h));
  let _ = h,
    v;
  bb0: {
    if (!n) {
    ...
    let e;
    (t[4] !== s || t[5] !== i || t[6] !== _
      ? ((e = Cn({ detectedItems: s, intl: i, providerIds: _ })),
        (t[4] = s),
        (t[5] = i),
        (t[6] = _),
        (t[7] = e))
  ...
  let y = v,
    ...
    C;
  t[8] !== s || t[9] !== i
    ? ((C = (e) => Cn({ detectedItems: s, intl: i, providerIds: e })),
      (t[8] = s),
      (t[9] = i),
      (t[10] = C))
    : (C = t[10]);
  ...
  t[20] !== y
    ? ((w = async (e, t) => {
        ...
        let o = t == null ? y : Cn({ detectedItems: s, intl: i, providerIds: t }),
          p = t == null ? c(e) : wn({ detectedItems: s, providerIds: t, selection: e }),
          m = Date.now(),
          h = `import`,
          g = 0;
        sn({ items: p, surface: `first_time_onboarding` });
        let _ = o?.chatChoiceKey != null && e[o.chatChoiceKey];
        try {
          h = `import`;
          let { projectRoots: n } = t == null ? await d(e) : await u(p);
          ((g = n.length),
            ...
            await zt({
              ...
              invalidateWorkspaceRootQueries: async () => {
                await Promise.all([
                  a.invalidateQueries({ queryKey: I(`workspace-root-options`) }),
                  a.invalidateQueries({ queryKey: I(`active-workspace-roots`) }),
                ]);
              },
              refreshRecentConversations: _ ? bn : void 0,
            }),
            (h = `invalidate_queries`),
            await Promise.all([
              a.invalidateQueries({ queryKey: I(`codex-agents-md`) }),
  ...
  return (
    ...
    t[28] !== w
      ? ((E = {
          ...
          isImporting: x,
          providerIds: _,
          shouldShowImportStep: S,
          summary: y,
          getSummaryForProviders: C,
          importSelection: w,
        }),
        (t[22] = _),
        (t[23] = y),
...
function bn() {
  return _e(`refresh-recent-conversations-for-host`, { hostId: A, sortKey: me });
}
    ...
    return (
      Sn(
        (
          await e.fetchQuery({
            queryKey: $t({ hostId: A }),
            queryFn: () => en({ hostId: A, includeHome: !0 }),
            staleTime: 0,
          })
        ).items,
      ).length > 0
...
function tr({
  ...
  let x = V(),
    [S, C] = (0, hr.useState)(() => Dn(g)),
    [w, T] = (0, hr.useState)(!1),
    [E, D] = (0, hr.useState)(() => new Set(g.customizeItems.map((e) => e.id))),
    O = l === `dialog`,
    A = a || i,
    j = a || i,
    M = ur({ summary: g, selection: S }),
    N = lr({ items: g.customizeItems, selection: S, group: `toolsAndSetup` }),
    F = lr({ items: g.customizeItems, selection: S, group: `projects` }),
    I = g.chatChoiceKey != null && (S[g.chatChoiceKey] ?? !1),
    L = ar({ isComplete: i, isSelected: N !== !1 }),
    R = ar({ isComplete: i, isSelected: F !== !1 }),
    z = ar({ isComplete: i, isSelected: I }),
    B = (e) => {
      y?.({ source: r, ...e });
    };
  (0, hr.useEffect)(() => {
    o && B({ action: `shown`, ...Z(g, S, f) });
  }, []);
  let ee = () => {
      (_?.(), T(!0));
    },
    te = () => {
      a || !M || (i || B({ action: `continue`, ...Z(g, S, f) }), v(S));
    },
    ne = () => {
      A || (B({ action: `skipped`, ...Z(g, S, f) }), b());
    },
    re = a
      ? (0, $.jsx)(W, {
    ...
    ae = c ?? (0, $.jsx)(nr, {}),
    oe = s === void 0 ? (0, $.jsx)(rr, {}) : s,
    se = (e) => {
      (e.preventDefault(), !(a || !M) && te());
    },
    ce = (0, $.jsxs)($.Fragment, {
      children: [
        O
          ? (0, $.jsx)(m, {
              children: (0, $.jsx)(h, {
                title: (0, $.jsx)(ie, { className: `contents`, children: ae }),
                subtitle: oe == null ? null : (0, $.jsx)(ke, { children: oe }),
              }),
            })
          : (0, $.jsx)(pt, { appBrand: e, sourceIconVariant: `orange`, title: ae, subtitle: oe }),
        (0, $.jsxs)(`div`, {
          className: u(`flex w-full flex-col`, O ? `mt-4` : `mt-8 max-w-sm`),
          children: [
            cr(g)
              ? (0, $.jsxs)(Dt, {
                  ...
                  children: [
                    g.toolsAndSetupCount > 0
                      ? (0, $.jsx)(Ot, {
                          checkboxId: `external-agent-import-tools-and-setup`,
                          checked: N,
                          control: j ? (0, $.jsx)(ir, { status: L }) : void 0,
                          disabled: A,
                          leadingContent: (0, $.jsx)(P, { className: `icon-base` }),
                          label: (0, $.jsx)(W, {
                          ...
                          trailingControl:
                            g.toolsAndSetupTooltip == null
                              ...
                              : (0, $.jsx)(or, {
                                  ...
                                  tooltip: g.toolsAndSetupTooltip.text,
                                }),
                          className: _r,
                          checkboxClassName: gr,
                          controlPlacement: `right`,
                          onCheckedChange: (e) => {
                            (C((t) =>
                              pr({
                                current: t,
                                items: g.customizeItems,
                                group: `toolsAndSetup`,
                                checked: e,
                              }),
                            ),
                    ...
                    g.projectCount > 0
                      ? (0, $.jsx)(Ot, {
                          ...
                          checked: F,
                          control: j ? (0, $.jsx)(ir, { status: R }) : void 0,
                          disabled: A,
                    ...
                    g.recentChatCount > 0
                      ? (0, $.jsx)(Ot, {
                          ...
                          checked: I,
                          control: j ? (0, $.jsx)(ir, { status: z }) : void 0,
                          disabled: A || g.chatChoiceKey == null,
                          leadingContent: (0, $.jsx)(Tt, { className: `icon-base` }),
                          label: (0, $.jsx)(W, {
                            id: `electron.onboarding.welcomeV2.externalAgentImport.recentChats.title`,
                            defaultMessage: `Chat sessions ({count})`,
                            description: `Recent chats toggle title`,
                            values: { count: g.recentChatCount },
                          }),
                          description: (0, $.jsx)(W, {
                          ...
                          trailingControl:
                            g.recentChatTooltip == null
                              ...
                              : (0, $.jsx)(or, {
                                  ...
                                  tooltip: g.recentChatTooltip.text,
                                }),
                          className: _r,
                          checkboxClassName: gr,
                          controlPlacement: `right`,
                          onCheckedChange: (e) => {
                            let t = g.chatChoiceKey;
                            t != null &&
                              (C((n) => ({ ...n, [t]: e })),
                              D((n) => {
                                let r = new Set(n);
        ...
        (0, $.jsx)(Nt, {
          ...
          onOpenChange: T,
          onConfirm: (e) => {
            let t = g.customizeItems.filter((t) => E.has(t.id) !== e.has(t.id)).length;
            D(e);
            let n = dr({ current: S, items: g.customizeItems, selectedItemIds: e });
            (C(n), B({ action: `customized`, changedItemsCount: t, ...Z(g, n, f) }));
          },
        }),
        (0, $.jsxs)(`div`, {
          className: u(
  ...
  return O
    ? (0, $.jsx)(Te, { as: `form`, className: `gap-0`, onSubmit: se, children: ce })
    : (0, $.jsx)(`div`, {
        className: `flex w-full max-w-lg flex-col items-center overflow-hidden rounded-2xl p-10`,
        children: ce,
      });
...
function ir(e) {
  ...
  if (n === `complete`) {
    ...
    let n;
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((n = (0, $.jsx)(S, { className: `h-5 w-5 text-token-charts-green` })), (t[3] = n))
      : (n = t[3]);
    let i;
    return (
      t[4] === e
  ...
  let a;
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, $.jsx)(de, { className: `h-5 w-5` })), (t[8] = a))
    : (a = t[8]);
  let o;
  return (
    t[9] === i
...
function or(e) {
  let t = (0, mr.c)(6),
    ...
    i;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = (0, $.jsx)(L, { className: `size-4`, "aria-hidden": `true` })), (t[0] = i))
    : (i = t[0]);
  let a;
  t[1] === n
    ? (a = t[2])
