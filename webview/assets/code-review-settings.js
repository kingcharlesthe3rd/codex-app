...
import { br as a, xr as o } from "./app-initial~app-main~onboarding-page.js";
import {
  BC as s,
  Gx as c,
  RC as l,
...
import { dt as v, lt as y } from "./app-initial~app-main~automations-page.js";
import {
  Er as b,
  F as x,
  P as S,
...
function L(e) {
  ...
  t[7] !== n || t[8] !== f || t[9] !== p || t[10] !== g
    ? ((_ = (0, B.jsx)(a, {
        label: u,
        description: d,
        control: (0, B.jsx)(S, { ariaLabel: f, checked: p, disabled: n, onChange: g }),
      })),
      (t[7] = n),
      (t[8] = f),
      (t[9] = p),
  ...
  let x;
  t[16] !== n || t[17] !== b
    ? ((x = (0, B.jsx)(A, { disabled: n, children: b })), (t[16] = n), (t[17] = b), (t[18] = x))
    : (x = t[18]);
  let T;
  t[19] === o
    ? (T = t[20])
  ...
  return (
    t[41] !== E || t[42] !== P || t[43] !== F || t[44] !== _
      ? ((I = (0, B.jsxs)(M, {
          children: [
            l,
            (0, B.jsx)(M.Content, { children: (0, B.jsxs)(O, { children: [_, E, P, F] }) }),
          ],
        })),
        (t[41] = E),
        (t[42] = P),
