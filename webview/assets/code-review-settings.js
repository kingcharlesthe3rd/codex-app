...
import { Ur as T, Wr as E } from "./app-initial~app-main~onboarding-page~profile.js";
import {
  H as D,
  K as O,
...
function L(e) {
  ...
  t[5] === a
    ...
    : ((h = (e) => {
      ...
      (t[6] = h));
  let _;
  t[7] !== n || t[8] !== p || t[9] !== m || t[10] !== h
    ? ((_ = (0, B.jsx)(T, {
        label: u,
        description: f,
        control: (0, B.jsx)(d, { ariaLabel: p, checked: m, disabled: n, onChange: h }),
      })),
      (t[7] = n),
      (t[8] = p),
      (t[9] = m),
  ...
  let C;
  t[16] !== n || t[17] !== S
    ? ((C = (0, B.jsx)(D, { disabled: n, children: S })), (t[16] = n), (t[17] = S), (t[18] = C))
    : (C = t[18]);
  let w;
  t[19] === a
    ? (w = t[20])
  ...
  t[21] !== C || t[22] !== w
    ? ((E = (0, B.jsx)(T, {
        label: b,
        description: x,
        control: (0, B.jsx)(c, { triggerButton: C, children: w }),
      })),
      (t[21] = C),
      (t[22] = w),
      (t[23] = E))
  ...
  return (
    t[41] !== E || t[42] !== P || t[43] !== F || t[44] !== _
      ? ((I = (0, B.jsxs)(M, {
          children: [
            l,
            (0, B.jsx)(M.Content, { children: (0, B.jsxs)(A, { children: [_, E, P, F] }) }),
          ],
        })),
        (t[41] = E),
        (t[42] = P),
