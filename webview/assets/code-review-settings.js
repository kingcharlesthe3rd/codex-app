...
import { gt as y, vt as b } from "./app-initial~app-main~automations-page.js";
import {
  h as x,
  p as S,
} from "./app-initial~app-main~login-route~codex-mobile-page~remote-connections-settings.js";
import { Mt as C, jt as w } from "./app-initial~app-main~onboarding-page.js";
import {
  n as T,
  t as E,
...
function L(e) {
  ...
  t[5] === a
    ...
    : ((g = (e) => {
      ...
      (t[6] = g));
  let y;
  t[7] !== n || t[8] !== d || t[9] !== m || t[10] !== g
    ? ((y = (0, B.jsx)(w, {
        label: l,
        description: u,
        control: (0, B.jsx)(p, { ariaLabel: d, checked: m, disabled: n, onChange: g }),
      })),
      (t[7] = n),
      (t[8] = d),
      (t[9] = m),
  ...
  t[12] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : ((b = t[12]), (x = t[13]));
  let S;
  t[14] === s ? (S = t[15]) : ((S = R(s)), (t[14] = s), (t[15] = S));
  let C;
  t[16] !== n || t[17] !== S
    ? ((C = (0, B.jsx)(O, { disabled: n, children: S })), (t[16] = n), (t[17] = S), (t[18] = C))
    : (C = t[18]);
  let T;
  t[19] === a
    ? (T = t[20])
  ...
  t[21] !== C || t[22] !== T
    ? ((E = (0, B.jsx)(w, {
        label: b,
        description: x,
        control: (0, B.jsx)(f, { triggerButton: C, children: T }),
      })),
      (t[21] = C),
      (t[22] = T),
      (t[23] = E))
  ...
  let I;
  return (
    t[41] !== E || t[42] !== P || t[43] !== F || t[44] !== y
      ? ((I = (0, B.jsxs)(M, {
          children: [
            c,
            (0, B.jsx)(M.Content, { children: (0, B.jsxs)(A, { children: [y, E, P, F] }) }),
          ],
        })),
        (t[41] = E),
        (t[42] = P),
