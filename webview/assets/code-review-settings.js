...
import { Fn as x, In as S } from "./app-initial~app-main~onboarding-page-CgNc-Bk2.js";
import {
  H as C,
  R as w,
...
function L(e) {
  ...
  t[7] !== n || t[8] !== d || t[9] !== p || t[10] !== h
    ? ((_ = (0, B.jsx)(x, {
        label: l,
        description: u,
        control: (0, B.jsx)(m, { ariaLabel: d, checked: p, disabled: n, onChange: h }),
      })),
      (t[7] = n),
      (t[8] = d),
      (t[9] = p),
  ...
  let T;
  t[16] !== n || t[17] !== C
    ? ((T = (0, B.jsx)(w, { disabled: n, children: C })), (t[16] = n), (t[17] = C), (t[18] = T))
    : (T = t[18]);
  let E;
  t[19] === a
    ? (E = t[20])
  ...
  t[28] === a
    ...
    : ((N = (e) => {
      ...
      (t[29] = N));
  let P;
  t[30] !== n || t[31] !== r.exhaustive_code_review || t[32] !== M || t[33] !== N
    ? ((P = (0, B.jsx)(x, {
        label: k,
        description: j,
        control: (0, B.jsx)(m, {
  ...
  return (
    t[41] !== D || t[42] !== P || t[43] !== F || t[44] !== _
      ? ((I = (0, B.jsxs)(O, {
          children: [
            c,
            (0, B.jsx)(O.Content, { children: (0, B.jsxs)(A, { children: [_, D, P, F] }) }),
          ],
        })),
        (t[41] = D),
        (t[42] = P),
