import { c as e, h as t, i as n } from "./chunk-20.js";
import { t as r } from "./clone-3.js";
import { t as i } from "./graphlib-3.js";
import { t as a } from "./src-3.js";
import { t as o } from "./line-DIsP-Yv_.js";
import { h as s } from "./step.js";
import { n as c, r as l } from "./chunk-70.js";
import { s as u } from "./invert.js";
import { t as d } from "./channel-4.js";
import { E as f, I as p, a as m, b as h, c as g, h as _, s as v, y } from "./chunk-3.js";
import "./dist-5.js";
import "./marked.esm.js";
import { a as b, n as x } from "./chunk-10.js";
import { t as S } from "./chunk-92.js";
import { t as C } from "./chunk-9.js";
import { t as w } from "./chunk-79.js";
var T = (function () {
        ...
        switch (i) {
          ...
          case 28:
            (r.getLogger().debug(`Rule: blockStatement : `, a[s - 2], a[s - 1], a[s]),
              (this.$ = { id: r.generateId(), type: `composite`, label: ``, children: a[s - 1] }));
            break;
          case 29:
...
Expecting ` +
          ...
          if (T[0] instanceof Array && T.length > 1)
            throw Error(`Parse Error: multiple actions possible at state: ` + w + `, token: ` + S);
          switch (T[0]) {
            case 1:
              (n.push(S),
                i.push(h.yytext),
            ...
            case 2:
              if (
                ...
                (E = this.performAction.apply(D, [s, u, l, g.yy, T[1], i, a].concat(m))),
                E !== void 0)
              )
                return E;
              (k &&
                ((n = n.slice(0, -1 * k * 2)), (i = i.slice(0, -1 * k)), (a = a.slice(0, -1 * k))),
...
` +
      ...
      next: c(function () {
        ...
        for (var i = this._currentRules(), a = 0; a < i.length; a++)
          if (((n = this._input.match(this.rules[i[a]])), n && (!t || n[0].length > t[0].length))) {
      ...
      performAction: c(function (e, t, n, r) {
        switch (n) {
          ...
          case 95:
            return (e.getLogger().debug(`Lex: LINK`, t.yytext), 15);
          case 96:
            return (e.getLogger().debug(`Lex: START_LINK`, t.yytext), this.pushState(`LLABEL`), 16);
          case 97:
            return (e.getLogger().debug(`Lex: START_LINK`, t.yytext), this.pushState(`LLABEL`), 16);
          case 98:
            return (e.getLogger().debug(`Lex: START_LINK`, t.yytext), this.pushState(`LLABEL`), 16);
          ...
          case 100:
            return (
              e.getLogger().debug(`Lex: Starting string`), this.pushState(`string`), `LINK_LABEL`
            );
          case 101:
    ...
    for (let e of n) {
      if (
        (typeof a == `number` &&
          ...
          e.widthInColumns > a &&
          l.warn(`Block ${e.id} width ${e.widthInColumns} exceeds configured column width ${a}`),
        (e.label &&= ne(e.label)),
        e.type === `classDef`)
      ) {
        re(e.id, e.css);
...
var ve = c((e) => {
  ...
  for (let r of e.children) {
    let { width: i, height: a, x: o, y: s } = r.size ?? { width: 0, height: 0, x: 0, y: 0 };
    (l.debug(
      ...
      r.type !== `space` && (i > t && (t = i / (e.widthInColumns ?? 1)), a > n && (n = a)));
  }
  ...
  if (e.children?.length > 0) {
    ...
    for (let t of e.children)
      t.size &&
        ...
        (t.size.width = i * (t.widthInColumns ?? 1) + L * ((t.widthInColumns ?? 1) - 1)),
        (t.size.height = a),
        (t.size.x = 0),
        (t.size.y = 0),
        l.debug(
    ...
    if (f < n) {
      ...
      for (let n of e.children)
        n.size && ((n.size.width = t), (n.size.height = o), (n.size.x = 0), (n.size.y = 0));
    }
    if (
      (l.debug(
...
function z(e, t) {
  ...
  let n = e.columns ?? -1;
  if (
    (l.debug(`layoutBlocks columns abc95`, e.id, `=>`, n, e), e.children && e.children.length > 0)
  ) {
    ...
    for (let r of e.children) {
      ...
      (n > 0 && (p = Math.min(p, n - (a % n))), (a += p), l.debug(`abc88 columnsPos`, r, a));
    }
  }
  l.debug(
...
c(z, `layoutBlocks`);
function B(e, { minX: t, minY: n, maxX: r, maxY: i } = { minX: 0, minY: 0, maxX: 0, maxY: 0 }) {
  if (e.size && e.id !== `root`) {
  ...
  if (e.children)
    for (let a of e.children)
      ({ minX: t, minY: n, maxX: r, maxY: i } = B(a, { minX: t, minY: n, maxX: r, maxY: i }));
...
c(V, `applyStyle`);
function be(e, t) {
  let n = a(document.createElementNS(`http://www.w3.org/2000/svg`, `foreignObject`)),
...
var H = c(async (e, t, r, i) => {
  ...
  we = c(async (e, t) => {
    let n = h(),
      ...
      i =
        t.labelType === `markdown`
          ? x(e, t.label, { style: t.labelStyle, useHtmlLabels: r, addSvgBackground: !0 }, n)
    ...
    (s.attr(`transform`, `translate(` + -c.width / 2 + `, ` + -c.height / 2 + `)`),
      (U[t.id] = o),
      (t.width = c.width),
      (t.height = c.height));
    let l;
...
var Te = c((e, n) => {
    ...
    if (e.startLabelLeft) {
      let n = W[e.id].startLeft,
        ...
        a = e.y;
      if (r) {
        let n = t.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, `start_left`, r);
        ((i = n.x), (a = n.y));
      }
    ...
    if (e.startLabelRight) {
      let n = W[e.id].startRight,
        ...
        a = e.y;
      if (r) {
        let n = t.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, `start_right`, r);
        ((i = n.x), (a = n.y));
      }
      n.attr(`transform`, `translate(${i}, ${a})`);
    }
    if (e.endLabelLeft) {
      let n = W[e.id].endLeft,
        ...
        a = e.y;
      if (r) {
        let n = t.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, `end_left`, r);
        ((i = n.x), (a = n.y));
      }
      n.attr(`transform`, `translate(${i}, ${a})`);
    }
    if (e.endLabelRight) {
      let n = W[e.id].endRight,
        ...
        a = e.y;
      if (r) {
        let n = t.calcTerminalLabelPosition(e.arrowTypeEnd ? 10 : 0, `end_right`, r);
        ((i = n.x), (a = n.y));
      }
      n.attr(`transform`, `translate(${i}, ${a})`);
    }
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    if (Math.abs(i - t.y) * o > Math.abs(r - t.x) * c) {
      ...
      s = (d * e) / u;
      let r = { x: n.x < t.x ? n.x + s : n.x - d + s, y: n.y < t.y ? n.y + u - e : n.y - u + e };
      return (
        s === 0 && ((r.x = t.x), (r.y = t.y)),
        d === 0 && (r.x = t.x),
        u === 0 && (r.y = t.y),
      ...
      return (
        l.debug(`sides calc abc89, Q ${u}, q ${e}, R ${d}, r ${s}`, { _x: i, _y: a }),
        s === 0 && ((i = t.x), (a = t.y)),
        d === 0 && (i = t.x),
        u === 0 && (a = t.y),
        { x: i, y: a }
  ...
  ke = c(function (e, t, n, r, i, a, c) {
    ...
    let S = e
        ...
        .attr(`style`, n.style),
      w = ``;
    ((h().flowchart.arrowMarkerAbsolute || h().state.arrowMarkerAbsolute) && (w = f(!0)),
      xe(S, n, w, c, i));
    let T = {};
...
var K = {
  ...
  q = c(async (e, t, r, i) => {
    ...
    return (
      l
        ? d.attr(`transform`, `translate(` + -v.width / 2 + `, ` + -v.height / 2 + `)`)
...
var Ue = c(async (e, t) => {
  ...
  X = c((e, t) => `${t || `node default`}${We(e.classes)} ${We(e.class)}`, `getClassesFromNode`),
  Ge = c(async (e, t) => {
...
var at = c(async (e, t) => {
    ...
    let r = e
      ...
      u = ``;
    ((u = typeof c == `object` ? c[0] : c), l.info(`Label text abc79`, u, c, typeof c == `object`));
    ...
    let p = c.slice(1, c.length),
      m = d.getBBox(),
      g = s.node().appendChild(await H(p.join ? p.join(`<br/>`) : p, t.labelStyle, !0, !0));
    if (_(h().flowchart.htmlLabels)) {
      let e = g.children[0],
        t = a(g);
      ((f = e.getBoundingClientRect()), t.attr(`width`, f.width), t.attr(`height`, f.height));
    ...
    return (
      ...
      a(d).attr(
        `transform`,
        `translate( ` + (f.width < m.width ? 0 : -(m.width - f.width) / 2) + `, 0)`,
      ),
      (f = s.node().getBBox()),
      s.attr(`transform`, `translate(` + -f.width / 2 + `, ` + (-f.height / 2 - v + 3) + `)`),
      i
  ...
  st = c(async (e, t) => {
    let { shapeSvg: n, bbox: r, halfPadding: i } = await q(e, t, X(t, void 0), !0),
  ...
  ft = {
    ...
    class_box: c(async (e, t) => {
      ...
      let i = e
        ...
        m = t.classData.annotations[0] ? `«` + t.classData.annotations[0] + `»` : ``,
      ...
      (t.classData.members.forEach(async (e) => {
        let n = e.getDisplayDetails(),
          r = n.displayText;
        h().flowchart.htmlLabels && (r = r.replace(/</g, `&lt;`).replace(/>/g, `&gt;`));
        let i = d.node().appendChild(await H(r, n.cssStyle ? n.cssStyle : t.labelStyle, !0, !0)),
          o = i.getBBox();
        if (_(h().flowchart.htmlLabels)) {
          let e = i.children[0],
            t = a(i);
      ...
      if (
        ...
        let e = (l - v.width) / 2;
        (a(g).attr(`transform`, `translate( ` + ((-1 * l) / 2 + e) + `, ` + (-1 * u) / 2 + `)`),
          (f = v.height + 4));
      }
      let w = (l - x.width) / 2;
      return (
        ...
        (f += 8),
        S.forEach((e) => {
          a(e).attr(`transform`, `translate( ` + -l / 2 + `, ` + ((-1 * u) / 2 + f + 8 / 2) + `)`);
          let t = e?.getBBox();
          f += (t?.height ?? 0) + 4;
        }),
        (f += 8),
        ...
        (f += 8),
        C.forEach((e) => {
          a(e).attr(`transform`, `translate( ` + -l / 2 + `, ` + ((-1 * u) / 2 + f) + `)`);
          let t = e?.getBBox();
          f += (t?.height ?? 0) + 4;
        }),
        o
  ...
  pt = c(async (e, t, n) => {
    ...
    return (
      ...
      (Q[t.id] = r),
      t.haveCallback && Q[t.id].attr(`class`, Q[t.id].attr(`class`) + ` clickable`),
      r
    );
  }, `insertNode`),
  mt = c((e) => {
...
async function bt(e, t, n, r, a) {
  ...
  for (let e of n)
    e.size &&
      o.setNode(e.id, { width: e.size.width, height: e.size.height, intersect: e.intersect });
  for (let n of t)
    if (n.start && n.end) {
    ...
    draw: c(async function (e, t, n, r) {
      ...
      if ((await yt(h, f, s), await bt(h, m, p, s, t), _)) {
        ...
        (g(d, n, r, !!i),
          ...
          d.attr(`viewBox`, `${e.x - 5} ${e.y - 5} ${e.width + 10} ${e.height + 10}`));
      }
    }, `draw`),
