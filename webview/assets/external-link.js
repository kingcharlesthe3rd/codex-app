...
import { Xn as i, Zn as a, vr as o, xr as s } from "./src-2.js";
import { r as c } from "./lib.js";
import { t as l } from "./tooltip.js";
import { t as u } from "./context-menu.js";
import { I as d, M as f } from "./rpc-Hf-fxjh7.js";
...
function C(e) {
  if (
    e.length > 255 ||
    e.length === 0 ||
    (!S(e.charCodeAt(0)) && e.charCodeAt(0) !== 46 && e.charCodeAt(0) !== 95)
  )
    return !1;
  let t = -1,
    n = -1,
  ...
  for (let i = 0; i < r; i += 1) {
    ...
    if (r === 46) {
      ...
      t = i;
    } else if (!(S(r) || r === 45 || r === 95)) return !1;
    n = r;
  }
  ...
  return typeof e != `string` ||
    (a.extractHostname
      ? a.mixedInputs
        ...
        : (i.hostname = y(e, !1))
      : (i.hostname = e),
    a.detectIp && i.hostname !== null && ((i.isIp = ee(i.hostname)), i.isIp))
    ? i
    : a.validateHostname && a.extractHostname && i.hostname !== null && !C(i.hostname)
      ? ((i.hostname = null), i)
      : (t === 0 ||
          i.hostname === null ||
          (n(i.hostname, a, i), t === 2 || i.publicSuffix === null) ||
          ((i.domain = _(i.publicSuffix, i.hostname, a)), t === 3 || i.domain === null) ||
          ((i.subdomain = ne(i.hostname, i.domain)), t === 4) ||
...
var k = (function () {
  ...
  A = (function () {
    let e = [1, {}],
      ...
      b = [1, { co: t }],
      x = [0, { objects: t }],
      ee = [2, { "eu-west-1": t, "us-east-1": t }],
      S = [0, { lb: t, s3: t, website: t }],
      C = [2, { nodes: t }],
      w = [0, { my: t }],
      T = [0, { s3: t, "s3-accesspoint": t, "s3-website": t }],
      ...
      0,
      {
        ...
        cloud: [
          1,
          {
            ...
            jote: t,
            jotelulu: t,
            k2: [0, { elastic: t, "ru-msk": S, "ru-spb": S, s3: t, website: t }],
            kuleuven: t,
            laravel: t,
            linkyard: t,
            magentosite: i,
...
`),
  ...
  let a = V(i);
  if (oe(a)) return `http://${i}`;
  if (B(i, a)) return `https://${i}`;
...
function R(e) {
  ...
  return (n.protocol !== `http:` && n.protocol !== `https:`) ||
    ...
    n.port.length > 0
    ? null
    : ((n.hostname = N), n.searchParams.append(ie, P), n.toString());
}
function z(e) {
...
function se(e) {
  let t = re(e, { allowPrivateDomains: !0 });
...
function G({ conversationId: e, url: t, source: n, initiator: i }) {
  let a = W(t);
  return a == null
    ? !1
...
function ue({ href: e, isBrowserSidebarEnabled: t }) {
  let n = q(e);
  return t && le(e) && (ce(e) || de(n));
}
function J({ conversationId: e, href: t, initiator: n }) {
  let i = q(t),
    a = de(i);
  return [
    {
      ...
      onSelect: () => {
        ...
        G({ conversationId: e, url: t, source: `manual`, initiator: n });
      },
    },
    {
...
function de(e) {
  try {
    ...
    return (t === `http:` || t === `https:`) && i(e);
  } catch {
    return !1;
  }
}
function fe({ event: e, href: t, initiator: n, originHostId: i }) {
  return le(t)
    ? (e.preventDefault(),
      r.dispatchMessage(`open-in-browser`, {
        disposition: Y(e),
...
function $(e) {
  ...
  t[11] !== a || t[12] !== o || t[13] !== c
    ? ((m = (e) => {
        fe({ event: e, href: a, initiator: o, originHostId: c });
      }),
      (t[11] = a),
      (t[12] = o),
      (t[13] = c),
  ...
  let g = h,
    _;
  t[20] !== g || t[21] !== f || t[22] !== p
    ? ((_ = f == null ? g : (0, Z.jsx)(l, { delayDuration: p, tooltipContent: f, children: g })),
      (t[20] = g),
      (t[21] = f),
      (t[22] = p),
      (t[23] = _))
    : (_ = t[23]);
  let v = _;
  if (!ue({ href: a, isBrowserSidebarEnabled: s })) return v;
  let y = r ?? o,
    b;
  t[24] !== i || t[25] !== a || t[26] !== y
    ? ((b = J({ conversationId: i, href: a, initiator: y })),
      (t[24] = i),
      (t[25] = a),
      (t[26] = y),
      (t[27] = b))
  ...
  return (
    t[28] !== v || t[29] !== b
      ? ((x = (0, Z.jsx)(u, { items: b, children: v })), (t[28] = v), (t[29] = b), (t[30] = x))
      : (x = t[30]),
    x
  );
}
export { F as a, G as i, ue as n, ae as o, J as r, re as s, Q as t };
