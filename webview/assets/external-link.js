...
import { Lr as i, Pr as a, cr as o, sr as s } from "./src-1.js";
import { r as c } from "./lib-1.js";
import { t as l } from "./tooltip-B.js";
import { t as u } from "./context-menu.js";
import { L as d, M as f } from "./rpc-1.js";
import { t as p } from "./browser-sidebar-availability.js";
...
function _(e, t, n) {
  if (n.validHosts !== null) {
    let e = n.validHosts;
    for (let n of e) if (h(t, n)) return n;
  }
  let r = 0;
  if (t.startsWith(`.`)) for (; r < t.length && t[r] === `.`; ) r += 1;
  return e.length === t.length - r ? null : g(t, e);
}
function v(e, t) {
  ...
  return typeof e != `string` ||
    (a.extractHostname
      ? a.mixedInputs
        ...
        : (i.hostname = y(e, !1))
      : (i.hostname = e),
    a.detectIp && i.hostname !== null && ((i.isIp = S(i.hostname)), i.isIp))
    ? i
    : a.validateHostname && a.extractHostname && i.hostname !== null && !w(i.hostname)
      ? ((i.hostname = null), i)
      : (t === 0 ||
          i.hostname === null ||
          (n(i.hostname, a, i), t === 2 || i.publicSuffix === null) ||
          ((i.domain = _(i.publicSuffix, i.hostname, a)), t === 3 || i.domain === null) ||
          ((i.subdomain = te(i.hostname, i.domain)), t === 4) ||
          (i.domainWithoutSuffix = v(i.domain, i.publicSuffix)),
        i);
}
function k(e, t, n) {
...
var A = (function () {
  ...
  j = (function () {
    let e = [1, {}],
      ...
      ee = [0, { s3: t, "s3-accesspoint": t }],
      te = [0, { direct: t }],
      D = [0, { "webview-assets": t }],
      O = [0, { vfs: t, "webview-assets": t }],
      k = [
        0,
        {
          "execute-api": t,
      ...
      R = [0, { app: t }],
      z = [0, { site: t }],
      B = [1, { com: e, edu: e, net: e, org: e }],
      V = [0, { j: t }],
      H = [0, { dyn: t }],
      se = [2, { web: t }],
      U = [1, { co: e, com: e, edu: e, gov: e, net: e, org: e }],
      ce = [0, { p: t }],
      W = [0, { user: t }],
      le = [1, { ms: t }],
      G = [0, { cdn: t }],
      ...
      de = [0, { cust: t }],
      q = [0, { s3: t }],
      fe = [1, { biz: e, com: e, edu: e, gov: e, info: e, net: e, org: e }],
      J = [0, { ipfs: t }],
      Y = [1, { framer: t }],
      X = [0, { forgot: t }],
      Z = [0, { core: [0, { blob: t, file: t, web: t }], servicebus: t }],
      Q = [1, { gs: e }],
      pe = [0, { nes: e }],
      $ = [1, { k12: e, cc: e, lib: e }],
      me = [1, { cc: e }],
    ...
    return [
      0,
      {
        ...
        name: [1, { her: X, his: X, ispmanager: t, keenetic: t }],
        nc: [1, { asso: e, nom: e }],
        ne: e,
        net: [
          1,
        ...
        org: [
          1,
          {
            ...
            fedorainfracloud: t,
            fedorapeople: t,
            fedoraproject: [0, { cloud: t, os: R, stg: [0, { os: R }] }],
            freedesktop: t,
            hatenadiary: t,
            hepforge: t,
            "in-dsl": t,
        ...
        cloud: [
          1,
          {
            ...
            jote: t,
            jotelulu: t,
            k2: [0, { elastic: t, "ru-msk": C, "ru-spb": C, s3: t, website: t }],
            kuleuven: t,
            laravel: t,
            linkyard: t,
            magentosite: i,
        ...
        edeka: e,
        education: b,
        email: [1, { crisp: [0, { on: t }], intouch: t, tawk: ce, tawkto: ce }],
        emerck: e,
        energy: e,
        engineer: e,
        engineering: e,
...
`),
  ...
  if (/^[a-z][a-z0-9+.-]*:\/\//i.test(i)) return n ? (R(i) ?? i) : i;
  if (/^about:/i.test(i)) return i;
  if (f(i) && !i.startsWith(`//`) && !(i.startsWith(`/`) && r)) {
    let e = d(``, i),
      t = new URL(`file:///`);
    if (a(e)) {
      let n = e.indexOf(`/`, 2);
  ...
  let o = V(i);
  if (oe(o)) return `http://${i}`;
  if (B(i, o)) return `https://${i}`;
  if (/\s/.test(i)) return U(i);
  if (n) {
    let e = R(i);
    if (e != null) return e;
  }
...
function ae(e) {
  ...
  try {
    let e = new URL(t);
    if (e.protocol === `file:`) {
      let t = i(decodeURIComponent(e.pathname));
...
function oe(e) {
  return e != null && L(e.hostname);
}
function I(e) {
  return e.protocol !== `http:` && e.protocol !== `https:` ? !1 : L(e.hostname);
}
function L(e) {
  return o(e);
}
function R(e) {
  ...
  return (n.protocol !== `http:` && n.protocol !== `https:`) ||
    ...
    n.port.length > 0
    ? null
    : ((n.hostname = re), n.searchParams.append(ie, P), n.toString());
}
function z(e) {
...
function B(e, t) {
  return /\s/.test(e) || t == null
    ...
    : t.hostname.startsWith(`[`)
      ? H(t.hostname)
      : t.hasPort || t.hostname.startsWith(`www.`) || H(t.hostname) || se(t.hostname);
}
function V(e) {
  let t = e.search(/[/?#]/),
    n = t === -1 ? e : e.slice(0, t);
...
function se(e) {
  let t = ne(e, { allowPrivateDomains: !0 });
...
function le({ conversationId: e, url: t, source: n, initiator: i }) {
  let a = W(t);
  return a == null
    ? !1
...
function de({ href: e, isBrowserSidebarEnabled: t }) {
  let n = K(e);
  return t && ue(e) && (ce(e) || fe(n));
}
function q({ conversationId: e, href: t, initiator: n }) {
  let i = K(t),
    a = fe(i);
  return [
    {
      ...
      onSelect: () => {
        ...
        le({ conversationId: e, url: t, source: `manual`, initiator: n });
      },
    },
    {
      ...
      onSelect: () => {
        r.dispatchMessage(`open-in-browser`, { url: i, useExternalBrowser: !0 });
      },
    },
...
function fe(e) {
  try {
    ...
    return (t === `http:` || t === `https:`) && s(e);
  } catch {
    return !1;
  }
}
function J({ event: e, href: t, initiator: n, openTarget: i, originHostId: a }) {
  return ue(t)
    ? (e.preventDefault(),
      r.dispatchMessage(`open-in-browser`, {
        disposition: Y(e),
...
function Y(e) {
  if (e.button === 1 || e.metaKey || e.ctrlKey) return `new-tab`;
}
var X = t(),
  Z = e();
function Q(e) {
  ...
  let n;
  return (t[3] === e ? (n = t[4]) : ((n = (0, Z.jsx)(pe, { ...e })), (t[3] = e), (t[4] = n)), n);
}
function pe(e) {
  let t = (0, X.c)(4),
    r = n(p),
  ...
  return (
    t[0] !== r || t[1] !== e || t[2] !== i
      ? ((a = (0, Z.jsx)($, { ...e, conversationId: i, isBrowserSidebarEnabled: r })),
        (t[0] = r),
        (t[1] = e),
        (t[2] = i),
        (t[3] = a))
...
function $(e) {
  ...
  t[0] === e
    ...
    : (({
      ...
      (t[11] = m));
  let h;
  t[12] !== a || t[13] !== o || t[14] !== c || t[15] !== d
    ? ((h = (e) => {
        J({ event: e, href: a, initiator: o, openTarget: c, originHostId: d });
      }),
      (t[12] = a),
      (t[13] = o),
      (t[14] = c),
  ...
  t[17] === g
    ...
    : ((_ = (e) => {
      ...
      (t[18] = _));
  let v;
  t[19] !== n || t[20] !== a || t[21] !== g || t[22] !== f || t[23] !== _
    ? ((v = (0, Z.jsx)(`a`, {
        ...f,
        href: a,
  ...
  let y = v,
    b;
  t[25] !== y || t[26] !== p || t[27] !== m
    ? ((b = p == null ? y : (0, Z.jsx)(l, { delayDuration: m, tooltipContent: p, children: y })),
      (t[25] = y),
      (t[26] = p),
      (t[27] = m),
      (t[28] = b))
    : (b = t[28]);
  let x = b;
  if (!de({ href: a, isBrowserSidebarEnabled: s })) return x;
  let S = r ?? o,
    C;
  t[29] !== i || t[30] !== a || t[31] !== S
    ? ((C = q({ conversationId: i, href: a, initiator: S })),
      (t[29] = i),
      (t[30] = a),
      (t[31] = S),
      (t[32] = C))
  ...
  return (
    t[33] !== x || t[34] !== C
      ? ((w = (0, Z.jsx)(u, { items: C, children: x })), (t[33] = x), (t[34] = C), (t[35] = w))
      : (w = t[35]),
    w
  );
}
export { le as a, ne as c, q as i, J as n, F as o, de as r, ae as s, Q as t };
