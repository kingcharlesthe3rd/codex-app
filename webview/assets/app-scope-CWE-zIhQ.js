...
function _e(e) {
  let t = !1,
    ...
    l = () => ce.isFocused() && (e.networkMode === `always` || pe.isOnline()) && e.canRun(),
    u = () => he(e.networkMode) && e.canRun(),
    f = (e) => {
      a() || (r?.(), i.resolve(e));
    },
    p = (e) => {
...
var ve = class {
    ...
    updateGcTime(e) {
      this.gcTime = Math.max(this.gcTime || 0, e ?? (d ? 1 / 0 : 300 * 1e3));
    }
    clearGcTimeout() {
    ...
    async fetch(e, t) {
      ...
      (this.options.behavior?.onFetch(a, this),
        ...
        (this.#i = _e({
          ...
          fn: a.fetchFn,
          onCancel: (e) => {
            (e instanceof ge && e.revert && this.setState({ ...this.#t, fetchStatus: `idle` }),
              n.abort());
          },
          onFail: (e, t) => {
    ...
    #s(e) {
      ((this.state = ((t) => {
        switch (e.type) {
          ...
          case `fetch`:
            return { ...t, ...be(t.data, this.options), fetchMeta: e.meta ?? null };
          case `success`:
            let n = {
              ...t,
              data: e.data,
...
var Se = class extends s {
  ...
  #g() {
    ...
    if (d || this.#r.isStale || !m(e)) return;
  ...
  #v(e) {
    (this.#x(),
      (this.#p = e),
      !(d || _(this.options.enabled, this.#t) === !1 || !m(this.#p) || this.#p === 0) &&
      ...
      (i?.isPlaceholderData && t.placeholderData === o?.placeholderData
        ...
        : (e =
            typeof t.placeholderData == `function`
              ...
              : t.placeholderData),
        e !== void 0 && ((m = `success`), (d = O(i?.data, e, t)), (u = !0)));
    }
...
function Ee(e, t, n, r) {
  return (
    (e !== t || _(r.enabled, e) === !1) && (!n.suspense || e.state.status !== `error`) && De(e, n)
  );
}
function De(e, t) {
...
function Ie(e) {
  return (
    (e.i ||= A()), (e.r ||= A()), (e.c ||= A()), (e.m ||= A()), (e.u ||= A()), (e.f ||= Fe()), e
  );
}
var Le = (e, t, ...n) => t.read(...n),
  Re = (e, t, ...n) => t.write(...n),
  ze = (e, t) => t.INTERNAL_onInit?.call(t, e),
  Be = (e, t, n) => t.onMount?.call(t, n),
  Ve = (e, t) => {
    var n;
    let r = j(e),
      i = r[0],
  ...
  Ue = (e) => {
    ...
    for (; d.length; ) {
      ...
      l.add(t);
      for (let e of Pe(t, i, n)) l.has(e) || d.push(e);
    }
  ...
  We = (e, t) => {
    ...
    let x = !0,
      ...
      te = {
        get signal() {
          return ((E ||= new AbortController()), E.signal);
        },
        get setSelf() {
          return (
            !D &&
    ...
    try {
      ...
      ((x = !1), y.n !== O && ne && (o.set(t, y.n), s.add(t), (r = c.c) == null || r.call(c, t)));
    }
  },
  Ge = (e, t) => {
    let n = j(e),
  ...
  Ke = (e, t, ...n) => {
    let r = j(e),
      ...
      v = (n, ...r) => {
        ...
        try {
          if (n === t) {
            if (!ke(n)) throw Error(`atom not writable`);
            let t = u.n,
              s = r[0];
            (m(e, n, s),
              p(e, n),
  ...
  Xe = (e, t, n) => {
    let r = j(e),
      ...
      s = `v` in o,
      c = o.v;
    if (Me(n)) for (let r of o.d.keys()) Ne(t, n, i(e, r));
    ((o.v = n), delete o.e, (!s || !Object.is(c, o.v)) && (++o.n, Me(c) && a(e, c)));
  },
  Ze = (e, t) => {
    let n = j(e)[14];
    return k(n(e, t));
...
function it(...e) {
  ...
  return (nt.set(t, Object.freeze(n)), t);
}
var at = 0;
function M(e, t) {
  let n = `atom${++at}`,
  ...
  return (
    typeof e == `function` ? (r.read = e) : ((r.init = e), (r.read = ot), (r.write = st)),
    t && (r.write = t),
    r
  );
}
    ...
    (n.INTERNAL_onInit = (e) => {
      ...
      function l() {
        ...
        let S = (r, ...a) => {
          ...
          try {
            if ((++i, r === n)) {
              if (!ke(r)) throw Error(`atom not writable`);
              let t = o.n,
                n = a[0];
        ...
        S.recurse = (t, ...r) => {
          if (s) {
            if (ft()) throw Error(`set.recurse is not allowed in cleanup`);
            return;
          }
          try {
...
function _t(e, t = dt()) {
  ...
  if (!r) {
    let i = pt(e),
      a = t.sub(i, () => {});
    ((r = () => {
      a &&= (n.delete(e), n.size === 0 && gt.delete(t), void a());
    }),
      n.set(e, r));
  }
  return r;
...
function F(e, t) {
  e != null && (t === `controller` || !vt.has(e)) && vt.set(e, t);
}
function yt(e) {
  return e == null ? void 0 : vt.get(e);
}
function bt(e) {
  let t = N.get(e) ?? 0;
  return (
...
function St(
  ...
  t,
  {
    getEnabledReaderOptions: n,
    getShouldSuppressStaleFetchOnEnable: r,
    isEnabledReaderMounting: i,
    shouldRetainFetchStartedAfterUnmount: a,
  },
) {
  let o = M(0),
    s = M(t),
    ...
    d = M((t) => {
      let n = t(s),
        a = kt(n.defaultQueryOptions(e(t))),
        o = t(c).get(n);
      if (((a._optimisticResults = `optimistic`), o != null)) {
        let e = n.getQueryCache().build(n, a),
          s = P(e);
        Dt(n, o, e);
        let c = typeof a.refetchOnMount == `function` ? a.refetchOnMount(e) : a.refetchOnMount,
          l = i() && (typeof a.enabled == `function` ? a.enabled(e) : a.enabled) !== !1;
        (l && e.state.status === `error` && e.state.data === void 0 && a.retryOnMount === !1
          ? o.setOptions({ ...a, suspense: !0 })
          : l &&
            r(t) &&
            c === !1 &&
            e.state.data !== void 0 &&
            o.setOptions({ ...a, staleTime: `static` }),
          o.setOptions(a));
        let u = P(o.getCurrentQuery());
        o.hasListeners() && u != null && u !== s && F(u, `automatic`);
      }
      return a;
    }),
    f = M((e) => {
      let t = kt(e(s).defaultQueryOptions(n(e)));
    ...
    m = M((e) => {
      ...
      let c = M(n.getCurrentResult());
      return (
        (c.onMount = (e) => {
          let s = n.getCurrentQuery(),
            c = P(s),
            l = bt(s),
            { activeFetchAtMount: u, hadMountedBefore: d } = o.mount(n, c, l.hadMountedReader);
          F(u, `preexisting`);
          let f = a();
          (t.getQueryCache().find({ exact: !0, queryKey: s.queryKey }) !== s && n.setOptions(r),
            n.getOptimisticResult(t.defaultQueryOptions(n.options)),
            e(n.getCurrentResult()));
          let p = n.subscribe(fe.batchCalls(e)),
            m = P(n.getCurrentQuery());
          return (
            m != null && m !== c && F(m, `automatic`),
            wt(n, d, m != null, i),
            () => {
              let e = n.getCurrentQuery(),
                r = P(e);
              (e === s && r != null && r !== c && F(r, `automatic`),
                l.unmount(),
                o.unmount(n),
                Tt({
                  activeFetchAtReaderMount: c,
                  activeFetchAtUnmount: r,
                  client: t,
                  observer: n,
                  queryAtUnmount: e,
                  retainFetchStartedAfterUnmount: f,
                  unsubscribe: p,
                }));
            }
          );
    ...
    g = M((e) => {
      let t = e(p),
        n = e(d),
        r = e(h);
      if (jt({ result: r, query: t.getCurrentQuery(), throwOnError: n.throwOnError }))
        throw r.error;
      return r;
    }),
    _ = M(
      (e) => {
        ...
        let o = r.get(t);
        if ((Ot(o, a) ? (a = o) : r.set(t, a), At(i, a))) return t.fetchOptimistic(i);
        if (jt({ result: a, query: t.getCurrentQuery(), throwOnError: i.throwOnError }))
          throw a.error;
        return a;
      },
      (e, t) => {
  ...
  return Object.assign(_, { rawResultAtom: g });
}
function Ct() {
  let e = new WeakMap(),
    t = new WeakSet(),
  ...
  return {
    mount(r, i, a) {
      let o = e.get(r) ?? 0,
        s = t.has(r);
      t.add(r);
      let c = o === 0 && !n.has(r) && !a && i != null && yt(i) !== `automatic` ? i : void 0;
      return (
        o === 0 &&
          (n.add(r),
          queueMicrotask(() => {
  ...
  !t ||
    ...
    queueMicrotask(() => {
      ...
      if (
        ...
        let n = P(t);
        e.refetch();
        let r = P(e.getCurrentQuery());
        r != null && r !== n && F(r, `automatic`);
      }
    });
}
function Tt({
  ...
  observer: r,
  queryAtUnmount: i,
  retainFetchStartedAfterUnmount: a,
  unsubscribe: o,
}) {
  queueMicrotask(() => {
    let s = r.getCurrentQuery(),
      c = P(s),
      l = yt(c),
      u = xt(s);
    if (
      c == null ||
      u ||
      (!(c != null && l !== `automatic` && !u && (s !== i || c !== t)) &&
        !(a && c != null && c === t && c !== e) &&
        !(l === `controller` || l === `preexisting`))
    ) {
      o();
      return;
    }
  ...
  let r = new Se(e, {
    ...
    a = () => {
      ...
      if (
        e != null &&
        e !== i &&
        (n === `controller` || n === `preexisting` || (n == null && !xt(t)))
      ) {
        if ((I.delete(i), I.has(e))) {
          r();
          return;
        }
        (I.add(e), (i = e), e.then(a, a));
        return;
      }
      (I.delete(i), r());
    };
...
function Dt(e, t, n) {
  ...
  let i = P(r),
    a = yt(i);
  i == null || (a !== `controller` && a !== `preexisting`) || Et(e, r, i);
}
function Ot(e, t) {
...
function jt({ result: e, throwOnError: t, query: n }) {
  return e.isError && !e.isFetching && se(t, [e.error, n]);
}
var L = e(n(), 1),
  Mt = new WeakMap(),
  Nt = new WeakMap(),
...
function Ft(e, t) {
  (e.debugEntries.add(t), Ht(e.store).add(e));
  let n = Mt.get(e.store);
  n?.entries != null && (n.entries.add(t), Wt(n));
}
function It(e) {
  if (e.debugEntries.size === 0) return;
  let t = Mt.get(e.store);
  if (t?.entries != null) {
...
function Ut(e, t) {
  ...
  let n = new Set();
  for (let t of Ht(e)) for (let e of t.debugEntries) n.add(e);
...
var qt = (e, t, n) => (t.has(n) ? t : t.set(n, e())).get(n),
  Jt = new WeakMap(),
  Yt = (e, t, n, r) =>
    qt(
      e,
...
var Zt = (e) => typeof e?.then == `function`;
function Qt(
  e = () => {
    try {
...
var $t = Qt();
function en(e, t, n = $t, r) {
  let i = M(r?.getOnInit ? n.getItem(e, t) : t);
  return (
...
var z = Symbol(`maitai.withQueryReadOptions`);
function B(e, t) {
...
function nn(e, t) {
  let n = M(e);
  return t == null ? n : Xt(n, (e) => e, t);
}
function rn(e) {
  (It(e), zt(e));
  for (let t of e.retainedScopeEntries.values()) for (let { node: e } of t.values()) rn(e);
...
function an(e, t, n, r) {
  return function (i, a, o) {
    if (U(i)) return on(t, e, i, n, hn(r, arguments.length === 2 && W(i) ? a : void 0));
    if (W(i) && arguments.length === 2) {
      let o = a,
        s = i,
        c = q(t, e, s.scope);
      return V(c, G(s, hn(r, o)).resolve(c, e), n);
    }
    if (a !== void 0 || arguments.length >= 2) {
      let s = i,
        c = q(t, e, s.scope);
      return gn(s) ? s.read(c, e, a, n, hn(r, o)) : s.resolve(c, e, a);
    }
    let s = q(t, e, i.scope);
    return V(s, G(i, hn(r, o)).resolve(s, e), n);
  };
}
function on(e, t, n, r, i) {
  ...
  let a = q(e, t, n.scope);
  return V(a, G(n, i).resolve(a, t), r);
}
function sn(e, t) {
...
function ln(e, t) {
  ...
  if (!Array.isArray(e) && !dn(e)) return e;
  let n = dn(e) && t?.excludeFieldsFromKey != null ? new Set(t.excludeFieldsFromKey) : void 0;
  return JSON.stringify(un(e, n));
}
function un(e, t) {
  if (Array.isArray(e)) return e.map((e) => un(e));
  if (!dn(e)) return e;
  let n = {};
  for (let r of Object.keys(e).sort()) t?.has(r) || (n[r] = un(e[r]));
  return n;
}
function dn(e) {
  ...
  return {
    derived: (i, a) => {
      let o,
        s = (c) => {
          let l = nn(
            (r) => i((e) => r(G(e, c).atom), Object.assign(Sn(e.token, t, e, r, c), { key: n })),
            a?.isEqual,
          );
          (B(e, l), R(e, l, `family-derived`, { debugLabel: r, familyKey: n }));
          let u = Object.assign(mn(e, l), {
            [z](e) {
    ...
    signal: (i, a) => {
      let o = tn(
          typeof i == `function` ? i(Object.assign(Sn(e.token, t, e), { key: n })) : i,
          a?.isEqual,
        ),
        s = a?.onMount;
      return (
        s != null &&
          ...
          (o.onMount = (r) =>
            s(
              ...
              Object.assign(X(e.token, t, e), { key: n }),
            ) ?? void 0)),
        R(e, o, `family-signal`, {
          debugLabel: r,
          familyKey: n,
...
function W(e) {
  return typeof e == `object` && !!e && z in e && typeof e[z] == `function`;
}
function G(e, t) {
  return t == null || !W(e) ? e : e[z](t);
}
function hn(e, t) {
...
function _n(e, t) {
  return {
    async cancel(n, r, i, a) {
      let [o, s, c] = vn(e, n, r, i, a);
      await Z(e, o, t).cancel(s, c);
    },
    getData(n, r) {
      return Z(e, K(e, n, r), t).getData();
    },
    getOptions(n, r) {
      return Z(e, K(e, n, r), t).getOptions();
    },
    async fetch(n, r) {
      return Z(e, K(e, n, r), t).fetch();
    },
    async getOrFetch(n, r) {
      return Z(e, K(e, n, r), t).getOrFetch();
    },
    async invalidate(n, r, i, a) {
      let [o, s, c] = vn(e, n, r, i, a);
      await Z(e, o, t).invalidate(s, c);
    },
    setData(n, r, i, a) {
      let [o, s, c] = vn(e, n, r, i, a);
      return Z(e, o, t).setData(s, c);
    },
    snapshot(n, r) {
      return Z(e, K(e, n, r), t);
    },
  };
}
function K(e, t, n) {
  return gn(t) ? t.resolve(e.node, e.chain, n) : t;
}
function vn(e, t, n, r, i) {
  return gn(t) ? [K(e, t, n), r, i] : [K(e, t), n, r];
}
function yn(e) {
  return U(e) && `set` in e;
}
...
function Cn(e, t, n, r) {
  return Object.assign(Sn(t.token, e, t, n, r), { get: an(e, t, n, r) });
}
function wn(e, t) {
  (e.parent != null && wn(e.parent, t), t(e.contextVersionAtom));
}
function Tn(e, t) {
  let n = new Map(),
    r = t.parent;
...
function X(e, t, n, r, i) {
  let a = r == null ? xn(n) : void 0,
    o = {
      chain: t,
      get: an(t, n, r, i),
      node: n,
      query: _n({ chain: t, node: n }, r),
      get queryClient() {
        if (n.queryClient == null) throw Error(`Missing query client`);
        return n.queryClient;
      },
  ...
  function c(r) {
    return _t((i) => r(X(e, t, n, i)), n.store);
  }
  function l(e) {
    return Dn(c, e);
  }
...
function On(e, t, n) {
  let r = q(e.node, e.chain, t.scope);
  if (r.queryClient == null) throw Error(`Missing query client`);
  return {
    queryClient: r.queryClient,
    queryOptions: t.getOptions(Cn(e.chain, r, n, { enabled: !1 })),
  };
}
function Z(e, t, n) {
  let r = On(e, t, n),
...
function kn(e) {
  let t = e.parent == null ? void 0 : kn(e.parent);
...
function jn(e, t, n) {
  let r = H(
    ...
    e,
    (r, i) => {
      let a = tn(typeof t == `function` ? t(Sn(e, i, r)) : t, n?.isEqual),
        o = n?.onMount;
      return (
        o != null &&
          (B(r, a),
...
function Nn(e, t, n) {
  return Rn(Q(e, (r) => In(e, (e) => t(r, e), { isEqual: n?.isEqual }), n));
}
function Pn(e, t, n) {
  return Rn(Q(e, (n) => zn(e, (e) => t(n, e)), n));
}
function Fn(e, t, n) {
  return Rn(Q(e, (n) => Bn(e, (e) => t(n, e)), n));
}
function In(e, t, n) {
  return Ln(e, t, void 0, n);
}
function Ln(e, t, n, r) {
  let i,
    a = H(
      ...
      e,
      (e, i) => {
        let a = nn((r) => t(Cn(i, e, r, n)), r?.isEqual);
        return (B(e, a), a);
      },
      (e, t) => {
        R(t, e, `derived`, { debugLabel: a.debugLabel });
      },
    ),
    o = Object.assign(a, {
      [z](a) {
        return n?.enabled === !1 || a.enabled
          ? o
          : (i ?? ((i = Ln(e, t, a, r)), (i.debugLabel = o.debugLabel)), i);
      },
    });
  return o;
}
function Rn(e, t = `readable-family`) {
  return Object.assign(e, {
    kind: t,
    read(t, n, r, i, a) {
      return on(t, n, e.resolve(t, n, r), i, a);
    },
  });
}
function zn(e, t) {
  let n = H(
      ...
      (e, n) => {
        ...
        let d = (r, i) => {
          ...
          f = St(
            ...
            () => r,
            {
              getEnabledReaderOptions: (t) => d(t, e.imperativeReadDepth === 0),
              getShouldSuppressStaleFetchOnEnable: (e) => !e(a),
              isEnabledReaderMounting: () => s,
          ...
          m = M((e) => {
            e(u);
            let t = e(f.rawResultAtom);
            return t.isEnabled ? { ...t, isEnabled: !1, isStale: !1 } : t;
          });
        return (B(e, p), B(e, m), { disabledReaderAtom: m, enabledReaderAtom: p, queryAtom: f });
      },
      ({ queryAtom: e }, t) => {
        R(t, e, `query`, { debugLabel: r.debugLabel });
      },
    ),
    r = Object.assign(
      H(`cached`, e, (e, t) => n.resolve(e, t).enabledReaderAtom),
      {
        getOptions: t,
        [z](e) {
    ...
    i = Object.assign(
      H(`cached`, e, (e, t) => n.resolve(e, t).disabledReaderAtom),
      {
        getOptions: t,
        [z]() {
          return i;
...
function Bn(e, t) {
  let n = H(
    ...
    (e, n) => {
      ...
      let r = M({ data: void 0, error: null, status: `idle`, variables: void 0 }),
        i = 0;
      return M((a) => {
        let o = a(r),
          s = async (a, o) => {
    ...
    (e, t) => {
      R(t, e, `mutation`, { debugLabel: n.debugLabel });
    },
  );
  return n;
}
function Vn(e, t) {
  return _t((n) => t(X(e.scope, e.chain, e.node, n)), e.node.store);
}
function Hn(e, t) {
  return Dn((t) => Vn(e, t), t);
}
function Un(e, t, n, r) {
  if (bn(t)) {
  ...
  let i = q(e.node, e.chain, t.scope);
  Y(i.store, t.resolve(i, e.chain), n);
}
var Wn = o(),
  Gn = e(i(), 1),
  Kn = r(),
  $ = (0, L.createContext)(new Map()),
  qn = (0, L.createContext)(void 0),
  Jn = {},
  Yn = 0;
function Xn(e) {
  let t = (0, Wn.c)(3),
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, Kn.jsx)(qn.Provider, { value: r, children: n })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
function Zn({ children: e, scope: t, value: n }) {
  let r = (0, L.useContext)($),
    i = (0, L.useContext)(qn),
  ...
  let u =
      t.retain == null || a == null
        ? void 0
        : er({ parentScope: a, providedValue: o, queryClient: i, scope: t, scopeKey: s }),
    d = u != null && !(0, Gn.default)(u.node.value, o),
    f = a?.queryClient ?? i,
    p =
  ...
  if (
    ...
    let e = p ?? Qn({ parentScope: a, providedValue: o, queryClient: i, scope: t, scopeKey: s }),
      n = Tn(r, t);
    (n.set(t.id, e), (c.current = { chain: n, node: e, parent: a, retainedEntry: u }));
  } else c.current.retainedEntry = u;
  (u == null ? $n({ node: c.current.node, parentScope: a, providedValue: o, queryClient: i }) : d)
    ...
    (0, L.useLayoutEffect)(() => {
      if (!(m == null || a == null))
        return (
          ...
          tr(a, t),
          () => {
            (--m.mountedCount, (m.lastUsed = rr()), tr(a, t));
          }
        );
    }, [m, a, t]),
    (0, Kn.jsx)($.Provider, { value: c.current.chain, children: e })
  );
}
function Qn({ parentScope: e, providedValue: t, queryClient: n, scope: r, scopeKey: i }) {
  return {
    cachedBindings: new Map(),
    contextVersionAtom: M(0),
...
function $n({ node: e, parentScope: t, providedValue: n, queryClient: r }) {
  let i = !(0, Gn.default)(e.value, n);
  return ((e.queryClient = t?.queryClient ?? r), (e.value = n), i);
}
function er({ parentScope: e, providedValue: t, queryClient: n, scope: r, scopeKey: i }) {
  return (
    e.retainedScopeEntries.get(r)?.get(i) ?? {
      lastUsed: 0,
      mountedCount: 0,
      node: Qn({ parentScope: e, providedValue: t, queryClient: n, scope: r, scopeKey: i }),
    }
  );
}
function tr(e, t) {
  ...
  if (r != null)
    for (; r.size > n; ) {
      let e = nr(r);
      if (e == null) return;
      (r.delete(e.key), rn(e.entry.node));
    }
}
function nr(e) {
  let t = null;
...
function ir(e, t) {
  let n = G(e, t);
  if (U(n)) {
    let e = (0, L.useCallback)((e) => n.subscribe(e), [n]),
      t = (0, L.useCallback)(() => n.store.get(n.atom), [n]);
    return (0, L.useSyncExternalStore)(e, t, t);
  }
  let r = (0, L.useContext)($),
    i = J(r, n.scope),
    a = n.resolve(i, r),
    o = (0, L.useCallback)((e) => i.store.sub(a, e), [a, i.store]),
    s = (0, L.useCallback)(() => i.store.get(a), [a, i.store]);
  return (0, L.useSyncExternalStore)(o, s, s);
}
function ar(e, t) {
  let n = (0, Wn.c)(4),
    r = (0, L.useContext)($),
...
function or(e, t, n) {
  let r = (0, Wn.c)(3),
    ...
    a;
  return (
    r[0] !== n || r[1] !== i ? ((a = G(i, n)), (r[0] = n), (r[1] = i), (r[2] = a)) : (a = r[2]),
    ir(a)
  );
}
function sr(e) {
  let t = (0, L.useContext)($),
    n = J(t, e),
    r = xn(n),
    i = (0, L.useRef)(null);
  if (i.current == null || i.current.node !== n) {
    ...
    function o(e, t, n) {
      if (U(e)) return G(e, arguments.length === 2 && W(e) ? t : void 0).get();
      if (W(e) && arguments.length === 2) {
        let n = e,
          r = J(a.chain, n.scope);
        return V(r, G(n, t).resolve(r, a.chain));
      }
      if (t !== void 0 || arguments.length >= 2) {
        let r = e,
          i = J(a.chain, r.scope);
        return gn(r) ? r.read(i, a.chain, t, void 0, n) : r.resolve(i, a.chain, t);
      }
      let r = e,
        i = J(a.chain, r.scope);
      return V(i, r.resolve(i, a.chain));
    }
    function s(e) {
      return Vn(a, e);
    }
    ...
    ((a.get = o), (a.query = _n(a)), (a.set = l), (a.watch = s), (a.when = c), (i.current = a));
...
//# sourceMappingURL=app-scope-CWE-zIhQ.js.map
