...
function C(e) {
  return e === g.FREE || e === g.GO || e === g.PLUS || e === g.PROLITE || e === g.PRO;
}
var w,
  T,
  E,
  ...
  P = e(() => {
    (u(),
      ...
      (N = { [g.FREE]: 0, [g.GO]: 1, [g.PLUS]: 2, [g.PROLITE]: 3, [g.PRO]: 4 }));
  });
function F() {
  let e = (0, R.c)(21),
  ...
  e[0] === i
    ? (v = e[1])
    : ((v = { queryConfig: { enabled: i, staleTime: r.ONE_MINUTE } }), (e[0] = i), (e[1] = v));
