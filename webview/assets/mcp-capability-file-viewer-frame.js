import { Ia as e } from "./app-server-manager-signals.js";
import { t } from "./jsx-runtime.js";
import { wt as n } from "./setting-storage.js";
import { t as r } from "./mcp-capability-view-frame.js";
function i(t, n) {
  let r = e(t),
    i = null,
    a = 0;
...
function p(e) {
  let t = (0, d.c)(15),
    { className: n, filePath: i, fileViewer: c, instanceId: l, readResourceText: u } = e,
    p;
  bb0: {
    if (l != null) {
      p = l;
  ...
  let m = p,
    h;
  t[1] !== i || t[2] !== m ? ((h = a(i, m)), (t[1] = i), (t[2] = m), (t[3] = h)) : (h = t[3]);
  let g = h,
    _;
...
//# sourceMappingURL=mcp-capability-file-viewer-frame.js.map
