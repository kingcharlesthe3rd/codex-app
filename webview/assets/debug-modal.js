...
import { c as Zn, l as Qn, n as $n, r as er } from "./home-onboarding-assistant-tutorial-card.js";
import {
  d as tr,
  l as nr,
  o as rr,
...
import {
  ...
  i as ar,
  s as or,
} from "./app-initial~app-main~onboarding-page~select-workspace-page~debug-window-page~debug-modal.js";
import { n as sr, t as cr } from "./avatar-overlay-debug-state.js";
import { d as lr, n as ur, t as dr, u as fr } from "./codex-mobile-setup-dialog.js";
import { c as pr, l as mr, n as hr, o as gr, s as _r } from "./use-debug-panel.js";
import { i as vr, o as yr, t as br } from "./thread-virtualizer.js";
function xr({ labels: e, projectlessThreadCwd: t, statuses: n, workspaceRoots: r }) {
  let i = new Map();
...
function B(e) {
  ...
  let [p, m] = (0, Tr.useState)(f),
    ...
    g;
  t[2] !== s || t[3] !== h
    ? ((g = z(`flex h-7 w-full items-center justify-between gap-2`, h, s)),
      (t[2] = s),
      (t[3] = h),
      (t[4] = g))
    : (g = t[4]);
  ...
  t[19] === c
    ? (C = t[20])
    : ((C = c
        ? (0, Er.jsx)(`span`, { className: `flex items-center gap-1`, onClick: Cr, children: c })
        : null),
      (t[19] = c),
      (t[20] = C));
  let w;
  ...
  t[26] !== S || t[27] !== T || t[28] !== g
    ? ((E = (0, Er.jsxs)(`div`, { className: g, children: [S, T] })),
      (t[26] = S),
      (t[27] = T),
      (t[28] = g),
      (t[29] = E))
  ...
  t[33] !== p || t[34] !== k || t[35] !== A
    ? ((j = (0, Er.jsx)(`div`, { className: `px-3`, style: k, "data-open": p, children: A })),
      (t[33] = p),
      (t[34] = k),
      (t[35] = A),
      (t[36] = j))
  ...
  return (
    t[37] !== E || t[38] !== j
      ? ((M = (0, Er.jsxs)(`div`, { children: [E, j] })), (t[37] = E), (t[38] = j), (t[39] = M))
      : (M = t[39]),
    M
  );
}
...
var wr,
  ...
  Er,
  Dr = e(() => {
    ((wr = L()), pe(), (Tr = t(kt(), 1)), u(), (Er = R()));
  });
function Or({ sourceThreadId: e }) {
  let [t, r] = (0, kr.useState)(jr),
    [i, a] = (0, kr.useState)(`Not run yet`),
    [o, s] = (0, kr.useState)(!1),
    c = async () => {
      if (!o) {
        s(!0);
        try {
          let n = JSON.parse(t),
            r = await $t(n, { sourceThreadId: e });
          a(
            `Success\n\nResult:\n${JSON.stringify(r, null, 2)}\n\nSent payload:\n${JSON.stringify(n, null, 2)}`,
          );
        } catch (e) {
          (a(`Error: ${e instanceof Error ? e.message : String(e)}\n\nInput JSON:\n${t}`),
            n.error(`Failed to run debug app action`, {
              safe: {},
...
function Rr(e) {
  let t = (0, Si.c)(15),
    ...
    a = m(r),
    [o] = Dt(`host_config`),
    [s] = Dt(`remote_ssh_connections`),
    [c] = Dt(`remote_control_connections`),
    l;
  if (t[0] !== o || t[1] !== n || t[2] !== i || t[3] !== c || t[4] !== s || t[5] !== a) {
    let e;
    (t[7] !== o || t[8] !== i || t[9] !== c || t[10] !== s || t[11] !== a
      ? ((e = (e) =>
          (0, H.jsx)(
            zr,
            {
              ...
              notifications: i.filter((t) => t.hostId === e),
              requests: a.filter((t) => t.hostId === e),
            },
            e,
          )),
        (t[7] = o),
  ...
  return (
    t[13] === l
      ? (u = t[14])
      : ((u = (0, H.jsx)(`div`, { className: `flex flex-col gap-3 py-3`, children: l })),
        (t[13] = l),
        (t[14] = u)),
    u
  );
...
function zr(e) {
  ...
  let f = d.length,
    p = xt(Di, r) ?? n.stateType === `local`,
    m = n.stateType === `local` ? `local` : s,
    h;
  t[2] === a ? (h = t[3]) : ((h = a.filter(Hr)), (t[2] = a), (t[3] = h));
  let g = h.length,
    _;
  t[4] === i ? (_ = t[5]) : ((_ = i.filter(Vr)), (t[4] = i), (t[5] = _));
  let v = _.length,
    y;
  t[6] === i ? (y = t[7]) : ((y = i.filter(Br)), (t[6] = i), (t[7] = y));
  let b = y.length,
    x;
  t[8] !== r || t[9] !== o
    ? ((x = (e) => {
  ...
  t[11] === n.displayName
    ...
    : ((S = (0, H.jsx)(`span`, {
      ...
      (t[12] = S));
  let C;
  t[13] === m ? (C = t[14]) : ((C = (0, H.jsx)(ci, { state: m })), (t[13] = m), (t[14] = C));
  let T;
  t[15] !== S || t[16] !== C
    ? ((T = (0, H.jsxs)(`div`, { className: `flex items-center gap-2`, children: [S, C] })),
      (t[15] = S),
      (t[16] = C),
      (t[17] = T))
    : (T = t[17]);
  let E = n.stateType === `connection` ? ` · ${r}` : null,
    D = ` · v${c ?? `Unavailable`}`,
    O;
  t[18] !== n.connectionType || t[19] !== D || t[20] !== E
    ? ((O = (0, H.jsxs)(`div`, {
        className: `mt-1 truncate text-xs text-token-description-foreground`,
        children: [n.connectionType, E, D],
      })),
  ...
  let A;
  t[22] !== O || t[23] !== T
    ? ((A = (0, H.jsxs)(`div`, { className: `min-w-0`, children: [T, O] })),
      (t[22] = O),
      (t[23] = T),
      (t[24] = A))
    : (A = t[24]);
  ...
  let re;
  t[47] !== u || t[48] !== n
    ? ((re = u ? (0, H.jsx)(Ur, { hostDetails: n }) : null), (t[47] = u), (t[48] = n), (t[49] = re))
    : (re = t[49]);
  let ie;
  t[50] !== r || t[51] !== l
    ? ((ie = (0, H.jsx)(qr, { hostId: r, threadStatusEntries: l })),
      (t[50] = r),
      (t[51] = l),
      (t[52] = ie))
    : (ie = t[52]);
  let ae;
  t[53] !== r || t[54] !== a
    ? ((ae = (0, H.jsx)(Gr, { hostId: r, requests: a })), (t[53] = r), (t[54] = a), (t[55] = ae))
    : (ae = t[55]);
  let oe;
  t[56] !== r || t[57] !== i
    ? ((oe = (0, H.jsx)(Xr, { hostId: r, notifications: i })),
      (t[56] = r),
      (t[57] = i),
      (t[58] = oe))
    : (oe = t[58]);
                                      ...
                                      (0, H.jsx)(
                                        Jr,
                                        {
                                          ...
                                          onUnsubscribe: async (t) => {
                                            r(t);
                                            try {
                                              await be(`unsubscribe-thread-for-host`, {
                                                hostId: e,
                                                threadId: t,
                                              });
                                            } finally {
...
function Jr(e) {
  ...
  t[9] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, H.jsx)(on, { className: `icon-xs` })), (t[9] = f))
    : (f = t[9]);
  let p;
  t[10] === d
    ? (p = t[11])
  ...
  let D = `turn: ${n.lastTurnStatus ?? `none`}`,
    O;
  t[34] === D ? (O = t[35]) : ((O = (0, H.jsx)(Yr, { label: D })), (t[34] = D), (t[35] = O));
  let k;
...
function Xr(e) {
  ...
  if (t[0] !== n || t[1] !== r || t[2] !== i || t[3] !== s || t[4] !== a) {
    ...
    let y = o,
      b;
    (t[18] === y ? (b = t[19]) : ((b = y.filter(ei)), (t[18] = y), (t[19] = b)), (d = b));
    let x;
    (t[20] !== y || t[21] !== a
      ? ((x = a ? y : y.filter($r)), (t[20] = y), (t[21] = a), (t[22] = x))
      : (x = t[22]),
      (f = x),
      (l = ni),
      (h = r.length === 0),
  ...
  t[29] !== p || t[30] !== m || t[31] !== y
    ? ((b = (0, H.jsxs)(`div`, { className: p, children: [m, y] })),
      (t[29] = p),
      (t[30] = m),
      (t[31] = y),
      (t[32] = b))
...
function ti(e) {
  let t = (0, Si.c)(7),
    { threadId: n } = e,
    r;
  t[0] === n ? (r = t[1]) : ((r = xe(n)), (t[0] = n), (t[1] = r));
  let i = xt(qe, r),
    a;
  ...
  return (
    t[4] !== a || t[5] !== n
      ? ((o = (0, H.jsx)(`option`, { value: n, children: a })), (t[4] = a), (t[5] = n), (t[6] = o))
      : (o = t[6]),
    o
  );
}
...
function ai(e) {
  ...
  t[0] === n.severity
    ? (r = t[1])
    : ((r = z(`group/notification bg-token-background rounded-lg border`, bi(n.severity))),
      (t[0] = n.severity),
      (t[1] = r));
  let i;
  t[2] === n.method
...
function ci(e) {
  ...
  t[0] === n
    ? (r = t[1])
    : ((r = z(`rounded-full px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide`, xi(n))),
      (t[0] = n),
      (t[1] = r));
  let i;
  return (
...
function ki() {
  ...
  e[1] === s
    ...
    : ((l = {
        ...
        queryKey: na,
        refetchInterval: ia,
        staleTime: ve.FIVE_SECONDS,
      }),
      (e[1] = s),
      (e[2] = l));
  let { data: u, isFetching: d, isLoading: p, refetch: m } = f(l),
    h;
  e[3] === m
    ? (h = e[4])
    : ((h = async (e) => {
        if (t != null)
          try {
            ...
            let r = t;
            (o(`Failed to open Browser owner`),
              n.error(`Failed to open Browser debug owner`, {
                safe: {
                  browserTabId: e.browserTabId,
                  conversationId: e.conversationId,
                  windowId: e.windowId,
      ...
      (e[4] = h));
  let g = h,
    _ = r && u != null ? `Browser tabs (${u.tabs.length})` : `Browser tabs`,
    v;
  e[5] !== u || e[6] !== d || e[7] !== r || e[8] !== m
    ? ((v = r
        ? (0, U.jsxs)(`div`, {
            ...
            children: [
              (0, U.jsx)(`button`, {
                ...
                onClick: () => {
                  u != null &&
                    navigator.clipboard?.writeText(JSON.stringify($i(u), null, 2)).catch(ji);
                },
              ...
              (0, U.jsx)(`button`, {
                ...
                disabled: u == null,
                onClick: () => {
                  u != null && navigator.clipboard?.writeText(JSON.stringify(u, null, 2)).catch(Ai);
                },
                children: `Copy JSON`,
              }),
              (0, U.jsxs)(`button`, {
                ...
                children: [d ? (0, U.jsx)(et, { className: `icon-2xs` }) : null, `Refresh`],
              }),
            ],
          })
        : null),
    ...
    : (v = e[9]);
  let y;
  e[10] !== u || e[11] !== g || e[12] !== p || e[13] !== r || e[14] !== a
    ? ((y = r
        ? t == null
          ...
          : p && u == null
            ...
            : u == null
              ...
              : (0, U.jsx)(Ni, { onOpenOwner: g, openOwnerStatus: a, snapshot: u })
        : null),
      (e[10] = u),
      (e[11] = g),
      (e[12] = p),
...
function Vi(e) {
  ...
  t[23] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((g = (0, U.jsxs)(`span`, {
        ...
        children: [`Open owner`, (0, U.jsx)(on, { className: `icon-2xs` })],
      })),
      (t[23] = g))
    : (g = t[23]);
  let _;
  ...
  t[55] === F
    ? (ee = t[56])
    : ((ee = (0, U.jsx)(V, { label: `Pending URL`, value: F })), (t[55] = F), (t[56] = ee));
  let te = `snapshot=${r.hasPersistedPageState}`,
    ne = `history=${r.persistedHistoryEntryCount ?? `none`}`,
    re = `host=${r.webviewHostRegistered}`,
    ie;
  t[57] !== te || t[58] !== ne || t[59] !== re
    ? ((ie = [te, ne, re]), (t[57] = te), (t[58] = ne), (t[59] = re), (t[60] = ie))
    : (ie = t[60]);
  let ae = ie.join(` `),
    oe;
  t[61] === ae
    ? (oe = t[62])
    : ((oe = (0, U.jsx)(V, { label: `Persistence`, value: ae })), (t[61] = ae), (t[62] = oe));
  let I;
  t[63] === r.persistedPageStateUpdatedAtMs
    ? (I = t[64])
    : ((I = Qi(r.persistedPageStateUpdatedAtMs)),
      (t[63] = r.persistedPageStateUpdatedAtMs),
      (t[64] = I));
  let se;
  t[65] === I
    ? (se = t[66])
    : ((se = (0, U.jsx)(V, { label: `Snapshot age`, value: I })), (t[65] = I), (t[66] = se));
  let ce;
  t[67] === r.restorePhase
    ? (ce = t[68])
  ...
  t[69] === r.restoreInvariant
    ...
    : ((le =
      ...
      (t[70] = le));
  let L;
  t[71] === r.bounds ? (L = t[72]) : ((L = Zi(r.bounds)), (t[71] = r.bounds), (t[72] = L));
  let ue;
  t[73] === L
    ? (ue = t[74])
    : ((ue = (0, U.jsx)(V, { label: `Bounds`, value: L })), (t[73] = L), (t[74] = ue));
  let de = `active=${r.active}`,
    fe = `presented=${r.presented}`,
    pe = `visible=${r.visible}`,
    me = `hasPage=${r.hasPage}`,
    he = `loading=${r.isLoading}`,
    ge = `restoring=${r.isRestoring}`,
    _e = `suspended=${r.isSuspended}`,
    ve;
  t[75] !== de ||
  t[76] !== fe ||
  t[77] !== pe ||
  ...
  t[83] === ye
    ? (be = t[84])
    : ((be = (0, U.jsx)(V, { label: `Flags`, value: ye })), (t[83] = ye), (t[84] = be));
  let xe = `page=${r.isBrowserUsePage}`,
    Se = `active=${r.isBrowserUseActive}`,
    Ce = `agent=${r.isAgentControllingBrowser}`,
    we = `visibilityRequest=${r.hasPendingBrowserUseVisibilityRequest}`,
    Te = `panelOpen=${r.pendingBrowserUsePanelOpen}`,
    Ee;
  t[85] !== xe || t[86] !== Se || t[87] !== Ce || t[88] !== we || t[89] !== Te
    ? ((Ee = [xe, Se, Ce, we, Te]),
      (t[85] = xe),
      (t[86] = Se),
      (t[87] = Ce),
  ...
  t[91] === De
    ? (Oe = t[92])
    : ((Oe = (0, U.jsx)(V, { label: `Browser Use`, value: De })), (t[91] = De), (t[92] = Oe));
  let ke = `mount=${r.mountGeneration}`,
    Ae = `last=${r.lastLifecycleSequence}`,
    je = `presented=${r.lastPresentedSequence}`,
    Me = `pendingAttach=${r.pendingAttachCount}`,
    Ne;
  t[93] !== ke || t[94] !== Ae || t[95] !== je || t[96] !== Me
    ? ((Ne = [ke, Ae, je, Me]),
      (t[93] = ke),
      (t[94] = Ae),
      (t[95] = je),
  ...
  t[98] === Pe
    ? (Fe = t[99])
    : ((Fe = (0, U.jsx)(V, { label: `Lifecycle`, value: Pe })), (t[98] = Pe), (t[99] = Fe));
  let Ie =
  ...
  t[100] === Ie
    ? (Le = t[101])
    : ((Le = (0, U.jsx)(V, { label: `Pending teardown`, value: Ie })),
      (t[100] = Ie),
      (t[101] = Le));
  let Re;
  t[102] !== b ||
  ...
  t[120] !== Le
    ? ((Re = (0, U.jsxs)(`div`, {
        ...
        children: [b, x, S, w, E, O, A, M, P, ee, oe, se, ce, le, ue, be, Oe, Fe, Le],
      })),
      (t[102] = b),
      (t[103] = x),
      (t[104] = S),
...
var es,
  ...
  ns,
  rs = e(() => {
    ((es = t(P(), 1)), (ts = 1024 * 1024), (ns = 5 * 1024 * 1024));
  });
function is() {
  let e = (0, ds.c)(25),
  ...
  let { data: l, isLoading: u } = Ot(`child-processes`, c),
    d;
  e[2] === l?.processes
    ? (d = e[3])
    ...
    ? ((v = t
        ? u && l == null
          ...
          : l?.rootProcess == null
            ...
            : (0, K.jsx)(os, { onProcessDetailsClick: o, processes: f, rootProcess: l.rootProcess })
        : null),
      (e[8] = l),
      (e[9] = u),
      (e[10] = t),
  ...
  e[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((x = (0, K.jsx)(g, {
        title: (0, K.jsx)(Ke, { children: `Process details` }),
        subtitle: (0, K.jsx)(tt, { children: `The process ID and full command are shown below` }),
      })),
      (e[14] = x))
    : (x = e[14]);
  let S;
  ...
  let C;
  e[17] !== S || e[18] !== y
    ? ((C = (0, K.jsx)(ct, { open: y, onOpenChange: b, size: `wide`, children: S })),
      (e[17] = S),
      (e[18] = y),
      (e[19] = C))
    : (C = e[19]);
...
function zs() {
  let e = (0, ec.c)(23),
    t = N.downloads,
    [r, i] = (0, tc.useState)(Vs),
    [a, o] = (0, tc.useState)(null),
    s = r && t != null,
    c;
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((c = async () => {
  ...
  e[1] === s
    ? (l = e[2])
    : ((l = { enabled: s, queryFn: c, queryKey: nc, staleTime: ve.FIVE_SECONDS }),
      (e[1] = s),
      (e[2] = l));
  let { data: u, isFetching: d, isLoading: p, refetch: m } = f(l),
    h;
  e[3] === m
    ...
    : ((h = async (e, r) => {
        if (t != null) {
          ...
          try {
            let t = await r();
            (t.ok || o($s(e, t)), await m());
          } catch (t) {
            let r = t;
            (o(`${e} failed`),
              n.error(`Failed to run downloads debug action`, {
                safe: { label: e },
                sensitive: { error: r },
              }));
          }
  ...
  let v = r && u != null ? `Downloads (${_.length})` : `Downloads`,
    y;
  e[7] !== u || e[8] !== d || e[9] !== r || e[10] !== m || e[11] !== g
    ? ((y = r
        ? (0, q.jsxs)(`div`, {
            className: `flex items-center gap-1`,
            children: [
              (0, q.jsxs)(`button`, {
                ...
                disabled: t == null,
                onClick: () => {
                  t != null && g(`Open downloads folder`, () => t.showDownloadsFolder());
                },
                children: [(0, q.jsx)(dn, { className: `icon-2xs` }), `Open in Finder`],
              }),
              (0, q.jsx)(`button`, {
                type: `button`,
                className: `cursor-interaction rounded px-1.5 py-0.5 text-xs hover:bg-token-foreground/10 disabled:cursor-not-allowed disabled:opacity-50`,
                disabled: u == null,
                onClick: () => {
                  u != null && navigator.clipboard?.writeText(JSON.stringify(u, null, 2)).catch(Bs);
                },
                children: `Copy JSON`,
              }),
              (0, q.jsxs)(`button`, {
                ...
                children: [d ? (0, q.jsx)(et, { className: `icon-2xs` }) : null, `Refresh`],
              }),
            ],
          })
        : null),
    ...
    : (y = e[12]);
  let b;
  e[13] !== a || e[14] !== u || e[15] !== p || e[16] !== r || e[17] !== g
    ? ((b = r
        ? t == null
          ...
          : p && u == null
            ...
            : u == null
              ...
              : (0, q.jsx)(Hs, {
                  actionStatus: a,
                  snapshot: u,
                  onCancel: (e) => g(`Cancel download`, () => t.cancel({ id: e.id })),
                  onOpen: (e) => g(`Open download`, () => t.open({ id: e.id })),
                  onPause: (e) => g(`Pause download`, () => t.pause({ id: e.id })),
                  onRemove: (e) => g(`Remove download`, () => t.remove({ id: e.id })),
                  onResume: (e) => g(`Resume download`, () => t.resume({ id: e.id })),
                  onShowInFolder: (e) =>
                    g(`Show download in Finder`, () => t.showInFolder({ id: e.id })),
                })
        : null),
      (e[13] = a),
      (e[14] = u),
...
function Ws(e) {
  ...
  if (Qs(n.status)) {
    ...
    t[3] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((o = (0, q.jsx)(Zt, { className: `icon-2xs` })), (t[3] = o))
      : (o = t[3]);
    let s;
    t[4] !== e || t[5] !== i
      ? ((s = (0, q.jsxs)(`button`, {
    ...
    t[10] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((u = (0, q.jsx)(ue, { className: `icon-2xs` })), (t[10] = u))
      : (u = t[10]);
    let d;
    t[11] !== c || t[12] !== l
      ? ((d = (0, q.jsxs)(`button`, {
  ...
  if (n.status === `paused`) {
    ...
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((a = (0, q.jsx)(nn, { className: `icon-2xs` })), (t[20] = a))
      : (a = t[20]);
    let o;
    t[21] !== e || t[22] !== i
      ? ((o = (0, q.jsxs)(`button`, {
    ...
    t[27] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((u = (0, q.jsx)(ue, { className: `icon-2xs` })), (t[27] = u))
      : (u = t[27]);
    let d;
    t[28] !== c || t[29] !== l
      ? ((d = (0, q.jsxs)(`button`, {
  ...
  t[43] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, q.jsx)(qt, { className: `icon-2xs` })), (t[43] = m))
    : (m = t[43]);
  let h;
  t[44] === p
    ? (h = t[45])
  ...
  let b;
  t[55] !== y || t[56] !== h
    ? ((b = (0, q.jsx)(he, { align: `end`, triggerButton: h, children: y })),
      (t[55] = y),
      (t[56] = h),
      (t[57] = b))
    : (b = t[57]);
...
function sc() {
  let e = (0, cc.c)(15),
    ...
    { data: i, isLoading: a } = M(ie.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED),
    o = i === !0,
  ...
  e[0] === s
    ...
    : ((c = (0, uc.jsx)(`div`, {
        ...
        children: (0, uc.jsx)(V, { label: `Lock override`, value: s }),
      })),
      (e[0] = s),
      (e[1] = c));
  let l;
  ...
  e[3] === t
    ...
    : ((u = (e) => {
        (r(null),
          He(t, ie.GLOBAL_DICTATION_FORCE_LOCK_DEBUG_ENABLED, e)
            .then(() => {
              O.dispatchMessage(`global-dictation-force-lock-changed`, { enabled: e });
            })
            .catch((e) => {
              r(
...
var cc,
  ...
  uc,
  dc = e(() => {
    ((cc = L()), Ae(), Ye(), (lc = t(kt(), 1)), _e(), Je(), D(), lt(), j(), Ir(), Dr(), (uc = R()));
  });
function fc() {
  let e = (0, mc.c)(35),
    t = o(),
  ...
  e[0] === t
    ? (a = e[1])
    : ((a = { mutationFn: pc, onSuccess: (e) => (t.setQueryData(En, e.state), e) }),
      (e[0] = t),
      (e[1] = a));
  let s = d(a);
  ...
  e[2] === i.configuredHotkey
    ? (c = e[3])
    : ((c = i.configuredHotkey == null ? `Off` : Vt(i.configuredHotkey)),
      (e[2] = i.configuredHotkey),
      (e[3] = c));
  let l = c,
    u = i.isGateEnabled ? `Enabled` : `Disabled`,
    f = i.isActive ? `Active` : `Inactive`,
    p = i.isDevOverrideEnabled ? `Enabled` : `Disabled`,
    h = i.configuredHotkey != null && !s.isPending,
    g;
  e[4] === l
    ? (g = e[5])
    : ((g = (0, gc.jsx)(V, { label: `Configured hotkey`, value: l })), (e[4] = l), (e[5] = g));
  let _;
  e[6] === u
    ? (_ = e[7])
    : ((_ = (0, gc.jsx)(V, { label: `Gate`, value: u })), (e[6] = u), (e[7] = _));
  let v;
  e[8] === f
    ? (v = e[9])
    : ((v = (0, gc.jsx)(V, { label: `Runtime`, value: f })), (e[8] = f), (e[9] = v));
  let y;
  e[10] === p
    ? (y = e[11])
    : ((y = (0, gc.jsx)(V, { label: `Dev override`, value: p })), (e[10] = p), (e[11] = y));
  let b;
  e[12] !== g || e[13] !== _ || e[14] !== v || e[15] !== y
    ? ((b = (0, gc.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [g, _, v, y] })),
      (e[12] = g),
      (e[13] = _),
      (e[14] = v),
      (e[15] = y),
  ...
  e[28] !== w || e[29] !== T || e[30] !== E
    ? ((D = (0, gc.jsxs)(`div`, { className: `flex flex-col gap-2 py-1.5`, children: [w, T, E] })),
      (e[28] = w),
      (e[29] = T),
      (e[30] = E),
      (e[31] = D))
...
var mc,
  ...
  gc,
  _c = e(() => {
    ((mc = L()), wt(), Ae(), (hc = t(kt(), 1)), bn(), Pt(), ne(), Ir(), Dr(), (gc = R()));
  });
function vc() {
  let e = (0, Jc.c)(1),
    t;
...
function yc() {
  ...
  if (
    ...
    ((_ = n.filter((e) => Ic(e).includes(v) && Lc(e).includes(y) && Pc(e, s))),
      (p = _.slice(0, d)));
    let b = jc(p);
    ...
    e[16] === a
      ...
      : ((T = (0, J.jsx)(`input`, {
        ...
        (e[17] = T));
    let E;
    e[18] === s ? (E = e[19]) : ((E = Fc(s)), (e[18] = s), (e[19] = E));
    let D;
    e[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((D = (0, J.jsx)(de, { className: `icon-2xs opacity-70` })), (e[20] = D))
      : (D = e[20]);
    let O;
    e[21] === E
      ? (O = e[22])
    ...
    e[24] === O
      ? (A = e[25])
      : ((A = (0, J.jsx)(he, { align: `end`, triggerButton: O, children: k })),
        (e[24] = O),
        (e[25] = A));
    let j;
...
function Ec(e) {
  let t = (0, Jc.c)(37),
    ...
    g;
  t[0] === h ? (g = t[1]) : ((g = z(`flex flex-col`, h)), (t[0] = h), (t[1] = g));
  let _;
  t[2] !== l || t[3] !== f || t[4] !== u
    ? ((_ = () => {
        let e = !l;
  ...
  kl = e(() => {
    (Ce(),
      ...
      (El = vt({
        ...
        data: $e(),
        mimeType: $e().optional(),
        mime_type: $e().optional(),
      }).catchall(Be())),
      (Dl = vt({ type: it(`text`), text: $e() }).catchall(Be())),
      (Ol = vt({ code: $e(), timeout_ms: Be().optional(), title: Be().optional() }).catchall(
        Be(),
      )));
  });
function Al(e) {
...
function Pl({ lines: e }) {
  let t = (0, Yl.useMemo)(
    ...
    c = (0, Yl.useRef)(null),
    l = (0, Yl.useRef)(n),
    u = br({ entries: t, gapPx: 0, measuredHeightsByKey: n });
  l.current = n;
  let d = at(() => {
...
function bu() {
  ...
  e[1] === L
    ? (ue = e[2])
    : ((ue = { params: le, queryConfig: { enabled: L } }), (e[1] = L), (e[2] = ue));
  let de = Ot(`workspace-root-options`, ue).data?.roots.length ?? 0,
    pe = r ? `Remote` : `Codex Mobile`,
    me;
  ...
  e[4] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ge = [
        ...
        { value: ir, label: `T5 Onboarding V2` },
      ]),
      (e[4] = ge))
    : (ge = e[4]);
  let _e = ge,
  ...
  e[8] === h.roles
    ? (Ee = e[9])
    : ((Ee = h.roles.length === 0 ? `none` : h.roles.join(`, `)), (e[8] = h.roles), (e[9] = Ee));
  let De = Ee,
    Oe;
  e[10] !== Te ||
  e[11] !== n ||
    ...
    ? ((Oe = I
        ? (0, X.jsxs)(`div`, {
            ...
            children: [
              (0, X.jsx)(`div`, {
                className: `text-xs text-token-description-foreground`,
                children: `Auth: ${n.authMethod ?? `none`} · Projects: ${de}`,
              }),
              (0, X.jsx)(`div`, {
                className: `text-xs text-token-description-foreground`,
                children: `Codex runtime: ${ie == null ? `idle` : xu(ie)}`,
              }),
              (0, X.jsx)(`div`, {
                ...
                children: he.map((e) =>
                  (0, X.jsx)(
                    `button`,
                    {
                      ...
                      onClick: () => {
                        if (e.value === `welcome`) {
                          (Qt(re), Rt(t), c(e.value), a(`/`, { replace: !0 }));
                          return;
                        }
                        (e.value === `workspace` && D(!1), c(e.value));
                      },
                      children: e.label,
                    },
                    e.value,
                ...
                children: [
                  (0, X.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, X.jsx)(`div`, { children: `Projectless completed: ${d ? `yes` : `no`}` }),
                      (0, X.jsx)(`div`, {
                        children: `V2 suggestions enabled at onboarding completion: ${y ? `yes` : `no`}`,
                      }),
                      (0, X.jsx)(`div`, {
                        children: `Plugin checklist active: ${g ? `yes` : `no`}`,
                      }),
                      (0, X.jsx)(`div`, { children: `Roles: ${De}` }),
                    ],
                  }),
                  (0, X.jsx)(`button`, {
                    type: `button`,
                    ...
                    onClick: () => {
                      (f(!1),
                        ...
                        D(!1),
                        (async () => {
                          (await He(t, `use-copilot-auth-if-available`, !1),
                            await be(`logout`, { hostId: re }),
                            c(`welcome`),
                            u(!0),
                            f(!1),
                            _(!1),
                            ...
                            onClick: () => {
                              (e.value == null &&
                                ...
                                t.queryClient.removeQueries({
                                  queryKey: v(`email-domain-mail-provider`),
                                }),
                                t.set(Jn, e.value));
                            },
                            children: e.label,
              ...
              (0, X.jsx)(se, { electron: !0, children: (0, X.jsx)(uu, {}) }),
              null,
              (0, X.jsxs)(`div`, {
                className: `flex flex-col gap-2`,
                children: [
                  (0, X.jsx)(`div`, {
                    className: `text-xs text-token-description-foreground`,
                    children: `Workspace onboarding experiment: ${Te}`,
                  }),
                  (0, X.jsx)(`div`, {
                    className: `flex flex-wrap gap-2`,
                    children: _e.map((e) =>
                      (0, X.jsx)(
                        `button`,
                        {
                          ...
                          onClick: () => {
                            ...
                            k({ arm: e.value, assignedAtMs: Date.now(), experimentName: ar });
                          },
                          children: e.label,
                        },
                        e.value,
              ...
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    ...
                    children: `Work plugins announcement: ${P ? `seen` : `unseen`}`,
                  }),
                  (0, X.jsx)(`button`, {
                    type: `button`,
                    ...
                    onClick: () => {
                      (F(!1), ee(!1), o.updateUserAsync(o.getContext().user));
                    },
              ...
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Remote Connections home announcement: ${te ? `seen` : `unseen`}`,
                  }),
                  (0, X.jsx)(`button`, {
                    type: `button`,
                    className: `rounded border border-token-border px-3 py-1 text-token-description-foreground hover:bg-token-foreground/5`,
              ...
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Browser profile import NUX: ${ne ? `seen` : `unseen`}`,
                  }),
                  (0, X.jsx)(`button`, {
                    type: `button`,
                    className: `cursor-interaction rounded border border-token-border px-3 py-1 text-token-description-foreground hover:bg-token-foreground/5`,
              ...
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  (0, X.jsx)(`div`, {
                    className: `text-token-description-foreground`,
                    children: `Browser comment mode coachmark: ${M ? `seen` : `unseen`}`,
                  }),
                  (0, X.jsx)(`button`, {
                    type: `button`,
                    className: `rounded border border-token-border px-3 py-1 text-token-description-foreground hover:bg-token-foreground/5`,
...
function Eu() {
  ...
  e[5] !== n || e[6] !== o
    ? ((s = (0, Ou.jsxs)(`div`, {
        ...
        children: [
          a,
          (0, Ou.jsx)(me, { ariaLabel: `Hide pet resize button`, checked: n, onChange: o }),
        ],
      })),
      (e[5] = n),
      (e[6] = o),
...
function Au() {
  ...
  e[12] === p
    ? (h = e[13])
    : ((h = (0, Pu.jsx)(V, { label: `File viewers`, value: p })), (e[12] = p), (e[13] = h));
  let g;
  e[14] === r.length ? (g = e[15]) : ((g = r.length.toString()), (e[14] = r.length), (e[15] = g));
  let _;
  e[16] === g
    ? (_ = e[17])
    : ((_ = (0, Pu.jsx)(V, { label: `Mention servers`, value: g })), (e[16] = g), (e[17] = _));
  let v;
  e[18] === a
    ? (v = e[19])
    : ((v = a ? (0, Pu.jsx)(et, { className: `icon-2xs` }) : null), (e[18] = a), (e[19] = v));
  let y;
...
function ju(e) {
  n.error(`Failed to reload bundled plugins from debug page`, {
    safe: {},
    sensitive: { error: e },
  });
}
var Mu,
  ...
  Pu,
  Fu = e(() => {
    ((Mu = L()), Ae(), (Nu = t(kt(), 1)), We(), i(), Mn(), I(), Ir(), Dr(), (Pu = R()));
  });
function Iu() {
  let e = (0, Ju.c)(2),
    t = Sn(),
    ...
    `div`,
    {
      ...
      children: [
        (0, Z.jsxs)(`div`, {
          ...
          children: [
            (0, Z.jsx)(`span`, {
              className: z(`w-fit rounded-full px-2 py-0.5 text-xs font-medium`, Hu(e.status)),
        ...
        i.length === 0
          ? null
          : (0, Z.jsx)(`div`, {
              className: z(`mt-2 grid gap-2`, i.length > 1 && `sm:grid-cols-2`),
              children: i.map(zu),
            }),
      ],
    },
...
function Wu(e, t) {
  let n = Ku(e);
  return Nt(Gu(e), t) > 0 || Nt(e.event.eventType, t) > 0 || Nt(n, t) > 0;
}
function Gu(e) {
...
var ud,
  ...
  gd = e(() => {
    (Ce(),
      ...
      pt($e()),
      (fd = vt({ dynamic_configs: Le($e(), Be()), feature_gates: Le($e(), Be()) })),
      (pd = Ue([vt({ is_user_in_experiment: rt() }), vt({ ue: it(!0) })])),
      (hd = new Map()));
  });
function _d() {
  let e = (0, bd.c)(49),
  ...
  if (e[0] !== n || e[1] !== i || e[2] !== o || e[3] !== t) {
    ...
    (e[24] === t.client
      ...
      : ((O = () => {
          (r(!0),
            Cn(t.client, `debug_button`).finally(() => {
              r(!1);
            }));
        }),
        (e[24] = t.client),
  ...
  e[35] !== y || e[36] !== d || e[37] !== f || e[38] !== p || e[39] !== m
    ? ((x = (0, Sd.jsxs)(`div`, { className: d, children: [f, p, m, y] })),
      (e[35] = y),
      (e[36] = d),
      (e[37] = f),
      (e[38] = p),
    ...
    : (x = e[40]);
  let S;
  e[41] === Symbol.for(`react.memo_cache_sentinel`) ? ((S = null), (e[41] = S)) : (S = e[41]);
  let C;
  return (
    e[42] !== c || e[43] !== x || e[44] !== h || e[45] !== g || e[46] !== _ || e[47] !== v
      ? ((C = (0, Sd.jsxs)(c, {
          storageKey: h,
          title: g,
          variant: _,
...
function yd(e) {
  let t = (0, bd.c)(7),
    ...
    s;
  t[0] !== i || t[1] !== a || t[2] !== o
    ? ((s = z(`inline-flex min-h-5 items-center rounded border px-2 text-xs`, i, a, o)),
      (t[0] = i),
      (t[1] = a),
      (t[2] = o),
      (t[3] = s))
...
var bd,
  ...
  Sd,
  Cd = e(() => {
    ((bd = L()), pe(), (xd = t(kt(), 1)), ot(), Rs(), F(), hn(), Ir(), Dr(), gd(), (Sd = R()));
  });
function wd() {
  let e = (0, Od.c)(18),
    [t, n] = (0, kd.useState)(!1),
...
function Ed(e) {
  ...
  t[11] !== i || t[12] !== a || t[13] !== n
    ? ((p = a
        ? (0, Ad.jsx)(`div`, {
            className: `pb-1`,
            children: (0, Ad.jsx)(It, { hostId: re, includeHidden: i, root: n }),
          })
        : null),
      (t[11] = i),
      (t[12] = a),
...
var Od,
  ...
  Ad,
  jd = e(() => {
    ((Od = L()), (kd = t(kt(), 1)), an(), u(), Xe(), le(), Rs(), Dr(), (Ad = R()));
  });
function Md() {
  let e = (0, Bd.c)(1),
    t = N.primaryRuntime;
...
function Nd(e) {
  let t = (0, Bd.c)(33),
    ...
    [u, p] = (0, Vd.useState)(`Not run yet`),
    h = m(jt),
    g;
  t[0] === r ? (g = t[1]) : ((g = () => r.getUpdateStatus()), (t[0] = r), (t[1] = g));
  let _;
  t[2] !== c || t[3] !== g
    ? ((_ = {
        enabled: c,
      ...
      (t[4] = _))
    : (_ = t[4]);
  let { data: v, isLoading: y, refetch: b } = f(_),
    x;
  t[5] !== r || t[6] !== s
    ? ((x = async (e) => {
        let { release: t } = e;
        return (await mn(s), r.runUpdateNow({ release: t }));
      }),
      (t[5] = r),
      (t[6] = s),
      (t[7] = x))
  ...
  t[8] === a
    ? (S = t[9])
    : ((S = (e) => {
        (p(Id(e)), a.invalidateQueries({ queryKey: kn }));
      }),
      (t[8] = a),
      (t[9] = S));
  let E;
  t[10] !== x || t[11] !== S
    ? ((E = { mutationFn: x, onSuccess: S }), (t[10] = x), (t[11] = S), (t[12] = E))
    : (E = t[12]);
  let D = d(E),
    k = v?.isRunning === !0 || D.isPending,
    A = h === `latest-alpha`,
    j;
  t[13] === i
    ? (j = t[14])
    : ((j = (e) => {
        ...
        (i.set(jt, t), O.dispatchMessage(`set-primary-runtime-install-release`, { release: t }));
      }),
      (t[13] = i),
      (t[14] = j));
  let M = j,
  ...
  t[22] !== A
    ? ((N = c
        ? (0, Q.jsx)(he, {
            ...
            triggerButton: (0, Q.jsxs)(`button`, {
              ...
              disabled: k,
              children: [
                k ? (0, Q.jsx)(et, { className: `icon-2xs` }) : null,
                `Cron`,
                (0, Q.jsx)(de, { className: `icon-2xs opacity-70` }),
              ],
            }),
            children: (0, Q.jsxs)(`div`, {
              className: `flex min-w-[220px] flex-col gap-0.5`,
              children: [
                (0, Q.jsx)(C.Title, { children: `Workspace runtime cron` }),
                (0, Q.jsx)(C.Item, {
                  disabled: k || v?.enabled === !1,
                  onSelect: () => {
                    D.mutateAsync({ release: h }).catch((e) => {
                      (p(`Failed to trigger cron job`),
                        n.error(`Failed to trigger workspace runtime cron from debug page`, {
                          safe: { release: h },
                          sensitive: { error: e },
                        }));
                    });
                ...
                (0, Q.jsx)(C.Separator, {}),
                (0, Q.jsx)(C.Title, { children: `Install flow` }),
                (0, Q.jsxs)(`div`, {
    ...
    : (N = t[23]);
  let P;
  t[24] !== v || t[25] !== y || t[26] !== c || t[27] !== k || t[28] !== u
    ? ((P = c
        ? y && v == null
          ? (0, Q.jsx)(`div`, {
              className: `text-token-description-foreground`,
          ...
          : (0, Q.jsxs)(`div`, {
              ...
              children: [
                ...
                v?.disabledReason == null
                  ? null
                  : (0, Q.jsx)(V, { label: `Disabled`, value: Rd(v.disabledReason) }),
                (0, Q.jsx)(V, { label: `Next cron`, value: Fd(v?.nextRunAt ?? null) }),
                (0, Q.jsx)(V, {
                  label: `Startup check`,
                  value: v?.startupChecked === !0 ? `Complete` : `Pending`,
                }),
                (0, Q.jsx)(V, { label: `Running`, value: k ? `Yes` : `No` }),
...
function Kd() {
  let e = (0, qd.c)(23),
    ...
    i = a(Ct.autoCleanupEnabled),
    { data: o, isLoading: s } = M(ie.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED),
    c = o === !0,
    l = i && c,
    u = s,
  ...
  e[0] === d
    ? (f = e[1])
    : ((f = (0, Yd.jsx)(V, { label: `Worktrees setting`, value: d })), (e[0] = d), (e[1] = f));
  let p = c ? `Enabled` : `Disabled`,
    m;
  e[2] === p
    ? (m = e[3])
    : ((m = (0, Yd.jsx)(V, { label: `Source-build override`, value: p })), (e[2] = p), (e[3] = m));
  let h = l ? `Enabled` : `Disabled`,
    g;
  e[4] === h
    ? (g = e[5])
    : ((g = (0, Yd.jsx)(V, { label: `Effective cleanup`, value: h })), (e[4] = h), (e[5] = g));
  let _;
  e[6] !== f || e[7] !== m || e[8] !== g
    ? ((_ = (0, Yd.jsxs)(`div`, { className: `flex flex-col py-1.5`, children: [f, m, g] })),
      (e[6] = f),
      (e[7] = m),
      (e[8] = g),
      (e[9] = _))
  ...
  e[11] === t
    ...
    : ((y = (e) => {
        (r(null),
          He(t, ie.WORKTREE_AUTO_CLEANUP_UNPACKAGED_OVERRIDE_ENABLED, e).catch((e) => {
...
var qd,
  ...
  Yd,
  Xd = e(() => {
    ((qd = L()), Ae(), Ye(), (Jd = t(kt(), 1)), _e(), Je(), D(), j(), h(), Ir(), Dr(), (Yd = R()));
  });
function Zd(e) {
  let t = (0, uf.c)(17),
    { onClose: n } = e,
...
function ef({
  ...
  let c = p(),
    ...
    { data: v } = m(hf),
    x = N.debug,
    S = typeof window < `u` && !!window.electronBridge?.getSentryInitOptions,
    w = typeof window < `u` && !!window.electronBridge?.triggerSentryTestError,
    T = x != null && o && y.allowDebugMenu(Ze()),
    E = v?.isPackaged === !1,
    D = e ?? null,
    O =
      typeof window < `u`
        ...
        : void 0,
    k = u.client.getContext().user?.customIDs?.stableID,
    A = async () => {
    ...
    j = async (e) => {
      if (!g) {
        _(!0);
        try {
          await x?.exportLogs({ scope: e });
        } catch (t) {
          n.error(`Failed to export logs`, { safe: { scope: e }, sensitive: { error: t } });
        } finally {
          _(!1);
        }
      }
    ...
    M = () => {
      (async () => {
        try {
          (await x?.openWindow(), t());
        } catch (e) {
          n.error(`Failed to open debug window`, { safe: {}, sensitive: { error: e } });
        }
      })();
    };
  return (0, $.jsxs)(`div`, {
    ...
    children: [
      a
        ? (0, $.jsxs)(`div`, {
            className: z(
              ...
              r == null && `draggable`,
              T ? `grid-cols-[2rem_1fr_auto]` : `grid-cols-[2rem_1fr_2rem]`,
            ),
            children: [
              (0, $.jsx)(`div`, {
                className: z(`h-full`, r == null ? `draggable` : `cursor-move`),
                onPointerDown: (e) => {
                  r != null && nf(e, r);
                },
              }),
      ...
      (0, $.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, $.jsx)(se, {
            electron: !0,
            children: (0, $.jsx)(Al, { conversationId: D ?? void 0 }),
          }),
          D == null ? null : (0, $.jsx)(bs, { conversationId: D }),
          d.map((e) => {
          ...
          null,
          E ? (0, $.jsx)(sc, {}) : null,
          (0, $.jsx)(Or, { sourceThreadId: D ?? void 0 }),
          E ? (0, $.jsx)(Kd, {}) : null,
          (0, $.jsx)(fc, {}),
          (0, $.jsx)(B, {
            ...
            children: (0, $.jsxs)(`div`, {
              className: `flex flex-col py-1.5`,
              children: [
                (0, $.jsx)(V, { label: `Auth Method`, value: c.authMethod ?? `none` }),
                (0, $.jsx)(V, { label: `User ID`, value: c.userId ?? `Unavailable` }),
                (0, $.jsx)(V, { label: `Account ID`, value: c.accountId ?? `Unavailable` }),
                (0, $.jsx)(V, { label: `Email`, value: c.email ?? `Unavailable` }),
              ],
            }),
          }),
          S
            ? (0, $.jsxs)(B, {
                ...
                children: [
                  (0, $.jsxs)(`div`, {
                    className: `flex flex-col py-1.5`,
                    children: [
                      (0, $.jsx)(V, { label: `App session ID`, value: O ?? `Unavailable` }),
                      (0, $.jsx)(V, { label: `Stable ID`, value: k ?? `Unavailable` }),
                    ],
                  }),
                  (0, $.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                g
                                  ? (0, $.jsx)(`div`, {
                                      ...
                                      children: (0, $.jsx)(et, { className: `icon-xxs` }),
                                    })
                                  : (0, $.jsx)(he, {
                                      align: `end`,
                                      triggerButton: (0, $.jsxs)(`button`, {
                                        ...
                                        children: [
                                          `Export`,
                                          (0, $.jsx)(de, { className: `icon-2xs opacity-70` }),
                                        ],
                                      }),
                                      children: (0, $.jsxs)(`div`, {
                                        className: `flex min-w-[180px] flex-col gap-0.5`,
...
function rf() {
  ...
  let r = t,
    i = o(),
    [a, s] = (0, df.useState)(of),
    l = a && (r === `dev` || r === `nightly`),
    u;
  e[1] === l
    ? (u = e[2])
    : ((u = { queryConfig: { enabled: l, intervalMs: ff } }), (e[1] = l), (e[2] = u));
  let { data: d, isLoading: f } = Ot(`ambient-suggestions-generation-statuses`, u),
    p;
  e[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((p = { hostId: re }), (e[3] = p))
    : (p = e[3]);
  ...
  e[4] === a
    ? (m = e[5])
    : ((m = { params: p, queryConfig: { enabled: a } }), (e[4] = a), (e[5] = m));
  let { data: h } = Ot(`workspace-root-options`, m),
    g;
  e[6] === a ? (g = e[7]) : ((g = { queryConfig: { enabled: a } }), (e[6] = a), (e[7] = g));
  let { data: _ } = Ot(`projectless-thread-cwd`, g),
    y;
  e[8] === i
    ? (y = e[9])
    : ((y = {
        onSuccess: () => {
          (i.invalidateQueries({ queryKey: v(`ambient-suggestions-generation-statuses`) }),
            i.invalidateQueries({ queryKey: v(`ambient-suggestions`) }));
        },
      }),
      (e[8] = i),
      (e[9] = y));
  let b = c(`ambient-suggestions-refresh`, y),
    x = d?.statuses,
    S,
    C,
    w;
  if (
    ...
    bb0: {
      let t = new Map(x?.map(af));
      if (
        ((C = xr({
          labels: h?.labels,
          projectlessThreadCwd: _?.cwd,
          statuses: x,
          workspaceRoots: h?.roots,
        })),
        r !== `dev` && r !== `nightly`)
      ) {
        w = null;
              ...
              (0, $.jsx)(
                Fs,
                {
                  ...
                  rightActions: (0, $.jsx)(`button`, {
                    ...
                    disabled: s || b.isPending,
                    onClick: () => {
                      b.mutateAsync({ domain: null, hostId: re, projectRoot: Qe(r) }).catch((e) => {
                        n.error(`Failed to refresh ambient suggestions from debug page`, {
                          safe: {},
    ...
    ((e[10] = d),
      ...
      (e[18] = C),
      (e[19] = w));
  } else ((S = e[17]), (C = e[18]), (w = e[19]));
  if (w !== Symbol.for(`react.early_return_sentinel`)) return w;
  let T = a ? `Ambient suggestion chats (${C.length})` : `Ambient suggestion chats`,
    E;
  return (
    e[22] !== S || e[23] !== T
      ? ((E = (0, $.jsx)(B, {
...
var uf,
  ...
  gf = e(() => {
    ((uf = L()),
      ...
      (hf = A(w, `is-packaged`, { staleTime: ve.FIVE_SECONDS })));
  });
